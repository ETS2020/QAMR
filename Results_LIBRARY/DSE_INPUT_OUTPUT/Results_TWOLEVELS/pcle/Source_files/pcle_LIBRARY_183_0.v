...
module FAU ( 
  ...
  nand4  g08(.a(new_n36_), .b(new_n32_), .c(x11), .d(new_n29_), .O(new_n37_));
  aoi21  g09(.a(new_n37_), .b(x09), .c(x10), .O(z0));
  inv1   g10(.a(x10), .O(new_n39_));
  oai21  g11(.a(x11), .b(x08), .c(x09), .O(new_n40_));
  ...
  aoi21  g17(.a(new_n45_), .b(new_n29_), .c(new_n44_), .O(new_n46_));
  nand2  g18(.a(x08), .b(x01), .O(new_n47_));
  oai21  g19(.a(new_n46_), .b(x10), .c(new_n47_), .O(z2));
  aoi21  g20(.a(new_n39_), .b(new_n44_), .c(new_n29_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(x02), .O(new_n50_));
  and2   g22(.a(x12), .b(x11), .O(new_n51_));
  nand3  g23(.a(new_n31_), .b(x12), .c(x11), .O(new_n52_));
  oai21  g24(.a(new_n51_), .b(new_n31_), .c(new_n52_), .O(new_n53_));
  nand4  g25(.a(new_n53_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n54_));
  nand2  g26(.a(new_n54_), .b(new_n50_), .O(z3));
  nand2  g27(.a(new_n30_), .b(x09), .O(new_n56_));
  nand3  g28(.a(new_n56_), .b(x13), .c(x11), .O(new_n57_));
  nand2  g29(.a(new_n57_), .b(x14), .O(new_n58_));
  nand3  g30(.a(new_n51_), .b(new_n33_), .c(x13), .O(new_n59_));
  aoi21  g31(.a(new_n59_), .b(new_n58_), .c(x08), .O(new_n60_));
  oai21  g32(.a(new_n60_), .b(new_n44_), .c(new_n39_), .O(new_n61_));
  nand2  g33(.a(x08), .b(x03), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n61_), .O(z4));
  nand2  g35(.a(new_n49_), .b(x04), .O(new_n64_));
  nand3  g36(.a(new_n51_), .b(x14), .c(x13), .O(new_n65_));
  inv1   g37(.a(new_n65_), .O(new_n66_));
  nand4  g38(.a(new_n51_), .b(new_n34_), .c(x14), .d(x13), .O(new_n67_));
  oai21  g39(.a(new_n66_), .b(new_n34_), .c(new_n67_), .O(new_n68_));
  nand4  g40(.a(new_n68_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n69_));
  nand2  g41(.a(new_n69_), .b(new_n64_), .O(z5));
  nand2  g42(.a(new_n33_), .b(x09), .O(new_n71_));
  nand4  g43(.a(new_n71_), .b(new_n51_), .c(x15), .d(x13), .O(new_n72_));
  nand2  g44(.a(new_n72_), .b(x16), .O(new_n73_));
  nand3  g45(.a(x13), .b(x12), .c(x11), .O(new_n74_));
  inv1   g46(.a(new_n74_), .O(new_n75_));
  nor2   g47(.a(x16), .b(new_n34_), .O(new_n76_));
  nand3  g48(.a(new_n76_), .b(new_n75_), .c(x14), .O(new_n77_));
  aoi21  g49(.a(new_n77_), .b(new_n73_), .c(x08), .O(new_n78_));
  oai21  g50(.a(new_n78_), .b(new_n44_), .c(new_n39_), .O(new_n79_));
  nand2  g51(.a(x08), .b(x05), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n79_), .O(z6));
  and2   g53(.a(x16), .b(x15), .O(new_n82_));
  nand3  g54(.a(new_n82_), .b(new_n75_), .c(new_n71_), .O(new_n83_));
  nand2  g55(.a(new_n83_), .b(x17), .O(new_n84_));
  inv1   g56(.a(x17), .O(new_n85_));
  nor2   g57(.a(new_n34_), .b(new_n33_), .O(new_n86_));
  nand4  g58(.a(new_n75_), .b(new_n86_), .c(new_n85_), .d(x16), .O(new_n87_));
  aoi21  g59(.a(new_n87_), .b(new_n84_), .c(x08), .O(new_n88_));
  oai21  g60(.a(new_n88_), .b(new_n44_), .c(new_n39_), .O(new_n89_));
  nand2  g61(.a(x08), .b(x06), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(new_n89_), .O(z7));
  nand2  g63(.a(new_n49_), .b(x07), .O(new_n92_));
  nand3  g64(.a(new_n86_), .b(x17), .c(x16), .O(new_n93_));
  oai21  g65(.a(new_n93_), .b(new_n74_), .c(x18), .O(new_n94_));
  nor2   g66(.a(x18), .b(new_n85_), .O(new_n95_));
  nand3  g67(.a(new_n95_), .b(new_n82_), .c(new_n66_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand4  g69(.a(new_n97_), .b(new_n39_), .c(x09), .d(new_n29_), .O(new_n98_));
