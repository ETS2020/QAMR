...
module FAU ( 
  ...
  nand2  g03(.a(new_n31_), .b(x03), .O(new_n32_));
  ...
  nand4  g33(.a(new_n61_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n56_), .O(z4));
  inv1   g35(.a(new_n50_), .O(new_n64_));
  nand3  g36(.a(new_n50_), .b(x14), .c(x13), .O(new_n65_));
  ...
  aoi21  g43(.a(new_n71_), .b(new_n70_), .c(new_n39_), .O(z5));
  ...
  nand4  g50(.a(new_n78_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n79_));
  aoi21  g51(.a(x08), .b(x05), .c(new_n39_), .O(new_n80_));
  ...
  nand4  g59(.a(new_n87_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n88_));
  aoi21  g60(.a(x08), .b(x06), .c(new_n39_), .O(new_n89_));
  ...
  nand4  g67(.a(new_n95_), .b(new_n29_), .c(x09), .d(new_n41_), .O(new_n96_));
  aoi21  g68(.a(x08), .b(x07), .c(new_n39_), .O(new_n97_));
