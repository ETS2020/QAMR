...
module FAU ( 
  ...
  nand3  g14(.a(x15), .b(new_n42_), .c(new_n31_), .O(new_n43_));
  ...
  aoi21  g25(.a(new_n53_), .b(new_n51_), .c(new_n39_), .O(new_n54_));
  ...
  aoi21  g33(.a(new_n61_), .b(new_n59_), .c(new_n39_), .O(new_n62_));
  ...
  nand4  g37(.a(new_n65_), .b(x15), .c(x09), .d(new_n30_), .O(new_n66_));
  ...
  oai21  g47(.a(new_n75_), .b(new_n50_), .c(new_n73_), .O(new_n76_));
  nand4  g48(.a(new_n76_), .b(x15), .c(new_n31_), .d(x09), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x08), .c(new_n71_), .O(z6));
  ...
  oai21  g57(.a(new_n85_), .b(x08), .c(new_n79_), .O(z7));
  inv1   g58(.a(x09), .O(new_n87_));
  inv1   g59(.a(new_n58_), .O(new_n88_));
  nand2  g60(.a(new_n74_), .b(x15), .O(new_n89_));
  nand4  g61(.a(new_n89_), .b(new_n88_), .c(x17), .d(x14), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nor2   g63(.a(new_n74_), .b(new_n60_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n88_), .c(new_n29_), .d(x17), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n91_), .c(new_n87_), .O(new_n94_));
  aoi21  g66(.a(new_n94_), .b(new_n30_), .c(new_n39_), .O(new_n95_));
