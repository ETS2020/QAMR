...
module FAU ( 
  ...
  aoi21  g14(.a(new_n42_), .b(new_n41_), .c(new_n30_), .O(new_n43_));
  nand2  g15(.a(new_n43_), .b(x00), .O(new_n44_));
  nand3  g16(.a(x17), .b(new_n41_), .c(new_n31_), .O(new_n45_));
  oai21  g17(.a(new_n45_), .b(new_n40_), .c(new_n44_), .O(z1));
  xor2a  g18(.a(x12), .b(x11), .O(new_n47_));
  nand4  g19(.a(new_n47_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n48_));
  aoi22  g20(.a(new_n42_), .b(new_n41_), .c(x08), .d(x01), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(new_n48_), .O(z2));
  nand2  g22(.a(new_n43_), .b(x02), .O(new_n51_));
  xnor2a g23(.a(x13), .b(x12), .O(new_n52_));
  nand3  g24(.a(x17), .b(x13), .c(new_n41_), .O(new_n53_));
  ...
  nand3  g28(.a(new_n39_), .b(x14), .c(new_n31_), .O(new_n57_));
  ...
  nand2  g39(.a(new_n43_), .b(x04), .O(new_n68_));
  ...
  nand3  g46(.a(x17), .b(x15), .c(new_n41_), .O(new_n75_));
  ...
  nand3  g50(.a(new_n39_), .b(x16), .c(new_n31_), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(x17), .O(new_n80_));
  nand2  g52(.a(new_n80_), .b(new_n41_), .O(new_n81_));
  ...
  nand4  g65(.a(new_n42_), .b(x16), .c(x15), .d(x14), .O(new_n94_));
  oai21  g66(.a(new_n94_), .b(new_n84_), .c(new_n93_), .O(new_n95_));
  nand4  g67(.a(new_n95_), .b(new_n31_), .c(x09), .d(new_n30_), .O(new_n96_));
  nand2  g68(.a(new_n96_), .b(new_n91_), .O(z7));
  nand2  g69(.a(new_n43_), .b(x07), .O(new_n98_));
  nand2  g70(.a(x18), .b(new_n42_), .O(new_n99_));
  ...
  or2    g74(.a(new_n92_), .b(new_n84_), .O(new_n103_));
  nand3  g75(.a(new_n103_), .b(x18), .c(x17), .O(new_n104_));
