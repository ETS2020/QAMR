...
module FAU ( 
  ...
  aoi21  g42(.a(x14), .b(x13), .c(x10), .O(new_n71_));
  nand3  g43(.a(x15), .b(x12), .c(x11), .O(new_n72_));
  oai21  g44(.a(new_n72_), .b(new_n71_), .c(x16), .O(new_n73_));
  inv1   g45(.a(x16), .O(new_n74_));
  nand4  g46(.a(new_n57_), .b(new_n74_), .c(x15), .d(x14), .O(new_n75_));
  aoi21  g47(.a(new_n75_), .b(new_n73_), .c(new_n46_), .O(new_n76_));
  oai21  g48(.a(new_n76_), .b(x10), .c(new_n30_), .O(new_n77_));
  ...
  nand4  g61(.a(new_n89_), .b(new_n83_), .c(new_n57_), .d(x17), .O(new_n90_));
  nand2  g62(.a(new_n90_), .b(x18), .O(new_n91_));
  nor2   g63(.a(new_n74_), .b(new_n63_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n65_), .c(new_n29_), .d(x17), .O(new_n93_));
  aoi21  g65(.a(new_n93_), .b(new_n91_), .c(new_n46_), .O(new_n94_));
