...
module FAU ( 
  ...
  aoi21  g20(.a(x12), .b(new_n31_), .c(new_n32_), .O(new_n49_));
  nand2  g21(.a(new_n49_), .b(x03), .O(new_n50_));
  inv1   g22(.a(x09), .O(new_n51_));
  nor2   g23(.a(new_n51_), .b(x08), .O(new_n52_));
  nand4  g24(.a(new_n52_), .b(x14), .c(new_n29_), .d(new_n31_), .O(new_n53_));
  nand2  g25(.a(new_n53_), .b(new_n50_), .O(z4));
  nand2  g26(.a(new_n49_), .b(x04), .O(new_n55_));
  nand4  g27(.a(new_n52_), .b(x15), .c(new_n29_), .d(new_n31_), .O(new_n56_));
  nand2  g28(.a(new_n56_), .b(new_n55_), .O(z5));
  nand2  g29(.a(new_n49_), .b(x05), .O(new_n58_));
  nand4  g30(.a(new_n52_), .b(x16), .c(new_n29_), .d(new_n31_), .O(new_n59_));
