...
module FAU ( 
  ...
  nand2  g39(.a(new_n50_), .b(new_n31_), .O(new_n68_));
  nand3  g40(.a(new_n65_), .b(x14), .c(x13), .O(new_n69_));
  oai22  g41(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n65_), .O(new_n70_));
  ...
  oai21  g60(.a(new_n44_), .b(new_n82_), .c(new_n88_), .O(z7));
  nand3  g61(.a(x17), .b(x16), .c(x15), .O(new_n90_));
  aoi22  g62(.a(new_n90_), .b(new_n31_), .c(new_n66_), .d(x15), .O(new_n91_));
  nor2   g63(.a(new_n77_), .b(new_n65_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n67_), .c(new_n29_), .d(x17), .O(new_n93_));
  oai21  g65(.a(new_n91_), .b(new_n29_), .c(new_n93_), .O(new_n94_));
  nand3  g66(.a(new_n94_), .b(x09), .c(new_n30_), .O(new_n95_));
  aoi21  g67(.a(x08), .b(x07), .c(new_n54_), .O(new_n96_));
