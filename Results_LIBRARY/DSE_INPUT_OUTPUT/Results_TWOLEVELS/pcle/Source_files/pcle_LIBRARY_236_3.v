...
module FAU ( 
  ...
  oai21  g36(.a(new_n64_), .b(new_n50_), .c(x15), .O(new_n65_));
  inv1   g37(.a(x15), .O(new_n66_));
  nand3  g38(.a(new_n66_), .b(x14), .c(x13), .O(new_n67_));
  oai21  g39(.a(new_n67_), .b(new_n50_), .c(new_n65_), .O(new_n68_));
  ...
  nor2   g54(.a(new_n66_), .b(new_n59_), .O(new_n83_));
  ...
  aoi21  g59(.a(x08), .b(x06), .c(new_n70_), .O(new_n88_));
  ...
  nand4  g63(.a(x13), .b(x12), .c(x11), .d(new_n31_), .O(new_n92_));
  nand4  g64(.a(new_n83_), .b(new_n29_), .c(x17), .d(x16), .O(new_n93_));
