...
module FAU ( 
  ...
  nand4  g23(.a(new_n51_), .b(new_n29_), .c(x09), .d(new_n43_), .O(new_n52_));
  ...
  nand3  g29(.a(new_n49_), .b(new_n32_), .c(x13), .O(new_n58_));
  aoi21  g30(.a(new_n58_), .b(new_n57_), .c(new_n55_), .O(new_n59_));
  oai21  g31(.a(new_n59_), .b(x10), .c(new_n43_), .O(new_n60_));
  nand2  g32(.a(x08), .b(x03), .O(new_n61_));
  nand2  g33(.a(new_n61_), .b(new_n60_), .O(z4));
  nand3  g34(.a(new_n49_), .b(x14), .c(x13), .O(new_n63_));
  inv1   g35(.a(new_n63_), .O(new_n64_));
  nand4  g36(.a(new_n49_), .b(new_n33_), .c(x14), .d(x13), .O(new_n65_));
  oai21  g37(.a(new_n64_), .b(new_n33_), .c(new_n65_), .O(new_n66_));
  nand4  g38(.a(new_n66_), .b(new_n29_), .c(x09), .d(new_n43_), .O(new_n67_));
  nand2  g39(.a(x08), .b(x04), .O(new_n68_));
  nand2  g40(.a(new_n68_), .b(new_n67_), .O(z5));
  nand2  g41(.a(new_n32_), .b(new_n29_), .O(new_n70_));
  nand4  g42(.a(new_n70_), .b(new_n49_), .c(x15), .d(x13), .O(new_n71_));
  nand2  g43(.a(new_n71_), .b(x16), .O(new_n72_));
  nand3  g44(.a(x13), .b(x12), .c(x11), .O(new_n73_));
  inv1   g45(.a(new_n73_), .O(new_n74_));
  nor2   g46(.a(x16), .b(new_n33_), .O(new_n75_));
  nand3  g47(.a(new_n75_), .b(new_n74_), .c(x14), .O(new_n76_));
  aoi21  g48(.a(new_n76_), .b(new_n72_), .c(new_n55_), .O(new_n77_));
  oai21  g49(.a(new_n77_), .b(x10), .c(new_n43_), .O(new_n78_));
  nand2  g50(.a(x08), .b(x05), .O(new_n79_));
  nand2  g51(.a(new_n79_), .b(new_n78_), .O(z6));
  and2   g52(.a(x16), .b(x15), .O(new_n81_));
  nand3  g53(.a(new_n81_), .b(new_n74_), .c(new_n70_), .O(new_n82_));
  nand2  g54(.a(new_n82_), .b(x17), .O(new_n83_));
  inv1   g55(.a(x17), .O(new_n84_));
  nand4  g56(.a(new_n74_), .b(new_n34_), .c(new_n84_), .d(x16), .O(new_n85_));
  aoi21  g57(.a(new_n85_), .b(new_n83_), .c(new_n55_), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(x10), .c(new_n43_), .O(new_n87_));
  nand2  g59(.a(x08), .b(x06), .O(new_n88_));
  nand2  g60(.a(new_n88_), .b(new_n87_), .O(z7));
  nand3  g61(.a(new_n34_), .b(x17), .c(x16), .O(new_n90_));
  oai21  g62(.a(new_n90_), .b(new_n73_), .c(x18), .O(new_n91_));
  nor2   g63(.a(x18), .b(new_n84_), .O(new_n92_));
  nand3  g64(.a(new_n92_), .b(new_n81_), .c(new_n64_), .O(new_n93_));
  nand2  g65(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g66(.a(new_n94_), .b(new_n29_), .c(x09), .d(new_n43_), .O(new_n95_));
