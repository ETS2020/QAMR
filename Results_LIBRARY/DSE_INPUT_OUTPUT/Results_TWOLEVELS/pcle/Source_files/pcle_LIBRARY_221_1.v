...
module FAU ( 
  ...
  oai21  g51(.a(new_n30_), .b(new_n39_), .c(new_n79_), .O(z6));
  ...
  aoi21  g58(.a(x08), .b(x06), .c(new_n63_), .O(new_n87_));
  ...
  nor2   g63(.a(new_n76_), .b(new_n67_), .O(new_n92_));
  nand4  g64(.a(new_n92_), .b(new_n69_), .c(new_n29_), .d(x17), .O(new_n93_));
