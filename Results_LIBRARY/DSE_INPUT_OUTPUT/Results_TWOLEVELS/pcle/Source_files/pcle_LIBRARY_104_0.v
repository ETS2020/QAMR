...
module FAU ( 
  ...
  aoi21  g45(.a(new_n73_), .b(new_n31_), .c(new_n51_), .O(new_n74_));
  nand2  g46(.a(x08), .b(x04), .O(new_n75_));
  oai21  g47(.a(new_n74_), .b(x10), .c(new_n75_), .O(z5));
  nand2  g48(.a(new_n32_), .b(new_n51_), .O(new_n77_));
  ...
  oai21  g56(.a(new_n84_), .b(new_n51_), .c(new_n78_), .O(z6));
  nand3  g57(.a(x16), .b(x15), .c(x14), .O(new_n86_));
  oai21  g58(.a(new_n86_), .b(new_n61_), .c(x17), .O(new_n87_));
  inv1   g59(.a(new_n61_), .O(new_n88_));
  nor2   g60(.a(new_n71_), .b(new_n30_), .O(new_n89_));
  nor2   g61(.a(x17), .b(new_n81_), .O(new_n90_));
  nand3  g62(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  aoi21  g63(.a(new_n91_), .b(new_n87_), .c(new_n52_), .O(new_n92_));
  aoi21  g64(.a(new_n92_), .b(new_n31_), .c(new_n51_), .O(new_n93_));
  ...
  nor2   g70(.a(new_n81_), .b(new_n71_), .O(new_n99_));
  nand4  g71(.a(new_n99_), .b(new_n98_), .c(new_n29_), .d(x17), .O(new_n100_));
  nand2  g72(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand3  g73(.a(new_n101_), .b(new_n32_), .c(x09), .O(new_n102_));
  aoi21  g74(.a(new_n102_), .b(new_n31_), .c(new_n51_), .O(z8));
endmodule
