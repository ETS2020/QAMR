...
module FAU ( 
  ...
  oai21  g10(.a(new_n26_), .b(new_n20_), .c(new_n19_), .O(new_n27_));
  nand2  g11(.a(new_n27_), .b(new_n15_), .O(z6));
  nand4  g12(.a(x3), .b(new_n26_), .c(new_n20_), .d(new_n19_), .O(z8));
  nand4  g13(.a(x3), .b(new_n26_), .c(new_n20_), .d(x0), .O(z9));
  one    g14(.O(z3));
  one    g15(.O(z5));
