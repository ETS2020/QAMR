...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    ...
    new_n34_, new_n37_, new_n40_, new_n41_;
  ...
  oai21  g18(.a(new_n18_), .b(new_n17_), .c(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n17_), .b(x0), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(z5));
  nand4  g21(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g22(.a(new_n16_), .b(new_n15_), .c(new_n18_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n24_), .O(z7));
  nand4  g24(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand2  g25(.a(new_n17_), .b(new_n15_), .O(new_n40_));
  oai21  g26(.a(new_n18_), .b(new_n17_), .c(x1), .O(new_n41_));
  nand3  g27(.a(new_n41_), .b(new_n40_), .c(new_n20_), .O(z9));
endmodule
