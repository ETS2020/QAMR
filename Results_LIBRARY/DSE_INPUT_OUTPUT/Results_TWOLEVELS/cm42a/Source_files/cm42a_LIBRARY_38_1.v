...
module FAU ( 
  ...
  nand2  g18(.a(x2), .b(new_n32_), .O(z4));
  nand4  g19(.a(new_n24_), .b(x2), .c(x1), .d(new_n21_), .O(z6));
  nand2  g20(.a(x3), .b(x1), .O(new_n35_));
  oai21  g21(.a(new_n15_), .b(x1), .c(new_n21_), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n35_), .c(new_n16_), .O(z7));
  nand4  g23(.a(x3), .b(new_n15_), .c(new_n32_), .d(new_n21_), .O(z8));
  oai21  g24(.a(x3), .b(x1), .c(x0), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n15_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n20_), .O(z9));
  nand2  g27(.a(x2), .b(new_n32_), .O(z5));
endmodule
