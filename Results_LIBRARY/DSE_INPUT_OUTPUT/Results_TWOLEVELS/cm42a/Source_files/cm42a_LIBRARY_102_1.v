...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n28_, new_n30_, new_n31_;
  ...
  nand4  g12(.a(new_n16_), .b(new_n20_), .c(x1), .d(x0), .O(z3));
  oai21  g13(.a(new_n20_), .b(x1), .c(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(z4));
  nand3  g15(.a(x2), .b(new_n19_), .c(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n23_), .O(z5));
  nand4  g18(.a(new_n16_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
