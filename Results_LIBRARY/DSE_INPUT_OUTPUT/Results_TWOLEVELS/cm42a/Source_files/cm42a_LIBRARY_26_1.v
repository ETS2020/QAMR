...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n24_, new_n25_,
    new_n27_, new_n30_, new_n31_, new_n34_, new_n35_;
  ...
  oai21  g14(.a(x3), .b(new_n24_), .c(x0), .O(new_n30_));
  oai21  g15(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n30_), .O(z7));
  nand4  g17(.a(x3), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g18(.a(x3), .b(x2), .c(x0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n16_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n19_), .O(z9));
  one    g21(.O(z2));
endmodule
