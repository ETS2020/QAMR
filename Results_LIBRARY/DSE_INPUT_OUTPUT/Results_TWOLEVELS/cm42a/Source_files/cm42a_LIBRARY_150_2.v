...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n24_, new_n29_,
    new_n30_;
  ...
  oai21  g10(.a(new_n24_), .b(x0), .c(new_n16_), .O(z4));
  nand4  g11(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g12(.a(new_n24_), .b(new_n16_), .c(x0), .O(z7));
  nor2   g13(.a(x3), .b(x1), .O(new_n29_));
  oai21  g14(.a(new_n29_), .b(x2), .c(new_n15_), .O(new_n30_));
