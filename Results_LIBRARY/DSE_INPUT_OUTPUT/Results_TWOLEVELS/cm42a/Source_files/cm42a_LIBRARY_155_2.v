...
module FAU ( 
  ...
  nor2   g05(.a(new_n18_), .b(x2), .O(new_n20_));
  ...
  nand2  g09(.a(new_n22_), .b(x0), .O(z3));
  ...
  oai21  g15(.a(x2), .b(new_n16_), .c(new_n15_), .O(new_n30_));
  ...
  nand3  g19(.a(new_n20_), .b(new_n18_), .c(new_n15_), .O(z5));
  nand3  g20(.a(new_n20_), .b(new_n18_), .c(new_n15_), .O(z9));
endmodule
