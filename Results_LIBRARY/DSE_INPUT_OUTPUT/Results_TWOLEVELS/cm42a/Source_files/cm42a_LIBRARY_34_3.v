...
module FAU ( 
  ...
  oai21  g06(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n21_));
  ...
  oai21  g13(.a(new_n27_), .b(x2), .c(new_n21_), .O(z6));
  nand4  g14(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  aoi21  g15(.a(x3), .b(new_n15_), .c(x1), .O(new_n30_));
  oai21  g16(.a(new_n30_), .b(x2), .c(new_n21_), .O(z9));
  oai21  g17(.a(new_n27_), .b(x2), .c(new_n21_), .O(z7));
endmodule
