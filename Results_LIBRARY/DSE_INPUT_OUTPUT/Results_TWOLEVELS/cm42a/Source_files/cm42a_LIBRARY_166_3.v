...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_;
  ...
  nand3  g08(.a(new_n15_), .b(new_n21_), .c(x1), .O(new_n23_));
  nand2  g09(.a(new_n23_), .b(new_n17_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n16_), .O(z2));
  oai21  g11(.a(x2), .b(new_n20_), .c(new_n15_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x0), .O(z3));
  oai21  g13(.a(x3), .b(x1), .c(new_n17_), .O(new_n28_));
  oai21  g14(.a(new_n21_), .b(x0), .c(new_n15_), .O(new_n29_));
  ...
  nand4  g20(.a(new_n15_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand4  g21(.a(new_n15_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g22(.a(new_n29_), .b(new_n18_), .O(z8));
  nand2  g23(.a(new_n29_), .b(x0), .O(z9));
endmodule
