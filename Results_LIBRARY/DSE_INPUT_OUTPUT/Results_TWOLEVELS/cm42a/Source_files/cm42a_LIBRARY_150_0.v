...
module FAU ( 
  ...
  nand3  g07(.a(new_n21_), .b(new_n18_), .c(x1), .O(new_n23_));
  ...
  nand2  g12(.a(new_n27_), .b(new_n17_), .O(z4));
  nand4  g13(.a(new_n21_), .b(x2), .c(new_n27_), .d(x0), .O(z5));
  nand4  g14(.a(new_n21_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand3  g15(.a(new_n21_), .b(x2), .c(x1), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n25_), .O(z7));
  nand4  g18(.a(x3), .b(new_n18_), .c(new_n27_), .d(x0), .O(z9));
  one    g19(.O(z0));
  nand2  g20(.a(new_n27_), .b(new_n17_), .O(z8));
endmodule
