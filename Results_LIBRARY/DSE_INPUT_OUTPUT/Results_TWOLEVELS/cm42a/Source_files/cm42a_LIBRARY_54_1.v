...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n25_, new_n26_,
  ...
  nand4  g09(.a(new_n19_), .b(x2), .c(new_n18_), .d(new_n21_), .O(z4));
  nand3  g10(.a(x2), .b(new_n18_), .c(x0), .O(new_n25_));
