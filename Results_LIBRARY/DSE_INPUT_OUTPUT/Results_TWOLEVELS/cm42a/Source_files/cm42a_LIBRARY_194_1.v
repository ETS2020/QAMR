...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n26_, new_n27_, new_n30_;
  ...
  oai21  g10(.a(new_n18_), .b(new_n15_), .c(new_n16_), .O(new_n26_));
  oai21  g11(.a(x3), .b(new_n17_), .c(x0), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n26_), .O(z7));
  nand4  g13(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g14(.a(x2), .b(x1), .c(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n26_), .O(z9));
  one    g16(.O(z6));
endmodule
