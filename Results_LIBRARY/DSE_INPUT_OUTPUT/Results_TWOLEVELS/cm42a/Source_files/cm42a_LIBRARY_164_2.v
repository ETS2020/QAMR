...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n21_, new_n24_, new_n28_;
  ...
  nand4  g09(.a(new_n16_), .b(x2), .c(new_n24_), .d(new_n15_), .O(z4));
  nand4  g10(.a(new_n16_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g11(.a(x1), .b(x0), .c(x3), .O(new_n28_));
  nand2  g12(.a(new_n28_), .b(new_n19_), .O(z8));
  oai21  g13(.a(new_n17_), .b(new_n16_), .c(x0), .O(z9));
  one    g14(.O(z3));
  one    g15(.O(z5));
  nand2  g16(.a(new_n19_), .b(new_n16_), .O(z7));
endmodule
