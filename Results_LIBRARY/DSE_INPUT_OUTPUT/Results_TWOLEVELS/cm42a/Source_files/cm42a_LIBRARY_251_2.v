...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n25_,
    new_n28_, new_n29_, new_n30_, new_n33_, new_n34_, new_n35_;
  ...
  nand2  g12(.a(x1), .b(x0), .O(new_n28_));
  nand3  g13(.a(new_n18_), .b(x2), .c(x1), .O(new_n29_));
  ...
  oai21  g18(.a(new_n33_), .b(x2), .c(new_n15_), .O(new_n34_));
