...
module FAU ( 
  ...
  nand4  g07(.a(new_n18_), .b(x2), .c(new_n21_), .d(new_n20_), .O(z4));
  nand2  g08(.a(x2), .b(x1), .O(new_n23_));
  oai21  g09(.a(x3), .b(x2), .c(new_n20_), .O(new_n24_));
  nand2  g10(.a(x3), .b(x0), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n24_), .c(new_n23_), .O(z5));
  oai21  g12(.a(x3), .b(x2), .c(x0), .O(new_n27_));
  nand2  g13(.a(x3), .b(new_n20_), .O(new_n28_));
  nand2  g14(.a(x2), .b(new_n21_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n27_), .O(z6));
  nand3  g16(.a(new_n29_), .b(new_n25_), .c(new_n24_), .O(z7));
  oai21  g17(.a(x3), .b(x2), .c(x1), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n29_), .c(new_n25_), .O(z8));
  nand4  g19(.a(x3), .b(new_n15_), .c(new_n21_), .d(x0), .O(z9));
