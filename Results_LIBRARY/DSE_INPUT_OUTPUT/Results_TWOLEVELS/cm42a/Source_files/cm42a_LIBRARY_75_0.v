...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n20_, new_n21_;
  ...
  nand4  g09(.a(x3), .b(new_n16_), .c(new_n21_), .d(new_n20_), .O(z8));
  nand4  g10(.a(x3), .b(new_n16_), .c(new_n21_), .d(x0), .O(z9));
  one    g11(.O(z0));
  one    g12(.O(z2));
  nand2  g13(.a(new_n17_), .b(new_n16_), .O(z3));
endmodule
