...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n24_, new_n28_,
    new_n29_, new_n30_, new_n33_, new_n34_;
  ...
  oai21  g13(.a(x3), .b(new_n28_), .c(x0), .O(new_n29_));
  oai21  g14(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z7));
  nand4  g16(.a(x3), .b(new_n28_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g17(.a(x3), .b(x2), .c(x0), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n19_), .O(z9));
  one    g20(.O(z6));
endmodule
