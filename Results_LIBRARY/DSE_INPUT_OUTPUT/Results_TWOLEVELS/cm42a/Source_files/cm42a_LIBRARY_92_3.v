...
module FAU ( 
  ...
  oai21  g14(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n29_));
  oai21  g15(.a(x3), .b(new_n15_), .c(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z5));
  nor2   g17(.a(new_n16_), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(z6));
  nand3  g19(.a(new_n25_), .b(new_n16_), .c(new_n15_), .O(z8));
  nand4  g20(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  nand2  g21(.a(new_n32_), .b(new_n16_), .O(z7));
endmodule
