...
module FAU ( 
  ...
  oai21  g09(.a(x3), .b(new_n16_), .c(x0), .O(new_n26_));
  oai21  g10(.a(new_n18_), .b(new_n15_), .c(new_n17_), .O(new_n27_));
  nand2  g11(.a(new_n27_), .b(new_n26_), .O(z7));
  nand4  g12(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g13(.a(x2), .b(x1), .c(x0), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n27_), .O(z9));
  one    g15(.O(z4));
  one    g16(.O(z6));
endmodule
