...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n26_, new_n29_, new_n30_, new_n31_, new_n36_;
  ...
  oai21  g10(.a(new_n20_), .b(x2), .c(new_n15_), .O(new_n25_));
  oai21  g11(.a(x3), .b(x0), .c(new_n17_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n25_), .O(z2));
  nand4  g13(.a(new_n20_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  oai21  g14(.a(x3), .b(x0), .c(new_n15_), .O(new_n29_));
  inv1   g15(.a(x0), .O(new_n30_));
  oai21  g16(.a(x1), .b(new_n30_), .c(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n29_), .O(z4));
  nand4  g18(.a(new_n20_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand3  g19(.a(new_n25_), .b(new_n18_), .c(new_n15_), .O(z6));
  nand2  g20(.a(x2), .b(x1), .O(z7));
  oai21  g21(.a(new_n20_), .b(x1), .c(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(z8));
  nand4  g23(.a(x3), .b(new_n17_), .c(new_n15_), .d(x0), .O(z9));
endmodule
