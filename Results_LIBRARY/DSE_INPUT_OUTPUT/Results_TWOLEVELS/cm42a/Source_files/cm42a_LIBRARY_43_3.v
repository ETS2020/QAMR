...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n33_, new_n34_,
    new_n37_, new_n38_;
  ...
  nand4  g12(.a(new_n20_), .b(new_n26_), .c(x1), .d(new_n19_), .O(z2));
  nand2  g13(.a(new_n17_), .b(x0), .O(new_n28_));
  nand3  g14(.a(new_n20_), .b(x2), .c(x1), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n23_), .O(z3));
  nand4  g16(.a(new_n20_), .b(x2), .c(new_n17_), .d(new_n19_), .O(z4));
  nand4  g17(.a(new_n20_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  nand2  g18(.a(new_n20_), .b(new_n26_), .O(new_n33_));
  nand2  g19(.a(new_n17_), .b(new_n19_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n16_), .O(z6));
  nand4  g21(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g22(.a(x2), .b(x0), .c(new_n17_), .O(new_n37_));
  oai21  g23(.a(new_n26_), .b(x1), .c(new_n20_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z8));
  nand4  g25(.a(x3), .b(new_n26_), .c(new_n17_), .d(x0), .O(z9));
endmodule
