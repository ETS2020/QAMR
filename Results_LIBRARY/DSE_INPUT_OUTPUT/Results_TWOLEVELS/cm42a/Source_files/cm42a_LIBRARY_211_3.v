...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n28_, new_n29_, new_n33_, new_n35_;
  ...
  nand4  g11(.a(new_n20_), .b(new_n17_), .c(x1), .d(new_n25_), .O(z2));
  nand4  g12(.a(new_n20_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  oai21  g13(.a(x3), .b(x0), .c(new_n15_), .O(new_n28_));
  oai21  g14(.a(x1), .b(new_n25_), .c(new_n17_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z4));
  nand4  g16(.a(new_n20_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand2  g17(.a(x2), .b(x1), .O(z6));
  oai21  g18(.a(new_n20_), .b(x1), .c(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(z8));
  oai21  g20(.a(new_n20_), .b(x2), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n29_), .b(new_n35_), .O(z9));
