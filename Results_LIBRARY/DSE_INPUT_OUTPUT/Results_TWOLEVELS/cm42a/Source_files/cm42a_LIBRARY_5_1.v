...
module FAU ( 
  ...
  nand2  g15(.a(x2), .b(new_n16_), .O(z4));
  nand4  g16(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g17(.a(new_n17_), .b(x0), .O(new_n32_));
  nand2  g18(.a(x3), .b(x1), .O(new_n33_));
  oai21  g19(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n32_), .O(z7));
  nand2  g21(.a(new_n32_), .b(x1), .O(new_n36_));
