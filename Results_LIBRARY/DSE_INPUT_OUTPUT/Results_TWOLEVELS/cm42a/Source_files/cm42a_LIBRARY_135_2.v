...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n24_, new_n25_, new_n27_, new_n30_, new_n32_, new_n34_;
  ...
  nand4  g14(.a(new_n17_), .b(x2), .c(new_n22_), .d(new_n15_), .O(z4));
  oai21  g15(.a(x3), .b(new_n16_), .c(x1), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n24_), .c(new_n15_), .O(z6));
  oai21  g17(.a(x2), .b(new_n22_), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n30_), .O(z7));
  oai21  g19(.a(new_n17_), .b(x2), .c(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n20_), .O(z8));
  nand2  g21(.a(new_n22_), .b(x0), .O(z5));
  nand2  g22(.a(new_n22_), .b(x0), .O(z9));
endmodule
