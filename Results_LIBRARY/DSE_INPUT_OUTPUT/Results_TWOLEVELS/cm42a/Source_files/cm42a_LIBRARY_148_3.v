...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n21_, new_n25_;
  ...
  oai21  g10(.a(x3), .b(new_n15_), .c(new_n16_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x2), .O(z5));
  nand2  g12(.a(x2), .b(x1), .O(z6));
  nand4  g13(.a(x3), .b(new_n20_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand4  g14(.a(x3), .b(new_n20_), .c(new_n16_), .d(x0), .O(z9));
  one    g15(.O(z7));
endmodule
