...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n22_, new_n24_, new_n27_,
    new_n28_, new_n29_;
  ...
  nand3  g09(.a(new_n24_), .b(new_n16_), .c(new_n19_), .O(z4));
  ...
  nand3  g15(.a(new_n29_), .b(new_n22_), .c(x2), .O(z7));
  one    g16(.O(z0));
  one    g17(.O(z8));
  one    g18(.O(z9));
endmodule
