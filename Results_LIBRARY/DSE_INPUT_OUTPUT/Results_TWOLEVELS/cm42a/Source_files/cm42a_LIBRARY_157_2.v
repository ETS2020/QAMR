...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n27_, new_n31_, new_n32_, new_n33_, new_n34_, new_n35_;
  ...
  oai21  g09(.a(new_n23_), .b(new_n15_), .c(new_n16_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n20_), .O(z2));
  nand2  g11(.a(new_n23_), .b(new_n16_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n20_), .O(z4));
  nand2  g13(.a(new_n24_), .b(new_n16_), .O(z5));
  nand4  g14(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g15(.a(x2), .b(new_n15_), .O(new_n31_));
  oai21  g16(.a(x2), .b(new_n16_), .c(x3), .O(new_n32_));
  nor2   g17(.a(x3), .b(x2), .O(new_n33_));
  and2   g18(.a(x2), .b(x0), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(new_n33_), .c(new_n16_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n32_), .c(new_n31_), .O(z7));
