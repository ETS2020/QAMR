...
module FAU ( 
  ...
  oai21  g11(.a(x1), .b(new_n20_), .c(new_n22_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x2), .O(z5));
  nand4  g13(.a(new_n22_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  oai21  g14(.a(new_n18_), .b(new_n20_), .c(new_n22_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x2), .O(z7));
  nand4  g16(.a(x3), .b(new_n21_), .c(new_n18_), .d(new_n20_), .O(z8));
  nand4  g17(.a(x3), .b(new_n21_), .c(new_n18_), .d(x0), .O(z9));
endmodule
