...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n23_, new_n25_,
    new_n26_, new_n27_, new_n31_, new_n32_, new_n34_;
  ...
  nand3  g10(.a(x2), .b(new_n16_), .c(new_n15_), .O(new_n25_));
  ...
  nor2   g19(.a(new_n18_), .b(x2), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n18_), .O(z8));
  nand2  g21(.a(new_n34_), .b(new_n18_), .O(z9));
endmodule
