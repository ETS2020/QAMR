...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n26_, new_n27_, new_n29_, new_n30_, new_n33_, new_n34_,
    new_n35_, new_n38_;
  ...
  nand3  g12(.a(new_n18_), .b(x2), .c(x1), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n26_), .c(new_n22_), .O(z3));
  oai21  g14(.a(x3), .b(x0), .c(new_n16_), .O(new_n29_));
  oai21  g15(.a(new_n17_), .b(x1), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z4));
  nand4  g17(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand2  g18(.a(new_n21_), .b(x0), .O(new_n33_));
  ...
  oai21  g23(.a(x2), .b(x0), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n30_), .O(z8));
