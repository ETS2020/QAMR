...
module FAU ( 
  ...
  oai21  g13(.a(x3), .b(x0), .c(new_n16_), .O(new_n28_));
  ...
  nand2  g21(.a(new_n23_), .b(x0), .O(new_n36_));
  nand2  g22(.a(new_n18_), .b(new_n17_), .O(new_n37_));
  nand3  g23(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(z6));
  oai21  g24(.a(new_n17_), .b(new_n15_), .c(new_n18_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n28_), .O(z7));
  nand2  g26(.a(new_n36_), .b(new_n20_), .O(z8));
