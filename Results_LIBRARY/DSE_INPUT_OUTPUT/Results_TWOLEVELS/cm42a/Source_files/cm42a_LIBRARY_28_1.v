...
module FAU ( 
  ...
  oai21  g09(.a(x3), .b(new_n19_), .c(new_n18_), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n24_), .O(z4));
  nand3  g11(.a(new_n20_), .b(x2), .c(x0), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n18_), .O(new_n28_));
  oai21  g13(.a(new_n18_), .b(new_n15_), .c(new_n28_), .O(z5));
  nand2  g14(.a(x1), .b(new_n15_), .O(z6));
  nand4  g15(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g16(.a(x3), .b(x2), .O(new_n32_));
  aoi21  g17(.a(x2), .b(new_n15_), .c(new_n32_), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(x1), .c(new_n15_), .O(z8));
