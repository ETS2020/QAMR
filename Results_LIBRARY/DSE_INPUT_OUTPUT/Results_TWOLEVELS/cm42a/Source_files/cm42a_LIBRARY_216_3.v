...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n35_,
    new_n37_, new_n39_;
  ...
  nand3  g16(.a(new_n28_), .b(new_n30_), .c(new_n18_), .O(z5));
  nand2  g17(.a(new_n20_), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n18_), .b(new_n17_), .O(new_n33_));
  nand3  g19(.a(new_n30_), .b(new_n33_), .c(new_n32_), .O(z6));
  nand2  g20(.a(new_n16_), .b(x0), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n33_), .c(new_n21_), .O(z7));
  oai21  g22(.a(x2), .b(x0), .c(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n28_), .O(z8));
  oai21  g24(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n28_), .O(z9));
endmodule
