...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n25_, new_n26_, new_n31_, new_n34_, new_n36_;
  inv1   g00(.a(x0), .O(new_n15_));
  inv1   g01(.a(x1), .O(new_n16_));
  inv1   g02(.a(x2), .O(new_n17_));
  inv1   g03(.a(x3), .O(new_n18_));
  nand4  g04(.a(new_n18_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z0));
  oai21  g05(.a(x2), .b(x1), .c(new_n18_), .O(new_n20_));
  ...
  nand2  g11(.a(new_n18_), .b(x2), .O(new_n26_));
  ...
  nand3  g17(.a(new_n31_), .b(new_n25_), .c(new_n24_), .O(z6));
  nand4  g18(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g19(.a(x2), .b(x0), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(x1), .c(x3), .O(z8));
