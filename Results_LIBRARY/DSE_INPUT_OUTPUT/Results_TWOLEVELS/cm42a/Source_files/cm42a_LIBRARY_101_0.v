...
module FAU ( 
  ...
  nand3  g09(.a(new_n19_), .b(new_n15_), .c(x0), .O(new_n24_));
  ...
  oai21  g14(.a(x3), .b(new_n15_), .c(x0), .O(new_n29_));
  oai21  g15(.a(x2), .b(new_n21_), .c(x1), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z5));
  oai21  g17(.a(x2), .b(new_n18_), .c(x0), .O(new_n32_));
  oai21  g18(.a(x3), .b(new_n15_), .c(x1), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z6));
  nand3  g20(.a(new_n33_), .b(new_n26_), .c(x0), .O(z7));
