...
module FAU ( 
  ...
  nand4  g11(.a(new_n20_), .b(x2), .c(new_n18_), .d(new_n25_), .O(z4));
  nand4  g12(.a(new_n20_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  oai21  g13(.a(x2), .b(x0), .c(new_n18_), .O(new_n28_));
  oai21  g14(.a(x3), .b(new_n19_), .c(new_n25_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z6));
  nand4  g16(.a(x3), .b(new_n19_), .c(new_n18_), .d(new_n25_), .O(z8));
  nand4  g17(.a(x3), .b(new_n19_), .c(new_n18_), .d(x0), .O(z9));
