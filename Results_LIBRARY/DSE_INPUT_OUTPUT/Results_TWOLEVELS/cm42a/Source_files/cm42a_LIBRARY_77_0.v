...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n21_, new_n22_, new_n28_;
  ...
  nand4  g11(.a(x3), .b(new_n28_), .c(new_n15_), .d(new_n21_), .O(z8));
  nand4  g12(.a(x3), .b(new_n28_), .c(new_n15_), .d(x0), .O(z9));
  one    g13(.O(z1));
  one    g14(.O(z4));
  one    g15(.O(z5));
endmodule
