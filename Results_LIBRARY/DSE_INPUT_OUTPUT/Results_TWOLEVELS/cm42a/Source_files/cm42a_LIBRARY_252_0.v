...
module FAU ( 
  ...
  nand2  g20(.a(new_n35_), .b(new_n33_), .O(z7));
  one    g21(.O(z0));
  one    g22(.O(z9));
  nand2  g23(.a(new_n17_), .b(new_n16_), .O(z8));
endmodule
