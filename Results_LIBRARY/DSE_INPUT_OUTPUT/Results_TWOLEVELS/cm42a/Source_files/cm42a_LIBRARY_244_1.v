...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n28_,
    new_n29_, new_n31_;
  ...
  oai21  g11(.a(x3), .b(new_n16_), .c(x0), .O(new_n28_));
  oai21  g12(.a(new_n21_), .b(x1), .c(new_n17_), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(new_n28_), .O(z7));
  oai21  g14(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n31_));
