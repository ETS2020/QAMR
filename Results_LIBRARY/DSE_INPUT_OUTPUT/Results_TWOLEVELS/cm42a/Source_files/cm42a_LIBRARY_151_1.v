...
module FAU ( 
  ...
  nand4  g11(.a(new_n22_), .b(x2), .c(new_n26_), .d(x0), .O(z5));
  nand2  g12(.a(x2), .b(new_n15_), .O(z6));
  oai21  g13(.a(x3), .b(new_n26_), .c(x0), .O(new_n29_));
  oai21  g14(.a(x1), .b(new_n15_), .c(new_n19_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z7));
  nand4  g16(.a(x3), .b(new_n19_), .c(new_n26_), .d(new_n15_), .O(z8));
  nand4  g17(.a(x3), .b(new_n19_), .c(new_n26_), .d(x0), .O(z9));
  one    g18(.O(z4));
endmodule
