...
module FAU ( 
  ...
  nand4  g07(.a(new_n16_), .b(new_n19_), .c(x1), .d(new_n21_), .O(z2));
  ...
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(new_n23_), .O(z3));
  nand4  g13(.a(new_n16_), .b(x2), .c(new_n15_), .d(new_n21_), .O(z4));
  nand4  g14(.a(new_n16_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand4  g15(.a(new_n16_), .b(x2), .c(x1), .d(new_n21_), .O(z6));
  nand2  g16(.a(new_n16_), .b(new_n19_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n26_), .c(new_n25_), .O(z7));
