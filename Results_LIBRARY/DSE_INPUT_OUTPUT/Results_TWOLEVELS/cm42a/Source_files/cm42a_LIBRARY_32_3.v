...
module FAU ( 
  ...
  nand4  g08(.a(new_n22_), .b(new_n17_), .c(x1), .d(new_n15_), .O(z2));
  inv1   g09(.a(x1), .O(new_n24_));
  oai21  g10(.a(x3), .b(new_n24_), .c(new_n17_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x0), .O(z3));
  oai21  g12(.a(new_n20_), .b(x0), .c(x2), .O(z4));
  nand4  g13(.a(new_n22_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g14(.a(new_n20_), .b(x0), .c(new_n17_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n16_), .O(z8));
  nand4  g16(.a(x3), .b(new_n17_), .c(new_n24_), .d(x0), .O(z9));
  one    g17(.O(z5));
  one    g18(.O(z7));
endmodule
