...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n25_,
    new_n26_, new_n27_, new_n31_, new_n32_, new_n33_, new_n35_, new_n36_,
    new_n37_;
  ...
  oai21  g06(.a(x1), .b(x0), .c(x2), .O(new_n21_));
  nand2  g07(.a(new_n21_), .b(new_n20_), .O(z1));
  nand2  g08(.a(new_n17_), .b(x1), .O(z2));
  nand2  g09(.a(x2), .b(x1), .O(new_n25_));
  nand3  g10(.a(new_n18_), .b(x2), .c(new_n15_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n16_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n25_), .O(z4));
  ...
  nor2   g19(.a(x3), .b(x2), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(x0), .c(new_n16_), .O(new_n36_));
  nand2  g21(.a(new_n33_), .b(x2), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n36_), .O(z8));
  nand4  g23(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  one    g24(.O(z3));
endmodule
