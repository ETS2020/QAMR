...
module FAU ( 
  ...
  oai21  g17(.a(x3), .b(x2), .c(new_n21_), .O(new_n32_));
  aoi21  g18(.a(x1), .b(x0), .c(new_n22_), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(x3), .c(new_n32_), .O(z5));
  oai21  g20(.a(x3), .b(new_n26_), .c(new_n21_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n30_), .O(z6));
  aoi21  g22(.a(new_n26_), .b(x0), .c(new_n22_), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(x3), .c(new_n32_), .O(z7));
  nand4  g24(.a(x3), .b(new_n22_), .c(new_n26_), .d(new_n21_), .O(z8));
  nand2  g25(.a(new_n32_), .b(new_n30_), .O(z9));
endmodule
