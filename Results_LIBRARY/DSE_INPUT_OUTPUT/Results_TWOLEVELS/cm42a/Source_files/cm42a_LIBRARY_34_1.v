...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n23_,
    new_n28_, new_n29_, new_n30_, new_n32_, new_n33_, new_n36_, new_n37_;
  ...
  oai21  g11(.a(new_n17_), .b(x1), .c(x0), .O(new_n28_));
  nand2  g12(.a(new_n17_), .b(new_n15_), .O(new_n29_));
  nand2  g13(.a(x3), .b(x1), .O(new_n30_));
  nand3  g14(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(z6));
  oai21  g15(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n32_));
  nand2  g16(.a(new_n17_), .b(x0), .O(new_n33_));
  nand3  g17(.a(new_n33_), .b(new_n32_), .c(new_n30_), .O(z7));
  nand4  g18(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand2  g19(.a(x1), .b(x0), .O(new_n36_));
  nand3  g20(.a(new_n18_), .b(new_n17_), .c(new_n16_), .O(new_n37_));
  nand3  g21(.a(new_n37_), .b(new_n32_), .c(new_n36_), .O(z9));
  one    g22(.O(z4));
  one    g23(.O(z5));
endmodule
