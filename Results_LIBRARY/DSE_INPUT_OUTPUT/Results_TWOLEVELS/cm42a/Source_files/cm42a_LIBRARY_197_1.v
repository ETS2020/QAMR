...
module FAU ( 
  ...
  nand3  g16(.a(x2), .b(new_n22_), .c(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n19_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n29_), .O(z5));
  nand2  g19(.a(x2), .b(x1), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(x0), .c(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n29_), .O(z6));
  oai21  g22(.a(new_n34_), .b(new_n18_), .c(new_n19_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n29_), .O(z7));
  one    g24(.O(z8));
  one    g25(.O(z9));
endmodule
