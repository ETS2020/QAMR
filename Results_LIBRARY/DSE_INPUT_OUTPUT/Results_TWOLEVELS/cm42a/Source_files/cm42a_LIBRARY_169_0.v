...
module FAU ( 
  ...
  nand4  g08(.a(new_n23_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  inv1   g09(.a(x1), .O(new_n26_));
  nand4  g10(.a(new_n23_), .b(x2), .c(new_n26_), .d(x0), .O(z5));
  nand4  g11(.a(new_n23_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand3  g12(.a(new_n23_), .b(x2), .c(x1), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(x0), .O(new_n30_));
  nand2  g14(.a(x1), .b(new_n17_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n30_), .O(z7));
  nor2   g16(.a(x3), .b(x1), .O(new_n34_));
  oai21  g17(.a(new_n34_), .b(x2), .c(x0), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n19_), .O(z9));
  one    g19(.O(z0));
  one    g20(.O(z4));
  one    g21(.O(z8));
endmodule
