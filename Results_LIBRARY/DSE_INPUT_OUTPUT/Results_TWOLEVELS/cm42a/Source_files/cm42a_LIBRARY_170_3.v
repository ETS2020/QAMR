...
module FAU ( 
  ...
  nand2  g08(.a(new_n17_), .b(new_n15_), .O(new_n23_));
  nand2  g09(.a(x3), .b(x2), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(x0), .O(new_n25_));
  nand2  g11(.a(new_n18_), .b(x1), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(new_n23_), .O(z4));
  nand2  g13(.a(new_n17_), .b(x0), .O(new_n28_));
  nand2  g14(.a(new_n24_), .b(new_n15_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n26_), .c(new_n28_), .O(z5));
  nand2  g16(.a(new_n18_), .b(new_n16_), .O(new_n31_));
  nand3  g17(.a(new_n25_), .b(new_n31_), .c(new_n23_), .O(z6));
  nand3  g18(.a(new_n29_), .b(new_n31_), .c(new_n28_), .O(z7));
