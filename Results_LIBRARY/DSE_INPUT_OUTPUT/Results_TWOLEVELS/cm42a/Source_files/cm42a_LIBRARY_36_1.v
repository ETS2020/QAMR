...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n23_, new_n25_, new_n26_,
    new_n29_, new_n32_;
  ...
  aoi21  g08(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n23_));
  oai21  g09(.a(new_n23_), .b(x3), .c(new_n15_), .O(z4));
  oai21  g10(.a(x3), .b(x1), .c(x0), .O(new_n25_));
  ...
  nand2  g15(.a(new_n29_), .b(new_n26_), .O(z7));
