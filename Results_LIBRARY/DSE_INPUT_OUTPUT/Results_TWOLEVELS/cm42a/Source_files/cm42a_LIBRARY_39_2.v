...
module FAU ( 
  ...
  nand2  g07(.a(new_n17_), .b(x1), .O(z2));
  oai21  g08(.a(x2), .b(new_n16_), .c(x0), .O(new_n24_));
  oai21  g09(.a(x3), .b(new_n17_), .c(new_n16_), .O(new_n25_));
  nand3  g10(.a(x2), .b(x1), .c(new_n15_), .O(new_n26_));
  nand3  g11(.a(new_n26_), .b(new_n25_), .c(new_n24_), .O(z4));
  oai21  g12(.a(x2), .b(new_n16_), .c(new_n15_), .O(new_n28_));
  nand3  g13(.a(x2), .b(x1), .c(x0), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n28_), .c(new_n25_), .O(z5));
  nand2  g15(.a(new_n16_), .b(new_n15_), .O(new_n31_));
  nand2  g16(.a(x3), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n24_), .O(z6));
  nand2  g18(.a(new_n16_), .b(x0), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n32_), .c(new_n28_), .O(z7));
