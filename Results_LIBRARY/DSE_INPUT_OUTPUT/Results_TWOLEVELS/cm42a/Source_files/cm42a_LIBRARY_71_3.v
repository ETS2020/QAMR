...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n28_, new_n31_, new_n32_, new_n33_, new_n35_;
  ...
  oai21  g13(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n22_), .O(z6));
  nand2  g15(.a(x3), .b(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n16_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n17_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n28_), .O(z8));
  oai21  g19(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n28_), .O(z9));
  one    g21(.O(z7));
endmodule
