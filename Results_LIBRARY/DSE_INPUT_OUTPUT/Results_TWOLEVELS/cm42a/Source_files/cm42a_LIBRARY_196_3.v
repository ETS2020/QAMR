...
module FAU ( 
  ...
  nand2  g11(.a(x3), .b(new_n20_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(new_n16_), .O(z2));
  nand4  g13(.a(new_n23_), .b(new_n20_), .c(x1), .d(x0), .O(z3));
  nand4  g14(.a(new_n23_), .b(x2), .c(new_n17_), .d(new_n19_), .O(z4));
  ...
  nand3  g20(.a(new_n34_), .b(new_n31_), .c(new_n30_), .O(z5));
  inv1   g21(.a(z6), .O(new_n36_));
  nand2  g22(.a(x2), .b(x1), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n36_), .O(z7));
  nand4  g24(.a(x3), .b(new_n20_), .c(new_n17_), .d(new_n19_), .O(z8));
  nand4  g25(.a(x3), .b(new_n20_), .c(new_n17_), .d(x0), .O(z9));
endmodule
