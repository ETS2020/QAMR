...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n21_, new_n22_, new_n25_, new_n29_;
  ...
  nor2   g08(.a(x1), .b(new_n19_), .O(new_n25_));
  nand3  g09(.a(new_n25_), .b(new_n16_), .c(x2), .O(z5));
  nand4  g10(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  inv1   g11(.a(x2), .O(new_n29_));
  nand4  g12(.a(x3), .b(new_n29_), .c(new_n21_), .d(new_n19_), .O(z8));
  nand3  g13(.a(new_n25_), .b(x3), .c(new_n29_), .O(z9));
  one    g14(.O(z0));
  one    g15(.O(z4));
  one    g16(.O(z6));
endmodule
