...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n26_,
    new_n27_, new_n28_, new_n32_, new_n33_, new_n35_, new_n36_;
  ...
  nand4  g13(.a(new_n21_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand4  g14(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g15(.a(x3), .b(x2), .O(new_n32_));
  oai21  g16(.a(new_n32_), .b(x0), .c(new_n15_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n18_), .O(z8));
  oai21  g18(.a(new_n32_), .b(new_n17_), .c(new_n15_), .O(new_n35_));
  oai21  g19(.a(x1), .b(x0), .c(x2), .O(new_n36_));
