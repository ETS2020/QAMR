...
module FAU ( 
  ...
  oai21  g20(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n17_), .b(x0), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(z7));
  nand2  g23(.a(new_n36_), .b(x1), .O(new_n38_));
  nor2   g24(.a(x3), .b(x1), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(x0), .c(new_n17_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n38_), .O(z8));
  oai21  g27(.a(new_n39_), .b(new_n15_), .c(new_n17_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n21_), .O(z9));
  nand2  g29(.a(x2), .b(new_n16_), .O(z5));
endmodule
