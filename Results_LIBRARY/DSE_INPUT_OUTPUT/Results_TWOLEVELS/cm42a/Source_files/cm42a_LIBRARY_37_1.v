...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n26_,
    new_n28_, new_n29_, new_n30_, new_n33_;
  ...
  oai21  g11(.a(x3), .b(x1), .c(x0), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x2), .O(z5));
  oai21  g13(.a(x1), .b(new_n15_), .c(new_n19_), .O(new_n28_));
  inv1   g14(.a(x1), .O(new_n29_));
  oai21  g15(.a(x3), .b(new_n29_), .c(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n28_), .O(z7));
  nand4  g17(.a(x3), .b(new_n19_), .c(new_n29_), .d(new_n15_), .O(z8));
  nand2  g18(.a(new_n26_), .b(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n18_), .O(z9));
  nand2  g20(.a(x2), .b(new_n15_), .O(z6));
endmodule
