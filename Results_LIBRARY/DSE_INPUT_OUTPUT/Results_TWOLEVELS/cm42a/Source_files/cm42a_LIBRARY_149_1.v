...
module FAU ( 
  ...
  oai21  g13(.a(new_n16_), .b(new_n15_), .c(x2), .O(z5));
  oai21  g14(.a(x3), .b(new_n22_), .c(x0), .O(new_n29_));
  oai21  g15(.a(x1), .b(new_n15_), .c(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z7));
  oai21  g17(.a(x2), .b(new_n22_), .c(x0), .O(new_n32_));
  oai21  g18(.a(new_n25_), .b(x1), .c(new_n19_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z8));
  nand4  g20(.a(x3), .b(new_n19_), .c(new_n22_), .d(x0), .O(z9));
