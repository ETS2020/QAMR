...
module FAU ( 
  ...
  oai21  g17(.a(new_n15_), .b(x1), .c(x0), .O(new_n33_));
  nand2  g18(.a(new_n15_), .b(new_n23_), .O(new_n34_));
  nand2  g19(.a(x3), .b(x1), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(z6));
  oai21  g21(.a(new_n15_), .b(x1), .c(new_n23_), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n35_), .c(new_n16_), .O(z7));
