...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n23_, new_n26_,
  ...
  oai21  g13(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n29_));
  ...
  nand2  g17(.a(new_n26_), .b(new_n17_), .O(new_n33_));
