...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_,
    new_n25_, new_n28_, new_n32_, new_n34_;
  ...
  nand2  g14(.a(x2), .b(new_n15_), .O(z6));
  nand4  g15(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g16(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n25_), .O(z8));
  nand2  g18(.a(new_n28_), .b(new_n17_), .O(new_n34_));
