...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n23_, new_n26_,
    new_n27_, new_n28_, new_n33_, new_n34_, new_n35_;
  ...
  nand2  g19(.a(new_n17_), .b(new_n15_), .O(new_n34_));
  oai21  g20(.a(new_n18_), .b(new_n17_), .c(x1), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(z9));
endmodule
