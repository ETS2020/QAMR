...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n32_, new_n33_,
    new_n35_, new_n38_;
  ...
  nand3  g15(.a(new_n29_), .b(new_n27_), .c(new_n22_), .O(z3));
  nand4  g16(.a(new_n18_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  oai21  g17(.a(x3), .b(new_n15_), .c(new_n16_), .O(new_n32_));
  oai21  g18(.a(new_n17_), .b(x1), .c(new_n18_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z5));
  nand2  g20(.a(new_n18_), .b(new_n17_), .O(new_n35_));
  nand3  g21(.a(new_n26_), .b(new_n35_), .c(new_n25_), .O(z6));
  nand4  g22(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g23(.a(x2), .b(x0), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n33_), .O(z8));
