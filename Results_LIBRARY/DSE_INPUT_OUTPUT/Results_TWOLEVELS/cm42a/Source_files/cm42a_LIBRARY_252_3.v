...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n27_, new_n28_, new_n31_, new_n32_, new_n35_,
    new_n36_;
  ...
  nand4  g15(.a(new_n20_), .b(x2), .c(new_n15_), .d(new_n24_), .O(z4));
  oai21  g16(.a(x3), .b(new_n24_), .c(new_n15_), .O(new_n31_));
  oai21  g17(.a(x1), .b(x0), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z5));
  nand2  g19(.a(x2), .b(x1), .O(z6));
  nand3  g20(.a(x3), .b(new_n15_), .c(new_n24_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n18_), .O(z8));
  nand4  g23(.a(x3), .b(new_n16_), .c(new_n15_), .d(x0), .O(z9));
