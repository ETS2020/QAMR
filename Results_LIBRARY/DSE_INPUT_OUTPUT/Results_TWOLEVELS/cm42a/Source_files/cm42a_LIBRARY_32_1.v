...
module FAU ( 
  ...
  oai21  g10(.a(x2), .b(new_n24_), .c(x0), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n20_), .O(z3));
  nand2  g12(.a(x2), .b(new_n15_), .O(z4));
  nand4  g13(.a(new_n22_), .b(x2), .c(new_n24_), .d(x0), .O(z5));
  nand4  g14(.a(new_n22_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g15(.a(new_n22_), .b(x1), .c(new_n19_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n15_), .O(z8));
  nand4  g17(.a(x3), .b(new_n19_), .c(new_n24_), .d(x0), .O(z9));
  one    g18(.O(z6));
endmodule
