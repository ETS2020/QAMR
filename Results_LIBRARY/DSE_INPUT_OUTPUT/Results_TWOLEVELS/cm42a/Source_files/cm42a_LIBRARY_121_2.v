...
module FAU ( 
  ...
  nand3  g10(.a(new_n24_), .b(x2), .c(new_n15_), .O(z4));
  oai21  g11(.a(new_n24_), .b(new_n17_), .c(x0), .O(z5));
  oai21  g12(.a(new_n17_), .b(new_n16_), .c(new_n15_), .O(new_n27_));
  oai21  g13(.a(x3), .b(x0), .c(x2), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n27_), .O(z6));
  nand4  g15(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  aoi21  g16(.a(new_n17_), .b(x1), .c(new_n18_), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(x0), .c(new_n28_), .O(z8));
  nand2  g18(.a(new_n17_), .b(x0), .O(z3));
  nand2  g19(.a(new_n17_), .b(x0), .O(z9));
endmodule
