...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n29_, new_n30_, new_n33_, new_n34_, new_n36_;
  ...
  oai21  g18(.a(new_n20_), .b(x0), .c(new_n17_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(z8));
  oai21  g20(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n22_), .O(z9));
  one    g22(.O(z7));
endmodule
