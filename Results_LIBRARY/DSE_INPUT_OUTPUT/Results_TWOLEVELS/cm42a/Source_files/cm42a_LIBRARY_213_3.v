...
module FAU ( 
  ...
  nand2  g04(.a(new_n17_), .b(x0), .O(z1));
  nand2  g05(.a(x3), .b(new_n15_), .O(new_n20_));
  inv1   g06(.a(x2), .O(new_n21_));
  nand3  g07(.a(new_n21_), .b(x1), .c(new_n15_), .O(new_n22_));
  ...
  nand4  g13(.a(new_n16_), .b(x2), .c(new_n25_), .d(new_n15_), .O(z4));
  nand4  g14(.a(new_n16_), .b(x2), .c(new_n25_), .d(x0), .O(z5));
  nand4  g15(.a(new_n16_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g16(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g17(.a(x3), .b(new_n21_), .c(new_n25_), .d(new_n15_), .O(z8));
  one    g18(.O(z9));
endmodule
