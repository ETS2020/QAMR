...
module FAU ( 
  ...
  aoi22  g11(.a(x3), .b(x2), .c(x1), .d(x0), .O(new_n27_));
  nand3  g12(.a(new_n27_), .b(z0), .c(x2), .O(z6));
  nand4  g13(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  inv1   g14(.a(x2), .O(new_n30_));
  nand4  g15(.a(x3), .b(new_n30_), .c(new_n15_), .d(new_n20_), .O(z8));
  nand2  g16(.a(new_n27_), .b(new_n24_), .O(z9));
  one    g17(.O(z1));
