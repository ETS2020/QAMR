...
module FAU ( 
  ...
  nand2  g17(.a(new_n19_), .b(new_n27_), .O(new_n32_));
  nand2  g18(.a(new_n16_), .b(x1), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(z4));
  nand2  g20(.a(new_n30_), .b(new_n27_), .O(new_n35_));
  nand2  g21(.a(new_n19_), .b(x0), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(z5));
  oai21  g23(.a(new_n20_), .b(x0), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n28_), .O(z6));
  oai21  g25(.a(new_n20_), .b(new_n27_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n24_), .O(z7));
  nand4  g27(.a(x3), .b(new_n19_), .c(new_n20_), .d(new_n27_), .O(z8));
  nand4  g28(.a(x3), .b(new_n19_), .c(new_n20_), .d(x0), .O(z9));
endmodule
