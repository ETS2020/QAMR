...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n25_, new_n28_, new_n29_, new_n31_;
  ...
  aoi22  g10(.a(x3), .b(x1), .c(x2), .d(x0), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(x2), .c(x1), .O(z6));
  nand4  g12(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g13(.a(x3), .b(x1), .O(new_n28_));
  nand2  g14(.a(x2), .b(new_n19_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n18_), .O(z8));
  oai21  g16(.a(x3), .b(x2), .c(new_n19_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n25_), .O(z9));
