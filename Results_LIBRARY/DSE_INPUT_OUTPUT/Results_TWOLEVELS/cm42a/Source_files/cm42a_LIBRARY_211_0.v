...
module FAU ( 
  ...
  oai21  g02(.a(new_n16_), .b(new_n15_), .c(x1), .O(new_n17_));
  inv1   g03(.a(x1), .O(new_n18_));
  oai21  g04(.a(new_n18_), .b(x0), .c(x2), .O(new_n19_));
  nand2  g05(.a(new_n19_), .b(new_n17_), .O(z0));
  inv1   g06(.a(x3), .O(new_n21_));
  nand4  g07(.a(new_n21_), .b(new_n16_), .c(x1), .d(new_n15_), .O(z2));
  nand4  g08(.a(new_n21_), .b(new_n16_), .c(x1), .d(x0), .O(z3));
  oai21  g09(.a(x3), .b(x0), .c(x2), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n17_), .O(z4));
  nand4  g11(.a(new_n21_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  nand3  g12(.a(new_n21_), .b(x1), .c(new_n15_), .O(new_n27_));
  ...
  nand2  g18(.a(new_n19_), .b(new_n17_), .O(z1));
  nand2  g19(.a(new_n19_), .b(new_n17_), .O(z8));
  nand2  g20(.a(new_n19_), .b(new_n17_), .O(z9));
endmodule
