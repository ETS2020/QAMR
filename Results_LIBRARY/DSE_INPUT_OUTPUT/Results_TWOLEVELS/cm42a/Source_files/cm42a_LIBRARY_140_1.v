...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n23_, new_n24_,
    new_n26_, new_n27_, new_n28_, new_n31_, new_n32_, new_n34_, new_n36_;
  ...
  nand3  g11(.a(x2), .b(new_n18_), .c(new_n23_), .O(new_n26_));
  ...
  oai21  g19(.a(new_n31_), .b(new_n23_), .c(new_n19_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n28_), .O(z7));
