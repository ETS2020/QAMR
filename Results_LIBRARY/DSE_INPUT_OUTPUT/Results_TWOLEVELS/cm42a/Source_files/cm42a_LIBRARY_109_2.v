...
module FAU ( 
  ...
  nand3  g07(.a(new_n20_), .b(x2), .c(new_n23_), .O(new_n24_));
  nand2  g08(.a(new_n24_), .b(new_n19_), .O(new_n25_));
  nand2  g09(.a(x2), .b(x0), .O(new_n26_));
  nand2  g10(.a(new_n26_), .b(new_n25_), .O(z4));
  nand4  g11(.a(new_n20_), .b(x2), .c(new_n23_), .d(x0), .O(z5));
  nand4  g12(.a(new_n20_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g13(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g14(.a(new_n20_), .b(x1), .c(new_n19_), .O(new_n31_));
