...
module FAU ( 
  ...
  nand4  g10(.a(new_n24_), .b(x2), .c(new_n17_), .d(new_n15_), .O(z4));
  inv1   g11(.a(x2), .O(new_n26_));
  oai21  g12(.a(x3), .b(new_n26_), .c(new_n17_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x0), .O(z5));
  nand4  g14(.a(new_n24_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g15(.a(new_n20_), .b(x0), .c(new_n17_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(z8));
  oai21  g17(.a(new_n26_), .b(x1), .c(new_n15_), .O(new_n32_));
  oai21  g18(.a(new_n24_), .b(x2), .c(new_n17_), .O(new_n33_));
