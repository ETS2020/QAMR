...
module FAU ( 
  ...
  oai21  g07(.a(x3), .b(new_n16_), .c(new_n15_), .O(new_n22_));
  nand2  g08(.a(new_n22_), .b(new_n17_), .O(z2));
  nand2  g09(.a(new_n17_), .b(x0), .O(z3));
  oai21  g10(.a(x3), .b(x1), .c(x2), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(x2), .c(new_n15_), .O(z4));
  nand2  g12(.a(new_n25_), .b(x0), .O(z5));
  nand4  g13(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g14(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n29_));
  oai21  g15(.a(x3), .b(new_n16_), .c(x2), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z7));
  oai21  g17(.a(new_n18_), .b(x1), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n17_), .O(z8));
  nand3  g19(.a(new_n20_), .b(new_n16_), .c(new_n15_), .O(z9));
endmodule
