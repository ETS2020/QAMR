...
module FAU ( 
  ...
  oai21  g07(.a(new_n17_), .b(x1), .c(x0), .O(new_n22_));
  oai21  g08(.a(x3), .b(new_n16_), .c(new_n17_), .O(new_n23_));
  nand3  g09(.a(x2), .b(x1), .c(new_n15_), .O(new_n24_));
  ...
  nor2   g16(.a(x3), .b(x1), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(x0), .c(new_n17_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(z8));
  nand4  g19(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  nand2  g20(.a(new_n27_), .b(x2), .O(z5));
endmodule
