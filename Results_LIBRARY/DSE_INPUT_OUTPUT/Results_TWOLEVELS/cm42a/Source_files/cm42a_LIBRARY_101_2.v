...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n24_,
    new_n26_, new_n27_, new_n30_, new_n31_, new_n34_, new_n35_;
  ...
  oai21  g08(.a(x3), .b(x2), .c(x1), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(x0), .O(z3));
  oai21  g10(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n26_));
  oai21  g11(.a(x2), .b(x0), .c(x1), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n26_), .O(z4));
  nand2  g13(.a(new_n16_), .b(x0), .O(z5));
  nand3  g14(.a(new_n18_), .b(x2), .c(new_n15_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x1), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n22_), .O(z6));
  nand4  g17(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g18(.a(new_n18_), .b(x2), .c(new_n15_), .O(new_n34_));
  oai21  g19(.a(new_n17_), .b(x0), .c(x1), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n34_), .O(z8));
  one    g21(.O(z1));
  one    g22(.O(z9));
endmodule
