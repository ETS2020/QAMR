...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n23_, new_n25_,
    new_n26_, new_n27_, new_n29_, new_n33_;
  ...
  nor2   g10(.a(x3), .b(x1), .O(new_n25_));
  nor2   g11(.a(new_n17_), .b(new_n15_), .O(new_n26_));
  nand3  g12(.a(new_n18_), .b(new_n17_), .c(new_n16_), .O(new_n27_));
  oai21  g13(.a(new_n26_), .b(new_n25_), .c(new_n27_), .O(z4));
  oai21  g14(.a(new_n22_), .b(x1), .c(new_n17_), .O(new_n29_));
  ...
  oai21  g18(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x0), .O(z9));
  nand2  g20(.a(new_n29_), .b(x0), .O(z7));
endmodule
