...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n24_, new_n25_, new_n29_, new_n31_, new_n32_;
  ...
  nand4  g12(.a(new_n19_), .b(new_n22_), .c(x1), .d(x0), .O(z3));
  nand4  g13(.a(new_n19_), .b(x2), .c(new_n15_), .d(new_n18_), .O(z4));
  oai21  g14(.a(new_n22_), .b(new_n18_), .c(new_n19_), .O(new_n29_));
