...
module FAU ( 
  ...
  nand4  g07(.a(new_n16_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand2  g08(.a(x3), .b(x0), .O(new_n25_));
  nand2  g09(.a(new_n20_), .b(x1), .O(new_n26_));
  oai21  g10(.a(x3), .b(x1), .c(new_n19_), .O(new_n27_));
  nand3  g11(.a(new_n27_), .b(new_n26_), .c(new_n25_), .O(z7));
  oai21  g12(.a(x2), .b(x0), .c(x3), .O(new_n29_));
