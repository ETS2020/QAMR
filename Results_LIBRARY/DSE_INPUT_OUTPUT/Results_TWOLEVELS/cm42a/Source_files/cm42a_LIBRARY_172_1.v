...
module FAU ( 
  ...
  nand2  g05(.a(new_n18_), .b(new_n15_), .O(new_n20_));
  nor3   g06(.a(x3), .b(x2), .c(x1), .O(new_n21_));
  oai21  g07(.a(new_n21_), .b(new_n15_), .c(new_n20_), .O(z1));
  ...
  oai21  g18(.a(x3), .b(new_n16_), .c(x0), .O(new_n33_));
