...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n27_, new_n28_, new_n29_,
    new_n31_, new_n32_;
  ...
  nand3  g09(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n27_));
  nand2  g10(.a(new_n27_), .b(new_n16_), .O(new_n28_));
  nand2  g11(.a(x3), .b(x1), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n28_), .O(z8));
  nand3  g13(.a(x3), .b(new_n17_), .c(x0), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n16_), .O(new_n32_));
