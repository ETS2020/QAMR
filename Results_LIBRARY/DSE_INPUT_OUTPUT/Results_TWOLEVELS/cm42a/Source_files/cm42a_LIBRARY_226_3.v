...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n26_,
  ...
  oai21  g15(.a(new_n17_), .b(new_n16_), .c(new_n18_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n18_), .c(new_n15_), .O(z6));
