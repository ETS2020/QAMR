...
module FAU ( 
  ...
  nand4  g14(.a(new_n15_), .b(x2), .c(new_n26_), .d(new_n21_), .O(z4));
  ...
  nand4  g20(.a(new_n15_), .b(x2), .c(x1), .d(new_n21_), .O(z6));
  nand4  g21(.a(new_n15_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g22(.a(new_n22_), .b(x0), .c(new_n15_), .O(new_n37_));
  oai21  g23(.a(x2), .b(x1), .c(new_n21_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z8));
  nand2  g25(.a(new_n30_), .b(new_n37_), .O(z9));
endmodule
