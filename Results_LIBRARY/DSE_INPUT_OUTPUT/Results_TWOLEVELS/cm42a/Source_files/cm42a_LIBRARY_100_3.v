...
module FAU ( 
  ...
  oai21  g16(.a(x3), .b(x0), .c(new_n17_), .O(new_n31_));
  inv1   g17(.a(x2), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(x1), .c(new_n20_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n31_), .O(z4));
  oai21  g20(.a(x3), .b(new_n19_), .c(new_n17_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n33_), .O(z5));
  nand4  g22(.a(new_n20_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g23(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g24(.a(x2), .b(x0), .c(new_n17_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n33_), .O(z8));
  nand4  g26(.a(x3), .b(new_n32_), .c(new_n17_), .d(x0), .O(z9));
endmodule
