...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n38_, new_n39_, new_n40_;
  ...
  nand4  g20(.a(new_n20_), .b(x2), .c(new_n27_), .d(x0), .O(z5));
  nand4  g21(.a(new_n20_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g22(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g23(.a(new_n20_), .b(new_n27_), .O(new_n38_));
  nand2  g24(.a(new_n17_), .b(x0), .O(new_n39_));
  nand2  g25(.a(new_n15_), .b(x1), .O(new_n40_));
  nand3  g26(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(z8));
  nand3  g27(.a(new_n40_), .b(new_n32_), .c(new_n38_), .O(z9));
endmodule
