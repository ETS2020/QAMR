...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n26_, new_n27_, new_n30_, new_n32_, new_n35_,
    new_n37_, new_n38_;
  ...
  nand3  g07(.a(new_n18_), .b(new_n15_), .c(x0), .O(new_n22_));
  ...
  oai21  g12(.a(x3), .b(new_n15_), .c(new_n17_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n26_), .O(z2));
  nand4  g14(.a(new_n18_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  inv1   g15(.a(x0), .O(new_n30_));
  nand2  g16(.a(x2), .b(new_n30_), .O(z4));
  nand2  g17(.a(new_n19_), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(x2), .O(z5));
  nand4  g19(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g20(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(z8));
  nand3  g22(.a(x3), .b(new_n15_), .c(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n24_), .O(z9));
  nand2  g25(.a(x2), .b(new_n30_), .O(z6));
endmodule
