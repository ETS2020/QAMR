...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n23_, new_n24_,
    new_n26_, new_n28_, new_n32_, new_n34_, new_n35_;
  ...
  oai21  g11(.a(x3), .b(new_n23_), .c(new_n19_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n15_), .O(z4));
  oai21  g13(.a(new_n23_), .b(x1), .c(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n20_), .O(z5));
  nand4  g15(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g16(.a(new_n24_), .b(x2), .c(new_n19_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n15_), .O(z8));
  oai21  g18(.a(x3), .b(x2), .c(x0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n19_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n18_), .O(z9));
  one    g21(.O(z6));
endmodule
