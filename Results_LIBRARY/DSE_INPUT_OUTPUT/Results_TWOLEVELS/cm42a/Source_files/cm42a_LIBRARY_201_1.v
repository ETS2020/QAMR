...
module FAU ( 
  ...
  oai21  g14(.a(new_n17_), .b(new_n15_), .c(new_n18_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n16_), .O(z5));
  nand2  g16(.a(x2), .b(x1), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(x0), .c(new_n18_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n25_), .O(z6));
  oai21  g19(.a(new_n31_), .b(new_n15_), .c(new_n18_), .O(new_n34_));
