...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n25_, new_n26_, new_n27_,
  ...
  nand3  g14(.a(new_n28_), .b(new_n26_), .c(new_n25_), .O(z6));
  nand4  g15(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g16(.a(new_n17_), .b(x0), .O(new_n31_));
  nand2  g17(.a(new_n27_), .b(x1), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n25_), .O(z8));
  nand3  g19(.a(new_n32_), .b(new_n26_), .c(new_n25_), .O(z9));
endmodule
