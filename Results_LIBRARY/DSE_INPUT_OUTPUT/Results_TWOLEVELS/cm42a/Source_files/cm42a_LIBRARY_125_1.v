...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n20_, new_n21_, new_n25_, new_n29_,
    new_n30_, new_n31_;
  ...
  nand2  g09(.a(x2), .b(new_n15_), .O(z4));
  inv1   g10(.a(x3), .O(new_n25_));
  nand4  g11(.a(new_n25_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  nand4  g12(.a(new_n25_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g13(.a(x3), .b(new_n16_), .c(new_n20_), .d(new_n15_), .O(z8));
  nand2  g14(.a(x2), .b(x0), .O(new_n29_));
  nand3  g15(.a(x3), .b(new_n20_), .c(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n29_), .O(z9));
  nand2  g18(.a(x2), .b(new_n15_), .O(z6));
endmodule
