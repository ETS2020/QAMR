...
module FAU ( 
  ...
  oai21  g10(.a(x2), .b(new_n22_), .c(x0), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n20_), .O(z3));
  nand2  g12(.a(x2), .b(new_n15_), .O(z4));
  inv1   g13(.a(x3), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(x2), .c(new_n22_), .d(x0), .O(z5));
  oai21  g15(.a(x3), .b(new_n22_), .c(x0), .O(new_n30_));
  oai21  g16(.a(x1), .b(new_n15_), .c(new_n19_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z7));
  nand4  g18(.a(x3), .b(new_n19_), .c(new_n22_), .d(new_n15_), .O(z8));
