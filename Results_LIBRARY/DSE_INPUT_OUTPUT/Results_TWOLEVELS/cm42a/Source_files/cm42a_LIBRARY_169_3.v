...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n23_, new_n30_;
  ...
  nand2  g09(.a(new_n23_), .b(x2), .O(z3));
  ...
  oai21  g15(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x0), .O(z9));
endmodule
