...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n24_,
    new_n25_, new_n26_, new_n28_, new_n29_, new_n34_, new_n35_, new_n36_;
  ...
  nand2  g08(.a(new_n20_), .b(x1), .O(z2));
  nand2  g09(.a(x2), .b(x1), .O(new_n24_));
  nand3  g10(.a(new_n21_), .b(x2), .c(new_n17_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n15_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n24_), .O(z4));
  nand3  g13(.a(new_n21_), .b(x2), .c(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n24_), .O(z5));
  nand4  g16(.a(new_n21_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand4  g17(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g18(.a(x3), .b(new_n20_), .c(new_n15_), .d(new_n17_), .O(z8));
  oai21  g19(.a(x3), .b(x2), .c(x0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(new_n35_));
  oai21  g21(.a(x1), .b(x0), .c(x2), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(z9));
  nand2  g23(.a(new_n20_), .b(x1), .O(z3));
endmodule
