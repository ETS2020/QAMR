...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n26_, new_n27_, new_n31_, new_n33_, new_n34_,
    new_n38_, new_n39_;
  ...
  nand4  g14(.a(new_n24_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  inv1   g15(.a(x1), .O(new_n31_));
  nand2  g16(.a(x2), .b(new_n31_), .O(z5));
  oai21  g17(.a(new_n17_), .b(x1), .c(x0), .O(new_n33_));
  nand2  g18(.a(x3), .b(x1), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n33_), .c(new_n20_), .O(z6));
  nand4  g20(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g21(.a(x3), .b(new_n17_), .c(new_n31_), .d(new_n15_), .O(z8));
  oai21  g22(.a(x3), .b(x1), .c(x0), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n17_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n21_), .O(z9));
  one    g25(.O(z4));
endmodule
