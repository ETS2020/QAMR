...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n26_, new_n27_, new_n29_, new_n31_, new_n33_, new_n34_,
    new_n37_, new_n39_;
  ...
  nand3  g13(.a(new_n27_), .b(new_n26_), .c(new_n21_), .O(z3));
  oai21  g14(.a(new_n17_), .b(x1), .c(new_n18_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n27_), .c(new_n18_), .O(z4));
  nand2  g16(.a(new_n16_), .b(new_n15_), .O(new_n31_));
  nand3  g17(.a(new_n29_), .b(new_n31_), .c(new_n18_), .O(z5));
  nand2  g18(.a(new_n20_), .b(x0), .O(new_n33_));
  nand2  g19(.a(new_n18_), .b(new_n17_), .O(new_n34_));
  nand3  g20(.a(new_n31_), .b(new_n34_), .c(new_n33_), .O(z6));
  nand4  g21(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g22(.a(x2), .b(x0), .c(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n29_), .O(z8));
  oai21  g24(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n29_), .O(z9));
endmodule
