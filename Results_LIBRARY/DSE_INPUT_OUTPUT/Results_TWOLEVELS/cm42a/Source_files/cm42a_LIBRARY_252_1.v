...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    ...
    new_n36_, new_n37_, new_n39_, new_n40_, new_n41_;
  ...
  nand3  g13(.a(new_n18_), .b(x1), .c(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n17_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n26_), .O(z3));
  nand2  g16(.a(x2), .b(new_n16_), .O(z5));
  oai21  g17(.a(new_n17_), .b(x1), .c(x0), .O(new_n33_));
  nand2  g18(.a(x3), .b(x1), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n33_), .c(new_n20_), .O(z6));
  oai21  g20(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n36_));
  nand2  g21(.a(new_n17_), .b(x0), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n36_), .c(new_n34_), .O(z7));
  nand2  g23(.a(new_n37_), .b(x1), .O(new_n39_));
  nor2   g24(.a(x3), .b(x1), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x0), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z8));
  nand4  g27(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  one    g28(.O(z4));
endmodule
