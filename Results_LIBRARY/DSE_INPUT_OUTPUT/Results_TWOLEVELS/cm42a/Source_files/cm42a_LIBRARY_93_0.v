...
module FAU ( 
  ...
  oai21  g16(.a(x3), .b(new_n16_), .c(x1), .O(new_n31_));
  oai21  g17(.a(new_n15_), .b(x0), .c(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z6));
  oai21  g19(.a(new_n15_), .b(new_n19_), .c(x2), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n31_), .O(z7));
  one    g21(.O(z8));
  one    g22(.O(z9));
  nand2  g23(.a(new_n16_), .b(new_n15_), .O(z1));
endmodule
