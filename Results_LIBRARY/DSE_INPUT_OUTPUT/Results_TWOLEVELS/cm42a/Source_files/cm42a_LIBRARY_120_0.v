...
module FAU ( 
  ...
  nand4  g10(.a(new_n23_), .b(x2), .c(new_n15_), .d(new_n19_), .O(z4));
  oai21  g11(.a(new_n16_), .b(x0), .c(x1), .O(new_n26_));
  oai21  g12(.a(x3), .b(new_n19_), .c(x2), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n26_), .O(z5));
  oai21  g14(.a(x3), .b(new_n16_), .c(x1), .O(new_n29_));
  oai21  g15(.a(new_n15_), .b(x0), .c(x2), .O(new_n30_));
