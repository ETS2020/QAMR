...
module FAU ( 
  ...
  nand3  g10(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n25_));
  ...
  nand2  g15(.a(new_n21_), .b(new_n16_), .O(z3));
  nand2  g16(.a(new_n21_), .b(new_n16_), .O(z6));
  nand2  g17(.a(new_n21_), .b(new_n16_), .O(z7));
endmodule
