...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    new_n23_, new_n24_, new_n26_, new_n28_, new_n30_, new_n31_, new_n36_;
  ...
  nand2  g12(.a(x1), .b(new_n26_), .O(z2));
  nand2  g13(.a(new_n19_), .b(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x1), .O(z3));
  oai21  g15(.a(x2), .b(x1), .c(x0), .O(new_n30_));
  oai21  g16(.a(x3), .b(new_n15_), .c(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z4));
  nand4  g18(.a(new_n18_), .b(x2), .c(new_n17_), .d(x0), .O(z5));
  nand4  g19(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g20(.a(new_n18_), .b(x2), .c(new_n17_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n16_), .O(z8));
  nand3  g22(.a(new_n36_), .b(new_n24_), .c(x0), .O(z9));
  one    g23(.O(z6));
endmodule
