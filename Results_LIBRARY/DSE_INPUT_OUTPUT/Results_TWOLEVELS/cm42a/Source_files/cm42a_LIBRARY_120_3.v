...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n28_, new_n29_, new_n31_, new_n34_,
    new_n35_, new_n37_, new_n38_, new_n41_, new_n42_, new_n43_;
  ...
  nand4  g17(.a(new_n31_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand4  g18(.a(new_n31_), .b(x2), .c(new_n26_), .d(new_n19_), .O(z4));
  nand2  g19(.a(x3), .b(new_n26_), .O(new_n34_));
  nand2  g20(.a(new_n17_), .b(x0), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n34_), .c(new_n23_), .O(z5));
  inv1   g22(.a(z6), .O(new_n37_));
  nand2  g23(.a(x2), .b(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z7));
  nand3  g25(.a(new_n28_), .b(new_n16_), .c(new_n26_), .O(z8));
  oai21  g26(.a(new_n17_), .b(new_n19_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n26_), .O(new_n42_));
  nand2  g28(.a(new_n17_), .b(x1), .O(new_n43_));
  nand3  g29(.a(new_n43_), .b(new_n42_), .c(new_n23_), .O(z9));
endmodule
