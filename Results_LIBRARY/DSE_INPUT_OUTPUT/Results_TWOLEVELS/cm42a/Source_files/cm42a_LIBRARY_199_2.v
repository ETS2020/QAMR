...
module FAU ( 
  ...
  nor2   g20(.a(x3), .b(x2), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(x0), .c(new_n16_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n17_), .O(z8));
  oai21  g23(.a(new_n36_), .b(new_n15_), .c(new_n16_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n17_), .O(z9));
  one    g25(.O(z2));
endmodule
