...
module FAU ( 
  ...
  nand2  g14(.a(new_n17_), .b(new_n19_), .O(new_n29_));
  nand3  g15(.a(new_n20_), .b(x2), .c(x1), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n29_), .c(new_n16_), .O(z4));
  nand2  g17(.a(new_n15_), .b(new_n19_), .O(new_n32_));
  nand2  g18(.a(new_n17_), .b(x0), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n30_), .c(new_n32_), .O(z5));
  nand4  g20(.a(new_n20_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand2  g21(.a(new_n20_), .b(new_n23_), .O(new_n36_));
  nand3  g22(.a(new_n33_), .b(new_n32_), .c(new_n36_), .O(z7));
  nand2  g23(.a(new_n15_), .b(x1), .O(new_n38_));
  nand3  g24(.a(new_n38_), .b(new_n33_), .c(new_n36_), .O(z8));
  nand4  g25(.a(x3), .b(new_n17_), .c(new_n23_), .d(x0), .O(z9));
endmodule
