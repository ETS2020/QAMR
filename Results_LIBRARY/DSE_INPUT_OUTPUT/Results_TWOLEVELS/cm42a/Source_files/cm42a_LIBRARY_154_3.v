...
module FAU ( 
  ...
  oai21  g15(.a(new_n16_), .b(new_n19_), .c(x0), .O(new_n30_));
  nand2  g16(.a(new_n19_), .b(new_n27_), .O(new_n31_));
  nand2  g17(.a(new_n16_), .b(x1), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(z4));
  nand4  g19(.a(new_n16_), .b(x2), .c(new_n20_), .d(x0), .O(z5));
  ...
  nand4  g23(.a(x3), .b(new_n19_), .c(new_n20_), .d(new_n27_), .O(z8));
  oai21  g24(.a(x1), .b(new_n27_), .c(new_n19_), .O(new_n39_));
