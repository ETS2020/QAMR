...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n20_, new_n22_, new_n26_, new_n27_,
    new_n28_;
  ...
  nand4  g08(.a(new_n20_), .b(x2), .c(new_n22_), .d(new_n15_), .O(z4));
  nand4  g09(.a(new_n20_), .b(x2), .c(new_n22_), .d(x0), .O(z5));
