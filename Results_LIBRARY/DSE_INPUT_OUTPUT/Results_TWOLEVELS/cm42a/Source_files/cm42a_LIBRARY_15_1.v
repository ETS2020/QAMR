...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n26_, new_n28_, new_n33_, new_n34_, new_n36_,
    new_n38_, new_n39_;
  ...
  nand4  g14(.a(new_n28_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand2  g15(.a(x2), .b(new_n25_), .O(z4));
  nand4  g16(.a(new_n28_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g17(.a(new_n17_), .b(x0), .O(new_n33_));
  nand2  g18(.a(x3), .b(x1), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n20_), .c(new_n33_), .O(z7));
  oai21  g20(.a(new_n28_), .b(x0), .c(new_n17_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n16_), .O(z8));
  oai21  g22(.a(x1), .b(x0), .c(x3), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n17_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n24_), .O(z9));
  one    g25(.O(z5));
endmodule
