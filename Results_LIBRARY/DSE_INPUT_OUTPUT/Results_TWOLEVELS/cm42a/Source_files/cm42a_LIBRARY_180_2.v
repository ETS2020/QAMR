...
module FAU ( 
  ...
  oai21  g11(.a(new_n24_), .b(new_n15_), .c(new_n16_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n18_), .O(z5));
  nand3  g13(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n29_));
  ...
  nand2  g19(.a(new_n34_), .b(new_n31_), .O(z9));
  one    g20(.O(z3));
  nand2  g21(.a(new_n18_), .b(x1), .O(z6));
  nand2  g22(.a(new_n18_), .b(x1), .O(z7));
endmodule
