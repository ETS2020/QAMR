...
module FAU ( 
  ...
  oai21  g14(.a(new_n22_), .b(x0), .c(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n25_), .O(z6));
  oai21  g16(.a(new_n15_), .b(x1), .c(new_n19_), .O(new_n31_));
  oai21  g17(.a(x3), .b(new_n22_), .c(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z7));
  nand4  g19(.a(x3), .b(new_n15_), .c(new_n22_), .d(new_n19_), .O(z8));
