...
module FAU ( 
  ...
  oai21  g07(.a(new_n21_), .b(x0), .c(new_n17_), .O(z2));
  nand3  g08(.a(new_n21_), .b(new_n16_), .c(new_n15_), .O(z3));
  ...
  nand3  g13(.a(new_n18_), .b(x1), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n27_), .O(z6));
  oai21  g16(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n31_));
  oai21  g17(.a(x3), .b(new_n16_), .c(x2), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z7));
  nand4  g19(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand3  g20(.a(new_n21_), .b(new_n16_), .c(new_n15_), .O(z9));
endmodule
