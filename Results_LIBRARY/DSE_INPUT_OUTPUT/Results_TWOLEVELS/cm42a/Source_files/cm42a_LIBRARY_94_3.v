...
module FAU ( 
  ...
  nand4  g14(.a(new_n29_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g15(.a(new_n20_), .b(x0), .c(new_n17_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n16_), .O(z8));
  oai21  g17(.a(new_n29_), .b(x2), .c(new_n17_), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(new_n25_), .O(z9));
  one    g19(.O(z3));
  one    g20(.O(z7));
endmodule
