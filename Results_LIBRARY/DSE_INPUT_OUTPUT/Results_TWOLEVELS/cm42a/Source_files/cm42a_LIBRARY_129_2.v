...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n23_, new_n24_, new_n27_,
    new_n28_, new_n29_, new_n31_, new_n32_, new_n33_, new_n35_;
  ...
  oai21  g17(.a(x2), .b(new_n16_), .c(x0), .O(new_n32_));
  nand3  g18(.a(new_n18_), .b(new_n17_), .c(new_n16_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(z8));
  nand2  g20(.a(x2), .b(x0), .O(new_n35_));
  nand3  g21(.a(new_n33_), .b(new_n28_), .c(new_n35_), .O(z9));
  nand2  g22(.a(new_n17_), .b(x1), .O(z3));
endmodule
