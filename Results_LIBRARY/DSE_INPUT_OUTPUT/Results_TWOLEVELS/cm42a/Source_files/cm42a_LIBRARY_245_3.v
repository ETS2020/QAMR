...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n29_, new_n30_, new_n33_, new_n34_, new_n36_;
  ...
  nand4  g10(.a(new_n24_), .b(new_n21_), .c(x1), .d(new_n16_), .O(z2));
  nand4  g11(.a(new_n24_), .b(new_n21_), .c(x1), .d(x0), .O(z3));
  nand4  g12(.a(new_n24_), .b(x2), .c(new_n19_), .d(new_n16_), .O(z4));
  oai21  g13(.a(x3), .b(new_n19_), .c(new_n16_), .O(new_n29_));
  oai21  g14(.a(x1), .b(x0), .c(new_n21_), .O(new_n30_));
  ...
  oai21  g20(.a(new_n24_), .b(x1), .c(new_n21_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n20_), .O(z9));
  one    g22(.O(z5));
endmodule
