...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n25_,
    new_n26_, new_n27_, new_n32_, new_n34_, new_n35_;
  ...
  oai21  g17(.a(x2), .b(x0), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n21_), .O(z8));
  oai21  g19(.a(x1), .b(x0), .c(new_n18_), .O(new_n34_));
