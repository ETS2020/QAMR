...
module FAU ( 
  ...
  oai21  g07(.a(new_n21_), .b(x2), .c(new_n20_), .O(z1));
  nor3   g08(.a(x3), .b(x2), .c(x0), .O(new_n23_));
  nand2  g09(.a(new_n17_), .b(new_n16_), .O(new_n24_));
  oai21  g10(.a(new_n23_), .b(new_n16_), .c(new_n24_), .O(z2));
  nand4  g11(.a(new_n18_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  nand2  g12(.a(x2), .b(new_n16_), .O(z4));
  nand4  g13(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g14(.a(x3), .b(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n17_), .O(new_n30_));
  oai21  g16(.a(new_n21_), .b(new_n16_), .c(new_n30_), .O(z7));
  nand4  g17(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand4  g18(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  nand2  g19(.a(x2), .b(new_n16_), .O(z5));
endmodule
