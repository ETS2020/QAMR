...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n27_, new_n28_, new_n32_, new_n34_;
  ...
  nand3  g10(.a(new_n18_), .b(x2), .c(x1), .O(new_n25_));
  ...
  nand3  g18(.a(new_n24_), .b(new_n32_), .c(new_n23_), .O(z7));
  oai21  g19(.a(x2), .b(x0), .c(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n28_), .O(z8));
