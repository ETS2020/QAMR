...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n27_, new_n28_;
  ...
  oai21  g11(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n27_));
  oai21  g12(.a(x3), .b(new_n17_), .c(x0), .O(new_n28_));
