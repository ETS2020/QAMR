...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n23_, new_n27_,
    new_n28_, new_n29_;
  ...
  oai21  g13(.a(new_n27_), .b(x0), .c(new_n18_), .O(new_n28_));
  nand2  g14(.a(x3), .b(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z6));
  nand4  g16(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g17(.a(x3), .b(new_n17_), .O(z8));
  nand2  g18(.a(x3), .b(new_n17_), .O(z9));
endmodule
