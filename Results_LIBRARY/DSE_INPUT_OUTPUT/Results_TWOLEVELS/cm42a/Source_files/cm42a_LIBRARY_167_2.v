...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n26_, new_n29_;
  ...
  oai21  g10(.a(x3), .b(new_n15_), .c(x2), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(x1), .O(z7));
  nand4  g12(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g13(.a(new_n18_), .b(new_n15_), .c(new_n16_), .O(new_n29_));
