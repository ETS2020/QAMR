...
module FAU ( 
  ...
  nand3  g07(.a(new_n21_), .b(x1), .c(new_n15_), .O(z2));
  ...
  oai21  g13(.a(new_n17_), .b(x0), .c(new_n18_), .O(new_n28_));
  ...
  oai21  g17(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n25_), .O(z9));
endmodule
