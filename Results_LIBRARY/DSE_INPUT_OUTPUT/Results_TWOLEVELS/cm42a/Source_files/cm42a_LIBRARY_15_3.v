...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n28_, new_n29_, new_n31_, new_n33_,
    new_n34_, new_n37_, new_n38_, new_n40_, new_n42_, new_n43_;
  ...
  nand2  g18(.a(new_n17_), .b(new_n19_), .O(new_n33_));
  nand2  g19(.a(x3), .b(new_n26_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n16_), .O(z4));
  nand4  g21(.a(new_n31_), .b(x2), .c(new_n26_), .d(x0), .O(z5));
  inv1   g22(.a(z7), .O(new_n37_));
  nand2  g23(.a(x2), .b(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z6));
  nand2  g25(.a(new_n17_), .b(x1), .O(new_n40_));
  nand3  g26(.a(new_n40_), .b(new_n28_), .c(new_n16_), .O(z8));
  oai21  g27(.a(new_n17_), .b(new_n19_), .c(x3), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n26_), .O(new_n43_));
  nand3  g29(.a(new_n40_), .b(new_n43_), .c(new_n23_), .O(z9));
endmodule
