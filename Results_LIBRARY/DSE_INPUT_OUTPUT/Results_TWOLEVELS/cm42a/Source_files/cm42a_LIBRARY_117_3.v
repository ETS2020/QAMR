...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n29_, new_n30_, new_n31_, new_n35_;
  ...
  nand2  g15(.a(new_n18_), .b(new_n17_), .O(new_n30_));
  nand2  g16(.a(new_n22_), .b(x0), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n30_), .c(new_n29_), .O(z6));
