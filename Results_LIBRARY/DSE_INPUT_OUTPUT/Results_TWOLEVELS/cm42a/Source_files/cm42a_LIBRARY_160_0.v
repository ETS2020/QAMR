...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n22_, new_n23_, new_n27_;
  ...
  oai21  g07(.a(new_n16_), .b(new_n18_), .c(x0), .O(new_n22_));
  oai21  g08(.a(x3), .b(x1), .c(x2), .O(new_n23_));
  nand2  g09(.a(new_n23_), .b(new_n22_), .O(z4));
  nand3  g10(.a(new_n23_), .b(x2), .c(x0), .O(z5));
  nand4  g11(.a(new_n19_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g12(.a(x3), .b(new_n15_), .c(x2), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n22_), .O(z7));
  nand4  g14(.a(x3), .b(new_n16_), .c(new_n18_), .d(x0), .O(z9));
