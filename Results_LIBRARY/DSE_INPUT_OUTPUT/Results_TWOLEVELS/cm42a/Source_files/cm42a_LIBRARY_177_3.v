...
module FAU ( 
  ...
  nand2  g13(.a(x3), .b(new_n16_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n26_), .O(z5));
  nand2  g15(.a(new_n17_), .b(x1), .O(new_n32_));
  nand3  g16(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n16_), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(new_n32_), .O(z8));
