...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n25_, new_n26_, new_n27_, new_n31_, new_n32_, new_n33_;
  ...
  oai21  g10(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n25_));
  ...
  nand3  g19(.a(new_n33_), .b(new_n27_), .c(new_n31_), .O(z6));
  nand4  g20(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g21(.a(x3), .b(new_n16_), .O(z8));
  nand2  g22(.a(x3), .b(new_n16_), .O(z9));
endmodule
