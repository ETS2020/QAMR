...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n26_, new_n28_, new_n29_, new_n33_;
  inv1   g00(.a(x0), .O(new_n15_));
  inv1   g01(.a(x1), .O(new_n16_));
  inv1   g02(.a(x2), .O(new_n17_));
  inv1   g03(.a(x3), .O(new_n18_));
  nand4  g04(.a(new_n18_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z0));
  nand3  g05(.a(new_n17_), .b(new_n16_), .c(x0), .O(new_n20_));
  ...
  oai21  g10(.a(new_n18_), .b(new_n16_), .c(x0), .O(new_n25_));
  nand2  g11(.a(new_n16_), .b(new_n15_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(new_n24_), .O(z2));
  oai21  g13(.a(new_n18_), .b(new_n16_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n16_), .b(x0), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n24_), .O(z3));
  nand4  g16(.a(new_n18_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g17(.a(new_n18_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand2  g18(.a(new_n18_), .b(new_n17_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n26_), .c(new_n25_), .O(z6));
  nand3  g20(.a(new_n33_), .b(new_n29_), .c(new_n28_), .O(z7));
  nand4  g21(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
