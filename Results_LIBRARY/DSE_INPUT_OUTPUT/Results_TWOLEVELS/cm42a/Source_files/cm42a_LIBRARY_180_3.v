...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n26_, new_n27_, new_n30_, new_n31_, new_n33_,
  ...
  oai21  g15(.a(x3), .b(x0), .c(new_n16_), .O(new_n30_));
  oai21  g16(.a(new_n17_), .b(x1), .c(new_n18_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z4));
  oai21  g18(.a(x3), .b(new_n15_), .c(new_n16_), .O(new_n33_));
  ...
  nand3  g23(.a(new_n37_), .b(new_n35_), .c(new_n21_), .O(z7));
  oai21  g24(.a(x2), .b(x0), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n31_), .O(z8));
  oai21  g26(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n31_), .O(z9));
endmodule
