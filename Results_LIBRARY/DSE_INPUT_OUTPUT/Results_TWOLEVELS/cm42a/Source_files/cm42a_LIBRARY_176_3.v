...
module FAU ( 
  ...
  nand4  g11(.a(new_n20_), .b(x2), .c(new_n15_), .d(new_n22_), .O(z4));
  oai21  g12(.a(new_n20_), .b(x1), .c(new_n17_), .O(new_n27_));
  oai21  g13(.a(x3), .b(new_n22_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n27_), .O(z5));
  oai21  g15(.a(new_n20_), .b(x2), .c(new_n15_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n18_), .O(z8));
  oai21  g17(.a(x2), .b(new_n22_), .c(new_n15_), .O(new_n34_));
