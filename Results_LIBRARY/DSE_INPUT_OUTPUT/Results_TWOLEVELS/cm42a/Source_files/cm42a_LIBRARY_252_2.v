...
module FAU ( 
  ...
  oai21  g10(.a(x1), .b(new_n15_), .c(x2), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z5));
  oai21  g12(.a(x2), .b(new_n16_), .c(x0), .O(new_n27_));
  nand2  g13(.a(new_n16_), .b(new_n15_), .O(new_n28_));
  nand2  g14(.a(x3), .b(x2), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n27_), .O(z6));
  nand2  g16(.a(z2), .b(new_n15_), .O(new_n31_));
