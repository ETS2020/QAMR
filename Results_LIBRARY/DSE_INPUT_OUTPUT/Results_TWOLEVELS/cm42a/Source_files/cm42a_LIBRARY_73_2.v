...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n23_, new_n25_,
    new_n26_, new_n27_, new_n29_, new_n30_, new_n32_, new_n36_, new_n37_;
  ...
  oai21  g10(.a(x2), .b(new_n19_), .c(x0), .O(new_n25_));
  oai21  g11(.a(x3), .b(new_n15_), .c(new_n19_), .O(new_n26_));
  nand3  g12(.a(x2), .b(x1), .c(new_n18_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n26_), .c(new_n25_), .O(z4));
  oai21  g14(.a(x2), .b(new_n19_), .c(new_n18_), .O(new_n29_));
  nand3  g15(.a(x2), .b(x1), .c(x0), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n29_), .c(new_n26_), .O(z5));
  inv1   g17(.a(x3), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(x2), .c(x1), .d(new_n18_), .O(z6));
  nand4  g19(.a(new_n32_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g20(.a(x3), .b(new_n15_), .c(new_n19_), .d(new_n18_), .O(z8));
  oai21  g21(.a(x3), .b(x2), .c(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n19_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(z9));
endmodule
