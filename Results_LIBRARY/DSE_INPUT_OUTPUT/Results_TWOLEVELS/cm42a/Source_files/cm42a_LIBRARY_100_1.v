...
module FAU ( 
  ...
  oai21  g15(.a(new_n22_), .b(x0), .c(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z4));
  oai21  g17(.a(new_n22_), .b(new_n18_), .c(new_n19_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n15_), .O(z5));
  nand3  g19(.a(new_n30_), .b(new_n25_), .c(x1), .O(z6));
  nand3  g20(.a(new_n32_), .b(new_n25_), .c(x1), .O(z7));
