...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n34_, new_n36_;
  ...
  nand3  g17(.a(new_n29_), .b(new_n31_), .c(new_n21_), .O(z5));
  nand4  g18(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand2  g19(.a(new_n18_), .b(new_n16_), .O(new_n34_));
  nand3  g20(.a(new_n31_), .b(new_n34_), .c(new_n21_), .O(z7));
  nand2  g21(.a(new_n20_), .b(x1), .O(new_n36_));
  nand3  g22(.a(new_n36_), .b(new_n31_), .c(new_n34_), .O(z8));
  nand3  g23(.a(new_n36_), .b(new_n28_), .c(new_n34_), .O(z9));
endmodule
