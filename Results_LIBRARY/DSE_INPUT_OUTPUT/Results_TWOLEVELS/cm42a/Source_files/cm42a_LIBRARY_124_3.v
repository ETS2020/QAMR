...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n23_, new_n24_, new_n25_,
    new_n26_, new_n31_, new_n32_, new_n33_, new_n35_;
  ...
  oai21  g07(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n23_));
  ...
  nand3  g16(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z8));
  oai21  g19(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n23_), .O(z9));
  one    g21(.O(z3));
endmodule
