...
module FAU ( 
  ...
  nor2   g10(.a(new_n17_), .b(x0), .O(new_n25_));
  ...
  oai21  g14(.a(new_n18_), .b(new_n16_), .c(new_n17_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z7));
  nand4  g16(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g17(.a(x2), .b(x0), .c(x1), .O(new_n32_));
  oai21  g18(.a(new_n18_), .b(new_n15_), .c(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z9));
  nand2  g20(.a(new_n25_), .b(new_n17_), .O(z5));
endmodule
