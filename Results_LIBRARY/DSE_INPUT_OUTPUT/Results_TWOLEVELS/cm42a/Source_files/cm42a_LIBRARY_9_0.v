...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n21_;
  ...
  nand4  g07(.a(new_n21_), .b(new_n20_), .c(x1), .d(x0), .O(z3));
  nand4  g08(.a(new_n21_), .b(x2), .c(new_n16_), .d(x0), .O(z5));
  nand4  g09(.a(new_n21_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g10(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g11(.a(new_n16_), .b(new_n19_), .O(z8));
