...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n26_;
  ...
  oai21  g09(.a(x3), .b(new_n16_), .c(x2), .O(new_n26_));
  nand2  g10(.a(new_n26_), .b(x0), .O(z7));
  nand4  g11(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand2  g12(.a(new_n17_), .b(x0), .O(z9));
  one    g13(.O(z1));
  one    g14(.O(z3));
endmodule
