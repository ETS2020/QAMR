...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n24_,
    new_n25_, new_n27_, new_n30_, new_n32_, new_n33_, new_n36_;
  ...
  oai21  g07(.a(x2), .b(new_n18_), .c(new_n20_), .O(new_n22_));
  nand2  g08(.a(new_n22_), .b(new_n15_), .O(z2));
  oai21  g09(.a(x3), .b(x2), .c(x0), .O(new_n24_));
  oai21  g10(.a(new_n18_), .b(new_n15_), .c(new_n20_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z3));
  aoi21  g12(.a(x1), .b(new_n15_), .c(new_n19_), .O(new_n27_));
  oai21  g13(.a(new_n27_), .b(x3), .c(new_n15_), .O(z4));
  nand4  g14(.a(new_n20_), .b(x2), .c(new_n18_), .d(x0), .O(z5));
  oai21  g15(.a(new_n19_), .b(new_n18_), .c(new_n20_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n24_), .O(z6));
  nand3  g17(.a(x2), .b(x1), .c(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n20_), .O(new_n33_));
  oai21  g19(.a(new_n20_), .b(new_n15_), .c(new_n33_), .O(z7));
