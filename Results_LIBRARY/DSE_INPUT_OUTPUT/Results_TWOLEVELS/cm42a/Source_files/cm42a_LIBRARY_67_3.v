...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n23_,
    new_n25_, new_n27_, new_n30_, new_n31_, new_n33_, new_n35_;
  ...
  oai21  g18(.a(new_n27_), .b(x0), .c(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n16_), .O(z8));
  oai21  g20(.a(new_n21_), .b(x1), .c(new_n17_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n23_), .O(z9));
  nand2  g22(.a(x2), .b(x0), .O(z7));
endmodule
