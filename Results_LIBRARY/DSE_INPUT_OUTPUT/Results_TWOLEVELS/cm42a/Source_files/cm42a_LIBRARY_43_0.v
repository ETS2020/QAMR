...
module FAU ( 
  ...
  nand2  g12(.a(x3), .b(new_n18_), .O(new_n27_));
  nand2  g13(.a(new_n19_), .b(x1), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n26_), .O(z6));
  nand4  g15(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g16(.a(x2), .b(x0), .c(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n15_), .O(z8));
  nand4  g18(.a(x3), .b(new_n19_), .c(new_n15_), .d(x0), .O(z9));
  nand2  g19(.a(new_n16_), .b(new_n15_), .O(z1));
  nand2  g20(.a(new_n24_), .b(new_n15_), .O(z5));
endmodule
