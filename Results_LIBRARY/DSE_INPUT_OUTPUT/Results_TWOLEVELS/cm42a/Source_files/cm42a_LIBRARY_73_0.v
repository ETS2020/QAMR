...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(new_n16_), .c(x1), .d(x0), .O(z3));
  oai21  g10(.a(new_n16_), .b(new_n19_), .c(x1), .O(new_n25_));
  oai21  g11(.a(x3), .b(x0), .c(x2), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n25_), .O(z4));
  oai21  g13(.a(new_n16_), .b(x0), .c(x1), .O(new_n28_));
  oai21  g14(.a(x3), .b(new_n19_), .c(x2), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z5));
  nand4  g16(.a(new_n23_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g17(.a(new_n23_), .b(x2), .c(x1), .d(x0), .O(z7));
  one    g18(.O(z8));
  nand2  g19(.a(new_n16_), .b(new_n15_), .O(z1));
  nand2  g20(.a(new_n16_), .b(new_n15_), .O(z9));
endmodule
