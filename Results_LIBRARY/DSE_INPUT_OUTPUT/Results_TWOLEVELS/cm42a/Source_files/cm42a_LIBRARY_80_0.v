...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_, new_n24_,
    new_n25_, new_n28_, new_n29_, new_n32_, new_n33_;
  ...
  nand3  g13(.a(new_n29_), .b(new_n21_), .c(new_n19_), .O(z6));
  nand3  g14(.a(new_n29_), .b(new_n25_), .c(new_n24_), .O(z7));
  nand2  g15(.a(x1), .b(new_n20_), .O(new_n32_));
  nand2  g16(.a(x3), .b(x2), .O(new_n33_));
  nand3  g17(.a(new_n33_), .b(new_n32_), .c(new_n19_), .O(z8));
  nand4  g18(.a(x3), .b(new_n28_), .c(new_n16_), .d(x0), .O(z9));
  one    g19(.O(z0));
  one    g20(.O(z4));
  nand2  g21(.a(new_n17_), .b(new_n16_), .O(z5));
endmodule
