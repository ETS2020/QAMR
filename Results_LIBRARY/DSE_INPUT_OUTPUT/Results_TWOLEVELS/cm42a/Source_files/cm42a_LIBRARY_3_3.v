...
module FAU ( 
  ...
  oai21  g10(.a(new_n19_), .b(x1), .c(new_n15_), .O(new_n25_));
  ...
  oai21  g15(.a(x2), .b(x1), .c(new_n15_), .O(new_n30_));
  oai21  g16(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z8));
  nand4  g18(.a(x3), .b(new_n19_), .c(new_n16_), .d(x0), .O(z9));
  nand2  g19(.a(new_n23_), .b(new_n15_), .O(z7));
endmodule
