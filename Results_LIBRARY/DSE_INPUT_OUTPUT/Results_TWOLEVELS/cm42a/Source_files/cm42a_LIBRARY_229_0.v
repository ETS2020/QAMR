...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n24_, new_n25_, new_n26_,
    new_n28_, new_n29_, new_n30_, new_n32_;
  ...
  nand4  g07(.a(new_n16_), .b(x2), .c(x1), .d(new_n18_), .O(z6));
  nand2  g08(.a(new_n19_), .b(x1), .O(new_n24_));
  nand2  g09(.a(x3), .b(x0), .O(new_n25_));
  oai21  g10(.a(x3), .b(x1), .c(new_n18_), .O(new_n26_));
  nand3  g11(.a(new_n26_), .b(new_n25_), .c(new_n24_), .O(z7));
  nand2  g12(.a(x1), .b(new_n18_), .O(new_n28_));
  nand2  g13(.a(x3), .b(x2), .O(new_n29_));
  oai21  g14(.a(x3), .b(x1), .c(x0), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n29_), .c(new_n28_), .O(z8));
  nand2  g16(.a(x1), .b(x0), .O(new_n32_));
  nand3  g17(.a(new_n26_), .b(new_n29_), .c(new_n32_), .O(z9));
  one    g18(.O(z5));
