...
module FAU ( 
  ...
  oai21  g13(.a(new_n16_), .b(new_n29_), .c(x2), .O(z6));
  nand4  g14(.a(new_n24_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g15(.a(new_n24_), .b(new_n15_), .O(new_n32_));
  oai21  g16(.a(new_n15_), .b(x1), .c(x0), .O(new_n33_));
