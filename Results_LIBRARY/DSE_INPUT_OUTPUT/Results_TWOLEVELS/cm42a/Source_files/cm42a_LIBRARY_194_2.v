...
module FAU ( 
  ...
  oai21  g10(.a(x3), .b(new_n17_), .c(x1), .O(new_n27_));
  nand3  g11(.a(new_n27_), .b(x1), .c(new_n15_), .O(z6));
  oai21  g12(.a(x2), .b(new_n16_), .c(new_n15_), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(new_n27_), .O(z7));
