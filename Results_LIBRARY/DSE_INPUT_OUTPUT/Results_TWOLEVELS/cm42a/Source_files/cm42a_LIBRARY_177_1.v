...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n27_;
  ...
  nand3  g08(.a(new_n20_), .b(x1), .c(x0), .O(z3));
  nand2  g09(.a(x2), .b(new_n16_), .O(z4));
  nand4  g10(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g11(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g12(.a(new_n18_), .b(x0), .c(new_n17_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n16_), .O(z8));
  nand4  g14(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  nand2  g15(.a(x2), .b(new_n16_), .O(z5));
endmodule
