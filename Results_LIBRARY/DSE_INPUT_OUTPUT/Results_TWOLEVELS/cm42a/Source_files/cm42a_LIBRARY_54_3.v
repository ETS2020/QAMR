...
module FAU ( 
  ...
  nand4  g09(.a(new_n20_), .b(new_n19_), .c(x1), .d(x0), .O(z3));
  ...
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n26_), .O(z5));
  nand4  g16(.a(new_n20_), .b(x2), .c(x1), .d(new_n22_), .O(z6));
  nand2  g17(.a(new_n20_), .b(new_n18_), .O(new_n32_));
  nand3  g18(.a(new_n29_), .b(new_n28_), .c(new_n32_), .O(z7));
  nand4  g19(.a(x3), .b(new_n19_), .c(new_n18_), .d(new_n22_), .O(z8));
