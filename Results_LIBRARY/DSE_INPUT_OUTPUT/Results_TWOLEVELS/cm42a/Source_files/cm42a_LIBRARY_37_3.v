...
module FAU ( 
  ...
  oai21  g12(.a(x1), .b(x0), .c(new_n21_), .O(new_n27_));
  inv1   g13(.a(x1), .O(new_n28_));
  oai21  g14(.a(x3), .b(new_n28_), .c(new_n20_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n27_), .O(z6));
  nand4  g16(.a(x3), .b(new_n21_), .c(new_n28_), .d(new_n20_), .O(z8));
  oai21  g17(.a(x2), .b(new_n28_), .c(new_n20_), .O(new_n32_));
  oai21  g18(.a(new_n22_), .b(x1), .c(new_n21_), .O(new_n33_));
