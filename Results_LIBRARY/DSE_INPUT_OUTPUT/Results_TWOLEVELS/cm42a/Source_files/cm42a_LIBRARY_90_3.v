...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n23_, new_n29_, new_n30_,
    new_n31_, new_n32_;
  ...
  nor2   g08(.a(x1), .b(x0), .O(new_n23_));
  oai21  g09(.a(new_n23_), .b(x3), .c(x2), .O(z4));
  ...
  nand2  g15(.a(new_n17_), .b(new_n15_), .O(new_n30_));
  nand2  g16(.a(x3), .b(x2), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n30_), .c(new_n29_), .O(z9));
endmodule
