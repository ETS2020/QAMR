...
module FAU ( 
  ...
  oai21  g10(.a(x3), .b(new_n22_), .c(new_n24_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n15_), .O(z4));
  oai21  g12(.a(new_n22_), .b(x1), .c(x0), .O(new_n27_));
  oai21  g13(.a(x3), .b(new_n15_), .c(new_n24_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n27_), .O(z5));
  nand4  g15(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g16(.a(x3), .b(new_n22_), .c(new_n24_), .d(new_n15_), .O(z8));
