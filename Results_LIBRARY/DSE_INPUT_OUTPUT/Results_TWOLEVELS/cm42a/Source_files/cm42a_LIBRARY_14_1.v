...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n22_, new_n23_,
    new_n25_, new_n28_, new_n29_, new_n30_, new_n32_, new_n33_, new_n35_;
  ...
  oai21  g20(.a(new_n32_), .b(new_n18_), .c(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n28_), .O(z7));
