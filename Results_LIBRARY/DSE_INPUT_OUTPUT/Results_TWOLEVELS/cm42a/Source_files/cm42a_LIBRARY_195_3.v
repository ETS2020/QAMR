...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(new_n19_), .c(new_n16_), .O(z2));
  oai21  g10(.a(new_n23_), .b(x3), .c(x0), .O(z3));
  nand3  g11(.a(x2), .b(new_n22_), .c(new_n16_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n19_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n17_), .O(z4));
  inv1   g14(.a(x2), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(x1), .c(new_n19_), .O(new_n30_));
  ...
  nand2  g20(.a(new_n32_), .b(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x0), .O(z7));
  oai21  g22(.a(new_n20_), .b(x0), .c(x3), .O(z8));
  one    g23(.O(z9));
endmodule
