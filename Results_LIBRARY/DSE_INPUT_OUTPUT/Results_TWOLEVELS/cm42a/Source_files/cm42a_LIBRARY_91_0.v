...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n24_, new_n26_,
    new_n27_, new_n29_, new_n31_, new_n32_, new_n33_;
  ...
  nand4  g07(.a(new_n18_), .b(new_n21_), .c(x1), .d(x0), .O(z3));
  nand2  g08(.a(new_n18_), .b(new_n15_), .O(z4));
  oai21  g09(.a(new_n21_), .b(x1), .c(x0), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n18_), .O(z5));
  oai21  g11(.a(x3), .b(x1), .c(x2), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n18_), .O(z7));
  inv1   g14(.a(x1), .O(new_n29_));
  nand4  g15(.a(x3), .b(new_n21_), .c(new_n29_), .d(new_n15_), .O(z8));
  nand3  g16(.a(x3), .b(new_n21_), .c(new_n29_), .O(new_n31_));
