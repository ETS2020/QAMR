...
module FAU ( 
  ...
  oai21  g12(.a(x2), .b(new_n26_), .c(new_n20_), .O(new_n27_));
  nand2  g13(.a(new_n17_), .b(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n20_), .O(z2));
  oai21  g15(.a(x3), .b(new_n19_), .c(new_n17_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n27_), .O(z3));
  nand2  g17(.a(new_n17_), .b(new_n19_), .O(new_n32_));
  nand3  g18(.a(new_n20_), .b(x2), .c(x1), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n32_), .c(new_n16_), .O(z4));
  nand3  g20(.a(new_n33_), .b(new_n28_), .c(new_n23_), .O(z5));
  nand4  g21(.a(new_n20_), .b(x2), .c(x1), .d(new_n19_), .O(z6));
  nand4  g22(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g23(.a(new_n20_), .b(new_n26_), .O(new_n38_));
  nand2  g24(.a(new_n15_), .b(x1), .O(new_n39_));
  nand3  g25(.a(new_n39_), .b(new_n28_), .c(new_n38_), .O(z8));
  nand3  g26(.a(new_n39_), .b(new_n32_), .c(new_n38_), .O(z9));
endmodule
