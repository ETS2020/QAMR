...
module FAU ( 
  ...
  oai21  g08(.a(x3), .b(x2), .c(new_n20_), .O(new_n23_));
  nand2  g09(.a(x2), .b(x1), .O(new_n24_));
  nand2  g10(.a(x3), .b(x0), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n24_), .c(new_n23_), .O(z5));
  nand4  g12(.a(new_n16_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  nand2  g13(.a(x2), .b(new_n21_), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n25_), .c(new_n23_), .O(z7));
  oai21  g15(.a(x3), .b(x2), .c(x1), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n28_), .c(new_n25_), .O(z8));
