...
module FAU ( 
  ...
  nand3  g09(.a(new_n23_), .b(x1), .c(new_n22_), .O(z2));
  nand3  g10(.a(new_n23_), .b(x1), .c(x0), .O(z3));
  nand4  g11(.a(new_n20_), .b(x2), .c(new_n19_), .d(new_n22_), .O(z4));
  ...
  nand3  g16(.a(new_n27_), .b(new_n16_), .c(new_n22_), .O(z8));
  oai21  g17(.a(x2), .b(new_n22_), .c(new_n19_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n27_), .O(z9));
