...
module FAU ( 
  ...
  oai21  g07(.a(x3), .b(x1), .c(x2), .O(new_n22_));
  nand2  g08(.a(new_n22_), .b(new_n15_), .O(z4));
  inv1   g09(.a(x1), .O(new_n24_));
  nand4  g10(.a(new_n20_), .b(x2), .c(new_n24_), .d(x0), .O(z5));
  oai21  g11(.a(new_n16_), .b(x1), .c(x0), .O(new_n26_));
  oai21  g12(.a(x3), .b(new_n24_), .c(x2), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n26_), .O(z6));
  nand4  g14(.a(new_n20_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g15(.a(new_n20_), .b(x1), .c(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n16_), .O(z9));
