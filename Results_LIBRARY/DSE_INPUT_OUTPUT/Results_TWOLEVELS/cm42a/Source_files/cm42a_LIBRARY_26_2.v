...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n23_, new_n25_, new_n27_,
  ...
  oai21  g08(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n23_));
  nand2  g09(.a(new_n23_), .b(new_n16_), .O(z4));
  nor2   g10(.a(x2), .b(x1), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x1), .O(z5));
