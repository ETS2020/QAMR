...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n23_, new_n24_,
    new_n26_, new_n27_, new_n28_, new_n32_, new_n33_;
  ...
  nor2   g06(.a(new_n16_), .b(new_n15_), .O(new_n21_));
  nand2  g07(.a(new_n21_), .b(new_n16_), .O(z2));
  oai21  g08(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n23_));
  oai21  g09(.a(x3), .b(x1), .c(x2), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n23_), .O(z4));
  nand3  g11(.a(new_n18_), .b(new_n16_), .c(x0), .O(new_n26_));
  ...
  oai21  g17(.a(new_n18_), .b(x0), .c(new_n16_), .O(new_n32_));
  oai21  g18(.a(x1), .b(new_n15_), .c(x2), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z8));
  nand4  g20(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(z9));
  nand2  g21(.a(new_n21_), .b(new_n16_), .O(z3));
endmodule
