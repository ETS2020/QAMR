...
module FAU ( 
  ...
  nand3  g12(.a(new_n20_), .b(x1), .c(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n18_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n23_), .O(z3));
  oai21  g15(.a(new_n20_), .b(x1), .c(new_n18_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z4));
  nand3  g17(.a(x2), .b(new_n19_), .c(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n18_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n23_), .O(z5));
