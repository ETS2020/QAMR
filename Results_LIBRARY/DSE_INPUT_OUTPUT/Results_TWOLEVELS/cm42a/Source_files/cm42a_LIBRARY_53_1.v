...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n29_, new_n31_, new_n32_;
  ...
  nand4  g11(.a(new_n18_), .b(new_n20_), .c(x1), .d(x0), .O(z3));
  nand4  g12(.a(new_n18_), .b(x2), .c(new_n19_), .d(new_n15_), .O(z4));
  nand4  g13(.a(new_n18_), .b(x2), .c(new_n19_), .d(x0), .O(z5));
  oai21  g14(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(z6));
  nand3  g16(.a(x2), .b(x1), .c(x0), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n18_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n23_), .O(z7));
