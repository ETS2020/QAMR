...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n25_,
    new_n28_, new_n29_, new_n30_, new_n33_, new_n34_;
  ...
  oai21  g07(.a(x2), .b(x0), .c(x1), .O(new_n22_));
  ...
  nand2  g14(.a(x1), .b(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z6));
  nand4  g16(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g17(.a(new_n18_), .b(x2), .c(new_n15_), .O(new_n33_));
  oai21  g18(.a(new_n17_), .b(x0), .c(x1), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n33_), .O(z8));
  one    g20(.O(z5));
