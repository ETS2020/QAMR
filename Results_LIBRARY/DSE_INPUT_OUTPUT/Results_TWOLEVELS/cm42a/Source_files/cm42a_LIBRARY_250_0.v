...
module FAU ( 
  ...
  aoi22  g10(.a(x3), .b(x2), .c(x1), .d(x0), .O(new_n27_));
  nand3  g11(.a(new_n27_), .b(x2), .c(x1), .O(z6));
  nand4  g12(.a(new_n16_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand2  g13(.a(x3), .b(x2), .O(new_n30_));
  nand2  g14(.a(x1), .b(new_n20_), .O(new_n31_));
  nand3  g15(.a(new_n31_), .b(new_n30_), .c(new_n19_), .O(z8));
  oai21  g16(.a(x3), .b(x1), .c(new_n20_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n27_), .O(z9));
  one    g18(.O(z1));
  one    g19(.O(z5));
