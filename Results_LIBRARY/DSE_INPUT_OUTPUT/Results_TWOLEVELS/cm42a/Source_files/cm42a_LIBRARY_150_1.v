...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n24_,
    new_n26_, new_n30_, new_n31_, new_n33_, new_n34_;
  ...
  oai21  g13(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n30_));
  oai21  g14(.a(x3), .b(new_n17_), .c(x0), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n30_), .O(z7));
  oai21  g16(.a(new_n17_), .b(x1), .c(x0), .O(new_n33_));
  oai21  g17(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n34_));
