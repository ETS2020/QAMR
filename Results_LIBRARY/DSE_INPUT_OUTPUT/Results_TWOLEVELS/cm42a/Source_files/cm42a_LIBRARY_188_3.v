...
module FAU ( 
  ...
  nand3  g15(.a(x3), .b(new_n16_), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n29_), .O(z8));
  oai21  g18(.a(x2), .b(new_n16_), .c(new_n15_), .O(new_n33_));
  oai21  g19(.a(new_n18_), .b(x1), .c(new_n17_), .O(new_n34_));
