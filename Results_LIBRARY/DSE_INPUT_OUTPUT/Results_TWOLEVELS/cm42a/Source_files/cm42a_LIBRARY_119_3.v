...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    ...
    new_n33_, new_n34_, new_n36_, new_n37_, new_n42_;
  ...
  oai21  g21(.a(new_n18_), .b(new_n17_), .c(new_n15_), .O(new_n36_));
  nand2  g22(.a(new_n17_), .b(x0), .O(new_n37_));
  nand3  g23(.a(new_n37_), .b(new_n36_), .c(new_n34_), .O(z5));
  nand4  g24(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g25(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g26(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand2  g27(.a(new_n31_), .b(x1), .O(new_n42_));
  nand3  g28(.a(new_n42_), .b(new_n33_), .c(new_n20_), .O(z9));
endmodule
