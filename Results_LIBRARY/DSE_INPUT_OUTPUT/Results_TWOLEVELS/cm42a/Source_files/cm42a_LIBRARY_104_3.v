...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n25_,
    new_n26_, new_n27_, new_n28_, new_n30_, new_n31_, new_n34_, new_n37_,
    new_n38_, new_n39_;
  ...
  nand2  g15(.a(new_n25_), .b(new_n15_), .O(new_n30_));
  ...
  nand2  g20(.a(new_n34_), .b(new_n21_), .O(z7));
  ...
  nand3  g25(.a(new_n39_), .b(new_n37_), .c(new_n27_), .O(z9));
endmodule
