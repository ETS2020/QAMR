...
module FAU ( 
  ...
  nand4  g15(.a(new_n25_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g16(.a(x3), .b(new_n27_), .c(new_n19_), .d(new_n15_), .O(z8));
  nand2  g17(.a(new_n23_), .b(new_n19_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n18_), .O(z9));
  one    g19(.O(z6));
endmodule
