...
module FAU ( 
  ...
  oai21  g08(.a(new_n22_), .b(x2), .c(new_n16_), .O(new_n23_));
  oai21  g09(.a(x3), .b(x0), .c(new_n19_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n23_), .O(z2));
  nand4  g11(.a(new_n22_), .b(new_n19_), .c(x1), .d(x0), .O(z3));
  inv1   g12(.a(x0), .O(new_n27_));
  nand4  g13(.a(new_n22_), .b(x2), .c(new_n16_), .d(new_n27_), .O(z4));
  nand3  g14(.a(new_n20_), .b(x2), .c(x0), .O(z5));
  nand2  g15(.a(new_n19_), .b(x0), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z6));
  nand3  g17(.a(new_n30_), .b(new_n23_), .c(new_n16_), .O(z8));
  nand4  g18(.a(x3), .b(new_n19_), .c(new_n16_), .d(x0), .O(z9));
  nand4  g19(.a(new_n30_), .b(new_n17_), .c(new_n16_), .d(x0), .O(z7));
endmodule
