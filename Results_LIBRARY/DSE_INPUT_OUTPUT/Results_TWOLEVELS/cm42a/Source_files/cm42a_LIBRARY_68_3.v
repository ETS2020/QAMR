...
module FAU ( 
  ...
  nand3  g08(.a(new_n18_), .b(x2), .c(x0), .O(new_n23_));
  nand3  g09(.a(new_n23_), .b(new_n22_), .c(new_n20_), .O(z1));
  oai21  g10(.a(x3), .b(x0), .c(new_n17_), .O(new_n25_));
  oai21  g11(.a(x2), .b(new_n16_), .c(new_n18_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n25_), .O(z2));
  oai21  g13(.a(x3), .b(new_n15_), .c(new_n17_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n26_), .O(z3));
  nand2  g15(.a(new_n21_), .b(x0), .O(new_n30_));
  ...
  nand4  g20(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  nand4  g21(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g22(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
