...
module FAU ( 
  ...
  nand2  g08(.a(new_n17_), .b(new_n16_), .O(new_n24_));
  nand3  g09(.a(new_n18_), .b(new_n16_), .c(x0), .O(new_n25_));
  ...
  oai21  g15(.a(new_n28_), .b(new_n17_), .c(new_n30_), .O(z6));
  nand4  g16(.a(new_n18_), .b(x2), .c(x1), .d(x0), .O(z7));
  oai21  g17(.a(new_n18_), .b(x0), .c(new_n16_), .O(new_n33_));
