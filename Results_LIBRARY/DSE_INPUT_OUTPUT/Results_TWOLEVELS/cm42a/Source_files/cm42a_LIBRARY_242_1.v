...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n24_,
    new_n25_, new_n27_, new_n31_, new_n32_;
  ...
  oai21  g08(.a(new_n21_), .b(new_n16_), .c(new_n22_), .O(z2));
  oai21  g09(.a(x3), .b(x2), .c(x1), .O(new_n24_));
  oai21  g10(.a(new_n16_), .b(new_n15_), .c(new_n17_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z3));
  nor2   g12(.a(new_n17_), .b(x0), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n17_), .O(z4));
  nand2  g14(.a(x2), .b(new_n16_), .O(z5));
  nand4  g15(.a(new_n18_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
  oai21  g16(.a(x3), .b(new_n15_), .c(x1), .O(new_n31_));
  oai21  g17(.a(new_n18_), .b(new_n16_), .c(new_n17_), .O(new_n32_));
