...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n23_, new_n24_,
    new_n25_, new_n28_, new_n29_, new_n32_;
  ...
  oai21  g14(.a(x3), .b(new_n18_), .c(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n28_), .O(z6));
  nand4  g16(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g17(.a(new_n19_), .b(x2), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n19_), .c(x0), .O(z8));
  nand4  g19(.a(x3), .b(new_n18_), .c(new_n16_), .d(x0), .O(z9));
