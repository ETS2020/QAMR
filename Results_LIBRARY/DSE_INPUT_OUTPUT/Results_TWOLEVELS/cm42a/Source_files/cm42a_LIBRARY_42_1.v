...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n24_,
    new_n26_, new_n30_, new_n31_, new_n33_;
  ...
  oai21  g11(.a(x3), .b(new_n17_), .c(new_n16_), .O(new_n26_));
  ...
  oai21  g16(.a(new_n18_), .b(x2), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n30_), .O(z8));
  nand2  g18(.a(new_n24_), .b(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n20_), .O(z9));
