...
module FAU ( 
  ...
  nand3  g10(.a(new_n25_), .b(new_n24_), .c(new_n22_), .O(z5));
  nand4  g11(.a(new_n16_), .b(x2), .c(x1), .d(new_n20_), .O(z6));
  inv1   g12(.a(x1), .O(new_n28_));
  nand2  g13(.a(x2), .b(new_n28_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(new_n25_), .c(new_n24_), .O(z7));
  nand4  g15(.a(x3), .b(new_n15_), .c(new_n28_), .d(new_n20_), .O(z8));
