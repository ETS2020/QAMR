...
module FAU ( 
  ...
  oai21  g04(.a(x3), .b(new_n15_), .c(new_n19_), .O(new_n20_));
  oai21  g05(.a(x2), .b(x0), .c(x1), .O(new_n21_));
  nand2  g06(.a(new_n21_), .b(new_n20_), .O(z2));
  inv1   g07(.a(x2), .O(new_n23_));
  inv1   g08(.a(x3), .O(new_n24_));
  nand4  g09(.a(new_n24_), .b(new_n23_), .c(x1), .d(x0), .O(z3));
  oai21  g10(.a(x3), .b(new_n23_), .c(new_n19_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n21_), .O(z4));
  ...
  nand4  g18(.a(x3), .b(new_n23_), .c(new_n15_), .d(new_n19_), .O(z8));
  one    g19(.O(z1));
