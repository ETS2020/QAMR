...
module FAU ( 
  ...
  nand2  g08(.a(x2), .b(x1), .O(z6));
  nand2  g09(.a(z6), .b(new_n15_), .O(new_n24_));
  nand2  g10(.a(new_n16_), .b(x0), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n24_), .c(new_n22_), .O(z3));
  nand2  g12(.a(z6), .b(x0), .O(new_n27_));
  nand2  g13(.a(new_n17_), .b(new_n15_), .O(new_n28_));
  nand2  g14(.a(x3), .b(new_n16_), .O(new_n29_));
