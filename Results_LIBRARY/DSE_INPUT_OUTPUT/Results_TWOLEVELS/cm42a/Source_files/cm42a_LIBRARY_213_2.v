...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n24_;
  ...
  nor2   g09(.a(new_n18_), .b(x2), .O(new_n24_));
  ...
  nand2  g14(.a(new_n18_), .b(x0), .O(z3));
  nand2  g15(.a(new_n24_), .b(new_n18_), .O(z7));
endmodule
