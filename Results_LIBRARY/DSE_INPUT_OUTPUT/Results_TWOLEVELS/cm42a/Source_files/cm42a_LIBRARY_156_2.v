...
module FAU ( 
  ...
  nor2   g05(.a(new_n18_), .b(x1), .O(new_n20_));
  ...
  nor3   g09(.a(x3), .b(x1), .c(x0), .O(new_n24_));
  nand2  g10(.a(new_n17_), .b(new_n15_), .O(new_n25_));
  oai21  g11(.a(new_n24_), .b(new_n17_), .c(new_n25_), .O(z4));
  oai21  g12(.a(x3), .b(x1), .c(x2), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x0), .O(z5));
  oai21  g14(.a(x3), .b(new_n16_), .c(x2), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n25_), .c(new_n15_), .O(z6));
