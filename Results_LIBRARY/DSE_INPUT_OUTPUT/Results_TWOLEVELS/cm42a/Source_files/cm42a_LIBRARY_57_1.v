...
module FAU ( 
  ...
  nand3  g07(.a(new_n19_), .b(x1), .c(new_n21_), .O(new_n22_));
  nand2  g08(.a(new_n22_), .b(new_n18_), .O(new_n23_));
  nand2  g09(.a(x2), .b(x1), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n23_), .O(z2));
  nand4  g11(.a(new_n19_), .b(new_n18_), .c(x1), .d(x0), .O(z3));
  nand4  g12(.a(new_n19_), .b(x2), .c(x1), .d(new_n21_), .O(z6));
  nand4  g13(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  nand4  g14(.a(x3), .b(new_n18_), .c(new_n15_), .d(new_n21_), .O(z8));
  nand4  g15(.a(x3), .b(new_n18_), .c(new_n15_), .d(x0), .O(z9));
  one    g16(.O(z4));
  one    g17(.O(z5));
endmodule
