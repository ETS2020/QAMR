...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n24_, new_n28_,
  ...
  nand4  g11(.a(new_n21_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
  nand3  g12(.a(new_n21_), .b(x2), .c(x1), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x0), .O(new_n29_));
  nand2  g14(.a(x1), .b(new_n17_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z7));
  oai21  g16(.a(new_n21_), .b(x2), .c(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n19_), .O(z9));
  one    g18(.O(z0));
  nand2  g19(.a(new_n24_), .b(new_n17_), .O(z8));
endmodule
