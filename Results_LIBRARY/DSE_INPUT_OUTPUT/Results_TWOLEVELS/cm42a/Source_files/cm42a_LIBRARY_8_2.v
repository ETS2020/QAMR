...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n21_, new_n22_, new_n29_,
    new_n30_, new_n31_;
  ...
  nand3  g12(.a(x3), .b(new_n16_), .c(x0), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(new_n17_), .O(new_n30_));
