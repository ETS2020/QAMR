...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_,
    new_n25_, new_n26_, new_n27_, new_n31_, new_n32_, new_n34_, new_n35_;
  ...
  oai21  g15(.a(new_n17_), .b(x1), .c(x0), .O(new_n31_));
  nand2  g16(.a(x3), .b(x1), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n20_), .O(z6));
  oai21  g18(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n34_));
  nand2  g19(.a(new_n17_), .b(x0), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n34_), .c(new_n32_), .O(z7));
