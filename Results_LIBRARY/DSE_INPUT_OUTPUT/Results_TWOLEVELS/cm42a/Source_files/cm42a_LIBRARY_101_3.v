...
module FAU ( 
  ...
  oai21  g12(.a(x3), .b(new_n17_), .c(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x0), .O(z5));
  oai21  g14(.a(x2), .b(x0), .c(new_n16_), .O(new_n29_));
  oai21  g15(.a(x3), .b(new_n17_), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z6));
  oai21  g17(.a(new_n21_), .b(x0), .c(new_n16_), .O(new_n33_));
  oai21  g18(.a(x2), .b(x1), .c(new_n15_), .O(new_n34_));
