...
module FAU ( 
  ...
  oai21  g07(.a(x2), .b(new_n18_), .c(x0), .O(new_n22_));
  oai21  g08(.a(x3), .b(new_n15_), .c(new_n18_), .O(new_n23_));
  inv1   g09(.a(x0), .O(new_n24_));
  nand3  g10(.a(x2), .b(x1), .c(new_n24_), .O(new_n25_));
  nand3  g11(.a(new_n25_), .b(new_n23_), .c(new_n22_), .O(z4));
  oai21  g12(.a(x2), .b(new_n18_), .c(new_n24_), .O(new_n27_));
  nand3  g13(.a(x2), .b(x1), .c(x0), .O(new_n28_));
  nand3  g14(.a(new_n28_), .b(new_n27_), .c(new_n23_), .O(z5));
  nand2  g15(.a(new_n18_), .b(new_n24_), .O(new_n30_));
  nand2  g16(.a(x3), .b(x2), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n30_), .c(new_n22_), .O(z6));
  nand2  g18(.a(new_n18_), .b(x0), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n31_), .c(new_n27_), .O(z7));
  nand4  g20(.a(x3), .b(new_n15_), .c(new_n18_), .d(new_n24_), .O(z8));
  nand4  g21(.a(x3), .b(new_n15_), .c(new_n18_), .d(x0), .O(z9));
  nand2  g22(.a(new_n15_), .b(x1), .O(z3));
endmodule
