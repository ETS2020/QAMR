...
module FAU ( 
  ...
  nor2   g12(.a(new_n17_), .b(new_n15_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n17_), .O(z6));
  nand2  g14(.a(x2), .b(x1), .O(z7));
  nand4  g15(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  oai21  g16(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n21_), .O(z9));
endmodule
