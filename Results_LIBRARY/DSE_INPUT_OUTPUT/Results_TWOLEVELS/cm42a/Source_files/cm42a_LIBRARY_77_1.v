...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n21_, new_n22_, new_n23_,
    new_n24_, new_n26_, new_n27_, new_n33_;
  ...
  nand4  g14(.a(new_n19_), .b(x2), .c(new_n15_), .d(new_n21_), .O(z4));
  nand4  g15(.a(new_n19_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand4  g16(.a(new_n19_), .b(x2), .c(x1), .d(new_n21_), .O(z6));
  nand4  g17(.a(new_n19_), .b(x2), .c(x1), .d(x0), .O(z7));
  nor2   g18(.a(new_n19_), .b(new_n18_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n19_), .O(z8));
  nand2  g20(.a(new_n33_), .b(new_n19_), .O(z9));
endmodule
