...
module FAU ( 
  ...
  oai21  g10(.a(x2), .b(new_n16_), .c(x0), .O(new_n26_));
  nand2  g11(.a(x3), .b(x2), .O(new_n27_));
  nand3  g12(.a(new_n27_), .b(new_n26_), .c(new_n25_), .O(z6));
  nand2  g13(.a(new_n16_), .b(x0), .O(new_n29_));
  oai21  g14(.a(x2), .b(new_n16_), .c(new_n15_), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n27_), .c(new_n29_), .O(z7));
  nand4  g16(.a(x3), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z8));
  nand2  g17(.a(x2), .b(x0), .O(new_n33_));
  nand3  g18(.a(new_n18_), .b(new_n17_), .c(new_n16_), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n30_), .c(new_n33_), .O(z9));
  one    g20(.O(z3));
endmodule
