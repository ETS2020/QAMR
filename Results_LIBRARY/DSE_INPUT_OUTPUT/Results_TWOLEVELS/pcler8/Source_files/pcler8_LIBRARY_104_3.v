...
module FAU ( 
  ...
  nand3  g81(.a(new_n125_), .b(x22), .c(x21), .O(new_n126_));
  ...
  nand4  g85(.a(new_n118_), .b(new_n129_), .c(new_n124_), .d(x24), .O(new_n130_));
  oai21  g86(.a(new_n128_), .b(new_n124_), .c(new_n130_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n46_), .c(x10), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n123_), .c(new_n69_), .O(z15));
