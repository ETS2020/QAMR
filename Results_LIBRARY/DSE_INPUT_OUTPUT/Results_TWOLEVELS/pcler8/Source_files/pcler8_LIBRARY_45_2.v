...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n48_, new_n50_, new_n52_, new_n54_, new_n55_,
    new_n56_, new_n58_, new_n60_, new_n61_, new_n63_, new_n65_;
  ...
  oai21  g11(.a(x10), .b(new_n55_), .c(x08), .O(new_n56_));
  nor2   g12(.a(new_n56_), .b(new_n54_), .O(z04));
  nand2  g13(.a(x08), .b(x04), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(new_n46_), .O(z05));
  inv1   g15(.a(x05), .O(new_n60_));
  inv1   g16(.a(x08), .O(new_n61_));
  oai21  g17(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(z06));
  inv1   g18(.a(x06), .O(new_n63_));
  oai21  g19(.a(new_n61_), .b(new_n63_), .c(new_n46_), .O(z07));
  inv1   g20(.a(x07), .O(new_n65_));
  oai21  g21(.a(new_n61_), .b(new_n65_), .c(new_n46_), .O(z08));
  nor2   g22(.a(new_n56_), .b(new_n60_), .O(z14));
  nor2   g23(.a(new_n56_), .b(new_n63_), .O(z15));
  nor2   g24(.a(new_n56_), .b(new_n65_), .O(z16));
  nand2  g25(.a(new_n48_), .b(new_n46_), .O(z09));
  nand2  g26(.a(new_n50_), .b(new_n46_), .O(z10));
  nand2  g27(.a(new_n52_), .b(new_n46_), .O(z11));
  nor2   g28(.a(new_n56_), .b(new_n54_), .O(z12));
  nand2  g29(.a(new_n58_), .b(new_n46_), .O(z13));
endmodule
