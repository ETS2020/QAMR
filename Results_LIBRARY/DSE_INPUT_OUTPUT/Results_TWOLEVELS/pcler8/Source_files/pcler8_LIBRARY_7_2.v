...
module FAU ( 
  ...
  nand2  g022(.a(new_n56_), .b(x04), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(z05));
  nand2  g024(.a(new_n56_), .b(x05), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n60_), .O(z06));
  ...
  nand3  g036(.a(new_n80_), .b(new_n57_), .c(new_n60_), .O(z09));
  ...
  nand3  g051(.a(new_n87_), .b(x13), .c(new_n47_), .O(new_n96_));
  nand3  g052(.a(new_n77_), .b(x22), .c(x21), .O(new_n97_));
  ...
  nand3  g057(.a(new_n90_), .b(x20), .c(x19), .O(new_n102_));
  oai21  g058(.a(new_n101_), .b(new_n90_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n99_), .c(new_n62_), .O(z11));
  nand3  g061(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n106_));
  nand3  g062(.a(new_n101_), .b(new_n91_), .c(x21), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n106_), .c(new_n46_), .d(new_n64_), .O(new_n108_));
  ...
  inv1   g067(.a(new_n92_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x23), .c(x14), .O(new_n113_));
  ...
  nand3  g079(.a(new_n123_), .b(new_n67_), .c(new_n60_), .O(z13));
  inv1   g080(.a(x25), .O(new_n125_));
  nand3  g081(.a(new_n76_), .b(x22), .c(x21), .O(new_n126_));
  nand3  g082(.a(x26), .b(x24), .c(x16), .O(new_n127_));
  oai21  g083(.a(new_n126_), .b(new_n100_), .c(new_n127_), .O(new_n128_));
  nand4  g084(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n129_));
  and2   g085(.a(new_n129_), .b(x24), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(x23), .c(new_n130_), .O(new_n131_));
  nand2  g087(.a(x24), .b(new_n54_), .O(new_n132_));
  oai21  g088(.a(new_n131_), .b(new_n125_), .c(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n69_), .O(z14));
  nand3  g091(.a(new_n101_), .b(x24), .c(x21), .O(new_n136_));
  ...
  nand4  g095(.a(new_n139_), .b(x25), .c(new_n47_), .d(x09), .O(new_n140_));
  oai22  g096(.a(new_n140_), .b(x08), .c(new_n65_), .d(new_n71_), .O(z15));
  nor2   g097(.a(new_n100_), .b(x18), .O(new_n142_));
  nand3  g098(.a(x24), .b(x22), .c(x21), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n142_), .c(new_n45_), .O(new_n145_));
  nand4  g101(.a(new_n45_), .b(x24), .c(x23), .d(x22), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n110_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(x25), .O(new_n148_));
