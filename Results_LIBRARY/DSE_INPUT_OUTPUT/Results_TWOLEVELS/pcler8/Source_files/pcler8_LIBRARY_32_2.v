...
module FAU ( 
  ...
  nor2   g22(.a(new_n50_), .b(new_n56_), .O(z12));
  nor2   g23(.a(new_n50_), .b(new_n59_), .O(z13));
  nor2   g24(.a(new_n50_), .b(new_n63_), .O(z15));
  oai21  g25(.a(new_n57_), .b(new_n65_), .c(new_n46_), .O(z16));
  nor2   g26(.a(new_n50_), .b(new_n48_), .O(z09));
  nand2  g27(.a(new_n52_), .b(new_n46_), .O(z10));
