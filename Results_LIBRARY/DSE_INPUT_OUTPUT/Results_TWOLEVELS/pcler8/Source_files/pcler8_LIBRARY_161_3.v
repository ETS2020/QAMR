...
module FAU ( 
  ...
  nand4  g09(.a(new_n53_), .b(new_n49_), .c(x09), .d(new_n47_), .O(new_n54_));
  aoi21  g10(.a(new_n54_), .b(new_n45_), .c(new_n46_), .O(z00));
  inv1   g11(.a(x00), .O(new_n56_));
  nand2  g12(.a(x22), .b(x10), .O(new_n57_));
  oai21  g13(.a(new_n47_), .b(new_n56_), .c(new_n57_), .O(z01));
  ...
  oai21  g25(.a(new_n47_), .b(new_n69_), .c(new_n57_), .O(z06));
  inv1   g26(.a(x06), .O(new_n71_));
  oai21  g27(.a(new_n47_), .b(new_n71_), .c(new_n57_), .O(z07));
  nand2  g28(.a(new_n60_), .b(x07), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(z08));
  nor2   g30(.a(new_n46_), .b(new_n50_), .O(new_n75_));
  ...
  nand4  g34(.a(new_n78_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n79_));
  oai21  g35(.a(new_n59_), .b(new_n56_), .c(new_n79_), .O(z09));
  ...
  nand4  g41(.a(new_n85_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n61_), .O(z10));
  nand4  g43(.a(x21), .b(x13), .c(x09), .d(new_n47_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n77_), .c(new_n45_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(x22), .O(new_n90_));
  nand3  g46(.a(new_n50_), .b(x20), .c(x19), .O(new_n91_));
  oai21  g47(.a(new_n49_), .b(new_n50_), .c(new_n91_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(new_n90_), .c(new_n63_), .O(z11));
  nand2  g50(.a(x23), .b(x14), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n52_), .c(x21), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n48_), .c(x22), .O(new_n97_));
  nand3  g53(.a(new_n49_), .b(new_n46_), .c(x21), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n65_), .O(z12));
  nand4  g57(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(x22), .c(x21), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n48_), .c(x23), .O(new_n104_));
  nand4  g60(.a(new_n49_), .b(new_n51_), .c(x22), .d(x21), .O(new_n105_));
  ...
  nand4  g72(.a(new_n116_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n117_));
  oai21  g73(.a(new_n59_), .b(new_n69_), .c(new_n117_), .O(z14));
  ...
  nor2   g78(.a(new_n51_), .b(new_n46_), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n114_), .c(new_n122_), .d(x24), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n126_));
  oai21  g82(.a(new_n59_), .b(new_n71_), .c(new_n126_), .O(z15));
  inv1   g83(.a(x26), .O(new_n128_));
  nand3  g84(.a(x24), .b(x23), .c(x22), .O(new_n129_));
  and2   g85(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  inv1   g86(.a(x18), .O(new_n131_));
  nand3  g87(.a(x25), .b(x21), .c(x20), .O(new_n132_));
  inv1   g88(.a(new_n132_), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(x19), .c(new_n131_), .O(new_n134_));
  aoi21  g90(.a(new_n134_), .b(x22), .c(new_n130_), .O(new_n135_));
  nor2   g91(.a(new_n113_), .b(new_n51_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n122_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n136_), .c(new_n75_), .d(new_n49_), .O(new_n138_));
  oai21  g94(.a(new_n135_), .b(new_n128_), .c(new_n138_), .O(new_n139_));
  nand3  g95(.a(new_n139_), .b(x09), .c(new_n47_), .O(new_n140_));
  nand3  g96(.a(new_n140_), .b(new_n73_), .c(new_n57_), .O(z16));
endmodule
