...
module FAU ( 
  ...
  aoi21  g19(.a(x08), .b(x02), .c(new_n47_), .O(new_n64_));
  ...
  nand2  g67(.a(new_n111_), .b(new_n69_), .O(z13));
  ...
  nand4  g76(.a(new_n120_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n121_));
  ...
  nand4  g82(.a(new_n118_), .b(new_n55_), .c(new_n126_), .d(x24), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n46_), .c(x09), .d(new_n49_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n73_), .c(new_n48_), .O(z15));
  oai21  g86(.a(x10), .b(x08), .c(x07), .O(new_n131_));
  ...
  nor2   g91(.a(new_n117_), .b(new_n54_), .O(new_n136_));
  ...
  nand2  g96(.a(new_n140_), .b(new_n131_), .O(z16));
endmodule
