...
module FAU ( 
  ...
  oai21  g052(.a(new_n62_), .b(new_n61_), .c(new_n96_), .O(z11));
  ...
  aoi21  g063(.a(x21), .b(x20), .c(new_n107_), .O(new_n108_));
  ...
  oai21  g070(.a(new_n114_), .b(new_n107_), .c(new_n47_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n66_), .O(z13));
  nand3  g072(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(x23), .c(x22), .d(x19), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n108_), .c(x24), .O(new_n119_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n107_), .c(new_n47_), .O(new_n125_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n107_), .c(new_n47_), .O(new_n134_));
  ...
  nor2   g095(.a(new_n120_), .b(new_n112_), .O(new_n140_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n107_), .c(new_n47_), .O(new_n144_));
