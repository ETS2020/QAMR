...
module FAU ( 
  ...
  oai21  g052(.a(x20), .b(x10), .c(x19), .O(new_n97_));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n100_), .c(x08), .O(new_n104_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n101_), .c(x23), .O(new_n109_));
  ...
  nand2  g079(.a(new_n123_), .b(new_n68_), .O(z14));
  aoi21  g080(.a(new_n110_), .b(new_n47_), .c(new_n75_), .O(new_n125_));
  ...
  nand2  g092(.a(new_n110_), .b(new_n47_), .O(new_n137_));
