...
module FAU ( 
  ...
  nand2  g12(.a(new_n55_), .b(x04), .O(new_n58_));
  ...
  oai21  g18(.a(new_n63_), .b(new_n62_), .c(new_n48_), .O(z07));
  ...
  nand4  g28(.a(new_n73_), .b(new_n72_), .c(new_n47_), .d(x09), .O(new_n74_));
  oai22  g29(.a(new_n74_), .b(x08), .c(new_n49_), .d(new_n51_), .O(z10));
  ...
  aoi21  g34(.a(new_n79_), .b(new_n77_), .c(new_n67_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n63_), .c(x24), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(x10), .c(new_n53_), .O(z11));
  ...
  nand4  g42(.a(new_n87_), .b(new_n47_), .c(x09), .d(new_n63_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n56_), .O(z12));
  ...
  nand4  g49(.a(new_n94_), .b(new_n72_), .c(new_n47_), .d(x09), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(x08), .c(new_n58_), .O(z13));
  nand3  g51(.a(x19), .b(x09), .c(new_n63_), .O(new_n97_));
  ...
  nand4  g56(.a(new_n68_), .b(x25), .c(new_n72_), .d(new_n47_), .O(new_n102_));
  oai21  g57(.a(new_n49_), .b(new_n62_), .c(new_n102_), .O(z15));
  nand2  g58(.a(x26), .b(x09), .O(new_n104_));
  oai21  g59(.a(new_n104_), .b(x08), .c(new_n72_), .O(new_n105_));
  nand2  g60(.a(new_n105_), .b(new_n47_), .O(new_n106_));
  oai21  g61(.a(new_n49_), .b(new_n65_), .c(new_n106_), .O(z16));
  zero   g62(.O(z00));
endmodule
