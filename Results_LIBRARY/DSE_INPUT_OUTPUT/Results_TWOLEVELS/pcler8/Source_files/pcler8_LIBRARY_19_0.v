...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n139_;
  nor2   g00(.a(x14), .b(x12), .O(new_n45_));
  ...
  oai21  g20(.a(new_n47_), .b(new_n64_), .c(new_n46_), .O(z03));
  ...
  aoi21  g51(.a(new_n95_), .b(new_n94_), .c(new_n45_), .O(z11));
  ...
  nand3  g58(.a(new_n102_), .b(new_n66_), .c(new_n46_), .O(z12));
  ...
  nand4  g64(.a(new_n108_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n109_));
  nand2  g65(.a(x08), .b(x04), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(new_n45_), .O(z13));
  ...
  nand3  g76(.a(new_n120_), .b(new_n69_), .c(new_n46_), .O(z14));
  ...
  nand3  g84(.a(new_n128_), .b(new_n71_), .c(new_n46_), .O(z15));
  ...
  nor2   g89(.a(new_n116_), .b(new_n53_), .O(new_n134_));
  ...
  nand2  g94(.a(x08), .b(x07), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n138_), .c(new_n45_), .O(z16));
endmodule
