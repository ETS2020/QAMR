...
module FAU ( 
  ...
  oai21  g22(.a(new_n58_), .b(new_n66_), .c(new_n60_), .O(z03));
  ...
  oai21  g39(.a(new_n64_), .b(new_n57_), .c(new_n83_), .O(z09));
  ...
  oai21  g45(.a(new_n64_), .b(new_n62_), .c(new_n89_), .O(z10));
  ...
  oai21  g52(.a(new_n64_), .b(new_n66_), .c(new_n96_), .O(z11));
  ...
  nand4  g60(.a(new_n104_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n105_));
  oai21  g61(.a(new_n64_), .b(new_n68_), .c(new_n105_), .O(z12));
  inv1   g62(.a(x09), .O(new_n107_));
  aoi21  g63(.a(x21), .b(x20), .c(new_n107_), .O(new_n108_));
  ...
  nand4  g67(.a(new_n102_), .b(new_n51_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n107_), .c(new_n78_), .O(new_n114_));
  ...
  aoi21  g81(.a(new_n51_), .b(x09), .c(new_n50_), .O(new_n126_));
  aoi21  g82(.a(x26), .b(x17), .c(new_n120_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n126_), .c(new_n121_), .O(new_n128_));
  ...
  oai21  g88(.a(new_n132_), .b(new_n107_), .c(new_n78_), .O(new_n133_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n79_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n107_), .c(new_n78_), .O(new_n143_));
