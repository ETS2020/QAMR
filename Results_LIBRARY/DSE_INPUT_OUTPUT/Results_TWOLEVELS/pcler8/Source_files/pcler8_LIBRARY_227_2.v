...
module FAU ( 
  ...
  aoi21  g010(.a(new_n54_), .b(x18), .c(new_n46_), .O(new_n55_));
  ...
  nand2  g022(.a(new_n54_), .b(x18), .O(new_n67_));
  ...
  nand2  g028(.a(new_n72_), .b(new_n67_), .O(z08));
  ...
  nand3  g039(.a(new_n54_), .b(x19), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g049(.a(x21), .b(new_n54_), .c(new_n83_), .O(new_n94_));
  ...
  nand3  g054(.a(x22), .b(new_n83_), .c(new_n47_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n98_), .c(new_n83_), .O(new_n100_));
  ...
  nor2   g061(.a(new_n54_), .b(new_n91_), .O(new_n106_));
  ...
  nand3  g066(.a(x23), .b(new_n83_), .c(new_n47_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n98_), .c(new_n83_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n54_), .O(new_n113_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n98_), .c(new_n83_), .O(new_n124_));
  ...
  nand2  g101(.a(x26), .b(new_n47_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n98_), .c(x20), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x18), .O(new_n148_));
  nand4  g104(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n129_), .c(x26), .O(new_n150_));
  nor2   g106(.a(new_n130_), .b(new_n118_), .O(new_n151_));
  nor2   g107(.a(x26), .b(new_n136_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n106_), .c(new_n151_), .d(new_n74_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n148_), .c(new_n72_), .O(z16));
endmodule
