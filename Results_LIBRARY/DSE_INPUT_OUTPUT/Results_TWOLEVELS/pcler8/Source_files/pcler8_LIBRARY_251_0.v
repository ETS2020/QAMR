...
module FAU ( 
  ...
  oai21  g070(.a(new_n60_), .b(new_n66_), .c(new_n114_), .O(z13));
  ...
  oai21  g080(.a(new_n60_), .b(new_n68_), .c(new_n124_), .O(z14));
  ...
  nor2   g092(.a(new_n82_), .b(x18), .O(new_n137_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n103_), .c(new_n142_), .d(new_n76_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(x08), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n97_), .c(new_n47_), .O(new_n146_));
