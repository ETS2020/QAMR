...
module FAU ( 
  ...
  nand4  g81(.a(new_n118_), .b(new_n54_), .c(new_n45_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n72_), .O(z15));
  nand2  g85(.a(x26), .b(x09), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(x08), .c(new_n48_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n45_), .O(new_n132_));
  inv1   g88(.a(x18), .O(new_n133_));
  nand3  g89(.a(x20), .b(x19), .c(new_n133_), .O(new_n134_));
  nand4  g90(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n134_), .c(x26), .O(new_n136_));
  nor2   g92(.a(new_n117_), .b(new_n53_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n45_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n77_), .d(new_n50_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n132_), .c(new_n74_), .O(z16));
endmodule
