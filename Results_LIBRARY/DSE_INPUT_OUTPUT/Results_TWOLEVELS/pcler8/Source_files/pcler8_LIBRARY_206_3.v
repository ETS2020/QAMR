...
module FAU ( 
  ...
  oai21  g036(.a(new_n80_), .b(new_n73_), .c(new_n57_), .O(z09));
  ...
  nand2  g044(.a(new_n88_), .b(new_n59_), .O(z10));
  ...
  aoi21  g062(.a(x21), .b(x20), .c(x10), .O(new_n107_));
  ...
  aoi21  g075(.a(new_n118_), .b(new_n47_), .c(new_n119_), .O(new_n120_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n46_), .c(x10), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n73_), .c(new_n67_), .O(z14));
  and2   g082(.a(x23), .b(x22), .O(new_n127_));
  nand3  g083(.a(x26), .b(x17), .c(new_n47_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n122_), .c(new_n127_), .d(x24), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x25), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand4  g087(.a(new_n122_), .b(new_n127_), .c(new_n131_), .d(x24), .O(new_n132_));
