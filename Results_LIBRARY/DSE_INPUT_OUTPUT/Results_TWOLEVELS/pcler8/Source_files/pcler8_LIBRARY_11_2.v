...
module FAU ( 
  ...
  oai21  g36(.a(new_n72_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  oai21  g60(.a(new_n72_), .b(new_n63_), .c(new_n104_), .O(z12));
  ...
  nand3  g68(.a(new_n112_), .b(new_n65_), .c(new_n56_), .O(z13));
  ...
  oai21  g78(.a(new_n72_), .b(new_n67_), .c(new_n122_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n69_), .c(new_n56_), .O(z15));
  ...
  oai21  g97(.a(new_n72_), .b(new_n71_), .c(new_n141_), .O(z16));
endmodule
