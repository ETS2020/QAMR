...
module FAU ( 
  ...
  nand2  g17(.a(new_n62_), .b(new_n47_), .O(z07));
  inv1   g18(.a(x07), .O(new_n64_));
  nor2   g19(.a(new_n52_), .b(new_n64_), .O(z08));
  zero   g20(.O(z00));
  nand2  g21(.a(new_n48_), .b(new_n47_), .O(z09));
  nor2   g22(.a(new_n52_), .b(new_n50_), .O(z10));
  nor2   g23(.a(new_n52_), .b(new_n54_), .O(z11));
  nor2   g24(.a(new_n52_), .b(new_n56_), .O(z12));
  nor2   g25(.a(new_n52_), .b(new_n58_), .O(z13));
  nand2  g26(.a(new_n60_), .b(new_n47_), .O(z14));
  nand2  g27(.a(new_n62_), .b(new_n47_), .O(z15));
