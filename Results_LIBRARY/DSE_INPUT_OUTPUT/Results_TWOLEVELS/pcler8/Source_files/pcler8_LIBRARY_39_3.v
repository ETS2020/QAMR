...
module FAU ( 
  ...
  nor2   g16(.a(new_n45_), .b(new_n47_), .O(new_n61_));
  ...
  nand3  g39(.a(new_n83_), .b(new_n59_), .c(new_n46_), .O(z09));
  ...
  nand3  g75(.a(new_n119_), .b(new_n70_), .c(new_n46_), .O(z14));
  ...
  nand2  g83(.a(new_n127_), .b(new_n72_), .O(z15));
