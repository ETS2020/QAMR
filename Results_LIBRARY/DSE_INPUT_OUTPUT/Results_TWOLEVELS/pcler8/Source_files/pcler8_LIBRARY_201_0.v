...
module FAU ( 
  ...
  oai21  g051(.a(new_n57_), .b(new_n62_), .c(new_n95_), .O(z11));
  ...
  nand2  g065(.a(x22), .b(x19), .O(new_n110_));
  aoi21  g066(.a(new_n109_), .b(x09), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n101_), .b(new_n107_), .c(x22), .d(x21), .O(new_n112_));
  oai21  g068(.a(new_n111_), .b(new_n107_), .c(new_n112_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n46_), .c(new_n106_), .O(new_n114_));
  ...
  inv1   g075(.a(new_n116_), .O(new_n120_));
  nor2   g076(.a(x24), .b(new_n107_), .O(new_n121_));
  ...
  nor2   g081(.a(new_n107_), .b(new_n75_), .O(new_n126_));
  ...
  nand2  g092(.a(new_n136_), .b(x09), .O(new_n137_));
  nand3  g093(.a(x25), .b(x22), .c(x21), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n137_), .c(new_n101_), .d(new_n135_), .O(new_n140_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n106_), .c(new_n47_), .O(new_n146_));
