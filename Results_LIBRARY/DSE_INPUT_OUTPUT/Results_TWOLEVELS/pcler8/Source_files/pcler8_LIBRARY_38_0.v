...
module FAU ( 
  ...
  nand2  g026(.a(new_n70_), .b(new_n63_), .O(z07));
  ...
  oai21  g045(.a(new_n89_), .b(new_n79_), .c(x21), .O(new_n90_));
  ...
  and2   g051(.a(x20), .b(x19), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  nand2  g053(.a(x23), .b(x14), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n88_), .c(x21), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n97_), .c(x22), .O(new_n100_));
  inv1   g056(.a(x22), .O(new_n101_));
  nand3  g057(.a(new_n96_), .b(new_n101_), .c(x21), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n100_), .c(x08), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n86_), .c(new_n47_), .O(new_n104_));
  ...
  nand4  g065(.a(new_n96_), .b(new_n109_), .c(x22), .d(x21), .O(new_n110_));
  ...
  nor2   g074(.a(x24), .b(new_n109_), .O(new_n119_));
  ...
  oai21  g078(.a(new_n57_), .b(new_n68_), .c(new_n122_), .O(z14));
  nand2  g079(.a(x26), .b(x17), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(x22), .c(new_n86_), .O(new_n125_));
  and2   g081(.a(x24), .b(x23), .O(new_n126_));
  nand3  g082(.a(new_n96_), .b(new_n126_), .c(x21), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n125_), .c(x25), .O(new_n128_));
  inv1   g084(.a(x25), .O(new_n129_));
  nor2   g085(.a(new_n109_), .b(new_n101_), .O(new_n130_));
  nand4  g086(.a(new_n118_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n128_), .c(x08), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n86_), .c(new_n47_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n70_), .O(z15));
  oai21  g090(.a(new_n101_), .b(x18), .c(x09), .O(new_n135_));
  nand3  g091(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n114_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(new_n45_), .O(new_n138_));
  nand4  g094(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n139_));
  nand4  g095(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n138_), .c(new_n46_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x09), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n47_), .O(new_n144_));
