...
module FAU ( 
  ...
  oai21  g20(.a(new_n59_), .b(new_n65_), .c(new_n53_), .O(z08));
  oai21  g21(.a(new_n59_), .b(new_n46_), .c(new_n53_), .O(z09));
  oai21  g22(.a(new_n59_), .b(new_n50_), .c(new_n53_), .O(z10));
  nor2   g23(.a(new_n48_), .b(new_n58_), .O(z13));
  oai21  g24(.a(new_n59_), .b(new_n61_), .c(new_n53_), .O(z14));
