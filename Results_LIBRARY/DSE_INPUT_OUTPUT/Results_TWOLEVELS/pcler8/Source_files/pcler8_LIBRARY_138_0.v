...
module FAU ( 
  ...
  oai21  g22(.a(new_n62_), .b(new_n66_), .c(new_n58_), .O(z03));
  inv1   g23(.a(x03), .O(new_n68_));
  oai21  g24(.a(new_n62_), .b(new_n68_), .c(new_n58_), .O(z04));
  ...
  aoi21  g38(.a(new_n82_), .b(new_n62_), .c(new_n78_), .O(new_n83_));
  ...
  nand4  g45(.a(new_n89_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n90_));
  oai21  g46(.a(new_n64_), .b(new_n61_), .c(new_n90_), .O(z10));
  ...
  nand4  g52(.a(new_n96_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n97_));
  oai21  g53(.a(new_n64_), .b(new_n66_), .c(new_n97_), .O(z11));
  ...
  nand4  g61(.a(new_n105_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n106_));
  ...
  nand4  g68(.a(new_n112_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n113_));
  ...
  aoi21  g79(.a(new_n123_), .b(new_n62_), .c(new_n78_), .O(new_n124_));
  ...
  nand4  g87(.a(new_n131_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n132_));
  ...
  nor2   g93(.a(new_n115_), .b(new_n51_), .O(new_n138_));
  ...
  nand4  g97(.a(new_n141_), .b(new_n85_), .c(x09), .d(new_n62_), .O(new_n142_));
