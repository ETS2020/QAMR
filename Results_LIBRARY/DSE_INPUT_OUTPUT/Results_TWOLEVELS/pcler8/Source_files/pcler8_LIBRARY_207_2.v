...
module FAU ( 
  ...
  nor2   g01(.a(x23), .b(new_n45_), .O(new_n46_));
  ...
  nand4  g38(.a(new_n82_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n83_));
  oai21  g39(.a(new_n62_), .b(new_n60_), .c(new_n83_), .O(z09));
  ...
  nand2  g43(.a(new_n50_), .b(x19), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n64_), .c(new_n47_), .O(z10));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n56_), .c(x20), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n49_), .c(x21), .O(new_n94_));
  nand3  g50(.a(new_n78_), .b(x20), .c(x19), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n66_), .c(new_n47_), .O(z11));
  aoi22  g54(.a(x23), .b(x10), .c(x21), .d(x20), .O(new_n99_));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n56_), .c(x19), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n45_), .c(new_n99_), .O(new_n102_));
  nor2   g58(.a(new_n49_), .b(x10), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n53_), .c(x21), .d(x20), .O(new_n104_));
  oai21  g60(.a(new_n102_), .b(new_n53_), .c(new_n104_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x09), .c(new_n48_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n68_), .O(z12));
  aoi21  g63(.a(x21), .b(x20), .c(new_n53_), .O(new_n108_));
  ...
  nand4  g67(.a(new_n51_), .b(new_n54_), .c(x22), .d(x21), .O(new_n112_));
  ...
  oai21  g80(.a(new_n62_), .b(new_n72_), .c(new_n124_), .O(z14));
  ...
  oai21  g88(.a(new_n62_), .b(new_n74_), .c(new_n132_), .O(z15));
  ...
  nand4  g95(.a(new_n139_), .b(new_n138_), .c(new_n79_), .d(new_n51_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n142_));
  oai21  g98(.a(new_n62_), .b(new_n76_), .c(new_n142_), .O(z16));
endmodule
