...
module FAU ( 
  ...
  nand2  g030(.a(x20), .b(x19), .O(new_n75_));
  inv1   g031(.a(new_n75_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(x22), .c(x21), .O(new_n77_));
  nand4  g033(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n78_));
  oai21  g034(.a(new_n78_), .b(new_n77_), .c(x19), .O(new_n79_));
  nand4  g035(.a(new_n79_), .b(x11), .c(new_n48_), .d(x09), .O(new_n80_));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n47_), .c(new_n82_), .O(new_n100_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n75_), .c(x22), .O(new_n104_));
  nand3  g060(.a(new_n76_), .b(new_n46_), .c(x21), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n104_), .c(new_n82_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n107_));
  oai21  g063(.a(new_n61_), .b(new_n65_), .c(new_n107_), .O(z12));
  nand2  g064(.a(new_n97_), .b(x11), .O(new_n109_));
  nand4  g065(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n109_), .c(new_n76_), .d(x22), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x23), .O(new_n112_));
  inv1   g068(.a(x23), .O(new_n113_));
  nand4  g069(.a(new_n76_), .b(new_n113_), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n83_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n47_), .c(new_n82_), .O(new_n116_));
  ...
  oai21  g082(.a(new_n61_), .b(new_n69_), .c(new_n126_), .O(z14));
  nand3  g083(.a(x26), .b(x24), .c(x17), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(x23), .c(new_n82_), .O(new_n129_));
  nand3  g085(.a(x24), .b(x22), .c(x21), .O(new_n130_));
  ...
  nor2   g089(.a(new_n113_), .b(new_n46_), .O(new_n134_));
  nor2   g090(.a(x25), .b(new_n122_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n123_), .c(new_n134_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n83_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n47_), .c(new_n82_), .O(new_n138_));
  ...
  inv1   g099(.a(new_n77_), .O(new_n144_));
  nor2   g100(.a(new_n122_), .b(new_n113_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n45_), .d(x25), .O(new_n146_));
