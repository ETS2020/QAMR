...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n63_, new_n65_, new_n66_, new_n68_, new_n70_, new_n72_,
  ...
  nor3   g17(.a(x09), .b(new_n57_), .c(new_n45_), .O(z02));
  ...
  nand2  g28(.a(new_n72_), .b(new_n66_), .O(z07));
  ...
  nand3  g37(.a(new_n81_), .b(new_n76_), .c(new_n57_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n45_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(x09), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n60_), .O(z09));
  oai21  g41(.a(x09), .b(x08), .c(x01), .O(new_n86_));
  inv1   g42(.a(x19), .O(new_n87_));
  nand3  g43(.a(x22), .b(x21), .c(x12), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n80_), .c(x19), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(x20), .O(new_n90_));
  oai21  g46(.a(x20), .b(new_n87_), .c(new_n90_), .O(new_n91_));
  nand4  g47(.a(new_n91_), .b(new_n76_), .c(x09), .d(new_n57_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n86_), .O(z10));
  ...
  aoi21  g54(.a(new_n98_), .b(new_n57_), .c(x01), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n46_), .c(new_n63_), .O(z11));
  nand2  g56(.a(new_n59_), .b(x03), .O(new_n101_));
  ...
  nand4  g64(.a(new_n108_), .b(x09), .c(new_n57_), .d(new_n45_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n101_), .O(z12));
  ...
  nand4  g71(.a(new_n115_), .b(x09), .c(new_n57_), .d(new_n45_), .O(new_n116_));
  ...
  nand4  g79(.a(new_n123_), .b(x09), .c(new_n57_), .d(new_n45_), .O(new_n124_));
  ...
  nand4  g87(.a(new_n131_), .b(x09), .c(new_n57_), .d(new_n45_), .O(new_n132_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n106_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x10), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(x09), .c(new_n57_), .d(new_n45_), .O(new_n142_));
