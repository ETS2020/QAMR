...
module FAU ( 
  ...
  nand3  g021(.a(x10), .b(x08), .c(x03), .O(new_n66_));
  ...
  oai21  g037(.a(new_n81_), .b(x03), .c(new_n59_), .O(z09));
  ...
  oai21  g045(.a(new_n62_), .b(new_n61_), .c(new_n89_), .O(z10));
  ...
  nand3  g063(.a(x10), .b(x08), .c(x03), .O(new_n108_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n123_), .c(new_n118_), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n48_), .c(x03), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(x10), .c(new_n70_), .O(z14));
  and2   g086(.a(x23), .b(x19), .O(new_n131_));
  nand2  g087(.a(x26), .b(x17), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n131_), .c(new_n120_), .d(x24), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x25), .O(new_n134_));
  inv1   g090(.a(x25), .O(new_n135_));
  nor2   g091(.a(new_n113_), .b(new_n46_), .O(new_n136_));
  nand4  g092(.a(new_n126_), .b(new_n136_), .c(new_n135_), .d(x24), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n134_), .c(new_n118_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n48_), .c(x03), .O(new_n139_));
  ...
  nor2   g100(.a(new_n124_), .b(new_n113_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n135_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n104_), .c(new_n145_), .d(new_n77_), .O(new_n147_));
