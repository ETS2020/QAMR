...
module FAU ( 
  ...
  inv1   g024(.a(new_n55_), .O(new_n69_));
  oai21  g025(.a(new_n47_), .b(new_n68_), .c(new_n69_), .O(z06));
  nand2  g026(.a(x08), .b(x06), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n69_), .O(z07));
  inv1   g028(.a(x07), .O(new_n73_));
  oai21  g029(.a(new_n47_), .b(new_n73_), .c(new_n69_), .O(z08));
  ...
  nand2  g036(.a(new_n80_), .b(x02), .O(new_n81_));
  ...
  aoi21  g046(.a(new_n90_), .b(new_n47_), .c(new_n62_), .O(new_n91_));
  oai22  g047(.a(new_n91_), .b(x10), .c(new_n60_), .d(new_n59_), .O(z10));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n84_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n62_), .c(new_n48_), .O(new_n100_));
  oai21  g056(.a(new_n47_), .b(new_n62_), .c(new_n100_), .O(z11));
  ...
  oai21  g065(.a(new_n60_), .b(new_n64_), .c(new_n109_), .O(z12));
  ...
  nand4  g072(.a(new_n116_), .b(x09), .c(new_n47_), .d(x02), .O(new_n117_));
  oai21  g073(.a(new_n60_), .b(new_n66_), .c(new_n117_), .O(z13));
  ...
  nand4  g082(.a(new_n126_), .b(x09), .c(new_n47_), .d(x02), .O(new_n127_));
  oai21  g083(.a(new_n60_), .b(new_n68_), .c(new_n127_), .O(z14));
  inv1   g084(.a(x25), .O(new_n129_));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x23), .c(x22), .O(new_n131_));
  nand4  g087(.a(x24), .b(x21), .c(x20), .d(x19), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(x02), .c(new_n132_), .O(new_n133_));
  nor2   g089(.a(x25), .b(new_n123_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n124_), .c(x23), .d(x22), .O(new_n135_));
  oai21  g091(.a(new_n133_), .b(new_n129_), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x09), .c(new_n47_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x02), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n48_), .O(new_n139_));
  ...
  nor2   g100(.a(new_n123_), .b(new_n114_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n129_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n106_), .c(new_n145_), .d(new_n76_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(x10), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(x09), .c(new_n47_), .d(x02), .O(new_n149_));
  oai21  g105(.a(new_n60_), .b(new_n73_), .c(new_n149_), .O(z16));
endmodule
