...
module FAU ( 
  ...
  nand2  g26(.a(new_n62_), .b(x04), .O(new_n71_));
  ...
  nand2  g32(.a(new_n62_), .b(x07), .O(new_n77_));
  ...
  nand2  g43(.a(new_n49_), .b(x19), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n90_));
  ...
  nand4  g52(.a(new_n96_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n106_));
  ...
  nand4  g68(.a(new_n112_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n113_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n141_));
