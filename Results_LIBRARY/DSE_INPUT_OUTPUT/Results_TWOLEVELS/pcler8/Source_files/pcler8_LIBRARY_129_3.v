...
module FAU ( 
  ...
  nand2  g16(.a(new_n57_), .b(x01), .O(new_n61_));
  ...
  oai21  g46(.a(new_n90_), .b(new_n52_), .c(x20), .O(new_n91_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n52_), .c(x21), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n48_), .c(x22), .O(new_n99_));
  nand3  g55(.a(new_n49_), .b(new_n51_), .c(x21), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n102_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n48_), .c(x23), .O(new_n106_));
  nand4  g62(.a(new_n49_), .b(new_n46_), .c(x22), .d(x21), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n67_), .O(z13));
  inv1   g66(.a(x24), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(x22), .c(x21), .O(new_n112_));
  nand4  g68(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n113_));
  oai21  g69(.a(new_n112_), .b(new_n48_), .c(new_n113_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(x23), .O(new_n115_));
  nor2   g71(.a(new_n46_), .b(new_n51_), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n49_), .c(x21), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x24), .c(new_n45_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n115_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(x09), .c(new_n47_), .O(new_n120_));
  ...
  nand4  g83(.a(new_n127_), .b(new_n116_), .c(new_n126_), .d(x24), .O(new_n128_));
  ...
  nor2   g91(.a(new_n111_), .b(new_n46_), .O(new_n136_));
