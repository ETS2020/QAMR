...
module FAU ( 
  ...
  oai21  g024(.a(new_n47_), .b(new_n68_), .c(new_n65_), .O(z05));
  inv1   g025(.a(x05), .O(new_n70_));
  oai21  g026(.a(new_n47_), .b(new_n70_), .c(new_n65_), .O(z06));
  inv1   g027(.a(x06), .O(new_n72_));
  nor2   g028(.a(new_n59_), .b(new_n72_), .O(z07));
  ...
  aoi21  g045(.a(new_n89_), .b(new_n47_), .c(x17), .O(new_n90_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n47_), .c(x17), .O(new_n99_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n47_), .c(x17), .O(new_n108_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(x17), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n116_));
  oai21  g072(.a(new_n59_), .b(new_n68_), .c(new_n116_), .O(z13));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n121_), .c(x17), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n126_));
  oai21  g082(.a(new_n59_), .b(new_n70_), .c(new_n126_), .O(z14));
  aoi21  g083(.a(x23), .b(x22), .c(x17), .O(new_n128_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n130_), .c(new_n83_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n47_), .c(x17), .O(new_n135_));
  oai22  g091(.a(new_n135_), .b(x10), .c(new_n59_), .d(new_n72_), .O(z15));
  ...
  nand4  g098(.a(new_n142_), .b(new_n105_), .c(new_n141_), .d(new_n77_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(x17), .O(new_n144_));
