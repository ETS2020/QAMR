...
module FAU ( 
  ...
  nand2  g015(.a(new_n59_), .b(new_n54_), .O(z02));
  ...
  aoi21  g049(.a(new_n93_), .b(new_n92_), .c(x08), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(x10), .c(x09), .O(new_n95_));
  ...
  nand3  g079(.a(x23), .b(x22), .c(x21), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n47_), .O(new_n125_));
  nand2  g081(.a(x26), .b(x17), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n125_), .c(new_n101_), .d(x24), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x25), .O(new_n128_));
  inv1   g084(.a(x25), .O(new_n129_));
  nor2   g085(.a(new_n109_), .b(new_n74_), .O(new_n130_));
  nand4  g086(.a(new_n119_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n128_), .c(x08), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(x10), .c(x09), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n69_), .O(z15));
  nor2   g090(.a(new_n83_), .b(x18), .O(new_n135_));
  nand3  g091(.a(x25), .b(x24), .c(x20), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(new_n125_), .O(new_n138_));
