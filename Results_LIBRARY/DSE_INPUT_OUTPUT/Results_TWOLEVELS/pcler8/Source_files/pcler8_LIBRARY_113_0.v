...
module FAU ( 
  ...
  nor3   g017(.a(new_n54_), .b(new_n46_), .c(new_n61_), .O(z03));
  nand2  g018(.a(x08), .b(x03), .O(new_n63_));
  nand2  g019(.a(new_n63_), .b(new_n58_), .O(z04));
  nand2  g020(.a(x08), .b(x04), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n58_), .O(z05));
  nand2  g022(.a(new_n55_), .b(x05), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(z06));
  nand2  g024(.a(new_n55_), .b(x06), .O(new_n69_));
  inv1   g025(.a(new_n69_), .O(z07));
  nand2  g026(.a(new_n55_), .b(x07), .O(new_n71_));
  nand2  g027(.a(new_n71_), .b(new_n58_), .O(z08));
  ...
  nand3  g042(.a(new_n86_), .b(new_n59_), .c(new_n58_), .O(z10));
  nand2  g043(.a(x20), .b(x19), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(new_n89_));
  nand3  g045(.a(new_n73_), .b(x20), .c(x19), .O(new_n90_));
  oai21  g046(.a(new_n89_), .b(new_n73_), .c(new_n90_), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n92_));
  oai21  g048(.a(new_n46_), .b(new_n61_), .c(new_n92_), .O(new_n93_));
  ...
  nor3   g054(.a(new_n98_), .b(new_n97_), .c(new_n74_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(x09), .d(new_n46_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n94_), .O(z11));
  nand2  g057(.a(x23), .b(x14), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n98_), .c(x21), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n88_), .c(x22), .O(new_n104_));
  nand3  g060(.a(new_n89_), .b(new_n74_), .c(x21), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n63_), .c(new_n58_), .O(z12));
  nand3  g064(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n109_));
  nand2  g065(.a(new_n89_), .b(new_n75_), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n109_), .c(x11), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n97_), .O(new_n112_));
  nand4  g068(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n89_), .c(x22), .d(x21), .O(new_n114_));
  ...
  oai22  g089(.a(new_n133_), .b(new_n131_), .c(new_n119_), .d(new_n130_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x23), .O(new_n135_));
  nand3  g091(.a(x24), .b(x23), .c(x22), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n131_), .c(x25), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n69_), .c(new_n58_), .O(z15));
  nor2   g096(.a(new_n88_), .b(x18), .O(new_n141_));
  ...
  nor2   g101(.a(new_n145_), .b(new_n131_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(x23), .O(new_n147_));
  nand3  g103(.a(x26), .b(new_n97_), .c(x11), .O(new_n148_));
