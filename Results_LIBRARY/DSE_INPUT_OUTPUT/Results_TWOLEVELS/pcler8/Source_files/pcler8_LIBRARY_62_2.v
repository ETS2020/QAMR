...
module FAU ( 
  ...
  oai21  g09(.a(new_n53_), .b(new_n52_), .c(new_n46_), .O(z02));
  nand2  g10(.a(x08), .b(x02), .O(new_n55_));
  nand2  g11(.a(new_n55_), .b(new_n46_), .O(z03));
  inv1   g12(.a(x03), .O(new_n57_));
  nor2   g13(.a(new_n50_), .b(new_n57_), .O(z04));
  inv1   g14(.a(x04), .O(new_n59_));
  nor2   g15(.a(new_n50_), .b(new_n59_), .O(z05));
  inv1   g16(.a(x05), .O(new_n61_));
  oai21  g17(.a(new_n53_), .b(new_n61_), .c(new_n46_), .O(z06));
  inv1   g18(.a(x06), .O(new_n63_));
  nor2   g19(.a(new_n50_), .b(new_n63_), .O(z07));
  nand2  g20(.a(x08), .b(x07), .O(new_n65_));
  nand2  g21(.a(new_n65_), .b(new_n46_), .O(z08));
  oai21  g22(.a(new_n53_), .b(new_n48_), .c(new_n46_), .O(z09));
  nor2   g23(.a(new_n50_), .b(new_n52_), .O(z10));
  oai21  g24(.a(new_n53_), .b(new_n57_), .c(new_n46_), .O(z12));
  nor2   g25(.a(new_n50_), .b(new_n61_), .O(z14));
  nand2  g26(.a(new_n55_), .b(new_n46_), .O(z11));
  nor2   g27(.a(new_n50_), .b(new_n59_), .O(z13));
  nor2   g28(.a(new_n50_), .b(new_n63_), .O(z15));
