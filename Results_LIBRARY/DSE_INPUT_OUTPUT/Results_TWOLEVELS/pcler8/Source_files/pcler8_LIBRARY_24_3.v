...
module FAU ( 
  ...
  oai21  g21(.a(new_n46_), .b(new_n65_), .c(new_n55_), .O(z05));
  ...
  oai21  g59(.a(new_n57_), .b(new_n63_), .c(new_n103_), .O(z12));
  ...
  oai21  g67(.a(new_n57_), .b(new_n65_), .c(new_n111_), .O(z13));
  inv1   g68(.a(x24), .O(new_n113_));
  nand3  g69(.a(x22), .b(x21), .c(x20), .O(new_n114_));
  nand3  g70(.a(x26), .b(x25), .c(x16), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(x23), .c(x19), .O(new_n116_));
  aoi21  g72(.a(new_n114_), .b(new_n47_), .c(new_n116_), .O(new_n117_));
  nor2   g73(.a(x24), .b(new_n108_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n100_), .c(new_n75_), .d(new_n47_), .O(new_n119_));
  oai21  g75(.a(new_n117_), .b(new_n113_), .c(new_n119_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(x09), .c(new_n46_), .O(new_n121_));
  ...
  oai21  g82(.a(new_n125_), .b(new_n123_), .c(new_n126_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x24), .O(new_n128_));
  nor2   g84(.a(new_n113_), .b(new_n108_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(x22), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n123_), .c(x25), .O(new_n131_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n100_), .c(new_n129_), .d(new_n75_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n138_), .O(new_n141_));
