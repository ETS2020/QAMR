...
module FAU ( 
  ...
  nand2  g16(.a(x10), .b(new_n54_), .O(new_n61_));
  oai21  g17(.a(new_n46_), .b(new_n60_), .c(new_n61_), .O(z03));
  ...
  nor2   g28(.a(new_n64_), .b(new_n72_), .O(z08));
  ...
  nand3  g36(.a(new_n80_), .b(new_n56_), .c(new_n61_), .O(z09));
  ...
  oai21  g51(.a(new_n64_), .b(new_n60_), .c(new_n95_), .O(z11));
  ...
  nand3  g68(.a(new_n112_), .b(new_n66_), .c(new_n61_), .O(z13));
  ...
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n61_), .O(z14));
