...
module FAU ( 
  ...
  aoi21  g15(.a(new_n59_), .b(new_n57_), .c(new_n58_), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(new_n61_));
  nor2   g17(.a(new_n61_), .b(new_n56_), .O(z01));
  ...
  nor2   g24(.a(new_n58_), .b(new_n57_), .O(z05));
  ...
  nand4  g36(.a(new_n80_), .b(new_n59_), .c(x09), .d(new_n58_), .O(new_n81_));
  oai22  g37(.a(new_n81_), .b(new_n57_), .c(new_n61_), .d(new_n56_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(x09), .c(new_n58_), .d(x04), .O(new_n89_));
  oai21  g45(.a(new_n61_), .b(new_n63_), .c(new_n89_), .O(z10));
  inv1   g46(.a(x19), .O(new_n91_));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n52_), .c(x20), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n91_), .c(x21), .O(new_n94_));
  nand3  g50(.a(new_n76_), .b(x20), .c(x19), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n94_), .c(x10), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(x09), .c(new_n58_), .d(x04), .O(new_n97_));
  oai21  g53(.a(new_n61_), .b(new_n65_), .c(new_n97_), .O(z11));
  ...
  nand4  g61(.a(new_n105_), .b(x09), .c(new_n58_), .d(x04), .O(new_n106_));
  ...
  nand3  g68(.a(new_n112_), .b(new_n59_), .c(x09), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n58_), .c(new_n57_), .O(z13));
  nand3  g70(.a(x22), .b(x21), .c(x20), .O(new_n115_));
  nand2  g71(.a(new_n115_), .b(x04), .O(new_n116_));
  nand3  g72(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n116_), .c(x23), .d(x19), .O(new_n118_));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n58_), .c(new_n57_), .O(new_n123_));
  ...
  nand4  g86(.a(new_n130_), .b(x09), .c(new_n58_), .d(x04), .O(new_n131_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n103_), .c(new_n137_), .d(new_n77_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x10), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(x09), .c(new_n58_), .d(x04), .O(new_n141_));
