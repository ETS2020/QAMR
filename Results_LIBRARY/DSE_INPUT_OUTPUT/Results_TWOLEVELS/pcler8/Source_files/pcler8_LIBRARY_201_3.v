...
module FAU ( 
  ...
  oai21  g39(.a(new_n55_), .b(new_n59_), .c(new_n83_), .O(z10));
  ...
  aoi21  g60(.a(new_n104_), .b(x20), .c(x10), .O(new_n105_));
  nand3  g61(.a(x22), .b(x21), .c(x19), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n105_), .c(x23), .O(new_n107_));
  ...
  nor2   g78(.a(new_n108_), .b(new_n98_), .O(new_n123_));
  ...
  oai21  g88(.a(new_n132_), .b(x18), .c(new_n47_), .O(new_n133_));
  nand3  g89(.a(x25), .b(x22), .c(x21), .O(new_n134_));
  nor2   g90(.a(new_n134_), .b(new_n94_), .O(new_n135_));
  ...
  oai21  g95(.a(new_n139_), .b(new_n136_), .c(new_n46_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n47_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(x09), .O(new_n142_));
