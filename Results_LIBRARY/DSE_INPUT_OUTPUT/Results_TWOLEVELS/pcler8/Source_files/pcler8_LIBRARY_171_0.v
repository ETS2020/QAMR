...
module FAU ( 
  ...
  nor2   g009(.a(x24), .b(x15), .O(new_n54_));
  nor2   g010(.a(new_n54_), .b(new_n46_), .O(new_n55_));
  nand2  g011(.a(new_n55_), .b(x00), .O(new_n56_));
  inv1   g012(.a(new_n56_), .O(z01));
  nand2  g013(.a(new_n55_), .b(x01), .O(new_n58_));
  inv1   g014(.a(new_n58_), .O(z02));
  inv1   g015(.a(new_n54_), .O(new_n60_));
  nand2  g016(.a(x08), .b(x02), .O(new_n61_));
  nand2  g017(.a(new_n61_), .b(new_n60_), .O(z03));
  and2   g018(.a(new_n55_), .b(x03), .O(z04));
  ...
  nand2  g024(.a(new_n68_), .b(new_n60_), .O(z07));
  nand2  g025(.a(new_n55_), .b(x07), .O(new_n70_));
  ...
  nand3  g034(.a(new_n78_), .b(new_n56_), .c(new_n60_), .O(z09));
  ...
  nand3  g041(.a(new_n85_), .b(new_n58_), .c(new_n60_), .O(z10));
  ...
  oai21  g045(.a(new_n89_), .b(new_n80_), .c(x21), .O(new_n90_));
  nand3  g046(.a(new_n72_), .b(x20), .c(x19), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n61_), .c(new_n60_), .O(z11));
  nand3  g050(.a(x21), .b(x20), .c(x19), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(x22), .O(new_n96_));
  nand2  g052(.a(x20), .b(x19), .O(new_n97_));
  nand2  g053(.a(new_n73_), .b(x21), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n100_));
  nand2  g056(.a(x08), .b(x03), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n60_), .O(new_n103_));
  inv1   g059(.a(x09), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(x08), .O(new_n105_));
  inv1   g061(.a(x23), .O(new_n106_));
  nor3   g062(.a(new_n88_), .b(new_n106_), .c(new_n73_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n105_), .c(x14), .d(new_n47_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n103_), .O(z12));
  nand4  g065(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x22), .c(x21), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n97_), .c(x23), .O(new_n112_));
  inv1   g068(.a(new_n97_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n106_), .c(x22), .d(x21), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n64_), .c(new_n60_), .O(z13));
  inv1   g073(.a(x24), .O(new_n118_));
  nand3  g074(.a(new_n105_), .b(x19), .c(new_n47_), .O(new_n119_));
  nand4  g075(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n120_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n96_), .c(new_n118_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n122_), .c(new_n66_), .O(z14));
  inv1   g084(.a(new_n95_), .O(new_n129_));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n129_), .c(x23), .d(x22), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x23), .c(x22), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n95_), .O(new_n134_));
  aoi21  g090(.a(new_n131_), .b(x25), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(x25), .b(new_n118_), .c(x15), .O(new_n136_));
  oai21  g092(.a(new_n135_), .b(new_n118_), .c(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n68_), .O(z15));
  nand3  g095(.a(new_n105_), .b(x26), .c(new_n47_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x15), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n118_), .O(new_n142_));
  inv1   g098(.a(x18), .O(new_n143_));
  nand2  g099(.a(new_n113_), .b(new_n143_), .O(new_n144_));
  nand3  g100(.a(new_n74_), .b(x25), .c(x23), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n144_), .c(x26), .O(new_n146_));
  nor2   g102(.a(new_n118_), .b(new_n106_), .O(new_n147_));
  nor2   g103(.a(x26), .b(new_n132_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n113_), .c(new_n147_), .d(new_n74_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n142_), .c(new_n70_), .O(z16));
endmodule
