...
module FAU ( 
  ...
  oai21  g21(.a(new_n57_), .b(new_n64_), .c(new_n65_), .O(z03));
  ...
  inv1   g27(.a(new_n59_), .O(new_n72_));
  ...
  aoi21  g38(.a(new_n82_), .b(new_n57_), .c(new_n78_), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(x10), .c(new_n60_), .O(z09));
  ...
  nand4  g52(.a(new_n96_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n97_));
  oai21  g53(.a(new_n72_), .b(new_n64_), .c(new_n97_), .O(z11));
  oai21  g54(.a(x20), .b(new_n78_), .c(x19), .O(new_n99_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n123_));
  ...
  nand4  g86(.a(new_n130_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n131_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n85_), .c(x09), .d(new_n57_), .O(new_n141_));
