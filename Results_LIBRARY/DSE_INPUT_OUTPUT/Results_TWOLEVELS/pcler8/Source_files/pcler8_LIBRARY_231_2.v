...
module FAU ( 
  ...
  oai21  g22(.a(new_n61_), .b(new_n58_), .c(new_n46_), .O(z13));
  nor2   g23(.a(new_n50_), .b(new_n60_), .O(z14));
  oai21  g24(.a(new_n61_), .b(new_n63_), .c(new_n46_), .O(z15));
  nor2   g25(.a(new_n50_), .b(new_n48_), .O(z09));
  nor2   g26(.a(new_n50_), .b(new_n52_), .O(z10));
  nor2   g27(.a(new_n50_), .b(new_n54_), .O(z11));
  nor2   g28(.a(new_n50_), .b(new_n56_), .O(z12));
