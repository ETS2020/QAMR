...
module FAU ( 
  ...
  nand2  g023(.a(new_n59_), .b(x05), .O(new_n68_));
  ...
  nor2   g030(.a(new_n74_), .b(new_n54_), .O(new_n75_));
  ...
  nand2  g046(.a(new_n90_), .b(new_n60_), .O(z10));
  ...
  nand3  g052(.a(new_n54_), .b(x20), .c(x19), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n62_), .O(z11));
  nand2  g056(.a(x23), .b(x14), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n94_), .c(x20), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n92_), .c(x22), .O(new_n103_));
  nand3  g059(.a(new_n74_), .b(x20), .c(x19), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x21), .O(new_n106_));
  nand3  g062(.a(x22), .b(new_n54_), .c(new_n47_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x09), .c(new_n46_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n64_), .c(new_n56_), .O(z12));
  nor2   g066(.a(new_n87_), .b(new_n92_), .O(new_n111_));
  nor2   g067(.a(x23), .b(new_n74_), .O(new_n112_));
  nand2  g068(.a(x23), .b(x15), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n94_), .O(new_n114_));
  aoi21  g070(.a(new_n112_), .b(new_n111_), .c(new_n114_), .O(new_n115_));
  nand2  g071(.a(new_n111_), .b(new_n75_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n77_), .c(new_n115_), .d(new_n54_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n66_), .O(z13));
  nor2   g076(.a(new_n77_), .b(new_n74_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x21), .O(new_n122_));
  nand3  g078(.a(x26), .b(x25), .c(x16), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x20), .c(x19), .O(new_n124_));
  aoi22  g080(.a(new_n124_), .b(x21), .c(new_n122_), .d(new_n47_), .O(new_n125_));
  nand3  g081(.a(x21), .b(x20), .c(x19), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n78_), .c(x23), .d(x22), .O(new_n128_));
  oai21  g084(.a(new_n125_), .b(new_n78_), .c(new_n128_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x09), .c(new_n46_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n68_), .c(new_n56_), .O(z14));
  inv1   g087(.a(x25), .O(new_n132_));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x20), .c(x19), .O(new_n134_));
  nand2  g090(.a(new_n79_), .b(new_n75_), .O(new_n135_));
  aoi22  g091(.a(new_n135_), .b(new_n47_), .c(new_n134_), .d(x21), .O(new_n136_));
  nand4  g092(.a(new_n127_), .b(new_n121_), .c(new_n132_), .d(x24), .O(new_n137_));
  oai21  g093(.a(new_n136_), .b(new_n132_), .c(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x09), .c(new_n46_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n70_), .c(new_n56_), .O(z15));
  nor2   g096(.a(new_n111_), .b(new_n54_), .O(new_n141_));
  inv1   g097(.a(x18), .O(new_n142_));
  nor2   g098(.a(new_n132_), .b(new_n78_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n75_), .c(x23), .d(new_n142_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n47_), .c(new_n141_), .O(new_n145_));
  nand4  g101(.a(new_n117_), .b(new_n79_), .c(new_n45_), .d(x25), .O(new_n146_));
  oai21  g102(.a(new_n145_), .b(new_n45_), .c(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x09), .c(new_n46_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n72_), .c(new_n56_), .O(z16));
endmodule
