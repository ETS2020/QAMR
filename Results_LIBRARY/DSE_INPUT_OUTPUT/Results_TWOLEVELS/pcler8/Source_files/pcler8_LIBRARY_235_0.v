...
module FAU ( 
  ...
  inv1   g32(.a(new_n62_), .O(new_n77_));
  ...
  oai21  g39(.a(new_n77_), .b(new_n57_), .c(new_n83_), .O(z09));
  ...
  oai21  g62(.a(new_n77_), .b(new_n67_), .c(new_n106_), .O(z12));
  ...
  oai21  g69(.a(new_n77_), .b(new_n69_), .c(new_n113_), .O(z13));
