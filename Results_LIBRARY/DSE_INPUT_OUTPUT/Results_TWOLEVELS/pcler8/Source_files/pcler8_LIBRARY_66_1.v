...
module FAU ( 
  ...
  oai21  g22(.a(new_n46_), .b(new_n66_), .c(new_n60_), .O(z05));
  ...
  oai21  g60(.a(new_n64_), .b(new_n63_), .c(new_n104_), .O(z12));
  ...
  oai21  g68(.a(new_n64_), .b(new_n66_), .c(new_n112_), .O(z13));
  ...
  oai21  g87(.a(new_n64_), .b(new_n70_), .c(new_n131_), .O(z15));
  ...
  oai21  g97(.a(new_n64_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
