...
module FAU ( 
  ...
  aoi21  g11(.a(x23), .b(new_n55_), .c(new_n46_), .O(new_n56_));
  inv1   g12(.a(new_n56_), .O(new_n57_));
  nor2   g13(.a(new_n57_), .b(new_n54_), .O(z01));
  nand2  g14(.a(x23), .b(new_n55_), .O(new_n59_));
  ...
  nor2   g37(.a(new_n45_), .b(new_n81_), .O(new_n82_));
  ...
  oai21  g41(.a(new_n57_), .b(new_n54_), .c(new_n85_), .O(z09));
  xnor2a g42(.a(x20), .b(x19), .O(new_n87_));
  nand3  g43(.a(new_n76_), .b(x20), .c(x12), .O(new_n88_));
  oai22  g44(.a(new_n88_), .b(new_n83_), .c(new_n87_), .d(new_n55_), .O(new_n89_));
  nand3  g45(.a(new_n89_), .b(new_n47_), .c(new_n46_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(new_n60_), .c(new_n59_), .O(z10));
  nand4  g47(.a(x21), .b(x13), .c(new_n47_), .d(new_n46_), .O(new_n92_));
  nand3  g48(.a(new_n82_), .b(x24), .c(x22), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n92_), .c(x09), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(x23), .O(new_n95_));
  nand2  g51(.a(x20), .b(x19), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  nand3  g53(.a(new_n74_), .b(x20), .c(x19), .O(new_n98_));
  oai21  g54(.a(new_n97_), .b(new_n74_), .c(new_n98_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n100_));
  nand3  g56(.a(new_n100_), .b(new_n95_), .c(new_n62_), .O(z11));
  nand2  g57(.a(x23), .b(x14), .O(new_n102_));
  nand3  g58(.a(x26), .b(x25), .c(x24), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n102_), .c(x21), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n96_), .c(x22), .O(new_n105_));
  nand3  g61(.a(new_n97_), .b(new_n75_), .c(x21), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n108_));
  oai21  g64(.a(new_n57_), .b(new_n64_), .c(new_n108_), .O(z12));
  ...
  nand4  g68(.a(new_n97_), .b(new_n78_), .c(x22), .d(x21), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  oai21  g71(.a(new_n57_), .b(new_n66_), .c(new_n115_), .O(z13));
  nand3  g72(.a(new_n79_), .b(x22), .c(x21), .O(new_n117_));
  nand4  g73(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n118_));
  oai21  g74(.a(new_n117_), .b(new_n96_), .c(new_n118_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(x23), .O(new_n120_));
  nand3  g76(.a(x23), .b(x22), .c(x21), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n96_), .c(x24), .O(new_n122_));
  ...
  nand3  g82(.a(new_n81_), .b(x24), .c(x22), .O(new_n127_));
  nand3  g83(.a(x26), .b(x25), .c(x17), .O(new_n128_));
  oai21  g84(.a(new_n127_), .b(new_n126_), .c(new_n128_), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(x23), .O(new_n130_));
  nand2  g86(.a(new_n80_), .b(x22), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n126_), .c(x25), .O(new_n132_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n97_), .c(new_n80_), .d(new_n76_), .O(new_n141_));
