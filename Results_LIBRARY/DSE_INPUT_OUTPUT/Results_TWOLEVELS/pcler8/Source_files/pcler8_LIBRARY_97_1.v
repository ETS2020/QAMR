...
module FAU ( 
  ...
  nand2  g27(.a(new_n71_), .b(new_n61_), .O(z06));
  nand2  g28(.a(x08), .b(x06), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n61_), .O(z07));
  nand2  g30(.a(new_n59_), .b(x07), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n61_), .O(z08));
  inv1   g32(.a(x19), .O(new_n77_));
  nand3  g33(.a(new_n77_), .b(x09), .c(new_n57_), .O(new_n78_));
  aoi21  g34(.a(new_n78_), .b(new_n45_), .c(x10), .O(new_n79_));
  or2    g35(.a(new_n79_), .b(z01), .O(z09));
  ...
  aoi21  g43(.a(new_n87_), .b(new_n57_), .c(x11), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(x10), .c(new_n62_), .O(z10));
  inv1   g45(.a(x10), .O(new_n90_));
  nand3  g46(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n53_), .c(x20), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n77_), .c(x21), .O(new_n93_));
  inv1   g49(.a(x21), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(x20), .c(x19), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n93_), .c(x11), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n90_), .c(x09), .d(new_n57_), .O(new_n97_));
  oai21  g53(.a(new_n65_), .b(new_n64_), .c(new_n97_), .O(z11));
  nor2   g54(.a(new_n85_), .b(new_n77_), .O(new_n99_));
  ...
  aoi21  g60(.a(new_n104_), .b(new_n103_), .c(x11), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n90_), .c(x09), .d(new_n57_), .O(new_n106_));
  ...
  aoi21  g67(.a(new_n111_), .b(new_n110_), .c(x11), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n90_), .c(x09), .d(new_n57_), .O(new_n113_));
  ...
  oai21  g72(.a(new_n116_), .b(new_n48_), .c(x24), .O(new_n117_));
  inv1   g73(.a(x24), .O(new_n118_));
  nand4  g74(.a(new_n49_), .b(new_n118_), .c(x23), .d(x22), .O(new_n119_));
  aoi21  g75(.a(new_n119_), .b(new_n117_), .c(x11), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n90_), .c(x09), .d(new_n57_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n71_), .O(z14));
  ...
  nand3  g81(.a(new_n125_), .b(new_n124_), .c(x19), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n52_), .b(new_n49_), .c(new_n128_), .d(x24), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n127_), .c(new_n46_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n57_), .c(x11), .O(new_n131_));
  ...
  nor2   g92(.a(new_n50_), .b(new_n94_), .O(new_n137_));
  nor2   g93(.a(new_n118_), .b(new_n51_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n128_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n99_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n136_), .c(x11), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n90_), .c(x09), .d(new_n57_), .O(new_n142_));
