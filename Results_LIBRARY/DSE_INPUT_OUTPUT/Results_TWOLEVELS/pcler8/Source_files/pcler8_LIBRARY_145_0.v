...
module FAU ( 
  ...
  oai21  g20(.a(new_n58_), .b(new_n63_), .c(new_n64_), .O(z02));
  nand2  g21(.a(new_n60_), .b(x02), .O(new_n66_));
  inv1   g22(.a(new_n66_), .O(z03));
  inv1   g23(.a(x03), .O(new_n68_));
  nor2   g24(.a(new_n61_), .b(new_n68_), .O(z04));
  ...
  nand2  g30(.a(new_n74_), .b(new_n64_), .O(z07));
  ...
  nand4  g61(.a(new_n105_), .b(new_n85_), .c(x09), .d(new_n58_), .O(new_n106_));
  oai21  g62(.a(new_n61_), .b(new_n68_), .c(new_n106_), .O(z12));
  ...
  oai21  g68(.a(new_n112_), .b(new_n78_), .c(new_n85_), .O(new_n113_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n85_), .c(x09), .d(new_n58_), .O(new_n123_));
  ...
  oai21  g87(.a(new_n131_), .b(new_n78_), .c(new_n85_), .O(new_n132_));
  ...
  nand4  g97(.a(new_n141_), .b(new_n85_), .c(x09), .d(new_n58_), .O(new_n142_));
