...
module FAU ( 
  ...
  nand4  g07(.a(new_n51_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n52_));
  ...
  nor2   g15(.a(new_n46_), .b(new_n48_), .O(new_n60_));
  and2   g16(.a(new_n60_), .b(x00), .O(z01));
  nand2  g17(.a(new_n60_), .b(x01), .O(new_n62_));
  ...
  nand4  g35(.a(new_n79_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n80_));
  nand2  g36(.a(x08), .b(x00), .O(new_n81_));
  aoi21  g37(.a(new_n81_), .b(new_n80_), .c(new_n46_), .O(z09));
  ...
  nand3  g58(.a(new_n102_), .b(new_n66_), .c(new_n47_), .O(z12));
  nand4  g59(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x22), .c(x21), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n50_), .c(x23), .O(new_n106_));
  nand4  g62(.a(new_n51_), .b(new_n54_), .c(x22), .d(x21), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n68_), .c(new_n47_), .O(z13));
  ...
  oai21  g72(.a(new_n116_), .b(new_n111_), .c(new_n114_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n70_), .c(new_n47_), .O(z14));
  nand3  g75(.a(x24), .b(x23), .c(x22), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n111_), .c(x25), .O(new_n121_));
  inv1   g77(.a(x25), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(x24), .c(x23), .d(x22), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n111_), .c(new_n121_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n125_));
  nand2  g81(.a(x08), .b(x06), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n125_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  nand4  g84(.a(x26), .b(x25), .c(x17), .d(x16), .O(new_n129_));
  ...
  nand3  g90(.a(new_n55_), .b(x25), .c(x24), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n134_), .c(x26), .O(new_n136_));
  nor2   g92(.a(new_n115_), .b(new_n54_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n122_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n76_), .d(new_n51_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n73_), .c(new_n47_), .O(z16));
endmodule
