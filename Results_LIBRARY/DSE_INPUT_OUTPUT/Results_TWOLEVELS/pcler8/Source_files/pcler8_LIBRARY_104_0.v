...
module FAU ( 
  ...
  oai21  g61(.a(new_n57_), .b(new_n64_), .c(new_n105_), .O(z12));
  ...
  oai21  g69(.a(new_n57_), .b(new_n66_), .c(new_n113_), .O(z13));
  ...
  aoi21  g84(.a(new_n127_), .b(x09), .c(new_n128_), .O(new_n129_));
  ...
  aoi21  g88(.a(new_n132_), .b(new_n46_), .c(new_n89_), .O(new_n133_));
