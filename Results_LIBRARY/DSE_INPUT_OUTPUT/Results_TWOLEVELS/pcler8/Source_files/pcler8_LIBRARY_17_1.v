...
module FAU ( 
  ...
  aoi21  g053(.a(new_n97_), .b(new_n47_), .c(x11), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(x10), .c(new_n62_), .O(z11));
  ...
  oai21  g081(.a(new_n70_), .b(new_n69_), .c(new_n125_), .O(z14));
  ...
  nor2   g095(.a(new_n46_), .b(new_n95_), .O(new_n140_));
  nor2   g096(.a(new_n121_), .b(new_n112_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n104_), .c(new_n141_), .d(new_n140_), .O(new_n143_));
