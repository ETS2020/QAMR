...
module FAU ( 
  ...
  aoi21  g35(.a(new_n80_), .b(new_n52_), .c(x24), .O(new_n81_));
  ...
  nand4  g42(.a(new_n87_), .b(new_n47_), .c(x09), .d(new_n52_), .O(new_n88_));
  oai21  g43(.a(new_n49_), .b(new_n57_), .c(new_n88_), .O(z12));
  ...
  nand3  g51(.a(x19), .b(x09), .c(new_n52_), .O(new_n97_));
  ...
  oai21  g55(.a(new_n49_), .b(new_n61_), .c(new_n100_), .O(z14));
  nand2  g56(.a(x25), .b(x09), .O(new_n102_));
  oai21  g57(.a(new_n102_), .b(x08), .c(new_n72_), .O(new_n103_));
  nand2  g58(.a(new_n103_), .b(new_n47_), .O(new_n104_));
  oai21  g59(.a(new_n49_), .b(new_n63_), .c(new_n104_), .O(z15));
  nand4  g60(.a(new_n68_), .b(x26), .c(new_n72_), .d(new_n47_), .O(new_n106_));
