...
module FAU ( 
  ...
  nand4  g43(.a(new_n87_), .b(new_n46_), .c(x09), .d(new_n76_), .O(new_n88_));
  ...
  nand3  g48(.a(new_n77_), .b(x20), .c(x19), .O(new_n93_));
  ...
  nand3  g57(.a(new_n101_), .b(new_n50_), .c(x21), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n46_), .c(x09), .d(new_n76_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n66_), .O(z12));
  nand2  g61(.a(new_n77_), .b(new_n46_), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n106_), .c(new_n101_), .d(x22), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x23), .O(new_n109_));
  nand4  g65(.a(new_n101_), .b(new_n51_), .c(x22), .d(x21), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(x08), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(x10), .c(x09), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n68_), .O(z13));
  ...
  nand4  g77(.a(new_n121_), .b(new_n46_), .c(x09), .d(new_n76_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n70_), .O(z14));
  aoi21  g79(.a(new_n51_), .b(new_n46_), .c(new_n50_), .O(new_n124_));
  aoi21  g80(.a(x26), .b(x17), .c(new_n118_), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(new_n124_), .c(new_n119_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n119_), .b(new_n52_), .c(new_n128_), .d(x24), .O(new_n129_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n101_), .c(new_n137_), .d(new_n78_), .O(new_n139_));
