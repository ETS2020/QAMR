...
module FAU ( 
  ...
  nand2  g45(.a(new_n89_), .b(new_n78_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n97_), .b(new_n92_), .c(new_n78_), .O(new_n98_));
  ...
  nand4  g62(.a(new_n106_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n107_));
  oai21  g63(.a(new_n68_), .b(new_n67_), .c(new_n107_), .O(z12));
  ...
  nand4  g69(.a(new_n113_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n114_));
  oai21  g70(.a(new_n68_), .b(new_n70_), .c(new_n114_), .O(z13));
  aoi21  g71(.a(x22), .b(x21), .c(new_n92_), .O(new_n116_));
  nand3  g72(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(x23), .c(x20), .d(x19), .O(new_n118_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n120_), .c(x23), .d(x22), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n119_), .c(x08), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n92_), .c(new_n78_), .O(new_n125_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n121_), .c(x25), .O(new_n129_));
  ...
  oai21  g88(.a(new_n132_), .b(new_n92_), .c(new_n78_), .O(new_n133_));
  ...
  oai21  g98(.a(new_n142_), .b(new_n92_), .c(new_n78_), .O(new_n143_));
