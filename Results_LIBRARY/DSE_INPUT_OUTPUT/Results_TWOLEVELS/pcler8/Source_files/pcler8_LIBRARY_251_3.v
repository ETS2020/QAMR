// Benchmark "FAU" written by ABC on Wed Aug 19 15:37:27 2020
...
module FAU ( 
  ...
  nand2  g010(.a(x10), .b(x09), .O(new_n55_));
  ...
  nand2  g016(.a(new_n58_), .b(x02), .O(new_n61_));
  ...
  nand2  g042(.a(new_n86_), .b(new_n59_), .O(z10));
  ...
  nand2  g050(.a(new_n94_), .b(new_n61_), .O(z11));
  oai21  g051(.a(x20), .b(x10), .c(x19), .O(new_n96_));
  ...
  nand3  g057(.a(new_n101_), .b(new_n74_), .c(x21), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n99_), .c(x08), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(x10), .c(x09), .O(new_n104_));
  ...
  oai21  g063(.a(new_n107_), .b(new_n100_), .c(x23), .O(new_n108_));
  ...
  nand2  g068(.a(new_n112_), .b(new_n65_), .O(z13));
  nand3  g069(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  nand3  g070(.a(x26), .b(x25), .c(x16), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x23), .c(x22), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n114_), .c(x24), .O(new_n117_));
  inv1   g073(.a(x24), .O(new_n118_));
  inv1   g074(.a(new_n114_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(x23), .d(x22), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n117_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n67_), .O(z14));
  nor2   g079(.a(new_n109_), .b(new_n74_), .O(new_n124_));
  nand2  g080(.a(x26), .b(x17), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n124_), .c(x24), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n114_), .c(x25), .O(new_n127_));
  inv1   g083(.a(x25), .O(new_n128_));
  nand4  g084(.a(new_n119_), .b(new_n124_), .c(new_n128_), .d(x24), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n69_), .O(z15));
  nand3  g088(.a(x24), .b(x23), .c(x22), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nor2   g090(.a(new_n81_), .b(x18), .O(new_n135_));
  ...
  nor2   g095(.a(new_n118_), .b(new_n109_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n128_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n101_), .c(new_n140_), .d(new_n75_), .O(new_n142_));
