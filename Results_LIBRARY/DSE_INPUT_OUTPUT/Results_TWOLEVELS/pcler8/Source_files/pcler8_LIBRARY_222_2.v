...
module FAU ( 
  ...
  oai21  g22(.a(new_n57_), .b(new_n50_), .c(new_n46_), .O(z10));
  nor2   g23(.a(new_n52_), .b(new_n56_), .O(z12));
  oai21  g24(.a(new_n57_), .b(new_n59_), .c(new_n46_), .O(z13));
  oai21  g25(.a(new_n57_), .b(new_n65_), .c(new_n46_), .O(z16));
  nand2  g26(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g27(.a(new_n52_), .b(new_n54_), .O(z11));
