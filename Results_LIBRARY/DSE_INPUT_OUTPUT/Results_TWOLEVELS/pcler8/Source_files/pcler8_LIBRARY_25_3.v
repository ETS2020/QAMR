...
module FAU ( 
  ...
  nand2  g009(.a(x20), .b(x10), .O(new_n54_));
  ...
  oai22  g030(.a(new_n74_), .b(new_n73_), .c(x19), .d(x10), .O(new_n75_));
  nand3  g031(.a(new_n75_), .b(x09), .c(new_n46_), .O(new_n76_));
  nand3  g032(.a(new_n76_), .b(new_n57_), .c(new_n54_), .O(z09));
  ...
  nor2   g044(.a(x21), .b(new_n78_), .O(new_n89_));
  aoi21  g045(.a(new_n88_), .b(x21), .c(new_n89_), .O(new_n90_));
  nand3  g046(.a(x21), .b(new_n85_), .c(new_n47_), .O(new_n91_));
  oai21  g047(.a(new_n90_), .b(new_n85_), .c(new_n91_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(x09), .c(new_n46_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n61_), .c(new_n54_), .O(z11));
  ...
  oai21  g067(.a(new_n109_), .b(new_n85_), .c(new_n111_), .O(new_n112_));
  ...
  oai21  g073(.a(new_n116_), .b(new_n105_), .c(new_n117_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x20), .O(new_n119_));
  inv1   g075(.a(x23), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n99_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x21), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n95_), .c(x24), .O(new_n123_));
  ...
  nand3  g082(.a(x26), .b(x17), .c(new_n47_), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(x19), .c(new_n85_), .O(new_n128_));
  and2   g084(.a(x21), .b(x20), .O(new_n129_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n128_), .c(x25), .O(new_n133_));
  nor2   g089(.a(x25), .b(new_n115_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n129_), .c(new_n121_), .d(x19), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x09), .c(new_n46_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n69_), .c(new_n54_), .O(z15));
  inv1   g094(.a(x18), .O(new_n139_));
  nand3  g095(.a(new_n129_), .b(x19), .c(new_n139_), .O(new_n140_));
  nand4  g096(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nor2   g098(.a(new_n115_), .b(new_n120_), .O(new_n143_));
  inv1   g099(.a(new_n110_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n45_), .d(x25), .O(new_n145_));
