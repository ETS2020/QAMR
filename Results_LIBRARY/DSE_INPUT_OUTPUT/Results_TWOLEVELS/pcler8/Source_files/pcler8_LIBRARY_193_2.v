...
module FAU ( 
  ...
  oai21  g10(.a(new_n47_), .b(new_n55_), .c(new_n49_), .O(z04));
  ...
  nor2   g16(.a(new_n59_), .b(new_n61_), .O(z06));
  ...
  nor2   g21(.a(new_n59_), .b(new_n46_), .O(z09));
  nor2   g22(.a(new_n59_), .b(new_n51_), .O(z10));
  nor2   g23(.a(new_n59_), .b(new_n55_), .O(z12));
  oai21  g24(.a(new_n47_), .b(new_n57_), .c(new_n49_), .O(z13));
  zero   g25(.O(z00));
  nand2  g26(.a(new_n53_), .b(new_n49_), .O(z11));
  nor2   g27(.a(new_n59_), .b(new_n61_), .O(z14));
  nor2   g28(.a(new_n59_), .b(new_n63_), .O(z15));
