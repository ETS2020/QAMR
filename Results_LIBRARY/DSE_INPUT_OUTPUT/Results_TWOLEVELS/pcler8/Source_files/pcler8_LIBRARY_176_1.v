...
module FAU ( 
  ...
  nand2  g22(.a(new_n55_), .b(x05), .O(new_n67_));
  inv1   g23(.a(new_n67_), .O(z06));
  nand2  g24(.a(new_n55_), .b(x06), .O(new_n69_));
  ...
  nand3  g35(.a(new_n79_), .b(new_n56_), .c(new_n58_), .O(z09));
  ...
  nand3  g59(.a(new_n103_), .b(new_n63_), .c(new_n58_), .O(z12));
  ...
  nand3  g67(.a(new_n111_), .b(new_n65_), .c(new_n58_), .O(z13));
  ...
  nand3  g77(.a(new_n121_), .b(new_n67_), .c(new_n58_), .O(z14));
  ...
  nand3  g86(.a(new_n130_), .b(new_n69_), .c(new_n58_), .O(z15));
  ...
  nand3  g96(.a(new_n140_), .b(new_n71_), .c(new_n58_), .O(z16));
endmodule
