...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x03), .O(new_n54_));
  ...
  aoi21  g19(.a(new_n47_), .b(new_n46_), .c(new_n63_), .O(z04));
  ...
  nand3  g58(.a(new_n102_), .b(x09), .c(new_n46_), .O(new_n103_));
  nand2  g59(.a(x08), .b(x03), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n103_), .c(x10), .O(z12));
  ...
  nand4  g65(.a(new_n100_), .b(new_n109_), .c(x22), .d(x21), .O(new_n110_));
  ...
  nand2  g87(.a(new_n131_), .b(new_n69_), .O(z15));
