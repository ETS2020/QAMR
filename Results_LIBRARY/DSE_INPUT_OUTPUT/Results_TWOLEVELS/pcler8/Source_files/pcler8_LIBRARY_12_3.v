...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n139_, new_n140_;
  and2   g00(.a(x18), .b(x10), .O(new_n45_));
  ...
  nand2  g86(.a(x26), .b(x09), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(x08), .c(new_n48_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(x18), .O(new_n133_));
  nand4  g89(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n134_));
  oai21  g90(.a(new_n134_), .b(new_n113_), .c(x26), .O(new_n135_));
  nor2   g91(.a(new_n117_), .b(new_n53_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n126_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n136_), .c(new_n77_), .d(new_n50_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n140_));
  nand3  g96(.a(new_n140_), .b(new_n133_), .c(new_n74_), .O(z16));
endmodule
