...
module FAU ( 
  ...
  aoi21  g11(.a(new_n55_), .b(new_n45_), .c(x08), .O(z00));
  ...
  oai21  g17(.a(new_n45_), .b(x08), .c(new_n61_), .O(z03));
  ...
  oai21  g24(.a(new_n45_), .b(x08), .c(new_n68_), .O(z06));
  ...
  aoi21  g34(.a(new_n78_), .b(x09), .c(x10), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(x08), .c(new_n57_), .O(z09));
  ...
  oai21  g40(.a(new_n84_), .b(new_n46_), .c(new_n45_), .O(new_n85_));
  ...
  oai21  g45(.a(new_n89_), .b(new_n47_), .c(x21), .O(new_n90_));
  nand3  g46(.a(new_n74_), .b(x20), .c(x19), .O(new_n91_));
  aoi21  g47(.a(new_n91_), .b(new_n90_), .c(new_n46_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x10), .c(new_n64_), .O(new_n93_));
  ...
  nand3  g55(.a(new_n95_), .b(new_n50_), .c(x21), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n45_), .c(x09), .d(new_n64_), .O(new_n102_));
  oai21  g58(.a(new_n64_), .b(new_n63_), .c(new_n102_), .O(z12));
  nand2  g59(.a(new_n74_), .b(new_n45_), .O(new_n104_));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n104_), .c(new_n95_), .d(x22), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(x23), .O(new_n107_));
  nand4  g63(.a(new_n95_), .b(new_n51_), .c(x22), .d(x21), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n107_), .c(new_n46_), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(x10), .c(new_n64_), .O(new_n110_));
  ...
  nand4  g75(.a(new_n119_), .b(new_n45_), .c(x09), .d(new_n64_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n68_), .O(z14));
  nand2  g77(.a(x26), .b(x17), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n52_), .c(x24), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n112_), .c(x25), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand4  g81(.a(new_n117_), .b(new_n52_), .c(new_n125_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n45_), .c(x09), .d(new_n64_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n70_), .O(z15));
  inv1   g85(.a(x18), .O(new_n130_));
  nand3  g86(.a(new_n49_), .b(x19), .c(new_n130_), .O(new_n131_));
  nand3  g87(.a(new_n52_), .b(x25), .c(x24), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n131_), .c(x26), .O(new_n133_));
  nor2   g89(.a(new_n116_), .b(new_n51_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n125_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n95_), .c(new_n134_), .d(new_n75_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n45_), .c(x09), .d(new_n64_), .O(new_n138_));
