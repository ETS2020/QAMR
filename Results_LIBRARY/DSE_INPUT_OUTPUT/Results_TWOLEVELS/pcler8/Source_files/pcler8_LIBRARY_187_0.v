...
module FAU ( 
  ...
  nand4  g035(.a(new_n79_), .b(x16), .c(new_n48_), .d(x09), .O(new_n80_));
  ...
  oai22  g046(.a(new_n90_), .b(x10), .c(new_n61_), .d(new_n59_), .O(z10));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n47_), .c(new_n82_), .O(new_n108_));
  ...
  aoi21  g073(.a(new_n94_), .b(x24), .c(new_n113_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(x22), .c(x21), .d(x20), .O(new_n119_));
  nand3  g075(.a(x23), .b(x22), .c(x21), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n101_), .c(x24), .O(new_n121_));
  oai21  g077(.a(new_n119_), .b(new_n92_), .c(new_n121_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(x16), .c(new_n48_), .d(x09), .O(new_n123_));
  oai22  g079(.a(new_n123_), .b(x08), .c(new_n61_), .d(new_n69_), .O(z14));
  ...
  oai21  g084(.a(new_n128_), .b(new_n125_), .c(x25), .O(new_n129_));
  ...
  aoi21  g088(.a(new_n132_), .b(new_n129_), .c(new_n82_), .O(new_n133_));
  ...
  and2   g098(.a(x24), .b(x23), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n130_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n105_), .c(new_n143_), .d(new_n76_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(new_n83_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n47_), .c(new_n82_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(x10), .c(new_n73_), .O(z16));
endmodule
