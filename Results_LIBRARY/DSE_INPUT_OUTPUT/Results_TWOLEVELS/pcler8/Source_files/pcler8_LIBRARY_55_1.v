...
module FAU ( 
  ...
  aoi21  g15(.a(x17), .b(new_n59_), .c(new_n58_), .O(new_n60_));
  ...
  nor2   g25(.a(new_n61_), .b(new_n69_), .O(z05));
  inv1   g26(.a(x05), .O(new_n71_));
  oai22  g27(.a(new_n45_), .b(x10), .c(new_n58_), .d(new_n71_), .O(z06));
  ...
  nand4  g37(.a(new_n81_), .b(new_n45_), .c(new_n59_), .d(x09), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(x08), .c(new_n61_), .d(new_n57_), .O(z09));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n86_), .c(new_n46_), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n58_), .c(x17), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(x10), .c(new_n63_), .O(z10));
  ...
  nand3  g51(.a(new_n77_), .b(x20), .c(x19), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n95_), .c(new_n46_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n58_), .c(x17), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(x10), .c(new_n65_), .O(z11));
  ...
  aoi21  g62(.a(new_n106_), .b(new_n58_), .c(x17), .O(new_n107_));
  ...
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x17), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n59_), .c(x09), .d(new_n58_), .O(new_n114_));
  oai21  g70(.a(new_n61_), .b(new_n69_), .c(new_n114_), .O(z13));
  ...
  nand4  g77(.a(new_n121_), .b(new_n59_), .c(x09), .d(new_n58_), .O(new_n122_));
  oai21  g78(.a(new_n61_), .b(new_n71_), .c(new_n122_), .O(z14));
  aoi21  g79(.a(x23), .b(x22), .c(x17), .O(new_n124_));
  nand4  g80(.a(x24), .b(x21), .c(x20), .d(x19), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n124_), .c(x25), .O(new_n126_));
  inv1   g82(.a(x25), .O(new_n127_));
  nand4  g83(.a(new_n52_), .b(new_n49_), .c(new_n127_), .d(x24), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n126_), .c(new_n46_), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n58_), .c(x17), .O(new_n130_));
  oai22  g86(.a(new_n130_), .b(x10), .c(new_n61_), .d(new_n73_), .O(z15));
  ...
  nand4  g93(.a(new_n137_), .b(new_n104_), .c(new_n136_), .d(new_n78_), .O(new_n138_));
  aoi21  g94(.a(new_n138_), .b(new_n135_), .c(x17), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n59_), .c(x09), .d(new_n58_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n75_), .O(z16));
endmodule
