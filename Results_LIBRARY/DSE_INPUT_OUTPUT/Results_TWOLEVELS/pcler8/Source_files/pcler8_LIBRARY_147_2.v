...
module FAU ( 
  ...
  nand4  g036(.a(new_n80_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(x01), .c(new_n59_), .O(z09));
  oai21  g038(.a(new_n49_), .b(x08), .c(x01), .O(new_n83_));
  nand2  g039(.a(new_n77_), .b(x12), .O(new_n84_));
  ...
  nand4  g045(.a(new_n89_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n90_));
  ...
  nand3  g053(.a(new_n76_), .b(x20), .c(x19), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n92_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n48_), .c(x01), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(x10), .c(new_n63_), .O(z11));
  ...
  oai21  g065(.a(new_n66_), .b(new_n65_), .c(new_n109_), .O(z12));
  nand2  g066(.a(new_n76_), .b(new_n47_), .O(new_n111_));
  nand4  g067(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n111_), .c(new_n106_), .d(x22), .O(new_n113_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n114_), .c(new_n92_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n48_), .c(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(x10), .c(new_n68_), .O(z13));
  nand3  g075(.a(new_n111_), .b(x20), .c(x19), .O(new_n120_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n124_), .c(x23), .d(x22), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n123_), .c(new_n92_), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n48_), .c(x01), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(x10), .c(new_n70_), .O(z14));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n133_), .c(new_n92_), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n48_), .c(x01), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(x10), .c(new_n72_), .O(z15));
  ...
  nand4  g101(.a(new_n145_), .b(new_n106_), .c(new_n144_), .d(new_n77_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n143_), .c(new_n92_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n48_), .c(x01), .O(new_n148_));
  oai22  g104(.a(new_n148_), .b(x10), .c(new_n66_), .d(new_n74_), .O(z16));
endmodule
