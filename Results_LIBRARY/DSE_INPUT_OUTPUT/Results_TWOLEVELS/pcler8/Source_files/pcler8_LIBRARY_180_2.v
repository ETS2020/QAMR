...
module FAU ( 
  ...
  oai21  g17(.a(new_n49_), .b(new_n61_), .c(new_n46_), .O(z06));
  ...
  nor2   g23(.a(new_n53_), .b(new_n61_), .O(z14));
  ...
  nand2  g27(.a(new_n57_), .b(new_n46_), .O(z12));
  nor2   g28(.a(new_n53_), .b(new_n59_), .O(z13));
  nor2   g29(.a(new_n53_), .b(new_n65_), .O(z16));
endmodule
