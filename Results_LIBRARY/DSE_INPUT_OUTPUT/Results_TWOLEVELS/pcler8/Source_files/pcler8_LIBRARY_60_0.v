...
module FAU ( 
  ...
  oai21  g053(.a(new_n57_), .b(new_n62_), .c(new_n97_), .O(z11));
  ...
  nor2   g087(.a(new_n111_), .b(new_n76_), .O(new_n132_));
  ...
  nor2   g096(.a(new_n116_), .b(new_n111_), .O(new_n141_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n74_), .c(new_n47_), .O(new_n145_));
