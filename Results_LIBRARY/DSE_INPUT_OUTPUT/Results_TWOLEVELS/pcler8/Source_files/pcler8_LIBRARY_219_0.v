...
module FAU ( 
  ...
  oai21  g043(.a(x20), .b(new_n45_), .c(new_n87_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n89_));
  oai21  g045(.a(new_n61_), .b(new_n63_), .c(new_n89_), .O(z10));
  ...
  oai21  g052(.a(new_n96_), .b(new_n91_), .c(new_n78_), .O(new_n97_));
  ...
  oai21  g061(.a(new_n105_), .b(new_n91_), .c(new_n78_), .O(new_n106_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n113_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n123_));
  ...
  nand4  g086(.a(new_n130_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n131_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n91_), .c(new_n78_), .O(new_n144_));
