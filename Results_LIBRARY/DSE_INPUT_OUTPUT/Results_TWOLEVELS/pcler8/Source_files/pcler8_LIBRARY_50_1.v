...
module FAU ( 
  ...
  nor2   g14(.a(new_n47_), .b(new_n45_), .O(z01));
  nand2  g15(.a(x08), .b(x01), .O(new_n60_));
  nand2  g16(.a(new_n60_), .b(new_n46_), .O(z02));
  aoi21  g17(.a(x10), .b(new_n45_), .c(new_n47_), .O(new_n62_));
  ...
  nand2  g27(.a(new_n62_), .b(x06), .O(new_n72_));
  ...
  nand2  g38(.a(new_n82_), .b(new_n76_), .O(z09));
  ...
  nand3  g46(.a(new_n90_), .b(new_n60_), .c(new_n46_), .O(z10));
  ...
  nand3  g54(.a(new_n98_), .b(new_n63_), .c(new_n46_), .O(z11));
  ...
  nand3  g61(.a(new_n105_), .b(new_n65_), .c(new_n46_), .O(z12));
  ...
  nand3  g68(.a(new_n112_), .b(new_n67_), .c(new_n46_), .O(z13));
  ...
  oai21  g78(.a(new_n70_), .b(new_n69_), .c(new_n122_), .O(z14));
  ...
  nand3  g86(.a(new_n130_), .b(new_n72_), .c(new_n46_), .O(z15));
  ...
  nand2  g96(.a(new_n140_), .b(new_n74_), .O(z16));
endmodule
