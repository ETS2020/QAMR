...
module FAU ( 
  ...
  aoi21  g043(.a(new_n87_), .b(new_n85_), .c(x18), .O(new_n88_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n47_), .c(x18), .O(new_n99_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(x18), .O(new_n107_));
  ...
  aoi21  g066(.a(new_n110_), .b(x21), .c(x18), .O(new_n111_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n47_), .c(x18), .O(new_n117_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n122_), .c(x18), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n127_));
  oai21  g083(.a(new_n59_), .b(new_n70_), .c(new_n127_), .O(z14));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(x23), .c(x18), .O(new_n130_));
  nand3  g086(.a(x24), .b(x22), .c(x21), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n105_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n130_), .c(x25), .O(new_n134_));
  inv1   g090(.a(x25), .O(new_n135_));
  nor2   g091(.a(new_n114_), .b(new_n46_), .O(new_n136_));
  nand4  g092(.a(new_n124_), .b(new_n136_), .c(new_n135_), .d(x24), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n134_), .c(new_n91_), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n47_), .c(x18), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(x10), .c(new_n72_), .O(z15));
  nand2  g096(.a(new_n114_), .b(new_n49_), .O(new_n141_));
  and2   g097(.a(x25), .b(x24), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n124_), .d(x22), .O(new_n143_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n105_), .c(new_n145_), .d(new_n77_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n144_), .c(new_n91_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n47_), .c(x18), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(x10), .c(new_n74_), .O(z16));
endmodule
