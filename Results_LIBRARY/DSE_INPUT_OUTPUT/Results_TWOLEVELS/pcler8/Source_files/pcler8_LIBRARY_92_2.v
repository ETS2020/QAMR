...
module FAU ( 
  ...
  oai21  g07(.a(new_n49_), .b(new_n51_), .c(new_n46_), .O(z02));
  ...
  nor2   g15(.a(new_n55_), .b(new_n59_), .O(z05));
  inv1   g16(.a(x05), .O(new_n61_));
  nor2   g17(.a(new_n55_), .b(new_n61_), .O(z06));
  inv1   g18(.a(x06), .O(new_n63_));
  oai21  g19(.a(new_n49_), .b(new_n63_), .c(new_n46_), .O(z07));
  inv1   g20(.a(x07), .O(new_n65_));
  nor2   g21(.a(new_n55_), .b(new_n65_), .O(z08));
  nor2   g22(.a(new_n55_), .b(new_n48_), .O(z09));
  nor2   g23(.a(new_n55_), .b(new_n51_), .O(z10));
  nor2   g24(.a(new_n55_), .b(new_n63_), .O(z15));
  nor2   g25(.a(new_n55_), .b(new_n53_), .O(z11));
  nor2   g26(.a(new_n55_), .b(new_n57_), .O(z12));
  nor2   g27(.a(new_n55_), .b(new_n59_), .O(z13));
  nor2   g28(.a(new_n55_), .b(new_n61_), .O(z14));
  nor2   g29(.a(new_n55_), .b(new_n65_), .O(z16));
endmodule
