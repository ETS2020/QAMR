...
module FAU ( 
  ...
  nand2  g23(.a(new_n55_), .b(x05), .O(new_n68_));
  inv1   g24(.a(new_n68_), .O(z06));
  nand2  g25(.a(x08), .b(x06), .O(new_n70_));
  nand2  g26(.a(new_n70_), .b(new_n60_), .O(z07));
  nand2  g27(.a(x08), .b(x07), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(new_n60_), .O(z08));
  ...
  nand2  g43(.a(new_n87_), .b(new_n58_), .O(z10));
  ...
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n60_), .O(z14));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n60_), .O(z16));
endmodule
