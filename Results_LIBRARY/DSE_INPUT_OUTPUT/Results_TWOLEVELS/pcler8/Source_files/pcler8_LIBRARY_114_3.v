...
module FAU ( 
  ...
  nand2  g10(.a(x24), .b(x10), .O(new_n55_));
  oai21  g11(.a(new_n46_), .b(new_n54_), .c(new_n55_), .O(z01));
  nand2  g12(.a(new_n55_), .b(x08), .O(new_n57_));
  ...
  oai21  g19(.a(new_n46_), .b(new_n63_), .c(new_n55_), .O(z04));
  ...
  oai21  g27(.a(new_n46_), .b(new_n71_), .c(new_n55_), .O(z08));
  ...
  nand4  g43(.a(x21), .b(x13), .c(x09), .d(new_n46_), .O(new_n88_));
  inv1   g44(.a(x23), .O(new_n89_));
  nor2   g45(.a(new_n89_), .b(new_n74_), .O(new_n90_));
  nand3  g46(.a(new_n90_), .b(x26), .c(x25), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n88_), .c(new_n47_), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(x24), .O(new_n93_));
  nand2  g49(.a(x20), .b(x19), .O(new_n94_));
  inv1   g50(.a(new_n94_), .O(new_n95_));
  nand3  g51(.a(new_n73_), .b(x20), .c(x19), .O(new_n96_));
  oai21  g52(.a(new_n95_), .b(new_n73_), .c(new_n96_), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n93_), .c(new_n61_), .O(z11));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  nand3  g56(.a(x26), .b(x25), .c(x24), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n100_), .c(x21), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n94_), .c(x22), .O(new_n103_));
  nand3  g59(.a(new_n95_), .b(new_n74_), .c(x21), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  oai21  g62(.a(new_n57_), .b(new_n63_), .c(new_n106_), .O(z12));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(x22), .c(x21), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n94_), .c(x23), .O(new_n110_));
  nand4  g66(.a(new_n95_), .b(new_n89_), .c(x22), .d(x21), .O(new_n111_));
  ...
  nand4  g83(.a(new_n127_), .b(x21), .c(x20), .d(x19), .O(new_n128_));
  aoi22  g84(.a(new_n128_), .b(x24), .c(new_n126_), .d(new_n47_), .O(new_n129_));
  nand4  g85(.a(new_n120_), .b(new_n90_), .c(new_n125_), .d(x24), .O(new_n130_));
  oai21  g86(.a(new_n129_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(x09), .c(new_n46_), .O(new_n132_));
  nand3  g88(.a(new_n132_), .b(new_n69_), .c(new_n55_), .O(z15));
  ...
  nor2   g93(.a(new_n119_), .b(new_n89_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n125_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n95_), .c(new_n138_), .d(new_n75_), .O(new_n140_));
