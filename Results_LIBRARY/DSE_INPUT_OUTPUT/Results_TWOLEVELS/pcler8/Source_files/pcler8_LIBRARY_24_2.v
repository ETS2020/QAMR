...
module FAU ( 
  ...
  nand3  g69(.a(x19), .b(x09), .c(new_n46_), .O(new_n114_));
  nor2   g70(.a(new_n109_), .b(new_n75_), .O(new_n115_));
  nand3  g71(.a(new_n115_), .b(x21), .c(x20), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n114_), .c(new_n47_), .O(new_n117_));
  ...
  nand3  g81(.a(new_n125_), .b(new_n118_), .c(new_n68_), .O(z14));
  ...
  nand4  g86(.a(new_n120_), .b(new_n115_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  oai21  g89(.a(new_n62_), .b(new_n70_), .c(new_n133_), .O(z15));
  ...
  nor2   g94(.a(new_n55_), .b(new_n109_), .O(new_n139_));
  ...
  oai21  g99(.a(new_n62_), .b(new_n72_), .c(new_n143_), .O(z16));
endmodule
