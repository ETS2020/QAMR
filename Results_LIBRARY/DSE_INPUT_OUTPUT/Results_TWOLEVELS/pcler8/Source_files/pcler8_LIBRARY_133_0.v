...
module FAU ( 
  ...
  nor2   g010(.a(x10), .b(x03), .O(new_n55_));
  ...
  nor2   g021(.a(new_n47_), .b(new_n65_), .O(z04));
  ...
  oai21  g036(.a(new_n80_), .b(new_n65_), .c(new_n58_), .O(z09));
  ...
  nand4  g043(.a(new_n87_), .b(x09), .c(new_n47_), .d(x03), .O(new_n88_));
  ...
  nand4  g052(.a(new_n96_), .b(x09), .c(new_n47_), .d(x03), .O(new_n97_));
  oai21  g053(.a(new_n61_), .b(new_n63_), .c(new_n97_), .O(z11));
  ...
  nand3  g059(.a(new_n99_), .b(new_n46_), .c(x21), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n48_), .c(x09), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n47_), .c(new_n65_), .O(z12));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(x10), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(x09), .c(new_n47_), .d(x03), .O(new_n114_));
  oai21  g070(.a(new_n61_), .b(new_n67_), .c(new_n114_), .O(z13));
  ...
  aoi21  g075(.a(new_n118_), .b(x03), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n124_), .b(x09), .c(new_n47_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x03), .O(new_n126_));
  ...
  nand3  g087(.a(x24), .b(x23), .c(x19), .O(new_n132_));
  aoi21  g088(.a(new_n131_), .b(x03), .c(new_n132_), .O(new_n133_));
  nor2   g089(.a(new_n111_), .b(new_n46_), .O(new_n134_));
  nand4  g090(.a(new_n122_), .b(new_n134_), .c(new_n129_), .d(x24), .O(new_n135_));
  oai21  g091(.a(new_n133_), .b(new_n129_), .c(new_n135_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x09), .c(new_n47_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x03), .O(new_n138_));
  ...
  nand3  g098(.a(new_n134_), .b(x25), .c(x24), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(x26), .O(new_n144_));
  nor2   g100(.a(new_n116_), .b(new_n111_), .O(new_n145_));
  ...
  nand4  g104(.a(new_n148_), .b(x09), .c(new_n47_), .d(x03), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n73_), .O(z16));
endmodule
