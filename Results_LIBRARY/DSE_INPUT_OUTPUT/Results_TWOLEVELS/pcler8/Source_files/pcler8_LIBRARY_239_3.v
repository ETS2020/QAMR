...
module FAU ( 
  ...
  nor2   g20(.a(new_n64_), .b(x10), .O(z06));
  ...
  nand2  g33(.a(new_n77_), .b(new_n70_), .O(z09));
  oai21  g34(.a(x10), .b(x01), .c(x08), .O(new_n79_));
  ...
  nand4  g40(.a(new_n84_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n79_), .O(z10));
  ...
  nand3  g56(.a(new_n100_), .b(new_n72_), .c(x21), .O(new_n101_));
  ...
  nand4  g64(.a(new_n100_), .b(new_n108_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(x09), .c(new_n46_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n62_), .c(x10), .O(z13));
  oai21  g68(.a(x10), .b(x05), .c(x08), .O(new_n113_));
  ...
  nand2  g78(.a(new_n122_), .b(new_n113_), .O(z14));
  oai21  g79(.a(x10), .b(x06), .c(x08), .O(new_n124_));
  ...
  nor2   g84(.a(new_n108_), .b(new_n72_), .O(new_n129_));
  ...
  nand2  g88(.a(new_n132_), .b(new_n124_), .O(z15));
  ...
  nor2   g93(.a(new_n118_), .b(new_n108_), .O(new_n138_));
  ...
  nand2  g98(.a(new_n142_), .b(new_n68_), .O(z16));
endmodule
