...
module FAU ( 
  ...
  nor2   g16(.a(new_n55_), .b(new_n60_), .O(new_n61_));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n60_), .c(new_n76_), .O(new_n82_));
  ...
  nand4  g44(.a(new_n88_), .b(new_n84_), .c(x09), .d(new_n60_), .O(new_n89_));
  oai21  g45(.a(new_n62_), .b(new_n59_), .c(new_n89_), .O(z10));
  ...
  nand4  g51(.a(new_n95_), .b(new_n84_), .c(x09), .d(new_n60_), .O(new_n96_));
  oai21  g52(.a(new_n62_), .b(new_n64_), .c(new_n96_), .O(z11));
  oai21  g53(.a(x20), .b(new_n76_), .c(x19), .O(new_n98_));
  ...
  nand4  g87(.a(new_n131_), .b(new_n84_), .c(x09), .d(new_n60_), .O(new_n132_));
