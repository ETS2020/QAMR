...
module FAU ( 
  ...
  nand4  g01(.a(x21), .b(x20), .c(x19), .d(x09), .O(new_n46_));
  ...
  aoi21  g11(.a(x10), .b(new_n55_), .c(new_n45_), .O(z01));
  inv1   g12(.a(x10), .O(new_n57_));
  oai21  g13(.a(new_n57_), .b(x01), .c(x08), .O(new_n58_));
  inv1   g14(.a(new_n58_), .O(z02));
  nand3  g15(.a(x10), .b(x08), .c(x02), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(z03));
  inv1   g17(.a(x03), .O(new_n62_));
  aoi21  g18(.a(x10), .b(new_n62_), .c(new_n45_), .O(z04));
  nand3  g19(.a(x10), .b(x08), .c(x04), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z05));
  nand3  g21(.a(x10), .b(x08), .c(x05), .O(new_n66_));
  inv1   g22(.a(new_n66_), .O(z06));
  nand3  g23(.a(x10), .b(x08), .c(x06), .O(new_n68_));
  inv1   g24(.a(new_n68_), .O(z07));
  oai21  g25(.a(new_n57_), .b(x07), .c(x08), .O(new_n70_));
  ...
  nand4  g32(.a(new_n76_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n77_));
  nor2   g33(.a(new_n57_), .b(new_n45_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(x00), .O(new_n79_));
  ...
  nand3  g41(.a(new_n85_), .b(new_n57_), .c(x09), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n58_), .O(z10));
  nand3  g43(.a(x23), .b(x22), .c(x13), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n51_), .c(x20), .O(new_n89_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n93_));
  nand2  g49(.a(new_n78_), .b(x02), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n93_), .O(z11));
  ...
  nand3  g56(.a(new_n100_), .b(new_n48_), .c(x21), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n103_));
  nand2  g59(.a(new_n78_), .b(x03), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n103_), .O(z12));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(x22), .c(x21), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n96_), .c(x23), .O(new_n108_));
  nand4  g64(.a(new_n100_), .b(new_n49_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n111_));
  nand2  g67(.a(new_n78_), .b(x04), .O(new_n112_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n122_));
  nand2  g78(.a(new_n78_), .b(x05), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n122_), .O(z14));
  ...
  nand4  g84(.a(new_n119_), .b(new_n50_), .c(new_n128_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n131_));
  nand2  g87(.a(new_n78_), .b(x06), .O(new_n132_));
  ...
  nor2   g93(.a(new_n118_), .b(new_n49_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n128_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n100_), .c(new_n138_), .d(new_n73_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n57_), .c(x09), .O(new_n142_));
  nand2  g98(.a(new_n142_), .b(new_n70_), .O(z16));
endmodule
