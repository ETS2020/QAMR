...
module FAU ( 
  ...
  nand2  g006(.a(x23), .b(x22), .O(new_n51_));
  nand3  g007(.a(x26), .b(x25), .c(x24), .O(new_n52_));
  nor2   g008(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand4  g009(.a(new_n53_), .b(new_n50_), .c(new_n48_), .d(new_n47_), .O(new_n54_));
  ...
  aoi21  g018(.a(new_n46_), .b(new_n47_), .c(new_n45_), .O(z03));
  ...
  nand3  g035(.a(new_n79_), .b(new_n48_), .c(new_n47_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n45_), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(x09), .O(new_n82_));
  ...
  nand4  g045(.a(new_n89_), .b(x09), .c(new_n47_), .d(new_n45_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n61_), .O(z10));
  inv1   g047(.a(z03), .O(new_n92_));
  inv1   g048(.a(x19), .O(new_n93_));
  inv1   g049(.a(new_n51_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x13), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n52_), .c(x20), .O(new_n96_));
  ...
  nor2   g057(.a(new_n87_), .b(new_n93_), .O(new_n102_));
  ...
  aoi21  g064(.a(new_n108_), .b(new_n47_), .c(x02), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n46_), .c(new_n64_), .O(z12));
  ...
  nand4  g072(.a(new_n116_), .b(x09), .c(new_n47_), .d(new_n45_), .O(new_n117_));
  ...
  nand4  g080(.a(new_n124_), .b(x09), .c(new_n47_), .d(new_n45_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n68_), .O(z14));
  nand2  g082(.a(new_n51_), .b(new_n45_), .O(new_n127_));
  aoi21  g083(.a(x26), .b(x17), .c(new_n122_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n102_), .d(x21), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x25), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand4  g087(.a(new_n94_), .b(new_n50_), .c(new_n131_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(x10), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n47_), .c(x02), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n46_), .c(new_n70_), .O(z15));
  inv1   g091(.a(x18), .O(new_n136_));
  nand4  g092(.a(x21), .b(x20), .c(x19), .d(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n94_), .b(x25), .c(x24), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(x26), .O(new_n139_));
  nor2   g095(.a(new_n122_), .b(new_n114_), .O(new_n140_));
  ...
  nand4  g099(.a(new_n143_), .b(x09), .c(new_n47_), .d(new_n45_), .O(new_n144_));
