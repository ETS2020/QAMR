...
module FAU ( 
  ...
  oai21  g10(.a(new_n55_), .b(new_n54_), .c(new_n51_), .O(z03));
  ...
  nand2  g16(.a(new_n61_), .b(new_n51_), .O(z06));
  inv1   g17(.a(x06), .O(new_n63_));
  nor2   g18(.a(new_n48_), .b(new_n63_), .O(z07));
  inv1   g19(.a(x07), .O(new_n65_));
  oai21  g20(.a(new_n55_), .b(new_n65_), .c(new_n51_), .O(z08));
  nor2   g21(.a(new_n48_), .b(new_n54_), .O(z11));
  oai21  g22(.a(new_n55_), .b(new_n63_), .c(new_n51_), .O(z15));
  nor2   g23(.a(new_n48_), .b(new_n65_), .O(z16));
  zero   g24(.O(z00));
  nor2   g25(.a(new_n48_), .b(new_n46_), .O(z09));
  nand2  g26(.a(new_n52_), .b(new_n51_), .O(z10));
  nor2   g27(.a(new_n48_), .b(new_n57_), .O(z12));
  nor2   g28(.a(new_n48_), .b(new_n59_), .O(z13));
  nand2  g29(.a(new_n61_), .b(new_n51_), .O(z14));
endmodule
