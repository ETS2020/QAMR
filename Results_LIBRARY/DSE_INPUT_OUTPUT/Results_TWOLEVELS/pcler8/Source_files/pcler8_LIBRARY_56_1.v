...
module FAU ( 
  ...
  oai21  g28(.a(new_n46_), .b(new_n72_), .c(new_n59_), .O(z08));
  ...
  oai21  g51(.a(new_n57_), .b(new_n62_), .c(new_n95_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n64_), .c(new_n59_), .O(z12));
  ...
  oai21  g68(.a(new_n57_), .b(new_n66_), .c(new_n112_), .O(z13));
  ...
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n59_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n59_), .O(z15));
