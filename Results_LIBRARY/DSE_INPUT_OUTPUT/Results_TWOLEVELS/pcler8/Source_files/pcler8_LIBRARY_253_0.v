...
module FAU ( 
  ...
  nand2  g17(.a(new_n61_), .b(new_n56_), .O(z02));
  ...
  nand2  g26(.a(new_n70_), .b(new_n56_), .O(z06));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n59_), .c(new_n76_), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(x10), .c(new_n57_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(new_n84_), .c(x09), .d(new_n59_), .O(new_n89_));
  ...
  oai21  g51(.a(new_n95_), .b(new_n76_), .c(new_n84_), .O(new_n96_));
  ...
  nand3  g58(.a(new_n98_), .b(new_n48_), .c(x21), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n84_), .c(x09), .d(new_n59_), .O(new_n105_));
  oai21  g61(.a(new_n66_), .b(new_n65_), .c(new_n105_), .O(z12));
  nand2  g62(.a(new_n77_), .b(x09), .O(new_n107_));
  ...
  nand4  g66(.a(new_n98_), .b(new_n49_), .c(x22), .d(x21), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n110_), .c(x08), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n76_), .c(new_n84_), .O(new_n113_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n84_), .c(x09), .d(new_n59_), .O(new_n123_));
  ...
  nand4  g84(.a(new_n120_), .b(new_n50_), .c(new_n128_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n84_), .c(x09), .d(new_n59_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n72_), .O(z15));
  inv1   g88(.a(x18), .O(new_n133_));
  nand3  g89(.a(new_n47_), .b(x19), .c(new_n133_), .O(new_n134_));
  nand3  g90(.a(new_n50_), .b(x25), .c(x24), .O(new_n135_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n84_), .c(x09), .d(new_n59_), .O(new_n141_));
