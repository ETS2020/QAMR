...
module FAU ( 
  ...
  nand4  g040(.a(new_n84_), .b(x17), .c(new_n48_), .d(x09), .O(new_n85_));
  oai22  g041(.a(new_n85_), .b(x08), .c(new_n58_), .d(new_n55_), .O(z09));
  ...
  nor2   g052(.a(new_n78_), .b(new_n46_), .O(new_n97_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n96_), .c(x21), .O(new_n101_));
  nand3  g057(.a(new_n75_), .b(x20), .c(x19), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n101_), .c(new_n87_), .O(new_n103_));
  ...
  oai21  g062(.a(x20), .b(new_n87_), .c(x19), .O(new_n107_));
  nand2  g063(.a(x23), .b(x14), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n99_), .c(x21), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n107_), .c(x22), .O(new_n110_));
  nor2   g066(.a(new_n91_), .b(new_n96_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n46_), .c(x21), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n106_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n47_), .c(new_n87_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(x10), .c(new_n65_), .O(z12));
  inv1   g071(.a(new_n111_), .O(new_n116_));
  nand3  g072(.a(new_n82_), .b(x24), .c(x15), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x22), .c(x21), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n116_), .c(x23), .O(new_n119_));
  nand4  g075(.a(new_n111_), .b(new_n78_), .c(x22), .d(x21), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n119_), .c(new_n87_), .O(new_n121_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n79_), .c(x23), .d(x22), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(new_n87_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n131_));
  oai21  g087(.a(new_n58_), .b(new_n69_), .c(new_n131_), .O(z14));
  ...
  nor2   g093(.a(new_n97_), .b(new_n87_), .O(new_n138_));
  nand3  g094(.a(new_n111_), .b(x24), .c(x21), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(x25), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n137_), .c(new_n106_), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n47_), .c(new_n87_), .O(new_n142_));
  ...
  nand3  g101(.a(new_n97_), .b(x25), .c(x24), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(x26), .O(new_n147_));
  nor2   g103(.a(x26), .b(new_n81_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n111_), .c(new_n80_), .d(new_n76_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n147_), .c(new_n87_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n151_));
  oai21  g107(.a(new_n58_), .b(new_n73_), .c(new_n151_), .O(z16));
endmodule
