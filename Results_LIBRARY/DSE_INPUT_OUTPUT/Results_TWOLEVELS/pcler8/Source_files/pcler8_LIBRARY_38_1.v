...
module FAU ( 
  ...
  nand2  g18(.a(x10), .b(new_n55_), .O(new_n63_));
  ...
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n63_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n64_), .c(new_n63_), .O(z12));
  ...
  oai21  g78(.a(new_n57_), .b(new_n68_), .c(new_n122_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n63_), .O(z15));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n63_), .O(z16));
endmodule
