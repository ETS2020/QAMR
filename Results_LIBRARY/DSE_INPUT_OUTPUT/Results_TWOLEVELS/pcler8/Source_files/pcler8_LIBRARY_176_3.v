...
module FAU ( 
  ...
  oai21  g54(.a(new_n98_), .b(new_n91_), .c(x20), .O(new_n99_));
  nand2  g55(.a(x21), .b(x19), .O(new_n100_));
  aoi21  g56(.a(new_n99_), .b(new_n47_), .c(new_n100_), .O(new_n101_));
  and2   g57(.a(x20), .b(x19), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n75_), .c(x21), .O(new_n103_));
  oai21  g59(.a(new_n101_), .b(new_n75_), .c(new_n103_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n46_), .c(x10), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n54_), .c(new_n64_), .O(z12));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(x20), .c(x10), .O(new_n108_));
  nand2  g64(.a(new_n76_), .b(x19), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n108_), .c(x23), .O(new_n110_));
  ...
  nand4  g73(.a(x26), .b(x25), .c(x16), .d(new_n47_), .O(new_n118_));
  ...
  nand4  g77(.a(new_n117_), .b(new_n121_), .c(x23), .d(x22), .O(new_n122_));
  ...
  nor2   g81(.a(new_n111_), .b(new_n75_), .O(new_n126_));
  ...
  nand4  g86(.a(new_n117_), .b(new_n126_), .c(new_n130_), .d(x24), .O(new_n131_));
  ...
  nor2   g94(.a(new_n121_), .b(new_n111_), .O(new_n139_));
