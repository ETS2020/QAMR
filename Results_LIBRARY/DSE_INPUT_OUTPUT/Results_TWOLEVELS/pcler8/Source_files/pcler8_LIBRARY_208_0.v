...
module FAU ( 
  ...
  aoi21  g44(.a(new_n88_), .b(new_n56_), .c(new_n82_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(x10), .c(new_n61_), .O(z10));
  inv1   g46(.a(x10), .O(new_n91_));
  ...
  aoi21  g53(.a(new_n97_), .b(new_n95_), .c(new_n82_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n91_), .c(x09), .d(new_n56_), .O(new_n99_));
  oai21  g55(.a(new_n64_), .b(new_n63_), .c(new_n99_), .O(z11));
  oai21  g56(.a(x20), .b(new_n82_), .c(x19), .O(new_n101_));
  ...
  aoi21  g70(.a(new_n114_), .b(new_n56_), .c(new_n82_), .O(new_n115_));
  ...
  aoi21  g77(.a(new_n121_), .b(new_n119_), .c(new_n82_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n91_), .c(x09), .d(new_n56_), .O(new_n123_));
  oai21  g79(.a(new_n64_), .b(new_n70_), .c(new_n123_), .O(z14));
  aoi21  g80(.a(new_n50_), .b(x18), .c(new_n49_), .O(new_n125_));
  aoi21  g81(.a(x26), .b(x17), .c(new_n120_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n125_), .c(new_n48_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x25), .O(new_n128_));
  nor2   g84(.a(x25), .b(new_n120_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n51_), .c(new_n48_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(new_n45_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n56_), .c(new_n82_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(x10), .c(new_n72_), .O(z15));
  inv1   g89(.a(x26), .O(new_n134_));
  nand3  g90(.a(new_n51_), .b(x25), .c(x24), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n47_), .c(new_n134_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(x18), .c(new_n91_), .d(x09), .O(new_n137_));
  oai22  g93(.a(new_n137_), .b(x08), .c(new_n64_), .d(new_n74_), .O(z16));
endmodule
