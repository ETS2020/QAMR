...
module FAU ( 
  ...
  nand2  g018(.a(new_n55_), .b(x10), .O(new_n63_));
  ...
  nand2  g024(.a(new_n68_), .b(new_n63_), .O(z06));
  ...
  nand3  g042(.a(new_n86_), .b(new_n59_), .c(new_n63_), .O(z10));
  ...
  nand3  g050(.a(new_n94_), .b(new_n61_), .c(new_n63_), .O(z11));
  nand2  g051(.a(x09), .b(new_n46_), .O(new_n96_));
  nand3  g052(.a(x21), .b(x20), .c(x19), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n96_), .c(new_n47_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n55_), .O(new_n99_));
  nand2  g055(.a(x20), .b(x19), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  inv1   g057(.a(new_n89_), .O(new_n102_));
  and2   g058(.a(x23), .b(x14), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(new_n74_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n101_), .c(new_n55_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n99_), .c(new_n64_), .O(z12));
  ...
  oai21  g072(.a(new_n96_), .b(new_n116_), .c(new_n47_), .O(new_n117_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n100_), .c(x24), .O(new_n121_));
  inv1   g077(.a(new_n97_), .O(new_n122_));
  ...
  oai21  g083(.a(new_n96_), .b(new_n127_), .c(new_n47_), .O(new_n128_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n97_), .c(x25), .O(new_n132_));
  nor2   g088(.a(new_n111_), .b(new_n55_), .O(new_n133_));
  nand4  g089(.a(new_n122_), .b(new_n133_), .c(new_n127_), .d(x24), .O(new_n134_));
  ...
  nor2   g097(.a(new_n116_), .b(new_n111_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n127_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n101_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
