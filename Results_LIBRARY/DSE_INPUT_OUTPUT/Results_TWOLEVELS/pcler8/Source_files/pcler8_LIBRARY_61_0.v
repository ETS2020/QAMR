...
module FAU ( 
  ...
  oai21  g24(.a(new_n56_), .b(new_n68_), .c(new_n66_), .O(z05));
  nand2  g25(.a(new_n58_), .b(x05), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z06));
  inv1   g27(.a(x06), .O(new_n72_));
  oai21  g28(.a(new_n56_), .b(new_n72_), .c(new_n66_), .O(z07));
  ...
  nand4  g44(.a(new_n88_), .b(new_n84_), .c(x09), .d(new_n56_), .O(new_n89_));
  oai21  g45(.a(new_n59_), .b(new_n61_), .c(new_n89_), .O(z10));
  ...
  nand4  g60(.a(new_n104_), .b(new_n84_), .c(x09), .d(new_n56_), .O(new_n105_));
  oai21  g61(.a(new_n59_), .b(new_n65_), .c(new_n105_), .O(z12));
  ...
  nand4  g68(.a(new_n112_), .b(new_n84_), .c(x09), .d(new_n56_), .O(new_n113_));
  oai21  g69(.a(new_n59_), .b(new_n68_), .c(new_n113_), .O(z13));
  aoi21  g70(.a(x22), .b(x21), .c(new_n76_), .O(new_n115_));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(new_n102_), .c(x23), .O(new_n117_));
