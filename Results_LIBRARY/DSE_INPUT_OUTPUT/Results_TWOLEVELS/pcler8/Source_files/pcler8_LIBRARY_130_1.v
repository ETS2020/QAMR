...
module FAU ( 
  ...
  nor2   g01(.a(new_n45_), .b(x01), .O(new_n46_));
  ...
  and2   g17(.a(x08), .b(x01), .O(z02));
  nand2  g18(.a(new_n59_), .b(x02), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z03));
  aoi21  g20(.a(x08), .b(x03), .c(new_n46_), .O(new_n65_));
  ...
  nand4  g35(.a(new_n79_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n80_));
  ...
  nor2   g44(.a(z02), .b(new_n46_), .O(new_n89_));
  ...
  nand2  g60(.a(new_n104_), .b(new_n65_), .O(z12));
  ...
  nand3  g85(.a(new_n129_), .b(new_n71_), .c(new_n47_), .O(z15));
