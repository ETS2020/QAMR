...
module FAU ( 
  ...
  oai21  g22(.a(new_n66_), .b(new_n58_), .c(new_n46_), .O(z13));
  nand2  g23(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g24(.a(new_n52_), .b(new_n50_), .O(z10));
  nor2   g25(.a(new_n52_), .b(new_n54_), .O(z11));
  nand2  g26(.a(new_n56_), .b(new_n46_), .O(z12));
  nand2  g27(.a(new_n60_), .b(new_n46_), .O(z14));
