...
module FAU ( 
  ...
  nand2  g11(.a(x10), .b(x00), .O(new_n56_));
  ...
  oai21  g28(.a(x10), .b(x08), .c(x00), .O(new_n73_));
  ...
  nand2  g36(.a(new_n80_), .b(new_n73_), .O(z09));
  ...
  nand3  g60(.a(new_n104_), .b(new_n63_), .c(new_n56_), .O(z12));
  ...
  nand3  g78(.a(new_n122_), .b(new_n67_), .c(new_n56_), .O(z14));
