...
module FAU ( 
  ...
  nand2  g09(.a(x17), .b(x10), .O(new_n54_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n113_), .c(new_n116_), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n120_));
  nand2  g76(.a(new_n120_), .b(new_n67_), .O(z14));
  nand2  g77(.a(x09), .b(new_n46_), .O(new_n122_));
  nand2  g78(.a(x26), .b(x25), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n122_), .c(new_n47_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(x17), .O(new_n125_));
  nand3  g81(.a(x24), .b(x23), .c(x22), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n113_), .c(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(x24), .c(x23), .d(x22), .O(new_n129_));
  oai21  g85(.a(new_n129_), .b(new_n113_), .c(new_n127_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n125_), .c(new_n69_), .O(z15));
