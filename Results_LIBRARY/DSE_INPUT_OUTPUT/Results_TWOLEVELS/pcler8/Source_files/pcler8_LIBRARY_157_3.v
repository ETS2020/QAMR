...
module FAU ( 
  ...
  aoi21  g22(.a(x08), .b(x03), .c(new_n47_), .O(new_n67_));
  ...
  aoi21  g28(.a(new_n46_), .b(new_n49_), .c(new_n45_), .O(z07));
  ...
  nand3  g84(.a(new_n128_), .b(x09), .c(new_n49_), .O(new_n129_));
  nand2  g85(.a(x08), .b(x06), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n129_), .c(x10), .O(z15));
