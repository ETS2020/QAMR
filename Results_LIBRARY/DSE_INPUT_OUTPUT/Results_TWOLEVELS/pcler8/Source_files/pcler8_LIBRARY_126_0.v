...
module FAU ( 
  ...
  nand2  g014(.a(new_n58_), .b(new_n56_), .O(z02));
  ...
  oai21  g042(.a(new_n86_), .b(x08), .c(x09), .O(new_n87_));
  nand2  g043(.a(new_n87_), .b(new_n47_), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n58_), .O(z10));
  inv1   g045(.a(x09), .O(new_n90_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n90_), .c(new_n47_), .O(new_n97_));
  oai21  g053(.a(new_n62_), .b(new_n60_), .c(new_n97_), .O(z11));
  ...
  oai21  g061(.a(new_n105_), .b(new_n90_), .c(new_n47_), .O(new_n106_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n90_), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n70_), .O(z15));
  nor2   g091(.a(new_n99_), .b(x18), .O(new_n136_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n90_), .c(new_n47_), .O(new_n144_));
