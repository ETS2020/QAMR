...
module FAU ( 
  ...
  oai21  g21(.a(new_n63_), .b(new_n65_), .c(new_n46_), .O(z08));
  nor2   g22(.a(new_n50_), .b(new_n62_), .O(z15));
  nor2   g23(.a(new_n50_), .b(new_n65_), .O(z16));
  nor2   g24(.a(new_n50_), .b(new_n48_), .O(z09));
  nor2   g25(.a(new_n50_), .b(new_n52_), .O(z10));
  nand2  g26(.a(new_n54_), .b(new_n46_), .O(z11));
  nor2   g27(.a(new_n50_), .b(new_n56_), .O(z12));
  nor2   g28(.a(new_n50_), .b(new_n58_), .O(z13));
