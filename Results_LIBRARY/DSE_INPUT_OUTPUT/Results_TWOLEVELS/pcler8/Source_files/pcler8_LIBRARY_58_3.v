...
module FAU ( 
  ...
  nand4  g37(.a(new_n81_), .b(new_n46_), .c(x09), .d(new_n57_), .O(new_n82_));
  ...
  nand4  g86(.a(new_n130_), .b(new_n46_), .c(x09), .d(new_n57_), .O(new_n131_));
