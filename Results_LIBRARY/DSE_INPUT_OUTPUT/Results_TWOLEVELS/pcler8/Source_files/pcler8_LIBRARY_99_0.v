...
module FAU ( 
  ...
  nor2   g09(.a(x10), .b(x09), .O(new_n54_));
  ...
  nand4  g67(.a(new_n102_), .b(new_n111_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n110_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n73_), .c(new_n47_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n65_), .O(z13));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(x23), .c(x22), .d(x19), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n107_), .c(x24), .O(new_n118_));
  inv1   g74(.a(x24), .O(new_n119_));
  nand3  g75(.a(x21), .b(x20), .c(x19), .O(new_n120_));
  inv1   g76(.a(new_n120_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n119_), .c(x23), .d(x22), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n118_), .c(x08), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n73_), .c(new_n47_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n67_), .O(z14));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(x24), .c(x23), .d(x22), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n120_), .c(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nor2   g85(.a(new_n111_), .b(new_n75_), .O(new_n130_));
  nand4  g86(.a(new_n121_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(x08), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n73_), .c(new_n47_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n69_), .O(z15));
  ...
  nor2   g94(.a(new_n119_), .b(new_n111_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n76_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n73_), .c(new_n47_), .O(new_n143_));
