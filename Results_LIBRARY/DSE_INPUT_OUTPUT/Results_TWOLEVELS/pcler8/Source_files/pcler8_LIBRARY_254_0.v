...
module FAU ( 
  ...
  nand3  g056(.a(x23), .b(x22), .c(x14), .O(new_n101_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n47_), .c(new_n82_), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(x10), .c(new_n61_), .d(new_n65_), .O(z12));
  ...
  inv1   g069(.a(new_n109_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n113_), .c(x22), .d(x21), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n112_), .c(new_n82_), .O(new_n116_));
  ...
  nand2  g075(.a(new_n46_), .b(x14), .O(new_n120_));
  nand3  g076(.a(x26), .b(x25), .c(x16), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n120_), .c(new_n119_), .d(x23), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x24), .O(new_n123_));
  inv1   g079(.a(x24), .O(new_n124_));
  nand4  g080(.a(new_n119_), .b(new_n124_), .c(x23), .d(x22), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n123_), .c(new_n91_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n47_), .c(new_n82_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(x10), .c(new_n69_), .O(z14));
  and2   g084(.a(x23), .b(x22), .O(new_n129_));
  ...
  nand4  g089(.a(new_n119_), .b(new_n129_), .c(new_n133_), .d(x24), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n132_), .c(new_n82_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n136_));
  oai21  g092(.a(new_n61_), .b(new_n71_), .c(new_n136_), .O(z15));
  inv1   g093(.a(x18), .O(new_n138_));
  nand4  g094(.a(x21), .b(x20), .c(x19), .d(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n124_), .b(x14), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n129_), .c(x25), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n139_), .c(x26), .O(new_n142_));
  nor2   g098(.a(new_n124_), .b(new_n113_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n133_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n114_), .c(new_n143_), .d(new_n76_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(new_n91_), .O(new_n146_));
