...
module FAU ( 
  ...
  nand2  g24(.a(new_n60_), .b(x04), .O(new_n69_));
  inv1   g25(.a(new_n69_), .O(z05));
  nand2  g26(.a(new_n60_), .b(x05), .O(new_n71_));
  inv1   g27(.a(new_n71_), .O(z06));
  nand2  g28(.a(new_n60_), .b(x06), .O(new_n73_));
  ...
  nand4  g37(.a(new_n81_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n61_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n96_));
  ...
  nand4  g60(.a(new_n104_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n105_));
  ...
  nand4  g67(.a(new_n111_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n112_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n122_));
  ...
  nand4  g85(.a(new_n129_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n130_));
  ...
  nor2   g91(.a(new_n118_), .b(new_n51_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n127_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n102_), .c(new_n136_), .d(new_n78_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n77_), .c(x09), .d(new_n59_), .O(new_n140_));
