...
module FAU ( 
  ...
  oai21  g020(.a(new_n47_), .b(new_n64_), .c(new_n58_), .O(z03));
  ...
  aoi21  g045(.a(new_n89_), .b(new_n47_), .c(x13), .O(new_n90_));
  ...
  aoi21  g050(.a(new_n94_), .b(new_n93_), .c(x13), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n96_));
  oai21  g052(.a(new_n62_), .b(new_n64_), .c(new_n96_), .O(z11));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n119_), .c(new_n83_), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n47_), .c(x13), .O(new_n125_));
  ...
  nand4  g087(.a(new_n127_), .b(new_n122_), .c(new_n131_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(x13), .O(new_n133_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(x13), .O(new_n143_));
