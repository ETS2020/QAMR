...
module FAU ( 
  ...
  aoi21  g11(.a(x10), .b(new_n55_), .c(new_n46_), .O(new_n56_));
  ...
  nand2  g23(.a(x10), .b(new_n55_), .O(new_n68_));
  oai21  g24(.a(new_n46_), .b(new_n67_), .c(new_n68_), .O(z06));
  inv1   g25(.a(x06), .O(new_n70_));
  oai21  g26(.a(new_n46_), .b(new_n70_), .c(new_n68_), .O(z07));
  inv1   g27(.a(x07), .O(new_n72_));
  oai21  g28(.a(new_n46_), .b(new_n72_), .c(new_n68_), .O(z08));
  ...
  oai21  g36(.a(new_n57_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n68_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n63_), .c(new_n68_), .O(z12));
  ...
  oai21  g68(.a(new_n57_), .b(new_n65_), .c(new_n112_), .O(z13));
  ...
  oai21  g78(.a(new_n57_), .b(new_n67_), .c(new_n122_), .O(z14));
  ...
  oai21  g87(.a(new_n57_), .b(new_n70_), .c(new_n131_), .O(z15));
  ...
  oai21  g97(.a(new_n57_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
