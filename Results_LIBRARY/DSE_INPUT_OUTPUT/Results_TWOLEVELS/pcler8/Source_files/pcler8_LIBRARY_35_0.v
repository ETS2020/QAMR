...
module FAU ( 
  ...
  aoi21  g011(.a(new_n55_), .b(x06), .c(x10), .O(z00));
  inv1   g012(.a(x00), .O(new_n57_));
  nor2   g013(.a(x10), .b(x06), .O(new_n58_));
  ...
  nor2   g029(.a(new_n45_), .b(new_n73_), .O(z07));
  ...
  oai22  g039(.a(new_n83_), .b(new_n73_), .c(new_n60_), .d(new_n57_), .O(z09));
  ...
  aoi21  g047(.a(new_n91_), .b(new_n45_), .c(new_n73_), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(x10), .c(new_n63_), .O(z10));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n45_), .c(new_n73_), .O(new_n100_));
  ...
  nand4  g064(.a(new_n108_), .b(x09), .c(new_n45_), .d(x06), .O(new_n109_));
  oai21  g065(.a(new_n60_), .b(new_n67_), .c(new_n109_), .O(z12));
  nand2  g066(.a(new_n78_), .b(x06), .O(new_n111_));
  nand4  g067(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n111_), .c(new_n102_), .d(x22), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x23), .O(new_n114_));
  nand4  g070(.a(new_n102_), .b(new_n51_), .c(x22), .d(x21), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n85_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n45_), .c(new_n73_), .O(new_n117_));
  ...
  nand4  g080(.a(new_n124_), .b(x09), .c(new_n45_), .d(x06), .O(new_n125_));
  oai21  g081(.a(new_n60_), .b(new_n71_), .c(new_n125_), .O(z14));
  inv1   g082(.a(x25), .O(new_n127_));
  nand4  g083(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n128_));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x24), .c(x19), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(x06), .c(new_n130_), .O(new_n131_));
  nand4  g087(.a(new_n52_), .b(new_n49_), .c(new_n127_), .d(x24), .O(new_n132_));
  oai21  g088(.a(new_n131_), .b(new_n127_), .c(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(x09), .c(new_n73_), .O(new_n134_));
  oai22  g090(.a(new_n134_), .b(x10), .c(new_n45_), .d(new_n73_), .O(z15));
  nand3  g091(.a(x26), .b(new_n51_), .c(new_n77_), .O(new_n136_));
  oai22  g092(.a(new_n136_), .b(new_n46_), .c(new_n45_), .d(new_n75_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x06), .O(new_n138_));
  ...
  nor2   g098(.a(new_n122_), .b(new_n51_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n127_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n102_), .c(new_n143_), .d(new_n79_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x09), .c(new_n45_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x06), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n77_), .O(new_n149_));
  nand3  g105(.a(x10), .b(x08), .c(x07), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(new_n138_), .O(z16));
endmodule
