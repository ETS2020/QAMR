...
module FAU ( 
  ...
  oai21  g017(.a(new_n46_), .b(new_n61_), .c(new_n55_), .O(z03));
  ...
  nor2   g022(.a(new_n66_), .b(new_n65_), .O(z05));
  ...
  nand2  g028(.a(new_n72_), .b(new_n55_), .O(z08));
  ...
  nand3  g047(.a(new_n54_), .b(x20), .c(x19), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n94_));
  oai21  g050(.a(new_n66_), .b(new_n61_), .c(new_n94_), .O(z11));
  nand2  g051(.a(x22), .b(x09), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(x08), .c(new_n47_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n54_), .O(new_n98_));
  nand2  g054(.a(x23), .b(x14), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n89_), .c(x20), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n81_), .c(x22), .O(new_n101_));
  ...
  nand3  g062(.a(new_n106_), .b(new_n98_), .c(new_n63_), .O(z12));
  ...
  oai21  g070(.a(new_n66_), .b(new_n65_), .c(new_n114_), .O(z13));
  nand2  g071(.a(x24), .b(x09), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(x08), .c(new_n47_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n54_), .O(new_n118_));
  nand3  g074(.a(x26), .b(x25), .c(x16), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x23), .c(x22), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n102_), .c(x24), .O(new_n121_));
  ...
  nand3  g083(.a(new_n127_), .b(new_n118_), .c(new_n68_), .O(z14));
  ...
  nand3  g087(.a(x22), .b(x20), .c(x19), .O(new_n132_));
  ...
  nor2   g092(.a(new_n111_), .b(new_n74_), .O(new_n137_));
  ...
  nand3  g096(.a(new_n140_), .b(new_n131_), .c(new_n70_), .O(z15));
  nand2  g097(.a(x26), .b(x09), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(x08), .c(new_n47_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n54_), .O(new_n144_));
  inv1   g100(.a(x18), .O(new_n145_));
  nand2  g101(.a(new_n103_), .b(new_n145_), .O(new_n146_));
  nand4  g102(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(x26), .O(new_n148_));
  nor2   g104(.a(new_n122_), .b(new_n111_), .O(new_n149_));
  nor2   g105(.a(x26), .b(new_n136_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n103_), .c(new_n149_), .d(new_n75_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n144_), .c(new_n72_), .O(z16));
endmodule
