...
module FAU ( 
  ...
  aoi21  g17(.a(new_n47_), .b(new_n46_), .c(new_n61_), .O(z03));
  ...
  nand3  g35(.a(new_n79_), .b(new_n57_), .c(new_n54_), .O(z09));
  ...
  nand3  g42(.a(new_n86_), .b(new_n59_), .c(new_n54_), .O(z10));
  ...
  nand3  g49(.a(new_n93_), .b(x09), .c(new_n46_), .O(new_n94_));
  nand2  g50(.a(x08), .b(x02), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n94_), .c(x10), .O(z11));
  ...
  nand3  g68(.a(new_n112_), .b(new_n65_), .c(new_n54_), .O(z13));
  ...
  nor2   g83(.a(new_n109_), .b(new_n74_), .O(new_n128_));
  ...
  nand3  g87(.a(new_n131_), .b(new_n69_), .c(new_n54_), .O(z15));
  ...
  nand4  g94(.a(new_n138_), .b(new_n101_), .c(new_n137_), .d(new_n75_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n71_), .c(new_n54_), .O(z16));
endmodule
