...
module FAU ( 
  ...
  nand4  g58(.a(new_n102_), .b(new_n46_), .c(x09), .d(new_n55_), .O(new_n103_));
  ...
  aoi21  g67(.a(x22), .b(x21), .c(x10), .O(new_n112_));
  nand3  g68(.a(x26), .b(x25), .c(x16), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(x23), .c(x20), .d(x19), .O(new_n114_));
  ...
  nand4  g85(.a(new_n129_), .b(new_n46_), .c(x09), .d(new_n55_), .O(new_n130_));
  ...
  nor2   g94(.a(new_n116_), .b(new_n50_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n127_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n100_), .c(new_n139_), .d(new_n76_), .O(new_n141_));
