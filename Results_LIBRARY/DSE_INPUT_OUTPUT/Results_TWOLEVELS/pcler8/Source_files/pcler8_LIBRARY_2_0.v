...
module FAU ( 
  ...
  inv1   g23(.a(new_n62_), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n67_), .O(z04));
  inv1   g25(.a(x04), .O(new_n70_));
  oai21  g26(.a(new_n58_), .b(new_n70_), .c(new_n60_), .O(z05));
  nand2  g27(.a(x08), .b(x05), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(new_n60_), .O(z06));
  ...
  oai21  g39(.a(new_n68_), .b(new_n57_), .c(new_n83_), .O(z09));
  ...
  oai21  g62(.a(new_n68_), .b(new_n67_), .c(new_n106_), .O(z12));
  ...
  oai21  g69(.a(new_n68_), .b(new_n70_), .c(new_n113_), .O(z13));
  ...
  oai21  g87(.a(new_n131_), .b(new_n91_), .c(new_n78_), .O(new_n132_));
  ...
  oai21  g97(.a(new_n141_), .b(new_n91_), .c(new_n78_), .O(new_n142_));
