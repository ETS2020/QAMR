...
module FAU ( 
  ...
  nor2   g00(.a(x22), .b(x09), .O(new_n45_));
  ...
  nand2  g86(.a(x26), .b(new_n48_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(x08), .c(x09), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n52_), .O(new_n133_));
  inv1   g89(.a(x18), .O(new_n134_));
  nand3  g90(.a(x20), .b(x19), .c(new_n134_), .O(new_n135_));
  nand4  g91(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n136_));
