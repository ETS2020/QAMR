...
module FAU ( 
  ...
  aoi21  g040(.a(new_n84_), .b(new_n46_), .c(x10), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(new_n54_), .c(new_n57_), .O(z09));
  ...
  aoi21  g056(.a(new_n100_), .b(new_n99_), .c(x08), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(x10), .c(x09), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n62_), .O(z11));
  ...
  nand3  g069(.a(new_n113_), .b(x15), .c(new_n47_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n104_), .c(x22), .d(x21), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x23), .O(new_n116_));
  nand4  g072(.a(new_n104_), .b(new_n78_), .c(x22), .d(x21), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(x08), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(x10), .c(x09), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n66_), .O(z13));
  nand3  g076(.a(x21), .b(x20), .c(x19), .O(new_n121_));
  nand2  g077(.a(new_n82_), .b(x16), .O(new_n122_));
  ...
  nand4  g081(.a(new_n125_), .b(new_n79_), .c(x23), .d(x22), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n68_), .O(z14));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(x23), .c(x10), .O(new_n131_));
  nand4  g087(.a(new_n104_), .b(x24), .c(x22), .d(x21), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(x25), .O(new_n133_));
  nor2   g089(.a(new_n78_), .b(new_n75_), .O(new_n134_));
  nand4  g090(.a(new_n125_), .b(new_n134_), .c(new_n81_), .d(x24), .O(new_n135_));
  ...
  nand3  g096(.a(new_n134_), .b(x25), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n81_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n104_), .c(new_n80_), .d(new_n76_), .O(new_n144_));
