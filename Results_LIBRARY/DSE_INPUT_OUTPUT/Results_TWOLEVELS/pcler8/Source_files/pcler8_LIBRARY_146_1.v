...
module FAU ( 
  ...
  nor2   g15(.a(new_n46_), .b(new_n59_), .O(z03));
  inv1   g16(.a(x03), .O(new_n61_));
  nor2   g17(.a(new_n46_), .b(new_n61_), .O(z04));
  inv1   g18(.a(x04), .O(new_n63_));
  nor2   g19(.a(new_n46_), .b(new_n63_), .O(z05));
  inv1   g20(.a(x05), .O(new_n65_));
  nor2   g21(.a(new_n46_), .b(new_n65_), .O(z06));
  nand2  g22(.a(x08), .b(x06), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n54_), .O(z07));
  inv1   g24(.a(x07), .O(new_n69_));
  nor2   g25(.a(new_n46_), .b(new_n69_), .O(z08));
  ...
  nand4  g35(.a(x22), .b(x21), .c(x20), .d(x12), .O(new_n80_));
  ...
  oai21  g40(.a(new_n84_), .b(new_n79_), .c(new_n47_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  ...
  oai21  g47(.a(new_n91_), .b(new_n88_), .c(x21), .O(new_n92_));
  ...
  oai21  g51(.a(new_n46_), .b(new_n59_), .c(new_n95_), .O(z11));
  ...
  oai21  g68(.a(new_n46_), .b(new_n63_), .c(new_n112_), .O(z13));
  ...
  nor2   g83(.a(new_n109_), .b(new_n72_), .O(new_n128_));
  ...
  nand2  g87(.a(new_n131_), .b(new_n67_), .O(z15));
  ...
  oai21  g97(.a(new_n46_), .b(new_n69_), .c(new_n141_), .O(z16));
endmodule
