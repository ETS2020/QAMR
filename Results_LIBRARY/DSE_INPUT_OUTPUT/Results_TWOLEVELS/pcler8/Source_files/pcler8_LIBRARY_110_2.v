...
module FAU ( 
  ...
  nand4  g75(.a(new_n119_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n120_));
  ...
  nor2   g89(.a(new_n116_), .b(new_n45_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n125_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n134_), .c(new_n76_), .d(new_n50_), .O(new_n136_));
  nand2  g92(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n138_));
