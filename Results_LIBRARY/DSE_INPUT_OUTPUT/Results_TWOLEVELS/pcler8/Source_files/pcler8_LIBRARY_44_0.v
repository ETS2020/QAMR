...
module FAU ( 
  ...
  oai22  g053(.a(new_n97_), .b(x10), .c(new_n61_), .d(new_n59_), .O(z11));
  ...
  oai21  g071(.a(new_n61_), .b(new_n65_), .c(new_n115_), .O(z13));
  ...
  nand4  g092(.a(new_n135_), .b(x25), .c(x24), .d(x23), .O(new_n137_));
  oai22  g093(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(x20), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x21), .O(new_n139_));
  inv1   g095(.a(x18), .O(new_n140_));
  nand3  g096(.a(x21), .b(x19), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n129_), .b(x25), .c(x24), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n141_), .c(x26), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n73_), .c(x09), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n45_), .c(new_n71_), .O(z16));
endmodule
