...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n62_, new_n63_, new_n65_, new_n67_, new_n69_, new_n70_,
  ...
  nor2   g17(.a(new_n59_), .b(new_n58_), .O(new_n62_));
  ...
  oai21  g23(.a(new_n58_), .b(new_n67_), .c(new_n60_), .O(z04));
  inv1   g24(.a(x04), .O(new_n69_));
  inv1   g25(.a(new_n62_), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n69_), .O(z05));
  nand2  g27(.a(new_n62_), .b(x05), .O(new_n72_));
  inv1   g28(.a(new_n72_), .O(z06));
  nand2  g29(.a(new_n62_), .b(x06), .O(new_n74_));
  inv1   g30(.a(new_n74_), .O(z07));
  nand2  g31(.a(new_n62_), .b(x07), .O(new_n76_));
  nand2  g32(.a(new_n76_), .b(new_n60_), .O(z08));
  ...
  oai21  g39(.a(new_n70_), .b(new_n57_), .c(new_n83_), .O(z09));
  ...
  oai21  g52(.a(new_n96_), .b(new_n91_), .c(new_n78_), .O(new_n97_));
  ...
  nand4  g61(.a(new_n105_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n106_));
  oai21  g62(.a(new_n70_), .b(new_n67_), .c(new_n106_), .O(z12));
  ...
  nand4  g68(.a(new_n112_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n113_));
  oai21  g69(.a(new_n70_), .b(new_n69_), .c(new_n113_), .O(z13));
  aoi21  g70(.a(x22), .b(x21), .c(new_n91_), .O(new_n115_));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(x23), .c(x20), .d(x19), .O(new_n117_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n91_), .c(new_n78_), .O(new_n124_));
  ...
  nand4  g87(.a(new_n131_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n132_));
  ...
  nand4  g97(.a(new_n141_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n142_));
