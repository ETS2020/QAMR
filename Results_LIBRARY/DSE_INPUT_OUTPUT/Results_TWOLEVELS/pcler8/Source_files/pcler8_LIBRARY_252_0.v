...
module FAU ( 
  ...
  oai21  g068(.a(new_n112_), .b(new_n89_), .c(new_n47_), .O(new_n113_));
  ...
  aoi21  g081(.a(new_n125_), .b(x23), .c(new_n89_), .O(new_n126_));
  nand3  g082(.a(x24), .b(x22), .c(x21), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n102_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n126_), .c(x25), .O(new_n130_));
  ...
  oai21  g090(.a(new_n134_), .b(new_n89_), .c(new_n47_), .O(new_n135_));
  ...
  nor2   g096(.a(new_n119_), .b(new_n110_), .O(new_n141_));
