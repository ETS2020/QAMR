...
module FAU ( 
  ...
  nand2  g011(.a(x14), .b(new_n48_), .O(new_n56_));
  ...
  aoi21  g043(.a(new_n87_), .b(new_n85_), .c(x14), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n89_));
  oai21  g045(.a(new_n60_), .b(new_n59_), .c(new_n89_), .O(z10));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n95_), .c(x14), .O(new_n97_));
  ...
  oai21  g056(.a(x20), .b(x14), .c(x21), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n91_), .c(x22), .O(new_n102_));
  nor2   g058(.a(new_n86_), .b(new_n91_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n46_), .c(x21), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n100_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n47_), .c(x14), .O(new_n106_));
  oai22  g062(.a(new_n106_), .b(x10), .c(new_n60_), .d(new_n64_), .O(z12));
  inv1   g063(.a(new_n103_), .O(new_n108_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(x14), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n115_));
  oai21  g071(.a(new_n60_), .b(new_n66_), .c(new_n115_), .O(z13));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(x14), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n125_));
  oai21  g081(.a(new_n60_), .b(new_n68_), .c(new_n125_), .O(z14));
  oai21  g082(.a(new_n112_), .b(new_n46_), .c(new_n49_), .O(new_n127_));
  aoi21  g083(.a(x26), .b(x17), .c(new_n121_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n103_), .d(x21), .O(new_n129_));
  ...
  aoi21  g090(.a(new_n134_), .b(new_n47_), .c(x14), .O(new_n135_));
  ...
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(x14), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n145_));
  oai21  g101(.a(new_n60_), .b(new_n72_), .c(new_n145_), .O(z16));
endmodule
