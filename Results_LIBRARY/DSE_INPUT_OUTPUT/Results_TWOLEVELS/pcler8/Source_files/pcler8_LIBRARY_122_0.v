...
module FAU ( 
  ...
  nand4  g08(.a(new_n52_), .b(new_n50_), .c(new_n49_), .d(new_n46_), .O(new_n53_));
  ...
  nand2  g28(.a(new_n72_), .b(new_n61_), .O(z07));
  nand2  g29(.a(x08), .b(x07), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n61_), .O(z08));
  inv1   g31(.a(x09), .O(new_n76_));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n56_), .c(new_n76_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(x10), .c(new_n59_), .d(new_n55_), .O(z09));
  inv1   g39(.a(x10), .O(new_n84_));
  nand3  g40(.a(x22), .b(x21), .c(x12), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n80_), .c(x19), .O(new_n86_));
  nor2   g42(.a(x20), .b(new_n45_), .O(new_n87_));
  aoi21  g43(.a(new_n86_), .b(x20), .c(new_n87_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(x08), .c(x09), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n84_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n62_), .O(z10));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n51_), .c(x20), .O(new_n93_));
  ...
  nand4  g67(.a(new_n103_), .b(new_n111_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n110_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n76_), .c(new_n84_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n68_), .O(z13));
  ...
  oai21  g79(.a(new_n123_), .b(new_n76_), .c(new_n84_), .O(new_n124_));
  oai21  g80(.a(new_n59_), .b(new_n70_), .c(new_n124_), .O(z14));
  ...
  nand4  g87(.a(new_n131_), .b(new_n84_), .c(x09), .d(new_n56_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n72_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand4  g90(.a(x21), .b(x20), .c(x19), .d(new_n134_), .O(new_n135_));
  nand2  g91(.a(new_n120_), .b(x09), .O(new_n136_));
  nand3  g92(.a(new_n136_), .b(new_n50_), .c(x25), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n135_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n120_), .b(new_n111_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n103_), .c(new_n139_), .d(new_n78_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n76_), .c(new_n84_), .O(new_n143_));
