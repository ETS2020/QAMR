...
module FAU ( 
  ...
  aoi21  g010(.a(x10), .b(new_n54_), .c(new_n46_), .O(z01));
  oai21  g011(.a(new_n47_), .b(x01), .c(x08), .O(new_n56_));
  ...
  aoi21  g022(.a(x10), .b(new_n66_), .c(new_n46_), .O(z07));
  ...
  nand2  g032(.a(x10), .b(x08), .O(new_n77_));
  oai21  g033(.a(new_n77_), .b(new_n54_), .c(new_n76_), .O(z09));
  inv1   g034(.a(x20), .O(new_n79_));
  nand4  g035(.a(x22), .b(x21), .c(x20), .d(x12), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(new_n74_), .c(x20), .O(new_n81_));
  nand2  g037(.a(new_n81_), .b(x19), .O(new_n82_));
  oai21  g038(.a(new_n79_), .b(x19), .c(new_n82_), .O(new_n83_));
  nand3  g039(.a(new_n83_), .b(new_n47_), .c(x09), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n56_), .O(z10));
  inv1   g041(.a(x02), .O(new_n86_));
  ...
  oai21  g046(.a(new_n90_), .b(new_n87_), .c(x21), .O(new_n91_));
  ...
  oai21  g050(.a(new_n77_), .b(new_n86_), .c(new_n94_), .O(z11));
  inv1   g051(.a(x03), .O(new_n96_));
  ...
  oai21  g060(.a(new_n77_), .b(new_n96_), .c(new_n104_), .O(z12));
  ...
  oai21  g069(.a(new_n77_), .b(new_n106_), .c(new_n113_), .O(z13));
  inv1   g070(.a(x05), .O(new_n115_));
  ...
  oai21  g080(.a(new_n77_), .b(new_n115_), .c(new_n124_), .O(z14));
  ...
  nor2   g085(.a(new_n110_), .b(new_n71_), .O(new_n130_));
  ...
  oai21  g089(.a(new_n77_), .b(new_n66_), .c(new_n133_), .O(z15));
  inv1   g090(.a(x07), .O(new_n135_));
  ...
  nor2   g095(.a(new_n120_), .b(new_n110_), .O(new_n140_));
  ...
  oai21  g100(.a(new_n77_), .b(new_n135_), .c(new_n144_), .O(z16));
endmodule
