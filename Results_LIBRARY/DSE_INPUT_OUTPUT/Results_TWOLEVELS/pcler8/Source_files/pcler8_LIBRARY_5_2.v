...
module FAU ( 
  ...
  nand3  g32(.a(new_n76_), .b(new_n55_), .c(x09), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n56_), .O(z09));
  oai21  g34(.a(new_n55_), .b(x01), .c(x08), .O(new_n79_));
  ...
  nand3  g40(.a(new_n84_), .b(new_n55_), .c(x09), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n79_), .O(z10));
  nand3  g42(.a(x23), .b(x22), .c(x13), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n51_), .c(x20), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n80_), .c(x21), .O(new_n89_));
  nand3  g45(.a(new_n72_), .b(x20), .c(x19), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g47(.a(new_n91_), .b(new_n55_), .c(x09), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n60_), .O(z11));
  nand2  g49(.a(x20), .b(x19), .O(new_n94_));
  nand2  g50(.a(x23), .b(x14), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n51_), .c(x21), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n94_), .c(x22), .O(new_n97_));
  inv1   g53(.a(new_n94_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n48_), .c(x21), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n55_), .c(x09), .d(new_n45_), .O(new_n101_));
  nor2   g57(.a(new_n55_), .b(new_n45_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(x03), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n101_), .O(z12));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x22), .c(x21), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n94_), .c(x23), .O(new_n107_));
  nand4  g63(.a(new_n98_), .b(new_n49_), .c(x22), .d(x21), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n55_), .c(x09), .d(new_n45_), .O(new_n110_));
  nand2  g66(.a(new_n102_), .b(x04), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(z13));
  oai21  g68(.a(new_n55_), .b(x05), .c(x08), .O(new_n113_));
  ...
  nand3  g77(.a(new_n121_), .b(new_n55_), .c(x09), .O(new_n122_));
  ...
  nand4  g83(.a(new_n119_), .b(new_n50_), .c(new_n127_), .d(x24), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n55_), .c(x09), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n68_), .O(z15));
  ...
  nor2   g91(.a(new_n118_), .b(new_n49_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n127_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n98_), .c(new_n136_), .d(new_n73_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n55_), .c(x09), .d(new_n45_), .O(new_n140_));
  nand2  g96(.a(new_n102_), .b(x07), .O(new_n141_));
