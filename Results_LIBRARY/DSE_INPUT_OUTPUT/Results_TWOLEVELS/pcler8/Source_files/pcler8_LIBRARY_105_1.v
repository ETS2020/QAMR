...
module FAU ( 
  ...
  nand2  g13(.a(x10), .b(new_n54_), .O(new_n58_));
  nand2  g14(.a(new_n55_), .b(x01), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(new_n58_), .O(z02));
  nand2  g16(.a(new_n55_), .b(x02), .O(new_n61_));
  ...
  nand2  g22(.a(new_n66_), .b(new_n58_), .O(z05));
  inv1   g23(.a(x05), .O(new_n68_));
  oai21  g24(.a(new_n46_), .b(new_n68_), .c(new_n58_), .O(z06));
  nand2  g25(.a(x08), .b(x06), .O(new_n70_));
  nand2  g26(.a(new_n70_), .b(new_n58_), .O(z07));
  inv1   g27(.a(x07), .O(new_n72_));
  oai21  g28(.a(new_n46_), .b(new_n72_), .c(new_n58_), .O(z08));
  ...
  nand3  g36(.a(new_n80_), .b(new_n56_), .c(new_n58_), .O(z09));
  ...
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n58_), .O(z11));
  ...
  nand3  g68(.a(new_n112_), .b(new_n66_), .c(new_n58_), .O(z13));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n58_), .O(z15));
