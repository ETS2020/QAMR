...
module FAU ( 
  ...
  aoi21  g013(.a(new_n55_), .b(x10), .c(new_n46_), .O(new_n58_));
  ...
  oai21  g019(.a(new_n46_), .b(new_n63_), .c(new_n56_), .O(z04));
  ...
  nor2   g030(.a(new_n55_), .b(new_n74_), .O(new_n75_));
  ...
  oai21  g035(.a(new_n66_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  nand3  g047(.a(new_n74_), .b(x20), .c(x19), .O(new_n92_));
  ...
  oai21  g067(.a(new_n66_), .b(new_n65_), .c(new_n111_), .O(z13));
  inv1   g068(.a(x24), .O(new_n113_));
  nand2  g069(.a(x09), .b(new_n46_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n47_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n55_), .O(new_n116_));
  nand3  g072(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x23), .c(x21), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n96_), .c(x24), .O(new_n119_));
  nand3  g075(.a(x21), .b(x20), .c(x19), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n113_), .c(x23), .d(x22), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n116_), .c(new_n68_), .O(z14));
  nand2  g081(.a(x26), .b(x17), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(x24), .c(x23), .d(x22), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n120_), .c(x25), .O(new_n128_));
  inv1   g084(.a(x25), .O(new_n129_));
  nor2   g085(.a(new_n108_), .b(new_n55_), .O(new_n130_));
  ...
  oai21  g089(.a(new_n66_), .b(new_n70_), .c(new_n133_), .O(z15));
  oai21  g090(.a(new_n114_), .b(new_n45_), .c(new_n47_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n55_), .O(new_n136_));
  inv1   g092(.a(x18), .O(new_n137_));
  nand2  g093(.a(new_n100_), .b(new_n137_), .O(new_n138_));
  nand4  g094(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n138_), .c(x26), .O(new_n140_));
  nor2   g096(.a(new_n113_), .b(new_n108_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n129_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n100_), .c(new_n141_), .d(new_n75_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n136_), .c(new_n72_), .O(z16));
endmodule
