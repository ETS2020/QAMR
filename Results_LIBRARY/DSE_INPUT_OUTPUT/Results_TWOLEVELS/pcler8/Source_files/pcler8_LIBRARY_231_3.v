...
module FAU ( 
  ...
  nand2  g19(.a(new_n61_), .b(x01), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z02));
  nand2  g21(.a(new_n61_), .b(x02), .O(new_n66_));
  ...
  oai21  g29(.a(new_n73_), .b(new_n72_), .c(new_n59_), .O(z06));
  nand2  g30(.a(new_n61_), .b(x06), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(z07));
  nand2  g32(.a(new_n61_), .b(x07), .O(new_n77_));
  ...
  nand4  g38(.a(new_n82_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n83_));
  ...
  nand4  g44(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n66_), .O(z11));
  ...
  nand4  g60(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n68_), .O(z12));
  ...
  nand4  g78(.a(new_n122_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n123_));
  oai21  g79(.a(new_n60_), .b(new_n72_), .c(new_n123_), .O(z14));
  ...
  nand4  g97(.a(new_n141_), .b(new_n46_), .c(x09), .d(new_n73_), .O(new_n142_));
