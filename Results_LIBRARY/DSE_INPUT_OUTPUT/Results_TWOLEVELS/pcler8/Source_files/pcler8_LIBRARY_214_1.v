...
module FAU ( 
  ...
  nor2   g13(.a(new_n46_), .b(new_n54_), .O(z02));
  ...
  nor2   g23(.a(new_n61_), .b(new_n67_), .O(z06));
  ...
  oai21  g68(.a(new_n61_), .b(new_n65_), .c(new_n112_), .O(z13));
  ...
  oai21  g78(.a(new_n61_), .b(new_n67_), .c(new_n122_), .O(z14));
