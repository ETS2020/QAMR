...
module FAU ( 
  ...
  nand3  g062(.a(new_n106_), .b(new_n98_), .c(new_n64_), .O(z12));
  ...
  nor2   g088(.a(new_n111_), .b(new_n74_), .O(new_n133_));
  ...
  nor2   g097(.a(new_n122_), .b(new_n111_), .O(new_n142_));
