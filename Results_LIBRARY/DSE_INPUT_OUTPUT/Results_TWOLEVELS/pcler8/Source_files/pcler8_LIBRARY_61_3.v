...
module FAU ( 
  ...
  and2   g07(.a(x23), .b(x22), .O(new_n52_));
  nand3  g08(.a(x26), .b(x25), .c(x24), .O(new_n53_));
  inv1   g09(.a(new_n53_), .O(new_n54_));
  nand4  g10(.a(new_n54_), .b(new_n52_), .c(new_n51_), .d(new_n48_), .O(new_n55_));
  ...
  oai21  g23(.a(new_n67_), .b(new_n66_), .c(new_n57_), .O(z04));
  inv1   g24(.a(x04), .O(new_n69_));
  oai21  g25(.a(new_n67_), .b(new_n69_), .c(new_n57_), .O(z05));
  nand2  g26(.a(new_n59_), .b(x05), .O(new_n71_));
  inv1   g27(.a(new_n71_), .O(z06));
  inv1   g28(.a(x06), .O(new_n73_));
  oai21  g29(.a(new_n67_), .b(new_n73_), .c(new_n57_), .O(z07));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n67_), .c(x10), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n45_), .c(new_n60_), .O(z09));
  ...
  oai21  g42(.a(x20), .b(new_n47_), .c(new_n86_), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n62_), .O(z10));
  nand3  g45(.a(x23), .b(x22), .c(x13), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n53_), .c(x20), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n47_), .c(x21), .O(new_n92_));
  nand3  g48(.a(new_n50_), .b(x20), .c(x19), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n92_), .c(x08), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(x10), .c(x09), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n64_), .O(z11));
  nand2  g52(.a(x20), .b(x19), .O(new_n97_));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n53_), .c(x21), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n97_), .c(x22), .O(new_n100_));
  inv1   g56(.a(new_n97_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n77_), .c(x21), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n104_));
  oai21  g60(.a(new_n58_), .b(new_n66_), .c(new_n104_), .O(z12));
  ...
  nand4  g65(.a(new_n101_), .b(new_n109_), .c(x22), .d(x21), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n112_));
  oai21  g68(.a(new_n58_), .b(new_n69_), .c(new_n112_), .O(z13));
  nand3  g69(.a(x21), .b(x20), .c(x19), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nand2  g71(.a(new_n77_), .b(new_n46_), .O(new_n116_));
  ...
  nand2  g79(.a(new_n123_), .b(new_n71_), .O(z14));
  ...
  nand4  g84(.a(new_n115_), .b(new_n52_), .c(new_n128_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n131_));
  oai21  g87(.a(new_n58_), .b(new_n73_), .c(new_n131_), .O(z15));
  inv1   g88(.a(x18), .O(new_n133_));
  nand4  g89(.a(x21), .b(x20), .c(x19), .d(new_n133_), .O(new_n134_));
  nand2  g90(.a(new_n120_), .b(new_n46_), .O(new_n135_));
  nand3  g91(.a(new_n135_), .b(new_n52_), .c(x25), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n134_), .c(x26), .O(new_n137_));
  nor2   g93(.a(new_n120_), .b(new_n109_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n128_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n101_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x08), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(x10), .c(x09), .O(new_n142_));
  nand2  g98(.a(new_n142_), .b(new_n75_), .O(z16));
endmodule
