...
module FAU ( 
  ...
  aoi21  g10(.a(new_n47_), .b(new_n54_), .c(new_n46_), .O(z01));
  oai21  g11(.a(x10), .b(x01), .c(x08), .O(new_n56_));
  ...
  aoi21  g24(.a(new_n47_), .b(new_n68_), .c(new_n46_), .O(z08));
  ...
  oai21  g38(.a(x20), .b(new_n79_), .c(new_n82_), .O(new_n83_));
  ...
  oai21  g44(.a(new_n88_), .b(new_n79_), .c(x21), .O(new_n89_));
  ...
  nand3  g56(.a(new_n100_), .b(x09), .c(new_n46_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n60_), .c(x10), .O(z12));
  ...
  nand3  g83(.a(new_n127_), .b(x09), .c(new_n46_), .O(new_n128_));
  aoi21  g84(.a(new_n128_), .b(new_n66_), .c(x10), .O(z15));
  ...
  aoi21  g95(.a(new_n139_), .b(new_n138_), .c(x10), .O(z16));
endmodule
