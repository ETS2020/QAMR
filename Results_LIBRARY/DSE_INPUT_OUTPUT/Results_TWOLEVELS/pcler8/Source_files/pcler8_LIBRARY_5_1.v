...
module FAU ( 
  ...
  aoi21  g13(.a(new_n57_), .b(new_n45_), .c(x08), .O(z00));
  inv1   g14(.a(x08), .O(new_n59_));
  nand2  g15(.a(x10), .b(new_n59_), .O(new_n60_));
  ...
  nand2  g23(.a(new_n67_), .b(new_n60_), .O(z04));
  ...
  nor2   g32(.a(new_n52_), .b(new_n50_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n97_), .b(new_n52_), .c(x21), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n104_));
  ...
  nand4  g64(.a(new_n97_), .b(new_n53_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n69_), .O(z13));
  aoi21  g68(.a(x22), .b(x21), .c(x10), .O(new_n113_));
  nand3  g69(.a(x26), .b(x25), .c(x16), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(x23), .c(x20), .d(x19), .O(new_n115_));
  ...
  aoi21  g76(.a(new_n120_), .b(new_n116_), .c(new_n46_), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(x10), .c(new_n59_), .O(new_n122_));
  ...
  oai21  g85(.a(new_n129_), .b(x10), .c(new_n59_), .O(new_n130_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n140_));
