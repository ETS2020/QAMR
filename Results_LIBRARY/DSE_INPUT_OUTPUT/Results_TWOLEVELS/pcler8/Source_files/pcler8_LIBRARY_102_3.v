...
module FAU ( 
  ...
  nand2  g09(.a(x24), .b(x10), .O(new_n54_));
  ...
  nand4  g44(.a(x26), .b(x25), .c(x23), .d(x22), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n88_), .c(new_n47_), .O(new_n90_));
  nand2  g46(.a(new_n90_), .b(x24), .O(new_n91_));
  nand2  g47(.a(x20), .b(x19), .O(new_n92_));
  inv1   g48(.a(new_n92_), .O(new_n93_));
  nand3  g49(.a(new_n73_), .b(x20), .c(x19), .O(new_n94_));
  oai21  g50(.a(new_n93_), .b(new_n73_), .c(new_n94_), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(new_n91_), .c(new_n61_), .O(z11));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  nand3  g54(.a(x26), .b(x25), .c(x24), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n98_), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n92_), .c(x22), .O(new_n101_));
  nand3  g57(.a(new_n93_), .b(new_n74_), .c(x21), .O(new_n102_));
  ...
  nand4  g65(.a(new_n93_), .b(new_n109_), .c(x22), .d(x21), .O(new_n110_));
  ...
  nor2   g74(.a(x24), .b(new_n109_), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(new_n93_), .c(new_n75_), .d(new_n47_), .O(new_n120_));
  oai21  g76(.a(new_n118_), .b(new_n114_), .c(new_n120_), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(x09), .c(new_n46_), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n67_), .c(new_n54_), .O(z14));
  nand3  g79(.a(x21), .b(x20), .c(x19), .O(new_n124_));
  inv1   g80(.a(x25), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(x23), .c(x22), .O(new_n126_));
  nand3  g82(.a(x26), .b(x25), .c(x17), .O(new_n127_));
  oai21  g83(.a(new_n126_), .b(new_n124_), .c(new_n127_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(x24), .O(new_n129_));
  nor2   g85(.a(new_n114_), .b(new_n109_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(x22), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n124_), .c(x25), .O(new_n132_));
  ...
  aoi22  g94(.a(new_n138_), .b(x24), .c(new_n136_), .d(new_n47_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n125_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n93_), .c(new_n130_), .d(new_n75_), .O(new_n141_));
  oai21  g97(.a(new_n139_), .b(new_n45_), .c(new_n141_), .O(new_n142_));
  nand3  g98(.a(new_n142_), .b(x09), .c(new_n46_), .O(new_n143_));
  nand3  g99(.a(new_n143_), .b(new_n71_), .c(new_n54_), .O(z16));
endmodule
