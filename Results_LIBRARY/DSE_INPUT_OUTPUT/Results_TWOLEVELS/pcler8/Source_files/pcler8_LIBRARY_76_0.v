...
module FAU ( 
  ...
  oai21  g025(.a(new_n47_), .b(new_n69_), .c(new_n64_), .O(z06));
  ...
  nand4  g035(.a(new_n79_), .b(x17), .c(new_n48_), .d(x09), .O(new_n80_));
  ...
  oai22  g046(.a(new_n90_), .b(x10), .c(new_n58_), .d(new_n60_), .O(z10));
  ...
  oai22  g055(.a(new_n99_), .b(x10), .c(new_n58_), .d(new_n62_), .O(z11));
  ...
  nor2   g066(.a(new_n45_), .b(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x24), .c(x15), .O(new_n112_));
  ...
  nand2  g076(.a(new_n111_), .b(x16), .O(new_n121_));
  ...
  nand3  g085(.a(x26), .b(x25), .c(x17), .O(new_n130_));
  ...
  nand4  g089(.a(new_n133_), .b(x21), .c(x20), .d(x19), .O(new_n134_));
  nor2   g090(.a(new_n115_), .b(new_n46_), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n82_), .O(new_n136_));
  nand3  g092(.a(new_n101_), .b(x24), .c(x21), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n136_), .c(x25), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n134_), .c(new_n83_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n47_), .c(new_n82_), .O(new_n140_));
  ...
  nor2   g101(.a(new_n124_), .b(new_n115_), .O(new_n146_));
  nor2   g102(.a(x26), .b(new_n110_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n101_), .c(new_n146_), .d(new_n76_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n145_), .c(new_n82_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n150_));
  oai21  g106(.a(new_n58_), .b(new_n73_), .c(new_n150_), .O(z16));
endmodule
