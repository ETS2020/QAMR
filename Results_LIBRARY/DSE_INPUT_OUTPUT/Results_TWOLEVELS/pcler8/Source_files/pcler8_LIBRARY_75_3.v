...
module FAU ( 
  ...
  aoi21  g023(.a(x08), .b(x05), .c(new_n55_), .O(new_n68_));
  ...
  nand3  g040(.a(new_n75_), .b(x20), .c(x12), .O(new_n85_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n89_), .c(x22), .O(new_n100_));
  nand3  g056(.a(new_n74_), .b(x20), .c(x19), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n100_), .c(new_n54_), .O(new_n102_));
  nand3  g058(.a(x22), .b(new_n54_), .c(new_n47_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n102_), .c(x09), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(x08), .c(new_n64_), .O(z12));
  and2   g062(.a(x20), .b(x19), .O(new_n107_));
  nor2   g063(.a(x23), .b(new_n74_), .O(new_n108_));
  nand2  g064(.a(x23), .b(x15), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n91_), .O(new_n110_));
  aoi21  g066(.a(new_n108_), .b(new_n107_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n107_), .b(new_n75_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  oai22  g069(.a(new_n113_), .b(new_n77_), .c(new_n111_), .d(new_n54_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n66_), .O(z13));
  nand4  g072(.a(x26), .b(x25), .c(x16), .d(new_n47_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x20), .c(x19), .O(new_n118_));
  nor2   g074(.a(new_n77_), .b(new_n74_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x21), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(new_n47_), .c(new_n118_), .d(x21), .O(new_n121_));
  ...
  nand3  g096(.a(new_n119_), .b(x25), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nand4  g098(.a(new_n113_), .b(new_n79_), .c(new_n45_), .d(x25), .O(new_n143_));
