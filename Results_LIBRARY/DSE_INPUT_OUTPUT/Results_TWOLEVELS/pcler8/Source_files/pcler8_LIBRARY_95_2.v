...
module FAU ( 
  ...
  oai21  g11(.a(new_n53_), .b(new_n55_), .c(new_n46_), .O(z03));
  ...
  nor2   g23(.a(new_n50_), .b(new_n55_), .O(z11));
  oai21  g24(.a(new_n53_), .b(new_n57_), .c(new_n46_), .O(z12));
  oai21  g25(.a(new_n53_), .b(new_n59_), .c(new_n46_), .O(z13));
  nor2   g26(.a(new_n50_), .b(new_n63_), .O(z15));
  nor2   g27(.a(new_n50_), .b(new_n65_), .O(z16));
  nor2   g28(.a(new_n50_), .b(new_n48_), .O(z09));
  nand2  g29(.a(new_n61_), .b(new_n46_), .O(z14));
endmodule
