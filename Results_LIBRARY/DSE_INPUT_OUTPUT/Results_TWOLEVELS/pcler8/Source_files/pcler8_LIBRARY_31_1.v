...
module FAU ( 
  ...
  nor2   g13(.a(new_n45_), .b(x10), .O(new_n58_));
  ...
  oai21  g23(.a(new_n57_), .b(new_n67_), .c(new_n62_), .O(z04));
  inv1   g24(.a(x04), .O(new_n69_));
  inv1   g25(.a(new_n59_), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n69_), .O(z05));
  inv1   g27(.a(x05), .O(new_n72_));
  nor2   g28(.a(new_n70_), .b(new_n72_), .O(z06));
  nand2  g29(.a(new_n59_), .b(x06), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n62_), .O(z07));
  nand2  g31(.a(new_n59_), .b(x07), .O(new_n76_));
  ...
  nand3  g39(.a(new_n83_), .b(x09), .c(new_n57_), .O(new_n84_));
  nand2  g40(.a(new_n84_), .b(new_n45_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n78_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n60_), .O(z09));
  nand3  g43(.a(x22), .b(x21), .c(x12), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n82_), .c(x19), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(x20), .O(new_n90_));
  inv1   g46(.a(x20), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(x19), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n90_), .c(new_n46_), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n57_), .c(x14), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(x10), .c(new_n63_), .O(z10));
  inv1   g51(.a(x19), .O(new_n96_));
  nand3  g52(.a(x23), .b(x22), .c(x13), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n53_), .c(x20), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n96_), .c(x21), .O(new_n99_));
  nand3  g55(.a(new_n79_), .b(x20), .c(x19), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n99_), .c(new_n46_), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n57_), .c(x14), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(x10), .c(new_n65_), .O(z11));
  nand2  g59(.a(new_n48_), .b(x22), .O(new_n104_));
  nand2  g60(.a(x20), .b(x19), .O(new_n105_));
  inv1   g61(.a(new_n105_), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(new_n50_), .c(x21), .O(new_n107_));
  aoi21  g63(.a(new_n107_), .b(new_n104_), .c(x14), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n109_));
  oai21  g65(.a(new_n70_), .b(new_n67_), .c(new_n109_), .O(z12));
  ...
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(x14), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n116_));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n120_), .c(x14), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n124_));
  oai21  g80(.a(new_n70_), .b(new_n72_), .c(new_n124_), .O(z14));
  ...
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(x14), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n132_));
  ...
  nor2   g93(.a(new_n121_), .b(new_n51_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n129_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n106_), .c(new_n138_), .d(new_n80_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x14), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n142_));
