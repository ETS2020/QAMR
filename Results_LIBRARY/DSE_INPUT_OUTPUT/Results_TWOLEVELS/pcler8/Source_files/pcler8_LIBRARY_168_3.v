...
module FAU ( 
  ...
  nand2  g17(.a(new_n61_), .b(new_n48_), .O(z01));
  ...
  nand2  g23(.a(new_n67_), .b(new_n48_), .O(z04));
  nor3   g24(.a(x10), .b(new_n49_), .c(new_n45_), .O(z05));
  ...
  oai21  g61(.a(x10), .b(x08), .c(x04), .O(new_n106_));
  ...
  nand2  g68(.a(new_n112_), .b(new_n106_), .O(z13));
  ...
  nand3  g96(.a(new_n140_), .b(new_n74_), .c(new_n48_), .O(z16));
endmodule
