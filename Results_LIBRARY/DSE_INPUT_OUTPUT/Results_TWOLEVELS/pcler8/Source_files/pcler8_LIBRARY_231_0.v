...
module FAU ( 
  ...
  nand2  g16(.a(new_n60_), .b(x08), .O(new_n61_));
  ...
  nor2   g21(.a(new_n61_), .b(new_n65_), .O(z03));
  inv1   g22(.a(x03), .O(new_n67_));
  nor2   g23(.a(new_n61_), .b(new_n67_), .O(z04));
  inv1   g24(.a(new_n61_), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(x04), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z05));
  inv1   g27(.a(x05), .O(new_n72_));
  inv1   g28(.a(x08), .O(new_n73_));
  oai21  g29(.a(new_n73_), .b(new_n72_), .c(new_n60_), .O(z06));
  nand2  g30(.a(new_n69_), .b(x06), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(z07));
  nand2  g32(.a(new_n69_), .b(x07), .O(new_n77_));
  ...
  nand4  g38(.a(new_n82_), .b(new_n59_), .c(x09), .d(new_n73_), .O(new_n83_));
  ...
  nand4  g44(.a(new_n88_), .b(new_n59_), .c(x09), .d(new_n73_), .O(new_n89_));
  oai21  g45(.a(new_n61_), .b(new_n63_), .c(new_n89_), .O(z10));
  ...
  nand4  g51(.a(new_n95_), .b(new_n59_), .c(x09), .d(new_n73_), .O(new_n96_));
  oai21  g52(.a(new_n61_), .b(new_n65_), .c(new_n96_), .O(z11));
  nand2  g53(.a(x20), .b(x19), .O(new_n98_));
  nand2  g54(.a(x23), .b(x14), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n53_), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n98_), .c(x22), .O(new_n101_));
  inv1   g57(.a(new_n98_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n50_), .c(x21), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n59_), .c(x09), .d(new_n73_), .O(new_n105_));
  oai21  g61(.a(new_n61_), .b(new_n67_), .c(new_n105_), .O(z12));
  aoi21  g62(.a(x21), .b(x20), .c(new_n58_), .O(new_n107_));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(x22), .c(x19), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n107_), .c(x23), .O(new_n110_));
  nand4  g66(.a(new_n102_), .b(new_n51_), .c(x22), .d(x21), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n110_), .c(x08), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n58_), .c(new_n59_), .O(new_n113_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n59_), .c(x09), .d(new_n73_), .O(new_n123_));
  oai21  g79(.a(new_n61_), .b(new_n72_), .c(new_n123_), .O(z14));
  aoi21  g80(.a(new_n51_), .b(x09), .c(new_n50_), .O(new_n125_));
  aoi21  g81(.a(x26), .b(x17), .c(new_n119_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n125_), .c(new_n120_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nand4  g85(.a(new_n120_), .b(new_n52_), .c(new_n129_), .d(x24), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(x08), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n58_), .c(new_n59_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n75_), .O(z15));
  ...
  nor2   g93(.a(new_n119_), .b(new_n51_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n129_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n102_), .c(new_n138_), .d(new_n79_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n59_), .c(x09), .d(new_n73_), .O(new_n142_));
