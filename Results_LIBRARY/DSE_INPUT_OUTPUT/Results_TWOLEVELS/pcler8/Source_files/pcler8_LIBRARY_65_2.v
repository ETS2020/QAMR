...
module FAU ( 
  ...
  nand2  g11(.a(new_n55_), .b(x10), .O(new_n56_));
  oai21  g12(.a(new_n46_), .b(new_n54_), .c(new_n56_), .O(z01));
  aoi21  g13(.a(new_n55_), .b(x10), .c(new_n46_), .O(new_n58_));
  ...
  oai21  g22(.a(new_n46_), .b(new_n66_), .c(new_n56_), .O(z05));
  ...
  nand3  g43(.a(new_n87_), .b(new_n59_), .c(new_n56_), .O(z10));
