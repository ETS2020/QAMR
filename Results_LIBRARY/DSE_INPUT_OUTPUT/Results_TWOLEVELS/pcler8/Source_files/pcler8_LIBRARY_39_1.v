...
module FAU ( 
  ...
  nor2   g10(.a(new_n45_), .b(x10), .O(new_n55_));
  ...
  nor2   g15(.a(new_n55_), .b(new_n59_), .O(new_n60_));
  ...
  nand3  g40(.a(new_n84_), .b(x09), .c(new_n59_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n45_), .O(new_n86_));
  nand2  g42(.a(new_n86_), .b(new_n75_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n57_), .O(z09));
  xor2a  g44(.a(x20), .b(x19), .O(new_n89_));
  nand3  g45(.a(new_n89_), .b(x09), .c(new_n59_), .O(new_n90_));
  aoi21  g46(.a(new_n90_), .b(new_n45_), .c(x10), .O(new_n91_));
  or2    g47(.a(new_n91_), .b(z02), .O(z10));
  ...
  nand3  g52(.a(new_n76_), .b(x20), .c(x19), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n96_), .c(x12), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n75_), .c(x09), .d(new_n59_), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n62_), .O(z11));
  ...
  nand3  g61(.a(new_n105_), .b(new_n77_), .c(x21), .O(new_n106_));
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(x12), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n75_), .c(x09), .d(new_n59_), .O(new_n108_));
  oai21  g64(.a(new_n65_), .b(new_n64_), .c(new_n108_), .O(z12));
  aoi21  g65(.a(x21), .b(x20), .c(x12), .O(new_n110_));
  nand4  g66(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n111_));
  nand3  g67(.a(new_n111_), .b(x22), .c(x19), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n110_), .c(x23), .O(new_n113_));
  nand4  g69(.a(new_n105_), .b(new_n80_), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(new_n46_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n59_), .c(x12), .O(new_n116_));
  oai22  g72(.a(new_n116_), .b(x10), .c(new_n65_), .d(new_n67_), .O(z13));
  ...
  nand4  g76(.a(new_n49_), .b(new_n81_), .c(x23), .d(x22), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n120_), .c(new_n46_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n59_), .c(x12), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(x10), .c(new_n69_), .O(z14));
  ...
  nand4  g94(.a(new_n138_), .b(new_n105_), .c(new_n82_), .d(new_n78_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n137_), .c(new_n46_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n59_), .c(x12), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(x10), .c(new_n73_), .O(z16));
endmodule
