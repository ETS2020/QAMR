...
module FAU ( 
  ...
  nand3  g06(.a(x23), .b(x22), .c(x21), .O(new_n51_));
  nand3  g07(.a(x26), .b(x25), .c(x24), .O(new_n52_));
  nor2   g08(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand4  g09(.a(new_n53_), .b(new_n50_), .c(x09), .d(new_n48_), .O(new_n54_));
  nand2  g10(.a(new_n54_), .b(new_n47_), .O(z00));
  nor2   g11(.a(new_n46_), .b(new_n48_), .O(new_n56_));
  ...
  nand2  g18(.a(new_n62_), .b(new_n47_), .O(z04));
  nand2  g19(.a(new_n56_), .b(x04), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z05));
  nand2  g21(.a(new_n56_), .b(x05), .O(new_n66_));
  inv1   g22(.a(new_n66_), .O(z06));
  and2   g23(.a(new_n56_), .b(x06), .O(z07));
  nand2  g24(.a(new_n56_), .b(x07), .O(new_n69_));
  ...
  nand4  g33(.a(new_n77_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n78_));
  nand2  g34(.a(x08), .b(x00), .O(new_n79_));
  aoi21  g35(.a(new_n79_), .b(new_n78_), .c(new_n46_), .O(z09));
  ...
  nand4  g41(.a(new_n85_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n86_));
  ...
  nand3  g46(.a(new_n72_), .b(x20), .c(x19), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n93_));
  nand3  g49(.a(new_n93_), .b(new_n60_), .c(new_n47_), .O(z11));
  nand2  g50(.a(x23), .b(x14), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n52_), .c(x21), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n49_), .c(x22), .O(new_n97_));
  inv1   g53(.a(new_n49_), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(new_n73_), .c(x21), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(new_n62_), .c(new_n47_), .O(z12));
  nand4  g58(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(x22), .c(x21), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n49_), .c(x23), .O(new_n105_));
  ...
  nand4  g64(.a(new_n108_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(new_n64_), .c(new_n47_), .O(z13));
  nand3  g66(.a(new_n71_), .b(x09), .c(new_n48_), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n52_), .c(x17), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(x16), .O(new_n113_));
  oai21  g69(.a(new_n51_), .b(new_n49_), .c(x24), .O(new_n114_));
  nand3  g70(.a(x21), .b(x20), .c(x19), .O(new_n115_));
  inv1   g71(.a(x24), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(x23), .c(x22), .O(new_n117_));
  oai21  g73(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n113_), .c(new_n66_), .O(z14));
  nand3  g76(.a(x24), .b(x23), .c(x22), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(new_n115_), .c(x25), .O(new_n122_));
  inv1   g78(.a(x25), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(x24), .c(x23), .d(x22), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n115_), .c(new_n122_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n126_));
  ...
  nand4  g86(.a(new_n130_), .b(x26), .c(x25), .d(x17), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(z15));
  ...
  nor2   g92(.a(new_n116_), .b(new_n106_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n123_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n74_), .d(new_n98_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n71_), .c(x09), .d(new_n48_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n69_), .c(new_n47_), .O(z16));
endmodule
