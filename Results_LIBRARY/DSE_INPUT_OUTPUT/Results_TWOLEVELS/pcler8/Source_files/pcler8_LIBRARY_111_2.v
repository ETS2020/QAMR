...
module FAU ( 
  ...
  nand2  g017(.a(new_n55_), .b(x10), .O(new_n62_));
  ...
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n62_), .O(z07));
  ...
  oai21  g040(.a(x20), .b(new_n55_), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g050(.a(new_n57_), .b(new_n61_), .c(new_n94_), .O(z11));
  nand2  g051(.a(x22), .b(x09), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(x08), .c(new_n47_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n55_), .O(new_n98_));
  ...
  nand3  g063(.a(new_n107_), .b(new_n98_), .c(new_n64_), .O(z12));
  ...
  oai21  g071(.a(new_n57_), .b(new_n66_), .c(new_n115_), .O(z13));
  ...
  oai21  g090(.a(new_n57_), .b(new_n70_), .c(new_n134_), .O(z15));
  ...
  nand4  g097(.a(new_n141_), .b(new_n104_), .c(new_n140_), .d(new_n76_), .O(new_n142_));
