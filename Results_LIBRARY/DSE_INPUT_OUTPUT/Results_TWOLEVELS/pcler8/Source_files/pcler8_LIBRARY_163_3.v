...
module FAU ( 
  ...
  nand3  g05(.a(new_n49_), .b(x09), .c(new_n47_), .O(new_n50_));
  ...
  nand3  g12(.a(new_n56_), .b(new_n54_), .c(new_n51_), .O(new_n57_));
  ...
  nand3  g33(.a(new_n54_), .b(x20), .c(x11), .O(new_n78_));
  nand4  g34(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n79_));
  oai22  g35(.a(new_n79_), .b(new_n78_), .c(x19), .d(x10), .O(new_n80_));
  nand3  g36(.a(new_n80_), .b(x09), .c(new_n47_), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n61_), .c(new_n63_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n64_), .O(z10));
  nand4  g46(.a(x21), .b(x13), .c(x09), .d(new_n47_), .O(new_n91_));
  nand4  g47(.a(x26), .b(x25), .c(x24), .d(x22), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(new_n45_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(x23), .O(new_n94_));
  nand3  g50(.a(new_n52_), .b(x20), .c(x19), .O(new_n95_));
  oai21  g51(.a(new_n49_), .b(new_n52_), .c(new_n95_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n94_), .c(new_n66_), .O(z11));
  nand2  g54(.a(x23), .b(x14), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n55_), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n48_), .c(x22), .O(new_n101_));
  nand3  g57(.a(new_n49_), .b(new_n53_), .c(x21), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n68_), .O(z12));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(x22), .c(x21), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n48_), .c(x23), .O(new_n108_));
  nand4  g64(.a(new_n49_), .b(new_n46_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n70_), .O(z13));
  ...
  nor2   g73(.a(x24), .b(new_n46_), .O(new_n118_));
  nand3  g74(.a(new_n118_), .b(new_n117_), .c(x22), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n72_), .O(z14));
  ...
  nor2   g82(.a(new_n46_), .b(new_n53_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n117_), .c(new_n126_), .d(x24), .O(new_n128_));
  ...
  nand4  g88(.a(new_n54_), .b(new_n132_), .c(x25), .d(x24), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n50_), .c(new_n45_), .O(new_n134_));
  ...
  nor2   g95(.a(new_n139_), .b(new_n132_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n45_), .c(x09), .d(new_n47_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n135_), .c(new_n76_), .O(z16));
endmodule
