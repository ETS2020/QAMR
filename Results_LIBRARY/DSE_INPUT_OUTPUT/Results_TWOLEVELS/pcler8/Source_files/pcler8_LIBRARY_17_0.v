...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n63_, new_n64_, new_n66_, new_n68_, new_n69_, new_n71_, new_n73_,
  ...
  nor2   g018(.a(new_n55_), .b(new_n47_), .O(new_n63_));
  ...
  inv1   g024(.a(new_n63_), .O(new_n69_));
  ...
  nand4  g041(.a(new_n85_), .b(new_n83_), .c(new_n81_), .d(new_n78_), .O(new_n86_));
  aoi21  g042(.a(new_n86_), .b(x19), .c(new_n76_), .O(new_n87_));
  aoi21  g043(.a(new_n87_), .b(new_n47_), .c(new_n75_), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(x10), .c(new_n57_), .O(z09));
  ...
  aoi21  g050(.a(new_n94_), .b(new_n93_), .c(new_n76_), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n47_), .c(new_n75_), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(x10), .c(new_n59_), .O(z10));
  nand3  g053(.a(x23), .b(x22), .c(x13), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n84_), .c(x20), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n77_), .c(x21), .O(new_n100_));
  nand3  g056(.a(new_n80_), .b(x20), .c(x19), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n100_), .c(new_n76_), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(new_n47_), .c(new_n75_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(x10), .c(new_n61_), .O(z11));
  nand2  g060(.a(x20), .b(x19), .O(new_n105_));
  nand2  g061(.a(x23), .b(x14), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n84_), .c(x21), .O(new_n107_));
  ...
  oai21  g068(.a(new_n112_), .b(x10), .c(new_n64_), .O(z12));
  ...
  oai21  g085(.a(new_n69_), .b(new_n68_), .c(new_n129_), .O(z14));
  nand2  g086(.a(x26), .b(x17), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n83_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n121_), .c(x25), .O(new_n133_));
  inv1   g089(.a(x25), .O(new_n134_));
  nand4  g090(.a(new_n126_), .b(new_n83_), .c(new_n134_), .d(x24), .O(new_n135_));
  ...
  nor2   g094(.a(new_n77_), .b(x18), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n81_), .O(new_n140_));
  nand3  g096(.a(new_n83_), .b(x25), .c(x24), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(x26), .O(new_n142_));
  nor2   g098(.a(new_n46_), .b(new_n80_), .O(new_n143_));
  nor2   g099(.a(new_n125_), .b(new_n82_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n134_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n109_), .c(new_n144_), .d(new_n143_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n142_), .c(new_n75_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n73_), .O(z16));
endmodule
