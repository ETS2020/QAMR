...
module FAU ( 
  ...
  oai21  g87(.a(new_n131_), .b(x08), .c(new_n45_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n53_), .O(new_n133_));
  ...
  nor2   g93(.a(new_n117_), .b(new_n53_), .O(new_n138_));
  ...
  nand3  g98(.a(new_n142_), .b(new_n133_), .c(new_n74_), .O(z16));
endmodule
