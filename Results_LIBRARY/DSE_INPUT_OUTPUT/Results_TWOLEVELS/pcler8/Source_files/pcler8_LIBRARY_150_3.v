...
module FAU ( 
  ...
  nand3  g056(.a(x23), .b(x14), .c(new_n47_), .O(new_n101_));
  ...
  nand3  g073(.a(new_n99_), .b(x23), .c(x21), .O(new_n118_));
  ...
  nor2   g084(.a(new_n120_), .b(new_n111_), .O(new_n129_));
  nand3  g085(.a(new_n99_), .b(new_n129_), .c(x21), .O(new_n130_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n99_), .c(new_n129_), .d(new_n76_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n141_), .c(x08), .O(new_n144_));
