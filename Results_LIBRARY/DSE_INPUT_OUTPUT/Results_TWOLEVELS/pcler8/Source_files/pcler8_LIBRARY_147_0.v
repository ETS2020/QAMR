...
module FAU ( 
  ...
  nor2   g016(.a(new_n47_), .b(new_n60_), .O(z02));
  ...
  nand3  g040(.a(new_n84_), .b(x20), .c(x01), .O(new_n85_));
  inv1   g041(.a(x20), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(x19), .O(new_n87_));
  aoi21  g043(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n60_), .c(new_n48_), .O(new_n89_));
  oai21  g045(.a(new_n47_), .b(new_n60_), .c(new_n89_), .O(z10));
  inv1   g046(.a(x19), .O(new_n91_));
  nand3  g047(.a(x22), .b(x13), .c(x01), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n78_), .c(x20), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n91_), .c(x21), .O(new_n94_));
  nand3  g050(.a(new_n75_), .b(x20), .c(x19), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n94_), .c(new_n82_), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n47_), .c(new_n60_), .O(new_n97_));
  ...
  nand4  g062(.a(new_n106_), .b(x09), .c(new_n47_), .d(x01), .O(new_n107_));
  oai21  g063(.a(new_n65_), .b(new_n64_), .c(new_n107_), .O(z12));
  nand4  g064(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x21), .c(new_n60_), .O(new_n110_));
  nand3  g066(.a(x22), .b(x20), .c(x19), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(x23), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n47_), .c(new_n60_), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(x10), .c(new_n67_), .O(z13));
  nand3  g073(.a(x26), .b(x25), .c(x16), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(x21), .c(new_n60_), .O(new_n119_));
  nand3  g075(.a(new_n104_), .b(x23), .c(x22), .O(new_n120_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n121_), .c(new_n82_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n47_), .c(new_n60_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(x10), .c(new_n69_), .O(z14));
  nand3  g084(.a(x26), .b(x17), .c(x01), .O(new_n129_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n47_), .c(new_n60_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(x10), .c(new_n71_), .O(z15));
  nand2  g093(.a(x09), .b(new_n47_), .O(new_n138_));
  nand3  g094(.a(x26), .b(x18), .c(new_n48_), .O(new_n139_));
  oai22  g095(.a(new_n139_), .b(new_n138_), .c(new_n47_), .d(new_n73_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x01), .O(new_n141_));
  nand4  g097(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n123_), .c(x26), .O(new_n143_));
  nor2   g099(.a(new_n122_), .b(new_n113_), .O(new_n144_));
  ...
  nand3  g103(.a(new_n147_), .b(x09), .c(new_n47_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x01), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n48_), .O(new_n150_));
  nand3  g106(.a(x10), .b(x08), .c(x07), .O(new_n151_));
