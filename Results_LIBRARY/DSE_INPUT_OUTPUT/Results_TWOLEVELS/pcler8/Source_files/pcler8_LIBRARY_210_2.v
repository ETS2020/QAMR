...
module FAU ( 
  ...
  nand3  g44(.a(new_n88_), .b(new_n61_), .c(new_n46_), .O(z10));
  ...
  nand2  g77(.a(x25), .b(x09), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(x08), .c(new_n48_), .O(new_n123_));
  ...
  oai21  g82(.a(new_n126_), .b(new_n112_), .c(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n117_), .b(new_n53_), .c(new_n128_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n124_), .c(new_n71_), .O(z15));
  ...
  nor2   g92(.a(new_n116_), .b(new_n45_), .O(new_n137_));
