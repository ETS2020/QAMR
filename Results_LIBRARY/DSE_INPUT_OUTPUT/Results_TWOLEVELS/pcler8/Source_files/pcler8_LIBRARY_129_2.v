...
module FAU ( 
  ...
  nor2   g08(.a(new_n45_), .b(new_n52_), .O(new_n53_));
  nand3  g09(.a(x26), .b(x25), .c(x24), .O(new_n54_));
  inv1   g10(.a(new_n54_), .O(new_n55_));
  nand3  g11(.a(new_n55_), .b(new_n53_), .c(x21), .O(new_n56_));
  oai21  g12(.a(new_n56_), .b(new_n51_), .c(new_n46_), .O(z00));
  aoi21  g13(.a(new_n45_), .b(x10), .c(new_n47_), .O(new_n58_));
  ...
  nand3  g36(.a(new_n80_), .b(new_n59_), .c(new_n46_), .O(z09));
  ...
  oai21  g47(.a(new_n91_), .b(new_n54_), .c(x20), .O(new_n92_));
  ...
  nand2  g52(.a(new_n96_), .b(new_n63_), .O(z11));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n54_), .c(x21), .O(new_n99_));
  ...
  nand4  g63(.a(new_n50_), .b(new_n45_), .c(x22), .d(x21), .O(new_n108_));
  ...
  nand2  g67(.a(x24), .b(x09), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(x08), .c(new_n48_), .O(new_n113_));
  ...
  nor2   g92(.a(new_n118_), .b(new_n45_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n128_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n76_), .d(new_n50_), .O(new_n139_));
