...
module FAU ( 
  ...
  aoi21  g16(.a(x10), .b(new_n45_), .c(new_n47_), .O(new_n61_));
  ...
  nand2  g23(.a(new_n61_), .b(x04), .O(new_n68_));
  ...
  nand3  g37(.a(new_n81_), .b(new_n59_), .c(new_n46_), .O(z09));
  ...
  nand3  g53(.a(new_n97_), .b(new_n64_), .c(new_n46_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n66_), .c(new_n46_), .O(z12));
  ...
  nand3  g77(.a(new_n121_), .b(new_n70_), .c(new_n46_), .O(z14));
  ...
  nand3  g85(.a(new_n129_), .b(new_n72_), .c(new_n46_), .O(z15));
  ...
  nand3  g95(.a(new_n139_), .b(new_n74_), .c(new_n46_), .O(z16));
endmodule
