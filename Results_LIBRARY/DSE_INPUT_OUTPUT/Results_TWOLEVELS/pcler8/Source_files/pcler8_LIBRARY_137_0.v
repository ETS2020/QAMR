...
module FAU ( 
  ...
  aoi21  g044(.a(new_n88_), .b(new_n47_), .c(new_n81_), .O(new_n89_));
  ...
  aoi21  g053(.a(new_n97_), .b(new_n95_), .c(new_n82_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n47_), .c(new_n81_), .O(new_n99_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n47_), .c(new_n81_), .O(new_n108_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n47_), .c(new_n81_), .O(new_n116_));
  ...
  inv1   g077(.a(new_n118_), .O(new_n122_));
  nor2   g078(.a(x24), .b(new_n113_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(x22), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n121_), .c(x10), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x09), .c(new_n47_), .d(x07), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n68_), .O(z14));
  nor2   g083(.a(new_n113_), .b(new_n46_), .O(new_n128_));
  ...
  nand4  g090(.a(new_n134_), .b(x09), .c(new_n47_), .d(x07), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n70_), .O(z15));
  nand2  g092(.a(x21), .b(x20), .O(new_n137_));
  nand3  g093(.a(x24), .b(x23), .c(x22), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(x07), .O(new_n139_));
  nand2  g095(.a(x25), .b(x19), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(x18), .O(new_n141_));
  aoi21  g097(.a(new_n141_), .b(new_n139_), .c(new_n45_), .O(new_n142_));
  nand3  g098(.a(new_n105_), .b(x22), .c(x21), .O(new_n143_));
  nand4  g099(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n142_), .c(x09), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x07), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n48_), .O(new_n148_));
