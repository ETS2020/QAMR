...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n54_, new_n56_,
    new_n57_, new_n58_, new_n60_, new_n62_, new_n64_, new_n65_;
  ...
  nand2  g15(.a(new_n60_), .b(new_n57_), .O(z06));
  inv1   g16(.a(x06), .O(new_n62_));
  nor2   g17(.a(new_n48_), .b(new_n62_), .O(z07));
  inv1   g18(.a(x07), .O(new_n64_));
  inv1   g19(.a(x08), .O(new_n65_));
  oai21  g20(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(z08));
  oai21  g21(.a(new_n65_), .b(new_n46_), .c(new_n57_), .O(z09));
  oai21  g22(.a(new_n65_), .b(new_n50_), .c(new_n57_), .O(z10));
  oai21  g23(.a(new_n65_), .b(new_n62_), .c(new_n57_), .O(z15));
  nor2   g24(.a(new_n48_), .b(new_n64_), .O(z16));
  zero   g25(.O(z00));
  nor2   g26(.a(new_n48_), .b(new_n52_), .O(z11));
  nor2   g27(.a(new_n48_), .b(new_n54_), .O(z12));
  nand2  g28(.a(new_n58_), .b(new_n57_), .O(z13));
  nand2  g29(.a(new_n60_), .b(new_n57_), .O(z14));
endmodule
