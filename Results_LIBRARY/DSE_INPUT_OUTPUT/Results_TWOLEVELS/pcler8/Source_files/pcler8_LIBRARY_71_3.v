...
module FAU ( 
  ...
  nand4  g082(.a(new_n126_), .b(x23), .c(x22), .d(x21), .O(new_n127_));
  nand3  g083(.a(x24), .b(x20), .c(x19), .O(new_n128_));
  aoi21  g084(.a(new_n127_), .b(new_n47_), .c(new_n128_), .O(new_n129_));
  nor2   g085(.a(new_n110_), .b(new_n75_), .O(new_n130_));
  nand4  g086(.a(new_n120_), .b(new_n130_), .c(new_n125_), .d(x24), .O(new_n131_));
  oai21  g087(.a(new_n129_), .b(new_n125_), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n46_), .c(x10), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n73_), .c(new_n69_), .O(z15));
  nand3  g090(.a(x23), .b(x22), .c(x21), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n47_), .O(new_n136_));
  nor2   g092(.a(new_n84_), .b(x18), .O(new_n137_));
  nand3  g093(.a(x25), .b(x24), .c(x20), .O(new_n138_));
  ...
  nor2   g098(.a(x26), .b(new_n125_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n102_), .c(new_n142_), .d(new_n76_), .O(new_n144_));
