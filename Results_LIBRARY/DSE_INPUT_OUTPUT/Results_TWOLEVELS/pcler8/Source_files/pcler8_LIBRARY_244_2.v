...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n62_, new_n64_, new_n67_, new_n69_, new_n71_, new_n73_, new_n74_,
  ...
  oai21  g016(.a(new_n48_), .b(new_n59_), .c(new_n60_), .O(z02));
  nand2  g017(.a(new_n57_), .b(x02), .O(new_n62_));
  inv1   g018(.a(new_n62_), .O(z03));
  nand2  g019(.a(new_n57_), .b(x03), .O(new_n64_));
  nand2  g020(.a(new_n64_), .b(new_n60_), .O(z04));
  aoi21  g021(.a(x10), .b(new_n48_), .c(new_n47_), .O(z05));
  inv1   g022(.a(x05), .O(new_n67_));
  oai21  g023(.a(new_n48_), .b(new_n67_), .c(new_n60_), .O(z06));
  inv1   g024(.a(x06), .O(new_n69_));
  oai21  g025(.a(new_n48_), .b(new_n69_), .c(new_n60_), .O(z07));
  inv1   g026(.a(x07), .O(new_n71_));
  oai21  g027(.a(new_n48_), .b(new_n71_), .c(new_n60_), .O(z08));
  ...
  aoi21  g032(.a(new_n76_), .b(new_n47_), .c(x10), .O(new_n77_));
  or2    g033(.a(new_n77_), .b(z01), .O(z09));
  inv1   g034(.a(new_n57_), .O(new_n79_));
  ...
  nand4  g041(.a(new_n85_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n86_));
  oai21  g042(.a(new_n79_), .b(new_n59_), .c(new_n86_), .O(z10));
  ...
  nand4  g051(.a(new_n95_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n96_));
  ...
  nand4  g060(.a(new_n104_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n64_), .O(z12));
  inv1   g062(.a(z05), .O(new_n107_));
  inv1   g063(.a(x23), .O(new_n108_));
  nand4  g064(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x21), .c(x20), .O(new_n110_));
  nand2  g066(.a(x22), .b(x19), .O(new_n111_));
  aoi21  g067(.a(new_n110_), .b(new_n47_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n102_), .b(new_n108_), .c(x22), .d(x21), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n108_), .c(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n107_), .O(z13));
  ...
  nand4  g080(.a(new_n124_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n125_));
  oai21  g081(.a(new_n79_), .b(new_n67_), .c(new_n125_), .O(z14));
  nand2  g082(.a(x26), .b(x17), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(x24), .c(x23), .d(x22), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n117_), .c(x25), .O(new_n129_));
  inv1   g085(.a(x25), .O(new_n130_));
  nor2   g086(.a(new_n108_), .b(new_n46_), .O(new_n131_));
  nand4  g087(.a(new_n122_), .b(new_n131_), .c(new_n130_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n129_), .c(x10), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n134_));
  oai21  g090(.a(new_n79_), .b(new_n69_), .c(new_n134_), .O(z15));
  ...
  nor2   g095(.a(new_n46_), .b(new_n93_), .O(new_n140_));
  nor2   g096(.a(new_n121_), .b(new_n108_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n130_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n102_), .c(new_n141_), .d(new_n140_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n139_), .c(x10), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n145_));
  oai21  g101(.a(new_n79_), .b(new_n71_), .c(new_n145_), .O(z16));
endmodule
