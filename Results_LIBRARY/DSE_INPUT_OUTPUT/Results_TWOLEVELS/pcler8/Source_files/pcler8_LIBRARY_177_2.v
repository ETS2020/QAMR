...
module FAU ( 
  ...
  oai21  g22(.a(new_n61_), .b(new_n54_), .c(new_n46_), .O(z11));
  oai21  g23(.a(new_n61_), .b(new_n56_), .c(new_n46_), .O(z12));
  oai21  g24(.a(new_n61_), .b(new_n58_), .c(new_n46_), .O(z13));
  nor2   g25(.a(new_n50_), .b(new_n60_), .O(z14));
