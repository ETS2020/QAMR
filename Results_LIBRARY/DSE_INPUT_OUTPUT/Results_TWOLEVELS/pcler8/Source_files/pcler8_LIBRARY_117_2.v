...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n47_), .c(new_n73_), .O(new_n97_));
  nand2  g053(.a(x23), .b(x14), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n89_), .c(x20), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n81_), .c(new_n47_), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(new_n97_), .c(new_n74_), .O(new_n101_));
  nand3  g057(.a(new_n74_), .b(x21), .c(x20), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n81_), .c(x10), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(x09), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(x08), .c(new_n63_), .O(z12));
  nand2  g061(.a(x20), .b(x19), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n96_), .c(x21), .O(new_n108_));
  oai21  g064(.a(new_n96_), .b(x21), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x22), .O(new_n110_));
  nand4  g066(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n107_), .c(x22), .O(new_n112_));
  ...
  nand2  g072(.a(x24), .b(x09), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(x08), .c(new_n47_), .O(new_n118_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n106_), .c(x24), .O(new_n122_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n119_), .c(new_n67_), .O(z14));
  nand2  g085(.a(x25), .b(x09), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(x08), .c(new_n47_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n96_), .O(new_n132_));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x24), .c(x22), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n124_), .c(x25), .O(new_n135_));
  inv1   g091(.a(x25), .O(new_n136_));
  nor2   g092(.a(new_n96_), .b(new_n74_), .O(new_n137_));
  nand4  g093(.a(new_n125_), .b(new_n137_), .c(new_n136_), .d(x24), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n132_), .c(new_n69_), .O(z15));
  nand2  g097(.a(x26), .b(x09), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(x08), .c(new_n47_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n96_), .O(new_n144_));
  inv1   g100(.a(x18), .O(new_n145_));
  nand2  g101(.a(new_n107_), .b(new_n145_), .O(new_n146_));
  nand3  g102(.a(new_n75_), .b(x25), .c(x24), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(x26), .O(new_n148_));
  nor2   g104(.a(new_n123_), .b(new_n96_), .O(new_n149_));
  nor2   g105(.a(x26), .b(new_n136_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n107_), .c(new_n149_), .d(new_n75_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n144_), .c(new_n71_), .O(z16));
endmodule
