...
module FAU ( 
  ...
  nor2   g15(.a(new_n52_), .b(new_n59_), .O(z05));
  ...
  nor2   g23(.a(new_n52_), .b(new_n57_), .O(z12));
  oai21  g24(.a(new_n55_), .b(new_n61_), .c(new_n46_), .O(z14));
  nor2   g25(.a(new_n52_), .b(new_n63_), .O(z15));
  nor2   g26(.a(new_n52_), .b(new_n65_), .O(z16));
  nand2  g27(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g28(.a(new_n52_), .b(new_n50_), .O(z10));
  nor2   g29(.a(new_n52_), .b(new_n59_), .O(z13));
endmodule
