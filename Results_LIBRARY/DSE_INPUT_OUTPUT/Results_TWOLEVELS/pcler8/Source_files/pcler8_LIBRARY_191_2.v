...
module FAU ( 
  ...
  aoi21  g012(.a(new_n49_), .b(x06), .c(new_n48_), .O(new_n57_));
  ...
  nand4  g034(.a(new_n78_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n79_));
  oai22  g035(.a(new_n79_), .b(x06), .c(new_n58_), .d(new_n56_), .O(z09));
  ...
  aoi21  g041(.a(new_n85_), .b(new_n83_), .c(x10), .O(new_n86_));
  nand4  g042(.a(new_n86_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n87_));
  ...
  aoi21  g050(.a(new_n94_), .b(new_n93_), .c(x10), .O(new_n95_));
  ...
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n107_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n48_), .c(x06), .O(new_n114_));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n119_), .c(x10), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n124_));
  oai21  g080(.a(new_n58_), .b(new_n68_), .c(new_n124_), .O(z14));
  oai21  g081(.a(new_n49_), .b(x08), .c(x06), .O(new_n126_));
  nor2   g082(.a(new_n111_), .b(new_n46_), .O(new_n127_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n134_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n107_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n48_), .c(x06), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(x10), .c(new_n72_), .O(z16));
endmodule
