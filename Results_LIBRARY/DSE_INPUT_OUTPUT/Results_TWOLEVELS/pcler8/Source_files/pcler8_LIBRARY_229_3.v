...
module FAU ( 
  ...
  nor2   g10(.a(new_n47_), .b(new_n54_), .O(new_n55_));
  ...
  nand2  g15(.a(new_n56_), .b(x01), .O(new_n60_));
  ...
  nand2  g36(.a(new_n80_), .b(new_n57_), .O(z09));
  ...
  nand2  g51(.a(new_n95_), .b(new_n62_), .O(z11));
  ...
  nand2  g78(.a(new_n122_), .b(new_n68_), .O(z14));
  inv1   g79(.a(x25), .O(new_n124_));
  nand2  g80(.a(x26), .b(x17), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(x22), .c(x21), .d(x20), .O(new_n126_));
  nand3  g82(.a(x24), .b(x23), .c(x19), .O(new_n127_));
  aoi21  g83(.a(new_n126_), .b(new_n47_), .c(new_n127_), .O(new_n128_));
  nor2   g84(.a(new_n109_), .b(new_n75_), .O(new_n129_));
  nand4  g85(.a(new_n119_), .b(new_n129_), .c(new_n124_), .d(x24), .O(new_n130_));
  oai21  g86(.a(new_n128_), .b(new_n124_), .c(new_n130_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n46_), .c(x10), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n54_), .c(new_n70_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand4  g90(.a(x22), .b(x21), .c(x20), .d(new_n134_), .O(new_n135_));
  nand4  g91(.a(x25), .b(x24), .c(x23), .d(x19), .O(new_n136_));
  aoi21  g92(.a(new_n135_), .b(new_n47_), .c(new_n136_), .O(new_n137_));
  nor2   g93(.a(new_n118_), .b(new_n109_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n124_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n101_), .c(new_n138_), .d(new_n76_), .O(new_n140_));
  oai21  g96(.a(new_n137_), .b(new_n45_), .c(new_n140_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n46_), .c(x10), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n54_), .c(new_n72_), .O(z16));
endmodule
