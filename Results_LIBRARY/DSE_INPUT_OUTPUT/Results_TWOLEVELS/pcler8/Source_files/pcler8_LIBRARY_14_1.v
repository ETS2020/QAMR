...
module FAU ( 
  ...
  nand3  g15(.a(new_n48_), .b(x08), .c(x05), .O(new_n60_));
  ...
  oai21  g25(.a(new_n49_), .b(new_n47_), .c(new_n69_), .O(z09));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n58_), .c(x25), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(x10), .c(new_n53_), .O(z11));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n85_), .c(x25), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n71_), .c(x09), .d(new_n58_), .O(new_n90_));
  oai21  g46(.a(new_n49_), .b(new_n55_), .c(new_n90_), .O(z12));
  nand2  g47(.a(x22), .b(x21), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n77_), .c(x23), .O(new_n93_));
  inv1   g49(.a(x23), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(x22), .c(x21), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n77_), .c(new_n93_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n45_), .c(new_n71_), .d(x09), .O(new_n97_));
  oai22  g53(.a(new_n97_), .b(x08), .c(new_n49_), .d(new_n57_), .O(z13));
  aoi21  g54(.a(x22), .b(x21), .c(x25), .O(new_n99_));
  nand3  g55(.a(x23), .b(x20), .c(x19), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n99_), .c(x24), .O(new_n101_));
  inv1   g57(.a(new_n84_), .O(new_n102_));
  nor2   g58(.a(x24), .b(new_n94_), .O(new_n103_));
  nand3  g59(.a(new_n103_), .b(new_n102_), .c(x22), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n101_), .c(new_n66_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n58_), .c(x25), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(x10), .c(new_n60_), .O(z14));
  nand3  g63(.a(new_n87_), .b(new_n67_), .c(new_n71_), .O(new_n108_));
  inv1   g64(.a(new_n92_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n45_), .c(x24), .d(x23), .O(new_n110_));
  oai22  g66(.a(new_n110_), .b(new_n108_), .c(new_n49_), .d(new_n62_), .O(z15));
  nand4  g67(.a(new_n67_), .b(x26), .c(new_n45_), .d(new_n71_), .O(new_n112_));
  oai21  g68(.a(new_n49_), .b(new_n64_), .c(new_n112_), .O(z16));
endmodule
