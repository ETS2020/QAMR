...
module FAU ( 
  ...
  oai21  g028(.a(new_n47_), .b(new_n72_), .c(new_n58_), .O(z07));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n47_), .c(x14), .O(new_n99_));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n102_), .c(new_n91_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n47_), .c(x14), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(x10), .c(new_n62_), .d(new_n66_), .O(z12));
  ...
  oai21  g071(.a(new_n62_), .b(new_n68_), .c(new_n115_), .O(z13));
  inv1   g072(.a(new_n101_), .O(new_n117_));
  nand2  g073(.a(new_n46_), .b(new_n49_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n47_), .c(x14), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(x10), .c(new_n70_), .O(z14));
  and2   g082(.a(x23), .b(x22), .O(new_n127_));
  nand2  g083(.a(x26), .b(x17), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(x24), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n101_), .c(x25), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand4  g087(.a(new_n117_), .b(new_n127_), .c(new_n131_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(x14), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n134_));
  oai21  g090(.a(new_n62_), .b(new_n72_), .c(new_n134_), .O(z15));
  inv1   g091(.a(x18), .O(new_n136_));
  nand4  g092(.a(x21), .b(x20), .c(x19), .d(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n122_), .b(new_n49_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n127_), .c(x25), .O(new_n139_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n104_), .c(new_n141_), .d(new_n77_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(new_n91_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n47_), .c(x14), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(x10), .c(new_n74_), .O(z16));
endmodule
