...
module FAU ( 
  ...
  nor2   g20(.a(new_n50_), .b(new_n64_), .O(z08));
  inv1   g21(.a(x08), .O(new_n66_));
  oai21  g22(.a(new_n66_), .b(new_n54_), .c(new_n46_), .O(z11));
  nor2   g23(.a(new_n50_), .b(new_n48_), .O(z09));
  nand2  g24(.a(new_n52_), .b(new_n46_), .O(z10));
  nand2  g25(.a(new_n56_), .b(new_n46_), .O(z12));
  nor2   g26(.a(new_n50_), .b(new_n58_), .O(z13));
  nor2   g27(.a(new_n50_), .b(new_n60_), .O(z14));
  nand2  g28(.a(new_n62_), .b(new_n46_), .O(z15));
  nor2   g29(.a(new_n50_), .b(new_n64_), .O(z16));
endmodule
