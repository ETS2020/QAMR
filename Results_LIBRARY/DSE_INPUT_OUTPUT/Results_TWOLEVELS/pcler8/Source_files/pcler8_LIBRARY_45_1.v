...
module FAU ( 
  ...
  aoi21  g21(.a(x10), .b(new_n45_), .c(new_n47_), .O(new_n66_));
  ...
  nand2  g28(.a(new_n66_), .b(x06), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n46_), .O(z07));
  nand2  g30(.a(new_n66_), .b(x07), .O(new_n75_));
  ...
  nand3  g68(.a(new_n112_), .b(new_n69_), .c(new_n46_), .O(z13));
