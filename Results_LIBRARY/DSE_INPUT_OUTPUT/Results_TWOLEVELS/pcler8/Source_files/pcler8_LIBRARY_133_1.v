...
module FAU ( 
  ...
  aoi21  g11(.a(x10), .b(new_n54_), .c(new_n46_), .O(new_n56_));
  ...
  nor2   g19(.a(new_n46_), .b(new_n54_), .O(z04));
  inv1   g20(.a(x04), .O(new_n65_));
  nor2   g21(.a(new_n62_), .b(new_n65_), .O(z05));
  ...
  oai21  g50(.a(new_n62_), .b(new_n61_), .c(new_n94_), .O(z11));
  ...
  oai21  g59(.a(new_n46_), .b(new_n54_), .c(new_n103_), .O(z12));
  ...
  oai21  g67(.a(new_n62_), .b(new_n65_), .c(new_n111_), .O(z13));
