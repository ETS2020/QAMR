...
module FAU ( 
  ...
  nand2  g19(.a(new_n55_), .b(x03), .O(new_n64_));
  nand2  g20(.a(new_n64_), .b(new_n58_), .O(z04));
  nand2  g21(.a(new_n55_), .b(x04), .O(new_n66_));
  ...
  nand2  g28(.a(new_n72_), .b(new_n58_), .O(z08));
  ...
  nand3  g43(.a(new_n87_), .b(new_n59_), .c(new_n58_), .O(z10));
  ...
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n58_), .O(z14));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n58_), .O(z16));
endmodule
