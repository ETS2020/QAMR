...
module FAU ( 
  ...
  nand2  g12(.a(new_n57_), .b(new_n51_), .O(z04));
  nand2  g13(.a(x08), .b(x04), .O(new_n59_));
  nand2  g14(.a(new_n59_), .b(new_n51_), .O(z05));
  ...
  oai21  g21(.a(new_n55_), .b(new_n46_), .c(new_n51_), .O(z09));
  nor2   g22(.a(new_n48_), .b(new_n54_), .O(z11));
  oai21  g23(.a(new_n55_), .b(new_n61_), .c(new_n51_), .O(z14));
  oai21  g24(.a(new_n55_), .b(new_n63_), .c(new_n51_), .O(z15));
  oai21  g25(.a(new_n55_), .b(new_n65_), .c(new_n51_), .O(z16));
  zero   g26(.O(z00));
  nand2  g27(.a(new_n52_), .b(new_n51_), .O(z10));
  nand2  g28(.a(new_n57_), .b(new_n51_), .O(z12));
  nand2  g29(.a(new_n59_), .b(new_n51_), .O(z13));
endmodule
