...
module FAU ( 
  ...
  aoi21  g011(.a(new_n54_), .b(x10), .c(new_n46_), .O(new_n56_));
  ...
  oai21  g051(.a(new_n62_), .b(new_n61_), .c(new_n95_), .O(z11));
  ...
  nand3  g068(.a(new_n112_), .b(new_n66_), .c(new_n55_), .O(z13));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(new_n54_), .O(new_n124_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n119_), .c(x25), .O(new_n129_));
  inv1   g085(.a(x25), .O(new_n130_));
  nand4  g086(.a(new_n120_), .b(new_n115_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  oai21  g089(.a(new_n62_), .b(new_n70_), .c(new_n133_), .O(z15));
  nand2  g090(.a(x09), .b(new_n46_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n45_), .c(new_n47_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  inv1   g093(.a(x18), .O(new_n138_));
  nand2  g094(.a(new_n101_), .b(new_n138_), .O(new_n139_));
  nand4  g095(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x26), .O(new_n141_));
  nor2   g097(.a(new_n54_), .b(new_n109_), .O(new_n142_));
  ...
  nand3  g102(.a(new_n146_), .b(new_n137_), .c(new_n72_), .O(z16));
endmodule
