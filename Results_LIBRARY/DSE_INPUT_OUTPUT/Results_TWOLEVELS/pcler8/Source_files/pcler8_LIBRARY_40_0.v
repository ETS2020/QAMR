...
module FAU ( 
  ...
  oai21  g17(.a(new_n46_), .b(new_n61_), .c(new_n55_), .O(z03));
  ...
  oai21  g52(.a(new_n68_), .b(new_n61_), .c(new_n96_), .O(z11));
  ...
  nand3  g59(.a(new_n103_), .b(new_n76_), .c(x21), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n101_), .c(x08), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n74_), .c(new_n47_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n63_), .O(z12));
  ...
  oai21  g70(.a(new_n68_), .b(new_n65_), .c(new_n114_), .O(z13));
  ...
  oai21  g80(.a(new_n68_), .b(new_n67_), .c(new_n124_), .O(z14));
  nor2   g81(.a(new_n111_), .b(new_n76_), .O(new_n126_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n103_), .c(new_n139_), .d(new_n77_), .O(new_n141_));
