...
module FAU ( 
  ...
  nand4  g08(.a(new_n52_), .b(new_n50_), .c(new_n47_), .d(new_n46_), .O(new_n53_));
  aoi21  g09(.a(new_n53_), .b(x09), .c(x10), .O(z00));
  inv1   g10(.a(x08), .O(new_n55_));
  nor2   g11(.a(x10), .b(x09), .O(new_n56_));
  ...
  inv1   g20(.a(new_n56_), .O(new_n65_));
  oai21  g21(.a(new_n55_), .b(new_n64_), .c(new_n65_), .O(z04));
  nand2  g22(.a(x08), .b(x04), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n65_), .O(z05));
  inv1   g24(.a(x05), .O(new_n69_));
  oai21  g25(.a(new_n55_), .b(new_n69_), .c(new_n65_), .O(z06));
  nand2  g26(.a(new_n57_), .b(x06), .O(new_n71_));
  inv1   g27(.a(new_n71_), .O(z07));
  nand2  g28(.a(new_n57_), .b(x07), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n65_), .O(z08));
  inv1   g30(.a(x09), .O(new_n75_));
  inv1   g31(.a(x21), .O(new_n76_));
  nor2   g32(.a(new_n48_), .b(new_n76_), .O(new_n77_));
  ...
  aoi21  g36(.a(new_n80_), .b(new_n55_), .c(new_n75_), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(x10), .c(new_n58_), .O(z09));
  inv1   g38(.a(x10), .O(new_n83_));
  nand3  g39(.a(x22), .b(x21), .c(x12), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n79_), .c(x19), .O(new_n85_));
  nor2   g41(.a(x20), .b(new_n45_), .O(new_n86_));
  ...
  oai21  g47(.a(new_n91_), .b(new_n51_), .c(x20), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n45_), .c(x21), .O(new_n93_));
  nand3  g49(.a(new_n76_), .b(x20), .c(x19), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n93_), .c(x08), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n75_), .c(new_n83_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n62_), .O(z11));
  inv1   g53(.a(new_n57_), .O(new_n98_));
  and2   g54(.a(x20), .b(x19), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  nand2  g56(.a(x23), .b(x14), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n51_), .c(x21), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n100_), .c(x22), .O(new_n103_));
  nand3  g59(.a(new_n99_), .b(new_n48_), .c(x21), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n83_), .c(x09), .d(new_n55_), .O(new_n106_));
  oai21  g62(.a(new_n98_), .b(new_n64_), .c(new_n106_), .O(z12));
  nand2  g63(.a(new_n76_), .b(x09), .O(new_n108_));
  nand4  g64(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n108_), .c(new_n99_), .d(x22), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(x23), .O(new_n111_));
  nand4  g67(.a(new_n99_), .b(new_n49_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n75_), .c(new_n83_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n67_), .O(z13));
  ...
  nand4  g79(.a(new_n123_), .b(new_n83_), .c(x09), .d(new_n55_), .O(new_n124_));
  oai21  g80(.a(new_n98_), .b(new_n69_), .c(new_n124_), .O(z14));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n50_), .c(x24), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n116_), .c(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nand4  g85(.a(new_n121_), .b(new_n50_), .c(new_n129_), .d(x24), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n83_), .c(x09), .d(new_n55_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n71_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand3  g90(.a(new_n47_), .b(x19), .c(new_n134_), .O(new_n135_));
  nand3  g91(.a(new_n50_), .b(x25), .c(x24), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n135_), .c(x26), .O(new_n137_));
  nor2   g93(.a(new_n120_), .b(new_n49_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n129_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n99_), .c(new_n138_), .d(new_n77_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n83_), .c(x09), .d(new_n55_), .O(new_n142_));
