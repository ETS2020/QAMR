...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n139_;
  nand2  g00(.a(x10), .b(x01), .O(new_n45_));
  inv1   g01(.a(x08), .O(new_n46_));
  inv1   g02(.a(x10), .O(new_n47_));
  nand2  g03(.a(x20), .b(x19), .O(new_n48_));
  inv1   g04(.a(new_n48_), .O(new_n49_));
  nand4  g05(.a(new_n49_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n50_));
  ...
  nand3  g11(.a(new_n55_), .b(new_n53_), .c(x21), .O(new_n56_));
  oai21  g12(.a(new_n56_), .b(new_n50_), .c(new_n45_), .O(z00));
  nand2  g13(.a(x08), .b(x00), .O(new_n58_));
  nand2  g14(.a(new_n58_), .b(new_n45_), .O(z01));
  nand2  g15(.a(x08), .b(x01), .O(new_n60_));
  nor2   g16(.a(new_n60_), .b(x10), .O(z02));
  nand2  g17(.a(new_n45_), .b(x08), .O(new_n62_));
  ...
  nand4  g36(.a(new_n80_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n81_));
  nand3  g37(.a(new_n81_), .b(new_n58_), .c(new_n45_), .O(z09));
  ...
  aoi21  g45(.a(new_n89_), .b(new_n60_), .c(x10), .O(z10));
  inv1   g46(.a(x19), .O(new_n91_));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n54_), .c(x20), .O(new_n93_));
  ...
  nand3  g53(.a(new_n97_), .b(new_n64_), .c(new_n45_), .O(z11));
  nand2  g54(.a(x23), .b(x14), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n54_), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n48_), .c(x22), .O(new_n101_));
  nand3  g57(.a(new_n49_), .b(new_n51_), .c(x21), .O(new_n102_));
  ...
  nand4  g64(.a(new_n49_), .b(new_n52_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n111_));
  ...
  nand2  g77(.a(new_n121_), .b(new_n70_), .O(z14));
  ...
  nand4  g82(.a(new_n118_), .b(new_n53_), .c(new_n126_), .d(x24), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n72_), .c(new_n45_), .O(z15));
  ...
  nor2   g90(.a(new_n117_), .b(new_n52_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n126_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n135_), .c(new_n77_), .d(new_n49_), .O(new_n137_));
  nand2  g93(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g95(.a(new_n139_), .b(new_n74_), .c(new_n45_), .O(z16));
endmodule
