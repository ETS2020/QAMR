...
module FAU ( 
  ...
  nor2   g36(.a(new_n45_), .b(new_n80_), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n77_), .c(x19), .d(x10), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(x09), .c(new_n46_), .O(new_n84_));
  nand3  g40(.a(new_n84_), .b(new_n57_), .c(new_n56_), .O(z09));
  xnor2a g41(.a(x20), .b(x19), .O(new_n86_));
  nand3  g42(.a(new_n76_), .b(x20), .c(x12), .O(new_n87_));
  oai22  g43(.a(new_n87_), .b(new_n82_), .c(new_n86_), .d(x10), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(x09), .c(new_n46_), .O(new_n89_));
  nand3  g45(.a(new_n89_), .b(new_n59_), .c(new_n56_), .O(z10));
  nand4  g46(.a(x21), .b(x13), .c(x09), .d(new_n46_), .O(new_n91_));
  nand3  g47(.a(new_n81_), .b(x24), .c(x22), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n91_), .c(new_n47_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(x23), .O(new_n94_));
  nand2  g50(.a(x20), .b(x19), .O(new_n95_));
  inv1   g51(.a(new_n95_), .O(new_n96_));
  nand3  g52(.a(new_n74_), .b(x20), .c(x19), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n74_), .c(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n94_), .c(new_n62_), .O(z11));
  ...
  oai21  g59(.a(new_n103_), .b(new_n95_), .c(x22), .O(new_n104_));
  nand3  g60(.a(new_n96_), .b(new_n75_), .c(x21), .O(new_n105_));
  ...
  nand4  g67(.a(new_n96_), .b(new_n54_), .c(x22), .d(x21), .O(new_n112_));
  ...
  nand3  g71(.a(new_n78_), .b(x22), .c(x21), .O(new_n116_));
  nand4  g72(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n117_));
  oai21  g73(.a(new_n116_), .b(new_n95_), .c(new_n117_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x23), .O(new_n119_));
  nand3  g75(.a(x23), .b(x22), .c(x21), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(new_n95_), .c(x24), .O(new_n121_));
  ...
  nand4  g83(.a(new_n127_), .b(new_n126_), .c(x24), .d(x22), .O(new_n128_));
  nand3  g84(.a(new_n80_), .b(x24), .c(x22), .O(new_n129_));
  nor2   g85(.a(new_n129_), .b(new_n125_), .O(new_n130_));
  aoi21  g86(.a(new_n128_), .b(x25), .c(new_n130_), .O(new_n131_));
  nand3  g87(.a(x25), .b(new_n54_), .c(new_n47_), .O(new_n132_));
  oai21  g88(.a(new_n131_), .b(new_n54_), .c(new_n132_), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(x09), .c(new_n46_), .O(new_n134_));
  nand3  g90(.a(new_n134_), .b(new_n70_), .c(new_n56_), .O(z15));
  ...
  nor2   g95(.a(x26), .b(new_n80_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n96_), .c(new_n79_), .d(new_n76_), .O(new_n141_));
