...
module FAU ( 
  ...
  and2   g00(.a(x12), .b(x10), .O(new_n45_));
  ...
  nand4  g38(.a(new_n82_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n60_), .O(z09));
  xnor2a g40(.a(x20), .b(x19), .O(new_n85_));
  nand3  g41(.a(new_n77_), .b(x20), .c(x12), .O(new_n86_));
  oai22  g42(.a(new_n86_), .b(new_n81_), .c(new_n85_), .d(x10), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(x09), .c(new_n47_), .O(new_n88_));
  nand3  g44(.a(new_n88_), .b(new_n62_), .c(new_n46_), .O(z10));
  ...
  oai21  g54(.a(new_n98_), .b(new_n55_), .c(x21), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n49_), .c(x22), .O(new_n100_));
  nand3  g56(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n103_));
  ...
  nand4  g63(.a(new_n50_), .b(new_n53_), .c(x22), .d(x21), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(new_n68_), .c(new_n46_), .O(z13));
  ...
  inv1   g71(.a(new_n112_), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n79_), .c(x23), .d(x22), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand4  g74(.a(new_n118_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n119_));
  nand2  g75(.a(new_n119_), .b(new_n70_), .O(z14));
  nand2  g76(.a(x26), .b(x17), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n112_), .c(x25), .O(new_n123_));
  inv1   g79(.a(x25), .O(new_n124_));
  nand4  g80(.a(new_n116_), .b(new_n54_), .c(new_n124_), .d(x24), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n72_), .c(new_n46_), .O(z15));
  ...
  nor2   g88(.a(x26), .b(new_n124_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n80_), .c(new_n77_), .d(new_n50_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n136_));
  nand3  g92(.a(new_n136_), .b(new_n74_), .c(new_n46_), .O(z16));
endmodule
