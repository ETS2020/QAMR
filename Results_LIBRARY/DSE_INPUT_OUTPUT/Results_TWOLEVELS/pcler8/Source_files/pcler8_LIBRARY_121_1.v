...
module FAU ( 
  ...
  nand3  g51(.a(new_n95_), .b(new_n62_), .c(new_n59_), .O(z11));
  ...
  nand3  g68(.a(new_n112_), .b(new_n66_), .c(new_n59_), .O(z13));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n59_), .O(z16));
endmodule
