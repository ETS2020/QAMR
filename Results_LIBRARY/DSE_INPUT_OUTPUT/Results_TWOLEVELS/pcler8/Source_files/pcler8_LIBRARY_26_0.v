...
module FAU ( 
  ...
  nor2   g08(.a(x10), .b(x09), .O(new_n53_));
  inv1   g09(.a(new_n53_), .O(new_n54_));
  inv1   g10(.a(x08), .O(new_n55_));
  nor2   g11(.a(new_n53_), .b(new_n55_), .O(new_n56_));
  ...
  nand4  g35(.a(new_n79_), .b(new_n74_), .c(x09), .d(new_n55_), .O(new_n80_));
  ...
  oai21  g40(.a(x20), .b(new_n45_), .c(new_n84_), .O(new_n85_));
  nand4  g41(.a(new_n85_), .b(new_n74_), .c(x09), .d(new_n55_), .O(new_n86_));
  oai21  g42(.a(new_n60_), .b(new_n59_), .c(new_n86_), .O(z10));
  ...
  oai21  g49(.a(new_n93_), .b(new_n88_), .c(new_n74_), .O(new_n94_));
  ...
  nand3  g56(.a(new_n100_), .b(new_n47_), .c(x21), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(new_n74_), .c(x09), .d(new_n55_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n64_), .O(z12));
  nand2  g60(.a(new_n75_), .b(x09), .O(new_n105_));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand4  g62(.a(new_n106_), .b(new_n105_), .c(new_n100_), .d(x22), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(x23), .O(new_n108_));
  nand4  g64(.a(new_n100_), .b(new_n48_), .c(x22), .d(x21), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n108_), .c(x08), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n88_), .c(new_n74_), .O(new_n111_));
  ...
  nand4  g76(.a(new_n120_), .b(new_n74_), .c(x09), .d(new_n55_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n68_), .O(z14));
  aoi21  g78(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n123_));
  aoi21  g79(.a(x26), .b(x17), .c(new_n117_), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n123_), .c(new_n118_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n126_));
  inv1   g82(.a(x25), .O(new_n127_));
  nor2   g83(.a(new_n48_), .b(new_n47_), .O(new_n128_));
  nand4  g84(.a(new_n118_), .b(new_n128_), .c(new_n127_), .d(x24), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n126_), .c(x08), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n88_), .c(new_n74_), .O(new_n131_));
  ...
  nor2   g92(.a(new_n117_), .b(new_n48_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n127_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n100_), .c(new_n137_), .d(new_n76_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x08), .O(new_n140_));
  oai21  g96(.a(new_n140_), .b(new_n88_), .c(new_n74_), .O(new_n141_));
