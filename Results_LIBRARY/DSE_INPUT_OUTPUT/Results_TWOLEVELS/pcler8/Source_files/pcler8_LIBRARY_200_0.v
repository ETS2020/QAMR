...
module FAU ( 
  ...
  nor2   g010(.a(x11), .b(x10), .O(new_n55_));
  ...
  nand2  g022(.a(new_n60_), .b(x04), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(z05));
  inv1   g024(.a(x05), .O(new_n69_));
  oai21  g025(.a(new_n47_), .b(new_n69_), .c(new_n56_), .O(z06));
  ...
  inv1   g030(.a(x11), .O(new_n75_));
  inv1   g031(.a(x09), .O(new_n76_));
  nand4  g032(.a(x21), .b(x20), .c(x19), .d(x11), .O(new_n77_));
  ...
  aoi21  g039(.a(new_n83_), .b(x19), .c(new_n76_), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n47_), .c(new_n75_), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(x10), .c(new_n57_), .O(z09));
  nand3  g042(.a(x22), .b(x21), .c(x12), .O(new_n87_));
  nand4  g043(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n87_), .c(x19), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(x20), .O(new_n90_));
  inv1   g046(.a(x20), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(x19), .O(new_n92_));
  aoi21  g048(.a(new_n92_), .b(new_n90_), .c(new_n76_), .O(new_n93_));
  aoi21  g049(.a(new_n93_), .b(new_n47_), .c(new_n75_), .O(new_n94_));
  oai22  g050(.a(new_n94_), .b(x10), .c(new_n61_), .d(new_n59_), .O(z10));
  ...
  aoi21  g057(.a(new_n101_), .b(new_n99_), .c(new_n75_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n103_));
  oai21  g059(.a(new_n61_), .b(new_n63_), .c(new_n103_), .O(z11));
  oai21  g060(.a(x20), .b(new_n75_), .c(x19), .O(new_n105_));
  ...
  and2   g064(.a(x20), .b(x19), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n46_), .c(x21), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(new_n76_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n47_), .c(new_n75_), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(x10), .c(new_n65_), .O(z12));
  ...
  nand4  g072(.a(new_n109_), .b(new_n79_), .c(x22), .d(x21), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(new_n76_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n47_), .c(new_n75_), .O(new_n119_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n124_), .c(new_n75_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n131_), .b(new_n80_), .c(x24), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n121_), .c(x25), .O(new_n133_));
  nor2   g089(.a(x25), .b(new_n125_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n126_), .c(new_n80_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n75_), .O(new_n136_));
  ...
  nand2  g095(.a(x24), .b(x23), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x11), .O(new_n141_));
  nand3  g097(.a(x25), .b(x22), .c(x21), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n141_), .c(new_n109_), .d(new_n139_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x26), .O(new_n145_));
  inv1   g101(.a(new_n140_), .O(new_n146_));
  nand4  g102(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n146_), .c(new_n45_), .d(x25), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n145_), .c(new_n76_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n47_), .c(new_n75_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(x10), .c(new_n73_), .O(z16));
endmodule
