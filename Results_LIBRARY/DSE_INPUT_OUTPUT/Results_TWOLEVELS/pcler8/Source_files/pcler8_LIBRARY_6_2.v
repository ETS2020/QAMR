...
module FAU ( 
  ...
  nand2  g028(.a(x21), .b(x20), .O(new_n73_));
  inv1   g029(.a(new_n73_), .O(new_n74_));
  nand3  g030(.a(new_n74_), .b(x11), .c(new_n47_), .O(new_n75_));
  ...
  nand3  g039(.a(new_n83_), .b(new_n56_), .c(new_n55_), .O(z09));
  ...
  oai21  g044(.a(x20), .b(new_n54_), .c(new_n88_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n59_), .O(z10));
  nand2  g047(.a(x21), .b(x09), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(x08), .c(new_n47_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  nand3  g050(.a(x23), .b(x22), .c(x13), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n79_), .c(x20), .O(new_n96_));
  ...
  nand3  g057(.a(new_n101_), .b(new_n94_), .c(new_n61_), .O(z11));
  nand2  g058(.a(x22), .b(x09), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(x08), .c(new_n47_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n54_), .O(new_n105_));
  inv1   g061(.a(x20), .O(new_n106_));
  nand2  g062(.a(x23), .b(x14), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n79_), .c(x21), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n106_), .c(x22), .O(new_n109_));
  nor2   g065(.a(new_n106_), .b(new_n54_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n76_), .c(x21), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n105_), .c(new_n63_), .O(z12));
  nand2  g070(.a(x23), .b(x09), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(x08), .c(new_n47_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n54_), .O(new_n117_));
  nand4  g073(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n74_), .c(x22), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x23), .O(new_n120_));
  nand4  g076(.a(new_n110_), .b(new_n77_), .c(x22), .d(x21), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n120_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n117_), .c(new_n65_), .O(z13));
  nand2  g080(.a(x24), .b(x09), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(x08), .c(new_n47_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n133_), .b(new_n78_), .c(new_n145_), .d(x24), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n140_), .c(new_n69_), .O(z15));
  inv1   g105(.a(x18), .O(new_n150_));
  nand3  g106(.a(new_n74_), .b(x19), .c(new_n150_), .O(new_n151_));
  nand4  g107(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n151_), .c(x26), .O(new_n153_));
  nor2   g109(.a(new_n76_), .b(new_n98_), .O(new_n154_));
  nor2   g110(.a(new_n131_), .b(new_n77_), .O(new_n155_));
  nor2   g111(.a(x26), .b(new_n145_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n110_), .c(new_n155_), .d(new_n154_), .O(new_n157_));
