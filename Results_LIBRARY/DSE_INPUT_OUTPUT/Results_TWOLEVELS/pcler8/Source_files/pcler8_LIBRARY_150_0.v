...
module FAU ( 
  ...
  nand4  g066(.a(new_n98_), .b(new_n110_), .c(x22), .d(x21), .O(new_n111_));
  ...
  aoi21  g071(.a(new_n115_), .b(x22), .c(new_n74_), .O(new_n116_));
  nand4  g072(.a(x23), .b(x21), .c(x20), .d(x19), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n116_), .c(x24), .O(new_n118_));
  nand3  g074(.a(x21), .b(x20), .c(x19), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nor2   g076(.a(x24), .b(new_n110_), .O(new_n121_));
  ...
  nand2  g080(.a(new_n124_), .b(new_n68_), .O(z14));
  nand2  g081(.a(x26), .b(x17), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(x22), .c(new_n74_), .O(new_n127_));
  and2   g083(.a(x24), .b(x23), .O(new_n128_));
  nand3  g084(.a(new_n98_), .b(new_n128_), .c(x21), .O(new_n129_));
  ...
  nand4  g088(.a(new_n120_), .b(new_n132_), .c(new_n131_), .d(x24), .O(new_n133_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n98_), .c(new_n128_), .d(new_n77_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n140_), .c(x08), .O(new_n143_));
