...
module FAU ( 
  ...
  oai21  g14(.a(new_n46_), .b(new_n58_), .c(new_n55_), .O(z02));
  inv1   g15(.a(x02), .O(new_n60_));
  nor2   g16(.a(new_n54_), .b(new_n46_), .O(new_n61_));
  inv1   g17(.a(new_n61_), .O(new_n62_));
  nor2   g18(.a(new_n62_), .b(new_n60_), .O(z03));
  nand2  g19(.a(new_n61_), .b(x03), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z04));
  nand2  g21(.a(new_n61_), .b(x04), .O(new_n66_));
  ...
  aoi21  g36(.a(new_n80_), .b(new_n46_), .c(new_n74_), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(x10), .c(new_n56_), .O(z09));
  ...
  oai21  g42(.a(x20), .b(new_n83_), .c(new_n86_), .O(new_n87_));
  nand4  g43(.a(new_n87_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n88_));
  oai21  g44(.a(new_n62_), .b(new_n58_), .c(new_n88_), .O(z10));
  ...
  nand3  g49(.a(new_n75_), .b(x20), .c(x19), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g51(.a(new_n95_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n96_));
  oai21  g52(.a(new_n62_), .b(new_n60_), .c(new_n96_), .O(z11));
  oai21  g53(.a(x20), .b(new_n74_), .c(x19), .O(new_n98_));
  ...
  and2   g57(.a(x20), .b(x19), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n76_), .c(x21), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n101_), .c(x08), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n74_), .c(new_n47_), .O(new_n105_));
  ...
  aoi21  g67(.a(new_n111_), .b(new_n109_), .c(x08), .O(new_n112_));
  oai21  g68(.a(new_n112_), .b(new_n74_), .c(new_n47_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n66_), .O(z13));
  ...
  oai21  g78(.a(new_n122_), .b(new_n74_), .c(new_n47_), .O(new_n123_));
  oai21  g79(.a(new_n62_), .b(new_n68_), .c(new_n123_), .O(z14));
  and2   g80(.a(x23), .b(x22), .O(new_n125_));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n125_), .c(x24), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n115_), .c(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nand4  g85(.a(new_n120_), .b(new_n125_), .c(new_n129_), .d(x24), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  oai21  g88(.a(new_n62_), .b(new_n70_), .c(new_n132_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand4  g90(.a(x21), .b(x20), .c(x19), .d(new_n134_), .O(new_n135_));
  nand2  g91(.a(new_n119_), .b(x09), .O(new_n136_));
  nand3  g92(.a(new_n136_), .b(new_n125_), .c(x25), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n135_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n119_), .b(new_n110_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n77_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n74_), .c(new_n47_), .O(new_n143_));
