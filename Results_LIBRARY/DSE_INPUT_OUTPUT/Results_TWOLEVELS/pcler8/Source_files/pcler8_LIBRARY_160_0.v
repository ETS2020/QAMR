...
module FAU ( 
  ...
  oai21  g61(.a(new_n105_), .b(new_n91_), .c(new_n78_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n91_), .c(new_n78_), .O(new_n113_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n123_));
  ...
  nand2  g90(.a(new_n51_), .b(x09), .O(new_n135_));
  and2   g91(.a(x25), .b(x24), .O(new_n136_));
  nand3  g92(.a(new_n136_), .b(new_n135_), .c(x22), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n134_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n119_), .b(new_n51_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n128_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n103_), .c(new_n139_), .d(new_n79_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n91_), .c(new_n78_), .O(new_n143_));
