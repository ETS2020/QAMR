...
module FAU ( 
  ...
  nand2  g002(.a(x18), .b(x17), .O(new_n47_));
  ...
  nor2   g013(.a(new_n57_), .b(new_n54_), .O(new_n58_));
  ...
  oai21  g026(.a(new_n54_), .b(new_n70_), .c(new_n61_), .O(z06));
  nand2  g027(.a(x08), .b(x06), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n61_), .O(z07));
  inv1   g029(.a(x07), .O(new_n74_));
  oai21  g030(.a(new_n54_), .b(new_n74_), .c(new_n61_), .O(z08));
  ...
  nand4  g034(.a(new_n78_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n59_), .c(new_n61_), .O(z09));
  ...
  nand4  g041(.a(new_n85_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n86_));
  ...
  nand4  g050(.a(new_n94_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n64_), .c(new_n61_), .O(z11));
  ...
  nand4  g060(.a(new_n104_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n105_));
  nand2  g061(.a(x08), .b(x03), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n57_), .O(z12));
  ...
  nand4  g069(.a(new_n113_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n68_), .c(new_n61_), .O(z13));
  ...
  oai21  g077(.a(new_n121_), .b(new_n116_), .c(new_n119_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n123_));
  nand2  g079(.a(x08), .b(x05), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n123_), .c(new_n57_), .O(z14));
  inv1   g081(.a(x09), .O(new_n126_));
  nor2   g082(.a(x10), .b(new_n126_), .O(new_n127_));
  nor2   g083(.a(new_n97_), .b(x18), .O(new_n128_));
  nand3  g084(.a(x23), .b(x22), .c(x21), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n89_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n127_), .d(new_n54_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n56_), .O(new_n132_));
  ...
  oai21  g093(.a(new_n137_), .b(new_n116_), .c(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n133_), .c(new_n72_), .O(z15));
  nand4  g096(.a(new_n102_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n141_));
  inv1   g097(.a(x26), .O(new_n142_));
  inv1   g098(.a(new_n129_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(x25), .d(x24), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(new_n141_), .c(new_n54_), .d(new_n74_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n61_), .O(new_n146_));
  nand4  g102(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n116_), .c(new_n56_), .O(new_n148_));
  nand2  g104(.a(x18), .b(new_n55_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n148_), .c(new_n142_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n146_), .O(z16));
endmodule
