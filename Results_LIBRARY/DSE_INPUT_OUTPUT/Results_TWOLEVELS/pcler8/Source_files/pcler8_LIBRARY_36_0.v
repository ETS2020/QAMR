...
module FAU ( 
  ...
  nand2  g23(.a(new_n67_), .b(new_n66_), .O(z04));
  nand2  g24(.a(x08), .b(x04), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n66_), .O(z05));
  nand2  g26(.a(x08), .b(x05), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n66_), .O(z06));
  nand2  g28(.a(x08), .b(x06), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n66_), .O(z07));
  nand2  g30(.a(x08), .b(x07), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n66_), .O(z08));
  ...
  oai21  g38(.a(new_n82_), .b(x10), .c(new_n60_), .O(z09));
  ...
  oai21  g52(.a(new_n96_), .b(new_n77_), .c(new_n84_), .O(new_n97_));
  ...
  oai21  g61(.a(new_n105_), .b(new_n77_), .c(new_n84_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n112_), .b(new_n77_), .c(new_n84_), .O(new_n113_));
