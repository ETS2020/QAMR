...
module FAU ( 
  ...
  nand2  g46(.a(new_n90_), .b(new_n62_), .O(z10));
  ...
  nand3  g54(.a(new_n98_), .b(new_n64_), .c(new_n46_), .O(z11));
  ...
  nand4  g93(.a(new_n137_), .b(new_n136_), .c(new_n78_), .d(new_n50_), .O(new_n138_));
