...
module FAU ( 
  ...
  nor2   g25(.a(new_n50_), .b(new_n59_), .O(z13));
  nor2   g26(.a(new_n50_), .b(new_n61_), .O(z14));
  nor2   g27(.a(new_n50_), .b(new_n63_), .O(z15));
  oai21  g28(.a(new_n53_), .b(new_n65_), .c(new_n46_), .O(z16));
  nor2   g29(.a(new_n50_), .b(new_n48_), .O(z09));
endmodule
