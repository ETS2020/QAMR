...
module FAU ( 
  ...
  oai21  g018(.a(new_n46_), .b(new_n62_), .c(new_n59_), .O(z03));
  ...
  oai21  g052(.a(new_n57_), .b(new_n62_), .c(new_n96_), .O(z11));
  ...
  oai21  g061(.a(new_n57_), .b(new_n64_), .c(new_n105_), .O(z12));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n46_), .c(new_n115_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(x10), .c(new_n68_), .O(z14));
  inv1   g082(.a(x25), .O(new_n127_));
  nand2  g083(.a(x26), .b(x17), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(x22), .c(x21), .d(x20), .O(new_n129_));
  nand3  g085(.a(x24), .b(x23), .c(x19), .O(new_n130_));
  aoi21  g086(.a(new_n129_), .b(x09), .c(new_n130_), .O(new_n131_));
  nor2   g087(.a(new_n110_), .b(new_n75_), .O(new_n132_));
  nand4  g088(.a(new_n122_), .b(new_n132_), .c(new_n127_), .d(x24), .O(new_n133_));
  oai21  g089(.a(new_n131_), .b(new_n127_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n46_), .c(new_n115_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(x10), .c(new_n70_), .O(z15));
  ...
  nor2   g096(.a(new_n116_), .b(new_n110_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n127_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n102_), .c(new_n141_), .d(new_n76_), .O(new_n143_));
