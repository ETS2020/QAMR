...
module FAU ( 
  ...
  nand3  g39(.a(x23), .b(x22), .c(x12), .O(new_n84_));
  ...
  oai21  g49(.a(new_n93_), .b(new_n85_), .c(x19), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(x21), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n89_), .c(new_n83_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n46_), .c(new_n82_), .O(new_n97_));
  oai22  g53(.a(new_n97_), .b(x10), .c(new_n57_), .d(new_n62_), .O(z11));
  inv1   g54(.a(x19), .O(new_n99_));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n85_), .c(x20), .O(new_n101_));
  ...
  aoi21  g60(.a(new_n104_), .b(new_n102_), .c(new_n82_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  oai21  g62(.a(new_n57_), .b(new_n64_), .c(new_n106_), .O(z12));
  nand2  g63(.a(x20), .b(x19), .O(new_n108_));
  nand2  g64(.a(x21), .b(x15), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n85_), .c(x22), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n108_), .c(x23), .O(new_n111_));
  inv1   g67(.a(new_n108_), .O(new_n112_));
  nand3  g68(.a(new_n112_), .b(new_n75_), .c(x22), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n111_), .c(new_n83_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n46_), .c(new_n82_), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(x10), .c(new_n66_), .O(z13));
  nand4  g72(.a(x26), .b(x25), .c(x21), .d(x16), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x23), .c(x22), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n108_), .c(x24), .O(new_n119_));
  nand4  g75(.a(new_n112_), .b(new_n76_), .c(x23), .d(x22), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n119_), .c(new_n83_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n46_), .c(new_n82_), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(x10), .c(new_n68_), .O(z14));
  nand3  g79(.a(x22), .b(x20), .c(x19), .O(new_n124_));
  nand3  g80(.a(x26), .b(x21), .c(x17), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(x24), .c(x23), .O(new_n126_));
  oai21  g82(.a(new_n126_), .b(new_n124_), .c(x25), .O(new_n127_));
  inv1   g83(.a(new_n124_), .O(new_n128_));
  nor2   g84(.a(x25), .b(new_n76_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n128_), .c(x23), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n127_), .c(new_n83_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n46_), .c(new_n82_), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(x10), .c(new_n70_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand2  g90(.a(new_n112_), .b(new_n134_), .O(new_n135_));
  nand4  g91(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n135_), .c(x26), .O(new_n137_));
  nand4  g93(.a(new_n128_), .b(new_n77_), .c(new_n45_), .d(x25), .O(new_n138_));
  aoi21  g94(.a(new_n138_), .b(new_n137_), .c(new_n82_), .O(new_n139_));
