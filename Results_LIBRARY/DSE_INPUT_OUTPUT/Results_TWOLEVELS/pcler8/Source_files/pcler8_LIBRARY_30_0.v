...
module FAU ( 
  ...
  nand2  g026(.a(new_n70_), .b(new_n65_), .O(z06));
  inv1   g027(.a(x06), .O(new_n72_));
  oai21  g028(.a(new_n56_), .b(new_n72_), .c(new_n65_), .O(z07));
  ...
  aoi21  g037(.a(new_n81_), .b(new_n56_), .c(new_n76_), .O(new_n82_));
  oai22  g038(.a(new_n82_), .b(x10), .c(new_n59_), .d(new_n55_), .O(z09));
  ...
  oai21  g052(.a(new_n96_), .b(new_n76_), .c(new_n84_), .O(new_n97_));
  ...
  nand3  g059(.a(new_n103_), .b(new_n77_), .c(x21), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(x08), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n76_), .c(new_n84_), .O(new_n106_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n84_), .c(x09), .d(new_n56_), .O(new_n114_));
  oai21  g070(.a(new_n59_), .b(new_n68_), .c(new_n114_), .O(z13));
  nand3  g071(.a(x21), .b(x20), .c(x19), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand2  g073(.a(new_n77_), .b(x09), .O(new_n118_));
  nand3  g074(.a(x26), .b(x25), .c(x16), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(x23), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x24), .O(new_n121_));
  inv1   g077(.a(x24), .O(new_n122_));
  nand4  g078(.a(new_n117_), .b(new_n122_), .c(x23), .d(x22), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(x08), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n76_), .c(new_n84_), .O(new_n125_));
  ...
  nand4  g086(.a(new_n117_), .b(new_n50_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n84_), .c(x09), .d(new_n56_), .O(new_n133_));
  oai21  g089(.a(new_n59_), .b(new_n72_), .c(new_n133_), .O(z15));
  inv1   g090(.a(x18), .O(new_n135_));
  nand4  g091(.a(x21), .b(x20), .c(x19), .d(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n122_), .b(x09), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n50_), .c(x25), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(x26), .O(new_n139_));
  nor2   g095(.a(new_n122_), .b(new_n111_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n130_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n103_), .c(new_n140_), .d(new_n78_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(x08), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n76_), .c(new_n84_), .O(new_n144_));
