...
module FAU ( 
  ...
  oai21  g48(.a(new_n92_), .b(new_n82_), .c(x21), .O(new_n93_));
  nand3  g49(.a(new_n74_), .b(x20), .c(x19), .O(new_n94_));
  aoi21  g50(.a(new_n94_), .b(new_n93_), .c(x08), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n89_), .c(new_n47_), .O(new_n96_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n89_), .c(new_n47_), .O(new_n105_));
  ...
  oai21  g79(.a(new_n57_), .b(new_n67_), .c(new_n123_), .O(z14));
  nor2   g80(.a(new_n110_), .b(new_n75_), .O(new_n125_));
  ...
  nand2  g88(.a(new_n132_), .b(new_n70_), .O(z15));
