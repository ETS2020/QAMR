...
module FAU ( 
  ...
  oai21  g035(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n80_));
  nand3  g036(.a(new_n80_), .b(x21), .c(x16), .O(new_n81_));
  inv1   g037(.a(x19), .O(new_n82_));
  nand2  g038(.a(new_n55_), .b(new_n82_), .O(new_n83_));
  ...
  nand2  g042(.a(x09), .b(new_n47_), .O(new_n87_));
  nand3  g043(.a(x20), .b(new_n82_), .c(new_n48_), .O(new_n88_));
  oai22  g044(.a(new_n88_), .b(new_n87_), .c(new_n47_), .d(new_n61_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n57_), .O(new_n90_));
  nand3  g046(.a(x22), .b(x20), .c(x12), .O(new_n91_));
  oai22  g047(.a(new_n91_), .b(new_n79_), .c(x20), .d(new_n82_), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(x21), .c(x16), .O(new_n93_));
  nand3  g049(.a(new_n55_), .b(new_n75_), .c(x19), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n90_), .O(z10));
  inv1   g053(.a(x16), .O(new_n98_));
  aoi21  g054(.a(x20), .b(x19), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g058(.a(new_n102_), .b(new_n99_), .c(x21), .O(new_n103_));
  nand3  g059(.a(new_n55_), .b(x20), .c(x19), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n63_), .c(new_n57_), .O(z11));
  nand2  g063(.a(x23), .b(x14), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n101_), .c(x20), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n82_), .c(x22), .O(new_n110_));
  nand2  g066(.a(x20), .b(x19), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n46_), .c(x21), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n110_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g071(.a(x22), .b(new_n55_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n115_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n65_), .O(z12));
  inv1   g075(.a(x23), .O(new_n120_));
  nand4  g076(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n112_), .c(x22), .O(new_n122_));
  nand3  g078(.a(new_n120_), .b(x22), .c(x21), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n111_), .O(new_n124_));
  aoi21  g080(.a(new_n122_), .b(x23), .c(new_n124_), .O(new_n125_));
  oai22  g081(.a(new_n125_), .b(new_n98_), .c(new_n120_), .d(x21), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n67_), .O(z13));
  nand4  g084(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(x24), .c(new_n120_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(x22), .c(x21), .d(x20), .O(new_n131_));
  nand3  g087(.a(x23), .b(x22), .c(x21), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n111_), .c(x24), .O(new_n133_));
  oai21  g089(.a(new_n131_), .b(new_n82_), .c(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n69_), .c(new_n57_), .O(z14));
  nand2  g092(.a(new_n76_), .b(x19), .O(new_n137_));
  inv1   g093(.a(x25), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x24), .c(x23), .O(new_n139_));
  nand3  g095(.a(x26), .b(x25), .c(x17), .O(new_n140_));
  oai21  g096(.a(new_n139_), .b(new_n137_), .c(new_n140_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x21), .O(new_n142_));
  nand3  g098(.a(x21), .b(x20), .c(x19), .O(new_n143_));
  nand2  g099(.a(new_n78_), .b(x22), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(x25), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n71_), .c(new_n57_), .O(z15));
  nor2   g104(.a(new_n111_), .b(x18), .O(new_n149_));
  ...
  nand4  g108(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n153_));
  nand4  g109(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n152_), .c(x16), .O(new_n156_));
  oai21  g112(.a(new_n45_), .b(x21), .c(new_n156_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n73_), .O(z16));
endmodule
