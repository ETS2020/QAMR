...
module FAU ( 
  ...
  nor2   g011(.a(x13), .b(x10), .O(new_n56_));
  ...
  oai21  g019(.a(new_n47_), .b(new_n63_), .c(new_n57_), .O(z03));
  ...
  oai21  g029(.a(new_n47_), .b(new_n73_), .c(new_n57_), .O(z08));
  and2   g030(.a(x22), .b(x21), .O(new_n75_));
  ...
  nand4  g034(.a(new_n78_), .b(x13), .c(new_n48_), .d(x09), .O(new_n79_));
  oai22  g035(.a(new_n79_), .b(x08), .c(new_n61_), .d(new_n55_), .O(z09));
  inv1   g036(.a(x13), .O(new_n81_));
  ...
  oai22  g045(.a(new_n89_), .b(x10), .c(new_n61_), .d(new_n59_), .O(z10));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n94_), .c(new_n81_), .O(new_n97_));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n81_), .O(new_n105_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n95_), .c(x23), .O(new_n110_));
  ...
  aoi21  g075(.a(new_n118_), .b(x13), .c(new_n119_), .O(new_n120_));
  ...
  inv1   g084(.a(new_n91_), .O(new_n129_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n103_), .c(new_n142_), .d(new_n75_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(new_n81_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n146_));
  oai21  g102(.a(new_n61_), .b(new_n73_), .c(new_n146_), .O(z16));
endmodule
