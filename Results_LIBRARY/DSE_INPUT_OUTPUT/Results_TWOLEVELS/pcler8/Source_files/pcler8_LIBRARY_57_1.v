...
module FAU ( 
  ...
  inv1   g26(.a(new_n61_), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n70_), .O(z06));
  nand2  g28(.a(new_n61_), .b(x06), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(z07));
  nand2  g30(.a(new_n61_), .b(x07), .O(new_n75_));
  ...
  nand3  g38(.a(new_n82_), .b(new_n59_), .c(new_n46_), .O(z09));
