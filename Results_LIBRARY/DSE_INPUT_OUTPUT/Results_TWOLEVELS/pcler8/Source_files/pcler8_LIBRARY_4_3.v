...
module FAU ( 
  ...
  nand2  g15(.a(new_n59_), .b(new_n54_), .O(z02));
  ...
  nand3  g63(.a(new_n107_), .b(x21), .c(x20), .O(new_n108_));
  nand2  g64(.a(x22), .b(x19), .O(new_n109_));
  aoi21  g65(.a(new_n108_), .b(new_n47_), .c(new_n109_), .O(new_n110_));
  nand4  g66(.a(new_n101_), .b(new_n106_), .c(x22), .d(x21), .O(new_n111_));
  oai21  g67(.a(new_n110_), .b(new_n106_), .c(new_n111_), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n46_), .c(x10), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n73_), .c(new_n65_), .O(z13));
  inv1   g70(.a(x24), .O(new_n115_));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand3  g72(.a(new_n116_), .b(x21), .c(x20), .O(new_n117_));
  nand3  g73(.a(x23), .b(x22), .c(x19), .O(new_n118_));
  aoi21  g74(.a(new_n117_), .b(new_n47_), .c(new_n118_), .O(new_n119_));
  nand3  g75(.a(x21), .b(x20), .c(x19), .O(new_n120_));
  inv1   g76(.a(new_n120_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n115_), .c(x23), .d(x22), .O(new_n122_));
  oai21  g78(.a(new_n119_), .b(new_n115_), .c(new_n122_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n46_), .c(x10), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n73_), .c(new_n67_), .O(z14));
  and2   g81(.a(x23), .b(x22), .O(new_n126_));
  nand3  g82(.a(x26), .b(x17), .c(new_n47_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n121_), .c(new_n126_), .d(x24), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(x25), .O(new_n129_));
  inv1   g85(.a(x25), .O(new_n130_));
  nand4  g86(.a(new_n121_), .b(new_n126_), .c(new_n130_), .d(x24), .O(new_n131_));
  ...
  nand3  g92(.a(new_n126_), .b(x25), .c(x24), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n136_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n115_), .b(new_n106_), .O(new_n139_));
