...
module FAU ( 
  ...
  oai21  g19(.a(new_n48_), .b(new_n63_), .c(new_n47_), .O(z02));
  nand2  g20(.a(new_n60_), .b(x02), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z03));
  inv1   g22(.a(x03), .O(new_n67_));
  oai21  g23(.a(new_n48_), .b(new_n67_), .c(new_n47_), .O(z04));
  and2   g24(.a(new_n60_), .b(x04), .O(z05));
  ...
  nand3  g37(.a(new_n81_), .b(new_n61_), .c(new_n47_), .O(z09));
  ...
  aoi21  g46(.a(new_n90_), .b(new_n89_), .c(new_n46_), .O(z10));
  nand4  g47(.a(x21), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n92_));
  nand2  g48(.a(new_n57_), .b(new_n55_), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  nand2  g50(.a(new_n94_), .b(x13), .O(new_n95_));
  nand3  g51(.a(new_n76_), .b(x20), .c(x19), .O(new_n96_));
  oai21  g52(.a(new_n51_), .b(new_n76_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g62(.a(new_n106_), .b(new_n105_), .c(new_n46_), .O(z12));
  ...
  nand4  g66(.a(new_n51_), .b(new_n54_), .c(x22), .d(x21), .O(new_n111_));
  ...
  nand4  g97(.a(new_n141_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n142_));
  nand3  g98(.a(new_n142_), .b(new_n74_), .c(new_n47_), .O(z16));
endmodule
