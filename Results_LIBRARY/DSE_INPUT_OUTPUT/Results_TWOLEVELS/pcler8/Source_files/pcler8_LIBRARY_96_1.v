...
module FAU ( 
  ...
  nand3  g36(.a(new_n80_), .b(new_n56_), .c(new_n65_), .O(z09));
  ...
  oai21  g51(.a(new_n61_), .b(new_n60_), .c(new_n95_), .O(z11));
  ...
  oai21  g60(.a(new_n61_), .b(new_n63_), .c(new_n104_), .O(z12));
  ...
  nand3  g68(.a(new_n112_), .b(new_n66_), .c(new_n65_), .O(z13));
  ...
  oai21  g78(.a(new_n61_), .b(new_n68_), .c(new_n122_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n65_), .O(z15));
  ...
  oai21  g97(.a(new_n61_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
