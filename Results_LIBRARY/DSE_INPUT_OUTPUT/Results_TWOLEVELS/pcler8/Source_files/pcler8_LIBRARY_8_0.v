...
module FAU ( 
  ...
  inv1   g023(.a(new_n58_), .O(new_n68_));
  nor2   g024(.a(new_n68_), .b(new_n67_), .O(z06));
  inv1   g025(.a(x06), .O(new_n70_));
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n55_), .O(z07));
  ...
  nand2  g045(.a(new_n89_), .b(new_n59_), .O(z10));
  ...
  oai21  g061(.a(new_n105_), .b(new_n74_), .c(new_n47_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n63_), .O(z12));
  ...
  nand2  g070(.a(new_n114_), .b(new_n65_), .O(z13));
  ...
  oai21  g079(.a(new_n123_), .b(new_n74_), .c(new_n47_), .O(new_n124_));
  oai21  g080(.a(new_n68_), .b(new_n67_), .c(new_n124_), .O(z14));
  and2   g081(.a(x23), .b(x22), .O(new_n126_));
