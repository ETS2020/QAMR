...
module FAU ( 
  ...
  nand2  g078(.a(new_n122_), .b(new_n68_), .O(z14));
  inv1   g079(.a(x25), .O(new_n124_));
  nand2  g080(.a(x26), .b(x17), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x23), .c(x22), .O(new_n126_));
  nand4  g082(.a(x24), .b(x21), .c(x20), .d(x19), .O(new_n127_));
  aoi21  g083(.a(new_n126_), .b(new_n47_), .c(new_n127_), .O(new_n128_));
  nand2  g084(.a(x23), .b(x22), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n119_), .b(new_n130_), .c(new_n124_), .d(x24), .O(new_n131_));
  oai21  g087(.a(new_n128_), .b(new_n124_), .c(new_n131_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n46_), .c(x10), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n54_), .c(new_n70_), .O(z15));
  inv1   g090(.a(x18), .O(new_n135_));
  nand2  g091(.a(new_n129_), .b(new_n47_), .O(new_n136_));
  nand3  g092(.a(x25), .b(x24), .c(x21), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n136_), .c(new_n101_), .d(new_n135_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x26), .O(new_n140_));
  nor2   g096(.a(new_n118_), .b(new_n109_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n124_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n101_), .c(new_n141_), .d(new_n76_), .O(new_n143_));
