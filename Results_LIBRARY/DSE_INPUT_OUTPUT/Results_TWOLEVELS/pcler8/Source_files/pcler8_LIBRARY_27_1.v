...
module FAU ( 
  ...
  nand2  g11(.a(x10), .b(new_n55_), .O(new_n56_));
  oai21  g12(.a(new_n46_), .b(new_n54_), .c(new_n56_), .O(z01));
  aoi21  g13(.a(x10), .b(new_n55_), .c(new_n46_), .O(new_n58_));
  ...
  nor2   g22(.a(new_n62_), .b(new_n66_), .O(z05));
  inv1   g23(.a(x05), .O(new_n68_));
  nor2   g24(.a(new_n62_), .b(new_n68_), .O(z06));
  nand2  g25(.a(new_n58_), .b(x06), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z07));
  nand2  g27(.a(new_n58_), .b(x07), .O(new_n72_));
  ...
  oai21  g36(.a(new_n62_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  oai21  g51(.a(new_n62_), .b(new_n61_), .c(new_n95_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n64_), .c(new_n56_), .O(z12));
  ...
  oai21  g68(.a(new_n62_), .b(new_n66_), .c(new_n112_), .O(z13));
  ...
  oai21  g78(.a(new_n62_), .b(new_n68_), .c(new_n122_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n56_), .O(z15));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n56_), .O(z16));
endmodule
