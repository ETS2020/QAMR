...
module FAU ( 
  ...
  nand2  g25(.a(new_n69_), .b(new_n60_), .O(z04));
  ...
  nand2  g46(.a(new_n90_), .b(new_n65_), .O(z10));
  ...
  nand4  g52(.a(new_n96_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n67_), .O(z11));
  ...
  nand4  g61(.a(new_n105_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n69_), .O(z12));
  aoi21  g63(.a(x21), .b(x20), .c(x10), .O(new_n108_));
  ...
  nand4  g67(.a(new_n99_), .b(new_n53_), .c(x22), .d(x21), .O(new_n112_));
  ...
  nand4  g85(.a(new_n121_), .b(new_n54_), .c(new_n129_), .d(x24), .O(new_n130_));
  ...
  nor2   g93(.a(new_n120_), .b(new_n53_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n129_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n99_), .c(new_n138_), .d(new_n79_), .O(new_n140_));
