...
module FAU ( 
  ...
  nor2   g09(.a(x25), .b(new_n47_), .O(new_n54_));
  ...
  nand3  g79(.a(new_n100_), .b(x09), .c(new_n46_), .O(new_n124_));
  nor2   g80(.a(new_n117_), .b(new_n108_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n75_), .O(new_n126_));
  ...
  aoi21  g87(.a(new_n131_), .b(new_n118_), .c(new_n123_), .O(new_n132_));
  ...
  nor2   g94(.a(x26), .b(new_n123_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n100_), .c(new_n125_), .d(new_n75_), .O(new_n140_));
