...
module FAU ( 
  ...
  oai21  g021(.a(new_n47_), .b(new_n65_), .c(new_n61_), .O(z04));
  ...
  oai22  g036(.a(new_n80_), .b(x08), .c(new_n58_), .d(new_n55_), .O(z09));
  ...
  oai21  g045(.a(new_n58_), .b(new_n60_), .c(new_n89_), .O(z10));
  ...
  nand3  g051(.a(new_n75_), .b(x20), .c(x19), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n95_), .c(new_n82_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n98_));
  oai21  g054(.a(new_n58_), .b(new_n63_), .c(new_n98_), .O(z11));
  ...
  oai21  g065(.a(x20), .b(new_n82_), .c(x19), .O(new_n110_));
  ...
  nand4  g070(.a(new_n104_), .b(new_n114_), .c(x22), .d(x21), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(new_n109_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n47_), .c(new_n82_), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(x10), .c(new_n67_), .O(z13));
  aoi21  g074(.a(new_n93_), .b(x24), .c(new_n114_), .O(new_n119_));
  ...
  oai21  g078(.a(new_n120_), .b(new_n91_), .c(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(x16), .c(new_n48_), .d(x09), .O(new_n124_));
  oai22  g080(.a(new_n124_), .b(x08), .c(new_n58_), .d(new_n69_), .O(z14));
  nand3  g081(.a(x21), .b(x20), .c(x19), .O(new_n126_));
  nor2   g082(.a(new_n114_), .b(new_n46_), .O(new_n127_));
  ...
  nand4  g088(.a(new_n132_), .b(new_n127_), .c(new_n131_), .d(x24), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n130_), .c(new_n82_), .O(new_n134_));
  ...
  nand2  g093(.a(x24), .b(x23), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x16), .O(new_n139_));
  nand3  g095(.a(x25), .b(x22), .c(x21), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n139_), .c(new_n104_), .d(new_n137_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x26), .O(new_n143_));
  inv1   g099(.a(new_n138_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n131_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n104_), .c(new_n144_), .d(new_n76_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n143_), .c(new_n109_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n47_), .c(new_n82_), .O(new_n148_));
