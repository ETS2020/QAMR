...
module FAU ( 
  ...
  nor2   g13(.a(x18), .b(x10), .O(new_n58_));
  ...
  nor2   g23(.a(new_n63_), .b(new_n67_), .O(z04));
  inv1   g24(.a(x04), .O(new_n69_));
  oai21  g25(.a(new_n57_), .b(new_n69_), .c(new_n59_), .O(z05));
  ...
  nand4  g36(.a(new_n80_), .b(x18), .c(new_n77_), .d(x09), .O(new_n81_));
  oai22  g37(.a(new_n81_), .b(x08), .c(new_n63_), .d(new_n56_), .O(z09));
  ...
  nand4  g45(.a(new_n89_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n90_));
  ...
  aoi21  g54(.a(new_n98_), .b(new_n57_), .c(new_n83_), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(x10), .c(new_n65_), .O(z11));
  ...
  aoi21  g62(.a(new_n106_), .b(new_n104_), .c(new_n83_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n108_));
  oai21  g64(.a(new_n63_), .b(new_n67_), .c(new_n108_), .O(z12));
  ...
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(new_n83_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n115_));
  oai21  g71(.a(new_n63_), .b(new_n69_), .c(new_n115_), .O(z13));
  ...
  nand4  g78(.a(new_n122_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n123_));
  oai21  g79(.a(new_n63_), .b(new_n71_), .c(new_n123_), .O(z14));
  ...
  nand4  g86(.a(new_n130_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n131_));
  ...
  nand4  g91(.a(new_n135_), .b(x18), .c(new_n77_), .d(x09), .O(new_n136_));
  oai22  g92(.a(new_n136_), .b(x08), .c(new_n63_), .d(new_n75_), .O(z16));
endmodule
