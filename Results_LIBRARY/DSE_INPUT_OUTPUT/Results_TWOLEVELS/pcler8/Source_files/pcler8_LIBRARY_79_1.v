...
module FAU ( 
  ...
  nand2  g16(.a(new_n60_), .b(new_n56_), .O(z03));
  inv1   g17(.a(x03), .O(new_n62_));
  oai21  g18(.a(new_n46_), .b(new_n62_), .c(new_n56_), .O(z04));
  inv1   g19(.a(x04), .O(new_n64_));
  oai21  g20(.a(new_n46_), .b(new_n64_), .c(new_n56_), .O(z05));
  inv1   g21(.a(x05), .O(new_n66_));
  aoi21  g22(.a(x10), .b(new_n55_), .c(new_n46_), .O(new_n67_));
  inv1   g23(.a(new_n67_), .O(new_n68_));
  nor2   g24(.a(new_n68_), .b(new_n66_), .O(z06));
  nand2  g25(.a(new_n67_), .b(x06), .O(new_n70_));
  ...
  oai21  g36(.a(new_n68_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  nand3  g51(.a(new_n95_), .b(new_n60_), .c(new_n56_), .O(z11));
  ...
  oai21  g60(.a(new_n68_), .b(new_n62_), .c(new_n104_), .O(z12));
  ...
  oai21  g68(.a(new_n68_), .b(new_n64_), .c(new_n112_), .O(z13));
  ...
  oai21  g78(.a(new_n68_), .b(new_n66_), .c(new_n122_), .O(z14));
