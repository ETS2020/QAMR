...
module FAU ( 
  ...
  nand3  g043(.a(new_n87_), .b(new_n59_), .c(new_n65_), .O(z10));
  ...
  nand3  g051(.a(new_n95_), .b(new_n61_), .c(new_n65_), .O(z11));
  ...
  nand3  g068(.a(new_n112_), .b(new_n66_), .c(new_n65_), .O(z13));
  ...
  nand3  g079(.a(x25), .b(new_n47_), .c(new_n46_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x09), .O(new_n125_));
