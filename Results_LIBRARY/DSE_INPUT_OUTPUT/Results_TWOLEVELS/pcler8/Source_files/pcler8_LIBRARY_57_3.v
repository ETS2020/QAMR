...
module FAU ( 
  ...
  nand2  g17(.a(new_n59_), .b(x08), .O(new_n62_));
  ...
  nand2  g25(.a(new_n63_), .b(x04), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z05));
  nand2  g27(.a(new_n63_), .b(x05), .O(new_n72_));
  inv1   g28(.a(new_n72_), .O(z06));
  nand2  g29(.a(new_n63_), .b(x06), .O(new_n74_));
  inv1   g30(.a(new_n74_), .O(z07));
  nand2  g31(.a(new_n63_), .b(x07), .O(new_n76_));
  ...
  oai21  g39(.a(new_n83_), .b(new_n45_), .c(new_n60_), .O(z09));
