...
module FAU ( 
  ...
  aoi21  g16(.a(x10), .b(new_n60_), .c(new_n45_), .O(z03));
  oai21  g17(.a(new_n57_), .b(x03), .c(x08), .O(new_n62_));
  inv1   g18(.a(new_n62_), .O(z04));
  nand3  g19(.a(x10), .b(x08), .c(x04), .O(new_n64_));
  inv1   g20(.a(new_n64_), .O(z05));
  inv1   g21(.a(x05), .O(new_n66_));
  aoi21  g22(.a(x10), .b(new_n66_), .c(new_n45_), .O(z06));
  ...
  nand3  g58(.a(new_n102_), .b(new_n57_), .c(x09), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n62_), .O(z12));
  ...
  nand4  g63(.a(new_n100_), .b(new_n49_), .c(x22), .d(x21), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n110_));
  nand2  g66(.a(new_n78_), .b(x04), .O(new_n111_));
  ...
  nand4  g76(.a(new_n120_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n121_));
  nand2  g77(.a(new_n78_), .b(x05), .O(new_n122_));
  ...
  nand4  g83(.a(new_n118_), .b(new_n50_), .c(new_n127_), .d(x24), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n130_));
  nand2  g86(.a(new_n78_), .b(x06), .O(new_n131_));
  ...
  nor2   g92(.a(new_n117_), .b(new_n49_), .O(new_n137_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n57_), .c(x09), .d(new_n45_), .O(new_n141_));
  nand2  g97(.a(new_n78_), .b(x07), .O(new_n142_));
