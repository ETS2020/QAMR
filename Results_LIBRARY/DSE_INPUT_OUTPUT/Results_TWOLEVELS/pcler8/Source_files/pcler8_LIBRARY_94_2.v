...
module FAU ( 
  ...
  nand4  g88(.a(x26), .b(new_n118_), .c(x09), .d(new_n46_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n47_), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n55_), .O(new_n135_));
  nand2  g91(.a(new_n101_), .b(new_n55_), .O(new_n136_));
  nand4  g92(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n136_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n118_), .b(new_n109_), .O(new_n139_));
  ...
  nand3  g99(.a(new_n143_), .b(new_n135_), .c(new_n72_), .O(z16));
endmodule
