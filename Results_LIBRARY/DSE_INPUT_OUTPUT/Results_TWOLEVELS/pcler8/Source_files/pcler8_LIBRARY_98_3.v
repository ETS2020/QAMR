...
module FAU ( 
  ...
  nor2   g12(.a(new_n46_), .b(new_n45_), .O(new_n57_));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n61_), .c(x10), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n45_), .c(new_n59_), .O(z09));
  ...
  nand4  g43(.a(new_n87_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n63_), .O(z10));
  ...
  nand4  g50(.a(new_n94_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n65_), .O(z11));
  oai21  g52(.a(x20), .b(x10), .c(x19), .O(new_n97_));
  ...
  aoi21  g59(.a(new_n103_), .b(new_n100_), .c(x08), .O(new_n104_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n102_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
