...
module FAU ( 
  ...
  nor2   g12(.a(x25), .b(x10), .O(new_n57_));
  ...
  oai21  g26(.a(new_n56_), .b(new_n70_), .c(new_n67_), .O(z06));
  inv1   g27(.a(x06), .O(new_n72_));
  nor2   g28(.a(new_n61_), .b(new_n72_), .O(z07));
  ...
  nand4  g33(.a(x26), .b(x24), .c(x23), .d(x22), .O(new_n78_));
  oai22  g34(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(x19), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(x09), .c(new_n56_), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(x25), .c(x10), .O(new_n81_));
  or2    g37(.a(new_n81_), .b(z01), .O(z09));
  ...
  aoi21  g44(.a(new_n88_), .b(new_n86_), .c(new_n76_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n83_), .c(x09), .d(new_n56_), .O(new_n90_));
  ...
  nand3  g51(.a(new_n48_), .b(x25), .c(new_n49_), .O(new_n96_));
  aoi21  g52(.a(new_n96_), .b(new_n95_), .c(new_n45_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n56_), .c(new_n76_), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(x10), .c(new_n63_), .O(z11));
  nand4  g55(.a(x26), .b(x24), .c(x23), .d(x14), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(x21), .c(x20), .d(x19), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(x22), .O(new_n102_));
  nand4  g58(.a(new_n48_), .b(x25), .c(new_n50_), .d(x21), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(new_n45_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n56_), .c(new_n76_), .O(new_n105_));
  oai22  g61(.a(new_n105_), .b(x10), .c(new_n61_), .d(new_n65_), .O(z12));
  nand3  g62(.a(x26), .b(x24), .c(x15), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(x22), .c(x21), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n47_), .c(x23), .O(new_n109_));
  inv1   g65(.a(x23), .O(new_n110_));
  nand3  g66(.a(x21), .b(x20), .c(x19), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(x25), .c(new_n110_), .d(x22), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n109_), .c(new_n45_), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n56_), .c(new_n76_), .O(new_n115_));
  ...
  oai21  g74(.a(new_n118_), .b(new_n111_), .c(x24), .O(new_n119_));
  nor2   g75(.a(x24), .b(new_n110_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n112_), .c(x22), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n119_), .c(new_n76_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n83_), .c(x09), .d(new_n56_), .O(new_n123_));
  oai21  g79(.a(new_n61_), .b(new_n70_), .c(new_n123_), .O(z14));
  nand4  g80(.a(x24), .b(x23), .c(x22), .d(x21), .O(new_n125_));
  inv1   g81(.a(new_n125_), .O(new_n126_));
  nand2  g82(.a(x26), .b(x17), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n126_), .c(x20), .d(x19), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(x25), .c(new_n83_), .d(x09), .O(new_n129_));
  oai22  g85(.a(new_n129_), .b(x08), .c(new_n61_), .d(new_n72_), .O(z15));
  inv1   g86(.a(x18), .O(new_n131_));
  nand2  g87(.a(new_n48_), .b(new_n131_), .O(new_n132_));
  nand3  g88(.a(new_n51_), .b(x24), .c(x23), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n132_), .c(x26), .O(new_n134_));
  inv1   g90(.a(x26), .O(new_n135_));
  nor2   g91(.a(new_n110_), .b(new_n50_), .O(new_n136_));
  nand4  g92(.a(new_n112_), .b(new_n136_), .c(new_n135_), .d(x24), .O(new_n137_));
  aoi21  g93(.a(new_n137_), .b(new_n134_), .c(new_n76_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n83_), .c(x09), .d(new_n56_), .O(new_n139_));
