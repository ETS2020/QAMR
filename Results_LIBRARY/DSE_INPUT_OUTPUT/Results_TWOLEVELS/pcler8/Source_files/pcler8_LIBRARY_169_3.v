...
module FAU ( 
  ...
  nand4  g71(.a(new_n115_), .b(x22), .c(x21), .d(x20), .O(new_n116_));
  nand2  g72(.a(x23), .b(x19), .O(new_n117_));
  aoi21  g73(.a(new_n116_), .b(new_n47_), .c(new_n117_), .O(new_n118_));
  nand3  g74(.a(x21), .b(x20), .c(x19), .O(new_n119_));
  inv1   g75(.a(new_n119_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n114_), .c(x23), .d(x22), .O(new_n121_));
  oai21  g77(.a(new_n118_), .b(new_n114_), .c(new_n121_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n46_), .c(x10), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n73_), .c(new_n67_), .O(z14));
  inv1   g80(.a(x25), .O(new_n125_));
  nand2  g81(.a(x26), .b(x17), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(x22), .c(x21), .d(x20), .O(new_n127_));
  nand3  g83(.a(x24), .b(x23), .c(x19), .O(new_n128_));
  aoi21  g84(.a(new_n127_), .b(new_n47_), .c(new_n128_), .O(new_n129_));
  nor2   g85(.a(new_n109_), .b(new_n75_), .O(new_n130_));
  nand4  g86(.a(new_n120_), .b(new_n130_), .c(new_n125_), .d(x24), .O(new_n131_));
  oai21  g87(.a(new_n129_), .b(new_n125_), .c(new_n131_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n46_), .c(x10), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n73_), .c(new_n69_), .O(z15));
  ...
  nor2   g94(.a(new_n114_), .b(new_n109_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n125_), .O(new_n140_));
