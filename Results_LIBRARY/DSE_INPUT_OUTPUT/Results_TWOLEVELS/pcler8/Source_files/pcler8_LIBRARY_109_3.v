...
module FAU ( 
  ...
  nand2  g39(.a(new_n83_), .b(new_n59_), .O(z10));
  ...
  oai21  g47(.a(new_n91_), .b(x10), .c(x09), .O(new_n92_));
  nand2  g48(.a(new_n92_), .b(new_n61_), .O(z11));
  ...
  aoi21  g56(.a(new_n100_), .b(new_n97_), .c(x08), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(x10), .c(x09), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n63_), .O(z12));
  ...
  aoi21  g68(.a(new_n112_), .b(x22), .c(x10), .O(new_n113_));
  nand4  g69(.a(x23), .b(x21), .c(x20), .d(x19), .O(new_n114_));
  ...
  aoi21  g75(.a(new_n119_), .b(new_n115_), .c(x08), .O(new_n120_));
  oai21  g76(.a(new_n120_), .b(x10), .c(x09), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n67_), .O(z14));
  nor2   g78(.a(new_n107_), .b(new_n98_), .O(new_n123_));
  ...
  nor2   g82(.a(x25), .b(new_n116_), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n118_), .c(new_n123_), .O(new_n128_));
  ...
  oai21  g87(.a(new_n116_), .b(x18), .c(new_n47_), .O(new_n132_));
  nand3  g88(.a(x25), .b(x23), .c(x22), .O(new_n133_));
  nor2   g89(.a(new_n133_), .b(new_n117_), .O(new_n134_));
  aoi21  g90(.a(new_n134_), .b(new_n132_), .c(new_n45_), .O(new_n135_));
  nand4  g91(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n136_));
  nand4  g92(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n137_));
  nor2   g93(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n135_), .c(new_n46_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(x09), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n71_), .O(z16));
endmodule
