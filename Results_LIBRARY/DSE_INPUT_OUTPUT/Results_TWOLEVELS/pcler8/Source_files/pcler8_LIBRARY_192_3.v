...
module FAU ( 
  ...
  oai21  g27(.a(new_n59_), .b(new_n70_), .c(new_n71_), .O(z05));
  ...
  nand2  g33(.a(new_n77_), .b(new_n71_), .O(z08));
  ...
  nand4  g44(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n96_));
  ...
  nand4  g60(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n68_), .O(z12));
  nand2  g62(.a(new_n61_), .b(x04), .O(new_n107_));
  nand4  g63(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g64(.a(new_n108_), .b(x22), .c(x21), .O(new_n109_));
  oai21  g65(.a(new_n109_), .b(new_n98_), .c(x23), .O(new_n110_));
  nand4  g66(.a(new_n102_), .b(new_n53_), .c(x22), .d(x21), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n113_));
  nand2  g69(.a(new_n113_), .b(new_n107_), .O(z13));
  ...
  nand4  g81(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n126_));
  nand2  g82(.a(x26), .b(x17), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(x24), .c(x19), .O(new_n128_));
  aoi21  g84(.a(new_n126_), .b(new_n46_), .c(new_n128_), .O(new_n129_));
  nand4  g85(.a(new_n120_), .b(new_n54_), .c(new_n125_), .d(x24), .O(new_n130_));
  oai21  g86(.a(new_n129_), .b(new_n125_), .c(new_n130_), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n59_), .c(x10), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(new_n45_), .c(new_n75_), .O(z15));
  inv1   g89(.a(x26), .O(new_n134_));
  inv1   g90(.a(x18), .O(new_n135_));
  nand4  g91(.a(x25), .b(x24), .c(x19), .d(new_n135_), .O(new_n136_));
  aoi21  g92(.a(new_n126_), .b(new_n46_), .c(new_n136_), .O(new_n137_));
  ...
  oai21  g96(.a(new_n137_), .b(new_n134_), .c(new_n140_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n59_), .c(x10), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(new_n45_), .c(new_n77_), .O(z16));
endmodule
