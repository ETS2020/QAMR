...
module FAU ( 
  ...
  oai21  g51(.a(new_n95_), .b(new_n73_), .c(new_n47_), .O(new_n96_));
  ...
  nand2  g72(.a(new_n75_), .b(x09), .O(new_n117_));
  ...
  nor2   g81(.a(new_n110_), .b(new_n75_), .O(new_n126_));
  nand2  g82(.a(x26), .b(x17), .O(new_n127_));
  nand3  g83(.a(new_n127_), .b(new_n126_), .c(x24), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n115_), .c(x25), .O(new_n129_));
  inv1   g85(.a(x25), .O(new_n130_));
  nand4  g86(.a(new_n116_), .b(new_n126_), .c(new_n130_), .d(x24), .O(new_n131_));
