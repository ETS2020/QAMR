...
module FAU ( 
  ...
  oai21  g08(.a(new_n51_), .b(new_n53_), .c(new_n47_), .O(z03));
  nand2  g09(.a(x08), .b(x03), .O(new_n55_));
  nand2  g10(.a(new_n55_), .b(new_n47_), .O(z04));
  inv1   g11(.a(x04), .O(new_n57_));
  oai21  g12(.a(new_n51_), .b(new_n57_), .c(new_n47_), .O(z05));
  inv1   g13(.a(x05), .O(new_n59_));
  oai21  g14(.a(new_n51_), .b(new_n59_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x06), .O(new_n61_));
  inv1   g16(.a(x09), .O(new_n62_));
  oai21  g17(.a(x10), .b(new_n62_), .c(x08), .O(new_n63_));
  nor2   g18(.a(new_n63_), .b(new_n61_), .O(z07));
  inv1   g19(.a(x07), .O(new_n65_));
  nor2   g20(.a(new_n63_), .b(new_n65_), .O(z08));
  nor2   g21(.a(new_n63_), .b(new_n50_), .O(z10));
  nor2   g22(.a(new_n63_), .b(new_n53_), .O(z11));
  nor2   g23(.a(new_n63_), .b(new_n57_), .O(z13));
  nor2   g24(.a(new_n63_), .b(new_n59_), .O(z14));
  oai21  g25(.a(new_n51_), .b(new_n61_), .c(new_n47_), .O(z15));
  oai21  g26(.a(new_n51_), .b(new_n65_), .c(new_n47_), .O(z16));
  zero   g27(.O(z00));
  nand2  g28(.a(new_n48_), .b(new_n47_), .O(z09));
  nand2  g29(.a(new_n55_), .b(new_n47_), .O(z12));
endmodule
