...
module FAU ( 
  ...
  nor2   g33(.a(new_n45_), .b(new_n77_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  oai21  g35(.a(new_n79_), .b(new_n73_), .c(x19), .O(new_n80_));
  nand4  g36(.a(new_n80_), .b(x23), .c(new_n47_), .d(x09), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(x08), .c(new_n57_), .O(z09));
  inv1   g38(.a(x23), .O(new_n83_));
  inv1   g39(.a(x09), .O(new_n84_));
  ...
  nand3  g45(.a(x23), .b(new_n89_), .c(x19), .O(new_n90_));
  aoi21  g46(.a(new_n90_), .b(new_n88_), .c(new_n84_), .O(new_n91_));
  aoi21  g47(.a(new_n91_), .b(new_n46_), .c(new_n83_), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(x10), .c(new_n59_), .O(z10));
  ...
  aoi21  g55(.a(new_n99_), .b(new_n97_), .c(new_n83_), .O(new_n100_));
  ...
  nand4  g59(.a(new_n103_), .b(x21), .c(x20), .d(x19), .O(new_n104_));
  nand2  g60(.a(new_n104_), .b(x22), .O(new_n105_));
  nand2  g61(.a(x20), .b(x19), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(x23), .c(new_n74_), .d(x21), .O(new_n108_));
  aoi21  g64(.a(new_n108_), .b(new_n105_), .c(new_n84_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n46_), .c(new_n83_), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(x10), .c(new_n63_), .O(z12));
  nor2   g67(.a(new_n74_), .b(new_n98_), .O(new_n112_));
  nand3  g68(.a(new_n78_), .b(x24), .c(x15), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n112_), .c(x20), .d(x19), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(x23), .c(new_n47_), .d(x09), .O(new_n115_));
  oai21  g71(.a(new_n115_), .b(x08), .c(new_n65_), .O(z13));
  nand3  g72(.a(x26), .b(x25), .c(x16), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(x22), .c(x21), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n106_), .c(x24), .O(new_n119_));
  nand4  g75(.a(new_n107_), .b(new_n75_), .c(x22), .d(x21), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n119_), .c(new_n84_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n46_), .c(new_n83_), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(x10), .c(new_n67_), .O(z14));
  ...
  nand4  g84(.a(new_n128_), .b(new_n77_), .c(x24), .d(x22), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n127_), .c(new_n84_), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n46_), .c(new_n83_), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(x10), .c(new_n69_), .O(z15));
  inv1   g88(.a(x18), .O(new_n133_));
  nand3  g89(.a(x20), .b(x19), .c(new_n133_), .O(new_n134_));
  nand4  g90(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n134_), .c(x26), .O(new_n136_));
  nand4  g92(.a(new_n128_), .b(new_n76_), .c(new_n45_), .d(x25), .O(new_n137_));
  aoi21  g93(.a(new_n137_), .b(new_n136_), .c(new_n84_), .O(new_n138_));
  aoi21  g94(.a(new_n138_), .b(new_n46_), .c(new_n83_), .O(new_n139_));
  oai21  g95(.a(new_n139_), .b(x10), .c(new_n71_), .O(z16));
endmodule
