...
module FAU ( 
  ...
  nand2  g21(.a(x10), .b(new_n55_), .O(new_n66_));
  oai21  g22(.a(new_n46_), .b(new_n65_), .c(new_n66_), .O(z05));
  nand2  g23(.a(x08), .b(x05), .O(new_n68_));
  nand2  g24(.a(new_n68_), .b(new_n66_), .O(z06));
  inv1   g25(.a(x06), .O(new_n70_));
  oai21  g26(.a(new_n46_), .b(new_n70_), .c(new_n66_), .O(z07));
  ...
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n66_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n63_), .c(new_n66_), .O(z12));
  ...
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n66_), .O(z14));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n66_), .O(z16));
endmodule
