...
module FAU ( 
  ...
  oai21  g23(.a(new_n63_), .b(new_n52_), .c(new_n46_), .O(z10));
  oai21  g24(.a(new_n63_), .b(new_n54_), .c(new_n46_), .O(z11));
  nor2   g25(.a(new_n50_), .b(new_n62_), .O(z15));
  nand2  g26(.a(new_n56_), .b(new_n46_), .O(z12));
  nor2   g27(.a(new_n50_), .b(new_n58_), .O(z13));
  nand2  g28(.a(new_n60_), .b(new_n46_), .O(z14));
