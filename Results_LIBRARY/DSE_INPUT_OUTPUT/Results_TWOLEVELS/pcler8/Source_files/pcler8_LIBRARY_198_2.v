...
module FAU ( 
  ...
  oai21  g13(.a(new_n49_), .b(new_n57_), .c(new_n46_), .O(z04));
  inv1   g14(.a(x04), .O(new_n59_));
  nor2   g15(.a(new_n53_), .b(new_n59_), .O(z05));
  ...
  nor2   g24(.a(new_n53_), .b(new_n57_), .O(z12));
  oai21  g25(.a(new_n49_), .b(new_n59_), .c(new_n46_), .O(z13));
  oai21  g26(.a(new_n49_), .b(new_n63_), .c(new_n46_), .O(z15));
  nor2   g27(.a(new_n53_), .b(new_n51_), .O(z10));
