...
module FAU ( 
  ...
  aoi21  g50(.a(new_n94_), .b(new_n93_), .c(x10), .O(z11));
  ...
  nand4  g56(.a(new_n100_), .b(new_n46_), .c(x09), .d(new_n45_), .O(new_n101_));
  ...
  aoi21  g75(.a(new_n119_), .b(new_n118_), .c(x10), .O(z14));
  nand2  g76(.a(x26), .b(x17), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n110_), .c(x25), .O(new_n123_));
  inv1   g79(.a(x25), .O(new_n124_));
  nand4  g80(.a(new_n115_), .b(new_n52_), .c(new_n124_), .d(x24), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(x09), .c(new_n45_), .O(new_n127_));
  aoi21  g83(.a(new_n127_), .b(new_n69_), .c(x10), .O(z15));
  ...
  nor2   g88(.a(new_n114_), .b(new_n51_), .O(new_n133_));
  nor2   g89(.a(x26), .b(new_n124_), .O(new_n134_));
  nand4  g90(.a(new_n134_), .b(new_n133_), .c(new_n74_), .d(new_n48_), .O(new_n135_));
  nand2  g91(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g92(.a(new_n136_), .b(x09), .c(new_n45_), .O(new_n137_));
  aoi21  g93(.a(new_n137_), .b(new_n71_), .c(x10), .O(z16));
endmodule
