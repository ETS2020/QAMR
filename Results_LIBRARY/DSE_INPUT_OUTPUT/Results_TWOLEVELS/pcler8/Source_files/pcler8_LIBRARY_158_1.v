...
module FAU ( 
  ...
  oai21  g018(.a(new_n47_), .b(new_n61_), .c(new_n62_), .O(z02));
  inv1   g019(.a(x02), .O(new_n64_));
  nor2   g020(.a(new_n59_), .b(new_n64_), .O(z03));
  inv1   g021(.a(x03), .O(new_n66_));
  oai21  g022(.a(new_n47_), .b(new_n66_), .c(new_n62_), .O(z04));
  ...
  oai21  g028(.a(new_n47_), .b(new_n72_), .c(new_n62_), .O(z07));
  ...
  aoi21  g052(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n98_));
  oai21  g054(.a(new_n59_), .b(new_n64_), .c(new_n98_), .O(z11));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(x16), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n107_));
  oai21  g063(.a(new_n59_), .b(new_n66_), .c(new_n107_), .O(z12));
  inv1   g064(.a(x23), .O(new_n109_));
  nand4  g065(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x21), .c(x20), .O(new_n111_));
  nand2  g067(.a(x22), .b(x19), .O(new_n112_));
  aoi21  g068(.a(new_n111_), .b(new_n49_), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n104_), .b(new_n109_), .c(x22), .d(x21), .O(new_n114_));
  oai21  g070(.a(new_n113_), .b(new_n109_), .c(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x09), .c(new_n47_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n49_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n48_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n68_), .O(z13));
  nor2   g075(.a(new_n109_), .b(new_n46_), .O(new_n120_));
  nand3  g076(.a(new_n104_), .b(new_n120_), .c(x21), .O(new_n121_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n122_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n49_), .c(new_n48_), .d(x09), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(x08), .c(new_n70_), .O(z14));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n120_), .c(x24), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n123_), .c(x25), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  inv1   g088(.a(new_n123_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n120_), .c(new_n132_), .d(x24), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n136_));
  oai21  g092(.a(new_n59_), .b(new_n72_), .c(new_n136_), .O(z15));
  inv1   g093(.a(x09), .O(new_n138_));
  oai21  g094(.a(new_n124_), .b(new_n109_), .c(new_n49_), .O(new_n139_));
  nor2   g095(.a(new_n100_), .b(x18), .O(new_n140_));
  nor2   g096(.a(new_n132_), .b(new_n46_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(x21), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x26), .O(new_n143_));
  nor2   g099(.a(new_n124_), .b(new_n109_), .O(new_n144_));
  nor2   g100(.a(x26), .b(new_n132_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n104_), .c(new_n144_), .d(new_n77_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n143_), .c(new_n138_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n47_), .c(x16), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(x10), .c(new_n74_), .O(z16));
endmodule
