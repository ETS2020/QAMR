...
module FAU ( 
  ...
  nand3  g034(.a(new_n78_), .b(x09), .c(new_n45_), .O(new_n79_));
  aoi21  g035(.a(new_n79_), .b(x03), .c(x10), .O(new_n80_));
  ...
  aoi21  g044(.a(new_n88_), .b(new_n45_), .c(new_n65_), .O(new_n89_));
  ...
  nand4  g053(.a(new_n97_), .b(x09), .c(new_n45_), .d(x03), .O(new_n98_));
  oai21  g054(.a(new_n68_), .b(new_n62_), .c(new_n98_), .O(z11));
  inv1   g055(.a(x10), .O(new_n100_));
  nand4  g056(.a(x22), .b(new_n86_), .c(new_n100_), .d(x09), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n45_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(x03), .O(new_n103_));
  nand2  g059(.a(x23), .b(x14), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n53_), .c(x21), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n91_), .c(x22), .O(new_n106_));
  nor2   g062(.a(new_n86_), .b(new_n91_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n50_), .c(x21), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n82_), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n65_), .c(new_n100_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n103_), .O(z12));
  nand3  g067(.a(x23), .b(new_n86_), .c(new_n100_), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n46_), .c(new_n45_), .d(new_n67_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x03), .O(new_n114_));
  ...
  nand4  g073(.a(new_n107_), .b(new_n51_), .c(x22), .d(x21), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x09), .c(new_n45_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x03), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n100_), .O(new_n122_));
  nand3  g078(.a(x10), .b(x08), .c(x04), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(new_n114_), .O(z13));
  nand3  g080(.a(x26), .b(x25), .c(x16), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x23), .c(x22), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n48_), .c(x24), .O(new_n127_));
  inv1   g083(.a(x24), .O(new_n128_));
  nand4  g084(.a(new_n49_), .b(new_n128_), .c(x23), .d(x22), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(x10), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(x09), .c(new_n45_), .d(x03), .O(new_n131_));
  oai21  g087(.a(new_n68_), .b(new_n70_), .c(new_n131_), .O(z14));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n52_), .c(x24), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n48_), .c(x25), .O(new_n135_));
  inv1   g091(.a(x25), .O(new_n136_));
  nand4  g092(.a(new_n52_), .b(new_n49_), .c(new_n136_), .d(x24), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(x10), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(x09), .c(new_n45_), .d(x03), .O(new_n139_));
  ...
  nor2   g100(.a(new_n50_), .b(new_n95_), .O(new_n145_));
  nor2   g101(.a(new_n128_), .b(new_n51_), .O(new_n146_));
  nor2   g102(.a(x26), .b(new_n136_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n107_), .c(new_n146_), .d(new_n145_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n144_), .c(x10), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x09), .c(new_n45_), .d(x03), .O(new_n150_));
