...
module FAU ( 
  ...
  nor2   g028(.a(new_n57_), .b(new_n72_), .O(z08));
  ...
  oai21  g055(.a(new_n99_), .b(new_n91_), .c(x20), .O(new_n100_));
  nand2  g056(.a(x21), .b(x19), .O(new_n101_));
  aoi21  g057(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  and2   g058(.a(x20), .b(x19), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n75_), .c(x21), .O(new_n104_));
  oai21  g060(.a(new_n102_), .b(new_n75_), .c(new_n104_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n46_), .c(new_n98_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(x10), .c(new_n64_), .O(z12));
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(x20), .c(new_n98_), .O(new_n109_));
  nand2  g065(.a(new_n76_), .b(x19), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n109_), .c(x23), .O(new_n111_));
  inv1   g067(.a(x23), .O(new_n112_));
  nand4  g068(.a(new_n103_), .b(new_n112_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(x08), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n98_), .c(new_n47_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n66_), .O(z13));
  nand3  g072(.a(x21), .b(x20), .c(x19), .O(new_n117_));
  nand4  g073(.a(x26), .b(x25), .c(x16), .d(x09), .O(new_n118_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(x08), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n98_), .c(new_n47_), .O(new_n125_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n98_), .c(new_n47_), .O(new_n144_));
  oai21  g100(.a(new_n57_), .b(new_n72_), .c(new_n144_), .O(z16));
endmodule
