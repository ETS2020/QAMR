...
module FAU ( 
  ...
  aoi21  g053(.a(new_n97_), .b(new_n96_), .c(x14), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n99_));
  oai21  g055(.a(new_n62_), .b(new_n64_), .c(new_n99_), .O(z11));
  ...
  oai21  g063(.a(new_n62_), .b(new_n66_), .c(new_n107_), .O(z12));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n119_), .c(x14), .O(new_n123_));
  ...
  nand2  g082(.a(new_n126_), .b(new_n49_), .O(new_n127_));
  aoi21  g083(.a(x26), .b(x17), .c(new_n120_), .O(new_n128_));
  ...
  nor2   g092(.a(new_n92_), .b(x18), .O(new_n137_));
  nor2   g093(.a(new_n131_), .b(new_n120_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n137_), .c(new_n127_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x26), .O(new_n140_));
  nor2   g096(.a(new_n120_), .b(new_n112_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n104_), .c(new_n141_), .d(new_n77_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(new_n83_), .O(new_n144_));
