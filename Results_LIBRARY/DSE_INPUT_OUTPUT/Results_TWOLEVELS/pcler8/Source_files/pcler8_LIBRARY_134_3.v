...
module FAU ( 
  ...
  oai21  g25(.a(new_n60_), .b(new_n69_), .c(new_n61_), .O(z04));
  ...
  nand2  g33(.a(new_n77_), .b(new_n61_), .O(z08));
  ...
  nand4  g44(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n89_));
  ...
  nand4  g60(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n105_));
  oai21  g61(.a(new_n63_), .b(new_n69_), .c(new_n105_), .O(z12));
  ...
  nand4  g67(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(new_n71_), .O(z13));
  aoi21  g69(.a(x22), .b(x21), .c(x10), .O(new_n114_));
  ...
  nand4  g86(.a(new_n130_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n131_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n141_));
