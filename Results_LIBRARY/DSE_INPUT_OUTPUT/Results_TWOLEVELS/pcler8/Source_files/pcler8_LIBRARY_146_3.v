...
module FAU ( 
  ...
  aoi21  g22(.a(new_n47_), .b(new_n66_), .c(new_n46_), .O(z07));
  ...
  aoi21  g48(.a(new_n92_), .b(new_n58_), .c(x10), .O(z11));
  ...
  nand3  g64(.a(new_n108_), .b(x09), .c(new_n46_), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n62_), .c(x10), .O(z13));
  ...
  aoi21  g75(.a(new_n119_), .b(new_n64_), .c(x10), .O(z14));
  ...
  aoi21  g85(.a(new_n129_), .b(new_n128_), .c(x10), .O(z15));
  ...
  nand4  g92(.a(new_n136_), .b(new_n98_), .c(new_n135_), .d(new_n72_), .O(new_n137_));
