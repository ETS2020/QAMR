...
module FAU ( 
  ...
  oai21  g036(.a(new_n60_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  oai21  g043(.a(new_n60_), .b(new_n58_), .c(new_n87_), .O(z10));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n101_), .c(x08), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n89_), .c(new_n47_), .O(new_n105_));
  ...
  nand2  g072(.a(new_n75_), .b(x09), .O(new_n117_));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n120_), .c(x08), .O(new_n123_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n89_), .c(new_n47_), .O(new_n144_));
