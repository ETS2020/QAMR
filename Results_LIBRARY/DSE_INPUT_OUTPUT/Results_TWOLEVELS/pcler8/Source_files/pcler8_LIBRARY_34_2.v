...
module FAU ( 
  ...
  nand2  g010(.a(new_n54_), .b(x10), .O(new_n55_));
  nand2  g011(.a(x08), .b(x00), .O(new_n56_));
  nand2  g012(.a(new_n56_), .b(new_n55_), .O(z01));
  aoi21  g013(.a(new_n54_), .b(x10), .c(new_n46_), .O(new_n58_));
  ...
  nand3  g031(.a(new_n75_), .b(x11), .c(new_n47_), .O(new_n76_));
  ...
  nand3  g039(.a(new_n83_), .b(x09), .c(new_n46_), .O(new_n84_));
  nand3  g040(.a(new_n84_), .b(new_n56_), .c(new_n55_), .O(z09));
  nand4  g041(.a(x22), .b(x21), .c(x20), .d(x12), .O(new_n86_));
  nand4  g042(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n87_));
  oai22  g043(.a(new_n87_), .b(new_n86_), .c(x20), .d(new_n54_), .O(new_n88_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n59_), .c(new_n55_), .O(z10));
  nand3  g048(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n80_), .c(x20), .O(new_n94_));
  ...
  nor2   g055(.a(new_n73_), .b(new_n54_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand2  g057(.a(x23), .b(x14), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n80_), .c(x21), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(x22), .O(new_n104_));
  nand3  g060(.a(new_n100_), .b(new_n77_), .c(x21), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n63_), .O(z12));
  nand2  g064(.a(x23), .b(x09), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(x08), .c(new_n47_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n54_), .O(new_n111_));
  nand4  g067(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n75_), .c(x22), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x23), .O(new_n114_));
  nand4  g070(.a(new_n100_), .b(new_n78_), .c(x22), .d(x21), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n111_), .c(new_n65_), .O(z13));
  ...
  nand2  g083(.a(new_n127_), .b(new_n67_), .O(z14));
  nand2  g084(.a(x25), .b(x09), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(x08), .c(new_n47_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n54_), .O(new_n131_));
  nand3  g087(.a(x22), .b(x21), .c(x20), .O(new_n132_));
  nand2  g088(.a(x26), .b(x17), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x24), .c(x23), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n132_), .c(x25), .O(new_n135_));
  inv1   g091(.a(x25), .O(new_n136_));
  nand4  g092(.a(new_n124_), .b(new_n79_), .c(new_n136_), .d(x24), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n131_), .c(new_n69_), .O(z15));
  ...
  nand3  g100(.a(x21), .b(x20), .c(new_n144_), .O(new_n145_));
  nand4  g101(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n145_), .c(x26), .O(new_n147_));
  nor2   g103(.a(new_n77_), .b(new_n74_), .O(new_n148_));
  nor2   g104(.a(new_n123_), .b(new_n78_), .O(new_n149_));
  nor2   g105(.a(x26), .b(new_n136_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n100_), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n143_), .c(new_n71_), .O(z16));
endmodule
