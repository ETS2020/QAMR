...
module FAU ( 
  ...
  oai21  g49(.a(new_n93_), .b(new_n84_), .c(x21), .O(new_n94_));
  nand3  g50(.a(new_n74_), .b(x20), .c(x19), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n94_), .c(x08), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n90_), .c(new_n47_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n61_), .O(z11));
  ...
  nand3  g59(.a(new_n103_), .b(new_n75_), .c(x21), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n102_), .c(x08), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(new_n90_), .c(new_n47_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n64_), .O(z12));
  ...
  oai21  g69(.a(new_n113_), .b(new_n90_), .c(new_n47_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n66_), .O(z13));
  nand3  g71(.a(x21), .b(x20), .c(x19), .O(new_n116_));
  nand4  g72(.a(x26), .b(x25), .c(x16), .d(x09), .O(new_n117_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n90_), .c(new_n47_), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n68_), .O(z14));
  nand3  g81(.a(x26), .b(x17), .c(x09), .O(new_n126_));
  ...
  oai21  g88(.a(new_n132_), .b(new_n90_), .c(new_n47_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n70_), .O(z15));
  ...
  nand4  g96(.a(new_n140_), .b(new_n103_), .c(new_n139_), .d(new_n76_), .O(new_n141_));
