...
module FAU ( 
  ...
  oai21  g64(.a(new_n108_), .b(new_n99_), .c(x23), .O(new_n109_));
  nand4  g65(.a(new_n98_), .b(new_n53_), .c(x22), .d(x21), .O(new_n110_));
  nand2  g66(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n112_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n98_), .c(new_n137_), .d(new_n79_), .O(new_n139_));
