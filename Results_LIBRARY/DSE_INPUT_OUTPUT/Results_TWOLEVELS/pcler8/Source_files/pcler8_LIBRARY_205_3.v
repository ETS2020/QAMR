...
module FAU ( 
  ...
  nand4  g75(.a(new_n115_), .b(new_n119_), .c(x23), .d(x22), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n118_), .c(x08), .O(new_n121_));
  oai21  g77(.a(new_n121_), .b(x10), .c(x09), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n67_), .O(z14));
  and2   g79(.a(x23), .b(x22), .O(new_n124_));
  nand3  g80(.a(x26), .b(x17), .c(new_n47_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n115_), .c(new_n124_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nand4  g84(.a(new_n115_), .b(new_n124_), .c(new_n128_), .d(x24), .O(new_n129_));
  ...
  nor2   g92(.a(new_n119_), .b(new_n109_), .O(new_n137_));
