...
module FAU ( 
  ...
  oai21  g52(.a(x20), .b(new_n73_), .c(x19), .O(new_n97_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n73_), .c(new_n47_), .O(new_n105_));
  ...
  oai21  g80(.a(new_n110_), .b(new_n75_), .c(x09), .O(new_n125_));
  aoi21  g81(.a(x26), .b(x17), .c(new_n119_), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n125_), .c(new_n102_), .d(x21), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nor2   g85(.a(new_n110_), .b(new_n75_), .O(new_n130_));
  nand4  g86(.a(new_n120_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  ...
  nor2   g90(.a(new_n101_), .b(x18), .O(new_n135_));
  nor2   g91(.a(new_n129_), .b(new_n119_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n135_), .c(new_n125_), .d(x21), .O(new_n137_));
