...
module FAU ( 
  ...
  aoi21  g13(.a(x10), .b(new_n54_), .c(new_n46_), .O(new_n58_));
  ...
  nor2   g20(.a(new_n62_), .b(new_n64_), .O(z04));
  ...
  oai21  g60(.a(new_n62_), .b(new_n64_), .c(new_n104_), .O(z12));
  ...
  nand3  g78(.a(new_n122_), .b(new_n68_), .c(new_n55_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n55_), .O(z15));
  ...
  oai21  g97(.a(new_n62_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
