...
module FAU ( 
  ...
  nand2  g09(.a(x18), .b(x10), .O(new_n54_));
  ...
  nand2  g87(.a(x26), .b(x09), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(x08), .c(new_n47_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(x18), .O(new_n134_));
  nand4  g90(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n113_), .c(x26), .O(new_n136_));
  ...
  nand3  g97(.a(new_n141_), .b(new_n134_), .c(new_n71_), .O(z16));
endmodule
