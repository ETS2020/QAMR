...
module FAU ( 
  ...
  nand2  g023(.a(new_n55_), .b(x05), .O(new_n68_));
  ...
  oai21  g062(.a(new_n64_), .b(new_n63_), .c(new_n106_), .O(z12));
  ...
  oai21  g070(.a(new_n64_), .b(new_n66_), .c(new_n114_), .O(z13));
  nand3  g071(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(x22), .c(new_n74_), .O(new_n117_));
  nand4  g073(.a(x23), .b(x21), .c(x20), .d(x19), .O(new_n118_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n74_), .c(new_n47_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n68_), .O(z14));
  nor2   g082(.a(new_n111_), .b(new_n76_), .O(new_n127_));
