...
module FAU ( 
  ...
  nor2   g24(.a(x19), .b(x10), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g26(.a(new_n70_), .b(new_n49_), .c(new_n48_), .O(z09));
  inv1   g27(.a(x10), .O(new_n72_));
  xor2a  g28(.a(x20), .b(x19), .O(new_n73_));
  nand4  g29(.a(new_n73_), .b(new_n72_), .c(x09), .d(new_n51_), .O(new_n74_));
  nand3  g30(.a(new_n74_), .b(new_n53_), .c(new_n48_), .O(z10));
  oai21  g31(.a(x23), .b(x19), .c(x20), .O(new_n76_));
  nand2  g32(.a(new_n76_), .b(x21), .O(new_n77_));
  nand2  g33(.a(x20), .b(x19), .O(new_n78_));
  inv1   g34(.a(x21), .O(new_n79_));
  nand2  g35(.a(new_n46_), .b(new_n79_), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(new_n81_));
  nand4  g37(.a(new_n81_), .b(new_n72_), .c(x09), .d(new_n51_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n55_), .O(z11));
  aoi21  g39(.a(x21), .b(x19), .c(x23), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n45_), .c(x22), .O(new_n85_));
  nor2   g41(.a(x23), .b(x22), .O(new_n86_));
  nand4  g42(.a(new_n86_), .b(x21), .c(x20), .d(x19), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(new_n72_), .c(x09), .d(new_n51_), .O(new_n89_));
  nand2  g45(.a(new_n89_), .b(new_n57_), .O(z12));
  nand3  g46(.a(new_n46_), .b(x22), .c(x21), .O(new_n91_));
  oai22  g47(.a(new_n91_), .b(new_n78_), .c(new_n46_), .d(x20), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n72_), .c(x09), .d(new_n51_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n59_), .O(z13));
  nand3  g50(.a(new_n68_), .b(x24), .c(new_n72_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n48_), .O(z14));
  nand3  g52(.a(new_n68_), .b(x25), .c(new_n72_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n63_), .c(new_n48_), .O(z15));
  nand3  g54(.a(new_n68_), .b(x26), .c(new_n72_), .O(new_n99_));
  nand3  g55(.a(new_n99_), .b(new_n65_), .c(new_n48_), .O(z16));
endmodule
