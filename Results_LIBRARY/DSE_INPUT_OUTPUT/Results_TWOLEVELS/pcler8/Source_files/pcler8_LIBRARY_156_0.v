...
module FAU ( 
  ...
  nor2   g032(.a(new_n61_), .b(new_n76_), .O(z08));
  ...
  nor2   g043(.a(x20), .b(new_n45_), .O(new_n88_));
  aoi21  g044(.a(new_n87_), .b(x20), .c(new_n88_), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(x08), .c(x09), .O(new_n90_));
  nand2  g046(.a(new_n90_), .b(new_n85_), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n63_), .O(z10));
  ...
  nand4  g069(.a(new_n113_), .b(new_n85_), .c(x09), .d(new_n58_), .O(new_n114_));
  oai21  g070(.a(new_n61_), .b(new_n70_), .c(new_n114_), .O(z13));
  inv1   g071(.a(x24), .O(new_n116_));
  nand3  g072(.a(x22), .b(x21), .c(x20), .O(new_n117_));
  nand3  g073(.a(x26), .b(x25), .c(x16), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x23), .c(x19), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(x09), .c(new_n119_), .O(new_n120_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n58_), .c(new_n78_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(x10), .c(new_n72_), .O(z14));
  nand2  g082(.a(new_n117_), .b(x09), .O(new_n127_));
  and2   g083(.a(x23), .b(x19), .O(new_n128_));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(x24), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x25), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  nand4  g088(.a(new_n122_), .b(new_n52_), .c(new_n132_), .d(x24), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n131_), .c(x08), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n78_), .c(new_n85_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n74_), .O(z15));
  ...
  nor2   g096(.a(new_n116_), .b(new_n51_), .O(new_n141_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n78_), .c(new_n85_), .O(new_n145_));
  oai21  g101(.a(new_n61_), .b(new_n76_), .c(new_n145_), .O(z16));
endmodule
