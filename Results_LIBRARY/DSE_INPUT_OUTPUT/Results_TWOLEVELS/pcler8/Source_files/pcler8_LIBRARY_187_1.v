...
module FAU ( 
  ...
  oai22  g037(.a(new_n81_), .b(x08), .c(new_n62_), .d(new_n56_), .O(z09));
  ...
  aoi21  g045(.a(new_n89_), .b(new_n47_), .c(x16), .O(new_n90_));
  oai22  g046(.a(new_n90_), .b(x10), .c(new_n62_), .d(new_n60_), .O(z10));
  ...
  aoi21  g053(.a(new_n97_), .b(new_n96_), .c(new_n83_), .O(new_n98_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n47_), .c(x16), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(x10), .c(new_n66_), .O(z12));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(x16), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n116_));
  oai21  g072(.a(new_n62_), .b(new_n68_), .c(new_n116_), .O(z13));
  nand3  g073(.a(x23), .b(x22), .c(x21), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n101_), .c(x24), .O(new_n119_));
  nand3  g075(.a(x21), .b(x20), .c(x19), .O(new_n120_));
  inv1   g076(.a(x24), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x23), .c(x22), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n120_), .c(new_n119_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n49_), .c(new_n48_), .d(x09), .O(new_n124_));
  oai22  g080(.a(new_n124_), .b(x08), .c(new_n62_), .d(new_n70_), .O(z14));
  nor2   g081(.a(new_n113_), .b(new_n46_), .O(new_n126_));
  nand2  g082(.a(x26), .b(x17), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n126_), .c(x24), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n120_), .c(x25), .O(new_n129_));
  inv1   g085(.a(x25), .O(new_n130_));
  inv1   g086(.a(new_n120_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n126_), .c(new_n130_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  ...
  nor2   g093(.a(new_n92_), .b(x18), .O(new_n138_));
  nand3  g094(.a(x25), .b(x21), .c(x20), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n138_), .c(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x26), .O(new_n142_));
  nor2   g098(.a(new_n121_), .b(new_n113_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n130_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n105_), .c(new_n143_), .d(new_n77_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(new_n83_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n47_), .c(x16), .O(new_n147_));
