...
module FAU ( 
  ...
  nand2  g10(.a(new_n54_), .b(x10), .O(new_n55_));
  ...
  aoi21  g15(.a(new_n54_), .b(x10), .c(new_n46_), .O(new_n60_));
  ...
  nand2  g25(.a(new_n60_), .b(x06), .O(new_n70_));
  ...
  nand3  g43(.a(new_n87_), .b(new_n58_), .c(new_n55_), .O(z10));
  ...
  oai21  g77(.a(new_n64_), .b(new_n68_), .c(new_n121_), .O(z14));
  inv1   g78(.a(x25), .O(new_n123_));
  nand2  g79(.a(x09), .b(new_n46_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(new_n123_), .c(new_n47_), .O(new_n125_));
  ...
  oai21  g84(.a(new_n128_), .b(new_n113_), .c(x25), .O(new_n129_));
  nor2   g85(.a(new_n54_), .b(new_n75_), .O(new_n130_));
  nand4  g86(.a(new_n118_), .b(new_n130_), .c(new_n123_), .d(x24), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g88(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n133_));
  nand3  g89(.a(new_n133_), .b(new_n126_), .c(new_n70_), .O(z15));
  ...
  nor2   g94(.a(new_n117_), .b(new_n54_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n123_), .O(new_n140_));
  ...
  oai21  g99(.a(new_n64_), .b(new_n72_), .c(new_n143_), .O(z16));
endmodule
