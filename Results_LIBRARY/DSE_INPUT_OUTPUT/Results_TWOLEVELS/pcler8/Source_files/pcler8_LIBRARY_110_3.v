...
module FAU ( 
  ...
  nor2   g80(.a(new_n46_), .b(new_n51_), .O(new_n125_));
  ...
  nor2   g89(.a(new_n115_), .b(new_n46_), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n124_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n134_), .c(new_n75_), .d(new_n49_), .O(new_n136_));
