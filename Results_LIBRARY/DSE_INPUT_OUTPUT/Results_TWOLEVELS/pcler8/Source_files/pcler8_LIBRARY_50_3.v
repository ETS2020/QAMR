...
module FAU ( 
  ...
  nor2   g14(.a(new_n58_), .b(x10), .O(z01));
  ...
  nand2  g22(.a(new_n66_), .b(new_n45_), .O(z04));
  ...
  nand3  g36(.a(new_n80_), .b(x09), .c(new_n46_), .O(new_n81_));
  aoi21  g37(.a(new_n81_), .b(new_n58_), .c(x10), .O(z09));
  ...
  nand3  g45(.a(new_n89_), .b(new_n60_), .c(new_n45_), .O(z10));
