...
module FAU ( 
  ...
  oai21  g70(.a(new_n70_), .b(new_n69_), .c(new_n114_), .O(z13));
  ...
  nand4  g92(.a(x25), .b(x20), .c(x19), .d(new_n136_), .O(new_n137_));
  aoi21  g93(.a(new_n135_), .b(x09), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g97(.a(new_n138_), .b(new_n134_), .c(new_n141_), .O(new_n142_));
  aoi21  g98(.a(new_n142_), .b(new_n58_), .c(new_n92_), .O(new_n143_));
  oai21  g99(.a(new_n143_), .b(x10), .c(new_n76_), .O(z16));
endmodule
