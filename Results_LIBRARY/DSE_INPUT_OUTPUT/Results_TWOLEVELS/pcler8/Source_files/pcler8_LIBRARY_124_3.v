...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n139_;
  and2   g00(.a(x10), .b(x04), .O(new_n45_));
  ...
  nor2   g24(.a(new_n68_), .b(x10), .O(z05));
  ...
  nand3  g66(.a(new_n110_), .b(x09), .c(new_n47_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n68_), .c(x10), .O(z13));
