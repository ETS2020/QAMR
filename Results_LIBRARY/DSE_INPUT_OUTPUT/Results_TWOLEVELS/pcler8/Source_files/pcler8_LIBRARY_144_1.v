...
module FAU ( 
  ...
  nor2   g11(.a(new_n47_), .b(x00), .O(new_n56_));
  nor2   g12(.a(new_n56_), .b(new_n46_), .O(new_n57_));
  nand2  g13(.a(new_n57_), .b(x01), .O(new_n58_));
  ...
  nand2  g23(.a(new_n67_), .b(new_n60_), .O(z06));
  nand2  g24(.a(new_n57_), .b(x06), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n60_), .O(z07));
  inv1   g26(.a(x07), .O(new_n71_));
  inv1   g27(.a(new_n57_), .O(new_n72_));
  ...
  nand3  g61(.a(new_n105_), .b(new_n63_), .c(new_n60_), .O(z12));
  ...
  nand3  g69(.a(new_n113_), .b(new_n65_), .c(new_n60_), .O(z13));
  ...
  nand3  g79(.a(new_n123_), .b(new_n67_), .c(new_n60_), .O(z14));
  ...
  nor2   g84(.a(new_n110_), .b(new_n75_), .O(new_n129_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n102_), .c(new_n138_), .d(new_n76_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n142_));
  oai21  g98(.a(new_n72_), .b(new_n71_), .c(new_n142_), .O(z16));
endmodule
