...
module FAU ( 
  ...
  aoi21  g074(.a(new_n117_), .b(new_n47_), .c(new_n118_), .O(new_n119_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n46_), .c(x10), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n54_), .c(new_n68_), .O(z14));
  ...
  aoi21  g085(.a(new_n128_), .b(new_n47_), .c(new_n129_), .O(new_n130_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n46_), .c(x10), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n54_), .c(new_n70_), .O(z15));
