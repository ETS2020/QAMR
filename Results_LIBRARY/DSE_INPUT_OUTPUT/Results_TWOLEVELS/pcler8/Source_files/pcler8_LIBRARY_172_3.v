...
module FAU ( 
  ...
  nand3  g43(.a(new_n75_), .b(x09), .c(new_n46_), .O(new_n88_));
  oai21  g44(.a(new_n88_), .b(new_n77_), .c(new_n47_), .O(new_n89_));
  ...
  oai21  g49(.a(new_n92_), .b(new_n73_), .c(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n90_), .c(new_n61_), .O(z11));
  nand2  g52(.a(x23), .b(x14), .O(new_n97_));
  nand3  g53(.a(x26), .b(x25), .c(x24), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n97_), .c(x21), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n91_), .c(x22), .O(new_n100_));
  nand3  g56(.a(new_n92_), .b(new_n74_), .c(x21), .O(new_n101_));
  ...
  nand4  g64(.a(new_n92_), .b(new_n108_), .c(x22), .d(x21), .O(new_n109_));
  ...
  nand4  g83(.a(new_n127_), .b(new_n118_), .c(new_n126_), .d(x24), .O(new_n128_));
  ...
  nand4  g93(.a(new_n137_), .b(new_n92_), .c(new_n136_), .d(new_n75_), .O(new_n138_));
