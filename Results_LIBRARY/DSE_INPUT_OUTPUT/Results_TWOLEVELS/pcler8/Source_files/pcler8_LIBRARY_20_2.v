...
module FAU ( 
  ...
  nor2   g11(.a(new_n53_), .b(new_n55_), .O(z03));
  ...
  oai21  g23(.a(new_n49_), .b(new_n51_), .c(new_n46_), .O(z10));
  oai21  g24(.a(new_n49_), .b(new_n55_), .c(new_n46_), .O(z11));
  nor2   g25(.a(new_n53_), .b(new_n57_), .O(z12));
  nor2   g26(.a(new_n53_), .b(new_n63_), .O(z15));
  oai21  g27(.a(new_n49_), .b(new_n65_), .c(new_n46_), .O(z16));
  nor2   g28(.a(new_n53_), .b(new_n59_), .O(z13));
  nor2   g29(.a(new_n53_), .b(new_n61_), .O(z14));
endmodule
