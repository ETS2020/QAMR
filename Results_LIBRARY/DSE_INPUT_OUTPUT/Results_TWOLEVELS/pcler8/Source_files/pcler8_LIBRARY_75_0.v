...
module FAU ( 
  ...
  nand3  g44(.a(x21), .b(new_n88_), .c(x19), .O(new_n89_));
  ...
  nor2   g49(.a(new_n75_), .b(new_n93_), .O(new_n94_));
  inv1   g50(.a(new_n85_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n94_), .c(x13), .O(new_n96_));
  nand3  g52(.a(new_n96_), .b(x20), .c(x19), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(x21), .c(new_n47_), .d(x09), .O(new_n98_));
  oai22  g54(.a(new_n98_), .b(x08), .c(new_n57_), .d(new_n62_), .O(z11));
  inv1   g55(.a(x19), .O(new_n100_));
  nand2  g56(.a(x23), .b(x14), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n85_), .c(x20), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n100_), .c(x22), .O(new_n103_));
  nand3  g59(.a(new_n93_), .b(x20), .c(x19), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n103_), .c(new_n83_), .O(new_n105_));
  aoi21  g61(.a(new_n105_), .b(new_n46_), .c(new_n82_), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(x10), .c(new_n64_), .O(z12));
  nor2   g63(.a(new_n88_), .b(new_n100_), .O(new_n108_));
  ...
  nand3  g67(.a(new_n108_), .b(new_n75_), .c(x22), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(new_n82_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(new_n66_), .O(z13));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  aoi21  g72(.a(new_n116_), .b(x22), .c(new_n82_), .O(new_n117_));
  nand3  g73(.a(x23), .b(x20), .c(x19), .O(new_n118_));
  oai21  g74(.a(new_n118_), .b(new_n117_), .c(x24), .O(new_n119_));
  nand4  g75(.a(new_n108_), .b(new_n76_), .c(x23), .d(x22), .O(new_n120_));
  ...
  nand2  g90(.a(new_n108_), .b(new_n134_), .O(new_n135_));
  nand3  g91(.a(new_n94_), .b(x25), .c(x24), .O(new_n136_));
