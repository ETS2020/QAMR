...
module FAU ( 
  ...
  oai21  g22(.a(new_n63_), .b(new_n52_), .c(new_n46_), .O(z10));
  oai21  g23(.a(new_n63_), .b(new_n58_), .c(new_n46_), .O(z13));
  nor2   g24(.a(new_n50_), .b(new_n62_), .O(z15));
  oai21  g25(.a(new_n63_), .b(new_n65_), .c(new_n46_), .O(z16));
  nor2   g26(.a(new_n50_), .b(new_n48_), .O(z09));
  nand2  g27(.a(new_n54_), .b(new_n46_), .O(z11));
  nand2  g28(.a(new_n56_), .b(new_n46_), .O(z12));
  nand2  g29(.a(new_n60_), .b(new_n46_), .O(z14));
endmodule
