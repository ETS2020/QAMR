...
module FAU ( 
  ...
  nand3  g84(.a(new_n128_), .b(new_n72_), .c(new_n47_), .O(z15));
  ...
  nand4  g93(.a(new_n137_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n138_));
  nor2   g94(.a(z08), .b(new_n46_), .O(new_n139_));
