...
module FAU ( 
  ...
  nor2   g13(.a(x20), .b(x10), .O(new_n58_));
  ...
  nand4  g40(.a(new_n84_), .b(x20), .c(new_n77_), .d(x09), .O(new_n85_));
  oai22  g41(.a(new_n85_), .b(x08), .c(new_n65_), .d(new_n56_), .O(z09));
  nand2  g42(.a(new_n79_), .b(x12), .O(new_n87_));
  oai21  g43(.a(new_n87_), .b(new_n83_), .c(x19), .O(new_n88_));
  nand4  g44(.a(new_n88_), .b(x20), .c(new_n77_), .d(x09), .O(new_n89_));
  oai22  g45(.a(new_n89_), .b(x08), .c(new_n65_), .d(new_n61_), .O(z10));
  inv1   g46(.a(x20), .O(new_n91_));
  nand3  g47(.a(x23), .b(x22), .c(x13), .O(new_n92_));
  oai21  g48(.a(new_n92_), .b(new_n52_), .c(x19), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(x21), .O(new_n94_));
  nand2  g50(.a(new_n78_), .b(x19), .O(new_n95_));
  aoi21  g51(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n97_));
  oai21  g53(.a(new_n65_), .b(new_n63_), .c(new_n97_), .O(z11));
  ...
  nand3  g58(.a(new_n49_), .b(x21), .c(x19), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n102_), .c(new_n45_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n57_), .c(new_n91_), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(x10), .c(new_n67_), .O(z12));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(new_n48_), .c(x22), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x23), .O(new_n109_));
  nand3  g65(.a(new_n48_), .b(new_n50_), .c(x22), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(new_n45_), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n57_), .c(new_n91_), .O(new_n112_));
  ...
  nand4  g72(.a(new_n48_), .b(new_n81_), .c(x23), .d(x22), .O(new_n117_));
  aoi21  g73(.a(new_n117_), .b(new_n116_), .c(new_n45_), .O(new_n118_));
  aoi21  g74(.a(new_n118_), .b(new_n57_), .c(new_n91_), .O(new_n119_));
  oai22  g75(.a(new_n119_), .b(x10), .c(new_n65_), .d(new_n71_), .O(z14));
  ...
  aoi21  g83(.a(new_n127_), .b(new_n124_), .c(new_n91_), .O(new_n128_));
  nand4  g84(.a(new_n128_), .b(new_n77_), .c(x09), .d(new_n57_), .O(new_n129_));
  oai21  g85(.a(new_n65_), .b(new_n73_), .c(new_n129_), .O(z15));
  nor2   g86(.a(new_n47_), .b(x18), .O(new_n131_));
  aoi21  g87(.a(new_n81_), .b(x20), .c(new_n125_), .O(new_n132_));
  nand3  g88(.a(new_n132_), .b(new_n131_), .c(new_n51_), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(x26), .O(new_n134_));
  nor2   g90(.a(x26), .b(new_n125_), .O(new_n135_));
  nand3  g91(.a(new_n135_), .b(new_n126_), .c(new_n82_), .O(new_n136_));
  aoi21  g92(.a(new_n136_), .b(new_n134_), .c(new_n45_), .O(new_n137_));
  aoi21  g93(.a(new_n137_), .b(new_n57_), .c(new_n91_), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(x10), .c(new_n75_), .O(z16));
endmodule
