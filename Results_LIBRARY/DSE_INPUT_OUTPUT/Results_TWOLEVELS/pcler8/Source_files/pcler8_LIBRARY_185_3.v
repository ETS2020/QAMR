...
module FAU ( 
  ...
  oai21  g77(.a(new_n55_), .b(new_n67_), .c(new_n121_), .O(z14));
  nor2   g78(.a(new_n108_), .b(new_n74_), .O(new_n123_));
  ...
  nand4  g83(.a(new_n118_), .b(new_n123_), .c(new_n127_), .d(x24), .O(new_n128_));
  ...
  nand3  g89(.a(new_n123_), .b(x25), .c(x24), .O(new_n134_));
