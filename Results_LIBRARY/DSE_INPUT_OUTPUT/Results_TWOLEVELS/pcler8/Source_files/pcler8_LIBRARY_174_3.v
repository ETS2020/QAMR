...
module FAU ( 
  ...
  nand2  g013(.a(new_n57_), .b(new_n54_), .O(z01));
  ...
  nor2   g039(.a(x20), .b(new_n83_), .O(new_n84_));
  aoi21  g040(.a(new_n82_), .b(x20), .c(new_n84_), .O(new_n85_));
  oai21  g041(.a(new_n85_), .b(x08), .c(new_n47_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(x09), .O(new_n87_));
  ...
  nand2  g051(.a(new_n95_), .b(new_n61_), .O(z11));
  ...
  nand3  g058(.a(new_n98_), .b(new_n74_), .c(x21), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n63_), .O(z12));
  nand2  g062(.a(new_n97_), .b(new_n47_), .O(new_n107_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n108_), .c(x23), .O(new_n111_));
  inv1   g067(.a(x23), .O(new_n112_));
  nand4  g068(.a(new_n98_), .b(new_n112_), .c(x22), .d(x21), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(x08), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(x10), .c(x09), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n65_), .O(z13));
  nand3  g072(.a(new_n107_), .b(x21), .c(x19), .O(new_n117_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(x23), .d(x22), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n120_), .c(x08), .O(new_n125_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n122_), .c(x25), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nor2   g087(.a(new_n112_), .b(new_n74_), .O(new_n132_));
  nand4  g088(.a(new_n123_), .b(new_n132_), .c(new_n131_), .d(x24), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n130_), .c(x08), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(x10), .c(x09), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n69_), .O(z15));
  ...
  nor2   g096(.a(new_n121_), .b(new_n112_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n98_), .c(new_n141_), .d(new_n75_), .O(new_n143_));
