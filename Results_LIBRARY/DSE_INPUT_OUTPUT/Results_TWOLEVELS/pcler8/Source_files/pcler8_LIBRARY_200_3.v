...
module FAU ( 
  ...
  nand2  g09(.a(x11), .b(x10), .O(new_n54_));
  ...
  nand2  g24(.a(new_n58_), .b(x06), .O(new_n69_));
  ...
  oai22  g33(.a(new_n77_), .b(new_n76_), .c(x19), .d(x10), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(x09), .c(new_n46_), .O(new_n79_));
