...
module FAU ( 
  ...
  oai21  g026(.a(new_n58_), .b(new_n69_), .c(new_n70_), .O(z05));
  ...
  nand2  g032(.a(new_n76_), .b(new_n70_), .O(z08));
  ...
  nand4  g051(.a(new_n95_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n96_));
  oai21  g052(.a(new_n61_), .b(new_n65_), .c(new_n96_), .O(z11));
  ...
  nand4  g060(.a(new_n104_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n105_));
  oai21  g061(.a(new_n61_), .b(new_n67_), .c(new_n105_), .O(z12));
  ...
  nand4  g065(.a(new_n102_), .b(new_n51_), .c(x22), .d(x21), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n112_));
  oai21  g068(.a(new_n61_), .b(new_n69_), .c(new_n112_), .O(z13));
  ...
  nand4  g077(.a(new_n121_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n122_));
  oai21  g078(.a(new_n61_), .b(new_n72_), .c(new_n122_), .O(z14));
  inv1   g079(.a(x09), .O(new_n124_));
  nand3  g080(.a(x22), .b(x21), .c(x20), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x09), .O(new_n126_));
  ...
  nand4  g087(.a(new_n119_), .b(new_n52_), .c(new_n131_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(x08), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n124_), .c(new_n78_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n74_), .O(z15));
  nor2   g091(.a(new_n45_), .b(x18), .O(new_n136_));
  nand3  g092(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n136_), .c(new_n126_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x26), .O(new_n140_));
  nor2   g096(.a(new_n118_), .b(new_n51_), .O(new_n141_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n124_), .c(new_n78_), .O(new_n145_));
