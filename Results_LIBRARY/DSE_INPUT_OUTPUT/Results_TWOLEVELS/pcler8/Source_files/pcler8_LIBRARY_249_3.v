...
module FAU ( 
  ...
  nand4  g010(.a(new_n54_), .b(new_n52_), .c(new_n51_), .d(new_n48_), .O(new_n55_));
  aoi21  g011(.a(new_n55_), .b(new_n46_), .c(new_n45_), .O(z00));
  ...
  nand2  g031(.a(new_n75_), .b(new_n64_), .O(z08));
  ...
  nor2   g041(.a(x20), .b(new_n47_), .O(new_n86_));
  aoi21  g042(.a(new_n85_), .b(x20), .c(new_n86_), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(x08), .c(new_n46_), .O(new_n88_));
  ...
  oai21  g053(.a(x20), .b(x10), .c(x19), .O(new_n98_));
  ...
  nand4  g086(.a(new_n117_), .b(new_n52_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n46_), .c(x09), .d(new_n57_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n73_), .O(z15));
  inv1   g090(.a(x18), .O(new_n135_));
  nand4  g091(.a(x21), .b(x20), .c(x19), .d(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n122_), .b(new_n46_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n52_), .c(x25), .O(new_n138_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n102_), .c(new_n140_), .d(new_n78_), .O(new_n142_));
