...
module FAU ( 
  ...
  inv1   g27(.a(new_n60_), .O(new_n72_));
  nand2  g28(.a(new_n61_), .b(x05), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n72_), .O(z06));
  nand2  g30(.a(x08), .b(x06), .O(new_n75_));
  nand2  g31(.a(new_n75_), .b(new_n72_), .O(z07));
  nand2  g32(.a(x08), .b(x07), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n72_), .O(z08));
  ...
  nand4  g77(.a(new_n121_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n73_), .O(z14));
  aoi21  g79(.a(new_n53_), .b(new_n46_), .c(new_n52_), .O(new_n124_));
  ...
  nand4  g84(.a(new_n119_), .b(new_n54_), .c(new_n128_), .d(x24), .O(new_n129_));
  ...
  nand2  g90(.a(new_n53_), .b(new_n46_), .O(new_n135_));
  ...
  nor2   g94(.a(new_n118_), .b(new_n53_), .O(new_n139_));
