...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x09), .O(new_n54_));
  ...
  nand2  g21(.a(new_n65_), .b(new_n54_), .O(z05));
  inv1   g22(.a(x05), .O(new_n67_));
  oai21  g23(.a(new_n46_), .b(new_n67_), .c(new_n54_), .O(z06));
  ...
  aoi21  g35(.a(new_n79_), .b(new_n46_), .c(x10), .O(new_n80_));
  oai21  g36(.a(new_n80_), .b(new_n73_), .c(new_n57_), .O(z09));
  ...
  nand2  g60(.a(new_n104_), .b(new_n63_), .O(z12));
  aoi21  g61(.a(x21), .b(x20), .c(x10), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(x22), .c(x19), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n106_), .c(x23), .O(new_n109_));
  inv1   g65(.a(x23), .O(new_n110_));
  nand4  g66(.a(new_n101_), .b(new_n110_), .c(x22), .d(x21), .O(new_n111_));
  ...
  oai21  g79(.a(new_n55_), .b(new_n67_), .c(new_n123_), .O(z14));
  and2   g80(.a(x23), .b(x22), .O(new_n125_));
  nand3  g81(.a(x26), .b(x17), .c(new_n47_), .O(new_n126_));
  nand4  g82(.a(new_n126_), .b(new_n120_), .c(new_n125_), .d(x24), .O(new_n127_));
  ...
  nand2  g88(.a(new_n132_), .b(new_n69_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand4  g90(.a(x21), .b(x20), .c(x19), .d(new_n134_), .O(new_n135_));
  nand3  g91(.a(new_n125_), .b(x25), .c(x24), .O(new_n136_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n101_), .c(new_n138_), .d(new_n76_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n142_));
  nand2  g98(.a(new_n142_), .b(new_n71_), .O(z16));
endmodule
