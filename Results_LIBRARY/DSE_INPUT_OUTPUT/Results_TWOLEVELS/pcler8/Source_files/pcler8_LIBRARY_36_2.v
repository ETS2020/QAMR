...
module FAU ( 
  ...
  oai21  g22(.a(new_n66_), .b(new_n48_), .c(new_n46_), .O(z09));
  oai21  g23(.a(new_n66_), .b(new_n52_), .c(new_n46_), .O(z10));
  oai21  g24(.a(new_n66_), .b(new_n54_), .c(new_n46_), .O(z11));
  nand2  g25(.a(new_n56_), .b(new_n46_), .O(z12));
  nand2  g26(.a(new_n58_), .b(new_n46_), .O(z13));
