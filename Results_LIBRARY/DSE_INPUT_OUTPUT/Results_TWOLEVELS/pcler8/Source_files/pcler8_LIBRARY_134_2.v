...
module FAU ( 
  ...
  oai21  g21(.a(new_n49_), .b(new_n65_), .c(new_n46_), .O(z08));
  nor2   g22(.a(new_n53_), .b(new_n48_), .O(z09));
  oai21  g23(.a(new_n49_), .b(new_n55_), .c(new_n46_), .O(z11));
  nor2   g24(.a(new_n53_), .b(new_n57_), .O(z12));
  oai21  g25(.a(new_n49_), .b(new_n61_), .c(new_n46_), .O(z14));
  nor2   g26(.a(new_n53_), .b(new_n65_), .O(z16));
  nor2   g27(.a(new_n53_), .b(new_n51_), .O(z10));
  nor2   g28(.a(new_n53_), .b(new_n59_), .O(z13));
  nor2   g29(.a(new_n53_), .b(new_n63_), .O(z15));
endmodule
