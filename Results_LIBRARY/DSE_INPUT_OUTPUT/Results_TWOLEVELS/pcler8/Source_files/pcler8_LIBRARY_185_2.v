...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n52_, new_n54_, new_n56_,
    new_n58_, new_n59_, new_n60_, new_n61_, new_n63_, new_n65_;
  ...
  nor2   g11(.a(new_n48_), .b(new_n56_), .O(z05));
  inv1   g12(.a(x05), .O(new_n58_));
  inv1   g13(.a(x08), .O(new_n59_));
  inv1   g14(.a(x10), .O(new_n60_));
  nand2  g15(.a(new_n60_), .b(x09), .O(new_n61_));
  oai21  g16(.a(new_n59_), .b(new_n58_), .c(new_n61_), .O(z06));
  inv1   g17(.a(x06), .O(new_n63_));
  oai21  g18(.a(new_n59_), .b(new_n63_), .c(new_n61_), .O(z07));
  inv1   g19(.a(x07), .O(new_n65_));
  oai21  g20(.a(new_n59_), .b(new_n65_), .c(new_n61_), .O(z08));
  oai21  g21(.a(new_n59_), .b(new_n52_), .c(new_n61_), .O(z11));
  oai21  g22(.a(new_n59_), .b(new_n54_), .c(new_n61_), .O(z12));
  nor2   g23(.a(new_n48_), .b(new_n58_), .O(z14));
  ...
  nor2   g29(.a(new_n48_), .b(new_n56_), .O(z13));
endmodule
