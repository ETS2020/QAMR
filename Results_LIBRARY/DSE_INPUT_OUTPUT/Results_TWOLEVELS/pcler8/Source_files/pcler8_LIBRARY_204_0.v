...
module FAU ( 
  ...
  nand4  g07(.a(new_n51_), .b(new_n48_), .c(x19), .d(new_n45_), .O(new_n52_));
  ...
  nand4  g34(.a(new_n78_), .b(new_n56_), .c(x09), .d(new_n45_), .O(new_n79_));
  oai21  g35(.a(new_n58_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  nand2  g42(.a(new_n86_), .b(new_n56_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n60_), .O(z10));
  nand3  g44(.a(x23), .b(x22), .c(x13), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n50_), .c(x20), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n83_), .c(x21), .O(new_n91_));
  nand3  g47(.a(new_n47_), .b(x20), .c(x19), .O(new_n92_));
  aoi21  g48(.a(new_n92_), .b(new_n91_), .c(x08), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n55_), .c(new_n56_), .O(new_n94_));
  oai21  g50(.a(new_n58_), .b(new_n62_), .c(new_n94_), .O(z11));
  nor2   g51(.a(new_n46_), .b(new_n83_), .O(new_n96_));
  inv1   g52(.a(new_n96_), .O(new_n97_));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n50_), .c(x21), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n97_), .c(x22), .O(new_n100_));
  nand3  g56(.a(new_n96_), .b(new_n74_), .c(x21), .O(new_n101_));
  aoi21  g57(.a(new_n101_), .b(new_n100_), .c(x08), .O(new_n102_));
  oai21  g58(.a(new_n102_), .b(new_n55_), .c(new_n56_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n64_), .O(z12));
  nand4  g60(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(x22), .c(x21), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n97_), .c(x23), .O(new_n107_));
  inv1   g63(.a(x23), .O(new_n108_));
  nand4  g64(.a(new_n96_), .b(new_n108_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand4  g66(.a(new_n110_), .b(new_n56_), .c(x09), .d(new_n45_), .O(new_n111_));
  oai21  g67(.a(new_n58_), .b(new_n66_), .c(new_n111_), .O(z13));
  ...
  nand4  g76(.a(new_n120_), .b(new_n56_), .c(x09), .d(new_n45_), .O(new_n121_));
  oai21  g77(.a(new_n58_), .b(new_n68_), .c(new_n121_), .O(z14));
  nand2  g78(.a(new_n49_), .b(x09), .O(new_n123_));
  aoi21  g79(.a(x26), .b(x17), .c(new_n117_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n123_), .c(new_n96_), .d(x21), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(x25), .O(new_n126_));
  inv1   g82(.a(x25), .O(new_n127_));
  inv1   g83(.a(new_n49_), .O(new_n128_));
  nand4  g84(.a(new_n118_), .b(new_n128_), .c(new_n127_), .d(x24), .O(new_n129_));
  aoi21  g85(.a(new_n129_), .b(new_n126_), .c(x08), .O(new_n130_));
  oai21  g86(.a(new_n130_), .b(new_n55_), .c(new_n56_), .O(new_n131_));
  nand2  g87(.a(new_n131_), .b(new_n70_), .O(z15));
  nor2   g88(.a(new_n83_), .b(x18), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n48_), .O(new_n134_));
  nand3  g90(.a(new_n128_), .b(x25), .c(x24), .O(new_n135_));
  oai21  g91(.a(new_n135_), .b(new_n134_), .c(x26), .O(new_n136_));
  nor2   g92(.a(new_n117_), .b(new_n108_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n127_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n96_), .c(new_n137_), .d(new_n75_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n56_), .c(x09), .d(new_n45_), .O(new_n141_));
  oai21  g97(.a(new_n58_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
