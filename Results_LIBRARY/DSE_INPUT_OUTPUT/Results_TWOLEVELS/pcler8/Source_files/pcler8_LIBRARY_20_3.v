...
module FAU ( 
  ...
  nor2   g043(.a(x20), .b(new_n47_), .O(new_n88_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n71_), .O(z13));
  ...
  nand4  g079(.a(new_n123_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n73_), .O(z14));
  nand2  g081(.a(x26), .b(x17), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n54_), .c(x24), .O(new_n127_));
  ...
  nor2   g096(.a(new_n120_), .b(new_n53_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n129_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n104_), .c(new_n141_), .d(new_n80_), .O(new_n143_));
