...
module FAU ( 
  ...
  oai21  g060(.a(new_n60_), .b(new_n64_), .c(new_n104_), .O(z12));
  inv1   g061(.a(x09), .O(new_n106_));
  inv1   g062(.a(x20), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x09), .O(new_n108_));
  ...
  oai21  g071(.a(new_n115_), .b(new_n106_), .c(new_n47_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n66_), .O(z13));
  nand3  g073(.a(new_n108_), .b(x21), .c(x19), .O(new_n118_));
  ...
  aoi21  g081(.a(new_n125_), .b(new_n121_), .c(x08), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n106_), .c(new_n47_), .O(new_n127_));
