...
module FAU ( 
  ...
  nand2  g19(.a(new_n63_), .b(new_n54_), .O(z04));
  ...
  aoi21  g65(.a(new_n109_), .b(new_n107_), .c(x08), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(x10), .c(x09), .O(new_n111_));
  nand2  g67(.a(new_n111_), .b(new_n65_), .O(z13));
  ...
  aoi21  g79(.a(new_n123_), .b(x23), .c(x10), .O(new_n124_));
  nand3  g80(.a(x24), .b(x22), .c(x21), .O(new_n125_));
  inv1   g81(.a(new_n125_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n100_), .O(new_n127_));
  oai21  g83(.a(new_n127_), .b(new_n124_), .c(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nor2   g85(.a(new_n108_), .b(new_n74_), .O(new_n130_));
  nand4  g86(.a(new_n118_), .b(new_n130_), .c(new_n129_), .d(x24), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(x08), .O(new_n132_));
  oai21  g88(.a(new_n132_), .b(x10), .c(x09), .O(new_n133_));
  nand2  g89(.a(new_n133_), .b(new_n69_), .O(z15));
  inv1   g90(.a(x18), .O(new_n135_));
  nand4  g91(.a(x21), .b(x20), .c(x19), .d(new_n135_), .O(new_n136_));
  nand3  g92(.a(new_n130_), .b(x25), .c(x24), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n136_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n117_), .b(new_n108_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n100_), .c(new_n139_), .d(new_n75_), .O(new_n141_));
