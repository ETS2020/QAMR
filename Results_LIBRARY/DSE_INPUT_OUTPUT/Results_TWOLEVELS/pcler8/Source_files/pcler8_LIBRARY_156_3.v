...
module FAU ( 
  ...
  oai21  g023(.a(new_n67_), .b(new_n66_), .c(new_n59_), .O(z03));
  inv1   g024(.a(x03), .O(new_n69_));
  oai21  g025(.a(new_n67_), .b(new_n69_), .c(new_n59_), .O(z04));
  nand2  g026(.a(new_n61_), .b(x04), .O(new_n71_));
  ...
  aoi21  g038(.a(new_n82_), .b(new_n67_), .c(x10), .O(new_n83_));
  oai21  g039(.a(new_n83_), .b(new_n45_), .c(new_n62_), .O(z09));
  ...
  nand4  g052(.a(new_n96_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n97_));
  oai21  g053(.a(new_n60_), .b(new_n66_), .c(new_n97_), .O(z11));
  ...
  nand4  g061(.a(new_n105_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n106_));
  oai21  g062(.a(new_n60_), .b(new_n69_), .c(new_n106_), .O(z12));
  ...
  nand4  g068(.a(new_n112_), .b(new_n46_), .c(x09), .d(new_n67_), .O(new_n113_));
  ...
  aoi21  g074(.a(new_n116_), .b(new_n46_), .c(new_n118_), .O(new_n119_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n67_), .c(x10), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n45_), .c(new_n73_), .O(z14));
  nand2  g081(.a(new_n116_), .b(new_n46_), .O(new_n126_));
  ...
  nand4  g087(.a(new_n121_), .b(new_n54_), .c(new_n131_), .d(x24), .O(new_n132_));
  ...
  nor2   g095(.a(new_n115_), .b(new_n53_), .O(new_n140_));
