...
module FAU ( 
  ...
  nand3  g72(.a(new_n116_), .b(x23), .c(x19), .O(new_n117_));
  aoi21  g73(.a(new_n115_), .b(new_n46_), .c(new_n117_), .O(new_n118_));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n63_), .c(x10), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n45_), .c(new_n73_), .O(z14));
  ...
  nand4  g86(.a(new_n130_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n131_));
  ...
  nor2   g92(.a(new_n114_), .b(new_n53_), .O(new_n137_));
