...
module FAU ( 
  ...
  nand2  g22(.a(new_n66_), .b(new_n65_), .O(z05));
  inv1   g23(.a(x05), .O(new_n68_));
  nor2   g24(.a(new_n57_), .b(new_n68_), .O(z06));
  inv1   g25(.a(x06), .O(new_n70_));
  oai21  g26(.a(new_n46_), .b(new_n70_), .c(new_n65_), .O(z07));
  nand2  g27(.a(new_n56_), .b(x07), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(new_n65_), .O(z08));
  inv1   g29(.a(x19), .O(new_n74_));
  inv1   g30(.a(x09), .O(new_n75_));
  inv1   g31(.a(x11), .O(new_n76_));
  nand2  g32(.a(x21), .b(x20), .O(new_n77_));
  nor4   g33(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(x08), .O(new_n78_));
  ...
  inv1   g65(.a(new_n77_), .O(new_n110_));
  ...
  nand3  g69(.a(new_n110_), .b(new_n80_), .c(x22), .O(new_n114_));
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(new_n75_), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n46_), .c(new_n74_), .O(new_n116_));
  ...
  oai21  g75(.a(new_n119_), .b(new_n77_), .c(x24), .O(new_n120_));
  nand4  g76(.a(new_n110_), .b(new_n86_), .c(x23), .d(x22), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n120_), .c(new_n75_), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n46_), .c(new_n74_), .O(new_n123_));
  oai22  g79(.a(new_n123_), .b(x10), .c(new_n57_), .d(new_n68_), .O(z14));
  ...
  nor2   g85(.a(x25), .b(new_n86_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n129_), .c(x23), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n128_), .c(new_n74_), .O(new_n132_));
  ...
  nand4  g94(.a(new_n129_), .b(new_n87_), .c(new_n45_), .d(x25), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n138_), .c(new_n74_), .O(new_n140_));
