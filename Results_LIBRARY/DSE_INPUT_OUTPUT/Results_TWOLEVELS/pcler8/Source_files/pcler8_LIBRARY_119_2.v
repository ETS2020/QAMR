...
module FAU ( 
  ...
  and2   g020(.a(new_n64_), .b(new_n46_), .O(new_n65_));
  inv1   g021(.a(new_n65_), .O(z03));
  nand2  g022(.a(x08), .b(x03), .O(new_n67_));
  and2   g023(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  inv1   g024(.a(new_n68_), .O(z04));
  nand2  g025(.a(x08), .b(x04), .O(new_n70_));
  nand2  g026(.a(new_n70_), .b(new_n46_), .O(z05));
  inv1   g027(.a(x08), .O(new_n72_));
  aoi21  g028(.a(new_n45_), .b(x10), .c(new_n72_), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(x05), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n46_), .O(z06));
  nand2  g031(.a(new_n73_), .b(x06), .O(new_n76_));
  inv1   g032(.a(new_n76_), .O(z07));
  nand2  g033(.a(new_n73_), .b(x07), .O(new_n78_));
  inv1   g034(.a(new_n78_), .O(z08));
  inv1   g035(.a(x21), .O(new_n80_));
  nor2   g036(.a(new_n53_), .b(new_n80_), .O(new_n81_));
  ...
  nand4  g040(.a(new_n84_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n85_));
  nand3  g041(.a(new_n85_), .b(new_n60_), .c(new_n46_), .O(z09));
  ...
  nand4  g048(.a(new_n92_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n62_), .c(new_n46_), .O(z10));
  inv1   g050(.a(x19), .O(new_n95_));
  nand3  g051(.a(x23), .b(x22), .c(x13), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n56_), .c(x20), .O(new_n97_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n101_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n68_), .O(z12));
  nand4  g065(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x22), .c(x21), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n50_), .c(x23), .O(new_n112_));
  nand4  g068(.a(new_n51_), .b(new_n54_), .c(x22), .d(x21), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n70_), .c(new_n46_), .O(z13));
  ...
  nor2   g077(.a(x24), .b(new_n54_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n121_), .c(x22), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n74_), .O(z14));
  ...
  nand4  g086(.a(new_n121_), .b(new_n55_), .c(new_n130_), .d(x24), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n76_), .c(new_n46_), .O(z15));
  nand3  g090(.a(x25), .b(x24), .c(x23), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n81_), .c(new_n51_), .d(new_n49_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n47_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n72_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n139_), .c(new_n78_), .O(z16));
endmodule
