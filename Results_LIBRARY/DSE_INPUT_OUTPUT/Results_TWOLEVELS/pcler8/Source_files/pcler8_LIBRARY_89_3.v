...
module FAU ( 
  ...
  nand2  g27(.a(new_n71_), .b(new_n61_), .O(z05));
  ...
  nand4  g51(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n96_));
  ...
  aoi21  g60(.a(new_n104_), .b(new_n101_), .c(x08), .O(new_n105_));
  ...
  oai21  g65(.a(new_n109_), .b(new_n102_), .c(x23), .O(new_n110_));
