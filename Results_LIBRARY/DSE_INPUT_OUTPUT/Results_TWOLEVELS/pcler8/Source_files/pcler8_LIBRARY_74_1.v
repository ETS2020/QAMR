...
module FAU ( 
  ...
  oai21  g20(.a(new_n46_), .b(new_n64_), .c(new_n56_), .O(z04));
  ...
  oai21  g26(.a(new_n46_), .b(new_n70_), .c(new_n56_), .O(z07));
  ...
  nand3  g68(.a(new_n112_), .b(new_n66_), .c(new_n56_), .O(z13));
  ...
  oai21  g87(.a(new_n62_), .b(new_n70_), .c(new_n131_), .O(z15));
