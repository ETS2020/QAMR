...
module FAU ( 
  ...
  nand2  g22(.a(new_n61_), .b(x02), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n64_), .O(z03));
  nand2  g24(.a(x08), .b(x03), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n64_), .O(z04));
  ...
  nand2  g31(.a(new_n75_), .b(new_n64_), .O(z07));
  nand2  g32(.a(new_n61_), .b(x07), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n64_), .O(z08));
  ...
  nand4  g38(.a(new_n82_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n83_));
  ...
  nand4  g52(.a(new_n96_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n67_), .O(z11));
  oai21  g54(.a(x20), .b(x10), .c(x19), .O(new_n99_));
  ...
  nor2   g58(.a(new_n49_), .b(new_n47_), .O(new_n103_));
  ...
  nand4  g97(.a(new_n141_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n142_));
