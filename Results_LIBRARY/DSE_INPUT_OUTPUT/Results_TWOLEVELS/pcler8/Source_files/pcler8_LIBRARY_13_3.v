...
module FAU ( 
  ...
  nand2  g09(.a(x22), .b(x10), .O(new_n54_));
  ...
  nand3  g43(.a(new_n87_), .b(new_n59_), .c(new_n54_), .O(z10));
  nand4  g44(.a(x21), .b(x13), .c(x09), .d(new_n46_), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n80_), .c(new_n47_), .O(new_n90_));
  ...
  nor2   g57(.a(x22), .b(new_n73_), .O(new_n102_));
  nand4  g58(.a(new_n102_), .b(x20), .c(x19), .d(new_n47_), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand3  g60(.a(new_n104_), .b(x09), .c(new_n46_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n63_), .c(new_n54_), .O(z12));
  ...
  nand4  g65(.a(new_n93_), .b(new_n77_), .c(x22), .d(x21), .O(new_n110_));
  ...
  nand4  g71(.a(new_n115_), .b(x21), .c(x20), .d(x19), .O(new_n116_));
  aoi22  g72(.a(new_n116_), .b(x22), .c(new_n114_), .d(new_n47_), .O(new_n117_));
  ...
  oai21  g76(.a(new_n117_), .b(new_n78_), .c(new_n120_), .O(new_n121_));
  ...
  nand3  g80(.a(x26), .b(x22), .c(x17), .O(new_n125_));
  nand3  g81(.a(new_n125_), .b(x23), .c(x22), .O(new_n126_));
  nand4  g82(.a(x24), .b(x21), .c(x20), .d(x19), .O(new_n127_));
  aoi22  g83(.a(new_n127_), .b(x22), .c(new_n126_), .d(new_n47_), .O(new_n128_));
  inv1   g84(.a(new_n114_), .O(new_n129_));
  ...
  nand3  g88(.a(new_n132_), .b(new_n69_), .c(new_n54_), .O(z15));
  ...
  nor2   g93(.a(x26), .b(new_n124_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n93_), .c(new_n79_), .d(new_n75_), .O(new_n139_));
