...
module FAU ( 
  ...
  aoi21  g048(.a(new_n92_), .b(new_n91_), .c(x08), .O(new_n93_));
  ...
  nand3  g056(.a(new_n100_), .b(new_n74_), .c(x21), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n63_), .O(z12));
  nand2  g060(.a(new_n73_), .b(new_n47_), .O(new_n105_));
  nand4  g061(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(new_n100_), .d(x22), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x23), .O(new_n108_));
  inv1   g064(.a(x23), .O(new_n109_));
  nand4  g065(.a(new_n100_), .b(new_n109_), .c(x22), .d(x21), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n108_), .c(x08), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(x10), .c(x09), .O(new_n112_));
  ...
  nand4  g084(.a(new_n118_), .b(new_n124_), .c(new_n128_), .d(x24), .O(new_n129_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n47_), .O(new_n135_));
  nand3  g091(.a(x25), .b(x22), .c(x21), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n100_), .d(new_n133_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x26), .O(new_n139_));
  inv1   g095(.a(new_n134_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n128_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n100_), .c(new_n140_), .d(new_n75_), .O(new_n142_));
