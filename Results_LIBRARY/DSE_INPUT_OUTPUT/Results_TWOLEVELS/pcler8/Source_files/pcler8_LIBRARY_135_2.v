...
module FAU ( 
  ...
  nor2   g13(.a(new_n54_), .b(new_n58_), .O(z05));
  inv1   g14(.a(x05), .O(new_n60_));
  nor2   g15(.a(new_n54_), .b(new_n60_), .O(z06));
  inv1   g16(.a(x06), .O(new_n62_));
  nor2   g17(.a(new_n54_), .b(new_n62_), .O(z07));
  nand2  g18(.a(x08), .b(x07), .O(new_n64_));
  nand2  g19(.a(new_n64_), .b(new_n47_), .O(z08));
  inv1   g20(.a(x08), .O(new_n66_));
  oai21  g21(.a(new_n66_), .b(new_n52_), .c(new_n47_), .O(z11));
  oai21  g22(.a(new_n66_), .b(new_n62_), .c(new_n47_), .O(z15));
  zero   g23(.O(z00));
  nand2  g24(.a(new_n48_), .b(new_n47_), .O(z09));
  nand2  g25(.a(new_n50_), .b(new_n47_), .O(z10));
  nand2  g26(.a(new_n56_), .b(new_n47_), .O(z12));
  nor2   g27(.a(new_n54_), .b(new_n58_), .O(z13));
  nor2   g28(.a(new_n54_), .b(new_n60_), .O(z14));
  nand2  g29(.a(new_n64_), .b(new_n47_), .O(z16));
endmodule
