...
module FAU ( 
  ...
  aoi21  g14(.a(new_n45_), .b(x01), .c(new_n47_), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(x00), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(z01));
  nand3  g17(.a(x09), .b(x08), .c(x01), .O(new_n62_));
  ...
  inv1   g26(.a(new_n59_), .O(new_n71_));
  nor2   g27(.a(new_n71_), .b(new_n70_), .O(z06));
  nand2  g28(.a(new_n59_), .b(x06), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n46_), .O(z07));
  ...
  nand3  g38(.a(new_n82_), .b(new_n60_), .c(new_n46_), .O(z09));
  oai21  g39(.a(new_n45_), .b(x08), .c(x01), .O(new_n84_));
  nand3  g40(.a(x22), .b(x21), .c(x12), .O(new_n85_));
  oai21  g41(.a(new_n85_), .b(new_n80_), .c(x19), .O(new_n86_));
  ...
  nand4  g46(.a(new_n90_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n91_));
  nand2  g47(.a(new_n91_), .b(new_n84_), .O(z10));
  inv1   g48(.a(x19), .O(new_n93_));
  nand3  g49(.a(x23), .b(x22), .c(x13), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n55_), .c(x20), .O(new_n95_));
  ...
  nand3  g55(.a(new_n99_), .b(new_n64_), .c(new_n46_), .O(z11));
  ...
  nand2  g62(.a(new_n106_), .b(new_n66_), .O(z12));
  ...
  oai21  g79(.a(new_n71_), .b(new_n70_), .c(new_n123_), .O(z14));
  ...
  nand2  g87(.a(new_n131_), .b(new_n73_), .O(z15));
