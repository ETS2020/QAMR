...
module FAU ( 
  ...
  nor2   g041(.a(x20), .b(new_n85_), .O(new_n86_));
  aoi21  g042(.a(new_n84_), .b(x20), .c(new_n86_), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(x08), .c(x09), .O(new_n88_));
  nand2  g044(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  oai21  g045(.a(new_n57_), .b(new_n59_), .c(new_n89_), .O(z10));
  ...
  oai21  g049(.a(new_n93_), .b(new_n85_), .c(x21), .O(new_n94_));
  nand3  g050(.a(new_n75_), .b(x20), .c(x19), .O(new_n95_));
  aoi21  g051(.a(new_n95_), .b(new_n94_), .c(x08), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n74_), .c(new_n47_), .O(new_n97_));
  ...
  oai21  g070(.a(new_n57_), .b(new_n66_), .c(new_n114_), .O(z13));
  ...
  oai21  g080(.a(new_n57_), .b(new_n68_), .c(new_n124_), .O(z14));
  inv1   g081(.a(x25), .O(new_n126_));
  nand2  g082(.a(x26), .b(x17), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(x23), .c(x22), .d(x21), .O(new_n128_));
  nand3  g084(.a(x24), .b(x20), .c(x19), .O(new_n129_));
  aoi21  g085(.a(new_n128_), .b(x09), .c(new_n129_), .O(new_n130_));
  nor2   g086(.a(new_n111_), .b(new_n76_), .O(new_n131_));
  nand4  g087(.a(new_n121_), .b(new_n131_), .c(new_n126_), .d(x24), .O(new_n132_));
  oai21  g088(.a(new_n130_), .b(new_n126_), .c(new_n132_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n46_), .c(new_n74_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(x10), .c(new_n70_), .O(z15));
  ...
  nor2   g096(.a(x26), .b(new_n126_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n103_), .c(new_n140_), .d(new_n77_), .O(new_n142_));
