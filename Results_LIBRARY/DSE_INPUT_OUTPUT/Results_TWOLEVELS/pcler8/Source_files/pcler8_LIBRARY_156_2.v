...
module FAU ( 
  ...
  oai21  g23(.a(new_n55_), .b(new_n52_), .c(new_n46_), .O(z10));
  nor2   g24(.a(new_n50_), .b(new_n54_), .O(z11));
  nor2   g25(.a(new_n50_), .b(new_n57_), .O(z12));
  oai21  g26(.a(new_n55_), .b(new_n61_), .c(new_n46_), .O(z14));
  oai21  g27(.a(new_n55_), .b(new_n63_), .c(new_n46_), .O(z15));
  oai21  g28(.a(new_n55_), .b(new_n65_), .c(new_n46_), .O(z16));
