...
module FAU ( 
  ...
  nor2   g01(.a(x09), .b(new_n45_), .O(new_n46_));
  ...
  aoi21  g20(.a(x09), .b(new_n48_), .c(new_n45_), .O(z03));
  ...
  nand2  g25(.a(new_n62_), .b(x05), .O(new_n70_));
  ...
  nand3  g37(.a(new_n81_), .b(new_n60_), .c(new_n47_), .O(z09));
  ...
  nand2  g54(.a(new_n98_), .b(new_n91_), .O(z11));
  ...
  nand3  g86(.a(new_n130_), .b(new_n72_), .c(new_n47_), .O(z15));
  ...
  nand4  g95(.a(new_n139_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n140_));
