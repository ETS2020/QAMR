...
module FAU ( 
  ...
  nand4  g74(.a(new_n118_), .b(new_n55_), .c(x23), .d(x22), .O(new_n119_));
  ...
  nand2  g78(.a(x25), .b(x09), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(x08), .c(new_n47_), .O(new_n124_));
  ...
  nand3  g89(.a(new_n133_), .b(new_n125_), .c(new_n70_), .O(z15));
  ...
  oai21  g99(.a(new_n66_), .b(new_n72_), .c(new_n143_), .O(z16));
endmodule
