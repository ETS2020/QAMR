...
module FAU ( 
  ...
  nand4  g035(.a(new_n79_), .b(x14), .c(new_n48_), .d(x09), .O(new_n80_));
  oai22  g036(.a(new_n80_), .b(x08), .c(new_n61_), .d(new_n55_), .O(z09));
  ...
  oai21  g045(.a(new_n61_), .b(new_n59_), .c(new_n89_), .O(z10));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n47_), .c(new_n82_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(x10), .c(new_n63_), .O(z11));
  inv1   g056(.a(x23), .O(new_n101_));
  oai21  g057(.a(new_n94_), .b(new_n101_), .c(x22), .O(new_n102_));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(new_n82_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n107_));
  oai21  g063(.a(new_n61_), .b(new_n65_), .c(new_n107_), .O(z12));
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n82_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n116_));
  oai21  g072(.a(new_n61_), .b(new_n67_), .c(new_n116_), .O(z13));
  nand3  g073(.a(x26), .b(x25), .c(x16), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x23), .c(x22), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n104_), .c(x24), .O(new_n120_));
  inv1   g076(.a(x24), .O(new_n121_));
  inv1   g077(.a(new_n104_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n121_), .c(x23), .d(x22), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(new_n82_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n125_));
  oai21  g081(.a(new_n61_), .b(new_n69_), .c(new_n125_), .O(z14));
  inv1   g082(.a(x25), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x23), .c(x22), .O(new_n128_));
  nand3  g084(.a(x26), .b(x25), .c(x17), .O(new_n129_));
  oai21  g085(.a(new_n128_), .b(new_n104_), .c(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x24), .O(new_n131_));
  nor2   g087(.a(new_n121_), .b(new_n101_), .O(new_n132_));
  nand3  g088(.a(new_n122_), .b(new_n132_), .c(x22), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x25), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(new_n82_), .O(new_n135_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n113_), .c(new_n132_), .d(new_n76_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n141_), .c(new_n82_), .O(new_n144_));
