...
module FAU ( 
  ...
  nand2  g11(.a(new_n56_), .b(new_n51_), .O(z04));
  ...
  oai21  g21(.a(new_n65_), .b(new_n46_), .c(new_n51_), .O(z09));
  oai21  g22(.a(new_n65_), .b(new_n62_), .c(new_n51_), .O(z15));
  nor2   g23(.a(new_n48_), .b(new_n64_), .O(z16));
  zero   g24(.O(z00));
  nand2  g25(.a(new_n52_), .b(new_n51_), .O(z10));
  nor2   g26(.a(new_n48_), .b(new_n54_), .O(z11));
  nand2  g27(.a(new_n56_), .b(new_n51_), .O(z12));
  nor2   g28(.a(new_n48_), .b(new_n58_), .O(z13));
  nand2  g29(.a(new_n60_), .b(new_n51_), .O(z14));
endmodule
