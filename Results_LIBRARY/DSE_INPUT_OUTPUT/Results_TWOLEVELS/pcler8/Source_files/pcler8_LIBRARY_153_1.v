...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n63_, new_n65_, new_n67_, new_n69_, new_n71_, new_n73_,
  ...
  aoi21  g14(.a(x10), .b(new_n45_), .c(new_n47_), .O(new_n59_));
  nand2  g15(.a(new_n59_), .b(x00), .O(new_n60_));
  inv1   g16(.a(new_n60_), .O(z01));
  nor2   g17(.a(new_n47_), .b(new_n45_), .O(z02));
  nand2  g18(.a(new_n59_), .b(x02), .O(new_n63_));
  inv1   g19(.a(new_n63_), .O(z03));
  nand2  g20(.a(new_n59_), .b(x03), .O(new_n65_));
  ...
  nand3  g36(.a(new_n80_), .b(new_n60_), .c(new_n46_), .O(z09));
  ...
  nand2  g45(.a(new_n89_), .b(new_n82_), .O(z10));
  ...
  nand3  g50(.a(new_n75_), .b(x20), .c(x19), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand4  g52(.a(new_n96_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(new_n63_), .c(new_n46_), .O(z11));
  ...
  nand3  g60(.a(new_n104_), .b(new_n65_), .c(new_n46_), .O(z12));
  ...
  nand4  g66(.a(new_n110_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n111_));
  ...
  nand4  g76(.a(new_n120_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n121_));
  ...
  nand4  g84(.a(new_n128_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n129_));
  nand3  g85(.a(new_n129_), .b(new_n71_), .c(new_n46_), .O(z15));
