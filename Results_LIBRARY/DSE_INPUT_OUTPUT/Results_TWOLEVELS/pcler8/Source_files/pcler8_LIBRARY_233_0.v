...
module FAU ( 
  ...
  oai22  g036(.a(new_n80_), .b(new_n63_), .c(new_n61_), .d(new_n55_), .O(z09));
  inv1   g037(.a(x09), .O(new_n82_));
  nand4  g038(.a(x22), .b(x21), .c(x12), .d(x02), .O(new_n83_));
  ...
  nand3  g053(.a(new_n97_), .b(new_n48_), .c(x09), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n47_), .c(new_n63_), .O(z11));
  nand2  g055(.a(x23), .b(x14), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n93_), .c(x20), .O(new_n101_));
  nand2  g057(.a(x21), .b(x19), .O(new_n102_));
  aoi21  g058(.a(new_n101_), .b(x02), .c(new_n102_), .O(new_n103_));
  nor2   g059(.a(new_n86_), .b(new_n91_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n46_), .c(x21), .O(new_n105_));
  oai21  g061(.a(new_n103_), .b(new_n46_), .c(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x09), .c(new_n47_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x02), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n48_), .O(new_n109_));
  ...
  aoi21  g072(.a(new_n116_), .b(new_n114_), .c(x10), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(x09), .c(new_n47_), .d(x02), .O(new_n118_));
  oai21  g074(.a(new_n61_), .b(new_n67_), .c(new_n118_), .O(z13));
  ...
  nand4  g088(.a(x24), .b(x21), .c(x20), .d(x19), .O(new_n133_));
  aoi21  g089(.a(new_n132_), .b(x02), .c(new_n133_), .O(new_n134_));
  nor2   g090(.a(new_n115_), .b(new_n46_), .O(new_n135_));
  nand4  g091(.a(new_n125_), .b(new_n135_), .c(new_n130_), .d(x24), .O(new_n136_));
  oai21  g092(.a(new_n134_), .b(new_n130_), .c(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(x09), .c(new_n47_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x02), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n48_), .O(new_n140_));
  ...
  nor2   g102(.a(x26), .b(new_n130_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n104_), .c(new_n146_), .d(new_n76_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n145_), .c(x10), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(x09), .c(new_n47_), .d(x02), .O(new_n150_));
  oai21  g106(.a(new_n61_), .b(new_n73_), .c(new_n150_), .O(z16));
endmodule
