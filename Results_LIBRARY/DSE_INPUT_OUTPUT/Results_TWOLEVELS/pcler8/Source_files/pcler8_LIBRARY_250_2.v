...
module FAU ( 
  ...
  oai21  g17(.a(new_n57_), .b(new_n61_), .c(new_n46_), .O(z06));
  inv1   g18(.a(x06), .O(new_n63_));
  nor2   g19(.a(new_n50_), .b(new_n63_), .O(z07));
  inv1   g20(.a(x07), .O(new_n65_));
  oai21  g21(.a(new_n57_), .b(new_n65_), .c(new_n46_), .O(z08));
  oai21  g22(.a(new_n57_), .b(new_n48_), .c(new_n46_), .O(z09));
  oai21  g23(.a(new_n57_), .b(new_n52_), .c(new_n46_), .O(z10));
  oai21  g24(.a(new_n57_), .b(new_n54_), .c(new_n46_), .O(z11));
  nor2   g25(.a(new_n50_), .b(new_n56_), .O(z12));
  nor2   g26(.a(new_n50_), .b(new_n61_), .O(z14));
  nor2   g27(.a(new_n50_), .b(new_n65_), .O(z16));
  nand2  g28(.a(new_n59_), .b(new_n46_), .O(z13));
  nor2   g29(.a(new_n50_), .b(new_n63_), .O(z15));
endmodule
