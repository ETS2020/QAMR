...
module FAU ( 
  ...
  nand2  g009(.a(x19), .b(x10), .O(new_n54_));
  ...
  nand2  g032(.a(new_n76_), .b(new_n57_), .O(z09));
  ...
  oai21  g048(.a(new_n55_), .b(new_n61_), .c(new_n92_), .O(z11));
  inv1   g049(.a(x22), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(x21), .c(x20), .O(new_n95_));
  nand3  g051(.a(x23), .b(x22), .c(x14), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n86_), .c(new_n95_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x19), .O(new_n98_));
  nand2  g054(.a(x21), .b(x20), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(x19), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x22), .c(new_n47_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x09), .c(new_n46_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n63_), .c(new_n54_), .O(z12));
  inv1   g061(.a(new_n86_), .O(new_n106_));
  nor2   g062(.a(x23), .b(new_n94_), .O(new_n107_));
  and2   g063(.a(x23), .b(x15), .O(new_n108_));
  aoi22  g064(.a(new_n108_), .b(new_n106_), .c(new_n107_), .d(new_n100_), .O(new_n109_));
  nand4  g065(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x23), .O(new_n111_));
  oai21  g067(.a(new_n109_), .b(new_n78_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n65_), .O(z13));
  inv1   g070(.a(x24), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x23), .c(x22), .O(new_n116_));
  nand4  g072(.a(x26), .b(x25), .c(x24), .d(x16), .O(new_n117_));
  oai21  g073(.a(new_n116_), .b(new_n99_), .c(new_n117_), .O(new_n118_));
  ...
  and2   g087(.a(x24), .b(x23), .O(new_n132_));
  ...
  nand3  g094(.a(new_n100_), .b(x19), .c(new_n138_), .O(new_n139_));
  nand4  g095(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(x26), .O(new_n141_));
  inv1   g097(.a(new_n110_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n132_), .c(new_n45_), .d(x25), .O(new_n143_));
