...
module FAU ( 
  ...
  nor2   g010(.a(x10), .b(x04), .O(new_n55_));
  ...
  aoi21  g032(.a(new_n76_), .b(x04), .c(x10), .O(new_n77_));
  or2    g033(.a(new_n77_), .b(z01), .O(z09));
  inv1   g034(.a(new_n56_), .O(new_n79_));
  ...
  nand4  g041(.a(new_n85_), .b(x09), .c(new_n47_), .d(x04), .O(new_n86_));
  oai21  g042(.a(new_n79_), .b(new_n58_), .c(new_n86_), .O(z10));
  ...
  nand4  g051(.a(new_n95_), .b(x09), .c(new_n47_), .d(x04), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n61_), .O(z11));
  nor2   g053(.a(new_n83_), .b(new_n88_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n98_), .b(new_n46_), .c(x21), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(x10), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(x09), .c(new_n47_), .d(x04), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n63_), .O(z12));
  inv1   g062(.a(x04), .O(new_n107_));
  ...
  aoi21  g067(.a(new_n110_), .b(x04), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n98_), .b(new_n108_), .c(x22), .d(x21), .O(new_n113_));
  oai21  g069(.a(new_n112_), .b(new_n108_), .c(new_n113_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(x09), .c(new_n107_), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(x10), .c(new_n65_), .O(z13));
  ...
  nand4  g080(.a(new_n124_), .b(x09), .c(new_n47_), .d(x04), .O(new_n125_));
  ...
  nand4  g089(.a(new_n133_), .b(x09), .c(new_n47_), .d(x04), .O(new_n134_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n98_), .c(new_n141_), .d(new_n140_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n139_), .c(x10), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(x09), .c(new_n47_), .d(x04), .O(new_n145_));
