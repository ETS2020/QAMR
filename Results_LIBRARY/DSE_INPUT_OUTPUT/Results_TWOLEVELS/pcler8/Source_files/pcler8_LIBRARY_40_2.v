...
module FAU ( 
  ...
  oai21  g14(.a(new_n55_), .b(new_n59_), .c(new_n47_), .O(z05));
  ...
  nor2   g21(.a(new_n52_), .b(new_n54_), .O(z11));
  oai21  g22(.a(new_n55_), .b(new_n57_), .c(new_n47_), .O(z12));
  nor2   g23(.a(new_n52_), .b(new_n59_), .O(z13));
  nor2   g24(.a(new_n52_), .b(new_n63_), .O(z15));
  zero   g25(.O(z00));
  nand2  g26(.a(new_n48_), .b(new_n47_), .O(z09));
  nor2   g27(.a(new_n52_), .b(new_n50_), .O(z10));
  nor2   g28(.a(new_n52_), .b(new_n61_), .O(z14));
