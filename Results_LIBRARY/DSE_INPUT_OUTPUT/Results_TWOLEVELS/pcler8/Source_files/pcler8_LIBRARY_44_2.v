...
module FAU ( 
  ...
  inv1   g025(.a(new_n64_), .O(new_n70_));
  nor2   g026(.a(new_n70_), .b(new_n69_), .O(z05));
  nand2  g027(.a(new_n64_), .b(x05), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n58_), .O(z06));
  nand2  g029(.a(new_n64_), .b(x06), .O(new_n74_));
  ...
  nand3  g039(.a(new_n83_), .b(x09), .c(new_n63_), .O(new_n84_));
  ...
  aoi21  g049(.a(new_n93_), .b(new_n63_), .c(x07), .O(new_n94_));
  ...
  aoi21  g057(.a(new_n101_), .b(new_n63_), .c(x07), .O(new_n102_));
  ...
  nand4  g066(.a(new_n110_), .b(x09), .c(new_n63_), .d(new_n45_), .O(new_n111_));
  ...
  nand4  g073(.a(new_n117_), .b(x09), .c(new_n63_), .d(new_n45_), .O(new_n118_));
  oai21  g074(.a(new_n70_), .b(new_n69_), .c(new_n118_), .O(z13));
  ...
  nand4  g081(.a(new_n125_), .b(x09), .c(new_n63_), .d(new_n45_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n72_), .O(z14));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n63_), .c(x07), .O(new_n136_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n108_), .c(new_n142_), .d(new_n80_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n141_), .c(x10), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x09), .c(new_n63_), .d(new_n45_), .O(new_n146_));
  nand3  g102(.a(x10), .b(x08), .c(x07), .O(new_n147_));
