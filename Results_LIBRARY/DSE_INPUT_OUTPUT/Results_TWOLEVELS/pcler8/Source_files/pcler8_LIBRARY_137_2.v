...
module FAU ( 
  ...
  nor2   g015(.a(new_n56_), .b(new_n48_), .O(new_n60_));
  ...
  aoi21  g028(.a(x10), .b(new_n48_), .c(new_n47_), .O(z08));
  ...
  aoi21  g045(.a(new_n89_), .b(new_n48_), .c(x07), .O(new_n90_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n48_), .c(x07), .O(new_n99_));
  ...
  aoi21  g063(.a(new_n107_), .b(new_n48_), .c(x07), .O(new_n108_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n48_), .c(x07), .O(new_n116_));
  ...
  inv1   g092(.a(z08), .O(new_n137_));
  nor2   g093(.a(new_n122_), .b(new_n113_), .O(new_n138_));
  nor2   g094(.a(new_n138_), .b(x07), .O(new_n139_));
  nor2   g095(.a(new_n101_), .b(x18), .O(new_n140_));
  nor2   g096(.a(new_n132_), .b(new_n46_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n140_), .c(x21), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n139_), .c(x26), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n132_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n105_), .c(new_n138_), .d(new_n75_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n49_), .c(x09), .d(new_n48_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n137_), .O(z16));
endmodule
