...
module FAU ( 
  ...
  oai21  g21(.a(new_n52_), .b(new_n65_), .c(new_n48_), .O(z08));
  ...
  nand2  g52(.a(new_n96_), .b(new_n67_), .O(new_n97_));
  nand2  g53(.a(new_n97_), .b(new_n61_), .O(z14));
  nand4  g54(.a(new_n91_), .b(x25), .c(new_n45_), .d(new_n67_), .O(new_n99_));
  oai21  g55(.a(new_n49_), .b(new_n63_), .c(new_n99_), .O(z15));
  nand4  g56(.a(new_n91_), .b(x26), .c(new_n45_), .d(new_n67_), .O(new_n101_));
