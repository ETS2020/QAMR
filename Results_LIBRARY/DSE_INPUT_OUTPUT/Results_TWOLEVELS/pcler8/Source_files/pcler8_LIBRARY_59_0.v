...
module FAU ( 
  ...
  nand4  g34(.a(new_n78_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n79_));
  nand2  g35(.a(x08), .b(x00), .O(new_n80_));
  aoi21  g36(.a(new_n80_), .b(new_n79_), .c(new_n45_), .O(z09));
  ...
  nand4  g49(.a(new_n93_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n94_));
  nand3  g50(.a(new_n94_), .b(new_n63_), .c(new_n46_), .O(z11));
  ...
  nand3  g57(.a(new_n101_), .b(new_n65_), .c(new_n46_), .O(z12));
  ...
  nand4  g61(.a(new_n50_), .b(new_n53_), .c(x22), .d(x21), .O(new_n106_));
  ...
  nand4  g72(.a(new_n116_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n117_));
  nand3  g73(.a(new_n117_), .b(new_n69_), .c(new_n46_), .O(z14));
  nand3  g74(.a(x24), .b(x23), .c(x22), .O(new_n119_));
  oai21  g75(.a(new_n119_), .b(new_n110_), .c(x25), .O(new_n120_));
  inv1   g76(.a(x25), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(x24), .c(x23), .d(x22), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(new_n110_), .c(new_n120_), .O(new_n123_));
  ...
  nand2  g82(.a(new_n126_), .b(new_n46_), .O(new_n127_));
  nand3  g83(.a(x26), .b(x25), .c(x17), .O(new_n128_));
  inv1   g84(.a(new_n128_), .O(new_n129_));
  nand4  g85(.a(new_n129_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n127_), .O(z15));
  ...
  nor2   g91(.a(new_n114_), .b(new_n53_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n121_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n136_), .c(new_n75_), .d(new_n50_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n140_));
  nand3  g96(.a(new_n140_), .b(new_n72_), .c(new_n46_), .O(z16));
endmodule
