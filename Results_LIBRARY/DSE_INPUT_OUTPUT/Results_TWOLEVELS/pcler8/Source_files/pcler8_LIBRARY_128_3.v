...
module FAU ( 
  ...
  nand3  g57(.a(new_n97_), .b(new_n75_), .c(x21), .O(new_n102_));
  ...
  oai21  g63(.a(new_n107_), .b(new_n98_), .c(x23), .O(new_n108_));
  inv1   g64(.a(x23), .O(new_n109_));
  nand4  g65(.a(new_n97_), .b(new_n109_), .c(x22), .d(x21), .O(new_n110_));
  ...
  aoi21  g70(.a(new_n114_), .b(x22), .c(x10), .O(new_n115_));
  nand4  g71(.a(x23), .b(x21), .c(x20), .d(x19), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n115_), .c(x24), .O(new_n117_));
  nand3  g73(.a(x21), .b(x20), .c(x19), .O(new_n118_));
  inv1   g74(.a(new_n118_), .O(new_n119_));
  nor2   g75(.a(x24), .b(new_n109_), .O(new_n120_));
  nand3  g76(.a(new_n120_), .b(new_n119_), .c(x22), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n117_), .c(x08), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(x10), .c(x09), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n67_), .O(z14));
  nand2  g80(.a(x26), .b(x17), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(x22), .c(x10), .O(new_n126_));
  and2   g82(.a(x24), .b(x23), .O(new_n127_));
  nand3  g83(.a(new_n97_), .b(new_n127_), .c(x21), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n126_), .c(x25), .O(new_n129_));
  inv1   g85(.a(x25), .O(new_n130_));
  nor2   g86(.a(new_n109_), .b(new_n75_), .O(new_n131_));
  nand4  g87(.a(new_n119_), .b(new_n131_), .c(new_n130_), .d(x24), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n129_), .c(x08), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(x10), .c(x09), .O(new_n134_));
  nand2  g90(.a(new_n134_), .b(new_n69_), .O(z15));
  ...
  nand4  g96(.a(new_n140_), .b(new_n97_), .c(new_n127_), .d(new_n76_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n139_), .c(x08), .O(new_n142_));
