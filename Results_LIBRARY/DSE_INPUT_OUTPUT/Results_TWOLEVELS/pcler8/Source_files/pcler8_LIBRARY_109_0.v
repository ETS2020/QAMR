...
module FAU ( 
  ...
  oai21  g022(.a(new_n46_), .b(new_n65_), .c(new_n66_), .O(z05));
  nand2  g023(.a(x08), .b(x05), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n66_), .O(z06));
  inv1   g025(.a(x06), .O(new_n70_));
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n66_), .O(z07));
  ...
  aoi21  g071(.a(new_n115_), .b(x22), .c(new_n89_), .O(new_n116_));
  ...
  oai21  g089(.a(new_n57_), .b(new_n70_), .c(new_n133_), .O(z15));
  inv1   g090(.a(x18), .O(new_n135_));
  nand4  g091(.a(x21), .b(x20), .c(x19), .d(new_n135_), .O(new_n136_));
  nand2  g092(.a(new_n119_), .b(x09), .O(new_n137_));
