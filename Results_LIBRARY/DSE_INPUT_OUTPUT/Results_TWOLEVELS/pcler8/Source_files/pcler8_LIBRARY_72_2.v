...
module FAU ( 
  ...
  aoi21  g16(.a(new_n45_), .b(x10), .c(new_n47_), .O(new_n61_));
  ...
  nand2  g21(.a(new_n61_), .b(x03), .O(new_n66_));
  ...
  nand2  g27(.a(new_n61_), .b(x06), .O(new_n72_));
  nand2  g28(.a(new_n72_), .b(new_n46_), .O(z07));
  nand2  g29(.a(new_n61_), .b(x07), .O(new_n74_));
  nand2  g30(.a(new_n74_), .b(new_n46_), .O(z08));
  nand4  g31(.a(x21), .b(x20), .c(x11), .d(new_n48_), .O(new_n76_));
  nand2  g32(.a(new_n56_), .b(new_n54_), .O(new_n77_));
  oai21  g33(.a(new_n77_), .b(new_n76_), .c(x19), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(x09), .c(new_n47_), .O(new_n79_));
  nand3  g35(.a(new_n79_), .b(new_n59_), .c(new_n46_), .O(z09));
  nand4  g36(.a(x22), .b(x21), .c(x20), .d(x12), .O(new_n81_));
  nand4  g37(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n82_));
  oai22  g38(.a(new_n82_), .b(new_n81_), .c(x20), .d(new_n45_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n48_), .O(new_n84_));
  nand2  g40(.a(x20), .b(new_n45_), .O(new_n85_));
  nand2  g41(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand3  g42(.a(new_n86_), .b(x09), .c(new_n47_), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n62_), .c(new_n46_), .O(z10));
  nand3  g44(.a(x23), .b(x22), .c(x13), .O(new_n89_));
  oai21  g45(.a(new_n89_), .b(new_n55_), .c(x20), .O(new_n90_));
  ...
  nand4  g50(.a(new_n94_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n64_), .O(z11));
  nand2  g52(.a(x23), .b(x14), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n55_), .c(x21), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n49_), .c(x22), .O(new_n99_));
  nand3  g55(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n100_));
  nand2  g56(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g57(.a(new_n101_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n66_), .O(z12));
  nand2  g59(.a(x23), .b(x09), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(x08), .c(new_n48_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n45_), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(x22), .c(x21), .d(x20), .O(new_n108_));
  ...
  nand3  g68(.a(new_n112_), .b(new_n106_), .c(new_n68_), .O(z13));
  ...
  nand2  g78(.a(new_n122_), .b(new_n70_), .O(z14));
  ...
  nor2   g91(.a(new_n52_), .b(new_n92_), .O(new_n136_));
  nor2   g92(.a(new_n118_), .b(new_n53_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n127_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n50_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n141_));
