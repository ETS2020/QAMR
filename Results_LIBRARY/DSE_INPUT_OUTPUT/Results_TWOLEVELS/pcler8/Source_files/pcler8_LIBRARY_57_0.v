...
module FAU ( 
  ...
  oai21  g11(.a(x10), .b(x09), .c(new_n55_), .O(z01));
  ...
  nor2   g26(.a(new_n66_), .b(new_n70_), .O(z06));
  ...
  aoi21  g36(.a(new_n80_), .b(new_n57_), .c(new_n58_), .O(new_n81_));
  oai21  g37(.a(new_n81_), .b(x10), .c(new_n55_), .O(z09));
  nand3  g38(.a(x22), .b(x21), .c(x12), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n79_), .c(x19), .O(new_n84_));
  nor2   g40(.a(x20), .b(new_n45_), .O(new_n85_));
  aoi21  g41(.a(new_n84_), .b(x20), .c(new_n85_), .O(new_n86_));
  oai21  g42(.a(new_n86_), .b(x08), .c(x09), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  nand2  g44(.a(new_n88_), .b(new_n61_), .O(z10));
  nand3  g45(.a(x23), .b(x22), .c(x13), .O(new_n90_));
  oai21  g46(.a(new_n90_), .b(new_n51_), .c(x20), .O(new_n91_));
  oai21  g47(.a(new_n91_), .b(new_n45_), .c(x21), .O(new_n92_));
  nand3  g48(.a(new_n76_), .b(x20), .c(x19), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n92_), .c(x08), .O(new_n94_));
  oai21  g50(.a(new_n94_), .b(new_n58_), .c(new_n59_), .O(new_n95_));
  ...
  oai21  g55(.a(new_n99_), .b(new_n51_), .c(x21), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n98_), .c(x22), .O(new_n101_));
  nand3  g57(.a(new_n97_), .b(new_n48_), .c(x21), .O(new_n102_));
  nand2  g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n59_), .c(x09), .d(new_n57_), .O(new_n104_));
  oai21  g60(.a(new_n66_), .b(new_n65_), .c(new_n104_), .O(z12));
  nand2  g61(.a(new_n76_), .b(x09), .O(new_n106_));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n106_), .c(new_n97_), .d(x22), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(x23), .O(new_n109_));
  nand4  g65(.a(new_n97_), .b(new_n49_), .c(x22), .d(x21), .O(new_n110_));
  aoi21  g66(.a(new_n110_), .b(new_n109_), .c(x08), .O(new_n111_));
  oai21  g67(.a(new_n111_), .b(new_n58_), .c(new_n59_), .O(new_n112_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n59_), .c(x09), .d(new_n57_), .O(new_n122_));
  oai21  g78(.a(new_n66_), .b(new_n70_), .c(new_n122_), .O(z14));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n50_), .c(x24), .O(new_n125_));
  ...
  nand4  g85(.a(new_n129_), .b(new_n59_), .c(x09), .d(new_n57_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n72_), .O(z15));
  inv1   g87(.a(x18), .O(new_n132_));
  nand3  g88(.a(new_n47_), .b(x19), .c(new_n132_), .O(new_n133_));
  nand3  g89(.a(new_n50_), .b(x25), .c(x24), .O(new_n134_));
  ...
  nand4  g93(.a(new_n137_), .b(new_n97_), .c(new_n136_), .d(new_n77_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n59_), .c(x09), .d(new_n57_), .O(new_n140_));
