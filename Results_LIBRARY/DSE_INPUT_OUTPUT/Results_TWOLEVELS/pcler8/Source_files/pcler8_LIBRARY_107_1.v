...
module FAU ( 
  ...
  nor2   g29(.a(new_n47_), .b(new_n45_), .O(z08));
  ...
  nand3  g84(.a(new_n128_), .b(new_n72_), .c(new_n46_), .O(z15));
  inv1   g85(.a(z08), .O(new_n130_));
  ...
  nand2  g95(.a(new_n139_), .b(new_n130_), .O(z16));
endmodule
