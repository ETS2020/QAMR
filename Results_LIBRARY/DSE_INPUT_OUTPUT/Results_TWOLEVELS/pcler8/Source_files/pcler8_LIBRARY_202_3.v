...
module FAU ( 
  ...
  nand2  g70(.a(new_n74_), .b(new_n47_), .O(new_n115_));
  ...
  nand4  g75(.a(new_n114_), .b(new_n119_), .c(x23), .d(x22), .O(new_n120_));
  ...
  nand4  g84(.a(new_n114_), .b(new_n124_), .c(new_n128_), .d(x24), .O(new_n129_));
