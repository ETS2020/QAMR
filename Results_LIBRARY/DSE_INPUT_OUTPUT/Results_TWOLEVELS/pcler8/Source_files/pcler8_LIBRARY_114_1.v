...
module FAU ( 
  ...
  nand2  g07(.a(new_n49_), .b(x08), .O(new_n53_));
  inv1   g08(.a(new_n53_), .O(new_n54_));
  nand2  g09(.a(new_n54_), .b(x02), .O(new_n55_));
  inv1   g10(.a(new_n55_), .O(z03));
  nand2  g11(.a(new_n54_), .b(x03), .O(new_n57_));
  nand2  g12(.a(new_n57_), .b(new_n49_), .O(z04));
  nand2  g13(.a(new_n54_), .b(x04), .O(new_n59_));
  inv1   g14(.a(new_n59_), .O(z05));
  inv1   g15(.a(x05), .O(new_n61_));
  oai21  g16(.a(new_n47_), .b(new_n61_), .c(new_n49_), .O(z06));
  ...
  nand4  g25(.a(new_n70_), .b(new_n68_), .c(new_n67_), .d(new_n48_), .O(new_n71_));
  oai21  g26(.a(new_n53_), .b(new_n46_), .c(new_n71_), .O(z09));
  xor2a  g27(.a(x20), .b(x19), .O(new_n73_));
  nand4  g28(.a(new_n73_), .b(new_n68_), .c(new_n48_), .d(x09), .O(new_n74_));
  oai22  g29(.a(new_n74_), .b(x08), .c(new_n53_), .d(new_n51_), .O(z10));
  ...
  aoi21  g34(.a(new_n79_), .b(new_n77_), .c(new_n69_), .O(new_n80_));
  aoi21  g35(.a(new_n80_), .b(new_n47_), .c(x24), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(x10), .c(new_n55_), .O(z11));
  ...
  nand4  g49(.a(new_n94_), .b(new_n68_), .c(new_n48_), .d(x09), .O(new_n95_));
  oai21  g50(.a(new_n95_), .b(x08), .c(new_n59_), .O(z13));
  nand3  g51(.a(new_n70_), .b(x19), .c(new_n48_), .O(new_n97_));
  nor2   g52(.a(x24), .b(new_n92_), .O(new_n98_));
  nand4  g53(.a(new_n98_), .b(x22), .c(x21), .d(x20), .O(new_n99_));
  oai22  g54(.a(new_n99_), .b(new_n97_), .c(new_n53_), .d(new_n61_), .O(z14));
  nand2  g55(.a(x25), .b(x09), .O(new_n101_));
  oai21  g56(.a(new_n101_), .b(x08), .c(new_n68_), .O(new_n102_));
  nand2  g57(.a(new_n102_), .b(new_n48_), .O(new_n103_));
  oai21  g58(.a(new_n53_), .b(new_n63_), .c(new_n103_), .O(z15));
  nand4  g59(.a(new_n70_), .b(x26), .c(new_n68_), .d(new_n48_), .O(new_n105_));
  oai21  g60(.a(new_n53_), .b(new_n65_), .c(new_n105_), .O(z16));
  zero   g61(.O(z00));
endmodule
