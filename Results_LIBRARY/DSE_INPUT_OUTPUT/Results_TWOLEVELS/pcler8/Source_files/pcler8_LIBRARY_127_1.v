...
module FAU ( 
  ...
  aoi21  g10(.a(x10), .b(new_n54_), .c(new_n46_), .O(new_n55_));
  nand2  g11(.a(new_n55_), .b(x00), .O(new_n56_));
  inv1   g12(.a(new_n56_), .O(z01));
  nand2  g13(.a(new_n55_), .b(x01), .O(new_n58_));
  inv1   g14(.a(new_n58_), .O(z02));
  nand2  g15(.a(x10), .b(new_n54_), .O(new_n60_));
  nand2  g16(.a(x08), .b(x02), .O(new_n61_));
  nand2  g17(.a(new_n61_), .b(new_n60_), .O(z03));
  inv1   g18(.a(x03), .O(new_n63_));
  oai21  g19(.a(new_n46_), .b(new_n63_), .c(new_n60_), .O(z04));
  inv1   g20(.a(x04), .O(new_n65_));
  inv1   g21(.a(new_n55_), .O(new_n66_));
  nor2   g22(.a(new_n66_), .b(new_n65_), .O(z05));
  inv1   g23(.a(x05), .O(new_n68_));
  nor2   g24(.a(new_n66_), .b(new_n68_), .O(z06));
  nand2  g25(.a(new_n55_), .b(x06), .O(new_n70_));
  inv1   g26(.a(new_n70_), .O(z07));
  inv1   g27(.a(x07), .O(new_n72_));
  oai21  g28(.a(new_n46_), .b(new_n72_), .c(new_n60_), .O(z08));
  ...
  nand3  g36(.a(new_n80_), .b(new_n56_), .c(new_n60_), .O(z09));
  ...
  oai21  g41(.a(x20), .b(new_n82_), .c(new_n85_), .O(new_n86_));
  nand4  g42(.a(new_n86_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n87_));
  nand3  g43(.a(new_n87_), .b(new_n58_), .c(new_n60_), .O(z10));
  ...
  oai21  g47(.a(new_n91_), .b(new_n82_), .c(x21), .O(new_n92_));
  nand3  g48(.a(new_n74_), .b(x20), .c(x19), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n95_));
  nand3  g51(.a(new_n95_), .b(new_n61_), .c(new_n60_), .O(z11));
  ...
  nand4  g67(.a(new_n111_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n112_));
  oai21  g68(.a(new_n66_), .b(new_n65_), .c(new_n112_), .O(z13));
  ...
  oai21  g78(.a(new_n66_), .b(new_n68_), .c(new_n122_), .O(z14));
  ...
  nor2   g83(.a(new_n109_), .b(new_n75_), .O(new_n128_));
  nand4  g84(.a(new_n119_), .b(new_n128_), .c(new_n127_), .d(x24), .O(new_n129_));
  nand2  g85(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand4  g86(.a(new_n130_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n131_));
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n60_), .O(z15));
  ...
  nor2   g92(.a(new_n118_), .b(new_n109_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n127_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n101_), .c(new_n137_), .d(new_n76_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  oai21  g97(.a(new_n66_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
