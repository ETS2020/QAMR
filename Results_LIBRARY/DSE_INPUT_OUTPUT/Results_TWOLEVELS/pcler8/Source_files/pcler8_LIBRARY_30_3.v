...
module FAU ( 
  ...
  nand2  g52(.a(new_n96_), .b(new_n64_), .O(z11));
  ...
  nand3  g58(.a(new_n102_), .b(new_n77_), .c(x21), .O(new_n103_));
  ...
  oai21  g79(.a(new_n123_), .b(x10), .c(x09), .O(new_n124_));
  nand2  g80(.a(new_n124_), .b(new_n70_), .O(z14));
  ...
  nand4  g85(.a(new_n116_), .b(new_n52_), .c(new_n129_), .d(x24), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g87(.a(new_n131_), .b(new_n46_), .c(x09), .d(new_n76_), .O(new_n132_));
  nand2  g88(.a(new_n132_), .b(new_n72_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand4  g90(.a(x21), .b(x20), .c(x19), .d(new_n134_), .O(new_n135_));
  nand2  g91(.a(new_n121_), .b(new_n46_), .O(new_n136_));
  nand3  g92(.a(new_n136_), .b(new_n52_), .c(x25), .O(new_n137_));
  oai21  g93(.a(new_n137_), .b(new_n135_), .c(x26), .O(new_n138_));
  nor2   g94(.a(new_n121_), .b(new_n110_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n129_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n102_), .c(new_n139_), .d(new_n78_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n138_), .c(x08), .O(new_n142_));
  oai21  g98(.a(new_n142_), .b(x10), .c(x09), .O(new_n143_));
  nand2  g99(.a(new_n143_), .b(new_n74_), .O(z16));
endmodule
