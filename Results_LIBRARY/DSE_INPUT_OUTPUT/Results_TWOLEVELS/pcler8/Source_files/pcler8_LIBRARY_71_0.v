...
module FAU ( 
  ...
  nand2  g086(.a(x23), .b(x22), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n121_), .b(new_n132_), .c(new_n126_), .d(x24), .O(new_n133_));
  oai21  g089(.a(new_n130_), .b(new_n126_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n46_), .c(new_n74_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(x10), .c(new_n70_), .O(z15));
  inv1   g092(.a(x18), .O(new_n137_));
  nand2  g093(.a(new_n131_), .b(x09), .O(new_n138_));
  nand3  g094(.a(x25), .b(x24), .c(x21), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n103_), .d(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x26), .O(new_n142_));
  nor2   g098(.a(new_n120_), .b(new_n111_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n126_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n103_), .c(new_n143_), .d(new_n77_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n142_), .c(x08), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n74_), .c(new_n47_), .O(new_n147_));
