...
module FAU ( 
  ...
  nor2   g013(.a(new_n45_), .b(x10), .O(new_n58_));
  ...
  oai21  g022(.a(new_n57_), .b(new_n65_), .c(new_n66_), .O(z03));
  inv1   g023(.a(x03), .O(new_n68_));
  nor2   g024(.a(new_n63_), .b(new_n68_), .O(z04));
  inv1   g025(.a(x04), .O(new_n70_));
  oai21  g026(.a(new_n57_), .b(new_n70_), .c(new_n66_), .O(z05));
  inv1   g027(.a(x05), .O(new_n72_));
  nor2   g028(.a(new_n63_), .b(new_n72_), .O(z06));
  nand2  g029(.a(x08), .b(x06), .O(new_n74_));
  nand2  g030(.a(new_n74_), .b(new_n66_), .O(z07));
  nand2  g031(.a(new_n59_), .b(x07), .O(new_n76_));
  ...
  nand3  g039(.a(new_n83_), .b(x09), .c(new_n57_), .O(new_n84_));
  nand2  g040(.a(new_n84_), .b(new_n45_), .O(new_n85_));
  nand2  g041(.a(new_n85_), .b(new_n78_), .O(new_n86_));
  nand2  g042(.a(new_n86_), .b(new_n60_), .O(z09));
  ...
  aoi21  g049(.a(new_n93_), .b(new_n57_), .c(x14), .O(new_n94_));
  oai22  g050(.a(new_n94_), .b(x10), .c(new_n63_), .d(new_n62_), .O(z10));
  ...
  aoi21  g056(.a(new_n100_), .b(new_n99_), .c(x14), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n102_));
  oai21  g058(.a(new_n63_), .b(new_n65_), .c(new_n102_), .O(z11));
  nand2  g059(.a(new_n48_), .b(x22), .O(new_n104_));
  nand2  g060(.a(x20), .b(x19), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n50_), .c(x21), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n104_), .c(x14), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n109_));
  oai21  g065(.a(new_n63_), .b(new_n68_), .c(new_n109_), .O(z12));
  nand4  g066(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x22), .c(x21), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n105_), .c(x23), .O(new_n113_));
  nand4  g069(.a(new_n106_), .b(new_n51_), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n113_), .c(x14), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n116_));
  oai21  g072(.a(new_n63_), .b(new_n70_), .c(new_n116_), .O(z13));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n120_), .c(x14), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n78_), .c(x09), .d(new_n57_), .O(new_n124_));
  oai21  g080(.a(new_n63_), .b(new_n72_), .c(new_n124_), .O(z14));
  nand4  g081(.a(x23), .b(x22), .c(x21), .d(x20), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n45_), .O(new_n127_));
  aoi21  g083(.a(x26), .b(x17), .c(new_n121_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(x19), .O(new_n129_));
  ...
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(new_n46_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n57_), .c(x14), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(x10), .c(new_n74_), .O(z15));
  nor2   g091(.a(new_n96_), .b(x18), .O(new_n136_));
  nor2   g092(.a(new_n131_), .b(new_n121_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n136_), .c(new_n127_), .O(new_n138_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n106_), .c(new_n140_), .d(new_n80_), .O(new_n142_));
  aoi21  g098(.a(new_n142_), .b(new_n139_), .c(new_n46_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n57_), .c(x14), .O(new_n144_));
