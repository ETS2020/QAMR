...
module FAU ( 
  ...
  nand2  g016(.a(new_n55_), .b(x10), .O(new_n61_));
  ...
  oai21  g026(.a(new_n46_), .b(new_n70_), .c(new_n61_), .O(z07));
  ...
  nand2  g060(.a(x23), .b(x09), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(x08), .c(new_n47_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n55_), .O(new_n107_));
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n100_), .c(x21), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x23), .O(new_n110_));
  inv1   g066(.a(x23), .O(new_n111_));
  nand4  g067(.a(new_n100_), .b(new_n111_), .c(x22), .d(x21), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n107_), .c(new_n66_), .O(z13));
  ...
  oai21  g076(.a(new_n120_), .b(new_n96_), .c(x24), .O(new_n121_));
  ...
  nor2   g088(.a(new_n111_), .b(new_n55_), .O(new_n133_));
  ...
  nand2  g093(.a(x26), .b(x09), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(x08), .c(new_n47_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n55_), .O(new_n140_));
  inv1   g096(.a(x18), .O(new_n141_));
  nand2  g097(.a(new_n100_), .b(new_n141_), .O(new_n142_));
  nand4  g098(.a(x25), .b(x24), .c(x23), .d(x21), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n142_), .c(x26), .O(new_n144_));
  nor2   g100(.a(new_n122_), .b(new_n111_), .O(new_n145_));
  nor2   g101(.a(x26), .b(new_n132_), .O(new_n146_));
  ...
  nand3  g105(.a(new_n149_), .b(new_n140_), .c(new_n72_), .O(z16));
endmodule
