...
module FAU ( 
  ...
  aoi21  g60(.a(x21), .b(x20), .c(x10), .O(new_n105_));
  nand4  g61(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n106_));
  nand3  g62(.a(new_n106_), .b(x22), .c(x19), .O(new_n107_));
  oai21  g63(.a(new_n107_), .b(new_n105_), .c(x23), .O(new_n108_));
  ...
  oai21  g71(.a(new_n115_), .b(new_n105_), .c(x24), .O(new_n116_));
  inv1   g72(.a(x24), .O(new_n117_));
  nand3  g73(.a(x21), .b(x20), .c(x19), .O(new_n118_));
  inv1   g74(.a(new_n118_), .O(new_n119_));
  nand4  g75(.a(new_n119_), .b(new_n117_), .c(x23), .d(x22), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n116_), .c(x08), .O(new_n121_));
  ...
  oai21  g81(.a(new_n125_), .b(new_n118_), .c(x25), .O(new_n126_));
