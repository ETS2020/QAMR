...
module FAU ( 
  ...
  nor2   g09(.a(new_n47_), .b(x01), .O(new_n54_));
  ...
  nor2   g42(.a(z02), .b(new_n54_), .O(new_n87_));
  ...
  oai21  g60(.a(new_n63_), .b(new_n62_), .c(new_n104_), .O(z12));
  ...
  nand3  g78(.a(new_n122_), .b(new_n67_), .c(new_n55_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n69_), .c(new_n55_), .O(z15));
  ...
  nand3  g97(.a(new_n141_), .b(new_n71_), .c(new_n55_), .O(z16));
endmodule
