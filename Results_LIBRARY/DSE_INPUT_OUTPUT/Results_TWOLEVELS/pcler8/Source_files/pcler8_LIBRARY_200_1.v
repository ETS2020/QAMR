...
module FAU ( 
  ...
  oai21  g026(.a(new_n47_), .b(new_n70_), .c(new_n57_), .O(z06));
  ...
  nand2  g035(.a(new_n79_), .b(new_n58_), .O(z09));
  ...
  aoi21  g043(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(new_n88_));
  aoi21  g044(.a(new_n88_), .b(new_n47_), .c(x11), .O(new_n89_));
  oai22  g045(.a(new_n89_), .b(x10), .c(new_n62_), .d(new_n60_), .O(z10));
  ...
  oai21  g049(.a(new_n93_), .b(new_n76_), .c(x21), .O(new_n94_));
  inv1   g050(.a(x21), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x20), .c(x19), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n94_), .c(x11), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n98_));
  oai21  g054(.a(new_n62_), .b(new_n64_), .c(new_n98_), .O(z11));
  oai21  g055(.a(x20), .b(x11), .c(x19), .O(new_n100_));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n103_), .c(new_n81_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n47_), .c(x11), .O(new_n107_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n47_), .c(x11), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(x10), .c(new_n68_), .O(z13));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n120_), .c(x11), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n125_));
  oai21  g081(.a(new_n62_), .b(new_n70_), .c(new_n125_), .O(z14));
  ...
  nand3  g087(.a(new_n131_), .b(new_n122_), .c(new_n127_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n130_), .c(x11), .O(new_n133_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n104_), .d(new_n136_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n143_), .c(new_n45_), .d(x25), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n142_), .c(new_n81_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n47_), .c(x11), .O(new_n148_));
