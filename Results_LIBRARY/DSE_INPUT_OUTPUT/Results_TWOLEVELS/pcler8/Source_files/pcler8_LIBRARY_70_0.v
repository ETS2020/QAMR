...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n61_, new_n63_, new_n66_, new_n68_, new_n70_, new_n72_,
  ...
  nor3   g017(.a(new_n45_), .b(new_n61_), .c(new_n60_), .O(z01));
  nor2   g018(.a(new_n45_), .b(new_n61_), .O(new_n63_));
  ...
  aoi21  g046(.a(new_n90_), .b(new_n89_), .c(new_n45_), .O(z10));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n98_), .c(new_n45_), .O(z11));
  ...
  nand4  g061(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n61_), .O(new_n106_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n50_), .c(x23), .O(new_n110_));
  nand4  g066(.a(new_n51_), .b(new_n53_), .c(x22), .d(x21), .O(new_n111_));
  ...
  oai21  g091(.a(new_n133_), .b(new_n115_), .c(x26), .O(new_n136_));
  nor2   g092(.a(new_n119_), .b(new_n53_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n47_), .c(x09), .d(new_n61_), .O(new_n145_));
