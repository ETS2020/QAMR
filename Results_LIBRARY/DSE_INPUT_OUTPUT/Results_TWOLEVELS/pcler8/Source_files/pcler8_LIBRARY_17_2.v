...
module FAU ( 
  ...
  aoi21  g17(.a(new_n54_), .b(x10), .c(new_n46_), .O(new_n62_));
  nand2  g18(.a(new_n62_), .b(x03), .O(new_n63_));
  ...
  nor2   g24(.a(new_n68_), .b(new_n67_), .O(z06));
  inv1   g25(.a(x06), .O(new_n70_));
  nor2   g26(.a(new_n68_), .b(new_n70_), .O(z07));
  inv1   g27(.a(x07), .O(new_n72_));
  nor2   g28(.a(new_n68_), .b(new_n72_), .O(z08));
  ...
  nand3  g51(.a(new_n95_), .b(new_n60_), .c(new_n55_), .O(z11));
  ...
  nand3  g68(.a(new_n112_), .b(new_n65_), .c(new_n55_), .O(z13));
  ...
  oai21  g78(.a(new_n68_), .b(new_n67_), .c(new_n122_), .O(z14));
  ...
  oai21  g87(.a(new_n68_), .b(new_n70_), .c(new_n131_), .O(z15));
  ...
  oai21  g97(.a(new_n68_), .b(new_n72_), .c(new_n141_), .O(z16));
endmodule
