// Benchmark "FAU" written by ABC on Wed Aug 19 15:36:41 2020
...
module FAU ( 
  ...
  nand2  g031(.a(new_n75_), .b(new_n60_), .O(z07));
  ...
  oai21  g043(.a(x20), .b(new_n47_), .c(new_n87_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n89_));
  nand2  g045(.a(new_n89_), .b(new_n65_), .O(z10));
  nand3  g046(.a(x23), .b(x22), .c(x13), .O(new_n91_));
  oai21  g047(.a(new_n91_), .b(new_n55_), .c(x20), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n47_), .c(x21), .O(new_n93_));
  nand3  g049(.a(new_n50_), .b(x20), .c(x19), .O(new_n94_));
  aoi21  g050(.a(new_n94_), .b(new_n93_), .c(x08), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(x10), .c(x09), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n67_), .O(z11));
  nor2   g053(.a(new_n49_), .b(new_n47_), .O(new_n98_));
  ...
  nand3  g058(.a(new_n98_), .b(new_n52_), .c(x21), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n69_), .O(z12));
  nand4  g062(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x22), .c(x21), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n99_), .c(x23), .O(new_n109_));
  nand4  g065(.a(new_n98_), .b(new_n53_), .c(x22), .d(x21), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n71_), .O(z13));
  aoi21  g069(.a(x22), .b(x21), .c(x10), .O(new_n114_));
  nand3  g070(.a(x26), .b(x25), .c(x16), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x23), .c(x20), .d(x19), .O(new_n116_));
  ...
  nand4  g076(.a(new_n120_), .b(new_n118_), .c(x23), .d(x22), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n117_), .c(x08), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(x10), .c(x09), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n73_), .O(z14));
  aoi21  g080(.a(new_n52_), .b(new_n46_), .c(new_n53_), .O(new_n125_));
  aoi21  g081(.a(x26), .b(x17), .c(new_n118_), .O(new_n126_));
  ...
  nand2  g091(.a(new_n52_), .b(new_n46_), .O(new_n136_));
  ...
  nor2   g095(.a(new_n118_), .b(new_n53_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n129_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n98_), .c(new_n140_), .d(new_n79_), .O(new_n142_));
