...
module FAU ( 
  ...
  nor2   g23(.a(new_n53_), .b(new_n57_), .O(z12));
  oai21  g24(.a(new_n49_), .b(new_n59_), .c(new_n46_), .O(z13));
  nor2   g25(.a(new_n53_), .b(new_n61_), .O(z14));
  nor2   g26(.a(new_n53_), .b(new_n51_), .O(z10));
  nand2  g27(.a(new_n55_), .b(new_n46_), .O(z11));
