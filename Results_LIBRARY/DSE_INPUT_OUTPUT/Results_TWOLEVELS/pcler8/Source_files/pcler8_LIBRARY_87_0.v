...
module FAU ( 
  ...
  nand2  g24(.a(new_n68_), .b(new_n63_), .O(z04));
  ...
  oai21  g55(.a(x20), .b(new_n99_), .c(x19), .O(new_n100_));
  ...
  oai21  g69(.a(new_n113_), .b(new_n99_), .c(new_n78_), .O(new_n114_));
  ...
  oai21  g88(.a(new_n132_), .b(new_n99_), .c(new_n78_), .O(new_n133_));
