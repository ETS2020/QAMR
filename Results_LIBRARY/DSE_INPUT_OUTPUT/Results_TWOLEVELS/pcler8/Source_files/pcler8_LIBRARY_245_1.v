...
module FAU ( 
  ...
  nor2   g028(.a(new_n72_), .b(new_n71_), .O(z07));
  inv1   g029(.a(x07), .O(new_n74_));
  nor2   g030(.a(new_n72_), .b(new_n74_), .O(z08));
  ...
  oai21  g040(.a(new_n84_), .b(new_n77_), .c(x19), .O(new_n85_));
  ...
  aoi21  g054(.a(new_n98_), .b(new_n96_), .c(x14), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n63_), .O(z11));
  oai21  g057(.a(x20), .b(x14), .c(x21), .O(new_n102_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n103_), .c(new_n83_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n47_), .c(x14), .O(new_n108_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(x14), .O(new_n115_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n121_), .c(x14), .O(new_n125_));
  ...
  aoi21  g089(.a(new_n133_), .b(new_n130_), .c(x14), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n135_));
  oai21  g091(.a(new_n72_), .b(new_n71_), .c(new_n135_), .O(z15));
  ...
  nor2   g096(.a(new_n46_), .b(new_n97_), .O(new_n141_));
  nor2   g097(.a(new_n122_), .b(new_n113_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n131_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n105_), .c(new_n142_), .d(new_n141_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n140_), .c(x14), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n146_));
  oai21  g102(.a(new_n72_), .b(new_n74_), .c(new_n146_), .O(z16));
endmodule
