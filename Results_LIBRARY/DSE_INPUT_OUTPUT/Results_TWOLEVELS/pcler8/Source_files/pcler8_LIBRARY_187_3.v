...
module FAU ( 
  ...
  nand2  g09(.a(x16), .b(x10), .O(new_n54_));
  ...
  nand3  g50(.a(new_n94_), .b(new_n61_), .c(new_n54_), .O(z11));
  ...
  nand3  g59(.a(new_n103_), .b(new_n63_), .c(new_n54_), .O(z12));
  ...
  nand3  g96(.a(new_n140_), .b(new_n71_), .c(new_n54_), .O(z16));
endmodule
