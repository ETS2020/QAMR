...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n49_, new_n51_, new_n53_, new_n55_,
    ...
    new_n87_, new_n88_, new_n89_, new_n91_, new_n93_;
  ...
  nand3  g32(.a(new_n47_), .b(x09), .c(new_n72_), .O(new_n78_));
  nand3  g33(.a(new_n71_), .b(x20), .c(x19), .O(new_n79_));
  oai22  g34(.a(new_n79_), .b(new_n78_), .c(new_n49_), .d(new_n53_), .O(z11));
  nand2  g35(.a(x22), .b(x09), .O(new_n81_));
  oai21  g36(.a(new_n81_), .b(x08), .c(new_n71_), .O(new_n82_));
  nand2  g37(.a(new_n82_), .b(new_n47_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n55_), .O(z12));
  nand4  g39(.a(new_n67_), .b(x23), .c(new_n71_), .d(new_n47_), .O(new_n85_));
  nand2  g40(.a(new_n85_), .b(new_n58_), .O(z13));
  ...
  nand4  g45(.a(new_n67_), .b(x25), .c(new_n71_), .d(new_n47_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n62_), .O(z15));
  nand4  g47(.a(new_n67_), .b(x26), .c(new_n71_), .d(new_n47_), .O(new_n93_));
