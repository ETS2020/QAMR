...
module FAU ( 
  ...
  nand2  g13(.a(new_n45_), .b(x08), .O(new_n58_));
  ...
  nand2  g18(.a(new_n62_), .b(new_n45_), .O(z02));
  ...
  nand2  g30(.a(new_n74_), .b(new_n45_), .O(z08));
  ...
  nand3  g37(.a(new_n81_), .b(new_n60_), .c(new_n45_), .O(z09));
  ...
  nand3  g45(.a(new_n89_), .b(new_n62_), .c(new_n45_), .O(z10));
  ...
  nand3  g60(.a(new_n104_), .b(new_n66_), .c(new_n45_), .O(z12));
  ...
  nand3  g67(.a(new_n111_), .b(new_n68_), .c(new_n45_), .O(z13));
  ...
  nand2  g95(.a(new_n139_), .b(new_n74_), .O(z16));
endmodule
