...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    new_n52_, new_n54_, new_n55_, new_n56_, new_n58_, new_n61_, new_n62_,
  ...
  nor2   g09(.a(new_n47_), .b(x02), .O(new_n54_));
  ...
  nor2   g20(.a(new_n62_), .b(new_n64_), .O(z05));
  inv1   g21(.a(x05), .O(new_n66_));
  inv1   g22(.a(new_n54_), .O(new_n67_));
  oai21  g23(.a(new_n46_), .b(new_n66_), .c(new_n67_), .O(z06));
  nand2  g24(.a(x08), .b(x06), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n67_), .O(z07));
  inv1   g26(.a(x07), .O(new_n71_));
  oai21  g27(.a(new_n46_), .b(new_n71_), .c(new_n67_), .O(z08));
  ...
  nand3  g35(.a(new_n79_), .b(new_n56_), .c(new_n67_), .O(z09));
  ...
  nand3  g42(.a(new_n86_), .b(new_n58_), .c(new_n67_), .O(z10));
  ...
  nor2   g50(.a(z03), .b(new_n54_), .O(new_n95_));
  ...
  oai21  g60(.a(new_n62_), .b(new_n61_), .c(new_n104_), .O(z12));
  ...
  oai21  g68(.a(new_n62_), .b(new_n64_), .c(new_n112_), .O(z13));
  ...
  oai21  g78(.a(new_n62_), .b(new_n66_), .c(new_n122_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n69_), .c(new_n67_), .O(z15));
  ...
  oai21  g97(.a(new_n62_), .b(new_n71_), .c(new_n141_), .O(z16));
endmodule
