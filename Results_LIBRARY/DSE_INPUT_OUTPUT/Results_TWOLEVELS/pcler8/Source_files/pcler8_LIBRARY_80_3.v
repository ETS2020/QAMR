...
module FAU ( 
  ...
  aoi21  g12(.a(new_n47_), .b(new_n56_), .c(new_n46_), .O(z02));
  inv1   g13(.a(x02), .O(new_n58_));
  aoi21  g14(.a(new_n47_), .b(new_n58_), .c(new_n46_), .O(z03));
  ...
  aoi21  g32(.a(new_n76_), .b(new_n54_), .c(x10), .O(z09));
  ...
  nand3  g38(.a(new_n82_), .b(x09), .c(new_n46_), .O(new_n83_));
  nand2  g39(.a(x08), .b(x01), .O(new_n84_));
  aoi21  g40(.a(new_n84_), .b(new_n83_), .c(x10), .O(z10));
  ...
  nand3  g47(.a(new_n91_), .b(x09), .c(new_n46_), .O(new_n92_));
  nand2  g48(.a(x08), .b(x02), .O(new_n93_));
  aoi21  g49(.a(new_n93_), .b(new_n92_), .c(x10), .O(z11));
  ...
  aoi21  g58(.a(new_n102_), .b(new_n60_), .c(x10), .O(z12));
  ...
  aoi21  g66(.a(new_n110_), .b(new_n62_), .c(x10), .O(z13));
  ...
  aoi21  g76(.a(new_n120_), .b(new_n64_), .c(x10), .O(z14));
  ...
  nor2   g81(.a(new_n107_), .b(new_n71_), .O(new_n126_));
  ...
  aoi21  g85(.a(new_n129_), .b(new_n66_), .c(x10), .O(z15));
  ...
  nand4  g92(.a(new_n136_), .b(new_n99_), .c(new_n135_), .d(new_n72_), .O(new_n137_));
  nand2  g93(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g94(.a(new_n138_), .b(x09), .c(new_n46_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n68_), .c(x10), .O(z16));
endmodule
