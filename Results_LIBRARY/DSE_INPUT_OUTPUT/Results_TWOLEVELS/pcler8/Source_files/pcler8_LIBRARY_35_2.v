...
module FAU ( 
  ...
  oai22  g039(.a(new_n83_), .b(x06), .c(new_n61_), .d(new_n58_), .O(z09));
  ...
  aoi21  g055(.a(new_n99_), .b(new_n46_), .c(x06), .O(new_n100_));
  ...
  nand3  g062(.a(new_n102_), .b(new_n51_), .c(x21), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n106_), .c(x10), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(x09), .c(new_n46_), .d(new_n45_), .O(new_n109_));
  oai21  g065(.a(new_n61_), .b(new_n67_), .c(new_n109_), .O(z12));
  nand2  g066(.a(new_n78_), .b(new_n45_), .O(new_n111_));
  ...
  nand4  g070(.a(new_n102_), .b(new_n52_), .c(x22), .d(x21), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n85_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n46_), .c(x06), .O(new_n117_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n49_), .c(x24), .O(new_n121_));
  inv1   g077(.a(x24), .O(new_n122_));
  nand4  g078(.a(new_n50_), .b(new_n122_), .c(x23), .d(x22), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n121_), .c(x10), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x09), .c(new_n46_), .d(new_n45_), .O(new_n125_));
  oai21  g081(.a(new_n61_), .b(new_n71_), .c(new_n125_), .O(z14));
  oai21  g082(.a(new_n77_), .b(x08), .c(x06), .O(new_n127_));
  aoi21  g083(.a(new_n52_), .b(new_n45_), .c(new_n51_), .O(new_n128_));
  aoi21  g084(.a(x26), .b(x17), .c(new_n122_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n128_), .c(new_n50_), .O(new_n130_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n77_), .c(x09), .d(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n127_), .O(z15));
  nand3  g092(.a(x26), .b(new_n52_), .c(new_n77_), .O(new_n137_));
  oai22  g093(.a(new_n137_), .b(new_n47_), .c(new_n46_), .d(new_n75_), .O(new_n138_));
  ...
  nor2   g099(.a(new_n122_), .b(new_n52_), .O(new_n144_));
  ...
  nand3  g107(.a(new_n151_), .b(new_n150_), .c(new_n139_), .O(z16));
endmodule
