...
module FAU ( 
  ...
  nand3  g033(.a(new_n77_), .b(x22), .c(new_n48_), .O(new_n78_));
  inv1   g034(.a(x19), .O(new_n79_));
  nand2  g035(.a(new_n45_), .b(new_n79_), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n78_), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(x09), .c(new_n47_), .O(new_n82_));
  nand3  g038(.a(new_n82_), .b(new_n59_), .c(new_n46_), .O(z09));
  ...
  oai21  g049(.a(new_n93_), .b(new_n79_), .c(x21), .O(new_n94_));
  ...
  oai21  g056(.a(new_n100_), .b(new_n54_), .c(x21), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n49_), .c(x22), .O(new_n102_));
  nand3  g058(.a(new_n50_), .b(new_n45_), .c(x21), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n65_), .O(z12));
  nand2  g062(.a(x23), .b(x09), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(x08), .c(new_n48_), .O(new_n108_));
  ...
  nand4  g068(.a(new_n50_), .b(new_n52_), .c(x22), .d(x21), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n109_), .c(new_n67_), .O(z13));
  nand2  g072(.a(x24), .b(x09), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(x08), .c(new_n48_), .O(new_n118_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n119_), .c(new_n69_), .O(z14));
  nand2  g085(.a(x26), .b(x17), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(x24), .c(x23), .d(x22), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n124_), .c(x25), .O(new_n132_));
  ...
  nor2   g097(.a(new_n123_), .b(new_n52_), .O(new_n142_));
  nor2   g098(.a(new_n45_), .b(new_n95_), .O(new_n143_));
  nor2   g099(.a(x26), .b(new_n133_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n50_), .O(new_n145_));
