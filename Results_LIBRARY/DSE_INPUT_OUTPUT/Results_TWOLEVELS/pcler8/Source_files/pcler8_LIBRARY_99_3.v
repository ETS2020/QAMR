...
module FAU ( 
  ...
  nor2   g16(.a(new_n55_), .b(new_n46_), .O(new_n61_));
  ...
  oai21  g36(.a(new_n80_), .b(new_n54_), .c(new_n57_), .O(z09));
  ...
  oai21  g42(.a(new_n86_), .b(x08), .c(new_n47_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(x09), .O(new_n88_));
  ...
  aoi21  g62(.a(x21), .b(x20), .c(x10), .O(new_n107_));
