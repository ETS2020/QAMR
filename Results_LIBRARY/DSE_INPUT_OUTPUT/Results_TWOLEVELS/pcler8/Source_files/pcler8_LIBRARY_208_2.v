...
module FAU ( 
  ...
  aoi21  g14(.a(new_n45_), .b(x10), .c(new_n47_), .O(new_n59_));
  ...
  nand3  g46(.a(new_n90_), .b(new_n62_), .c(new_n46_), .O(z10));
  inv1   g47(.a(x19), .O(new_n92_));
  nand3  g48(.a(x23), .b(x22), .c(x13), .O(new_n93_));
  oai21  g49(.a(new_n93_), .b(new_n55_), .c(x20), .O(new_n94_));
  ...
  nand4  g53(.a(new_n97_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n98_));
  nand2  g54(.a(new_n98_), .b(new_n64_), .O(z11));
  nand2  g55(.a(x23), .b(x14), .O(new_n100_));
  oai21  g56(.a(new_n100_), .b(new_n55_), .c(x21), .O(new_n101_));
  oai21  g57(.a(new_n101_), .b(new_n49_), .c(x22), .O(new_n102_));
  nand3  g58(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n105_));
  nand3  g61(.a(new_n105_), .b(new_n66_), .c(new_n46_), .O(z12));
  ...
  nand3  g68(.a(new_n112_), .b(new_n68_), .c(new_n46_), .O(z13));
  ...
  oai21  g78(.a(new_n71_), .b(new_n70_), .c(new_n122_), .O(z14));
  ...
  nand3  g86(.a(new_n130_), .b(new_n73_), .c(new_n46_), .O(z15));
  nand4  g87(.a(x21), .b(x20), .c(x19), .d(new_n45_), .O(new_n132_));
  nand4  g88(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(new_n132_), .c(x26), .O(new_n134_));
  nor2   g90(.a(new_n118_), .b(new_n53_), .O(new_n135_));
  nor2   g91(.a(x26), .b(new_n127_), .O(new_n136_));
  nand4  g92(.a(new_n136_), .b(new_n135_), .c(new_n78_), .d(new_n50_), .O(new_n137_));
  nand2  g93(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n139_));
