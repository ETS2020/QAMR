...
module FAU ( 
  ...
  aoi21  g10(.a(new_n54_), .b(x10), .c(new_n46_), .O(new_n55_));
  ...
  nand2  g15(.a(new_n54_), .b(x10), .O(new_n60_));
  ...
  nand3  g60(.a(new_n104_), .b(new_n63_), .c(new_n60_), .O(z12));
  ...
  nand3  g68(.a(new_n112_), .b(new_n65_), .c(new_n60_), .O(z13));
  ...
  oai21  g87(.a(new_n72_), .b(new_n69_), .c(new_n131_), .O(z15));
