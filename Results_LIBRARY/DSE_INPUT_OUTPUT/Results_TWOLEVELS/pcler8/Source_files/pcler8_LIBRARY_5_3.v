...
module FAU ( 
  ...
  aoi21  g21(.a(new_n46_), .b(new_n65_), .c(new_n45_), .O(z05));
  ...
  nand4  g33(.a(new_n77_), .b(new_n46_), .c(x09), .d(new_n45_), .O(new_n78_));
  nand2  g34(.a(new_n78_), .b(new_n57_), .O(z09));
  oai21  g35(.a(x10), .b(x01), .c(x08), .O(new_n80_));
  ...
  nand2  g42(.a(new_n86_), .b(new_n80_), .O(z10));
  ...
  nand4  g48(.a(new_n92_), .b(new_n46_), .c(x09), .d(new_n45_), .O(new_n93_));
  ...
  nand2  g64(.a(x08), .b(x04), .O(new_n109_));
  aoi21  g65(.a(new_n109_), .b(new_n108_), .c(x10), .O(z13));
  oai21  g66(.a(x10), .b(x05), .c(x08), .O(new_n111_));
  ...
  nand4  g75(.a(new_n119_), .b(new_n46_), .c(x09), .d(new_n45_), .O(new_n120_));
  ...
  nand4  g83(.a(new_n127_), .b(new_n46_), .c(x09), .d(new_n45_), .O(new_n128_));
  nand2  g84(.a(new_n128_), .b(new_n69_), .O(z15));
  ...
  nand4  g91(.a(new_n135_), .b(new_n134_), .c(new_n74_), .d(new_n48_), .O(new_n136_));
