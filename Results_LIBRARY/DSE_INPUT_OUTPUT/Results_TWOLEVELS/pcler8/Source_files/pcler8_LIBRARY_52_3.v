...
module FAU ( 
  ...
  nand3  g68(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n89_), .c(new_n47_), .O(new_n114_));
  nand2  g70(.a(new_n114_), .b(x16), .O(new_n115_));
  inv1   g71(.a(x24), .O(new_n116_));
  nand2  g72(.a(x23), .b(x22), .O(new_n117_));
  nor3   g73(.a(new_n96_), .b(new_n117_), .c(new_n73_), .O(new_n118_));
  nand3  g74(.a(x21), .b(x20), .c(x19), .O(new_n119_));
  nand3  g75(.a(new_n116_), .b(x23), .c(x22), .O(new_n120_));
  oai22  g76(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(new_n121_));
  nand4  g77(.a(new_n121_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(new_n115_), .c(new_n67_), .O(z14));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(x24), .c(x23), .d(x22), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(new_n119_), .c(x25), .O(new_n126_));
  inv1   g82(.a(x25), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(x24), .c(x23), .d(x22), .O(new_n128_));
  oai21  g84(.a(new_n128_), .b(new_n119_), .c(new_n126_), .O(new_n129_));
  ...
  nor2   g91(.a(new_n116_), .b(new_n108_), .O(new_n136_));
