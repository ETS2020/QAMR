...
module FAU ( 
  ...
  nand2  g28(.a(new_n64_), .b(x05), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n60_), .O(z06));
  nand2  g30(.a(new_n64_), .b(x06), .O(new_n75_));
  ...
  aoi21  g37(.a(new_n81_), .b(new_n63_), .c(x10), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(new_n45_), .c(new_n61_), .O(z09));
  ...
  nand2  g42(.a(new_n49_), .b(x19), .O(new_n87_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n96_));
  ...
  nand4  g60(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n105_));
  ...
  nand4  g77(.a(new_n121_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n73_), .O(z14));
  ...
  nand4  g85(.a(new_n129_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n130_));
  nand2  g86(.a(new_n130_), .b(new_n75_), .O(z15));
  ...
  nor2   g91(.a(new_n52_), .b(new_n50_), .O(new_n136_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n46_), .c(x09), .d(new_n63_), .O(new_n141_));
