...
module FAU ( 
  ...
  nand2  g28(.a(new_n72_), .b(new_n59_), .O(z06));
  ...
  nand4  g67(.a(new_n111_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n112_));
  ...
  aoi21  g80(.a(new_n52_), .b(new_n46_), .c(new_n53_), .O(new_n125_));
  aoi21  g81(.a(x26), .b(x17), .c(new_n120_), .O(new_n126_));
  nand3  g82(.a(new_n126_), .b(new_n125_), .c(new_n115_), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(x25), .O(new_n128_));
  inv1   g84(.a(x25), .O(new_n129_));
  nand4  g85(.a(new_n115_), .b(new_n54_), .c(new_n129_), .d(x24), .O(new_n130_));
  ...
  nand4  g97(.a(new_n141_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n142_));
