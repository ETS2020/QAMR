...
module FAU ( 
  ...
  nand2  g13(.a(new_n58_), .b(x09), .O(new_n59_));
  oai21  g14(.a(new_n57_), .b(new_n56_), .c(new_n59_), .O(z05));
  nand2  g15(.a(x08), .b(x05), .O(new_n61_));
  nand2  g16(.a(new_n61_), .b(new_n59_), .O(z06));
  inv1   g17(.a(x06), .O(new_n63_));
  oai21  g18(.a(new_n57_), .b(new_n63_), .c(new_n59_), .O(z07));
  inv1   g19(.a(x07), .O(new_n65_));
  nor2   g20(.a(new_n48_), .b(new_n65_), .O(z08));
  oai21  g21(.a(new_n57_), .b(new_n52_), .c(new_n59_), .O(z11));
  oai21  g22(.a(new_n57_), .b(new_n54_), .c(new_n59_), .O(z12));
  nor2   g23(.a(new_n48_), .b(new_n56_), .O(z13));
  nor2   g24(.a(new_n48_), .b(new_n63_), .O(z15));
  oai21  g25(.a(new_n57_), .b(new_n65_), .c(new_n59_), .O(z16));
  zero   g26(.O(z00));
  nor2   g27(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g28(.a(new_n48_), .b(new_n50_), .O(z10));
  nand2  g29(.a(new_n61_), .b(new_n59_), .O(z14));
endmodule
