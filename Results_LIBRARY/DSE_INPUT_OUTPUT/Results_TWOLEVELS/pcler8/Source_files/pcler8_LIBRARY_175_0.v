...
module FAU ( 
  ...
  nor2   g00(.a(x16), .b(x13), .O(new_n45_));
  ...
  oai21  g18(.a(new_n47_), .b(new_n62_), .c(new_n46_), .O(z02));
  ...
  nand2  g44(.a(x08), .b(x01), .O(new_n89_));
  aoi21  g45(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(z10));
  ...
  aoi21  g61(.a(new_n105_), .b(new_n104_), .c(new_n45_), .O(z12));
  ...
  nand2  g68(.a(x08), .b(x04), .O(new_n113_));
  aoi21  g69(.a(new_n113_), .b(new_n112_), .c(new_n45_), .O(z13));
  ...
  nand3  g79(.a(new_n123_), .b(new_n69_), .c(new_n46_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n71_), .c(new_n46_), .O(z15));
  ...
  nand3  g97(.a(new_n141_), .b(new_n73_), .c(new_n46_), .O(z16));
endmodule
