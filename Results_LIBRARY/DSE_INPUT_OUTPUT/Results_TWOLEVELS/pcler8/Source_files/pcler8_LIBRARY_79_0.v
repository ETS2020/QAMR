...
module FAU ( 
  ...
  nor2   g022(.a(new_n55_), .b(new_n46_), .O(new_n67_));
  inv1   g023(.a(new_n67_), .O(new_n68_));
  nor2   g024(.a(new_n68_), .b(new_n66_), .O(z06));
  nand2  g025(.a(new_n67_), .b(x06), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(z07));
  nand2  g027(.a(new_n67_), .b(x07), .O(new_n72_));
  ...
  oai21  g036(.a(new_n68_), .b(new_n54_), .c(new_n80_), .O(z09));
  ...
  nand2  g053(.a(new_n97_), .b(new_n60_), .O(z11));
  ...
  oai21  g062(.a(new_n68_), .b(new_n62_), .c(new_n106_), .O(z12));
  ...
  oai21  g070(.a(new_n68_), .b(new_n64_), .c(new_n114_), .O(z13));
  ...
  oai21  g080(.a(new_n68_), .b(new_n66_), .c(new_n124_), .O(z14));
  oai21  g081(.a(new_n75_), .b(new_n74_), .c(x09), .O(new_n126_));
  aoi21  g082(.a(x26), .b(x17), .c(new_n120_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n126_), .c(new_n103_), .d(x23), .O(new_n128_));
  ...
  nand4  g093(.a(new_n137_), .b(new_n136_), .c(new_n126_), .d(x23), .O(new_n138_));
