...
module FAU ( 
  ...
  oai21  g018(.a(new_n46_), .b(new_n61_), .c(new_n62_), .O(z03));
  ...
  nand2  g028(.a(new_n72_), .b(new_n62_), .O(z08));
  ...
  nand4  g072(.a(new_n116_), .b(x22), .c(x21), .d(x20), .O(new_n117_));
  nand2  g073(.a(x23), .b(x19), .O(new_n118_));
  aoi21  g074(.a(new_n117_), .b(x09), .c(new_n118_), .O(new_n119_));
  ...
  nand4  g083(.a(new_n127_), .b(x22), .c(x21), .d(x20), .O(new_n128_));
  nand3  g084(.a(x24), .b(x23), .c(x19), .O(new_n129_));
  aoi21  g085(.a(new_n128_), .b(x09), .c(new_n129_), .O(new_n130_));
  nor2   g086(.a(new_n110_), .b(new_n76_), .O(new_n131_));
  ...
  nor2   g095(.a(new_n115_), .b(new_n110_), .O(new_n140_));
