...
module FAU ( 
  ...
  oai21  g35(.a(new_n59_), .b(new_n54_), .c(new_n79_), .O(z09));
  ...
  oai21  g42(.a(new_n59_), .b(new_n57_), .c(new_n86_), .O(z10));
  ...
  oai21  g59(.a(new_n59_), .b(new_n63_), .c(new_n103_), .O(z12));
  ...
  nand3  g70(.a(new_n114_), .b(new_n100_), .c(x23), .O(new_n115_));
  ...
  oai21  g79(.a(new_n74_), .b(new_n73_), .c(new_n47_), .O(new_n124_));
  aoi21  g80(.a(x26), .b(x17), .c(new_n117_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n124_), .c(new_n100_), .d(x23), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nor2   g84(.a(new_n108_), .b(new_n74_), .O(new_n129_));
  ...
  nor2   g93(.a(new_n117_), .b(new_n108_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n128_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n100_), .c(new_n138_), .d(new_n75_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n142_));
  oai21  g98(.a(new_n59_), .b(new_n71_), .c(new_n142_), .O(z16));
endmodule
