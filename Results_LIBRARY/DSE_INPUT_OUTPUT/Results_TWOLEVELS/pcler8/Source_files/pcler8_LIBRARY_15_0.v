...
module FAU ( 
  ...
  aoi21  g37(.a(new_n81_), .b(new_n61_), .c(new_n77_), .O(new_n82_));
  oai21  g38(.a(new_n82_), .b(x10), .c(new_n59_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(new_n84_), .c(x09), .d(new_n61_), .O(new_n89_));
  ...
  oai21  g51(.a(new_n95_), .b(new_n77_), .c(new_n84_), .O(new_n96_));
  ...
  oai21  g60(.a(new_n104_), .b(new_n77_), .c(new_n84_), .O(new_n105_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n77_), .c(new_n84_), .O(new_n123_));
  ...
  oai21  g86(.a(new_n130_), .b(new_n77_), .c(new_n84_), .O(new_n131_));
  ...
  nor2   g92(.a(new_n120_), .b(new_n51_), .O(new_n137_));
  nor2   g93(.a(x26), .b(new_n128_), .O(new_n138_));
  nand4  g94(.a(new_n138_), .b(new_n102_), .c(new_n137_), .d(new_n78_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n136_), .c(x08), .O(new_n140_));
  oai21  g96(.a(new_n140_), .b(new_n77_), .c(new_n84_), .O(new_n141_));
