...
module FAU ( 
  ...
  nand4  g52(.a(new_n96_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n97_));
  oai21  g53(.a(new_n66_), .b(new_n65_), .c(new_n97_), .O(z11));
  ...
  oai21  g62(.a(new_n66_), .b(new_n68_), .c(new_n106_), .O(z12));
  ...
  oai21  g69(.a(new_n66_), .b(new_n70_), .c(new_n113_), .O(z13));
  ...
  nand3  g74(.a(new_n118_), .b(x23), .c(x19), .O(new_n119_));
  aoi21  g75(.a(new_n117_), .b(x09), .c(new_n119_), .O(new_n120_));
  nand3  g76(.a(x21), .b(x20), .c(x19), .O(new_n121_));
  inv1   g77(.a(new_n121_), .O(new_n122_));
  nand4  g78(.a(new_n122_), .b(new_n116_), .c(x23), .d(x22), .O(new_n123_));
  oai21  g79(.a(new_n120_), .b(new_n116_), .c(new_n123_), .O(new_n124_));
  aoi21  g80(.a(new_n124_), .b(new_n58_), .c(new_n115_), .O(new_n125_));
  oai21  g81(.a(new_n125_), .b(x10), .c(new_n72_), .O(z14));
  ...
  nand4  g88(.a(new_n132_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n133_));
  ...
  nor2   g94(.a(new_n116_), .b(new_n51_), .O(new_n139_));
  ...
  nand4  g98(.a(new_n142_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n143_));
