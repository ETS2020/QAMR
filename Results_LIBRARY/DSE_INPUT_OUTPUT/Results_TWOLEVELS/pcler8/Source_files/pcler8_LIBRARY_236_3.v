...
module FAU ( 
  ...
  aoi21  g38(.a(new_n82_), .b(new_n78_), .c(x10), .O(new_n83_));
  ...
  nand4  g44(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n66_), .O(z11));
  oai21  g53(.a(x20), .b(x10), .c(x19), .O(new_n98_));
  ...
  nor2   g57(.a(new_n49_), .b(new_n47_), .O(new_n102_));
  ...
  nand2  g68(.a(new_n112_), .b(new_n70_), .O(z13));
  ...
  nand4  g77(.a(new_n121_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n72_), .O(z14));
  nand2  g79(.a(x26), .b(x17), .O(new_n124_));
  nand3  g80(.a(new_n124_), .b(new_n54_), .c(x24), .O(new_n125_));
  ...
  nand4  g93(.a(new_n137_), .b(new_n102_), .c(new_n136_), .d(new_n79_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n46_), .c(x09), .d(new_n78_), .O(new_n140_));
