...
module FAU ( 
  ...
  nand2  g002(.a(x14), .b(x13), .O(new_n47_));
  ...
  nand2  g010(.a(x14), .b(x13), .O(new_n55_));
  ...
  oai21  g026(.a(new_n54_), .b(new_n70_), .c(new_n55_), .O(z07));
  ...
  nand4  g032(.a(new_n76_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n77_));
  nand2  g033(.a(x08), .b(x00), .O(new_n78_));
  aoi21  g034(.a(new_n78_), .b(new_n77_), .c(new_n56_), .O(z09));
  ...
  nand4  g040(.a(new_n84_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n85_));
  nand3  g041(.a(new_n85_), .b(new_n60_), .c(new_n55_), .O(z10));
  nand4  g042(.a(x21), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n87_));
  nand2  g043(.a(x23), .b(x22), .O(new_n88_));
  nand3  g044(.a(x26), .b(x25), .c(x24), .O(new_n89_));
  nor3   g045(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  oai21  g046(.a(new_n90_), .b(x14), .c(x13), .O(new_n91_));
  ...
  nand4  g052(.a(new_n96_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n91_), .c(new_n62_), .O(z11));
  inv1   g054(.a(x09), .O(new_n99_));
  nor2   g055(.a(x10), .b(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n93_), .b(x13), .O(new_n101_));
  nor3   g057(.a(new_n89_), .b(new_n88_), .c(new_n92_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n54_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(x13), .c(x14), .O(new_n105_));
  inv1   g061(.a(x22), .O(new_n106_));
  nand3  g062(.a(x21), .b(x20), .c(x19), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n106_), .b(x21), .O(new_n109_));
  oai22  g065(.a(new_n109_), .b(new_n93_), .c(new_n108_), .d(new_n106_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n111_));
  ...
  oai21  g070(.a(new_n114_), .b(new_n93_), .c(x23), .O(new_n115_));
  inv1   g071(.a(x23), .O(new_n116_));
  nand4  g072(.a(new_n94_), .b(new_n116_), .c(x22), .d(x21), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n66_), .c(new_n55_), .O(z13));
  nand3  g076(.a(x26), .b(x25), .c(x16), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x23), .c(x22), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n107_), .c(x24), .O(new_n123_));
  inv1   g079(.a(x24), .O(new_n124_));
  nand4  g080(.a(new_n108_), .b(new_n124_), .c(x23), .d(x22), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand4  g082(.a(new_n126_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n127_));
  nand2  g083(.a(x08), .b(x05), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(new_n56_), .O(z14));
  ...
  nand4  g090(.a(new_n108_), .b(new_n130_), .c(new_n134_), .d(x24), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n137_));
  nand2  g093(.a(x08), .b(x06), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n137_), .c(new_n56_), .O(z15));
  nand4  g095(.a(x25), .b(x24), .c(x23), .d(x22), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n107_), .c(x26), .O(new_n141_));
  nor2   g097(.a(new_n124_), .b(new_n116_), .O(new_n142_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n45_), .c(x09), .d(new_n54_), .O(new_n148_));
  ...
  nand4  g107(.a(new_n47_), .b(x26), .c(x18), .d(new_n45_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(x09), .c(new_n54_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n151_), .O(z16));
endmodule
