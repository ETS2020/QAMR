...
module FAU ( 
  ...
  nand2  g09(.a(x10), .b(x06), .O(new_n54_));
  ...
  nand3  g67(.a(new_n111_), .b(new_n65_), .c(new_n54_), .O(z13));
  ...
  oai21  g78(.a(x10), .b(x08), .c(x06), .O(new_n123_));
  ...
  nor2   g83(.a(new_n108_), .b(new_n74_), .O(new_n128_));
  ...
  nand2  g87(.a(new_n131_), .b(new_n123_), .O(z15));
  ...
  nand4  g94(.a(new_n138_), .b(new_n100_), .c(new_n137_), .d(new_n75_), .O(new_n139_));
