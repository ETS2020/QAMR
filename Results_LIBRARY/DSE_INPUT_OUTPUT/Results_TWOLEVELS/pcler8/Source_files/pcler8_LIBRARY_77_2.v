...
module FAU ( 
  ...
  oai21  g21(.a(new_n65_), .b(new_n64_), .c(new_n46_), .O(z08));
  oai21  g22(.a(new_n65_), .b(new_n48_), .c(new_n46_), .O(z09));
  oai21  g23(.a(new_n65_), .b(new_n54_), .c(new_n46_), .O(z11));
  nor2   g24(.a(new_n50_), .b(new_n64_), .O(z16));
  ...
  nand2  g29(.a(new_n62_), .b(new_n46_), .O(z15));
endmodule
