...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n92_), .c(x20), .O(new_n100_));
  ...
  oai21  g060(.a(new_n102_), .b(new_n76_), .c(new_n104_), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n46_), .c(new_n74_), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(x10), .c(new_n64_), .O(z12));
  inv1   g063(.a(new_n92_), .O(new_n108_));
  and2   g064(.a(x15), .b(x09), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n103_), .c(x22), .d(x21), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x23), .O(new_n112_));
  inv1   g068(.a(x23), .O(new_n113_));
  nand4  g069(.a(new_n103_), .b(new_n113_), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(x08), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n74_), .c(new_n47_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n66_), .O(z13));
  nand3  g073(.a(x21), .b(x20), .c(x19), .O(new_n118_));
  nand4  g074(.a(x26), .b(x25), .c(x16), .d(x09), .O(new_n119_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n74_), .c(new_n47_), .O(new_n126_));
  oai21  g082(.a(new_n57_), .b(new_n68_), .c(new_n126_), .O(z14));
  nor2   g083(.a(new_n113_), .b(new_n76_), .O(new_n128_));
  nand3  g084(.a(x26), .b(x17), .c(x09), .O(new_n129_));
