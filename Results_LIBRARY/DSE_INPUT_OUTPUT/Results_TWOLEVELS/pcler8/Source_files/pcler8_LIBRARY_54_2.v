...
module FAU ( 
  ...
  aoi21  g019(.a(x08), .b(x02), .c(new_n46_), .O(new_n64_));
  ...
  nand3  g050(.a(new_n76_), .b(x20), .c(x19), .O(new_n95_));
  ...
  oai21  g063(.a(new_n107_), .b(new_n49_), .c(x23), .O(new_n108_));
  nand4  g064(.a(new_n50_), .b(new_n53_), .c(x22), .d(x21), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n68_), .O(z13));
  nand2  g068(.a(x24), .b(x09), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(x08), .c(new_n45_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n53_), .O(new_n115_));
  nand3  g071(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x22), .c(x21), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n49_), .c(x24), .O(new_n118_));
  ...
  nand3  g080(.a(new_n124_), .b(new_n115_), .c(new_n70_), .O(z14));
  ...
  nand2  g088(.a(new_n132_), .b(new_n72_), .O(z15));
  ...
  nand3  g093(.a(x20), .b(x19), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(x25), .b(x24), .c(x22), .d(x21), .O(new_n139_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n141_), .c(new_n77_), .d(new_n50_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n136_), .c(new_n74_), .O(z16));
endmodule
