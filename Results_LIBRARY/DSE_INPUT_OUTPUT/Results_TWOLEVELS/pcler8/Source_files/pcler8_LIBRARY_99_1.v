...
module FAU ( 
  ...
  aoi21  g15(.a(x10), .b(new_n54_), .c(new_n46_), .O(new_n60_));
  ...
  nand3  g35(.a(new_n79_), .b(new_n56_), .c(new_n55_), .O(z09));
  ...
  nand3  g67(.a(new_n111_), .b(new_n65_), .c(new_n55_), .O(z13));
  ...
  nand3  g77(.a(new_n121_), .b(new_n67_), .c(new_n55_), .O(z14));
  ...
  nand3  g86(.a(new_n130_), .b(new_n69_), .c(new_n55_), .O(z15));
  ...
  nor2   g91(.a(new_n117_), .b(new_n108_), .O(new_n136_));
  nor2   g92(.a(x26), .b(new_n126_), .O(new_n137_));
  nand4  g93(.a(new_n137_), .b(new_n100_), .c(new_n136_), .d(new_n75_), .O(new_n138_));
  nand2  g94(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n140_));
  nand3  g96(.a(new_n140_), .b(new_n71_), .c(new_n55_), .O(z16));
endmodule
