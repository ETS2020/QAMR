...
module FAU ( 
  ...
  oai21  g28(.a(new_n45_), .b(new_n72_), .c(new_n57_), .O(z08));
  ...
  aoi21  g34(.a(new_n78_), .b(new_n45_), .c(new_n55_), .O(new_n79_));
  oai22  g35(.a(new_n79_), .b(x10), .c(new_n58_), .d(new_n54_), .O(z09));
