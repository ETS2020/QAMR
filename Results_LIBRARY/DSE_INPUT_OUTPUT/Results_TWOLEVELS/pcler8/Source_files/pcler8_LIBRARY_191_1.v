...
module FAU ( 
  ...
  nor2   g10(.a(new_n47_), .b(x06), .O(new_n55_));
  ...
  nand2  g25(.a(new_n56_), .b(x07), .O(new_n70_));
  ...
  oai21  g49(.a(new_n57_), .b(new_n61_), .c(new_n93_), .O(z11));
  ...
  oai21  g58(.a(new_n57_), .b(new_n63_), .c(new_n102_), .O(z12));
  inv1   g59(.a(new_n55_), .O(new_n104_));
  ...
  nand3  g67(.a(new_n111_), .b(new_n65_), .c(new_n104_), .O(z13));
  ...
  oai21  g77(.a(new_n57_), .b(new_n67_), .c(new_n121_), .O(z14));
  ...
  nor2   g82(.a(new_n108_), .b(new_n73_), .O(new_n127_));
  ...
  nor2   g86(.a(z07), .b(new_n55_), .O(new_n131_));
  ...
  nand4  g94(.a(new_n138_), .b(new_n99_), .c(new_n137_), .d(new_n74_), .O(new_n139_));
  nand2  g95(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n141_));
  nand3  g97(.a(new_n141_), .b(new_n70_), .c(new_n104_), .O(z16));
endmodule
