...
module FAU ( 
  ...
  nor2   g25(.a(new_n59_), .b(new_n69_), .O(z05));
  ...
  nand4  g36(.a(new_n80_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n81_));
  ...
  nand4  g50(.a(new_n94_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n95_));
  ...
  aoi21  g59(.a(new_n103_), .b(new_n100_), .c(new_n46_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(x10), .c(new_n59_), .O(new_n105_));
  ...
  nand4  g67(.a(new_n111_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n112_));
  oai21  g68(.a(new_n59_), .b(new_n69_), .c(new_n112_), .O(z13));
  ...
  nand4  g77(.a(new_n121_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n122_));
  ...
  nand4  g85(.a(new_n129_), .b(new_n45_), .c(x09), .d(new_n59_), .O(new_n130_));
  ...
  nand4  g93(.a(new_n137_), .b(new_n102_), .c(new_n136_), .d(new_n77_), .O(new_n138_));
