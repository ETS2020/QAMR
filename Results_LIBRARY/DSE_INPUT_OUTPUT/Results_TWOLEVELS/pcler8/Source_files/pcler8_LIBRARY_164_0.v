...
module FAU ( 
  ...
  nor2   g010(.a(x20), .b(x19), .O(new_n55_));
  ...
  nand4  g035(.a(new_n79_), .b(x20), .c(new_n47_), .d(x09), .O(new_n80_));
  oai22  g036(.a(new_n80_), .b(x08), .c(new_n57_), .d(new_n54_), .O(z09));
  inv1   g037(.a(x20), .O(new_n82_));
  inv1   g038(.a(x09), .O(new_n83_));
  nor2   g039(.a(new_n83_), .b(x08), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n47_), .c(new_n82_), .O(new_n85_));
  or2    g041(.a(new_n85_), .b(x19), .O(new_n86_));
  nand2  g042(.a(new_n76_), .b(x12), .O(new_n87_));
  oai21  g043(.a(new_n87_), .b(new_n78_), .c(x20), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n86_), .c(new_n59_), .O(z10));
  inv1   g046(.a(x19), .O(new_n91_));
  nand3  g047(.a(new_n84_), .b(x21), .c(new_n47_), .O(new_n92_));
  ...
  nand3  g054(.a(new_n74_), .b(x20), .c(x19), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n94_), .c(new_n62_), .O(z11));
  nand3  g058(.a(new_n84_), .b(x22), .c(new_n47_), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x20), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n91_), .O(new_n105_));
  nand2  g061(.a(x23), .b(x14), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n96_), .c(x21), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n82_), .c(x22), .O(new_n108_));
  nand4  g064(.a(new_n75_), .b(x21), .c(x20), .d(x19), .O(new_n109_));
  ...
  nand3  g068(.a(new_n84_), .b(x23), .c(new_n47_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x20), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n91_), .O(new_n115_));
  nor2   g071(.a(new_n74_), .b(new_n91_), .O(new_n116_));
  nor2   g072(.a(x23), .b(new_n75_), .O(new_n117_));
  nand2  g073(.a(x23), .b(x15), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n96_), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(new_n116_), .c(new_n119_), .O(new_n120_));
  nand2  g076(.a(new_n76_), .b(x20), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x23), .O(new_n122_));
  oai21  g078(.a(new_n120_), .b(new_n82_), .c(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n115_), .c(new_n66_), .O(z13));
  inv1   g081(.a(x24), .O(new_n126_));
  nand2  g082(.a(x21), .b(x20), .O(new_n127_));
  nand3  g083(.a(new_n126_), .b(x23), .c(x22), .O(new_n128_));
  oai22  g084(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(x20), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x19), .O(new_n130_));
  nand3  g086(.a(x26), .b(x25), .c(x16), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n116_), .c(x23), .d(x22), .O(new_n132_));
  ...
  nand2  g094(.a(new_n138_), .b(x20), .O(new_n139_));
  nand3  g095(.a(x24), .b(x23), .c(x22), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n127_), .c(x19), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x25), .O(new_n143_));
  and2   g099(.a(x23), .b(x22), .O(new_n144_));
  inv1   g100(.a(new_n127_), .O(new_n145_));
  nor2   g101(.a(x25), .b(new_n126_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n145_), .c(new_n144_), .d(x19), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n70_), .O(z15));
  nand2  g106(.a(x26), .b(new_n91_), .O(new_n151_));
  nand3  g107(.a(x22), .b(x21), .c(x19), .O(new_n152_));
  nand4  g108(.a(new_n45_), .b(x25), .c(x24), .d(x23), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x20), .O(new_n155_));
  nor2   g111(.a(new_n127_), .b(x18), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n144_), .c(x25), .d(x24), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(x26), .c(x19), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n72_), .O(z16));
endmodule
