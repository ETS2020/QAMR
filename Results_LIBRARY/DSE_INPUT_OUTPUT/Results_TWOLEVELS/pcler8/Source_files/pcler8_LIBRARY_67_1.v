...
module FAU ( 
  ...
  nand3  g08(.a(new_n49_), .b(x08), .c(x02), .O(new_n54_));
  ...
  aoi21  g33(.a(new_n78_), .b(new_n76_), .c(x22), .O(new_n79_));
  nand4  g34(.a(new_n79_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n54_), .O(z11));
  nand3  g36(.a(new_n48_), .b(x09), .c(new_n47_), .O(new_n82_));
  nand4  g37(.a(new_n71_), .b(x21), .c(x20), .d(x19), .O(new_n83_));
  oai22  g38(.a(new_n83_), .b(new_n82_), .c(new_n52_), .d(new_n56_), .O(z12));
  nand4  g39(.a(new_n67_), .b(x23), .c(new_n71_), .d(new_n48_), .O(new_n85_));
  oai21  g40(.a(new_n52_), .b(new_n58_), .c(new_n85_), .O(z13));
  ...
  oai21  g44(.a(new_n52_), .b(new_n60_), .c(new_n89_), .O(z14));
  nand4  g45(.a(new_n67_), .b(x25), .c(new_n71_), .d(new_n48_), .O(new_n91_));
  oai21  g46(.a(new_n52_), .b(new_n62_), .c(new_n91_), .O(z15));
