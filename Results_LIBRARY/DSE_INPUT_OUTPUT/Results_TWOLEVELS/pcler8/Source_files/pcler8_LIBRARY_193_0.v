...
module FAU ( 
  ...
  oai21  g043(.a(new_n68_), .b(new_n58_), .c(new_n87_), .O(z10));
  ...
  oai21  g061(.a(new_n68_), .b(new_n62_), .c(new_n105_), .O(z12));
  nand2  g062(.a(new_n74_), .b(x09), .O(new_n107_));
  nand4  g063(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n107_), .c(new_n102_), .d(x22), .O(new_n109_));
  ...
  oai21  g069(.a(new_n113_), .b(new_n89_), .c(new_n47_), .O(new_n114_));
  ...
  nor2   g081(.a(new_n111_), .b(new_n75_), .O(new_n126_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n137_), .c(new_n102_), .d(new_n135_), .O(new_n140_));
  ...
  oai21  g101(.a(new_n145_), .b(new_n89_), .c(new_n47_), .O(new_n146_));
