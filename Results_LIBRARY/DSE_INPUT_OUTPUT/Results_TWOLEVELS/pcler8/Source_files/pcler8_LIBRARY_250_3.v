...
module FAU ( 
  ...
  inv1   g23(.a(new_n60_), .O(new_n68_));
  nand2  g24(.a(new_n61_), .b(x03), .O(new_n69_));
  nand2  g25(.a(new_n69_), .b(new_n68_), .O(z04));
  nand2  g26(.a(x08), .b(x04), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n68_), .O(z05));
  nand2  g28(.a(new_n61_), .b(x05), .O(new_n73_));
  nand2  g29(.a(new_n73_), .b(new_n68_), .O(z06));
  nand2  g30(.a(new_n61_), .b(x06), .O(new_n75_));
  inv1   g31(.a(new_n75_), .O(z07));
  nand2  g32(.a(new_n61_), .b(x07), .O(new_n77_));
  nand2  g33(.a(new_n77_), .b(new_n68_), .O(z08));
  ...
  aoi21  g38(.a(new_n82_), .b(new_n59_), .c(x10), .O(new_n83_));
  oai21  g39(.a(new_n83_), .b(new_n45_), .c(new_n62_), .O(z09));
  ...
  nand4  g61(.a(new_n105_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n69_), .O(z12));
  ...
  nand4  g78(.a(new_n122_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n123_));
  ...
  nand4  g86(.a(new_n130_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n131_));
  ...
  nand4  g96(.a(new_n140_), .b(new_n46_), .c(x09), .d(new_n59_), .O(new_n141_));
