...
module FAU ( 
  ...
  nand2  g027(.a(new_n61_), .b(x07), .O(new_n72_));
  ...
  oai21  g051(.a(new_n62_), .b(new_n60_), .c(new_n95_), .O(z11));
  inv1   g052(.a(x09), .O(new_n97_));
  oai21  g053(.a(x20), .b(new_n97_), .c(x19), .O(new_n98_));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n101_), .c(x08), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n97_), .c(new_n47_), .O(new_n106_));
  ...
  oai21  g070(.a(new_n62_), .b(new_n66_), .c(new_n114_), .O(z13));
  ...
  oai21  g081(.a(new_n111_), .b(new_n75_), .c(x09), .O(new_n126_));
  aoi21  g082(.a(x26), .b(x17), .c(new_n120_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n126_), .c(new_n103_), .d(x21), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x25), .O(new_n129_));
  inv1   g085(.a(x25), .O(new_n130_));
  nor2   g086(.a(new_n111_), .b(new_n75_), .O(new_n131_));
  nand4  g087(.a(new_n121_), .b(new_n131_), .c(new_n130_), .d(x24), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n129_), .c(x08), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n97_), .c(new_n47_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n70_), .O(z15));
  nor2   g091(.a(new_n102_), .b(x18), .O(new_n136_));
  nor2   g092(.a(new_n130_), .b(new_n120_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n136_), .c(new_n126_), .d(x21), .O(new_n138_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n97_), .c(new_n47_), .O(new_n144_));
