...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n74_), .c(new_n47_), .O(new_n96_));
  ...
  aoi21  g063(.a(new_n107_), .b(x21), .c(new_n74_), .O(new_n108_));
  nand3  g064(.a(x22), .b(x20), .c(x19), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n108_), .c(x23), .O(new_n110_));
  ...
  aoi21  g082(.a(new_n126_), .b(x23), .c(new_n74_), .O(new_n127_));
  nand3  g083(.a(x24), .b(x22), .c(x21), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n102_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n127_), .c(x25), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  nor2   g088(.a(new_n111_), .b(new_n76_), .O(new_n133_));
  nand4  g089(.a(new_n121_), .b(new_n133_), .c(new_n132_), .d(x24), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(x08), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n74_), .c(new_n47_), .O(new_n136_));
  ...
  nor2   g097(.a(new_n120_), .b(new_n111_), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n132_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n102_), .c(new_n142_), .d(new_n77_), .O(new_n144_));
