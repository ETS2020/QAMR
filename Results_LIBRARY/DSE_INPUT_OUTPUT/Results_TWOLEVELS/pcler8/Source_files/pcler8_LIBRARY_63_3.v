...
module FAU ( 
  ...
  nand4  g053(.a(x26), .b(x25), .c(x24), .d(x22), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n97_), .c(new_n47_), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x23), .O(new_n100_));
  ...
  oai22  g060(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n75_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n100_), .c(new_n64_), .O(z12));
  ...
  nand4  g067(.a(new_n111_), .b(new_n54_), .c(x22), .d(x21), .O(new_n112_));
  ...
  oai21  g074(.a(new_n117_), .b(new_n103_), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x23), .O(new_n120_));
  nor2   g076(.a(new_n54_), .b(new_n75_), .O(new_n121_));
  nand3  g077(.a(new_n111_), .b(new_n121_), .c(x21), .O(new_n122_));
  ...
  aoi21  g083(.a(x24), .b(x23), .c(x10), .O(new_n128_));
  nand2  g084(.a(x26), .b(x17), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n111_), .c(x22), .d(x21), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(x23), .c(new_n128_), .O(new_n131_));
  nand4  g087(.a(new_n102_), .b(new_n121_), .c(new_n127_), .d(x24), .O(new_n132_));
  oai21  g088(.a(new_n131_), .b(new_n127_), .c(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x09), .c(new_n46_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n70_), .c(new_n56_), .O(z15));
  inv1   g091(.a(x18), .O(new_n136_));
  nand4  g092(.a(x21), .b(x20), .c(x19), .d(new_n136_), .O(new_n137_));
  nand3  g093(.a(new_n121_), .b(x25), .c(x24), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(x26), .O(new_n139_));
  nor2   g095(.a(new_n116_), .b(new_n54_), .O(new_n140_));
  nor2   g096(.a(x26), .b(new_n127_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n111_), .c(new_n140_), .d(new_n76_), .O(new_n142_));
