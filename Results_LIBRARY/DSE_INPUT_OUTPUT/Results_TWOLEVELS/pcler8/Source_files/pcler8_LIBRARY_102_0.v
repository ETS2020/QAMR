...
module FAU ( 
  ...
  nor2   g10(.a(x24), .b(x10), .O(new_n55_));
  ...
  oai21  g20(.a(new_n46_), .b(new_n64_), .c(new_n61_), .O(z04));
  ...
  oai21  g26(.a(new_n46_), .b(new_n70_), .c(new_n61_), .O(z07));
  ...
  aoi21  g63(.a(new_n107_), .b(new_n106_), .c(new_n82_), .O(new_n108_));
  nand4  g64(.a(new_n108_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n109_));
  oai21  g65(.a(new_n57_), .b(new_n64_), .c(new_n109_), .O(z12));
  nand3  g66(.a(x26), .b(x25), .c(x15), .O(new_n111_));
  ...
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(new_n82_), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n116_));
  oai21  g72(.a(new_n57_), .b(new_n66_), .c(new_n116_), .O(z13));
  nand2  g73(.a(x23), .b(x22), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(x21), .O(new_n119_));
  nand3  g75(.a(x26), .b(x25), .c(x16), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n119_), .c(x20), .d(x19), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(x24), .O(new_n122_));
  aoi21  g78(.a(new_n122_), .b(new_n98_), .c(new_n92_), .O(new_n123_));
  aoi21  g79(.a(new_n123_), .b(new_n46_), .c(new_n82_), .O(new_n124_));
  oai21  g80(.a(new_n124_), .b(x10), .c(new_n68_), .O(z14));
  ...
  nand3  g87(.a(new_n131_), .b(new_n130_), .c(x22), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n129_), .c(new_n82_), .O(new_n133_));
  nand4  g89(.a(new_n133_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n134_));
  oai21  g90(.a(new_n57_), .b(new_n70_), .c(new_n134_), .O(z15));
  inv1   g91(.a(x18), .O(new_n136_));
  nand3  g92(.a(x20), .b(x19), .c(new_n136_), .O(new_n137_));
  nand4  g93(.a(x25), .b(x23), .c(x22), .d(x21), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n137_), .c(x26), .O(new_n139_));
  nand4  g95(.a(new_n130_), .b(new_n77_), .c(new_n45_), .d(x25), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n139_), .c(new_n92_), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n46_), .c(new_n82_), .O(new_n142_));
  oai22  g98(.a(new_n142_), .b(x10), .c(new_n57_), .d(new_n72_), .O(z16));
endmodule
