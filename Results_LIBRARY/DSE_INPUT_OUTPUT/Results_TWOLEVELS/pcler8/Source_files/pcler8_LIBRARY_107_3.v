...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n139_;
  and2   g00(.a(x10), .b(x07), .O(new_n45_));
  ...
  nor2   g30(.a(new_n74_), .b(x10), .O(z08));
  ...
  nand3  g94(.a(new_n138_), .b(x09), .c(new_n47_), .O(new_n139_));
  aoi21  g95(.a(new_n139_), .b(new_n74_), .c(x10), .O(z16));
endmodule
