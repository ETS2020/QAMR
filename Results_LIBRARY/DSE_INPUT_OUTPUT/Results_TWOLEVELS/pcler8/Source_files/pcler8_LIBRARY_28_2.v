...
module FAU ( 
  ...
  nand2  g09(.a(new_n54_), .b(new_n53_), .O(z03));
  ...
  oai21  g21(.a(new_n66_), .b(new_n58_), .c(new_n53_), .O(z13));
  oai21  g22(.a(new_n66_), .b(new_n60_), .c(new_n53_), .O(z14));
  oai21  g23(.a(new_n66_), .b(new_n62_), .c(new_n53_), .O(z15));
  zero   g24(.O(z00));
  nor2   g25(.a(new_n48_), .b(new_n46_), .O(z09));
  nor2   g26(.a(new_n48_), .b(new_n50_), .O(z10));
  nand2  g27(.a(new_n54_), .b(new_n53_), .O(z11));
  nor2   g28(.a(new_n48_), .b(new_n56_), .O(z12));
  nand2  g29(.a(new_n64_), .b(new_n53_), .O(z16));
endmodule
