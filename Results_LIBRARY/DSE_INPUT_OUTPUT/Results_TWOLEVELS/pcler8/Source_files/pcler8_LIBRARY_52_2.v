...
module FAU ( 
  ...
  nand2  g16(.a(new_n55_), .b(x10), .O(new_n61_));
  ...
  nand3  g51(.a(new_n95_), .b(new_n62_), .c(new_n61_), .O(z11));
  ...
  nand3  g87(.a(new_n131_), .b(new_n70_), .c(new_n61_), .O(z15));
  ...
  nand3  g97(.a(new_n141_), .b(new_n72_), .c(new_n61_), .O(z16));
endmodule
