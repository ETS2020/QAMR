...
module FAU ( 
  ...
  wire new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_,
    ...
    new_n60_, new_n62_, new_n64_, new_n66_, new_n68_, new_n69_, new_n70_,
  ...
  oai21  g22(.a(new_n58_), .b(new_n66_), .c(new_n60_), .O(z04));
  inv1   g23(.a(x04), .O(new_n68_));
  nor2   g24(.a(new_n59_), .b(new_n58_), .O(new_n69_));
  inv1   g25(.a(new_n69_), .O(new_n70_));
  nor2   g26(.a(new_n70_), .b(new_n68_), .O(z05));
  inv1   g27(.a(x05), .O(new_n72_));
  nor2   g28(.a(new_n70_), .b(new_n72_), .O(z06));
  nand2  g29(.a(new_n69_), .b(x06), .O(new_n74_));
  inv1   g30(.a(new_n74_), .O(z07));
  nand2  g31(.a(new_n69_), .b(x07), .O(new_n76_));
  ...
  oai21  g63(.a(new_n70_), .b(new_n66_), .c(new_n107_), .O(z12));
  ...
  oai21  g70(.a(new_n70_), .b(new_n68_), .c(new_n114_), .O(z13));
