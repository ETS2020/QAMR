...
module FAU ( 
  ...
  nand4  g052(.a(new_n96_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n97_));
  ...
  nand2  g064(.a(new_n47_), .b(x09), .O(new_n109_));
  ...
  nand4  g069(.a(new_n103_), .b(new_n51_), .c(x22), .d(x21), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n113_), .c(x08), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n108_), .c(new_n78_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n70_), .O(z13));
  nand3  g073(.a(new_n109_), .b(x21), .c(x19), .O(new_n118_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n108_), .c(new_n78_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n72_), .O(z14));
  ...
  nand4  g090(.a(new_n134_), .b(new_n78_), .c(x09), .d(new_n58_), .O(new_n135_));
