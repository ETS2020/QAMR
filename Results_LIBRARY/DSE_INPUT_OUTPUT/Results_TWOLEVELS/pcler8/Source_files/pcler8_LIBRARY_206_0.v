...
module FAU ( 
  ...
  nand2  g026(.a(new_n70_), .b(new_n64_), .O(z07));
  ...
  aoi21  g063(.a(x21), .b(x20), .c(new_n74_), .O(new_n108_));
  nand4  g064(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x22), .c(x19), .O(new_n110_));
  ...
  oai21  g070(.a(new_n114_), .b(new_n74_), .c(new_n47_), .O(new_n115_));
  ...
  nand3  g075(.a(x23), .b(x22), .c(x19), .O(new_n120_));
  aoi21  g076(.a(new_n119_), .b(x09), .c(new_n120_), .O(new_n121_));
  nand3  g077(.a(x21), .b(x20), .c(x19), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n117_), .c(x23), .d(x22), .O(new_n124_));
  oai21  g080(.a(new_n121_), .b(new_n117_), .c(new_n124_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n46_), .c(new_n74_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(x10), .c(new_n68_), .O(z14));
  nand3  g083(.a(x26), .b(x17), .c(x09), .O(new_n128_));
  ...
  nor2   g087(.a(new_n112_), .b(new_n76_), .O(new_n132_));
  ...
  nor2   g096(.a(new_n117_), .b(new_n112_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n103_), .c(new_n141_), .d(new_n77_), .O(new_n143_));
