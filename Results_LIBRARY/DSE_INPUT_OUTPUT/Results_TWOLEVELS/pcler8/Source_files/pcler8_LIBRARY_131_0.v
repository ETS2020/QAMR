...
module FAU ( 
  ...
  nor2   g09(.a(x21), .b(x10), .O(new_n54_));
  ...
  oai21  g18(.a(new_n46_), .b(new_n62_), .c(new_n55_), .O(z03));
  ...
  nand3  g37(.a(x23), .b(x22), .c(x12), .O(new_n82_));
  ...
  aoi21  g43(.a(new_n87_), .b(new_n85_), .c(new_n74_), .O(new_n88_));
  ...
  nand4  g47(.a(new_n91_), .b(x23), .c(x22), .d(x13), .O(new_n92_));
  nand3  g48(.a(new_n92_), .b(x20), .c(x19), .O(new_n93_));
  nand4  g49(.a(new_n93_), .b(x21), .c(new_n47_), .d(x09), .O(new_n94_));
  oai22  g50(.a(new_n94_), .b(x08), .c(new_n60_), .d(new_n62_), .O(z11));
  inv1   g51(.a(x09), .O(new_n96_));
  inv1   g52(.a(x19), .O(new_n97_));
  nand2  g53(.a(x23), .b(x14), .O(new_n98_));
  oai21  g54(.a(new_n98_), .b(new_n83_), .c(x20), .O(new_n99_));
  oai21  g55(.a(new_n99_), .b(new_n97_), .c(x22), .O(new_n100_));
  inv1   g56(.a(x22), .O(new_n101_));
  nand3  g57(.a(new_n101_), .b(x20), .c(x19), .O(new_n102_));
  aoi21  g58(.a(new_n102_), .b(new_n100_), .c(new_n96_), .O(new_n103_));
  aoi21  g59(.a(new_n103_), .b(new_n46_), .c(new_n74_), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(x10), .c(new_n64_), .O(z12));
  ...
  nand3  g66(.a(new_n106_), .b(new_n110_), .c(x22), .O(new_n111_));
  aoi21  g67(.a(new_n111_), .b(new_n109_), .c(new_n74_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n113_));
  oai21  g69(.a(new_n60_), .b(new_n66_), .c(new_n113_), .O(z13));
  nand2  g70(.a(new_n101_), .b(x21), .O(new_n115_));
  nand3  g71(.a(x26), .b(x25), .c(x16), .O(new_n116_));
  nand4  g72(.a(new_n116_), .b(new_n115_), .c(new_n106_), .d(x23), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(x24), .O(new_n118_));
  inv1   g74(.a(x24), .O(new_n119_));
  nand4  g75(.a(new_n106_), .b(new_n119_), .c(x23), .d(x22), .O(new_n120_));
  aoi21  g76(.a(new_n120_), .b(new_n118_), .c(new_n96_), .O(new_n121_));
  aoi21  g77(.a(new_n121_), .b(new_n46_), .c(new_n74_), .O(new_n122_));
  oai21  g78(.a(new_n122_), .b(x10), .c(new_n68_), .O(z14));
  nand3  g79(.a(new_n115_), .b(x20), .c(x19), .O(new_n124_));
  ...
  nand3  g83(.a(x22), .b(x20), .c(x19), .O(new_n128_));
  inv1   g84(.a(new_n128_), .O(new_n129_));
  nor2   g85(.a(x25), .b(new_n119_), .O(new_n130_));
  nand3  g86(.a(new_n130_), .b(new_n129_), .c(x23), .O(new_n131_));
  aoi21  g87(.a(new_n131_), .b(new_n127_), .c(new_n96_), .O(new_n132_));
  aoi21  g88(.a(new_n132_), .b(new_n46_), .c(new_n74_), .O(new_n133_));
  oai21  g89(.a(new_n133_), .b(x10), .c(new_n70_), .O(z15));
  inv1   g90(.a(x18), .O(new_n135_));
  nand2  g91(.a(new_n106_), .b(new_n135_), .O(new_n136_));
  and2   g92(.a(x25), .b(x24), .O(new_n137_));
  nand3  g93(.a(new_n137_), .b(new_n115_), .c(x23), .O(new_n138_));
  oai21  g94(.a(new_n138_), .b(new_n136_), .c(x26), .O(new_n139_));
  nor2   g95(.a(new_n119_), .b(new_n110_), .O(new_n140_));
  nand4  g96(.a(new_n129_), .b(new_n140_), .c(new_n45_), .d(x25), .O(new_n141_));
  aoi21  g97(.a(new_n141_), .b(new_n139_), .c(new_n96_), .O(new_n142_));
  aoi21  g98(.a(new_n142_), .b(new_n46_), .c(new_n74_), .O(new_n143_));
