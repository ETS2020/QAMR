...
module FAU ( 
  ...
  nor2   g53(.a(new_n47_), .b(new_n45_), .O(new_n98_));
  ...
  nand4  g67(.a(new_n98_), .b(new_n51_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n107_), .c(new_n77_), .O(new_n114_));
  ...
  oai21  g79(.a(new_n123_), .b(new_n107_), .c(new_n77_), .O(new_n124_));
  ...
  oai21  g87(.a(new_n131_), .b(new_n107_), .c(new_n77_), .O(new_n132_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n98_), .c(new_n138_), .d(new_n78_), .O(new_n140_));
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x08), .O(new_n141_));
  oai21  g97(.a(new_n141_), .b(new_n107_), .c(new_n77_), .O(new_n142_));
