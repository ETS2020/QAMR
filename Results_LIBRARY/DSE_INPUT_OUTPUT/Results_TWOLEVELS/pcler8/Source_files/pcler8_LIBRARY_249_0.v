...
module FAU ( 
  ...
  oai21  g020(.a(new_n56_), .b(new_n63_), .c(new_n64_), .O(z03));
  nand2  g021(.a(x08), .b(x03), .O(new_n66_));
  nand2  g022(.a(new_n66_), .b(new_n64_), .O(z04));
  inv1   g023(.a(x04), .O(new_n68_));
  nor2   g024(.a(new_n59_), .b(new_n68_), .O(z05));
  nand2  g025(.a(new_n58_), .b(x05), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(z06));
  inv1   g027(.a(x06), .O(new_n72_));
  oai21  g028(.a(new_n56_), .b(new_n72_), .c(new_n64_), .O(z07));
  ...
  oai21  g047(.a(new_n91_), .b(new_n51_), .c(x20), .O(new_n92_));
  ...
  nand4  g051(.a(new_n95_), .b(new_n76_), .c(x09), .d(new_n56_), .O(new_n96_));
  oai21  g052(.a(new_n59_), .b(new_n63_), .c(new_n96_), .O(z11));
  inv1   g053(.a(x09), .O(new_n98_));
  oai21  g054(.a(x20), .b(new_n98_), .c(x19), .O(new_n99_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n77_), .c(x21), .O(new_n105_));
  aoi21  g061(.a(new_n105_), .b(new_n102_), .c(x08), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n98_), .c(new_n76_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n66_), .O(z12));
  ...
  nand4  g070(.a(new_n114_), .b(new_n76_), .c(x09), .d(new_n56_), .O(new_n115_));
  oai21  g071(.a(new_n59_), .b(new_n68_), .c(new_n115_), .O(z13));
  nand3  g072(.a(x21), .b(x20), .c(x19), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand2  g074(.a(new_n77_), .b(x09), .O(new_n119_));
  nand3  g075(.a(x26), .b(x25), .c(x16), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n119_), .c(new_n118_), .d(x23), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x24), .O(new_n122_));
  inv1   g078(.a(x24), .O(new_n123_));
  nand4  g079(.a(new_n118_), .b(new_n123_), .c(x23), .d(x22), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n122_), .c(x08), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n98_), .c(new_n76_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n70_), .O(z14));
  nand2  g083(.a(x26), .b(x17), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n50_), .c(x24), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n117_), .c(x25), .O(new_n130_));
  inv1   g086(.a(x25), .O(new_n131_));
  nand4  g087(.a(new_n118_), .b(new_n50_), .c(new_n131_), .d(x24), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n76_), .c(x09), .d(new_n56_), .O(new_n134_));
  oai21  g090(.a(new_n59_), .b(new_n72_), .c(new_n134_), .O(z15));
  inv1   g091(.a(x18), .O(new_n136_));
  nand4  g092(.a(x21), .b(x20), .c(x19), .d(new_n136_), .O(new_n137_));
  nand2  g093(.a(new_n123_), .b(x09), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n50_), .c(x25), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(x26), .O(new_n140_));
  nor2   g096(.a(new_n123_), .b(new_n112_), .O(new_n141_));
  nor2   g097(.a(x26), .b(new_n131_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n104_), .c(new_n141_), .d(new_n78_), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n140_), .c(x08), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n98_), .c(new_n76_), .O(new_n145_));
