...
module FAU ( 
  ...
  nor2   g17(.a(new_n59_), .b(new_n61_), .O(new_n62_));
  nand2  g18(.a(new_n62_), .b(x00), .O(new_n63_));
  nand2  g19(.a(new_n63_), .b(new_n60_), .O(z01));
  nand2  g20(.a(new_n62_), .b(x01), .O(new_n65_));
  inv1   g21(.a(new_n65_), .O(z02));
  nand2  g22(.a(new_n62_), .b(x02), .O(new_n67_));
  nand2  g23(.a(new_n67_), .b(new_n60_), .O(z03));
  nand2  g24(.a(new_n62_), .b(x03), .O(new_n69_));
  inv1   g25(.a(new_n69_), .O(z04));
  nand2  g26(.a(x08), .b(x04), .O(new_n71_));
  nand2  g27(.a(new_n71_), .b(new_n60_), .O(z05));
  nand2  g28(.a(new_n62_), .b(x05), .O(new_n73_));
  inv1   g29(.a(new_n73_), .O(z06));
  nand2  g30(.a(new_n62_), .b(x06), .O(new_n75_));
  ...
  nand4  g38(.a(new_n82_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n83_));
  nand2  g39(.a(new_n83_), .b(new_n63_), .O(z09));
  ...
  nand4  g44(.a(new_n88_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n89_));
  ...
  nand4  g51(.a(new_n95_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n96_));
  nand2  g52(.a(new_n96_), .b(new_n67_), .O(z11));
  nor2   g53(.a(new_n49_), .b(new_n47_), .O(new_n98_));
  ...
  nand3  g58(.a(new_n98_), .b(new_n52_), .c(x21), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand4  g60(.a(new_n104_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n105_));
  nand2  g61(.a(new_n105_), .b(new_n69_), .O(z12));
  oai21  g62(.a(x20), .b(x10), .c(x19), .O(new_n107_));
  ...
  nand4  g78(.a(new_n122_), .b(new_n46_), .c(x09), .d(new_n61_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n73_), .O(z14));
  aoi21  g80(.a(new_n53_), .b(new_n46_), .c(new_n52_), .O(new_n125_));
  ...
  nand4  g85(.a(new_n120_), .b(new_n54_), .c(new_n129_), .d(x24), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n128_), .c(x08), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(x10), .c(x09), .O(new_n132_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n98_), .c(new_n138_), .d(new_n79_), .O(new_n140_));
