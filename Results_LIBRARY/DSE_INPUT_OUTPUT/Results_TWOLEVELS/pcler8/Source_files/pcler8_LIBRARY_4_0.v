...
module FAU ( 
  ...
  nand4  g067(.a(new_n102_), .b(new_n107_), .c(x22), .d(x21), .O(new_n112_));
  oai21  g068(.a(new_n111_), .b(new_n107_), .c(new_n112_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n46_), .c(new_n74_), .O(new_n114_));
  ...
  nor2   g086(.a(new_n107_), .b(new_n76_), .O(new_n131_));
  ...
  nor2   g095(.a(new_n116_), .b(new_n107_), .O(new_n140_));
