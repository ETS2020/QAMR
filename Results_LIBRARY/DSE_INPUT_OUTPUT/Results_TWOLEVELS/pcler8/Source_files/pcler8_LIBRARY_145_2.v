...
module FAU ( 
  ...
  nor2   g11(.a(new_n50_), .b(new_n55_), .O(z03));
  ...
  oai21  g21(.a(new_n53_), .b(new_n65_), .c(new_n46_), .O(z08));
  oai21  g22(.a(new_n53_), .b(new_n48_), .c(new_n46_), .O(z09));
  nor2   g23(.a(new_n50_), .b(new_n52_), .O(z10));
  oai21  g24(.a(new_n53_), .b(new_n55_), .c(new_n46_), .O(z11));
  oai21  g25(.a(new_n53_), .b(new_n59_), .c(new_n46_), .O(z13));
  nor2   g26(.a(new_n50_), .b(new_n65_), .O(z16));
  nor2   g27(.a(new_n50_), .b(new_n57_), .O(z12));
  nor2   g28(.a(new_n50_), .b(new_n61_), .O(z14));
