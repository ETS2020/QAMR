...
module FAU ( 
  ...
  aoi21  g019(.a(x10), .b(new_n48_), .c(new_n47_), .O(z03));
  nand2  g020(.a(x08), .b(x03), .O(new_n65_));
  nand2  g021(.a(new_n65_), .b(new_n58_), .O(z04));
  inv1   g022(.a(x04), .O(new_n67_));
  oai21  g023(.a(new_n48_), .b(new_n67_), .c(new_n58_), .O(z05));
  inv1   g024(.a(x05), .O(new_n69_));
  oai21  g025(.a(new_n48_), .b(new_n69_), .c(new_n58_), .O(z06));
  ...
  oai22  g036(.a(new_n80_), .b(x02), .c(new_n62_), .d(new_n56_), .O(z09));
  ...
  nand4  g053(.a(new_n97_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n98_));
  nand3  g054(.a(x10), .b(x08), .c(x02), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(z11));
  oai21  g056(.a(x20), .b(x02), .c(x19), .O(new_n101_));
  ...
  nand4  g072(.a(new_n116_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n117_));
  oai21  g073(.a(new_n62_), .b(new_n67_), .c(new_n117_), .O(z13));
  ...
  oai21  g083(.a(new_n62_), .b(new_n69_), .c(new_n127_), .O(z14));
  oai21  g084(.a(new_n114_), .b(new_n46_), .c(new_n47_), .O(new_n129_));
  aoi21  g085(.a(x26), .b(x17), .c(new_n123_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n129_), .c(new_n105_), .d(x21), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x25), .O(new_n132_));
  inv1   g088(.a(x25), .O(new_n133_));
  nor2   g089(.a(new_n114_), .b(new_n46_), .O(new_n134_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n48_), .c(x02), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(x10), .c(new_n71_), .O(z15));
  ...
  nand4  g102(.a(new_n146_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n147_));
  oai21  g103(.a(new_n62_), .b(new_n73_), .c(new_n147_), .O(z16));
endmodule
