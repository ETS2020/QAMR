...
module FAU ( 
  ...
  nand3  g66(.a(new_n110_), .b(new_n68_), .c(new_n47_), .O(z13));
  ...
  nand4  g81(.a(new_n117_), .b(new_n54_), .c(new_n125_), .d(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand4  g83(.a(new_n127_), .b(new_n45_), .c(x09), .d(new_n48_), .O(new_n128_));
  nor2   g84(.a(z07), .b(new_n46_), .O(new_n129_));
  ...
  nand3  g95(.a(new_n139_), .b(new_n73_), .c(new_n47_), .O(z16));
endmodule
