...
module FAU ( 
  ...
  nand3  g30(.a(new_n59_), .b(x08), .c(x07), .O(new_n75_));
  ...
  oai22  g39(.a(new_n83_), .b(x08), .c(new_n60_), .d(new_n57_), .O(z09));
  ...
  aoi21  g45(.a(new_n89_), .b(new_n87_), .c(x17), .O(new_n90_));
  nand4  g46(.a(new_n90_), .b(new_n77_), .c(x09), .d(new_n63_), .O(new_n91_));
  ...
  nand4  g54(.a(new_n98_), .b(new_n77_), .c(x09), .d(new_n63_), .O(new_n99_));
  oai21  g55(.a(new_n60_), .b(new_n65_), .c(new_n99_), .O(z11));
  oai21  g56(.a(x20), .b(x17), .c(x19), .O(new_n101_));
  ...
  aoi21  g64(.a(new_n108_), .b(new_n63_), .c(x17), .O(new_n109_));
  ...
  aoi21  g70(.a(new_n114_), .b(new_n113_), .c(x17), .O(new_n115_));
  nand4  g71(.a(new_n115_), .b(new_n77_), .c(x09), .d(new_n63_), .O(new_n116_));
  oai21  g72(.a(new_n60_), .b(new_n69_), .c(new_n116_), .O(z13));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n120_), .c(x17), .O(new_n123_));
  nand4  g79(.a(new_n123_), .b(new_n77_), .c(x09), .d(new_n63_), .O(new_n124_));
  oai21  g80(.a(new_n60_), .b(new_n71_), .c(new_n124_), .O(z14));
  aoi21  g81(.a(x23), .b(x22), .c(x17), .O(new_n126_));
  nand4  g82(.a(x24), .b(x21), .c(x20), .d(x19), .O(new_n127_));
  ...
  aoi21  g87(.a(new_n131_), .b(new_n63_), .c(x17), .O(new_n132_));
  oai22  g88(.a(new_n132_), .b(x10), .c(new_n60_), .d(new_n73_), .O(z15));
  ...
  aoi21  g96(.a(new_n140_), .b(new_n137_), .c(x17), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n77_), .c(x09), .d(new_n63_), .O(new_n142_));
