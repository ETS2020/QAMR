...
module FAU ( 
  ...
  nand2  g017(.a(new_n61_), .b(new_n59_), .O(z03));
  ...
  nand3  g037(.a(new_n81_), .b(new_n56_), .c(new_n59_), .O(z09));
  ...
  nor3   g048(.a(new_n92_), .b(new_n91_), .c(new_n72_), .O(new_n93_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n92_), .c(x20), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n96_), .c(x21), .O(new_n99_));
  nand3  g055(.a(new_n72_), .b(x20), .c(x19), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n61_), .c(new_n59_), .O(z11));
  nand3  g059(.a(x21), .b(x20), .c(x19), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n73_), .b(x21), .c(x20), .d(x19), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n73_), .c(new_n106_), .O(new_n107_));
  ...
  nor2   g067(.a(new_n92_), .b(new_n91_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n88_), .c(x14), .d(new_n47_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n111_), .O(z12));
  nor2   g070(.a(new_n76_), .b(x19), .O(new_n115_));
  nand4  g071(.a(new_n76_), .b(x22), .c(x21), .d(x19), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n115_), .c(x20), .O(new_n118_));
  aoi21  g074(.a(x21), .b(x20), .c(new_n73_), .O(new_n119_));
  ...
  nand3  g080(.a(new_n124_), .b(new_n64_), .c(new_n59_), .O(z13));
  nand2  g081(.a(x26), .b(x16), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x23), .O(new_n127_));
  nand4  g083(.a(x22), .b(x21), .c(x20), .d(x19), .O(new_n128_));
  aoi22  g084(.a(new_n128_), .b(x23), .c(new_n127_), .d(x25), .O(new_n129_));
  nand4  g085(.a(new_n105_), .b(new_n77_), .c(x23), .d(x22), .O(new_n130_));
  oai21  g086(.a(new_n129_), .b(new_n77_), .c(new_n130_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n66_), .O(z14));
  nand2  g089(.a(x25), .b(new_n96_), .O(new_n134_));
  ...
  oai21  g097(.a(new_n141_), .b(new_n119_), .c(x25), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n68_), .O(z15));
  nand2  g101(.a(x26), .b(new_n136_), .O(new_n146_));
  nand4  g102(.a(new_n45_), .b(x25), .c(x24), .d(x22), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n104_), .c(new_n146_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x23), .O(new_n149_));
  inv1   g105(.a(x18), .O(new_n150_));
  and2   g106(.a(x20), .b(x19), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n78_), .c(new_n74_), .d(new_n150_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(x26), .c(x25), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n149_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n70_), .O(z16));
endmodule
