...
module FAU ( 
  ...
  nand2  g11(.a(new_n47_), .b(new_n55_), .O(new_n56_));
  ...
  oai21  g27(.a(new_n46_), .b(new_n71_), .c(new_n56_), .O(z08));
  ...
  aoi21  g34(.a(new_n78_), .b(new_n46_), .c(new_n55_), .O(new_n79_));
  oai22  g35(.a(new_n79_), .b(x10), .c(new_n57_), .d(new_n54_), .O(z09));
  ...
  nand2  g42(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  nand2  g43(.a(new_n87_), .b(new_n59_), .O(z10));
  ...
  oai21  g47(.a(new_n91_), .b(new_n83_), .c(x21), .O(new_n92_));
  ...
  oai21  g51(.a(new_n57_), .b(new_n61_), .c(new_n95_), .O(z11));
  nand2  g52(.a(x23), .b(x14), .O(new_n97_));
  oai21  g53(.a(new_n97_), .b(new_n90_), .c(x20), .O(new_n98_));
  nand2  g54(.a(x21), .b(x19), .O(new_n99_));
  aoi21  g55(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  nand2  g56(.a(x20), .b(x19), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(new_n102_));
  nand3  g58(.a(new_n102_), .b(new_n74_), .c(x21), .O(new_n103_));
  oai21  g59(.a(new_n100_), .b(new_n74_), .c(new_n103_), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n46_), .c(new_n55_), .O(new_n105_));
  oai21  g61(.a(new_n105_), .b(x10), .c(new_n63_), .O(z12));
  nand4  g62(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n107_));
  nand3  g63(.a(new_n107_), .b(x22), .c(x21), .O(new_n108_));
  oai21  g64(.a(new_n108_), .b(new_n101_), .c(x23), .O(new_n109_));
  ...
  oai21  g69(.a(new_n57_), .b(new_n65_), .c(new_n113_), .O(z13));
  nand3  g70(.a(x21), .b(x20), .c(x19), .O(new_n115_));
  nand4  g71(.a(x26), .b(x25), .c(x16), .d(x09), .O(new_n116_));
  ...
  oai21  g78(.a(new_n122_), .b(new_n55_), .c(new_n47_), .O(new_n123_));
  nand2  g79(.a(new_n123_), .b(new_n67_), .O(z14));
  nand3  g80(.a(x26), .b(x17), .c(x09), .O(new_n125_));
  ...
  nor2   g84(.a(new_n110_), .b(new_n74_), .O(new_n129_));
  nand4  g85(.a(new_n120_), .b(new_n129_), .c(new_n128_), .d(x24), .O(new_n130_));
  aoi21  g86(.a(new_n130_), .b(new_n127_), .c(x08), .O(new_n131_));
  oai21  g87(.a(new_n131_), .b(new_n55_), .c(new_n47_), .O(new_n132_));
  oai21  g88(.a(new_n57_), .b(new_n69_), .c(new_n132_), .O(z15));
  inv1   g89(.a(x18), .O(new_n134_));
  nand4  g90(.a(x21), .b(x20), .c(x19), .d(new_n134_), .O(new_n135_));
  nand3  g91(.a(new_n129_), .b(x25), .c(x24), .O(new_n136_));
  oai21  g92(.a(new_n136_), .b(new_n135_), .c(x26), .O(new_n137_));
  nor2   g93(.a(new_n119_), .b(new_n110_), .O(new_n138_));
  nor2   g94(.a(x26), .b(new_n128_), .O(new_n139_));
  nand4  g95(.a(new_n139_), .b(new_n102_), .c(new_n138_), .d(new_n75_), .O(new_n140_));
  nand2  g96(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand4  g97(.a(new_n141_), .b(new_n47_), .c(x09), .d(new_n46_), .O(new_n142_));
  oai21  g98(.a(new_n57_), .b(new_n71_), .c(new_n142_), .O(z16));
endmodule
