...
module FAU ( 
  ...
  oai21  g41(.a(new_n85_), .b(x08), .c(new_n47_), .O(new_n86_));
  ...
  oai21  g59(.a(new_n103_), .b(x10), .c(x09), .O(new_n104_));
  ...
  oai21  g79(.a(new_n109_), .b(new_n74_), .c(new_n47_), .O(new_n124_));
  aoi21  g80(.a(x26), .b(x17), .c(new_n118_), .O(new_n125_));
  nand4  g81(.a(new_n125_), .b(new_n124_), .c(new_n101_), .d(x21), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(x25), .O(new_n127_));
  inv1   g83(.a(x25), .O(new_n128_));
  nor2   g84(.a(new_n109_), .b(new_n74_), .O(new_n129_));
  ...
  nor2   g89(.a(new_n97_), .b(x18), .O(new_n134_));
  nor2   g90(.a(new_n128_), .b(new_n118_), .O(new_n135_));
  nand4  g91(.a(new_n135_), .b(new_n134_), .c(new_n124_), .d(x21), .O(new_n136_));
  ...
  nand4  g95(.a(new_n139_), .b(new_n101_), .c(new_n138_), .d(new_n75_), .O(new_n140_));
