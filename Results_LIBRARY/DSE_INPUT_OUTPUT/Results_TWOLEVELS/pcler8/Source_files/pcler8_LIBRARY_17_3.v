...
module FAU ( 
  ...
  nand2  g16(.a(new_n54_), .b(x08), .O(new_n61_));
  ...
  nand2  g22(.a(new_n62_), .b(x05), .O(new_n67_));
  inv1   g23(.a(new_n67_), .O(z06));
  nand2  g24(.a(new_n62_), .b(x06), .O(new_n69_));
  ...
  nand3  g50(.a(new_n94_), .b(new_n59_), .c(new_n54_), .O(z11));
