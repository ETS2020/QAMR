...
module FAU ( 
  ...
  nand2  g18(.a(new_n61_), .b(x08), .O(new_n63_));
  ...
  nand2  g23(.a(new_n67_), .b(new_n61_), .O(z03));
  ...
  oai21  g39(.a(new_n63_), .b(new_n59_), .c(new_n83_), .O(z09));
  ...
  nand4  g61(.a(new_n105_), .b(new_n46_), .c(x09), .d(new_n60_), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n69_), .O(z12));
  oai21  g63(.a(x20), .b(x10), .c(x19), .O(new_n108_));
