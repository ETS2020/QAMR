...
module FAU ( 
  ...
  nand2  g13(.a(new_n58_), .b(new_n47_), .O(z06));
  ...
  nand2  g22(.a(x20), .b(x09), .O(new_n68_));
  oai21  g23(.a(new_n68_), .b(x08), .c(new_n67_), .O(new_n69_));
  nand2  g24(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  nand2  g25(.a(new_n70_), .b(new_n50_), .O(z10));
  ...
  nand3  g30(.a(new_n75_), .b(new_n73_), .c(new_n46_), .O(new_n76_));
  nand2  g31(.a(new_n76_), .b(new_n52_), .O(z11));
  inv1   g32(.a(x22), .O(new_n78_));
  nor2   g33(.a(new_n78_), .b(x19), .O(new_n79_));
  nand3  g34(.a(new_n79_), .b(new_n73_), .c(new_n46_), .O(new_n80_));
  nand2  g35(.a(new_n80_), .b(new_n54_), .O(z12));
  nand2  g36(.a(x23), .b(x09), .O(new_n82_));
  oai21  g37(.a(new_n82_), .b(x08), .c(new_n67_), .O(new_n83_));
  nand2  g38(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  nand2  g39(.a(new_n84_), .b(new_n56_), .O(z13));
  inv1   g40(.a(x24), .O(new_n86_));
  nor2   g41(.a(new_n86_), .b(x19), .O(new_n87_));
  nand3  g42(.a(new_n87_), .b(new_n73_), .c(new_n46_), .O(new_n88_));
  nand2  g43(.a(new_n88_), .b(new_n58_), .O(z14));
  nand2  g44(.a(x25), .b(x09), .O(new_n90_));
  oai21  g45(.a(new_n90_), .b(x08), .c(new_n67_), .O(new_n91_));
  nand2  g46(.a(new_n91_), .b(new_n46_), .O(new_n92_));
  nand2  g47(.a(new_n92_), .b(new_n60_), .O(z15));
  nand2  g48(.a(x26), .b(x09), .O(new_n94_));
  oai21  g49(.a(new_n94_), .b(x08), .c(new_n67_), .O(new_n95_));
