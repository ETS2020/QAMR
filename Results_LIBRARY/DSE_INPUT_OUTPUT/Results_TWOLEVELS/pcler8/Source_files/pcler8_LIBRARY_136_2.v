...
module FAU ( 
  ...
  nor2   g013(.a(new_n56_), .b(new_n48_), .O(new_n58_));
  ...
  oai21  g036(.a(new_n80_), .b(x01), .c(new_n59_), .O(z09));
  ...
  nand3  g044(.a(x10), .b(x08), .c(x01), .O(new_n89_));
  ...
  nand3  g052(.a(new_n75_), .b(x20), .c(x19), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n96_), .c(new_n91_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n48_), .c(x01), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(x10), .c(new_n62_), .O(z11));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n91_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(new_n48_), .c(x01), .O(new_n108_));
  ...
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(x10), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n116_));
  oai21  g072(.a(new_n67_), .b(new_n66_), .c(new_n116_), .O(z13));
  ...
  nand4  g081(.a(new_n125_), .b(x09), .c(new_n48_), .d(new_n47_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n69_), .O(z14));
  oai21  g083(.a(new_n113_), .b(new_n46_), .c(new_n47_), .O(new_n128_));
  aoi21  g084(.a(x26), .b(x17), .c(new_n122_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n128_), .c(new_n105_), .d(x21), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x25), .O(new_n131_));
  inv1   g087(.a(x25), .O(new_n132_));
  nor2   g088(.a(new_n113_), .b(new_n46_), .O(new_n133_));
  nand4  g089(.a(new_n123_), .b(new_n133_), .c(new_n132_), .d(x24), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n131_), .c(new_n91_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n48_), .c(x01), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(x10), .c(new_n71_), .O(z15));
  nor2   g093(.a(new_n101_), .b(x18), .O(new_n138_));
  nor2   g094(.a(new_n132_), .b(new_n122_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n138_), .c(new_n128_), .d(x21), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x26), .O(new_n141_));
  nor2   g097(.a(new_n122_), .b(new_n113_), .O(new_n142_));
  ...
  aoi21  g101(.a(new_n145_), .b(new_n48_), .c(x01), .O(new_n146_));
