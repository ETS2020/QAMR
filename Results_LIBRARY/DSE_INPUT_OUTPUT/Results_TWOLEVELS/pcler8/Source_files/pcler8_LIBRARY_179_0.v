...
module FAU ( 
  ...
  nor2   g00(.a(x25), .b(x09), .O(new_n45_));
  ...
  nand4  g32(.a(x26), .b(x24), .c(x23), .d(x22), .O(new_n77_));
  oai21  g33(.a(new_n77_), .b(new_n76_), .c(x19), .O(new_n78_));
  nand3  g34(.a(new_n78_), .b(x25), .c(x09), .O(new_n79_));
  inv1   g35(.a(x19), .O(new_n80_));
  inv1   g36(.a(x25), .O(new_n81_));
  nand2  g37(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g38(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  nand3  g39(.a(new_n83_), .b(new_n48_), .c(new_n47_), .O(new_n84_));
  nand3  g40(.a(new_n84_), .b(new_n60_), .c(new_n46_), .O(z09));
  nand3  g41(.a(x22), .b(x21), .c(x12), .O(new_n86_));
  nand4  g42(.a(x26), .b(x25), .c(x24), .d(x23), .O(new_n87_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n93_));
  nand2  g49(.a(new_n93_), .b(new_n62_), .O(z10));
  nand3  g50(.a(x23), .b(x22), .c(x13), .O(new_n95_));
  oai21  g51(.a(new_n95_), .b(new_n55_), .c(x20), .O(new_n96_));
  oai21  g52(.a(new_n96_), .b(new_n80_), .c(x21), .O(new_n97_));
  inv1   g53(.a(x21), .O(new_n98_));
  nand3  g54(.a(new_n98_), .b(x20), .c(x19), .O(new_n99_));
  nand2  g55(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n101_));
  nand2  g57(.a(new_n101_), .b(new_n64_), .O(z11));
  nand2  g58(.a(x23), .b(x14), .O(new_n103_));
  oai21  g59(.a(new_n103_), .b(new_n55_), .c(x21), .O(new_n104_));
  oai21  g60(.a(new_n104_), .b(new_n49_), .c(x22), .O(new_n105_));
  nand3  g61(.a(new_n50_), .b(new_n52_), .c(x21), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n48_), .c(x09), .d(new_n47_), .O(new_n108_));
  nand2  g64(.a(new_n108_), .b(new_n66_), .O(z12));
  ...
  nand3  g71(.a(new_n115_), .b(new_n68_), .c(new_n46_), .O(z13));
  ...
  nand3  g81(.a(new_n125_), .b(new_n70_), .c(new_n46_), .O(z14));
  ...
  nand4  g85(.a(new_n122_), .b(new_n54_), .c(new_n81_), .d(x24), .O(new_n130_));
  ...
  nor2   g93(.a(new_n52_), .b(new_n98_), .O(new_n138_));
  nor2   g94(.a(new_n121_), .b(new_n53_), .O(new_n139_));
  nor2   g95(.a(x26), .b(new_n81_), .O(new_n140_));
  nand4  g96(.a(new_n140_), .b(new_n139_), .c(new_n138_), .d(new_n50_), .O(new_n141_));
  nand2  g97(.a(new_n141_), .b(new_n137_), .O(new_n142_));
