...
module FAU ( 
  ...
  nand2  g26(.a(new_n70_), .b(new_n60_), .O(z05));
  ...
  oai21  g39(.a(new_n66_), .b(new_n57_), .c(new_n83_), .O(z09));
  ...
  oai21  g52(.a(new_n66_), .b(new_n65_), .c(new_n96_), .O(z11));
  ...
  aoi21  g61(.a(new_n105_), .b(new_n102_), .c(x08), .O(new_n106_));
  oai21  g62(.a(new_n106_), .b(new_n98_), .c(new_n78_), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(new_n68_), .O(z12));
  nand4  g64(.a(x26), .b(x25), .c(x24), .d(x15), .O(new_n109_));
  nand3  g65(.a(new_n109_), .b(x22), .c(x21), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n103_), .c(x23), .O(new_n111_));
  nand4  g67(.a(new_n104_), .b(new_n51_), .c(x22), .d(x21), .O(new_n112_));
  aoi21  g68(.a(new_n112_), .b(new_n111_), .c(x08), .O(new_n113_));
  oai21  g69(.a(new_n113_), .b(new_n98_), .c(new_n78_), .O(new_n114_));
  ...
  aoi21  g78(.a(new_n122_), .b(new_n119_), .c(x08), .O(new_n123_));
  oai21  g79(.a(new_n123_), .b(new_n98_), .c(new_n78_), .O(new_n124_));
