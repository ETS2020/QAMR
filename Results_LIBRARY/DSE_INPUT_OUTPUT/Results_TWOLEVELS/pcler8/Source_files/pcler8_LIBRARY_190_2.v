...
module FAU ( 
  ...
  oai21  g22(.a(new_n55_), .b(new_n61_), .c(new_n51_), .O(z14));
  oai21  g23(.a(new_n55_), .b(new_n65_), .c(new_n51_), .O(z16));
  zero   g24(.O(z00));
  nor2   g25(.a(new_n48_), .b(new_n46_), .O(z09));
  nand2  g26(.a(new_n52_), .b(new_n51_), .O(z10));
  nand2  g27(.a(new_n57_), .b(new_n51_), .O(z12));
  nand2  g28(.a(new_n59_), .b(new_n51_), .O(z13));
