...
module FAU ( 
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(x11), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  inv1   g29(.a(x19), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(x11), .O(new_n72_));
  ...
  nor3   g52(.a(new_n72_), .b(x24), .c(new_n93_), .O(new_n94_));
  ...
  nand2  g57(.a(new_n84_), .b(x16), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n73_), .O(z14));
