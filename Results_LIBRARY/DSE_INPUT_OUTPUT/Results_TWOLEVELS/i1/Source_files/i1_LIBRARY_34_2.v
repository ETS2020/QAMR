...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n77_, new_n79_, new_n80_, new_n81_, new_n82_,
    new_n84_, new_n86_, new_n88_, new_n90_, new_n92_, new_n93_, new_n95_,
    new_n97_, new_n100_, new_n101_;
  ...
  nand4  g35(.a(new_n68_), .b(x19), .c(new_n69_), .d(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n66_), .c(new_n43_), .O(z05));
  nand3  g37(.a(new_n63_), .b(new_n50_), .c(new_n61_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n81_));
  nor2   g40(.a(new_n64_), .b(new_n42_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n60_), .O(z06));
  ...
  nand3  g51(.a(new_n92_), .b(x22), .c(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z11));
  nand3  g53(.a(new_n92_), .b(x23), .c(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n88_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z13));
  and2   g57(.a(new_n92_), .b(x16), .O(z14));
