...
module FAU ( 
  ...
  nand2  g01(.a(x22), .b(new_n42_), .O(new_n43_));
  ...
  nand2  g20(.a(new_n49_), .b(new_n48_), .O(new_n62_));
  inv1   g21(.a(x09), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x08), .c(new_n50_), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  aoi22  g24(.a(new_n65_), .b(new_n61_), .c(new_n59_), .d(x00), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n42_), .c(new_n43_), .O(z02));
  ...
  nand4  g32(.a(new_n73_), .b(new_n72_), .c(new_n61_), .d(new_n50_), .O(new_n74_));
  ...
  nand3  g42(.a(x22), .b(x19), .c(x17), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(x24), .O(z11));
  inv1   g44(.a(x23), .O(new_n86_));
  inv1   g45(.a(new_n43_), .O(new_n87_));
  nor3   g46(.a(new_n87_), .b(x24), .c(new_n86_), .O(new_n88_));
