...
module FAU ( 
  ...
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n46_), .O(z11));
  nand2  g50(.a(new_n82_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n87_), .c(new_n46_), .O(z12));
  oai21  g52(.a(new_n92_), .b(new_n90_), .c(new_n46_), .O(z13));
