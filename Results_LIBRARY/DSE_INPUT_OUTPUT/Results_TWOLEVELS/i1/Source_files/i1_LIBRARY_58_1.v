...
module FAU ( 
  ...
  nor3   g42(.a(new_n71_), .b(new_n83_), .c(new_n81_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  nand2  g44(.a(new_n83_), .b(x22), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n76_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n76_), .O(z11));
  nand4  g48(.a(new_n76_), .b(new_n83_), .c(x23), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n83_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n76_), .O(z13));
  nand2  g52(.a(new_n83_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n76_), .O(z14));
