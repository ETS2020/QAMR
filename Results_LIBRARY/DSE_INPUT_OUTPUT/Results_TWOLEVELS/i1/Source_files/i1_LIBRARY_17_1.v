...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n67_, new_n68_, new_n70_, new_n72_, new_n73_, new_n75_, new_n78_,
  ...
  inv1   g26(.a(new_n65_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(new_n67_), .c(new_n64_), .O(z04));
  inv1   g28(.a(x10), .O(new_n70_));
  nand2  g29(.a(new_n68_), .b(new_n70_), .O(z05));
  inv1   g30(.a(x18), .O(new_n72_));
  inv1   g31(.a(x24), .O(new_n73_));
  nor3   g32(.a(new_n65_), .b(new_n73_), .c(new_n72_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nand2  g34(.a(new_n68_), .b(new_n75_), .O(z08));
  oai21  g35(.a(new_n73_), .b(new_n75_), .c(new_n68_), .O(z09));
  nand4  g36(.a(new_n68_), .b(new_n73_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand4  g38(.a(new_n68_), .b(new_n73_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n73_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n68_), .O(z12));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n68_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  nor3   g46(.a(new_n65_), .b(x24), .c(new_n87_), .O(z14));
