...
module FAU ( 
  ...
  nand3  g33(.a(new_n58_), .b(new_n74_), .c(new_n72_), .O(z04));
  ...
  nand3  g41(.a(new_n82_), .b(new_n48_), .c(new_n64_), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n85_));
  nand4  g44(.a(new_n82_), .b(new_n61_), .c(new_n48_), .d(new_n64_), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n42_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n43_), .O(z06));
  ...
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(new_n58_), .O(z10));
  inv1   g56(.a(x17), .O(new_n98_));
  oai21  g57(.a(new_n96_), .b(new_n98_), .c(new_n58_), .O(z11));
  nand3  g58(.a(new_n93_), .b(x23), .c(x14), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n58_), .O(z12));
  nand4  g60(.a(new_n58_), .b(new_n93_), .c(x23), .d(x17), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z13));
  nand2  g62(.a(new_n93_), .b(x16), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n58_), .O(z14));
  nor2   g64(.a(x13), .b(x12), .O(new_n106_));
  nor2   g65(.a(x15), .b(x14), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n57_), .O(z15));
endmodule
