...
module FAU ( 
  ...
  nand2  g21(.a(x19), .b(x08), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(new_n62_), .c(new_n60_), .O(z04));
  ...
  nand2  g30(.a(new_n71_), .b(new_n63_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n63_), .b(new_n73_), .O(z08));
  inv1   g33(.a(x24), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n73_), .c(new_n63_), .O(z09));
  nand3  g35(.a(new_n75_), .b(x22), .c(x14), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n63_), .O(z10));
  nand4  g37(.a(new_n63_), .b(new_n75_), .c(x22), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand3  g39(.a(new_n63_), .b(new_n75_), .c(x23), .O(new_n81_));
  ...
  oai21  g46(.a(x24), .b(new_n87_), .c(new_n63_), .O(z14));
  inv1   g47(.a(x12), .O(new_n89_));
  inv1   g48(.a(x13), .O(new_n90_));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nand4  g50(.a(new_n91_), .b(new_n63_), .c(new_n90_), .d(new_n89_), .O(z15));
endmodule
