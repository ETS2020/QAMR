...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n86_, new_n87_, new_n88_;
  ...
  oai21  g32(.a(new_n73_), .b(new_n71_), .c(new_n65_), .O(z09));
  nand4  g33(.a(new_n65_), .b(new_n73_), .c(x22), .d(x14), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z10));
  nand3  g35(.a(new_n73_), .b(x22), .c(x17), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n65_), .O(z11));
  inv1   g37(.a(x14), .O(new_n79_));
  nand2  g38(.a(new_n73_), .b(x23), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n65_), .O(z12));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n65_), .O(z13));
  nand2  g42(.a(new_n73_), .b(x16), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n65_), .O(z14));
  inv1   g44(.a(x12), .O(new_n86_));
  inv1   g45(.a(x13), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n65_), .c(new_n87_), .d(new_n86_), .O(z15));
  buf    g48(.a(x19), .O(z06));
endmodule
