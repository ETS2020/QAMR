...
module FAU ( 
  ...
  nand2  g39(.a(new_n62_), .b(new_n64_), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n83_));
  nand3  g42(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n84_));
  nor2   g43(.a(x05), .b(x04), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n50_), .c(new_n49_), .O(new_n86_));
  nor3   g45(.a(new_n86_), .b(new_n84_), .c(new_n42_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n83_), .c(new_n43_), .O(z06));
  ...
  nand4  g55(.a(new_n58_), .b(new_n93_), .c(x22), .d(x17), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z11));
  nand4  g57(.a(new_n58_), .b(new_n93_), .c(x23), .d(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n93_), .b(x23), .c(x17), .O(new_n101_));
