...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n68_, new_n70_, new_n71_, new_n76_,
  ...
  and2   g32(.a(new_n71_), .b(x10), .O(z05));
  nor2   g33(.a(new_n45_), .b(new_n43_), .O(z06));
  inv1   g34(.a(x18), .O(new_n76_));
  nand2  g35(.a(new_n71_), .b(x24), .O(new_n77_));
