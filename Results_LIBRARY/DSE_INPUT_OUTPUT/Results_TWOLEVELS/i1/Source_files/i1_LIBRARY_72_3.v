...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n82_, new_n84_, new_n85_, new_n87_,
    new_n88_, new_n90_, new_n92_, new_n94_, new_n96_, new_n97_, new_n98_;
  inv1   g00(.a(x00), .O(new_n42_));
  nand2  g01(.a(x18), .b(x10), .O(new_n43_));
  ...
  oai21  g27(.a(new_n68_), .b(new_n58_), .c(new_n43_), .O(z02));
  ...
  inv1   g33(.a(new_n66_), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(x19), .c(new_n65_), .d(new_n50_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(new_n74_), .O(z05));
  nor2   g36(.a(new_n71_), .b(new_n58_), .O(z06));
  nand3  g37(.a(x24), .b(x18), .c(new_n74_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  and2   g39(.a(new_n43_), .b(x11), .O(z08));
  nand3  g40(.a(new_n43_), .b(x24), .c(x11), .O(new_n82_));
  ...
  nor2   g45(.a(new_n71_), .b(x24), .O(new_n87_));
