...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n80_, new_n82_, new_n84_, new_n86_, new_n87_,
  ...
  nand4  g40(.a(new_n71_), .b(new_n80_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n80_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n71_), .O(z11));
  inv1   g44(.a(x23), .O(new_n86_));
  nand2  g45(.a(new_n71_), .b(new_n80_), .O(new_n87_));
