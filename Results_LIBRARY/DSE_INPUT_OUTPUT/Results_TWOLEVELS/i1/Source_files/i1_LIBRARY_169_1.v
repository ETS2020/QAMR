...
module FAU ( 
  ...
  nor2   g31(.a(new_n45_), .b(x14), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z03));
  nor2   g33(.a(x21), .b(x20), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n73_), .O(z04));
