...
module FAU ( 
  ...
  nor2   g13(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(new_n43_), .O(new_n56_));
  ...
  nand3  g22(.a(new_n53_), .b(new_n63_), .c(new_n52_), .O(new_n64_));
  ...
  nand2  g34(.a(new_n63_), .b(new_n43_), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n52_), .c(new_n75_), .d(new_n74_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(x04), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n79_));
  nor3   g38(.a(new_n61_), .b(new_n43_), .c(new_n42_), .O(new_n80_));
  ...
  nor3   g62(.a(new_n69_), .b(x13), .c(x12), .O(new_n104_));
