...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n79_, new_n81_, new_n83_, new_n84_, new_n86_,
  ...
  nand2  g32(.a(new_n65_), .b(x10), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n73_), .O(z05));
  inv1   g34(.a(new_n66_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x24), .c(x18), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n76_), .b(new_n79_), .O(z08));
  nand3  g39(.a(new_n76_), .b(x24), .c(x11), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z09));
  nor2   g41(.a(new_n66_), .b(x24), .O(new_n83_));
  ...
  nand4  g56(.a(new_n97_), .b(new_n76_), .c(new_n96_), .d(new_n95_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
