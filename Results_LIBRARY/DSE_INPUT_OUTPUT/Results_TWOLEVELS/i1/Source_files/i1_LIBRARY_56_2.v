...
module FAU ( 
  ...
  nand4  g19(.a(new_n60_), .b(new_n59_), .c(new_n51_), .d(new_n43_), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(x00), .O(new_n62_));
  nand4  g21(.a(new_n43_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  ...
  nand4  g34(.a(new_n75_), .b(new_n65_), .c(new_n64_), .d(new_n53_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n45_), .c(new_n74_), .O(z05));
  oai21  g36(.a(new_n47_), .b(x00), .c(x04), .O(new_n78_));
  nand4  g37(.a(new_n60_), .b(new_n51_), .c(new_n43_), .d(new_n50_), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x02), .O(new_n80_));
  nand4  g39(.a(new_n60_), .b(new_n59_), .c(new_n51_), .d(x00), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n48_), .c(new_n81_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n47_), .c(new_n78_), .O(z06));
