...
module FAU ( 
  ...
  nand4  g14(.a(new_n55_), .b(new_n43_), .c(new_n54_), .d(new_n53_), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(x04), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n49_), .c(new_n47_), .O(z01));
  aoi21  g18(.a(x19), .b(x00), .c(x08), .O(new_n60_));
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(new_n61_));
  inv1   g20(.a(x04), .O(new_n62_));
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n62_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n61_), .c(x00), .O(new_n64_));
  nand4  g23(.a(new_n62_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n65_));
  inv1   g24(.a(x09), .O(new_n66_));
  nor2   g25(.a(x06), .b(x05), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n65_), .c(new_n64_), .O(new_n69_));
  ...
  nand3  g33(.a(new_n48_), .b(new_n74_), .c(new_n72_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand3  g35(.a(new_n67_), .b(x19), .c(new_n44_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n43_), .O(new_n79_));
  oai21  g38(.a(new_n76_), .b(x08), .c(new_n79_), .O(z05));
  nor3   g39(.a(x06), .b(x05), .c(x04), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n64_), .O(new_n83_));
  nand3  g42(.a(new_n44_), .b(x07), .c(x00), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  aoi21  g44(.a(new_n83_), .b(new_n43_), .c(new_n85_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n49_), .c(new_n47_), .O(z06));
  nand2  g46(.a(x24), .b(x18), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n48_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nor2   g49(.a(new_n45_), .b(new_n90_), .O(z08));
  inv1   g50(.a(x24), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n90_), .c(new_n48_), .O(z09));
  nor2   g52(.a(new_n45_), .b(x24), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x22), .c(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z10));
  nand3  g55(.a(new_n92_), .b(x22), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n48_), .O(z11));
  nand3  g57(.a(new_n94_), .b(x23), .c(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n92_), .b(x23), .c(x17), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n48_), .O(z13));
  ...
  nand4  g66(.a(new_n107_), .b(new_n48_), .c(new_n106_), .d(new_n105_), .O(z15));
endmodule
