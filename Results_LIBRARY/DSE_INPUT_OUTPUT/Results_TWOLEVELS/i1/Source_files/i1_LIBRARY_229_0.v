...
module FAU ( 
  ...
  nand4  g32(.a(new_n65_), .b(x19), .c(new_n66_), .d(new_n52_), .O(new_n74_));
  oai22  g33(.a(new_n74_), .b(new_n63_), .c(new_n43_), .d(new_n73_), .O(z05));
  nand3  g34(.a(new_n60_), .b(new_n50_), .c(new_n58_), .O(new_n76_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n46_), .O(z06));
