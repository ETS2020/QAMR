...
module FAU ( 
  ...
  nand2  g35(.a(new_n57_), .b(x24), .O(new_n77_));
  ...
  nand2  g42(.a(new_n83_), .b(new_n57_), .O(z10));
  nand4  g43(.a(new_n57_), .b(new_n82_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  inv1   g45(.a(x23), .O(new_n87_));
  nand2  g46(.a(new_n57_), .b(new_n82_), .O(new_n88_));
