...
module FAU ( 
  ...
  nor2   g15(.a(x19), .b(new_n49_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n56_), .O(z01));
  oai21  g18(.a(new_n43_), .b(x00), .c(x06), .O(new_n60_));
  ...
  nand3  g40(.a(new_n81_), .b(new_n48_), .c(new_n64_), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n84_));
  nand4  g43(.a(new_n81_), .b(new_n61_), .c(new_n48_), .d(new_n64_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n42_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n43_), .O(z06));
  inv1   g46(.a(x18), .O(new_n88_));
  nand2  g47(.a(new_n58_), .b(x24), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(new_n88_), .O(z07));
  inv1   g49(.a(x11), .O(new_n91_));
  nand2  g50(.a(new_n58_), .b(new_n91_), .O(z08));
  nor2   g51(.a(new_n89_), .b(new_n91_), .O(z09));
  inv1   g52(.a(x24), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x22), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n58_), .O(z10));
  nand4  g55(.a(new_n58_), .b(new_n94_), .c(x22), .d(x17), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z11));
  inv1   g57(.a(x14), .O(new_n99_));
  nand2  g58(.a(new_n94_), .b(x23), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(new_n99_), .c(new_n58_), .O(z12));
  inv1   g60(.a(x17), .O(new_n102_));
  oai21  g61(.a(new_n100_), .b(new_n102_), .c(new_n58_), .O(z13));
  nand2  g62(.a(new_n94_), .b(x16), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n58_), .O(z14));
  nor2   g64(.a(x15), .b(x14), .O(new_n106_));
  nor3   g65(.a(new_n57_), .b(x13), .c(x12), .O(new_n107_));
