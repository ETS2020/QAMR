...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(x19), .c(x14), .O(new_n58_));
  ...
  aoi21  g28(.a(new_n69_), .b(x14), .c(new_n43_), .O(z02));
  ...
  nand4  g35(.a(new_n76_), .b(x14), .c(new_n66_), .d(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n64_), .c(x14), .O(new_n78_));
  ...
  nand3  g44(.a(new_n85_), .b(x19), .c(x14), .O(new_n86_));
  ...
  nand4  g55(.a(new_n45_), .b(new_n94_), .c(x22), .d(x17), .O(new_n97_));
