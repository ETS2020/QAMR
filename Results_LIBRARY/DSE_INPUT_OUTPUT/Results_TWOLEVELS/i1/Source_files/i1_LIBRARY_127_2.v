...
module FAU ( 
  ...
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n72_), .O(z09));
  nand4  g43(.a(new_n72_), .b(new_n80_), .c(x22), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z10));
  nand3  g45(.a(new_n80_), .b(x22), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n72_), .O(z11));
  nand4  g47(.a(new_n72_), .b(new_n80_), .c(x23), .d(x14), .O(new_n89_));
