...
module FAU ( 
  ...
  nand3  g12(.a(new_n53_), .b(x19), .c(x09), .O(new_n54_));
  oai21  g13(.a(new_n54_), .b(new_n52_), .c(x08), .O(new_n55_));
  nand2  g14(.a(new_n55_), .b(new_n47_), .O(new_n56_));
  oai21  g15(.a(new_n46_), .b(x00), .c(new_n56_), .O(z01));
  nand3  g16(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(new_n58_));
  nand2  g17(.a(new_n53_), .b(new_n51_), .O(new_n59_));
  oai21  g18(.a(new_n59_), .b(new_n58_), .c(x08), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(new_n47_), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(x00), .O(new_n62_));
  inv1   g21(.a(new_n52_), .O(new_n63_));
  inv1   g22(.a(x08), .O(new_n64_));
  nor2   g23(.a(x09), .b(new_n64_), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n53_), .c(new_n63_), .d(new_n47_), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n62_), .c(new_n46_), .O(z02));
  ...
  nand4  g57(.a(new_n44_), .b(new_n87_), .c(x23), .d(x17), .O(new_n99_));
