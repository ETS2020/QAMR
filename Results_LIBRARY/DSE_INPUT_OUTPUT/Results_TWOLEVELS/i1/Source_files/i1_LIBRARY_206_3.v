...
module FAU ( 
  ...
  nand2  g33(.a(new_n52_), .b(x10), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(z05));
  nor2   g35(.a(new_n52_), .b(x08), .O(z06));
  nand3  g36(.a(new_n61_), .b(x24), .c(x18), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nand2  g39(.a(new_n61_), .b(new_n80_), .O(z08));
  nand3  g40(.a(new_n61_), .b(x24), .c(x11), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z09));
  inv1   g42(.a(x14), .O(new_n84_));
  inv1   g43(.a(x24), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x22), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n61_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n61_), .O(z11));
  nand3  g48(.a(new_n61_), .b(new_n85_), .c(x23), .O(new_n90_));
  ...
  nand3  g54(.a(new_n61_), .b(new_n85_), .c(x16), .O(new_n96_));
