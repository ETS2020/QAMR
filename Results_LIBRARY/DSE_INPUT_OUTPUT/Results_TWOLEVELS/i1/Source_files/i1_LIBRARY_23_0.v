...
module FAU ( 
  ...
  nand4  g24(.a(new_n65_), .b(new_n62_), .c(new_n47_), .d(new_n46_), .O(new_n66_));
  ...
  nand4  g32(.a(new_n73_), .b(new_n58_), .c(new_n50_), .d(new_n57_), .O(new_n74_));
  ...
  nand2  g37(.a(new_n78_), .b(new_n71_), .O(z07));
  ...
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n71_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n71_), .O(z11));
  nand4  g47(.a(new_n71_), .b(new_n82_), .c(x23), .d(x14), .O(new_n89_));
