...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x00), .c(x08), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n53_), .O(z02));
  inv1   g19(.a(x20), .O(new_n61_));
  nand2  g20(.a(new_n43_), .b(new_n61_), .O(z03));
  inv1   g21(.a(x21), .O(new_n63_));
  aoi22  g22(.a(new_n63_), .b(new_n61_), .c(x19), .d(x08), .O(z04));
  ...
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(z12));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n43_), .O(z13));
  nand3  g48(.a(new_n43_), .b(new_n78_), .c(x16), .O(new_n90_));
