...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n78_, new_n79_, new_n81_, new_n84_, new_n85_, new_n87_,
  ...
  nand2  g33(.a(new_n71_), .b(new_n74_), .O(z05));
  nor2   g34(.a(new_n45_), .b(new_n43_), .O(z06));
  inv1   g35(.a(x18), .O(new_n77_));
  inv1   g36(.a(x24), .O(new_n78_));
  inv1   g37(.a(new_n71_), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n79_), .b(new_n81_), .O(z08));
  oai21  g41(.a(new_n78_), .b(new_n81_), .c(new_n71_), .O(z09));
  ...
  nand4  g47(.a(new_n71_), .b(new_n78_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand3  g49(.a(new_n78_), .b(x23), .c(x17), .O(new_n91_));
  ...
  nor3   g54(.a(new_n79_), .b(x13), .c(x12), .O(new_n96_));
