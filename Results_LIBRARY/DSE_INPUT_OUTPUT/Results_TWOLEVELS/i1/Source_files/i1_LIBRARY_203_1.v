// Benchmark "FAU" written by ABC on Wed Aug 19 17:35:18 2020
...
module FAU ( 
  ...
  nor2   g33(.a(new_n46_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n76_));
  oai22  g35(.a(new_n76_), .b(new_n63_), .c(new_n44_), .d(new_n74_), .O(z05));
  nand2  g36(.a(new_n43_), .b(new_n46_), .O(z06));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(x24), .O(new_n80_));
  nor3   g39(.a(new_n44_), .b(new_n80_), .c(new_n79_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n44_), .b(new_n82_), .O(z08));
  oai21  g42(.a(new_n80_), .b(new_n82_), .c(new_n58_), .O(z09));
  nand3  g43(.a(x22), .b(x19), .c(x14), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(x24), .O(z10));
  nand3  g45(.a(x22), .b(x19), .c(x17), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(x24), .O(z11));
  nand4  g47(.a(new_n58_), .b(new_n80_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand3  g49(.a(new_n80_), .b(x23), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n58_), .O(z13));
  nand2  g51(.a(new_n80_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n58_), .O(z14));
