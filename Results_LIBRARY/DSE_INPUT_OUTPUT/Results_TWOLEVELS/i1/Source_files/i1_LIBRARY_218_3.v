...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n68_, new_n71_, new_n72_, new_n74_, new_n76_, new_n78_, new_n80_,
  ...
  nand4  g36(.a(new_n71_), .b(new_n76_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand3  g38(.a(new_n76_), .b(x22), .c(x17), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n71_), .O(z11));
  nand4  g40(.a(new_n71_), .b(new_n76_), .c(x23), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand3  g42(.a(new_n76_), .b(x23), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n71_), .O(z13));
  nand2  g44(.a(new_n76_), .b(x16), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n71_), .O(z14));
  inv1   g46(.a(x12), .O(new_n88_));
  inv1   g47(.a(x13), .O(new_n89_));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(new_n71_), .c(new_n89_), .d(new_n88_), .O(z15));
endmodule
