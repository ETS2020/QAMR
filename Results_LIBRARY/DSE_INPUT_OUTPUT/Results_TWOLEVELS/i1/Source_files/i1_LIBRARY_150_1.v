...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n67_, new_n70_, new_n72_, new_n73_, new_n74_, new_n75_,
  ...
  oai21  g22(.a(new_n63_), .b(new_n50_), .c(new_n61_), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(x19), .c(x08), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z02));
  inv1   g25(.a(x20), .O(new_n67_));
  nand2  g26(.a(new_n44_), .b(new_n67_), .O(z03));
  or2    g27(.a(z03), .b(x21), .O(z04));
  inv1   g28(.a(x10), .O(new_n70_));
  nand2  g29(.a(new_n44_), .b(new_n70_), .O(z05));
  inv1   g30(.a(x05), .O(new_n72_));
  inv1   g31(.a(x06), .O(new_n73_));
  nand4  g32(.a(new_n51_), .b(new_n73_), .c(new_n72_), .d(new_n49_), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n76_));
  nor2   g35(.a(new_n60_), .b(new_n42_), .O(new_n77_));
  ...
  nand4  g52(.a(new_n44_), .b(new_n87_), .c(x23), .d(x17), .O(new_n94_));
