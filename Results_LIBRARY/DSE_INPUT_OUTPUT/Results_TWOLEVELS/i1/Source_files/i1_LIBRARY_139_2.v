...
module FAU ( 
  ...
  nand2  g40(.a(new_n71_), .b(x24), .O(new_n82_));
  ...
  nand4  g52(.a(new_n71_), .b(new_n93_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n93_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n71_), .O(z13));
  nand2  g56(.a(new_n93_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n71_), .O(z14));
