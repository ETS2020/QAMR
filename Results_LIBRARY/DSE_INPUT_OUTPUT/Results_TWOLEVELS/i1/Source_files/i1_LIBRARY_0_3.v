// Benchmark "FAU" written by ABC on Wed Aug 19 17:33:51 2020
...
module FAU ( 
  ...
  nor2   g28(.a(x08), .b(x00), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(x00), .c(new_n52_), .O(z06));
  nand3  g30(.a(new_n64_), .b(x24), .c(x18), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nor2   g33(.a(new_n61_), .b(new_n74_), .O(z08));
  nand2  g34(.a(x24), .b(x11), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n64_), .O(z09));
  nor2   g36(.a(new_n61_), .b(x24), .O(new_n78_));
  ...
  nand4  g50(.a(new_n91_), .b(new_n64_), .c(new_n90_), .d(new_n89_), .O(z15));
endmodule
