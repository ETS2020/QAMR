...
module FAU ( 
  ...
  nand4  g40(.a(new_n45_), .b(new_n77_), .c(x22), .d(x14), .O(new_n82_));
  ...
  nand2  g45(.a(new_n77_), .b(x23), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n45_), .O(z12));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n45_), .O(z13));
  inv1   g49(.a(x16), .O(new_n91_));
  nor3   g50(.a(new_n44_), .b(x24), .c(new_n91_), .O(z14));
