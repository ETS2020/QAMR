...
module FAU ( 
  ...
  nand3  g11(.a(x18), .b(x09), .c(x08), .O(new_n53_));
  ...
  aoi21  g31(.a(new_n72_), .b(x18), .c(new_n43_), .O(z02));
  ...
  nand4  g39(.a(new_n63_), .b(x19), .c(x18), .d(new_n80_), .O(new_n81_));
  ...
  nand3  g46(.a(new_n87_), .b(x19), .c(x18), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z06));
  inv1   g48(.a(x24), .O(new_n90_));
  nor2   g49(.a(new_n90_), .b(new_n58_), .O(z07));
  inv1   g50(.a(x11), .O(new_n92_));
  nor2   g51(.a(new_n44_), .b(new_n92_), .O(z08));
  nor3   g52(.a(new_n44_), .b(new_n90_), .c(new_n92_), .O(z09));
  nand3  g53(.a(new_n90_), .b(x22), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n45_), .O(z10));
  nand4  g55(.a(new_n45_), .b(new_n90_), .c(x22), .d(x17), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z11));
  inv1   g57(.a(x23), .O(new_n99_));
  nor3   g58(.a(new_n44_), .b(x24), .c(new_n99_), .O(new_n100_));
  ...
  nand2  g63(.a(new_n90_), .b(x16), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n45_), .O(z14));
