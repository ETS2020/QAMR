...
module FAU ( 
  ...
  nand3  g32(.a(new_n73_), .b(new_n72_), .c(new_n69_), .O(z04));
  ...
  nand2  g38(.a(new_n79_), .b(new_n73_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n73_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n70_), .b(new_n83_), .c(new_n81_), .O(z09));
  nand3  g43(.a(new_n83_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n73_), .O(z10));
  nand4  g45(.a(new_n73_), .b(new_n83_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand4  g47(.a(new_n73_), .b(new_n83_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand4  g49(.a(new_n73_), .b(new_n83_), .c(x23), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z13));
  nand2  g51(.a(new_n83_), .b(x16), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n73_), .O(z14));
