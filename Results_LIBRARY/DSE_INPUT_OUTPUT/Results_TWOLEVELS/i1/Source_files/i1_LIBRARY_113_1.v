...
module FAU ( 
  ...
  oai22  g33(.a(new_n74_), .b(new_n64_), .c(new_n44_), .d(new_n73_), .O(z05));
  inv1   g34(.a(new_n44_), .O(new_n76_));
  nand4  g35(.a(new_n60_), .b(new_n50_), .c(new_n63_), .d(new_n49_), .O(new_n77_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n46_), .c(new_n76_), .O(z06));
  ...
  oai21  g45(.a(new_n83_), .b(new_n85_), .c(new_n76_), .O(z09));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n83_), .b(x22), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n76_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n76_), .O(z11));
  nand3  g51(.a(new_n83_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n76_), .O(z12));
  nand4  g53(.a(new_n76_), .b(new_n83_), .c(x23), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z13));
  nand2  g55(.a(new_n83_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n76_), .O(z14));
