...
module FAU ( 
  ...
  nand4  g21(.a(new_n62_), .b(new_n61_), .c(new_n45_), .d(new_n49_), .O(new_n63_));
  ...
  aoi21  g28(.a(new_n69_), .b(new_n64_), .c(new_n60_), .O(z02));
  ...
  nand4  g34(.a(new_n75_), .b(new_n61_), .c(new_n50_), .d(new_n49_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(x05), .O(new_n77_));
  or2    g36(.a(new_n77_), .b(x10), .O(z05));
  inv1   g37(.a(x18), .O(new_n79_));
  inv1   g38(.a(new_n43_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x24), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n79_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nor2   g42(.a(new_n43_), .b(new_n83_), .O(z08));
  ...
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n80_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n80_), .O(z11));
  nand4  g50(.a(new_n80_), .b(new_n87_), .c(x23), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand3  g52(.a(new_n87_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n80_), .O(z13));
  nand2  g54(.a(new_n87_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n80_), .O(z14));
