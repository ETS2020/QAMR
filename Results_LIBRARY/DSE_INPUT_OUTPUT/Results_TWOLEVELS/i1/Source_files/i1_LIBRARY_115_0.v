...
module FAU ( 
  ...
  nand2  g41(.a(new_n82_), .b(new_n74_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nand2  g43(.a(new_n74_), .b(new_n84_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  nor3   g45(.a(new_n43_), .b(new_n86_), .c(new_n84_), .O(z09));
  nand4  g46(.a(new_n74_), .b(new_n86_), .c(x22), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand3  g48(.a(new_n86_), .b(x22), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n74_), .O(z11));
