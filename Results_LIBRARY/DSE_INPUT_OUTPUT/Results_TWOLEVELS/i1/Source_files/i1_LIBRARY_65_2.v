...
module FAU ( 
  ...
  nand3  g36(.a(new_n63_), .b(x19), .c(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n62_), .c(new_n76_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n43_), .O(new_n80_));
  oai21  g39(.a(new_n77_), .b(new_n76_), .c(new_n80_), .O(z05));
  nand2  g40(.a(new_n77_), .b(new_n43_), .O(z06));
  ...
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(new_n73_), .O(z12));
  inv1   g56(.a(x17), .O(new_n98_));
  oai21  g57(.a(new_n96_), .b(new_n98_), .c(new_n73_), .O(z13));
