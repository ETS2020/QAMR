...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n59_), .c(new_n43_), .O(z02));
  inv1   g25(.a(x20), .O(new_n67_));
  nor2   g26(.a(x19), .b(new_n42_), .O(new_n68_));
  ...
  nand4  g31(.a(new_n62_), .b(x19), .c(new_n63_), .d(new_n50_), .O(new_n73_));
  oai22  g32(.a(new_n73_), .b(new_n60_), .c(new_n68_), .d(new_n72_), .O(z05));
  nand2  g33(.a(new_n43_), .b(new_n42_), .O(z06));
  inv1   g34(.a(x18), .O(new_n76_));
  inv1   g35(.a(x24), .O(new_n77_));
  nor3   g36(.a(new_n68_), .b(new_n77_), .c(new_n76_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  inv1   g38(.a(new_n68_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n79_), .O(z08));
  oai21  g40(.a(new_n77_), .b(new_n79_), .c(new_n80_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  nand2  g42(.a(new_n80_), .b(new_n77_), .O(new_n84_));
  ...
  nand4  g48(.a(new_n80_), .b(new_n77_), .c(x23), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n77_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n80_), .O(z13));
  inv1   g52(.a(x16), .O(new_n94_));
  nor2   g53(.a(new_n84_), .b(new_n94_), .O(z14));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  nor3   g55(.a(new_n68_), .b(x13), .c(x12), .O(new_n97_));
