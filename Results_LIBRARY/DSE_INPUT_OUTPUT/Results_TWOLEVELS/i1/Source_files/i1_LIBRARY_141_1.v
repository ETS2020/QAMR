...
module FAU ( 
  ...
  nand3  g40(.a(x24), .b(x18), .c(x11), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  nand2  g42(.a(x24), .b(x11), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n46_), .O(z09));
  ...
  nand2  g52(.a(new_n93_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n92_), .c(new_n46_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n46_), .O(z13));
  nand2  g56(.a(new_n93_), .b(x16), .O(new_n98_));
