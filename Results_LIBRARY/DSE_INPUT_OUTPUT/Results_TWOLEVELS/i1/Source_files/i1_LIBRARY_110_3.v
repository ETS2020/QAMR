...
module FAU ( 
  ...
  nand2  g33(.a(new_n58_), .b(x10), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(z05));
  nor2   g35(.a(new_n58_), .b(x08), .O(z06));
  ...
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n67_), .O(z09));
  nand3  g42(.a(new_n82_), .b(x22), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n67_), .O(z10));
  nand4  g44(.a(new_n67_), .b(new_n82_), .c(x22), .d(x17), .O(new_n86_));
  ...
  nand3  g51(.a(new_n67_), .b(new_n82_), .c(x16), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z14));
  nor2   g53(.a(x13), .b(x12), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n66_), .O(z15));
endmodule
