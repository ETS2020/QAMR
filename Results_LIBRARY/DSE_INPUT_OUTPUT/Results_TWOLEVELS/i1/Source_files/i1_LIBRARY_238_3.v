...
module FAU ( 
  ...
  nor3   g44(.a(new_n64_), .b(x21), .c(new_n42_), .O(new_n86_));
  ...
  oai21  g55(.a(new_n96_), .b(new_n94_), .c(new_n46_), .O(z10));
  inv1   g56(.a(x17), .O(new_n98_));
  oai21  g57(.a(new_n96_), .b(new_n98_), .c(new_n46_), .O(z11));
  nand3  g58(.a(new_n95_), .b(x23), .c(x14), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n46_), .O(z12));
  nand4  g60(.a(new_n46_), .b(new_n95_), .c(x23), .d(x17), .O(new_n102_));
