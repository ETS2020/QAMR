...
module FAU ( 
  ...
  and2   g33(.a(new_n44_), .b(x10), .O(z05));
  nand3  g34(.a(new_n62_), .b(new_n53_), .c(new_n50_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n78_));
  nor2   g37(.a(new_n63_), .b(new_n42_), .O(new_n79_));
  ...
  nor3   g44(.a(new_n72_), .b(new_n85_), .c(new_n83_), .O(z09));
  ...
  nand2  g50(.a(new_n44_), .b(new_n85_), .O(new_n92_));
