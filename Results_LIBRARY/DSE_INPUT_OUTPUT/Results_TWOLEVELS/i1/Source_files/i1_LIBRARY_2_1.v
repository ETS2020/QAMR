...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(x11), .c(new_n43_), .O(z02));
  ...
  nand4  g35(.a(new_n76_), .b(x11), .c(new_n66_), .d(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n64_), .c(x11), .O(new_n78_));
  ...
  nand2  g48(.a(x24), .b(x11), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n45_), .O(z09));
  ...
  nand3  g56(.a(new_n95_), .b(x23), .c(x14), .O(new_n98_));
