...
module FAU ( 
  ...
  oai21  g43(.a(new_n84_), .b(new_n78_), .c(new_n63_), .O(z12));
  oai21  g44(.a(new_n84_), .b(new_n82_), .c(new_n63_), .O(z13));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n62_), .O(z15));
endmodule
