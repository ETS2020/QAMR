...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_,
  ...
  aoi21  g17(.a(new_n58_), .b(new_n46_), .c(new_n45_), .O(z01));
  ...
  aoi21  g27(.a(new_n68_), .b(new_n64_), .c(new_n45_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nor2   g29(.a(new_n45_), .b(x08), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n70_), .O(z03));
  nor2   g32(.a(x21), .b(x20), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n71_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nor2   g35(.a(new_n71_), .b(new_n76_), .O(z05));
  nor2   g36(.a(new_n45_), .b(new_n43_), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n72_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n71_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n72_), .O(z09));
  nand3  g43(.a(new_n83_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n72_), .O(z10));
  nand4  g45(.a(new_n72_), .b(new_n83_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand4  g47(.a(new_n72_), .b(new_n83_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand4  g49(.a(new_n72_), .b(new_n83_), .c(x23), .d(x17), .O(new_n91_));
  ...
  nor3   g54(.a(new_n71_), .b(x13), .c(x12), .O(new_n96_));
