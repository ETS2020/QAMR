...
module FAU ( 
  ...
  aoi21  g05(.a(x05), .b(new_n42_), .c(new_n45_), .O(z02));
  inv1   g06(.a(x20), .O(new_n48_));
  nor2   g07(.a(new_n45_), .b(x05), .O(new_n49_));
  ...
  oai21  g16(.a(new_n45_), .b(x05), .c(x24), .O(new_n58_));
  ...
  nand4  g22(.a(new_n54_), .b(new_n63_), .c(x22), .d(x14), .O(new_n64_));
  ...
  oai21  g31(.a(new_n45_), .b(x05), .c(new_n63_), .O(new_n73_));
