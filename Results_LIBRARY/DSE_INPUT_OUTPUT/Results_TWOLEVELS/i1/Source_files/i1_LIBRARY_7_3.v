...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n80_, new_n82_, new_n83_, new_n84_, new_n85_, new_n87_,
  ...
  aoi21  g22(.a(new_n63_), .b(x00), .c(x08), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n59_), .O(z02));
  inv1   g24(.a(x20), .O(new_n66_));
  nand2  g25(.a(new_n43_), .b(new_n66_), .O(z03));
  inv1   g26(.a(x21), .O(new_n68_));
  aoi22  g27(.a(new_n68_), .b(new_n66_), .c(x19), .d(x08), .O(z04));
  ...
  nor2   g34(.a(new_n59_), .b(x08), .O(z06));
  ...
  nand3  g41(.a(new_n43_), .b(new_n82_), .c(x22), .O(new_n83_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n43_), .O(z12));
  nand4  g49(.a(new_n43_), .b(new_n82_), .c(x23), .d(x17), .O(new_n91_));
