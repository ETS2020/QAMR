...
module FAU ( 
  ...
  oai21  g43(.a(new_n84_), .b(new_n43_), .c(new_n73_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nor2   g45(.a(new_n75_), .b(new_n86_), .O(z08));
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n73_), .O(z09));
  nand4  g47(.a(new_n73_), .b(new_n84_), .c(x22), .d(x14), .O(new_n89_));
  ...
  nand2  g52(.a(new_n73_), .b(new_n84_), .O(new_n94_));
  ...
  nor3   g61(.a(new_n75_), .b(x13), .c(x12), .O(new_n103_));
