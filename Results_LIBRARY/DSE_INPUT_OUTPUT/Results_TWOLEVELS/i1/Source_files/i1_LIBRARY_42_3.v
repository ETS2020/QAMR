...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n79_, new_n81_, new_n82_, new_n83_, new_n85_, new_n87_, new_n90_,
    new_n92_, new_n93_;
  ...
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n66_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n66_), .O(z11));
  nand2  g45(.a(new_n82_), .b(x23), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n81_), .c(new_n66_), .O(z12));
  oai21  g47(.a(new_n87_), .b(new_n85_), .c(new_n66_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  oai21  g49(.a(x24), .b(new_n90_), .c(new_n66_), .O(z14));
  nor2   g50(.a(x13), .b(x12), .O(new_n92_));
  nor2   g51(.a(x15), .b(x14), .O(new_n93_));
  aoi22  g52(.a(new_n93_), .b(new_n92_), .c(x19), .d(x08), .O(z15));
endmodule
