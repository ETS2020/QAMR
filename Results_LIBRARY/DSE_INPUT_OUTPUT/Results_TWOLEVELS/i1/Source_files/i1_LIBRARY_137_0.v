...
module FAU ( 
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n59_), .O(z09));
  nand3  g41(.a(new_n81_), .b(x22), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n59_), .O(z10));
  nand4  g43(.a(new_n59_), .b(new_n81_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  nand4  g45(.a(new_n59_), .b(new_n81_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n81_), .b(x23), .c(x17), .O(new_n89_));
