...
module FAU ( 
  ...
  nand2  g48(.a(new_n85_), .b(x14), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(x19), .c(new_n43_), .O(z10));
  nand3  g50(.a(x22), .b(x19), .c(x17), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(x24), .O(z11));
  nand3  g52(.a(new_n85_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z12));
  nand4  g54(.a(new_n45_), .b(new_n85_), .c(x23), .d(x17), .O(new_n96_));
