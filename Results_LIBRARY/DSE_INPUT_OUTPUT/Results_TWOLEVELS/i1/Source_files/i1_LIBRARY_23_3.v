...
module FAU ( 
  ...
  aoi21  g27(.a(x19), .b(x05), .c(new_n68_), .O(z03));
  ...
  nand4  g33(.a(new_n74_), .b(new_n58_), .c(new_n49_), .d(new_n48_), .O(new_n75_));
