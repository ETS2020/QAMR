...
module FAU ( 
  ...
  nand4  g12(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(x00), .O(new_n54_));
  inv1   g13(.a(x04), .O(new_n55_));
  inv1   g14(.a(x05), .O(new_n56_));
  inv1   g15(.a(x09), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x08), .c(x07), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(new_n46_), .c(new_n56_), .d(new_n55_), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n53_), .O(z02));
  inv1   g20(.a(x20), .O(new_n62_));
  nor2   g21(.a(new_n53_), .b(x00), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n62_), .O(z03));
  inv1   g23(.a(x21), .O(new_n65_));
  inv1   g24(.a(new_n63_), .O(new_n66_));
  nand3  g25(.a(new_n66_), .b(new_n65_), .c(new_n62_), .O(z04));
  inv1   g26(.a(x10), .O(new_n68_));
  nand4  g27(.a(new_n55_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n69_));
  inv1   g28(.a(x08), .O(new_n70_));
  nand4  g29(.a(new_n70_), .b(new_n47_), .c(new_n46_), .d(new_n56_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n69_), .c(x00), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x19), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n68_), .O(z05));
  oai21  g33(.a(new_n57_), .b(new_n42_), .c(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n47_), .c(new_n46_), .d(new_n56_), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(x04), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n60_), .c(new_n53_), .O(z06));
  inv1   g38(.a(x18), .O(new_n80_));
  nand2  g39(.a(new_n66_), .b(x24), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n66_), .b(new_n83_), .O(z08));
  ...
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n66_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n66_), .O(z11));
  inv1   g50(.a(x23), .O(new_n92_));
  nor3   g51(.a(new_n63_), .b(x24), .c(new_n92_), .O(new_n93_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n66_), .O(z14));
