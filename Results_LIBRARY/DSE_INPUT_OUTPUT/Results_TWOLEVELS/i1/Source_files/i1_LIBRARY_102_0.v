...
module FAU ( 
  ...
  nand3  g23(.a(new_n64_), .b(new_n63_), .c(x08), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n62_), .c(x19), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n45_), .O(new_n67_));
  nand4  g26(.a(new_n64_), .b(new_n61_), .c(new_n60_), .d(new_n45_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x19), .c(x00), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n67_), .O(z02));
  ...
  nand4  g34(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  nor2   g36(.a(x06), .b(x05), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(x19), .c(new_n77_), .d(new_n51_), .O(new_n79_));
  oai22  g38(.a(new_n79_), .b(new_n76_), .c(new_n43_), .d(new_n75_), .O(z05));
  inv1   g39(.a(new_n43_), .O(new_n81_));
  nand2  g40(.a(x24), .b(x18), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nand2  g43(.a(new_n81_), .b(new_n84_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n81_), .O(z09));
  nand3  g46(.a(new_n86_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n81_), .O(z10));
  nor2   g48(.a(new_n43_), .b(x24), .O(new_n90_));
