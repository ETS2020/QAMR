...
module FAU ( 
  ...
  nand2  g35(.a(new_n70_), .b(x24), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n76_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n70_), .b(new_n79_), .O(z08));
  ...
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n70_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n70_), .O(z11));
  nand2  g46(.a(new_n83_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n82_), .c(new_n70_), .O(z12));
  oai21  g48(.a(new_n88_), .b(new_n86_), .c(new_n70_), .O(z13));
