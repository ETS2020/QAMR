...
module FAU ( 
  ...
  oai21  g19(.a(new_n60_), .b(x00), .c(x04), .O(new_n61_));
  ...
  nand4  g23(.a(new_n43_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n65_));
  inv1   g24(.a(x09), .O(new_n66_));
  nor2   g25(.a(x06), .b(x05), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(x08), .d(new_n52_), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n64_), .c(x19), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n61_), .O(z02));
  ...
  nor2   g36(.a(new_n60_), .b(x08), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n67_), .c(new_n77_), .d(new_n52_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n45_), .c(new_n76_), .O(z05));
  nand3  g39(.a(new_n63_), .b(new_n43_), .c(new_n49_), .O(new_n81_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n60_), .c(new_n61_), .O(z06));
  inv1   g44(.a(x18), .O(new_n86_));
  nand2  g45(.a(new_n45_), .b(x24), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(new_n86_), .O(z07));
  inv1   g47(.a(x11), .O(new_n89_));
  nor2   g48(.a(new_n44_), .b(new_n89_), .O(z08));
  nor2   g49(.a(new_n87_), .b(new_n89_), .O(z09));
  inv1   g50(.a(x24), .O(new_n92_));
  nand4  g51(.a(new_n45_), .b(new_n92_), .c(x22), .d(x14), .O(new_n93_));
  ...
  nand4  g57(.a(new_n45_), .b(new_n92_), .c(x23), .d(x17), .O(new_n99_));
