...
module FAU ( 
  ...
  aoi22  g21(.a(new_n62_), .b(new_n59_), .c(x19), .d(x08), .O(z04));
  ...
  nand2  g39(.a(new_n80_), .b(new_n60_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n60_), .b(new_n82_), .O(z08));
  nand3  g42(.a(new_n60_), .b(x24), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x24), .O(new_n86_));
  nand4  g45(.a(new_n60_), .b(new_n86_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n86_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n60_), .O(z11));
  inv1   g49(.a(x14), .O(new_n91_));
  nand2  g50(.a(new_n86_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n60_), .O(z12));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n60_), .O(z13));
  nand3  g54(.a(new_n60_), .b(new_n86_), .c(x16), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z14));
  inv1   g56(.a(x12), .O(new_n98_));
  inv1   g57(.a(x13), .O(new_n99_));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  nand4  g59(.a(new_n100_), .b(new_n60_), .c(new_n99_), .d(new_n98_), .O(z15));
endmodule
