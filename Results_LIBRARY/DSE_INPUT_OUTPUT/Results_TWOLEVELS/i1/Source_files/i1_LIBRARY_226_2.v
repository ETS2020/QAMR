...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n89_, new_n90_, new_n91_, new_n93_, new_n97_,
    new_n99_, new_n100_;
  ...
  nor2   g31(.a(new_n72_), .b(new_n43_), .O(z03));
  inv1   g32(.a(x21), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n43_), .O(z04));
  ...
  nor3   g53(.a(x24), .b(new_n72_), .c(new_n89_), .O(z12));
  nor3   g54(.a(x24), .b(new_n72_), .c(new_n93_), .O(z13));
