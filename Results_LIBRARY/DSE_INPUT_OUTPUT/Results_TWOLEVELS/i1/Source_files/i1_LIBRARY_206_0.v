...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n88_, new_n90_, new_n91_, new_n92_, new_n94_, new_n96_,
    new_n98_, new_n99_;
  ...
  nand2  g30(.a(new_n59_), .b(new_n71_), .O(z03));
  or2    g31(.a(z03), .b(x21), .O(z04));
  nand2  g32(.a(new_n59_), .b(x10), .O(new_n74_));
  nor2   g33(.a(new_n58_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n64_), .c(new_n74_), .O(z05));
  inv1   g36(.a(x18), .O(new_n78_));
  nand2  g37(.a(new_n59_), .b(x24), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n78_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n59_), .b(new_n81_), .O(z08));
  ...
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n59_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n59_), .O(z11));
  ...
  nor3   g55(.a(new_n43_), .b(x24), .c(new_n96_), .O(z14));
