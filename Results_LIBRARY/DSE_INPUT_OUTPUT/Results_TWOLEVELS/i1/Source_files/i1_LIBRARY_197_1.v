...
module FAU ( 
  ...
  nand2  g34(.a(new_n45_), .b(new_n75_), .O(z05));
  ...
  nand4  g42(.a(new_n45_), .b(new_n82_), .c(x22), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z10));
  nand4  g44(.a(new_n45_), .b(new_n82_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  nand4  g46(.a(new_n45_), .b(new_n82_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand4  g48(.a(new_n45_), .b(new_n82_), .c(x23), .d(x17), .O(new_n90_));
