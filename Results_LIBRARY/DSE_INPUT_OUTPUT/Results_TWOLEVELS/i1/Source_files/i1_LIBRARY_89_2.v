...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n79_, new_n82_, new_n84_, new_n86_, new_n87_,
  ...
  aoi21  g36(.a(new_n77_), .b(x19), .c(new_n43_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nor2   g38(.a(new_n44_), .b(new_n79_), .O(z08));
  oai21  g39(.a(new_n77_), .b(new_n79_), .c(new_n70_), .O(z09));
  nand4  g40(.a(new_n70_), .b(new_n77_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n77_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n70_), .O(z11));
  inv1   g44(.a(x23), .O(new_n86_));
  nand2  g45(.a(new_n70_), .b(new_n77_), .O(new_n87_));
