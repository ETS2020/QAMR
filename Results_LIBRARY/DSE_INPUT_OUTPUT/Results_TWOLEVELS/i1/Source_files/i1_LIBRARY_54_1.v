...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(new_n52_), .c(new_n42_), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x08), .c(new_n43_), .O(z01));
  ...
  nand4  g35(.a(new_n53_), .b(new_n76_), .c(new_n75_), .d(new_n50_), .O(new_n77_));
  ...
  nand3  g40(.a(new_n81_), .b(x19), .c(x08), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z06));
  ...
  nand4  g50(.a(new_n45_), .b(new_n88_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  nand4  g52(.a(new_n45_), .b(new_n88_), .c(x23), .d(x14), .O(new_n94_));
