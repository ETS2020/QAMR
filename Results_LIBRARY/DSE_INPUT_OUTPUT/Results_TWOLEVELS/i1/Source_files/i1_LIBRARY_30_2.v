...
module FAU ( 
  ...
  nand2  g25(.a(new_n49_), .b(new_n48_), .O(new_n67_));
  nor4   g26(.a(new_n67_), .b(x09), .c(new_n66_), .d(x07), .O(new_n68_));
  nand4  g27(.a(new_n68_), .b(new_n65_), .c(new_n46_), .d(new_n45_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n64_), .c(new_n43_), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nor2   g30(.a(new_n57_), .b(new_n71_), .O(z03));
  inv1   g31(.a(x21), .O(new_n73_));
  nand3  g32(.a(new_n58_), .b(new_n73_), .c(new_n71_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nand4  g34(.a(new_n48_), .b(new_n61_), .c(new_n47_), .d(new_n46_), .O(new_n76_));
  ...
  oai21  g39(.a(new_n43_), .b(x00), .c(x01), .O(new_n81_));
  ...
  nand4  g43(.a(new_n82_), .b(new_n65_), .c(new_n46_), .d(x00), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n45_), .c(new_n85_), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n43_), .c(new_n81_), .O(z06));
  nand2  g46(.a(x24), .b(x18), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n58_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nand2  g49(.a(new_n58_), .b(new_n90_), .O(z08));
  inv1   g50(.a(x24), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n90_), .c(new_n58_), .O(z09));
  ...
  nand4  g57(.a(new_n58_), .b(new_n92_), .c(x23), .d(x14), .O(new_n99_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n58_), .O(z14));
