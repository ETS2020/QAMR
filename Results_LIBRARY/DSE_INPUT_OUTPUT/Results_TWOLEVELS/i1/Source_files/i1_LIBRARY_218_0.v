...
module FAU ( 
  ...
  nand4  g40(.a(new_n75_), .b(new_n80_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n80_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n75_), .O(z11));
  nand4  g44(.a(new_n75_), .b(new_n80_), .c(x23), .d(x14), .O(new_n86_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n75_), .O(z14));
