...
module FAU ( 
  ...
  nand3  g13(.a(new_n54_), .b(x09), .c(new_n53_), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n47_), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x00), .c(new_n43_), .O(z01));
  ...
  nand3  g23(.a(new_n54_), .b(new_n64_), .c(new_n53_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n52_), .c(new_n63_), .O(new_n66_));
  ...
  nand2  g35(.a(new_n64_), .b(new_n47_), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n53_), .c(new_n76_), .d(new_n75_), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(x04), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n80_));
  nor3   g39(.a(new_n62_), .b(new_n47_), .c(new_n42_), .O(new_n81_));
  ...
  nand2  g49(.a(new_n90_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n89_), .c(new_n45_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n45_), .O(z11));
  nand4  g53(.a(new_n45_), .b(new_n90_), .c(x23), .d(x14), .O(new_n95_));
