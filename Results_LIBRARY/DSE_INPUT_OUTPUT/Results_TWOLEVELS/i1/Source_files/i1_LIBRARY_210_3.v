...
module FAU ( 
  ...
  aoi21  g18(.a(new_n59_), .b(x00), .c(x08), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n54_), .O(z02));
  ...
  nor2   g29(.a(new_n54_), .b(x08), .O(z06));
  ...
  nand4  g38(.a(new_n43_), .b(new_n76_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  nand4  g40(.a(new_n43_), .b(new_n76_), .c(x23), .d(x14), .O(new_n82_));
