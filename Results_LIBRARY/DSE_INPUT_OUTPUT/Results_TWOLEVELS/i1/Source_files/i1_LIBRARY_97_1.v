...
module FAU ( 
  ...
  nand2  g37(.a(new_n78_), .b(new_n58_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nor2   g39(.a(new_n44_), .b(new_n80_), .O(z08));
  inv1   g40(.a(x24), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n58_), .O(z09));
  nand2  g42(.a(new_n82_), .b(x14), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(x19), .c(new_n43_), .O(z10));
  nand2  g44(.a(new_n82_), .b(x17), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(x19), .c(new_n43_), .O(z11));
  nand4  g46(.a(new_n58_), .b(new_n82_), .c(x23), .d(x14), .O(new_n88_));
