...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n80_, new_n82_, new_n83_, new_n85_, new_n87_, new_n89_,
  ...
  nand2  g24(.a(x19), .b(x01), .O(new_n66_));
  and2   g25(.a(new_n66_), .b(x20), .O(z03));
  nor2   g26(.a(x21), .b(x20), .O(new_n68_));
  aoi21  g27(.a(x19), .b(x01), .c(new_n68_), .O(z04));
  ...
  nand2  g36(.a(new_n77_), .b(new_n66_), .O(z07));
  and2   g37(.a(new_n66_), .b(x11), .O(z08));
  ...
  nand2  g42(.a(new_n83_), .b(new_n66_), .O(z10));
  nand4  g43(.a(new_n66_), .b(new_n82_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  nand4  g45(.a(new_n66_), .b(new_n82_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n82_), .b(x23), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n66_), .O(z13));
  ...
  nand4  g54(.a(new_n95_), .b(new_n66_), .c(new_n94_), .d(new_n93_), .O(z15));
endmodule
