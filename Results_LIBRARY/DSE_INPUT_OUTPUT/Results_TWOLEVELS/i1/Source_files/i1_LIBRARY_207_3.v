...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(x09), .c(x08), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n65_), .c(x00), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(new_n81_));
  aoi21  g40(.a(x09), .b(x08), .c(x07), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n83_));
  nor3   g42(.a(new_n83_), .b(x02), .c(x01), .O(new_n84_));
  nand2  g43(.a(new_n64_), .b(new_n43_), .O(new_n85_));
  nor2   g44(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n81_), .c(new_n44_), .O(z06));
  ...
  oai21  g58(.a(new_n99_), .b(new_n94_), .c(new_n46_), .O(z12));
  oai21  g59(.a(new_n99_), .b(new_n97_), .c(new_n46_), .O(z13));
