...
module FAU ( 
  ...
  nor2   g14(.a(x13), .b(new_n42_), .O(new_n56_));
  ...
  nand3  g36(.a(new_n64_), .b(new_n60_), .c(new_n48_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  nand4  g38(.a(new_n61_), .b(x19), .c(new_n58_), .d(new_n79_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(z05));
  oai21  g40(.a(new_n67_), .b(new_n79_), .c(x13), .O(new_n82_));
  ...
  nor3   g44(.a(new_n62_), .b(x13), .c(new_n42_), .O(new_n86_));
  ...
  nand3  g52(.a(new_n43_), .b(new_n92_), .c(x22), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(new_n95_));
  ...
  oai21  g60(.a(new_n101_), .b(new_n100_), .c(new_n43_), .O(z12));
  inv1   g61(.a(x17), .O(new_n103_));
  oai21  g62(.a(new_n101_), .b(new_n103_), .c(new_n43_), .O(z13));
  inv1   g63(.a(x16), .O(new_n105_));
  oai21  g64(.a(x24), .b(new_n105_), .c(new_n43_), .O(z14));
  inv1   g65(.a(x12), .O(new_n107_));
  inv1   g66(.a(x15), .O(new_n108_));
  nand4  g67(.a(new_n108_), .b(new_n100_), .c(new_n58_), .d(new_n107_), .O(z15));
endmodule
