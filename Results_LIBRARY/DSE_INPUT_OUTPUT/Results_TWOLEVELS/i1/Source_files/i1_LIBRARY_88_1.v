...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n67_, new_n68_, new_n69_, new_n72_, new_n74_, new_n76_,
  ...
  nand2  g28(.a(new_n69_), .b(new_n67_), .O(z03));
  or2    g29(.a(z03), .b(x21), .O(z04));
  inv1   g30(.a(x10), .O(new_n72_));
  nor2   g31(.a(new_n68_), .b(new_n72_), .O(z05));
  nor2   g32(.a(new_n43_), .b(x00), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x00), .c(new_n45_), .O(z06));
  ...
  nor3   g41(.a(new_n68_), .b(x24), .c(new_n82_), .O(new_n83_));
  ...
  nand4  g46(.a(new_n69_), .b(new_n80_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n80_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n69_), .O(z13));
  nand2  g50(.a(new_n80_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n69_), .O(z14));
  nor2   g52(.a(x15), .b(x14), .O(new_n94_));
  nor3   g53(.a(new_n68_), .b(x13), .c(x12), .O(new_n95_));
