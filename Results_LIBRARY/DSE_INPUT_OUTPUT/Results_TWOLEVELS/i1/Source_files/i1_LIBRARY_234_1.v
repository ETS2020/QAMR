// Benchmark "FAU" written by ABC on Wed Aug 19 17:35:32 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n76_,
  ...
  nor2   g31(.a(new_n72_), .b(new_n70_), .O(z04));
  nand2  g32(.a(new_n45_), .b(new_n43_), .O(z05));
  nor2   g33(.a(new_n45_), .b(new_n43_), .O(z06));
  inv1   g34(.a(x18), .O(new_n76_));
  inv1   g35(.a(x24), .O(new_n77_));
  nor3   g36(.a(new_n70_), .b(new_n77_), .c(new_n76_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nor2   g38(.a(new_n70_), .b(new_n79_), .O(z08));
  inv1   g39(.a(new_n70_), .O(new_n81_));
  oai21  g40(.a(new_n77_), .b(new_n79_), .c(new_n81_), .O(z09));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n77_), .b(x22), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n81_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n81_), .O(z11));
  inv1   g46(.a(x23), .O(new_n88_));
  nor3   g47(.a(new_n70_), .b(x24), .c(new_n88_), .O(new_n89_));
  ...
  nand2  g52(.a(new_n77_), .b(x16), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n81_), .O(z14));
