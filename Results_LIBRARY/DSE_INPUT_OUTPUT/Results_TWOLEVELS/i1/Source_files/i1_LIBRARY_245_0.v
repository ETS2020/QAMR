// Benchmark "FAU" written by ABC on Wed Aug 19 17:35:36 2020
...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n91_, new_n93_, new_n96_, new_n97_, new_n99_, new_n101_, new_n103_,
    new_n106_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x21), .b(x15), .O(new_n43_));
  ...
  nand2  g30(.a(new_n71_), .b(new_n44_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nand2  g32(.a(new_n44_), .b(new_n73_), .O(z03));
  inv1   g33(.a(x15), .O(new_n75_));
  inv1   g34(.a(x21), .O(new_n76_));
  oai21  g35(.a(new_n73_), .b(new_n75_), .c(new_n76_), .O(z04));
  nand3  g36(.a(x19), .b(new_n66_), .c(new_n51_), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n65_), .c(x10), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n43_), .O(z05));
  ...
  aoi21  g45(.a(new_n86_), .b(x00), .c(new_n43_), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n70_), .c(x19), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z06));
  inv1   g48(.a(x18), .O(new_n90_));
  inv1   g49(.a(x24), .O(new_n91_));
  nor3   g50(.a(new_n43_), .b(new_n91_), .c(new_n90_), .O(z07));
  inv1   g51(.a(x11), .O(new_n93_));
  nor2   g52(.a(new_n43_), .b(new_n93_), .O(z08));
  oai21  g53(.a(new_n91_), .b(new_n93_), .c(new_n44_), .O(z09));
  nor2   g54(.a(new_n43_), .b(x24), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(x22), .c(x14), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z10));
  nand3  g57(.a(new_n91_), .b(x22), .c(x17), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n44_), .O(z11));
  nand3  g59(.a(new_n96_), .b(x23), .c(x14), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z12));
  nand3  g61(.a(new_n96_), .b(x23), .c(x17), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z13));
  and2   g63(.a(new_n96_), .b(x16), .O(z14));
  nor3   g64(.a(x14), .b(x13), .c(x12), .O(new_n106_));
  oai21  g65(.a(new_n106_), .b(new_n76_), .c(new_n75_), .O(z15));
endmodule
