...
module FAU ( 
  ...
  nand3  g34(.a(x24), .b(x19), .c(x18), .O(new_n76_));
  ...
  nand2  g41(.a(new_n43_), .b(new_n80_), .O(new_n83_));
  ...
  nand3  g47(.a(new_n80_), .b(x23), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n43_), .O(z12));
  nand4  g49(.a(new_n43_), .b(new_n80_), .c(x23), .d(x17), .O(new_n91_));
