...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n87_, new_n89_, new_n91_, new_n93_, new_n94_,
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x18), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n63_), .c(new_n58_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nor2   g32(.a(new_n58_), .b(new_n44_), .O(new_n74_));
  ...
  nand3  g40(.a(x24), .b(new_n58_), .c(x18), .O(new_n82_));
  ...
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n87_), .O(z09));
  nand3  g47(.a(new_n86_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n87_), .O(z10));
  nand4  g49(.a(new_n87_), .b(new_n86_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  inv1   g51(.a(x14), .O(new_n93_));
  nand2  g52(.a(new_n86_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n87_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n87_), .O(z13));
  nand3  g56(.a(new_n87_), .b(new_n86_), .c(x16), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z14));
  inv1   g58(.a(x12), .O(new_n100_));
  inv1   g59(.a(x13), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nand4  g61(.a(new_n102_), .b(new_n87_), .c(new_n101_), .d(new_n100_), .O(z15));
  buf    g62(.a(x19), .O(z06));
endmodule
