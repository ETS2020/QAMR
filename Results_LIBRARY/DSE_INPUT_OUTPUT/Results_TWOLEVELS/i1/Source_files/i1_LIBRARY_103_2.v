...
module FAU ( 
  ...
  nand4  g36(.a(new_n77_), .b(new_n66_), .c(new_n65_), .d(new_n51_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n44_), .c(new_n76_), .O(z05));
  nand4  g38(.a(new_n61_), .b(new_n49_), .c(new_n60_), .d(new_n48_), .O(new_n80_));
  nor3   g39(.a(new_n80_), .b(x02), .c(x01), .O(new_n81_));
  nand2  g40(.a(new_n63_), .b(x00), .O(new_n82_));
  ...
  nor3   g48(.a(new_n73_), .b(new_n89_), .c(new_n87_), .O(z09));
  ...
  nand4  g56(.a(new_n44_), .b(new_n89_), .c(x23), .d(x17), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z13));
  inv1   g58(.a(x16), .O(new_n100_));
  nor3   g59(.a(new_n73_), .b(x24), .c(new_n100_), .O(z14));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nor3   g61(.a(new_n73_), .b(x13), .c(x12), .O(new_n103_));
