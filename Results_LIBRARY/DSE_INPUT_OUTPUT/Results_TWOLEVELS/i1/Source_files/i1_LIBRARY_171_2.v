...
module FAU ( 
  ...
  oai21  g14(.a(new_n43_), .b(x00), .c(x01), .O(new_n56_));
  nor3   g15(.a(x04), .b(x03), .c(x02), .O(new_n57_));
  ...
  nand2  g27(.a(new_n43_), .b(x01), .O(new_n69_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n60_), .c(new_n47_), .d(new_n46_), .O(new_n75_));
  nor2   g34(.a(x07), .b(x06), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x19), .c(new_n62_), .O(new_n77_));
  ...
  nand4  g39(.a(new_n76_), .b(new_n48_), .c(new_n60_), .d(new_n47_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(x02), .O(new_n82_));
  nand3  g41(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(new_n45_), .c(new_n83_), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n43_), .c(new_n56_), .O(z06));
  inv1   g44(.a(x18), .O(new_n86_));
  nand2  g45(.a(new_n69_), .b(x24), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(new_n86_), .O(z07));
  inv1   g47(.a(x11), .O(new_n89_));
  nor2   g48(.a(new_n71_), .b(new_n89_), .O(z08));
  nor2   g49(.a(new_n87_), .b(new_n89_), .O(z09));
  inv1   g50(.a(x22), .O(new_n92_));
  inv1   g51(.a(x24), .O(new_n93_));
  nand2  g52(.a(new_n69_), .b(new_n93_), .O(new_n94_));
  nor2   g53(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  ...
  nand2  g59(.a(new_n93_), .b(x23), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n100_), .c(new_n69_), .O(z12));
  inv1   g61(.a(x17), .O(new_n103_));
  oai21  g62(.a(new_n101_), .b(new_n103_), .c(new_n69_), .O(z13));
  inv1   g63(.a(x16), .O(new_n105_));
  nor2   g64(.a(new_n94_), .b(new_n105_), .O(z14));
  nor2   g65(.a(x15), .b(x14), .O(new_n107_));
  nor3   g66(.a(new_n71_), .b(x13), .c(x12), .O(new_n108_));
