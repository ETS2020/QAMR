...
module FAU ( 
  ...
  nor2   g20(.a(x24), .b(new_n42_), .O(new_n62_));
  ...
  aoi21  g49(.a(new_n43_), .b(new_n90_), .c(new_n44_), .O(z07));
  inv1   g50(.a(x11), .O(new_n92_));
  nand2  g51(.a(new_n46_), .b(new_n92_), .O(z08));
  nand3  g52(.a(x24), .b(new_n43_), .c(x11), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z09));
  inv1   g54(.a(x14), .O(new_n96_));
  nand2  g55(.a(new_n44_), .b(x22), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n96_), .c(new_n46_), .O(z10));
  inv1   g57(.a(x17), .O(new_n99_));
  oai21  g58(.a(new_n97_), .b(new_n99_), .c(new_n46_), .O(z11));
  nand2  g59(.a(x23), .b(x14), .O(new_n101_));
  nor2   g60(.a(new_n101_), .b(x24), .O(z12));
  nand3  g61(.a(new_n44_), .b(x23), .c(x17), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n46_), .O(z13));
  inv1   g63(.a(x16), .O(new_n105_));
  nor2   g64(.a(x24), .b(new_n105_), .O(z14));
