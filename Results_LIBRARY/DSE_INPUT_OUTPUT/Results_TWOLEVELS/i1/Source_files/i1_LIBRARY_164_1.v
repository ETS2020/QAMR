...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n94_, new_n95_, new_n97_, new_n99_, new_n101_, new_n104_,
    new_n105_;
  ...
  aoi21  g30(.a(new_n71_), .b(x17), .c(new_n43_), .O(z02));
  ...
  nand4  g37(.a(new_n62_), .b(x19), .c(x17), .d(new_n68_), .O(new_n79_));
  oai22  g38(.a(new_n79_), .b(new_n78_), .c(new_n44_), .d(new_n77_), .O(z05));
  nand3  g39(.a(new_n62_), .b(new_n50_), .c(new_n64_), .O(new_n81_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z11));
  ...
  and2   g61(.a(new_n94_), .b(x16), .O(z14));
