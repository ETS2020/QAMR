...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n84_, new_n85_, new_n87_, new_n89_, new_n92_, new_n94_,
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n57_), .O(new_n70_));
  ...
  nand3  g36(.a(new_n77_), .b(new_n51_), .c(new_n50_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n65_), .c(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n76_), .O(z05));
  nand3  g40(.a(new_n62_), .b(new_n50_), .c(new_n60_), .O(new_n82_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n43_), .O(z06));
  inv1   g45(.a(x24), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(new_n57_), .O(z07));
  inv1   g47(.a(x11), .O(new_n89_));
  nor2   g48(.a(new_n44_), .b(new_n89_), .O(z08));
  nor3   g49(.a(new_n44_), .b(new_n87_), .c(new_n89_), .O(z09));
  nand3  g50(.a(new_n87_), .b(x22), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n45_), .O(z10));
  nand4  g52(.a(new_n45_), .b(new_n87_), .c(x22), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z11));
  inv1   g54(.a(x23), .O(new_n96_));
  nand2  g55(.a(new_n45_), .b(new_n87_), .O(new_n97_));
