...
module FAU ( 
  ...
  nand2  g49(.a(new_n89_), .b(x22), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(x19), .c(new_n43_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n45_), .O(z11));
  nand3  g53(.a(x23), .b(x19), .c(x14), .O(new_n95_));
  nor2   g54(.a(new_n95_), .b(x24), .O(z12));
  nand4  g55(.a(new_n45_), .b(new_n89_), .c(x23), .d(x17), .O(new_n97_));
