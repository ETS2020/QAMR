...
module FAU ( 
  ...
  nand4  g24(.a(new_n65_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n51_), .O(new_n67_));
  nor2   g26(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n63_), .c(new_n43_), .O(z02));
  ...
  nor2   g33(.a(new_n44_), .b(new_n74_), .O(z05));
  nand2  g34(.a(x09), .b(new_n64_), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(x04), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n79_));
  nor3   g38(.a(new_n62_), .b(new_n64_), .c(new_n42_), .O(new_n80_));
