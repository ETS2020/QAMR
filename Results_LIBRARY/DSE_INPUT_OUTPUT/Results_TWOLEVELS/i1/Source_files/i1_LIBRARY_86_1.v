...
module FAU ( 
  ...
  nand3  g19(.a(new_n60_), .b(new_n49_), .c(new_n59_), .O(new_n61_));
  ...
  nand3  g27(.a(new_n68_), .b(x19), .c(x14), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nor2   g30(.a(new_n45_), .b(x14), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n71_), .O(z03));
  nor2   g33(.a(x21), .b(x20), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n72_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n64_), .b(new_n65_), .c(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n63_), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n77_), .O(z05));
  nor2   g40(.a(new_n43_), .b(x00), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x00), .c(new_n45_), .O(z06));
  ...
  nor3   g59(.a(new_n72_), .b(x13), .c(x12), .O(new_n101_));
