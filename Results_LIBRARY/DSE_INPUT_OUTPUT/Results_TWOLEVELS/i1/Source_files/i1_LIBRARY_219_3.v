...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x02), .c(new_n42_), .O(z00));
  ...
  oai21  g34(.a(new_n75_), .b(x02), .c(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n72_), .O(z05));
  nor2   g36(.a(new_n44_), .b(x02), .O(z06));
  nand3  g37(.a(new_n67_), .b(x24), .c(x18), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n68_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n67_), .O(z09));
  nand3  g43(.a(new_n67_), .b(new_n83_), .c(x22), .O(new_n85_));
  ...
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n67_), .O(z12));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n67_), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  oai21  g55(.a(x24), .b(new_n96_), .c(new_n67_), .O(z14));
