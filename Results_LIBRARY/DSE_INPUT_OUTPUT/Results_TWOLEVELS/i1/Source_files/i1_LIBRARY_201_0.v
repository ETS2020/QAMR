...
module FAU ( 
  ...
  nand3  g22(.a(new_n63_), .b(new_n62_), .c(x08), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n61_), .c(x19), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  nor3   g25(.a(x03), .b(x02), .c(x01), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n63_), .c(new_n50_), .d(new_n46_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x19), .c(x00), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n66_), .O(z02));
  ...
  nand4  g34(.a(new_n75_), .b(new_n67_), .c(new_n51_), .d(new_n50_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(x19), .c(x04), .O(new_n77_));
  or2    g36(.a(new_n77_), .b(x10), .O(z05));
  nand4  g37(.a(new_n63_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(x01), .c(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  oai21  g40(.a(new_n68_), .b(new_n42_), .c(x19), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(z06));
