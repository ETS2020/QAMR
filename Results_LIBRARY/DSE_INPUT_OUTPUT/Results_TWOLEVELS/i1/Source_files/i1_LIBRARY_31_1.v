...
module FAU ( 
  ...
  nand3  g13(.a(new_n54_), .b(x19), .c(x09), .O(new_n55_));
  ...
  aoi21  g20(.a(new_n61_), .b(x00), .c(new_n43_), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n57_), .O(z02));
  ...
  nand4  g28(.a(new_n52_), .b(x19), .c(new_n69_), .d(new_n51_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n50_), .c(new_n68_), .O(new_n71_));
  ...
  nand4  g34(.a(new_n51_), .b(new_n75_), .c(new_n74_), .d(new_n49_), .O(new_n76_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n65_), .O(z15));
endmodule
