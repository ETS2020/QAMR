...
module FAU ( 
  ...
  nor2   g25(.a(new_n66_), .b(x01), .O(new_n67_));
  ...
  aoi22  g31(.a(new_n72_), .b(new_n69_), .c(x19), .d(x01), .O(z04));
  ...
  nand3  g44(.a(new_n70_), .b(new_n85_), .c(x22), .O(new_n86_));
  ...
  nand2  g51(.a(new_n85_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n70_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n70_), .O(z13));
  nand3  g55(.a(new_n70_), .b(new_n85_), .c(x16), .O(new_n97_));
