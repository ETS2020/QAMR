...
module FAU ( 
  ...
  oai21  g17(.a(new_n56_), .b(x04), .c(x24), .O(new_n59_));
  ...
  nand3  g23(.a(new_n64_), .b(x22), .c(x14), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n44_), .O(z10));
  ...
  oai21  g32(.a(new_n56_), .b(x04), .c(new_n64_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n73_), .O(z14));
  nor2   g34(.a(x13), .b(x12), .O(new_n76_));
  nor2   g35(.a(x15), .b(x14), .O(new_n77_));
  aoi22  g36(.a(new_n77_), .b(new_n76_), .c(x19), .d(new_n43_), .O(z15));
endmodule
