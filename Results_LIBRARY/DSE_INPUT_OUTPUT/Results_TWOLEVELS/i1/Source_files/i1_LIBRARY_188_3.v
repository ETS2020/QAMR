...
module FAU ( 
  ...
  nand4  g49(.a(new_n43_), .b(new_n90_), .c(x22), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z10));
  nand3  g51(.a(new_n90_), .b(x22), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n43_), .O(z11));
  nand3  g53(.a(new_n43_), .b(new_n90_), .c(x23), .O(new_n95_));
  ...
  aoi22  g63(.a(new_n104_), .b(new_n103_), .c(x19), .d(x05), .O(z15));
endmodule
