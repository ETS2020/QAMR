// Benchmark "FAU" written by ABC on Wed Aug 19 17:34:14 2020
...
module FAU ( 
  ...
  nand3  g09(.a(x19), .b(x09), .c(x08), .O(new_n51_));
  oai21  g10(.a(x09), .b(x08), .c(new_n51_), .O(new_n52_));
  nand4  g11(.a(new_n52_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n53_));
  nor2   g12(.a(new_n53_), .b(x04), .O(new_n54_));
  nand4  g13(.a(new_n54_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n55_));
  aoi21  g14(.a(x19), .b(new_n42_), .c(new_n43_), .O(new_n56_));
  nand2  g15(.a(new_n56_), .b(new_n55_), .O(z01));
  ...
  nand4  g22(.a(new_n60_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n64_));
  ...
  oai21  g28(.a(new_n69_), .b(new_n58_), .c(new_n59_), .O(z02));
  ...
  aoi21  g33(.a(new_n63_), .b(x19), .c(x08), .O(new_n75_));
  or2    g34(.a(new_n75_), .b(x10), .O(z05));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n59_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nor2   g38(.a(new_n43_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  nor3   g40(.a(new_n43_), .b(new_n81_), .c(new_n79_), .O(z09));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n81_), .b(x22), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n59_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n59_), .O(z11));
  nand4  g46(.a(new_n59_), .b(new_n81_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n81_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n59_), .O(z13));
  nand2  g50(.a(new_n81_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n59_), .O(z14));
