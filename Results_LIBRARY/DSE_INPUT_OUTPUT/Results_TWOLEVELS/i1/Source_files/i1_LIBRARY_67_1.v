...
module FAU ( 
  ...
  nand4  g36(.a(new_n77_), .b(new_n67_), .c(new_n66_), .d(new_n53_), .O(new_n78_));
  ...
  nand3  g49(.a(x22), .b(x19), .c(x14), .O(new_n91_));
  nor2   g50(.a(new_n91_), .b(x24), .O(z10));
  nand2  g51(.a(new_n86_), .b(x17), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(x19), .c(new_n43_), .O(z11));
