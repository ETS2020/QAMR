...
module FAU ( 
  ...
  nand3  g13(.a(new_n54_), .b(x19), .c(new_n53_), .O(new_n55_));
  oai21  g14(.a(new_n55_), .b(new_n52_), .c(new_n43_), .O(new_n56_));
  ...
  nand3  g21(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n60_), .c(new_n43_), .O(new_n64_));
  ...
  nand3  g31(.a(new_n54_), .b(x19), .c(new_n47_), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n52_), .c(new_n72_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n43_), .O(new_n75_));
  oai21  g34(.a(new_n72_), .b(new_n47_), .c(new_n75_), .O(z05));
  nand3  g35(.a(new_n54_), .b(x19), .c(new_n43_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n52_), .c(new_n43_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  nand3  g38(.a(new_n64_), .b(new_n47_), .c(x00), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x19), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n79_), .O(z06));
  ...
  nand3  g52(.a(new_n84_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z12));
  nand4  g54(.a(new_n45_), .b(new_n84_), .c(x23), .d(x17), .O(new_n96_));
