...
module FAU ( 
  ...
  nor2   g14(.a(x01), .b(new_n42_), .O(new_n56_));
  ...
  aoi22  g32(.a(new_n73_), .b(new_n71_), .c(x19), .d(x01), .O(z04));
  inv1   g33(.a(x08), .O(new_n75_));
  nand3  g34(.a(new_n64_), .b(x19), .c(new_n75_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n66_), .c(x10), .O(new_n78_));
  nand2  g37(.a(new_n45_), .b(x10), .O(new_n79_));
  oai21  g38(.a(new_n78_), .b(x01), .c(new_n79_), .O(z05));
  oai21  g39(.a(new_n63_), .b(new_n75_), .c(x01), .O(new_n81_));
  ...
  nand4  g43(.a(new_n60_), .b(new_n59_), .c(new_n58_), .d(x00), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n45_), .O(z06));
  nand2  g46(.a(x24), .b(x18), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n43_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nand2  g49(.a(new_n43_), .b(new_n90_), .O(z08));
  nand3  g50(.a(new_n43_), .b(x24), .c(x11), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z09));
  inv1   g52(.a(x24), .O(new_n94_));
  nand4  g53(.a(new_n43_), .b(new_n94_), .c(x22), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z10));
  nand3  g55(.a(new_n94_), .b(x22), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n43_), .O(z11));
  nand4  g57(.a(new_n43_), .b(new_n94_), .c(x23), .d(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n94_), .b(x23), .c(x17), .O(new_n101_));
