...
module FAU ( 
  ...
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n61_), .O(z09));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n85_), .b(x22), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n61_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n61_), .O(z11));
  nand3  g50(.a(new_n61_), .b(new_n85_), .c(x23), .O(new_n92_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n63_), .O(z15));
endmodule
