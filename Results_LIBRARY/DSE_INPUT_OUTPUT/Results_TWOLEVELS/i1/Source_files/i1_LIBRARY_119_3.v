...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n78_, new_n80_, new_n81_, new_n82_, new_n84_, new_n86_, new_n89_,
    new_n91_, new_n92_;
  ...
  nand2  g23(.a(x19), .b(x08), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n64_), .O(z03));
  or2    g25(.a(z03), .b(x21), .O(z04));
  inv1   g26(.a(x10), .O(new_n68_));
  nand4  g27(.a(x19), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n49_), .c(new_n68_), .O(new_n70_));
  ...
  and2   g35(.a(new_n65_), .b(x11), .O(z08));
  nand3  g36(.a(new_n65_), .b(x24), .c(x11), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z09));
  inv1   g38(.a(x14), .O(new_n80_));
  inv1   g39(.a(x24), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x22), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n65_), .O(z10));
  inv1   g42(.a(x17), .O(new_n84_));
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n65_), .O(z11));
  nand2  g44(.a(new_n81_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n80_), .c(new_n65_), .O(z12));
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n65_), .O(z13));
  inv1   g47(.a(x16), .O(new_n89_));
  oai21  g48(.a(x24), .b(new_n89_), .c(new_n65_), .O(z14));
  nor2   g49(.a(x13), .b(x12), .O(new_n91_));
  nor2   g50(.a(x15), .b(x14), .O(new_n92_));
  aoi22  g51(.a(new_n92_), .b(new_n91_), .c(x19), .d(x08), .O(z15));
  buf    g52(.a(x19), .O(z06));
endmodule
