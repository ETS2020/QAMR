...
module FAU ( 
  ...
  nand3  g27(.a(new_n68_), .b(x19), .c(x15), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nor2   g30(.a(new_n45_), .b(x15), .O(new_n72_));
  nor2   g31(.a(new_n72_), .b(new_n71_), .O(z03));
  inv1   g32(.a(x21), .O(new_n74_));
  inv1   g33(.a(new_n72_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n74_), .c(new_n71_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n64_), .b(new_n65_), .c(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n63_), .c(x15), .O(new_n79_));
  ...
  nand2  g42(.a(new_n83_), .b(new_n75_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n72_), .b(new_n85_), .O(z08));
  inv1   g45(.a(x24), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n75_), .O(z09));
  inv1   g47(.a(x22), .O(new_n89_));
  nor3   g48(.a(new_n72_), .b(x24), .c(new_n89_), .O(new_n90_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n75_), .O(z12));
  nand4  g55(.a(new_n75_), .b(new_n87_), .c(x23), .d(x17), .O(new_n97_));
  ...
  nor3   g60(.a(new_n72_), .b(x13), .c(x12), .O(new_n102_));
