...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n93_, new_n96_, new_n97_;
  ...
  nand2  g40(.a(new_n70_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n70_), .O(z09));
