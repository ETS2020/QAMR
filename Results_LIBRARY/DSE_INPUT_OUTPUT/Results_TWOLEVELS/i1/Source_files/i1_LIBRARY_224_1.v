...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n85_, new_n86_, new_n88_, new_n91_, new_n92_, new_n93_,
  ...
  nand3  g37(.a(new_n63_), .b(new_n59_), .c(new_n48_), .O(new_n79_));
  inv1   g38(.a(x08), .O(new_n80_));
  nor2   g39(.a(new_n45_), .b(new_n43_), .O(z06));
  ...
  inv1   g43(.a(new_n74_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x24), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n84_), .O(z07));
  ...
  oai21  g52(.a(new_n93_), .b(new_n91_), .c(new_n85_), .O(z10));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n85_), .O(z11));
  nand3  g55(.a(new_n92_), .b(x23), .c(x14), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n85_), .O(z12));
  nand4  g57(.a(new_n85_), .b(new_n92_), .c(x23), .d(x17), .O(new_n99_));
