...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n89_, new_n90_, new_n92_, new_n94_, new_n97_,
    new_n99_, new_n100_;
  ...
  nand3  g26(.a(new_n53_), .b(x08), .c(new_n51_), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  nand4  g28(.a(new_n69_), .b(new_n67_), .c(new_n50_), .d(new_n49_), .O(new_n70_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(z04));
  nand4  g35(.a(x19), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n67_), .c(x10), .O(new_n79_));
  nand2  g38(.a(x19), .b(x10), .O(new_n80_));
  oai21  g39(.a(new_n79_), .b(x08), .c(new_n80_), .O(z05));
  nand2  g40(.a(new_n61_), .b(new_n43_), .O(z06));
  ...
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n75_), .O(z09));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n84_), .b(x22), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n75_), .O(z10));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n75_), .O(z11));
  nand2  g52(.a(new_n84_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n89_), .c(new_n75_), .O(z12));
  oai21  g54(.a(new_n94_), .b(new_n92_), .c(new_n75_), .O(z13));
  nand2  g55(.a(new_n84_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n75_), .O(z14));
