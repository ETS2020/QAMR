...
module FAU ( 
  ...
  nand4  g34(.a(new_n46_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  nor2   g36(.a(x06), .b(x05), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(x19), .c(new_n77_), .d(new_n52_), .O(new_n79_));
  oai22  g38(.a(new_n79_), .b(new_n76_), .c(new_n43_), .d(new_n75_), .O(z05));
  inv1   g39(.a(x19), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n77_), .c(x07), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n47_), .c(new_n81_), .O(new_n85_));
  oai21  g44(.a(new_n68_), .b(new_n42_), .c(x19), .O(new_n86_));
  oai21  g45(.a(new_n85_), .b(x04), .c(new_n86_), .O(z06));
  inv1   g46(.a(x18), .O(new_n88_));
  nand2  g47(.a(new_n44_), .b(x24), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(new_n88_), .O(z07));
  inv1   g49(.a(x11), .O(new_n91_));
  nand2  g50(.a(new_n44_), .b(new_n91_), .O(z08));
  ...
  nand3  g59(.a(new_n100_), .b(x23), .c(x14), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n44_), .O(z12));
  nand4  g61(.a(new_n44_), .b(new_n100_), .c(x23), .d(x17), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z13));
  nand2  g63(.a(new_n100_), .b(x16), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n44_), .O(z14));
