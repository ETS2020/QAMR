...
module FAU ( 
  ...
  oai21  g59(.a(new_n100_), .b(new_n99_), .c(new_n44_), .O(z12));
  inv1   g60(.a(x17), .O(new_n102_));
  oai21  g61(.a(new_n100_), .b(new_n102_), .c(new_n44_), .O(z13));
  inv1   g62(.a(x16), .O(new_n104_));
  nor3   g63(.a(new_n43_), .b(x24), .c(new_n104_), .O(z14));
  nor2   g64(.a(x15), .b(x14), .O(new_n106_));
  nor3   g65(.a(new_n43_), .b(x13), .c(x12), .O(new_n107_));
