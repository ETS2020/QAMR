...
module FAU ( 
  ...
  inv1   g41(.a(new_n73_), .O(new_n83_));
  ...
  nor3   g47(.a(new_n73_), .b(new_n88_), .c(new_n86_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n88_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n83_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n83_), .O(z11));
  nand4  g53(.a(new_n83_), .b(new_n88_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n88_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n83_), .O(z13));
  nand2  g57(.a(new_n88_), .b(x16), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n83_), .O(z14));
  inv1   g59(.a(x13), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nand4  g61(.a(new_n102_), .b(new_n45_), .c(new_n101_), .d(new_n43_), .O(z15));
endmodule
