...
module FAU ( 
  ...
  nand3  g29(.a(new_n70_), .b(x19), .c(x13), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nor2   g32(.a(new_n45_), .b(x13), .O(new_n74_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n59_), .c(new_n48_), .O(new_n80_));
  inv1   g39(.a(x08), .O(new_n81_));
  nor2   g40(.a(new_n45_), .b(new_n43_), .O(z06));
