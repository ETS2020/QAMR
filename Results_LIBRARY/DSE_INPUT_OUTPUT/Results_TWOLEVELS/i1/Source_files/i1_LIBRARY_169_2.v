...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n88_, new_n90_, new_n92_, new_n94_;
  inv1   g00(.a(x19), .O(new_n42_));
  nand2  g01(.a(new_n42_), .b(x14), .O(new_n43_));
  ...
  nand4  g33(.a(new_n74_), .b(x19), .c(new_n64_), .d(new_n50_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n62_), .c(new_n73_), .O(z05));
  inv1   g35(.a(x18), .O(new_n77_));
  inv1   g36(.a(x24), .O(new_n78_));
  nor3   g37(.a(new_n70_), .b(new_n78_), .c(new_n77_), .O(z07));
  ...
  nand2  g42(.a(x19), .b(x14), .O(new_n84_));
  nor3   g43(.a(new_n84_), .b(x24), .c(new_n83_), .O(z10));
  nand3  g44(.a(new_n78_), .b(x22), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n43_), .O(z11));
  inv1   g46(.a(x23), .O(new_n88_));
  nor3   g47(.a(new_n84_), .b(x24), .c(new_n88_), .O(z12));
  nand3  g48(.a(new_n78_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n43_), .O(z13));
  inv1   g50(.a(x16), .O(new_n92_));
  nor3   g51(.a(new_n70_), .b(x24), .c(new_n92_), .O(z14));
  nor3   g52(.a(x15), .b(x13), .c(x12), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(x14), .c(new_n84_), .O(z15));
  buf    g54(.a(x19), .O(z06));
endmodule
