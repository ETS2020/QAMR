...
module FAU ( 
  ...
  nand3  g21(.a(new_n53_), .b(x08), .c(new_n51_), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  aoi21  g23(.a(new_n62_), .b(x00), .c(new_n64_), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n45_), .c(new_n58_), .O(z02));
  ...
  nand4  g30(.a(new_n53_), .b(x19), .c(new_n52_), .d(new_n51_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n50_), .c(new_n71_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n45_), .O(new_n74_));
  oai21  g33(.a(x19), .b(new_n71_), .c(new_n74_), .O(z05));
  inv1   g34(.a(x05), .O(new_n76_));
  inv1   g35(.a(x06), .O(new_n77_));
  nand4  g36(.a(new_n51_), .b(new_n77_), .c(new_n76_), .d(new_n49_), .O(new_n78_));
  ...
  nor2   g46(.a(new_n68_), .b(new_n87_), .O(z08));
  inv1   g47(.a(x24), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n87_), .c(new_n43_), .O(z09));
  inv1   g49(.a(x14), .O(new_n91_));
  nand2  g50(.a(new_n89_), .b(x22), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n43_), .O(z10));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n43_), .O(z11));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n68_), .O(z15));
endmodule
