...
module FAU ( 
  ...
  nand4  g35(.a(x19), .b(new_n66_), .c(new_n50_), .d(new_n48_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n49_), .O(new_n79_));
  oai21  g38(.a(new_n43_), .b(new_n76_), .c(new_n79_), .O(z05));
  ...
  nor2   g49(.a(new_n57_), .b(new_n90_), .O(z08));
  inv1   g50(.a(x24), .O(new_n92_));
  nor3   g51(.a(new_n57_), .b(new_n92_), .c(new_n90_), .O(z09));
  nand3  g52(.a(new_n92_), .b(x22), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n58_), .O(z10));
  nand4  g54(.a(new_n58_), .b(new_n92_), .c(x22), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z11));
  inv1   g56(.a(x14), .O(new_n98_));
  nand2  g57(.a(new_n92_), .b(x23), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n98_), .c(new_n58_), .O(z12));
  inv1   g59(.a(x17), .O(new_n101_));
  oai21  g60(.a(new_n99_), .b(new_n101_), .c(new_n58_), .O(z13));
  inv1   g61(.a(x16), .O(new_n103_));
  nor3   g62(.a(new_n57_), .b(x24), .c(new_n103_), .O(z14));
  nor2   g63(.a(x15), .b(x14), .O(new_n105_));
  nor3   g64(.a(new_n57_), .b(x13), .c(x12), .O(new_n106_));
