...
module FAU ( 
  ...
  nand2  g35(.a(new_n58_), .b(x08), .O(z06));
  ...
  oai21  g41(.a(new_n79_), .b(new_n81_), .c(new_n59_), .O(z09));
  inv1   g42(.a(x22), .O(new_n84_));
  nand2  g43(.a(new_n59_), .b(new_n79_), .O(new_n85_));
  ...
  nor2   g50(.a(new_n85_), .b(new_n91_), .O(new_n92_));
  ...
  nor2   g56(.a(new_n85_), .b(new_n97_), .O(z14));
