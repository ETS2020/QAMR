...
module FAU ( 
  ...
  nor2   g15(.a(x19), .b(new_n45_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n56_), .O(z01));
  oai21  g18(.a(new_n43_), .b(x00), .c(x01), .O(new_n60_));
  nor3   g19(.a(x04), .b(x03), .c(x02), .O(new_n61_));
  ...
  nand4  g36(.a(new_n77_), .b(new_n67_), .c(new_n76_), .d(new_n50_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n58_), .c(new_n75_), .O(z05));
  nand2  g38(.a(new_n62_), .b(new_n64_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n82_));
  nand3  g41(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(new_n83_));
  nor2   g42(.a(x05), .b(x04), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n50_), .c(new_n49_), .O(new_n85_));
  nor3   g44(.a(new_n85_), .b(new_n83_), .c(new_n42_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n82_), .c(new_n43_), .O(z06));
  inv1   g46(.a(x18), .O(new_n88_));
  inv1   g47(.a(x24), .O(new_n89_));
  nor3   g48(.a(new_n57_), .b(new_n89_), .c(new_n88_), .O(z07));
  inv1   g49(.a(x11), .O(new_n91_));
  nand2  g50(.a(new_n58_), .b(new_n91_), .O(z08));
  oai21  g51(.a(new_n89_), .b(new_n91_), .c(new_n58_), .O(z09));
  inv1   g52(.a(x14), .O(new_n94_));
  nand2  g53(.a(new_n89_), .b(x22), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n94_), .c(new_n58_), .O(z10));
  inv1   g55(.a(x17), .O(new_n97_));
  oai21  g56(.a(new_n95_), .b(new_n97_), .c(new_n58_), .O(z11));
  nand4  g57(.a(new_n58_), .b(new_n89_), .c(x23), .d(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n89_), .b(x23), .c(x17), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n58_), .O(z13));
  inv1   g61(.a(x16), .O(new_n103_));
  nor3   g62(.a(new_n57_), .b(x24), .c(new_n103_), .O(z14));
  nor2   g63(.a(x13), .b(x12), .O(new_n105_));
  nor2   g64(.a(x15), .b(x14), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n57_), .O(z15));
endmodule
