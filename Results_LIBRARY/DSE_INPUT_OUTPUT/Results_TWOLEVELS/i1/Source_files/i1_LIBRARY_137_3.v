...
module FAU ( 
  ...
  nand2  g36(.a(new_n77_), .b(new_n70_), .O(z10));
  nand4  g37(.a(new_n70_), .b(new_n75_), .c(x22), .d(x17), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z11));
  nand4  g39(.a(new_n70_), .b(new_n75_), .c(x23), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z12));
  nand3  g41(.a(new_n75_), .b(x23), .c(x17), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n70_), .O(z13));
  ...
  nand4  g48(.a(new_n89_), .b(new_n70_), .c(new_n88_), .d(new_n87_), .O(z15));
endmodule
