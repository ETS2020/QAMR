...
module FAU ( 
  ...
  nor2   g32(.a(new_n73_), .b(new_n71_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  inv1   g34(.a(new_n71_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(z05));
  nor2   g36(.a(new_n45_), .b(new_n43_), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nor2   g40(.a(new_n71_), .b(new_n81_), .O(z08));
  inv1   g41(.a(x24), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n76_), .O(z09));
  nand3  g43(.a(new_n83_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n76_), .O(z10));
  nand4  g45(.a(new_n76_), .b(new_n83_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  nand4  g47(.a(new_n76_), .b(new_n83_), .c(x23), .d(x14), .O(new_n89_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n76_), .O(z14));
