...
module FAU ( 
  ...
  nor2   g14(.a(x19), .b(new_n55_), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(new_n54_), .O(z01));
  ...
  nand3  g21(.a(new_n62_), .b(x19), .c(new_n48_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n61_), .c(x00), .O(new_n64_));
  nor3   g23(.a(x05), .b(x04), .c(x03), .O(new_n65_));
  inv1   g24(.a(x09), .O(new_n66_));
  nand3  g25(.a(x19), .b(new_n66_), .c(x08), .O(new_n67_));
  nor3   g26(.a(new_n67_), .b(x07), .c(x06), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(new_n65_), .c(new_n59_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n64_), .O(z02));
  inv1   g29(.a(x20), .O(new_n71_));
  nor2   g30(.a(new_n56_), .b(new_n71_), .O(z03));
  nor2   g31(.a(x21), .b(x20), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n56_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  inv1   g34(.a(x08), .O(new_n76_));
  nand4  g35(.a(new_n62_), .b(x19), .c(new_n76_), .d(new_n48_), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n61_), .c(new_n56_), .d(new_n75_), .O(z05));
  ...
  nor3   g55(.a(new_n56_), .b(x13), .c(x12), .O(new_n97_));
