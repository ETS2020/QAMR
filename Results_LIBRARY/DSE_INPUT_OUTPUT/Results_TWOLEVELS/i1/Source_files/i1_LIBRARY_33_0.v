...
module FAU ( 
  ...
  nor2   g01(.a(x24), .b(x21), .O(new_n43_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n71_), .c(new_n73_), .O(z04));
  ...
  nand3  g39(.a(new_n80_), .b(new_n45_), .c(new_n76_), .O(z05));
  nor2   g40(.a(new_n43_), .b(new_n78_), .O(z06));
  ...
  oai21  g45(.a(new_n74_), .b(new_n85_), .c(new_n45_), .O(z09));
  nand3  g46(.a(x22), .b(x21), .c(x14), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(x24), .O(z10));
  nand2  g48(.a(x22), .b(x17), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(x21), .c(x24), .O(z11));
  nand2  g50(.a(x23), .b(x14), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(x21), .c(x24), .O(z12));
  nand2  g52(.a(x23), .b(x17), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(x21), .c(x24), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  aoi21  g55(.a(x21), .b(new_n96_), .c(x24), .O(z14));
