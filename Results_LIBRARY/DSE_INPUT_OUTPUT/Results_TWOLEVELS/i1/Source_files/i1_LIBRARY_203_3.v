...
module FAU ( 
  ...
  nand4  g38(.a(new_n61_), .b(new_n44_), .c(x19), .d(new_n68_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(new_n74_), .d(new_n78_), .O(z05));
  inv1   g40(.a(new_n74_), .O(new_n82_));
  ...
  nand4  g47(.a(new_n87_), .b(x22), .c(new_n58_), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z10));
  nand4  g49(.a(new_n87_), .b(x22), .c(new_n58_), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand4  g51(.a(new_n82_), .b(new_n87_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n87_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n82_), .O(z13));
  nand2  g55(.a(new_n87_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n82_), .O(z14));
  nor2   g57(.a(x13), .b(x12), .O(new_n99_));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n74_), .O(z15));
  buf    g60(.a(x19), .O(z06));
endmodule
