...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(x00), .c(new_n44_), .O(z01));
  nor2   g14(.a(x19), .b(x00), .O(new_n56_));
  ...
  nand4  g22(.a(new_n63_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n64_));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n44_), .O(z06));
  inv1   g41(.a(x18), .O(new_n83_));
  inv1   g42(.a(x24), .O(new_n84_));
  nor3   g43(.a(new_n56_), .b(new_n84_), .c(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nor2   g45(.a(new_n56_), .b(new_n86_), .O(z08));
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n57_), .O(z09));
  inv1   g47(.a(x22), .O(new_n89_));
  nand2  g48(.a(new_n57_), .b(new_n84_), .O(new_n90_));
  ...
  nand4  g54(.a(new_n57_), .b(new_n84_), .c(x23), .d(x14), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z12));
  nand3  g56(.a(new_n84_), .b(x23), .c(x17), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n57_), .O(z13));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n56_), .O(z15));
endmodule
