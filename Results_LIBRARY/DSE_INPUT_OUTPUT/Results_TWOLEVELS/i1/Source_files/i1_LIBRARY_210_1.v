...
module FAU ( 
  ...
  nand4  g12(.a(x09), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n54_));
  ...
  nand4  g22(.a(new_n63_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  aoi21  g24(.a(new_n62_), .b(x00), .c(new_n65_), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(x08), .c(new_n58_), .O(z02));
  ...
  nand4  g31(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n49_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n75_));
  nor2   g34(.a(new_n62_), .b(new_n42_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x19), .c(x08), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z06));
  ...
  nand4  g57(.a(new_n98_), .b(new_n44_), .c(new_n97_), .d(new_n96_), .O(z15));
endmodule
