...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x13), .c(new_n42_), .O(z00));
  ...
  nor2   g13(.a(x13), .b(new_n42_), .O(new_n55_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n74_), .O(z10));
  nand4  g48(.a(new_n74_), .b(new_n87_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n87_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n74_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n74_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  oai21  g56(.a(x24), .b(new_n97_), .c(new_n74_), .O(z14));
