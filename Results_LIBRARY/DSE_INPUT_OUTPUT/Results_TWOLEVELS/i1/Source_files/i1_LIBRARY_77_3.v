...
module FAU ( 
  ...
  nand2  g29(.a(x19), .b(x11), .O(new_n71_));
  ...
  nor2   g40(.a(new_n81_), .b(x11), .O(z06));
  nand3  g41(.a(new_n71_), .b(x24), .c(x18), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z07));
  nor2   g43(.a(x19), .b(new_n44_), .O(z08));
  nand2  g44(.a(z08), .b(x24), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z09));
  inv1   g46(.a(x24), .O(new_n88_));
  nand3  g47(.a(new_n71_), .b(new_n88_), .c(x22), .O(new_n89_));
  ...
  nand3  g53(.a(new_n71_), .b(new_n88_), .c(x23), .O(new_n95_));
  ...
  oai21  g60(.a(x24), .b(new_n101_), .c(new_n71_), .O(z14));
