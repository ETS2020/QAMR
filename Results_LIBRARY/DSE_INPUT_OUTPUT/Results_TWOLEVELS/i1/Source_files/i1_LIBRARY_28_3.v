...
module FAU ( 
  ...
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(new_n51_), .d(new_n64_), .O(new_n67_));
  nand4  g26(.a(new_n64_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  nand3  g28(.a(new_n55_), .b(x08), .c(new_n53_), .O(new_n70_));
  nor3   g29(.a(new_n70_), .b(x06), .c(x05), .O(new_n71_));
  aoi22  g30(.a(new_n71_), .b(new_n69_), .c(new_n67_), .d(x00), .O(new_n72_));
  ...
  nor2   g37(.a(x06), .b(x05), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n43_), .c(new_n54_), .d(new_n53_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n68_), .c(new_n43_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x19), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n78_), .O(z05));
  nand3  g42(.a(new_n66_), .b(new_n51_), .c(new_n64_), .O(new_n84_));
  ...
  nand4  g57(.a(new_n46_), .b(new_n95_), .c(x22), .d(x17), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z11));
  nand3  g59(.a(new_n95_), .b(x23), .c(x14), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n46_), .O(z12));
  nand4  g61(.a(new_n46_), .b(new_n95_), .c(x23), .d(x17), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z13));
  nand3  g63(.a(new_n95_), .b(new_n44_), .c(x16), .O(new_n105_));
