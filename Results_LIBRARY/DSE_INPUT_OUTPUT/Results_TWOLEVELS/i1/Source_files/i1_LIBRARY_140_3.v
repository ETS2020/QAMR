...
module FAU ( 
  ...
  oai21  g16(.a(new_n57_), .b(new_n52_), .c(x00), .O(new_n58_));
  ...
  aoi21  g23(.a(new_n64_), .b(x00), .c(x08), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n44_), .O(z02));
  inv1   g25(.a(x20), .O(new_n67_));
  nor2   g26(.a(new_n45_), .b(new_n67_), .O(z03));
  nor2   g27(.a(x21), .b(x20), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n45_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nand4  g30(.a(x19), .b(new_n55_), .c(new_n54_), .d(new_n53_), .O(new_n72_));
  ...
  nor2   g35(.a(new_n44_), .b(x08), .O(z06));
  ...
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n46_), .O(z10));
  ...
  nand4  g50(.a(new_n46_), .b(new_n85_), .c(x23), .d(x17), .O(new_n92_));
