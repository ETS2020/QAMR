...
module FAU ( 
  ...
  nand3  g29(.a(new_n70_), .b(x23), .c(x19), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nor2   g32(.a(x23), .b(new_n45_), .O(new_n74_));
  ...
  nor2   g39(.a(new_n43_), .b(new_n45_), .O(z06));
  ...
  oai21  g54(.a(new_n95_), .b(new_n90_), .c(new_n75_), .O(z12));
  oai21  g55(.a(new_n95_), .b(new_n93_), .c(new_n75_), .O(z13));
  nand2  g56(.a(new_n88_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n75_), .O(z14));
  nor2   g58(.a(x13), .b(x12), .O(new_n100_));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n74_), .O(z15));
endmodule
