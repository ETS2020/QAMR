...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n68_, new_n69_, new_n71_, new_n72_, new_n76_,
  ...
  and2   g32(.a(new_n69_), .b(x10), .O(z05));
  ...
  nor3   g39(.a(new_n71_), .b(new_n80_), .c(new_n78_), .O(z09));
  nand3  g40(.a(new_n80_), .b(x22), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n69_), .O(z10));
  nand4  g42(.a(new_n69_), .b(new_n80_), .c(x22), .d(x17), .O(new_n84_));
