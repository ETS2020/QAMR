...
module FAU ( 
  ...
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n43_), .b(new_n78_), .O(z08));
  inv1   g38(.a(x24), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(z09));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n80_), .b(x22), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n75_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n75_), .O(z11));
  nand4  g45(.a(new_n75_), .b(new_n80_), .c(x23), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z12));
  nand3  g47(.a(new_n80_), .b(x23), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n75_), .O(z13));
  nand2  g49(.a(new_n80_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n75_), .O(z14));
