...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n79_, new_n81_, new_n83_, new_n85_, new_n86_,
  ...
  oai21  g35(.a(new_n76_), .b(new_n65_), .c(new_n43_), .O(z05));
  nand2  g36(.a(new_n60_), .b(new_n43_), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n46_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n46_), .b(new_n81_), .O(z08));
  ...
  nand4  g50(.a(new_n46_), .b(new_n83_), .c(x23), .d(x17), .O(new_n92_));
