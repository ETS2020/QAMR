...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n77_, new_n79_, new_n80_, new_n82_, new_n84_, new_n86_,
  ...
  nand3  g25(.a(new_n66_), .b(new_n50_), .c(new_n49_), .O(new_n67_));
  ...
  nor3   g43(.a(new_n72_), .b(new_n84_), .c(new_n82_), .O(z09));
  inv1   g44(.a(x14), .O(new_n86_));
  nand2  g45(.a(new_n84_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n79_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n79_), .O(z11));
  nand3  g49(.a(new_n84_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n79_), .O(z12));
  nand4  g51(.a(new_n79_), .b(new_n84_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  nand2  g53(.a(new_n84_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n79_), .O(z14));
  nor2   g55(.a(x13), .b(x12), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n72_), .O(z15));
endmodule
