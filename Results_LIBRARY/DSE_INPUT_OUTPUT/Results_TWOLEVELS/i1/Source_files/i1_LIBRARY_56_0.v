...
module FAU ( 
  ...
  nand4  g34(.a(new_n66_), .b(new_n58_), .c(new_n67_), .d(new_n52_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n63_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n75_), .O(z05));
  nand4  g38(.a(x08), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n80_));
  ...
  nand4  g57(.a(new_n44_), .b(new_n91_), .c(x23), .d(x14), .O(new_n99_));
  ...
  nor3   g64(.a(new_n43_), .b(x13), .c(x12), .O(new_n106_));
