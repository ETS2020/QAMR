...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n89_, new_n91_, new_n93_, new_n94_, new_n95_,
  ...
  nand4  g34(.a(new_n75_), .b(new_n67_), .c(new_n66_), .d(new_n53_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n45_), .c(new_n74_), .O(z05));
  nand4  g36(.a(new_n61_), .b(new_n51_), .c(new_n64_), .d(new_n50_), .O(new_n78_));
  ...
  nand4  g49(.a(new_n45_), .b(new_n84_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  inv1   g51(.a(x23), .O(new_n93_));
  nand2  g52(.a(new_n45_), .b(new_n84_), .O(new_n94_));
