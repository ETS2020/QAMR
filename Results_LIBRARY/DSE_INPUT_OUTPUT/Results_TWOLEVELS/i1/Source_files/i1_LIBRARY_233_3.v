...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n81_, new_n83_, new_n84_, new_n85_, new_n87_,
  ...
  nand2  g32(.a(new_n57_), .b(new_n42_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n45_), .O(new_n75_));
  nor2   g34(.a(x08), .b(new_n42_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n71_), .O(z06));
  nand3  g36(.a(new_n43_), .b(x24), .c(x18), .O(new_n78_));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n62_), .O(z15));
endmodule
