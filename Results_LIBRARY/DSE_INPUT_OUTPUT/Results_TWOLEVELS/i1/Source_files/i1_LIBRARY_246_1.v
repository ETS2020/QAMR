...
module FAU ( 
  ...
  nor2   g39(.a(new_n43_), .b(x00), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x00), .c(new_n45_), .O(z06));
  inv1   g41(.a(x18), .O(new_n83_));
  inv1   g42(.a(x24), .O(new_n84_));
  nor3   g43(.a(new_n70_), .b(new_n84_), .c(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n73_), .b(new_n86_), .O(z08));
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n73_), .O(z09));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n84_), .b(x22), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n73_), .O(z10));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n73_), .O(z11));
  nand2  g52(.a(new_n84_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n89_), .c(new_n73_), .O(z12));
  oai21  g54(.a(new_n94_), .b(new_n92_), .c(new_n73_), .O(z13));
