...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n63_), .c(new_n60_), .d(new_n46_), .O(new_n68_));
  ...
  nand3  g35(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n77_));
  inv1   g36(.a(x08), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n45_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n76_), .O(z05));
  ...
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n74_), .O(z09));
  ...
  nand2  g59(.a(new_n100_), .b(new_n74_), .O(z14));
  nor2   g60(.a(x13), .b(x12), .O(new_n102_));
  nor2   g61(.a(x15), .b(x14), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z15));
  buf    g63(.a(x19), .O(z06));
endmodule
