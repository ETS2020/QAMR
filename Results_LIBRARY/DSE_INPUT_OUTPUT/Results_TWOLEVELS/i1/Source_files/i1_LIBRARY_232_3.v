...
module FAU ( 
  ...
  nor2   g27(.a(new_n52_), .b(x08), .O(z06));
  ...
  nand2  g37(.a(new_n78_), .b(new_n70_), .O(z10));
  nand4  g38(.a(new_n70_), .b(new_n77_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n77_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n70_), .O(z12));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n70_), .O(z13));
  nand2  g45(.a(new_n77_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n70_), .O(z14));
  nor2   g47(.a(x13), .b(x12), .O(new_n89_));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n61_), .O(z15));
endmodule
