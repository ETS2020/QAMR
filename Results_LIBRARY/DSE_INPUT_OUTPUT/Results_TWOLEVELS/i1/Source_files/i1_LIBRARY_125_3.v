...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n88_, new_n90_, new_n92_, new_n94_, new_n97_, new_n98_;
  ...
  nand2  g26(.a(x19), .b(x16), .O(new_n68_));
  and2   g27(.a(new_n68_), .b(x20), .O(z03));
  inv1   g28(.a(new_n68_), .O(new_n70_));
  ...
  nand3  g34(.a(new_n75_), .b(new_n49_), .c(new_n48_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n61_), .c(new_n74_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n73_), .O(z05));
  nor2   g38(.a(x16), .b(x00), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x00), .c(new_n44_), .O(z06));
  nand3  g40(.a(new_n68_), .b(x24), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nand2  g43(.a(new_n68_), .b(new_n84_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n68_), .O(z09));
  nand3  g46(.a(new_n86_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n68_), .O(z10));
  nand4  g48(.a(new_n68_), .b(new_n86_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand4  g50(.a(new_n68_), .b(new_n86_), .c(x23), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z12));
  nand3  g52(.a(new_n86_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n68_), .O(z13));
  aoi21  g54(.a(x24), .b(new_n44_), .c(new_n74_), .O(z14));
