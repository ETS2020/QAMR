...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(z02));
  ...
  nand3  g34(.a(new_n68_), .b(x19), .c(new_n52_), .O(new_n76_));
  ...
  nand3  g39(.a(new_n63_), .b(new_n50_), .c(new_n61_), .O(new_n81_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n60_), .O(z06));
