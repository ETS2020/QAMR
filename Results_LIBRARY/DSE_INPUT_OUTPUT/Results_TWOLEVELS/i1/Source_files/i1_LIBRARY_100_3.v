...
module FAU ( 
  ...
  nand3  g27(.a(new_n65_), .b(new_n56_), .c(x08), .O(new_n69_));
  ...
  nand3  g35(.a(new_n65_), .b(x19), .c(new_n55_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n68_), .c(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n43_), .O(new_n79_));
  oai21  g38(.a(x19), .b(new_n76_), .c(new_n79_), .O(z05));
  ...
  nand2  g60(.a(new_n101_), .b(new_n46_), .O(z14));
