...
module FAU ( 
  ...
  nand4  g29(.a(new_n70_), .b(new_n67_), .c(new_n66_), .d(new_n50_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n65_), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(new_n46_), .c(x19), .O(new_n73_));
  ...
  nand3  g37(.a(new_n67_), .b(new_n62_), .c(new_n50_), .O(new_n79_));
  inv1   g38(.a(x08), .O(new_n80_));
  nand4  g39(.a(new_n63_), .b(x19), .c(new_n43_), .d(new_n80_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n79_), .c(x24), .d(new_n43_), .O(z05));
  nand3  g41(.a(new_n63_), .b(new_n51_), .c(new_n66_), .O(new_n83_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(x10), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n44_), .c(x19), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n46_), .O(z06));
  nand3  g48(.a(x24), .b(x18), .c(new_n43_), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z07));
  inv1   g50(.a(x11), .O(new_n92_));
  aoi21  g51(.a(x24), .b(x10), .c(new_n92_), .O(z08));
  aoi21  g52(.a(new_n92_), .b(new_n43_), .c(new_n44_), .O(z09));
  nand3  g53(.a(new_n44_), .b(x22), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n46_), .O(z10));
  nand2  g55(.a(x22), .b(x17), .O(new_n97_));
  nor2   g56(.a(new_n97_), .b(x24), .O(z11));
  nand3  g57(.a(new_n44_), .b(x23), .c(x14), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n46_), .O(z12));
  nand2  g59(.a(x23), .b(x17), .O(new_n101_));
  nor2   g60(.a(new_n101_), .b(x24), .O(z13));
  nand2  g61(.a(new_n44_), .b(x16), .O(new_n103_));
