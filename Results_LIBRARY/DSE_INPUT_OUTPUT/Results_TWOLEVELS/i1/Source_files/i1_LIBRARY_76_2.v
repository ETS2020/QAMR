...
module FAU ( 
  ...
  nand4  g22(.a(new_n59_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n64_));
  ...
  nand3  g32(.a(new_n73_), .b(new_n43_), .c(new_n46_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nand3  g34(.a(new_n66_), .b(new_n67_), .c(new_n52_), .O(new_n76_));
  ...
  inv1   g38(.a(x09), .O(new_n80_));
  nand3  g39(.a(new_n43_), .b(new_n80_), .c(x08), .O(new_n81_));
  ...
  nor3   g43(.a(new_n62_), .b(new_n43_), .c(new_n42_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n46_), .O(z06));
  ...
  nand2  g53(.a(new_n44_), .b(new_n94_), .O(new_n95_));
  nor2   g54(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  ...
  nor2   g60(.a(new_n95_), .b(new_n101_), .O(new_n102_));
  ...
  nor2   g66(.a(new_n95_), .b(new_n107_), .O(z14));
  inv1   g67(.a(x12), .O(new_n109_));
  inv1   g68(.a(x13), .O(new_n110_));
  nor2   g69(.a(x15), .b(x14), .O(new_n111_));
  nand4  g70(.a(new_n111_), .b(new_n44_), .c(new_n110_), .d(new_n109_), .O(z15));
  buf    g71(.a(x20), .O(z03));
endmodule
