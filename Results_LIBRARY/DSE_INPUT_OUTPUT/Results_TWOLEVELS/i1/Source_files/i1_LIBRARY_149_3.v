...
module FAU ( 
  ...
  nand3  g53(.a(new_n94_), .b(new_n93_), .c(x22), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z10));
  nand3  g55(.a(new_n93_), .b(x22), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n46_), .O(z11));
  nand3  g57(.a(new_n94_), .b(new_n93_), .c(x23), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand4  g59(.a(new_n46_), .b(new_n93_), .c(x23), .d(x17), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z13));
  nand3  g61(.a(new_n46_), .b(new_n93_), .c(x16), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z14));
  inv1   g63(.a(new_n94_), .O(new_n105_));
  nor3   g64(.a(x15), .b(x13), .c(x12), .O(new_n106_));
  oai21  g65(.a(new_n106_), .b(x14), .c(new_n105_), .O(z15));
endmodule
