...
module FAU ( 
  ...
  nand4  g14(.a(x19), .b(new_n55_), .c(new_n54_), .d(new_n53_), .O(new_n56_));
  oai21  g15(.a(new_n56_), .b(new_n52_), .c(new_n43_), .O(new_n57_));
  ...
  nand3  g20(.a(new_n54_), .b(new_n53_), .c(new_n51_), .O(new_n62_));
  oai21  g21(.a(new_n62_), .b(new_n61_), .c(new_n43_), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n47_), .O(new_n64_));
  ...
  nand4  g30(.a(x19), .b(new_n54_), .c(new_n53_), .d(new_n51_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n61_), .c(new_n43_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n47_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n71_), .O(z05));
  nand3  g34(.a(new_n63_), .b(new_n47_), .c(x00), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n74_), .O(z06));
