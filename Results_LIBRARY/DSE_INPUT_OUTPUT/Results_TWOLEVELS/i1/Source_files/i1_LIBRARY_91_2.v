...
module FAU ( 
  ...
  nand3  g18(.a(new_n48_), .b(new_n47_), .c(new_n43_), .O(new_n60_));
  ...
  nand3  g24(.a(new_n65_), .b(new_n47_), .c(new_n43_), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n84_), .b(new_n43_), .c(new_n85_), .O(new_n86_));
  ...
  nand4  g57(.a(new_n45_), .b(new_n92_), .c(x23), .d(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n92_), .b(x23), .c(x17), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n45_), .O(z13));
