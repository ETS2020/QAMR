...
module FAU ( 
  ...
  and2   g25(.a(new_n59_), .b(new_n45_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(z05));
  oai21  g27(.a(new_n59_), .b(new_n42_), .c(new_n45_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n66_), .O(z06));
  ...
  oai21  g35(.a(new_n76_), .b(new_n73_), .c(new_n43_), .O(z09));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n74_), .O(z15));
endmodule
