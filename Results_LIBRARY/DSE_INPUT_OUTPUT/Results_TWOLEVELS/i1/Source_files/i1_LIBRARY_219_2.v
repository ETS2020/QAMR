...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n92_, new_n95_, new_n96_, new_n97_, new_n99_, new_n101_, new_n102_,
    new_n104_, new_n106_, new_n108_, new_n109_;
  inv1   g00(.a(x00), .O(new_n42_));
  inv1   g01(.a(x19), .O(new_n43_));
  aoi21  g02(.a(new_n43_), .b(x02), .c(new_n42_), .O(z00));
  ...
  nor2   g15(.a(x19), .b(new_n46_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n56_), .O(z01));
  oai21  g18(.a(new_n43_), .b(x00), .c(x02), .O(new_n60_));
  ...
  nor3   g49(.a(new_n57_), .b(new_n90_), .c(new_n89_), .O(z07));
  inv1   g50(.a(x11), .O(new_n92_));
  nor2   g51(.a(new_n57_), .b(new_n92_), .O(z08));
  oai21  g52(.a(new_n90_), .b(new_n92_), .c(new_n58_), .O(z09));
  ...
  nand2  g60(.a(new_n90_), .b(x23), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n101_), .c(new_n58_), .O(z12));
  inv1   g62(.a(x17), .O(new_n104_));
  oai21  g63(.a(new_n102_), .b(new_n104_), .c(new_n58_), .O(z13));
  nand2  g64(.a(new_n90_), .b(x16), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n58_), .O(z14));
  nor2   g66(.a(x13), .b(x12), .O(new_n108_));
  nor2   g67(.a(x15), .b(x14), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n57_), .O(z15));
endmodule
