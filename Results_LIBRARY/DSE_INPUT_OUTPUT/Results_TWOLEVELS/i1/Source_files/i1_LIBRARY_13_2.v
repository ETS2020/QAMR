...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(new_n56_), .c(new_n47_), .O(new_n58_));
  nor2   g17(.a(x06), .b(x05), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(x19), .c(new_n50_), .O(new_n60_));
  oai21  g19(.a(new_n60_), .b(new_n58_), .c(x00), .O(new_n61_));
  nor3   g20(.a(x05), .b(x04), .c(x03), .O(new_n62_));
  inv1   g21(.a(x09), .O(new_n63_));
  nand3  g22(.a(x19), .b(new_n63_), .c(x08), .O(new_n64_));
  nor3   g23(.a(new_n64_), .b(x07), .c(x06), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(new_n62_), .c(new_n57_), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n61_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nor2   g27(.a(x19), .b(new_n42_), .O(new_n69_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n59_), .c(new_n75_), .d(new_n50_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n72_), .c(new_n74_), .O(z05));
  nand2  g37(.a(new_n43_), .b(new_n42_), .O(z06));
  ...
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n72_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n72_), .O(z11));
  inv1   g50(.a(x23), .O(new_n92_));
  nor3   g51(.a(new_n69_), .b(x24), .c(new_n92_), .O(new_n93_));
  ...
  nand2  g57(.a(new_n98_), .b(new_n72_), .O(z14));
  nor2   g58(.a(x13), .b(x12), .O(new_n100_));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n69_), .O(z15));
endmodule
