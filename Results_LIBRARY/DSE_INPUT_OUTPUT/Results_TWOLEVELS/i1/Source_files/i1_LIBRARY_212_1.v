...
module FAU ( 
  ...
  nor2   g11(.a(new_n46_), .b(x01), .O(new_n53_));
  nor2   g12(.a(x21), .b(x20), .O(new_n54_));
  nor2   g13(.a(new_n54_), .b(new_n53_), .O(z04));
  inv1   g14(.a(x10), .O(new_n56_));
  nor2   g15(.a(new_n53_), .b(new_n56_), .O(z05));
  nor2   g16(.a(new_n43_), .b(x00), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x00), .c(new_n46_), .O(z06));
  nand2  g18(.a(x24), .b(x18), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(new_n44_), .O(z07));
  inv1   g20(.a(x11), .O(new_n62_));
  nand2  g21(.a(new_n44_), .b(new_n62_), .O(z08));
  oai21  g22(.a(new_n46_), .b(x01), .c(x24), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n62_), .O(z09));
  inv1   g24(.a(x24), .O(new_n66_));
  nand4  g25(.a(new_n44_), .b(new_n66_), .c(x22), .d(x14), .O(new_n67_));
  inv1   g26(.a(new_n67_), .O(z10));
  nand3  g27(.a(new_n66_), .b(x22), .c(x17), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n44_), .O(z11));
  nand4  g29(.a(new_n44_), .b(new_n66_), .c(x23), .d(x14), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z12));
  nand3  g31(.a(new_n66_), .b(x23), .c(x17), .O(new_n73_));
