...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n68_, new_n69_, new_n70_, new_n71_, new_n74_, new_n76_, new_n78_,
  ...
  aoi21  g19(.a(new_n60_), .b(x00), .c(x08), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(new_n44_), .O(z02));
  ...
  nor2   g31(.a(new_n44_), .b(x08), .O(z06));
  nand3  g32(.a(new_n46_), .b(x24), .c(x18), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n46_), .b(new_n76_), .O(z08));
  nand3  g36(.a(new_n46_), .b(x24), .c(x11), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z09));
  inv1   g38(.a(x24), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x22), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n46_), .O(z10));
  nand4  g41(.a(new_n46_), .b(new_n80_), .c(x22), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  nand4  g43(.a(new_n46_), .b(new_n80_), .c(x23), .d(x14), .O(new_n85_));
  ...
  nand4  g52(.a(new_n93_), .b(new_n46_), .c(new_n92_), .d(new_n91_), .O(z15));
endmodule
