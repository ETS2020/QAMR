...
module FAU ( 
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n69_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n69_), .O(z11));
  nand2  g46(.a(new_n81_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n83_), .c(new_n69_), .O(z12));
  oai21  g48(.a(new_n88_), .b(new_n86_), .c(new_n69_), .O(z13));
