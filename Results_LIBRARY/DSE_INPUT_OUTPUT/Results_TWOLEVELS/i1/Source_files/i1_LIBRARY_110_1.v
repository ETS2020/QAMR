...
module FAU ( 
  ...
  nor3   g33(.a(new_n65_), .b(new_n74_), .c(new_n73_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n66_), .b(new_n76_), .O(z08));
  oai21  g36(.a(new_n74_), .b(new_n76_), .c(new_n66_), .O(z09));
  nand3  g37(.a(new_n74_), .b(x22), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n66_), .O(z10));
  nand4  g39(.a(new_n66_), .b(new_n74_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n74_), .b(x23), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n66_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n66_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor3   g47(.a(new_n65_), .b(x24), .c(new_n88_), .O(z14));
