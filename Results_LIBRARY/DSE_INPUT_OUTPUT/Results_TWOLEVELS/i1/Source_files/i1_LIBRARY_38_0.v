...
module FAU ( 
  ...
  nand2  g32(.a(new_n61_), .b(x19), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n72_), .O(z05));
  nand4  g35(.a(x08), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n77_));
  ...
  nand2  g41(.a(new_n82_), .b(new_n75_), .O(z06));
  inv1   g42(.a(x18), .O(new_n84_));
  inv1   g43(.a(x24), .O(new_n85_));
  nor3   g44(.a(new_n43_), .b(new_n85_), .c(new_n84_), .O(z07));
  ...
  nand4  g50(.a(new_n44_), .b(new_n85_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  inv1   g52(.a(x23), .O(new_n94_));
  nand2  g53(.a(new_n44_), .b(new_n85_), .O(new_n95_));
