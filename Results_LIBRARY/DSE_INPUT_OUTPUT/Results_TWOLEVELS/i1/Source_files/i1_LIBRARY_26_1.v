...
module FAU ( 
  ...
  nand2  g32(.a(new_n65_), .b(x24), .O(new_n74_));
  ...
  nand2  g39(.a(new_n65_), .b(new_n80_), .O(new_n81_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n65_), .O(z12));
  nand4  g47(.a(new_n65_), .b(new_n80_), .c(x23), .d(x17), .O(new_n89_));
