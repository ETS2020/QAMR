...
module FAU ( 
  ...
  aoi21  g43(.a(x19), .b(new_n84_), .c(new_n43_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n45_), .b(new_n86_), .O(z08));
  nand3  g46(.a(x24), .b(x19), .c(x11), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n43_), .b(x22), .O(new_n91_));
  ...
  nand3  g55(.a(new_n43_), .b(x23), .c(x17), .O(new_n97_));
