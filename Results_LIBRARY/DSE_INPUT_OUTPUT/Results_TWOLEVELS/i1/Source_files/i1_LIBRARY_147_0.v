...
module FAU ( 
  ...
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(new_n50_), .d(new_n49_), .O(new_n67_));
  ...
  nor2   g35(.a(x06), .b(x05), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(x19), .c(new_n76_), .d(new_n51_), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n60_), .c(new_n43_), .d(new_n75_), .O(z05));
  ...
  nand4  g46(.a(new_n71_), .b(new_n84_), .c(x22), .d(x17), .O(new_n88_));
