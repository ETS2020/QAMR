...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n87_, new_n88_, new_n90_, new_n92_, new_n94_,
  ...
  inv1   g41(.a(new_n74_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n82_), .O(z08));
  inv1   g43(.a(x24), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n82_), .c(new_n74_), .O(z09));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n85_), .b(x22), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n74_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n74_), .O(z11));
  nand3  g50(.a(new_n85_), .b(x23), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n74_), .O(z12));
  nand4  g52(.a(new_n74_), .b(new_n85_), .c(x23), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  oai21  g55(.a(x24), .b(new_n96_), .c(new_n74_), .O(z14));
  nor2   g56(.a(x13), .b(x12), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n83_), .O(z15));
  buf    g59(.a(x20), .O(z03));
  buf    g60(.a(x19), .O(z06));
endmodule
