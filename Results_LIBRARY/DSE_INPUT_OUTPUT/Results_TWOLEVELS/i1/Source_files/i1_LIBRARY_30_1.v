...
module FAU ( 
  ...
  nand2  g19(.a(new_n60_), .b(new_n54_), .O(z07));
  inv1   g20(.a(x11), .O(new_n62_));
  nand2  g21(.a(new_n54_), .b(new_n62_), .O(z08));
  inv1   g22(.a(x24), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n62_), .c(new_n54_), .O(z09));
  inv1   g24(.a(x14), .O(new_n66_));
  nand2  g25(.a(new_n64_), .b(x22), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n66_), .c(new_n54_), .O(z10));
  inv1   g27(.a(x17), .O(new_n69_));
  oai21  g28(.a(new_n67_), .b(new_n69_), .c(new_n54_), .O(z11));
  nand4  g29(.a(new_n54_), .b(new_n64_), .c(x23), .d(x14), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z12));
  nand3  g31(.a(new_n64_), .b(x23), .c(x17), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n54_), .O(z13));
  nand2  g33(.a(new_n64_), .b(x16), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n54_), .O(z14));
  nor2   g35(.a(x13), .b(x12), .O(new_n77_));
  nor2   g36(.a(x15), .b(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n51_), .O(z15));
endmodule
