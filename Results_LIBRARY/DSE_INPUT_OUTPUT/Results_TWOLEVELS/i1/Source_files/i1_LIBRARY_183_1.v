...
module FAU ( 
  ...
  nand4  g39(.a(new_n60_), .b(x19), .c(x12), .d(new_n80_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n79_), .c(new_n74_), .d(new_n78_), .O(z05));
  nor2   g41(.a(new_n43_), .b(x00), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(x00), .c(new_n45_), .O(z06));
  inv1   g43(.a(new_n74_), .O(new_n85_));
  nand2  g44(.a(x24), .b(x18), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(z07));
  ...
  nand4  g50(.a(new_n85_), .b(new_n90_), .c(x22), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z10));
  nand3  g52(.a(new_n90_), .b(x22), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n85_), .O(z11));
  nand4  g54(.a(new_n85_), .b(new_n90_), .c(x23), .d(x14), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z12));
  nand3  g56(.a(new_n90_), .b(x23), .c(x17), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n85_), .O(z13));
  nand2  g58(.a(new_n90_), .b(x16), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n85_), .O(z14));
  inv1   g60(.a(x13), .O(new_n102_));
  nor2   g61(.a(x15), .b(x14), .O(new_n103_));
  nand4  g62(.a(new_n103_), .b(new_n45_), .c(new_n102_), .d(new_n43_), .O(z15));
endmodule
