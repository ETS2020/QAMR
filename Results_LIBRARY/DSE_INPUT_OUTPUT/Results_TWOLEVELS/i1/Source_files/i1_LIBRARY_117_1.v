...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n72_, new_n75_,
  ...
  nor2   g24(.a(new_n65_), .b(new_n50_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n43_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n63_), .c(new_n58_), .O(z02));
  ...
  nand2  g33(.a(x09), .b(new_n43_), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(x04), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n78_));
  nor3   g37(.a(new_n62_), .b(new_n43_), .c(new_n42_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n58_), .O(z06));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nor2   g42(.a(new_n70_), .b(new_n83_), .O(z08));
  ...
  nor3   g57(.a(new_n70_), .b(x13), .c(x12), .O(new_n99_));
