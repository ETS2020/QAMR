...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n88_, new_n90_, new_n92_, new_n95_, new_n97_, new_n98_;
  ...
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(x15), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n60_), .c(new_n44_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  aoi21  g27(.a(x19), .b(x15), .c(new_n68_), .O(z03));
  ...
  nand3  g33(.a(new_n74_), .b(new_n49_), .c(new_n48_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n61_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(x15), .c(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n73_), .O(z05));
  nor2   g37(.a(x15), .b(x00), .O(new_n79_));
  ...
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n71_), .O(z10));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n71_), .O(z11));
  nand2  g50(.a(new_n85_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n87_), .c(new_n71_), .O(z12));
  oai21  g52(.a(new_n92_), .b(new_n90_), .c(new_n71_), .O(z13));
  nand3  g53(.a(new_n71_), .b(new_n85_), .c(x16), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z14));
  nor3   g55(.a(x14), .b(x13), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n44_), .b(x15), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(x15), .c(new_n98_), .O(z15));
endmodule
