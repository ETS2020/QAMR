...
module FAU ( 
  ...
  and2   g24(.a(new_n43_), .b(x20), .O(z03));
  ...
  nand3  g45(.a(new_n43_), .b(new_n80_), .c(x23), .O(new_n87_));
  ...
  nand3  g51(.a(new_n43_), .b(new_n80_), .c(x16), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z14));
  nor2   g53(.a(x13), .b(x12), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n67_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
