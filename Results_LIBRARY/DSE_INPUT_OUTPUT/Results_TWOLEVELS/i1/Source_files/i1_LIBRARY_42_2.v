...
module FAU ( 
  ...
  nand3  g29(.a(new_n58_), .b(x19), .c(new_n50_), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n57_), .O(new_n72_));
  nor2   g31(.a(new_n72_), .b(x10), .O(new_n73_));
  nand2  g32(.a(x19), .b(x10), .O(new_n74_));
  oai21  g33(.a(new_n73_), .b(x08), .c(new_n74_), .O(z05));
  ...
  oai21  g48(.a(new_n89_), .b(new_n83_), .c(new_n43_), .O(z12));
  oai21  g49(.a(new_n89_), .b(new_n87_), .c(new_n43_), .O(z13));
  nand2  g50(.a(new_n84_), .b(x16), .O(new_n92_));
