...
module FAU ( 
  ...
  nand2  g30(.a(new_n57_), .b(x10), .O(new_n72_));
  ...
  nand2  g34(.a(new_n45_), .b(x08), .O(z06));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n57_), .O(z07));
  ...
  nand4  g41(.a(new_n57_), .b(new_n81_), .c(x22), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z10));
  nand3  g43(.a(new_n81_), .b(x22), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n57_), .O(z11));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n81_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n57_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n57_), .O(z13));
