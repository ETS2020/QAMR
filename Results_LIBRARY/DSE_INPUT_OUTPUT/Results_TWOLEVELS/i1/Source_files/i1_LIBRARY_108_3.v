...
module FAU ( 
  ...
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n69_), .O(z12));
  ...
  nand4  g60(.a(new_n101_), .b(new_n69_), .c(new_n100_), .d(new_n99_), .O(z15));
endmodule
