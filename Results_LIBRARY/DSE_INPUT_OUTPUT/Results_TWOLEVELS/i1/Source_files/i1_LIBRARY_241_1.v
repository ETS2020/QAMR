...
module FAU ( 
  ...
  nand4  g20(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(new_n48_), .O(new_n62_));
  and2   g21(.a(new_n62_), .b(x00), .O(new_n63_));
  ...
  nand3  g26(.a(new_n67_), .b(x08), .c(new_n53_), .O(new_n68_));
  nor3   g27(.a(new_n68_), .b(x06), .c(x05), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n63_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n47_), .c(new_n45_), .O(z02));
  nor2   g30(.a(new_n43_), .b(new_n47_), .O(z03));
  nand2  g31(.a(x21), .b(new_n43_), .O(new_n73_));
  oai21  g32(.a(new_n43_), .b(new_n47_), .c(new_n73_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nor2   g34(.a(new_n47_), .b(x08), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n65_), .c(new_n44_), .d(new_n75_), .O(z05));
  nand3  g37(.a(new_n61_), .b(new_n51_), .c(new_n64_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n81_));
  nor2   g40(.a(new_n62_), .b(new_n42_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n47_), .O(z06));
  ...
  nor3   g47(.a(new_n44_), .b(new_n88_), .c(new_n86_), .O(z09));
  nand4  g48(.a(new_n45_), .b(new_n88_), .c(x22), .d(x14), .O(new_n90_));
  ...
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z12));
  nand4  g54(.a(new_n45_), .b(new_n88_), .c(x23), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  nand2  g56(.a(new_n88_), .b(x16), .O(new_n98_));
