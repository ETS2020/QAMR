...
module FAU ( 
  ...
  nand4  g37(.a(new_n63_), .b(new_n50_), .c(new_n61_), .d(new_n49_), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(x02), .c(x01), .O(new_n80_));
  nor3   g39(.a(new_n80_), .b(new_n64_), .c(new_n42_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n60_), .c(new_n45_), .O(z06));
  inv1   g41(.a(x18), .O(new_n83_));
  aoi21  g42(.a(x19), .b(new_n83_), .c(new_n43_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  aoi21  g44(.a(x24), .b(new_n60_), .c(new_n85_), .O(z08));
  aoi21  g45(.a(x19), .b(new_n85_), .c(new_n43_), .O(z09));
  ...
  nor2   g51(.a(new_n92_), .b(x24), .O(z12));
  nand3  g52(.a(new_n43_), .b(x23), .c(x17), .O(new_n94_));
