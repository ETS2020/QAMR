...
module FAU ( 
  ...
  nand4  g36(.a(new_n62_), .b(new_n49_), .c(new_n61_), .d(new_n48_), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(x02), .c(x01), .O(new_n79_));
  nand2  g38(.a(new_n64_), .b(x00), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(x19), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n44_), .O(z06));
  ...
  nand4  g63(.a(new_n104_), .b(x19), .c(new_n103_), .d(new_n102_), .O(z15));
endmodule
