...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x00), .c(new_n44_), .O(z01));
  ...
  nand4  g33(.a(x19), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n64_), .c(x19), .O(new_n76_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n44_), .O(z06));
  ...
  nand4  g61(.a(new_n102_), .b(new_n45_), .c(new_n101_), .d(new_n100_), .O(z15));
endmodule
