...
module FAU ( 
  ...
  nand4  g23(.a(new_n60_), .b(new_n43_), .c(new_n48_), .d(new_n47_), .O(new_n65_));
  ...
  nand4  g34(.a(new_n49_), .b(new_n60_), .c(new_n48_), .d(new_n47_), .O(new_n76_));
  ...
  nand3  g39(.a(new_n62_), .b(new_n49_), .c(new_n60_), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n43_), .c(new_n48_), .d(new_n47_), .O(new_n83_));
  nor2   g42(.a(new_n63_), .b(new_n42_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n59_), .O(z06));
  nand2  g44(.a(x24), .b(x18), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n45_), .O(z07));
  inv1   g46(.a(x11), .O(new_n88_));
  nand2  g47(.a(new_n45_), .b(new_n88_), .O(z08));
  inv1   g48(.a(x24), .O(new_n90_));
  nor3   g49(.a(new_n44_), .b(new_n90_), .c(new_n88_), .O(z09));
  inv1   g50(.a(x22), .O(new_n92_));
  ...
  nand3  g56(.a(new_n90_), .b(x23), .c(x14), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n45_), .O(z12));
  nand4  g58(.a(new_n45_), .b(new_n90_), .c(x23), .d(x17), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z13));
  nand2  g60(.a(new_n90_), .b(x16), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n45_), .O(z14));
