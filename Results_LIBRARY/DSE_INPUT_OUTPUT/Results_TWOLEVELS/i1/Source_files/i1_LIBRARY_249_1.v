...
module FAU ( 
  ...
  nor2   g31(.a(new_n45_), .b(x13), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z03));
  inv1   g33(.a(x21), .O(new_n75_));
  inv1   g34(.a(new_n73_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n75_), .c(new_n72_), .O(z04));
  ...
  oai22  g41(.a(new_n82_), .b(new_n79_), .c(new_n73_), .d(new_n78_), .O(z05));
  ...
  nand2  g49(.a(new_n90_), .b(new_n76_), .O(z10));
  nand4  g50(.a(new_n76_), .b(new_n88_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  inv1   g52(.a(x14), .O(new_n94_));
  nand2  g53(.a(new_n88_), .b(x23), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n94_), .c(new_n76_), .O(z12));
  inv1   g55(.a(x17), .O(new_n97_));
  oai21  g56(.a(new_n95_), .b(new_n97_), .c(new_n76_), .O(z13));
  nand2  g57(.a(new_n88_), .b(x16), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n76_), .O(z14));
  inv1   g59(.a(x12), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nand4  g61(.a(new_n102_), .b(new_n45_), .c(new_n43_), .d(new_n101_), .O(z15));
endmodule
