...
module FAU ( 
  ...
  oai21  g28(.a(new_n69_), .b(new_n43_), .c(new_n44_), .O(z02));
  ...
  nand3  g37(.a(new_n62_), .b(new_n50_), .c(new_n60_), .O(new_n79_));
  ...
  nor2   g46(.a(new_n45_), .b(new_n87_), .O(z08));
  ...
  nor3   g64(.a(new_n45_), .b(x13), .c(x12), .O(new_n106_));
