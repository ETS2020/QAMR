...
module FAU ( 
  ...
  nand3  g34(.a(new_n61_), .b(new_n74_), .c(x22), .O(new_n76_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n61_), .O(z12));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n61_), .O(z13));
  inv1   g45(.a(x16), .O(new_n87_));
  oai21  g46(.a(x24), .b(new_n87_), .c(new_n61_), .O(z14));
