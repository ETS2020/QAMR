...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n62_), .c(new_n42_), .O(z02));
  ...
  nand4  g34(.a(new_n75_), .b(new_n65_), .c(new_n64_), .d(new_n50_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n43_), .c(new_n74_), .O(z05));
  nand4  g36(.a(new_n60_), .b(new_n48_), .c(new_n59_), .d(new_n47_), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(x02), .c(x01), .O(new_n79_));
  nand2  g38(.a(new_n62_), .b(x00), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(x19), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n43_), .O(z06));
  ...
  nand2  g48(.a(new_n43_), .b(new_n87_), .O(new_n90_));
  ...
  aoi22  g64(.a(new_n105_), .b(new_n104_), .c(x21), .d(new_n42_), .O(z15));
endmodule
