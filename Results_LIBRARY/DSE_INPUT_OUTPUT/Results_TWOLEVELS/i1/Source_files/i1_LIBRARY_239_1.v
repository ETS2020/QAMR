...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n75_, new_n77_,
    new_n79_, new_n81_, new_n82_, new_n84_, new_n86_, new_n89_, new_n91_,
    new_n92_;
  ...
  nor2   g32(.a(new_n66_), .b(new_n43_), .O(z06));
  nand2  g33(.a(x24), .b(x18), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n68_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nand2  g36(.a(new_n68_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  nor3   g38(.a(new_n67_), .b(new_n79_), .c(new_n77_), .O(z09));
  ...
  oai21  g43(.a(new_n82_), .b(new_n84_), .c(new_n68_), .O(z11));
  nand2  g44(.a(new_n79_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n81_), .c(new_n68_), .O(z12));
  oai21  g46(.a(new_n86_), .b(new_n84_), .c(new_n68_), .O(z13));
