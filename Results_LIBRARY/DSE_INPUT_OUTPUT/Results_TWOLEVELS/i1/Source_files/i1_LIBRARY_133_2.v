...
module FAU ( 
  ...
  aoi21  g30(.a(new_n43_), .b(x14), .c(new_n71_), .O(z04));
  ...
  nand4  g35(.a(new_n59_), .b(new_n49_), .c(new_n62_), .d(new_n48_), .O(new_n77_));
  ...
  nand2  g47(.a(x19), .b(x14), .O(new_n89_));
  nor3   g48(.a(new_n89_), .b(x24), .c(new_n88_), .O(z10));
  inv1   g49(.a(x24), .O(new_n91_));
  nand4  g50(.a(new_n44_), .b(new_n91_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  inv1   g52(.a(x23), .O(new_n94_));
  nor3   g53(.a(new_n89_), .b(x24), .c(new_n94_), .O(z12));
  ...
  oai21  g59(.a(new_n100_), .b(x14), .c(new_n89_), .O(z15));
endmodule
