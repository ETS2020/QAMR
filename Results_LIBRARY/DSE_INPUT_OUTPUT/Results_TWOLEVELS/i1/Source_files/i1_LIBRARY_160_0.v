// Benchmark "FAU" written by ABC on Wed Aug 19 17:34:59 2020
...
module FAU ( 
  ...
  nand4  g34(.a(x19), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n65_), .c(new_n46_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(x08), .c(new_n75_), .O(z05));
  nand3  g38(.a(new_n60_), .b(new_n50_), .c(new_n63_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n82_));
  nor2   g41(.a(new_n61_), .b(new_n42_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n46_), .O(z06));
  ...
  nand2  g51(.a(new_n92_), .b(new_n44_), .O(z10));
  nand4  g52(.a(new_n44_), .b(new_n91_), .c(x22), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z11));
  nand4  g54(.a(new_n44_), .b(new_n91_), .c(x23), .d(x14), .O(new_n96_));
