...
module FAU ( 
  ...
  nand3  g15(.a(new_n56_), .b(x19), .c(x14), .O(new_n57_));
  ...
  aoi21  g33(.a(x19), .b(new_n43_), .c(new_n74_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand4  g35(.a(new_n66_), .b(new_n65_), .c(new_n67_), .d(new_n51_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x14), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  nand4  g39(.a(x08), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(x04), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n83_));
  nor2   g42(.a(new_n62_), .b(new_n42_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(new_n83_), .c(new_n77_), .d(x14), .O(new_n85_));
  and2   g44(.a(new_n85_), .b(x19), .O(z06));
  ...
  nor2   g52(.a(new_n93_), .b(x24), .O(z10));
  inv1   g53(.a(x24), .O(new_n95_));
  nand4  g54(.a(new_n44_), .b(new_n95_), .c(x22), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z11));
  nand2  g56(.a(x23), .b(x14), .O(new_n98_));
  nor2   g57(.a(new_n98_), .b(x24), .O(z12));
  ...
  nor3   g62(.a(x15), .b(x13), .c(x12), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(x19), .c(new_n43_), .O(z15));
endmodule
