...
module FAU ( 
  ...
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z07));
  ...
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n74_), .O(z10));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n74_), .O(z11));
  nand4  g47(.a(new_n74_), .b(new_n82_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand3  g49(.a(new_n82_), .b(x23), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n74_), .O(z13));
