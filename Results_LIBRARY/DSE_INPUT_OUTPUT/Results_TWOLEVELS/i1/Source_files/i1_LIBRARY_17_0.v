...
module FAU ( 
  ...
  nand3  g30(.a(new_n57_), .b(new_n71_), .c(new_n69_), .O(z04));
  aoi21  g31(.a(new_n61_), .b(x19), .c(x08), .O(new_n73_));
  or2    g32(.a(new_n73_), .b(x10), .O(z05));
  nand2  g33(.a(new_n45_), .b(x08), .O(z06));
  ...
  oai21  g39(.a(new_n77_), .b(new_n79_), .c(new_n57_), .O(z09));
  inv1   g40(.a(x22), .O(new_n82_));
  nor3   g41(.a(new_n43_), .b(x24), .c(new_n82_), .O(new_n83_));
  ...
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n57_), .O(z12));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n57_), .O(z13));
