...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(new_n47_), .c(new_n46_), .O(new_n58_));
  ...
  nand4  g23(.a(new_n64_), .b(new_n60_), .c(new_n57_), .d(new_n46_), .O(new_n65_));
  ...
  nand2  g31(.a(new_n71_), .b(x10), .O(new_n73_));
  ...
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n71_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n71_), .O(z11));
