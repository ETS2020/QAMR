...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n75_, new_n76_,
    new_n78_, new_n81_, new_n82_, new_n83_, new_n85_, new_n87_, new_n90_,
    new_n92_, new_n93_;
  ...
  nand2  g34(.a(new_n68_), .b(x24), .O(new_n76_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n68_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n68_), .O(z11));
  nand2  g45(.a(new_n82_), .b(x23), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n81_), .c(new_n68_), .O(z12));
  oai21  g47(.a(new_n87_), .b(new_n85_), .c(new_n68_), .O(z13));
  inv1   g48(.a(x16), .O(new_n90_));
  nor3   g49(.a(new_n67_), .b(x24), .c(new_n90_), .O(z14));
