...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n68_, new_n69_, new_n71_, new_n72_, new_n73_, new_n75_,
  ...
  and2   g25(.a(new_n43_), .b(x20), .O(z03));
  ...
  nor2   g36(.a(new_n68_), .b(new_n77_), .O(z08));
  inv1   g37(.a(x24), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n43_), .O(z09));
  nand4  g39(.a(new_n43_), .b(new_n79_), .c(x22), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  nand3  g41(.a(new_n79_), .b(x22), .c(x17), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n43_), .O(z11));
  nand4  g43(.a(new_n43_), .b(new_n79_), .c(x23), .d(x14), .O(new_n85_));
  ...
  nor3   g50(.a(new_n68_), .b(x13), .c(x12), .O(new_n92_));
