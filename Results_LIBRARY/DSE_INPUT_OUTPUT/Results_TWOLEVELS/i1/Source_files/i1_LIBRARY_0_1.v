...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n77_, new_n79_, new_n80_, new_n82_, new_n85_, new_n86_,
  ...
  nor2   g30(.a(new_n71_), .b(new_n69_), .O(z03));
  inv1   g31(.a(x21), .O(new_n73_));
  nand3  g32(.a(new_n70_), .b(new_n73_), .c(new_n69_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nand2  g34(.a(new_n70_), .b(new_n75_), .O(z05));
  ...
  nor3   g39(.a(new_n71_), .b(new_n80_), .c(new_n79_), .O(z07));
  ...
  nand2  g44(.a(new_n70_), .b(new_n80_), .O(new_n86_));
  ...
  nor2   g51(.a(new_n86_), .b(new_n92_), .O(new_n93_));
  ...
  nor2   g57(.a(new_n86_), .b(new_n98_), .O(z14));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  nor3   g59(.a(new_n71_), .b(x13), .c(x12), .O(new_n101_));
