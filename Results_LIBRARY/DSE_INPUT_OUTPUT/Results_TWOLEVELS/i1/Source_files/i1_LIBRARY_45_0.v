...
module FAU ( 
  ...
  nor2   g32(.a(x06), .b(x05), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(x19), .c(new_n73_), .d(new_n52_), .O(new_n75_));
  oai22  g34(.a(new_n75_), .b(new_n59_), .c(new_n43_), .d(new_n72_), .O(z05));
  oai21  g35(.a(x09), .b(new_n73_), .c(new_n46_), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n52_), .c(new_n50_), .d(new_n58_), .O(new_n78_));
  ...
  oai21  g41(.a(new_n66_), .b(new_n42_), .c(x19), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n82_), .O(z06));
  ...
  nand3  g49(.a(new_n86_), .b(x22), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(z10));
  nand4  g51(.a(new_n44_), .b(new_n86_), .c(x22), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z11));
  inv1   g53(.a(x14), .O(new_n95_));
  nand2  g54(.a(new_n86_), .b(x23), .O(new_n96_));
