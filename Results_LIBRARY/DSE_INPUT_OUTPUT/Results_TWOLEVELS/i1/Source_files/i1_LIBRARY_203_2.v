...
module FAU ( 
  ...
  nor2   g32(.a(x22), .b(new_n58_), .O(new_n74_));
  ...
  nand4  g38(.a(new_n61_), .b(x22), .c(x19), .d(new_n68_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(new_n74_), .d(new_n78_), .O(z05));
  inv1   g40(.a(x18), .O(new_n82_));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n74_), .b(new_n83_), .c(new_n82_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n74_), .b(new_n85_), .O(z08));
  inv1   g45(.a(new_n74_), .O(new_n87_));
  oai21  g46(.a(new_n83_), .b(new_n85_), .c(new_n87_), .O(z09));
  ...
  nand4  g51(.a(new_n87_), .b(new_n83_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n83_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n87_), .O(z13));
  nand2  g55(.a(new_n83_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n87_), .O(z14));
