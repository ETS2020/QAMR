...
module FAU ( 
  ...
  nand3  g30(.a(new_n43_), .b(new_n70_), .c(x19), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  nor2   g32(.a(new_n42_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n65_), .c(new_n64_), .d(new_n51_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n44_), .c(new_n73_), .O(z05));
  nand2  g35(.a(x21), .b(new_n42_), .O(z06));
  ...
  aoi22  g59(.a(new_n100_), .b(new_n99_), .c(new_n43_), .d(new_n42_), .O(z15));
endmodule
