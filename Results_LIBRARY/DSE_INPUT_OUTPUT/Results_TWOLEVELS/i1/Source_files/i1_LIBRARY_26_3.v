...
module FAU ( 
  ...
  nand3  g30(.a(new_n65_), .b(x24), .c(x18), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nand2  g33(.a(new_n65_), .b(new_n74_), .O(z08));
  nand3  g34(.a(new_n65_), .b(x24), .c(x11), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z09));
  nor2   g36(.a(new_n62_), .b(x24), .O(new_n78_));
  ...
  nand3  g42(.a(new_n83_), .b(x23), .c(x14), .O(new_n84_));
  ...
  nand4  g51(.a(new_n92_), .b(new_n65_), .c(new_n91_), .d(new_n90_), .O(z15));
endmodule
