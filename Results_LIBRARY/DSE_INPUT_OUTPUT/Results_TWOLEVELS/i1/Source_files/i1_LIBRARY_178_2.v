...
module FAU ( 
  ...
  nand3  g30(.a(new_n71_), .b(new_n45_), .c(x19), .O(new_n72_));
  ...
  oai22  g40(.a(new_n81_), .b(new_n79_), .c(new_n78_), .d(new_n43_), .O(z05));
  ...
  nor2   g44(.a(new_n63_), .b(new_n42_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(x10), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(x24), .c(x19), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z06));
  and2   g48(.a(x24), .b(x18), .O(z07));
  inv1   g49(.a(x11), .O(new_n91_));
  nor2   g50(.a(new_n44_), .b(new_n91_), .O(z08));
  oai21  g51(.a(new_n78_), .b(new_n91_), .c(new_n45_), .O(z09));
  nand2  g52(.a(x22), .b(x14), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n43_), .c(x24), .O(z10));
  nand4  g54(.a(new_n78_), .b(x22), .c(x17), .d(new_n43_), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z11));
  nand2  g56(.a(x23), .b(x14), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n43_), .c(x24), .O(z12));
  nand4  g58(.a(new_n78_), .b(x23), .c(x17), .d(new_n43_), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z13));
  inv1   g60(.a(x16), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n43_), .c(x24), .O(z14));
