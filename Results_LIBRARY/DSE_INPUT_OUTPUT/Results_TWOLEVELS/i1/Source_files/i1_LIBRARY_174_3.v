...
module FAU ( 
  ...
  nor2   g38(.a(new_n58_), .b(x07), .O(z06));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n70_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nor2   g42(.a(new_n69_), .b(new_n83_), .O(z08));
  inv1   g43(.a(x24), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n70_), .O(z09));
  nor2   g45(.a(new_n69_), .b(x24), .O(new_n87_));
  ...
  nand3  g52(.a(new_n85_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n70_), .O(z12));
  ...
  nand4  g61(.a(new_n102_), .b(new_n70_), .c(new_n101_), .d(new_n100_), .O(z15));
endmodule
