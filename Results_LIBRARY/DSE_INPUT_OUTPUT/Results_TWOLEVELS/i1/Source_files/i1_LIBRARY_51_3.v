...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(x12), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n61_), .c(new_n44_), .O(z02));
  nand2  g29(.a(x19), .b(x12), .O(new_n71_));
  and2   g30(.a(new_n71_), .b(x20), .O(z03));
  nor2   g31(.a(x21), .b(x20), .O(new_n73_));
  aoi21  g32(.a(x19), .b(x12), .c(new_n73_), .O(z04));
  nand2  g33(.a(new_n71_), .b(x10), .O(new_n75_));
  nand3  g34(.a(new_n62_), .b(new_n58_), .c(new_n47_), .O(new_n76_));
  inv1   g35(.a(x08), .O(new_n77_));
  nor2   g36(.a(new_n44_), .b(x12), .O(z06));
  nand3  g37(.a(new_n59_), .b(z06), .c(new_n77_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n76_), .c(new_n75_), .O(z05));
  ...
  oai21  g48(.a(new_n89_), .b(new_n87_), .c(new_n71_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n71_), .O(z11));
  nand4  g51(.a(new_n71_), .b(new_n88_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n88_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n71_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  oai21  g56(.a(x24), .b(new_n97_), .c(new_n71_), .O(z14));
