...
module FAU ( 
  ...
  nand4  g36(.a(new_n77_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n65_), .c(new_n44_), .d(new_n76_), .O(z05));
  nand3  g38(.a(new_n61_), .b(new_n51_), .c(new_n64_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n82_));
  nor2   g41(.a(new_n62_), .b(new_n42_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n47_), .O(z06));
  ...
  aoi21  g53(.a(new_n94_), .b(x19), .c(new_n43_), .O(z11));
