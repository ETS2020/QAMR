...
module FAU ( 
  ...
  nand3  g07(.a(x09), .b(x08), .c(x00), .O(new_n49_));
  oai21  g08(.a(x09), .b(x08), .c(new_n49_), .O(new_n50_));
  ...
  nand4  g14(.a(new_n55_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n56_));
  nor2   g15(.a(x06), .b(x05), .O(new_n57_));
  inv1   g16(.a(x09), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(x08), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(new_n57_), .c(new_n48_), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n56_), .O(new_n61_));
  aoi21  g20(.a(new_n61_), .b(x00), .c(new_n42_), .O(z02));
  inv1   g21(.a(x20), .O(new_n63_));
  nor2   g22(.a(new_n42_), .b(x00), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n63_), .O(z03));
  nor2   g24(.a(x21), .b(x20), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n64_), .O(z04));
  inv1   g26(.a(x10), .O(new_n68_));
  inv1   g27(.a(x08), .O(new_n69_));
  nand4  g28(.a(new_n57_), .b(x19), .c(new_n69_), .d(new_n48_), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n56_), .c(new_n68_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x00), .O(new_n72_));
  oai21  g31(.a(x19), .b(new_n68_), .c(new_n72_), .O(z05));
  nand2  g32(.a(new_n58_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(x04), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n45_), .c(new_n44_), .d(new_n43_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x19), .c(x00), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z06));
  inv1   g39(.a(new_n64_), .O(new_n81_));
