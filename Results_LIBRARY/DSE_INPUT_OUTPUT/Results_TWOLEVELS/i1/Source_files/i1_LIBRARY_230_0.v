...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n88_, new_n90_, new_n92_, new_n93_, new_n95_, new_n97_,
    new_n99_, new_n100_;
  ...
  nand3  g46(.a(new_n83_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z10));
  nand4  g48(.a(new_n44_), .b(new_n83_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n83_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n44_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n44_), .O(z13));
  nand2  g55(.a(new_n83_), .b(x16), .O(new_n97_));
