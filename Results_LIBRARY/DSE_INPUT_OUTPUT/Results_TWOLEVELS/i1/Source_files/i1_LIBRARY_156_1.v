...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n88_, new_n89_, new_n90_, new_n92_, new_n94_,
  ...
  nand3  g14(.a(new_n55_), .b(x19), .c(x16), .O(new_n56_));
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(x16), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  inv1   g29(.a(x19), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(x16), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n70_), .O(z03));
  nor2   g33(.a(x21), .b(x20), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n72_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n63_), .b(new_n64_), .c(new_n50_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n62_), .c(x16), .O(new_n79_));
  ...
  nor3   g47(.a(new_n72_), .b(x24), .c(new_n88_), .O(new_n89_));
  ...
  oai21  g56(.a(x24), .b(new_n43_), .c(new_n73_), .O(z14));
  nor2   g57(.a(x13), .b(x12), .O(new_n99_));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n72_), .O(z15));
  buf    g60(.a(x19), .O(z06));
endmodule
