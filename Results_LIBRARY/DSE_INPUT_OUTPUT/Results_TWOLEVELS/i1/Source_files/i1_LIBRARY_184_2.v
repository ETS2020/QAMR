...
module FAU ( 
  ...
  oai21  g32(.a(new_n71_), .b(x19), .c(new_n43_), .O(z04));
  ...
  nor2   g38(.a(new_n43_), .b(new_n45_), .O(z06));
  inv1   g39(.a(x18), .O(new_n81_));
  nand2  g40(.a(new_n72_), .b(x24), .O(new_n82_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n72_), .O(z10));
  nand4  g48(.a(new_n72_), .b(new_n87_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand3  g50(.a(new_n87_), .b(x23), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n72_), .O(z12));
  nand4  g52(.a(new_n72_), .b(new_n87_), .c(x23), .d(x17), .O(new_n94_));
  ...
  aoi22  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .d(x19), .O(z15));
endmodule
