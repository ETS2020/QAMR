...
module FAU ( 
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(new_n43_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n62_), .c(new_n58_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nor2   g29(.a(x22), .b(new_n58_), .O(new_n71_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n43_), .c(x19), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n75_), .O(z05));
  nor2   g37(.a(new_n43_), .b(new_n58_), .O(z06));
  inv1   g38(.a(x18), .O(new_n80_));
  nand2  g39(.a(new_n72_), .b(x24), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n72_), .b(new_n83_), .O(z08));
  ...
  nor3   g49(.a(new_n71_), .b(x24), .c(new_n90_), .O(new_n91_));
  ...
  oai21  g55(.a(x24), .b(new_n96_), .c(new_n72_), .O(z14));
