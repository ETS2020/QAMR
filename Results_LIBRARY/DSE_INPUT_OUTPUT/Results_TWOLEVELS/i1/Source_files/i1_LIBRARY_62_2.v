...
module FAU ( 
  ...
  nor3   g43(.a(new_n72_), .b(new_n84_), .c(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nor2   g45(.a(new_n72_), .b(new_n86_), .O(z08));
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n44_), .O(z09));
  inv1   g47(.a(x22), .O(new_n89_));
  nand2  g48(.a(new_n44_), .b(new_n84_), .O(new_n90_));
