...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n92_, new_n94_, new_n95_, new_n97_, new_n99_, new_n101_, new_n103_,
    new_n105_, new_n106_;
  ...
  nor2   g20(.a(x11), .b(new_n42_), .O(new_n62_));
  ...
  nand3  g25(.a(new_n66_), .b(new_n51_), .c(new_n65_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n64_), .c(x00), .O(new_n68_));
  nand4  g27(.a(new_n65_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n69_));
  nor2   g28(.a(x06), .b(x05), .O(new_n70_));
  nor2   g29(.a(x09), .b(new_n54_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(new_n70_), .c(new_n53_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n69_), .c(new_n68_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x19), .c(new_n43_), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z02));
  inv1   g34(.a(x20), .O(new_n76_));
  nand2  g35(.a(new_n46_), .b(new_n76_), .O(z03));
  or2    g36(.a(z03), .b(x21), .O(z04));
  inv1   g37(.a(x10), .O(new_n79_));
  nand4  g38(.a(new_n70_), .b(new_n43_), .c(new_n54_), .d(new_n53_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n69_), .c(new_n43_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x19), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n79_), .O(z05));
  nand3  g42(.a(new_n66_), .b(new_n51_), .c(new_n65_), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  nand4  g44(.a(new_n85_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(new_n68_), .c(x00), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x19), .c(new_n43_), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z06));
  nand2  g48(.a(x24), .b(x18), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n46_), .O(z07));
  inv1   g50(.a(x24), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n44_), .c(new_n43_), .O(z09));
  inv1   g52(.a(x14), .O(new_n94_));
  nand2  g53(.a(new_n92_), .b(x22), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n94_), .c(new_n46_), .O(z10));
  inv1   g55(.a(x17), .O(new_n97_));
  oai21  g56(.a(new_n95_), .b(new_n97_), .c(new_n46_), .O(z11));
  nand4  g57(.a(new_n46_), .b(new_n92_), .c(x23), .d(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n92_), .b(x23), .c(x17), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n46_), .O(z13));
  nand3  g61(.a(new_n46_), .b(new_n92_), .c(x16), .O(new_n103_));
