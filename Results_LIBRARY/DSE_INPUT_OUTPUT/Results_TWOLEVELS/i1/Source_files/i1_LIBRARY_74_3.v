...
module FAU ( 
  ...
  nor2   g37(.a(x08), .b(x00), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x00), .c(new_n52_), .O(z06));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n61_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n61_), .b(new_n83_), .O(z08));
  nand3  g43(.a(new_n61_), .b(x24), .c(x11), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z09));
  inv1   g45(.a(x24), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n61_), .O(z10));
  nand4  g48(.a(new_n61_), .b(new_n87_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  nand3  g50(.a(new_n61_), .b(new_n87_), .c(x23), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(new_n93_));
  ...
  oai21  g57(.a(x24), .b(new_n98_), .c(new_n61_), .O(z14));
  nor2   g58(.a(x13), .b(x12), .O(new_n100_));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n62_), .O(z15));
endmodule
