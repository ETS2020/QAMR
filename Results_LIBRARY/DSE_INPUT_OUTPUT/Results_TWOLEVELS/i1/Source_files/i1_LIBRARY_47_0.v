...
module FAU ( 
  ...
  oai21  g31(.a(new_n70_), .b(new_n45_), .c(new_n72_), .O(z04));
  ...
  nand2  g37(.a(x21), .b(new_n45_), .O(z06));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n57_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n57_), .b(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n57_), .O(z09));
  nand4  g44(.a(new_n57_), .b(new_n84_), .c(x22), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand3  g46(.a(new_n84_), .b(x22), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n57_), .O(z11));
  ...
  nand2  g54(.a(new_n84_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n57_), .O(z14));
