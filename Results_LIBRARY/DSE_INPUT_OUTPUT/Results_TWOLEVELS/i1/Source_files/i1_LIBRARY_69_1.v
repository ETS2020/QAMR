...
module FAU ( 
  ...
  nor2   g31(.a(new_n67_), .b(new_n72_), .O(z05));
  nand2  g32(.a(x24), .b(x18), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n68_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nand2  g35(.a(new_n68_), .b(new_n76_), .O(z08));
  ...
  nor3   g45(.a(new_n67_), .b(x24), .c(new_n86_), .O(new_n87_));
