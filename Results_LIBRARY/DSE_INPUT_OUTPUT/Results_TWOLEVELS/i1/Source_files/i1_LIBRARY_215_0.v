...
module FAU ( 
  ...
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(new_n51_), .d(new_n45_), .O(new_n67_));
  ...
  nand2  g38(.a(new_n71_), .b(x24), .O(new_n80_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n85_), .c(x22), .d(x17), .O(new_n88_));
