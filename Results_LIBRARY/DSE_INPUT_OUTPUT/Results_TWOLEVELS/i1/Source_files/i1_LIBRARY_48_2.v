...
module FAU ( 
  ...
  nor2   g27(.a(x19), .b(new_n47_), .O(new_n69_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n57_), .c(new_n46_), .d(new_n45_), .O(new_n75_));
  nand3  g34(.a(new_n58_), .b(x19), .c(new_n64_), .O(new_n76_));
  ...
  oai21  g38(.a(new_n43_), .b(x00), .c(x03), .O(new_n80_));
  nand4  g39(.a(new_n58_), .b(new_n48_), .c(new_n57_), .d(new_n47_), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(x02), .O(new_n82_));
  nor3   g41(.a(x04), .b(x02), .c(x01), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n58_), .c(new_n48_), .d(x00), .O(new_n84_));
  aoi21  g43(.a(new_n82_), .b(new_n45_), .c(new_n84_), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n43_), .c(new_n80_), .O(z06));
  inv1   g45(.a(x18), .O(new_n87_));
  inv1   g46(.a(x24), .O(new_n88_));
  nor3   g47(.a(new_n69_), .b(new_n88_), .c(new_n87_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nor2   g49(.a(new_n69_), .b(new_n90_), .O(z08));
  oai21  g50(.a(new_n88_), .b(new_n90_), .c(new_n72_), .O(z09));
  inv1   g51(.a(x22), .O(new_n93_));
  nor3   g52(.a(new_n69_), .b(x24), .c(new_n93_), .O(new_n94_));
  ...
  nor3   g58(.a(new_n69_), .b(x24), .c(new_n99_), .O(new_n100_));
  ...
  nand2  g63(.a(new_n88_), .b(x16), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n72_), .O(z14));
  nor2   g65(.a(x15), .b(x14), .O(new_n107_));
  nor3   g66(.a(new_n69_), .b(x13), .c(x12), .O(new_n108_));
