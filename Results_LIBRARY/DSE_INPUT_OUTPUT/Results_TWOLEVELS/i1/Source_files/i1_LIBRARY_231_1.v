...
module FAU ( 
  ...
  nand3  g11(.a(x12), .b(x09), .c(x08), .O(new_n53_));
  ...
  aoi21  g31(.a(new_n72_), .b(x12), .c(new_n43_), .O(z02));
  ...
  nand4  g39(.a(new_n63_), .b(x19), .c(x12), .d(new_n80_), .O(new_n81_));
  ...
  nand3  g46(.a(new_n87_), .b(x19), .c(x12), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z06));
  inv1   g48(.a(x18), .O(new_n90_));
  nand2  g49(.a(new_n45_), .b(x24), .O(new_n91_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z10));
  nand4  g57(.a(new_n45_), .b(new_n96_), .c(x22), .d(x17), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z11));
  nand4  g59(.a(new_n45_), .b(new_n96_), .c(x23), .d(x14), .O(new_n101_));
  ...
  nand4  g67(.a(new_n108_), .b(new_n43_), .c(new_n107_), .d(new_n58_), .O(z15));
endmodule
