...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n87_, new_n88_, new_n89_, new_n91_, new_n93_, new_n96_,
    new_n98_, new_n99_;
  ...
  nand3  g31(.a(x23), .b(new_n72_), .c(new_n71_), .O(z04));
  ...
  oai21  g48(.a(new_n89_), .b(new_n87_), .c(new_n44_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n44_), .O(z11));
  inv1   g51(.a(x23), .O(new_n93_));
  nor3   g52(.a(x24), .b(new_n93_), .c(new_n87_), .O(z12));
  nor3   g53(.a(x24), .b(new_n93_), .c(new_n91_), .O(z13));
  nand2  g54(.a(new_n88_), .b(x16), .O(new_n96_));
