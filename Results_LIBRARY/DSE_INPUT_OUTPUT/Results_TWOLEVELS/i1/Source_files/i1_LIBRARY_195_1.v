...
module FAU ( 
  ...
  nor2   g10(.a(new_n46_), .b(x02), .O(new_n52_));
  nor2   g11(.a(new_n52_), .b(new_n51_), .O(z03));
  inv1   g12(.a(x21), .O(new_n54_));
  nand3  g13(.a(new_n44_), .b(new_n54_), .c(new_n51_), .O(z04));
  ...
  oai21  g30(.a(new_n71_), .b(new_n70_), .c(new_n44_), .O(z12));
  inv1   g31(.a(x17), .O(new_n73_));
  oai21  g32(.a(new_n71_), .b(new_n73_), .c(new_n44_), .O(z13));
