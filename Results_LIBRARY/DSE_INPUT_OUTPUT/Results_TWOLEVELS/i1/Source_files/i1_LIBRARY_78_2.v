...
module FAU ( 
  ...
  nand2  g38(.a(new_n43_), .b(x24), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n78_), .O(z09));
  inv1   g40(.a(x22), .O(new_n82_));
  inv1   g41(.a(x24), .O(new_n83_));
  nand2  g42(.a(new_n43_), .b(new_n83_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  ...
  nor2   g49(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  ...
  nor2   g55(.a(new_n84_), .b(new_n96_), .O(z14));
