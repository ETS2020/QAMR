...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n48_, new_n49_, new_n51_, new_n53_,
    new_n56_, new_n57_, new_n59_, new_n62_, new_n63_, new_n65_, new_n67_,
  ...
  aoi22  g10(.a(new_n51_), .b(new_n48_), .c(x19), .d(new_n43_), .O(z04));
  ...
  oai21  g15(.a(new_n45_), .b(x06), .c(x24), .O(new_n57_));
  ...
  nand2  g22(.a(new_n63_), .b(new_n49_), .O(z10));
  nand4  g23(.a(new_n49_), .b(new_n62_), .c(x22), .d(x17), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z11));
  inv1   g25(.a(x14), .O(new_n67_));
  nand2  g26(.a(new_n62_), .b(x23), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n67_), .c(new_n49_), .O(z12));
  inv1   g28(.a(x17), .O(new_n70_));
  oai21  g29(.a(new_n68_), .b(new_n70_), .c(new_n49_), .O(z13));
  nand2  g30(.a(new_n62_), .b(x16), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n49_), .O(z14));
  inv1   g32(.a(x12), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nor2   g34(.a(x15), .b(x14), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n49_), .c(new_n75_), .d(new_n74_), .O(z15));
endmodule
