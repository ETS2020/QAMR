...
module FAU ( 
  ...
  nand4  g39(.a(new_n62_), .b(new_n43_), .c(x19), .d(new_n80_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(z05));
  inv1   g41(.a(x19), .O(new_n83_));
  nand2  g42(.a(new_n45_), .b(new_n83_), .O(z06));
  nand3  g43(.a(x24), .b(x18), .c(x10), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z07));
  inv1   g45(.a(x11), .O(new_n87_));
  aoi21  g46(.a(x24), .b(new_n78_), .c(new_n87_), .O(z08));
  aoi21  g47(.a(new_n87_), .b(x10), .c(new_n43_), .O(z09));
  nand3  g48(.a(new_n43_), .b(x22), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n45_), .O(z10));
  nand2  g50(.a(x22), .b(x17), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(x24), .O(z11));
  nand3  g52(.a(new_n43_), .b(x23), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z12));
  nand2  g54(.a(x23), .b(x17), .O(new_n96_));
  nor2   g55(.a(new_n96_), .b(x24), .O(z13));
  nand2  g56(.a(new_n43_), .b(x16), .O(new_n98_));
