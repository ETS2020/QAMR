...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x11), .c(new_n42_), .O(z00));
  ...
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x11), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n63_), .c(new_n58_), .O(z02));
  nand2  g31(.a(x19), .b(x11), .O(new_n73_));
  ...
  nand3  g57(.a(new_n73_), .b(new_n88_), .c(x16), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z14));
  nor2   g59(.a(x13), .b(x12), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n75_), .O(z15));
  buf    g62(.a(x19), .O(z06));
endmodule
