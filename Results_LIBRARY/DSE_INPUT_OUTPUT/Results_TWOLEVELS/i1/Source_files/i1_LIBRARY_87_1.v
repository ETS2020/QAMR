...
module FAU ( 
  ...
  nand3  g36(.a(new_n44_), .b(new_n77_), .c(new_n74_), .O(z04));
  nand2  g37(.a(new_n44_), .b(x10), .O(new_n79_));
  nand3  g38(.a(new_n64_), .b(new_n60_), .c(new_n49_), .O(new_n80_));
  ...
  oai21  g42(.a(new_n67_), .b(new_n81_), .c(new_n43_), .O(new_n84_));
  ...
  nor3   g46(.a(new_n62_), .b(new_n43_), .c(new_n42_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(z06));
