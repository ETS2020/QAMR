...
module FAU ( 
  ...
  nand2  g13(.a(new_n54_), .b(new_n53_), .O(z05));
  nor2   g14(.a(new_n45_), .b(new_n43_), .O(z06));
  nand2  g15(.a(x24), .b(x18), .O(new_n57_));
  nand2  g16(.a(new_n57_), .b(new_n54_), .O(z07));
  inv1   g17(.a(x11), .O(new_n59_));
  nor2   g18(.a(new_n49_), .b(new_n59_), .O(z08));
  oai21  g19(.a(new_n45_), .b(x01), .c(x24), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(new_n59_), .O(z09));
  inv1   g21(.a(x24), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x22), .c(x14), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n54_), .O(z10));
  nand4  g24(.a(new_n54_), .b(new_n63_), .c(x22), .d(x17), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z11));
  nand4  g26(.a(new_n54_), .b(new_n63_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  nand3  g28(.a(new_n63_), .b(x23), .c(x17), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n54_), .O(z13));
  nand2  g30(.a(new_n63_), .b(x16), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n54_), .O(z14));
  inv1   g32(.a(x12), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nor2   g34(.a(x15), .b(x14), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n54_), .c(new_n75_), .d(new_n74_), .O(z15));
endmodule
