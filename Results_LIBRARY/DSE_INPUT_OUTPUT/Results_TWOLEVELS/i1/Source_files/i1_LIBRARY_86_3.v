...
module FAU ( 
  ...
  nand2  g30(.a(x19), .b(x14), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n71_), .O(z03));
  inv1   g32(.a(x21), .O(new_n74_));
  aoi22  g33(.a(new_n74_), .b(new_n71_), .c(x19), .d(x14), .O(z04));
  ...
  nor2   g39(.a(x14), .b(x00), .O(new_n81_));
  ...
  nand2  g44(.a(new_n72_), .b(new_n85_), .O(z08));
  nand3  g45(.a(new_n72_), .b(x24), .c(x11), .O(new_n87_));
  ...
  nand2  g51(.a(new_n92_), .b(new_n72_), .O(z11));
  nand4  g52(.a(new_n89_), .b(x23), .c(new_n44_), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand4  g54(.a(new_n72_), .b(new_n89_), .c(x23), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  inv1   g56(.a(x16), .O(new_n98_));
  oai21  g57(.a(x24), .b(new_n98_), .c(new_n72_), .O(z14));
