...
module FAU ( 
  ...
  nand2  g25(.a(x19), .b(x06), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n66_), .O(z03));
  inv1   g27(.a(x21), .O(new_n69_));
  aoi22  g28(.a(new_n69_), .b(new_n66_), .c(x19), .d(x06), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  inv1   g30(.a(x08), .O(new_n72_));
  nand4  g31(.a(new_n72_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n57_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(x06), .c(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(z05));
  nor2   g35(.a(new_n44_), .b(x06), .O(z06));
  nand3  g36(.a(new_n67_), .b(x24), .c(x18), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nand2  g39(.a(new_n67_), .b(new_n80_), .O(z08));
  nand3  g40(.a(new_n67_), .b(x24), .c(x11), .O(new_n82_));
  ...
  nand4  g45(.a(new_n67_), .b(new_n84_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n84_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n67_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n67_), .O(z13));
  inv1   g52(.a(x16), .O(new_n94_));
  oai21  g53(.a(x24), .b(new_n94_), .c(new_n67_), .O(z14));
  inv1   g54(.a(x12), .O(new_n96_));
  inv1   g55(.a(x13), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nand4  g57(.a(new_n98_), .b(new_n67_), .c(new_n97_), .d(new_n96_), .O(z15));
endmodule
