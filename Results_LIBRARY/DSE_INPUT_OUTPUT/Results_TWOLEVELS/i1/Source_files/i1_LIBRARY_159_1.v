...
module FAU ( 
  ...
  nand4  g36(.a(new_n53_), .b(new_n77_), .c(new_n76_), .d(new_n50_), .O(new_n78_));
  ...
  nand3  g41(.a(new_n82_), .b(x19), .c(x08), .O(new_n83_));
  ...
  nand4  g56(.a(new_n44_), .b(new_n91_), .c(x23), .d(x17), .O(new_n98_));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n71_), .O(z15));
endmodule
