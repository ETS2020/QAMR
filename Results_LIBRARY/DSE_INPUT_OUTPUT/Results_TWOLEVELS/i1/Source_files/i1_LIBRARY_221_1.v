...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n68_, new_n70_, new_n73_, new_n75_, new_n77_, new_n79_,
  ...
  nand2  g32(.a(new_n73_), .b(new_n66_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n65_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n66_), .O(z09));
  nand3  g37(.a(new_n77_), .b(x22), .c(x14), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n66_), .O(z10));
  nand4  g39(.a(new_n66_), .b(new_n77_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand4  g41(.a(new_n66_), .b(new_n77_), .c(x23), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand3  g43(.a(new_n77_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n66_), .O(z13));
  nand2  g45(.a(new_n77_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n66_), .O(z14));
  nor2   g47(.a(x15), .b(x14), .O(new_n89_));
  nor3   g48(.a(new_n65_), .b(x13), .c(x12), .O(new_n90_));
