...
module FAU ( 
  ...
  nand3  g39(.a(new_n64_), .b(x24), .c(x18), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n64_), .b(new_n83_), .O(z08));
  nand3  g43(.a(new_n64_), .b(x24), .c(x11), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z09));
  inv1   g45(.a(x24), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n64_), .O(z10));
  ...
  nand2  g52(.a(new_n93_), .b(new_n64_), .O(z12));
