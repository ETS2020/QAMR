...
module FAU ( 
  ...
  nand2  g35(.a(new_n45_), .b(x13), .O(z06));
  ...
  nand4  g42(.a(new_n71_), .b(new_n79_), .c(x22), .d(x14), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z10));
  nand3  g44(.a(new_n79_), .b(x22), .c(x17), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n71_), .O(z11));
  nand4  g46(.a(new_n71_), .b(new_n79_), .c(x23), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z12));
  nand3  g48(.a(new_n79_), .b(x23), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n71_), .O(z13));
  nand2  g50(.a(new_n79_), .b(x16), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n71_), .O(z14));
  inv1   g52(.a(x13), .O(new_n94_));
  nor3   g53(.a(x15), .b(x14), .c(x12), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n45_), .c(new_n94_), .O(z15));
endmodule
