...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n84_, new_n85_, new_n86_, new_n89_, new_n91_, new_n93_,
  ...
  nand3  g29(.a(new_n70_), .b(x19), .c(x18), .O(new_n71_));
  ...
  nand4  g36(.a(new_n66_), .b(x18), .c(new_n67_), .d(new_n52_), .O(new_n78_));
  ...
  nand3  g40(.a(new_n62_), .b(new_n50_), .c(new_n61_), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n64_), .c(x00), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x19), .c(x18), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z06));
  and2   g46(.a(x24), .b(x18), .O(z07));
  ...
  nand4  g57(.a(new_n45_), .b(new_n91_), .c(x23), .d(x14), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z12));
  nand3  g59(.a(new_n91_), .b(x23), .c(x17), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n45_), .O(z13));
  nand2  g61(.a(new_n91_), .b(x16), .O(new_n103_));
