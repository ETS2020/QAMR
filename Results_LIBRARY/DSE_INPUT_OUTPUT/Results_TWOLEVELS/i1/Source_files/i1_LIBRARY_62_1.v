...
module FAU ( 
  ...
  nand4  g19(.a(new_n60_), .b(x19), .c(x09), .d(x00), .O(new_n61_));
  ...
  nand4  g34(.a(new_n59_), .b(new_n75_), .c(new_n49_), .d(new_n48_), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(x02), .O(new_n77_));
  nand4  g36(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(x00), .O(new_n78_));
  aoi21  g37(.a(new_n77_), .b(new_n46_), .c(new_n78_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x09), .c(new_n74_), .O(z06));
  inv1   g39(.a(x18), .O(new_n81_));
  inv1   g40(.a(x24), .O(new_n82_));
  nor3   g41(.a(new_n65_), .b(new_n82_), .c(new_n81_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nor2   g43(.a(new_n65_), .b(new_n84_), .O(z08));
