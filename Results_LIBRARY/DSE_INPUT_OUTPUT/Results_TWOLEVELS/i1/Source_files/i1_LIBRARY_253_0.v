...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n91_, new_n92_, new_n94_, new_n97_, new_n98_, new_n100_, new_n102_,
    new_n103_, new_n104_, new_n106_, new_n108_, new_n110_, new_n111_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x22), .b(x20), .O(new_n43_));
  ...
  nand2  g32(.a(x22), .b(new_n73_), .O(z03));
  nand2  g33(.a(x22), .b(x21), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n73_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(x19), .b(new_n67_), .c(new_n51_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n66_), .c(new_n65_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n77_), .c(new_n43_), .O(z05));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n63_), .c(new_n43_), .O(new_n86_));
  nand4  g45(.a(new_n66_), .b(x09), .c(x08), .d(new_n51_), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n64_), .c(x00), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(x19), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z06));
  inv1   g49(.a(x18), .O(new_n91_));
  nand2  g50(.a(new_n45_), .b(x24), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(new_n91_), .O(z07));
  inv1   g52(.a(x11), .O(new_n94_));
  nor2   g53(.a(new_n43_), .b(new_n94_), .O(z08));
  nor2   g54(.a(new_n92_), .b(new_n94_), .O(z09));
  inv1   g55(.a(x24), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(x22), .c(x14), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n45_), .O(z10));
  nand2  g58(.a(x22), .b(x17), .O(new_n100_));
  nor2   g59(.a(new_n100_), .b(x24), .O(z11));
  inv1   g60(.a(x23), .O(new_n102_));
  nor3   g61(.a(new_n43_), .b(x24), .c(new_n102_), .O(new_n103_));
  ...
  nand2  g67(.a(new_n108_), .b(new_n45_), .O(z14));
  nor2   g68(.a(x13), .b(x12), .O(new_n110_));
  nor2   g69(.a(x15), .b(x14), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n43_), .O(z15));
endmodule
