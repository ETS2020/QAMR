...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n87_, new_n89_, new_n90_, new_n91_, new_n93_, new_n95_,
  ...
  nand4  g37(.a(new_n61_), .b(new_n50_), .c(new_n63_), .d(new_n49_), .O(new_n79_));
  ...
  oai21  g41(.a(new_n82_), .b(new_n46_), .c(new_n58_), .O(z06));
  nand2  g42(.a(x24), .b(x18), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n58_), .O(z07));
  nor2   g44(.a(new_n46_), .b(new_n43_), .O(z08));
  ...
  oai21  g50(.a(new_n91_), .b(new_n89_), .c(new_n58_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n58_), .O(z11));
