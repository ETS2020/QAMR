...
module FAU ( 
  ...
  and2   g01(.a(x20), .b(x19), .O(new_n43_));
  ...
  nand2  g31(.a(x21), .b(new_n46_), .O(new_n73_));
  oai21  g32(.a(new_n46_), .b(x19), .c(new_n73_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nand4  g34(.a(new_n66_), .b(new_n46_), .c(new_n67_), .d(new_n52_), .O(new_n76_));
  ...
  nand3  g38(.a(new_n62_), .b(new_n50_), .c(new_n61_), .O(new_n80_));
  ...
  nand3  g42(.a(new_n83_), .b(new_n46_), .c(x19), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z06));
  nand3  g44(.a(new_n44_), .b(x24), .c(x18), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z07));
  inv1   g46(.a(x11), .O(new_n88_));
  nor2   g47(.a(new_n43_), .b(new_n88_), .O(z08));
  nand3  g48(.a(new_n44_), .b(x24), .c(x11), .O(new_n90_));
  ...
  nand2  g56(.a(new_n95_), .b(x23), .O(new_n98_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n43_), .O(z15));
  buf    g67(.a(x20), .O(z03));
endmodule
