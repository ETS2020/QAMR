...
module FAU ( 
  ...
  nand3  g27(.a(new_n68_), .b(new_n66_), .c(new_n62_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(new_n64_), .c(new_n43_), .O(new_n70_));
  and2   g29(.a(new_n70_), .b(x19), .O(z02));
  ...
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n46_), .O(z10));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n46_), .O(z11));
  nand2  g55(.a(new_n90_), .b(x23), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n92_), .c(new_n46_), .O(z12));
  oai21  g57(.a(new_n97_), .b(new_n95_), .c(new_n46_), .O(z13));
  nand3  g58(.a(new_n46_), .b(new_n90_), .c(x16), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z14));
  inv1   g60(.a(x12), .O(new_n102_));
  inv1   g61(.a(x13), .O(new_n103_));
  nor2   g62(.a(x15), .b(x14), .O(new_n104_));
  nand4  g63(.a(new_n104_), .b(new_n46_), .c(new_n103_), .d(new_n102_), .O(z15));
endmodule
