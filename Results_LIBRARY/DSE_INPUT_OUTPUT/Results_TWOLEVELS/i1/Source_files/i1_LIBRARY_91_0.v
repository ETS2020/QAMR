...
module FAU ( 
  ...
  nor2   g36(.a(x08), .b(x07), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n68_), .c(new_n67_), .d(new_n47_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x19), .c(x01), .O(new_n80_));
  or2    g39(.a(new_n80_), .b(x10), .O(z05));
  nand3  g40(.a(new_n61_), .b(new_n69_), .c(x08), .O(new_n82_));
  ...
  oai21  g46(.a(new_n64_), .b(new_n42_), .c(x19), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z06));
