...
module FAU ( 
  ...
  nand4  g34(.a(new_n75_), .b(new_n63_), .c(new_n62_), .d(new_n50_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n72_), .c(new_n74_), .O(z05));
  oai21  g36(.a(new_n43_), .b(x00), .c(x05), .O(new_n78_));
  nand4  g37(.a(new_n58_), .b(new_n48_), .c(new_n56_), .d(new_n47_), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x02), .O(new_n80_));
  nand4  g39(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(x00), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n45_), .c(new_n81_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n43_), .c(new_n78_), .O(z06));
  nand2  g42(.a(x24), .b(x18), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n72_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n72_), .b(new_n86_), .O(z08));
  inv1   g46(.a(x24), .O(new_n88_));
  nor3   g47(.a(new_n69_), .b(new_n88_), .c(new_n86_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n88_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n72_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n72_), .O(z11));
  nand4  g53(.a(new_n72_), .b(new_n88_), .c(x23), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z12));
  nand3  g55(.a(new_n88_), .b(x23), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n72_), .O(z13));
  inv1   g57(.a(x16), .O(new_n99_));
  nor3   g58(.a(new_n69_), .b(x24), .c(new_n99_), .O(z14));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  nor3   g60(.a(new_n69_), .b(x13), .c(x12), .O(new_n102_));
