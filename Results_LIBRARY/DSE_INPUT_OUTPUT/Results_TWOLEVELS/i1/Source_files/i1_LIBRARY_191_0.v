...
module FAU ( 
  ...
  nand2  g43(.a(new_n84_), .b(new_n57_), .O(z10));
  nand4  g44(.a(new_n57_), .b(new_n79_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  nand3  g46(.a(new_n79_), .b(x23), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n57_), .O(z12));
  nand4  g48(.a(new_n57_), .b(new_n79_), .c(x23), .d(x17), .O(new_n90_));
