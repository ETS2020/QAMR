...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n50_, new_n51_,
    ...
    new_n66_, new_n67_, new_n68_, new_n70_, new_n72_, new_n74_, new_n76_,
  ...
  nor2   g14(.a(new_n45_), .b(x01), .O(new_n56_));
  ...
  oai21  g22(.a(new_n45_), .b(x01), .c(x24), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n62_), .O(z09));
  inv1   g24(.a(x14), .O(new_n66_));
  inv1   g25(.a(x24), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x22), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n66_), .c(new_n51_), .O(z10));
  inv1   g28(.a(x17), .O(new_n70_));
  oai21  g29(.a(new_n68_), .b(new_n70_), .c(new_n51_), .O(z11));
  nand3  g30(.a(new_n67_), .b(x23), .c(x14), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n51_), .O(z12));
  nand4  g32(.a(new_n51_), .b(new_n67_), .c(x23), .d(x17), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(z13));
  nand2  g34(.a(new_n67_), .b(x16), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n51_), .O(z14));
