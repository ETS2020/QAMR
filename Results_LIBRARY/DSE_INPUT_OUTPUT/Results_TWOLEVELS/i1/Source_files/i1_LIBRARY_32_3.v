...
module FAU ( 
  ...
  inv1   g23(.a(new_n62_), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(new_n64_), .c(new_n61_), .O(z04));
  ...
  nand3  g29(.a(new_n65_), .b(x24), .c(x18), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n62_), .b(new_n73_), .O(z08));
  inv1   g33(.a(x24), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n73_), .c(new_n65_), .O(z09));
  nand3  g35(.a(new_n75_), .b(x22), .c(x14), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n65_), .O(z10));
  nor2   g37(.a(new_n62_), .b(x24), .O(new_n79_));
