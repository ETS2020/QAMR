...
module FAU ( 
  ...
  nand2  g39(.a(x11), .b(new_n69_), .O(new_n81_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n45_), .O(z06));
  nand2  g47(.a(x24), .b(x18), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z07));
  nor2   g49(.a(new_n43_), .b(new_n69_), .O(z08));
  inv1   g50(.a(x24), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(x08), .c(new_n43_), .O(z09));
  ...
  nand2  g63(.a(new_n92_), .b(x16), .O(new_n105_));
