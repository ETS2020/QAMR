...
module FAU ( 
  ...
  nand2  g36(.a(new_n60_), .b(x01), .O(z06));
  ...
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n72_), .O(z10));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n72_), .O(z11));
  nand3  g48(.a(new_n83_), .b(x23), .c(x14), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n72_), .O(z12));
  nand4  g50(.a(new_n72_), .b(new_n83_), .c(x23), .d(x17), .O(new_n92_));
