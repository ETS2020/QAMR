// Benchmark "FAU" written by ABC on Wed Aug 19 17:34:06 2020
...
module FAU ( 
  ...
  oai21  g12(.a(new_n53_), .b(new_n50_), .c(x00), .O(new_n54_));
  nand3  g13(.a(new_n54_), .b(x19), .c(x08), .O(new_n55_));
  inv1   g14(.a(new_n55_), .O(z01));
  nor2   g15(.a(x03), .b(x02), .O(new_n57_));
  nor2   g16(.a(x05), .b(x04), .O(new_n58_));
  nor2   g17(.a(x07), .b(x06), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(new_n46_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x00), .O(new_n61_));
  inv1   g20(.a(new_n50_), .O(new_n62_));
  nor2   g21(.a(x09), .b(x07), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(new_n52_), .c(new_n62_), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(x19), .c(x08), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nand2  g27(.a(new_n44_), .b(new_n68_), .O(z03));
  or2    g28(.a(z03), .b(x21), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nand2  g30(.a(new_n44_), .b(new_n71_), .O(z05));
  inv1   g31(.a(x19), .O(new_n73_));
  inv1   g32(.a(x05), .O(new_n74_));
  nand4  g33(.a(new_n59_), .b(new_n74_), .c(new_n49_), .d(new_n48_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(x02), .O(new_n76_));
  nor3   g35(.a(x03), .b(x02), .c(x01), .O(new_n77_));
  nand4  g36(.a(new_n59_), .b(new_n58_), .c(new_n77_), .d(x00), .O(new_n78_));
  aoi21  g37(.a(new_n76_), .b(new_n46_), .c(new_n78_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x08), .c(new_n73_), .O(z06));
  inv1   g39(.a(x18), .O(new_n81_));
  inv1   g40(.a(x24), .O(new_n82_));
  inv1   g41(.a(new_n44_), .O(new_n83_));
  nor3   g42(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n83_), .b(new_n85_), .O(z08));
  oai21  g45(.a(new_n82_), .b(new_n85_), .c(new_n44_), .O(z09));
  nand3  g46(.a(new_n82_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z10));
  nand4  g48(.a(new_n44_), .b(new_n82_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x23), .O(new_n92_));
  nand2  g51(.a(new_n44_), .b(new_n82_), .O(new_n93_));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(z15));
endmodule
