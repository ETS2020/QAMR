...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n86_, new_n89_, new_n91_, new_n92_, new_n93_,
  ...
  nand2  g32(.a(x19), .b(x16), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n73_), .O(z03));
  inv1   g35(.a(x21), .O(new_n77_));
  nand3  g36(.a(new_n74_), .b(new_n77_), .c(new_n73_), .O(z04));
  nand2  g37(.a(new_n74_), .b(x10), .O(new_n79_));
  nand3  g38(.a(new_n63_), .b(new_n59_), .c(new_n47_), .O(new_n80_));
  inv1   g39(.a(x08), .O(new_n81_));
  nand4  g40(.a(new_n60_), .b(x19), .c(new_n57_), .d(new_n81_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n80_), .c(new_n79_), .O(z05));
  nor2   g42(.a(x16), .b(x00), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(x00), .c(new_n44_), .O(z06));
  nand3  g44(.a(new_n74_), .b(x24), .c(x18), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z07));
  and2   g46(.a(new_n74_), .b(x11), .O(z08));
  nand3  g47(.a(new_n74_), .b(x24), .c(x11), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z09));
  inv1   g49(.a(x14), .O(new_n91_));
  inv1   g50(.a(x24), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x22), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n91_), .c(new_n74_), .O(z10));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n74_), .O(z11));
  nand3  g55(.a(new_n74_), .b(new_n92_), .c(x23), .O(new_n97_));
  ...
  nand3  g61(.a(new_n92_), .b(new_n44_), .c(x16), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z14));
  nor2   g63(.a(x13), .b(x12), .O(new_n105_));
  nor2   g64(.a(x15), .b(x14), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n75_), .O(z15));
endmodule
