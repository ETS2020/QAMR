...
module FAU ( 
  ...
  nor2   g35(.a(new_n46_), .b(x08), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n60_), .c(new_n76_), .d(new_n52_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n73_), .c(new_n75_), .O(z05));
  ...
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n73_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n73_), .O(z13));
