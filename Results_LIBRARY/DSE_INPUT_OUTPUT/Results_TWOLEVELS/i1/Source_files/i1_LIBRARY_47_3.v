...
module FAU ( 
  ...
  nand2  g27(.a(new_n51_), .b(new_n50_), .O(new_n69_));
  nor4   g28(.a(new_n69_), .b(x09), .c(new_n68_), .d(x07), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n67_), .c(x21), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n65_), .c(new_n60_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nand2  g32(.a(new_n43_), .b(new_n73_), .O(z03));
  nand2  g33(.a(new_n46_), .b(x20), .O(new_n75_));
  oai21  g34(.a(new_n46_), .b(x19), .c(new_n75_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nor4   g36(.a(new_n69_), .b(new_n66_), .c(x08), .d(x07), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(x21), .c(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n77_), .O(z05));
  nand3  g39(.a(x21), .b(x09), .c(x08), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(x04), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n84_));
  nor3   g43(.a(new_n64_), .b(x21), .c(new_n42_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n60_), .O(z06));
  ...
  nand4  g51(.a(new_n43_), .b(new_n91_), .c(x22), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z10));
  nand3  g53(.a(new_n91_), .b(x22), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n43_), .O(z11));
  nand3  g55(.a(new_n43_), .b(new_n91_), .c(x23), .O(new_n97_));
