// Benchmark "FAU" written by ABC on Wed Aug 19 17:34:32 2020
...
module FAU ( 
  ...
  nand3  g14(.a(new_n55_), .b(x19), .c(x18), .O(new_n56_));
  ...
  nor2   g32(.a(new_n58_), .b(x18), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n73_), .O(z03));
  nor2   g34(.a(x21), .b(x20), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n74_), .O(z04));
  inv1   g36(.a(x10), .O(new_n78_));
  nand3  g37(.a(new_n64_), .b(new_n60_), .c(new_n47_), .O(new_n79_));
  nand4  g38(.a(new_n61_), .b(x19), .c(x18), .d(new_n68_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(new_n74_), .d(new_n78_), .O(z05));
  inv1   g40(.a(x24), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n43_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nor2   g43(.a(new_n74_), .b(new_n84_), .O(z08));
  inv1   g44(.a(new_n74_), .O(new_n86_));
  oai21  g45(.a(new_n82_), .b(new_n84_), .c(new_n86_), .O(z09));
  nand3  g46(.a(new_n82_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n86_), .O(z10));
  nand4  g48(.a(new_n86_), .b(new_n82_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n82_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n86_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n86_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  nor3   g56(.a(new_n74_), .b(x24), .c(new_n97_), .O(z14));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nor3   g58(.a(new_n74_), .b(x13), .c(x12), .O(new_n100_));
