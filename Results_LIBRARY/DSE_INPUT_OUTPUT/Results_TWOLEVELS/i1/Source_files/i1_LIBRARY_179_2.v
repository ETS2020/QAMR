...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n76_, new_n77_, new_n78_, new_n79_, new_n81_,
  ...
  nand3  g30(.a(new_n71_), .b(x20), .c(x19), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z02));
  inv1   g32(.a(x21), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(x19), .c(new_n57_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand3  g35(.a(new_n67_), .b(new_n68_), .c(new_n52_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(x20), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  inv1   g39(.a(x09), .O(new_n81_));
  nand3  g40(.a(new_n57_), .b(new_n81_), .c(x08), .O(new_n82_));
  ...
  nor3   g44(.a(new_n63_), .b(new_n57_), .c(new_n42_), .O(new_n86_));
  ...
  nand3  g52(.a(new_n92_), .b(x22), .c(x14), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z10));
  nand4  g54(.a(new_n45_), .b(new_n92_), .c(x22), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z11));
  inv1   g56(.a(x23), .O(new_n98_));
  nand2  g57(.a(new_n45_), .b(new_n92_), .O(new_n99_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n44_), .O(z15));
  buf    g68(.a(x20), .O(z03));
endmodule
