...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(new_n66_), .c(new_n43_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n62_), .c(new_n45_), .O(z02));
  inv1   g30(.a(x20), .O(new_n72_));
  nor2   g31(.a(new_n45_), .b(x16), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n72_), .O(z03));
  ...
  oai22  g40(.a(new_n81_), .b(new_n78_), .c(new_n73_), .d(new_n77_), .O(z05));
  inv1   g41(.a(x18), .O(new_n83_));
  nand2  g42(.a(new_n74_), .b(x24), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nor2   g45(.a(new_n73_), .b(new_n86_), .O(z08));
  nor2   g46(.a(new_n84_), .b(new_n86_), .O(z09));
  inv1   g47(.a(x22), .O(new_n89_));
  nor3   g48(.a(new_n73_), .b(x24), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n95_), .b(x23), .c(x14), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n74_), .O(z12));
  nand4  g56(.a(new_n74_), .b(new_n95_), .c(x23), .d(x17), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z13));
  oai21  g58(.a(x24), .b(new_n43_), .c(new_n74_), .O(z14));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  nor3   g60(.a(new_n73_), .b(x13), .c(x12), .O(new_n102_));
