...
module FAU ( 
  ...
  nand2  g25(.a(x19), .b(x05), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n66_), .O(z03));
  inv1   g27(.a(x21), .O(new_n69_));
  aoi22  g28(.a(new_n69_), .b(new_n66_), .c(x19), .d(x05), .O(z04));
  ...
  oai21  g33(.a(new_n74_), .b(x05), .c(x19), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n71_), .O(z05));
  nor2   g35(.a(x05), .b(x00), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(x00), .c(new_n44_), .O(z06));
  ...
  nand3  g41(.a(new_n67_), .b(x24), .c(x11), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  inv1   g44(.a(x24), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n67_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n67_), .O(z11));
  nand2  g49(.a(new_n86_), .b(x23), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n85_), .c(new_n67_), .O(z12));
  oai21  g51(.a(new_n91_), .b(new_n89_), .c(new_n67_), .O(z13));
  nand3  g52(.a(new_n67_), .b(new_n86_), .c(x16), .O(new_n94_));
