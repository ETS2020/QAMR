...
module FAU ( 
  ...
  nor2   g27(.a(x19), .b(x00), .O(new_n69_));
  ...
  nand2  g49(.a(new_n72_), .b(new_n90_), .O(new_n91_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n72_), .O(z12));
  nand4  g57(.a(new_n72_), .b(new_n90_), .c(x23), .d(x17), .O(new_n99_));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n69_), .O(z15));
endmodule
