...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n74_, new_n76_, new_n77_, new_n79_, new_n80_, new_n82_, new_n85_,
  ...
  nand4  g35(.a(new_n67_), .b(x19), .c(new_n68_), .d(new_n52_), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n65_), .c(new_n44_), .d(new_n76_), .O(z05));
  inv1   g37(.a(x18), .O(new_n79_));
  nand2  g38(.a(new_n46_), .b(x24), .O(new_n80_));
  ...
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n46_), .O(z10));
  ...
  nand4  g51(.a(new_n46_), .b(new_n86_), .c(x23), .d(x17), .O(new_n93_));
  ...
  nand4  g57(.a(new_n98_), .b(new_n85_), .c(new_n97_), .d(new_n43_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
