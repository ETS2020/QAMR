...
module FAU ( 
  ...
  nor2   g32(.a(new_n69_), .b(new_n73_), .O(z05));
  nor2   g33(.a(new_n45_), .b(new_n43_), .O(z06));
  inv1   g34(.a(new_n69_), .O(new_n76_));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n76_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  nor3   g40(.a(new_n69_), .b(new_n81_), .c(new_n79_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  nor3   g42(.a(new_n69_), .b(x24), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n76_), .O(z14));
