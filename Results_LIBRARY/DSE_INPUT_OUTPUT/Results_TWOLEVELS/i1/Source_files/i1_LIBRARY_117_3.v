...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n43_), .c(new_n44_), .O(z02));
  ...
  nand2  g36(.a(new_n77_), .b(new_n46_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nor2   g38(.a(new_n45_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n46_), .O(z09));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n81_), .b(x22), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n46_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n46_), .O(z11));
  nand4  g46(.a(new_n46_), .b(new_n81_), .c(x23), .d(x14), .O(new_n88_));
  ...
  nand4  g55(.a(new_n96_), .b(new_n46_), .c(new_n95_), .d(new_n94_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
