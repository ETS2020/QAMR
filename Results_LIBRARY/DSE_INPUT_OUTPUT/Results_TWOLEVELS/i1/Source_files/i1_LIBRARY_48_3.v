...
module FAU ( 
  ...
  nand2  g27(.a(x19), .b(x03), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n68_), .O(z03));
  inv1   g30(.a(x21), .O(new_n72_));
  nand3  g31(.a(new_n69_), .b(new_n72_), .c(new_n68_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  inv1   g33(.a(x08), .O(new_n75_));
  nand3  g34(.a(new_n59_), .b(x19), .c(new_n75_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n62_), .c(new_n74_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n44_), .O(new_n78_));
  oai21  g37(.a(x19), .b(new_n74_), .c(new_n78_), .O(z05));
  nand3  g38(.a(new_n69_), .b(x24), .c(x18), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n70_), .b(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n69_), .O(z09));
  nand3  g44(.a(new_n69_), .b(new_n84_), .c(x22), .O(new_n86_));
  ...
  nand3  g50(.a(new_n69_), .b(new_n84_), .c(x23), .O(new_n92_));
  ...
  oai21  g57(.a(x24), .b(new_n98_), .c(new_n69_), .O(z14));
  inv1   g58(.a(x12), .O(new_n100_));
  inv1   g59(.a(x13), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nand4  g61(.a(new_n102_), .b(new_n69_), .c(new_n101_), .d(new_n100_), .O(z15));
  buf    g62(.a(x19), .O(z06));
endmodule
