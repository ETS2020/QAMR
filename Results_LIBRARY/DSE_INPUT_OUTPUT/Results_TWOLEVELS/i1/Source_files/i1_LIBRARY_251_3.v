...
module FAU ( 
  ...
  nand2  g26(.a(x19), .b(x07), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n67_), .O(z03));
  inv1   g29(.a(x21), .O(new_n71_));
  nand3  g30(.a(new_n68_), .b(new_n71_), .c(new_n67_), .O(z04));
  inv1   g31(.a(x08), .O(new_n73_));
  nand3  g32(.a(new_n58_), .b(x19), .c(new_n73_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n61_), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(x10), .O(new_n76_));
  nand2  g35(.a(new_n44_), .b(x10), .O(new_n77_));
  oai21  g36(.a(new_n76_), .b(x07), .c(new_n77_), .O(z05));
  nor2   g37(.a(new_n44_), .b(x07), .O(z06));
  nand2  g38(.a(x24), .b(x18), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n68_), .O(z07));
  and2   g40(.a(new_n68_), .b(x11), .O(z08));
  nand3  g41(.a(new_n68_), .b(x24), .c(x11), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  inv1   g43(.a(x14), .O(new_n85_));
  inv1   g44(.a(x24), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x22), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n68_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n68_), .O(z11));
  nand3  g49(.a(new_n86_), .b(x23), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n68_), .O(z12));
  nand4  g51(.a(new_n68_), .b(new_n86_), .c(x23), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z13));
  inv1   g53(.a(x16), .O(new_n95_));
  oai21  g54(.a(x24), .b(new_n95_), .c(new_n68_), .O(z14));
  nor2   g55(.a(x13), .b(x12), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(z15));
endmodule
