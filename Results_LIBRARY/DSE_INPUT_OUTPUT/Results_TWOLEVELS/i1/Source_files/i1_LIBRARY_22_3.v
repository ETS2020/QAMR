...
module FAU ( 
  ...
  and2   g19(.a(new_n60_), .b(x20), .O(z03));
  ...
  nand3  g26(.a(new_n60_), .b(x24), .c(x18), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z07));
  inv1   g28(.a(x11), .O(new_n70_));
  nand2  g29(.a(new_n60_), .b(new_n70_), .O(z08));
  nand3  g30(.a(new_n60_), .b(x24), .c(x11), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(z09));
  inv1   g32(.a(x24), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(x22), .c(x14), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n60_), .O(z10));
  nand4  g35(.a(new_n60_), .b(new_n74_), .c(x22), .d(x17), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z11));
  inv1   g37(.a(x14), .O(new_n79_));
  nand2  g38(.a(new_n74_), .b(x23), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n60_), .O(z12));
  inv1   g40(.a(x17), .O(new_n82_));
  oai21  g41(.a(new_n80_), .b(new_n82_), .c(new_n60_), .O(z13));
  nand3  g42(.a(new_n60_), .b(new_n74_), .c(x16), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z14));
  inv1   g44(.a(x12), .O(new_n86_));
  inv1   g45(.a(x13), .O(new_n87_));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  nand4  g47(.a(new_n88_), .b(new_n60_), .c(new_n87_), .d(new_n86_), .O(z15));
  buf    g48(.a(x19), .O(z06));
endmodule
