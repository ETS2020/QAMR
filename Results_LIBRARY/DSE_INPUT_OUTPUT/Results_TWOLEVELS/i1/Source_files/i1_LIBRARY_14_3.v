...
module FAU ( 
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(new_n44_), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  inv1   g29(.a(x19), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n44_), .O(new_n72_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n62_), .c(new_n44_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  nor2   g39(.a(new_n71_), .b(x15), .O(z06));
  inv1   g40(.a(new_n72_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x24), .c(x18), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nand2  g44(.a(new_n82_), .b(new_n85_), .O(z08));
  inv1   g45(.a(x24), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(z09));
  nand3  g47(.a(new_n87_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n82_), .O(z10));
  nand4  g49(.a(new_n82_), .b(new_n87_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  inv1   g51(.a(x14), .O(new_n93_));
  nand2  g52(.a(new_n87_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n82_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n82_), .O(z13));
  nand2  g56(.a(new_n87_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n82_), .O(z14));
  nor3   g58(.a(x14), .b(x13), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n71_), .b(x15), .O(new_n101_));
