...
module FAU ( 
  ...
  nand3  g33(.a(new_n67_), .b(x19), .c(new_n53_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n66_), .c(x10), .O(new_n77_));
  nand2  g36(.a(x19), .b(x10), .O(new_n78_));
  oai21  g37(.a(new_n77_), .b(x08), .c(new_n78_), .O(z05));
  nand4  g38(.a(new_n61_), .b(new_n51_), .c(new_n64_), .d(new_n50_), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(x02), .O(new_n81_));
  nand4  g40(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(x00), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n48_), .c(new_n82_), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n47_), .c(new_n45_), .O(z06));
  ...
  nor3   g56(.a(new_n44_), .b(x24), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g62(.a(x24), .b(new_n103_), .c(new_n45_), .O(z14));
