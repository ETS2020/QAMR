...
module FAU ( 
  ...
  nor2   g25(.a(x09), .b(new_n43_), .O(new_n67_));
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(new_n65_), .d(new_n53_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n63_), .c(new_n47_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nand2  g29(.a(new_n45_), .b(new_n70_), .O(z03));
  or2    g30(.a(z03), .b(x21), .O(z04));
  nand3  g31(.a(new_n66_), .b(x19), .c(new_n53_), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n65_), .c(x10), .O(new_n75_));
  nand2  g34(.a(x19), .b(x10), .O(new_n76_));
  oai21  g35(.a(new_n75_), .b(x08), .c(new_n76_), .O(z05));
  nand3  g36(.a(new_n61_), .b(new_n51_), .c(new_n59_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n80_));
  nor2   g39(.a(new_n62_), .b(new_n42_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n47_), .O(z06));
  ...
  nand2  g48(.a(new_n45_), .b(new_n87_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n87_), .b(x23), .c(x14), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n45_), .O(z12));
  nand4  g56(.a(new_n45_), .b(new_n87_), .c(x23), .d(x17), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z13));
  inv1   g58(.a(x16), .O(new_n100_));
  nor2   g59(.a(new_n90_), .b(new_n100_), .O(z14));
