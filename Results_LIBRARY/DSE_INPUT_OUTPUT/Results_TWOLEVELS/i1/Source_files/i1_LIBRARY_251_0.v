...
module FAU ( 
  ...
  nand3  g21(.a(new_n62_), .b(new_n61_), .c(x08), .O(new_n63_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(new_n50_), .d(new_n49_), .O(new_n68_));
  ...
  nand4  g36(.a(new_n62_), .b(x19), .c(new_n77_), .d(new_n45_), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n60_), .c(new_n43_), .d(new_n76_), .O(z05));
  ...
  nand2  g50(.a(new_n91_), .b(new_n74_), .O(z12));
  nand4  g51(.a(new_n74_), .b(new_n84_), .c(x23), .d(x17), .O(new_n93_));
