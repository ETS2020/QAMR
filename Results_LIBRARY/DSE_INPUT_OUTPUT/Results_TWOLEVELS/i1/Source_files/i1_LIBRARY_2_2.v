...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n84_, new_n85_, new_n87_, new_n90_, new_n92_, new_n94_,
  ...
  nand2  g24(.a(new_n52_), .b(new_n51_), .O(new_n66_));
  ...
  nand2  g29(.a(new_n70_), .b(new_n45_), .O(z02));
  ...
  nor2   g37(.a(new_n47_), .b(x08), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n53_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n45_), .c(new_n76_), .O(z05));
  nand3  g40(.a(new_n61_), .b(new_n51_), .c(new_n64_), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n84_));
  nor2   g43(.a(new_n62_), .b(new_n42_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n47_), .O(z06));
  nand2  g45(.a(x24), .b(x18), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n45_), .O(z07));
  nor2   g47(.a(new_n47_), .b(new_n43_), .O(z08));
  inv1   g48(.a(x24), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(x19), .c(new_n43_), .O(z09));
  nand3  g50(.a(new_n90_), .b(x22), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n45_), .O(z10));
  nor2   g52(.a(new_n44_), .b(x24), .O(new_n94_));
  ...
  nand3  g57(.a(new_n90_), .b(x23), .c(x17), .O(new_n99_));
