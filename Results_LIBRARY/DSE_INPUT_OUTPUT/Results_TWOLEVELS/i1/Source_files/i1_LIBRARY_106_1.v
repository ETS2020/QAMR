...
module FAU ( 
  ...
  nand2  g29(.a(new_n70_), .b(new_n65_), .O(z07));
  inv1   g30(.a(x11), .O(new_n72_));
  inv1   g31(.a(new_n65_), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n72_), .O(z08));
  inv1   g33(.a(x24), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n72_), .c(new_n65_), .O(z09));
  nand4  g35(.a(new_n65_), .b(new_n75_), .c(x22), .d(x14), .O(new_n77_));
  ...
  nand2  g40(.a(new_n65_), .b(new_n75_), .O(new_n82_));
