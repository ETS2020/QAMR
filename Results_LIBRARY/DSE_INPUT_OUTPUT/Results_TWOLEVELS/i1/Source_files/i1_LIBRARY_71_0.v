...
module FAU ( 
  ...
  nand4  g23(.a(new_n64_), .b(new_n63_), .c(new_n50_), .d(new_n49_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x00), .O(new_n66_));
  nand4  g25(.a(new_n49_), .b(new_n46_), .c(new_n48_), .d(new_n47_), .O(new_n67_));
  ...
  nand3  g38(.a(new_n64_), .b(new_n50_), .c(new_n49_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n46_), .c(new_n48_), .d(new_n47_), .O(new_n82_));
  ...
  nand3  g55(.a(new_n89_), .b(x23), .c(x14), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(z12));
  nand4  g57(.a(new_n44_), .b(new_n89_), .c(x23), .d(x17), .O(new_n99_));
