...
module FAU ( 
  ...
  aoi21  g06(.a(x04), .b(new_n42_), .c(new_n46_), .O(z02));
  inv1   g07(.a(x20), .O(new_n49_));
  nand2  g08(.a(new_n44_), .b(new_n49_), .O(z03));
  nor2   g09(.a(new_n46_), .b(x04), .O(new_n51_));
  ...
  oai21  g15(.a(new_n46_), .b(x04), .c(x24), .O(new_n57_));
  ...
  nand3  g23(.a(new_n62_), .b(x22), .c(x17), .O(new_n65_));
