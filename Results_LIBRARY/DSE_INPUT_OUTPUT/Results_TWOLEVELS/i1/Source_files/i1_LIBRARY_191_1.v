...
module FAU ( 
  ...
  nand3  g36(.a(new_n73_), .b(x22), .c(x14), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n68_), .O(z10));
  nand4  g38(.a(new_n68_), .b(new_n73_), .c(x22), .d(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z11));
  nand3  g40(.a(new_n73_), .b(x23), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n68_), .O(z12));
  nand4  g42(.a(new_n68_), .b(new_n73_), .c(x23), .d(x17), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z13));
  nand2  g44(.a(new_n73_), .b(x16), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n68_), .O(z14));
  nor2   g46(.a(x15), .b(x14), .O(new_n88_));
  nor3   g47(.a(new_n65_), .b(x13), .c(x12), .O(new_n89_));
