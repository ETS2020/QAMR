...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n85_, new_n87_, new_n89_, new_n91_, new_n92_, new_n93_,
  ...
  nor2   g31(.a(x23), .b(new_n45_), .O(new_n73_));
  ...
  nand4  g38(.a(new_n60_), .b(x23), .c(x19), .d(new_n79_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n78_), .c(new_n73_), .d(new_n77_), .O(z05));
  nor2   g40(.a(new_n43_), .b(x00), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(x00), .c(new_n45_), .O(z06));
  inv1   g42(.a(new_n73_), .O(new_n84_));
  nand2  g43(.a(x24), .b(x18), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z07));
  inv1   g45(.a(x11), .O(new_n87_));
  nand2  g46(.a(new_n84_), .b(new_n87_), .O(z08));
  inv1   g47(.a(x24), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(z09));
  inv1   g49(.a(x22), .O(new_n91_));
  nor3   g50(.a(new_n73_), .b(x24), .c(new_n91_), .O(new_n92_));
  ...
  nand2  g55(.a(x23), .b(x14), .O(new_n97_));
  nor2   g56(.a(new_n97_), .b(x24), .O(z12));
  nand3  g57(.a(new_n89_), .b(x23), .c(x17), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n84_), .O(z13));
  nand2  g59(.a(new_n89_), .b(x16), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n84_), .O(z14));
  nor2   g61(.a(x13), .b(x12), .O(new_n103_));
  nor2   g62(.a(x15), .b(x14), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n73_), .O(z15));
endmodule
