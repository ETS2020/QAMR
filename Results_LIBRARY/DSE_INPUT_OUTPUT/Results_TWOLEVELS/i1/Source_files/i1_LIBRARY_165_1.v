...
module FAU ( 
  ...
  nand2  g36(.a(new_n77_), .b(new_n72_), .O(z07));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n72_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n72_), .O(z11));
  nand4  g46(.a(new_n72_), .b(new_n81_), .c(x23), .d(x14), .O(new_n88_));
  ...
  nor3   g51(.a(new_n69_), .b(x24), .c(new_n92_), .O(z14));
