...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n93_, new_n94_, new_n96_, new_n98_,
    new_n99_;
  ...
  nor2   g22(.a(new_n63_), .b(x05), .O(new_n64_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n57_), .c(new_n67_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n72_), .O(z05));
  nor2   g36(.a(new_n44_), .b(x05), .O(z06));
  inv1   g37(.a(new_n68_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x24), .c(x18), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n68_), .b(new_n82_), .O(z08));
  nand3  g42(.a(new_n79_), .b(x24), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  nor2   g44(.a(new_n68_), .b(x24), .O(new_n86_));
  ...
  nand3  g52(.a(new_n93_), .b(x23), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n79_), .O(z13));
