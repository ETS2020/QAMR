...
module FAU ( 
  ...
  nand4  g36(.a(new_n66_), .b(new_n73_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand3  g38(.a(new_n73_), .b(x22), .c(x17), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n66_), .O(z11));
  nand4  g40(.a(new_n66_), .b(new_n73_), .c(x23), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z12));
  nand4  g42(.a(new_n66_), .b(new_n73_), .c(x23), .d(x17), .O(new_n84_));
