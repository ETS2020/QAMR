...
module FAU ( 
  ...
  aoi21  g38(.a(new_n79_), .b(x00), .c(new_n60_), .O(z06));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n62_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n62_), .b(new_n83_), .O(z08));
  nand3  g43(.a(new_n62_), .b(x24), .c(x11), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z09));
  inv1   g45(.a(x24), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n62_), .O(z10));
  nor2   g48(.a(new_n61_), .b(x24), .O(new_n90_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n62_), .O(z13));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n61_), .O(z15));
endmodule
