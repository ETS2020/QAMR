...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n77_, new_n78_, new_n79_, new_n82_, new_n83_,
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(x12), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  inv1   g29(.a(x19), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(x12), .O(new_n72_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n62_), .c(x12), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n76_), .O(z05));
  nor2   g39(.a(new_n71_), .b(new_n43_), .O(z06));
  inv1   g40(.a(x18), .O(new_n82_));
  nand2  g41(.a(new_n73_), .b(x24), .O(new_n83_));
  ...
  nor3   g53(.a(new_n72_), .b(x24), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n73_), .O(z14));
  nor3   g60(.a(x15), .b(x14), .c(x13), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(x19), .c(new_n43_), .O(z15));
endmodule
