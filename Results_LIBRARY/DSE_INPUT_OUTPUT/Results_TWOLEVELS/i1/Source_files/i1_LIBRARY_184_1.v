...
module FAU ( 
  ...
  aoi21  g02(.a(x21), .b(new_n43_), .c(new_n42_), .O(z00));
  nand2  g03(.a(x21), .b(new_n43_), .O(new_n45_));
  ...
  nand3  g37(.a(new_n61_), .b(new_n49_), .c(new_n59_), .O(new_n79_));
  ...
  nand4  g55(.a(new_n45_), .b(new_n90_), .c(x23), .d(x17), .O(new_n97_));
  ...
  aoi22  g61(.a(new_n102_), .b(new_n101_), .c(x21), .d(new_n43_), .O(z15));
endmodule
