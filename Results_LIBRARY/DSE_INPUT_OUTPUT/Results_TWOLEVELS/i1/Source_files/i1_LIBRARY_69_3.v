...
module FAU ( 
  ...
  nand2  g36(.a(new_n77_), .b(new_n65_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n65_), .b(new_n79_), .O(z08));
  nand3  g39(.a(new_n65_), .b(x24), .c(x11), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z09));
  inv1   g41(.a(x24), .O(new_n83_));
  nand3  g42(.a(new_n65_), .b(new_n83_), .c(x22), .O(new_n84_));
  ...
  nand3  g48(.a(new_n65_), .b(new_n83_), .c(x23), .O(new_n90_));
  ...
  oai21  g55(.a(x24), .b(new_n96_), .c(new_n65_), .O(z14));
  nor2   g56(.a(x13), .b(x12), .O(new_n98_));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n67_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
