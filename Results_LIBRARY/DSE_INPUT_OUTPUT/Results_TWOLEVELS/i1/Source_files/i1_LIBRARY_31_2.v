...
module FAU ( 
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(new_n61_), .O(new_n68_));
  ...
  nand3  g36(.a(new_n59_), .b(new_n49_), .c(new_n62_), .O(new_n78_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(z15));
endmodule
