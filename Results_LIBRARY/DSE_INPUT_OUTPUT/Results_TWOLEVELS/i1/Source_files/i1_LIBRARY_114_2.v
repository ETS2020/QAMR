...
module FAU ( 
  ...
  nand4  g36(.a(new_n77_), .b(new_n68_), .c(new_n67_), .d(new_n52_), .O(new_n78_));
  ...
  aoi21  g46(.a(new_n87_), .b(x19), .c(new_n43_), .O(z09));
  ...
  nand4  g52(.a(new_n45_), .b(new_n87_), .c(x23), .d(x14), .O(new_n94_));
