...
module FAU ( 
  ...
  oai21  g14(.a(new_n43_), .b(x00), .c(x03), .O(new_n56_));
  nor3   g15(.a(x04), .b(x02), .c(x01), .O(new_n57_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n60_), .c(new_n46_), .d(new_n45_), .O(new_n75_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n72_), .O(z07));
  inv1   g46(.a(x11), .O(new_n88_));
  nand2  g47(.a(new_n72_), .b(new_n88_), .O(z08));
  inv1   g48(.a(x24), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n88_), .c(new_n72_), .O(z09));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n90_), .b(x22), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n72_), .O(z10));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n72_), .O(z11));
  inv1   g55(.a(x23), .O(new_n97_));
  nor3   g56(.a(new_n69_), .b(x24), .c(new_n97_), .O(new_n98_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n72_), .O(z14));
