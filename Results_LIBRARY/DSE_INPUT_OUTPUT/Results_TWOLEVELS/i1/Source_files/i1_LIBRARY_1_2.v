...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n92_, new_n95_, new_n96_, new_n98_, new_n100_, new_n101_,
  ...
  nand3  g11(.a(x21), .b(x09), .c(x08), .O(new_n53_));
  ...
  aoi21  g31(.a(new_n72_), .b(x21), .c(new_n43_), .O(z02));
  inv1   g32(.a(x20), .O(new_n74_));
  nand2  g33(.a(new_n45_), .b(new_n74_), .O(z03));
  nand3  g34(.a(new_n58_), .b(new_n74_), .c(new_n43_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n66_), .b(new_n62_), .c(new_n49_), .O(new_n78_));
  inv1   g37(.a(x08), .O(new_n79_));
  nand4  g38(.a(new_n63_), .b(x21), .c(x19), .d(new_n79_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n78_), .c(new_n44_), .d(new_n77_), .O(z05));
  nand3  g40(.a(new_n63_), .b(new_n50_), .c(new_n65_), .O(new_n82_));
  ...
  nand3  g45(.a(new_n86_), .b(x21), .c(x19), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z06));
  inv1   g47(.a(x18), .O(new_n89_));
  nand2  g48(.a(new_n45_), .b(x24), .O(new_n90_));
  ...
  nand2  g55(.a(new_n96_), .b(new_n45_), .O(z10));
  nand4  g56(.a(new_n45_), .b(new_n95_), .c(x22), .d(x17), .O(new_n98_));
