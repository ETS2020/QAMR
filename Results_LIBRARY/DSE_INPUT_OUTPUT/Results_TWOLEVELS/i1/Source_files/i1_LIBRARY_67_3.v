...
module FAU ( 
  ...
  nand3  g31(.a(new_n72_), .b(new_n44_), .c(x19), .O(new_n73_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n44_), .c(new_n43_), .O(new_n80_));
  ...
  nand4  g44(.a(new_n85_), .b(new_n84_), .c(new_n79_), .d(new_n44_), .O(new_n86_));
  ...
  nand4  g52(.a(new_n92_), .b(x22), .c(new_n43_), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z10));
  nand2  g54(.a(new_n92_), .b(x17), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n43_), .c(new_n44_), .O(z11));
  nand4  g56(.a(new_n46_), .b(new_n92_), .c(x23), .d(x14), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z12));
  nand3  g58(.a(new_n92_), .b(x23), .c(x17), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n46_), .O(z13));
