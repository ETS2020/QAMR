...
module FAU ( 
  ...
  nor2   g13(.a(x03), .b(new_n42_), .O(new_n55_));
  ...
  nand2  g29(.a(x19), .b(x03), .O(new_n71_));
  ...
  oai21  g36(.a(new_n76_), .b(x03), .c(new_n77_), .O(z05));
  nor2   g37(.a(x03), .b(x00), .O(new_n79_));
  ...
  nand3  g45(.a(new_n71_), .b(new_n86_), .c(x22), .O(new_n87_));
  ...
  nand3  g51(.a(new_n71_), .b(new_n86_), .c(x23), .O(new_n93_));
  ...
  oai21  g58(.a(x24), .b(new_n99_), .c(new_n71_), .O(z14));
  nor2   g59(.a(x13), .b(x12), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n101_), .c(x19), .d(x03), .O(z15));
endmodule
