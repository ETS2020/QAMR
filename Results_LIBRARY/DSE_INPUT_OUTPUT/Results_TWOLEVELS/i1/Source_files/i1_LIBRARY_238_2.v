...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(x21), .c(x19), .O(new_n58_));
  ...
  nand3  g35(.a(new_n65_), .b(new_n75_), .c(new_n43_), .O(z04));
  inv1   g36(.a(x10), .O(new_n78_));
  nand3  g37(.a(new_n66_), .b(new_n61_), .c(new_n49_), .O(new_n79_));
  nand4  g38(.a(new_n62_), .b(x21), .c(x19), .d(new_n70_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .d(new_n78_), .O(z05));
  oai21  g40(.a(x09), .b(new_n70_), .c(new_n65_), .O(new_n82_));
  ...
  nor3   g44(.a(new_n63_), .b(new_n65_), .c(new_n42_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(z06));
  ...
  oai21  g55(.a(new_n96_), .b(new_n94_), .c(new_n45_), .O(z10));
  inv1   g56(.a(x17), .O(new_n98_));
  oai21  g57(.a(new_n96_), .b(new_n98_), .c(new_n45_), .O(z11));
  nand3  g58(.a(new_n95_), .b(x23), .c(x14), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n45_), .O(z12));
  nand4  g60(.a(new_n45_), .b(new_n95_), .c(x23), .d(x17), .O(new_n102_));
