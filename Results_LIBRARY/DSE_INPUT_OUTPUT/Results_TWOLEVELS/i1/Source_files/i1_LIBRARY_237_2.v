...
module FAU ( 
  ...
  aoi21  g28(.a(new_n69_), .b(x20), .c(new_n43_), .O(z02));
  ...
  nand4  g34(.a(new_n75_), .b(x20), .c(new_n66_), .d(new_n52_), .O(new_n76_));
  ...
  nand3  g38(.a(new_n62_), .b(new_n50_), .c(new_n60_), .O(new_n80_));
  ...
  nand4  g53(.a(new_n45_), .b(new_n88_), .c(x22), .d(x17), .O(new_n95_));
  ...
  nand2  g60(.a(new_n88_), .b(x16), .O(new_n102_));
