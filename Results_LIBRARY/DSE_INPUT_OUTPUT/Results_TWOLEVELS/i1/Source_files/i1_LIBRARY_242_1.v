...
module FAU ( 
  ...
  inv1   g28(.a(new_n67_), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(new_n69_), .c(new_n65_), .O(z04));
  inv1   g30(.a(x10), .O(new_n72_));
  nand2  g31(.a(new_n70_), .b(new_n72_), .O(z05));
  nor2   g32(.a(new_n66_), .b(new_n43_), .O(z06));
  inv1   g33(.a(x18), .O(new_n75_));
  inv1   g34(.a(x24), .O(new_n76_));
  nor3   g35(.a(new_n67_), .b(new_n76_), .c(new_n75_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n67_), .b(new_n78_), .O(z08));
  oai21  g38(.a(new_n76_), .b(new_n78_), .c(new_n70_), .O(z09));
  nand3  g39(.a(new_n76_), .b(x22), .c(x14), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n70_), .O(z10));
  nand4  g41(.a(new_n70_), .b(new_n76_), .c(x22), .d(x17), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z11));
  inv1   g43(.a(x23), .O(new_n85_));
  nor3   g44(.a(new_n67_), .b(x24), .c(new_n85_), .O(new_n86_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n70_), .O(z14));
  nor2   g51(.a(x15), .b(x14), .O(new_n93_));
  nor3   g52(.a(new_n67_), .b(x13), .c(x12), .O(new_n94_));
