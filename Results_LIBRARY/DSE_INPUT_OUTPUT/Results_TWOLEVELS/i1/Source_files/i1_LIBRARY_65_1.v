...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n70_, new_n74_, new_n76_,
  ...
  and2   g31(.a(new_n70_), .b(x10), .O(z05));
  ...
  nor3   g40(.a(new_n81_), .b(new_n80_), .c(new_n78_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  nand2  g42(.a(new_n70_), .b(new_n80_), .O(new_n84_));
  ...
  nor2   g54(.a(new_n84_), .b(new_n95_), .O(z14));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  nor3   g56(.a(new_n81_), .b(x13), .c(x12), .O(new_n98_));
