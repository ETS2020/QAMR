...
module FAU ( 
  ...
  nand2  g35(.a(new_n76_), .b(new_n57_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n43_), .b(new_n78_), .O(z08));
  inv1   g38(.a(x24), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n57_), .O(z09));
  nand4  g40(.a(new_n57_), .b(new_n80_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n80_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n57_), .O(z11));
  inv1   g44(.a(x23), .O(new_n86_));
  nand2  g45(.a(new_n57_), .b(new_n80_), .O(new_n87_));
