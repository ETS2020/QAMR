...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n77_, new_n80_, new_n82_, new_n84_, new_n86_, new_n88_, new_n90_,
    new_n91_;
  ...
  nor3   g34(.a(new_n43_), .b(new_n75_), .c(new_n74_), .O(z07));
  inv1   g35(.a(x11), .O(new_n77_));
  nor2   g36(.a(new_n43_), .b(new_n77_), .O(z08));
  oai21  g37(.a(new_n75_), .b(new_n77_), .c(new_n57_), .O(z09));
  nand3  g38(.a(new_n75_), .b(x22), .c(x14), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n57_), .O(z10));
  nand4  g40(.a(new_n57_), .b(new_n75_), .c(x22), .d(x17), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z11));
  nand3  g42(.a(new_n75_), .b(x23), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n57_), .O(z12));
  nand4  g44(.a(new_n57_), .b(new_n75_), .c(x23), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z13));
  nand2  g46(.a(new_n75_), .b(x16), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n57_), .O(z14));
