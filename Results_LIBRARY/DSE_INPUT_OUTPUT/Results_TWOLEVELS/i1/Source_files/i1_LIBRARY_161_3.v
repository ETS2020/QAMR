...
module FAU ( 
  ...
  nor2   g14(.a(x23), .b(new_n42_), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n55_), .c(new_n45_), .O(z01));
  inv1   g16(.a(x23), .O(new_n58_));
  ...
  nand4  g38(.a(new_n61_), .b(new_n58_), .c(x19), .d(new_n79_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(z05));
  oai21  g40(.a(new_n67_), .b(new_n79_), .c(x23), .O(new_n82_));
  ...
  nor3   g44(.a(new_n62_), .b(x23), .c(new_n42_), .O(new_n86_));
  ...
  aoi21  g49(.a(x23), .b(x19), .c(new_n90_), .O(z08));
  ...
  nand4  g58(.a(new_n92_), .b(x23), .c(new_n45_), .d(x14), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z12));
  nand2  g60(.a(new_n92_), .b(x17), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n45_), .c(new_n58_), .O(z13));
  nand3  g62(.a(new_n43_), .b(new_n92_), .c(x16), .O(new_n104_));
