...
module FAU ( 
  ...
  nand4  g49(.a(new_n69_), .b(new_n84_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n84_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n69_), .O(z13));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n71_), .O(z15));
endmodule
