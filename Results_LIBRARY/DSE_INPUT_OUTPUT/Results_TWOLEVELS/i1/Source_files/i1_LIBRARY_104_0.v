...
module FAU ( 
  ...
  nand4  g34(.a(new_n75_), .b(new_n65_), .c(new_n64_), .d(new_n52_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(new_n74_), .O(z05));
  nand3  g36(.a(new_n60_), .b(new_n50_), .c(new_n58_), .O(new_n78_));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n46_), .O(z06));
  and2   g41(.a(x24), .b(x18), .O(z07));
  ...
  nand4  g52(.a(new_n44_), .b(new_n86_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n86_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(z13));
