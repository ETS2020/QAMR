...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n92_, new_n95_, new_n97_, new_n99_, new_n101_, new_n104_,
    new_n105_;
  ...
  aoi21  g29(.a(new_n70_), .b(x16), .c(new_n43_), .O(z02));
  ...
  nor2   g35(.a(new_n58_), .b(x08), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n65_), .c(x16), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n76_), .O(z05));
  nand3  g40(.a(new_n63_), .b(new_n50_), .c(new_n61_), .O(new_n82_));
  ...
  nand2  g51(.a(new_n45_), .b(new_n92_), .O(z08));
  ...
  nand4  g59(.a(new_n45_), .b(new_n90_), .c(x23), .d(x17), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z13));
  nor2   g61(.a(x24), .b(new_n58_), .O(z14));
