...
module FAU ( 
  ...
  oai22  g36(.a(new_n77_), .b(new_n64_), .c(new_n44_), .d(new_n75_), .O(z05));
  nand4  g37(.a(new_n61_), .b(new_n51_), .c(new_n63_), .d(new_n50_), .O(new_n79_));
  ...
  nand3  g52(.a(x23), .b(x19), .c(x14), .O(new_n94_));
  nor2   g53(.a(new_n94_), .b(x24), .O(z12));
  nand2  g54(.a(new_n88_), .b(x17), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(x19), .c(new_n43_), .O(z13));
