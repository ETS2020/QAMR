...
module FAU ( 
  ...
  oai21  g48(.a(new_n89_), .b(new_n87_), .c(new_n74_), .O(z10));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n74_), .O(z11));
  inv1   g51(.a(x23), .O(new_n93_));
  nand2  g52(.a(new_n74_), .b(new_n88_), .O(new_n94_));
