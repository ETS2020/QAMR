...
module FAU ( 
  ...
  nand3  g32(.a(new_n44_), .b(new_n73_), .c(new_n70_), .O(z04));
  ...
  nor3   g43(.a(new_n71_), .b(new_n84_), .c(new_n83_), .O(z07));
  nand3  g44(.a(x24), .b(x19), .c(x11), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z09));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n84_), .b(x22), .O(new_n89_));
  ...
  nand4  g51(.a(new_n44_), .b(new_n84_), .c(x23), .d(x14), .O(new_n93_));
  ...
  nor3   g56(.a(new_n71_), .b(x24), .c(new_n97_), .O(z14));
