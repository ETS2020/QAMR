...
module FAU ( 
  ...
  nand4  g38(.a(new_n79_), .b(new_n51_), .c(new_n62_), .d(new_n50_), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(x02), .O(new_n81_));
  nand3  g40(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n48_), .c(new_n82_), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n47_), .c(new_n58_), .O(z06));
  ...
  nand3  g52(.a(new_n89_), .b(x22), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n45_), .O(z11));
