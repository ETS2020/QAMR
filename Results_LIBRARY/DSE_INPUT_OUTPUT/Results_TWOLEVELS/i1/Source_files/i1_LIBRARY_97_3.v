...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n74_, new_n75_, new_n77_, new_n79_, new_n80_, new_n82_,
  ...
  nand2  g48(.a(new_n88_), .b(x14), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n58_), .c(new_n44_), .O(z10));
  nand2  g50(.a(new_n88_), .b(x17), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n58_), .c(new_n44_), .O(z11));
  nand4  g52(.a(new_n75_), .b(new_n88_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n88_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n75_), .O(z13));
