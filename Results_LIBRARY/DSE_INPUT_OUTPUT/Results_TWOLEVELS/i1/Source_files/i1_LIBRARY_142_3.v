...
module FAU ( 
  ...
  nand3  g11(.a(new_n52_), .b(x19), .c(new_n45_), .O(new_n53_));
  ...
  nand4  g18(.a(new_n59_), .b(x19), .c(new_n45_), .d(x00), .O(new_n60_));
  ...
  and2   g27(.a(new_n59_), .b(new_n45_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(z05));
  oai21  g29(.a(new_n59_), .b(new_n42_), .c(new_n45_), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n69_), .c(new_n68_), .O(z06));
  nand3  g31(.a(new_n43_), .b(x24), .c(x18), .O(new_n73_));
  inv1   g32(.a(new_n73_), .O(z07));
  inv1   g33(.a(x11), .O(new_n75_));
  nor2   g34(.a(new_n63_), .b(new_n75_), .O(z08));
  inv1   g35(.a(x24), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n75_), .c(new_n43_), .O(z09));
  nand4  g37(.a(new_n43_), .b(new_n77_), .c(x22), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand3  g39(.a(new_n77_), .b(x22), .c(x17), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n43_), .O(z11));
  nand4  g41(.a(new_n43_), .b(new_n77_), .c(x23), .d(x14), .O(new_n83_));
