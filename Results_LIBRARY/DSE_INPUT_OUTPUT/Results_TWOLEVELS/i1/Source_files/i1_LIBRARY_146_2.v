...
module FAU ( 
  ...
  nand4  g24(.a(new_n65_), .b(new_n64_), .c(new_n49_), .d(new_n63_), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(x00), .O(new_n67_));
  nand4  g26(.a(new_n63_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(new_n69_));
  nor2   g28(.a(x06), .b(x05), .O(new_n70_));
  nor2   g29(.a(x09), .b(new_n53_), .O(new_n71_));
  nand4  g30(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(new_n51_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n67_), .c(new_n43_), .O(z02));
  and2   g32(.a(new_n44_), .b(x20), .O(z03));
  nor2   g33(.a(x21), .b(x20), .O(new_n75_));
  nor2   g34(.a(new_n75_), .b(new_n60_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nor2   g36(.a(new_n43_), .b(x08), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n70_), .c(new_n69_), .d(new_n51_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n44_), .c(new_n77_), .O(z05));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n43_), .O(new_n81_));
  ...
  oai21  g43(.a(new_n66_), .b(new_n42_), .c(x19), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n84_), .c(new_n44_), .O(z06));
  nand2  g45(.a(x24), .b(x18), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z07));
  inv1   g47(.a(x11), .O(new_n89_));
  nor2   g48(.a(new_n60_), .b(new_n89_), .O(z08));
  ...
  nor3   g67(.a(new_n60_), .b(x13), .c(x12), .O(new_n109_));
