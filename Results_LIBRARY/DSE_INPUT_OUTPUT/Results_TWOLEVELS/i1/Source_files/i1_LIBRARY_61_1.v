...
module FAU ( 
  ...
  oai21  g14(.a(new_n55_), .b(new_n51_), .c(x00), .O(new_n56_));
  nand3  g15(.a(new_n56_), .b(x19), .c(x08), .O(new_n57_));
  ...
  nand4  g22(.a(new_n63_), .b(new_n54_), .c(new_n53_), .d(new_n52_), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n51_), .O(new_n65_));
  aoi21  g24(.a(new_n62_), .b(x00), .c(new_n65_), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(x08), .c(new_n43_), .O(z02));
  ...
  nand4  g32(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(new_n50_), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n76_));
  nor2   g35(.a(new_n62_), .b(new_n42_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x19), .c(x08), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z06));
  ...
  nand4  g45(.a(new_n45_), .b(new_n82_), .c(x22), .d(x14), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z10));
  nand3  g47(.a(new_n82_), .b(x22), .c(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z11));
  inv1   g49(.a(x14), .O(new_n91_));
  nand2  g50(.a(new_n82_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n45_), .O(z12));
