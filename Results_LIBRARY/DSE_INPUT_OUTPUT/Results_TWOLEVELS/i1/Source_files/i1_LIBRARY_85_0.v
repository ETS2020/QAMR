...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n94_, new_n96_, new_n98_, new_n100_, new_n103_, new_n104_;
  ...
  nor2   g49(.a(new_n43_), .b(new_n90_), .O(z08));
  ...
  nand3  g54(.a(new_n88_), .b(x22), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(z11));
  nand3  g56(.a(new_n88_), .b(x23), .c(x14), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n44_), .O(z12));
  nand3  g58(.a(new_n93_), .b(x23), .c(x17), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z13));
  and2   g60(.a(new_n93_), .b(x16), .O(z14));
