...
module FAU ( 
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n74_), .O(z10));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n74_), .O(z11));
  inv1   g46(.a(x23), .O(new_n88_));
  nor3   g47(.a(new_n69_), .b(x24), .c(new_n88_), .O(new_n89_));
  ...
  nor3   g53(.a(new_n69_), .b(x24), .c(new_n94_), .O(z14));
