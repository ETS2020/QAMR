...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n70_, new_n71_, new_n73_, new_n74_, new_n77_, new_n78_, new_n80_,
  ...
  nor2   g27(.a(new_n54_), .b(new_n43_), .O(z06));
  inv1   g28(.a(x18), .O(new_n70_));
  nand2  g29(.a(new_n65_), .b(x24), .O(new_n71_));
  ...
  nor2   g48(.a(new_n83_), .b(new_n89_), .O(z14));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nor3   g50(.a(new_n74_), .b(x13), .c(x12), .O(new_n92_));
