...
module FAU ( 
  ...
  nand4  g14(.a(new_n55_), .b(new_n49_), .c(new_n48_), .d(new_n43_), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(x00), .c(new_n47_), .O(z01));
  oai21  g16(.a(new_n47_), .b(x00), .c(x01), .O(new_n58_));
  ...
  nand4  g21(.a(new_n62_), .b(new_n49_), .c(new_n48_), .d(new_n43_), .O(new_n63_));
  inv1   g22(.a(x08), .O(new_n64_));
  nor2   g23(.a(x09), .b(new_n64_), .O(new_n65_));
  nand4  g24(.a(new_n65_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n66_));
  ...
  nor2   g33(.a(x03), .b(x02), .O(new_n75_));
  nor2   g34(.a(x05), .b(x04), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nor2   g36(.a(x07), .b(x06), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x19), .c(new_n64_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(new_n81_));
  oai21  g40(.a(new_n47_), .b(new_n74_), .c(new_n81_), .O(z05));
  nand2  g41(.a(new_n60_), .b(new_n62_), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(new_n49_), .c(new_n48_), .d(new_n43_), .O(new_n85_));
  nand4  g44(.a(new_n76_), .b(new_n75_), .c(new_n78_), .d(new_n43_), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n42_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n47_), .O(z06));
  nand2  g47(.a(x24), .b(x18), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(z07));
  inv1   g49(.a(x11), .O(new_n91_));
  nor2   g50(.a(new_n44_), .b(new_n91_), .O(z08));
  inv1   g51(.a(x24), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n91_), .c(new_n45_), .O(z09));
  ...
  oai21  g59(.a(new_n100_), .b(new_n95_), .c(new_n45_), .O(z12));
  oai21  g60(.a(new_n100_), .b(new_n98_), .c(new_n45_), .O(z13));
