...
module FAU ( 
  ...
  nor2   g20(.a(new_n61_), .b(new_n44_), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n60_), .O(z03));
  nor2   g22(.a(x21), .b(x20), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n62_), .O(z04));
  ...
  nor2   g28(.a(new_n61_), .b(x08), .O(z06));
  inv1   g29(.a(new_n62_), .O(new_n71_));
  nand2  g30(.a(x24), .b(x18), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n71_), .O(z07));
  inv1   g32(.a(x11), .O(new_n74_));
  nor2   g33(.a(new_n62_), .b(new_n74_), .O(z08));
  inv1   g34(.a(x24), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(z09));
  inv1   g36(.a(x14), .O(new_n78_));
  nand2  g37(.a(new_n76_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n71_), .O(z11));
  nand4  g41(.a(new_n71_), .b(new_n76_), .c(x23), .d(x14), .O(new_n83_));
  ...
  nand4  g50(.a(new_n91_), .b(new_n71_), .c(new_n90_), .d(new_n89_), .O(z15));
endmodule
