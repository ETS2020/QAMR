...
module FAU ( 
  ...
  nand4  g18(.a(new_n59_), .b(new_n58_), .c(new_n49_), .d(new_n46_), .O(new_n60_));
  ...
  aoi21  g27(.a(x19), .b(x04), .c(new_n68_), .O(z03));
  inv1   g28(.a(x21), .O(new_n70_));
  nand3  g29(.a(new_n43_), .b(new_n70_), .c(new_n68_), .O(z04));
  inv1   g30(.a(x08), .O(new_n72_));
  nand3  g31(.a(new_n59_), .b(x19), .c(new_n72_), .O(new_n73_));
  nor2   g32(.a(new_n73_), .b(new_n62_), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(x10), .O(new_n75_));
  nand2  g34(.a(new_n45_), .b(x10), .O(new_n76_));
  oai21  g35(.a(new_n75_), .b(x04), .c(new_n76_), .O(z05));
  nand2  g36(.a(new_n72_), .b(x04), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n81_));
  nor3   g40(.a(new_n60_), .b(x04), .c(new_n42_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n45_), .O(z06));
  nand3  g42(.a(new_n43_), .b(x24), .c(x18), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n43_), .b(new_n86_), .O(z08));
  nand3  g46(.a(new_n43_), .b(x24), .c(x11), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z09));
  inv1   g48(.a(x24), .O(new_n90_));
  nand3  g49(.a(new_n43_), .b(new_n90_), .c(x22), .O(new_n91_));
  ...
  nand3  g55(.a(new_n90_), .b(x23), .c(x14), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n43_), .O(z12));
  nand4  g57(.a(new_n43_), .b(new_n90_), .c(x23), .d(x17), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z13));
  inv1   g59(.a(x16), .O(new_n101_));
  oai21  g60(.a(x24), .b(new_n101_), .c(new_n43_), .O(z14));
  inv1   g61(.a(x12), .O(new_n103_));
  inv1   g62(.a(x13), .O(new_n104_));
  nor2   g63(.a(x15), .b(x14), .O(new_n105_));
  nand4  g64(.a(new_n105_), .b(new_n43_), .c(new_n104_), .d(new_n103_), .O(z15));
endmodule
