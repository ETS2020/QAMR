...
module FAU ( 
  ...
  nand2  g13(.a(x09), .b(x08), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(x07), .O(new_n56_));
  nand3  g15(.a(new_n56_), .b(new_n54_), .c(new_n53_), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(new_n47_), .c(new_n45_), .O(z01));
  inv1   g17(.a(x07), .O(new_n59_));
  inv1   g18(.a(x09), .O(new_n60_));
  nand4  g19(.a(new_n54_), .b(x19), .c(new_n60_), .d(x08), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n52_), .c(x08), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  nor2   g22(.a(x03), .b(x02), .O(new_n64_));
  nand4  g23(.a(new_n64_), .b(new_n54_), .c(new_n51_), .d(new_n48_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n59_), .O(new_n67_));
  ...
  nor2   g33(.a(new_n43_), .b(new_n74_), .O(z05));
  nor3   g34(.a(x07), .b(x06), .c(x05), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n77_));
  nand2  g36(.a(new_n65_), .b(x00), .O(new_n78_));
  oai21  g37(.a(new_n77_), .b(x01), .c(new_n78_), .O(new_n79_));
  nor2   g38(.a(new_n59_), .b(new_n42_), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(x08), .c(new_n80_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n47_), .c(new_n45_), .O(z06));
