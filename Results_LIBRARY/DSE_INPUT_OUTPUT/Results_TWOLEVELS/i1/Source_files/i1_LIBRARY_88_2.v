...
module FAU ( 
  ...
  nand2  g37(.a(x19), .b(x10), .O(new_n79_));
  oai21  g38(.a(new_n78_), .b(x08), .c(new_n79_), .O(z05));
  nand2  g39(.a(new_n61_), .b(new_n43_), .O(z06));
  ...
  nand4  g52(.a(new_n73_), .b(new_n86_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n86_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n73_), .O(z13));
  nand2  g56(.a(new_n86_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n73_), .O(z14));
