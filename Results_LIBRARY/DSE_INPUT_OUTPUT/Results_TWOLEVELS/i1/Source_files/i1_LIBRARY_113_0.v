...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n68_, new_n71_, new_n72_, new_n75_, new_n76_,
    new_n78_, new_n80_, new_n82_, new_n83_, new_n85_, new_n87_, new_n89_,
  ...
  nand2  g27(.a(new_n68_), .b(x19), .O(z03));
  or2    g28(.a(z03), .b(x21), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nand4  g30(.a(new_n63_), .b(x19), .c(new_n64_), .d(new_n51_), .O(new_n72_));
  oai22  g31(.a(new_n72_), .b(new_n61_), .c(new_n43_), .d(new_n71_), .O(z05));
  nand2  g32(.a(x20), .b(new_n45_), .O(z06));
  ...
  oai21  g39(.a(new_n76_), .b(new_n78_), .c(new_n80_), .O(z09));
  inv1   g40(.a(x14), .O(new_n82_));
  nand2  g41(.a(new_n76_), .b(x22), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n80_), .O(z11));
  nand3  g45(.a(new_n76_), .b(x23), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n80_), .O(z12));
  nand4  g47(.a(new_n80_), .b(new_n76_), .c(x23), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z13));
  nand2  g49(.a(new_n76_), .b(x16), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n80_), .O(z14));
