...
module FAU ( 
  ...
  aoi21  g55(.a(new_n96_), .b(new_n44_), .c(new_n43_), .O(z10));
  nand4  g56(.a(new_n46_), .b(new_n95_), .c(x22), .d(x17), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z11));
  nand2  g58(.a(new_n95_), .b(x23), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n44_), .c(new_n43_), .O(z12));
  inv1   g60(.a(x17), .O(new_n102_));
  oai21  g61(.a(new_n100_), .b(new_n102_), .c(new_n46_), .O(z13));
