...
module FAU ( 
  ...
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(new_n53_), .O(z09));
  inv1   g21(.a(x14), .O(new_n63_));
  nand2  g22(.a(new_n61_), .b(x22), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(new_n53_), .O(z10));
  inv1   g24(.a(x17), .O(new_n66_));
  oai21  g25(.a(new_n64_), .b(new_n66_), .c(new_n53_), .O(z11));
  nand4  g26(.a(new_n53_), .b(new_n61_), .c(x23), .d(x14), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  nand4  g28(.a(new_n53_), .b(new_n61_), .c(x23), .d(x17), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(z13));
  nand2  g30(.a(new_n61_), .b(x16), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n53_), .O(z14));
  inv1   g32(.a(x12), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nor2   g34(.a(x15), .b(x14), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n53_), .c(new_n75_), .d(new_n74_), .O(z15));
  buf    g36(.a(x19), .O(z06));
endmodule
