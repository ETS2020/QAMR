...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(x10), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n60_), .c(new_n44_), .O(z02));
  nand2  g26(.a(x19), .b(x10), .O(new_n68_));
  ...
  nand3  g47(.a(new_n68_), .b(new_n82_), .c(x23), .O(new_n89_));
