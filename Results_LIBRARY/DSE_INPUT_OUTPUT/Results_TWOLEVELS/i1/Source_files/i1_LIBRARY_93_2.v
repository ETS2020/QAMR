...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n87_, new_n89_, new_n91_, new_n92_, new_n94_, new_n97_,
    new_n98_;
  ...
  nand2  g33(.a(new_n46_), .b(x10), .O(new_n75_));
  ...
  nand3  g50(.a(new_n91_), .b(x23), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n46_), .O(z12));
  nand4  g52(.a(new_n46_), .b(new_n91_), .c(x23), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z13));
  aoi21  g54(.a(x24), .b(x19), .c(new_n43_), .O(z14));
