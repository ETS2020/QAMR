...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n76_, new_n77_, new_n78_, new_n80_, new_n82_, new_n84_,
  ...
  nand2  g31(.a(new_n43_), .b(x19), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n72_), .O(z03));
  oai21  g33(.a(new_n72_), .b(x19), .c(new_n43_), .O(z04));
  nand2  g34(.a(new_n73_), .b(x10), .O(new_n76_));
  nand3  g35(.a(new_n63_), .b(new_n59_), .c(new_n48_), .O(new_n77_));
  inv1   g36(.a(x08), .O(new_n78_));
  nor2   g37(.a(new_n43_), .b(new_n45_), .O(z06));
  nand3  g38(.a(new_n60_), .b(z06), .c(new_n78_), .O(new_n80_));
  ...
  nand4  g46(.a(new_n73_), .b(new_n86_), .c(x22), .d(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z10));
  nand3  g48(.a(new_n86_), .b(x22), .c(x17), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n73_), .O(z11));
  inv1   g50(.a(x23), .O(new_n92_));
  nand2  g51(.a(new_n73_), .b(new_n86_), .O(new_n93_));
  ...
  nand4  g62(.a(new_n103_), .b(new_n73_), .c(new_n102_), .d(new_n101_), .O(z15));
endmodule
