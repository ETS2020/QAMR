...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n85_, new_n88_, new_n90_, new_n91_, new_n92_, new_n94_,
  ...
  nand4  g35(.a(new_n76_), .b(new_n65_), .c(new_n64_), .d(new_n52_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n71_), .c(new_n75_), .O(z05));
  ...
  nor2   g45(.a(new_n46_), .b(new_n43_), .O(z08));
  nand2  g46(.a(z08), .b(x24), .O(new_n88_));
  ...
  nand2  g60(.a(new_n85_), .b(x16), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n71_), .O(z14));
