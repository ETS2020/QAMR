...
module FAU ( 
  ...
  oai21  g14(.a(new_n43_), .b(x00), .c(x07), .O(new_n56_));
  nor3   g15(.a(x03), .b(x02), .c(x01), .O(new_n57_));
  nor3   g16(.a(x06), .b(x05), .c(x04), .O(new_n58_));
  ...
  nor2   g27(.a(x19), .b(new_n50_), .O(new_n69_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n75_), .c(new_n63_), .d(new_n50_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n70_), .c(new_n74_), .O(z05));
  nor2   g37(.a(x07), .b(x06), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n48_), .c(new_n60_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n82_));
  nand4  g41(.a(new_n79_), .b(new_n57_), .c(new_n48_), .d(new_n60_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n42_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n43_), .O(z06));
  nand2  g44(.a(x24), .b(x18), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n70_), .O(z07));
  inv1   g46(.a(x11), .O(new_n88_));
  nor2   g47(.a(new_n69_), .b(new_n88_), .O(z08));
  inv1   g48(.a(x24), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n88_), .c(new_n70_), .O(z09));
  inv1   g50(.a(x22), .O(new_n92_));
  nand2  g51(.a(new_n70_), .b(new_n90_), .O(new_n93_));
  ...
  nand3  g57(.a(new_n90_), .b(x23), .c(x14), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n70_), .O(z12));
  nand4  g59(.a(new_n70_), .b(new_n90_), .c(x23), .d(x17), .O(new_n101_));
  ...
  nor3   g64(.a(new_n69_), .b(x13), .c(x12), .O(new_n106_));
