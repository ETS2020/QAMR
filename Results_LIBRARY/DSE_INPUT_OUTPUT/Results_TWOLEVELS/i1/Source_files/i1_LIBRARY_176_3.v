...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n74_, new_n75_, new_n78_, new_n79_, new_n80_, new_n82_,
  ...
  nor2   g32(.a(new_n57_), .b(new_n44_), .O(new_n74_));
  inv1   g33(.a(new_n74_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n73_), .O(z03));
  ...
  nor2   g39(.a(x23), .b(new_n44_), .O(z06));
  nand3  g40(.a(new_n60_), .b(z06), .c(new_n80_), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n79_), .c(new_n74_), .d(new_n78_), .O(z05));
  nand2  g42(.a(x24), .b(x18), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n75_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nor2   g45(.a(new_n74_), .b(new_n86_), .O(z08));
  inv1   g46(.a(x24), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n75_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n88_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n75_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n75_), .O(z11));
  nand2  g53(.a(new_n88_), .b(x14), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n44_), .c(new_n57_), .O(z12));
  nand2  g55(.a(new_n88_), .b(x17), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n44_), .c(new_n57_), .O(z13));
