...
module FAU ( 
  ...
  aoi21  g02(.a(x20), .b(new_n43_), .c(new_n42_), .O(z00));
  ...
  nor2   g27(.a(new_n68_), .b(new_n43_), .O(z03));
  inv1   g28(.a(x21), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n68_), .O(z04));
  inv1   g30(.a(x10), .O(new_n72_));
  nand2  g31(.a(x20), .b(new_n43_), .O(new_n73_));
  nor2   g32(.a(new_n43_), .b(x08), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(new_n63_), .c(new_n62_), .d(new_n50_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(z05));
  nand3  g35(.a(new_n58_), .b(new_n48_), .c(new_n56_), .O(new_n77_));
  ...
  nand4  g49(.a(new_n73_), .b(new_n88_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand4  g51(.a(new_n73_), .b(new_n88_), .c(x23), .d(x14), .O(new_n93_));
