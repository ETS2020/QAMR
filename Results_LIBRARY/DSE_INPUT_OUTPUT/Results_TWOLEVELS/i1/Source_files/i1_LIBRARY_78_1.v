...
module FAU ( 
  ...
  oai21  g34(.a(new_n75_), .b(new_n43_), .c(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n74_), .O(z05));
  nor2   g36(.a(new_n58_), .b(new_n43_), .O(z06));
  ...
  nand2  g41(.a(new_n71_), .b(x24), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(new_n81_), .O(z09));
  inv1   g43(.a(x22), .O(new_n85_));
  inv1   g44(.a(x24), .O(new_n86_));
  nand2  g45(.a(new_n71_), .b(new_n86_), .O(new_n87_));
  ...
  nand4  g61(.a(new_n102_), .b(new_n58_), .c(new_n101_), .d(new_n43_), .O(z15));
endmodule
