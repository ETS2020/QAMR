...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(x19), .c(x10), .O(new_n58_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(x08), .d(new_n52_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n64_), .c(new_n63_), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(x19), .c(x10), .O(new_n69_));
  ...
  nand2  g34(.a(new_n43_), .b(new_n75_), .O(z05));
  nand2  g35(.a(x24), .b(x18), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n45_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nor2   g38(.a(new_n44_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  nor3   g40(.a(new_n44_), .b(new_n81_), .c(new_n79_), .O(z09));
  nand3  g41(.a(new_n81_), .b(x22), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n45_), .O(z10));
  nand4  g43(.a(new_n45_), .b(new_n81_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  inv1   g45(.a(x14), .O(new_n87_));
  nand2  g46(.a(new_n81_), .b(x23), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n87_), .c(new_n45_), .O(z12));
  inv1   g48(.a(x17), .O(new_n90_));
  oai21  g49(.a(new_n88_), .b(new_n90_), .c(new_n45_), .O(z13));
