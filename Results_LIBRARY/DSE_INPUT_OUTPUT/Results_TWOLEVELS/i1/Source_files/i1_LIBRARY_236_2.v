...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n78_, new_n80_, new_n83_, new_n85_, new_n87_,
  ...
  nor3   g37(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nor2   g39(.a(new_n78_), .b(new_n80_), .O(z08));
  oai21  g40(.a(new_n77_), .b(new_n80_), .c(new_n43_), .O(z09));
  nand3  g41(.a(new_n77_), .b(x22), .c(x14), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n43_), .O(z10));
  nand4  g43(.a(new_n43_), .b(new_n77_), .c(x22), .d(x17), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z11));
  nand3  g45(.a(new_n77_), .b(x23), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n43_), .O(z12));
  nand4  g47(.a(new_n43_), .b(new_n77_), .c(x23), .d(x17), .O(new_n89_));
