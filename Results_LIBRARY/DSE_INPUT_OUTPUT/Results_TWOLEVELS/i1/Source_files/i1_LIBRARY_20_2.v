...
module FAU ( 
  ...
  aoi22  g28(.a(new_n69_), .b(new_n65_), .c(new_n62_), .d(x00), .O(new_n70_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n65_), .c(new_n52_), .d(new_n51_), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n43_), .c(new_n47_), .O(z05));
