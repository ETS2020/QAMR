...
module FAU ( 
  ...
  nor2   g19(.a(new_n47_), .b(x09), .O(new_n61_));
  nand4  g20(.a(new_n61_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n62_));
  ...
  nand4  g25(.a(new_n66_), .b(new_n65_), .c(new_n51_), .d(new_n59_), .O(new_n67_));
  ...
  nand4  g33(.a(x19), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n75_));
  ...
  nand3  g37(.a(new_n66_), .b(new_n51_), .c(new_n59_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n81_));
  nor2   g40(.a(new_n67_), .b(new_n42_), .O(new_n82_));
  ...
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n45_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n45_), .O(z11));
  nand3  g53(.a(new_n88_), .b(x23), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n45_), .O(z12));
  nand4  g55(.a(new_n45_), .b(new_n88_), .c(x23), .d(x17), .O(new_n97_));
