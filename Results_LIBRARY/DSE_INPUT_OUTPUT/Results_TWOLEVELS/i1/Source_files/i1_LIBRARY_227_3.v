...
module FAU ( 
  ...
  nand2  g17(.a(x19), .b(x08), .O(new_n59_));
  and2   g18(.a(new_n59_), .b(x20), .O(z03));
  inv1   g19(.a(new_n59_), .O(new_n61_));
  nor2   g20(.a(x21), .b(x20), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n61_), .O(z04));
  inv1   g22(.a(x10), .O(new_n64_));
  nand2  g23(.a(new_n56_), .b(new_n44_), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x19), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n64_), .O(z05));
  inv1   g26(.a(x19), .O(new_n68_));
  nor2   g27(.a(x08), .b(x00), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(x00), .c(new_n68_), .O(z06));
  nand3  g29(.a(new_n59_), .b(x24), .c(x18), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n59_), .b(new_n73_), .O(z08));
  nand3  g33(.a(new_n59_), .b(x24), .c(x11), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z09));
  inv1   g35(.a(x24), .O(new_n77_));
  nand4  g36(.a(new_n59_), .b(new_n77_), .c(x22), .d(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z10));
  nand3  g38(.a(new_n77_), .b(x22), .c(x17), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n59_), .O(z11));
  nand3  g40(.a(new_n59_), .b(new_n77_), .c(x23), .O(new_n82_));
  ...
  oai21  g47(.a(x24), .b(new_n88_), .c(new_n59_), .O(z14));
  nor2   g48(.a(x13), .b(x12), .O(new_n90_));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n61_), .O(z15));
endmodule
