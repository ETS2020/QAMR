...
module FAU ( 
  ...
  nand4  g49(.a(new_n57_), .b(new_n90_), .c(x23), .d(x14), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z12));
  nand3  g51(.a(new_n90_), .b(x23), .c(x17), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n57_), .O(z13));
  nand2  g53(.a(new_n90_), .b(x16), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n57_), .O(z14));
