...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(x20), .c(x19), .O(new_n58_));
  ...
  nand3  g24(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  ...
  aoi21  g30(.a(new_n71_), .b(x20), .c(new_n43_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  inv1   g32(.a(x21), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(x19), .c(new_n73_), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nand3  g35(.a(new_n65_), .b(new_n61_), .c(new_n49_), .O(new_n77_));
  nand4  g36(.a(new_n62_), .b(x20), .c(x19), .d(new_n68_), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n77_), .c(new_n44_), .d(new_n76_), .O(z05));
  nand3  g38(.a(new_n62_), .b(new_n50_), .c(new_n64_), .O(new_n80_));
  ...
  nand3  g43(.a(new_n84_), .b(x20), .c(x19), .O(new_n85_));
  ...
  nor3   g50(.a(new_n44_), .b(new_n91_), .c(new_n89_), .O(z09));
  nand4  g51(.a(new_n45_), .b(new_n91_), .c(x22), .d(x14), .O(new_n93_));
  ...
  nand4  g57(.a(new_n45_), .b(new_n91_), .c(x23), .d(x17), .O(new_n99_));
