...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n86_, new_n89_, new_n91_, new_n93_, new_n95_, new_n97_,
    new_n99_, new_n100_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x22), .b(x19), .O(new_n43_));
  ...
  nand4  g34(.a(new_n67_), .b(x19), .c(new_n68_), .d(new_n51_), .O(new_n76_));
  oai22  g35(.a(new_n76_), .b(new_n65_), .c(new_n43_), .d(new_n75_), .O(z05));
  nand3  g36(.a(new_n62_), .b(new_n49_), .c(new_n60_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n80_));
  nor2   g39(.a(new_n63_), .b(new_n42_), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n59_), .O(z06));
  inv1   g41(.a(x18), .O(new_n83_));
  inv1   g42(.a(x24), .O(new_n84_));
  nor3   g43(.a(new_n43_), .b(new_n84_), .c(new_n83_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n44_), .b(new_n86_), .O(z08));
  oai21  g46(.a(new_n84_), .b(new_n86_), .c(new_n44_), .O(z09));
  nand3  g47(.a(new_n84_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n44_), .O(z10));
  nand2  g49(.a(x22), .b(x17), .O(new_n91_));
  nor2   g50(.a(new_n91_), .b(x24), .O(z11));
  nand3  g51(.a(new_n84_), .b(x23), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z12));
  nand4  g53(.a(new_n44_), .b(new_n84_), .c(x23), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z13));
  nand2  g55(.a(new_n84_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(z14));
  nor2   g57(.a(x13), .b(x12), .O(new_n99_));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n43_), .O(z15));
endmodule
