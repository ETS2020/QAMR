...
module FAU ( 
  ...
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(z10));
  ...
  oai21  g57(.a(new_n98_), .b(new_n97_), .c(new_n44_), .O(z12));
  inv1   g58(.a(x17), .O(new_n100_));
  oai21  g59(.a(new_n98_), .b(new_n100_), .c(new_n44_), .O(z13));
  inv1   g60(.a(x16), .O(new_n102_));
  nor3   g61(.a(new_n43_), .b(x24), .c(new_n102_), .O(z14));
