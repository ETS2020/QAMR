...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n70_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n70_), .O(z11));
  nand4  g41(.a(new_n70_), .b(new_n78_), .c(x23), .d(x14), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z12));
  nand3  g43(.a(new_n78_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n70_), .O(z13));
