...
module FAU ( 
  ...
  oai21  g41(.a(new_n68_), .b(new_n80_), .c(new_n57_), .O(new_n83_));
  ...
  nor3   g45(.a(new_n63_), .b(new_n57_), .c(new_n42_), .O(new_n87_));
  ...
  oai21  g61(.a(new_n102_), .b(new_n101_), .c(new_n45_), .O(z12));
  inv1   g62(.a(x17), .O(new_n104_));
  oai21  g63(.a(new_n102_), .b(new_n104_), .c(new_n45_), .O(z13));
  ...
  nand4  g68(.a(new_n109_), .b(new_n43_), .c(new_n57_), .d(new_n108_), .O(z15));
endmodule
