...
module FAU ( 
  ...
  nand2  g30(.a(new_n43_), .b(x19), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n71_), .O(z03));
  nand3  g32(.a(new_n43_), .b(new_n71_), .c(new_n45_), .O(z04));
  inv1   g33(.a(x10), .O(new_n75_));
  nand3  g34(.a(new_n64_), .b(new_n65_), .c(new_n51_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(x21), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n75_), .O(z05));
  nor2   g38(.a(new_n43_), .b(x00), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(x00), .c(new_n45_), .O(z06));
  ...
  nand2  g47(.a(new_n72_), .b(new_n86_), .O(new_n89_));
  ...
  aoi22  g63(.a(new_n104_), .b(new_n103_), .c(new_n43_), .d(x19), .O(z15));
endmodule
