...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n78_, new_n82_, new_n84_, new_n85_,
    new_n86_, new_n88_, new_n90_, new_n91_, new_n92_, new_n94_, new_n96_,
    new_n98_, new_n99_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x18), .b(x11), .O(new_n43_));
  ...
  nand3  g37(.a(new_n78_), .b(new_n45_), .c(new_n74_), .O(z05));
  nor2   g38(.a(new_n43_), .b(new_n76_), .O(z06));
  and2   g39(.a(x24), .b(x18), .O(z07));
  nand2  g40(.a(x24), .b(x11), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n45_), .O(z09));
  ...
  nand2  g50(.a(new_n91_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n90_), .c(new_n45_), .O(z12));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n45_), .O(z13));
  nand2  g54(.a(new_n91_), .b(x16), .O(new_n96_));
