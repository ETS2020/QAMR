...
module FAU ( 
  ...
  nand2  g35(.a(new_n45_), .b(x16), .O(z06));
  ...
  nand4  g48(.a(new_n69_), .b(new_n82_), .c(x23), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n82_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n69_), .O(z13));
