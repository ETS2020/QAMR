...
module FAU ( 
  ...
  nor2   g16(.a(x18), .b(new_n42_), .O(new_n58_));
  ...
  nand3  g36(.a(new_n77_), .b(new_n52_), .c(new_n51_), .O(new_n78_));
  ...
  nand3  g40(.a(new_n62_), .b(new_n51_), .c(new_n60_), .O(new_n82_));
  ...
  nand3  g45(.a(x24), .b(new_n44_), .c(x18), .O(new_n87_));
  ...
  nand2  g57(.a(new_n96_), .b(x23), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(new_n100_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n45_), .O(z15));
endmodule
