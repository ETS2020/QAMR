...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n79_, new_n81_, new_n83_, new_n84_, new_n85_,
  ...
  nand2  g22(.a(new_n50_), .b(new_n49_), .O(new_n64_));
  inv1   g23(.a(x09), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(x08), .c(new_n51_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  aoi22  g26(.a(new_n67_), .b(new_n63_), .c(new_n61_), .d(x00), .O(new_n68_));
  oai21  g27(.a(new_n68_), .b(new_n45_), .c(new_n57_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nand2  g29(.a(new_n57_), .b(new_n70_), .O(z03));
  or2    g30(.a(z03), .b(x21), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  inv1   g32(.a(new_n64_), .O(new_n74_));
  nor2   g33(.a(new_n45_), .b(x08), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n74_), .c(new_n63_), .d(new_n51_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n57_), .c(new_n73_), .O(z05));
  and2   g36(.a(x24), .b(x18), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nand2  g38(.a(new_n57_), .b(new_n79_), .O(z08));
  inv1   g39(.a(x24), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n57_), .O(z09));
  inv1   g41(.a(x22), .O(new_n83_));
  nand2  g42(.a(new_n57_), .b(new_n81_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n57_), .O(z12));
  nand4  g50(.a(new_n57_), .b(new_n81_), .c(x23), .d(x17), .O(new_n92_));
