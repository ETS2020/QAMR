...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(x00), .c(x05), .O(new_n60_));
  ...
  nand4  g26(.a(new_n67_), .b(new_n66_), .c(x08), .d(new_n51_), .O(new_n68_));
  ...
  nand4  g36(.a(new_n77_), .b(new_n67_), .c(new_n76_), .d(new_n51_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n45_), .c(new_n75_), .O(z05));
  nor2   g38(.a(x07), .b(x06), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n43_), .c(new_n64_), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n83_));
  nand4  g42(.a(new_n80_), .b(new_n61_), .c(new_n43_), .d(new_n64_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(new_n42_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n59_), .O(z06));
  ...
  nand4  g51(.a(new_n45_), .b(new_n88_), .c(x22), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z10));
  nand3  g53(.a(new_n88_), .b(x22), .c(x17), .O(new_n95_));
