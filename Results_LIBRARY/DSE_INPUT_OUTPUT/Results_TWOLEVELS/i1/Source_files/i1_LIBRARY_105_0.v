...
module FAU ( 
  ...
  nand2  g29(.a(new_n70_), .b(x19), .O(z03));
  nand2  g30(.a(x21), .b(x19), .O(new_n72_));
  ...
  nand2  g42(.a(new_n44_), .b(x24), .O(new_n84_));
  ...
  nand4  g50(.a(new_n44_), .b(new_n89_), .c(x22), .d(x17), .O(new_n92_));
