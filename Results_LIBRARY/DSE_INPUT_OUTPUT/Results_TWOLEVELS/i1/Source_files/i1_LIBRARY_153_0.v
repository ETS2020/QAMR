...
module FAU ( 
  ...
  nand4  g34(.a(new_n75_), .b(x19), .c(new_n74_), .d(new_n52_), .O(new_n76_));
  oai22  g35(.a(new_n76_), .b(new_n59_), .c(new_n43_), .d(new_n73_), .O(z05));
  oai21  g36(.a(x09), .b(new_n74_), .c(new_n46_), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n52_), .c(new_n50_), .d(new_n58_), .O(new_n79_));
  ...
  oai21  g42(.a(new_n66_), .b(new_n42_), .c(x19), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n83_), .O(z06));
  ...
  nor2   g50(.a(new_n43_), .b(x24), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x22), .c(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z10));
  nand3  g53(.a(new_n90_), .b(x22), .c(x17), .O(new_n95_));
