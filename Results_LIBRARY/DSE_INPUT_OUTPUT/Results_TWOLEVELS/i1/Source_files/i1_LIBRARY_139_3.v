...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n93_, new_n95_, new_n96_, new_n97_;
  ...
  aoi22  g27(.a(new_n68_), .b(new_n65_), .c(x19), .d(x08), .O(z04));
  ...
  nand3  g34(.a(new_n66_), .b(x24), .c(x18), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nand2  g37(.a(new_n66_), .b(new_n78_), .O(z08));
  nand3  g38(.a(new_n66_), .b(x24), .c(x11), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z09));
  inv1   g40(.a(x24), .O(new_n82_));
  nand3  g41(.a(new_n66_), .b(new_n82_), .c(x22), .O(new_n83_));
  ...
  nand4  g47(.a(new_n66_), .b(new_n82_), .c(x23), .d(x14), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z12));
  nand3  g49(.a(new_n82_), .b(x23), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n66_), .O(z13));
  inv1   g51(.a(x16), .O(new_n93_));
  oai21  g52(.a(x24), .b(new_n93_), .c(new_n66_), .O(z14));
  inv1   g53(.a(x12), .O(new_n95_));
  inv1   g54(.a(x13), .O(new_n96_));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  nand4  g56(.a(new_n97_), .b(new_n66_), .c(new_n96_), .d(new_n95_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
