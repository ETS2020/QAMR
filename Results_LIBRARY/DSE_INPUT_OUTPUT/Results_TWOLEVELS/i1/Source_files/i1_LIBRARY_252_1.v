...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n86_, new_n87_, new_n89_, new_n92_, new_n93_,
  ...
  nand3  g29(.a(new_n70_), .b(x19), .c(x16), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z02));
  inv1   g31(.a(x20), .O(new_n73_));
  nor2   g32(.a(new_n45_), .b(x16), .O(new_n74_));
  ...
  nand4  g40(.a(new_n60_), .b(x19), .c(x16), .d(new_n81_), .O(new_n82_));
  ...
  nand2  g45(.a(new_n77_), .b(x24), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(new_n86_), .O(z07));
  inv1   g47(.a(x11), .O(new_n89_));
  nor2   g48(.a(new_n74_), .b(new_n89_), .O(z08));
  nor2   g49(.a(new_n87_), .b(new_n89_), .O(z09));
  inv1   g50(.a(x14), .O(new_n92_));
  inv1   g51(.a(x24), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x22), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n92_), .c(new_n77_), .O(z10));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n77_), .O(z11));
  inv1   g56(.a(x23), .O(new_n98_));
  nor3   g57(.a(new_n74_), .b(x24), .c(new_n98_), .O(new_n99_));
  ...
  nor2   g62(.a(x24), .b(new_n43_), .O(z14));
  nor2   g63(.a(x13), .b(x12), .O(new_n105_));
  nor2   g64(.a(x15), .b(x14), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n74_), .O(z15));
endmodule
