...
module FAU ( 
  ...
  aoi21  g29(.a(new_n70_), .b(new_n44_), .c(new_n43_), .O(z02));
  inv1   g30(.a(x21), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n44_), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  inv1   g33(.a(new_n68_), .O(new_n75_));
  nand4  g34(.a(new_n75_), .b(new_n44_), .c(new_n67_), .d(new_n53_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n65_), .c(new_n44_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n74_), .O(z05));
  nand3  g38(.a(new_n63_), .b(new_n51_), .c(new_n61_), .O(new_n80_));
  ...
  nand3  g43(.a(new_n84_), .b(new_n44_), .c(x19), .O(new_n85_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n46_), .O(z10));
  nand4  g53(.a(new_n46_), .b(new_n91_), .c(x22), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z11));
  inv1   g55(.a(x14), .O(new_n97_));
  nand2  g56(.a(new_n91_), .b(x23), .O(new_n98_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n45_), .O(z15));
  buf    g65(.a(x20), .O(z03));
endmodule
