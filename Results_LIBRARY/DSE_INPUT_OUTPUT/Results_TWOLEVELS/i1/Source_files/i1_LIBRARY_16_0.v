...
module FAU ( 
  ...
  oai21  g27(.a(new_n68_), .b(new_n42_), .c(new_n44_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nand2  g29(.a(new_n44_), .b(new_n70_), .O(z03));
  oai21  g30(.a(new_n70_), .b(new_n42_), .c(new_n43_), .O(z04));
  nand2  g31(.a(new_n44_), .b(x10), .O(new_n73_));
  inv1   g32(.a(new_n66_), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(x19), .c(new_n65_), .d(new_n51_), .O(new_n75_));
  ...
  nand2  g46(.a(new_n44_), .b(new_n81_), .O(new_n88_));
