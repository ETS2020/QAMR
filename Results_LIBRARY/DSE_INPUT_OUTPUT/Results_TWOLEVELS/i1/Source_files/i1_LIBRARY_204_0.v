...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n77_, new_n78_, new_n79_, new_n82_, new_n83_,
    new_n86_, new_n87_, new_n89_, new_n91_, new_n93_, new_n96_, new_n97_;
  inv1   g00(.a(x00), .O(new_n42_));
  nor2   g01(.a(x11), .b(x08), .O(new_n43_));
  ...
  nand2  g27(.a(new_n50_), .b(new_n49_), .O(new_n69_));
  nor4   g28(.a(new_n69_), .b(x09), .c(new_n68_), .d(x07), .O(new_n70_));
  aoi22  g29(.a(new_n70_), .b(new_n67_), .c(new_n63_), .d(x00), .O(new_n71_));
  ...
  and2   g53(.a(new_n86_), .b(x16), .O(z14));
