...
module FAU ( 
  ...
  nand4  g33(.a(new_n48_), .b(new_n61_), .c(new_n47_), .d(new_n46_), .O(new_n75_));
  nand3  g34(.a(new_n62_), .b(x19), .c(new_n66_), .O(new_n76_));
  ...
  oai21  g38(.a(new_n43_), .b(x00), .c(x01), .O(new_n80_));
  nor3   g39(.a(x07), .b(x06), .c(x05), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n61_), .c(new_n47_), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(x02), .O(new_n83_));
  nand4  g42(.a(new_n81_), .b(new_n65_), .c(new_n46_), .d(x00), .O(new_n84_));
  ...
  nor2   g48(.a(new_n57_), .b(new_n89_), .O(z08));
  inv1   g49(.a(x24), .O(new_n91_));
  nor3   g50(.a(new_n57_), .b(new_n91_), .c(new_n89_), .O(z09));
  inv1   g51(.a(x14), .O(new_n93_));
  nand2  g52(.a(new_n91_), .b(x22), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n58_), .O(z10));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n58_), .O(z11));
  nand3  g56(.a(new_n91_), .b(x23), .c(x14), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n58_), .O(z12));
  nand4  g58(.a(new_n58_), .b(new_n91_), .c(x23), .d(x17), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z13));
  nand2  g60(.a(new_n91_), .b(x16), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n58_), .O(z14));
  nor2   g62(.a(x15), .b(x14), .O(new_n104_));
  nor3   g63(.a(new_n57_), .b(x13), .c(x12), .O(new_n105_));
