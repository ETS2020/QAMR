...
module FAU ( 
  ...
  oai21  g50(.a(new_n57_), .b(new_n90_), .c(new_n45_), .O(z09));
  nand2  g51(.a(x22), .b(x14), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n43_), .c(x24), .O(z10));
  nand4  g53(.a(new_n57_), .b(x22), .c(new_n43_), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z11));
  nand4  g55(.a(new_n57_), .b(x23), .c(new_n43_), .d(x14), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z12));
  nand2  g57(.a(x23), .b(x17), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n43_), .c(x24), .O(z13));
  nand3  g59(.a(new_n57_), .b(new_n43_), .c(x16), .O(new_n101_));
