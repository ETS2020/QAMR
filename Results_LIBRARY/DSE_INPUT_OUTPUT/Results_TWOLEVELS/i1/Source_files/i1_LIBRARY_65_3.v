...
module FAU ( 
  ...
  aoi21  g36(.a(new_n77_), .b(x00), .c(new_n52_), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n61_), .O(z07));
  inv1   g39(.a(x11), .O(new_n81_));
  nand2  g40(.a(new_n61_), .b(new_n81_), .O(z08));
  nand3  g41(.a(new_n61_), .b(x24), .c(x11), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z09));
  inv1   g43(.a(x24), .O(new_n85_));
  nand3  g44(.a(new_n61_), .b(new_n85_), .c(x22), .O(new_n86_));
  ...
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n61_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n61_), .O(z13));
  nand3  g55(.a(new_n61_), .b(new_n85_), .c(x16), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z14));
  inv1   g57(.a(x12), .O(new_n99_));
  inv1   g58(.a(x13), .O(new_n100_));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  nand4  g60(.a(new_n101_), .b(new_n61_), .c(new_n100_), .d(new_n99_), .O(z15));
endmodule
