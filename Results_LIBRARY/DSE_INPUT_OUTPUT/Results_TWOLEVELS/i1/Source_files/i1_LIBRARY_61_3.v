...
module FAU ( 
  ...
  nand3  g24(.a(new_n46_), .b(new_n65_), .c(new_n63_), .O(z04));
  ...
  oai21  g37(.a(new_n78_), .b(new_n76_), .c(new_n46_), .O(z09));
  nand4  g38(.a(new_n46_), .b(new_n78_), .c(x22), .d(x14), .O(new_n80_));
  ...
  oai21  g44(.a(new_n85_), .b(new_n84_), .c(new_n46_), .O(z12));
  inv1   g45(.a(x17), .O(new_n87_));
  oai21  g46(.a(new_n85_), .b(new_n87_), .c(new_n46_), .O(z13));
