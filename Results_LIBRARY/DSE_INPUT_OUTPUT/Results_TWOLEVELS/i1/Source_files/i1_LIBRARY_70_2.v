...
module FAU ( 
  ...
  nand3  g25(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n67_));
  nor2   g26(.a(x07), .b(x06), .O(new_n68_));
  nand3  g27(.a(new_n68_), .b(new_n50_), .c(new_n60_), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n62_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x00), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n66_), .O(z02));
  ...
  nand4  g37(.a(x19), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n61_), .c(new_n77_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(new_n81_));
  oai21  g40(.a(new_n78_), .b(new_n77_), .c(new_n81_), .O(z05));
  nand4  g41(.a(new_n68_), .b(new_n50_), .c(new_n60_), .d(new_n49_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x02), .O(new_n84_));
  nand2  g43(.a(new_n70_), .b(x00), .O(new_n85_));
  aoi21  g44(.a(new_n84_), .b(new_n47_), .c(new_n85_), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n62_), .c(new_n45_), .O(z06));
  nand2  g46(.a(x24), .b(x18), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z07));
  inv1   g48(.a(x24), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n78_), .c(new_n45_), .O(z09));
