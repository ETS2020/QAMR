...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n85_, new_n87_, new_n90_, new_n91_, new_n92_, new_n93_,
  ...
  nor2   g30(.a(new_n71_), .b(new_n43_), .O(z03));
  ...
  nand2  g50(.a(new_n44_), .b(new_n91_), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  ...
  nor2   g57(.a(new_n92_), .b(new_n98_), .O(new_n99_));
  ...
  nor2   g63(.a(new_n92_), .b(new_n104_), .O(z14));
  inv1   g64(.a(x12), .O(new_n106_));
  inv1   g65(.a(x13), .O(new_n107_));
  nor2   g66(.a(x15), .b(x14), .O(new_n108_));
  nand4  g67(.a(new_n108_), .b(new_n44_), .c(new_n107_), .d(new_n106_), .O(z15));
endmodule
