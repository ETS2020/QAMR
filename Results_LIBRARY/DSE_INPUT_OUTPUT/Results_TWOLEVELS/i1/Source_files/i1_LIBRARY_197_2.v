...
module FAU ( 
  ...
  nand3  g37(.a(x19), .b(new_n43_), .c(new_n52_), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n64_), .c(new_n78_), .O(new_n81_));
  ...
  nand2  g45(.a(x24), .b(x11), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n45_), .O(z09));
  ...
  oai21  g60(.a(x24), .b(new_n101_), .c(new_n45_), .O(z14));
