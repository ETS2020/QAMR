...
module FAU ( 
  ...
  nand4  g37(.a(new_n62_), .b(new_n49_), .c(new_n60_), .d(new_n48_), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(x02), .c(x01), .O(new_n80_));
  nor3   g39(.a(new_n80_), .b(new_n63_), .c(new_n42_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n59_), .c(new_n44_), .O(z06));
