...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n86_, new_n87_, new_n89_, new_n91_, new_n93_, new_n94_, new_n97_,
    new_n98_;
  ...
  nand2  g39(.a(new_n58_), .b(x24), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n80_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n58_), .b(new_n83_), .O(z08));
  ...
  nand3  g47(.a(x22), .b(x19), .c(x17), .O(new_n89_));
  ...
  aoi21  g53(.a(new_n94_), .b(x19), .c(new_n43_), .O(z13));
  and2   g54(.a(new_n86_), .b(x16), .O(z14));
