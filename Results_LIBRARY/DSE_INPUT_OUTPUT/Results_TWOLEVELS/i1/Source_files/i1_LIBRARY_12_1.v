...
module FAU ( 
  ...
  nor2   g26(.a(new_n67_), .b(new_n65_), .O(z04));
  inv1   g27(.a(x10), .O(new_n69_));
  nor2   g28(.a(new_n65_), .b(new_n69_), .O(z05));
  nor2   g29(.a(new_n54_), .b(new_n43_), .O(z06));
  inv1   g30(.a(x18), .O(new_n72_));
  inv1   g31(.a(new_n65_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x24), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n72_), .O(z07));
  inv1   g34(.a(x11), .O(new_n76_));
  nor2   g35(.a(new_n65_), .b(new_n76_), .O(z08));
  ...
  oai21  g40(.a(new_n81_), .b(new_n79_), .c(new_n73_), .O(z10));
  inv1   g41(.a(x17), .O(new_n83_));
  oai21  g42(.a(new_n81_), .b(new_n83_), .c(new_n73_), .O(z11));
  nand4  g43(.a(new_n73_), .b(new_n80_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand3  g45(.a(new_n80_), .b(x23), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n73_), .O(z13));
  nand2  g47(.a(new_n80_), .b(x16), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n73_), .O(z14));
