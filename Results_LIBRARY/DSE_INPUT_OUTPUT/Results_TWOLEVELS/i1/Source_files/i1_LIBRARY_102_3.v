...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n80_, new_n81_, new_n83_, new_n85_,
  ...
  nor2   g23(.a(new_n64_), .b(x01), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n60_), .c(new_n44_), .O(z02));
  inv1   g25(.a(x20), .O(new_n67_));
  inv1   g26(.a(x01), .O(new_n68_));
  nor2   g27(.a(new_n44_), .b(new_n68_), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n67_), .O(z03));
  nor2   g29(.a(x21), .b(x20), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n69_), .O(z04));
  inv1   g31(.a(x10), .O(new_n73_));
  inv1   g32(.a(x08), .O(new_n74_));
  nand3  g33(.a(new_n58_), .b(x19), .c(new_n74_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n61_), .c(new_n73_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n68_), .O(new_n77_));
  oai21  g36(.a(x19), .b(new_n73_), .c(new_n77_), .O(z05));
  nor2   g37(.a(new_n44_), .b(x01), .O(z06));
  inv1   g38(.a(new_n69_), .O(new_n80_));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n80_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nand2  g42(.a(new_n80_), .b(new_n83_), .O(z08));
  inv1   g43(.a(x24), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z09));
  nand3  g45(.a(new_n85_), .b(x22), .c(x14), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n80_), .O(z10));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n69_), .O(z15));
endmodule
