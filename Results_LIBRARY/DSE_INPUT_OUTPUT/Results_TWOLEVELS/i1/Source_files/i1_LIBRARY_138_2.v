...
module FAU ( 
  ...
  nand4  g47(.a(new_n80_), .b(new_n86_), .c(x22), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  nand4  g49(.a(new_n80_), .b(new_n86_), .c(x23), .d(x14), .O(new_n91_));
  ...
  nand4  g58(.a(new_n99_), .b(new_n80_), .c(new_n98_), .d(new_n97_), .O(z15));
  buf    g59(.a(x20), .O(z03));
endmodule
