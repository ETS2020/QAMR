...
module FAU ( 
  ...
  nand2  g43(.a(new_n84_), .b(new_n77_), .O(z06));
  ...
  nor3   g49(.a(new_n43_), .b(new_n90_), .c(new_n88_), .O(z09));
  nand4  g50(.a(new_n44_), .b(new_n90_), .c(x22), .d(x14), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z10));
  nand3  g52(.a(new_n90_), .b(x22), .c(x17), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(z11));
  inv1   g54(.a(x23), .O(new_n96_));
  nor3   g55(.a(new_n43_), .b(x24), .c(new_n96_), .O(new_n97_));
  ...
  nand2  g61(.a(new_n102_), .b(new_n44_), .O(z14));
  nor2   g62(.a(x13), .b(x12), .O(new_n104_));
  nor2   g63(.a(x15), .b(x14), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n43_), .O(z15));
endmodule
