...
module FAU ( 
  ...
  nor2   g20(.a(x22), .b(new_n42_), .O(new_n62_));
  ...
  nand2  g54(.a(new_n94_), .b(x14), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n43_), .c(new_n44_), .O(z10));
  nand4  g56(.a(new_n94_), .b(x22), .c(new_n43_), .d(x17), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z11));
  nand3  g58(.a(new_n94_), .b(x23), .c(x14), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n46_), .O(z12));
  nand4  g60(.a(new_n46_), .b(new_n94_), .c(x23), .d(x17), .O(new_n102_));
