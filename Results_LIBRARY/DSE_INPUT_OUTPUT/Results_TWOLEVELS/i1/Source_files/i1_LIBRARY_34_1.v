...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n79_, new_n81_, new_n83_, new_n85_, new_n87_,
    new_n88_, new_n90_, new_n92_, new_n95_, new_n96_;
  ...
  nor2   g36(.a(new_n43_), .b(new_n57_), .O(z06));
  ...
  nor2   g45(.a(new_n44_), .b(x24), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x22), .c(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand3  g48(.a(new_n87_), .b(x23), .c(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z12));
  nand3  g50(.a(new_n83_), .b(x23), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n45_), .O(z13));
  and2   g52(.a(new_n87_), .b(x16), .O(z14));
