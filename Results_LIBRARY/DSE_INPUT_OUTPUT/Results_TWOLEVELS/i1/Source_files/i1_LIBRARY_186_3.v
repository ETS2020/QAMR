...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n82_, new_n84_, new_n85_, new_n87_, new_n89_, new_n90_;
  ...
  nand2  g25(.a(new_n56_), .b(new_n44_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x19), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n66_), .O(z05));
  nor2   g28(.a(new_n60_), .b(x08), .O(z06));
  nand3  g29(.a(new_n62_), .b(x24), .c(x18), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nor2   g32(.a(new_n61_), .b(new_n73_), .O(z08));
  nand3  g33(.a(new_n62_), .b(x24), .c(x11), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z09));
  nor2   g35(.a(new_n61_), .b(x24), .O(new_n77_));
  ...
  nand3  g43(.a(new_n84_), .b(x23), .c(x17), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n62_), .O(z13));
