...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x17), .c(new_n42_), .O(z00));
  ...
  oai21  g36(.a(new_n77_), .b(x17), .c(x19), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n76_), .O(z05));
  nor2   g38(.a(new_n58_), .b(x17), .O(z06));
  ...
  nand4  g49(.a(new_n90_), .b(x22), .c(new_n58_), .d(x17), .O(new_n91_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n58_), .c(new_n44_), .O(z13));
