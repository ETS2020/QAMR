...
module FAU ( 
  ...
  nand4  g31(.a(new_n72_), .b(new_n60_), .c(new_n59_), .d(new_n48_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n66_), .c(new_n71_), .O(z05));
  inv1   g33(.a(x18), .O(new_n75_));
  nand2  g34(.a(new_n66_), .b(x24), .O(new_n76_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n82_), .O(new_n83_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n66_), .O(z12));
  nand4  g49(.a(new_n66_), .b(new_n82_), .c(x23), .d(x17), .O(new_n91_));
