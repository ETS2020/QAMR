...
module FAU ( 
  ...
  and2   g19(.a(new_n60_), .b(x00), .O(new_n61_));
  inv1   g20(.a(x04), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n63_));
  ...
  nand2  g27(.a(new_n68_), .b(new_n44_), .O(z02));
  ...
  nand4  g36(.a(new_n77_), .b(new_n76_), .c(new_n75_), .d(new_n51_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n44_), .c(new_n74_), .O(z05));
  nand3  g38(.a(new_n59_), .b(new_n49_), .c(new_n62_), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n82_));
  nor2   g41(.a(new_n60_), .b(new_n42_), .O(new_n83_));
  ...
  nor2   g47(.a(new_n71_), .b(new_n88_), .O(z08));
  ...
  aoi21  g52(.a(new_n93_), .b(x19), .c(new_n91_), .O(z10));
  nand4  g53(.a(new_n44_), .b(new_n92_), .c(x22), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z11));
  nand2  g55(.a(new_n92_), .b(x23), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(x19), .c(new_n91_), .O(z12));
  inv1   g57(.a(x17), .O(new_n99_));
  oai21  g58(.a(new_n97_), .b(new_n99_), .c(new_n44_), .O(z13));
  inv1   g59(.a(x16), .O(new_n101_));
  nor3   g60(.a(new_n71_), .b(x24), .c(new_n101_), .O(z14));
