...
module FAU ( 
  ...
  nand2  g28(.a(new_n43_), .b(x19), .O(new_n70_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n62_), .c(x23), .O(new_n78_));
  ...
  nand2  g42(.a(new_n83_), .b(new_n70_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n72_), .b(new_n85_), .O(z08));
  inv1   g45(.a(x24), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n70_), .O(z09));
  nand3  g47(.a(new_n87_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n70_), .O(z10));
  nand4  g49(.a(new_n70_), .b(new_n87_), .c(x22), .d(x17), .O(new_n91_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n70_), .O(z13));
  nand2  g55(.a(new_n87_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n70_), .O(z14));
