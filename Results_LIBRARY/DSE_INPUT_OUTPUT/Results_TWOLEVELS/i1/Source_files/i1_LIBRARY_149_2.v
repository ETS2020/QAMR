...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n65_), .c(new_n64_), .d(new_n51_), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n61_), .c(new_n43_), .O(z02));
  ...
  nand4  g34(.a(new_n65_), .b(x19), .c(new_n66_), .d(new_n51_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n63_), .c(new_n75_), .O(z05));
  nand4  g36(.a(new_n59_), .b(new_n49_), .c(new_n62_), .d(new_n48_), .O(new_n78_));
  nor2   g37(.a(new_n78_), .b(x02), .O(new_n79_));
  nand4  g38(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(x00), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(new_n46_), .c(new_n80_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n43_), .c(new_n44_), .O(z06));
  ...
  nor3   g46(.a(new_n72_), .b(new_n87_), .c(new_n85_), .O(z09));
  inv1   g47(.a(x22), .O(new_n89_));
  nand2  g48(.a(x19), .b(x14), .O(new_n90_));
  nor3   g49(.a(new_n90_), .b(x24), .c(new_n89_), .O(z10));
  nand3  g50(.a(new_n87_), .b(x22), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n44_), .O(z11));
  inv1   g52(.a(x23), .O(new_n94_));
  nor3   g53(.a(new_n90_), .b(x24), .c(new_n94_), .O(z12));
  nand4  g54(.a(new_n44_), .b(new_n87_), .c(x23), .d(x17), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z13));
  inv1   g56(.a(x16), .O(new_n98_));
  nor3   g57(.a(new_n72_), .b(x24), .c(new_n98_), .O(z14));
  nor3   g58(.a(x15), .b(x13), .c(x12), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(x14), .c(new_n90_), .O(z15));
endmodule
