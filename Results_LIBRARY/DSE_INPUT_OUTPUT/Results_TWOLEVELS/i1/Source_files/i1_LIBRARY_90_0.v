...
module FAU ( 
  ...
  nand4  g36(.a(new_n62_), .b(new_n49_), .c(new_n60_), .d(new_n48_), .O(new_n78_));
  nor3   g37(.a(new_n78_), .b(x02), .c(x01), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(new_n63_), .c(new_n42_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n59_), .c(new_n44_), .O(z06));
  ...
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z09));
  nand2  g46(.a(x22), .b(x14), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(x19), .c(x24), .O(z10));
  nand3  g48(.a(x22), .b(x19), .c(x17), .O(new_n90_));
  nor2   g49(.a(new_n90_), .b(x24), .O(z11));
  nand3  g50(.a(x23), .b(x19), .c(x14), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(x24), .O(z12));
  nand2  g52(.a(x23), .b(x17), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(x19), .c(x24), .O(z13));
  nand2  g54(.a(x19), .b(x16), .O(new_n96_));
  nor2   g55(.a(new_n96_), .b(x24), .O(z14));
