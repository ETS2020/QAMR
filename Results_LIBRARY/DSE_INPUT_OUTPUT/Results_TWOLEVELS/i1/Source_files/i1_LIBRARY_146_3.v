...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n58_, new_n61_, new_n62_, new_n64_, new_n65_, new_n66_, new_n68_,
  ...
  and2   g18(.a(new_n43_), .b(x20), .O(z03));
  ...
  nand2  g29(.a(x24), .b(x11), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n43_), .O(z09));
  nor2   g31(.a(new_n61_), .b(x24), .O(new_n73_));
  ...
  nand3  g36(.a(new_n73_), .b(x23), .c(x14), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z12));
  nand3  g38(.a(new_n73_), .b(x23), .c(x17), .O(new_n80_));
  inv1   g39(.a(new_n80_), .O(z13));
  nand2  g40(.a(new_n73_), .b(x16), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z14));
  inv1   g42(.a(x12), .O(new_n84_));
  inv1   g43(.a(x13), .O(new_n85_));
  nor2   g44(.a(x15), .b(x14), .O(new_n86_));
  nand4  g45(.a(new_n86_), .b(new_n43_), .c(new_n85_), .d(new_n84_), .O(z15));
  buf    g46(.a(x19), .O(z06));
endmodule
