...
module FAU ( 
  ...
  aoi21  g25(.a(new_n60_), .b(x00), .c(new_n66_), .O(new_n67_));
  oai21  g26(.a(new_n67_), .b(new_n43_), .c(new_n44_), .O(z02));
  inv1   g27(.a(x20), .O(new_n69_));
  nand2  g28(.a(new_n44_), .b(new_n69_), .O(z03));
  inv1   g29(.a(x21), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n69_), .O(z04));
  ...
  nand4  g35(.a(new_n59_), .b(new_n49_), .c(new_n61_), .d(new_n48_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(x02), .O(new_n78_));
  nand4  g37(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(x00), .O(new_n79_));
  aoi21  g38(.a(new_n78_), .b(new_n46_), .c(new_n79_), .O(new_n80_));
  ...
  nand4  g61(.a(new_n102_), .b(new_n44_), .c(new_n101_), .d(new_n100_), .O(z15));
endmodule
