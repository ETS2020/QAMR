...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x14), .c(new_n42_), .O(z00));
  ...
  nor2   g13(.a(x14), .b(new_n42_), .O(new_n55_));
  ...
  nand2  g32(.a(x19), .b(x14), .O(new_n74_));
  ...
  nand4  g48(.a(new_n89_), .b(x22), .c(new_n44_), .d(x14), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z10));
  nand4  g50(.a(new_n74_), .b(new_n89_), .c(x22), .d(x17), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z11));
  nand4  g52(.a(new_n89_), .b(x23), .c(new_n44_), .d(x14), .O(new_n94_));
  ...
  oai21  g57(.a(x24), .b(new_n98_), .c(new_n74_), .O(z14));
