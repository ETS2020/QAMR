...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n94_, new_n95_, new_n97_, new_n99_, new_n102_, new_n104_,
    new_n105_;
  ...
  nand4  g35(.a(new_n48_), .b(new_n60_), .c(new_n47_), .d(new_n46_), .O(new_n77_));
  nand3  g36(.a(new_n62_), .b(x19), .c(new_n68_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  oai21  g39(.a(new_n43_), .b(new_n76_), .c(new_n80_), .O(z05));
  nand3  g40(.a(new_n62_), .b(new_n48_), .c(new_n60_), .O(new_n82_));
  ...
  nand2  g46(.a(new_n58_), .b(x24), .O(new_n88_));
  ...
  oai21  g54(.a(new_n95_), .b(new_n93_), .c(new_n58_), .O(z10));
  inv1   g55(.a(x17), .O(new_n97_));
  oai21  g56(.a(new_n95_), .b(new_n97_), .c(new_n58_), .O(z11));
  nand2  g57(.a(new_n94_), .b(x23), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n93_), .c(new_n58_), .O(z12));
  oai21  g59(.a(new_n99_), .b(new_n97_), .c(new_n58_), .O(z13));
  inv1   g60(.a(x16), .O(new_n102_));
  nor3   g61(.a(new_n57_), .b(x24), .c(new_n102_), .O(z14));
  nor2   g62(.a(x13), .b(x12), .O(new_n104_));
  nor2   g63(.a(x15), .b(x14), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n57_), .O(z15));
endmodule
