...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(x19), .c(x12), .O(new_n58_));
  ...
  nand4  g38(.a(new_n62_), .b(x19), .c(x12), .d(new_n70_), .O(new_n80_));
  ...
  nand4  g67(.a(new_n108_), .b(new_n43_), .c(new_n107_), .d(new_n65_), .O(z15));
endmodule
