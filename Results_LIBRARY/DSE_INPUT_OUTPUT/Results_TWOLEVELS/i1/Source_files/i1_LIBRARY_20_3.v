// Benchmark "FAU" written by ABC on Wed Aug 19 17:33:59 2020
...
module FAU ( 
  ...
  aoi21  g31(.a(new_n72_), .b(new_n69_), .c(x10), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n65_), .c(new_n44_), .O(z02));
  inv1   g33(.a(x20), .O(new_n75_));
  nor2   g34(.a(new_n45_), .b(new_n75_), .O(z03));
  inv1   g35(.a(x21), .O(new_n77_));
  nand3  g36(.a(new_n46_), .b(new_n77_), .c(new_n75_), .O(z04));
  nand3  g37(.a(new_n66_), .b(new_n62_), .c(new_n50_), .O(new_n79_));
  nand4  g38(.a(new_n63_), .b(x19), .c(new_n43_), .d(new_n70_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(x19), .d(new_n43_), .O(z05));
  oai21  g40(.a(x09), .b(new_n70_), .c(x10), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n83_));
  nor2   g42(.a(new_n83_), .b(x04), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n85_));
  nor3   g44(.a(new_n64_), .b(x10), .c(new_n42_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n44_), .O(z06));
  nand3  g46(.a(new_n46_), .b(x24), .c(x18), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nor2   g49(.a(new_n45_), .b(new_n90_), .O(z08));
  inv1   g50(.a(x24), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n90_), .c(new_n46_), .O(z09));
  nand4  g52(.a(new_n46_), .b(new_n92_), .c(x22), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z10));
  nand3  g54(.a(new_n92_), .b(x22), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n46_), .O(z11));
  inv1   g56(.a(x14), .O(new_n98_));
  nand2  g57(.a(new_n92_), .b(x23), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n98_), .c(new_n46_), .O(z12));
  inv1   g59(.a(x17), .O(new_n101_));
  oai21  g60(.a(new_n99_), .b(new_n101_), .c(new_n46_), .O(z13));
  ...
  nand4  g66(.a(new_n107_), .b(new_n46_), .c(new_n106_), .d(new_n105_), .O(z15));
endmodule
