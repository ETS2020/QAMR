...
module FAU ( 
  ...
  nand4  g32(.a(x19), .b(new_n64_), .c(new_n52_), .d(new_n51_), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n63_), .c(new_n73_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  oai21  g35(.a(new_n47_), .b(new_n73_), .c(new_n76_), .O(z05));
  nor2   g36(.a(x07), .b(x06), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n51_), .c(new_n62_), .d(new_n50_), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x02), .O(new_n80_));
  nand3  g39(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n81_));
  aoi21  g40(.a(new_n80_), .b(new_n48_), .c(new_n81_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n47_), .c(new_n58_), .O(z06));
