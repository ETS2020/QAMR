...
module FAU ( 
  ...
  nand4  g26(.a(new_n67_), .b(new_n65_), .c(new_n64_), .d(new_n63_), .O(new_n68_));
  ...
  aoi22  g33(.a(new_n74_), .b(new_n72_), .c(x19), .d(x01), .O(z04));
  inv1   g34(.a(x10), .O(new_n76_));
  nor2   g35(.a(x08), .b(x07), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n59_), .c(new_n50_), .d(new_n49_), .O(new_n78_));
  ...
  nand3  g41(.a(new_n82_), .b(x08), .c(x01), .O(new_n83_));
  ...
  nand4  g45(.a(new_n60_), .b(new_n59_), .c(new_n58_), .d(x00), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n45_), .O(z06));
  nand2  g48(.a(x24), .b(x18), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n43_), .O(z07));
  inv1   g50(.a(x11), .O(new_n92_));
  nand2  g51(.a(new_n43_), .b(new_n92_), .O(z08));
  inv1   g52(.a(x24), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n92_), .c(new_n43_), .O(z09));
  inv1   g54(.a(x14), .O(new_n96_));
  nand2  g55(.a(new_n94_), .b(x22), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n96_), .c(new_n43_), .O(z10));
  inv1   g57(.a(x17), .O(new_n99_));
  oai21  g58(.a(new_n97_), .b(new_n99_), .c(new_n43_), .O(z11));
  nand4  g59(.a(new_n43_), .b(new_n94_), .c(x23), .d(x14), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z12));
  nand3  g61(.a(new_n94_), .b(x23), .c(x17), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n43_), .O(z13));
  nand3  g63(.a(new_n43_), .b(new_n94_), .c(x16), .O(new_n105_));
