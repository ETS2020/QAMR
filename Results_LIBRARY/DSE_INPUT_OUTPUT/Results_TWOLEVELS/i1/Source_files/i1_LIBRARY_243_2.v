...
module FAU ( 
  ...
  nor3   g46(.a(new_n78_), .b(x24), .c(new_n87_), .O(new_n88_));
  ...
  nor3   g53(.a(x15), .b(x14), .c(x13), .O(new_n95_));
  nand2  g54(.a(x19), .b(x12), .O(new_n96_));
  oai21  g55(.a(new_n95_), .b(x12), .c(new_n96_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
