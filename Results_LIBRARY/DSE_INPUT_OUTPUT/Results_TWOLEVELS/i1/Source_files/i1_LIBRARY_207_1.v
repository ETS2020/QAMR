...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n50_, new_n52_,
    ...
    new_n67_, new_n69_, new_n72_, new_n74_, new_n75_, new_n76_;
  ...
  and2   g14(.a(x05), .b(x00), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n42_), .c(new_n48_), .O(z06));
  nand2  g16(.a(x24), .b(x18), .O(new_n58_));
  nand2  g17(.a(new_n58_), .b(new_n44_), .O(z07));
  inv1   g18(.a(x11), .O(new_n60_));
  aoi21  g19(.a(x19), .b(new_n43_), .c(new_n60_), .O(z08));
