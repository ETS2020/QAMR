...
module FAU ( 
  ...
  nand3  g34(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n63_), .b(new_n64_), .c(new_n50_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n62_), .c(new_n44_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n77_), .O(z05));
  nand2  g40(.a(x24), .b(x18), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n75_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nor2   g43(.a(new_n72_), .b(new_n84_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n75_), .O(z09));
  nand3  g46(.a(new_n86_), .b(x22), .c(x14), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n75_), .O(z10));
  nand4  g48(.a(new_n75_), .b(new_n86_), .c(x22), .d(x17), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z11));
  inv1   g50(.a(x14), .O(new_n92_));
  nand2  g51(.a(new_n86_), .b(x23), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n92_), .c(new_n75_), .O(z12));
  inv1   g53(.a(x17), .O(new_n95_));
  oai21  g54(.a(new_n93_), .b(new_n95_), .c(new_n75_), .O(z13));
  nand3  g55(.a(new_n75_), .b(new_n86_), .c(x16), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z14));
  nor3   g57(.a(x14), .b(x13), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n71_), .b(x15), .O(new_n100_));
  oai21  g59(.a(new_n99_), .b(x15), .c(new_n100_), .O(z15));
  buf    g60(.a(x19), .O(z06));
endmodule
