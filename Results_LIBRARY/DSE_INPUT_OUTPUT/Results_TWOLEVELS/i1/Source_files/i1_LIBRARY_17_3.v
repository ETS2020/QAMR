...
module FAU ( 
  ...
  nand3  g24(.a(new_n62_), .b(new_n65_), .c(new_n61_), .O(z04));
  ...
  nand3  g35(.a(new_n62_), .b(new_n75_), .c(x22), .O(new_n77_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n62_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n62_), .O(z13));
  nand3  g46(.a(new_n62_), .b(new_n75_), .c(x16), .O(new_n88_));
