...
module FAU ( 
  ...
  nand4  g20(.a(new_n61_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n62_));
  nor2   g21(.a(x06), .b(x05), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(new_n53_), .c(new_n51_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n62_), .c(x19), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(x08), .O(new_n66_));
  nor3   g25(.a(x03), .b(x02), .c(x01), .O(new_n67_));
  nor2   g26(.a(x07), .b(x06), .O(new_n68_));
  nand4  g27(.a(new_n68_), .b(new_n67_), .c(new_n49_), .d(new_n61_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x19), .c(x00), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n66_), .O(z02));
  ...
  nand3  g37(.a(new_n63_), .b(x19), .c(new_n51_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n62_), .c(new_n77_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n43_), .O(new_n81_));
  oai21  g40(.a(new_n78_), .b(new_n77_), .c(new_n81_), .O(z05));
  nand2  g41(.a(new_n78_), .b(new_n43_), .O(z06));
  nand2  g42(.a(x24), .b(x18), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n73_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n73_), .b(new_n86_), .O(z08));
  inv1   g46(.a(x24), .O(new_n88_));
  oai21  g47(.a(new_n88_), .b(new_n86_), .c(new_n73_), .O(z09));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n88_), .b(x22), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n73_), .O(z10));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n73_), .O(z11));
  ...
  nand2  g60(.a(new_n101_), .b(new_n73_), .O(z14));
