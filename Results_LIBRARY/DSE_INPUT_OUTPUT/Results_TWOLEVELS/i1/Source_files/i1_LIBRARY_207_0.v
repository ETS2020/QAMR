...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n96_, new_n99_, new_n101_, new_n102_;
  ...
  nand4  g32(.a(new_n73_), .b(new_n65_), .c(new_n51_), .d(new_n58_), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(x19), .c(x05), .O(new_n75_));
  or2    g34(.a(new_n75_), .b(x10), .O(z05));
  nand3  g35(.a(new_n46_), .b(x09), .c(x08), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n52_), .c(new_n51_), .d(new_n58_), .O(new_n78_));
  ...
  oai21  g55(.a(new_n96_), .b(new_n91_), .c(new_n44_), .O(z12));
  oai21  g56(.a(new_n96_), .b(new_n94_), .c(new_n44_), .O(z13));
