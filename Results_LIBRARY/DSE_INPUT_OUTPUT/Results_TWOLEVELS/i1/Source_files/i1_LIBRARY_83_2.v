...
module FAU ( 
  ...
  nand4  g22(.a(new_n63_), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n61_), .c(x11), .O(new_n65_));
  ...
  oai21  g38(.a(new_n76_), .b(new_n75_), .c(new_n79_), .O(z05));
  nor2   g39(.a(new_n44_), .b(new_n62_), .O(z06));
  inv1   g40(.a(x18), .O(new_n82_));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n44_), .b(new_n83_), .c(new_n82_), .O(z07));
  nand2  g43(.a(new_n76_), .b(new_n43_), .O(z08));
  oai21  g44(.a(new_n83_), .b(new_n76_), .c(new_n45_), .O(z09));
  nand4  g45(.a(new_n45_), .b(new_n83_), .c(x22), .d(x14), .O(new_n87_));
