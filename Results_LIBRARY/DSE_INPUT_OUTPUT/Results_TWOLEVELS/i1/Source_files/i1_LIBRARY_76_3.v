...
module FAU ( 
  ...
  nor2   g14(.a(x20), .b(new_n42_), .O(new_n56_));
  ...
  nand3  g29(.a(new_n70_), .b(new_n58_), .c(x19), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z02));
  nor2   g31(.a(new_n58_), .b(x19), .O(z03));
  inv1   g32(.a(x21), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n58_), .O(z04));
  ...
  nand3  g40(.a(x20), .b(new_n81_), .c(x08), .O(new_n82_));
  ...
  nor3   g44(.a(new_n62_), .b(x20), .c(new_n42_), .O(new_n86_));
  ...
  aoi21  g52(.a(x20), .b(x19), .c(x24), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x22), .O(new_n95_));
  ...
  nand2  g59(.a(new_n94_), .b(x23), .O(new_n101_));
