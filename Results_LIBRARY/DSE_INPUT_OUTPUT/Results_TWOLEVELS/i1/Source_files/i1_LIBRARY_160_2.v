...
module FAU ( 
  ...
  nand4  g34(.a(new_n75_), .b(new_n60_), .c(new_n74_), .d(new_n51_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(new_n44_), .c(new_n73_), .O(z05));
  nand3  g36(.a(new_n65_), .b(new_n49_), .c(new_n57_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n80_));
  nor2   g39(.a(new_n66_), .b(new_n42_), .O(new_n81_));
  ...
  nand4  g52(.a(new_n44_), .b(new_n89_), .c(x23), .d(x14), .O(new_n94_));
  ...
  nor3   g59(.a(new_n70_), .b(x13), .c(x12), .O(new_n101_));
