...
module FAU ( 
  ...
  nand4  g34(.a(new_n75_), .b(new_n64_), .c(new_n63_), .d(new_n51_), .O(new_n76_));
  ...
  nand3  g41(.a(x24), .b(x19), .c(x18), .O(new_n83_));
  ...
  nand4  g53(.a(new_n44_), .b(new_n87_), .c(x23), .d(x14), .O(new_n95_));
