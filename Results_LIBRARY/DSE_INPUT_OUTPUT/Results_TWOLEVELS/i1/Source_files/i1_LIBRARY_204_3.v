...
module FAU ( 
  ...
  nand4  g36(.a(x19), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n62_), .c(new_n77_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n43_), .O(new_n80_));
  oai21  g39(.a(x11), .b(new_n77_), .c(new_n80_), .O(z05));
  nor2   g40(.a(new_n45_), .b(new_n63_), .O(z06));
  nand3  g41(.a(new_n46_), .b(x24), .c(x18), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(z07));
  nor2   g43(.a(new_n44_), .b(x08), .O(z08));
  nand2  g44(.a(z08), .b(x24), .O(new_n86_));
  ...
  nand2  g51(.a(new_n92_), .b(new_n46_), .O(z11));
