...
module FAU ( 
  ...
  nand4  g25(.a(new_n66_), .b(new_n62_), .c(new_n45_), .d(new_n49_), .O(new_n67_));
  ...
  nand4  g33(.a(new_n74_), .b(new_n66_), .c(new_n50_), .d(new_n49_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x19), .c(x05), .O(new_n76_));
  ...
  nand2  g45(.a(new_n79_), .b(new_n86_), .O(new_n87_));
  nor2   g46(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  ...
  nand4  g51(.a(new_n79_), .b(new_n86_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n86_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n79_), .O(z13));
