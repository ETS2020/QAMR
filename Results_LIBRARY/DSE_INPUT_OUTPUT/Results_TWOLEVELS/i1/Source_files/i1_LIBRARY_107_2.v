...
module FAU ( 
  ...
  oai22  g36(.a(new_n77_), .b(new_n66_), .c(new_n44_), .d(new_n76_), .O(z05));
  nand4  g37(.a(new_n63_), .b(new_n50_), .c(new_n62_), .d(new_n49_), .O(new_n79_));
  nor3   g38(.a(new_n79_), .b(x02), .c(x01), .O(new_n80_));
  nand2  g39(.a(new_n65_), .b(x00), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(x19), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n45_), .O(z06));
  ...
  oai21  g56(.a(new_n97_), .b(new_n96_), .c(new_n45_), .O(z12));
  inv1   g57(.a(x17), .O(new_n99_));
  oai21  g58(.a(new_n97_), .b(new_n99_), .c(new_n45_), .O(z13));
  nand2  g59(.a(new_n85_), .b(x16), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n45_), .O(z14));
  inv1   g61(.a(x12), .O(new_n103_));
  inv1   g62(.a(x15), .O(new_n104_));
  nand4  g63(.a(new_n104_), .b(new_n96_), .c(new_n43_), .d(new_n103_), .O(z15));
endmodule
