...
module FAU ( 
  ...
  nand3  g31(.a(new_n64_), .b(x19), .c(new_n51_), .O(new_n73_));
  ...
  nand3  g36(.a(new_n59_), .b(new_n49_), .c(new_n57_), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n80_));
  nor2   g39(.a(new_n60_), .b(new_n42_), .O(new_n81_));
  ...
  nor2   g44(.a(new_n70_), .b(new_n85_), .O(z08));
  ...
  nor3   g58(.a(new_n70_), .b(x13), .c(x12), .O(new_n100_));
