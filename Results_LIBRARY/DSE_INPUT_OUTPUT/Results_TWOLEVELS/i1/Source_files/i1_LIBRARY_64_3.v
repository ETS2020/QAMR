...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n66_), .O(z09));
  nand4  g39(.a(new_n66_), .b(new_n79_), .c(x22), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  nand3  g41(.a(new_n79_), .b(x22), .c(x17), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n66_), .O(z11));
  inv1   g43(.a(x14), .O(new_n85_));
  nand2  g44(.a(new_n79_), .b(x23), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n85_), .c(new_n66_), .O(z12));
  inv1   g46(.a(x17), .O(new_n88_));
  oai21  g47(.a(new_n86_), .b(new_n88_), .c(new_n66_), .O(z13));
  ...
  nand4  g53(.a(new_n94_), .b(new_n66_), .c(new_n93_), .d(new_n92_), .O(z15));
  buf    g54(.a(x19), .O(z06));
endmodule
