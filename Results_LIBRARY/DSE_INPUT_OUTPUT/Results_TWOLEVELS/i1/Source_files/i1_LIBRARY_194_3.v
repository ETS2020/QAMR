...
module FAU ( 
  ...
  nand4  g39(.a(new_n43_), .b(new_n78_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand4  g41(.a(new_n43_), .b(new_n78_), .c(x23), .d(x14), .O(new_n83_));
  ...
  nand4  g50(.a(new_n91_), .b(new_n43_), .c(new_n90_), .d(new_n89_), .O(z15));
endmodule
