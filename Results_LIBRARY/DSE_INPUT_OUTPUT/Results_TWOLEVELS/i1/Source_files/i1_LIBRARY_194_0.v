...
module FAU ( 
  ...
  nand2  g46(.a(new_n44_), .b(x24), .O(new_n88_));
  nor2   g47(.a(new_n88_), .b(new_n87_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  nand2  g49(.a(new_n44_), .b(new_n90_), .O(z08));
  nor2   g50(.a(new_n88_), .b(new_n90_), .O(z09));
  ...
  nand4  g56(.a(new_n44_), .b(new_n93_), .c(x23), .d(x14), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z12));
  nand3  g58(.a(new_n93_), .b(x23), .c(x17), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(z13));
