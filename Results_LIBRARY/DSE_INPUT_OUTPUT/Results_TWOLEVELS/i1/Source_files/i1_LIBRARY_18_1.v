...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n75_, new_n76_, new_n77_, new_n78_, new_n79_, new_n82_, new_n85_,
  ...
  aoi21  g27(.a(new_n68_), .b(new_n65_), .c(new_n57_), .O(new_n69_));
  ...
  nand2  g42(.a(new_n43_), .b(new_n57_), .O(z08));
  inv1   g43(.a(x24), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n57_), .c(new_n45_), .O(z09));
