...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n65_, new_n66_, new_n67_, new_n69_, new_n72_, new_n75_, new_n76_,
    new_n78_, new_n81_, new_n83_, new_n85_, new_n87_, new_n89_, new_n91_,
    new_n92_;
  ...
  aoi21  g30(.a(new_n61_), .b(x19), .c(x08), .O(new_n72_));
  or2    g31(.a(new_n72_), .b(x10), .O(z05));
  nand2  g32(.a(new_n45_), .b(x08), .O(z06));
  inv1   g33(.a(x18), .O(new_n75_));
  inv1   g34(.a(x24), .O(new_n76_));
  nor3   g35(.a(new_n43_), .b(new_n76_), .c(new_n75_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nor2   g37(.a(new_n43_), .b(new_n78_), .O(z08));
  oai21  g38(.a(new_n76_), .b(new_n78_), .c(new_n57_), .O(z09));
  nand4  g39(.a(new_n57_), .b(new_n76_), .c(x22), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  nand3  g41(.a(new_n76_), .b(x22), .c(x17), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n57_), .O(z11));
  nand3  g43(.a(new_n76_), .b(x23), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n57_), .O(z12));
  nand4  g45(.a(new_n57_), .b(new_n76_), .c(x23), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z13));
  nand2  g47(.a(new_n76_), .b(x16), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n57_), .O(z14));
