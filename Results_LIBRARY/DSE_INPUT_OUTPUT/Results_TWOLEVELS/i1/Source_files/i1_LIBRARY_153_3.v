...
module FAU ( 
  ...
  oai21  g39(.a(x09), .b(new_n76_), .c(x06), .O(new_n81_));
  nand4  g40(.a(new_n81_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n84_));
  nor3   g43(.a(new_n63_), .b(x06), .c(new_n42_), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n44_), .O(z06));
  nand2  g45(.a(x24), .b(x18), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n46_), .O(z07));
  inv1   g47(.a(x11), .O(new_n89_));
  nor2   g48(.a(new_n45_), .b(new_n89_), .O(z08));
  nand3  g49(.a(new_n46_), .b(x24), .c(x11), .O(new_n91_));
