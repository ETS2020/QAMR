...
module FAU ( 
  ...
  nor2   g24(.a(new_n65_), .b(new_n44_), .O(new_n66_));
  inv1   g25(.a(new_n66_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n64_), .O(z03));
  nor2   g27(.a(x21), .b(x20), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n66_), .O(z04));
  inv1   g29(.a(x10), .O(new_n71_));
  nand4  g30(.a(x19), .b(new_n52_), .c(new_n51_), .d(new_n50_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(new_n49_), .c(new_n71_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n44_), .O(new_n74_));
  nand2  g33(.a(new_n65_), .b(x10), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(z05));
  nand3  g35(.a(new_n67_), .b(x24), .c(x18), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z07));
  inv1   g37(.a(x11), .O(new_n79_));
  nor2   g38(.a(new_n66_), .b(new_n79_), .O(z08));
  nand3  g39(.a(new_n67_), .b(x24), .c(x11), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z09));
  inv1   g41(.a(x24), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x22), .c(x14), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n67_), .O(z10));
  nand4  g44(.a(new_n67_), .b(new_n83_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  inv1   g46(.a(x14), .O(new_n88_));
  nand2  g47(.a(new_n83_), .b(x23), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(new_n67_), .O(z12));
  inv1   g49(.a(x17), .O(new_n91_));
  oai21  g50(.a(new_n89_), .b(new_n91_), .c(new_n67_), .O(z13));
  nand3  g51(.a(new_n67_), .b(new_n83_), .c(x16), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z14));
  inv1   g53(.a(x12), .O(new_n95_));
  inv1   g54(.a(x13), .O(new_n96_));
  nor2   g55(.a(x15), .b(x14), .O(new_n97_));
  nand4  g56(.a(new_n97_), .b(new_n67_), .c(new_n96_), .d(new_n95_), .O(z15));
  buf    g57(.a(x19), .O(z06));
endmodule
