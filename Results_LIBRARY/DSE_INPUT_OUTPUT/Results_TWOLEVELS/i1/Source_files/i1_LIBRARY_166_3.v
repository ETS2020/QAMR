...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n73_, new_n75_, new_n76_, new_n78_, new_n80_, new_n81_, new_n82_,
  ...
  nand4  g36(.a(new_n66_), .b(x19), .c(new_n67_), .d(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n64_), .c(new_n45_), .O(z05));
  ...
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n67_), .d(new_n51_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n45_), .O(new_n85_));
  and2   g44(.a(new_n85_), .b(x19), .O(z06));
  nand2  g45(.a(x24), .b(x18), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n43_), .O(z07));
  and2   g47(.a(new_n43_), .b(x11), .O(z08));
  nand3  g48(.a(new_n43_), .b(x24), .c(x11), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z09));
  inv1   g50(.a(x24), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x22), .c(x14), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n43_), .O(z10));
  nand4  g53(.a(new_n43_), .b(new_n92_), .c(x22), .d(x17), .O(new_n95_));
