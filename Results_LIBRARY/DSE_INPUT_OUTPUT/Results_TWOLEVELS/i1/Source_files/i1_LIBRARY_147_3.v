...
module FAU ( 
  ...
  oai21  g35(.a(new_n75_), .b(x06), .c(new_n76_), .O(z05));
  nor2   g36(.a(new_n44_), .b(x06), .O(z06));
  nand2  g37(.a(x24), .b(x18), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n68_), .O(z07));
  and2   g39(.a(new_n68_), .b(x11), .O(z08));
  nand3  g40(.a(new_n68_), .b(x24), .c(x11), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z09));
  inv1   g42(.a(x24), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x22), .c(x14), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n68_), .O(z10));
  nand4  g45(.a(new_n68_), .b(new_n84_), .c(x22), .d(x17), .O(new_n87_));
  inv1   g46(.a(new_n87_), .O(z11));
  inv1   g47(.a(x14), .O(new_n89_));
  nand2  g48(.a(new_n84_), .b(x23), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n89_), .c(new_n68_), .O(z12));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n68_), .O(z13));
  nand3  g52(.a(new_n68_), .b(new_n84_), .c(x16), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z14));
  inv1   g54(.a(x12), .O(new_n96_));
  inv1   g55(.a(x13), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  nand4  g57(.a(new_n98_), .b(new_n68_), .c(new_n97_), .d(new_n96_), .O(z15));
endmodule
