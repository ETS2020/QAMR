...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(new_n62_), .c(x23), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n60_), .c(new_n44_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nand2  g27(.a(x23), .b(x19), .O(new_n69_));
  ...
  nand3  g35(.a(new_n76_), .b(new_n49_), .c(new_n48_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n61_), .c(new_n75_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x19), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n74_), .O(z05));
  nor2   g39(.a(x23), .b(x00), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(x00), .c(new_n44_), .O(z06));
  nand2  g41(.a(x24), .b(x18), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n69_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n71_), .b(new_n85_), .O(z08));
  inv1   g45(.a(x24), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n69_), .O(z09));
  nand3  g47(.a(new_n87_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n69_), .O(z10));
  nand4  g49(.a(new_n69_), .b(new_n87_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand4  g51(.a(new_n87_), .b(x23), .c(new_n44_), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand2  g53(.a(new_n87_), .b(x17), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n44_), .c(new_n75_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  oai21  g56(.a(x24), .b(new_n97_), .c(new_n69_), .O(z14));
