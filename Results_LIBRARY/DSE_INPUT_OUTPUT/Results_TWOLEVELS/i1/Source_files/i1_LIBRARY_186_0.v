...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n87_, new_n89_, new_n91_, new_n92_, new_n95_, new_n96_;
  ...
  aoi21  g28(.a(new_n69_), .b(new_n63_), .c(new_n58_), .O(z02));
  ...
  aoi21  g34(.a(new_n62_), .b(x19), .c(x08), .O(new_n76_));
  or2    g35(.a(new_n76_), .b(x10), .O(z05));
  inv1   g36(.a(x18), .O(new_n78_));
  nand2  g37(.a(new_n72_), .b(x24), .O(new_n79_));
  ...
  nor2   g42(.a(new_n43_), .b(x24), .O(new_n84_));
