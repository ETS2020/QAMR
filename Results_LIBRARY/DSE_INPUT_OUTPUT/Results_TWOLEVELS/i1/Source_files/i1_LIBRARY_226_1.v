...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n88_, new_n89_, new_n90_, new_n92_, new_n96_,
    new_n98_, new_n99_;
  ...
  nand3  g32(.a(new_n43_), .b(new_n73_), .c(new_n72_), .O(z04));
  ...
  nand3  g38(.a(new_n79_), .b(new_n45_), .c(new_n75_), .O(z05));
  ...
  nor4   g52(.a(x24), .b(new_n43_), .c(new_n72_), .d(new_n88_), .O(z12));
  nor4   g53(.a(x24), .b(new_n43_), .c(new_n72_), .d(new_n92_), .O(z13));
