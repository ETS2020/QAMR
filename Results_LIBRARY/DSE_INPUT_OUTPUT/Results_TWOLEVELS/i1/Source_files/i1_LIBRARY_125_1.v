...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n86_, new_n89_, new_n91_, new_n93_, new_n95_, new_n98_,
    new_n99_;
  ...
  nor2   g28(.a(new_n45_), .b(x16), .O(new_n70_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n62_), .c(x16), .O(new_n77_));
  ...
  nor3   g42(.a(new_n70_), .b(new_n83_), .c(new_n82_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  inv1   g44(.a(new_n70_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(z08));
  oai21  g46(.a(new_n83_), .b(new_n85_), .c(new_n86_), .O(z09));
  nand3  g47(.a(new_n83_), .b(x22), .c(x14), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n86_), .O(z10));
  nand4  g49(.a(new_n86_), .b(new_n83_), .c(x22), .d(x17), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z11));
  nand4  g51(.a(new_n86_), .b(new_n83_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n83_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n86_), .O(z13));
  oai21  g55(.a(x24), .b(new_n43_), .c(new_n86_), .O(z14));
