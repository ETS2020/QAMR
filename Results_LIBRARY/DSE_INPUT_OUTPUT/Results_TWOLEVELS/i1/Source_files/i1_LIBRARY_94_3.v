...
module FAU ( 
  ...
  nand3  g28(.a(new_n46_), .b(new_n69_), .c(new_n67_), .O(z04));
  ...
  nand4  g43(.a(new_n46_), .b(new_n84_), .c(x22), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z10));
  nand3  g45(.a(new_n84_), .b(x22), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n46_), .O(z11));
  ...
  nand3  g52(.a(new_n46_), .b(new_n84_), .c(x16), .O(new_n94_));
