...
module FAU ( 
  ...
  nor2   g20(.a(x07), .b(x05), .O(new_n62_));
  nand4  g21(.a(new_n62_), .b(new_n61_), .c(new_n51_), .d(new_n48_), .O(new_n63_));
  ...
  nor2   g27(.a(new_n68_), .b(x06), .O(new_n69_));
  ...
  nand3  g34(.a(new_n62_), .b(x19), .c(new_n75_), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n65_), .c(new_n74_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  oai21  g37(.a(x19), .b(new_n74_), .c(new_n78_), .O(z05));
  oai21  g38(.a(x09), .b(new_n75_), .c(x06), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n83_));
  nor3   g42(.a(new_n63_), .b(x06), .c(new_n42_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n44_), .O(z06));
  nand3  g44(.a(new_n46_), .b(x24), .c(x18), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z07));
  inv1   g46(.a(x11), .O(new_n88_));
  nor2   g47(.a(new_n45_), .b(new_n88_), .O(z08));
  inv1   g48(.a(x24), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n88_), .c(new_n46_), .O(z09));
  nand3  g50(.a(new_n90_), .b(x22), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n46_), .O(z10));
  nand4  g52(.a(new_n46_), .b(new_n90_), .c(x22), .d(x17), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z11));
  inv1   g54(.a(x14), .O(new_n96_));
  nand2  g55(.a(new_n90_), .b(x23), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n96_), .c(new_n46_), .O(z12));
  inv1   g57(.a(x17), .O(new_n99_));
  oai21  g58(.a(new_n97_), .b(new_n99_), .c(new_n46_), .O(z13));
  nand3  g59(.a(new_n46_), .b(new_n90_), .c(x16), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z14));
  inv1   g61(.a(x12), .O(new_n103_));
  inv1   g62(.a(x13), .O(new_n104_));
  nor2   g63(.a(x15), .b(x14), .O(new_n105_));
  nand4  g64(.a(new_n105_), .b(new_n46_), .c(new_n104_), .d(new_n103_), .O(z15));
endmodule
