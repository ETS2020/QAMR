...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n85_, new_n88_, new_n89_, new_n90_, new_n92_, new_n94_,
  ...
  nand3  g36(.a(new_n65_), .b(x19), .c(new_n52_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n64_), .c(new_n77_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n54_), .O(new_n80_));
  oai21  g39(.a(new_n43_), .b(new_n77_), .c(new_n80_), .O(z05));
  ...
  nand2  g53(.a(new_n44_), .b(new_n89_), .O(new_n95_));
  ...
  nor3   g62(.a(new_n45_), .b(x13), .c(x12), .O(new_n104_));
