...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n66_, new_n68_, new_n70_, new_n72_, new_n73_, new_n75_, new_n78_,
  ...
  nor2   g29(.a(new_n65_), .b(new_n70_), .O(z05));
  inv1   g30(.a(x18), .O(new_n72_));
  nand2  g31(.a(new_n66_), .b(x24), .O(new_n73_));
  ...
  nand4  g37(.a(new_n66_), .b(new_n78_), .c(x22), .d(x14), .O(new_n79_));
  inv1   g38(.a(new_n79_), .O(z10));
  nand4  g39(.a(new_n66_), .b(new_n78_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  nand4  g41(.a(new_n66_), .b(new_n78_), .c(x23), .d(x14), .O(new_n83_));
