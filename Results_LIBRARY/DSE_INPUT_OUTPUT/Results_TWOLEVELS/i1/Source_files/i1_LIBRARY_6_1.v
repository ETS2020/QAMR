...
module FAU ( 
  ...
  nand3  g35(.a(new_n63_), .b(new_n54_), .c(new_n51_), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n79_));
  nor2   g38(.a(new_n64_), .b(new_n42_), .O(new_n80_));
  ...
  oai21  g49(.a(new_n90_), .b(new_n88_), .c(new_n45_), .O(z10));
  inv1   g50(.a(x17), .O(new_n92_));
  oai21  g51(.a(new_n90_), .b(new_n92_), .c(new_n45_), .O(z11));
  nand4  g52(.a(new_n45_), .b(new_n89_), .c(x23), .d(x14), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n89_), .b(x23), .c(x17), .O(new_n96_));
