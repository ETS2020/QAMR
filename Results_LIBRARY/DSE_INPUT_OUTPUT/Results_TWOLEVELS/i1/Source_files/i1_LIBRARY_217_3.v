...
module FAU ( 
  ...
  nand2  g37(.a(new_n78_), .b(new_n59_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nand2  g39(.a(new_n59_), .b(new_n80_), .O(z08));
  nand3  g40(.a(new_n59_), .b(x24), .c(x11), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z09));
  inv1   g42(.a(x24), .O(new_n84_));
  nand3  g43(.a(new_n59_), .b(new_n84_), .c(x22), .O(new_n85_));
  ...
  nand3  g49(.a(new_n59_), .b(new_n84_), .c(x23), .O(new_n91_));
  ...
  oai21  g56(.a(x24), .b(new_n97_), .c(new_n59_), .O(z14));
  inv1   g57(.a(x12), .O(new_n99_));
  inv1   g58(.a(x13), .O(new_n100_));
  nor2   g59(.a(x15), .b(x14), .O(new_n101_));
  nand4  g60(.a(new_n101_), .b(new_n59_), .c(new_n100_), .d(new_n99_), .O(z15));
endmodule
