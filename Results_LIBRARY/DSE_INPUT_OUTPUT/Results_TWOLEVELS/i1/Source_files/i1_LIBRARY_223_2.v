...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n84_, new_n86_, new_n87_, new_n89_, new_n92_, new_n94_,
  ...
  nand4  g37(.a(new_n78_), .b(new_n68_), .c(new_n67_), .d(new_n52_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n45_), .c(new_n77_), .O(z05));
  nand4  g39(.a(new_n63_), .b(new_n50_), .c(new_n62_), .d(new_n49_), .O(new_n81_));
  nor3   g40(.a(new_n81_), .b(x02), .c(x01), .O(new_n82_));
  nand2  g41(.a(new_n65_), .b(x00), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(x19), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n45_), .O(z06));
  ...
  nand3  g50(.a(x22), .b(x19), .c(x14), .O(new_n92_));
  nor2   g51(.a(new_n92_), .b(x24), .O(z10));
  nand3  g52(.a(new_n87_), .b(x22), .c(x17), .O(new_n94_));
