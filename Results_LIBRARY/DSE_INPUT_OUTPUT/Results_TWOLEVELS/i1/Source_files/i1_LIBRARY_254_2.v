...
module FAU ( 
  ...
  aoi21  g02(.a(new_n43_), .b(x06), .c(new_n42_), .O(z00));
  ...
  oai21  g14(.a(new_n43_), .b(x00), .c(x06), .O(new_n56_));
  nor3   g15(.a(x03), .b(x02), .c(x01), .O(new_n57_));
  nor3   g16(.a(x07), .b(x05), .c(x04), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n57_), .c(new_n42_), .O(new_n59_));
  inv1   g18(.a(x04), .O(new_n60_));
  nand4  g19(.a(new_n60_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n61_));
  inv1   g20(.a(x09), .O(new_n62_));
  nor2   g21(.a(x06), .b(x05), .O(new_n63_));
  nand4  g22(.a(new_n63_), .b(new_n62_), .c(x08), .d(new_n50_), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(new_n61_), .O(new_n65_));
  oai21  g24(.a(new_n65_), .b(new_n59_), .c(x19), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n56_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nor2   g27(.a(x19), .b(new_n49_), .O(new_n69_));
  ...
  inv1   g33(.a(new_n61_), .O(new_n75_));
  nor2   g34(.a(new_n43_), .b(x08), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(new_n63_), .c(new_n75_), .d(new_n50_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n70_), .c(new_n74_), .O(z05));
  nor2   g37(.a(x07), .b(x06), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n48_), .c(new_n60_), .d(new_n47_), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(x02), .O(new_n81_));
  nand3  g40(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n82_));
  aoi21  g41(.a(new_n81_), .b(new_n45_), .c(new_n82_), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n43_), .c(new_n56_), .O(z06));
  inv1   g43(.a(x18), .O(new_n85_));
  nand2  g44(.a(new_n70_), .b(x24), .O(new_n86_));
  nor2   g45(.a(new_n86_), .b(new_n85_), .O(z07));
  inv1   g46(.a(x11), .O(new_n88_));
  nand2  g47(.a(new_n70_), .b(new_n88_), .O(z08));
  nor2   g48(.a(new_n86_), .b(new_n88_), .O(z09));
  inv1   g49(.a(x24), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x22), .c(x14), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n70_), .O(z10));
  nor2   g52(.a(new_n69_), .b(x24), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x22), .c(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z11));
  nand3  g55(.a(new_n91_), .b(x23), .c(x14), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n70_), .O(z12));
  nand3  g57(.a(new_n94_), .b(x23), .c(x17), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z13));
  and2   g59(.a(new_n94_), .b(x16), .O(z14));
