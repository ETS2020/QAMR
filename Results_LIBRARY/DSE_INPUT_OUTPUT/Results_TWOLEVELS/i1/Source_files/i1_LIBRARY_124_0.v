...
module FAU ( 
  ...
  nand4  g23(.a(new_n64_), .b(x19), .c(new_n63_), .d(x08), .O(new_n65_));
  ...
  nand4  g27(.a(new_n68_), .b(new_n64_), .c(new_n46_), .d(new_n50_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x19), .c(x00), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n67_), .O(z02));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n81_), .O(z06));
  ...
  nand4  g57(.a(new_n44_), .b(new_n88_), .c(x23), .d(x17), .O(new_n99_));
