...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n94_, new_n96_, new_n98_, new_n101_, new_n103_;
  ...
  nand4  g38(.a(new_n62_), .b(x19), .c(x14), .d(new_n79_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n78_), .c(new_n44_), .d(new_n77_), .O(z05));
  nand2  g40(.a(new_n57_), .b(new_n79_), .O(new_n82_));
  ...
  nand2  g52(.a(new_n89_), .b(x22), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n57_), .c(new_n45_), .O(z10));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n45_), .O(z11));
  nand2  g56(.a(new_n89_), .b(x23), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n57_), .c(new_n45_), .O(z12));
  oai21  g58(.a(new_n98_), .b(new_n96_), .c(new_n45_), .O(z13));
  inv1   g59(.a(x16), .O(new_n101_));
  nor3   g60(.a(new_n44_), .b(x24), .c(new_n101_), .O(z14));
  nor3   g61(.a(x15), .b(x13), .c(x12), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(x19), .c(new_n57_), .O(z15));
endmodule
