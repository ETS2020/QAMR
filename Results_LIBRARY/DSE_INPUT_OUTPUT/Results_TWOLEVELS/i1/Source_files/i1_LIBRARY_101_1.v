...
module FAU ( 
  ...
  nor3   g14(.a(x09), .b(x08), .c(x07), .O(new_n56_));
  ...
  nand3  g21(.a(new_n62_), .b(new_n61_), .c(new_n52_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n60_), .c(new_n43_), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n59_), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(x19), .c(x00), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n47_), .O(z02));
  inv1   g26(.a(x20), .O(new_n68_));
  nor2   g27(.a(new_n44_), .b(new_n68_), .O(z03));
  inv1   g28(.a(x21), .O(new_n70_));
  nand3  g29(.a(new_n47_), .b(new_n70_), .c(new_n68_), .O(z04));
  nand3  g30(.a(new_n55_), .b(x19), .c(new_n59_), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n54_), .c(x10), .O(new_n74_));
  nand2  g33(.a(x10), .b(x07), .O(new_n75_));
  oai21  g34(.a(new_n74_), .b(x08), .c(new_n75_), .O(z05));
  nand3  g35(.a(new_n55_), .b(new_n43_), .c(new_n59_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n53_), .O(new_n78_));
  aoi21  g37(.a(new_n65_), .b(x00), .c(new_n78_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n48_), .c(new_n46_), .O(z06));
  nand2  g39(.a(x24), .b(x18), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(new_n47_), .O(z07));
  inv1   g41(.a(x11), .O(new_n83_));
  nor2   g42(.a(new_n44_), .b(new_n83_), .O(z08));
  inv1   g43(.a(x24), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(new_n47_), .O(z09));
