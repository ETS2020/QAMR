...
module FAU ( 
  ...
  aoi21  g05(.a(x07), .b(new_n42_), .c(new_n45_), .O(z02));
  inv1   g06(.a(x20), .O(new_n48_));
  nor2   g07(.a(new_n45_), .b(x07), .O(new_n49_));
  ...
  nand4  g29(.a(new_n52_), .b(new_n64_), .c(x23), .d(x17), .O(new_n71_));
