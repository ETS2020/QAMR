...
module FAU ( 
  ...
  nor2   g31(.a(new_n43_), .b(x08), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(new_n64_), .c(new_n63_), .d(new_n51_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n44_), .c(new_n72_), .O(z05));
  nand3  g34(.a(new_n59_), .b(new_n49_), .c(new_n57_), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  nand4  g36(.a(new_n77_), .b(new_n48_), .c(new_n47_), .d(new_n46_), .O(new_n78_));
  nor2   g37(.a(new_n60_), .b(new_n42_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n43_), .O(z06));
