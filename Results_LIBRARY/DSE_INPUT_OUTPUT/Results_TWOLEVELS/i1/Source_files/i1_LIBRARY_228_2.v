...
module FAU ( 
  ...
  inv1   g37(.a(new_n44_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x24), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n78_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nand2  g41(.a(new_n79_), .b(new_n82_), .O(z08));
  nor2   g42(.a(new_n80_), .b(new_n82_), .O(z09));
  nor2   g43(.a(new_n44_), .b(x24), .O(new_n85_));
