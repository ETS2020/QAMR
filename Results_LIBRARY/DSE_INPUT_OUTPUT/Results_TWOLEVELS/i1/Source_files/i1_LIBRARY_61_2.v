...
module FAU ( 
  ...
  nand4  g19(.a(new_n60_), .b(x19), .c(new_n59_), .d(new_n51_), .O(new_n61_));
  ...
  nand4  g35(.a(new_n76_), .b(new_n60_), .c(new_n75_), .d(new_n51_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n44_), .c(new_n74_), .O(z05));
  nand3  g37(.a(new_n65_), .b(new_n49_), .c(new_n57_), .O(new_n79_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(z06));
  inv1   g42(.a(x18), .O(new_n84_));
  inv1   g43(.a(x24), .O(new_n85_));
  nor3   g44(.a(new_n70_), .b(new_n85_), .c(new_n84_), .O(z07));
  inv1   g45(.a(x11), .O(new_n87_));
  nor2   g46(.a(new_n70_), .b(new_n87_), .O(z08));
  oai21  g47(.a(new_n85_), .b(new_n87_), .c(new_n44_), .O(z09));
  nand4  g48(.a(new_n44_), .b(new_n85_), .c(x22), .d(x14), .O(new_n90_));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n70_), .O(z15));
endmodule
