...
module FAU ( 
  ...
  inv1   g24(.a(new_n43_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(new_n65_), .O(z03));
  inv1   g26(.a(x21), .O(new_n68_));
  nand3  g27(.a(new_n43_), .b(new_n68_), .c(new_n65_), .O(z04));
  inv1   g28(.a(x10), .O(new_n70_));
  nand4  g29(.a(x19), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(new_n50_), .c(new_n70_), .O(new_n72_));
  ...
  nor2   g35(.a(new_n74_), .b(x08), .O(z06));
  ...
  nand3  g53(.a(new_n43_), .b(new_n82_), .c(x16), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z14));
  nor2   g55(.a(x13), .b(x12), .O(new_n97_));
  nor2   g56(.a(x15), .b(x14), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n66_), .O(z15));
endmodule
