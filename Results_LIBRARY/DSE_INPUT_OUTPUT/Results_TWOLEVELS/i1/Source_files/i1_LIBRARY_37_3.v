...
module FAU ( 
  ...
  aoi22  g22(.a(new_n63_), .b(new_n60_), .c(x19), .d(x08), .O(z04));
  inv1   g23(.a(x10), .O(new_n65_));
  nand2  g24(.a(new_n57_), .b(new_n44_), .O(new_n66_));
  ...
  nand3  g29(.a(new_n61_), .b(x24), .c(x18), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z07));
  inv1   g31(.a(x11), .O(new_n73_));
  nand2  g32(.a(new_n61_), .b(new_n73_), .O(z08));
  nand3  g33(.a(new_n61_), .b(x24), .c(x11), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z09));
  inv1   g35(.a(x14), .O(new_n77_));
  inv1   g36(.a(x24), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x22), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n77_), .c(new_n61_), .O(z10));
  inv1   g39(.a(x17), .O(new_n81_));
  oai21  g40(.a(new_n79_), .b(new_n81_), .c(new_n61_), .O(z11));
  nand2  g41(.a(new_n78_), .b(x23), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n77_), .c(new_n61_), .O(z12));
  oai21  g43(.a(new_n83_), .b(new_n81_), .c(new_n61_), .O(z13));
  nand3  g44(.a(new_n61_), .b(new_n78_), .c(x16), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z14));
  inv1   g46(.a(x12), .O(new_n88_));
  inv1   g47(.a(x13), .O(new_n89_));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(new_n61_), .c(new_n89_), .d(new_n88_), .O(z15));
endmodule
