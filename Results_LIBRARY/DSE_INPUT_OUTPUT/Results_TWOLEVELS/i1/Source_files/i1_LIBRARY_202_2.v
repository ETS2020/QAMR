...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n83_, new_n84_, new_n85_, new_n86_, new_n88_, new_n90_, new_n93_,
  ...
  nand3  g11(.a(x24), .b(x09), .c(x08), .O(new_n53_));
  ...
  nand3  g31(.a(new_n72_), .b(x24), .c(x19), .O(new_n73_));
  ...
  nand3  g37(.a(new_n67_), .b(new_n62_), .c(new_n49_), .O(new_n79_));
  nand4  g38(.a(new_n63_), .b(x24), .c(x19), .d(new_n69_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n79_), .c(new_n44_), .d(new_n78_), .O(z05));
  nand3  g40(.a(new_n63_), .b(new_n50_), .c(new_n66_), .O(new_n82_));
  ...
  nand3  g44(.a(new_n85_), .b(x24), .c(x19), .O(new_n86_));
  ...
  nor2   g50(.a(new_n58_), .b(new_n90_), .O(z09));
  nand2  g51(.a(x22), .b(x14), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n43_), .c(x24), .O(z10));
  nand2  g53(.a(x22), .b(x17), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n43_), .c(x24), .O(z11));
  nand4  g55(.a(new_n58_), .b(x23), .c(new_n43_), .d(x14), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z12));
  nand2  g57(.a(x23), .b(x17), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n43_), .c(x24), .O(z13));
  nand3  g59(.a(new_n58_), .b(new_n43_), .c(x16), .O(new_n101_));
