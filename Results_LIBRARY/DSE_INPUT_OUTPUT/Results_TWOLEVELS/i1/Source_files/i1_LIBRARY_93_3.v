...
module FAU ( 
  ...
  and2   g41(.a(new_n72_), .b(x11), .O(z08));
  nand3  g42(.a(new_n72_), .b(x24), .c(x11), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(z09));
  inv1   g44(.a(x24), .O(new_n86_));
  nand3  g45(.a(new_n72_), .b(new_n86_), .c(x22), .O(new_n87_));
  ...
  nand4  g53(.a(new_n72_), .b(new_n86_), .c(x23), .d(x17), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z13));
  inv1   g55(.a(x16), .O(new_n97_));
  aoi21  g56(.a(x24), .b(new_n44_), .c(new_n97_), .O(z14));
