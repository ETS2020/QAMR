...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n77_, new_n79_, new_n80_, new_n83_, new_n84_, new_n85_,
  ...
  nand4  g32(.a(new_n73_), .b(new_n58_), .c(new_n72_), .d(new_n50_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n43_), .c(new_n71_), .O(z05));
  ...
  nor2   g39(.a(new_n80_), .b(new_n79_), .O(z08));
  nor2   g40(.a(new_n77_), .b(new_n79_), .O(z09));
  ...
  nand2  g48(.a(new_n43_), .b(new_n84_), .O(new_n90_));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n80_), .O(z15));
  buf    g59(.a(x19), .O(z06));
endmodule
