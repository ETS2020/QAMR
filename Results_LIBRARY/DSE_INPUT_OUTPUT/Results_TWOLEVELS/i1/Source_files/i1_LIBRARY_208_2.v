...
module FAU ( 
  ...
  nand3  g37(.a(new_n65_), .b(x19), .c(new_n52_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n64_), .c(new_n78_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n54_), .O(new_n81_));
  oai21  g40(.a(new_n43_), .b(new_n78_), .c(new_n81_), .O(z05));
  ...
  nand4  g51(.a(new_n44_), .b(new_n87_), .c(x23), .d(x14), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z12));
  nand3  g53(.a(new_n87_), .b(x23), .c(x17), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n44_), .O(z13));
  nand2  g55(.a(new_n87_), .b(x16), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(z14));
  nor2   g57(.a(x15), .b(x14), .O(new_n99_));
  nor3   g58(.a(new_n45_), .b(x13), .c(x12), .O(new_n100_));
