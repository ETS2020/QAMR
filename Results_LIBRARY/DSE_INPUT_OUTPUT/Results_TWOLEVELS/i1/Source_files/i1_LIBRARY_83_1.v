...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n72_, new_n74_, new_n77_, new_n78_, new_n79_, new_n82_, new_n83_,
  ...
  oai21  g31(.a(new_n72_), .b(new_n60_), .c(new_n45_), .O(z02));
  inv1   g32(.a(x20), .O(new_n74_));
  nand2  g33(.a(new_n45_), .b(new_n74_), .O(z03));
  or2    g34(.a(z03), .b(x21), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n65_), .b(new_n62_), .c(new_n49_), .O(new_n78_));
  nand4  g37(.a(new_n63_), .b(x19), .c(new_n43_), .d(new_n69_), .O(new_n79_));
  oai22  g38(.a(new_n79_), .b(new_n78_), .c(new_n44_), .d(new_n77_), .O(z05));
  nor2   g39(.a(new_n44_), .b(new_n60_), .O(z06));
  inv1   g40(.a(x18), .O(new_n82_));
  inv1   g41(.a(x24), .O(new_n83_));
  nor3   g42(.a(new_n44_), .b(new_n83_), .c(new_n82_), .O(z07));
  aoi21  g43(.a(new_n83_), .b(x08), .c(new_n43_), .O(z09));
  nand4  g44(.a(new_n45_), .b(new_n83_), .c(x22), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand3  g46(.a(new_n83_), .b(x22), .c(x17), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z11));
  inv1   g48(.a(x14), .O(new_n90_));
  nand2  g49(.a(new_n83_), .b(x23), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n90_), .c(new_n45_), .O(z12));
  inv1   g51(.a(x17), .O(new_n93_));
  oai21  g52(.a(new_n91_), .b(new_n93_), .c(new_n45_), .O(z13));
