// Benchmark "FAU" written by ABC on Wed Aug 19 17:34:22 2020
...
module FAU ( 
  ...
  nand3  g14(.a(new_n55_), .b(x19), .c(x15), .O(new_n56_));
  ...
  nand3  g26(.a(new_n67_), .b(x19), .c(x15), .O(new_n68_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n62_), .c(x15), .O(new_n78_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n71_), .O(z10));
  nand4  g47(.a(new_n71_), .b(new_n85_), .c(x22), .d(x17), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z11));
  inv1   g49(.a(x14), .O(new_n91_));
  nand2  g50(.a(new_n85_), .b(x23), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n91_), .c(new_n71_), .O(z12));
  inv1   g52(.a(x17), .O(new_n94_));
  oai21  g53(.a(new_n92_), .b(new_n94_), .c(new_n71_), .O(z13));
  inv1   g54(.a(x16), .O(new_n96_));
  nor3   g55(.a(new_n72_), .b(x24), .c(new_n96_), .O(z14));
  nor3   g56(.a(x14), .b(x13), .c(x12), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(x19), .c(new_n43_), .O(z15));
  buf    g58(.a(x19), .O(z06));
endmodule
