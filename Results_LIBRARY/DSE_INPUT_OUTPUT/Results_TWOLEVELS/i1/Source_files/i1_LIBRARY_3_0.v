...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n84_, new_n85_, new_n87_, new_n90_, new_n91_, new_n93_, new_n94_,
  ...
  nand4  g32(.a(new_n50_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n74_));
  nand3  g33(.a(new_n60_), .b(x19), .c(new_n66_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n58_), .O(new_n77_));
  ...
  nand3  g56(.a(new_n93_), .b(x23), .c(x17), .O(new_n98_));
