...
module FAU ( 
  ...
  oai21  g41(.a(x09), .b(new_n70_), .c(new_n65_), .O(new_n83_));
  ...
  nor3   g45(.a(new_n63_), .b(new_n65_), .c(new_n42_), .O(new_n87_));
  ...
  nand4  g53(.a(new_n45_), .b(new_n93_), .c(x22), .d(x14), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z10));
  nand3  g55(.a(new_n93_), .b(x22), .c(x17), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z11));
  nand2  g57(.a(x23), .b(x14), .O(new_n99_));
  nor2   g58(.a(new_n99_), .b(x24), .O(z12));
