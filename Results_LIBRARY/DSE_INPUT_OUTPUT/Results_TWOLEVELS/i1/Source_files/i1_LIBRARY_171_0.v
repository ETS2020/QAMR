...
module FAU ( 
  ...
  nand2  g37(.a(new_n45_), .b(x01), .O(z06));
  inv1   g38(.a(x18), .O(new_n80_));
  nand2  g39(.a(new_n69_), .b(x24), .O(new_n81_));
  ...
  oai21  g53(.a(new_n94_), .b(new_n92_), .c(new_n69_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n69_), .O(z13));
