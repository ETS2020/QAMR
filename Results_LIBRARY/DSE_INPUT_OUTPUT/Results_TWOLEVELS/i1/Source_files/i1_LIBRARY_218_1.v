...
module FAU ( 
  ...
  nand4  g39(.a(new_n72_), .b(new_n79_), .c(x22), .d(x14), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z10));
  nand3  g41(.a(new_n79_), .b(x22), .c(x17), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n72_), .O(z11));
  nand4  g43(.a(new_n72_), .b(new_n79_), .c(x23), .d(x14), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z12));
  nand3  g45(.a(new_n79_), .b(x23), .c(x17), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n72_), .O(z13));
  nand2  g47(.a(new_n79_), .b(x16), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n72_), .O(z14));
  nor2   g49(.a(x15), .b(x14), .O(new_n91_));
  nor3   g50(.a(new_n67_), .b(x13), .c(x12), .O(new_n92_));
