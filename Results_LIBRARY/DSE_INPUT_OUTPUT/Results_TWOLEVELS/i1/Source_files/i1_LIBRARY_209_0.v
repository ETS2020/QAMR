...
module FAU ( 
  ...
  nand3  g33(.a(new_n65_), .b(x19), .c(new_n52_), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n63_), .c(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n66_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n74_), .O(z05));
  nand3  g37(.a(new_n60_), .b(new_n50_), .c(new_n58_), .O(new_n79_));
  ...
  nand2  g55(.a(new_n88_), .b(x23), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n96_), .c(new_n44_), .O(z12));
