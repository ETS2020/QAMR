...
module FAU ( 
  ...
  nor2   g32(.a(new_n73_), .b(new_n71_), .O(z03));
  inv1   g33(.a(x21), .O(new_n75_));
  nand3  g34(.a(new_n72_), .b(new_n75_), .c(new_n71_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  nand3  g36(.a(new_n64_), .b(new_n65_), .c(new_n50_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n63_), .c(new_n57_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x19), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n77_), .O(z05));
  nor2   g40(.a(new_n44_), .b(x15), .O(z06));
  nand2  g41(.a(x24), .b(x18), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n72_), .O(z07));
  inv1   g43(.a(x11), .O(new_n85_));
  nor2   g44(.a(new_n73_), .b(new_n85_), .O(z08));
  inv1   g45(.a(x24), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n85_), .c(new_n72_), .O(z09));
  nand3  g47(.a(new_n72_), .b(new_n87_), .c(x22), .O(new_n89_));
  ...
  nand3  g53(.a(new_n87_), .b(x23), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n72_), .O(z12));
  nand4  g55(.a(new_n72_), .b(new_n87_), .c(x23), .d(x17), .O(new_n97_));
