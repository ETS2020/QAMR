...
module FAU ( 
  ...
  oai21  g48(.a(new_n86_), .b(new_n88_), .c(new_n45_), .O(z09));
  nand3  g49(.a(new_n86_), .b(x22), .c(x14), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n45_), .O(z10));
  nand4  g51(.a(new_n45_), .b(new_n86_), .c(x22), .d(x17), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z11));
  nand3  g53(.a(new_n86_), .b(x23), .c(x14), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n45_), .O(z12));
  nand4  g55(.a(new_n45_), .b(new_n86_), .c(x23), .d(x17), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z13));
  nor3   g57(.a(x24), .b(new_n60_), .c(new_n43_), .O(z14));
