...
module FAU ( 
  ...
  inv1   g21(.a(new_n61_), .O(new_n63_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n61_), .O(z07));
  inv1   g40(.a(x11), .O(new_n82_));
  nor2   g41(.a(new_n63_), .b(new_n82_), .O(z08));
  inv1   g42(.a(x24), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n82_), .c(new_n61_), .O(z09));
  nand3  g44(.a(new_n84_), .b(x22), .c(x14), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n61_), .O(z10));
  nand4  g46(.a(new_n61_), .b(new_n84_), .c(x22), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand3  g48(.a(new_n61_), .b(new_n84_), .c(x23), .O(new_n90_));
  ...
  oai21  g55(.a(x24), .b(new_n96_), .c(new_n61_), .O(z14));
  inv1   g56(.a(x12), .O(new_n98_));
  inv1   g57(.a(x13), .O(new_n99_));
  nor2   g58(.a(x15), .b(x14), .O(new_n100_));
  nand4  g59(.a(new_n100_), .b(new_n61_), .c(new_n99_), .d(new_n98_), .O(z15));
endmodule
