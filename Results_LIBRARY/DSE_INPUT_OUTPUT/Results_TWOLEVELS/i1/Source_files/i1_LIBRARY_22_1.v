...
module FAU ( 
  ...
  and2   g24(.a(new_n65_), .b(x20), .O(z03));
  inv1   g25(.a(new_n65_), .O(new_n67_));
  nor2   g26(.a(x21), .b(x20), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n67_), .O(z04));
  inv1   g28(.a(x10), .O(new_n70_));
  nand2  g29(.a(new_n65_), .b(new_n70_), .O(z05));
  inv1   g30(.a(x18), .O(new_n72_));
  nand2  g31(.a(new_n65_), .b(x24), .O(new_n73_));
  ...
  nand2  g38(.a(new_n79_), .b(new_n65_), .O(z10));
  nand4  g39(.a(new_n65_), .b(new_n78_), .c(x22), .d(x17), .O(new_n81_));
  inv1   g40(.a(new_n81_), .O(z11));
  inv1   g41(.a(x14), .O(new_n83_));
  nand2  g42(.a(new_n78_), .b(x23), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n83_), .c(new_n65_), .O(z12));
  inv1   g44(.a(x17), .O(new_n86_));
  oai21  g45(.a(new_n84_), .b(new_n86_), .c(new_n65_), .O(z13));
  inv1   g46(.a(x16), .O(new_n88_));
  nor3   g47(.a(new_n67_), .b(x24), .c(new_n88_), .O(z14));
  nor2   g48(.a(x15), .b(x14), .O(new_n90_));
  nor3   g49(.a(new_n67_), .b(x13), .c(x12), .O(new_n91_));
