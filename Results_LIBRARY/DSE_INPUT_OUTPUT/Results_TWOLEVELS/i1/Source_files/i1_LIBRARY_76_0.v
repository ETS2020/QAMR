...
module FAU ( 
  ...
  nand3  g31(.a(new_n72_), .b(new_n44_), .c(x19), .O(z04));
  ...
  nand4  g36(.a(new_n62_), .b(new_n50_), .c(new_n61_), .d(new_n49_), .O(new_n78_));
  ...
  nand2  g40(.a(new_n81_), .b(new_n45_), .O(z06));
  ...
  nand2  g49(.a(new_n45_), .b(new_n90_), .O(new_n91_));
  nor2   g50(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  ...
  nor2   g56(.a(new_n91_), .b(new_n97_), .O(new_n98_));
  ...
  nor2   g62(.a(new_n91_), .b(new_n103_), .O(z14));
  inv1   g63(.a(x12), .O(new_n105_));
  inv1   g64(.a(x13), .O(new_n106_));
  nor2   g65(.a(x15), .b(x14), .O(new_n107_));
  nand4  g66(.a(new_n107_), .b(new_n45_), .c(new_n106_), .d(new_n105_), .O(z15));
  buf    g67(.a(x20), .O(z03));
endmodule
