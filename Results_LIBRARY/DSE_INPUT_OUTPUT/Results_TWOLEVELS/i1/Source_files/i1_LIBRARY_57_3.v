...
module FAU ( 
  ...
  aoi21  g01(.a(x19), .b(x03), .c(new_n42_), .O(z00));
  ...
  nand2  g19(.a(new_n60_), .b(new_n48_), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n59_), .c(x00), .O(new_n62_));
  nand4  g21(.a(new_n48_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n63_));
  inv1   g22(.a(x09), .O(new_n64_));
  nand3  g23(.a(new_n60_), .b(new_n64_), .c(x08), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nor2   g25(.a(new_n66_), .b(x03), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n62_), .c(new_n58_), .O(z02));
  inv1   g27(.a(x20), .O(new_n69_));
  aoi21  g28(.a(x19), .b(x03), .c(new_n69_), .O(z03));
  inv1   g29(.a(x21), .O(new_n71_));
  nand2  g30(.a(x19), .b(x03), .O(new_n72_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n72_), .O(z07));
  ...
  oai21  g46(.a(new_n87_), .b(new_n86_), .c(new_n72_), .O(z10));
  inv1   g47(.a(x17), .O(new_n89_));
  oai21  g48(.a(new_n87_), .b(new_n89_), .c(new_n72_), .O(z11));
  nand3  g49(.a(new_n72_), .b(new_n84_), .c(x23), .O(new_n91_));
  ...
  oai21  g56(.a(x24), .b(new_n97_), .c(new_n72_), .O(z14));
