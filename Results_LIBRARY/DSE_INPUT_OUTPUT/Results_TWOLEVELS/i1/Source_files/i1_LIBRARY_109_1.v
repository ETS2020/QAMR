...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n92_, new_n95_, new_n96_, new_n98_, new_n99_, new_n101_, new_n103_,
    new_n106_, new_n107_;
  ...
  nand4  g28(.a(new_n69_), .b(new_n66_), .c(new_n65_), .d(new_n49_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n64_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x19), .c(x13), .O(new_n72_));
  ...
  nand4  g39(.a(new_n62_), .b(x19), .c(x13), .d(new_n80_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n79_), .c(new_n44_), .d(new_n78_), .O(z05));
  nand3  g41(.a(new_n62_), .b(new_n50_), .c(new_n65_), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(new_n49_), .c(new_n48_), .d(new_n47_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n64_), .c(x00), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x19), .c(x13), .O(new_n87_));
  ...
  nand2  g58(.a(new_n99_), .b(new_n45_), .O(z11));
  nand3  g59(.a(new_n95_), .b(x23), .c(x14), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z12));
  nand3  g61(.a(new_n98_), .b(x23), .c(x17), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n45_), .O(z13));
  and2   g63(.a(new_n95_), .b(x16), .O(z14));
  nor2   g64(.a(x15), .b(x14), .O(new_n106_));
  nor3   g65(.a(x19), .b(x13), .c(x12), .O(new_n107_));
