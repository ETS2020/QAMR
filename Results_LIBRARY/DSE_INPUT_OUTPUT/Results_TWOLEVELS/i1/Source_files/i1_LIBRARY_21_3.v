...
module FAU ( 
  ...
  nor2   g30(.a(new_n44_), .b(x08), .O(z06));
  nand3  g31(.a(new_n46_), .b(x24), .c(x18), .O(new_n73_));
  ...
  nand4  g44(.a(new_n46_), .b(new_n77_), .c(x23), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z13));
  nand3  g46(.a(new_n46_), .b(new_n77_), .c(x16), .O(new_n88_));
