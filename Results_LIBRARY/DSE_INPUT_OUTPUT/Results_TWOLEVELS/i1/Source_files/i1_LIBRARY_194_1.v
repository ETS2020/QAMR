...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x08), .c(new_n46_), .O(z01));
  ...
  aoi21  g26(.a(new_n67_), .b(x08), .c(new_n46_), .O(z02));
  inv1   g27(.a(x20), .O(new_n69_));
  nand2  g28(.a(new_n44_), .b(new_n69_), .O(z03));
  inv1   g29(.a(x21), .O(new_n71_));
  aoi22  g30(.a(new_n71_), .b(new_n69_), .c(x19), .d(new_n43_), .O(z04));
  ...
  nand4  g51(.a(new_n44_), .b(new_n88_), .c(x23), .d(x14), .O(new_n93_));
