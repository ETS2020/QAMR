...
module FAU ( 
  ...
  nand4  g23(.a(new_n64_), .b(x19), .c(new_n43_), .d(x00), .O(new_n65_));
  ...
  nand3  g36(.a(new_n46_), .b(x24), .c(x18), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z07));
  inv1   g38(.a(x11), .O(new_n80_));
  nor2   g39(.a(new_n45_), .b(new_n80_), .O(z08));
  nand2  g40(.a(x24), .b(x11), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n46_), .O(z09));
