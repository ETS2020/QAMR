// Benchmark "FAU" written by ABC on Wed Aug 19 17:34:21 2020
...
module FAU ( 
  ...
  nand2  g29(.a(new_n52_), .b(new_n51_), .O(new_n71_));
  nor4   g30(.a(new_n71_), .b(x09), .c(new_n70_), .d(x07), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n69_), .c(x23), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n65_), .c(new_n43_), .O(z02));
  inv1   g33(.a(x20), .O(new_n75_));
  nand2  g34(.a(new_n46_), .b(new_n75_), .O(z03));
  nor2   g35(.a(x21), .b(x20), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n45_), .O(z04));
  inv1   g37(.a(x10), .O(new_n79_));
  nand3  g38(.a(new_n66_), .b(new_n62_), .c(new_n50_), .O(new_n80_));
  nand4  g39(.a(new_n63_), .b(new_n44_), .c(x19), .d(new_n70_), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n80_), .c(new_n45_), .d(new_n79_), .O(z05));
  oai21  g41(.a(x09), .b(new_n70_), .c(x23), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(new_n53_), .c(new_n52_), .d(new_n51_), .O(new_n84_));
  nor2   g43(.a(new_n84_), .b(x04), .O(new_n85_));
  nand4  g44(.a(new_n85_), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n86_));
  nor3   g45(.a(new_n64_), .b(x23), .c(new_n42_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n43_), .O(z06));
  ...
  nand4  g54(.a(new_n46_), .b(new_n95_), .c(x22), .d(x14), .O(new_n96_));
  inv1   g55(.a(new_n96_), .O(z10));
  nand3  g56(.a(new_n95_), .b(x22), .c(x17), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n46_), .O(z11));
  nand4  g58(.a(new_n95_), .b(x23), .c(new_n43_), .d(x14), .O(new_n100_));
  inv1   g59(.a(new_n100_), .O(z12));
  nand2  g60(.a(new_n95_), .b(x17), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n43_), .c(new_n44_), .O(z13));
  nand3  g62(.a(new_n46_), .b(new_n95_), .c(x16), .O(new_n104_));
  inv1   g63(.a(new_n104_), .O(z14));
  inv1   g64(.a(x12), .O(new_n106_));
  inv1   g65(.a(x13), .O(new_n107_));
  nor2   g66(.a(x15), .b(x14), .O(new_n108_));
  nand4  g67(.a(new_n108_), .b(new_n46_), .c(new_n107_), .d(new_n106_), .O(z15));
endmodule
