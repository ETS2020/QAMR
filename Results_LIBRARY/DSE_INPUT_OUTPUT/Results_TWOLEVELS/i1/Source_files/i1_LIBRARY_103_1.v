...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n65_), .c(x18), .O(new_n80_));
  ...
  nor2   g49(.a(new_n90_), .b(new_n57_), .O(z07));
  ...
  nand2  g54(.a(new_n90_), .b(x22), .O(new_n96_));
  ...
  nand3  g58(.a(new_n90_), .b(x23), .c(x14), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n45_), .O(z12));
  nand4  g60(.a(new_n45_), .b(new_n90_), .c(x23), .d(x17), .O(new_n102_));
  inv1   g61(.a(new_n102_), .O(z13));
  inv1   g62(.a(x16), .O(new_n104_));
  nor3   g63(.a(new_n44_), .b(x24), .c(new_n104_), .O(z14));
