...
module FAU ( 
  ...
  wire new_n42_, new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n88_, new_n90_, new_n92_, new_n94_, new_n95_, new_n96_;
  ...
  oai21  g39(.a(new_n80_), .b(new_n78_), .c(new_n66_), .O(z09));
  nand4  g40(.a(new_n66_), .b(new_n80_), .c(x22), .d(x14), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z10));
  nand3  g42(.a(new_n80_), .b(x22), .c(x17), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n66_), .O(z11));
  nand3  g44(.a(new_n66_), .b(new_n80_), .c(x23), .O(new_n86_));
  ...
  oai21  g51(.a(x24), .b(new_n92_), .c(new_n66_), .O(z14));
  inv1   g52(.a(x12), .O(new_n94_));
  inv1   g53(.a(x13), .O(new_n95_));
  nor2   g54(.a(x15), .b(x14), .O(new_n96_));
  nand4  g55(.a(new_n96_), .b(new_n66_), .c(new_n95_), .d(new_n94_), .O(z15));
  buf    g56(.a(x19), .O(z06));
endmodule
