...
module FAU ( 
  ...
  aoi21  g26(.a(new_n67_), .b(new_n64_), .c(x22), .O(new_n68_));
  aoi21  g27(.a(new_n68_), .b(new_n62_), .c(new_n58_), .O(z02));
  inv1   g28(.a(x20), .O(new_n70_));
  nand2  g29(.a(x22), .b(x19), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(new_n70_), .O(z03));
  or2    g31(.a(z03), .b(x21), .O(z04));
  inv1   g32(.a(x10), .O(new_n74_));
  nor4   g33(.a(new_n66_), .b(new_n63_), .c(x08), .d(x07), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(x22), .c(x19), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n74_), .O(z05));
  nor2   g36(.a(x22), .b(new_n58_), .O(z06));
  ...
  nand4  g44(.a(new_n85_), .b(x22), .c(new_n58_), .d(x14), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z10));
  nand4  g46(.a(new_n85_), .b(x22), .c(new_n58_), .d(x17), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z11));
  nand3  g48(.a(new_n71_), .b(new_n85_), .c(x23), .O(new_n90_));
  ...
  aoi22  g58(.a(new_n99_), .b(new_n98_), .c(x22), .d(x19), .O(z15));
endmodule
