...
module FAU ( 
  ...
  nand3  g38(.a(new_n62_), .b(new_n49_), .c(new_n60_), .O(new_n80_));
  ...
  nand2  g60(.a(new_n89_), .b(x16), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n44_), .O(z14));
  inv1   g62(.a(x15), .O(new_n104_));
  nor3   g63(.a(x14), .b(x13), .c(x12), .O(new_n105_));
  oai21  g64(.a(new_n105_), .b(new_n59_), .c(new_n104_), .O(z15));
endmodule
