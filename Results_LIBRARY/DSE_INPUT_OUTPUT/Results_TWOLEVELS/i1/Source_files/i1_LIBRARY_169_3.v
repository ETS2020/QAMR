...
module FAU ( 
  ...
  nand2  g29(.a(x19), .b(x14), .O(new_n71_));
  ...
  nor2   g37(.a(new_n44_), .b(x14), .O(z06));
  nand3  g38(.a(new_n59_), .b(z06), .c(new_n78_), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n77_), .c(new_n76_), .O(z05));
  nand3  g40(.a(new_n71_), .b(x24), .c(x18), .O(new_n82_));
  inv1   g41(.a(new_n82_), .O(z07));
  inv1   g42(.a(x11), .O(new_n84_));
  nor2   g43(.a(new_n73_), .b(new_n84_), .O(z08));
  inv1   g44(.a(x24), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n84_), .c(new_n71_), .O(z09));
  nand2  g46(.a(new_n44_), .b(x14), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(new_n86_), .c(x22), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(z10));
  nand3  g50(.a(new_n86_), .b(x22), .c(x17), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n71_), .O(z11));
  nand3  g52(.a(new_n89_), .b(new_n86_), .c(x23), .O(new_n94_));
  inv1   g53(.a(new_n94_), .O(z12));
  nand3  g54(.a(new_n86_), .b(x23), .c(x17), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n71_), .O(z13));
  nand3  g56(.a(new_n71_), .b(new_n86_), .c(x16), .O(new_n98_));
  inv1   g57(.a(new_n98_), .O(z14));
  nor3   g58(.a(x15), .b(x13), .c(x12), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(x14), .c(new_n88_), .O(z15));
endmodule
