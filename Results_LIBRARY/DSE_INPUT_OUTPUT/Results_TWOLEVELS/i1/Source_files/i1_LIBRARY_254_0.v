...
module FAU ( 
  ...
  nand4  g18(.a(new_n59_), .b(x08), .c(new_n51_), .d(new_n49_), .O(new_n60_));
  ...
  aoi21  g33(.a(new_n74_), .b(x19), .c(x06), .O(new_n75_));
  or2    g34(.a(new_n75_), .b(x10), .O(z05));
  nand2  g35(.a(new_n45_), .b(x06), .O(z06));
  inv1   g36(.a(x18), .O(new_n78_));
  nand2  g37(.a(new_n69_), .b(x24), .O(new_n79_));
  ...
  nand2  g44(.a(new_n85_), .b(new_n69_), .O(z10));
