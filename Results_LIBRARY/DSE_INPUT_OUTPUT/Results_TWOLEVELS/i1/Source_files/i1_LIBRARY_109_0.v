...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n88_, new_n89_, new_n91_, new_n92_, new_n94_, new_n96_,
  ...
  nand2  g51(.a(new_n92_), .b(new_n44_), .O(z11));
  ...
  nand4  g60(.a(new_n101_), .b(x19), .c(new_n100_), .d(new_n99_), .O(z15));
endmodule
