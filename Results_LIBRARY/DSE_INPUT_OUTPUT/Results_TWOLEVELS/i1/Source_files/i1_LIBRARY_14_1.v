...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n85_, new_n86_, new_n89_, new_n91_, new_n93_, new_n94_, new_n96_,
    new_n98_, new_n100_;
  ...
  nor3   g42(.a(new_n72_), .b(new_n83_), .c(new_n82_), .O(z07));
  ...
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n86_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n86_), .O(z13));
  nand2  g56(.a(new_n83_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n86_), .O(z14));
