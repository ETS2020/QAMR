...
module FAU ( 
  ...
  nand2  g34(.a(new_n57_), .b(x24), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n75_), .O(z07));
  inv1   g36(.a(x11), .O(new_n78_));
  nand2  g37(.a(new_n57_), .b(new_n78_), .O(z08));
  ...
  oai21  g42(.a(new_n83_), .b(new_n81_), .c(new_n57_), .O(z10));
  inv1   g43(.a(x17), .O(new_n85_));
  oai21  g44(.a(new_n83_), .b(new_n85_), .c(new_n57_), .O(z11));
  nand4  g45(.a(new_n57_), .b(new_n82_), .c(x23), .d(x14), .O(new_n87_));
