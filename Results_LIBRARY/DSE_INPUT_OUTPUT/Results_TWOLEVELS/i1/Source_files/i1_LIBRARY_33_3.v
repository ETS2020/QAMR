...
module FAU ( 
  ...
  nand2  g18(.a(new_n59_), .b(new_n47_), .O(z01));
  ...
  nand2  g33(.a(new_n44_), .b(x21), .O(new_n75_));
  oai21  g34(.a(x21), .b(new_n73_), .c(new_n75_), .O(z04));
  inv1   g35(.a(x10), .O(new_n77_));
  inv1   g36(.a(new_n65_), .O(new_n78_));
  inv1   g37(.a(x19), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(x08), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n66_), .c(new_n78_), .d(new_n53_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n47_), .c(new_n77_), .O(z05));
  nor2   g41(.a(new_n45_), .b(new_n79_), .O(z06));
  inv1   g42(.a(x18), .O(new_n84_));
  aoi21  g43(.a(new_n43_), .b(new_n84_), .c(new_n44_), .O(z07));
  inv1   g44(.a(x11), .O(new_n86_));
  nand2  g45(.a(new_n47_), .b(new_n86_), .O(z08));
  aoi21  g46(.a(new_n43_), .b(new_n86_), .c(new_n44_), .O(z09));
  nand2  g47(.a(x22), .b(x14), .O(new_n89_));
  nor2   g48(.a(new_n89_), .b(x24), .O(z10));
  nand3  g49(.a(new_n44_), .b(x22), .c(x17), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n47_), .O(z11));
  inv1   g51(.a(x14), .O(new_n93_));
  nand2  g52(.a(new_n44_), .b(x23), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n93_), .c(new_n47_), .O(z12));
  inv1   g54(.a(x17), .O(new_n96_));
  oai21  g55(.a(new_n94_), .b(new_n96_), .c(new_n47_), .O(z13));
  nand2  g56(.a(new_n44_), .b(x16), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n47_), .O(z14));
  inv1   g58(.a(x12), .O(new_n100_));
  inv1   g59(.a(x13), .O(new_n101_));
  nor2   g60(.a(x15), .b(x14), .O(new_n102_));
  nand4  g61(.a(new_n102_), .b(new_n47_), .c(new_n101_), .d(new_n100_), .O(z15));
endmodule
