...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    ...
    new_n92_, new_n95_, new_n97_, new_n99_, new_n100_, new_n101_,
  ...
  oai21  g33(.a(new_n73_), .b(x15), .c(new_n43_), .O(z04));
  inv1   g34(.a(new_n44_), .O(new_n76_));
  nand3  g35(.a(x19), .b(new_n66_), .c(new_n51_), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n67_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n65_), .c(x10), .O(new_n79_));
  nor2   g38(.a(new_n79_), .b(new_n76_), .O(z05));
  ...
  aoi21  g44(.a(new_n85_), .b(x00), .c(new_n76_), .O(new_n86_));
  oai21  g45(.a(new_n86_), .b(new_n70_), .c(x19), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n44_), .O(z06));
  inv1   g47(.a(x18), .O(new_n89_));
  inv1   g48(.a(x24), .O(new_n90_));
  nor3   g49(.a(new_n76_), .b(new_n90_), .c(new_n89_), .O(z07));
  inv1   g50(.a(x11), .O(new_n92_));
  nor2   g51(.a(new_n76_), .b(new_n92_), .O(z08));
  oai21  g52(.a(new_n90_), .b(new_n92_), .c(new_n44_), .O(z09));
  nand4  g53(.a(new_n44_), .b(new_n90_), .c(x22), .d(x14), .O(new_n95_));
  ...
  nand2  g58(.a(new_n44_), .b(new_n90_), .O(new_n100_));
  nor2   g59(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  ...
  nor2   g65(.a(new_n100_), .b(new_n106_), .O(z14));
  nor3   g66(.a(x14), .b(x13), .c(x12), .O(new_n108_));
  nand2  g67(.a(x21), .b(x15), .O(new_n109_));
  oai21  g68(.a(new_n108_), .b(x15), .c(new_n109_), .O(z15));
endmodule
