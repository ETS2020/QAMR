...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n92_, new_n94_, new_n96_, new_n98_, new_n99_, new_n101_, new_n103_,
  ...
  nor2   g20(.a(x10), .b(new_n42_), .O(new_n62_));
  ...
  nand3  g39(.a(new_n70_), .b(new_n65_), .c(new_n50_), .O(new_n81_));
  nand4  g40(.a(new_n66_), .b(x19), .c(new_n43_), .d(new_n54_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(z05));
  nand3  g42(.a(new_n66_), .b(new_n51_), .c(new_n69_), .O(new_n84_));
  ...
  oai21  g53(.a(new_n94_), .b(new_n92_), .c(new_n46_), .O(z09));
  nand3  g54(.a(new_n94_), .b(x22), .c(x14), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n46_), .O(z10));
  nor2   g56(.a(new_n45_), .b(x24), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(x22), .c(x17), .O(new_n99_));
  inv1   g58(.a(new_n99_), .O(z11));
  nand3  g59(.a(new_n98_), .b(x23), .c(x14), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z12));
  nand3  g61(.a(new_n94_), .b(x23), .c(x17), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n46_), .O(z13));
  nand2  g63(.a(new_n98_), .b(x16), .O(new_n105_));
