...
module FAU ( 
  ...
  nand4  g44(.a(new_n43_), .b(new_n82_), .c(x22), .d(x17), .O(new_n86_));
  inv1   g45(.a(new_n86_), .O(z11));
  nand4  g46(.a(new_n43_), .b(new_n82_), .c(x23), .d(x14), .O(new_n88_));
  ...
  nor3   g53(.a(new_n70_), .b(x13), .c(x12), .O(new_n95_));
