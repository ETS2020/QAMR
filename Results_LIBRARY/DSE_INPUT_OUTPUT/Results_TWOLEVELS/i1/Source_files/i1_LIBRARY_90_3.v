...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(x08), .c(new_n53_), .O(new_n70_));
  ...
  nand4  g38(.a(new_n62_), .b(new_n44_), .c(x19), .d(new_n79_), .O(new_n80_));
  oai22  g39(.a(new_n80_), .b(new_n78_), .c(new_n45_), .d(new_n77_), .O(z05));
  nand2  g40(.a(x24), .b(new_n79_), .O(new_n82_));
  ...
  nor3   g44(.a(new_n63_), .b(x24), .c(new_n42_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(z06));
  inv1   g46(.a(x18), .O(new_n88_));
  aoi21  g47(.a(new_n43_), .b(new_n88_), .c(new_n44_), .O(z07));
  inv1   g48(.a(x11), .O(new_n90_));
  aoi21  g49(.a(x24), .b(x19), .c(new_n90_), .O(z08));
  aoi21  g50(.a(new_n43_), .b(new_n90_), .c(new_n44_), .O(z09));
  nand3  g51(.a(new_n44_), .b(x22), .c(x14), .O(new_n93_));
  ...
  nand3  g57(.a(new_n44_), .b(x23), .c(x17), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n46_), .O(z13));
  inv1   g59(.a(x16), .O(new_n101_));
  nor2   g60(.a(x24), .b(new_n101_), .O(z14));
