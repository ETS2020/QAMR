...
module FAU ( 
  ...
  nand3  g19(.a(new_n53_), .b(new_n52_), .c(new_n60_), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(x05), .O(new_n63_));
  nor2   g22(.a(x20), .b(new_n43_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(x00), .O(new_n65_));
  nand4  g24(.a(new_n60_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n66_));
  ...
  aoi21  g30(.a(new_n71_), .b(new_n65_), .c(new_n48_), .O(z02));
  nand2  g31(.a(x21), .b(new_n44_), .O(new_n73_));
  oai21  g32(.a(new_n44_), .b(x05), .c(new_n73_), .O(z04));
  nand4  g33(.a(x19), .b(new_n69_), .c(new_n53_), .d(new_n52_), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n67_), .c(x10), .O(new_n77_));
  nand2  g36(.a(new_n44_), .b(x10), .O(new_n78_));
  oai21  g37(.a(new_n77_), .b(x05), .c(new_n78_), .O(z05));
  nor3   g38(.a(x07), .b(x06), .c(x04), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n51_), .c(new_n50_), .d(new_n49_), .O(new_n81_));
  oai21  g40(.a(new_n61_), .b(new_n59_), .c(x00), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g42(.a(new_n64_), .b(x00), .O(new_n84_));
  inv1   g43(.a(new_n84_), .O(new_n85_));
  aoi21  g44(.a(new_n83_), .b(new_n43_), .c(new_n85_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(z00), .c(new_n48_), .O(z06));
