...
module FAU ( 
  ...
  nor2   g30(.a(new_n54_), .b(x10), .O(new_n55_));
  ...
  nand2  g43(.a(x10), .b(new_n50_), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(x11), .c(x12), .d(new_n40_), .O(z3));
  nand3  g45(.a(x09), .b(x08), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n50_), .O(new_n71_));
  aoi21  g47(.a(new_n54_), .b(x07), .c(new_n55_), .O(new_n72_));
  ...
  nand4  g52(.a(new_n76_), .b(new_n74_), .c(new_n54_), .d(new_n25_), .O(z5));
  nor2   g53(.a(new_n60_), .b(new_n40_), .O(new_n78_));
  oai21  g54(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n33_), .O(new_n80_));
  nand3  g56(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(new_n78_), .O(new_n82_));
  nand2  g58(.a(x14), .b(x02), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n40_), .O(new_n84_));
  nand2  g60(.a(new_n60_), .b(x00), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(new_n33_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n82_), .c(new_n50_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n54_), .c(x10), .O(z6));
  ...
  nor2   g68(.a(new_n61_), .b(new_n27_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(x10), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n91_), .c(new_n72_), .O(z7));
  inv1   g71(.a(x12), .O(new_n96_));
  nand3  g72(.a(new_n92_), .b(new_n96_), .c(x03), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n50_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x11), .c(new_n25_), .O(z8));
endmodule
