...
module FAU ( 
  ...
  aoi21  g40(.a(new_n64_), .b(new_n50_), .c(new_n61_), .O(new_n65_));
  oai21  g41(.a(new_n60_), .b(x00), .c(new_n65_), .O(z2));
  aoi22  g42(.a(new_n54_), .b(x11), .c(x12), .d(new_n26_), .O(z3));
  ...
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n25_), .O(z4));
  inv1   g48(.a(x12), .O(new_n73_));
  nor2   g49(.a(x07), .b(x00), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(x13), .c(new_n73_), .d(new_n51_), .O(z5));
  oai21  g51(.a(new_n56_), .b(x03), .c(new_n32_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n27_), .O(new_n77_));
  nand3  g53(.a(new_n56_), .b(x03), .c(new_n32_), .O(new_n78_));
  aoi22  g54(.a(new_n78_), .b(new_n77_), .c(x08), .d(x00), .O(new_n79_));
  ...
  oai21  g60(.a(new_n84_), .b(new_n79_), .c(new_n51_), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(x07), .O(z6));
  nand3  g62(.a(new_n82_), .b(new_n50_), .c(x02), .O(new_n87_));
  nand3  g63(.a(x09), .b(x03), .c(new_n32_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(x01), .O(new_n89_));
  oai21  g65(.a(new_n48_), .b(x08), .c(new_n50_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n51_), .O(new_n91_));
  oai21  g67(.a(x11), .b(new_n51_), .c(new_n91_), .O(z7));
  nand4  g68(.a(new_n73_), .b(x03), .c(new_n32_), .d(new_n27_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n56_), .b(new_n26_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n51_), .d(new_n50_), .O(z8));
endmodule
