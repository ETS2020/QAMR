...
module FAU ( 
  ...
  nand4  g28(.a(x14), .b(new_n36_), .c(x09), .d(new_n25_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n52_), .c(new_n49_), .O(new_n55_));
  nand2  g31(.a(x14), .b(x07), .O(new_n56_));
  ...
  nand3  g37(.a(new_n61_), .b(new_n38_), .c(x02), .O(new_n62_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n38_), .O(z4));
  nand4  g47(.a(x13), .b(new_n65_), .c(new_n49_), .d(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x14), .O(new_n73_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n27_), .c(new_n25_), .O(new_n78_));
  nand3  g54(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n79_));
  nand3  g55(.a(x14), .b(new_n27_), .c(x01), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n78_), .c(new_n75_), .O(new_n82_));
  nand2  g58(.a(x09), .b(new_n26_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n27_), .c(x01), .O(new_n84_));
  aoi21  g60(.a(new_n77_), .b(new_n29_), .c(x02), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n82_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n49_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(x14), .c(x10), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n29_), .O(new_n90_));
  nand4  g66(.a(new_n36_), .b(new_n75_), .c(new_n49_), .d(x01), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x02), .O(new_n92_));
  aoi21  g68(.a(new_n49_), .b(x02), .c(new_n26_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x08), .c(new_n49_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n92_), .c(x14), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n36_), .O(z7));
  nand4  g72(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g74(.a(new_n76_), .b(new_n25_), .c(x10), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n56_), .d(new_n38_), .O(z8));
endmodule
