...
module FAU ( 
  ...
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(z3));
  ...
  nand2  g51(.a(x09), .b(new_n32_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(x10), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n74_), .c(new_n59_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x07), .c(new_n73_), .O(z4));
  nor2   g55(.a(x07), .b(x00), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x10), .c(new_n74_), .O(new_n81_));
  nor3   g57(.a(x12), .b(x07), .c(x00), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x10), .c(new_n81_), .O(z5));
  nor2   g59(.a(new_n59_), .b(new_n39_), .O(new_n84_));
  oai21  g60(.a(new_n60_), .b(x03), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n32_), .O(new_n86_));
  nand3  g62(.a(new_n60_), .b(x03), .c(new_n27_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(new_n88_));
  nand2  g64(.a(x14), .b(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n39_), .O(new_n90_));
  nand2  g66(.a(new_n59_), .b(x00), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(new_n32_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n88_), .c(new_n50_), .O(new_n93_));
  nor2   g69(.a(new_n93_), .b(x07), .O(z6));
  aoi21  g70(.a(x03), .b(new_n32_), .c(x10), .O(new_n95_));
  nor2   g71(.a(x07), .b(new_n27_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n95_), .c(new_n59_), .O(new_n97_));
  nand4  g73(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g75(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n100_));
  oai21  g76(.a(x09), .b(x00), .c(new_n49_), .O(new_n101_));
  aoi21  g77(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  nand2  g78(.a(new_n74_), .b(x10), .O(new_n103_));
