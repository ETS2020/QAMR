...
module FAU ( 
  ...
  nand3  g60(.a(new_n57_), .b(new_n47_), .c(new_n54_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n29_), .O(new_n87_));
  oai21  g63(.a(new_n26_), .b(x01), .c(new_n54_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n47_), .d(new_n46_), .O(z7));
  nand4  g65(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n47_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  nand2  g68(.a(new_n47_), .b(x07), .O(new_n93_));
  oai21  g69(.a(new_n92_), .b(x07), .c(new_n93_), .O(z8));
endmodule
