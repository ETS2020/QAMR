...
module FAU ( 
  ...
  nor2   g22(.a(new_n25_), .b(new_n38_), .O(new_n47_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n57_), .c(new_n25_), .O(new_n72_));
  ...
  nor2   g54(.a(x08), .b(new_n27_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(x01), .O(new_n80_));
  nand2  g56(.a(x08), .b(x00), .O(new_n81_));
  aoi21  g57(.a(x09), .b(new_n38_), .c(x02), .O(new_n82_));
  nand3  g58(.a(new_n67_), .b(x03), .c(new_n31_), .O(new_n83_));
  oai21  g59(.a(new_n82_), .b(x01), .c(new_n83_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  inv1   g61(.a(x14), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(x02), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n85_), .c(new_n80_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n57_), .c(new_n25_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  aoi21  g66(.a(new_n66_), .b(x02), .c(x10), .O(new_n91_));
  oai21  g67(.a(new_n38_), .b(x01), .c(new_n66_), .O(new_n92_));
  nor2   g68(.a(x02), .b(x01), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x09), .c(x03), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(new_n25_), .O(z7));
  aoi21  g71(.a(new_n25_), .b(new_n38_), .c(x12), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n93_), .c(new_n67_), .O(new_n97_));
  aoi21  g73(.a(new_n67_), .b(new_n27_), .c(new_n97_), .O(new_n98_));
