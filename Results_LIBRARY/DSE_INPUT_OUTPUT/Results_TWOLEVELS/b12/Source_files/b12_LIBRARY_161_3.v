...
module FAU ( 
  ...
  nand2  g39(.a(new_n36_), .b(new_n51_), .O(new_n64_));
  nand2  g40(.a(x12), .b(x09), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n64_), .c(x07), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n63_), .c(x00), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(new_n63_), .b(new_n50_), .c(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n36_), .O(z3));
  aoi21  g46(.a(x09), .b(x00), .c(x07), .O(new_n71_));
  nor2   g47(.a(x11), .b(new_n50_), .O(new_n72_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n74_), .c(new_n50_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n73_), .O(z4));
  nand4  g57(.a(x13), .b(new_n68_), .c(new_n50_), .d(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n57_), .O(new_n83_));
  oai21  g59(.a(new_n57_), .b(x06), .c(new_n83_), .O(z5));
  nand2  g60(.a(new_n51_), .b(x03), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n27_), .c(new_n25_), .O(new_n86_));
  nand3  g62(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n28_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n86_), .c(new_n74_), .O(new_n89_));
  oai21  g65(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n29_), .O(new_n91_));
  oai21  g67(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n92_));
  ...
  nand2  g73(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n57_), .c(new_n50_), .O(new_n99_));
  inv1   g75(.a(new_n99_), .O(z6));
  nand3  g76(.a(x09), .b(x03), .c(new_n29_), .O(new_n101_));
  nand4  g77(.a(new_n57_), .b(new_n74_), .c(new_n50_), .d(x01), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n27_), .O(new_n104_));
  oai22  g80(.a(x10), .b(x03), .c(x07), .d(new_n27_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n74_), .O(new_n106_));
  nand4  g82(.a(new_n106_), .b(new_n104_), .c(new_n57_), .d(new_n50_), .O(z7));
  oai21  g83(.a(x12), .b(new_n51_), .c(new_n25_), .O(new_n108_));
  nand3  g84(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n109_));
  aoi21  g85(.a(new_n109_), .b(x09), .c(x07), .O(new_n110_));
  nand4  g86(.a(x12), .b(x09), .c(new_n50_), .d(x00), .O(new_n111_));
  nand4  g87(.a(new_n111_), .b(new_n110_), .c(new_n108_), .d(new_n57_), .O(z8));
endmodule
