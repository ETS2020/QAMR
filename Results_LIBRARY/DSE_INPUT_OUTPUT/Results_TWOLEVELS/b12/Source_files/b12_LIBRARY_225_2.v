...
module FAU ( 
  ...
  nor2   g15(.a(x14), .b(new_n29_), .O(new_n40_));
  nor3   g16(.a(new_n40_), .b(x02), .c(new_n28_), .O(new_n41_));
  nand2  g17(.a(x06), .b(x01), .O(new_n42_));
  nand2  g18(.a(new_n42_), .b(x14), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(x05), .c(new_n32_), .O(new_n44_));
  oai21  g20(.a(new_n44_), .b(new_n41_), .c(x03), .O(new_n45_));
  nand2  g21(.a(new_n43_), .b(x05), .O(new_n46_));
  nand3  g22(.a(new_n46_), .b(x04), .c(x02), .O(new_n47_));
  aoi21  g23(.a(new_n47_), .b(new_n45_), .c(x00), .O(z1));
  nand2  g24(.a(new_n35_), .b(x03), .O(new_n49_));
  inv1   g25(.a(x07), .O(new_n50_));
  inv1   g26(.a(x10), .O(new_n51_));
  aoi22  g27(.a(x14), .b(x03), .c(new_n51_), .d(new_n50_), .O(new_n52_));
  nand4  g28(.a(new_n52_), .b(new_n49_), .c(new_n30_), .d(new_n28_), .O(new_n53_));
  ...
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n28_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n32_), .c(x08), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n50_), .c(new_n40_), .O(new_n66_));
  ...
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n40_), .O(z4));
  aoi21  g51(.a(new_n50_), .b(x00), .c(x12), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n55_), .c(new_n26_), .d(x13), .O(z5));
  ...
  aoi21  g57(.a(new_n61_), .b(x03), .c(x01), .O(new_n82_));
  inv1   g58(.a(x03), .O(new_n83_));
  nand3  g59(.a(x09), .b(new_n83_), .c(new_n28_), .O(new_n84_));
  oai21  g60(.a(new_n82_), .b(x02), .c(new_n84_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n81_), .O(new_n86_));
  nand3  g62(.a(new_n25_), .b(x01), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n80_), .O(new_n88_));
  ...
  oai21  g71(.a(x07), .b(new_n32_), .c(x03), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n92_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n95_), .c(new_n55_), .d(new_n26_), .O(z7));
  nand4  g74(.a(new_n69_), .b(x03), .c(new_n32_), .d(new_n28_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nor2   g76(.a(x09), .b(x00), .O(new_n101_));
  nor3   g77(.a(new_n101_), .b(x10), .c(x07), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(new_n100_), .c(new_n40_), .O(z8));
endmodule
