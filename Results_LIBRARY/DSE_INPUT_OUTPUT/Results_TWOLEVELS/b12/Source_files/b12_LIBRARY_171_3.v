...
module FAU ( 
  ...
  xor2a  g25(.a(x10), .b(x07), .O(new_n50_));
  ...
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(z6));
  nand3  g63(.a(new_n55_), .b(new_n46_), .c(x02), .O(new_n88_));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n47_), .O(new_n91_));
  aoi21  g67(.a(x03), .b(new_n29_), .c(x08), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n46_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n91_), .O(z7));
  nand4  g70(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  nand2  g72(.a(new_n56_), .b(new_n37_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n47_), .d(new_n46_), .O(z8));
endmodule
