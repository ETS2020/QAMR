...
module FAU ( 
  ...
  nand3  g21(.a(new_n45_), .b(new_n26_), .c(x02), .O(new_n46_));
  inv1   g22(.a(new_n46_), .O(new_n47_));
  nor2   g23(.a(x10), .b(x07), .O(new_n48_));
  nor3   g24(.a(new_n48_), .b(x03), .c(x01), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n47_), .c(new_n38_), .O(new_n50_));
  inv1   g26(.a(x07), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nand3  g28(.a(x10), .b(new_n52_), .c(new_n27_), .O(new_n53_));
  nand2  g29(.a(new_n25_), .b(x09), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n53_), .c(x01), .O(new_n55_));
  nor2   g31(.a(x08), .b(new_n28_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n55_), .c(new_n51_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n50_), .c(new_n26_), .O(z2));
  ...
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n26_), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n51_), .d(new_n38_), .O(new_n69_));
  ...
  oai21  g50(.a(new_n74_), .b(x03), .c(new_n28_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n30_), .O(new_n76_));
  nand2  g52(.a(x02), .b(x00), .O(new_n77_));
  nand3  g53(.a(new_n74_), .b(x03), .c(new_n28_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n73_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n25_), .c(new_n52_), .d(new_n51_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand2  g57(.a(x05), .b(x01), .O(new_n82_));
  oai21  g58(.a(x05), .b(new_n27_), .c(new_n82_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n38_), .O(new_n84_));
  nand2  g60(.a(x01), .b(new_n38_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n25_), .c(new_n51_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n84_), .c(new_n28_), .O(new_n87_));
  oai21  g63(.a(new_n29_), .b(x10), .c(new_n51_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(new_n52_), .O(new_n89_));
  nand3  g65(.a(x09), .b(new_n51_), .c(new_n30_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n25_), .c(new_n52_), .d(x03), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n89_), .O(z7));
  nand3  g69(.a(new_n48_), .b(new_n27_), .c(new_n30_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n68_), .c(new_n28_), .d(new_n30_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n51_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x08), .c(new_n25_), .O(z8));
endmodule
