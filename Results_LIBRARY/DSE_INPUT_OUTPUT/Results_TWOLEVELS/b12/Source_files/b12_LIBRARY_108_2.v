...
module FAU ( 
  ...
  oai21  g43(.a(new_n65_), .b(new_n25_), .c(x07), .O(new_n68_));
  nand3  g44(.a(x09), .b(x08), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n57_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n68_), .O(z4));
  inv1   g47(.a(x12), .O(new_n72_));
  nand3  g48(.a(x13), .b(new_n72_), .c(new_n40_), .O(new_n73_));
  ...
  nand2  g68(.a(new_n25_), .b(new_n57_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(new_n58_), .c(new_n93_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n91_), .O(z7));
  nand4  g71(.a(new_n72_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g73(.a(new_n50_), .b(new_n40_), .c(new_n93_), .O(new_n98_));
