...
module FAU ( 
  ...
  nand2  g29(.a(x13), .b(x10), .O(new_n54_));
  ...
  oai21  g46(.a(new_n67_), .b(new_n26_), .c(new_n70_), .O(z3));
  ...
  nand4  g51(.a(x13), .b(new_n65_), .c(new_n46_), .d(new_n39_), .O(new_n76_));
  ...
  nand4  g67(.a(new_n25_), .b(new_n47_), .c(new_n46_), .d(x02), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n31_), .O(new_n94_));
  oai21  g70(.a(new_n28_), .b(x01), .c(new_n47_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand3  g72(.a(x03), .b(new_n29_), .c(new_n31_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n25_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n65_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(new_n53_), .b(new_n39_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n25_), .d(new_n46_), .O(z8));
endmodule
