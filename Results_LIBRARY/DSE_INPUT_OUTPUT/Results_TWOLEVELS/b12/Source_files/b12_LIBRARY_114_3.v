...
module FAU ( 
  ...
  nand3  g63(.a(new_n87_), .b(x01), .c(new_n25_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n82_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n37_), .c(new_n36_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n27_), .O(new_n92_));
  nand2  g68(.a(new_n37_), .b(new_n59_), .O(new_n93_));
  ...
  nor2   g72(.a(new_n96_), .b(new_n54_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n95_), .O(z7));
  nand4  g74(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  aoi21  g76(.a(new_n83_), .b(new_n25_), .c(x10), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n100_), .c(new_n36_), .O(z8));
endmodule
