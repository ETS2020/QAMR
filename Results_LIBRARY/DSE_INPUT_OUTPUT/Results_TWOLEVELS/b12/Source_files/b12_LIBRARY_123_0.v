...
module FAU ( 
  ...
  nand3  g60(.a(new_n84_), .b(new_n26_), .c(new_n81_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(x00), .c(new_n25_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n80_), .c(new_n53_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n79_), .O(z4));
  nand4  g64(.a(x13), .b(new_n73_), .c(new_n53_), .d(new_n40_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x05), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n26_), .O(z5));
  oai21  g67(.a(x09), .b(new_n29_), .c(new_n33_), .O(new_n92_));
  nor2   g68(.a(x02), .b(x00), .O(new_n93_));
  nor2   g69(.a(x08), .b(new_n40_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nand2  g71(.a(x08), .b(x00), .O(new_n96_));
  oai21  g72(.a(new_n82_), .b(x03), .c(new_n41_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n96_), .c(new_n33_), .O(new_n98_));
  inv1   g74(.a(x14), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(x01), .c(new_n40_), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(new_n98_), .c(new_n95_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n26_), .c(new_n53_), .d(x05), .O(new_n102_));
  inv1   g78(.a(new_n102_), .O(z6));
  nand3  g79(.a(x09), .b(x03), .c(new_n41_), .O(new_n104_));
  nand4  g80(.a(new_n26_), .b(new_n81_), .c(new_n53_), .d(x02), .O(new_n105_));
  aoi21  g81(.a(new_n105_), .b(new_n104_), .c(x01), .O(new_n106_));
  oai21  g82(.a(new_n29_), .b(x01), .c(new_n81_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(new_n53_), .O(new_n108_));
  oai21  g84(.a(new_n108_), .b(new_n106_), .c(x05), .O(new_n109_));
  nand2  g85(.a(new_n109_), .b(new_n26_), .O(z7));
  nand4  g86(.a(new_n73_), .b(x03), .c(new_n41_), .d(new_n33_), .O(new_n111_));
  oai21  g87(.a(x09), .b(x00), .c(new_n53_), .O(new_n112_));
  aoi21  g88(.a(new_n111_), .b(x09), .c(new_n112_), .O(new_n113_));
  oai21  g89(.a(new_n113_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
