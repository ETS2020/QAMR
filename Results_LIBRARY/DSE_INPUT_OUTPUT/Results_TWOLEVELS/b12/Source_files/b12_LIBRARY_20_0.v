...
module FAU ( 
  ...
  oai21  g39(.a(new_n63_), .b(new_n51_), .c(x00), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n57_), .c(new_n63_), .O(new_n66_));
  nand3  g42(.a(new_n65_), .b(new_n51_), .c(new_n25_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n64_), .O(z3));
  nand3  g44(.a(x09), .b(x08), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n51_), .O(new_n70_));
  oai21  g46(.a(new_n57_), .b(x07), .c(new_n63_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  inv1   g48(.a(x13), .O(new_n73_));
  aoi21  g49(.a(x12), .b(new_n25_), .c(new_n73_), .O(new_n74_));
  nor2   g50(.a(new_n63_), .b(x10), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n74_), .c(new_n51_), .d(new_n25_), .O(z5));
  ...
  oai21  g56(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n81_));
  ...
  aoi21  g63(.a(new_n87_), .b(x11), .c(x10), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  inv1   g65(.a(x08), .O(new_n90_));
  nand4  g66(.a(new_n57_), .b(new_n90_), .c(new_n51_), .d(x02), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n29_), .O(new_n93_));
  oai21  g69(.a(new_n26_), .b(x01), .c(new_n90_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n75_), .d(new_n51_), .O(z7));
  nand4  g71(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g73(.a(new_n52_), .b(new_n25_), .c(x07), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n97_), .c(new_n75_), .O(z8));
endmodule
