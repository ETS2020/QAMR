...
module FAU ( 
  ...
  aoi21  g42(.a(x09), .b(new_n38_), .c(x02), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(x03), .c(new_n31_), .O(new_n69_));
  ...
  oai21  g49(.a(x08), .b(new_n27_), .c(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(x01), .c(x07), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n71_), .c(x10), .O(z6));
  nand3  g52(.a(x03), .b(new_n31_), .c(new_n28_), .O(new_n77_));
  nor2   g53(.a(x02), .b(x01), .O(new_n78_));
  nor2   g54(.a(new_n68_), .b(new_n38_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .d(new_n53_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x07), .c(new_n25_), .O(z7));
  inv1   g57(.a(x12), .O(new_n82_));
  nand3  g58(.a(new_n78_), .b(new_n82_), .c(x03), .O(new_n83_));
