...
module FAU ( 
  ...
  nand2  g43(.a(new_n52_), .b(x11), .O(new_n68_));
  oai21  g44(.a(new_n67_), .b(x00), .c(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n26_), .O(z3));
  nand2  g46(.a(x08), .b(x00), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(x09), .c(new_n27_), .O(new_n72_));
  oai21  g48(.a(new_n34_), .b(new_n37_), .c(new_n27_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n48_), .O(new_n74_));
  nor2   g50(.a(x08), .b(new_n27_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(x00), .c(new_n63_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n51_), .c(new_n25_), .O(new_n78_));
  inv1   g54(.a(x11), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x07), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n78_), .O(z4));
  nor2   g57(.a(x07), .b(new_n48_), .O(new_n82_));
  nand2  g58(.a(x13), .b(new_n67_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(new_n51_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(z5));
  ...
  nand3  g66(.a(new_n90_), .b(new_n71_), .c(new_n27_), .O(new_n91_));
  ...
  nand4  g76(.a(new_n67_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n101_));
