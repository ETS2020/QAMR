...
module FAU ( 
  ...
  nand2  g44(.a(new_n68_), .b(new_n56_), .O(new_n69_));
  nand2  g45(.a(new_n64_), .b(x07), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n37_), .O(z4));
  nand4  g47(.a(x13), .b(new_n65_), .c(new_n56_), .d(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n52_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n50_), .O(z5));
  oai21  g50(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n75_));
  nand2  g51(.a(new_n27_), .b(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n48_), .b(x00), .O(new_n77_));
  ...
  aoi21  g58(.a(new_n82_), .b(new_n79_), .c(x10), .O(new_n83_));
  nand3  g59(.a(new_n36_), .b(x02), .c(new_n25_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n83_), .c(new_n56_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n37_), .O(z6));
  nand3  g63(.a(new_n48_), .b(new_n56_), .c(x02), .O(new_n88_));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n26_), .b(x01), .c(new_n48_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n56_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n90_), .c(new_n52_), .O(new_n93_));
  ...
  nand2  g72(.a(new_n49_), .b(new_n25_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n52_), .d(new_n56_), .O(z8));
endmodule
