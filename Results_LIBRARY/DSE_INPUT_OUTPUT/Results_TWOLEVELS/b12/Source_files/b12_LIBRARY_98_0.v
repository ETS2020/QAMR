...
module FAU ( 
  ...
  nand2  g26(.a(new_n36_), .b(x03), .O(new_n51_));
  nand2  g27(.a(new_n27_), .b(x01), .O(new_n52_));
  inv1   g28(.a(x07), .O(new_n53_));
  nand3  g29(.a(new_n26_), .b(new_n53_), .c(x05), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(x04), .c(new_n33_), .O(new_n56_));
  nand2  g32(.a(new_n25_), .b(x04), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n56_), .c(new_n52_), .d(new_n51_), .O(new_n58_));
  oai21  g34(.a(x10), .b(x07), .c(new_n29_), .O(new_n59_));
  nand3  g35(.a(new_n26_), .b(x09), .c(new_n53_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(x01), .O(new_n61_));
  aoi21  g37(.a(new_n58_), .b(x02), .c(new_n61_), .O(new_n62_));
  nand2  g38(.a(x10), .b(new_n29_), .O(new_n63_));
  nand3  g39(.a(new_n26_), .b(x09), .c(x05), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n33_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n41_), .c(x08), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n53_), .c(new_n30_), .O(new_n68_));
  oai21  g44(.a(new_n62_), .b(x00), .c(new_n68_), .O(z2));
  inv1   g45(.a(x12), .O(new_n70_));
  nand2  g46(.a(x11), .b(x07), .O(new_n71_));
  oai21  g47(.a(new_n70_), .b(x00), .c(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n39_), .O(z3));
  aoi21  g49(.a(x09), .b(x00), .c(x07), .O(new_n74_));
  nor2   g50(.a(x11), .b(new_n53_), .O(new_n75_));
  ...
  nand3  g56(.a(new_n80_), .b(new_n26_), .c(x05), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n26_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n77_), .c(new_n53_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n76_), .O(z4));
  nor2   g60(.a(x10), .b(x00), .O(new_n85_));
  inv1   g61(.a(x13), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(x05), .c(x12), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n85_), .c(new_n39_), .d(new_n53_), .O(z5));
  oai21  g64(.a(x09), .b(new_n29_), .c(new_n33_), .O(new_n89_));
  nor2   g65(.a(x02), .b(x00), .O(new_n90_));
  nor2   g66(.a(x08), .b(new_n40_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  oai21  g68(.a(new_n78_), .b(x03), .c(new_n41_), .O(new_n93_));
  nand2  g69(.a(x08), .b(x00), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n33_), .O(new_n95_));
  inv1   g71(.a(x14), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(x01), .c(new_n40_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n95_), .c(new_n92_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n26_), .c(new_n53_), .d(x05), .O(new_n99_));
  inv1   g75(.a(new_n99_), .O(z6));
  nand3  g76(.a(x09), .b(x03), .c(new_n41_), .O(new_n101_));
  nand2  g77(.a(x05), .b(x02), .O(new_n102_));
  nand3  g78(.a(new_n26_), .b(new_n77_), .c(new_n53_), .O(new_n103_));
  oai21  g79(.a(new_n103_), .b(new_n102_), .c(new_n101_), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(new_n33_), .O(new_n105_));
  oai21  g81(.a(new_n29_), .b(x01), .c(new_n77_), .O(new_n106_));
  nor2   g82(.a(x10), .b(new_n25_), .O(new_n107_));
  nand4  g83(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n53_), .O(z7));
  nand4  g84(.a(new_n70_), .b(x03), .c(new_n41_), .d(new_n33_), .O(new_n109_));
  nand2  g85(.a(new_n109_), .b(x09), .O(new_n110_));
  nand3  g86(.a(new_n78_), .b(x05), .c(new_n40_), .O(new_n111_));
  nand4  g87(.a(new_n111_), .b(new_n110_), .c(new_n107_), .d(new_n53_), .O(z8));
endmodule
