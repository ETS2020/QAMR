...
module FAU ( 
  ...
  aoi21  g33(.a(x09), .b(new_n28_), .c(x02), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(x08), .c(new_n57_), .O(new_n59_));
  ...
  aoi21  g42(.a(new_n66_), .b(x01), .c(new_n27_), .O(new_n67_));
  nand3  g43(.a(x09), .b(new_n66_), .c(new_n28_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n67_), .c(new_n57_), .d(x09), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n64_), .O(z4));
  ...
  nand2  g59(.a(new_n66_), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(new_n28_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(new_n57_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x07), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n31_), .O(new_n88_));
  nand2  g64(.a(new_n25_), .b(x02), .O(new_n89_));
  nand2  g65(.a(new_n57_), .b(new_n66_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n28_), .O(new_n92_));
  oai21  g68(.a(new_n38_), .b(x01), .c(new_n66_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n57_), .d(new_n25_), .O(z7));
  inv1   g70(.a(x12), .O(new_n95_));
  nand4  g71(.a(new_n89_), .b(new_n95_), .c(x03), .d(new_n28_), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  aoi21  g73(.a(new_n96_), .b(x09), .c(new_n97_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x10), .c(new_n25_), .O(z8));
endmodule
