...
module FAU ( 
  ...
  nand2  g23(.a(x14), .b(x10), .O(new_n48_));
  ...
  nor2   g42(.a(x10), .b(x00), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x14), .c(new_n66_), .O(new_n68_));
  oai22  g44(.a(new_n68_), .b(x07), .c(new_n65_), .d(new_n62_), .O(z3));
  nor2   g45(.a(x09), .b(x07), .O(new_n70_));
  nor2   g46(.a(x11), .b(new_n54_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n70_), .c(new_n26_), .O(new_n72_));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nor2   g49(.a(x09), .b(x01), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x08), .c(x00), .O(new_n75_));
  aoi22  g51(.a(new_n75_), .b(new_n50_), .c(new_n73_), .d(x14), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x07), .c(new_n72_), .O(z4));
  nand4  g53(.a(x13), .b(new_n66_), .c(new_n54_), .d(new_n27_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n50_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n48_), .O(z5));
  ...
  oai21  g60(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n73_), .c(new_n28_), .O(new_n86_));
  nand3  g62(.a(new_n25_), .b(x01), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n50_), .c(new_n54_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  nor2   g66(.a(x02), .b(x01), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x07), .c(x03), .O(new_n92_));
  nand3  g68(.a(new_n91_), .b(x09), .c(x03), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  aoi21  g70(.a(new_n92_), .b(new_n46_), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n48_), .O(z7));
  aoi21  g72(.a(new_n47_), .b(new_n27_), .c(x07), .O(new_n97_));
  nand3  g73(.a(new_n91_), .b(new_n66_), .c(x03), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n97_), .c(new_n50_), .O(z8));
endmodule
