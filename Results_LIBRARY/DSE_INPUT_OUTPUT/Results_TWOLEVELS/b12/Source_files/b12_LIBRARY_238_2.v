...
module FAU ( 
  ...
  nor2   g30(.a(x14), .b(new_n51_), .O(new_n55_));
  ...
  nand4  g53(.a(x13), .b(new_n77_), .c(new_n50_), .d(new_n40_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  oai21  g55(.a(new_n25_), .b(new_n51_), .c(new_n79_), .O(z5));
  nor2   g56(.a(new_n60_), .b(new_n40_), .O(new_n81_));
  oai21  g57(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n33_), .O(new_n83_));
  nand3  g59(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(new_n81_), .O(new_n85_));
  oai21  g61(.a(new_n25_), .b(new_n28_), .c(new_n40_), .O(new_n86_));
  nand2  g62(.a(new_n60_), .b(x00), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(new_n33_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n85_), .c(new_n51_), .O(new_n89_));
  nor2   g65(.a(new_n89_), .b(x07), .O(z6));
  nand2  g66(.a(new_n50_), .b(x02), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x03), .c(new_n33_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n60_), .O(new_n93_));
  nand4  g69(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand3  g71(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n51_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n77_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  nand2  g75(.a(new_n61_), .b(new_n40_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n51_), .d(new_n50_), .O(z8));
endmodule
