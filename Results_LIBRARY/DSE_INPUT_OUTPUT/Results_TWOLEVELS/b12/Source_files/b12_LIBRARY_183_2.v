...
module FAU ( 
  ...
  aoi21  g50(.a(new_n74_), .b(new_n27_), .c(x00), .O(new_n75_));
  aoi21  g51(.a(new_n74_), .b(new_n61_), .c(x08), .O(new_n76_));
  ...
  nand3  g55(.a(new_n78_), .b(new_n57_), .c(x03), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x00), .c(new_n80_), .O(new_n81_));
  nor2   g57(.a(x14), .b(x00), .O(new_n82_));
  aoi21  g58(.a(new_n57_), .b(x00), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n29_), .c(new_n36_), .O(new_n84_));
  aoi21  g60(.a(new_n81_), .b(new_n27_), .c(new_n84_), .O(new_n85_));
  ...
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n36_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n53_), .O(z7));
  inv1   g68(.a(x12), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n94_));
