...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(x00), .c(new_n62_), .d(new_n46_), .O(new_n64_));
  ...
  nand4  g45(.a(x13), .b(new_n63_), .c(new_n46_), .d(new_n37_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n47_), .O(new_n71_));
  oai21  g47(.a(x14), .b(new_n47_), .c(new_n71_), .O(z5));
  ...
  oai21  g52(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n77_));
  ...
  nand2  g60(.a(new_n46_), .b(x02), .O(new_n85_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n47_), .d(new_n46_), .O(z7));
  nand4  g65(.a(new_n63_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand2  g67(.a(new_n55_), .b(new_n37_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n47_), .d(new_n46_), .O(z8));
endmodule
