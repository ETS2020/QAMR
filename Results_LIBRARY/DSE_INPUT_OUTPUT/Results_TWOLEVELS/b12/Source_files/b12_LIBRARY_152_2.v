...
module FAU ( 
  ...
  nand3  g22(.a(x10), .b(new_n28_), .c(new_n31_), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n29_), .O(new_n48_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n54_), .c(new_n31_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n49_), .c(new_n26_), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(x00), .c(new_n60_), .O(new_n62_));
  oai21  g38(.a(new_n26_), .b(new_n39_), .c(x12), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n51_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n27_), .O(z3));
  nand3  g41(.a(x09), .b(x08), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n51_), .O(new_n67_));
  nand2  g43(.a(new_n60_), .b(x07), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n27_), .O(z4));
  nand3  g45(.a(new_n52_), .b(new_n51_), .c(new_n39_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n27_), .O(new_n71_));
  nand4  g47(.a(new_n52_), .b(x09), .c(new_n51_), .d(new_n31_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(x09), .c(x00), .O(new_n73_));
  nand3  g49(.a(x09), .b(new_n51_), .c(x01), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n25_), .O(new_n76_));
  nand3  g52(.a(x14), .b(x12), .c(new_n51_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n71_), .O(z5));
  nor2   g54(.a(new_n55_), .b(new_n39_), .O(new_n79_));
  xor2a  g55(.a(x09), .b(x03), .O(new_n80_));
  nor2   g56(.a(new_n29_), .b(x01), .O(new_n81_));
  aoi21  g57(.a(new_n80_), .b(new_n29_), .c(new_n81_), .O(new_n82_));
  ...
  nand2  g63(.a(new_n87_), .b(new_n27_), .O(z6));
  nand2  g64(.a(new_n51_), .b(x02), .O(new_n89_));
  ...
  aoi21  g68(.a(new_n90_), .b(new_n55_), .c(new_n92_), .O(new_n93_));
  nor2   g69(.a(new_n93_), .b(new_n26_), .O(z7));
  inv1   g70(.a(x09), .O(new_n95_));
  oai21  g71(.a(x12), .b(x02), .c(x09), .O(new_n96_));
  nand2  g72(.a(new_n95_), .b(new_n39_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n52_), .d(new_n51_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n27_), .O(new_n99_));
  inv1   g75(.a(x14), .O(new_n100_));
  oai21  g76(.a(x13), .b(x07), .c(new_n100_), .O(new_n101_));
  oai21  g77(.a(new_n100_), .b(x07), .c(x13), .O(new_n102_));
  aoi22  g78(.a(new_n102_), .b(new_n28_), .c(new_n101_), .d(x01), .O(new_n103_));
  oai21  g79(.a(new_n103_), .b(new_n95_), .c(new_n99_), .O(z8));
endmodule
