...
module FAU ( 
  ...
  nand4  g28(.a(x13), .b(new_n36_), .c(x09), .d(new_n25_), .O(new_n53_));
  ...
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n36_), .d(new_n49_), .O(z5));
  ...
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n75_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(x13), .c(new_n36_), .d(new_n49_), .O(new_n85_));
  ...
  nand3  g65(.a(x13), .b(new_n36_), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n87_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n29_), .O(new_n92_));
  aoi21  g68(.a(x03), .b(new_n29_), .c(x08), .O(new_n93_));
  nor4   g69(.a(new_n93_), .b(new_n37_), .c(x10), .d(x07), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n92_), .O(z7));
  oai21  g71(.a(new_n26_), .b(x02), .c(new_n49_), .O(new_n96_));
  nor2   g72(.a(x12), .b(x01), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(new_n78_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n49_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n98_), .c(x13), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n36_), .O(z8));
endmodule
