...
module FAU ( 
  ...
  aoi21  g44(.a(x11), .b(new_n50_), .c(new_n68_), .O(new_n69_));
  aoi21  g45(.a(x12), .b(new_n40_), .c(new_n69_), .O(z3));
  nor2   g46(.a(new_n61_), .b(new_n40_), .O(new_n71_));
  or2    g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g48(.a(x01), .b(x00), .O(new_n73_));
  oai21  g49(.a(new_n61_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n60_), .c(new_n50_), .O(new_n77_));
  nand2  g53(.a(new_n68_), .b(x07), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(z4));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(x13), .b(new_n80_), .c(new_n51_), .d(new_n50_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(new_n82_));
  oai21  g58(.a(new_n69_), .b(new_n40_), .c(new_n82_), .O(z5));
  ...
  nor2   g65(.a(x08), .b(new_n40_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n51_), .c(new_n50_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n26_), .O(z6));
  nand3  g70(.a(new_n60_), .b(new_n50_), .c(x02), .O(new_n95_));
  nand3  g71(.a(x09), .b(x03), .c(new_n28_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x01), .O(new_n97_));
  oai21  g73(.a(new_n27_), .b(x01), .c(new_n60_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n50_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n97_), .c(new_n51_), .O(new_n100_));
  nand2  g76(.a(x11), .b(x10), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n100_), .O(z7));
  oai21  g78(.a(new_n27_), .b(x02), .c(new_n50_), .O(new_n103_));
  nor2   g79(.a(x12), .b(x01), .O(new_n104_));
  aoi21  g80(.a(new_n104_), .b(new_n103_), .c(new_n61_), .O(new_n105_));
  oai21  g81(.a(x09), .b(x00), .c(new_n50_), .O(new_n106_));
  oai21  g82(.a(new_n106_), .b(new_n105_), .c(new_n51_), .O(new_n107_));
