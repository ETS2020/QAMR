...
module FAU ( 
  ...
  nand3  g31(.a(new_n52_), .b(x09), .c(x06), .O(new_n56_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n52_), .c(new_n74_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(x00), .c(new_n73_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n72_), .c(new_n51_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n71_), .O(z4));
  nand4  g57(.a(x13), .b(new_n65_), .c(new_n51_), .d(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x06), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n52_), .O(z5));
  nand2  g60(.a(x06), .b(x01), .O(new_n85_));
  nand2  g61(.a(new_n75_), .b(x03), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(new_n25_), .O(new_n87_));
  nand2  g63(.a(x06), .b(x02), .O(new_n88_));
  nand2  g64(.a(x09), .b(new_n26_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n87_), .c(new_n74_), .O(new_n91_));
  nand2  g67(.a(x14), .b(x02), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x01), .O(new_n93_));
  oai21  g69(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n29_), .O(new_n95_));
  nand3  g71(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n96_));
  ...
  nand2  g75(.a(new_n99_), .b(new_n51_), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(x06), .c(x10), .O(z6));
  nand3  g77(.a(x09), .b(x03), .c(new_n27_), .O(new_n102_));
  nand4  g78(.a(new_n52_), .b(new_n74_), .c(new_n51_), .d(x02), .O(new_n103_));
  aoi21  g79(.a(new_n103_), .b(new_n102_), .c(x01), .O(new_n104_));
  oai21  g80(.a(new_n26_), .b(x01), .c(new_n74_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n51_), .O(new_n106_));
  oai21  g82(.a(new_n106_), .b(new_n104_), .c(x06), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(new_n52_), .O(z7));
  nand4  g84(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n109_));
  nand2  g85(.a(new_n109_), .b(x09), .O(new_n110_));
  aoi22  g86(.a(new_n75_), .b(new_n25_), .c(x07), .d(x06), .O(new_n111_));
  nand4  g87(.a(new_n111_), .b(new_n110_), .c(new_n52_), .d(x06), .O(z8));
endmodule
