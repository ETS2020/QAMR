...
module FAU ( 
  ...
  nand3  g26(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(x01), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n49_), .c(new_n37_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n29_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n27_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n54_), .c(new_n46_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n53_), .c(new_n25_), .O(z2));
  ...
  nor2   g42(.a(x11), .b(new_n46_), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n66_), .c(new_n25_), .O(new_n68_));
  inv1   g44(.a(x13), .O(new_n69_));
  nand2  g45(.a(x01), .b(x00), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n29_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n70_), .c(x10), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n69_), .c(new_n54_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x07), .c(new_n68_), .O(z4));
  nor2   g50(.a(x07), .b(x00), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x10), .c(new_n69_), .O(new_n76_));
  nor3   g52(.a(x12), .b(x07), .c(x00), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x10), .c(new_n76_), .O(z5));
  ...
  oai21  g58(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n83_));
  nand2  g59(.a(x08), .b(x00), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n29_), .O(new_n85_));
  ...
  nand3  g66(.a(new_n54_), .b(new_n46_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n27_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  oai21  g69(.a(new_n26_), .b(x01), .c(new_n54_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n46_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(new_n47_), .O(new_n96_));
  nand2  g72(.a(new_n69_), .b(x10), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n96_), .O(z7));
  nand4  g74(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n99_));
  oai21  g75(.a(x09), .b(x00), .c(new_n46_), .O(new_n100_));
  aoi21  g76(.a(new_n99_), .b(x09), .c(new_n100_), .O(new_n101_));
  oai21  g77(.a(new_n101_), .b(x10), .c(new_n97_), .O(z8));
endmodule
