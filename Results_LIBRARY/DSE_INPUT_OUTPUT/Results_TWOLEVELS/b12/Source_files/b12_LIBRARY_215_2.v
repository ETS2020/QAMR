...
module FAU ( 
  ...
  oai21  g40(.a(new_n61_), .b(new_n46_), .c(new_n64_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n66_), .c(new_n38_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n25_), .O(z5));
  ...
  oai21  g61(.a(new_n27_), .b(x01), .c(new_n47_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand4  g63(.a(new_n66_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n88_));
  nor2   g64(.a(x09), .b(x00), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n25_), .O(z8));
endmodule
