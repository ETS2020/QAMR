...
module FAU ( 
  ...
  nand2  g34(.a(x12), .b(new_n39_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n58_), .c(new_n27_), .O(new_n60_));
  inv1   g36(.a(new_n60_), .O(z3));
  inv1   g37(.a(x11), .O(new_n62_));
  nand3  g38(.a(new_n27_), .b(new_n62_), .c(x07), .O(new_n63_));
  aoi21  g39(.a(x08), .b(x00), .c(new_n25_), .O(new_n64_));
  nor2   g40(.a(new_n26_), .b(x09), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n63_), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n49_), .d(new_n39_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x09), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(z5));
  oai21  g47(.a(x02), .b(x01), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n28_), .b(new_n31_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(x08), .O(new_n74_));
  nand2  g50(.a(x14), .b(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x01), .O(new_n76_));
  oai21  g52(.a(new_n28_), .b(x02), .c(new_n31_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(x00), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n74_), .c(new_n49_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x09), .c(x10), .O(z6));
  nor2   g56(.a(new_n53_), .b(x07), .O(new_n81_));
  nand2  g57(.a(new_n42_), .b(new_n31_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n26_), .d(x09), .O(z7));
  nand3  g59(.a(new_n68_), .b(new_n49_), .c(x03), .O(new_n84_));
  nor3   g60(.a(new_n84_), .b(x02), .c(x01), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
