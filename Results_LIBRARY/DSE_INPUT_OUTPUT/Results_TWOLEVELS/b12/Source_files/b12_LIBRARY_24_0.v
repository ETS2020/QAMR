...
module FAU ( 
  ...
  nand2  g36(.a(x10), .b(new_n27_), .O(new_n61_));
  nand3  g37(.a(x13), .b(new_n50_), .c(x09), .O(new_n62_));
  ...
  aoi21  g41(.a(new_n65_), .b(new_n49_), .c(new_n25_), .O(new_n66_));
  ...
  nor2   g48(.a(x11), .b(new_n49_), .O(new_n73_));
  ...
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x10), .c(new_n75_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x07), .c(new_n74_), .O(z4));
  nor3   g57(.a(x12), .b(x07), .c(x00), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n76_), .c(new_n50_), .O(z5));
  nand2  g59(.a(x08), .b(x00), .O(new_n84_));
  aoi21  g60(.a(x09), .b(new_n27_), .c(x02), .O(new_n85_));
  inv1   g61(.a(x09), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(x03), .c(new_n28_), .O(new_n87_));
  oai21  g63(.a(new_n85_), .b(x01), .c(new_n87_), .O(new_n88_));
  ...
  nand4  g69(.a(new_n93_), .b(x13), .c(new_n50_), .d(new_n49_), .O(new_n94_));
  inv1   g70(.a(new_n94_), .O(z6));
  aoi21  g71(.a(x03), .b(new_n33_), .c(new_n76_), .O(new_n96_));
  nor2   g72(.a(x07), .b(new_n28_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(new_n75_), .O(new_n98_));
  nor2   g74(.a(x02), .b(x01), .O(new_n99_));
  nor2   g75(.a(new_n86_), .b(new_n27_), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(new_n99_), .c(x10), .O(new_n101_));
  aoi21  g77(.a(x13), .b(x07), .c(new_n25_), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n101_), .c(new_n98_), .O(z7));
  nand3  g79(.a(new_n99_), .b(new_n68_), .c(x03), .O(new_n104_));
  oai21  g80(.a(x09), .b(x00), .c(new_n49_), .O(new_n105_));
  aoi21  g81(.a(new_n104_), .b(x09), .c(new_n105_), .O(new_n106_));
  oai21  g82(.a(new_n106_), .b(new_n76_), .c(new_n50_), .O(z8));
endmodule
