...
module FAU ( 
  ...
  nand2  g64(.a(new_n88_), .b(new_n67_), .O(new_n89_));
  aoi21  g65(.a(new_n86_), .b(new_n28_), .c(new_n89_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n84_), .c(x07), .O(z6));
  nand3  g67(.a(new_n69_), .b(new_n25_), .c(x02), .O(new_n92_));
  ...
  oai21  g71(.a(new_n38_), .b(x01), .c(new_n69_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n67_), .d(new_n25_), .O(z7));
  nand4  g73(.a(new_n64_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  inv1   g75(.a(x09), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n27_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n99_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
