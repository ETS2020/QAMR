...
module FAU ( 
  ...
  nand2  g11(.a(x10), .b(x06), .O(new_n36_));
  ...
  nand2  g21(.a(new_n30_), .b(x03), .O(new_n46_));
  ...
  aoi21  g26(.a(new_n50_), .b(new_n29_), .c(new_n45_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n44_), .c(new_n27_), .O(new_n52_));
  nand2  g28(.a(new_n49_), .b(new_n26_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n52_), .c(new_n25_), .O(new_n58_));
  inv1   g34(.a(new_n36_), .O(new_n59_));
  nor2   g35(.a(new_n48_), .b(x03), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n55_), .c(new_n29_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n27_), .c(x08), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n47_), .c(new_n59_), .O(new_n63_));
  ...
  oai21  g56(.a(new_n54_), .b(x03), .c(new_n27_), .O(new_n81_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n48_), .c(new_n47_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  inv1   g65(.a(x08), .O(new_n90_));
  nand4  g66(.a(new_n48_), .b(new_n90_), .c(new_n47_), .d(x02), .O(new_n91_));
  ...
  aoi21  g70(.a(new_n94_), .b(new_n90_), .c(new_n49_), .O(new_n95_));
  ...
  aoi21  g74(.a(new_n54_), .b(new_n25_), .c(x10), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n98_), .c(new_n47_), .O(z8));
endmodule
