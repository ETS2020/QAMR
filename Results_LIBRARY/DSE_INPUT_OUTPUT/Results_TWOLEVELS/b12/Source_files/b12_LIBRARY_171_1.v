...
module FAU ( 
  ...
  oai22  g46(.a(new_n70_), .b(x00), .c(new_n69_), .d(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n26_), .O(z3));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x09), .c(new_n29_), .O(new_n74_));
  nand3  g50(.a(new_n50_), .b(x02), .c(new_n49_), .O(new_n75_));
  nand2  g51(.a(new_n65_), .b(x01), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  oai21  g53(.a(new_n28_), .b(x00), .c(new_n61_), .O(new_n78_));
  aoi21  g54(.a(new_n77_), .b(new_n52_), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(new_n69_), .b(x07), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x07), .c(new_n80_), .O(z4));
  nor2   g57(.a(x10), .b(x00), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(x13), .c(new_n70_), .d(new_n25_), .O(z5));
  nand2  g59(.a(x09), .b(new_n58_), .O(new_n84_));
  nand2  g60(.a(new_n52_), .b(x02), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(x00), .O(new_n86_));
  nor2   g62(.a(x08), .b(new_n27_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n86_), .c(new_n29_), .O(new_n88_));
  oai21  g64(.a(x09), .b(new_n58_), .c(new_n29_), .O(new_n89_));
  nand2  g65(.a(new_n27_), .b(new_n49_), .O(new_n90_));
  oai21  g66(.a(x08), .b(new_n49_), .c(new_n90_), .O(new_n91_));
  nand4  g67(.a(x09), .b(new_n65_), .c(new_n58_), .d(x00), .O(new_n92_));
  inv1   g68(.a(x14), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x01), .c(new_n49_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n52_), .O(new_n95_));
  aoi21  g71(.a(new_n91_), .b(new_n89_), .c(new_n95_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n88_), .c(x07), .O(z6));
  nor2   g73(.a(x02), .b(x01), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x07), .c(x03), .O(new_n99_));
  nor2   g75(.a(new_n60_), .b(new_n58_), .O(new_n100_));
  aoi22  g76(.a(new_n100_), .b(new_n98_), .c(new_n99_), .d(new_n65_), .O(new_n101_));
  ...
  nand2  g80(.a(new_n60_), .b(new_n49_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n52_), .d(new_n25_), .O(z8));
endmodule
