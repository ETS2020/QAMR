...
module FAU ( 
  ...
  nand4  g62(.a(new_n47_), .b(new_n55_), .c(new_n46_), .d(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n29_), .O(new_n89_));
  oai21  g65(.a(new_n26_), .b(x01), .c(new_n55_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n47_), .d(new_n46_), .O(z7));
  nand2  g67(.a(new_n47_), .b(x07), .O(new_n92_));
  nand4  g68(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n93_));
  oai21  g69(.a(x09), .b(x00), .c(new_n47_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x07), .c(new_n92_), .O(z8));
endmodule
