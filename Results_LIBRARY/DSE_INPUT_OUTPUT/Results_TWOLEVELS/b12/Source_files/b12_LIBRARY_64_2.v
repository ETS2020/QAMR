...
module FAU ( 
  ...
  oai21  g44(.a(new_n66_), .b(x11), .c(new_n68_), .O(z4));
  ...
  oai21  g52(.a(new_n48_), .b(x03), .c(new_n28_), .O(new_n77_));
  nand2  g53(.a(x08), .b(x00), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n33_), .O(new_n79_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n51_), .c(new_n55_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n28_), .O(new_n85_));
  nand4  g61(.a(new_n51_), .b(new_n47_), .c(new_n55_), .d(x02), .O(new_n86_));
  ...
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n66_), .O(z7));
  nand4  g66(.a(new_n63_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n48_), .b(new_n38_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n55_), .O(z8));
endmodule
