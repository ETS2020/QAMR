...
module FAU ( 
  ...
  aoi21  g45(.a(x12), .b(new_n25_), .c(new_n69_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n36_), .c(new_n48_), .d(new_n25_), .O(z5));
  inv1   g47(.a(x09), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(x03), .c(x01), .O(new_n73_));
  nand2  g49(.a(new_n56_), .b(x01), .O(new_n74_));
  oai21  g50(.a(new_n73_), .b(x00), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n27_), .O(new_n76_));
  oai21  g52(.a(new_n72_), .b(x03), .c(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n29_), .b(new_n25_), .O(new_n78_));
  oai21  g54(.a(x08), .b(new_n25_), .c(new_n78_), .O(new_n79_));
  inv1   g55(.a(x08), .O(new_n80_));
  nand4  g56(.a(new_n72_), .b(new_n80_), .c(x03), .d(x00), .O(new_n81_));
  inv1   g57(.a(x14), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x02), .c(new_n25_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(new_n84_));
  aoi21  g60(.a(new_n79_), .b(new_n77_), .c(new_n84_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n76_), .c(x10), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n29_), .O(new_n87_));
  nand3  g63(.a(new_n36_), .b(new_n80_), .c(x01), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(x02), .O(new_n89_));
  aoi21  g65(.a(x03), .b(new_n27_), .c(x08), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n48_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n36_), .O(z7));
  nand4  g68(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n72_), .b(new_n25_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n36_), .d(new_n48_), .O(z8));
endmodule
