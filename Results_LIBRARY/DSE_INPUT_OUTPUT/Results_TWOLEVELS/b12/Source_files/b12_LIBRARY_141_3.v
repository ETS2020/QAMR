...
module FAU ( 
  ...
  oai21  g41(.a(new_n65_), .b(new_n26_), .c(x12), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n45_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n64_), .c(new_n25_), .O(z3));
  inv1   g44(.a(x08), .O(new_n69_));
  aoi21  g45(.a(new_n46_), .b(new_n27_), .c(x10), .O(new_n70_));
  nand2  g46(.a(x09), .b(x00), .O(new_n71_));
  aoi21  g47(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(new_n72_));
  aoi21  g48(.a(new_n62_), .b(x07), .c(new_n65_), .O(new_n73_));
  oai21  g49(.a(new_n72_), .b(x07), .c(new_n73_), .O(z4));
  nand2  g50(.a(x12), .b(x09), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n45_), .d(new_n26_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n48_), .O(new_n77_));
  oai21  g53(.a(x12), .b(x10), .c(new_n46_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(z5));
  oai21  g55(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n26_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  oai21  g59(.a(new_n46_), .b(x03), .c(new_n30_), .O(new_n84_));
  nand2  g60(.a(x08), .b(x00), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n27_), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x01), .c(new_n26_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n48_), .c(new_n45_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(new_n69_), .b(new_n45_), .c(x02), .O(new_n92_));
  nand3  g68(.a(x09), .b(x03), .c(new_n30_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(x01), .O(new_n94_));
  aoi21  g70(.a(new_n45_), .b(x01), .c(new_n37_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x08), .c(new_n45_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n94_), .c(new_n48_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n54_), .O(z7));
  oai21  g74(.a(x10), .b(new_n26_), .c(new_n46_), .O(new_n99_));
  nand2  g75(.a(new_n75_), .b(new_n45_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n48_), .O(new_n101_));
  nand4  g77(.a(new_n48_), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand3  g79(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(z8));
endmodule
