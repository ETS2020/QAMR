...
module FAU ( 
  ...
  nand3  g47(.a(new_n71_), .b(new_n51_), .c(new_n48_), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n27_), .O(new_n74_));
  nor3   g50(.a(new_n74_), .b(x10), .c(new_n73_), .O(new_n75_));
  ...
  nand3  g68(.a(x09), .b(x03), .c(new_n37_), .O(new_n93_));
  inv1   g69(.a(x08), .O(new_n94_));
  nand4  g70(.a(new_n51_), .b(new_n94_), .c(new_n25_), .d(x02), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n27_), .O(new_n97_));
  nor2   g73(.a(new_n74_), .b(x10), .O(new_n98_));
  nand2  g74(.a(new_n94_), .b(new_n57_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n25_), .O(z7));
  inv1   g76(.a(x12), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand2  g79(.a(new_n73_), .b(new_n48_), .O(new_n104_));
