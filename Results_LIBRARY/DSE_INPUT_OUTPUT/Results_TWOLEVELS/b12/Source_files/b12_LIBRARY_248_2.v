...
module FAU ( 
  ...
  nand3  g30(.a(new_n47_), .b(new_n54_), .c(new_n53_), .O(new_n55_));
  ...
  nand2  g34(.a(new_n47_), .b(new_n54_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n52_), .c(new_n25_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n26_), .c(x08), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(new_n53_), .c(new_n47_), .d(x03), .O(new_n62_));
  ...
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(x01), .b(x00), .O(new_n73_));
  oai21  g49(.a(new_n54_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n47_), .c(new_n52_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n72_), .c(new_n53_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n71_), .O(z4));
  nand3  g54(.a(x13), .b(new_n65_), .c(new_n53_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  nand2  g56(.a(new_n53_), .b(x00), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n47_), .d(new_n52_), .O(z5));
  nand2  g58(.a(new_n54_), .b(new_n26_), .O(new_n83_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n47_), .c(new_n53_), .d(new_n52_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  oai21  g66(.a(new_n72_), .b(x07), .c(new_n52_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n47_), .O(z7));
  nand3  g68(.a(new_n54_), .b(new_n53_), .c(x00), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n52_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n47_), .O(z8));
endmodule
