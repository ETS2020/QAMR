...
module FAU ( 
  ...
  oai21  g28(.a(new_n52_), .b(x02), .c(new_n51_), .O(new_n53_));
  inv1   g29(.a(x10), .O(new_n54_));
  nand2  g30(.a(x08), .b(x00), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n29_), .O(new_n56_));
  nand3  g32(.a(new_n49_), .b(x02), .c(x00), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand4  g34(.a(new_n58_), .b(new_n54_), .c(x09), .d(new_n48_), .O(new_n59_));
  ...
  nand3  g41(.a(new_n37_), .b(new_n65_), .c(x07), .O(new_n66_));
  nor2   g42(.a(new_n54_), .b(x09), .O(new_n67_));
  aoi21  g43(.a(new_n55_), .b(x09), .c(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x07), .c(new_n66_), .O(z4));
  inv1   g45(.a(x12), .O(new_n70_));
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n48_), .d(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x09), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n54_), .O(z5));
  nand2  g49(.a(x09), .b(x02), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n29_), .c(new_n25_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n52_), .c(new_n49_), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(new_n29_), .O(new_n77_));
  aoi21  g53(.a(x03), .b(new_n27_), .c(x01), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(new_n25_), .O(new_n79_));
  ...
  nand3  g59(.a(new_n83_), .b(x08), .c(new_n48_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x09), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n54_), .O(z7));
  oai21  g62(.a(x12), .b(x07), .c(x09), .O(new_n87_));
  nor2   g63(.a(x02), .b(x01), .O(new_n88_));
  nor2   g64(.a(new_n36_), .b(x10), .O(new_n89_));
