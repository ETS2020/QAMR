...
module FAU ( 
  ...
  nand3  g29(.a(new_n36_), .b(x09), .c(new_n53_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n52_), .c(x01), .O(new_n55_));
  aoi21  g31(.a(new_n51_), .b(x02), .c(new_n55_), .O(new_n56_));
  nand3  g32(.a(new_n36_), .b(x09), .c(new_n29_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n27_), .c(x08), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n53_), .c(new_n37_), .O(new_n59_));
  ...
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n38_), .O(z4));
  inv1   g44(.a(x13), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(x12), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n36_), .c(new_n53_), .d(new_n25_), .O(z5));
  nand2  g47(.a(x08), .b(x00), .O(new_n72_));
  aoi22  g48(.a(new_n36_), .b(x02), .c(x09), .d(new_n26_), .O(new_n73_));
  inv1   g49(.a(x09), .O(new_n74_));
  nand4  g50(.a(new_n36_), .b(new_n74_), .c(x03), .d(new_n27_), .O(new_n75_));
  ...
  aoi21  g56(.a(new_n80_), .b(new_n78_), .c(x10), .O(new_n81_));
  aoi22  g57(.a(new_n81_), .b(x01), .c(new_n76_), .d(new_n72_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x07), .c(new_n38_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n84_));
  nand4  g60(.a(new_n36_), .b(new_n79_), .c(new_n53_), .d(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n29_), .O(new_n87_));
  oai21  g63(.a(x10), .b(new_n79_), .c(new_n26_), .O(new_n88_));
  nand2  g64(.a(new_n36_), .b(x07), .O(new_n89_));
  nand2  g65(.a(new_n79_), .b(x01), .O(new_n90_));
  nand2  g66(.a(x10), .b(x03), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n89_), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n88_), .c(new_n87_), .O(z7));
  aoi21  g70(.a(x12), .b(x09), .c(x10), .O(new_n95_));
  nand2  g71(.a(new_n53_), .b(new_n26_), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n27_), .c(new_n29_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n53_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai22  g75(.a(new_n99_), .b(x10), .c(new_n95_), .d(new_n26_), .O(z8));
endmodule
