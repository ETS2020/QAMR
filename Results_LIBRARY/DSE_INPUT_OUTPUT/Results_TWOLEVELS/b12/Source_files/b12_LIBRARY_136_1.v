...
module FAU ( 
  ...
  nand2  g34(.a(x09), .b(new_n27_), .O(new_n59_));
  inv1   g35(.a(x10), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x02), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n59_), .c(x08), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x10), .c(new_n25_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n58_), .O(z2));
  nand2  g40(.a(new_n60_), .b(new_n25_), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x07), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(new_n65_), .c(x12), .d(new_n50_), .O(z3));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(x09), .c(new_n27_), .O(new_n70_));
  oai21  g46(.a(x05), .b(new_n28_), .c(new_n60_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(x02), .c(new_n27_), .O(new_n72_));
  nand4  g48(.a(new_n60_), .b(new_n33_), .c(x04), .d(x02), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n72_), .c(new_n50_), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  oai21  g52(.a(x08), .b(new_n27_), .c(new_n60_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n75_), .c(new_n70_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n67_), .O(z4));
  inv1   g57(.a(x13), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n60_), .c(x12), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n60_), .c(new_n25_), .d(new_n50_), .O(z5));
  aoi21  g60(.a(x09), .b(new_n38_), .c(x02), .O(new_n85_));
  nand3  g61(.a(new_n76_), .b(x03), .c(new_n37_), .O(new_n86_));
  oai21  g62(.a(new_n85_), .b(x01), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n69_), .O(new_n88_));
  nand2  g64(.a(x14), .b(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  oai21  g66(.a(x08), .b(new_n50_), .c(new_n90_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(x01), .c(x10), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n88_), .c(x07), .O(z6));
  inv1   g69(.a(x08), .O(new_n94_));
  nor2   g70(.a(x02), .b(x01), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x07), .c(x03), .O(new_n96_));
  nor2   g72(.a(new_n76_), .b(new_n38_), .O(new_n97_));
  aoi22  g73(.a(new_n97_), .b(new_n95_), .c(new_n96_), .d(new_n94_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x10), .c(new_n25_), .O(z7));
  inv1   g75(.a(x12), .O(new_n100_));
  nand3  g76(.a(new_n95_), .b(new_n100_), .c(x03), .O(new_n101_));
