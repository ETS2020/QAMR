...
module FAU ( 
  ...
  nand3  g26(.a(x07), .b(new_n37_), .c(new_n27_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n30_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n47_), .c(new_n26_), .O(new_n53_));
  oai21  g29(.a(new_n50_), .b(x07), .c(new_n53_), .O(z2));
  inv1   g30(.a(x07), .O(new_n55_));
  inv1   g31(.a(x11), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  inv1   g33(.a(x12), .O(new_n58_));
  oai21  g34(.a(x07), .b(x00), .c(x11), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n57_), .c(new_n25_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n55_), .O(new_n63_));
  oai21  g39(.a(new_n56_), .b(x10), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z4));
  nand4  g41(.a(x13), .b(new_n58_), .c(new_n47_), .d(new_n26_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n55_), .O(new_n67_));
  oai21  g43(.a(x10), .b(new_n55_), .c(new_n67_), .O(z5));
  oai21  g44(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n69_));
  nand2  g45(.a(new_n30_), .b(new_n26_), .O(new_n70_));
  inv1   g46(.a(x08), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n69_), .O(new_n74_));
  inv1   g50(.a(x09), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x03), .c(new_n30_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n45_), .c(new_n27_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x01), .c(new_n26_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n47_), .c(new_n55_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(z6));
  nand3  g58(.a(new_n71_), .b(new_n55_), .c(x02), .O(new_n83_));
  nand3  g59(.a(x09), .b(x03), .c(new_n30_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x01), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n47_), .O(new_n86_));
  aoi21  g62(.a(x03), .b(new_n27_), .c(x08), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x10), .c(new_n55_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n86_), .O(z7));
  nand4  g65(.a(new_n58_), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand2  g67(.a(new_n75_), .b(new_n26_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n47_), .d(new_n55_), .O(z8));
endmodule
