...
module FAU ( 
  ...
  nor2   g29(.a(new_n25_), .b(x03), .O(new_n54_));
  inv1   g30(.a(x09), .O(new_n55_));
  nor2   g31(.a(x10), .b(new_n55_), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n33_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n28_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n53_), .c(new_n47_), .O(new_n59_));
  ...
  aoi21  g40(.a(x10), .b(x07), .c(new_n53_), .O(new_n65_));
  nand2  g41(.a(x09), .b(x00), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(x10), .c(new_n53_), .O(new_n67_));
  oai22  g43(.a(new_n67_), .b(x07), .c(new_n65_), .d(x11), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n47_), .d(new_n38_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n53_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(z5));
  oai21  g48(.a(new_n55_), .b(x03), .c(new_n28_), .O(new_n73_));
  ...
  oai21  g53(.a(new_n77_), .b(x00), .c(x01), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n25_), .c(new_n53_), .d(new_n47_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nor2   g57(.a(x02), .b(new_n33_), .O(new_n82_));
  nor2   g58(.a(new_n55_), .b(x01), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(new_n25_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n47_), .c(x03), .d(new_n28_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n53_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(z7));
  nand4  g63(.a(new_n25_), .b(new_n47_), .c(new_n27_), .d(new_n33_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n69_), .c(new_n28_), .d(new_n33_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n47_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x08), .c(new_n25_), .O(z8));
endmodule
