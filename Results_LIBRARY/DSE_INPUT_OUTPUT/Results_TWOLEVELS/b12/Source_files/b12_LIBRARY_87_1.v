...
module FAU ( 
  ...
  nor2   g42(.a(x10), .b(new_n55_), .O(new_n67_));
  oai21  g43(.a(new_n64_), .b(new_n49_), .c(new_n25_), .O(new_n68_));
  oai21  g44(.a(x10), .b(new_n55_), .c(new_n29_), .O(new_n69_));
  ...
  nand2  g48(.a(new_n63_), .b(x07), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z4));
  nor2   g50(.a(x12), .b(x00), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x07), .c(x13), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n49_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n36_), .O(z5));
  aoi21  g54(.a(x09), .b(new_n26_), .c(x02), .O(new_n79_));
  nand2  g55(.a(new_n54_), .b(x02), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x00), .c(new_n80_), .O(new_n81_));
  ...
  oai21  g60(.a(x08), .b(new_n25_), .c(new_n84_), .O(new_n85_));
  nand4  g61(.a(x09), .b(new_n54_), .c(new_n26_), .d(x00), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x01), .c(new_n25_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n49_), .O(new_n89_));
  aoi21  g65(.a(new_n85_), .b(new_n83_), .c(new_n89_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n82_), .c(x07), .O(z6));
  nand3  g67(.a(new_n54_), .b(new_n36_), .c(x02), .O(new_n92_));
  ...
  aoi21  g71(.a(new_n54_), .b(x01), .c(x10), .O(new_n96_));
  nand2  g72(.a(new_n54_), .b(new_n26_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n36_), .O(z7));
  nand4  g74(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(new_n55_), .b(new_n25_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n49_), .d(new_n36_), .O(z8));
endmodule
