...
module FAU ( 
  ...
  oai21  g31(.a(new_n55_), .b(new_n50_), .c(new_n25_), .O(new_n56_));
  nand3  g32(.a(new_n53_), .b(x09), .c(new_n36_), .O(new_n57_));
  oai21  g33(.a(new_n53_), .b(x03), .c(new_n57_), .O(new_n58_));
  ...
  nor2   g40(.a(x12), .b(new_n53_), .O(new_n65_));
  ...
  nor2   g46(.a(x09), .b(x07), .O(new_n71_));
  nor2   g47(.a(x11), .b(new_n52_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n38_), .O(new_n73_));
  aoi21  g49(.a(x08), .b(x00), .c(new_n53_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n53_), .c(new_n75_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x00), .c(x05), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n74_), .c(new_n52_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n73_), .O(z4));
  nand4  g58(.a(x13), .b(new_n67_), .c(new_n52_), .d(new_n25_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n53_), .c(new_n36_), .O(z5));
  nand2  g61(.a(new_n36_), .b(x01), .O(new_n86_));
  nand2  g62(.a(new_n76_), .b(x03), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(new_n25_), .O(new_n88_));
  nand2  g64(.a(new_n36_), .b(x02), .O(new_n89_));
  nand2  g65(.a(x09), .b(new_n26_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n88_), .c(new_n75_), .O(new_n92_));
  nand2  g68(.a(x14), .b(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x01), .O(new_n94_));
  oai21  g70(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n29_), .O(new_n96_));
  nand3  g72(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n97_));
  ...
  nand2  g76(.a(new_n100_), .b(new_n52_), .O(new_n101_));
  aoi21  g77(.a(new_n101_), .b(new_n36_), .c(x10), .O(z6));
  nand3  g78(.a(x09), .b(x03), .c(new_n27_), .O(new_n103_));
  nand4  g79(.a(new_n53_), .b(new_n75_), .c(new_n52_), .d(x02), .O(new_n104_));
  aoi21  g80(.a(new_n104_), .b(new_n103_), .c(x01), .O(new_n105_));
  oai21  g81(.a(new_n26_), .b(x01), .c(new_n75_), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(new_n52_), .O(new_n107_));
  oai21  g83(.a(new_n107_), .b(new_n105_), .c(new_n36_), .O(new_n108_));
  nand2  g84(.a(new_n108_), .b(new_n53_), .O(z7));
  nand4  g85(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n110_));
  oai21  g86(.a(x09), .b(x00), .c(new_n52_), .O(new_n111_));
  aoi21  g87(.a(new_n110_), .b(x09), .c(new_n111_), .O(new_n112_));
  oai21  g88(.a(new_n112_), .b(x05), .c(new_n53_), .O(z8));
endmodule
