...
module FAU ( 
  ...
  oai21  g30(.a(x14), .b(new_n49_), .c(new_n54_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n26_), .c(new_n25_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(new_n57_));
  aoi21  g33(.a(new_n53_), .b(new_n49_), .c(new_n57_), .O(new_n58_));
  inv1   g34(.a(x08), .O(new_n59_));
  oai21  g35(.a(new_n36_), .b(x10), .c(new_n59_), .O(new_n60_));
  oai22  g36(.a(new_n60_), .b(x07), .c(new_n37_), .d(x00), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x02), .O(new_n62_));
  oai21  g38(.a(new_n58_), .b(x01), .c(new_n62_), .O(z2));
  inv1   g39(.a(x11), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(x00), .c(new_n64_), .d(new_n49_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n38_), .O(z3));
  inv1   g43(.a(x09), .O(new_n68_));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nor2   g45(.a(x09), .b(x01), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x14), .c(new_n54_), .O(new_n71_));
  aoi22  g47(.a(new_n71_), .b(new_n69_), .c(new_n38_), .d(new_n68_), .O(new_n72_));
  nand3  g48(.a(new_n38_), .b(new_n64_), .c(x07), .O(new_n73_));
  oai21  g49(.a(new_n72_), .b(x07), .c(new_n73_), .O(z4));
  nor2   g50(.a(x10), .b(x00), .O(new_n75_));
  nor2   g51(.a(x14), .b(x13), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n37_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n75_), .c(new_n65_), .d(new_n49_), .O(z5));
  nor2   g54(.a(x02), .b(x01), .O(new_n79_));
  nand2  g55(.a(x09), .b(new_n26_), .O(new_n80_));
  nand2  g56(.a(new_n68_), .b(x03), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n69_), .c(new_n36_), .d(new_n54_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(x07), .O(z6));
  oai21  g60(.a(x02), .b(x01), .c(new_n54_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(x03), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n36_), .c(new_n59_), .O(new_n87_));
  nand3  g63(.a(new_n79_), .b(x09), .c(x03), .O(new_n88_));
  nor2   g64(.a(x14), .b(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n49_), .O(z7));
  nand3  g66(.a(new_n79_), .b(new_n65_), .c(x03), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nor2   g68(.a(x10), .b(x07), .O(new_n93_));
  nand3  g69(.a(new_n36_), .b(new_n68_), .c(new_n25_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n38_), .O(z8));
endmodule
