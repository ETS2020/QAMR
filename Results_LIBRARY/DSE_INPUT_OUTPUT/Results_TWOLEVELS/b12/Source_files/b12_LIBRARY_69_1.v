...
module FAU ( 
  ...
  nand2  g24(.a(x07), .b(new_n27_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  nand3  g26(.a(new_n35_), .b(new_n26_), .c(x01), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n50_), .c(new_n35_), .O(new_n52_));
  nand2  g28(.a(x09), .b(new_n25_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n49_), .c(x01), .O(new_n54_));
  aoi21  g30(.a(new_n52_), .b(x02), .c(new_n54_), .O(new_n55_));
  inv1   g31(.a(x10), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(x09), .c(new_n33_), .O(new_n57_));
  ...
  oai21  g37(.a(new_n61_), .b(new_n25_), .c(x00), .O(new_n62_));
  inv1   g38(.a(x12), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x10), .c(new_n25_), .O(new_n64_));
  nand2  g40(.a(new_n63_), .b(new_n61_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n62_), .O(z3));
  inv1   g42(.a(x08), .O(new_n67_));
  oai21  g43(.a(x09), .b(x01), .c(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(x09), .c(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n56_), .c(new_n25_), .O(new_n70_));
  oai21  g46(.a(x11), .b(new_n25_), .c(new_n70_), .O(z4));
  inv1   g47(.a(x13), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(x12), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n56_), .c(new_n25_), .d(new_n40_), .O(z5));
  oai21  g50(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n75_));
  nor2   g51(.a(x02), .b(x00), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n40_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  nand2  g54(.a(x09), .b(new_n27_), .O(new_n79_));
  aoi22  g55(.a(new_n79_), .b(new_n28_), .c(x08), .d(x00), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x02), .c(new_n40_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n56_), .O(new_n83_));
  aoi21  g59(.a(new_n80_), .b(new_n33_), .c(new_n83_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n78_), .c(x07), .O(z6));
  nand3  g61(.a(new_n67_), .b(new_n25_), .c(x02), .O(new_n86_));
  nand3  g62(.a(x09), .b(x03), .c(new_n28_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n33_), .O(new_n89_));
  aoi21  g65(.a(new_n67_), .b(x01), .c(x10), .O(new_n90_));
  nand2  g66(.a(new_n67_), .b(new_n27_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n25_), .O(z7));
  nand4  g68(.a(new_n63_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  inv1   g70(.a(x09), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n40_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n94_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
