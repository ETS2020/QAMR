...
module FAU ( 
  ...
  nor2   g47(.a(new_n71_), .b(x01), .O(new_n72_));
  aoi21  g48(.a(new_n28_), .b(new_n33_), .c(x10), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(new_n70_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n57_), .c(x09), .d(x00), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n66_), .b(x07), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(z4));
  nor3   g54(.a(x12), .b(x10), .c(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x13), .c(new_n25_), .O(z5));
  nand2  g56(.a(new_n71_), .b(x03), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n28_), .c(new_n40_), .O(new_n82_));
  nand3  g58(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n83_));
  nand3  g59(.a(new_n57_), .b(new_n28_), .c(x01), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n82_), .c(new_n70_), .O(new_n86_));
  ...
  nand3  g66(.a(new_n71_), .b(x03), .c(new_n28_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n40_), .c(x10), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n86_), .c(x07), .O(z6));
  nand3  g70(.a(new_n70_), .b(new_n25_), .c(x01), .O(new_n95_));
  nand3  g71(.a(x09), .b(x03), .c(new_n33_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x02), .O(new_n97_));
  nand2  g73(.a(new_n25_), .b(x02), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(x03), .c(x08), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n97_), .c(new_n57_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n25_), .O(z7));
  nand4  g77(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand2  g79(.a(new_n71_), .b(new_n40_), .O(new_n104_));
