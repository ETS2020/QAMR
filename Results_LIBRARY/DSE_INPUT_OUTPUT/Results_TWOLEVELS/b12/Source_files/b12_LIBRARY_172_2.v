...
module FAU ( 
  ...
  aoi22  g42(.a(new_n66_), .b(x07), .c(x12), .d(new_n40_), .O(z3));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n57_), .O(new_n69_));
  oai21  g45(.a(new_n66_), .b(new_n57_), .c(new_n69_), .O(z4));
  inv1   g46(.a(x13), .O(new_n71_));
  aoi21  g47(.a(x12), .b(new_n40_), .c(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n25_), .c(new_n57_), .d(new_n40_), .O(z5));
  oai21  g49(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n40_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  oai21  g53(.a(new_n50_), .b(x03), .c(new_n28_), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n30_), .O(new_n80_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n25_), .c(new_n57_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n28_), .O(new_n86_));
  nand4  g62(.a(new_n25_), .b(new_n58_), .c(new_n57_), .d(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n30_), .O(new_n89_));
  oai21  g65(.a(new_n27_), .b(x01), .c(new_n58_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n25_), .d(new_n57_), .O(z7));
  inv1   g67(.a(x12), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n93_));
