...
module FAU ( 
  ...
  oai21  g46(.a(new_n66_), .b(x10), .c(x07), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  inv1   g48(.a(x12), .O(new_n73_));
  nand4  g49(.a(x13), .b(new_n73_), .c(new_n37_), .d(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n36_), .O(new_n75_));
  oai21  g51(.a(x10), .b(new_n36_), .c(new_n75_), .O(z5));
  ...
  nand4  g71(.a(new_n73_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  nand2  g73(.a(new_n81_), .b(new_n25_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n37_), .d(new_n36_), .O(z8));
endmodule
