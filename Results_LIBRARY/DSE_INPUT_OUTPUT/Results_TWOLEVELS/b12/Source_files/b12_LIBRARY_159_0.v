...
module FAU ( 
  ...
  nand3  g32(.a(x11), .b(new_n36_), .c(x09), .O(new_n57_));
  oai21  g33(.a(new_n36_), .b(x03), .c(new_n57_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n29_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n27_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n56_), .c(new_n52_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n55_), .c(new_n38_), .O(z2));
  nand2  g38(.a(x11), .b(new_n52_), .O(new_n63_));
  nor2   g39(.a(x11), .b(new_n36_), .O(new_n64_));
  inv1   g40(.a(new_n64_), .O(new_n65_));
  aoi22  g41(.a(new_n65_), .b(new_n63_), .c(x12), .d(new_n25_), .O(z3));
  inv1   g42(.a(x09), .O(new_n67_));
  nand2  g43(.a(new_n38_), .b(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n56_), .b(new_n25_), .c(x10), .O(new_n69_));
  nand2  g45(.a(x01), .b(x00), .O(new_n70_));
  oai21  g46(.a(new_n67_), .b(x01), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n36_), .c(new_n56_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x11), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n69_), .c(new_n68_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n52_), .O(new_n76_));
  nand2  g52(.a(new_n64_), .b(x07), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(z4));
  inv1   g54(.a(x12), .O(new_n79_));
  nand4  g55(.a(x13), .b(new_n79_), .c(new_n52_), .d(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x11), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n36_), .O(z5));
  nand2  g58(.a(x09), .b(new_n26_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n27_), .c(x00), .O(new_n84_));
  nand2  g60(.a(x11), .b(x02), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n83_), .c(x08), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n84_), .c(new_n29_), .O(new_n87_));
  aoi21  g63(.a(new_n67_), .b(x03), .c(x01), .O(new_n88_));
  nand3  g64(.a(new_n67_), .b(new_n56_), .c(x03), .O(new_n89_));
  oai21  g65(.a(new_n88_), .b(x00), .c(new_n89_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n27_), .O(new_n91_));
  nand3  g67(.a(x11), .b(new_n56_), .c(x00), .O(new_n92_));
  oai21  g68(.a(x14), .b(x00), .c(new_n92_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x01), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n91_), .c(new_n87_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n52_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(x11), .c(x10), .O(z6));
  nand3  g73(.a(x09), .b(x03), .c(new_n27_), .O(new_n98_));
  nand4  g74(.a(new_n36_), .b(new_n56_), .c(new_n52_), .d(x02), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(new_n98_), .c(x01), .O(new_n100_));
  oai21  g76(.a(new_n26_), .b(x01), .c(new_n56_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n52_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(new_n100_), .c(x11), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n36_), .O(z7));
  nand4  g80(.a(new_n79_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n105_));
  oai21  g81(.a(x09), .b(x00), .c(new_n52_), .O(new_n106_));
  aoi21  g82(.a(new_n105_), .b(x09), .c(new_n106_), .O(new_n107_));
  oai21  g83(.a(new_n107_), .b(new_n37_), .c(new_n36_), .O(z8));
endmodule
