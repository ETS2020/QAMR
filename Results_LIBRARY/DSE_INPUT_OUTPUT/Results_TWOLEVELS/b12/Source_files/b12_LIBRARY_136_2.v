...
module FAU ( 
  ...
  oai21  g22(.a(new_n27_), .b(x02), .c(new_n40_), .O(new_n47_));
  nor2   g23(.a(x08), .b(x07), .O(new_n48_));
  nand2  g24(.a(new_n48_), .b(new_n27_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n47_), .c(new_n25_), .O(new_n50_));
  oai21  g26(.a(x09), .b(x02), .c(new_n40_), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nand2  g28(.a(x09), .b(new_n52_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n51_), .c(x10), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n50_), .c(new_n30_), .O(new_n55_));
  nand2  g31(.a(new_n35_), .b(new_n30_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n26_), .c(new_n40_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n48_), .c(x02), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n55_), .c(new_n26_), .O(z2));
  inv1   g36(.a(x11), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x10), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(x07), .c(x12), .d(new_n40_), .O(z3));
  inv1   g39(.a(x07), .O(new_n64_));
  nand3  g40(.a(x09), .b(x08), .c(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  oai21  g42(.a(new_n61_), .b(new_n25_), .c(x07), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n66_), .O(z4));
  inv1   g44(.a(x13), .O(new_n69_));
  aoi21  g45(.a(x12), .b(new_n40_), .c(new_n69_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n25_), .c(new_n64_), .d(new_n40_), .O(z5));
  oai21  g47(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n72_));
  nor2   g48(.a(x02), .b(x00), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n40_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand2  g51(.a(x09), .b(new_n27_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n28_), .c(x00), .O(new_n77_));
  nand2  g53(.a(new_n64_), .b(x02), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(x08), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n30_), .O(new_n80_));
  nor2   g56(.a(x14), .b(new_n30_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n40_), .c(x07), .O(new_n82_));
  ...
  nand3  g61(.a(new_n25_), .b(new_n52_), .c(x02), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x01), .O(new_n87_));
  aoi21  g63(.a(x03), .b(new_n30_), .c(x08), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(new_n64_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n25_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n92_));
