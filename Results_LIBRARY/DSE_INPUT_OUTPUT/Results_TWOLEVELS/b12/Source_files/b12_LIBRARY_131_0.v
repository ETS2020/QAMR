...
module FAU ( 
  ...
  nor2   g05(.a(x07), .b(x05), .O(new_n30_));
  ...
  nand2  g11(.a(x07), .b(new_n25_), .O(new_n36_));
  ...
  nand4  g30(.a(new_n54_), .b(new_n26_), .c(x05), .d(new_n34_), .O(new_n55_));
  ...
  nand3  g36(.a(new_n60_), .b(new_n26_), .c(x05), .O(new_n61_));
  ...
  nor2   g40(.a(new_n54_), .b(x03), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n60_), .c(new_n34_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n41_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n64_), .c(new_n26_), .d(x05), .O(new_n68_));
  oai21  g44(.a(new_n63_), .b(x00), .c(new_n68_), .O(z2));
  inv1   g45(.a(x00), .O(new_n70_));
  nand2  g46(.a(new_n26_), .b(x05), .O(new_n71_));
  inv1   g47(.a(x11), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x07), .O(new_n73_));
  aoi22  g49(.a(new_n73_), .b(new_n71_), .c(x12), .d(new_n70_), .O(z3));
  nand4  g50(.a(x09), .b(x08), .c(x05), .d(x00), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n26_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n73_), .O(z4));
  aoi21  g53(.a(new_n26_), .b(x00), .c(x10), .O(new_n78_));
  inv1   g54(.a(x12), .O(new_n79_));
  nand4  g55(.a(x13), .b(new_n79_), .c(new_n26_), .d(x05), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n78_), .b(new_n25_), .c(new_n81_), .O(z5));
  nand2  g58(.a(x08), .b(x00), .O(new_n83_));
  aoi21  g59(.a(x09), .b(new_n29_), .c(x02), .O(new_n84_));
  nand3  g60(.a(new_n59_), .b(x03), .c(new_n41_), .O(new_n85_));
  ...
  nand4  g67(.a(new_n91_), .b(new_n54_), .c(new_n26_), .d(x05), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  nand3  g69(.a(x09), .b(x03), .c(new_n41_), .O(new_n94_));
  nand4  g70(.a(new_n54_), .b(new_n64_), .c(new_n26_), .d(x02), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(x01), .O(new_n96_));
  oai21  g72(.a(new_n29_), .b(x01), .c(new_n64_), .O(new_n97_));
  ...
  nand4  g76(.a(new_n79_), .b(x03), .c(new_n41_), .d(new_n34_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi22  g78(.a(x10), .b(x05), .c(new_n59_), .d(new_n70_), .O(new_n103_));
  nand4  g79(.a(new_n103_), .b(new_n102_), .c(new_n26_), .d(x05), .O(z8));
endmodule
