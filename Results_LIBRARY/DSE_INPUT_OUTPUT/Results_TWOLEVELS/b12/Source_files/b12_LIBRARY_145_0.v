...
module FAU ( 
  ...
  nor2   g11(.a(x10), .b(x05), .O(new_n36_));
  ...
  aoi22  g23(.a(new_n47_), .b(new_n29_), .c(new_n46_), .d(x04), .O(new_n48_));
  ...
  nand3  g31(.a(new_n52_), .b(x09), .c(x05), .O(new_n56_));
  ...
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(x05), .O(new_n67_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n52_), .c(x05), .O(z5));
  nand2  g60(.a(new_n75_), .b(x03), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n46_), .c(new_n25_), .O(new_n86_));
  nand2  g62(.a(x05), .b(x02), .O(new_n87_));
  nand2  g63(.a(x09), .b(new_n26_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(x01), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n86_), .c(new_n74_), .O(new_n90_));
  nand2  g66(.a(x14), .b(x02), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x01), .O(new_n92_));
  oai21  g68(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n29_), .O(new_n94_));
  nand3  g70(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n95_));
  ...
  aoi21  g75(.a(new_n99_), .b(x05), .c(x10), .O(z6));
  nand3  g76(.a(x09), .b(x03), .c(new_n27_), .O(new_n101_));
  nand4  g77(.a(new_n52_), .b(new_n74_), .c(new_n51_), .d(x02), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(new_n101_), .c(x01), .O(new_n103_));
  oai21  g79(.a(new_n26_), .b(x01), .c(new_n74_), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(new_n51_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(new_n103_), .c(x05), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(new_n52_), .O(z7));
  nand4  g83(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n108_));
  oai21  g84(.a(x09), .b(x00), .c(new_n51_), .O(new_n109_));
  aoi21  g85(.a(new_n108_), .b(x09), .c(new_n109_), .O(new_n110_));
  oai21  g86(.a(new_n110_), .b(new_n73_), .c(new_n52_), .O(z8));
endmodule
