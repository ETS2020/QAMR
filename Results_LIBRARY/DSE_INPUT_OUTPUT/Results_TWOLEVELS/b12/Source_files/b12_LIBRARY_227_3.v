...
module FAU ( 
  ...
  nand4  g51(.a(x13), .b(new_n75_), .c(new_n47_), .d(new_n40_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n60_), .O(z5));
  ...
  nand3  g62(.a(new_n26_), .b(x02), .c(new_n40_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n82_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n25_), .c(new_n47_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  nand2  g66(.a(new_n47_), .b(x02), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x03), .c(new_n32_), .O(new_n92_));
  nand4  g68(.a(x09), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n47_), .O(new_n94_));
  aoi21  g70(.a(new_n92_), .b(new_n48_), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n60_), .O(z7));
  nand4  g72(.a(new_n75_), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n47_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x10), .c(new_n60_), .O(z8));
endmodule
