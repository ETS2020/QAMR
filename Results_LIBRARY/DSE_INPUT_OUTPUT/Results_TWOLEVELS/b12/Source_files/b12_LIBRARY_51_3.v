...
module FAU ( 
  ...
  nor2   g50(.a(x10), .b(x00), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n74_), .d(new_n51_), .O(z5));
  nand2  g52(.a(x08), .b(x00), .O(new_n77_));
  aoi21  g53(.a(x09), .b(new_n39_), .c(x02), .O(new_n78_));
  inv1   g54(.a(x09), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x03), .c(new_n31_), .O(new_n80_));
  ...
  nor2   g59(.a(x08), .b(new_n26_), .O(new_n84_));
  ...
  nand3  g64(.a(new_n59_), .b(new_n51_), .c(x02), .O(new_n89_));
  nand3  g65(.a(x09), .b(x03), .c(new_n31_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x07), .c(new_n52_), .O(new_n92_));
  oai21  g68(.a(new_n49_), .b(x08), .c(new_n52_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n51_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n92_), .O(z7));
  aoi21  g71(.a(x12), .b(x09), .c(x07), .O(new_n96_));
  nand3  g72(.a(x03), .b(new_n31_), .c(new_n27_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n52_), .O(new_n98_));
