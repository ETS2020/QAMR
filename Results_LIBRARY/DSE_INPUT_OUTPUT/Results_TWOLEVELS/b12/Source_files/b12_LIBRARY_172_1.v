...
module FAU ( 
  ...
  nand3  g37(.a(new_n51_), .b(x09), .c(new_n27_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n37_), .c(x08), .O(new_n63_));
  ...
  aoi22  g43(.a(new_n67_), .b(new_n52_), .c(x12), .d(new_n48_), .O(z3));
  ...
  aoi21  g50(.a(new_n74_), .b(x00), .c(new_n73_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n72_), .c(new_n70_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n51_), .c(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n67_), .O(z4));
  ...
  oai21  g57(.a(x09), .b(new_n57_), .c(new_n27_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x00), .O(new_n83_));
  nor2   g59(.a(x08), .b(new_n48_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  oai21  g61(.a(new_n73_), .b(x03), .c(new_n37_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n69_), .c(new_n27_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x02), .c(new_n48_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n51_), .c(new_n25_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  inv1   g68(.a(x08), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(x02), .c(x10), .O(new_n94_));
  oai21  g70(.a(new_n57_), .b(x01), .c(new_n93_), .O(new_n95_));
  nand4  g71(.a(x09), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n25_), .O(z7));
  inv1   g73(.a(x12), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n99_));
