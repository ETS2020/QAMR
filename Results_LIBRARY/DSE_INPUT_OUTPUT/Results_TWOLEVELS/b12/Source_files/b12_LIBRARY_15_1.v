...
module FAU ( 
  ...
  nand2  g31(.a(x09), .b(new_n29_), .O(new_n56_));
  ...
  oai21  g36(.a(new_n49_), .b(new_n60_), .c(x00), .O(new_n61_));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x10), .c(new_n36_), .O(new_n63_));
  ...
  oai21  g43(.a(new_n64_), .b(new_n67_), .c(new_n25_), .O(new_n68_));
  inv1   g44(.a(x08), .O(new_n69_));
  nand3  g45(.a(new_n67_), .b(x01), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n56_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n68_), .c(new_n67_), .d(x09), .O(new_n73_));
  ...
  nand2  g53(.a(new_n77_), .b(new_n67_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n36_), .O(z5));
  nor2   g55(.a(new_n69_), .b(new_n25_), .O(new_n80_));
  ...
  nand2  g63(.a(new_n69_), .b(x00), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(new_n29_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n85_), .c(new_n67_), .O(new_n90_));
  nor2   g66(.a(new_n90_), .b(x07), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n27_), .O(new_n92_));
  nand4  g68(.a(new_n67_), .b(new_n69_), .c(new_n36_), .d(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n29_), .O(new_n95_));
  oai21  g71(.a(new_n26_), .b(x01), .c(new_n69_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n67_), .d(new_n36_), .O(z7));
  nand2  g73(.a(new_n36_), .b(new_n26_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n64_), .c(new_n27_), .d(new_n29_), .O(new_n99_));
