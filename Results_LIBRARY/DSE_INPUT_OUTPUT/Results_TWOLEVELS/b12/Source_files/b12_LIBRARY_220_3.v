...
module FAU ( 
  ...
  oai21  g37(.a(new_n57_), .b(new_n59_), .c(new_n61_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nand4  g39(.a(x13), .b(new_n63_), .c(new_n48_), .d(new_n37_), .O(new_n64_));
  inv1   g40(.a(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n59_), .O(z5));
  oai21  g42(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n67_));
  nand2  g43(.a(new_n27_), .b(new_n37_), .O(new_n68_));
  ...
  oai21  g49(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n46_), .c(new_n32_), .O(new_n75_));
  inv1   g51(.a(x14), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x01), .c(new_n37_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n72_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n48_), .c(new_n59_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(z6));
  nand3  g56(.a(new_n69_), .b(new_n59_), .c(x02), .O(new_n81_));
  nand3  g57(.a(x09), .b(x03), .c(new_n27_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(x01), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x07), .c(new_n48_), .O(new_n84_));
  aoi21  g60(.a(x03), .b(new_n32_), .c(x08), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x10), .c(new_n59_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n84_), .O(z7));
  nand4  g63(.a(new_n63_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand2  g65(.a(new_n73_), .b(new_n37_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n48_), .d(new_n59_), .O(z8));
endmodule
