...
module FAU ( 
  ...
  nand2  g25(.a(x14), .b(x10), .O(new_n50_));
  ...
  nand3  g37(.a(new_n61_), .b(new_n37_), .c(x02), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n60_), .O(z2));
  inv1   g39(.a(x11), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(x00), .c(new_n64_), .d(new_n56_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n37_), .O(z3));
  nor2   g43(.a(new_n49_), .b(x01), .O(new_n68_));
  nor2   g44(.a(x14), .b(new_n29_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n25_), .O(new_n70_));
  nor2   g46(.a(new_n29_), .b(new_n25_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n68_), .c(new_n48_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(x09), .O(new_n73_));
  nor2   g49(.a(new_n49_), .b(new_n48_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(x00), .c(new_n36_), .O(new_n75_));
  aoi21  g51(.a(new_n73_), .b(new_n52_), .c(new_n75_), .O(new_n76_));
  nand3  g52(.a(new_n37_), .b(new_n64_), .c(x07), .O(new_n77_));
  oai21  g53(.a(new_n76_), .b(x07), .c(new_n77_), .O(z4));
  nor2   g54(.a(x13), .b(x10), .O(new_n79_));
  nor3   g55(.a(new_n79_), .b(x07), .c(x00), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n65_), .c(new_n52_), .O(z5));
  ...
  oai21  g61(.a(new_n49_), .b(x03), .c(new_n27_), .O(new_n86_));
  nand2  g62(.a(x08), .b(x00), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n29_), .O(new_n88_));
  nand2  g64(.a(new_n69_), .b(new_n25_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n85_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n52_), .c(new_n56_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  nand2  g68(.a(new_n56_), .b(x02), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x03), .c(new_n29_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n52_), .c(new_n48_), .O(new_n95_));
  nor2   g71(.a(x02), .b(x01), .O(new_n96_));
  nor2   g72(.a(new_n49_), .b(new_n26_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(x10), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n95_), .c(new_n56_), .O(z7));
  nand3  g75(.a(new_n96_), .b(new_n65_), .c(x03), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  aoi21  g77(.a(new_n49_), .b(new_n25_), .c(x10), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n101_), .c(new_n56_), .O(z8));
endmodule
