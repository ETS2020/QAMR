...
module FAU ( 
  ...
  nor3   g52(.a(x12), .b(x10), .c(x00), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x13), .c(new_n49_), .O(z5));
  ...
  nand3  g67(.a(new_n59_), .b(new_n49_), .c(x02), .O(new_n92_));
  nand3  g68(.a(x09), .b(x03), .c(new_n27_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(x01), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x07), .c(new_n50_), .O(new_n95_));
  aoi21  g71(.a(x03), .b(new_n32_), .c(x08), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x10), .c(new_n49_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n95_), .O(z7));
  nand4  g74(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(new_n83_), .b(new_n39_), .O(new_n101_));
