...
module FAU ( 
  ...
  nand3  g22(.a(new_n26_), .b(x10), .c(new_n38_), .O(new_n47_));
  inv1   g23(.a(x10), .O(new_n48_));
  nand3  g24(.a(x14), .b(new_n48_), .c(x09), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n47_), .c(x08), .O(new_n50_));
  nand4  g26(.a(x14), .b(new_n48_), .c(x09), .d(new_n27_), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n50_), .c(new_n46_), .O(new_n53_));
  nor2   g29(.a(x10), .b(x07), .O(new_n54_));
  nand2  g30(.a(x14), .b(x09), .O(new_n55_));
  oai21  g31(.a(new_n54_), .b(x09), .c(new_n55_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n38_), .c(new_n27_), .O(new_n57_));
  ...
  oai21  g48(.a(x12), .b(x00), .c(new_n46_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n54_), .c(new_n26_), .d(x13), .O(z5));
  ...
  oai21  g56(.a(x02), .b(x00), .c(new_n78_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n75_), .c(x03), .O(new_n82_));
  aoi21  g58(.a(x14), .b(x02), .c(x00), .O(new_n83_));
  nor2   g59(.a(x08), .b(x02), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n83_), .c(x01), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n82_), .c(new_n80_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n48_), .c(new_n46_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n26_), .O(z6));
  nand2  g64(.a(new_n26_), .b(x02), .O(new_n89_));
  nand3  g65(.a(new_n48_), .b(new_n31_), .c(x01), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x07), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n38_), .c(new_n77_), .O(new_n92_));
  oai21  g68(.a(new_n42_), .b(x01), .c(x14), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n54_), .O(z7));
  nand2  g71(.a(new_n31_), .b(new_n28_), .O(new_n96_));
  nand3  g72(.a(x14), .b(new_n65_), .c(x03), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(x09), .O(new_n98_));
  aoi21  g74(.a(new_n75_), .b(new_n27_), .c(x10), .O(new_n99_));
