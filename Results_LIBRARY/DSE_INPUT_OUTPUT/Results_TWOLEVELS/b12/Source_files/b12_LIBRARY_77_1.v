...
module FAU ( 
  ...
  aoi22  g34(.a(new_n58_), .b(x11), .c(x12), .d(new_n27_), .O(z3));
  nand2  g35(.a(x08), .b(x00), .O(new_n60_));
  nand2  g36(.a(new_n31_), .b(x01), .O(new_n61_));
  nand2  g37(.a(x09), .b(new_n28_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n61_), .c(x11), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x10), .c(new_n60_), .O(new_n64_));
  inv1   g40(.a(x09), .O(new_n65_));
  nor2   g41(.a(x11), .b(x08), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(x02), .c(x10), .d(new_n65_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n64_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n46_), .O(new_n69_));
  inv1   g45(.a(x11), .O(new_n70_));
  nor2   g46(.a(new_n31_), .b(x00), .O(new_n71_));
  ...
  nand4  g51(.a(x13), .b(new_n75_), .c(new_n46_), .d(new_n27_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n70_), .O(new_n77_));
  ...
  nand2  g57(.a(new_n65_), .b(x03), .O(new_n82_));
  nand2  g58(.a(new_n70_), .b(x01), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(x02), .O(new_n84_));
  nand3  g60(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n84_), .c(new_n60_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x01), .c(new_n27_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n81_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n46_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n70_), .c(x10), .O(z6));
  nand3  g68(.a(x09), .b(x03), .c(new_n28_), .O(new_n93_));
  nand2  g69(.a(new_n46_), .b(x01), .O(new_n94_));
  inv1   g70(.a(x08), .O(new_n95_));
  nand2  g71(.a(new_n47_), .b(new_n95_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n31_), .O(new_n98_));
  nand3  g74(.a(new_n70_), .b(new_n46_), .c(x02), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(x03), .c(x08), .O(new_n100_));
  nor4   g76(.a(new_n100_), .b(x11), .c(x10), .d(x07), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n98_), .O(z7));
  nand4  g78(.a(new_n75_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n103_));
  oai21  g79(.a(x09), .b(x00), .c(new_n46_), .O(new_n104_));
  aoi21  g80(.a(new_n103_), .b(x09), .c(new_n104_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(x11), .c(new_n25_), .O(z8));
endmodule
