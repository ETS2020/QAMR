...
module FAU ( 
  ...
  nand3  g39(.a(x13), .b(new_n63_), .c(new_n27_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n46_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(z5));
  nor2   g42(.a(new_n53_), .b(new_n27_), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x03), .c(new_n31_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n28_), .O(new_n70_));
  nand3  g46(.a(new_n68_), .b(x03), .c(new_n31_), .O(new_n71_));
  ...
  nand2  g50(.a(new_n53_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n28_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n72_), .c(new_n25_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x07), .O(z6));
  nand3  g54(.a(x03), .b(new_n31_), .c(new_n28_), .O(new_n79_));
  nor2   g55(.a(x02), .b(x01), .O(new_n80_));
  nor2   g56(.a(new_n68_), .b(new_n38_), .O(new_n81_));
  aoi22  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n53_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x07), .c(new_n25_), .O(z7));
  nand3  g59(.a(new_n80_), .b(new_n63_), .c(x03), .O(new_n84_));
  nor2   g60(.a(x09), .b(x00), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n25_), .O(z8));
endmodule
