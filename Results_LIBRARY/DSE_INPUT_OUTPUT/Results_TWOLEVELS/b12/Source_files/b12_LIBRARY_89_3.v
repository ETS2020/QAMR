...
module FAU ( 
  ...
  aoi22  g44(.a(new_n68_), .b(x07), .c(x12), .d(new_n39_), .O(z3));
  nand3  g45(.a(x09), .b(x08), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n49_), .O(new_n71_));
  oai21  g47(.a(new_n67_), .b(x10), .c(x07), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(z4));
  inv1   g49(.a(x12), .O(new_n74_));
  nand4  g50(.a(x13), .b(new_n74_), .c(new_n50_), .d(new_n39_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n49_), .O(z5));
  oai21  g53(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n78_));
  ...
  oai21  g58(.a(new_n82_), .b(x03), .c(new_n27_), .O(new_n83_));
  ...
  nand2  g67(.a(new_n50_), .b(new_n59_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n63_), .c(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n32_), .O(new_n94_));
  oai21  g70(.a(new_n26_), .b(x01), .c(new_n59_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n50_), .d(new_n49_), .O(z7));
  aoi21  g72(.a(x09), .b(x02), .c(x07), .O(new_n97_));
  nand3  g73(.a(new_n74_), .b(x03), .c(new_n32_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n50_), .O(new_n99_));
  aoi21  g75(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  oai22  g76(.a(new_n100_), .b(x07), .c(new_n97_), .d(x10), .O(z8));
endmodule
