...
module FAU ( 
  ...
  oai21  g37(.a(x10), .b(x07), .c(x11), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x00), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai21  g40(.a(new_n48_), .b(new_n45_), .c(new_n64_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n25_), .O(z3));
  inv1   g42(.a(x08), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n27_), .c(x10), .O(new_n69_));
  nand2  g45(.a(x09), .b(x00), .O(new_n70_));
  aoi21  g46(.a(new_n69_), .b(new_n67_), .c(new_n70_), .O(new_n71_));
  inv1   g47(.a(new_n25_), .O(new_n72_));
  nand2  g48(.a(x08), .b(new_n45_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n48_), .c(new_n72_), .O(new_n74_));
  oai21  g50(.a(new_n71_), .b(x07), .c(new_n74_), .O(z4));
  nand4  g51(.a(x13), .b(new_n64_), .c(new_n45_), .d(new_n26_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n46_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n54_), .O(z5));
  nor2   g54(.a(new_n67_), .b(new_n26_), .O(new_n79_));
  oai21  g55(.a(new_n68_), .b(x03), .c(new_n30_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n27_), .O(new_n81_));
  nand3  g57(.a(new_n68_), .b(x03), .c(new_n30_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(new_n83_));
  nand2  g59(.a(x14), .b(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n26_), .O(new_n85_));
  nand2  g61(.a(new_n67_), .b(x00), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(new_n27_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n83_), .c(new_n46_), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(x07), .O(z6));
  nor2   g65(.a(x02), .b(x01), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(x03), .O(new_n91_));
  nand3  g67(.a(new_n90_), .b(x09), .c(x03), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n45_), .O(new_n93_));
  aoi21  g69(.a(new_n91_), .b(new_n67_), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n54_), .O(z7));
  nand2  g71(.a(new_n45_), .b(new_n37_), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n90_), .c(new_n64_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n45_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x10), .c(new_n54_), .O(z8));
endmodule
