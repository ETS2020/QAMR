...
module FAU ( 
  ...
  nand3  g38(.a(new_n62_), .b(new_n47_), .c(x00), .O(new_n63_));
  inv1   g39(.a(x11), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai21  g41(.a(new_n64_), .b(new_n46_), .c(new_n65_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n63_), .O(z3));
  oai21  g43(.a(new_n65_), .b(new_n47_), .c(new_n37_), .O(new_n68_));
  nand2  g44(.a(new_n25_), .b(new_n55_), .O(new_n69_));
  nor2   g45(.a(x09), .b(x01), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x10), .c(x12), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n54_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n68_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n46_), .O(new_n74_));
  nand3  g50(.a(new_n25_), .b(new_n64_), .c(x07), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z4));
  nor3   g52(.a(x12), .b(x07), .c(x00), .O(new_n77_));
  inv1   g53(.a(x13), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x10), .c(new_n65_), .O(new_n79_));
  oai21  g55(.a(new_n77_), .b(x10), .c(new_n79_), .O(z5));
  ...
  oai21  g60(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(x08), .b(x00), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n29_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x01), .c(new_n37_), .O(new_n89_));
  ...
  nand3  g68(.a(new_n54_), .b(new_n46_), .c(x02), .O(new_n93_));
  nand3  g69(.a(x09), .b(x03), .c(new_n27_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(x01), .O(new_n95_));
  aoi21  g71(.a(new_n46_), .b(x01), .c(new_n26_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x08), .c(new_n46_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(new_n47_), .O(new_n98_));
  oai21  g74(.a(x12), .b(new_n47_), .c(new_n98_), .O(z7));
  nand4  g75(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  nand2  g77(.a(new_n55_), .b(new_n37_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n47_), .d(new_n46_), .O(z8));
endmodule
