...
module FAU ( 
  ...
  nand2  g29(.a(x09), .b(new_n33_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n28_), .O(new_n55_));
  ...
  oai21  g37(.a(new_n33_), .b(new_n38_), .c(new_n54_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n53_), .O(new_n63_));
  nand4  g39(.a(new_n63_), .b(new_n48_), .c(x09), .d(x00), .O(new_n64_));
  ...
  nor2   g46(.a(new_n53_), .b(new_n38_), .O(new_n71_));
  inv1   g47(.a(x09), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(x03), .c(new_n28_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n33_), .O(new_n74_));
  nand3  g50(.a(new_n72_), .b(x03), .c(new_n28_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n71_), .O(new_n76_));
  nand2  g52(.a(x14), .b(x02), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n38_), .O(new_n78_));
  nand2  g54(.a(new_n53_), .b(x00), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(new_n33_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n76_), .c(new_n48_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(x07), .O(z6));
  nand3  g58(.a(new_n53_), .b(new_n25_), .c(x02), .O(new_n83_));
  nand3  g59(.a(x09), .b(x03), .c(new_n28_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x01), .O(new_n85_));
  aoi21  g61(.a(x03), .b(new_n33_), .c(x08), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n85_), .c(new_n48_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(z7));
  aoi21  g64(.a(new_n25_), .b(x02), .c(x12), .O(new_n89_));
  ...
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n25_), .O(z8));
endmodule
