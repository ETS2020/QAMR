...
module FAU ( 
  ...
  oai21  g43(.a(new_n60_), .b(new_n25_), .c(x07), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(z4));
  nor2   g45(.a(x12), .b(x00), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n25_), .d(new_n46_), .O(z5));
  ...
  and2   g52(.a(x08), .b(x00), .O(new_n77_));
  aoi21  g53(.a(new_n76_), .b(new_n28_), .c(new_n77_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x01), .c(new_n38_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n46_), .O(new_n81_));
  aoi21  g57(.a(new_n78_), .b(new_n30_), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n75_), .c(x10), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n28_), .O(new_n84_));
  nand3  g60(.a(new_n25_), .b(new_n47_), .c(x02), .O(new_n85_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand4  g65(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n90_));
