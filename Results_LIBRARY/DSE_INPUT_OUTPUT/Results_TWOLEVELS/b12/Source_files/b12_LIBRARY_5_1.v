...
module FAU ( 
  ...
  nor2   g30(.a(new_n37_), .b(new_n27_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n54_), .c(new_n25_), .O(new_n56_));
  ...
  nand4  g36(.a(new_n60_), .b(new_n36_), .c(new_n57_), .d(new_n50_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n56_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n50_), .c(x00), .O(new_n64_));
  nor2   g40(.a(x12), .b(x00), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x10), .c(new_n50_), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n63_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n64_), .O(z3));
  nand3  g45(.a(new_n59_), .b(new_n58_), .c(new_n28_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n36_), .c(new_n57_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n52_), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n50_), .O(new_n73_));
  oai21  g49(.a(x11), .b(new_n50_), .c(new_n73_), .O(z4));
  nor3   g50(.a(x12), .b(x10), .c(x00), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x13), .c(new_n50_), .O(z5));
  ...
  aoi21  g56(.a(new_n51_), .b(x03), .c(x01), .O(new_n81_));
  nand3  g57(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x02), .c(new_n82_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  inv1   g60(.a(x14), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x01), .c(new_n25_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n79_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n36_), .c(new_n50_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  nand3  g65(.a(new_n57_), .b(new_n50_), .c(x01), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n29_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x02), .O(new_n92_));
  aoi21  g68(.a(x03), .b(new_n27_), .c(x08), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n92_), .c(new_n36_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n50_), .O(z7));
  oai21  g71(.a(new_n26_), .b(x01), .c(new_n50_), .O(new_n96_));
  nor2   g72(.a(x12), .b(x02), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(new_n51_), .O(new_n98_));
  nor2   g74(.a(x09), .b(x00), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n98_), .c(new_n36_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n50_), .O(z8));
endmodule
