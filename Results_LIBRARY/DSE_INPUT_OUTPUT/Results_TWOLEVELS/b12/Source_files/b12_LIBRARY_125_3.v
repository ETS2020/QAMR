...
module FAU ( 
  ...
  oai22  g51(.a(x13), .b(x12), .c(x10), .d(new_n39_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n49_), .O(new_n77_));
  oai21  g53(.a(x12), .b(x07), .c(new_n50_), .O(new_n78_));
  nor2   g54(.a(x13), .b(new_n50_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n77_), .O(z5));
  nand2  g57(.a(x08), .b(x00), .O(new_n82_));
  aoi21  g58(.a(x09), .b(new_n26_), .c(x02), .O(new_n83_));
  nand3  g59(.a(new_n60_), .b(x03), .c(new_n27_), .O(new_n84_));
  ...
  nand3  g66(.a(new_n90_), .b(new_n50_), .c(new_n49_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n25_), .O(z6));
  nand3  g68(.a(new_n59_), .b(new_n49_), .c(x02), .O(new_n93_));
  ...
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(new_n50_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n80_), .O(z7));
  inv1   g75(.a(x12), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n101_));
  oai21  g77(.a(x09), .b(x00), .c(new_n49_), .O(new_n102_));
  aoi21  g78(.a(new_n101_), .b(x09), .c(new_n102_), .O(new_n103_));
  oai21  g79(.a(new_n103_), .b(x10), .c(new_n80_), .O(z8));
endmodule
