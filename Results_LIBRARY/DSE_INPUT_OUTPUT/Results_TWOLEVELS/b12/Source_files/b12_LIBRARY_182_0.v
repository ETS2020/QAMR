...
module FAU ( 
  ...
  nand3  g35(.a(x11), .b(new_n51_), .c(x09), .O(new_n60_));
  oai21  g36(.a(new_n51_), .b(x03), .c(new_n60_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n33_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n28_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n59_), .c(new_n50_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n58_), .c(new_n26_), .O(z2));
  nand2  g41(.a(x11), .b(new_n50_), .O(new_n66_));
  nor2   g42(.a(x11), .b(new_n51_), .O(new_n67_));
  inv1   g43(.a(new_n67_), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(new_n66_), .c(x12), .d(new_n40_), .O(z3));
  inv1   g45(.a(x09), .O(new_n70_));
  nand2  g46(.a(new_n26_), .b(new_n70_), .O(new_n71_));
  nand2  g47(.a(x08), .b(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x10), .O(new_n73_));
  nand2  g49(.a(x02), .b(x00), .O(new_n74_));
  nand2  g50(.a(x09), .b(new_n33_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n29_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n51_), .c(new_n59_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x00), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x11), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n73_), .c(new_n71_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n50_), .O(new_n81_));
  nand2  g57(.a(new_n67_), .b(x07), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n81_), .O(z4));
  inv1   g59(.a(x12), .O(new_n84_));
  nand4  g60(.a(x13), .b(new_n84_), .c(new_n50_), .d(new_n40_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x11), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n51_), .O(z5));
  nand2  g63(.a(new_n33_), .b(new_n40_), .O(new_n88_));
  nand2  g64(.a(x11), .b(new_n59_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n40_), .c(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n92_));
  nand3  g68(.a(new_n70_), .b(x03), .c(new_n28_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n72_), .O(new_n95_));
  nand2  g71(.a(x14), .b(x02), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n40_), .O(new_n97_));
  oai21  g73(.a(new_n89_), .b(x02), .c(new_n97_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x01), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n95_), .c(new_n91_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n50_), .O(new_n101_));
  aoi21  g77(.a(new_n101_), .b(x11), .c(x10), .O(z6));
  nand3  g78(.a(x09), .b(x03), .c(new_n33_), .O(new_n103_));
  nand2  g79(.a(new_n50_), .b(x01), .O(new_n104_));
  nand3  g80(.a(x11), .b(new_n51_), .c(new_n59_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(new_n104_), .c(new_n103_), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(new_n28_), .O(new_n107_));
  oai21  g83(.a(x07), .b(new_n28_), .c(x03), .O(new_n108_));
  nand2  g84(.a(new_n108_), .b(new_n59_), .O(new_n109_));
  aoi21  g85(.a(x11), .b(x07), .c(new_n25_), .O(new_n110_));
  nand4  g86(.a(new_n110_), .b(new_n109_), .c(new_n107_), .d(new_n51_), .O(z7));
  nand4  g87(.a(new_n84_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n112_));
  nand2  g88(.a(new_n112_), .b(x09), .O(new_n113_));
  aoi21  g89(.a(new_n70_), .b(new_n40_), .c(x10), .O(new_n114_));
