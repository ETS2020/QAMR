...
module FAU ( 
  ...
  nand2  g13(.a(new_n37_), .b(new_n36_), .O(z8));
  nand2  g14(.a(z8), .b(new_n35_), .O(z0));
  ...
  nand2  g29(.a(new_n53_), .b(z8), .O(z3));
  ...
  nand2  g34(.a(new_n58_), .b(new_n37_), .O(z5));
  zero   g35(.O(z6));
  nand2  g36(.a(new_n58_), .b(new_n37_), .O(z7));
endmodule
