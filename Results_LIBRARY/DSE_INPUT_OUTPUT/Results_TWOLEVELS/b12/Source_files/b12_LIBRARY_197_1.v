...
module FAU ( 
  ...
  nand2  g34(.a(x09), .b(new_n25_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(x01), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n56_), .c(new_n48_), .O(new_n61_));
  aoi21  g37(.a(x09), .b(new_n27_), .c(x02), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x08), .c(new_n51_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n25_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n61_), .O(z2));
  ...
  nand3  g48(.a(new_n72_), .b(new_n51_), .c(new_n48_), .O(new_n73_));
  inv1   g49(.a(x09), .O(new_n74_));
  nor2   g50(.a(x08), .b(new_n27_), .O(new_n75_));
  nor3   g51(.a(new_n75_), .b(x10), .c(new_n74_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n73_), .c(new_n71_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n25_), .O(new_n78_));
  nand2  g54(.a(new_n66_), .b(x07), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(z4));
  nor2   g56(.a(x10), .b(x00), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(x13), .c(new_n67_), .d(new_n25_), .O(z5));
  oai21  g58(.a(x09), .b(new_n57_), .c(new_n27_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n48_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  oai21  g62(.a(new_n74_), .b(x03), .c(new_n37_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n70_), .c(new_n27_), .O(new_n88_));
  inv1   g64(.a(x14), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x01), .c(new_n48_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n88_), .c(new_n86_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n51_), .c(new_n25_), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  nand3  g69(.a(x09), .b(x03), .c(new_n37_), .O(new_n94_));
  inv1   g70(.a(x08), .O(new_n95_));
  nand4  g71(.a(new_n51_), .b(new_n95_), .c(new_n25_), .d(x02), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n27_), .O(new_n98_));
  nor2   g74(.a(new_n75_), .b(x10), .O(new_n99_));
  nand2  g75(.a(new_n95_), .b(new_n57_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n25_), .O(z7));
  nand4  g77(.a(new_n67_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand2  g79(.a(new_n74_), .b(new_n48_), .O(new_n104_));
  nand4  g80(.a(new_n104_), .b(new_n103_), .c(new_n51_), .d(new_n25_), .O(z8));
endmodule
