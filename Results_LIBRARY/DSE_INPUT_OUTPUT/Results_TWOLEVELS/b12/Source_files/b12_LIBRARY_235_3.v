...
module FAU ( 
  ...
  oai21  g41(.a(new_n63_), .b(x10), .c(x07), .O(new_n66_));
  ...
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n70_), .d(new_n47_), .O(z5));
  nand2  g48(.a(new_n52_), .b(x03), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n27_), .c(new_n37_), .O(new_n74_));
  nand3  g50(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n28_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n74_), .c(new_n57_), .O(new_n77_));
  nand2  g53(.a(x14), .b(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x01), .O(new_n79_));
  oai21  g55(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n80_));
  ...
  nand2  g60(.a(new_n84_), .b(new_n77_), .O(new_n85_));
