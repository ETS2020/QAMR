...
module FAU ( 
  ...
  nand2  g58(.a(new_n82_), .b(x05), .O(new_n83_));
  ...
  aoi21  g63(.a(new_n87_), .b(new_n85_), .c(new_n25_), .O(new_n88_));
  nand3  g64(.a(x05), .b(new_n27_), .c(x01), .O(new_n89_));
  nand3  g65(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n88_), .c(new_n74_), .O(new_n92_));
  nand2  g68(.a(x14), .b(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x01), .O(new_n94_));
  oai21  g70(.a(new_n86_), .b(x03), .c(new_n27_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n29_), .O(new_n96_));
  nand3  g72(.a(new_n86_), .b(x03), .c(new_n27_), .O(new_n97_));
  ...
  aoi21  g77(.a(new_n101_), .b(x05), .c(x10), .O(z6));
  nand3  g78(.a(x09), .b(x03), .c(new_n29_), .O(new_n103_));
  nand3  g79(.a(new_n52_), .b(new_n74_), .c(new_n51_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(new_n46_), .c(new_n103_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n27_), .O(new_n106_));
  oai21  g82(.a(x07), .b(new_n27_), .c(x03), .O(new_n107_));
  nand3  g83(.a(new_n52_), .b(new_n51_), .c(x05), .O(new_n108_));
  aoi21  g84(.a(new_n107_), .b(new_n74_), .c(new_n108_), .O(new_n109_));
  nand2  g85(.a(new_n109_), .b(new_n106_), .O(z7));
  nand4  g86(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n111_));
  oai21  g87(.a(x09), .b(x00), .c(new_n51_), .O(new_n112_));
  aoi21  g88(.a(new_n111_), .b(x09), .c(new_n112_), .O(new_n113_));
  oai21  g89(.a(new_n113_), .b(new_n73_), .c(new_n52_), .O(z8));
endmodule
