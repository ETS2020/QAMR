...
module FAU ( 
  ...
  nor2   g46(.a(new_n31_), .b(new_n70_), .O(new_n71_));
  nor2   g47(.a(x12), .b(new_n29_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n69_), .O(new_n73_));
  inv1   g49(.a(x12), .O(new_n74_));
  oai21  g50(.a(x07), .b(x00), .c(x11), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n54_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n73_), .O(z3));
  nor2   g53(.a(x09), .b(x07), .O(new_n78_));
  nor2   g54(.a(x11), .b(new_n58_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(new_n30_), .O(new_n80_));
  aoi21  g56(.a(x08), .b(x00), .c(new_n29_), .O(new_n81_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n29_), .c(new_n82_), .O(new_n86_));
  ...
  nand2  g67(.a(new_n91_), .b(new_n29_), .O(z5));
  oai21  g68(.a(x09), .b(new_n28_), .c(new_n51_), .O(new_n93_));
  nor2   g69(.a(x02), .b(x00), .O(new_n94_));
  nor2   g70(.a(x08), .b(new_n70_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  nand2  g72(.a(x08), .b(x00), .O(new_n97_));
  oai21  g73(.a(new_n83_), .b(x03), .c(new_n40_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n97_), .c(new_n51_), .O(new_n99_));
  inv1   g75(.a(x14), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(x01), .c(new_n70_), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n99_), .c(new_n96_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n29_), .c(new_n58_), .d(new_n54_), .O(new_n103_));
  inv1   g79(.a(new_n103_), .O(z6));
  nand3  g80(.a(x09), .b(x03), .c(new_n40_), .O(new_n105_));
  nand4  g81(.a(new_n29_), .b(new_n82_), .c(new_n58_), .d(x02), .O(new_n106_));
  aoi21  g82(.a(new_n106_), .b(new_n105_), .c(x01), .O(new_n107_));
  oai21  g83(.a(new_n28_), .b(x01), .c(new_n82_), .O(new_n108_));
  nand2  g84(.a(new_n108_), .b(new_n58_), .O(new_n109_));
  oai21  g85(.a(new_n109_), .b(new_n107_), .c(new_n54_), .O(new_n110_));
  nand2  g86(.a(new_n110_), .b(new_n29_), .O(z7));
  nand4  g87(.a(new_n74_), .b(x03), .c(new_n40_), .d(new_n51_), .O(new_n112_));
  oai21  g88(.a(x09), .b(x00), .c(new_n58_), .O(new_n113_));
  aoi21  g89(.a(new_n112_), .b(x09), .c(new_n113_), .O(new_n114_));
  oai21  g90(.a(new_n114_), .b(x05), .c(new_n29_), .O(z8));
endmodule
