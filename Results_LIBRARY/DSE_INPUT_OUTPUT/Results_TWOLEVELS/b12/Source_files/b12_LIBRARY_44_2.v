...
module FAU ( 
  ...
  aoi21  g55(.a(new_n79_), .b(x00), .c(x06), .O(new_n80_));
  ...
  nand2  g60(.a(new_n84_), .b(new_n53_), .O(z5));
  ...
  aoi22  g87(.a(new_n76_), .b(new_n25_), .c(x07), .d(new_n36_), .O(new_n112_));
  nand4  g88(.a(new_n112_), .b(new_n111_), .c(new_n53_), .d(new_n36_), .O(z8));
endmodule
