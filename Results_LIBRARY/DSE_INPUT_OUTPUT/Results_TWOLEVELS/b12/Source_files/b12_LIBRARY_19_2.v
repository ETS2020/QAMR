...
module FAU ( 
  ...
  nand3  g26(.a(new_n50_), .b(x09), .c(new_n36_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n52_));
  nand2  g28(.a(new_n50_), .b(x09), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n49_), .c(x08), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n36_), .c(new_n52_), .O(new_n55_));
  nor2   g31(.a(new_n37_), .b(x00), .O(new_n56_));
  nor2   g32(.a(x08), .b(x07), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(x02), .O(new_n58_));
  oai21  g34(.a(new_n55_), .b(x01), .c(new_n58_), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x10), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(x07), .c(x12), .d(new_n25_), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n36_), .O(new_n64_));
  oai21  g40(.a(new_n61_), .b(new_n36_), .c(new_n64_), .O(z4));
  inv1   g41(.a(x12), .O(new_n66_));
  nand3  g42(.a(x13), .b(new_n66_), .c(new_n25_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n36_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n50_), .O(z5));
  oai21  g45(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n70_));
  nand2  g46(.a(new_n27_), .b(new_n25_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n70_), .O(new_n75_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n75_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n50_), .c(new_n36_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand2  g60(.a(new_n36_), .b(x02), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x03), .c(new_n29_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n72_), .O(new_n87_));
  nor2   g63(.a(x02), .b(x01), .O(new_n88_));
  nor2   g64(.a(new_n76_), .b(new_n26_), .O(new_n89_));
  nand2  g65(.a(new_n50_), .b(new_n36_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(new_n88_), .c(new_n90_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n87_), .O(z7));
  nand3  g68(.a(new_n88_), .b(new_n66_), .c(x03), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n76_), .b(new_n25_), .c(new_n90_), .O(new_n95_));
