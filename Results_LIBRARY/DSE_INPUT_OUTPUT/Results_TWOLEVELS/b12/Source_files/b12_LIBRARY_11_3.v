...
module FAU ( 
  ...
  oai21  g44(.a(new_n66_), .b(x10), .c(x07), .O(new_n69_));
  nand3  g45(.a(x09), .b(x08), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n36_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n69_), .O(z4));
  oai21  g48(.a(x12), .b(x07), .c(new_n37_), .O(new_n73_));
  nand3  g49(.a(x13), .b(new_n37_), .c(new_n25_), .O(new_n74_));
  ...
  nand3  g64(.a(new_n58_), .b(new_n36_), .c(x02), .O(new_n89_));
  nand3  g65(.a(x09), .b(x03), .c(new_n27_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x07), .c(new_n37_), .O(new_n92_));
  aoi21  g68(.a(x03), .b(new_n29_), .c(x08), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n36_), .O(new_n94_));
