...
module FAU ( 
  ...
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n36_), .d(new_n53_), .O(z5));
  ...
  nand3  g59(.a(new_n83_), .b(new_n36_), .c(new_n53_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n27_), .O(new_n86_));
  inv1   g62(.a(x08), .O(new_n87_));
  nand4  g63(.a(new_n36_), .b(new_n87_), .c(new_n53_), .d(x02), .O(new_n88_));
  ...
  oai21  g67(.a(new_n91_), .b(x07), .c(new_n36_), .O(new_n92_));
  nor2   g68(.a(new_n36_), .b(new_n26_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n90_), .O(z7));
  oai21  g71(.a(x10), .b(x09), .c(new_n26_), .O(new_n96_));
  nand3  g72(.a(new_n63_), .b(new_n27_), .c(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  nand2  g74(.a(new_n77_), .b(new_n25_), .O(new_n99_));
  aoi21  g75(.a(new_n36_), .b(x07), .c(new_n93_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n96_), .O(z8));
endmodule
