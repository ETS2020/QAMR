...
module FAU ( 
  ...
  oai21  g38(.a(new_n58_), .b(new_n60_), .c(new_n62_), .O(z4));
  inv1   g39(.a(x12), .O(new_n64_));
  nand4  g40(.a(x13), .b(new_n64_), .c(new_n49_), .d(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n60_), .O(new_n66_));
  oai21  g42(.a(x10), .b(new_n60_), .c(new_n66_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n49_), .c(new_n60_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x09), .b(x03), .c(new_n27_), .O(new_n82_));
  nand4  g58(.a(new_n49_), .b(new_n70_), .c(new_n60_), .d(x02), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n29_), .O(new_n85_));
  oai21  g61(.a(new_n26_), .b(x01), .c(new_n70_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n49_), .d(new_n60_), .O(z7));
  nand4  g63(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand2  g65(.a(new_n74_), .b(new_n25_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n49_), .d(new_n60_), .O(z8));
endmodule
