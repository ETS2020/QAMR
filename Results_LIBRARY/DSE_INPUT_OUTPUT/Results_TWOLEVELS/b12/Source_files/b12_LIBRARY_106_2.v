...
module FAU ( 
  ...
  oai21  g43(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n68_));
  ...
  aoi22  g48(.a(new_n72_), .b(new_n28_), .c(x08), .d(x00), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x01), .c(new_n38_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  aoi21  g52(.a(new_n73_), .b(new_n33_), .c(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n71_), .c(x10), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n28_), .O(new_n79_));
  nand3  g55(.a(new_n25_), .b(new_n54_), .c(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n33_), .O(new_n82_));
  nand2  g58(.a(x03), .b(new_n33_), .O(new_n83_));
  nand2  g59(.a(new_n25_), .b(new_n47_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(new_n54_), .c(new_n84_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n82_), .O(z7));
  nand4  g62(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  nor2   g64(.a(x09), .b(x00), .O(new_n89_));
  nor2   g65(.a(new_n89_), .b(new_n84_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n88_), .O(z8));
endmodule
