...
module FAU ( 
  ...
  nand4  g48(.a(x13), .b(new_n72_), .c(new_n37_), .d(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  oai21  g50(.a(x10), .b(new_n36_), .c(new_n74_), .O(z5));
  ...
  nand3  g62(.a(new_n86_), .b(new_n37_), .c(new_n36_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n39_), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  nand2  g65(.a(new_n37_), .b(new_n58_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n62_), .c(new_n89_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n29_), .O(new_n92_));
  oai21  g68(.a(new_n26_), .b(x01), .c(new_n58_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n37_), .d(new_n36_), .O(z7));
  nand4  g70(.a(new_n72_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  nand2  g72(.a(new_n80_), .b(new_n25_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n37_), .d(new_n36_), .O(z8));
endmodule
