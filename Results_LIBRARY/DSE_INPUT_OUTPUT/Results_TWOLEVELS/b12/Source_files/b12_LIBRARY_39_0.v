...
module FAU ( 
  ...
  nand2  g37(.a(new_n61_), .b(new_n53_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n59_), .c(x01), .O(new_n63_));
  aoi21  g39(.a(new_n58_), .b(x02), .c(new_n63_), .O(new_n64_));
  nor2   g40(.a(new_n26_), .b(x03), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n61_), .c(new_n33_), .O(new_n66_));
  ...
  oai21  g46(.a(new_n70_), .b(new_n53_), .c(x00), .O(new_n71_));
  inv1   g47(.a(x12), .O(new_n72_));
  oai21  g48(.a(x07), .b(x00), .c(x11), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n39_), .O(z3));
  nand3  g51(.a(x09), .b(x08), .c(x00), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n53_), .O(new_n77_));
  nand2  g53(.a(new_n70_), .b(x07), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n39_), .O(z4));
  oai21  g55(.a(x12), .b(x00), .c(new_n53_), .O(new_n80_));
  aoi21  g56(.a(x07), .b(x05), .c(x10), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n39_), .d(x13), .O(z5));
  oai21  g58(.a(x09), .b(new_n29_), .c(new_n33_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n40_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  oai21  g62(.a(new_n60_), .b(x03), .c(new_n41_), .O(new_n87_));
  nand2  g63(.a(x08), .b(x00), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n33_), .O(new_n89_));
  ...
  nand4  g68(.a(new_n92_), .b(new_n26_), .c(new_n53_), .d(x05), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  nand3  g70(.a(x09), .b(x03), .c(new_n41_), .O(new_n95_));
  inv1   g71(.a(x08), .O(new_n96_));
  nand4  g72(.a(new_n26_), .b(new_n96_), .c(new_n53_), .d(x02), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n95_), .c(x01), .O(new_n98_));
  oai21  g74(.a(new_n29_), .b(x01), .c(new_n96_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n53_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n98_), .c(x05), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n26_), .O(z7));
  nand4  g78(.a(new_n72_), .b(x03), .c(new_n41_), .d(new_n33_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  aoi22  g80(.a(new_n60_), .b(new_n40_), .c(x07), .d(x05), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n26_), .d(x05), .O(z8));
endmodule
