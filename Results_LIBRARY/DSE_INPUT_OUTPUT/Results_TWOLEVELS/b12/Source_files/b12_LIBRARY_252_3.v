...
module FAU ( 
  ...
  oai21  g31(.a(new_n55_), .b(new_n49_), .c(new_n37_), .O(new_n56_));
  ...
  nand3  g36(.a(new_n60_), .b(new_n57_), .c(new_n46_), .O(new_n61_));
  ...
  nand4  g47(.a(new_n71_), .b(new_n69_), .c(new_n47_), .d(new_n46_), .O(z5));
  nor2   g48(.a(new_n57_), .b(new_n37_), .O(new_n73_));
  oai21  g49(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n29_), .O(new_n75_));
  nand3  g51(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n76_));
  ...
  nand2  g55(.a(new_n57_), .b(x00), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(new_n29_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n77_), .c(new_n47_), .O(new_n82_));
  nor2   g58(.a(new_n82_), .b(x07), .O(z6));
  nand3  g59(.a(new_n57_), .b(new_n46_), .c(x02), .O(new_n84_));
  ...
  aoi21  g66(.a(x12), .b(x09), .c(x07), .O(new_n91_));
  nand3  g67(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n92_));
  oai21  g68(.a(x09), .b(x00), .c(new_n47_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai22  g70(.a(new_n94_), .b(x07), .c(new_n91_), .d(x10), .O(z8));
endmodule
