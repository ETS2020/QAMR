...
module FAU ( 
  ...
  inv1   g32(.a(new_n37_), .O(new_n57_));
  inv1   g33(.a(x10), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(x03), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n53_), .c(new_n29_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n27_), .c(x08), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n51_), .c(new_n57_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n56_), .O(z2));
  inv1   g39(.a(x11), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(x00), .c(new_n64_), .d(new_n51_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n37_), .O(z3));
  oai21  g43(.a(x13), .b(new_n58_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n37_), .b(new_n52_), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  nand2  g46(.a(x01), .b(x00), .O(new_n71_));
  nand2  g47(.a(x09), .b(new_n29_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(x10), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x13), .c(new_n70_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n69_), .c(new_n68_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n51_), .O(new_n76_));
  nand3  g52(.a(new_n37_), .b(new_n64_), .c(x07), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(z4));
  oai21  g54(.a(x12), .b(x10), .c(x13), .O(new_n79_));
  nand3  g55(.a(x13), .b(new_n51_), .c(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n58_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z5));
  nand2  g58(.a(x08), .b(x00), .O(new_n83_));
  aoi21  g59(.a(x09), .b(new_n26_), .c(x02), .O(new_n84_));
  nand3  g60(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n85_));
  ...
  nand3  g67(.a(new_n91_), .b(new_n58_), .c(new_n51_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n37_), .O(z6));
  nand3  g69(.a(new_n70_), .b(new_n51_), .c(x02), .O(new_n94_));
  nand3  g70(.a(x09), .b(x03), .c(new_n27_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(x01), .O(new_n96_));
  oai21  g72(.a(new_n26_), .b(x01), .c(new_n70_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n51_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n96_), .c(new_n58_), .O(new_n99_));
  nand2  g75(.a(x13), .b(x10), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n99_), .O(z7));
  nand4  g77(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n102_));
  oai21  g78(.a(x09), .b(x00), .c(new_n51_), .O(new_n103_));
  aoi21  g79(.a(new_n102_), .b(x09), .c(new_n103_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(x10), .c(new_n100_), .O(z8));
endmodule
