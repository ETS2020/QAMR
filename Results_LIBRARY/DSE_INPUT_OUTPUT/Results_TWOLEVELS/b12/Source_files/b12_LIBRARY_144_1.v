...
module FAU ( 
  ...
  aoi21  g59(.a(x14), .b(x01), .c(x00), .O(new_n84_));
  nor3   g60(.a(x10), .b(x08), .c(x01), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(x02), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n83_), .c(new_n80_), .d(new_n36_), .O(new_n87_));
  and2   g63(.a(new_n87_), .b(new_n50_), .O(z6));
