...
module FAU ( 
  ...
  aoi21  g40(.a(new_n64_), .b(new_n33_), .c(x08), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n55_), .c(new_n61_), .O(new_n66_));
  oai21  g42(.a(new_n60_), .b(x00), .c(new_n66_), .O(z2));
  nor2   g43(.a(x11), .b(x10), .O(new_n68_));
  aoi21  g44(.a(x11), .b(new_n55_), .c(new_n68_), .O(new_n69_));
  aoi21  g45(.a(x12), .b(new_n27_), .c(new_n69_), .O(z3));
  nand3  g46(.a(x09), .b(x08), .c(x00), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n55_), .O(new_n72_));
  oai21  g48(.a(new_n51_), .b(x11), .c(new_n72_), .O(z4));
  inv1   g49(.a(x12), .O(new_n74_));
  nand4  g50(.a(x13), .b(new_n74_), .c(new_n62_), .d(new_n55_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  oai21  g52(.a(new_n69_), .b(new_n27_), .c(new_n76_), .O(z5));
  ...
  nand3  g63(.a(new_n87_), .b(new_n62_), .c(new_n55_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  inv1   g65(.a(x08), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n55_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n33_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  oai21  g69(.a(new_n49_), .b(x08), .c(new_n55_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n93_), .c(new_n62_), .O(new_n95_));
  oai21  g71(.a(new_n25_), .b(new_n62_), .c(new_n95_), .O(z7));
  nand4  g72(.a(new_n74_), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  nand2  g74(.a(new_n56_), .b(new_n27_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n62_), .d(new_n55_), .O(z8));
endmodule
