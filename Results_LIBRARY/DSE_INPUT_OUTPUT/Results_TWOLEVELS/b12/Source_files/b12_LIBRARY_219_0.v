...
module FAU ( 
  ...
  nand2  g25(.a(new_n49_), .b(x06), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n29_), .O(new_n52_));
  nand3  g28(.a(new_n52_), .b(new_n47_), .c(new_n45_), .O(new_n53_));
  ...
  aoi21  g40(.a(new_n64_), .b(new_n55_), .c(new_n36_), .O(new_n65_));
  oai21  g41(.a(new_n60_), .b(x00), .c(new_n65_), .O(z2));
  inv1   g42(.a(x11), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n55_), .c(x00), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  oai21  g45(.a(x07), .b(x00), .c(x11), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n68_), .c(new_n37_), .O(z3));
  nand3  g48(.a(x09), .b(x08), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n55_), .O(new_n74_));
  nand2  g50(.a(new_n67_), .b(x07), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n37_), .O(z4));
  oai21  g52(.a(x12), .b(x00), .c(new_n55_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n49_), .c(new_n37_), .d(x13), .O(z5));
  ...
  oai21  g58(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n83_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n61_), .c(new_n55_), .d(x06), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  nand3  g66(.a(x09), .b(x03), .c(new_n27_), .O(new_n91_));
  nand2  g67(.a(x06), .b(x02), .O(new_n92_));
  inv1   g68(.a(x08), .O(new_n93_));
  nand3  g69(.a(new_n61_), .b(new_n93_), .c(new_n55_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n92_), .c(new_n91_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n29_), .O(new_n96_));
  oai21  g72(.a(new_n26_), .b(x01), .c(new_n93_), .O(new_n97_));
  nor2   g73(.a(new_n36_), .b(x10), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(z7));
  nand4  g75(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  aoi21  g77(.a(new_n56_), .b(new_n25_), .c(x07), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n101_), .c(new_n98_), .O(z8));
endmodule
