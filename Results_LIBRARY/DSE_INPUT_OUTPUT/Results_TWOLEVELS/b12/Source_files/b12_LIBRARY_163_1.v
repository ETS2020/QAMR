...
module FAU ( 
  ...
  nor2   g29(.a(new_n51_), .b(x09), .O(new_n54_));
  ...
  nand3  g33(.a(new_n57_), .b(x09), .c(new_n33_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n28_), .c(x08), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n50_), .c(new_n54_), .O(new_n60_));
  oai21  g36(.a(new_n56_), .b(x00), .c(new_n60_), .O(z2));
  inv1   g37(.a(x12), .O(new_n62_));
  oai22  g38(.a(new_n62_), .b(x00), .c(new_n51_), .d(x09), .O(new_n63_));
  nand2  g39(.a(x12), .b(new_n40_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n26_), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(x11), .c(new_n63_), .d(x07), .O(z3));
  aoi21  g42(.a(new_n50_), .b(x00), .c(x10), .O(new_n67_));
  nand2  g43(.a(x08), .b(x00), .O(new_n68_));
  nor2   g44(.a(x11), .b(new_n50_), .O(new_n69_));
  aoi21  g45(.a(new_n68_), .b(new_n50_), .c(new_n69_), .O(new_n70_));
  oai21  g46(.a(new_n67_), .b(x09), .c(new_n70_), .O(z4));
  nand2  g47(.a(x10), .b(new_n25_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n50_), .c(x00), .O(new_n73_));
  nand3  g49(.a(new_n64_), .b(x13), .c(new_n50_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nand2  g51(.a(x10), .b(x09), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n73_), .O(z5));
  ...
  oai21  g57(.a(new_n25_), .b(x03), .c(new_n28_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n68_), .c(new_n33_), .O(new_n83_));
  ...
  nand4  g66(.a(new_n51_), .b(new_n90_), .c(new_n50_), .d(x02), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n33_), .O(new_n93_));
  aoi21  g69(.a(x03), .b(new_n33_), .c(x08), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x07), .c(new_n51_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n93_), .c(new_n76_), .O(z7));
  oai21  g72(.a(x09), .b(x07), .c(new_n62_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n40_), .c(x07), .O(new_n98_));
  nand3  g74(.a(new_n62_), .b(new_n51_), .c(x03), .O(new_n99_));
  nor3   g75(.a(new_n99_), .b(x02), .c(x01), .O(new_n100_));
  oai22  g76(.a(new_n100_), .b(new_n25_), .c(new_n98_), .d(x10), .O(z8));
endmodule
