...
module FAU ( 
  ...
  nand2  g57(.a(new_n73_), .b(x00), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(new_n32_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n79_), .c(new_n47_), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(x07), .O(z6));
  nand2  g61(.a(new_n46_), .b(x02), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(x03), .c(new_n32_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n46_), .O(new_n89_));
  aoi21  g65(.a(new_n87_), .b(new_n73_), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n55_), .O(z7));
  oai21  g67(.a(new_n26_), .b(x02), .c(new_n46_), .O(new_n92_));
  ...
  oai21  g71(.a(new_n95_), .b(new_n94_), .c(new_n47_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n55_), .O(z8));
endmodule
