...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n27_), .O(z4));
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n47_), .d(new_n39_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n25_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n48_), .O(z5));
  nor2   g44(.a(x02), .b(x00), .O(new_n69_));
  nor2   g45(.a(x08), .b(new_n39_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(x01), .O(new_n71_));
  oai22  g47(.a(x08), .b(x02), .c(x01), .d(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x03), .O(new_n73_));
  aoi21  g49(.a(x14), .b(x01), .c(x00), .O(new_n74_));
  nor2   g50(.a(x08), .b(x01), .O(new_n75_));
  ...
  nand3  g56(.a(new_n51_), .b(x02), .c(new_n31_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x03), .c(new_n31_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n80_), .c(x07), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x09), .c(new_n48_), .O(z7));
  nand4  g60(.a(new_n48_), .b(new_n25_), .c(new_n47_), .d(x00), .O(z8));
endmodule
