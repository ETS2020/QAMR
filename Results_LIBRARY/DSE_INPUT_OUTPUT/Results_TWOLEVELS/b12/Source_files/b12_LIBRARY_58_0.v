...
module FAU ( 
  ...
  nor2   g00(.a(x07), .b(x06), .O(new_n25_));
  ...
  aoi21  g16(.a(x07), .b(new_n39_), .c(new_n40_), .O(new_n41_));
  ...
  nor2   g22(.a(new_n25_), .b(new_n31_), .O(new_n47_));
  ...
  nand3  g30(.a(new_n54_), .b(new_n49_), .c(x06), .O(new_n55_));
  ...
  oai21  g36(.a(new_n60_), .b(new_n54_), .c(new_n28_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n31_), .O(new_n62_));
  nand4  g38(.a(new_n62_), .b(new_n58_), .c(new_n49_), .d(x06), .O(new_n63_));
  ...
  oai21  g43(.a(new_n67_), .b(new_n39_), .c(new_n49_), .O(new_n68_));
  nand2  g44(.a(new_n67_), .b(new_n65_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(z3));
  nand3  g46(.a(x09), .b(x08), .c(x00), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n49_), .c(x06), .O(new_n72_));
  oai21  g48(.a(x11), .b(new_n49_), .c(new_n72_), .O(z4));
  nand4  g49(.a(x13), .b(new_n67_), .c(x06), .d(new_n27_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n50_), .c(new_n49_), .O(z5));
  ...
  aoi21  g56(.a(x09), .b(new_n48_), .c(x02), .O(new_n81_));
  nand3  g57(.a(new_n53_), .b(x03), .c(new_n31_), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x01), .c(new_n82_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n80_), .O(new_n84_));
  inv1   g60(.a(x14), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x02), .c(new_n27_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n79_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(x06), .c(x07), .O(z6));
  nand2  g65(.a(new_n49_), .b(x02), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x03), .c(new_n28_), .O(new_n91_));
  nand4  g67(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n59_), .O(new_n93_));
  aoi21  g69(.a(new_n91_), .b(new_n58_), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n39_), .c(new_n49_), .O(z7));
  oai21  g71(.a(new_n48_), .b(x02), .c(new_n49_), .O(new_n96_));
  nor2   g72(.a(x12), .b(x01), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(new_n53_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n59_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n98_), .c(x06), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n49_), .O(z8));
endmodule
