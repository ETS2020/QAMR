...
module FAU ( 
  ...
  nand2  g25(.a(new_n47_), .b(new_n46_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n26_), .O(new_n51_));
  nand3  g27(.a(new_n47_), .b(x09), .c(new_n46_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n51_), .c(x01), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n49_), .c(new_n37_), .O(new_n54_));
  inv1   g30(.a(x08), .O(new_n55_));
  inv1   g31(.a(x09), .O(new_n56_));
  nor2   g32(.a(x10), .b(new_n56_), .O(new_n57_));
  nor2   g33(.a(new_n47_), .b(x03), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n57_), .c(new_n29_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n27_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n55_), .c(new_n46_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n54_), .c(new_n25_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n46_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(z3));
  aoi21  g42(.a(new_n56_), .b(new_n29_), .c(x10), .O(new_n67_));
  nand2  g43(.a(x09), .b(x00), .O(new_n68_));
  aoi21  g44(.a(new_n67_), .b(new_n55_), .c(new_n68_), .O(new_n69_));
  aoi21  g45(.a(x08), .b(new_n46_), .c(x11), .O(new_n70_));
  aoi21  g46(.a(x11), .b(x10), .c(new_n70_), .O(new_n71_));
  oai21  g47(.a(new_n69_), .b(x07), .c(new_n71_), .O(z4));
  inv1   g48(.a(x13), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(x00), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n64_), .c(new_n47_), .d(new_n46_), .O(z5));
  oai21  g51(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n76_));
  nor2   g52(.a(x02), .b(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n37_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(new_n76_), .O(new_n79_));
  oai21  g55(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n80_));
  nand2  g56(.a(x08), .b(x00), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n29_), .O(new_n82_));
  inv1   g58(.a(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x01), .c(new_n37_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n47_), .c(new_n46_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  nand4  g64(.a(new_n47_), .b(new_n55_), .c(new_n46_), .d(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n29_), .O(new_n91_));
  oai21  g67(.a(new_n50_), .b(new_n29_), .c(x03), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n55_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n91_), .c(new_n47_), .d(new_n46_), .O(z7));
  nand4  g70(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n46_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  nand2  g73(.a(new_n63_), .b(x10), .O(new_n98_));
  oai21  g74(.a(new_n97_), .b(x10), .c(new_n98_), .O(z8));
endmodule
