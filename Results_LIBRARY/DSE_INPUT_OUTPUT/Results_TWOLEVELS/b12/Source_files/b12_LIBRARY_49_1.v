...
module FAU ( 
  ...
  nand2  g35(.a(x09), .b(new_n27_), .O(new_n60_));
  inv1   g36(.a(x10), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(x02), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n60_), .c(x08), .O(new_n63_));
  ...
  oai22  g43(.a(new_n67_), .b(x00), .c(new_n66_), .d(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n26_), .O(z3));
  nand2  g45(.a(x08), .b(x00), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(x09), .c(new_n27_), .O(new_n71_));
  oai21  g47(.a(new_n34_), .b(new_n37_), .c(new_n27_), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n27_), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n48_), .c(new_n73_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n71_), .c(new_n61_), .d(x09), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n66_), .b(x07), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n76_), .O(z4));
  nor2   g54(.a(x10), .b(x00), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(x13), .c(new_n67_), .d(new_n25_), .O(z5));
  oai21  g56(.a(x09), .b(new_n52_), .c(new_n27_), .O(new_n81_));
  nor2   g57(.a(x02), .b(x00), .O(new_n82_));
  nor2   g58(.a(x08), .b(new_n48_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  inv1   g60(.a(x09), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x03), .c(new_n37_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n70_), .c(new_n27_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x01), .c(new_n48_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n61_), .c(new_n25_), .O(new_n91_));
  ...
  nor2   g71(.a(new_n85_), .b(new_n52_), .O(new_n96_));
  aoi22  g72(.a(new_n96_), .b(new_n94_), .c(new_n95_), .d(new_n93_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x10), .c(new_n25_), .O(z7));
  nand3  g74(.a(new_n94_), .b(new_n67_), .c(x03), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(new_n85_), .b(new_n48_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n61_), .d(new_n25_), .O(z8));
endmodule
