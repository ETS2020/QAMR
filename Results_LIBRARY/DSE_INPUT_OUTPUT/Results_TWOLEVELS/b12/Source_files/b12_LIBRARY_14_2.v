...
module FAU ( 
  ...
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n73_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n25_), .c(new_n47_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n28_), .O(new_n83_));
  nand3  g59(.a(new_n25_), .b(new_n54_), .c(x02), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x01), .O(new_n85_));
  aoi21  g61(.a(x03), .b(new_n30_), .c(x08), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n85_), .c(new_n47_), .O(new_n87_));
  ...
  nand2  g66(.a(new_n74_), .b(new_n38_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n25_), .d(new_n47_), .O(z8));
endmodule
