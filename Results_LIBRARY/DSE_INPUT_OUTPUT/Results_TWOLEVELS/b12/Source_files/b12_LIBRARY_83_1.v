...
module FAU ( 
  ...
  nor2   g38(.a(x02), .b(x00), .O(new_n63_));
  nor2   g39(.a(x08), .b(new_n25_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(x01), .O(new_n65_));
  nand2  g41(.a(new_n56_), .b(new_n25_), .O(new_n66_));
  aoi21  g42(.a(new_n54_), .b(new_n29_), .c(new_n55_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n49_), .c(new_n36_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n61_), .O(z4));
  inv1   g46(.a(x13), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(x12), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n49_), .c(new_n36_), .d(new_n25_), .O(z5));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  aoi21  g50(.a(x09), .b(new_n26_), .c(x02), .O(new_n75_));
  nand3  g51(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n76_));
  oai21  g52(.a(new_n75_), .b(x01), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x02), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n65_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n49_), .c(new_n36_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n84_));
  nand4  g60(.a(new_n49_), .b(new_n54_), .c(new_n36_), .d(x02), .O(new_n85_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n49_), .d(new_n36_), .O(z7));
  oai21  g65(.a(new_n26_), .b(x02), .c(new_n36_), .O(new_n90_));
  nor2   g66(.a(x12), .b(x01), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(new_n55_), .O(new_n92_));
  nor2   g68(.a(x09), .b(x00), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n92_), .c(new_n49_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n36_), .O(z8));
endmodule
