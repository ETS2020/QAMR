...
module FAU ( 
  ...
  nand3  g36(.a(new_n51_), .b(x09), .c(new_n30_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n28_), .c(x08), .O(new_n62_));
  ...
  oai21  g57(.a(new_n81_), .b(x03), .c(new_n28_), .O(new_n82_));
  nand2  g58(.a(x08), .b(x00), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n30_), .O(new_n84_));
  inv1   g60(.a(x14), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x02), .c(new_n40_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n80_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n51_), .c(new_n25_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n28_), .O(new_n90_));
  nand4  g66(.a(new_n51_), .b(new_n68_), .c(new_n25_), .d(x02), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n30_), .O(new_n93_));
  aoi21  g69(.a(new_n68_), .b(x01), .c(x10), .O(new_n94_));
  nand2  g70(.a(new_n68_), .b(new_n27_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n25_), .O(z7));
  inv1   g72(.a(x12), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  nand2  g75(.a(new_n81_), .b(new_n40_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
