...
module FAU ( 
  ...
  nor3   g45(.a(new_n27_), .b(new_n60_), .c(x01), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(x12), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n52_), .O(new_n72_));
  nor2   g48(.a(new_n27_), .b(x01), .O(new_n73_));
  inv1   g49(.a(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n68_), .O(z3));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  oai21  g52(.a(x10), .b(new_n60_), .c(new_n25_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n60_), .O(new_n78_));
  aoi21  g54(.a(new_n66_), .b(x07), .c(new_n73_), .O(new_n79_));
  oai21  g55(.a(new_n78_), .b(x07), .c(new_n79_), .O(z4));
  nand4  g56(.a(x13), .b(new_n67_), .c(new_n52_), .d(new_n69_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n27_), .O(new_n82_));
  oai21  g58(.a(new_n27_), .b(new_n25_), .c(new_n82_), .O(z5));
  nand3  g59(.a(new_n76_), .b(x02), .c(new_n25_), .O(new_n84_));
  aoi21  g60(.a(x14), .b(x02), .c(x00), .O(new_n85_));
  nor2   g61(.a(x08), .b(new_n69_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n85_), .c(x01), .O(new_n87_));
  xor2a  g63(.a(x09), .b(x03), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n58_), .c(x00), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(new_n90_));
  nand3  g66(.a(new_n88_), .b(new_n25_), .c(new_n69_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(new_n92_));
  aoi21  g68(.a(new_n90_), .b(new_n27_), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x07), .c(new_n74_), .O(z6));
  nor2   g70(.a(x08), .b(x07), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(x01), .O(new_n96_));
  nand4  g72(.a(new_n27_), .b(new_n52_), .c(x02), .d(new_n25_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x03), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n58_), .O(new_n99_));
  nand2  g75(.a(x09), .b(x03), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(x02), .c(new_n27_), .O(new_n101_));
  aoi22  g77(.a(new_n101_), .b(new_n25_), .c(new_n27_), .d(x07), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n99_), .c(new_n96_), .O(z7));
  nor2   g79(.a(new_n60_), .b(new_n25_), .O(new_n104_));
  aoi21  g80(.a(x09), .b(new_n25_), .c(x00), .O(new_n105_));
  aoi21  g81(.a(new_n104_), .b(x00), .c(new_n105_), .O(new_n106_));
  nand3  g82(.a(new_n67_), .b(x03), .c(new_n59_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(x09), .O(new_n108_));
  nand4  g84(.a(new_n108_), .b(new_n106_), .c(new_n27_), .d(new_n52_), .O(z8));
endmodule
