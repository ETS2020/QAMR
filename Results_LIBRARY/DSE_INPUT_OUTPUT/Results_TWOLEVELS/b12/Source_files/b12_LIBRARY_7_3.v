...
module FAU ( 
  ...
  nand2  g00(.a(x14), .b(x09), .O(new_n25_));
  ...
  nand2  g16(.a(x03), .b(new_n30_), .O(new_n41_));
  ...
  nand3  g21(.a(new_n25_), .b(x10), .c(new_n37_), .O(new_n46_));
  inv1   g22(.a(x10), .O(new_n47_));
  inv1   g23(.a(x14), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(new_n47_), .c(x09), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n46_), .c(x08), .O(new_n50_));
  nand4  g26(.a(new_n48_), .b(new_n47_), .c(x09), .d(new_n26_), .O(new_n51_));
  ...
  nand3  g32(.a(new_n56_), .b(new_n37_), .c(new_n26_), .O(new_n57_));
  ...
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n45_), .O(new_n65_));
  ...
  oai21  g47(.a(new_n71_), .b(x00), .c(new_n45_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n54_), .c(new_n25_), .d(new_n64_), .O(z5));
  inv1   g49(.a(x08), .O(new_n74_));
  inv1   g50(.a(x09), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x03), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n30_), .c(new_n26_), .O(new_n77_));
  nand2  g53(.a(x09), .b(new_n37_), .O(new_n78_));
  oai21  g54(.a(x02), .b(new_n27_), .c(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  oai21  g56(.a(new_n48_), .b(new_n27_), .c(x02), .O(new_n81_));
  oai21  g57(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n82_));
  ...
  nand2  g61(.a(new_n85_), .b(new_n80_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n47_), .c(new_n45_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(z6));
  nand2  g64(.a(new_n25_), .b(x02), .O(new_n89_));
  nand3  g65(.a(new_n47_), .b(new_n30_), .c(x01), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x07), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n37_), .c(new_n74_), .O(new_n92_));
  oai21  g68(.a(new_n41_), .b(x01), .c(new_n48_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n54_), .O(z7));
  nand2  g71(.a(new_n30_), .b(new_n27_), .O(new_n96_));
  nand3  g72(.a(new_n48_), .b(new_n64_), .c(x03), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(x09), .O(new_n98_));
  aoi21  g74(.a(new_n75_), .b(new_n26_), .c(x10), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n98_), .c(new_n45_), .O(z8));
endmodule
