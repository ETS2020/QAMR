...
module FAU ( 
  ...
  nand4  g49(.a(new_n73_), .b(new_n65_), .c(new_n52_), .d(new_n56_), .O(z5));
  nor2   g50(.a(new_n48_), .b(new_n25_), .O(new_n75_));
  oai21  g51(.a(new_n49_), .b(x03), .c(new_n27_), .O(new_n76_));
  ...
  oai21  g55(.a(new_n36_), .b(new_n27_), .c(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n48_), .b(x00), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(new_n29_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n79_), .c(new_n52_), .O(new_n83_));
