...
module FAU ( 
  ...
  nand2  g26(.a(x09), .b(new_n46_), .O(new_n51_));
  ...
  aoi21  g30(.a(x10), .b(new_n26_), .c(x09), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(x01), .c(new_n27_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n54_), .c(new_n46_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n53_), .c(new_n25_), .O(z2));
  inv1   g34(.a(x11), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x00), .c(new_n59_), .O(new_n61_));
  inv1   g37(.a(new_n25_), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n37_), .c(x12), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n46_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n61_), .c(new_n25_), .O(z3));
  nand2  g41(.a(x09), .b(new_n29_), .O(new_n66_));
  nand2  g42(.a(new_n47_), .b(x01), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  nand2  g44(.a(x09), .b(x00), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n46_), .O(new_n70_));
  aoi21  g46(.a(new_n59_), .b(x07), .c(new_n62_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  inv1   g48(.a(x09), .O(new_n73_));
  oai21  g49(.a(x12), .b(x10), .c(new_n73_), .O(new_n74_));
  nand2  g50(.a(x12), .b(x09), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n46_), .d(new_n37_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n47_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(z5));
  ...
  oai21  g58(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n83_));
  ...
  aoi21  g69(.a(new_n46_), .b(x01), .c(new_n26_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x08), .c(new_n46_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(new_n47_), .O(new_n96_));
  oai21  g72(.a(new_n47_), .b(x09), .c(new_n96_), .O(z7));
  oai21  g73(.a(x10), .b(new_n37_), .c(new_n73_), .O(new_n98_));
  nand2  g74(.a(new_n75_), .b(new_n46_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n47_), .O(new_n100_));
  nand4  g76(.a(new_n47_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(z8));
endmodule
