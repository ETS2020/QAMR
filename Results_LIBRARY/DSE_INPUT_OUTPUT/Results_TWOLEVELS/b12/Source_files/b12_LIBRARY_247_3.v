...
module FAU ( 
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n25_), .O(z4));
  nand4  g46(.a(x13), .b(new_n64_), .c(new_n46_), .d(new_n37_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n47_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n55_), .O(z5));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  aoi21  g50(.a(x09), .b(new_n26_), .c(x02), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n77_));
  oai21  g53(.a(new_n75_), .b(x01), .c(new_n77_), .O(new_n78_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n47_), .c(new_n46_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(z6));
  inv1   g61(.a(x08), .O(new_n86_));
  nand2  g62(.a(new_n46_), .b(x02), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x03), .c(new_n32_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n46_), .O(new_n90_));
  aoi21  g66(.a(new_n88_), .b(new_n86_), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n55_), .O(z7));
  nand4  g68(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n93_));
  oai21  g69(.a(x09), .b(x00), .c(new_n46_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n55_), .O(z8));
endmodule
