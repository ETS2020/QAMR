...
module FAU ( 
  ...
  nand2  g23(.a(x03), .b(new_n27_), .O(new_n48_));
  ...
  oai22  g45(.a(new_n69_), .b(x00), .c(new_n68_), .d(new_n51_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(z3));
  oai21  g47(.a(new_n68_), .b(x10), .c(x07), .O(new_n72_));
  nand3  g48(.a(x09), .b(x08), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n51_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n72_), .O(z4));
  oai21  g51(.a(x12), .b(x07), .c(new_n52_), .O(new_n76_));
  nand3  g52(.a(x13), .b(new_n52_), .c(new_n26_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n51_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n76_), .O(z5));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  aoi21  g56(.a(x09), .b(new_n39_), .c(x02), .O(new_n81_));
  ...
  nand3  g65(.a(new_n89_), .b(new_n52_), .c(new_n51_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n25_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n31_), .O(new_n92_));
  nand2  g68(.a(new_n52_), .b(new_n59_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n64_), .c(new_n92_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n27_), .O(new_n95_));
  nand2  g71(.a(new_n48_), .b(new_n59_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n52_), .d(new_n51_), .O(z7));
  aoi21  g73(.a(x09), .b(x02), .c(x10), .O(new_n98_));
  nand3  g74(.a(new_n69_), .b(x03), .c(new_n27_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(new_n82_), .b(new_n26_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(new_n51_), .O(z8));
endmodule
