...
module FAU ( 
  ...
  nand4  g47(.a(new_n71_), .b(new_n69_), .c(new_n53_), .d(new_n38_), .O(z5));
  ...
  nand3  g56(.a(new_n25_), .b(x02), .c(new_n38_), .O(new_n81_));
  ...
  nand4  g61(.a(new_n69_), .b(new_n47_), .c(new_n53_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n33_), .O(new_n88_));
  nand2  g64(.a(x03), .b(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n47_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n88_), .c(new_n69_), .d(new_n53_), .O(z7));
  nand2  g67(.a(new_n89_), .b(new_n53_), .O(new_n92_));
