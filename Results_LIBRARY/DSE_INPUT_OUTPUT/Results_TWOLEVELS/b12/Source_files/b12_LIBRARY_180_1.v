...
module FAU ( 
  ...
  oai22  g39(.a(new_n63_), .b(x00), .c(new_n48_), .d(new_n47_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n26_), .O(z3));
  nand3  g41(.a(x09), .b(x08), .c(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n48_), .b(x07), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n26_), .O(z4));
  inv1   g45(.a(x13), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x11), .c(new_n25_), .O(new_n71_));
  aoi21  g47(.a(new_n47_), .b(x00), .c(x10), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n68_), .d(new_n63_), .O(z5));
  ...
  oai21  g54(.a(new_n56_), .b(x03), .c(new_n28_), .O(new_n79_));
  ...
  nand4  g60(.a(new_n84_), .b(new_n48_), .c(new_n25_), .d(new_n47_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n28_), .O(new_n87_));
  nand2  g63(.a(new_n47_), .b(x02), .O(new_n88_));
  nand3  g64(.a(new_n48_), .b(new_n25_), .c(new_n55_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n30_), .O(new_n91_));
  oai21  g67(.a(new_n27_), .b(x01), .c(new_n55_), .O(new_n92_));
  nor3   g68(.a(x11), .b(x10), .c(x07), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n91_), .O(z7));
  ...
  oai21  g73(.a(new_n97_), .b(x11), .c(new_n25_), .O(z8));
endmodule
