...
module FAU ( 
  ...
  nor2   g12(.a(x14), .b(new_n36_), .O(new_n37_));
  ...
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n52_), .O(new_n65_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n38_), .O(z4));
  nand4  g46(.a(x13), .b(new_n64_), .c(new_n52_), .d(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n36_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x10), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z5));
  nand2  g50(.a(new_n27_), .b(new_n25_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x00), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n75_), .c(new_n29_), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  aoi21  g55(.a(x09), .b(new_n26_), .c(x02), .O(new_n80_));
  nand3  g56(.a(new_n53_), .b(x03), .c(new_n27_), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(x01), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n79_), .c(new_n78_), .O(new_n83_));
  inv1   g59(.a(x14), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x02), .c(new_n25_), .O(new_n85_));
  oai21  g61(.a(new_n83_), .b(x10), .c(new_n85_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n52_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n38_), .O(z6));
  nand3  g64(.a(new_n76_), .b(new_n52_), .c(x02), .O(new_n89_));
  nand3  g65(.a(x09), .b(x03), .c(new_n27_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  oai21  g67(.a(new_n26_), .b(x01), .c(new_n76_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n52_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n91_), .c(new_n36_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n73_), .O(z7));
  nand2  g71(.a(new_n52_), .b(new_n26_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n64_), .c(new_n27_), .d(new_n29_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n52_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x10), .c(new_n73_), .O(z8));
endmodule
