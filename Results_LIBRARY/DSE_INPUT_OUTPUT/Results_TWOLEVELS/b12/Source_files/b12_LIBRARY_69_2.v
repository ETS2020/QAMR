...
module FAU ( 
  ...
  nand4  g50(.a(new_n74_), .b(new_n25_), .c(new_n54_), .d(new_n40_), .O(z5));
  ...
  oai21  g55(.a(new_n53_), .b(new_n40_), .c(new_n79_), .O(new_n80_));
  ...
  aoi21  g59(.a(new_n83_), .b(x01), .c(x07), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n80_), .c(x10), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n28_), .O(new_n86_));
  nand3  g62(.a(new_n25_), .b(new_n53_), .c(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n33_), .O(new_n89_));
  nand2  g65(.a(new_n25_), .b(new_n54_), .O(new_n90_));
  nand2  g66(.a(x03), .b(new_n33_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n53_), .c(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n89_), .O(z7));
  nand4  g69(.a(new_n66_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n77_), .b(new_n40_), .c(new_n90_), .O(new_n96_));
