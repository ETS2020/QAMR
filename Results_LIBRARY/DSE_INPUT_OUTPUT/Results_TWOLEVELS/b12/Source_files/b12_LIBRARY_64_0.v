...
module FAU ( 
  ...
  nand3  g25(.a(x11), .b(new_n49_), .c(x09), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n48_), .c(x08), .O(new_n51_));
  nand4  g27(.a(x11), .b(new_n49_), .c(x09), .d(new_n38_), .O(new_n52_));
  ...
  nor2   g35(.a(new_n25_), .b(x00), .O(new_n60_));
  aoi21  g36(.a(x11), .b(x00), .c(x10), .O(new_n61_));
  nor3   g37(.a(new_n61_), .b(x08), .c(x07), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n60_), .c(x02), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n59_), .O(z2));
  nand2  g40(.a(new_n55_), .b(x00), .O(new_n65_));
  inv1   g41(.a(x11), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n49_), .c(new_n66_), .O(new_n68_));
  nand3  g44(.a(new_n67_), .b(new_n47_), .c(new_n38_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n65_), .O(z3));
  nand3  g46(.a(x09), .b(x08), .c(x00), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n47_), .O(new_n72_));
  oai21  g48(.a(new_n49_), .b(x07), .c(new_n66_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z4));
  oai21  g50(.a(x12), .b(x00), .c(new_n47_), .O(new_n75_));
  nor2   g51(.a(x10), .b(x07), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n75_), .c(new_n26_), .d(x13), .O(z5));
  inv1   g53(.a(x08), .O(new_n78_));
  inv1   g54(.a(x09), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x03), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n28_), .c(new_n38_), .O(new_n81_));
  nand3  g57(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n29_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(new_n78_), .O(new_n84_));
  nand2  g60(.a(x14), .b(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x01), .O(new_n86_));
  oai21  g62(.a(new_n79_), .b(x03), .c(new_n28_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n33_), .O(new_n88_));
  nand3  g64(.a(new_n79_), .b(x03), .c(new_n28_), .O(new_n89_));
  ...
  nand4  g68(.a(new_n92_), .b(x11), .c(new_n49_), .d(new_n47_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  nand3  g70(.a(x09), .b(x03), .c(new_n33_), .O(new_n95_));
  nand2  g71(.a(new_n47_), .b(x01), .O(new_n96_));
  nand3  g72(.a(x11), .b(new_n49_), .c(new_n78_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n28_), .O(new_n99_));
  oai21  g75(.a(new_n27_), .b(x02), .c(new_n78_), .O(new_n100_));
  nor2   g76(.a(new_n66_), .b(x10), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n47_), .O(z7));
  nand4  g78(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  aoi21  g80(.a(new_n79_), .b(new_n38_), .c(x07), .O(new_n105_));
  nand3  g81(.a(new_n105_), .b(new_n104_), .c(new_n101_), .O(z8));
endmodule
