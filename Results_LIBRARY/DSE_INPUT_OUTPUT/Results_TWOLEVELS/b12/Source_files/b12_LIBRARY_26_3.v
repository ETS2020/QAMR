...
module FAU ( 
  ...
  oai22  g43(.a(new_n67_), .b(x00), .c(new_n66_), .d(new_n36_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n39_), .O(z3));
  nand3  g45(.a(x09), .b(x08), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n36_), .O(new_n71_));
  nand3  g47(.a(new_n66_), .b(new_n37_), .c(x07), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(z4));
  oai21  g49(.a(x12), .b(x07), .c(new_n37_), .O(new_n74_));
  nand3  g50(.a(x13), .b(new_n37_), .c(new_n25_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n36_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(z5));
  nand2  g53(.a(x08), .b(x00), .O(new_n78_));
  aoi21  g54(.a(x09), .b(new_n26_), .c(x02), .O(new_n79_));
  inv1   g55(.a(x09), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x03), .c(new_n27_), .O(new_n81_));
  oai21  g57(.a(new_n79_), .b(x01), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g63(.a(new_n87_), .b(new_n37_), .c(new_n36_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n39_), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n27_), .O(new_n90_));
  nand2  g66(.a(new_n37_), .b(new_n58_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n62_), .c(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n29_), .O(new_n93_));
  oai21  g69(.a(new_n26_), .b(x01), .c(new_n58_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n37_), .d(new_n36_), .O(z7));
  aoi21  g71(.a(x12), .b(x09), .c(x07), .O(new_n96_));
  nand3  g72(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n37_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai22  g75(.a(new_n99_), .b(x07), .c(new_n96_), .d(x10), .O(z8));
endmodule
