...
module FAU ( 
  ...
  aoi22  g31(.a(new_n37_), .b(new_n25_), .c(new_n55_), .d(new_n48_), .O(new_n56_));
  oai22  g32(.a(new_n56_), .b(new_n27_), .c(new_n54_), .d(x01), .O(z2));
  inv1   g33(.a(x11), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(x10), .O(new_n59_));
  aoi22  g35(.a(new_n59_), .b(x07), .c(x12), .d(new_n25_), .O(z3));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n48_), .O(new_n62_));
  oai21  g38(.a(new_n59_), .b(new_n48_), .c(new_n62_), .O(z4));
  inv1   g39(.a(x13), .O(new_n64_));
  aoi21  g40(.a(x12), .b(new_n25_), .c(new_n64_), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n36_), .c(new_n48_), .d(new_n25_), .O(z5));
  nor2   g42(.a(new_n55_), .b(new_n25_), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x03), .c(new_n27_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n29_), .O(new_n70_));
  nand3  g46(.a(new_n68_), .b(x03), .c(new_n27_), .O(new_n71_));
  ...
  oai21  g52(.a(new_n76_), .b(new_n72_), .c(new_n36_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x07), .O(z6));
  nand2  g54(.a(new_n48_), .b(x02), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x03), .c(new_n29_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n55_), .O(new_n81_));
  nor2   g57(.a(x02), .b(x01), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x09), .c(x03), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n81_), .c(new_n36_), .d(new_n48_), .O(z7));
  inv1   g60(.a(x12), .O(new_n85_));
  nand3  g61(.a(new_n82_), .b(new_n85_), .c(x03), .O(new_n86_));
  nor2   g62(.a(x09), .b(x00), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x07), .c(new_n36_), .O(z8));
endmodule
