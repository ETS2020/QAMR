...
module FAU ( 
  ...
  nand2  g55(.a(x09), .b(new_n51_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(x10), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n27_), .c(new_n66_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x07), .c(new_n78_), .O(z4));
  inv1   g59(.a(x13), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(x12), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n29_), .c(new_n58_), .d(new_n48_), .O(z5));
  oai21  g62(.a(x09), .b(new_n52_), .c(new_n51_), .O(new_n87_));
  nor2   g63(.a(x02), .b(x00), .O(new_n88_));
  nor2   g64(.a(x08), .b(new_n48_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  oai21  g66(.a(new_n61_), .b(x03), .c(new_n25_), .O(new_n91_));
  nand2  g67(.a(x08), .b(x00), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n51_), .O(new_n93_));
  inv1   g69(.a(x14), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(x01), .c(new_n48_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n93_), .c(new_n90_), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n29_), .c(new_n58_), .O(new_n97_));
  inv1   g73(.a(new_n97_), .O(z6));
  inv1   g74(.a(new_n57_), .O(new_n99_));
  nand3  g75(.a(new_n66_), .b(new_n58_), .c(x02), .O(new_n100_));
  nand3  g76(.a(x09), .b(x03), .c(new_n25_), .O(new_n101_));
  aoi21  g77(.a(new_n101_), .b(new_n100_), .c(x01), .O(new_n102_));
  oai21  g78(.a(new_n52_), .b(x01), .c(new_n66_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n58_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(new_n102_), .c(new_n29_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n99_), .O(z7));
  nand4  g82(.a(new_n72_), .b(x03), .c(new_n25_), .d(new_n51_), .O(new_n107_));
  oai21  g83(.a(x09), .b(x00), .c(new_n58_), .O(new_n108_));
  aoi21  g84(.a(new_n107_), .b(x09), .c(new_n108_), .O(new_n109_));
  oai21  g85(.a(new_n109_), .b(x10), .c(new_n99_), .O(z8));
endmodule
