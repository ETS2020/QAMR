...
module FAU ( 
  ...
  nand4  g46(.a(new_n70_), .b(new_n62_), .c(new_n36_), .d(new_n53_), .O(z5));
  inv1   g47(.a(x08), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  ...
  nand2  g56(.a(new_n72_), .b(x00), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(new_n29_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n78_), .c(new_n36_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(x07), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand4  g61(.a(new_n36_), .b(new_n72_), .c(new_n53_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  oai21  g64(.a(x10), .b(new_n72_), .c(new_n26_), .O(new_n89_));
  nand2  g65(.a(new_n36_), .b(x07), .O(new_n90_));
  nand2  g66(.a(new_n72_), .b(x01), .O(new_n91_));
  nand2  g67(.a(x10), .b(x03), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n89_), .c(new_n88_), .O(z7));
  nand3  g71(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n53_), .c(x12), .O(new_n97_));
  aoi21  g73(.a(new_n74_), .b(new_n25_), .c(x07), .O(new_n98_));
  oai21  g74(.a(new_n97_), .b(new_n74_), .c(new_n98_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n36_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n92_), .O(z8));
endmodule
