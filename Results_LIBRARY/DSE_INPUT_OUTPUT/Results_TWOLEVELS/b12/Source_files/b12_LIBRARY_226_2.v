...
module FAU ( 
  ...
  oai21  g43(.a(new_n67_), .b(new_n51_), .c(x00), .O(new_n68_));
  ...
  oai21  g50(.a(new_n25_), .b(new_n67_), .c(x07), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z4));
  nor3   g52(.a(x12), .b(x10), .c(x00), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x13), .c(new_n51_), .O(z5));
  ...
  nand2  g65(.a(x13), .b(x07), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n33_), .O(new_n91_));
  inv1   g67(.a(x08), .O(new_n92_));
  nand3  g68(.a(new_n52_), .b(new_n92_), .c(x02), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n91_), .c(x01), .O(new_n94_));
  oai21  g70(.a(new_n49_), .b(x08), .c(new_n52_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n94_), .c(new_n51_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n90_), .O(z7));
  nand4  g73(.a(new_n69_), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n52_), .O(new_n99_));
  aoi21  g75(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(x07), .c(new_n90_), .O(z8));
endmodule
