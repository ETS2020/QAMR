...
module FAU ( 
  ...
  aoi21  g35(.a(new_n49_), .b(new_n36_), .c(new_n59_), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  nor2   g37(.a(new_n61_), .b(x00), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n60_), .c(new_n37_), .O(z3));
  nand2  g39(.a(new_n27_), .b(new_n25_), .O(new_n64_));
  nand2  g40(.a(new_n54_), .b(x00), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x01), .O(new_n67_));
  nand2  g43(.a(new_n56_), .b(new_n25_), .O(new_n68_));
  aoi21  g44(.a(new_n54_), .b(new_n29_), .c(new_n55_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n49_), .c(new_n36_), .O(new_n71_));
  nand2  g47(.a(new_n59_), .b(x07), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n71_), .O(z4));
  inv1   g49(.a(x13), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n49_), .c(x12), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n49_), .c(new_n36_), .d(new_n25_), .O(z5));
  oai22  g52(.a(x10), .b(new_n29_), .c(x09), .d(new_n26_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n66_), .O(new_n78_));
  nand2  g54(.a(new_n29_), .b(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n65_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x09), .c(new_n26_), .O(new_n81_));
  aoi21  g57(.a(x14), .b(x01), .c(x00), .O(new_n82_));
  nor2   g58(.a(x08), .b(x01), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(x02), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n81_), .c(new_n78_), .d(new_n49_), .O(new_n85_));
  and2   g61(.a(new_n85_), .b(new_n36_), .O(z6));
  nand2  g62(.a(new_n36_), .b(x02), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x03), .c(new_n29_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(new_n90_));
  aoi21  g66(.a(new_n88_), .b(new_n54_), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n36_), .O(z7));
  nand4  g68(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n55_), .b(new_n25_), .O(new_n95_));
