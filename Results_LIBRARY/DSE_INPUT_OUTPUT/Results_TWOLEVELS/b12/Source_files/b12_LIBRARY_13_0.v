...
module FAU ( 
  ...
  nand3  g37(.a(new_n27_), .b(new_n58_), .c(x07), .O(new_n62_));
  aoi21  g38(.a(x08), .b(x00), .c(new_n25_), .O(new_n63_));
  nor2   g39(.a(new_n26_), .b(x09), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n49_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n62_), .O(z4));
  nand4  g42(.a(x13), .b(new_n59_), .c(new_n49_), .d(new_n39_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x09), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n26_), .O(z5));
  nor2   g45(.a(x02), .b(x01), .O(new_n70_));
  oai22  g46(.a(new_n70_), .b(new_n39_), .c(x03), .d(x01), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n53_), .O(new_n72_));
  aoi21  g48(.a(x03), .b(new_n29_), .c(x01), .O(new_n73_));
  inv1   g49(.a(x14), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n30_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n73_), .c(new_n39_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n72_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n26_), .c(x09), .d(new_n49_), .O(new_n79_));
  inv1   g55(.a(new_n79_), .O(z6));
  nand2  g56(.a(new_n42_), .b(new_n31_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x08), .c(new_n49_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x09), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n26_), .O(z7));
  nand4  g60(.a(new_n70_), .b(new_n59_), .c(new_n49_), .d(x03), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x09), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n26_), .O(z8));
endmodule
