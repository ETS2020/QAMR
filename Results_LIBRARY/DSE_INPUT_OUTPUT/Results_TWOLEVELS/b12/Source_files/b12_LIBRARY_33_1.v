...
module FAU ( 
  ...
  nand4  g51(.a(new_n69_), .b(new_n52_), .c(new_n51_), .d(new_n27_), .O(new_n76_));
  ...
  nand3  g63(.a(new_n87_), .b(x02), .c(new_n27_), .O(new_n88_));
  ...
  nand2  g68(.a(new_n51_), .b(x02), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x03), .c(new_n28_), .O(new_n94_));
  nand4  g70(.a(x09), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n52_), .c(new_n51_), .O(new_n96_));
  aoi21  g72(.a(new_n94_), .b(new_n92_), .c(new_n96_), .O(new_n97_));
  nor2   g73(.a(new_n97_), .b(new_n61_), .O(z7));
  nand4  g74(.a(new_n69_), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n99_));
