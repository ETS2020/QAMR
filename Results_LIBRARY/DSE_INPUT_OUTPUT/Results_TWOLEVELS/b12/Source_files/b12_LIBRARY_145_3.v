...
module FAU ( 
  ...
  nand2  g65(.a(new_n89_), .b(new_n36_), .O(z6));
  nand3  g66(.a(new_n71_), .b(new_n50_), .c(x02), .O(new_n91_));
  ...
  nand2  g70(.a(new_n94_), .b(new_n50_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(new_n57_), .O(new_n96_));
  nand2  g72(.a(x10), .b(new_n70_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n96_), .O(z7));
  nand4  g74(.a(new_n77_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n99_));
