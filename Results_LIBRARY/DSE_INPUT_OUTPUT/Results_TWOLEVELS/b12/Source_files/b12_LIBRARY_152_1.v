...
module FAU ( 
  ...
  nor2   g01(.a(new_n25_), .b(x13), .O(new_n26_));
  ...
  nor2   g22(.a(new_n46_), .b(new_n29_), .O(new_n47_));
  ...
  oai21  g28(.a(new_n52_), .b(new_n47_), .c(new_n39_), .O(new_n53_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n31_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n29_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n54_), .c(new_n49_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n53_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n27_), .O(new_n62_));
  inv1   g38(.a(x13), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x01), .c(x14), .O(new_n64_));
  and2   g40(.a(new_n64_), .b(new_n50_), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n49_), .c(x02), .d(new_n39_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n62_), .O(z2));
  inv1   g43(.a(x11), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  oai22  g45(.a(new_n69_), .b(x00), .c(new_n68_), .d(new_n49_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n27_), .O(z4));
  nand4  g51(.a(new_n69_), .b(new_n50_), .c(new_n49_), .d(new_n39_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x13), .O(new_n77_));
  oai21  g53(.a(x14), .b(x13), .c(new_n77_), .O(z5));
  oai21  g54(.a(x02), .b(x01), .c(x00), .O(new_n79_));
  xor2a  g55(.a(x09), .b(x03), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n29_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n79_), .c(x08), .O(new_n82_));
  nand2  g58(.a(new_n64_), .b(x02), .O(new_n83_));
  oai21  g59(.a(new_n80_), .b(x01), .c(new_n29_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x00), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n82_), .c(new_n50_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n27_), .O(z6));
  nand2  g63(.a(new_n49_), .b(x02), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x03), .c(new_n31_), .O(new_n89_));
  nor2   g65(.a(x02), .b(x01), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x09), .c(x03), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n50_), .c(new_n49_), .O(new_n92_));
  aoi21  g68(.a(new_n89_), .b(new_n54_), .c(new_n92_), .O(new_n93_));
  nor2   g69(.a(new_n93_), .b(new_n26_), .O(z7));
  nand3  g70(.a(new_n90_), .b(new_n69_), .c(x03), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  nor3   g73(.a(new_n97_), .b(x10), .c(x07), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(new_n96_), .c(new_n26_), .O(z8));
endmodule
