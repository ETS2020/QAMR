...
module FAU ( 
  ...
  nor2   g40(.a(x11), .b(new_n47_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n26_), .O(new_n66_));
  nand2  g42(.a(x01), .b(x00), .O(new_n67_));
  nand2  g43(.a(x09), .b(new_n30_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(x13), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x10), .c(new_n55_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x07), .c(new_n66_), .O(z4));
  inv1   g47(.a(x13), .O(new_n72_));
  nor2   g48(.a(x02), .b(x01), .O(new_n73_));
  aoi21  g49(.a(new_n28_), .b(new_n30_), .c(new_n27_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(x09), .d(new_n47_), .O(new_n75_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n30_), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x02), .c(new_n38_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n82_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n72_), .c(new_n25_), .d(new_n47_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n28_), .O(new_n92_));
  nand4  g68(.a(new_n25_), .b(new_n55_), .c(new_n47_), .d(x02), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(x01), .O(new_n94_));
  oai21  g70(.a(new_n27_), .b(x01), .c(new_n55_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n47_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n94_), .c(new_n72_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n25_), .O(z7));
  nand3  g74(.a(new_n73_), .b(new_n60_), .c(x03), .O(new_n99_));
  oai21  g75(.a(x09), .b(x00), .c(new_n47_), .O(new_n100_));
  aoi21  g76(.a(new_n99_), .b(x09), .c(new_n100_), .O(new_n101_));
  oai21  g77(.a(new_n101_), .b(x13), .c(new_n25_), .O(z8));
endmodule
