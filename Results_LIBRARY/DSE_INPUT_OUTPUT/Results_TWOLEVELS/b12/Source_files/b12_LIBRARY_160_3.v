...
module FAU ( 
  ...
  nor2   g20(.a(new_n44_), .b(x06), .O(new_n45_));
  inv1   g21(.a(x07), .O(new_n46_));
  nor2   g22(.a(x10), .b(new_n46_), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n25_), .O(new_n48_));
  ...
  nand4  g29(.a(new_n53_), .b(new_n44_), .c(x09), .d(new_n46_), .O(new_n54_));
  inv1   g30(.a(new_n54_), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n29_), .O(new_n56_));
  oai21  g32(.a(x08), .b(x07), .c(x00), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n36_), .c(x02), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n56_), .O(z2));
  nand2  g35(.a(x11), .b(x07), .O(new_n60_));
  nand2  g36(.a(x12), .b(new_n25_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n36_), .O(new_n62_));
  ...
  nand4  g46(.a(new_n70_), .b(x13), .c(new_n69_), .d(new_n44_), .O(z5));
  ...
  nand3  g57(.a(new_n81_), .b(new_n44_), .c(new_n46_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n36_), .O(z6));
  inv1   g59(.a(new_n45_), .O(new_n84_));
  nand3  g60(.a(new_n50_), .b(new_n46_), .c(x02), .O(new_n85_));
  nand3  g61(.a(x09), .b(x03), .c(new_n27_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x01), .O(new_n87_));
  oai21  g63(.a(new_n26_), .b(x01), .c(new_n50_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n46_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n87_), .c(new_n44_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n84_), .O(z7));
  nand4  g67(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  nand2  g69(.a(new_n76_), .b(new_n25_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n44_), .d(new_n46_), .O(z8));
endmodule
