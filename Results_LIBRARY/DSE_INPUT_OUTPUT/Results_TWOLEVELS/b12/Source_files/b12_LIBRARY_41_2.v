...
module FAU ( 
  ...
  nand2  g64(.a(new_n25_), .b(new_n57_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n63_), .c(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n28_), .O(new_n91_));
  nand2  g67(.a(new_n25_), .b(new_n59_), .O(new_n92_));
  nand2  g68(.a(x03), .b(new_n28_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n57_), .c(new_n92_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n91_), .O(z7));
  inv1   g71(.a(x12), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n28_), .O(new_n97_));
  aoi21  g73(.a(new_n42_), .b(new_n59_), .c(new_n97_), .O(new_n98_));
  aoi21  g74(.a(new_n77_), .b(new_n27_), .c(new_n92_), .O(new_n99_));
  oai21  g75(.a(new_n98_), .b(new_n77_), .c(new_n99_), .O(z8));
endmodule
