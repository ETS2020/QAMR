...
module FAU ( 
  ...
  nor2   g21(.a(new_n45_), .b(new_n27_), .O(new_n46_));
  oai21  g22(.a(x10), .b(x07), .c(new_n26_), .O(new_n47_));
  inv1   g23(.a(x07), .O(new_n48_));
  nand3  g24(.a(new_n36_), .b(x09), .c(new_n48_), .O(new_n49_));
  ...
  nand3  g28(.a(new_n36_), .b(x09), .c(x04), .O(new_n53_));
  oai21  g29(.a(new_n36_), .b(x03), .c(new_n53_), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(new_n29_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n27_), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n52_), .c(new_n48_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n51_), .c(new_n37_), .O(z2));
  nand2  g34(.a(x11), .b(x07), .O(new_n59_));
  nand2  g35(.a(x12), .b(new_n25_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n37_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z3));
  aoi21  g38(.a(x09), .b(x00), .c(x07), .O(new_n63_));
  nor2   g39(.a(x11), .b(new_n48_), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(new_n37_), .O(new_n65_));
  inv1   g41(.a(x09), .O(new_n66_));
  nand2  g42(.a(x01), .b(x00), .O(new_n67_));
  oai21  g43(.a(new_n66_), .b(x01), .c(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n36_), .c(x04), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n36_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n52_), .c(new_n48_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n65_), .O(z4));
  inv1   g48(.a(x12), .O(new_n73_));
  nand4  g49(.a(x13), .b(new_n73_), .c(new_n48_), .d(new_n25_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x04), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n36_), .O(z5));
  nand2  g52(.a(x08), .b(x00), .O(new_n77_));
  aoi21  g53(.a(x09), .b(new_n26_), .c(x02), .O(new_n78_));
  nand3  g54(.a(new_n66_), .b(x03), .c(new_n27_), .O(new_n79_));
  ...
  nand4  g61(.a(new_n85_), .b(new_n36_), .c(new_n48_), .d(x04), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  nand4  g64(.a(new_n36_), .b(new_n52_), .c(new_n48_), .d(x02), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n26_), .b(x01), .c(new_n52_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n48_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n90_), .c(x04), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n36_), .O(z7));
  oai21  g70(.a(new_n26_), .b(x02), .c(new_n48_), .O(new_n95_));
  nor2   g71(.a(x12), .b(x01), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(new_n66_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n48_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n97_), .c(x04), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n36_), .O(z8));
endmodule
