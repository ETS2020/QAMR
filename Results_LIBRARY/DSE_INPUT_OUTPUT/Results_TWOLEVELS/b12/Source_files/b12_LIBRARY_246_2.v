...
module FAU ( 
  ...
  nor2   g30(.a(x13), .b(new_n50_), .O(new_n55_));
  ...
  aoi22  g45(.a(new_n69_), .b(x07), .c(x12), .d(new_n40_), .O(z3));
  nand3  g46(.a(x09), .b(x08), .c(x00), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n50_), .O(new_n72_));
  oai21  g48(.a(new_n69_), .b(new_n50_), .c(new_n72_), .O(z4));
  nor3   g49(.a(x12), .b(x10), .c(x00), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x13), .c(new_n50_), .O(z5));
  ...
  oai21  g55(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n80_));
  nand2  g56(.a(x08), .b(x00), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n33_), .O(new_n82_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n51_), .c(new_n50_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n26_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n28_), .O(new_n88_));
  nand3  g64(.a(new_n51_), .b(new_n60_), .c(x02), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n27_), .b(x01), .c(new_n60_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n51_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n90_), .c(new_n50_), .O(new_n93_));
  oai21  g69(.a(new_n25_), .b(new_n50_), .c(new_n93_), .O(z7));
