...
module FAU ( 
  ...
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n26_), .O(z4));
  inv1   g48(.a(x13), .O(new_n73_));
  aoi21  g49(.a(x12), .b(new_n38_), .c(x07), .O(new_n74_));
  nand2  g50(.a(new_n57_), .b(new_n38_), .O(new_n75_));
  nand2  g51(.a(x12), .b(x09), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n48_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n74_), .c(new_n73_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n25_), .O(z5));
  nand2  g55(.a(x09), .b(new_n27_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n28_), .c(x00), .O(new_n81_));
  nand2  g57(.a(new_n73_), .b(x02), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n80_), .c(x08), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(new_n33_), .O(new_n84_));
  aoi21  g60(.a(new_n57_), .b(x03), .c(x01), .O(new_n85_));
  nand3  g61(.a(new_n57_), .b(new_n56_), .c(x03), .O(new_n86_));
  oai21  g62(.a(new_n85_), .b(x00), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n28_), .O(new_n88_));
  nor2   g64(.a(x08), .b(new_n38_), .O(new_n89_));
  nor2   g65(.a(x14), .b(x00), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n88_), .c(new_n84_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n48_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n73_), .c(x10), .O(z6));
  nand3  g70(.a(x09), .b(x03), .c(new_n28_), .O(new_n95_));
  nand4  g71(.a(new_n25_), .b(new_n56_), .c(new_n48_), .d(x02), .O(new_n96_));
  ...
  oai21  g75(.a(new_n99_), .b(new_n97_), .c(new_n73_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n25_), .O(z7));
  inv1   g77(.a(x12), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n103_));
  nand2  g79(.a(new_n75_), .b(new_n48_), .O(new_n104_));
  aoi21  g80(.a(new_n103_), .b(x09), .c(new_n104_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(x13), .c(new_n25_), .O(z8));
endmodule
