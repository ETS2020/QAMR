...
module FAU ( 
  ...
  oai21  g37(.a(new_n49_), .b(new_n61_), .c(x00), .O(new_n62_));
  oai21  g38(.a(x12), .b(x00), .c(new_n56_), .O(new_n63_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n56_), .c(new_n36_), .O(new_n74_));
  oai21  g50(.a(x11), .b(new_n36_), .c(new_n74_), .O(z4));
  nor2   g51(.a(x12), .b(x00), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x07), .c(x13), .O(new_n77_));
  ...
  oai21  g59(.a(new_n69_), .b(x03), .c(new_n27_), .O(new_n84_));
  ...
  nand3  g65(.a(new_n89_), .b(new_n56_), .c(new_n36_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n27_), .O(new_n92_));
  nand4  g68(.a(new_n56_), .b(new_n68_), .c(new_n36_), .d(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n29_), .O(new_n95_));
  oai21  g71(.a(new_n26_), .b(x01), .c(new_n68_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n56_), .d(new_n36_), .O(z7));
  nand3  g73(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n36_), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(new_n65_), .c(new_n69_), .O(new_n100_));
  aoi21  g76(.a(new_n69_), .b(new_n25_), .c(new_n100_), .O(new_n101_));
  oai21  g77(.a(new_n101_), .b(x10), .c(new_n36_), .O(z8));
endmodule
