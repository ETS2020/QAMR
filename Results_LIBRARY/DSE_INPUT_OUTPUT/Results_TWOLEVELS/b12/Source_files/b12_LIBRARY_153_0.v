...
module FAU ( 
  ...
  nand3  g25(.a(x11), .b(new_n25_), .c(x09), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n49_), .c(x08), .O(new_n51_));
  nand4  g27(.a(x11), .b(new_n25_), .c(x09), .d(new_n39_), .O(new_n52_));
  ...
  oai21  g38(.a(new_n26_), .b(new_n48_), .c(x00), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n25_), .c(new_n26_), .O(new_n65_));
  nand2  g41(.a(new_n64_), .b(new_n48_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(z3));
  oai21  g43(.a(new_n25_), .b(x07), .c(new_n26_), .O(new_n68_));
  nand3  g44(.a(x09), .b(x08), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n48_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n68_), .O(z4));
  nand4  g47(.a(x13), .b(new_n64_), .c(new_n48_), .d(new_n39_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x11), .O(new_n73_));
  ...
  aoi21  g53(.a(new_n77_), .b(new_n29_), .c(new_n39_), .O(new_n78_));
  nand3  g54(.a(x09), .b(new_n28_), .c(new_n34_), .O(new_n79_));
  ...
  oai21  g59(.a(new_n76_), .b(x03), .c(new_n29_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n34_), .O(new_n85_));
  nand3  g61(.a(new_n76_), .b(x03), .c(new_n29_), .O(new_n86_));
  ...
  nand4  g65(.a(new_n89_), .b(x11), .c(new_n25_), .d(new_n48_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n34_), .O(new_n92_));
  nand2  g68(.a(new_n48_), .b(x01), .O(new_n93_));
  nand3  g69(.a(x11), .b(new_n25_), .c(new_n75_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n29_), .O(new_n96_));
  nand3  g72(.a(x11), .b(new_n48_), .c(x02), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(x03), .c(x08), .O(new_n98_));
  nor4   g74(.a(new_n98_), .b(new_n26_), .c(x10), .d(x07), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n96_), .O(z7));
  nand4  g76(.a(new_n64_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g78(.a(new_n76_), .b(new_n39_), .c(x10), .O(new_n103_));
  nand4  g79(.a(new_n103_), .b(new_n102_), .c(new_n55_), .d(new_n27_), .O(z8));
endmodule
