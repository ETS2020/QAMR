...
module FAU ( 
  ...
  oai21  g31(.a(new_n38_), .b(x03), .c(new_n55_), .O(new_n56_));
  aoi21  g32(.a(new_n51_), .b(x02), .c(new_n56_), .O(new_n57_));
  inv1   g33(.a(x08), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n52_), .c(new_n26_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n29_), .c(new_n38_), .O(new_n60_));
  nand3  g36(.a(new_n38_), .b(x09), .c(new_n29_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n27_), .c(x08), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n52_), .c(new_n60_), .O(new_n63_));
  oai21  g39(.a(new_n57_), .b(x00), .c(new_n63_), .O(z2));
  inv1   g40(.a(x12), .O(new_n65_));
  nand2  g41(.a(x11), .b(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x00), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n36_), .O(z3));
  aoi21  g44(.a(x09), .b(x00), .c(x07), .O(new_n69_));
  nor2   g45(.a(x11), .b(new_n52_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(new_n71_));
  oai21  g47(.a(x10), .b(new_n25_), .c(x01), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n58_), .c(new_n52_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(z4));
  inv1   g50(.a(x13), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(x12), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n38_), .c(new_n52_), .d(new_n25_), .O(z5));
  nor2   g53(.a(x01), .b(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n25_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(x02), .O(new_n80_));
  inv1   g56(.a(x09), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x03), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n29_), .c(new_n25_), .O(new_n83_));
  nand3  g59(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n83_), .c(new_n58_), .O(new_n86_));
  oai21  g62(.a(new_n82_), .b(x02), .c(new_n84_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n25_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n80_), .O(new_n89_));
  nand2  g65(.a(x14), .b(x02), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x01), .c(new_n25_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(new_n92_));
  aoi21  g68(.a(new_n89_), .b(new_n38_), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x07), .c(new_n36_), .O(z6));
  oai21  g70(.a(x10), .b(new_n58_), .c(x01), .O(new_n95_));
  nand2  g71(.a(x09), .b(x03), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x02), .c(new_n38_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n29_), .O(new_n98_));
  oai22  g74(.a(x10), .b(x03), .c(x07), .d(new_n27_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n58_), .O(new_n100_));
  nand2  g76(.a(new_n38_), .b(x07), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(new_n95_), .O(z7));
  nand4  g78(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n103_));
  oai21  g79(.a(x09), .b(x00), .c(new_n52_), .O(new_n104_));
  aoi21  g80(.a(new_n103_), .b(x09), .c(new_n104_), .O(new_n105_));
  nand2  g81(.a(x10), .b(new_n29_), .O(new_n106_));
  oai21  g82(.a(new_n105_), .b(x10), .c(new_n106_), .O(z8));
endmodule
