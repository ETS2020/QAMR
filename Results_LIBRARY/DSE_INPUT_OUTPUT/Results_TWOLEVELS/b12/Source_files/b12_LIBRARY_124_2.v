...
module FAU ( 
  ...
  nand4  g51(.a(x13), .b(new_n75_), .c(new_n51_), .d(new_n50_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  oai21  g53(.a(new_n69_), .b(new_n40_), .c(new_n77_), .O(z5));
  ...
  nand3  g63(.a(new_n87_), .b(new_n51_), .c(new_n50_), .O(new_n88_));
  ...
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand3  g70(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n50_), .c(x12), .O(new_n96_));
  aoi21  g72(.a(new_n61_), .b(new_n40_), .c(x07), .O(new_n97_));
  oai21  g73(.a(new_n96_), .b(new_n61_), .c(new_n97_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n51_), .O(new_n99_));
  oai21  g75(.a(new_n25_), .b(new_n51_), .c(new_n99_), .O(z8));
endmodule
