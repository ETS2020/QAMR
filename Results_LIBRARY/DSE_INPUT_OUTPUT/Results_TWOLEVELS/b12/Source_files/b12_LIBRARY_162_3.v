...
module FAU ( 
  ...
  nand2  g48(.a(x12), .b(new_n48_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n32_), .O(new_n74_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n32_), .O(z4));
  inv1   g56(.a(new_n57_), .O(new_n81_));
  inv1   g57(.a(x12), .O(new_n82_));
  nand4  g58(.a(x13), .b(new_n82_), .c(new_n58_), .d(new_n48_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n29_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n81_), .O(z5));
  oai21  g61(.a(x09), .b(new_n52_), .c(new_n51_), .O(new_n86_));
  nor2   g62(.a(x02), .b(x00), .O(new_n87_));
  nor2   g63(.a(x08), .b(new_n48_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  oai21  g65(.a(new_n61_), .b(x03), .c(new_n25_), .O(new_n90_));
  nand2  g66(.a(x08), .b(x00), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n51_), .O(new_n92_));
  inv1   g68(.a(x14), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x01), .c(new_n48_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n89_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n29_), .c(new_n58_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n32_), .O(z6));
  nand3  g73(.a(x09), .b(x03), .c(new_n25_), .O(new_n98_));
  nand4  g74(.a(new_n29_), .b(new_n66_), .c(new_n58_), .d(x02), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n51_), .O(new_n101_));
  oai21  g77(.a(new_n52_), .b(x01), .c(new_n66_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n29_), .d(new_n58_), .O(z7));
  nand4  g79(.a(new_n82_), .b(x03), .c(new_n25_), .d(new_n51_), .O(new_n104_));
  oai21  g80(.a(x09), .b(x00), .c(new_n58_), .O(new_n105_));
  aoi21  g81(.a(new_n104_), .b(x09), .c(new_n105_), .O(new_n106_));
  oai21  g82(.a(new_n106_), .b(x10), .c(new_n81_), .O(z8));
endmodule
