...
module FAU ( 
  ...
  nand3  g65(.a(new_n58_), .b(new_n36_), .c(x02), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n27_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x07), .c(new_n37_), .O(new_n93_));
  aoi21  g69(.a(x03), .b(new_n29_), .c(x08), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n36_), .O(new_n95_));
  ...
  oai21  g74(.a(x09), .b(x00), .c(new_n37_), .O(new_n99_));
