...
module FAU ( 
  ...
  nand2  g30(.a(x09), .b(new_n30_), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n28_), .c(x07), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(x10), .c(new_n25_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n54_), .O(z2));
  nand2  g34(.a(x11), .b(x07), .O(new_n59_));
  nand2  g35(.a(x12), .b(new_n38_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n59_), .c(new_n26_), .O(new_n61_));
  inv1   g37(.a(new_n61_), .O(z3));
  nand3  g38(.a(new_n48_), .b(x01), .c(x00), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n55_), .c(x08), .O(new_n64_));
  nand2  g40(.a(x09), .b(x00), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(new_n66_));
  ...
  nand4  g46(.a(x13), .b(new_n70_), .c(new_n47_), .d(new_n38_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n48_), .O(new_n72_));
  nand2  g48(.a(x10), .b(x08), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z5));
  oai21  g50(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n75_));
  ...
  oai21  g55(.a(new_n79_), .b(x03), .c(new_n28_), .O(new_n80_));
  nand2  g56(.a(x08), .b(x00), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n30_), .O(new_n82_));
  ...
  nand4  g64(.a(new_n48_), .b(new_n25_), .c(new_n47_), .d(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n30_), .O(new_n91_));
  oai21  g67(.a(x10), .b(new_n30_), .c(x03), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n25_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n91_), .c(new_n48_), .d(new_n47_), .O(z7));
  nand4  g70(.a(new_n70_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n47_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x10), .c(new_n73_), .O(z8));
endmodule
