...
module FAU ( 
  ...
  aoi22  g34(.a(new_n58_), .b(x07), .c(x12), .d(new_n25_), .O(z3));
  oai21  g35(.a(new_n57_), .b(x10), .c(x07), .O(new_n60_));
  ...
  nand4  g42(.a(new_n66_), .b(x13), .c(new_n65_), .d(new_n61_), .O(z5));
  ...
  nand3  g55(.a(new_n79_), .b(new_n49_), .c(new_n61_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(new_n70_), .b(new_n61_), .c(x02), .O(new_n82_));
  nand3  g58(.a(x09), .b(x03), .c(new_n27_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(x01), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(new_n49_), .O(new_n85_));
  aoi21  g61(.a(x03), .b(new_n29_), .c(x08), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n61_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n85_), .O(z7));
  nand4  g64(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand2  g66(.a(new_n74_), .b(new_n25_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n49_), .d(new_n61_), .O(z8));
endmodule
