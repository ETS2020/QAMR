...
module FAU ( 
  ...
  nand2  g16(.a(new_n40_), .b(x10), .O(new_n41_));
  ...
  inv1   g22(.a(x06), .O(new_n47_));
  nand2  g23(.a(x08), .b(x00), .O(new_n48_));
  nand4  g24(.a(new_n48_), .b(new_n25_), .c(x09), .d(new_n47_), .O(new_n49_));
  inv1   g25(.a(x03), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  nand3  g27(.a(x10), .b(new_n51_), .c(new_n50_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n49_), .c(x07), .O(new_n53_));
  inv1   g29(.a(x07), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(x06), .c(new_n25_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n50_), .c(new_n27_), .O(new_n56_));
  inv1   g32(.a(new_n56_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n53_), .c(new_n28_), .O(new_n58_));
  ...
  oai21  g47(.a(x12), .b(x00), .c(new_n54_), .O(new_n72_));
  ...
  nand2  g53(.a(new_n51_), .b(x00), .O(new_n78_));
  ...
  aoi21  g64(.a(new_n88_), .b(new_n47_), .c(x10), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n28_), .O(new_n90_));
  nand4  g66(.a(new_n25_), .b(new_n51_), .c(new_n54_), .d(x01), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n31_), .O(new_n93_));
  nand3  g69(.a(new_n54_), .b(new_n47_), .c(x02), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x03), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n51_), .O(new_n96_));
  nor2   g72(.a(x10), .b(x06), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n93_), .d(new_n54_), .O(z7));
