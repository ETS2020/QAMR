...
module FAU ( 
  ...
  nand2  g47(.a(x12), .b(new_n40_), .O(new_n72_));
  ...
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n29_), .O(z4));
  inv1   g55(.a(x12), .O(new_n80_));
  nand4  g56(.a(x13), .b(new_n80_), .c(new_n54_), .d(new_n40_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n35_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n57_), .O(z5));
  aoi21  g59(.a(x09), .b(new_n41_), .c(x02), .O(new_n84_));
  nand3  g60(.a(new_n64_), .b(x03), .c(new_n28_), .O(new_n85_));
  oai21  g61(.a(new_n84_), .b(x01), .c(new_n85_), .O(new_n86_));
  oai21  g62(.a(new_n63_), .b(new_n40_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g67(.a(new_n91_), .b(new_n35_), .c(new_n54_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n29_), .O(z6));
  aoi21  g69(.a(new_n63_), .b(x02), .c(x07), .O(new_n94_));
  oai21  g70(.a(new_n41_), .b(x01), .c(new_n63_), .O(new_n95_));
  nand4  g71(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n94_), .d(new_n35_), .O(z7));
  nand4  g73(.a(new_n80_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n54_), .O(new_n99_));
  aoi21  g75(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(x10), .c(new_n57_), .O(z8));
endmodule
