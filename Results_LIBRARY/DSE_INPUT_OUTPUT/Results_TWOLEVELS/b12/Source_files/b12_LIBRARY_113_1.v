...
module FAU ( 
  ...
  nand3  g20(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n45_));
  ...
  aoi21  g25(.a(new_n49_), .b(new_n47_), .c(x00), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  nand3  g27(.a(x09), .b(new_n51_), .c(new_n48_), .O(new_n52_));
  inv1   g28(.a(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n50_), .c(new_n46_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(x01), .c(new_n45_), .O(z2));
  ...
  nor2   g36(.a(x11), .b(new_n48_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n36_), .O(new_n62_));
  nand2  g38(.a(x01), .b(x00), .O(new_n63_));
  nand2  g39(.a(x09), .b(new_n29_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n63_), .c(x10), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x03), .c(new_n51_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x07), .c(new_n62_), .O(z4));
  nor2   g43(.a(x13), .b(x10), .O(new_n68_));
  nor3   g44(.a(new_n68_), .b(x07), .c(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n56_), .c(new_n46_), .O(z5));
  oai21  g46(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n71_));
  nand2  g47(.a(new_n27_), .b(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n51_), .b(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n71_), .O(new_n75_));
  nor2   g51(.a(new_n27_), .b(x01), .O(new_n76_));
  nor2   g52(.a(x14), .b(new_n29_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n76_), .c(new_n25_), .O(new_n78_));
  nand3  g54(.a(new_n51_), .b(x02), .c(new_n29_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n75_), .O(new_n80_));
  nand2  g56(.a(new_n29_), .b(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x09), .c(new_n26_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(new_n84_));
  aoi21  g60(.a(new_n80_), .b(new_n46_), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n36_), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n27_), .O(new_n87_));
  nand4  g63(.a(new_n46_), .b(new_n51_), .c(new_n48_), .d(x02), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n29_), .O(new_n90_));
  nand2  g66(.a(x03), .b(new_n29_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n46_), .c(new_n51_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n90_), .c(new_n46_), .d(new_n48_), .O(z7));
  nand4  g69(.a(new_n56_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  inv1   g71(.a(x09), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n25_), .c(x10), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n95_), .c(new_n48_), .O(z8));
endmodule
