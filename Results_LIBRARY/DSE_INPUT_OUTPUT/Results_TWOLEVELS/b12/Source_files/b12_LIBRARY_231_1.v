...
module FAU ( 
  ...
  nand2  g51(.a(new_n59_), .b(x09), .O(new_n76_));
  aoi21  g52(.a(new_n75_), .b(x01), .c(new_n76_), .O(new_n77_));
  ...
  aoi21  g58(.a(new_n59_), .b(x00), .c(new_n82_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n81_), .c(new_n59_), .d(new_n25_), .O(z5));
  oai21  g60(.a(x09), .b(new_n38_), .c(new_n27_), .O(new_n85_));
  nor2   g61(.a(x02), .b(x00), .O(new_n86_));
  nor2   g62(.a(x08), .b(new_n50_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  nand2  g64(.a(x09), .b(new_n38_), .O(new_n89_));
  aoi22  g65(.a(new_n89_), .b(new_n37_), .c(x08), .d(x00), .O(new_n90_));
  inv1   g66(.a(x14), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x01), .c(new_n50_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n59_), .O(new_n93_));
  aoi21  g69(.a(new_n90_), .b(new_n27_), .c(new_n93_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n88_), .c(x07), .O(z6));
  nor2   g71(.a(x02), .b(x01), .O(new_n96_));
  inv1   g72(.a(new_n96_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n75_), .c(x10), .O(new_n98_));
  inv1   g74(.a(x09), .O(new_n99_));
  nor2   g75(.a(new_n99_), .b(new_n38_), .O(new_n100_));
  aoi22  g76(.a(new_n100_), .b(new_n96_), .c(new_n75_), .d(new_n38_), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n98_), .c(new_n25_), .O(z7));
  nand3  g78(.a(new_n96_), .b(new_n81_), .c(x03), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  nand2  g80(.a(new_n99_), .b(new_n50_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n59_), .d(new_n25_), .O(z8));
endmodule
