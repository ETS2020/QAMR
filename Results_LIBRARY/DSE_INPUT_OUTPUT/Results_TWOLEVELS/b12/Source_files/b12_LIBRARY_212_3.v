...
module FAU ( 
  ...
  nand4  g48(.a(new_n72_), .b(new_n47_), .c(new_n46_), .d(new_n37_), .O(z5));
  ...
  aoi21  g62(.a(new_n86_), .b(x02), .c(x07), .O(new_n87_));
  oai21  g63(.a(new_n26_), .b(x01), .c(new_n86_), .O(new_n88_));
  nand4  g64(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n47_), .O(z7));
  nand3  g66(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n46_), .c(x12), .O(new_n92_));
  aoi21  g68(.a(new_n76_), .b(new_n37_), .c(x07), .O(new_n93_));
  oai21  g69(.a(new_n92_), .b(new_n76_), .c(new_n93_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n47_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n55_), .O(z8));
endmodule
