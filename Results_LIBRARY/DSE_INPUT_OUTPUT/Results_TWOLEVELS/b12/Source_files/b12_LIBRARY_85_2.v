...
module FAU ( 
  ...
  aoi21  g49(.a(x12), .b(new_n27_), .c(new_n73_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n25_), .c(new_n59_), .d(new_n27_), .O(z5));
  nor2   g51(.a(new_n57_), .b(new_n27_), .O(new_n76_));
