...
module FAU ( 
  ...
  nor2   g23(.a(x13), .b(x10), .O(new_n48_));
  ...
  oai21  g27(.a(x13), .b(new_n47_), .c(new_n25_), .O(new_n52_));
  ...
  aoi21  g44(.a(x12), .b(new_n38_), .c(x07), .O(new_n69_));
  inv1   g45(.a(x09), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n38_), .O(new_n71_));
  nand2  g47(.a(x12), .b(x09), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n47_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n69_), .c(new_n68_), .O(new_n74_));
  ...
  nand3  g56(.a(new_n70_), .b(x03), .c(new_n28_), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(x01), .c(new_n81_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n79_), .O(new_n83_));
  inv1   g59(.a(x14), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x02), .c(new_n38_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n83_), .c(new_n78_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n47_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n68_), .c(x10), .O(z6));
  inv1   g64(.a(x08), .O(new_n89_));
  nand2  g65(.a(new_n47_), .b(x02), .O(new_n90_));
  ...
  aoi21  g69(.a(new_n91_), .b(new_n89_), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x13), .c(new_n25_), .O(z7));
  inv1   g71(.a(x12), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n97_));
  nand2  g73(.a(new_n71_), .b(new_n47_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x13), .c(new_n25_), .O(z8));
endmodule
