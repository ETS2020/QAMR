...
module FAU ( 
  ...
  oai21  g38(.a(new_n62_), .b(new_n25_), .c(x00), .O(new_n63_));
  oai21  g39(.a(x12), .b(x00), .c(new_n57_), .O(new_n64_));
  ...
  oai21  g45(.a(x09), .b(x01), .c(new_n69_), .O(new_n70_));
  ...
  and2   g50(.a(new_n74_), .b(x13), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n57_), .c(new_n25_), .d(new_n27_), .O(z5));
  ...
  oai21  g57(.a(new_n81_), .b(x03), .c(new_n31_), .O(new_n82_));
  ...
  nand3  g63(.a(new_n87_), .b(new_n57_), .c(new_n25_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  nand3  g65(.a(new_n69_), .b(new_n25_), .c(x02), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n31_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  nand2  g68(.a(new_n25_), .b(x01), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(x03), .c(x08), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n92_), .c(new_n57_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n25_), .O(z7));
  nand4  g72(.a(new_n66_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  nand2  g74(.a(new_n81_), .b(new_n27_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
