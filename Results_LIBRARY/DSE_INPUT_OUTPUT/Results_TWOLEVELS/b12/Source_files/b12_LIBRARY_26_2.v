...
module FAU ( 
  ...
  aoi21  g62(.a(new_n83_), .b(new_n79_), .c(new_n86_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n78_), .c(x10), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n29_), .O(new_n89_));
  nand3  g65(.a(new_n53_), .b(new_n57_), .c(x01), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n27_), .O(new_n92_));
  nand2  g68(.a(new_n61_), .b(x03), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n57_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n92_), .c(new_n53_), .d(new_n36_), .O(z7));
  nand4  g71(.a(new_n66_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  aoi21  g73(.a(new_n96_), .b(x09), .c(new_n97_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x07), .c(new_n53_), .O(z8));
endmodule
