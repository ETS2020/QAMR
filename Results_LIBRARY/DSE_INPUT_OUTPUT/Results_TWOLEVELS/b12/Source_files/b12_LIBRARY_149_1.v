...
module FAU ( 
  ...
  nand2  g53(.a(new_n36_), .b(x02), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(x08), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n29_), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n75_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n52_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n36_), .c(x10), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n27_), .O(new_n86_));
  inv1   g62(.a(x08), .O(new_n87_));
  nand4  g63(.a(new_n58_), .b(new_n87_), .c(new_n52_), .d(x02), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n86_), .c(x01), .O(new_n89_));
  oai21  g65(.a(new_n26_), .b(x01), .c(new_n87_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n52_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n89_), .c(new_n36_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n58_), .O(z7));
  ...
  nand2  g72(.a(new_n36_), .b(x07), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(z5), .O(z8));
endmodule
