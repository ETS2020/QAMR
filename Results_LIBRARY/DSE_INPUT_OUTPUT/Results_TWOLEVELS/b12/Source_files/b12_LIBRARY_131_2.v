...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n102_;
  nand2  g00(.a(x07), .b(x05), .O(new_n25_));
  ...
  nor2   g05(.a(x07), .b(new_n29_), .O(new_n30_));
  ...
  aoi22  g47(.a(new_n71_), .b(new_n57_), .c(x12), .d(new_n69_), .O(z3));
  nand4  g48(.a(x09), .b(x08), .c(new_n29_), .d(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n34_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n71_), .O(z4));
  nand2  g51(.a(x13), .b(new_n53_), .O(new_n76_));
  aoi21  g52(.a(new_n34_), .b(x00), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(x12), .b(new_n69_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n34_), .d(new_n29_), .O(z5));
  oai21  g55(.a(x09), .b(new_n28_), .c(new_n38_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n69_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  oai21  g59(.a(new_n62_), .b(x03), .c(new_n40_), .O(new_n84_));
  nand2  g60(.a(x08), .b(x00), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n38_), .O(new_n86_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n53_), .c(new_n34_), .d(new_n29_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n40_), .O(new_n92_));
  nand4  g68(.a(new_n53_), .b(new_n61_), .c(new_n34_), .d(x02), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(x01), .O(new_n94_));
  oai21  g70(.a(new_n28_), .b(x01), .c(new_n61_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n53_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n94_), .c(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n34_), .O(z7));
  inv1   g74(.a(x12), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(x03), .c(new_n40_), .d(new_n38_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  aoi22  g77(.a(x10), .b(new_n29_), .c(new_n62_), .d(new_n69_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n34_), .d(new_n29_), .O(z8));
endmodule
