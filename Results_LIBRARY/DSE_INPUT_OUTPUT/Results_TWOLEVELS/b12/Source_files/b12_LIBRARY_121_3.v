...
module FAU ( 
  ...
  oai21  g34(.a(x10), .b(x07), .c(new_n54_), .O(new_n59_));
  ...
  aoi21  g39(.a(new_n63_), .b(new_n59_), .c(x01), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n58_), .c(new_n51_), .O(new_n65_));
  inv1   g41(.a(new_n32_), .O(new_n66_));
  nor2   g42(.a(new_n29_), .b(x03), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n62_), .c(new_n46_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n25_), .c(x08), .O(new_n69_));
  aoi21  g45(.a(new_n69_), .b(new_n60_), .c(new_n66_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n65_), .O(z2));
  inv1   g47(.a(x11), .O(new_n72_));
  aoi21  g48(.a(x12), .b(new_n51_), .c(new_n66_), .O(new_n73_));
  oai21  g49(.a(new_n72_), .b(new_n60_), .c(new_n73_), .O(new_n74_));
  inv1   g50(.a(new_n74_), .O(z3));
  nand3  g51(.a(x09), .b(x08), .c(x00), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n60_), .O(new_n77_));
  nand2  g53(.a(new_n72_), .b(x07), .O(new_n78_));
  ...
  oai21  g58(.a(x09), .b(new_n54_), .c(new_n46_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n51_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  oai21  g62(.a(new_n61_), .b(x03), .c(new_n25_), .O(new_n87_));
  nand2  g63(.a(x08), .b(x00), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(new_n89_));
  inv1   g65(.a(x14), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x01), .c(new_n51_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n89_), .c(new_n86_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n29_), .c(new_n60_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  inv1   g70(.a(x08), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n60_), .c(x02), .O(new_n96_));
  nand3  g72(.a(x09), .b(x03), .c(new_n25_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(x01), .O(new_n98_));
  oai21  g74(.a(new_n54_), .b(x01), .c(new_n95_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n60_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n98_), .c(new_n29_), .O(new_n101_));
  nand2  g77(.a(x10), .b(new_n27_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n101_), .O(z7));
  nand4  g79(.a(new_n80_), .b(x03), .c(new_n25_), .d(new_n46_), .O(new_n104_));
  oai21  g80(.a(x09), .b(x00), .c(new_n60_), .O(new_n105_));
  aoi21  g81(.a(new_n104_), .b(x09), .c(new_n105_), .O(new_n106_));
  oai21  g82(.a(new_n106_), .b(x10), .c(new_n102_), .O(z8));
endmodule
