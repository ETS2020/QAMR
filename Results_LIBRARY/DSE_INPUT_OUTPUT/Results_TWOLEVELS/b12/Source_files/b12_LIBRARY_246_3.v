...
module FAU ( 
  ...
  or2    g42(.a(x13), .b(x11), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(x07), .c(x12), .d(new_n39_), .O(z3));
  nand3  g44(.a(x09), .b(x08), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n49_), .O(new_n70_));
  oai21  g46(.a(new_n67_), .b(new_n49_), .c(new_n70_), .O(z4));
  nor3   g47(.a(x12), .b(x10), .c(x00), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(x13), .c(new_n49_), .O(z5));
  ...
  oai21  g53(.a(new_n60_), .b(x03), .c(new_n27_), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n32_), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n39_), .O(new_n82_));
  ...
  nand3  g62(.a(new_n50_), .b(new_n59_), .c(x02), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(x01), .O(new_n88_));
  oai21  g64(.a(new_n26_), .b(x01), .c(new_n59_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n49_), .O(new_n91_));
  oai21  g67(.a(x13), .b(new_n49_), .c(new_n91_), .O(z7));
  inv1   g68(.a(x12), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  nand2  g71(.a(new_n60_), .b(new_n39_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n50_), .d(new_n49_), .O(z8));
endmodule
