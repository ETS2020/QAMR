...
module FAU ( 
  ...
  oai21  g24(.a(x04), .b(new_n26_), .c(x10), .O(new_n49_));
  ...
  nand2  g41(.a(new_n65_), .b(x10), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(x07), .c(x12), .d(new_n25_), .O(z3));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n36_), .O(new_n69_));
  oai21  g45(.a(new_n66_), .b(new_n36_), .c(new_n69_), .O(z4));
  inv1   g46(.a(x12), .O(new_n71_));
  nand3  g47(.a(x13), .b(new_n71_), .c(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n53_), .O(z5));
  ...
  nand2  g58(.a(new_n82_), .b(new_n36_), .O(new_n83_));
  aoi21  g59(.a(new_n80_), .b(new_n29_), .c(new_n83_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n78_), .c(x10), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n27_), .O(new_n86_));
  nand3  g62(.a(new_n53_), .b(new_n57_), .c(x02), .O(new_n87_));
  ...
  nand2  g66(.a(new_n53_), .b(new_n36_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(new_n57_), .c(new_n91_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n89_), .O(z7));
  nand4  g69(.a(new_n71_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  nor2   g71(.a(x09), .b(x00), .O(new_n96_));
  nor2   g72(.a(new_n96_), .b(new_n91_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n95_), .O(z8));
endmodule
