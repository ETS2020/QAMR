...
module FAU ( 
  ...
  oai22  g39(.a(new_n48_), .b(new_n62_), .c(new_n63_), .d(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n26_), .O(z3));
  nand2  g41(.a(x01), .b(x00), .O(new_n66_));
  nand2  g42(.a(x09), .b(new_n28_), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n66_), .c(x08), .O(new_n68_));
  nand2  g44(.a(x09), .b(x00), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n57_), .O(new_n70_));
  nand2  g46(.a(new_n62_), .b(x07), .O(new_n71_));
  oai21  g47(.a(new_n70_), .b(x07), .c(new_n71_), .O(z4));
  nand3  g48(.a(x13), .b(new_n63_), .c(new_n27_), .O(new_n73_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n78_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n57_), .c(new_n25_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  inv1   g65(.a(x08), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n25_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n31_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  aoi21  g69(.a(x03), .b(new_n28_), .c(x08), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n93_), .c(new_n57_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n25_), .O(z7));
  nand4  g72(.a(new_n63_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n97_));
