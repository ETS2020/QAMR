...
module FAU ( 
  ...
  nand2  g29(.a(x10), .b(new_n36_), .O(new_n54_));
  inv1   g30(.a(x11), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x07), .O(new_n56_));
  aoi22  g32(.a(new_n56_), .b(new_n54_), .c(x12), .d(new_n25_), .O(z3));
  nand4  g33(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n36_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n56_), .O(z4));
  nand2  g36(.a(new_n37_), .b(new_n36_), .O(z5));
  inv1   g37(.a(new_n38_), .O(z6));
  one    g38(.O(z7));
  one    g39(.O(z8));
endmodule
