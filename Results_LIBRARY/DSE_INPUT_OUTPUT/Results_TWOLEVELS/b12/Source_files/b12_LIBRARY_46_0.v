...
module FAU ( 
  ...
  oai21  g47(.a(x12), .b(x00), .c(new_n49_), .O(new_n72_));
  inv1   g48(.a(x13), .O(new_n73_));
  nor2   g49(.a(new_n73_), .b(x10), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n72_), .c(new_n56_), .d(new_n38_), .O(z5));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(x03), .c(x01), .O(new_n78_));
  nand3  g54(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n79_));
  oai21  g55(.a(new_n78_), .b(x02), .c(new_n79_), .O(new_n80_));
  ...
  nand4  g61(.a(new_n85_), .b(x14), .c(new_n36_), .d(new_n49_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n29_), .O(new_n88_));
  nand2  g64(.a(new_n49_), .b(x01), .O(new_n89_));
  inv1   g65(.a(x08), .O(new_n90_));
  nand3  g66(.a(x14), .b(new_n36_), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n27_), .O(new_n93_));
  nand3  g69(.a(x14), .b(new_n49_), .c(x02), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(x03), .c(x08), .O(new_n95_));
  nor4   g71(.a(new_n95_), .b(new_n37_), .c(x10), .d(x07), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n93_), .O(z7));
  oai21  g73(.a(new_n26_), .b(x01), .c(new_n49_), .O(new_n98_));
  nor2   g74(.a(x12), .b(x02), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(new_n98_), .c(new_n77_), .O(new_n100_));
  oai21  g76(.a(x09), .b(x00), .c(new_n49_), .O(new_n101_));
  oai21  g77(.a(new_n101_), .b(new_n100_), .c(x14), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n36_), .O(z8));
endmodule
