...
module FAU ( 
  ...
  nand2  g36(.a(new_n56_), .b(new_n25_), .O(new_n61_));
  inv1   g37(.a(x11), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(x07), .O(new_n63_));
  aoi22  g39(.a(new_n63_), .b(new_n61_), .c(x12), .d(new_n27_), .O(z3));
  oai21  g40(.a(x12), .b(new_n56_), .c(new_n27_), .O(new_n65_));
  inv1   g41(.a(x08), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  nor2   g43(.a(new_n67_), .b(x01), .O(new_n68_));
  nor2   g44(.a(x10), .b(new_n28_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n66_), .O(new_n70_));
  nor2   g46(.a(x10), .b(new_n67_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n63_), .O(z4));
  inv1   g50(.a(x13), .O(new_n75_));
  aoi21  g51(.a(new_n25_), .b(x00), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(x12), .b(new_n27_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n76_), .c(new_n56_), .d(new_n25_), .O(z5));
  ...
  nand2  g58(.a(x09), .b(new_n38_), .O(new_n83_));
  aoi22  g59(.a(new_n83_), .b(new_n31_), .c(x08), .d(x00), .O(new_n84_));
  inv1   g60(.a(x14), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x01), .c(new_n27_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n56_), .O(new_n87_));
  aoi21  g63(.a(new_n84_), .b(new_n28_), .c(new_n87_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n82_), .c(x07), .O(z6));
  nor2   g65(.a(x02), .b(x01), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(x03), .O(new_n91_));
  nor2   g67(.a(new_n67_), .b(new_n38_), .O(new_n92_));
  aoi22  g68(.a(new_n92_), .b(new_n90_), .c(new_n91_), .d(new_n66_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n25_), .O(z7));
  inv1   g70(.a(x12), .O(new_n95_));
  nand3  g71(.a(new_n90_), .b(new_n95_), .c(x03), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  nand2  g73(.a(new_n67_), .b(new_n27_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
