...
module FAU ( 
  ...
  oai22  g21(.a(new_n45_), .b(x00), .c(x08), .d(x07), .O(new_n46_));
  inv1   g22(.a(x07), .O(new_n47_));
  inv1   g23(.a(x09), .O(new_n48_));
  nand3  g24(.a(new_n25_), .b(new_n48_), .c(new_n47_), .O(new_n49_));
  nor3   g25(.a(new_n49_), .b(x01), .c(x00), .O(new_n50_));
  aoi21  g26(.a(new_n46_), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  aoi21  g27(.a(new_n48_), .b(x07), .c(x10), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  nand3  g29(.a(x10), .b(new_n53_), .c(new_n47_), .O(new_n54_));
  oai21  g30(.a(new_n52_), .b(x00), .c(new_n54_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n27_), .c(new_n30_), .O(new_n56_));
  oai21  g32(.a(new_n51_), .b(new_n28_), .c(new_n56_), .O(z2));
  inv1   g33(.a(x11), .O(new_n58_));
  inv1   g34(.a(x12), .O(new_n59_));
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n58_), .d(new_n47_), .O(new_n60_));
  ...
  nand4  g41(.a(x13), .b(new_n59_), .c(new_n47_), .d(new_n38_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n48_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n25_), .O(z5));
  aoi21  g44(.a(new_n27_), .b(new_n30_), .c(new_n38_), .O(new_n69_));
  nor2   g45(.a(new_n28_), .b(x01), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(new_n71_));
  aoi21  g47(.a(new_n27_), .b(new_n28_), .c(x01), .O(new_n72_));
  inv1   g48(.a(x14), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x02), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n29_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n72_), .c(new_n38_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n71_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n25_), .c(new_n48_), .d(new_n47_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  nand3  g55(.a(new_n70_), .b(new_n25_), .c(new_n47_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x03), .c(new_n30_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n53_), .c(x07), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x09), .c(new_n25_), .O(z7));
  oai21  g59(.a(x07), .b(new_n38_), .c(new_n48_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(z8));
endmodule
