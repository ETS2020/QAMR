...
module FAU ( 
  ...
  oai21  g42(.a(x13), .b(new_n48_), .c(new_n38_), .O(new_n67_));
  nand2  g43(.a(new_n26_), .b(new_n52_), .O(new_n68_));
  nand2  g44(.a(x01), .b(x00), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n30_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n69_), .c(x10), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x13), .c(new_n57_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n47_), .O(new_n74_));
  nand3  g50(.a(new_n26_), .b(new_n63_), .c(x07), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z4));
  nand4  g52(.a(x13), .b(new_n64_), .c(new_n47_), .d(new_n38_), .O(new_n77_));
  ...
  oai21  g60(.a(new_n52_), .b(x03), .c(new_n28_), .O(new_n85_));
  ...
  nand3  g68(.a(new_n57_), .b(new_n47_), .c(x02), .O(new_n93_));
  nand3  g69(.a(x09), .b(x03), .c(new_n28_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(x01), .O(new_n95_));
  oai21  g71(.a(new_n27_), .b(x01), .c(new_n57_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(new_n48_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n79_), .O(z7));
  nand4  g75(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n100_));
  oai21  g76(.a(x09), .b(x00), .c(new_n47_), .O(new_n101_));
  aoi21  g77(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(x10), .c(new_n79_), .O(z8));
endmodule
