...
module FAU ( 
  ...
  aoi21  g43(.a(new_n60_), .b(x07), .c(new_n55_), .O(new_n68_));
  ...
  nand4  g48(.a(new_n72_), .b(new_n70_), .c(new_n51_), .d(new_n25_), .O(z5));
  nand2  g49(.a(new_n64_), .b(x03), .O(new_n74_));
  nand2  g50(.a(new_n70_), .b(x01), .O(new_n75_));
  nand2  g51(.a(new_n27_), .b(new_n25_), .O(new_n76_));
  inv1   g52(.a(x08), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x00), .O(new_n78_));
  aoi22  g54(.a(new_n78_), .b(new_n76_), .c(new_n75_), .d(new_n74_), .O(new_n79_));
  oai21  g55(.a(new_n64_), .b(x03), .c(new_n27_), .O(new_n80_));
  ...
  aoi21  g60(.a(new_n84_), .b(new_n82_), .c(x10), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n79_), .c(new_n51_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n36_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  nand4  g64(.a(new_n70_), .b(new_n77_), .c(new_n51_), .d(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n29_), .O(new_n91_));
  oai21  g67(.a(x10), .b(new_n77_), .c(new_n26_), .O(new_n92_));
  nand2  g68(.a(new_n70_), .b(x07), .O(new_n93_));
  nand3  g69(.a(new_n77_), .b(new_n51_), .c(x01), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n36_), .O(new_n95_));
  inv1   g71(.a(new_n95_), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n92_), .c(new_n91_), .O(z7));
  oai21  g73(.a(x10), .b(x09), .c(new_n26_), .O(new_n98_));
  nor2   g74(.a(x02), .b(x01), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x07), .c(new_n61_), .O(new_n100_));
