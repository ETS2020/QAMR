...
module FAU ( 
  ...
  nand2  g31(.a(x09), .b(new_n51_), .O(new_n56_));
  ...
  oai21  g36(.a(new_n52_), .b(x03), .c(new_n60_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n27_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n31_), .c(x08), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n51_), .c(new_n59_), .O(new_n64_));
  oai21  g40(.a(new_n58_), .b(x00), .c(new_n64_), .O(z2));
  inv1   g41(.a(x11), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n51_), .c(x00), .O(new_n67_));
  ...
  nor2   g48(.a(new_n60_), .b(x01), .O(new_n73_));
  nor2   g49(.a(x10), .b(new_n27_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n72_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x09), .c(x00), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  aoi21  g53(.a(new_n66_), .b(x07), .c(new_n59_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(z4));
  nor2   g55(.a(x12), .b(x00), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x13), .c(new_n52_), .d(new_n51_), .O(z5));
  nor2   g57(.a(new_n72_), .b(new_n26_), .O(new_n82_));
  oai21  g58(.a(new_n60_), .b(x03), .c(new_n31_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n27_), .O(new_n84_));
  nand3  g60(.a(new_n60_), .b(x03), .c(new_n31_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(new_n86_));
  nand2  g62(.a(x14), .b(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n26_), .O(new_n88_));
  nand2  g64(.a(new_n72_), .b(x00), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(new_n27_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n86_), .c(new_n52_), .O(new_n91_));
  nor2   g67(.a(new_n91_), .b(x07), .O(z6));
  nand3  g68(.a(new_n72_), .b(new_n51_), .c(x02), .O(new_n93_));
  nand3  g69(.a(x09), .b(x03), .c(new_n31_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(x01), .O(new_n95_));
  aoi21  g71(.a(new_n51_), .b(x01), .c(new_n39_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x08), .c(new_n51_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(new_n52_), .O(new_n98_));
  oai21  g74(.a(new_n52_), .b(x09), .c(new_n98_), .O(z7));
  oai21  g75(.a(x10), .b(new_n26_), .c(new_n60_), .O(new_n100_));
  nand4  g76(.a(new_n68_), .b(x03), .c(new_n31_), .d(new_n27_), .O(new_n101_));
  aoi21  g77(.a(new_n101_), .b(x09), .c(x07), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(x10), .c(new_n100_), .O(z8));
endmodule
