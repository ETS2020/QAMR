...
module FAU ( 
  ...
  aoi21  g18(.a(new_n39_), .b(x03), .c(new_n42_), .O(new_n43_));
  oai21  g19(.a(new_n43_), .b(x00), .c(new_n26_), .O(z1));
  inv1   g20(.a(x00), .O(new_n45_));
  inv1   g21(.a(x01), .O(new_n46_));
  aoi22  g22(.a(new_n25_), .b(x06), .c(new_n27_), .d(new_n46_), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n28_), .O(new_n48_));
  inv1   g24(.a(x06), .O(new_n49_));
  inv1   g25(.a(x07), .O(new_n50_));
  nand3  g26(.a(new_n25_), .b(new_n50_), .c(new_n49_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n28_), .O(new_n52_));
  nand2  g28(.a(x06), .b(x05), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(x04), .O(new_n54_));
  nand3  g30(.a(x10), .b(x05), .c(x01), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  aoi21  g32(.a(new_n52_), .b(new_n46_), .c(new_n56_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n48_), .c(new_n35_), .O(new_n58_));
  oai21  g34(.a(x10), .b(x07), .c(new_n27_), .O(new_n59_));
  nand3  g35(.a(new_n25_), .b(x09), .c(new_n50_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n59_), .c(x01), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n58_), .c(new_n45_), .O(new_n62_));
  inv1   g38(.a(x08), .O(new_n63_));
  nand3  g39(.a(new_n25_), .b(x09), .c(new_n49_), .O(new_n64_));
  oai21  g40(.a(new_n25_), .b(x03), .c(new_n64_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n46_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n35_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n63_), .c(new_n50_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n62_), .c(new_n26_), .O(z2));
  ...
  nor2   g50(.a(x11), .b(new_n50_), .O(new_n75_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n25_), .c(new_n49_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n63_), .c(new_n50_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n76_), .O(z4));
  nand4  g59(.a(x13), .b(new_n70_), .c(new_n50_), .d(new_n45_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n49_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(z5));
  oai21  g62(.a(x09), .b(new_n27_), .c(new_n46_), .O(new_n87_));
  nor2   g63(.a(x02), .b(x00), .O(new_n88_));
  nor2   g64(.a(x08), .b(new_n45_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(new_n90_));
  oai21  g66(.a(new_n77_), .b(x03), .c(new_n35_), .O(new_n91_));
  nand2  g67(.a(x08), .b(x00), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n91_), .c(new_n46_), .O(new_n93_));
  inv1   g69(.a(x14), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(x01), .c(new_n45_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n93_), .c(new_n90_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n25_), .c(new_n50_), .d(new_n49_), .O(new_n97_));
  inv1   g73(.a(new_n97_), .O(z6));
  nand3  g74(.a(x09), .b(x03), .c(new_n35_), .O(new_n99_));
  nand4  g75(.a(new_n25_), .b(new_n63_), .c(new_n50_), .d(x02), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(new_n99_), .c(x01), .O(new_n101_));
  oai21  g77(.a(new_n27_), .b(x01), .c(new_n63_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n50_), .O(new_n103_));
  oai21  g79(.a(new_n103_), .b(new_n101_), .c(new_n49_), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(new_n25_), .O(z7));
  nand4  g81(.a(new_n70_), .b(x03), .c(new_n35_), .d(new_n46_), .O(new_n106_));
  oai21  g82(.a(x09), .b(x00), .c(new_n50_), .O(new_n107_));
  aoi21  g83(.a(new_n106_), .b(x09), .c(new_n107_), .O(new_n108_));
  oai21  g84(.a(new_n108_), .b(x06), .c(new_n25_), .O(z8));
endmodule
