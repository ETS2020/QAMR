...
module FAU ( 
  ...
  aoi22  g39(.a(new_n63_), .b(new_n61_), .c(x12), .d(new_n40_), .O(z3));
  ...
  nand4  g44(.a(new_n68_), .b(new_n60_), .c(x09), .d(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n63_), .O(z4));
  ...
  nand3  g53(.a(new_n77_), .b(x03), .c(new_n28_), .O(new_n78_));
  oai21  g54(.a(new_n76_), .b(x01), .c(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n65_), .b(new_n40_), .c(new_n79_), .O(new_n80_));
  nand2  g56(.a(x14), .b(x02), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n40_), .O(new_n82_));
  oai21  g58(.a(x08), .b(new_n40_), .c(new_n82_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(x01), .c(x10), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n80_), .c(x07), .O(z6));
  nand3  g61(.a(new_n65_), .b(new_n25_), .c(x02), .O(new_n86_));
  ...
  oai21  g65(.a(new_n27_), .b(x01), .c(new_n65_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n60_), .d(new_n25_), .O(z7));
  aoi21  g67(.a(new_n25_), .b(x02), .c(x12), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(x03), .c(new_n33_), .O(new_n93_));
  nor2   g69(.a(x09), .b(x00), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n25_), .O(z8));
endmodule
