...
module FAU ( 
  ...
  nand2  g49(.a(new_n73_), .b(new_n47_), .O(z3));
  nor2   g50(.a(new_n63_), .b(new_n27_), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(new_n76_));
  oai22  g52(.a(new_n76_), .b(new_n65_), .c(new_n26_), .d(x01), .O(new_n77_));
  nand3  g53(.a(new_n47_), .b(new_n71_), .c(x07), .O(new_n78_));
  oai21  g54(.a(new_n77_), .b(x07), .c(new_n78_), .O(z4));
  nand4  g55(.a(x13), .b(new_n72_), .c(new_n57_), .d(new_n27_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n26_), .O(new_n81_));
  oai21  g57(.a(new_n26_), .b(new_n25_), .c(new_n81_), .O(z5));
  oai21  g58(.a(new_n65_), .b(x03), .c(new_n64_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n25_), .O(new_n84_));
  nand3  g60(.a(new_n65_), .b(x03), .c(new_n64_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(new_n75_), .O(new_n86_));
  nand2  g62(.a(x14), .b(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n27_), .O(new_n88_));
  nand2  g64(.a(new_n63_), .b(x00), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(new_n25_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n86_), .c(new_n26_), .O(new_n91_));
  nor2   g67(.a(new_n91_), .b(x07), .O(z6));
  nor2   g68(.a(x08), .b(x07), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(x01), .O(new_n94_));
  nand2  g70(.a(new_n93_), .b(x02), .O(new_n95_));
  nand3  g71(.a(x09), .b(x03), .c(new_n64_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x01), .O(new_n97_));
  oai21  g73(.a(x08), .b(x03), .c(new_n57_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n97_), .c(new_n26_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n94_), .O(z7));
  oai21  g76(.a(x10), .b(x09), .c(x01), .O(new_n101_));
  nand3  g77(.a(new_n72_), .b(x03), .c(new_n64_), .O(new_n102_));
  oai21  g78(.a(x09), .b(x00), .c(new_n57_), .O(new_n103_));
  aoi21  g79(.a(new_n102_), .b(x09), .c(new_n103_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(x10), .c(new_n101_), .O(z8));
endmodule
