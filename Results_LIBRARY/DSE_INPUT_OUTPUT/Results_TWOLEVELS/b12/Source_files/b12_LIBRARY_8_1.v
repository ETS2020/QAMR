...
module FAU ( 
  ...
  aoi22  g35(.a(new_n59_), .b(new_n57_), .c(x12), .d(new_n27_), .O(z3));
  nand2  g36(.a(x01), .b(x00), .O(new_n61_));
  oai21  g37(.a(new_n53_), .b(x01), .c(new_n61_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n52_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(x09), .c(x00), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n47_), .c(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n59_), .O(z4));
  nor2   g42(.a(x12), .b(x00), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x07), .c(x13), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n47_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(z5));
  nand3  g46(.a(new_n47_), .b(new_n52_), .c(x00), .O(new_n71_));
  oai21  g47(.a(x02), .b(x00), .c(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x01), .O(new_n73_));
  nand2  g49(.a(x08), .b(x00), .O(new_n74_));
  aoi21  g50(.a(x09), .b(new_n38_), .c(x02), .O(new_n75_));
  nand3  g51(.a(new_n53_), .b(x03), .c(new_n31_), .O(new_n76_));
  ...
  aoi21  g56(.a(new_n77_), .b(new_n74_), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n73_), .c(x07), .O(z6));
  aoi21  g58(.a(new_n52_), .b(x02), .c(x10), .O(new_n83_));
  oai21  g59(.a(new_n38_), .b(x01), .c(new_n52_), .O(new_n84_));
  nand4  g60(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n25_), .O(z7));
  oai21  g62(.a(new_n38_), .b(x01), .c(new_n25_), .O(new_n87_));
  nor2   g63(.a(x12), .b(x02), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(new_n53_), .O(new_n89_));
  nor2   g65(.a(x09), .b(x00), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n47_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n25_), .O(z8));
endmodule
