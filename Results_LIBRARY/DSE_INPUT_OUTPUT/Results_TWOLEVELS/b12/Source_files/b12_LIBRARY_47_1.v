...
module FAU ( 
  ...
  nor2   g12(.a(new_n36_), .b(x04), .O(new_n37_));
  ...
  nor2   g40(.a(x12), .b(new_n30_), .O(new_n65_));
  ...
  aoi22  g52(.a(new_n76_), .b(new_n36_), .c(new_n74_), .d(x04), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x07), .c(new_n73_), .O(z4));
  nand4  g54(.a(x13), .b(new_n67_), .c(new_n52_), .d(new_n25_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n36_), .O(new_n80_));
  nand2  g56(.a(x10), .b(x04), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(z5));
  ...
  oai21  g62(.a(new_n53_), .b(x03), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n74_), .c(new_n29_), .O(new_n88_));
  ...
  nand3  g67(.a(new_n91_), .b(new_n36_), .c(new_n52_), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  inv1   g69(.a(x08), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n52_), .c(x02), .O(new_n95_));
  nand3  g71(.a(x09), .b(x03), .c(new_n27_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x01), .O(new_n97_));
  aoi21  g73(.a(new_n52_), .b(x01), .c(new_n26_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x08), .c(new_n52_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n97_), .c(new_n36_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n81_), .O(z7));
  ...
  oai21  g80(.a(new_n104_), .b(x10), .c(new_n81_), .O(z8));
endmodule
