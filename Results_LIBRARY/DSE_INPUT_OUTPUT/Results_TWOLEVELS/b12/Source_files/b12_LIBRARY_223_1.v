...
module FAU ( 
  ...
  nand2  g24(.a(new_n34_), .b(new_n27_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n32_), .O(new_n50_));
  nor2   g26(.a(x10), .b(x07), .O(new_n51_));
  inv1   g27(.a(x03), .O(new_n52_));
  aoi21  g28(.a(new_n28_), .b(new_n52_), .c(new_n25_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n51_), .c(new_n27_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n50_), .c(new_n37_), .O(new_n55_));
  nand2  g31(.a(x07), .b(new_n52_), .O(new_n56_));
  nand2  g32(.a(x09), .b(new_n25_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n56_), .c(x01), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n55_), .c(new_n48_), .O(new_n59_));
  inv1   g35(.a(x10), .O(new_n60_));
  aoi21  g36(.a(x09), .b(new_n27_), .c(x02), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(x08), .c(new_n60_), .O(new_n62_));
  ...
  oai22  g42(.a(new_n66_), .b(x00), .c(new_n65_), .d(new_n25_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n26_), .O(z3));
  nand2  g44(.a(x08), .b(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(x09), .c(new_n27_), .O(new_n70_));
  oai21  g46(.a(new_n34_), .b(new_n37_), .c(new_n27_), .O(new_n71_));
  nor2   g47(.a(x08), .b(new_n27_), .O(new_n72_));
  aoi21  g48(.a(new_n71_), .b(new_n48_), .c(new_n72_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n70_), .c(new_n60_), .d(x09), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g51(.a(new_n65_), .b(x07), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(z4));
  nor2   g53(.a(x10), .b(x00), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(x13), .c(new_n66_), .d(new_n25_), .O(z5));
  oai21  g55(.a(x09), .b(new_n52_), .c(new_n27_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n48_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  inv1   g59(.a(x09), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x03), .c(new_n37_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n69_), .c(new_n27_), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x01), .c(new_n48_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n60_), .c(new_n25_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n37_), .O(new_n92_));
  inv1   g68(.a(x08), .O(new_n93_));
  nand4  g69(.a(new_n60_), .b(new_n93_), .c(new_n25_), .d(x02), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n27_), .O(new_n96_));
  aoi21  g72(.a(new_n93_), .b(x01), .c(x10), .O(new_n97_));
  nand2  g73(.a(new_n93_), .b(new_n52_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n25_), .O(z7));
  nand4  g75(.a(new_n66_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n100_));
  nor2   g76(.a(x09), .b(x00), .O(new_n101_));
  aoi21  g77(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(x10), .c(new_n25_), .O(z8));
endmodule
