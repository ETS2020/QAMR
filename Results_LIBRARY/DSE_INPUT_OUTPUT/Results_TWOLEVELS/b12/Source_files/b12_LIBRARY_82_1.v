...
module FAU ( 
  ...
  aoi21  g35(.a(new_n59_), .b(new_n27_), .c(x07), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x10), .c(new_n58_), .O(new_n61_));
  oai21  g37(.a(new_n57_), .b(x00), .c(new_n61_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n54_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n38_), .O(z3));
  nand2  g42(.a(new_n36_), .b(x01), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n59_), .c(x08), .O(new_n68_));
  nand2  g44(.a(x09), .b(x00), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n54_), .O(new_n70_));
  aoi21  g46(.a(new_n63_), .b(x07), .c(new_n37_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  nand4  g48(.a(x13), .b(new_n64_), .c(new_n54_), .d(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand2  g50(.a(x10), .b(x08), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z5));
  oai21  g52(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n77_));
  nor2   g53(.a(x08), .b(new_n25_), .O(new_n78_));
  nor3   g54(.a(x10), .b(x02), .c(x00), .O(new_n79_));
  ...
  aoi21  g59(.a(new_n82_), .b(new_n25_), .c(new_n83_), .O(new_n84_));
  nand3  g60(.a(x09), .b(new_n58_), .c(new_n26_), .O(new_n85_));
  oai21  g61(.a(new_n84_), .b(x10), .c(new_n85_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n29_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n36_), .c(x02), .d(new_n25_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n80_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n38_), .O(z6));
  nand3  g68(.a(new_n58_), .b(new_n54_), .c(x02), .O(new_n93_));
  nand3  g69(.a(x09), .b(x03), .c(new_n27_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(x01), .O(new_n95_));
  aoi21  g71(.a(new_n54_), .b(x01), .c(new_n26_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x08), .c(new_n54_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(new_n36_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n75_), .O(z7));
  nand2  g75(.a(new_n54_), .b(new_n26_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n64_), .c(new_n27_), .d(new_n29_), .O(new_n101_));
  oai21  g77(.a(x09), .b(x00), .c(new_n54_), .O(new_n102_));
  aoi21  g78(.a(new_n101_), .b(x09), .c(new_n102_), .O(new_n103_));
  oai21  g79(.a(new_n103_), .b(x10), .c(new_n75_), .O(z8));
endmodule
