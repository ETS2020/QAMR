...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(x12), .c(x00), .O(new_n65_));
  ...
  oai21  g47(.a(new_n71_), .b(x10), .c(new_n66_), .O(new_n72_));
  aoi22  g48(.a(new_n72_), .b(new_n47_), .c(new_n70_), .d(new_n27_), .O(new_n73_));
  aoi21  g49(.a(new_n66_), .b(x10), .c(x11), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x07), .O(new_n75_));
  oai21  g51(.a(new_n73_), .b(x07), .c(new_n75_), .O(z4));
  aoi21  g52(.a(x12), .b(new_n46_), .c(x00), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(x13), .c(new_n25_), .d(new_n46_), .O(z5));
  oai21  g54(.a(x09), .b(new_n28_), .c(new_n31_), .O(new_n79_));
  nor2   g55(.a(x02), .b(x00), .O(new_n80_));
  nor2   g56(.a(x08), .b(new_n39_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  oai21  g58(.a(new_n53_), .b(x03), .c(new_n29_), .O(new_n83_));
  ...
  nand3  g64(.a(new_n88_), .b(new_n25_), .c(new_n46_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n27_), .O(z6));
  nand3  g66(.a(new_n47_), .b(new_n46_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n29_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  aoi21  g69(.a(new_n46_), .b(x01), .c(new_n28_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x08), .c(new_n46_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(new_n25_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n54_), .O(z7));
  aoi21  g73(.a(new_n53_), .b(new_n39_), .c(x07), .O(new_n98_));
  nand4  g74(.a(new_n66_), .b(x03), .c(new_n29_), .d(new_n31_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(new_n98_), .c(new_n25_), .O(z8));
endmodule
