...
module FAU ( 
  ...
  and2   g27(.a(new_n51_), .b(new_n40_), .O(new_n52_));
  inv1   g28(.a(x07), .O(new_n53_));
  nand3  g29(.a(x10), .b(new_n53_), .c(new_n27_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n50_), .c(x08), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n33_), .O(new_n56_));
  nand3  g32(.a(new_n35_), .b(new_n26_), .c(x01), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n35_), .c(x00), .O(new_n58_));
  ...
  oai21  g38(.a(new_n62_), .b(new_n53_), .c(x00), .O(new_n63_));
  ...
  nand3  g45(.a(new_n62_), .b(x10), .c(x07), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(z4));
  nor2   g47(.a(x12), .b(x00), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(x13), .c(new_n25_), .d(new_n53_), .O(z5));
  nand2  g49(.a(x09), .b(new_n27_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n28_), .c(x00), .O(new_n75_));
  nand2  g51(.a(new_n53_), .b(x02), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n74_), .c(x08), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n33_), .O(new_n78_));
  inv1   g54(.a(x09), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x03), .c(x01), .O(new_n80_));
  inv1   g56(.a(x08), .O(new_n81_));
  nand3  g57(.a(new_n79_), .b(new_n81_), .c(x03), .O(new_n82_));
  oai21  g58(.a(new_n80_), .b(x00), .c(new_n82_), .O(new_n83_));
  nor2   g59(.a(x14), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n81_), .b(x00), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n33_), .c(new_n53_), .O(new_n86_));
  ...
  nand3  g65(.a(new_n25_), .b(new_n81_), .c(x02), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  aoi21  g67(.a(x03), .b(new_n33_), .c(x08), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n91_), .c(new_n53_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n25_), .O(z7));
  nand4  g70(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n95_));
