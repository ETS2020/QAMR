...
module FAU ( 
  ...
  nand2  g40(.a(new_n62_), .b(new_n64_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n61_), .O(z3));
  inv1   g42(.a(x08), .O(new_n67_));
  oai21  g43(.a(new_n33_), .b(new_n40_), .c(new_n56_), .O(new_n68_));
  inv1   g44(.a(x10), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(x09), .c(x00), .O(new_n70_));
  aoi21  g46(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(new_n71_));
  nand2  g47(.a(new_n64_), .b(x07), .O(new_n72_));
  oai21  g48(.a(new_n71_), .b(x07), .c(new_n72_), .O(z4));
  nand3  g49(.a(x13), .b(new_n62_), .c(new_n40_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n69_), .O(new_n75_));
  ...
  oai21  g56(.a(new_n67_), .b(new_n40_), .c(new_n80_), .O(new_n81_));
  nand2  g57(.a(x14), .b(x02), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n40_), .O(new_n83_));
  oai21  g59(.a(x08), .b(new_n40_), .c(new_n83_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(x01), .c(x10), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n81_), .c(x07), .O(z6));
  nand3  g62(.a(new_n67_), .b(new_n25_), .c(x02), .O(new_n87_));
  ...
  oai21  g66(.a(new_n27_), .b(x01), .c(new_n67_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n69_), .d(new_n25_), .O(z7));
  nand3  g68(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n25_), .c(x12), .O(new_n94_));
  nand2  g70(.a(new_n78_), .b(new_n40_), .O(new_n95_));
  oai21  g71(.a(new_n94_), .b(new_n78_), .c(new_n95_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n69_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n25_), .O(z8));
endmodule
