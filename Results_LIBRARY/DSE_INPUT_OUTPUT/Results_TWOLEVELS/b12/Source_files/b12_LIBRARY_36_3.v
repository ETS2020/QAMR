...
module FAU ( 
  ...
  nor2   g46(.a(x11), .b(new_n47_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n70_), .c(new_n28_), .O(new_n72_));
  nand2  g48(.a(x01), .b(x00), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n32_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(x10), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n26_), .c(new_n48_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x07), .c(new_n72_), .O(z4));
  nor2   g53(.a(x07), .b(x00), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x10), .c(new_n26_), .O(new_n79_));
  nor3   g55(.a(x12), .b(x07), .c(x00), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x10), .c(new_n79_), .O(z5));
  oai21  g57(.a(x09), .b(new_n29_), .c(new_n32_), .O(new_n82_));
  ...
  oai21  g62(.a(new_n86_), .b(x03), .c(new_n30_), .O(new_n87_));
  nand2  g63(.a(x08), .b(x00), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n32_), .O(new_n89_));
  inv1   g65(.a(x14), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x01), .c(new_n40_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n25_), .c(new_n47_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  nand2  g70(.a(new_n47_), .b(x02), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(x03), .c(new_n32_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n48_), .O(new_n97_));
  nand4  g73(.a(x09), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n25_), .d(new_n47_), .O(z7));
  aoi21  g75(.a(new_n86_), .b(new_n40_), .c(x07), .O(new_n100_));
  nand4  g76(.a(new_n66_), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n100_), .c(new_n25_), .O(z8));
endmodule
