...
module FAU ( 
  ...
  nor2   g24(.a(new_n27_), .b(new_n28_), .O(new_n49_));
  inv1   g25(.a(x09), .O(new_n50_));
  nor2   g26(.a(x10), .b(new_n50_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n48_), .c(new_n49_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n47_), .c(x01), .O(new_n53_));
  inv1   g29(.a(x05), .O(new_n54_));
  nand2  g30(.a(new_n54_), .b(x04), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n26_), .c(x01), .O(new_n56_));
  nor3   g32(.a(x14), .b(x10), .c(x07), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(new_n34_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n56_), .c(new_n28_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n53_), .c(new_n38_), .O(new_n60_));
  inv1   g36(.a(new_n26_), .O(new_n61_));
  nor2   g37(.a(new_n25_), .b(x03), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n51_), .c(new_n33_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n28_), .c(x08), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n48_), .c(new_n61_), .O(new_n65_));
  ...
  nand4  g53(.a(x13), .b(new_n77_), .c(new_n48_), .d(new_n38_), .O(new_n78_));
  ...
  nand2  g58(.a(x09), .b(new_n27_), .O(new_n83_));
  nand2  g59(.a(new_n50_), .b(x03), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n81_), .c(new_n76_), .d(new_n25_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x07), .O(z6));
  nor2   g63(.a(new_n82_), .b(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n25_), .c(new_n48_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(x03), .c(x08), .O(new_n90_));
  nand3  g66(.a(new_n82_), .b(x09), .c(x03), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n76_), .c(new_n25_), .d(new_n48_), .O(new_n92_));
  or2    g68(.a(new_n92_), .b(new_n90_), .O(z7));
  nand3  g69(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n76_), .c(x12), .O(new_n95_));
  nand2  g71(.a(new_n50_), .b(new_n38_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n76_), .c(new_n25_), .d(new_n48_), .O(new_n97_));
  inv1   g73(.a(new_n97_), .O(new_n98_));
  oai21  g74(.a(new_n95_), .b(new_n50_), .c(new_n98_), .O(z8));
endmodule
