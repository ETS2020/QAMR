...
module FAU ( 
  ...
  nand2  g28(.a(x09), .b(new_n28_), .O(new_n53_));
  ...
  oai21  g34(.a(x12), .b(x00), .c(new_n47_), .O(new_n59_));
  ...
  nand3  g39(.a(new_n63_), .b(new_n60_), .c(new_n58_), .O(z3));
  oai21  g40(.a(new_n28_), .b(new_n27_), .c(new_n53_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n52_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(x09), .c(x00), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n47_), .c(new_n25_), .O(new_n68_));
  ...
  nand2  g48(.a(new_n72_), .b(new_n47_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n25_), .O(z5));
  nand2  g50(.a(x09), .b(new_n38_), .O(new_n75_));
  nand2  g51(.a(new_n47_), .b(x01), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(new_n27_), .O(new_n77_));
  inv1   g53(.a(x09), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x03), .c(new_n31_), .O(new_n79_));
  oai21  g55(.a(new_n31_), .b(x01), .c(new_n79_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n77_), .c(new_n52_), .O(new_n81_));
  oai21  g57(.a(new_n78_), .b(x03), .c(new_n31_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n28_), .O(new_n83_));
  oai21  g59(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n31_), .O(new_n85_));
  inv1   g61(.a(x14), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x02), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n27_), .c(x10), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n81_), .c(x07), .O(z6));
  nand3  g66(.a(new_n52_), .b(new_n25_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n31_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n28_), .O(new_n94_));
  oai21  g70(.a(new_n38_), .b(x01), .c(new_n52_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n47_), .d(new_n25_), .O(z7));
  nand2  g72(.a(new_n25_), .b(new_n38_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n62_), .c(new_n31_), .d(new_n28_), .O(new_n98_));
