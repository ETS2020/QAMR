...
module FAU ( 
  ...
  nor2   g45(.a(new_n63_), .b(x01), .O(new_n70_));
  aoi21  g46(.a(new_n49_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand3  g47(.a(x09), .b(new_n62_), .c(new_n27_), .O(new_n72_));
  oai21  g48(.a(new_n71_), .b(x00), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n37_), .b(new_n48_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x08), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x01), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n51_), .c(x09), .O(new_n77_));
  aoi21  g53(.a(new_n73_), .b(new_n51_), .c(new_n77_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x07), .c(new_n68_), .O(z4));
  inv1   g55(.a(x12), .O(new_n80_));
  inv1   g56(.a(x13), .O(new_n81_));
  aoi21  g57(.a(new_n51_), .b(x00), .c(new_n81_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n80_), .c(new_n51_), .d(new_n25_), .O(z5));
  nand2  g59(.a(x09), .b(new_n57_), .O(new_n84_));
  nand2  g60(.a(new_n51_), .b(x02), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(x00), .O(new_n86_));
  nor2   g62(.a(x08), .b(new_n37_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n86_), .c(new_n27_), .O(new_n88_));
  oai21  g64(.a(x09), .b(new_n57_), .c(new_n27_), .O(new_n89_));
  oai21  g65(.a(x08), .b(new_n48_), .c(new_n74_), .O(new_n90_));
  nand4  g66(.a(x09), .b(new_n62_), .c(new_n57_), .d(x00), .O(new_n91_));
  inv1   g67(.a(x14), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(x01), .c(new_n48_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n91_), .c(new_n51_), .O(new_n94_));
  aoi21  g70(.a(new_n90_), .b(new_n89_), .c(new_n94_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n88_), .c(x07), .O(z6));
  nand2  g72(.a(new_n85_), .b(new_n27_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n62_), .c(x10), .O(new_n98_));
  nor2   g74(.a(x02), .b(x01), .O(new_n99_));
  nor2   g75(.a(new_n63_), .b(new_n57_), .O(new_n100_));
  aoi22  g76(.a(new_n100_), .b(new_n99_), .c(new_n62_), .d(new_n57_), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n98_), .c(new_n25_), .O(z7));
  nand3  g78(.a(new_n99_), .b(new_n80_), .c(x03), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  nand2  g80(.a(new_n63_), .b(new_n48_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n51_), .d(new_n25_), .O(z8));
endmodule
