...
module FAU ( 
  ...
  aoi21  g31(.a(new_n55_), .b(new_n31_), .c(x08), .O(new_n56_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n62_), .c(new_n60_), .O(z3));
  inv1   g42(.a(x10), .O(new_n67_));
  oai21  g43(.a(new_n64_), .b(new_n67_), .c(new_n27_), .O(new_n68_));
  inv1   g44(.a(x08), .O(new_n69_));
  oai21  g45(.a(new_n28_), .b(new_n27_), .c(new_n55_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  inv1   g47(.a(x09), .O(new_n72_));
  nor2   g48(.a(x10), .b(new_n72_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  nand2  g51(.a(new_n63_), .b(x07), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(z4));
  nor2   g53(.a(x12), .b(x00), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x07), .c(x13), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n67_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(z5));
  nand2  g57(.a(x09), .b(new_n38_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n31_), .c(x00), .O(new_n83_));
  nand2  g59(.a(new_n67_), .b(x02), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n82_), .c(x08), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n83_), .c(new_n28_), .O(new_n86_));
  aoi21  g62(.a(new_n72_), .b(x03), .c(x01), .O(new_n87_));
  nand3  g63(.a(new_n72_), .b(new_n69_), .c(x03), .O(new_n88_));
  oai21  g64(.a(new_n87_), .b(x00), .c(new_n88_), .O(new_n89_));
  nor2   g65(.a(x14), .b(x00), .O(new_n90_));
  aoi21  g66(.a(new_n69_), .b(x00), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n28_), .c(new_n67_), .O(new_n92_));
  aoi21  g68(.a(new_n89_), .b(new_n31_), .c(new_n92_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n86_), .c(x07), .O(z6));
  nand3  g70(.a(new_n69_), .b(new_n25_), .c(x02), .O(new_n95_));
  nand3  g71(.a(x09), .b(x03), .c(new_n31_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x01), .O(new_n97_));
  aoi21  g73(.a(x03), .b(new_n28_), .c(x08), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n97_), .c(new_n67_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n25_), .O(z7));
  nand2  g76(.a(new_n25_), .b(new_n38_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n64_), .c(new_n31_), .d(new_n28_), .O(new_n102_));
  nor2   g78(.a(x09), .b(x00), .O(new_n103_));
  aoi21  g79(.a(new_n102_), .b(x09), .c(new_n103_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(x10), .c(new_n25_), .O(z8));
endmodule
