...
module FAU ( 
  ...
  nor2   g47(.a(new_n53_), .b(new_n27_), .O(new_n72_));
  oai21  g48(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n28_), .O(new_n74_));
  nand3  g50(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(new_n76_));
  nand2  g52(.a(x14), .b(x02), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n27_), .O(new_n78_));
  nand2  g54(.a(new_n53_), .b(x00), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(new_n28_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n76_), .c(new_n54_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(x07), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n31_), .O(new_n83_));
  nand2  g59(.a(new_n25_), .b(x02), .O(new_n84_));
  nand2  g60(.a(new_n54_), .b(new_n53_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n28_), .O(new_n87_));
  aoi21  g63(.a(new_n53_), .b(x01), .c(x10), .O(new_n88_));
  nand2  g64(.a(new_n53_), .b(new_n38_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n87_), .d(new_n25_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n84_), .b(new_n91_), .c(x03), .d(new_n28_), .O(new_n92_));
  nor2   g68(.a(x09), .b(x00), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n25_), .O(z8));
endmodule
