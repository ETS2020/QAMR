...
module FAU ( 
  ...
  oai21  g34(.a(new_n58_), .b(new_n25_), .c(x00), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(x10), .c(new_n25_), .O(new_n61_));
  nand2  g37(.a(new_n60_), .b(new_n58_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n59_), .O(z3));
  nand2  g39(.a(new_n28_), .b(new_n38_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(x08), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(x01), .O(new_n66_));
  nand2  g42(.a(new_n55_), .b(new_n38_), .O(new_n67_));
  aoi21  g43(.a(new_n53_), .b(new_n30_), .c(new_n54_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n48_), .c(new_n25_), .O(new_n70_));
  oai21  g46(.a(x11), .b(new_n25_), .c(new_n70_), .O(z4));
  inv1   g47(.a(x13), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(x12), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n48_), .c(new_n25_), .d(new_n38_), .O(z5));
  oai21  g50(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n75_));
  oai21  g51(.a(x08), .b(new_n38_), .c(new_n64_), .O(new_n76_));
  ...
  nand3  g57(.a(new_n81_), .b(x02), .c(new_n38_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n77_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n48_), .c(new_n25_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(new_n53_), .b(new_n25_), .c(x02), .O(new_n86_));
  ...
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n48_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n25_), .O(z7));
  nand4  g68(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n54_), .b(new_n38_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n48_), .d(new_n25_), .O(z8));
endmodule
