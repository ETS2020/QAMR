...
module FAU ( 
  ...
  nand4  g39(.a(x13), .b(new_n57_), .c(new_n47_), .d(new_n26_), .O(new_n64_));
  ...
  nor2   g45(.a(x09), .b(new_n37_), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n30_), .c(new_n69_), .d(new_n27_), .O(new_n71_));
  aoi21  g47(.a(x14), .b(x02), .c(x00), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n26_), .O(new_n73_));
  ...
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n55_), .O(z7));
