...
module FAU ( 
  ...
  oai21  g41(.a(new_n65_), .b(new_n57_), .c(x00), .O(new_n66_));
  ...
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n25_), .d(new_n57_), .O(z5));
  ...
  oai21  g68(.a(new_n27_), .b(x01), .c(new_n58_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n25_), .d(new_n57_), .O(z7));
  nand4  g70(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n95_));
