...
module FAU ( 
  ...
  nand2  g37(.a(new_n46_), .b(new_n45_), .O(new_n62_));
  aoi22  g38(.a(new_n62_), .b(x11), .c(x12), .d(new_n26_), .O(z3));
  inv1   g39(.a(x09), .O(new_n64_));
  nand2  g40(.a(new_n62_), .b(x11), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  inv1   g42(.a(x08), .O(new_n67_));
  nand2  g43(.a(x01), .b(x00), .O(new_n68_));
  oai21  g44(.a(new_n64_), .b(x01), .c(new_n68_), .O(new_n69_));
  ...
  nand3  g48(.a(x08), .b(new_n45_), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n48_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n72_), .c(new_n66_), .O(z4));
  inv1   g51(.a(x12), .O(new_n76_));
  nand4  g52(.a(x13), .b(new_n76_), .c(new_n45_), .d(new_n26_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n54_), .O(z5));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  aoi21  g56(.a(x09), .b(new_n37_), .c(x02), .O(new_n81_));
  nand3  g57(.a(new_n64_), .b(x03), .c(new_n30_), .O(new_n82_));
  ...
  nand3  g66(.a(x09), .b(x03), .c(new_n30_), .O(new_n91_));
  nand4  g67(.a(new_n46_), .b(new_n67_), .c(new_n45_), .d(x02), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n27_), .O(new_n94_));
  oai21  g70(.a(new_n37_), .b(x01), .c(new_n67_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n46_), .d(new_n45_), .O(z7));
  oai21  g72(.a(new_n37_), .b(x02), .c(new_n45_), .O(new_n97_));
  nor2   g73(.a(x12), .b(x01), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(new_n97_), .c(new_n64_), .O(new_n99_));
  oai21  g75(.a(x09), .b(x00), .c(new_n45_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n99_), .c(new_n46_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n54_), .O(z8));
endmodule
