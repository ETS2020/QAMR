...
module FAU ( 
  ...
  nand3  g32(.a(new_n36_), .b(new_n53_), .c(x09), .O(new_n57_));
  ...
  oai21  g38(.a(new_n36_), .b(new_n52_), .c(x00), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai21  g40(.a(x11), .b(x00), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n63_), .c(new_n38_), .O(z3));
  inv1   g43(.a(x09), .O(new_n68_));
  oai21  g44(.a(new_n53_), .b(x07), .c(x11), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  inv1   g46(.a(x08), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n25_), .c(x10), .O(new_n72_));
  nand2  g48(.a(x01), .b(x00), .O(new_n73_));
  oai21  g49(.a(new_n68_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n36_), .c(new_n53_), .d(new_n71_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n72_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n52_), .O(new_n77_));
  oai21  g53(.a(x07), .b(new_n25_), .c(new_n36_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n70_), .O(z4));
  nand4  g55(.a(x13), .b(new_n64_), .c(new_n52_), .d(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n36_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n53_), .O(z5));
  ...
  aoi21  g63(.a(new_n68_), .b(x03), .c(x01), .O(new_n88_));
  nand3  g64(.a(new_n68_), .b(new_n71_), .c(x03), .O(new_n89_));
  oai21  g65(.a(new_n88_), .b(x00), .c(new_n89_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n27_), .O(new_n91_));
  nand3  g67(.a(new_n36_), .b(new_n71_), .c(x00), .O(new_n92_));
  ...
  aoi21  g72(.a(new_n96_), .b(new_n36_), .c(x10), .O(z6));
  nand3  g73(.a(x09), .b(x03), .c(new_n27_), .O(new_n98_));
  nand4  g74(.a(new_n53_), .b(new_n71_), .c(new_n52_), .d(x02), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(new_n98_), .c(x01), .O(new_n100_));
  oai21  g76(.a(new_n26_), .b(x01), .c(new_n71_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n52_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(new_n100_), .c(new_n36_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n53_), .O(z7));
  nand4  g80(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n105_));
  oai21  g81(.a(x09), .b(x00), .c(new_n52_), .O(new_n106_));
  aoi21  g82(.a(new_n105_), .b(x09), .c(new_n106_), .O(new_n107_));
  oai21  g83(.a(new_n107_), .b(x11), .c(new_n53_), .O(z8));
endmodule
