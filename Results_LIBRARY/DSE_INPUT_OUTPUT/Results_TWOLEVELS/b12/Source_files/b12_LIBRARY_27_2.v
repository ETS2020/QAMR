...
module FAU ( 
  ...
  aoi21  g47(.a(x12), .b(new_n25_), .c(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n53_), .c(new_n36_), .d(new_n25_), .O(z5));
  nor2   g49(.a(new_n57_), .b(new_n25_), .O(new_n74_));
  inv1   g50(.a(x09), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n29_), .O(new_n77_));
  nand3  g53(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n74_), .O(new_n79_));
  nand2  g55(.a(x14), .b(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n57_), .b(x00), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(new_n29_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n79_), .c(new_n53_), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(x07), .O(z6));
  ...
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(new_n36_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n53_), .O(z7));
  ...
  oai21  g71(.a(new_n95_), .b(x07), .c(new_n53_), .O(z8));
endmodule
