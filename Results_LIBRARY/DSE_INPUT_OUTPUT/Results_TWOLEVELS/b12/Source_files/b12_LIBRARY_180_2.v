...
module FAU ( 
  ...
  nand4  g61(.a(new_n52_), .b(new_n56_), .c(new_n51_), .d(x02), .O(new_n86_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n52_), .d(new_n51_), .O(z7));
  nand4  g66(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n51_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  nand2  g69(.a(x11), .b(x10), .O(new_n94_));
  oai21  g70(.a(new_n93_), .b(x10), .c(new_n94_), .O(z8));
endmodule
