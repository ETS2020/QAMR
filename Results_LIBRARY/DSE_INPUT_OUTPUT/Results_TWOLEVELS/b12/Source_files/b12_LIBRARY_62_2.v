...
module FAU ( 
  ...
  oai21  g40(.a(new_n61_), .b(new_n25_), .c(x07), .O(new_n65_));
  ...
  nand4  g46(.a(new_n70_), .b(new_n25_), .c(new_n45_), .d(new_n38_), .O(z5));
  nand2  g47(.a(new_n45_), .b(x02), .O(new_n72_));
  nand2  g48(.a(x09), .b(new_n27_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(x00), .O(new_n74_));
  nand2  g50(.a(new_n47_), .b(x02), .O(new_n75_));
  ...
  nand2  g54(.a(new_n28_), .b(new_n38_), .O(new_n79_));
  oai21  g55(.a(x08), .b(new_n38_), .c(new_n79_), .O(new_n80_));
  nand4  g56(.a(x09), .b(new_n51_), .c(new_n27_), .d(x00), .O(new_n81_));
  inv1   g57(.a(x14), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x01), .c(new_n38_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n45_), .O(new_n84_));
  aoi21  g60(.a(new_n80_), .b(new_n78_), .c(new_n84_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n77_), .c(x10), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n28_), .O(new_n87_));
  nand3  g63(.a(new_n25_), .b(new_n51_), .c(x02), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(x01), .O(new_n89_));
  aoi21  g65(.a(x03), .b(new_n30_), .c(x08), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n45_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n25_), .O(z7));
  nand4  g68(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n93_));
