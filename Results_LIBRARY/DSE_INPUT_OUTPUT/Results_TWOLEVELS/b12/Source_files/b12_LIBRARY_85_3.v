...
module FAU ( 
  ...
  nand2  g60(.a(new_n59_), .b(x00), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(new_n27_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n82_), .c(new_n52_), .O(new_n87_));
