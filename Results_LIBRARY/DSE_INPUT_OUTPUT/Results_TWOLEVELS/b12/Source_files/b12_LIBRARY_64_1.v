...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n53_), .c(new_n26_), .O(z4));
  inv1   g42(.a(x13), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x11), .c(new_n25_), .O(new_n68_));
  aoi21  g44(.a(new_n47_), .b(x00), .c(x10), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n68_), .c(new_n53_), .d(new_n61_), .O(z5));
  ...
  nand3  g63(.a(new_n87_), .b(x09), .c(x03), .O(new_n88_));
  nor2   g64(.a(x11), .b(x10), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(z7));
  nand3  g66(.a(new_n87_), .b(new_n61_), .c(x03), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n73_), .b(new_n38_), .c(x10), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n53_), .d(new_n26_), .O(z8));
endmodule
