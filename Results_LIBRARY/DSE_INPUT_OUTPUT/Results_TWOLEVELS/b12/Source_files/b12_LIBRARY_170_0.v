...
module FAU ( 
  ...
  oai21  g38(.a(new_n37_), .b(new_n52_), .c(x00), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n36_), .c(new_n37_), .O(new_n65_));
  nand4  g41(.a(new_n64_), .b(x11), .c(new_n52_), .d(new_n25_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n63_), .O(z3));
  inv1   g43(.a(x09), .O(new_n68_));
  nand2  g44(.a(new_n38_), .b(new_n68_), .O(new_n69_));
  oai21  g45(.a(new_n56_), .b(new_n25_), .c(x10), .O(new_n70_));
  nand2  g46(.a(x01), .b(x00), .O(new_n71_));
  oai21  g47(.a(new_n68_), .b(x01), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n36_), .c(new_n56_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n37_), .b(x10), .c(x07), .O(new_n78_));
  ...
  nand3  g64(.a(new_n68_), .b(new_n56_), .c(x03), .O(new_n89_));
