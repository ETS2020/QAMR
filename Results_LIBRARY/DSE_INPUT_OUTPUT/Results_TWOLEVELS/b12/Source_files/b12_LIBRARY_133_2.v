...
module FAU ( 
  ...
  oai21  g43(.a(new_n67_), .b(new_n59_), .c(x00), .O(new_n68_));
  ...
  nand3  g50(.a(new_n67_), .b(x10), .c(x07), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z4));
  inv1   g52(.a(x13), .O(new_n77_));
  aoi21  g53(.a(x12), .b(new_n27_), .c(new_n77_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n25_), .c(new_n59_), .d(new_n27_), .O(z5));
  ...
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n28_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x01), .c(new_n27_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n83_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n25_), .c(new_n59_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  nand3  g68(.a(x09), .b(x03), .c(new_n31_), .O(new_n93_));
  nand3  g69(.a(new_n25_), .b(new_n57_), .c(x02), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(x01), .O(new_n95_));
  aoi21  g71(.a(x03), .b(new_n28_), .c(x08), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n95_), .c(new_n59_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n25_), .O(z7));
  nand4  g74(.a(new_n69_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nand2  g76(.a(new_n84_), .b(new_n27_), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n25_), .d(new_n59_), .O(z8));
endmodule
