...
module FAU ( 
  ...
  nand2  g31(.a(x10), .b(new_n28_), .O(new_n56_));
  nand3  g32(.a(x13), .b(new_n25_), .c(x09), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n31_), .O(new_n59_));
  ...
  nor2   g43(.a(x11), .b(new_n48_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n67_), .c(new_n27_), .O(new_n69_));
  nand2  g45(.a(x01), .b(x00), .O(new_n70_));
  nand2  g46(.a(x09), .b(new_n31_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n70_), .c(new_n26_), .O(new_n72_));
  ...
  oai21  g51(.a(new_n75_), .b(new_n26_), .c(new_n25_), .O(z5));
  oai21  g52(.a(x09), .b(new_n28_), .c(new_n31_), .O(new_n77_));
  nand2  g53(.a(new_n29_), .b(new_n39_), .O(new_n78_));
  ...
  nand3  g62(.a(new_n86_), .b(x01), .c(new_n39_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(x13), .c(new_n25_), .d(new_n48_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  nand3  g66(.a(x09), .b(x03), .c(new_n29_), .O(new_n91_));
  nand4  g67(.a(new_n25_), .b(new_n55_), .c(new_n48_), .d(x02), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  oai21  g69(.a(new_n28_), .b(x01), .c(new_n55_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n48_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(x13), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n25_), .O(z7));
  nand4  g73(.a(new_n63_), .b(x03), .c(new_n29_), .d(new_n31_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n48_), .O(new_n99_));
  aoi21  g75(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n26_), .c(new_n25_), .O(z8));
endmodule
