...
module FAU ( 
  ...
  oai21  g27(.a(x09), .b(x07), .c(new_n47_), .O(new_n52_));
  nor2   g28(.a(new_n47_), .b(x03), .O(new_n53_));
  ...
  aoi21  g39(.a(new_n61_), .b(new_n57_), .c(new_n63_), .O(new_n64_));
  oai21  g40(.a(new_n56_), .b(x00), .c(new_n64_), .O(z2));
  inv1   g41(.a(new_n63_), .O(new_n66_));
  inv1   g42(.a(x11), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x00), .c(new_n67_), .O(new_n69_));
  oai21  g45(.a(new_n68_), .b(x00), .c(new_n57_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n66_), .O(z3));
  nand3  g47(.a(x09), .b(x08), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n57_), .O(new_n73_));
  nand2  g49(.a(new_n67_), .b(x07), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n66_), .O(z4));
  oai21  g51(.a(x12), .b(x00), .c(new_n57_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n66_), .c(new_n45_), .d(x13), .O(z5));
  oai21  g53(.a(x02), .b(x01), .c(x00), .O(new_n78_));
  nand2  g54(.a(x09), .b(new_n25_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(x08), .O(new_n80_));
  nand2  g56(.a(x14), .b(x02), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x01), .O(new_n82_));
  oai21  g58(.a(x09), .b(x02), .c(new_n25_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(x00), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n80_), .c(new_n57_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n62_), .c(x10), .O(z6));
  nand4  g62(.a(new_n47_), .b(x08), .c(new_n57_), .d(new_n62_), .O(z7));
  nor2   g63(.a(x10), .b(x03), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n58_), .c(new_n57_), .d(x00), .O(z8));
endmodule
