...
module FAU ( 
  ...
  nand3  g34(.a(new_n51_), .b(x09), .c(new_n25_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(x01), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n56_), .c(new_n48_), .O(new_n61_));
  inv1   g37(.a(x08), .O(new_n62_));
  inv1   g38(.a(x09), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x01), .c(new_n37_), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(new_n51_), .c(new_n62_), .d(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n61_), .O(z2));
  inv1   g42(.a(x11), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n25_), .c(x00), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x10), .c(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n69_), .b(new_n67_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n68_), .O(z3));
  nand2  g48(.a(x08), .b(x00), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x09), .c(new_n27_), .O(new_n74_));
  oai21  g50(.a(new_n34_), .b(new_n37_), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n48_), .O(new_n76_));
  nor2   g52(.a(x08), .b(new_n27_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(x00), .c(new_n63_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n51_), .c(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n67_), .b(x07), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n80_), .O(z4));
  inv1   g58(.a(x13), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(x10), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n69_), .c(new_n25_), .d(new_n48_), .O(z5));
  oai21  g61(.a(x09), .b(new_n57_), .c(new_n27_), .O(new_n86_));
  nor2   g62(.a(x02), .b(x00), .O(new_n87_));
  nor2   g63(.a(x08), .b(new_n48_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  oai21  g65(.a(new_n63_), .b(x03), .c(new_n37_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n73_), .c(new_n27_), .O(new_n91_));
  inv1   g67(.a(x14), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(x02), .c(new_n48_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n91_), .c(new_n89_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n51_), .c(new_n25_), .O(new_n95_));
  inv1   g71(.a(new_n95_), .O(z6));
  aoi21  g72(.a(new_n62_), .b(x02), .c(x10), .O(new_n97_));
  oai21  g73(.a(new_n57_), .b(x01), .c(new_n62_), .O(new_n98_));
  nand4  g74(.a(x09), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n25_), .O(z7));
  nand4  g76(.a(new_n69_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n101_));
