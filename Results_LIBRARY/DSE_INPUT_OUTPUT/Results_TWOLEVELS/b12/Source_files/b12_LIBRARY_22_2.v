...
module FAU ( 
  ...
  nand2  g49(.a(new_n73_), .b(new_n38_), .O(z5));
  ...
  nand4  g55(.a(new_n79_), .b(new_n75_), .c(new_n38_), .d(new_n49_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(x02), .O(z6));
  nand2  g57(.a(new_n38_), .b(new_n55_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n29_), .c(new_n49_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n27_), .O(new_n84_));
  aoi22  g60(.a(new_n38_), .b(x02), .c(new_n55_), .d(new_n26_), .O(new_n85_));
  nand3  g61(.a(x09), .b(x03), .c(new_n29_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n38_), .O(z7));
  nand3  g63(.a(new_n65_), .b(x03), .c(new_n29_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  aoi22  g65(.a(new_n77_), .b(new_n25_), .c(x07), .d(new_n27_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n38_), .d(new_n27_), .O(z8));
endmodule
