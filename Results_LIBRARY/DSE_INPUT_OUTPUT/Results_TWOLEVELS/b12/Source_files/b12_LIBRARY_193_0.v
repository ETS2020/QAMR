...
module FAU ( 
  ...
  nand2  g15(.a(new_n39_), .b(x06), .O(new_n40_));
  inv1   g16(.a(x06), .O(new_n41_));
  nand2  g17(.a(x10), .b(new_n41_), .O(new_n42_));
  aoi21  g18(.a(new_n42_), .b(new_n40_), .c(new_n31_), .O(new_n43_));
  ...
  nand4  g25(.a(new_n49_), .b(new_n48_), .c(x09), .d(x06), .O(new_n50_));
  inv1   g26(.a(x03), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nand3  g28(.a(x10), .b(new_n52_), .c(new_n51_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n50_), .c(x07), .O(new_n54_));
  aoi21  g30(.a(x07), .b(x06), .c(x10), .O(new_n55_));
  nor3   g31(.a(new_n55_), .b(x03), .c(x00), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n28_), .O(new_n57_));
  ...
  oai21  g38(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  ...
  oai21  g47(.a(x12), .b(x00), .c(new_n61_), .O(new_n72_));
  nor2   g48(.a(x10), .b(x07), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n72_), .c(new_n26_), .d(x13), .O(z5));
  inv1   g50(.a(x09), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x03), .c(new_n31_), .O(new_n76_));
  nand2  g52(.a(new_n28_), .b(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n52_), .b(x00), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n76_), .O(new_n80_));
  nand2  g56(.a(new_n31_), .b(new_n27_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n75_), .c(x03), .O(new_n83_));
  aoi21  g59(.a(x14), .b(x02), .c(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(x02), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(x01), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n83_), .c(new_n80_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n61_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(x06), .c(x10), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n28_), .O(new_n90_));
  nand4  g66(.a(new_n48_), .b(new_n52_), .c(new_n61_), .d(x01), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n31_), .O(new_n93_));
  nand3  g69(.a(new_n61_), .b(x06), .c(x02), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x03), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n52_), .O(new_n96_));
  nor2   g72(.a(x10), .b(new_n41_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n93_), .d(new_n61_), .O(z7));
  nand4  g74(.a(new_n64_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  aoi21  g76(.a(new_n75_), .b(new_n27_), .c(x07), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n100_), .c(new_n97_), .O(z8));
endmodule
