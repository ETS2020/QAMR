...
module FAU ( 
  ...
  nand3  g47(.a(x13), .b(new_n65_), .c(new_n25_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n36_), .c(new_n54_), .d(new_n49_), .O(z5));
  nand2  g50(.a(x08), .b(x00), .O(new_n75_));
  nor2   g51(.a(x02), .b(x01), .O(new_n76_));
  nand2  g52(.a(x09), .b(new_n26_), .O(new_n77_));
  inv1   g53(.a(x09), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x03), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n76_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n75_), .c(new_n36_), .d(new_n54_), .O(new_n81_));
  nor2   g57(.a(new_n81_), .b(x07), .O(z6));
  nor2   g58(.a(new_n76_), .b(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n54_), .c(new_n49_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(x03), .c(x08), .O(new_n85_));
  nand3  g61(.a(new_n76_), .b(x09), .c(x03), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n36_), .c(new_n54_), .d(new_n49_), .O(new_n87_));
  or2    g63(.a(new_n87_), .b(new_n85_), .O(z7));
  nand3  g64(.a(new_n76_), .b(new_n65_), .c(x03), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n49_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x14), .c(new_n54_), .O(z8));
endmodule
