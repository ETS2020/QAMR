...
module FAU ( 
  ...
  oai21  g44(.a(new_n68_), .b(new_n51_), .c(x00), .O(new_n69_));
  inv1   g45(.a(x12), .O(new_n70_));
  oai21  g46(.a(x07), .b(x00), .c(x11), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n25_), .O(z3));
  nand3  g49(.a(x09), .b(x08), .c(x00), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  oai21  g51(.a(new_n68_), .b(x10), .c(x07), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n75_), .O(z4));
  nand4  g53(.a(x13), .b(new_n70_), .c(new_n52_), .d(new_n26_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n51_), .O(new_n79_));
  nor2   g55(.a(x10), .b(new_n51_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z5));
  oai21  g58(.a(x09), .b(new_n39_), .c(new_n27_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n26_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  inv1   g62(.a(x09), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x03), .c(new_n31_), .O(new_n88_));
  nand2  g64(.a(x08), .b(x00), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n27_), .O(new_n90_));
  inv1   g66(.a(x14), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x01), .c(new_n26_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n90_), .c(new_n86_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n52_), .c(new_n51_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n25_), .O(z6));
  nand3  g71(.a(new_n59_), .b(new_n51_), .c(x02), .O(new_n96_));
  nand3  g72(.a(x09), .b(x03), .c(new_n31_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(x01), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x07), .c(new_n52_), .O(new_n99_));
  oai21  g75(.a(new_n49_), .b(x08), .c(new_n52_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n51_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n99_), .O(z7));
  aoi21  g78(.a(new_n70_), .b(new_n31_), .c(x07), .O(new_n103_));
  nor2   g79(.a(new_n49_), .b(x10), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(new_n103_), .c(x09), .O(new_n105_));
  oai21  g81(.a(x09), .b(x00), .c(new_n52_), .O(new_n106_));
  aoi21  g82(.a(new_n106_), .b(new_n51_), .c(new_n80_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(new_n105_), .O(z8));
endmodule
