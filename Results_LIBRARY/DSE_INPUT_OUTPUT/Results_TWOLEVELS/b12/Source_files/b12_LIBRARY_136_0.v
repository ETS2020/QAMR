...
module FAU ( 
  ...
  nand2  g32(.a(new_n56_), .b(x07), .O(new_n57_));
  aoi22  g33(.a(new_n57_), .b(new_n55_), .c(x12), .d(new_n39_), .O(z3));
  nand4  g34(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n25_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n57_), .O(z4));
  inv1   g37(.a(new_n27_), .O(z6));
  nand2  g38(.a(new_n26_), .b(new_n25_), .O(z7));
  one    g39(.O(z5));
