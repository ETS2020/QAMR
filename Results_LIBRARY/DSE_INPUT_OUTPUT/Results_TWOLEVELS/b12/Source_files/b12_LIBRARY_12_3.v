...
module FAU ( 
  ...
  nand2  g45(.a(new_n69_), .b(new_n57_), .O(z5));
  ...
  nand3  g60(.a(new_n73_), .b(new_n57_), .c(x02), .O(new_n85_));
  nand3  g61(.a(x09), .b(x03), .c(new_n27_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x01), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x07), .c(new_n49_), .O(new_n88_));
  aoi21  g64(.a(x03), .b(new_n29_), .c(x08), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x10), .c(new_n57_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n88_), .O(z7));
  nand4  g67(.a(new_n60_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  nand2  g69(.a(new_n77_), .b(new_n25_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n49_), .d(new_n57_), .O(z8));
endmodule
