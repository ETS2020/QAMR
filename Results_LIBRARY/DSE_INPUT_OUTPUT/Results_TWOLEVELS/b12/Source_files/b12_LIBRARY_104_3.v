...
module FAU ( 
  ...
  aoi21  g25(.a(new_n49_), .b(new_n29_), .c(new_n48_), .O(new_n50_));
  aoi21  g26(.a(new_n50_), .b(new_n47_), .c(new_n27_), .O(new_n51_));
  oai21  g27(.a(x10), .b(x07), .c(new_n26_), .O(new_n52_));
  ...
  nor2   g34(.a(new_n36_), .b(x03), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n55_), .c(new_n29_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n27_), .c(x08), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n53_), .c(new_n38_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n58_), .O(z2));
  inv1   g39(.a(x11), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai22  g41(.a(new_n65_), .b(x00), .c(new_n64_), .d(new_n53_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n39_), .O(z3));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n53_), .O(new_n69_));
  nand2  g45(.a(new_n64_), .b(x07), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n39_), .O(z4));
  nand4  g47(.a(x13), .b(new_n65_), .c(new_n53_), .d(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  nand2  g49(.a(new_n37_), .b(x10), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(z5));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  aoi21  g52(.a(x09), .b(new_n26_), .c(x02), .O(new_n77_));
  nand3  g53(.a(new_n54_), .b(x03), .c(new_n27_), .O(new_n78_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n36_), .c(new_n53_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n39_), .O(z6));
  inv1   g62(.a(x08), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n53_), .c(x02), .O(new_n88_));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n26_), .b(x01), .c(new_n87_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n53_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n90_), .c(new_n36_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n74_), .O(z7));
  nand2  g70(.a(new_n53_), .b(new_n26_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n65_), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  oai21  g72(.a(x09), .b(x00), .c(new_n53_), .O(new_n97_));
  aoi21  g73(.a(new_n96_), .b(x09), .c(new_n97_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x10), .c(new_n74_), .O(z8));
endmodule
