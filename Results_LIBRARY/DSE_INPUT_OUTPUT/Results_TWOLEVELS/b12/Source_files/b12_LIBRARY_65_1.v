...
module FAU ( 
  ...
  oai21  g35(.a(new_n59_), .b(new_n25_), .c(x00), .O(new_n60_));
  ...
  nand3  g50(.a(new_n74_), .b(x13), .c(new_n25_), .O(z5));
  nor2   g51(.a(new_n67_), .b(new_n38_), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x03), .c(new_n28_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n33_), .O(new_n79_));
  nand3  g55(.a(new_n77_), .b(x03), .c(new_n28_), .O(new_n80_));
  ...
  nand2  g59(.a(new_n67_), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(new_n33_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(new_n66_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x07), .O(z6));
  nand3  g63(.a(new_n67_), .b(new_n25_), .c(x02), .O(new_n88_));
  ...
  oai21  g67(.a(new_n91_), .b(new_n90_), .c(new_n66_), .O(new_n92_));
  ...
  oai21  g72(.a(new_n96_), .b(x10), .c(new_n25_), .O(z8));
endmodule
