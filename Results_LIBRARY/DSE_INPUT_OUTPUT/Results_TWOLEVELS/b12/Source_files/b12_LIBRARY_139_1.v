...
module FAU ( 
  ...
  nor2   g23(.a(x11), .b(x10), .O(new_n48_));
  ...
  aoi21  g29(.a(new_n53_), .b(new_n25_), .c(x03), .O(new_n54_));
  aoi22  g30(.a(new_n54_), .b(new_n38_), .c(new_n51_), .d(new_n47_), .O(new_n55_));
  oai21  g31(.a(x08), .b(x07), .c(x00), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(new_n26_), .c(x02), .O(new_n57_));
  oai21  g33(.a(new_n55_), .b(x01), .c(new_n57_), .O(z2));
  inv1   g34(.a(x12), .O(new_n59_));
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n52_), .d(new_n47_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n26_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n47_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n53_), .c(new_n26_), .O(z4));
  inv1   g40(.a(x13), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x11), .c(new_n25_), .O(new_n66_));
  aoi21  g42(.a(new_n47_), .b(x00), .c(x10), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n53_), .d(new_n59_), .O(z5));
  ...
  oai21  g50(.a(new_n74_), .b(new_n72_), .c(new_n69_), .O(new_n75_));
  nand2  g51(.a(x14), .b(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x01), .O(new_n77_));
  oai21  g53(.a(new_n70_), .b(x03), .c(new_n28_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n33_), .O(new_n79_));
  nand3  g55(.a(new_n70_), .b(x03), .c(new_n28_), .O(new_n80_));
  ...
  nand4  g59(.a(new_n83_), .b(new_n52_), .c(new_n25_), .d(new_n47_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n33_), .O(new_n86_));
  nand4  g62(.a(new_n25_), .b(new_n69_), .c(new_n47_), .d(x01), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(x02), .O(new_n88_));
  aoi21  g64(.a(new_n47_), .b(x02), .c(new_n27_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x08), .c(new_n47_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n52_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n25_), .O(z7));
  nand4  g68(.a(new_n59_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  oai21  g69(.a(x09), .b(x00), .c(new_n47_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x11), .c(new_n25_), .O(z8));
endmodule
