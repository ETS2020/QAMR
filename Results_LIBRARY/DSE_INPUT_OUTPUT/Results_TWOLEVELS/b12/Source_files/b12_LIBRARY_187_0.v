...
module FAU ( 
  ...
  nand2  g37(.a(x12), .b(new_n26_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(new_n63_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n47_), .O(z4));
  nor2   g46(.a(x07), .b(x00), .O(new_n71_));
  inv1   g47(.a(x13), .O(new_n72_));
  nor2   g48(.a(new_n72_), .b(x12), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n71_), .c(new_n46_), .d(x01), .O(z5));
  nand2  g50(.a(x14), .b(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n26_), .O(new_n76_));
  oai21  g52(.a(x08), .b(new_n26_), .c(new_n76_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n46_), .c(new_n65_), .d(x01), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  inv1   g55(.a(x08), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x07), .c(x01), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n46_), .O(z7));
  nor2   g58(.a(x10), .b(x09), .O(new_n83_));
  nand2  g59(.a(new_n65_), .b(new_n26_), .O(new_n84_));
  nand2  g60(.a(x07), .b(x01), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n47_), .O(z8));
endmodule
