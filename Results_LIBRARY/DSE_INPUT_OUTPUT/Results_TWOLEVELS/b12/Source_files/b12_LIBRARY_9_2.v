...
module FAU ( 
  ...
  nand4  g21(.a(new_n31_), .b(new_n45_), .c(new_n44_), .d(x00), .O(new_n46_));
  aoi21  g22(.a(new_n46_), .b(x00), .c(new_n25_), .O(new_n47_));
  inv1   g23(.a(x09), .O(new_n48_));
  aoi21  g24(.a(new_n31_), .b(new_n48_), .c(x08), .O(new_n49_));
  nand3  g25(.a(new_n31_), .b(x09), .c(new_n34_), .O(new_n50_));
  inv1   g26(.a(new_n50_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n49_), .c(new_n44_), .O(new_n52_));
  oai21  g28(.a(x10), .b(x07), .c(new_n34_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n52_), .c(x01), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n47_), .c(new_n35_), .O(new_n55_));
  oai21  g31(.a(x08), .b(x07), .c(x00), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(x10), .c(x02), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n55_), .O(z2));
  inv1   g34(.a(x11), .O(new_n59_));
  inv1   g35(.a(x12), .O(new_n60_));
  oai22  g36(.a(new_n60_), .b(x00), .c(new_n59_), .d(new_n44_), .O(new_n61_));
  ...
  nand3  g43(.a(new_n67_), .b(x13), .c(new_n60_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n35_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n31_), .O(z5));
  oai21  g46(.a(x02), .b(x01), .c(x00), .O(new_n71_));
  oai21  g47(.a(new_n48_), .b(x01), .c(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n45_), .O(new_n73_));
  aoi21  g49(.a(new_n48_), .b(new_n25_), .c(x01), .O(new_n74_));
  oai21  g50(.a(x14), .b(new_n25_), .c(new_n26_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n74_), .c(new_n34_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n73_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n31_), .c(new_n44_), .d(new_n35_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  oai21  g55(.a(new_n45_), .b(x07), .c(new_n35_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n31_), .O(z7));
  aoi21  g57(.a(x07), .b(new_n35_), .c(new_n67_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n31_), .c(new_n48_), .d(new_n35_), .O(z8));
endmodule
