...
module FAU ( 
  ...
  nor2   g00(.a(x14), .b(x13), .O(new_n25_));
  ...
  oai22  g44(.a(new_n68_), .b(x00), .c(new_n67_), .d(new_n51_), .O(new_n69_));
  ...
  nand4  g51(.a(new_n68_), .b(new_n52_), .c(new_n51_), .d(new_n27_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x13), .O(new_n77_));
  oai21  g53(.a(new_n75_), .b(x13), .c(new_n77_), .O(z5));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  aoi21  g55(.a(x09), .b(new_n40_), .c(x02), .O(new_n80_));
  nand3  g56(.a(new_n56_), .b(x03), .c(new_n33_), .O(new_n81_));
  ...
  nor2   g60(.a(x08), .b(new_n27_), .O(new_n85_));
  ...
  nand2  g66(.a(new_n51_), .b(x02), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x03), .c(new_n28_), .O(new_n92_));
  nand4  g68(.a(x09), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n52_), .c(new_n51_), .O(new_n94_));
  aoi21  g70(.a(new_n92_), .b(new_n90_), .c(new_n94_), .O(new_n95_));
  nor2   g71(.a(new_n95_), .b(new_n25_), .O(z7));
  nand4  g72(.a(new_n68_), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n97_));
