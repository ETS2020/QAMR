...
module FAU ( 
  ...
  oai21  g42(.a(x10), .b(x00), .c(x14), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n45_), .O(new_n68_));
  oai21  g44(.a(new_n65_), .b(new_n62_), .c(new_n68_), .O(z3));
  ...
  aoi22  g51(.a(new_n75_), .b(new_n46_), .c(new_n73_), .d(new_n48_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x07), .c(new_n72_), .O(z4));
  nand4  g53(.a(x13), .b(new_n66_), .c(new_n45_), .d(new_n26_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n46_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n54_), .O(z5));
  ...
  oai21  g61(.a(new_n85_), .b(x03), .c(new_n30_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n73_), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n48_), .b(x02), .c(new_n26_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n84_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n46_), .c(new_n45_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  inv1   g67(.a(x08), .O(new_n92_));
  nor2   g68(.a(x02), .b(x01), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x07), .c(x03), .O(new_n94_));
  nand3  g70(.a(new_n93_), .b(x09), .c(x03), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n45_), .O(new_n96_));
  aoi21  g72(.a(new_n94_), .b(new_n92_), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x10), .c(new_n54_), .O(z7));
  aoi21  g74(.a(new_n85_), .b(new_n26_), .c(x07), .O(new_n99_));
  nand3  g75(.a(new_n93_), .b(new_n66_), .c(x03), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n99_), .c(new_n46_), .O(z8));
endmodule
