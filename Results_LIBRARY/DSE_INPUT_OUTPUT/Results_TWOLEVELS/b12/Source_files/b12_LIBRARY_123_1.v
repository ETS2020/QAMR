...
module FAU ( 
  ...
  nor2   g57(.a(x09), .b(x01), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x08), .c(x00), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n29_), .c(new_n81_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(new_n80_), .O(z4));
  nand4  g61(.a(x13), .b(new_n74_), .c(new_n59_), .d(new_n41_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n29_), .O(new_n87_));
  nand2  g63(.a(x10), .b(x05), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n87_), .O(z5));
  oai21  g65(.a(new_n60_), .b(x03), .c(new_n28_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n35_), .O(new_n91_));
  nand3  g67(.a(new_n60_), .b(x03), .c(new_n28_), .O(new_n92_));
  aoi22  g68(.a(new_n92_), .b(new_n91_), .c(x08), .d(x00), .O(new_n93_));
  nand2  g69(.a(x14), .b(x02), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n41_), .O(new_n95_));
  inv1   g71(.a(x08), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x00), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n95_), .c(new_n35_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n93_), .c(new_n29_), .O(new_n99_));
  nor2   g75(.a(new_n99_), .b(x07), .O(z6));
  nand3  g76(.a(new_n96_), .b(new_n59_), .c(x02), .O(new_n101_));
  nand3  g77(.a(x09), .b(x03), .c(new_n28_), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(new_n101_), .c(x01), .O(new_n103_));
  aoi21  g79(.a(new_n59_), .b(x01), .c(new_n42_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(x08), .c(new_n59_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(new_n103_), .c(new_n29_), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(new_n88_), .O(z7));
  nand4  g83(.a(new_n74_), .b(x03), .c(new_n28_), .d(new_n35_), .O(new_n108_));
  oai21  g84(.a(x09), .b(x00), .c(new_n59_), .O(new_n109_));
  aoi21  g85(.a(new_n108_), .b(x09), .c(new_n109_), .O(new_n110_));
  oai21  g86(.a(new_n110_), .b(x10), .c(new_n88_), .O(z8));
endmodule
