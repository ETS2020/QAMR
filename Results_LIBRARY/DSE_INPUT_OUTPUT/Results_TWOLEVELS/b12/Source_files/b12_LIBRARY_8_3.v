...
module FAU ( 
  ...
  oai21  g42(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n67_));
  nand2  g43(.a(new_n30_), .b(new_n26_), .O(new_n68_));
  ...
  oai21  g49(.a(new_n73_), .b(x03), .c(new_n30_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n45_), .c(new_n27_), .O(new_n75_));
  inv1   g51(.a(x14), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x01), .c(new_n26_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n72_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n47_), .c(new_n58_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(z6));
  nand3  g56(.a(x09), .b(x03), .c(new_n30_), .O(new_n81_));
  nand4  g57(.a(new_n47_), .b(new_n69_), .c(new_n58_), .d(x02), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n27_), .O(new_n84_));
  oai21  g60(.a(new_n37_), .b(x01), .c(new_n69_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n84_), .c(new_n47_), .d(new_n58_), .O(z7));
  nand4  g62(.a(new_n62_), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n47_), .O(new_n88_));
  aoi21  g64(.a(new_n87_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x07), .c(new_n65_), .O(z8));
endmodule
