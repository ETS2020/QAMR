...
module FAU ( 
  ...
  aoi21  g27(.a(new_n51_), .b(new_n48_), .c(new_n32_), .O(new_n52_));
  nor2   g28(.a(x10), .b(x07), .O(new_n53_));
  nor3   g29(.a(new_n53_), .b(x03), .c(x01), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n52_), .c(new_n27_), .O(new_n55_));
  inv1   g31(.a(x07), .O(new_n56_));
  inv1   g32(.a(new_n26_), .O(new_n57_));
  nor2   g33(.a(new_n25_), .b(x03), .O(new_n58_));
  inv1   g34(.a(x09), .O(new_n59_));
  nor2   g35(.a(x10), .b(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n58_), .c(new_n28_), .O(new_n61_));
  aoi21  g37(.a(new_n61_), .b(new_n32_), .c(x08), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n56_), .c(new_n57_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n55_), .O(z2));
  inv1   g40(.a(x11), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  oai22  g42(.a(new_n66_), .b(x00), .c(new_n65_), .d(new_n56_), .O(new_n67_));
  ...
  nand4  g49(.a(x13), .b(new_n66_), .c(new_n56_), .d(new_n27_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(z5));
  oai21  g52(.a(new_n59_), .b(x03), .c(new_n32_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n28_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x00), .c(x02), .O(new_n80_));
  oai21  g56(.a(x09), .b(new_n40_), .c(new_n28_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n32_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n78_), .O(new_n83_));
  nand4  g59(.a(new_n83_), .b(new_n25_), .c(new_n73_), .d(new_n56_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nor2   g61(.a(x02), .b(new_n28_), .O(new_n86_));
  nor2   g62(.a(new_n59_), .b(x01), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n86_), .c(new_n25_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n56_), .c(x03), .d(new_n32_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n73_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n25_), .O(z7));
  nand4  g67(.a(new_n60_), .b(new_n56_), .c(new_n40_), .d(new_n28_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n56_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n73_), .O(new_n94_));
  nor2   g70(.a(x12), .b(x02), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n28_), .c(new_n59_), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  nor4   g73(.a(new_n97_), .b(new_n96_), .c(x10), .d(x08), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n94_), .O(z8));
endmodule
