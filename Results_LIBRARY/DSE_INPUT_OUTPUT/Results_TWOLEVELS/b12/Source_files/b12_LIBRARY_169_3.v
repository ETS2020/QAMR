...
module FAU ( 
  ...
  oai21  g46(.a(new_n69_), .b(new_n49_), .c(new_n70_), .O(new_n71_));
  ...
  oai21  g53(.a(new_n77_), .b(x10), .c(new_n70_), .O(new_n78_));
  nor3   g54(.a(x12), .b(x07), .c(x00), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x10), .c(new_n78_), .O(z5));
  oai21  g56(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n81_));
  ...
  oai21  g74(.a(x12), .b(new_n50_), .c(new_n98_), .O(z7));
  nand4  g75(.a(new_n70_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  nand2  g77(.a(new_n60_), .b(new_n39_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n50_), .d(new_n49_), .O(z8));
endmodule
