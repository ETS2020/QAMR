...
module FAU ( 
  ...
  nand3  g32(.a(new_n52_), .b(x09), .c(new_n51_), .O(new_n57_));
  ...
  nand2  g40(.a(new_n51_), .b(x02), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n60_), .c(new_n61_), .O(new_n67_));
  oai21  g43(.a(new_n59_), .b(x00), .c(new_n67_), .O(z2));
  inv1   g44(.a(x11), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n52_), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(x07), .c(x12), .d(new_n26_), .O(z3));
  nand3  g47(.a(x09), .b(x08), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n51_), .O(new_n73_));
  oai21  g49(.a(new_n70_), .b(new_n51_), .c(new_n73_), .O(z4));
  nor2   g50(.a(x12), .b(x00), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n52_), .d(new_n51_), .O(z5));
  oai21  g52(.a(x09), .b(new_n39_), .c(new_n27_), .O(new_n77_));
  nor2   g53(.a(x02), .b(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n26_), .O(new_n79_));
  ...
  nand3  g61(.a(new_n85_), .b(x01), .c(new_n26_), .O(new_n86_));
  ...
  nand2  g66(.a(new_n52_), .b(new_n60_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n65_), .c(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n27_), .O(new_n93_));
  aoi21  g69(.a(new_n48_), .b(new_n60_), .c(new_n55_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n93_), .O(z7));
  inv1   g71(.a(x12), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(x03), .c(new_n31_), .d(new_n27_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g74(.a(new_n81_), .b(new_n26_), .c(x10), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n98_), .c(new_n51_), .O(z8));
endmodule
