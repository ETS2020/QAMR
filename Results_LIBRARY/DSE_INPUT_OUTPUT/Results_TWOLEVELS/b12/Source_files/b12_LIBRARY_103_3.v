...
module FAU ( 
  ...
  nand4  g60(.a(x13), .b(new_n84_), .c(new_n58_), .d(new_n48_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n29_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n83_), .O(z5));
  nor2   g63(.a(new_n66_), .b(new_n48_), .O(new_n88_));
  oai21  g64(.a(new_n61_), .b(x03), .c(new_n25_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n51_), .O(new_n90_));
  nand3  g66(.a(new_n61_), .b(x03), .c(new_n25_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(new_n92_));
  nand2  g68(.a(x14), .b(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n48_), .O(new_n94_));
  nand2  g70(.a(new_n66_), .b(x00), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(new_n51_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n92_), .c(new_n29_), .O(new_n97_));
  nor2   g73(.a(new_n97_), .b(x07), .O(z6));
  nand3  g74(.a(x09), .b(x03), .c(new_n25_), .O(new_n99_));
  nand4  g75(.a(new_n29_), .b(new_n66_), .c(new_n58_), .d(x02), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n51_), .O(new_n102_));
  nand2  g78(.a(new_n54_), .b(x01), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x03), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(new_n66_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n102_), .c(new_n29_), .d(new_n58_), .O(z7));
  nand4  g82(.a(new_n84_), .b(x03), .c(new_n25_), .d(new_n51_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(x09), .O(new_n108_));
  nand2  g84(.a(new_n61_), .b(new_n48_), .O(new_n109_));
  nand4  g85(.a(new_n109_), .b(new_n108_), .c(new_n29_), .d(new_n58_), .O(z8));
endmodule
