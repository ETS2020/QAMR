...
module FAU ( 
  ...
  nand2  g25(.a(x13), .b(x10), .O(new_n50_));
  ...
  nor2   g47(.a(new_n36_), .b(x00), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n65_), .c(new_n52_), .d(new_n56_), .O(z5));
  nor2   g49(.a(new_n48_), .b(new_n25_), .O(new_n74_));
  oai21  g50(.a(new_n49_), .b(x03), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n29_), .O(new_n76_));
  nand3  g52(.a(new_n49_), .b(x03), .c(new_n27_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(new_n78_));
  nand2  g54(.a(x14), .b(x02), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n48_), .b(x00), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(new_n29_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n78_), .c(new_n52_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(x07), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand4  g61(.a(new_n52_), .b(new_n48_), .c(new_n56_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  oai21  g64(.a(new_n26_), .b(x01), .c(new_n48_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n52_), .d(new_n56_), .O(z7));
  nand3  g66(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n56_), .c(x12), .O(new_n92_));
  aoi21  g68(.a(new_n49_), .b(new_n25_), .c(x07), .O(new_n93_));
  oai21  g69(.a(new_n92_), .b(new_n49_), .c(new_n93_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n52_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n50_), .O(z8));
endmodule
