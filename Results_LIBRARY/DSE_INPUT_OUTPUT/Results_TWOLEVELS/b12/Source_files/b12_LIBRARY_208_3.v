...
module FAU ( 
  ...
  oai22  g27(.a(new_n51_), .b(x02), .c(new_n47_), .d(new_n25_), .O(new_n52_));
  ...
  aoi21  g37(.a(new_n61_), .b(new_n28_), .c(x10), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n47_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(x09), .c(x00), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n60_), .O(new_n65_));
  nand2  g41(.a(x11), .b(new_n49_), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(x07), .c(x10), .d(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n65_), .O(z4));
  inv1   g44(.a(x12), .O(new_n69_));
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n49_), .d(new_n25_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n60_), .O(new_n71_));
  oai21  g47(.a(x10), .b(new_n60_), .c(new_n71_), .O(z5));
  inv1   g48(.a(x09), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x03), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n27_), .c(new_n25_), .O(new_n75_));
  nand3  g51(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n28_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(new_n78_));
  nand2  g54(.a(x14), .b(x02), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x01), .O(new_n80_));
  oai21  g56(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n29_), .O(new_n82_));
  nand3  g58(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n80_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n78_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n49_), .c(new_n60_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n36_), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n29_), .O(new_n89_));
  nand4  g65(.a(new_n49_), .b(new_n47_), .c(new_n60_), .d(x01), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n27_), .O(new_n92_));
  aoi21  g68(.a(new_n47_), .b(x02), .c(x10), .O(new_n93_));
  nand2  g69(.a(new_n47_), .b(new_n26_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n60_), .O(z7));
  nand4  g71(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  nand2  g73(.a(new_n73_), .b(new_n25_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n49_), .d(new_n60_), .O(z8));
endmodule
