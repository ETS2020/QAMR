...
module FAU ( 
  ...
  nand3  g46(.a(new_n63_), .b(new_n47_), .c(x07), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  nand2  g48(.a(new_n47_), .b(x07), .O(new_n73_));
  nand4  g49(.a(x13), .b(new_n65_), .c(new_n47_), .d(new_n37_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n46_), .O(new_n75_));
  ...
  nand3  g60(.a(new_n84_), .b(x01), .c(new_n37_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n47_), .c(new_n46_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  nand4  g65(.a(new_n47_), .b(new_n55_), .c(new_n46_), .d(x02), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n29_), .O(new_n92_));
  oai21  g68(.a(new_n26_), .b(x01), .c(new_n55_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n47_), .d(new_n46_), .O(z7));
  ...
  oai21  g73(.a(new_n97_), .b(x07), .c(new_n73_), .O(z8));
endmodule
