...
module FAU ( 
  ...
  nor3   g41(.a(x12), .b(x10), .c(x00), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(x13), .c(new_n55_), .O(z5));
  oai21  g43(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n68_));
  ...
  oai21  g50(.a(new_n74_), .b(x03), .c(new_n30_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n45_), .c(new_n27_), .O(new_n76_));
  inv1   g52(.a(x14), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x02), .c(new_n26_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n73_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n47_), .c(new_n55_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  aoi21  g57(.a(new_n70_), .b(x02), .c(x10), .O(new_n82_));
  oai21  g58(.a(new_n37_), .b(x01), .c(new_n70_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .d(new_n55_), .O(z7));
  aoi21  g61(.a(new_n30_), .b(new_n27_), .c(x07), .O(new_n86_));
  aoi21  g62(.a(new_n58_), .b(x03), .c(x10), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n86_), .c(x09), .O(new_n88_));
  oai21  g64(.a(x09), .b(x00), .c(new_n47_), .O(new_n89_));
  nor2   g65(.a(x10), .b(new_n55_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n88_), .O(z8));
endmodule
