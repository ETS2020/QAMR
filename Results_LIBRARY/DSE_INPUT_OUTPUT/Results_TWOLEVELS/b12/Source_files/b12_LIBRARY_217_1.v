...
module FAU ( 
  ...
  nand3  g42(.a(x09), .b(new_n54_), .c(new_n29_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n65_), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n49_), .c(new_n63_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x07), .c(new_n61_), .O(z4));
  aoi21  g46(.a(new_n36_), .b(x00), .c(x12), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n49_), .d(new_n36_), .O(z5));
  oai21  g48(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n73_));
  nor2   g49(.a(x08), .b(new_n25_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n64_), .c(new_n73_), .O(new_n75_));
  oai21  g51(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n76_));
  ...
  nand3  g59(.a(new_n54_), .b(new_n36_), .c(x02), .O(new_n84_));
  ...
  oai21  g64(.a(new_n88_), .b(new_n86_), .c(new_n49_), .O(new_n89_));
  ...
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n36_), .O(z8));
endmodule
