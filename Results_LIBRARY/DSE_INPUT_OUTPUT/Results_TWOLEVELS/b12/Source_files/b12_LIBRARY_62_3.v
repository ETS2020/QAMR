...
module FAU ( 
  ...
  nand3  g59(.a(new_n83_), .b(x02), .c(new_n37_), .O(new_n84_));
  ...
  nand2  g70(.a(new_n47_), .b(x07), .O(new_n95_));
  nand4  g71(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  oai21  g72(.a(x09), .b(x00), .c(new_n47_), .O(new_n97_));
  aoi21  g73(.a(new_n96_), .b(x09), .c(new_n97_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x07), .c(new_n95_), .O(z8));
endmodule
