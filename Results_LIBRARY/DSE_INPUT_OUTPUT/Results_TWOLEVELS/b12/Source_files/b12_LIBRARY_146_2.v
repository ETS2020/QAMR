...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n80_, new_n81_, new_n82_, new_n85_, new_n86_;
  ...
  oai21  g34(.a(new_n58_), .b(new_n53_), .c(new_n29_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n27_), .c(x08), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n51_), .c(new_n36_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n56_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n51_), .O(new_n65_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n37_), .O(z4));
  nand3  g46(.a(x13), .b(new_n64_), .c(new_n25_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n57_), .c(new_n51_), .d(new_n26_), .O(z5));
  inv1   g49(.a(x08), .O(new_n74_));
  aoi21  g50(.a(new_n27_), .b(new_n29_), .c(new_n25_), .O(new_n75_));
  nor2   g51(.a(new_n52_), .b(x01), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  aoi21  g53(.a(new_n52_), .b(new_n27_), .c(x01), .O(new_n78_));
  oai21  g54(.a(x14), .b(new_n27_), .c(new_n28_), .O(new_n79_));
  ...
  aoi21  g58(.a(new_n82_), .b(new_n26_), .c(x10), .O(z6));
  nand4  g59(.a(new_n57_), .b(x08), .c(new_n51_), .d(new_n26_), .O(z7));
  nand3  g60(.a(new_n52_), .b(new_n51_), .c(x00), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n26_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n57_), .O(z8));
endmodule
