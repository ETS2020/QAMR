...
module FAU ( 
  ...
  nand3  g44(.a(new_n63_), .b(new_n47_), .c(x07), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(z4));
  inv1   g46(.a(x13), .O(new_n71_));
  nor2   g47(.a(new_n71_), .b(x10), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n64_), .c(new_n46_), .d(new_n37_), .O(z5));
  nor2   g49(.a(new_n57_), .b(new_n37_), .O(new_n74_));
  oai21  g50(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n29_), .O(new_n76_));
  nand3  g52(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n77_));
  ...
  nand4  g61(.a(new_n47_), .b(new_n57_), .c(new_n46_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  oai21  g64(.a(new_n26_), .b(x01), .c(new_n57_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n47_), .d(new_n46_), .O(z7));
