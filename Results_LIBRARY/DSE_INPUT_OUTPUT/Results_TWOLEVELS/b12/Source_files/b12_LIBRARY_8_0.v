...
module FAU ( 
  ...
  aoi21  g22(.a(new_n39_), .b(new_n29_), .c(x02), .O(new_n47_));
  nand2  g23(.a(new_n27_), .b(new_n28_), .O(new_n48_));
  ...
  aoi22  g30(.a(new_n54_), .b(new_n52_), .c(x12), .d(new_n28_), .O(z3));
  nand3  g31(.a(x09), .b(x08), .c(x00), .O(new_n56_));
  nand3  g32(.a(new_n56_), .b(x10), .c(new_n25_), .O(new_n57_));
  nand2  g33(.a(new_n57_), .b(new_n54_), .O(z4));
  nand2  g34(.a(new_n26_), .b(new_n25_), .O(z5));
  inv1   g35(.a(new_n27_), .O(z6));
  one    g36(.O(z7));
  nand2  g37(.a(new_n26_), .b(new_n25_), .O(z8));
endmodule
