...
module FAU ( 
  ...
  oai21  g54(.a(x12), .b(x00), .c(new_n58_), .O(new_n79_));
  aoi21  g55(.a(x07), .b(new_n54_), .c(x10), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n30_), .d(x13), .O(z5));
  oai21  g57(.a(x09), .b(new_n28_), .c(new_n51_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x00), .O(new_n83_));
  inv1   g59(.a(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n83_), .c(new_n82_), .O(new_n86_));
  ...
  nand3  g66(.a(new_n90_), .b(x01), .c(new_n84_), .O(new_n91_));
  ...
  nand4  g78(.a(new_n71_), .b(x03), .c(new_n40_), .d(new_n51_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  aoi22  g80(.a(new_n59_), .b(new_n84_), .c(x07), .d(new_n54_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n29_), .d(new_n54_), .O(z8));
endmodule
