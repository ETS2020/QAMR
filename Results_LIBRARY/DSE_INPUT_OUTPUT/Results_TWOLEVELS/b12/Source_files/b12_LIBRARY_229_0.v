...
module FAU ( 
  ...
  nor2   g11(.a(x10), .b(x09), .O(new_n36_));
  ...
  nand3  g25(.a(x10), .b(new_n49_), .c(new_n48_), .O(new_n50_));
  oai21  g26(.a(new_n36_), .b(x00), .c(new_n50_), .O(new_n51_));
  oai21  g27(.a(x03), .b(x01), .c(new_n27_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  inv1   g29(.a(x10), .O(new_n54_));
  oai21  g30(.a(new_n49_), .b(new_n25_), .c(new_n29_), .O(new_n55_));
  nand3  g31(.a(new_n49_), .b(x02), .c(x00), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n54_), .c(x09), .d(new_n48_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n53_), .O(z2));
  inv1   g35(.a(x09), .O(new_n60_));
  oai21  g36(.a(x07), .b(new_n25_), .c(x10), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  oai21  g38(.a(new_n60_), .b(x07), .c(x11), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(x00), .O(new_n64_));
  inv1   g40(.a(x11), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(new_n48_), .c(new_n66_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n64_), .c(new_n62_), .O(z3));
  oai21  g44(.a(new_n60_), .b(x08), .c(x00), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n48_), .O(new_n70_));
  nand2  g46(.a(new_n65_), .b(x07), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n62_), .O(z4));
  nand4  g48(.a(x13), .b(new_n66_), .c(new_n48_), .d(new_n25_), .O(new_n73_));
  ...
  oai21  g54(.a(new_n60_), .b(new_n27_), .c(x03), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n49_), .c(x00), .O(new_n80_));
  aoi21  g56(.a(x03), .b(new_n27_), .c(x01), .O(new_n81_));
  nor2   g57(.a(x14), .b(new_n27_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(new_n25_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n80_), .c(new_n78_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n48_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(x09), .c(x10), .O(z6));
  nand3  g62(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x08), .c(new_n48_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n54_), .O(z7));
  nand3  g66(.a(new_n66_), .b(new_n48_), .c(x03), .O(new_n91_));
  nor3   g67(.a(new_n91_), .b(x02), .c(x01), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n60_), .c(new_n54_), .O(z8));
endmodule
