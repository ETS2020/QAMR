...
module FAU ( 
  ...
  inv1   g56(.a(x00), .O(new_n81_));
  nand4  g57(.a(x13), .b(new_n67_), .c(new_n52_), .d(new_n81_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n28_), .O(z5));
  inv1   g60(.a(x03), .O(new_n85_));
  oai21  g61(.a(x09), .b(new_n85_), .c(new_n42_), .O(new_n86_));
  nor2   g62(.a(x02), .b(x00), .O(new_n87_));
  nor2   g63(.a(x08), .b(new_n81_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  oai21  g65(.a(new_n74_), .b(x03), .c(new_n37_), .O(new_n90_));
  nand2  g66(.a(x08), .b(x00), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n42_), .O(new_n92_));
  inv1   g68(.a(x14), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x01), .c(new_n81_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n92_), .c(new_n89_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n28_), .c(new_n52_), .d(new_n51_), .O(new_n96_));
  inv1   g72(.a(new_n96_), .O(z6));
  nand3  g73(.a(x09), .b(x03), .c(new_n37_), .O(new_n98_));
  nand4  g74(.a(new_n28_), .b(new_n60_), .c(new_n52_), .d(x02), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(new_n98_), .c(x01), .O(new_n100_));
  oai21  g76(.a(new_n85_), .b(x01), .c(new_n60_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n52_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(new_n100_), .c(new_n51_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n28_), .O(z7));
  nand4  g80(.a(new_n67_), .b(x03), .c(new_n37_), .d(new_n42_), .O(new_n105_));
  oai21  g81(.a(x09), .b(x00), .c(new_n52_), .O(new_n106_));
  aoi21  g82(.a(new_n105_), .b(x09), .c(new_n106_), .O(new_n107_));
  oai21  g83(.a(new_n107_), .b(x05), .c(new_n28_), .O(z8));
endmodule
