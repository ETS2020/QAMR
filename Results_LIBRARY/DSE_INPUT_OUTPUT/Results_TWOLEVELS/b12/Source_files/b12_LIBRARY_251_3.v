...
module FAU ( 
  ...
  oai21  g53(.a(new_n77_), .b(x10), .c(new_n50_), .O(new_n78_));
  ...
  oai21  g61(.a(new_n85_), .b(x03), .c(new_n27_), .O(new_n86_));
  ...
  nand3  g69(.a(new_n71_), .b(new_n47_), .c(x02), .O(new_n94_));
  nand3  g70(.a(x09), .b(x03), .c(new_n27_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(x01), .O(new_n96_));
  oai21  g72(.a(new_n26_), .b(x01), .c(new_n71_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n47_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n96_), .c(new_n48_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n56_), .O(z7));
  aoi21  g76(.a(new_n85_), .b(new_n25_), .c(x07), .O(new_n101_));
  nand4  g77(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand3  g79(.a(new_n103_), .b(new_n101_), .c(new_n48_), .O(z8));
endmodule
