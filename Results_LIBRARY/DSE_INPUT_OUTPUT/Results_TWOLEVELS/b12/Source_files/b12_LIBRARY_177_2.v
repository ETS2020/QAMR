...
module FAU ( 
  ...
  nand3  g39(.a(x13), .b(new_n57_), .c(new_n27_), .O(new_n64_));
  ...
  nand3  g50(.a(new_n74_), .b(x01), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n46_), .O(new_n76_));
  aoi21  g52(.a(new_n73_), .b(new_n31_), .c(new_n76_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n71_), .c(x10), .O(z6));
  nand3  g54(.a(x09), .b(x03), .c(new_n28_), .O(new_n79_));
  nand3  g55(.a(new_n25_), .b(new_n53_), .c(x01), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n31_), .O(new_n82_));
  oai21  g58(.a(x07), .b(new_n31_), .c(x03), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n53_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n82_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand4  g61(.a(new_n57_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n86_));
