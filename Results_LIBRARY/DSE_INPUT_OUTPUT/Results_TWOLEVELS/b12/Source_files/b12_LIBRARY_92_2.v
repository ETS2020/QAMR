...
module FAU ( 
  ...
  nand2  g23(.a(x11), .b(x10), .O(new_n48_));
  ...
  nor2   g37(.a(new_n25_), .b(x07), .O(new_n62_));
  nor2   g38(.a(x11), .b(x10), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(x00), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  nand2  g41(.a(x12), .b(new_n50_), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(new_n25_), .c(new_n65_), .d(new_n54_), .O(new_n67_));
  ...
  nand3  g48(.a(x13), .b(new_n65_), .c(new_n54_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n50_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n64_), .c(new_n48_), .O(z5));
  nor2   g51(.a(new_n46_), .b(new_n27_), .O(new_n76_));
  oai21  g52(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n28_), .O(new_n78_));
  nand3  g54(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n79_));
  ...
  nand2  g58(.a(new_n46_), .b(x00), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(new_n28_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n80_), .c(new_n50_), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(x07), .O(z6));
  nand2  g62(.a(new_n54_), .b(x02), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x03), .c(new_n28_), .O(new_n88_));
  nor2   g64(.a(x02), .b(x01), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x09), .c(x03), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n54_), .O(new_n91_));
  aoi21  g67(.a(new_n88_), .b(new_n46_), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n48_), .O(z7));
  nand2  g69(.a(new_n54_), .b(new_n38_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n89_), .c(new_n65_), .O(new_n95_));
