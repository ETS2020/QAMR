...
module FAU ( 
  ...
  nand2  g41(.a(new_n25_), .b(x00), .O(new_n66_));
  aoi22  g42(.a(new_n66_), .b(x12), .c(x11), .d(x07), .O(z3));
  ...
  nand3  g47(.a(new_n71_), .b(new_n69_), .c(new_n28_), .O(z4));
  nor2   g48(.a(x07), .b(x00), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(x13), .c(new_n26_), .d(new_n25_), .O(z5));
  oai21  g50(.a(x09), .b(new_n29_), .c(new_n32_), .O(new_n75_));
  ...
  oai21  g55(.a(new_n79_), .b(x03), .c(new_n30_), .O(new_n80_));
  nand2  g56(.a(x08), .b(x00), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n32_), .O(new_n82_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n25_), .c(new_n47_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n28_), .O(z6));
  aoi21  g63(.a(new_n48_), .b(x02), .c(x07), .O(new_n88_));
  oai21  g64(.a(new_n29_), .b(x01), .c(new_n48_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n25_), .O(z7));
  nand2  g67(.a(new_n79_), .b(new_n40_), .O(new_n92_));
  nand2  g68(.a(x12), .b(x09), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n47_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n25_), .O(new_n95_));
  nand3  g71(.a(x03), .b(new_n30_), .c(new_n32_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(x09), .c(x10), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x12), .c(new_n95_), .O(z8));
endmodule
