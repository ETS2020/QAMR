...
module FAU ( 
  ...
  nor2   g39(.a(new_n53_), .b(new_n38_), .O(new_n64_));
  nor3   g40(.a(x09), .b(x02), .c(x01), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(x09), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n48_), .c(new_n25_), .O(new_n67_));
  oai21  g43(.a(x11), .b(new_n25_), .c(new_n67_), .O(z4));
  inv1   g44(.a(x13), .O(new_n69_));
  nor2   g45(.a(new_n69_), .b(x10), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n60_), .c(new_n25_), .d(new_n38_), .O(z5));
  nand2  g47(.a(new_n54_), .b(x03), .O(new_n72_));
  nand2  g48(.a(new_n48_), .b(x01), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(x00), .O(new_n74_));
  nor2   g50(.a(x10), .b(x08), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x01), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n74_), .c(new_n28_), .O(new_n78_));
  oai21  g54(.a(new_n54_), .b(x03), .c(new_n28_), .O(new_n79_));
  nand2  g55(.a(new_n30_), .b(new_n38_), .O(new_n80_));
  oai21  g56(.a(x08), .b(new_n38_), .c(new_n80_), .O(new_n81_));
  nand4  g57(.a(new_n54_), .b(new_n53_), .c(x03), .d(x00), .O(new_n82_));
  inv1   g58(.a(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x02), .c(new_n38_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n48_), .O(new_n85_));
  aoi21  g61(.a(new_n81_), .b(new_n79_), .c(new_n85_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n78_), .c(x07), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n30_), .O(new_n88_));
  nand3  g64(.a(new_n75_), .b(new_n25_), .c(x01), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n28_), .O(new_n91_));
  aoi21  g67(.a(new_n53_), .b(x02), .c(x10), .O(new_n92_));
  nand2  g68(.a(new_n53_), .b(new_n27_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n25_), .O(z7));
  nand4  g70(.a(new_n60_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n95_));
