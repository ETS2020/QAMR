...
module FAU ( 
  ...
  aoi22  g51(.a(new_n75_), .b(new_n57_), .c(new_n73_), .d(new_n64_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x07), .c(new_n72_), .O(z4));
  nand4  g53(.a(x13), .b(new_n65_), .c(new_n50_), .d(new_n25_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n57_), .O(new_n79_));
  nand2  g55(.a(x10), .b(new_n64_), .O(new_n80_));
  ...
  oai21  g61(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n73_), .c(new_n29_), .O(new_n87_));
  ...
  nand3  g66(.a(new_n90_), .b(new_n57_), .c(new_n50_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n36_), .O(z6));
  inv1   g68(.a(x08), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n50_), .c(x02), .O(new_n94_));
  nand3  g70(.a(x09), .b(x03), .c(new_n27_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(x01), .O(new_n96_));
  aoi21  g72(.a(new_n50_), .b(x01), .c(new_n26_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x08), .c(new_n50_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n96_), .c(new_n57_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n80_), .O(z7));
  nand4  g76(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  nand2  g78(.a(new_n51_), .b(new_n25_), .O(new_n103_));
  nand4  g79(.a(new_n103_), .b(new_n102_), .c(new_n57_), .d(new_n50_), .O(z8));
endmodule
