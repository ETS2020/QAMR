...
module FAU ( 
  ...
  oai22  g17(.a(new_n41_), .b(new_n29_), .c(new_n40_), .d(new_n27_), .O(new_n42_));
  ...
  aoi21  g32(.a(x09), .b(new_n29_), .c(x02), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(x08), .c(new_n56_), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n65_), .b(x01), .c(new_n25_), .O(new_n66_));
  nand3  g42(.a(x09), .b(new_n65_), .c(new_n29_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n66_), .c(new_n56_), .d(x09), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n36_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n63_), .O(z4));
  nor2   g46(.a(x12), .b(x00), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x07), .c(x13), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n56_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n36_), .O(z5));
  ...
  nand3  g61(.a(new_n85_), .b(new_n56_), .c(new_n36_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  nand4  g64(.a(new_n56_), .b(new_n65_), .c(new_n36_), .d(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n29_), .O(new_n91_));
  oai21  g67(.a(new_n26_), .b(x01), .c(new_n65_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n56_), .d(new_n36_), .O(z7));
  oai21  g69(.a(new_n41_), .b(x01), .c(x09), .O(new_n94_));
  nor2   g70(.a(x09), .b(x00), .O(new_n95_));
  aoi21  g71(.a(x12), .b(x09), .c(new_n95_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n94_), .c(new_n56_), .d(new_n36_), .O(z8));
endmodule
