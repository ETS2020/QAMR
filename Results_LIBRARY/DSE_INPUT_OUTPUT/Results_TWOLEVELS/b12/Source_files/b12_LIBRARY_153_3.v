...
module FAU ( 
  ...
  oai21  g41(.a(new_n49_), .b(new_n46_), .c(new_n65_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n25_), .O(z3));
  inv1   g43(.a(x08), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x07), .c(new_n49_), .O(new_n69_));
  aoi21  g45(.a(new_n48_), .b(new_n32_), .c(x08), .O(new_n70_));
  nand2  g46(.a(x09), .b(x00), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n70_), .c(new_n46_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n69_), .c(new_n25_), .O(z4));
  nand4  g49(.a(x13), .b(new_n65_), .c(new_n46_), .d(new_n37_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n47_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n55_), .O(z5));
  oai21  g52(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n77_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n32_), .O(new_n84_));
  inv1   g60(.a(x14), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x01), .c(new_n37_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n80_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n47_), .c(new_n46_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  oai21  g65(.a(x10), .b(new_n27_), .c(new_n32_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n46_), .c(new_n26_), .O(new_n91_));
  nand4  g67(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n47_), .c(new_n46_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n91_), .b(x08), .c(new_n94_), .O(z7));
  nand4  g71(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  nand2  g73(.a(new_n81_), .b(new_n37_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n47_), .d(new_n46_), .O(z8));
endmodule
