...
module FAU ( 
  ...
  oai21  g38(.a(new_n60_), .b(new_n50_), .c(x07), .O(new_n63_));
  ...
  nor2   g62(.a(new_n76_), .b(new_n26_), .O(new_n87_));
  aoi22  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n72_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x07), .c(new_n50_), .O(z7));
  nand3  g65(.a(new_n86_), .b(new_n67_), .c(x03), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand2  g67(.a(new_n76_), .b(new_n25_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n50_), .d(new_n36_), .O(z8));
endmodule
