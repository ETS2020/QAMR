...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n102_;
  nor2   g00(.a(x14), .b(x10), .O(new_n25_));
  ...
  nand3  g26(.a(x14), .b(new_n50_), .c(new_n49_), .O(new_n51_));
  ...
  nand4  g53(.a(x13), .b(new_n77_), .c(new_n49_), .d(new_n40_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(x14), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n50_), .O(z5));
  nor2   g56(.a(x02), .b(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n40_), .O(new_n82_));
  ...
  nand3  g61(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n86_));
  oai21  g62(.a(new_n85_), .b(x01), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n83_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(x14), .c(new_n50_), .d(new_n49_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  inv1   g67(.a(x08), .O(new_n92_));
  nand2  g68(.a(new_n49_), .b(x02), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x03), .c(new_n33_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g71(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n96_));
  aoi21  g72(.a(x14), .b(x07), .c(new_n25_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n50_), .O(z7));
  nand3  g74(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n99_));
  aoi21  g75(.a(new_n99_), .b(x14), .c(x12), .O(new_n100_));
  or2    g76(.a(new_n100_), .b(new_n61_), .O(new_n101_));
  nand2  g77(.a(new_n61_), .b(new_n40_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n97_), .d(new_n50_), .O(z8));
endmodule
