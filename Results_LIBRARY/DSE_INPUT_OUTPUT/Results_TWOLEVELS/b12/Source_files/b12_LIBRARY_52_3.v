...
module FAU ( 
  ...
  inv1   g23(.a(x13), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(x10), .c(new_n37_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n47_), .c(x08), .O(new_n50_));
  nand3  g26(.a(new_n46_), .b(x09), .c(new_n26_), .O(new_n51_));
  inv1   g27(.a(new_n51_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n50_), .c(new_n45_), .O(new_n53_));
  nand2  g29(.a(new_n48_), .b(x10), .O(new_n54_));
  oai21  g30(.a(x10), .b(new_n45_), .c(new_n54_), .O(new_n55_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n25_), .c(x02), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n58_), .O(z2));
  inv1   g37(.a(x11), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n45_), .c(x00), .O(new_n63_));
  ...
  nand2  g44(.a(new_n68_), .b(new_n45_), .O(new_n69_));
  nand2  g45(.a(new_n62_), .b(x07), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n25_), .O(z4));
  nor2   g47(.a(x12), .b(x00), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(x13), .c(new_n46_), .d(new_n45_), .O(z5));
  oai21  g49(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n26_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  inv1   g53(.a(x09), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x03), .c(new_n30_), .O(new_n79_));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n27_), .O(new_n81_));
  inv1   g57(.a(x14), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x01), .c(new_n26_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n77_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n46_), .c(new_n45_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n30_), .O(new_n87_));
  inv1   g63(.a(x08), .O(new_n88_));
  nand4  g64(.a(new_n46_), .b(new_n88_), .c(new_n45_), .d(x02), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n87_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n27_), .O(new_n91_));
  oai21  g67(.a(new_n37_), .b(x01), .c(new_n88_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n46_), .d(new_n45_), .O(z7));
  nand4  g69(.a(new_n64_), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n78_), .b(new_n26_), .c(x10), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n95_), .c(new_n45_), .O(z8));
endmodule
