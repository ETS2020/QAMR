...
module FAU ( 
  ...
  oai21  g41(.a(new_n58_), .b(x10), .c(x07), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(z4));
  nand4  g43(.a(x13), .b(new_n60_), .c(new_n49_), .d(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n57_), .O(new_n69_));
  oai21  g45(.a(x10), .b(new_n57_), .c(new_n69_), .O(z5));
  ...
  nand2  g59(.a(new_n83_), .b(new_n36_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand4  g61(.a(new_n49_), .b(new_n73_), .c(new_n57_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  oai21  g64(.a(new_n26_), .b(x01), .c(new_n73_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n49_), .d(new_n57_), .O(z7));
  nand4  g66(.a(new_n60_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nand2  g68(.a(new_n77_), .b(new_n25_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n49_), .d(new_n57_), .O(z8));
endmodule
