...
module FAU ( 
  ...
  nand2  g35(.a(new_n59_), .b(new_n25_), .O(z3));
  nand3  g36(.a(x09), .b(x08), .c(x00), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  nand3  g38(.a(new_n57_), .b(new_n48_), .c(x07), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(z4));
  nor2   g40(.a(x10), .b(x00), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(x13), .c(new_n58_), .d(new_n56_), .O(z5));
  nor2   g42(.a(new_n46_), .b(new_n37_), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x03), .c(new_n27_), .O(new_n69_));
  nor2   g45(.a(x09), .b(new_n26_), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n27_), .c(new_n69_), .d(new_n32_), .O(new_n71_));
  ...
  oai21  g50(.a(new_n71_), .b(new_n67_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n48_), .c(new_n56_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(z6));
  aoi21  g53(.a(new_n46_), .b(x02), .c(x10), .O(new_n78_));
  oai21  g54(.a(new_n26_), .b(x01), .c(new_n46_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n56_), .O(z7));
  aoi21  g57(.a(x12), .b(x09), .c(x07), .O(new_n82_));
  nand3  g58(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n83_));
  oai21  g59(.a(x09), .b(x00), .c(new_n48_), .O(new_n84_));
