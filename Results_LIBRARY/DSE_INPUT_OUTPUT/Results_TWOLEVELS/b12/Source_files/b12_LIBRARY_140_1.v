...
module FAU ( 
  ...
  nand2  g34(.a(x12), .b(new_n27_), .O(new_n59_));
  ...
  aoi21  g43(.a(x12), .b(new_n27_), .c(x07), .O(new_n68_));
  inv1   g44(.a(x09), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n27_), .O(new_n70_));
  nand2  g46(.a(x12), .b(x09), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n46_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n68_), .c(new_n67_), .O(new_n73_));
  ...
  nand3  g55(.a(new_n69_), .b(x03), .c(new_n31_), .O(new_n80_));
  ...
  aoi21  g62(.a(new_n86_), .b(new_n67_), .c(x10), .O(z6));
  ...
  aoi21  g68(.a(new_n90_), .b(new_n88_), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x13), .c(new_n25_), .O(z7));
  inv1   g70(.a(x12), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n96_));
  nand2  g72(.a(new_n70_), .b(new_n46_), .O(new_n97_));
  aoi21  g73(.a(new_n96_), .b(x09), .c(new_n97_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(x13), .c(new_n25_), .O(z8));
endmodule
