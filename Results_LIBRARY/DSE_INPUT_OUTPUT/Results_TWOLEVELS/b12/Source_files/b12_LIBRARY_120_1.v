...
module FAU ( 
  ...
  oai21  g25(.a(new_n49_), .b(x03), .c(new_n33_), .O(new_n50_));
  ...
  oai21  g44(.a(new_n65_), .b(new_n68_), .c(new_n40_), .O(new_n69_));
  inv1   g45(.a(x08), .O(new_n70_));
  nand3  g46(.a(new_n68_), .b(x01), .c(x00), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n57_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  inv1   g49(.a(x09), .O(new_n74_));
  nor2   g50(.a(x10), .b(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n69_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n61_), .b(x07), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(z4));
  nor2   g55(.a(x12), .b(x00), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x07), .c(x13), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n68_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(z5));
  oai21  g59(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n84_));
  nor2   g60(.a(x02), .b(x00), .O(new_n85_));
  nor2   g61(.a(x08), .b(new_n40_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(new_n87_));
  oai21  g63(.a(new_n74_), .b(x03), .c(new_n28_), .O(new_n88_));
  nand2  g64(.a(x08), .b(x00), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n88_), .c(new_n33_), .O(new_n90_));
  inv1   g66(.a(x14), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x01), .c(new_n40_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n90_), .c(new_n87_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n68_), .c(new_n25_), .O(new_n94_));
  inv1   g70(.a(new_n94_), .O(z6));
  nand3  g71(.a(x09), .b(x03), .c(new_n28_), .O(new_n96_));
  nand4  g72(.a(new_n68_), .b(new_n70_), .c(new_n25_), .d(x02), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n33_), .O(new_n99_));
  oai21  g75(.a(new_n27_), .b(x01), .c(new_n70_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n68_), .d(new_n25_), .O(z7));
  nand4  g77(.a(new_n65_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand2  g79(.a(new_n74_), .b(new_n40_), .O(new_n104_));
  nand4  g80(.a(new_n104_), .b(new_n103_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
