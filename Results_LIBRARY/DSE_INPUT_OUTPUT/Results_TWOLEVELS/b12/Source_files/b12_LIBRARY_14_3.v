...
module FAU ( 
  ...
  oai21  g26(.a(new_n50_), .b(x02), .c(new_n46_), .O(new_n51_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  inv1   g34(.a(x12), .O(new_n59_));
  oai21  g35(.a(x07), .b(x00), .c(x11), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n58_), .c(new_n25_), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n56_), .O(new_n64_));
  nand3  g40(.a(new_n57_), .b(new_n48_), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  nor3   g42(.a(x12), .b(x10), .c(x00), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(x13), .c(new_n56_), .O(z5));
  oai21  g44(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n69_));
  nand2  g45(.a(new_n27_), .b(new_n37_), .O(new_n70_));
  ...
  oai21  g51(.a(new_n75_), .b(x03), .c(new_n27_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n46_), .c(new_n32_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x02), .c(new_n37_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n74_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n48_), .c(new_n56_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nor2   g58(.a(x02), .b(x01), .O(new_n83_));
  nor2   g59(.a(new_n75_), .b(new_n26_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x07), .O(new_n85_));
  nand3  g61(.a(x03), .b(new_n27_), .c(new_n32_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n71_), .c(x10), .O(new_n87_));
  oai22  g63(.a(new_n87_), .b(x07), .c(new_n85_), .d(x10), .O(z7));
  nand3  g64(.a(new_n83_), .b(new_n59_), .c(x03), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  nand2  g66(.a(new_n75_), .b(new_n37_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n48_), .d(new_n56_), .O(z8));
endmodule
