...
module FAU ( 
  ...
  nor2   g22(.a(x13), .b(x10), .O(new_n47_));
  ...
  oai21  g26(.a(x13), .b(new_n46_), .c(new_n25_), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n38_), .c(new_n27_), .O(new_n52_));
  ...
  oai22  g35(.a(new_n59_), .b(x00), .c(new_n58_), .d(new_n46_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n26_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n46_), .O(new_n63_));
  nand2  g39(.a(new_n58_), .b(x07), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n63_), .c(new_n26_), .O(z4));
  inv1   g41(.a(x13), .O(new_n67_));
  inv1   g42(.a(x08), .O(new_n68_));
  inv1   g43(.a(x09), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x03), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n31_), .c(new_n27_), .O(new_n71_));
  nand3  g46(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n72_));
  oai21  g47(.a(x02), .b(new_n28_), .c(new_n72_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(new_n74_));
  oai21  g49(.a(new_n69_), .b(x03), .c(new_n31_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n28_), .O(new_n76_));
  oai21  g51(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n31_), .O(new_n78_));
  inv1   g53(.a(x14), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(x02), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(new_n78_), .c(new_n76_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n27_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n74_), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n67_), .c(new_n25_), .d(new_n46_), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n28_), .O(new_n86_));
  nand2  g61(.a(new_n46_), .b(x01), .O(new_n87_));
  nand2  g62(.a(new_n47_), .b(new_n68_), .O(new_n88_));
  oai21  g63(.a(new_n88_), .b(new_n87_), .c(new_n86_), .O(new_n89_));
  nand2  g64(.a(new_n89_), .b(new_n31_), .O(new_n90_));
  nand3  g65(.a(new_n67_), .b(new_n46_), .c(x02), .O(new_n91_));
  nand2  g66(.a(new_n91_), .b(x03), .O(new_n92_));
  nand2  g67(.a(new_n92_), .b(new_n68_), .O(new_n93_));
  nor2   g68(.a(x13), .b(x10), .O(new_n94_));
  nand4  g69(.a(new_n94_), .b(new_n93_), .c(new_n90_), .d(new_n46_), .O(z7));
  nand4  g70(.a(new_n59_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n96_));
  nand2  g71(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g72(.a(new_n69_), .b(new_n27_), .c(x07), .O(new_n98_));
  nand3  g73(.a(new_n98_), .b(new_n97_), .c(new_n94_), .O(z8));
  one    g74(.O(z5));
endmodule
