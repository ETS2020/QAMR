...
module FAU ( 
  ...
  nor2   g55(.a(new_n68_), .b(new_n37_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(x07), .O(new_n81_));
  nand3  g57(.a(x03), .b(new_n30_), .c(new_n27_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n45_), .c(x10), .O(new_n83_));
  oai22  g59(.a(new_n83_), .b(x07), .c(new_n81_), .d(x10), .O(z7));
  aoi21  g60(.a(x12), .b(x09), .c(x07), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n47_), .O(new_n86_));
  aoi21  g62(.a(new_n82_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai22  g63(.a(new_n87_), .b(x07), .c(new_n85_), .d(x10), .O(z8));
endmodule
