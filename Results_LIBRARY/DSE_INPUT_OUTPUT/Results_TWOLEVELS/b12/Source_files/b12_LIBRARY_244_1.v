...
module FAU ( 
  ...
  nand3  g21(.a(new_n36_), .b(new_n34_), .c(x06), .O(new_n46_));
  ...
  aoi21  g42(.a(new_n35_), .b(x00), .c(x05), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n28_), .c(new_n66_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n63_), .c(new_n54_), .O(new_n69_));
  ...
  nand2  g54(.a(new_n28_), .b(x01), .O(new_n79_));
  nand2  g55(.a(x09), .b(new_n33_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n35_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n63_), .c(new_n54_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n77_), .O(z4));
  inv1   g61(.a(x13), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x12), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n35_), .c(new_n54_), .d(new_n40_), .O(z5));
  nand2  g64(.a(new_n64_), .b(x03), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n28_), .c(new_n40_), .O(new_n90_));
  nor2   g66(.a(new_n64_), .b(x03), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n33_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n90_), .c(new_n63_), .O(new_n94_));
  nand2  g70(.a(x14), .b(x02), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x01), .O(new_n96_));
  oai21  g72(.a(new_n91_), .b(x02), .c(new_n33_), .O(new_n97_));
  nand3  g73(.a(new_n64_), .b(x03), .c(new_n28_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n40_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n94_), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n35_), .c(new_n54_), .O(new_n102_));
  inv1   g78(.a(new_n102_), .O(z6));
  nand3  g79(.a(new_n63_), .b(new_n54_), .c(x01), .O(new_n104_));
  nand3  g80(.a(x09), .b(x03), .c(new_n33_), .O(new_n105_));
  aoi21  g81(.a(new_n105_), .b(new_n104_), .c(x02), .O(new_n106_));
  oai21  g82(.a(new_n41_), .b(x02), .c(new_n63_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(new_n54_), .O(new_n108_));
  oai21  g84(.a(new_n108_), .b(new_n106_), .c(new_n35_), .O(new_n109_));
  nand2  g85(.a(new_n109_), .b(new_n57_), .O(z7));
  nand4  g86(.a(new_n71_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n111_));
  oai21  g87(.a(x09), .b(x00), .c(new_n54_), .O(new_n112_));
  aoi21  g88(.a(new_n111_), .b(x09), .c(new_n112_), .O(new_n113_));
  oai21  g89(.a(new_n113_), .b(x10), .c(new_n57_), .O(z8));
endmodule
