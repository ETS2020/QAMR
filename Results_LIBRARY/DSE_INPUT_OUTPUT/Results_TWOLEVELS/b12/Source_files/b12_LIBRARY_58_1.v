...
module FAU ( 
  ...
  nor2   g14(.a(new_n38_), .b(x06), .O(new_n39_));
  nor3   g15(.a(new_n39_), .b(x02), .c(new_n28_), .O(new_n40_));
  nand2  g16(.a(x05), .b(x01), .O(new_n41_));
  nand2  g17(.a(new_n41_), .b(x06), .O(new_n42_));
  nand2  g18(.a(new_n38_), .b(new_n25_), .O(new_n43_));
  aoi21  g19(.a(new_n43_), .b(new_n42_), .c(new_n31_), .O(new_n44_));
  ...
  nor2   g24(.a(new_n39_), .b(new_n31_), .O(new_n49_));
  ...
  oai21  g34(.a(new_n58_), .b(new_n49_), .c(new_n27_), .O(new_n59_));
  inv1   g35(.a(x08), .O(new_n60_));
  nor2   g36(.a(new_n51_), .b(x03), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n56_), .c(new_n28_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n31_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n60_), .c(new_n38_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n59_), .O(z2));
  inv1   g41(.a(x11), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n38_), .c(x00), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(x07), .b(x00), .c(x11), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n67_), .c(new_n26_), .O(z3));
  nand3  g47(.a(x09), .b(x08), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n38_), .O(new_n73_));
  nand3  g49(.a(new_n66_), .b(x07), .c(x06), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n73_), .O(z4));
  nor3   g51(.a(x12), .b(x10), .c(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x13), .c(new_n38_), .O(z5));
  nand2  g53(.a(x08), .b(x00), .O(new_n78_));
  aoi21  g54(.a(x09), .b(new_n50_), .c(x02), .O(new_n79_));
  nand3  g55(.a(new_n55_), .b(x03), .c(new_n31_), .O(new_n80_));
  ...
  nor2   g59(.a(x08), .b(new_n27_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n83_), .c(x01), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n82_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n51_), .c(new_n38_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n26_), .O(z6));
  nand3  g64(.a(x03), .b(new_n31_), .c(new_n28_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n51_), .O(new_n91_));
  aoi21  g67(.a(new_n89_), .b(new_n60_), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x07), .c(new_n52_), .O(z7));
  nand4  g69(.a(new_n68_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n94_));
  oai21  g70(.a(x09), .b(x00), .c(new_n51_), .O(new_n95_));
  aoi21  g71(.a(new_n94_), .b(x09), .c(new_n95_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x07), .c(new_n52_), .O(z8));
endmodule
