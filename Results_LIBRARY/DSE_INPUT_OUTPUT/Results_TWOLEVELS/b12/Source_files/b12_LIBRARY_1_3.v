...
module FAU ( 
  ...
  nand2  g00(.a(x13), .b(x10), .O(new_n25_));
  ...
  nand3  g19(.a(new_n30_), .b(new_n26_), .c(new_n29_), .O(new_n44_));
  ...
  oai21  g30(.a(new_n54_), .b(new_n49_), .c(new_n37_), .O(new_n55_));
  inv1   g31(.a(x08), .O(new_n56_));
  nor2   g32(.a(new_n47_), .b(x03), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n52_), .c(new_n29_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n27_), .O(new_n59_));
  nand3  g35(.a(new_n59_), .b(new_n56_), .c(new_n46_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n55_), .c(new_n25_), .O(z2));
  nand2  g37(.a(x11), .b(x07), .O(new_n62_));
  nand2  g38(.a(x12), .b(new_n37_), .O(new_n63_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n25_), .O(z4));
  oai22  g46(.a(x13), .b(x12), .c(x10), .d(new_n37_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n46_), .O(new_n72_));
  inv1   g48(.a(x12), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n46_), .c(x10), .O(new_n74_));
  nor2   g50(.a(x13), .b(new_n47_), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n72_), .O(z5));
  nand2  g53(.a(new_n51_), .b(x03), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n27_), .c(new_n37_), .O(new_n79_));
  nand3  g55(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n28_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n79_), .c(new_n56_), .O(new_n82_));
  nand2  g58(.a(x14), .b(x02), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(x01), .O(new_n84_));
  oai21  g60(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n29_), .O(new_n86_));
  nand3  g62(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n37_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n82_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n47_), .c(new_n46_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  nand3  g68(.a(x09), .b(x03), .c(new_n29_), .O(new_n93_));
  nand4  g69(.a(new_n47_), .b(new_n56_), .c(new_n46_), .d(x01), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n27_), .O(new_n96_));
  oai21  g72(.a(x07), .b(new_n27_), .c(x03), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n56_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n96_), .c(new_n47_), .d(new_n46_), .O(z7));
  nand3  g75(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n73_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand2  g79(.a(new_n51_), .b(new_n37_), .O(new_n104_));
  nand4  g80(.a(new_n104_), .b(new_n103_), .c(new_n47_), .d(new_n46_), .O(z8));
endmodule
