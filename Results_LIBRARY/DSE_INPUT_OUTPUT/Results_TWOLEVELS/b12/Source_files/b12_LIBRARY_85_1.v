...
module FAU ( 
  ...
  nand4  g48(.a(new_n72_), .b(new_n57_), .c(new_n25_), .d(new_n27_), .O(z5));
  oai21  g49(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n27_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  inv1   g53(.a(x09), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x03), .c(new_n31_), .O(new_n79_));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n28_), .O(new_n81_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n57_), .c(new_n25_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(new_n66_), .b(new_n25_), .c(x02), .O(new_n87_));
  ...
  oai21  g69(.a(new_n38_), .b(x02), .c(new_n25_), .O(new_n94_));
  nor2   g70(.a(x12), .b(x01), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(new_n78_), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(new_n57_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n25_), .O(z8));
endmodule
