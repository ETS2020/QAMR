...
module FAU ( 
  ...
  oai22  g40(.a(new_n64_), .b(x00), .c(new_n63_), .d(new_n50_), .O(new_n65_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n36_), .O(z4));
  nor3   g46(.a(x12), .b(x07), .c(x00), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x10), .c(x13), .O(z5));
  ...
  oai21  g52(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n77_));
  ...
  nand3  g61(.a(new_n85_), .b(new_n50_), .c(x02), .O(new_n86_));
  nand3  g62(.a(x09), .b(x03), .c(new_n27_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(x01), .O(new_n88_));
  oai21  g64(.a(new_n26_), .b(x01), .c(new_n85_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n57_), .O(new_n91_));
  oai21  g67(.a(x13), .b(new_n57_), .c(new_n91_), .O(z7));
  nand4  g68(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n51_), .b(new_n25_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n57_), .d(new_n50_), .O(z8));
endmodule
