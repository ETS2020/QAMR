...
module FAU ( 
  ...
  oai21  g36(.a(x09), .b(x01), .c(new_n52_), .O(new_n61_));
  nand4  g37(.a(new_n61_), .b(new_n47_), .c(x09), .d(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n25_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n59_), .O(z4));
  nor2   g40(.a(x12), .b(x00), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(x07), .c(x13), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n47_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n25_), .O(z5));
  nor2   g44(.a(new_n52_), .b(new_n27_), .O(new_n69_));
  oai21  g45(.a(new_n53_), .b(x03), .c(new_n31_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n28_), .O(new_n71_));
  nand3  g47(.a(new_n53_), .b(x03), .c(new_n31_), .O(new_n72_));
  ...
  nand2  g51(.a(new_n52_), .b(x00), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(new_n28_), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n73_), .c(new_n47_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n31_), .O(new_n80_));
  nand2  g56(.a(new_n25_), .b(x02), .O(new_n81_));
  nand2  g57(.a(new_n47_), .b(new_n52_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n28_), .O(new_n84_));
  aoi21  g60(.a(new_n52_), .b(x01), .c(x10), .O(new_n85_));
  nand2  g61(.a(new_n52_), .b(new_n38_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n25_), .O(z7));
  inv1   g63(.a(x12), .O(new_n88_));
  nand4  g64(.a(new_n81_), .b(new_n88_), .c(x03), .d(new_n28_), .O(new_n89_));
  nor2   g65(.a(x09), .b(x00), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x10), .c(new_n25_), .O(z8));
endmodule
