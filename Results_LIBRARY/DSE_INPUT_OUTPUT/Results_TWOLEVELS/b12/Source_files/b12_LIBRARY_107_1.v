...
module FAU ( 
  ...
  oai21  g30(.a(new_n47_), .b(x01), .c(new_n31_), .O(new_n55_));
  nand4  g31(.a(new_n55_), .b(new_n54_), .c(new_n53_), .d(new_n25_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n52_), .O(z2));
  nand2  g33(.a(new_n54_), .b(new_n25_), .O(new_n58_));
  inv1   g34(.a(x11), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(x07), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(new_n58_), .c(x12), .d(new_n27_), .O(z3));
  oai21  g37(.a(x12), .b(new_n54_), .c(new_n27_), .O(new_n62_));
  nand2  g38(.a(new_n47_), .b(new_n28_), .O(new_n63_));
  nand3  g39(.a(new_n63_), .b(new_n54_), .c(new_n53_), .O(new_n64_));
  nand3  g40(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n25_), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n60_), .O(z4));
  inv1   g43(.a(x13), .O(new_n68_));
  aoi21  g44(.a(new_n25_), .b(x00), .c(new_n68_), .O(new_n69_));
  nand2  g45(.a(x12), .b(new_n27_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n69_), .c(new_n54_), .d(new_n25_), .O(z5));
  nand2  g47(.a(x09), .b(new_n38_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n31_), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n54_), .b(x02), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n72_), .c(x08), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n73_), .c(new_n28_), .O(new_n76_));
  aoi21  g52(.a(new_n47_), .b(x03), .c(x01), .O(new_n77_));
  nand3  g53(.a(new_n47_), .b(new_n53_), .c(x03), .O(new_n78_));
  oai21  g54(.a(new_n77_), .b(x00), .c(new_n78_), .O(new_n79_));
  nor2   g55(.a(x14), .b(x00), .O(new_n80_));
  aoi21  g56(.a(new_n53_), .b(x00), .c(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n28_), .c(new_n54_), .O(new_n82_));
  aoi21  g58(.a(new_n79_), .b(new_n31_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g63(.a(new_n25_), .b(x01), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(x03), .c(x08), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n87_), .c(new_n54_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n25_), .O(z7));
  inv1   g67(.a(x12), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n93_));
