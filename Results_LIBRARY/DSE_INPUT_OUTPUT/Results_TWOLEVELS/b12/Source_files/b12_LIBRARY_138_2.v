...
module FAU ( 
  ...
  oai21  g43(.a(new_n65_), .b(new_n53_), .c(x07), .O(new_n68_));
  ...
  nand3  g49(.a(new_n73_), .b(x13), .c(new_n72_), .O(z5));
  ...
  oai21  g54(.a(new_n57_), .b(new_n25_), .c(new_n78_), .O(new_n79_));
  nand2  g55(.a(x14), .b(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  oai21  g57(.a(x08), .b(new_n25_), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g61(.a(new_n53_), .b(new_n57_), .c(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  nand2  g64(.a(x03), .b(new_n29_), .O(new_n89_));
  nand2  g65(.a(new_n53_), .b(new_n36_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(new_n57_), .c(new_n90_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n88_), .O(z7));
  nand4  g68(.a(new_n72_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n93_));
