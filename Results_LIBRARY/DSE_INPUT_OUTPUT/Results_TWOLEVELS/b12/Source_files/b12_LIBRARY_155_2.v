...
module FAU ( 
  ...
  nand2  g24(.a(x12), .b(x10), .O(new_n49_));
  ...
  nand2  g38(.a(x12), .b(x00), .O(new_n63_));
  nand2  g39(.a(new_n25_), .b(new_n51_), .O(new_n64_));
  aoi22  g40(.a(new_n64_), .b(new_n63_), .c(x11), .d(x07), .O(z3));
  ...
  nand4  g48(.a(new_n72_), .b(new_n26_), .c(new_n55_), .d(new_n38_), .O(z5));
  oai21  g49(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n74_));
  nor2   g50(.a(x02), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n38_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  oai21  g53(.a(new_n48_), .b(x03), .c(new_n28_), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n33_), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n38_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n77_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n51_), .c(new_n55_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(new_n51_), .b(new_n55_), .c(x02), .O(new_n86_));
  ...
  nor2   g65(.a(new_n48_), .b(new_n27_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x10), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n88_), .c(new_n55_), .O(z7));
  nand3  g68(.a(new_n89_), .b(new_n25_), .c(x03), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n48_), .b(new_n38_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n55_), .O(z8));
endmodule
