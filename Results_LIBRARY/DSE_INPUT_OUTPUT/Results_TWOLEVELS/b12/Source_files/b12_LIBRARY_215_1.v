...
module FAU ( 
  ...
  oai21  g26(.a(x05), .b(new_n28_), .c(new_n27_), .O(new_n51_));
  ...
  nand3  g32(.a(new_n56_), .b(x09), .c(new_n25_), .O(new_n57_));
  aoi21  g33(.a(new_n57_), .b(new_n55_), .c(x01), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n54_), .c(new_n50_), .O(new_n59_));
  nand3  g35(.a(new_n56_), .b(x09), .c(new_n27_), .O(new_n60_));
  aoi21  g36(.a(new_n60_), .b(new_n37_), .c(x08), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(x10), .c(new_n25_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n59_), .O(z2));
  nand2  g39(.a(new_n56_), .b(new_n25_), .O(new_n64_));
  ...
  oai21  g45(.a(new_n34_), .b(new_n37_), .c(new_n27_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n50_), .O(new_n71_));
  inv1   g47(.a(x09), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n27_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(x00), .c(new_n72_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n71_), .c(new_n69_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n56_), .c(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n66_), .O(z4));
  aoi21  g53(.a(x13), .b(new_n50_), .c(x07), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x12), .c(new_n56_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(z5));
  nand2  g56(.a(new_n37_), .b(new_n50_), .O(new_n81_));
  oai21  g57(.a(x08), .b(new_n50_), .c(new_n81_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n56_), .c(x01), .O(new_n83_));
  aoi21  g59(.a(x09), .b(new_n38_), .c(x02), .O(new_n84_));
  nand3  g60(.a(new_n72_), .b(x03), .c(new_n37_), .O(new_n85_));
  oai21  g61(.a(new_n84_), .b(x01), .c(new_n85_), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x02), .c(new_n50_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n56_), .O(new_n89_));
  aoi21  g65(.a(new_n86_), .b(new_n68_), .c(new_n89_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n83_), .c(x07), .O(z6));
  inv1   g67(.a(x08), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(x02), .c(x10), .O(new_n93_));
  oai21  g69(.a(new_n38_), .b(x01), .c(new_n92_), .O(new_n94_));
  nand4  g70(.a(x09), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n25_), .O(z7));
  inv1   g72(.a(x12), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n98_));
  nor2   g74(.a(x09), .b(x00), .O(new_n99_));
  aoi21  g75(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(x10), .c(new_n25_), .O(z8));
endmodule
