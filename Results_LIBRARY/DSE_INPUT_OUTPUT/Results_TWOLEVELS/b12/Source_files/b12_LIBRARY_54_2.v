...
module FAU ( 
  ...
  nand3  g48(.a(new_n65_), .b(x10), .c(x07), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z4));
  nand3  g50(.a(x13), .b(new_n67_), .c(new_n38_), .O(new_n75_));
  ...
  aoi22  g58(.a(new_n82_), .b(new_n28_), .c(x08), .d(x00), .O(new_n83_));
  inv1   g59(.a(x14), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x01), .c(new_n38_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n64_), .O(new_n86_));
  aoi21  g62(.a(new_n83_), .b(new_n30_), .c(new_n86_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n81_), .c(x10), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n28_), .O(new_n89_));
  nand3  g65(.a(new_n25_), .b(new_n56_), .c(x02), .O(new_n90_));
  ...
  nand2  g69(.a(new_n25_), .b(new_n64_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(new_n56_), .c(new_n94_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n92_), .O(z7));
  nand4  g72(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g74(.a(new_n53_), .b(new_n38_), .c(new_n94_), .O(new_n99_));
