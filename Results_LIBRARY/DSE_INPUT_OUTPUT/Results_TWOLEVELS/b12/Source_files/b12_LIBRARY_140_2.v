...
module FAU ( 
  ...
  aoi22  g41(.a(new_n65_), .b(x00), .c(new_n64_), .d(new_n63_), .O(new_n66_));
  nand2  g42(.a(new_n25_), .b(x10), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n64_), .c(new_n54_), .O(new_n68_));
  oai21  g44(.a(new_n66_), .b(new_n62_), .c(new_n68_), .O(z3));
  nand3  g45(.a(x09), .b(x08), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand2  g47(.a(new_n63_), .b(x07), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n26_), .O(z4));
  nand4  g49(.a(x13), .b(new_n64_), .c(new_n54_), .d(new_n27_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n50_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n48_), .O(z5));
  oai21  g52(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n77_));
  nor2   g53(.a(x02), .b(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n27_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  oai21  g56(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n81_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n50_), .c(new_n54_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n26_), .O(z6));
  nand2  g64(.a(new_n54_), .b(x02), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x03), .c(new_n28_), .O(new_n90_));
  nand4  g66(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n54_), .O(new_n92_));
  aoi21  g68(.a(new_n90_), .b(new_n46_), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x10), .c(new_n48_), .O(z7));
  nand4  g70(.a(new_n64_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n54_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x10), .c(new_n48_), .O(z8));
endmodule
