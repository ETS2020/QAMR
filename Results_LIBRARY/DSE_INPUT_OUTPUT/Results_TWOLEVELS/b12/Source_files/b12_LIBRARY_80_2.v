...
module FAU ( 
  ...
  oai21  g33(.a(new_n57_), .b(new_n46_), .c(x00), .O(new_n58_));
  ...
  oai21  g40(.a(new_n57_), .b(new_n25_), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  nand3  g42(.a(x13), .b(new_n59_), .c(new_n27_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n46_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n25_), .O(z5));
  inv1   g45(.a(x09), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x03), .c(new_n31_), .O(new_n71_));
  nand2  g47(.a(new_n28_), .b(new_n27_), .O(new_n72_));
  ...
  nand2  g52(.a(new_n31_), .b(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n70_), .c(x03), .O(new_n79_));
  aoi21  g55(.a(x14), .b(x02), .c(x00), .O(new_n80_));
  nor3   g56(.a(x08), .b(x07), .c(x02), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n79_), .c(new_n76_), .d(new_n46_), .O(new_n83_));
  and2   g59(.a(new_n83_), .b(new_n25_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n28_), .O(new_n85_));
  nand3  g61(.a(new_n25_), .b(new_n73_), .c(x01), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x02), .O(new_n87_));
  aoi21  g63(.a(x03), .b(new_n31_), .c(x08), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(new_n46_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n25_), .O(z7));
  nand4  g66(.a(new_n59_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nand2  g68(.a(new_n70_), .b(new_n27_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n25_), .d(new_n46_), .O(z8));
endmodule
