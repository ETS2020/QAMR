...
module FAU ( 
  ...
  aoi22  g53(.a(new_n77_), .b(new_n36_), .c(new_n75_), .d(x06), .O(new_n78_));
  ...
  nand2  g57(.a(x10), .b(x06), .O(new_n82_));
  ...
  nand3  g71(.a(new_n95_), .b(new_n52_), .c(x02), .O(new_n96_));
  nand3  g72(.a(x09), .b(x03), .c(new_n27_), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(x01), .O(new_n98_));
  aoi21  g74(.a(new_n52_), .b(x01), .c(new_n26_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x08), .c(new_n52_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n98_), .c(new_n36_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n82_), .O(z7));
  nand4  g78(.a(new_n68_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  nand2  g80(.a(new_n53_), .b(new_n25_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n36_), .d(new_n52_), .O(z8));
endmodule
