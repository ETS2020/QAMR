...
module FAU ( 
  ...
  nand4  g47(.a(new_n71_), .b(x13), .c(new_n53_), .d(new_n36_), .O(z5));
  ...
  nand3  g59(.a(new_n83_), .b(new_n53_), .c(new_n36_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n27_), .O(new_n86_));
  nand2  g62(.a(new_n53_), .b(new_n57_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n61_), .c(new_n86_), .O(new_n88_));
  ...
  nand4  g70(.a(new_n94_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  aoi21  g72(.a(new_n77_), .b(new_n25_), .c(new_n91_), .O(new_n97_));
