...
module FAU ( 
  ...
  nand4  g51(.a(new_n75_), .b(new_n67_), .c(new_n36_), .d(new_n25_), .O(z5));
  nor2   g52(.a(new_n58_), .b(new_n25_), .O(new_n77_));
  ...
  oai21  g62(.a(new_n86_), .b(new_n82_), .c(new_n37_), .O(new_n87_));
