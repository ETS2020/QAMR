...
module FAU ( 
  ...
  oai21  g38(.a(new_n58_), .b(new_n36_), .c(x07), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n62_), .O(z4));
  inv1   g40(.a(x13), .O(new_n65_));
  aoi21  g41(.a(x12), .b(new_n25_), .c(new_n65_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n36_), .c(new_n48_), .d(new_n25_), .O(z5));
  nor2   g43(.a(new_n55_), .b(new_n25_), .O(new_n68_));
  ...
  oai21  g53(.a(new_n77_), .b(new_n73_), .c(new_n36_), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x07), .O(z6));
  nand3  g55(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  nor2   g57(.a(new_n69_), .b(new_n26_), .O(new_n82_));
  aoi22  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n55_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x07), .c(new_n36_), .O(z7));
