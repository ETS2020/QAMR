...
module FAU ( 
  ...
  aoi22  g44(.a(new_n68_), .b(new_n52_), .c(x12), .d(new_n48_), .O(z3));
  ...
  nor2   g49(.a(x08), .b(new_n27_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(x00), .c(new_n63_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n51_), .c(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n68_), .O(z4));
  inv1   g54(.a(x13), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n51_), .c(x12), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n51_), .c(new_n25_), .d(new_n48_), .O(z5));
  oai22  g57(.a(x10), .b(new_n27_), .c(x09), .d(new_n57_), .O(new_n82_));
  nand2  g58(.a(new_n37_), .b(new_n48_), .O(new_n83_));
  oai21  g59(.a(x08), .b(new_n48_), .c(new_n83_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g61(.a(x09), .b(new_n57_), .O(new_n86_));
  nand2  g62(.a(new_n51_), .b(x02), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(x00), .O(new_n88_));
  aoi21  g64(.a(new_n86_), .b(new_n37_), .c(x08), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(new_n27_), .O(new_n90_));
  nor2   g66(.a(x14), .b(new_n37_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n48_), .c(x10), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n90_), .c(new_n85_), .O(new_n93_));
  and2   g69(.a(new_n93_), .b(new_n25_), .O(z6));
  aoi21  g70(.a(new_n62_), .b(x02), .c(x10), .O(new_n95_));
  oai21  g71(.a(new_n57_), .b(x01), .c(new_n62_), .O(new_n96_));
  nand4  g72(.a(x09), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n25_), .O(z7));
  inv1   g74(.a(x12), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(x03), .c(new_n37_), .d(new_n27_), .O(new_n100_));
