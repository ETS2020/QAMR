...
module FAU ( 
  ...
  oai21  g37(.a(new_n58_), .b(new_n36_), .c(x07), .O(new_n62_));
  ...
  nand4  g43(.a(new_n67_), .b(new_n36_), .c(new_n48_), .d(new_n25_), .O(z5));
  ...
  aoi21  g48(.a(x09), .b(new_n26_), .c(x02), .O(new_n73_));
  inv1   g49(.a(x09), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(x03), .c(new_n27_), .O(new_n75_));
  oai21  g51(.a(new_n73_), .b(x01), .c(new_n75_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n72_), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x02), .c(new_n25_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n71_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n36_), .c(new_n48_), .O(new_n81_));
  inv1   g57(.a(new_n81_), .O(z6));
  nand3  g58(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x01), .O(new_n84_));
  nor2   g60(.a(new_n74_), .b(new_n26_), .O(new_n85_));
  aoi22  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n55_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n36_), .O(z7));
  nand3  g63(.a(new_n84_), .b(new_n59_), .c(x03), .O(new_n88_));
  nor2   g64(.a(x09), .b(x00), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(x09), .c(new_n89_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n36_), .O(z8));
endmodule
