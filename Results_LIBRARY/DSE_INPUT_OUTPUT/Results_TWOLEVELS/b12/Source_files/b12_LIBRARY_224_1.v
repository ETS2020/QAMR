...
module FAU ( 
  ...
  nand2  g46(.a(x12), .b(new_n40_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n29_), .O(new_n72_));
  inv1   g48(.a(new_n72_), .O(z3));
  nand3  g49(.a(x09), .b(x08), .c(x00), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n58_), .O(new_n75_));
  inv1   g51(.a(x11), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x07), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n29_), .O(z4));
  inv1   g54(.a(x12), .O(new_n79_));
  nor2   g55(.a(x07), .b(x00), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x13), .c(new_n79_), .d(new_n35_), .O(z5));
  ...
  nand4  g77(.a(new_n79_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n102_));
