...
module FAU ( 
  ...
  oai21  g35(.a(new_n56_), .b(new_n25_), .c(x07), .O(new_n60_));
  ...
  nand4  g41(.a(new_n65_), .b(new_n25_), .c(new_n46_), .d(new_n27_), .O(z5));
