...
module FAU ( 
  ...
  nand3  g41(.a(new_n65_), .b(new_n64_), .c(new_n37_), .O(new_n66_));
  inv1   g42(.a(new_n66_), .O(z3));
  aoi21  g43(.a(x09), .b(x00), .c(x07), .O(new_n68_));
  nor2   g44(.a(x11), .b(new_n51_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n37_), .O(new_n70_));
  ...
  nand3  g64(.a(new_n88_), .b(new_n58_), .c(new_n51_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n37_), .O(z6));
  nand3  g66(.a(new_n71_), .b(new_n51_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n27_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  oai21  g69(.a(new_n26_), .b(x01), .c(new_n71_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n51_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(new_n58_), .O(new_n96_));
  nand2  g72(.a(x10), .b(x05), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n96_), .O(z7));
  nand2  g74(.a(new_n51_), .b(new_n26_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n77_), .c(new_n27_), .d(new_n29_), .O(new_n100_));
  oai21  g76(.a(x09), .b(x00), .c(new_n51_), .O(new_n101_));
  aoi21  g77(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(x10), .c(new_n97_), .O(z8));
endmodule
