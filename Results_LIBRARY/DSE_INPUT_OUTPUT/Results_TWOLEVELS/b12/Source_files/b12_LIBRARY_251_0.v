...
module FAU ( 
  ...
  nand3  g26(.a(x13), .b(new_n36_), .c(x09), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n49_), .O(new_n53_));
  nand4  g29(.a(x13), .b(new_n36_), .c(x09), .d(new_n25_), .O(new_n54_));
  ...
  nand3  g35(.a(new_n59_), .b(new_n38_), .c(x02), .O(new_n60_));
  ...
  nand2  g40(.a(new_n64_), .b(new_n38_), .O(z3));
  aoi21  g41(.a(x09), .b(x00), .c(x07), .O(new_n66_));
  inv1   g42(.a(x07), .O(new_n67_));
  nor2   g43(.a(x11), .b(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n66_), .c(new_n38_), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n29_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n28_), .c(x10), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x02), .c(x13), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n49_), .c(new_n67_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n69_), .O(z4));
  nor3   g51(.a(x12), .b(x07), .c(x00), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n37_), .c(new_n36_), .O(z5));
  inv1   g53(.a(x09), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(x03), .c(new_n27_), .O(new_n79_));
  nand2  g55(.a(new_n49_), .b(x00), .O(new_n80_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n78_), .c(x03), .O(new_n85_));
  aoi21  g61(.a(x14), .b(x02), .c(x00), .O(new_n86_));
  nand3  g62(.a(x13), .b(new_n49_), .c(new_n27_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n86_), .c(x01), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n85_), .c(new_n82_), .O(new_n90_));
  ...
  nand4  g69(.a(new_n36_), .b(new_n49_), .c(new_n67_), .d(x01), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(x02), .O(new_n95_));
  aoi21  g71(.a(new_n67_), .b(x02), .c(new_n26_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x08), .c(new_n67_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(x13), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n36_), .O(z7));
  aoi21  g75(.a(new_n78_), .b(new_n25_), .c(x07), .O(new_n100_));
  nand4  g76(.a(new_n62_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n100_), .c(x13), .d(new_n36_), .O(z8));
endmodule
