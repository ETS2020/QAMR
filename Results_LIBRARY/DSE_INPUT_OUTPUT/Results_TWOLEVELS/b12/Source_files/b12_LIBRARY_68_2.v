...
module FAU ( 
  ...
  nand2  g29(.a(x12), .b(x10), .O(new_n54_));
  ...
  nand2  g34(.a(new_n25_), .b(x07), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n28_), .c(new_n39_), .O(new_n61_));
  oai21  g37(.a(new_n58_), .b(x07), .c(new_n61_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n31_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n52_), .O(z2));
  nand2  g40(.a(x12), .b(x00), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n25_), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(new_n65_), .c(x11), .d(x07), .O(z3));
  ...
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n27_), .O(z4));
  inv1   g49(.a(x13), .O(new_n74_));
  nor2   g50(.a(new_n74_), .b(x12), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(new_n59_), .c(new_n27_), .d(new_n39_), .O(z5));
  ...
  oai21  g72(.a(new_n96_), .b(x10), .c(new_n93_), .O(z8));
endmodule
