...
module FAU ( 
  ...
  oai21  g44(.a(new_n64_), .b(new_n25_), .c(x07), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n68_), .O(z4));
  inv1   g46(.a(x13), .O(new_n71_));
  aoi21  g47(.a(x12), .b(new_n38_), .c(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n25_), .c(new_n55_), .d(new_n38_), .O(z5));
  inv1   g49(.a(x08), .O(new_n74_));
  nor2   g50(.a(new_n74_), .b(new_n38_), .O(new_n75_));
  oai21  g51(.a(new_n49_), .b(x03), .c(new_n28_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n33_), .O(new_n77_));
  nand3  g53(.a(new_n49_), .b(x03), .c(new_n28_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(new_n79_));
  nand2  g55(.a(x14), .b(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n38_), .O(new_n81_));
  nand2  g57(.a(new_n74_), .b(x00), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(new_n33_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n79_), .c(new_n25_), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(x07), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n28_), .O(new_n86_));
  nand4  g62(.a(new_n25_), .b(new_n74_), .c(new_n55_), .d(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n33_), .O(new_n89_));
  oai21  g65(.a(new_n27_), .b(x01), .c(new_n74_), .O(new_n90_));
