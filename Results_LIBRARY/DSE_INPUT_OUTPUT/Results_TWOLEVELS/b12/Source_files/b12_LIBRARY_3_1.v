...
module FAU ( 
  ...
  nand3  g55(.a(new_n52_), .b(new_n25_), .c(x02), .O(new_n80_));
  nand3  g56(.a(x09), .b(x03), .c(new_n31_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(x01), .O(new_n82_));
  nand2  g58(.a(new_n25_), .b(x01), .O(new_n83_));
  ...
  aoi21  g62(.a(new_n25_), .b(x02), .c(x12), .O(new_n87_));
  ...
  oai21  g66(.a(new_n90_), .b(x10), .c(new_n25_), .O(z8));
endmodule
