...
module FAU ( 
  ...
  nand4  g45(.a(new_n69_), .b(x13), .c(new_n36_), .d(new_n48_), .O(z5));
  ...
  nand3  g59(.a(new_n83_), .b(new_n36_), .c(new_n48_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand2  g61(.a(new_n48_), .b(x02), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(x03), .c(new_n29_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n73_), .O(new_n88_));
  nor2   g64(.a(x02), .b(x01), .O(new_n89_));
  nor2   g65(.a(new_n77_), .b(new_n26_), .O(new_n90_));
  nand2  g66(.a(new_n36_), .b(new_n48_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(new_n89_), .c(new_n91_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n88_), .O(z7));
  nand3  g69(.a(new_n89_), .b(new_n61_), .c(x03), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n77_), .b(new_n25_), .c(new_n91_), .O(new_n96_));
