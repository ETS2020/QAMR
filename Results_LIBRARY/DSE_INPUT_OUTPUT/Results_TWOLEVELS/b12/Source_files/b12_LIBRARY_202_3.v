...
module FAU ( 
  ...
  nand2  g11(.a(x13), .b(x11), .O(new_n36_));
  ...
  nand3  g24(.a(new_n36_), .b(new_n48_), .c(new_n47_), .O(new_n49_));
  oai21  g25(.a(x04), .b(new_n26_), .c(new_n49_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n29_), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(new_n46_), .c(new_n44_), .O(new_n52_));
  nand2  g28(.a(new_n48_), .b(new_n47_), .O(new_n53_));
  ...
  inv1   g35(.a(new_n36_), .O(new_n60_));
  ...
  aoi21  g39(.a(new_n63_), .b(new_n47_), .c(new_n60_), .O(new_n64_));
  oai21  g40(.a(new_n59_), .b(x00), .c(new_n64_), .O(z2));
  inv1   g41(.a(x11), .O(new_n66_));
  inv1   g42(.a(x13), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n47_), .c(new_n66_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n36_), .O(z4));
  inv1   g49(.a(new_n68_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(x00), .O(new_n75_));
  nand2  g51(.a(new_n36_), .b(x07), .O(new_n76_));
  oai21  g52(.a(x12), .b(x10), .c(new_n66_), .O(new_n77_));
  nor2   g53(.a(x09), .b(x00), .O(new_n78_));
  nand2  g54(.a(x12), .b(x09), .O(new_n79_));
  oai21  g55(.a(x12), .b(x07), .c(new_n79_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n67_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n77_), .c(new_n76_), .d(new_n75_), .O(z5));
  nand2  g58(.a(new_n27_), .b(new_n25_), .O(new_n83_));
  inv1   g59(.a(x08), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x00), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n83_), .c(new_n29_), .O(new_n86_));
  nand2  g62(.a(x08), .b(x00), .O(new_n87_));
  aoi21  g63(.a(x09), .b(new_n26_), .c(x02), .O(new_n88_));
  nand3  g64(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n89_));
  oai21  g65(.a(new_n88_), .b(x01), .c(new_n89_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n87_), .c(new_n86_), .O(new_n91_));
  inv1   g67(.a(x14), .O(new_n92_));
  oai22  g68(.a(x13), .b(new_n27_), .c(x11), .d(new_n29_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n25_), .O(new_n94_));
  oai21  g70(.a(new_n91_), .b(new_n60_), .c(new_n94_), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n48_), .c(new_n47_), .O(new_n96_));
  inv1   g72(.a(new_n96_), .O(z6));
  nand3  g73(.a(x09), .b(x03), .c(new_n27_), .O(new_n98_));
  nand4  g74(.a(new_n48_), .b(new_n84_), .c(new_n47_), .d(x02), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n29_), .O(new_n101_));
  nand2  g77(.a(x03), .b(new_n29_), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(new_n84_), .c(new_n53_), .O(new_n103_));
  aoi21  g79(.a(new_n103_), .b(new_n101_), .c(new_n60_), .O(z7));
  inv1   g80(.a(x12), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(x09), .O(new_n107_));
  nor3   g83(.a(new_n78_), .b(x10), .c(x07), .O(new_n108_));
  aoi21  g84(.a(new_n108_), .b(new_n107_), .c(new_n60_), .O(z8));
endmodule
