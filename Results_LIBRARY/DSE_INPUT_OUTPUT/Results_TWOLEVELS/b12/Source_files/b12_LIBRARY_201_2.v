...
module FAU ( 
  ...
  nand3  g45(.a(x13), .b(new_n62_), .c(new_n38_), .O(new_n70_));
  ...
  nand3  g59(.a(new_n83_), .b(new_n25_), .c(new_n45_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n28_), .O(new_n86_));
  nand4  g62(.a(new_n25_), .b(new_n47_), .c(new_n45_), .d(x02), .O(new_n87_));
  ...
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n25_), .d(new_n45_), .O(z7));
  nand4  g67(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n92_));
