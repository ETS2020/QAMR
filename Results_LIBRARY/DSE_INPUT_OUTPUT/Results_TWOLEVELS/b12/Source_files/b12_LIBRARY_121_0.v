...
module FAU ( 
  ...
  oai21  g32(.a(x10), .b(x07), .c(new_n29_), .O(new_n57_));
  ...
  nor2   g38(.a(new_n26_), .b(x03), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n59_), .c(new_n34_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n41_), .c(x08), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n54_), .c(new_n30_), .O(new_n66_));
  oai21  g42(.a(new_n62_), .b(x00), .c(new_n66_), .O(z2));
  inv1   g43(.a(x11), .O(new_n68_));
  inv1   g44(.a(x00), .O(new_n69_));
  aoi21  g45(.a(x12), .b(new_n69_), .c(new_n30_), .O(new_n70_));
  ...
  aoi21  g50(.a(new_n68_), .b(x07), .c(new_n30_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z4));
  nor2   g52(.a(x07), .b(x00), .O(new_n77_));
  inv1   g53(.a(x13), .O(new_n78_));
  nor2   g54(.a(new_n78_), .b(x12), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n77_), .c(new_n26_), .d(x05), .O(z5));
  oai21  g56(.a(x09), .b(new_n29_), .c(new_n34_), .O(new_n81_));
  nor2   g57(.a(x02), .b(x00), .O(new_n82_));
  nor2   g58(.a(x08), .b(new_n69_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  oai21  g60(.a(new_n58_), .b(x03), .c(new_n41_), .O(new_n85_));
  nand2  g61(.a(x08), .b(x00), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n34_), .O(new_n87_));
  ...
  nand4  g66(.a(new_n90_), .b(new_n26_), .c(new_n54_), .d(x05), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  nand3  g68(.a(x09), .b(x03), .c(new_n41_), .O(new_n93_));
  inv1   g69(.a(x08), .O(new_n94_));
  nand4  g70(.a(new_n26_), .b(new_n94_), .c(new_n54_), .d(x02), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n93_), .c(x01), .O(new_n96_));
  oai21  g72(.a(new_n29_), .b(x01), .c(new_n94_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n54_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n96_), .c(x05), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n26_), .O(z7));
  inv1   g76(.a(x12), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(x03), .c(new_n41_), .d(new_n34_), .O(new_n102_));
