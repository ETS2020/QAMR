...
module FAU ( 
  ...
  oai21  g52(.a(x10), .b(new_n51_), .c(new_n76_), .O(z5));
  nor2   g53(.a(new_n59_), .b(new_n26_), .O(new_n78_));
  ...
  oai21  g63(.a(new_n87_), .b(new_n83_), .c(new_n52_), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(x07), .O(z6));
  nand3  g65(.a(new_n59_), .b(new_n51_), .c(x02), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n31_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x07), .c(new_n52_), .O(new_n93_));
  oai21  g69(.a(new_n49_), .b(x08), .c(new_n52_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n51_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n93_), .O(z7));
  aoi21  g72(.a(x12), .b(x09), .c(x07), .O(new_n97_));
  nand3  g73(.a(x03), .b(new_n31_), .c(new_n27_), .O(new_n98_));
  oai21  g74(.a(x09), .b(x00), .c(new_n52_), .O(new_n99_));
