...
module FAU ( 
  ...
  nand3  g39(.a(new_n58_), .b(new_n49_), .c(x07), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n63_), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  nor2   g42(.a(new_n66_), .b(x10), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n59_), .c(new_n57_), .d(new_n25_), .O(z5));
  nor2   g44(.a(new_n47_), .b(new_n25_), .O(new_n69_));
  inv1   g45(.a(x09), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x03), .c(new_n27_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n29_), .O(new_n72_));
  nand3  g48(.a(new_n70_), .b(x03), .c(new_n27_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n72_), .c(new_n69_), .O(new_n74_));
  nand2  g50(.a(x14), .b(x02), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n47_), .b(x00), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n29_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n74_), .c(new_n49_), .O(new_n79_));
  nor2   g55(.a(new_n79_), .b(x07), .O(z6));
  nor2   g56(.a(x02), .b(x01), .O(new_n81_));
  nor2   g57(.a(new_n70_), .b(new_n26_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(x07), .O(new_n83_));
  nand3  g59(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n47_), .c(x10), .O(new_n85_));
  oai22  g61(.a(new_n85_), .b(x07), .c(new_n83_), .d(x10), .O(z7));
  aoi21  g62(.a(x12), .b(x09), .c(x07), .O(new_n87_));
  oai21  g63(.a(x09), .b(x00), .c(new_n49_), .O(new_n88_));
  aoi21  g64(.a(new_n84_), .b(x09), .c(new_n88_), .O(new_n89_));
  oai22  g65(.a(new_n89_), .b(x07), .c(new_n87_), .d(x10), .O(z8));
endmodule
