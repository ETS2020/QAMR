...
module FAU ( 
  ...
  nor2   g40(.a(x11), .b(new_n48_), .O(new_n65_));
  ...
  aoi21  g45(.a(new_n69_), .b(new_n28_), .c(x10), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x02), .c(new_n68_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n36_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n67_), .c(new_n48_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n66_), .O(z4));
  nor2   g50(.a(x02), .b(x01), .O(new_n75_));
  aoi21  g51(.a(new_n27_), .b(new_n29_), .c(new_n26_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n75_), .c(x09), .d(new_n48_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n68_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n36_), .O(z5));
  oai21  g55(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  nand3  g57(.a(new_n68_), .b(new_n67_), .c(x01), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(x02), .O(new_n83_));
  inv1   g59(.a(x09), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x03), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n29_), .b(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n67_), .b(x00), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n85_), .O(new_n89_));
  nand4  g65(.a(new_n84_), .b(new_n67_), .c(x03), .d(x00), .O(new_n90_));
  inv1   g66(.a(x14), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x02), .c(new_n25_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n90_), .c(new_n89_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n83_), .c(new_n48_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n68_), .c(x10), .O(z6));
  nand3  g71(.a(x09), .b(x03), .c(new_n29_), .O(new_n96_));
  nand4  g72(.a(new_n36_), .b(new_n67_), .c(new_n48_), .d(x01), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(x02), .O(new_n98_));
  aoi21  g74(.a(new_n48_), .b(x02), .c(new_n26_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x08), .c(new_n48_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(new_n98_), .c(new_n68_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n36_), .O(z7));
  nand3  g78(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n103_));
  aoi21  g79(.a(new_n103_), .b(new_n68_), .c(x12), .O(new_n104_));
  nand2  g80(.a(new_n84_), .b(new_n25_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n68_), .c(new_n36_), .d(new_n48_), .O(new_n106_));
  inv1   g82(.a(new_n106_), .O(new_n107_));
  oai21  g83(.a(new_n104_), .b(new_n84_), .c(new_n107_), .O(z8));
endmodule
