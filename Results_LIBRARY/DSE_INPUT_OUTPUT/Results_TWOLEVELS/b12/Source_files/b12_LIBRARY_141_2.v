...
module FAU ( 
  ...
  oai21  g22(.a(x09), .b(new_n46_), .c(new_n25_), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(new_n38_), .c(new_n28_), .O(new_n48_));
  ...
  nand3  g28(.a(x10), .b(new_n38_), .c(new_n28_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n49_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n52_), .c(new_n46_), .O(new_n55_));
  ...
  nand3  g39(.a(new_n63_), .b(new_n62_), .c(new_n26_), .O(z4));
  inv1   g40(.a(x09), .O(new_n65_));
  nand4  g41(.a(x13), .b(new_n58_), .c(new_n46_), .d(new_n27_), .O(new_n66_));
  ...
  nand4  g53(.a(new_n77_), .b(new_n25_), .c(new_n65_), .d(new_n46_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  nand4  g55(.a(new_n25_), .b(new_n46_), .c(x02), .d(new_n28_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x03), .c(new_n28_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n52_), .c(x07), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x09), .c(new_n25_), .O(z7));
  nand4  g59(.a(new_n25_), .b(new_n65_), .c(new_n46_), .d(x00), .O(z8));
endmodule
