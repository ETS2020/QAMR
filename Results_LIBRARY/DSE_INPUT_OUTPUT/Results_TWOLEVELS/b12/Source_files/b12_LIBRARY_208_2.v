...
module FAU ( 
  ...
  aoi22  g36(.a(new_n60_), .b(x07), .c(x12), .d(new_n25_), .O(z3));
  nand3  g37(.a(x09), .b(x08), .c(x00), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n48_), .O(new_n63_));
  oai21  g39(.a(new_n59_), .b(new_n36_), .c(x07), .O(new_n64_));
  ...
  aoi21  g45(.a(x09), .b(new_n26_), .c(x02), .O(new_n70_));
  inv1   g46(.a(x08), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x02), .O(new_n72_));
  oai21  g48(.a(new_n70_), .b(x00), .c(new_n72_), .O(new_n73_));
  ...
  nand4  g53(.a(x09), .b(new_n71_), .c(new_n26_), .d(x00), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x01), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n48_), .O(new_n81_));
  aoi21  g57(.a(new_n77_), .b(new_n75_), .c(new_n81_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n74_), .c(x10), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n27_), .O(new_n84_));
  nand3  g60(.a(new_n36_), .b(new_n71_), .c(x02), .O(new_n85_));
  ...
  nand2  g64(.a(new_n36_), .b(new_n48_), .O(new_n89_));
  aoi21  g65(.a(new_n88_), .b(new_n71_), .c(new_n89_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n87_), .O(z7));
  nand4  g67(.a(new_n66_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  nor2   g69(.a(x09), .b(x00), .O(new_n94_));
  nor2   g70(.a(new_n94_), .b(new_n89_), .O(new_n95_));
