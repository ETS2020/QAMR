...
module FAU ( 
  ...
  nand2  g40(.a(new_n27_), .b(new_n25_), .O(new_n65_));
  nand2  g41(.a(new_n54_), .b(x00), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x01), .O(new_n68_));
  nand2  g44(.a(new_n56_), .b(new_n25_), .O(new_n69_));
  aoi21  g45(.a(new_n54_), .b(new_n29_), .c(new_n55_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n49_), .c(new_n36_), .O(new_n72_));
  nand2  g48(.a(new_n59_), .b(x07), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z4));
  inv1   g50(.a(x13), .O(new_n75_));
  nor2   g51(.a(new_n75_), .b(x10), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n61_), .c(new_n36_), .d(new_n25_), .O(z5));
  oai21  g53(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  oai21  g55(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n80_));
  nand2  g56(.a(x08), .b(x00), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n29_), .O(new_n82_));
  inv1   g58(.a(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x02), .c(new_n25_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n49_), .c(new_n36_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  aoi21  g63(.a(new_n54_), .b(x02), .c(x10), .O(new_n88_));
  oai21  g64(.a(new_n26_), .b(x01), .c(new_n54_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n36_), .O(z7));
  nand4  g67(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  nand2  g69(.a(new_n55_), .b(new_n25_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n49_), .d(new_n36_), .O(z8));
endmodule
