...
module FAU ( 
  ...
  aoi21  g23(.a(x05), .b(x01), .c(new_n30_), .O(new_n48_));
  nand2  g24(.a(new_n30_), .b(x03), .O(new_n49_));
  inv1   g25(.a(x07), .O(new_n50_));
  nand2  g26(.a(new_n36_), .b(new_n50_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n29_), .c(new_n48_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n47_), .c(new_n27_), .O(new_n54_));
  nand2  g30(.a(new_n51_), .b(new_n26_), .O(new_n55_));
  ...
  oai21  g35(.a(new_n59_), .b(new_n54_), .c(new_n25_), .O(new_n60_));
  nor2   g36(.a(new_n36_), .b(x03), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n57_), .c(new_n29_), .O(new_n62_));
  aoi21  g38(.a(new_n62_), .b(new_n27_), .c(x08), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n50_), .c(new_n38_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n60_), .O(z2));
  oai21  g41(.a(new_n37_), .b(new_n50_), .c(x00), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  oai21  g43(.a(new_n37_), .b(new_n50_), .c(new_n67_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n66_), .c(new_n39_), .O(z3));
  inv1   g45(.a(x08), .O(new_n70_));
  nand4  g46(.a(new_n36_), .b(new_n70_), .c(new_n50_), .d(x01), .O(new_n71_));
  oai21  g47(.a(x11), .b(new_n50_), .c(new_n71_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x00), .O(new_n73_));
  nand2  g49(.a(new_n51_), .b(x11), .O(new_n74_));
  oai21  g50(.a(new_n56_), .b(new_n25_), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n57_), .b(new_n50_), .c(new_n29_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x11), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n70_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n75_), .c(new_n73_), .O(z4));
  nand4  g55(.a(x13), .b(new_n67_), .c(new_n50_), .d(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n36_), .O(new_n81_));
  nand2  g57(.a(new_n37_), .b(x10), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n81_), .O(z5));
  nand2  g59(.a(x08), .b(x00), .O(new_n84_));
  aoi21  g60(.a(x09), .b(new_n26_), .c(x02), .O(new_n85_));
  nand3  g61(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n86_));
  ...
  nor2   g65(.a(x08), .b(new_n25_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n36_), .c(new_n50_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n39_), .O(z6));
  nand3  g70(.a(new_n70_), .b(new_n50_), .c(x02), .O(new_n95_));
  nand3  g71(.a(x09), .b(x03), .c(new_n27_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x01), .O(new_n97_));
  oai21  g73(.a(new_n26_), .b(x01), .c(new_n70_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n50_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n97_), .c(new_n36_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n82_), .O(z7));
  nand4  g77(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n102_));
  oai21  g78(.a(x09), .b(x00), .c(new_n50_), .O(new_n103_));
  aoi21  g79(.a(new_n102_), .b(x09), .c(new_n103_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(x10), .c(new_n82_), .O(z8));
endmodule
