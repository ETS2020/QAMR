...
module FAU ( 
  ...
  nand3  g40(.a(new_n64_), .b(new_n59_), .c(new_n50_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n58_), .c(new_n26_), .O(z2));
  nand2  g42(.a(x11), .b(new_n50_), .O(new_n67_));
  inv1   g43(.a(x11), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(x10), .O(new_n69_));
  aoi22  g45(.a(new_n69_), .b(new_n67_), .c(x12), .d(new_n40_), .O(z3));
  oai21  g46(.a(new_n51_), .b(x07), .c(new_n68_), .O(new_n71_));
  ...
  oai21  g52(.a(new_n76_), .b(x12), .c(new_n50_), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n75_), .c(x11), .d(new_n51_), .O(z5));
  nor2   g54(.a(new_n59_), .b(new_n40_), .O(new_n79_));
  oai21  g55(.a(new_n60_), .b(x03), .c(new_n28_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n33_), .O(new_n81_));
  nand3  g57(.a(new_n60_), .b(x03), .c(new_n28_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(new_n79_), .O(new_n83_));
  nand2  g59(.a(x14), .b(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n40_), .O(new_n85_));
  nand2  g61(.a(new_n59_), .b(x00), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(new_n33_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n83_), .c(new_n50_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(x11), .c(x10), .O(z6));
  nand2  g65(.a(new_n50_), .b(x02), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x03), .c(new_n33_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n59_), .O(new_n92_));
  nand4  g68(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  aoi21  g69(.a(x11), .b(x07), .c(new_n25_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n51_), .O(z7));
  nand3  g71(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n50_), .c(x12), .O(new_n97_));
  aoi21  g73(.a(new_n60_), .b(new_n40_), .c(x07), .O(new_n98_));
  oai21  g74(.a(new_n97_), .b(new_n60_), .c(new_n98_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x11), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n51_), .O(z8));
endmodule
