...
module FAU ( 
  ...
  aoi21  g46(.a(x12), .b(new_n40_), .c(new_n30_), .O(new_n71_));
  oai21  g47(.a(new_n70_), .b(new_n53_), .c(new_n71_), .O(new_n72_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n39_), .O(z4));
  inv1   g53(.a(x12), .O(new_n78_));
  oai21  g54(.a(x07), .b(x00), .c(x05), .O(new_n79_));
  nor2   g55(.a(x10), .b(new_n25_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(x13), .d(new_n78_), .O(z5));
  oai21  g57(.a(x09), .b(new_n29_), .c(new_n33_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x00), .O(new_n83_));
  nor2   g59(.a(x08), .b(new_n40_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n85_));
  oai21  g61(.a(new_n60_), .b(x03), .c(new_n41_), .O(new_n86_));
  ...
  nand4  g67(.a(new_n91_), .b(new_n26_), .c(new_n53_), .d(x05), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  nand3  g69(.a(x09), .b(x03), .c(new_n41_), .O(new_n94_));
  inv1   g70(.a(x08), .O(new_n95_));
  nand4  g71(.a(new_n26_), .b(new_n95_), .c(new_n53_), .d(x02), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n94_), .c(x01), .O(new_n97_));
  oai21  g73(.a(new_n29_), .b(x01), .c(new_n95_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(new_n97_), .c(x05), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n26_), .O(z7));
  nand4  g77(.a(new_n78_), .b(x03), .c(new_n41_), .d(new_n33_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  aoi22  g79(.a(new_n60_), .b(new_n40_), .c(x07), .d(x05), .O(new_n104_));
  nand3  g80(.a(new_n104_), .b(new_n103_), .c(new_n80_), .O(z8));
endmodule
