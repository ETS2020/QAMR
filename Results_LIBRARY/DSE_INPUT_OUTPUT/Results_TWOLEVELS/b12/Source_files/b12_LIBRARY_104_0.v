...
module FAU ( 
  ...
  nor2   g11(.a(x14), .b(x10), .O(new_n36_));
  ...
  nand4  g46(.a(x13), .b(new_n64_), .c(new_n51_), .d(new_n25_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x14), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n57_), .O(z5));
  nand2  g49(.a(new_n52_), .b(x03), .O(new_n74_));
  nand2  g50(.a(new_n27_), .b(new_n25_), .O(new_n75_));
  inv1   g51(.a(x08), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x00), .O(new_n77_));
  aoi22  g53(.a(new_n77_), .b(new_n75_), .c(new_n74_), .d(new_n29_), .O(new_n78_));
  oai21  g54(.a(new_n52_), .b(x03), .c(new_n27_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  oai22  g57(.a(new_n81_), .b(new_n27_), .c(new_n52_), .d(x03), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n76_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n80_), .c(x01), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n78_), .c(new_n51_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(x14), .c(x10), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n27_), .O(new_n87_));
  nand4  g63(.a(new_n57_), .b(new_n76_), .c(new_n51_), .d(x02), .O(new_n88_));
  ...
  oai21  g67(.a(new_n91_), .b(new_n89_), .c(x14), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n57_), .O(z7));
  nand4  g69(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n94_));
  oai21  g70(.a(x09), .b(x00), .c(new_n51_), .O(new_n95_));
  aoi21  g71(.a(new_n94_), .b(x09), .c(new_n95_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n81_), .c(new_n57_), .O(z8));
endmodule
