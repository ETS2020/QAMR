...
module FAU ( 
  ...
  nand2  g11(.a(x10), .b(x08), .O(new_n36_));
  ...
  nand2  g28(.a(new_n51_), .b(new_n25_), .O(new_n53_));
  aoi21  g29(.a(new_n53_), .b(new_n52_), .c(x07), .O(new_n54_));
  inv1   g30(.a(x07), .O(new_n55_));
  nand2  g31(.a(x10), .b(new_n47_), .O(new_n56_));
  ...
  aoi22  g36(.a(new_n36_), .b(new_n25_), .c(new_n47_), .d(new_n55_), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n27_), .c(new_n60_), .O(z2));
  nand2  g38(.a(x11), .b(x07), .O(new_n63_));
  nand2  g39(.a(x12), .b(new_n25_), .O(new_n64_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n36_), .O(z4));
  inv1   g47(.a(x12), .O(new_n72_));
  nor3   g48(.a(x10), .b(x07), .c(x00), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x13), .c(new_n72_), .O(z5));
  nand2  g50(.a(new_n50_), .b(x03), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n27_), .c(new_n25_), .O(new_n76_));
  nand3  g52(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n28_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n76_), .c(new_n47_), .O(new_n79_));
  nand2  g55(.a(x14), .b(x02), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x01), .O(new_n81_));
  oai21  g57(.a(new_n50_), .b(x03), .c(new_n27_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n29_), .O(new_n83_));
  nand3  g59(.a(new_n50_), .b(x03), .c(new_n27_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n81_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n79_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n48_), .c(new_n55_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n36_), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n29_), .O(new_n90_));
  nand4  g66(.a(new_n48_), .b(new_n47_), .c(new_n55_), .d(x01), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n27_), .O(new_n93_));
  oai21  g69(.a(x07), .b(new_n27_), .c(x03), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n47_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n93_), .c(new_n48_), .d(new_n55_), .O(z7));
  nand4  g72(.a(new_n72_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g74(.a(new_n50_), .b(new_n25_), .c(x10), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n98_), .c(new_n55_), .O(z8));
endmodule
