...
module FAU ( 
  ...
  nand2  g58(.a(x09), .b(new_n28_), .O(new_n83_));
  nand2  g59(.a(new_n25_), .b(x02), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(x00), .O(new_n85_));
  aoi21  g61(.a(new_n83_), .b(new_n29_), .c(x08), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n85_), .c(new_n31_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x02), .c(new_n39_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n82_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n46_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n25_), .c(x10), .O(z6));
  oai21  g68(.a(x08), .b(new_n29_), .c(new_n46_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n25_), .O(new_n94_));
  oai21  g70(.a(new_n28_), .b(x01), .c(new_n47_), .O(new_n95_));
  nand4  g71(.a(x09), .b(x03), .c(new_n29_), .d(new_n31_), .O(new_n96_));
  nor2   g72(.a(x13), .b(x10), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(z7));
  nand2  g74(.a(new_n76_), .b(new_n25_), .O(new_n99_));
  oai21  g75(.a(new_n42_), .b(x01), .c(x09), .O(new_n100_));
