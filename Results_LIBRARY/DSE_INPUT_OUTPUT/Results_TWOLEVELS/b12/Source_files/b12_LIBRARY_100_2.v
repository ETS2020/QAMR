...
module FAU ( 
  ...
  oai21  g45(.a(new_n65_), .b(new_n53_), .c(x07), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(z4));
  inv1   g47(.a(x12), .O(new_n72_));
  nand3  g48(.a(x13), .b(new_n72_), .c(new_n25_), .O(new_n73_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n53_), .c(new_n36_), .O(new_n87_));
  ...
  nand2  g68(.a(x03), .b(new_n29_), .O(new_n93_));
  nand2  g69(.a(new_n53_), .b(new_n36_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(new_n57_), .c(new_n94_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n92_), .O(z7));
  nand4  g72(.a(new_n72_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  aoi21  g74(.a(new_n80_), .b(new_n25_), .c(new_n94_), .O(new_n99_));
