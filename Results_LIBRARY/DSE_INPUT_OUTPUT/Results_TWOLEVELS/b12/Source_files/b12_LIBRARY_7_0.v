...
module FAU ( 
  ...
  nor2   g00(.a(x14), .b(x09), .O(new_n25_));
  ...
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(new_n38_), .c(new_n28_), .O(new_n51_));
  oai21  g27(.a(new_n25_), .b(new_n31_), .c(new_n51_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n46_), .O(new_n53_));
  inv1   g29(.a(x07), .O(new_n54_));
  nand3  g30(.a(new_n48_), .b(x09), .c(new_n54_), .O(new_n55_));
  nand3  g31(.a(x14), .b(x07), .c(new_n38_), .O(new_n56_));
  aoi21  g32(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  inv1   g33(.a(x08), .O(new_n58_));
  nand4  g34(.a(new_n48_), .b(x09), .c(new_n58_), .d(new_n54_), .O(new_n59_));
  inv1   g35(.a(new_n59_), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n57_), .c(new_n28_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n53_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n54_), .c(x00), .O(new_n64_));
  inv1   g40(.a(x12), .O(new_n65_));
  oai21  g41(.a(x07), .b(x00), .c(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n64_), .c(new_n26_), .O(z3));
  ...
  oai21  g48(.a(x12), .b(x00), .c(new_n54_), .O(new_n73_));
  nor2   g49(.a(x10), .b(x07), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(new_n26_), .d(x13), .O(z5));
  nand2  g51(.a(new_n47_), .b(x03), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n31_), .c(new_n27_), .O(new_n77_));
  nand3  g53(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n78_));
  oai21  g54(.a(x02), .b(new_n28_), .c(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n58_), .O(new_n80_));
  nand2  g56(.a(x14), .b(x02), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(x01), .O(new_n82_));
  oai21  g58(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n28_), .O(new_n84_));
  nand3  g60(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n82_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n27_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n80_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n48_), .c(new_n54_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n26_), .O(z6));
  nand3  g66(.a(x09), .b(x03), .c(new_n28_), .O(new_n91_));
  nand4  g67(.a(new_n48_), .b(new_n58_), .c(new_n54_), .d(x01), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n31_), .O(new_n94_));
  aoi21  g70(.a(new_n81_), .b(new_n47_), .c(x07), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n38_), .c(new_n58_), .O(new_n96_));
  nor3   g72(.a(new_n25_), .b(x10), .c(x07), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n96_), .c(new_n94_), .O(z7));
  oai21  g74(.a(new_n49_), .b(new_n27_), .c(new_n47_), .O(new_n99_));
  nand4  g75(.a(new_n65_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n99_), .c(new_n74_), .O(z8));
endmodule
