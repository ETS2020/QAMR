...
module FAU ( 
  ...
  nand3  g24(.a(new_n48_), .b(new_n25_), .c(new_n47_), .O(new_n49_));
  ...
  nand2  g52(.a(new_n56_), .b(x03), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n74_), .c(new_n48_), .d(new_n25_), .O(new_n79_));
  nor2   g55(.a(new_n79_), .b(x07), .O(z6));
  inv1   g56(.a(new_n75_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n48_), .c(new_n25_), .d(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(x03), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n55_), .O(new_n84_));
  nand3  g60(.a(new_n75_), .b(x09), .c(x03), .O(new_n85_));
  nand2  g61(.a(new_n48_), .b(x07), .O(new_n86_));
  and2   g62(.a(new_n86_), .b(new_n26_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(new_n25_), .O(z7));
  nand3  g64(.a(new_n75_), .b(new_n64_), .c(x03), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n56_), .b(new_n38_), .c(x10), .O(new_n91_));
