...
module FAU ( 
  ...
  nand3  g46(.a(new_n65_), .b(x10), .c(x07), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z4));
  nand3  g48(.a(x13), .b(new_n66_), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n53_), .O(z5));
  ...
  nand2  g64(.a(new_n53_), .b(new_n57_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n61_), .c(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n29_), .O(new_n91_));
  oai21  g67(.a(new_n26_), .b(x01), .c(new_n57_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n53_), .d(new_n36_), .O(z7));
