...
module FAU ( 
  ...
  nand2  g11(.a(x14), .b(x10), .O(new_n36_));
  ...
  inv1   g25(.a(x14), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(x10), .c(new_n26_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n49_), .c(x08), .O(new_n52_));
  nand3  g28(.a(new_n48_), .b(x09), .c(new_n25_), .O(new_n53_));
  inv1   g29(.a(new_n53_), .O(new_n54_));
  oai21  g30(.a(new_n54_), .b(new_n52_), .c(new_n47_), .O(new_n55_));
  nand2  g31(.a(new_n50_), .b(x10), .O(new_n56_));
  oai21  g32(.a(x10), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n26_), .c(new_n25_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n55_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n29_), .O(new_n60_));
  oai21  g36(.a(x08), .b(x07), .c(x00), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n36_), .c(x02), .O(new_n62_));
  ...
  nand2  g42(.a(new_n66_), .b(new_n36_), .O(z3));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n47_), .O(new_n69_));
  nand2  g45(.a(new_n64_), .b(x07), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z4));
  nand4  g47(.a(x13), .b(new_n65_), .c(new_n47_), .d(new_n25_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n48_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n56_), .O(z5));
  inv1   g50(.a(x08), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(x03), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n29_), .c(new_n25_), .O(new_n78_));
  nand2  g54(.a(x09), .b(new_n26_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n27_), .c(x01), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(new_n81_));
  nand2  g57(.a(new_n50_), .b(x01), .O(new_n82_));
  oai21  g58(.a(new_n77_), .b(x02), .c(new_n82_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n80_), .c(new_n25_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n81_), .c(x10), .O(new_n85_));
  nand4  g61(.a(x14), .b(new_n27_), .c(x01), .d(new_n25_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n85_), .c(new_n47_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n36_), .O(z6));
  nand3  g65(.a(new_n75_), .b(new_n47_), .c(x02), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n27_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  oai21  g68(.a(new_n26_), .b(x01), .c(new_n75_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n47_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n92_), .c(new_n48_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n56_), .O(z7));
  nand4  g72(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  nand2  g74(.a(new_n76_), .b(new_n25_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n48_), .d(new_n47_), .O(z8));
endmodule
