...
module FAU ( 
  ...
  aoi22  g56(.a(new_n80_), .b(new_n27_), .c(x08), .d(x00), .O(new_n81_));
  inv1   g57(.a(x14), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x01), .c(new_n25_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n36_), .O(new_n84_));
  aoi21  g60(.a(new_n81_), .b(new_n29_), .c(new_n84_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n79_), .c(x10), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n27_), .O(new_n87_));
  nand3  g63(.a(new_n53_), .b(new_n57_), .c(x02), .O(new_n88_));
  ...
  nand2  g67(.a(new_n53_), .b(new_n36_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(new_n57_), .c(new_n92_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n90_), .O(z7));
  ...
  nor2   g73(.a(new_n97_), .b(new_n92_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n96_), .O(z8));
endmodule
