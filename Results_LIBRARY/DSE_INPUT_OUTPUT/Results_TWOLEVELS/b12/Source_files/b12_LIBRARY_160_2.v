...
module FAU ( 
  ...
  nand2  g12(.a(new_n36_), .b(x06), .O(new_n37_));
  ...
  nand4  g23(.a(new_n47_), .b(new_n36_), .c(x09), .d(new_n46_), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand3  g25(.a(x10), .b(new_n49_), .c(new_n26_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g27(.a(x07), .b(new_n46_), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n36_), .c(x03), .O(new_n53_));
  aoi22  g29(.a(new_n53_), .b(new_n25_), .c(new_n51_), .d(new_n45_), .O(new_n54_));
  oai21  g30(.a(x08), .b(x07), .c(x00), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n37_), .c(x02), .O(new_n56_));
  ...
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n37_), .O(z4));
  inv1   g42(.a(x12), .O(new_n67_));
  oai21  g43(.a(x07), .b(x00), .c(new_n46_), .O(new_n68_));
  nor2   g44(.a(x10), .b(x06), .O(new_n69_));
  ...
  nand3  g48(.a(new_n46_), .b(new_n27_), .c(x01), .O(new_n73_));
  ...
  oai21  g59(.a(new_n83_), .b(new_n76_), .c(new_n45_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n46_), .c(x10), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n29_), .O(new_n86_));
  nand4  g62(.a(new_n36_), .b(new_n49_), .c(new_n45_), .d(x01), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(x02), .O(new_n88_));
  aoi21  g64(.a(new_n45_), .b(x02), .c(new_n26_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(x08), .c(new_n45_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n46_), .O(new_n91_));
  ...
  nand2  g70(.a(new_n77_), .b(new_n25_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n69_), .d(new_n52_), .O(z8));
endmodule
