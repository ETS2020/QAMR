...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n80_, new_n81_, new_n82_, new_n84_, new_n85_, new_n86_;
  ...
  oai21  g15(.a(x04), .b(x03), .c(new_n27_), .O(new_n40_));
  ...
  nand2  g23(.a(new_n47_), .b(new_n37_), .O(z1));
  inv1   g24(.a(x07), .O(new_n49_));
  oai21  g25(.a(x09), .b(new_n49_), .c(new_n36_), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(new_n26_), .c(new_n27_), .O(new_n51_));
  nand2  g27(.a(new_n37_), .b(x02), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n25_), .O(new_n54_));
  inv1   g30(.a(x08), .O(new_n55_));
  nand3  g31(.a(x10), .b(new_n26_), .c(new_n27_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n52_), .O(new_n57_));
  nand3  g33(.a(new_n57_), .b(new_n55_), .c(new_n49_), .O(new_n58_));
  ...
  aoi21  g39(.a(new_n36_), .b(x09), .c(x00), .O(new_n64_));
  oai22  g40(.a(new_n36_), .b(x08), .c(x09), .d(new_n25_), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(new_n49_), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  aoi21  g43(.a(x10), .b(x07), .c(new_n67_), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x11), .c(new_n66_), .O(z4));
  ...
  nand2  g49(.a(new_n26_), .b(new_n39_), .O(new_n74_));
  nor2   g50(.a(x01), .b(x00), .O(new_n75_));
  nor2   g51(.a(x08), .b(new_n25_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n74_), .O(new_n77_));
  nor2   g53(.a(x14), .b(new_n39_), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n28_), .c(new_n25_), .O(new_n79_));
  nand3  g55(.a(new_n28_), .b(new_n67_), .c(new_n55_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n77_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n49_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n67_), .c(x10), .O(z6));
  aoi21  g59(.a(new_n36_), .b(x01), .c(x02), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(x03), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n55_), .c(x07), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x09), .c(new_n36_), .O(z7));
  nand4  g63(.a(new_n36_), .b(new_n67_), .c(new_n49_), .d(x00), .O(z8));
endmodule
