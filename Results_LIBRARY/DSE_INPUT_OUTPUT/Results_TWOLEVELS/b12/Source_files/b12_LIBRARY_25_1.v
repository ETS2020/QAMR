...
module FAU ( 
  ...
  nor2   g31(.a(new_n55_), .b(x01), .O(new_n56_));
  ...
  oai21  g37(.a(new_n61_), .b(new_n36_), .c(x00), .O(new_n62_));
  nor2   g38(.a(x12), .b(x00), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x10), .c(new_n36_), .O(new_n64_));
  ...
  nor2   g45(.a(x10), .b(new_n29_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n56_), .c(new_n69_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n68_), .c(x09), .d(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n36_), .O(new_n73_));
  oai21  g49(.a(x11), .b(new_n36_), .c(new_n73_), .O(z4));
  nor3   g50(.a(x12), .b(x10), .c(x00), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x13), .c(new_n36_), .O(z5));
  nor2   g52(.a(new_n69_), .b(new_n25_), .O(new_n77_));
  oai21  g53(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n29_), .O(new_n79_));
  nand3  g55(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(new_n77_), .O(new_n81_));
  nand2  g57(.a(x14), .b(x02), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n25_), .O(new_n83_));
  nand2  g59(.a(new_n69_), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n83_), .c(new_n29_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(new_n68_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x07), .O(z6));
  nand3  g63(.a(new_n69_), .b(new_n36_), .c(x02), .O(new_n88_));
  nand3  g64(.a(x09), .b(x03), .c(new_n27_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  nand2  g66(.a(new_n36_), .b(x01), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(x03), .c(x08), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n90_), .c(new_n68_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n36_), .O(z7));
  nand2  g70(.a(new_n36_), .b(x02), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n65_), .c(x03), .d(new_n29_), .O(new_n96_));
