...
module FAU ( 
  ...
  oai21  g46(.a(new_n68_), .b(new_n25_), .c(x07), .O(new_n71_));
  ...
  nor3   g51(.a(x10), .b(x07), .c(x00), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(x13), .c(new_n75_), .O(z5));
  oai21  g53(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n78_));
  ...
  aoi22  g58(.a(new_n82_), .b(new_n31_), .c(x08), .d(x00), .O(new_n83_));
  inv1   g59(.a(x14), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x01), .c(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n60_), .O(new_n86_));
  aoi21  g62(.a(new_n83_), .b(new_n28_), .c(new_n86_), .O(new_n87_));
  ...
  nor2   g66(.a(new_n53_), .b(new_n38_), .O(new_n91_));
  aoi22  g67(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n58_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x07), .c(new_n25_), .O(z7));
  nand3  g69(.a(new_n90_), .b(new_n75_), .c(x03), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  nand2  g71(.a(new_n53_), .b(new_n27_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n95_), .c(new_n25_), .d(new_n60_), .O(z8));
endmodule
