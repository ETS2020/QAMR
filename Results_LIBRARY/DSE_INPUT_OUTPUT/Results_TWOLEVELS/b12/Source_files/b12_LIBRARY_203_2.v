...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n87_, new_n88_, new_n91_, new_n92_;
  ...
  nand4  g18(.a(x10), .b(x03), .c(new_n26_), .d(x01), .O(new_n43_));
  nand2  g19(.a(new_n43_), .b(new_n42_), .O(new_n44_));
  nand2  g20(.a(new_n44_), .b(new_n38_), .O(new_n45_));
  nor2   g21(.a(x10), .b(new_n39_), .O(new_n46_));
  inv1   g22(.a(new_n46_), .O(new_n47_));
  nand2  g23(.a(new_n47_), .b(new_n45_), .O(z1));
  oai21  g24(.a(x10), .b(x07), .c(new_n39_), .O(new_n49_));
  nand2  g25(.a(new_n49_), .b(new_n25_), .O(new_n50_));
  inv1   g26(.a(x10), .O(new_n51_));
  nor2   g27(.a(new_n51_), .b(new_n34_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n35_), .c(x01), .O(new_n53_));
  nand2  g29(.a(new_n40_), .b(new_n34_), .O(new_n54_));
  ...
  aoi21  g35(.a(new_n59_), .b(new_n49_), .c(x01), .O(new_n60_));
  aoi21  g36(.a(new_n55_), .b(x02), .c(new_n60_), .O(new_n61_));
  nor2   g37(.a(new_n51_), .b(x03), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n58_), .c(new_n25_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n26_), .c(x08), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n56_), .c(new_n46_), .O(new_n65_));
  oai21  g41(.a(new_n61_), .b(x00), .c(new_n65_), .O(z2));
  inv1   g42(.a(x11), .O(new_n67_));
  nor2   g43(.a(new_n46_), .b(new_n38_), .O(new_n68_));
  nor2   g44(.a(x12), .b(new_n51_), .O(new_n69_));
  oai22  g45(.a(new_n69_), .b(new_n68_), .c(new_n67_), .d(new_n56_), .O(new_n70_));
  inv1   g46(.a(x12), .O(new_n71_));
  oai21  g47(.a(x07), .b(x00), .c(x11), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n71_), .c(new_n39_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n70_), .O(z3));
  nand3  g50(.a(x09), .b(x08), .c(x00), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n56_), .O(new_n76_));
  nand2  g52(.a(new_n67_), .b(x07), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n47_), .O(z4));
  nor3   g54(.a(x12), .b(x07), .c(x00), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(x13), .c(new_n51_), .d(new_n39_), .O(z5));
  oai21  g56(.a(x02), .b(x01), .c(x00), .O(new_n81_));
  nand2  g57(.a(x09), .b(new_n25_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(new_n81_), .c(x08), .O(new_n83_));
  nand2  g59(.a(x14), .b(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x01), .O(new_n85_));
  oai21  g61(.a(x09), .b(x02), .c(new_n25_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x00), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n83_), .c(new_n56_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n39_), .c(x10), .O(z6));
  nand4  g65(.a(new_n51_), .b(x08), .c(new_n56_), .d(new_n39_), .O(z7));
  nand3  g66(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n39_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n51_), .O(z8));
endmodule
