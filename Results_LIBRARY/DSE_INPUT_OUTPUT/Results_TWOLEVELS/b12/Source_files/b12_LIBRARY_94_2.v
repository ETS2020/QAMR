...
module FAU ( 
  ...
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n30_), .O(new_n79_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n25_), .c(new_n45_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n28_), .O(new_n85_));
  nand4  g61(.a(new_n25_), .b(new_n47_), .c(new_n45_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n30_), .O(new_n88_));
  oai21  g64(.a(new_n27_), .b(x01), .c(new_n47_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n25_), .d(new_n45_), .O(z7));
  nand4  g66(.a(new_n62_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n91_));
