...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n65_, new_n66_;
  nor2   g00(.a(x10), .b(x07), .O(z6));
  inv1   g01(.a(z6), .O(new_n26_));
  ...
  oai21  g25(.a(new_n49_), .b(z6), .c(new_n48_), .O(new_n50_));
  ...
  oai21  g34(.a(new_n58_), .b(x07), .c(x11), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(x00), .O(new_n60_));
  aoi21  g36(.a(x12), .b(x10), .c(x07), .O(new_n61_));
  nor2   g37(.a(x12), .b(x11), .O(new_n62_));
  nor2   g38(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n60_), .O(z3));
