...
module FAU ( 
  ...
  nand3  g25(.a(x13), .b(new_n25_), .c(x09), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(new_n48_), .O(new_n52_));
  nand4  g28(.a(x13), .b(new_n25_), .c(x09), .d(new_n39_), .O(new_n53_));
  ...
  oai21  g32(.a(new_n56_), .b(new_n54_), .c(new_n34_), .O(new_n57_));
  oai21  g33(.a(x08), .b(x07), .c(x00), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n27_), .c(x02), .O(new_n59_));
  ...
  nor3   g46(.a(x12), .b(x07), .c(x00), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n26_), .c(new_n25_), .O(z5));
  nor2   g48(.a(new_n48_), .b(new_n39_), .O(new_n73_));
  inv1   g49(.a(x09), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(x03), .c(new_n29_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n34_), .O(new_n76_));
  nand3  g52(.a(new_n74_), .b(x03), .c(new_n29_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n76_), .c(new_n73_), .O(new_n78_));
  nand2  g54(.a(x14), .b(x02), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n39_), .O(new_n80_));
  nand2  g56(.a(new_n48_), .b(x00), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(new_n34_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n78_), .c(new_n65_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(x13), .c(x10), .O(z6));
  nand2  g60(.a(new_n65_), .b(x02), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x03), .c(new_n34_), .O(new_n86_));
  nand4  g62(.a(x09), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n65_), .O(new_n88_));
  aoi21  g64(.a(new_n86_), .b(new_n48_), .c(new_n88_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n26_), .c(new_n25_), .O(z7));
  inv1   g66(.a(x12), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n92_));
  oai21  g68(.a(x09), .b(x00), .c(new_n65_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n26_), .c(new_n25_), .O(z8));
endmodule
