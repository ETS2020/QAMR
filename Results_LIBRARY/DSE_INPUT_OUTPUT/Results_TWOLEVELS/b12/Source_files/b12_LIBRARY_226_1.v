...
module FAU ( 
  ...
  nand3  g28(.a(new_n52_), .b(new_n25_), .c(new_n28_), .O(new_n53_));
  ...
  aoi21  g42(.a(new_n66_), .b(new_n61_), .c(x13), .O(new_n67_));
  oai22  g43(.a(new_n67_), .b(x07), .c(new_n60_), .d(x00), .O(z2));
  ...
  nor2   g48(.a(new_n61_), .b(new_n27_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n64_), .c(x09), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(new_n75_));
  oai21  g51(.a(x11), .b(new_n25_), .c(new_n75_), .O(z4));
  oai21  g52(.a(new_n56_), .b(x03), .c(new_n32_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n28_), .O(new_n79_));
  nand3  g54(.a(new_n56_), .b(x03), .c(new_n32_), .O(new_n80_));
  aoi21  g55(.a(new_n80_), .b(new_n79_), .c(new_n73_), .O(new_n81_));
  nand2  g56(.a(x14), .b(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n27_), .O(new_n83_));
  nand2  g58(.a(new_n61_), .b(x00), .O(new_n84_));
  aoi21  g59(.a(new_n84_), .b(new_n83_), .c(new_n28_), .O(new_n85_));
  oai21  g60(.a(new_n85_), .b(new_n81_), .c(new_n52_), .O(new_n86_));
  aoi21  g61(.a(new_n86_), .b(new_n64_), .c(x07), .O(z6));
  nand2  g62(.a(new_n25_), .b(x02), .O(new_n88_));
  nand3  g63(.a(new_n88_), .b(x03), .c(new_n28_), .O(new_n89_));
  nand4  g64(.a(x09), .b(x03), .c(new_n32_), .d(new_n28_), .O(new_n90_));
  nand2  g65(.a(new_n90_), .b(new_n52_), .O(new_n91_));
  aoi21  g66(.a(new_n89_), .b(new_n61_), .c(new_n91_), .O(new_n92_));
  oai21  g67(.a(new_n92_), .b(x13), .c(new_n25_), .O(z7));
  nand4  g68(.a(new_n69_), .b(x03), .c(new_n32_), .d(new_n28_), .O(new_n94_));
  oai21  g69(.a(x09), .b(x00), .c(new_n52_), .O(new_n95_));
  aoi21  g70(.a(new_n94_), .b(x09), .c(new_n95_), .O(new_n96_));
  oai21  g71(.a(new_n96_), .b(x13), .c(new_n25_), .O(z8));
  one    g72(.O(z5));
endmodule
