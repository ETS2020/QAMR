...
module FAU ( 
  ...
  nand2  g65(.a(new_n68_), .b(new_n69_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n88_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n29_), .O(new_n92_));
  aoi21  g68(.a(new_n69_), .b(x01), .c(x10), .O(new_n93_));
  nand2  g69(.a(new_n69_), .b(new_n26_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n36_), .O(z7));
  nand4  g71(.a(new_n89_), .b(new_n65_), .c(x03), .d(new_n29_), .O(new_n96_));
