...
module FAU ( 
  ...
  oai21  g36(.a(new_n57_), .b(new_n46_), .c(new_n60_), .O(z4));
  inv1   g37(.a(x12), .O(new_n62_));
  nand3  g38(.a(x13), .b(new_n62_), .c(new_n27_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n46_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n25_), .O(z5));
  oai21  g41(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n66_));
  ...
  aoi22  g46(.a(new_n70_), .b(new_n31_), .c(x08), .d(x00), .O(new_n71_));
  inv1   g47(.a(x14), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(x01), .c(new_n27_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n46_), .O(new_n74_));
  aoi21  g50(.a(new_n71_), .b(new_n28_), .c(new_n74_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n69_), .c(x10), .O(z6));
  nand3  g52(.a(x09), .b(x03), .c(new_n31_), .O(new_n77_));
  nand3  g53(.a(new_n25_), .b(new_n53_), .c(x02), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n28_), .O(new_n80_));
  oai21  g56(.a(new_n38_), .b(x01), .c(new_n53_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand4  g58(.a(new_n62_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n83_));
  nor2   g59(.a(x09), .b(x00), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x07), .c(new_n25_), .O(z8));
endmodule
