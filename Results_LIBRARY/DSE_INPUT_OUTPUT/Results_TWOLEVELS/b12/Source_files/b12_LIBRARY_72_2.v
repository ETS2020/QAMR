...
module FAU ( 
  ...
  nand2  g40(.a(new_n64_), .b(x10), .O(new_n65_));
  aoi22  g41(.a(new_n65_), .b(x07), .c(x12), .d(new_n38_), .O(z3));
  inv1   g42(.a(x07), .O(new_n67_));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  oai21  g45(.a(new_n64_), .b(new_n25_), .c(x07), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(z4));
  inv1   g47(.a(x12), .O(new_n72_));
  nand3  g48(.a(x13), .b(new_n72_), .c(new_n38_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n67_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n25_), .O(z5));
  aoi21  g51(.a(x09), .b(new_n27_), .c(x02), .O(new_n76_));
  nand3  g52(.a(new_n53_), .b(x03), .c(new_n28_), .O(new_n77_));
  oai21  g53(.a(new_n76_), .b(x01), .c(new_n77_), .O(new_n78_));
  oai21  g54(.a(new_n56_), .b(new_n38_), .c(new_n78_), .O(new_n79_));
  ...
  nand3  g61(.a(new_n25_), .b(new_n56_), .c(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n30_), .O(new_n88_));
  oai21  g64(.a(new_n27_), .b(x01), .c(new_n56_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n25_), .d(new_n67_), .O(z7));
  nand4  g66(.a(new_n72_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n91_));
  nor2   g67(.a(x09), .b(x00), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x07), .c(new_n25_), .O(z8));
endmodule
