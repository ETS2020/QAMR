...
module FAU ( 
  ...
  nand2  g37(.a(new_n28_), .b(new_n38_), .O(new_n62_));
  nand2  g38(.a(new_n53_), .b(x00), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n62_), .c(new_n33_), .O(new_n64_));
  nand2  g40(.a(new_n55_), .b(new_n38_), .O(new_n65_));
  nand3  g41(.a(x09), .b(new_n53_), .c(new_n33_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n48_), .d(x09), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n64_), .c(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n60_), .O(z4));
  inv1   g45(.a(x12), .O(new_n70_));
  inv1   g46(.a(x13), .O(new_n71_));
  aoi21  g47(.a(new_n48_), .b(x00), .c(new_n71_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n70_), .c(new_n48_), .d(new_n25_), .O(z5));
  aoi21  g49(.a(x09), .b(new_n27_), .c(x02), .O(new_n74_));
  oai22  g50(.a(new_n74_), .b(x00), .c(x08), .d(new_n28_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n33_), .O(new_n76_));
  nand2  g52(.a(new_n63_), .b(new_n62_), .O(new_n77_));
  oai21  g53(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n78_));
  nand4  g54(.a(x09), .b(new_n53_), .c(new_n27_), .d(x00), .O(new_n79_));
  inv1   g55(.a(x14), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x01), .c(new_n38_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(new_n82_));
  aoi21  g58(.a(new_n78_), .b(new_n77_), .c(new_n82_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n76_), .c(x07), .O(z6));
  nand3  g60(.a(new_n53_), .b(new_n25_), .c(x02), .O(new_n85_));
  ...
  oai21  g64(.a(new_n27_), .b(x01), .c(new_n53_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n48_), .d(new_n25_), .O(z7));
  nand4  g66(.a(new_n70_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  nand2  g68(.a(new_n54_), .b(new_n38_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
