...
module FAU ( 
  ...
  oai21  g43(.a(new_n63_), .b(x10), .c(x07), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(z4));
  nand2  g45(.a(new_n47_), .b(x07), .O(new_n70_));
