...
module FAU ( 
  ...
  nand2  g24(.a(new_n25_), .b(x09), .O(new_n49_));
  nand2  g25(.a(x10), .b(new_n27_), .O(new_n50_));
  and2   g26(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n48_), .c(x00), .O(new_n52_));
  inv1   g28(.a(x07), .O(new_n53_));
  nand3  g29(.a(x10), .b(new_n53_), .c(new_n27_), .O(new_n54_));
  aoi21  g30(.a(new_n54_), .b(new_n49_), .c(x08), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n52_), .c(new_n33_), .O(new_n56_));
  aoi21  g32(.a(new_n26_), .b(x01), .c(new_n34_), .O(new_n57_));
  nor2   g33(.a(new_n57_), .b(x00), .O(new_n58_));
  nor2   g34(.a(x08), .b(x07), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n58_), .c(x02), .O(new_n60_));
  nand3  g36(.a(new_n60_), .b(new_n56_), .c(new_n26_), .O(z2));
  ...
  nand4  g47(.a(new_n71_), .b(new_n25_), .c(new_n53_), .d(new_n38_), .O(z5));
  ...
  nand3  g58(.a(new_n82_), .b(x02), .c(new_n38_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n81_), .c(new_n75_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n25_), .c(new_n53_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n28_), .O(new_n87_));
  inv1   g63(.a(x08), .O(new_n88_));
  nand3  g64(.a(new_n25_), .b(new_n88_), .c(x02), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n87_), .c(x01), .O(new_n90_));
  aoi21  g66(.a(x03), .b(new_n33_), .c(x08), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n90_), .c(new_n53_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n25_), .O(z7));
  nand4  g69(.a(new_n63_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n94_));
  nor2   g70(.a(x09), .b(x00), .O(new_n95_));
  aoi21  g71(.a(new_n94_), .b(x09), .c(new_n95_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x07), .c(new_n25_), .O(z8));
endmodule
