...
module FAU ( 
  ...
  oai21  g35(.a(new_n57_), .b(new_n25_), .c(x07), .O(new_n60_));
  ...
  nor2   g41(.a(new_n65_), .b(x00), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n64_), .c(new_n25_), .d(new_n47_), .O(z5));
  aoi21  g43(.a(x09), .b(new_n27_), .c(x02), .O(new_n68_));
  oai22  g44(.a(new_n68_), .b(x00), .c(x08), .d(new_n28_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n33_), .O(new_n70_));
  oai21  g46(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n71_));
  nand2  g47(.a(new_n28_), .b(new_n38_), .O(new_n72_));
  oai21  g48(.a(x08), .b(new_n38_), .c(new_n72_), .O(new_n73_));
  nand4  g49(.a(x09), .b(new_n54_), .c(new_n27_), .d(x00), .O(new_n74_));
  inv1   g50(.a(x14), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x01), .c(new_n38_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n47_), .O(new_n77_));
  aoi21  g53(.a(new_n73_), .b(new_n71_), .c(new_n77_), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n70_), .c(x10), .O(z6));
  nand2  g55(.a(new_n47_), .b(x02), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x03), .c(new_n33_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  nor2   g58(.a(x02), .b(x01), .O(new_n83_));
  inv1   g59(.a(x09), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(new_n27_), .O(new_n85_));
  nand2  g61(.a(new_n25_), .b(new_n47_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(new_n83_), .c(new_n86_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n82_), .O(z7));
  nand3  g64(.a(new_n83_), .b(new_n64_), .c(x03), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x09), .O(new_n90_));
  aoi21  g66(.a(new_n84_), .b(new_n38_), .c(new_n86_), .O(new_n91_));
