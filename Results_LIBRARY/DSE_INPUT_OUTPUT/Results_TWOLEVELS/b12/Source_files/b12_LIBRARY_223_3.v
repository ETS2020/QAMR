...
module FAU ( 
  ...
  oai21  g39(.a(new_n60_), .b(x10), .c(x07), .O(new_n64_));
  ...
  nor2   g44(.a(new_n68_), .b(x10), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n61_), .c(new_n46_), .d(new_n37_), .O(z5));
  ...
  aoi21  g65(.a(x12), .b(x09), .c(x07), .O(new_n90_));
  ...
  oai22  g69(.a(new_n93_), .b(x07), .c(new_n90_), .d(x10), .O(z8));
endmodule
