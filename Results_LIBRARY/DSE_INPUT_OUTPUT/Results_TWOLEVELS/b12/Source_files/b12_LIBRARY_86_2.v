...
module FAU ( 
  ...
  oai21  g44(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n69_));
  nor2   g45(.a(x02), .b(x00), .O(new_n70_));
  nor2   g46(.a(x08), .b(new_n38_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x03), .c(new_n28_), .O(new_n74_));
  nand2  g50(.a(x08), .b(x00), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n30_), .O(new_n76_));
  ...
  nand3  g55(.a(new_n79_), .b(new_n25_), .c(new_n45_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(x09), .b(x03), .c(new_n28_), .O(new_n82_));
  nand4  g58(.a(new_n25_), .b(new_n47_), .c(new_n45_), .d(x02), .O(new_n83_));
  ...
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n25_), .d(new_n45_), .O(z7));
  ...
  nand3  g67(.a(new_n91_), .b(new_n90_), .c(new_n45_), .O(z8));
endmodule
