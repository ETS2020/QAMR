...
module FAU ( 
  ...
  nor2   g01(.a(new_n25_), .b(x11), .O(new_n26_));
  ...
  nand3  g26(.a(new_n50_), .b(new_n31_), .c(new_n39_), .O(new_n51_));
  ...
  nand2  g34(.a(new_n57_), .b(new_n39_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n58_), .c(x07), .O(new_n60_));
  nor3   g36(.a(new_n50_), .b(x03), .c(x00), .O(new_n61_));
  oai21  g37(.a(new_n61_), .b(new_n60_), .c(new_n31_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n53_), .c(new_n27_), .O(z2));
  inv1   g39(.a(x11), .O(new_n64_));
  aoi21  g40(.a(new_n25_), .b(x09), .c(new_n64_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(x00), .c(new_n25_), .O(new_n66_));
  oai21  g42(.a(x12), .b(x07), .c(new_n64_), .O(new_n67_));
  oai21  g43(.a(new_n66_), .b(x07), .c(new_n67_), .O(z3));
  aoi21  g44(.a(x12), .b(new_n64_), .c(x00), .O(new_n69_));
  oai21  g45(.a(x09), .b(new_n39_), .c(x08), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(x11), .c(new_n69_), .O(new_n71_));
  nand3  g47(.a(x09), .b(x08), .c(new_n46_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n25_), .c(new_n64_), .O(new_n73_));
  oai21  g49(.a(new_n71_), .b(x07), .c(new_n73_), .O(z4));
  oai21  g50(.a(new_n25_), .b(x11), .c(x07), .O(new_n75_));
  aoi21  g51(.a(new_n56_), .b(x00), .c(x12), .O(new_n76_));
  oai22  g52(.a(new_n76_), .b(new_n64_), .c(x12), .d(new_n39_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  inv1   g54(.a(x13), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(x10), .c(new_n25_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(z5));
  nand2  g57(.a(x08), .b(x00), .O(new_n82_));
  aoi21  g58(.a(x09), .b(new_n28_), .c(x02), .O(new_n83_));
  nand3  g59(.a(new_n56_), .b(x03), .c(new_n29_), .O(new_n84_));
  ...
  nor2   g63(.a(x08), .b(new_n39_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n87_), .c(x01), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n86_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n54_), .c(new_n46_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n27_), .O(z6));
  nand2  g68(.a(new_n46_), .b(x02), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(x03), .c(new_n31_), .O(new_n94_));
  nand4  g70(.a(x09), .b(x03), .c(new_n29_), .d(new_n31_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n54_), .O(new_n96_));
  aoi21  g72(.a(new_n94_), .b(new_n47_), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n26_), .c(new_n75_), .O(z7));
  nor2   g74(.a(new_n25_), .b(new_n64_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n46_), .O(new_n100_));
  oai21  g76(.a(x12), .b(x09), .c(new_n100_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(new_n39_), .O(new_n102_));
  nand2  g78(.a(new_n27_), .b(x10), .O(new_n103_));
  nand3  g79(.a(x03), .b(new_n29_), .c(new_n31_), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(new_n25_), .O(new_n105_));
  nand3  g81(.a(new_n99_), .b(new_n46_), .c(x00), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(x09), .O(new_n108_));
  nand4  g84(.a(new_n108_), .b(new_n103_), .c(new_n102_), .d(new_n75_), .O(z8));
endmodule
