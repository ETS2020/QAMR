...
module FAU ( 
  ...
  nand3  g39(.a(new_n63_), .b(new_n56_), .c(new_n27_), .O(z2));
  nand2  g40(.a(x11), .b(x07), .O(new_n65_));
  nand2  g41(.a(x12), .b(new_n39_), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n65_), .c(new_n27_), .O(new_n67_));
  ...
  oai21  g50(.a(new_n74_), .b(new_n26_), .c(new_n25_), .O(z5));
  nand2  g51(.a(x09), .b(new_n28_), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n29_), .c(x00), .O(new_n77_));
  nand2  g53(.a(x13), .b(x02), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n76_), .c(x08), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n77_), .c(new_n34_), .O(new_n80_));
  aoi21  g56(.a(new_n58_), .b(x03), .c(x01), .O(new_n81_));
  nand3  g57(.a(new_n58_), .b(new_n57_), .c(x03), .O(new_n82_));
  oai21  g58(.a(new_n81_), .b(x00), .c(new_n82_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n29_), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n39_), .O(new_n85_));
  ...
  aoi21  g65(.a(new_n89_), .b(x13), .c(x10), .O(z6));
  nand3  g66(.a(x09), .b(x03), .c(new_n29_), .O(new_n91_));
  nand4  g67(.a(new_n25_), .b(new_n57_), .c(new_n49_), .d(x02), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  oai21  g69(.a(new_n28_), .b(x01), .c(new_n57_), .O(new_n94_));
  ...
  nand4  g74(.a(new_n98_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n99_));
  oai21  g75(.a(x09), .b(x00), .c(new_n49_), .O(new_n100_));
  aoi21  g76(.a(new_n99_), .b(x09), .c(new_n100_), .O(new_n101_));
  oai21  g77(.a(new_n101_), .b(new_n26_), .c(new_n25_), .O(z8));
endmodule
