...
module FAU ( 
  ...
  nor2   g40(.a(x11), .b(x10), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n64_), .c(x00), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  nand2  g43(.a(x12), .b(new_n36_), .O(new_n68_));
  aoi22  g44(.a(new_n68_), .b(new_n63_), .c(new_n67_), .d(new_n52_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n66_), .O(z3));
  oai21  g46(.a(x11), .b(new_n36_), .c(new_n25_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  oai21  g48(.a(new_n53_), .b(new_n72_), .c(x11), .O(new_n73_));
  ...
  nand3  g52(.a(new_n76_), .b(new_n36_), .c(new_n72_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n71_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n52_), .O(new_n79_));
  nand2  g55(.a(x09), .b(new_n52_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n63_), .c(new_n36_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n79_), .O(z4));
  oai21  g58(.a(x11), .b(new_n36_), .c(x07), .O(new_n83_));
  nand2  g59(.a(x11), .b(x10), .O(new_n84_));
  oai22  g60(.a(new_n84_), .b(x00), .c(x13), .d(x10), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n52_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n83_), .c(new_n68_), .d(new_n66_), .O(z5));
  nand2  g63(.a(new_n53_), .b(x03), .O(new_n88_));
  ...
  oai21  g67(.a(new_n91_), .b(new_n89_), .c(new_n72_), .O(new_n92_));
  nand2  g68(.a(x14), .b(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x01), .O(new_n94_));
  oai21  g70(.a(new_n53_), .b(x03), .c(new_n27_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n29_), .O(new_n96_));
  nand3  g72(.a(new_n53_), .b(x03), .c(new_n27_), .O(new_n97_));
  ...
  nand3  g76(.a(new_n100_), .b(new_n36_), .c(new_n52_), .O(new_n101_));
  inv1   g77(.a(new_n101_), .O(z6));
  nand3  g78(.a(x09), .b(x03), .c(new_n29_), .O(new_n103_));
  nand4  g79(.a(new_n36_), .b(new_n72_), .c(new_n52_), .d(x01), .O(new_n104_));
  ...
  aoi21  g83(.a(new_n107_), .b(new_n72_), .c(x10), .O(new_n108_));
  nand3  g84(.a(new_n108_), .b(new_n106_), .c(new_n83_), .O(z7));
  nand4  g85(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n110_));
  nand2  g86(.a(new_n110_), .b(x09), .O(new_n111_));
  aoi21  g87(.a(new_n53_), .b(new_n25_), .c(x10), .O(new_n112_));
  nand3  g88(.a(new_n112_), .b(new_n111_), .c(new_n83_), .O(z8));
endmodule
