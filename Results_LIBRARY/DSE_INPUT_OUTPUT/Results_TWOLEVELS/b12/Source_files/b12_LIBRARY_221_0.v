...
module FAU ( 
  ...
  nand4  g48(.a(new_n72_), .b(new_n70_), .c(new_n54_), .d(x09), .O(z5));
  ...
  aoi21  g52(.a(x03), .b(new_n27_), .c(x01), .O(new_n77_));
  ...
  nand3  g61(.a(new_n85_), .b(x08), .c(new_n48_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x09), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n54_), .O(z7));
  aoi21  g64(.a(x03), .b(new_n29_), .c(x07), .O(new_n89_));
  inv1   g65(.a(x12), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n48_), .c(new_n27_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n89_), .c(x09), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n54_), .O(z8));
endmodule
