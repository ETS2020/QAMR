...
module FAU ( 
  ...
  nand4  g24(.a(x14), .b(new_n25_), .c(new_n48_), .d(new_n31_), .O(new_n49_));
  ...
  nand4  g46(.a(x13), .b(new_n64_), .c(new_n48_), .d(new_n39_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(x14), .O(new_n72_));
  ...
  nand4  g58(.a(new_n82_), .b(x14), .c(new_n25_), .d(new_n48_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand2  g60(.a(new_n48_), .b(x02), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x03), .c(new_n31_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n55_), .O(new_n87_));
  nor2   g63(.a(x02), .b(x01), .O(new_n88_));
  nor2   g64(.a(new_n56_), .b(new_n28_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x10), .O(new_n90_));
  inv1   g66(.a(new_n27_), .O(new_n91_));
  aoi21  g67(.a(x14), .b(x07), .c(new_n91_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n90_), .c(new_n87_), .O(z7));
  nand3  g69(.a(new_n88_), .b(new_n64_), .c(x03), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x09), .O(new_n95_));
  aoi21  g71(.a(new_n56_), .b(new_n39_), .c(x10), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n95_), .c(new_n92_), .O(z8));
endmodule
