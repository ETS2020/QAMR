...
module FAU ( 
  ...
  aoi21  g40(.a(x11), .b(new_n56_), .c(new_n64_), .O(new_n65_));
  aoi21  g41(.a(x12), .b(new_n25_), .c(new_n65_), .O(z3));
  oai21  g42(.a(x10), .b(x07), .c(new_n36_), .O(new_n67_));
  nand3  g43(.a(x09), .b(x08), .c(x00), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n56_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n67_), .O(z4));
  inv1   g46(.a(new_n50_), .O(new_n71_));
  inv1   g47(.a(x12), .O(new_n72_));
  nand3  g48(.a(x13), .b(new_n72_), .c(new_n56_), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n52_), .c(new_n71_), .O(new_n74_));
  oai21  g50(.a(new_n65_), .b(new_n25_), .c(new_n74_), .O(z5));
  nand2  g51(.a(x08), .b(x00), .O(new_n76_));
  aoi21  g52(.a(x09), .b(new_n26_), .c(x02), .O(new_n77_));
  nand3  g53(.a(new_n49_), .b(x03), .c(new_n27_), .O(new_n78_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n52_), .c(new_n56_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n37_), .O(z6));
  aoi21  g62(.a(new_n48_), .b(x02), .c(x07), .O(new_n87_));
  oai21  g63(.a(new_n26_), .b(x01), .c(new_n48_), .O(new_n88_));
  nor2   g64(.a(x02), .b(x01), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x09), .c(x03), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n88_), .c(new_n87_), .d(new_n52_), .O(z7));
  nand2  g67(.a(new_n56_), .b(new_n26_), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n89_), .c(new_n72_), .O(new_n93_));
  oai21  g69(.a(x09), .b(x00), .c(new_n56_), .O(new_n94_));
  aoi21  g70(.a(new_n93_), .b(x09), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n50_), .O(z8));
endmodule
