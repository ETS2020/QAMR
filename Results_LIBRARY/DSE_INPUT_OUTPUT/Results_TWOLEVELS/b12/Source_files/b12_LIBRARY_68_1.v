...
module FAU ( 
  ...
  oai21  g33(.a(x12), .b(new_n46_), .c(new_n57_), .O(new_n58_));
  ...
  nor2   g46(.a(new_n70_), .b(x07), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n25_), .c(new_n57_), .d(new_n39_), .O(z5));
  inv1   g48(.a(x09), .O(new_n73_));
  oai22  g49(.a(x12), .b(new_n29_), .c(new_n73_), .d(x03), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n39_), .O(new_n75_));
  nand2  g51(.a(new_n47_), .b(x02), .O(new_n76_));
  aoi21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  ...
  nand4  g57(.a(x09), .b(new_n47_), .c(new_n28_), .d(x00), .O(new_n82_));
  inv1   g58(.a(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x01), .c(new_n39_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n77_), .c(new_n46_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n25_), .c(x10), .O(z6));
  nand3  g63(.a(new_n25_), .b(new_n46_), .c(x02), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x03), .c(new_n31_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n47_), .O(new_n90_));
  nor2   g66(.a(x02), .b(x01), .O(new_n91_));
  nor2   g67(.a(new_n73_), .b(new_n28_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x07), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n90_), .c(new_n25_), .d(new_n57_), .O(z7));
  nand3  g70(.a(x03), .b(new_n29_), .c(new_n31_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n46_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x12), .c(new_n57_), .O(z8));
endmodule
