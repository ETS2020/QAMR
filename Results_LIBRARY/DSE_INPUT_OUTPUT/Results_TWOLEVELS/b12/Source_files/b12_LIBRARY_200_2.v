...
module FAU ( 
  ...
  nand4  g11(.a(new_n29_), .b(x03), .c(x02), .d(new_n35_), .O(new_n36_));
  aoi21  g12(.a(new_n36_), .b(new_n34_), .c(x00), .O(z0));
  nand2  g13(.a(new_n29_), .b(x03), .O(new_n38_));
  nand2  g14(.a(x10), .b(x04), .O(new_n39_));
  ...
  oai21  g21(.a(new_n45_), .b(new_n40_), .c(x02), .O(new_n46_));
  oai22  g22(.a(new_n42_), .b(x04), .c(new_n30_), .d(x02), .O(new_n47_));
  ...
  nand2  g26(.a(x05), .b(x01), .O(new_n51_));
  nand3  g27(.a(new_n51_), .b(x10), .c(x04), .O(new_n52_));
  inv1   g28(.a(x03), .O(new_n53_));
  oai21  g29(.a(x10), .b(x07), .c(new_n53_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n29_), .c(new_n35_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n52_), .c(new_n50_), .O(new_n56_));
  ...
  aoi21  g36(.a(new_n60_), .b(new_n54_), .c(x01), .O(new_n61_));
  aoi21  g37(.a(new_n56_), .b(x02), .c(new_n61_), .O(new_n62_));
  nor2   g38(.a(new_n41_), .b(x03), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n59_), .c(new_n35_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n28_), .c(x08), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n57_), .c(new_n30_), .O(new_n66_));
  ...
  nand2  g54(.a(new_n78_), .b(new_n41_), .O(z5));
  oai21  g55(.a(x09), .b(new_n53_), .c(new_n35_), .O(new_n80_));
  nor2   g56(.a(x02), .b(x00), .O(new_n81_));
  nor2   g57(.a(x08), .b(new_n76_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .O(new_n83_));
  oai21  g59(.a(new_n58_), .b(x03), .c(new_n28_), .O(new_n84_));
  nand2  g60(.a(x08), .b(x00), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n35_), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x01), .c(new_n76_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n83_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n41_), .c(new_n57_), .d(new_n29_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n28_), .O(new_n92_));
  inv1   g68(.a(x08), .O(new_n93_));
  nand4  g69(.a(new_n41_), .b(new_n93_), .c(new_n57_), .d(x02), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n92_), .c(x01), .O(new_n95_));
  oai21  g71(.a(new_n53_), .b(x01), .c(new_n93_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n57_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n95_), .c(new_n29_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n41_), .O(z7));
  nand4  g75(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n35_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x09), .O(new_n101_));
  aoi22  g77(.a(new_n58_), .b(new_n76_), .c(x07), .d(new_n29_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n101_), .c(new_n41_), .d(new_n29_), .O(z8));
endmodule
