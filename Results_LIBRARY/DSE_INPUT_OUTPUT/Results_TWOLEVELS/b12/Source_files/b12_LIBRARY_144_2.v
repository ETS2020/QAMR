...
module FAU ( 
  ...
  aoi21  g47(.a(x09), .b(new_n26_), .c(x02), .O(new_n72_));
  inv1   g48(.a(x08), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x02), .O(new_n74_));
  oai21  g50(.a(new_n72_), .b(x00), .c(new_n74_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n29_), .O(new_n76_));
  oai21  g52(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n77_));
  nand2  g53(.a(new_n27_), .b(new_n25_), .O(new_n78_));
  oai21  g54(.a(x08), .b(new_n25_), .c(new_n78_), .O(new_n79_));
  nand4  g55(.a(x09), .b(new_n73_), .c(new_n26_), .d(x00), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n25_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n48_), .O(new_n83_));
  aoi21  g59(.a(new_n79_), .b(new_n77_), .c(new_n83_), .O(new_n84_));
  aoi21  g60(.a(new_n84_), .b(new_n76_), .c(x10), .O(z6));
  nand3  g61(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n86_));
  nor2   g62(.a(x02), .b(x01), .O(new_n87_));
  inv1   g63(.a(x09), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(new_n26_), .O(new_n89_));
  aoi22  g65(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(new_n73_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(x07), .c(new_n36_), .O(z7));
  nand3  g67(.a(new_n87_), .b(new_n61_), .c(x03), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  nand2  g69(.a(new_n88_), .b(new_n25_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n36_), .d(new_n48_), .O(z8));
endmodule
