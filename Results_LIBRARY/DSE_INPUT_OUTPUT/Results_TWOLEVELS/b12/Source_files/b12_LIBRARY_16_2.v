...
module FAU ( 
  ...
  aoi22  g44(.a(new_n68_), .b(x07), .c(x12), .d(new_n38_), .O(z3));
  nand3  g45(.a(x09), .b(x08), .c(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n48_), .O(new_n71_));
  oai21  g47(.a(new_n68_), .b(new_n48_), .c(new_n71_), .O(z4));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(x13), .b(new_n73_), .c(new_n38_), .O(new_n74_));
  ...
  nand4  g66(.a(new_n25_), .b(new_n49_), .c(new_n48_), .d(x02), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n30_), .O(new_n93_));
  nand2  g69(.a(x03), .b(new_n30_), .O(new_n94_));
  nand2  g70(.a(new_n25_), .b(new_n48_), .O(new_n95_));
  aoi21  g71(.a(new_n94_), .b(new_n49_), .c(new_n95_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n93_), .O(z7));
  nand4  g73(.a(new_n73_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  aoi21  g75(.a(new_n81_), .b(new_n38_), .c(new_n95_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n99_), .O(z8));
endmodule
