...
module FAU ( 
  ...
  nand3  g42(.a(new_n66_), .b(new_n27_), .c(new_n29_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(x09), .c(x00), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n56_), .c(new_n36_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n63_), .O(z4));
  nor2   g47(.a(x12), .b(x00), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(x13), .c(new_n56_), .d(new_n36_), .O(z5));
  nand2  g49(.a(new_n66_), .b(x03), .O(new_n74_));
  ...
  oai21  g53(.a(new_n77_), .b(new_n75_), .c(new_n65_), .O(new_n78_));
  nand2  g54(.a(x14), .b(x02), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x01), .O(new_n80_));
  oai21  g56(.a(new_n66_), .b(x03), .c(new_n27_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n29_), .O(new_n82_));
  nand3  g58(.a(new_n66_), .b(x03), .c(new_n27_), .O(new_n83_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n56_), .c(new_n36_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(z6));
  nand3  g64(.a(new_n65_), .b(new_n36_), .c(x01), .O(new_n89_));
  nand3  g65(.a(x09), .b(x03), .c(new_n29_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n89_), .c(x02), .O(new_n91_));
  nand2  g67(.a(new_n36_), .b(x02), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(x03), .c(x08), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n91_), .c(new_n56_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n36_), .O(z7));
  aoi21  g71(.a(new_n36_), .b(x01), .c(x12), .O(new_n96_));
  ...
  oai21  g75(.a(new_n99_), .b(x10), .c(new_n36_), .O(z8));
endmodule
