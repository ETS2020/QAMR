...
module FAU ( 
  ...
  nor2   g58(.a(new_n74_), .b(new_n37_), .O(new_n83_));
  ...
  nor2   g63(.a(new_n82_), .b(x07), .O(new_n88_));
  aoi21  g64(.a(new_n58_), .b(x03), .c(x10), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n88_), .c(x09), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n47_), .O(new_n91_));
  nor2   g67(.a(x10), .b(new_n55_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(new_n55_), .c(new_n92_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n90_), .O(z8));
endmodule
