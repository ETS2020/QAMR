...
module FAU ( 
  ...
  nor3   g25(.a(x10), .b(x07), .c(x06), .O(new_n50_));
  ...
  aoi21  g36(.a(new_n52_), .b(x02), .c(new_n60_), .O(new_n61_));
  nor2   g37(.a(new_n54_), .b(x03), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(new_n58_), .c(new_n29_), .O(new_n63_));
  aoi21  g39(.a(new_n63_), .b(new_n27_), .c(x08), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(new_n53_), .c(new_n37_), .O(new_n65_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n68_), .c(new_n38_), .O(z3));
  ...
  oai21  g53(.a(x12), .b(x00), .c(new_n53_), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(new_n77_), .c(new_n38_), .d(x13), .O(z5));
  ...
  oai21  g59(.a(new_n57_), .b(x03), .c(new_n27_), .O(new_n84_));
  ...
  nand4  g65(.a(new_n89_), .b(new_n54_), .c(new_n53_), .d(new_n36_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand3  g67(.a(x09), .b(x03), .c(new_n27_), .O(new_n92_));
  nand2  g68(.a(new_n36_), .b(x02), .O(new_n93_));
  inv1   g69(.a(x08), .O(new_n94_));
  nand3  g70(.a(new_n54_), .b(new_n94_), .c(new_n53_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n93_), .c(new_n92_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n29_), .O(new_n97_));
  oai21  g73(.a(new_n26_), .b(x01), .c(new_n94_), .O(new_n98_));
  nor2   g74(.a(x10), .b(x06), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n53_), .O(z7));
  nand4  g76(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g78(.a(new_n57_), .b(new_n25_), .c(x07), .O(new_n103_));
