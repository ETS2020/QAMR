...
module FAU ( 
  ...
  nand2  g41(.a(new_n51_), .b(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x00), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(new_n37_), .b(new_n50_), .c(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n39_), .O(z3));
  oai21  g46(.a(new_n56_), .b(new_n25_), .c(new_n66_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(x01), .b(x00), .O(new_n73_));
  oai21  g49(.a(new_n56_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n36_), .c(new_n50_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x11), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n72_), .O(new_n77_));
  nand2  g53(.a(new_n37_), .b(x07), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n71_), .O(z4));
  nand4  g55(.a(x13), .b(new_n68_), .c(new_n50_), .d(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n36_), .O(new_n81_));
  oai21  g57(.a(x11), .b(new_n36_), .c(new_n81_), .O(z5));
  ...
  oai21  g62(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n87_));
  ...
  aoi21  g70(.a(x03), .b(new_n29_), .c(x10), .O(new_n95_));
  nor2   g71(.a(x07), .b(new_n27_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n95_), .c(new_n72_), .O(new_n97_));
  nand4  g73(.a(x09), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n36_), .d(new_n50_), .O(z7));
  nor2   g75(.a(x09), .b(x00), .O(new_n100_));
  aoi21  g76(.a(x09), .b(x01), .c(new_n100_), .O(new_n101_));
  nand3  g77(.a(new_n68_), .b(x03), .c(new_n27_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(x09), .O(new_n103_));
  nand4  g79(.a(new_n103_), .b(new_n101_), .c(new_n36_), .d(new_n50_), .O(z8));
endmodule
