...
module FAU ( 
  ...
  nand3  g45(.a(new_n69_), .b(new_n66_), .c(new_n39_), .O(z3));
  inv1   g46(.a(x08), .O(new_n71_));
  oai21  g47(.a(new_n57_), .b(x01), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(x09), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n50_), .O(new_n74_));
  oai21  g50(.a(new_n71_), .b(x07), .c(new_n37_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n39_), .O(z4));
  nor2   g52(.a(x12), .b(x00), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(x13), .c(new_n36_), .d(new_n50_), .O(z5));
  ...
  nand3  g64(.a(new_n88_), .b(new_n36_), .c(new_n50_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n39_), .O(z6));
  nand3  g66(.a(x09), .b(x03), .c(new_n27_), .O(new_n91_));
  nand4  g67(.a(new_n36_), .b(new_n71_), .c(new_n50_), .d(x02), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n29_), .O(new_n94_));
  oai21  g70(.a(x07), .b(new_n29_), .c(x03), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n71_), .c(new_n51_), .O(new_n96_));
  ...
  aoi21  g75(.a(new_n56_), .b(new_n25_), .c(x10), .O(new_n100_));
