...
module FAU ( 
  ...
  nand3  g51(.a(new_n68_), .b(new_n52_), .c(x07), .O(new_n76_));
  ...
  oai21  g55(.a(x10), .b(new_n51_), .c(new_n79_), .O(z5));
  oai21  g56(.a(x09), .b(new_n39_), .c(new_n27_), .O(new_n81_));
  nor2   g57(.a(x02), .b(x00), .O(new_n82_));
  nor2   g58(.a(x08), .b(new_n26_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  inv1   g60(.a(x09), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(x03), .c(new_n31_), .O(new_n86_));
  nand2  g62(.a(x08), .b(x00), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n27_), .O(new_n88_));
  inv1   g64(.a(x14), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x01), .c(new_n26_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n88_), .c(new_n84_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n52_), .c(new_n51_), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  nand3  g69(.a(new_n59_), .b(new_n51_), .c(x02), .O(new_n94_));
  nand3  g70(.a(x09), .b(x03), .c(new_n31_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(x01), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x07), .c(new_n52_), .O(new_n97_));
  oai21  g73(.a(new_n49_), .b(x08), .c(new_n52_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n51_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n97_), .O(z7));
  nand4  g76(.a(new_n70_), .b(x03), .c(new_n31_), .d(new_n27_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  nand2  g78(.a(new_n85_), .b(new_n26_), .O(new_n103_));
  nand4  g79(.a(new_n103_), .b(new_n102_), .c(new_n52_), .d(new_n51_), .O(z8));
endmodule
