...
module FAU ( 
  ...
  nor2   g44(.a(x11), .b(new_n47_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n36_), .O(new_n70_));
  ...
  oai21  g50(.a(new_n74_), .b(new_n50_), .c(new_n71_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x07), .c(new_n70_), .O(z4));
  nor2   g52(.a(x13), .b(x10), .O(new_n77_));
  nor3   g53(.a(new_n77_), .b(x07), .c(x00), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n64_), .c(new_n48_), .O(z5));
  ...
  nand3  g63(.a(new_n50_), .b(x02), .c(new_n25_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n87_), .c(new_n83_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n48_), .c(new_n47_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand2  g67(.a(new_n47_), .b(x02), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(x03), .c(new_n29_), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n48_), .c(new_n71_), .O(new_n94_));
  nor2   g70(.a(x02), .b(x01), .O(new_n95_));
  nor2   g71(.a(new_n84_), .b(new_n26_), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x10), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n94_), .c(new_n47_), .O(z7));
  nand3  g74(.a(new_n95_), .b(new_n64_), .c(x03), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  aoi21  g76(.a(new_n84_), .b(new_n25_), .c(x10), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n100_), .c(new_n47_), .O(z8));
endmodule
