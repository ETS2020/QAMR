...
module FAU ( 
  ...
  oai21  g12(.a(new_n28_), .b(new_n35_), .c(new_n36_), .O(new_n37_));
  nand2  g13(.a(new_n37_), .b(x06), .O(new_n38_));
  ...
  nor2   g20(.a(new_n36_), .b(x06), .O(new_n45_));
  inv1   g21(.a(x07), .O(new_n46_));
  nor2   g22(.a(x10), .b(new_n46_), .O(new_n47_));
  oai21  g23(.a(new_n47_), .b(new_n45_), .c(new_n44_), .O(new_n48_));
  inv1   g24(.a(x06), .O(new_n49_));
  inv1   g25(.a(x08), .O(new_n50_));
  nand4  g26(.a(x10), .b(new_n50_), .c(new_n46_), .d(new_n49_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n48_), .c(x03), .O(new_n52_));
  nand2  g28(.a(x08), .b(x00), .O(new_n53_));
  nand4  g29(.a(new_n53_), .b(new_n36_), .c(x09), .d(new_n46_), .O(new_n54_));
  ...
  oai21  g53(.a(new_n77_), .b(x03), .c(new_n25_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n53_), .c(new_n35_), .O(new_n79_));
  inv1   g55(.a(x14), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(x01), .c(new_n44_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n76_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n36_), .c(new_n46_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n31_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n25_), .O(new_n85_));
  nand4  g61(.a(new_n36_), .b(new_n50_), .c(new_n46_), .d(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n35_), .O(new_n88_));
  oai21  g64(.a(new_n72_), .b(x01), .c(new_n50_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n36_), .d(new_n46_), .O(z7));
  nand4  g66(.a(new_n62_), .b(x03), .c(new_n25_), .d(new_n35_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n77_), .b(new_n44_), .c(x10), .O(new_n93_));
