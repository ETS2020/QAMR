...
module FAU ( 
  ...
  nor2   g56(.a(new_n72_), .b(new_n37_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(x07), .O(new_n82_));
  nand3  g58(.a(x03), .b(new_n30_), .c(new_n27_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n68_), .c(x10), .O(new_n84_));
  oai22  g60(.a(new_n84_), .b(x07), .c(new_n82_), .d(x10), .O(z7));
  aoi21  g61(.a(x12), .b(x09), .c(x07), .O(new_n86_));
  oai21  g62(.a(x09), .b(x00), .c(new_n47_), .O(new_n87_));
  aoi21  g63(.a(new_n83_), .b(x09), .c(new_n87_), .O(new_n88_));
  oai22  g64(.a(new_n88_), .b(x07), .c(new_n86_), .d(x10), .O(z8));
endmodule
