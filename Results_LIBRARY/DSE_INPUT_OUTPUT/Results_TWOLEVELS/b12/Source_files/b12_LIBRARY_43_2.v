...
module FAU ( 
  ...
  nand4  g48(.a(new_n72_), .b(x13), .c(new_n50_), .d(new_n54_), .O(z5));
  ...
  oai21  g53(.a(new_n47_), .b(x03), .c(new_n31_), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n78_), .c(new_n28_), .O(new_n80_));
  inv1   g56(.a(x14), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n27_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n80_), .c(new_n77_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n50_), .c(new_n54_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(z6));
  nand3  g61(.a(x09), .b(x03), .c(new_n31_), .O(new_n86_));
  nand4  g62(.a(new_n50_), .b(new_n46_), .c(new_n54_), .d(x02), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n28_), .O(new_n89_));
  oai21  g65(.a(new_n38_), .b(x01), .c(new_n46_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n89_), .c(new_n50_), .d(new_n54_), .O(z7));
  nand4  g67(.a(new_n64_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n47_), .b(new_n27_), .c(x10), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(new_n54_), .O(z8));
endmodule
