...
module FAU ( 
  ...
  oai21  g47(.a(new_n68_), .b(new_n49_), .c(new_n71_), .O(z4));
  inv1   g48(.a(x12), .O(new_n73_));
  nand4  g49(.a(x13), .b(new_n73_), .c(new_n50_), .d(new_n39_), .O(new_n74_));
  ...
  nand3  g61(.a(new_n85_), .b(x01), .c(new_n39_), .O(new_n86_));
  ...
  nand2  g66(.a(new_n50_), .b(new_n59_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n63_), .c(new_n90_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n32_), .O(new_n93_));
  oai21  g69(.a(new_n26_), .b(x01), .c(new_n59_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n50_), .d(new_n49_), .O(z7));
  nand4  g71(.a(new_n73_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  nand2  g73(.a(new_n81_), .b(new_n39_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n50_), .d(new_n49_), .O(z8));
endmodule
