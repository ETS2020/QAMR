...
module FAU ( 
  ...
  aoi22  g41(.a(new_n51_), .b(x11), .c(x12), .d(new_n25_), .O(z3));
  nand2  g42(.a(new_n51_), .b(x11), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n56_), .O(new_n68_));
  nor2   g44(.a(x09), .b(x01), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x08), .c(x00), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n36_), .c(new_n50_), .O(new_n71_));
  nand3  g47(.a(x08), .b(new_n50_), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n37_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n68_), .O(z4));
  inv1   g50(.a(x12), .O(new_n75_));
  nand4  g51(.a(x13), .b(new_n75_), .c(new_n50_), .d(new_n25_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n36_), .O(new_n77_));
  nand2  g53(.a(new_n37_), .b(x10), .O(new_n78_));
  ...
  nand3  g67(.a(new_n91_), .b(new_n50_), .c(x02), .O(new_n92_));
  ...
  oai21  g72(.a(new_n96_), .b(new_n94_), .c(new_n36_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n78_), .O(z7));
  oai21  g74(.a(new_n26_), .b(x02), .c(new_n50_), .O(new_n99_));
  nor2   g75(.a(x12), .b(x01), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(new_n99_), .c(new_n56_), .O(new_n101_));
  oai21  g77(.a(x09), .b(x00), .c(new_n50_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(new_n101_), .c(new_n36_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n78_), .O(z8));
endmodule
