...
module FAU ( 
  ...
  aoi21  g29(.a(new_n25_), .b(x07), .c(x00), .O(new_n54_));
  nor2   g30(.a(x08), .b(x07), .O(new_n55_));
  oai21  g31(.a(new_n55_), .b(new_n54_), .c(x02), .O(new_n56_));
  oai21  g32(.a(new_n53_), .b(x01), .c(new_n56_), .O(z2));
  ...
  oai21  g38(.a(new_n59_), .b(new_n47_), .c(new_n62_), .O(z4));
  inv1   g39(.a(x13), .O(new_n64_));
  aoi21  g40(.a(x12), .b(new_n38_), .c(new_n64_), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n25_), .c(new_n47_), .d(new_n38_), .O(z5));
  inv1   g42(.a(x09), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x03), .c(new_n28_), .O(new_n68_));
  inv1   g44(.a(x08), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x00), .O(new_n70_));
  oai21  g46(.a(x01), .b(x00), .c(new_n70_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n68_), .O(new_n72_));
  oai21  g48(.a(x02), .b(x00), .c(new_n70_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n67_), .c(x03), .O(new_n74_));
  aoi21  g50(.a(x14), .b(x02), .c(x00), .O(new_n75_));
  nor3   g51(.a(x08), .b(x07), .c(x02), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(x01), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n74_), .c(new_n72_), .d(new_n47_), .O(new_n78_));
  and2   g54(.a(new_n78_), .b(new_n25_), .O(z6));
  nand3  g55(.a(x09), .b(x03), .c(new_n30_), .O(new_n80_));
  nand3  g56(.a(new_n25_), .b(new_n69_), .c(x01), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n80_), .c(x02), .O(new_n82_));
  aoi21  g58(.a(x03), .b(new_n28_), .c(x08), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n82_), .c(new_n47_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n25_), .O(z7));
  inv1   g61(.a(x12), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x09), .O(new_n88_));
  nand2  g64(.a(new_n67_), .b(new_n38_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n88_), .c(new_n25_), .d(new_n47_), .O(z8));
endmodule
