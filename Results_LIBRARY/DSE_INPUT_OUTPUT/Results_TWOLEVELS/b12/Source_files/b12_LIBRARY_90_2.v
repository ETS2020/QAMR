...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n87_, new_n88_, new_n90_, new_n91_, new_n92_, new_n94_;
  ...
  nand4  g29(.a(new_n25_), .b(new_n53_), .c(new_n52_), .d(new_n28_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n51_), .c(new_n48_), .O(new_n55_));
  nor2   g31(.a(x10), .b(x07), .O(new_n56_));
  nor3   g32(.a(new_n56_), .b(x03), .c(x01), .O(new_n57_));
  aoi21  g33(.a(new_n55_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand3  g34(.a(x10), .b(new_n40_), .c(new_n28_), .O(new_n59_));
  aoi21  g35(.a(new_n59_), .b(new_n32_), .c(x08), .O(new_n60_));
  aoi22  g36(.a(new_n60_), .b(new_n52_), .c(new_n25_), .d(x09), .O(new_n61_));
  oai21  g37(.a(new_n58_), .b(x00), .c(new_n61_), .O(z2));
  inv1   g38(.a(x11), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n52_), .c(x00), .O(new_n64_));
  ...
  nor2   g48(.a(x09), .b(new_n27_), .O(new_n73_));
  nor2   g49(.a(new_n65_), .b(x00), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n52_), .O(new_n75_));
  nand4  g51(.a(x13), .b(new_n25_), .c(new_n53_), .d(new_n52_), .O(new_n76_));
  inv1   g52(.a(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n75_), .O(z5));
  aoi21  g54(.a(new_n40_), .b(new_n32_), .c(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n32_), .O(new_n80_));
  ...
  nand3  g61(.a(new_n85_), .b(x03), .c(new_n32_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n84_), .c(new_n81_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n25_), .c(new_n53_), .d(new_n52_), .O(new_n88_));
  inv1   g64(.a(new_n88_), .O(z6));
  nand3  g65(.a(new_n56_), .b(x02), .c(new_n28_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x03), .c(new_n28_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n85_), .c(x07), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x09), .c(new_n25_), .O(z7));
  oai21  g69(.a(x07), .b(new_n27_), .c(new_n53_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n25_), .O(z8));
endmodule
