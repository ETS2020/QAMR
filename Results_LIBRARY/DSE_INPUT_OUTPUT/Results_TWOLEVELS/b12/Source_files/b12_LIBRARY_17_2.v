...
module FAU ( 
  ...
  oai21  g47(.a(new_n68_), .b(new_n59_), .c(new_n71_), .O(z4));
  inv1   g48(.a(x12), .O(new_n73_));
  nand3  g49(.a(x13), .b(new_n73_), .c(new_n27_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n59_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n25_), .O(z5));
  nor2   g52(.a(new_n57_), .b(new_n27_), .O(new_n77_));
  ...
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(new_n28_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n82_), .c(new_n25_), .O(new_n87_));
  nor2   g63(.a(new_n87_), .b(x07), .O(z6));
  nand3  g64(.a(x09), .b(x03), .c(new_n31_), .O(new_n89_));
  nand2  g65(.a(new_n25_), .b(new_n57_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n63_), .c(new_n89_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n28_), .O(new_n92_));
  oai21  g68(.a(new_n38_), .b(x01), .c(new_n57_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n25_), .d(new_n59_), .O(z7));
  nand4  g70(.a(new_n73_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n95_));
