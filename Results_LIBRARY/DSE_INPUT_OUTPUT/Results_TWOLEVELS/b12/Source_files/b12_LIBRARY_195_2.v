...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n62_, new_n63_, new_n66_, new_n68_, new_n69_, new_n70_, new_n72_,
  ...
  oai21  g27(.a(new_n48_), .b(x07), .c(new_n51_), .O(new_n52_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n50_), .c(new_n38_), .O(new_n58_));
  inv1   g34(.a(x08), .O(new_n59_));
  nor2   g35(.a(new_n48_), .b(x03), .O(new_n60_));
  oai21  g36(.a(new_n60_), .b(new_n55_), .c(new_n30_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n28_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n59_), .c(new_n47_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n58_), .O(z2));
  aoi21  g40(.a(x12), .b(new_n38_), .c(x07), .O(z3));
  nor2   g41(.a(new_n54_), .b(new_n59_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(x00), .c(x07), .O(z4));
  inv1   g43(.a(x12), .O(new_n68_));
  nand4  g44(.a(x13), .b(new_n68_), .c(new_n48_), .d(new_n38_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n47_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n51_), .O(z5));
  ...
  oai21  g51(.a(new_n54_), .b(x03), .c(new_n28_), .O(new_n76_));
  nand2  g52(.a(x08), .b(x00), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n30_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x02), .c(new_n38_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n48_), .c(new_n47_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n26_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n28_), .O(new_n84_));
  nand3  g60(.a(new_n48_), .b(new_n59_), .c(x02), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(x01), .O(new_n86_));
  oai21  g62(.a(new_n27_), .b(x01), .c(new_n59_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n48_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n86_), .c(new_n47_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n51_), .O(z7));
  nand4  g66(.a(new_n68_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n48_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x07), .c(new_n51_), .O(z8));
endmodule
