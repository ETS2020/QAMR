...
module FAU ( 
  ...
  oai21  g46(.a(new_n68_), .b(x10), .c(x07), .O(new_n71_));
  ...
  nor2   g52(.a(new_n76_), .b(x10), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n75_), .c(new_n51_), .d(new_n26_), .O(z5));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  aoi21  g55(.a(x09), .b(new_n39_), .c(x02), .O(new_n80_));
  ...
  nor2   g67(.a(new_n81_), .b(new_n39_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x07), .O(new_n93_));
  nand3  g69(.a(x03), .b(new_n31_), .c(new_n27_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n59_), .c(x10), .O(new_n95_));
  oai22  g71(.a(new_n95_), .b(x07), .c(new_n93_), .d(x10), .O(z7));
  nand3  g72(.a(new_n91_), .b(new_n75_), .c(x03), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(x09), .O(new_n98_));
  nand2  g74(.a(new_n81_), .b(new_n26_), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n52_), .d(new_n51_), .O(z8));
endmodule
