...
module FAU ( 
  ...
  nor2   g12(.a(x13), .b(new_n36_), .O(new_n37_));
  ...
  oai21  g47(.a(new_n71_), .b(x07), .c(new_n36_), .O(new_n72_));
  nor3   g48(.a(x12), .b(x10), .c(x00), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n71_), .c(new_n72_), .O(z5));
  ...
  oai21  g54(.a(new_n53_), .b(x03), .c(new_n27_), .O(new_n79_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n36_), .c(new_n52_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n38_), .O(z6));
  inv1   g62(.a(x08), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n52_), .c(x02), .O(new_n88_));
  ...
  oai21  g69(.a(new_n71_), .b(new_n36_), .c(new_n93_), .O(z7));
  nand4  g70(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  nand2  g72(.a(new_n53_), .b(new_n25_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n36_), .d(new_n52_), .O(z8));
endmodule
