...
module FAU ( 
  ...
  aoi21  g40(.a(x12), .b(new_n37_), .c(new_n64_), .O(new_n65_));
  nand4  g41(.a(new_n65_), .b(new_n48_), .c(new_n59_), .d(new_n37_), .O(z5));
  inv1   g42(.a(x09), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(x03), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n27_), .c(new_n37_), .O(new_n69_));
  nand3  g45(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n28_), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n69_), .c(new_n46_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(x01), .O(new_n74_));
  oai21  g50(.a(new_n67_), .b(x03), .c(new_n27_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n32_), .O(new_n76_));
  nand3  g52(.a(new_n67_), .b(x03), .c(new_n27_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n37_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n48_), .c(new_n59_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n32_), .O(new_n83_));
  nand4  g59(.a(new_n48_), .b(new_n46_), .c(new_n59_), .d(x01), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n27_), .O(new_n86_));
  oai21  g62(.a(x07), .b(new_n27_), .c(x03), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n46_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n86_), .c(new_n48_), .d(new_n59_), .O(z7));
  inv1   g65(.a(x12), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x09), .O(new_n92_));
  aoi21  g68(.a(new_n67_), .b(new_n37_), .c(x10), .O(new_n93_));
  nand3  g69(.a(new_n93_), .b(new_n92_), .c(new_n59_), .O(z8));
endmodule
