...
module FAU ( 
  ...
  oai21  g39(.a(x12), .b(new_n36_), .c(new_n25_), .O(new_n64_));
  nand2  g40(.a(new_n56_), .b(new_n29_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n36_), .c(new_n55_), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n64_), .c(new_n36_), .d(x09), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n50_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n62_), .O(z4));
  inv1   g45(.a(x13), .O(new_n70_));
  aoi21  g46(.a(new_n50_), .b(x00), .c(new_n70_), .O(new_n71_));
  nand2  g47(.a(x12), .b(new_n25_), .O(new_n72_));
  nand4  g48(.a(new_n72_), .b(new_n71_), .c(new_n36_), .d(new_n50_), .O(z5));
  ...
  oai21  g54(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n79_));
  ...
  nand2  g72(.a(new_n56_), .b(new_n25_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n36_), .d(new_n50_), .O(z8));
endmodule
