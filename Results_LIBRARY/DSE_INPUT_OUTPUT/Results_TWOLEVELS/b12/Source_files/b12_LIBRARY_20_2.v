...
module FAU ( 
  ...
  nor2   g12(.a(x11), .b(new_n36_), .O(new_n37_));
  ...
  oai21  g43(.a(new_n67_), .b(x10), .c(new_n65_), .O(new_n68_));
  nand3  g44(.a(new_n67_), .b(new_n49_), .c(new_n25_), .O(new_n69_));
  ...
  nand2  g48(.a(new_n50_), .b(new_n65_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n72_), .O(z4));
  inv1   g50(.a(x13), .O(new_n75_));
  aoi21  g51(.a(x12), .b(new_n25_), .c(new_n75_), .O(new_n76_));
  nand4  g52(.a(new_n76_), .b(new_n36_), .c(new_n49_), .d(new_n25_), .O(z5));
  oai21  g53(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n25_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(new_n81_));
  oai21  g57(.a(new_n55_), .b(x03), .c(new_n27_), .O(new_n82_));
  nand2  g58(.a(x08), .b(x00), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n29_), .O(new_n84_));
  ...
  nand3  g63(.a(new_n87_), .b(new_n36_), .c(new_n49_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n38_), .O(z6));
  nand3  g65(.a(x09), .b(x03), .c(new_n27_), .O(new_n90_));
  inv1   g66(.a(x08), .O(new_n91_));
  nand4  g67(.a(new_n36_), .b(new_n91_), .c(new_n49_), .d(x02), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n90_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n29_), .O(new_n94_));
  nand2  g70(.a(x03), .b(new_n29_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n91_), .c(new_n50_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n94_), .O(z7));
  nand4  g73(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  aoi21  g75(.a(new_n55_), .b(new_n25_), .c(x10), .O(new_n100_));
