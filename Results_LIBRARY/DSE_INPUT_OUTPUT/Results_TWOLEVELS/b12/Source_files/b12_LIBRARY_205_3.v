...
module FAU ( 
  ...
  nor2   g39(.a(x10), .b(x00), .O(new_n64_));
  nand4  g40(.a(new_n64_), .b(x13), .c(new_n63_), .d(new_n59_), .O(z5));
  oai21  g41(.a(x09), .b(new_n37_), .c(new_n27_), .O(new_n66_));
  nand2  g42(.a(new_n30_), .b(new_n26_), .O(new_n67_));
  ...
  oai21  g48(.a(new_n72_), .b(x03), .c(new_n30_), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n45_), .c(new_n27_), .O(new_n74_));
  inv1   g50(.a(x14), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(x01), .c(new_n26_), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n47_), .c(new_n59_), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(z6));
  aoi21  g55(.a(new_n68_), .b(x02), .c(x10), .O(new_n80_));
  oai21  g56(.a(new_n37_), .b(x01), .c(new_n68_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(new_n59_), .O(z7));
  aoi21  g59(.a(x12), .b(x09), .c(x07), .O(new_n84_));
  nand3  g60(.a(x03), .b(new_n30_), .c(new_n27_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n47_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai22  g63(.a(new_n87_), .b(x07), .c(new_n84_), .d(x10), .O(z8));
endmodule
