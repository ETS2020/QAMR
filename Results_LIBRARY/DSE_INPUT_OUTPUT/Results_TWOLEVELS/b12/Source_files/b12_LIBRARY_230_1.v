...
module FAU ( 
  ...
  oai21  g41(.a(new_n65_), .b(new_n56_), .c(x00), .O(new_n66_));
  inv1   g42(.a(x12), .O(new_n67_));
  oai21  g43(.a(x07), .b(x00), .c(x11), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n66_), .c(new_n45_), .O(z3));
  nand3  g46(.a(x09), .b(x08), .c(x00), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n56_), .O(new_n72_));
  nand2  g48(.a(new_n65_), .b(x07), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(new_n72_), .c(new_n45_), .O(z4));
  nor2   g50(.a(x12), .b(x00), .O(new_n75_));
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n28_), .d(new_n56_), .O(z5));
  ...
  nand4  g68(.a(new_n28_), .b(new_n60_), .c(new_n56_), .d(x02), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n47_), .O(new_n95_));
  oai21  g71(.a(new_n38_), .b(x01), .c(new_n60_), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n95_), .c(new_n51_), .O(z7));
  inv1   g73(.a(x09), .O(new_n98_));
  nand4  g74(.a(new_n28_), .b(x05), .c(x02), .d(new_n37_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x01), .O(new_n101_));
  nand2  g77(.a(new_n29_), .b(x03), .O(new_n102_));
  nand2  g78(.a(new_n51_), .b(new_n47_), .O(new_n103_));
  aoi21  g79(.a(new_n103_), .b(new_n102_), .c(new_n34_), .O(new_n104_));
  nand3  g80(.a(new_n28_), .b(new_n98_), .c(new_n56_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(x02), .c(x03), .O(new_n106_));
  oai21  g82(.a(new_n106_), .b(new_n104_), .c(new_n37_), .O(new_n107_));
  nand3  g83(.a(new_n67_), .b(x03), .c(new_n34_), .O(new_n108_));
  nand2  g84(.a(new_n108_), .b(x09), .O(new_n109_));
  nand4  g85(.a(new_n109_), .b(new_n107_), .c(new_n101_), .d(new_n51_), .O(z8));
endmodule
