...
module FAU ( 
  ...
  aoi21  g41(.a(new_n65_), .b(new_n51_), .c(new_n61_), .O(new_n66_));
  oai21  g42(.a(new_n60_), .b(x00), .c(new_n66_), .O(z2));
  inv1   g43(.a(x11), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x00), .c(new_n68_), .O(new_n70_));
  oai21  g46(.a(new_n61_), .b(new_n27_), .c(x12), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n51_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n70_), .c(new_n26_), .O(z3));
  nand3  g49(.a(x09), .b(x08), .c(x00), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nand2  g51(.a(new_n68_), .b(x07), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n26_), .O(z4));
  oai21  g53(.a(x07), .b(x00), .c(new_n26_), .O(new_n78_));
  oai21  g54(.a(new_n69_), .b(x07), .c(new_n52_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(x14), .O(new_n80_));
  inv1   g56(.a(x13), .O(new_n81_));
  nand3  g57(.a(x03), .b(new_n33_), .c(new_n28_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(x07), .c(new_n56_), .O(new_n83_));
  nand2  g59(.a(new_n56_), .b(new_n27_), .O(new_n84_));
  inv1   g60(.a(new_n84_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n83_), .c(new_n81_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n80_), .c(new_n78_), .O(z5));
  nand2  g63(.a(x08), .b(x00), .O(new_n88_));
  aoi21  g64(.a(x09), .b(new_n40_), .c(x02), .O(new_n89_));
  ...
  aoi21  g68(.a(x14), .b(x02), .c(x00), .O(new_n93_));
  nor2   g69(.a(x08), .b(new_n27_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n93_), .c(x01), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n92_), .O(new_n96_));
  nand3  g72(.a(new_n96_), .b(new_n52_), .c(new_n51_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n26_), .O(z6));
  inv1   g74(.a(x08), .O(new_n99_));
  nand2  g75(.a(new_n51_), .b(x02), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(x03), .c(new_n28_), .O(new_n101_));
  nand4  g77(.a(x09), .b(x03), .c(new_n33_), .d(new_n28_), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(new_n52_), .c(new_n51_), .O(new_n103_));
  aoi21  g79(.a(new_n101_), .b(new_n99_), .c(new_n103_), .O(new_n104_));
  nor2   g80(.a(new_n104_), .b(new_n61_), .O(z7));
  oai21  g81(.a(new_n40_), .b(x01), .c(new_n51_), .O(new_n106_));
  aoi21  g82(.a(new_n106_), .b(new_n69_), .c(new_n56_), .O(new_n107_));
  nand3  g83(.a(new_n84_), .b(new_n52_), .c(new_n51_), .O(new_n108_));
  oai21  g84(.a(new_n108_), .b(new_n107_), .c(new_n26_), .O(new_n109_));
  oai21  g85(.a(x13), .b(x07), .c(new_n25_), .O(new_n110_));
  nand3  g86(.a(new_n110_), .b(x09), .c(x02), .O(new_n111_));
  nand2  g87(.a(new_n111_), .b(new_n109_), .O(z8));
endmodule
