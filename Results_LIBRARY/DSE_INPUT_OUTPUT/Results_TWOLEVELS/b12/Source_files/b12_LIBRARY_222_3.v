...
module FAU ( 
  ...
  nand2  g52(.a(new_n76_), .b(new_n51_), .O(z5));
  oai21  g53(.a(x09), .b(new_n39_), .c(new_n27_), .O(new_n78_));
  nor2   g54(.a(x02), .b(x00), .O(new_n79_));
  nor2   g55(.a(x08), .b(new_n26_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .O(new_n81_));
  inv1   g57(.a(x09), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x03), .c(new_n31_), .O(new_n83_));
  nand2  g59(.a(x08), .b(x00), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n27_), .O(new_n85_));
  inv1   g61(.a(x14), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(x01), .c(new_n26_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n85_), .c(new_n81_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n52_), .c(new_n51_), .O(new_n89_));
  inv1   g65(.a(new_n89_), .O(z6));
  nand3  g66(.a(new_n59_), .b(new_n51_), .c(x02), .O(new_n91_));
  nand3  g67(.a(x09), .b(x03), .c(new_n31_), .O(new_n92_));
  aoi21  g68(.a(new_n92_), .b(new_n91_), .c(x01), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(x07), .c(new_n52_), .O(new_n94_));
  oai21  g70(.a(new_n49_), .b(x08), .c(new_n52_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n51_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n94_), .O(z7));
  nand4  g73(.a(new_n74_), .b(x03), .c(new_n31_), .d(new_n27_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(x09), .O(new_n99_));
  nand2  g75(.a(new_n82_), .b(new_n26_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n52_), .d(new_n51_), .O(z8));
endmodule
