...
module FAU ( 
  ...
  aoi21  g45(.a(x12), .b(new_n37_), .c(new_n69_), .O(new_n70_));
  nand4  g46(.a(new_n70_), .b(new_n47_), .c(new_n46_), .d(new_n37_), .O(z5));
  ...
  oai21  g51(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n76_));
  ...
  nand4  g60(.a(new_n47_), .b(new_n55_), .c(new_n46_), .d(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n29_), .O(new_n87_));
  oai21  g63(.a(new_n26_), .b(x01), .c(new_n55_), .O(new_n88_));
  ...
  aoi21  g68(.a(new_n56_), .b(new_n37_), .c(x10), .O(new_n93_));
