...
module FAU ( 
  ...
  oai21  g40(.a(new_n60_), .b(x10), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  inv1   g42(.a(x12), .O(new_n67_));
  nand4  g43(.a(x13), .b(new_n67_), .c(new_n47_), .d(new_n37_), .O(new_n68_));
  inv1   g44(.a(new_n68_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n46_), .O(z5));
  ...
  nand3  g59(.a(new_n54_), .b(new_n46_), .c(x02), .O(new_n84_));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(x01), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x07), .c(new_n47_), .O(new_n87_));
  aoi21  g63(.a(x03), .b(new_n29_), .c(x08), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x10), .c(new_n46_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n87_), .O(z7));
  nand4  g66(.a(new_n67_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n91_));
  oai21  g67(.a(x09), .b(x00), .c(new_n47_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(x09), .c(new_n92_), .O(new_n93_));
  nand2  g69(.a(new_n47_), .b(x07), .O(new_n94_));
  oai21  g70(.a(new_n93_), .b(x07), .c(new_n94_), .O(z8));
endmodule
