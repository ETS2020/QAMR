...
module FAU ( 
  ...
  oai22  g25(.a(new_n49_), .b(x02), .c(new_n45_), .d(new_n26_), .O(new_n50_));
  ...
  aoi22  g32(.a(new_n56_), .b(x07), .c(x12), .d(new_n26_), .O(z3));
  oai21  g33(.a(new_n55_), .b(x10), .c(x07), .O(new_n58_));
  inv1   g34(.a(x07), .O(new_n59_));
  nand3  g35(.a(x09), .b(x08), .c(x00), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n58_), .O(z4));
  inv1   g38(.a(x12), .O(new_n63_));
  nand4  g39(.a(x13), .b(new_n63_), .c(new_n47_), .d(new_n26_), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n59_), .O(new_n65_));
  oai21  g41(.a(x10), .b(new_n59_), .c(new_n65_), .O(z5));
  nor2   g42(.a(new_n45_), .b(new_n26_), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(x03), .c(new_n30_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n27_), .O(new_n70_));
  nand3  g46(.a(new_n68_), .b(x03), .c(new_n30_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n70_), .c(new_n67_), .O(new_n72_));
  nand2  g48(.a(x14), .b(x02), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n26_), .O(new_n74_));
  nand2  g50(.a(new_n45_), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(new_n27_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n72_), .c(new_n47_), .O(new_n77_));
  nor2   g53(.a(new_n77_), .b(x07), .O(z6));
  aoi21  g54(.a(new_n45_), .b(x02), .c(x10), .O(new_n79_));
  oai21  g55(.a(new_n37_), .b(x01), .c(new_n45_), .O(new_n80_));
  nand4  g56(.a(x09), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(new_n59_), .O(z7));
  aoi21  g58(.a(x12), .b(x09), .c(x07), .O(new_n83_));
  nand3  g59(.a(x03), .b(new_n30_), .c(new_n27_), .O(new_n84_));
  oai21  g60(.a(x09), .b(x00), .c(new_n47_), .O(new_n85_));
  aoi21  g61(.a(new_n84_), .b(x09), .c(new_n85_), .O(new_n86_));
  oai22  g62(.a(new_n86_), .b(x07), .c(new_n83_), .d(x10), .O(z8));
endmodule
