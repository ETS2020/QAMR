...
module FAU ( 
  ...
  nand2  g06(.a(x07), .b(x03), .O(new_n31_));
  ...
  nor2   g23(.a(new_n47_), .b(new_n33_), .O(new_n48_));
  aoi21  g24(.a(new_n46_), .b(new_n25_), .c(new_n48_), .O(new_n49_));
  nand4  g25(.a(x10), .b(new_n47_), .c(new_n34_), .d(new_n44_), .O(new_n50_));
  inv1   g26(.a(new_n50_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n49_), .c(new_n43_), .O(new_n52_));
  nor2   g28(.a(x10), .b(x07), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(x01), .c(new_n25_), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n34_), .c(new_n33_), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n52_), .O(z2));
  inv1   g32(.a(x11), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n43_), .c(x00), .O(new_n58_));
  inv1   g34(.a(x12), .O(new_n59_));
  oai21  g35(.a(x07), .b(x00), .c(x11), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n58_), .c(new_n31_), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n43_), .O(new_n64_));
  nand3  g40(.a(new_n57_), .b(x07), .c(new_n34_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  nor3   g42(.a(x12), .b(x10), .c(x00), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(x13), .c(new_n43_), .O(z5));
  inv1   g44(.a(x09), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x03), .c(new_n25_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n43_), .c(new_n44_), .O(new_n71_));
  nand3  g47(.a(new_n69_), .b(x03), .c(new_n25_), .O(new_n72_));
  aoi21  g48(.a(new_n72_), .b(new_n71_), .c(new_n48_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n43_), .c(x01), .O(new_n78_));
  inv1   g54(.a(new_n78_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n73_), .c(new_n45_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n31_), .O(z6));
  oai21  g57(.a(new_n47_), .b(x07), .c(new_n34_), .O(new_n82_));
  oai21  g58(.a(x02), .b(x01), .c(new_n47_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n25_), .d(new_n44_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n83_), .c(new_n45_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n43_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n82_), .O(z7));
  oai21  g63(.a(x09), .b(x07), .c(new_n34_), .O(new_n88_));
  nor2   g64(.a(x12), .b(x02), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n44_), .c(new_n69_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n45_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n88_), .O(z8));
endmodule
