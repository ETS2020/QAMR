...
module FAU ( 
  ...
  oai21  g27(.a(x12), .b(new_n47_), .c(new_n25_), .O(new_n52_));
  ...
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n47_), .O(z5));
  inv1   g46(.a(x08), .O(new_n71_));
  inv1   g47(.a(x09), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x03), .O(new_n73_));
  aoi21  g49(.a(new_n73_), .b(new_n28_), .c(new_n38_), .O(new_n74_));
  nand3  g50(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n29_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n74_), .c(new_n71_), .O(new_n77_));
  oai21  g53(.a(new_n72_), .b(x03), .c(new_n28_), .O(new_n78_));
  ...
  nand4  g62(.a(new_n86_), .b(new_n66_), .c(new_n25_), .d(new_n47_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(z6));
  nor2   g64(.a(x08), .b(x07), .O(new_n89_));
  nand3  g65(.a(x09), .b(x03), .c(new_n33_), .O(new_n90_));
  nand4  g66(.a(new_n25_), .b(new_n71_), .c(new_n47_), .d(x01), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x02), .O(new_n92_));
  aoi21  g68(.a(new_n89_), .b(x02), .c(new_n92_), .O(new_n93_));
  aoi21  g69(.a(new_n71_), .b(new_n27_), .c(x07), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n66_), .d(new_n25_), .O(z7));
  nand3  g71(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g73(.a(new_n72_), .b(new_n38_), .c(x07), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n97_), .c(new_n69_), .O(z8));
endmodule
