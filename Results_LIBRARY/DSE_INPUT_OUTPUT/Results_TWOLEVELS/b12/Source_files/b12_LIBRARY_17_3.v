...
module FAU ( 
  ...
  aoi21  g65(.a(new_n59_), .b(x02), .c(x10), .O(new_n90_));
  oai21  g66(.a(new_n39_), .b(x01), .c(new_n59_), .O(new_n91_));
  nand4  g67(.a(x09), .b(x03), .c(new_n31_), .d(new_n27_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n51_), .O(z7));
  aoi21  g69(.a(x12), .b(x09), .c(x07), .O(new_n94_));
  nand3  g70(.a(x03), .b(new_n31_), .c(new_n27_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n52_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  oai22  g73(.a(new_n97_), .b(x07), .c(new_n94_), .d(x10), .O(z8));
endmodule
