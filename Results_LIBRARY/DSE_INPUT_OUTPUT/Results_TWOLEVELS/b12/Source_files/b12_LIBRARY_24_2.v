...
module FAU ( 
  ...
  oai22  g45(.a(new_n69_), .b(x00), .c(new_n68_), .d(new_n50_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n26_), .O(z3));
  oai21  g47(.a(x13), .b(new_n51_), .c(new_n40_), .O(new_n72_));
  nand2  g48(.a(new_n26_), .b(new_n61_), .O(new_n73_));
  nand2  g49(.a(x01), .b(x00), .O(new_n74_));
  nand2  g50(.a(x09), .b(new_n33_), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(new_n74_), .c(x10), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x13), .c(new_n60_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n73_), .c(new_n72_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n50_), .O(new_n79_));
  nand3  g55(.a(new_n26_), .b(new_n68_), .c(x07), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(z4));
  oai21  g57(.a(x12), .b(x10), .c(x13), .O(new_n82_));
  nand3  g58(.a(x13), .b(new_n50_), .c(new_n40_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n51_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n82_), .O(z5));
  nor2   g61(.a(new_n60_), .b(new_n40_), .O(new_n86_));
  oai21  g62(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n33_), .O(new_n88_));
  nand3  g64(.a(new_n61_), .b(x03), .c(new_n28_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(new_n86_), .O(new_n90_));
  nand2  g66(.a(x14), .b(x02), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n40_), .O(new_n92_));
  nand2  g68(.a(new_n60_), .b(x00), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(new_n33_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n90_), .c(new_n51_), .O(new_n95_));
  nor2   g71(.a(new_n95_), .b(x07), .O(z6));
  aoi21  g72(.a(x03), .b(new_n33_), .c(x10), .O(new_n97_));
  nor2   g73(.a(x07), .b(new_n28_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n97_), .c(new_n60_), .O(new_n99_));
  nand4  g75(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n100_));
  nand4  g76(.a(new_n100_), .b(new_n99_), .c(new_n51_), .d(new_n50_), .O(z7));
  nand4  g77(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n102_));
  oai21  g78(.a(x09), .b(x00), .c(new_n50_), .O(new_n103_));
  aoi21  g79(.a(new_n102_), .b(x09), .c(new_n103_), .O(new_n104_));
  nand2  g80(.a(x13), .b(x10), .O(new_n105_));
