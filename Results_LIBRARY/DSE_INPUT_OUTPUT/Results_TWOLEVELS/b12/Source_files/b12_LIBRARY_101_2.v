...
module FAU ( 
  ...
  nand2  g54(.a(new_n46_), .b(x02), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x03), .c(new_n28_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n53_), .O(new_n81_));
  nand4  g57(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n25_), .d(new_n46_), .O(z7));
  nand4  g59(.a(new_n63_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n84_));
