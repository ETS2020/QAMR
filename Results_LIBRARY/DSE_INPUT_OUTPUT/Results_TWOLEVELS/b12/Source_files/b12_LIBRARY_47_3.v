...
module FAU ( 
  ...
  nand2  g11(.a(x10), .b(x04), .O(new_n36_));
  ...
  and2   g38(.a(x11), .b(x07), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  aoi22  g40(.a(new_n36_), .b(x00), .c(new_n64_), .d(new_n30_), .O(new_n65_));
  oai21  g41(.a(x07), .b(x00), .c(x11), .O(new_n66_));
  nand3  g42(.a(new_n66_), .b(new_n64_), .c(new_n57_), .O(new_n67_));
  oai21  g43(.a(new_n65_), .b(new_n63_), .c(new_n67_), .O(z3));
  nor2   g44(.a(x09), .b(x07), .O(new_n69_));
  nor2   g45(.a(x11), .b(new_n50_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(new_n71_));
  aoi21  g47(.a(x08), .b(x00), .c(x04), .O(new_n72_));
  nor2   g48(.a(x09), .b(x01), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x08), .c(x00), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n57_), .c(new_n72_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x07), .c(new_n71_), .O(z4));
  nand4  g52(.a(x13), .b(new_n64_), .c(new_n50_), .d(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n57_), .O(new_n78_));
  nand2  g54(.a(x10), .b(new_n30_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n78_), .O(z5));
  oai21  g56(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n29_), .O(new_n82_));
  nand3  g58(.a(new_n51_), .b(x03), .c(new_n27_), .O(new_n83_));
  aoi22  g59(.a(new_n83_), .b(new_n82_), .c(x08), .d(x00), .O(new_n84_));
  nand2  g60(.a(x14), .b(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n25_), .O(new_n86_));
  inv1   g62(.a(x08), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(x00), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n86_), .c(new_n29_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n84_), .c(new_n57_), .O(new_n90_));
  nor2   g66(.a(new_n90_), .b(x07), .O(z6));
  nand3  g67(.a(new_n87_), .b(new_n50_), .c(x02), .O(new_n92_));
  nand3  g68(.a(x09), .b(x03), .c(new_n27_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n92_), .c(x01), .O(new_n94_));
  aoi21  g70(.a(new_n50_), .b(x01), .c(new_n26_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x08), .c(new_n50_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n94_), .c(new_n57_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n79_), .O(z7));
  oai21  g74(.a(new_n26_), .b(x02), .c(new_n50_), .O(new_n99_));
  nor2   g75(.a(x12), .b(x01), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(new_n99_), .c(new_n51_), .O(new_n101_));
  oai21  g77(.a(x09), .b(x00), .c(new_n50_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(new_n101_), .c(new_n57_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n79_), .O(z8));
endmodule
