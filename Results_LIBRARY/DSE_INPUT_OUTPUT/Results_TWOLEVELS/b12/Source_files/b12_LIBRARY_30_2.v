...
module FAU ( 
  ...
  aoi21  g52(.a(new_n75_), .b(new_n61_), .c(x08), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(new_n76_), .c(new_n29_), .O(new_n78_));
  inv1   g54(.a(x09), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(x03), .c(x01), .O(new_n80_));
  nand3  g56(.a(new_n79_), .b(new_n57_), .c(x03), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(x00), .c(new_n81_), .O(new_n82_));
  nor2   g58(.a(x14), .b(x00), .O(new_n83_));
  aoi21  g59(.a(new_n57_), .b(x00), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n29_), .c(new_n36_), .O(new_n85_));
  aoi21  g61(.a(new_n82_), .b(new_n27_), .c(new_n85_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n78_), .c(x10), .O(z6));
