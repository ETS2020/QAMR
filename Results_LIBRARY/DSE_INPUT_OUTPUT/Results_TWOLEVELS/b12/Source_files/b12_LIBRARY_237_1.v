...
module FAU ( 
  ...
  nand4  g65(.a(new_n36_), .b(new_n55_), .c(new_n50_), .d(x02), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n29_), .O(new_n92_));
  aoi21  g68(.a(new_n55_), .b(x01), .c(x10), .O(new_n93_));
  nand2  g69(.a(new_n55_), .b(new_n26_), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n92_), .d(new_n50_), .O(z7));
