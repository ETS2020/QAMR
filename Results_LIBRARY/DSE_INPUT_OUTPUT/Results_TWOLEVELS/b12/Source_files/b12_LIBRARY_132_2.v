...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n80_, new_n82_, new_n83_, new_n84_, new_n86_;
  ...
  aoi21  g37(.a(new_n25_), .b(x09), .c(x00), .O(new_n62_));
  oai22  g38(.a(new_n25_), .b(x08), .c(x09), .d(new_n38_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(new_n62_), .c(new_n47_), .O(new_n64_));
  inv1   g40(.a(x09), .O(new_n65_));
  aoi21  g41(.a(x10), .b(x07), .c(new_n65_), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(x11), .c(new_n64_), .O(z4));
  nand4  g43(.a(x13), .b(new_n58_), .c(new_n47_), .d(new_n38_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n25_), .O(z5));
  nand2  g46(.a(new_n27_), .b(new_n28_), .O(new_n71_));
  nor2   g47(.a(x01), .b(x00), .O(new_n72_));
  nor2   g48(.a(x08), .b(new_n38_), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(new_n71_), .O(new_n74_));
  nor2   g50(.a(x02), .b(new_n33_), .O(new_n75_));
  nor2   g51(.a(x14), .b(new_n28_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n75_), .c(new_n38_), .O(new_n77_));
  nand3  g53(.a(new_n75_), .b(new_n65_), .c(new_n53_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n74_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n47_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n65_), .c(x10), .O(z6));
  aoi21  g57(.a(new_n25_), .b(x01), .c(x02), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x07), .c(x03), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n53_), .c(x07), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x09), .c(new_n25_), .O(z7));
  oai21  g61(.a(x07), .b(new_n38_), .c(new_n65_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n25_), .O(z8));
endmodule
