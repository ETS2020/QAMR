...
module FAU ( 
  ...
  nand4  g50(.a(x13), .b(new_n74_), .c(new_n45_), .d(new_n38_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x14), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n55_), .O(z5));
  inv1   g53(.a(x09), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(x03), .c(x01), .O(new_n79_));
  nor2   g55(.a(x02), .b(x00), .O(new_n80_));
  aoi21  g56(.a(new_n46_), .b(x00), .c(new_n80_), .O(new_n81_));
  oai21  g57(.a(new_n78_), .b(x03), .c(new_n28_), .O(new_n82_));
  nand2  g58(.a(x08), .b(x00), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n30_), .O(new_n84_));
  oai21  g60(.a(new_n81_), .b(new_n79_), .c(new_n84_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(x14), .c(new_n55_), .d(new_n45_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n28_), .O(new_n88_));
  nand4  g64(.a(new_n55_), .b(new_n46_), .c(new_n45_), .d(x02), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n27_), .b(x01), .c(new_n46_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n45_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n90_), .c(x14), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n55_), .O(z7));
  nand4  g70(.a(new_n74_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n95_));
  oai21  g71(.a(x09), .b(x00), .c(new_n45_), .O(new_n96_));
  aoi21  g72(.a(new_n95_), .b(x09), .c(new_n96_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n49_), .c(new_n55_), .O(z8));
endmodule
