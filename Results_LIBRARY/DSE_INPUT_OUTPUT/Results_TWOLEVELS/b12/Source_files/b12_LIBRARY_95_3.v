...
module FAU ( 
  ...
  nand2  g32(.a(new_n48_), .b(x07), .O(new_n57_));
  ...
  nand3  g38(.a(new_n62_), .b(new_n36_), .c(x02), .O(new_n63_));
  ...
  nand3  g47(.a(new_n71_), .b(new_n70_), .c(new_n36_), .O(z4));
  nor2   g48(.a(new_n50_), .b(x12), .O(new_n73_));
  nand2  g49(.a(new_n47_), .b(x00), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(new_n57_), .d(new_n36_), .O(z5));
  inv1   g51(.a(x08), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(new_n25_), .O(new_n77_));
  ...
  nand2  g60(.a(new_n76_), .b(x00), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(new_n84_), .c(new_n29_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n82_), .c(new_n48_), .O(new_n87_));
  nor2   g63(.a(new_n87_), .b(x07), .O(z6));
  aoi21  g64(.a(new_n76_), .b(x02), .c(x07), .O(new_n89_));
  oai21  g65(.a(new_n26_), .b(x01), .c(new_n76_), .O(new_n90_));
  nand4  g66(.a(x09), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n48_), .O(z7));
  nand3  g68(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n47_), .c(x12), .O(new_n94_));
  aoi21  g70(.a(new_n78_), .b(new_n25_), .c(x07), .O(new_n95_));
  oai21  g71(.a(new_n94_), .b(new_n78_), .c(new_n95_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n48_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n56_), .O(z8));
endmodule
