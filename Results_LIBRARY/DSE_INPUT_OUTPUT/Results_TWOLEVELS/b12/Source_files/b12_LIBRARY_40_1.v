...
module FAU ( 
  ...
  oai21  g35(.a(new_n53_), .b(new_n48_), .c(x00), .O(new_n60_));
  inv1   g36(.a(x12), .O(new_n61_));
  oai21  g37(.a(new_n53_), .b(new_n48_), .c(new_n61_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n60_), .c(new_n37_), .O(z3));
  inv1   g39(.a(x08), .O(new_n64_));
  nand2  g40(.a(x09), .b(new_n29_), .O(new_n65_));
  aoi21  g41(.a(new_n65_), .b(new_n28_), .c(x11), .O(new_n66_));
  oai22  g42(.a(new_n66_), .b(x10), .c(new_n64_), .d(new_n25_), .O(new_n67_));
  inv1   g43(.a(x09), .O(new_n68_));
  nor2   g44(.a(x11), .b(x08), .O(new_n69_));
  aoi22  g45(.a(new_n69_), .b(x02), .c(x10), .d(new_n68_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n48_), .O(new_n72_));
  nor2   g48(.a(new_n27_), .b(x00), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n48_), .O(new_n74_));
  oai21  g50(.a(new_n74_), .b(new_n73_), .c(new_n53_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n72_), .O(z4));
  nand4  g52(.a(x13), .b(new_n61_), .c(new_n48_), .d(new_n25_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n53_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n36_), .O(z5));
  nand2  g55(.a(new_n68_), .b(x03), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n27_), .c(new_n25_), .O(new_n81_));
  nand3  g57(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n28_), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(new_n81_), .c(new_n64_), .O(new_n84_));
  nand2  g60(.a(x14), .b(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(x01), .O(new_n86_));
  oai21  g62(.a(new_n68_), .b(x03), .c(new_n27_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n29_), .O(new_n88_));
  nand3  g64(.a(new_n68_), .b(x03), .c(new_n27_), .O(new_n89_));
  ...
  nand4  g68(.a(new_n92_), .b(new_n53_), .c(new_n36_), .d(new_n48_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  nand3  g70(.a(x09), .b(x03), .c(new_n29_), .O(new_n95_));
  nand2  g71(.a(new_n48_), .b(x01), .O(new_n96_));
  nand2  g72(.a(new_n49_), .b(new_n64_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(new_n95_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n27_), .O(new_n99_));
  nand3  g75(.a(new_n53_), .b(new_n48_), .c(x02), .O(new_n100_));
  aoi21  g76(.a(new_n100_), .b(x03), .c(x08), .O(new_n101_));
  nor4   g77(.a(new_n101_), .b(x11), .c(x10), .d(x07), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n99_), .O(z7));
  nand4  g79(.a(new_n61_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(x09), .O(new_n105_));
  aoi21  g81(.a(new_n68_), .b(new_n25_), .c(x10), .O(new_n106_));
  nand4  g82(.a(new_n106_), .b(new_n105_), .c(new_n54_), .d(new_n37_), .O(z8));
endmodule
