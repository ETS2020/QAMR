...
module FAU ( 
  ...
  aoi21  g44(.a(x12), .b(new_n39_), .c(new_n68_), .O(z3));
  oai21  g45(.a(new_n60_), .b(new_n39_), .c(new_n67_), .O(new_n70_));
  nand2  g46(.a(x01), .b(x00), .O(new_n71_));
  oai21  g47(.a(new_n60_), .b(x01), .c(new_n71_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n50_), .c(new_n49_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n75_), .c(new_n70_), .O(z4));
  inv1   g54(.a(x12), .O(new_n79_));
  nor2   g55(.a(x07), .b(x00), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(x13), .c(new_n79_), .d(new_n50_), .O(z5));
  ...
  nand2  g74(.a(new_n76_), .b(x10), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n98_), .O(z7));
  oai21  g76(.a(new_n26_), .b(x01), .c(new_n49_), .O(new_n101_));
  nor2   g77(.a(x12), .b(x02), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(new_n101_), .c(new_n60_), .O(new_n103_));
  oai21  g79(.a(x09), .b(x00), .c(new_n49_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(new_n103_), .c(new_n50_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n99_), .O(z8));
endmodule
