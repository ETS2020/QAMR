...
module FAU ( 
  ...
  oai22  g48(.a(new_n30_), .b(new_n72_), .c(x12), .d(new_n26_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  inv1   g50(.a(x12), .O(new_n75_));
  oai21  g51(.a(x07), .b(x00), .c(x11), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(x05), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n74_), .O(z3));
  nor2   g54(.a(x09), .b(x07), .O(new_n79_));
  nor2   g55(.a(x11), .b(new_n54_), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(new_n66_), .O(new_n81_));
  aoi21  g57(.a(x08), .b(x00), .c(new_n26_), .O(new_n82_));
  inv1   g58(.a(x09), .O(new_n83_));
  nand2  g59(.a(x01), .b(x00), .O(new_n84_));
  oai21  g60(.a(new_n83_), .b(x01), .c(new_n84_), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n26_), .c(new_n62_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(x00), .c(new_n25_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n82_), .c(new_n54_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n81_), .O(z4));
  nand4  g65(.a(x13), .b(new_n75_), .c(new_n54_), .d(new_n72_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x05), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n26_), .O(z5));
  oai21  g68(.a(x09), .b(new_n29_), .c(new_n34_), .O(new_n93_));
  nor2   g69(.a(x02), .b(x00), .O(new_n94_));
  nor2   g70(.a(x08), .b(new_n72_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(new_n94_), .c(new_n93_), .O(new_n96_));
  nand2  g72(.a(x08), .b(x00), .O(new_n97_));
  oai21  g73(.a(new_n83_), .b(x03), .c(new_n41_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n97_), .c(new_n34_), .O(new_n99_));
  inv1   g75(.a(x14), .O(new_n100_));
  nand3  g76(.a(new_n100_), .b(x01), .c(new_n72_), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(new_n99_), .c(new_n96_), .O(new_n102_));
  nand4  g78(.a(new_n102_), .b(new_n26_), .c(new_n54_), .d(x05), .O(new_n103_));
  inv1   g79(.a(new_n103_), .O(z6));
  nand3  g80(.a(x09), .b(x03), .c(new_n41_), .O(new_n105_));
  nand2  g81(.a(x05), .b(x02), .O(new_n106_));
  nand3  g82(.a(new_n26_), .b(new_n62_), .c(new_n54_), .O(new_n107_));
  oai21  g83(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(new_n108_));
  nand2  g84(.a(new_n108_), .b(new_n34_), .O(new_n109_));
  aoi21  g85(.a(x03), .b(new_n34_), .c(x08), .O(new_n110_));
  nor3   g86(.a(new_n110_), .b(new_n57_), .c(new_n25_), .O(new_n111_));
  nand2  g87(.a(new_n111_), .b(new_n109_), .O(z7));
  nand4  g88(.a(new_n75_), .b(x03), .c(new_n41_), .d(new_n34_), .O(new_n113_));
  oai21  g89(.a(x09), .b(x00), .c(new_n54_), .O(new_n114_));
  aoi21  g90(.a(new_n113_), .b(x09), .c(new_n114_), .O(new_n115_));
  oai21  g91(.a(new_n115_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
