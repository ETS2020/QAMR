...
module FAU ( 
  ...
  oai21  g48(.a(new_n25_), .b(new_n48_), .c(new_n72_), .O(z5));
  ...
  oai21  g53(.a(new_n56_), .b(x03), .c(new_n28_), .O(new_n78_));
  ...
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n77_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n48_), .c(new_n47_), .O(new_n83_));
  inv1   g59(.a(new_n83_), .O(z6));
  nand2  g60(.a(new_n47_), .b(x02), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(x03), .c(new_n30_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n55_), .O(new_n87_));
  nand4  g63(.a(x09), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n88_));
  nand4  g64(.a(new_n88_), .b(new_n87_), .c(new_n48_), .d(new_n47_), .O(z7));
  nand4  g65(.a(new_n64_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nand2  g67(.a(new_n56_), .b(new_n38_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n48_), .d(new_n47_), .O(z8));
endmodule
