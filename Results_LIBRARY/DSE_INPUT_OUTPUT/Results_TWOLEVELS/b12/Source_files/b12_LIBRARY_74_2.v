...
module FAU ( 
  ...
  oai21  g54(.a(new_n50_), .b(x03), .c(new_n28_), .O(new_n79_));
  nand2  g55(.a(x08), .b(x00), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n79_), .c(new_n30_), .O(new_n81_));
  ...
  nand3  g60(.a(new_n84_), .b(new_n25_), .c(new_n57_), .O(new_n85_));
  inv1   g61(.a(new_n85_), .O(z6));
  nand3  g62(.a(x09), .b(x03), .c(new_n28_), .O(new_n87_));
  nand3  g63(.a(new_n25_), .b(new_n58_), .c(x02), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(x01), .O(new_n89_));
  aoi21  g65(.a(x03), .b(new_n30_), .c(x08), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n57_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n25_), .O(z7));
  nand4  g68(.a(new_n66_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n50_), .b(new_n40_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n25_), .d(new_n57_), .O(z8));
endmodule
