...
module FAU ( 
  ...
  aoi21  g22(.a(new_n31_), .b(x02), .c(new_n27_), .O(new_n47_));
  inv1   g23(.a(x07), .O(new_n48_));
  inv1   g24(.a(x08), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n48_), .c(new_n27_), .O(new_n50_));
  oai21  g26(.a(new_n47_), .b(x00), .c(new_n50_), .O(new_n51_));
  nand2  g27(.a(new_n51_), .b(x10), .O(new_n52_));
  nor2   g28(.a(x10), .b(x07), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(x04), .c(x02), .O(new_n54_));
  nand2  g30(.a(new_n25_), .b(x09), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n38_), .O(new_n57_));
  nand3  g33(.a(new_n25_), .b(x09), .c(new_n49_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n57_), .c(new_n52_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n30_), .O(new_n60_));
  inv1   g36(.a(new_n26_), .O(new_n61_));
  nand2  g37(.a(new_n49_), .b(new_n48_), .O(new_n62_));
  aoi21  g38(.a(new_n26_), .b(x01), .c(new_n34_), .O(new_n63_));
  oai21  g39(.a(new_n63_), .b(x00), .c(new_n62_), .O(new_n64_));
  aoi21  g40(.a(new_n64_), .b(x02), .c(new_n61_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n60_), .O(z2));
  inv1   g42(.a(x11), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(new_n48_), .c(x00), .O(new_n68_));
  inv1   g44(.a(x12), .O(new_n69_));
  oai21  g45(.a(x07), .b(x00), .c(x11), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g47(.a(new_n71_), .b(new_n68_), .c(new_n26_), .O(z3));
  nand3  g48(.a(x09), .b(x08), .c(x00), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n48_), .O(new_n74_));
  oai21  g50(.a(new_n67_), .b(new_n25_), .c(x07), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(new_n74_), .O(z4));
  nand3  g52(.a(x13), .b(new_n69_), .c(new_n38_), .O(new_n77_));
  ...
  nand3  g66(.a(new_n90_), .b(new_n25_), .c(new_n48_), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(z6));
  nand3  g68(.a(x09), .b(x03), .c(new_n28_), .O(new_n93_));
  nand4  g69(.a(new_n25_), .b(new_n49_), .c(new_n48_), .d(x02), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n30_), .O(new_n96_));
  nand2  g72(.a(x03), .b(new_n30_), .O(new_n97_));
  nand2  g73(.a(new_n25_), .b(new_n48_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(new_n49_), .c(new_n98_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n96_), .O(z7));
  nand4  g76(.a(new_n69_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g78(.a(new_n84_), .b(new_n38_), .c(new_n98_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n102_), .O(z8));
endmodule
