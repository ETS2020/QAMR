...
module FAU ( 
  ...
  oai21  g20(.a(new_n27_), .b(x02), .c(new_n38_), .O(new_n45_));
  inv1   g21(.a(x07), .O(new_n46_));
  inv1   g22(.a(x08), .O(new_n47_));
  nand3  g23(.a(new_n47_), .b(new_n46_), .c(new_n27_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(new_n45_), .c(new_n25_), .O(new_n49_));
  oai21  g25(.a(x09), .b(x02), .c(new_n38_), .O(new_n50_));
  nand2  g26(.a(x09), .b(new_n47_), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n50_), .c(x10), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(new_n49_), .c(new_n30_), .O(new_n53_));
  nand2  g29(.a(new_n47_), .b(new_n46_), .O(new_n54_));
  oai21  g30(.a(x05), .b(new_n31_), .c(new_n30_), .O(new_n55_));
  nand3  g31(.a(new_n55_), .b(new_n26_), .c(new_n38_), .O(new_n56_));
  ...
  nand2  g36(.a(new_n60_), .b(x10), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(x07), .c(x12), .d(new_n38_), .O(z3));
  oai21  g38(.a(new_n60_), .b(new_n25_), .c(x07), .O(new_n63_));
  ...
  nand3  g44(.a(new_n68_), .b(x13), .c(new_n67_), .O(z5));
  oai21  g45(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n70_));
  nor2   g46(.a(x02), .b(x00), .O(new_n71_));
  nor2   g47(.a(x08), .b(new_n38_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(new_n73_));
  nand2  g49(.a(x09), .b(new_n27_), .O(new_n74_));
  and2   g50(.a(x08), .b(x00), .O(new_n75_));
  aoi21  g51(.a(new_n74_), .b(new_n28_), .c(new_n75_), .O(new_n76_));
  inv1   g52(.a(x14), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x01), .c(new_n38_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n46_), .O(new_n79_));
  aoi21  g55(.a(new_n76_), .b(new_n30_), .c(new_n79_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n73_), .c(x10), .O(z6));
  nand3  g57(.a(x09), .b(x03), .c(new_n28_), .O(new_n82_));
  nand3  g58(.a(new_n25_), .b(new_n47_), .c(x02), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n30_), .O(new_n85_));
  nand2  g61(.a(x03), .b(new_n30_), .O(new_n86_));
  nand2  g62(.a(new_n25_), .b(new_n46_), .O(new_n87_));
  aoi21  g63(.a(new_n86_), .b(new_n47_), .c(new_n87_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n85_), .O(z7));
  nand4  g65(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(x09), .O(new_n91_));
  nor2   g67(.a(x09), .b(x00), .O(new_n92_));
  nor2   g68(.a(new_n92_), .b(new_n87_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n91_), .O(z8));
endmodule
