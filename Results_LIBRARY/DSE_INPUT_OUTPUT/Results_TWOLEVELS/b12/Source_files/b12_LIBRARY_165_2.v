...
module FAU ( 
  ...
  nand3  g23(.a(new_n47_), .b(new_n45_), .c(new_n27_), .O(new_n48_));
  ...
  aoi21  g28(.a(new_n52_), .b(new_n45_), .c(new_n49_), .O(new_n53_));
  ...
  oai21  g34(.a(new_n53_), .b(x01), .c(new_n58_), .O(z2));
  ...
  oai21  g40(.a(new_n61_), .b(new_n45_), .c(new_n64_), .O(z4));
  inv1   g41(.a(x13), .O(new_n66_));
  aoi21  g42(.a(x12), .b(new_n38_), .c(new_n66_), .O(new_n67_));
  nand4  g43(.a(new_n67_), .b(new_n25_), .c(new_n45_), .d(new_n38_), .O(z5));
  nand2  g44(.a(new_n45_), .b(x02), .O(new_n69_));
  nand2  g45(.a(x09), .b(new_n27_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n69_), .c(x00), .O(new_n71_));
  nor2   g47(.a(x08), .b(new_n28_), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n30_), .O(new_n73_));
  oai21  g49(.a(x09), .b(new_n27_), .c(new_n30_), .O(new_n74_));
  nand2  g50(.a(new_n28_), .b(new_n38_), .O(new_n75_));
  oai21  g51(.a(x08), .b(new_n38_), .c(new_n75_), .O(new_n76_));
  nand4  g52(.a(x09), .b(new_n47_), .c(new_n27_), .d(x00), .O(new_n77_));
  inv1   g53(.a(x14), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(x01), .c(new_n38_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n77_), .c(new_n45_), .O(new_n80_));
  aoi21  g56(.a(new_n76_), .b(new_n74_), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n73_), .c(x10), .O(z6));
  nand3  g58(.a(x09), .b(x03), .c(new_n28_), .O(new_n83_));
  nand3  g59(.a(new_n25_), .b(new_n47_), .c(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n30_), .O(new_n86_));
  oai21  g62(.a(new_n27_), .b(x01), .c(new_n47_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n86_), .c(new_n25_), .d(new_n45_), .O(z7));
  inv1   g64(.a(x12), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n90_));
  nor2   g66(.a(x09), .b(x00), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x07), .c(new_n25_), .O(z8));
endmodule
