...
module FAU ( 
  ...
  nor2   g50(.a(new_n65_), .b(new_n25_), .O(new_n75_));
  inv1   g51(.a(x09), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n29_), .O(new_n78_));
  nand3  g54(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n79_));
  aoi21  g55(.a(new_n79_), .b(new_n78_), .c(new_n75_), .O(new_n80_));
  nand2  g56(.a(x14), .b(x02), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n25_), .O(new_n82_));
  nand2  g58(.a(new_n65_), .b(x00), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(new_n29_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n80_), .c(new_n56_), .O(new_n85_));
  nor2   g61(.a(new_n85_), .b(x07), .O(z6));
  nand3  g62(.a(new_n65_), .b(new_n36_), .c(x02), .O(new_n87_));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n87_), .c(x01), .O(new_n89_));
  aoi21  g65(.a(x03), .b(new_n29_), .c(x08), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n89_), .c(new_n56_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n36_), .O(z7));
  oai21  g68(.a(new_n26_), .b(x02), .c(new_n36_), .O(new_n93_));
  nor2   g69(.a(x12), .b(x01), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n93_), .c(new_n76_), .O(new_n95_));
  nor2   g71(.a(x09), .b(x00), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n95_), .c(new_n56_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n36_), .O(z8));
endmodule
