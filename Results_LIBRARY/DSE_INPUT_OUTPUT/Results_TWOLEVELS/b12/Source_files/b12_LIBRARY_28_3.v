...
module FAU ( 
  ...
  nand4  g52(.a(x13), .b(new_n69_), .c(new_n50_), .d(new_n39_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n49_), .O(new_n78_));
  oai21  g54(.a(x10), .b(new_n49_), .c(new_n78_), .O(z5));
  ...
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n32_), .O(new_n87_));
  inv1   g63(.a(x14), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x01), .c(new_n39_), .O(new_n89_));
  ...
  nand2  g69(.a(new_n50_), .b(new_n59_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n63_), .c(new_n93_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n32_), .O(new_n96_));
  oai21  g72(.a(new_n26_), .b(x01), .c(new_n59_), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(new_n96_), .c(new_n50_), .d(new_n49_), .O(z7));
  aoi21  g74(.a(x09), .b(x02), .c(x07), .O(new_n99_));
  nand3  g75(.a(new_n69_), .b(x03), .c(new_n32_), .O(new_n100_));
  oai21  g76(.a(x09), .b(x00), .c(new_n50_), .O(new_n101_));
  aoi21  g77(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  oai22  g78(.a(new_n102_), .b(x07), .c(new_n99_), .d(x10), .O(z8));
endmodule
