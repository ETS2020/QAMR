...
module FAU ( 
  ...
  nor2   g38(.a(new_n25_), .b(x07), .O(new_n63_));
  nor2   g39(.a(x11), .b(x10), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n63_), .c(x00), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  nand2  g42(.a(x12), .b(new_n51_), .O(new_n67_));
  aoi22  g43(.a(new_n67_), .b(new_n25_), .c(new_n66_), .d(new_n55_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n65_), .O(z3));
  oai21  g45(.a(x10), .b(x07), .c(new_n25_), .O(new_n70_));
  nand3  g46(.a(x09), .b(x08), .c(x00), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n55_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n70_), .O(z4));
  nand3  g49(.a(x13), .b(new_n66_), .c(new_n55_), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n65_), .c(new_n49_), .O(z5));
  oai21  g52(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n77_));
  nor2   g53(.a(x02), .b(x00), .O(new_n78_));
  nor2   g54(.a(x08), .b(new_n38_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  oai21  g56(.a(new_n48_), .b(x03), .c(new_n28_), .O(new_n81_));
  ...
  nand3  g62(.a(new_n86_), .b(new_n51_), .c(new_n55_), .O(new_n87_));
  inv1   g63(.a(new_n87_), .O(z6));
  aoi21  g64(.a(new_n47_), .b(x02), .c(x07), .O(new_n89_));
  oai21  g65(.a(new_n27_), .b(x01), .c(new_n47_), .O(new_n90_));
  nand4  g66(.a(x09), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n91_));
  nand4  g67(.a(new_n91_), .b(new_n90_), .c(new_n89_), .d(new_n51_), .O(z7));
  nand4  g68(.a(new_n66_), .b(x03), .c(new_n28_), .d(new_n33_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n48_), .b(new_n38_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n51_), .d(new_n55_), .O(z8));
endmodule
