...
module FAU ( 
  ...
  nand3  g25(.a(new_n49_), .b(new_n48_), .c(x06), .O(new_n50_));
  ...
  nand2  g33(.a(x10), .b(new_n26_), .O(new_n58_));
  nand3  g34(.a(new_n49_), .b(x09), .c(x06), .O(new_n59_));
  ...
  aoi21  g38(.a(new_n62_), .b(new_n48_), .c(new_n36_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n57_), .O(z2));
  inv1   g40(.a(x12), .O(new_n65_));
  nand2  g41(.a(x11), .b(x07), .O(new_n66_));
  oai21  g42(.a(new_n65_), .b(x00), .c(new_n66_), .O(new_n67_));
  nand2  g43(.a(new_n67_), .b(new_n37_), .O(z3));
  aoi21  g44(.a(x09), .b(x00), .c(x07), .O(new_n69_));
  nor2   g45(.a(x11), .b(new_n48_), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(new_n69_), .c(new_n37_), .O(new_n71_));
  inv1   g47(.a(x08), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  nand2  g49(.a(x01), .b(x00), .O(new_n74_));
  oai21  g50(.a(new_n73_), .b(x01), .c(new_n74_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n49_), .c(x06), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n49_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n72_), .c(new_n48_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n71_), .O(z4));
  nand4  g55(.a(x13), .b(new_n65_), .c(new_n48_), .d(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x06), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n49_), .O(z5));
  ...
  oai21  g62(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n87_));
  ...
  nand4  g68(.a(new_n92_), .b(new_n49_), .c(new_n48_), .d(x06), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  nor2   g70(.a(x08), .b(x03), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x07), .c(x06), .O(new_n96_));
  oai21  g72(.a(x07), .b(new_n27_), .c(new_n29_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n72_), .O(new_n98_));
  nor2   g74(.a(x02), .b(x01), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(x09), .c(x03), .O(new_n100_));
  nor2   g76(.a(new_n36_), .b(x10), .O(new_n101_));
  nand4  g77(.a(new_n101_), .b(new_n100_), .c(new_n98_), .d(new_n96_), .O(z7));
  aoi21  g78(.a(new_n73_), .b(new_n25_), .c(x07), .O(new_n103_));
  nand3  g79(.a(new_n99_), .b(new_n65_), .c(x03), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(x09), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n103_), .c(new_n49_), .d(x06), .O(z8));
endmodule
