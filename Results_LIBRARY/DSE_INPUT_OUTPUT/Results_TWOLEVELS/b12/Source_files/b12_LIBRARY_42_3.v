...
module FAU ( 
  ...
  oai21  g41(.a(x10), .b(x07), .c(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(x00), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(new_n26_), .b(new_n47_), .c(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n28_), .O(z3));
  inv1   g46(.a(x09), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n40_), .c(new_n66_), .O(new_n72_));
  nand2  g48(.a(x01), .b(x00), .O(new_n73_));
  oai21  g49(.a(new_n71_), .b(x01), .c(new_n73_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n25_), .c(new_n47_), .O(new_n75_));
  nand2  g51(.a(new_n75_), .b(x11), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n48_), .O(new_n77_));
  nand2  g53(.a(new_n26_), .b(x07), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(z4));
  nand4  g55(.a(x13), .b(new_n68_), .c(new_n47_), .d(new_n40_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n25_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n60_), .O(z5));
  oai21  g58(.a(x09), .b(new_n29_), .c(new_n32_), .O(new_n83_));
  nor2   g59(.a(x02), .b(x00), .O(new_n84_));
  nor2   g60(.a(x08), .b(new_n40_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n84_), .c(new_n83_), .O(new_n86_));
  oai21  g62(.a(new_n71_), .b(x03), .c(new_n30_), .O(new_n87_));
  ...
  nand4  g75(.a(new_n68_), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n100_));
  oai21  g76(.a(x09), .b(x00), .c(new_n47_), .O(new_n101_));
  aoi21  g77(.a(new_n100_), .b(x09), .c(new_n101_), .O(new_n102_));
  oai21  g78(.a(new_n102_), .b(x10), .c(new_n60_), .O(z8));
endmodule
