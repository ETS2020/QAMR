...
module FAU ( 
  ...
  nand2  g11(.a(x11), .b(x10), .O(new_n36_));
  ...
  oai21  g40(.a(new_n64_), .b(x00), .c(new_n50_), .O(new_n65_));
  inv1   g41(.a(x09), .O(new_n66_));
  nand2  g42(.a(new_n48_), .b(new_n66_), .O(new_n67_));
  nand2  g43(.a(x12), .b(x09), .O(new_n68_));
  aoi21  g44(.a(new_n68_), .b(new_n67_), .c(new_n25_), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n64_), .c(new_n47_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n65_), .c(new_n36_), .O(z3));
  inv1   g47(.a(x08), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(x01), .O(new_n73_));
  nand3  g49(.a(x09), .b(new_n72_), .c(new_n29_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n73_), .c(x09), .d(x00), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n48_), .c(new_n47_), .O(new_n76_));
  nand4  g52(.a(x09), .b(x08), .c(new_n47_), .d(x00), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n50_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n76_), .O(z4));
  nand4  g55(.a(x13), .b(new_n64_), .c(new_n47_), .d(new_n25_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n48_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n56_), .O(z5));
  ...
  oai21  g62(.a(new_n66_), .b(x03), .c(new_n27_), .O(new_n87_));
  ...
  nand3  g68(.a(new_n92_), .b(new_n48_), .c(new_n47_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(z6));
  aoi21  g70(.a(new_n47_), .b(x02), .c(new_n26_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n29_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n72_), .O(new_n97_));
  nand4  g73(.a(x09), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n48_), .d(new_n47_), .O(z7));
  oai21  g75(.a(x12), .b(new_n66_), .c(new_n25_), .O(new_n100_));
  nand3  g76(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n101_));
  aoi21  g77(.a(new_n101_), .b(x09), .c(x07), .O(new_n102_));
  nand4  g78(.a(x12), .b(x09), .c(new_n47_), .d(x00), .O(new_n103_));
  nand4  g79(.a(new_n103_), .b(new_n102_), .c(new_n100_), .d(new_n48_), .O(z8));
endmodule
