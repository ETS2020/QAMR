...
module FAU ( 
  ...
  nand2  g39(.a(x12), .b(new_n37_), .O(new_n64_));
  ...
  oai22  g47(.a(x13), .b(x12), .c(x10), .d(new_n37_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n46_), .O(new_n73_));
  oai21  g49(.a(x12), .b(x07), .c(new_n47_), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n55_), .O(z5));
  ...
  nand3  g64(.a(new_n88_), .b(new_n46_), .c(x02), .O(new_n89_));
  ...
  nand2  g68(.a(new_n92_), .b(new_n46_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n91_), .c(new_n47_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n55_), .O(z7));
  inv1   g71(.a(x12), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(x03), .c(new_n27_), .d(new_n32_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n46_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x10), .c(new_n55_), .O(z8));
endmodule
