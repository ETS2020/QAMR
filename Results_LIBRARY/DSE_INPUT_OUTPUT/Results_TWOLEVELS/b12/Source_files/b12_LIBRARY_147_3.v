...
module FAU ( 
  ...
  nand2  g00(.a(x14), .b(x06), .O(new_n25_));
  ...
  oai21  g06(.a(x14), .b(x01), .c(x06), .O(new_n31_));
  ...
  aoi21  g24(.a(x14), .b(x06), .c(x04), .O(new_n49_));
  nor2   g25(.a(x14), .b(new_n38_), .O(new_n50_));
  oai21  g26(.a(new_n50_), .b(new_n49_), .c(x01), .O(new_n51_));
  inv1   g27(.a(x07), .O(new_n52_));
  inv1   g28(.a(x10), .O(new_n53_));
  oai21  g29(.a(x06), .b(x01), .c(x14), .O(new_n54_));
  nand3  g30(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n55_));
  nand3  g31(.a(new_n39_), .b(new_n38_), .c(x04), .O(new_n56_));
  nand4  g32(.a(new_n56_), .b(new_n55_), .c(new_n51_), .d(new_n48_), .O(new_n57_));
  ...
  inv1   g39(.a(new_n25_), .O(new_n64_));
  nor2   g40(.a(new_n53_), .b(x03), .O(new_n65_));
  oai21  g41(.a(new_n65_), .b(new_n60_), .c(new_n43_), .O(new_n66_));
  aoi21  g42(.a(new_n66_), .b(new_n34_), .c(x08), .O(new_n67_));
  aoi21  g43(.a(new_n67_), .b(new_n52_), .c(new_n64_), .O(new_n68_));
  oai21  g44(.a(new_n63_), .b(x00), .c(new_n68_), .O(z2));
  inv1   g45(.a(x11), .O(new_n70_));
  inv1   g46(.a(x00), .O(new_n71_));
  aoi21  g47(.a(x12), .b(new_n71_), .c(new_n64_), .O(new_n72_));
  oai21  g48(.a(new_n70_), .b(new_n52_), .c(new_n72_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n77_), .b(new_n76_), .c(new_n25_), .O(z4));
  inv1   g54(.a(x12), .O(new_n79_));
  nor3   g55(.a(x10), .b(x07), .c(x00), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n25_), .c(x13), .d(new_n79_), .O(z5));
  aoi21  g57(.a(new_n59_), .b(x03), .c(x01), .O(new_n82_));
  oai21  g58(.a(x06), .b(x02), .c(x14), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n71_), .O(new_n84_));
  inv1   g60(.a(x08), .O(new_n85_));
  oai21  g61(.a(x06), .b(new_n71_), .c(x14), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n84_), .c(new_n82_), .O(new_n88_));
  aoi21  g64(.a(x09), .b(new_n26_), .c(x02), .O(new_n89_));
  oai21  g65(.a(new_n85_), .b(new_n71_), .c(new_n54_), .O(new_n90_));
  nor2   g66(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n88_), .c(new_n53_), .O(new_n92_));
  nor2   g68(.a(new_n92_), .b(x07), .O(z6));
  nand3  g69(.a(new_n39_), .b(new_n53_), .c(new_n52_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(x06), .c(new_n43_), .O(new_n95_));
  oai22  g71(.a(new_n55_), .b(new_n34_), .c(new_n64_), .d(x03), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(new_n95_), .c(new_n85_), .O(new_n97_));
  nand4  g73(.a(x09), .b(x03), .c(new_n34_), .d(new_n43_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n53_), .c(new_n52_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n25_), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(new_n97_), .O(z7));
  nor2   g77(.a(x10), .b(x07), .O(new_n102_));
  nand4  g78(.a(new_n79_), .b(x03), .c(new_n34_), .d(new_n43_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(x09), .O(new_n104_));
  nand2  g80(.a(new_n59_), .b(new_n71_), .O(new_n105_));
  nand4  g81(.a(new_n105_), .b(new_n104_), .c(new_n102_), .d(new_n25_), .O(z8));
endmodule
