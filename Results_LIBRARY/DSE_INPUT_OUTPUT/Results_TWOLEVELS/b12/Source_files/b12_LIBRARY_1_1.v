...
module FAU ( 
  ...
  nand4  g24(.a(new_n48_), .b(new_n25_), .c(new_n47_), .d(new_n30_), .O(new_n49_));
  ...
  nand2  g39(.a(x12), .b(new_n38_), .O(new_n64_));
  ...
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n26_), .O(z4));
  aoi21  g47(.a(x12), .b(new_n38_), .c(x07), .O(new_n72_));
  nand2  g48(.a(new_n56_), .b(new_n38_), .O(new_n73_));
  nand2  g49(.a(x12), .b(x09), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n47_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n72_), .c(new_n48_), .O(new_n76_));
  ...
  nand2  g55(.a(new_n55_), .b(x00), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  oai21  g58(.a(new_n56_), .b(x03), .c(new_n28_), .O(new_n83_));
  ...
  nand4  g64(.a(new_n88_), .b(new_n48_), .c(new_n25_), .d(new_n47_), .O(new_n89_));
  ...
  inv1   g70(.a(new_n26_), .O(new_n95_));
  aoi21  g71(.a(new_n48_), .b(x07), .c(new_n95_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n94_), .c(new_n93_), .d(new_n25_), .O(z7));
  inv1   g73(.a(new_n75_), .O(new_n98_));
  oai21  g74(.a(new_n41_), .b(x01), .c(x09), .O(new_n99_));
  nand4  g75(.a(new_n99_), .b(new_n98_), .c(new_n48_), .d(new_n25_), .O(z8));
endmodule
