...
module FAU ( 
  ...
  nand3  g62(.a(new_n58_), .b(new_n47_), .c(new_n55_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n29_), .O(new_n89_));
  nand2  g65(.a(x03), .b(new_n29_), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n55_), .c(new_n50_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n89_), .O(z7));
  nand4  g68(.a(new_n63_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  aoi21  g70(.a(new_n77_), .b(new_n37_), .c(x10), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n94_), .c(new_n46_), .O(z8));
endmodule
