...
module FAU ( 
  ...
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n57_), .O(z5));
  ...
  aoi21  g62(.a(new_n86_), .b(x13), .c(x10), .O(z6));
  nand3  g63(.a(x09), .b(x03), .c(new_n27_), .O(new_n88_));
  inv1   g64(.a(x08), .O(new_n89_));
  nand4  g65(.a(new_n57_), .b(new_n89_), .c(new_n51_), .d(x02), .O(new_n90_));
  aoi21  g66(.a(new_n90_), .b(new_n88_), .c(x01), .O(new_n91_));
  oai21  g67(.a(new_n26_), .b(x01), .c(new_n89_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n51_), .O(new_n93_));
  oai21  g69(.a(new_n93_), .b(new_n91_), .c(x13), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n57_), .O(z7));
  nand4  g71(.a(new_n64_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(x09), .O(new_n97_));
  aoi21  g73(.a(new_n52_), .b(new_n25_), .c(x10), .O(new_n98_));
  aoi21  g74(.a(x13), .b(x07), .c(new_n36_), .O(new_n99_));
