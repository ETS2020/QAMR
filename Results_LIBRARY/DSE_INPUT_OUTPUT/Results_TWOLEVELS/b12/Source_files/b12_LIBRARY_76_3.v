...
module FAU ( 
  ...
  nor2   g53(.a(new_n58_), .b(new_n25_), .O(new_n78_));
  ...
  nand2  g61(.a(new_n58_), .b(x00), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(new_n29_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n83_), .c(new_n37_), .O(new_n88_));
