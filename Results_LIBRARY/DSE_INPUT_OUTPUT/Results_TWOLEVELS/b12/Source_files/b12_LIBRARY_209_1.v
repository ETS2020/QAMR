...
module FAU ( 
  ...
  nand2  g32(.a(new_n26_), .b(new_n27_), .O(new_n57_));
  inv1   g33(.a(x08), .O(new_n58_));
  oai21  g34(.a(new_n51_), .b(x10), .c(new_n58_), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(x07), .c(new_n57_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(x02), .O(new_n61_));
  oai21  g37(.a(new_n56_), .b(x01), .c(new_n61_), .O(z2));
  nand2  g38(.a(x11), .b(x07), .O(new_n63_));
  nand2  g39(.a(x12), .b(new_n27_), .O(new_n64_));
  ...
  nor2   g44(.a(x09), .b(x01), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(x14), .c(new_n25_), .O(new_n70_));
  aoi22  g46(.a(new_n70_), .b(new_n68_), .c(new_n26_), .d(new_n67_), .O(new_n71_));
  inv1   g47(.a(x11), .O(new_n72_));
  nand3  g48(.a(new_n26_), .b(new_n72_), .c(x07), .O(new_n73_));
  ...
  nand2  g55(.a(x09), .b(new_n38_), .O(new_n80_));
  nand2  g56(.a(new_n67_), .b(x03), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n68_), .c(new_n51_), .d(new_n25_), .O(new_n83_));
  nor2   g59(.a(new_n83_), .b(x07), .O(z6));
  nor2   g60(.a(new_n79_), .b(x10), .O(new_n85_));
  ...
  oai21  g65(.a(new_n89_), .b(new_n87_), .c(new_n51_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n25_), .O(z7));
  nand3  g67(.a(new_n79_), .b(new_n75_), .c(x03), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi21  g69(.a(new_n67_), .b(new_n27_), .c(x10), .O(new_n94_));
  nand4  g70(.a(new_n94_), .b(new_n93_), .c(new_n52_), .d(new_n26_), .O(z8));
endmodule
