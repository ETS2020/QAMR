...
module FAU ( 
  ...
  nand2  g66(.a(new_n25_), .b(x02), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(x03), .c(new_n28_), .O(new_n92_));
  nand4  g68(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n93_));
  inv1   g69(.a(new_n93_), .O(new_n94_));
  aoi21  g70(.a(new_n92_), .b(new_n66_), .c(new_n94_), .O(new_n95_));
  oai21  g71(.a(new_n95_), .b(x10), .c(new_n25_), .O(z7));
  inv1   g72(.a(x12), .O(new_n97_));
  nand4  g73(.a(new_n97_), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n98_));
