...
module FAU ( 
  ...
  nand3  g33(.a(x10), .b(new_n57_), .c(new_n40_), .O(new_n58_));
  nand2  g34(.a(new_n25_), .b(x09), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n28_), .O(new_n61_));
  nand2  g37(.a(new_n57_), .b(x02), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  aoi22  g39(.a(new_n63_), .b(new_n56_), .c(new_n25_), .d(x08), .O(new_n64_));
  ...
  oai21  g59(.a(new_n83_), .b(x00), .c(x01), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n82_), .c(new_n80_), .O(new_n85_));
  nand4  g61(.a(new_n85_), .b(new_n25_), .c(new_n57_), .d(new_n56_), .O(new_n86_));
  inv1   g62(.a(new_n86_), .O(z6));
  inv1   g63(.a(new_n59_), .O(new_n88_));
  oai21  g64(.a(x10), .b(new_n28_), .c(new_n32_), .O(new_n89_));
  aoi22  g65(.a(new_n89_), .b(new_n57_), .c(new_n88_), .d(new_n28_), .O(new_n90_));
  nand4  g66(.a(new_n25_), .b(new_n57_), .c(new_n56_), .d(x03), .O(new_n91_));
  inv1   g67(.a(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n90_), .b(x07), .c(new_n92_), .O(z7));
  nand2  g69(.a(new_n40_), .b(new_n28_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n59_), .c(new_n56_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n57_), .O(new_n96_));
  nor2   g72(.a(x12), .b(x02), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n28_), .c(new_n78_), .O(new_n98_));
  nor2   g74(.a(x09), .b(x00), .O(new_n99_));
  nor4   g75(.a(new_n99_), .b(new_n98_), .c(x10), .d(x08), .O(new_n100_));
