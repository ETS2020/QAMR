...
module FAU ( 
  ...
  aoi21  g31(.a(x09), .b(new_n28_), .c(x02), .O(new_n56_));
  oai21  g32(.a(new_n56_), .b(x08), .c(new_n55_), .O(new_n57_));
  ...
  nand3  g51(.a(new_n55_), .b(new_n64_), .c(x00), .O(new_n76_));
  oai21  g52(.a(x02), .b(x00), .c(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(x01), .O(new_n78_));
  nand2  g54(.a(x08), .b(x00), .O(new_n79_));
  aoi21  g55(.a(x09), .b(new_n38_), .c(x02), .O(new_n80_));
  nand3  g56(.a(new_n65_), .b(x03), .c(new_n31_), .O(new_n81_));
  oai21  g57(.a(new_n80_), .b(x01), .c(new_n81_), .O(new_n82_));
  inv1   g58(.a(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x02), .c(new_n27_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n55_), .O(new_n85_));
  aoi21  g61(.a(new_n82_), .b(new_n79_), .c(new_n85_), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n78_), .c(x07), .O(z6));
  nand2  g63(.a(new_n25_), .b(x02), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(x03), .c(new_n28_), .O(new_n89_));
  nand4  g65(.a(x09), .b(x03), .c(new_n31_), .d(new_n28_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(new_n91_));
  aoi21  g67(.a(new_n89_), .b(new_n64_), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x10), .c(new_n25_), .O(z7));
