...
module FAU ( 
  ...
  nand3  g26(.a(new_n36_), .b(new_n50_), .c(new_n49_), .O(new_n51_));
  ...
  aoi21  g40(.a(new_n64_), .b(new_n49_), .c(new_n37_), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n58_), .O(z2));
  oai21  g42(.a(new_n36_), .b(new_n49_), .c(x00), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(new_n36_), .b(new_n49_), .c(new_n68_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n67_), .c(new_n38_), .O(z3));
  nor2   g46(.a(x11), .b(new_n49_), .O(new_n71_));
  inv1   g47(.a(new_n71_), .O(new_n72_));
  inv1   g48(.a(x09), .O(new_n73_));
  oai21  g49(.a(new_n50_), .b(x07), .c(x11), .O(new_n74_));
  oai21  g50(.a(new_n73_), .b(new_n25_), .c(new_n74_), .O(new_n75_));
  ...
  nand3  g58(.a(new_n82_), .b(new_n75_), .c(new_n72_), .O(z4));
  nand4  g59(.a(x13), .b(new_n68_), .c(new_n49_), .d(new_n25_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n36_), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n50_), .O(z5));
  nand2  g62(.a(new_n73_), .b(x03), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n27_), .c(new_n25_), .O(new_n88_));
  nand3  g64(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n28_), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n76_), .O(new_n91_));
  nand2  g67(.a(x14), .b(x02), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x01), .O(new_n93_));
  oai21  g69(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n29_), .O(new_n95_));
  nand3  g71(.a(new_n73_), .b(x03), .c(new_n27_), .O(new_n96_));
  ...
  nand4  g75(.a(new_n99_), .b(new_n36_), .c(new_n50_), .d(new_n49_), .O(new_n100_));
  inv1   g76(.a(new_n100_), .O(z6));
  nand3  g77(.a(x09), .b(x03), .c(new_n29_), .O(new_n102_));
  nand2  g78(.a(new_n49_), .b(x01), .O(new_n103_));
  nand2  g79(.a(new_n60_), .b(new_n76_), .O(new_n104_));
  oai21  g80(.a(new_n104_), .b(new_n103_), .c(new_n102_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n27_), .O(new_n106_));
  oai21  g82(.a(x07), .b(new_n27_), .c(x03), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(new_n76_), .O(new_n108_));
  nor2   g84(.a(new_n71_), .b(new_n37_), .O(new_n109_));
  nand4  g85(.a(new_n109_), .b(new_n108_), .c(new_n106_), .d(new_n50_), .O(z7));
  nand4  g86(.a(new_n68_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n111_));
  nand2  g87(.a(new_n111_), .b(x09), .O(new_n112_));
  aoi21  g88(.a(new_n73_), .b(new_n25_), .c(x10), .O(new_n113_));
  nand3  g89(.a(new_n113_), .b(new_n112_), .c(new_n109_), .O(z8));
endmodule
