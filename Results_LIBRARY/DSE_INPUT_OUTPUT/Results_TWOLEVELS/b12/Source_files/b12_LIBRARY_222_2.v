...
module FAU ( 
  ...
  nand2  g73(.a(new_n80_), .b(new_n27_), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(new_n97_), .c(new_n25_), .d(new_n59_), .O(z8));
endmodule
