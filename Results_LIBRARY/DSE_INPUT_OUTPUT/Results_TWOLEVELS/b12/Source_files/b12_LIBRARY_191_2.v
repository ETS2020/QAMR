...
module FAU ( 
  ...
  oai21  g26(.a(x04), .b(x03), .c(new_n35_), .O(new_n51_));
  inv1   g27(.a(x07), .O(new_n52_));
  nand4  g28(.a(new_n34_), .b(new_n52_), .c(new_n29_), .d(new_n38_), .O(new_n53_));
  nand3  g29(.a(new_n53_), .b(new_n51_), .c(new_n50_), .O(new_n54_));
  aoi21  g30(.a(x07), .b(new_n29_), .c(x10), .O(new_n55_));
  nand2  g31(.a(new_n52_), .b(new_n29_), .O(new_n56_));
  nand2  g32(.a(new_n34_), .b(x09), .O(new_n57_));
  oai22  g33(.a(new_n57_), .b(new_n56_), .c(new_n55_), .d(x03), .O(new_n58_));
  aoi22  g34(.a(new_n58_), .b(new_n38_), .c(new_n54_), .d(x02), .O(new_n59_));
  inv1   g35(.a(x08), .O(new_n60_));
  oai22  g36(.a(new_n57_), .b(x05), .c(new_n34_), .d(x03), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n38_), .O(new_n62_));
  inv1   g38(.a(new_n30_), .O(new_n63_));
  ...
  oai22  g45(.a(new_n69_), .b(x00), .c(new_n68_), .d(new_n52_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n63_), .O(z3));
  nand3  g47(.a(x09), .b(x08), .c(x00), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n52_), .O(new_n73_));
  nand2  g49(.a(new_n68_), .b(x07), .O(new_n74_));
  nand3  g50(.a(new_n74_), .b(new_n73_), .c(new_n63_), .O(z4));
  inv1   g51(.a(x00), .O(new_n76_));
  nand4  g52(.a(x13), .b(new_n69_), .c(new_n52_), .d(new_n76_), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n29_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n34_), .O(z5));
  inv1   g55(.a(x09), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(x03), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n40_), .c(new_n76_), .O(new_n82_));
  nand3  g58(.a(x09), .b(new_n28_), .c(new_n38_), .O(new_n83_));
  oai21  g59(.a(x02), .b(new_n38_), .c(new_n83_), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n82_), .c(new_n60_), .O(new_n85_));
  nand2  g61(.a(x14), .b(x02), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(x01), .O(new_n87_));
  oai21  g63(.a(new_n80_), .b(x03), .c(new_n40_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n38_), .O(new_n89_));
  nand3  g65(.a(new_n80_), .b(x03), .c(new_n40_), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n89_), .c(new_n87_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(new_n76_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n34_), .c(new_n52_), .d(new_n29_), .O(new_n94_));
  inv1   g70(.a(new_n94_), .O(z6));
  nand3  g71(.a(x09), .b(x03), .c(new_n38_), .O(new_n96_));
  nand2  g72(.a(new_n29_), .b(x01), .O(new_n97_));
  nand3  g73(.a(new_n34_), .b(new_n60_), .c(new_n52_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n97_), .c(new_n96_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n40_), .O(new_n100_));
  oai21  g76(.a(x08), .b(new_n40_), .c(new_n52_), .O(new_n101_));
  nor2   g77(.a(x10), .b(x05), .O(new_n102_));
  oai21  g78(.a(x08), .b(x03), .c(new_n102_), .O(new_n103_));
  aoi21  g79(.a(new_n101_), .b(new_n29_), .c(new_n103_), .O(new_n104_));
  nand2  g80(.a(new_n104_), .b(new_n100_), .O(z7));
  nand4  g81(.a(new_n69_), .b(x03), .c(new_n40_), .d(new_n38_), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(x09), .O(new_n107_));
  aoi22  g83(.a(new_n80_), .b(new_n76_), .c(x07), .d(new_n29_), .O(new_n108_));
  nand3  g84(.a(new_n108_), .b(new_n107_), .c(new_n102_), .O(z8));
endmodule
