...
module FAU ( 
  ...
  nand4  g64(.a(new_n54_), .b(new_n53_), .c(new_n25_), .d(x01), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n31_), .O(new_n91_));
  nand2  g67(.a(new_n42_), .b(new_n53_), .O(new_n92_));
  nand4  g68(.a(new_n92_), .b(new_n91_), .c(new_n54_), .d(new_n25_), .O(z7));
