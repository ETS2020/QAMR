...
module FAU ( 
  ...
  oai21  g42(.a(new_n59_), .b(new_n36_), .c(x07), .O(new_n67_));
  ...
  nor2   g66(.a(new_n90_), .b(new_n26_), .O(new_n91_));
  nand2  g67(.a(new_n36_), .b(new_n48_), .O(new_n92_));
  aoi21  g68(.a(new_n91_), .b(new_n89_), .c(new_n92_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n88_), .O(z7));
  nand3  g70(.a(new_n89_), .b(new_n61_), .c(x03), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(x09), .O(new_n96_));
  aoi21  g72(.a(new_n90_), .b(new_n25_), .c(new_n92_), .O(new_n97_));
