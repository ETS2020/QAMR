...
module FAU ( 
  ...
  nand2  g23(.a(x10), .b(new_n27_), .O(new_n48_));
  nand3  g24(.a(new_n25_), .b(x09), .c(new_n47_), .O(new_n49_));
  aoi21  g25(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n50_));
  nand2  g26(.a(new_n25_), .b(x09), .O(new_n51_));
  aoi21  g27(.a(new_n51_), .b(new_n48_), .c(x08), .O(new_n52_));
  aoi21  g28(.a(new_n52_), .b(new_n47_), .c(new_n50_), .O(new_n53_));
  inv1   g29(.a(x08), .O(new_n54_));
  aoi22  g30(.a(new_n26_), .b(new_n38_), .c(new_n54_), .d(new_n47_), .O(new_n55_));
  oai22  g31(.a(new_n55_), .b(new_n28_), .c(new_n53_), .d(x01), .O(z2));
  inv1   g32(.a(x11), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n47_), .c(x00), .O(new_n58_));
  inv1   g34(.a(x12), .O(new_n59_));
  oai21  g35(.a(x07), .b(x00), .c(x11), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n58_), .c(new_n26_), .O(z3));
  nand3  g38(.a(x09), .b(x08), .c(x00), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n47_), .O(new_n64_));
  nand3  g40(.a(new_n57_), .b(x10), .c(x07), .O(new_n65_));
  nand2  g41(.a(new_n65_), .b(new_n64_), .O(z4));
  inv1   g42(.a(x13), .O(new_n67_));
  aoi21  g43(.a(x12), .b(new_n38_), .c(new_n67_), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n25_), .c(new_n47_), .d(new_n38_), .O(z5));
  inv1   g45(.a(x09), .O(new_n70_));
  oai21  g46(.a(new_n70_), .b(x03), .c(new_n28_), .O(new_n71_));
  nand2  g47(.a(new_n54_), .b(x00), .O(new_n72_));
  oai21  g48(.a(x01), .b(x00), .c(new_n72_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  oai21  g50(.a(x02), .b(x00), .c(new_n72_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n70_), .c(x03), .O(new_n76_));
  aoi21  g52(.a(x14), .b(x02), .c(x00), .O(new_n77_));
  nor2   g53(.a(x08), .b(x02), .O(new_n78_));
  oai21  g54(.a(new_n78_), .b(new_n77_), .c(x01), .O(new_n79_));
  nand4  g55(.a(new_n79_), .b(new_n76_), .c(new_n74_), .d(new_n47_), .O(new_n80_));
  and2   g56(.a(new_n80_), .b(new_n25_), .O(z6));
  nand3  g57(.a(x09), .b(x03), .c(new_n30_), .O(new_n82_));
  nand3  g58(.a(new_n25_), .b(new_n54_), .c(x01), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n28_), .O(new_n85_));
  oai21  g61(.a(x07), .b(new_n28_), .c(x03), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n85_), .c(new_n25_), .d(new_n47_), .O(z7));
  nand4  g64(.a(new_n59_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n89_));
  nor2   g65(.a(x09), .b(x00), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(x07), .c(new_n25_), .O(z8));
endmodule
