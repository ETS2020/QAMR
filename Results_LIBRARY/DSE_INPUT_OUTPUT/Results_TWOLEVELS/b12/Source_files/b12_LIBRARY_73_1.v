...
module FAU ( 
  ...
  aoi21  g26(.a(x10), .b(new_n25_), .c(new_n31_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n27_), .O(new_n52_));
  inv1   g28(.a(x08), .O(new_n53_));
  inv1   g29(.a(x10), .O(new_n54_));
  nand2  g30(.a(x02), .b(x00), .O(new_n55_));
  nand2  g31(.a(x09), .b(new_n28_), .O(new_n56_));
  nand2  g32(.a(new_n56_), .b(new_n55_), .O(new_n57_));
  nand4  g33(.a(new_n57_), .b(new_n54_), .c(new_n53_), .d(new_n25_), .O(new_n58_));
  nand2  g34(.a(new_n58_), .b(new_n52_), .O(z2));
  ...
  nand2  g42(.a(new_n31_), .b(x01), .O(new_n67_));
  nand3  g43(.a(new_n67_), .b(new_n56_), .c(new_n55_), .O(new_n68_));
  nand3  g44(.a(new_n68_), .b(new_n54_), .c(new_n53_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n48_), .c(x00), .O(new_n70_));
  ...
  aoi21  g54(.a(new_n47_), .b(x03), .c(x01), .O(new_n79_));
  nand3  g55(.a(x09), .b(new_n38_), .c(new_n28_), .O(new_n80_));
  oai21  g56(.a(new_n79_), .b(x02), .c(new_n80_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n78_), .O(new_n82_));
  inv1   g58(.a(x14), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(x01), .c(new_n27_), .O(new_n84_));
  ...
  nand3  g63(.a(new_n53_), .b(new_n25_), .c(x01), .O(new_n88_));
  nand3  g64(.a(x09), .b(x03), .c(new_n28_), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n88_), .c(x02), .O(new_n90_));
  aoi21  g66(.a(x03), .b(new_n31_), .c(x08), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n90_), .c(new_n54_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n25_), .O(z7));
  oai21  g69(.a(new_n38_), .b(x01), .c(new_n25_), .O(new_n94_));
  nor2   g70(.a(x12), .b(x02), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(new_n47_), .O(new_n96_));
  nor2   g72(.a(x09), .b(x00), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(new_n96_), .c(new_n54_), .O(new_n98_));
