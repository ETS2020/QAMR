...
module FAU ( 
  ...
  nand3  g15(.a(new_n39_), .b(new_n35_), .c(x02), .O(new_n40_));
  ...
  nand3  g22(.a(new_n46_), .b(x10), .c(x04), .O(new_n47_));
  inv1   g23(.a(x03), .O(new_n48_));
  oai21  g24(.a(x10), .b(x07), .c(new_n48_), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n35_), .c(new_n34_), .O(new_n50_));
  nand3  g26(.a(new_n50_), .b(new_n47_), .c(new_n45_), .O(new_n51_));
  aoi21  g27(.a(x07), .b(new_n35_), .c(x10), .O(new_n52_));
  inv1   g28(.a(x07), .O(new_n53_));
  nand4  g29(.a(new_n29_), .b(x09), .c(new_n53_), .d(new_n35_), .O(new_n54_));
  oai21  g30(.a(new_n52_), .b(x03), .c(new_n54_), .O(new_n55_));
  aoi22  g31(.a(new_n55_), .b(new_n34_), .c(new_n51_), .d(x02), .O(new_n56_));
  inv1   g32(.a(x08), .O(new_n57_));
  nand3  g33(.a(new_n29_), .b(x09), .c(new_n35_), .O(new_n58_));
  oai21  g34(.a(new_n29_), .b(x03), .c(new_n58_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n34_), .O(new_n60_));
  nand2  g36(.a(new_n30_), .b(x02), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n57_), .c(new_n53_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n67_), .b(new_n65_), .c(new_n30_), .O(new_n68_));
  ...
  nand3  g49(.a(new_n73_), .b(new_n71_), .c(new_n30_), .O(z4));
  nor2   g50(.a(x07), .b(x00), .O(new_n75_));
  inv1   g51(.a(x13), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(x12), .O(new_n77_));
  nand4  g53(.a(new_n77_), .b(new_n75_), .c(new_n29_), .d(new_n35_), .O(z5));
  oai21  g54(.a(x09), .b(new_n48_), .c(new_n34_), .O(new_n79_));
  nor2   g55(.a(x02), .b(x00), .O(new_n80_));
  nor2   g56(.a(x08), .b(new_n66_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(new_n79_), .O(new_n82_));
  inv1   g58(.a(x09), .O(new_n83_));
  oai21  g59(.a(new_n83_), .b(x03), .c(new_n28_), .O(new_n84_));
  nand2  g60(.a(x08), .b(x00), .O(new_n85_));
  nand3  g61(.a(new_n85_), .b(new_n84_), .c(new_n34_), .O(new_n86_));
  inv1   g62(.a(x14), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(x01), .c(new_n66_), .O(new_n88_));
  nand3  g64(.a(new_n88_), .b(new_n86_), .c(new_n82_), .O(new_n89_));
  nand4  g65(.a(new_n89_), .b(new_n29_), .c(new_n53_), .d(new_n35_), .O(new_n90_));
  inv1   g66(.a(new_n90_), .O(z6));
  nand2  g67(.a(new_n53_), .b(x02), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(x03), .c(new_n34_), .O(new_n93_));
  nand4  g69(.a(x09), .b(x03), .c(new_n28_), .d(new_n34_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n53_), .O(new_n95_));
  aoi21  g71(.a(new_n93_), .b(new_n57_), .c(new_n95_), .O(new_n96_));
  oai21  g72(.a(new_n96_), .b(x04), .c(new_n29_), .O(z7));
  inv1   g73(.a(x12), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(x03), .c(new_n28_), .d(new_n34_), .O(new_n99_));
  oai21  g75(.a(x09), .b(x00), .c(new_n53_), .O(new_n100_));
  aoi21  g76(.a(new_n99_), .b(x09), .c(new_n100_), .O(new_n101_));
  oai21  g77(.a(new_n101_), .b(x04), .c(new_n29_), .O(z8));
endmodule
