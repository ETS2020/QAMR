...
module FAU ( 
  ...
  oai21  g45(.a(new_n67_), .b(x10), .c(x07), .O(new_n70_));
  ...
  nand4  g51(.a(new_n75_), .b(x13), .c(new_n74_), .d(new_n37_), .O(z5));
  ...
  nand2  g65(.a(new_n37_), .b(new_n59_), .O(new_n90_));
  ...
  nor2   g69(.a(new_n93_), .b(new_n54_), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(new_n92_), .O(z7));
  nand4  g71(.a(new_n74_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n96_));
