...
module FAU ( 
  ...
  nand2  g38(.a(x10), .b(new_n52_), .O(new_n63_));
  aoi22  g39(.a(new_n63_), .b(x11), .c(x12), .d(new_n25_), .O(z3));
  inv1   g40(.a(x09), .O(new_n65_));
  nand2  g41(.a(new_n63_), .b(x11), .O(new_n66_));
  nand2  g42(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  inv1   g43(.a(x08), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n25_), .c(x10), .O(new_n69_));
  nand2  g45(.a(x01), .b(x00), .O(new_n70_));
  oai21  g46(.a(new_n65_), .b(x01), .c(new_n70_), .O(new_n71_));
  nand4  g47(.a(new_n71_), .b(new_n36_), .c(new_n53_), .d(new_n68_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n69_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n52_), .O(new_n74_));
  oai21  g50(.a(x07), .b(new_n25_), .c(new_n36_), .O(new_n75_));
  nand3  g51(.a(new_n75_), .b(new_n74_), .c(new_n67_), .O(z4));
  inv1   g52(.a(x12), .O(new_n77_));
  nand4  g53(.a(x13), .b(new_n77_), .c(new_n52_), .d(new_n25_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n36_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n53_), .O(z5));
  nand2  g56(.a(x09), .b(new_n26_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n27_), .c(x00), .O(new_n82_));
  nand2  g58(.a(new_n36_), .b(x02), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n81_), .c(x08), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(new_n82_), .c(new_n29_), .O(new_n85_));
  aoi21  g61(.a(new_n65_), .b(x03), .c(x01), .O(new_n86_));
  nand3  g62(.a(new_n65_), .b(new_n68_), .c(x03), .O(new_n87_));
  oai21  g63(.a(new_n86_), .b(x00), .c(new_n87_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n27_), .O(new_n89_));
  nand3  g65(.a(new_n36_), .b(new_n68_), .c(x00), .O(new_n90_));
  oai21  g66(.a(x14), .b(x00), .c(new_n90_), .O(new_n91_));
  nand2  g67(.a(new_n91_), .b(x01), .O(new_n92_));
  nand3  g68(.a(new_n92_), .b(new_n89_), .c(new_n85_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n52_), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n36_), .c(x10), .O(z6));
  nand3  g71(.a(x09), .b(x03), .c(new_n27_), .O(new_n96_));
  nand4  g72(.a(new_n53_), .b(new_n68_), .c(new_n52_), .d(x02), .O(new_n97_));
  aoi21  g73(.a(new_n97_), .b(new_n96_), .c(x01), .O(new_n98_));
  oai21  g74(.a(new_n26_), .b(x01), .c(new_n68_), .O(new_n99_));
  ...
  nand4  g78(.a(new_n77_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n103_));
  oai21  g79(.a(x09), .b(x00), .c(new_n52_), .O(new_n104_));
  aoi21  g80(.a(new_n103_), .b(x09), .c(new_n104_), .O(new_n105_));
  oai21  g81(.a(new_n105_), .b(x11), .c(new_n53_), .O(z8));
endmodule
