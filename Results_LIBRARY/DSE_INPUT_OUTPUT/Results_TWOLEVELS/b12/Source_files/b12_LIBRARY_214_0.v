...
module FAU ( 
  ...
  nand2  g57(.a(new_n41_), .b(x01), .O(new_n82_));
  nand2  g58(.a(x09), .b(new_n33_), .O(new_n83_));
  nand3  g59(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n26_), .c(new_n80_), .O(new_n85_));
  aoi21  g61(.a(new_n85_), .b(x00), .c(new_n25_), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(new_n79_), .c(new_n58_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n78_), .O(z4));
  nand4  g64(.a(x13), .b(new_n72_), .c(new_n58_), .d(new_n40_), .O(new_n89_));
  nand2  g65(.a(new_n89_), .b(x05), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n26_), .O(z5));
  nand2  g67(.a(x05), .b(x02), .O(new_n92_));
  inv1   g68(.a(x09), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x03), .O(new_n94_));
  aoi21  g70(.a(new_n94_), .b(new_n92_), .c(new_n40_), .O(new_n95_));
  nand3  g71(.a(x05), .b(new_n41_), .c(x01), .O(new_n96_));
  nand3  g72(.a(x09), .b(new_n29_), .c(new_n33_), .O(new_n97_));
  nand2  g73(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n95_), .c(new_n80_), .O(new_n99_));
  nand2  g75(.a(x14), .b(x02), .O(new_n100_));
  nand2  g76(.a(new_n100_), .b(x01), .O(new_n101_));
  oai21  g77(.a(new_n93_), .b(x03), .c(new_n41_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n33_), .O(new_n103_));
  nand3  g79(.a(new_n93_), .b(x03), .c(new_n41_), .O(new_n104_));
  nand3  g80(.a(new_n104_), .b(new_n103_), .c(new_n101_), .O(new_n105_));
  nand2  g81(.a(new_n105_), .b(new_n40_), .O(new_n106_));
  nand2  g82(.a(new_n106_), .b(new_n99_), .O(new_n107_));
  nand2  g83(.a(new_n107_), .b(new_n58_), .O(new_n108_));
  aoi21  g84(.a(new_n108_), .b(x05), .c(x10), .O(z6));
  nand3  g85(.a(x09), .b(x03), .c(new_n33_), .O(new_n110_));
  nand2  g86(.a(x05), .b(x01), .O(new_n111_));
  nand3  g87(.a(new_n26_), .b(new_n80_), .c(new_n58_), .O(new_n112_));
  oai21  g88(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand2  g89(.a(new_n113_), .b(new_n41_), .O(new_n114_));
  oai21  g90(.a(x07), .b(new_n41_), .c(x03), .O(new_n115_));
  nand3  g91(.a(new_n26_), .b(new_n58_), .c(x05), .O(new_n116_));
  aoi21  g92(.a(new_n115_), .b(new_n80_), .c(new_n116_), .O(new_n117_));
  nand2  g93(.a(new_n117_), .b(new_n114_), .O(z7));
  nand4  g94(.a(new_n72_), .b(x03), .c(new_n41_), .d(new_n33_), .O(new_n119_));
  oai21  g95(.a(x09), .b(x00), .c(new_n58_), .O(new_n120_));
  aoi21  g96(.a(new_n119_), .b(x09), .c(new_n120_), .O(new_n121_));
  oai21  g97(.a(new_n121_), .b(new_n25_), .c(new_n26_), .O(z8));
endmodule
