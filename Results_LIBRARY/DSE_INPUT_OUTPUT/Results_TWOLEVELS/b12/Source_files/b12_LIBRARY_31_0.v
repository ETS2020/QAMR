...
module FAU ( 
  ...
  nand3  g23(.a(new_n36_), .b(x09), .c(new_n47_), .O(new_n48_));
  aoi21  g24(.a(new_n48_), .b(x03), .c(x01), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n46_), .c(new_n25_), .O(new_n50_));
  inv1   g26(.a(x08), .O(new_n51_));
  aoi21  g27(.a(new_n36_), .b(x09), .c(new_n26_), .O(new_n52_));
  oai21  g28(.a(new_n52_), .b(x01), .c(new_n27_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n62_), .b(new_n61_), .c(new_n37_), .O(z4));
  inv1   g39(.a(x13), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(x00), .c(new_n47_), .O(new_n65_));
  aoi21  g41(.a(x07), .b(x03), .c(x10), .O(new_n66_));
  nand4  g42(.a(new_n66_), .b(new_n65_), .c(new_n37_), .d(new_n57_), .O(z5));
  aoi21  g43(.a(x09), .b(new_n29_), .c(new_n25_), .O(new_n68_));
  nor2   g44(.a(new_n27_), .b(x01), .O(new_n69_));
  oai21  g45(.a(new_n69_), .b(new_n68_), .c(new_n51_), .O(new_n70_));
  aoi21  g46(.a(x14), .b(x02), .c(new_n29_), .O(new_n71_));
  aoi21  g47(.a(x09), .b(new_n27_), .c(x01), .O(new_n72_));
  oai21  g48(.a(new_n72_), .b(new_n71_), .c(new_n25_), .O(new_n73_));
  nand2  g49(.a(new_n73_), .b(new_n70_), .O(new_n74_));
  nand4  g50(.a(new_n74_), .b(new_n36_), .c(new_n47_), .d(x03), .O(new_n75_));
  inv1   g51(.a(new_n75_), .O(z6));
  nand2  g52(.a(x09), .b(new_n27_), .O(new_n77_));
  nand2  g53(.a(x03), .b(x02), .O(new_n78_));
  nand3  g54(.a(new_n36_), .b(new_n51_), .c(new_n47_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n78_), .c(new_n77_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n29_), .O(new_n81_));
  nand2  g57(.a(new_n51_), .b(x01), .O(new_n82_));
  nand4  g58(.a(new_n82_), .b(new_n81_), .c(new_n66_), .d(new_n37_), .O(z7));
  nor2   g59(.a(x02), .b(x01), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(new_n57_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n47_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(new_n26_), .c(new_n36_), .O(z8));
endmodule
