...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n87_, new_n88_, new_n90_, new_n92_, new_n93_, new_n94_;
  ...
  aoi21  g40(.a(x11), .b(x07), .c(new_n28_), .O(new_n65_));
  nor2   g41(.a(x12), .b(x11), .O(new_n66_));
  oai21  g42(.a(new_n66_), .b(new_n65_), .c(new_n27_), .O(new_n67_));
  inv1   g43(.a(x12), .O(new_n68_));
  oai21  g44(.a(new_n25_), .b(x00), .c(new_n26_), .O(new_n69_));
  nand3  g45(.a(new_n69_), .b(new_n68_), .c(new_n53_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n67_), .O(z3));
  aoi21  g47(.a(x09), .b(x00), .c(new_n25_), .O(new_n72_));
  nor2   g48(.a(new_n26_), .b(x08), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(new_n74_));
  inv1   g50(.a(x11), .O(new_n75_));
  nand3  g51(.a(new_n27_), .b(new_n75_), .c(x07), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n74_), .O(z4));
  nand4  g53(.a(x13), .b(new_n68_), .c(new_n53_), .d(new_n28_), .O(new_n78_));
  ...
  oai21  g59(.a(new_n83_), .b(x03), .c(new_n33_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n29_), .O(new_n85_));
  nand3  g61(.a(new_n83_), .b(x03), .c(new_n33_), .O(new_n86_));
  nand3  g62(.a(new_n86_), .b(new_n85_), .c(new_n82_), .O(new_n87_));
  nand4  g63(.a(new_n87_), .b(new_n26_), .c(x08), .d(new_n53_), .O(new_n88_));
  nor2   g64(.a(new_n88_), .b(x00), .O(z6));
  nand4  g65(.a(x09), .b(x03), .c(new_n33_), .d(new_n29_), .O(new_n90_));
  nand4  g66(.a(new_n90_), .b(new_n26_), .c(x08), .d(new_n53_), .O(z7));
  nand4  g67(.a(new_n68_), .b(x03), .c(new_n33_), .d(new_n29_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(x09), .O(new_n93_));
  aoi22  g69(.a(new_n83_), .b(new_n28_), .c(x08), .d(x07), .O(new_n94_));
