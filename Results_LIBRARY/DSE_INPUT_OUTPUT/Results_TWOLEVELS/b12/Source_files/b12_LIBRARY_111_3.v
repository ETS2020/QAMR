...
module FAU ( 
  ...
  oai21  g43(.a(x09), .b(new_n26_), .c(new_n32_), .O(new_n68_));
  nand2  g44(.a(new_n27_), .b(new_n37_), .O(new_n69_));
  ...
  nand3  g51(.a(new_n75_), .b(new_n46_), .c(new_n32_), .O(new_n76_));
  inv1   g52(.a(x14), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(x01), .c(new_n37_), .O(new_n78_));
  nand3  g54(.a(new_n78_), .b(new_n76_), .c(new_n73_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n48_), .c(new_n59_), .O(new_n80_));
  inv1   g56(.a(new_n80_), .O(z6));
  nand3  g57(.a(new_n70_), .b(new_n59_), .c(x02), .O(new_n82_));
  nand3  g58(.a(x09), .b(x03), .c(new_n27_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(x01), .O(new_n84_));
  oai21  g60(.a(new_n84_), .b(x07), .c(new_n48_), .O(new_n85_));
  aoi21  g61(.a(x03), .b(new_n32_), .c(x08), .O(new_n86_));
  oai21  g62(.a(new_n86_), .b(x10), .c(new_n59_), .O(new_n87_));
  nand2  g63(.a(new_n87_), .b(new_n85_), .O(z7));
  aoi21  g64(.a(x09), .b(x02), .c(x07), .O(new_n89_));
  nand3  g65(.a(new_n64_), .b(x03), .c(new_n32_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n48_), .O(new_n91_));
  aoi21  g67(.a(new_n90_), .b(x09), .c(new_n91_), .O(new_n92_));
  oai22  g68(.a(new_n92_), .b(x07), .c(new_n89_), .d(x10), .O(z8));
endmodule
