...
module FAU ( 
  ...
  aoi21  g65(.a(new_n89_), .b(new_n27_), .c(x01), .O(new_n90_));
  oai21  g66(.a(new_n90_), .b(new_n88_), .c(new_n75_), .O(new_n91_));
  oai21  g67(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n29_), .O(new_n93_));
  nand2  g69(.a(x14), .b(x02), .O(new_n94_));
  nand2  g70(.a(new_n94_), .b(x01), .O(new_n95_));
  nand3  g71(.a(new_n76_), .b(x03), .c(new_n27_), .O(new_n96_));
  ...
  aoi21  g76(.a(new_n100_), .b(new_n36_), .c(x10), .O(z6));
  nand2  g77(.a(new_n52_), .b(x02), .O(new_n102_));
  nand3  g78(.a(new_n102_), .b(x03), .c(new_n29_), .O(new_n103_));
  nand2  g79(.a(new_n103_), .b(new_n75_), .O(new_n104_));
  nor2   g80(.a(x02), .b(x01), .O(new_n105_));
  nor2   g81(.a(new_n76_), .b(new_n26_), .O(new_n106_));
  aoi22  g82(.a(new_n106_), .b(new_n105_), .c(x07), .d(new_n36_), .O(new_n107_));
  nand4  g83(.a(new_n107_), .b(new_n104_), .c(new_n53_), .d(new_n36_), .O(z7));
  nand3  g84(.a(new_n105_), .b(new_n67_), .c(x03), .O(new_n109_));
  oai21  g85(.a(x09), .b(x00), .c(new_n52_), .O(new_n110_));
  aoi21  g86(.a(new_n109_), .b(x09), .c(new_n110_), .O(new_n111_));
  oai21  g87(.a(new_n111_), .b(x05), .c(new_n53_), .O(z8));
endmodule
