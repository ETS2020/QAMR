...
module FAU ( 
  ...
  nand2  g23(.a(new_n36_), .b(new_n47_), .O(new_n48_));
  nand3  g24(.a(new_n48_), .b(new_n26_), .c(new_n27_), .O(new_n49_));
  oai21  g25(.a(new_n46_), .b(new_n39_), .c(new_n49_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n25_), .O(new_n51_));
  inv1   g27(.a(x08), .O(new_n52_));
  nor2   g28(.a(new_n36_), .b(x03), .O(new_n53_));
  ...
  nand3  g34(.a(new_n58_), .b(new_n51_), .c(new_n37_), .O(z2));
  ...
  nand4  g43(.a(x13), .b(new_n61_), .c(new_n47_), .d(new_n25_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n52_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n36_), .O(z5));
  nand3  g46(.a(x09), .b(new_n52_), .c(new_n26_), .O(new_n71_));
  aoi21  g47(.a(new_n71_), .b(new_n39_), .c(x01), .O(new_n72_));
  inv1   g48(.a(x14), .O(new_n73_));
  oai21  g49(.a(new_n73_), .b(x00), .c(x02), .O(new_n74_));
  aoi22  g50(.a(new_n54_), .b(x03), .c(new_n52_), .d(x01), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(x02), .c(new_n74_), .O(new_n76_));
  oai21  g52(.a(new_n76_), .b(new_n72_), .c(new_n47_), .O(new_n77_));
  aoi21  g53(.a(new_n77_), .b(new_n52_), .c(x10), .O(z6));
  nor2   g54(.a(new_n54_), .b(x01), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n28_), .c(new_n36_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n47_), .c(x03), .d(new_n39_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n52_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n36_), .O(z7));
  nand4  g59(.a(new_n36_), .b(new_n47_), .c(new_n26_), .d(new_n27_), .O(new_n84_));
  nand4  g60(.a(new_n84_), .b(new_n61_), .c(new_n39_), .d(new_n27_), .O(new_n85_));
  oai21  g61(.a(x09), .b(x00), .c(new_n47_), .O(new_n86_));
  aoi21  g62(.a(new_n85_), .b(x09), .c(new_n86_), .O(new_n87_));
  oai21  g63(.a(new_n87_), .b(x08), .c(new_n36_), .O(z8));
endmodule
