...
module FAU ( 
  ...
  nand2  g55(.a(x01), .b(x00), .O(new_n80_));
  oai21  g56(.a(new_n55_), .b(x01), .c(new_n80_), .O(new_n81_));
  aoi21  g57(.a(new_n81_), .b(new_n79_), .c(new_n26_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(x10), .c(new_n78_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n50_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n75_), .O(z4));
  nand4  g61(.a(x13), .b(new_n69_), .c(new_n50_), .d(new_n26_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n51_), .O(new_n87_));
  nand2  g63(.a(new_n76_), .b(x10), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n87_), .O(z5));
  nor2   g65(.a(x02), .b(x00), .O(new_n90_));
  nor2   g66(.a(x08), .b(new_n26_), .O(new_n91_));
  oai21  g67(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  aoi21  g68(.a(x09), .b(new_n39_), .c(x02), .O(new_n93_));
  nand3  g69(.a(new_n55_), .b(x03), .c(new_n32_), .O(new_n94_));
  oai21  g70(.a(new_n93_), .b(x01), .c(new_n94_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n77_), .O(new_n96_));
  nand3  g72(.a(new_n76_), .b(x02), .c(new_n26_), .O(new_n97_));
  nand3  g73(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(new_n98_));
  nand3  g74(.a(new_n98_), .b(new_n51_), .c(new_n50_), .O(new_n99_));
  inv1   g75(.a(new_n99_), .O(z6));
  nand2  g76(.a(new_n50_), .b(x02), .O(new_n101_));
  nand3  g77(.a(new_n101_), .b(x03), .c(new_n27_), .O(new_n102_));
  nand2  g78(.a(new_n102_), .b(new_n79_), .O(new_n103_));
  nand4  g79(.a(x09), .b(x03), .c(new_n32_), .d(new_n27_), .O(new_n104_));
  nand4  g80(.a(new_n104_), .b(new_n103_), .c(new_n51_), .d(new_n50_), .O(z7));
  oai21  g81(.a(new_n39_), .b(x02), .c(new_n50_), .O(new_n106_));
  nor2   g82(.a(x12), .b(x01), .O(new_n107_));
  aoi21  g83(.a(new_n107_), .b(new_n106_), .c(new_n55_), .O(new_n108_));
  oai21  g84(.a(x09), .b(x00), .c(new_n50_), .O(new_n109_));
  oai21  g85(.a(new_n109_), .b(new_n108_), .c(new_n51_), .O(new_n110_));
  nand2  g86(.a(new_n110_), .b(new_n88_), .O(z8));
endmodule
