...
module FAU ( 
  ...
  nand2  g53(.a(new_n27_), .b(new_n37_), .O(new_n78_));
  ...
  oai21  g57(.a(new_n56_), .b(x03), .c(new_n27_), .O(new_n82_));
  ...
  nand3  g65(.a(new_n55_), .b(new_n46_), .c(x02), .O(new_n90_));
  nand3  g66(.a(x09), .b(x03), .c(new_n27_), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n90_), .c(x01), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(x07), .c(new_n47_), .O(new_n93_));
  aoi21  g69(.a(x03), .b(new_n29_), .c(x08), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x10), .c(new_n46_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n93_), .O(z7));
  nand4  g72(.a(new_n65_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n97_));
  oai21  g73(.a(x09), .b(x00), .c(new_n47_), .O(new_n98_));
  aoi21  g74(.a(new_n97_), .b(x09), .c(new_n98_), .O(new_n99_));
  oai21  g75(.a(new_n99_), .b(x07), .c(new_n73_), .O(z8));
endmodule
