...
module FAU ( 
  ...
  nand4  g51(.a(x13), .b(new_n75_), .c(new_n52_), .d(new_n26_), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  oai21  g53(.a(x10), .b(new_n51_), .c(new_n77_), .O(z5));
  nor2   g54(.a(new_n59_), .b(new_n26_), .O(new_n79_));
  inv1   g55(.a(x09), .O(new_n80_));
  oai21  g56(.a(new_n80_), .b(x03), .c(new_n31_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n27_), .O(new_n82_));
  nand3  g58(.a(new_n80_), .b(x03), .c(new_n31_), .O(new_n83_));
  aoi21  g59(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(new_n84_));
  nand2  g60(.a(x14), .b(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n26_), .O(new_n86_));
  nand2  g62(.a(new_n59_), .b(x00), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n86_), .c(new_n27_), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n84_), .c(new_n52_), .O(new_n89_));
  nor2   g65(.a(new_n89_), .b(x07), .O(z6));
  aoi21  g66(.a(new_n59_), .b(x02), .c(x10), .O(new_n91_));
  oai21  g67(.a(new_n39_), .b(x01), .c(new_n59_), .O(new_n92_));
  nand4  g68(.a(x09), .b(x03), .c(new_n31_), .d(new_n27_), .O(new_n93_));
  nand4  g69(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n51_), .O(z7));
  aoi21  g70(.a(x12), .b(x09), .c(x07), .O(new_n95_));
  nand3  g71(.a(x03), .b(new_n31_), .c(new_n27_), .O(new_n96_));
  oai21  g72(.a(x09), .b(x00), .c(new_n52_), .O(new_n97_));
