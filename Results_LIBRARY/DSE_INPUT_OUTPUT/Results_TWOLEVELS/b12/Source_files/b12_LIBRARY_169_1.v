...
module FAU ( 
  ...
  oai21  g22(.a(x10), .b(x07), .c(new_n27_), .O(new_n47_));
  inv1   g23(.a(x07), .O(new_n48_));
  nand3  g24(.a(new_n25_), .b(x09), .c(new_n48_), .O(new_n49_));
  nand3  g25(.a(new_n49_), .b(new_n47_), .c(new_n28_), .O(new_n50_));
  nand2  g26(.a(new_n50_), .b(new_n33_), .O(new_n51_));
  nor2   g27(.a(x05), .b(new_n30_), .O(new_n52_));
  aoi21  g28(.a(new_n26_), .b(x01), .c(new_n52_), .O(new_n53_));
  oai21  g29(.a(new_n53_), .b(new_n28_), .c(new_n51_), .O(new_n54_));
  ...
  nor2   g34(.a(new_n25_), .b(x03), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n58_), .c(new_n33_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n28_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n56_), .c(new_n48_), .O(new_n62_));
  nand3  g38(.a(new_n62_), .b(new_n55_), .c(new_n26_), .O(z2));
  inv1   g39(.a(x11), .O(new_n64_));
  oai21  g40(.a(new_n64_), .b(new_n48_), .c(x00), .O(new_n65_));
  inv1   g41(.a(x12), .O(new_n66_));
  nand2  g42(.a(new_n28_), .b(new_n33_), .O(new_n67_));
  oai21  g43(.a(x02), .b(x01), .c(x03), .O(new_n68_));
  oai21  g44(.a(new_n68_), .b(new_n67_), .c(x09), .O(new_n69_));
  nand2  g45(.a(new_n57_), .b(new_n38_), .O(new_n70_));
  aoi21  g46(.a(new_n70_), .b(new_n69_), .c(x07), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(new_n64_), .c(new_n66_), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n65_), .c(new_n26_), .O(z3));
  nand3  g49(.a(x09), .b(x08), .c(x00), .O(new_n74_));
  nand2  g50(.a(new_n74_), .b(new_n48_), .O(new_n75_));
  nand2  g51(.a(new_n64_), .b(x07), .O(new_n76_));
  nand3  g52(.a(new_n76_), .b(new_n75_), .c(new_n26_), .O(z4));
  nand3  g53(.a(x13), .b(new_n48_), .c(new_n38_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n66_), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n25_), .O(z5));
  oai21  g56(.a(x09), .b(new_n27_), .c(new_n33_), .O(new_n81_));
  ...
  aoi21  g61(.a(new_n85_), .b(new_n28_), .c(x00), .O(new_n86_));
  nand2  g62(.a(new_n66_), .b(x02), .O(new_n87_));
  aoi21  g63(.a(new_n87_), .b(new_n85_), .c(x08), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(new_n86_), .c(new_n33_), .O(new_n89_));
  inv1   g65(.a(x14), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(x02), .c(new_n38_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n89_), .c(new_n84_), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n48_), .O(new_n93_));
  aoi21  g69(.a(new_n93_), .b(new_n66_), .c(x10), .O(z6));
  nand3  g70(.a(x09), .b(x03), .c(new_n28_), .O(new_n95_));
  nand3  g71(.a(new_n25_), .b(new_n56_), .c(x02), .O(new_n96_));
  aoi21  g72(.a(new_n96_), .b(new_n95_), .c(x07), .O(new_n97_));
  oai21  g73(.a(new_n27_), .b(x01), .c(new_n56_), .O(new_n98_));
  nand2  g74(.a(new_n98_), .b(new_n48_), .O(new_n99_));
  aoi21  g75(.a(new_n97_), .b(new_n33_), .c(new_n99_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(x12), .c(new_n25_), .O(z7));
  nand3  g77(.a(x03), .b(new_n28_), .c(new_n33_), .O(new_n102_));
  inv1   g78(.a(new_n70_), .O(new_n103_));
  aoi21  g79(.a(new_n102_), .b(x09), .c(new_n103_), .O(new_n104_));
  nand4  g80(.a(new_n104_), .b(new_n66_), .c(new_n25_), .d(new_n48_), .O(z8));
endmodule
