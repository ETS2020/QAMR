...
module FAU ( 
  ...
  nand4  g28(.a(x14), .b(new_n25_), .c(x09), .d(new_n39_), .O(new_n53_));
  ...
  nand4  g45(.a(x13), .b(new_n63_), .c(new_n61_), .d(new_n39_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(x14), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n25_), .O(z5));
  nand2  g48(.a(new_n29_), .b(new_n39_), .O(new_n73_));
  nand2  g49(.a(new_n48_), .b(x00), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n34_), .O(new_n75_));
  nor2   g51(.a(new_n48_), .b(new_n39_), .O(new_n76_));
  inv1   g52(.a(x09), .O(new_n77_));
  oai21  g53(.a(new_n77_), .b(x03), .c(new_n29_), .O(new_n78_));
  nand2  g54(.a(new_n78_), .b(new_n34_), .O(new_n79_));
  nand3  g55(.a(new_n77_), .b(x03), .c(new_n29_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n79_), .c(new_n76_), .O(new_n81_));
  oai21  g57(.a(new_n81_), .b(new_n75_), .c(new_n61_), .O(new_n82_));
  aoi21  g58(.a(new_n82_), .b(x14), .c(x10), .O(z6));
  nand2  g59(.a(new_n61_), .b(x02), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(x03), .c(new_n34_), .O(new_n85_));
  ...
  nand4  g65(.a(new_n63_), .b(x03), .c(new_n29_), .d(new_n34_), .O(new_n90_));
  oai21  g66(.a(x09), .b(x00), .c(new_n61_), .O(new_n91_));
