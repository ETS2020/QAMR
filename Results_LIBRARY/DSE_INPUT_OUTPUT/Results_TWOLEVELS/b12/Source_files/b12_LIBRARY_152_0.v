...
module FAU ( 
  ...
  inv1   g21(.a(new_n27_), .O(new_n46_));
  oai21  g22(.a(x08), .b(x07), .c(x00), .O(new_n47_));
  nand3  g23(.a(x10), .b(new_n28_), .c(new_n31_), .O(new_n48_));
  ...
  oai21  g34(.a(new_n58_), .b(new_n55_), .c(new_n31_), .O(new_n59_));
  ...
  nand3  g43(.a(new_n67_), .b(new_n66_), .c(new_n27_), .O(z4));
  nand4  g44(.a(new_n62_), .b(new_n53_), .c(new_n52_), .d(new_n39_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(x13), .O(new_n70_));
  oai21  g46(.a(new_n26_), .b(x13), .c(new_n70_), .O(z5));
  nor2   g47(.a(new_n56_), .b(new_n39_), .O(new_n72_));
  xor2a  g48(.a(x09), .b(x03), .O(new_n73_));
  nor2   g49(.a(new_n29_), .b(x01), .O(new_n74_));
  aoi21  g50(.a(new_n73_), .b(new_n29_), .c(new_n74_), .O(new_n75_));
  ...
  oai21  g54(.a(new_n75_), .b(new_n72_), .c(new_n78_), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(new_n53_), .c(new_n52_), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n27_), .O(z6));
  nand2  g57(.a(new_n52_), .b(x02), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(x03), .c(new_n31_), .O(new_n83_));
  nand4  g59(.a(x09), .b(x03), .c(new_n29_), .d(new_n31_), .O(new_n84_));
  nand3  g60(.a(new_n84_), .b(new_n53_), .c(new_n52_), .O(new_n85_));
  aoi21  g61(.a(new_n83_), .b(new_n56_), .c(new_n85_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(new_n46_), .O(z7));
  nand4  g63(.a(new_n62_), .b(x03), .c(new_n29_), .d(new_n31_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(x09), .O(new_n89_));
  nor2   g65(.a(x09), .b(x00), .O(new_n90_));
  nor3   g66(.a(new_n90_), .b(x10), .c(x07), .O(new_n91_));
  aoi21  g67(.a(new_n91_), .b(new_n89_), .c(new_n46_), .O(z8));
endmodule
