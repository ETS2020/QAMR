...
module FAU ( 
  ...
  nand2  g30(.a(x10), .b(new_n26_), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n51_), .c(x01), .O(new_n56_));
  nor2   g32(.a(x07), .b(new_n27_), .O(new_n57_));
  oai21  g33(.a(new_n57_), .b(new_n56_), .c(new_n54_), .O(new_n58_));
  nand3  g34(.a(new_n58_), .b(new_n53_), .c(new_n25_), .O(z2));
  inv1   g35(.a(x11), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n47_), .O(new_n61_));
  aoi22  g37(.a(new_n61_), .b(x07), .c(x12), .d(new_n37_), .O(z3));
  ...
  nor2   g43(.a(new_n67_), .b(x10), .O(new_n68_));
  nand4  g44(.a(new_n68_), .b(new_n66_), .c(new_n46_), .d(new_n37_), .O(z5));
  nor2   g45(.a(new_n54_), .b(new_n37_), .O(new_n70_));
  inv1   g46(.a(x09), .O(new_n71_));
  oai21  g47(.a(new_n71_), .b(x03), .c(new_n27_), .O(new_n72_));
  nand2  g48(.a(new_n72_), .b(new_n29_), .O(new_n73_));
  nand3  g49(.a(new_n71_), .b(x03), .c(new_n27_), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n70_), .O(new_n75_));
  nand2  g51(.a(x14), .b(x02), .O(new_n76_));
  nand2  g52(.a(new_n76_), .b(new_n37_), .O(new_n77_));
  nand2  g53(.a(new_n54_), .b(x00), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n77_), .c(new_n29_), .O(new_n79_));
  oai21  g55(.a(new_n79_), .b(new_n75_), .c(new_n47_), .O(new_n80_));
  nor2   g56(.a(new_n80_), .b(x07), .O(z6));
  nand3  g57(.a(x09), .b(x03), .c(new_n27_), .O(new_n82_));
  nand3  g58(.a(new_n57_), .b(new_n47_), .c(new_n54_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(new_n29_), .O(new_n85_));
  oai21  g61(.a(new_n26_), .b(x01), .c(new_n54_), .O(new_n86_));
  nand4  g62(.a(new_n86_), .b(new_n85_), .c(new_n47_), .d(new_n46_), .O(z7));
  aoi21  g63(.a(x12), .b(x09), .c(x07), .O(new_n88_));
  nand3  g64(.a(x03), .b(new_n27_), .c(new_n29_), .O(new_n89_));
  oai21  g65(.a(x09), .b(x00), .c(new_n47_), .O(new_n90_));
  aoi21  g66(.a(new_n89_), .b(x09), .c(new_n90_), .O(new_n91_));
  oai22  g67(.a(new_n91_), .b(x07), .c(new_n88_), .d(x10), .O(z8));
endmodule
