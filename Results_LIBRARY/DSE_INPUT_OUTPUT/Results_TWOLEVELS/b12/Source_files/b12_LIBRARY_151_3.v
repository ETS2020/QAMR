...
module FAU ( 
  ...
  oai21  g36(.a(new_n56_), .b(new_n58_), .c(new_n60_), .O(z4));
  inv1   g37(.a(x12), .O(new_n62_));
  nand4  g38(.a(x13), .b(new_n62_), .c(new_n47_), .d(new_n26_), .O(new_n63_));
  nand2  g39(.a(new_n63_), .b(new_n58_), .O(new_n64_));
  oai21  g40(.a(x10), .b(new_n58_), .c(new_n64_), .O(z5));
  nor2   g41(.a(new_n45_), .b(new_n26_), .O(new_n66_));
  inv1   g42(.a(x09), .O(new_n67_));
  oai21  g43(.a(new_n67_), .b(x03), .c(new_n30_), .O(new_n68_));
  nand2  g44(.a(new_n68_), .b(new_n27_), .O(new_n69_));
  nand3  g45(.a(new_n67_), .b(x03), .c(new_n30_), .O(new_n70_));
  ...
  nand2  g49(.a(new_n45_), .b(x00), .O(new_n74_));
  aoi21  g50(.a(new_n74_), .b(new_n73_), .c(new_n27_), .O(new_n75_));
  oai21  g51(.a(new_n75_), .b(new_n71_), .c(new_n47_), .O(new_n76_));
  nor2   g52(.a(new_n76_), .b(x07), .O(z6));
  aoi21  g53(.a(new_n45_), .b(x02), .c(x10), .O(new_n78_));
  oai21  g54(.a(new_n37_), .b(x01), .c(new_n45_), .O(new_n79_));
  nand4  g55(.a(x09), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n80_));
  nand4  g56(.a(new_n80_), .b(new_n79_), .c(new_n78_), .d(new_n58_), .O(z7));
  aoi21  g57(.a(x12), .b(x09), .c(x07), .O(new_n82_));
  nand3  g58(.a(x03), .b(new_n30_), .c(new_n27_), .O(new_n83_));
  oai21  g59(.a(x09), .b(x00), .c(new_n47_), .O(new_n84_));
  aoi21  g60(.a(new_n83_), .b(x09), .c(new_n84_), .O(new_n85_));
  oai22  g61(.a(new_n85_), .b(x07), .c(new_n82_), .d(x10), .O(z8));
endmodule
