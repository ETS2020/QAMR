...
module FAU ( 
  ...
  wire new_n25_, new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_,
    ...
    new_n102_;
  nand2  g00(.a(x14), .b(x13), .O(new_n25_));
  ...
  inv1   g20(.a(new_n25_), .O(new_n45_));
  oai21  g21(.a(x08), .b(x07), .c(x00), .O(new_n46_));
  nand3  g22(.a(x10), .b(new_n37_), .c(new_n27_), .O(new_n47_));
  ...
  oai21  g33(.a(new_n57_), .b(new_n54_), .c(new_n27_), .O(new_n58_));
  aoi21  g34(.a(new_n58_), .b(new_n49_), .c(new_n45_), .O(z2));
  nand2  g35(.a(x11), .b(x07), .O(new_n60_));
  nand2  g36(.a(x12), .b(new_n26_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n60_), .c(new_n25_), .O(new_n62_));
  ...
  aoi21  g43(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(z4));
  nor2   g44(.a(x07), .b(x00), .O(new_n69_));
  inv1   g45(.a(x14), .O(new_n70_));
  oai21  g46(.a(x12), .b(x10), .c(new_n70_), .O(new_n71_));
  inv1   g47(.a(x13), .O(new_n72_));
  nand3  g48(.a(new_n72_), .b(new_n51_), .c(new_n26_), .O(new_n73_));
  nand4  g49(.a(new_n73_), .b(new_n71_), .c(new_n69_), .d(new_n25_), .O(z5));
  inv1   g50(.a(x09), .O(new_n75_));
  aoi21  g51(.a(new_n75_), .b(x03), .c(x01), .O(new_n76_));
  oai21  g52(.a(x13), .b(x02), .c(x14), .O(new_n77_));
  nand2  g53(.a(new_n77_), .b(new_n26_), .O(new_n78_));
  oai21  g54(.a(x13), .b(new_n26_), .c(x14), .O(new_n79_));
  nand2  g55(.a(new_n79_), .b(new_n55_), .O(new_n80_));
  aoi21  g56(.a(new_n80_), .b(new_n78_), .c(new_n76_), .O(new_n81_));
  aoi21  g57(.a(x09), .b(new_n37_), .c(x02), .O(new_n82_));
  oai21  g58(.a(x13), .b(x01), .c(x14), .O(new_n83_));
  oai21  g59(.a(new_n55_), .b(new_n26_), .c(new_n83_), .O(new_n84_));
  nor2   g60(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  oai21  g61(.a(new_n85_), .b(new_n81_), .c(new_n52_), .O(new_n86_));
  nor2   g62(.a(new_n86_), .b(x07), .O(z6));
  nand3  g63(.a(new_n70_), .b(new_n52_), .c(new_n51_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(x13), .c(new_n27_), .O(new_n89_));
  oai21  g65(.a(x14), .b(x10), .c(x13), .O(new_n90_));
  nand3  g66(.a(new_n90_), .b(new_n51_), .c(x02), .O(new_n91_));
  oai21  g67(.a(new_n45_), .b(x03), .c(new_n91_), .O(new_n92_));
  oai21  g68(.a(new_n92_), .b(new_n89_), .c(new_n55_), .O(new_n93_));
  nand4  g69(.a(x09), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(new_n52_), .c(new_n51_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n25_), .O(new_n96_));
  nand2  g72(.a(new_n96_), .b(new_n93_), .O(z7));
  inv1   g73(.a(x12), .O(new_n98_));
  nand4  g74(.a(new_n98_), .b(x03), .c(new_n30_), .d(new_n27_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(x09), .O(new_n100_));
  nor2   g76(.a(x09), .b(x00), .O(new_n101_));
  nor3   g77(.a(new_n101_), .b(x10), .c(x07), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(new_n100_), .c(new_n45_), .O(z8));
endmodule
