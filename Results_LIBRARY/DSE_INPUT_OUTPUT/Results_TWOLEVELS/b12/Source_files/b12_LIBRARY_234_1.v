...
module FAU ( 
  ...
  nand2  g31(.a(x09), .b(new_n33_), .O(new_n56_));
  ...
  oai21  g36(.a(new_n60_), .b(new_n25_), .c(x00), .O(new_n61_));
  nor2   g37(.a(x12), .b(x00), .O(new_n62_));
  oai21  g38(.a(new_n62_), .b(x10), .c(new_n25_), .O(new_n63_));
  inv1   g39(.a(x12), .O(new_n64_));
  nand2  g40(.a(new_n64_), .b(new_n60_), .O(new_n65_));
  nand3  g41(.a(new_n65_), .b(new_n63_), .c(new_n61_), .O(z3));
  inv1   g42(.a(x10), .O(new_n67_));
  inv1   g43(.a(x08), .O(new_n68_));
  oai21  g44(.a(x09), .b(x01), .c(new_n68_), .O(new_n69_));
  nand4  g45(.a(new_n69_), .b(new_n67_), .c(x09), .d(x00), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n25_), .O(new_n71_));
  oai21  g47(.a(x11), .b(new_n25_), .c(new_n71_), .O(z4));
  nor3   g48(.a(x12), .b(x10), .c(x00), .O(new_n73_));
  nand3  g49(.a(new_n73_), .b(x13), .c(new_n25_), .O(z5));
  ...
  nand3  g57(.a(new_n81_), .b(x01), .c(new_n40_), .O(new_n82_));
  nand2  g58(.a(new_n82_), .b(new_n67_), .O(new_n83_));
  ...
  nor2   g63(.a(new_n87_), .b(x10), .O(new_n88_));
  inv1   g64(.a(x09), .O(new_n89_));
  nor2   g65(.a(new_n89_), .b(new_n27_), .O(new_n90_));
  aoi22  g66(.a(new_n90_), .b(new_n86_), .c(new_n68_), .d(new_n27_), .O(new_n91_));
  nand3  g67(.a(new_n91_), .b(new_n88_), .c(new_n25_), .O(z7));
  nand3  g68(.a(new_n86_), .b(new_n64_), .c(x03), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(x09), .O(new_n94_));
  nand2  g70(.a(new_n89_), .b(new_n40_), .O(new_n95_));
  nand4  g71(.a(new_n95_), .b(new_n94_), .c(new_n26_), .d(new_n25_), .O(z8));
endmodule
