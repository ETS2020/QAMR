...
module FAU ( 
  ...
  aoi21  g56(.a(new_n25_), .b(x00), .c(new_n80_), .O(new_n81_));
  nand4  g57(.a(new_n81_), .b(new_n79_), .c(new_n51_), .d(new_n25_), .O(z5));
  ...
  oai21  g62(.a(new_n63_), .b(x03), .c(new_n37_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n70_), .c(new_n27_), .O(new_n88_));
  inv1   g64(.a(x14), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(x02), .c(new_n48_), .O(new_n90_));
  ...
  nand3  g69(.a(new_n51_), .b(new_n25_), .c(x02), .O(new_n94_));
  nand3  g70(.a(new_n94_), .b(x03), .c(new_n27_), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n62_), .O(new_n96_));
  nor2   g72(.a(x02), .b(x01), .O(new_n97_));
  nor2   g73(.a(new_n63_), .b(new_n57_), .O(new_n98_));
  aoi21  g74(.a(new_n98_), .b(new_n97_), .c(x10), .O(new_n99_));
  nand3  g75(.a(new_n99_), .b(new_n96_), .c(new_n25_), .O(z7));
  nand3  g76(.a(new_n97_), .b(new_n79_), .c(x03), .O(new_n101_));
  nand2  g77(.a(new_n101_), .b(x09), .O(new_n102_));
  aoi21  g78(.a(new_n63_), .b(new_n48_), .c(x10), .O(new_n103_));
  nand3  g79(.a(new_n103_), .b(new_n102_), .c(new_n25_), .O(z8));
endmodule
