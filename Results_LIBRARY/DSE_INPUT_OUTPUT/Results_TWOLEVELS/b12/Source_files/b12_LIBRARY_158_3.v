...
module FAU ( 
  ...
  nand4  g26(.a(new_n26_), .b(new_n47_), .c(new_n32_), .d(new_n40_), .O(new_n51_));
  oai21  g27(.a(new_n50_), .b(new_n27_), .c(new_n51_), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(x02), .O(new_n53_));
  nand3  g29(.a(x10), .b(new_n25_), .c(new_n29_), .O(new_n54_));
  nand2  g30(.a(new_n26_), .b(x09), .O(new_n55_));
  aoi21  g31(.a(new_n55_), .b(new_n54_), .c(x08), .O(new_n56_));
  nand3  g32(.a(new_n26_), .b(x09), .c(new_n40_), .O(new_n57_));
  inv1   g33(.a(new_n57_), .O(new_n58_));
  oai21  g34(.a(new_n58_), .b(new_n56_), .c(new_n47_), .O(new_n59_));
  nand2  g35(.a(x10), .b(new_n25_), .O(new_n60_));
  ...
  oai21  g44(.a(new_n27_), .b(new_n40_), .c(x12), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n47_), .O(new_n70_));
  nand3  g46(.a(new_n70_), .b(new_n68_), .c(new_n28_), .O(z3));
  aoi21  g47(.a(new_n25_), .b(new_n32_), .c(x10), .O(new_n72_));
  nand2  g48(.a(x09), .b(x00), .O(new_n73_));
  aoi21  g49(.a(new_n72_), .b(new_n48_), .c(new_n73_), .O(new_n74_));
  aoi21  g50(.a(new_n66_), .b(x07), .c(new_n27_), .O(new_n75_));
  oai21  g51(.a(new_n74_), .b(x07), .c(new_n75_), .O(z4));
  oai21  g52(.a(x12), .b(x10), .c(new_n25_), .O(new_n77_));
  nand2  g53(.a(x12), .b(x09), .O(new_n78_));
  nand4  g54(.a(new_n78_), .b(x13), .c(new_n47_), .d(new_n40_), .O(new_n79_));
  ...
  oai21  g61(.a(new_n25_), .b(x03), .c(new_n30_), .O(new_n86_));
  nand2  g62(.a(x08), .b(x00), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n32_), .O(new_n88_));
  ...
  nand3  g67(.a(new_n91_), .b(new_n26_), .c(new_n47_), .O(new_n92_));
  inv1   g68(.a(new_n92_), .O(z6));
  nand3  g69(.a(new_n48_), .b(new_n47_), .c(x02), .O(new_n94_));
  nand3  g70(.a(x09), .b(x03), .c(new_n30_), .O(new_n95_));
  aoi21  g71(.a(new_n95_), .b(new_n94_), .c(x01), .O(new_n96_));
  aoi21  g72(.a(new_n47_), .b(x01), .c(new_n29_), .O(new_n97_));
  oai21  g73(.a(new_n97_), .b(x08), .c(new_n47_), .O(new_n98_));
  oai21  g74(.a(new_n98_), .b(new_n96_), .c(new_n26_), .O(new_n99_));
  nand2  g75(.a(new_n99_), .b(new_n60_), .O(z7));
  oai21  g76(.a(x10), .b(new_n40_), .c(new_n25_), .O(new_n101_));
  nand4  g77(.a(new_n67_), .b(x03), .c(new_n30_), .d(new_n32_), .O(new_n102_));
  aoi21  g78(.a(new_n102_), .b(x09), .c(x07), .O(new_n103_));
  oai21  g79(.a(new_n103_), .b(x10), .c(new_n101_), .O(z8));
endmodule
