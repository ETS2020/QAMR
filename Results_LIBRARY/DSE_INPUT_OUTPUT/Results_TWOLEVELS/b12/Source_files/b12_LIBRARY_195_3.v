...
module FAU ( 
  ...
  nand2  g00(.a(x11), .b(x07), .O(new_n25_));
  ...
  nor2   g25(.a(new_n47_), .b(x07), .O(new_n50_));
  nor2   g26(.a(x11), .b(new_n46_), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(new_n50_), .c(new_n26_), .O(new_n52_));
  ...
  oai21  g32(.a(new_n56_), .b(new_n49_), .c(new_n37_), .O(new_n57_));
  inv1   g33(.a(x08), .O(new_n58_));
  nor2   g34(.a(new_n47_), .b(x03), .O(new_n59_));
  oai21  g35(.a(new_n59_), .b(new_n54_), .c(new_n29_), .O(new_n60_));
  nand2  g36(.a(new_n60_), .b(new_n27_), .O(new_n61_));
  nand3  g37(.a(new_n61_), .b(new_n58_), .c(new_n46_), .O(new_n62_));
  nand2  g38(.a(new_n62_), .b(new_n57_), .O(z2));
  aoi22  g39(.a(x12), .b(new_n37_), .c(x11), .d(x07), .O(z3));
  inv1   g40(.a(new_n51_), .O(new_n65_));
  ...
  nand4  g45(.a(x13), .b(new_n69_), .c(new_n47_), .d(new_n37_), .O(new_n70_));
  nand2  g46(.a(new_n70_), .b(new_n46_), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n65_), .O(z5));
  oai21  g48(.a(x09), .b(new_n26_), .c(new_n29_), .O(new_n73_));
  ...
  nand3  g56(.a(new_n80_), .b(x02), .c(new_n37_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n79_), .c(new_n76_), .O(new_n82_));
  nand3  g58(.a(new_n82_), .b(new_n47_), .c(new_n46_), .O(new_n83_));
  nand2  g59(.a(new_n83_), .b(new_n25_), .O(z6));
  nand3  g60(.a(x09), .b(x03), .c(new_n27_), .O(new_n85_));
  nand3  g61(.a(new_n47_), .b(new_n58_), .c(x02), .O(new_n86_));
  aoi21  g62(.a(new_n86_), .b(new_n85_), .c(x01), .O(new_n87_));
  oai21  g63(.a(new_n26_), .b(x01), .c(new_n58_), .O(new_n88_));
  nand2  g64(.a(new_n88_), .b(new_n47_), .O(new_n89_));
  oai21  g65(.a(new_n89_), .b(new_n87_), .c(new_n46_), .O(new_n90_));
  nand2  g66(.a(new_n90_), .b(new_n65_), .O(z7));
  nand4  g67(.a(new_n69_), .b(x03), .c(new_n27_), .d(new_n29_), .O(new_n92_));
  oai21  g68(.a(x09), .b(x00), .c(new_n47_), .O(new_n93_));
  aoi21  g69(.a(new_n92_), .b(x09), .c(new_n93_), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(x07), .c(new_n65_), .O(z8));
endmodule
