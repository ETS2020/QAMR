...
module FAU ( 
  ...
  aoi21  g21(.a(x10), .b(new_n25_), .c(new_n31_), .O(new_n46_));
  ...
  nand4  g44(.a(x13), .b(new_n61_), .c(new_n49_), .d(new_n27_), .O(new_n69_));
  nand2  g45(.a(new_n69_), .b(new_n47_), .O(new_n70_));
  nand2  g46(.a(x10), .b(x09), .O(new_n71_));
  nand2  g47(.a(new_n71_), .b(new_n70_), .O(z5));
  ...
  oai21  g52(.a(new_n25_), .b(x03), .c(new_n31_), .O(new_n77_));
  nand3  g53(.a(new_n77_), .b(new_n65_), .c(new_n28_), .O(new_n78_));
  inv1   g54(.a(x14), .O(new_n79_));
  nand3  g55(.a(new_n79_), .b(x01), .c(new_n27_), .O(new_n80_));
  nand3  g56(.a(new_n80_), .b(new_n78_), .c(new_n76_), .O(new_n81_));
  nand3  g57(.a(new_n81_), .b(new_n47_), .c(new_n49_), .O(new_n82_));
  inv1   g58(.a(new_n82_), .O(z6));
  nand3  g59(.a(x09), .b(x03), .c(new_n31_), .O(new_n84_));
  nand4  g60(.a(new_n47_), .b(new_n53_), .c(new_n49_), .d(x02), .O(new_n85_));
  nand2  g61(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand2  g62(.a(new_n86_), .b(new_n28_), .O(new_n87_));
  aoi21  g63(.a(x03), .b(new_n28_), .c(x08), .O(new_n88_));
  oai21  g64(.a(new_n88_), .b(x07), .c(new_n47_), .O(new_n89_));
  nand3  g65(.a(new_n89_), .b(new_n87_), .c(new_n71_), .O(z7));
  nand2  g66(.a(new_n47_), .b(x07), .O(new_n91_));
  oai21  g67(.a(x10), .b(new_n27_), .c(new_n25_), .O(new_n92_));
  nand2  g68(.a(new_n31_), .b(new_n28_), .O(new_n93_));
  nand3  g69(.a(new_n61_), .b(new_n47_), .c(x03), .O(new_n94_));
  oai21  g70(.a(new_n94_), .b(new_n93_), .c(x09), .O(new_n95_));
  nand3  g71(.a(new_n95_), .b(new_n92_), .c(new_n91_), .O(z8));
endmodule
