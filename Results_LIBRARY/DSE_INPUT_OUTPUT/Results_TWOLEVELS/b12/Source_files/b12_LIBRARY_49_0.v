...
module FAU ( 
  ...
  nand3  g22(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n47_));
  inv1   g23(.a(new_n47_), .O(new_n48_));
  nor2   g24(.a(x03), .b(x01), .O(new_n49_));
  oai21  g25(.a(new_n49_), .b(new_n48_), .c(new_n39_), .O(new_n50_));
  nor2   g26(.a(new_n49_), .b(x02), .O(new_n51_));
  oai21  g27(.a(new_n51_), .b(x08), .c(x10), .O(new_n52_));
  nand2  g28(.a(new_n52_), .b(new_n25_), .O(new_n53_));
  nand2  g29(.a(new_n53_), .b(new_n50_), .O(z2));
  oai21  g30(.a(new_n26_), .b(x07), .c(x11), .O(new_n55_));
  nand2  g31(.a(new_n55_), .b(x00), .O(new_n56_));
  aoi21  g32(.a(x12), .b(x10), .c(x07), .O(new_n57_));
  nor2   g33(.a(x12), .b(x11), .O(new_n58_));
  nor2   g34(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand2  g35(.a(new_n59_), .b(new_n56_), .O(z3));
  nand4  g36(.a(x10), .b(x09), .c(x08), .d(x00), .O(new_n61_));
  nand2  g37(.a(new_n61_), .b(new_n25_), .O(new_n62_));
  oai21  g38(.a(x11), .b(new_n25_), .c(new_n62_), .O(z4));
  nand2  g39(.a(new_n26_), .b(new_n25_), .O(z7));
  one    g40(.O(z5));
  zero   g41(.O(z6));
  one    g42(.O(z8));
endmodule
