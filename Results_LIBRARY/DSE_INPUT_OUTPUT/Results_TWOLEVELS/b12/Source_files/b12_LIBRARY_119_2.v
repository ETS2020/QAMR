...
module FAU ( 
  ...
  nand2  g53(.a(new_n53_), .b(x03), .O(new_n78_));
  aoi21  g54(.a(new_n78_), .b(new_n28_), .c(new_n38_), .O(new_n79_));
  nor2   g55(.a(new_n53_), .b(x03), .O(new_n80_));
  nand2  g56(.a(new_n80_), .b(new_n30_), .O(new_n81_));
  nand2  g57(.a(new_n81_), .b(new_n29_), .O(new_n82_));
  oai21  g58(.a(new_n82_), .b(new_n79_), .c(new_n56_), .O(new_n83_));
  nand2  g59(.a(x14), .b(x02), .O(new_n84_));
  nand2  g60(.a(new_n84_), .b(x01), .O(new_n85_));
  oai21  g61(.a(new_n80_), .b(x02), .c(new_n30_), .O(new_n86_));
  nand3  g62(.a(new_n53_), .b(x03), .c(new_n28_), .O(new_n87_));
  nand3  g63(.a(new_n87_), .b(new_n86_), .c(new_n85_), .O(new_n88_));
  aoi21  g64(.a(new_n88_), .b(new_n38_), .c(x07), .O(new_n89_));
  aoi21  g65(.a(new_n89_), .b(new_n83_), .c(x10), .O(z6));
  nand3  g66(.a(x09), .b(x03), .c(new_n30_), .O(new_n91_));
  nand3  g67(.a(new_n25_), .b(new_n56_), .c(x01), .O(new_n92_));
  nand2  g68(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g69(.a(new_n93_), .b(new_n28_), .O(new_n94_));
  oai21  g70(.a(x07), .b(new_n28_), .c(x03), .O(new_n95_));
  nand2  g71(.a(new_n95_), .b(new_n56_), .O(new_n96_));
  nand4  g72(.a(new_n96_), .b(new_n94_), .c(new_n25_), .d(new_n64_), .O(z7));
  nand4  g73(.a(new_n67_), .b(x03), .c(new_n28_), .d(new_n30_), .O(new_n98_));
  nor2   g74(.a(x09), .b(x00), .O(new_n99_));
  aoi21  g75(.a(new_n98_), .b(x09), .c(new_n99_), .O(new_n100_));
  oai21  g76(.a(new_n100_), .b(x07), .c(new_n25_), .O(z8));
endmodule
