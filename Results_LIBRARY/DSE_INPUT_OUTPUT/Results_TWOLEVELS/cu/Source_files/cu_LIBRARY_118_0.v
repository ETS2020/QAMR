...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n38_), .c(new_n44_), .d(x07), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x07), .c(x00), .O(z02));
  inv1   g22(.a(x01), .O(new_n48_));
  nand3  g23(.a(new_n36_), .b(new_n48_), .c(x00), .O(new_n49_));
  nand4  g24(.a(new_n44_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n50_));
  ...
  nand4  g33(.a(new_n28_), .b(new_n44_), .c(new_n37_), .d(x02), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  inv1   g35(.a(x09), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n48_), .O(new_n62_));
  ...
  nand3  g48(.a(new_n44_), .b(new_n37_), .c(x02), .O(new_n74_));
