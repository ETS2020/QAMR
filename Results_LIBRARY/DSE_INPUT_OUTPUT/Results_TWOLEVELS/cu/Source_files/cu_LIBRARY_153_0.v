...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n26_), .c(new_n31_), .d(new_n41_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x05), .c(x01), .O(z02));
  nand4  g21(.a(new_n44_), .b(new_n26_), .c(new_n31_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x05), .c(x01), .O(z03));
  nand3  g23(.a(new_n31_), .b(x01), .c(new_n41_), .O(new_n49_));
  nand4  g24(.a(new_n42_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n39_), .O(z04));
  nor3   g26(.a(x02), .b(new_n27_), .c(new_n41_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  nor2   g31(.a(x09), .b(x01), .O(new_n57_));
  nor2   g32(.a(x11), .b(new_n27_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nor2   g34(.a(x08), .b(x01), .O(new_n60_));
  nor2   g35(.a(x10), .b(new_n27_), .O(new_n61_));
  ...
  nand4  g39(.a(new_n42_), .b(new_n29_), .c(x02), .d(x01), .O(new_n65_));
  ...
  nor3   g43(.a(new_n43_), .b(x03), .c(x02), .O(z07));
  nand2  g44(.a(x05), .b(new_n31_), .O(new_n70_));
  nand2  g45(.a(x13), .b(new_n56_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n65_), .O(new_n72_));
  ...
  oai21  g51(.a(x05), .b(new_n27_), .c(new_n70_), .O(new_n77_));
