...
module FAU ( 
  ...
  nor3   g27(.a(x02), .b(new_n53_), .c(new_n32_), .O(new_n54_));
  nand4  g28(.a(new_n54_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n55_));
  nor2   g29(.a(new_n55_), .b(x13), .O(z05));
  nand3  g30(.a(new_n42_), .b(x05), .c(x04), .O(new_n57_));
  ...
  aoi21  g47(.a(new_n45_), .b(new_n42_), .c(new_n53_), .O(new_n74_));
  nand2  g48(.a(x01), .b(x00), .O(new_n75_));
  nand4  g49(.a(new_n75_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(new_n77_));
  nand3  g51(.a(new_n77_), .b(new_n36_), .c(new_n30_), .O(new_n78_));
  oai21  g52(.a(new_n74_), .b(new_n32_), .c(new_n78_), .O(z07));
  nand4  g53(.a(x13), .b(new_n60_), .c(x05), .d(new_n30_), .O(new_n80_));
  nand2  g54(.a(new_n80_), .b(new_n70_), .O(new_n81_));
  nand3  g55(.a(new_n81_), .b(x04), .c(new_n36_), .O(new_n82_));
  nand2  g56(.a(new_n82_), .b(new_n34_), .O(z08));
  inv1   g57(.a(x06), .O(new_n84_));
  nor3   g58(.a(new_n33_), .b(new_n43_), .c(new_n84_), .O(z09));
  nand3  g59(.a(new_n29_), .b(x06), .c(new_n36_), .O(new_n86_));
  nand2  g60(.a(new_n86_), .b(new_n34_), .O(z10));
  zero   g61(.O(z03));
endmodule
