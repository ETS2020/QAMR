...
module FAU ( 
  ...
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(new_n27_), .d(x05), .O(new_n64_));
  nand4  g39(.a(new_n43_), .b(x07), .c(new_n32_), .d(x02), .O(new_n65_));
  ...
  nand4  g43(.a(new_n43_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nor2   g45(.a(new_n31_), .b(x03), .O(new_n71_));
  nand3  g46(.a(new_n43_), .b(x07), .c(new_n32_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n71_), .c(new_n27_), .O(new_n74_));
  nor2   g49(.a(new_n43_), .b(x12), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n71_), .c(x05), .d(new_n29_), .O(new_n76_));
  oai21  g51(.a(new_n74_), .b(new_n29_), .c(new_n76_), .O(z08));
  inv1   g52(.a(x06), .O(new_n78_));
  nor3   g53(.a(new_n38_), .b(new_n43_), .c(new_n78_), .O(z09));
  nand3  g54(.a(new_n28_), .b(x06), .c(new_n26_), .O(new_n80_));
