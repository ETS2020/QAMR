...
module FAU ( 
  ...
  nand4  g12(.a(x05), .b(new_n31_), .c(new_n26_), .d(new_n29_), .O(new_n38_));
  nand2  g13(.a(new_n38_), .b(new_n37_), .O(z01));
  nand2  g14(.a(new_n27_), .b(x02), .O(new_n40_));
  inv1   g15(.a(x00), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  nand3  g17(.a(new_n29_), .b(new_n42_), .c(new_n41_), .O(new_n43_));
  inv1   g18(.a(x13), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n40_), .O(z02));
  nand4  g21(.a(new_n26_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor3   g29(.a(x02), .b(new_n42_), .c(new_n41_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n56_));
  ...
  nand4  g42(.a(new_n44_), .b(x10), .c(new_n32_), .d(x02), .O(new_n68_));
  ...
  nand4  g46(.a(new_n44_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n40_), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n74_));
