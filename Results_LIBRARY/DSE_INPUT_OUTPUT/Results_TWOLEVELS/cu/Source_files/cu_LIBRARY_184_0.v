...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n36_), .c(new_n42_), .d(x09), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x09), .c(x01), .O(z02));
  ...
  nor2   g36(.a(x10), .b(new_n46_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n51_), .O(new_n63_));
  inv1   g38(.a(x11), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x01), .c(x00), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n42_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n35_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n72_), .b(new_n46_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n27_), .O(new_n76_));
