...
module FAU ( 
  ...
  nand4  g27(.a(new_n52_), .b(new_n51_), .c(new_n31_), .d(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n27_), .c(x03), .O(z04));
  nand4  g29(.a(new_n52_), .b(new_n51_), .c(new_n31_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n27_), .c(x03), .O(z05));
  nand4  g31(.a(new_n27_), .b(new_n32_), .c(x04), .d(x02), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n27_), .c(x03), .O(z06));
  nand3  g33(.a(new_n52_), .b(new_n31_), .c(new_n28_), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n27_), .c(x03), .O(z07));
  nand4  g35(.a(new_n32_), .b(x04), .c(new_n26_), .d(x02), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(x13), .O(z08));
  inv1   g37(.a(x06), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(x03), .c(new_n27_), .O(z09));
  nand2  g39(.a(new_n30_), .b(x06), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n27_), .c(x03), .O(z10));
endmodule
