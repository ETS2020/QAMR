...
module FAU ( 
  ...
  nor2   g00(.a(x06), .b(x00), .O(new_n26_));
  ...
  nand4  g22(.a(new_n32_), .b(new_n34_), .c(new_n42_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n27_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n32_), .b(new_n34_), .c(x01), .d(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x06), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand3  g30(.a(new_n34_), .b(x01), .c(x00), .O(new_n56_));
  nand4  g31(.a(new_n47_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n33_), .O(z05));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  nor2   g35(.a(x09), .b(x01), .O(new_n61_));
  nor2   g36(.a(x11), .b(new_n42_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nor2   g38(.a(x08), .b(x01), .O(new_n64_));
  nor2   g39(.a(x10), .b(new_n42_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n41_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n47_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n69_));
  oai21  g44(.a(new_n68_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n32_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n33_), .O(z06));
  inv1   g47(.a(x06), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n41_), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x02), .c(new_n33_), .O(z07));
  nand4  g51(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n69_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n32_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n33_), .O(z08));
  oai21  g55(.a(new_n47_), .b(new_n73_), .c(new_n33_), .O(z09));
  nand2  g56(.a(x05), .b(x02), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x06), .c(new_n32_), .O(new_n83_));
