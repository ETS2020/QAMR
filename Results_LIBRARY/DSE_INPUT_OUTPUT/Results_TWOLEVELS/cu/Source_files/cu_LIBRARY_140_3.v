...
module FAU ( 
  ...
  nand4  g21(.a(new_n44_), .b(new_n34_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand3  g25(.a(new_n34_), .b(x01), .c(new_n41_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n37_), .O(z04));
  ...
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n44_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n37_), .O(z06));
  nand4  g43(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n44_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n37_), .O(z07));
  ...
  nand4  g50(.a(new_n33_), .b(new_n27_), .c(x06), .d(new_n44_), .O(new_n76_));
