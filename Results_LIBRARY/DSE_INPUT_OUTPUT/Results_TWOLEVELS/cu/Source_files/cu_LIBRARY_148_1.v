...
module FAU ( 
  ...
  oai21  g33(.a(x09), .b(x01), .c(new_n58_), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(x08), .c(x00), .O(new_n60_));
  inv1   g35(.a(x10), .O(new_n61_));
  oai21  g36(.a(new_n26_), .b(x01), .c(new_n42_), .O(new_n62_));
  inv1   g37(.a(x09), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n26_), .c(new_n43_), .O(new_n64_));
  ...
  nand4  g43(.a(new_n36_), .b(new_n45_), .c(new_n29_), .d(x02), .O(new_n69_));
  ...
  inv1   g47(.a(new_n50_), .O(z07));
  nand4  g48(.a(x13), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n74_));
