...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n43_), .c(x05), .d(new_n32_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n36_), .c(new_n28_), .d(new_n42_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x00), .O(z02));
  inv1   g22(.a(x00), .O(new_n48_));
  nor2   g23(.a(new_n46_), .b(new_n48_), .O(z03));
  nand3  g24(.a(new_n28_), .b(x01), .c(new_n48_), .O(new_n50_));
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n35_), .O(z04));
  nand3  g27(.a(new_n28_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n35_), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  nand2  g32(.a(x09), .b(new_n42_), .O(new_n58_));
  ...
  nand2  g37(.a(new_n62_), .b(x08), .O(new_n63_));
  aoi21  g38(.a(x10), .b(x01), .c(x08), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n48_), .O(new_n65_));
  inv1   g40(.a(x09), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n42_), .c(x00), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x11), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(new_n43_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n35_), .b(new_n43_), .c(new_n29_), .d(x02), .O(new_n72_));
  ...
  aoi21  g50(.a(new_n26_), .b(new_n42_), .c(x13), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g53(.a(x13), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n79_));
  ...
  nor3   g58(.a(new_n26_), .b(new_n43_), .c(new_n83_), .O(z09));
