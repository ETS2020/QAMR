...
module FAU ( 
  ...
  inv1   g42(.a(z03), .O(new_n68_));
  nand4  g43(.a(new_n47_), .b(new_n34_), .c(new_n30_), .d(new_n40_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand3  g46(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n72_));
