...
module FAU ( 
  ...
  nor2   g18(.a(x13), .b(new_n32_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n43_), .c(new_n31_), .d(new_n42_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n42_), .c(x00), .O(z02));
  nand3  g21(.a(new_n29_), .b(new_n42_), .c(x00), .O(new_n47_));
  nand3  g22(.a(new_n44_), .b(new_n31_), .c(new_n36_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n27_), .O(z03));
  nand4  g24(.a(new_n44_), .b(new_n43_), .c(new_n31_), .d(x00), .O(new_n51_));
  aoi21  g25(.a(new_n51_), .b(x00), .c(new_n42_), .O(z05));
  inv1   g26(.a(x13), .O(new_n53_));
  nand4  g27(.a(new_n27_), .b(new_n53_), .c(new_n32_), .d(x02), .O(new_n54_));
  ...
  aoi21  g35(.a(new_n61_), .b(new_n59_), .c(new_n53_), .O(new_n62_));
  ...
  aoi21  g40(.a(x01), .b(new_n26_), .c(x13), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand3  g45(.a(new_n71_), .b(x04), .c(new_n36_), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n27_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n27_), .O(z09));
  inv1   g49(.a(new_n33_), .O(new_n76_));
  nand4  g50(.a(new_n76_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n77_));
