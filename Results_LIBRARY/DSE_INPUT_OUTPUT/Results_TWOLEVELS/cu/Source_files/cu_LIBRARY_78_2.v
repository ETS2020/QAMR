...
module FAU ( 
  ...
  nand4  g10(.a(x06), .b(x05), .c(new_n29_), .d(new_n31_), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(new_n35_), .c(x03), .O(z01));
  inv1   g12(.a(x00), .O(new_n38_));
  inv1   g13(.a(x01), .O(new_n39_));
  nand4  g14(.a(new_n26_), .b(new_n31_), .c(new_n39_), .d(new_n38_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(new_n41_));
  nand4  g16(.a(new_n41_), .b(x06), .c(x05), .d(new_n29_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x13), .O(z02));
  nand4  g18(.a(new_n26_), .b(new_n31_), .c(new_n39_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x06), .c(x05), .d(new_n29_), .O(new_n46_));
  ...
  aoi21  g25(.a(new_n50_), .b(x06), .c(new_n32_), .O(z04));
  nand3  g26(.a(new_n49_), .b(new_n48_), .c(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x06), .c(new_n32_), .O(z05));
  ...
  nand4  g41(.a(new_n66_), .b(new_n54_), .c(x06), .d(x05), .O(new_n67_));
  inv1   g42(.a(x13), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n32_), .c(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(new_n27_), .b(new_n39_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n29_), .c(new_n26_), .d(new_n31_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(x06), .c(new_n32_), .O(z07));
  inv1   g50(.a(x12), .O(new_n76_));
  nand4  g51(.a(x13), .b(new_n76_), .c(x05), .d(new_n31_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n69_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n26_), .O(new_n79_));
  nand2  g54(.a(new_n27_), .b(x05), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(z08));
  nor2   g56(.a(new_n68_), .b(new_n27_), .O(z09));
