...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n37_), .c(new_n34_), .d(new_n44_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n43_), .c(x01), .O(z02));
  nand4  g24(.a(new_n47_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n43_), .c(x01), .O(z03));
  nand3  g26(.a(new_n34_), .b(x01), .c(new_n44_), .O(new_n52_));
  nand4  g27(.a(new_n45_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n27_), .O(z04));
  nor3   g29(.a(x02), .b(new_n26_), .c(new_n44_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n56_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n43_), .c(new_n44_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n45_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n27_), .b(new_n45_), .c(new_n31_), .d(x02), .O(new_n67_));
  ...
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n34_), .O(new_n74_));
  nand3  g49(.a(new_n45_), .b(new_n31_), .c(x02), .O(new_n75_));
  ...
  nor3   g54(.a(new_n28_), .b(new_n45_), .c(new_n79_), .O(z09));
