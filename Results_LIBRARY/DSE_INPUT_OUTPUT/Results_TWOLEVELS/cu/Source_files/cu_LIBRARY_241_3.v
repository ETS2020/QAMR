...
module FAU ( 
  ...
  aoi21  g17(.a(new_n42_), .b(new_n31_), .c(new_n28_), .O(z03));
  nand4  g18(.a(new_n39_), .b(new_n31_), .c(x01), .d(new_n37_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n31_), .c(new_n28_), .O(z04));
  inv1   g20(.a(x01), .O(new_n46_));
  nor3   g21(.a(x02), .b(new_n46_), .c(new_n37_), .O(new_n47_));
  ...
  nor2   g31(.a(x10), .b(new_n46_), .O(new_n57_));
  ...
  nand2  g38(.a(new_n63_), .b(new_n30_), .O(z06));
  nand4  g39(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n65_));
  nor2   g40(.a(new_n65_), .b(x02), .O(z07));
  nand4  g41(.a(x13), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n67_));
  ...
  oai21  g46(.a(new_n52_), .b(new_n71_), .c(new_n30_), .O(z09));
  oai21  g47(.a(new_n71_), .b(x03), .c(new_n30_), .O(z10));
endmodule
