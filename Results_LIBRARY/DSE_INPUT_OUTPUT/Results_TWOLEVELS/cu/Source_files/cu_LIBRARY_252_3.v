...
module FAU ( 
  ...
  nand3  g21(.a(new_n44_), .b(x05), .c(new_n30_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n35_), .c(new_n28_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n42_), .c(new_n41_), .O(z03));
  ...
  inv1   g42(.a(z03), .O(new_n69_));
  nand4  g43(.a(new_n48_), .b(new_n35_), .c(new_n28_), .d(new_n41_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n69_), .O(z07));
  nand4  g45(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n72_));
  nand3  g46(.a(new_n44_), .b(new_n31_), .c(x02), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g48(.a(new_n74_), .b(new_n26_), .c(x04), .d(new_n35_), .O(new_n75_));
  inv1   g49(.a(new_n75_), .O(z08));
  nand3  g50(.a(new_n26_), .b(x13), .c(x06), .O(new_n77_));
  inv1   g51(.a(new_n77_), .O(z09));
  inv1   g52(.a(new_n32_), .O(new_n79_));
  nand3  g53(.a(new_n79_), .b(x06), .c(new_n35_), .O(new_n80_));
  nand2  g54(.a(new_n80_), .b(new_n26_), .O(z10));
  zero   g55(.O(z05));
endmodule
