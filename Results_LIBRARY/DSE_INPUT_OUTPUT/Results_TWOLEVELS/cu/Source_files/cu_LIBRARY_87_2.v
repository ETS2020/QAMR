...
module FAU ( 
  ...
  nand4  g48(.a(new_n69_), .b(x05), .c(new_n30_), .d(new_n42_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  inv1   g50(.a(new_n27_), .O(new_n76_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n76_), .O(z08));
  and2   g55(.a(x13), .b(x06), .O(z09));
  inv1   g56(.a(new_n32_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n76_), .c(x06), .d(new_n42_), .O(new_n83_));
