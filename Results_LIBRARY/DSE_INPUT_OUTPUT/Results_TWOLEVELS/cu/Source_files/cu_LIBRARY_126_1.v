...
module FAU ( 
  ...
  oai21  g08(.a(new_n30_), .b(x04), .c(new_n26_), .O(new_n34_));
  ...
  nand4  g22(.a(new_n36_), .b(new_n26_), .c(new_n47_), .d(x00), .O(new_n48_));
  ...
  nand3  g27(.a(new_n26_), .b(x01), .c(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n46_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n28_), .O(z04));
  ...
  nand4  g43(.a(new_n46_), .b(new_n30_), .c(x02), .d(x01), .O(new_n69_));
  ...
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n28_), .O(z07));
  nand3  g49(.a(new_n46_), .b(new_n30_), .c(x04), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x03), .c(x01), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(x02), .O(new_n77_));
  nor2   g52(.a(new_n40_), .b(x03), .O(new_n78_));
  nor2   g53(.a(new_n46_), .b(x12), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n78_), .c(x05), .d(new_n26_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n77_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n27_), .b(new_n46_), .c(new_n82_), .O(z09));
  oai21  g58(.a(x05), .b(new_n47_), .c(x02), .O(new_n84_));
