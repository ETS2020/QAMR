...
module FAU ( 
  ...
  nor2   g00(.a(x11), .b(x10), .O(new_n26_));
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n46_));
  ...
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n53_));
  ...
  nand3  g34(.a(x11), .b(new_n59_), .c(new_n42_), .O(new_n60_));
  inv1   g35(.a(x11), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(x10), .c(x00), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(x01), .O(new_n64_));
  inv1   g39(.a(x09), .O(new_n65_));
  nand2  g40(.a(new_n61_), .b(x10), .O(new_n66_));
  nand2  g41(.a(x11), .b(new_n43_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n65_), .c(x00), .O(new_n69_));
  inv1   g44(.a(x08), .O(new_n70_));
  nand2  g45(.a(x11), .b(new_n59_), .O(new_n71_));
  nand2  g46(.a(x10), .b(new_n43_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n70_), .c(new_n42_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n69_), .c(new_n64_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x13), .c(new_n58_), .d(new_n57_), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x05), .c(new_n28_), .O(new_n78_));
  nand3  g53(.a(new_n52_), .b(new_n29_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n36_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z06));
  nand4  g57(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n79_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n36_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n35_), .O(z08));
  inv1   g61(.a(x06), .O(new_n87_));
  nor3   g62(.a(new_n26_), .b(new_n45_), .c(new_n87_), .O(z09));
  nand2  g63(.a(x05), .b(x02), .O(new_n89_));
  nand4  g64(.a(new_n89_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n90_));
