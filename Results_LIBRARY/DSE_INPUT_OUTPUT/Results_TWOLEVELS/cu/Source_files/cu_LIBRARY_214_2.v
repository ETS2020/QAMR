...
module FAU ( 
  ...
  nand3  g20(.a(new_n35_), .b(x01), .c(new_n45_), .O(new_n46_));
  ...
  nand4  g27(.a(new_n27_), .b(new_n47_), .c(new_n37_), .d(x02), .O(new_n53_));
