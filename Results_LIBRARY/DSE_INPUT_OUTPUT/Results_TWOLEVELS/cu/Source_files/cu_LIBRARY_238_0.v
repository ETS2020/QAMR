...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x08), .c(x05), .d(new_n27_), .O(new_n46_));
  ...
  nand3  g27(.a(new_n34_), .b(x01), .c(new_n42_), .O(new_n53_));
  inv1   g28(.a(x13), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n33_), .O(z04));
  nand3  g31(.a(new_n34_), .b(x01), .c(x00), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n55_), .c(new_n33_), .O(z05));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  inv1   g35(.a(x09), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(x08), .c(new_n43_), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(x01), .c(new_n42_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n66_), .c(new_n54_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n33_), .b(new_n54_), .c(new_n35_), .d(x02), .O(new_n71_));
  oai21  g46(.a(new_n70_), .b(x02), .c(new_n71_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n32_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z06));
  aoi21  g49(.a(new_n49_), .b(new_n43_), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n71_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n32_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n33_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n26_), .b(new_n54_), .c(new_n82_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x06), .c(new_n32_), .O(new_n85_));
