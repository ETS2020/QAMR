...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x11), .c(x05), .d(new_n27_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand2  g22(.a(new_n36_), .b(new_n33_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x11), .c(x13), .O(z03));
  nor2   g26(.a(x02), .b(new_n43_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n49_), .c(new_n42_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x11), .c(x13), .O(z04));
  nand3  g29(.a(new_n52_), .b(new_n49_), .c(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x11), .c(x13), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x11), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(x01), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand3  g35(.a(x13), .b(new_n60_), .c(new_n43_), .O(new_n61_));
  ...
  nand3  g43(.a(new_n68_), .b(x13), .c(new_n42_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(x12), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n57_), .c(x05), .d(new_n34_), .O(new_n71_));
  inv1   g46(.a(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x11), .c(new_n35_), .d(x02), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n33_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n32_), .O(z06));
  nor2   g51(.a(x11), .b(x01), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(new_n42_), .c(new_n35_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n27_), .c(new_n33_), .d(new_n34_), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(x11), .c(x13), .O(z07));
  inv1   g55(.a(x12), .O(new_n81_));
  nand4  g56(.a(x13), .b(new_n81_), .c(x05), .d(new_n34_), .O(new_n82_));
  ...
  nand2  g61(.a(new_n86_), .b(new_n32_), .O(z09));
  nand2  g62(.a(x05), .b(x02), .O(new_n88_));
  nand3  g63(.a(new_n88_), .b(x06), .c(new_n33_), .O(new_n89_));
  nand2  g64(.a(new_n89_), .b(new_n32_), .O(z10));
endmodule
