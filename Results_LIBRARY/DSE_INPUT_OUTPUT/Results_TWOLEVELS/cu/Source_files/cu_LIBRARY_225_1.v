...
module FAU ( 
  ...
  oai21  g02(.a(x10), .b(x04), .c(new_n27_), .O(new_n28_));
  ...
  nand4  g16(.a(new_n41_), .b(new_n40_), .c(x05), .d(new_n30_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(new_n34_), .c(x02), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n26_), .b(new_n27_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n34_), .c(x05), .d(new_n30_), .O(new_n47_));
  ...
  nand3  g44(.a(new_n40_), .b(new_n31_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  oai21  g48(.a(x01), .b(x00), .c(x10), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n40_), .c(x05), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n30_), .c(new_n26_), .O(new_n77_));
  aoi21  g52(.a(new_n77_), .b(new_n34_), .c(x02), .O(z07));
  nand2  g53(.a(x05), .b(new_n27_), .O(new_n79_));
  nand3  g54(.a(x13), .b(new_n59_), .c(new_n34_), .O(new_n80_));
  oai21  g55(.a(new_n80_), .b(new_n79_), .c(new_n70_), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(x04), .c(new_n26_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z08));
  nand2  g58(.a(x13), .b(x06), .O(new_n84_));
  oai21  g59(.a(new_n34_), .b(x02), .c(new_n84_), .O(z09));
