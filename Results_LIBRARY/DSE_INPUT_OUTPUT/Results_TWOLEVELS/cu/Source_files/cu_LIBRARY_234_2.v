...
module FAU ( 
  ...
  nand3  g26(.a(new_n45_), .b(x05), .c(new_n28_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n35_), .c(new_n32_), .d(new_n42_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x11), .c(new_n43_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n35_), .c(new_n32_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x11), .c(new_n43_), .O(z05));
  ...
  nand4  g44(.a(new_n36_), .b(new_n45_), .c(new_n29_), .d(x02), .O(new_n70_));
  ...
  nand3  g48(.a(new_n53_), .b(new_n35_), .c(new_n32_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n36_), .O(z07));
  nand4  g50(.a(x13), .b(new_n59_), .c(x05), .d(new_n32_), .O(new_n76_));
