...
module FAU ( 
  ...
  nand4  g29(.a(new_n33_), .b(new_n41_), .c(new_n27_), .d(x02), .O(new_n55_));
  ...
  nand3  g36(.a(new_n61_), .b(x01), .c(new_n47_), .O(new_n62_));
  ...
  aoi21  g42(.a(new_n42_), .b(new_n47_), .c(x13), .O(new_n68_));
  ...
  nand3  g46(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n72_));
