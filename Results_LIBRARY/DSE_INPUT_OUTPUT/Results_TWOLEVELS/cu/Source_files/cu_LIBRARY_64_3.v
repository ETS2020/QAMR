...
module FAU ( 
  ...
  nand3  g20(.a(new_n34_), .b(new_n45_), .c(x00), .O(new_n46_));
  nand4  g21(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n41_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n46_), .c(new_n37_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n34_), .b(x01), .c(new_n49_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n47_), .c(new_n37_), .O(z04));
  nand3  g26(.a(new_n34_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n47_), .c(new_n37_), .O(z05));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(x01), .c(x00), .O(new_n57_));
  inv1   g32(.a(x08), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n45_), .c(new_n49_), .O(new_n59_));
  inv1   g34(.a(x10), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x01), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n59_), .c(new_n57_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n55_), .d(new_n26_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n54_), .c(x05), .d(new_n34_), .O(new_n65_));
  nand3  g40(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n41_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z06));
  nand4  g44(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n41_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(x02), .c(new_n37_), .O(z07));
  nand4  g46(.a(x13), .b(new_n55_), .c(x05), .d(new_n34_), .O(new_n72_));
  ...
  aoi21  g51(.a(new_n26_), .b(new_n76_), .c(new_n27_), .O(z09));
  nand3  g52(.a(new_n33_), .b(x06), .c(new_n41_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n37_), .O(z10));
endmodule
