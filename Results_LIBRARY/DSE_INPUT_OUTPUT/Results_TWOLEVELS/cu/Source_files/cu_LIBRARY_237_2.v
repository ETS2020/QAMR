...
module FAU ( 
  ...
  nand4  g25(.a(new_n50_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z03));
  nor2   g27(.a(x02), .b(new_n44_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n46_), .c(new_n43_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n26_), .c(x13), .O(z04));
  nand3  g30(.a(new_n53_), .b(new_n46_), .c(x00), .O(new_n56_));
  ...
  nand3  g47(.a(x09), .b(new_n44_), .c(x00), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x05), .c(new_n30_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n36_), .c(new_n28_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(new_n26_), .c(x13), .O(z07));
  nand4  g52(.a(x13), .b(new_n59_), .c(x05), .d(new_n28_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n36_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n35_), .O(z08));
  nand2  g56(.a(x13), .b(x06), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n35_), .O(z09));
  inv1   g58(.a(new_n32_), .O(new_n84_));
