...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n29_), .c(new_n45_), .d(new_n44_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n26_), .c(x13), .O(z02));
  nand4  g24(.a(new_n47_), .b(new_n29_), .c(new_n45_), .d(x00), .O(new_n50_));
  ...
  nand3  g42(.a(new_n59_), .b(new_n30_), .c(x02), .O(new_n68_));
  ...
  nand2  g46(.a(new_n47_), .b(new_n29_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n26_), .c(x13), .O(z07));
  ...
  nand4  g55(.a(new_n80_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n81_));
