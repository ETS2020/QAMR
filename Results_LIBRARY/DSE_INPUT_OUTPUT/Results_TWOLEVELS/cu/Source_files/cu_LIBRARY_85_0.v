...
module FAU ( 
  ...
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n36_), .O(z04));
  nand3  g30(.a(new_n32_), .b(x01), .c(x00), .O(new_n56_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n53_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n65_));
  nand3  g40(.a(new_n53_), .b(new_n29_), .c(x02), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n59_), .b(new_n43_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n59_), .c(x05), .d(new_n32_), .O(new_n73_));
  ...
  nand2  g52(.a(new_n77_), .b(new_n36_), .O(z09));
  nand3  g53(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n79_));
