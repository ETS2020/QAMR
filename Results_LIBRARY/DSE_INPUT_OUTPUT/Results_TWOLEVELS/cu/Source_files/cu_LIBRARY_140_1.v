...
module FAU ( 
  ...
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n36_), .O(z04));
  nand3  g26(.a(new_n29_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n44_), .c(new_n36_), .O(z05));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n26_), .O(new_n62_));
  ...
  nand2  g41(.a(new_n66_), .b(new_n36_), .O(z06));
  nand4  g42(.a(new_n26_), .b(x05), .c(new_n33_), .d(new_n43_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(x02), .c(new_n36_), .O(z07));
  nand2  g44(.a(x05), .b(new_n29_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n55_), .c(x06), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n43_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z08));
  nand2  g49(.a(x05), .b(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n43_), .O(new_n76_));
