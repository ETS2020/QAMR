...
module FAU ( 
  ...
  aoi21  g07(.a(new_n32_), .b(new_n28_), .c(z02), .O(z00));
  ...
  nand4  g17(.a(new_n35_), .b(new_n27_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nor2   g22(.a(x13), .b(new_n30_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n47_), .c(new_n29_), .d(x01), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x01), .c(x00), .O(z04));
  ...
  nand3  g29(.a(new_n47_), .b(x05), .c(x04), .O(new_n55_));
  ...
  nand2  g35(.a(new_n60_), .b(new_n54_), .O(new_n61_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n41_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n68_));
  ...
  aoi21  g46(.a(new_n42_), .b(new_n54_), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand4  g49(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n75_));
  ...
  nor3   g54(.a(z02), .b(new_n41_), .c(new_n79_), .O(z09));
  inv1   g55(.a(new_n31_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n82_));
