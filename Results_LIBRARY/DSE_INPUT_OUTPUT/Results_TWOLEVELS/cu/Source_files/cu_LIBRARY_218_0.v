...
module FAU ( 
  ...
  nand3  g20(.a(new_n45_), .b(x05), .c(new_n36_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x05), .c(x01), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n35_), .b(x01), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n45_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n28_), .O(z04));
  nand3  g28(.a(new_n35_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n28_), .O(z05));
  ...
  nand4  g40(.a(new_n45_), .b(new_n27_), .c(x02), .d(x01), .O(new_n66_));
  ...
  nor3   g44(.a(new_n46_), .b(x03), .c(x02), .O(z07));
  ...
  nand2  g49(.a(new_n74_), .b(new_n28_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n28_), .O(z09));
  oai21  g52(.a(x05), .b(new_n26_), .c(new_n71_), .O(new_n78_));
