...
module FAU ( 
  ...
  nand3  g37(.a(new_n62_), .b(new_n42_), .c(x01), .O(new_n63_));
  ...
  nand3  g43(.a(new_n68_), .b(new_n42_), .c(x01), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n43_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n53_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(x05), .d(new_n35_), .O(new_n73_));
  nand4  g48(.a(new_n27_), .b(new_n53_), .c(new_n37_), .d(x02), .O(new_n74_));
  ...
  aoi21  g52(.a(x07), .b(new_n26_), .c(x13), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(x02), .O(z07));
  nand4  g55(.a(x13), .b(new_n59_), .c(x05), .d(new_n35_), .O(new_n81_));
  nand3  g56(.a(new_n53_), .b(new_n37_), .c(x02), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n27_), .c(x04), .d(new_n34_), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z08));
  nand2  g60(.a(x13), .b(x06), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n27_), .O(z09));
  nand2  g62(.a(x05), .b(x02), .O(new_n88_));
  nand4  g63(.a(new_n88_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n89_));
