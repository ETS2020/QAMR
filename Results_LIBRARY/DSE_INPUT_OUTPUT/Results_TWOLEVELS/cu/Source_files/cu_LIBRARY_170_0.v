...
module FAU ( 
  ...
  nand3  g38(.a(new_n63_), .b(new_n41_), .c(x00), .O(new_n64_));
  oai21  g39(.a(new_n62_), .b(x00), .c(new_n64_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(x13), .c(new_n59_), .d(x11), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n68_));
  nand3  g43(.a(new_n51_), .b(new_n32_), .c(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  nand4  g47(.a(new_n51_), .b(x11), .c(x05), .d(new_n31_), .O(new_n73_));
  nor3   g48(.a(new_n73_), .b(x03), .c(x02), .O(z07));
  nand2  g49(.a(x05), .b(new_n27_), .O(new_n75_));
  nand3  g50(.a(x13), .b(new_n59_), .c(x11), .O(new_n76_));
  ...
  oai21  g55(.a(x11), .b(x02), .c(new_n80_), .O(z09));
  aoi21  g56(.a(x06), .b(new_n26_), .c(new_n28_), .O(new_n82_));
  nand3  g57(.a(x06), .b(new_n32_), .c(new_n26_), .O(new_n83_));
