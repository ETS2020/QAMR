...
module FAU ( 
  ...
  nand3  g38(.a(new_n63_), .b(new_n43_), .c(new_n42_), .O(new_n64_));
  ...
  nor2   g44(.a(x11), .b(new_n43_), .O(new_n70_));
  aoi21  g45(.a(x08), .b(new_n43_), .c(x00), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n68_), .c(new_n45_), .O(new_n73_));
  ...
  nand3  g59(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n85_));
