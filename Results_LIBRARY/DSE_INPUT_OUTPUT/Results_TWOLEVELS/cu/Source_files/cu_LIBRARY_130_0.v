...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n68_, new_n70_, new_n71_, new_n74_, new_n75_, new_n76_;
  ...
  nand4  g11(.a(x13), .b(new_n28_), .c(x04), .d(x02), .O(new_n37_));
  ...
  nand4  g17(.a(new_n42_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n43_));
  ...
  nor3   g25(.a(x02), .b(new_n50_), .c(new_n45_), .O(new_n51_));
  ...
  nor2   g31(.a(x11), .b(new_n50_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  nor2   g33(.a(x08), .b(x01), .O(new_n59_));
  nor2   g34(.a(x10), .b(new_n50_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n45_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n55_), .d(new_n54_), .O(new_n63_));
  nor2   g38(.a(new_n63_), .b(new_n28_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x04), .c(new_n26_), .d(new_n31_), .O(new_n65_));
  nand2  g40(.a(new_n29_), .b(new_n28_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  nand4  g42(.a(new_n29_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n68_));
  ...
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n66_), .O(z08));
  and2   g47(.a(x13), .b(x06), .O(z09));
  nand2  g48(.a(x13), .b(new_n28_), .O(new_n74_));
  oai21  g49(.a(new_n28_), .b(x02), .c(new_n74_), .O(new_n75_));
