...
module FAU ( 
  ...
  aoi21  g18(.a(new_n43_), .b(x11), .c(x01), .O(z02));
  ...
  nand4  g26(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n52_));
  ...
  oai21  g33(.a(x09), .b(x01), .c(x11), .O(new_n59_));
  ...
  nand4  g40(.a(new_n33_), .b(new_n41_), .c(new_n36_), .d(x02), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n32_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n33_), .O(z06));
  nor2   g44(.a(x11), .b(x01), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(x00), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n33_), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n34_), .O(new_n74_));
  nand3  g49(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n33_), .c(x04), .d(new_n32_), .O(new_n77_));
  ...
  nand4  g56(.a(new_n81_), .b(new_n33_), .c(x06), .d(new_n32_), .O(new_n82_));
