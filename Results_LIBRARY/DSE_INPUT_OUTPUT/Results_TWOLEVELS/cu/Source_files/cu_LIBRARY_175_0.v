...
module FAU ( 
  ...
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z05));
  nand4  g33(.a(new_n32_), .b(new_n51_), .c(new_n36_), .d(x02), .O(new_n59_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n34_), .d(x01), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n59_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n33_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  aoi21  g47(.a(new_n61_), .b(new_n42_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n32_), .O(z07));
  nand4  g50(.a(x13), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n59_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n82_), .b(x06), .c(new_n33_), .O(new_n83_));
