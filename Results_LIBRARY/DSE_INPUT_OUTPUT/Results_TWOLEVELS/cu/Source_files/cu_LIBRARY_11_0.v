...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n32_), .c(new_n34_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x01), .c(x00), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nand3  g21(.a(new_n34_), .b(new_n46_), .c(x00), .O(new_n47_));
  nand4  g22(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n34_), .b(x01), .c(new_n50_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n48_), .c(new_n33_), .O(z04));
  ...
  nand2  g35(.a(new_n60_), .b(new_n33_), .O(new_n61_));
  inv1   g36(.a(x11), .O(new_n62_));
  nand2  g37(.a(x09), .b(new_n46_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n62_), .c(x06), .O(new_n64_));
  inv1   g39(.a(x09), .O(new_n65_));
  nand3  g40(.a(x11), .b(new_n65_), .c(new_n46_), .O(new_n66_));
  ...
  nand2  g45(.a(x11), .b(new_n50_), .O(new_n71_));
  oai21  g46(.a(x11), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n69_), .c(x01), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n68_), .c(new_n41_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n57_), .c(new_n55_), .d(x05), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x02), .c(new_n61_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n32_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z06));
  inv1   g53(.a(new_n44_), .O(z07));
  nand2  g54(.a(x05), .b(new_n34_), .O(new_n80_));
  nand2  g55(.a(x13), .b(new_n57_), .O(new_n81_));
  nand4  g56(.a(new_n33_), .b(new_n41_), .c(new_n36_), .d(x02), .O(new_n82_));
  oai21  g57(.a(new_n81_), .b(new_n80_), .c(new_n82_), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x04), .c(new_n32_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n33_), .O(z08));
  nor2   g60(.a(new_n41_), .b(new_n70_), .O(z09));
