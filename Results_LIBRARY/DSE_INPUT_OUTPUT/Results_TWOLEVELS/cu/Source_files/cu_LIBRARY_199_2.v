...
module FAU ( 
  ...
  nor3   g25(.a(x02), .b(new_n32_), .c(new_n46_), .O(new_n51_));
  ...
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(new_n59_));
  ...
  nand3  g45(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n71_));
  ...
  nor3   g50(.a(z03), .b(new_n45_), .c(new_n75_), .O(z09));
  nand3  g51(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n77_));
