...
module FAU ( 
  ...
  nand4  g21(.a(new_n37_), .b(new_n30_), .c(new_n33_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n26_), .O(new_n49_));
  ...
  aoi21  g46(.a(x01), .b(x00), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n26_), .d(new_n37_), .O(new_n73_));
  ...
  nand3  g55(.a(new_n29_), .b(x06), .c(new_n37_), .O(new_n81_));
