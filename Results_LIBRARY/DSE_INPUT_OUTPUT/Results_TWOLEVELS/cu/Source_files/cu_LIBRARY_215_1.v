...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(new_n30_), .c(new_n36_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z03));
  nor2   g23(.a(x03), .b(x02), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n46_), .c(new_n30_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x00), .c(new_n32_), .O(z05));
  nand3  g26(.a(x05), .b(new_n26_), .c(new_n32_), .O(new_n52_));
  ...
  oai21  g33(.a(new_n56_), .b(new_n52_), .c(new_n58_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(x00), .O(new_n60_));
  oai22  g35(.a(x11), .b(new_n32_), .c(x08), .d(x00), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(x13), .c(new_n55_), .d(new_n53_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x05), .c(new_n26_), .O(new_n64_));
  nand4  g39(.a(new_n57_), .b(new_n27_), .c(x02), .d(new_n32_), .O(new_n65_));
  ...
  inv1   g43(.a(x00), .O(new_n69_));
  aoi21  g44(.a(x01), .b(new_n69_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand2  g47(.a(x05), .b(new_n26_), .O(new_n73_));
  nand2  g48(.a(x13), .b(new_n55_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n34_), .c(x04), .d(new_n36_), .O(new_n76_));
