...
module FAU ( 
  ...
  nor2   g22(.a(x13), .b(new_n36_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n48_), .c(new_n27_), .d(x01), .O(new_n50_));
  aoi21  g24(.a(new_n50_), .b(x01), .c(x00), .O(z04));
  inv1   g25(.a(x00), .O(new_n52_));
  nor3   g26(.a(x02), .b(new_n43_), .c(new_n52_), .O(new_n53_));
  nand4  g27(.a(new_n53_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n54_));
  ...
  nand3  g36(.a(new_n62_), .b(x01), .c(new_n52_), .O(new_n63_));
  ...
  aoi21  g42(.a(new_n43_), .b(new_n52_), .c(x13), .O(new_n69_));
