...
module FAU ( 
  ...
  nand4  g16(.a(new_n41_), .b(new_n26_), .c(new_n31_), .d(new_n38_), .O(new_n42_));
  aoi21  g17(.a(new_n42_), .b(x05), .c(x01), .O(z02));
  nand4  g18(.a(new_n26_), .b(new_n31_), .c(new_n27_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n39_), .c(x05), .d(new_n28_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  nand2  g22(.a(new_n29_), .b(new_n27_), .O(new_n48_));
  nand3  g23(.a(new_n31_), .b(x01), .c(new_n38_), .O(new_n49_));
  nand4  g24(.a(new_n39_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(z04));
  nand3  g26(.a(new_n31_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n50_), .c(new_n48_), .O(z05));
  ...
  nand4  g38(.a(new_n39_), .b(new_n29_), .c(x02), .d(x01), .O(new_n64_));
