...
module FAU ( 
  ...
  nand4  g10(.a(x06), .b(new_n32_), .c(x04), .d(x02), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(new_n35_), .c(x03), .O(z01));
  nand2  g12(.a(new_n28_), .b(x04), .O(new_n38_));
  ...
  nand3  g37(.a(new_n42_), .b(new_n32_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x06), .c(x04), .d(new_n26_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z06));
  nand4  g41(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n67_));
  ...
  nand4  g45(.a(new_n70_), .b(x06), .c(x04), .d(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z08));
  nor2   g47(.a(new_n42_), .b(new_n28_), .O(z09));
  nand3  g48(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n38_), .O(z10));
endmodule
