...
module FAU ( 
  ...
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n26_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n26_), .b(new_n35_), .c(new_n29_), .d(x02), .O(new_n68_));
  ...
  oai21  g46(.a(new_n35_), .b(x01), .c(x00), .O(new_n72_));
  oai21  g47(.a(new_n35_), .b(new_n43_), .c(new_n42_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n72_), .c(new_n29_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n32_), .c(new_n36_), .d(new_n28_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n35_), .c(x13), .O(z07));
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n28_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n68_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n36_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z08));
  nor2   g55(.a(new_n26_), .b(new_n35_), .O(z09));
  nand2  g56(.a(x05), .b(x02), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(x13), .c(x06), .d(new_n36_), .O(new_n83_));
