...
module FAU ( 
  ...
  nand3  g16(.a(new_n31_), .b(new_n41_), .c(new_n40_), .O(new_n42_));
  nor2   g17(.a(x13), .b(new_n28_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n27_), .c(new_n26_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n38_), .O(z02));
  nand3  g20(.a(new_n31_), .b(new_n41_), .c(x00), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n38_), .O(z03));
  nand4  g22(.a(new_n43_), .b(new_n27_), .c(new_n31_), .d(new_n40_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n26_), .c(new_n41_), .O(z04));
  ...
  oai21  g42(.a(new_n41_), .b(x00), .c(x03), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n69_));
