...
module FAU ( 
  ...
  aoi21  g20(.a(new_n45_), .b(x00), .c(x01), .O(z03));
  ...
  nand4  g27(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n33_), .O(z05));
  nand3  g29(.a(new_n41_), .b(x05), .c(x04), .O(new_n55_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n68_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n61_), .O(z06));
  aoi21  g47(.a(new_n44_), .b(new_n41_), .c(new_n62_), .O(new_n73_));
  aoi21  g48(.a(x01), .b(new_n47_), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n75_));
  oai22  g50(.a(new_n75_), .b(x02), .c(new_n73_), .d(x00), .O(z07));
  ...
  nand3  g57(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n83_));
