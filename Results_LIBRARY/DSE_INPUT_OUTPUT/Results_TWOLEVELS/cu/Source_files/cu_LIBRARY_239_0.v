...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand4  g24(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n49_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nor2   g28(.a(x04), .b(x03), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n31_), .c(x01), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x05), .c(x13), .O(z05));
  ...
  oai21  g44(.a(new_n44_), .b(new_n49_), .c(new_n28_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n27_), .c(new_n26_), .d(new_n31_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(x05), .c(x13), .O(z07));
  nor2   g47(.a(x03), .b(x02), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n58_), .c(x05), .d(x04), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(new_n29_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n39_), .O(z09));
  nand3  g52(.a(new_n33_), .b(x06), .c(new_n26_), .O(new_n78_));
