...
module FAU ( 
  ...
  aoi22  g08(.a(new_n33_), .b(new_n29_), .c(new_n27_), .d(new_n26_), .O(z00));
  ...
  nand4  g16(.a(new_n41_), .b(new_n28_), .c(new_n40_), .d(new_n39_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x07), .c(x05), .d(new_n30_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nor2   g20(.a(new_n26_), .b(new_n31_), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(new_n30_), .c(new_n41_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n28_), .c(new_n40_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x07), .c(x13), .O(z03));
  nand4  g25(.a(new_n41_), .b(new_n28_), .c(x01), .d(new_n39_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x07), .c(x05), .d(new_n30_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n48_), .b(new_n28_), .c(x01), .d(x00), .O(new_n55_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n27_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n26_), .d(x05), .O(new_n65_));
  nand4  g40(.a(new_n27_), .b(x07), .c(new_n31_), .d(x02), .O(new_n66_));
  ...
  nand4  g44(.a(new_n46_), .b(new_n30_), .c(new_n41_), .d(new_n28_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(x07), .c(x13), .O(z07));
  ...
  aoi21  g51(.a(new_n27_), .b(new_n26_), .c(new_n32_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x06), .c(new_n41_), .O(new_n78_));
