...
module FAU ( 
  ...
  nand4  g22(.a(new_n35_), .b(new_n36_), .c(new_n27_), .d(x00), .O(new_n48_));
  ...
  aoi21  g28(.a(new_n53_), .b(new_n26_), .c(new_n27_), .O(z04));
  ...
  nand3  g53(.a(new_n34_), .b(x13), .c(x06), .O(new_n79_));
