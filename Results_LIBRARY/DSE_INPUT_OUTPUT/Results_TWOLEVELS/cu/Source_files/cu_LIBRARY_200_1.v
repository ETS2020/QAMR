...
module FAU ( 
  ...
  nor3   g25(.a(x02), .b(new_n46_), .c(new_n26_), .O(new_n52_));
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nand4  g28(.a(new_n27_), .b(new_n45_), .c(new_n32_), .d(x02), .O(new_n55_));
  inv1   g29(.a(x07), .O(new_n56_));
  inv1   g30(.a(x12), .O(new_n57_));
  nor2   g31(.a(x09), .b(x01), .O(new_n58_));
  nor2   g32(.a(x11), .b(new_n46_), .O(new_n59_));
  oai21  g33(.a(new_n59_), .b(new_n58_), .c(x00), .O(new_n60_));
  inv1   g34(.a(x08), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n46_), .c(new_n26_), .O(new_n62_));
  ...
  aoi21  g41(.a(x01), .b(new_n26_), .c(x13), .O(new_n68_));
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n69_));
  oai21  g43(.a(new_n69_), .b(x02), .c(new_n27_), .O(z07));
