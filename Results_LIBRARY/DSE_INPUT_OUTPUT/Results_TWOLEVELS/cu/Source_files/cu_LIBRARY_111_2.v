...
module FAU ( 
  ...
  inv1   g13(.a(x07), .O(new_n41_));
  inv1   g14(.a(x12), .O(new_n42_));
  ...
  aoi21  g23(.a(new_n50_), .b(new_n46_), .c(new_n27_), .O(new_n51_));
  nand4  g24(.a(new_n51_), .b(new_n42_), .c(new_n41_), .d(x05), .O(new_n52_));
  nand3  g25(.a(new_n27_), .b(new_n32_), .c(x02), .O(new_n53_));
  oai21  g26(.a(new_n52_), .b(x02), .c(new_n53_), .O(new_n54_));
  nand3  g27(.a(new_n54_), .b(x04), .c(new_n26_), .O(new_n55_));
  inv1   g28(.a(new_n55_), .O(z06));
  nand4  g29(.a(x13), .b(new_n42_), .c(x05), .d(new_n29_), .O(new_n57_));
  nand2  g30(.a(new_n57_), .b(new_n53_), .O(new_n58_));
  nand3  g31(.a(new_n58_), .b(x04), .c(new_n26_), .O(new_n59_));
  inv1   g32(.a(new_n59_), .O(z08));
  and2   g33(.a(x13), .b(x06), .O(z09));
  nand3  g34(.a(new_n28_), .b(x06), .c(new_n26_), .O(new_n62_));
  inv1   g35(.a(new_n62_), .O(z10));
  zero   g36(.O(z02));
  zero   g37(.O(z05));
  nor2   g38(.a(x13), .b(new_n32_), .O(z04));
  nor2   g39(.a(x13), .b(new_n32_), .O(z07));
endmodule
