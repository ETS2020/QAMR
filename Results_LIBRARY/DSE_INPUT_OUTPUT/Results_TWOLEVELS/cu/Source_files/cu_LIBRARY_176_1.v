...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n31_), .c(x05), .d(new_n26_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nand4  g20(.a(new_n41_), .b(new_n29_), .c(new_n40_), .d(x00), .O(new_n46_));
  ...
  aoi21  g29(.a(new_n54_), .b(new_n31_), .c(x04), .O(z04));
  nand3  g30(.a(new_n53_), .b(new_n50_), .c(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n31_), .c(x04), .O(z05));
  ...
  aoi21  g46(.a(x06), .b(new_n40_), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n41_), .d(new_n29_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n31_), .c(x04), .O(z07));
  ...
  nand3  g53(.a(x13), .b(x06), .c(x04), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z09));
  oai21  g55(.a(new_n35_), .b(new_n29_), .c(new_n41_), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(x04), .c(new_n31_), .O(z10));
endmodule
