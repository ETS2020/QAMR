...
module FAU ( 
  ...
  nand4  g27(.a(new_n52_), .b(new_n44_), .c(x05), .d(new_n29_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand4  g29(.a(x05), .b(x04), .c(new_n35_), .d(new_n36_), .O(new_n56_));
  ...
  aoi21  g40(.a(new_n66_), .b(new_n64_), .c(new_n44_), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(new_n59_), .c(new_n57_), .d(x05), .O(new_n68_));
  nand3  g42(.a(new_n44_), .b(new_n38_), .c(x02), .O(new_n69_));
  oai21  g43(.a(new_n68_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand3  g44(.a(new_n70_), .b(x04), .c(new_n35_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n62_), .O(z06));
  aoi21  g46(.a(x01), .b(x00), .c(x13), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n74_));
  ...
  nand3  g51(.a(new_n77_), .b(x04), .c(new_n35_), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n34_), .O(z08));
  nand3  g53(.a(new_n34_), .b(x13), .c(x06), .O(new_n80_));
  inv1   g54(.a(new_n80_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n82_));
  nand3  g56(.a(new_n82_), .b(x06), .c(new_n35_), .O(new_n83_));
  nand2  g57(.a(new_n83_), .b(new_n34_), .O(z10));
  zero   g58(.O(z05));
endmodule
