...
module FAU ( 
  ...
  nand3  g18(.a(new_n26_), .b(x05), .c(new_n29_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n37_), .c(new_n33_), .d(new_n43_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n26_), .c(x00), .O(z02));
  nand4  g22(.a(new_n37_), .b(new_n33_), .c(new_n43_), .d(x00), .O(new_n48_));
  ...
  nand4  g27(.a(new_n37_), .b(new_n33_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n26_), .c(x05), .d(new_n29_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nor3   g31(.a(x02), .b(new_n43_), .c(new_n52_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n58_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n33_), .d(x00), .O(new_n69_));
  nand3  g44(.a(new_n26_), .b(new_n30_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n37_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  nor3   g48(.a(new_n44_), .b(x03), .c(x02), .O(z07));
  nand2  g49(.a(new_n33_), .b(x00), .O(new_n75_));
  nand3  g50(.a(x13), .b(new_n61_), .c(x05), .O(new_n76_));
  ...
  aoi21  g55(.a(new_n80_), .b(x00), .c(new_n26_), .O(z09));
  nand4  g56(.a(new_n32_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n82_));
