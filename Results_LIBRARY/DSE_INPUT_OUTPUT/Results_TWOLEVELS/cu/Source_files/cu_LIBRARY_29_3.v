...
module FAU ( 
  ...
  nand4  g22(.a(new_n38_), .b(new_n34_), .c(new_n47_), .d(x00), .O(new_n48_));
  ...
  nand4  g27(.a(new_n38_), .b(new_n34_), .c(x01), .d(new_n52_), .O(new_n53_));
  ...
  nand4  g32(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n37_), .O(z05));
  inv1   g34(.a(x07), .O(new_n60_));
  inv1   g35(.a(x12), .O(new_n61_));
  nand2  g36(.a(x10), .b(x01), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n52_), .O(new_n63_));
  ...
  nand3  g45(.a(new_n70_), .b(x05), .c(new_n34_), .O(new_n71_));
  nand3  g46(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n38_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n37_), .O(z06));
  nand4  g50(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(x02), .c(new_n37_), .O(z07));
  ...
  nand3  g56(.a(x13), .b(new_n26_), .c(x06), .O(new_n82_));
