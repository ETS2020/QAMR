...
module FAU ( 
  ...
  nand4  g19(.a(new_n37_), .b(new_n30_), .c(new_n26_), .d(new_n44_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n43_), .c(x05), .d(new_n34_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x13), .O(z02));
  nor2   g23(.a(x03), .b(x02), .O(new_n49_));
  nor2   g24(.a(x13), .b(new_n31_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n49_), .c(new_n34_), .d(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n43_), .c(x01), .O(z03));
  inv1   g27(.a(x13), .O(new_n53_));
  nand4  g28(.a(new_n37_), .b(new_n30_), .c(x01), .d(new_n44_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n53_), .c(x05), .d(new_n34_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(z04));
  nand3  g32(.a(new_n30_), .b(x01), .c(x00), .O(new_n58_));
  nand3  g33(.a(new_n50_), .b(new_n34_), .c(new_n37_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n27_), .O(z05));
  inv1   g35(.a(x07), .O(new_n61_));
  inv1   g36(.a(x12), .O(new_n62_));
  nand2  g37(.a(x09), .b(new_n26_), .O(new_n63_));
  ...
  nand4  g44(.a(new_n27_), .b(new_n53_), .c(new_n31_), .d(x02), .O(new_n70_));
  ...
  nand3  g48(.a(x11), .b(new_n26_), .c(new_n44_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n53_), .c(x05), .d(new_n34_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n37_), .c(new_n30_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n27_), .O(z07));
  nand4  g53(.a(x13), .b(new_n62_), .c(x05), .d(new_n30_), .O(new_n79_));
  nand3  g54(.a(new_n53_), .b(new_n31_), .c(x02), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n27_), .c(x04), .d(new_n37_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z08));
  inv1   g58(.a(x06), .O(new_n84_));
  nor3   g59(.a(new_n28_), .b(new_n53_), .c(new_n84_), .O(z09));
  nand2  g60(.a(x05), .b(x02), .O(new_n86_));
  nand3  g61(.a(new_n86_), .b(x06), .c(new_n37_), .O(new_n87_));
