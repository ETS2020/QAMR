...
module FAU ( 
  ...
  nand4  g20(.a(new_n35_), .b(new_n30_), .c(new_n41_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n42_), .c(x05), .d(new_n26_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(new_n33_), .O(z04));
  nor3   g25(.a(x02), .b(new_n41_), .c(new_n32_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n52_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n41_), .c(new_n32_), .O(new_n61_));
  ...
  nand4  g41(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n67_));
  ...
  nand2  g46(.a(new_n71_), .b(new_n33_), .O(z08));
  inv1   g47(.a(x06), .O(new_n73_));
  nor3   g48(.a(z04), .b(new_n42_), .c(new_n73_), .O(z09));
  nand4  g49(.a(new_n33_), .b(new_n29_), .c(x06), .d(new_n35_), .O(new_n75_));
