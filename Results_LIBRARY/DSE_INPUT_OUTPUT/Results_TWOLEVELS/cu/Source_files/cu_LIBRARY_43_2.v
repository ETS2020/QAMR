...
module FAU ( 
  ...
  nor2   g13(.a(x05), .b(new_n38_), .O(new_n39_));
  inv1   g14(.a(new_n39_), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n37_), .O(z01));
  ...
  nand3  g19(.a(new_n30_), .b(new_n38_), .c(x00), .O(new_n45_));
  ...
  nand3  g25(.a(new_n50_), .b(new_n30_), .c(new_n49_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x05), .c(new_n38_), .O(z04));
  nand3  g27(.a(new_n50_), .b(new_n30_), .c(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x05), .c(new_n38_), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  inv1   g31(.a(x09), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(x05), .c(new_n38_), .O(new_n58_));
  ...
  nand3  g38(.a(new_n63_), .b(x05), .c(new_n38_), .O(new_n64_));
  ...
  aoi21  g49(.a(new_n28_), .b(new_n38_), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n27_), .c(new_n26_), .d(new_n30_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n40_), .O(z07));
  nand4  g52(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n78_));
  ...
  nor3   g57(.a(new_n39_), .b(new_n46_), .c(new_n82_), .O(z09));
  nand3  g58(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n84_));
