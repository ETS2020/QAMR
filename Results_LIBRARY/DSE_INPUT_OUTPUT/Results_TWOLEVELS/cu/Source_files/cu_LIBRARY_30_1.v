...
module FAU ( 
  ...
  nand3  g25(.a(new_n31_), .b(x01), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n44_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n52_));
  ...
  nand3  g41(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n67_));
  ...
  nand4  g45(.a(new_n44_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(x02), .c(new_n39_), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n73_));
