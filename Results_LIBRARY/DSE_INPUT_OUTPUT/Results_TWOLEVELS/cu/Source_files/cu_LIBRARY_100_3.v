...
module FAU ( 
  ...
  nand3  g20(.a(new_n45_), .b(x05), .c(new_n26_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n34_), .c(new_n30_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n44_), .c(new_n43_), .O(z03));
  nand4  g24(.a(new_n34_), .b(new_n30_), .c(x01), .d(new_n43_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n45_), .c(x05), .d(new_n26_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand4  g28(.a(x05), .b(x04), .c(new_n34_), .d(new_n30_), .O(new_n55_));
  ...
  oai21  g33(.a(new_n59_), .b(new_n55_), .c(new_n44_), .O(new_n60_));
  nand2  g34(.a(new_n60_), .b(x00), .O(new_n61_));
  inv1   g35(.a(x08), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(new_n44_), .c(new_n43_), .O(new_n63_));
  ...
  nor4   g45(.a(new_n46_), .b(x03), .c(x02), .d(x00), .O(new_n72_));
  or2    g46(.a(new_n72_), .b(z03), .O(z07));
  ...
  nand2  g50(.a(new_n76_), .b(new_n32_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n32_), .O(z09));
  nand3  g53(.a(new_n29_), .b(x06), .c(new_n34_), .O(new_n80_));
