...
module FAU ( 
  ...
  nand3  g18(.a(new_n29_), .b(new_n28_), .c(new_n43_), .O(new_n44_));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n26_), .O(z02));
  nand4  g22(.a(new_n36_), .b(new_n29_), .c(new_n28_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n45_), .c(x05), .d(new_n40_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n36_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n45_), .c(x05), .d(new_n40_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nor3   g30(.a(x02), .b(new_n28_), .c(new_n43_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z05));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  nor2   g35(.a(x09), .b(x01), .O(new_n61_));
  nor2   g36(.a(x11), .b(new_n28_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nor2   g38(.a(x08), .b(x01), .O(new_n64_));
  nor2   g39(.a(x10), .b(new_n28_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n45_), .b(new_n30_), .c(x02), .d(new_n28_), .O(new_n69_));
  ...
  nand4  g47(.a(new_n45_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand3  g49(.a(new_n45_), .b(new_n30_), .c(x04), .O(new_n75_));
