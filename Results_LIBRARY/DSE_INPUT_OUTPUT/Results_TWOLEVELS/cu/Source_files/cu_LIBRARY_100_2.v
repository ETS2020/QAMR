...
module FAU ( 
  ...
  nand4  g20(.a(new_n36_), .b(new_n30_), .c(x01), .d(new_n32_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n26_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z04));
  inv1   g24(.a(x01), .O(new_n50_));
  nor3   g25(.a(x02), .b(new_n50_), .c(new_n32_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z05));
  nor2   g28(.a(x03), .b(x02), .O(new_n54_));
  nand3  g29(.a(new_n54_), .b(x05), .c(x04), .O(new_n55_));
  ...
  nand3  g39(.a(new_n64_), .b(x01), .c(new_n32_), .O(new_n65_));
  ...
  nand3  g46(.a(new_n45_), .b(x05), .c(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n54_), .c(new_n50_), .O(new_n74_));
  nand4  g49(.a(new_n73_), .b(new_n36_), .c(new_n30_), .d(new_n32_), .O(new_n75_));
  oai21  g50(.a(new_n74_), .b(new_n32_), .c(new_n75_), .O(z07));
  ...
  nand3  g57(.a(new_n29_), .b(x06), .c(new_n36_), .O(new_n83_));
