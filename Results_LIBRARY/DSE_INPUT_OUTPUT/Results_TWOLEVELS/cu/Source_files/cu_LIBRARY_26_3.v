...
module FAU ( 
  ...
  nand3  g19(.a(new_n34_), .b(new_n44_), .c(new_n26_), .O(new_n45_));
  nand4  g20(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n37_), .O(z02));
  nand4  g22(.a(new_n38_), .b(new_n34_), .c(new_n44_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n38_), .b(new_n34_), .c(x01), .d(new_n26_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nor3   g30(.a(x02), .b(new_n44_), .c(new_n26_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n57_));
  ...
  nand4  g42(.a(new_n67_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n68_));
  ...
  nand4  g47(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand2  g49(.a(new_n34_), .b(new_n26_), .O(new_n75_));
  nand3  g50(.a(x13), .b(new_n60_), .c(x05), .O(new_n76_));
  ...
  aoi21  g55(.a(new_n80_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand4  g56(.a(new_n33_), .b(new_n37_), .c(x06), .d(new_n38_), .O(new_n82_));
