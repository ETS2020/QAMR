...
module FAU ( 
  ...
  nand4  g10(.a(x06), .b(new_n28_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n50_));
  ...
  nand4  g38(.a(new_n41_), .b(x06), .c(new_n28_), .d(x02), .O(new_n64_));
  ...
  nand4  g42(.a(new_n41_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n68_));
  ...
  nand2  g47(.a(new_n72_), .b(new_n47_), .O(z08));
  nor2   g48(.a(new_n41_), .b(new_n29_), .O(z09));
  aoi21  g49(.a(x06), .b(new_n27_), .c(new_n28_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x03), .c(new_n47_), .O(z10));
endmodule
