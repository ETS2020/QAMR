...
module FAU ( 
  ...
  nand3  g34(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n60_));
  ...
  nand4  g41(.a(new_n45_), .b(new_n27_), .c(x02), .d(x01), .O(new_n67_));
  ...
  aoi21  g45(.a(new_n51_), .b(new_n46_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand2  g48(.a(x05), .b(new_n26_), .O(new_n74_));
  nand2  g49(.a(x13), .b(new_n58_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n60_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  inv1   g53(.a(x06), .O(new_n79_));
  nor3   g54(.a(z02), .b(new_n45_), .c(new_n79_), .O(z09));
