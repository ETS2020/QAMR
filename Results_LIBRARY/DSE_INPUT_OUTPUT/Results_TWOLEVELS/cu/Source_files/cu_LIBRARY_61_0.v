...
module FAU ( 
  ...
  nand4  g18(.a(x12), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n44_));
  ...
  nand4  g24(.a(new_n45_), .b(new_n32_), .c(x01), .d(new_n42_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x12), .c(x13), .O(z04));
  nand4  g26(.a(new_n36_), .b(new_n32_), .c(x01), .d(x00), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x12), .c(x05), .d(new_n28_), .O(new_n54_));
  ...
  nor2   g38(.a(x10), .b(new_n60_), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n63_), .c(new_n42_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n58_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n58_), .b(x12), .c(new_n29_), .d(x02), .O(new_n68_));
  ...
  nand4  g46(.a(new_n58_), .b(x12), .c(x05), .d(new_n28_), .O(new_n72_));
  nor3   g47(.a(new_n72_), .b(x03), .c(x02), .O(z07));
  nand3  g48(.a(new_n57_), .b(x05), .c(new_n32_), .O(new_n74_));
