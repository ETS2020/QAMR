...
module FAU ( 
  ...
  nand3  g27(.a(new_n32_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n36_), .O(z05));
  ...
  nand4  g42(.a(x13), .b(new_n56_), .c(x05), .d(new_n32_), .O(new_n68_));
  ...
  nor3   g47(.a(new_n26_), .b(new_n43_), .c(new_n72_), .O(z09));
  nand3  g48(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n74_));
