...
module FAU ( 
  ...
  aoi21  g04(.a(new_n26_), .b(new_n28_), .c(new_n29_), .O(new_n30_));
  inv1   g05(.a(new_n30_), .O(new_n31_));
  nand2  g06(.a(new_n31_), .b(new_n27_), .O(z00));
  nand3  g07(.a(new_n29_), .b(x04), .c(new_n28_), .O(new_n33_));
  oai21  g08(.a(new_n30_), .b(x02), .c(new_n33_), .O(z01));
  inv1   g09(.a(x13), .O(new_n35_));
  nor2   g10(.a(x01), .b(x00), .O(new_n36_));
  nand4  g11(.a(new_n36_), .b(new_n35_), .c(new_n26_), .d(new_n28_), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(x05), .c(x02), .O(z02));
  inv1   g13(.a(x01), .O(new_n39_));
  inv1   g14(.a(x02), .O(new_n40_));
  nand4  g15(.a(new_n28_), .b(new_n40_), .c(new_n39_), .d(x00), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n35_), .c(x05), .d(new_n26_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand4  g20(.a(new_n28_), .b(new_n40_), .c(x01), .d(new_n45_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n35_), .c(x05), .d(new_n26_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z04));
  nor3   g24(.a(x02), .b(new_n39_), .c(new_n45_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n26_), .d(new_n28_), .O(new_n51_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n57_), .c(new_n35_), .O(new_n61_));
  ...
  nand4  g40(.a(new_n65_), .b(x04), .c(new_n28_), .d(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(z06));
  oai21  g42(.a(x01), .b(x00), .c(new_n29_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n35_), .c(new_n26_), .d(new_n28_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x05), .c(x02), .O(z07));
  nand4  g45(.a(x13), .b(new_n54_), .c(x05), .d(new_n40_), .O(new_n71_));
  nand2  g46(.a(new_n65_), .b(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n28_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  inv1   g50(.a(x06), .O(new_n76_));
  oai21  g51(.a(x05), .b(x02), .c(x13), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(new_n76_), .O(z09));
  xor2a  g53(.a(x05), .b(x02), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x06), .c(new_n28_), .O(new_n80_));
