...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nand3  g20(.a(new_n33_), .b(new_n26_), .c(x00), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n37_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n36_), .b(new_n33_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x07), .c(x05), .d(new_n29_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n36_), .b(new_n33_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x07), .c(x05), .d(new_n29_), .O(new_n57_));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n47_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n66_));
  nand3  g41(.a(new_n47_), .b(new_n30_), .c(x02), .O(new_n67_));
  ...
  aoi21  g45(.a(new_n59_), .b(x01), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n60_), .c(x05), .d(new_n33_), .O(new_n74_));
  ...
  nor3   g53(.a(new_n27_), .b(new_n47_), .c(new_n78_), .O(z09));
  nand3  g54(.a(new_n32_), .b(x06), .c(new_n36_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n37_), .O(z10));
endmodule
