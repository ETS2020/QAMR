...
module FAU ( 
  ...
  oai21  g03(.a(x12), .b(new_n27_), .c(new_n28_), .O(new_n29_));
  ...
  nor2   g15(.a(new_n35_), .b(x05), .O(new_n41_));
  ...
  nand4  g41(.a(new_n66_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n67_));
  ...
  nand2  g51(.a(new_n35_), .b(new_n28_), .O(new_n77_));
