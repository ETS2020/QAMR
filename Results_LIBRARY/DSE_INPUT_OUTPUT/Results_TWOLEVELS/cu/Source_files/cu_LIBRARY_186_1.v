...
module FAU ( 
  ...
  nor3   g19(.a(x02), .b(new_n45_), .c(new_n41_), .O(new_n46_));
  nand4  g20(.a(new_n46_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n47_));
  ...
  aoi21  g30(.a(new_n56_), .b(new_n54_), .c(new_n52_), .O(new_n57_));
  nand4  g31(.a(new_n57_), .b(new_n51_), .c(new_n50_), .d(x05), .O(new_n58_));
  nand3  g32(.a(new_n52_), .b(new_n32_), .c(x02), .O(new_n59_));
  oai21  g33(.a(new_n58_), .b(x02), .c(new_n59_), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(x04), .c(new_n26_), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(new_n49_), .O(z06));
  nand4  g36(.a(new_n52_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n63_));
  nor3   g37(.a(new_n63_), .b(x02), .c(new_n45_), .O(z07));
  nand4  g38(.a(x13), .b(new_n51_), .c(x05), .d(new_n27_), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(new_n59_), .O(new_n66_));
  nand3  g40(.a(new_n66_), .b(x04), .c(new_n26_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n49_), .O(z08));
  inv1   g42(.a(x06), .O(new_n69_));
  nor3   g43(.a(z03), .b(new_n52_), .c(new_n69_), .O(z09));
  nand3  g44(.a(new_n29_), .b(x06), .c(new_n26_), .O(new_n71_));
