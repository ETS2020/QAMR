...
module FAU ( 
  ...
  nand3  g16(.a(new_n41_), .b(x05), .c(new_n26_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n30_), .c(new_n40_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n31_), .c(x03), .O(z02));
  ...
  nand3  g30(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n57_));
  oai21  g31(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand4  g32(.a(new_n58_), .b(x04), .c(new_n35_), .d(new_n31_), .O(new_n59_));
  inv1   g33(.a(new_n59_), .O(z06));
  nand2  g34(.a(new_n43_), .b(new_n30_), .O(new_n61_));
  aoi21  g35(.a(new_n61_), .b(new_n31_), .c(x03), .O(z07));
  nand4  g36(.a(x13), .b(new_n50_), .c(x05), .d(new_n30_), .O(new_n63_));
  nand4  g37(.a(new_n41_), .b(new_n27_), .c(x02), .d(new_n31_), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(x04), .O(new_n66_));
  aoi21  g40(.a(new_n66_), .b(new_n31_), .c(x03), .O(z08));
  inv1   g41(.a(x06), .O(new_n68_));
  nor3   g42(.a(z04), .b(new_n41_), .c(new_n68_), .O(z09));
  nand4  g43(.a(new_n29_), .b(x06), .c(new_n35_), .d(new_n31_), .O(new_n70_));
