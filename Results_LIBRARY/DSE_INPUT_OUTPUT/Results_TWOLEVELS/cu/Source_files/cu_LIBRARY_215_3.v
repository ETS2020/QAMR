...
module FAU ( 
  ...
  aoi21  g52(.a(x01), .b(x00), .c(x13), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(x05), .c(new_n30_), .d(new_n34_), .O(new_n79_));
  ...
  nand4  g58(.a(new_n83_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n84_));
  ...
  nand3  g63(.a(new_n88_), .b(x06), .c(new_n34_), .O(new_n89_));
