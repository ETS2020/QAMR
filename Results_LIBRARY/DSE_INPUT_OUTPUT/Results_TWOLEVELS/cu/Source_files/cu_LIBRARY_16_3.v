...
module FAU ( 
  ...
  nand2  g00(.a(x08), .b(x02), .O(new_n26_));
  ...
  oai21  g20(.a(new_n45_), .b(new_n42_), .c(new_n26_), .O(z02));
  nand3  g21(.a(new_n28_), .b(new_n41_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n26_), .O(z03));
  nand3  g23(.a(new_n28_), .b(x01), .c(new_n40_), .O(new_n49_));
  ...
  nand4  g38(.a(new_n44_), .b(new_n31_), .c(new_n29_), .d(x02), .O(new_n64_));
