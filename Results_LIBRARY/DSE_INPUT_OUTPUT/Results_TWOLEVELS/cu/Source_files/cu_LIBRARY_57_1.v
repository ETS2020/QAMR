...
module FAU ( 
  ...
  nand4  g32(.a(new_n57_), .b(new_n56_), .c(new_n37_), .d(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n27_), .c(x03), .O(z05));
  ...
  nand4  g43(.a(new_n68_), .b(new_n60_), .c(x05), .d(new_n28_), .O(new_n69_));
  nand3  g44(.a(new_n61_), .b(new_n32_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  nand4  g48(.a(new_n57_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n74_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  nand2  g54(.a(x13), .b(x06), .O(new_n80_));
  oai21  g55(.a(new_n27_), .b(x03), .c(new_n80_), .O(z09));
  nand2  g56(.a(new_n30_), .b(x06), .O(new_n82_));
  aoi21  g57(.a(new_n82_), .b(new_n27_), .c(x03), .O(z10));
endmodule
