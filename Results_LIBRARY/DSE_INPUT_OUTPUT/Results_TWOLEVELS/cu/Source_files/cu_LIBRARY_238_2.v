...
module FAU ( 
  ...
  nand4  g25(.a(new_n47_), .b(x08), .c(x05), .d(new_n29_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n34_), .c(new_n35_), .d(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x08), .c(new_n45_), .O(z04));
  nand4  g29(.a(new_n52_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x08), .c(new_n45_), .O(z05));
  ...
  nand3  g36(.a(new_n61_), .b(x08), .c(x01), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(x00), .O(new_n64_));
  nand2  g39(.a(new_n26_), .b(new_n45_), .O(new_n65_));
  inv1   g40(.a(x10), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x08), .c(x01), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n65_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n50_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n64_), .c(new_n47_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n27_), .b(new_n47_), .c(new_n37_), .d(x02), .O(new_n72_));
  ...
  aoi21  g50(.a(new_n26_), .b(x01), .c(x13), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x02), .O(z07));
  nand4  g53(.a(x13), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n79_));
