...
module FAU ( 
  ...
  nand3  g19(.a(new_n36_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n28_), .O(z02));
  nand4  g23(.a(new_n28_), .b(new_n46_), .c(x05), .d(new_n30_), .O(new_n49_));
  nor3   g24(.a(new_n49_), .b(x03), .c(x02), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(new_n44_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(new_n43_), .O(z03));
  nand2  g27(.a(new_n50_), .b(x01), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x00), .O(z04));
  nor2   g29(.a(new_n53_), .b(new_n43_), .O(z05));
  ...
  nand4  g40(.a(new_n28_), .b(new_n46_), .c(new_n38_), .d(x02), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n44_), .b(new_n43_), .c(new_n28_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n28_), .O(z07));
  nand4  g48(.a(x13), .b(new_n57_), .c(x05), .d(new_n36_), .O(new_n74_));
  nand3  g49(.a(new_n46_), .b(new_n38_), .c(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n28_), .c(x04), .d(new_n35_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  nor2   g53(.a(new_n46_), .b(new_n26_), .O(z09));
