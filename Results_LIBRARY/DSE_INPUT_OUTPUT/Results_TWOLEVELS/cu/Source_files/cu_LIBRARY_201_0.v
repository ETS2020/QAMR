...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n45_));
  ...
  nand3  g39(.a(new_n49_), .b(new_n36_), .c(x02), .O(new_n65_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n33_), .c(x04), .d(new_n32_), .O(new_n72_));
  ...
  nand4  g51(.a(new_n76_), .b(new_n33_), .c(x06), .d(new_n32_), .O(new_n77_));
