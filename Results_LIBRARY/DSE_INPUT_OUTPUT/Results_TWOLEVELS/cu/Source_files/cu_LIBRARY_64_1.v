...
module FAU ( 
  ...
  nand4  g11(.a(new_n36_), .b(x05), .c(new_n29_), .d(new_n33_), .O(new_n37_));
  ...
  nand3  g19(.a(new_n33_), .b(new_n44_), .c(x00), .O(new_n45_));
  nand4  g20(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n40_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n36_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand3  g23(.a(new_n33_), .b(x01), .c(new_n48_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n46_), .c(new_n36_), .O(z04));
  nand3  g25(.a(new_n33_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n46_), .c(new_n36_), .O(z05));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x12), .O(new_n54_));
  inv1   g29(.a(x10), .O(new_n55_));
  nor2   g30(.a(x08), .b(x01), .O(new_n56_));
  aoi21  g31(.a(new_n55_), .b(x01), .c(new_n56_), .O(new_n57_));
  inv1   g32(.a(x09), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(new_n44_), .c(x00), .O(new_n59_));
  oai21  g34(.a(new_n57_), .b(x00), .c(new_n59_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(x13), .c(new_n54_), .d(x11), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n53_), .c(x05), .d(new_n33_), .O(new_n63_));
  nand3  g38(.a(new_n26_), .b(new_n30_), .c(x02), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n40_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z06));
  nand4  g42(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n40_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(x02), .c(new_n36_), .O(z07));
  nand4  g44(.a(x13), .b(new_n54_), .c(x05), .d(new_n33_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n64_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n40_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n36_), .O(z08));
  inv1   g48(.a(x06), .O(new_n74_));
  aoi21  g49(.a(x11), .b(new_n74_), .c(new_n26_), .O(z09));
  nand3  g50(.a(new_n32_), .b(x06), .c(new_n40_), .O(new_n76_));
