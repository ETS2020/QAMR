...
module FAU ( 
  ...
  nor2   g17(.a(x13), .b(new_n37_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n42_), .c(new_n28_), .d(new_n26_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(x01), .O(z02));
  nand3  g20(.a(new_n35_), .b(x01), .c(new_n26_), .O(new_n47_));
  nand3  g21(.a(new_n43_), .b(new_n28_), .c(new_n34_), .O(new_n48_));
  oai21  g22(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z04));
  nand4  g23(.a(new_n43_), .b(new_n42_), .c(new_n28_), .d(x01), .O(new_n50_));
  ...
  aoi21  g38(.a(new_n64_), .b(new_n62_), .c(new_n59_), .O(new_n65_));
  nand4  g39(.a(new_n65_), .b(new_n55_), .c(new_n53_), .d(x05), .O(new_n66_));
  nand3  g40(.a(new_n59_), .b(new_n37_), .c(x02), .O(new_n67_));
  oai21  g41(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n34_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n58_), .O(z06));
  aoi21  g44(.a(new_n60_), .b(x00), .c(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n72_));
  nor2   g46(.a(new_n72_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n55_), .c(x05), .d(new_n35_), .O(new_n74_));
  ...
  nor3   g52(.a(new_n27_), .b(new_n59_), .c(new_n78_), .O(z09));
