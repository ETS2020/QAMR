...
module FAU ( 
  ...
  nor3   g27(.a(x02), .b(new_n45_), .c(new_n44_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n54_));
  ...
  oai21  g36(.a(new_n61_), .b(new_n60_), .c(new_n44_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n27_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n26_), .c(new_n56_), .d(x05), .O(new_n64_));
  nand3  g39(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n65_));
  oai21  g40(.a(new_n64_), .b(x02), .c(new_n65_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n38_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nand4  g43(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand3  g45(.a(x13), .b(x05), .c(new_n34_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n65_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n38_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n37_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  aoi21  g50(.a(new_n26_), .b(new_n75_), .c(new_n27_), .O(z09));
  nand4  g51(.a(new_n33_), .b(new_n37_), .c(x06), .d(new_n38_), .O(new_n77_));
