...
module FAU ( 
  ...
  nand4  g22(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n38_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n35_), .c(x05), .d(new_n30_), .O(new_n50_));
  ...
  aoi21  g30(.a(new_n55_), .b(new_n35_), .c(new_n31_), .O(z05));
  ...
  nand4  g44(.a(new_n69_), .b(new_n57_), .c(new_n35_), .d(x05), .O(new_n70_));
  ...
  nand4  g50(.a(new_n54_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  inv1   g52(.a(x12), .O(new_n78_));
  nand4  g53(.a(x13), .b(new_n78_), .c(x05), .d(new_n28_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n26_), .O(new_n81_));
  oai21  g56(.a(new_n35_), .b(new_n31_), .c(new_n81_), .O(z08));
  aoi21  g57(.a(new_n71_), .b(new_n31_), .c(new_n35_), .O(z09));
  nand3  g58(.a(x06), .b(new_n31_), .c(new_n26_), .O(new_n84_));
