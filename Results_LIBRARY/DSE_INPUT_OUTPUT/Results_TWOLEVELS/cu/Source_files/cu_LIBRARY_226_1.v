...
module FAU ( 
  ...
  nand3  g24(.a(new_n46_), .b(x05), .c(new_n28_), .O(new_n51_));
  inv1   g25(.a(new_n51_), .O(new_n52_));
  nand2  g26(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  aoi21  g27(.a(new_n53_), .b(x00), .c(new_n26_), .O(z05));
  ...
  oai21  g34(.a(new_n60_), .b(new_n56_), .c(new_n26_), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(new_n55_), .O(new_n62_));
  inv1   g36(.a(x09), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(new_n26_), .c(x00), .O(new_n64_));
  ...
  nand3  g42(.a(new_n46_), .b(new_n37_), .c(x02), .O(new_n69_));
  ...
  aoi21  g46(.a(new_n52_), .b(new_n50_), .c(x01), .O(new_n73_));
  aoi21  g47(.a(new_n26_), .b(new_n55_), .c(x13), .O(new_n74_));
  nand4  g48(.a(new_n74_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n75_));
  oai22  g49(.a(new_n75_), .b(x02), .c(new_n73_), .d(x00), .O(z07));
  nand4  g50(.a(x13), .b(new_n59_), .c(x05), .d(new_n35_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n69_), .O(new_n78_));
  ...
  nand4  g57(.a(new_n83_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n84_));
