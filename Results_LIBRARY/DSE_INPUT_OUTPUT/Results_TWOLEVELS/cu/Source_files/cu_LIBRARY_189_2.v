...
module FAU ( 
  ...
  nand3  g46(.a(new_n44_), .b(new_n26_), .c(x02), .O(new_n72_));
  ...
  oai21  g51(.a(new_n76_), .b(x02), .c(new_n27_), .O(z07));
  nand2  g52(.a(x05), .b(new_n35_), .O(new_n78_));
  nand2  g53(.a(x13), .b(new_n57_), .O(new_n79_));
  oai21  g54(.a(new_n79_), .b(new_n78_), .c(new_n72_), .O(new_n80_));
  ...
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n34_), .O(new_n86_));
