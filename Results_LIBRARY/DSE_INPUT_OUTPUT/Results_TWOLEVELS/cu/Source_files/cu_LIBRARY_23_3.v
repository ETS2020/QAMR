...
module FAU ( 
  ...
  aoi21  g24(.a(new_n49_), .b(new_n46_), .c(x01), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(new_n26_), .O(z03));
  aoi21  g26(.a(new_n49_), .b(new_n46_), .c(x00), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(new_n27_), .O(z04));
  nand3  g28(.a(new_n46_), .b(x05), .c(x04), .O(new_n55_));
  ...
  oai21  g33(.a(new_n59_), .b(new_n55_), .c(new_n27_), .O(new_n60_));
  nand2  g34(.a(new_n60_), .b(x00), .O(new_n61_));
  inv1   g35(.a(x08), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(new_n27_), .c(new_n26_), .O(new_n63_));
  ...
  nand3  g41(.a(new_n47_), .b(new_n38_), .c(x02), .O(new_n68_));
  ...
  aoi21  g45(.a(x01), .b(x00), .c(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n36_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand3  g50(.a(new_n76_), .b(x04), .c(new_n34_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n35_), .O(z08));
  nand3  g52(.a(new_n35_), .b(x13), .c(x06), .O(new_n79_));
  inv1   g53(.a(new_n79_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n82_));
