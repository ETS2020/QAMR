...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n78_;
  nand2  g00(.a(x09), .b(x06), .O(new_n26_));
  ...
  nand4  g38(.a(new_n26_), .b(new_n41_), .c(new_n36_), .d(x02), .O(new_n64_));
  ...
  nand3  g44(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n26_), .c(x04), .d(new_n33_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  inv1   g48(.a(x09), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n74_), .c(x06), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  inv1   g51(.a(x06), .O(new_n77_));
  oai21  g52(.a(new_n36_), .b(new_n34_), .c(new_n33_), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(new_n74_), .c(new_n77_), .O(z10));
endmodule
