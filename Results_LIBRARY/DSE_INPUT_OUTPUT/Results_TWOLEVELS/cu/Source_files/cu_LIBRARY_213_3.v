...
module FAU ( 
  ...
  nand3  g21(.a(new_n34_), .b(new_n26_), .c(x00), .O(new_n47_));
  inv1   g22(.a(x13), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n47_), .c(new_n37_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n48_), .b(x05), .c(new_n30_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n38_), .c(new_n34_), .d(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n38_), .c(new_n34_), .d(x00), .O(new_n56_));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n48_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(x05), .d(new_n34_), .O(new_n66_));
  nand3  g41(.a(new_n48_), .b(new_n31_), .c(x02), .O(new_n67_));
  ...
  nand3  g45(.a(new_n53_), .b(new_n38_), .c(new_n34_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n37_), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n34_), .O(new_n73_));
  ...
  nand2  g52(.a(new_n77_), .b(new_n37_), .O(z09));
