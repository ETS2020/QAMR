...
module FAU ( 
  ...
  nor2   g13(.a(new_n31_), .b(new_n38_), .O(z04));
  inv1   g14(.a(z04), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n37_), .O(z01));
  nor2   g16(.a(x01), .b(x00), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n30_), .c(new_n26_), .d(new_n28_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x13), .c(new_n31_), .O(z02));
  nor2   g19(.a(x13), .b(x04), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n26_), .c(new_n28_), .d(x00), .O(new_n46_));
  ...
  nand3  g32(.a(new_n50_), .b(new_n31_), .c(x02), .O(new_n58_));
  ...
  aoi21  g36(.a(x01), .b(new_n51_), .c(x13), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n30_), .c(new_n26_), .d(new_n28_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n38_), .c(new_n31_), .O(z07));
  nand4  g39(.a(x13), .b(new_n49_), .c(x05), .d(new_n28_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n58_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n40_), .O(z08));
  nand3  g43(.a(new_n40_), .b(x13), .c(x06), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x06), .c(new_n26_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n40_), .O(z10));
  nor2   g48(.a(new_n31_), .b(new_n38_), .O(z05));
endmodule
