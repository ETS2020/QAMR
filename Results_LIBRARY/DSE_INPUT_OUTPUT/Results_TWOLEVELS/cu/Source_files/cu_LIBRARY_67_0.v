...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(x08), .c(x05), .d(new_n28_), .O(new_n50_));
  ...
  nand3  g37(.a(new_n62_), .b(x08), .c(new_n43_), .O(new_n63_));
  ...
  nand3  g43(.a(new_n68_), .b(x01), .c(new_n42_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n67_), .c(new_n52_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n35_), .b(new_n52_), .c(new_n29_), .d(x02), .O(new_n72_));
  ...
  inv1   g50(.a(x08), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(new_n43_), .c(x13), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g54(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n80_));
  nand3  g55(.a(new_n52_), .b(new_n29_), .c(x02), .O(new_n81_));
  ...
  nand2  g60(.a(new_n85_), .b(new_n35_), .O(z09));
  nand4  g61(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n87_));
