...
module FAU ( 
  ...
  nand4  g29(.a(new_n33_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nor2   g32(.a(x08), .b(x01), .O(new_n58_));
  nor2   g33(.a(x10), .b(new_n32_), .O(new_n59_));
  ...
  oai21  g42(.a(new_n44_), .b(new_n42_), .c(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x00), .O(new_n69_));
  nand2  g44(.a(x01), .b(x00), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n35_), .c(new_n30_), .O(new_n73_));
