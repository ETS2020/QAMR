...
module FAU ( 
  ...
  nand4  g10(.a(x06), .b(x05), .c(new_n31_), .d(new_n29_), .O(new_n36_));
  ...
  nand4  g16(.a(new_n41_), .b(x06), .c(x05), .d(new_n31_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x13), .O(z02));
  nand4  g18(.a(new_n26_), .b(new_n29_), .c(new_n39_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x06), .c(x05), .d(new_n31_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z03));
  nand4  g22(.a(new_n26_), .b(new_n29_), .c(x01), .d(new_n38_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x06), .c(x05), .d(new_n31_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z04));
  nor2   g26(.a(x02), .b(new_n39_), .O(new_n52_));
  nor2   g27(.a(x04), .b(x03), .O(new_n53_));
  nor2   g28(.a(x13), .b(new_n27_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x06), .c(new_n32_), .O(z05));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n38_), .O(new_n62_));
  inv1   g37(.a(x08), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n39_), .O(new_n64_));
  inv1   g39(.a(x10), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x01), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n64_), .c(x00), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n62_), .c(x13), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x12), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n57_), .c(x06), .d(x05), .O(new_n70_));
  inv1   g45(.a(x13), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n32_), .c(x02), .O(new_n72_));
  ...
  nand3  g50(.a(new_n54_), .b(x05), .c(new_n31_), .O(new_n76_));
  nor3   g51(.a(new_n76_), .b(x03), .c(x02), .O(z07));
  inv1   g52(.a(x12), .O(new_n78_));
  nand4  g53(.a(x13), .b(new_n78_), .c(x05), .d(new_n29_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n26_), .O(new_n81_));
  nand2  g56(.a(new_n27_), .b(x05), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n81_), .O(z08));
  oai21  g58(.a(new_n71_), .b(new_n27_), .c(new_n82_), .O(z09));
