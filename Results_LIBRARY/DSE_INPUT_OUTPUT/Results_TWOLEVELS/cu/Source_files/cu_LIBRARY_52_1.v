...
module FAU ( 
  ...
  oai21  g02(.a(x07), .b(x04), .c(new_n27_), .O(new_n28_));
  ...
  nor2   g14(.a(x13), .b(x07), .O(new_n40_));
  nand3  g15(.a(new_n40_), .b(x05), .c(new_n30_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n26_), .c(new_n39_), .d(new_n38_), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(new_n35_), .c(x02), .O(z02));
  nand4  g19(.a(new_n26_), .b(new_n27_), .c(new_n39_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n35_), .c(x05), .d(new_n30_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x13), .O(z03));
  nand4  g23(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n38_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n35_), .c(x05), .d(new_n30_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z04));
  nand4  g27(.a(new_n42_), .b(new_n26_), .c(x01), .d(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n35_), .c(x02), .O(z05));
  ...
  nand4  g38(.a(new_n63_), .b(new_n55_), .c(new_n35_), .d(x05), .O(new_n64_));
  ...
  nand4  g44(.a(new_n40_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand2  g46(.a(x04), .b(new_n26_), .O(new_n72_));
  nand3  g47(.a(x13), .b(new_n55_), .c(x05), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n35_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n27_), .O(new_n75_));
  nand4  g50(.a(new_n65_), .b(x04), .c(new_n26_), .d(x02), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n75_), .O(z08));
  inv1   g52(.a(x06), .O(new_n78_));
  oai21  g53(.a(new_n35_), .b(x02), .c(x13), .O(new_n79_));
