...
module FAU ( 
  ...
  nand4  g22(.a(new_n36_), .b(new_n32_), .c(new_n43_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x07), .c(x05), .d(new_n28_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  inv1   g26(.a(x13), .O(new_n52_));
  nand4  g27(.a(new_n36_), .b(new_n32_), .c(x01), .d(new_n42_), .O(new_n53_));
  ...
  nand4  g34(.a(new_n35_), .b(new_n52_), .c(new_n29_), .d(x02), .O(new_n60_));
  ...
  nand4  g42(.a(new_n67_), .b(x13), .c(new_n62_), .d(new_n61_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n32_), .d(x01), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n60_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n36_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z06));
  aoi21  g48(.a(new_n61_), .b(new_n43_), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n62_), .c(x05), .d(new_n32_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n60_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n36_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n35_), .O(z08));
  inv1   g55(.a(x06), .O(new_n81_));
  nor3   g56(.a(new_n26_), .b(new_n52_), .c(new_n81_), .O(z09));
  nand3  g57(.a(new_n31_), .b(x06), .c(new_n36_), .O(new_n83_));
