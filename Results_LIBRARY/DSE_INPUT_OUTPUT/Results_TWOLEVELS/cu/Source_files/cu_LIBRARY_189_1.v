...
module FAU ( 
  ...
  nand4  g38(.a(new_n42_), .b(new_n31_), .c(new_n36_), .d(new_n30_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(x01), .c(new_n26_), .O(z07));
  nand4  g40(.a(x13), .b(new_n53_), .c(x05), .d(new_n30_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n60_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n36_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n28_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n28_), .O(z09));
  oai21  g46(.a(x02), .b(new_n48_), .c(x05), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x06), .c(new_n36_), .O(new_n73_));
