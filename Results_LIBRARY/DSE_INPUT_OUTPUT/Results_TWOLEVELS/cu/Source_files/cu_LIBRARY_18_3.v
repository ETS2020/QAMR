...
module FAU ( 
  ...
  oai21  g01(.a(x13), .b(x05), .c(x02), .O(new_n27_));
  ...
  nand4  g17(.a(new_n26_), .b(new_n28_), .c(new_n42_), .d(x00), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  inv1   g21(.a(x00), .O(new_n47_));
  nand3  g22(.a(new_n28_), .b(x01), .c(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n41_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n49_));
  oai22  g24(.a(new_n49_), .b(new_n48_), .c(new_n41_), .d(new_n28_), .O(z04));
  ...
  nand2  g38(.a(new_n35_), .b(x02), .O(new_n64_));
  ...
  nand4  g42(.a(new_n41_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n55_), .c(x05), .d(new_n28_), .O(new_n70_));
  ...
  aoi21  g49(.a(new_n74_), .b(new_n28_), .c(new_n41_), .O(z09));
  nand3  g50(.a(new_n27_), .b(x06), .c(new_n26_), .O(new_n76_));
