...
module FAU ( 
  ...
  nor2   g16(.a(x13), .b(new_n27_), .O(new_n43_));
  nand4  g17(.a(new_n43_), .b(new_n42_), .c(new_n26_), .d(x00), .O(new_n44_));
  aoi21  g18(.a(new_n44_), .b(x00), .c(x01), .O(z03));
  inv1   g19(.a(x13), .O(new_n46_));
  inv1   g20(.a(x00), .O(new_n47_));
  nand4  g21(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n26_), .O(new_n50_));
  inv1   g24(.a(new_n50_), .O(z04));
  inv1   g25(.a(x01), .O(new_n52_));
  nor3   g26(.a(x02), .b(new_n52_), .c(new_n47_), .O(new_n53_));
  nand4  g27(.a(new_n53_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n54_));
  nor2   g28(.a(new_n54_), .b(x13), .O(z05));
  nand4  g29(.a(new_n33_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n56_));
  inv1   g30(.a(x07), .O(new_n57_));
  inv1   g31(.a(x12), .O(new_n58_));
  nor2   g32(.a(x09), .b(x01), .O(new_n59_));
  nor2   g33(.a(x11), .b(new_n52_), .O(new_n60_));
  oai21  g34(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  inv1   g35(.a(x10), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x01), .c(new_n47_), .O(new_n63_));
  ...
  aoi21  g42(.a(new_n52_), .b(new_n47_), .c(x13), .O(new_n69_));
  nand4  g43(.a(new_n69_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n70_));
  nor2   g44(.a(new_n70_), .b(x02), .O(z07));
  nand4  g45(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n72_));
  nand3  g46(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n73_));
  ...
  nor3   g51(.a(new_n32_), .b(new_n46_), .c(new_n77_), .O(z09));
