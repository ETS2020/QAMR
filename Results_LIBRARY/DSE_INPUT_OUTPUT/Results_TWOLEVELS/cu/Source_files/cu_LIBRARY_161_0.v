...
module FAU ( 
  ...
  nand4  g10(.a(x11), .b(new_n28_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand2  g21(.a(new_n29_), .b(new_n28_), .O(new_n47_));
  ...
  nand3  g26(.a(new_n31_), .b(x01), .c(x00), .O(new_n52_));
  ...
  nand4  g38(.a(new_n41_), .b(x11), .c(new_n28_), .d(x02), .O(new_n64_));
  ...
  nand2  g44(.a(x05), .b(new_n31_), .O(new_n70_));
  ...
  oai21  g51(.a(new_n29_), .b(x05), .c(new_n70_), .O(new_n77_));
