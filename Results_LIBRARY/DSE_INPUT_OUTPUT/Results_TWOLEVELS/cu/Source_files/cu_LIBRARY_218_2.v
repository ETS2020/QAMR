// Benchmark "FAU" written by ABC on Wed Aug 19 17:19:27 2020
...
module FAU ( 
  ...
  nand3  g19(.a(new_n35_), .b(new_n29_), .c(x00), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n27_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n46_), .b(x05), .c(new_n36_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n34_), .c(new_n35_), .d(new_n49_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x05), .c(new_n29_), .O(z04));
  nand4  g28(.a(new_n51_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x05), .c(new_n29_), .O(z05));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nor2   g32(.a(x09), .b(x01), .O(new_n58_));
  nor2   g33(.a(x11), .b(new_n29_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(x00), .O(new_n60_));
  nor2   g35(.a(x08), .b(x01), .O(new_n61_));
  nor2   g36(.a(x10), .b(new_n29_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n49_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n46_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n65_));
  nand4  g40(.a(new_n46_), .b(new_n26_), .c(x02), .d(new_n29_), .O(new_n66_));
  ...
  nor3   g44(.a(new_n50_), .b(x03), .c(x02), .O(z07));
  nand2  g45(.a(x05), .b(new_n35_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n57_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n66_), .O(new_n73_));
  ...
  oai21  g52(.a(x05), .b(x01), .c(new_n71_), .O(new_n78_));
