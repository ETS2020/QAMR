...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x08), .c(x05), .d(new_n27_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nor2   g21(.a(x03), .b(x02), .O(new_n47_));
  nor2   g22(.a(x13), .b(new_n36_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n47_), .c(new_n27_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x08), .c(x01), .O(z03));
  ...
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n57_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n51_), .O(new_n66_));
  ...
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n32_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n33_), .O(z06));
  nor2   g46(.a(x08), .b(x01), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n41_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n33_), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n68_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n32_), .O(new_n78_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n33_), .c(x06), .d(new_n32_), .O(new_n83_));
