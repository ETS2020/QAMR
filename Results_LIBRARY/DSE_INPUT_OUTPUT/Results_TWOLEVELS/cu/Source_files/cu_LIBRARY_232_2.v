...
module FAU ( 
  ...
  nand4  g22(.a(new_n27_), .b(new_n45_), .c(x05), .d(new_n31_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n36_), .c(new_n29_), .O(new_n50_));
  nor3   g25(.a(new_n50_), .b(x01), .c(new_n42_), .O(z03));
  nor3   g26(.a(new_n50_), .b(new_n43_), .c(x00), .O(z04));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n45_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n63_));
  nand3  g38(.a(new_n45_), .b(new_n32_), .c(x02), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n63_), .c(x07), .O(new_n65_));
  nand4  g40(.a(new_n45_), .b(x08), .c(new_n32_), .d(x02), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n65_), .c(x04), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x03), .O(z06));
  inv1   g44(.a(new_n50_), .O(z07));
  nand4  g45(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n64_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  nor3   g50(.a(new_n28_), .b(new_n45_), .c(new_n75_), .O(z09));
  inv1   g51(.a(new_n33_), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n78_));
