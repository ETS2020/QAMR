...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n50_, new_n52_, new_n53_, new_n55_, new_n57_, new_n59_, new_n61_,
    new_n63_, new_n64_;
  ...
  nand4  g20(.a(new_n45_), .b(new_n28_), .c(new_n44_), .d(new_n43_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n42_), .c(new_n31_), .O(z02));
  nand4  g22(.a(new_n26_), .b(new_n28_), .c(new_n44_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n42_), .c(x05), .d(new_n30_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nor2   g26(.a(x02), .b(new_n44_), .O(new_n52_));
  nand3  g27(.a(new_n52_), .b(new_n45_), .c(new_n43_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n42_), .c(new_n31_), .O(z04));
  nand3  g29(.a(new_n52_), .b(new_n45_), .c(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n42_), .c(new_n31_), .O(z05));
  nand4  g31(.a(new_n31_), .b(x04), .c(new_n26_), .d(x02), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z06));
  nand4  g33(.a(new_n42_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x02), .O(z07));
  inv1   g35(.a(x06), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n31_), .c(new_n42_), .O(z09));
  nand2  g37(.a(x05), .b(x02), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x06), .c(new_n26_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n40_), .O(z10));
