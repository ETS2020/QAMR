...
module FAU ( 
  ...
  nand4  g20(.a(new_n42_), .b(new_n32_), .c(new_n40_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand3  g24(.a(new_n32_), .b(x01), .c(new_n39_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n44_), .c(new_n35_), .O(z04));
  nand2  g26(.a(x01), .b(x00), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x02), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n28_), .d(new_n42_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z05));
  nand2  g30(.a(new_n42_), .b(x02), .O(new_n56_));
  nand3  g31(.a(new_n43_), .b(new_n29_), .c(x04), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n35_), .O(z06));
  nand4  g33(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n42_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(x02), .c(new_n35_), .O(z07));
  inv1   g35(.a(x06), .O(new_n61_));
  aoi21  g36(.a(x12), .b(new_n61_), .c(new_n43_), .O(z09));
  nand3  g37(.a(new_n31_), .b(x06), .c(new_n42_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n35_), .O(z10));
  oai21  g39(.a(new_n57_), .b(new_n56_), .c(new_n35_), .O(z08));
endmodule
