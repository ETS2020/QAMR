...
module FAU ( 
  ...
  oai21  g08(.a(new_n33_), .b(new_n32_), .c(x10), .O(new_n34_));
  ...
  oai21  g32(.a(new_n57_), .b(new_n47_), .c(new_n27_), .O(z05));
  ...
  nand4  g43(.a(new_n46_), .b(x10), .c(new_n30_), .d(x02), .O(new_n69_));
  ...
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n27_), .O(z07));
