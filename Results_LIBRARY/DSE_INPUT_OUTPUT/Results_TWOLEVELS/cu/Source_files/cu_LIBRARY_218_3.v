...
module FAU ( 
  ...
  nor3   g20(.a(x13), .b(x04), .c(x03), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n31_), .c(new_n26_), .d(x00), .O(new_n47_));
  ...
  nand4  g33(.a(new_n58_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n59_));
  inv1   g34(.a(x13), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n27_), .c(x02), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x04), .c(new_n37_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z06));
  nand4  g39(.a(new_n60_), .b(x05), .c(new_n32_), .d(new_n37_), .O(new_n65_));
  nor3   g40(.a(new_n65_), .b(x02), .c(x01), .O(z07));
  nand4  g41(.a(x13), .b(new_n50_), .c(x05), .d(new_n31_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n61_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n37_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n29_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n29_), .O(z09));
  oai21  g47(.a(x02), .b(x01), .c(x05), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x06), .c(new_n37_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z10));
  nor2   g50(.a(new_n27_), .b(new_n26_), .O(z05));
endmodule
