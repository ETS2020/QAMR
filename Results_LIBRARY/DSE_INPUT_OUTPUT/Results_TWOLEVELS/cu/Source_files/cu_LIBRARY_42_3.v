...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n41_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n50_,
  ...
  nand3  g18(.a(new_n36_), .b(new_n26_), .c(new_n43_), .O(new_n44_));
  nor2   g19(.a(x13), .b(new_n38_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n29_), .c(new_n34_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n35_), .O(z02));
  nand3  g22(.a(new_n36_), .b(new_n26_), .c(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n35_), .O(z03));
  nor3   g24(.a(x03), .b(x02), .c(x00), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n45_), .c(new_n29_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g27(.a(new_n34_), .b(new_n36_), .c(x01), .d(x00), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  inv1   g33(.a(x13), .O(new_n59_));
  inv1   g34(.a(x08), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(x01), .c(new_n43_), .O(new_n61_));
  inv1   g36(.a(x11), .O(new_n62_));
  nor2   g37(.a(x09), .b(x01), .O(new_n63_));
  aoi22  g38(.a(new_n63_), .b(x00), .c(new_n62_), .d(x01), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n59_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n66_));
  nand3  g41(.a(new_n59_), .b(new_n38_), .c(x02), .O(new_n67_));
  ...
  nand3  g45(.a(x10), .b(x01), .c(x00), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n34_), .c(new_n36_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n35_), .O(z07));
  nand4  g50(.a(x13), .b(new_n58_), .c(x05), .d(new_n36_), .O(new_n76_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n83_));
