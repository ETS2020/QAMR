...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n36_), .c(new_n42_), .d(x10), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x10), .c(x01), .O(z02));
  ...
  nand4  g27(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n32_), .O(z04));
  ...
  oai21  g36(.a(x08), .b(x01), .c(x10), .O(new_n62_));
  ...
  nand3  g40(.a(new_n42_), .b(new_n35_), .c(x02), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n70_), .b(new_n46_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n72_));
