...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n45_));
  ...
  oai21  g24(.a(new_n49_), .b(new_n45_), .c(new_n32_), .O(z04));
  nor2   g25(.a(new_n26_), .b(x13), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n52_));
  ...
  nand3  g39(.a(new_n51_), .b(new_n36_), .c(x02), .O(new_n65_));
  ...
  nand4  g43(.a(x13), .b(new_n57_), .c(x05), .d(new_n34_), .O(new_n69_));
  nand3  g44(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n32_), .c(x04), .d(new_n33_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  inv1   g48(.a(x06), .O(new_n74_));
  nor3   g49(.a(new_n26_), .b(new_n44_), .c(new_n74_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n32_), .c(x06), .d(new_n33_), .O(new_n77_));
