...
module FAU ( 
  ...
  nand4  g31(.a(new_n42_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n35_), .O(z05));
  nand4  g33(.a(new_n35_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n59_));
  ...
  nand3  g51(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n26_), .b(new_n42_), .c(new_n81_), .O(z09));
