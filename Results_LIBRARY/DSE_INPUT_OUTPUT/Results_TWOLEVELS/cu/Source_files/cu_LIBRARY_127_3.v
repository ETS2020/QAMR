...
module FAU ( 
  ...
  nand2  g28(.a(new_n39_), .b(x02), .O(new_n54_));
  nand3  g29(.a(new_n28_), .b(new_n33_), .c(x04), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n26_), .O(z06));
  nand4  g31(.a(new_n28_), .b(new_n30_), .c(new_n39_), .d(new_n29_), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n28_), .c(new_n33_), .O(z07));
  nand4  g33(.a(new_n33_), .b(x04), .c(new_n39_), .d(x02), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x13), .O(z08));
