...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n37_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n37_), .b(new_n36_), .c(new_n26_), .d(x00), .O(new_n47_));
  ...
  nand4  g34(.a(new_n60_), .b(x13), .c(new_n54_), .d(new_n53_), .O(new_n61_));
  inv1   g35(.a(new_n61_), .O(new_n62_));
  nand4  g36(.a(new_n62_), .b(x05), .c(new_n36_), .d(new_n26_), .O(new_n63_));
  nor2   g37(.a(x13), .b(x05), .O(new_n64_));
  nand2  g38(.a(new_n64_), .b(x02), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand3  g40(.a(new_n66_), .b(x04), .c(new_n37_), .O(new_n67_));
  inv1   g41(.a(new_n67_), .O(z06));
  nand4  g42(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n37_), .O(new_n69_));
  aoi21  g43(.a(new_n69_), .b(new_n26_), .c(x02), .O(z07));
  nand2  g44(.a(x04), .b(new_n37_), .O(new_n71_));
  nand3  g45(.a(x13), .b(new_n54_), .c(x05), .O(new_n72_));
  oai21  g46(.a(new_n72_), .b(new_n71_), .c(new_n26_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand2  g48(.a(new_n64_), .b(x04), .O(new_n75_));
  oai21  g49(.a(new_n75_), .b(new_n41_), .c(new_n74_), .O(z08));
  inv1   g50(.a(x06), .O(new_n77_));
  nor3   g51(.a(z04), .b(new_n46_), .c(new_n77_), .O(z09));
  nand2  g52(.a(new_n36_), .b(new_n26_), .O(new_n79_));
  oai21  g53(.a(x05), .b(new_n36_), .c(new_n79_), .O(new_n80_));
  nand3  g54(.a(new_n80_), .b(x06), .c(new_n37_), .O(new_n81_));
