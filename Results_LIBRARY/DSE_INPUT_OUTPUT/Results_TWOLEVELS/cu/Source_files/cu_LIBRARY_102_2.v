...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n26_), .c(x01), .d(new_n41_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n42_), .c(x05), .d(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nor3   g25(.a(x02), .b(new_n32_), .c(new_n41_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z05));
  nand4  g28(.a(x05), .b(x04), .c(new_n35_), .d(new_n26_), .O(new_n54_));
  ...
  nand3  g35(.a(x05), .b(new_n26_), .c(x01), .O(new_n61_));
  inv1   g36(.a(x10), .O(new_n62_));
  nand4  g37(.a(x13), .b(new_n57_), .c(new_n62_), .d(new_n55_), .O(new_n63_));
  nand3  g38(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(new_n61_), .c(new_n64_), .O(new_n65_));
  ...
  nand4  g46(.a(x13), .b(new_n57_), .c(new_n71_), .d(new_n55_), .O(new_n72_));
  ...
  nand2  g51(.a(new_n76_), .b(new_n60_), .O(z06));
  ...
  nor3   g61(.a(z03), .b(new_n42_), .c(new_n86_), .O(z09));
