...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x06), .c(x05), .d(new_n26_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  nand4  g20(.a(new_n41_), .b(new_n30_), .c(new_n40_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x06), .c(x05), .d(new_n26_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x13), .O(z03));
  nor2   g24(.a(x02), .b(new_n40_), .O(new_n50_));
  inv1   g25(.a(x13), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(x05), .c(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n50_), .c(new_n39_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x06), .c(x04), .O(z04));
  nand3  g30(.a(new_n53_), .b(new_n50_), .c(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x06), .c(x04), .O(z05));
  ...
  aoi21  g46(.a(new_n27_), .b(new_n40_), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n41_), .d(new_n30_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(x06), .c(x04), .O(z07));
  ...
  nor2   g53(.a(new_n51_), .b(new_n27_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x06), .c(new_n41_), .O(new_n81_));
