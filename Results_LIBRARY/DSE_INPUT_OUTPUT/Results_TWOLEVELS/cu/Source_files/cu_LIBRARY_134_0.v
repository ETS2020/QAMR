...
module FAU ( 
  ...
  oai21  g02(.a(x04), .b(x03), .c(x06), .O(new_n28_));
  ...
  nand4  g10(.a(x06), .b(new_n27_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand4  g19(.a(new_n44_), .b(new_n41_), .c(x05), .d(new_n34_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  inv1   g21(.a(x00), .O(new_n47_));
  nand4  g22(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n41_), .c(x05), .d(new_n34_), .O(new_n50_));
  ...
  nand4  g29(.a(new_n41_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n53_), .O(z05));
  ...
  nand4  g45(.a(new_n41_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n71_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n53_), .O(z08));
  oai21  g51(.a(new_n41_), .b(new_n52_), .c(new_n53_), .O(z09));
  aoi21  g52(.a(x04), .b(new_n30_), .c(x05), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(new_n30_), .c(x06), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(x03), .O(z10));
endmodule
