...
module FAU ( 
  ...
  nand4  g25(.a(new_n41_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n35_), .O(z05));
  nand4  g27(.a(new_n35_), .b(new_n41_), .c(new_n30_), .d(x02), .O(new_n53_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n35_), .O(z09));
