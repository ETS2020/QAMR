...
module FAU ( 
  ...
  nand4  g25(.a(new_n35_), .b(new_n28_), .c(x01), .d(new_n50_), .O(new_n51_));
  ...
  nor2   g42(.a(x03), .b(x02), .O(new_n69_));
  nand3  g43(.a(new_n44_), .b(x05), .c(new_n30_), .O(new_n70_));
  inv1   g44(.a(new_n70_), .O(new_n71_));
  aoi21  g45(.a(new_n71_), .b(new_n69_), .c(x01), .O(new_n72_));
  nand4  g46(.a(new_n71_), .b(new_n35_), .c(new_n28_), .d(new_n50_), .O(new_n73_));
  oai21  g47(.a(new_n72_), .b(new_n50_), .c(new_n73_), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n56_), .O(new_n76_));
  nand3  g50(.a(new_n76_), .b(x04), .c(new_n35_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n26_), .O(z08));
