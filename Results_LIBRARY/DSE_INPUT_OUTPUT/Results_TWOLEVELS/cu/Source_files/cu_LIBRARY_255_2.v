...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n26_), .c(new_n43_), .O(new_n44_));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n36_), .O(z02));
  nand4  g22(.a(new_n37_), .b(new_n33_), .c(new_n26_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n45_), .c(x05), .d(new_n29_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n45_), .b(x12), .c(x05), .d(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n37_), .c(new_n33_), .d(new_n43_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x12), .c(new_n26_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n37_), .c(new_n33_), .d(x00), .O(new_n56_));
  ...
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n71_));
  ...
  nor3   g52(.a(new_n27_), .b(new_n45_), .c(new_n77_), .O(z09));
  nand4  g53(.a(new_n32_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n79_));
