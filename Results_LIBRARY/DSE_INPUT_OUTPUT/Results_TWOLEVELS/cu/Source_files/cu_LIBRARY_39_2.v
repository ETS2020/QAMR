...
module FAU ( 
  ...
  nand3  g11(.a(new_n36_), .b(x05), .c(new_n27_), .O(new_n37_));
  inv1   g12(.a(new_n37_), .O(new_n38_));
  nand4  g13(.a(new_n38_), .b(new_n26_), .c(new_n35_), .d(x00), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n26_), .c(x03), .O(z03));
  inv1   g15(.a(x00), .O(new_n41_));
  nand4  g16(.a(new_n31_), .b(new_n26_), .c(x01), .d(new_n41_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n36_), .c(x05), .d(new_n27_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z04));
  nor3   g20(.a(x02), .b(new_n35_), .c(new_n41_), .O(new_n46_));
  ...
  nor3   g38(.a(new_n37_), .b(x03), .c(x02), .O(z07));
  inv1   g39(.a(x12), .O(new_n65_));
  nand4  g40(.a(x13), .b(new_n65_), .c(x05), .d(x04), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n26_), .c(x03), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  oai21  g43(.a(x03), .b(new_n26_), .c(x13), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(new_n68_), .O(z09));
  aoi21  g45(.a(new_n68_), .b(new_n26_), .c(x03), .O(z10));
endmodule
