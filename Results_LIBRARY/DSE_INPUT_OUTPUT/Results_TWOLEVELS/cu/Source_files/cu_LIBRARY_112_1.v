...
module FAU ( 
  ...
  oai21  g09(.a(new_n34_), .b(new_n33_), .c(new_n26_), .O(new_n35_));
  nand3  g10(.a(new_n35_), .b(new_n31_), .c(new_n29_), .O(z00));
  nand3  g11(.a(new_n32_), .b(x04), .c(x02), .O(new_n37_));
  inv1   g12(.a(x04), .O(new_n38_));
  nand4  g13(.a(new_n26_), .b(x05), .c(new_n38_), .d(new_n30_), .O(new_n39_));
  ...
  nand4  g20(.a(new_n45_), .b(new_n26_), .c(x05), .d(new_n38_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nor2   g22(.a(x13), .b(x11), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(x05), .c(new_n43_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n30_), .c(new_n42_), .d(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n26_), .c(x04), .O(z03));
  nand4  g27(.a(new_n50_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n26_), .c(x04), .O(z04));
  nand4  g29(.a(new_n43_), .b(new_n30_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n26_), .c(x05), .d(new_n38_), .O(new_n57_));
  ...
  nor2   g37(.a(x11), .b(new_n42_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(x00), .O(new_n64_));
  nor2   g39(.a(x08), .b(x01), .O(new_n65_));
  nor2   g40(.a(x10), .b(new_n42_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n41_), .O(new_n67_));
  ...
  nand2  g47(.a(new_n72_), .b(new_n28_), .O(z06));
  nand4  g48(.a(new_n48_), .b(x05), .c(new_n38_), .d(new_n43_), .O(new_n74_));
  ...
  nor3   g55(.a(new_n27_), .b(new_n61_), .c(new_n80_), .O(z09));
  inv1   g56(.a(new_n33_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n28_), .c(x06), .d(new_n43_), .O(new_n83_));
