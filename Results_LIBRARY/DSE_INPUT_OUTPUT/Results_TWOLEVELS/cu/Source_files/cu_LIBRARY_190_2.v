...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n36_), .O(z02));
  nand3  g23(.a(new_n33_), .b(new_n44_), .c(x00), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n47_), .c(new_n36_), .O(z03));
  nand3  g25(.a(new_n33_), .b(x01), .c(new_n43_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n47_), .c(new_n36_), .O(z04));
  nor2   g27(.a(new_n27_), .b(x13), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x02), .O(z07));
  nand2  g30(.a(z07), .b(x01), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(new_n43_), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand2  g35(.a(x11), .b(new_n44_), .O(new_n61_));
  inv1   g36(.a(x11), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n26_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n60_), .c(x00), .O(new_n65_));
  aoi21  g40(.a(x08), .b(new_n44_), .c(x00), .O(new_n66_));
  nor2   g41(.a(x11), .b(new_n44_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n26_), .O(new_n68_));
  inv1   g43(.a(x08), .O(new_n69_));
  nand4  g44(.a(x11), .b(new_n69_), .c(new_n44_), .d(new_n43_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n68_), .c(new_n65_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x13), .c(new_n59_), .d(new_n58_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x05), .c(new_n33_), .O(new_n74_));
  nand3  g49(.a(new_n53_), .b(new_n30_), .c(x02), .O(new_n75_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n75_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n37_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n36_), .O(z08));
  inv1   g57(.a(x06), .O(new_n83_));
  nor3   g58(.a(new_n27_), .b(new_n46_), .c(new_n83_), .O(z09));
  nand4  g59(.a(new_n32_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n85_));
