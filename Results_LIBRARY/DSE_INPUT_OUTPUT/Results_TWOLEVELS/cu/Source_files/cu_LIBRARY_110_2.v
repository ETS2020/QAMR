...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n37_), .c(new_n47_), .d(x06), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x06), .c(new_n46_), .O(z03));
  nand3  g25(.a(new_n35_), .b(x01), .c(new_n46_), .O(new_n51_));
  nand4  g26(.a(new_n47_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n52_));
  ...
  nand4  g30(.a(new_n55_), .b(x06), .c(x05), .d(new_n29_), .O(new_n56_));
  ...
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n46_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n47_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n27_), .b(new_n47_), .c(new_n36_), .d(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(new_n26_), .b(x00), .c(x13), .O(new_n73_));
  ...
  nor2   g55(.a(new_n47_), .b(new_n26_), .O(z09));
