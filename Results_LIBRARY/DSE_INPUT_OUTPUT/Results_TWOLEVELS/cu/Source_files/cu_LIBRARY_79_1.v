...
module FAU ( 
  ...
  nor2   g26(.a(x13), .b(new_n27_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n51_), .c(new_n26_), .d(x00), .O(new_n53_));
  ...
  aoi21  g42(.a(x01), .b(new_n32_), .c(x13), .O(new_n68_));
  ...
  nand3  g46(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n72_));
  ...
  nor3   g51(.a(z04), .b(new_n44_), .c(new_n76_), .O(z09));
  nand3  g52(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n78_));
