...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n43_), .c(x00), .O(new_n44_));
  nand4  g19(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n39_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n34_), .O(z03));
  inv1   g21(.a(x00), .O(new_n47_));
  nand4  g22(.a(new_n39_), .b(new_n33_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nor3   g26(.a(x02), .b(new_n43_), .c(new_n47_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n39_), .O(new_n53_));
  ...
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n39_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n34_), .O(z06));
  nand4  g42(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n39_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand2  g44(.a(x05), .b(new_n33_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n56_), .c(x09), .O(new_n71_));
  ...
  aoi21  g50(.a(x09), .b(new_n75_), .c(new_n26_), .O(z09));
