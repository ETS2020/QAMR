...
module FAU ( 
  ...
  nand4  g17(.a(new_n33_), .b(new_n34_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nand4  g22(.a(new_n33_), .b(new_n34_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g29(.a(x05), .b(x04), .c(new_n33_), .d(new_n34_), .O(new_n55_));
  ...
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n73_));
