...
module FAU ( 
  ...
  nand4  g17(.a(x10), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n27_), .c(new_n42_), .d(new_n41_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x10), .c(x13), .O(z02));
  nand4  g21(.a(new_n35_), .b(new_n27_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x10), .c(x05), .d(new_n29_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x10), .c(x05), .d(new_n29_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n44_), .b(new_n27_), .c(x01), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x10), .c(x13), .O(z05));
  ...
  nand4  g42(.a(new_n59_), .b(x10), .c(new_n30_), .d(x02), .O(new_n68_));
  ...
  nand4  g46(.a(new_n59_), .b(x10), .c(x05), .d(new_n29_), .O(new_n72_));
  nor3   g47(.a(new_n72_), .b(x03), .c(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n74_));
