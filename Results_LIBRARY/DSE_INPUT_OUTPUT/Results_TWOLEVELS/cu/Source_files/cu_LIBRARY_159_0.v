...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n38_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z04));
  nor3   g23(.a(x02), .b(new_n39_), .c(new_n38_), .O(new_n49_));
  ...
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n38_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n56_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(x13), .c(new_n53_), .d(new_n52_), .O(new_n61_));
  nor2   g36(.a(new_n61_), .b(new_n28_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x04), .c(new_n26_), .d(new_n31_), .O(new_n63_));
  nand2  g38(.a(new_n29_), .b(new_n28_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(z06));
  nand2  g40(.a(new_n28_), .b(x01), .O(new_n66_));
  ...
  nand4  g44(.a(new_n69_), .b(new_n53_), .c(x05), .d(x04), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n29_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n64_), .O(z09));
