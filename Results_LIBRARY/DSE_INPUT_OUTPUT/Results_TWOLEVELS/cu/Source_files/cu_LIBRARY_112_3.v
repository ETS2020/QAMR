...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n78_;
  nand2  g00(.a(x11), .b(x04), .O(new_n26_));
  nand2  g01(.a(new_n26_), .b(x03), .O(new_n27_));
  inv1   g02(.a(x04), .O(new_n28_));
  inv1   g03(.a(x05), .O(new_n29_));
  oai21  g04(.a(new_n29_), .b(x02), .c(new_n28_), .O(new_n30_));
  ...
  nand3  g11(.a(x05), .b(new_n28_), .c(new_n36_), .O(new_n37_));
  ...
  nand4  g16(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n40_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x13), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n36_), .b(new_n44_), .c(x00), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n40_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n26_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n36_), .b(x01), .c(new_n49_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n47_), .c(new_n26_), .O(z04));
  nor3   g26(.a(x02), .b(new_n44_), .c(new_n49_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n40_), .O(new_n53_));
  ...
  aoi22  g35(.a(new_n60_), .b(new_n49_), .c(new_n59_), .d(x01), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n46_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n63_));
  nand4  g38(.a(new_n46_), .b(new_n31_), .c(new_n29_), .d(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n40_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n31_), .c(new_n28_), .O(z06));
  nand4  g42(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n40_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n56_), .c(x05), .d(new_n36_), .O(new_n70_));
  nand3  g45(.a(new_n46_), .b(new_n29_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n31_), .c(x04), .d(new_n40_), .O(new_n73_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n26_), .c(x06), .d(new_n40_), .O(new_n78_));
