...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(new_n41_), .c(x00), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x01), .O(z02));
  inv1   g21(.a(x00), .O(new_n48_));
  nand4  g22(.a(new_n35_), .b(new_n26_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g23(.a(new_n49_), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(new_n42_), .c(x05), .d(new_n30_), .O(new_n51_));
  inv1   g25(.a(new_n51_), .O(z04));
  aoi21  g26(.a(new_n44_), .b(new_n41_), .c(new_n32_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(new_n48_), .O(z05));
  nand3  g28(.a(new_n41_), .b(x05), .c(x04), .O(new_n55_));
  ...
  nand3  g38(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n65_));
  oai21  g39(.a(new_n64_), .b(new_n62_), .c(new_n65_), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n48_), .O(new_n67_));
  nand4  g41(.a(new_n42_), .b(new_n27_), .c(x02), .d(x01), .O(new_n68_));
  ...
  aoi21  g52(.a(new_n32_), .b(x00), .c(x13), .O(new_n79_));
  nand4  g53(.a(new_n79_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n80_));
  ...
  nand4  g58(.a(new_n84_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n85_));
  inv1   g59(.a(new_n85_), .O(z08));
  inv1   g60(.a(x06), .O(new_n87_));
  nand2  g61(.a(new_n33_), .b(x13), .O(new_n88_));
  nor2   g62(.a(new_n88_), .b(new_n87_), .O(z09));
  nand2  g63(.a(x05), .b(x02), .O(new_n90_));
  nand3  g64(.a(new_n90_), .b(x06), .c(new_n35_), .O(new_n91_));
  nand2  g65(.a(new_n91_), .b(new_n33_), .O(z10));
  zero   g66(.O(z03));
endmodule
