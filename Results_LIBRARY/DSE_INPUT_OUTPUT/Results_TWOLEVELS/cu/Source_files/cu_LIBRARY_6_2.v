...
module FAU ( 
  ...
  oai21  g41(.a(new_n45_), .b(new_n43_), .c(x01), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(x00), .O(new_n69_));
  nand2  g43(.a(x01), .b(x00), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n71_));
  inv1   g45(.a(new_n71_), .O(new_n72_));
  nand3  g46(.a(new_n72_), .b(new_n36_), .c(new_n29_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n69_), .O(z07));
  nand4  g48(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n75_));
  nand3  g49(.a(new_n44_), .b(new_n32_), .c(x02), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g51(.a(new_n77_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n78_));
  inv1   g52(.a(new_n78_), .O(z08));
  inv1   g53(.a(x06), .O(new_n80_));
  nor3   g54(.a(new_n28_), .b(new_n44_), .c(new_n80_), .O(z09));
  inv1   g55(.a(new_n33_), .O(new_n82_));
  nand4  g56(.a(new_n82_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n83_));
