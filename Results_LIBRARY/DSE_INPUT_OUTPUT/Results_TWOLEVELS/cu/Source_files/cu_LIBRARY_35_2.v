...
module FAU ( 
  ...
  nand2  g17(.a(new_n36_), .b(new_n29_), .O(new_n43_));
  inv1   g18(.a(x13), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(x05), .c(new_n31_), .O(new_n45_));
  or2    g20(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  ...
  nor3   g26(.a(x02), .b(new_n26_), .c(new_n42_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z05));
  nand4  g29(.a(new_n27_), .b(new_n44_), .c(new_n32_), .d(x02), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nor2   g32(.a(x08), .b(x01), .O(new_n58_));
  nor2   g33(.a(x10), .b(new_n26_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(new_n60_));
  ...
  oai21  g42(.a(new_n45_), .b(new_n43_), .c(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x00), .O(new_n69_));
  nand2  g44(.a(x01), .b(x00), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n36_), .c(new_n29_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n69_), .O(z07));
  nand4  g49(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n55_), .O(new_n76_));
