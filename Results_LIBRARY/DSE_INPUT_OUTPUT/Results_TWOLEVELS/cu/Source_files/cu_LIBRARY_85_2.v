...
module FAU ( 
  ...
  nand4  g21(.a(new_n36_), .b(new_n33_), .c(new_n26_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand4  g26(.a(new_n46_), .b(x12), .c(x05), .d(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n36_), .c(new_n33_), .d(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x12), .c(new_n26_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n36_), .c(new_n33_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x12), .c(new_n26_), .O(z05));
  ...
  nand3  g53(.a(new_n32_), .b(x06), .c(new_n36_), .O(new_n79_));
