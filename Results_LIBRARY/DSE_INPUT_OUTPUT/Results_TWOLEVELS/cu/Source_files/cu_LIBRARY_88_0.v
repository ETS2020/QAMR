...
module FAU ( 
  ...
  nand4  g17(.a(new_n33_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n44_));
  ...
  nand3  g28(.a(new_n48_), .b(x05), .c(x04), .O(new_n55_));
  ...
  nand4  g45(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n72_));
  oai21  g46(.a(new_n72_), .b(x02), .c(new_n32_), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n34_), .O(new_n74_));
  ...
  nand3  g54(.a(new_n80_), .b(x06), .c(new_n33_), .O(new_n81_));
  nand2  g55(.a(new_n81_), .b(new_n32_), .O(z10));
  zero   g56(.O(z02));
endmodule
