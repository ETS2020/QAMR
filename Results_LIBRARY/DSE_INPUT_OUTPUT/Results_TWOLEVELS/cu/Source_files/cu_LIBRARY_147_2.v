...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(new_n31_), .c(new_n27_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n27_), .c(x03), .O(z03));
  nor2   g23(.a(x03), .b(new_n27_), .O(z04));
  ...
  nand4  g32(.a(new_n57_), .b(new_n51_), .c(new_n50_), .d(x05), .O(new_n58_));
  nand4  g33(.a(new_n44_), .b(new_n32_), .c(x02), .d(new_n27_), .O(new_n59_));
  oai21  g34(.a(new_n58_), .b(x02), .c(new_n59_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x04), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n27_), .c(x03), .O(z06));
  nor4   g37(.a(new_n45_), .b(x03), .c(x02), .d(x01), .O(z07));
  nand4  g38(.a(x13), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n64_));
  nand3  g39(.a(new_n44_), .b(new_n32_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(x04), .c(new_n26_), .d(new_n27_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n69_));
  oai21  g44(.a(x03), .b(new_n27_), .c(new_n69_), .O(z09));
  oai21  g45(.a(new_n32_), .b(new_n31_), .c(x06), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n27_), .c(x03), .O(z10));
