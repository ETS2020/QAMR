...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n34_), .c(new_n30_), .d(new_n41_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n41_), .c(new_n40_), .O(z03));
  nand4  g24(.a(new_n47_), .b(new_n34_), .c(new_n30_), .d(new_n40_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n40_), .c(new_n41_), .O(z04));
  inv1   g26(.a(new_n32_), .O(z05));
  nand4  g27(.a(new_n32_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  aoi21  g40(.a(x01), .b(x00), .c(x13), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(x05), .c(new_n26_), .d(new_n34_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n32_), .O(z09));
  nand4  g50(.a(new_n32_), .b(new_n29_), .c(x06), .d(new_n34_), .O(new_n76_));
