...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n27_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n29_), .c(new_n34_), .O(new_n53_));
  oai21  g27(.a(new_n53_), .b(new_n52_), .c(new_n35_), .O(z05));
  nand4  g28(.a(new_n35_), .b(new_n46_), .c(new_n30_), .d(x02), .O(new_n55_));
  inv1   g29(.a(x07), .O(new_n56_));
  inv1   g30(.a(x12), .O(new_n57_));
  nor2   g31(.a(x09), .b(x01), .O(new_n58_));
  inv1   g32(.a(x01), .O(new_n59_));
  nor2   g33(.a(x11), .b(new_n59_), .O(new_n60_));
  oai21  g34(.a(new_n60_), .b(new_n58_), .c(x00), .O(new_n61_));
  ...
  aoi21  g42(.a(new_n59_), .b(new_n47_), .c(x13), .O(new_n69_));
  ...
  nand3  g46(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n73_));
