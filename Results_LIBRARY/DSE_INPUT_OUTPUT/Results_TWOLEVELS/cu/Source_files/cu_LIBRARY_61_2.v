...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n33_), .c(new_n44_), .d(new_n43_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n26_), .c(x13), .O(z02));
  nand4  g23(.a(new_n46_), .b(new_n33_), .c(new_n44_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n26_), .c(x13), .O(z03));
  nand4  g25(.a(new_n46_), .b(new_n33_), .c(x01), .d(new_n43_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n26_), .c(x13), .O(z04));
  nand4  g27(.a(new_n37_), .b(new_n33_), .c(x01), .d(x00), .O(new_n53_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n57_), .c(x05), .d(new_n33_), .O(new_n66_));
  nand3  g41(.a(new_n58_), .b(new_n30_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n26_), .c(x04), .d(new_n37_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nor2   g45(.a(x13), .b(x12), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand3  g48(.a(x13), .b(x05), .c(new_n33_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n26_), .c(x04), .d(new_n37_), .O(new_n76_));
