...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n33_), .d(new_n37_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n36_), .O(z02));
  nand3  g23(.a(new_n29_), .b(new_n44_), .c(x00), .O(new_n49_));
  ...
  nand4  g27(.a(new_n36_), .b(new_n46_), .c(x05), .d(new_n33_), .O(new_n53_));
  nor3   g28(.a(new_n53_), .b(x03), .c(x02), .O(z07));
  ...
  nand4  g40(.a(new_n65_), .b(x05), .c(new_n29_), .d(x00), .O(new_n66_));
  nand3  g41(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n27_), .O(new_n68_));
  aoi21  g43(.a(x10), .b(x01), .c(x08), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n26_), .O(new_n70_));
  inv1   g45(.a(x10), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x08), .c(x01), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n70_), .c(new_n46_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n74_));
  nor3   g49(.a(new_n74_), .b(x02), .c(x00), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n68_), .c(x04), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x03), .O(z06));
  nand4  g52(.a(x13), .b(new_n58_), .c(x05), .d(new_n29_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n67_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n36_), .c(x04), .d(new_n37_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  nand3  g56(.a(x13), .b(x08), .c(x06), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z09));
  oai21  g58(.a(new_n30_), .b(new_n29_), .c(new_n37_), .O(new_n84_));
  aoi21  g59(.a(new_n84_), .b(x08), .c(new_n26_), .O(z10));
endmodule
