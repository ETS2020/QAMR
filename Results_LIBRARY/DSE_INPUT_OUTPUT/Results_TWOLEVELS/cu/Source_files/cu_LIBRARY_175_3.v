...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n31_), .d(new_n37_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n37_), .b(new_n29_), .c(new_n26_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand4  g26(.a(new_n37_), .b(new_n29_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n37_), .b(new_n29_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n58_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g43(.a(new_n46_), .b(new_n32_), .c(x02), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n68_), .c(x12), .O(new_n70_));
  nand4  g45(.a(new_n46_), .b(new_n32_), .c(x02), .d(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n70_), .c(x04), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x03), .O(z06));
  aoi21  g49(.a(x12), .b(x01), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n31_), .d(new_n37_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(x02), .c(new_n36_), .O(z07));
  nand4  g52(.a(new_n36_), .b(new_n46_), .c(new_n32_), .d(x02), .O(new_n78_));
  nand4  g53(.a(x13), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n79_));
