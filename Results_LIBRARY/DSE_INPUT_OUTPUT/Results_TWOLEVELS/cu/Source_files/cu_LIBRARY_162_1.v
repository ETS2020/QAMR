...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n42_), .c(new_n30_), .d(new_n32_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(new_n32_), .c(x00), .O(z02));
  nand3  g20(.a(new_n26_), .b(new_n32_), .c(x00), .O(new_n46_));
  nand3  g21(.a(new_n43_), .b(new_n30_), .c(new_n36_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n46_), .c(new_n34_), .O(z03));
  nand4  g23(.a(new_n43_), .b(new_n42_), .c(new_n30_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x00), .c(new_n32_), .O(z05));
  nand3  g25(.a(x05), .b(new_n26_), .c(new_n32_), .O(new_n51_));
  ...
  nand3  g31(.a(new_n56_), .b(new_n27_), .c(x02), .O(new_n57_));
  oai21  g32(.a(new_n55_), .b(new_n51_), .c(new_n57_), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(x00), .O(new_n59_));
  oai22  g34(.a(x11), .b(new_n32_), .c(x08), .d(x00), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(x13), .c(new_n54_), .d(new_n52_), .O(new_n61_));
  inv1   g36(.a(new_n61_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x05), .c(new_n26_), .O(new_n63_));
  nand4  g38(.a(new_n56_), .b(new_n27_), .c(x02), .d(new_n32_), .O(new_n64_));
  ...
  aoi21  g43(.a(x01), .b(new_n68_), .c(x13), .O(new_n69_));
  ...
  nand2  g47(.a(x13), .b(new_n54_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n57_), .O(new_n74_));
