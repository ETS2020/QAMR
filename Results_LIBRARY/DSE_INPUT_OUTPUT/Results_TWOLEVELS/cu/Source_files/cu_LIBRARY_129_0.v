...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x11), .c(x05), .d(new_n27_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nand3  g21(.a(x05), .b(new_n27_), .c(new_n33_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n34_), .c(new_n42_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x11), .c(x13), .O(z03));
  nand4  g25(.a(new_n33_), .b(new_n34_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x11), .c(x05), .d(new_n27_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n48_), .b(new_n34_), .c(x01), .d(x00), .O(new_n55_));
  ...
  nand3  g35(.a(x13), .b(new_n60_), .c(new_n42_), .O(new_n61_));
  ...
  nand3  g43(.a(new_n68_), .b(x13), .c(new_n41_), .O(new_n69_));
  ...
  aoi21  g51(.a(new_n58_), .b(new_n41_), .c(new_n36_), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n27_), .c(new_n33_), .d(new_n34_), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(x11), .c(x13), .O(z07));
  inv1   g54(.a(x12), .O(new_n80_));
  nand4  g55(.a(x13), .b(new_n80_), .c(x05), .d(new_n34_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n33_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n32_), .O(z08));
  nand2  g59(.a(x13), .b(x06), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n32_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n87_));
  nand3  g62(.a(new_n87_), .b(x06), .c(new_n33_), .O(new_n88_));
