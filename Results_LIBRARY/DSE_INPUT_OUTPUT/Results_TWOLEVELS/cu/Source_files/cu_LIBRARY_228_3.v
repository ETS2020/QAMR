...
module FAU ( 
  ...
  nor2   g25(.a(x02), .b(new_n46_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n47_), .c(new_n50_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n45_), .c(new_n31_), .O(z04));
  nand3  g28(.a(new_n51_), .b(new_n47_), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n45_), .c(new_n31_), .O(z05));
  nand2  g30(.a(new_n26_), .b(x02), .O(new_n56_));
  nand3  g31(.a(new_n45_), .b(new_n31_), .c(x04), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n40_), .O(z06));
  nand4  g33(.a(new_n45_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x02), .O(z07));
  inv1   g35(.a(x06), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n31_), .c(new_n45_), .O(z09));
  nand2  g37(.a(x05), .b(x02), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x06), .c(new_n26_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n40_), .O(z10));
  oai21  g40(.a(new_n57_), .b(new_n56_), .c(new_n40_), .O(z08));
endmodule
