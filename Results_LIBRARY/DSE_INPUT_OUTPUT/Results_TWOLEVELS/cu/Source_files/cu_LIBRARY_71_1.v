...
module FAU ( 
  ...
  nor2   g01(.a(new_n26_), .b(x10), .O(new_n27_));
  ...
  nand3  g25(.a(new_n33_), .b(x01), .c(new_n49_), .O(new_n51_));
  nand4  g26(.a(new_n44_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n37_), .O(z04));
  nand3  g28(.a(new_n33_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n37_), .O(z05));
  ...
  nor3   g36(.a(x08), .b(x01), .c(x00), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n26_), .O(new_n63_));
  inv1   g38(.a(x10), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x01), .c(new_n49_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n44_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n56_), .c(x05), .d(new_n33_), .O(new_n67_));
  ...
  nand4  g46(.a(x13), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n72_));
  ...
  nor3   g51(.a(new_n27_), .b(new_n44_), .c(new_n76_), .O(z09));
  nand3  g52(.a(new_n32_), .b(x06), .c(new_n36_), .O(new_n78_));
