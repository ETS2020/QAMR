...
module FAU ( 
  ...
  nand3  g18(.a(new_n35_), .b(new_n26_), .c(x00), .O(new_n44_));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n36_), .d(new_n40_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n28_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n40_), .b(new_n35_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n45_), .c(x05), .d(new_n36_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n26_), .c(new_n48_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n36_), .d(new_n40_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z05));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  inv1   g32(.a(x09), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(x05), .c(new_n26_), .O(new_n59_));
  ...
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(new_n45_), .O(new_n70_));
  ...
  nand4  g50(.a(new_n45_), .b(x05), .c(new_n36_), .d(new_n40_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(x02), .c(new_n28_), .O(z07));
  nand4  g52(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n72_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n40_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n28_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n27_), .b(new_n45_), .c(new_n82_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x06), .c(new_n40_), .O(new_n85_));
