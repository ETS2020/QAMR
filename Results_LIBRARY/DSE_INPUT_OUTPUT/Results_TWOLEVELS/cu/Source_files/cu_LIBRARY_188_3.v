...
module FAU ( 
  ...
  nand2  g27(.a(x13), .b(x03), .O(new_n53_));
  nand3  g28(.a(new_n30_), .b(x01), .c(x00), .O(new_n54_));
  nand4  g29(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n55_));
  ...
  nand3  g41(.a(new_n42_), .b(new_n31_), .c(x02), .O(new_n67_));
