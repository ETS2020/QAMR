...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n32_, new_n33_,
    ...
    new_n85_;
  nor2   g00(.a(x09), .b(x00), .O(new_n26_));
  ...
  nand4  g23(.a(new_n33_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n48_), .c(x05), .d(new_n27_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  nor2   g27(.a(x03), .b(x02), .O(new_n53_));
  inv1   g28(.a(x09), .O(new_n54_));
  nor2   g29(.a(x13), .b(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n53_), .c(new_n36_), .d(x01), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x09), .c(x00), .O(z04));
  nand3  g32(.a(new_n34_), .b(x01), .c(x00), .O(new_n58_));
  nand4  g33(.a(new_n48_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n32_), .O(z05));
  ...
  nor2   g40(.a(x09), .b(x01), .O(new_n66_));
  nor2   g41(.a(x11), .b(new_n43_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(x00), .c(new_n66_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n65_), .c(new_n48_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n62_), .c(new_n61_), .d(x05), .O(new_n70_));
  nand3  g45(.a(new_n48_), .b(new_n35_), .c(x02), .O(new_n71_));
  ...
  aoi21  g49(.a(new_n54_), .b(new_n42_), .c(x13), .O(new_n75_));
  ...
  nand4  g59(.a(new_n84_), .b(new_n32_), .c(x06), .d(new_n33_), .O(new_n85_));
