...
module FAU ( 
  ...
  oai21  g01(.a(x12), .b(x02), .c(x05), .O(new_n27_));
  ...
  nand4  g19(.a(new_n44_), .b(new_n28_), .c(new_n39_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n35_), .c(new_n31_), .O(z03));
  nand4  g21(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n38_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n35_), .c(x05), .d(new_n30_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z04));
  nand4  g25(.a(new_n26_), .b(new_n28_), .c(x01), .d(x00), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n35_), .c(x05), .d(new_n30_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x13), .O(new_n56_));
  nor2   g31(.a(x09), .b(x01), .O(new_n57_));
  nor2   g32(.a(x11), .b(new_n39_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  nor2   g34(.a(x08), .b(x01), .O(new_n60_));
  nor2   g35(.a(x10), .b(new_n39_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n60_), .c(new_n38_), .O(new_n62_));
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n56_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n35_), .c(new_n55_), .d(x05), .O(new_n64_));
  ...
  aoi21  g43(.a(new_n39_), .b(x00), .c(new_n35_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n30_), .c(new_n26_), .d(new_n28_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n35_), .c(new_n31_), .O(z07));
  nand4  g47(.a(x13), .b(new_n35_), .c(x05), .d(new_n28_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n65_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n26_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  nand2  g51(.a(x12), .b(x05), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x13), .c(x06), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z09));
  nand3  g54(.a(new_n27_), .b(x06), .c(new_n26_), .O(new_n80_));
