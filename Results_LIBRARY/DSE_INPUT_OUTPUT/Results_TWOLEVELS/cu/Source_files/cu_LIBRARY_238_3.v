...
module FAU ( 
  ...
  nand4  g25(.a(new_n46_), .b(new_n49_), .c(x05), .d(new_n28_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n33_), .c(new_n34_), .d(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n49_), .c(new_n44_), .O(z04));
  nand4  g29(.a(new_n52_), .b(new_n33_), .c(new_n34_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n49_), .c(new_n44_), .O(z05));
  ...
  nand2  g58(.a(new_n83_), .b(new_n26_), .O(z10));
endmodule
