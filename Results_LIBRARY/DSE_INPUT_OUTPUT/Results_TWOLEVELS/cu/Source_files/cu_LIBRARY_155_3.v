...
module FAU ( 
  ...
  nand4  g22(.a(new_n38_), .b(new_n34_), .c(new_n26_), .d(x00), .O(new_n48_));
  ...
  nand4  g31(.a(new_n38_), .b(new_n34_), .c(x01), .d(x00), .O(new_n57_));
  ...
  nand4  g46(.a(new_n47_), .b(new_n31_), .c(x02), .d(new_n26_), .O(new_n72_));
  ...
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x02), .O(z07));
  nand4  g53(.a(new_n37_), .b(new_n47_), .c(new_n31_), .d(x02), .O(new_n79_));
  nand4  g54(.a(x13), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(x04), .c(new_n38_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n37_), .O(z08));
  nand3  g58(.a(new_n37_), .b(x13), .c(x06), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z09));
  nand3  g60(.a(new_n33_), .b(x06), .c(new_n38_), .O(new_n86_));
