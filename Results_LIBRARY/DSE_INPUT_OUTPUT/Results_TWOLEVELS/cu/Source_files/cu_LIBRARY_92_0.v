...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x07), .c(x05), .d(new_n27_), .O(new_n46_));
  ...
  aoi21  g26(.a(new_n51_), .b(x07), .c(x01), .O(z03));
  ...
  nand4  g33(.a(new_n53_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n32_), .O(z05));
  nand4  g35(.a(new_n32_), .b(new_n53_), .c(new_n35_), .d(x02), .O(new_n61_));
  ...
  nand4  g42(.a(new_n67_), .b(x13), .c(new_n62_), .d(new_n49_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n34_), .d(x01), .O(new_n70_));
  ...
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n75_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n32_), .O(z08));
  inv1   g55(.a(x06), .O(new_n81_));
  nor3   g56(.a(new_n26_), .b(new_n53_), .c(new_n81_), .O(z09));
