...
module FAU ( 
  ...
  nor2   g21(.a(x05), .b(x01), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n28_), .b(x01), .c(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n48_), .O(z04));
  nor3   g27(.a(x02), .b(new_n27_), .c(new_n49_), .O(new_n53_));
  ...
  nand2  g33(.a(new_n58_), .b(new_n27_), .O(new_n59_));
  ...
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(new_n42_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n57_), .c(new_n56_), .d(new_n28_), .O(new_n71_));
  nand3  g46(.a(new_n36_), .b(new_n42_), .c(new_n29_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n48_), .O(z06));
  nand4  g50(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(x02), .c(new_n48_), .O(z07));
  nand2  g52(.a(x05), .b(new_n28_), .O(new_n78_));
  ...
  nor3   g58(.a(new_n47_), .b(new_n42_), .c(new_n83_), .O(z09));
  oai21  g59(.a(x05), .b(new_n27_), .c(new_n78_), .O(new_n85_));
