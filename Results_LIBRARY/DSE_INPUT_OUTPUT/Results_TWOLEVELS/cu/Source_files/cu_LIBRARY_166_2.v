...
module FAU ( 
  ...
  nand3  g14(.a(new_n30_), .b(new_n35_), .c(new_n39_), .O(new_n40_));
  ...
  nand4  g18(.a(new_n26_), .b(new_n30_), .c(new_n35_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  nand3  g22(.a(new_n41_), .b(x05), .c(new_n27_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(new_n30_), .d(new_n39_), .O(new_n50_));
  ...
  nand4  g38(.a(new_n41_), .b(new_n28_), .c(x02), .d(new_n35_), .O(new_n64_));
  ...
  nor3   g42(.a(new_n48_), .b(x03), .c(x02), .O(z07));
  ...
  nand2  g46(.a(new_n71_), .b(new_n38_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n38_), .O(z09));
  nand3  g49(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n75_));
