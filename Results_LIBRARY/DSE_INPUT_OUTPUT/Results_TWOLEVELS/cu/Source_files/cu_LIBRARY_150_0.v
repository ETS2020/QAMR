...
module FAU ( 
  ...
  nand4  g23(.a(new_n32_), .b(new_n44_), .c(x05), .d(new_n27_), .O(new_n49_));
  ...
  nand4  g38(.a(new_n32_), .b(new_n44_), .c(new_n36_), .d(x02), .O(new_n64_));
  ...
  nand4  g45(.a(new_n70_), .b(new_n32_), .c(x04), .d(new_n33_), .O(new_n71_));
