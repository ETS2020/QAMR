...
module FAU ( 
  ...
  nand3  g21(.a(new_n33_), .b(new_n46_), .c(x00), .O(new_n47_));
  nand4  g22(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n36_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n37_), .b(new_n33_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n26_), .c(x05), .d(new_n29_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n33_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n48_), .c(new_n36_), .O(z05));
  ...
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n50_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n26_), .O(new_n64_));
  ...
  nand4  g44(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n58_), .c(x05), .d(new_n33_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n66_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n37_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n36_), .O(z08));
  nand3  g50(.a(x13), .b(x08), .c(x06), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z09));
  nand3  g52(.a(new_n32_), .b(x06), .c(new_n37_), .O(new_n78_));
