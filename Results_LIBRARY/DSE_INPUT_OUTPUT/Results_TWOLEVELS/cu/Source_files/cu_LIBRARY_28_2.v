...
module FAU ( 
  ...
  nand4  g26(.a(new_n45_), .b(x10), .c(x05), .d(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n34_), .c(new_n35_), .d(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x10), .c(new_n46_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n56_));
  ...
  nand3  g41(.a(new_n66_), .b(new_n46_), .c(new_n51_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n27_), .b(new_n45_), .c(new_n37_), .d(x02), .O(new_n70_));
  ...
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n35_), .O(new_n77_));
  ...
  nor3   g56(.a(new_n28_), .b(new_n45_), .c(new_n81_), .O(z09));
