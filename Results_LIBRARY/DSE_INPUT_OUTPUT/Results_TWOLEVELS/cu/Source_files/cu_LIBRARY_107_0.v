...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(x10), .c(x03), .O(z02));
  ...
  nand4  g30(.a(new_n26_), .b(new_n30_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x10), .c(x05), .d(new_n27_), .O(new_n58_));
  ...
  aoi21  g52(.a(new_n77_), .b(x10), .c(x03), .O(z08));
  nand2  g53(.a(x13), .b(x06), .O(new_n79_));
  oai21  g54(.a(x10), .b(x03), .c(new_n79_), .O(z09));
  oai21  g55(.a(new_n31_), .b(new_n30_), .c(x06), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(x10), .c(x03), .O(z10));
endmodule
