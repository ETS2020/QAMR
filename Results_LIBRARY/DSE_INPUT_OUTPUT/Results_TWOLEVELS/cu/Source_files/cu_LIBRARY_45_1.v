...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n50_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
  ...
  nand2  g17(.a(new_n42_), .b(x05), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n26_), .c(new_n35_), .d(new_n30_), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(new_n41_), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(new_n32_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z02));
  nand3  g23(.a(new_n30_), .b(new_n41_), .c(x00), .O(new_n49_));
  nand3  g24(.a(new_n44_), .b(new_n26_), .c(new_n35_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n33_), .O(z03));
  aoi21  g26(.a(new_n45_), .b(x00), .c(new_n41_), .O(z05));
  nand4  g27(.a(new_n33_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x09), .b(x01), .O(new_n57_));
  nor2   g31(.a(x11), .b(new_n41_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  inv1   g33(.a(x08), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n41_), .c(new_n32_), .O(new_n61_));
  aoi21  g35(.a(new_n61_), .b(new_n59_), .c(new_n42_), .O(new_n62_));
  ...
  aoi21  g40(.a(new_n41_), .b(new_n32_), .c(x13), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n68_));
  oai21  g42(.a(new_n68_), .b(x02), .c(new_n47_), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n70_));
  nand3  g44(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n71_));
  ...
  nand4  g50(.a(new_n33_), .b(new_n29_), .c(x06), .d(new_n35_), .O(new_n77_));
