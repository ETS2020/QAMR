...
module FAU ( 
  ...
  nor3   g22(.a(x03), .b(x02), .c(x01), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n37_), .c(new_n47_), .d(x08), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x08), .c(new_n46_), .O(z03));
  nand4  g25(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n46_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n53_));
  ...
  inv1   g36(.a(x01), .O(new_n62_));
  nor2   g37(.a(x11), .b(new_n62_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n61_), .c(x00), .O(new_n64_));
  nor2   g39(.a(x08), .b(x01), .O(new_n65_));
  nor2   g40(.a(x10), .b(new_n62_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n46_), .c(new_n65_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n47_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n27_), .b(new_n47_), .c(new_n36_), .d(x02), .O(new_n70_));
  ...
  aoi21  g48(.a(new_n26_), .b(x00), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n60_), .c(x05), .d(new_n35_), .O(new_n77_));
  nand3  g52(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n78_));
