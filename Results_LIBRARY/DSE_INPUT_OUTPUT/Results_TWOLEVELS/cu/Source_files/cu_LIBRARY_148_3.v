...
module FAU ( 
  ...
  aoi21  g00(.a(x10), .b(x08), .c(x03), .O(new_n26_));
  ...
  nand2  g09(.a(x10), .b(x08), .O(new_n35_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n59_), .c(x01), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n58_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x00), .O(new_n63_));
  nand2  g38(.a(new_n59_), .b(new_n42_), .O(new_n64_));
  nand2  g39(.a(new_n57_), .b(x01), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g41(.a(new_n56_), .b(new_n59_), .c(new_n42_), .O(new_n67_));
  nand3  g42(.a(new_n60_), .b(new_n57_), .c(x01), .O(new_n68_));
  ...
  nand4  g47(.a(new_n35_), .b(new_n44_), .c(new_n28_), .d(x02), .O(new_n73_));
  ...
  nand4  g51(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n73_), .O(new_n78_));
  ...
  nand3  g57(.a(new_n30_), .b(x06), .c(new_n34_), .O(new_n83_));
