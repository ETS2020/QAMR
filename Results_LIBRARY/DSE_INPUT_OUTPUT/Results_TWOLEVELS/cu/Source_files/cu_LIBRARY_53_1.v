...
module FAU ( 
  ...
  nand4  g27(.a(new_n27_), .b(new_n47_), .c(new_n37_), .d(x02), .O(new_n54_));
  ...
  nand4  g41(.a(new_n67_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n35_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand3  g45(.a(new_n71_), .b(x04), .c(new_n34_), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n27_), .O(z08));
  inv1   g47(.a(x06), .O(new_n74_));
  nor3   g48(.a(new_n28_), .b(new_n47_), .c(new_n74_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n76_));
  nand4  g50(.a(new_n76_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n77_));
