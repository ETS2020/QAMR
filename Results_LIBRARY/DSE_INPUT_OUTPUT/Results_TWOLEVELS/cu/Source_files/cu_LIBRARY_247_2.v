...
module FAU ( 
  ...
  nand3  g06(.a(new_n31_), .b(x10), .c(x05), .O(new_n32_));
  inv1   g07(.a(x05), .O(new_n33_));
  oai21  g08(.a(new_n30_), .b(new_n29_), .c(new_n33_), .O(new_n34_));
  nand3  g09(.a(new_n34_), .b(new_n32_), .c(new_n28_), .O(z00));
  ...
  aoi21  g38(.a(new_n62_), .b(x01), .c(new_n63_), .O(new_n64_));
  inv1   g39(.a(x08), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n43_), .c(new_n42_), .O(new_n66_));
  oai21  g41(.a(new_n64_), .b(new_n42_), .c(new_n66_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(x13), .c(new_n61_), .d(x10), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n70_));
  inv1   g45(.a(x13), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n33_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n36_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z06));
  nand4  g50(.a(new_n71_), .b(x10), .c(x05), .d(new_n30_), .O(new_n76_));
  nor3   g51(.a(new_n76_), .b(x03), .c(x02), .O(z07));
  nand2  g52(.a(x05), .b(new_n29_), .O(new_n78_));
  nand3  g53(.a(x13), .b(new_n61_), .c(x10), .O(new_n79_));
