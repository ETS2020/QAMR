...
module FAU ( 
  ...
  oai21  g02(.a(x13), .b(new_n27_), .c(x02), .O(new_n28_));
  ...
  nand2  g14(.a(x13), .b(x02), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n39_), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(new_n30_), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  nand4  g19(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n40_), .O(z02));
  nand3  g21(.a(new_n30_), .b(new_n43_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n40_), .O(z03));
  nand4  g23(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n42_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n34_), .c(x05), .d(new_n27_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nand3  g27(.a(new_n30_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n45_), .c(new_n40_), .O(z05));
  ...
  nand3  g39(.a(new_n34_), .b(new_n31_), .c(x02), .O(new_n65_));
  ...
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n40_), .O(z07));
  ...
  nand3  g49(.a(x13), .b(x06), .c(new_n30_), .O(new_n75_));
