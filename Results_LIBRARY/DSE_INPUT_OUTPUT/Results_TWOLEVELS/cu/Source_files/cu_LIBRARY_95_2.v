...
module FAU ( 
  ...
  nor2   g21(.a(x07), .b(new_n31_), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n30_), .c(new_n42_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n28_), .c(new_n41_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n26_), .c(x13), .O(z03));
  nand4  g26(.a(new_n49_), .b(new_n28_), .c(x01), .d(new_n40_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n26_), .c(x13), .O(z04));
  nand4  g28(.a(new_n42_), .b(new_n28_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n56_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n66_));
  nand3  g41(.a(new_n35_), .b(new_n31_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n26_), .c(x04), .d(new_n42_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nand4  g45(.a(new_n47_), .b(new_n30_), .c(new_n42_), .d(new_n28_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n26_), .c(x13), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n73_));
  nand4  g48(.a(new_n35_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n74_));
