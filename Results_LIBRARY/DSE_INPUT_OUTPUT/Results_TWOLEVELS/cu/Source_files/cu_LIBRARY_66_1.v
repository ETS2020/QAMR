...
module FAU ( 
  ...
  nand3  g27(.a(x05), .b(new_n35_), .c(new_n26_), .O(new_n53_));
  ...
  nand3  g32(.a(new_n42_), .b(new_n37_), .c(x02), .O(new_n58_));
  oai21  g33(.a(new_n57_), .b(new_n53_), .c(new_n58_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(x00), .O(new_n60_));
  oai22  g35(.a(x11), .b(new_n26_), .c(x08), .d(x00), .O(new_n61_));
  ...
  nand4  g39(.a(new_n42_), .b(new_n37_), .c(x02), .d(new_n26_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n42_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n34_), .O(z07));
  nand2  g45(.a(x05), .b(new_n35_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n56_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n34_), .c(x04), .d(new_n33_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  inv1   g50(.a(x06), .O(new_n76_));
  nor3   g51(.a(z04), .b(new_n42_), .c(new_n76_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n79_));
