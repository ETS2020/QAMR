...
module FAU ( 
  ...
  nand3  g24(.a(new_n28_), .b(x01), .c(new_n42_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n35_), .O(z04));
  nor2   g26(.a(new_n27_), .b(x13), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n53_));
  ...
  nand3  g45(.a(new_n52_), .b(new_n31_), .c(x02), .O(new_n71_));
