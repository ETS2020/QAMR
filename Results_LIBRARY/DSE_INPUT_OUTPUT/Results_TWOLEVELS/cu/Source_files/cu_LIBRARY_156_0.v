...
module FAU ( 
  ...
  nand4  g10(.a(x12), .b(new_n28_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nor2   g15(.a(x12), .b(x05), .O(new_n41_));
  ...
  nand4  g25(.a(new_n50_), .b(new_n45_), .c(x05), .d(new_n27_), .O(new_n51_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n29_), .c(new_n56_), .d(x05), .O(new_n64_));
  nand4  g39(.a(new_n45_), .b(x12), .c(new_n28_), .d(x02), .O(new_n65_));
  ...
  nand4  g43(.a(new_n45_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n42_), .O(z07));
  nand2  g45(.a(x05), .b(new_n31_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n29_), .O(new_n72_));
  ...
  nor3   g51(.a(new_n41_), .b(new_n45_), .c(new_n76_), .O(z09));
  oai21  g52(.a(new_n29_), .b(x05), .c(new_n71_), .O(new_n78_));
