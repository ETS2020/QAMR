...
module FAU ( 
  ...
  nand4  g18(.a(new_n26_), .b(new_n27_), .c(new_n43_), .d(x00), .O(new_n44_));
  ...
  aoi21  g26(.a(new_n51_), .b(new_n34_), .c(x02), .O(z04));
  ...
  aoi21  g35(.a(new_n60_), .b(x02), .c(new_n34_), .O(z09));
  nand2  g36(.a(new_n31_), .b(x02), .O(new_n62_));
  oai21  g37(.a(x13), .b(x02), .c(new_n62_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x06), .c(new_n26_), .O(new_n64_));
