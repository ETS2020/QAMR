...
module FAU ( 
  ...
  nand4  g11(.a(new_n30_), .b(new_n26_), .c(x04), .d(x02), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(new_n36_), .c(x03), .O(z01));
  inv1   g13(.a(x00), .O(new_n39_));
  inv1   g14(.a(x01), .O(new_n40_));
  nand3  g15(.a(new_n34_), .b(new_n40_), .c(new_n39_), .O(new_n41_));
  inv1   g16(.a(x03), .O(new_n42_));
  nand4  g17(.a(new_n30_), .b(x05), .c(new_n35_), .d(new_n42_), .O(new_n43_));
  oai21  g18(.a(new_n43_), .b(new_n41_), .c(new_n27_), .O(z02));
  nand4  g19(.a(new_n42_), .b(new_n34_), .c(new_n40_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  nand4  g23(.a(new_n42_), .b(new_n34_), .c(x01), .d(new_n39_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n40_), .c(new_n39_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n35_), .d(new_n42_), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n30_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n65_));
  nand3  g40(.a(new_n30_), .b(new_n26_), .c(x02), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n42_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z06));
  nand4  g44(.a(new_n30_), .b(x05), .c(new_n35_), .d(new_n42_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g46(.a(x13), .b(new_n57_), .c(x05), .d(new_n34_), .O(new_n72_));
