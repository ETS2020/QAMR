...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(new_n44_), .c(x05), .d(new_n30_), .O(new_n47_));
  ...
  oai21  g27(.a(new_n52_), .b(new_n45_), .c(new_n26_), .O(z05));
  ...
  nand4  g36(.a(new_n61_), .b(new_n54_), .c(x05), .d(new_n28_), .O(new_n62_));
  nand3  g37(.a(new_n44_), .b(new_n31_), .c(x02), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n62_), .c(x07), .O(new_n64_));
  inv1   g39(.a(x08), .O(new_n65_));
  nand4  g40(.a(new_n44_), .b(new_n65_), .c(new_n31_), .d(x02), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n64_), .c(x04), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x03), .O(z06));
  nand4  g44(.a(x13), .b(new_n54_), .c(x05), .d(new_n28_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n63_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n26_), .c(x04), .d(new_n35_), .O(new_n72_));
  ...
  nand4  g51(.a(new_n76_), .b(new_n26_), .c(x06), .d(new_n35_), .O(new_n77_));
