...
module FAU ( 
  ...
  nand2  g14(.a(new_n27_), .b(x03), .O(new_n40_));
  ...
  nand4  g21(.a(new_n26_), .b(new_n31_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n28_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n44_), .c(x05), .d(new_n28_), .O(new_n53_));
  ...
  nand3  g41(.a(new_n27_), .b(x01), .c(new_n41_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n44_), .b(new_n32_), .c(new_n26_), .d(x02), .O(new_n70_));
  oai21  g45(.a(new_n69_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(x04), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n40_), .O(z06));
  nand4  g48(.a(new_n44_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n76_));
  nand3  g51(.a(new_n44_), .b(new_n32_), .c(x02), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n26_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n40_), .O(z08));
  nand2  g55(.a(x13), .b(x06), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n40_), .O(z09));
