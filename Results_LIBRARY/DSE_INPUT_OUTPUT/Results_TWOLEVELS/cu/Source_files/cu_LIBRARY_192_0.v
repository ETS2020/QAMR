...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n45_), .c(x05), .d(new_n34_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n30_), .b(x01), .c(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n45_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n40_), .O(z04));
  nor3   g29(.a(x02), .b(new_n46_), .c(new_n51_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n56_));
  ...
  nand4  g42(.a(new_n45_), .b(x06), .c(new_n27_), .d(x02), .O(new_n68_));
  ...
  nand4  g46(.a(new_n45_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n72_));
  ...
  oai21  g52(.a(new_n45_), .b(new_n39_), .c(new_n40_), .O(z09));
  nand3  g53(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n79_));
