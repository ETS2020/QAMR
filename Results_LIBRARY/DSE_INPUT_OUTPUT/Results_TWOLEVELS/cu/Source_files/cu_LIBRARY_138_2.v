...
module FAU ( 
  ...
  nand3  g19(.a(new_n29_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n27_), .O(z02));
  nand4  g23(.a(new_n36_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  nand4  g27(.a(new_n36_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x07), .c(x05), .d(new_n31_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z04));
  nor2   g31(.a(x03), .b(x02), .O(new_n57_));
  nor2   g32(.a(x13), .b(new_n26_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n57_), .c(new_n37_), .d(x00), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(x07), .c(new_n44_), .O(z05));
  nand4  g35(.a(new_n27_), .b(new_n46_), .c(new_n32_), .d(x02), .O(new_n61_));
  ...
  nand4  g42(.a(new_n67_), .b(x13), .c(new_n62_), .d(new_n26_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n29_), .d(new_n44_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n61_), .O(new_n71_));
  ...
  nand4  g51(.a(x13), .b(new_n62_), .c(x05), .d(new_n29_), .O(new_n77_));
  nand3  g52(.a(new_n46_), .b(new_n32_), .c(x02), .O(new_n78_));
