...
module FAU ( 
  ...
  nand4  g50(.a(new_n27_), .b(new_n45_), .c(new_n32_), .d(x02), .O(new_n76_));
  ...
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n81_));
  nor2   g56(.a(new_n81_), .b(x02), .O(z07));
  nand4  g57(.a(x13), .b(new_n61_), .c(x05), .d(new_n29_), .O(new_n83_));
  nand3  g58(.a(new_n45_), .b(new_n32_), .c(x02), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n86_));
  inv1   g61(.a(new_n86_), .O(z08));
  oai21  g62(.a(new_n45_), .b(new_n26_), .c(new_n27_), .O(z09));
  inv1   g63(.a(new_n33_), .O(new_n89_));
  nand3  g64(.a(new_n89_), .b(x06), .c(new_n36_), .O(new_n90_));
