...
module FAU ( 
  ...
  aoi21  g00(.a(x12), .b(x01), .c(x03), .O(new_n26_));
  ...
  nand2  g09(.a(x12), .b(x01), .O(new_n35_));
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n35_), .O(z02));
  nand4  g21(.a(new_n34_), .b(new_n27_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x12), .O(new_n51_));
  nand4  g26(.a(new_n34_), .b(new_n27_), .c(x01), .d(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n34_), .b(new_n27_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z05));
  inv1   g34(.a(x07), .O(new_n60_));
  nor2   g35(.a(x11), .b(new_n42_), .O(new_n61_));
  nor3   g36(.a(x12), .b(x09), .c(x01), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(x00), .O(new_n63_));
  nor2   g38(.a(x10), .b(new_n42_), .O(new_n64_));
  nor3   g39(.a(x12), .b(x08), .c(x01), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n41_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n44_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(x05), .d(new_n27_), .O(new_n68_));
  nand4  g43(.a(new_n35_), .b(new_n44_), .c(new_n28_), .d(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(x12), .b(x01), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n51_), .c(x05), .d(new_n27_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n69_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n34_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  nand3  g54(.a(new_n35_), .b(x13), .c(x06), .O(new_n80_));
