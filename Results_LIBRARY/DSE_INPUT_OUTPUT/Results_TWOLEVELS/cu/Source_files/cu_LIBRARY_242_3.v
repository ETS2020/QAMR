...
module FAU ( 
  ...
  oai21  g09(.a(x12), .b(new_n26_), .c(new_n34_), .O(z00));
  ...
  nand2  g14(.a(x12), .b(x03), .O(new_n40_));
  ...
  nand3  g43(.a(new_n45_), .b(new_n31_), .c(x02), .O(new_n69_));
  oai21  g44(.a(new_n68_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n26_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n40_), .O(z06));
  nand4  g47(.a(new_n45_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n40_), .O(z07));
  nand4  g49(.a(x13), .b(new_n60_), .c(x05), .d(new_n27_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n69_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n26_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  nand3  g53(.a(new_n40_), .b(x13), .c(x06), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z09));
  nand3  g55(.a(new_n29_), .b(x06), .c(new_n26_), .O(new_n81_));
