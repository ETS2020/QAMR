...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n37_), .c(new_n43_), .d(new_n26_), .O(new_n45_));
  ...
  nand3  g27(.a(new_n35_), .b(x01), .c(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n54_));
  ...
  nand2  g37(.a(x08), .b(new_n47_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n26_), .c(new_n52_), .O(new_n64_));
  ...
  aoi21  g45(.a(x10), .b(new_n47_), .c(x13), .O(new_n71_));
