...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n42_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n33_), .c(new_n41_), .d(x00), .O(new_n49_));
  ...
  nand4  g29(.a(new_n42_), .b(new_n33_), .c(x01), .d(x00), .O(new_n55_));
  ...
  nand3  g45(.a(new_n70_), .b(new_n37_), .c(x02), .O(new_n71_));
