...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n42_), .c(x05), .d(new_n26_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  aoi21  g25(.a(new_n44_), .b(x01), .c(new_n41_), .O(z05));
  nand4  g26(.a(new_n33_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n52_));
  ...
  nand2  g39(.a(x01), .b(x00), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n42_), .c(x05), .d(new_n26_), .O(new_n66_));
  nor3   g41(.a(new_n66_), .b(x03), .c(x02), .O(new_n67_));
  or2    g42(.a(new_n67_), .b(z05), .O(z07));
  nand4  g43(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand3  g44(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n70_));
