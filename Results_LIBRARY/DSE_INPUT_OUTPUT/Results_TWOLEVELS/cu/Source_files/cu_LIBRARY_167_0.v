...
module FAU ( 
  ...
  nand4  g18(.a(new_n36_), .b(new_n32_), .c(x01), .d(new_n44_), .O(new_n45_));
  inv1   g19(.a(new_n45_), .O(new_n46_));
  nand4  g20(.a(new_n46_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n47_));
  inv1   g21(.a(new_n47_), .O(z04));
  inv1   g22(.a(x01), .O(new_n49_));
  nor3   g23(.a(x02), .b(new_n49_), .c(new_n44_), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n51_));
  nor2   g25(.a(new_n51_), .b(x13), .O(z05));
  inv1   g26(.a(x07), .O(new_n53_));
  inv1   g27(.a(x12), .O(new_n54_));
  nor2   g28(.a(x09), .b(x01), .O(new_n55_));
  nor2   g29(.a(x11), .b(new_n49_), .O(new_n56_));
  oai21  g30(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  nor2   g31(.a(x08), .b(x01), .O(new_n58_));
  nor2   g32(.a(x10), .b(new_n49_), .O(new_n59_));
  oai21  g33(.a(new_n59_), .b(new_n58_), .c(new_n44_), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n57_), .c(new_n43_), .O(new_n61_));
  nand4  g35(.a(new_n61_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n62_));
  nand4  g36(.a(new_n43_), .b(new_n29_), .c(x02), .d(x01), .O(new_n63_));
  ...
  nand4  g40(.a(x05), .b(new_n28_), .c(new_n36_), .d(new_n32_), .O(new_n67_));
  aoi21  g41(.a(new_n67_), .b(x01), .c(x13), .O(z07));
  nand4  g42(.a(x13), .b(new_n54_), .c(x05), .d(new_n32_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n63_), .O(new_n70_));
  nand3  g44(.a(new_n70_), .b(x04), .c(new_n36_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n35_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n35_), .O(z09));
  nand3  g48(.a(new_n31_), .b(x06), .c(new_n36_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n35_), .O(z10));
  zero   g50(.O(z02));
endmodule
