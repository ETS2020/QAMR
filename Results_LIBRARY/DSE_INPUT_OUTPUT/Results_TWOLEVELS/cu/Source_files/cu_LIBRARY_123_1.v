...
module FAU ( 
  ...
  nand2  g24(.a(new_n36_), .b(new_n26_), .O(new_n50_));
  nand3  g25(.a(new_n45_), .b(x05), .c(new_n30_), .O(new_n51_));
  ...
  nand3  g33(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n59_));
  ...
  nand4  g40(.a(new_n45_), .b(new_n27_), .c(x02), .d(new_n32_), .O(new_n66_));
  ...
  oai21  g45(.a(new_n51_), .b(new_n50_), .c(new_n32_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  aoi21  g47(.a(new_n32_), .b(new_n70_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n72_), .O(z07));
  nand2  g50(.a(x05), .b(new_n26_), .O(new_n76_));
  nand2  g51(.a(x13), .b(new_n57_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n76_), .c(new_n59_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n34_), .c(x04), .d(new_n36_), .O(new_n79_));
  ...
  nand4  g58(.a(new_n83_), .b(new_n34_), .c(x06), .d(new_n36_), .O(new_n84_));
