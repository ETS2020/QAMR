...
module FAU ( 
  ...
  nand2  g18(.a(new_n35_), .b(new_n26_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n31_), .c(new_n43_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x05), .c(x13), .O(z02));
  nand4  g22(.a(new_n26_), .b(new_n31_), .c(new_n43_), .d(x00), .O(new_n48_));
  ...
  aoi21  g28(.a(new_n53_), .b(x05), .c(x13), .O(z04));
  ...
  nand4  g47(.a(new_n72_), .b(new_n58_), .c(x05), .d(x04), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n29_), .O(z08));
