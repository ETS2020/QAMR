...
module FAU ( 
  ...
  nor3   g25(.a(x02), .b(new_n42_), .c(new_n26_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n52_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n42_), .c(new_n26_), .O(new_n61_));
  ...
  nand4  g41(.a(new_n43_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n27_), .O(z07));
  ...
  nor3   g49(.a(z04), .b(new_n43_), .c(new_n74_), .O(z09));
