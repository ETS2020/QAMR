...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n74_, new_n77_, new_n78_, new_n79_, new_n81_, new_n83_, new_n84_;
  ...
  nor2   g09(.a(new_n27_), .b(x01), .O(new_n35_));
  nand3  g10(.a(new_n35_), .b(new_n28_), .c(x04), .O(new_n36_));
  ...
  nand3  g22(.a(new_n41_), .b(x05), .c(new_n30_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(new_n27_), .d(new_n47_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x05), .c(new_n42_), .O(z04));
  nand4  g26(.a(new_n49_), .b(new_n26_), .c(new_n27_), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x05), .c(new_n42_), .O(z05));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  inv1   g30(.a(x09), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(x05), .c(new_n42_), .O(new_n57_));
  ...
  nand3  g37(.a(new_n62_), .b(x05), .c(new_n42_), .O(new_n63_));
  ...
  nand4  g43(.a(new_n68_), .b(new_n55_), .c(new_n54_), .d(new_n27_), .O(new_n69_));
  nand3  g44(.a(new_n35_), .b(new_n41_), .c(new_n28_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n26_), .O(new_n72_));
  nor2   g47(.a(x05), .b(new_n42_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n72_), .O(z06));
  nor3   g50(.a(new_n48_), .b(x03), .c(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n77_));
  ...
  nor3   g56(.a(new_n73_), .b(new_n41_), .c(new_n81_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x06), .c(new_n26_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n74_), .O(z10));
endmodule
