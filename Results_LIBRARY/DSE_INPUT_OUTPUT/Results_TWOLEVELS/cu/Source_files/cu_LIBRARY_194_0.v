...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor2   g29(.a(x02), .b(new_n45_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n56_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(x04), .d(new_n26_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z06));
  nand4  g45(.a(new_n29_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand3  g47(.a(x04), .b(new_n26_), .c(new_n31_), .O(new_n73_));
  nand3  g48(.a(x13), .b(new_n59_), .c(x05), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(new_n73_), .c(new_n40_), .O(z08));
