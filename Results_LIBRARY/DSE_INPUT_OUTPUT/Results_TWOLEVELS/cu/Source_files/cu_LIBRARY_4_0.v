...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n27_), .c(new_n43_), .d(new_n42_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x08), .c(x05), .d(new_n29_), .O(new_n46_));
  ...
  aoi21  g26(.a(new_n51_), .b(x08), .c(x01), .O(z03));
  inv1   g27(.a(x13), .O(new_n53_));
  nand4  g28(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n42_), .O(new_n54_));
  ...
  nand4  g33(.a(new_n58_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n59_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n53_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n62_), .c(new_n61_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n34_), .b(new_n53_), .c(new_n30_), .d(x02), .O(new_n70_));
  ...
  aoi21  g48(.a(new_n49_), .b(new_n43_), .c(x13), .O(new_n74_));
  ...
  nand3  g52(.a(new_n53_), .b(new_n30_), .c(x02), .O(new_n78_));
  ...
  nor3   g57(.a(new_n26_), .b(new_n53_), .c(new_n82_), .O(z09));
  inv1   g58(.a(new_n31_), .O(new_n84_));
