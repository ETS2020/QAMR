...
module FAU ( 
  ...
  nand4  g29(.a(new_n35_), .b(new_n27_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n57_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n63_), .c(new_n45_), .O(new_n68_));
  ...
  aoi21  g48(.a(x06), .b(x01), .c(x13), .O(new_n74_));
  ...
  nand3  g56(.a(x13), .b(x06), .c(new_n46_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z09));
  oai21  g58(.a(new_n28_), .b(new_n27_), .c(new_n35_), .O(new_n84_));
  aoi21  g59(.a(new_n84_), .b(new_n46_), .c(new_n51_), .O(z10));
endmodule
