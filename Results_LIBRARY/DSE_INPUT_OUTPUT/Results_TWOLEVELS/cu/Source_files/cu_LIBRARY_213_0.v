...
module FAU ( 
  ...
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n59_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n65_));
  nand3  g40(.a(new_n59_), .b(new_n29_), .c(x02), .O(new_n66_));
  ...
  nor2   g44(.a(x07), .b(x01), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n42_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n32_), .O(new_n74_));
  ...
  nand4  g54(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n80_));
