...
module FAU ( 
  ...
  nand4  g18(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n43_), .O(new_n44_));
  ...
  aoi22  g34(.a(new_n59_), .b(new_n40_), .c(new_n58_), .d(x01), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n57_), .c(new_n27_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n62_));
  nand3  g37(.a(new_n27_), .b(new_n37_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n43_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n35_), .O(z06));
  nand4  g41(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n43_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand2  g43(.a(x05), .b(new_n34_), .O(new_n69_));
  nand3  g44(.a(x13), .b(new_n55_), .c(new_n26_), .O(new_n70_));
