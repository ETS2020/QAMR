...
module FAU ( 
  ...
  nand4  g19(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n44_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n37_), .O(z02));
  nand3  g21(.a(new_n34_), .b(new_n42_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n37_), .O(z03));
  nand3  g23(.a(new_n34_), .b(x01), .c(new_n41_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n45_), .c(new_n37_), .O(z04));
  nand3  g25(.a(new_n34_), .b(x01), .c(x00), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n37_), .O(z05));
  ...
  nand3  g37(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n44_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n37_), .O(z06));
  nand4  g41(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n44_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n37_), .O(z07));
  nand4  g43(.a(x13), .b(new_n54_), .c(x05), .d(new_n34_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n63_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n44_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n37_), .O(z08));
  nand2  g47(.a(new_n33_), .b(new_n44_), .O(new_n74_));
  aoi21  g48(.a(new_n74_), .b(new_n27_), .c(new_n26_), .O(z10));
  zero   g49(.O(z09));
endmodule
