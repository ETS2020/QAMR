...
module FAU ( 
  ...
  nand2  g08(.a(x10), .b(x06), .O(new_n34_));
  ...
  nand4  g17(.a(new_n34_), .b(new_n42_), .c(x05), .d(new_n31_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n35_), .c(new_n27_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z07));
  nand2  g21(.a(z07), .b(new_n41_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x00), .O(z02));
  inv1   g23(.a(x00), .O(new_n49_));
  nor2   g24(.a(new_n47_), .b(new_n49_), .O(z03));
  nand3  g25(.a(new_n27_), .b(x01), .c(new_n49_), .O(new_n51_));
  nand4  g26(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n35_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n34_), .O(z04));
  nor3   g28(.a(new_n45_), .b(new_n41_), .c(new_n49_), .O(z05));
  nand4  g29(.a(x05), .b(new_n27_), .c(new_n41_), .d(x00), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x09), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(x13), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(new_n59_));
  nand3  g34(.a(new_n42_), .b(new_n28_), .c(x02), .O(new_n60_));
  ...
  nand3  g39(.a(new_n64_), .b(new_n41_), .c(new_n49_), .O(new_n65_));
  ...
  nor2   g45(.a(x11), .b(new_n41_), .O(new_n71_));
  aoi21  g46(.a(x08), .b(new_n41_), .c(x00), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n70_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n69_), .c(new_n42_), .O(new_n74_));
  ...
  aoi21  g58(.a(new_n42_), .b(new_n70_), .c(new_n63_), .O(z09));
  oai21  g59(.a(new_n28_), .b(new_n27_), .c(new_n35_), .O(new_n85_));
  aoi21  g60(.a(new_n85_), .b(new_n70_), .c(new_n63_), .O(z10));
endmodule
