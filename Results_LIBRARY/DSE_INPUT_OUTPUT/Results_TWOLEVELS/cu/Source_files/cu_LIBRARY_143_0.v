...
module FAU ( 
  ...
  aoi21  g21(.a(new_n46_), .b(x11), .c(x01), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n36_), .c(new_n32_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x11), .c(x01), .O(z03));
  ...
  nand4  g29(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n55_));
  ...
  nand3  g35(.a(x11), .b(new_n60_), .c(new_n59_), .O(new_n61_));
  ...
  nand3  g43(.a(x11), .b(new_n68_), .c(new_n59_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n42_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n43_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n73_));
  nand4  g48(.a(new_n35_), .b(new_n43_), .c(new_n29_), .d(x02), .O(new_n74_));
  ...
  nand3  g52(.a(new_n45_), .b(new_n36_), .c(new_n32_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n35_), .O(z07));
  ...
  nand3  g60(.a(new_n31_), .b(x06), .c(new_n36_), .O(new_n86_));
