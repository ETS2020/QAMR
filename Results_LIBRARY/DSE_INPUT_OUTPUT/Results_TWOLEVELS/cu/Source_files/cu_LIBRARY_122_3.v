...
module FAU ( 
  ...
  oai21  g02(.a(x11), .b(new_n27_), .c(x02), .O(new_n28_));
  ...
  nand4  g10(.a(new_n35_), .b(new_n31_), .c(x04), .d(x02), .O(new_n36_));
  ...
  nand2  g21(.a(x11), .b(x02), .O(new_n47_));
  ...
  nor3   g26(.a(x02), .b(new_n42_), .c(new_n48_), .O(new_n52_));
  ...
  nand3  g39(.a(new_n41_), .b(new_n31_), .c(x02), .O(new_n65_));
  oai21  g40(.a(new_n64_), .b(x02), .c(new_n65_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n26_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n47_), .O(z06));
  nand4  g43(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n47_), .O(z07));
  nor2   g45(.a(new_n27_), .b(x03), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(new_n41_), .c(new_n31_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n35_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(x02), .O(new_n74_));
  nor2   g49(.a(new_n41_), .b(x12), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n71_), .c(x05), .d(new_n30_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n74_), .O(z08));
  nand3  g52(.a(new_n47_), .b(x13), .c(x06), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x06), .c(new_n26_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n47_), .O(z10));
endmodule
