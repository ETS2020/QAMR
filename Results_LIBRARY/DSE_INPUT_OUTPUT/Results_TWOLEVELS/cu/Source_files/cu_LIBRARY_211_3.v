...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n84_, new_n86_;
  aoi21  g00(.a(x08), .b(x06), .c(x03), .O(new_n26_));
  ...
  nand2  g08(.a(x08), .b(x06), .O(new_n34_));
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n31_), .d(new_n35_), .O(new_n45_));
  ...
  nand4  g25(.a(new_n34_), .b(new_n44_), .c(x05), .d(new_n31_), .O(new_n51_));
  nor3   g26(.a(new_n51_), .b(x03), .c(x02), .O(z07));
  nand2  g27(.a(z07), .b(x01), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n41_), .O(z05));
  nand4  g29(.a(x05), .b(new_n27_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x11), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(x13), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(new_n59_));
  nand3  g34(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n60_));
  oai21  g35(.a(new_n59_), .b(new_n55_), .c(new_n60_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n34_), .O(new_n62_));
  inv1   g37(.a(x06), .O(new_n63_));
  inv1   g38(.a(x09), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n42_), .c(x00), .O(new_n65_));
  inv1   g40(.a(x10), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x01), .c(new_n41_), .O(new_n67_));
  ...
  aoi21  g48(.a(new_n73_), .b(new_n69_), .c(new_n44_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x02), .c(new_n62_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n35_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z06));
  nand2  g53(.a(x05), .b(new_n27_), .O(new_n79_));
  nand2  g54(.a(x13), .b(new_n58_), .O(new_n80_));
  oai21  g55(.a(new_n80_), .b(new_n79_), .c(new_n60_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z08));
  nand3  g58(.a(x13), .b(new_n70_), .c(x06), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z09));
  oai21  g60(.a(new_n28_), .b(new_n27_), .c(new_n35_), .O(new_n86_));
  aoi21  g61(.a(new_n86_), .b(new_n70_), .c(new_n63_), .O(z10));
endmodule
