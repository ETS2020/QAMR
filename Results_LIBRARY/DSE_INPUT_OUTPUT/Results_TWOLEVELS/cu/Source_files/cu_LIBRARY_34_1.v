...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n26_), .c(new_n36_), .d(new_n30_), .O(new_n43_));
  ...
  nand4  g28(.a(x05), .b(x04), .c(new_n36_), .d(new_n30_), .O(new_n55_));
  ...
  aoi21  g39(.a(new_n65_), .b(new_n63_), .c(new_n45_), .O(new_n66_));
  nand4  g40(.a(new_n66_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n67_));
  nand3  g41(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n68_));
  ...
  aoi21  g45(.a(x01), .b(new_n51_), .c(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n73_));
  oai21  g47(.a(new_n73_), .b(x02), .c(new_n34_), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n68_), .O(new_n76_));
  nand3  g50(.a(new_n76_), .b(x04), .c(new_n36_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n34_), .O(z08));
  inv1   g52(.a(x06), .O(new_n79_));
  nor3   g53(.a(new_n33_), .b(new_n45_), .c(new_n79_), .O(z09));
  nand4  g54(.a(new_n34_), .b(new_n29_), .c(x06), .d(new_n36_), .O(new_n81_));
