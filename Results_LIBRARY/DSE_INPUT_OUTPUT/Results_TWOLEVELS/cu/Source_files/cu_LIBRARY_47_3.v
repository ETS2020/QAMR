...
module FAU ( 
  ...
  nand3  g46(.a(new_n49_), .b(new_n27_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  nand3  g50(.a(new_n32_), .b(x13), .c(x06), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z09));
  nand3  g52(.a(new_n29_), .b(x06), .c(new_n34_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n32_), .O(z10));
endmodule
