// Benchmark "FAU" written by ABC on Wed Aug 19 17:19:20 2020
...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n41_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
  ...
  nor2   g18(.a(new_n27_), .b(x13), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x02), .O(z07));
  nand2  g21(.a(z07), .b(new_n43_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x00), .O(z02));
  nand3  g23(.a(new_n33_), .b(new_n43_), .c(x00), .O(new_n49_));
  inv1   g24(.a(x13), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n49_), .c(new_n37_), .O(z03));
  inv1   g27(.a(x00), .O(new_n53_));
  nand3  g28(.a(new_n33_), .b(x01), .c(new_n53_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n51_), .c(new_n37_), .O(z04));
  nand3  g30(.a(new_n33_), .b(x01), .c(x00), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n51_), .c(new_n37_), .O(z05));
  ...
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(new_n53_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n50_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(x05), .d(new_n33_), .O(new_n66_));
  nand3  g41(.a(new_n50_), .b(new_n30_), .c(x02), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(x07), .O(new_n68_));
  nand4  g43(.a(new_n50_), .b(x09), .c(new_n30_), .d(x02), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(new_n68_), .c(x04), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x03), .O(z06));
  nand3  g47(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n73_));
  ...
  nor3   g53(.a(new_n27_), .b(new_n50_), .c(new_n78_), .O(z09));
  nand4  g54(.a(new_n32_), .b(new_n37_), .c(x06), .d(new_n36_), .O(new_n80_));
