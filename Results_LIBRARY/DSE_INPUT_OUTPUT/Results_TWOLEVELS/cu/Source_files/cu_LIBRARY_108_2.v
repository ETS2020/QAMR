...
module FAU ( 
  ...
  nand3  g33(.a(x10), .b(new_n58_), .c(new_n42_), .O(new_n59_));
  inv1   g34(.a(x10), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n26_), .c(x01), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n59_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n51_), .O(new_n63_));
  nand2  g38(.a(x11), .b(x01), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(x00), .O(new_n65_));
  nand2  g40(.a(new_n58_), .b(new_n42_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  inv1   g42(.a(x11), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x10), .c(x01), .d(x00), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  aoi21  g45(.a(new_n67_), .b(new_n26_), .c(new_n70_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n63_), .c(new_n43_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n73_));
  nand4  g48(.a(new_n34_), .b(new_n43_), .c(new_n37_), .d(x02), .O(new_n74_));
  ...
  nand3  g52(.a(new_n27_), .b(new_n42_), .c(new_n51_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(new_n33_), .c(new_n35_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n34_), .O(z07));
  nand4  g57(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n74_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n33_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n34_), .O(z08));
  inv1   g61(.a(x06), .O(new_n87_));
  nor3   g62(.a(new_n27_), .b(new_n43_), .c(new_n87_), .O(z09));
  nand2  g63(.a(x05), .b(x02), .O(new_n89_));
  nand4  g64(.a(new_n89_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n90_));
