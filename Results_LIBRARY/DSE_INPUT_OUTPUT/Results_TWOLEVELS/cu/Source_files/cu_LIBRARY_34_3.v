...
module FAU ( 
  ...
  oai21  g34(.a(new_n60_), .b(new_n56_), .c(new_n44_), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(x00), .O(new_n62_));
  inv1   g36(.a(x08), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(new_n44_), .c(new_n49_), .O(new_n64_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n34_), .c(new_n30_), .d(new_n49_), .O(new_n76_));
  oai21  g50(.a(new_n75_), .b(new_n49_), .c(new_n76_), .O(z07));
  ...
  nand4  g57(.a(new_n32_), .b(new_n29_), .c(x06), .d(new_n34_), .O(new_n84_));
