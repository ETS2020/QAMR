...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n34_), .c(new_n43_), .d(new_n42_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n48_));
  ...
  nor2   g27(.a(x13), .b(x12), .O(new_n53_));
  ...
  aoi21  g31(.a(new_n56_), .b(new_n26_), .c(x02), .O(z04));
  nand3  g32(.a(new_n55_), .b(new_n52_), .c(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(new_n26_), .c(x02), .O(z05));
  ...
  nand4  g43(.a(new_n68_), .b(new_n26_), .c(new_n60_), .d(x05), .O(new_n69_));
  nand3  g44(.a(new_n61_), .b(new_n39_), .c(x02), .O(new_n70_));
  ...
  nand4  g48(.a(new_n53_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n26_), .c(x05), .d(new_n34_), .O(new_n76_));
  ...
  oai21  g55(.a(new_n26_), .b(x02), .c(new_n80_), .O(z09));
  aoi21  g56(.a(x06), .b(new_n35_), .c(x12), .O(new_n82_));
  nand3  g57(.a(x06), .b(new_n39_), .c(new_n35_), .O(new_n83_));
