...
module FAU ( 
  ...
  nand3  g41(.a(new_n46_), .b(new_n29_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n31_), .c(x04), .d(new_n36_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nand4  g45(.a(new_n46_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand3  g47(.a(x13), .b(x05), .c(new_n28_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n67_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n31_), .c(x04), .d(new_n36_), .O(new_n75_));
