...
module FAU ( 
  ...
  aoi21  g46(.a(new_n51_), .b(new_n49_), .c(x01), .O(new_n72_));
  aoi21  g47(.a(new_n32_), .b(new_n54_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n74_));
  oai22  g49(.a(new_n74_), .b(x02), .c(new_n72_), .d(x00), .O(z07));
