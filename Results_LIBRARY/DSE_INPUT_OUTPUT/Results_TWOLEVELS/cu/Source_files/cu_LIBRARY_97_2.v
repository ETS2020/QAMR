...
module FAU ( 
  ...
  nand4  g20(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n46_), .O(new_n47_));
  inv1   g21(.a(new_n47_), .O(new_n48_));
  nand4  g22(.a(new_n48_), .b(new_n45_), .c(x05), .d(new_n26_), .O(new_n49_));
  ...
  nand4  g27(.a(new_n33_), .b(new_n45_), .c(new_n27_), .d(x02), .O(new_n54_));
