...
module FAU ( 
  ...
  oai21  g02(.a(x06), .b(new_n27_), .c(x04), .O(new_n28_));
  ...
  nand2  g12(.a(x06), .b(x04), .O(new_n38_));
  ...
  oai21  g26(.a(new_n51_), .b(new_n43_), .c(new_n38_), .O(z05));
  ...
  nand3  g37(.a(new_n42_), .b(new_n31_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z06));
  nand4  g41(.a(new_n42_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n54_), .c(x05), .d(new_n27_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n63_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n35_), .c(x04), .d(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z08));
  nand3  g47(.a(x13), .b(x06), .c(new_n30_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z09));
  oai21  g49(.a(new_n31_), .b(new_n27_), .c(new_n26_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n30_), .c(new_n35_), .O(z10));
endmodule
