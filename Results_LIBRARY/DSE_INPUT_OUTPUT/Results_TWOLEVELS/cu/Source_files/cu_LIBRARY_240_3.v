...
module FAU ( 
  ...
  nand2  g22(.a(x13), .b(x03), .O(new_n48_));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n30_), .b(x01), .c(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  ...
  nand4  g39(.a(new_n42_), .b(new_n31_), .c(new_n26_), .d(x02), .O(new_n65_));
  ...
  nand4  g43(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n48_), .O(z07));
  nand4  g45(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand3  g46(.a(new_n42_), .b(new_n31_), .c(x02), .O(new_n72_));
  ...
  aoi21  g51(.a(new_n76_), .b(new_n26_), .c(new_n42_), .O(z09));
