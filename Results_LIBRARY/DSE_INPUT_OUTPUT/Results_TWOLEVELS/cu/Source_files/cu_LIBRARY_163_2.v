...
module FAU ( 
  ...
  nand4  g27(.a(new_n27_), .b(new_n48_), .c(new_n37_), .d(x02), .O(new_n54_));
  ...
  aoi21  g40(.a(new_n26_), .b(x00), .c(x13), .O(new_n67_));
  ...
  nor3   g48(.a(new_n28_), .b(new_n48_), .c(new_n74_), .O(z09));
  nand2  g49(.a(x05), .b(x02), .O(new_n76_));
  nand3  g50(.a(new_n76_), .b(x06), .c(new_n34_), .O(new_n77_));
