...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(x05), .c(new_n33_), .d(new_n37_), .O(new_n46_));
  ...
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n37_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n54_));
  ...
  nand3  g46(.a(new_n26_), .b(new_n30_), .c(x02), .O(new_n72_));
  ...
  nand4  g50(.a(new_n26_), .b(x05), .c(new_n33_), .d(new_n37_), .O(new_n76_));
  oai21  g51(.a(new_n76_), .b(x02), .c(new_n36_), .O(z07));
  nand2  g52(.a(x05), .b(new_n29_), .O(new_n78_));
  inv1   g53(.a(x12), .O(new_n79_));
  nand3  g54(.a(x13), .b(new_n79_), .c(x06), .O(new_n80_));
  oai21  g55(.a(new_n80_), .b(new_n78_), .c(new_n72_), .O(new_n81_));
