...
module FAU ( 
  ...
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n26_), .d(new_n55_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x05), .c(new_n35_), .O(new_n65_));
  nand3  g40(.a(new_n42_), .b(new_n37_), .c(x02), .O(new_n66_));
  ...
  inv1   g44(.a(new_n45_), .O(z07));
  nand4  g45(.a(x13), .b(new_n26_), .c(x05), .d(new_n35_), .O(new_n71_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n78_));
