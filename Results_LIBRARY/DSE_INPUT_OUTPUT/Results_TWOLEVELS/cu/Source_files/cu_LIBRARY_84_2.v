...
module FAU ( 
  ...
  nand3  g12(.a(x05), .b(new_n37_), .c(new_n36_), .O(new_n38_));
  ...
  nand4  g18(.a(new_n43_), .b(new_n37_), .c(new_n35_), .d(new_n36_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x13), .c(new_n30_), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n35_), .b(new_n36_), .c(new_n26_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n46_), .c(x05), .d(new_n37_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nor2   g25(.a(x02), .b(x00), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n46_), .c(new_n37_), .d(new_n35_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x05), .c(new_n26_), .O(z04));
  inv1   g28(.a(x00), .O(new_n54_));
  nor3   g29(.a(x02), .b(new_n26_), .c(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n37_), .d(new_n35_), .O(new_n56_));
  ...
  nand3  g41(.a(new_n66_), .b(x05), .c(new_n26_), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n46_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(new_n58_), .d(new_n36_), .O(new_n73_));
  nand3  g48(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n35_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n28_), .O(z06));
  oai21  g52(.a(new_n26_), .b(x00), .c(new_n30_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n46_), .c(new_n37_), .d(new_n35_), .O(new_n79_));
  oai21  g54(.a(new_n79_), .b(x02), .c(new_n28_), .O(z07));
  nand4  g55(.a(x13), .b(new_n59_), .c(x05), .d(new_n36_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n74_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n35_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n28_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n27_), .b(new_n46_), .c(new_n85_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n87_));
  nand3  g62(.a(new_n87_), .b(x06), .c(new_n35_), .O(new_n88_));
  nand2  g63(.a(new_n88_), .b(new_n28_), .O(z10));
endmodule
