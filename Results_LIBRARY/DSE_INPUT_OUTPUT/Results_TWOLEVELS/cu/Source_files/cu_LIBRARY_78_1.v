...
module FAU ( 
  ...
  nand2  g21(.a(x06), .b(new_n28_), .O(new_n47_));
  inv1   g22(.a(x00), .O(new_n48_));
  nand3  g23(.a(new_n27_), .b(x01), .c(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n50_));
  ...
  nand2  g50(.a(new_n26_), .b(new_n27_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(x05), .c(new_n35_), .O(z10));
endmodule
