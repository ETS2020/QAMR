...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n31_), .c(new_n42_), .d(new_n41_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n27_), .c(x03), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n31_), .c(new_n42_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n27_), .c(x03), .O(z03));
  nand4  g24(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n41_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n27_), .c(x05), .d(new_n28_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n45_), .b(new_n31_), .c(x01), .d(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n27_), .c(x03), .O(z05));
  ...
  nand3  g40(.a(new_n43_), .b(new_n32_), .c(x02), .O(new_n66_));
  ...
  nor2   g44(.a(new_n27_), .b(new_n42_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n41_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n28_), .d(new_n31_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n27_), .c(x03), .O(z07));
  ...
  nand3  g52(.a(x13), .b(x06), .c(x03), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z09));
  nor2   g54(.a(new_n27_), .b(x03), .O(z10));
endmodule
