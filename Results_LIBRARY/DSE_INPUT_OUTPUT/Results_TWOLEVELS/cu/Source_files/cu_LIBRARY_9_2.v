...
module FAU ( 
  ...
  nand4  g20(.a(new_n33_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n45_), .b(x06), .c(x05), .d(new_n28_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n33_), .c(new_n35_), .d(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x06), .c(new_n26_), .O(z04));
  nand4  g29(.a(new_n52_), .b(new_n33_), .c(new_n35_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x06), .c(new_n26_), .O(z05));
  ...
  oai21  g53(.a(new_n45_), .b(new_n71_), .c(new_n34_), .O(z09));
