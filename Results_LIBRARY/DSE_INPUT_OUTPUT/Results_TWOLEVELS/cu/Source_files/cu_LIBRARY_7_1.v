...
module FAU ( 
  ...
  nor2   g22(.a(x13), .b(new_n28_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n27_), .c(new_n26_), .O(new_n49_));
  ...
  nor3   g30(.a(x02), .b(new_n46_), .c(new_n51_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n57_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n34_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand2  g43(.a(new_n37_), .b(x02), .O(new_n69_));
  ...
  nand3  g47(.a(new_n48_), .b(new_n27_), .c(new_n26_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand3  g49(.a(x13), .b(new_n60_), .c(new_n30_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n69_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n26_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n41_), .O(z08));
  inv1   g53(.a(x06), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(x05), .c(new_n34_), .O(z09));
  inv1   g55(.a(new_n37_), .O(new_n81_));
  oai21  g56(.a(new_n28_), .b(x02), .c(new_n81_), .O(new_n82_));
