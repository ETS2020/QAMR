...
module FAU ( 
  ...
  nand4  g27(.a(new_n45_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n27_), .O(z04));
  nor3   g29(.a(x02), .b(new_n46_), .c(new_n51_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n56_));
  ...
  nand3  g43(.a(new_n68_), .b(x05), .c(x01), .O(new_n69_));
  ...
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(new_n58_), .d(new_n35_), .O(new_n73_));
  nand3  g48(.a(new_n45_), .b(new_n29_), .c(x02), .O(new_n74_));
  ...
  nand4  g52(.a(new_n45_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g54(.a(x13), .b(new_n59_), .c(x05), .d(new_n35_), .O(new_n80_));
  ...
  nor3   g59(.a(new_n26_), .b(new_n45_), .c(new_n84_), .O(z09));
