...
module FAU ( 
  ...
  nand4  g43(.a(new_n45_), .b(new_n30_), .c(new_n26_), .d(x02), .O(new_n69_));
  ...
  nand3  g53(.a(x13), .b(x06), .c(x05), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z09));
  nand4  g55(.a(x06), .b(x05), .c(new_n34_), .d(new_n35_), .O(new_n81_));
