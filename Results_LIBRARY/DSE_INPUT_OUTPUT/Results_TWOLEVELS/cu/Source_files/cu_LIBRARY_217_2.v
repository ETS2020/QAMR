...
module FAU ( 
  ...
  nand2  g15(.a(new_n27_), .b(x03), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n40_), .O(z01));
  inv1   g17(.a(x00), .O(new_n43_));
  inv1   g18(.a(x01), .O(new_n44_));
  nand3  g19(.a(new_n31_), .b(new_n44_), .c(new_n43_), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n41_), .O(z02));
  nand3  g23(.a(new_n31_), .b(new_n44_), .c(x00), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n47_), .c(new_n41_), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n43_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n46_), .c(x05), .d(new_n28_), .O(new_n53_));
  ...
  nand3  g41(.a(new_n46_), .b(new_n32_), .c(x02), .O(new_n67_));
  ...
  nand4  g45(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n71_));
