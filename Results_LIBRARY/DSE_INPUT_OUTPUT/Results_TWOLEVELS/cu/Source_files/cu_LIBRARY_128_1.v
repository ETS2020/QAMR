...
module FAU ( 
  ...
  nand3  g34(.a(new_n59_), .b(x01), .c(new_n43_), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n58_), .c(new_n26_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n62_));
  nand3  g37(.a(new_n26_), .b(new_n30_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n37_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n36_), .O(z06));
  nand4  g41(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n36_), .O(z07));
  nand4  g43(.a(x13), .b(new_n55_), .c(x05), .d(new_n33_), .O(new_n69_));
  ...
  aoi21  g48(.a(x08), .b(new_n73_), .c(new_n26_), .O(z09));
  nand4  g49(.a(new_n32_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n75_));
