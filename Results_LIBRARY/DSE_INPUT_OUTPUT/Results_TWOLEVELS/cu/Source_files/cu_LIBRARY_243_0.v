...
module FAU ( 
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(x12), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(x05), .d(new_n28_), .O(new_n68_));
  inv1   g43(.a(x13), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x12), .c(new_n29_), .d(x02), .O(new_n70_));
  ...
  nor2   g49(.a(new_n74_), .b(new_n29_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n32_), .c(new_n36_), .d(new_n28_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(x12), .c(x13), .O(z07));
  nand4  g52(.a(x13), .b(new_n74_), .c(x05), .d(new_n28_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n70_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n36_), .O(new_n80_));
