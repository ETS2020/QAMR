...
module FAU ( 
  ...
  nand3  g28(.a(new_n50_), .b(new_n29_), .c(new_n37_), .O(new_n54_));
  ...
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n59_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n58_), .c(x05), .d(new_n33_), .O(new_n73_));
  nand3  g48(.a(new_n59_), .b(new_n30_), .c(x02), .O(new_n74_));
  ...
  nand3  g52(.a(x07), .b(new_n44_), .c(new_n43_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(new_n37_), .c(new_n33_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n36_), .O(z07));
  nand4  g57(.a(x13), .b(new_n58_), .c(x05), .d(new_n33_), .O(new_n83_));
  ...
  nand2  g62(.a(new_n87_), .b(new_n36_), .O(z09));
  nand4  g63(.a(new_n32_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n89_));
