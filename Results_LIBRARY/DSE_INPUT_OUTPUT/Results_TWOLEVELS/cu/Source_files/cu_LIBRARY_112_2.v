...
module FAU ( 
  ...
  oai21  g05(.a(new_n30_), .b(x02), .c(new_n26_), .O(new_n31_));
  ...
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n26_), .d(new_n40_), .O(new_n47_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n47_), .c(new_n28_), .O(z04));
  nor3   g26(.a(x02), .b(new_n44_), .c(new_n49_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n26_), .d(new_n40_), .O(new_n53_));
  ...
  nand4  g38(.a(new_n46_), .b(x11), .c(new_n30_), .d(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n40_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(x11), .c(new_n26_), .O(z06));
  nand4  g42(.a(new_n46_), .b(x05), .c(new_n26_), .d(new_n40_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n56_), .c(x05), .d(new_n36_), .O(new_n70_));
  nand3  g45(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x11), .c(x04), .d(new_n40_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  nor3   g50(.a(new_n27_), .b(new_n46_), .c(new_n75_), .O(z09));
  nand2  g51(.a(x05), .b(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n28_), .c(x06), .d(new_n40_), .O(new_n78_));
