...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z04));
  nor3   g24(.a(x02), .b(new_n26_), .c(new_n45_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand4  g27(.a(new_n27_), .b(new_n47_), .c(new_n32_), .d(x02), .O(new_n53_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n58_), .c(new_n47_), .O(new_n61_));
  ...
  aoi21  g40(.a(new_n26_), .b(x00), .c(x13), .O(new_n66_));
  ...
  nand3  g44(.a(new_n47_), .b(new_n32_), .c(x02), .O(new_n70_));
  ...
  nor3   g49(.a(z03), .b(new_n47_), .c(new_n74_), .O(z09));
