...
module FAU ( 
  ...
  inv1   g52(.a(new_n44_), .O(z07));
  nand2  g53(.a(x05), .b(new_n34_), .O(new_n79_));
  nand2  g54(.a(x13), .b(new_n57_), .O(new_n80_));
  nand4  g55(.a(new_n26_), .b(new_n41_), .c(new_n36_), .d(x02), .O(new_n81_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(new_n81_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n33_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n26_), .O(z08));
  nand3  g59(.a(x13), .b(new_n69_), .c(x06), .O(new_n85_));
  inv1   g60(.a(new_n85_), .O(z09));
  oai21  g61(.a(new_n36_), .b(new_n34_), .c(new_n33_), .O(new_n87_));
  aoi21  g62(.a(new_n87_), .b(new_n69_), .c(new_n62_), .O(z10));
endmodule
