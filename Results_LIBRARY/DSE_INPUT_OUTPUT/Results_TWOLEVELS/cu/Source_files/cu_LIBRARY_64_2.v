...
module FAU ( 
  ...
  nand4  g44(.a(new_n37_), .b(new_n26_), .c(new_n30_), .d(x02), .O(new_n70_));
  ...
  inv1   g51(.a(new_n27_), .O(new_n77_));
  nand4  g52(.a(x13), .b(new_n61_), .c(x05), .d(new_n33_), .O(new_n78_));
  ...
  nand3  g58(.a(new_n32_), .b(x06), .c(new_n36_), .O(new_n84_));
