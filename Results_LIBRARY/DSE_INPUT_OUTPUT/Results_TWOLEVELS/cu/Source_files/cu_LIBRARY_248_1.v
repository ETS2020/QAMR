...
module FAU ( 
  ...
  nand4  g25(.a(new_n36_), .b(new_n33_), .c(x01), .d(new_n43_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n44_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n56_));
  ...
  nand3  g41(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(x13), .c(new_n59_), .d(new_n58_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x05), .c(new_n33_), .O(new_n70_));
  nand3  g45(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n71_));
  ...
  aoi21  g49(.a(x08), .b(new_n62_), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n59_), .c(x05), .d(new_n33_), .O(new_n78_));
