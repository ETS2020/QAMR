...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x10), .c(x05), .d(new_n28_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n36_), .c(new_n32_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x10), .c(x01), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n36_), .c(new_n32_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x10), .c(x01), .O(z03));
  nand3  g24(.a(new_n32_), .b(x01), .c(new_n42_), .O(new_n50_));
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n35_), .O(z04));
  inv1   g27(.a(x01), .O(new_n53_));
  nor3   g28(.a(x02), .b(new_n53_), .c(new_n42_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(x10), .b(new_n59_), .c(new_n53_), .O(new_n60_));
  ...
  aoi21  g51(.a(new_n67_), .b(new_n53_), .c(x13), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n58_), .c(x05), .d(new_n32_), .O(new_n80_));
  nand3  g55(.a(new_n43_), .b(new_n29_), .c(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand4  g57(.a(new_n82_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n26_), .b(new_n43_), .c(new_n85_), .O(z09));
  nand3  g61(.a(new_n31_), .b(x06), .c(new_n36_), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(new_n35_), .O(z10));
endmodule
