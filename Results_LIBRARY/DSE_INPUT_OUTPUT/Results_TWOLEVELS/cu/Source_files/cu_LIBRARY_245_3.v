...
module FAU ( 
  ...
  nand4  g10(.a(new_n31_), .b(x04), .c(x02), .d(new_n35_), .O(new_n36_));
  ...
  nand4  g16(.a(new_n26_), .b(new_n28_), .c(new_n35_), .d(x00), .O(new_n42_));
  ...
  nand4  g23(.a(new_n48_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nor2   g25(.a(x03), .b(new_n46_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n28_), .c(new_n35_), .O(z05));
  ...
  nand3  g38(.a(new_n41_), .b(new_n31_), .c(x02), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n26_), .O(new_n66_));
  nand2  g41(.a(x02), .b(x01), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  oai21  g43(.a(new_n35_), .b(new_n46_), .c(x02), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(x03), .c(new_n67_), .O(z07));
  nor2   g46(.a(new_n30_), .b(x03), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n41_), .c(new_n31_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n35_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(x02), .O(new_n75_));
  nor2   g50(.a(new_n41_), .b(x12), .O(new_n76_));
