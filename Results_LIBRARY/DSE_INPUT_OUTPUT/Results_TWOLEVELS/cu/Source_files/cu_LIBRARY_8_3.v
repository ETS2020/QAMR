...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n26_), .c(new_n37_), .d(new_n30_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x13), .c(new_n27_), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nor2   g21(.a(x03), .b(x02), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n46_), .c(x05), .d(new_n26_), .O(new_n48_));
  ...
  nand4  g53(.a(new_n35_), .b(new_n29_), .c(x06), .d(new_n37_), .O(new_n79_));
