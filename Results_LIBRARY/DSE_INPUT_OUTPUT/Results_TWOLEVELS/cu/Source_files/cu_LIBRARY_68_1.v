...
module FAU ( 
  ...
  aoi21  g25(.a(new_n50_), .b(new_n42_), .c(x01), .O(z03));
  ...
  nand4  g43(.a(new_n35_), .b(new_n60_), .c(new_n29_), .d(x02), .O(new_n69_));
  ...
  nand3  g47(.a(x06), .b(new_n26_), .c(new_n43_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n60_), .c(x05), .d(new_n32_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n36_), .c(new_n28_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n35_), .O(z07));
  nand4  g52(.a(x13), .b(new_n59_), .c(x05), .d(new_n28_), .O(new_n78_));
  nand3  g53(.a(new_n60_), .b(new_n29_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  aoi21  g57(.a(new_n60_), .b(x01), .c(new_n42_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(x06), .c(new_n36_), .d(x01), .O(new_n85_));
