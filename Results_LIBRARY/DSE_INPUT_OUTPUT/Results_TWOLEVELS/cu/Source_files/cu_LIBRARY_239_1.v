...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n34_), .c(x05), .d(new_n27_), .O(new_n48_));
  ...
  nor2   g30(.a(x13), .b(new_n28_), .O(new_n56_));
  nand3  g31(.a(new_n56_), .b(new_n27_), .c(new_n26_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n55_), .c(new_n40_), .O(z05));
  ...
  nor2   g39(.a(x10), .b(new_n45_), .O(new_n65_));
  ...
  nand3  g43(.a(new_n34_), .b(new_n28_), .c(x02), .O(new_n69_));
  ...
  nand3  g47(.a(new_n56_), .b(new_n27_), .c(new_n26_), .O(new_n73_));
  ...
  nand3  g55(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n81_));
