...
module FAU ( 
  ...
  nand4  g17(.a(new_n33_), .b(new_n34_), .c(new_n42_), .d(new_n41_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x10), .c(x05), .d(new_n27_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nand4  g21(.a(new_n33_), .b(new_n34_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x10), .c(x05), .d(new_n27_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand3  g25(.a(new_n34_), .b(x01), .c(new_n41_), .O(new_n51_));
  inv1   g26(.a(x13), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n32_), .O(z04));
  nand3  g29(.a(new_n34_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n32_), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  inv1   g33(.a(x09), .O(new_n59_));
  nand3  g34(.a(x10), .b(new_n59_), .c(new_n42_), .O(new_n60_));
  ...
  nand3  g40(.a(x10), .b(new_n65_), .c(new_n42_), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n52_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n32_), .b(new_n52_), .c(new_n36_), .d(x02), .O(new_n73_));
  ...
  aoi21  g51(.a(new_n67_), .b(new_n42_), .c(x13), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n58_), .c(x05), .d(new_n34_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n73_), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(x04), .c(new_n33_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n32_), .O(z08));
  inv1   g58(.a(x06), .O(new_n84_));
  nor3   g59(.a(new_n26_), .b(new_n52_), .c(new_n84_), .O(z09));
  nand2  g60(.a(x05), .b(x02), .O(new_n86_));
  nand3  g61(.a(new_n86_), .b(x06), .c(new_n33_), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(new_n32_), .O(z10));
endmodule
