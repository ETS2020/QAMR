...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n85_;
  aoi21  g00(.a(x08), .b(x01), .c(x03), .O(new_n26_));
  ...
  nand2  g08(.a(x08), .b(x01), .O(new_n34_));
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n35_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x13), .O(z02));
  inv1   g19(.a(x13), .O(new_n45_));
  inv1   g20(.a(x01), .O(new_n46_));
  nand4  g21(.a(new_n35_), .b(new_n27_), .c(new_n46_), .d(x00), .O(new_n47_));
  ...
  nand4  g27(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z04));
  nor2   g31(.a(x03), .b(x02), .O(new_n57_));
  nor2   g32(.a(x13), .b(x08), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n57_), .c(new_n36_), .d(x00), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n51_), .c(new_n46_), .O(z05));
  inv1   g35(.a(x07), .O(new_n61_));
  inv1   g36(.a(x12), .O(new_n62_));
  nor2   g37(.a(x09), .b(x01), .O(new_n63_));
  nor2   g38(.a(x11), .b(new_n46_), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n63_), .c(x00), .O(new_n65_));
  nand2  g40(.a(x10), .b(x01), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n51_), .c(new_n52_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n62_), .c(new_n61_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n34_), .b(new_n45_), .c(new_n28_), .d(x02), .O(new_n70_));
  ...
  aoi21  g48(.a(x08), .b(x01), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n31_), .d(new_n35_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n62_), .c(x05), .d(new_n27_), .O(new_n77_));
  nand3  g52(.a(new_n45_), .b(new_n28_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  nand3  g56(.a(new_n34_), .b(x13), .c(x06), .O(new_n82_));
