...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(new_n46_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n34_), .c(x05), .d(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand4  g26(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n34_), .c(x05), .d(new_n27_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nand3  g30(.a(new_n30_), .b(x01), .c(x00), .O(new_n56_));
  nor2   g31(.a(x13), .b(new_n28_), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n27_), .c(new_n26_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n56_), .c(new_n41_), .O(z05));
  inv1   g34(.a(x07), .O(new_n60_));
  inv1   g35(.a(x12), .O(new_n61_));
  nor2   g36(.a(x09), .b(x01), .O(new_n62_));
  nor2   g37(.a(x11), .b(new_n46_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(x00), .O(new_n64_));
  nor2   g39(.a(x08), .b(x01), .O(new_n65_));
  nor2   g40(.a(x10), .b(new_n46_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n51_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n34_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n69_));
  nand2  g44(.a(new_n37_), .b(x02), .O(new_n70_));
  ...
  nand3  g48(.a(new_n57_), .b(new_n27_), .c(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand3  g50(.a(x13), .b(new_n61_), .c(new_n30_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n70_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n26_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n41_), .O(z08));
  nand3  g54(.a(x13), .b(x06), .c(x05), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z09));
  inv1   g56(.a(new_n37_), .O(new_n82_));
  oai21  g57(.a(new_n28_), .b(x02), .c(new_n82_), .O(new_n83_));
