...
module FAU ( 
  ...
  nand4  g20(.a(new_n34_), .b(new_n35_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n27_), .c(x05), .d(new_n36_), .O(new_n48_));
  ...
  nand4  g27(.a(new_n52_), .b(new_n27_), .c(x05), .d(new_n36_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor2   g29(.a(x04), .b(x03), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n35_), .c(x01), .d(x00), .O(new_n56_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(x04), .d(new_n34_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z06));
  oai21  g45(.a(new_n45_), .b(new_n50_), .c(new_n26_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n36_), .c(new_n34_), .d(new_n35_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x05), .c(x13), .O(z07));
  nand3  g48(.a(x04), .b(new_n34_), .c(new_n35_), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n59_), .c(x05), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n28_), .O(z08));
  and2   g51(.a(x13), .b(x06), .O(z09));
  nand2  g52(.a(x05), .b(new_n35_), .O(new_n78_));
  oai21  g53(.a(new_n27_), .b(x05), .c(new_n78_), .O(new_n79_));
