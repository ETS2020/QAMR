...
module FAU ( 
  ...
  nand4  g17(.a(new_n36_), .b(new_n30_), .c(new_n33_), .d(x00), .O(new_n44_));
  inv1   g18(.a(new_n44_), .O(new_n45_));
  nand4  g19(.a(new_n45_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(z03));
  nor2   g21(.a(x03), .b(x02), .O(new_n48_));
  nand4  g22(.a(new_n48_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n49_));
  aoi21  g23(.a(new_n49_), .b(x01), .c(x00), .O(z04));
  nand3  g24(.a(new_n30_), .b(x01), .c(x00), .O(new_n51_));
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n52_));
  oai21  g26(.a(new_n52_), .b(new_n51_), .c(new_n34_), .O(z05));
  nand4  g27(.a(new_n34_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x09), .b(x01), .O(new_n57_));
  nor2   g31(.a(x11), .b(new_n33_), .O(new_n58_));
  ...
  nand4  g40(.a(new_n43_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n67_));
  oai21  g41(.a(new_n67_), .b(x02), .c(new_n34_), .O(z07));
  nand4  g42(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n54_), .O(new_n70_));
  nand3  g44(.a(new_n70_), .b(x04), .c(new_n36_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n34_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n34_), .O(z09));
  nand4  g48(.a(new_n34_), .b(new_n29_), .c(x06), .d(new_n36_), .O(new_n75_));
