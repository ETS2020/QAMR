...
module FAU ( 
  ...
  nand2  g01(.a(x04), .b(new_n26_), .O(new_n27_));
  ...
  oai21  g08(.a(new_n30_), .b(x02), .c(new_n29_), .O(new_n34_));
  nand3  g09(.a(new_n34_), .b(new_n33_), .c(new_n28_), .O(z00));
  inv1   g10(.a(x03), .O(new_n36_));
  inv1   g11(.a(x02), .O(new_n37_));
  nand3  g12(.a(x05), .b(new_n29_), .c(new_n37_), .O(new_n38_));
  ...
  nand4  g23(.a(new_n48_), .b(new_n36_), .c(new_n37_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n29_), .c(x01), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand4  g26(.a(new_n36_), .b(new_n37_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nand3  g30(.a(new_n37_), .b(x01), .c(x00), .O(new_n56_));
  nand4  g31(.a(new_n46_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n57_));
  ...
  nand4  g43(.a(new_n68_), .b(x04), .c(new_n36_), .d(x01), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nor3   g45(.a(new_n47_), .b(x03), .c(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n60_), .c(x05), .d(new_n37_), .O(new_n72_));
  nand4  g47(.a(new_n46_), .b(new_n30_), .c(x02), .d(x01), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n36_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(x01), .c(new_n29_), .O(z08));
