...
module FAU ( 
  ...
  nand4  g22(.a(new_n37_), .b(new_n34_), .c(new_n26_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n30_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand4  g27(.a(new_n47_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n37_), .c(new_n34_), .d(new_n52_), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g31(.a(new_n54_), .b(new_n37_), .c(new_n34_), .d(x00), .O(new_n57_));
  ...
  aoi21  g46(.a(x12), .b(x01), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n73_));
  ...
  nand2  g52(.a(new_n77_), .b(new_n38_), .O(z08));
  nand2  g53(.a(x13), .b(x06), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n38_), .O(z09));
  nand3  g55(.a(new_n33_), .b(x06), .c(new_n37_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n38_), .O(z10));
endmodule
