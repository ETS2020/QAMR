...
module FAU ( 
  ...
  nor2   g17(.a(new_n26_), .b(x13), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x02), .O(z07));
  nand2  g20(.a(z07), .b(new_n42_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x00), .O(z02));
  nand3  g22(.a(new_n32_), .b(new_n42_), .c(x00), .O(new_n48_));
  inv1   g23(.a(x13), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n36_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand3  g27(.a(new_n32_), .b(x01), .c(new_n52_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n50_), .c(new_n36_), .O(z04));
  nand3  g29(.a(new_n32_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n50_), .c(new_n36_), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nor2   g33(.a(x08), .b(x01), .O(new_n59_));
  nor2   g34(.a(x10), .b(new_n42_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n52_), .O(new_n61_));
  ...
  nand3  g40(.a(new_n49_), .b(new_n29_), .c(x02), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand4  g42(.a(new_n49_), .b(x07), .c(new_n29_), .d(x02), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  aoi21  g44(.a(new_n67_), .b(x09), .c(new_n69_), .O(new_n70_));
  nor3   g45(.a(new_n70_), .b(new_n28_), .c(x03), .O(z06));
  nand3  g46(.a(new_n43_), .b(new_n29_), .c(x02), .O(new_n72_));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n32_), .O(new_n73_));
  ...
  nor3   g52(.a(new_n26_), .b(new_n49_), .c(new_n77_), .O(z09));
  nand4  g53(.a(new_n31_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n79_));
