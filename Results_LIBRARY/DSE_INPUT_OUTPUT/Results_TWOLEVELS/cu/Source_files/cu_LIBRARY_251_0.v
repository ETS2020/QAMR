...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n41_), .c(new_n29_), .d(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(x00), .c(x01), .O(z03));
  inv1   g19(.a(x13), .O(new_n45_));
  inv1   g20(.a(x00), .O(new_n46_));
  nand4  g21(.a(new_n34_), .b(new_n27_), .c(x01), .d(new_n46_), .O(new_n47_));
  ...
  nand3  g26(.a(new_n42_), .b(new_n29_), .c(new_n34_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n35_), .O(z05));
  nand4  g28(.a(new_n35_), .b(new_n45_), .c(new_n30_), .d(x02), .O(new_n54_));
