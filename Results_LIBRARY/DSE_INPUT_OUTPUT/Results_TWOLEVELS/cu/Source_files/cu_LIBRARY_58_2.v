...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n32_), .d(new_n35_), .O(new_n46_));
  ...
  nand4  g24(.a(new_n35_), .b(new_n28_), .c(x01), .d(new_n42_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x12), .c(x05), .d(new_n32_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n35_), .b(new_n28_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x12), .c(x05), .d(new_n32_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  nand4  g32(.a(new_n36_), .b(new_n45_), .c(new_n29_), .d(x02), .O(new_n58_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n26_), .c(new_n59_), .d(x05), .O(new_n65_));
  ...
  aoi21  g43(.a(new_n26_), .b(x01), .c(x13), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n32_), .d(new_n35_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n26_), .c(x05), .d(new_n28_), .O(new_n72_));
  nand3  g47(.a(new_n45_), .b(new_n29_), .c(x02), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n72_), .c(x01), .O(new_n74_));
  nand4  g49(.a(new_n45_), .b(x12), .c(new_n29_), .d(x02), .O(new_n75_));
