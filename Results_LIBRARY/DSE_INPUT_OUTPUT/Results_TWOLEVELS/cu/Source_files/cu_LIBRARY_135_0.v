...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n26_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n48_));
  ...
  nand3  g28(.a(x05), .b(new_n26_), .c(x01), .O(new_n54_));
  ...
  oai22  g36(.a(x10), .b(x00), .c(x09), .d(x01), .O(new_n62_));
  ...
  nand4  g40(.a(new_n41_), .b(new_n27_), .c(x02), .d(x01), .O(new_n66_));
  ...
  nand4  g44(.a(new_n41_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n70_));
  ...
  nand4  g49(.a(new_n74_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n75_));
  ...
  nand4  g54(.a(new_n79_), .b(new_n33_), .c(x06), .d(new_n35_), .O(new_n80_));
