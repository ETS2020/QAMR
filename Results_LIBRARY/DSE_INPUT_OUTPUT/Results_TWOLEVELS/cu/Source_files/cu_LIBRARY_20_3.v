...
module FAU ( 
  ...
  nand4  g29(.a(new_n26_), .b(new_n44_), .c(new_n36_), .d(x02), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x12), .O(new_n57_));
  nor2   g32(.a(x08), .b(x01), .O(new_n58_));
  nor2   g33(.a(x10), .b(new_n45_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n50_), .O(new_n60_));
  ...
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n69_));
