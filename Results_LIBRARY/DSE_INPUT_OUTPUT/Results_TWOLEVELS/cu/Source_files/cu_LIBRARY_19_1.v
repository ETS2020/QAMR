...
module FAU ( 
  ...
  nand4  g22(.a(new_n38_), .b(new_n27_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n44_), .c(x05), .d(new_n32_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nand3  g26(.a(new_n27_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n45_), .c(new_n33_), .O(z05));
  ...
  nand3  g39(.a(x13), .b(x07), .c(x06), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z09));
  nand2  g41(.a(x05), .b(x02), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n33_), .c(x06), .d(new_n38_), .O(new_n68_));
