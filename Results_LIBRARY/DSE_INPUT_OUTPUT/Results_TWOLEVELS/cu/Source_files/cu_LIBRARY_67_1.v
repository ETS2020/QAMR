...
module FAU ( 
  ...
  nand4  g18(.a(new_n36_), .b(new_n32_), .c(new_n26_), .d(new_n43_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n42_), .c(x05), .d(new_n28_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand4  g22(.a(new_n36_), .b(new_n32_), .c(new_n26_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n42_), .c(x05), .d(new_n28_), .O(new_n50_));
  ...
  aoi21  g50(.a(x08), .b(new_n26_), .c(x13), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g53(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n79_));
  nand3  g54(.a(new_n52_), .b(new_n29_), .c(x02), .O(new_n80_));
  ...
  nand2  g59(.a(new_n84_), .b(new_n35_), .O(z09));
  nand4  g60(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n86_));
