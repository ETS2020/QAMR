...
module FAU ( 
  ...
  nand4  g17(.a(new_n26_), .b(new_n28_), .c(new_n42_), .d(new_n41_), .O(new_n43_));
  ...
  nand3  g22(.a(new_n47_), .b(x05), .c(new_n31_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n28_), .c(new_n42_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n27_), .c(x03), .O(z03));
  nand4  g26(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n49_), .b(new_n28_), .c(x01), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n27_), .c(x03), .O(z05));
  ...
  nand3  g41(.a(new_n47_), .b(new_n32_), .c(x02), .O(new_n67_));
  oai21  g42(.a(new_n66_), .b(x02), .c(new_n67_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  aoi21  g45(.a(x11), .b(new_n41_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n31_), .d(new_n28_), .O(new_n72_));
  ...
  nand4  g50(.a(new_n75_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n76_));
  ...
  nand2  g55(.a(new_n30_), .b(x06), .O(new_n81_));
