...
module FAU ( 
  ...
  nand4  g30(.a(new_n55_), .b(new_n45_), .c(x05), .d(new_n34_), .O(new_n56_));
  ...
  nand3  g39(.a(new_n44_), .b(new_n64_), .c(x01), .O(new_n65_));
  ...
  nand3  g45(.a(new_n44_), .b(new_n70_), .c(x01), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n53_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n67_), .c(new_n45_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n61_), .c(x05), .d(new_n30_), .O(new_n75_));
  nand4  g50(.a(new_n27_), .b(new_n45_), .c(new_n31_), .d(x02), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n37_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n27_), .O(z06));
  aoi21  g54(.a(x12), .b(new_n26_), .c(x13), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n81_));
  nor2   g56(.a(new_n81_), .b(x02), .O(z07));
  nand4  g57(.a(x13), .b(new_n44_), .c(x05), .d(new_n30_), .O(new_n83_));
  ...
  nor3   g62(.a(new_n28_), .b(new_n45_), .c(new_n87_), .O(z09));
  nand2  g63(.a(x05), .b(x02), .O(new_n89_));
  nand3  g64(.a(new_n89_), .b(x06), .c(new_n37_), .O(new_n90_));
  nand2  g65(.a(new_n90_), .b(new_n27_), .O(z10));
endmodule
