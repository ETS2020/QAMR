...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n26_), .O(new_n48_));
  ...
  nand4  g28(.a(new_n33_), .b(new_n41_), .c(new_n27_), .d(x02), .O(new_n54_));
  ...
  nand4  g41(.a(new_n41_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n67_));
  ...
  nor3   g48(.a(z02), .b(new_n41_), .c(new_n73_), .O(z09));
