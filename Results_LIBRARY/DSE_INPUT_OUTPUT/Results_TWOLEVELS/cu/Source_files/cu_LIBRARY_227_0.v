...
module FAU ( 
  ...
  nand4  g41(.a(new_n66_), .b(x04), .c(new_n39_), .d(new_n34_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n28_), .O(z06));
  nand4  g43(.a(x05), .b(new_n35_), .c(new_n39_), .d(new_n34_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x05), .c(x13), .O(z07));
  nand3  g45(.a(x04), .b(new_n39_), .c(new_n34_), .O(new_n71_));
  ...
  nand3  g50(.a(new_n75_), .b(x06), .c(new_n39_), .O(new_n76_));
