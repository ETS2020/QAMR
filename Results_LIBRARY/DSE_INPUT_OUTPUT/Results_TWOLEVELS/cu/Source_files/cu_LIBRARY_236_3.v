...
module FAU ( 
  ...
  nand2  g11(.a(x13), .b(x01), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n30_), .d(new_n34_), .O(new_n38_));
  inv1   g13(.a(new_n28_), .O(new_n39_));
  nand4  g14(.a(new_n39_), .b(new_n31_), .c(x04), .d(x02), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n38_), .c(x03), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  nand3  g17(.a(new_n34_), .b(new_n26_), .c(new_n42_), .O(new_n43_));
  ...
  nand4  g21(.a(new_n44_), .b(new_n34_), .c(new_n26_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand4  g25(.a(new_n44_), .b(new_n34_), .c(x01), .d(new_n42_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n27_), .b(x05), .c(new_n30_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n44_), .c(new_n34_), .d(x00), .O(new_n57_));
  ...
  nor3   g47(.a(new_n55_), .b(x03), .c(x02), .O(z07));
  nand2  g48(.a(new_n34_), .b(new_n26_), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n60_), .c(x05), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n44_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  inv1   g53(.a(x06), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand4  g55(.a(new_n33_), .b(new_n39_), .c(x06), .d(new_n44_), .O(new_n81_));
