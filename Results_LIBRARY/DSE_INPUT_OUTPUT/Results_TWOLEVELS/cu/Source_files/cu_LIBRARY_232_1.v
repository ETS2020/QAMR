...
module FAU ( 
  ...
  nand3  g40(.a(new_n45_), .b(new_n32_), .c(x02), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(x08), .O(new_n67_));
  nand4  g42(.a(new_n45_), .b(x07), .c(new_n32_), .d(x02), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n67_), .c(x04), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x03), .O(z06));
  inv1   g46(.a(new_n50_), .O(z07));
  nand4  g47(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  nor3   g52(.a(new_n28_), .b(new_n45_), .c(new_n77_), .O(z09));
  inv1   g53(.a(new_n33_), .O(new_n79_));
