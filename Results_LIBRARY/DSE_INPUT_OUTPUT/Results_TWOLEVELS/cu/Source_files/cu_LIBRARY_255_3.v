...
module FAU ( 
  ...
  nand4  g27(.a(new_n46_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n53_));
  ...
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n73_));
  ...
  nand3  g53(.a(new_n37_), .b(x13), .c(x06), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z09));
  nand4  g55(.a(new_n33_), .b(new_n37_), .c(x06), .d(new_n38_), .O(new_n81_));
