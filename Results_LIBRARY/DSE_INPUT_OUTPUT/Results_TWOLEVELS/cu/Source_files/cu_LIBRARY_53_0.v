...
module FAU ( 
  ...
  nor2   g16(.a(x13), .b(new_n30_), .O(new_n43_));
  nand4  g17(.a(new_n43_), .b(new_n42_), .c(new_n29_), .d(x00), .O(new_n44_));
  aoi21  g18(.a(new_n44_), .b(x00), .c(x01), .O(z03));
  inv1   g19(.a(x13), .O(new_n46_));
  inv1   g20(.a(x00), .O(new_n47_));
  nand4  g21(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n47_), .O(new_n48_));
  ...
  nand4  g29(.a(new_n34_), .b(new_n46_), .c(new_n30_), .d(x02), .O(new_n56_));
  ...
  nor3   g50(.a(new_n26_), .b(new_n46_), .c(new_n76_), .O(z09));
