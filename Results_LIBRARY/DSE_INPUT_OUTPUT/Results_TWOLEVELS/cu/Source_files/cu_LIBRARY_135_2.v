...
module FAU ( 
  ...
  nand3  g22(.a(new_n26_), .b(x01), .c(new_n41_), .O(new_n49_));
  nand4  g23(.a(new_n43_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n50_));
  oai21  g24(.a(new_n50_), .b(new_n49_), .c(new_n33_), .O(z04));
  nor3   g25(.a(x02), .b(new_n32_), .c(new_n41_), .O(new_n52_));
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nand3  g28(.a(new_n42_), .b(x05), .c(x04), .O(new_n55_));
  ...
  nand3  g35(.a(x05), .b(new_n26_), .c(x01), .O(new_n62_));
  ...
  nand2  g40(.a(new_n66_), .b(new_n41_), .O(new_n67_));
  nand4  g41(.a(new_n43_), .b(new_n27_), .c(x02), .d(x01), .O(new_n68_));
  inv1   g42(.a(new_n68_), .O(new_n69_));
  nand3  g43(.a(x05), .b(new_n26_), .c(new_n32_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n76_), .b(x04), .c(new_n35_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n61_), .O(z06));
  aoi21  g52(.a(new_n45_), .b(new_n42_), .c(new_n32_), .O(new_n79_));
  nand2  g53(.a(x01), .b(x00), .O(new_n80_));
  nand4  g54(.a(new_n80_), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n81_));
  inv1   g55(.a(new_n81_), .O(new_n82_));
  nand3  g56(.a(new_n82_), .b(new_n35_), .c(new_n26_), .O(new_n83_));
  oai21  g57(.a(new_n79_), .b(new_n41_), .c(new_n83_), .O(z07));
  nand2  g58(.a(x13), .b(new_n58_), .O(new_n85_));
  nand2  g59(.a(x05), .b(new_n26_), .O(new_n86_));
  oai21  g60(.a(new_n86_), .b(new_n85_), .c(new_n65_), .O(new_n87_));
  nand4  g61(.a(new_n87_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n88_));
  inv1   g62(.a(new_n88_), .O(z08));
  inv1   g63(.a(x06), .O(new_n90_));
  nand2  g64(.a(new_n33_), .b(x13), .O(new_n91_));
  nor2   g65(.a(new_n91_), .b(new_n90_), .O(z09));
  nand2  g66(.a(x05), .b(x02), .O(new_n93_));
  nand4  g67(.a(new_n93_), .b(new_n33_), .c(x06), .d(new_n35_), .O(new_n94_));
  inv1   g68(.a(new_n94_), .O(z10));
  zero   g69(.O(z03));
endmodule
