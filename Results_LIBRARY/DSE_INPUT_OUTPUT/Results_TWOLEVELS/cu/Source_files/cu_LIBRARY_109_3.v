...
module FAU ( 
  ...
  nand3  g24(.a(new_n29_), .b(x01), .c(new_n42_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n26_), .O(z04));
  nand4  g26(.a(new_n26_), .b(new_n45_), .c(x05), .d(new_n33_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n36_), .c(new_n29_), .d(x01), .O(new_n54_));
  ...
  nand3  g44(.a(new_n27_), .b(x01), .c(x00), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n45_), .c(x05), .d(new_n33_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n36_), .c(new_n29_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n26_), .O(z07));
