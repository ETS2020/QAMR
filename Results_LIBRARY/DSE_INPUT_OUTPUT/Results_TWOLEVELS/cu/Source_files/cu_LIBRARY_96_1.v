...
module FAU ( 
  ...
  nand2  g43(.a(new_n69_), .b(new_n53_), .O(new_n70_));
  nand3  g44(.a(new_n70_), .b(x04), .c(new_n35_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n33_), .O(z08));
  inv1   g46(.a(x06), .O(new_n73_));
  nand2  g47(.a(new_n33_), .b(x13), .O(new_n74_));
  nor2   g48(.a(new_n74_), .b(new_n73_), .O(z09));
  nand3  g49(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n76_));
