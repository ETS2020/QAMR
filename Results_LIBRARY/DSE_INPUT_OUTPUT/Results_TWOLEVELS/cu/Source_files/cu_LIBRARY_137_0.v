...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x09), .c(x05), .d(new_n27_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nand4  g21(.a(x09), .b(x05), .c(new_n27_), .d(new_n42_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n32_), .c(new_n41_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x09), .c(x13), .O(z03));
  ...
  nand4  g29(.a(new_n42_), .b(new_n32_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x09), .c(x05), .d(new_n27_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z05));
  inv1   g33(.a(new_n26_), .O(new_n59_));
  inv1   g34(.a(x07), .O(new_n60_));
  nand2  g35(.a(new_n33_), .b(new_n41_), .O(new_n61_));
  inv1   g36(.a(x11), .O(new_n62_));
  nand3  g37(.a(x13), .b(new_n62_), .c(x01), .O(new_n63_));
  ...
  nand3  g45(.a(new_n70_), .b(x13), .c(new_n40_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(x12), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n60_), .c(x05), .d(new_n32_), .O(new_n73_));
  nor2   g48(.a(x13), .b(new_n33_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n37_), .c(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n42_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n59_), .O(z06));
  nand3  g53(.a(new_n74_), .b(x05), .c(new_n27_), .O(new_n79_));
  nor3   g54(.a(new_n79_), .b(x03), .c(x02), .O(z07));
  inv1   g55(.a(x12), .O(new_n81_));
  nand4  g56(.a(x13), .b(new_n81_), .c(x05), .d(new_n32_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n75_), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x04), .c(new_n42_), .O(new_n84_));
  inv1   g59(.a(new_n84_), .O(z08));
  nand2  g60(.a(x13), .b(x06), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n59_), .O(z09));
  nand2  g62(.a(x05), .b(x02), .O(new_n88_));
  nand3  g63(.a(new_n88_), .b(x06), .c(new_n42_), .O(new_n89_));
  nand2  g64(.a(new_n89_), .b(new_n59_), .O(z10));
endmodule
