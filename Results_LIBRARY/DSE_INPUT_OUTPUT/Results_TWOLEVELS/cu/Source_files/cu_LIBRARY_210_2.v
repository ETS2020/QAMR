...
module FAU ( 
  ...
  nand4  g19(.a(new_n37_), .b(new_n29_), .c(new_n44_), .d(new_n43_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x13), .O(z02));
  nand4  g23(.a(new_n26_), .b(x05), .c(new_n33_), .d(new_n37_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n26_), .c(x13), .O(z03));
  nand4  g27(.a(new_n37_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z04));
  nand4  g31(.a(new_n50_), .b(new_n29_), .c(x01), .d(x00), .O(new_n57_));
  ...
  nand3  g44(.a(new_n61_), .b(new_n30_), .c(x02), .O(new_n70_));
  ...
  nor2   g48(.a(x13), .b(x08), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n33_), .d(new_n37_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n60_), .c(x05), .d(new_n29_), .O(new_n77_));
