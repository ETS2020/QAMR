...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n36_), .c(new_n46_), .d(x00), .O(new_n47_));
  ...
  nand4  g26(.a(new_n34_), .b(new_n36_), .c(x01), .d(new_n26_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n51_), .c(x05), .d(new_n29_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nor2   g30(.a(x03), .b(x02), .O(new_n56_));
  nor2   g31(.a(x13), .b(new_n38_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n56_), .c(new_n29_), .d(x01), .O(new_n58_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n51_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n69_));
  nand3  g44(.a(new_n51_), .b(new_n38_), .c(x02), .O(new_n70_));
  ...
  nand3  g48(.a(x06), .b(new_n46_), .c(x00), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n51_), .c(x05), .d(new_n29_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n34_), .c(new_n36_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n35_), .O(z07));
  nand4  g53(.a(x13), .b(new_n61_), .c(x05), .d(new_n36_), .O(new_n79_));
  ...
  aoi21  g57(.a(new_n51_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(x06), .c(new_n34_), .d(new_n26_), .O(new_n85_));
