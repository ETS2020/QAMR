...
module FAU ( 
  ...
  nor3   g18(.a(new_n29_), .b(x13), .c(new_n32_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n35_), .c(new_n38_), .d(new_n31_), .O(new_n45_));
  ...
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n35_), .d(new_n38_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n28_), .O(z03));
  nor3   g26(.a(new_n45_), .b(new_n47_), .c(x00), .O(z04));
  nand3  g27(.a(new_n31_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n50_), .c(new_n28_), .O(z05));
  inv1   g29(.a(x12), .O(new_n55_));
  nor2   g30(.a(x09), .b(x01), .O(new_n56_));
  nor2   g31(.a(x11), .b(new_n47_), .O(new_n57_));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n49_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n26_), .d(x05), .O(new_n63_));
  nand4  g38(.a(new_n28_), .b(new_n49_), .c(new_n32_), .d(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n38_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n28_), .O(z06));
  aoi21  g42(.a(new_n29_), .b(new_n59_), .c(x13), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n35_), .d(new_n38_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n28_), .O(z07));
  nand4  g45(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n71_));
  nand3  g46(.a(new_n49_), .b(new_n32_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n28_), .c(x04), .d(new_n38_), .O(new_n74_));
  ...
  nand4  g53(.a(new_n78_), .b(new_n28_), .c(x06), .d(new_n38_), .O(new_n79_));
