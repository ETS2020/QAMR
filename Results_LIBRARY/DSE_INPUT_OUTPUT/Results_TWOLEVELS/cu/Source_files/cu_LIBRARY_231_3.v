...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n33_,
    ...
    new_n83_, new_n84_, new_n85_, new_n88_;
  ...
  nand3  g14(.a(new_n39_), .b(new_n26_), .c(new_n33_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(new_n34_), .b(new_n43_), .c(new_n42_), .O(new_n44_));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n26_), .O(z02));
  nand4  g22(.a(new_n33_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n48_));
  ...
  nand4  g28(.a(new_n53_), .b(new_n36_), .c(new_n45_), .d(new_n52_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n52_), .c(new_n43_), .O(z04));
  nand4  g30(.a(new_n33_), .b(new_n34_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n52_), .c(x05), .d(new_n28_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z05));
  inv1   g34(.a(x07), .O(new_n60_));
  inv1   g35(.a(x12), .O(new_n61_));
  inv1   g36(.a(x09), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n43_), .O(new_n63_));
  inv1   g38(.a(x11), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n52_), .c(x01), .O(new_n65_));
  ...
  nand3  g45(.a(new_n70_), .b(new_n52_), .c(x01), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n42_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n67_), .c(new_n45_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n75_));
  nand4  g50(.a(new_n26_), .b(new_n45_), .c(new_n35_), .d(x02), .O(new_n76_));
  ...
  nand2  g58(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n33_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n26_), .O(z08));
  aoi21  g61(.a(new_n45_), .b(new_n43_), .c(new_n52_), .O(z09));
  oai21  g62(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(new_n88_));
  aoi21  g63(.a(new_n88_), .b(new_n43_), .c(new_n52_), .O(z10));
endmodule
