...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n34_), .b(x01), .c(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n30_), .b(x05), .c(new_n35_), .d(new_n40_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n27_), .O(z04));
  nand3  g27(.a(new_n34_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n27_), .O(z05));
  ...
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(new_n55_), .d(new_n34_), .O(new_n64_));
  nand2  g39(.a(new_n37_), .b(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n40_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n27_), .O(z06));
  nand4  g43(.a(new_n30_), .b(x05), .c(new_n35_), .d(new_n40_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n27_), .O(z07));
  nand2  g45(.a(x05), .b(new_n34_), .O(new_n71_));
  nand2  g46(.a(x13), .b(new_n56_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n71_), .c(new_n65_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n40_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  nand3  g50(.a(x13), .b(x06), .c(x05), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z09));
  inv1   g52(.a(new_n37_), .O(new_n78_));
  nand2  g53(.a(new_n71_), .b(new_n78_), .O(new_n79_));
