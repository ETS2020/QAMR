...
module FAU ( 
  ...
  inv1   g21(.a(new_n46_), .O(z02));
  nand3  g22(.a(new_n30_), .b(new_n41_), .c(x00), .O(new_n48_));
  nand4  g23(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n48_), .c(new_n33_), .O(z03));
  aoi21  g25(.a(new_n44_), .b(x00), .c(new_n41_), .O(z05));
  nand3  g26(.a(new_n43_), .b(x05), .c(x04), .O(new_n53_));
  ...
  oai21  g31(.a(new_n57_), .b(new_n53_), .c(new_n41_), .O(new_n58_));
  ...
  aoi21  g43(.a(new_n41_), .b(new_n32_), .c(x13), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n71_));
  oai21  g45(.a(new_n71_), .b(x02), .c(new_n46_), .O(z07));
  ...
  nand2  g49(.a(new_n75_), .b(new_n33_), .O(z08));
