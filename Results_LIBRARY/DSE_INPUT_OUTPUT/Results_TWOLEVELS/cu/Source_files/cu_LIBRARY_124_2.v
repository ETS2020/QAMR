...
module FAU ( 
  ...
  nor2   g15(.a(x10), .b(new_n26_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand2  g17(.a(new_n42_), .b(new_n40_), .O(z01));
  nor3   g18(.a(x02), .b(x01), .c(x00), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  inv1   g21(.a(x01), .O(new_n47_));
  nand3  g22(.a(new_n31_), .b(new_n47_), .c(x00), .O(new_n48_));
  inv1   g23(.a(x13), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n42_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand3  g27(.a(new_n31_), .b(x01), .c(new_n52_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n50_), .c(new_n42_), .O(z04));
  nor3   g29(.a(x02), .b(new_n47_), .c(new_n52_), .O(new_n55_));
  ...
  nand2  g35(.a(new_n60_), .b(new_n47_), .O(new_n61_));
  inv1   g36(.a(x11), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x01), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n52_), .O(new_n64_));
  nor3   g39(.a(x08), .b(x01), .c(x00), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(new_n26_), .O(new_n66_));
  nand3  g41(.a(new_n27_), .b(x01), .c(new_n52_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n66_), .c(new_n49_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n49_), .b(new_n32_), .c(new_n26_), .d(x02), .O(new_n70_));
  ...
  nand4  g48(.a(new_n49_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n76_));
  nand3  g51(.a(new_n49_), .b(new_n32_), .c(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n41_), .b(new_n49_), .c(new_n81_), .O(z09));
