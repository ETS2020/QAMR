...
module FAU ( 
  ...
  nand3  g13(.a(x05), .b(new_n28_), .c(new_n32_), .O(new_n39_));
  nand3  g14(.a(new_n29_), .b(x04), .c(x02), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand3  g16(.a(new_n41_), .b(new_n38_), .c(new_n35_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(z01));
  inv1   g18(.a(x00), .O(new_n44_));
  inv1   g19(.a(x01), .O(new_n45_));
  nand3  g20(.a(x05), .b(new_n28_), .c(new_n35_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n32_), .c(new_n45_), .d(new_n44_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x12), .c(x13), .O(z02));
  nand4  g24(.a(new_n35_), .b(new_n32_), .c(new_n45_), .d(x00), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x12), .c(x05), .d(new_n28_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z03));
  nand4  g28(.a(new_n47_), .b(new_n32_), .c(x01), .d(new_n44_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x12), .c(x13), .O(z04));
  nand4  g30(.a(new_n35_), .b(new_n32_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x12), .c(x05), .d(new_n28_), .O(new_n58_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(x12), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n69_));
  nand4  g44(.a(new_n37_), .b(x12), .c(new_n29_), .d(x02), .O(new_n70_));
  ...
  nand4  g49(.a(new_n74_), .b(x12), .c(x05), .d(new_n28_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(x12), .c(x13), .O(z07));
  nand3  g51(.a(new_n36_), .b(x05), .c(new_n32_), .O(new_n77_));
  ...
  nand3  g57(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n83_));
