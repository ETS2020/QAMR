...
module FAU ( 
  ...
  nand4  g27(.a(new_n46_), .b(x11), .c(x05), .d(new_n34_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n37_), .c(new_n30_), .d(new_n43_), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x11), .c(new_n44_), .O(z04));
  nand4  g31(.a(new_n54_), .b(new_n37_), .c(new_n30_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x11), .c(new_n44_), .O(z05));
  ...
  nand4  g42(.a(new_n27_), .b(new_n46_), .c(new_n31_), .d(x02), .O(new_n68_));
  ...
  nor3   g55(.a(new_n28_), .b(new_n46_), .c(new_n80_), .O(z09));
