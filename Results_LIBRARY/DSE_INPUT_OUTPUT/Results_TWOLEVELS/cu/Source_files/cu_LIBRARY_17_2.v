...
module FAU ( 
  ...
  nand2  g10(.a(new_n35_), .b(x11), .O(new_n36_));
  ...
  nand4  g17(.a(new_n42_), .b(new_n28_), .c(new_n41_), .d(new_n40_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n45_));
  ...
  nor2   g27(.a(x11), .b(new_n31_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n40_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n26_), .c(x13), .O(z04));
  nand4  g30(.a(new_n42_), .b(new_n28_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n58_));
  ...
  nand4  g44(.a(new_n35_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n70_));
  ...
  nand4  g48(.a(new_n53_), .b(new_n30_), .c(new_n42_), .d(new_n28_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n26_), .c(x13), .O(z07));
  nand4  g50(.a(x13), .b(new_n61_), .c(x05), .d(new_n28_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n70_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n42_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  inv1   g54(.a(new_n27_), .O(new_n80_));
