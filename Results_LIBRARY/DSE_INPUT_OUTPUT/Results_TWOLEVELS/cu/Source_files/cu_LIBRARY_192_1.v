...
module FAU ( 
  ...
  nand2  g12(.a(x06), .b(new_n28_), .O(new_n38_));
  ...
  nor2   g25(.a(x13), .b(new_n28_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n30_), .c(new_n26_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n50_), .c(new_n38_), .O(z04));
  ...
  nand4  g42(.a(new_n43_), .b(new_n67_), .c(new_n28_), .d(x02), .O(new_n68_));
  ...
  nand3  g46(.a(new_n51_), .b(new_n30_), .c(new_n26_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n38_), .O(z07));
  ...
  nor2   g52(.a(new_n51_), .b(new_n67_), .O(z09));
