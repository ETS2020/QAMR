...
module FAU ( 
  ...
  nand3  g19(.a(new_n35_), .b(x01), .c(new_n26_), .O(new_n45_));
  ...
  nor3   g24(.a(x02), .b(new_n49_), .c(new_n26_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand4  g27(.a(x05), .b(x04), .c(new_n33_), .d(new_n35_), .O(new_n53_));
  ...
  aoi21  g44(.a(new_n49_), .b(x00), .c(x13), .O(new_n70_));
  ...
  nor3   g52(.a(z03), .b(new_n46_), .c(new_n77_), .O(z09));
