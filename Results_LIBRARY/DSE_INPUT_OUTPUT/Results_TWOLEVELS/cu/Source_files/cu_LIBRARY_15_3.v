...
module FAU ( 
  ...
  nand4  g21(.a(new_n37_), .b(new_n29_), .c(new_n46_), .d(x00), .O(new_n47_));
  ...
  nand4  g27(.a(new_n27_), .b(x05), .c(new_n31_), .d(new_n37_), .O(new_n53_));
  ...
  nand3  g38(.a(new_n63_), .b(x01), .c(new_n51_), .O(new_n64_));
  ...
  nand4  g56(.a(new_n81_), .b(new_n36_), .c(x06), .d(new_n37_), .O(new_n82_));
