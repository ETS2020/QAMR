...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(new_n43_), .c(new_n30_), .O(new_n47_));
  ...
  nand3  g38(.a(new_n49_), .b(new_n27_), .c(x02), .O(new_n65_));
  oai21  g39(.a(new_n64_), .b(new_n62_), .c(new_n65_), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(new_n40_), .O(new_n67_));
  nand4  g41(.a(new_n49_), .b(new_n27_), .c(x02), .d(new_n41_), .O(new_n68_));
