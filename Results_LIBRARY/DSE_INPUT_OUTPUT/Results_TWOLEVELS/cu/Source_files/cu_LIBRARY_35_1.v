...
module FAU ( 
  ...
  nand2  g45(.a(new_n71_), .b(new_n27_), .O(z08));
  nand2  g46(.a(x13), .b(x06), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n27_), .O(z09));
  inv1   g48(.a(new_n33_), .O(new_n75_));
  nand4  g49(.a(new_n75_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n76_));
