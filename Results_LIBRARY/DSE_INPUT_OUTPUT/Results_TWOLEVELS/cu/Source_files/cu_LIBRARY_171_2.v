...
module FAU ( 
  ...
  nand3  g19(.a(new_n44_), .b(new_n28_), .c(new_n34_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n33_), .O(z02));
  ...
  nand4  g28(.a(new_n53_), .b(x09), .c(x05), .d(new_n28_), .O(new_n54_));
  ...
  aoi21  g32(.a(new_n57_), .b(x09), .c(new_n26_), .O(z05));
  ...
  nand3  g50(.a(new_n75_), .b(new_n34_), .c(new_n35_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n33_), .O(z07));
  ...
  nand4  g59(.a(new_n84_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n85_));
