...
module FAU ( 
  ...
  nand2  g20(.a(new_n44_), .b(x01), .O(new_n47_));
  nand2  g21(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(z04));
  inv1   g23(.a(x01), .O(new_n50_));
  nor3   g24(.a(x02), .b(new_n50_), .c(new_n46_), .O(new_n51_));
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(x13), .O(z05));
  nand3  g27(.a(new_n43_), .b(x05), .c(x04), .O(new_n54_));
  ...
  nand2  g33(.a(new_n59_), .b(new_n46_), .O(new_n60_));
  ...
  aoi21  g44(.a(x01), .b(new_n46_), .c(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n72_));
  oai21  g46(.a(new_n72_), .b(x02), .c(new_n48_), .O(z07));
  ...
  nor3   g52(.a(new_n32_), .b(new_n42_), .c(new_n78_), .O(z09));
  nand4  g53(.a(new_n33_), .b(new_n29_), .c(x06), .d(new_n35_), .O(new_n80_));
