...
module FAU ( 
  ...
  nand3  g19(.a(new_n35_), .b(new_n26_), .c(x00), .O(new_n45_));
  inv1   g20(.a(x13), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand4  g24(.a(new_n33_), .b(new_n35_), .c(x01), .d(new_n49_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x08), .c(x05), .d(new_n28_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n33_), .b(new_n35_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x08), .c(x05), .d(new_n28_), .O(new_n56_));
  ...
  oai21  g37(.a(x10), .b(new_n26_), .c(x08), .O(new_n63_));
  ...
  aoi21  g46(.a(new_n71_), .b(x01), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n34_), .O(z07));
