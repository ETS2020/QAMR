...
module FAU ( 
  ...
  aoi21  g20(.a(new_n45_), .b(new_n41_), .c(x00), .O(z02));
  nand4  g21(.a(new_n35_), .b(new_n30_), .c(new_n41_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n42_), .c(x05), .d(new_n26_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand4  g25(.a(new_n44_), .b(new_n35_), .c(new_n30_), .d(x00), .O(new_n52_));
  aoi21  g26(.a(new_n52_), .b(x00), .c(new_n41_), .O(z05));
  ...
  nand3  g50(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n33_), .O(z10));
  zero   g52(.O(z04));
endmodule
