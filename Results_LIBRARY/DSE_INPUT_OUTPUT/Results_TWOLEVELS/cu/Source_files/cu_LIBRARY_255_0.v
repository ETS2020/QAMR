...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n37_), .c(new_n43_), .d(x12), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x12), .c(x01), .O(z02));
  inv1   g21(.a(x01), .O(new_n47_));
  nand4  g22(.a(new_n36_), .b(new_n32_), .c(new_n47_), .d(x00), .O(new_n48_));
  ...
  nand4  g28(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n35_), .O(z04));
  nand3  g30(.a(new_n32_), .b(x01), .c(x00), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n54_), .c(new_n35_), .O(z05));
  ...
  aoi21  g44(.a(new_n59_), .b(new_n47_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n71_));
  ...
  nor3   g52(.a(new_n26_), .b(new_n43_), .c(new_n77_), .O(z09));
  nand4  g53(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n79_));
