...
module FAU ( 
  ...
  aoi21  g01(.a(new_n26_), .b(x08), .c(x03), .O(new_n27_));
  ...
  nand2  g10(.a(new_n26_), .b(x08), .O(new_n36_));
  ...
  nand4  g22(.a(new_n36_), .b(new_n45_), .c(x05), .d(new_n32_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n35_), .c(new_n28_), .O(new_n50_));
  ...
  nand3  g40(.a(new_n59_), .b(new_n26_), .c(x01), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(new_n67_));
  ...
  nand4  g45(.a(new_n36_), .b(new_n45_), .c(new_n29_), .d(x02), .O(new_n71_));
