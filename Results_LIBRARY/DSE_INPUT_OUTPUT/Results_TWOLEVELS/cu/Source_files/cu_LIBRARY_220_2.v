...
module FAU ( 
  ...
  nand2  g23(.a(new_n37_), .b(new_n34_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n35_), .c(new_n44_), .d(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n26_), .c(x13), .O(z03));
  nor2   g27(.a(x02), .b(new_n44_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n50_), .c(new_n43_), .O(new_n54_));
  ...
  nand4  g43(.a(new_n60_), .b(new_n26_), .c(new_n36_), .d(x02), .O(new_n69_));
  ...
  nand3  g47(.a(x11), .b(new_n44_), .c(new_n43_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x05), .c(new_n28_), .O(new_n74_));
