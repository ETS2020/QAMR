...
module FAU ( 
  ...
  nand3  g32(.a(new_n46_), .b(x05), .c(new_n29_), .O(new_n62_));
  nand2  g33(.a(new_n62_), .b(new_n57_), .O(new_n63_));
  nand3  g34(.a(new_n63_), .b(x04), .c(new_n26_), .O(new_n64_));
  nand2  g35(.a(new_n64_), .b(new_n40_), .O(z08));
  nand2  g36(.a(x13), .b(x06), .O(new_n66_));
  nand2  g37(.a(new_n66_), .b(new_n40_), .O(z09));
  nand3  g38(.a(new_n28_), .b(x06), .c(new_n26_), .O(new_n68_));
