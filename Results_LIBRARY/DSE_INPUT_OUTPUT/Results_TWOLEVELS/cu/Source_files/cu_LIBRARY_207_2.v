...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n30_), .c(new_n31_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n46_));
  ...
  nand4  g33(.a(new_n58_), .b(x04), .c(new_n35_), .d(new_n31_), .O(new_n59_));
  inv1   g34(.a(new_n59_), .O(z06));
  nand4  g35(.a(new_n43_), .b(x05), .c(new_n26_), .d(new_n30_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n31_), .c(x03), .O(z07));
  nand4  g37(.a(x13), .b(new_n49_), .c(x05), .d(new_n30_), .O(new_n63_));
  nand4  g38(.a(new_n43_), .b(new_n27_), .c(x02), .d(new_n31_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x04), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n31_), .c(x03), .O(z08));
  inv1   g42(.a(x06), .O(new_n68_));
  nor3   g43(.a(z04), .b(new_n43_), .c(new_n68_), .O(z09));
  nand4  g44(.a(new_n29_), .b(x06), .c(new_n35_), .d(new_n31_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z10));
  nor2   g46(.a(x03), .b(new_n31_), .O(z05));
endmodule
