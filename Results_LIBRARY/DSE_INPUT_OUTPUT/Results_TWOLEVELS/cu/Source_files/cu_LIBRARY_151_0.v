...
module FAU ( 
  ...
  nand4  g11(.a(x13), .b(new_n26_), .c(x04), .d(x02), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(new_n36_), .c(x03), .O(z01));
  inv1   g13(.a(x03), .O(new_n39_));
  nor2   g14(.a(x01), .b(x00), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(new_n35_), .c(new_n39_), .d(new_n34_), .O(new_n41_));
  aoi21  g16(.a(new_n41_), .b(x05), .c(x13), .O(z02));
  inv1   g17(.a(x01), .O(new_n43_));
  nand4  g18(.a(new_n39_), .b(new_n34_), .c(new_n43_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n27_), .c(x05), .d(new_n35_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n39_), .b(new_n34_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n27_), .c(x05), .d(new_n35_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n43_), .c(new_n48_), .O(new_n53_));
  ...
  nand4  g41(.a(new_n66_), .b(x05), .c(x04), .d(new_n39_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z06));
  oai21  g43(.a(x01), .b(x00), .c(new_n26_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n35_), .c(new_n39_), .d(new_n34_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(x05), .c(x13), .O(z07));
  nor2   g46(.a(x03), .b(x02), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n57_), .c(x05), .d(x04), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(new_n27_), .O(z08));
  and2   g49(.a(x13), .b(x06), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x06), .c(new_n39_), .O(new_n77_));
