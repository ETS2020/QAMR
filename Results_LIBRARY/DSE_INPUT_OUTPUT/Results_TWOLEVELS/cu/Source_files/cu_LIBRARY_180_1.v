...
module FAU ( 
  ...
  aoi21  g27(.a(new_n45_), .b(new_n42_), .c(new_n52_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(new_n26_), .O(z05));
  ...
  oai21  g34(.a(new_n59_), .b(new_n55_), .c(new_n26_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n52_), .O(new_n61_));
  inv1   g36(.a(x09), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n26_), .c(x00), .O(new_n63_));
  ...
  nand3  g42(.a(new_n43_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  aoi21  g46(.a(x01), .b(new_n52_), .c(x13), .O(new_n72_));
  ...
  nor3   g54(.a(z04), .b(new_n43_), .c(new_n79_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n82_));
