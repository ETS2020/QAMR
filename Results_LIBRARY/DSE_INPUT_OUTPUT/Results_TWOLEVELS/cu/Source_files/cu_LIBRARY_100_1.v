...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(z03));
  nor3   g23(.a(x02), .b(new_n44_), .c(new_n32_), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n51_));
  ...
  oai21  g45(.a(new_n71_), .b(x02), .c(new_n33_), .O(z07));
