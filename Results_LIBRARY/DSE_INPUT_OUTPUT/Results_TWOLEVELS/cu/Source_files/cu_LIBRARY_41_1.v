...
module FAU ( 
  ...
  nor2   g31(.a(x11), .b(new_n45_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  inv1   g33(.a(x08), .O(new_n59_));
  nand3  g34(.a(new_n59_), .b(new_n45_), .c(new_n26_), .O(new_n60_));
  ...
  aoi21  g40(.a(x01), .b(new_n26_), .c(x13), .O(new_n66_));
  ...
  nor3   g49(.a(z04), .b(new_n47_), .c(new_n74_), .O(z09));
