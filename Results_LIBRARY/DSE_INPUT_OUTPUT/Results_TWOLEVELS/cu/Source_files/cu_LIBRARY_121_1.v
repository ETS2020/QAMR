...
module FAU ( 
  ...
  aoi21  g56(.a(new_n52_), .b(x01), .c(new_n42_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(x06), .c(new_n34_), .d(x01), .O(new_n84_));
