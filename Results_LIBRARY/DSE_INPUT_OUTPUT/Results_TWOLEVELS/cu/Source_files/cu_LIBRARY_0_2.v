...
module FAU ( 
  ...
  nand4  g13(.a(new_n38_), .b(new_n30_), .c(new_n26_), .d(new_n27_), .O(new_n39_));
  ...
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(new_n30_), .d(new_n26_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x05), .c(new_n42_), .O(z04));
  ...
  oai21  g50(.a(new_n42_), .b(x00), .c(new_n28_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n41_), .c(new_n30_), .d(new_n26_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n74_), .O(z07));
  ...
  nor3   g59(.a(new_n73_), .b(new_n41_), .c(new_n84_), .O(z09));
