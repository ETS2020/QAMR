...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n32_), .d(new_n28_), .O(new_n38_));
  ...
  nor2   g18(.a(new_n35_), .b(new_n29_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n32_), .c(new_n43_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n28_), .c(new_n42_), .d(new_n41_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x06), .c(x13), .O(z02));
  nand4  g23(.a(new_n43_), .b(new_n28_), .c(new_n42_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x06), .c(x05), .d(new_n32_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z03));
  nor2   g27(.a(x02), .b(new_n42_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n46_), .c(new_n41_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x06), .c(x13), .O(z04));
  nand3  g30(.a(new_n53_), .b(new_n46_), .c(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x06), .c(x13), .O(z05));
  inv1   g32(.a(new_n26_), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n36_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n36_), .b(x06), .c(new_n29_), .d(x02), .O(new_n69_));
  oai21  g44(.a(new_n68_), .b(x02), .c(new_n69_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n43_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n58_), .O(z06));
  nand4  g47(.a(new_n44_), .b(new_n32_), .c(new_n43_), .d(new_n28_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(x06), .c(x13), .O(z07));
  ...
  nand2  g54(.a(new_n79_), .b(new_n58_), .O(z09));
