...
module FAU ( 
  ...
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n54_));
  ...
  nand3  g39(.a(new_n64_), .b(x01), .c(new_n43_), .O(new_n65_));
  ...
  nand3  g43(.a(new_n68_), .b(x05), .c(new_n33_), .O(new_n69_));
  nand3  g44(.a(new_n46_), .b(new_n30_), .c(x02), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n69_), .c(x09), .O(new_n71_));
  nand4  g46(.a(new_n46_), .b(x12), .c(new_n30_), .d(x02), .O(new_n72_));
  ...
  nor2   g51(.a(new_n30_), .b(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x13), .c(new_n59_), .d(new_n26_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n76_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n36_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  nand2  g56(.a(x13), .b(x06), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n37_), .O(z09));
  nand4  g58(.a(new_n32_), .b(new_n37_), .c(x06), .d(new_n36_), .O(new_n84_));
