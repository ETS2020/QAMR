...
module FAU ( 
  ...
  nand4  g22(.a(new_n37_), .b(new_n34_), .c(new_n47_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n30_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand4  g27(.a(new_n37_), .b(new_n34_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x07), .c(x05), .d(new_n30_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z04));
  nand4  g31(.a(new_n37_), .b(new_n34_), .c(x01), .d(x00), .O(new_n57_));
  inv1   g32(.a(new_n57_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(x07), .c(x05), .d(new_n30_), .O(new_n59_));
  ...
  nand2  g38(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  ...
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n34_), .d(new_n47_), .O(new_n70_));
  ...
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n62_), .c(x05), .d(new_n34_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n37_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n27_), .O(z08));
  inv1   g55(.a(x06), .O(new_n81_));
  nor3   g56(.a(new_n28_), .b(new_n46_), .c(new_n81_), .O(z09));
  nand3  g57(.a(new_n33_), .b(x06), .c(new_n37_), .O(new_n83_));
