...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n35_), .c(new_n31_), .d(new_n41_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x00), .O(z02));
  inv1   g21(.a(x00), .O(new_n47_));
  nor2   g22(.a(new_n45_), .b(new_n47_), .O(z03));
  nand3  g23(.a(new_n31_), .b(x01), .c(new_n47_), .O(new_n49_));
  nand4  g24(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n50_));
  ...
  aoi21  g31(.a(x09), .b(new_n41_), .c(new_n47_), .O(new_n57_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n59_), .c(new_n42_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n65_));
  nand4  g40(.a(new_n34_), .b(new_n42_), .c(new_n28_), .d(x02), .O(new_n66_));
  ...
  oai21  g44(.a(new_n34_), .b(x01), .c(new_n42_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(new_n28_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n27_), .c(new_n35_), .d(new_n31_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n34_), .O(z07));
  nand4  g48(.a(x13), .b(new_n55_), .c(x05), .d(new_n31_), .O(new_n74_));
  ...
  nand3  g52(.a(new_n34_), .b(x13), .c(x06), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z09));
  nand3  g54(.a(new_n30_), .b(x06), .c(new_n35_), .O(new_n80_));
