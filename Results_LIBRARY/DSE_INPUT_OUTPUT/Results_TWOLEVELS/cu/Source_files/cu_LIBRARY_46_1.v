...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    ...
    new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_, new_n52_,
  ...
  aoi21  g09(.a(new_n34_), .b(new_n30_), .c(z04), .O(z00));
  ...
  nand4  g21(.a(new_n36_), .b(new_n29_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  aoi21  g25(.a(new_n45_), .b(x00), .c(new_n42_), .O(z05));
  nand4  g26(.a(new_n27_), .b(new_n43_), .c(new_n32_), .d(x02), .O(new_n52_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n42_), .c(new_n26_), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n57_), .c(new_n43_), .O(new_n60_));
  nand4  g35(.a(new_n60_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(x02), .c(new_n52_), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x04), .c(new_n36_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(z06));
  inv1   g39(.a(z02), .O(new_n65_));
  aoi21  g40(.a(new_n42_), .b(new_n26_), .c(x13), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n65_), .O(z07));
  nand4  g43(.a(x13), .b(new_n54_), .c(x05), .d(new_n29_), .O(new_n69_));
  nand3  g44(.a(new_n43_), .b(new_n32_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n72_));
  ...
  nand3  g51(.a(new_n76_), .b(x06), .c(new_n36_), .O(new_n77_));
