...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n35_), .c(new_n42_), .d(new_n41_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x10), .c(x02), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n34_), .c(new_n42_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x10), .c(x05), .d(new_n27_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  nand4  g26(.a(new_n35_), .b(new_n34_), .c(x01), .d(new_n41_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x10), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n45_), .b(new_n35_), .c(x01), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x10), .c(x02), .O(z05));
  ...
  nand4  g42(.a(new_n67_), .b(new_n58_), .c(x05), .d(new_n34_), .O(new_n68_));
  ...
  oai21  g47(.a(x10), .b(x01), .c(x00), .O(new_n73_));
  oai21  g48(.a(x10), .b(new_n42_), .c(new_n41_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(new_n73_), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(x10), .c(x02), .O(z07));
  nand2  g52(.a(x05), .b(new_n34_), .O(new_n78_));
  nand3  g53(.a(x13), .b(new_n59_), .c(x10), .O(new_n79_));
  oai21  g54(.a(new_n79_), .b(new_n78_), .c(new_n69_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n35_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  nand2  g57(.a(x13), .b(x06), .O(new_n83_));
  oai21  g58(.a(x10), .b(x02), .c(new_n83_), .O(z09));
  inv1   g59(.a(x10), .O(new_n85_));
  aoi21  g60(.a(x06), .b(new_n35_), .c(new_n85_), .O(new_n86_));
  nand3  g61(.a(x06), .b(new_n29_), .c(new_n35_), .O(new_n87_));
