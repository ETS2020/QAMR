...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n45_));
  ...
  nand4  g25(.a(new_n44_), .b(x10), .c(x05), .d(new_n28_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n34_), .c(new_n35_), .d(new_n42_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x10), .c(new_n26_), .O(z04));
  nand4  g29(.a(new_n52_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x10), .c(new_n26_), .O(z05));
  ...
  nand3  g40(.a(new_n44_), .b(new_n37_), .c(x02), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n70_), .b(x01), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n74_));
