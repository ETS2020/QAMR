...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n31_), .c(new_n36_), .d(new_n29_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x13), .c(new_n32_), .O(z02));
  inv1   g19(.a(x01), .O(new_n45_));
  nand3  g20(.a(new_n29_), .b(new_n45_), .c(x00), .O(new_n46_));
  nor2   g21(.a(x13), .b(new_n32_), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n31_), .c(new_n36_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z03));
  nor2   g24(.a(x03), .b(x02), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n47_), .c(new_n31_), .d(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(x00), .c(new_n45_), .O(z05));
  inv1   g27(.a(x13), .O(new_n53_));
  nand4  g28(.a(new_n27_), .b(new_n53_), .c(new_n32_), .d(x02), .O(new_n54_));
  ...
  nand3  g35(.a(new_n60_), .b(new_n45_), .c(new_n26_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n53_), .O(new_n62_));
  ...
  aoi21  g41(.a(x01), .b(new_n26_), .c(x13), .O(new_n67_));
  ...
  nor3   g49(.a(z04), .b(new_n53_), .c(new_n74_), .O(z09));
