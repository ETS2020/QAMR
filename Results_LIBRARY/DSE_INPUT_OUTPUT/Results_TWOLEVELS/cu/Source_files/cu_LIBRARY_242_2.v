...
module FAU ( 
  ...
  nor2   g15(.a(x12), .b(new_n26_), .O(new_n41_));
  ...
  nand4  g23(.a(new_n26_), .b(new_n31_), .c(new_n48_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n47_), .c(x05), .d(new_n28_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  inv1   g27(.a(x00), .O(new_n53_));
  nand4  g28(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n53_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n47_), .c(x05), .d(new_n28_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(z04));
  nand3  g32(.a(new_n31_), .b(x01), .c(x00), .O(new_n58_));
  nand4  g33(.a(new_n47_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(z05));
  inv1   g35(.a(x07), .O(new_n61_));
  nor2   g36(.a(x09), .b(x01), .O(new_n62_));
  nor2   g37(.a(x11), .b(new_n48_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(x00), .O(new_n64_));
  nor2   g39(.a(x08), .b(x01), .O(new_n65_));
  nor2   g40(.a(x10), .b(new_n48_), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n53_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n47_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n27_), .c(new_n61_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n47_), .b(new_n32_), .c(new_n26_), .d(x02), .O(new_n70_));
  ...
  nand4  g48(.a(new_n47_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n42_), .O(z07));
  nand4  g50(.a(x13), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n76_));
  nand3  g51(.a(new_n47_), .b(new_n32_), .c(x02), .O(new_n77_));
  ...
  nor3   g56(.a(new_n41_), .b(new_n47_), .c(new_n81_), .O(z09));
