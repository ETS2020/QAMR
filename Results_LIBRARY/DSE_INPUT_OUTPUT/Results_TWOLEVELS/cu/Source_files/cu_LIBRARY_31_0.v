...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n27_), .c(new_n43_), .d(x00), .O(new_n44_));
  inv1   g18(.a(new_n44_), .O(new_n45_));
  nand4  g19(.a(new_n45_), .b(new_n42_), .c(x05), .d(new_n29_), .O(new_n46_));
  inv1   g20(.a(new_n46_), .O(z03));
  nor2   g21(.a(x03), .b(x02), .O(new_n48_));
  nand4  g22(.a(new_n48_), .b(new_n42_), .c(x05), .d(new_n29_), .O(new_n49_));
  aoi21  g23(.a(new_n49_), .b(x01), .c(x00), .O(z04));
  inv1   g24(.a(x00), .O(new_n51_));
  nor3   g25(.a(x02), .b(new_n43_), .c(new_n51_), .O(new_n52_));
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nand4  g28(.a(new_n34_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n55_));
  ...
  nand3  g35(.a(new_n61_), .b(x01), .c(new_n51_), .O(new_n62_));
  aoi21  g36(.a(new_n62_), .b(new_n60_), .c(new_n42_), .O(new_n63_));
  ...
  nand4  g41(.a(new_n42_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n68_));
  oai21  g42(.a(new_n68_), .b(x02), .c(new_n34_), .O(z07));
  nand4  g43(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n70_));
  nand3  g44(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n71_));
