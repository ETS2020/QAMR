...
module FAU ( 
  ...
  nand4  g31(.a(new_n42_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n33_), .O(z05));
  nand3  g33(.a(x05), .b(new_n35_), .c(new_n46_), .O(new_n59_));
  ...
  nand3  g38(.a(new_n42_), .b(new_n37_), .c(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(new_n59_), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x00), .O(new_n66_));
  inv1   g41(.a(x08), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x01), .c(new_n51_), .O(new_n68_));
  inv1   g43(.a(x11), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x01), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n68_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x13), .c(new_n62_), .d(new_n60_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x05), .c(new_n35_), .O(new_n74_));
  nand4  g49(.a(new_n42_), .b(new_n26_), .c(new_n37_), .d(x02), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n74_), .c(new_n66_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n34_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n33_), .O(z06));
  nand3  g53(.a(x10), .b(x01), .c(new_n51_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n42_), .c(x05), .d(new_n28_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(new_n34_), .c(new_n35_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n33_), .O(z07));
  nand2  g58(.a(x05), .b(new_n35_), .O(new_n84_));
  nand2  g59(.a(x13), .b(new_n62_), .O(new_n85_));
  oai21  g60(.a(new_n85_), .b(new_n84_), .c(new_n64_), .O(new_n86_));
  nand4  g61(.a(new_n86_), .b(new_n33_), .c(x04), .d(new_n34_), .O(new_n87_));
  inv1   g62(.a(new_n87_), .O(z08));
  inv1   g63(.a(x06), .O(new_n89_));
  nor3   g64(.a(new_n27_), .b(new_n42_), .c(new_n89_), .O(z09));
  nand2  g65(.a(x05), .b(x02), .O(new_n91_));
  nand3  g66(.a(new_n91_), .b(x06), .c(new_n34_), .O(new_n92_));
  nand2  g67(.a(new_n92_), .b(new_n33_), .O(z10));
endmodule
