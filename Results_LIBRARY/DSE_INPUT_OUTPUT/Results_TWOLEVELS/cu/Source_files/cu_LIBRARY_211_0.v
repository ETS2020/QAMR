...
module FAU ( 
  ...
  nor2   g00(.a(x08), .b(x06), .O(new_n26_));
  ...
  nand4  g26(.a(new_n35_), .b(new_n45_), .c(x05), .d(new_n32_), .O(new_n52_));
  nor3   g27(.a(new_n52_), .b(x03), .c(x02), .O(z07));
  nand2  g28(.a(z07), .b(x01), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(new_n42_), .O(z05));
  nand4  g30(.a(x05), .b(new_n28_), .c(x01), .d(x00), .O(new_n56_));
  ...
  nand2  g45(.a(new_n64_), .b(new_n43_), .O(new_n71_));
  nand2  g46(.a(x10), .b(x01), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n42_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n70_), .c(x06), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n69_), .c(new_n45_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n59_), .c(new_n57_), .d(x05), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n63_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n36_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z06));
  nand2  g55(.a(x05), .b(new_n28_), .O(new_n81_));
  nand2  g56(.a(x13), .b(new_n59_), .O(new_n82_));
  oai21  g57(.a(new_n82_), .b(new_n81_), .c(new_n61_), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n84_));
  ...
  nand2  g63(.a(new_n88_), .b(new_n35_), .O(z10));
endmodule
