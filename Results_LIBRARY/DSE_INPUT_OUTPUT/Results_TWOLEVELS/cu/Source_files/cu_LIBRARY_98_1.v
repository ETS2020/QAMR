...
module FAU ( 
  ...
  nor2   g12(.a(new_n26_), .b(x01), .O(new_n38_));
  ...
  nand3  g19(.a(new_n44_), .b(new_n31_), .c(new_n41_), .O(new_n45_));
  ...
  nand3  g23(.a(new_n31_), .b(x01), .c(new_n41_), .O(new_n49_));
  nand4  g24(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n39_), .O(z04));
  inv1   g26(.a(x01), .O(new_n52_));
  nor3   g27(.a(x02), .b(new_n52_), .c(new_n41_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n54_));
  ...
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n42_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n56_), .d(x05), .O(new_n65_));
  nand3  g40(.a(new_n42_), .b(new_n28_), .c(x02), .O(new_n66_));
  ...
  aoi21  g44(.a(x03), .b(x01), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n39_), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n31_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n66_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n26_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n39_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  nor3   g52(.a(new_n38_), .b(new_n42_), .c(new_n77_), .O(z09));
  nand3  g53(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n79_));
