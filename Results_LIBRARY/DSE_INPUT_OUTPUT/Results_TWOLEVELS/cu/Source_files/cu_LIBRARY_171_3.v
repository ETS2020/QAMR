...
module FAU ( 
  ...
  nand3  g47(.a(x09), .b(x01), .c(new_n43_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n48_), .c(x05), .d(new_n29_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n35_), .c(new_n36_), .O(new_n76_));
