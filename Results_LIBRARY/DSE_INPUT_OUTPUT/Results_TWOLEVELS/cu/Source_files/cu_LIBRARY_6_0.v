...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(new_n27_), .c(new_n42_), .d(x00), .O(new_n43_));
  ...
  nand4  g22(.a(new_n47_), .b(new_n41_), .c(x05), .d(new_n29_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x01), .c(x00), .O(z04));
  inv1   g24(.a(x00), .O(new_n50_));
  nor3   g25(.a(x02), .b(new_n42_), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z05));
  nand4  g28(.a(new_n35_), .b(new_n41_), .c(new_n30_), .d(x02), .O(new_n54_));
  ...
  nand3  g35(.a(new_n60_), .b(x01), .c(new_n50_), .O(new_n61_));
  ...
  nand4  g41(.a(new_n41_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n27_), .O(new_n69_));
  nand3  g44(.a(new_n41_), .b(new_n30_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  inv1   g48(.a(x06), .O(new_n74_));
  nor3   g49(.a(z02), .b(new_n41_), .c(new_n74_), .O(z09));
  inv1   g50(.a(new_n31_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n77_));
