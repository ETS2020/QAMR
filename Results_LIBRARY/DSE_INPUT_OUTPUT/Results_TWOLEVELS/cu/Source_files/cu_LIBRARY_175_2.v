...
module FAU ( 
  ...
  nand4  g26(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x12), .c(x05), .d(new_n29_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n34_), .b(new_n35_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x12), .c(x05), .d(new_n29_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z05));
  nand4  g34(.a(new_n27_), .b(new_n45_), .c(new_n37_), .d(x02), .O(new_n60_));
  ...
  nand4  g41(.a(new_n66_), .b(x13), .c(new_n26_), .d(new_n61_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n35_), .d(new_n46_), .O(new_n69_));
  ...
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g50(.a(x13), .b(new_n26_), .c(x05), .d(new_n35_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n60_), .O(new_n77_));
