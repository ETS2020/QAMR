...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n30_), .c(new_n42_), .d(x00), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n41_), .c(x05), .d(new_n26_), .O(new_n45_));
  ...
  nand4  g24(.a(new_n49_), .b(new_n41_), .c(x05), .d(new_n26_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nand3  g26(.a(new_n30_), .b(x01), .c(x00), .O(new_n52_));
  nand4  g27(.a(new_n41_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n33_), .O(z05));
  nand4  g29(.a(x05), .b(x04), .c(new_n35_), .d(new_n30_), .O(new_n55_));
  ...
  aoi21  g46(.a(new_n42_), .b(new_n47_), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n73_));
  ...
  nand3  g55(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n81_));
