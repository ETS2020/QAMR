...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n28_), .c(new_n34_), .d(new_n35_), .O(new_n43_));
  nor3   g18(.a(new_n43_), .b(x13), .c(new_n37_), .O(z02));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n34_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nor3   g25(.a(x02), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n52_));
  ...
  oai21  g33(.a(new_n58_), .b(new_n54_), .c(new_n26_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n50_), .O(new_n60_));
  inv1   g35(.a(x09), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n26_), .c(x00), .O(new_n62_));
  ...
  nand3  g41(.a(new_n45_), .b(new_n37_), .c(x02), .O(new_n67_));
  ...
  aoi21  g45(.a(x01), .b(new_n50_), .c(x13), .O(new_n71_));
