...
module FAU ( 
  ...
  nor2   g18(.a(x02), .b(new_n44_), .O(new_n45_));
  nor3   g19(.a(x13), .b(x04), .c(x03), .O(new_n46_));
  nand3  g20(.a(new_n46_), .b(new_n45_), .c(new_n43_), .O(new_n47_));
  aoi21  g21(.a(new_n47_), .b(x01), .c(new_n26_), .O(z04));
  nand3  g22(.a(new_n46_), .b(new_n45_), .c(x00), .O(new_n49_));
  aoi21  g23(.a(new_n49_), .b(x01), .c(new_n26_), .O(z05));
  inv1   g24(.a(x07), .O(new_n51_));
  inv1   g25(.a(x12), .O(new_n52_));
  inv1   g26(.a(x10), .O(new_n53_));
  nand2  g27(.a(new_n53_), .b(new_n43_), .O(new_n54_));
  inv1   g28(.a(x11), .O(new_n55_));
  nand2  g29(.a(new_n55_), .b(x00), .O(new_n56_));
  nand2  g30(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand4  g31(.a(new_n57_), .b(x13), .c(new_n52_), .d(new_n51_), .O(new_n58_));
  inv1   g32(.a(new_n58_), .O(new_n59_));
  nand4  g33(.a(new_n59_), .b(x05), .c(new_n30_), .d(x01), .O(new_n60_));
  inv1   g34(.a(x13), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n26_), .c(x02), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(new_n60_), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(x04), .c(new_n36_), .O(new_n64_));
  inv1   g38(.a(new_n64_), .O(z06));
  nand4  g39(.a(new_n61_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n66_));
  nor3   g40(.a(new_n66_), .b(x02), .c(new_n44_), .O(z07));
  nand4  g41(.a(x13), .b(new_n52_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n62_), .O(new_n69_));
  nand3  g43(.a(new_n69_), .b(x04), .c(new_n36_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n28_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n28_), .O(z09));
  oai21  g47(.a(x02), .b(new_n44_), .c(x05), .O(new_n74_));
  nand3  g48(.a(new_n74_), .b(x06), .c(new_n36_), .O(new_n75_));
