...
module FAU ( 
  ...
  nand4  g25(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n49_), .c(x05), .d(new_n31_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nor2   g29(.a(x03), .b(x02), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n46_), .c(new_n31_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n49_), .c(new_n44_), .O(z05));
  ...
  aoi22  g39(.a(new_n64_), .b(new_n50_), .c(new_n63_), .d(x01), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n60_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n34_), .b(new_n60_), .c(new_n28_), .d(x02), .O(new_n68_));
  ...
  nand3  g46(.a(x11), .b(x01), .c(new_n50_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n35_), .c(new_n27_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n34_), .O(z07));
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n27_), .O(new_n77_));
  nand3  g52(.a(new_n60_), .b(new_n28_), .c(x02), .O(new_n78_));
