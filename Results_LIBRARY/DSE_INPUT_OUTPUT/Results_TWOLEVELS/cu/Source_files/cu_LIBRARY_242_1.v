...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n27_), .c(x05), .d(new_n28_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n27_), .c(x05), .d(new_n28_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nor2   g29(.a(x02), .b(new_n42_), .O(new_n55_));
  nor2   g30(.a(x13), .b(new_n32_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n55_), .c(new_n28_), .d(x00), .O(new_n57_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n68_));
  nand4  g43(.a(new_n60_), .b(new_n27_), .c(new_n32_), .d(x02), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(x04), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n27_), .c(x03), .O(z06));
  aoi21  g47(.a(x01), .b(x00), .c(new_n27_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n28_), .d(new_n31_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(new_n27_), .c(x03), .O(z07));
  nand3  g51(.a(x13), .b(x05), .c(new_n31_), .O(new_n77_));
  nand3  g52(.a(new_n60_), .b(new_n32_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n27_), .c(x04), .d(new_n26_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  oai21  g57(.a(new_n27_), .b(x03), .c(x13), .O(new_n83_));
  nor2   g58(.a(new_n83_), .b(new_n82_), .O(z09));
  oai21  g59(.a(new_n32_), .b(new_n31_), .c(x06), .O(new_n85_));
  aoi21  g60(.a(new_n85_), .b(new_n27_), .c(x03), .O(z10));
endmodule
