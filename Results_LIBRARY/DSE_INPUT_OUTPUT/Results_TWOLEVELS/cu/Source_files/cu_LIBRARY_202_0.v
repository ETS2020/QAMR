...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x10), .c(x05), .d(new_n32_), .O(new_n46_));
  ...
  aoi21  g25(.a(new_n50_), .b(x10), .c(x01), .O(z03));
  nand3  g26(.a(new_n28_), .b(x01), .c(new_n42_), .O(new_n52_));
  nand3  g27(.a(new_n49_), .b(new_n32_), .c(new_n36_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n35_), .O(z04));
  nand3  g29(.a(new_n28_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n35_), .O(z05));
  ...
  oai21  g37(.a(x08), .b(x01), .c(x10), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n42_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n59_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n35_), .b(new_n59_), .c(new_n29_), .d(x02), .O(new_n67_));
  ...
  nor2   g45(.a(x10), .b(x01), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n42_), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g49(.a(x13), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n75_));
  nand3  g50(.a(new_n59_), .b(new_n29_), .c(x02), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z08));
  inv1   g54(.a(x06), .O(new_n80_));
  nor3   g55(.a(new_n26_), .b(new_n59_), .c(new_n80_), .O(z09));
