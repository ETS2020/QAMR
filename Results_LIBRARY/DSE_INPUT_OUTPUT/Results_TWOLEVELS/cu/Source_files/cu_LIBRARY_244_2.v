...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nand3  g21(.a(new_n32_), .b(new_n46_), .c(x00), .O(new_n47_));
  inv1   g22(.a(x13), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n47_), .c(new_n35_), .O(z03));
  nor3   g25(.a(x03), .b(x02), .c(x00), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n37_), .c(new_n48_), .d(x10), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x10), .c(new_n46_), .O(z04));
  nand4  g28(.a(new_n36_), .b(new_n32_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x10), .c(x05), .d(new_n28_), .O(new_n56_));
  ...
  nand3  g37(.a(new_n62_), .b(x10), .c(x01), .O(new_n63_));
  ...
  nand3  g42(.a(new_n67_), .b(new_n46_), .c(new_n66_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n65_), .c(new_n48_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n35_), .b(new_n48_), .c(new_n29_), .d(x02), .O(new_n71_));
  ...
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n59_), .c(x05), .d(new_n32_), .O(new_n78_));
  ...
  nand4  g59(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n85_));
