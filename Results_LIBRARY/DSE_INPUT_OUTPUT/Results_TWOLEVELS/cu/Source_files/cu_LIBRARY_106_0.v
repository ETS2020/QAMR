...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n50_, new_n52_, new_n53_, new_n56_, new_n57_, new_n58_, new_n59_,
  ...
  aoi21  g05(.a(new_n30_), .b(x02), .c(x03), .O(new_n31_));
  nor2   g06(.a(x05), .b(x02), .O(new_n32_));
  aoi21  g07(.a(x05), .b(x04), .c(new_n32_), .O(new_n33_));
  aoi21  g08(.a(new_n33_), .b(new_n31_), .c(new_n29_), .O(z00));
  ...
  nand3  g15(.a(new_n40_), .b(new_n28_), .c(new_n35_), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(z01));
  inv1   g17(.a(x13), .O(new_n43_));
  nand4  g18(.a(new_n28_), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n35_), .c(new_n36_), .O(new_n46_));
  nor3   g21(.a(new_n46_), .b(x01), .c(x00), .O(z02));
  inv1   g22(.a(x01), .O(new_n48_));
  nand3  g23(.a(new_n36_), .b(new_n48_), .c(x00), .O(new_n49_));
  nand4  g24(.a(new_n43_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n28_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand3  g27(.a(new_n36_), .b(x01), .c(new_n52_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n50_), .c(new_n28_), .O(z04));
  nor3   g29(.a(new_n46_), .b(new_n48_), .c(new_n52_), .O(z05));
  inv1   g30(.a(x07), .O(new_n56_));
  nor2   g31(.a(x09), .b(x01), .O(new_n57_));
  nor2   g32(.a(x11), .b(new_n48_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(x00), .O(new_n59_));
  inv1   g34(.a(x10), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x01), .c(new_n52_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n59_), .c(new_n43_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n27_), .c(new_n56_), .d(x05), .O(new_n63_));
  nand3  g38(.a(new_n43_), .b(new_n38_), .c(x02), .O(new_n64_));
