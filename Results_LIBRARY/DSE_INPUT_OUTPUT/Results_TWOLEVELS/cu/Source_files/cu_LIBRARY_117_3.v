...
module FAU ( 
  ...
  nand3  g23(.a(new_n45_), .b(x05), .c(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n26_), .c(new_n31_), .d(new_n48_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n26_), .c(new_n43_), .O(z04));
  nand4  g27(.a(new_n50_), .b(new_n26_), .c(new_n31_), .d(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n26_), .c(new_n43_), .O(z05));
  ...
  nand4  g39(.a(new_n45_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n65_));
  ...
  nor3   g43(.a(new_n49_), .b(x03), .c(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n56_), .c(x05), .d(new_n31_), .O(new_n70_));
  nand3  g45(.a(new_n45_), .b(new_n28_), .c(x02), .O(new_n71_));
