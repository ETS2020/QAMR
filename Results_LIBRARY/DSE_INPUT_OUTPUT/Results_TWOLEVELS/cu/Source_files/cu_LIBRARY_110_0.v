...
module FAU ( 
  ...
  nand4  g18(.a(new_n32_), .b(new_n34_), .c(new_n43_), .d(new_n42_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x06), .c(x05), .d(new_n27_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand3  g22(.a(new_n34_), .b(new_n43_), .c(x00), .O(new_n48_));
  inv1   g23(.a(x13), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n33_), .O(z03));
  nor2   g26(.a(x03), .b(x02), .O(new_n52_));
  inv1   g27(.a(x06), .O(new_n53_));
  nor2   g28(.a(x13), .b(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n52_), .c(new_n36_), .d(x01), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x06), .c(x00), .O(z04));
  nor3   g31(.a(x02), .b(new_n43_), .c(new_n42_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n58_));
  ...
  nand4  g44(.a(new_n33_), .b(new_n49_), .c(new_n35_), .d(x02), .O(new_n70_));
  oai21  g45(.a(new_n69_), .b(x02), .c(new_n70_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n32_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n33_), .O(z06));
  aoi21  g48(.a(new_n53_), .b(new_n42_), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n77_));
  nand3  g52(.a(new_n49_), .b(new_n35_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n33_), .c(x04), .d(new_n32_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  nor2   g56(.a(new_n49_), .b(new_n53_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x06), .c(new_n32_), .O(new_n84_));
