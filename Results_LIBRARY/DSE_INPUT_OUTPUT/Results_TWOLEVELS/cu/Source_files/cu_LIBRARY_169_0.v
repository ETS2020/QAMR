...
module FAU ( 
  ...
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n48_), .O(z05));
  ...
  nand4  g44(.a(new_n69_), .b(new_n56_), .c(new_n55_), .d(new_n28_), .O(new_n70_));
  nand3  g45(.a(new_n36_), .b(new_n42_), .c(new_n29_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n26_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n48_), .O(z06));
  nand4  g49(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n75_));
  nor2   g50(.a(new_n75_), .b(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n77_));
  ...
  nor3   g56(.a(new_n47_), .b(new_n42_), .c(new_n81_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(x06), .c(new_n26_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n48_), .O(z10));
endmodule
