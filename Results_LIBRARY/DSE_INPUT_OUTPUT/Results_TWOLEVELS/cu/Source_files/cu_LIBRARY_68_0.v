...
module FAU ( 
  ...
  aoi21  g25(.a(new_n50_), .b(x06), .c(x01), .O(z03));
  nand3  g26(.a(new_n32_), .b(x01), .c(new_n42_), .O(new_n52_));
  nand3  g27(.a(new_n49_), .b(new_n28_), .c(new_n36_), .O(new_n53_));
  ...
  nand3  g36(.a(new_n61_), .b(x06), .c(new_n43_), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n43_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n72_), .b(new_n66_), .c(new_n60_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n74_));
  nand4  g49(.a(new_n35_), .b(new_n60_), .c(new_n29_), .d(x02), .O(new_n75_));
  ...
  nor2   g53(.a(x06), .b(x01), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(new_n42_), .c(x13), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n81_));
  oai21  g56(.a(new_n81_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g57(.a(x13), .b(new_n59_), .c(x05), .d(new_n32_), .O(new_n83_));
  nand3  g58(.a(new_n60_), .b(new_n29_), .c(x02), .O(new_n84_));
