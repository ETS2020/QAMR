...
module FAU ( 
  ...
  nand2  g11(.a(x05), .b(new_n28_), .O(new_n37_));
  nand3  g12(.a(new_n29_), .b(x04), .c(x02), .O(new_n38_));
  oai21  g13(.a(new_n37_), .b(x02), .c(new_n38_), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(new_n36_), .c(new_n35_), .O(new_n40_));
  inv1   g15(.a(new_n40_), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand4  g18(.a(new_n35_), .b(new_n32_), .c(new_n43_), .d(new_n42_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x07), .c(x05), .d(new_n28_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  inv1   g22(.a(new_n37_), .O(new_n48_));
  nor2   g23(.a(x03), .b(x02), .O(new_n49_));
  inv1   g24(.a(x07), .O(new_n50_));
  nor2   g25(.a(x13), .b(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n49_), .c(new_n48_), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x07), .c(x01), .O(z03));
  inv1   g28(.a(x13), .O(new_n54_));
  nand4  g29(.a(new_n35_), .b(new_n32_), .c(x01), .d(new_n42_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n54_), .c(x05), .d(new_n28_), .O(new_n57_));
  inv1   g32(.a(new_n57_), .O(z04));
  nor3   g33(.a(x02), .b(new_n43_), .c(new_n42_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n60_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n64_), .c(new_n54_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n62_), .c(new_n50_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n54_), .b(new_n29_), .c(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(new_n50_), .b(new_n43_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n62_), .c(x05), .d(new_n32_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n69_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n35_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n36_), .O(z08));
  inv1   g54(.a(x06), .O(new_n80_));
  nor3   g55(.a(new_n26_), .b(new_n54_), .c(new_n80_), .O(z09));
  nand3  g56(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n36_), .O(z10));
endmodule
