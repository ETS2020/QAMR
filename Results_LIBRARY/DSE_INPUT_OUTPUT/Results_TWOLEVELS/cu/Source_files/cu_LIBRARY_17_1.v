...
module FAU ( 
  ...
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n56_), .d(x11), .O(new_n63_));
  ...
  oai21  g45(.a(new_n70_), .b(x02), .c(new_n35_), .O(z07));
  nand2  g46(.a(x05), .b(new_n28_), .O(new_n72_));
  nand3  g47(.a(x13), .b(new_n56_), .c(x11), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n72_), .c(new_n66_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n39_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  inv1   g51(.a(x06), .O(new_n77_));
  aoi21  g52(.a(x11), .b(new_n77_), .c(new_n26_), .O(z09));
  inv1   g53(.a(new_n32_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x06), .c(new_n39_), .O(new_n80_));
