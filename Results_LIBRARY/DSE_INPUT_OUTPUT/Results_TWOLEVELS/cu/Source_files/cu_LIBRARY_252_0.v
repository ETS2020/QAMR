...
module FAU ( 
  ...
  nand2  g15(.a(new_n35_), .b(new_n27_), .O(new_n41_));
  ...
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(x02), .c(new_n69_), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n73_));
  ...
  nor3   g53(.a(z02), .b(new_n42_), .c(new_n78_), .O(z09));
