...
module FAU ( 
  ...
  aoi21  g27(.a(new_n52_), .b(new_n40_), .c(new_n41_), .O(z04));
  ...
  oai21  g41(.a(new_n51_), .b(new_n50_), .c(new_n41_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(x00), .O(new_n69_));
  aoi21  g43(.a(new_n41_), .b(x00), .c(x13), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n34_), .O(new_n71_));
  oai21  g45(.a(new_n71_), .b(x02), .c(new_n69_), .O(z07));
  nand4  g46(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n55_), .O(new_n74_));
