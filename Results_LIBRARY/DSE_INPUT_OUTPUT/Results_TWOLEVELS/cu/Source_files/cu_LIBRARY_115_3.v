...
module FAU ( 
  ...
  aoi21  g46(.a(x08), .b(x01), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g49(.a(x13), .b(new_n60_), .c(x05), .d(new_n36_), .O(new_n75_));
  ...
  nand4  g56(.a(new_n81_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n82_));
