...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n28_), .c(new_n46_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n45_), .c(new_n31_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n45_), .c(x05), .d(new_n30_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor3   g29(.a(x02), .b(new_n46_), .c(new_n50_), .O(new_n55_));
  ...
  nand4  g34(.a(new_n45_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n60_));
  nor2   g35(.a(new_n60_), .b(x02), .O(z07));
  nand3  g36(.a(new_n45_), .b(new_n31_), .c(x04), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n58_), .c(new_n40_), .O(z08));
  inv1   g38(.a(x06), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n31_), .c(new_n45_), .O(z09));
  nand3  g40(.a(new_n27_), .b(x06), .c(new_n26_), .O(new_n66_));
