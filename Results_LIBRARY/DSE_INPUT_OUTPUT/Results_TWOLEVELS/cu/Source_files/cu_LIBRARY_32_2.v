...
module FAU ( 
  ...
  nand4  g27(.a(new_n52_), .b(x09), .c(x05), .d(new_n29_), .O(new_n53_));
  ...
  oai21  g35(.a(x11), .b(new_n26_), .c(x09), .O(new_n61_));
  ...
  nand3  g42(.a(new_n47_), .b(new_n30_), .c(x02), .O(new_n68_));
  ...
  inv1   g46(.a(x09), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x01), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n37_), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n33_), .O(new_n76_));
  ...
  nor3   g55(.a(new_n27_), .b(new_n47_), .c(new_n80_), .O(z09));
