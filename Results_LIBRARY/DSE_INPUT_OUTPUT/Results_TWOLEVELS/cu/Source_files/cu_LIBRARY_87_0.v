...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(x08), .c(x05), .d(new_n29_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(x08), .b(x05), .c(new_n29_), .d(new_n42_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n27_), .c(x01), .d(new_n40_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x08), .c(x13), .O(z04));
  nand4  g29(.a(new_n42_), .b(new_n27_), .c(x01), .d(x00), .O(new_n55_));
  ...
  nor2   g43(.a(x13), .b(new_n34_), .O(new_n69_));
  ...
  nand3  g48(.a(new_n69_), .b(x05), .c(new_n29_), .O(new_n74_));
  nor3   g49(.a(new_n74_), .b(x03), .c(x02), .O(z07));
  inv1   g50(.a(new_n26_), .O(new_n76_));
  nand4  g51(.a(x13), .b(new_n60_), .c(x05), .d(new_n27_), .O(new_n77_));
