...
module FAU ( 
  ...
  nand4  g22(.a(new_n26_), .b(new_n28_), .c(new_n47_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand4  g27(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nand3  g31(.a(new_n28_), .b(x01), .c(x00), .O(new_n57_));
  nand4  g32(.a(new_n46_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n41_), .O(z05));
  ...
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n27_), .d(x05), .O(new_n68_));
  ...
  nand4  g47(.a(new_n46_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n73_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n41_), .O(z09));
