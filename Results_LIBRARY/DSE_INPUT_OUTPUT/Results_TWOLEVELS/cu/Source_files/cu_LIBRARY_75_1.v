...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n33_, new_n34_, new_n35_, new_n37_, new_n38_, new_n42_, new_n43_,
  ...
  nand3  g11(.a(new_n28_), .b(x05), .c(new_n33_), .O(new_n37_));
  nand3  g12(.a(new_n34_), .b(x04), .c(x02), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(new_n37_), .c(x03), .O(z01));
  nor2   g14(.a(new_n34_), .b(x01), .O(z03));
  inv1   g15(.a(x13), .O(new_n42_));
  nor2   g16(.a(x02), .b(x00), .O(new_n43_));
  nand4  g17(.a(new_n43_), .b(new_n42_), .c(new_n33_), .d(new_n26_), .O(new_n44_));
  aoi21  g18(.a(new_n44_), .b(x01), .c(new_n34_), .O(z04));
  inv1   g19(.a(x00), .O(new_n46_));
  nor3   g20(.a(x02), .b(new_n27_), .c(new_n46_), .O(new_n47_));
  nand4  g21(.a(new_n47_), .b(x05), .c(new_n33_), .d(new_n26_), .O(new_n48_));
  nor2   g22(.a(new_n48_), .b(x13), .O(z05));
  inv1   g23(.a(x07), .O(new_n50_));
  inv1   g24(.a(x12), .O(new_n51_));
  inv1   g25(.a(x10), .O(new_n52_));
  nand2  g26(.a(new_n52_), .b(new_n46_), .O(new_n53_));
  inv1   g27(.a(x11), .O(new_n54_));
  nand2  g28(.a(new_n54_), .b(x00), .O(new_n55_));
  nand2  g29(.a(new_n55_), .b(new_n53_), .O(new_n56_));
  nand4  g30(.a(new_n56_), .b(x13), .c(new_n51_), .d(new_n50_), .O(new_n57_));
  inv1   g31(.a(new_n57_), .O(new_n58_));
  nand4  g32(.a(new_n58_), .b(x05), .c(new_n31_), .d(x01), .O(new_n59_));
  nand3  g33(.a(new_n42_), .b(new_n34_), .c(x02), .O(new_n60_));
  nand2  g34(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(x04), .c(new_n26_), .O(new_n62_));
  inv1   g36(.a(new_n62_), .O(z06));
  aoi21  g37(.a(new_n27_), .b(x00), .c(x13), .O(new_n64_));
  nand4  g38(.a(new_n64_), .b(new_n33_), .c(new_n26_), .d(new_n31_), .O(new_n65_));
  aoi21  g39(.a(new_n65_), .b(x01), .c(new_n34_), .O(z07));
  nand3  g40(.a(x13), .b(new_n51_), .c(x05), .O(new_n67_));
  oai21  g41(.a(new_n67_), .b(new_n29_), .c(new_n60_), .O(new_n68_));
  ...
  oai21  g48(.a(new_n34_), .b(x01), .c(new_n74_), .O(z10));
  zero   g49(.O(z02));
endmodule
