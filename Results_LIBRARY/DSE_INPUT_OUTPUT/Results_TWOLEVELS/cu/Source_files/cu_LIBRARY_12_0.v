...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n42_), .c(x05), .d(new_n32_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x06), .c(x01), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nand4  g21(.a(new_n36_), .b(new_n28_), .c(new_n46_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x06), .c(x05), .d(new_n32_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n28_), .b(x01), .c(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n42_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n53_));
  ...
  nor2   g37(.a(x10), .b(new_n46_), .O(new_n63_));
  ...
  nand3  g41(.a(new_n42_), .b(new_n29_), .c(x02), .O(new_n67_));
  ...
  nor2   g45(.a(x06), .b(x01), .O(new_n71_));
