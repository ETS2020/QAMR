...
module FAU ( 
  ...
  nand3  g21(.a(new_n46_), .b(x05), .c(new_n30_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n35_), .c(new_n28_), .d(new_n45_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n45_), .c(new_n44_), .O(z03));
  nand4  g25(.a(new_n48_), .b(new_n35_), .c(new_n28_), .d(new_n44_), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n44_), .c(new_n45_), .O(z04));
  nand4  g27(.a(new_n26_), .b(new_n46_), .c(new_n31_), .d(x02), .O(new_n54_));
  inv1   g28(.a(x07), .O(new_n55_));
  inv1   g29(.a(x12), .O(new_n56_));
  nor2   g30(.a(x08), .b(x01), .O(new_n57_));
  nor2   g31(.a(x10), .b(new_n45_), .O(new_n58_));
  oai21  g32(.a(new_n58_), .b(new_n57_), .c(new_n44_), .O(new_n59_));
  inv1   g33(.a(x09), .O(new_n60_));
  nand3  g34(.a(new_n60_), .b(new_n45_), .c(x00), .O(new_n61_));
  aoi21  g35(.a(new_n61_), .b(new_n59_), .c(new_n46_), .O(new_n62_));
  ...
  aoi21  g40(.a(x01), .b(x00), .c(x13), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n70_));
  nand3  g44(.a(new_n46_), .b(new_n31_), .c(x02), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n26_), .c(x04), .d(new_n35_), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z08));
  nand3  g48(.a(new_n26_), .b(x13), .c(x06), .O(new_n75_));
  inv1   g49(.a(new_n75_), .O(z09));
  inv1   g50(.a(new_n32_), .O(new_n77_));
