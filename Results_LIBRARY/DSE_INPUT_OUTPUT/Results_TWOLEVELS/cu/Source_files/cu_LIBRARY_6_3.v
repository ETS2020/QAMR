...
module FAU ( 
  ...
  nor2   g33(.a(x10), .b(new_n42_), .O(new_n60_));
  oai21  g34(.a(new_n60_), .b(new_n59_), .c(new_n41_), .O(new_n61_));
  inv1   g35(.a(x09), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(new_n42_), .c(x00), .O(new_n63_));
  ...
  oai21  g42(.a(new_n52_), .b(new_n51_), .c(new_n42_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(x00), .O(new_n70_));
  aoi21  g44(.a(new_n42_), .b(x00), .c(x13), .O(new_n71_));
  ...
  nand3  g52(.a(new_n26_), .b(x13), .c(x06), .O(new_n79_));
  inv1   g53(.a(new_n79_), .O(z09));
  inv1   g54(.a(new_n32_), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(new_n26_), .c(x06), .d(new_n35_), .O(new_n82_));
