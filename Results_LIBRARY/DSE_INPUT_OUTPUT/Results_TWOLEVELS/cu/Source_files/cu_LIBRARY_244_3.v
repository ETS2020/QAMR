...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x13), .O(z02));
  inv1   g19(.a(x01), .O(new_n45_));
  nand3  g20(.a(new_n31_), .b(new_n45_), .c(x00), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n34_), .O(z03));
  inv1   g24(.a(x10), .O(new_n50_));
  nor3   g25(.a(x03), .b(x02), .c(x00), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n36_), .c(new_n47_), .d(new_n50_), .O(new_n52_));
  ...
  nor2   g39(.a(x11), .b(x10), .O(new_n65_));
  aoi22  g40(.a(new_n65_), .b(x01), .c(new_n64_), .d(x00), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n47_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n34_), .b(new_n47_), .c(new_n28_), .d(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(x10), .b(x01), .c(x13), .O(new_n73_));
  ...
  nand3  g51(.a(new_n47_), .b(new_n28_), .c(x02), .O(new_n77_));
  ...
  nand4  g57(.a(new_n30_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n83_));
