...
module FAU ( 
  ...
  nand2  g09(.a(x11), .b(x01), .O(new_n35_));
  ...
  nand4  g26(.a(new_n44_), .b(new_n51_), .c(x05), .d(new_n31_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n34_), .c(new_n27_), .d(new_n41_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n51_), .c(new_n42_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n34_), .c(new_n27_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n51_), .c(new_n42_), .O(z05));
  ...
  aoi22  g38(.a(new_n63_), .b(new_n41_), .c(new_n62_), .d(x01), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n44_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n35_), .b(new_n44_), .c(new_n28_), .d(x02), .O(new_n67_));
  ...
  aoi21  g45(.a(x11), .b(x01), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n27_), .O(new_n74_));
  ...
  nand3  g53(.a(new_n35_), .b(x13), .c(x06), .O(new_n79_));
