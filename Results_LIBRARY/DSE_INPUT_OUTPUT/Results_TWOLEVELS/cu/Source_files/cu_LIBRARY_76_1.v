...
module FAU ( 
  ...
  nand4  g25(.a(new_n50_), .b(new_n43_), .c(x05), .d(new_n34_), .O(new_n51_));
  ...
  nand4  g33(.a(new_n53_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n59_));
  ...
  nand3  g46(.a(new_n71_), .b(x05), .c(new_n30_), .O(new_n72_));
  nand4  g47(.a(new_n27_), .b(new_n53_), .c(new_n31_), .d(x02), .O(new_n73_));
  ...
  nand4  g54(.a(x13), .b(new_n62_), .c(x05), .d(new_n30_), .O(new_n80_));
  nand3  g55(.a(new_n53_), .b(new_n31_), .c(x02), .O(new_n81_));
  ...
  nand3  g62(.a(new_n87_), .b(x06), .c(new_n37_), .O(new_n88_));
