...
module FAU ( 
  ...
  nor2   g10(.a(new_n35_), .b(x01), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(new_n34_), .c(new_n31_), .O(new_n37_));
  nand3  g12(.a(new_n37_), .b(new_n27_), .c(new_n30_), .O(new_n38_));
  nand2  g13(.a(new_n35_), .b(new_n27_), .O(new_n39_));
  nand3  g14(.a(new_n39_), .b(new_n31_), .c(x02), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n38_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n26_), .O(new_n42_));
  nand2  g17(.a(x13), .b(new_n27_), .O(new_n43_));
  ...
  nand3  g23(.a(x05), .b(new_n26_), .c(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand3  g25(.a(new_n50_), .b(new_n48_), .c(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n35_), .c(x04), .O(z03));
  nand3  g27(.a(new_n50_), .b(x01), .c(new_n34_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n35_), .c(x04), .O(z04));
  nand3  g29(.a(new_n50_), .b(x01), .c(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n35_), .c(x04), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nor2   g33(.a(x09), .b(x01), .O(new_n59_));
  nor2   g34(.a(x11), .b(new_n48_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  nor2   g36(.a(x08), .b(x01), .O(new_n62_));
  nor2   g37(.a(x10), .b(new_n48_), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(new_n34_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n35_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n35_), .b(new_n31_), .c(x04), .d(x02), .O(new_n67_));
  ...
  nand3  g45(.a(new_n37_), .b(new_n26_), .c(new_n30_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n35_), .c(x04), .O(z07));
  nand4  g47(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n73_));
  nand3  g48(.a(new_n35_), .b(new_n31_), .c(x02), .O(new_n74_));
  ...
  aoi21  g53(.a(new_n78_), .b(x04), .c(new_n35_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n43_), .c(x06), .d(new_n26_), .O(new_n81_));
