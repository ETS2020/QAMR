...
module FAU ( 
  ...
  nand3  g22(.a(x05), .b(new_n28_), .c(new_n34_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n35_), .c(new_n43_), .d(x00), .O(new_n50_));
  ...
  nand4  g30(.a(new_n49_), .b(new_n35_), .c(x01), .d(x00), .O(new_n56_));
  ...
  nand3  g43(.a(new_n60_), .b(new_n37_), .c(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(x11), .b(new_n42_), .c(new_n37_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n28_), .c(new_n34_), .d(new_n35_), .O(new_n74_));
