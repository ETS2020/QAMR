...
module FAU ( 
  ...
  nand3  g11(.a(x05), .b(new_n33_), .c(new_n29_), .O(new_n37_));
  nand3  g12(.a(new_n30_), .b(x04), .c(x02), .O(new_n38_));
  nand2  g13(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand2  g14(.a(new_n39_), .b(new_n36_), .O(new_n40_));
  oai21  g15(.a(x13), .b(x06), .c(new_n40_), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(x05), .b(new_n33_), .c(new_n36_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n29_), .c(new_n43_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x06), .c(x13), .O(z02));
  nand4  g22(.a(new_n36_), .b(new_n29_), .c(new_n43_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x06), .c(x05), .d(new_n33_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  nand4  g26(.a(new_n36_), .b(new_n29_), .c(x01), .d(new_n42_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x06), .c(x05), .d(new_n33_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n45_), .b(new_n29_), .c(x01), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x06), .c(x13), .O(z05));
  ...
  nand4  g42(.a(new_n27_), .b(x06), .c(new_n30_), .d(x02), .O(new_n68_));
  ...
  oai21  g46(.a(x06), .b(x01), .c(x00), .O(new_n72_));
  oai21  g47(.a(x06), .b(new_n43_), .c(new_n42_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n72_), .c(new_n30_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n33_), .c(new_n36_), .d(new_n29_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(x06), .c(x13), .O(z07));
