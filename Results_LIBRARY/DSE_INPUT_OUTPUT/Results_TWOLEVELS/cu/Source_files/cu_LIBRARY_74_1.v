...
module FAU ( 
  ...
  nand3  g24(.a(new_n35_), .b(x01), .c(new_n42_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n27_), .O(z04));
  nor2   g26(.a(new_n28_), .b(x13), .O(new_n52_));
  ...
  nand3  g42(.a(new_n52_), .b(new_n37_), .c(x02), .O(new_n68_));
