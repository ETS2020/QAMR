...
module FAU ( 
  ...
  inv1   g24(.a(new_n33_), .O(z04));
  nand2  g25(.a(new_n35_), .b(new_n30_), .O(new_n51_));
  nand3  g26(.a(new_n44_), .b(x05), .c(new_n26_), .O(new_n52_));
  or2    g27(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x00), .c(new_n45_), .O(z05));
  nand4  g29(.a(new_n33_), .b(new_n44_), .c(new_n27_), .d(x02), .O(new_n55_));
  ...
  nand3  g36(.a(new_n61_), .b(new_n45_), .c(new_n32_), .O(new_n62_));
  ...
  oai21  g42(.a(new_n52_), .b(new_n51_), .c(new_n45_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n32_), .O(new_n69_));
  aoi21  g44(.a(new_n45_), .b(new_n32_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(x02), .c(new_n69_), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n55_), .O(new_n74_));
  ...
  nand4  g53(.a(new_n33_), .b(new_n29_), .c(x06), .d(new_n35_), .O(new_n79_));
