...
module FAU ( 
  ...
  aoi21  g25(.a(new_n52_), .b(new_n48_), .c(new_n44_), .O(new_n53_));
  nand4  g26(.a(new_n53_), .b(new_n43_), .c(new_n42_), .d(x05), .O(new_n54_));
  nand3  g27(.a(new_n44_), .b(new_n26_), .c(x02), .O(new_n55_));
  oai21  g28(.a(new_n54_), .b(x02), .c(new_n55_), .O(new_n56_));
  nand3  g29(.a(new_n56_), .b(x04), .c(new_n41_), .O(new_n57_));
  inv1   g30(.a(new_n57_), .O(z06));
  nand4  g31(.a(x13), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n59_));
  nand2  g32(.a(new_n59_), .b(new_n55_), .O(new_n60_));
  nand3  g33(.a(new_n60_), .b(x04), .c(new_n41_), .O(new_n61_));
  inv1   g34(.a(new_n61_), .O(z08));
  nand2  g35(.a(x13), .b(x06), .O(new_n63_));
  nand2  g36(.a(new_n63_), .b(new_n28_), .O(z09));
  oai21  g37(.a(new_n44_), .b(x02), .c(x05), .O(new_n65_));
  nand3  g38(.a(new_n65_), .b(x06), .c(new_n41_), .O(new_n66_));
