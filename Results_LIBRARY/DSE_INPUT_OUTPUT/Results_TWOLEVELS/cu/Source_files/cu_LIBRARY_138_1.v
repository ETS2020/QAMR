...
module FAU ( 
  ...
  nand4  g27(.a(new_n35_), .b(new_n28_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nand3  g31(.a(new_n28_), .b(x01), .c(x00), .O(new_n57_));
  nand4  g32(.a(new_n43_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n58_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n43_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(x05), .d(new_n28_), .O(new_n68_));
  nand3  g43(.a(new_n43_), .b(new_n31_), .c(x02), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n68_), .c(x07), .O(new_n70_));
  nand4  g45(.a(new_n43_), .b(new_n31_), .c(x02), .d(x01), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(new_n70_), .c(x04), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x03), .O(z06));
  aoi21  g49(.a(x07), .b(new_n47_), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n60_), .c(x05), .d(new_n28_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n69_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n36_), .c(x04), .d(new_n35_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n27_), .b(new_n43_), .c(new_n82_), .O(z09));
  inv1   g58(.a(new_n32_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x06), .c(new_n35_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n36_), .O(z10));
endmodule
