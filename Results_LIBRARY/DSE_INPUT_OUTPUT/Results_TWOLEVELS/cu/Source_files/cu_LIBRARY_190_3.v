...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n37_), .O(z02));
  nand3  g24(.a(new_n34_), .b(new_n45_), .c(x00), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n37_), .O(z03));
  nand3  g26(.a(new_n34_), .b(x01), .c(new_n44_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n48_), .c(new_n37_), .O(z04));
  nor2   g28(.a(new_n28_), .b(x13), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n55_));
  ...
  nand2  g34(.a(new_n26_), .b(new_n44_), .O(new_n60_));
  nand2  g35(.a(new_n27_), .b(x00), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(new_n62_));
  inv1   g37(.a(x09), .O(new_n63_));
  oai21  g38(.a(x10), .b(x01), .c(x11), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n63_), .c(x00), .O(new_n65_));
  inv1   g40(.a(x08), .O(new_n66_));
  oai21  g41(.a(x11), .b(x01), .c(x10), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n62_), .c(x13), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x12), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(x05), .d(new_n34_), .O(new_n72_));
  nand3  g47(.a(new_n54_), .b(new_n31_), .c(x02), .O(new_n73_));
  ...
  nand4  g52(.a(x13), .b(new_n77_), .c(x05), .d(new_n34_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n73_), .O(new_n79_));
  nand3  g54(.a(new_n79_), .b(x04), .c(new_n38_), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n37_), .O(z08));
  nand3  g56(.a(new_n37_), .b(x13), .c(x06), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(z09));
  nand4  g58(.a(new_n33_), .b(new_n37_), .c(x06), .d(new_n38_), .O(new_n84_));
