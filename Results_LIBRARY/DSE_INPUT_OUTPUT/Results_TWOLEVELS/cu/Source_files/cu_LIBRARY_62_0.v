...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n35_), .c(new_n26_), .d(new_n42_), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(x13), .O(z02));
  nand4  g20(.a(new_n43_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x05), .c(x13), .O(z03));
  nand4  g22(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n42_), .O(new_n48_));
  ...
  nor3   g27(.a(x02), .b(new_n52_), .c(new_n42_), .O(new_n53_));
  ...
  oai21  g51(.a(new_n29_), .b(x05), .c(new_n76_), .O(new_n77_));
