...
module FAU ( 
  ...
  nand4  g43(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n33_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n71_));
  ...
  aoi21  g50(.a(x11), .b(new_n75_), .c(new_n26_), .O(z09));
