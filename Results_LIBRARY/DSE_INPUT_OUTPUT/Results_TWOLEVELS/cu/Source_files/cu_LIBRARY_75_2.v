...
module FAU ( 
  ...
  nand4  g13(.a(new_n38_), .b(new_n27_), .c(new_n26_), .d(new_n30_), .O(new_n39_));
  nor3   g14(.a(new_n39_), .b(x13), .c(new_n28_), .O(z02));
  ...
  nor2   g21(.a(x02), .b(x00), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n44_), .c(new_n27_), .d(new_n26_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x05), .c(new_n35_), .O(z04));
  inv1   g24(.a(x00), .O(new_n50_));
  nor3   g25(.a(x02), .b(new_n35_), .c(new_n50_), .O(new_n51_));
  ...
  nand4  g38(.a(new_n44_), .b(new_n28_), .c(x02), .d(new_n35_), .O(new_n64_));
  ...
  oai21  g42(.a(new_n35_), .b(x00), .c(new_n28_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n44_), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n42_), .O(z07));
  ...
  nor3   g50(.a(new_n41_), .b(new_n44_), .c(new_n75_), .O(z09));
  nand3  g51(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n42_), .O(z10));
endmodule
