...
module FAU ( 
  ...
  nand2  g15(.a(x03), .b(new_n26_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n40_), .O(z01));
  nor3   g17(.a(x02), .b(x01), .c(x00), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n27_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(x05), .c(new_n28_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n27_), .c(new_n31_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n27_), .c(x01), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n31_), .b(x01), .c(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n27_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n41_), .O(z04));
  nand3  g29(.a(new_n31_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n41_), .O(z05));
  ...
  nand3  g36(.a(new_n61_), .b(new_n27_), .c(x01), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(new_n27_), .c(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n51_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n46_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n46_), .b(new_n32_), .c(new_n27_), .d(x02), .O(new_n73_));
  ...
  nor3   g51(.a(new_n47_), .b(x03), .c(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n78_));
  nand3  g53(.a(new_n46_), .b(new_n32_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n27_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  nand2  g57(.a(x13), .b(x06), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n41_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n27_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n41_), .O(z10));
endmodule
