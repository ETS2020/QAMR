...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(new_n35_), .c(x05), .d(new_n27_), .O(new_n49_));
  ...
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n35_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n63_));
  nand3  g38(.a(new_n35_), .b(new_n28_), .c(x02), .O(new_n64_));
  ...
  nand4  g42(.a(new_n35_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n68_));
  ...
  aoi21  g49(.a(new_n74_), .b(x05), .c(new_n35_), .O(z09));
  nand3  g50(.a(new_n32_), .b(x06), .c(new_n26_), .O(new_n76_));
  oai21  g51(.a(new_n35_), .b(x05), .c(new_n76_), .O(z10));
endmodule
