...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n32_, new_n33_,
    ...
    new_n92_;
  nor2   g00(.a(x10), .b(x00), .O(new_n26_));
  ...
  aoi21  g18(.a(new_n43_), .b(x10), .c(x00), .O(z02));
  ...
  nand4  g30(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n33_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n32_), .O(z05));
  nand4  g32(.a(x04), .b(new_n33_), .c(new_n34_), .d(new_n45_), .O(new_n58_));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x08), .O(new_n60_));
  nor2   g35(.a(new_n41_), .b(x12), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n58_), .c(x10), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n50_), .O(new_n64_));
  nand4  g39(.a(new_n32_), .b(new_n41_), .c(new_n36_), .d(x02), .O(new_n65_));
  ...
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n34_), .d(x00), .O(new_n74_));
  ...
  inv1   g52(.a(x10), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x01), .c(new_n50_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(new_n33_), .c(new_n34_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n32_), .O(z07));
  nand3  g58(.a(new_n61_), .b(x05), .c(new_n34_), .O(new_n84_));
  nand3  g59(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n84_), .O(new_n86_));
  nand4  g61(.a(new_n86_), .b(new_n32_), .c(x04), .d(new_n33_), .O(new_n87_));
  inv1   g62(.a(new_n87_), .O(z08));
  inv1   g63(.a(x06), .O(new_n89_));
  nor3   g64(.a(new_n26_), .b(new_n41_), .c(new_n89_), .O(z09));
  nand2  g65(.a(x05), .b(x02), .O(new_n91_));
  nand3  g66(.a(new_n91_), .b(x06), .c(new_n33_), .O(new_n92_));
  nand2  g67(.a(new_n92_), .b(new_n32_), .O(z10));
endmodule
