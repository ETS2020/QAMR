...
module FAU ( 
  ...
  nand3  g21(.a(new_n35_), .b(new_n46_), .c(x00), .O(new_n47_));
  inv1   g22(.a(x13), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n49_));
  ...
  nand4  g28(.a(new_n53_), .b(x07), .c(x05), .d(new_n29_), .O(new_n54_));
  ...
  aoi21  g33(.a(new_n58_), .b(x07), .c(new_n46_), .O(z05));
  nand4  g34(.a(new_n27_), .b(new_n48_), .c(new_n36_), .d(x02), .O(new_n60_));
  ...
  nor3   g55(.a(new_n28_), .b(new_n48_), .c(new_n80_), .O(z09));
