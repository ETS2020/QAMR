...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(new_n26_), .c(x00), .O(z02));
  nand3  g20(.a(new_n35_), .b(new_n26_), .c(x00), .O(new_n46_));
  nand4  g21(.a(new_n42_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n46_), .c(new_n34_), .O(z03));
  inv1   g23(.a(x00), .O(new_n50_));
  nor3   g24(.a(x02), .b(new_n26_), .c(new_n50_), .O(new_n51_));
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(x13), .O(z05));
  nand4  g27(.a(x05), .b(x04), .c(new_n33_), .d(new_n35_), .O(new_n54_));
  ...
  nand3  g40(.a(new_n42_), .b(new_n37_), .c(x02), .O(new_n67_));
  ...
  aoi21  g44(.a(x01), .b(new_n50_), .c(x13), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n72_));
  nor2   g46(.a(new_n72_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand3  g49(.a(new_n75_), .b(x04), .c(new_n33_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n34_), .O(z08));
  inv1   g51(.a(x06), .O(new_n78_));
  nor3   g52(.a(new_n27_), .b(new_n42_), .c(new_n78_), .O(z09));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand4  g54(.a(new_n80_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n81_));
