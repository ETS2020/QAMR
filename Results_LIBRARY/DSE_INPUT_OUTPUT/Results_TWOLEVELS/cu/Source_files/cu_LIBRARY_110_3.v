...
module FAU ( 
  ...
  nand2  g00(.a(x06), .b(x00), .O(new_n26_));
  ...
  inv1   g20(.a(x06), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nor3   g22(.a(x03), .b(x02), .c(x01), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n36_), .c(new_n47_), .d(new_n46_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n46_), .c(new_n45_), .O(z03));
  nand3  g25(.a(new_n34_), .b(x01), .c(new_n45_), .O(new_n51_));
  nand4  g26(.a(new_n47_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n26_), .O(z04));
  nand4  g28(.a(new_n33_), .b(new_n34_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n46_), .c(x05), .d(new_n28_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  nor2   g34(.a(x09), .b(x01), .O(new_n60_));
  inv1   g35(.a(x01), .O(new_n61_));
  nor2   g36(.a(x11), .b(new_n61_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n60_), .c(x00), .O(new_n63_));
  nor2   g38(.a(x08), .b(x01), .O(new_n64_));
  nor2   g39(.a(x10), .b(new_n61_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n26_), .b(new_n47_), .c(new_n35_), .d(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(x06), .b(x00), .c(x13), .O(new_n73_));
  ...
  nand3  g51(.a(new_n47_), .b(new_n35_), .c(x02), .O(new_n77_));
  ...
  nand3  g55(.a(x13), .b(x06), .c(new_n45_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(x06), .c(new_n33_), .d(new_n45_), .O(new_n84_));
