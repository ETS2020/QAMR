...
module FAU ( 
  ...
  nand3  g27(.a(new_n28_), .b(x01), .c(new_n43_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n47_), .c(new_n26_), .O(z04));
  nand3  g29(.a(new_n28_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n47_), .c(new_n26_), .O(z05));
  ...
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n43_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n46_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(x05), .d(new_n28_), .O(new_n65_));
  nand3  g40(.a(new_n46_), .b(new_n29_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n31_), .c(x04), .d(new_n36_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n26_), .O(z06));
  nand4  g44(.a(new_n46_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand3  g46(.a(x13), .b(x05), .c(new_n28_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n66_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n31_), .c(x04), .d(new_n36_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  nand3  g50(.a(new_n26_), .b(x13), .c(x06), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z09));
  inv1   g52(.a(new_n32_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n36_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n26_), .O(z10));
endmodule
