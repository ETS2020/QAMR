...
module FAU ( 
  ...
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nand4  g28(.a(new_n35_), .b(new_n44_), .c(new_n30_), .d(x02), .O(new_n55_));
  ...
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n69_));
