...
module FAU ( 
  ...
  nand3  g18(.a(new_n43_), .b(new_n30_), .c(new_n34_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n32_), .O(z02));
  nor2   g20(.a(x03), .b(x02), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n43_), .c(new_n30_), .d(new_n41_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n41_), .c(new_n40_), .O(z03));
  nand4  g23(.a(new_n46_), .b(new_n43_), .c(new_n30_), .d(new_n40_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n40_), .c(new_n41_), .O(z04));
  inv1   g25(.a(new_n32_), .O(z05));
  nand3  g26(.a(new_n46_), .b(x05), .c(x04), .O(new_n52_));
  inv1   g27(.a(x07), .O(new_n53_));
  inv1   g28(.a(x09), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nand4  g30(.a(x13), .b(new_n55_), .c(new_n54_), .d(new_n53_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n52_), .c(new_n41_), .O(new_n57_));
  nand2  g32(.a(new_n57_), .b(x00), .O(new_n58_));
  nand3  g33(.a(x05), .b(new_n26_), .c(new_n41_), .O(new_n59_));
  ...
  nand4  g40(.a(new_n62_), .b(new_n27_), .c(x02), .d(new_n41_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(new_n67_));
  nand3  g42(.a(x05), .b(new_n26_), .c(x01), .O(new_n68_));
  ...
  aoi21  g51(.a(x01), .b(x00), .c(x13), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n30_), .d(new_n34_), .O(new_n78_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  nand2  g59(.a(x13), .b(x06), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n32_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n87_));
  nand3  g62(.a(new_n87_), .b(x06), .c(new_n34_), .O(new_n88_));
  nand2  g63(.a(new_n88_), .b(new_n32_), .O(z10));
endmodule
