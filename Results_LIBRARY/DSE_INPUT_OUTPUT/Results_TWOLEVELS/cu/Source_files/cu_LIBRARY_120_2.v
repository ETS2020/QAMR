...
module FAU ( 
  ...
  nand2  g11(.a(new_n36_), .b(x12), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n29_), .d(new_n33_), .O(new_n38_));
  nand4  g13(.a(new_n37_), .b(new_n30_), .c(x04), .d(x02), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n38_), .c(x03), .O(z01));
  inv1   g15(.a(x00), .O(new_n41_));
  inv1   g16(.a(x01), .O(new_n42_));
  inv1   g17(.a(x03), .O(new_n43_));
  nand4  g18(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n43_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n33_), .c(new_n42_), .d(new_n41_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n26_), .c(x13), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n33_), .c(new_n42_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n26_), .c(x13), .O(z03));
  nand4  g24(.a(new_n43_), .b(new_n33_), .c(x01), .d(new_n41_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n26_), .c(x05), .d(new_n29_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n45_), .b(new_n33_), .c(x01), .d(x00), .O(new_n54_));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n36_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(x05), .d(new_n33_), .O(new_n64_));
  nand3  g39(.a(new_n36_), .b(new_n30_), .c(x02), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n26_), .c(x04), .d(new_n43_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nor2   g43(.a(x13), .b(x12), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n29_), .d(new_n43_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  inv1   g46(.a(new_n27_), .O(new_n72_));
  nand3  g47(.a(x13), .b(x05), .c(new_n33_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n65_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n26_), .c(x04), .d(new_n43_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n72_), .O(z08));
  and2   g51(.a(x13), .b(x06), .O(z09));
  nand4  g52(.a(new_n32_), .b(new_n72_), .c(x06), .d(new_n43_), .O(new_n78_));
