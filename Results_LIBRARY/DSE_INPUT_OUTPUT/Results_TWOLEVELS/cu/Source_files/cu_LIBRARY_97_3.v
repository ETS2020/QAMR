...
module FAU ( 
  ...
  nor2   g32(.a(x10), .b(new_n44_), .O(new_n59_));
  oai21  g33(.a(new_n59_), .b(new_n58_), .c(new_n49_), .O(new_n60_));
  inv1   g34(.a(x09), .O(new_n61_));
  nand3  g35(.a(new_n61_), .b(new_n44_), .c(x00), .O(new_n62_));
  ...
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n26_), .d(new_n34_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand3  g45(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n74_));
  inv1   g48(.a(new_n74_), .O(z08));
  nand3  g49(.a(new_n32_), .b(x13), .c(x06), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(z09));
  nand3  g51(.a(new_n29_), .b(x06), .c(new_n34_), .O(new_n78_));
