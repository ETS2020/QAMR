...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n45_));
  nand2  g20(.a(new_n45_), .b(new_n32_), .O(new_n46_));
  nand2  g21(.a(new_n46_), .b(new_n42_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z02));
  nand3  g23(.a(new_n30_), .b(new_n32_), .c(x00), .O(new_n49_));
  nand4  g24(.a(new_n43_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n34_), .O(z03));
  aoi21  g26(.a(new_n45_), .b(x00), .c(new_n32_), .O(z05));
  nand3  g27(.a(new_n44_), .b(x05), .c(x04), .O(new_n53_));
  ...
  oai21  g32(.a(new_n57_), .b(new_n53_), .c(new_n32_), .O(new_n58_));
  nand2  g33(.a(new_n58_), .b(new_n42_), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n32_), .c(x00), .O(new_n61_));
  ...
  aoi21  g44(.a(new_n32_), .b(new_n42_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n71_));
  ...
  nor3   g52(.a(z04), .b(new_n43_), .c(new_n77_), .O(z09));
