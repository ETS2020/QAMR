...
module FAU ( 
  ...
  aoi21  g00(.a(x07), .b(x01), .c(x03), .O(new_n26_));
  ...
  nand2  g09(.a(x07), .b(x01), .O(new_n35_));
  ...
  nand3  g19(.a(new_n44_), .b(new_n31_), .c(new_n34_), .O(new_n45_));
  ...
  nand4  g24(.a(new_n34_), .b(new_n27_), .c(x01), .d(new_n41_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n49_), .c(x05), .d(new_n31_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nor2   g28(.a(x03), .b(x02), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n44_), .c(new_n31_), .d(x00), .O(new_n55_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n66_));
  nand4  g41(.a(new_n35_), .b(new_n58_), .c(new_n28_), .d(x02), .O(new_n67_));
  ...
  nand3  g45(.a(x07), .b(x01), .c(new_n41_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(x05), .d(new_n31_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n34_), .c(new_n27_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n35_), .O(z07));
  nand4  g50(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n76_));
  nand3  g51(.a(new_n58_), .b(new_n28_), .c(x02), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z08));
  nand3  g55(.a(new_n35_), .b(x13), .c(x06), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z09));
  nand2  g57(.a(x05), .b(x02), .O(new_n83_));
  nand4  g58(.a(new_n83_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n84_));
