...
module FAU ( 
  ...
  nor2   g00(.a(x11), .b(x04), .O(new_n26_));
  ...
  nand4  g19(.a(new_n44_), .b(x11), .c(x05), .d(new_n37_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x11), .c(x05), .d(new_n42_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x11), .c(x04), .O(z03));
  nand4  g26(.a(new_n49_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x11), .c(x04), .O(z04));
  nand4  g28(.a(new_n42_), .b(new_n29_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x11), .c(x05), .d(new_n37_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x04), .c(new_n41_), .O(new_n61_));
  ...
  aoi21  g46(.a(new_n71_), .b(new_n65_), .c(new_n47_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n73_));
  nand4  g48(.a(new_n47_), .b(new_n31_), .c(x04), .d(x02), .O(new_n74_));
  oai21  g49(.a(new_n73_), .b(x02), .c(new_n74_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n42_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n27_), .O(z06));
  nand4  g52(.a(new_n47_), .b(x11), .c(x05), .d(new_n37_), .O(new_n78_));
  nor3   g53(.a(new_n78_), .b(x03), .c(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n80_));
  nand3  g55(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n42_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n26_), .b(new_n47_), .c(new_n85_), .O(z09));
  inv1   g61(.a(new_n32_), .O(new_n87_));
  nand4  g62(.a(new_n87_), .b(new_n27_), .c(x06), .d(new_n42_), .O(new_n88_));
