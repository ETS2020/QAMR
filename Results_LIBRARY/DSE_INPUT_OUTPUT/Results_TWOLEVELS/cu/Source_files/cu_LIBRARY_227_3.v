...
module FAU ( 
  ...
  nand4  g23(.a(new_n39_), .b(new_n29_), .c(x01), .d(new_n48_), .O(new_n49_));
  ...
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n30_), .d(new_n39_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  nand2  g31(.a(new_n39_), .b(x02), .O(new_n57_));
  nand3  g32(.a(new_n28_), .b(new_n33_), .c(x04), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n26_), .O(z06));
  nand4  g34(.a(new_n28_), .b(new_n30_), .c(new_n39_), .d(new_n29_), .O(new_n60_));
  ...
  nand3  g39(.a(new_n64_), .b(x06), .c(new_n39_), .O(new_n65_));
