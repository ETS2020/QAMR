...
module FAU ( 
  ...
  nand4  g23(.a(new_n38_), .b(new_n34_), .c(new_n45_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  nand4  g27(.a(new_n38_), .b(new_n34_), .c(x01), .d(new_n44_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nand3  g31(.a(new_n34_), .b(x01), .c(x00), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n47_), .c(new_n37_), .O(z05));
  ...
  aoi21  g43(.a(new_n68_), .b(new_n66_), .c(x00), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(new_n64_), .c(x13), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x12), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(new_n26_), .d(x05), .O(new_n72_));
  nand3  g47(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n73_));
  ...
  nand4  g51(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n37_), .O(z07));
  nand2  g53(.a(x05), .b(new_n34_), .O(new_n79_));
  inv1   g54(.a(x12), .O(new_n80_));
  nand3  g55(.a(x13), .b(new_n80_), .c(new_n26_), .O(new_n81_));
  oai21  g56(.a(new_n81_), .b(new_n79_), .c(new_n73_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n38_), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z08));
  nand4  g59(.a(new_n33_), .b(new_n27_), .c(x06), .d(new_n38_), .O(new_n86_));
  inv1   g60(.a(new_n86_), .O(z10));
  zero   g61(.O(z09));
endmodule
