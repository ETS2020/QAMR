...
module FAU ( 
  ...
  nand4  g17(.a(x07), .b(x05), .c(new_n29_), .d(new_n42_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n27_), .c(new_n41_), .d(new_n40_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x07), .c(x13), .O(z02));
  nand4  g21(.a(new_n42_), .b(new_n27_), .c(new_n41_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x07), .c(x05), .d(new_n29_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(new_n42_), .b(new_n27_), .c(x01), .d(new_n40_), .O(new_n51_));
  ...
  aoi21  g30(.a(new_n55_), .b(x07), .c(x13), .O(z05));
  ...
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n34_), .d(x05), .O(new_n65_));
  nor2   g40(.a(x13), .b(new_n34_), .O(new_n66_));
  ...
  nand3  g45(.a(new_n66_), .b(x05), .c(new_n29_), .O(new_n71_));
