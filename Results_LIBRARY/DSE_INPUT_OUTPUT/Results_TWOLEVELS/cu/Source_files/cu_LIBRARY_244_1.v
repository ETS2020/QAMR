...
module FAU ( 
  ...
  aoi21  g01(.a(x10), .b(new_n26_), .c(x03), .O(new_n27_));
  ...
  nand2  g09(.a(x10), .b(new_n26_), .O(new_n35_));
  ...
  nand4  g19(.a(new_n36_), .b(new_n32_), .c(new_n26_), .d(new_n44_), .O(new_n45_));
  ...
  aoi21  g47(.a(x10), .b(new_n26_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n76_));
  nand3  g51(.a(new_n54_), .b(new_n29_), .c(x02), .O(new_n77_));
  ...
  nand4  g57(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n83_));
