...
module FAU ( 
  ...
  nand4  g26(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n41_), .O(new_n52_));
  ...
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z05));
  inv1   g33(.a(x07), .O(new_n59_));
  inv1   g34(.a(x12), .O(new_n60_));
  inv1   g35(.a(x09), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(x06), .c(new_n42_), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(x06), .c(new_n42_), .O(new_n68_));
  ...
  aoi21  g47(.a(new_n72_), .b(new_n66_), .c(new_n51_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n74_));
  nand4  g49(.a(new_n34_), .b(new_n51_), .c(new_n30_), .d(x02), .O(new_n75_));
  ...
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n81_));
  nor2   g56(.a(new_n81_), .b(x02), .O(z07));
  nand4  g57(.a(x13), .b(new_n60_), .c(x05), .d(new_n27_), .O(new_n83_));
  nand3  g58(.a(new_n51_), .b(new_n30_), .c(x02), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n86_));
  inv1   g61(.a(new_n86_), .O(z08));
  oai21  g62(.a(new_n51_), .b(new_n79_), .c(new_n34_), .O(z09));
  inv1   g63(.a(new_n31_), .O(new_n89_));
  nand3  g64(.a(new_n89_), .b(x06), .c(new_n35_), .O(new_n90_));
