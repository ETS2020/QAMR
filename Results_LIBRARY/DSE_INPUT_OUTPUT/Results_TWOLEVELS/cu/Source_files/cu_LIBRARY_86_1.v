...
module FAU ( 
  ...
  nand4  g28(.a(new_n36_), .b(new_n33_), .c(x01), .d(new_n43_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n53_), .c(x05), .d(new_n29_), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(z04));
  nand3  g32(.a(new_n33_), .b(x01), .c(x00), .O(new_n58_));
  nand4  g33(.a(new_n53_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n37_), .O(z05));
  inv1   g35(.a(x07), .O(new_n61_));
  inv1   g36(.a(x09), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n44_), .O(new_n63_));
  inv1   g38(.a(x11), .O(new_n64_));
  nand3  g39(.a(new_n26_), .b(new_n64_), .c(x01), .O(new_n65_));
  ...
  nand3  g45(.a(new_n26_), .b(new_n70_), .c(x01), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n43_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n67_), .c(new_n53_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n61_), .c(x05), .d(new_n33_), .O(new_n75_));
  nand3  g50(.a(new_n53_), .b(new_n30_), .c(x02), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n36_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n37_), .O(z06));
  aoi21  g54(.a(x12), .b(new_n44_), .c(x13), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n29_), .d(new_n36_), .O(new_n81_));
  oai21  g56(.a(new_n81_), .b(x02), .c(new_n37_), .O(z07));
  nand4  g57(.a(x13), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n36_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n37_), .O(z08));
  inv1   g61(.a(x06), .O(new_n87_));
  nor3   g62(.a(new_n27_), .b(new_n53_), .c(new_n87_), .O(z09));
  nand4  g63(.a(new_n32_), .b(new_n37_), .c(x06), .d(new_n36_), .O(new_n89_));
