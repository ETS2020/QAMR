...
module FAU ( 
  ...
  nand3  g19(.a(new_n44_), .b(new_n30_), .c(new_n35_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n26_), .O(z02));
  nor3   g21(.a(x03), .b(x02), .c(x01), .O(new_n47_));
  nand3  g22(.a(new_n47_), .b(new_n44_), .c(new_n30_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n42_), .c(new_n41_), .O(z03));
  inv1   g24(.a(x13), .O(new_n50_));
  nand4  g25(.a(new_n35_), .b(new_n28_), .c(x01), .d(new_n41_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n50_), .c(x05), .d(new_n30_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand4  g29(.a(new_n26_), .b(new_n50_), .c(new_n31_), .d(x02), .O(new_n55_));
  ...
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n28_), .O(new_n71_));
  ...
  inv1   g51(.a(new_n32_), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n26_), .c(x06), .d(new_n35_), .O(new_n78_));
