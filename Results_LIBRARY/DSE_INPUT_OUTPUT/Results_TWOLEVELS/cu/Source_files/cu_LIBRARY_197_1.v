...
module FAU ( 
  ...
  nand4  g24(.a(new_n34_), .b(new_n35_), .c(new_n44_), .d(x00), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n49_), .c(x05), .d(new_n28_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z03));
  nor2   g28(.a(x03), .b(x02), .O(new_n54_));
  nor2   g29(.a(x13), .b(x09), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n54_), .c(new_n37_), .d(x01), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n26_), .c(x00), .O(z04));
  nand3  g32(.a(new_n35_), .b(x01), .c(x00), .O(new_n58_));
  nand4  g33(.a(new_n49_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n59_));
  ...
  nand3  g41(.a(new_n26_), .b(new_n66_), .c(new_n44_), .O(new_n67_));
  inv1   g42(.a(x10), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x01), .c(new_n43_), .O(new_n69_));
  and2   g44(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n65_), .c(new_n49_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n62_), .c(new_n61_), .d(x05), .O(new_n72_));
  nand3  g47(.a(new_n49_), .b(new_n36_), .c(x02), .O(new_n73_));
  oai21  g48(.a(new_n72_), .b(x02), .c(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n34_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n33_), .O(z06));
  aoi21  g51(.a(x09), .b(new_n43_), .c(x13), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n78_));
  nor2   g53(.a(new_n78_), .b(x02), .O(z07));
  nand4  g54(.a(x13), .b(new_n62_), .c(x05), .d(new_n35_), .O(new_n80_));
