...
module FAU ( 
  ...
  nand3  g13(.a(x05), .b(new_n34_), .c(new_n30_), .O(new_n39_));
  ...
  nand3  g43(.a(new_n48_), .b(new_n31_), .c(x02), .O(new_n69_));
  ...
  aoi21  g47(.a(x09), .b(x01), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n38_), .O(z07));
  ...
  nand3  g54(.a(new_n38_), .b(x13), .c(x06), .O(new_n80_));
