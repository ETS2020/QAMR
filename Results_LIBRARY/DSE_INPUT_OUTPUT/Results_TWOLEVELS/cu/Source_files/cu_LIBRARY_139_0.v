...
module FAU ( 
  ...
  nand3  g16(.a(new_n41_), .b(x05), .c(new_n28_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n26_), .c(new_n31_), .d(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(x01), .O(z03));
  nor2   g20(.a(x05), .b(x01), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  inv1   g22(.a(x00), .O(new_n48_));
  nand3  g23(.a(new_n31_), .b(x01), .c(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n41_), .b(x05), .c(new_n28_), .d(new_n26_), .O(new_n50_));
  ...
  nand2  g31(.a(new_n56_), .b(new_n27_), .O(new_n57_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n47_), .O(z08));
  inv1   g54(.a(x06), .O(new_n80_));
  nor3   g55(.a(new_n46_), .b(new_n41_), .c(new_n80_), .O(z09));
  oai21  g56(.a(x05), .b(new_n27_), .c(new_n75_), .O(new_n82_));
