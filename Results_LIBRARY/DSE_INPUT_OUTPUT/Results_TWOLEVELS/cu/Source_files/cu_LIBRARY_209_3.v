...
module FAU ( 
  ...
  aoi21  g00(.a(x13), .b(x01), .c(x03), .O(new_n26_));
  ...
  nand4  g09(.a(new_n34_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n35_));
  nand2  g10(.a(x13), .b(x01), .O(new_n36_));
  nand4  g11(.a(new_n36_), .b(new_n28_), .c(x04), .d(x02), .O(new_n37_));
  aoi21  g12(.a(new_n37_), .b(new_n35_), .c(x03), .O(z01));
  inv1   g13(.a(x03), .O(new_n39_));
  nor3   g14(.a(x02), .b(x01), .c(x00), .O(new_n40_));
  nand4  g15(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n39_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x13), .O(z02));
  inv1   g17(.a(x01), .O(new_n43_));
  nand3  g18(.a(new_n31_), .b(new_n43_), .c(x00), .O(new_n44_));
  inv1   g19(.a(x13), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n27_), .d(new_n39_), .O(new_n46_));
  ...
  aoi21  g24(.a(new_n49_), .b(new_n45_), .c(new_n43_), .O(z04));
  inv1   g25(.a(x00), .O(new_n51_));
  nor3   g26(.a(x02), .b(new_n43_), .c(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n27_), .d(new_n39_), .O(new_n53_));
  ...
  nand3  g37(.a(new_n45_), .b(new_n28_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n39_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n36_), .O(z06));
  nand4  g41(.a(new_n45_), .b(x05), .c(new_n27_), .d(new_n39_), .O(new_n67_));
  ...
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n39_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n36_), .O(z08));
  inv1   g47(.a(x06), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n43_), .c(new_n45_), .O(z09));
  nand3  g49(.a(new_n30_), .b(x06), .c(new_n39_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n36_), .O(z10));
endmodule
