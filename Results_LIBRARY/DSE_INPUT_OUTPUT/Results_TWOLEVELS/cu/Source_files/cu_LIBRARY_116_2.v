...
module FAU ( 
  ...
  nand4  g31(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n60_));
  nand2  g32(.a(new_n60_), .b(new_n54_), .O(new_n61_));
  nand3  g33(.a(new_n61_), .b(x04), .c(new_n41_), .O(new_n62_));
  inv1   g34(.a(new_n62_), .O(z08));
  and2   g35(.a(x13), .b(x06), .O(z09));
  oai21  g36(.a(new_n53_), .b(x02), .c(x05), .O(new_n65_));
  nand3  g37(.a(new_n65_), .b(x06), .c(new_n41_), .O(new_n66_));
  inv1   g38(.a(new_n66_), .O(z10));
  zero   g39(.O(z02));
  zero   g40(.O(z03));
  zero   g41(.O(z07));
