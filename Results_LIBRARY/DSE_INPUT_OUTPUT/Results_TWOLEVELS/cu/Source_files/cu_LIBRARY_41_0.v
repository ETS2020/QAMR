...
module FAU ( 
  ...
  nand3  g18(.a(new_n44_), .b(x05), .c(new_n29_), .O(new_n45_));
  ...
  aoi21  g41(.a(new_n49_), .b(new_n42_), .c(x13), .O(new_n68_));
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n71_));
  nand3  g45(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g47(.a(new_n73_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n74_));
  inv1   g48(.a(new_n74_), .O(z08));
  inv1   g49(.a(x06), .O(new_n76_));
  nor3   g50(.a(new_n26_), .b(new_n44_), .c(new_n76_), .O(z09));
