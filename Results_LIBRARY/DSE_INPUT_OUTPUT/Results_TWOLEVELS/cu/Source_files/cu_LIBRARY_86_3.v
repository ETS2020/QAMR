...
module FAU ( 
  ...
  nor2   g32(.a(x13), .b(new_n31_), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n57_), .c(new_n30_), .d(x00), .O(new_n59_));
  aoi21  g34(.a(new_n59_), .b(new_n27_), .c(new_n26_), .O(z05));
  inv1   g35(.a(x07), .O(new_n61_));
  nor2   g36(.a(x11), .b(new_n26_), .O(new_n62_));
  nor3   g37(.a(x12), .b(x09), .c(x01), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(new_n62_), .c(x00), .O(new_n64_));
  nor2   g39(.a(x10), .b(new_n26_), .O(new_n65_));
  nor3   g40(.a(x12), .b(x08), .c(x01), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n65_), .c(new_n52_), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n47_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n69_));
  nand3  g44(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n37_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n38_), .O(z06));
  nand3  g48(.a(x12), .b(x01), .c(new_n52_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n47_), .c(x05), .d(new_n30_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n37_), .c(new_n34_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n38_), .O(z07));
  nand4  g53(.a(x13), .b(new_n27_), .c(x05), .d(new_n34_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n70_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n37_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n38_), .O(z08));
  nand3  g57(.a(new_n38_), .b(x13), .c(x06), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z09));
  nand4  g59(.a(new_n33_), .b(new_n38_), .c(x06), .d(new_n37_), .O(new_n85_));
