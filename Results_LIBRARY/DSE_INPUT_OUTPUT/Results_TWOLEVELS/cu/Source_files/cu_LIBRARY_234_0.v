...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(x11), .c(x01), .O(z02));
  ...
  nand3  g34(.a(x11), .b(new_n59_), .c(new_n46_), .O(new_n60_));
  ...
  nand3  g42(.a(x11), .b(new_n67_), .c(new_n46_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n66_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n51_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n64_), .c(new_n42_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n36_), .b(new_n42_), .c(new_n29_), .d(x02), .O(new_n73_));
  ...
  aoi21  g52(.a(new_n77_), .b(x00), .c(x13), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n79_));
  oai21  g54(.a(new_n79_), .b(x02), .c(new_n36_), .O(z07));
  nand4  g55(.a(x13), .b(new_n58_), .c(x05), .d(new_n32_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n73_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n35_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n36_), .O(z08));
  nand2  g59(.a(x13), .b(x06), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n36_), .O(z09));
  nand3  g61(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n87_));
