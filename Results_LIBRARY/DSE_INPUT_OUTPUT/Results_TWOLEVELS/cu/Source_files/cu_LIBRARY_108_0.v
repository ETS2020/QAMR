...
module FAU ( 
  ...
  nand4  g17(.a(new_n33_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n43_));
  ...
  nand3  g21(.a(new_n34_), .b(new_n41_), .c(x00), .O(new_n47_));
  nand4  g22(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n48_));
  ...
  nand4  g46(.a(new_n33_), .b(new_n42_), .c(new_n36_), .d(x02), .O(new_n72_));
  oai21  g47(.a(new_n71_), .b(x02), .c(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n32_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z06));
  nand3  g50(.a(new_n26_), .b(new_n41_), .c(new_n50_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(new_n32_), .c(new_n34_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n33_), .O(z07));
  nand4  g55(.a(x13), .b(new_n56_), .c(x05), .d(new_n34_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n32_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n33_), .O(z08));
  inv1   g59(.a(x06), .O(new_n85_));
  nor3   g60(.a(new_n26_), .b(new_n42_), .c(new_n85_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n87_));
  nand4  g62(.a(new_n87_), .b(new_n33_), .c(x06), .d(new_n32_), .O(new_n88_));
