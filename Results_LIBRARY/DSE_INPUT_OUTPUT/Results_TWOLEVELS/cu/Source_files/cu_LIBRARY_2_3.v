...
module FAU ( 
  ...
  oai21  g09(.a(new_n34_), .b(x03), .c(x05), .O(new_n35_));
  nand4  g10(.a(new_n28_), .b(x04), .c(new_n26_), .d(x02), .O(new_n36_));
  ...
  nor2   g22(.a(x13), .b(x04), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n27_), .c(x01), .d(new_n47_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n26_), .c(new_n28_), .O(z04));
  ...
  nand4  g38(.a(new_n41_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x04), .O(new_n66_));
  nand2  g41(.a(x05), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  oai21  g43(.a(new_n42_), .b(x00), .c(x03), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n41_), .c(new_n31_), .d(new_n27_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n26_), .c(new_n28_), .O(z07));
  nand4  g46(.a(x13), .b(new_n55_), .c(x05), .d(new_n27_), .O(new_n72_));
  nand3  g47(.a(new_n41_), .b(new_n28_), .c(x02), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(x04), .c(new_n26_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  nand3  g51(.a(new_n67_), .b(x13), .c(x06), .O(new_n77_));
