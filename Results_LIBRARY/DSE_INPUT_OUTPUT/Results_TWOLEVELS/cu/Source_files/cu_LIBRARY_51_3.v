...
module FAU ( 
  ...
  nand4  g23(.a(new_n34_), .b(new_n36_), .c(new_n26_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n48_), .c(x05), .d(new_n29_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  nand4  g27(.a(new_n34_), .b(new_n36_), .c(x01), .d(new_n43_), .O(new_n53_));
  ...
  nand4  g32(.a(new_n57_), .b(new_n45_), .c(new_n29_), .d(x00), .O(new_n58_));
  ...
  nand3  g47(.a(x08), .b(x01), .c(new_n43_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n48_), .c(x05), .d(new_n29_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n34_), .c(new_n36_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n35_), .O(z07));
  nand4  g52(.a(x13), .b(new_n61_), .c(x05), .d(new_n36_), .O(new_n78_));
