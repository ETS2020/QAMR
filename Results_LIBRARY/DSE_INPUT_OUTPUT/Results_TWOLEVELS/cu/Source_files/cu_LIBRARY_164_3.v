...
module FAU ( 
  ...
  oai21  g09(.a(x11), .b(new_n26_), .c(new_n34_), .O(z00));
  ...
  nand2  g14(.a(x11), .b(x03), .O(new_n40_));
  ...
  nand4  g27(.a(new_n52_), .b(new_n47_), .c(x05), .d(new_n30_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n27_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n48_), .c(new_n40_), .O(z05));
  ...
  nand3  g41(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n67_));
  ...
  nand4  g45(.a(new_n47_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(x02), .c(new_n40_), .O(z07));
  ...
  nand3  g51(.a(new_n40_), .b(x13), .c(x06), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z09));
  nand3  g53(.a(new_n29_), .b(x06), .c(new_n26_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n40_), .O(z10));
endmodule
