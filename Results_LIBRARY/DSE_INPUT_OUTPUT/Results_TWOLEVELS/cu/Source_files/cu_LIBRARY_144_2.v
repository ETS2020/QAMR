...
module FAU ( 
  ...
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z02));
  ...
  nand4  g27(.a(new_n52_), .b(new_n38_), .c(new_n47_), .d(x10), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x10), .c(new_n45_), .O(z04));
  nand4  g29(.a(new_n37_), .b(new_n34_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x10), .c(x05), .d(new_n30_), .O(new_n57_));
  ...
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n76_));
  ...
  nand3  g59(.a(new_n33_), .b(x06), .c(new_n37_), .O(new_n85_));
