...
module FAU ( 
  ...
  nand3  g26(.a(new_n48_), .b(x05), .c(new_n34_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n37_), .c(new_n30_), .d(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x10), .c(new_n46_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n37_), .c(new_n30_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x10), .c(new_n46_), .O(z05));
  ...
  nand3  g38(.a(new_n63_), .b(new_n46_), .c(new_n51_), .O(new_n64_));
  aoi21  g39(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(new_n65_));
  nand4  g40(.a(new_n65_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n66_));
  nand4  g41(.a(new_n27_), .b(new_n48_), .c(new_n31_), .d(x02), .O(new_n67_));
  ...
  nand3  g45(.a(new_n53_), .b(new_n37_), .c(new_n30_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n27_), .O(z07));
  nand4  g47(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n73_));
  nand3  g48(.a(new_n48_), .b(new_n31_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n27_), .c(x04), .d(new_n37_), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z08));
  inv1   g52(.a(x06), .O(new_n78_));
  nor3   g53(.a(new_n28_), .b(new_n48_), .c(new_n78_), .O(z09));
