...
module FAU ( 
  ...
  nand4  g16(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n42_));
  ...
  nand4  g26(.a(new_n35_), .b(new_n31_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n50_), .c(x05), .d(new_n27_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand4  g30(.a(new_n35_), .b(new_n31_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n50_), .c(x05), .d(new_n27_), .O(new_n58_));
  ...
  nand2  g42(.a(x10), .b(x01), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(new_n50_), .c(new_n51_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n67_), .c(new_n44_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n71_));
  nand4  g46(.a(new_n34_), .b(new_n44_), .c(new_n28_), .d(x02), .O(new_n72_));
  ...
  aoi21  g50(.a(x08), .b(x01), .c(x13), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n34_), .O(z07));
  nand4  g53(.a(x13), .b(new_n61_), .c(x05), .d(new_n31_), .O(new_n79_));
  nand3  g54(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n80_));
  ...
  nand4  g60(.a(new_n30_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n86_));
