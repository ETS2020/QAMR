...
module FAU ( 
  ...
  nand4  g20(.a(new_n36_), .b(new_n28_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n28_), .b(x01), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n26_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n35_), .O(z04));
  nand3  g28(.a(new_n28_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n35_), .O(z05));
  ...
  nand4  g40(.a(new_n65_), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n66_));
  nand3  g41(.a(new_n26_), .b(new_n31_), .c(x02), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n36_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z06));
  nand4  g45(.a(new_n26_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n71_));
