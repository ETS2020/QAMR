...
module FAU ( 
  ...
  aoi21  g00(.a(x11), .b(x08), .c(x03), .O(new_n26_));
  ...
  nand2  g08(.a(x11), .b(x08), .O(new_n34_));
  ...
  nand4  g16(.a(new_n34_), .b(new_n41_), .c(x05), .d(new_n27_), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand3  g18(.a(new_n43_), .b(new_n35_), .c(new_n31_), .O(new_n44_));
  nor3   g19(.a(new_n44_), .b(x01), .c(x00), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nand3  g21(.a(new_n31_), .b(new_n46_), .c(x00), .O(new_n47_));
  nand4  g22(.a(new_n41_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n48_));
  ...
  aoi21  g31(.a(x09), .b(new_n46_), .c(new_n50_), .O(new_n57_));
  nor2   g32(.a(x10), .b(new_n46_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(new_n59_));
  inv1   g34(.a(x08), .O(new_n60_));
  aoi21  g35(.a(x10), .b(x01), .c(x00), .O(new_n61_));
  nor2   g36(.a(x09), .b(x01), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n59_), .c(new_n41_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n55_), .c(new_n54_), .d(x05), .O(new_n65_));
  nand4  g40(.a(new_n34_), .b(new_n41_), .c(new_n28_), .d(x02), .O(new_n66_));
  ...
  xnor2a g44(.a(x01), .b(x00), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n34_), .O(new_n71_));
  xnor2a g46(.a(x01), .b(x00), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n71_), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n34_), .O(z07));
  ...
  nand3  g54(.a(new_n34_), .b(x13), .c(x06), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z09));
  nand4  g56(.a(new_n30_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n82_));
