...
module FAU ( 
  ...
  oai21  g08(.a(new_n33_), .b(new_n32_), .c(x12), .O(new_n34_));
  ...
  nand4  g24(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n40_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand3  g27(.a(new_n29_), .b(x01), .c(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n46_), .b(x05), .c(new_n40_), .d(new_n36_), .O(new_n54_));
  ...
  nor2   g34(.a(x11), .b(new_n47_), .O(new_n60_));
  ...
  nand4  g40(.a(new_n65_), .b(new_n26_), .c(new_n58_), .d(x05), .O(new_n66_));
  ...
  nand4  g47(.a(x13), .b(new_n26_), .c(x05), .d(new_n29_), .O(new_n73_));
  ...
  nand2  g52(.a(new_n77_), .b(new_n27_), .O(z09));
  inv1   g53(.a(new_n32_), .O(new_n79_));
