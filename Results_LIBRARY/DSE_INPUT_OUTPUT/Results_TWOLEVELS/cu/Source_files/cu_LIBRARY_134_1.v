...
module FAU ( 
  ...
  oai21  g03(.a(x06), .b(new_n27_), .c(new_n28_), .O(new_n29_));
  ...
  nand2  g26(.a(x06), .b(new_n28_), .O(new_n52_));
  nand3  g27(.a(new_n30_), .b(x01), .c(x00), .O(new_n53_));
  nor2   g28(.a(x13), .b(new_n28_), .O(new_n54_));
  nand3  g29(.a(new_n54_), .b(new_n27_), .c(new_n26_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n53_), .c(new_n52_), .O(z05));
  ...
  nand4  g41(.a(new_n41_), .b(new_n35_), .c(new_n28_), .d(x02), .O(new_n67_));
  ...
  nand3  g45(.a(new_n54_), .b(new_n27_), .c(new_n26_), .O(new_n71_));
  ...
  nand2  g50(.a(new_n75_), .b(new_n52_), .O(z08));
  nor2   g51(.a(new_n54_), .b(new_n35_), .O(z09));
  nand4  g52(.a(x06), .b(x05), .c(new_n26_), .d(new_n30_), .O(new_n78_));
