...
module FAU ( 
  ...
  nand4  g17(.a(new_n35_), .b(new_n26_), .c(new_n43_), .d(x00), .O(new_n44_));
  inv1   g18(.a(new_n44_), .O(new_n45_));
  nand4  g19(.a(new_n45_), .b(new_n42_), .c(x05), .d(new_n30_), .O(new_n46_));
  ...
  nand4  g27(.a(new_n53_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n54_));
  nor2   g28(.a(new_n54_), .b(x13), .O(z05));
  nand3  g29(.a(x05), .b(new_n26_), .c(x01), .O(new_n56_));
  ...
  nand3  g34(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n61_));
  ...
  nand3  g40(.a(new_n66_), .b(x05), .c(new_n26_), .O(new_n67_));
  ...
  nand2  g44(.a(new_n70_), .b(new_n33_), .O(z06));
  aoi21  g45(.a(new_n43_), .b(new_n48_), .c(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand2  g48(.a(x05), .b(new_n26_), .O(new_n75_));
  nand2  g49(.a(x13), .b(new_n59_), .O(new_n76_));
  oai21  g50(.a(new_n76_), .b(new_n75_), .c(new_n61_), .O(new_n77_));
  nand4  g51(.a(new_n77_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n78_));
  inv1   g52(.a(new_n78_), .O(z08));
  inv1   g53(.a(x06), .O(new_n80_));
  nor3   g54(.a(new_n32_), .b(new_n42_), .c(new_n80_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n82_));
  nand3  g56(.a(new_n82_), .b(x06), .c(new_n35_), .O(new_n83_));
  nand2  g57(.a(new_n83_), .b(new_n33_), .O(z10));
  zero   g58(.O(z02));
endmodule
