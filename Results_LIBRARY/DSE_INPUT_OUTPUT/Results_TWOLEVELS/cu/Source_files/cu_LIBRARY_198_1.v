...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n35_), .O(z02));
  nand4  g21(.a(new_n36_), .b(new_n28_), .c(new_n43_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  nand4  g25(.a(new_n36_), .b(new_n28_), .c(x01), .d(new_n42_), .O(new_n51_));
  ...
  nand3  g37(.a(new_n62_), .b(new_n43_), .c(new_n42_), .O(new_n63_));
  oai21  g38(.a(new_n61_), .b(new_n42_), .c(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(x13), .c(new_n58_), .d(x10), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n57_), .c(x05), .d(new_n28_), .O(new_n67_));
  nand3  g42(.a(new_n26_), .b(new_n31_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n36_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z06));
  nand4  g46(.a(new_n26_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand2  g48(.a(x05), .b(new_n28_), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n58_), .c(x10), .O(new_n75_));
  ...
  aoi21  g54(.a(x10), .b(new_n79_), .c(new_n26_), .O(z09));
