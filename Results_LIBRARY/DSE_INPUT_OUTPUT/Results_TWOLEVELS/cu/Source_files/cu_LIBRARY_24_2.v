...
module FAU ( 
  ...
  nand3  g22(.a(new_n47_), .b(x05), .c(new_n29_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n34_), .c(new_n35_), .d(new_n46_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x07), .c(new_n45_), .O(z03));
  nand4  g26(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n45_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nand4  g30(.a(new_n49_), .b(new_n34_), .c(new_n35_), .d(x01), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x07), .c(new_n45_), .O(z05));
  nand4  g32(.a(new_n27_), .b(new_n47_), .c(new_n37_), .d(x02), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  inv1   g34(.a(x08), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n46_), .O(new_n61_));
  inv1   g36(.a(x10), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(x01), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n61_), .c(new_n47_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n59_), .c(new_n26_), .d(x05), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(x02), .c(new_n58_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n34_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n27_), .O(z06));
  nand3  g43(.a(new_n49_), .b(new_n34_), .c(new_n35_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n27_), .O(z07));
  nand4  g45(.a(x13), .b(new_n59_), .c(x05), .d(new_n35_), .O(new_n71_));
  nand3  g46(.a(new_n47_), .b(new_n37_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n27_), .c(x04), .d(new_n34_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  inv1   g50(.a(x06), .O(new_n76_));
  nor3   g51(.a(new_n28_), .b(new_n47_), .c(new_n76_), .O(z09));
  nand2  g52(.a(x05), .b(x02), .O(new_n78_));
  nand4  g53(.a(new_n78_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n79_));
