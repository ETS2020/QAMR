...
module FAU ( 
  ...
  nand2  g11(.a(new_n36_), .b(x06), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n30_), .c(x04), .d(x02), .O(new_n38_));
  inv1   g13(.a(new_n27_), .O(new_n39_));
  nand4  g14(.a(new_n39_), .b(x05), .c(new_n33_), .d(new_n29_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n38_), .c(x03), .O(z01));
  inv1   g16(.a(x00), .O(new_n42_));
  inv1   g17(.a(x01), .O(new_n43_));
  inv1   g18(.a(x03), .O(new_n44_));
  nand3  g19(.a(x05), .b(new_n33_), .c(new_n44_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n29_), .c(new_n43_), .d(new_n42_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n26_), .c(x13), .O(z02));
  nand4  g23(.a(new_n44_), .b(new_n29_), .c(new_n43_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z03));
  nor2   g27(.a(x02), .b(new_n43_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n46_), .c(new_n42_), .O(new_n54_));
  ...
  nand4  g42(.a(new_n36_), .b(new_n26_), .c(new_n30_), .d(x02), .O(new_n68_));
  oai21  g43(.a(new_n67_), .b(x02), .c(new_n68_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n44_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n39_), .O(z06));
  nand3  g46(.a(x06), .b(new_n43_), .c(x00), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x05), .c(new_n33_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n44_), .c(new_n29_), .O(new_n75_));
  ...
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n44_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z08));
  nand2  g55(.a(x05), .b(x02), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(x13), .c(x06), .d(new_n44_), .O(new_n82_));
