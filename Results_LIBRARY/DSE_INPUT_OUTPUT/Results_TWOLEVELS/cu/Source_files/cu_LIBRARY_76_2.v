...
module FAU ( 
  ...
  nand2  g17(.a(new_n42_), .b(new_n27_), .O(z01));
  nor3   g18(.a(x02), .b(x01), .c(x00), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  inv1   g21(.a(x13), .O(new_n47_));
  inv1   g22(.a(x01), .O(new_n48_));
  nand4  g23(.a(new_n37_), .b(new_n30_), .c(new_n48_), .d(x00), .O(new_n49_));
  ...
  nand4  g28(.a(new_n37_), .b(new_n30_), .c(x01), .d(new_n53_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x08), .c(x05), .d(new_n34_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z04));
  nor2   g32(.a(x03), .b(x02), .O(new_n58_));
  nor2   g33(.a(x13), .b(new_n26_), .O(new_n59_));
  nand4  g34(.a(new_n59_), .b(new_n58_), .c(new_n38_), .d(x00), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(x08), .c(new_n48_), .O(z05));
  inv1   g36(.a(x07), .O(new_n62_));
  inv1   g37(.a(x12), .O(new_n63_));
  nor2   g38(.a(x09), .b(x01), .O(new_n64_));
  nor2   g39(.a(x11), .b(new_n48_), .O(new_n65_));
  oai21  g40(.a(new_n65_), .b(new_n64_), .c(x00), .O(new_n66_));
  oai21  g41(.a(x10), .b(new_n48_), .c(x08), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n53_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n66_), .c(new_n47_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n63_), .c(new_n62_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n27_), .b(new_n47_), .c(new_n31_), .d(x02), .O(new_n71_));
  ...
  aoi21  g49(.a(new_n26_), .b(x01), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n63_), .c(x05), .d(new_n30_), .O(new_n78_));
  nand3  g53(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n79_));
  ...
  nor3   g58(.a(new_n28_), .b(new_n47_), .c(new_n83_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n37_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n27_), .O(z10));
endmodule
