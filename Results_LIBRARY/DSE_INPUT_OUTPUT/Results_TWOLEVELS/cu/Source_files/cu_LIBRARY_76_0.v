...
module FAU ( 
  ...
  nand4  g32(.a(new_n52_), .b(x05), .c(new_n32_), .d(new_n36_), .O(new_n58_));
  ...
  aoi21  g48(.a(new_n73_), .b(new_n43_), .c(x13), .O(new_n74_));
