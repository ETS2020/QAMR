...
module FAU ( 
  ...
  nand4  g26(.a(new_n33_), .b(new_n34_), .c(x01), .d(new_n41_), .O(new_n52_));
  ...
  nand4  g50(.a(x13), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n76_));
  nand3  g51(.a(new_n44_), .b(new_n36_), .c(x02), .O(new_n77_));
