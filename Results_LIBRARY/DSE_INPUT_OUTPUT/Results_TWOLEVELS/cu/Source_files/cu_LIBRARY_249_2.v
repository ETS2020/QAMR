...
module FAU ( 
  ...
  nand3  g21(.a(new_n30_), .b(x01), .c(new_n41_), .O(new_n47_));
  nand3  g22(.a(new_n43_), .b(new_n26_), .c(new_n35_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n33_), .O(z04));
  nand4  g24(.a(new_n43_), .b(new_n42_), .c(new_n26_), .d(x01), .O(new_n50_));
  ...
  aoi21  g40(.a(new_n32_), .b(x00), .c(x13), .O(new_n66_));
