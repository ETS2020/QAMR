...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n46_));
  ...
  nand4  g26(.a(new_n45_), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n35_), .c(new_n36_), .d(new_n43_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n35_), .c(new_n36_), .d(x00), .O(new_n56_));
  ...
  nand3  g41(.a(new_n45_), .b(new_n38_), .c(x02), .O(new_n67_));
  ...
  aoi21  g45(.a(x10), .b(x01), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n36_), .O(new_n74_));
