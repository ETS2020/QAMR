...
module FAU ( 
  ...
  nand3  g32(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n58_));
  ...
  nand4  g39(.a(new_n42_), .b(new_n27_), .c(x02), .d(new_n32_), .O(new_n65_));
  ...
  nand4  g43(.a(new_n42_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n69_));
  ...
  nand4  g48(.a(new_n73_), .b(new_n34_), .c(x04), .d(new_n36_), .O(new_n74_));
  ...
  nand4  g53(.a(new_n78_), .b(new_n34_), .c(x06), .d(new_n36_), .O(new_n79_));
