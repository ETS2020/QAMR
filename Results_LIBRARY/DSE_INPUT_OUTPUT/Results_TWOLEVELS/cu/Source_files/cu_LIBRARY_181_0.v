...
module FAU ( 
  ...
  nand4  g18(.a(new_n26_), .b(new_n27_), .c(new_n38_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n39_), .c(x05), .d(new_n31_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  nand4  g22(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n37_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n39_), .c(x05), .d(new_n31_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nand4  g26(.a(new_n41_), .b(new_n26_), .c(x01), .d(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x05), .c(x02), .O(z05));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nor2   g30(.a(x09), .b(x01), .O(new_n56_));
  nor2   g31(.a(x11), .b(new_n38_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(x00), .O(new_n58_));
  nor2   g33(.a(x08), .b(x01), .O(new_n59_));
  nor2   g34(.a(x10), .b(new_n38_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(new_n37_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n58_), .c(new_n39_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n54_), .d(x04), .O(new_n63_));
  oai21  g38(.a(new_n63_), .b(x03), .c(x05), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n27_), .O(new_n65_));
  nand4  g40(.a(new_n39_), .b(new_n28_), .c(x04), .d(new_n26_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(z06));
  nor3   g42(.a(new_n40_), .b(x03), .c(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n55_), .c(x04), .d(new_n26_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(x05), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n27_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n66_), .O(z08));
  nand2  g47(.a(x13), .b(x06), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n29_), .O(z09));
  aoi21  g49(.a(x06), .b(new_n26_), .c(new_n28_), .O(new_n75_));
  nand3  g50(.a(x06), .b(new_n28_), .c(new_n26_), .O(new_n76_));
  oai21  g51(.a(new_n75_), .b(x02), .c(new_n76_), .O(z10));
endmodule
