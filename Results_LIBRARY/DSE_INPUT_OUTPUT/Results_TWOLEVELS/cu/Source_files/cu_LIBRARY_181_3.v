...
module FAU ( 
  ...
  nand4  g14(.a(new_n39_), .b(new_n31_), .c(new_n38_), .d(new_n37_), .O(new_n40_));
  aoi21  g15(.a(new_n40_), .b(new_n31_), .c(new_n28_), .O(z02));
  inv1   g16(.a(x13), .O(new_n42_));
  nand4  g17(.a(new_n26_), .b(new_n31_), .c(new_n38_), .d(x00), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(z03));
  nand4  g21(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n37_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n42_), .c(x05), .d(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nand4  g25(.a(new_n39_), .b(new_n31_), .c(x01), .d(x00), .O(new_n51_));
  ...
  nor2   g30(.a(x11), .b(new_n38_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  nor2   g32(.a(x08), .b(x01), .O(new_n58_));
  nor2   g33(.a(x10), .b(new_n38_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n37_), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n57_), .c(new_n42_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n54_), .c(new_n53_), .d(x05), .O(new_n62_));
  nand2  g37(.a(new_n42_), .b(x02), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n26_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n30_), .O(z06));
  nand4  g41(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand3  g43(.a(new_n42_), .b(x04), .c(new_n26_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n28_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(x02), .O(new_n71_));
  nor2   g46(.a(new_n27_), .b(x03), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x13), .c(new_n54_), .d(x05), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n71_), .O(z08));
  inv1   g49(.a(x06), .O(new_n75_));
  oai21  g50(.a(new_n42_), .b(new_n75_), .c(new_n30_), .O(z09));
  oai21  g51(.a(new_n75_), .b(x03), .c(new_n30_), .O(z10));
endmodule
