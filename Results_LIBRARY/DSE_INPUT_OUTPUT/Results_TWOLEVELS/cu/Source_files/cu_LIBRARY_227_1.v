...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n46_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(new_n56_), .d(new_n34_), .O(new_n65_));
  ...
  nand4  g44(.a(new_n30_), .b(x05), .c(new_n35_), .d(new_n39_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(x02), .c(new_n27_), .O(z07));
  nand3  g46(.a(x13), .b(new_n57_), .c(new_n34_), .O(new_n72_));
  ...
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n39_), .O(new_n79_));
