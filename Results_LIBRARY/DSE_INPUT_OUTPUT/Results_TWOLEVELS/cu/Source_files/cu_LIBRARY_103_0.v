...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n74_, new_n75_, new_n78_, new_n79_, new_n80_, new_n82_, new_n84_,
    new_n85_;
  ...
  nand4  g20(.a(new_n45_), .b(new_n34_), .c(new_n35_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x05), .c(x01), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n34_), .c(new_n35_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x05), .c(x01), .O(z03));
  nand4  g24(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n42_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n43_), .c(x05), .d(new_n36_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nor3   g28(.a(x02), .b(new_n26_), .c(new_n42_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n36_), .d(new_n34_), .O(new_n55_));
  ...
  nand3  g36(.a(new_n61_), .b(x05), .c(x01), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(x05), .c(x01), .O(new_n68_));
  ...
  nand4  g47(.a(new_n43_), .b(new_n27_), .c(x02), .d(x01), .O(new_n73_));
  ...
  nor3   g51(.a(new_n44_), .b(x03), .c(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n78_));
  ...
  nand2  g57(.a(new_n82_), .b(new_n28_), .O(z09));
