...
module FAU ( 
  ...
  nand4  g22(.a(new_n35_), .b(new_n27_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g23(.a(new_n49_), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(new_n42_), .c(x05), .d(new_n29_), .O(new_n51_));
  inv1   g25(.a(new_n51_), .O(z04));
  nor3   g26(.a(x02), .b(new_n43_), .c(new_n48_), .O(new_n53_));
  nand4  g27(.a(new_n53_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n54_));
  nor2   g28(.a(new_n54_), .b(x13), .O(z05));
  nand4  g29(.a(new_n34_), .b(new_n42_), .c(new_n30_), .d(x02), .O(new_n56_));
  ...
  nand4  g43(.a(new_n69_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n70_));
  oai21  g44(.a(new_n70_), .b(x02), .c(new_n34_), .O(z07));
  nand4  g45(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n72_));
  ...
  inv1   g51(.a(new_n31_), .O(new_n78_));
  nand4  g52(.a(new_n78_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n79_));
