...
module FAU ( 
  ...
  nand4  g26(.a(new_n33_), .b(new_n46_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand3  g33(.a(new_n59_), .b(new_n44_), .c(new_n32_), .O(new_n60_));
  ...
  nand3  g43(.a(new_n46_), .b(new_n27_), .c(x02), .O(new_n70_));
