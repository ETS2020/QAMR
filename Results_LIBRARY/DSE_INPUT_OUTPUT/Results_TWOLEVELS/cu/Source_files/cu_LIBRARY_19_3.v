...
module FAU ( 
  ...
  nand4  g23(.a(new_n40_), .b(new_n29_), .c(x01), .d(new_n48_), .O(new_n49_));
  ...
  oai21  g28(.a(new_n53_), .b(new_n46_), .c(new_n36_), .O(z05));
  ...
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n26_), .d(x05), .O(new_n63_));
  nand3  g38(.a(new_n27_), .b(new_n32_), .c(x02), .O(new_n64_));
  ...
  nand4  g42(.a(new_n27_), .b(x05), .c(new_n31_), .d(new_n40_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(x02), .c(new_n36_), .O(z07));
  nand2  g44(.a(x05), .b(new_n29_), .O(new_n70_));
  nand3  g45(.a(x13), .b(new_n55_), .c(new_n26_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n40_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(z08));
  nand3  g49(.a(x13), .b(new_n26_), .c(x06), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z09));
  inv1   g51(.a(new_n33_), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n36_), .c(x06), .d(new_n40_), .O(new_n78_));
