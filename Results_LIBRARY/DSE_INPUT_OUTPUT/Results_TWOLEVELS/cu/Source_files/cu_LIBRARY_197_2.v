...
module FAU ( 
  ...
  nand4  g23(.a(new_n48_), .b(x09), .c(x05), .d(new_n28_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand3  g25(.a(new_n35_), .b(x01), .c(new_n26_), .O(new_n51_));
  ...
  nand4  g32(.a(new_n57_), .b(new_n55_), .c(new_n37_), .d(x01), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x09), .c(new_n26_), .O(z05));
  nand4  g34(.a(x04), .b(new_n34_), .c(new_n35_), .d(x01), .O(new_n60_));
  ...
  oai21  g39(.a(new_n64_), .b(new_n60_), .c(x09), .O(new_n65_));
  ...
  nand4  g47(.a(new_n72_), .b(x13), .c(new_n67_), .d(new_n61_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n35_), .d(new_n26_), .O(new_n75_));
  nand3  g50(.a(new_n52_), .b(new_n36_), .c(x02), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n75_), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(x04), .c(new_n34_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n66_), .O(z06));
  aoi21  g54(.a(new_n56_), .b(x00), .c(x13), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n81_));
  nor2   g56(.a(new_n81_), .b(x02), .O(z07));
  nand3  g57(.a(new_n63_), .b(x05), .c(new_n35_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n76_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n34_), .O(new_n85_));
  nand2  g60(.a(new_n85_), .b(new_n33_), .O(z08));
  nand2  g61(.a(x13), .b(x06), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(new_n33_), .O(z09));
  nand2  g63(.a(x05), .b(x02), .O(new_n89_));
  nand4  g64(.a(new_n89_), .b(new_n33_), .c(x06), .d(new_n34_), .O(new_n90_));
