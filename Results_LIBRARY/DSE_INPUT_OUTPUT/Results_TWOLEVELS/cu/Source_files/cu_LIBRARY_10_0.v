...
module FAU ( 
  ...
  nor2   g16(.a(x13), .b(new_n36_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n41_), .c(new_n27_), .d(x00), .O(new_n43_));
  aoi21  g18(.a(new_n43_), .b(x00), .c(x01), .O(z03));
  inv1   g19(.a(x13), .O(new_n45_));
  inv1   g20(.a(x00), .O(new_n46_));
  nand4  g21(.a(new_n32_), .b(new_n34_), .c(x01), .d(new_n46_), .O(new_n47_));
  ...
  nand3  g42(.a(new_n45_), .b(new_n36_), .c(x02), .O(new_n68_));
  ...
  aoi21  g46(.a(new_n51_), .b(new_n46_), .c(x13), .O(new_n72_));
