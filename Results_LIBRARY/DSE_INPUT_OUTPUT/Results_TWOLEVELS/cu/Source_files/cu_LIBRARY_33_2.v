...
module FAU ( 
  ...
  nand4  g23(.a(new_n35_), .b(new_n26_), .c(x01), .d(new_n41_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nor3   g27(.a(x02), .b(new_n32_), .c(new_n41_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z05));
  nand3  g30(.a(new_n42_), .b(x05), .c(x04), .O(new_n56_));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x11), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  nand4  g34(.a(x13), .b(new_n59_), .c(new_n58_), .d(new_n57_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n56_), .c(x01), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(x00), .O(new_n62_));
  nand3  g37(.a(x05), .b(new_n26_), .c(x01), .O(new_n63_));
  ...
  nand4  g43(.a(new_n43_), .b(new_n27_), .c(x02), .d(x01), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(new_n70_));
  nand3  g45(.a(x05), .b(new_n26_), .c(new_n32_), .O(new_n71_));
  ...
  aoi21  g54(.a(new_n45_), .b(new_n42_), .c(new_n32_), .O(new_n80_));
  nand2  g55(.a(x01), .b(x00), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n43_), .c(x05), .d(new_n30_), .O(new_n82_));
  inv1   g57(.a(new_n82_), .O(new_n83_));
  nand3  g58(.a(new_n83_), .b(new_n35_), .c(new_n26_), .O(new_n84_));
  oai21  g59(.a(new_n80_), .b(new_n41_), .c(new_n84_), .O(z07));
  nand2  g60(.a(x13), .b(new_n59_), .O(new_n86_));
  nand2  g61(.a(x05), .b(new_n26_), .O(new_n87_));
  oai21  g62(.a(new_n87_), .b(new_n86_), .c(new_n66_), .O(new_n88_));
  nand4  g63(.a(new_n88_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n89_));
  inv1   g64(.a(new_n89_), .O(z08));
  nand2  g65(.a(x13), .b(x06), .O(new_n91_));
  nand2  g66(.a(new_n91_), .b(new_n33_), .O(z09));
  nand2  g67(.a(x05), .b(x02), .O(new_n93_));
  nand4  g68(.a(new_n93_), .b(new_n33_), .c(x06), .d(new_n35_), .O(new_n94_));
  inv1   g69(.a(new_n94_), .O(z10));
endmodule
