...
module FAU ( 
  ...
  nand4  g21(.a(new_n37_), .b(new_n33_), .c(new_n46_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n26_), .c(x05), .d(new_n29_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand4  g26(.a(new_n37_), .b(new_n33_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n26_), .c(x05), .d(new_n29_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nand3  g30(.a(new_n33_), .b(x01), .c(x00), .O(new_n56_));
  nand4  g31(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n56_), .c(new_n36_), .O(z05));
  ...
  nand3  g39(.a(new_n64_), .b(x01), .c(new_n51_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n26_), .O(new_n66_));
  ...
  nand4  g46(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n36_), .O(z07));
