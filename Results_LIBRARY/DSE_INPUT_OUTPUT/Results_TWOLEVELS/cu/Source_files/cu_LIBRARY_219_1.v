...
module FAU ( 
  ...
  nand4  g21(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n47_));
  ...
  nand4  g26(.a(new_n33_), .b(new_n42_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand4  g39(.a(new_n42_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n66_));
  oai21  g40(.a(new_n66_), .b(x02), .c(new_n33_), .O(z07));
  nand4  g41(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand2  g42(.a(new_n68_), .b(new_n53_), .O(new_n69_));
  nand3  g43(.a(new_n69_), .b(x04), .c(new_n35_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n33_), .O(z08));
  nand2  g45(.a(x13), .b(x06), .O(new_n72_));
  nand2  g46(.a(new_n72_), .b(new_n33_), .O(z09));
  nand3  g47(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n74_));
