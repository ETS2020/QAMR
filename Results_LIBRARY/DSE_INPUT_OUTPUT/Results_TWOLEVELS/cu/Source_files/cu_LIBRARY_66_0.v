...
module FAU ( 
  ...
  aoi21  g05(.a(new_n30_), .b(new_n28_), .c(z02), .O(z00));
  ...
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nand3  g27(.a(x05), .b(new_n34_), .c(x01), .O(new_n53_));
  ...
  nand3  g32(.a(new_n41_), .b(new_n36_), .c(x02), .O(new_n58_));
  oai21  g33(.a(new_n57_), .b(new_n53_), .c(new_n58_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(x00), .O(new_n60_));
  oai22  g35(.a(x10), .b(x00), .c(x09), .d(x01), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(x13), .c(new_n56_), .d(new_n54_), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(x05), .c(new_n34_), .O(new_n64_));
  nand4  g39(.a(new_n41_), .b(new_n36_), .c(x02), .d(x01), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(new_n64_), .c(new_n60_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n32_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n33_), .O(z06));
  aoi21  g43(.a(x01), .b(new_n45_), .c(x13), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(x02), .c(new_n47_), .O(z07));
  ...
  nand4  g49(.a(new_n74_), .b(new_n33_), .c(x04), .d(new_n32_), .O(new_n75_));
  ...
  nand4  g54(.a(new_n79_), .b(new_n33_), .c(x06), .d(new_n32_), .O(new_n80_));
