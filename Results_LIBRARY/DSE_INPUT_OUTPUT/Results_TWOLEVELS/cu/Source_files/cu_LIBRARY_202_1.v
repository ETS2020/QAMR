...
module FAU ( 
  ...
  nand3  g27(.a(new_n30_), .b(x01), .c(new_n44_), .O(new_n53_));
  nand3  g28(.a(new_n50_), .b(new_n34_), .c(new_n37_), .O(new_n54_));
  ...
  nand2  g38(.a(x08), .b(new_n26_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n43_), .c(new_n44_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n60_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n27_), .b(new_n60_), .c(new_n31_), .d(x02), .O(new_n68_));
  ...
  nand3  g46(.a(x10), .b(new_n26_), .c(new_n44_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n37_), .c(new_n30_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n27_), .O(z07));
  nand4  g51(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n77_));
  nand3  g52(.a(new_n60_), .b(new_n31_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n27_), .c(x04), .d(new_n37_), .O(new_n80_));
  inv1   g55(.a(new_n80_), .O(z08));
  inv1   g56(.a(x06), .O(new_n82_));
  nor3   g57(.a(new_n28_), .b(new_n60_), .c(new_n82_), .O(z09));
