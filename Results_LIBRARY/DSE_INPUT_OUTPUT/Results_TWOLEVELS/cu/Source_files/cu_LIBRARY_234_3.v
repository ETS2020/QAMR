...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n31_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n44_), .c(x05), .d(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x11), .O(new_n51_));
  nand3  g26(.a(new_n44_), .b(x05), .c(new_n27_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n34_), .c(new_n31_), .d(new_n41_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n51_), .c(new_n42_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n34_), .c(new_n31_), .d(x00), .O(new_n56_));
  ...
  nand4  g42(.a(new_n35_), .b(new_n44_), .c(new_n28_), .d(x02), .O(new_n68_));
  ...
  nand3  g46(.a(new_n53_), .b(new_n34_), .c(new_n31_), .O(new_n72_));
  ...
  nand3  g54(.a(new_n30_), .b(x06), .c(new_n34_), .O(new_n80_));
