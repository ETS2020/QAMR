...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n67_, new_n68_, new_n69_, new_n71_, new_n72_, new_n74_, new_n77_;
  inv1   g00(.a(x03), .O(new_n26_));
  inv1   g01(.a(x02), .O(new_n27_));
  inv1   g02(.a(x13), .O(new_n28_));
  oai21  g03(.a(new_n28_), .b(new_n27_), .c(x04), .O(new_n29_));
  ...
  nand3  g09(.a(x05), .b(new_n31_), .c(new_n27_), .O(new_n35_));
  ...
  nand2  g13(.a(new_n28_), .b(x04), .O(new_n39_));
  ...
  nand4  g21(.a(new_n46_), .b(new_n28_), .c(x05), .d(new_n31_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(x05), .b(new_n26_), .c(new_n27_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(x01), .c(new_n49_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n31_), .c(x13), .O(z04));
  nand3  g28(.a(new_n51_), .b(x01), .c(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n31_), .c(x13), .O(z05));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n58_), .c(new_n49_), .O(new_n61_));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(x00), .O(new_n66_));
  oai21  g41(.a(new_n66_), .b(new_n61_), .c(new_n56_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x07), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n26_), .d(new_n27_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(x13), .c(new_n31_), .O(z06));
  nand2  g45(.a(x04), .b(new_n44_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n26_), .d(new_n27_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n31_), .c(x13), .O(z07));
  nand4  g48(.a(new_n56_), .b(x05), .c(new_n26_), .d(new_n27_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(x13), .c(new_n31_), .O(z08));
  and2   g50(.a(x13), .b(x06), .O(z09));
  nand3  g51(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n39_), .O(z10));
endmodule
