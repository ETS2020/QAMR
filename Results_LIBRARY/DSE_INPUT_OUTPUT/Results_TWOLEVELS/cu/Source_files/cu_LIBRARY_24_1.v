...
module FAU ( 
  ...
  nand4  g18(.a(new_n34_), .b(new_n35_), .c(new_n43_), .d(new_n26_), .O(new_n44_));
  ...
  nand4  g24(.a(new_n49_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n27_), .O(z03));
  nand4  g26(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n26_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n42_), .c(x05), .d(new_n29_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nand3  g30(.a(new_n35_), .b(x01), .c(x00), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n50_), .c(new_n27_), .O(z05));
  ...
  nand3  g38(.a(new_n63_), .b(new_n42_), .c(x00), .O(new_n64_));
  ...
  nand4  g43(.a(new_n68_), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n69_));
  nand4  g44(.a(new_n27_), .b(new_n49_), .c(new_n37_), .d(x02), .O(new_n70_));
  ...
  aoi21  g48(.a(x07), .b(new_n26_), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g51(.a(x13), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n77_));
  nand3  g52(.a(new_n49_), .b(new_n37_), .c(x02), .O(new_n78_));
  ...
  nor3   g57(.a(new_n28_), .b(new_n49_), .c(new_n82_), .O(z09));
  nand2  g58(.a(x05), .b(x02), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n85_));
