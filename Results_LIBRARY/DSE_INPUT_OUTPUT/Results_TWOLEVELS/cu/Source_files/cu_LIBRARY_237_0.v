...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n27_), .c(new_n43_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x09), .c(x13), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n27_), .c(new_n43_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x09), .c(x05), .d(new_n29_), .O(new_n50_));
  ...
  nor2   g46(.a(x09), .b(x01), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x00), .c(new_n30_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n29_), .c(new_n35_), .d(new_n27_), .O(new_n74_));
  aoi21  g49(.a(new_n74_), .b(x09), .c(x13), .O(z07));
  nand4  g50(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n76_));
  ...
  inv1   g56(.a(new_n31_), .O(new_n82_));
