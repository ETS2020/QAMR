...
module FAU ( 
  ...
  nand4  g20(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n36_), .O(z02));
  nand3  g22(.a(new_n33_), .b(new_n44_), .c(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n36_), .O(z03));
  nand3  g24(.a(new_n33_), .b(x01), .c(new_n43_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n36_), .O(z04));
  nand3  g26(.a(new_n33_), .b(x01), .c(x00), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n46_), .c(new_n36_), .O(z05));
  ...
  nand4  g36(.a(new_n61_), .b(x13), .c(new_n55_), .d(x09), .O(new_n62_));
  inv1   g37(.a(new_n62_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n54_), .c(x05), .d(new_n33_), .O(new_n64_));
  ...
  nand4  g43(.a(new_n26_), .b(x05), .c(new_n29_), .d(new_n37_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand4  g45(.a(x13), .b(new_n55_), .c(x05), .d(new_n33_), .O(new_n71_));
  ...
  nand3  g51(.a(new_n32_), .b(x06), .c(new_n37_), .O(new_n77_));
