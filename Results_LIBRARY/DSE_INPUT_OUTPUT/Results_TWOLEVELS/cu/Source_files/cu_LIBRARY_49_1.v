...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n44_));
  ...
  nand3  g24(.a(new_n32_), .b(x01), .c(new_n48_), .O(new_n50_));
  ...
  aoi21  g47(.a(new_n72_), .b(new_n68_), .c(new_n43_), .O(new_n73_));
  ...
  nand2  g52(.a(x05), .b(new_n32_), .O(new_n78_));
  nand2  g53(.a(x13), .b(new_n58_), .O(new_n79_));
  oai21  g54(.a(new_n79_), .b(new_n78_), .c(new_n60_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  oai21  g57(.a(new_n43_), .b(new_n26_), .c(new_n35_), .O(z09));
  nand3  g58(.a(new_n31_), .b(x06), .c(new_n36_), .O(new_n84_));
