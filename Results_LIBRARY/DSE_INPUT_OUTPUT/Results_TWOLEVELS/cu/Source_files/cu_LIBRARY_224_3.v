...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n50_, new_n52_, new_n54_, new_n55_, new_n57_, new_n59_, new_n60_,
  ...
  nand3  g24(.a(new_n34_), .b(new_n45_), .c(x00), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n38_), .O(z03));
  nand3  g26(.a(new_n34_), .b(x01), .c(new_n44_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n48_), .c(new_n38_), .O(z04));
  nor2   g28(.a(new_n28_), .b(x13), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x02), .O(z07));
  nand2  g31(.a(z07), .b(x01), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(new_n44_), .O(z05));
  ...
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(x05), .d(new_n34_), .O(new_n67_));
  nand3  g42(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n67_), .c(x12), .O(new_n69_));
  nand4  g44(.a(new_n47_), .b(new_n26_), .c(new_n31_), .d(x02), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n69_), .c(x04), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x03), .O(z06));
  nand3  g48(.a(new_n54_), .b(new_n31_), .c(x02), .O(new_n74_));
  nand4  g49(.a(x13), .b(new_n27_), .c(x05), .d(new_n34_), .O(new_n75_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n38_), .O(z09));
  nand4  g55(.a(new_n33_), .b(new_n38_), .c(x06), .d(new_n37_), .O(new_n81_));
