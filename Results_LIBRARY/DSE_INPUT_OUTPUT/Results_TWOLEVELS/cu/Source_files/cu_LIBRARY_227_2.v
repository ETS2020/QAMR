...
module FAU ( 
  ...
  wire new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n43_, new_n44_, new_n45_, new_n46_,
    new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n53_,
    new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n60_, new_n61_,
    new_n62_, new_n63_, new_n66_, new_n67_;
  inv1   g00(.a(x05), .O(new_n26_));
  nor2   g01(.a(x13), .b(new_n26_), .O(z07));
  inv1   g02(.a(z07), .O(new_n28_));
  ...
  inv1   g13(.a(x03), .O(new_n43_));
  inv1   g14(.a(x07), .O(new_n44_));
  nor2   g15(.a(x09), .b(x01), .O(new_n45_));
  inv1   g16(.a(x01), .O(new_n46_));
  nor2   g17(.a(x11), .b(new_n46_), .O(new_n47_));
  oai21  g18(.a(new_n47_), .b(new_n45_), .c(x00), .O(new_n48_));
  inv1   g19(.a(x00), .O(new_n49_));
  nor2   g20(.a(x08), .b(x01), .O(new_n50_));
  nor2   g21(.a(x10), .b(new_n46_), .O(new_n51_));
  oai21  g22(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n52_));
  aoi21  g23(.a(new_n52_), .b(new_n48_), .c(x12), .O(new_n53_));
  nand4  g24(.a(new_n53_), .b(new_n44_), .c(x05), .d(new_n30_), .O(new_n54_));
  inv1   g25(.a(x13), .O(new_n55_));
  nand2  g26(.a(new_n55_), .b(x02), .O(new_n56_));
  nand2  g27(.a(new_n56_), .b(new_n54_), .O(new_n57_));
  nand3  g28(.a(new_n57_), .b(x04), .c(new_n43_), .O(new_n58_));
  nand2  g29(.a(new_n58_), .b(new_n28_), .O(z06));
  inv1   g30(.a(x12), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x05), .c(new_n30_), .O(new_n61_));
  nand2  g32(.a(new_n61_), .b(new_n56_), .O(new_n62_));
  nand3  g33(.a(new_n62_), .b(x04), .c(new_n43_), .O(new_n63_));
  nand2  g34(.a(new_n63_), .b(new_n28_), .O(z08));
  and2   g35(.a(x13), .b(x06), .O(z09));
  nand2  g36(.a(x05), .b(x02), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x06), .c(new_n43_), .O(new_n67_));
  nand2  g38(.a(new_n67_), .b(new_n28_), .O(z10));
  zero   g39(.O(z02));
  zero   g40(.O(z03));
  zero   g41(.O(z04));
  zero   g42(.O(z05));
