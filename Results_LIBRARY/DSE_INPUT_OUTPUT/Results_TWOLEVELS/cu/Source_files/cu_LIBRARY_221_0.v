...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  inv1   g20(.a(x00), .O(new_n46_));
  nand4  g21(.a(new_n26_), .b(new_n31_), .c(x01), .d(new_n46_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n29_), .c(x05), .d(new_n27_), .O(new_n49_));
  ...
  nand4  g41(.a(new_n29_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n67_));
  ...
  nand2  g46(.a(new_n29_), .b(new_n28_), .O(new_n72_));
