...
module FAU ( 
  ...
  aoi21  g07(.a(new_n32_), .b(new_n30_), .c(z04), .O(z00));
  ...
  nand4  g42(.a(new_n67_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n68_));
  ...
  nor3   g49(.a(z04), .b(new_n45_), .c(new_n74_), .O(z09));
