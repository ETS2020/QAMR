...
module FAU ( 
  ...
  nand3  g20(.a(new_n35_), .b(x01), .c(new_n46_), .O(new_n47_));
  inv1   g21(.a(x13), .O(new_n48_));
  nand4  g22(.a(new_n48_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n49_));
  oai21  g23(.a(new_n49_), .b(new_n47_), .c(new_n27_), .O(z04));
  nor3   g24(.a(x02), .b(new_n26_), .c(new_n46_), .O(new_n51_));
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(x13), .O(z05));
  nand4  g27(.a(x05), .b(x04), .c(new_n34_), .d(new_n35_), .O(new_n54_));
  ...
  aoi21  g51(.a(new_n26_), .b(x00), .c(x13), .O(new_n78_));
  nand4  g52(.a(new_n78_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n79_));
  nor2   g53(.a(new_n79_), .b(x02), .O(z07));
  nand2  g54(.a(x13), .b(new_n57_), .O(new_n81_));
  nand2  g55(.a(x05), .b(new_n35_), .O(new_n82_));
  oai21  g56(.a(new_n82_), .b(new_n81_), .c(new_n64_), .O(new_n83_));
  nand4  g57(.a(new_n83_), .b(new_n27_), .c(x04), .d(new_n34_), .O(new_n84_));
  inv1   g58(.a(new_n84_), .O(z08));
  inv1   g59(.a(x06), .O(new_n86_));
  nor3   g60(.a(new_n28_), .b(new_n48_), .c(new_n86_), .O(z09));
  nand2  g61(.a(x05), .b(x02), .O(new_n88_));
  nand3  g62(.a(new_n88_), .b(x06), .c(new_n34_), .O(new_n89_));
  nand2  g63(.a(new_n89_), .b(new_n27_), .O(z10));
  zero   g64(.O(z03));
endmodule
