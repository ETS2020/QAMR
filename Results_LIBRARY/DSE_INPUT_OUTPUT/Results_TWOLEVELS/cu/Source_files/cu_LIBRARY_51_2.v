...
module FAU ( 
  ...
  nand3  g17(.a(new_n35_), .b(new_n26_), .c(new_n42_), .O(new_n43_));
  ...
  nand4  g22(.a(new_n33_), .b(new_n35_), .c(new_n26_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n47_), .c(x05), .d(new_n28_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n33_), .b(new_n35_), .c(x01), .d(new_n42_), .O(new_n52_));
  ...
  nand4  g31(.a(new_n56_), .b(new_n44_), .c(new_n28_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x08), .c(new_n26_), .O(z05));
  ...
  oai21  g38(.a(x10), .b(new_n26_), .c(x08), .O(new_n64_));
  ...
  nand3  g42(.a(new_n47_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  nand3  g47(.a(new_n72_), .b(x01), .c(new_n42_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n47_), .c(x05), .d(new_n28_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n33_), .c(new_n35_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n34_), .O(z07));
  nand4  g52(.a(x13), .b(new_n60_), .c(x05), .d(new_n35_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n68_), .O(new_n79_));
  ...
  nand3  g59(.a(new_n84_), .b(x06), .c(new_n33_), .O(new_n85_));
