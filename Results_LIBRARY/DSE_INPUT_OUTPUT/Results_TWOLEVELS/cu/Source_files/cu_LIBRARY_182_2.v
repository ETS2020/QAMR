...
module FAU ( 
  ...
  nand4  g21(.a(new_n35_), .b(new_n30_), .c(x01), .d(new_n41_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n42_), .c(x05), .d(new_n26_), .O(new_n50_));
  inv1   g24(.a(new_n50_), .O(z04));
  nand4  g25(.a(new_n44_), .b(new_n35_), .c(new_n30_), .d(x01), .O(new_n52_));
  aoi21  g26(.a(new_n52_), .b(x01), .c(new_n41_), .O(z05));
