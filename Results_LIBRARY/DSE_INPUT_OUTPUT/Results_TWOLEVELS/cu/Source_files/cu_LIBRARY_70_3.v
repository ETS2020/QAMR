...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n45_));
  ...
  nand4  g32(.a(new_n57_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z05));
  inv1   g34(.a(x12), .O(new_n60_));
  nor3   g35(.a(x09), .b(x07), .c(x01), .O(new_n61_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n68_));
  ...
  nand3  g56(.a(new_n33_), .b(x06), .c(new_n37_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n38_), .O(z10));
endmodule
