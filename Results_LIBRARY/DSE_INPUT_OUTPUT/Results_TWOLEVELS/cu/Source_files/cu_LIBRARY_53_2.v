...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n46_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n45_), .c(x05), .d(new_n29_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nor3   g25(.a(x02), .b(new_n26_), .c(new_n46_), .O(new_n51_));
  ...
  nor3   g49(.a(z03), .b(new_n45_), .c(new_n74_), .O(z09));
  nand2  g50(.a(x05), .b(x02), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n77_));
