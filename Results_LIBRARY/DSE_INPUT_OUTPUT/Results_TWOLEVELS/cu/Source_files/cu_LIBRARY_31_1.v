...
module FAU ( 
  ...
  nand4  g28(.a(new_n27_), .b(new_n45_), .c(new_n32_), .d(x02), .O(new_n54_));
  ...
  oai21  g43(.a(new_n68_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g44(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand3  g45(.a(new_n45_), .b(new_n32_), .c(x02), .O(new_n71_));
