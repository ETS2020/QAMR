...
module FAU ( 
  ...
  nand4  g30(.a(new_n36_), .b(new_n32_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x08), .c(x05), .d(new_n28_), .O(new_n58_));
  ...
  aoi21  g47(.a(new_n72_), .b(new_n67_), .c(new_n45_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n74_));
  nand4  g49(.a(new_n35_), .b(new_n45_), .c(new_n29_), .d(x02), .O(new_n75_));
  ...
  nand4  g54(.a(new_n79_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n80_));
  oai21  g55(.a(new_n80_), .b(x02), .c(new_n35_), .O(z07));
  nand4  g56(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n82_));
  nand3  g57(.a(new_n45_), .b(new_n29_), .c(x02), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(new_n35_), .c(x04), .d(new_n36_), .O(new_n85_));
  inv1   g60(.a(new_n85_), .O(z08));
  nand2  g61(.a(x13), .b(x06), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(new_n35_), .O(z09));
  nand4  g63(.a(new_n31_), .b(new_n35_), .c(x06), .d(new_n36_), .O(new_n89_));
