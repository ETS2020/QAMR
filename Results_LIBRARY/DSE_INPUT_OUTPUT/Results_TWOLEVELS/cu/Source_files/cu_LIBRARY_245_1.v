...
module FAU ( 
  ...
  nand4  g10(.a(new_n32_), .b(x04), .c(x02), .d(x01), .O(new_n36_));
  ...
  nand4  g16(.a(new_n26_), .b(new_n29_), .c(new_n27_), .d(x00), .O(new_n42_));
  ...
  nand4  g23(.a(new_n48_), .b(new_n41_), .c(x05), .d(new_n31_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z04));
  nand2  g25(.a(x02), .b(new_n27_), .O(new_n51_));
  nand3  g26(.a(new_n29_), .b(x01), .c(x00), .O(new_n52_));
  nand4  g27(.a(new_n41_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n53_));
  ...
  aoi21  g43(.a(new_n68_), .b(new_n62_), .c(new_n41_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n70_));
  nand3  g45(.a(new_n41_), .b(new_n32_), .c(x02), .O(new_n71_));
  ...
  nand4  g49(.a(new_n41_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x02), .c(new_n51_), .O(z07));
  nor2   g51(.a(new_n31_), .b(x03), .O(new_n77_));
  nand3  g52(.a(new_n77_), .b(new_n41_), .c(new_n32_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(x01), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(x02), .O(new_n80_));
  nor2   g55(.a(new_n41_), .b(x12), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n77_), .c(x05), .d(new_n29_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n80_), .O(z08));
  nand2  g58(.a(x13), .b(x06), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n51_), .O(z09));
  nand2  g60(.a(x05), .b(x02), .O(new_n86_));
  nand3  g61(.a(new_n86_), .b(x06), .c(new_n26_), .O(new_n87_));
  nand2  g62(.a(new_n87_), .b(new_n51_), .O(z10));
endmodule
