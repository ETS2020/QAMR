...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n46_), .c(new_n45_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand4  g26(.a(new_n34_), .b(new_n46_), .c(x01), .d(new_n51_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n30_), .c(x05), .d(new_n35_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nand3  g30(.a(new_n46_), .b(x01), .c(x00), .O(new_n56_));
  nor2   g31(.a(x13), .b(new_n26_), .O(new_n57_));
  nand3  g32(.a(new_n57_), .b(new_n35_), .c(new_n34_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n56_), .c(new_n27_), .O(z05));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n30_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n57_), .b(new_n35_), .c(new_n34_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand2  g50(.a(x05), .b(new_n46_), .O(new_n76_));
  nand2  g51(.a(x13), .b(new_n61_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(new_n76_), .c(new_n70_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n34_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z08));
  nand3  g55(.a(x13), .b(x06), .c(x05), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z09));
  nand2  g57(.a(new_n76_), .b(new_n38_), .O(new_n83_));
