...
module FAU ( 
  ...
  aoi21  g29(.a(new_n54_), .b(new_n52_), .c(new_n49_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n48_), .c(new_n47_), .d(x05), .O(new_n56_));
  nand3  g31(.a(new_n49_), .b(new_n31_), .c(x02), .O(new_n57_));
  oai21  g32(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand3  g33(.a(new_n58_), .b(x04), .c(new_n26_), .O(new_n59_));
  nand2  g34(.a(new_n59_), .b(new_n46_), .O(z06));
  nand4  g35(.a(new_n49_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n61_));
  nor3   g36(.a(new_n61_), .b(x02), .c(x01), .O(z07));
  nand4  g37(.a(x13), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n57_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n26_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n46_), .O(z08));
  nand3  g41(.a(new_n46_), .b(x13), .c(x06), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z09));
  nand3  g43(.a(new_n27_), .b(x06), .c(new_n26_), .O(new_n69_));
  inv1   g44(.a(new_n69_), .O(z10));
  nor2   g45(.a(new_n31_), .b(new_n41_), .O(z05));
endmodule
