...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  inv1   g23(.a(new_n37_), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(x01), .c(new_n48_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n26_), .c(x13), .O(z04));
  nand3  g26(.a(new_n49_), .b(x01), .c(x00), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n26_), .c(x13), .O(z05));
  inv1   g28(.a(x07), .O(new_n54_));
  inv1   g29(.a(x12), .O(new_n55_));
  nor2   g30(.a(x09), .b(x01), .O(new_n56_));
  nor2   g31(.a(x11), .b(new_n43_), .O(new_n57_));
  ...
  nand2  g41(.a(new_n27_), .b(x03), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n66_), .O(z06));
  nand2  g43(.a(x03), .b(new_n43_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n31_), .d(new_n28_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n26_), .c(x13), .O(z07));
  nand4  g46(.a(x13), .b(new_n55_), .c(x05), .d(new_n28_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n64_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n26_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n67_), .O(z09));
  nand3  g52(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n67_), .O(z10));
endmodule
