...
module FAU ( 
  ...
  nor2   g17(.a(x13), .b(new_n27_), .O(new_n44_));
  nand4  g18(.a(new_n44_), .b(new_n43_), .c(new_n30_), .d(x00), .O(new_n45_));
  aoi21  g19(.a(new_n45_), .b(x00), .c(x01), .O(z03));
  nand4  g20(.a(new_n44_), .b(new_n43_), .c(new_n30_), .d(x01), .O(new_n47_));
  aoi21  g21(.a(new_n47_), .b(x01), .c(x00), .O(z04));
  nand3  g22(.a(new_n26_), .b(x01), .c(x00), .O(new_n49_));
  nand3  g23(.a(new_n44_), .b(new_n30_), .c(new_n36_), .O(new_n50_));
  oai21  g24(.a(new_n50_), .b(new_n49_), .c(new_n34_), .O(z05));
  nand3  g25(.a(x05), .b(new_n26_), .c(x01), .O(new_n52_));
  ...
  nand3  g31(.a(new_n57_), .b(new_n27_), .c(x02), .O(new_n58_));
  oai21  g32(.a(new_n56_), .b(new_n52_), .c(new_n58_), .O(new_n59_));
  nand2  g33(.a(new_n59_), .b(x00), .O(new_n60_));
  oai22  g34(.a(x10), .b(x00), .c(x09), .d(x01), .O(new_n61_));
  nand4  g35(.a(new_n61_), .b(x13), .c(new_n55_), .d(new_n53_), .O(new_n62_));
  inv1   g36(.a(new_n62_), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(x05), .c(new_n26_), .O(new_n64_));
  nand4  g38(.a(new_n57_), .b(new_n27_), .c(x02), .d(x01), .O(new_n65_));
  nand3  g39(.a(new_n65_), .b(new_n64_), .c(new_n60_), .O(new_n66_));
  nand3  g40(.a(new_n66_), .b(x04), .c(new_n36_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n34_), .O(z06));
  aoi21  g42(.a(new_n33_), .b(new_n32_), .c(x13), .O(new_n69_));
  nand4  g43(.a(new_n69_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n70_));
  nor2   g44(.a(new_n70_), .b(x02), .O(z07));
  nand2  g45(.a(x05), .b(new_n26_), .O(new_n72_));
  nand2  g46(.a(x13), .b(new_n55_), .O(new_n73_));
  oai21  g47(.a(new_n73_), .b(new_n72_), .c(new_n58_), .O(new_n74_));
  ...
  nand3  g53(.a(new_n79_), .b(x06), .c(new_n36_), .O(new_n80_));
