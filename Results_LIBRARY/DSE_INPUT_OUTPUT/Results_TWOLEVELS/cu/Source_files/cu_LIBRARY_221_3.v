...
module FAU ( 
  ...
  nand4  g18(.a(new_n26_), .b(new_n28_), .c(new_n43_), .d(x00), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n34_), .c(x05), .d(new_n30_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(z03));
  inv1   g22(.a(x00), .O(new_n48_));
  nand4  g23(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n48_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n34_), .c(x05), .d(new_n30_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nand2  g27(.a(x01), .b(x00), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x02), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z05));
  nand4  g31(.a(new_n31_), .b(x04), .c(new_n26_), .d(x02), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z06));
  nor3   g33(.a(new_n35_), .b(x03), .c(x02), .O(z07));
  inv1   g34(.a(x06), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n31_), .c(new_n34_), .O(z09));
  nand2  g36(.a(x05), .b(x02), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x06), .c(new_n26_), .O(new_n63_));
  oai21  g38(.a(new_n34_), .b(new_n31_), .c(new_n63_), .O(z10));
  nor2   g39(.a(new_n57_), .b(x13), .O(z08));
endmodule
