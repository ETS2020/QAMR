...
module FAU ( 
  ...
  nand4  g23(.a(new_n34_), .b(new_n35_), .c(new_n44_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  nor3   g27(.a(x03), .b(x02), .c(x00), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n37_), .c(new_n46_), .d(x06), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x06), .c(new_n44_), .O(z04));
  nand4  g30(.a(new_n34_), .b(new_n35_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x06), .c(x05), .d(new_n29_), .O(new_n58_));
  ...
  nand3  g39(.a(new_n64_), .b(x06), .c(x01), .O(new_n65_));
  ...
  nand3  g45(.a(new_n70_), .b(x06), .c(x01), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n69_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n43_), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n67_), .c(new_n46_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n75_));
  nand4  g50(.a(new_n27_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n76_));
  ...
  aoi21  g54(.a(new_n26_), .b(x01), .c(x13), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n81_));
  nor2   g56(.a(new_n81_), .b(x02), .O(z07));
  nand4  g57(.a(x13), .b(new_n61_), .c(x05), .d(new_n35_), .O(new_n83_));
  ...
  oai21  g61(.a(new_n46_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand2  g62(.a(x05), .b(x02), .O(new_n88_));
  nand3  g63(.a(new_n88_), .b(x06), .c(new_n34_), .O(new_n89_));
  nand2  g64(.a(new_n89_), .b(new_n27_), .O(z10));
endmodule
