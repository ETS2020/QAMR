...
module FAU ( 
  ...
  wire new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    ...
    new_n59_, new_n62_, new_n63_, new_n64_, new_n66_, new_n68_, new_n69_;
  ...
  nand3  g33(.a(new_n45_), .b(x05), .c(new_n30_), .O(new_n62_));
  ...
  oai21  g39(.a(new_n46_), .b(x02), .c(x05), .O(new_n68_));
  nand3  g40(.a(new_n68_), .b(x06), .c(new_n36_), .O(new_n69_));
  inv1   g41(.a(new_n69_), .O(z10));
  zero   g42(.O(z02));
  zero   g43(.O(z05));
  zero   g44(.O(z07));
