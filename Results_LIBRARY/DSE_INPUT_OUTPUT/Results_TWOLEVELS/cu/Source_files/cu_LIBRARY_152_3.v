...
module FAU ( 
  ...
  nand4  g12(.a(new_n37_), .b(x05), .c(new_n34_), .d(new_n30_), .O(new_n38_));
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n34_), .d(new_n41_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x13), .O(z02));
  inv1   g19(.a(x01), .O(new_n45_));
  nand4  g20(.a(new_n41_), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n27_), .c(x05), .d(new_n34_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n41_), .b(new_n30_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n27_), .c(x05), .d(new_n34_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n30_), .b(x01), .c(x00), .O(new_n55_));
  nand4  g30(.a(new_n27_), .b(x05), .c(new_n34_), .d(new_n41_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n37_), .O(z05));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n27_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n68_));
  oai21  g43(.a(new_n67_), .b(x02), .c(new_n68_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n41_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n37_), .O(z06));
  nand4  g46(.a(new_n27_), .b(x05), .c(new_n34_), .d(new_n41_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand2  g48(.a(x05), .b(new_n30_), .O(new_n74_));
  nand3  g49(.a(x13), .b(new_n59_), .c(new_n26_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(new_n74_), .c(new_n68_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n41_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  nand2  g53(.a(x05), .b(x02), .O(new_n80_));
  nand4  g54(.a(new_n80_), .b(new_n27_), .c(x06), .d(new_n41_), .O(new_n81_));
