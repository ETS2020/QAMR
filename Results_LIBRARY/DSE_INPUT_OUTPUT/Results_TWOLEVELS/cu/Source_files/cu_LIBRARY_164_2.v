...
module FAU ( 
  ...
  nand2  g09(.a(x11), .b(x03), .O(new_n35_));
  nand2  g10(.a(new_n35_), .b(new_n34_), .O(z00));
  nand3  g11(.a(x05), .b(new_n30_), .c(new_n27_), .O(new_n37_));
  nand3  g12(.a(new_n31_), .b(x04), .c(x02), .O(new_n38_));
  nand2  g13(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand2  g14(.a(new_n39_), .b(new_n26_), .O(new_n40_));
  nor2   g15(.a(x11), .b(new_n26_), .O(new_n41_));
  ...
  nand3  g22(.a(new_n27_), .b(new_n47_), .c(x00), .O(new_n48_));
  ...
  nand4  g27(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n49_), .c(x05), .d(new_n30_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nand3  g31(.a(new_n27_), .b(x01), .c(x00), .O(new_n57_));
  oai21  g32(.a(new_n57_), .b(new_n50_), .c(new_n42_), .O(z05));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n49_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n49_), .b(new_n31_), .c(x02), .O(new_n69_));
  ...
  nand4  g47(.a(new_n49_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n42_), .O(z07));
  ...
  nor3   g54(.a(new_n41_), .b(new_n49_), .c(new_n79_), .O(z09));
