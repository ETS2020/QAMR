...
module FAU ( 
  ...
  nand4  g25(.a(new_n33_), .b(new_n34_), .c(x01), .d(new_n50_), .O(new_n51_));
  ...
  nand4  g31(.a(new_n56_), .b(new_n49_), .c(x05), .d(new_n28_), .O(new_n57_));
  ...
  nand3  g39(.a(new_n64_), .b(new_n49_), .c(new_n50_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n46_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n26_), .b(new_n46_), .c(new_n36_), .d(x02), .O(new_n68_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n26_), .c(x04), .d(new_n33_), .O(new_n78_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n26_), .c(x06), .d(new_n33_), .O(new_n83_));
