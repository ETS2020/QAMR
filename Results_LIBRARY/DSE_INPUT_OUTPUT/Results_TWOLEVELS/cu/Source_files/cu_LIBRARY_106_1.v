...
module FAU ( 
  ...
  nand4  g17(.a(new_n27_), .b(new_n42_), .c(x05), .d(new_n31_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand3  g19(.a(new_n44_), .b(new_n36_), .c(new_n29_), .O(new_n45_));
  nor3   g20(.a(new_n45_), .b(x01), .c(x00), .O(z02));
  inv1   g21(.a(x01), .O(new_n47_));
  nand3  g22(.a(new_n29_), .b(new_n47_), .c(x00), .O(new_n48_));
  nand4  g23(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n49_));
  oai21  g24(.a(new_n49_), .b(new_n48_), .c(new_n27_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n29_), .b(x01), .c(new_n51_), .O(new_n52_));
  ...
  aoi21  g35(.a(new_n60_), .b(new_n58_), .c(new_n51_), .O(new_n61_));
  inv1   g36(.a(x10), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n51_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n61_), .c(new_n56_), .O(new_n65_));
  nand3  g40(.a(new_n26_), .b(new_n47_), .c(new_n51_), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n65_), .c(new_n42_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n68_));
  nand3  g43(.a(new_n42_), .b(new_n32_), .c(x02), .O(new_n69_));
  ...
  nand2  g53(.a(new_n78_), .b(new_n27_), .O(z09));
  inv1   g54(.a(new_n33_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n81_));
