...
module FAU ( 
  ...
  nand4  g26(.a(new_n36_), .b(new_n33_), .c(x01), .d(new_n51_), .O(new_n52_));
  ...
  nor2   g31(.a(x13), .b(new_n30_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n56_), .c(new_n29_), .d(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x12), .c(new_n26_), .O(z05));
  ...
  nand3  g46(.a(new_n61_), .b(x01), .c(new_n51_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n73_));
  inv1   g48(.a(new_n73_), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n36_), .c(new_n33_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n37_), .O(z07));
  ...
  nand2  g54(.a(new_n79_), .b(new_n37_), .O(z08));
  inv1   g55(.a(x06), .O(new_n81_));
  nor3   g56(.a(new_n27_), .b(new_n46_), .c(new_n81_), .O(z09));
  nand4  g57(.a(new_n32_), .b(new_n37_), .c(x06), .d(new_n36_), .O(new_n83_));
