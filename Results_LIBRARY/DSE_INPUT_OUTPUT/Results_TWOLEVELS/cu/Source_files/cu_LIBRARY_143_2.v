...
module FAU ( 
  ...
  nor2   g19(.a(x13), .b(new_n29_), .O(new_n45_));
  nand3  g20(.a(new_n45_), .b(new_n28_), .c(new_n36_), .O(new_n46_));
  ...
  nand4  g24(.a(new_n36_), .b(new_n32_), .c(x01), .d(new_n42_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(x11), .c(x05), .d(new_n28_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nor2   g28(.a(x03), .b(x02), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n45_), .c(new_n28_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x11), .c(new_n43_), .O(z05));
  ...
  nand3  g37(.a(x11), .b(new_n62_), .c(x01), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n42_), .O(new_n65_));
  inv1   g40(.a(x09), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(new_n43_), .c(x00), .O(new_n67_));
  aoi21  g42(.a(new_n67_), .b(new_n65_), .c(new_n59_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n58_), .c(new_n57_), .d(x05), .O(new_n69_));
  nand4  g44(.a(new_n35_), .b(new_n59_), .c(new_n29_), .d(x02), .O(new_n70_));
  ...
  nand3  g48(.a(new_n26_), .b(x01), .c(new_n42_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n59_), .c(x05), .d(new_n28_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(new_n36_), .c(new_n32_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n35_), .O(z07));
  nand4  g53(.a(x13), .b(new_n58_), .c(x05), .d(new_n32_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n70_), .O(new_n80_));
