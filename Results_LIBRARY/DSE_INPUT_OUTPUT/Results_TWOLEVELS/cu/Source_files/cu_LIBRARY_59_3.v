...
module FAU ( 
  ...
  nand3  g21(.a(new_n44_), .b(x05), .c(new_n26_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand3  g23(.a(new_n48_), .b(new_n37_), .c(new_n30_), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n33_), .c(new_n32_), .O(z03));
  nand4  g25(.a(new_n37_), .b(new_n30_), .c(x01), .d(new_n32_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n44_), .c(x05), .d(new_n26_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand4  g29(.a(x05), .b(x04), .c(new_n37_), .d(new_n30_), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x09), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(x13), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n55_), .c(new_n33_), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x00), .O(new_n61_));
  inv1   g36(.a(x08), .O(new_n62_));
  nand3  g37(.a(new_n62_), .b(new_n33_), .c(new_n32_), .O(new_n63_));
  ...
  nand3  g54(.a(new_n29_), .b(x06), .c(new_n37_), .O(new_n80_));
