...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x08), .c(x05), .d(new_n28_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n35_), .c(new_n32_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x08), .c(x01), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n35_), .c(new_n32_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x08), .c(x01), .O(z03));
  nand4  g24(.a(new_n35_), .b(new_n32_), .c(x01), .d(new_n42_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n43_), .c(x05), .d(new_n28_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand3  g28(.a(new_n32_), .b(x01), .c(x00), .O(new_n54_));
  nand4  g29(.a(new_n43_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n55_));
  ...
  nor2   g35(.a(x11), .b(new_n60_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n59_), .c(x00), .O(new_n62_));
  ...
  nand3  g41(.a(new_n43_), .b(new_n29_), .c(x02), .O(new_n67_));
  ...
  aoi21  g46(.a(new_n71_), .b(new_n60_), .c(x13), .O(new_n72_));
