...
module FAU ( 
  ...
  nor2   g22(.a(x13), .b(new_n30_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n48_), .c(new_n29_), .d(x01), .O(new_n50_));
  aoi21  g24(.a(new_n50_), .b(x01), .c(x00), .O(z04));
  nand3  g25(.a(new_n27_), .b(x01), .c(x00), .O(new_n52_));
  nand3  g26(.a(new_n49_), .b(new_n29_), .c(new_n35_), .O(new_n53_));
  oai21  g27(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(z05));
  ...
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n27_), .O(new_n72_));
  nand3  g46(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g48(.a(new_n74_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n75_));
  inv1   g49(.a(new_n75_), .O(z08));
  nand2  g50(.a(x13), .b(x06), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n34_), .O(z09));
  inv1   g52(.a(new_n31_), .O(new_n79_));
  nand4  g53(.a(new_n79_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n80_));
