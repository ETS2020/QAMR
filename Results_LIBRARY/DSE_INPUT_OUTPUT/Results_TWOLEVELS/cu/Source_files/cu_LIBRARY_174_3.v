...
module FAU ( 
  ...
  nand4  g26(.a(new_n51_), .b(new_n44_), .c(x05), .d(new_n30_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n50_), .c(new_n45_), .O(z04));
  nand4  g28(.a(new_n26_), .b(new_n44_), .c(new_n31_), .d(x02), .O(new_n54_));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  nor2   g31(.a(x08), .b(x01), .O(new_n57_));
  nor2   g32(.a(x10), .b(new_n45_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n50_), .O(new_n59_));
  inv1   g34(.a(x09), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(new_n45_), .c(x00), .O(new_n61_));
  ...
  nand4  g42(.a(new_n67_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n56_), .c(x05), .d(new_n28_), .O(new_n70_));
  nand3  g45(.a(new_n44_), .b(new_n31_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n26_), .c(x04), .d(new_n35_), .O(new_n73_));
