...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(new_n31_), .c(new_n44_), .d(x00), .O(new_n45_));
  ...
  nand3  g26(.a(new_n51_), .b(new_n31_), .c(new_n49_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n26_), .c(new_n44_), .O(z04));
  nand3  g28(.a(new_n51_), .b(new_n31_), .c(x00), .O(new_n54_));
  ...
  aoi21  g44(.a(x03), .b(new_n44_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n27_), .d(new_n31_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n38_), .O(z07));
  ...
  nand2  g50(.a(new_n75_), .b(new_n38_), .O(z08));
  nand3  g51(.a(new_n38_), .b(x13), .c(x06), .O(new_n77_));
