...
module FAU ( 
  ...
  oai21  g04(.a(new_n28_), .b(x03), .c(new_n29_), .O(new_n30_));
  nand2  g05(.a(new_n30_), .b(new_n27_), .O(z00));
  nand3  g06(.a(x05), .b(new_n28_), .c(new_n26_), .O(new_n32_));
  nand3  g07(.a(new_n29_), .b(x04), .c(x02), .O(new_n33_));
  aoi21  g08(.a(new_n33_), .b(new_n32_), .c(x03), .O(z01));
  inv1   g09(.a(x03), .O(new_n35_));
  inv1   g10(.a(x13), .O(new_n36_));
  nor3   g11(.a(x02), .b(x01), .c(x00), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n36_), .c(new_n28_), .d(new_n35_), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(new_n26_), .c(new_n29_), .O(z02));
  inv1   g14(.a(x01), .O(new_n40_));
  nand4  g15(.a(new_n35_), .b(new_n26_), .c(new_n40_), .d(x00), .O(new_n41_));
  inv1   g16(.a(new_n41_), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(new_n36_), .c(x05), .d(new_n28_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z03));
  inv1   g19(.a(x00), .O(new_n45_));
  nand4  g20(.a(new_n35_), .b(new_n26_), .c(x01), .d(new_n45_), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n36_), .c(x05), .d(new_n28_), .O(new_n48_));
  ...
  nand4  g42(.a(new_n36_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n68_));
  ...
  nand3  g48(.a(new_n66_), .b(x13), .c(x06), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z09));
  nand3  g50(.a(new_n66_), .b(x06), .c(new_n35_), .O(new_n76_));
