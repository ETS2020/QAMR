...
module FAU ( 
  ...
  nand3  g23(.a(new_n48_), .b(new_n34_), .c(new_n37_), .O(new_n49_));
  ...
  nand4  g28(.a(new_n53_), .b(x11), .c(x05), .d(new_n34_), .O(new_n54_));
  nor2   g29(.a(new_n54_), .b(x13), .O(z04));
  nor2   g30(.a(x03), .b(x02), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n48_), .c(new_n34_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x11), .c(new_n46_), .O(z05));
  ...
  nand3  g40(.a(new_n65_), .b(new_n46_), .c(x00), .O(new_n66_));
  aoi21  g41(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand4  g43(.a(new_n27_), .b(new_n61_), .c(new_n31_), .d(x02), .O(new_n69_));
  ...
  nand3  g47(.a(new_n26_), .b(x01), .c(new_n51_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n37_), .c(new_n30_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n27_), .O(z07));
  nand4  g52(.a(x13), .b(new_n60_), .c(x05), .d(new_n30_), .O(new_n78_));
  nand3  g53(.a(new_n61_), .b(new_n31_), .c(x02), .O(new_n79_));
  ...
  nor3   g58(.a(new_n28_), .b(new_n61_), .c(new_n83_), .O(z09));
