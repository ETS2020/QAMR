...
module FAU ( 
  ...
  nand4  g19(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n44_), .c(new_n33_), .O(z02));
  ...
  nand3  g25(.a(new_n35_), .b(x01), .c(new_n42_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n45_), .c(new_n33_), .O(z04));
  nand3  g27(.a(new_n35_), .b(x01), .c(x00), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n45_), .c(new_n33_), .O(z05));
  inv1   g29(.a(x07), .O(new_n55_));
  inv1   g30(.a(x12), .O(new_n56_));
  inv1   g31(.a(x10), .O(new_n57_));
  nor2   g32(.a(x08), .b(x01), .O(new_n58_));
  aoi21  g33(.a(new_n57_), .b(x01), .c(new_n58_), .O(new_n59_));
  inv1   g34(.a(x11), .O(new_n60_));
  nand3  g35(.a(new_n60_), .b(x01), .c(x00), .O(new_n61_));
  oai21  g36(.a(new_n59_), .b(x00), .c(new_n61_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n56_), .d(x09), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n55_), .c(x05), .d(new_n35_), .O(new_n65_));
  nand3  g40(.a(new_n26_), .b(new_n37_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n34_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z06));
  nand4  g44(.a(new_n26_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n70_));
  oai21  g45(.a(new_n70_), .b(x02), .c(new_n33_), .O(z07));
  nand4  g46(.a(x13), .b(new_n56_), .c(x05), .d(new_n35_), .O(new_n72_));
  ...
  aoi21  g51(.a(x09), .b(new_n76_), .c(new_n26_), .O(z09));
