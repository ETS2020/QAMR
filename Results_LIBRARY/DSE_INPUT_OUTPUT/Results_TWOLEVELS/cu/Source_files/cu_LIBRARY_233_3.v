...
module FAU ( 
  ...
  nand4  g18(.a(new_n27_), .b(x05), .c(new_n31_), .d(new_n43_), .O(new_n44_));
  oai21  g19(.a(new_n44_), .b(new_n42_), .c(new_n36_), .O(z02));
  nand4  g20(.a(new_n43_), .b(new_n29_), .c(new_n41_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand4  g24(.a(new_n43_), .b(new_n29_), .c(x01), .d(new_n40_), .O(new_n50_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n44_), .c(new_n36_), .O(z05));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n59_), .c(new_n27_), .O(new_n63_));
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(new_n26_), .d(x05), .O(new_n64_));
  nand3  g39(.a(new_n27_), .b(new_n32_), .c(x02), .O(new_n65_));
  oai21  g40(.a(new_n64_), .b(x02), .c(new_n65_), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x04), .c(new_n43_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(z06));
  nand4  g43(.a(new_n27_), .b(x05), .c(new_n31_), .d(new_n43_), .O(new_n69_));
  nor2   g44(.a(new_n69_), .b(x02), .O(z07));
  nand2  g45(.a(x05), .b(new_n29_), .O(new_n71_));
  nand3  g46(.a(x13), .b(new_n56_), .c(new_n26_), .O(new_n72_));
  ...
  nand3  g53(.a(new_n78_), .b(x06), .c(new_n43_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n36_), .O(z10));
endmodule
