...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(new_n32_), .c(new_n44_), .d(new_n43_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x09), .c(x13), .O(z02));
  nand4  g23(.a(new_n46_), .b(new_n32_), .c(new_n44_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x09), .c(x13), .O(z03));
  nor2   g25(.a(x02), .b(new_n44_), .O(new_n51_));
  nand3  g26(.a(new_n51_), .b(new_n46_), .c(new_n43_), .O(new_n52_));
  ...
  nand4  g41(.a(new_n58_), .b(x09), .c(new_n29_), .d(x02), .O(new_n67_));
  ...
  nand4  g46(.a(new_n71_), .b(x09), .c(x05), .d(new_n28_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x13), .O(z07));
  nand4  g48(.a(x13), .b(new_n57_), .c(x05), .d(new_n32_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n36_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n35_), .O(z08));
  and2   g52(.a(x13), .b(x06), .O(z09));
  nand3  g53(.a(new_n31_), .b(x06), .c(new_n36_), .O(new_n79_));
