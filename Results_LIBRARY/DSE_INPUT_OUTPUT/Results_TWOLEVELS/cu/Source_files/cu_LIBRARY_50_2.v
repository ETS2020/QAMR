...
module FAU ( 
  ...
  nand2  g10(.a(new_n26_), .b(x01), .O(new_n36_));
  ...
  nand3  g20(.a(new_n45_), .b(new_n28_), .c(new_n35_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n36_), .O(z02));
  inv1   g22(.a(x13), .O(new_n48_));
  nand4  g23(.a(new_n35_), .b(new_n32_), .c(new_n43_), .d(x00), .O(new_n49_));
  ...
  nand3  g28(.a(new_n53_), .b(new_n45_), .c(new_n28_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x07), .c(new_n43_), .O(z04));
  nand4  g30(.a(new_n35_), .b(new_n32_), .c(x01), .d(x00), .O(new_n56_));
  inv1   g31(.a(new_n56_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x07), .c(x05), .d(new_n28_), .O(new_n58_));
  nor2   g33(.a(new_n58_), .b(x13), .O(z05));
  nand4  g34(.a(new_n36_), .b(new_n48_), .c(new_n29_), .d(x02), .O(new_n60_));
  ...
  nand4  g41(.a(new_n66_), .b(x13), .c(new_n61_), .d(new_n26_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(x05), .c(new_n32_), .d(new_n43_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n60_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(x04), .c(new_n35_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(z06));
  nand3  g47(.a(new_n26_), .b(x01), .c(x00), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n35_), .c(new_n32_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n36_), .O(z07));
  nand4  g52(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n78_));
  nand3  g53(.a(new_n48_), .b(new_n29_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n36_), .c(x04), .d(new_n35_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  nand2  g57(.a(x13), .b(x06), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n36_), .O(z09));
  nand4  g59(.a(new_n31_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n85_));
