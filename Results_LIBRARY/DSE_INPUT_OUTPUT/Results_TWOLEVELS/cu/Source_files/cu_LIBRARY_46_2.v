...
module FAU ( 
  ...
  nand2  g18(.a(new_n43_), .b(x05), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n31_), .c(new_n36_), .d(new_n29_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(new_n42_), .c(x01), .O(z02));
  nand3  g22(.a(new_n29_), .b(x01), .c(new_n42_), .O(new_n49_));
  nand3  g23(.a(new_n45_), .b(new_n31_), .c(new_n36_), .O(new_n50_));
  oai21  g24(.a(new_n50_), .b(new_n49_), .c(new_n27_), .O(z04));
  aoi21  g25(.a(new_n46_), .b(x01), .c(new_n42_), .O(z05));
  nand4  g26(.a(new_n27_), .b(new_n43_), .c(new_n32_), .d(x02), .O(new_n53_));
  ...
  nand3  g33(.a(new_n59_), .b(x01), .c(x00), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n58_), .c(new_n43_), .O(new_n61_));
  ...
  nand2  g39(.a(x01), .b(x00), .O(new_n66_));
  nand4  g40(.a(new_n66_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n67_));
  nor3   g41(.a(new_n67_), .b(x03), .c(x02), .O(new_n68_));
  or2    g42(.a(new_n68_), .b(z05), .O(z07));
  nand4  g43(.a(x13), .b(new_n55_), .c(x05), .d(new_n29_), .O(new_n70_));
  nand3  g44(.a(new_n43_), .b(new_n32_), .c(x02), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n27_), .O(z09));
  inv1   g50(.a(new_n33_), .O(new_n77_));
