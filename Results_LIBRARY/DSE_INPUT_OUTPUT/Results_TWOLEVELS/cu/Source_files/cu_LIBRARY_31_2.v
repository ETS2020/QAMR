...
module FAU ( 
  ...
  nand4  g22(.a(new_n48_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n49_));
  ...
  nand4  g27(.a(new_n27_), .b(new_n48_), .c(new_n32_), .d(x02), .O(new_n54_));
  ...
  nor2   g40(.a(x03), .b(x02), .O(new_n67_));
  nand3  g41(.a(new_n48_), .b(x05), .c(new_n31_), .O(new_n68_));
  inv1   g42(.a(new_n68_), .O(new_n69_));
  aoi21  g43(.a(new_n69_), .b(new_n67_), .c(new_n26_), .O(new_n70_));
  nand4  g44(.a(new_n69_), .b(new_n36_), .c(new_n29_), .d(new_n46_), .O(new_n71_));
  oai21  g45(.a(new_n70_), .b(new_n46_), .c(new_n71_), .O(z07));
  nand4  g46(.a(x13), .b(new_n56_), .c(x05), .d(new_n29_), .O(new_n73_));
  nand3  g47(.a(new_n48_), .b(new_n32_), .c(x02), .O(new_n74_));
  nand2  g48(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g49(.a(new_n75_), .b(new_n27_), .c(x04), .d(new_n36_), .O(new_n76_));
  inv1   g50(.a(new_n76_), .O(z08));
  nand2  g51(.a(x13), .b(x06), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n27_), .O(z09));
  inv1   g53(.a(new_n33_), .O(new_n80_));
  nand3  g54(.a(new_n80_), .b(x06), .c(new_n36_), .O(new_n81_));
  nand2  g55(.a(new_n81_), .b(new_n27_), .O(z10));
  zero   g56(.O(z03));
endmodule
