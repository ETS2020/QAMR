...
module FAU ( 
  ...
  nand2  g35(.a(new_n29_), .b(new_n28_), .O(new_n63_));
  inv1   g36(.a(new_n63_), .O(new_n64_));
  nand4  g37(.a(new_n64_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n65_));
  nor2   g38(.a(new_n65_), .b(x13), .O(z07));
  nand3  g39(.a(x13), .b(new_n51_), .c(x05), .O(new_n67_));
  oai21  g40(.a(new_n67_), .b(new_n63_), .c(new_n59_), .O(new_n68_));
  nand3  g41(.a(new_n68_), .b(x04), .c(new_n36_), .O(new_n69_));
  inv1   g42(.a(new_n69_), .O(z08));
  nand2  g43(.a(x13), .b(x06), .O(new_n71_));
  nand2  g44(.a(new_n71_), .b(new_n26_), .O(z09));
  nand2  g45(.a(x05), .b(x02), .O(new_n73_));
  nand3  g46(.a(new_n73_), .b(x06), .c(new_n36_), .O(new_n74_));
  nand2  g47(.a(new_n74_), .b(new_n26_), .O(z10));
  zero   g48(.O(z04));
  zero   g49(.O(z05));
endmodule
