...
module FAU ( 
  ...
  nand3  g20(.a(new_n43_), .b(x05), .c(new_n26_), .O(new_n46_));
  ...
  nand4  g28(.a(new_n32_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n55_));
  ...
  aoi21  g36(.a(new_n62_), .b(new_n60_), .c(new_n43_), .O(new_n63_));
  ...
  inv1   g41(.a(z03), .O(new_n68_));
  nand4  g42(.a(new_n47_), .b(new_n34_), .c(new_n30_), .d(new_n40_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n68_), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n30_), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n55_), .O(new_n72_));
  nand3  g46(.a(new_n72_), .b(x04), .c(new_n34_), .O(new_n73_));
  nand2  g47(.a(new_n73_), .b(new_n32_), .O(z08));
  nand2  g48(.a(x13), .b(x06), .O(new_n75_));
  nand2  g49(.a(new_n75_), .b(new_n32_), .O(z09));
  nand3  g50(.a(new_n29_), .b(x06), .c(new_n34_), .O(new_n77_));
  nand2  g51(.a(new_n77_), .b(new_n32_), .O(z10));
  zero   g52(.O(z05));
endmodule
