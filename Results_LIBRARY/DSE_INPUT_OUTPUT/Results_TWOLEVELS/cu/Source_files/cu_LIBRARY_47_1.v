...
module FAU ( 
  ...
  nand4  g23(.a(new_n43_), .b(new_n42_), .c(new_n26_), .d(x00), .O(new_n50_));
  aoi21  g24(.a(new_n50_), .b(x00), .c(new_n41_), .O(z05));
  inv1   g25(.a(x13), .O(new_n52_));
  nand4  g26(.a(new_n33_), .b(new_n52_), .c(new_n27_), .d(x02), .O(new_n53_));
  ...
  nand3  g33(.a(new_n59_), .b(new_n41_), .c(new_n32_), .O(new_n60_));
  aoi21  g34(.a(new_n60_), .b(new_n58_), .c(new_n52_), .O(new_n61_));
  ...
  aoi21  g39(.a(x01), .b(new_n32_), .c(x13), .O(new_n66_));
  nand4  g40(.a(new_n66_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n67_));
  nor2   g41(.a(new_n67_), .b(x02), .O(z07));
  nand4  g42(.a(x13), .b(new_n55_), .c(x05), .d(new_n30_), .O(new_n69_));
  nand3  g43(.a(new_n52_), .b(new_n27_), .c(x02), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand4  g45(.a(new_n71_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n72_));
  inv1   g46(.a(new_n72_), .O(z08));
  inv1   g47(.a(x06), .O(new_n74_));
  nand2  g48(.a(new_n33_), .b(x13), .O(new_n75_));
  nor2   g49(.a(new_n75_), .b(new_n74_), .O(z09));
