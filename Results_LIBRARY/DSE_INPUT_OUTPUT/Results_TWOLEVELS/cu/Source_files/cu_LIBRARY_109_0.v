...
module FAU ( 
  ...
  nor2   g00(.a(x10), .b(x09), .O(new_n26_));
  ...
  nand4  g26(.a(new_n36_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n35_), .c(new_n32_), .d(x01), .O(new_n54_));
  ...
  nand3  g44(.a(new_n26_), .b(x01), .c(x00), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n45_), .c(x05), .d(new_n28_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(new_n35_), .c(new_n32_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n36_), .O(z07));
  nand4  g49(.a(x13), .b(new_n57_), .c(x05), .d(new_n32_), .O(new_n75_));
