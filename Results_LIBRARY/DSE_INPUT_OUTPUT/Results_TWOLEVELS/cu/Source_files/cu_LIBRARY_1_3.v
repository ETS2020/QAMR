...
module FAU ( 
  ...
  nand3  g22(.a(new_n36_), .b(new_n44_), .c(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n34_), .O(z03));
  nand4  g24(.a(new_n35_), .b(new_n36_), .c(x01), .d(new_n43_), .O(new_n50_));
  ...
  nand4  g38(.a(new_n63_), .b(new_n56_), .c(x05), .d(new_n36_), .O(new_n64_));
  nand3  g39(.a(new_n27_), .b(new_n38_), .c(x02), .O(new_n65_));
  ...
  nand4  g43(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n69_));
  oai21  g44(.a(new_n69_), .b(x02), .c(new_n34_), .O(z07));
  nand3  g45(.a(x13), .b(x05), .c(new_n36_), .O(new_n71_));
