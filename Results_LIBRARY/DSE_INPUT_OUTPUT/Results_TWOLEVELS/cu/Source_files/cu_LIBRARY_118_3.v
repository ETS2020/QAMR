...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n36_), .c(new_n45_), .d(new_n48_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n48_), .c(new_n42_), .O(z03));
  nand4  g26(.a(new_n33_), .b(new_n34_), .c(x01), .d(new_n42_), .O(new_n52_));
  ...
  nand4  g32(.a(new_n57_), .b(new_n48_), .c(x05), .d(new_n28_), .O(new_n58_));
  ...
  nand3  g43(.a(new_n68_), .b(new_n48_), .c(new_n42_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(new_n45_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n71_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n26_), .O(z06));
  aoi21  g50(.a(x07), .b(x00), .c(x13), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n28_), .d(new_n33_), .O(new_n77_));
  nor2   g52(.a(new_n77_), .b(x02), .O(z07));
  nand4  g53(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n79_));
  nand3  g54(.a(new_n45_), .b(new_n35_), .c(x02), .O(new_n80_));
  nand2  g55(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n26_), .c(x04), .d(new_n33_), .O(new_n82_));
  ...
  nand4  g61(.a(new_n86_), .b(new_n26_), .c(x06), .d(new_n33_), .O(new_n87_));
