...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    new_n33_, new_n35_, new_n36_, new_n37_, new_n38_, new_n39_, new_n43_,
  ...
  nand2  g10(.a(new_n35_), .b(x01), .O(new_n36_));
  nand2  g11(.a(new_n36_), .b(new_n28_), .O(new_n37_));
  nor2   g12(.a(x03), .b(new_n28_), .O(new_n38_));
  nand3  g13(.a(new_n38_), .b(new_n32_), .c(x04), .O(new_n39_));
  nand2  g14(.a(new_n39_), .b(new_n37_), .O(z01));
  nor2   g15(.a(x02), .b(x01), .O(z03));
  inv1   g16(.a(x13), .O(new_n43_));
  nor2   g17(.a(x03), .b(x00), .O(new_n44_));
  nand4  g18(.a(new_n44_), .b(new_n43_), .c(x05), .d(new_n31_), .O(new_n45_));
  aoi21  g19(.a(new_n45_), .b(x01), .c(x02), .O(z04));
  inv1   g20(.a(x00), .O(new_n47_));
  nor3   g21(.a(x02), .b(new_n27_), .c(new_n47_), .O(new_n48_));
  ...
  nand2  g27(.a(new_n53_), .b(new_n47_), .O(new_n54_));
  inv1   g28(.a(x11), .O(new_n55_));
  nand2  g29(.a(new_n55_), .b(x00), .O(new_n56_));
  aoi21  g30(.a(new_n56_), .b(new_n54_), .c(new_n43_), .O(new_n57_));
  nand4  g31(.a(new_n57_), .b(new_n52_), .c(new_n51_), .d(x05), .O(new_n58_));
  nor2   g32(.a(new_n58_), .b(new_n31_), .O(new_n59_));
  aoi21  g33(.a(new_n59_), .b(new_n26_), .c(new_n27_), .O(new_n60_));
  nand4  g34(.a(new_n38_), .b(new_n43_), .c(new_n32_), .d(x04), .O(new_n61_));
  oai21  g35(.a(new_n60_), .b(x02), .c(new_n61_), .O(z06));
  aoi21  g36(.a(new_n27_), .b(x00), .c(x13), .O(new_n63_));
  nand4  g37(.a(new_n63_), .b(x05), .c(new_n31_), .d(new_n26_), .O(new_n64_));
  aoi21  g38(.a(new_n64_), .b(x01), .c(x02), .O(z07));
  ...
  nand2  g42(.a(new_n68_), .b(new_n28_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n61_), .O(z08));
  nand2  g44(.a(x13), .b(x06), .O(new_n71_));
  oai21  g45(.a(x02), .b(x01), .c(new_n71_), .O(z09));
  nand2  g46(.a(new_n28_), .b(x01), .O(new_n73_));
  oai21  g47(.a(x05), .b(new_n28_), .c(new_n73_), .O(new_n74_));
  nand3  g48(.a(new_n74_), .b(x06), .c(new_n26_), .O(new_n75_));
