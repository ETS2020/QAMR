...
module FAU ( 
  ...
  nand4  g23(.a(new_n44_), .b(new_n34_), .c(x01), .d(new_n41_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n51_));
  ...
  nand4  g37(.a(new_n62_), .b(new_n26_), .c(new_n55_), .d(x05), .O(new_n63_));
  nand3  g38(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n64_));
  oai21  g39(.a(new_n63_), .b(x02), .c(new_n64_), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x04), .c(new_n44_), .O(new_n66_));
  inv1   g41(.a(new_n66_), .O(z06));
  nand4  g42(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n44_), .O(new_n68_));
  nor2   g43(.a(new_n68_), .b(x02), .O(z07));
  nand3  g44(.a(x13), .b(x05), .c(new_n34_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n64_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n44_), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n37_), .O(z08));
  nand3  g48(.a(x13), .b(new_n26_), .c(x06), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z09));
  nand4  g50(.a(new_n33_), .b(new_n37_), .c(x06), .d(new_n44_), .O(new_n76_));
