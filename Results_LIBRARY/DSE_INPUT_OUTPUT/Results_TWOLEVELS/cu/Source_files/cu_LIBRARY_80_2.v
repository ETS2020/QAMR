...
module FAU ( 
  ...
  nor2   g02(.a(z04), .b(x03), .O(new_n28_));
  ...
  nand2  g11(.a(new_n36_), .b(x01), .O(new_n37_));
  nand4  g12(.a(new_n37_), .b(new_n30_), .c(x04), .d(x02), .O(new_n38_));
  nand4  g13(.a(new_n37_), .b(x05), .c(new_n29_), .d(new_n33_), .O(new_n39_));
  aoi21  g14(.a(new_n39_), .b(new_n38_), .c(x03), .O(z01));
  inv1   g15(.a(x03), .O(new_n41_));
  nor3   g16(.a(x02), .b(x01), .c(x00), .O(new_n42_));
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n29_), .d(new_n41_), .O(new_n43_));
  nor2   g18(.a(new_n43_), .b(x13), .O(z02));
  nand4  g19(.a(new_n41_), .b(new_n33_), .c(new_n26_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n36_), .c(x05), .d(new_n29_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(z03));
  inv1   g23(.a(x07), .O(new_n50_));
  inv1   g24(.a(x12), .O(new_n51_));
  nor2   g25(.a(x09), .b(x01), .O(new_n52_));
  nor2   g26(.a(x11), .b(new_n26_), .O(new_n53_));
  oai21  g27(.a(new_n53_), .b(new_n52_), .c(x00), .O(new_n54_));
  inv1   g28(.a(x00), .O(new_n55_));
  nor2   g29(.a(x08), .b(x01), .O(new_n56_));
  nor2   g30(.a(x10), .b(new_n26_), .O(new_n57_));
  oai21  g31(.a(new_n57_), .b(new_n56_), .c(new_n55_), .O(new_n58_));
  aoi21  g32(.a(new_n58_), .b(new_n54_), .c(new_n36_), .O(new_n59_));
  nand4  g33(.a(new_n59_), .b(new_n51_), .c(new_n50_), .d(x05), .O(new_n60_));
  nand4  g34(.a(new_n36_), .b(new_n30_), .c(x02), .d(new_n26_), .O(new_n61_));
  oai21  g35(.a(new_n60_), .b(x02), .c(new_n61_), .O(new_n62_));
  nand3  g36(.a(new_n62_), .b(x04), .c(new_n41_), .O(new_n63_));
  inv1   g37(.a(new_n63_), .O(z06));
  nand4  g38(.a(x05), .b(new_n29_), .c(new_n41_), .d(new_n33_), .O(new_n65_));
  aoi21  g39(.a(new_n65_), .b(new_n26_), .c(x13), .O(z07));
  nand4  g40(.a(x13), .b(new_n51_), .c(x05), .d(new_n33_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n61_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n41_), .O(new_n69_));
  inv1   g43(.a(new_n69_), .O(z08));
  and2   g44(.a(x13), .b(x06), .O(z09));
  inv1   g45(.a(z04), .O(new_n72_));
  nand4  g46(.a(new_n32_), .b(new_n72_), .c(x06), .d(new_n41_), .O(new_n73_));
