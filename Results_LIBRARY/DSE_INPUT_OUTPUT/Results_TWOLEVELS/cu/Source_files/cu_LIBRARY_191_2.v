...
module FAU ( 
  ...
  nor3   g24(.a(x02), .b(new_n49_), .c(new_n32_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x05), .c(new_n26_), .d(new_n36_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z05));
  nor2   g27(.a(x03), .b(x02), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(x05), .c(x04), .O(new_n54_));
  ...
  nand3  g45(.a(new_n46_), .b(x05), .c(new_n26_), .O(new_n71_));
  inv1   g46(.a(new_n71_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n53_), .c(new_n49_), .O(new_n73_));
  nand4  g48(.a(new_n72_), .b(new_n36_), .c(new_n30_), .d(new_n32_), .O(new_n74_));
  oai21  g49(.a(new_n73_), .b(new_n32_), .c(new_n74_), .O(z07));
  ...
  nor3   g55(.a(z03), .b(new_n46_), .c(new_n80_), .O(z09));
  nand4  g56(.a(new_n34_), .b(new_n29_), .c(x06), .d(new_n36_), .O(new_n82_));
