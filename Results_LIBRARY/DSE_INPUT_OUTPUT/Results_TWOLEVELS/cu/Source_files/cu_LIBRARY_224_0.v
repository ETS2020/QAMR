...
module FAU ( 
  ...
  nor2   g00(.a(x12), .b(x09), .O(new_n26_));
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n46_));
  ...
  oai21  g25(.a(new_n50_), .b(new_n46_), .c(new_n36_), .O(z04));
  nor2   g26(.a(new_n26_), .b(x13), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x02), .O(z07));
  nand2  g29(.a(z07), .b(x01), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(new_n42_), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nor2   g33(.a(x08), .b(x01), .O(new_n59_));
  nor2   g34(.a(x10), .b(new_n43_), .O(new_n60_));
  ...
  nand4  g42(.a(new_n45_), .b(x12), .c(new_n29_), .d(x02), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  aoi21  g44(.a(new_n67_), .b(x09), .c(new_n69_), .O(new_n70_));
  nor3   g45(.a(new_n70_), .b(new_n28_), .c(x03), .O(z06));
  nand3  g46(.a(new_n52_), .b(new_n29_), .c(x02), .O(new_n72_));
  nor2   g47(.a(new_n29_), .b(x02), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x13), .c(new_n58_), .d(x09), .O(new_n74_));
  ...
  nand4  g54(.a(new_n31_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n80_));
