...
module FAU ( 
  ...
  nand4  g27(.a(new_n26_), .b(new_n46_), .c(new_n31_), .d(x02), .O(new_n53_));
  ...
  nand4  g41(.a(new_n66_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n67_));
  nor2   g42(.a(new_n67_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n55_), .c(x05), .d(new_n28_), .O(new_n69_));
  ...
  inv1   g49(.a(new_n32_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n26_), .c(x06), .d(new_n35_), .O(new_n76_));
