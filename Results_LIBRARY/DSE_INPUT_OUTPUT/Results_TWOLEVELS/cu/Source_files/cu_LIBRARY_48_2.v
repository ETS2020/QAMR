...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n47_));
  ...
  nand4  g26(.a(new_n51_), .b(x06), .c(x05), .d(new_n28_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z04));
  nand4  g28(.a(new_n34_), .b(new_n35_), .c(x01), .d(x00), .O(new_n54_));
  ...
  nand3  g42(.a(new_n46_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n74_));
