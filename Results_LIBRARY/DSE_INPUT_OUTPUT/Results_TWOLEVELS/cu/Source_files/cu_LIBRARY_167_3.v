...
module FAU ( 
  ...
  nand4  g22(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n47_), .c(new_n37_), .O(z03));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n38_), .b(new_n34_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nor3   g29(.a(x02), .b(new_n26_), .c(new_n50_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n56_));
  ...
  nand4  g41(.a(new_n66_), .b(x05), .c(new_n34_), .d(new_n26_), .O(new_n67_));
  ...
  nand4  g46(.a(new_n27_), .b(x05), .c(new_n30_), .d(new_n38_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n37_), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n34_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n68_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n38_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n37_), .O(z08));
  inv1   g52(.a(x06), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(new_n26_), .c(new_n27_), .O(z09));
  nand3  g54(.a(new_n33_), .b(x06), .c(new_n38_), .O(new_n80_));
