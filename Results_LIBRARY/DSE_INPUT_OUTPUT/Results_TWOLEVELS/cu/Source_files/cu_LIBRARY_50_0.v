...
module FAU ( 
  ...
  aoi21  g19(.a(new_n44_), .b(x07), .c(x01), .O(z02));
  inv1   g20(.a(x01), .O(new_n46_));
  nand4  g21(.a(new_n35_), .b(new_n32_), .c(new_n46_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x07), .c(x05), .d(new_n28_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(new_n32_), .b(x01), .c(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n42_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n53_));
  ...
  nand4  g32(.a(new_n36_), .b(new_n42_), .c(new_n29_), .d(x02), .O(new_n58_));
  ...
  nand4  g42(.a(new_n67_), .b(x05), .c(new_n32_), .d(x01), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n58_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n35_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z06));
  nor2   g46(.a(x07), .b(x01), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x00), .c(x13), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n36_), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n32_), .O(new_n76_));
  nand3  g51(.a(new_n42_), .b(new_n29_), .c(x02), .O(new_n77_));
