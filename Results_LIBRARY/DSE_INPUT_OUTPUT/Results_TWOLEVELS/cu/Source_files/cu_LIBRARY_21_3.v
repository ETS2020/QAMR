...
module FAU ( 
  ...
  nand4  g12(.a(new_n30_), .b(x04), .c(x02), .d(new_n28_), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(new_n37_), .c(x03), .O(z01));
  inv1   g14(.a(x00), .O(new_n40_));
  nand3  g15(.a(new_n36_), .b(new_n28_), .c(new_n40_), .O(new_n41_));
  ...
  nand4  g20(.a(new_n42_), .b(new_n36_), .c(new_n28_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n43_), .c(x05), .d(new_n29_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nand4  g24(.a(new_n42_), .b(new_n36_), .c(x01), .d(new_n40_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n43_), .c(x05), .d(new_n29_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand3  g28(.a(new_n43_), .b(x05), .c(new_n29_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n42_), .c(new_n36_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n29_), .c(new_n28_), .O(z05));
  ...
  nand4  g40(.a(new_n43_), .b(new_n30_), .c(x02), .d(new_n28_), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(new_n42_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n28_), .c(new_n29_), .O(z06));
  nor3   g44(.a(new_n54_), .b(x03), .c(x02), .O(z07));
  nand4  g45(.a(x13), .b(new_n59_), .c(x05), .d(new_n36_), .O(new_n71_));
  nand3  g46(.a(new_n43_), .b(new_n30_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(x04), .c(new_n42_), .d(new_n28_), .O(new_n74_));
