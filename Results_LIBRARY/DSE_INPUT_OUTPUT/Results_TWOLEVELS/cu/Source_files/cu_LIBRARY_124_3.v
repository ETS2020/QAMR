...
module FAU ( 
  ...
  oai21  g09(.a(x10), .b(new_n26_), .c(new_n34_), .O(z00));
  ...
  nand2  g14(.a(x10), .b(x03), .O(new_n40_));
  ...
  nand3  g40(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n66_));
  ...
  nand4  g44(.a(new_n47_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n70_));
  ...
  nand3  g50(.a(new_n40_), .b(x13), .c(x06), .O(new_n76_));
