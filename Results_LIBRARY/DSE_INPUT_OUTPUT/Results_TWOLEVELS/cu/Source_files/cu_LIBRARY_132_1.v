...
module FAU ( 
  ...
  oai21  g03(.a(x06), .b(new_n28_), .c(new_n27_), .O(new_n29_));
  ...
  aoi21  g18(.a(new_n43_), .b(new_n35_), .c(x04), .O(z02));
  nand4  g19(.a(new_n42_), .b(new_n30_), .c(new_n39_), .d(x00), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n35_), .c(x04), .O(z03));
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(x01), .d(new_n38_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n35_), .c(x05), .d(new_n27_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z04));
  nand4  g25(.a(new_n42_), .b(new_n30_), .c(x01), .d(x00), .O(new_n51_));
  aoi21  g26(.a(new_n51_), .b(new_n35_), .c(x04), .O(z05));
  ...
  nand4  g44(.a(x13), .b(new_n54_), .c(x05), .d(new_n30_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n64_), .O(new_n71_));
  nand3  g46(.a(new_n71_), .b(x04), .c(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(z08));
  nand3  g48(.a(x13), .b(x06), .c(x04), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(z09));
  oai21  g50(.a(new_n28_), .b(new_n30_), .c(new_n26_), .O(new_n76_));
  aoi21  g51(.a(new_n76_), .b(x04), .c(new_n35_), .O(z10));
endmodule
