...
module FAU ( 
  ...
  aoi21  g08(.a(x04), .b(x02), .c(x03), .O(new_n34_));
  nand4  g09(.a(x05), .b(new_n27_), .c(new_n26_), .d(new_n31_), .O(new_n35_));
  oai21  g10(.a(new_n34_), .b(x05), .c(new_n35_), .O(z01));
  ...
  nor2   g20(.a(x05), .b(new_n26_), .O(new_n46_));
  ...
  nand4  g43(.a(new_n40_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n69_));
  ...
  nor3   g50(.a(new_n46_), .b(new_n40_), .c(new_n75_), .O(z09));
