...
module FAU ( 
  ...
  aoi21  g28(.a(new_n53_), .b(new_n40_), .c(new_n41_), .O(z04));
  nand3  g29(.a(new_n50_), .b(x05), .c(x04), .O(new_n56_));
  ...
  nand3  g36(.a(x05), .b(new_n26_), .c(new_n41_), .O(new_n63_));
  inv1   g37(.a(x08), .O(new_n64_));
  nand4  g38(.a(x13), .b(new_n59_), .c(new_n64_), .d(new_n57_), .O(new_n65_));
  nand3  g39(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n66_));
  oai21  g40(.a(new_n65_), .b(new_n63_), .c(new_n66_), .O(new_n67_));
  nand2  g41(.a(new_n67_), .b(new_n40_), .O(new_n68_));
  nand4  g42(.a(new_n43_), .b(new_n27_), .c(x02), .d(new_n41_), .O(new_n69_));
  inv1   g43(.a(new_n69_), .O(new_n70_));
  nand3  g44(.a(x05), .b(new_n26_), .c(x01), .O(new_n71_));
  inv1   g45(.a(new_n71_), .O(new_n72_));
  inv1   g46(.a(x10), .O(new_n73_));
  nand4  g47(.a(x13), .b(new_n59_), .c(new_n73_), .d(new_n57_), .O(new_n74_));
  inv1   g48(.a(new_n74_), .O(new_n75_));
  aoi21  g49(.a(new_n75_), .b(new_n72_), .c(new_n70_), .O(new_n76_));
  nand2  g50(.a(new_n76_), .b(new_n68_), .O(new_n77_));
  nand3  g51(.a(new_n77_), .b(x04), .c(new_n34_), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n62_), .O(z06));
  aoi21  g53(.a(new_n52_), .b(new_n50_), .c(x01), .O(new_n80_));
  aoi21  g54(.a(new_n41_), .b(x00), .c(x13), .O(new_n81_));
  nand4  g55(.a(new_n81_), .b(x05), .c(new_n30_), .d(new_n34_), .O(new_n82_));
  oai22  g56(.a(new_n82_), .b(x02), .c(new_n80_), .d(new_n40_), .O(z07));
  nand2  g57(.a(x13), .b(new_n59_), .O(new_n84_));
  nand2  g58(.a(x05), .b(new_n26_), .O(new_n85_));
  oai21  g59(.a(new_n85_), .b(new_n84_), .c(new_n66_), .O(new_n86_));
  nand4  g60(.a(new_n86_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n87_));
  inv1   g61(.a(new_n87_), .O(z08));
  nand3  g62(.a(new_n32_), .b(x13), .c(x06), .O(new_n89_));
  inv1   g63(.a(new_n89_), .O(z09));
  nand2  g64(.a(x05), .b(x02), .O(new_n91_));
  nand4  g65(.a(new_n91_), .b(new_n32_), .c(x06), .d(new_n34_), .O(new_n92_));
  inv1   g66(.a(new_n92_), .O(z10));
  zero   g67(.O(z05));
endmodule
