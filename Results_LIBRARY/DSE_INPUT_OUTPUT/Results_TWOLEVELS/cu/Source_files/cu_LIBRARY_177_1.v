...
module FAU ( 
  ...
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n54_), .d(new_n26_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x05), .c(new_n30_), .O(new_n65_));
  nand4  g40(.a(new_n27_), .b(new_n48_), .c(new_n31_), .d(x02), .O(new_n66_));
  ...
  nand2  g44(.a(new_n28_), .b(new_n55_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n48_), .c(x05), .d(new_n34_), .O(new_n71_));
  ...
  nand3  g50(.a(new_n48_), .b(new_n31_), .c(x02), .O(new_n76_));
