...
module FAU ( 
  ...
  nand3  g32(.a(x11), .b(new_n57_), .c(new_n46_), .O(new_n58_));
  inv1   g33(.a(x08), .O(new_n59_));
  nand3  g34(.a(new_n26_), .b(new_n59_), .c(x01), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(new_n58_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(x00), .O(new_n62_));
  nand2  g37(.a(x10), .b(x01), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n51_), .O(new_n64_));
  nand2  g39(.a(new_n57_), .b(new_n46_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  inv1   g41(.a(x10), .O(new_n67_));
  nand4  g42(.a(x11), .b(new_n67_), .c(x01), .d(new_n51_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(new_n69_));
  aoi21  g44(.a(new_n66_), .b(new_n59_), .c(new_n69_), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n62_), .c(new_n48_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n56_), .c(new_n55_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n27_), .b(new_n48_), .c(new_n31_), .d(x02), .O(new_n73_));
  ...
  nand2  g52(.a(new_n77_), .b(new_n27_), .O(new_n78_));
  xnor2a g53(.a(x01), .b(x00), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(new_n78_), .c(x13), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n81_));
  oai21  g56(.a(new_n81_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g57(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n73_), .O(new_n84_));
  nand3  g59(.a(new_n84_), .b(x04), .c(new_n37_), .O(new_n85_));
  ...
  nand4  g64(.a(new_n89_), .b(new_n27_), .c(x06), .d(new_n37_), .O(new_n90_));
