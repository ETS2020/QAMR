...
module FAU ( 
  ...
  nand2  g35(.a(x10), .b(new_n44_), .O(new_n61_));
  inv1   g36(.a(x10), .O(new_n62_));
  nand2  g37(.a(new_n26_), .b(new_n62_), .O(new_n63_));
  nand2  g38(.a(new_n63_), .b(new_n61_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(new_n60_), .c(new_n43_), .O(new_n65_));
  aoi21  g40(.a(x09), .b(new_n44_), .c(new_n43_), .O(new_n66_));
  nor2   g41(.a(x10), .b(new_n44_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(new_n66_), .c(new_n26_), .O(new_n68_));
  inv1   g43(.a(x09), .O(new_n69_));
  nand4  g44(.a(x10), .b(new_n69_), .c(new_n44_), .d(x00), .O(new_n70_));
