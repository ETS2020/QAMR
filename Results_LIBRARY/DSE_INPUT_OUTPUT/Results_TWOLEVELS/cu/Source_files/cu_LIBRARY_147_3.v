...
module FAU ( 
  ...
  oai21  g09(.a(new_n26_), .b(x01), .c(new_n34_), .O(z00));
  ...
  nand2  g14(.a(x03), .b(x01), .O(new_n40_));
  ...
  nand3  g25(.a(new_n47_), .b(x05), .c(new_n27_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n26_), .c(new_n30_), .d(new_n50_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n26_), .c(new_n45_), .O(z04));
  nand4  g29(.a(new_n52_), .b(new_n26_), .c(new_n30_), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(new_n26_), .c(new_n45_), .O(z05));
  inv1   g31(.a(x07), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nor3   g33(.a(x09), .b(x03), .c(x01), .O(new_n59_));
  nor2   g34(.a(x11), .b(new_n45_), .O(new_n60_));
  oai21  g35(.a(new_n60_), .b(new_n59_), .c(x00), .O(new_n61_));
  nor3   g36(.a(x08), .b(x03), .c(x01), .O(new_n62_));
  ...
  nand4  g41(.a(new_n47_), .b(new_n31_), .c(new_n26_), .d(x02), .O(new_n67_));
  ...
  nor3   g45(.a(new_n51_), .b(x03), .c(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n58_), .c(x05), .d(new_n30_), .O(new_n72_));
  nand3  g47(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n73_));
