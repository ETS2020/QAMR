...
module FAU ( 
  ...
  nand3  g26(.a(new_n45_), .b(x05), .c(new_n31_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n36_), .c(new_n29_), .d(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x08), .c(new_n46_), .O(z04));
  nand4  g30(.a(new_n53_), .b(new_n36_), .c(new_n29_), .d(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x08), .c(new_n46_), .O(z05));
  ...
  nand2  g40(.a(new_n26_), .b(new_n46_), .O(new_n66_));
  ...
  aoi21  g45(.a(new_n70_), .b(new_n65_), .c(new_n45_), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n72_));
  nand4  g47(.a(new_n27_), .b(new_n45_), .c(new_n32_), .d(x02), .O(new_n73_));
  ...
  nand3  g51(.a(new_n53_), .b(new_n36_), .c(new_n29_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n27_), .O(z07));
  nand4  g53(.a(x13), .b(new_n59_), .c(x05), .d(new_n29_), .O(new_n79_));
  nand3  g54(.a(new_n45_), .b(new_n32_), .c(x02), .O(new_n80_));
  ...
  nor3   g59(.a(new_n28_), .b(new_n45_), .c(new_n84_), .O(z09));
  inv1   g60(.a(new_n33_), .O(new_n86_));
  nand3  g61(.a(new_n86_), .b(x06), .c(new_n36_), .O(new_n87_));
