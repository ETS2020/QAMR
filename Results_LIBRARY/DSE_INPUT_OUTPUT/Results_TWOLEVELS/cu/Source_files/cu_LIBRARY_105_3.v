...
module FAU ( 
  ...
  nand4  g24(.a(new_n34_), .b(new_n26_), .c(x01), .d(new_n49_), .O(new_n50_));
  ...
  nand3  g35(.a(x05), .b(new_n26_), .c(new_n44_), .O(new_n62_));
  ...
  nand2  g40(.a(new_n66_), .b(new_n49_), .O(new_n67_));
  nand4  g41(.a(new_n43_), .b(new_n27_), .c(x02), .d(new_n44_), .O(new_n68_));
  ...
  nand4  g53(.a(new_n79_), .b(x05), .c(new_n30_), .d(new_n34_), .O(new_n80_));
  ...
  nand3  g60(.a(new_n32_), .b(x13), .c(x06), .O(new_n87_));
  inv1   g61(.a(new_n87_), .O(z09));
  nand2  g62(.a(x05), .b(x02), .O(new_n89_));
  nand3  g63(.a(new_n89_), .b(x06), .c(new_n34_), .O(new_n90_));
  nand2  g64(.a(new_n90_), .b(new_n32_), .O(z10));
  zero   g65(.O(z05));
endmodule
