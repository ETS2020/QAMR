...
module FAU ( 
  ...
  oai21  g01(.a(x11), .b(x05), .c(x02), .O(new_n27_));
  ...
  nand2  g23(.a(x11), .b(x02), .O(new_n49_));
  inv1   g24(.a(x00), .O(new_n50_));
  nand3  g25(.a(new_n28_), .b(x01), .c(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n43_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n52_));
  ...
  nand4  g40(.a(new_n43_), .b(new_n34_), .c(new_n31_), .d(x02), .O(new_n66_));
  ...
  nand4  g44(.a(new_n43_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n70_));
