...
module FAU ( 
  ...
  nand2  g12(.a(x13), .b(new_n28_), .O(new_n38_));
  ...
  nand3  g19(.a(new_n27_), .b(new_n40_), .c(x00), .O(new_n45_));
  oai21  g20(.a(new_n45_), .b(new_n43_), .c(new_n38_), .O(z03));
  ...
  nand4  g37(.a(new_n62_), .b(new_n55_), .c(new_n54_), .d(new_n27_), .O(new_n63_));
  ...
  nand4  g42(.a(new_n42_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(x02), .c(new_n38_), .O(z07));
  nand2  g44(.a(x05), .b(new_n27_), .O(new_n70_));
  ...
  aoi21  g50(.a(new_n75_), .b(x05), .c(new_n42_), .O(z09));
  inv1   g51(.a(new_n35_), .O(new_n77_));
  nand2  g52(.a(new_n70_), .b(new_n77_), .O(new_n78_));
