...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(new_n27_), .c(new_n42_), .d(new_n41_), .O(new_n43_));
  ...
  oai21  g28(.a(new_n53_), .b(new_n51_), .c(new_n35_), .O(z04));
  ...
  nand3  g34(.a(new_n59_), .b(x08), .c(new_n42_), .O(new_n60_));
  ...
  nand4  g43(.a(new_n35_), .b(new_n52_), .c(new_n30_), .d(x02), .O(new_n69_));
  ...
  nand4  g51(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n77_));
  nand3  g52(.a(new_n52_), .b(new_n30_), .c(x02), .O(new_n78_));
  nand2  g53(.a(new_n78_), .b(new_n77_), .O(new_n79_));
  nand4  g54(.a(new_n79_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n80_));
