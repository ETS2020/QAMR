...
module FAU ( 
  ...
  oai21  g30(.a(new_n55_), .b(new_n48_), .c(new_n34_), .O(z05));
  ...
  nand4  g44(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n70_));
