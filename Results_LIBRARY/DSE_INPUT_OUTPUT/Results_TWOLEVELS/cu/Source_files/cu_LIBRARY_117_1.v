...
module FAU ( 
  ...
  nand2  g13(.a(x03), .b(new_n38_), .O(new_n39_));
  ...
  nand3  g19(.a(new_n44_), .b(x05), .c(new_n27_), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n26_), .c(new_n31_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n26_), .c(x01), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nand3  g24(.a(new_n31_), .b(x01), .c(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n44_), .b(x05), .c(new_n27_), .d(new_n26_), .O(new_n51_));
  ...
  nand4  g45(.a(new_n44_), .b(new_n28_), .c(new_n26_), .d(x02), .O(new_n71_));
  ...
  nor3   g49(.a(new_n45_), .b(x03), .c(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n56_), .c(x05), .d(new_n31_), .O(new_n76_));
  nand3  g51(.a(new_n44_), .b(new_n28_), .c(x02), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n26_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n39_), .O(z08));
  nand2  g55(.a(x13), .b(x06), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n39_), .O(z09));
  nand3  g57(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n39_), .O(z10));
endmodule
