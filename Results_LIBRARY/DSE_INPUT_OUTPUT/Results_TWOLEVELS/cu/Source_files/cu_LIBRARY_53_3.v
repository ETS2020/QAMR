...
module FAU ( 
  ...
  nand4  g22(.a(new_n47_), .b(new_n46_), .c(x05), .d(new_n30_), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(new_n45_), .c(new_n44_), .O(z03));
  nand4  g24(.a(new_n35_), .b(new_n28_), .c(x01), .d(new_n44_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n46_), .c(x05), .d(new_n30_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(z04));
  nand4  g28(.a(new_n26_), .b(new_n46_), .c(new_n31_), .d(x02), .O(new_n55_));
  ...
  nand4  g42(.a(new_n68_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n69_));
  nor2   g43(.a(new_n69_), .b(x02), .O(z07));
  nand4  g44(.a(x13), .b(new_n57_), .c(x05), .d(new_n28_), .O(new_n71_));
  ...
  nand4  g51(.a(new_n77_), .b(new_n26_), .c(x06), .d(new_n35_), .O(new_n78_));
