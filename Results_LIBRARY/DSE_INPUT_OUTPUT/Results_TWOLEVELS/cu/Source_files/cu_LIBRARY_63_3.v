...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n85_, new_n86_;
  aoi21  g00(.a(x07), .b(x00), .c(x03), .O(new_n26_));
  ...
  nand2  g09(.a(x07), .b(x00), .O(new_n35_));
  ...
  nand4  g17(.a(new_n42_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n43_));
  ...
  nand3  g25(.a(new_n27_), .b(x01), .c(new_n45_), .O(new_n51_));
  nand4  g26(.a(new_n47_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n52_));
  ...
  nand4  g30(.a(new_n55_), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n56_));
  ...
  nand3  g42(.a(new_n67_), .b(new_n46_), .c(new_n45_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n62_), .c(new_n47_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n70_));
  nand4  g45(.a(new_n35_), .b(new_n47_), .c(new_n28_), .d(x02), .O(new_n71_));
  ...
  aoi21  g49(.a(x07), .b(x00), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n78_));
  nand3  g53(.a(new_n47_), .b(new_n28_), .c(x02), .O(new_n79_));
  ...
  nand4  g60(.a(new_n85_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n86_));
