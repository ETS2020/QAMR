...
module FAU ( 
  ...
  nor2   g20(.a(x13), .b(new_n27_), .O(new_n47_));
  nand3  g21(.a(new_n47_), .b(new_n26_), .c(new_n35_), .O(new_n48_));
  oai21  g22(.a(new_n48_), .b(new_n46_), .c(new_n33_), .O(z04));
  nor2   g23(.a(x03), .b(x02), .O(new_n50_));
  nand4  g24(.a(new_n50_), .b(new_n47_), .c(new_n26_), .d(x01), .O(new_n51_));
  aoi21  g25(.a(new_n51_), .b(x01), .c(new_n45_), .O(z05));
  inv1   g26(.a(x13), .O(new_n53_));
  nand4  g27(.a(new_n33_), .b(new_n53_), .c(new_n27_), .d(x02), .O(new_n54_));
  ...
  aoi21  g40(.a(new_n32_), .b(x00), .c(x13), .O(new_n67_));
  ...
  nand3  g44(.a(new_n53_), .b(new_n27_), .c(x02), .O(new_n71_));
