...
module FAU ( 
  ...
  oai21  g01(.a(x11), .b(x02), .c(x05), .O(new_n27_));
  ...
  nand3  g33(.a(new_n58_), .b(new_n39_), .c(new_n38_), .O(new_n59_));
  inv1   g34(.a(x10), .O(new_n60_));
  nand2  g35(.a(new_n60_), .b(x01), .O(new_n61_));
  nand3  g36(.a(new_n61_), .b(new_n59_), .c(new_n57_), .O(new_n62_));
  nand4  g37(.a(new_n62_), .b(x13), .c(new_n55_), .d(new_n35_), .O(new_n63_));
  inv1   g38(.a(new_n63_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n54_), .c(x05), .d(new_n28_), .O(new_n65_));
  ...
  aoi21  g45(.a(x11), .b(new_n39_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n30_), .c(new_n26_), .d(new_n28_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n35_), .c(new_n31_), .O(z07));
  nand4  g48(.a(x13), .b(new_n55_), .c(x05), .d(new_n28_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n67_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n26_), .O(new_n76_));
  nand2  g51(.a(x11), .b(x05), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n76_), .O(z08));
  nand2  g53(.a(x13), .b(x06), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n77_), .O(z09));
