...
module FAU ( 
  ...
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n30_), .d(new_n36_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nand3  g28(.a(x05), .b(new_n26_), .c(new_n32_), .O(new_n55_));
  ...
  nand3  g33(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n60_));
  oai21  g34(.a(new_n59_), .b(new_n55_), .c(new_n60_), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(x00), .O(new_n62_));
  oai22  g36(.a(x11), .b(new_n32_), .c(x08), .d(x00), .O(new_n63_));
  nand4  g37(.a(new_n63_), .b(x13), .c(new_n58_), .d(new_n56_), .O(new_n64_));
  inv1   g38(.a(new_n64_), .O(new_n65_));
  nand3  g39(.a(new_n65_), .b(x05), .c(new_n26_), .O(new_n66_));
  nand4  g40(.a(new_n45_), .b(new_n27_), .c(x02), .d(new_n32_), .O(new_n67_));
  nand3  g41(.a(new_n67_), .b(new_n66_), .c(new_n62_), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(x04), .c(new_n36_), .O(new_n69_));
  nand2  g43(.a(new_n69_), .b(new_n34_), .O(z06));
  aoi21  g44(.a(x01), .b(new_n51_), .c(x13), .O(new_n71_));
  ...
  nand2  g48(.a(x13), .b(new_n58_), .O(new_n75_));
  oai21  g49(.a(new_n75_), .b(new_n74_), .c(new_n60_), .O(new_n76_));
