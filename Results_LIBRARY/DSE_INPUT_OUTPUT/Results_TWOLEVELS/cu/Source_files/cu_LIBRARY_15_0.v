...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x09), .c(x05), .d(new_n29_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nand4  g21(.a(new_n35_), .b(new_n27_), .c(new_n42_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x09), .c(x05), .d(new_n29_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nor2   g25(.a(x02), .b(new_n42_), .O(new_n51_));
  nand4  g26(.a(x09), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(new_n51_), .c(new_n41_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x09), .c(x13), .O(z04));
  nand3  g30(.a(new_n53_), .b(new_n51_), .c(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x09), .c(x13), .O(z05));
  ...
  nand4  g47(.a(new_n60_), .b(x09), .c(x05), .d(new_n29_), .O(new_n73_));
  nor3   g48(.a(new_n73_), .b(x03), .c(x02), .O(z07));
  nand4  g49(.a(x13), .b(new_n59_), .c(x05), .d(new_n27_), .O(new_n75_));
