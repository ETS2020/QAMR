...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x09), .c(x05), .d(new_n28_), .O(new_n46_));
  ...
  aoi21  g25(.a(new_n50_), .b(x09), .c(x01), .O(z03));
  ...
  nand4  g32(.a(new_n57_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n58_));
  ...
  nand3  g43(.a(new_n52_), .b(new_n29_), .c(x02), .O(new_n69_));
  ...
  nor2   g47(.a(x09), .b(x01), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n42_), .c(x13), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n75_));
  oai21  g50(.a(new_n75_), .b(x02), .c(new_n36_), .O(z07));
  ...
  nand4  g57(.a(new_n31_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n83_));
