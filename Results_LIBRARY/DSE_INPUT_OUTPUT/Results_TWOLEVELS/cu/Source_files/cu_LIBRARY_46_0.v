...
module FAU ( 
  ...
  nand4  g25(.a(new_n41_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n34_), .O(z05));
  nand4  g27(.a(new_n34_), .b(new_n41_), .c(new_n30_), .d(x02), .O(new_n53_));
  ...
  nand4  g41(.a(new_n41_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n34_), .O(z07));
  ...
  nand4  g46(.a(new_n71_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n72_));
