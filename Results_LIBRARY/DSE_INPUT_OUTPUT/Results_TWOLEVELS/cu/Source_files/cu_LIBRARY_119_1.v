...
module FAU ( 
  ...
  oai21  g02(.a(x13), .b(x02), .c(new_n27_), .O(new_n28_));
  ...
  nand4  g21(.a(new_n26_), .b(new_n30_), .c(new_n34_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n37_), .c(x05), .d(new_n27_), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(z03));
  inv1   g25(.a(x00), .O(new_n51_));
  nand3  g26(.a(x05), .b(new_n26_), .c(new_n30_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand3  g28(.a(new_n53_), .b(x01), .c(new_n51_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n37_), .c(x04), .O(z04));
  nand3  g30(.a(new_n53_), .b(x01), .c(x00), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n37_), .c(x04), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  nor2   g34(.a(x09), .b(x01), .O(new_n60_));
  nor2   g35(.a(x11), .b(new_n34_), .O(new_n61_));
  oai21  g36(.a(new_n61_), .b(new_n60_), .c(x00), .O(new_n62_));
  nor2   g37(.a(x08), .b(x01), .O(new_n63_));
  nor2   g38(.a(x10), .b(new_n34_), .O(new_n64_));
  oai21  g39(.a(new_n64_), .b(new_n63_), .c(new_n51_), .O(new_n65_));
  aoi21  g40(.a(new_n65_), .b(new_n62_), .c(new_n37_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n59_), .c(new_n58_), .d(x05), .O(new_n67_));
  nand4  g42(.a(new_n37_), .b(new_n31_), .c(x04), .d(x02), .O(new_n68_));
  oai21  g43(.a(new_n67_), .b(x02), .c(new_n68_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n26_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n42_), .O(z06));
  nand3  g46(.a(new_n35_), .b(new_n26_), .c(new_n30_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n37_), .c(x04), .O(z07));
  nand4  g48(.a(x13), .b(new_n59_), .c(x05), .d(new_n30_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n68_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n26_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n42_), .O(z08));
  nand3  g52(.a(x13), .b(x06), .c(x04), .O(new_n78_));
  inv1   g53(.a(new_n78_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x06), .c(new_n26_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n42_), .O(z10));
endmodule
