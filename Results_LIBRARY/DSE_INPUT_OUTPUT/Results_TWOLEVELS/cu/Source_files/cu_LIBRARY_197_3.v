...
module FAU ( 
  ...
  nor2   g31(.a(x13), .b(x09), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n56_), .c(new_n38_), .d(x01), .O(new_n58_));
  ...
  nand2  g39(.a(new_n64_), .b(new_n47_), .O(new_n65_));
  inv1   g40(.a(x10), .O(new_n66_));
  nand3  g41(.a(new_n66_), .b(x01), .c(new_n26_), .O(new_n67_));
  ...
  nand3  g45(.a(new_n70_), .b(x05), .c(new_n36_), .O(new_n71_));
  nand3  g46(.a(new_n53_), .b(new_n37_), .c(x02), .O(new_n72_));
  ...
  aoi21  g50(.a(x09), .b(x00), .c(x13), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n77_));
  ...
  nand4  g60(.a(new_n85_), .b(new_n34_), .c(x06), .d(new_n35_), .O(new_n86_));
