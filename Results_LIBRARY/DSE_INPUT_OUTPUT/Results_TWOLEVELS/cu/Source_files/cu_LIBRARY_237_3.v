...
module FAU ( 
  ...
  oai21  g21(.a(new_n46_), .b(new_n45_), .c(new_n34_), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n36_), .c(new_n44_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand3  g26(.a(new_n36_), .b(x01), .c(new_n43_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n46_), .c(new_n34_), .O(z04));
  nand3  g28(.a(new_n36_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n46_), .c(new_n34_), .O(z05));
  ...
  nand3  g37(.a(new_n62_), .b(x01), .c(new_n43_), .O(new_n63_));
  ...
  nand4  g41(.a(new_n66_), .b(new_n56_), .c(x05), .d(new_n36_), .O(new_n67_));
  nand3  g42(.a(new_n27_), .b(new_n38_), .c(x02), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g44(.a(new_n69_), .b(x04), .c(new_n35_), .O(new_n70_));
  inv1   g45(.a(new_n70_), .O(z06));
  nand4  g46(.a(new_n27_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n72_));
  oai21  g47(.a(new_n72_), .b(x02), .c(new_n34_), .O(z07));
  ...
  aoi21  g53(.a(new_n26_), .b(new_n78_), .c(new_n27_), .O(z09));
