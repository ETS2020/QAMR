...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(new_n44_), .c(x05), .d(new_n26_), .O(new_n46_));
  ...
  aoi21  g25(.a(new_n46_), .b(new_n50_), .c(new_n43_), .O(z04));
  nand3  g26(.a(new_n45_), .b(x05), .c(x04), .O(new_n53_));
  ...
  nand3  g34(.a(new_n60_), .b(new_n43_), .c(new_n50_), .O(new_n61_));
  ...
  aoi21  g43(.a(new_n43_), .b(x00), .c(x13), .O(new_n70_));
  nand4  g44(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n34_), .O(new_n71_));
  ...
  nand4  g52(.a(new_n32_), .b(new_n29_), .c(x06), .d(new_n34_), .O(new_n79_));
