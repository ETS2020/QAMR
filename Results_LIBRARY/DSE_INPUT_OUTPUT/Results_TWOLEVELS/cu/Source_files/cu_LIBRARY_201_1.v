...
module FAU ( 
  ...
  nor2   g24(.a(new_n28_), .b(x13), .O(new_n50_));
  ...
  nand3  g29(.a(new_n35_), .b(x01), .c(x00), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n46_), .c(new_n27_), .O(z05));
  ...
  nand3  g41(.a(new_n66_), .b(x05), .c(new_n35_), .O(new_n67_));
  nand3  g42(.a(new_n50_), .b(new_n37_), .c(x02), .O(new_n68_));
  ...
  nand4  g46(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n72_));
  nand3  g47(.a(new_n45_), .b(new_n37_), .c(x02), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n27_), .c(x04), .d(new_n34_), .O(new_n75_));
  ...
  nand4  g54(.a(new_n79_), .b(new_n27_), .c(x06), .d(new_n34_), .O(new_n80_));
