...
module FAU ( 
  ...
  nand4  g10(.a(x13), .b(x05), .c(new_n31_), .d(new_n27_), .O(new_n36_));
  aoi21  g11(.a(new_n36_), .b(new_n35_), .c(x03), .O(z01));
  nor2   g12(.a(x13), .b(x02), .O(z04));
  inv1   g13(.a(x07), .O(new_n42_));
  ...
  aoi21  g23(.a(new_n51_), .b(new_n47_), .c(new_n28_), .O(new_n52_));
  nand4  g24(.a(new_n52_), .b(new_n43_), .c(new_n42_), .d(x05), .O(new_n53_));
  nand3  g25(.a(new_n28_), .b(new_n32_), .c(x02), .O(new_n54_));
  oai21  g26(.a(new_n53_), .b(x02), .c(new_n54_), .O(new_n55_));
  nand3  g27(.a(new_n55_), .b(x04), .c(new_n26_), .O(new_n56_));
  inv1   g28(.a(new_n56_), .O(z06));
  nand4  g29(.a(x13), .b(new_n43_), .c(x05), .d(new_n27_), .O(new_n59_));
  nand2  g30(.a(new_n59_), .b(new_n54_), .O(new_n60_));
  nand3  g31(.a(new_n60_), .b(x04), .c(new_n26_), .O(new_n61_));
  inv1   g32(.a(new_n61_), .O(z08));
  nand2  g33(.a(x13), .b(x06), .O(new_n63_));
  oai21  g34(.a(x13), .b(x02), .c(new_n63_), .O(z09));
  nand2  g35(.a(new_n32_), .b(x02), .O(new_n65_));
  oai21  g36(.a(new_n28_), .b(x02), .c(new_n65_), .O(new_n66_));
  nand3  g37(.a(new_n66_), .b(x06), .c(new_n26_), .O(new_n67_));
