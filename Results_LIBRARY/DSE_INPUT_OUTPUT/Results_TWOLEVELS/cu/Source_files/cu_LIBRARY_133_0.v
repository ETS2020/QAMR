...
module FAU ( 
  ...
  nand4  g15(.a(new_n40_), .b(x05), .c(new_n35_), .d(new_n39_), .O(new_n41_));
  nor2   g16(.a(new_n41_), .b(x13), .O(z02));
  nor2   g17(.a(x13), .b(x04), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n39_), .c(new_n34_), .d(x00), .O(new_n44_));
  aoi21  g19(.a(new_n44_), .b(x05), .c(x01), .O(z03));
  inv1   g20(.a(x13), .O(new_n46_));
  inv1   g21(.a(x00), .O(new_n47_));
  nand4  g22(.a(new_n39_), .b(new_n34_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n35_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  inv1   g26(.a(x01), .O(new_n52_));
  nor3   g27(.a(x02), .b(new_n52_), .c(new_n47_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n35_), .d(new_n39_), .O(new_n54_));
  ...
  nand2  g43(.a(new_n68_), .b(new_n47_), .O(new_n69_));
  aoi21  g44(.a(new_n69_), .b(new_n63_), .c(new_n46_), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n57_), .c(new_n56_), .d(new_n34_), .O(new_n71_));
  nand3  g46(.a(new_n46_), .b(new_n29_), .c(x02), .O(new_n72_));
  nand2  g47(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(x04), .c(new_n39_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n27_), .O(z06));
  oai21  g50(.a(x01), .b(new_n47_), .c(new_n29_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n46_), .c(new_n35_), .d(new_n39_), .O(new_n77_));
  oai21  g52(.a(new_n77_), .b(x02), .c(new_n27_), .O(z07));
  nand4  g53(.a(x13), .b(new_n57_), .c(x05), .d(new_n34_), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n72_), .O(new_n80_));
  nand3  g55(.a(new_n80_), .b(x04), .c(new_n39_), .O(new_n81_));
  nand2  g56(.a(new_n81_), .b(new_n27_), .O(z08));
  inv1   g57(.a(x06), .O(new_n83_));
  nor3   g58(.a(new_n26_), .b(new_n46_), .c(new_n83_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x06), .c(new_n39_), .O(new_n86_));
