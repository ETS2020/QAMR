...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n31_), .d(new_n36_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n27_), .O(z02));
  nand3  g22(.a(new_n29_), .b(new_n43_), .c(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n27_), .O(z03));
  nand3  g24(.a(new_n45_), .b(x05), .c(new_n31_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n36_), .c(new_n29_), .d(new_n42_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(x08), .c(new_n43_), .O(z04));
  nand4  g28(.a(new_n51_), .b(new_n36_), .c(new_n29_), .d(x00), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(x08), .c(new_n43_), .O(z05));
  ...
  nand3  g49(.a(new_n51_), .b(new_n36_), .c(new_n29_), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n27_), .O(z07));
  nand4  g51(.a(x13), .b(new_n57_), .c(x05), .d(new_n29_), .O(new_n77_));
  nand3  g52(.a(new_n45_), .b(new_n32_), .c(x02), .O(new_n78_));
  ...
  nor3   g57(.a(new_n28_), .b(new_n45_), .c(new_n82_), .O(z09));
  inv1   g58(.a(new_n33_), .O(new_n84_));
  nand4  g59(.a(new_n84_), .b(new_n27_), .c(x06), .d(new_n36_), .O(new_n85_));
