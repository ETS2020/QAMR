...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n48_), .c(new_n47_), .d(x07), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x07), .c(new_n46_), .O(z03));
  nand3  g26(.a(new_n30_), .b(x01), .c(new_n46_), .O(new_n52_));
  nand4  g27(.a(new_n47_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n53_));
  oai21  g28(.a(new_n53_), .b(new_n52_), .c(new_n27_), .O(z04));
  nand4  g29(.a(new_n37_), .b(new_n30_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x07), .c(x05), .d(new_n34_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z05));
  nand4  g33(.a(new_n27_), .b(new_n47_), .c(new_n31_), .d(x02), .O(new_n59_));
  ...
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n34_), .d(new_n37_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n60_), .c(x05), .d(new_n30_), .O(new_n74_));
  nand3  g49(.a(new_n47_), .b(new_n31_), .c(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand4  g51(.a(new_n76_), .b(new_n27_), .c(x04), .d(new_n37_), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z08));
  inv1   g53(.a(x06), .O(new_n79_));
  nor3   g54(.a(new_n28_), .b(new_n47_), .c(new_n79_), .O(z09));
  nand2  g55(.a(x05), .b(x02), .O(new_n81_));
  nand4  g56(.a(new_n81_), .b(new_n27_), .c(x06), .d(new_n37_), .O(new_n82_));
