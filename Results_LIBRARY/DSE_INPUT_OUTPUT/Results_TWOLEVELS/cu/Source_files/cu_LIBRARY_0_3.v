...
module FAU ( 
  ...
  oai21  g01(.a(x04), .b(x01), .c(x05), .O(new_n27_));
  ...
  nand4  g16(.a(new_n26_), .b(new_n30_), .c(new_n34_), .d(x00), .O(new_n42_));
  inv1   g17(.a(new_n42_), .O(new_n43_));
  nand4  g18(.a(new_n43_), .b(new_n41_), .c(x05), .d(new_n28_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(z03));
  nor2   g20(.a(new_n31_), .b(new_n34_), .O(z04));
  inv1   g21(.a(z04), .O(new_n48_));
  ...
  nand3  g31(.a(new_n41_), .b(new_n31_), .c(x02), .O(new_n58_));
  oai21  g32(.a(new_n57_), .b(x02), .c(new_n58_), .O(new_n59_));
  nand3  g33(.a(new_n59_), .b(x04), .c(new_n26_), .O(new_n60_));
  nand2  g34(.a(new_n60_), .b(new_n48_), .O(z06));
  nand4  g35(.a(new_n41_), .b(new_n28_), .c(new_n26_), .d(new_n30_), .O(new_n62_));
  aoi21  g36(.a(new_n62_), .b(new_n34_), .c(new_n31_), .O(z07));
  nand2  g37(.a(new_n30_), .b(new_n34_), .O(new_n64_));
  nand3  g38(.a(x13), .b(new_n50_), .c(x05), .O(new_n65_));
  oai21  g39(.a(new_n65_), .b(new_n64_), .c(new_n58_), .O(new_n66_));
  nand3  g40(.a(new_n66_), .b(x04), .c(new_n26_), .O(new_n67_));
  inv1   g41(.a(new_n67_), .O(z08));
  nand3  g42(.a(new_n48_), .b(x13), .c(x06), .O(new_n69_));
  inv1   g43(.a(new_n69_), .O(z09));
  nand2  g44(.a(new_n64_), .b(x05), .O(new_n71_));
