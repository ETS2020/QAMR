...
module FAU ( 
  ...
  nand4  g22(.a(new_n34_), .b(new_n35_), .c(new_n47_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nor3   g26(.a(x03), .b(x02), .c(x00), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n37_), .c(new_n46_), .d(x07), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x07), .c(new_n47_), .O(z04));
  ...
  nand4  g41(.a(new_n66_), .b(new_n60_), .c(new_n26_), .d(x05), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n59_), .O(new_n68_));
  nand3  g43(.a(new_n68_), .b(x04), .c(new_n34_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n27_), .O(z06));
  aoi21  g45(.a(new_n26_), .b(x01), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n60_), .c(x05), .d(new_n35_), .O(new_n74_));
