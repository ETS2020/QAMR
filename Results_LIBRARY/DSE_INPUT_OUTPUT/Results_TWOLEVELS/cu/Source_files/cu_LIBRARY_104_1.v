...
module FAU ( 
  ...
  nand4  g16(.a(new_n41_), .b(x05), .c(new_n33_), .d(new_n40_), .O(new_n42_));
  nor2   g17(.a(new_n42_), .b(x13), .O(z02));
  inv1   g18(.a(x01), .O(new_n44_));
  nand4  g19(.a(new_n40_), .b(new_n29_), .c(new_n44_), .d(x00), .O(new_n45_));
  inv1   g20(.a(new_n45_), .O(new_n46_));
  nand4  g21(.a(new_n46_), .b(new_n26_), .c(x05), .d(new_n33_), .O(new_n47_));
  ...
  nand4  g29(.a(new_n26_), .b(x05), .c(new_n33_), .d(new_n40_), .O(new_n55_));
  oai21  g30(.a(new_n55_), .b(new_n54_), .c(new_n36_), .O(z05));
  ...
  aoi21  g39(.a(new_n64_), .b(new_n61_), .c(new_n26_), .O(new_n65_));
  ...
  nand4  g45(.a(new_n26_), .b(x05), .c(new_n33_), .d(new_n40_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand2  g47(.a(x05), .b(new_n29_), .O(new_n73_));
  nand3  g48(.a(x13), .b(new_n58_), .c(x06), .O(new_n74_));
  ...
  nand2  g55(.a(new_n80_), .b(new_n36_), .O(z10));
endmodule
