...
module FAU ( 
  ...
  wire new_n26_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_, new_n33_,
    new_n34_, new_n36_, new_n37_, new_n38_, new_n39_, new_n40_, new_n45_,
    new_n46_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_, new_n59_,
    new_n60_, new_n62_, new_n63_, new_n64_, new_n67_, new_n68_;
  ...
  nand3  g29(.a(new_n47_), .b(new_n26_), .c(x02), .O(new_n58_));
  oai21  g30(.a(new_n57_), .b(x02), .c(new_n58_), .O(new_n59_));
  nand3  g31(.a(new_n59_), .b(x04), .c(new_n36_), .O(new_n60_));
  inv1   g32(.a(new_n60_), .O(z06));
  nand3  g33(.a(new_n46_), .b(x05), .c(new_n30_), .O(new_n62_));
  nand2  g34(.a(new_n62_), .b(new_n58_), .O(new_n63_));
  nand3  g35(.a(new_n63_), .b(x04), .c(new_n36_), .O(new_n64_));
  nand2  g36(.a(new_n64_), .b(new_n28_), .O(z08));
  and2   g37(.a(x13), .b(x06), .O(z09));
  oai21  g38(.a(new_n47_), .b(x02), .c(x05), .O(new_n67_));
  nand3  g39(.a(new_n67_), .b(x06), .c(new_n36_), .O(new_n68_));
  inv1   g40(.a(new_n68_), .O(z10));
  zero   g41(.O(z02));
  zero   g42(.O(z03));
  zero   g43(.O(z04));
