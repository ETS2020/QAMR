...
module FAU ( 
  ...
  nand4  g18(.a(new_n35_), .b(new_n36_), .c(new_n26_), .d(new_n43_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(x07), .c(x05), .d(new_n30_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n36_), .c(new_n26_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x07), .c(x05), .d(new_n30_), .O(new_n50_));
  ...
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n28_), .O(z04));
  nor3   g30(.a(x02), .b(new_n26_), .c(new_n43_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n57_));
  nor2   g32(.a(new_n57_), .b(x13), .O(z05));
  nand4  g33(.a(new_n28_), .b(new_n53_), .c(new_n38_), .d(x02), .O(new_n59_));
  ...
  aoi21  g44(.a(new_n27_), .b(new_n26_), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n60_), .c(x05), .d(new_n36_), .O(new_n73_));
  nand3  g48(.a(new_n53_), .b(new_n38_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(new_n28_), .c(x04), .d(new_n35_), .O(new_n76_));
  ...
  nand4  g55(.a(new_n80_), .b(new_n28_), .c(x06), .d(new_n35_), .O(new_n81_));
