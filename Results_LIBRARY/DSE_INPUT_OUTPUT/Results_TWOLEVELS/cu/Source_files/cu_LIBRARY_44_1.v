...
module FAU ( 
  ...
  nand2  g01(.a(x02), .b(new_n26_), .O(new_n27_));
  ...
  nand4  g21(.a(new_n46_), .b(new_n40_), .c(new_n36_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n29_), .c(x01), .O(z03));
  inv1   g23(.a(x00), .O(new_n49_));
  nor2   g24(.a(x02), .b(new_n26_), .O(new_n50_));
  nand2  g25(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand3  g26(.a(new_n46_), .b(new_n40_), .c(new_n36_), .O(new_n52_));
  ...
  nand3  g36(.a(new_n61_), .b(new_n29_), .c(x01), .O(new_n62_));
  ...
  nand3  g42(.a(new_n67_), .b(new_n29_), .c(x01), .O(new_n68_));
  ...
  nand4  g47(.a(new_n58_), .b(new_n30_), .c(x02), .d(x01), .O(new_n73_));
  ...
  oai21  g51(.a(x01), .b(new_n49_), .c(x02), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(new_n58_), .c(x05), .d(new_n40_), .O(new_n78_));
  oai21  g53(.a(new_n78_), .b(x03), .c(new_n27_), .O(z07));
  ...
  oai21  g60(.a(x05), .b(new_n26_), .c(x02), .O(new_n86_));
