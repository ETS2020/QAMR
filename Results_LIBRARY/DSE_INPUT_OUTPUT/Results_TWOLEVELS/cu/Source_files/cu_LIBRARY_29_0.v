...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n83_, new_n84_, new_n85_, new_n86_, new_n89_;
  ...
  nand4  g21(.a(new_n46_), .b(x08), .c(x05), .d(new_n28_), .O(new_n47_));
  nor2   g22(.a(new_n47_), .b(x13), .O(z02));
  nand4  g23(.a(new_n36_), .b(new_n32_), .c(new_n44_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(x08), .c(x05), .d(new_n28_), .O(new_n51_));
  nor2   g26(.a(new_n51_), .b(x13), .O(z03));
  nand4  g27(.a(new_n36_), .b(new_n32_), .c(x01), .d(new_n43_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x08), .c(x05), .d(new_n28_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z04));
  nor2   g31(.a(x02), .b(new_n44_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(new_n37_), .c(new_n36_), .d(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x08), .c(x13), .O(z05));
  ...
  nand3  g41(.a(new_n66_), .b(x01), .c(new_n43_), .O(new_n67_));
  inv1   g42(.a(new_n67_), .O(new_n68_));
  oai21  g43(.a(new_n68_), .b(new_n65_), .c(x13), .O(new_n69_));
  inv1   g44(.a(x08), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n44_), .c(new_n43_), .O(new_n71_));
  aoi21  g46(.a(new_n71_), .b(new_n69_), .c(x12), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(new_n60_), .c(x05), .d(new_n32_), .O(new_n73_));
  inv1   g48(.a(x13), .O(new_n74_));
  nand3  g49(.a(new_n74_), .b(new_n29_), .c(x02), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n73_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x04), .c(new_n36_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n35_), .O(z06));
  aoi21  g53(.a(x01), .b(x00), .c(x08), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(new_n29_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n28_), .c(new_n36_), .d(new_n32_), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(x08), .c(x13), .O(z07));
  inv1   g57(.a(x12), .O(new_n83_));
  nand4  g58(.a(x13), .b(new_n83_), .c(x05), .d(new_n32_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n75_), .O(new_n85_));
  nand3  g60(.a(new_n85_), .b(x04), .c(new_n36_), .O(new_n86_));
  nand2  g61(.a(new_n86_), .b(new_n35_), .O(z08));
  and2   g62(.a(x13), .b(x06), .O(z09));
