...
module FAU ( 
  ...
  inv1   g19(.a(new_n37_), .O(new_n45_));
  ...
  nand4  g46(.a(new_n71_), .b(new_n59_), .c(x05), .d(new_n26_), .O(new_n72_));
  nand3  g47(.a(new_n27_), .b(new_n32_), .c(x02), .O(new_n73_));
  oai21  g48(.a(new_n72_), .b(x02), .c(new_n73_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(x04), .O(new_n75_));
  nand2  g50(.a(new_n75_), .b(new_n41_), .O(z06));
  oai21  g51(.a(x01), .b(x00), .c(x03), .O(new_n77_));
  nand4  g52(.a(new_n77_), .b(x05), .c(new_n31_), .d(new_n28_), .O(new_n78_));
  aoi21  g53(.a(new_n78_), .b(new_n26_), .c(x13), .O(z07));
  nand2  g54(.a(new_n26_), .b(new_n28_), .O(new_n80_));
  inv1   g55(.a(x12), .O(new_n81_));
  nand3  g56(.a(x13), .b(new_n81_), .c(x05), .O(new_n82_));
  oai21  g57(.a(new_n82_), .b(new_n80_), .c(new_n73_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(x04), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n41_), .O(z08));
  and2   g60(.a(x13), .b(x06), .O(z09));
  nand3  g61(.a(new_n30_), .b(x06), .c(new_n26_), .O(new_n87_));
