...
module FAU ( 
  ...
  nand3  g29(.a(x05), .b(new_n27_), .c(x01), .O(new_n56_));
  ...
  nand3  g34(.a(new_n42_), .b(new_n30_), .c(x02), .O(new_n61_));
  oai21  g35(.a(new_n60_), .b(new_n56_), .c(new_n61_), .O(new_n62_));
  nand2  g36(.a(new_n62_), .b(x00), .O(new_n63_));
  oai22  g37(.a(x10), .b(x00), .c(x09), .d(x01), .O(new_n64_));
  nand4  g38(.a(new_n64_), .b(x13), .c(new_n59_), .d(new_n57_), .O(new_n65_));
  inv1   g39(.a(new_n65_), .O(new_n66_));
  nand3  g40(.a(new_n66_), .b(x05), .c(new_n27_), .O(new_n67_));
  nand4  g41(.a(new_n42_), .b(new_n30_), .c(x02), .d(x01), .O(new_n68_));
  nand3  g42(.a(new_n68_), .b(new_n67_), .c(new_n63_), .O(new_n69_));
  nand3  g43(.a(new_n69_), .b(x04), .c(new_n35_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n34_), .O(z06));
  aoi21  g45(.a(new_n43_), .b(new_n52_), .c(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n29_), .d(new_n35_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand2  g48(.a(x05), .b(new_n27_), .O(new_n75_));
  nand2  g49(.a(x13), .b(new_n59_), .O(new_n76_));
  oai21  g50(.a(new_n76_), .b(new_n75_), .c(new_n61_), .O(new_n77_));
  nand4  g51(.a(new_n77_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n78_));
  inv1   g52(.a(new_n78_), .O(z08));
  inv1   g53(.a(x06), .O(new_n80_));
  nor3   g54(.a(new_n26_), .b(new_n42_), .c(new_n80_), .O(z09));
