...
module FAU ( 
  ...
  nand4  g24(.a(new_n49_), .b(new_n43_), .c(x05), .d(new_n29_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand3  g27(.a(new_n35_), .b(x01), .c(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n44_), .b(x05), .c(new_n29_), .d(new_n34_), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n53_), .c(new_n27_), .O(z04));
  nor3   g30(.a(x02), .b(new_n26_), .c(new_n52_), .O(new_n56_));
  ...
  nand4  g43(.a(new_n27_), .b(new_n44_), .c(new_n36_), .d(x02), .O(new_n69_));
  ...
  aoi21  g54(.a(new_n44_), .b(x01), .c(new_n43_), .O(z09));
  oai21  g55(.a(new_n36_), .b(new_n35_), .c(new_n34_), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(x01), .c(new_n43_), .O(z10));
endmodule
