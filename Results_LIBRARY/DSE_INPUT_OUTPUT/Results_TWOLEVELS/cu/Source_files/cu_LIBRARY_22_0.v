...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n43_));
  ...
  nand3  g27(.a(x05), .b(new_n26_), .c(x01), .O(new_n53_));
  ...
  nand3  g32(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n58_));
  ...
  nand4  g39(.a(new_n41_), .b(new_n27_), .c(x02), .d(x01), .O(new_n65_));
