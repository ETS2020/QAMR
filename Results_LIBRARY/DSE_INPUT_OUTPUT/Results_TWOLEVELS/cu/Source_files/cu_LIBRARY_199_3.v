...
module FAU ( 
  ...
  nand4  g21(.a(new_n46_), .b(new_n45_), .c(x05), .d(new_n26_), .O(new_n47_));
  ...
  nand4  g25(.a(new_n50_), .b(new_n45_), .c(x05), .d(new_n26_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z04));
  nand4  g27(.a(new_n32_), .b(new_n45_), .c(new_n27_), .d(x02), .O(new_n54_));
  ...
  nand4  g41(.a(new_n67_), .b(x05), .c(new_n26_), .d(new_n34_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n70_));
  nand3  g44(.a(new_n45_), .b(new_n27_), .c(x02), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n32_), .c(x04), .d(new_n34_), .O(new_n73_));
