...
module FAU ( 
  ...
  wire new_n26_, new_n27_, new_n28_, new_n29_, new_n30_, new_n31_, new_n32_,
    ...
    new_n78_, new_n79_;
  nand2  g00(.a(x11), .b(x02), .O(new_n26_));
  ...
  nand4  g23(.a(new_n43_), .b(new_n28_), .c(x01), .d(new_n40_), .O(new_n49_));
  ...
  nand4  g40(.a(new_n44_), .b(new_n31_), .c(new_n29_), .d(x02), .O(new_n66_));
  oai21  g41(.a(new_n65_), .b(x02), .c(new_n66_), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(x04), .c(new_n43_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(new_n26_), .O(z06));
  nand4  g44(.a(new_n44_), .b(x05), .c(new_n36_), .d(new_n43_), .O(new_n70_));
