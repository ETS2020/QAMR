...
module FAU ( 
  ...
  nand4  g22(.a(new_n35_), .b(new_n26_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n41_), .c(x05), .d(new_n30_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z04));
  nand3  g26(.a(new_n26_), .b(x01), .c(x00), .O(new_n52_));
  nand4  g27(.a(new_n41_), .b(x05), .c(new_n30_), .d(new_n35_), .O(new_n53_));
  ...
  nand3  g34(.a(new_n41_), .b(new_n27_), .c(x02), .O(new_n60_));
  ...
  nand4  g41(.a(new_n41_), .b(new_n27_), .c(x02), .d(x01), .O(new_n67_));
  ...
  aoi21  g45(.a(new_n42_), .b(new_n47_), .c(x13), .O(new_n71_));
