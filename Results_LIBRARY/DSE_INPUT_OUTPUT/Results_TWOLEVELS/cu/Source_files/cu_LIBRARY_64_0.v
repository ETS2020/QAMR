...
module FAU ( 
  ...
  nand2  g14(.a(new_n39_), .b(new_n32_), .O(new_n40_));
  nand3  g15(.a(new_n29_), .b(x04), .c(x02), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand3  g17(.a(new_n42_), .b(new_n38_), .c(new_n35_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(z01));
  inv1   g19(.a(x00), .O(new_n45_));
  inv1   g20(.a(x01), .O(new_n46_));
  nand4  g21(.a(new_n35_), .b(new_n32_), .c(new_n46_), .d(new_n45_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x11), .c(x05), .d(new_n28_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z02));
  nand2  g25(.a(new_n39_), .b(new_n35_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n32_), .c(new_n46_), .d(x00), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(x11), .c(x13), .O(z03));
  nor2   g29(.a(x02), .b(new_n46_), .O(new_n55_));
  nand3  g30(.a(new_n55_), .b(new_n52_), .c(new_n45_), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(x11), .c(x13), .O(z04));
  nand3  g32(.a(new_n55_), .b(new_n52_), .c(x00), .O(new_n58_));
  aoi21  g33(.a(new_n58_), .b(x11), .c(x13), .O(z05));
  ...
  nand4  g49(.a(new_n74_), .b(x11), .c(x05), .d(new_n28_), .O(new_n75_));
  aoi21  g50(.a(new_n75_), .b(x11), .c(x13), .O(z07));
  inv1   g51(.a(new_n26_), .O(new_n77_));
  nand4  g52(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n78_));
  ...
  nand2  g57(.a(new_n82_), .b(new_n77_), .O(z09));
  nand3  g58(.a(new_n31_), .b(x06), .c(new_n35_), .O(new_n84_));
  nand2  g59(.a(new_n84_), .b(new_n77_), .O(z10));
endmodule
