...
module FAU ( 
  ...
  nand4  g20(.a(new_n27_), .b(x05), .c(new_n31_), .d(new_n40_), .O(new_n46_));
  ...
  nand4  g26(.a(new_n51_), .b(x05), .c(new_n31_), .d(new_n40_), .O(new_n52_));
  nor2   g27(.a(new_n52_), .b(x13), .O(z05));
  inv1   g28(.a(x12), .O(new_n54_));
  nor2   g29(.a(x09), .b(x01), .O(new_n55_));
  nor2   g30(.a(x11), .b(new_n44_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(x00), .O(new_n57_));
  nor2   g32(.a(x08), .b(x01), .O(new_n58_));
  nor2   g33(.a(x10), .b(new_n44_), .O(new_n59_));
  oai21  g34(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(new_n60_));
  aoi21  g35(.a(new_n60_), .b(new_n57_), .c(new_n27_), .O(new_n61_));
  nand4  g36(.a(new_n61_), .b(new_n54_), .c(new_n26_), .d(x05), .O(new_n62_));
  nand3  g37(.a(new_n27_), .b(new_n32_), .c(x02), .O(new_n63_));
  oai21  g38(.a(new_n62_), .b(x02), .c(new_n63_), .O(new_n64_));
  nand3  g39(.a(new_n64_), .b(x04), .c(new_n40_), .O(new_n65_));
  inv1   g40(.a(new_n65_), .O(z06));
  nand4  g41(.a(new_n27_), .b(x05), .c(new_n31_), .d(new_n40_), .O(new_n67_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n36_), .O(z07));
  nand2  g43(.a(x05), .b(new_n29_), .O(new_n69_));
  nand3  g44(.a(x13), .b(new_n54_), .c(new_n26_), .O(new_n70_));
  ...
  aoi21  g49(.a(new_n26_), .b(new_n74_), .c(new_n27_), .O(z09));
  inv1   g50(.a(new_n33_), .O(new_n76_));
  nand3  g51(.a(new_n76_), .b(x06), .c(new_n40_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n36_), .O(z10));
endmodule
