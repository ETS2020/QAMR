...
module FAU ( 
  ...
  nand4  g11(.a(new_n36_), .b(x05), .c(new_n30_), .d(new_n28_), .O(new_n37_));
  nand4  g12(.a(new_n36_), .b(new_n31_), .c(x04), .d(x02), .O(new_n38_));
  aoi21  g13(.a(new_n38_), .b(new_n37_), .c(x03), .O(z01));
  inv1   g14(.a(x00), .O(new_n40_));
  inv1   g15(.a(x01), .O(new_n41_));
  inv1   g16(.a(x03), .O(new_n42_));
  nand4  g17(.a(new_n26_), .b(x05), .c(new_n30_), .d(new_n42_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(new_n28_), .c(new_n41_), .d(new_n40_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(new_n26_), .c(x13), .O(z02));
  nand4  g21(.a(new_n42_), .b(new_n28_), .c(new_n41_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(new_n42_), .b(new_n28_), .c(x01), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n26_), .c(x05), .d(new_n30_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n44_), .b(new_n28_), .c(x01), .d(x00), .O(new_n55_));
  ...
  nor2   g36(.a(x10), .b(new_n41_), .O(new_n62_));
  oai21  g37(.a(new_n62_), .b(new_n61_), .c(new_n40_), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n60_), .c(new_n35_), .O(new_n64_));
  nand4  g39(.a(new_n64_), .b(new_n57_), .c(x05), .d(new_n28_), .O(new_n65_));
  nand3  g40(.a(new_n35_), .b(new_n31_), .c(x02), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n26_), .c(x04), .d(new_n42_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z06));
  nor2   g44(.a(x13), .b(x07), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n30_), .d(new_n42_), .O(new_n71_));
  nor2   g46(.a(new_n71_), .b(x02), .O(z07));
  nand4  g47(.a(x13), .b(new_n57_), .c(x05), .d(new_n28_), .O(new_n73_));
  nand3  g48(.a(new_n70_), .b(new_n31_), .c(x02), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n42_), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z08));
  inv1   g52(.a(new_n27_), .O(new_n78_));
  nand2  g53(.a(x13), .b(x06), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(z09));
  inv1   g55(.a(new_n32_), .O(new_n81_));
  nand3  g56(.a(new_n81_), .b(x06), .c(new_n42_), .O(new_n82_));
  nand2  g57(.a(new_n82_), .b(new_n78_), .O(z10));
endmodule
