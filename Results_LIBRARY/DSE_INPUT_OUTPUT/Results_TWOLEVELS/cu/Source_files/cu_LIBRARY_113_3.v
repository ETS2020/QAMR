...
module FAU ( 
  ...
  nand4  g10(.a(new_n35_), .b(new_n31_), .c(new_n29_), .d(new_n28_), .O(z00));
  inv1   g11(.a(x03), .O(new_n37_));
  nand3  g12(.a(x05), .b(new_n26_), .c(new_n30_), .O(new_n38_));
  ...
  nand3  g17(.a(new_n30_), .b(new_n33_), .c(new_n32_), .O(new_n43_));
  inv1   g18(.a(x13), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n26_), .d(new_n37_), .O(new_n45_));
  ...
  aoi21  g26(.a(new_n48_), .b(new_n32_), .c(new_n33_), .O(z04));
  nand3  g27(.a(new_n47_), .b(x05), .c(x04), .O(new_n53_));
  ...
  nand3  g40(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n66_));
  ...
  aoi21  g44(.a(new_n33_), .b(x00), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n37_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(x02), .c(new_n50_), .O(z07));
  ...
  nand3  g51(.a(new_n35_), .b(x13), .c(x06), .O(new_n77_));
  inv1   g52(.a(new_n77_), .O(z09));
  nand3  g53(.a(new_n29_), .b(x06), .c(new_n37_), .O(new_n79_));
