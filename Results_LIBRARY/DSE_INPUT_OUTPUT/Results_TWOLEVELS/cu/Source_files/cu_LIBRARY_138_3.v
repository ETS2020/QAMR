...
module FAU ( 
  ...
  nor2   g12(.a(new_n32_), .b(x04), .O(new_n38_));
  ...
  nand4  g23(.a(new_n36_), .b(new_n29_), .c(new_n26_), .d(x00), .O(new_n49_));
  inv1   g24(.a(new_n49_), .O(new_n50_));
  nand4  g25(.a(new_n50_), .b(new_n46_), .c(x05), .d(new_n31_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(z03));
  nand4  g27(.a(new_n36_), .b(new_n29_), .c(x01), .d(new_n44_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n27_), .c(x05), .d(new_n31_), .O(new_n55_));
  nor2   g30(.a(new_n55_), .b(x13), .O(z04));
  nor2   g31(.a(x03), .b(x02), .O(new_n57_));
  nor2   g32(.a(x13), .b(x07), .O(new_n58_));
  nand4  g33(.a(new_n58_), .b(new_n57_), .c(new_n38_), .d(x00), .O(new_n59_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n46_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n61_), .c(x05), .d(new_n29_), .O(new_n69_));
  nand3  g44(.a(new_n46_), .b(new_n32_), .c(x02), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n69_), .c(x07), .O(new_n71_));
  nand4  g46(.a(new_n46_), .b(new_n32_), .c(x02), .d(new_n26_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(new_n71_), .c(x04), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x03), .O(z06));
  aoi21  g50(.a(x07), .b(x01), .c(x13), .O(new_n76_));
