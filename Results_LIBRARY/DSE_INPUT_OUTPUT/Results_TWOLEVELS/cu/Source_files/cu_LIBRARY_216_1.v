...
module FAU ( 
  ...
  aoi21  g20(.a(new_n45_), .b(new_n42_), .c(x01), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x00), .O(z02));
  nand4  g22(.a(new_n36_), .b(new_n30_), .c(new_n32_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n43_), .c(x05), .d(new_n26_), .O(new_n50_));
  ...
  oai21  g34(.a(new_n60_), .b(new_n56_), .c(new_n32_), .O(new_n61_));
  nand2  g35(.a(new_n61_), .b(new_n53_), .O(new_n62_));
  inv1   g36(.a(x09), .O(new_n63_));
  nand3  g37(.a(new_n63_), .b(new_n32_), .c(x00), .O(new_n64_));
  inv1   g38(.a(x11), .O(new_n65_));
  ...
  aoi21  g46(.a(x01), .b(new_n53_), .c(x13), .O(new_n73_));
