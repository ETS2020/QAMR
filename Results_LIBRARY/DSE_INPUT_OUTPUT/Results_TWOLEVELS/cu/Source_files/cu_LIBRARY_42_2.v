...
module FAU ( 
  ...
  nand3  g21(.a(new_n35_), .b(new_n26_), .c(x00), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n34_), .O(z03));
  nor3   g23(.a(x03), .b(x02), .c(x00), .O(new_n49_));
  nand3  g24(.a(new_n49_), .b(new_n44_), .c(new_n28_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x10), .c(new_n26_), .O(z04));
  nand4  g26(.a(new_n33_), .b(new_n35_), .c(x01), .d(x00), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x10), .c(x05), .d(new_n28_), .O(new_n54_));
  ...
  nand3  g45(.a(new_n70_), .b(x01), .c(x00), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(new_n58_), .c(x05), .d(new_n28_), .O(new_n72_));
  inv1   g47(.a(new_n72_), .O(new_n73_));
  nand3  g48(.a(new_n73_), .b(new_n33_), .c(new_n35_), .O(new_n74_));
  nand2  g49(.a(new_n74_), .b(new_n34_), .O(z07));
  nand4  g50(.a(x13), .b(new_n57_), .c(x05), .d(new_n35_), .O(new_n76_));
  ...
  nand4  g57(.a(new_n82_), .b(new_n34_), .c(x06), .d(new_n33_), .O(new_n83_));
