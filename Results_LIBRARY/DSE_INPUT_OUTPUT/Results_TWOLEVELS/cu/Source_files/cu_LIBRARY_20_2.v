...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n47_), .O(new_n48_));
  inv1   g22(.a(new_n48_), .O(new_n49_));
  nand4  g23(.a(new_n49_), .b(new_n46_), .c(x05), .d(new_n29_), .O(new_n50_));
  inv1   g24(.a(new_n50_), .O(z04));
  nor2   g25(.a(x03), .b(x02), .O(new_n52_));
  nor2   g26(.a(x13), .b(new_n37_), .O(new_n53_));
  nand4  g27(.a(new_n53_), .b(new_n52_), .c(new_n29_), .d(x01), .O(new_n54_));
  aoi21  g28(.a(new_n54_), .b(x01), .c(new_n47_), .O(z05));
  nand4  g29(.a(new_n27_), .b(new_n46_), .c(new_n37_), .d(x02), .O(new_n56_));
  inv1   g30(.a(x07), .O(new_n57_));
  inv1   g31(.a(x12), .O(new_n58_));
  nor2   g32(.a(x08), .b(x01), .O(new_n59_));
  nor2   g33(.a(x10), .b(new_n26_), .O(new_n60_));
  oai21  g34(.a(new_n60_), .b(new_n59_), .c(new_n47_), .O(new_n61_));
  ...
  aoi21  g42(.a(new_n26_), .b(x00), .c(x13), .O(new_n69_));
  ...
  nor3   g50(.a(new_n28_), .b(new_n46_), .c(new_n76_), .O(z09));
