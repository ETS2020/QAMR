...
module FAU ( 
  ...
  nand3  g20(.a(new_n34_), .b(new_n26_), .c(new_n45_), .O(new_n46_));
  inv1   g21(.a(x13), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n38_), .O(z02));
  nand3  g24(.a(new_n34_), .b(new_n26_), .c(x00), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n48_), .c(new_n38_), .O(z03));
  nor3   g26(.a(x03), .b(x02), .c(x00), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n39_), .c(new_n47_), .d(new_n27_), .O(new_n53_));
  aoi21  g28(.a(new_n53_), .b(new_n27_), .c(new_n26_), .O(z04));
  nand4  g29(.a(new_n37_), .b(new_n34_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n27_), .c(x05), .d(new_n30_), .O(new_n57_));
  ...
  nand4  g48(.a(new_n73_), .b(x05), .c(new_n30_), .d(new_n37_), .O(new_n74_));
  nor2   g49(.a(new_n74_), .b(x02), .O(z07));
  nand4  g50(.a(x13), .b(new_n60_), .c(x05), .d(new_n34_), .O(new_n76_));
  ...
  nand4  g56(.a(new_n33_), .b(x06), .c(new_n37_), .d(new_n26_), .O(new_n82_));
