...
module FAU ( 
  ...
  nand4  g20(.a(new_n33_), .b(new_n35_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(x06), .c(x05), .d(new_n28_), .O(new_n48_));
  nor2   g23(.a(new_n48_), .b(x13), .O(z03));
  inv1   g24(.a(x13), .O(new_n50_));
  nand4  g25(.a(new_n33_), .b(new_n35_), .c(x01), .d(new_n26_), .O(new_n51_));
  ...
  nor2   g30(.a(x13), .b(new_n37_), .O(new_n56_));
  ...
  aoi21  g41(.a(new_n66_), .b(new_n63_), .c(new_n50_), .O(new_n67_));
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n68_));
  nand3  g43(.a(new_n50_), .b(new_n37_), .c(x02), .O(new_n69_));
  ...
  nor2   g47(.a(x06), .b(x01), .O(new_n73_));
