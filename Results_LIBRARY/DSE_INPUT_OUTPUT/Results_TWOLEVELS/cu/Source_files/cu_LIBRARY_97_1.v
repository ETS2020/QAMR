...
module FAU ( 
  ...
  nand4  g16(.a(new_n41_), .b(new_n26_), .c(new_n35_), .d(new_n30_), .O(new_n42_));
  nor3   g17(.a(new_n42_), .b(x13), .c(new_n27_), .O(z02));
  inv1   g18(.a(x13), .O(new_n44_));
  inv1   g19(.a(x01), .O(new_n45_));
  nand4  g20(.a(new_n35_), .b(new_n30_), .c(new_n45_), .d(x00), .O(new_n46_));
  inv1   g21(.a(new_n46_), .O(new_n47_));
  nand4  g22(.a(new_n47_), .b(new_n44_), .c(x05), .d(new_n26_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(z03));
  nor3   g24(.a(x02), .b(new_n45_), .c(new_n32_), .O(new_n51_));
  nand4  g25(.a(new_n51_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n52_));
  nor2   g26(.a(new_n52_), .b(x13), .O(z05));
  nand4  g27(.a(new_n33_), .b(new_n44_), .c(new_n27_), .d(x02), .O(new_n54_));
  ...
  nand3  g34(.a(new_n60_), .b(new_n45_), .c(new_n32_), .O(new_n61_));
  ...
  aoi21  g40(.a(x01), .b(new_n32_), .c(x13), .O(new_n67_));
  nand4  g41(.a(new_n67_), .b(x05), .c(new_n26_), .d(new_n35_), .O(new_n68_));
  nor2   g42(.a(new_n68_), .b(x02), .O(z07));
  nand4  g43(.a(x13), .b(new_n56_), .c(x05), .d(new_n30_), .O(new_n70_));
  nand3  g44(.a(new_n44_), .b(new_n27_), .c(x02), .O(new_n71_));
  nand2  g45(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(new_n33_), .c(x04), .d(new_n35_), .O(new_n73_));
  inv1   g47(.a(new_n73_), .O(z08));
  inv1   g48(.a(x06), .O(new_n75_));
  nand2  g49(.a(new_n33_), .b(x13), .O(new_n76_));
  nor2   g50(.a(new_n76_), .b(new_n75_), .O(z09));
  nand3  g51(.a(new_n29_), .b(x06), .c(new_n35_), .O(new_n78_));
  nand2  g52(.a(new_n78_), .b(new_n33_), .O(z10));
  zero   g53(.O(z04));
endmodule
