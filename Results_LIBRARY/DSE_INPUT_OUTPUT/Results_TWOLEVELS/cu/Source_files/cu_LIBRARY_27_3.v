...
module FAU ( 
  ...
  nand2  g16(.a(new_n41_), .b(new_n26_), .O(z01));
  ...
  nand3  g20(.a(new_n37_), .b(new_n28_), .c(x00), .O(new_n46_));
  ...
  nand4  g25(.a(new_n36_), .b(new_n37_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n47_), .c(x05), .d(new_n29_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(z04));
  nand3  g29(.a(new_n47_), .b(x05), .c(new_n29_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n36_), .c(new_n37_), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n29_), .c(new_n28_), .O(z05));
