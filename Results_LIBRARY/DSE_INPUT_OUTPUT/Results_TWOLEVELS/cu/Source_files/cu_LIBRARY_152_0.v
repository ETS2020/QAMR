...
module FAU ( 
  ...
  nand4  g17(.a(new_n42_), .b(new_n33_), .c(new_n41_), .d(new_n40_), .O(new_n43_));
  inv1   g18(.a(new_n43_), .O(new_n44_));
  nand4  g19(.a(new_n44_), .b(x06), .c(x05), .d(new_n29_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  nand4  g21(.a(new_n42_), .b(new_n33_), .c(new_n41_), .d(x00), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(x06), .c(x05), .d(new_n29_), .O(new_n49_));
  nor2   g24(.a(new_n49_), .b(x13), .O(z03));
  nand4  g25(.a(new_n42_), .b(new_n33_), .c(x01), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x06), .c(x05), .d(new_n29_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(x06), .b(x05), .c(new_n29_), .d(new_n42_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n33_), .c(x01), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(x06), .c(x13), .O(z05));
  nand2  g33(.a(new_n27_), .b(new_n26_), .O(new_n59_));
  ...
  aoi21  g42(.a(new_n67_), .b(new_n64_), .c(new_n27_), .O(new_n68_));
  nand4  g43(.a(new_n68_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n69_));
  nor2   g44(.a(x13), .b(new_n26_), .O(new_n70_));
  nand3  g45(.a(new_n70_), .b(new_n30_), .c(x02), .O(new_n71_));
  ...
  nand3  g49(.a(new_n70_), .b(x05), .c(new_n29_), .O(new_n75_));
  nor3   g50(.a(new_n75_), .b(x03), .c(x02), .O(z07));
  nand4  g51(.a(x13), .b(new_n61_), .c(x05), .d(new_n33_), .O(new_n77_));
  nand2  g52(.a(new_n77_), .b(new_n71_), .O(new_n78_));
  nand3  g53(.a(new_n78_), .b(x04), .c(new_n42_), .O(new_n79_));
  inv1   g54(.a(new_n79_), .O(z08));
  nor2   g55(.a(new_n27_), .b(new_n26_), .O(z09));
  nand3  g56(.a(new_n32_), .b(x06), .c(new_n42_), .O(new_n82_));
