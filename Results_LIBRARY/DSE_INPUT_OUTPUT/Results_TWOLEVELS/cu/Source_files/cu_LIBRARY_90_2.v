...
module FAU ( 
  ...
  nand4  g20(.a(new_n34_), .b(new_n35_), .c(x01), .d(new_n26_), .O(new_n47_));
  inv1   g21(.a(new_n47_), .O(new_n48_));
  nand4  g22(.a(new_n48_), .b(new_n42_), .c(x05), .d(new_n28_), .O(new_n49_));
  inv1   g23(.a(new_n49_), .O(z04));
  inv1   g24(.a(x01), .O(new_n51_));
  nor3   g25(.a(x02), .b(new_n51_), .c(new_n26_), .O(new_n52_));
  nand4  g26(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n53_));
  nor2   g27(.a(new_n53_), .b(x13), .O(z05));
  nand4  g28(.a(x05), .b(x04), .c(new_n34_), .d(new_n35_), .O(new_n55_));
  ...
  nand2  g36(.a(new_n62_), .b(new_n51_), .O(new_n63_));
  inv1   g37(.a(x10), .O(new_n64_));
  nand3  g38(.a(new_n64_), .b(x01), .c(new_n26_), .O(new_n65_));
  aoi21  g39(.a(new_n65_), .b(new_n63_), .c(new_n42_), .O(new_n66_));
  nand4  g40(.a(new_n66_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n67_));
  nand3  g41(.a(new_n42_), .b(new_n37_), .c(x02), .O(new_n68_));
  oai21  g42(.a(new_n67_), .b(x02), .c(new_n68_), .O(new_n69_));
  nand3  g43(.a(new_n69_), .b(x04), .c(new_n34_), .O(new_n70_));
  nand2  g44(.a(new_n70_), .b(new_n61_), .O(z06));
  aoi21  g45(.a(new_n51_), .b(x00), .c(x13), .O(new_n72_));
  nand4  g46(.a(new_n72_), .b(x05), .c(new_n28_), .d(new_n34_), .O(new_n73_));
  nor2   g47(.a(new_n73_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n58_), .c(x05), .d(new_n35_), .O(new_n75_));
  ...
  nor3   g53(.a(new_n27_), .b(new_n42_), .c(new_n79_), .O(z09));
  nand2  g54(.a(x05), .b(x02), .O(new_n81_));
  nand3  g55(.a(new_n81_), .b(x06), .c(new_n34_), .O(new_n82_));
