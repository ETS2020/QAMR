...
module FAU ( 
  ...
  oai21  g10(.a(new_n35_), .b(new_n34_), .c(x13), .O(new_n36_));
  ...
  nand3  g14(.a(new_n39_), .b(x04), .c(x02), .O(new_n40_));
  nand2  g15(.a(new_n40_), .b(new_n37_), .O(new_n41_));
  nand2  g16(.a(new_n41_), .b(new_n26_), .O(new_n42_));
  nand2  g17(.a(x13), .b(x05), .O(new_n43_));
  nand2  g18(.a(new_n43_), .b(new_n42_), .O(z01));
  ...
  nand4  g22(.a(new_n26_), .b(new_n28_), .c(new_n35_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n38_), .c(x05), .d(new_n30_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  nand4  g26(.a(new_n26_), .b(new_n28_), .c(x01), .d(new_n34_), .O(new_n52_));
  inv1   g27(.a(new_n52_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(new_n38_), .c(x05), .d(new_n30_), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(z04));
  nor2   g30(.a(x04), .b(x03), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n28_), .c(x01), .d(x00), .O(new_n57_));
  aoi21  g32(.a(new_n57_), .b(new_n38_), .c(new_n31_), .O(z05));
  nand4  g33(.a(new_n31_), .b(x04), .c(new_n26_), .d(x02), .O(new_n59_));
  nor2   g34(.a(new_n59_), .b(x13), .O(z06));
  nand4  g35(.a(new_n36_), .b(new_n30_), .c(new_n26_), .d(new_n28_), .O(new_n61_));
  aoi21  g36(.a(new_n61_), .b(new_n38_), .c(new_n31_), .O(z07));
  inv1   g37(.a(x06), .O(new_n63_));
  aoi21  g38(.a(new_n63_), .b(new_n31_), .c(new_n38_), .O(z09));
  nand2  g39(.a(x05), .b(x02), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x06), .c(new_n26_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n43_), .O(z10));
  nor2   g42(.a(new_n59_), .b(x13), .O(z08));
endmodule
