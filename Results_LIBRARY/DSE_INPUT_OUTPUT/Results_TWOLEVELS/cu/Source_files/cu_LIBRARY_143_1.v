...
module FAU ( 
  ...
  nand2  g09(.a(x11), .b(new_n26_), .O(new_n35_));
  ...
  nand4  g21(.a(new_n46_), .b(new_n36_), .c(new_n32_), .d(new_n43_), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(new_n42_), .c(x01), .O(z02));
  nand4  g23(.a(new_n46_), .b(new_n36_), .c(new_n32_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(new_n42_), .c(x01), .O(z03));
  nand4  g25(.a(new_n36_), .b(new_n32_), .c(x01), .d(new_n43_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n44_), .b(x05), .c(new_n28_), .d(new_n36_), .O(new_n56_));
  oai21  g31(.a(new_n56_), .b(new_n55_), .c(new_n35_), .O(z05));
  inv1   g32(.a(x07), .O(new_n58_));
  inv1   g33(.a(x12), .O(new_n59_));
  aoi21  g34(.a(x09), .b(new_n26_), .c(new_n43_), .O(new_n60_));
  ...
  nand4  g41(.a(new_n35_), .b(new_n44_), .c(new_n29_), .d(x02), .O(new_n67_));
  ...
  nand3  g45(.a(new_n46_), .b(new_n36_), .c(new_n32_), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n35_), .O(z07));
