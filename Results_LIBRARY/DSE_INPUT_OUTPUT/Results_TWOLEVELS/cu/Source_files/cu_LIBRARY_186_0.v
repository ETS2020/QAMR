...
module FAU ( 
  ...
  nor3   g26(.a(x02), .b(new_n27_), .c(new_n48_), .O(new_n52_));
  ...
  nand3  g45(.a(new_n41_), .b(new_n29_), .c(x02), .O(new_n71_));
  nand2  g46(.a(new_n71_), .b(new_n70_), .O(new_n72_));
  nand3  g47(.a(new_n72_), .b(x04), .c(new_n26_), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n47_), .O(z06));
  nor3   g49(.a(new_n42_), .b(x03), .c(x02), .O(z07));
  nand2  g50(.a(x05), .b(new_n31_), .O(new_n76_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n47_), .O(z08));
  inv1   g55(.a(x06), .O(new_n81_));
  nor3   g56(.a(new_n46_), .b(new_n41_), .c(new_n81_), .O(z09));
  oai21  g57(.a(x05), .b(new_n27_), .c(new_n76_), .O(new_n83_));
