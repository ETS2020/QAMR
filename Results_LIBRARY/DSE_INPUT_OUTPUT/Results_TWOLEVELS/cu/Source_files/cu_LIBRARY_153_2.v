...
module FAU ( 
  ...
  nand2  g12(.a(new_n28_), .b(x01), .O(new_n38_));
  ...
  nand3  g22(.a(new_n43_), .b(x05), .c(new_n27_), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n26_), .c(new_n30_), .d(new_n40_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(x05), .c(new_n41_), .O(z04));
  nor3   g26(.a(x02), .b(new_n41_), .c(new_n40_), .O(new_n52_));
  ...
  nand4  g39(.a(new_n43_), .b(new_n28_), .c(x02), .d(new_n41_), .O(new_n65_));
  ...
  nor3   g43(.a(new_n48_), .b(x03), .c(x02), .O(z07));
  ...
  oai21  g51(.a(x05), .b(x01), .c(new_n70_), .O(new_n77_));
