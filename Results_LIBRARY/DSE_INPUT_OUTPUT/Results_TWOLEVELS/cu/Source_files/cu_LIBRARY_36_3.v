...
module FAU ( 
  ...
  nand3  g28(.a(new_n53_), .b(new_n44_), .c(new_n28_), .O(new_n54_));
  aoi21  g29(.a(new_n54_), .b(new_n52_), .c(new_n42_), .O(z04));
  ...
  nand3  g47(.a(x11), .b(x01), .c(x00), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n47_), .c(x05), .d(new_n28_), .O(new_n74_));
  inv1   g49(.a(new_n74_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(new_n33_), .c(new_n34_), .O(new_n76_));
  nand2  g51(.a(new_n76_), .b(new_n26_), .O(z07));
  nand4  g52(.a(x13), .b(new_n61_), .c(x05), .d(new_n34_), .O(new_n78_));
  nand3  g53(.a(new_n47_), .b(new_n36_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n26_), .c(x04), .d(new_n33_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  nand2  g57(.a(x13), .b(x06), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n26_), .O(z09));
  nand2  g59(.a(x05), .b(x02), .O(new_n85_));
  nand4  g60(.a(new_n85_), .b(new_n26_), .c(x06), .d(new_n33_), .O(new_n86_));
