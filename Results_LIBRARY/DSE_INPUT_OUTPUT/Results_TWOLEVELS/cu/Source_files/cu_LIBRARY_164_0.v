...
module FAU ( 
  ...
  nand3  g12(.a(new_n37_), .b(new_n36_), .c(x11), .O(new_n38_));
  ...
  nand4  g18(.a(new_n43_), .b(x11), .c(x05), .d(new_n30_), .O(new_n44_));
  nor2   g19(.a(new_n44_), .b(x13), .O(z02));
  inv1   g20(.a(x13), .O(new_n46_));
  nand3  g21(.a(new_n46_), .b(x05), .c(new_n30_), .O(new_n47_));
  inv1   g22(.a(new_n47_), .O(new_n48_));
  nand4  g23(.a(new_n48_), .b(new_n27_), .c(new_n41_), .d(x00), .O(new_n49_));
  aoi21  g24(.a(new_n49_), .b(x11), .c(x03), .O(z03));
  nand4  g25(.a(new_n26_), .b(new_n27_), .c(x01), .d(new_n40_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(x11), .c(x05), .d(new_n30_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n48_), .b(new_n27_), .c(x01), .d(x00), .O(new_n55_));
  aoi21  g30(.a(new_n55_), .b(x11), .c(x03), .O(z05));
  ...
  nand3  g37(.a(new_n62_), .b(new_n41_), .c(x00), .O(new_n63_));
  ...
  nand4  g42(.a(new_n67_), .b(x11), .c(x04), .d(new_n26_), .O(new_n68_));
  inv1   g43(.a(new_n68_), .O(z06));
  inv1   g44(.a(x11), .O(new_n70_));
  aoi21  g45(.a(new_n70_), .b(new_n40_), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n30_), .d(new_n27_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(x11), .c(x03), .O(z07));
  ...
  oai21  g53(.a(x11), .b(x03), .c(x13), .O(new_n79_));
  nor2   g54(.a(new_n79_), .b(new_n78_), .O(z09));
  nand2  g55(.a(new_n29_), .b(x06), .O(new_n81_));
  aoi21  g56(.a(new_n81_), .b(x11), .c(x03), .O(z10));
endmodule
