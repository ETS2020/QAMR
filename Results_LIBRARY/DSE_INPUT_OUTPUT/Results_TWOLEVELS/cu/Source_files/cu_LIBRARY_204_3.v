...
module FAU ( 
  ...
  nand2  g09(.a(x08), .b(x01), .O(new_n35_));
  ...
  nand4  g21(.a(new_n46_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n47_));
  oai21  g22(.a(new_n47_), .b(new_n45_), .c(new_n35_), .O(z03));
  inv1   g23(.a(x08), .O(new_n49_));
  inv1   g24(.a(x00), .O(new_n50_));
  nand4  g25(.a(new_n34_), .b(new_n31_), .c(x01), .d(new_n50_), .O(new_n51_));
  inv1   g26(.a(new_n51_), .O(new_n52_));
  nand4  g27(.a(new_n52_), .b(new_n49_), .c(x05), .d(new_n27_), .O(new_n53_));
  nor2   g28(.a(new_n53_), .b(x13), .O(z04));
  nand4  g29(.a(new_n34_), .b(new_n31_), .c(x01), .d(x00), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(new_n56_));
  nand4  g31(.a(new_n56_), .b(new_n49_), .c(x05), .d(new_n27_), .O(new_n57_));
  ...
  nand3  g38(.a(new_n63_), .b(new_n49_), .c(x01), .O(new_n64_));
  nand2  g39(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g40(.a(new_n65_), .b(x00), .O(new_n66_));
  nand2  g41(.a(x10), .b(x01), .O(new_n67_));
  nand3  g42(.a(new_n67_), .b(new_n49_), .c(new_n50_), .O(new_n68_));
  aoi21  g43(.a(new_n68_), .b(new_n66_), .c(new_n46_), .O(new_n69_));
  nand4  g44(.a(new_n69_), .b(new_n60_), .c(new_n59_), .d(x05), .O(new_n70_));
  nand4  g45(.a(new_n35_), .b(new_n46_), .c(new_n28_), .d(x02), .O(new_n71_));
  ...
  aoi21  g49(.a(x08), .b(x01), .c(x13), .O(new_n75_));
  nand4  g50(.a(new_n75_), .b(x05), .c(new_n27_), .d(new_n34_), .O(new_n76_));
  nor2   g51(.a(new_n76_), .b(x02), .O(z07));
  nand4  g52(.a(x13), .b(new_n60_), .c(x05), .d(new_n31_), .O(new_n78_));
  nand3  g53(.a(new_n46_), .b(new_n28_), .c(x02), .O(new_n79_));
  nand2  g54(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand4  g55(.a(new_n80_), .b(new_n35_), .c(x04), .d(new_n34_), .O(new_n81_));
  inv1   g56(.a(new_n81_), .O(z08));
  nand3  g57(.a(new_n35_), .b(x13), .c(x06), .O(new_n83_));
  inv1   g58(.a(new_n83_), .O(z09));
  nand4  g59(.a(new_n30_), .b(new_n35_), .c(x06), .d(new_n34_), .O(new_n85_));
