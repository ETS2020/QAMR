...
module FAU ( 
  ...
  nand4  g15(.a(new_n40_), .b(new_n26_), .c(new_n34_), .d(new_n30_), .O(new_n41_));
  ...
  nand2  g24(.a(new_n34_), .b(new_n30_), .O(new_n50_));
  nand3  g25(.a(new_n43_), .b(x05), .c(new_n26_), .O(new_n51_));
  or2    g26(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n49_), .c(new_n44_), .O(z04));
  inv1   g28(.a(new_n32_), .O(z05));
  nand4  g29(.a(new_n32_), .b(new_n43_), .c(new_n27_), .d(x02), .O(new_n55_));
  ...
  aoi21  g37(.a(new_n62_), .b(new_n60_), .c(new_n43_), .O(new_n63_));
  ...
  oai21  g42(.a(new_n51_), .b(new_n50_), .c(new_n44_), .O(new_n68_));
  nand2  g43(.a(new_n68_), .b(x00), .O(new_n69_));
  aoi21  g44(.a(new_n44_), .b(x00), .c(x13), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(x05), .c(new_n26_), .d(new_n34_), .O(new_n71_));
  ...
  nand4  g53(.a(new_n32_), .b(new_n29_), .c(x06), .d(new_n34_), .O(new_n79_));
