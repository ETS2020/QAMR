...
module FAU ( 
  ...
  nand4  g40(.a(new_n34_), .b(new_n46_), .c(new_n28_), .d(x02), .O(new_n66_));
  ...
  nand3  g44(.a(new_n52_), .b(new_n35_), .c(new_n27_), .O(new_n70_));
  nand2  g45(.a(new_n70_), .b(new_n34_), .O(z07));
  nand4  g46(.a(x13), .b(new_n58_), .c(x05), .d(new_n27_), .O(new_n72_));
  nand3  g47(.a(new_n46_), .b(new_n28_), .c(x02), .O(new_n73_));
  nand2  g48(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand4  g49(.a(new_n74_), .b(new_n34_), .c(x04), .d(new_n35_), .O(new_n75_));
  inv1   g50(.a(new_n75_), .O(z08));
  nand3  g51(.a(new_n34_), .b(x13), .c(x06), .O(new_n77_));
