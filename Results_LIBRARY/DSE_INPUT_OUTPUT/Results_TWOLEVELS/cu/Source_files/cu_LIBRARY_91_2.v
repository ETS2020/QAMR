...
module FAU ( 
  ...
  nand2  g20(.a(new_n38_), .b(new_n36_), .O(new_n46_));
  ...
  nand2  g46(.a(new_n47_), .b(new_n33_), .O(new_n72_));
  ...
  nor2   g52(.a(new_n59_), .b(new_n26_), .O(z09));
  nand2  g53(.a(new_n32_), .b(new_n36_), .O(new_n79_));
  aoi21  g54(.a(new_n79_), .b(x13), .c(new_n26_), .O(z10));
endmodule
