...
module FAU ( 
  ...
  nand4  g15(.a(new_n40_), .b(new_n27_), .c(new_n26_), .d(new_n31_), .O(new_n41_));
  nor3   g16(.a(new_n41_), .b(x13), .c(new_n28_), .O(z02));
  ...
  nand4  g24(.a(new_n49_), .b(new_n43_), .c(x05), .d(new_n27_), .O(new_n50_));
  aoi21  g25(.a(new_n50_), .b(new_n26_), .c(new_n44_), .O(z04));
  inv1   g26(.a(x00), .O(new_n52_));
  nor3   g27(.a(x02), .b(new_n44_), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g44(.a(new_n44_), .b(x00), .c(x03), .O(new_n70_));
  nand4  g45(.a(new_n70_), .b(new_n43_), .c(x05), .d(new_n27_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(x02), .c(new_n38_), .O(z07));
