...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x12), .c(x05), .d(new_n33_), .O(new_n45_));
  ...
  nand4  g25(.a(new_n36_), .b(new_n29_), .c(x01), .d(new_n43_), .O(new_n51_));
  ...
  nand4  g30(.a(new_n55_), .b(x05), .c(new_n33_), .d(new_n36_), .O(new_n56_));
  nor2   g31(.a(new_n56_), .b(x13), .O(z05));
  nand4  g32(.a(new_n37_), .b(new_n44_), .c(new_n30_), .d(x02), .O(new_n58_));
  ...
  nand4  g39(.a(new_n64_), .b(new_n27_), .c(new_n59_), .d(x05), .O(new_n65_));
  ...
  nand4  g44(.a(new_n69_), .b(x05), .c(new_n33_), .d(new_n36_), .O(new_n70_));
  nor2   g45(.a(new_n70_), .b(x02), .O(z07));
  nand4  g46(.a(x13), .b(new_n27_), .c(x05), .d(new_n29_), .O(new_n72_));
  nand3  g47(.a(new_n44_), .b(new_n30_), .c(x02), .O(new_n73_));
  aoi21  g48(.a(new_n73_), .b(new_n72_), .c(new_n26_), .O(new_n74_));
  nand4  g49(.a(new_n44_), .b(x12), .c(new_n30_), .d(x02), .O(new_n75_));
  ...
  nand2  g54(.a(new_n79_), .b(new_n37_), .O(z09));
