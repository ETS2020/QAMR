...
module FAU ( 
  ...
  aoi21  g29(.a(new_n55_), .b(new_n53_), .c(new_n43_), .O(new_n56_));
  nand4  g30(.a(new_n56_), .b(new_n50_), .c(new_n49_), .d(x05), .O(new_n57_));
  nand3  g31(.a(new_n43_), .b(new_n27_), .c(x02), .O(new_n58_));
  oai21  g32(.a(new_n57_), .b(x02), .c(new_n58_), .O(new_n59_));
  nand4  g33(.a(new_n59_), .b(x04), .c(new_n35_), .d(new_n31_), .O(new_n60_));
  inv1   g34(.a(new_n60_), .O(z06));
  nand4  g35(.a(new_n43_), .b(x05), .c(new_n26_), .d(new_n30_), .O(new_n62_));
  aoi21  g36(.a(new_n62_), .b(new_n31_), .c(x03), .O(z07));
  nand4  g37(.a(x13), .b(new_n50_), .c(x05), .d(new_n30_), .O(new_n64_));
  nand4  g38(.a(new_n43_), .b(new_n27_), .c(x02), .d(new_n31_), .O(new_n65_));
  nand2  g39(.a(new_n65_), .b(new_n64_), .O(new_n66_));
  nand2  g40(.a(new_n66_), .b(x04), .O(new_n67_));
  aoi21  g41(.a(new_n67_), .b(new_n31_), .c(x03), .O(z08));
  inv1   g42(.a(x06), .O(new_n69_));
  nor3   g43(.a(z04), .b(new_n43_), .c(new_n69_), .O(z09));
  nand4  g44(.a(new_n29_), .b(x06), .c(new_n35_), .d(new_n31_), .O(new_n71_));
