...
module FAU ( 
  ...
  aoi21  g06(.a(x04), .b(new_n30_), .c(new_n31_), .O(new_n32_));
  ...
  nand3  g15(.a(new_n42_), .b(x05), .c(new_n26_), .O(new_n43_));
  inv1   g16(.a(new_n43_), .O(new_n44_));
  nand3  g17(.a(new_n44_), .b(new_n30_), .c(new_n41_), .O(new_n45_));
  aoi21  g18(.a(new_n45_), .b(x01), .c(x03), .O(z04));
  nand3  g19(.a(new_n44_), .b(new_n30_), .c(x00), .O(new_n47_));
  aoi21  g20(.a(new_n47_), .b(x01), .c(x03), .O(z05));
  ...
  aoi21  g27(.a(new_n54_), .b(new_n52_), .c(new_n42_), .O(new_n55_));
  nand4  g28(.a(new_n55_), .b(new_n50_), .c(new_n49_), .d(x05), .O(new_n56_));
  nand3  g29(.a(new_n42_), .b(new_n27_), .c(x02), .O(new_n57_));
  oai21  g30(.a(new_n56_), .b(x02), .c(new_n57_), .O(new_n58_));
  nand4  g31(.a(new_n58_), .b(x04), .c(new_n34_), .d(x01), .O(new_n59_));
  inv1   g32(.a(new_n59_), .O(z06));
  nand2  g33(.a(new_n44_), .b(new_n30_), .O(new_n61_));
  aoi21  g34(.a(new_n61_), .b(x01), .c(x03), .O(z07));
  nand4  g35(.a(x13), .b(new_n50_), .c(x05), .d(new_n30_), .O(new_n63_));
  nand4  g36(.a(new_n42_), .b(new_n27_), .c(x02), .d(x01), .O(new_n64_));
  nand2  g37(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g38(.a(new_n65_), .b(x04), .O(new_n66_));
  aoi21  g39(.a(new_n66_), .b(x01), .c(x03), .O(z08));
  inv1   g40(.a(x06), .O(new_n68_));
  nor3   g41(.a(new_n31_), .b(new_n42_), .c(new_n68_), .O(z09));
  nand4  g42(.a(new_n29_), .b(x06), .c(new_n34_), .d(x01), .O(new_n70_));
  inv1   g43(.a(new_n70_), .O(z10));
  zero   g44(.O(z02));
  zero   g45(.O(z03));
endmodule
