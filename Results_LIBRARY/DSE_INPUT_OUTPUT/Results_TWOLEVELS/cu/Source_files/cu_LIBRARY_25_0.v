...
module FAU ( 
  ...
  nand4  g18(.a(new_n43_), .b(x06), .c(x05), .d(new_n32_), .O(new_n44_));
  inv1   g19(.a(new_n44_), .O(new_n45_));
  nand4  g20(.a(new_n45_), .b(new_n35_), .c(new_n28_), .d(new_n42_), .O(new_n46_));
  aoi21  g21(.a(new_n46_), .b(x06), .c(x01), .O(z02));
  nand4  g22(.a(new_n45_), .b(new_n35_), .c(new_n28_), .d(x00), .O(new_n48_));
  aoi21  g23(.a(new_n48_), .b(x06), .c(x01), .O(z03));
  nand3  g24(.a(new_n28_), .b(x01), .c(new_n42_), .O(new_n50_));
  nand4  g25(.a(new_n43_), .b(x05), .c(new_n32_), .d(new_n35_), .O(new_n51_));
  oai21  g26(.a(new_n51_), .b(new_n50_), .c(new_n36_), .O(z04));
  inv1   g27(.a(x01), .O(new_n53_));
  nor3   g28(.a(x02), .b(new_n53_), .c(new_n42_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(x05), .c(new_n32_), .d(new_n35_), .O(new_n55_));
  ...
  aoi21  g46(.a(new_n71_), .b(new_n53_), .c(x13), .O(new_n72_));
  ...
  nor2   g53(.a(new_n43_), .b(new_n71_), .O(z09));
