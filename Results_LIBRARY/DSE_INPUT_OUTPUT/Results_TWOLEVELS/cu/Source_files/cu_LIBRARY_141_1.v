...
module FAU ( 
  ...
  nand4  g40(.a(new_n45_), .b(new_n37_), .c(x02), .d(new_n26_), .O(new_n66_));
  ...
  aoi21  g44(.a(x01), .b(new_n50_), .c(x13), .O(new_n70_));
