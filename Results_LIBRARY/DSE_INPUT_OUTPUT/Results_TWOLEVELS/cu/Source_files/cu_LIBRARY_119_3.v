...
module FAU ( 
  ...
  nand4  g26(.a(new_n34_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n52_));
  oai21  g27(.a(new_n52_), .b(new_n51_), .c(new_n40_), .O(z04));
  nand3  g28(.a(new_n27_), .b(x01), .c(x00), .O(new_n54_));
  oai21  g29(.a(new_n54_), .b(new_n52_), .c(new_n40_), .O(z05));
  nand3  g30(.a(new_n31_), .b(new_n26_), .c(x02), .O(new_n56_));
  aoi21  g31(.a(new_n56_), .b(new_n34_), .c(new_n30_), .O(z06));
  nand4  g32(.a(new_n34_), .b(x05), .c(new_n30_), .d(new_n26_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(x02), .c(new_n40_), .O(z07));
  nand3  g34(.a(x13), .b(x06), .c(new_n30_), .O(new_n60_));
  inv1   g35(.a(new_n60_), .O(z09));
  nand3  g36(.a(new_n29_), .b(x06), .c(new_n26_), .O(new_n62_));
  nand2  g37(.a(new_n62_), .b(new_n40_), .O(z10));
  aoi21  g38(.a(new_n56_), .b(new_n34_), .c(new_n30_), .O(z08));
endmodule
