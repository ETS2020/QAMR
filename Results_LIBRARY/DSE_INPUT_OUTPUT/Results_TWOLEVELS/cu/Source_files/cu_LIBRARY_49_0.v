...
module FAU ( 
  ...
  nand4  g29(.a(x05), .b(new_n28_), .c(new_n42_), .d(x00), .O(new_n55_));
  ...
  nand3  g41(.a(x10), .b(new_n66_), .c(new_n42_), .O(new_n67_));
  ...
  aoi21  g49(.a(new_n74_), .b(new_n69_), .c(new_n43_), .O(new_n75_));
  ...
  oai21  g59(.a(new_n43_), .b(new_n71_), .c(new_n35_), .O(z09));
