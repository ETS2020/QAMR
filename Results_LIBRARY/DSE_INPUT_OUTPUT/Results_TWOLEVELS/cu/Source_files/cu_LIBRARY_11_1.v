...
module FAU ( 
  ...
  nand4  g29(.a(x05), .b(new_n35_), .c(new_n47_), .d(new_n51_), .O(new_n55_));
  inv1   g30(.a(x07), .O(new_n56_));
  inv1   g31(.a(x08), .O(new_n57_));
  inv1   g32(.a(x12), .O(new_n58_));
  nand4  g33(.a(x13), .b(new_n58_), .c(new_n57_), .d(new_n56_), .O(new_n59_));
  nand3  g34(.a(new_n42_), .b(new_n37_), .c(x02), .O(new_n60_));
  oai21  g35(.a(new_n59_), .b(new_n55_), .c(new_n60_), .O(new_n61_));
  nand2  g36(.a(new_n61_), .b(new_n27_), .O(new_n62_));
  inv1   g37(.a(x09), .O(new_n63_));
  nand3  g38(.a(new_n63_), .b(new_n47_), .c(x00), .O(new_n64_));
  inv1   g39(.a(x10), .O(new_n65_));
  nand3  g40(.a(new_n65_), .b(x01), .c(new_n51_), .O(new_n66_));
  nand2  g41(.a(new_n66_), .b(new_n64_), .O(new_n67_));
  nand2  g42(.a(new_n67_), .b(x06), .O(new_n68_));
  inv1   g43(.a(x11), .O(new_n69_));
  nor2   g44(.a(x10), .b(new_n47_), .O(new_n70_));
  aoi21  g45(.a(x09), .b(new_n47_), .c(new_n51_), .O(new_n71_));
  oai21  g46(.a(new_n71_), .b(new_n70_), .c(new_n69_), .O(new_n72_));
  aoi21  g47(.a(new_n72_), .b(new_n68_), .c(new_n42_), .O(new_n73_));
  nand4  g48(.a(new_n73_), .b(new_n58_), .c(new_n56_), .d(x05), .O(new_n74_));
  oai21  g49(.a(new_n74_), .b(x02), .c(new_n62_), .O(new_n75_));
  nand3  g50(.a(new_n75_), .b(x04), .c(new_n34_), .O(new_n76_));
  inv1   g51(.a(new_n76_), .O(z06));
  inv1   g52(.a(new_n45_), .O(z07));
  nand2  g53(.a(x05), .b(new_n35_), .O(new_n79_));
  nand2  g54(.a(x13), .b(new_n58_), .O(new_n80_));
  nand4  g55(.a(new_n27_), .b(new_n42_), .c(new_n37_), .d(x02), .O(new_n81_));
  oai21  g56(.a(new_n80_), .b(new_n79_), .c(new_n81_), .O(new_n82_));
  nand3  g57(.a(new_n82_), .b(x04), .c(new_n34_), .O(new_n83_));
  nand2  g58(.a(new_n83_), .b(new_n27_), .O(z08));
  nor2   g59(.a(new_n42_), .b(new_n26_), .O(z09));
