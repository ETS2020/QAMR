...
module FAU ( 
  ...
  aoi21  g45(.a(x12), .b(x01), .c(x13), .O(new_n71_));
  nand4  g46(.a(new_n71_), .b(x05), .c(new_n31_), .d(new_n34_), .O(new_n72_));
  nor2   g47(.a(new_n72_), .b(x02), .O(z07));
  nand4  g48(.a(x13), .b(new_n49_), .c(x05), .d(new_n27_), .O(new_n74_));
