...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(x05), .c(new_n34_), .d(new_n38_), .O(new_n45_));
  nor2   g20(.a(new_n45_), .b(x13), .O(z02));
  inv1   g21(.a(x01), .O(new_n47_));
  nand4  g22(.a(new_n38_), .b(new_n30_), .c(new_n47_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(new_n27_), .c(x05), .d(new_n34_), .O(new_n50_));
  inv1   g25(.a(new_n50_), .O(z03));
  inv1   g26(.a(x00), .O(new_n52_));
  nand4  g27(.a(new_n38_), .b(new_n30_), .c(x01), .d(new_n52_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n27_), .c(x05), .d(new_n34_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nor3   g31(.a(x02), .b(new_n47_), .c(new_n52_), .O(new_n57_));
  nand4  g32(.a(new_n57_), .b(x05), .c(new_n34_), .d(new_n38_), .O(new_n58_));
  ...
  nand4  g42(.a(new_n67_), .b(new_n60_), .c(x05), .d(new_n30_), .O(new_n68_));
  nand3  g43(.a(new_n27_), .b(new_n31_), .c(x02), .O(new_n69_));
  ...
  nand4  g47(.a(new_n27_), .b(x05), .c(new_n34_), .d(new_n38_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n37_), .O(z07));
  ...
  nand3  g56(.a(new_n81_), .b(x06), .c(new_n38_), .O(new_n82_));
