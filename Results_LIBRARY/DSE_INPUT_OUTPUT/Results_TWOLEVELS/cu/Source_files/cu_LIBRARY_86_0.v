...
module FAU ( 
  ...
  nand4  g20(.a(new_n45_), .b(x12), .c(x05), .d(new_n28_), .O(new_n46_));
  nor2   g21(.a(new_n46_), .b(x13), .O(z02));
  nand4  g22(.a(new_n35_), .b(new_n32_), .c(new_n43_), .d(x00), .O(new_n48_));
  inv1   g23(.a(new_n48_), .O(new_n49_));
  nand4  g24(.a(new_n49_), .b(x12), .c(x05), .d(new_n28_), .O(new_n50_));
  nor2   g25(.a(new_n50_), .b(x13), .O(z03));
  inv1   g26(.a(x13), .O(new_n52_));
  nand4  g27(.a(new_n35_), .b(new_n32_), .c(x01), .d(new_n42_), .O(new_n53_));
  inv1   g28(.a(new_n53_), .O(new_n54_));
  nand4  g29(.a(new_n54_), .b(new_n52_), .c(x05), .d(new_n28_), .O(new_n55_));
  inv1   g30(.a(new_n55_), .O(z04));
  nand3  g31(.a(new_n32_), .b(x01), .c(x00), .O(new_n57_));
  nand4  g32(.a(new_n52_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n58_));
  oai21  g33(.a(new_n58_), .b(new_n57_), .c(new_n36_), .O(z05));
  ...
  aoi21  g40(.a(new_n65_), .b(new_n63_), .c(new_n52_), .O(new_n66_));
  nand4  g41(.a(new_n66_), .b(new_n61_), .c(new_n60_), .d(x05), .O(new_n67_));
  nand3  g42(.a(new_n52_), .b(new_n29_), .c(x02), .O(new_n68_));
  ...
  aoi21  g46(.a(new_n61_), .b(new_n43_), .c(x13), .O(new_n72_));
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n28_), .d(new_n35_), .O(new_n73_));
  oai21  g48(.a(new_n73_), .b(x02), .c(new_n36_), .O(z07));
  nand4  g49(.a(x13), .b(new_n61_), .c(x05), .d(new_n32_), .O(new_n75_));
  ...
  nor3   g54(.a(new_n26_), .b(new_n52_), .c(new_n79_), .O(z09));
  nand4  g55(.a(new_n31_), .b(new_n36_), .c(x06), .d(new_n35_), .O(new_n81_));
