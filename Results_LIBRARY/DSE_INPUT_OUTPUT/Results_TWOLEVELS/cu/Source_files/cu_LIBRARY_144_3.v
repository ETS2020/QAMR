...
module FAU ( 
  ...
  aoi21  g00(.a(x10), .b(x01), .c(x03), .O(new_n26_));
  ...
  nand2  g08(.a(x10), .b(x01), .O(new_n34_));
  ...
  nand4  g20(.a(new_n45_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n46_));
  oai21  g21(.a(new_n46_), .b(new_n44_), .c(new_n34_), .O(z02));
  nand3  g22(.a(new_n31_), .b(new_n43_), .c(x00), .O(new_n48_));
  oai21  g23(.a(new_n48_), .b(new_n46_), .c(new_n34_), .O(z03));
  inv1   g24(.a(x10), .O(new_n50_));
  nor3   g25(.a(x03), .b(x02), .c(x00), .O(new_n51_));
  nand4  g26(.a(new_n51_), .b(new_n36_), .c(new_n45_), .d(new_n50_), .O(new_n52_));
  aoi21  g27(.a(new_n52_), .b(new_n50_), .c(new_n43_), .O(z04));
  nand4  g28(.a(new_n35_), .b(new_n31_), .c(x01), .d(x00), .O(new_n54_));
  inv1   g29(.a(new_n54_), .O(new_n55_));
  nand4  g30(.a(new_n55_), .b(new_n50_), .c(x05), .d(new_n27_), .O(new_n56_));
  ...
  nand4  g42(.a(new_n34_), .b(new_n45_), .c(new_n28_), .d(x02), .O(new_n68_));
  ...
  nand4  g47(.a(new_n72_), .b(x05), .c(new_n27_), .d(new_n35_), .O(new_n73_));
  nor2   g48(.a(new_n73_), .b(x02), .O(z07));
  nand4  g49(.a(x13), .b(new_n59_), .c(x05), .d(new_n31_), .O(new_n75_));
  nand3  g50(.a(new_n45_), .b(new_n28_), .c(x02), .O(new_n76_));
  ...
  nand3  g56(.a(new_n30_), .b(x06), .c(new_n35_), .O(new_n82_));
