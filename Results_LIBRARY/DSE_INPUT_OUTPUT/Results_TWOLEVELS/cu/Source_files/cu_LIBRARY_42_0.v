...
module FAU ( 
  ...
  nand4  g19(.a(new_n44_), .b(new_n32_), .c(new_n34_), .d(new_n41_), .O(new_n45_));
  aoi21  g20(.a(new_n45_), .b(x10), .c(x01), .O(z02));
  nand4  g21(.a(new_n44_), .b(new_n32_), .c(new_n34_), .d(x00), .O(new_n47_));
  aoi21  g22(.a(new_n47_), .b(x10), .c(x01), .O(z03));
  nand3  g23(.a(new_n34_), .b(x01), .c(new_n41_), .O(new_n49_));
  nand4  g24(.a(new_n42_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n50_));
  oai21  g25(.a(new_n50_), .b(new_n49_), .c(new_n33_), .O(z04));
  inv1   g26(.a(x01), .O(new_n52_));
  nor3   g27(.a(x02), .b(new_n52_), .c(new_n41_), .O(new_n53_));
  nand4  g28(.a(new_n53_), .b(x05), .c(new_n27_), .d(new_n32_), .O(new_n54_));
  ...
  nand3  g43(.a(new_n44_), .b(new_n32_), .c(new_n34_), .O(new_n69_));
  nand2  g44(.a(new_n69_), .b(new_n33_), .O(z07));
  nand4  g45(.a(x13), .b(new_n57_), .c(x05), .d(new_n34_), .O(new_n71_));
  ...
  nand4  g52(.a(new_n77_), .b(new_n33_), .c(x06), .d(new_n32_), .O(new_n78_));
