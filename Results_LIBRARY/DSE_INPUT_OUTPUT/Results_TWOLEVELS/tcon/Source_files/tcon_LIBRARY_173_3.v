...
module FAU ( 
  ...
  nor2   g12(.a(new_n45_), .b(x10), .O(z06));
  and2   g13(.a(new_n35_), .b(x16), .O(z07));
  and2   g14(.a(x15), .b(x10), .O(new_n48_));
  ...
  oai21  g19(.a(x15), .b(new_n50_), .c(x10), .O(new_n53_));
  ...
  oai21  g34(.a(x10), .b(new_n50_), .c(x15), .O(new_n68_));
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z15));
endmodule
