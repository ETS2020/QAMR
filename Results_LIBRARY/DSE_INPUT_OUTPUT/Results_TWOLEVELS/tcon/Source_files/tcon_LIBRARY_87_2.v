...
module FAU ( 
  ...
  aoi21  g02(.a(new_n35_), .b(x11), .c(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(new_n35_), .b(x11), .O(new_n38_));
  nand2  g05(.a(new_n38_), .b(new_n37_), .O(z01));
  inv1   g06(.a(x12), .O(new_n40_));
  aoi21  g07(.a(new_n35_), .b(x11), .c(new_n40_), .O(z03));
  inv1   g08(.a(x14), .O(new_n42_));
  nand2  g09(.a(new_n38_), .b(new_n42_), .O(z05));
  inv1   g10(.a(x15), .O(new_n44_));
  aoi21  g11(.a(new_n35_), .b(x11), .c(new_n44_), .O(z06));
  inv1   g12(.a(x16), .O(new_n46_));
  aoi21  g13(.a(new_n35_), .b(x11), .c(new_n46_), .O(z07));
  ...
  nand2  g21(.a(x13), .b(x08), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(x11), .O(new_n56_));
