...
module FAU ( 
  ...
  aoi21  g07(.a(new_n35_), .b(x03), .c(new_n40_), .O(z03));
  inv1   g08(.a(x13), .O(new_n42_));
  nand2  g09(.a(new_n36_), .b(new_n42_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  inv1   g11(.a(x03), .O(new_n45_));
  nor2   g12(.a(x09), .b(new_n45_), .O(new_n46_));
  ...
  aoi21  g19(.a(x08), .b(new_n45_), .c(x09), .O(new_n53_));
  ...
  nand3  g30(.a(x12), .b(new_n54_), .c(new_n45_), .O(new_n64_));
  oai21  g31(.a(new_n63_), .b(new_n45_), .c(new_n64_), .O(z11));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n54_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z14));
