...
module FAU ( 
  ...
  nand2  g06(.a(x10), .b(new_n39_), .O(new_n40_));
  ...
  nand3  g20(.a(new_n35_), .b(x09), .c(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z08));
  inv1   g22(.a(x01), .O(new_n56_));
  nand2  g23(.a(x08), .b(new_n56_), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(x10), .c(x00), .O(new_n58_));
  nand3  g25(.a(new_n35_), .b(x08), .c(x01), .O(new_n59_));
