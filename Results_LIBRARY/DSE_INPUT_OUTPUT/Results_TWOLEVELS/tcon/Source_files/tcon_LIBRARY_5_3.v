...
module FAU ( 
  ...
  nand2  g00(.a(x15), .b(x01), .O(new_n34_));
  ...
  nor2   g13(.a(new_n46_), .b(x01), .O(z06));
  ...
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n34_), .O(z08));
  oai21  g20(.a(x15), .b(x08), .c(x01), .O(new_n54_));
  ...
  nand3  g38(.a(new_n71_), .b(x15), .c(new_n69_), .O(new_n72_));
  nand3  g39(.a(new_n46_), .b(x08), .c(x06), .O(new_n73_));
