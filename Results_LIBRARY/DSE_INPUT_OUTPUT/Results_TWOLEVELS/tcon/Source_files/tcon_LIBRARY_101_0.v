...
module FAU ( 
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n35_), .O(z10));
  ...
  oai21  g33(.a(new_n65_), .b(new_n64_), .c(new_n66_), .O(z13));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand2  g35(.a(x15), .b(new_n49_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n35_), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  aoi21  g38(.a(x14), .b(x08), .c(x16), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n49_), .O(new_n73_));
  oai21  g40(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(z15));
  buf    g41(.a(x14), .O(z05));
  buf    g42(.a(x16), .O(z07));
endmodule
