...
module FAU ( 
  ...
  nor2   g15(.a(x14), .b(new_n46_), .O(new_n49_));
  ...
  aoi21  g22(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(z08));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n49_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n54_), .O(new_n69_));
  aoi21  g36(.a(x08), .b(new_n46_), .c(x14), .O(new_n70_));
  oai21  g37(.a(new_n70_), .b(new_n68_), .c(new_n69_), .O(z13));
