...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  nand2  g02(.a(new_n35_), .b(x14), .O(new_n36_));
  ...
  nand2  g14(.a(new_n35_), .b(new_n46_), .O(z06));
  ...
  nor2   g24(.a(x15), .b(new_n46_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(x11), .b(new_n51_), .O(new_n60_));
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n58_), .O(z10));
  ...
  oai21  g34(.a(new_n35_), .b(new_n51_), .c(x14), .O(new_n68_));
  ...
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n58_), .O(z15));
endmodule
