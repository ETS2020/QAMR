...
module FAU ( 
  ...
  aoi21  g06(.a(x13), .b(x02), .c(new_n39_), .O(z02));
  ...
  nand2  g24(.a(new_n39_), .b(new_n49_), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(x02), .O(new_n59_));
  inv1   g26(.a(x02), .O(new_n60_));
  nand3  g27(.a(x11), .b(new_n49_), .c(new_n60_), .O(new_n61_));
  ...
  oai21  g32(.a(new_n49_), .b(x02), .c(x13), .O(new_n66_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n53_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n49_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n53_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n49_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n53_), .O(z15));
  buf    g44(.a(x13), .O(z04));
endmodule
