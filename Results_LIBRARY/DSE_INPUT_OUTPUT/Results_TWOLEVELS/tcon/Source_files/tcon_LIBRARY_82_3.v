...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n39_, new_n41_, new_n43_, new_n47_, new_n48_,
  ...
  nand3  g27(.a(new_n43_), .b(x08), .c(x04), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z12));
  inv1   g29(.a(x05), .O(new_n63_));
  oai21  g30(.a(new_n48_), .b(new_n63_), .c(new_n43_), .O(z13));
