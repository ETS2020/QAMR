...
module FAU ( 
  ...
  nand2  g10(.a(new_n35_), .b(new_n43_), .O(z03));
  ...
  oai22  g29(.a(new_n62_), .b(new_n61_), .c(new_n43_), .d(x08), .O(z11));
  nand2  g30(.a(x13), .b(x12), .O(new_n64_));
  oai21  g31(.a(x13), .b(new_n51_), .c(new_n64_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(x04), .O(new_n66_));
  nand3  g33(.a(x13), .b(x12), .c(new_n51_), .O(new_n67_));
