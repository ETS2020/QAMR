...
module FAU ( 
  ...
  aoi21  g05(.a(x13), .b(new_n37_), .c(new_n38_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  aoi21  g07(.a(x13), .b(new_n37_), .c(new_n40_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(x13), .b(new_n37_), .c(new_n42_), .O(z03));
  nor2   g10(.a(new_n35_), .b(new_n37_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  aoi21  g12(.a(x13), .b(new_n37_), .c(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  oai21  g14(.a(new_n35_), .b(x08), .c(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  aoi21  g16(.a(x13), .b(new_n37_), .c(new_n49_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  nand3  g18(.a(new_n35_), .b(x09), .c(new_n37_), .O(new_n52_));
  ...
  nand3  g24(.a(new_n35_), .b(x11), .c(new_n37_), .O(new_n58_));
