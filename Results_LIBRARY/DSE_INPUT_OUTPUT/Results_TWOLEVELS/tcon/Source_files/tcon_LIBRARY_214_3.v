...
module FAU ( 
  ...
  and2   g10(.a(x12), .b(x11), .O(new_n44_));
  ...
  oai21  g18(.a(x12), .b(new_n46_), .c(x11), .O(new_n52_));
  nand2  g19(.a(x08), .b(x02), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z10));
  oai21  g21(.a(x11), .b(new_n46_), .c(x12), .O(new_n55_));
  ...
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n44_), .O(z13));
  nand2  g30(.a(x08), .b(x06), .O(new_n64_));
  nand2  g31(.a(x15), .b(new_n46_), .O(new_n65_));
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n44_), .O(z14));
  nand2  g33(.a(x08), .b(x07), .O(new_n67_));
  nand2  g34(.a(x16), .b(new_n46_), .O(new_n68_));
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n44_), .O(z15));
  buf    g36(.a(x11), .O(z02));
  buf    g37(.a(x12), .O(z03));
endmodule
