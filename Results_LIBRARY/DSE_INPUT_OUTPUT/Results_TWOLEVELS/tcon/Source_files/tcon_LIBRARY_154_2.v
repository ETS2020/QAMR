...
module FAU ( 
  ...
  nand2  g07(.a(new_n35_), .b(x04), .O(new_n41_));
  ...
  aoi21  g12(.a(new_n35_), .b(x04), .c(new_n45_), .O(z04));
  ...
  oai21  g32(.a(x13), .b(x08), .c(x09), .O(new_n66_));
  nand3  g33(.a(x13), .b(new_n53_), .c(new_n34_), .O(new_n67_));
  oai21  g34(.a(new_n66_), .b(new_n34_), .c(new_n67_), .O(z12));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n41_), .O(z14));
