...
module FAU ( 
  ...
  aoi21  g13(.a(x11), .b(new_n35_), .c(new_n46_), .O(z05));
  ...
  nand3  g26(.a(x12), .b(new_n40_), .c(new_n35_), .O(new_n60_));
  ...
  nand3  g32(.a(x14), .b(new_n40_), .c(new_n35_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand3  g35(.a(x15), .b(new_n40_), .c(new_n35_), .O(new_n69_));
