...
module FAU ( 
  ...
  nand2  g23(.a(new_n56_), .b(new_n36_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  inv1   g25(.a(x11), .O(new_n59_));
  nand3  g26(.a(x12), .b(new_n59_), .c(new_n35_), .O(new_n60_));
  ...
  nand3  g35(.a(x15), .b(new_n59_), .c(new_n35_), .O(new_n69_));
