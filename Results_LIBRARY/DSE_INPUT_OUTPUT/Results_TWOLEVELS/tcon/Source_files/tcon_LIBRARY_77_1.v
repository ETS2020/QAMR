...
module FAU ( 
  ...
  nand2  g18(.a(new_n47_), .b(new_n51_), .O(z07));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z10));
  nand2  g29(.a(x12), .b(new_n53_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x03), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(z11));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n47_), .O(z13));
  nand2  g38(.a(x15), .b(new_n53_), .O(new_n72_));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n47_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  oai21  g42(.a(new_n51_), .b(x08), .c(new_n75_), .O(new_n76_));
  nand2  g43(.a(new_n76_), .b(x00), .O(new_n77_));
  nand3  g44(.a(x16), .b(new_n53_), .c(new_n35_), .O(new_n78_));
