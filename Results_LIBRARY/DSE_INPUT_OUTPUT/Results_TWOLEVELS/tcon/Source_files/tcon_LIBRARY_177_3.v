...
module FAU ( 
  ...
  nor2   g21(.a(new_n54_), .b(x04), .O(new_n55_));
  nor2   g22(.a(x11), .b(new_n46_), .O(new_n56_));
  oai21  g23(.a(new_n56_), .b(new_n55_), .c(x02), .O(new_n57_));
  inv1   g24(.a(x04), .O(new_n58_));
  nand3  g25(.a(x11), .b(new_n46_), .c(new_n58_), .O(new_n59_));
