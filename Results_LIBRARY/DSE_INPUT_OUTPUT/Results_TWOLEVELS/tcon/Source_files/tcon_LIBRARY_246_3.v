...
module FAU ( 
  ...
  oai21  g17(.a(x15), .b(x00), .c(x08), .O(new_n51_));
  ...
  nand3  g22(.a(new_n47_), .b(x08), .c(x01), .O(new_n56_));
  ...
  oai21  g37(.a(new_n52_), .b(new_n70_), .c(new_n47_), .O(z14));
  nand2  g38(.a(x16), .b(new_n52_), .O(new_n72_));
  nand3  g39(.a(new_n47_), .b(x08), .c(x07), .O(new_n73_));
