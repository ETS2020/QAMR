...
module FAU ( 
  ...
  nor2   g07(.a(new_n35_), .b(x02), .O(new_n41_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n57_), .c(new_n41_), .O(z09));
  nand2  g27(.a(x11), .b(new_n58_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n53_), .c(new_n38_), .O(z10));
  nand2  g29(.a(x12), .b(new_n58_), .O(new_n63_));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n41_), .O(z14));
  nand2  g41(.a(x16), .b(new_n58_), .O(new_n75_));
