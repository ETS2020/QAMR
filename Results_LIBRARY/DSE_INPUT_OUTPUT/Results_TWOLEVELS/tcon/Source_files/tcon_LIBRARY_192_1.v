...
module FAU ( 
  ...
  aoi21  g19(.a(new_n52_), .b(new_n50_), .c(new_n42_), .O(z08));
  inv1   g20(.a(x01), .O(new_n54_));
  aoi21  g21(.a(new_n41_), .b(x08), .c(x10), .O(new_n55_));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n42_), .O(z12));
  oai21  g33(.a(new_n35_), .b(new_n51_), .c(x14), .O(new_n67_));
  ...
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n42_), .O(z15));
  buf    g42(.a(x10), .O(z01));
  buf    g43(.a(x14), .O(z05));
endmodule
