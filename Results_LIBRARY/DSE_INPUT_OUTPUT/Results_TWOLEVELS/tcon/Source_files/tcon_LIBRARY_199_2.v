// Benchmark "FAU" written by ABC on Wed Aug 19 20:51:35 2020
...
module FAU ( 
  ...
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n50_), .O(z08));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n50_), .O(z11));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n50_), .O(z13));
