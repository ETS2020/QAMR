...
module FAU ( 
  ...
  aoi21  g11(.a(new_n35_), .b(x03), .c(new_n44_), .O(z03));
  ...
  oai21  g28(.a(x12), .b(x08), .c(x13), .O(new_n62_));
  nand3  g29(.a(x12), .b(new_n53_), .c(new_n39_), .O(new_n63_));
  oai21  g30(.a(new_n62_), .b(new_n39_), .c(new_n63_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  aoi21  g32(.a(x08), .b(new_n39_), .c(x13), .O(new_n66_));
