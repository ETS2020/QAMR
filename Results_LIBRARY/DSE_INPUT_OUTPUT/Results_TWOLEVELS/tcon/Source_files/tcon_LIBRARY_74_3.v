...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n41_, new_n43_, new_n44_, new_n47_, new_n48_,
  ...
  nand2  g13(.a(x09), .b(new_n43_), .O(new_n47_));
  ...
  nand2  g18(.a(x10), .b(new_n43_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z09));
  oai21  g20(.a(x15), .b(x02), .c(x08), .O(new_n54_));
  nand2  g21(.a(x11), .b(new_n43_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z10));
  nand2  g23(.a(x12), .b(new_n43_), .O(new_n57_));
  nand3  g24(.a(new_n48_), .b(x08), .c(x03), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z11));
  oai21  g26(.a(x15), .b(x04), .c(x08), .O(new_n60_));
  nand2  g27(.a(x13), .b(new_n43_), .O(new_n61_));
  ...
  nand2  g33(.a(new_n66_), .b(new_n44_), .O(z14));
