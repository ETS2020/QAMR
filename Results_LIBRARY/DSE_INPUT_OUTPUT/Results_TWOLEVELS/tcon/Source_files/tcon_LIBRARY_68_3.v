...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(x11), .O(z06));
  ...
  nor2   g32(.a(x15), .b(new_n46_), .O(new_n66_));
  oai21  g33(.a(new_n66_), .b(z06), .c(x06), .O(new_n67_));
  nand2  g34(.a(z06), .b(new_n46_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand2  g37(.a(x16), .b(new_n46_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n50_), .O(z15));
  buf    g39(.a(x11), .O(z02));
endmodule
