...
module FAU ( 
  ...
  nand2  g05(.a(new_n35_), .b(x09), .O(new_n39_));
  ...
  nand2  g10(.a(new_n39_), .b(new_n43_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nand2  g12(.a(new_n39_), .b(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  nand2  g14(.a(new_n39_), .b(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nor2   g16(.a(x10), .b(new_n34_), .O(new_n50_));
  nor2   g17(.a(new_n50_), .b(new_n49_), .O(z07));
