...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n43_, new_n45_, new_n46_,
  ...
  nand2  g12(.a(x15), .b(new_n45_), .O(new_n46_));
  inv1   g13(.a(new_n46_), .O(z06));
  and2   g14(.a(new_n35_), .b(x16), .O(z07));
  nand2  g15(.a(x09), .b(new_n45_), .O(new_n49_));
  ...
  nand2  g23(.a(x11), .b(new_n45_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z10));
  nand2  g25(.a(x12), .b(new_n45_), .O(new_n59_));
  nand3  g26(.a(new_n50_), .b(x08), .c(x03), .O(new_n60_));
  ...
  nand3  g32(.a(new_n50_), .b(x08), .c(x05), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  nand3  g34(.a(new_n50_), .b(x08), .c(x06), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n46_), .O(z14));
  nand2  g36(.a(x16), .b(new_n45_), .O(new_n70_));
  nand3  g37(.a(new_n50_), .b(x08), .c(x07), .O(new_n71_));
