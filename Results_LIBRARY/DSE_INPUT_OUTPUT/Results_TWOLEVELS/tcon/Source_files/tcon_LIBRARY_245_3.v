...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n38_, new_n40_, new_n43_, new_n45_, new_n47_, new_n48_,
  ...
  nand2  g00(.a(x15), .b(x07), .O(new_n34_));
  ...
  nor2   g10(.a(new_n43_), .b(x07), .O(z06));
  inv1   g11(.a(x16), .O(new_n45_));
  aoi21  g12(.a(x15), .b(x07), .c(new_n45_), .O(z07));
  ...
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand2  g31(.a(x14), .b(new_n49_), .O(new_n65_));
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(z13));
  oai21  g33(.a(new_n49_), .b(x07), .c(x15), .O(new_n67_));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(new_n45_), .b(new_n49_), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n43_), .c(x07), .O(new_n71_));
  inv1   g38(.a(x07), .O(new_n72_));
  nand3  g39(.a(x16), .b(new_n49_), .c(new_n72_), .O(new_n73_));
