...
module FAU ( 
  ...
  aoi21  g18(.a(new_n51_), .b(new_n49_), .c(new_n36_), .O(z08));
  nand2  g19(.a(x10), .b(new_n50_), .O(new_n53_));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n45_), .O(z09));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n45_), .O(z11));
  nand2  g28(.a(x13), .b(new_n50_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n45_), .O(z12));
  nand2  g31(.a(x14), .b(x13), .O(new_n65_));
  oai21  g32(.a(x14), .b(new_n50_), .c(new_n65_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(x05), .O(new_n67_));
  nand3  g34(.a(x14), .b(x13), .c(new_n50_), .O(new_n68_));
  ...
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n45_), .O(z15));
  buf    g42(.a(x13), .O(z04));
  buf    g43(.a(x14), .O(z05));
endmodule
