...
module FAU ( 
  ...
  nand2  g26(.a(x12), .b(new_n54_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z11));
  inv1   g28(.a(x04), .O(new_n62_));
  oai22  g29(.a(new_n51_), .b(new_n62_), .c(new_n42_), .d(x08), .O(z12));
