...
module FAU ( 
  ...
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n40_), .O(z08));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n36_), .O(z15));
  buf    g41(.a(x10), .O(z01));
  buf    g42(.a(x15), .O(z06));
endmodule
