...
module FAU ( 
  ...
  nand2  g13(.a(new_n46_), .b(x04), .O(z05));
  ...
  nand3  g21(.a(new_n54_), .b(new_n53_), .c(new_n42_), .O(z08));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n42_), .O(z11));
  oai21  g31(.a(x13), .b(x08), .c(x04), .O(new_n65_));
  nand3  g32(.a(x14), .b(x13), .c(new_n52_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z12));
  nand2  g34(.a(x14), .b(new_n52_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n42_), .O(z13));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(x15), .b(new_n52_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z14));
  nand2  g40(.a(x16), .b(new_n52_), .O(new_n74_));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n42_), .O(z15));
endmodule
