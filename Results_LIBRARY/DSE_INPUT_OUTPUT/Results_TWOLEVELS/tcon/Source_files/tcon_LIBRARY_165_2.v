...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n58_, new_n60_, new_n61_, new_n63_, new_n65_, new_n67_,
  ...
  nand2  g24(.a(x13), .b(x08), .O(new_n58_));
  ...
  oai21  g29(.a(new_n51_), .b(x04), .c(x13), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n38_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  oai22  g32(.a(new_n58_), .b(new_n65_), .c(new_n44_), .d(x08), .O(z13));
  oai21  g33(.a(new_n35_), .b(x06), .c(x08), .O(new_n67_));
  nand2  g34(.a(x15), .b(new_n51_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  oai21  g36(.a(new_n35_), .b(x07), .c(x08), .O(new_n70_));
  nand2  g37(.a(x16), .b(new_n51_), .O(new_n71_));
