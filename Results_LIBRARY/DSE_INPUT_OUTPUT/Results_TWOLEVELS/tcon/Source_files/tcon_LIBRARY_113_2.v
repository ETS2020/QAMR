...
module FAU ( 
  ...
  aoi21  g26(.a(x08), .b(new_n43_), .c(x11), .O(new_n60_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n52_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n44_), .O(z14));
  oai21  g41(.a(x16), .b(x08), .c(x11), .O(new_n75_));
  nand3  g42(.a(x16), .b(new_n52_), .c(new_n43_), .O(new_n76_));
  oai21  g43(.a(new_n75_), .b(new_n43_), .c(new_n76_), .O(z15));
  buf    g44(.a(x11), .O(z02));
endmodule
