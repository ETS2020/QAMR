...
module FAU ( 
  ...
  nor2   g02(.a(x07), .b(new_n35_), .O(new_n36_));
  ...
  nand2  g19(.a(new_n48_), .b(new_n52_), .O(z07));
  oai21  g20(.a(x08), .b(new_n47_), .c(x00), .O(new_n54_));
  inv1   g21(.a(x08), .O(new_n55_));
  nand2  g22(.a(x09), .b(new_n55_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n54_), .O(z08));
  ...
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(z10));
  ...
  oai21  g42(.a(x16), .b(x08), .c(x07), .O(new_n76_));
  nand3  g43(.a(x16), .b(new_n55_), .c(new_n35_), .O(new_n77_));
