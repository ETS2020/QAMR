...
module FAU ( 
  ...
  nand2  g29(.a(x16), .b(new_n53_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(x03), .O(new_n64_));
  ...
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n40_), .O(z14));
  nand2  g42(.a(x08), .b(x07), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n63_), .c(new_n40_), .O(z15));
endmodule
