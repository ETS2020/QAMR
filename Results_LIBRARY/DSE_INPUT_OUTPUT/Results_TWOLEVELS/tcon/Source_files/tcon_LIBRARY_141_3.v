...
module FAU ( 
  ...
  oai21  g24(.a(x15), .b(x03), .c(x08), .O(new_n58_));
  nand2  g25(.a(x12), .b(new_n48_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z11));
  oai21  g27(.a(x15), .b(x04), .c(x08), .O(new_n61_));
  ...
  nand3  g34(.a(new_n55_), .b(x08), .c(x06), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  oai21  g36(.a(x15), .b(x07), .c(x08), .O(new_n70_));
