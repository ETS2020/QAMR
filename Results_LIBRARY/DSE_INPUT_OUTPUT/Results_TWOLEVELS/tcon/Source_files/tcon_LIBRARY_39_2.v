...
module FAU ( 
  ...
  nor2   g02(.a(x04), .b(new_n35_), .O(new_n36_));
  ...
  nand2  g18(.a(new_n51_), .b(x01), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z07));
  ...
  oai21  g24(.a(x08), .b(new_n51_), .c(x01), .O(new_n58_));
