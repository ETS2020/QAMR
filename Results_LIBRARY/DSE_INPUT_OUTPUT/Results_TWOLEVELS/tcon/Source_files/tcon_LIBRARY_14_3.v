...
module FAU ( 
  ...
  aoi21  g15(.a(x08), .b(x03), .c(new_n48_), .O(z07));
  ...
  oai21  g27(.a(new_n41_), .b(x08), .c(new_n35_), .O(z11));
  nand2  g28(.a(x08), .b(x04), .O(new_n62_));
  oai22  g29(.a(new_n62_), .b(x03), .c(new_n43_), .d(x08), .O(z12));
  ...
  oai22  g34(.a(new_n67_), .b(x03), .c(new_n46_), .d(x08), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  oai22  g36(.a(new_n69_), .b(x03), .c(new_n48_), .d(x08), .O(z15));
endmodule
