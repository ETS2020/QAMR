...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n38_, new_n40_, new_n42_, new_n44_, new_n46_, new_n47_,
  ...
  nand2  g00(.a(x14), .b(x04), .O(new_n34_));
  ...
  aoi21  g09(.a(x14), .b(x04), .c(new_n42_), .O(z06));
  ...
  nand3  g25(.a(new_n34_), .b(x13), .c(new_n46_), .O(new_n59_));
  inv1   g26(.a(x14), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(x08), .c(x04), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n59_), .O(z12));
  oai21  g29(.a(new_n46_), .b(x04), .c(x14), .O(new_n63_));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  and2   g32(.a(x14), .b(x04), .O(new_n66_));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand2  g34(.a(x15), .b(new_n46_), .O(new_n68_));
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n66_), .O(z14));
