...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n44_, new_n45_, new_n46_,
    ...
    new_n68_;
  nand2  g00(.a(x15), .b(x09), .O(new_n34_));
  ...
  oai21  g11(.a(x15), .b(new_n44_), .c(x09), .O(new_n45_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n57_), .O(z15));
  buf    g36(.a(x09), .O(z00));
  buf    g37(.a(x15), .O(z06));
endmodule
