...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n44_, new_n45_, new_n47_,
  ...
  nand2  g00(.a(x14), .b(x07), .O(new_n34_));
  ...
  nor2   g12(.a(new_n45_), .b(new_n44_), .O(z07));
  ...
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n45_), .O(z10));
  nand2  g23(.a(x08), .b(x03), .O(new_n57_));
  nand2  g24(.a(x12), .b(new_n47_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n45_), .O(z11));
  ...
  nor2   g30(.a(new_n63_), .b(x07), .O(new_n64_));
  nor2   g31(.a(x14), .b(new_n47_), .O(new_n65_));
  oai21  g32(.a(new_n65_), .b(new_n64_), .c(x05), .O(new_n66_));
  inv1   g33(.a(x07), .O(new_n67_));
  nand3  g34(.a(x14), .b(new_n47_), .c(new_n67_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n66_), .O(z13));
  nand2  g36(.a(x15), .b(new_n47_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n34_), .O(z14));
  oai21  g39(.a(x14), .b(x08), .c(x07), .O(new_n73_));
  oai21  g40(.a(new_n44_), .b(x08), .c(new_n73_), .O(z15));
  buf    g41(.a(x14), .O(z05));
endmodule
