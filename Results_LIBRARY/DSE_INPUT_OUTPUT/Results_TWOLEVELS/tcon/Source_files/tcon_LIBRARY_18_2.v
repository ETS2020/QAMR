...
module FAU ( 
  ...
  nand2  g12(.a(new_n45_), .b(x03), .O(new_n46_));
  nand2  g13(.a(new_n46_), .b(new_n44_), .O(z04));
  ...
  nand2  g28(.a(x14), .b(new_n52_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(x03), .O(new_n63_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n62_), .c(new_n46_), .O(z13));
