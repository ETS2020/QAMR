...
module FAU ( 
  ...
  oai21  g12(.a(new_n39_), .b(x08), .c(new_n45_), .O(z05));
  ...
  nor2   g17(.a(x11), .b(x09), .O(new_n51_));
  ...
  nand3  g31(.a(x14), .b(new_n39_), .c(new_n34_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand3  g34(.a(x15), .b(new_n39_), .c(new_n34_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand3  g37(.a(x16), .b(new_n39_), .c(new_n34_), .O(new_n71_));
