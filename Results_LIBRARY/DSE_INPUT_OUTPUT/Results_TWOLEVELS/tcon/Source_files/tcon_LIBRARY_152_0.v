...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x03), .O(new_n35_));
  ...
  nand2  g15(.a(new_n48_), .b(x03), .O(z06));
  ...
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n35_), .O(z08));
  ...
  nand3  g29(.a(x15), .b(x12), .c(new_n53_), .O(new_n63_));
  ...
  aoi21  g38(.a(x08), .b(x03), .c(x15), .O(new_n72_));
