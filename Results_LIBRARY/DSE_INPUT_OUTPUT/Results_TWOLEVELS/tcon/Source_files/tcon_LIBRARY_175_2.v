...
module FAU ( 
  ...
  oai21  g24(.a(new_n40_), .b(x02), .c(x11), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n36_), .O(z10));
  inv1   g26(.a(x03), .O(new_n60_));
  nand2  g27(.a(x11), .b(x08), .O(new_n61_));
  ...
  oai22  g36(.a(new_n61_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z14));
