...
module FAU ( 
  ...
  nand2  g30(.a(new_n63_), .b(x12), .O(new_n64_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n42_), .O(z12));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(x14), .b(new_n54_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n42_), .O(z13));
  nand2  g39(.a(x15), .b(new_n54_), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n63_), .c(new_n36_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n54_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n42_), .O(z15));
endmodule
