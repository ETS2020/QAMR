...
module FAU ( 
  ...
  oai21  g15(.a(x15), .b(new_n45_), .c(x10), .O(new_n49_));
  nand2  g16(.a(x08), .b(x01), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z09));
  and2   g18(.a(x15), .b(x10), .O(new_n52_));
  ...
  oai21  g31(.a(x10), .b(new_n45_), .c(x15), .O(new_n65_));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z15));
  buf    g37(.a(x15), .O(z06));
endmodule
