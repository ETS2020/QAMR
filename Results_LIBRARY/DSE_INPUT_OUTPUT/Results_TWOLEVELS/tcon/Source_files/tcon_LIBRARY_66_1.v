...
module FAU ( 
  ...
  nor2   g12(.a(new_n45_), .b(new_n34_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  aoi21  g14(.a(x14), .b(new_n34_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  aoi21  g16(.a(x14), .b(new_n34_), .c(new_n49_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  nand3  g18(.a(new_n45_), .b(x09), .c(new_n34_), .O(new_n52_));
  ...
  nand3  g27(.a(new_n45_), .b(x12), .c(new_n34_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand3  g30(.a(new_n45_), .b(x13), .c(new_n34_), .O(new_n64_));
  ...
  nand3  g37(.a(x16), .b(new_n45_), .c(new_n34_), .O(new_n71_));
