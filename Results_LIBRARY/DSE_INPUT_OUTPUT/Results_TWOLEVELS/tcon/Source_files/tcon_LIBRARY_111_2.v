...
module FAU ( 
  ...
  oai22  g23(.a(new_n56_), .b(new_n55_), .c(new_n38_), .d(x08), .O(z09));
  ...
  nand2  g28(.a(x12), .b(new_n44_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  oai21  g30(.a(new_n44_), .b(x04), .c(x13), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n36_), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(new_n56_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z13));
  inv1   g34(.a(x06), .O(new_n68_));
  oai22  g35(.a(new_n56_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(new_n56_), .b(new_n70_), .c(new_n50_), .d(x08), .O(z15));
endmodule
