...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n39_, new_n43_, new_n45_, new_n46_, new_n47_,
    new_n48_, new_n50_, new_n51_, new_n53_, new_n54_, new_n56_, new_n58_,
  ...
  oai21  g22(.a(x14), .b(x08), .c(x03), .O(new_n56_));
  oai21  g23(.a(new_n39_), .b(x08), .c(new_n56_), .O(z11));
  nand2  g24(.a(x08), .b(x04), .O(new_n58_));
  nand2  g25(.a(x13), .b(new_n47_), .O(new_n59_));
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n45_), .O(z12));
  inv1   g27(.a(x03), .O(new_n61_));
  inv1   g28(.a(x05), .O(new_n62_));
  nand2  g29(.a(x08), .b(new_n62_), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(x14), .c(new_n61_), .O(new_n64_));
