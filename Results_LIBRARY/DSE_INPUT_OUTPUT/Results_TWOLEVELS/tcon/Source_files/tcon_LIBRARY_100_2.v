...
module FAU ( 
  ...
  nand2  g04(.a(new_n35_), .b(x03), .O(new_n38_));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n43_), .O(z13));
  ...
  nand2  g42(.a(x16), .b(new_n55_), .O(new_n76_));
