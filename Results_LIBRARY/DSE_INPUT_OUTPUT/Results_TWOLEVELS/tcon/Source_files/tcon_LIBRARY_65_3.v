...
module FAU ( 
  ...
  nor2   g20(.a(x11), .b(new_n48_), .O(new_n54_));
  inv1   g21(.a(x11), .O(new_n55_));
  nor2   g22(.a(x13), .b(new_n55_), .O(new_n56_));
  oai21  g23(.a(new_n56_), .b(new_n54_), .c(x02), .O(new_n57_));
  nand2  g24(.a(new_n56_), .b(new_n48_), .O(new_n58_));
  ...
  nand3  g29(.a(new_n35_), .b(x08), .c(x04), .O(new_n63_));
  nand3  g30(.a(x13), .b(new_n55_), .c(new_n48_), .O(new_n64_));
