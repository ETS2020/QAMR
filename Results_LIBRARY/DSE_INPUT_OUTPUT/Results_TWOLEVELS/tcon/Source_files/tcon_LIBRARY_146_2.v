// Benchmark "FAU" written by ABC on Wed Aug 19 20:51:19 2020
...
module FAU ( 
  ...
  nand2  g14(.a(new_n47_), .b(new_n46_), .O(z07));
  inv1   g15(.a(x08), .O(new_n49_));
  nand2  g16(.a(x14), .b(x09), .O(new_n50_));
  oai21  g17(.a(x09), .b(new_n49_), .c(new_n50_), .O(new_n51_));
  nand2  g18(.a(new_n51_), .b(x00), .O(new_n52_));
  nand3  g19(.a(x14), .b(x09), .c(new_n49_), .O(new_n53_));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n47_), .O(z10));
  ...
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(z12));
  nand2  g33(.a(x14), .b(new_n49_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n47_), .O(z13));
