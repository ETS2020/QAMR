...
module FAU ( 
  ...
  nor2   g12(.a(new_n45_), .b(x13), .O(z07));
  and2   g13(.a(x16), .b(x13), .O(new_n47_));
  ...
  oai21  g27(.a(x16), .b(new_n49_), .c(x13), .O(new_n61_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n47_), .O(z14));
  oai21  g36(.a(x13), .b(new_n49_), .c(x16), .O(new_n70_));
