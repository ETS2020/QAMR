...
module FAU ( 
  ...
  nand2  g17(.a(x16), .b(x11), .O(new_n51_));
  ...
  oai22  g28(.a(new_n61_), .b(new_n60_), .c(new_n41_), .d(x08), .O(z10));
  ...
  oai21  g41(.a(x16), .b(new_n54_), .c(new_n51_), .O(new_n75_));
  nand2  g42(.a(new_n75_), .b(x07), .O(new_n76_));
  nand2  g43(.a(z07), .b(new_n54_), .O(new_n77_));
