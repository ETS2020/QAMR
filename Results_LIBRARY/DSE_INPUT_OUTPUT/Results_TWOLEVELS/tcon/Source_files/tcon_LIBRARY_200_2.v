...
module FAU ( 
  ...
  nand2  g22(.a(x10), .b(new_n46_), .O(new_n56_));
  ...
  nand2  g31(.a(x14), .b(x08), .O(new_n65_));
  oai22  g32(.a(new_n65_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z12));
  oai21  g33(.a(new_n46_), .b(x05), .c(x14), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n38_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(new_n65_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z14));
