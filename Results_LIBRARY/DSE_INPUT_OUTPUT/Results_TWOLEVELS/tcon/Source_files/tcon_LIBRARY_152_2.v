...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x03), .O(new_n44_));
  ...
  nand2  g16(.a(new_n43_), .b(new_n35_), .O(z06));
  ...
  nand3  g29(.a(new_n44_), .b(x12), .c(new_n54_), .O(new_n63_));
  nand3  g30(.a(x15), .b(x08), .c(x03), .O(new_n64_));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n44_), .O(z13));
  inv1   g38(.a(x06), .O(new_n72_));
  aoi21  g39(.a(x08), .b(new_n35_), .c(x15), .O(new_n73_));
  nand2  g40(.a(x15), .b(new_n54_), .O(new_n74_));
  oai21  g41(.a(new_n73_), .b(new_n72_), .c(new_n74_), .O(z14));
