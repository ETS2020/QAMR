...
module FAU ( 
  ...
  nor2   g16(.a(x15), .b(x09), .O(new_n50_));
  ...
  inv1   g26(.a(x15), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(x12), .c(new_n34_), .O(new_n61_));
  ...
  nand3  g33(.a(new_n60_), .b(x14), .c(new_n34_), .O(new_n67_));
