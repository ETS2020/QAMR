...
module FAU ( 
  ...
  nand2  g16(.a(x09), .b(new_n38_), .O(new_n50_));
  inv1   g17(.a(x11), .O(new_n51_));
  nand3  g18(.a(new_n51_), .b(x08), .c(x00), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z08));
  oai21  g20(.a(x11), .b(x01), .c(x08), .O(new_n54_));
  nand2  g21(.a(x10), .b(new_n38_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  nand3  g23(.a(new_n51_), .b(x08), .c(x02), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n39_), .O(z10));
  oai21  g25(.a(x11), .b(x03), .c(x08), .O(new_n59_));
  nand2  g26(.a(x12), .b(new_n38_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z11));
  nand2  g28(.a(x13), .b(new_n38_), .O(new_n62_));
  nand3  g29(.a(new_n51_), .b(x08), .c(x04), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand2  g31(.a(x14), .b(new_n38_), .O(new_n65_));
  nand3  g32(.a(new_n51_), .b(x08), .c(x05), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z13));
  oai21  g34(.a(x11), .b(x06), .c(x08), .O(new_n68_));
  nand2  g35(.a(x15), .b(new_n38_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  oai21  g37(.a(x11), .b(x07), .c(x08), .O(new_n71_));
  nand2  g38(.a(x16), .b(new_n38_), .O(new_n72_));
