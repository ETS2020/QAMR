...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n41_, new_n47_, new_n48_,
  ...
  nor2   g06(.a(new_n39_), .b(x07), .O(z02));
  ...
  nor2   g20(.a(x11), .b(new_n47_), .O(new_n54_));
  oai21  g21(.a(new_n54_), .b(z02), .c(x02), .O(new_n55_));
  inv1   g22(.a(x07), .O(new_n56_));
  nand3  g23(.a(x11), .b(new_n47_), .c(new_n56_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n55_), .O(z10));
  inv1   g25(.a(new_n35_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n47_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n59_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand2  g30(.a(x13), .b(new_n47_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n59_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n47_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n59_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand2  g36(.a(x15), .b(new_n47_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n59_), .O(z14));
  nand2  g38(.a(z07), .b(new_n47_), .O(new_n72_));
  nand2  g39(.a(new_n54_), .b(x07), .O(new_n73_));
