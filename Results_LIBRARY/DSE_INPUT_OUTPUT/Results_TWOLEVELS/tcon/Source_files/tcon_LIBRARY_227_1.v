...
module FAU ( 
  ...
  nand2  g12(.a(new_n35_), .b(new_n45_), .O(z04));
  ...
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n37_), .O(z12));
  ...
  nand2  g39(.a(x16), .b(x13), .O(new_n73_));
  oai21  g40(.a(x16), .b(new_n51_), .c(new_n73_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(x07), .O(new_n75_));
  nand3  g42(.a(x16), .b(x13), .c(new_n51_), .O(new_n76_));
