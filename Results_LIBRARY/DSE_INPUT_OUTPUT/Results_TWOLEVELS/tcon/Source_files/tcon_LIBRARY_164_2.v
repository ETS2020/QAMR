...
module FAU ( 
  ...
  nand2  g25(.a(x14), .b(x08), .O(new_n59_));
  oai22  g26(.a(new_n59_), .b(new_n58_), .c(new_n40_), .d(x08), .O(z10));
  inv1   g27(.a(x03), .O(new_n61_));
  oai22  g28(.a(new_n59_), .b(new_n61_), .c(new_n42_), .d(x08), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  oai22  g30(.a(new_n59_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z12));
  ...
  oai22  g37(.a(new_n59_), .b(new_n70_), .c(new_n50_), .d(x08), .O(z15));
endmodule
