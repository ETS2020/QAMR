...
module FAU ( 
  ...
  nand2  g11(.a(new_n35_), .b(x07), .O(new_n45_));
  ...
  nand2  g16(.a(new_n45_), .b(new_n49_), .O(z06));
  ...
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n45_), .O(z14));
  oai21  g42(.a(new_n35_), .b(x08), .c(x07), .O(new_n76_));
