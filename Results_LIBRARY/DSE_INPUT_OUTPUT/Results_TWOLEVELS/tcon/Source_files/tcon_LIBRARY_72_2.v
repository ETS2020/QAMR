...
module FAU ( 
  ...
  aoi21  g19(.a(new_n52_), .b(new_n50_), .c(new_n40_), .O(z08));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n40_), .O(z11));
  oai21  g29(.a(new_n35_), .b(new_n51_), .c(x13), .O(new_n63_));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand2  g36(.a(x15), .b(new_n51_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n40_), .O(z14));
