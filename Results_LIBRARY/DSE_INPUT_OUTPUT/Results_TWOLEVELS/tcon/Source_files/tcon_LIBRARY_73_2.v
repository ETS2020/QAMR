...
module FAU ( 
  ...
  aoi21  g02(.a(new_n34_), .b(x06), .c(new_n35_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  aoi21  g04(.a(new_n34_), .b(x06), .c(new_n37_), .O(z01));
  inv1   g05(.a(x06), .O(new_n39_));
  inv1   g06(.a(x11), .O(new_n40_));
  oai21  g07(.a(x08), .b(new_n39_), .c(new_n40_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(new_n34_), .b(x06), .c(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  oai21  g11(.a(x08), .b(new_n39_), .c(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(new_n34_), .b(x06), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  aoi21  g15(.a(new_n34_), .b(x06), .c(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  aoi21  g17(.a(new_n34_), .b(x06), .c(new_n50_), .O(z07));
  nor2   g18(.a(x09), .b(x06), .O(new_n52_));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  oai21  g20(.a(new_n52_), .b(x08), .c(new_n53_), .O(z08));
  nor2   g21(.a(x10), .b(x06), .O(new_n55_));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  oai21  g23(.a(new_n55_), .b(x08), .c(new_n56_), .O(z09));
  nor2   g24(.a(x11), .b(x06), .O(new_n58_));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  oai21  g26(.a(new_n58_), .b(x08), .c(new_n59_), .O(z10));
  nor2   g27(.a(x12), .b(x06), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  oai21  g29(.a(new_n61_), .b(x08), .c(new_n62_), .O(z11));
  nor2   g30(.a(x13), .b(x06), .O(new_n64_));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  oai21  g32(.a(new_n64_), .b(x08), .c(new_n65_), .O(z12));
  nor2   g33(.a(x14), .b(x06), .O(new_n67_));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  oai21  g35(.a(new_n67_), .b(x08), .c(new_n68_), .O(z13));
  oai21  g36(.a(new_n48_), .b(x08), .c(new_n39_), .O(z14));
  nor2   g37(.a(x16), .b(x06), .O(new_n71_));
