...
module FAU ( 
  ...
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n36_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  aoi21  g32(.a(new_n35_), .b(x08), .c(x14), .O(new_n66_));
  ...
  oai21  g39(.a(x16), .b(new_n50_), .c(new_n72_), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(x07), .O(new_n74_));
  nand3  g41(.a(x16), .b(x14), .c(new_n50_), .O(new_n75_));
