...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n45_, new_n46_, new_n49_, new_n51_, new_n53_, new_n54_, new_n55_,
  ...
  nand2  g12(.a(x14), .b(new_n45_), .O(new_n46_));
  nand2  g13(.a(new_n46_), .b(new_n44_), .O(z04));
  nor2   g14(.a(new_n35_), .b(new_n45_), .O(z05));
  ...
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n46_), .O(z08));
