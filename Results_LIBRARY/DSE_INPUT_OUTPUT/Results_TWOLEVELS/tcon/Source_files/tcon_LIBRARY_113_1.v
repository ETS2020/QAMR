...
module FAU ( 
  ...
  nand2  g07(.a(x11), .b(x07), .O(new_n41_));
  ...
  oai21  g26(.a(x11), .b(new_n53_), .c(new_n41_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(x02), .O(new_n61_));
  nand3  g28(.a(x11), .b(new_n53_), .c(x07), .O(new_n62_));
  ...
  nand3  g43(.a(x16), .b(new_n35_), .c(new_n53_), .O(new_n77_));
