...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(new_n34_), .O(z00));
  nand2  g02(.a(x15), .b(x09), .O(new_n36_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n53_), .O(z10));
  ...
  oai21  g35(.a(x09), .b(new_n50_), .c(x15), .O(new_n69_));
