...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n43_,
  ...
  nand2  g07(.a(new_n37_), .b(new_n40_), .O(new_n41_));
  nand2  g08(.a(new_n41_), .b(new_n39_), .O(z02));
  inv1   g09(.a(x12), .O(new_n43_));
  nor2   g10(.a(new_n35_), .b(new_n43_), .O(z03));
  ...
  oai21  g27(.a(x12), .b(new_n37_), .c(new_n40_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  oai21  g30(.a(x13), .b(new_n37_), .c(new_n40_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  oai21  g33(.a(x14), .b(new_n37_), .c(new_n40_), .O(new_n67_));
  ...
  oai21  g39(.a(x16), .b(new_n37_), .c(new_n40_), .O(new_n73_));
