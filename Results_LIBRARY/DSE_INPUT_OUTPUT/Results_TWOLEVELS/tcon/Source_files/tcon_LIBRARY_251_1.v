...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n39_, new_n41_, new_n43_,
  ...
  nand2  g06(.a(new_n39_), .b(new_n37_), .O(z01));
  inv1   g07(.a(x11), .O(new_n41_));
  nor2   g08(.a(new_n38_), .b(new_n41_), .O(z02));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n38_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n51_), .O(new_n59_));
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n38_), .O(z10));
  ...
  nand3  g36(.a(x14), .b(x09), .c(new_n51_), .O(new_n70_));
