...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(x11), .O(new_n44_));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n44_), .O(z11));
  nand2  g29(.a(x13), .b(new_n50_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n44_), .O(z12));
  ...
  aoi21  g36(.a(new_n35_), .b(x08), .c(x15), .O(new_n70_));
