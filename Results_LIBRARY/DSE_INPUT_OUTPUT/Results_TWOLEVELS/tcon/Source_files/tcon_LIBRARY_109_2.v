...
module FAU ( 
  ...
  oai21  g22(.a(new_n55_), .b(x02), .c(x11), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n40_), .O(z10));
  inv1   g24(.a(x03), .O(new_n58_));
  oai22  g25(.a(new_n51_), .b(new_n58_), .c(new_n39_), .d(x08), .O(z11));
  oai21  g26(.a(new_n35_), .b(x04), .c(x08), .O(new_n60_));
  nand2  g27(.a(x13), .b(new_n55_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z12));
  oai21  g29(.a(new_n35_), .b(x05), .c(x08), .O(new_n63_));
  nand2  g30(.a(x14), .b(new_n55_), .O(new_n64_));
  ...
  nand2  g35(.a(x16), .b(new_n55_), .O(new_n69_));
