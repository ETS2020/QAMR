...
module FAU ( 
  ...
  nand2  g05(.a(x16), .b(x10), .O(new_n39_));
  ...
  nand2  g18(.a(new_n51_), .b(new_n35_), .O(z07));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x00), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n37_), .O(z08));
  oai21  g23(.a(x10), .b(new_n53_), .c(new_n39_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(x01), .O(new_n58_));
  nand2  g25(.a(z01), .b(new_n53_), .O(new_n59_));
