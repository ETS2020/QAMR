...
module FAU ( 
  ...
  oai21  g34(.a(new_n45_), .b(x08), .c(new_n67_), .O(z13));
  oai21  g35(.a(x15), .b(new_n45_), .c(new_n51_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  oai21  g38(.a(x16), .b(new_n45_), .c(new_n51_), .O(new_n72_));
