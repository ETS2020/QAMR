...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n40_, new_n42_, new_n47_,
  ...
  nor2   g01(.a(new_n34_), .b(x02), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nand2  g03(.a(x09), .b(x02), .O(new_n37_));
  nand2  g04(.a(new_n37_), .b(new_n36_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  and2   g06(.a(x09), .b(x02), .O(new_n40_));
  ...
  oai21  g16(.a(new_n49_), .b(x02), .c(x09), .O(new_n50_));
  ...
  aoi21  g21(.a(new_n54_), .b(new_n53_), .c(new_n40_), .O(z09));
  oai21  g22(.a(x09), .b(x08), .c(x02), .O(new_n56_));
  ...
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n40_), .O(z14));
