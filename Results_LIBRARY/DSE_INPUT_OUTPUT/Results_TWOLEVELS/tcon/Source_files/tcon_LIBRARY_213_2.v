...
module FAU ( 
  ...
  nand2  g19(.a(x09), .b(new_n42_), .O(new_n53_));
  ...
  oai21  g27(.a(new_n42_), .b(x03), .c(x12), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n36_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  nand2  g30(.a(x12), .b(x08), .O(new_n64_));
  oai22  g31(.a(new_n64_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  oai22  g33(.a(new_n64_), .b(new_n66_), .c(new_n46_), .d(x08), .O(z13));
  oai21  g34(.a(new_n35_), .b(x06), .c(x08), .O(new_n68_));
  nand2  g35(.a(x15), .b(new_n42_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  oai21  g37(.a(new_n35_), .b(x07), .c(x08), .O(new_n71_));
  nand2  g38(.a(x16), .b(new_n42_), .O(new_n72_));
