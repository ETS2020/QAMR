...
module FAU ( 
  ...
  nor2   g25(.a(x16), .b(new_n44_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x04), .O(new_n60_));
  oai21  g27(.a(new_n59_), .b(new_n58_), .c(new_n60_), .O(z12));
  nand2  g28(.a(x08), .b(x05), .O(new_n62_));
  nand2  g29(.a(x14), .b(new_n44_), .O(new_n63_));
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n51_), .O(z13));
  ...
  nor2   g35(.a(new_n68_), .b(x13), .O(new_n69_));
  oai21  g36(.a(new_n69_), .b(new_n59_), .c(x07), .O(new_n70_));
  nand2  g37(.a(new_n69_), .b(new_n44_), .O(new_n71_));
