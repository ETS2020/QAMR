...
module FAU ( 
  ...
  nor2   g13(.a(new_n46_), .b(x11), .O(z07));
  ...
  and2   g18(.a(x16), .b(x11), .O(new_n52_));
  ...
  nand3  g23(.a(new_n46_), .b(x11), .c(new_n48_), .O(new_n57_));
  ...
  oai21  g37(.a(x11), .b(new_n48_), .c(x16), .O(new_n71_));
