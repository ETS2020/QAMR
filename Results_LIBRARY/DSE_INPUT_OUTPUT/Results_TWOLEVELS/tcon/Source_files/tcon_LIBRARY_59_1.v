...
module FAU ( 
  ...
  nand2  g03(.a(x10), .b(x09), .O(new_n37_));
  inv1   g04(.a(new_n37_), .O(z01));
  inv1   g05(.a(x11), .O(new_n39_));
  nor2   g06(.a(new_n35_), .b(x09), .O(new_n40_));
  ...
  aoi21  g20(.a(new_n35_), .b(x08), .c(x09), .O(new_n54_));
  oai22  g21(.a(new_n54_), .b(new_n53_), .c(new_n34_), .d(x08), .O(z08));
  inv1   g22(.a(x08), .O(new_n56_));
  oai21  g23(.a(x10), .b(new_n56_), .c(new_n37_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(x01), .O(new_n58_));
  nand2  g25(.a(z01), .b(new_n56_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z09));
  nand2  g27(.a(x08), .b(x02), .O(new_n61_));
  nand2  g28(.a(x11), .b(new_n56_), .O(new_n62_));
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n40_), .O(z10));
  nand2  g30(.a(x12), .b(new_n56_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n43_), .O(z11));
  nand2  g33(.a(x13), .b(new_n56_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x04), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n43_), .O(z12));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(x14), .b(new_n56_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n40_), .O(z13));
  nand2  g39(.a(x15), .b(new_n56_), .O(new_n73_));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n43_), .O(z14));
  nand2  g42(.a(x08), .b(x07), .O(new_n76_));
  nand2  g43(.a(x16), .b(new_n56_), .O(new_n77_));
  aoi21  g44(.a(new_n77_), .b(new_n76_), .c(new_n40_), .O(z15));
endmodule
