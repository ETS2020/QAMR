...
module FAU ( 
  ...
  nand2  g21(.a(x10), .b(x03), .O(new_n55_));
  oai21  g22(.a(x10), .b(new_n51_), .c(new_n55_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(x01), .O(new_n57_));
  nand3  g24(.a(x10), .b(new_n51_), .c(x03), .O(new_n58_));
  ...
  nand3  g30(.a(x12), .b(new_n35_), .c(new_n51_), .O(new_n64_));
