...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_, new_n45_,
    new_n46_, new_n47_, new_n49_, new_n51_, new_n53_, new_n55_, new_n56_,
  ...
  nand2  g14(.a(new_n47_), .b(new_n45_), .O(z05));
  ...
  oai21  g21(.a(x10), .b(new_n34_), .c(new_n46_), .O(new_n55_));
  ...
  oai21  g36(.a(x15), .b(new_n34_), .c(new_n46_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z14));
  oai21  g39(.a(x16), .b(new_n34_), .c(new_n46_), .O(new_n73_));
