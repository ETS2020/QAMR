...
module FAU ( 
  ...
  nor2   g15(.a(x10), .b(new_n48_), .O(new_n49_));
  nand2  g16(.a(x08), .b(x00), .O(new_n50_));
  oai21  g17(.a(new_n49_), .b(new_n34_), .c(new_n50_), .O(z08));
  inv1   g18(.a(x10), .O(new_n52_));
  nor2   g19(.a(new_n52_), .b(x09), .O(new_n53_));
  oai21  g20(.a(new_n53_), .b(new_n49_), .c(x01), .O(new_n54_));
  nand2  g21(.a(new_n53_), .b(new_n48_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  inv1   g23(.a(new_n37_), .O(new_n57_));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(z12));
