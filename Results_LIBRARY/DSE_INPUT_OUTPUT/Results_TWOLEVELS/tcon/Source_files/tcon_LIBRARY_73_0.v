...
module FAU ( 
  ...
  nor2   g15(.a(new_n35_), .b(new_n48_), .O(z05));
  inv1   g16(.a(x15), .O(new_n50_));
  aoi21  g17(.a(new_n41_), .b(new_n40_), .c(new_n50_), .O(z06));
  inv1   g18(.a(x16), .O(new_n52_));
  nor2   g19(.a(new_n35_), .b(new_n52_), .O(z07));
  oai21  g20(.a(x09), .b(new_n40_), .c(new_n41_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x00), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z08));
  oai21  g23(.a(x10), .b(new_n40_), .c(new_n41_), .O(new_n57_));
  ...
  oai21  g35(.a(x14), .b(new_n40_), .c(new_n41_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z13));
  oai21  g38(.a(x15), .b(x08), .c(x06), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n42_), .O(z14));
  oai21  g40(.a(x16), .b(new_n40_), .c(new_n41_), .O(new_n74_));
