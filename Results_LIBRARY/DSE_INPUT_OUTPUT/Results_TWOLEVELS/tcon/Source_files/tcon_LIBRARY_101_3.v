...
module FAU ( 
  ...
  nor2   g15(.a(new_n48_), .b(x14), .O(z07));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n50_), .O(z10));
  ...
  nand2  g34(.a(z05), .b(new_n52_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z13));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(x15), .b(new_n52_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n50_), .O(z14));
  nor2   g39(.a(x16), .b(new_n52_), .O(new_n73_));
  oai21  g40(.a(new_n73_), .b(z07), .c(x07), .O(new_n74_));
  nand2  g41(.a(z07), .b(new_n52_), .O(new_n75_));
