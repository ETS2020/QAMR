...
module FAU ( 
  ...
  nor2   g18(.a(x15), .b(new_n48_), .O(new_n52_));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n46_), .O(z10));
  ...
  nor2   g34(.a(new_n67_), .b(x10), .O(new_n68_));
  oai21  g35(.a(new_n68_), .b(new_n52_), .c(x06), .O(new_n69_));
