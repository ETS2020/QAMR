...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x07), .O(new_n40_));
  ...
  aoi21  g36(.a(x08), .b(new_n35_), .c(x14), .O(new_n70_));
  ...
  oai21  g42(.a(new_n39_), .b(x08), .c(x07), .O(new_n76_));
  oai21  g43(.a(new_n51_), .b(x08), .c(new_n76_), .O(z15));
endmodule
