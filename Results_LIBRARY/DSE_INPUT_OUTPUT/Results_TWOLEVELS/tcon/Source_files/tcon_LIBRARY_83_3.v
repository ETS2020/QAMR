...
module FAU ( 
  ...
  oai21  g17(.a(x16), .b(x00), .c(x08), .O(new_n51_));
  nand2  g18(.a(x09), .b(new_n48_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z08));
  oai21  g20(.a(x16), .b(x01), .c(x08), .O(new_n54_));
  ...
  nand3  g39(.a(new_n72_), .b(x08), .c(x07), .O(new_n73_));
  nand2  g40(.a(new_n73_), .b(new_n49_), .O(z15));
endmodule
