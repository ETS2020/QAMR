...
module FAU ( 
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n34_), .O(z08));
  nand2  g21(.a(x10), .b(new_n51_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n34_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n51_), .O(new_n59_));
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n47_), .O(z10));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n47_), .O(z12));
  inv1   g33(.a(x06), .O(new_n67_));
  nand2  g34(.a(new_n44_), .b(new_n51_), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(x05), .O(new_n69_));
  inv1   g36(.a(x05), .O(new_n70_));
  nand3  g37(.a(x14), .b(new_n51_), .c(new_n70_), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n69_), .O(z13));
  oai21  g39(.a(x08), .b(x05), .c(x06), .O(new_n73_));
  oai21  g40(.a(new_n46_), .b(x08), .c(new_n73_), .O(z14));
