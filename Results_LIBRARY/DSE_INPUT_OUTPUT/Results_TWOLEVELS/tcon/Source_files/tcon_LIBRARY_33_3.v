...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n41_, new_n42_, new_n46_, new_n48_,
  ...
  oai21  g14(.a(x13), .b(x00), .c(x08), .O(new_n48_));
  nand2  g15(.a(x09), .b(new_n41_), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n48_), .O(z08));
  oai21  g17(.a(x13), .b(x01), .c(x08), .O(new_n51_));
  nand2  g18(.a(x10), .b(new_n41_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z09));
  oai21  g20(.a(x13), .b(x02), .c(x08), .O(new_n54_));
  nand2  g21(.a(x11), .b(new_n41_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z10));
  oai21  g23(.a(x13), .b(x03), .c(x08), .O(new_n57_));
  nand2  g24(.a(x12), .b(new_n41_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z11));
  inv1   g26(.a(x13), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(x08), .c(x04), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n42_), .O(z12));
  nand2  g29(.a(x14), .b(new_n41_), .O(new_n63_));
  nand3  g30(.a(new_n60_), .b(x08), .c(x05), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  oai21  g32(.a(x13), .b(x06), .c(x08), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n41_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z14));
  nand2  g35(.a(x16), .b(new_n41_), .O(new_n69_));
  nand3  g36(.a(new_n60_), .b(x08), .c(x07), .O(new_n70_));
