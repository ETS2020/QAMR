...
module FAU ( 
  ...
  aoi21  g05(.a(x14), .b(new_n37_), .c(new_n38_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  aoi21  g07(.a(x14), .b(new_n37_), .c(new_n40_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(x14), .b(new_n37_), .c(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  aoi21  g11(.a(x14), .b(new_n37_), .c(new_n44_), .O(z04));
  nor2   g12(.a(new_n35_), .b(new_n37_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  aoi21  g14(.a(x14), .b(new_n37_), .c(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  aoi21  g16(.a(x14), .b(new_n37_), .c(new_n49_), .O(z07));
  nand2  g17(.a(x08), .b(x00), .O(new_n51_));
  nand3  g18(.a(new_n35_), .b(x09), .c(new_n37_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z08));
  nor2   g20(.a(x14), .b(x10), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  oai21  g22(.a(new_n54_), .b(x08), .c(new_n55_), .O(z09));
  nor2   g23(.a(x14), .b(x11), .O(new_n57_));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  oai21  g25(.a(new_n57_), .b(x08), .c(new_n58_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand3  g27(.a(new_n35_), .b(x12), .c(new_n37_), .O(new_n61_));
  ...
  oai21  g33(.a(new_n35_), .b(x08), .c(new_n66_), .O(z13));
  nor2   g34(.a(x15), .b(x14), .O(new_n68_));
