...
module FAU ( 
  ...
  aoi21  g05(.a(new_n35_), .b(x02), .c(new_n38_), .O(z01));
  inv1   g06(.a(x11), .O(new_n40_));
  nand2  g07(.a(new_n36_), .b(new_n40_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(new_n35_), .b(x02), .c(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  nand2  g11(.a(new_n36_), .b(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(new_n35_), .b(x02), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n36_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  aoi21  g17(.a(new_n35_), .b(x02), .c(new_n50_), .O(z07));
  ...
  nand3  g27(.a(x12), .b(new_n35_), .c(new_n53_), .O(new_n61_));
  ...
  nand3  g33(.a(x14), .b(new_n35_), .c(new_n53_), .O(new_n67_));
  ...
  nor2   g38(.a(x16), .b(x02), .O(new_n72_));
