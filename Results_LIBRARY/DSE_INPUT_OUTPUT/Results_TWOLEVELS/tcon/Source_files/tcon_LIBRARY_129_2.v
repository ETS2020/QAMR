...
module FAU ( 
  ...
  nand2  g27(.a(x13), .b(x08), .O(new_n61_));
  oai22  g28(.a(new_n61_), .b(new_n60_), .c(new_n42_), .d(x08), .O(z11));
  oai21  g29(.a(new_n51_), .b(x04), .c(x13), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n40_), .O(z12));
  ...
  oai22  g35(.a(new_n61_), .b(new_n68_), .c(new_n46_), .d(x08), .O(z14));
  inv1   g36(.a(x07), .O(new_n70_));
  oai22  g37(.a(new_n61_), .b(new_n70_), .c(new_n48_), .d(x08), .O(z15));
  buf    g38(.a(x13), .O(z04));
endmodule
