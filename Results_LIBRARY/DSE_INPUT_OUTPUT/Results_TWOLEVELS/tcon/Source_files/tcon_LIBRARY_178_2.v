...
module FAU ( 
  ...
  aoi21  g11(.a(new_n35_), .b(x05), .c(new_n44_), .O(z05));
  ...
  aoi21  g19(.a(x08), .b(new_n47_), .c(x09), .O(new_n53_));
  ...
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n48_), .O(z11));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(x13), .b(new_n54_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n48_), .O(z12));
  oai21  g35(.a(x14), .b(x08), .c(x09), .O(new_n69_));
  nand3  g36(.a(x14), .b(new_n54_), .c(new_n47_), .O(new_n70_));
  oai21  g37(.a(new_n69_), .b(new_n47_), .c(new_n70_), .O(z13));
