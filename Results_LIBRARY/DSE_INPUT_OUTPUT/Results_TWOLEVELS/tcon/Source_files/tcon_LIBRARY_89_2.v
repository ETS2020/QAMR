...
module FAU ( 
  ...
  nand2  g12(.a(new_n45_), .b(new_n35_), .O(z05));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n41_), .O(z12));
  ...
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n41_), .O(z15));
  buf    g44(.a(x11), .O(z02));
endmodule
