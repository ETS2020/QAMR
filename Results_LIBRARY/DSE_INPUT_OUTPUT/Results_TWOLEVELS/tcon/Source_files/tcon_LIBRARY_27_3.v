...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n40_, new_n46_, new_n48_,
  ...
  nand2  g01(.a(x16), .b(x01), .O(new_n35_));
  ...
  nor2   g13(.a(new_n46_), .b(x01), .O(z07));
  ...
  oai21  g18(.a(x16), .b(x08), .c(x01), .O(new_n52_));
  oai21  g19(.a(new_n37_), .b(x08), .c(new_n52_), .O(z09));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n38_), .O(z11));
  ...
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n38_), .O(z13));
  nand2  g32(.a(x15), .b(new_n48_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n35_), .O(z14));
  inv1   g35(.a(x01), .O(new_n69_));
  inv1   g36(.a(x07), .O(new_n70_));
  nand2  g37(.a(x08), .b(new_n70_), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(x16), .c(new_n69_), .O(new_n72_));
  nand3  g39(.a(new_n46_), .b(x08), .c(x07), .O(new_n73_));
