...
module FAU ( 
  ...
  nand2  g01(.a(x09), .b(x03), .O(new_n35_));
  ...
  nor2   g15(.a(new_n48_), .b(x03), .O(new_n49_));
  inv1   g16(.a(x08), .O(new_n50_));
  nor2   g17(.a(x09), .b(new_n50_), .O(new_n51_));
  oai21  g18(.a(new_n51_), .b(new_n49_), .c(x00), .O(new_n52_));
  inv1   g19(.a(x03), .O(new_n53_));
  nand3  g20(.a(x09), .b(new_n50_), .c(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n52_), .O(z08));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand2  g23(.a(x10), .b(new_n50_), .O(new_n57_));
  ...
  oai21  g28(.a(x09), .b(x08), .c(x03), .O(new_n62_));
  oai21  g29(.a(new_n39_), .b(x08), .c(new_n62_), .O(z11));
