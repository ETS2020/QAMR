...
module FAU ( 
  ...
  inv1   g09(.a(new_n36_), .O(new_n43_));
  nand2  g10(.a(new_n43_), .b(new_n42_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nand2  g12(.a(new_n43_), .b(new_n45_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  nand2  g14(.a(new_n43_), .b(new_n47_), .O(z06));
  inv1   g15(.a(x16), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n35_), .O(z07));
  inv1   g17(.a(x08), .O(new_n51_));
  nand2  g18(.a(x09), .b(new_n51_), .O(new_n52_));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(z08));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand2  g22(.a(x10), .b(new_n51_), .O(new_n56_));
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n36_), .O(z09));
  nand2  g24(.a(x16), .b(x11), .O(new_n58_));
  oai21  g25(.a(x11), .b(new_n51_), .c(new_n58_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(x02), .O(new_n60_));
  nand3  g27(.a(x16), .b(x11), .c(new_n51_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z10));
  nand2  g29(.a(x12), .b(new_n51_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x03), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n43_), .O(z11));
  nand2  g32(.a(x13), .b(new_n51_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x04), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n43_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n51_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n51_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n36_), .O(z14));
  nand2  g41(.a(x16), .b(new_n51_), .O(new_n75_));
  nand2  g42(.a(x08), .b(x07), .O(new_n76_));
  nand3  g43(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z15));
  buf    g44(.a(x11), .O(z02));
endmodule
