...
module FAU ( 
  ...
  aoi21  g17(.a(x15), .b(new_n35_), .c(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nand3  g19(.a(new_n48_), .b(x09), .c(new_n35_), .O(new_n53_));
  ...
  and2   g36(.a(x08), .b(x06), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand3  g38(.a(x16), .b(new_n48_), .c(new_n35_), .O(new_n72_));
