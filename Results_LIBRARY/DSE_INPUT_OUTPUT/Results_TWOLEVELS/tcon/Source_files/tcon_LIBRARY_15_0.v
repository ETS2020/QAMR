...
module FAU ( 
  ...
  aoi21  g16(.a(new_n36_), .b(new_n35_), .c(new_n49_), .O(z07));
  oai21  g17(.a(new_n36_), .b(x09), .c(new_n35_), .O(new_n51_));
  ...
  nand2  g27(.a(x13), .b(x12), .O(new_n61_));
  oai21  g28(.a(new_n61_), .b(x08), .c(new_n60_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  oai21  g30(.a(new_n36_), .b(x08), .c(new_n63_), .O(z12));
