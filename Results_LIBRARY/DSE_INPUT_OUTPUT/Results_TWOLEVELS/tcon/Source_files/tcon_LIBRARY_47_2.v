...
module FAU ( 
  ...
  nand2  g19(.a(x09), .b(new_n39_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z08));
  oai21  g21(.a(new_n35_), .b(x01), .c(x08), .O(new_n55_));
  nand2  g22(.a(x10), .b(new_n39_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  oai21  g24(.a(new_n39_), .b(x02), .c(x11), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n42_), .O(z10));
  oai21  g26(.a(new_n35_), .b(x03), .c(x08), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n39_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  inv1   g29(.a(x04), .O(new_n63_));
  nand2  g30(.a(x11), .b(x08), .O(new_n64_));
  oai22  g31(.a(new_n64_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z12));
  oai21  g32(.a(new_n35_), .b(x05), .c(x08), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n39_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  oai22  g36(.a(new_n64_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z14));
  inv1   g37(.a(x07), .O(new_n71_));
  oai22  g38(.a(new_n64_), .b(new_n71_), .c(new_n50_), .d(x08), .O(z15));
endmodule
