...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x14), .b(x09), .O(new_n37_));
  ...
  aoi21  g17(.a(x14), .b(x08), .c(x09), .O(new_n51_));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(z10));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n48_), .O(z14));
