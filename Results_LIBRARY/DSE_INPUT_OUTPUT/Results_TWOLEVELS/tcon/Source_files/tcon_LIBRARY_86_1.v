...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n47_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_,
  ...
  oai21  g19(.a(new_n50_), .b(new_n49_), .c(new_n52_), .O(z08));
  ...
  oai21  g33(.a(x14), .b(new_n51_), .c(new_n66_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(x05), .O(new_n68_));
  nand3  g35(.a(x14), .b(x09), .c(new_n51_), .O(new_n69_));
