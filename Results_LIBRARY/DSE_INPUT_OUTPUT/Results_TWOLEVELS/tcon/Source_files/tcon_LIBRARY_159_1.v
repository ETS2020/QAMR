...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(x00), .O(new_n44_));
  ...
  nand3  g20(.a(new_n43_), .b(x09), .c(new_n53_), .O(new_n54_));
  ...
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n44_), .O(z11));
  inv1   g31(.a(x04), .O(new_n65_));
  nand2  g32(.a(x08), .b(new_n65_), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(x13), .c(x00), .O(new_n67_));
  nand3  g34(.a(new_n43_), .b(x08), .c(x04), .O(new_n68_));
