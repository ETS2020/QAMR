...
module FAU ( 
  ...
  aoi21  g12(.a(x04), .b(new_n44_), .c(new_n45_), .O(z04));
  ...
  nand2  g18(.a(x04), .b(new_n44_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z07));
  inv1   g20(.a(x08), .O(new_n54_));
  nand2  g21(.a(x09), .b(new_n54_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x00), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n52_), .O(z08));
  nand2  g24(.a(x10), .b(new_n54_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x01), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n52_), .O(z09));
