...
module FAU ( 
  ...
  nand2  g12(.a(new_n45_), .b(x04), .O(new_n46_));
  nand2  g13(.a(new_n46_), .b(new_n44_), .O(z04));
  inv1   g14(.a(x14), .O(new_n48_));
  nand2  g15(.a(new_n46_), .b(new_n48_), .O(z05));
  nand2  g16(.a(new_n45_), .b(new_n35_), .O(z06));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(z09));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n46_), .O(z13));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n66_), .c(new_n46_), .O(z14));
