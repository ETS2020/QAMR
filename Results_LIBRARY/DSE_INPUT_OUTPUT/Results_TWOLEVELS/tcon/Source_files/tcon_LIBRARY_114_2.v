...
module FAU ( 
  ...
  oai22  g27(.a(new_n51_), .b(new_n60_), .c(new_n42_), .d(x08), .O(z11));
  oai21  g28(.a(new_n35_), .b(x04), .c(x08), .O(new_n62_));
  nand2  g29(.a(x13), .b(new_n54_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  oai21  g31(.a(new_n54_), .b(x05), .c(x14), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n36_), .O(z13));
