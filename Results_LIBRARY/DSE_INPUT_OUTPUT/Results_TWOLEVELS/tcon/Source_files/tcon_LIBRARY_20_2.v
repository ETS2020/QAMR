...
module FAU ( 
  ...
  nor2   g07(.a(x14), .b(new_n34_), .O(new_n41_));
  ...
  nand2  g13(.a(new_n35_), .b(new_n34_), .O(z05));
  ...
  aoi21  g27(.a(new_n60_), .b(new_n59_), .c(new_n41_), .O(z10));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n41_), .O(z12));
  ...
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n41_), .O(z15));
endmodule
