...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x06), .O(new_n35_));
  ...
  nor2   g11(.a(new_n44_), .b(x06), .O(z05));
  ...
  and2   g20(.a(x14), .b(x06), .O(new_n54_));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n54_), .O(z12));
  oai21  g33(.a(new_n50_), .b(x06), .c(x14), .O(new_n67_));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z13));
  oai21  g36(.a(x14), .b(x08), .c(x06), .O(new_n70_));
  oai21  g37(.a(new_n46_), .b(x08), .c(new_n70_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n50_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n54_), .O(z15));
endmodule
