...
module FAU ( 
  ...
  nand3  g16(.a(new_n35_), .b(x08), .c(x01), .O(new_n50_));
  inv1   g17(.a(x16), .O(new_n51_));
  nand3  g18(.a(new_n51_), .b(x10), .c(new_n46_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z09));
  and2   g20(.a(x16), .b(x10), .O(new_n54_));
  ...
  oai21  g36(.a(x10), .b(new_n46_), .c(x16), .O(new_n70_));
