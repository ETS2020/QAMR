...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n41_, new_n43_, new_n46_, new_n47_, new_n48_,
    ...
    new_n70_;
  nand2  g00(.a(x15), .b(x10), .O(new_n34_));
  and2   g01(.a(new_n34_), .b(x09), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x15), .b(new_n36_), .O(z01));
  ...
  nor2   g10(.a(new_n43_), .b(x10), .O(z06));
  ...
  nor2   g17(.a(x15), .b(new_n48_), .O(new_n51_));
  nand2  g18(.a(x08), .b(x01), .O(new_n52_));
  oai21  g19(.a(new_n51_), .b(new_n36_), .c(new_n52_), .O(z09));
  ...
  oai21  g32(.a(new_n51_), .b(z06), .c(x06), .O(new_n66_));
  nand2  g33(.a(z06), .b(new_n48_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  nand2  g36(.a(x16), .b(new_n48_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z15));
endmodule
