...
module FAU ( 
  ...
  nand2  g13(.a(x15), .b(x13), .O(new_n47_));
  ...
  oai21  g37(.a(x15), .b(new_n51_), .c(new_n47_), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(x06), .O(new_n72_));
  nand2  g39(.a(z06), .b(new_n51_), .O(new_n73_));
