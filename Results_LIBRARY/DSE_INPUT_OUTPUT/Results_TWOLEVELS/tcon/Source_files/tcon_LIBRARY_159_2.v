// Benchmark "FAU" written by ABC on Wed Aug 19 20:51:23 2020
...
module FAU ( 
  ...
  nand2  g02(.a(new_n35_), .b(x00), .O(new_n36_));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n36_), .O(z13));
  ...
  aoi21  g44(.a(new_n77_), .b(new_n76_), .c(new_n44_), .O(z15));
endmodule
