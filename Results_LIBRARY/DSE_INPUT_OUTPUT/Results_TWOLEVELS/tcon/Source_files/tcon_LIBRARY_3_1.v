...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n47_, new_n49_, new_n51_, new_n52_, new_n53_, new_n54_,
  ...
  nor2   g12(.a(new_n39_), .b(new_n35_), .O(z05));
  ...
  aoi21  g18(.a(new_n39_), .b(x08), .c(x09), .O(new_n52_));
