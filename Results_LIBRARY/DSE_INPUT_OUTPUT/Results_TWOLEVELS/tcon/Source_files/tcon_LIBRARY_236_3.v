...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n41_, new_n43_, new_n45_, new_n48_,
  ...
  oai21  g24(.a(new_n38_), .b(x08), .c(new_n57_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n56_), .O(new_n59_));
  inv1   g26(.a(x02), .O(new_n60_));
  nand3  g27(.a(x11), .b(new_n48_), .c(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n59_), .O(z10));
  nand2  g29(.a(x12), .b(new_n48_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x03), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n34_), .O(z11));
  oai21  g32(.a(x13), .b(x08), .c(x04), .O(new_n66_));
  nand3  g33(.a(x13), .b(new_n48_), .c(new_n56_), .O(new_n67_));
  oai21  g34(.a(new_n66_), .b(x02), .c(new_n67_), .O(z12));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n48_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n52_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n48_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n52_), .O(z14));
  nand2  g41(.a(x16), .b(new_n48_), .O(new_n75_));
