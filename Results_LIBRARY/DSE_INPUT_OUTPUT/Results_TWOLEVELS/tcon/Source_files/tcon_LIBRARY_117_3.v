...
module FAU ( 
  ...
  oai21  g20(.a(x14), .b(x02), .c(x08), .O(new_n54_));
  ...
  nand2  g30(.a(new_n63_), .b(new_n48_), .O(z13));
  oai21  g31(.a(x14), .b(x06), .c(x08), .O(new_n65_));
  nand2  g32(.a(x15), .b(new_n46_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z14));
  oai21  g34(.a(x14), .b(x07), .c(x08), .O(new_n68_));
