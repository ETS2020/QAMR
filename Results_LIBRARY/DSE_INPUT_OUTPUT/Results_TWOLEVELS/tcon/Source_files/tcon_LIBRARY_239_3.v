...
module FAU ( 
  ...
  oai21  g22(.a(x16), .b(x08), .c(x02), .O(new_n56_));
  oai21  g23(.a(new_n39_), .b(x08), .c(new_n56_), .O(z10));
  nand2  g24(.a(x12), .b(new_n50_), .O(new_n58_));
  ...
  inv1   g36(.a(x02), .O(new_n70_));
  inv1   g37(.a(x07), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n71_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(x16), .c(new_n70_), .O(new_n73_));
  inv1   g40(.a(x16), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(x08), .c(x07), .O(new_n75_));
  nand2  g42(.a(new_n75_), .b(new_n73_), .O(z15));
  buf    g43(.a(x16), .O(z07));
endmodule
