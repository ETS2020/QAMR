...
module FAU ( 
  ...
  aoi21  g07(.a(new_n35_), .b(x02), .c(new_n40_), .O(z02));
  ...
  nor2   g22(.a(x13), .b(new_n44_), .O(new_n56_));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  nand2  g24(.a(x10), .b(new_n52_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z09));
  oai21  g26(.a(x11), .b(x08), .c(x13), .O(new_n60_));
  nand3  g27(.a(x11), .b(new_n52_), .c(new_n44_), .O(new_n61_));
  oai21  g28(.a(new_n60_), .b(new_n44_), .c(new_n61_), .O(z10));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n56_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n52_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n56_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n52_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n56_), .O(z15));
endmodule
