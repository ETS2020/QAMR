...
module FAU ( 
  ...
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n41_), .O(z11));
  nand2  g30(.a(x13), .b(x05), .O(new_n64_));
  oai21  g31(.a(x13), .b(new_n52_), .c(new_n64_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(x04), .O(new_n66_));
  nand3  g33(.a(x13), .b(new_n52_), .c(x05), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z12));
  oai21  g35(.a(x14), .b(x08), .c(x05), .O(new_n69_));
  nand3  g36(.a(x14), .b(new_n35_), .c(new_n52_), .O(new_n70_));
