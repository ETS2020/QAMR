...
module FAU ( 
  ...
  aoi21  g06(.a(new_n39_), .b(x01), .c(new_n38_), .O(z01));
  inv1   g07(.a(x11), .O(new_n41_));
  nor2   g08(.a(new_n36_), .b(new_n41_), .O(z02));
  inv1   g09(.a(x12), .O(new_n43_));
  nand2  g10(.a(new_n39_), .b(x01), .O(new_n44_));
  nand2  g11(.a(new_n44_), .b(new_n43_), .O(z03));
  ...
  oai21  g22(.a(x10), .b(x08), .c(x14), .O(new_n56_));
  nand3  g23(.a(x10), .b(new_n52_), .c(new_n35_), .O(new_n57_));
  oai21  g24(.a(new_n56_), .b(new_n35_), .c(new_n57_), .O(z09));
  ...
  aoi21  g35(.a(x08), .b(new_n35_), .c(x14), .O(new_n69_));
