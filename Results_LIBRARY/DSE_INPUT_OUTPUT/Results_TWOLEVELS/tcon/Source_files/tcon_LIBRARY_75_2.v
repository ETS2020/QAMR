...
module FAU ( 
  ...
  oai21  g21(.a(new_n38_), .b(x01), .c(x10), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n36_), .O(z09));
  ...
  nand3  g32(.a(x10), .b(x08), .c(x05), .O(new_n66_));
  oai21  g33(.a(new_n46_), .b(x08), .c(new_n66_), .O(z13));
