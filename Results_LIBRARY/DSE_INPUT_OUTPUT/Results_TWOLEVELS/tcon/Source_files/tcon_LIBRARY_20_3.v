...
module FAU ( 
  ...
  nand3  g19(.a(new_n52_), .b(new_n51_), .c(new_n37_), .O(z09));
  and2   g20(.a(x14), .b(x09), .O(new_n54_));
  ...
  oai21  g30(.a(x09), .b(new_n47_), .c(x14), .O(new_n64_));
