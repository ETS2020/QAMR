...
module FAU ( 
  ...
  aoi21  g18(.a(new_n39_), .b(x07), .c(new_n51_), .O(z07));
  ...
  oai21  g41(.a(x16), .b(x08), .c(x13), .O(new_n75_));
  nand3  g42(.a(x16), .b(new_n53_), .c(new_n35_), .O(new_n76_));
  oai21  g43(.a(new_n75_), .b(new_n35_), .c(new_n76_), .O(z15));
endmodule
