...
module FAU ( 
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n39_), .O(z11));
  nand2  g31(.a(x13), .b(new_n49_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n39_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n49_), .O(new_n69_));
  ...
  nand2  g41(.a(x16), .b(new_n49_), .O(new_n75_));
