...
module FAU ( 
  ...
  nor2   g21(.a(x15), .b(new_n48_), .O(new_n55_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z11));
  ...
  inv1   g33(.a(x15), .O(new_n67_));
  nor2   g34(.a(new_n67_), .b(x11), .O(new_n68_));
  oai21  g35(.a(new_n68_), .b(new_n55_), .c(x06), .O(new_n69_));
  nand2  g36(.a(new_n68_), .b(new_n48_), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n48_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z15));
  buf    g41(.a(x11), .O(z02));
  buf    g42(.a(x15), .O(z06));
endmodule
