...
module FAU ( 
  ...
  nand3  g19(.a(x10), .b(new_n52_), .c(new_n35_), .O(new_n53_));
  ...
  nand3  g25(.a(x12), .b(new_n52_), .c(new_n35_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z11));
  nand2  g27(.a(x08), .b(x04), .O(new_n61_));
  nand3  g28(.a(x13), .b(new_n52_), .c(new_n35_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand3  g31(.a(x14), .b(new_n52_), .c(new_n35_), .O(new_n65_));
  ...
  nand3  g37(.a(x16), .b(new_n52_), .c(new_n35_), .O(new_n71_));
