...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n38_, new_n41_, new_n46_, new_n47_, new_n48_,
  ...
  nor2   g08(.a(new_n41_), .b(x03), .O(z04));
  ...
  nand3  g23(.a(new_n35_), .b(x12), .c(new_n48_), .O(new_n57_));
  nand3  g24(.a(new_n41_), .b(x08), .c(x03), .O(new_n58_));
  ...
  nand3  g29(.a(new_n62_), .b(x13), .c(new_n60_), .O(new_n63_));
  nand3  g30(.a(new_n41_), .b(x08), .c(x04), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x14), .b(new_n48_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n46_), .O(z13));
