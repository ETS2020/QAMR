...
module FAU ( 
  ...
  nand2  g01(.a(x12), .b(x06), .O(new_n35_));
  ...
  and2   g12(.a(x12), .b(x06), .O(new_n46_));
  ...
  aoi21  g18(.a(new_n51_), .b(new_n49_), .c(new_n46_), .O(z08));
  ...
  oai21  g25(.a(new_n50_), .b(x06), .c(x12), .O(new_n59_));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n46_), .O(z13));
  oai21  g34(.a(x12), .b(x08), .c(x06), .O(new_n68_));
  oai21  g35(.a(new_n45_), .b(x08), .c(new_n68_), .O(z14));
