...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n45_, new_n46_, new_n49_, new_n51_, new_n52_, new_n53_, new_n55_,
  ...
  nor2   g12(.a(x15), .b(new_n45_), .O(new_n46_));
  nor2   g13(.a(new_n46_), .b(new_n44_), .O(z05));
  nand2  g14(.a(new_n35_), .b(new_n45_), .O(z06));
  ...
  aoi21  g20(.a(new_n53_), .b(new_n51_), .c(new_n46_), .O(z08));
  oai21  g21(.a(new_n35_), .b(new_n52_), .c(x10), .O(new_n55_));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n46_), .O(z10));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n46_), .O(z12));
  ...
  aoi21  g37(.a(new_n45_), .b(x08), .c(x15), .O(new_n71_));
  nand2  g38(.a(x15), .b(new_n52_), .O(new_n72_));
  oai21  g39(.a(new_n71_), .b(new_n70_), .c(new_n72_), .O(z14));
