...
module FAU ( 
  ...
  nand2  g04(.a(x11), .b(x10), .O(new_n38_));
  ...
  oai21  g23(.a(x10), .b(new_n53_), .c(new_n38_), .O(new_n57_));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n36_), .O(z11));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n45_), .O(z13));
