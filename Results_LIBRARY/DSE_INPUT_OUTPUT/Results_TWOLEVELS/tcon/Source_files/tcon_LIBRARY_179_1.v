...
module FAU ( 
  ...
  nand2  g15(.a(x15), .b(x11), .O(new_n49_));
  inv1   g16(.a(new_n49_), .O(z06));
  inv1   g17(.a(x16), .O(new_n51_));
  nand2  g18(.a(new_n45_), .b(new_n51_), .O(z07));
  inv1   g19(.a(x08), .O(new_n53_));
  nand2  g20(.a(x09), .b(new_n53_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x00), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n45_), .O(z08));
  ...
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n45_), .O(z10));
  nand2  g29(.a(x12), .b(new_n53_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x03), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n45_), .O(z11));
  ...
  oai21  g38(.a(x15), .b(new_n53_), .c(new_n49_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(x06), .O(new_n73_));
  nand2  g40(.a(z06), .b(new_n53_), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n73_), .O(z14));
  nand2  g42(.a(x16), .b(new_n53_), .O(new_n76_));
  nand2  g43(.a(x08), .b(x07), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n45_), .O(z15));
endmodule
