...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x01), .O(new_n35_));
  nand2  g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  aoi21  g04(.a(x14), .b(x01), .c(new_n37_), .O(z01));
  ...
  nand2  g18(.a(new_n37_), .b(new_n47_), .O(new_n52_));
  ...
  nand2  g30(.a(x13), .b(new_n47_), .O(new_n64_));
  aoi22  g31(.a(new_n64_), .b(new_n63_), .c(x14), .d(x01), .O(z12));
  inv1   g32(.a(x05), .O(new_n66_));
  nand2  g33(.a(x08), .b(new_n66_), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(x14), .c(new_n54_), .O(new_n68_));
  nand3  g35(.a(new_n51_), .b(x08), .c(x05), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z13));
  nand2  g37(.a(x15), .b(new_n47_), .O(new_n71_));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n35_), .O(z14));
  nand2  g40(.a(x16), .b(new_n47_), .O(new_n74_));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n35_), .O(z15));
  buf    g43(.a(x14), .O(z05));
endmodule
