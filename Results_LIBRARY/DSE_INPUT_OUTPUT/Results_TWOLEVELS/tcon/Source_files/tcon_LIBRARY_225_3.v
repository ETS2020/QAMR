...
module FAU ( 
  ...
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n35_), .O(z09));
  nand2  g22(.a(x11), .b(new_n53_), .O(new_n56_));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand3  g24(.a(new_n57_), .b(new_n56_), .c(new_n38_), .O(z10));
  nand2  g25(.a(x12), .b(new_n53_), .O(new_n59_));
  ...
  oai21  g34(.a(new_n53_), .b(x00), .c(x15), .O(new_n68_));
