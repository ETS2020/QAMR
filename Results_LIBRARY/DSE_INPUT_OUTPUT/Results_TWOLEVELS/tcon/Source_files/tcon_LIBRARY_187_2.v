...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_, new_n42_,
    ...
    new_n56_, new_n57_, new_n60_, new_n61_, new_n63_, new_n64_, new_n66_,
  ...
  nand2  g06(.a(new_n39_), .b(x02), .O(new_n40_));
  ...
  oai21  g25(.a(new_n39_), .b(x08), .c(new_n35_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n53_), .O(new_n61_));
  ...
  nand2  g33(.a(x14), .b(new_n53_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n36_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  nand2  g36(.a(x15), .b(new_n53_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n36_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  nand2  g39(.a(x16), .b(new_n53_), .O(new_n73_));
