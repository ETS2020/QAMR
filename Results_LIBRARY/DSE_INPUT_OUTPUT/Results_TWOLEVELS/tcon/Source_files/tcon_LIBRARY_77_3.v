...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n42_, new_n44_, new_n47_,
  ...
  oai21  g15(.a(x08), .b(x07), .c(x00), .O(new_n49_));
  ...
  aoi21  g20(.a(new_n53_), .b(new_n51_), .c(new_n36_), .O(z09));
  nand2  g21(.a(x11), .b(new_n52_), .O(new_n55_));
  ...
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n36_), .O(z12));
  ...
  inv1   g36(.a(x00), .O(new_n70_));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  oai21  g38(.a(new_n47_), .b(x08), .c(new_n71_), .O(new_n72_));
  nand2  g39(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  inv1   g40(.a(x07), .O(new_n74_));
  nand3  g41(.a(x16), .b(new_n52_), .c(new_n74_), .O(new_n75_));
