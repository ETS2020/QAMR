...
module FAU ( 
  ...
  nand3  g19(.a(x10), .b(new_n52_), .c(new_n34_), .O(new_n53_));
  ...
  nand3  g31(.a(x14), .b(new_n52_), .c(new_n34_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand3  g34(.a(x15), .b(new_n52_), .c(new_n34_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand3  g37(.a(x16), .b(new_n52_), .c(new_n34_), .O(new_n71_));
