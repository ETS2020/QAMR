...
module FAU ( 
  ...
  nand2  g27(.a(x14), .b(x12), .O(new_n61_));
  oai21  g28(.a(new_n61_), .b(x08), .c(new_n60_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand2  g30(.a(x14), .b(x13), .O(new_n64_));
  oai21  g31(.a(new_n64_), .b(x08), .c(new_n63_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  oai21  g33(.a(new_n53_), .b(x08), .c(new_n66_), .O(z13));
  oai21  g34(.a(x15), .b(new_n53_), .c(new_n52_), .O(new_n68_));
