...
module FAU ( 
  ...
  oai21  g23(.a(new_n55_), .b(new_n38_), .c(new_n56_), .O(z10));
  inv1   g24(.a(new_n34_), .O(new_n58_));
  ...
  oai21  g34(.a(new_n55_), .b(z06), .c(x06), .O(new_n68_));
  nand2  g35(.a(z06), .b(new_n48_), .O(new_n69_));
