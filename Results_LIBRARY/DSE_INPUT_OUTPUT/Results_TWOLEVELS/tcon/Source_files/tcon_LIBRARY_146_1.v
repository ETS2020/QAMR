...
module FAU ( 
  ...
  nand2  g16(.a(x14), .b(new_n34_), .O(new_n50_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n38_), .O(z09));
  nand2  g26(.a(x11), .b(new_n54_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x02), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n50_), .O(z10));
  nand2  g29(.a(x12), .b(new_n54_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x03), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n50_), .O(z11));
  nand2  g32(.a(x13), .b(new_n54_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x04), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n50_), .O(z12));
  oai21  g35(.a(new_n34_), .b(new_n54_), .c(x14), .O(new_n69_));
  ...
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n50_), .O(z14));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand2  g42(.a(x16), .b(new_n54_), .O(new_n76_));
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n38_), .O(z15));
endmodule
