...
module FAU ( 
  ...
  nor2   g06(.a(x14), .b(new_n39_), .O(z04));
  ...
  nor2   g24(.a(x14), .b(new_n46_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x04), .O(new_n59_));
  oai21  g26(.a(new_n58_), .b(new_n39_), .c(new_n59_), .O(z12));
  inv1   g27(.a(x14), .O(new_n61_));
  nor2   g28(.a(new_n61_), .b(x13), .O(new_n62_));
  oai21  g29(.a(new_n62_), .b(new_n58_), .c(x05), .O(new_n63_));
  nand2  g30(.a(new_n62_), .b(new_n46_), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z13));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n46_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n44_), .O(z14));
