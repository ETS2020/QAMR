...
module FAU ( 
  ...
  nand2  g08(.a(x11), .b(new_n34_), .O(new_n42_));
  ...
  nand3  g19(.a(new_n39_), .b(x09), .c(new_n34_), .O(new_n53_));
  ...
  nand3  g27(.a(x12), .b(new_n39_), .c(new_n34_), .O(new_n61_));
