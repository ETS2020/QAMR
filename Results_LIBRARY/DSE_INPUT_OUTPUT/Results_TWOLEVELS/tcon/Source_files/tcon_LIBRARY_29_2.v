...
module FAU ( 
  ...
  nor2   g02(.a(x06), .b(new_n35_), .O(new_n36_));
  nor2   g03(.a(new_n36_), .b(new_n34_), .O(z00));
  inv1   g04(.a(x10), .O(new_n38_));
  inv1   g05(.a(x06), .O(new_n39_));
  nand2  g06(.a(new_n39_), .b(x04), .O(new_n40_));
  ...
  aoi21  g13(.a(new_n39_), .b(x04), .c(new_n46_), .O(z04));
  ...
  oai21  g33(.a(x13), .b(x08), .c(x06), .O(new_n67_));
  nand3  g34(.a(x13), .b(new_n55_), .c(new_n35_), .O(new_n68_));
  oai21  g35(.a(new_n67_), .b(new_n35_), .c(new_n68_), .O(z12));
