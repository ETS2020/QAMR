...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n37_, new_n41_, new_n44_, new_n45_, new_n46_, new_n48_,
  ...
  oai21  g20(.a(x11), .b(x03), .c(x08), .O(new_n54_));
  nand2  g21(.a(x12), .b(new_n45_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z11));
  nand2  g23(.a(x13), .b(new_n45_), .O(new_n57_));
  ...
  nand2  g32(.a(x16), .b(new_n45_), .O(new_n66_));
  nand3  g33(.a(new_n51_), .b(x08), .c(x07), .O(new_n67_));
