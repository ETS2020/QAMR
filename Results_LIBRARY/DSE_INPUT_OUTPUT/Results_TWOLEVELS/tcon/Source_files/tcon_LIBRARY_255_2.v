...
module FAU ( 
  ...
  nand2  g18(.a(new_n51_), .b(new_n38_), .O(z08));
  ...
  oai22  g23(.a(new_n54_), .b(new_n56_), .c(new_n37_), .d(x08), .O(z10));
  oai21  g24(.a(new_n34_), .b(x03), .c(x08), .O(new_n58_));
  ...
  oai22  g31(.a(new_n54_), .b(new_n64_), .c(new_n44_), .d(x08), .O(z13));
  ...
  oai22  g36(.a(new_n54_), .b(new_n69_), .c(new_n48_), .d(x08), .O(z15));
  buf    g37(.a(x09), .O(z00));
endmodule
