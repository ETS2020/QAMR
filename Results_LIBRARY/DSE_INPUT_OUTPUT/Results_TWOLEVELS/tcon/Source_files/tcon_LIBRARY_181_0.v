...
module FAU ( 
  ...
  aoi21  g06(.a(new_n34_), .b(new_n36_), .c(new_n39_), .O(z02));
  inv1   g07(.a(x12), .O(new_n41_));
  nand2  g08(.a(new_n34_), .b(new_n36_), .O(new_n42_));
  ...
  oai21  g29(.a(x13), .b(new_n34_), .c(new_n36_), .O(new_n63_));
  ...
  oai21  g35(.a(x15), .b(new_n34_), .c(new_n36_), .O(new_n69_));
