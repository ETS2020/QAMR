...
module FAU ( 
  ...
  oai21  g31(.a(new_n35_), .b(x08), .c(x04), .O(new_n65_));
  oai21  g32(.a(new_n46_), .b(x08), .c(new_n65_), .O(z12));
  ...
  aoi21  g38(.a(x08), .b(new_n41_), .c(x15), .O(new_n72_));
  oai21  g39(.a(new_n72_), .b(new_n70_), .c(new_n71_), .O(z14));
