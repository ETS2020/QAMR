...
module FAU ( 
  ...
  aoi21  g17(.a(new_n43_), .b(x07), .c(new_n50_), .O(z07));
  ...
  oai21  g40(.a(x16), .b(x08), .c(x15), .O(new_n74_));
  nand3  g41(.a(x16), .b(new_n53_), .c(new_n35_), .O(new_n75_));
  oai21  g42(.a(new_n74_), .b(new_n35_), .c(new_n75_), .O(z15));
  buf    g43(.a(x15), .O(z06));
endmodule
