...
module FAU ( 
  ...
  nand2  g10(.a(new_n37_), .b(new_n43_), .O(z05));
  ...
  nand2  g20(.a(x11), .b(new_n34_), .O(new_n54_));
  ...
  nand2  g26(.a(x13), .b(new_n34_), .O(new_n60_));
  ...
  oai21  g32(.a(x09), .b(x06), .c(x08), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n34_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z14));
  nand2  g35(.a(x16), .b(new_n34_), .O(new_n69_));
  nand3  g36(.a(new_n48_), .b(x08), .c(x07), .O(new_n70_));
