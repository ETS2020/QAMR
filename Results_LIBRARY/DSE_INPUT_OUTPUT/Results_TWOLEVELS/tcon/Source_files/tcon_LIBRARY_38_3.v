...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n38_, new_n41_, new_n43_, new_n44_, new_n46_, new_n47_,
  ...
  nor2   g11(.a(new_n44_), .b(new_n43_), .O(z07));
  inv1   g12(.a(x09), .O(new_n46_));
  nor2   g13(.a(new_n46_), .b(x07), .O(new_n47_));
  inv1   g14(.a(x08), .O(new_n48_));
  nor2   g15(.a(x09), .b(new_n48_), .O(new_n49_));
  oai21  g16(.a(new_n49_), .b(new_n47_), .c(x00), .O(new_n50_));
  inv1   g17(.a(x07), .O(new_n51_));
  nand3  g18(.a(x09), .b(new_n48_), .c(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(z08));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand2  g21(.a(x10), .b(new_n48_), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n54_), .c(new_n44_), .O(z09));
