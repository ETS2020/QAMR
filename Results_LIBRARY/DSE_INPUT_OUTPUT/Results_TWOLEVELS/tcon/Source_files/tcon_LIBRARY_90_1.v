...
module FAU ( 
  ...
  nand3  g18(.a(new_n51_), .b(new_n50_), .c(new_n45_), .O(z08));
  nand2  g19(.a(x10), .b(x09), .O(new_n53_));
  oai21  g20(.a(x10), .b(new_n49_), .c(new_n53_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(x01), .O(new_n55_));
  nand3  g22(.a(x10), .b(x09), .c(new_n49_), .O(new_n56_));
