...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n42_, new_n45_, new_n47_, new_n48_,
  ...
  nor2   g04(.a(new_n37_), .b(x08), .O(z01));
  ...
  nand3  g15(.a(new_n37_), .b(x08), .c(x00), .O(new_n49_));
  nand2  g16(.a(new_n49_), .b(new_n48_), .O(z08));
  inv1   g17(.a(x01), .O(new_n51_));
  oai21  g18(.a(new_n47_), .b(new_n51_), .c(new_n37_), .O(z09));
  ...
  nand3  g23(.a(new_n37_), .b(x08), .c(x03), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z11));
  nand2  g25(.a(x13), .b(new_n47_), .O(new_n59_));
  nand3  g26(.a(new_n37_), .b(x08), .c(x04), .O(new_n60_));
  ...
  nand3  g35(.a(new_n37_), .b(x08), .c(x07), .O(new_n69_));
