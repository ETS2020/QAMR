...
module FAU ( 
  ...
  oai21  g21(.a(new_n34_), .b(new_n52_), .c(x10), .O(new_n55_));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  nor2   g24(.a(new_n35_), .b(x09), .O(new_n58_));
  ...
  aoi21  g30(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(z11));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand2  g32(.a(x13), .b(new_n52_), .O(new_n66_));
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n58_), .O(z12));
  ...
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n58_), .O(z14));
