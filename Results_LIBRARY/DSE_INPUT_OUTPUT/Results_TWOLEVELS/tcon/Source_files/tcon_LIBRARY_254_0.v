...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x10), .O(new_n35_));
  nor2   g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(x15), .b(new_n37_), .O(z01));
  ...
  aoi21  g19(.a(new_n52_), .b(new_n50_), .c(new_n35_), .O(z08));
  nand2  g20(.a(x10), .b(new_n51_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n40_), .O(z09));
  nand2  g23(.a(x11), .b(new_n51_), .O(new_n57_));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n40_), .O(z10));
  nand2  g26(.a(x12), .b(new_n51_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n40_), .O(z11));
  nand2  g29(.a(x08), .b(x04), .O(new_n63_));
  nand2  g30(.a(x13), .b(new_n51_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n35_), .O(z12));
  nand2  g32(.a(x14), .b(new_n51_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n40_), .O(z13));
  inv1   g35(.a(x06), .O(new_n69_));
  aoi21  g36(.a(x10), .b(x08), .c(x15), .O(new_n70_));
  nand2  g37(.a(x15), .b(new_n51_), .O(new_n71_));
  oai21  g38(.a(new_n70_), .b(new_n69_), .c(new_n71_), .O(z14));
  nand2  g39(.a(x08), .b(x07), .O(new_n73_));
  nand2  g40(.a(x16), .b(new_n51_), .O(new_n74_));
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n35_), .O(z15));
  buf    g42(.a(x15), .O(z06));
endmodule
