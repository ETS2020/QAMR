...
module FAU ( 
  ...
  nor2   g04(.a(x10), .b(new_n34_), .O(new_n38_));
  inv1   g05(.a(new_n38_), .O(new_n39_));
  nand2  g06(.a(new_n39_), .b(new_n37_), .O(z02));
