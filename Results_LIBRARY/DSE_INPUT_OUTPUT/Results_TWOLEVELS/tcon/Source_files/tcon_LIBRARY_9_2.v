...
module FAU ( 
  ...
  nor2   g07(.a(x13), .b(new_n34_), .O(new_n41_));
  nor2   g08(.a(new_n41_), .b(new_n40_), .O(z02));
  inv1   g09(.a(x12), .O(new_n43_));
  nor2   g10(.a(new_n41_), .b(new_n43_), .O(z03));
  nand2  g11(.a(new_n35_), .b(new_n34_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nor2   g13(.a(new_n41_), .b(new_n46_), .O(z05));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n41_), .O(z09));
  ...
  aoi21  g32(.a(new_n34_), .b(x08), .c(x13), .O(new_n66_));
