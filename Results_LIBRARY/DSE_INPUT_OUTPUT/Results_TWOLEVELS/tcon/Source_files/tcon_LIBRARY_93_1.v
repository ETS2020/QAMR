...
module FAU ( 
  ...
  nor2   g14(.a(new_n47_), .b(x02), .O(new_n48_));
  nor2   g15(.a(new_n48_), .b(new_n46_), .O(z06));
  ...
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(z08));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n48_), .O(z12));
  inv1   g34(.a(x05), .O(new_n68_));
  nand2  g35(.a(x08), .b(new_n68_), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(x14), .c(x02), .O(new_n70_));
  nand3  g37(.a(new_n47_), .b(x08), .c(x05), .O(new_n71_));
  nand2  g38(.a(new_n71_), .b(new_n70_), .O(z13));
  ...
  aoi21  g44(.a(new_n77_), .b(new_n76_), .c(new_n48_), .O(z15));
  buf    g45(.a(x14), .O(z05));
endmodule
