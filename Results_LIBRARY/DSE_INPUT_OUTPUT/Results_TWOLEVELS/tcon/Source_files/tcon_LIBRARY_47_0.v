...
module FAU ( 
  ...
  oai21  g08(.a(x11), .b(x08), .c(new_n41_), .O(z03));
  ...
  oai21  g18(.a(new_n39_), .b(x09), .c(new_n51_), .O(new_n52_));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z08));
  oai21  g21(.a(new_n39_), .b(x10), .c(new_n51_), .O(new_n55_));
  ...
  oai21  g26(.a(x12), .b(new_n39_), .c(new_n51_), .O(new_n60_));
  ...
  oai21  g32(.a(x14), .b(new_n39_), .c(new_n51_), .O(new_n66_));
