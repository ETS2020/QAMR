...
module FAU ( 
  ...
  nand2  g11(.a(new_n44_), .b(x05), .O(z04));
  ...
  aoi21  g32(.a(x08), .b(x05), .c(x13), .O(new_n66_));
  nand2  g33(.a(x13), .b(new_n53_), .O(new_n67_));
  oai21  g34(.a(new_n66_), .b(new_n65_), .c(new_n67_), .O(z12));
  oai21  g35(.a(x14), .b(x08), .c(x05), .O(new_n69_));
  nand3  g36(.a(x14), .b(x13), .c(new_n53_), .O(new_n70_));
