...
module FAU ( 
  ...
  aoi21  g02(.a(x13), .b(new_n35_), .c(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(x13), .b(new_n35_), .O(new_n38_));
  nand2  g05(.a(new_n38_), .b(new_n37_), .O(z01));
  inv1   g06(.a(x13), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n35_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(x13), .b(new_n35_), .c(new_n42_), .O(z03));
  nor2   g10(.a(new_n40_), .b(new_n35_), .O(z04));
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n38_), .O(z08));
  ...
  nand3  g26(.a(new_n59_), .b(new_n58_), .c(new_n38_), .O(z10));
  nand2  g27(.a(x12), .b(new_n51_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n38_), .O(z11));
  nand2  g30(.a(x11), .b(x08), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(x13), .O(new_n65_));
