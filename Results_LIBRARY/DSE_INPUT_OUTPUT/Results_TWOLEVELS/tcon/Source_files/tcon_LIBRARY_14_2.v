...
module FAU ( 
  ...
  aoi21  g13(.a(new_n35_), .b(x03), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n36_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  aoi21  g17(.a(new_n35_), .b(x03), .c(new_n50_), .O(z07));
  ...
  nor2   g22(.a(x10), .b(x03), .O(new_n56_));
