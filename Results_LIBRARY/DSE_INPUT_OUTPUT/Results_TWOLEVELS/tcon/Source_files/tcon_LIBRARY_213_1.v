...
module FAU ( 
  ...
  aoi21  g11(.a(x12), .b(new_n35_), .c(new_n44_), .O(z05));
  ...
  nand2  g26(.a(new_n59_), .b(new_n36_), .O(z11));
  nand2  g27(.a(x08), .b(x04), .O(new_n61_));
  inv1   g28(.a(x12), .O(new_n62_));
  nand3  g29(.a(x13), .b(new_n62_), .c(new_n35_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n61_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n62_), .c(new_n35_), .O(new_n66_));
