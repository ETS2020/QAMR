// Benchmark "FAU" written by ABC on Wed Aug 19 20:50:37 2020
...
module FAU ( 
  ...
  nand3  g12(.a(new_n34_), .b(x09), .c(new_n45_), .O(new_n46_));
  ...
  oai21  g18(.a(new_n47_), .b(x08), .c(new_n51_), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand3  g20(.a(new_n47_), .b(x08), .c(x01), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  inv1   g22(.a(new_n34_), .O(new_n56_));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand2  g24(.a(x11), .b(new_n45_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n56_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand2  g27(.a(x12), .b(new_n45_), .O(new_n61_));
  ...
  nand2  g32(.a(x14), .b(new_n45_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n34_), .O(z13));
  ...
  nand2  g39(.a(x16), .b(new_n45_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n56_), .O(z15));
  buf    g41(.a(x10), .O(z01));
endmodule
