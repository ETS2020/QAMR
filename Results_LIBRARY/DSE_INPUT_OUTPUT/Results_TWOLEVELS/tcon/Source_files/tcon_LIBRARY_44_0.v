...
module FAU ( 
  ...
  oai21  g03(.a(x16), .b(x08), .c(new_n36_), .O(z01));
  inv1   g04(.a(x11), .O(new_n38_));
  nor2   g05(.a(x16), .b(x08), .O(new_n39_));
  ...
  nor2   g14(.a(new_n39_), .b(new_n47_), .O(z06));
  ...
  nand2  g36(.a(x16), .b(x15), .O(new_n70_));
  oai21  g37(.a(new_n70_), .b(x08), .c(new_n69_), .O(z14));
  nand2  g38(.a(x08), .b(x07), .O(new_n72_));
  oai21  g39(.a(new_n50_), .b(x08), .c(new_n72_), .O(z15));
  buf    g40(.a(x16), .O(z07));
endmodule
