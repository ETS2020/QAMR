...
module FAU ( 
  ...
  nand2  g11(.a(x16), .b(new_n40_), .O(new_n45_));
  ...
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n45_), .O(z11));
  nand2  g31(.a(x13), .b(new_n51_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n45_), .O(z12));
  ...
  oai21  g40(.a(new_n40_), .b(new_n51_), .c(x16), .O(new_n74_));
