...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x11), .O(z03));
  ...
  nand3  g25(.a(new_n58_), .b(new_n57_), .c(new_n49_), .O(z10));
  nand2  g26(.a(x12), .b(new_n50_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n60_), .c(new_n49_), .O(z11));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n49_), .O(z13));
  nand2  g35(.a(x15), .b(new_n50_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n49_), .O(z14));
