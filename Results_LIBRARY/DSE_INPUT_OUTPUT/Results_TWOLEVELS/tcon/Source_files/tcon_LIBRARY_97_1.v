...
module FAU ( 
  ...
  oai21  g36(.a(new_n42_), .b(x08), .c(new_n69_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand3  g38(.a(x16), .b(new_n42_), .c(new_n34_), .O(new_n72_));
