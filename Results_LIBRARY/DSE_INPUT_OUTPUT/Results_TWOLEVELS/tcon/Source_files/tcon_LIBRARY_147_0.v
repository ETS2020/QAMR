...
module FAU ( 
  ...
  oai21  g06(.a(x11), .b(x08), .c(new_n39_), .O(z03));
  inv1   g07(.a(x13), .O(new_n41_));
  nor2   g08(.a(new_n35_), .b(new_n41_), .O(z04));
  inv1   g09(.a(x14), .O(new_n43_));
  oai21  g10(.a(x11), .b(x08), .c(new_n43_), .O(z05));
  ...
  oai21  g20(.a(new_n50_), .b(x10), .c(new_n49_), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  oai21  g24(.a(new_n50_), .b(x08), .c(new_n57_), .O(z10));
  oai21  g25(.a(x12), .b(new_n50_), .c(new_n49_), .O(new_n59_));
  ...
  nand2  g35(.a(x15), .b(x11), .O(new_n69_));
  oai21  g36(.a(new_n69_), .b(x08), .c(new_n68_), .O(z14));
  nand2  g37(.a(x08), .b(x07), .O(new_n71_));
  nand2  g38(.a(x16), .b(x11), .O(new_n72_));
