...
module FAU ( 
  ...
  nor2   g08(.a(new_n36_), .b(new_n41_), .O(z02));
  ...
  nand3  g20(.a(new_n53_), .b(new_n52_), .c(new_n37_), .O(z08));
  ...
  oai21  g33(.a(x14), .b(new_n51_), .c(new_n47_), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(x05), .O(new_n68_));
  nand2  g35(.a(z05), .b(new_n51_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  aoi21  g38(.a(new_n35_), .b(x08), .c(x15), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n51_), .O(new_n73_));
  oai21  g40(.a(new_n72_), .b(new_n71_), .c(new_n73_), .O(z14));
