...
module FAU ( 
  ...
  nand2  g06(.a(x06), .b(new_n39_), .O(new_n40_));
  ...
  nand2  g15(.a(new_n40_), .b(new_n48_), .O(z05));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n54_), .c(new_n36_), .O(z08));
  ...
  nand3  g34(.a(x13), .b(new_n55_), .c(new_n35_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z12));
  nand2  g36(.a(x14), .b(new_n55_), .O(new_n70_));
  nand2  g37(.a(x08), .b(x05), .O(new_n71_));
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n40_), .O(z13));
  oai21  g39(.a(x08), .b(new_n39_), .c(x06), .O(new_n73_));
  nand2  g40(.a(x15), .b(new_n55_), .O(new_n74_));
