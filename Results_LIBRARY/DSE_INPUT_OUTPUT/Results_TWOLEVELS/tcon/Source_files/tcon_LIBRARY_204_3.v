...
module FAU ( 
  ...
  nand3  g16(.a(new_n41_), .b(x08), .c(x00), .O(new_n50_));
  nand2  g17(.a(new_n50_), .b(new_n49_), .O(z08));
  nand2  g18(.a(x10), .b(new_n48_), .O(new_n52_));
  nand3  g19(.a(new_n41_), .b(x08), .c(x01), .O(new_n53_));
  ...
  oai21  g28(.a(new_n48_), .b(new_n61_), .c(new_n41_), .O(z12));
  nand2  g29(.a(x14), .b(new_n48_), .O(new_n63_));
  nand3  g30(.a(new_n41_), .b(x08), .c(x05), .O(new_n64_));
