...
module FAU ( 
  ...
  nand2  g04(.a(new_n35_), .b(new_n37_), .O(z03));
  inv1   g05(.a(x13), .O(new_n39_));
  nand2  g06(.a(new_n35_), .b(new_n39_), .O(z04));
  ...
  nand3  g13(.a(new_n35_), .b(x08), .c(x00), .O(new_n47_));
  inv1   g14(.a(x08), .O(new_n48_));
  inv1   g15(.a(x10), .O(new_n49_));
  nand3  g16(.a(new_n49_), .b(x09), .c(new_n48_), .O(new_n50_));
  ...
  and2   g21(.a(x10), .b(x09), .O(new_n55_));
