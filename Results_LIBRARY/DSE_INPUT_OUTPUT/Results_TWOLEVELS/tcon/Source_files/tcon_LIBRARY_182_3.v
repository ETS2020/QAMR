...
module FAU ( 
  ...
  and2   g14(.a(x14), .b(x13), .O(new_n48_));
  ...
  nand3  g24(.a(new_n35_), .b(x08), .c(x04), .O(new_n58_));
  inv1   g25(.a(x14), .O(new_n59_));
  nand3  g26(.a(new_n59_), .b(x13), .c(new_n44_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n58_), .O(z12));
  oai21  g28(.a(x13), .b(new_n44_), .c(x14), .O(new_n62_));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n48_), .O(z15));
  buf    g37(.a(x13), .O(z04));
  buf    g38(.a(x14), .O(z05));
endmodule
