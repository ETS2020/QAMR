// Benchmark "FAU" written by ABC on Wed Aug 19 20:51:40 2020
...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_, new_n43_,
    ...
    new_n77_;
  nand2  g00(.a(x09), .b(x03), .O(new_n34_));
  inv1   g01(.a(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  inv1   g03(.a(x09), .O(new_n37_));
  nor2   g04(.a(new_n37_), .b(x03), .O(new_n38_));
  ...
  nor2   g14(.a(new_n38_), .b(new_n47_), .O(z05));
  ...
  nand3  g22(.a(x09), .b(new_n53_), .c(x03), .O(new_n56_));
  ...
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n39_), .O(z10));
  oai21  g30(.a(x12), .b(x08), .c(x03), .O(new_n64_));
  nand3  g31(.a(x12), .b(new_n37_), .c(new_n53_), .O(new_n65_));
  ...
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n39_), .O(z15));
endmodule
