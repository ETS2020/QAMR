...
module FAU ( 
  ...
  and2   g11(.a(x13), .b(x05), .O(new_n45_));
  ...
  inv1   g26(.a(x05), .O(new_n60_));
  nand3  g27(.a(x13), .b(new_n47_), .c(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n59_), .O(z12));
  nand3  g29(.a(new_n34_), .b(x14), .c(new_n47_), .O(new_n63_));
  inv1   g30(.a(x13), .O(new_n64_));
  nand3  g31(.a(new_n64_), .b(x08), .c(x05), .O(new_n65_));
