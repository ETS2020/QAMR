...
module FAU ( 
  ...
  aoi21  g05(.a(new_n35_), .b(x08), .c(new_n38_), .O(z02));
  ...
  aoi21  g17(.a(x08), .b(new_n50_), .c(new_n35_), .O(z08));
  ...
  oai22  g24(.a(new_n57_), .b(new_n56_), .c(new_n38_), .d(x08), .O(z10));
  ...
  nand2  g31(.a(x14), .b(new_n53_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  oai22  g34(.a(new_n57_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z14));
