...
module FAU ( 
  ...
  nor2   g08(.a(new_n41_), .b(x02), .O(new_n42_));
  ...
  oai21  g25(.a(x11), .b(x08), .c(x02), .O(new_n59_));
  nand3  g26(.a(new_n41_), .b(x11), .c(new_n52_), .O(new_n60_));
  ...
  oai21  g31(.a(new_n52_), .b(new_n35_), .c(x13), .O(new_n65_));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n42_), .O(z13));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(x15), .b(new_n52_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n42_), .O(z14));
  nand2  g40(.a(x08), .b(x07), .O(new_n74_));
  nand2  g41(.a(x16), .b(new_n52_), .O(new_n75_));
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n42_), .O(z15));
  buf    g43(.a(x13), .O(z04));
endmodule
