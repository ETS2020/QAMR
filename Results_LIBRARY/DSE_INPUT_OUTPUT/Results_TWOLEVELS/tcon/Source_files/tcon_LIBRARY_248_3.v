...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x10), .O(new_n35_));
  ...
  and2   g07(.a(new_n35_), .b(x15), .O(z06));
  ...
  nor2   g15(.a(x13), .b(new_n45_), .O(new_n49_));
  nand2  g16(.a(x08), .b(x01), .O(new_n50_));
  oai21  g17(.a(new_n49_), .b(new_n48_), .c(new_n50_), .O(z09));
  nand2  g18(.a(x08), .b(x02), .O(new_n52_));
  nand2  g19(.a(x11), .b(new_n45_), .O(new_n53_));
  aoi21  g20(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(z10));
  nand2  g21(.a(x08), .b(x03), .O(new_n55_));
  nand2  g22(.a(x12), .b(new_n45_), .O(new_n56_));
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n43_), .O(z11));
  inv1   g24(.a(x13), .O(new_n58_));
  nor2   g25(.a(new_n58_), .b(x10), .O(new_n59_));
  oai21  g26(.a(new_n59_), .b(new_n49_), .c(x04), .O(new_n60_));
  nand2  g27(.a(new_n59_), .b(new_n45_), .O(new_n61_));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n43_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  nand2  g36(.a(x16), .b(new_n45_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n43_), .O(z15));
  buf    g38(.a(x10), .O(z01));
  buf    g39(.a(x13), .O(z04));
endmodule
