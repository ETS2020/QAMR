...
module FAU ( 
  ...
  nand2  g10(.a(new_n43_), .b(new_n42_), .O(z05));
  inv1   g11(.a(x15), .O(new_n45_));
  nand2  g12(.a(new_n43_), .b(new_n45_), .O(z06));
