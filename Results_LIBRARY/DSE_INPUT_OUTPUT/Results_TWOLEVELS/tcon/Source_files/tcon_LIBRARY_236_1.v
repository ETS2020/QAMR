...
module FAU ( 
  ...
  nand2  g08(.a(x04), .b(new_n41_), .O(new_n42_));
  ...
  aoi21  g13(.a(x04), .b(new_n41_), .c(new_n46_), .O(z04));
  ...
  nor2   g19(.a(new_n36_), .b(new_n52_), .O(z07));
  inv1   g20(.a(x08), .O(new_n54_));
  nand2  g21(.a(x09), .b(new_n54_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x00), .O(new_n56_));
  nand3  g23(.a(new_n56_), .b(new_n55_), .c(new_n42_), .O(z08));
  nand2  g24(.a(x08), .b(x01), .O(new_n58_));
  nand2  g25(.a(x10), .b(new_n54_), .O(new_n59_));
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n36_), .O(z09));
  oai21  g27(.a(x11), .b(x08), .c(x02), .O(new_n61_));
  nand3  g28(.a(x11), .b(new_n54_), .c(new_n35_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z10));
  nand2  g30(.a(x12), .b(new_n54_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n42_), .O(z11));
  oai21  g33(.a(x13), .b(x08), .c(x04), .O(new_n67_));
  nand3  g34(.a(x13), .b(new_n54_), .c(new_n35_), .O(new_n68_));
  oai21  g35(.a(new_n67_), .b(new_n41_), .c(new_n68_), .O(z12));
  nand2  g36(.a(x08), .b(x05), .O(new_n70_));
  nand2  g37(.a(x14), .b(new_n54_), .O(new_n71_));
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n36_), .O(z13));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand2  g40(.a(x15), .b(new_n54_), .O(new_n74_));
