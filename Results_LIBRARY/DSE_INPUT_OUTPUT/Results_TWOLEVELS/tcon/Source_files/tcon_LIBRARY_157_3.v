...
module FAU ( 
  ...
  and2   g01(.a(x13), .b(x00), .O(new_n35_));
  nor2   g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nand2  g04(.a(x13), .b(x00), .O(new_n38_));
  ...
  nor2   g11(.a(new_n44_), .b(x00), .O(z04));
  ...
  oai21  g18(.a(x13), .b(x08), .c(x00), .O(new_n52_));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n54_), .c(new_n35_), .O(z09));
  ...
  oai21  g30(.a(new_n55_), .b(x00), .c(x13), .O(new_n64_));
