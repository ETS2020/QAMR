...
module FAU ( 
  ...
  aoi21  g09(.a(new_n38_), .b(x03), .c(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  nor2   g11(.a(new_n36_), .b(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  nand2  g13(.a(new_n38_), .b(x03), .O(new_n47_));
  ...
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n47_), .O(z08));
  inv1   g23(.a(x01), .O(new_n57_));
  aoi21  g24(.a(x08), .b(new_n35_), .c(x10), .O(new_n58_));
  nand2  g25(.a(x10), .b(new_n53_), .O(new_n59_));
  oai21  g26(.a(new_n58_), .b(new_n57_), .c(new_n59_), .O(z09));
  nand2  g27(.a(x08), .b(x02), .O(new_n61_));
  nand2  g28(.a(x11), .b(new_n53_), .O(new_n62_));
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n36_), .O(z10));
  oai21  g30(.a(x12), .b(x08), .c(x10), .O(new_n64_));
  nand3  g31(.a(x12), .b(new_n53_), .c(new_n35_), .O(new_n65_));
  oai21  g32(.a(new_n64_), .b(new_n35_), .c(new_n65_), .O(z11));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n47_), .O(z13));
  nand2  g39(.a(x15), .b(new_n53_), .O(new_n73_));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n47_), .O(z14));
