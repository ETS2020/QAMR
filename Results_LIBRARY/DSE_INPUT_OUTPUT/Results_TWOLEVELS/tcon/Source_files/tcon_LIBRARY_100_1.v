...
module FAU ( 
  ...
  nor2   g02(.a(new_n35_), .b(x03), .O(new_n36_));
  ...
  nand2  g18(.a(x09), .b(x03), .O(new_n52_));
  oai21  g19(.a(x09), .b(new_n51_), .c(new_n52_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(x00), .O(new_n54_));
  nand3  g21(.a(x09), .b(new_n51_), .c(x03), .O(new_n55_));
  ...
  nand3  g31(.a(new_n64_), .b(new_n63_), .c(new_n37_), .O(z11));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(x13), .b(new_n51_), .O(new_n67_));
