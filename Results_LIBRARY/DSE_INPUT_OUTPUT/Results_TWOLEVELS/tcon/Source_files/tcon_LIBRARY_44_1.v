...
module FAU ( 
  ...
  oai21  g04(.a(new_n35_), .b(x08), .c(new_n37_), .O(z01));
  inv1   g05(.a(x08), .O(new_n39_));
  inv1   g06(.a(x11), .O(new_n40_));
  aoi21  g07(.a(x16), .b(new_n39_), .c(new_n40_), .O(z02));
  inv1   g08(.a(x12), .O(new_n42_));
  aoi21  g09(.a(x16), .b(new_n39_), .c(new_n42_), .O(z03));
  inv1   g10(.a(x13), .O(new_n44_));
  aoi21  g11(.a(x16), .b(new_n39_), .c(new_n44_), .O(z04));
  inv1   g12(.a(x14), .O(new_n46_));
  aoi21  g13(.a(x16), .b(new_n39_), .c(new_n46_), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  aoi21  g15(.a(x16), .b(new_n39_), .c(new_n48_), .O(z06));
  nor2   g16(.a(new_n35_), .b(new_n39_), .O(z07));
  nor2   g17(.a(x16), .b(x09), .O(new_n51_));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  oai21  g19(.a(new_n51_), .b(x08), .c(new_n52_), .O(z08));
  nand2  g20(.a(x08), .b(x01), .O(new_n54_));
  nand3  g21(.a(new_n35_), .b(x10), .c(new_n39_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  nand2  g23(.a(x08), .b(x02), .O(new_n57_));
  nand3  g24(.a(new_n35_), .b(x11), .c(new_n39_), .O(new_n58_));
  nand2  g25(.a(new_n58_), .b(new_n57_), .O(z10));
  nand2  g26(.a(x08), .b(x03), .O(new_n60_));
  nand3  g27(.a(new_n35_), .b(x12), .c(new_n39_), .O(new_n61_));
  ...
  nand3  g36(.a(new_n35_), .b(x15), .c(new_n39_), .O(new_n70_));
