...
module FAU ( 
  ...
  nand2  g13(.a(x14), .b(x07), .O(new_n47_));
  ...
  nand3  g34(.a(new_n67_), .b(new_n66_), .c(new_n37_), .O(z12));
  oai21  g35(.a(x14), .b(new_n54_), .c(new_n47_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(x05), .O(new_n70_));
  nand3  g37(.a(x14), .b(new_n54_), .c(x07), .O(new_n71_));
