...
module FAU ( 
  ...
  nand2  g01(.a(x13), .b(x00), .O(new_n35_));
  ...
  nand3  g13(.a(new_n35_), .b(x09), .c(new_n46_), .O(new_n47_));
  ...
  nand3  g30(.a(new_n63_), .b(x13), .c(new_n61_), .O(new_n64_));
  nand3  g31(.a(new_n48_), .b(x08), .c(x04), .O(new_n65_));
  ...
  nand2  g40(.a(x16), .b(new_n46_), .O(new_n74_));
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n51_), .O(z15));
  buf    g42(.a(x13), .O(z04));
endmodule
