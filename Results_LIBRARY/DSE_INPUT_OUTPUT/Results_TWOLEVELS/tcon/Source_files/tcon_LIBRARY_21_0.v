...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n47_, new_n49_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  aoi21  g08(.a(new_n36_), .b(new_n35_), .c(new_n41_), .O(z02));
  ...
  nand2  g17(.a(new_n36_), .b(x08), .O(z07));
  ...
  nand2  g25(.a(x16), .b(x11), .O(new_n59_));
