...
module FAU ( 
  ...
  oai21  g04(.a(x11), .b(x08), .c(new_n37_), .O(z01));
  ...
  oai21  g14(.a(x11), .b(x08), .c(new_n47_), .O(z06));
  ...
  oai21  g32(.a(x14), .b(new_n39_), .c(new_n65_), .O(new_n66_));
  nand2  g33(.a(x08), .b(x05), .O(new_n67_));
  nand2  g34(.a(new_n67_), .b(new_n66_), .O(z13));
  oai21  g35(.a(x15), .b(new_n39_), .c(new_n65_), .O(new_n69_));
