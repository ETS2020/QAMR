...
module FAU ( 
  ...
  wire new_n34_, new_n36_, new_n38_, new_n40_, new_n45_, new_n46_, new_n47_,
    ...
    new_n69_, new_n70_;
  nand2  g00(.a(x13), .b(x07), .O(new_n34_));
  ...
  and2   g18(.a(x13), .b(x07), .O(new_n52_));
  ...
  oai21  g25(.a(new_n45_), .b(x07), .c(x13), .O(new_n59_));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n52_), .O(z14));
  nand3  g34(.a(new_n34_), .b(x16), .c(new_n45_), .O(new_n68_));
  inv1   g35(.a(x13), .O(new_n69_));
  nand3  g36(.a(new_n69_), .b(x08), .c(x07), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n68_), .O(z15));
  buf    g38(.a(x13), .O(z04));
endmodule
