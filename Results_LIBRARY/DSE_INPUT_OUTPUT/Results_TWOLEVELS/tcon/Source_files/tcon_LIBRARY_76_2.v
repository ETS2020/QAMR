...
module FAU ( 
  ...
  nand2  g04(.a(x14), .b(x10), .O(new_n38_));
  ...
  oai21  g21(.a(x10), .b(new_n52_), .c(new_n38_), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(x01), .O(new_n56_));
  nand2  g23(.a(z01), .b(new_n52_), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z09));
  nand2  g25(.a(x11), .b(new_n52_), .O(new_n59_));
  nand2  g26(.a(x08), .b(x02), .O(new_n60_));
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n41_), .O(z10));
  nand2  g28(.a(x12), .b(new_n52_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand3  g30(.a(new_n63_), .b(new_n62_), .c(new_n41_), .O(z11));
  ...
  nand3  g39(.a(new_n72_), .b(new_n71_), .c(new_n41_), .O(z14));
  nand2  g40(.a(x16), .b(new_n52_), .O(new_n74_));
  nand2  g41(.a(x08), .b(x07), .O(new_n75_));
  nand3  g42(.a(new_n75_), .b(new_n74_), .c(new_n41_), .O(z15));
  buf    g43(.a(x14), .O(z05));
endmodule
