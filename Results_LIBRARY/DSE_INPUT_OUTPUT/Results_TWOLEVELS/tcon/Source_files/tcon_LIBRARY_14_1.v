...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n57_, new_n59_, new_n62_, new_n64_, new_n65_, new_n67_, new_n69_;
  ...
  nand2  g27(.a(new_n42_), .b(new_n56_), .O(z11));
  nand3  g28(.a(x08), .b(x04), .c(x03), .O(new_n62_));
  oai21  g29(.a(new_n44_), .b(x08), .c(new_n62_), .O(z12));
  oai21  g30(.a(x05), .b(new_n35_), .c(x08), .O(new_n64_));
  nand2  g31(.a(x14), .b(new_n56_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z13));
  nand3  g33(.a(x08), .b(x06), .c(x03), .O(new_n67_));
