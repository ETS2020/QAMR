...
module FAU ( 
  ...
  oai21  g27(.a(new_n40_), .b(x08), .c(new_n60_), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(x04), .O(new_n62_));
  nand3  g29(.a(x11), .b(new_n53_), .c(new_n35_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z10));
  nand2  g31(.a(x12), .b(new_n53_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x03), .O(new_n66_));
  nand3  g33(.a(new_n66_), .b(new_n65_), .c(new_n41_), .O(z11));
  oai21  g34(.a(x13), .b(x08), .c(x04), .O(new_n68_));
  nand3  g35(.a(x13), .b(new_n53_), .c(new_n35_), .O(new_n69_));
  ...
  nand3  g45(.a(new_n78_), .b(new_n77_), .c(new_n41_), .O(z15));
endmodule
