...
module FAU ( 
  ...
  nand2  g11(.a(new_n44_), .b(x11), .O(z04));
  ...
  aoi21  g26(.a(x13), .b(x08), .c(x11), .O(new_n60_));
  nand2  g27(.a(x11), .b(new_n53_), .O(new_n61_));
  oai21  g28(.a(new_n60_), .b(new_n59_), .c(new_n61_), .O(z10));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(x12), .b(new_n53_), .O(new_n64_));
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n35_), .O(z11));
  inv1   g32(.a(x04), .O(new_n66_));
  aoi21  g33(.a(x11), .b(x08), .c(x13), .O(new_n67_));
