...
module FAU ( 
  ...
  nor2   g05(.a(new_n38_), .b(x11), .O(z03));
  ...
  and2   g17(.a(x12), .b(x11), .O(new_n51_));
  ...
  nand3  g22(.a(new_n38_), .b(x11), .c(new_n47_), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z10));
  oai21  g24(.a(x11), .b(new_n47_), .c(x12), .O(new_n58_));
  ...
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n51_), .O(z15));
  buf    g39(.a(x11), .O(z02));
endmodule
