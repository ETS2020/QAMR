...
module FAU ( 
  ...
  nand2  g02(.a(x09), .b(x07), .O(new_n36_));
  ...
  nor2   g16(.a(x09), .b(new_n49_), .O(new_n50_));
  oai21  g17(.a(new_n50_), .b(z00), .c(x00), .O(new_n51_));
  inv1   g18(.a(x07), .O(new_n52_));
  nand3  g19(.a(x09), .b(new_n49_), .c(new_n52_), .O(new_n53_));
  ...
  aoi21  g33(.a(new_n66_), .b(new_n65_), .c(new_n55_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  nand2  g35(.a(x14), .b(new_n49_), .O(new_n69_));
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n55_), .O(z13));
  nand2  g37(.a(x08), .b(x06), .O(new_n71_));
  nand2  g38(.a(x15), .b(new_n49_), .O(new_n72_));
  aoi21  g39(.a(new_n72_), .b(new_n71_), .c(new_n55_), .O(z14));
  oai21  g40(.a(x09), .b(x08), .c(x07), .O(new_n74_));
  oai21  g41(.a(new_n47_), .b(x08), .c(new_n74_), .O(z15));
endmodule
