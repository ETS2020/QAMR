...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n41_, new_n43_,
    new_n45_, new_n48_, new_n50_, new_n52_, new_n53_, new_n55_, new_n56_,
  ...
  aoi21  g12(.a(new_n36_), .b(new_n35_), .c(new_n45_), .O(z04));
  nand2  g13(.a(new_n36_), .b(x08), .O(z05));
  inv1   g14(.a(x15), .O(new_n48_));
  nand2  g15(.a(new_n37_), .b(new_n48_), .O(z06));
  inv1   g16(.a(x16), .O(new_n50_));
  nand2  g17(.a(new_n37_), .b(new_n50_), .O(z07));
  nand2  g18(.a(x08), .b(x00), .O(new_n52_));
  nand2  g19(.a(x14), .b(x09), .O(new_n53_));
  oai21  g20(.a(new_n53_), .b(x08), .c(new_n52_), .O(z08));
  oai21  g21(.a(new_n36_), .b(x10), .c(new_n35_), .O(new_n55_));
  nand2  g22(.a(x08), .b(x01), .O(new_n56_));
  nand2  g23(.a(new_n56_), .b(new_n55_), .O(z09));
  oai21  g24(.a(new_n36_), .b(x11), .c(new_n35_), .O(new_n58_));
  nand2  g25(.a(x08), .b(x02), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n58_), .O(z10));
  oai21  g27(.a(new_n36_), .b(x12), .c(new_n35_), .O(new_n61_));
  nand2  g28(.a(x08), .b(x03), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z11));
  oai21  g30(.a(new_n36_), .b(x13), .c(new_n35_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x04), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z12));
  inv1   g33(.a(x05), .O(new_n67_));
  nand2  g34(.a(x08), .b(new_n67_), .O(z13));
  oai21  g35(.a(x15), .b(new_n36_), .c(new_n35_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  oai21  g38(.a(x16), .b(new_n36_), .c(new_n35_), .O(new_n72_));
