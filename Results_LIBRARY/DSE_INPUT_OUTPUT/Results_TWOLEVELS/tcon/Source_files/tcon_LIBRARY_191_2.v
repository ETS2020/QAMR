...
module FAU ( 
  ...
  nand2  g06(.a(new_n39_), .b(x01), .O(new_n40_));
  nand2  g07(.a(new_n40_), .b(new_n38_), .O(z01));
  nand2  g08(.a(new_n39_), .b(new_n35_), .O(z02));
  ...
  nand2  g18(.a(new_n40_), .b(new_n51_), .O(z07));
  ...
  nand3  g28(.a(new_n61_), .b(new_n57_), .c(new_n40_), .O(z10));
