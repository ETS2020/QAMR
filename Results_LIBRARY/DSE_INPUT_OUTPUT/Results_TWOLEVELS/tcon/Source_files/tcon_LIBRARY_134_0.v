...
module FAU ( 
  ...
  nand2  g18(.a(x15), .b(x09), .O(new_n52_));
  ...
  nand2  g24(.a(x15), .b(x11), .O(new_n58_));
  oai21  g25(.a(new_n58_), .b(x08), .c(new_n57_), .O(z10));
  oai21  g26(.a(new_n36_), .b(x12), .c(new_n34_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  oai21  g29(.a(new_n36_), .b(x13), .c(new_n34_), .O(new_n63_));
  nand2  g30(.a(x08), .b(x04), .O(new_n64_));
  nand2  g31(.a(new_n64_), .b(new_n63_), .O(z12));
  nand2  g32(.a(x08), .b(x05), .O(new_n66_));
  nand2  g33(.a(x15), .b(x14), .O(new_n67_));
  oai21  g34(.a(new_n67_), .b(x08), .c(new_n66_), .O(z13));
  nand2  g35(.a(x08), .b(x06), .O(new_n69_));
  oai21  g36(.a(new_n36_), .b(x08), .c(new_n69_), .O(z14));
  oai21  g37(.a(x16), .b(new_n36_), .c(new_n34_), .O(new_n71_));
