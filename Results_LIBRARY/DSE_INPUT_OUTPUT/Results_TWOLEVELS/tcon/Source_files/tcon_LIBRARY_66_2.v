...
module FAU ( 
  ...
  aoi21  g12(.a(new_n35_), .b(x08), .c(new_n45_), .O(z06));
  inv1   g13(.a(x16), .O(new_n47_));
  aoi21  g14(.a(new_n35_), .b(x08), .c(new_n47_), .O(z07));
  inv1   g15(.a(x00), .O(new_n49_));
  nand2  g16(.a(x14), .b(x08), .O(new_n50_));
  ...
  oai22  g35(.a(new_n50_), .b(new_n68_), .c(new_n47_), .d(x08), .O(z15));
  buf    g36(.a(x14), .O(z05));
endmodule
