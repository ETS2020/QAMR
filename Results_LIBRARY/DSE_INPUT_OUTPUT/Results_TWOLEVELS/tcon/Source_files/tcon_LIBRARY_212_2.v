...
module FAU ( 
  ...
  nor2   g17(.a(x13), .b(new_n44_), .O(new_n51_));
  nor2   g18(.a(new_n51_), .b(new_n50_), .O(z07));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n51_), .O(z13));
  ...
  aoi21  g43(.a(new_n76_), .b(new_n75_), .c(new_n51_), .O(z15));
endmodule
