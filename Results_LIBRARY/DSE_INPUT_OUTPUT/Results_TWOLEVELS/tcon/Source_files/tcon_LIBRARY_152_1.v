...
module FAU ( 
  ...
  nand2  g10(.a(x15), .b(new_n43_), .O(new_n44_));
  ...
  aoi21  g21(.a(new_n54_), .b(new_n52_), .c(new_n36_), .O(z08));
  ...
  oai21  g28(.a(x12), .b(x08), .c(x03), .O(new_n62_));
  nand3  g29(.a(new_n35_), .b(x12), .c(new_n53_), .O(new_n63_));
  ...
  nand3  g36(.a(new_n69_), .b(new_n68_), .c(new_n44_), .O(z13));
  inv1   g37(.a(x06), .O(new_n71_));
  nand2  g38(.a(x08), .b(new_n71_), .O(new_n72_));
  nand3  g39(.a(new_n72_), .b(x15), .c(x03), .O(new_n73_));
  nand3  g40(.a(new_n35_), .b(x08), .c(x06), .O(new_n74_));
  nand2  g41(.a(new_n74_), .b(new_n73_), .O(z14));
  nand2  g42(.a(x16), .b(new_n53_), .O(new_n76_));
  nand2  g43(.a(x08), .b(x07), .O(new_n77_));
  nand3  g44(.a(new_n77_), .b(new_n76_), .c(new_n44_), .O(z15));
  buf    g45(.a(x15), .O(z06));
endmodule
