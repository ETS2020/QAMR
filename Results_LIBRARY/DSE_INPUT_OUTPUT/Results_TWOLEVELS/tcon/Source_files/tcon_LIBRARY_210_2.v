...
module FAU ( 
  ...
  nand2  g11(.a(new_n42_), .b(x11), .O(new_n45_));
  nand2  g12(.a(new_n45_), .b(new_n44_), .O(z05));
  inv1   g13(.a(x15), .O(new_n47_));
  nand2  g14(.a(new_n45_), .b(new_n47_), .O(z06));
  ...
  oai21  g24(.a(new_n42_), .b(new_n51_), .c(x11), .O(new_n58_));
  ...
  nand3  g29(.a(new_n62_), .b(new_n61_), .c(new_n45_), .O(z11));
  ...
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n45_), .O(z13));
