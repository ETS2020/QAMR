...
module FAU ( 
  ...
  nand3  g17(.a(new_n43_), .b(x09), .c(new_n34_), .O(new_n51_));
  nand2  g18(.a(new_n51_), .b(new_n50_), .O(z08));
  nand2  g19(.a(x08), .b(x01), .O(new_n53_));
  nand3  g20(.a(new_n43_), .b(x10), .c(new_n34_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  nand2  g22(.a(x08), .b(x02), .O(new_n56_));
  oai21  g23(.a(new_n43_), .b(x08), .c(new_n56_), .O(z10));
  nand2  g24(.a(x08), .b(x03), .O(new_n58_));
  nand3  g25(.a(x12), .b(new_n43_), .c(new_n34_), .O(new_n59_));
  ...
  nand3  g31(.a(x14), .b(new_n43_), .c(new_n34_), .O(new_n65_));
  ...
  nand3  g37(.a(x16), .b(new_n43_), .c(new_n34_), .O(new_n71_));
