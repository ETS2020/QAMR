...
module FAU ( 
  ...
  nand3  g17(.a(new_n50_), .b(new_n49_), .c(new_n36_), .O(z08));
  ...
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n35_), .O(z13));
  ...
  aoi21  g38(.a(new_n71_), .b(new_n70_), .c(new_n35_), .O(z15));
  buf    g39(.a(x09), .O(z00));
  buf    g40(.a(x13), .O(z04));
endmodule
