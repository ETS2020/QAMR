...
module FAU ( 
  ...
  nand2  g10(.a(new_n35_), .b(new_n41_), .O(z04));
  inv1   g11(.a(x14), .O(new_n45_));
  nor2   g12(.a(new_n42_), .b(new_n45_), .O(z05));
  ...
  aoi21  g20(.a(new_n53_), .b(new_n51_), .c(new_n42_), .O(z08));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n42_), .O(z10));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand2  g28(.a(x12), .b(new_n52_), .O(new_n62_));
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z11));
  inv1   g30(.a(x04), .O(new_n64_));
  aoi21  g31(.a(new_n41_), .b(x08), .c(x13), .O(new_n65_));
