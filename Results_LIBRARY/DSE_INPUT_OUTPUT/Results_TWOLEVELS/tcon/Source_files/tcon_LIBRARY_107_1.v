...
module FAU ( 
  ...
  aoi21  g07(.a(x14), .b(new_n35_), .c(new_n40_), .O(z02));
  ...
  and2   g33(.a(x08), .b(x05), .O(z13));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand3  g35(.a(x15), .b(new_n46_), .c(new_n35_), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n68_), .O(z14));
  nor2   g37(.a(x16), .b(x14), .O(new_n71_));
