...
module FAU ( 
  ...
  nand2  g01(.a(x14), .b(x10), .O(new_n35_));
  nand2  g02(.a(new_n35_), .b(new_n34_), .O(z00));
  inv1   g03(.a(x10), .O(new_n37_));
  nor2   g04(.a(x14), .b(new_n37_), .O(z01));
  ...
  nor2   g11(.a(new_n44_), .b(x10), .O(z05));
  ...
  nand3  g19(.a(new_n35_), .b(x08), .c(x01), .O(new_n53_));
  nand2  g20(.a(z01), .b(new_n49_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z09));
  inv1   g22(.a(new_n35_), .O(new_n56_));
  ...
  nor2   g32(.a(x14), .b(new_n49_), .O(new_n66_));
  oai21  g33(.a(new_n66_), .b(z05), .c(x05), .O(new_n67_));
  nand2  g34(.a(z05), .b(new_n49_), .O(new_n68_));
