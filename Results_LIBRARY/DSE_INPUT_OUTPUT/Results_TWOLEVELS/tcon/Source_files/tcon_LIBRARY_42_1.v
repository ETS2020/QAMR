...
module FAU ( 
  ...
  nor2   g09(.a(new_n42_), .b(new_n35_), .O(z04));
  inv1   g10(.a(x14), .O(new_n44_));
  nand2  g11(.a(new_n36_), .b(new_n44_), .O(z05));
  inv1   g12(.a(x15), .O(new_n46_));
  nor2   g13(.a(new_n42_), .b(x10), .O(new_n47_));
  ...
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n47_), .O(z11));
  oai21  g30(.a(new_n35_), .b(new_n51_), .c(x13), .O(new_n64_));
