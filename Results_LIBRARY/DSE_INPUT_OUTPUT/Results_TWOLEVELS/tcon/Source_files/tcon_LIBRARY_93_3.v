...
module FAU ( 
  ...
  oai21  g22(.a(x14), .b(x08), .c(x02), .O(new_n56_));
  ...
  nand3  g33(.a(new_n66_), .b(x14), .c(new_n64_), .O(new_n67_));
  inv1   g34(.a(x14), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(x08), .c(x05), .O(new_n69_));
  nand2  g36(.a(new_n69_), .b(new_n67_), .O(z13));
  ...
  aoi21  g42(.a(new_n75_), .b(new_n74_), .c(new_n48_), .O(z15));
  buf    g43(.a(x14), .O(z05));
endmodule
