...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n43_, new_n45_, new_n46_, new_n47_,
    ...
    new_n69_, new_n70_;
  nand2  g00(.a(x09), .b(x04), .O(new_n34_));
  ...
  oai21  g12(.a(new_n45_), .b(x04), .c(x09), .O(new_n46_));
  nand2  g13(.a(x08), .b(x00), .O(new_n47_));
  nand2  g14(.a(new_n47_), .b(new_n46_), .O(z08));
  and2   g15(.a(x09), .b(x04), .O(new_n49_));
  ...
  nand3  g25(.a(new_n34_), .b(x13), .c(new_n45_), .O(new_n59_));
  ...
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n49_), .O(z13));
  ...
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n49_), .O(z15));
  buf    g38(.a(x09), .O(z00));
endmodule
