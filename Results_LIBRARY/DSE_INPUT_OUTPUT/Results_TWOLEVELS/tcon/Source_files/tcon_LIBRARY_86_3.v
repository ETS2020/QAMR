...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n39_, new_n45_, new_n46_, new_n47_,
  ...
  and2   g09(.a(new_n37_), .b(x15), .O(z06));
  and2   g10(.a(new_n37_), .b(x16), .O(z07));
  nand3  g11(.a(new_n37_), .b(x08), .c(x00), .O(new_n45_));
  inv1   g12(.a(x08), .O(new_n46_));
  nand2  g13(.a(z00), .b(new_n46_), .O(new_n47_));
  nand2  g14(.a(new_n47_), .b(new_n45_), .O(z08));
  nand2  g15(.a(x10), .b(new_n46_), .O(new_n49_));
  nand2  g16(.a(x08), .b(x01), .O(new_n50_));
  nand3  g17(.a(new_n50_), .b(new_n49_), .c(new_n37_), .O(z09));
  ...
  nand3  g27(.a(new_n60_), .b(new_n59_), .c(new_n37_), .O(z12));
  inv1   g28(.a(x14), .O(new_n62_));
  nor2   g29(.a(new_n62_), .b(x09), .O(new_n63_));
  nor2   g30(.a(x14), .b(new_n46_), .O(new_n64_));
  oai21  g31(.a(new_n64_), .b(new_n63_), .c(x05), .O(new_n65_));
  nand2  g32(.a(new_n63_), .b(new_n46_), .O(new_n66_));
