...
module FAU ( 
  ...
  oai21  g21(.a(x12), .b(x08), .c(x02), .O(new_n55_));
  oai21  g22(.a(new_n38_), .b(x08), .c(new_n55_), .O(z10));
  oai21  g23(.a(new_n48_), .b(x02), .c(x12), .O(new_n57_));
  ...
  and2   g35(.a(x12), .b(x02), .O(new_n69_));
