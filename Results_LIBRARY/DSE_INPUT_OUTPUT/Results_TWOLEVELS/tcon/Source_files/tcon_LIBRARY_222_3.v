...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n39_, new_n41_, new_n43_, new_n45_, new_n48_,
  ...
  nor2   g12(.a(new_n45_), .b(x03), .O(z06));
  ...
  oai21  g25(.a(x15), .b(x08), .c(x03), .O(new_n59_));
  oai21  g26(.a(new_n39_), .b(x08), .c(new_n59_), .O(z11));
  ...
  nand3  g36(.a(new_n69_), .b(x15), .c(new_n67_), .O(new_n70_));
  nand3  g37(.a(new_n45_), .b(x08), .c(x06), .O(new_n71_));
