...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n38_, new_n40_, new_n43_, new_n44_, new_n45_, new_n47_,
  ...
  oai21  g17(.a(x15), .b(new_n43_), .c(x11), .O(new_n51_));
  nand2  g18(.a(x08), .b(x02), .O(new_n52_));
  nand2  g19(.a(new_n52_), .b(new_n51_), .O(z10));
  nand2  g20(.a(x12), .b(new_n43_), .O(new_n54_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n47_), .O(z12));
  nand2  g26(.a(x08), .b(x05), .O(new_n60_));
  nand2  g27(.a(x14), .b(new_n43_), .O(new_n61_));
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n47_), .O(z13));
  oai21  g29(.a(x11), .b(new_n43_), .c(x15), .O(new_n63_));
  ...
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n47_), .O(z15));
  buf    g35(.a(x11), .O(z02));
  buf    g36(.a(x15), .O(z06));
endmodule
