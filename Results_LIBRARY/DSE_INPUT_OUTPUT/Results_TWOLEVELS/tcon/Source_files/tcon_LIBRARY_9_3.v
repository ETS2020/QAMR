...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n43_, new_n45_, new_n46_, new_n47_,
  ...
  and2   g07(.a(new_n37_), .b(x14), .O(z05));
  and2   g08(.a(new_n37_), .b(x15), .O(z06));
  inv1   g09(.a(x16), .O(new_n43_));
  nand2  g10(.a(new_n37_), .b(new_n43_), .O(z07));
  inv1   g11(.a(x08), .O(new_n45_));
  nor2   g12(.a(x13), .b(new_n45_), .O(new_n46_));
  nand2  g13(.a(x08), .b(x00), .O(new_n47_));
  oai21  g14(.a(new_n46_), .b(new_n34_), .c(new_n47_), .O(z08));
  inv1   g15(.a(new_n37_), .O(new_n49_));
  ...
  nor2   g26(.a(new_n59_), .b(x09), .O(new_n60_));
  oai21  g27(.a(new_n60_), .b(new_n46_), .c(x04), .O(new_n61_));
  nand2  g28(.a(new_n60_), .b(new_n45_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z12));
  nand2  g30(.a(x14), .b(new_n45_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n37_), .O(z13));
  nand2  g33(.a(x15), .b(new_n45_), .O(new_n67_));
  nand2  g34(.a(x08), .b(x06), .O(new_n68_));
  nand3  g35(.a(new_n68_), .b(new_n67_), .c(new_n37_), .O(z14));
