...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n39_, new_n40_, new_n41_, new_n42_,
  ...
  nand2  g09(.a(new_n42_), .b(new_n39_), .O(z03));
  ...
  oai21  g35(.a(x15), .b(new_n41_), .c(new_n40_), .O(new_n69_));
  nand2  g36(.a(x08), .b(x06), .O(new_n70_));
  nand2  g37(.a(new_n70_), .b(new_n69_), .O(z14));
  oai21  g38(.a(x16), .b(new_n41_), .c(new_n40_), .O(new_n72_));
