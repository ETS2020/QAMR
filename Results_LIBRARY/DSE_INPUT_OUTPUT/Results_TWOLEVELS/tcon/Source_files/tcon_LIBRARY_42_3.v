...
module FAU ( 
  ...
  nor2   g10(.a(new_n43_), .b(x10), .O(z04));
  ...
  oai21  g20(.a(x13), .b(new_n50_), .c(x10), .O(new_n54_));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand2  g22(.a(new_n55_), .b(new_n54_), .O(z09));
  and2   g23(.a(x13), .b(x10), .O(new_n57_));
  ...
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n57_), .O(z11));
  oai21  g30(.a(x10), .b(new_n50_), .c(x13), .O(new_n64_));
  ...
  aoi21  g41(.a(new_n74_), .b(new_n73_), .c(new_n57_), .O(z15));
endmodule
