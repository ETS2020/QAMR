...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n43_, new_n45_, new_n47_,
  ...
  and2   g06(.a(new_n38_), .b(x11), .O(z02));
  and2   g07(.a(new_n38_), .b(x12), .O(z03));
  ...
  nand2  g14(.a(new_n38_), .b(new_n47_), .O(z07));
  ...
  nand2  g19(.a(x10), .b(new_n34_), .O(new_n53_));
  ...
  oai21  g27(.a(x09), .b(x04), .c(x08), .O(new_n61_));
  nand2  g28(.a(x13), .b(new_n34_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z12));
  oai21  g30(.a(x09), .b(x05), .c(x08), .O(new_n64_));
