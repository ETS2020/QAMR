...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n40_, new_n42_, new_n45_, new_n47_, new_n48_,
  ...
  nor2   g30(.a(x16), .b(new_n49_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  oai21  g32(.a(new_n64_), .b(new_n42_), .c(new_n65_), .O(z13));
  nand2  g33(.a(x08), .b(x06), .O(new_n67_));
  nand2  g34(.a(x15), .b(new_n49_), .O(new_n68_));
  aoi21  g35(.a(new_n68_), .b(new_n67_), .c(new_n47_), .O(z14));
  oai21  g36(.a(new_n64_), .b(z07), .c(x07), .O(new_n70_));
  nand2  g37(.a(z07), .b(new_n49_), .O(new_n71_));
