...
module FAU ( 
  ...
  and2   g14(.a(x11), .b(x01), .O(new_n48_));
  ...
  oai21  g20(.a(new_n36_), .b(x08), .c(new_n53_), .O(z09));
  ...
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n48_), .O(z11));
  nand2  g27(.a(x08), .b(x04), .O(new_n61_));
  nand2  g28(.a(x13), .b(new_n50_), .O(new_n62_));
  aoi21  g29(.a(new_n62_), .b(new_n61_), .c(new_n48_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand2  g31(.a(x14), .b(new_n50_), .O(new_n65_));
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n48_), .O(z13));
