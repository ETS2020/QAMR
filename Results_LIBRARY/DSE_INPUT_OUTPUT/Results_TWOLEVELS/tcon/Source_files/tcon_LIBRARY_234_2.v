...
module FAU ( 
  ...
  oai22  g22(.a(new_n53_), .b(new_n55_), .c(new_n37_), .d(x08), .O(z10));
  oai21  g23(.a(new_n34_), .b(x03), .c(x08), .O(new_n57_));
  inv1   g24(.a(x08), .O(new_n58_));
  nand2  g25(.a(x12), .b(new_n58_), .O(new_n59_));
  nand2  g26(.a(new_n59_), .b(new_n57_), .O(z11));
  inv1   g27(.a(x04), .O(new_n61_));
  oai22  g28(.a(new_n53_), .b(new_n61_), .c(new_n42_), .d(x08), .O(z12));
  inv1   g29(.a(x05), .O(new_n63_));
  oai22  g30(.a(new_n53_), .b(new_n63_), .c(new_n44_), .d(x08), .O(z13));
  oai21  g31(.a(new_n34_), .b(x06), .c(x08), .O(new_n65_));
  nand2  g32(.a(x15), .b(new_n58_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z14));
  inv1   g34(.a(x07), .O(new_n68_));
  oai22  g35(.a(new_n53_), .b(new_n68_), .c(new_n48_), .d(x08), .O(z15));
  buf    g36(.a(x09), .O(z00));
endmodule
