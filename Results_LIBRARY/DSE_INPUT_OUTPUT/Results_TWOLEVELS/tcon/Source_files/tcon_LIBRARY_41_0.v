...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n42_, new_n44_,
  ...
  nand2  g07(.a(new_n36_), .b(x08), .O(z02));
  ...
  aoi21  g15(.a(new_n36_), .b(new_n35_), .c(new_n48_), .O(z06));
  ...
  oai21  g26(.a(x12), .b(new_n36_), .c(new_n35_), .O(new_n60_));
  nand2  g27(.a(x08), .b(x03), .O(new_n61_));
  nand2  g28(.a(new_n61_), .b(new_n60_), .O(z11));
  oai21  g29(.a(x13), .b(new_n36_), .c(new_n35_), .O(new_n63_));
