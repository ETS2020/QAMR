...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n38_, new_n43_, new_n45_, new_n47_, new_n48_,
  ...
  and2   g13(.a(x11), .b(x02), .O(new_n47_));
  ...
  oai21  g22(.a(new_n38_), .b(x08), .c(new_n55_), .O(z10));
  nand2  g23(.a(x08), .b(x03), .O(new_n57_));
  nand2  g24(.a(x12), .b(new_n49_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n47_), .O(z11));
  ...
  aoi21  g31(.a(new_n64_), .b(new_n63_), .c(new_n47_), .O(z13));
  nand2  g32(.a(x08), .b(x06), .O(new_n66_));
  nand2  g33(.a(x15), .b(new_n49_), .O(new_n67_));
  aoi21  g34(.a(new_n67_), .b(new_n66_), .c(new_n47_), .O(z14));
  nand2  g35(.a(x08), .b(x07), .O(new_n69_));
  nand2  g36(.a(x16), .b(new_n49_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n47_), .O(z15));
endmodule
