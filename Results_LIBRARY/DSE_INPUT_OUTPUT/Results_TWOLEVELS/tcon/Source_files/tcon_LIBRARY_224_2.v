...
module FAU ( 
  ...
  aoi21  g13(.a(new_n35_), .b(x04), .c(new_n46_), .O(z04));
  ...
  oai21  g32(.a(x13), .b(x08), .c(x15), .O(new_n66_));
  nand3  g33(.a(x13), .b(new_n54_), .c(new_n39_), .O(new_n67_));
  oai21  g34(.a(new_n66_), .b(new_n39_), .c(new_n67_), .O(z12));
