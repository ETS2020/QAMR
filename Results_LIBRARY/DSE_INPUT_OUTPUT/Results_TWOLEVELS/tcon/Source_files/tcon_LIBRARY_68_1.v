...
module FAU ( 
  ...
  nand3  g22(.a(new_n55_), .b(new_n54_), .c(new_n43_), .O(z08));
  ...
  aoi21  g27(.a(new_n35_), .b(x08), .c(x11), .O(new_n61_));
  oai22  g28(.a(new_n61_), .b(new_n60_), .c(new_n40_), .d(x08), .O(z10));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n43_), .O(z13));
