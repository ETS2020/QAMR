...
module FAU ( 
  ...
  nand3  g19(.a(new_n44_), .b(x09), .c(new_n34_), .O(new_n53_));
  nand2  g20(.a(new_n53_), .b(new_n52_), .O(z08));
  nand2  g21(.a(x08), .b(x01), .O(new_n55_));
  nand3  g22(.a(new_n44_), .b(x10), .c(new_n34_), .O(new_n56_));
  ...
  nor2   g27(.a(x13), .b(x12), .O(new_n61_));
