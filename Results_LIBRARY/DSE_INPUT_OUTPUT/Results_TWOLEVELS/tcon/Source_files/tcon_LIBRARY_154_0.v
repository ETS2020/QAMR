...
module FAU ( 
  ...
  nand2  g01(.a(new_n34_), .b(x04), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x09), .b(x04), .O(new_n37_));
  ...
  aoi21  g24(.a(new_n57_), .b(new_n56_), .c(new_n37_), .O(z09));
  ...
  nand3  g32(.a(x13), .b(x09), .c(new_n52_), .O(new_n66_));
