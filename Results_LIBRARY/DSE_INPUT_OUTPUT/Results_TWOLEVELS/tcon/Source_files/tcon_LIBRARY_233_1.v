...
module FAU ( 
  ...
  nor2   g08(.a(new_n41_), .b(x04), .O(new_n42_));
  ...
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n42_), .O(z09));
  ...
  nand3  g40(.a(new_n73_), .b(x15), .c(x04), .O(new_n74_));
  nand3  g41(.a(new_n41_), .b(x08), .c(x06), .O(new_n75_));
