...
module FAU ( 
  ...
  aoi21  g34(.a(x10), .b(x08), .c(x15), .O(new_n68_));
  nand2  g35(.a(x15), .b(new_n49_), .O(new_n69_));
  oai21  g36(.a(new_n68_), .b(new_n67_), .c(new_n69_), .O(z14));
