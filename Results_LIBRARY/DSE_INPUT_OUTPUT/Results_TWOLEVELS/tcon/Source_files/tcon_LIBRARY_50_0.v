...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n37_, new_n39_, new_n40_, new_n42_,
    new_n44_, new_n46_, new_n48_, new_n50_, new_n53_, new_n54_, new_n56_,
  ...
  nor2   g06(.a(x16), .b(x08), .O(new_n40_));
  ...
  nand2  g15(.a(new_n37_), .b(new_n48_), .O(z05));
  inv1   g16(.a(x15), .O(new_n50_));
  nor2   g17(.a(new_n40_), .b(new_n50_), .O(z06));
  nand2  g18(.a(new_n36_), .b(x08), .O(z07));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  nand2  g20(.a(x16), .b(x09), .O(new_n54_));
