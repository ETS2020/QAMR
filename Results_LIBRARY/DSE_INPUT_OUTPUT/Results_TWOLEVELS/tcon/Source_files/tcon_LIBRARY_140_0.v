// Benchmark "FAU" written by ABC on Wed Aug 19 20:51:18 2020
...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n36_, new_n37_, new_n38_, new_n40_, new_n41_, new_n43_,
  ...
  nor2   g07(.a(x09), .b(x08), .O(new_n41_));
  ...
  oai21  g20(.a(new_n34_), .b(x08), .c(new_n53_), .O(z08));
  oai21  g21(.a(x10), .b(new_n34_), .c(new_n37_), .O(new_n55_));
  ...
  oai21  g27(.a(x12), .b(new_n34_), .c(new_n37_), .O(new_n61_));
  ...
  oai21  g36(.a(x15), .b(new_n34_), .c(new_n37_), .O(new_n70_));
