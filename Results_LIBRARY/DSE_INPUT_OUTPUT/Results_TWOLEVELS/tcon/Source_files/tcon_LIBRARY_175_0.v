...
module FAU ( 
  ...
  oai21  g01(.a(x11), .b(x08), .c(new_n34_), .O(z00));
  inv1   g02(.a(x10), .O(new_n36_));
  nor2   g03(.a(x11), .b(x08), .O(new_n37_));
  ...
  oai21  g29(.a(x13), .b(new_n39_), .c(new_n51_), .O(new_n63_));
  ...
  oai21  g38(.a(x16), .b(new_n39_), .c(new_n51_), .O(new_n72_));
