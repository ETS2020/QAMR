...
module FAU ( 
  ...
  nor2   g21(.a(x13), .b(new_n48_), .O(new_n55_));
  ...
  oai21  g27(.a(new_n55_), .b(z04), .c(x04), .O(new_n61_));
  nand2  g28(.a(z04), .b(new_n48_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z12));
  nand2  g30(.a(x08), .b(x05), .O(new_n64_));
  nand2  g31(.a(x14), .b(new_n48_), .O(new_n65_));
  aoi21  g32(.a(new_n65_), .b(new_n64_), .c(new_n46_), .O(z13));
