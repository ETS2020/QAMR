...
module FAU ( 
  ...
  aoi21  g15(.a(x09), .b(new_n35_), .c(new_n48_), .O(z07));
  ...
  nand3  g22(.a(x11), .b(new_n55_), .c(new_n35_), .O(new_n56_));
  ...
  nand3  g28(.a(x13), .b(new_n55_), .c(new_n35_), .O(new_n62_));
  ...
  nand3  g34(.a(x15), .b(new_n55_), .c(new_n35_), .O(new_n68_));
  nand2  g35(.a(new_n68_), .b(new_n67_), .O(z14));
  nand2  g36(.a(x08), .b(x07), .O(new_n70_));
  nand3  g37(.a(x16), .b(new_n55_), .c(new_n35_), .O(new_n71_));
