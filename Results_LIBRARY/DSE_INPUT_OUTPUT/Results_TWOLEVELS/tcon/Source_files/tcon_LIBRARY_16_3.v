...
module FAU ( 
  ...
  output z00, z01, z02, z03, z04, z05, z06, z07, z08, z09, z10, z11, z12, z13,
    z14, z15;
  wire new_n34_, new_n35_, new_n37_, new_n38_, new_n42_, new_n47_, new_n48_,
  ...
  nand2  g18(.a(new_n51_), .b(new_n38_), .O(z09));
  oai21  g19(.a(x10), .b(x02), .c(x08), .O(new_n53_));
  nand2  g20(.a(x11), .b(new_n37_), .O(new_n54_));
  nand2  g21(.a(new_n54_), .b(new_n53_), .O(z10));
  nand2  g22(.a(x12), .b(new_n37_), .O(new_n56_));
  nand3  g23(.a(new_n50_), .b(x08), .c(x03), .O(new_n57_));
  nand2  g24(.a(new_n57_), .b(new_n56_), .O(z11));
  oai21  g25(.a(x10), .b(x04), .c(x08), .O(new_n59_));
  nand2  g26(.a(x13), .b(new_n37_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(new_n59_), .O(z12));
  nand2  g28(.a(x14), .b(new_n37_), .O(new_n62_));
  nand3  g29(.a(new_n50_), .b(x08), .c(x05), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z13));
  oai21  g31(.a(x10), .b(x06), .c(x08), .O(new_n65_));
  nand2  g32(.a(x15), .b(new_n37_), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z14));
  oai21  g34(.a(x10), .b(x07), .c(x08), .O(new_n68_));
  nand2  g35(.a(x16), .b(new_n37_), .O(new_n69_));
