...
module FAU ( 
  ...
  oai21  g11(.a(x14), .b(x00), .c(x08), .O(new_n45_));
  ...
  nand3  g20(.a(new_n50_), .b(x08), .c(x02), .O(new_n54_));
  ...
  nand2  g29(.a(new_n62_), .b(new_n50_), .O(z13));
  nand2  g30(.a(x15), .b(new_n46_), .O(new_n64_));
  nand3  g31(.a(new_n50_), .b(x08), .c(x06), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(new_n64_), .O(z14));
  nand2  g33(.a(x16), .b(new_n46_), .O(new_n67_));
  nand3  g34(.a(new_n50_), .b(x08), .c(x07), .O(new_n68_));
