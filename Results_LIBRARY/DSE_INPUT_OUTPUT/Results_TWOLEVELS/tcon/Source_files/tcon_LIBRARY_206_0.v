...
module FAU ( 
  ...
  nor2   g11(.a(new_n35_), .b(new_n44_), .O(z03));
  inv1   g12(.a(x13), .O(new_n46_));
  nand2  g13(.a(new_n40_), .b(new_n46_), .O(z04));
  nand2  g14(.a(new_n39_), .b(x08), .O(z05));
  ...
  nand2  g23(.a(x14), .b(x10), .O(new_n57_));
  ...
  oai21  g28(.a(new_n39_), .b(x12), .c(new_n38_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z11));
  oai21  g31(.a(new_n39_), .b(x13), .c(new_n38_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z12));
  nand2  g34(.a(x08), .b(x05), .O(new_n68_));
  oai21  g35(.a(new_n39_), .b(x08), .c(new_n68_), .O(z13));
  oai21  g36(.a(x15), .b(new_n39_), .c(new_n38_), .O(new_n70_));
