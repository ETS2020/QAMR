...
module FAU ( 
  ...
  nor2   g10(.a(new_n41_), .b(new_n35_), .O(z03));
  ...
  aoi21  g22(.a(new_n55_), .b(new_n53_), .c(new_n42_), .O(z08));
  ...
  aoi21  g28(.a(new_n61_), .b(new_n60_), .c(new_n42_), .O(z10));
  oai21  g29(.a(new_n54_), .b(new_n35_), .c(x12), .O(new_n63_));
  ...
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n42_), .O(z14));
  oai21  g41(.a(x16), .b(x08), .c(x07), .O(new_n75_));
  nand3  g42(.a(x16), .b(new_n41_), .c(new_n54_), .O(new_n76_));
