...
module FAU ( 
  ...
  nor2   g01(.a(x09), .b(x05), .O(new_n35_));
  ...
  aoi21  g17(.a(x08), .b(x05), .c(x09), .O(new_n51_));
  ...
  aoi21  g23(.a(new_n56_), .b(new_n55_), .c(new_n35_), .O(z09));
  nand2  g24(.a(x08), .b(x02), .O(new_n58_));
  nand2  g25(.a(x11), .b(new_n52_), .O(new_n59_));
  aoi21  g26(.a(new_n59_), .b(new_n58_), .c(new_n35_), .O(z10));
  ...
  oai21  g33(.a(x14), .b(x08), .c(x05), .O(new_n67_));
  nand3  g34(.a(x14), .b(x09), .c(new_n52_), .O(new_n68_));
