...
module FAU ( 
  ...
  nand2  g16(.a(new_n49_), .b(new_n35_), .O(z06));
  ...
  oai21  g26(.a(x11), .b(new_n54_), .c(new_n41_), .O(new_n60_));
  nand2  g27(.a(new_n60_), .b(x02), .O(new_n61_));
  nand2  g28(.a(z02), .b(new_n54_), .O(new_n62_));
  nand2  g29(.a(new_n62_), .b(new_n61_), .O(z10));
  nand2  g30(.a(x12), .b(new_n54_), .O(new_n64_));
  nand2  g31(.a(x08), .b(x03), .O(new_n65_));
  nand3  g32(.a(new_n65_), .b(new_n64_), .c(new_n39_), .O(z11));
  ...
  nand3  g38(.a(new_n71_), .b(new_n70_), .c(new_n39_), .O(z13));
  nand2  g39(.a(x15), .b(new_n54_), .O(new_n73_));
  nand2  g40(.a(x08), .b(x06), .O(new_n74_));
  nand3  g41(.a(new_n74_), .b(new_n73_), .c(new_n39_), .O(z14));
