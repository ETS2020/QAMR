...
module FAU ( 
  ...
  nand2  g04(.a(new_n37_), .b(x03), .O(z01));
  ...
  aoi21  g23(.a(x08), .b(x03), .c(x10), .O(new_n57_));
  ...
  nand3  g37(.a(new_n70_), .b(new_n69_), .c(new_n46_), .O(z13));
  nand2  g38(.a(x15), .b(new_n52_), .O(new_n72_));
  nand2  g39(.a(x08), .b(x06), .O(new_n73_));
  nand3  g40(.a(new_n73_), .b(new_n72_), .c(new_n46_), .O(z14));
