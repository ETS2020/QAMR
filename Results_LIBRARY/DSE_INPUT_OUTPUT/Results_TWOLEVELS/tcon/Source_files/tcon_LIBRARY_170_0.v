...
module FAU ( 
  ...
  oai21  g28(.a(new_n41_), .b(x12), .c(new_n40_), .O(new_n62_));
  nand2  g29(.a(x08), .b(x03), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z11));
  oai21  g31(.a(new_n41_), .b(x13), .c(new_n40_), .O(new_n65_));
  nand2  g32(.a(x08), .b(x04), .O(new_n66_));
  nand2  g33(.a(new_n66_), .b(new_n65_), .O(z12));
  oai21  g34(.a(new_n41_), .b(x14), .c(new_n40_), .O(new_n68_));
