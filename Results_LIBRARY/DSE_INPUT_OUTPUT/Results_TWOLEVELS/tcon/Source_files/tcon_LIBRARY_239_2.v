...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    new_n46_, new_n47_, new_n48_, new_n50_, new_n53_, new_n54_, new_n55_,
  ...
  nand2  g18(.a(new_n35_), .b(new_n47_), .O(z07));
  nand2  g19(.a(x08), .b(x00), .O(new_n53_));
  inv1   g20(.a(x08), .O(new_n54_));
  nand2  g21(.a(x09), .b(new_n54_), .O(new_n55_));
  aoi21  g22(.a(new_n55_), .b(new_n53_), .c(new_n48_), .O(z08));
  nand2  g23(.a(x08), .b(x01), .O(new_n57_));
  nand2  g24(.a(x10), .b(new_n54_), .O(new_n58_));
  aoi21  g25(.a(new_n58_), .b(new_n57_), .c(new_n48_), .O(z09));
  oai21  g26(.a(new_n35_), .b(x08), .c(x02), .O(new_n60_));
  oai21  g27(.a(new_n40_), .b(x08), .c(new_n60_), .O(z10));
  ...
  aoi21  g36(.a(new_n69_), .b(new_n68_), .c(new_n48_), .O(z13));
  ...
  aoi21  g42(.a(x08), .b(new_n47_), .c(x16), .O(new_n76_));
  oai21  g43(.a(new_n76_), .b(new_n74_), .c(new_n75_), .O(z15));
endmodule
