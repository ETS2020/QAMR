...
module FAU ( 
  ...
  wire new_n34_, new_n35_, new_n36_, new_n38_, new_n40_, new_n42_, new_n44_,
    ...
    new_n68_, new_n69_, new_n70_, new_n72_;
  ...
  nand3  g36(.a(new_n69_), .b(x15), .c(new_n35_), .O(new_n70_));
