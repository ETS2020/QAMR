...
module FAU ( 
  ...
  nand2  g29(.a(x13), .b(new_n56_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  inv1   g31(.a(x05), .O(new_n65_));
  oai22  g32(.a(new_n53_), .b(new_n65_), .c(new_n44_), .d(x08), .O(z13));
  inv1   g33(.a(x06), .O(new_n67_));
  oai22  g34(.a(new_n53_), .b(new_n67_), .c(new_n46_), .d(x08), .O(z14));
  oai21  g35(.a(new_n34_), .b(x07), .c(x08), .O(new_n69_));
  nand2  g36(.a(x16), .b(new_n56_), .O(new_n70_));
