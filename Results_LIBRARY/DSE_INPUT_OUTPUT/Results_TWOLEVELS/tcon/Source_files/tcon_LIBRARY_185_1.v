...
module FAU ( 
  ...
  nand3  g29(.a(x13), .b(new_n40_), .c(new_n34_), .O(new_n63_));
  nand2  g30(.a(new_n63_), .b(new_n62_), .O(z12));
  nand2  g31(.a(x08), .b(x05), .O(new_n65_));
  nand3  g32(.a(x14), .b(new_n40_), .c(new_n34_), .O(new_n66_));
  ...
  nor2   g37(.a(x16), .b(x11), .O(new_n71_));
