// Benchmark "FAU" written by ABC on Wed Aug 19 20:51:22 2020
...
module FAU ( 
  ...
  aoi21  g30(.a(x11), .b(x08), .c(x13), .O(new_n64_));
  nand2  g31(.a(x13), .b(new_n51_), .O(new_n65_));
  oai21  g32(.a(new_n64_), .b(new_n63_), .c(new_n65_), .O(z12));
