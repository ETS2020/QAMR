...
module FAU ( 
  ...
  nand2  g06(.a(new_n35_), .b(new_n39_), .O(z01));
  ...
  oai21  g31(.a(x13), .b(new_n52_), .c(new_n64_), .O(new_n65_));
  nand2  g32(.a(new_n65_), .b(x04), .O(new_n66_));
  nand3  g33(.a(x13), .b(x10), .c(new_n52_), .O(new_n67_));
