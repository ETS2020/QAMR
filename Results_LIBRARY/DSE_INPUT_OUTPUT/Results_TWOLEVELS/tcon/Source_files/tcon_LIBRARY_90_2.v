...
module FAU ( 
  ...
  nand2  g03(.a(new_n35_), .b(new_n34_), .O(z01));
  inv1   g04(.a(x11), .O(new_n38_));
  nor2   g05(.a(x10), .b(new_n34_), .O(new_n39_));
