...
module FAU ( 
  ...
  nand2  g27(.a(new_n41_), .b(new_n49_), .O(new_n61_));
  nand3  g28(.a(new_n61_), .b(new_n34_), .c(x03), .O(new_n62_));
  nand3  g29(.a(x12), .b(new_n49_), .c(new_n52_), .O(new_n63_));
  ...
  inv1   g34(.a(new_n37_), .O(new_n68_));
  nand2  g35(.a(x08), .b(x05), .O(new_n69_));
  nand2  g36(.a(x14), .b(new_n49_), .O(new_n70_));
  aoi21  g37(.a(new_n70_), .b(new_n69_), .c(new_n68_), .O(z13));
  nand2  g38(.a(x08), .b(x06), .O(new_n72_));
  nand2  g39(.a(x15), .b(new_n49_), .O(new_n73_));
  aoi21  g40(.a(new_n73_), .b(new_n72_), .c(new_n68_), .O(z14));
