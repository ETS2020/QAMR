...
module FAU ( 
  ...
  aoi21  g061(.a(new_n75_), .b(new_n74_), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g068(.a(x39), .b(new_n130_), .c(new_n123_), .O(new_n131_));
  ...
  nand4  g092(.a(new_n152_), .b(new_n123_), .c(x20), .d(new_n151_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand4  g095(.a(new_n124_), .b(x39), .c(new_n146_), .d(new_n118_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  aoi21  g097(.a(new_n146_), .b(new_n118_), .c(new_n69_), .O(new_n160_));
  nand4  g098(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n161_));
  oai22  g099(.a(new_n161_), .b(new_n64_), .c(new_n160_), .d(new_n123_), .O(new_n162_));
  ...
  oai21  g103(.a(new_n165_), .b(new_n100_), .c(x27), .O(new_n166_));
  ...
  nand2  g110(.a(new_n172_), .b(new_n70_), .O(z16));
  ...
  nand2  g116(.a(new_n92_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n76_), .O(new_n180_));
  inv1   g118(.a(x09), .O(new_n181_));
  nand2  g119(.a(new_n74_), .b(new_n181_), .O(new_n182_));
  aoi21  g120(.a(new_n180_), .b(new_n100_), .c(new_n182_), .O(new_n183_));
  nand3  g121(.a(new_n83_), .b(x40), .c(x39), .O(new_n184_));
  oai21  g122(.a(new_n183_), .b(new_n73_), .c(new_n184_), .O(z18));
  aoi21  g123(.a(x40), .b(new_n69_), .c(x08), .O(new_n186_));
  aoi21  g124(.a(x40), .b(x29), .c(new_n100_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n92_), .O(new_n188_));
  oai21  g126(.a(new_n83_), .b(new_n69_), .c(x40), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n76_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n74_), .c(new_n181_), .O(new_n192_));
