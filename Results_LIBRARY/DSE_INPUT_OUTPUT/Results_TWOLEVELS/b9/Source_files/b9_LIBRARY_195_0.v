...
module FAU ( 
  ...
  aoi21  g064(.a(new_n126_), .b(new_n93_), .c(new_n124_), .O(new_n127_));
  ...
  nand3  g073(.a(new_n135_), .b(x05), .c(new_n72_), .O(new_n136_));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n93_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n139_), .c(new_n79_), .O(new_n145_));
  nor2   g083(.a(new_n145_), .b(x09), .O(z11));
  inv1   g084(.a(x35), .O(new_n147_));
  nand3  g085(.a(new_n66_), .b(new_n81_), .c(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi22  g087(.a(new_n68_), .b(x27), .c(x39), .d(new_n72_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n151_));
  nand3  g089(.a(new_n69_), .b(new_n64_), .c(x33), .O(new_n152_));
  ...
  nand4  g099(.a(new_n68_), .b(x33), .c(x20), .d(new_n159_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n135_), .b(new_n154_), .c(new_n72_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  oai21  g104(.a(new_n125_), .b(x04), .c(x40), .O(new_n167_));
  aoi21  g105(.a(new_n64_), .b(x33), .c(x13), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n167_), .c(x35), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n147_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(new_n66_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n173_));
  nand4  g111(.a(new_n155_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n174_));
  nor2   g112(.a(new_n125_), .b(x13), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n174_), .c(x40), .d(new_n72_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  oai21  g115(.a(new_n63_), .b(new_n96_), .c(new_n64_), .O(new_n178_));
  nand2  g116(.a(new_n175_), .b(new_n72_), .O(new_n179_));
  ...
  oai22  g130(.a(new_n119_), .b(new_n192_), .c(new_n83_), .d(x27), .O(new_n193_));
  ...
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n65_), .d(new_n79_), .O(z18));
  oai22  g135(.a(new_n64_), .b(x35), .c(new_n82_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n141_), .O(new_n199_));
  nor2   g137(.a(x40), .b(x35), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n89_), .c(x33), .O(new_n201_));
  inv1   g139(.a(x08), .O(new_n202_));
  nand2  g140(.a(x35), .b(x27), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(x40), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n64_), .b(x28), .c(new_n96_), .O(new_n205_));
  nand4  g143(.a(new_n205_), .b(new_n204_), .c(new_n201_), .d(new_n199_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n79_), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(x09), .c(new_n65_), .O(z20));
