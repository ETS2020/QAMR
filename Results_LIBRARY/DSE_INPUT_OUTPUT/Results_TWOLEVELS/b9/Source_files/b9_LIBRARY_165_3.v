...
module FAU ( 
  ...
  aoi21  g17(.a(new_n66_), .b(new_n79_), .c(z08), .O(new_n80_));
  ...
  nand2  g50(.a(new_n79_), .b(new_n112_), .O(new_n113_));
  nand4  g51(.a(new_n113_), .b(new_n111_), .c(x35), .d(new_n84_), .O(new_n114_));
  nand4  g52(.a(new_n114_), .b(z02), .c(new_n71_), .d(new_n110_), .O(new_n115_));
  inv1   g53(.a(new_n115_), .O(z11));
  nor2   g54(.a(z08), .b(new_n79_), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(new_n68_), .O(z12));
  nand4  g56(.a(new_n68_), .b(z02), .c(x27), .d(x20), .O(new_n119_));
  nor3   g57(.a(new_n119_), .b(x19), .c(x18), .O(z13));
  nor2   g58(.a(x19), .b(x18), .O(new_n121_));
  nand4  g59(.a(new_n121_), .b(new_n117_), .c(new_n68_), .d(x20), .O(z14));
  inv1   g60(.a(x12), .O(new_n123_));
  nor2   g61(.a(new_n102_), .b(new_n123_), .O(z15));
  inv1   g62(.a(x23), .O(new_n125_));
  nand4  g63(.a(z02), .b(new_n125_), .c(x22), .d(x01), .O(new_n126_));
  inv1   g64(.a(new_n126_), .O(z16));
  inv1   g65(.a(x01), .O(new_n128_));
  inv1   g66(.a(x24), .O(new_n129_));
  nand4  g67(.a(z02), .b(new_n129_), .c(x23), .d(x22), .O(new_n130_));
  nor2   g68(.a(new_n130_), .b(new_n128_), .O(z17));
  nand2  g69(.a(x27), .b(new_n104_), .O(new_n132_));
  oai21  g70(.a(x27), .b(new_n112_), .c(new_n132_), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(x35), .c(new_n84_), .O(new_n134_));
  nand4  g72(.a(new_n134_), .b(z02), .c(new_n71_), .d(new_n110_), .O(z18));
  oai21  g73(.a(x28), .b(new_n112_), .c(new_n79_), .O(new_n136_));
  nand2  g74(.a(new_n136_), .b(x35), .O(new_n137_));
  nand4  g75(.a(new_n137_), .b(z02), .c(new_n71_), .d(new_n110_), .O(new_n138_));
  inv1   g76(.a(new_n138_), .O(z20));
  inv1   g77(.a(new_n115_), .O(z19));
endmodule
