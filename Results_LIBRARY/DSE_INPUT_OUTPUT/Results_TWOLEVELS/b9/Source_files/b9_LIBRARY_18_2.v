...
module FAU ( 
  ...
  nand2  g016(.a(new_n78_), .b(x05), .O(new_n79_));
  ...
  nor2   g031(.a(x40), .b(x05), .O(new_n94_));
  ...
  nand4  g036(.a(new_n98_), .b(new_n97_), .c(new_n79_), .d(x21), .O(z03));
  ...
  nand3  g041(.a(new_n103_), .b(new_n79_), .c(new_n70_), .O(z05));
  aoi21  g042(.a(new_n79_), .b(new_n64_), .c(new_n83_), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(x37), .c(new_n79_), .O(z06));
  ...
  nand2  g056(.a(new_n79_), .b(new_n118_), .O(z08));
  ...
  aoi21  g061(.a(x40), .b(new_n123_), .c(new_n94_), .O(new_n124_));
  nand3  g062(.a(x40), .b(x39), .c(x05), .O(new_n125_));
  oai21  g063(.a(new_n124_), .b(new_n122_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n85_), .c(new_n65_), .O(new_n127_));
  nand3  g065(.a(new_n79_), .b(x37), .c(x06), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x27), .O(new_n130_));
  aoi21  g068(.a(new_n82_), .b(new_n81_), .c(new_n78_), .O(new_n131_));
  ...
  nand4  g098(.a(new_n131_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n160_), .c(new_n79_), .O(z13));
  inv1   g100(.a(new_n71_), .O(new_n163_));
  oai21  g101(.a(new_n123_), .b(x04), .c(x40), .O(new_n164_));
  nor2   g102(.a(new_n94_), .b(x13), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(new_n166_));
  nand4  g104(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n166_), .c(new_n70_), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n170_));
  nand4  g108(.a(new_n153_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n171_));
  nor2   g109(.a(new_n123_), .b(x13), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n171_), .c(x40), .d(new_n65_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  oai21  g112(.a(new_n64_), .b(x05), .c(new_n78_), .O(new_n175_));
  nand2  g113(.a(new_n172_), .b(new_n65_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  oai21  g115(.a(x32), .b(x30), .c(new_n177_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n64_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n175_), .c(new_n174_), .d(new_n169_), .O(z14));
  ...
  oai22  g128(.a(new_n84_), .b(x27), .c(new_n118_), .d(new_n190_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n137_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n192_), .c(new_n79_), .d(new_n81_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(new_n139_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n66_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n134_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n81_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z20));
  nor2   g139(.a(new_n142_), .b(x09), .O(z19));
endmodule
