...
module FAU ( 
  ...
  nand3  g027(.a(new_n89_), .b(new_n73_), .c(new_n88_), .O(new_n90_));
  nor2   g028(.a(x27), .b(x08), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n83_), .c(x04), .O(new_n92_));
  nand3  g030(.a(new_n67_), .b(x28), .c(x04), .O(new_n93_));
  nand2  g031(.a(new_n63_), .b(x39), .O(new_n94_));
  aoi21  g032(.a(new_n93_), .b(new_n75_), .c(new_n94_), .O(new_n95_));
  nand3  g033(.a(new_n95_), .b(new_n92_), .c(new_n90_), .O(z02));
  nand2  g034(.a(new_n68_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x27), .O(new_n98_));
  nand3  g036(.a(new_n63_), .b(new_n67_), .c(new_n98_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n97_), .c(new_n63_), .d(x21), .O(z03));
  inv1   g038(.a(x21), .O(new_n101_));
  nand4  g039(.a(new_n99_), .b(new_n97_), .c(new_n63_), .d(new_n101_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n67_), .c(new_n64_), .O(z05));
  nand3  g042(.a(new_n103_), .b(new_n63_), .c(new_n67_), .O(new_n105_));
  ...
  nand3  g049(.a(x38), .b(new_n73_), .c(new_n109_), .O(new_n112_));
  ...
  nand3  g054(.a(x40), .b(x39), .c(new_n73_), .O(new_n117_));
  ...
  oai21  g061(.a(x39), .b(x25), .c(x40), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x07), .O(new_n125_));
  nand4  g063(.a(x40), .b(x39), .c(new_n73_), .d(x05), .O(new_n126_));
  aoi22  g064(.a(new_n126_), .b(new_n125_), .c(new_n83_), .d(new_n123_), .O(new_n127_));
  nor2   g065(.a(new_n64_), .b(new_n67_), .O(new_n128_));
  aoi22  g066(.a(new_n128_), .b(x06), .c(new_n127_), .d(new_n122_), .O(new_n129_));
  inv1   g067(.a(x39), .O(new_n130_));
  oai21  g068(.a(x32), .b(x30), .c(x40), .O(new_n131_));
  nor3   g069(.a(new_n131_), .b(new_n130_), .c(x25), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x05), .c(new_n122_), .O(new_n133_));
  oai21  g071(.a(new_n129_), .b(new_n98_), .c(new_n133_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n82_), .c(new_n122_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(new_n73_), .c(new_n63_), .d(new_n98_), .O(new_n137_));
  aoi21  g075(.a(x39), .b(x29), .c(x25), .O(new_n138_));
  nor2   g076(.a(new_n98_), .b(new_n122_), .O(new_n139_));
  oai22  g077(.a(new_n139_), .b(new_n83_), .c(new_n138_), .d(new_n75_), .O(new_n140_));
  oai21  g078(.a(new_n137_), .b(x08), .c(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n80_), .c(new_n135_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n63_), .O(z11));
  nor2   g081(.a(x27), .b(x25), .O(new_n144_));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n74_), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n122_), .c(x25), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n75_), .c(new_n70_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n63_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(x25), .O(new_n157_));
  nand4  g095(.a(new_n69_), .b(new_n75_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n132_), .b(new_n150_), .c(new_n122_), .O(new_n161_));
  ...
  nor2   g125(.a(new_n98_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n84_), .c(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n63_), .d(new_n135_), .O(z18));
  inv1   g128(.a(new_n142_), .O(z19));
  nand2  g129(.a(x39), .b(x29), .O(new_n192_));
  nor2   g130(.a(new_n82_), .b(x27), .O(new_n193_));
  nor2   g131(.a(x35), .b(x25), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(new_n192_), .O(new_n195_));
  inv1   g133(.a(x08), .O(new_n196_));
  aoi21  g134(.a(x35), .b(x27), .c(x25), .O(new_n197_));
  nor2   g135(.a(x40), .b(x27), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n197_), .c(new_n196_), .O(new_n199_));
  oai21  g137(.a(new_n193_), .b(new_n169_), .c(new_n75_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n199_), .c(new_n195_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n80_), .c(new_n135_), .O(new_n202_));
