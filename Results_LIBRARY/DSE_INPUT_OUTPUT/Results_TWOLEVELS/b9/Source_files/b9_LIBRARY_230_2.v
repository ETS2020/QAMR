...
module FAU ( 
  ...
  nand3  g033(.a(new_n64_), .b(new_n67_), .c(new_n66_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n95_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  nand4  g036(.a(new_n96_), .b(new_n95_), .c(new_n64_), .d(new_n98_), .O(z04));
  ...
  nand3  g058(.a(new_n120_), .b(new_n84_), .c(new_n73_), .O(new_n121_));
  ...
  aoi21  g062(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n125_));
  ...
  oai21  g066(.a(new_n63_), .b(x29), .c(x39), .O(new_n129_));
  ...
  nand3  g070(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n64_), .d(new_n66_), .O(new_n134_));
  ...
  nor2   g078(.a(new_n69_), .b(new_n73_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(x40), .O(new_n142_));
  oai21  g080(.a(new_n69_), .b(x39), .c(new_n142_), .O(z12));
  ...
  nand3  g091(.a(new_n153_), .b(new_n144_), .c(new_n73_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x40), .c(new_n114_), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n152_), .O(z13));
  aoi21  g094(.a(new_n144_), .b(new_n73_), .c(new_n63_), .O(new_n157_));
  nor2   g095(.a(x19), .b(x18), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n150_), .c(x27), .d(x20), .O(new_n159_));
  oai21  g097(.a(new_n157_), .b(new_n114_), .c(new_n159_), .O(new_n160_));
  ...
  inv1   g116(.a(new_n83_), .O(new_n179_));
  nor2   g117(.a(new_n66_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(x09), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n178_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g120(.a(new_n136_), .b(new_n64_), .O(z19));
  inv1   g121(.a(x08), .O(new_n184_));
  aoi22  g122(.a(new_n176_), .b(x28), .c(new_n64_), .d(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n89_), .b(x40), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x39), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n138_), .O(new_n188_));
  oai21  g126(.a(new_n185_), .b(x27), .c(new_n188_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n79_), .c(new_n128_), .O(new_n190_));
