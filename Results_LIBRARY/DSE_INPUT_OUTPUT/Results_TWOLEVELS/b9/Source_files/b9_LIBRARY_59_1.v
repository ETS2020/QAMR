...
module FAU ( 
  ...
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n141_), .O(new_n181_));
  ...
  oai22  g122(.a(new_n184_), .b(new_n90_), .c(new_n183_), .d(new_n95_), .O(z18));
  ...
  nand2  g127(.a(x39), .b(new_n141_), .O(new_n190_));
