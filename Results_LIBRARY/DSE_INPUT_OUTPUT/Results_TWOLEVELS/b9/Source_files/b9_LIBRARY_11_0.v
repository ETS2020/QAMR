...
module FAU ( 
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n83_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n81_), .c(new_n70_), .O(z05));
  nand2  g041(.a(new_n81_), .b(new_n64_), .O(new_n104_));
  inv1   g042(.a(x28), .O(new_n105_));
  oai21  g043(.a(x40), .b(x39), .c(new_n105_), .O(new_n106_));
  aoi21  g044(.a(new_n106_), .b(new_n104_), .c(x37), .O(z06));
  ...
  nand3  g072(.a(x35), .b(new_n105_), .c(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x39), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n104_), .c(x08), .O(new_n137_));
  nand2  g075(.a(x40), .b(new_n75_), .O(new_n138_));
  nand2  g076(.a(x40), .b(x29), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x39), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  aoi22  g079(.a(new_n141_), .b(new_n86_), .c(new_n140_), .d(new_n138_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n137_), .c(new_n84_), .O(new_n143_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n76_), .c(x39), .O(new_n150_));
  ...
  nor2   g098(.a(new_n131_), .b(x13), .O(new_n161_));
  ...
  nand3  g104(.a(new_n166_), .b(new_n165_), .c(z08), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n169_));
  oai21  g107(.a(new_n75_), .b(x27), .c(new_n169_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n85_), .c(new_n84_), .O(new_n171_));
  nand2  g109(.a(new_n76_), .b(x39), .O(new_n172_));
  oai21  g110(.a(new_n75_), .b(x04), .c(x40), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n152_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n71_), .c(new_n70_), .O(new_n175_));
  aoi21  g113(.a(x40), .b(x27), .c(x39), .O(new_n176_));
  oai21  g114(.a(new_n166_), .b(new_n76_), .c(new_n172_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n64_), .c(new_n176_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n175_), .c(new_n171_), .d(new_n168_), .O(z14));
  ...
  nand4  g124(.a(new_n81_), .b(new_n186_), .c(x23), .d(x22), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n185_), .O(z17));
  nand2  g126(.a(z08), .b(x29), .O(new_n189_));
  oai21  g127(.a(new_n93_), .b(x27), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n64_), .b(x04), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n86_), .c(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n81_), .d(new_n84_), .O(z18));
  inv1   g132(.a(x09), .O(new_n195_));
  oai22  g133(.a(new_n75_), .b(x35), .c(new_n105_), .d(x27), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n139_), .O(new_n197_));
  oai21  g135(.a(new_n75_), .b(x08), .c(new_n138_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n66_), .O(new_n199_));
  nor2   g137(.a(new_n83_), .b(x08), .O(new_n200_));
  nor2   g138(.a(x39), .b(new_n105_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n64_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n199_), .c(new_n197_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n84_), .c(new_n195_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n81_), .O(z20));
  nor2   g143(.a(new_n143_), .b(x09), .O(z19));
endmodule
