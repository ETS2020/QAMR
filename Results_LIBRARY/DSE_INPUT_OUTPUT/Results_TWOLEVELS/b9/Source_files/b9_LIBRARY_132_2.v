...
module FAU ( 
  ...
  oai21  g023(.a(new_n69_), .b(x35), .c(new_n76_), .O(new_n86_));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n91_), .c(new_n89_), .O(z03));
  aoi21  g034(.a(new_n94_), .b(new_n93_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n91_), .c(new_n89_), .O(z04));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n89_), .O(z05));
  nand3  g038(.a(new_n99_), .b(new_n70_), .c(new_n94_), .O(new_n101_));
  ...
  nand3  g059(.a(new_n121_), .b(new_n78_), .c(new_n118_), .O(new_n122_));
  ...
  oai21  g069(.a(new_n69_), .b(x29), .c(x39), .O(new_n132_));
  nand2  g070(.a(x27), .b(x04), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x35), .c(new_n76_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n76_), .c(new_n118_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n70_), .d(new_n93_), .O(new_n137_));
  ...
  nor2   g078(.a(new_n64_), .b(new_n93_), .O(new_n141_));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n94_), .b(new_n75_), .c(new_n142_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  nor2   g082(.a(new_n141_), .b(new_n118_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x40), .O(new_n146_));
  oai21  g084(.a(new_n141_), .b(x39), .c(new_n146_), .O(z12));
  ...
  nand2  g091(.a(new_n90_), .b(new_n94_), .O(new_n154_));
  ...
  nand4  g094(.a(new_n154_), .b(new_n126_), .c(x20), .d(new_n153_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n128_), .b(new_n148_), .c(new_n118_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  aoi21  g099(.a(new_n148_), .b(new_n118_), .c(new_n69_), .O(new_n162_));
  nand4  g100(.a(x27), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n163_));
  oai22  g101(.a(new_n163_), .b(new_n64_), .c(new_n162_), .d(new_n126_), .O(new_n164_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n76_), .c(x27), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(x40), .c(new_n74_), .d(new_n73_), .O(new_n169_));
  ...
  nand2  g115(.a(new_n177_), .b(new_n70_), .O(z17));
  nand2  g116(.a(x39), .b(x29), .O(new_n179_));
  oai21  g117(.a(new_n77_), .b(x27), .c(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  inv1   g119(.a(new_n77_), .O(new_n182_));
  nor2   g120(.a(new_n93_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n181_), .c(new_n70_), .d(new_n73_), .O(z18));
  inv1   g123(.a(new_n139_), .O(z19));
  inv1   g124(.a(x08), .O(new_n187_));
  aoi22  g125(.a(new_n179_), .b(x28), .c(new_n70_), .d(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n83_), .b(x40), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x39), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n142_), .O(new_n191_));
  oai21  g129(.a(new_n188_), .b(x27), .c(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n73_), .c(new_n131_), .O(new_n193_));
