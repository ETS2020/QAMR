...
module FAU ( 
  ...
  nand3  g042(.a(new_n104_), .b(new_n64_), .c(new_n66_), .O(z05));
  oai22  g043(.a(x40), .b(new_n94_), .c(new_n81_), .d(new_n98_), .O(new_n106_));
  ...
  aoi21  g059(.a(new_n121_), .b(x40), .c(new_n94_), .O(z09));
  ...
  nand3  g072(.a(x35), .b(new_n81_), .c(new_n72_), .O(new_n135_));
  ...
  oai21  g085(.a(x37), .b(x28), .c(x27), .O(new_n148_));
  nand2  g086(.a(new_n95_), .b(x39), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(x04), .c(new_n148_), .O(new_n150_));
  inv1   g088(.a(x35), .O(new_n151_));
  nand2  g089(.a(new_n66_), .b(new_n151_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n94_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n63_), .O(new_n154_));
  nand2  g092(.a(x39), .b(new_n72_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n66_), .c(new_n151_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(new_n154_), .c(new_n150_), .d(new_n147_), .O(z12));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n72_), .c(new_n101_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n166_), .O(z13));
  nand2  g108(.a(new_n158_), .b(new_n72_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n149_), .c(new_n148_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n173_));
  nand4  g111(.a(new_n159_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(z08), .c(new_n158_), .d(new_n72_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  oai21  g114(.a(new_n152_), .b(new_n81_), .c(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n79_), .c(new_n78_), .O(new_n178_));
  nand3  g116(.a(x39), .b(new_n158_), .c(new_n72_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n66_), .c(new_n151_), .O(new_n180_));
  and2   g118(.a(new_n180_), .b(new_n154_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n178_), .c(new_n176_), .d(new_n172_), .O(z14));
  nand3  g120(.a(x34), .b(x27), .c(x12), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(x40), .c(new_n94_), .O(z15));
  ...
  nand2  g129(.a(x27), .b(new_n72_), .O(new_n192_));
  nand2  g130(.a(new_n98_), .b(x08), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(new_n151_), .O(new_n194_));
  nand2  g132(.a(new_n78_), .b(new_n134_), .O(new_n195_));
  aoi21  g133(.a(new_n194_), .b(new_n81_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n101_), .c(new_n119_), .d(new_n88_), .O(z18));
  inv1   g135(.a(new_n144_), .O(z19));
  nand2  g136(.a(x28), .b(new_n98_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n138_), .d(new_n95_), .O(new_n200_));
  nand2  g138(.a(new_n64_), .b(new_n98_), .O(new_n201_));
  nand2  g139(.a(x40), .b(new_n151_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n201_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n200_), .c(new_n78_), .O(new_n204_));
