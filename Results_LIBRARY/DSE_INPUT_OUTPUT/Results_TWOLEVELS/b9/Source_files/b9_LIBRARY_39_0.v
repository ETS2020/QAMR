...
module FAU ( 
  ...
  aoi21  g035(.a(new_n66_), .b(new_n93_), .c(new_n97_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n79_), .O(z03));
  aoi21  g037(.a(new_n66_), .b(new_n93_), .c(x21), .O(new_n100_));
  ...
  aoi21  g041(.a(new_n65_), .b(new_n93_), .c(new_n83_), .O(new_n104_));
  ...
  nand2  g069(.a(new_n65_), .b(new_n93_), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n83_), .c(new_n72_), .O(new_n133_));
  ...
  oai21  g080(.a(new_n142_), .b(new_n135_), .c(new_n80_), .O(new_n143_));
  ...
  oai21  g085(.a(new_n117_), .b(x04), .c(new_n69_), .O(new_n148_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n72_), .c(new_n79_), .O(new_n161_));
  ...
  nand2  g102(.a(new_n164_), .b(new_n93_), .O(new_n165_));
  ...
  nand4  g109(.a(new_n136_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n172_));
  ...
  nand2  g122(.a(x27), .b(new_n72_), .O(new_n185_));
  nand2  g123(.a(new_n93_), .b(x08), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n136_), .O(new_n187_));
  inv1   g125(.a(x09), .O(new_n188_));
  nand2  g126(.a(new_n80_), .b(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n187_), .b(new_n83_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n79_), .c(new_n117_), .d(new_n90_), .O(z18));
  oai22  g129(.a(new_n63_), .b(x35), .c(new_n83_), .d(x27), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n138_), .O(new_n193_));
  nor2   g131(.a(new_n64_), .b(x39), .O(new_n194_));
  nor2   g132(.a(new_n63_), .b(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n194_), .c(new_n136_), .O(new_n196_));
  nor2   g134(.a(new_n79_), .b(x08), .O(new_n197_));
  nor2   g135(.a(x39), .b(new_n83_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n197_), .c(new_n93_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n196_), .c(new_n193_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n188_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n65_), .O(z20));
  nor2   g140(.a(new_n143_), .b(x09), .O(z19));
endmodule
