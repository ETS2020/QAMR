...
module FAU ( 
  ...
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n93_), .d(x40), .O(z02));
  ...
  aoi21  g044(.a(new_n106_), .b(new_n70_), .c(new_n97_), .O(z05));
  ...
  oai21  g059(.a(x39), .b(x34), .c(x40), .O(new_n122_));
  inv1   g060(.a(new_n122_), .O(z08));
  inv1   g061(.a(x34), .O(new_n124_));
  nand3  g062(.a(x27), .b(x26), .c(x11), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n76_), .c(new_n124_), .O(z09));
  nand2  g064(.a(new_n122_), .b(x07), .O(new_n127_));
  nand4  g065(.a(x40), .b(x39), .c(new_n124_), .d(x05), .O(new_n128_));
  ...
  nand4  g073(.a(new_n135_), .b(new_n124_), .c(x05), .d(new_n65_), .O(new_n136_));
  ...
  aoi21  g078(.a(new_n140_), .b(new_n124_), .c(new_n139_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n142_), .b(new_n76_), .c(new_n144_), .O(new_n145_));
  oai21  g083(.a(new_n141_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n84_), .c(new_n138_), .O(new_n147_));
  ...
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n124_), .O(new_n152_));
  nand2  g090(.a(new_n72_), .b(x27), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n76_), .O(new_n154_));
  ...
  nand2  g103(.a(new_n165_), .b(new_n124_), .O(new_n166_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n124_), .O(new_n180_));
  ...
  nand2  g130(.a(new_n84_), .b(new_n138_), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n86_), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(new_n77_), .b(new_n124_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n92_), .c(new_n194_), .d(new_n97_), .O(z18));
  inv1   g134(.a(new_n147_), .O(z19));
  nor2   g135(.a(new_n142_), .b(new_n76_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  aoi21  g137(.a(new_n66_), .b(new_n124_), .c(new_n139_), .O(new_n200_));
  oai22  g138(.a(new_n200_), .b(x08), .c(new_n199_), .d(new_n198_), .O(new_n201_));
