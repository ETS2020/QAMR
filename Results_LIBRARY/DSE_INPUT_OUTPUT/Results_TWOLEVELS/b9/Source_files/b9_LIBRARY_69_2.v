...
module FAU ( 
  ...
  nor2   g035(.a(x40), .b(x26), .O(new_n98_));
  ...
  nor2   g063(.a(new_n125_), .b(new_n76_), .O(z09));
  inv1   g064(.a(x07), .O(new_n127_));
  aoi21  g065(.a(x40), .b(new_n75_), .c(new_n98_), .O(new_n128_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n86_), .c(new_n142_), .O(new_n144_));
  inv1   g082(.a(x08), .O(new_n145_));
  nand2  g083(.a(x40), .b(x04), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x35), .c(new_n85_), .d(x27), .O(new_n147_));
  ...
  nand2  g088(.a(new_n150_), .b(new_n81_), .O(z11));
  ...
  nand2  g095(.a(new_n157_), .b(new_n109_), .O(new_n158_));
  ...
  nor2   g106(.a(new_n137_), .b(x13), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n65_), .c(new_n104_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n168_), .O(z13));
  nand3  g109(.a(x20), .b(new_n165_), .c(new_n164_), .O(new_n172_));
  nand4  g110(.a(new_n161_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n173_));
  ...
  oai21  g114(.a(new_n176_), .b(new_n98_), .c(new_n172_), .O(new_n177_));
  ...
  oai21  g118(.a(new_n175_), .b(new_n154_), .c(new_n180_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n177_), .c(new_n158_), .O(z14));
  nand3  g121(.a(x34), .b(x27), .c(x12), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(x40), .c(new_n109_), .O(z15));
  ...
  nand2  g132(.a(new_n83_), .b(new_n141_), .O(new_n195_));
  aoi21  g133(.a(new_n194_), .b(new_n85_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n104_), .c(new_n92_), .d(new_n123_), .O(z18));
  inv1   g135(.a(new_n142_), .O(new_n198_));
  oai21  g136(.a(new_n66_), .b(new_n64_), .c(new_n145_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n199_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n83_), .c(new_n141_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n81_), .O(z20));
  nand2  g141(.a(new_n150_), .b(new_n81_), .O(z19));
endmodule
