...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(new_n66_), .d(x09), .O(new_n77_));
  ...
  oai21  g029(.a(new_n91_), .b(new_n88_), .c(x09), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x40), .O(z02));
  nand2  g031(.a(new_n70_), .b(x27), .O(new_n94_));
  nand3  g032(.a(new_n64_), .b(new_n69_), .c(new_n68_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n94_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g034(.a(x21), .O(new_n97_));
  nand4  g035(.a(new_n95_), .b(new_n94_), .c(new_n64_), .d(new_n97_), .O(z04));
  ...
  nand3  g050(.a(x40), .b(x39), .c(x09), .O(new_n113_));
  ...
  aoi21  g058(.a(new_n120_), .b(x09), .c(new_n74_), .O(new_n121_));
  nand4  g059(.a(x40), .b(x39), .c(x09), .d(x05), .O(new_n122_));
  oai21  g060(.a(new_n121_), .b(new_n119_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n84_), .c(new_n118_), .O(new_n124_));
  ...
  nor2   g067(.a(new_n129_), .b(new_n120_), .O(new_n130_));
  nand4  g068(.a(new_n130_), .b(x09), .c(x05), .d(new_n118_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n127_), .O(z10));
  inv1   g070(.a(x35), .O(new_n133_));
  oai21  g071(.a(new_n89_), .b(new_n133_), .c(new_n74_), .O(new_n134_));
  aoi21  g072(.a(x27), .b(x04), .c(x28), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n79_), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n74_), .c(x09), .O(z11));
  nand3  g076(.a(new_n69_), .b(new_n81_), .c(new_n133_), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x27), .c(x10), .O(new_n140_));
  aoi21  g078(.a(x39), .b(new_n118_), .c(new_n71_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(x09), .O(new_n142_));
  oai21  g080(.a(new_n71_), .b(x40), .c(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x28), .c(new_n74_), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n118_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand2  g087(.a(new_n70_), .b(new_n69_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n147_), .c(new_n68_), .O(new_n152_));
  nand4  g090(.a(new_n128_), .b(x39), .c(new_n144_), .d(new_n118_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x09), .c(new_n74_), .O(new_n154_));
  or2    g092(.a(new_n154_), .b(new_n152_), .O(z13));
  nand3  g093(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n156_));
  nor2   g094(.a(new_n74_), .b(new_n120_), .O(new_n157_));
  nand4  g095(.a(new_n145_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n144_), .d(new_n118_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand3  g098(.a(new_n69_), .b(new_n133_), .c(x28), .O(new_n161_));
  oai21  g099(.a(x27), .b(new_n63_), .c(new_n161_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n80_), .c(new_n79_), .O(new_n163_));
  inv1   g101(.a(new_n71_), .O(new_n164_));
  oai21  g102(.a(new_n120_), .b(x04), .c(x09), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(x40), .c(new_n144_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n163_), .c(new_n160_), .d(new_n64_), .O(z14));
  nand4  g106(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n64_), .O(z15));
  ...
  nand2  g113(.a(new_n175_), .b(new_n64_), .O(z17));
  inv1   g114(.a(x08), .O(new_n177_));
  nand2  g115(.a(x27), .b(new_n118_), .O(new_n178_));
  oai21  g116(.a(x27), .b(new_n177_), .c(new_n178_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(x35), .c(new_n82_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n74_), .c(new_n79_), .d(new_n63_), .O(z18));
  oai21  g119(.a(x28), .b(new_n177_), .c(new_n68_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x35), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n74_), .c(new_n79_), .d(new_n63_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z20));
  aoi21  g123(.a(new_n137_), .b(new_n74_), .c(x09), .O(z19));
endmodule
