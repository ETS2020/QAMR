...
module FAU ( 
  ...
  aoi21  g040(.a(new_n63_), .b(x39), .c(x27), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(new_n83_), .c(new_n67_), .O(new_n104_));
  nand2  g042(.a(new_n104_), .b(new_n64_), .O(z06));
  ...
  oai22  g060(.a(new_n122_), .b(new_n120_), .c(x39), .d(new_n121_), .O(new_n123_));
  ...
  oai21  g072(.a(new_n66_), .b(new_n73_), .c(new_n83_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  inv1   g075(.a(x35), .O(new_n138_));
  nand2  g076(.a(x40), .b(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n83_), .c(new_n73_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n103_), .c(new_n137_), .O(new_n141_));
  oai21  g079(.a(new_n63_), .b(x29), .c(x39), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n141_), .c(new_n136_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n80_), .c(new_n133_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n64_), .O(z11));
  nand3  g084(.a(new_n67_), .b(new_n82_), .c(new_n138_), .O(new_n147_));
  ...
  oai21  g088(.a(new_n69_), .b(x39), .c(new_n150_), .O(z12));
  ...
  nand4  g098(.a(new_n158_), .b(new_n128_), .c(x20), .d(new_n157_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n130_), .b(new_n152_), .c(new_n73_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand2  g103(.a(x40), .b(x04), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(x39), .c(new_n152_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n68_), .O(new_n168_));
  nand4  g106(.a(new_n138_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n67_), .O(new_n171_));
  nand3  g109(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n172_));
  nand4  g110(.a(new_n153_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(x39), .c(new_n152_), .d(new_n73_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  aoi21  g113(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n73_), .c(new_n63_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n128_), .c(new_n66_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n175_), .c(new_n171_), .d(new_n64_), .O(z14));
  ...
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n138_), .O(new_n191_));
  nand2  g129(.a(new_n80_), .b(new_n133_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n83_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n79_), .c(new_n122_), .d(new_n90_), .O(z18));
  oai21  g132(.a(new_n83_), .b(x27), .c(x35), .O(new_n195_));
  and2   g133(.a(new_n195_), .b(new_n142_), .O(new_n196_));
  nand2  g134(.a(new_n64_), .b(new_n66_), .O(new_n197_));
  aoi21  g135(.a(new_n139_), .b(new_n197_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n80_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z20));
  buf    g138(.a(x39), .O(z08));
  nand2  g139(.a(new_n145_), .b(new_n64_), .O(z19));
endmodule
