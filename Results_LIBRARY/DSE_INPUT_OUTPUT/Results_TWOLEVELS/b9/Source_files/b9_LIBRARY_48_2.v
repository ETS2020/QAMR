...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x06), .O(new_n81_));
  ...
  oai21  g032(.a(new_n80_), .b(x35), .c(new_n94_), .O(new_n95_));
  ...
  oai21  g040(.a(new_n94_), .b(new_n64_), .c(new_n70_), .O(new_n103_));
  ...
  oai21  g058(.a(new_n70_), .b(new_n64_), .c(x40), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(x06), .O(new_n122_));
  ...
  nand2  g070(.a(new_n132_), .b(new_n122_), .O(z10));
  ...
  nor2   g077(.a(x40), .b(x06), .O(new_n140_));
  ...
  nor2   g100(.a(new_n130_), .b(x13), .O(new_n163_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n167_));
  ...
  inv1   g115(.a(x06), .O(new_n178_));
  nand3  g116(.a(new_n150_), .b(new_n80_), .c(new_n178_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n177_), .c(new_n171_), .O(z14));
  ...
  aoi21  g131(.a(new_n191_), .b(new_n94_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n83_), .c(new_n91_), .d(new_n75_), .O(z18));
  nor2   g133(.a(x40), .b(x35), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n93_), .c(new_n178_), .O(new_n197_));
