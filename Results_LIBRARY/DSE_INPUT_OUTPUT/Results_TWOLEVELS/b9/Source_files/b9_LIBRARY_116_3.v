...
module FAU ( 
  ...
  nand2  g54(.a(new_n84_), .b(new_n116_), .O(new_n117_));
  nand4  g55(.a(new_n117_), .b(new_n115_), .c(x35), .d(new_n78_), .O(new_n118_));
  nand3  g56(.a(new_n118_), .b(new_n71_), .c(new_n114_), .O(new_n119_));
  nand2  g57(.a(new_n119_), .b(new_n63_), .O(z11));
  nor2   g58(.a(z08), .b(new_n84_), .O(new_n121_));
  nand2  g59(.a(new_n121_), .b(new_n68_), .O(z12));
  nand4  g60(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n123_));
  nor3   g61(.a(new_n123_), .b(x19), .c(x18), .O(z13));
  nor2   g62(.a(x19), .b(x18), .O(new_n125_));
  nand4  g63(.a(new_n125_), .b(new_n121_), .c(new_n68_), .d(x20), .O(z14));
  nand4  g64(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  nand2  g65(.a(new_n127_), .b(new_n63_), .O(z15));
  inv1   g66(.a(x23), .O(new_n129_));
  nand4  g67(.a(new_n63_), .b(new_n129_), .c(x22), .d(x01), .O(new_n130_));
  inv1   g68(.a(new_n130_), .O(z16));
  inv1   g69(.a(x24), .O(new_n132_));
  nand4  g70(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  nand2  g71(.a(new_n133_), .b(new_n63_), .O(z17));
  nand2  g72(.a(x27), .b(new_n108_), .O(new_n135_));
  oai21  g73(.a(x27), .b(new_n116_), .c(new_n135_), .O(new_n136_));
  nand3  g74(.a(new_n136_), .b(x35), .c(new_n78_), .O(new_n137_));
  nor2   g75(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g76(.a(new_n138_), .b(new_n137_), .c(z08), .O(z18));
  oai21  g77(.a(x28), .b(new_n116_), .c(new_n84_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(x35), .O(new_n141_));
  nand3  g79(.a(new_n141_), .b(new_n71_), .c(new_n114_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(new_n63_), .O(z20));
  nand2  g81(.a(new_n119_), .b(new_n63_), .O(z19));
endmodule
