...
module FAU ( 
  ...
  aoi21  g033(.a(new_n95_), .b(new_n91_), .c(new_n74_), .O(z03));
  aoi21  g034(.a(new_n94_), .b(new_n93_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n91_), .c(new_n74_), .O(z04));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n74_), .O(z05));
  nand3  g038(.a(new_n99_), .b(new_n71_), .c(new_n94_), .O(new_n101_));
  ...
  nor2   g052(.a(new_n67_), .b(new_n70_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand4  g054(.a(new_n71_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  ...
  nand3  g060(.a(new_n122_), .b(new_n80_), .c(x27), .O(new_n123_));
  ...
  nand3  g073(.a(x35), .b(new_n78_), .c(new_n119_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n71_), .d(new_n93_), .O(new_n137_));
  ...
  nor2   g079(.a(new_n70_), .b(x27), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n141_), .c(new_n66_), .O(new_n143_));
  oai21  g081(.a(new_n70_), .b(new_n119_), .c(x40), .O(new_n144_));
  oai21  g082(.a(new_n64_), .b(new_n93_), .c(new_n144_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n143_), .c(new_n71_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x40), .c(new_n147_), .d(new_n119_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand2  g090(.a(new_n90_), .b(new_n94_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n150_), .c(new_n70_), .O(new_n155_));
  nand4  g093(.a(new_n153_), .b(new_n67_), .c(x20), .d(new_n152_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand4  g096(.a(new_n125_), .b(x39), .c(new_n147_), .d(new_n119_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  aoi21  g098(.a(new_n147_), .b(new_n119_), .c(new_n70_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .d(new_n67_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n78_), .c(x27), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x39), .c(new_n76_), .d(new_n75_), .O(new_n168_));
  ...
  nand4  g110(.a(new_n71_), .b(new_n172_), .c(x22), .d(x01), .O(new_n173_));
  ...
  nand2  g117(.a(new_n93_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n178_), .O(new_n181_));
  nand2  g119(.a(new_n75_), .b(new_n131_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n78_), .c(new_n182_), .O(new_n183_));
  nand3  g121(.a(z08), .b(x29), .c(x08), .O(new_n184_));
  oai21  g122(.a(new_n183_), .b(new_n74_), .c(new_n184_), .O(z18));
  inv1   g123(.a(new_n139_), .O(z19));
  oai21  g124(.a(new_n78_), .b(x27), .c(x35), .O(new_n187_));
  and2   g125(.a(new_n187_), .b(new_n132_), .O(new_n188_));
  nand2  g126(.a(new_n71_), .b(new_n93_), .O(new_n189_));
  nand2  g127(.a(x39), .b(new_n178_), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n75_), .O(new_n192_));
