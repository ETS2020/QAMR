...
module FAU ( 
  ...
  inv1   g032(.a(x34), .O(new_n95_));
  nand2  g033(.a(new_n63_), .b(new_n95_), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(new_n94_), .O(z02));
  nand2  g035(.a(new_n66_), .b(x27), .O(new_n98_));
  inv1   g036(.a(x27), .O(new_n99_));
  nand3  g037(.a(new_n64_), .b(new_n65_), .c(new_n99_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n98_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g039(.a(x21), .O(new_n102_));
  nand4  g040(.a(new_n100_), .b(new_n98_), .c(new_n64_), .d(new_n102_), .O(z04));
  aoi21  g041(.a(x28), .b(x27), .c(x37), .O(new_n104_));
  nor2   g042(.a(new_n104_), .b(new_n78_), .O(z05));
  nand2  g043(.a(new_n64_), .b(new_n99_), .O(new_n106_));
  oai21  g044(.a(x40), .b(new_n95_), .c(new_n82_), .O(new_n107_));
  ...
  nand3  g059(.a(x27), .b(x26), .c(x11), .O(new_n122_));
  ...
  nor2   g069(.a(new_n65_), .b(new_n99_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n78_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n64_), .d(new_n99_), .O(new_n137_));
  ...
  nand3  g085(.a(new_n65_), .b(new_n81_), .c(new_n147_), .O(new_n148_));
  ...
  nand3  g089(.a(new_n68_), .b(new_n63_), .c(new_n95_), .O(new_n152_));
  ...
  nand4  g099(.a(new_n67_), .b(new_n95_), .c(x20), .d(new_n159_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  aoi21  g102(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n154_), .d(new_n71_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(z13));
  inv1   g105(.a(x39), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(x04), .c(x40), .O(new_n169_));
  aoi21  g107(.a(new_n63_), .b(new_n95_), .c(x13), .O(new_n170_));
  aoi22  g108(.a(new_n170_), .b(new_n169_), .c(x35), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n147_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n171_), .c(new_n65_), .O(new_n174_));
  nand3  g112(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n175_));
  nand4  g113(.a(new_n155_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n176_));
  nor2   g114(.a(x13), .b(x04), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n176_), .c(x40), .d(x39), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  aoi21  g117(.a(new_n95_), .b(x27), .c(x40), .O(new_n180_));
  aoi21  g118(.a(new_n80_), .b(new_n79_), .c(new_n168_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n177_), .c(new_n63_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n99_), .c(new_n180_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n179_), .c(new_n174_), .O(z14));
  nand3  g122(.a(x27), .b(x26), .c(x12), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(x40), .c(new_n95_), .O(z15));
  ...
  nand2  g132(.a(new_n99_), .b(x08), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n194_), .c(new_n147_), .O(new_n196_));
  nand2  g134(.a(new_n79_), .b(new_n135_), .O(new_n197_));
  aoi21  g135(.a(new_n196_), .b(new_n82_), .c(new_n197_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n78_), .c(new_n120_), .d(new_n89_), .O(z18));
  inv1   g137(.a(new_n145_), .O(z19));
  oai22  g138(.a(new_n63_), .b(x35), .c(new_n82_), .d(x27), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n138_), .O(new_n202_));
  nor2   g140(.a(x40), .b(x35), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n91_), .c(new_n95_), .O(new_n204_));
  inv1   g142(.a(x08), .O(new_n205_));
  nand2  g143(.a(x35), .b(x27), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(x40), .c(new_n205_), .O(new_n207_));
  nand3  g145(.a(new_n63_), .b(x28), .c(new_n99_), .O(new_n208_));
  nand4  g146(.a(new_n208_), .b(new_n207_), .c(new_n204_), .d(new_n202_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n79_), .c(new_n135_), .O(new_n210_));
