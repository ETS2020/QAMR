...
module FAU ( 
  ...
  nor2   g044(.a(new_n106_), .b(new_n83_), .O(z05));
  aoi21  g045(.a(new_n81_), .b(new_n64_), .c(new_n86_), .O(new_n108_));
  ...
  aoi21  g059(.a(new_n97_), .b(x19), .c(new_n121_), .O(z08));
  ...
  aoi21  g072(.a(new_n134_), .b(x06), .c(new_n83_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(z10));
  inv1   g074(.a(x09), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x19), .c(new_n81_), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x19), .O(new_n141_));
  ...
  oai22  g089(.a(new_n75_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n152_));
  ...
  nand4  g096(.a(new_n72_), .b(x20), .c(new_n80_), .d(new_n158_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand4  g099(.a(new_n130_), .b(x39), .c(new_n154_), .d(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x19), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x40), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z13));
  oai21  g103(.a(new_n130_), .b(new_n80_), .c(x40), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n64_), .O(new_n167_));
  nand4  g105(.a(new_n155_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n76_), .c(new_n154_), .d(new_n65_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x19), .O(new_n170_));
  nand3  g108(.a(new_n72_), .b(x20), .c(new_n158_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n121_), .O(new_n172_));
  ...
  oai22  g121(.a(new_n87_), .b(x27), .c(new_n75_), .d(new_n183_), .O(new_n184_));
  ...
  nand4  g126(.a(new_n188_), .b(new_n185_), .c(new_n81_), .d(new_n137_), .O(z18));
  nand2  g127(.a(new_n147_), .b(new_n81_), .O(z19));
  nor2   g128(.a(new_n86_), .b(x27), .O(new_n191_));
  nor2   g129(.a(x35), .b(new_n80_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n191_), .c(new_n140_), .O(new_n193_));
  inv1   g131(.a(x08), .O(new_n194_));
  aoi21  g132(.a(x35), .b(x27), .c(new_n80_), .O(new_n195_));
  nor2   g133(.a(x40), .b(x27), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n195_), .c(new_n194_), .O(new_n197_));
  oai21  g135(.a(new_n191_), .b(new_n66_), .c(new_n121_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n197_), .c(new_n193_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n84_), .c(new_n137_), .O(new_n200_));
