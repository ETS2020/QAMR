...
module FAU ( 
  ...
  oai21  g031(.a(new_n93_), .b(new_n88_), .c(x40), .O(z02));
  nor2   g032(.a(x37), .b(x27), .O(new_n95_));
  aoi21  g033(.a(new_n68_), .b(x27), .c(new_n95_), .O(new_n96_));
  aoi22  g034(.a(new_n96_), .b(x21), .c(x40), .d(new_n88_), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi22  g036(.a(new_n96_), .b(new_n98_), .c(x40), .d(new_n88_), .O(z04));
  ...
  nor2   g051(.a(new_n63_), .b(new_n88_), .O(z08));
  nand4  g052(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n65_), .O(z09));
  inv1   g054(.a(x05), .O(new_n117_));
  nand2  g055(.a(new_n63_), .b(x07), .O(new_n118_));
  oai21  g056(.a(new_n63_), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  nand3  g057(.a(new_n119_), .b(new_n84_), .c(x27), .O(new_n120_));
  oai21  g058(.a(x32), .b(x30), .c(x40), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(new_n117_), .c(new_n120_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n73_), .O(new_n123_));
  nand3  g061(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n123_), .c(new_n65_), .O(z10));
  inv1   g063(.a(x29), .O(new_n126_));
  aoi21  g064(.a(x39), .b(new_n126_), .c(new_n63_), .O(new_n127_));
  nand2  g065(.a(x27), .b(x04), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n91_), .c(new_n127_), .O(new_n129_));
  inv1   g067(.a(x27), .O(new_n130_));
  nand2  g068(.a(new_n65_), .b(new_n130_), .O(new_n131_));
  oai21  g069(.a(new_n83_), .b(x04), .c(x39), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(x08), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n129_), .c(new_n79_), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(x09), .O(z11));
  nor3   g073(.a(x37), .b(x36), .c(x35), .O(new_n136_));
  nor2   g074(.a(new_n63_), .b(x27), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n136_), .c(new_n74_), .O(new_n138_));
  oai21  g076(.a(new_n63_), .b(x04), .c(new_n130_), .O(new_n139_));
  aoi22  g077(.a(x40), .b(new_n73_), .c(x35), .d(x28), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n67_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n139_), .c(new_n138_), .d(new_n65_), .O(z12));
  ...
  aoi21  g087(.a(new_n149_), .b(new_n146_), .c(new_n88_), .O(new_n150_));
  nand4  g088(.a(new_n69_), .b(new_n63_), .c(x20), .d(new_n148_), .O(new_n151_));
  ...
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n143_), .d(new_n73_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(z13));
  nand3  g094(.a(x40), .b(new_n143_), .c(new_n73_), .O(new_n157_));
  nand2  g095(.a(new_n148_), .b(new_n147_), .O(new_n158_));
  oai21  g096(.a(x37), .b(x28), .c(x20), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(new_n157_), .O(new_n160_));
  nor2   g098(.a(x37), .b(x35), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x28), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n137_), .c(x04), .O(new_n164_));
  oai21  g102(.a(new_n161_), .b(new_n137_), .c(x13), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n144_), .c(new_n161_), .O(new_n167_));
  ...
  aoi21  g108(.a(new_n170_), .b(new_n63_), .c(new_n64_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n169_), .c(new_n165_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n164_), .c(new_n160_), .O(z14));
  ...
  inv1   g121(.a(x35), .O(new_n184_));
  nand2  g122(.a(x27), .b(new_n73_), .O(new_n185_));
  nand2  g123(.a(new_n130_), .b(x08), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n184_), .O(new_n187_));
  inv1   g125(.a(x09), .O(new_n188_));
  nand2  g126(.a(new_n79_), .b(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n187_), .b(new_n82_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n64_), .c(new_n183_), .d(new_n90_), .O(z18));
  aoi21  g129(.a(x28), .b(new_n130_), .c(new_n184_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n127_), .O(new_n193_));
  nand2  g131(.a(x39), .b(new_n184_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n131_), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n79_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z20));
  nor2   g135(.a(new_n134_), .b(x09), .O(z19));
endmodule
