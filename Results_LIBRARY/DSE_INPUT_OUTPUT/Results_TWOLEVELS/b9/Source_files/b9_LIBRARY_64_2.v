...
module FAU ( 
  ...
  aoi21  g035(.a(new_n69_), .b(x39), .c(x27), .O(new_n98_));
  ...
  oai21  g068(.a(new_n90_), .b(new_n116_), .c(new_n77_), .O(new_n131_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n77_), .c(new_n116_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n98_), .c(new_n133_), .O(new_n137_));
  oai21  g075(.a(new_n69_), .b(x29), .c(x39), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n137_), .c(new_n132_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n74_), .c(new_n129_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n70_), .O(z11));
  nor2   g080(.a(new_n64_), .b(new_n90_), .O(new_n143_));
  nand3  g081(.a(new_n91_), .b(new_n76_), .c(new_n134_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  nor2   g083(.a(new_n143_), .b(new_n116_), .O(new_n146_));
  ...
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n149_), .d(new_n116_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand2  g092(.a(new_n88_), .b(new_n91_), .O(new_n155_));
  ...
  nand4  g095(.a(new_n155_), .b(new_n124_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n126_), .b(new_n149_), .c(new_n116_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand2  g100(.a(x40), .b(x04), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(x39), .c(new_n149_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n88_), .O(new_n165_));
  nand4  g103(.a(new_n134_), .b(new_n75_), .c(new_n74_), .d(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n91_), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n169_));
  nand4  g107(.a(new_n150_), .b(new_n75_), .c(new_n74_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x39), .c(new_n149_), .d(new_n116_), .O(new_n171_));
  ...
  oai21  g112(.a(new_n174_), .b(new_n124_), .c(new_n90_), .O(new_n175_));
  ...
  oai21  g123(.a(new_n78_), .b(x27), .c(new_n130_), .O(new_n186_));
