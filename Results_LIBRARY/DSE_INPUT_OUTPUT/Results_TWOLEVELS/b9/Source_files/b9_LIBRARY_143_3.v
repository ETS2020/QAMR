...
module FAU ( 
  ...
  nor2   g039(.a(new_n101_), .b(new_n64_), .O(z05));
  aoi21  g040(.a(new_n63_), .b(new_n67_), .c(new_n89_), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(x37), .c(new_n63_), .O(z06));
  ...
  nand3  g047(.a(x38), .b(new_n72_), .c(new_n107_), .O(new_n110_));
  ...
  oai21  g052(.a(x39), .b(x25), .c(x40), .O(new_n115_));
  ...
  nand2  g058(.a(new_n115_), .b(x07), .O(new_n121_));
  ...
  oai21  g068(.a(new_n126_), .b(new_n67_), .c(new_n130_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x40), .b(x39), .c(x29), .O(new_n133_));
  nor2   g071(.a(new_n67_), .b(new_n119_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n90_), .c(new_n133_), .O(new_n135_));
  inv1   g073(.a(x08), .O(new_n136_));
  nand3  g074(.a(new_n82_), .b(x27), .c(new_n119_), .O(new_n137_));
  ...
  nand3  g080(.a(new_n68_), .b(new_n142_), .c(new_n81_), .O(new_n143_));
  nand2  g081(.a(x40), .b(new_n67_), .O(new_n144_));
  ...
  or2    g085(.a(new_n70_), .b(x40), .O(new_n148_));
  ...
  nand4  g097(.a(new_n127_), .b(x39), .c(new_n150_), .d(new_n119_), .O(new_n160_));
  ...
  oai21  g103(.a(x13), .b(x04), .c(x40), .O(new_n166_));
  ...
  oai21  g128(.a(new_n90_), .b(x27), .c(new_n133_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n192_), .c(new_n137_), .d(new_n79_), .O(z18));
  inv1   g132(.a(new_n133_), .O(new_n195_));
  oai21  g133(.a(new_n81_), .b(new_n67_), .c(new_n136_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n67_), .c(new_n81_), .O(new_n197_));
  ...
  nand2  g138(.a(new_n140_), .b(new_n63_), .O(z19));
endmodule
