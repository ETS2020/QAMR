...
module FAU ( 
  ...
  inv1   g14(.a(new_n68_), .O(new_n78_));
  ...
  aoi21  g19(.a(new_n82_), .b(new_n79_), .c(new_n78_), .O(z03));
  aoi21  g20(.a(new_n64_), .b(new_n81_), .c(x21), .O(new_n84_));
  aoi21  g21(.a(new_n84_), .b(new_n79_), .c(new_n78_), .O(z04));
  ...
  nand3  g42(.a(new_n73_), .b(x07), .c(new_n106_), .O(new_n107_));
  nand2  g43(.a(x37), .b(x06), .O(new_n108_));
  nand2  g44(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g45(.a(new_n109_), .b(x27), .O(new_n110_));
  nand2  g46(.a(new_n110_), .b(new_n68_), .O(z10));
  inv1   g47(.a(x09), .O(new_n112_));
  inv1   g48(.a(x08), .O(new_n113_));
  aoi21  g49(.a(new_n81_), .b(new_n113_), .c(new_n71_), .O(new_n114_));
  aoi21  g50(.a(x27), .b(x04), .c(x28), .O(new_n115_));
  oai21  g51(.a(new_n114_), .b(new_n78_), .c(new_n115_), .O(new_n116_));
  nand3  g52(.a(new_n116_), .b(new_n70_), .c(new_n112_), .O(new_n117_));
  nand2  g53(.a(new_n117_), .b(new_n68_), .O(z11));
  aoi21  g54(.a(new_n66_), .b(x27), .c(new_n78_), .O(z12));
  nand4  g55(.a(new_n68_), .b(new_n66_), .c(x27), .d(x20), .O(new_n120_));
  ...
  aoi21  g60(.a(new_n124_), .b(new_n66_), .c(new_n78_), .O(z14));
  inv1   g61(.a(x12), .O(new_n126_));
  nor2   g62(.a(new_n104_), .b(new_n126_), .O(z15));
  inv1   g63(.a(x23), .O(new_n128_));
  nand4  g64(.a(new_n68_), .b(new_n128_), .c(x22), .d(x01), .O(new_n129_));
  inv1   g65(.a(new_n129_), .O(z16));
  inv1   g66(.a(x24), .O(new_n131_));
  nand4  g67(.a(new_n131_), .b(x23), .c(x22), .d(x01), .O(new_n132_));
  nand2  g68(.a(new_n132_), .b(new_n68_), .O(z17));
  inv1   g69(.a(x28), .O(new_n134_));
  nand2  g70(.a(x27), .b(new_n106_), .O(new_n135_));
  oai21  g71(.a(x27), .b(new_n113_), .c(new_n135_), .O(new_n136_));
  nand3  g72(.a(new_n136_), .b(x35), .c(new_n134_), .O(new_n137_));
  nor2   g73(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g74(.a(new_n138_), .b(new_n137_), .c(new_n78_), .O(z18));
  oai21  g75(.a(x28), .b(new_n113_), .c(new_n81_), .O(new_n140_));
  nand2  g76(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g77(.a(new_n141_), .b(new_n68_), .c(new_n70_), .d(new_n112_), .O(new_n142_));
  inv1   g78(.a(new_n142_), .O(z20));
  one    g79(.O(z02));
  zero   g80(.O(z08));
  nand2  g81(.a(new_n117_), .b(new_n68_), .O(z19));
endmodule
