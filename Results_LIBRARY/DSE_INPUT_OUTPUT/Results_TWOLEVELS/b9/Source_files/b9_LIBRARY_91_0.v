...
module FAU ( 
  ...
  aoi22  g026(.a(new_n88_), .b(new_n87_), .c(x28), .d(x04), .O(new_n89_));
  ...
  inv1   g030(.a(new_n65_), .O(new_n93_));
  ...
  nand2  g057(.a(new_n119_), .b(new_n65_), .O(z09));
  inv1   g058(.a(x05), .O(new_n121_));
  nand2  g059(.a(new_n117_), .b(x07), .O(new_n122_));
  oai21  g060(.a(new_n117_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  ...
  nor2   g066(.a(new_n66_), .b(new_n96_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n93_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n103_), .c(new_n72_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n65_), .d(new_n96_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  nand2  g074(.a(new_n64_), .b(x13), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x35), .c(new_n103_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  oai21  g079(.a(new_n134_), .b(x08), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n79_), .c(new_n132_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n65_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  nor2   g083(.a(new_n64_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n74_), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n72_), .c(new_n64_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n64_), .c(new_n69_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n147_), .c(new_n65_), .O(z12));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x28), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n63_), .d(new_n72_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n68_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n96_), .O(new_n157_));
  nand3  g095(.a(new_n125_), .b(x39), .c(new_n72_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x40), .c(x13), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n157_), .O(z13));
  nor2   g098(.a(x19), .b(x18), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n68_), .c(x27), .d(x20), .O(new_n162_));
  oai21  g100(.a(new_n148_), .b(x13), .c(new_n162_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n164_));
  nor2   g102(.a(x37), .b(x35), .O(new_n165_));
  aoi21  g103(.a(new_n164_), .b(new_n151_), .c(new_n165_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n103_), .c(x27), .O(new_n167_));
  ...
  nand2  g111(.a(new_n173_), .b(new_n65_), .O(z16));
  inv1   g112(.a(x01), .O(new_n175_));
  inv1   g113(.a(x24), .O(new_n176_));
  nand4  g114(.a(new_n65_), .b(new_n176_), .c(x23), .d(x22), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n175_), .O(z17));
  nand2  g116(.a(x27), .b(new_n72_), .O(new_n179_));
  nand2  g117(.a(new_n96_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n81_), .O(new_n181_));
  nand2  g119(.a(new_n79_), .b(new_n132_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n103_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n93_), .c(new_n117_), .d(new_n88_), .O(z18));
  inv1   g122(.a(new_n143_), .O(z19));
  oai22  g123(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x13), .O(new_n187_));
  aoi21  g125(.a(x35), .b(x27), .c(x08), .O(new_n188_));
  aoi21  g126(.a(x39), .b(x29), .c(x35), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(x40), .O(new_n190_));
  nand3  g128(.a(x40), .b(x39), .c(x29), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(x28), .c(new_n96_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n190_), .c(new_n187_), .O(new_n193_));
