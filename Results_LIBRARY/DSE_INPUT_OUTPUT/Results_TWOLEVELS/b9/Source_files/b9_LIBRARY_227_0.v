...
module FAU ( 
  ...
  oai21  g028(.a(new_n73_), .b(x35), .c(new_n81_), .O(new_n91_));
  ...
  nand3  g068(.a(new_n104_), .b(x37), .c(x06), .O(new_n131_));
  ...
  nor2   g072(.a(new_n134_), .b(new_n73_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(x39), .c(x05), .d(new_n71_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(z10));
  nand2  g075(.a(new_n104_), .b(new_n66_), .O(new_n138_));
  ...
  nand3  g086(.a(new_n67_), .b(new_n80_), .c(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x27), .c(x10), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n71_), .c(new_n69_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(x40), .O(new_n152_));
  nor2   g090(.a(new_n69_), .b(x40), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x25), .O(new_n154_));
  ...
  nand4  g103(.a(new_n135_), .b(x39), .c(new_n156_), .d(new_n71_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n165_), .c(new_n104_), .O(z13));
  oai21  g105(.a(new_n93_), .b(x04), .c(x40), .O(new_n168_));
  aoi21  g106(.a(new_n73_), .b(x25), .c(x13), .O(new_n169_));
  aoi22  g107(.a(new_n169_), .b(new_n168_), .c(x35), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n148_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n67_), .O(new_n173_));
  nand3  g111(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n174_));
  nand4  g112(.a(new_n157_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n175_));
  nor2   g113(.a(x13), .b(x04), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(new_n94_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  aoi21  g116(.a(x27), .b(x25), .c(x40), .O(new_n179_));
  nor2   g117(.a(new_n134_), .b(new_n93_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n176_), .c(new_n73_), .O(new_n181_));
  ...
  nand2  g122(.a(new_n184_), .b(new_n104_), .O(z15));
  inv1   g123(.a(x23), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(x22), .c(x01), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n104_), .O(z16));
  inv1   g126(.a(x24), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(x23), .c(x22), .d(x01), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n104_), .O(z17));
  nand2  g129(.a(new_n94_), .b(x29), .O(new_n192_));
  ...
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n104_), .d(new_n78_), .O(z18));
  nor2   g135(.a(x40), .b(x35), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n90_), .c(x25), .O(new_n199_));
  ...
  nand3  g140(.a(new_n192_), .b(x28), .c(new_n66_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n202_), .c(new_n199_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n78_), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(x09), .c(new_n104_), .O(z20));
