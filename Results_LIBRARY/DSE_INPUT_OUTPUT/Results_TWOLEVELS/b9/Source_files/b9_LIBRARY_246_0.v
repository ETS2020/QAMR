...
module FAU ( 
  ...
  nor2   g000(.a(x40), .b(x09), .O(new_n63_));
  ...
  nand2  g030(.a(new_n74_), .b(x09), .O(new_n93_));
  ...
  aoi21  g035(.a(new_n65_), .b(new_n97_), .c(new_n96_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n63_), .O(z03));
  aoi21  g037(.a(new_n65_), .b(new_n97_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n63_), .O(z04));
  aoi21  g039(.a(x28), .b(x27), .c(x37), .O(new_n102_));
  nor2   g040(.a(new_n102_), .b(new_n63_), .O(z05));
  oai22  g041(.a(x40), .b(x09), .c(new_n82_), .d(new_n97_), .O(new_n104_));
  ...
  nand2  g057(.a(new_n119_), .b(new_n64_), .O(z08));
  ...
  nor2   g069(.a(new_n65_), .b(new_n97_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n63_), .O(new_n133_));
  ...
  nand4  g077(.a(x35), .b(new_n82_), .c(x27), .d(new_n71_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(x40), .c(new_n79_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x40), .c(x09), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n97_), .c(new_n73_), .O(new_n146_));
  nand2  g084(.a(x39), .b(new_n71_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n68_), .O(new_n148_));
  nand2  g086(.a(new_n82_), .b(x09), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x35), .c(x37), .O(new_n150_));
  nand2  g088(.a(x27), .b(x09), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n74_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n148_), .c(new_n146_), .O(z12));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n71_), .c(new_n63_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(z13));
  nand3  g104(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n167_));
  inv1   g105(.a(new_n119_), .O(new_n168_));
  nand4  g106(.a(new_n155_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n154_), .d(new_n71_), .O(new_n170_));
  ...
  nand3  g113(.a(x39), .b(new_n154_), .c(new_n71_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n68_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n171_), .d(new_n152_), .O(z14));
  ...
  nand3  g126(.a(x35), .b(new_n82_), .c(new_n97_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n135_), .c(new_n139_), .O(new_n190_));
  nand2  g128(.a(new_n140_), .b(new_n79_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n190_), .c(x40), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n188_), .O(z18));
  nand4  g131(.a(new_n142_), .b(x40), .c(new_n79_), .d(new_n188_), .O(new_n194_));
  inv1   g132(.a(new_n194_), .O(z19));
  inv1   g133(.a(new_n135_), .O(new_n196_));
  oai21  g134(.a(new_n172_), .b(new_n97_), .c(new_n139_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n97_), .c(new_n172_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand4  g137(.a(new_n199_), .b(x40), .c(new_n79_), .d(new_n188_), .O(new_n200_));
