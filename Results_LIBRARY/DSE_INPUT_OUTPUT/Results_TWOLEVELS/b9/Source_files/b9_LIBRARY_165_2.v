...
module FAU ( 
  ...
  nand2  g031(.a(new_n82_), .b(x27), .O(new_n94_));
  nand2  g032(.a(new_n66_), .b(x28), .O(new_n95_));
  ...
  aoi21  g037(.a(new_n66_), .b(new_n99_), .c(new_n78_), .O(new_n100_));
  ...
  nor2   g041(.a(new_n82_), .b(new_n99_), .O(new_n104_));
  ...
  nand3  g061(.a(new_n123_), .b(new_n84_), .c(new_n72_), .O(new_n124_));
  ...
  nor3   g066(.a(new_n128_), .b(new_n63_), .c(new_n93_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(x05), .c(new_n72_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n127_), .O(z10));
  inv1   g069(.a(x29), .O(new_n132_));
  aoi21  g070(.a(x40), .b(new_n132_), .c(new_n93_), .O(new_n133_));
  ...
  oai22  g083(.a(new_n145_), .b(new_n99_), .c(new_n93_), .d(x04), .O(new_n146_));
  ...
  nand4  g093(.a(new_n68_), .b(new_n93_), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n129_), .b(new_n148_), .c(new_n72_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  oai21  g098(.a(new_n128_), .b(x13), .c(x40), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(x39), .c(new_n72_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n99_), .O(new_n163_));
  nand3  g101(.a(x39), .b(new_n148_), .c(new_n72_), .O(new_n164_));
  nand3  g102(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n145_), .c(new_n164_), .O(new_n166_));
  nand2  g104(.a(new_n165_), .b(new_n149_), .O(new_n167_));
  oai21  g105(.a(x37), .b(x35), .c(new_n167_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n166_), .c(new_n163_), .d(new_n64_), .O(z14));
  ...
  oai22  g117(.a(new_n83_), .b(x27), .c(new_n93_), .d(new_n132_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n99_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n90_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g122(.a(x28), .b(new_n99_), .c(new_n89_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n133_), .O(new_n186_));
  nand2  g124(.a(x40), .b(new_n89_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n136_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n79_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z20));
  buf    g128(.a(x39), .O(z08));
  nor2   g129(.a(new_n140_), .b(x09), .O(z19));
endmodule
