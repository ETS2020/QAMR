...
module FAU ( 
  ...
  aoi21  g14(.a(new_n76_), .b(x04), .c(new_n64_), .O(z01));
  nand2  g15(.a(new_n67_), .b(x27), .O(new_n79_));
  inv1   g16(.a(x21), .O(new_n80_));
  inv1   g17(.a(x27), .O(new_n81_));
  aoi21  g18(.a(new_n66_), .b(new_n81_), .c(new_n80_), .O(new_n82_));
  aoi21  g19(.a(new_n82_), .b(new_n79_), .c(new_n64_), .O(z03));
  aoi21  g20(.a(new_n66_), .b(new_n81_), .c(x21), .O(new_n84_));
  aoi21  g21(.a(new_n84_), .b(new_n79_), .c(new_n64_), .O(z04));
  nand2  g22(.a(x28), .b(x27), .O(new_n86_));
  nand3  g23(.a(new_n86_), .b(new_n63_), .c(new_n66_), .O(z05));
  nand2  g24(.a(z05), .b(new_n63_), .O(z06));
  ...
  nand2  g37(.a(new_n100_), .b(new_n63_), .O(z07));
  nand4  g38(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n103_));
  nand2  g39(.a(new_n103_), .b(new_n63_), .O(z09));
  ...
  nand2  g44(.a(new_n108_), .b(x27), .O(new_n109_));
  nand2  g45(.a(new_n109_), .b(new_n63_), .O(z10));
  inv1   g46(.a(x09), .O(new_n111_));
  inv1   g47(.a(x28), .O(new_n112_));
  nand2  g48(.a(x27), .b(x04), .O(new_n113_));
  inv1   g49(.a(x08), .O(new_n114_));
  nand2  g50(.a(new_n81_), .b(new_n114_), .O(new_n115_));
  nand4  g51(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n112_), .O(new_n116_));
  nand4  g52(.a(new_n116_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(new_n117_));
  inv1   g53(.a(new_n117_), .O(z11));
  aoi21  g54(.a(new_n68_), .b(x27), .c(new_n64_), .O(z12));
  nand4  g55(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n120_));
  nor3   g56(.a(new_n120_), .b(x19), .c(x18), .O(z13));
  nor2   g57(.a(x19), .b(x18), .O(new_n122_));
  nand3  g58(.a(new_n122_), .b(x27), .c(x20), .O(new_n123_));
  inv1   g59(.a(new_n123_), .O(new_n124_));
  aoi21  g60(.a(new_n124_), .b(new_n68_), .c(new_n64_), .O(z14));
  inv1   g61(.a(x12), .O(new_n126_));
  nand4  g62(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n127_));
  nor2   g63(.a(new_n127_), .b(new_n126_), .O(z15));
  inv1   g64(.a(x23), .O(new_n129_));
  nand4  g65(.a(new_n63_), .b(new_n129_), .c(x22), .d(x01), .O(new_n130_));
  inv1   g66(.a(new_n130_), .O(z16));
  inv1   g67(.a(x01), .O(new_n132_));
  inv1   g68(.a(x24), .O(new_n133_));
  nand4  g69(.a(new_n63_), .b(new_n133_), .c(x23), .d(x22), .O(new_n134_));
  nor2   g70(.a(new_n134_), .b(new_n132_), .O(z17));
  nand2  g71(.a(x27), .b(new_n105_), .O(new_n136_));
  oai21  g72(.a(x27), .b(new_n114_), .c(new_n136_), .O(new_n137_));
  nand3  g73(.a(new_n137_), .b(x35), .c(new_n112_), .O(new_n138_));
  nor2   g74(.a(x30), .b(x09), .O(new_n139_));
  aoi21  g75(.a(new_n139_), .b(new_n138_), .c(new_n64_), .O(z18));
  nand2  g76(.a(new_n117_), .b(new_n63_), .O(z19));
  oai21  g77(.a(x28), .b(new_n114_), .c(new_n81_), .O(new_n142_));
  nand2  g78(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g79(.a(new_n143_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(new_n144_));
  inv1   g80(.a(new_n144_), .O(z20));
  one    g81(.O(z02));
  zero   g82(.O(z08));
endmodule
