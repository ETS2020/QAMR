...
module FAU ( 
  ...
  nand2  g033(.a(new_n88_), .b(x04), .O(new_n96_));
  inv1   g034(.a(x39), .O(new_n97_));
  nor2   g035(.a(x27), .b(x08), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(x04), .c(new_n97_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n96_), .c(new_n95_), .d(x40), .O(z02));
  nor2   g038(.a(x37), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n71_), .b(x27), .c(new_n101_), .O(new_n102_));
  aoi22  g040(.a(new_n102_), .b(x21), .c(new_n81_), .d(new_n80_), .O(z03));
  inv1   g041(.a(x21), .O(new_n104_));
  aoi22  g042(.a(new_n102_), .b(new_n104_), .c(new_n81_), .d(new_n80_), .O(z04));
  aoi21  g043(.a(x28), .b(x27), .c(x37), .O(new_n106_));
  nor2   g044(.a(new_n106_), .b(new_n84_), .O(z05));
  aoi21  g045(.a(new_n82_), .b(new_n64_), .c(new_n87_), .O(new_n108_));
  ...
  nand2  g076(.a(new_n81_), .b(x19), .O(new_n139_));
  ...
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n87_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  oai21  g083(.a(new_n138_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n85_), .c(new_n136_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(z11));
  inv1   g086(.a(x10), .O(new_n149_));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  nor2   g088(.a(new_n81_), .b(x27), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  nand3  g090(.a(x40), .b(x39), .c(new_n65_), .O(new_n153_));
  oai21  g091(.a(new_n73_), .b(new_n64_), .c(new_n153_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n152_), .c(new_n82_), .O(z12));
  inv1   g093(.a(x13), .O(new_n156_));
  nand2  g094(.a(x36), .b(x35), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x28), .c(new_n81_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n156_), .d(new_n65_), .O(new_n159_));
  inv1   g097(.a(x18), .O(new_n160_));
  nand4  g098(.a(new_n72_), .b(x20), .c(new_n80_), .d(new_n160_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x27), .O(new_n163_));
  nand3  g101(.a(new_n129_), .b(x40), .c(x39), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x13), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n65_), .c(new_n84_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z13));
  nand4  g105(.a(new_n157_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand4  g107(.a(x40), .b(x39), .c(new_n156_), .d(new_n65_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(x19), .O(new_n171_));
  nand2  g109(.a(x20), .b(new_n160_), .O(new_n172_));
  nor2   g110(.a(new_n97_), .b(x13), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n168_), .c(new_n65_), .O(new_n174_));
  ...
  nand3  g116(.a(x39), .b(new_n156_), .c(new_n65_), .O(new_n179_));
  oai21  g117(.a(new_n73_), .b(new_n64_), .c(new_n179_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n178_), .c(new_n175_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n171_), .O(z14));
  ...
  nand2  g130(.a(new_n76_), .b(x29), .O(new_n193_));
  oai21  g131(.a(new_n88_), .b(x27), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x08), .O(new_n195_));
  nor2   g133(.a(new_n66_), .b(x28), .O(new_n196_));
  nor2   g134(.a(new_n64_), .b(x04), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(x09), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n195_), .c(new_n82_), .d(new_n85_), .O(z18));
  nand2  g137(.a(new_n147_), .b(new_n82_), .O(z19));
  nor2   g138(.a(x40), .b(x35), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n98_), .c(x19), .O(new_n202_));
  ...
  nand3  g143(.a(new_n193_), .b(x28), .c(new_n64_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n205_), .c(new_n202_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n85_), .c(new_n136_), .O(new_n208_));
