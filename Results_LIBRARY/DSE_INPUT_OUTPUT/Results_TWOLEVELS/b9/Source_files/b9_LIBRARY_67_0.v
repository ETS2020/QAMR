...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n206_;
  nor2   g000(.a(x40), .b(x38), .O(new_n63_));
  ...
  aoi21  g023(.a(new_n85_), .b(x04), .c(new_n63_), .O(z01));
  ...
  nand2  g029(.a(new_n73_), .b(x38), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n91_), .O(z02));
  nand2  g031(.a(new_n68_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x21), .O(new_n95_));
  aoi21  g033(.a(new_n67_), .b(new_n66_), .c(new_n95_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n94_), .c(new_n63_), .O(z03));
  aoi21  g035(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n63_), .O(z04));
  inv1   g037(.a(new_n63_), .O(new_n100_));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n100_), .c(new_n67_), .O(z05));
  aoi21  g040(.a(new_n100_), .b(new_n66_), .c(new_n81_), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(x37), .c(new_n100_), .O(z06));
  ...
  nand2  g054(.a(new_n116_), .b(new_n100_), .O(z08));
  inv1   g055(.a(x11), .O(new_n118_));
  nand4  g056(.a(new_n100_), .b(x34), .c(x27), .d(x26), .O(new_n119_));
  nor2   g057(.a(new_n119_), .b(new_n118_), .O(z09));
  inv1   g058(.a(x07), .O(new_n121_));
  inv1   g059(.a(x39), .O(new_n122_));
  nand2  g060(.a(x40), .b(new_n122_), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n92_), .c(new_n121_), .O(new_n124_));
  nand3  g062(.a(x40), .b(x39), .c(x05), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n124_), .c(new_n83_), .O(new_n127_));
  nand3  g065(.a(new_n100_), .b(x37), .c(x06), .O(new_n128_));
  oai21  g066(.a(new_n127_), .b(x04), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x27), .O(new_n130_));
  inv1   g068(.a(x05), .O(new_n131_));
  nand2  g069(.a(new_n79_), .b(new_n78_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x40), .c(x39), .O(new_n133_));
  nor2   g071(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n71_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n130_), .O(z10));
  nand2  g074(.a(new_n100_), .b(new_n66_), .O(new_n137_));
  oai21  g075(.a(new_n82_), .b(x04), .c(x40), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n137_), .c(x08), .O(new_n139_));
  inv1   g077(.a(new_n82_), .O(new_n140_));
  nand2  g078(.a(x39), .b(x29), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x40), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n92_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n139_), .c(new_n78_), .O(new_n145_));
  nor2   g083(.a(new_n145_), .b(x09), .O(z11));
  inv1   g084(.a(x35), .O(new_n147_));
  nand3  g085(.a(new_n67_), .b(new_n80_), .c(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi21  g087(.a(x39), .b(new_n71_), .c(new_n69_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n151_));
  nor2   g089(.a(new_n69_), .b(x40), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x38), .O(new_n153_));
  ...
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n71_), .O(new_n158_));
  ...
  nand2  g100(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x27), .O(new_n164_));
  nor2   g102(.a(new_n133_), .b(x13), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n71_), .c(new_n63_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(z13));
  nand3  g105(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n168_));
  inv1   g106(.a(new_n116_), .O(new_n169_));
  nand4  g107(.a(new_n156_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n169_), .c(new_n155_), .d(new_n71_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n168_), .O(new_n172_));
  nand3  g110(.a(new_n67_), .b(new_n147_), .c(x28), .O(new_n173_));
  oai21  g111(.a(new_n73_), .b(x27), .c(new_n173_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n79_), .c(new_n78_), .O(new_n175_));
  oai21  g113(.a(new_n122_), .b(x04), .c(x40), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n92_), .c(new_n155_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n68_), .c(new_n67_), .O(new_n178_));
  aoi21  g116(.a(x38), .b(x27), .c(x40), .O(new_n179_));
  nor2   g117(.a(new_n122_), .b(x13), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n71_), .c(new_n73_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n66_), .c(new_n179_), .O(new_n182_));
  ...
  nand4  g124(.a(new_n100_), .b(new_n186_), .c(x22), .d(x01), .O(new_n187_));
  inv1   g125(.a(new_n187_), .O(z16));
  inv1   g126(.a(x24), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(x23), .c(x22), .d(x01), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n100_), .O(z17));
  inv1   g129(.a(x29), .O(new_n192_));
  oai22  g130(.a(new_n116_), .b(new_n192_), .c(new_n82_), .d(x27), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  nor2   g132(.a(new_n66_), .b(x04), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n140_), .c(x09), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n100_), .d(new_n78_), .O(z18));
  oai22  g135(.a(new_n73_), .b(x35), .c(new_n81_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n141_), .O(new_n199_));
  oai21  g137(.a(new_n73_), .b(x08), .c(new_n92_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n147_), .O(new_n201_));
  nor2   g139(.a(new_n63_), .b(x08), .O(new_n202_));
  nor2   g140(.a(x40), .b(new_n81_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n66_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n78_), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(x09), .c(new_n100_), .O(z20));
  nor2   g145(.a(new_n145_), .b(x09), .O(z19));
endmodule
