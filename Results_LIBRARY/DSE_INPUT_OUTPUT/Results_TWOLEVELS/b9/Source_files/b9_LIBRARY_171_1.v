...
module FAU ( 
  ...
  nand3  g051(.a(new_n113_), .b(new_n111_), .c(new_n81_), .O(new_n114_));
  ...
  nand3  g058(.a(x40), .b(x39), .c(x33), .O(new_n121_));
  ...
  aoi21  g064(.a(new_n75_), .b(x33), .c(new_n76_), .O(new_n127_));
  nand4  g065(.a(x40), .b(x39), .c(x33), .d(x05), .O(new_n128_));
  oai21  g066(.a(new_n127_), .b(new_n126_), .c(new_n128_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n89_), .c(new_n65_), .O(new_n130_));
  ...
  nor4   g072(.a(new_n134_), .b(new_n76_), .c(new_n75_), .d(new_n81_), .O(new_n135_));
  ...
  nand3  g076(.a(x35), .b(new_n87_), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x33), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n138_), .c(x08), .O(new_n141_));
  inv1   g079(.a(new_n88_), .O(new_n142_));
  nand2  g080(.a(x39), .b(x29), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x33), .c(new_n76_), .O(new_n144_));
  nand2  g082(.a(x27), .b(x04), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n142_), .c(new_n144_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n141_), .c(new_n85_), .O(new_n147_));
  ...
  nand4  g101(.a(new_n72_), .b(new_n76_), .c(x20), .d(new_n161_), .O(new_n164_));
  ...
  nor2   g106(.a(new_n134_), .b(x13), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(new_n81_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n153_), .c(new_n64_), .O(new_n171_));
  nand3  g109(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n172_));
  nand4  g110(.a(new_n157_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n173_));
  nor2   g111(.a(x13), .b(x04), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n173_), .c(new_n77_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n172_), .O(new_n176_));
  inv1   g114(.a(new_n71_), .O(new_n177_));
  aoi21  g115(.a(new_n174_), .b(new_n77_), .c(new_n177_), .O(new_n178_));
  nand4  g116(.a(new_n66_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n179_));
  inv1   g117(.a(new_n179_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n178_), .c(new_n70_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n176_), .c(new_n171_), .d(new_n82_), .O(z14));
  ...
  nand2  g135(.a(new_n77_), .b(x33), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n94_), .c(new_n197_), .d(new_n84_), .O(z18));
  oai21  g137(.a(new_n147_), .b(x09), .c(new_n82_), .O(z19));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(new_n144_), .O(new_n202_));
  nand2  g140(.a(new_n66_), .b(x33), .O(new_n203_));
  aoi21  g141(.a(new_n203_), .b(new_n138_), .c(x08), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n85_), .O(new_n205_));
