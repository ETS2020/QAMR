...
module FAU ( 
  ...
  inv1   g06(.a(new_n67_), .O(new_n69_));
  ...
  aoi21  g13(.a(new_n75_), .b(x04), .c(new_n69_), .O(z01));
  ...
  aoi21  g20(.a(new_n83_), .b(new_n80_), .c(new_n69_), .O(z03));
  aoi21  g21(.a(new_n82_), .b(new_n78_), .c(x21), .O(new_n85_));
  aoi21  g22(.a(new_n85_), .b(new_n80_), .c(new_n69_), .O(z04));
  aoi21  g23(.a(x28), .b(x27), .c(x37), .O(new_n87_));
  nor2   g24(.a(new_n87_), .b(new_n69_), .O(z05));
  ...
  nand2  g48(.a(new_n112_), .b(new_n67_), .O(z10));
