...
module FAU ( 
  ...
  nand4  g027(.a(new_n89_), .b(new_n87_), .c(new_n86_), .d(x39), .O(z02));
  ...
  oai22  g068(.a(new_n130_), .b(new_n128_), .c(x39), .d(new_n129_), .O(new_n131_));
  ...
  aoi21  g073(.a(new_n76_), .b(new_n75_), .c(new_n69_), .O(new_n136_));
  ...
  aoi21  g078(.a(x40), .b(new_n140_), .c(new_n73_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n79_), .b(x04), .c(x40), .O(new_n145_));
  ...
  nand2  g089(.a(x39), .b(new_n121_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n151_), .c(new_n127_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n150_), .c(x40), .O(new_n154_));
  ...
  nand4  g097(.a(new_n159_), .b(x39), .c(new_n157_), .d(new_n127_), .O(new_n160_));
  ...
  aoi21  g104(.a(new_n166_), .b(x40), .c(new_n73_), .O(new_n167_));
  ...
  nand2  g138(.a(x40), .b(new_n92_), .O(new_n201_));
