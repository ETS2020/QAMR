...
module FAU ( 
  ...
  oai21  g54(.a(z08), .b(x28), .c(x35), .O(new_n117_));
  nand2  g55(.a(new_n117_), .b(new_n64_), .O(new_n118_));
  nand3  g56(.a(new_n118_), .b(z02), .c(x27), .O(z12));
  nand4  g57(.a(z02), .b(new_n66_), .c(x27), .d(x20), .O(new_n120_));
  nor3   g58(.a(new_n120_), .b(x19), .c(x18), .O(z13));
  nand3  g59(.a(z02), .b(x27), .c(x20), .O(new_n122_));
  nor3   g60(.a(new_n122_), .b(x19), .c(x18), .O(new_n123_));
  nand2  g61(.a(new_n123_), .b(new_n118_), .O(z14));
  inv1   g62(.a(x12), .O(new_n125_));
  nor2   g63(.a(new_n102_), .b(new_n125_), .O(z15));
