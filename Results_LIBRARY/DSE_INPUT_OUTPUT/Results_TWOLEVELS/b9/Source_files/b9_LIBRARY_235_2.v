...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x12), .O(new_n81_));
  ...
  nor2   g035(.a(x40), .b(x12), .O(new_n98_));
  ...
  aoi21  g063(.a(x40), .b(new_n75_), .c(new_n98_), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x05), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n87_), .c(new_n65_), .O(new_n129_));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n99_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n139_), .c(new_n83_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(x09), .c(new_n81_), .O(z11));
  ...
  oai21  g090(.a(new_n152_), .b(new_n98_), .c(new_n151_), .O(new_n153_));
  ...
  nor2   g100(.a(new_n161_), .b(x12), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n134_), .b(new_n155_), .c(new_n65_), .O(new_n165_));
  ...
  oai21  g109(.a(new_n171_), .b(new_n98_), .c(new_n167_), .O(new_n172_));
  ...
  nand3  g117(.a(new_n151_), .b(new_n76_), .c(new_n179_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n178_), .c(new_n172_), .O(z14));
  ...
  nand2  g133(.a(new_n83_), .b(new_n195_), .O(new_n196_));
  aoi21  g134(.a(new_n194_), .b(new_n85_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n101_), .c(new_n92_), .d(new_n191_), .O(z18));
  nor2   g136(.a(new_n145_), .b(x09), .O(z19));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  aoi21  g138(.a(new_n142_), .b(new_n99_), .c(new_n200_), .O(new_n201_));
  nand2  g139(.a(x40), .b(new_n66_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n137_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n83_), .O(new_n204_));
