...
module FAU ( 
  ...
  nand2  g030(.a(x40), .b(new_n82_), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n91_), .c(x04), .O(new_n95_));
  inv1   g033(.a(x39), .O(new_n96_));
  nand3  g034(.a(new_n67_), .b(x28), .c(x04), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n96_), .c(new_n79_), .O(new_n98_));
  nand3  g036(.a(new_n98_), .b(new_n95_), .c(new_n90_), .O(z02));
  ...
  aoi21  g040(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n100_), .c(new_n79_), .O(z04));
  aoi21  g042(.a(x28), .b(x27), .c(x37), .O(new_n105_));
  nor2   g043(.a(new_n105_), .b(new_n79_), .O(z05));
  aoi21  g044(.a(new_n64_), .b(new_n66_), .c(new_n92_), .O(new_n107_));
  ...
  oai22  g063(.a(new_n125_), .b(new_n123_), .c(x39), .d(new_n124_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n84_), .c(new_n73_), .O(new_n127_));
  ...
  aoi21  g068(.a(new_n81_), .b(new_n80_), .c(new_n63_), .O(new_n131_));
  ...
  nand3  g074(.a(new_n136_), .b(x35), .c(new_n92_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand3  g076(.a(x35), .b(new_n92_), .c(new_n73_), .O(new_n139_));
  ...
  nand3  g081(.a(new_n67_), .b(new_n83_), .c(new_n82_), .O(new_n144_));
  ...
  nand2  g095(.a(new_n81_), .b(new_n80_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n149_), .c(new_n73_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x40), .c(new_n96_), .O(new_n160_));
  ...
  oai21  g102(.a(new_n162_), .b(new_n96_), .c(new_n164_), .O(new_n165_));
  ...
  oai21  g106(.a(new_n168_), .b(new_n92_), .c(x27), .O(new_n169_));
  ...
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n82_), .O(new_n182_));
  nand2  g120(.a(new_n80_), .b(new_n134_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(new_n92_), .c(new_n183_), .O(new_n184_));
  oai22  g122(.a(new_n184_), .b(new_n79_), .c(new_n125_), .d(new_n89_), .O(z18));
  inv1   g123(.a(new_n142_), .O(z19));
  oai21  g124(.a(new_n92_), .b(x27), .c(x35), .O(new_n187_));
  and2   g125(.a(new_n187_), .b(new_n135_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n66_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n93_), .c(x08), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n80_), .O(new_n191_));
