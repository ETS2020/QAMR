...
module FAU ( 
  ...
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n78_), .O(z04));
  aoi21  g037(.a(x28), .b(x27), .c(x37), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n78_), .O(z05));
  aoi21  g039(.a(new_n64_), .b(new_n92_), .c(new_n82_), .O(new_n102_));
  ...
  nand3  g060(.a(new_n122_), .b(new_n84_), .c(new_n72_), .O(new_n123_));
  ...
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n64_), .d(new_n92_), .O(new_n137_));
  ...
  oai21  g081(.a(new_n63_), .b(new_n72_), .c(x39), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n92_), .O(new_n145_));
  nand2  g083(.a(x39), .b(new_n72_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n67_), .c(new_n66_), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(new_n145_), .c(new_n143_), .d(new_n64_), .O(z12));
  ...
  nand4  g094(.a(new_n68_), .b(new_n115_), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n128_), .b(new_n149_), .c(new_n72_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  nand3  g099(.a(x39), .b(new_n149_), .c(new_n72_), .O(new_n162_));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n68_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(new_n166_));
  inv1   g104(.a(new_n142_), .O(new_n167_));
  nor2   g105(.a(x37), .b(x35), .O(new_n168_));
  aoi21  g106(.a(new_n163_), .b(new_n150_), .c(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n82_), .c(new_n167_), .O(new_n170_));
  ...
  aoi21  g111(.a(new_n173_), .b(new_n92_), .c(new_n78_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n171_), .c(new_n166_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nor2   g114(.a(new_n118_), .b(new_n176_), .O(z15));
  ...
  nand2  g122(.a(x39), .b(x29), .O(new_n185_));
  oai21  g123(.a(new_n83_), .b(x27), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  inv1   g125(.a(new_n83_), .O(new_n188_));
  nor2   g126(.a(new_n92_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n187_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g129(.a(new_n139_), .O(z19));
  aoi22  g130(.a(new_n185_), .b(x28), .c(new_n64_), .d(new_n91_), .O(new_n193_));
  inv1   g131(.a(x35), .O(new_n194_));
  nand2  g132(.a(new_n89_), .b(x40), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(x39), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n194_), .O(new_n197_));
  oai21  g135(.a(new_n193_), .b(x27), .c(new_n197_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n131_), .O(new_n199_));
