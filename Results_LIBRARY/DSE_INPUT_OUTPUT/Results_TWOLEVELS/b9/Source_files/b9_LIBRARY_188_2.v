...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x13), .O(new_n96_));
  ...
  aoi21  g044(.a(new_n79_), .b(new_n67_), .c(new_n83_), .O(new_n107_));
  ...
  nand2  g062(.a(new_n121_), .b(x07), .O(new_n125_));
  ...
  oai21  g074(.a(x28), .b(x04), .c(x40), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(x35), .c(x27), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand3  g077(.a(x40), .b(x39), .c(x29), .O(new_n140_));
  nor2   g078(.a(new_n67_), .b(new_n72_), .O(new_n141_));
  ...
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n63_), .d(new_n72_), .O(new_n157_));
  inv1   g095(.a(x18), .O(new_n158_));
  inv1   g096(.a(x19), .O(new_n159_));
  nand4  g097(.a(new_n151_), .b(x20), .c(new_n159_), .d(new_n158_), .O(new_n160_));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n72_), .c(new_n64_), .O(new_n165_));
  ...
  nand3  g106(.a(x39), .b(new_n63_), .c(new_n72_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n74_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n96_), .c(new_n167_), .O(new_n172_));
  nand3  g110(.a(new_n68_), .b(new_n146_), .c(x28), .O(new_n173_));
  ...
  nand3  g116(.a(new_n178_), .b(new_n172_), .c(new_n153_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nand4  g118(.a(new_n79_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n146_), .O(new_n192_));
  nand2  g130(.a(new_n80_), .b(new_n135_), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n83_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n64_), .c(new_n121_), .d(new_n90_), .O(z18));
  inv1   g133(.a(new_n140_), .O(new_n196_));
  oai21  g134(.a(new_n146_), .b(new_n67_), .c(new_n136_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n67_), .c(new_n146_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n135_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n79_), .O(z20));
  nand2  g139(.a(new_n144_), .b(new_n79_), .O(z19));
endmodule
