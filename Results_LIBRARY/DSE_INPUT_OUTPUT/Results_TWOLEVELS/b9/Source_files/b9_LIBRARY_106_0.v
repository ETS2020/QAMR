...
module FAU ( 
  ...
  nand3  g034(.a(new_n96_), .b(new_n91_), .c(new_n76_), .O(z02));
  ...
  oai21  g043(.a(x40), .b(x39), .c(new_n64_), .O(new_n106_));
  oai21  g044(.a(x40), .b(x39), .c(new_n93_), .O(new_n107_));
  ...
  aoi21  g075(.a(x39), .b(new_n66_), .c(x28), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n106_), .c(new_n65_), .O(new_n139_));
  ...
  oai21  g082(.a(new_n144_), .b(new_n142_), .c(new_n143_), .O(new_n145_));
  oai21  g083(.a(new_n144_), .b(new_n95_), .c(new_n128_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n140_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n83_), .c(new_n136_), .O(new_n148_));
  ...
  nand3  g092(.a(new_n128_), .b(new_n70_), .c(new_n93_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(new_n151_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x40), .O(new_n157_));
  oai21  g095(.a(new_n94_), .b(x04), .c(new_n93_), .O(new_n158_));
  nand2  g096(.a(new_n94_), .b(new_n66_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n158_), .c(x37), .O(new_n160_));
  nor2   g098(.a(x40), .b(x27), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n160_), .c(x39), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n157_), .O(z12));
  inv1   g101(.a(x13), .O(new_n164_));
  nand2  g102(.a(x36), .b(x35), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x28), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(x40), .c(new_n164_), .d(new_n65_), .O(new_n167_));
  inv1   g105(.a(x18), .O(new_n168_));
  inv1   g106(.a(x19), .O(new_n169_));
  nand4  g107(.a(new_n72_), .b(x20), .c(new_n169_), .d(new_n168_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n167_), .c(new_n128_), .O(new_n171_));
  nand4  g109(.a(new_n72_), .b(x40), .c(x20), .d(new_n169_), .O(new_n172_));
  nor2   g110(.a(new_n172_), .b(x18), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n171_), .c(x27), .O(new_n174_));
  nand3  g112(.a(new_n130_), .b(new_n164_), .c(new_n65_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(z13));
  nand3  g114(.a(x20), .b(new_n169_), .c(new_n168_), .O(new_n177_));
  oai22  g115(.a(new_n94_), .b(x35), .c(new_n128_), .d(x36), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n179_));
  nor2   g117(.a(x40), .b(new_n128_), .O(new_n180_));
  nand3  g118(.a(x39), .b(new_n164_), .c(new_n65_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(x40), .c(new_n180_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n179_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n177_), .O(new_n184_));
  nand2  g122(.a(new_n181_), .b(new_n150_), .O(new_n185_));
  oai21  g123(.a(new_n128_), .b(x13), .c(new_n93_), .O(new_n186_));
  nand4  g124(.a(new_n66_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n70_), .O(new_n189_));
  nand3  g127(.a(new_n84_), .b(new_n83_), .c(new_n64_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n189_), .c(new_n185_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x40), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n184_), .c(new_n162_), .O(z14));
  ...
  nand2  g142(.a(new_n83_), .b(new_n136_), .O(new_n205_));
  aoi21  g143(.a(new_n204_), .b(new_n93_), .c(new_n205_), .O(new_n206_));
  oai22  g144(.a(new_n206_), .b(new_n80_), .c(new_n90_), .d(new_n75_), .O(z18));
  nand2  g145(.a(x28), .b(new_n64_), .O(new_n208_));
  nand2  g146(.a(new_n143_), .b(x39), .O(new_n209_));
  nand2  g147(.a(x40), .b(new_n128_), .O(new_n210_));
  aoi22  g148(.a(new_n210_), .b(new_n209_), .c(new_n208_), .d(x35), .O(new_n211_));
  aoi21  g149(.a(new_n141_), .b(new_n106_), .c(x08), .O(new_n212_));
  oai21  g150(.a(new_n212_), .b(new_n211_), .c(new_n83_), .O(new_n213_));
  nor2   g151(.a(new_n213_), .b(x09), .O(z20));
  nand2  g152(.a(new_n148_), .b(new_n81_), .O(z19));
endmodule
