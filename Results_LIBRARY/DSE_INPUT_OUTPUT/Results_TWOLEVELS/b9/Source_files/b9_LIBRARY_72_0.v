...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n195_, new_n196_;
  nor2   g000(.a(x40), .b(x11), .O(new_n63_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n99_), .c(new_n63_), .O(z03));
  ...
  nor2   g044(.a(new_n106_), .b(new_n63_), .O(z05));
  ...
  nand2  g062(.a(new_n74_), .b(x11), .O(new_n125_));
  ...
  oai21  g066(.a(new_n128_), .b(new_n126_), .c(new_n84_), .O(new_n129_));
  ...
  aoi21  g078(.a(x39), .b(x29), .c(new_n74_), .O(new_n141_));
  aoi21  g079(.a(new_n74_), .b(x11), .c(new_n141_), .O(new_n142_));
  ...
  oai22  g129(.a(new_n191_), .b(new_n63_), .c(new_n150_), .d(new_n89_), .O(z18));
