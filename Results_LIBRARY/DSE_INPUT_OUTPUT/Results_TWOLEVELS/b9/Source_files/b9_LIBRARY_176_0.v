...
module FAU ( 
  ...
  nor2   g020(.a(x40), .b(x39), .O(new_n83_));
  ...
  aoi21  g058(.a(x35), .b(new_n105_), .c(x36), .O(new_n121_));
  ...
  nor3   g064(.a(new_n83_), .b(new_n70_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n65_), .c(new_n127_), .O(new_n128_));
  oai21  g066(.a(x32), .b(x30), .c(x40), .O(new_n129_));
  nor2   g067(.a(new_n129_), .b(new_n75_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n65_), .O(new_n131_));
  oai21  g069(.a(new_n128_), .b(new_n64_), .c(new_n131_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n105_), .c(new_n65_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x39), .c(new_n81_), .d(new_n64_), .O(new_n135_));
  ...
  nand3  g078(.a(new_n140_), .b(x35), .c(new_n105_), .O(new_n141_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n76_), .c(x39), .O(new_n151_));
  ...
  nand3  g101(.a(new_n130_), .b(new_n153_), .c(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand3  g103(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n166_));
  nand4  g104(.a(new_n154_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n167_));
  ...
  oai21  g109(.a(new_n75_), .b(x27), .c(new_n171_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n85_), .c(new_n84_), .O(new_n173_));
  nand2  g111(.a(new_n76_), .b(x39), .O(new_n174_));
  oai21  g112(.a(new_n75_), .b(x04), .c(x40), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n153_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n71_), .c(new_n70_), .O(new_n177_));
  aoi21  g115(.a(x40), .b(x27), .c(x39), .O(new_n178_));
  oai21  g116(.a(new_n168_), .b(new_n76_), .c(new_n174_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n64_), .c(new_n178_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n177_), .c(new_n173_), .d(new_n170_), .O(z14));
  ...
  oai21  g129(.a(new_n93_), .b(x27), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n64_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n86_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n81_), .d(new_n84_), .O(z18));
  nand2  g134(.a(new_n144_), .b(new_n81_), .O(z19));
  nand2  g135(.a(x28), .b(new_n64_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n138_), .d(new_n136_), .O(new_n199_));
  nand2  g137(.a(new_n81_), .b(new_n64_), .O(new_n200_));
  nand2  g138(.a(x39), .b(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n200_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n199_), .c(new_n84_), .O(new_n203_));
