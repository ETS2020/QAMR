...
module FAU ( 
  ...
  nor2   g022(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  ...
  aoi21  g035(.a(new_n97_), .b(new_n95_), .c(new_n84_), .O(z03));
  nand2  g036(.a(new_n65_), .b(new_n79_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n95_), .c(new_n64_), .d(new_n96_), .O(z04));
  aoi21  g038(.a(new_n81_), .b(new_n65_), .c(new_n84_), .O(z05));
  aoi21  g039(.a(new_n64_), .b(new_n79_), .c(new_n89_), .O(new_n102_));
  ...
  nand3  g061(.a(new_n123_), .b(new_n120_), .c(new_n71_), .O(new_n124_));
  ...
  aoi21  g066(.a(new_n80_), .b(new_n128_), .c(new_n74_), .O(new_n129_));
  ...
  nand3  g074(.a(x35), .b(new_n89_), .c(new_n71_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n64_), .d(new_n79_), .O(new_n138_));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(new_n79_), .O(new_n154_));
  nand2  g092(.a(new_n80_), .b(new_n128_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n147_), .c(new_n71_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x39), .c(new_n74_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n154_), .O(z13));
  nand3  g096(.a(x40), .b(new_n147_), .c(new_n71_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n160_));
  inv1   g098(.a(new_n160_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n67_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  nor2   g101(.a(x37), .b(x35), .O(new_n164_));
  aoi21  g102(.a(new_n160_), .b(new_n148_), .c(new_n164_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n89_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n80_), .c(new_n128_), .O(new_n167_));
  nand2  g105(.a(x39), .b(x13), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x40), .c(new_n71_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n79_), .c(new_n84_), .O(new_n170_));
  ...
  oai21  g119(.a(new_n90_), .b(x27), .c(new_n181_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  inv1   g121(.a(new_n90_), .O(new_n184_));
  nor2   g122(.a(new_n79_), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n183_), .c(new_n64_), .d(new_n128_), .O(z18));
  nand2  g125(.a(new_n140_), .b(new_n64_), .O(z19));
  aoi22  g126(.a(new_n181_), .b(x28), .c(new_n64_), .d(new_n92_), .O(new_n189_));
  inv1   g127(.a(x35), .O(new_n190_));
  nand2  g128(.a(new_n88_), .b(x39), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x40), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  oai21  g131(.a(new_n189_), .b(x27), .c(new_n193_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n128_), .c(new_n132_), .O(new_n195_));
