...
module FAU ( 
  ...
  oai21  g044(.a(new_n104_), .b(x37), .c(new_n81_), .O(z06));
  ...
  nor2   g059(.a(x40), .b(x02), .O(new_n122_));
  ...
  nand3  g071(.a(x35), .b(new_n103_), .c(new_n65_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x40), .c(new_n81_), .d(new_n64_), .O(new_n135_));
  ...
  aoi21  g077(.a(new_n137_), .b(new_n85_), .c(new_n139_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(new_n83_), .O(new_n141_));
  ...
  nor2   g082(.a(new_n73_), .b(new_n64_), .O(new_n145_));
  ...
  nand2  g086(.a(new_n148_), .b(new_n91_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z12));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n81_), .b(new_n72_), .c(x20), .d(new_n151_), .O(new_n152_));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x28), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x40), .c(x39), .d(new_n153_), .O(new_n156_));
  oai22  g094(.a(new_n156_), .b(x04), .c(new_n152_), .d(x18), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x27), .O(new_n158_));
  nand3  g096(.a(new_n131_), .b(new_n153_), .c(new_n65_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand2  g098(.a(x20), .b(new_n151_), .O(new_n161_));
  nand4  g099(.a(new_n154_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n162_));
  nand3  g100(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n162_), .c(new_n76_), .O(new_n165_));
  oai22  g103(.a(new_n165_), .b(new_n122_), .c(new_n161_), .d(x18), .O(new_n166_));
  nand3  g104(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n84_), .c(new_n83_), .O(new_n169_));
  oai21  g107(.a(new_n164_), .b(new_n145_), .c(new_n169_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x40), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n166_), .c(new_n149_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n81_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x22), .c(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n81_), .O(z16));
  inv1   g115(.a(x01), .O(new_n178_));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n81_), .b(new_n179_), .c(x23), .d(x22), .O(new_n180_));
  ...
  nand2  g124(.a(new_n83_), .b(new_n186_), .O(new_n187_));
  aoi21  g125(.a(new_n185_), .b(new_n103_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n98_), .c(new_n92_), .d(new_n182_), .O(z18));
  oai21  g127(.a(new_n141_), .b(x09), .c(new_n81_), .O(z19));
  nor2   g128(.a(x40), .b(x35), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n94_), .c(new_n91_), .O(new_n192_));
  ...
  nand3  g134(.a(new_n196_), .b(x28), .c(new_n64_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n195_), .c(new_n192_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n83_), .c(new_n186_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n81_), .O(z20));
endmodule
