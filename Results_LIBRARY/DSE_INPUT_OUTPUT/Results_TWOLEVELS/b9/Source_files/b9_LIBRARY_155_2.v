...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x20), .O(new_n81_));
  ...
  oai21  g032(.a(new_n80_), .b(x35), .c(new_n85_), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n94_), .c(x04), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n93_), .c(x40), .d(x39), .O(z02));
  nand2  g035(.a(new_n71_), .b(x27), .O(new_n98_));
  nand2  g036(.a(new_n70_), .b(new_n64_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n98_), .c(new_n81_), .d(x21), .O(z03));
  ...
  aoi21  g043(.a(new_n81_), .b(new_n64_), .c(new_n85_), .O(new_n106_));
  ...
  nand2  g062(.a(new_n84_), .b(new_n83_), .O(new_n125_));
  nand3  g063(.a(new_n125_), .b(x40), .c(x39), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n121_), .c(new_n124_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n65_), .O(new_n128_));
  nor2   g066(.a(new_n70_), .b(new_n64_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n101_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  nand2  g069(.a(new_n81_), .b(new_n64_), .O(new_n132_));
  oai21  g070(.a(new_n86_), .b(x04), .c(x40), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(new_n132_), .c(x08), .O(new_n134_));
  inv1   g072(.a(new_n86_), .O(new_n135_));
  nand2  g073(.a(x39), .b(x29), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x40), .O(new_n137_));
  inv1   g075(.a(x20), .O(new_n138_));
  nand2  g076(.a(new_n80_), .b(new_n138_), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(new_n135_), .c(new_n139_), .d(new_n137_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n134_), .c(new_n83_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(x09), .c(new_n81_), .O(z11));
  ...
  nand3  g086(.a(new_n148_), .b(new_n80_), .c(new_n138_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n80_), .O(new_n153_));
  ...
  nor2   g097(.a(new_n126_), .b(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n101_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nand3  g100(.a(x39), .b(new_n151_), .c(new_n65_), .O(new_n163_));
  nand3  g101(.a(x27), .b(new_n156_), .c(new_n155_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n72_), .c(new_n80_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n138_), .c(new_n163_), .O(new_n167_));
  oai21  g105(.a(x19), .b(x18), .c(x40), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x20), .O(new_n169_));
  nand3  g107(.a(x40), .b(new_n70_), .c(new_n66_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n169_), .b(new_n152_), .c(new_n171_), .O(new_n172_));
  nand2  g110(.a(x40), .b(new_n64_), .O(new_n173_));
  oai21  g111(.a(new_n172_), .b(new_n85_), .c(new_n173_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n84_), .c(new_n83_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n167_), .c(new_n139_), .O(z14));
  ...
  nand2  g121(.a(new_n183_), .b(new_n81_), .O(z17));
  ...
  nand2  g126(.a(new_n83_), .b(new_n188_), .O(new_n189_));
  aoi21  g127(.a(new_n187_), .b(new_n85_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n101_), .c(new_n92_), .d(new_n75_), .O(z18));
  nor2   g129(.a(new_n142_), .b(x09), .O(z19));
  nor2   g130(.a(x40), .b(x35), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n94_), .c(new_n138_), .O(new_n194_));
  ...
  nand2  g135(.a(z08), .b(x29), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(x28), .c(new_n64_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n197_), .c(new_n194_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n83_), .c(new_n188_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n81_), .O(z20));
endmodule
