...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n70_, new_n71_,
    ...
    new_n81_, new_n83_, new_n85_, new_n87_, new_n88_, new_n90_, new_n91_,
  ...
  aoi21  g21(.a(new_n83_), .b(new_n78_), .c(z08), .O(z04));
  aoi21  g22(.a(x28), .b(x27), .c(x37), .O(new_n85_));
  nor2   g23(.a(new_n85_), .b(z08), .O(z05));
  inv1   g24(.a(x28), .O(new_n87_));
  aoi21  g25(.a(z02), .b(new_n80_), .c(new_n87_), .O(new_n88_));
  ...
  nand2  g52(.a(new_n80_), .b(new_n114_), .O(new_n115_));
  nand4  g53(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n87_), .O(new_n116_));
  nand4  g54(.a(new_n116_), .b(z02), .c(new_n70_), .d(new_n112_), .O(new_n117_));
  inv1   g55(.a(new_n117_), .O(z11));
  nor2   g56(.a(z08), .b(new_n80_), .O(new_n119_));
  nand2  g57(.a(new_n119_), .b(new_n66_), .O(z12));
  nand4  g58(.a(z02), .b(new_n66_), .c(x27), .d(x20), .O(new_n121_));
  nor3   g59(.a(new_n121_), .b(x19), .c(x18), .O(z13));
  nor2   g60(.a(x19), .b(x18), .O(new_n123_));
  nand4  g61(.a(new_n123_), .b(new_n119_), .c(new_n66_), .d(x20), .O(z14));
  inv1   g62(.a(x12), .O(new_n125_));
  nor2   g63(.a(new_n104_), .b(new_n125_), .O(z15));
  inv1   g64(.a(x23), .O(new_n127_));
  nand3  g65(.a(new_n127_), .b(x22), .c(x01), .O(new_n128_));
  nand2  g66(.a(new_n128_), .b(z02), .O(z16));
  inv1   g67(.a(x24), .O(new_n130_));
  nand4  g68(.a(new_n130_), .b(x23), .c(x22), .d(x01), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(z02), .O(z17));
  nand2  g70(.a(x27), .b(new_n106_), .O(new_n133_));
  oai21  g71(.a(x27), .b(new_n114_), .c(new_n133_), .O(new_n134_));
  nand3  g72(.a(new_n134_), .b(x35), .c(new_n87_), .O(new_n135_));
  nor2   g73(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g74(.a(new_n136_), .b(new_n135_), .c(z08), .O(z18));
  nand2  g75(.a(new_n117_), .b(z02), .O(z19));
  oai21  g76(.a(x28), .b(new_n114_), .c(new_n80_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x35), .O(new_n140_));
  nand4  g78(.a(new_n140_), .b(z02), .c(new_n70_), .d(new_n112_), .O(new_n141_));
