...
module FAU ( 
  ...
  inv1   g066(.a(new_n82_), .O(new_n129_));
  inv1   g067(.a(x29), .O(new_n130_));
  aoi21  g068(.a(x40), .b(new_n130_), .c(new_n114_), .O(new_n131_));
  ...
  nand4  g091(.a(new_n67_), .b(new_n114_), .c(x20), .d(new_n151_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  aoi21  g094(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(new_n157_));
  ...
  oai21  g100(.a(new_n160_), .b(new_n114_), .c(new_n162_), .O(new_n163_));
  ...
  nand4  g105(.a(new_n167_), .b(x40), .c(new_n79_), .d(new_n78_), .O(new_n168_));
  ...
  oai22  g115(.a(new_n82_), .b(x27), .c(new_n114_), .d(new_n130_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nor2   g117(.a(new_n90_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n129_), .c(x09), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n179_), .c(new_n64_), .d(new_n78_), .O(z18));
  inv1   g120(.a(x35), .O(new_n183_));
  aoi21  g121(.a(x28), .b(new_n90_), .c(new_n183_), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n131_), .O(new_n185_));
  nand2  g123(.a(x40), .b(new_n183_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n134_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n185_), .c(new_n78_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(x09), .O(z20));
  nor2   g127(.a(new_n138_), .b(x09), .O(z19));
endmodule
