...
module FAU ( 
  ...
  aoi21  g19(.a(new_n82_), .b(new_n80_), .c(z08), .O(z03));
  aoi21  g20(.a(new_n65_), .b(new_n64_), .c(x21), .O(new_n84_));
  aoi21  g21(.a(new_n84_), .b(new_n80_), .c(z08), .O(z04));
  nand2  g22(.a(x28), .b(x27), .O(new_n86_));
  aoi21  g23(.a(new_n86_), .b(new_n65_), .c(z08), .O(z05));
  nand3  g24(.a(new_n86_), .b(new_n69_), .c(new_n65_), .O(new_n88_));
  inv1   g25(.a(new_n88_), .O(z06));
  ...
  nand3  g37(.a(new_n100_), .b(new_n69_), .c(x03), .O(new_n101_));
  inv1   g38(.a(new_n101_), .O(z07));
  nand4  g39(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n103_));
  nand2  g40(.a(new_n103_), .b(new_n69_), .O(z09));
  ...
  nand3  g45(.a(new_n108_), .b(new_n69_), .c(x27), .O(new_n109_));
  ...
  aoi21  g76(.a(new_n139_), .b(new_n138_), .c(z08), .O(z18));
  nand2  g77(.a(new_n117_), .b(new_n69_), .O(z19));
  oai21  g78(.a(x28), .b(new_n114_), .c(new_n64_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g80(.a(new_n143_), .b(new_n69_), .c(new_n72_), .d(new_n111_), .O(new_n144_));
