...
module FAU ( 
  ...
  aoi21  g081(.a(new_n143_), .b(x40), .c(new_n98_), .O(new_n144_));
  ...
  nand4  g100(.a(new_n72_), .b(new_n112_), .c(x20), .d(new_n160_), .O(new_n163_));
  ...
  nand3  g108(.a(z08), .b(new_n155_), .c(new_n65_), .O(new_n171_));
  ...
  aoi21  g113(.a(new_n171_), .b(new_n152_), .c(new_n101_), .O(new_n176_));
  ...
  oai22  g131(.a(new_n193_), .b(new_n101_), .c(new_n92_), .d(new_n75_), .O(z18));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n144_), .O(new_n196_));
