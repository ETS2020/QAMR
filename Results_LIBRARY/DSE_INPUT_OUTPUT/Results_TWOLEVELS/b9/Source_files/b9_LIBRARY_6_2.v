...
module FAU ( 
  ...
  aoi21  g036(.a(new_n65_), .b(new_n92_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(new_n78_), .O(z04));
  aoi21  g038(.a(x28), .b(x27), .c(x37), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n78_), .O(z05));
  aoi21  g040(.a(new_n64_), .b(new_n92_), .c(new_n82_), .O(new_n103_));
  ...
  nand2  g054(.a(new_n116_), .b(new_n64_), .O(z08));
  ...
  nor2   g066(.a(new_n65_), .b(new_n92_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n78_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n64_), .d(new_n92_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  nand2  g074(.a(new_n63_), .b(new_n121_), .O(new_n137_));
  ...
  oai21  g085(.a(new_n116_), .b(x04), .c(new_n68_), .O(new_n148_));
  ...
  nor2   g095(.a(new_n156_), .b(x07), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(x27), .O(new_n159_));
  nand4  g097(.a(new_n125_), .b(x39), .c(new_n150_), .d(new_n71_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  inv1   g099(.a(new_n116_), .O(new_n162_));
  oai21  g100(.a(new_n124_), .b(x13), .c(x40), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n71_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n92_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n167_));
  nor2   g105(.a(x13), .b(x04), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n167_), .c(new_n162_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  aoi22  g108(.a(new_n168_), .b(new_n162_), .c(x35), .d(x28), .O(new_n171_));
  inv1   g109(.a(x35), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n171_), .c(new_n65_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n170_), .c(new_n165_), .d(new_n64_), .O(z14));
  ...
  nand2  g124(.a(x27), .b(new_n71_), .O(new_n187_));
  nand2  g125(.a(new_n92_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n172_), .O(new_n189_));
  nand2  g127(.a(new_n79_), .b(new_n132_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n82_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n78_), .c(new_n116_), .d(new_n89_), .O(z18));
  inv1   g130(.a(new_n143_), .O(z19));
  oai22  g131(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n121_), .O(new_n195_));
  ...
  nand2  g136(.a(new_n162_), .b(x29), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(x28), .c(new_n92_), .O(new_n200_));
