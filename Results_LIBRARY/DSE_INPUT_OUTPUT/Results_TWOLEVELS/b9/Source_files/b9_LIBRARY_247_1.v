...
module FAU ( 
  ...
  aoi21  g029(.a(new_n90_), .b(x27), .c(new_n91_), .O(new_n92_));
  aoi22  g030(.a(new_n92_), .b(x21), .c(x40), .d(new_n70_), .O(z03));
  inv1   g031(.a(x21), .O(new_n94_));
  aoi22  g032(.a(new_n92_), .b(new_n94_), .c(x40), .d(new_n70_), .O(z04));
  inv1   g033(.a(x37), .O(new_n96_));
  nand2  g034(.a(x28), .b(x27), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(new_n71_), .c(new_n96_), .O(z05));
  ...
  nand2  g050(.a(new_n112_), .b(new_n71_), .O(z09));
  inv1   g051(.a(x04), .O(new_n114_));
  inv1   g052(.a(x05), .O(new_n115_));
  inv1   g053(.a(x07), .O(new_n116_));
  nand2  g054(.a(x40), .b(x39), .O(new_n117_));
  oai22  g055(.a(new_n117_), .b(new_n115_), .c(x40), .d(new_n116_), .O(new_n118_));
  nand3  g056(.a(new_n118_), .b(new_n80_), .c(new_n114_), .O(new_n119_));
  ...
  nor2   g061(.a(new_n123_), .b(new_n70_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(x05), .c(new_n114_), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n122_), .O(z10));
  inv1   g064(.a(x09), .O(new_n127_));
  oai21  g065(.a(new_n70_), .b(x29), .c(x40), .O(new_n128_));
  nand2  g066(.a(x27), .b(x04), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(x35), .c(new_n78_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  inv1   g069(.a(x27), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n78_), .c(new_n114_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x39), .c(new_n71_), .d(new_n132_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(x08), .c(new_n131_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n75_), .c(new_n127_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n71_), .O(z11));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n132_), .c(new_n66_), .O(new_n139_));
  oai21  g077(.a(new_n70_), .b(new_n114_), .c(x40), .O(new_n140_));
  oai21  g078(.a(new_n64_), .b(new_n132_), .c(new_n140_), .O(new_n141_));
  ...
  nand2  g086(.a(new_n90_), .b(new_n96_), .O(new_n149_));
  ...
  nand3  g092(.a(new_n124_), .b(new_n143_), .c(new_n114_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  aoi21  g094(.a(new_n143_), .b(new_n114_), .c(new_n70_), .O(new_n157_));
  ...
  oai21  g100(.a(new_n162_), .b(new_n78_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n76_), .d(new_n75_), .O(new_n164_));
  ...
  nand2  g113(.a(x27), .b(new_n114_), .O(new_n176_));
  nand2  g114(.a(new_n132_), .b(x08), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(new_n175_), .O(new_n178_));
  nand2  g116(.a(new_n75_), .b(new_n127_), .O(new_n179_));
  aoi21  g117(.a(new_n178_), .b(new_n78_), .c(new_n179_), .O(new_n180_));
  oai22  g118(.a(new_n180_), .b(new_n74_), .c(new_n117_), .d(new_n85_), .O(z18));
  inv1   g119(.a(new_n136_), .O(z19));
  oai21  g120(.a(new_n78_), .b(x27), .c(x35), .O(new_n183_));
  and2   g121(.a(new_n183_), .b(new_n128_), .O(new_n184_));
  nand2  g122(.a(new_n71_), .b(new_n132_), .O(new_n185_));
  nand2  g123(.a(x39), .b(new_n175_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n184_), .c(new_n75_), .O(new_n188_));
