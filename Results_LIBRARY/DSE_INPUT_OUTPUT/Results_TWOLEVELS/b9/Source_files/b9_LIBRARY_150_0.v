...
module FAU ( 
  ...
  oai21  g027(.a(new_n89_), .b(new_n82_), .c(x04), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(x39), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n88_), .c(x40), .O(new_n92_));
  oai21  g030(.a(x40), .b(new_n87_), .c(new_n92_), .O(z02));
  ...
  nand2  g036(.a(new_n65_), .b(new_n96_), .O(new_n99_));
  ...
  oai21  g040(.a(x40), .b(x39), .c(new_n96_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(x28), .O(new_n104_));
  ...
  nor3   g066(.a(new_n63_), .b(new_n65_), .c(new_n128_), .O(new_n129_));
  ...
  aoi21  g078(.a(x39), .b(new_n140_), .c(x28), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n139_), .c(new_n103_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand2  g081(.a(x40), .b(x29), .O(new_n144_));
  ...
  nand2  g085(.a(x40), .b(new_n140_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n145_), .c(new_n81_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n87_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n147_), .c(new_n143_), .O(new_n151_));
  ...
  oai21  g092(.a(new_n154_), .b(new_n96_), .c(new_n73_), .O(new_n155_));
  oai21  g093(.a(new_n118_), .b(x04), .c(new_n68_), .O(new_n156_));
  ...
  nor2   g104(.a(new_n133_), .b(x13), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n71_), .c(new_n63_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(z13));
  nand3  g107(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n170_));
  nand4  g108(.a(new_n159_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  nand4  g110(.a(x40), .b(x39), .c(new_n158_), .d(new_n71_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n172_), .c(new_n170_), .O(new_n174_));
  nand3  g112(.a(new_n65_), .b(new_n140_), .c(x28), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n80_), .c(new_n79_), .O(new_n177_));
  aoi21  g115(.a(new_n173_), .b(new_n68_), .c(new_n63_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n174_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nor2   g118(.a(new_n121_), .b(new_n180_), .O(z15));
  ...
  oai22  g127(.a(new_n118_), .b(new_n189_), .c(new_n82_), .d(x27), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n96_), .b(x04), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n83_), .c(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g132(.a(x40), .b(new_n87_), .O(new_n195_));
  nand2  g133(.a(x28), .b(new_n96_), .O(new_n196_));
  nand2  g134(.a(new_n144_), .b(x39), .O(new_n197_));
  aoi22  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .d(x35), .O(new_n198_));
  nand2  g136(.a(x39), .b(new_n140_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n103_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n79_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z20));
  nand2  g140(.a(new_n152_), .b(new_n64_), .O(z19));
endmodule
