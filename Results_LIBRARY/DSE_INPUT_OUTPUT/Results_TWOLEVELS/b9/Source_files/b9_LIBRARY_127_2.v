...
module FAU ( 
  ...
  nor2   g037(.a(new_n81_), .b(new_n91_), .O(new_n100_));
  ...
  nand2  g053(.a(new_n115_), .b(new_n64_), .O(z08));
  nand4  g054(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n63_), .O(z09));
  ...
  oai22  g070(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  inv1   g072(.a(x29), .O(new_n135_));
  oai21  g073(.a(new_n91_), .b(new_n71_), .c(new_n81_), .O(new_n136_));
  oai21  g074(.a(new_n115_), .b(new_n135_), .c(new_n136_), .O(new_n137_));
  ...
  oai21  g078(.a(x28), .b(x04), .c(new_n90_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n140_), .c(new_n137_), .d(new_n134_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n78_), .c(new_n131_), .O(new_n143_));
  ...
  oai21  g085(.a(new_n115_), .b(x04), .c(new_n68_), .O(new_n148_));
  ...
  nor2   g095(.a(new_n156_), .b(x11), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(x27), .O(new_n159_));
  nand3  g097(.a(new_n125_), .b(new_n150_), .c(new_n71_), .O(new_n160_));
  ...
  nand4  g102(.a(x40), .b(x39), .c(new_n150_), .d(new_n71_), .O(new_n165_));
  ...
  nand3  g108(.a(new_n165_), .b(new_n66_), .c(new_n65_), .O(new_n171_));
  aoi21  g109(.a(x27), .b(new_n132_), .c(x40), .O(new_n172_));
  nand2  g110(.a(x40), .b(x13), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x39), .c(new_n71_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n91_), .c(new_n172_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n171_), .c(new_n170_), .d(new_n166_), .O(z14));
  ...
  nand2  g124(.a(new_n91_), .b(x08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n167_), .O(new_n188_));
  nand2  g126(.a(new_n78_), .b(new_n131_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n81_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n95_), .c(new_n115_), .d(new_n88_), .O(z18));
  aoi21  g129(.a(x28), .b(new_n91_), .c(new_n167_), .O(new_n192_));
  oai21  g130(.a(new_n123_), .b(new_n135_), .c(x40), .O(new_n193_));
  nand2  g131(.a(new_n63_), .b(new_n132_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(new_n192_), .O(new_n195_));
  nand2  g133(.a(new_n64_), .b(new_n91_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n167_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n78_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z20));
  nand2  g138(.a(new_n143_), .b(new_n64_), .O(z19));
endmodule
