...
module FAU ( 
  ...
  aoi22  g030(.a(new_n92_), .b(x21), .c(new_n70_), .d(x39), .O(z03));
  inv1   g031(.a(x21), .O(new_n94_));
  aoi22  g032(.a(new_n92_), .b(new_n94_), .c(new_n70_), .d(x39), .O(z04));
  ...
  oai21  g065(.a(new_n70_), .b(x29), .c(x39), .O(new_n128_));
  ...
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n71_), .d(new_n132_), .O(new_n134_));
  ...
  oai21  g077(.a(new_n70_), .b(new_n114_), .c(x39), .O(new_n140_));
  ...
  nand4  g101(.a(new_n163_), .b(x40), .c(new_n76_), .d(new_n75_), .O(new_n164_));
  ...
  nand2  g123(.a(x40), .b(new_n175_), .O(new_n186_));
