...
module FAU ( 
  ...
  aoi21  g24(.a(new_n86_), .b(new_n80_), .c(new_n85_), .O(new_n87_));
  aoi21  g25(.a(new_n87_), .b(new_n84_), .c(z08), .O(z03));
  nand2  g26(.a(new_n86_), .b(new_n80_), .O(new_n89_));
  nand4  g27(.a(new_n89_), .b(new_n84_), .c(new_n67_), .d(new_n85_), .O(z04));
  aoi21  g28(.a(x28), .b(x27), .c(x37), .O(new_n91_));
  nor2   g29(.a(new_n91_), .b(z08), .O(z05));
  nand3  g30(.a(new_n86_), .b(new_n67_), .c(new_n80_), .O(new_n93_));
  inv1   g31(.a(new_n93_), .O(z06));
  ...
  nand4  g37(.a(new_n99_), .b(new_n97_), .c(new_n96_), .d(new_n95_), .O(new_n100_));
  inv1   g38(.a(x14), .O(new_n101_));
  inv1   g39(.a(x25), .O(new_n102_));
  nand3  g40(.a(x38), .b(new_n102_), .c(new_n98_), .O(new_n103_));
  nand2  g41(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g42(.a(new_n104_), .b(new_n100_), .O(new_n105_));
  nand3  g43(.a(new_n105_), .b(new_n67_), .c(x03), .O(new_n106_));
  inv1   g44(.a(new_n106_), .O(z07));
  nand4  g45(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n108_));
  nand2  g46(.a(new_n108_), .b(new_n67_), .O(z09));
  ...
  nand4  g68(.a(new_n67_), .b(x34), .c(x27), .d(x26), .O(new_n131_));
  nor2   g69(.a(new_n131_), .b(new_n130_), .O(z15));
  inv1   g70(.a(x23), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(x22), .c(x01), .O(new_n134_));
  nand2  g72(.a(new_n134_), .b(new_n67_), .O(z16));
  inv1   g73(.a(x24), .O(new_n136_));
  nand4  g74(.a(new_n136_), .b(x23), .c(x22), .d(x01), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(new_n67_), .O(z17));
  ...
  oai21  g80(.a(x28), .b(new_n118_), .c(new_n78_), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(x35), .O(new_n144_));
  nand4  g82(.a(new_n144_), .b(new_n67_), .c(new_n69_), .d(new_n116_), .O(new_n145_));
  inv1   g83(.a(new_n145_), .O(z20));
  inv1   g84(.a(new_n121_), .O(z19));
endmodule
