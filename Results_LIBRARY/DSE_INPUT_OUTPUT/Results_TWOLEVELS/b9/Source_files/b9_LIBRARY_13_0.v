...
module FAU ( 
  ...
  nand2  g036(.a(new_n81_), .b(x31), .O(new_n99_));
  ...
  nand4  g053(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n80_), .O(new_n116_));
  inv1   g054(.a(x25), .O(new_n117_));
  nand3  g055(.a(x38), .b(new_n117_), .c(new_n114_), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(x14), .c(new_n116_), .O(new_n120_));
  ...
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n82_), .O(z10));
  ...
  nand4  g099(.a(new_n72_), .b(x31), .c(x20), .d(new_n159_), .O(new_n162_));
  ...
  nand3  g107(.a(z08), .b(new_n154_), .c(new_n65_), .O(new_n170_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n151_), .c(new_n101_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n171_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nand4  g115(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n178_));
  ...
  nand2  g128(.a(new_n84_), .b(new_n190_), .O(new_n191_));
  aoi21  g129(.a(new_n189_), .b(new_n86_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n101_), .c(new_n93_), .d(new_n75_), .O(z18));
  nand2  g131(.a(x28), .b(new_n64_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(x35), .c(new_n143_), .d(new_n99_), .O(new_n195_));
  ...
  nor2   g137(.a(new_n146_), .b(x09), .O(z19));
endmodule
