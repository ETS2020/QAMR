...
module FAU ( 
  ...
  nand2  g036(.a(new_n63_), .b(x16), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n98_), .O(z02));
  nand2  g038(.a(new_n72_), .b(x27), .O(new_n101_));
  inv1   g039(.a(new_n90_), .O(new_n102_));
  aoi21  g040(.a(new_n71_), .b(new_n65_), .c(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n101_), .c(x21), .O(z03));
  inv1   g042(.a(x21), .O(new_n105_));
  nand3  g043(.a(new_n103_), .b(new_n101_), .c(new_n105_), .O(z04));
  aoi21  g044(.a(x28), .b(x27), .c(x37), .O(new_n107_));
  nor2   g045(.a(new_n107_), .b(new_n102_), .O(z05));
  inv1   g046(.a(z05), .O(z06));
  inv1   g047(.a(x33), .O(new_n110_));
  nand2  g048(.a(x17), .b(new_n64_), .O(new_n111_));
  ...
  nand3  g056(.a(new_n118_), .b(new_n90_), .c(x03), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(z07));
  inv1   g058(.a(new_n77_), .O(new_n121_));
  nand2  g059(.a(new_n90_), .b(new_n121_), .O(z08));
  nand4  g060(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n90_), .O(z09));
  inv1   g062(.a(x07), .O(new_n125_));
  nand2  g063(.a(x40), .b(new_n76_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n99_), .c(new_n125_), .O(new_n127_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n99_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n140_), .c(new_n82_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(x09), .O(z11));
  nand3  g085(.a(new_n71_), .b(new_n68_), .c(new_n67_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi22  g087(.a(new_n73_), .b(x27), .c(x39), .d(new_n66_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n151_));
  nand2  g089(.a(new_n73_), .b(x27), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n63_), .c(x16), .O(new_n153_));
  ...
  oai21  g104(.a(new_n76_), .b(x04), .c(x40), .O(new_n167_));
  aoi21  g105(.a(new_n63_), .b(x16), .c(x13), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n167_), .c(x35), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n67_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(new_n71_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n173_));
  nand4  g111(.a(new_n156_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  nand4  g113(.a(x40), .b(x39), .c(new_n155_), .d(new_n66_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n175_), .c(new_n173_), .O(new_n177_));
  aoi21  g115(.a(x27), .b(x16), .c(x40), .O(new_n178_));
  nand3  g116(.a(x39), .b(new_n155_), .c(new_n66_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  oai21  g118(.a(x32), .b(x30), .c(new_n180_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n65_), .c(new_n178_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n177_), .c(new_n172_), .O(z14));
  inv1   g121(.a(x12), .O(new_n184_));
  nand4  g122(.a(new_n90_), .b(x34), .c(x27), .d(x26), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n184_), .O(z15));
  inv1   g124(.a(x23), .O(new_n187_));
  nand4  g125(.a(new_n90_), .b(new_n187_), .c(x22), .d(x01), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(z16));
  inv1   g127(.a(x24), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(x23), .c(x22), .d(x01), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n90_), .O(z17));
  nand2  g130(.a(x27), .b(new_n66_), .O(new_n193_));
  nand2  g131(.a(new_n65_), .b(x08), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(new_n67_), .O(new_n195_));
  inv1   g133(.a(x09), .O(new_n196_));
  nand2  g134(.a(new_n82_), .b(new_n196_), .O(new_n197_));
  aoi21  g135(.a(new_n195_), .b(new_n84_), .c(new_n197_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n102_), .c(new_n93_), .d(new_n121_), .O(z18));
  oai21  g137(.a(new_n146_), .b(x09), .c(new_n90_), .O(z19));
  nand2  g138(.a(x28), .b(new_n65_), .O(new_n201_));
  aoi22  g139(.a(new_n201_), .b(x35), .c(new_n143_), .d(new_n99_), .O(new_n202_));
  nand2  g140(.a(x40), .b(new_n67_), .O(new_n203_));
  aoi21  g141(.a(new_n203_), .b(new_n138_), .c(x08), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n82_), .O(new_n205_));
