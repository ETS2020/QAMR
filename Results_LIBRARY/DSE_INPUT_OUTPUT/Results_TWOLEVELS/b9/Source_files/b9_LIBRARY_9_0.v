...
module FAU ( 
  ...
  nand2  g030(.a(new_n64_), .b(x24), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n92_), .O(z02));
  inv1   g032(.a(new_n65_), .O(new_n95_));
  ...
  nand2  g038(.a(new_n66_), .b(new_n98_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n96_), .c(new_n65_), .d(new_n97_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n65_), .c(new_n66_), .O(z05));
  aoi21  g042(.a(new_n65_), .b(new_n98_), .c(new_n82_), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(x37), .c(new_n65_), .O(z06));
  ...
  oai21  g061(.a(new_n118_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  ...
  nor2   g067(.a(new_n66_), .b(new_n98_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n95_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x40), .c(new_n65_), .d(new_n98_), .O(new_n135_));
  nand2  g073(.a(x39), .b(x29), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x40), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n93_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n79_), .c(new_n133_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n98_), .c(new_n74_), .O(new_n146_));
  oai21  g084(.a(new_n118_), .b(x04), .c(new_n69_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n146_), .c(new_n65_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n64_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x39), .c(new_n149_), .d(new_n72_), .O(new_n152_));
  ...
  nand3  g095(.a(new_n126_), .b(x40), .c(x39), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x13), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n72_), .c(new_n95_), .O(new_n160_));
  ...
  nand3  g102(.a(z08), .b(new_n149_), .c(new_n72_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(new_n162_), .O(new_n166_));
  inv1   g104(.a(x35), .O(new_n167_));
  nand3  g105(.a(new_n66_), .b(new_n167_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n80_), .c(new_n79_), .O(new_n170_));
  aoi21  g108(.a(new_n165_), .b(new_n69_), .c(new_n95_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(new_n166_), .O(z14));
  nand4  g110(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n65_), .O(z15));
  inv1   g112(.a(x23), .O(new_n175_));
  nand4  g113(.a(new_n65_), .b(new_n175_), .c(x22), .d(x01), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(z16));
  nand3  g115(.a(x23), .b(x22), .c(x01), .O(new_n178_));
  nor3   g116(.a(new_n178_), .b(new_n64_), .c(x24), .O(z17));
  inv1   g117(.a(x29), .O(new_n180_));
  oai22  g118(.a(new_n118_), .b(new_n180_), .c(new_n83_), .d(x27), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n167_), .b(x28), .O(new_n183_));
  nor2   g121(.a(new_n98_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n182_), .c(new_n65_), .d(new_n79_), .O(z18));
  nand2  g124(.a(new_n143_), .b(new_n65_), .O(z19));
  nand2  g125(.a(x28), .b(new_n98_), .O(new_n188_));
  aoi22  g126(.a(new_n188_), .b(x35), .c(new_n137_), .d(new_n93_), .O(new_n189_));
  nand2  g127(.a(new_n65_), .b(new_n98_), .O(new_n190_));
  nand2  g128(.a(x40), .b(new_n167_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n189_), .c(new_n79_), .O(new_n193_));
