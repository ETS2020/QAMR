...
module FAU ( 
  ...
  nand2  g032(.a(x40), .b(new_n83_), .O(new_n95_));
  ...
  aoi22  g043(.a(new_n105_), .b(new_n103_), .c(new_n104_), .d(x40), .O(z05));
  ...
  aoi21  g060(.a(new_n122_), .b(x39), .c(new_n67_), .O(z08));
  ...
  oai22  g066(.a(new_n104_), .b(new_n127_), .c(x40), .d(new_n128_), .O(new_n129_));
  ...
  nor2   g072(.a(new_n134_), .b(new_n83_), .O(new_n135_));
  ...
  nand4  g091(.a(new_n153_), .b(x40), .c(new_n151_), .d(new_n126_), .O(new_n154_));
  ...
  nand3  g103(.a(x40), .b(new_n151_), .c(new_n126_), .O(new_n166_));
  ...
  nand2  g109(.a(x39), .b(new_n87_), .O(new_n172_));
