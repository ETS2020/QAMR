...
module FAU ( 
  ...
  nand2  g033(.a(new_n64_), .b(x34), .O(new_n96_));
  ...
  nor2   g041(.a(new_n103_), .b(new_n66_), .O(z05));
  nand2  g042(.a(new_n65_), .b(new_n69_), .O(new_n105_));
  oai21  g043(.a(x40), .b(x34), .c(new_n83_), .O(new_n106_));
  ...
  nor2   g070(.a(new_n70_), .b(new_n69_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(x06), .c(new_n66_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x40), .c(new_n65_), .d(new_n69_), .O(new_n138_));
  nand2  g076(.a(x39), .b(x29), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x40), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n96_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n145_), .b(new_n80_), .c(new_n136_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n65_), .O(z11));
  inv1   g085(.a(x35), .O(new_n148_));
  nand3  g086(.a(new_n70_), .b(new_n82_), .c(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x27), .c(x10), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n74_), .c(new_n72_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(x40), .O(new_n152_));
  inv1   g090(.a(new_n72_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n64_), .c(x34), .O(new_n154_));
  ...
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n156_), .d(new_n74_), .O(new_n159_));
  inv1   g097(.a(x18), .O(new_n160_));
  inv1   g098(.a(x19), .O(new_n161_));
  nand2  g099(.a(new_n71_), .b(new_n70_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x20), .c(new_n161_), .d(new_n160_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n159_), .c(new_n64_), .O(new_n164_));
  nand4  g102(.a(new_n162_), .b(x34), .c(x20), .d(new_n161_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n129_), .b(new_n156_), .c(new_n74_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n167_), .O(z13));
  oai21  g107(.a(new_n127_), .b(x04), .c(x40), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n96_), .c(new_n156_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n153_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n173_));
  nand4  g111(.a(new_n157_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  nand4  g113(.a(x40), .b(x39), .c(new_n156_), .d(new_n74_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n175_), .c(new_n173_), .O(new_n177_));
  nand3  g115(.a(new_n70_), .b(new_n148_), .c(x28), .O(new_n178_));
  oai21  g116(.a(new_n64_), .b(x27), .c(new_n178_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n81_), .c(new_n80_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n177_), .c(new_n172_), .d(new_n65_), .O(z14));
  ...
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n148_), .O(new_n193_));
  nand2  g131(.a(new_n80_), .b(new_n136_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n83_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n66_), .c(new_n119_), .d(new_n90_), .O(z18));
  inv1   g134(.a(new_n146_), .O(z19));
  oai22  g135(.a(new_n64_), .b(x35), .c(new_n83_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n139_), .O(new_n199_));
  nor2   g137(.a(x40), .b(x35), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n92_), .c(x34), .O(new_n201_));
  inv1   g139(.a(x08), .O(new_n202_));
  nand2  g140(.a(x35), .b(x27), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(x40), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n64_), .b(x28), .c(new_n69_), .O(new_n205_));
  nand4  g143(.a(new_n205_), .b(new_n204_), .c(new_n201_), .d(new_n199_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n80_), .c(new_n136_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n65_), .O(z20));
endmodule
