...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x05), .O(new_n64_));
  ...
  nand2  g037(.a(new_n68_), .b(new_n93_), .O(new_n100_));
  ...
  nor2   g075(.a(new_n93_), .b(new_n74_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n85_), .c(new_n137_), .O(new_n139_));
  nand3  g077(.a(new_n84_), .b(x27), .c(new_n74_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n92_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n80_), .c(new_n136_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n64_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  nor2   g083(.a(new_n63_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n75_), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n74_), .c(new_n63_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n124_), .c(new_n71_), .O(new_n149_));
  ...
  nor2   g096(.a(new_n157_), .b(x05), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n133_), .b(new_n151_), .c(new_n74_), .O(new_n161_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n124_), .c(new_n163_), .O(new_n168_));
  nand3  g106(.a(new_n68_), .b(new_n83_), .c(x28), .O(new_n169_));
  ...
  nand3  g111(.a(new_n71_), .b(new_n63_), .c(new_n104_), .O(new_n174_));
  ...
  oai21  g122(.a(new_n85_), .b(x27), .c(new_n137_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n65_), .b(x30), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n140_), .d(new_n136_), .O(z18));
  inv1   g126(.a(new_n137_), .O(new_n189_));
  oai21  g127(.a(new_n83_), .b(new_n93_), .c(new_n92_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n93_), .c(new_n83_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n136_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n64_), .O(z20));
  nand2  g132(.a(new_n143_), .b(new_n64_), .O(z19));
endmodule
