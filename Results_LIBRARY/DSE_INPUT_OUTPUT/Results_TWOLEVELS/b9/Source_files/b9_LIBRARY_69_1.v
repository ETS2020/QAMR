...
module FAU ( 
  ...
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n79_), .d(x21), .O(z03));
  inv1   g036(.a(new_n79_), .O(new_n99_));
  aoi21  g037(.a(new_n96_), .b(new_n64_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n95_), .c(new_n99_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n96_), .c(new_n99_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n79_), .c(new_n96_), .O(new_n104_));
  ...
  nand4  g067(.a(new_n129_), .b(x26), .c(x05), .d(new_n65_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n126_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(new_n74_), .b(x29), .O(new_n133_));
  ...
  nand3  g079(.a(new_n96_), .b(new_n67_), .c(new_n66_), .O(new_n142_));
  ...
  aoi21  g096(.a(new_n158_), .b(x26), .c(new_n73_), .O(new_n159_));
  ...
  nand3  g104(.a(new_n96_), .b(new_n66_), .c(x28), .O(new_n167_));
  ...
  nand2  g111(.a(new_n173_), .b(new_n79_), .O(z15));
  ...
  nand2  g117(.a(new_n179_), .b(new_n79_), .O(z17));
  nand2  g118(.a(new_n64_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n137_), .c(new_n66_), .O(new_n182_));
  nand2  g120(.a(new_n81_), .b(new_n132_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(new_n83_), .c(new_n183_), .O(new_n184_));
  inv1   g122(.a(new_n133_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(x26), .c(x08), .O(new_n186_));
  oai21  g124(.a(new_n184_), .b(new_n99_), .c(new_n186_), .O(z18));
  oai21  g125(.a(new_n66_), .b(new_n64_), .c(new_n136_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n185_), .c(new_n188_), .O(new_n190_));
