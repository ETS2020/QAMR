...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x30), .O(new_n81_));
  ...
  aoi21  g025(.a(new_n87_), .b(x27), .c(x32), .O(new_n88_));
  oai21  g026(.a(new_n88_), .b(new_n76_), .c(new_n84_), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(x04), .O(z01));
  aoi21  g028(.a(x29), .b(x08), .c(x02), .O(new_n91_));
  aoi21  g029(.a(new_n86_), .b(x04), .c(new_n91_), .O(new_n92_));
  ...
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n81_), .O(z03));
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n81_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n82_), .c(new_n70_), .O(z05));
  aoi21  g041(.a(new_n82_), .b(new_n64_), .c(new_n85_), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(x37), .c(new_n82_), .O(z06));
  ...
  nand3  g052(.a(new_n114_), .b(new_n82_), .c(x03), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(z07));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(z09));
  inv1   g057(.a(x07), .O(new_n120_));
  nand2  g058(.a(x40), .b(new_n75_), .O(new_n121_));
  nand2  g059(.a(new_n76_), .b(x30), .O(new_n122_));
  ...
  oai21  g063(.a(new_n125_), .b(new_n123_), .c(new_n87_), .O(new_n126_));
  nand3  g064(.a(new_n82_), .b(x37), .c(x06), .O(new_n127_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n86_), .c(new_n135_), .O(new_n137_));
  nand2  g075(.a(x40), .b(x04), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(x35), .c(new_n85_), .d(x27), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n93_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n134_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x40), .c(x30), .O(z11));
  nand3  g081(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi22  g083(.a(new_n72_), .b(x27), .c(x39), .d(new_n65_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x40), .O(new_n147_));
  nand2  g085(.a(new_n72_), .b(x27), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n76_), .c(x30), .O(new_n149_));
  ...
  aoi21  g095(.a(new_n157_), .b(new_n154_), .c(new_n76_), .O(new_n158_));
  ...
  inv1   g101(.a(new_n71_), .O(new_n164_));
  oai21  g102(.a(new_n75_), .b(x04), .c(x40), .O(new_n165_));
  aoi21  g103(.a(new_n76_), .b(x30), .c(x13), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  inv1   g105(.a(x32), .O(new_n168_));
  nand4  g106(.a(new_n66_), .b(new_n168_), .c(new_n84_), .d(x28), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n167_), .c(new_n70_), .O(new_n171_));
  nand3  g109(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n172_));
  nand4  g110(.a(new_n152_), .b(new_n168_), .c(new_n84_), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(z08), .c(new_n151_), .d(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand2  g113(.a(new_n168_), .b(new_n64_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(x40), .c(x30), .O(new_n177_));
  nand3  g115(.a(x39), .b(new_n151_), .c(new_n65_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x40), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n122_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n64_), .c(new_n177_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n175_), .c(new_n171_), .O(z14));
  nand4  g120(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n82_), .O(z15));
  inv1   g122(.a(x23), .O(new_n185_));
  nand4  g123(.a(new_n82_), .b(new_n185_), .c(x22), .d(x01), .O(new_n186_));
  ...
  nand3  g129(.a(x35), .b(new_n85_), .c(new_n64_), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n135_), .c(new_n93_), .O(new_n193_));
  nand2  g131(.a(x27), .b(new_n65_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n86_), .c(new_n134_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(x40), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n84_), .O(z18));
  aoi21  g135(.a(x35), .b(x27), .c(x08), .O(new_n198_));
  nand2  g136(.a(x28), .b(new_n64_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(x39), .d(x29), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n134_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(x40), .c(x30), .O(z20));
  aoi21  g140(.a(new_n142_), .b(x40), .c(x30), .O(z19));
endmodule
