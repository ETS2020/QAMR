...
module FAU ( 
  ...
  nor2   g056(.a(new_n64_), .b(new_n118_), .O(z08));
  ...
  nand2  g061(.a(x40), .b(new_n118_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n96_), .c(new_n123_), .O(new_n125_));
  ...
  nand4  g071(.a(new_n133_), .b(x39), .c(x05), .d(new_n74_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n131_), .O(z10));
  nand2  g073(.a(x39), .b(x29), .O(new_n136_));
  oai22  g074(.a(new_n64_), .b(x35), .c(new_n69_), .d(new_n74_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand2  g076(.a(new_n90_), .b(x28), .O(new_n139_));
  inv1   g077(.a(x08), .O(new_n140_));
  nand2  g078(.a(x35), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x04), .c(new_n140_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x40), .O(new_n144_));
  nand2  g082(.a(new_n118_), .b(x28), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n138_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n80_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x40), .c(x09), .O(z11));
  inv1   g086(.a(x35), .O(new_n149_));
  nand3  g087(.a(new_n70_), .b(new_n82_), .c(new_n149_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x27), .c(x10), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n74_), .c(new_n72_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(x40), .O(new_n153_));
  nor2   g091(.a(new_n72_), .b(x40), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x09), .O(new_n155_));
  ...
  nand2  g100(.a(new_n71_), .b(new_n70_), .O(new_n163_));
  ...
  nand4  g104(.a(new_n133_), .b(x39), .c(new_n157_), .d(new_n74_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n65_), .O(z13));
  oai21  g106(.a(new_n118_), .b(x04), .c(x40), .O(new_n169_));
  aoi21  g107(.a(new_n64_), .b(x09), .c(x13), .O(new_n170_));
  aoi22  g108(.a(new_n170_), .b(new_n169_), .c(x35), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n149_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n171_), .c(new_n70_), .O(new_n174_));
  nand3  g112(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n175_));
  nand4  g113(.a(new_n158_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n176_));
  nor2   g114(.a(x13), .b(x04), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(z08), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n175_), .O(new_n179_));
  aoi21  g117(.a(x27), .b(x09), .c(x40), .O(new_n180_));
  nor2   g118(.a(new_n132_), .b(new_n118_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n177_), .c(new_n64_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n69_), .c(new_n180_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n179_), .c(new_n174_), .O(z14));
  nand4  g122(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n65_), .O(z15));
  ...
  oai21  g130(.a(new_n84_), .b(x27), .c(new_n136_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  inv1   g132(.a(new_n84_), .O(new_n195_));
  nor2   g133(.a(new_n69_), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n195_), .c(x09), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n194_), .c(new_n65_), .d(new_n80_), .O(z18));
  inv1   g136(.a(new_n136_), .O(new_n199_));
  nand2  g137(.a(new_n141_), .b(new_n140_), .O(new_n200_));
  aoi21  g138(.a(x28), .b(new_n69_), .c(new_n149_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n200_), .O(new_n202_));
  nand4  g140(.a(new_n202_), .b(x40), .c(new_n80_), .d(new_n63_), .O(new_n203_));
  inv1   g141(.a(new_n203_), .O(z20));
  aoi21  g142(.a(new_n147_), .b(x40), .c(x09), .O(z19));
endmodule
