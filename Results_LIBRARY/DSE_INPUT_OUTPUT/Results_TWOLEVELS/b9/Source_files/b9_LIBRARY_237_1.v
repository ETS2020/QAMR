...
module FAU ( 
  ...
  oai21  g067(.a(new_n70_), .b(x29), .c(x40), .O(new_n130_));
  ...
  aoi22  g072(.a(new_n134_), .b(x39), .c(new_n71_), .d(new_n90_), .O(new_n135_));
  ...
  oai21  g078(.a(new_n70_), .b(new_n117_), .c(x40), .O(new_n141_));
  ...
  nand4  g084(.a(new_n146_), .b(x40), .c(new_n144_), .d(new_n117_), .O(new_n147_));
  ...
  aoi21  g092(.a(new_n154_), .b(x39), .c(new_n67_), .O(new_n155_));
  ...
  aoi21  g118(.a(x40), .b(new_n70_), .c(x08), .O(new_n181_));
  aoi21  g119(.a(x40), .b(x29), .c(new_n99_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(new_n90_), .O(new_n183_));
  nand2  g121(.a(new_n83_), .b(x39), .O(new_n184_));
