...
module FAU ( 
  ...
  oai21  g034(.a(new_n76_), .b(x35), .c(new_n87_), .O(new_n97_));
  oai21  g035(.a(new_n97_), .b(new_n96_), .c(x04), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n95_), .c(x40), .d(x39), .O(z02));
  ...
  nand3  g042(.a(new_n104_), .b(x40), .c(new_n70_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(x21), .O(new_n106_));
  aoi21  g044(.a(new_n71_), .b(x27), .c(new_n101_), .O(new_n107_));
  oai21  g045(.a(new_n107_), .b(new_n76_), .c(new_n106_), .O(z04));
  aoi21  g046(.a(new_n104_), .b(new_n70_), .c(new_n84_), .O(z05));
  oai22  g047(.a(x40), .b(x21), .c(new_n87_), .d(new_n64_), .O(new_n110_));
  ...
  nand2  g064(.a(new_n76_), .b(x21), .O(new_n127_));
  ...
  oai21  g077(.a(new_n88_), .b(x04), .c(x40), .O(new_n140_));
  ...
  nor2   g091(.a(new_n151_), .b(x40), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x21), .O(new_n155_));
  ...
  nand4  g102(.a(new_n72_), .b(x21), .c(x20), .d(new_n162_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n136_), .b(new_n157_), .c(new_n65_), .O(new_n168_));
  ...
  nand4  g109(.a(new_n158_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n172_));
  ...
  oai21  g117(.a(new_n174_), .b(new_n151_), .c(new_n179_), .O(new_n180_));
  ...
  nand2  g134(.a(new_n85_), .b(new_n196_), .O(new_n197_));
  aoi21  g135(.a(new_n195_), .b(new_n87_), .c(new_n197_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n84_), .c(new_n94_), .d(new_n192_), .O(z18));
  nor2   g137(.a(x40), .b(x35), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n96_), .c(x21), .O(new_n201_));
