...
module FAU ( 
  ...
  aoi21  g040(.a(new_n102_), .b(new_n100_), .c(new_n81_), .O(z03));
  aoi21  g041(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n100_), .c(new_n81_), .O(z04));
  aoi21  g043(.a(x28), .b(x27), .c(x37), .O(new_n106_));
  nor2   g044(.a(new_n106_), .b(new_n81_), .O(z05));
  oai21  g045(.a(x40), .b(x39), .c(new_n64_), .O(new_n108_));
  nand2  g046(.a(new_n108_), .b(x28), .O(new_n109_));
  nand2  g047(.a(new_n109_), .b(new_n70_), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(new_n82_), .O(z06));
  ...
  nand2  g061(.a(new_n82_), .b(new_n123_), .O(z08));
  inv1   g062(.a(x11), .O(new_n125_));
  nand4  g063(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n126_));
  nor2   g064(.a(new_n126_), .b(new_n125_), .O(z09));
  xor2a  g065(.a(x40), .b(x39), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x07), .O(new_n129_));
  nand3  g067(.a(x40), .b(x39), .c(x05), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n87_), .O(new_n131_));
  inv1   g069(.a(x06), .O(new_n132_));
  nor3   g070(.a(new_n81_), .b(new_n70_), .c(new_n132_), .O(new_n133_));
  ...
  oai21  g078(.a(new_n66_), .b(x28), .c(x39), .O(new_n141_));
  nand2  g079(.a(x40), .b(x04), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n108_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g082(.a(x40), .b(new_n75_), .O(new_n145_));
  nand2  g083(.a(x40), .b(x29), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x39), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nor2   g086(.a(new_n64_), .b(new_n65_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n94_), .c(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n84_), .c(new_n139_), .O(new_n152_));
  ...
  oai21  g095(.a(new_n123_), .b(x04), .c(new_n157_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n156_), .c(new_n82_), .O(z12));
  inv1   g097(.a(x13), .O(new_n160_));
  nand2  g098(.a(x36), .b(x35), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x28), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x40), .c(new_n160_), .d(new_n65_), .O(new_n163_));
  inv1   g101(.a(x18), .O(new_n164_));
  inv1   g102(.a(x19), .O(new_n165_));
  nand4  g103(.a(new_n72_), .b(x20), .c(new_n165_), .d(new_n164_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n163_), .c(new_n75_), .O(new_n167_));
  nand4  g105(.a(new_n72_), .b(x40), .c(x20), .d(new_n165_), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(x18), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(x27), .O(new_n170_));
  nand3  g108(.a(new_n136_), .b(new_n160_), .c(new_n65_), .O(new_n171_));
  ...
  nand3  g113(.a(new_n77_), .b(new_n160_), .c(new_n65_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n175_), .c(new_n173_), .O(new_n177_));
  ...
  aoi21  g118(.a(new_n176_), .b(new_n157_), .c(new_n81_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n177_), .O(z14));
  inv1   g120(.a(x12), .O(new_n183_));
  nor2   g121(.a(new_n126_), .b(new_n183_), .O(z15));
  ...
  nand2  g127(.a(new_n189_), .b(new_n82_), .O(z17));
  ...
  nand2  g131(.a(new_n84_), .b(new_n139_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n86_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n81_), .c(new_n92_), .d(new_n123_), .O(z18));
  nand2  g134(.a(new_n152_), .b(new_n82_), .O(z19));
  nand2  g135(.a(x28), .b(new_n64_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n147_), .d(new_n145_), .O(new_n199_));
  nand2  g137(.a(x39), .b(new_n66_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n108_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n84_), .O(new_n202_));
