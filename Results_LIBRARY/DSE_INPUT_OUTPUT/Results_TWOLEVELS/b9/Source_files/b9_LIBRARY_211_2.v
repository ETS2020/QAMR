...
module FAU ( 
  ...
  nor2   g065(.a(new_n69_), .b(new_n68_), .O(new_n128_));
  ...
  aoi22  g070(.a(new_n132_), .b(x40), .c(new_n64_), .d(new_n68_), .O(new_n133_));
  nand2  g071(.a(x39), .b(x29), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x40), .O(new_n135_));
  nand2  g073(.a(new_n63_), .b(new_n104_), .O(new_n136_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n63_), .c(new_n104_), .O(new_n150_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n104_), .d(new_n73_), .O(new_n154_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n73_), .c(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n160_), .O(z13));
  nor2   g102(.a(x40), .b(x13), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n166_));
  nand4  g104(.a(new_n152_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x39), .b(new_n104_), .c(new_n73_), .O(new_n168_));
  ...
  nand2  g109(.a(new_n68_), .b(new_n104_), .O(new_n172_));
  nand4  g110(.a(x40), .b(new_n69_), .c(new_n144_), .d(x28), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(x32), .O(new_n174_));
  oai21  g112(.a(new_n169_), .b(new_n63_), .c(new_n136_), .O(new_n175_));
  aoi22  g113(.a(new_n175_), .b(new_n149_), .c(new_n174_), .d(new_n79_), .O(new_n176_));
  ...
  oai22  g124(.a(new_n93_), .b(new_n186_), .c(new_n83_), .d(x27), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  inv1   g126(.a(new_n83_), .O(new_n189_));
  nor2   g127(.a(new_n68_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g130(.a(new_n142_), .b(new_n64_), .O(z19));
  nand2  g131(.a(x28), .b(new_n68_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(x35), .c(new_n136_), .d(new_n135_), .O(new_n195_));
  nand2  g133(.a(new_n64_), .b(new_n68_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n144_), .O(new_n197_));
