...
module FAU ( 
  ...
  oai21  g028(.a(x35), .b(new_n75_), .c(new_n80_), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x04), .O(new_n92_));
  inv1   g030(.a(x40), .O(new_n93_));
  inv1   g031(.a(x37), .O(new_n94_));
  nand3  g032(.a(new_n94_), .b(x28), .c(new_n64_), .O(new_n95_));
  nand2  g033(.a(new_n76_), .b(x39), .O(new_n96_));
  aoi21  g034(.a(new_n95_), .b(new_n93_), .c(new_n96_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n92_), .c(new_n90_), .d(new_n88_), .O(z02));
  oai21  g036(.a(new_n66_), .b(new_n80_), .c(x27), .O(new_n99_));
  nand3  g037(.a(new_n76_), .b(new_n94_), .c(new_n64_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n99_), .c(new_n76_), .d(x21), .O(z03));
  inv1   g039(.a(x21), .O(new_n102_));
  nand4  g040(.a(new_n100_), .b(new_n99_), .c(new_n76_), .d(new_n102_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  aoi22  g042(.a(new_n104_), .b(new_n94_), .c(x40), .d(new_n75_), .O(z05));
  nand3  g043(.a(new_n104_), .b(new_n76_), .c(new_n94_), .O(new_n106_));
  ...
  nand2  g055(.a(new_n117_), .b(new_n76_), .O(z07));
  inv1   g056(.a(x39), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(x23), .c(new_n93_), .O(z08));
  ...
  nand4  g062(.a(x40), .b(x39), .c(x23), .d(x05), .O(new_n125_));
  oai21  g063(.a(z08), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n82_), .c(new_n65_), .O(new_n127_));
  ...
  nand3  g082(.a(new_n94_), .b(new_n67_), .c(new_n66_), .O(new_n145_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n146_), .c(x23), .O(new_n149_));
  oai21  g087(.a(new_n70_), .b(new_n64_), .c(new_n93_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n93_), .O(new_n154_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(new_n75_), .O(new_n160_));
  nand4  g098(.a(new_n158_), .b(new_n93_), .c(x20), .d(new_n157_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n132_), .b(new_n152_), .c(new_n65_), .O(new_n164_));
  ...
  nand3  g105(.a(x39), .b(new_n152_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n75_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n93_), .c(new_n166_), .O(new_n171_));
  ...
  oai21  g112(.a(new_n169_), .b(new_n147_), .c(new_n174_), .O(new_n175_));
  ...
  nand2  g116(.a(new_n178_), .b(new_n76_), .O(z15));
  nand4  g117(.a(new_n93_), .b(new_n75_), .c(x22), .d(x01), .O(new_n180_));
  ...
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n76_), .d(new_n185_), .O(z18));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n140_), .O(new_n193_));
  oai21  g131(.a(new_n66_), .b(new_n64_), .c(x23), .O(new_n194_));
  nand2  g132(.a(new_n93_), .b(new_n64_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n194_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n193_), .c(new_n78_), .O(new_n197_));
