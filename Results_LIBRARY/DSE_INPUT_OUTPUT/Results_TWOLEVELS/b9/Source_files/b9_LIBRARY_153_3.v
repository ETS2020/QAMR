...
module FAU ( 
  ...
  nand3  g21(.a(new_n63_), .b(new_n66_), .c(new_n78_), .O(new_n84_));
  nand4  g22(.a(new_n84_), .b(new_n83_), .c(new_n63_), .d(x21), .O(z03));
  inv1   g23(.a(x21), .O(new_n86_));
  nand4  g24(.a(new_n84_), .b(new_n83_), .c(new_n63_), .d(new_n86_), .O(z04));
  nand2  g25(.a(x28), .b(x27), .O(new_n88_));
  aoi21  g26(.a(new_n88_), .b(new_n66_), .c(z08), .O(z05));
  nand3  g27(.a(new_n88_), .b(new_n63_), .c(new_n66_), .O(new_n90_));
  ...
  nand3  g48(.a(new_n110_), .b(new_n63_), .c(x27), .O(new_n111_));
  ...
  nand3  g53(.a(new_n115_), .b(x35), .c(new_n80_), .O(new_n116_));
  nand4  g54(.a(new_n116_), .b(new_n63_), .c(new_n71_), .d(new_n113_), .O(new_n117_));
  inv1   g55(.a(new_n117_), .O(z11));
  aoi21  g56(.a(new_n68_), .b(x27), .c(z08), .O(z12));
  nand4  g57(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n120_));
  nor3   g58(.a(new_n120_), .b(x19), .c(x18), .O(z13));
  nor2   g59(.a(x19), .b(x18), .O(new_n122_));
  nand3  g60(.a(new_n122_), .b(x27), .c(x20), .O(new_n123_));
  inv1   g61(.a(new_n123_), .O(new_n124_));
  aoi21  g62(.a(new_n124_), .b(new_n68_), .c(z08), .O(z14));
  inv1   g63(.a(x12), .O(new_n126_));
  nand4  g64(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n127_));
  ...
  nand2  g72(.a(new_n78_), .b(x08), .O(new_n135_));
  oai21  g73(.a(new_n78_), .b(x04), .c(new_n135_), .O(new_n136_));
  nand3  g74(.a(new_n136_), .b(x35), .c(new_n80_), .O(new_n137_));
  nor2   g75(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g76(.a(new_n138_), .b(new_n137_), .c(z08), .O(z18));
  nand2  g77(.a(new_n117_), .b(new_n63_), .O(z19));
  oai21  g78(.a(new_n114_), .b(new_n72_), .c(new_n63_), .O(new_n141_));
  oai21  g79(.a(new_n80_), .b(x27), .c(new_n141_), .O(new_n142_));
  nand3  g80(.a(new_n142_), .b(new_n71_), .c(new_n113_), .O(new_n143_));
  nand2  g81(.a(new_n143_), .b(new_n63_), .O(z20));
endmodule
