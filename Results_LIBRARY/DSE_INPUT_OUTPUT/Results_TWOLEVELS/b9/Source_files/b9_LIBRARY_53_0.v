...
module FAU ( 
  ...
  aoi21  g028(.a(x40), .b(new_n90_), .c(x28), .O(new_n91_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n105_), .c(x08), .O(new_n135_));
  nor2   g073(.a(new_n90_), .b(x28), .O(new_n136_));
  inv1   g074(.a(x29), .O(new_n137_));
  oai21  g075(.a(new_n64_), .b(new_n137_), .c(x39), .O(new_n138_));
  ...
  oai21  g084(.a(new_n63_), .b(x04), .c(new_n69_), .O(new_n147_));
  nand2  g085(.a(x39), .b(new_n83_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x35), .c(x37), .O(new_n149_));
  nand2  g087(.a(x39), .b(x27), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n64_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n147_), .c(new_n146_), .O(z12));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n72_), .c(new_n79_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z13));
  aoi21  g103(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(x40), .c(x39), .d(new_n72_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n98_), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n169_));
  inv1   g107(.a(new_n93_), .O(new_n170_));
  nand4  g108(.a(new_n154_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n170_), .c(new_n153_), .d(new_n72_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand3  g111(.a(x39), .b(new_n153_), .c(new_n72_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n67_), .O(new_n175_));
  nand3  g113(.a(new_n81_), .b(new_n80_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n90_), .O(new_n178_));
  nand3  g116(.a(new_n64_), .b(x39), .c(new_n83_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n178_), .c(new_n175_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n66_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n173_), .c(new_n168_), .d(new_n65_), .O(z14));
  ...
  oai22  g128(.a(new_n93_), .b(new_n137_), .c(new_n84_), .d(x27), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n98_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n136_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n192_), .c(new_n65_), .d(new_n80_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n98_), .c(new_n90_), .O(new_n196_));
  aoi21  g134(.a(new_n139_), .b(new_n138_), .c(new_n196_), .O(new_n197_));
  nand2  g135(.a(x39), .b(new_n90_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n105_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n80_), .O(new_n200_));
