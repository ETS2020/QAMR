...
module FAU ( 
  ...
  nor2   g071(.a(x40), .b(x35), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n91_), .c(x11), .O(new_n135_));
  inv1   g073(.a(x29), .O(new_n136_));
  oai21  g074(.a(new_n97_), .b(new_n72_), .c(new_n82_), .O(new_n137_));
  oai21  g075(.a(new_n93_), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  aoi21  g076(.a(x35), .b(x27), .c(x08), .O(new_n139_));
  aoi21  g077(.a(x39), .b(x29), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n139_), .c(x40), .O(new_n141_));
  inv1   g079(.a(x08), .O(new_n142_));
  oai21  g080(.a(x28), .b(x04), .c(new_n142_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n141_), .c(new_n138_), .d(new_n135_), .O(new_n144_));
  ...
  oai21  g086(.a(new_n93_), .b(x04), .c(new_n69_), .O(new_n149_));
  ...
  nand3  g098(.a(new_n127_), .b(new_n151_), .c(new_n72_), .O(new_n161_));
  ...
  nand3  g103(.a(new_n94_), .b(new_n151_), .c(new_n72_), .O(new_n166_));
  ...
  aoi21  g109(.a(new_n166_), .b(new_n69_), .c(new_n98_), .O(new_n172_));
  ...
  nand2  g121(.a(new_n97_), .b(x08), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(new_n168_), .O(new_n185_));
  nand2  g123(.a(new_n79_), .b(new_n133_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(new_n82_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n98_), .c(new_n93_), .d(new_n89_), .O(z18));
  aoi21  g126(.a(x28), .b(new_n97_), .c(new_n168_), .O(new_n189_));
  oai21  g127(.a(new_n125_), .b(new_n136_), .c(x40), .O(new_n190_));
  nand2  g128(.a(new_n64_), .b(x11), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n189_), .O(new_n192_));
  nand2  g130(.a(new_n65_), .b(new_n97_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n168_), .O(new_n194_));
  ...
  nand2  g135(.a(new_n145_), .b(new_n65_), .O(z19));
endmodule
