...
module FAU ( 
  ...
  inv1   g073(.a(x23), .O(new_n136_));
  nor2   g074(.a(x40), .b(x35), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n92_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(z08), .O(new_n139_));
  oai21  g077(.a(new_n64_), .b(new_n65_), .c(new_n85_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  oai22  g079(.a(new_n76_), .b(x08), .c(x29), .d(new_n64_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x04), .O(new_n143_));
  aoi22  g081(.a(x35), .b(new_n85_), .c(x29), .d(x08), .O(new_n144_));
  oai22  g082(.a(x39), .b(x35), .c(x27), .d(x08), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x40), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(new_n143_), .c(new_n141_), .d(new_n138_), .O(new_n147_));
  ...
  oai21  g093(.a(new_n155_), .b(new_n96_), .c(new_n154_), .O(new_n156_));
  ...
  nand4  g103(.a(new_n72_), .b(new_n136_), .c(x20), .d(new_n163_), .O(new_n166_));
  ...
  nand3  g120(.a(new_n154_), .b(new_n76_), .c(new_n136_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n182_), .c(new_n176_), .O(z14));
  inv1   g122(.a(x12), .O(new_n185_));
  nor2   g123(.a(new_n122_), .b(new_n185_), .O(z15));
  nand2  g124(.a(x22), .b(x01), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(x23), .O(z16));
  nor4   g126(.a(new_n187_), .b(new_n76_), .c(x24), .d(new_n136_), .O(z17));
  inv1   g127(.a(x29), .O(new_n190_));
  oai22  g128(.a(new_n86_), .b(x27), .c(new_n139_), .d(new_n190_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  inv1   g130(.a(new_n86_), .O(new_n193_));
  nor2   g131(.a(new_n64_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n192_), .c(new_n81_), .d(new_n83_), .O(z18));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  oai21  g135(.a(new_n75_), .b(new_n190_), .c(x40), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n97_), .c(new_n197_), .O(new_n199_));
  ...
  oai21  g142(.a(new_n148_), .b(x09), .c(new_n81_), .O(z19));
endmodule
