...
module FAU ( 
  ...
  nand4  g033(.a(new_n95_), .b(new_n93_), .c(new_n91_), .d(x40), .O(z02));
  ...
  aoi21  g055(.a(new_n94_), .b(x12), .c(new_n74_), .O(z08));
  ...
  aoi22  g074(.a(new_n136_), .b(x12), .c(new_n64_), .d(new_n68_), .O(new_n137_));
  ...
  nor2   g087(.a(new_n124_), .b(x04), .O(new_n150_));
  ...
  nand4  g100(.a(new_n128_), .b(x39), .c(new_n153_), .d(new_n122_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x12), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x40), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(z13));
  inv1   g104(.a(new_n150_), .O(new_n167_));
  aoi21  g105(.a(new_n128_), .b(new_n153_), .c(new_n63_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(new_n68_), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n170_));
  inv1   g108(.a(new_n124_), .O(new_n171_));
  nand4  g109(.a(new_n154_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n172_));
  ...
  nand4  g115(.a(new_n177_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n176_), .c(new_n69_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n175_), .c(new_n169_), .d(new_n64_), .O(z14));
  ...
  oai21  g140(.a(new_n197_), .b(new_n177_), .c(new_n74_), .O(new_n203_));
