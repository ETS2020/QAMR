...
module FAU ( 
  ...
  nand2  g24(.a(z05), .b(new_n68_), .O(z06));
  ...
  nand4  g52(.a(new_n115_), .b(new_n68_), .c(new_n71_), .d(new_n111_), .O(new_n116_));
  ...
  nand2  g70(.a(new_n81_), .b(x08), .O(new_n134_));
  oai21  g71(.a(new_n81_), .b(x04), .c(new_n134_), .O(new_n135_));
  nand3  g72(.a(new_n135_), .b(x35), .c(new_n112_), .O(new_n136_));
  nand4  g73(.a(new_n136_), .b(new_n68_), .c(new_n71_), .d(new_n111_), .O(z18));
  nand2  g74(.a(new_n116_), .b(new_n68_), .O(z19));
  oai21  g75(.a(new_n113_), .b(new_n72_), .c(new_n68_), .O(new_n139_));
