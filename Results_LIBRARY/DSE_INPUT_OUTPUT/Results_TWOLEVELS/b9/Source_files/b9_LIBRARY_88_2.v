...
module FAU ( 
  ...
  aoi21  g068(.a(new_n75_), .b(new_n74_), .c(new_n83_), .O(new_n131_));
  ...
  oai21  g086(.a(new_n143_), .b(x39), .c(new_n148_), .O(z12));
  ...
  aoi21  g098(.a(new_n160_), .b(x40), .c(new_n70_), .O(new_n161_));
  ...
  nand4  g107(.a(new_n169_), .b(x40), .c(new_n75_), .d(new_n74_), .O(new_n170_));
