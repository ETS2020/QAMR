...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x33), .O(new_n81_));
  ...
  nand4  g055(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  ...
  nor2   g065(.a(new_n70_), .b(new_n64_), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(x06), .c(new_n98_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n127_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(x40), .c(new_n81_), .d(new_n64_), .O(new_n133_));
  nand2  g071(.a(x39), .b(x29), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x40), .O(new_n135_));
  nand2  g073(.a(new_n80_), .b(new_n106_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g075(.a(x27), .b(x04), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(x35), .c(new_n85_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  oai21  g078(.a(new_n133_), .b(x08), .c(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n83_), .c(new_n131_), .O(new_n142_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n80_), .c(new_n106_), .O(new_n149_));
  ...
  nand3  g097(.a(new_n124_), .b(x40), .c(x39), .O(new_n160_));
  ...
  nand2  g127(.a(new_n83_), .b(new_n131_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n85_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n98_), .c(new_n92_), .d(new_n75_), .O(z18));
  nand2  g130(.a(new_n142_), .b(new_n81_), .O(z19));
  nand2  g131(.a(x28), .b(new_n64_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(x35), .c(new_n136_), .d(new_n135_), .O(new_n195_));
  nand2  g133(.a(new_n81_), .b(new_n64_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n66_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n195_), .c(new_n83_), .O(new_n199_));
