...
module FAU ( 
  ...
  aoi21  g041(.a(new_n64_), .b(new_n66_), .c(new_n83_), .O(new_n104_));
  ...
  nand3  g062(.a(new_n124_), .b(new_n85_), .c(new_n73_), .O(new_n125_));
  ...
  aoi21  g066(.a(new_n81_), .b(new_n80_), .c(new_n63_), .O(new_n129_));
  ...
  aoi22  g075(.a(new_n137_), .b(x40), .c(new_n64_), .d(new_n66_), .O(new_n138_));
  ...
  nand3  g079(.a(new_n67_), .b(new_n82_), .c(new_n91_), .O(new_n142_));
  ...
  aoi21  g095(.a(new_n157_), .b(x40), .c(new_n117_), .O(new_n158_));
  ...
  oai21  g100(.a(new_n160_), .b(new_n117_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g116(.a(new_n84_), .b(x27), .c(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n66_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n92_), .c(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n180_), .c(new_n64_), .d(new_n80_), .O(z18));
  ...
  nand2  g124(.a(new_n90_), .b(x40), .O(new_n187_));
