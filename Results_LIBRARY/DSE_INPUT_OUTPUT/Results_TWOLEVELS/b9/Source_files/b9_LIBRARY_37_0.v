...
module FAU ( 
  ...
  nand2  g037(.a(new_n76_), .b(x33), .O(new_n100_));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n102_), .c(new_n84_), .O(z04));
  aoi21  g044(.a(x28), .b(x27), .c(x37), .O(new_n107_));
  nor2   g045(.a(new_n107_), .b(new_n84_), .O(z05));
  nand2  g046(.a(new_n82_), .b(new_n64_), .O(new_n109_));
  oai21  g047(.a(x40), .b(x33), .c(new_n87_), .O(new_n110_));
  aoi21  g048(.a(new_n110_), .b(new_n109_), .c(x37), .O(z06));
  nand2  g049(.a(x17), .b(new_n63_), .O(new_n112_));
  inv1   g050(.a(x00), .O(new_n113_));
  oai21  g051(.a(x25), .b(new_n113_), .c(x38), .O(new_n114_));
  nand3  g052(.a(new_n114_), .b(new_n112_), .c(new_n81_), .O(new_n115_));
  ...
  aoi21  g064(.a(new_n126_), .b(new_n100_), .c(new_n125_), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(x05), .O(new_n128_));
  inv1   g066(.a(new_n128_), .O(new_n129_));
  oai21  g067(.a(new_n129_), .b(new_n127_), .c(new_n89_), .O(new_n130_));
  ...
  oai21  g075(.a(new_n88_), .b(x04), .c(x40), .O(new_n138_));
  ...
  inv1   g088(.a(new_n100_), .O(new_n151_));
  nand2  g089(.a(new_n72_), .b(x27), .O(new_n152_));
  aoi21  g090(.a(x39), .b(new_n65_), .c(new_n76_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n150_), .c(new_n82_), .O(z12));
  ...
  nand4  g101(.a(new_n72_), .b(x33), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n135_), .b(new_n156_), .c(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  nand3  g106(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n169_));
  nand4  g107(.a(new_n157_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n170_));
  nand3  g108(.a(x39), .b(new_n156_), .c(new_n65_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n76_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n151_), .c(new_n169_), .O(new_n174_));
  ...
  nand3  g118(.a(new_n152_), .b(new_n76_), .c(x33), .O(new_n181_));
  ...
  nand2  g133(.a(new_n85_), .b(new_n195_), .O(new_n196_));
  aoi21  g134(.a(new_n194_), .b(new_n87_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n84_), .c(new_n94_), .d(new_n191_), .O(z18));
  oai21  g136(.a(new_n145_), .b(x09), .c(new_n82_), .O(z19));
  nand2  g137(.a(x28), .b(new_n64_), .O(new_n200_));
  aoi22  g138(.a(new_n200_), .b(x35), .c(new_n142_), .d(new_n100_), .O(new_n201_));
  nand2  g139(.a(x40), .b(new_n66_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n109_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n85_), .O(new_n204_));
