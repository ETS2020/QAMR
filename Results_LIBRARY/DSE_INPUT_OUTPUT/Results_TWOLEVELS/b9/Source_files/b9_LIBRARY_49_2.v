...
module FAU ( 
  ...
  aoi21  g038(.a(new_n65_), .b(new_n98_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n78_), .O(z04));
  aoi21  g040(.a(x28), .b(x27), .c(x37), .O(new_n103_));
  nor2   g041(.a(new_n103_), .b(new_n78_), .O(z05));
  inv1   g042(.a(x12), .O(new_n105_));
  oai22  g043(.a(x40), .b(new_n105_), .c(new_n82_), .d(new_n98_), .O(new_n106_));
  ...
  nand2  g056(.a(new_n93_), .b(new_n64_), .O(z08));
  ...
  oai21  g062(.a(new_n93_), .b(new_n123_), .c(new_n124_), .O(new_n125_));
  ...
  nor2   g068(.a(new_n65_), .b(new_n98_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n78_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n82_), .c(new_n71_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n64_), .d(new_n98_), .O(new_n136_));
  nand2  g074(.a(x39), .b(x29), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x40), .O(new_n138_));
  nand2  g076(.a(new_n63_), .b(new_n105_), .O(new_n139_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n79_), .c(new_n134_), .O(new_n145_));
  ...
  nand2  g087(.a(x39), .b(new_n71_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n68_), .O(new_n151_));
  oai21  g089(.a(x28), .b(x12), .c(x35), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n65_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(x27), .c(new_n105_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n63_), .O(new_n155_));
  ...
  nand3  g103(.a(new_n127_), .b(x40), .c(x39), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(x13), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n71_), .c(new_n78_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n165_), .O(z13));
  aoi21  g107(.a(new_n80_), .b(new_n79_), .c(x13), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x40), .c(x39), .d(new_n71_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n98_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n173_));
  nand4  g111(.a(new_n158_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n94_), .c(new_n157_), .d(new_n71_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand3  g114(.a(x39), .b(new_n157_), .c(new_n71_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n66_), .O(new_n178_));
  inv1   g116(.a(x35), .O(new_n179_));
  nand3  g117(.a(new_n80_), .b(new_n79_), .c(x28), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x40), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand3  g120(.a(new_n63_), .b(new_n82_), .c(new_n105_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n182_), .c(new_n178_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n65_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n176_), .c(new_n172_), .d(new_n64_), .O(z14));
  nand3  g124(.a(x34), .b(x27), .c(x26), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(x40), .c(new_n105_), .O(z15));
  ...
  nand2  g132(.a(new_n94_), .b(x29), .O(new_n195_));
  oai21  g133(.a(new_n83_), .b(x27), .c(new_n195_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(x08), .O(new_n197_));
  nor2   g135(.a(new_n179_), .b(x28), .O(new_n198_));
  nor2   g136(.a(new_n98_), .b(x04), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n198_), .c(x09), .O(new_n200_));
  nand4  g138(.a(new_n200_), .b(new_n197_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g139(.a(new_n145_), .O(z19));
  nor2   g140(.a(x40), .b(x35), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n91_), .c(new_n105_), .O(new_n204_));
  aoi21  g142(.a(x35), .b(x27), .c(x08), .O(new_n205_));
  aoi21  g143(.a(x39), .b(x29), .c(x35), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n205_), .c(x40), .O(new_n207_));
  nand3  g145(.a(new_n195_), .b(x28), .c(new_n98_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n207_), .c(new_n204_), .O(new_n209_));
