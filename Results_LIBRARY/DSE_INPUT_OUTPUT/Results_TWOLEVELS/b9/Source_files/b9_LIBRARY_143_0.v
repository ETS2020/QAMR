...
module FAU ( 
  ...
  oai21  g051(.a(new_n73_), .b(new_n113_), .c(new_n92_), .O(z08));
  nand4  g052(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(new_n92_), .O(z09));
  inv1   g054(.a(x07), .O(new_n117_));
  nand2  g055(.a(x40), .b(new_n113_), .O(new_n118_));
  nand2  g056(.a(new_n73_), .b(x25), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n118_), .c(new_n117_), .O(new_n120_));
  nand3  g058(.a(x40), .b(x39), .c(x05), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n120_), .c(new_n83_), .O(new_n123_));
  ...
  nor2   g072(.a(new_n66_), .b(new_n71_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n82_), .c(new_n134_), .O(new_n136_));
  nand2  g074(.a(x40), .b(x04), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(x35), .c(new_n81_), .d(x27), .O(new_n138_));
  ...
  nand2  g079(.a(new_n141_), .b(new_n92_), .O(z11));
  inv1   g080(.a(x35), .O(new_n143_));
  nand3  g081(.a(new_n67_), .b(new_n80_), .c(new_n143_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n71_), .c(new_n69_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x40), .O(new_n147_));
  nor2   g085(.a(new_n69_), .b(x40), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x25), .O(new_n149_));
  ...
  oai21  g123(.a(new_n82_), .b(x27), .c(new_n134_), .O(new_n186_));
  ...
  nand4  g128(.a(new_n190_), .b(new_n187_), .c(new_n92_), .d(new_n78_), .O(z18));
  inv1   g129(.a(new_n134_), .O(new_n192_));
  oai21  g130(.a(new_n143_), .b(new_n66_), .c(new_n89_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n66_), .c(new_n143_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n78_), .c(new_n133_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n92_), .O(z20));
  nand2  g135(.a(new_n141_), .b(new_n92_), .O(z19));
endmodule
