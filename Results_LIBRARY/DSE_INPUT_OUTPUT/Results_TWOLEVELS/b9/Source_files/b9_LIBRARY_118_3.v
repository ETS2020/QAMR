...
module FAU ( 
  ...
  nand2  g017(.a(x40), .b(x14), .O(new_n80_));
  ...
  oai21  g035(.a(new_n97_), .b(new_n94_), .c(new_n88_), .O(new_n98_));
  ...
  nand4  g043(.a(new_n105_), .b(new_n104_), .c(new_n80_), .d(x21), .O(z03));
  inv1   g044(.a(new_n80_), .O(new_n107_));
  ...
  nand3  g048(.a(new_n110_), .b(new_n80_), .c(new_n70_), .O(z05));
  ...
  nand2  g057(.a(new_n119_), .b(new_n88_), .O(new_n120_));
  oai21  g058(.a(new_n117_), .b(x31), .c(new_n120_), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(x03), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n80_), .O(z07));
  nand3  g061(.a(x40), .b(x39), .c(new_n88_), .O(new_n124_));
  inv1   g062(.a(new_n124_), .O(z08));
  nand4  g063(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n80_), .O(z09));
  ...
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n80_), .O(z10));
  inv1   g077(.a(x28), .O(new_n140_));
  nand2  g078(.a(x40), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(x35), .c(new_n140_), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n88_), .c(new_n80_), .d(new_n64_), .O(new_n143_));
  nand2  g081(.a(x39), .b(x29), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n88_), .c(new_n89_), .O(new_n145_));
  nand2  g083(.a(x27), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(x35), .c(new_n140_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(new_n148_));
  oai22  g086(.a(new_n148_), .b(new_n145_), .c(new_n143_), .d(x08), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n82_), .c(new_n99_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n80_), .O(z11));
  nand3  g089(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(new_n152_));
  nand2  g090(.a(x40), .b(new_n64_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n152_), .c(x10), .O(new_n154_));
  nand2  g092(.a(new_n141_), .b(x39), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n64_), .O(new_n156_));
  nand2  g094(.a(x39), .b(new_n65_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n71_), .c(new_n70_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n154_), .c(new_n88_), .O(new_n160_));
  oai21  g098(.a(new_n73_), .b(new_n64_), .c(new_n89_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z12));
  inv1   g100(.a(x13), .O(new_n163_));
  nand2  g101(.a(x36), .b(x35), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(x28), .c(new_n89_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n163_), .d(new_n65_), .O(new_n166_));
  inv1   g104(.a(x18), .O(new_n167_));
  inv1   g105(.a(x19), .O(new_n168_));
  nand4  g106(.a(new_n72_), .b(x20), .c(new_n168_), .d(new_n167_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n166_), .c(x14), .O(new_n170_));
  nand4  g108(.a(new_n72_), .b(new_n89_), .c(x20), .d(new_n168_), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(x18), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(x27), .O(new_n173_));
  nand4  g111(.a(new_n134_), .b(new_n88_), .c(new_n163_), .d(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(z13));
  nand3  g113(.a(x20), .b(new_n168_), .c(new_n167_), .O(new_n176_));
  nand4  g114(.a(new_n164_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n177_));
  ...
  nand3  g122(.a(new_n184_), .b(new_n83_), .c(new_n82_), .O(new_n185_));
  nand2  g123(.a(new_n153_), .b(new_n72_), .O(new_n186_));
  oai21  g124(.a(x13), .b(x04), .c(new_n186_), .O(new_n187_));
  oai21  g125(.a(new_n73_), .b(new_n64_), .c(new_n132_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n187_), .c(new_n185_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n88_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n182_), .c(new_n161_), .O(z14));
  inv1   g129(.a(x12), .O(new_n192_));
  nand4  g130(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(new_n192_), .O(z15));
  inv1   g132(.a(x23), .O(new_n195_));
  nand4  g133(.a(new_n80_), .b(new_n195_), .c(x22), .d(x01), .O(new_n196_));
  inv1   g134(.a(new_n196_), .O(z16));
  inv1   g135(.a(x24), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(x23), .c(x22), .d(x01), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n80_), .O(z17));
  nand2  g138(.a(x27), .b(new_n65_), .O(new_n201_));
  nand2  g139(.a(new_n64_), .b(x08), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n201_), .c(new_n66_), .O(new_n203_));
  nand2  g141(.a(new_n82_), .b(new_n99_), .O(new_n204_));
  aoi21  g142(.a(new_n203_), .b(new_n140_), .c(new_n204_), .O(new_n205_));
  nand4  g143(.a(new_n76_), .b(x29), .c(new_n88_), .d(x08), .O(new_n206_));
  oai21  g144(.a(new_n205_), .b(new_n107_), .c(new_n206_), .O(z18));
  inv1   g145(.a(new_n150_), .O(z19));
  aoi21  g146(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n209_));
  aoi21  g147(.a(x35), .b(x27), .c(x14), .O(new_n210_));
  nor2   g148(.a(x40), .b(x27), .O(new_n211_));
  oai21  g149(.a(new_n211_), .b(new_n210_), .c(new_n95_), .O(new_n212_));
  oai21  g150(.a(new_n209_), .b(new_n145_), .c(new_n212_), .O(new_n213_));
  nand3  g151(.a(new_n213_), .b(new_n82_), .c(new_n99_), .O(new_n214_));
  inv1   g152(.a(new_n214_), .O(z20));
endmodule
