...
module FAU ( 
  ...
  oai21  g037(.a(new_n99_), .b(new_n96_), .c(x31), .O(new_n100_));
  ...
  aoi21  g048(.a(new_n81_), .b(new_n64_), .c(new_n85_), .O(new_n111_));
  ...
  nand4  g054(.a(new_n116_), .b(new_n114_), .c(new_n113_), .d(new_n80_), .O(new_n117_));
  ...
  nand3  g061(.a(x40), .b(x39), .c(x31), .O(new_n124_));
  ...
  nor2   g089(.a(new_n91_), .b(x27), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  oai21  g091(.a(x27), .b(new_n65_), .c(x31), .O(new_n154_));
  ...
  aoi21  g099(.a(new_n161_), .b(x28), .c(new_n91_), .O(new_n162_));
  ...
  nand4  g105(.a(new_n72_), .b(new_n91_), .c(x20), .d(new_n165_), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(x18), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(x27), .O(new_n170_));
  nand4  g108(.a(new_n134_), .b(x31), .c(new_n160_), .d(new_n65_), .O(new_n171_));
  ...
  nand4  g123(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n185_), .O(z15));
  inv1   g125(.a(x23), .O(new_n188_));
  nand4  g126(.a(new_n81_), .b(new_n188_), .c(x22), .d(x01), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(z16));
  inv1   g128(.a(x01), .O(new_n191_));
  inv1   g129(.a(x24), .O(new_n192_));
  nand4  g130(.a(new_n81_), .b(new_n192_), .c(x23), .d(x22), .O(new_n193_));
  ...
  nand2  g138(.a(new_n76_), .b(x31), .O(new_n201_));
  oai22  g139(.a(new_n201_), .b(new_n93_), .c(new_n200_), .d(new_n102_), .O(z18));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(new_n145_), .O(new_n204_));
  nand2  g142(.a(new_n66_), .b(x31), .O(new_n205_));
  ...
  nor2   g146(.a(new_n148_), .b(x09), .O(z19));
endmodule
