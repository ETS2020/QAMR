...
module FAU ( 
  ...
  nand2  g032(.a(new_n66_), .b(new_n91_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n94_), .c(new_n65_), .d(x21), .O(z03));
  aoi21  g034(.a(new_n66_), .b(new_n91_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n94_), .c(new_n79_), .O(z04));
  aoi21  g036(.a(x28), .b(x27), .c(x37), .O(new_n99_));
  nor2   g037(.a(new_n99_), .b(new_n79_), .O(z05));
  inv1   g038(.a(x28), .O(new_n101_));
  aoi21  g039(.a(new_n65_), .b(new_n91_), .c(new_n101_), .O(new_n102_));
  oai21  g040(.a(new_n102_), .b(x37), .c(new_n65_), .O(z06));
  ...
  nor2   g052(.a(new_n64_), .b(new_n63_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand4  g054(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(z09));
  aoi21  g056(.a(x35), .b(new_n101_), .c(x36), .O(new_n119_));
  ...
  nor3   g062(.a(new_n79_), .b(new_n66_), .c(new_n124_), .O(new_n125_));
  aoi21  g063(.a(new_n123_), .b(new_n72_), .c(new_n125_), .O(new_n126_));
  ...
  oai21  g067(.a(new_n126_), .b(new_n91_), .c(new_n129_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n101_), .c(new_n72_), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(x39), .c(new_n65_), .d(new_n91_), .O(new_n133_));
  nand2  g071(.a(x40), .b(new_n63_), .O(new_n134_));
  ...
  nand3  g076(.a(new_n138_), .b(x35), .c(new_n101_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  oai21  g078(.a(new_n133_), .b(x08), .c(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n80_), .c(new_n131_), .O(new_n142_));
  ...
  inv1   g084(.a(z08), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(x04), .c(new_n69_), .O(new_n148_));
  ...
  aoi21  g100(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x40), .c(x39), .d(new_n72_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n91_), .O(new_n165_));
  ...
  aoi22  g108(.a(new_n168_), .b(z08), .c(x35), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n171_), .c(new_n66_), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n170_), .c(new_n165_), .d(new_n65_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nor2   g114(.a(new_n117_), .b(new_n176_), .O(z15));
  ...
  nand2  g122(.a(z08), .b(x29), .O(new_n185_));
  oai21  g123(.a(new_n87_), .b(x27), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n91_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n83_), .c(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n65_), .d(new_n80_), .O(z18));
  inv1   g128(.a(new_n142_), .O(z19));
  oai22  g129(.a(new_n63_), .b(x35), .c(new_n101_), .d(x27), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n135_), .O(new_n193_));
  oai21  g131(.a(new_n63_), .b(x08), .c(new_n134_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n82_), .O(new_n195_));
  nor2   g133(.a(new_n79_), .b(x08), .O(new_n196_));
  nor2   g134(.a(x39), .b(new_n101_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n196_), .c(new_n91_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n195_), .c(new_n193_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n80_), .c(new_n131_), .O(new_n200_));
