...
module FAU ( 
  ...
  aoi21  g044(.a(new_n106_), .b(new_n102_), .c(new_n84_), .O(z04));
  ...
  oai21  g048(.a(x40), .b(x31), .c(new_n87_), .O(new_n111_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n100_), .c(new_n128_), .O(new_n130_));
  nand3  g068(.a(x40), .b(x39), .c(x05), .O(new_n131_));
  inv1   g069(.a(new_n131_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n130_), .c(new_n89_), .O(new_n133_));
  ...
  oai21  g078(.a(new_n88_), .b(x04), .c(x40), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n110_), .c(x08), .O(new_n142_));
  inv1   g080(.a(new_n88_), .O(new_n143_));
  nor2   g081(.a(x40), .b(new_n81_), .O(new_n144_));
  aoi21  g082(.a(x39), .b(x29), .c(new_n76_), .O(new_n145_));
  nor2   g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g084(.a(x27), .b(x04), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n143_), .c(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n142_), .c(new_n85_), .O(new_n149_));
  ...
  nand4  g104(.a(new_n72_), .b(x31), .c(x20), .d(new_n164_), .O(new_n167_));
  ...
  oai21  g114(.a(new_n176_), .b(new_n144_), .c(new_n172_), .O(new_n177_));
  ...
  oai22  g135(.a(new_n197_), .b(new_n84_), .c(new_n94_), .d(new_n124_), .O(z18));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n146_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n110_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n85_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(x09), .O(z20));
  nor2   g142(.a(new_n149_), .b(x09), .O(z19));
endmodule
