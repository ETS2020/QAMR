...
module FAU ( 
  ...
  aoi21  g26(.a(new_n88_), .b(new_n84_), .c(new_n78_), .O(z04));
  aoi21  g27(.a(x28), .b(x27), .c(x37), .O(new_n90_));
  nor2   g28(.a(new_n90_), .b(new_n78_), .O(z05));
  ...
  nand2  g43(.a(new_n105_), .b(new_n70_), .O(z07));
  nand4  g44(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n108_));
  nand2  g45(.a(new_n108_), .b(new_n70_), .O(z09));
  ...
  nand2  g51(.a(new_n114_), .b(new_n70_), .O(z10));
  inv1   g52(.a(x09), .O(new_n116_));
  nor2   g53(.a(x27), .b(x08), .O(new_n117_));
  aoi21  g54(.a(x27), .b(x04), .c(new_n117_), .O(new_n118_));
  nand3  g55(.a(new_n118_), .b(x35), .c(new_n64_), .O(new_n119_));
  nand4  g56(.a(new_n119_), .b(new_n70_), .c(new_n72_), .d(new_n116_), .O(new_n120_));
  inv1   g57(.a(new_n120_), .O(z11));
  nor2   g58(.a(new_n78_), .b(new_n68_), .O(z12));
  nand4  g59(.a(new_n70_), .b(new_n67_), .c(x27), .d(x20), .O(new_n123_));
  nor3   g60(.a(new_n123_), .b(x19), .c(x18), .O(z13));
  nor2   g61(.a(x19), .b(x18), .O(new_n125_));
  nand4  g62(.a(new_n125_), .b(new_n70_), .c(new_n68_), .d(x20), .O(z14));
  nand4  g63(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(new_n70_), .O(z15));
  inv1   g65(.a(x23), .O(new_n129_));
  nand4  g66(.a(new_n70_), .b(new_n129_), .c(x22), .d(x01), .O(new_n130_));
  inv1   g67(.a(new_n130_), .O(z16));
  inv1   g68(.a(x24), .O(new_n132_));
  nand4  g69(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  nand2  g70(.a(new_n133_), .b(new_n70_), .O(z17));
  nand2  g71(.a(new_n80_), .b(x08), .O(new_n135_));
  oai21  g72(.a(new_n80_), .b(x04), .c(new_n135_), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n64_), .O(new_n137_));
  nor2   g74(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g75(.a(new_n138_), .b(new_n137_), .c(new_n78_), .O(z18));
  nand2  g76(.a(new_n120_), .b(new_n70_), .O(z19));
  oai21  g77(.a(new_n117_), .b(new_n65_), .c(new_n70_), .O(new_n141_));
  oai21  g78(.a(new_n64_), .b(x27), .c(new_n141_), .O(new_n142_));
  nand3  g79(.a(new_n142_), .b(new_n72_), .c(new_n116_), .O(new_n143_));
  nand2  g80(.a(new_n143_), .b(new_n70_), .O(z20));
  zero   g81(.O(z08));
endmodule
