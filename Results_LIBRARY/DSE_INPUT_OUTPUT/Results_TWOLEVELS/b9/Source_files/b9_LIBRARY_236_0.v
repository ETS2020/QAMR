...
module FAU ( 
  ...
  nand4  g034(.a(new_n96_), .b(new_n95_), .c(new_n65_), .d(x21), .O(z03));
  inv1   g035(.a(new_n65_), .O(new_n98_));
  aoi21  g036(.a(new_n66_), .b(new_n92_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(new_n98_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n65_), .c(new_n66_), .O(z05));
  oai22  g040(.a(x40), .b(x39), .c(new_n82_), .d(new_n92_), .O(new_n103_));
  nor2   g041(.a(new_n103_), .b(x37), .O(z06));
  inv1   g042(.a(x33), .O(new_n105_));
  nand2  g043(.a(x17), .b(new_n73_), .O(new_n106_));
  ...
  nand2  g052(.a(new_n114_), .b(new_n65_), .O(z07));
  ...
  nand2  g058(.a(new_n116_), .b(x07), .O(new_n121_));
  ...
  nand2  g066(.a(new_n128_), .b(new_n72_), .O(new_n129_));
  nand3  g067(.a(x37), .b(x27), .c(x06), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n65_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(z08), .b(x29), .O(new_n133_));
  nor2   g071(.a(new_n92_), .b(new_n72_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n83_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(x27), .b(new_n72_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n83_), .c(new_n91_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n79_), .c(new_n132_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n65_), .O(z11));
  inv1   g078(.a(x35), .O(new_n141_));
  nand3  g079(.a(new_n66_), .b(new_n81_), .c(new_n141_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x27), .c(x10), .O(new_n143_));
  aoi22  g081(.a(new_n68_), .b(x27), .c(x39), .d(new_n72_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x40), .O(new_n145_));
  nand3  g083(.a(new_n69_), .b(new_n64_), .c(x39), .O(new_n146_));
  ...
  nand4  g088(.a(new_n150_), .b(x40), .c(new_n148_), .d(new_n72_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n68_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n63_), .O(new_n155_));
  nand4  g093(.a(new_n68_), .b(x40), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n126_), .b(new_n148_), .c(new_n72_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  nand3  g098(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n161_));
  nand4  g099(.a(new_n149_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n162_));
  nor2   g100(.a(x13), .b(x04), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(z08), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand3  g103(.a(new_n66_), .b(new_n141_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n80_), .c(new_n79_), .O(new_n168_));
  nand2  g106(.a(new_n64_), .b(x39), .O(new_n169_));
  oai21  g107(.a(new_n63_), .b(x04), .c(x40), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(new_n148_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n67_), .c(new_n66_), .O(new_n172_));
  aoi21  g110(.a(x40), .b(x27), .c(x39), .O(new_n173_));
  oai21  g111(.a(new_n163_), .b(new_n64_), .c(new_n169_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n92_), .c(new_n173_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n172_), .c(new_n168_), .d(new_n165_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nor2   g115(.a(new_n119_), .b(new_n177_), .O(z15));
  ...
  nand2  g121(.a(new_n183_), .b(new_n65_), .O(z17));
  nand2  g122(.a(new_n92_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n136_), .c(new_n141_), .O(new_n186_));
  nand2  g124(.a(new_n79_), .b(new_n132_), .O(new_n187_));
  aoi21  g125(.a(new_n186_), .b(new_n82_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n98_), .c(new_n116_), .d(new_n89_), .O(z18));
  inv1   g127(.a(new_n133_), .O(new_n190_));
  oai21  g128(.a(new_n141_), .b(new_n92_), .c(new_n91_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n92_), .c(new_n141_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n132_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n65_), .O(z20));
  nand2  g133(.a(new_n139_), .b(new_n65_), .O(z19));
endmodule
