...
module FAU ( 
  ...
  nand2  g032(.a(x40), .b(new_n63_), .O(new_n95_));
  ...
  aoi21  g040(.a(new_n66_), .b(new_n100_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n98_), .c(new_n97_), .O(z04));
  aoi21  g042(.a(x28), .b(x27), .c(x37), .O(new_n105_));
  nor2   g043(.a(new_n105_), .b(new_n97_), .O(z05));
  aoi21  g044(.a(new_n65_), .b(new_n100_), .c(new_n82_), .O(new_n107_));
  oai21  g045(.a(new_n107_), .b(x37), .c(new_n65_), .O(z06));
  ...
  nand2  g058(.a(new_n120_), .b(new_n65_), .O(z08));
  ...
  nand2  g072(.a(new_n65_), .b(new_n100_), .O(new_n135_));
  ...
  nand2  g078(.a(x40), .b(x29), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x39), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n95_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n138_), .c(new_n79_), .O(new_n145_));
  ...
  inv1   g087(.a(new_n95_), .O(new_n150_));
  aoi21  g088(.a(x40), .b(new_n72_), .c(new_n63_), .O(new_n151_));
  ...
  nand4  g094(.a(new_n156_), .b(x40), .c(new_n154_), .d(new_n72_), .O(new_n157_));
  inv1   g095(.a(x18), .O(new_n158_));
  inv1   g096(.a(x19), .O(new_n159_));
  nand4  g097(.a(new_n68_), .b(x20), .c(new_n159_), .d(new_n158_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n157_), .c(new_n63_), .O(new_n161_));
  nand4  g099(.a(new_n68_), .b(x40), .c(x20), .d(new_n159_), .O(new_n162_));
  ...
  nand3  g106(.a(x40), .b(new_n154_), .c(new_n72_), .O(new_n169_));
  ...
  nand4  g110(.a(x39), .b(new_n66_), .c(new_n139_), .d(x28), .O(new_n173_));
  nand2  g111(.a(x40), .b(new_n100_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(x32), .O(new_n175_));
  oai21  g113(.a(new_n170_), .b(new_n63_), .c(new_n95_), .O(new_n176_));
  aoi22  g114(.a(new_n176_), .b(new_n69_), .c(new_n175_), .d(new_n79_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n172_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nand4  g117(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n179_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand4  g120(.a(new_n65_), .b(new_n182_), .c(x22), .d(x01), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z16));
  inv1   g122(.a(x01), .O(new_n185_));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n65_), .b(new_n186_), .c(x23), .d(x22), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n185_), .O(z17));
  nand2  g126(.a(x27), .b(new_n72_), .O(new_n189_));
  nand2  g127(.a(new_n100_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n139_), .O(new_n191_));
  ...
  nand2  g133(.a(x28), .b(new_n100_), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(x35), .c(new_n142_), .d(new_n95_), .O(new_n197_));
  nand2  g135(.a(x39), .b(new_n139_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n135_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n79_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z20));
  nor2   g139(.a(new_n145_), .b(x09), .O(z19));
endmodule
