...
module FAU ( 
  ...
  wire new_n63_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_, new_n70_,
    ...
    new_n133_, new_n134_, new_n137_, new_n138_, new_n139_;
  ...
  nand2  g45(.a(new_n108_), .b(new_n63_), .O(z10));
  ...
  nand3  g50(.a(new_n113_), .b(x35), .c(new_n111_), .O(new_n114_));
  nand4  g51(.a(new_n114_), .b(new_n63_), .c(new_n72_), .d(new_n110_), .O(new_n115_));
  nand2  g52(.a(new_n115_), .b(new_n63_), .O(z11));
  nor2   g53(.a(new_n69_), .b(z08), .O(z12));
  inv1   g54(.a(x19), .O(new_n118_));
  nand3  g55(.a(new_n69_), .b(x20), .c(new_n118_), .O(new_n119_));
  oai21  g56(.a(new_n119_), .b(x18), .c(new_n63_), .O(z13));
  nor2   g57(.a(x19), .b(x18), .O(new_n121_));
  nand4  g58(.a(new_n121_), .b(new_n69_), .c(new_n63_), .d(x20), .O(z14));
  inv1   g59(.a(x12), .O(new_n123_));
  nand4  g60(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n124_));
  ...
  nand2  g67(.a(new_n130_), .b(new_n63_), .O(z17));
  nand2  g68(.a(new_n66_), .b(x08), .O(new_n132_));
  oai21  g69(.a(new_n66_), .b(x04), .c(new_n132_), .O(new_n133_));
  nand3  g70(.a(new_n133_), .b(x35), .c(new_n111_), .O(new_n134_));
  nand4  g71(.a(new_n134_), .b(new_n63_), .c(new_n72_), .d(new_n110_), .O(z18));
  inv1   g72(.a(new_n115_), .O(z19));
  oai21  g73(.a(new_n112_), .b(new_n73_), .c(new_n63_), .O(new_n137_));
  oai21  g74(.a(new_n111_), .b(x27), .c(new_n137_), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(new_n72_), .c(new_n110_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(new_n63_), .O(z20));
  one    g77(.O(z02));
endmodule
