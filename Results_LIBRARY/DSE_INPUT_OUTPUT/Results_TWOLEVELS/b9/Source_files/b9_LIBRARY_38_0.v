...
module FAU ( 
  ...
  aoi21  g014(.a(new_n76_), .b(new_n63_), .c(new_n64_), .O(new_n77_));
  nand4  g015(.a(new_n77_), .b(x39), .c(new_n67_), .d(new_n75_), .O(new_n78_));
  oai21  g016(.a(new_n74_), .b(new_n66_), .c(new_n78_), .O(z00));
  ...
  aoi21  g034(.a(new_n69_), .b(new_n92_), .c(new_n96_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n95_), .c(new_n66_), .O(z03));
  aoi21  g036(.a(new_n69_), .b(new_n92_), .c(x21), .O(new_n99_));
  ...
  oai22  g040(.a(x40), .b(x10), .c(new_n83_), .d(new_n92_), .O(new_n103_));
  ...
  nand2  g061(.a(new_n64_), .b(x10), .O(new_n124_));
  ...
  nand2  g075(.a(new_n65_), .b(new_n92_), .O(new_n138_));
  ...
  aoi21  g086(.a(x39), .b(new_n75_), .c(new_n64_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n142_), .c(new_n72_), .O(new_n150_));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  nand2  g089(.a(x40), .b(x27), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n63_), .O(new_n153_));
  ...
  nand3  g106(.a(x39), .b(new_n155_), .c(new_n75_), .O(new_n169_));
  ...
  oai21  g114(.a(new_n170_), .b(new_n73_), .c(new_n176_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x40), .O(new_n178_));
  nand3  g116(.a(new_n72_), .b(new_n64_), .c(x10), .O(new_n179_));
  ...
  oai22  g127(.a(new_n116_), .b(new_n189_), .c(new_n84_), .d(x27), .O(new_n190_));
  ...
  aoi21  g132(.a(x28), .b(new_n92_), .c(new_n173_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n144_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n173_), .O(new_n197_));
