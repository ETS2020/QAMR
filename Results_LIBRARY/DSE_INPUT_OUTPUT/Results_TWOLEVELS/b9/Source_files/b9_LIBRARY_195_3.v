...
module FAU ( 
  ...
  nand2  g030(.a(new_n68_), .b(x28), .O(new_n93_));
  oai21  g031(.a(new_n93_), .b(new_n92_), .c(new_n74_), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n91_), .O(z02));
  nand2  g033(.a(new_n69_), .b(x27), .O(new_n96_));
  nand3  g034(.a(new_n63_), .b(new_n68_), .c(new_n67_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n63_), .d(x21), .O(z03));
  inv1   g036(.a(x21), .O(new_n99_));
  nand4  g037(.a(new_n97_), .b(new_n96_), .c(new_n63_), .d(new_n99_), .O(z04));
  ...
  nand2  g052(.a(new_n114_), .b(new_n72_), .O(new_n115_));
  nand3  g053(.a(new_n112_), .b(new_n74_), .c(new_n110_), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(new_n115_), .c(new_n105_), .O(z07));
  nand3  g055(.a(x40), .b(x39), .c(new_n72_), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z08));
  inv1   g057(.a(x11), .O(new_n120_));
  nand4  g058(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(new_n120_), .O(z09));
  inv1   g060(.a(x04), .O(new_n123_));
  aoi21  g061(.a(x35), .b(new_n81_), .c(x36), .O(new_n124_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n126_), .c(new_n124_), .O(new_n130_));
  nand3  g068(.a(new_n63_), .b(x37), .c(x06), .O(new_n131_));
  inv1   g069(.a(new_n131_), .O(new_n132_));
  aoi21  g070(.a(new_n130_), .b(new_n123_), .c(new_n132_), .O(new_n133_));
  oai21  g071(.a(x32), .b(x30), .c(x40), .O(new_n134_));
  nor3   g072(.a(new_n134_), .b(new_n127_), .c(x33), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x05), .c(new_n123_), .O(new_n136_));
  oai21  g074(.a(new_n133_), .b(new_n67_), .c(new_n136_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  nand3  g076(.a(x35), .b(new_n81_), .c(new_n123_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n72_), .c(new_n63_), .d(new_n67_), .O(new_n140_));
  aoi21  g078(.a(x39), .b(x29), .c(x33), .O(new_n141_));
  nor2   g079(.a(new_n67_), .b(new_n123_), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n82_), .c(new_n141_), .d(new_n74_), .O(new_n143_));
  ...
  nand3  g086(.a(new_n68_), .b(new_n148_), .c(new_n147_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x27), .c(x10), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n123_), .c(new_n70_), .O(new_n151_));
  ...
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n154_), .d(new_n123_), .O(new_n157_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n157_), .c(x33), .O(new_n162_));
  ...
  nand3  g103(.a(new_n135_), .b(new_n154_), .c(new_n123_), .O(new_n166_));
  ...
  nand4  g107(.a(new_n169_), .b(new_n128_), .c(new_n154_), .d(new_n123_), .O(new_n170_));
  ...
  oai21  g112(.a(new_n127_), .b(x04), .c(new_n72_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(x40), .c(new_n154_), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n69_), .c(new_n68_), .O(new_n177_));
  nand3  g115(.a(x39), .b(new_n154_), .c(new_n123_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n72_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n67_), .c(new_n64_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n177_), .c(new_n174_), .d(new_n171_), .O(z14));
  ...
  nand2  g124(.a(new_n186_), .b(new_n63_), .O(z16));
  inv1   g125(.a(x24), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(x23), .c(x22), .d(x01), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n63_), .O(z17));
  nand2  g128(.a(new_n128_), .b(x29), .O(new_n191_));
  oai21  g129(.a(new_n82_), .b(x27), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n67_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n83_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n63_), .d(new_n79_), .O(z18));
  nand2  g134(.a(x39), .b(x29), .O(new_n197_));
  nor2   g135(.a(new_n81_), .b(x27), .O(new_n198_));
  nor2   g136(.a(x35), .b(x33), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n197_), .O(new_n200_));
  inv1   g138(.a(x08), .O(new_n201_));
  nor2   g139(.a(new_n64_), .b(x27), .O(new_n202_));
  oai21  g140(.a(new_n199_), .b(new_n202_), .c(new_n201_), .O(new_n203_));
  oai21  g141(.a(new_n198_), .b(new_n147_), .c(new_n74_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n203_), .c(new_n200_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n79_), .c(new_n138_), .O(new_n206_));
