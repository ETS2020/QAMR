...
module FAU ( 
  ...
  nand2  g016(.a(new_n78_), .b(x26), .O(new_n79_));
  ...
  nor2   g031(.a(x40), .b(x26), .O(new_n94_));
  ...
  nor2   g058(.a(new_n120_), .b(new_n78_), .O(z09));
  ...
  oai21  g079(.a(new_n123_), .b(new_n141_), .c(x40), .O(new_n142_));
  ...
  aoi21  g095(.a(new_n157_), .b(x28), .c(new_n78_), .O(new_n158_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n94_), .c(new_n168_), .O(new_n173_));
  ...
  aoi21  g118(.a(new_n180_), .b(x40), .c(new_n152_), .O(z15));
  ...
  oai22  g126(.a(new_n84_), .b(x27), .c(new_n118_), .d(new_n141_), .O(new_n189_));
