...
module FAU ( 
  ...
  inv1   g44(.a(x11), .O(new_n108_));
  nand4  g45(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n109_));
  nor2   g46(.a(new_n109_), .b(new_n108_), .O(z09));
  inv1   g47(.a(x04), .O(new_n111_));
  nand3  g48(.a(new_n74_), .b(x07), .c(new_n111_), .O(new_n112_));
  nand2  g49(.a(x37), .b(x06), .O(new_n113_));
  nand2  g50(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand3  g51(.a(new_n114_), .b(new_n63_), .c(x27), .O(new_n115_));
  inv1   g52(.a(new_n115_), .O(z10));
  inv1   g53(.a(x09), .O(new_n117_));
  inv1   g54(.a(x08), .O(new_n118_));
  aoi21  g55(.a(new_n66_), .b(new_n118_), .c(new_n72_), .O(new_n119_));
  aoi21  g56(.a(x27), .b(x04), .c(x28), .O(new_n120_));
  oai21  g57(.a(new_n119_), .b(new_n64_), .c(new_n120_), .O(new_n121_));
  nand3  g58(.a(new_n121_), .b(new_n71_), .c(new_n117_), .O(new_n122_));
  nand2  g59(.a(new_n122_), .b(new_n63_), .O(z11));
  nand2  g60(.a(new_n68_), .b(new_n63_), .O(z12));
  nor2   g61(.a(new_n67_), .b(new_n64_), .O(new_n125_));
  nand3  g62(.a(new_n125_), .b(x27), .c(x20), .O(new_n126_));
  nor3   g63(.a(new_n126_), .b(x19), .c(x18), .O(z13));
  nor2   g64(.a(new_n82_), .b(new_n64_), .O(z14));
  inv1   g65(.a(x12), .O(new_n129_));
  nor2   g66(.a(new_n109_), .b(new_n129_), .O(z15));
  inv1   g67(.a(x23), .O(new_n131_));
  nand3  g68(.a(new_n131_), .b(x22), .c(x01), .O(new_n132_));
  nand2  g69(.a(new_n132_), .b(new_n63_), .O(z16));
  inv1   g70(.a(x24), .O(new_n134_));
  nand4  g71(.a(new_n134_), .b(x23), .c(x22), .d(x01), .O(new_n135_));
  nand2  g72(.a(new_n135_), .b(new_n63_), .O(z17));
  nand2  g73(.a(x27), .b(new_n111_), .O(new_n137_));
  oai21  g74(.a(x27), .b(new_n118_), .c(new_n137_), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(x35), .c(new_n84_), .O(new_n139_));
  nand4  g76(.a(new_n139_), .b(new_n63_), .c(new_n71_), .d(new_n117_), .O(z18));
  oai21  g77(.a(x28), .b(new_n118_), .c(new_n66_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(x35), .O(new_n142_));
  nand4  g79(.a(new_n142_), .b(new_n63_), .c(new_n71_), .d(new_n117_), .O(new_n143_));
  inv1   g80(.a(new_n143_), .O(z20));
  zero   g81(.O(z08));
  nand2  g82(.a(new_n122_), .b(new_n63_), .O(z19));
endmodule
