...
module FAU ( 
  ...
  nand3  g067(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n130_));
  ...
  inv1   g074(.a(x12), .O(new_n137_));
  nand2  g075(.a(new_n63_), .b(new_n137_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n134_), .c(new_n138_), .d(new_n136_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n132_), .c(new_n79_), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(x09), .O(z11));
  nand3  g080(.a(new_n69_), .b(new_n81_), .c(new_n133_), .O(new_n143_));
  ...
  nand2  g085(.a(new_n147_), .b(new_n137_), .O(new_n148_));
  ...
  aoi21  g098(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n150_), .d(new_n73_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(z13));
  inv1   g101(.a(x39), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(x04), .c(x40), .O(new_n165_));
  aoi21  g103(.a(new_n63_), .b(new_n137_), .c(x13), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n165_), .c(x35), .d(x28), .O(new_n167_));
  nand4  g105(.a(new_n133_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n168_));
  ...
  inv1   g109(.a(new_n115_), .O(new_n172_));
  nand4  g110(.a(new_n151_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n172_), .c(new_n150_), .d(new_n73_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  aoi21  g113(.a(x27), .b(new_n137_), .c(x40), .O(new_n176_));
  nand3  g114(.a(x39), .b(new_n150_), .c(new_n73_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x40), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n123_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n68_), .c(new_n176_), .O(new_n180_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n65_), .c(new_n115_), .d(new_n89_), .O(z18));
  oai22  g135(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n137_), .O(new_n199_));
  ...
  nand3  g141(.a(new_n203_), .b(x28), .c(new_n68_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n202_), .c(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n79_), .c(new_n194_), .O(new_n206_));
