...
module FAU ( 
  ...
  aoi21  g034(.a(new_n66_), .b(new_n91_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g040(.a(new_n64_), .b(new_n91_), .c(new_n81_), .O(new_n103_));
  ...
  nand4  g067(.a(new_n129_), .b(x39), .c(x05), .d(new_n72_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n127_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  oai21  g070(.a(new_n63_), .b(x29), .c(x39), .O(new_n133_));
  ...
  nand3  g074(.a(x35), .b(new_n81_), .c(new_n72_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x40), .c(new_n64_), .d(new_n91_), .O(new_n138_));
  ...
  oai21  g082(.a(new_n63_), .b(new_n72_), .c(x39), .O(new_n145_));
  ...
  nand4  g086(.a(new_n148_), .b(new_n146_), .c(new_n144_), .d(new_n64_), .O(z12));
  ...
  oai21  g097(.a(new_n159_), .b(new_n63_), .c(x39), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n158_), .O(z13));
  inv1   g099(.a(new_n143_), .O(new_n162_));
  nor2   g100(.a(x19), .b(x18), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n162_), .c(new_n68_), .d(x20), .O(new_n164_));
  oai21  g102(.a(x13), .b(x04), .c(new_n164_), .O(new_n165_));
  oai21  g103(.a(new_n128_), .b(new_n116_), .c(new_n91_), .O(new_n166_));
  ...
  aoi21  g108(.a(new_n128_), .b(x28), .c(new_n116_), .O(new_n171_));
  nand2  g109(.a(new_n116_), .b(new_n81_), .O(new_n172_));
  oai21  g110(.a(new_n171_), .b(x35), .c(new_n172_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n66_), .c(new_n94_), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n170_), .c(new_n166_), .d(new_n165_), .O(z14));
  ...
  inv1   g125(.a(new_n82_), .O(new_n188_));
  nor2   g126(.a(new_n91_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n187_), .c(new_n64_), .d(new_n78_), .O(z18));
  nand2  g129(.a(new_n140_), .b(new_n64_), .O(z19));
  aoi22  g130(.a(new_n185_), .b(x28), .c(new_n64_), .d(new_n90_), .O(new_n193_));
  inv1   g131(.a(x35), .O(new_n194_));
  nand2  g132(.a(new_n88_), .b(x40), .O(new_n195_));
