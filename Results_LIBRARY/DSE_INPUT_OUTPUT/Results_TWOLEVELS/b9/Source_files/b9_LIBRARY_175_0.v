...
module FAU ( 
  ...
  nand2  g036(.a(new_n81_), .b(x26), .O(new_n99_));
  ...
  oai22  g046(.a(x40), .b(x26), .c(new_n86_), .d(new_n64_), .O(new_n109_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n82_), .O(z10));
  ...
  oai22  g087(.a(new_n73_), .b(new_n64_), .c(new_n128_), .d(x04), .O(new_n150_));
  nand2  g088(.a(new_n86_), .b(x26), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x35), .c(x37), .O(new_n152_));
  nand2  g090(.a(x27), .b(x26), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n152_), .c(new_n81_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n150_), .c(new_n149_), .O(z12));
  ...
  nand4  g101(.a(new_n72_), .b(x26), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n130_), .b(new_n156_), .c(new_n65_), .O(new_n167_));
  ...
  nand4  g108(.a(new_n170_), .b(z08), .c(new_n156_), .d(new_n65_), .O(new_n171_));
  ...
  nand3  g113(.a(x39), .b(new_n156_), .c(new_n65_), .O(new_n176_));
  oai21  g114(.a(new_n73_), .b(new_n64_), .c(new_n176_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n172_), .d(new_n154_), .O(z14));
  ...
  oai22  g131(.a(new_n193_), .b(new_n104_), .c(new_n93_), .d(new_n75_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n95_), .c(x26), .O(new_n196_));
