...
module FAU ( 
  ...
  nor2   g032(.a(x40), .b(new_n78_), .O(new_n95_));
  ...
  nor2   g038(.a(x40), .b(x39), .O(new_n101_));
  ...
  aoi21  g043(.a(new_n80_), .b(new_n64_), .c(new_n89_), .O(new_n106_));
  oai21  g044(.a(new_n106_), .b(x37), .c(new_n80_), .O(z06));
  ...
  nor3   g067(.a(new_n101_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  ...
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n80_), .d(new_n64_), .O(new_n138_));
  nand2  g076(.a(x40), .b(new_n78_), .O(new_n139_));
  ...
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n89_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  oai21  g083(.a(new_n138_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n82_), .c(new_n136_), .O(new_n147_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n95_), .c(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n151_), .c(new_n80_), .O(z12));
  inv1   g093(.a(x13), .O(new_n156_));
  nand2  g094(.a(x36), .b(x35), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x28), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x40), .c(new_n156_), .d(new_n65_), .O(new_n159_));
  inv1   g097(.a(x18), .O(new_n160_));
  inv1   g098(.a(x19), .O(new_n161_));
  nand4  g099(.a(new_n72_), .b(x20), .c(new_n161_), .d(new_n160_), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(new_n159_), .c(new_n78_), .O(new_n163_));
  nand4  g101(.a(new_n72_), .b(x40), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n133_), .b(new_n156_), .c(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  nand3  g106(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n169_));
  nand4  g107(.a(new_n157_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n170_));
  ...
  nand3  g118(.a(new_n152_), .b(new_n79_), .c(x39), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n174_), .O(z14));
  inv1   g120(.a(x12), .O(new_n183_));
  nor2   g121(.a(new_n122_), .b(new_n183_), .O(z15));
  ...
  oai22  g130(.a(new_n90_), .b(x27), .c(new_n119_), .d(new_n192_), .O(new_n193_));
  ...
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n80_), .d(new_n82_), .O(z18));
  inv1   g135(.a(new_n147_), .O(z19));
  nand2  g136(.a(x28), .b(new_n64_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n141_), .d(new_n139_), .O(new_n200_));
  nand2  g138(.a(new_n80_), .b(new_n64_), .O(new_n201_));
  nand2  g139(.a(x39), .b(new_n66_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n201_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n200_), .c(new_n82_), .O(new_n204_));
