...
module FAU ( 
  ...
  oai21  g029(.a(x27), .b(new_n65_), .c(x02), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g031(.a(new_n66_), .b(x28), .c(x04), .O(new_n94_));
  nand3  g032(.a(x28), .b(x27), .c(x04), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n76_), .O(new_n96_));
  nor2   g034(.a(new_n84_), .b(new_n75_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n94_), .d(new_n93_), .O(z02));
  ...
  aoi21  g062(.a(new_n75_), .b(x29), .c(new_n76_), .O(new_n125_));
  nand4  g063(.a(x40), .b(x39), .c(x29), .d(x05), .O(new_n126_));
  ...
  nor3   g070(.a(new_n132_), .b(new_n76_), .c(new_n75_), .O(new_n133_));
  ...
  oai21  g076(.a(new_n64_), .b(new_n65_), .c(new_n138_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  aoi21  g078(.a(x40), .b(new_n81_), .c(x27), .O(new_n141_));
  nand2  g079(.a(new_n66_), .b(x29), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n138_), .c(new_n65_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n141_), .c(new_n91_), .O(new_n144_));
  or2    g082(.a(new_n125_), .b(x35), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n144_), .c(new_n140_), .O(new_n146_));
  ...
  oai22  g090(.a(new_n137_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n152_), .c(new_n82_), .O(z12));
  ...
  nor4   g101(.a(new_n132_), .b(new_n75_), .c(x13), .d(x04), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n81_), .c(x40), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(z13));
  oai21  g104(.a(new_n132_), .b(x13), .c(x29), .O(new_n167_));
  ...
  nand4  g108(.a(new_n156_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n171_));
  ...
  nand2  g130(.a(new_n85_), .b(new_n136_), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n138_), .c(new_n193_), .O(new_n194_));
  nand3  g132(.a(new_n77_), .b(x29), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n194_), .b(new_n84_), .c(new_n195_), .O(z18));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n125_), .O(new_n198_));
  inv1   g136(.a(new_n141_), .O(new_n199_));
  aoi21  g137(.a(new_n142_), .b(new_n199_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n85_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z20));
  nand2  g140(.a(new_n147_), .b(new_n82_), .O(z19));
endmodule
