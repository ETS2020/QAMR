...
module FAU ( 
  ...
  oai21  g040(.a(new_n102_), .b(new_n64_), .c(new_n70_), .O(new_n103_));
  ...
  nor2   g055(.a(new_n117_), .b(new_n76_), .O(z09));
  inv1   g056(.a(x07), .O(new_n119_));
  nor2   g057(.a(x40), .b(x34), .O(new_n120_));
  aoi21  g058(.a(x40), .b(new_n75_), .c(new_n120_), .O(new_n121_));
  nand3  g059(.a(x40), .b(x39), .c(x05), .O(new_n122_));
  oai21  g060(.a(new_n121_), .b(new_n119_), .c(new_n122_), .O(new_n123_));
  nand3  g061(.a(new_n123_), .b(new_n87_), .c(new_n65_), .O(new_n124_));
  nand3  g062(.a(new_n81_), .b(x37), .c(x06), .O(new_n125_));
  ...
  nand3  g071(.a(x35), .b(new_n102_), .c(new_n65_), .O(new_n134_));
  ...
  aoi21  g075(.a(new_n137_), .b(x40), .c(new_n120_), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n85_), .c(new_n138_), .O(new_n140_));
  ...
  nor2   g086(.a(new_n145_), .b(x40), .O(new_n149_));
  ...
  nand4  g102(.a(new_n153_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n165_));
  ...
  nor2   g114(.a(new_n176_), .b(new_n76_), .O(z15));
  ...
  oai21  g123(.a(new_n86_), .b(x27), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n64_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n85_), .c(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n81_), .d(new_n83_), .O(z18));
  nor2   g128(.a(new_n141_), .b(x09), .O(z19));
  oai22  g129(.a(new_n76_), .b(x35), .c(new_n102_), .d(x27), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n137_), .O(new_n193_));
  oai22  g131(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n148_), .O(new_n195_));
  nand2  g133(.a(x35), .b(x27), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(x40), .c(new_n93_), .O(new_n197_));
  nand3  g135(.a(new_n76_), .b(x28), .c(new_n64_), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n197_), .c(new_n195_), .d(new_n193_), .O(new_n199_));
