...
module FAU ( 
  ...
  nand2  g025(.a(new_n87_), .b(new_n83_), .O(new_n88_));
  nand2  g026(.a(x39), .b(new_n76_), .O(new_n89_));
  nand3  g027(.a(new_n89_), .b(new_n88_), .c(new_n86_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(x04), .O(new_n91_));
  nand4  g029(.a(new_n91_), .b(new_n85_), .c(x40), .d(x39), .O(z02));
  nand2  g030(.a(x35), .b(x28), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x27), .O(new_n94_));
  inv1   g032(.a(x37), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n94_), .c(new_n71_), .d(x21), .O(z03));
  inv1   g035(.a(new_n71_), .O(new_n98_));
  aoi21  g036(.a(new_n95_), .b(new_n87_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n94_), .c(new_n98_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n95_), .c(new_n98_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n71_), .c(new_n95_), .O(new_n103_));
  ...
  nand2  g053(.a(new_n115_), .b(new_n71_), .O(z07));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n71_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  ...
  oai21  g070(.a(new_n70_), .b(x29), .c(x40), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(x35), .c(new_n86_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n86_), .c(new_n120_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n71_), .d(new_n87_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(x08), .c(new_n136_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n74_), .c(new_n132_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n71_), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n87_), .c(new_n66_), .O(new_n143_));
  oai22  g081(.a(new_n64_), .b(new_n87_), .c(new_n67_), .d(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n143_), .c(new_n71_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x28), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x40), .c(new_n146_), .d(new_n120_), .O(new_n149_));
  ...
  nand4  g095(.a(new_n126_), .b(x39), .c(new_n146_), .d(new_n120_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x40), .b(new_n146_), .c(new_n120_), .O(new_n160_));
  nand4  g098(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n64_), .c(new_n160_), .O(new_n162_));
  ...
  oai21  g103(.a(new_n165_), .b(new_n86_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n75_), .c(new_n74_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n162_), .c(new_n71_), .O(z14));
  ...
  nand2  g115(.a(x27), .b(new_n120_), .O(new_n178_));
  nand2  g116(.a(new_n87_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n76_), .O(new_n180_));
  nand2  g118(.a(new_n74_), .b(new_n132_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(new_n86_), .c(new_n181_), .O(new_n182_));
  nand4  g120(.a(x40), .b(x39), .c(x29), .d(x08), .O(new_n183_));
  oai21  g121(.a(new_n182_), .b(new_n98_), .c(new_n183_), .O(z18));
  inv1   g122(.a(new_n140_), .O(z19));
  oai21  g123(.a(new_n86_), .b(x27), .c(x35), .O(new_n186_));
  and2   g124(.a(new_n186_), .b(new_n133_), .O(new_n187_));
  nand2  g125(.a(new_n71_), .b(new_n87_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n89_), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n74_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(x09), .O(z20));
