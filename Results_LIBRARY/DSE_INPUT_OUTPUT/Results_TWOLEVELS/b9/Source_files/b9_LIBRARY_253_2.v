...
module FAU ( 
  ...
  nand2  g029(.a(new_n63_), .b(new_n80_), .O(new_n92_));
  ...
  oai21  g038(.a(new_n81_), .b(new_n95_), .c(new_n65_), .O(new_n101_));
  ...
  nand3  g059(.a(new_n121_), .b(new_n83_), .c(x40), .O(new_n122_));
  nor2   g060(.a(x40), .b(x36), .O(new_n123_));
  nand4  g061(.a(new_n123_), .b(x35), .c(new_n81_), .d(x07), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n122_), .c(x04), .O(new_n125_));
  inv1   g063(.a(x06), .O(new_n126_));
  nor3   g064(.a(new_n96_), .b(new_n65_), .c(new_n126_), .O(new_n127_));
  ...
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n64_), .d(new_n95_), .O(new_n137_));
  ...
  nand2  g085(.a(x40), .b(new_n95_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n73_), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n71_), .c(new_n63_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n123_), .c(new_n68_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  inv1   g092(.a(x35), .O(new_n155_));
  oai22  g093(.a(new_n63_), .b(x28), .c(new_n80_), .d(new_n155_), .O(new_n156_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n71_), .c(new_n96_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n162_), .O(z13));
  nand3  g103(.a(x39), .b(new_n154_), .c(new_n71_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x40), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n92_), .O(new_n168_));
  nor2   g106(.a(x19), .b(x18), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n67_), .c(x27), .d(x20), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand2  g109(.a(x40), .b(new_n155_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x36), .O(new_n173_));
  nand3  g111(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n174_));
  nand3  g112(.a(x40), .b(new_n65_), .c(new_n155_), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(new_n176_));
  aoi21  g114(.a(new_n174_), .b(new_n173_), .c(new_n176_), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n81_), .c(new_n148_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n79_), .c(new_n78_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n171_), .O(z14));
  ...
  nand2  g127(.a(new_n95_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n155_), .O(new_n191_));
  nand2  g129(.a(new_n78_), .b(new_n135_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n81_), .c(new_n192_), .O(new_n193_));
  nand3  g131(.a(z08), .b(x29), .c(x08), .O(new_n194_));
  oai21  g132(.a(new_n193_), .b(new_n96_), .c(new_n194_), .O(z18));
  nand2  g133(.a(new_n145_), .b(new_n64_), .O(z19));
  nand2  g134(.a(x28), .b(new_n95_), .O(new_n197_));
  aoi22  g135(.a(new_n197_), .b(x35), .c(new_n139_), .d(new_n92_), .O(new_n198_));
  nand2  g136(.a(new_n64_), .b(new_n95_), .O(new_n199_));
  aoi21  g137(.a(new_n172_), .b(new_n199_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n78_), .O(new_n201_));
