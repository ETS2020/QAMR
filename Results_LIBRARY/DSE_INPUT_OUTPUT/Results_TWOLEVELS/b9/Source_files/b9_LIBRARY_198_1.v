...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(x25), .d(new_n66_), .O(new_n78_));
  ...
  nand3  g051(.a(x38), .b(new_n63_), .c(new_n111_), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(new_n115_));
  oai22  g053(.a(new_n115_), .b(x14), .c(new_n113_), .d(x31), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(x03), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n64_), .O(z07));
  nand3  g056(.a(x40), .b(x39), .c(x25), .O(new_n119_));
  ...
  aoi21  g063(.a(new_n96_), .b(x25), .c(new_n75_), .O(new_n126_));
  nand4  g064(.a(x40), .b(x39), .c(x25), .d(x05), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n85_), .c(new_n124_), .O(new_n129_));
  ...
  nor3   g071(.a(new_n133_), .b(new_n96_), .c(new_n63_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(x05), .c(new_n124_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n132_), .O(z10));
  inv1   g074(.a(x09), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n83_), .c(new_n124_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x25), .c(new_n64_), .d(new_n100_), .O(new_n139_));
  ...
  nand3  g086(.a(new_n148_), .b(new_n80_), .c(new_n137_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n64_), .O(z11));
  nor2   g088(.a(x27), .b(new_n63_), .O(new_n151_));
  nor3   g089(.a(x37), .b(x36), .c(x35), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n74_), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n124_), .c(new_n63_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n75_), .c(new_n71_), .O(new_n155_));
  ...
  nand4  g097(.a(new_n159_), .b(x39), .c(new_n157_), .d(new_n124_), .O(new_n160_));
  inv1   g098(.a(x18), .O(new_n161_));
  inv1   g099(.a(x19), .O(new_n162_));
  nand4  g100(.a(new_n70_), .b(x20), .c(new_n162_), .d(new_n161_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n160_), .c(new_n63_), .O(new_n164_));
  nand4  g102(.a(new_n70_), .b(new_n75_), .c(x20), .d(new_n162_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n134_), .b(new_n157_), .c(new_n124_), .O(new_n168_));
  ...
  nand3  g109(.a(x39), .b(new_n157_), .c(new_n124_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n63_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n75_), .c(new_n170_), .O(new_n175_));
  nand3  g113(.a(new_n68_), .b(new_n143_), .c(x28), .O(new_n176_));
  ...
  nand2  g117(.a(new_n179_), .b(x25), .O(new_n180_));
  nand2  g118(.a(new_n71_), .b(new_n75_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n175_), .O(z14));
  ...
  nor2   g131(.a(new_n100_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n144_), .c(x30), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n64_), .d(new_n137_), .O(z18));
  inv1   g134(.a(new_n149_), .O(z19));
  nor2   g135(.a(new_n83_), .b(x27), .O(new_n198_));
  nor2   g136(.a(x35), .b(new_n63_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n140_), .O(new_n200_));
  inv1   g138(.a(x08), .O(new_n201_));
  aoi21  g139(.a(x35), .b(x27), .c(new_n63_), .O(new_n202_));
  nor2   g140(.a(x40), .b(x27), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n201_), .O(new_n204_));
  oai21  g142(.a(new_n198_), .b(new_n143_), .c(new_n75_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n80_), .c(new_n137_), .O(new_n207_));
