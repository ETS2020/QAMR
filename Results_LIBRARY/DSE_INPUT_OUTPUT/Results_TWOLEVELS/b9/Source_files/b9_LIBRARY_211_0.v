...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(new_n67_), .d(new_n73_), .O(new_n77_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n69_), .c(new_n98_), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n66_), .O(z03));
  nand2  g039(.a(new_n99_), .b(new_n69_), .O(new_n102_));
  nand4  g040(.a(new_n102_), .b(new_n97_), .c(new_n65_), .d(new_n98_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n65_), .c(new_n99_), .O(z05));
  ...
  nor2   g065(.a(new_n99_), .b(new_n69_), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(x06), .c(new_n66_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n127_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(x40), .c(new_n65_), .d(new_n69_), .O(new_n133_));
  nand2  g071(.a(x39), .b(x29), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x40), .O(new_n135_));
  nand2  g073(.a(new_n64_), .b(x13), .O(new_n136_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n79_), .c(new_n131_), .O(new_n142_));
  inv1   g080(.a(new_n142_), .O(z11));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n99_), .b(new_n81_), .c(new_n144_), .O(new_n145_));
  ...
  nand3  g097(.a(new_n124_), .b(x39), .c(new_n73_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x40), .c(x13), .O(new_n161_));
  or2    g099(.a(new_n161_), .b(new_n159_), .O(z13));
  aoi21  g100(.a(x39), .b(new_n73_), .c(new_n64_), .O(new_n163_));
  nand4  g101(.a(x27), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n70_), .c(new_n163_), .d(x13), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n166_));
  nor2   g104(.a(x37), .b(x35), .O(new_n167_));
  aoi21  g105(.a(new_n166_), .b(new_n152_), .c(new_n167_), .O(new_n168_));
  ...
  oai22  g118(.a(new_n93_), .b(new_n180_), .c(new_n83_), .d(x27), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  nor2   g120(.a(new_n144_), .b(x28), .O(new_n183_));
  nor2   g121(.a(new_n69_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n182_), .c(new_n65_), .d(new_n79_), .O(z18));
  nand2  g124(.a(new_n142_), .b(new_n65_), .O(z19));
  nand2  g125(.a(x28), .b(new_n69_), .O(new_n188_));
  aoi22  g126(.a(new_n188_), .b(x35), .c(new_n136_), .d(new_n135_), .O(new_n189_));
  nand2  g127(.a(new_n65_), .b(new_n69_), .O(new_n190_));
  nand2  g128(.a(x40), .b(new_n144_), .O(new_n191_));
