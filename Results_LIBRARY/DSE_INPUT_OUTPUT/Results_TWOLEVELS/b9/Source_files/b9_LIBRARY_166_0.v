...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x36), .O(new_n81_));
  ...
  oai21  g028(.a(new_n85_), .b(new_n81_), .c(new_n90_), .O(z01));
  ...
  oai21  g034(.a(new_n76_), .b(x35), .c(new_n96_), .O(new_n97_));
  oai21  g035(.a(new_n97_), .b(new_n95_), .c(x04), .O(new_n98_));
  nand3  g036(.a(new_n98_), .b(new_n94_), .c(z08), .O(z02));
  ...
  oai22  g045(.a(x40), .b(x36), .c(new_n96_), .d(new_n64_), .O(new_n108_));
  ...
  nor2   g064(.a(x40), .b(new_n124_), .O(new_n127_));
  ...
  nand3  g079(.a(new_n88_), .b(x27), .c(new_n65_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n86_), .c(new_n136_), .O(new_n145_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n76_), .c(x36), .O(new_n152_));
  ...
  nor2   g100(.a(new_n84_), .b(new_n76_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n154_), .d(new_n65_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(new_n82_), .O(z13));
  inv1   g103(.a(new_n71_), .O(new_n166_));
  oai21  g104(.a(new_n75_), .b(x04), .c(x40), .O(new_n167_));
  aoi21  g105(.a(new_n76_), .b(x36), .c(x13), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n167_), .c(new_n166_), .O(new_n169_));
  nand4  g107(.a(new_n66_), .b(new_n87_), .c(new_n86_), .d(x28), .O(new_n170_));
  ...
  nand4  g111(.a(new_n155_), .b(new_n87_), .c(new_n86_), .d(x28), .O(new_n174_));
  ...
  aoi21  g115(.a(x36), .b(x27), .c(x40), .O(new_n178_));
  nor2   g116(.a(new_n84_), .b(new_n75_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n175_), .c(new_n76_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n64_), .c(new_n178_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n177_), .c(new_n172_), .O(z14));
  ...
  nand2  g130(.a(new_n88_), .b(new_n64_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n137_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x08), .O(new_n195_));
  nor2   g133(.a(new_n81_), .b(x30), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n195_), .c(new_n142_), .d(new_n136_), .O(z18));
  inv1   g135(.a(new_n137_), .O(new_n198_));
  oai21  g136(.a(new_n66_), .b(new_n64_), .c(new_n141_), .O(new_n199_));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n199_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n86_), .c(new_n136_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n82_), .O(z20));
  nand2  g141(.a(new_n145_), .b(new_n82_), .O(z19));
endmodule
