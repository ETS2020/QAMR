...
module FAU ( 
  ...
  oai21  g020(.a(new_n82_), .b(new_n69_), .c(new_n80_), .O(new_n83_));
  nor2   g021(.a(new_n66_), .b(new_n74_), .O(new_n84_));
  ...
  nand2  g032(.a(new_n64_), .b(x36), .O(new_n95_));
  ...
  oai21  g058(.a(new_n89_), .b(x28), .c(new_n63_), .O(new_n121_));
  nand3  g059(.a(new_n121_), .b(x39), .c(x05), .O(new_n122_));
  inv1   g060(.a(x28), .O(new_n123_));
  inv1   g061(.a(x39), .O(new_n124_));
  nand4  g062(.a(new_n124_), .b(x35), .c(new_n123_), .d(x07), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n122_), .c(new_n64_), .O(new_n126_));
  nand3  g064(.a(new_n116_), .b(x36), .c(x07), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n126_), .c(new_n74_), .O(new_n129_));
  ...
  nand2  g076(.a(new_n90_), .b(new_n74_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(x40), .c(new_n65_), .d(new_n69_), .O(new_n140_));
  nand2  g078(.a(x39), .b(x29), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x40), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n95_), .O(new_n143_));
  oai21  g081(.a(new_n69_), .b(new_n74_), .c(new_n90_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  oai21  g083(.a(new_n140_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n133_), .O(new_n147_));
  nor2   g085(.a(new_n147_), .b(x09), .O(z11));
  nand3  g086(.a(new_n70_), .b(new_n63_), .c(new_n89_), .O(new_n149_));
  ...
  nand2  g091(.a(new_n153_), .b(x36), .O(new_n154_));
  ...
  inv1   g106(.a(new_n95_), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n170_));
  nand4  g108(.a(new_n157_), .b(new_n80_), .c(new_n133_), .d(x28), .O(new_n171_));
  ...
  nand3  g113(.a(new_n70_), .b(new_n89_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n80_), .c(new_n133_), .O(new_n178_));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n89_), .O(new_n192_));
  inv1   g130(.a(x09), .O(new_n193_));
  nand2  g131(.a(new_n133_), .b(new_n193_), .O(new_n194_));
  aoi21  g132(.a(new_n192_), .b(new_n123_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n66_), .c(new_n116_), .d(new_n87_), .O(z18));
  oai21  g134(.a(new_n147_), .b(x09), .c(new_n65_), .O(z19));
  nand2  g135(.a(x28), .b(new_n69_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n142_), .d(new_n95_), .O(new_n199_));
  nand2  g137(.a(new_n65_), .b(new_n69_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n89_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n200_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n199_), .c(new_n133_), .O(new_n203_));
