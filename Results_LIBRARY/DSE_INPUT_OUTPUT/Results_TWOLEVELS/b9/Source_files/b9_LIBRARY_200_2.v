...
module FAU ( 
  ...
  nor2   g031(.a(x40), .b(x07), .O(new_n94_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n78_), .O(z03));
  ...
  aoi21  g043(.a(new_n64_), .b(new_n99_), .c(new_n88_), .O(new_n106_));
  ...
  aoi21  g066(.a(new_n128_), .b(new_n127_), .c(new_n63_), .O(new_n129_));
  nand3  g067(.a(x37), .b(new_n124_), .c(x06), .O(new_n130_));
  ...
  nand2  g075(.a(new_n64_), .b(new_n99_), .O(new_n138_));
  nand3  g076(.a(x35), .b(new_n88_), .c(new_n71_), .O(new_n139_));
  ...
  aoi21  g081(.a(new_n143_), .b(x40), .c(new_n94_), .O(new_n144_));
  ...
  nand2  g089(.a(z08), .b(new_n71_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n66_), .c(new_n65_), .O(new_n153_));
  aoi21  g091(.a(x27), .b(new_n124_), .c(x40), .O(new_n154_));
  nand2  g092(.a(x40), .b(x04), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x39), .c(x27), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n153_), .c(new_n151_), .O(z12));
  ...
  nand3  g106(.a(new_n135_), .b(new_n159_), .c(new_n71_), .O(new_n169_));
  ...
  nor2   g110(.a(new_n63_), .b(x04), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n172_), .c(x39), .d(new_n159_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  nand3  g113(.a(new_n65_), .b(new_n81_), .c(x28), .O(new_n176_));
  oai21  g114(.a(new_n63_), .b(x27), .c(new_n176_), .O(new_n177_));
  ...
  aoi21  g118(.a(new_n119_), .b(new_n68_), .c(new_n78_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n178_), .d(new_n175_), .O(z14));
  ...
  oai22  g130(.a(new_n119_), .b(new_n192_), .c(new_n89_), .d(x27), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  nor2   g132(.a(new_n99_), .b(x04), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n142_), .c(x09), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n64_), .d(new_n79_), .O(z18));
  oai21  g135(.a(new_n147_), .b(x09), .c(new_n64_), .O(z19));
  aoi21  g136(.a(x28), .b(new_n99_), .c(new_n81_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n144_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n81_), .O(new_n201_));
