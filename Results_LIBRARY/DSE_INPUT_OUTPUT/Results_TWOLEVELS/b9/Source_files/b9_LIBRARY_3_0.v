...
module FAU ( 
  ...
  nor2   g000(.a(x19), .b(x13), .O(new_n63_));
  ...
  oai21  g022(.a(new_n67_), .b(x28), .c(new_n68_), .O(new_n85_));
  ...
  nor2   g029(.a(new_n67_), .b(x28), .O(new_n92_));
  oai21  g030(.a(x27), .b(x08), .c(new_n92_), .O(new_n93_));
  aoi21  g031(.a(new_n93_), .b(x04), .c(new_n76_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n63_), .O(z02));
  nand2  g033(.a(new_n72_), .b(x27), .O(new_n96_));
  inv1   g034(.a(x21), .O(new_n97_));
  aoi21  g035(.a(new_n71_), .b(new_n65_), .c(new_n97_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n63_), .O(z03));
  nand2  g037(.a(new_n71_), .b(new_n65_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n82_), .d(new_n97_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n71_), .c(new_n63_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n82_), .c(new_n71_), .O(new_n104_));
  ...
  nand2  g059(.a(new_n76_), .b(x07), .O(new_n122_));
  ...
  nand2  g063(.a(new_n84_), .b(new_n83_), .O(new_n126_));
  ...
  aoi21  g068(.a(new_n130_), .b(new_n129_), .c(new_n63_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(new_n77_), .b(x29), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n92_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand3  g075(.a(new_n92_), .b(x27), .c(new_n66_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(new_n82_), .c(new_n83_), .d(new_n132_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n82_), .O(z11));
  inv1   g080(.a(x10), .O(new_n143_));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n65_), .c(new_n143_), .O(new_n145_));
  oai22  g083(.a(new_n76_), .b(x04), .c(new_n74_), .d(new_n65_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n82_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n118_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n66_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand4  g091(.a(new_n73_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n126_), .b(x40), .c(x39), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(x04), .c(x19), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n148_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z13));
  oai21  g098(.a(new_n126_), .b(new_n153_), .c(new_n148_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n65_), .O(new_n162_));
  nand4  g100(.a(new_n149_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n77_), .c(new_n148_), .d(new_n66_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x19), .O(new_n165_));
  nand3  g103(.a(new_n73_), .b(x20), .c(new_n152_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x13), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n165_), .c(new_n162_), .O(z14));
  inv1   g106(.a(x12), .O(new_n169_));
  nand4  g107(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n170_));
  nor2   g108(.a(new_n170_), .b(new_n169_), .O(z15));
  inv1   g109(.a(x23), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(x22), .c(x01), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n82_), .O(z16));
  inv1   g112(.a(x24), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(x23), .c(x22), .d(x01), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n82_), .O(z17));
  nand2  g115(.a(new_n92_), .b(new_n65_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n133_), .O(new_n179_));
  nand3  g117(.a(new_n138_), .b(new_n83_), .c(new_n132_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(x08), .c(new_n180_), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n63_), .O(z18));
  inv1   g120(.a(new_n141_), .O(z19));
  inv1   g121(.a(new_n133_), .O(new_n184_));
  oai21  g122(.a(new_n67_), .b(new_n65_), .c(new_n137_), .O(new_n185_));
  aoi21  g123(.a(x28), .b(new_n65_), .c(new_n67_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n185_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n82_), .c(new_n83_), .d(new_n132_), .O(new_n188_));
