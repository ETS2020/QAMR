...
module FAU ( 
  ...
  nand4  g041(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n64_), .O(z03));
  nand3  g042(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z04));
  nor2   g043(.a(new_n99_), .b(new_n65_), .O(z05));
  ...
  nand2  g056(.a(new_n95_), .b(new_n64_), .O(z08));
  ...
  nor2   g062(.a(x40), .b(x21), .O(new_n125_));
  ...
  nand3  g084(.a(new_n69_), .b(new_n81_), .c(new_n92_), .O(new_n147_));
  ...
  nand4  g100(.a(new_n160_), .b(new_n98_), .c(x20), .d(new_n159_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n134_), .b(new_n154_), .c(new_n73_), .O(new_n166_));
  ...
  nand3  g111(.a(new_n69_), .b(new_n92_), .c(x28), .O(new_n174_));
  ...
  oai22  g126(.a(new_n95_), .b(new_n89_), .c(new_n83_), .d(x27), .O(new_n189_));
  ...
  aoi21  g133(.a(new_n137_), .b(new_n93_), .c(x08), .O(new_n196_));
