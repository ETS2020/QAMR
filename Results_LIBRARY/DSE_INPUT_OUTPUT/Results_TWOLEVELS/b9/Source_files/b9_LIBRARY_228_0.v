...
module FAU ( 
  ...
  nand2  g036(.a(new_n76_), .b(x39), .O(new_n99_));
  ...
  oai21  g047(.a(x40), .b(x39), .c(new_n93_), .O(new_n110_));
  ...
  aoi21  g062(.a(x35), .b(new_n93_), .c(x36), .O(new_n125_));
  ...
  nor3   g068(.a(new_n83_), .b(new_n70_), .c(new_n130_), .O(new_n131_));
  ...
  oai21  g075(.a(new_n132_), .b(new_n64_), .c(new_n137_), .O(z10));
  nand3  g076(.a(x35), .b(new_n93_), .c(new_n65_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x39), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n109_), .c(x08), .O(new_n141_));
  nand2  g079(.a(x40), .b(new_n75_), .O(new_n142_));
  nand2  g080(.a(x40), .b(x29), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(x39), .O(new_n144_));
  nand2  g082(.a(x27), .b(x04), .O(new_n145_));
  aoi22  g083(.a(new_n145_), .b(new_n86_), .c(new_n144_), .d(new_n142_), .O(new_n146_));
  ...
  inv1   g090(.a(new_n99_), .O(new_n153_));
  ...
  nand3  g094(.a(new_n156_), .b(new_n152_), .c(new_n81_), .O(z12));
  ...
  oai21  g116(.a(new_n173_), .b(new_n76_), .c(new_n99_), .O(new_n179_));
  aoi22  g117(.a(new_n179_), .b(new_n154_), .c(new_n178_), .d(new_n84_), .O(new_n180_));
  ...
  aoi21  g133(.a(new_n193_), .b(new_n93_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n83_), .c(new_n91_), .d(new_n190_), .O(z18));
  oai22  g135(.a(new_n75_), .b(x35), .c(new_n93_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n143_), .O(new_n199_));
  oai21  g137(.a(new_n75_), .b(x08), .c(new_n142_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n66_), .O(new_n201_));
  nor2   g139(.a(new_n83_), .b(x08), .O(new_n202_));
  nor2   g140(.a(x39), .b(new_n93_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n64_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n84_), .c(new_n194_), .O(new_n206_));
