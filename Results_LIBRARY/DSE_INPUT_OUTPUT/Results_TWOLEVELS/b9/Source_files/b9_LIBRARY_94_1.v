...
module FAU ( 
  ...
  oai21  g027(.a(new_n89_), .b(new_n78_), .c(x27), .O(new_n90_));
  ...
  aoi21  g062(.a(new_n76_), .b(new_n75_), .c(new_n67_), .O(new_n125_));
  ...
  aoi22  g071(.a(new_n133_), .b(x39), .c(new_n71_), .d(new_n91_), .O(new_n134_));
  ...
  aoi21  g090(.a(new_n76_), .b(new_n75_), .c(x13), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n117_), .c(new_n70_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n67_), .c(new_n152_), .O(z13));
  nor2   g093(.a(new_n67_), .b(x04), .O(new_n156_));
  oai21  g094(.a(new_n153_), .b(new_n70_), .c(new_n156_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n91_), .O(new_n158_));
  nand3  g096(.a(x40), .b(new_n143_), .c(new_n117_), .O(new_n159_));
  nand3  g097(.a(x20), .b(new_n148_), .c(new_n147_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n64_), .c(new_n159_), .O(new_n161_));
  nand2  g099(.a(new_n160_), .b(new_n144_), .O(new_n162_));
  oai21  g100(.a(x37), .b(x35), .c(new_n162_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(new_n76_), .c(new_n75_), .d(x28), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(new_n161_), .c(new_n158_), .d(new_n71_), .O(z14));
  ...
  inv1   g111(.a(x29), .O(new_n174_));
  oai22  g112(.a(new_n79_), .b(x27), .c(new_n67_), .d(new_n174_), .O(new_n175_));
  ...
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n71_), .d(new_n75_), .O(z18));
  inv1   g117(.a(new_n136_), .O(z19));
  oai21  g118(.a(new_n78_), .b(x27), .c(x35), .O(new_n181_));
  and2   g119(.a(new_n181_), .b(new_n129_), .O(new_n182_));
  nand2  g120(.a(new_n71_), .b(new_n91_), .O(new_n183_));
  nand2  g121(.a(x39), .b(new_n89_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n182_), .c(new_n75_), .O(new_n186_));
