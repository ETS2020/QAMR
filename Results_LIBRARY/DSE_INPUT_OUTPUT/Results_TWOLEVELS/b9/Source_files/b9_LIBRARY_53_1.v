...
module FAU ( 
  ...
  oai21  g033(.a(x28), .b(new_n92_), .c(x04), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n74_), .c(new_n79_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n94_), .d(new_n91_), .O(z02));
  nand2  g036(.a(new_n67_), .b(x27), .O(new_n99_));
  inv1   g037(.a(x21), .O(new_n100_));
  aoi21  g038(.a(new_n66_), .b(new_n92_), .c(new_n100_), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n79_), .O(z03));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n66_), .c(new_n79_), .O(z05));
  nand3  g044(.a(new_n105_), .b(new_n64_), .c(new_n66_), .O(new_n107_));
  ...
  aoi21  g072(.a(x39), .b(new_n134_), .c(new_n74_), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n133_), .c(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n64_), .b(new_n92_), .O(new_n138_));
  ...
  inv1   g084(.a(new_n68_), .O(new_n147_));
  oai22  g085(.a(new_n147_), .b(new_n92_), .c(new_n74_), .d(x04), .O(new_n148_));
  ...
  aoi21  g096(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n72_), .c(new_n63_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n74_), .c(new_n158_), .O(z13));
  nor2   g099(.a(new_n74_), .b(x04), .O(new_n162_));
  oai21  g100(.a(new_n159_), .b(new_n63_), .c(new_n162_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n92_), .O(new_n164_));
  nand3  g102(.a(x40), .b(new_n150_), .c(new_n72_), .O(new_n165_));
  nand3  g103(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n147_), .c(new_n165_), .O(new_n167_));
  nand2  g105(.a(new_n166_), .b(new_n151_), .O(new_n168_));
  oai21  g106(.a(x37), .b(x35), .c(new_n168_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n167_), .c(new_n164_), .d(new_n64_), .O(z14));
  ...
  oai22  g117(.a(new_n84_), .b(x27), .c(new_n74_), .d(new_n134_), .O(new_n180_));
  ...
  aoi21  g123(.a(x28), .b(new_n92_), .c(new_n185_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n135_), .O(new_n187_));
  nand2  g125(.a(x39), .b(new_n185_), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n138_), .c(x08), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n80_), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(x09), .O(z20));
  buf    g129(.a(x40), .O(z08));
  nor2   g130(.a(new_n142_), .b(x09), .O(z19));
endmodule
