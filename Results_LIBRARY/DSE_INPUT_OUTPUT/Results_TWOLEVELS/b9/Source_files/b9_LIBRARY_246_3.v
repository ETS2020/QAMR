...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n94_, new_n95_, new_n97_, new_n100_, new_n101_, new_n103_,
  ...
  nand2  g016(.a(x28), .b(x27), .O(new_n79_));
  aoi21  g017(.a(new_n79_), .b(x35), .c(x36), .O(new_n80_));
  oai21  g018(.a(new_n80_), .b(new_n68_), .c(new_n78_), .O(new_n81_));
  inv1   g019(.a(x04), .O(new_n82_));
  nor2   g020(.a(new_n65_), .b(new_n82_), .O(new_n83_));
  oai21  g021(.a(new_n81_), .b(x30), .c(new_n83_), .O(z01));
  ...
  oai21  g026(.a(new_n88_), .b(new_n86_), .c(x04), .O(new_n89_));
  nand2  g027(.a(new_n89_), .b(x39), .O(new_n90_));
  oai21  g028(.a(new_n90_), .b(new_n85_), .c(new_n63_), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x40), .O(z02));
  nand2  g030(.a(new_n70_), .b(x27), .O(new_n93_));
  inv1   g031(.a(x21), .O(new_n94_));
  aoi21  g032(.a(new_n69_), .b(new_n68_), .c(new_n94_), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n93_), .c(new_n65_), .O(z03));
  aoi21  g034(.a(new_n69_), .b(new_n68_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n93_), .c(new_n65_), .O(z04));
  aoi21  g036(.a(new_n79_), .b(new_n69_), .c(new_n65_), .O(z05));
  inv1   g037(.a(new_n65_), .O(new_n100_));
  nand3  g038(.a(new_n79_), .b(new_n100_), .c(new_n69_), .O(new_n101_));
  ...
  nand3  g064(.a(new_n126_), .b(new_n122_), .c(x27), .O(new_n127_));
  inv1   g065(.a(x30), .O(new_n128_));
  nand2  g066(.a(new_n78_), .b(new_n128_), .O(new_n129_));
  ...
  aoi21  g071(.a(new_n133_), .b(x06), .c(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(z10));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  nor2   g074(.a(new_n68_), .b(new_n82_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n88_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand4  g077(.a(x35), .b(new_n87_), .c(x27), .d(new_n82_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n128_), .c(new_n63_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n100_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n68_), .c(new_n73_), .O(new_n146_));
  inv1   g084(.a(new_n71_), .O(new_n147_));
  oai21  g085(.a(new_n123_), .b(x04), .c(new_n147_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n100_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n64_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n150_), .d(new_n82_), .O(new_n153_));
  ...
  nand4  g097(.a(new_n129_), .b(x39), .c(new_n150_), .d(new_n82_), .O(new_n160_));
  ...
  nand4  g102(.a(new_n151_), .b(new_n78_), .c(new_n128_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  nand4  g104(.a(x40), .b(x39), .c(new_n150_), .d(new_n82_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  inv1   g106(.a(x35), .O(new_n169_));
  nand3  g107(.a(new_n69_), .b(new_n169_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n78_), .c(new_n128_), .O(new_n172_));
  aoi21  g110(.a(new_n167_), .b(new_n147_), .c(new_n65_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n168_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n100_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(x22), .c(x01), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n100_), .O(z16));
  inv1   g117(.a(x01), .O(new_n180_));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n100_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  nand3  g121(.a(x35), .b(new_n87_), .c(new_n68_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n136_), .c(new_n139_), .O(new_n185_));
  nand2  g123(.a(new_n140_), .b(new_n128_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(new_n63_), .O(new_n187_));
  oai21  g125(.a(x40), .b(new_n63_), .c(new_n187_), .O(z18));
  inv1   g126(.a(new_n143_), .O(z19));
  inv1   g127(.a(new_n136_), .O(new_n190_));
  oai21  g128(.a(new_n169_), .b(new_n68_), .c(new_n139_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n68_), .c(new_n169_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n128_), .c(new_n63_), .O(new_n194_));
