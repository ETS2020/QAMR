...
module FAU ( 
  ...
  nand2  g017(.a(x40), .b(x33), .O(new_n80_));
  ...
  nand3  g030(.a(new_n92_), .b(new_n91_), .c(new_n90_), .O(new_n93_));
  nor2   g031(.a(x27), .b(x08), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n85_), .c(x04), .O(new_n95_));
  inv1   g033(.a(x40), .O(new_n96_));
  nor2   g034(.a(new_n96_), .b(x33), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n93_), .d(x39), .O(z02));
  ...
  nand3  g048(.a(new_n110_), .b(new_n108_), .c(new_n91_), .O(new_n111_));
  ...
  nand3  g055(.a(x40), .b(x39), .c(new_n91_), .O(new_n118_));
  ...
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n102_), .O(new_n132_));
  ...
  nand2  g076(.a(new_n84_), .b(x27), .O(new_n139_));
  oai21  g077(.a(x33), .b(new_n65_), .c(x35), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n139_), .c(new_n138_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n137_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n82_), .c(new_n134_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n80_), .O(z11));
  inv1   g082(.a(x10), .O(new_n145_));
  nor2   g083(.a(x33), .b(x27), .O(new_n146_));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n145_), .O(new_n148_));
  nand2  g086(.a(new_n76_), .b(new_n65_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n71_), .c(new_n70_), .O(new_n150_));
  nor2   g088(.a(x33), .b(new_n65_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n75_), .c(new_n64_), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(new_n150_), .c(new_n148_), .d(new_n80_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n96_), .O(new_n156_));
  ...
  nand4  g100(.a(new_n127_), .b(x39), .c(new_n154_), .d(new_n65_), .O(new_n163_));
  ...
  inv1   g104(.a(x20), .O(new_n167_));
  nor2   g105(.a(new_n146_), .b(new_n167_), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n72_), .c(new_n159_), .d(new_n158_), .O(new_n169_));
  oai21  g107(.a(x13), .b(x04), .c(new_n169_), .O(new_n170_));
  nand4  g108(.a(x27), .b(x20), .c(new_n159_), .d(new_n158_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n73_), .c(new_n75_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n173_));
  nor2   g111(.a(x37), .b(x35), .O(new_n174_));
  aoi21  g112(.a(new_n173_), .b(new_n155_), .c(new_n174_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n84_), .c(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n83_), .c(new_n82_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n172_), .c(new_n170_), .d(new_n80_), .O(z14));
  ...
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n80_), .d(new_n82_), .O(z18));
  inv1   g130(.a(new_n135_), .O(new_n193_));
  oai21  g131(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n82_), .c(new_n134_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n80_), .O(z20));
  nand2  g136(.a(new_n143_), .b(new_n80_), .O(z19));
endmodule
