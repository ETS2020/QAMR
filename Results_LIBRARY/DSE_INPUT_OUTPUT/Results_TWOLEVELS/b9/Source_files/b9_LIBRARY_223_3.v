...
module FAU ( 
  ...
  aoi21  g21(.a(new_n83_), .b(new_n79_), .c(z08), .O(z04));
  ...
  nand2  g40(.a(new_n102_), .b(z02), .O(z09));
  ...
  nand4  g63(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n126_));
  nor2   g64(.a(new_n126_), .b(new_n125_), .O(z15));
  ...
  nand2  g71(.a(new_n64_), .b(x08), .O(new_n134_));
  oai21  g72(.a(new_n64_), .b(x04), .c(new_n134_), .O(new_n135_));
  ...
  oai21  g77(.a(new_n112_), .b(new_n72_), .c(z02), .O(new_n140_));
  oai21  g78(.a(new_n111_), .b(x27), .c(new_n140_), .O(new_n141_));
