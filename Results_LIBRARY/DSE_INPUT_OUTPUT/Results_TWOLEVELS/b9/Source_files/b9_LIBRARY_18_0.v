...
module FAU ( 
  ...
  nand2  g032(.a(new_n79_), .b(x05), .O(new_n95_));
  ...
  aoi21  g042(.a(new_n80_), .b(new_n64_), .c(new_n84_), .O(new_n105_));
  ...
  nand3  g064(.a(new_n126_), .b(new_n86_), .c(new_n65_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n122_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x27), .O(new_n129_));
  nand2  g067(.a(new_n83_), .b(new_n82_), .O(new_n130_));
  ...
  oai21  g078(.a(new_n124_), .b(new_n140_), .c(x40), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n95_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(new_n82_), .O(new_n144_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n79_), .c(x05), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n79_), .O(new_n155_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n65_), .c(new_n100_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n161_), .O(z13));
  oai21  g102(.a(new_n124_), .b(x04), .c(x40), .O(new_n165_));
  aoi21  g103(.a(new_n79_), .b(x05), .c(x13), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n165_), .c(x35), .d(x28), .O(new_n167_));
  nand4  g105(.a(new_n66_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(new_n70_), .O(new_n170_));
  nand3  g108(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n171_));
  nand4  g109(.a(new_n154_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n172_));
  nor2   g110(.a(new_n124_), .b(x13), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n172_), .c(x40), .d(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  aoi21  g113(.a(x27), .b(x05), .c(x40), .O(new_n176_));
  nand3  g114(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x40), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n130_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n64_), .c(new_n176_), .O(new_n180_));
  ...
  nand2  g123(.a(new_n185_), .b(new_n80_), .O(z16));
  inv1   g124(.a(x01), .O(new_n187_));
  inv1   g125(.a(x24), .O(new_n188_));
  nand4  g126(.a(new_n80_), .b(new_n188_), .c(x23), .d(x22), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n187_), .O(z17));
  oai22  g128(.a(new_n85_), .b(x27), .c(new_n118_), .d(new_n140_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n139_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n192_), .c(new_n80_), .d(new_n82_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n196_));
  aoi21  g134(.a(new_n141_), .b(new_n95_), .c(new_n196_), .O(new_n197_));
  ...
  nor2   g139(.a(new_n144_), .b(x09), .O(z19));
endmodule
