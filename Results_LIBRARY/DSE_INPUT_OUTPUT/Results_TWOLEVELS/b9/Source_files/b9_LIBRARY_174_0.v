...
module FAU ( 
  ...
  nand2  g033(.a(new_n74_), .b(x25), .O(new_n96_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n63_), .O(z03));
  ...
  aoi21  g044(.a(new_n79_), .b(new_n100_), .c(new_n83_), .O(new_n107_));
  ...
  nand3  g051(.a(x40), .b(new_n113_), .c(x00), .O(new_n114_));
  oai21  g052(.a(new_n63_), .b(x38), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g056(.a(x38), .b(new_n118_), .c(new_n74_), .O(new_n119_));
  ...
  aoi21  g080(.a(x39), .b(x29), .c(new_n74_), .O(new_n143_));
  aoi21  g081(.a(new_n74_), .b(x25), .c(new_n143_), .O(new_n144_));
  ...
  nand3  g087(.a(new_n66_), .b(new_n82_), .c(new_n149_), .O(new_n150_));
  ...
  nand3  g091(.a(new_n69_), .b(new_n74_), .c(x25), .O(new_n154_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n159_), .c(new_n74_), .O(new_n163_));
  nand4  g101(.a(new_n68_), .b(x25), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n136_), .b(new_n156_), .c(new_n72_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  oai21  g106(.a(new_n122_), .b(x04), .c(x40), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n96_), .c(new_n156_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n69_), .O(new_n171_));
  nand3  g109(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n172_));
  nand4  g110(.a(new_n157_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(z08), .c(new_n156_), .d(new_n72_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand3  g113(.a(new_n66_), .b(new_n149_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n80_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n175_), .c(new_n171_), .d(new_n79_), .O(z14));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n149_), .O(new_n192_));
  ...
  oai22  g133(.a(new_n195_), .b(new_n63_), .c(new_n189_), .d(new_n90_), .O(z18));
  aoi21  g134(.a(x28), .b(new_n100_), .c(new_n149_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n144_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n149_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n139_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n80_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z20));
  nor2   g140(.a(new_n147_), .b(x09), .O(z19));
endmodule
