...
module FAU ( 
  ...
  aoi22  g052(.a(new_n114_), .b(x38), .c(x17), .d(new_n65_), .O(new_n115_));
  nand4  g053(.a(new_n115_), .b(new_n75_), .c(new_n112_), .d(new_n111_), .O(new_n116_));
  nand2  g054(.a(x38), .b(new_n113_), .O(new_n117_));
  oai21  g055(.a(new_n117_), .b(x00), .c(new_n73_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n116_), .c(new_n110_), .O(z07));
  nand3  g057(.a(x40), .b(x39), .c(new_n73_), .O(new_n120_));
  ...
  nor2   g086(.a(x27), .b(x14), .O(new_n149_));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n74_), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n90_), .c(x14), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n75_), .c(new_n70_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n151_), .c(new_n63_), .O(z12));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(x14), .O(new_n162_));
  nand4  g100(.a(new_n69_), .b(new_n75_), .c(x20), .d(new_n160_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand4  g103(.a(new_n132_), .b(new_n73_), .c(new_n155_), .d(new_n90_), .O(new_n166_));
  ...
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(x14), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n75_), .c(new_n168_), .O(new_n173_));
  nand3  g111(.a(new_n67_), .b(new_n91_), .c(x28), .O(new_n174_));
  ...
  nand2  g115(.a(new_n177_), .b(new_n73_), .O(new_n178_));
  nand2  g116(.a(new_n70_), .b(new_n75_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n178_), .c(new_n173_), .O(z14));
  nand4  g118(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n63_), .O(z15));
  ...
  nand2  g127(.a(x27), .b(new_n90_), .O(new_n190_));
  nand2  g128(.a(new_n101_), .b(x08), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n91_), .O(new_n192_));
  nand2  g130(.a(new_n80_), .b(new_n138_), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n83_), .c(new_n193_), .O(new_n194_));
  inv1   g132(.a(new_n140_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n73_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n194_), .b(new_n64_), .c(new_n196_), .O(z18));
  oai21  g135(.a(new_n91_), .b(new_n101_), .c(new_n143_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n101_), .c(new_n91_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n195_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n138_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n63_), .O(z20));
  nand2  g140(.a(new_n147_), .b(new_n63_), .O(z19));
endmodule
