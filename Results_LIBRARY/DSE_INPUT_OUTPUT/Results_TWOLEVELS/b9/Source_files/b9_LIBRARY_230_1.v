...
module FAU ( 
  ...
  nand3  g031(.a(new_n66_), .b(new_n93_), .c(x04), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(x40), .O(z02));
  nand2  g033(.a(new_n68_), .b(x27), .O(new_n96_));
  nand3  g034(.a(new_n64_), .b(new_n67_), .c(new_n66_), .O(new_n97_));
  ...
  aoi21  g062(.a(new_n81_), .b(new_n80_), .c(new_n75_), .O(new_n125_));
  ...
  nand3  g068(.a(new_n130_), .b(x35), .c(new_n83_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n83_), .c(new_n73_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x39), .c(new_n64_), .d(new_n66_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(x08), .c(new_n132_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n80_), .c(new_n128_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(z11));
  inv1   g075(.a(x35), .O(new_n138_));
  nand3  g076(.a(new_n67_), .b(new_n82_), .c(new_n138_), .O(new_n139_));
  ...
  oai21  g080(.a(new_n69_), .b(x40), .c(new_n142_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x40), .c(new_n144_), .d(new_n73_), .O(new_n147_));
  ...
  nand2  g090(.a(new_n81_), .b(new_n80_), .O(new_n153_));
  ...
  nand4  g119(.a(new_n181_), .b(new_n178_), .c(new_n64_), .d(new_n80_), .O(z18));
  nand2  g120(.a(new_n136_), .b(new_n64_), .O(z19));
  aoi22  g121(.a(new_n176_), .b(x28), .c(new_n64_), .d(new_n93_), .O(new_n184_));
  nand2  g122(.a(new_n90_), .b(x39), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x40), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n138_), .O(new_n187_));
  oai21  g125(.a(new_n184_), .b(x27), .c(new_n187_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n80_), .c(new_n128_), .O(new_n189_));
