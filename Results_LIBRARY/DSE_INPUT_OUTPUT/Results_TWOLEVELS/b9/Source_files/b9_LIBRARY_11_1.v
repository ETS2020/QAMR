// Benchmark "FAU" written by ABC on Tue Aug 18 17:25:53 2020
...
module FAU ( 
  ...
  oai21  g021(.a(new_n83_), .b(new_n69_), .c(x40), .O(new_n84_));
  inv1   g022(.a(x27), .O(new_n85_));
  inv1   g023(.a(x04), .O(new_n86_));
  oai21  g024(.a(x08), .b(new_n86_), .c(x40), .O(new_n87_));
  nand2  g025(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand2  g026(.a(new_n78_), .b(x04), .O(new_n89_));
  inv1   g027(.a(x40), .O(new_n90_));
  oai21  g028(.a(x28), .b(new_n85_), .c(x04), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand4  g030(.a(new_n92_), .b(new_n89_), .c(new_n88_), .d(new_n84_), .O(z02));
  nand2  g031(.a(x35), .b(x28), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x37), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(new_n85_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n70_), .d(x21), .O(z03));
  aoi21  g036(.a(new_n96_), .b(new_n85_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(new_n73_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n70_), .c(new_n96_), .O(z05));
  ...
  nand3  g046(.a(new_n108_), .b(new_n106_), .c(new_n104_), .O(new_n109_));
  ...
  aoi21  g063(.a(new_n75_), .b(new_n74_), .c(new_n90_), .O(new_n126_));
  nand4  g064(.a(new_n126_), .b(x39), .c(x05), .d(new_n86_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(z10));
  inv1   g066(.a(new_n78_), .O(new_n129_));
  inv1   g067(.a(x29), .O(new_n130_));
  aoi21  g068(.a(x39), .b(new_n130_), .c(new_n90_), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n129_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n70_), .b(new_n85_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n77_), .c(new_n86_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x39), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n134_), .c(x08), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n133_), .c(new_n74_), .O(new_n138_));
  nor2   g076(.a(new_n138_), .b(x09), .O(z11));
  nor2   g077(.a(new_n64_), .b(new_n85_), .O(new_n140_));
  inv1   g078(.a(x35), .O(new_n141_));
  nand3  g079(.a(new_n96_), .b(new_n76_), .c(new_n141_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x27), .c(x10), .O(new_n143_));
  nor2   g081(.a(new_n140_), .b(new_n86_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x39), .O(new_n145_));
  oai21  g083(.a(new_n140_), .b(x40), .c(new_n145_), .O(z12));
  inv1   g084(.a(x13), .O(new_n147_));
  nand2  g085(.a(x36), .b(x35), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x28), .O(new_n149_));
  nand4  g087(.a(new_n149_), .b(x40), .c(new_n147_), .d(new_n86_), .O(new_n150_));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand2  g090(.a(new_n94_), .b(new_n96_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n150_), .c(new_n85_), .O(new_n155_));
  nand2  g093(.a(new_n75_), .b(new_n74_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n147_), .c(new_n86_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x39), .c(new_n90_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n155_), .O(z13));
  nand2  g097(.a(x39), .b(x04), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(x40), .c(new_n147_), .O(new_n161_));
  oai21  g099(.a(new_n64_), .b(new_n85_), .c(new_n161_), .O(new_n162_));
  nand3  g100(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n163_));
  nand4  g101(.a(new_n148_), .b(new_n75_), .c(new_n74_), .d(x28), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x40), .c(new_n147_), .d(new_n86_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand3  g104(.a(new_n96_), .b(new_n141_), .c(x28), .O(new_n167_));
  oai21  g105(.a(new_n69_), .b(x27), .c(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n75_), .c(new_n74_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n166_), .c(new_n162_), .d(new_n70_), .O(z14));
  nand4  g108(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n70_), .O(z15));
  inv1   g110(.a(x23), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(x22), .c(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n70_), .O(z16));
  inv1   g113(.a(x01), .O(new_n176_));
  inv1   g114(.a(x24), .O(new_n177_));
  nand4  g115(.a(new_n70_), .b(new_n177_), .c(x23), .d(x22), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n176_), .O(z17));
  oai22  g117(.a(new_n78_), .b(x27), .c(new_n90_), .d(new_n130_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n85_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n129_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n70_), .d(new_n74_), .O(z18));
  inv1   g122(.a(x09), .O(new_n185_));
  aoi21  g123(.a(x40), .b(new_n69_), .c(x08), .O(new_n186_));
  aoi21  g124(.a(x40), .b(x29), .c(new_n77_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n85_), .O(new_n188_));
  aoi21  g126(.a(x29), .b(x08), .c(new_n69_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n90_), .c(new_n141_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n74_), .c(new_n185_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n70_), .O(z20));
  nor2   g131(.a(new_n138_), .b(x09), .O(z19));
endmodule
