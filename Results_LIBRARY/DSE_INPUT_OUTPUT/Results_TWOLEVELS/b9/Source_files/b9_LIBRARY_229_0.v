...
module FAU ( 
  ...
  oai21  g036(.a(x40), .b(new_n80_), .c(new_n98_), .O(z02));
  ...
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n82_), .d(new_n64_), .O(new_n137_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n81_), .c(x39), .O(new_n153_));
  ...
  nand3  g103(.a(new_n128_), .b(new_n155_), .c(new_n65_), .O(new_n166_));
  ...
  nand4  g107(.a(new_n169_), .b(z08), .c(new_n155_), .d(new_n65_), .O(new_n170_));
  ...
  aoi21  g112(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n175_));
  oai21  g113(.a(x40), .b(new_n80_), .c(new_n155_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n175_), .c(new_n152_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n174_), .c(new_n171_), .d(new_n82_), .O(z14));
  ...
  nand2  g127(.a(new_n84_), .b(new_n135_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n86_), .c(new_n190_), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n103_), .c(new_n93_), .d(new_n75_), .O(z18));
  nand2  g130(.a(new_n146_), .b(new_n82_), .O(z19));
  oai22  g131(.a(new_n80_), .b(x35), .c(new_n86_), .d(x27), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n138_), .O(new_n195_));
  oai21  g133(.a(new_n80_), .b(x08), .c(new_n140_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n66_), .O(new_n197_));
  nor2   g135(.a(new_n103_), .b(x08), .O(new_n198_));
  nor2   g136(.a(x39), .b(new_n86_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n64_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n197_), .c(new_n195_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n84_), .c(new_n135_), .O(new_n202_));
