...
module FAU ( 
  ...
  nand2  g078(.a(new_n81_), .b(x31), .O(new_n141_));
  ...
  aoi21  g092(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n155_));
  ...
  nand3  g104(.a(new_n129_), .b(x40), .c(x39), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(x13), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n65_), .c(new_n84_), .O(new_n169_));
  ...
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(new_n81_), .O(new_n175_));
  ...
  nand3  g116(.a(new_n178_), .b(new_n86_), .c(new_n85_), .O(new_n179_));
  ...
  nand3  g120(.a(new_n154_), .b(new_n81_), .c(x31), .O(new_n183_));
  ...
  nand2  g133(.a(new_n85_), .b(new_n136_), .O(new_n196_));
  aoi21  g134(.a(new_n195_), .b(new_n87_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n84_), .c(new_n94_), .d(new_n75_), .O(z18));
  inv1   g136(.a(new_n147_), .O(z19));
  nand2  g137(.a(x28), .b(new_n64_), .O(new_n200_));
  aoi22  g138(.a(new_n200_), .b(x35), .c(new_n141_), .d(new_n140_), .O(new_n201_));
  ...
  oai21  g142(.a(new_n204_), .b(new_n201_), .c(new_n85_), .O(new_n205_));
