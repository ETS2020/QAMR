...
module FAU ( 
  ...
  oai22  g041(.a(x40), .b(x24), .c(new_n85_), .d(new_n64_), .O(new_n104_));
  ...
  nand2  g061(.a(new_n79_), .b(x24), .O(new_n124_));
  ...
  oai21  g065(.a(new_n127_), .b(new_n125_), .c(new_n87_), .O(new_n128_));
  nand3  g066(.a(new_n80_), .b(x37), .c(x06), .O(new_n129_));
  ...
  nand2  g073(.a(new_n80_), .b(new_n64_), .O(new_n136_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n140_), .c(x40), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n124_), .O(new_n143_));
  ...
  aoi22  g088(.a(x39), .b(new_n65_), .c(x35), .d(x28), .O(new_n151_));
  nand2  g089(.a(new_n85_), .b(x24), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x35), .c(x40), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n70_), .O(new_n154_));
  aoi21  g092(.a(x27), .b(x24), .c(x40), .O(new_n155_));
  oai21  g093(.a(new_n79_), .b(new_n65_), .c(x39), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n64_), .c(new_n155_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n154_), .c(new_n150_), .O(z12));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n162_), .c(new_n79_), .O(new_n166_));
  nand4  g104(.a(new_n72_), .b(x24), .c(x20), .d(new_n164_), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(x18), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n166_), .c(x27), .O(new_n169_));
  nand3  g107(.a(new_n133_), .b(new_n159_), .c(new_n65_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(z13));
  nand3  g109(.a(x20), .b(new_n164_), .c(new_n163_), .O(new_n172_));
  nand4  g110(.a(new_n160_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n173_));
  ...
  nand2  g116(.a(new_n178_), .b(new_n148_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n84_), .c(new_n83_), .O(new_n180_));
  inv1   g118(.a(new_n174_), .O(new_n181_));
  oai21  g119(.a(new_n149_), .b(new_n73_), .c(new_n181_), .O(new_n182_));
  oai21  g120(.a(new_n177_), .b(new_n64_), .c(new_n117_), .O(new_n183_));
  nand2  g121(.a(new_n124_), .b(x39), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n70_), .c(new_n85_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n183_), .c(new_n80_), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n182_), .c(new_n180_), .d(new_n176_), .O(z14));
  inv1   g126(.a(x12), .O(new_n189_));
  nand4  g127(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n190_));
  ...
  nor3   g133(.a(new_n195_), .b(new_n79_), .c(x24), .O(z17));
  oai22  g134(.a(new_n86_), .b(x27), .c(new_n117_), .d(new_n140_), .O(new_n197_));
  ...
  oai21  g139(.a(new_n144_), .b(x09), .c(new_n80_), .O(z19));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  aoi21  g141(.a(new_n141_), .b(new_n124_), .c(new_n203_), .O(new_n204_));
