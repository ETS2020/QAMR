...
module FAU ( 
  ...
  nor2   g016(.a(x40), .b(new_n78_), .O(new_n79_));
  ...
  aoi21  g029(.a(x28), .b(x04), .c(new_n63_), .O(new_n92_));
  oai21  g030(.a(x27), .b(x08), .c(x35), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x04), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(x39), .O(z02));
  ...
  aoi21  g039(.a(new_n98_), .b(new_n66_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n101_), .O(z04));
  nand3  g041(.a(new_n64_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g042(.a(new_n79_), .b(new_n98_), .c(new_n104_), .O(z05));
  aoi21  g043(.a(new_n64_), .b(new_n66_), .c(new_n83_), .O(new_n106_));
  ...
  oai21  g056(.a(new_n63_), .b(x37), .c(new_n83_), .O(new_n119_));
  nor4   g057(.a(new_n119_), .b(new_n63_), .c(x37), .d(new_n72_), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(new_n78_), .O(z08));
  ...
  oai21  g072(.a(new_n63_), .b(x29), .c(x39), .O(new_n135_));
  ...
  nand3  g076(.a(x35), .b(new_n83_), .c(new_n72_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(x40), .c(new_n64_), .d(new_n66_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n98_), .b(new_n82_), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n83_), .c(new_n144_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(x37), .c(x27), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x04), .c(new_n146_), .O(new_n149_));
  oai22  g087(.a(new_n149_), .b(new_n63_), .c(new_n68_), .d(x39), .O(z12));
  ...
  nand2  g094(.a(new_n96_), .b(new_n98_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n154_), .c(new_n66_), .O(new_n159_));
  nand3  g097(.a(new_n128_), .b(new_n151_), .c(new_n72_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x40), .c(new_n78_), .O(new_n161_));
  or2    g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nand2  g100(.a(new_n83_), .b(x04), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(x37), .c(x40), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x39), .O(new_n165_));
  nand4  g103(.a(x27), .b(x20), .c(new_n156_), .d(new_n155_), .O(new_n166_));
  oai22  g104(.a(new_n166_), .b(new_n67_), .c(new_n78_), .d(x13), .O(new_n167_));
  aoi21  g105(.a(new_n98_), .b(new_n144_), .c(new_n66_), .O(new_n168_));
  oai22  g106(.a(new_n168_), .b(new_n72_), .c(new_n128_), .d(x27), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x40), .O(new_n170_));
  nand3  g108(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n171_));
  nand4  g109(.a(new_n152_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n72_), .O(new_n173_));
  nor2   g111(.a(x30), .b(new_n83_), .O(new_n174_));
  nor3   g112(.a(x37), .b(x35), .c(x32), .O(new_n175_));
  aoi22  g113(.a(new_n175_), .b(new_n174_), .c(new_n173_), .d(new_n171_), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n170_), .c(new_n167_), .d(new_n165_), .O(z14));
  inv1   g115(.a(x12), .O(new_n178_));
  nand4  g116(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n179_));
  ...
  oai21  g125(.a(new_n84_), .b(x27), .c(new_n187_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  inv1   g127(.a(new_n84_), .O(new_n190_));
  nor2   g128(.a(new_n66_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n189_), .c(new_n64_), .d(new_n80_), .O(z18));
  inv1   g131(.a(new_n142_), .O(z19));
  inv1   g132(.a(x08), .O(new_n195_));
  aoi22  g133(.a(new_n187_), .b(x28), .c(new_n64_), .d(new_n195_), .O(new_n196_));
  nand2  g134(.a(new_n90_), .b(x40), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(x39), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n144_), .O(new_n199_));
  oai21  g137(.a(new_n196_), .b(x27), .c(new_n199_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n80_), .c(new_n134_), .O(new_n201_));
