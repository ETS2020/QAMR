...
module FAU ( 
  ...
  nand3  g23(.a(new_n86_), .b(new_n63_), .c(new_n67_), .O(z05));
  ...
  aoi21  g49(.a(new_n66_), .b(new_n112_), .c(new_n73_), .O(new_n113_));
  aoi21  g50(.a(x27), .b(x04), .c(x28), .O(new_n114_));
  oai21  g51(.a(new_n113_), .b(z08), .c(new_n114_), .O(new_n115_));
  ...
  nand2  g55(.a(new_n68_), .b(new_n67_), .O(new_n119_));
  nand4  g56(.a(new_n119_), .b(new_n63_), .c(x27), .d(x20), .O(new_n120_));
  nor3   g57(.a(new_n120_), .b(x19), .c(x18), .O(z13));
  nor2   g58(.a(x19), .b(x18), .O(new_n122_));
  nand4  g59(.a(new_n122_), .b(new_n69_), .c(new_n63_), .d(x20), .O(z14));
  ...
  oai21  g75(.a(x28), .b(new_n112_), .c(new_n66_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(x35), .O(new_n140_));
  nand4  g77(.a(new_n140_), .b(new_n63_), .c(new_n72_), .d(new_n111_), .O(new_n141_));
  inv1   g78(.a(new_n141_), .O(z20));
  one    g79(.O(z02));
  nand2  g80(.a(new_n116_), .b(new_n63_), .O(z19));
endmodule
