...
module FAU ( 
  ...
  aoi21  g021(.a(x29), .b(x08), .c(new_n69_), .O(new_n84_));
  ...
  aoi21  g037(.a(new_n70_), .b(new_n92_), .c(new_n77_), .O(new_n100_));
  ...
  aoi21  g064(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n127_));
  ...
  nand3  g072(.a(x35), .b(new_n77_), .c(new_n119_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n70_), .d(new_n92_), .O(new_n136_));
  ...
  nand3  g079(.a(new_n93_), .b(new_n76_), .c(new_n141_), .O(new_n142_));
  ...
  nand2  g090(.a(new_n89_), .b(new_n93_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n150_), .c(new_n92_), .O(new_n155_));
  inv1   g093(.a(x39), .O(new_n156_));
  nand2  g094(.a(new_n75_), .b(new_n74_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n147_), .c(new_n119_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x40), .c(new_n156_), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n155_), .O(z13));
  aoi21  g098(.a(new_n147_), .b(new_n119_), .c(new_n69_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .d(new_n156_), .O(new_n163_));
  ...
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n141_), .O(new_n180_));
  nand2  g118(.a(new_n74_), .b(new_n130_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(new_n77_), .c(new_n181_), .O(new_n182_));
  nand3  g120(.a(z08), .b(x29), .c(x08), .O(new_n183_));
  oai21  g121(.a(new_n182_), .b(new_n73_), .c(new_n183_), .O(z18));
  inv1   g122(.a(new_n138_), .O(z19));
  aoi21  g123(.a(new_n69_), .b(x39), .c(x08), .O(new_n186_));
  aoi21  g124(.a(x39), .b(x29), .c(new_n77_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n92_), .O(new_n188_));
  oai21  g126(.a(new_n84_), .b(new_n156_), .c(new_n141_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n74_), .c(new_n130_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n70_), .O(z20));
endmodule
