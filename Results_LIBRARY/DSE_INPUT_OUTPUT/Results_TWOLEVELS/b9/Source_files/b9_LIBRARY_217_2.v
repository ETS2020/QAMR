...
module FAU ( 
  ...
  aoi21  g031(.a(new_n93_), .b(new_n91_), .c(new_n73_), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n89_), .c(x40), .O(new_n95_));
  nor2   g033(.a(x19), .b(x18), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(x35), .c(x28), .d(x20), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(x35), .c(x28), .O(new_n98_));
  nand3  g036(.a(new_n96_), .b(x27), .c(x20), .O(new_n99_));
  aoi21  g037(.a(new_n98_), .b(x27), .c(new_n99_), .O(new_n100_));
  oai21  g038(.a(new_n100_), .b(x39), .c(new_n95_), .O(z02));
  nand2  g039(.a(new_n68_), .b(x27), .O(new_n102_));
  nand2  g040(.a(new_n67_), .b(new_n66_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n102_), .c(new_n64_), .d(x21), .O(z03));
  aoi21  g042(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n105_));
  aoi21  g043(.a(new_n105_), .b(new_n102_), .c(new_n79_), .O(z04));
  nand2  g044(.a(x28), .b(x27), .O(new_n107_));
  nand3  g045(.a(new_n107_), .b(new_n64_), .c(new_n67_), .O(z05));
  ...
  nor2   g075(.a(new_n66_), .b(new_n73_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n84_), .c(new_n137_), .O(new_n139_));
  nand3  g077(.a(new_n91_), .b(x27), .c(new_n73_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n67_), .b(new_n82_), .c(new_n90_), .O(new_n145_));
  ...
  oai21  g086(.a(new_n69_), .b(x39), .c(new_n148_), .O(z12));
  ...
  nor2   g099(.a(new_n129_), .b(new_n63_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x39), .c(new_n150_), .d(new_n73_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n161_), .O(z13));
  nand2  g102(.a(x40), .b(x04), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(x39), .c(new_n150_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n68_), .O(new_n167_));
  nand4  g105(.a(new_n90_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n168_));
  ...
  nand4  g109(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(x39), .c(new_n150_), .d(new_n73_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  nor2   g112(.a(new_n129_), .b(x13), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n73_), .c(new_n63_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n128_), .c(new_n66_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n174_), .c(new_n170_), .d(new_n64_), .O(z14));
  ...
  oai21  g124(.a(new_n84_), .b(x27), .c(new_n137_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n79_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n140_), .d(new_n136_), .O(z18));
  inv1   g128(.a(new_n137_), .O(new_n191_));
  oai21  g129(.a(new_n90_), .b(new_n66_), .c(new_n92_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n66_), .c(new_n90_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n80_), .c(new_n136_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n64_), .O(z20));
  buf    g134(.a(x39), .O(z08));
  nand2  g135(.a(new_n143_), .b(new_n64_), .O(z19));
endmodule
