...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x12), .O(new_n81_));
  ...
  nand2  g036(.a(new_n76_), .b(x12), .O(new_n99_));
  ...
  nand4  g043(.a(new_n105_), .b(new_n101_), .c(new_n82_), .d(new_n102_), .O(z04));
  aoi21  g044(.a(x28), .b(x27), .c(x37), .O(new_n107_));
  nor2   g045(.a(new_n107_), .b(new_n81_), .O(z05));
  aoi21  g046(.a(new_n82_), .b(new_n64_), .c(new_n86_), .O(new_n109_));
  oai21  g047(.a(new_n109_), .b(x37), .c(new_n82_), .O(z06));
  ...
  aoi21  g063(.a(new_n125_), .b(new_n99_), .c(new_n124_), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x05), .O(new_n127_));
  inv1   g065(.a(new_n127_), .O(new_n128_));
  oai21  g066(.a(new_n128_), .b(new_n126_), .c(new_n88_), .O(new_n129_));
  ...
  inv1   g087(.a(new_n99_), .O(new_n150_));
  ...
  nor2   g101(.a(new_n161_), .b(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n134_), .b(new_n155_), .c(new_n65_), .O(new_n166_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n150_), .c(new_n168_), .O(new_n173_));
  ...
  nand3  g117(.a(new_n151_), .b(new_n76_), .c(x12), .O(new_n180_));
  ...
  oai22  g135(.a(new_n197_), .b(new_n81_), .c(new_n93_), .d(new_n191_), .O(z18));
  nor2   g136(.a(new_n145_), .b(x09), .O(z19));
  nand2  g137(.a(x28), .b(new_n64_), .O(new_n200_));
  aoi22  g138(.a(new_n200_), .b(x35), .c(new_n142_), .d(new_n99_), .O(new_n201_));
