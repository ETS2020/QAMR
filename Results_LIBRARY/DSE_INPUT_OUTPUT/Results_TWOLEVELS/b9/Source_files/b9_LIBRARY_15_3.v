...
module FAU ( 
  ...
  nand2  g018(.a(x40), .b(x02), .O(new_n81_));
  ...
  nor2   g033(.a(new_n83_), .b(new_n75_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n95_), .c(new_n92_), .d(x40), .O(z02));
  ...
  nor2   g043(.a(new_n83_), .b(x27), .O(new_n106_));
  oai21  g044(.a(new_n106_), .b(new_n90_), .c(new_n70_), .O(new_n107_));
  ...
  nor2   g072(.a(x32), .b(x30), .O(new_n135_));
  nor3   g073(.a(new_n135_), .b(new_n76_), .c(new_n75_), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(x05), .c(new_n65_), .d(new_n120_), .O(new_n137_));
  oai21  g075(.a(new_n134_), .b(new_n64_), .c(new_n137_), .O(z10));
  inv1   g076(.a(x09), .O(new_n139_));
  nand2  g077(.a(new_n86_), .b(new_n65_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n120_), .c(new_n106_), .O(new_n141_));
  aoi21  g079(.a(x39), .b(x29), .c(x02), .O(new_n142_));
  nor2   g080(.a(new_n64_), .b(new_n65_), .O(new_n143_));
  oai22  g081(.a(new_n143_), .b(new_n91_), .c(new_n142_), .d(new_n76_), .O(new_n144_));
  oai21  g082(.a(new_n141_), .b(x08), .c(new_n144_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n84_), .c(new_n139_), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(z11));
  inv1   g085(.a(x10), .O(new_n148_));
  nor2   g086(.a(x27), .b(x02), .O(new_n149_));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n148_), .O(new_n151_));
  inv1   g089(.a(new_n77_), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n153_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(x02), .O(new_n162_));
  ...
  nand4  g103(.a(new_n136_), .b(new_n155_), .c(new_n65_), .d(new_n120_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(z13));
  oai21  g105(.a(new_n135_), .b(x13), .c(new_n120_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n77_), .c(new_n65_), .O(new_n169_));
  ...
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n77_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  inv1   g113(.a(new_n71_), .O(new_n176_));
  aoi21  g114(.a(new_n173_), .b(new_n77_), .c(new_n176_), .O(new_n177_));
  nand4  g115(.a(new_n66_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n177_), .c(new_n70_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n175_), .c(new_n170_), .d(new_n81_), .O(z14));
  ...
  oai22  g128(.a(new_n91_), .b(x27), .c(new_n152_), .d(new_n94_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n86_), .c(x30), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n192_), .c(new_n81_), .d(new_n139_), .O(z18));
  nor2   g133(.a(new_n90_), .b(x27), .O(new_n196_));
  nor2   g134(.a(x35), .b(x02), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n196_), .c(new_n75_), .d(new_n94_), .O(new_n198_));
  aoi21  g136(.a(x35), .b(x27), .c(x02), .O(new_n199_));
  nor2   g137(.a(x40), .b(x27), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n93_), .O(new_n201_));
  oai21  g139(.a(new_n196_), .b(new_n66_), .c(new_n76_), .O(new_n202_));
