...
module FAU ( 
  ...
  aoi21  g041(.a(new_n80_), .b(new_n64_), .c(new_n85_), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(x37), .c(new_n80_), .O(z06));
  ...
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n82_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x39), .c(new_n80_), .d(new_n64_), .O(new_n134_));
  nand2  g072(.a(x40), .b(x29), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x39), .O(new_n136_));
  nand2  g074(.a(x40), .b(new_n78_), .O(new_n137_));
  ...
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n79_), .O(new_n156_));
  ...
  nand3  g116(.a(new_n150_), .b(x40), .c(new_n78_), .O(new_n179_));
  ...
  oai22  g128(.a(new_n86_), .b(x27), .c(new_n117_), .d(new_n190_), .O(new_n191_));
  ...
  nand4  g133(.a(new_n195_), .b(new_n192_), .c(new_n80_), .d(new_n83_), .O(z18));
  inv1   g134(.a(new_n143_), .O(z19));
  oai22  g135(.a(new_n78_), .b(x35), .c(new_n85_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n135_), .O(new_n199_));
  nor2   g137(.a(new_n78_), .b(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n149_), .c(new_n66_), .O(new_n201_));
  nor2   g139(.a(new_n82_), .b(x08), .O(new_n202_));
  nor2   g140(.a(x39), .b(new_n85_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n64_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n83_), .c(new_n132_), .O(new_n206_));
