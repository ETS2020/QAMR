...
module FAU ( 
  ...
  oai21  g030(.a(new_n79_), .b(new_n84_), .c(x35), .O(new_n93_));
  ...
  nand2  g042(.a(new_n104_), .b(new_n79_), .O(new_n105_));
  ...
  oai21  g052(.a(x40), .b(new_n79_), .c(new_n84_), .O(new_n115_));
  ...
  nand3  g080(.a(new_n142_), .b(x39), .c(x05), .O(new_n143_));
  ...
  aoi21  g087(.a(x40), .b(new_n149_), .c(new_n79_), .O(new_n150_));
  nand2  g088(.a(x27), .b(x04), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n148_), .c(new_n150_), .O(new_n152_));
  oai21  g090(.a(new_n85_), .b(x04), .c(x40), .O(new_n153_));
  ...
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(x40), .O(new_n171_));
  aoi21  g109(.a(new_n68_), .b(new_n67_), .c(x39), .O(new_n172_));
  ...
  aoi21  g113(.a(new_n82_), .b(new_n81_), .c(new_n63_), .O(new_n176_));
  ...
  nand3  g119(.a(x40), .b(new_n157_), .c(new_n82_), .O(new_n182_));
  ...
  aoi21  g150(.a(new_n90_), .b(x40), .c(new_n79_), .O(new_n213_));
