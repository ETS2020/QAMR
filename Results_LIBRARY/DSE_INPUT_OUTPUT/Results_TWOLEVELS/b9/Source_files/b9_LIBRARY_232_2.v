...
module FAU ( 
  ...
  nor2   g062(.a(new_n124_), .b(new_n67_), .O(new_n125_));
  ...
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n71_), .d(new_n90_), .O(new_n134_));
  ...
  oai21  g077(.a(new_n70_), .b(new_n116_), .c(x39), .O(new_n140_));
  ...
  nand2  g123(.a(x40), .b(new_n185_), .O(new_n186_));
