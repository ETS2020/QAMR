...
module FAU ( 
  ...
  nand2  g51(.a(new_n81_), .b(new_n114_), .O(new_n115_));
  nand4  g52(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n112_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(new_n117_));
  inv1   g54(.a(new_n117_), .O(z11));
  aoi21  g55(.a(new_n68_), .b(x27), .c(z08), .O(z12));
  nand4  g56(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n120_));
  ...
  aoi21  g61(.a(new_n124_), .b(new_n68_), .c(z08), .O(z14));
  ...
  nand2  g75(.a(new_n117_), .b(new_n63_), .O(z19));
  oai21  g76(.a(x28), .b(new_n114_), .c(new_n81_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g78(.a(new_n141_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(new_n142_));
