...
module FAU ( 
  ...
  oai21  g045(.a(x40), .b(new_n93_), .c(new_n85_), .O(new_n108_));
  ...
  nand2  g061(.a(new_n76_), .b(new_n93_), .O(new_n124_));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n139_), .c(new_n125_), .d(x29), .O(new_n141_));
  oai21  g079(.a(new_n86_), .b(x04), .c(x40), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n107_), .c(x08), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n141_), .c(new_n83_), .O(new_n144_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n76_), .c(new_n93_), .O(new_n151_));
  ...
  nand3  g103(.a(new_n165_), .b(new_n124_), .c(new_n153_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n150_), .O(new_n167_));
  nand3  g105(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n168_));
  nand4  g106(.a(new_n154_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(z08), .c(new_n153_), .d(new_n65_), .O(new_n170_));
  ...
  nand4  g112(.a(new_n174_), .b(new_n171_), .c(new_n167_), .d(new_n81_), .O(z14));
  ...
  nand2  g123(.a(x39), .b(x29), .O(new_n186_));
  ...
  aoi21  g127(.a(new_n189_), .b(new_n139_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n81_), .d(new_n83_), .O(z18));
  aoi22  g129(.a(new_n186_), .b(x28), .c(new_n81_), .d(new_n92_), .O(new_n192_));
  aoi21  g130(.a(x39), .b(x08), .c(new_n76_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n93_), .c(new_n66_), .O(new_n194_));
  oai21  g132(.a(new_n192_), .b(x27), .c(new_n194_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n83_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(x09), .c(new_n81_), .O(z20));
  nor2   g135(.a(new_n144_), .b(x09), .O(z19));
endmodule
