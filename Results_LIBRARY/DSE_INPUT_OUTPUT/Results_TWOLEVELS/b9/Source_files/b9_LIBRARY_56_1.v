...
module FAU ( 
  ...
  inv1   g013(.a(x22), .O(new_n76_));
  nor2   g014(.a(new_n76_), .b(x13), .O(new_n77_));
  ...
  nand3  g035(.a(new_n94_), .b(new_n97_), .c(new_n64_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n94_), .d(x21), .O(z03));
  nor2   g037(.a(new_n77_), .b(x21), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n98_), .c(new_n96_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n77_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n94_), .c(new_n97_), .O(new_n104_));
  ...
  nand3  g053(.a(new_n115_), .b(new_n94_), .c(x03), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(z07));
  inv1   g055(.a(x39), .O(new_n118_));
  inv1   g056(.a(x40), .O(new_n119_));
  nor3   g057(.a(new_n77_), .b(new_n119_), .c(new_n118_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n94_), .O(z09));
  nand2  g060(.a(new_n89_), .b(x07), .O(new_n123_));
  ...
  nand3  g069(.a(new_n131_), .b(new_n130_), .c(new_n94_), .O(z10));
  inv1   g070(.a(x08), .O(new_n133_));
  oai21  g071(.a(new_n66_), .b(new_n64_), .c(new_n133_), .O(new_n134_));
  nand3  g072(.a(x40), .b(x39), .c(x29), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n66_), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n134_), .c(new_n77_), .O(new_n137_));
  inv1   g075(.a(new_n135_), .O(new_n138_));
  nor2   g076(.a(x28), .b(x04), .O(new_n139_));
  aoi21  g077(.a(x27), .b(x04), .c(x28), .O(new_n140_));
  oai22  g078(.a(new_n140_), .b(new_n138_), .c(new_n139_), .d(x08), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n137_), .c(new_n80_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(x09), .c(new_n94_), .O(z11));
  ...
  oai22  g084(.a(new_n89_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(new_n146_), .c(new_n77_), .O(z12));
  ...
  oai21  g097(.a(new_n159_), .b(x04), .c(new_n76_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n149_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  nor2   g101(.a(new_n89_), .b(x04), .O(new_n164_));
  nand4  g102(.a(new_n150_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n164_), .c(x22), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(x13), .c(new_n163_), .O(new_n167_));
  nand3  g105(.a(new_n97_), .b(new_n66_), .c(x28), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x27), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n81_), .c(new_n80_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n147_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n76_), .O(new_n172_));
  oai21  g110(.a(new_n70_), .b(new_n64_), .c(x13), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n167_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n94_), .O(z15));
  nand3  g114(.a(x22), .b(x13), .c(x01), .O(new_n177_));
  ...
  aoi21  g123(.a(new_n185_), .b(new_n90_), .c(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n184_), .c(new_n94_), .d(new_n181_), .O(z18));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n138_), .c(new_n134_), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n94_), .c(new_n80_), .d(new_n181_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z20));
  oai21  g129(.a(new_n142_), .b(x09), .c(new_n94_), .O(z19));
endmodule
