...
module FAU ( 
  ...
  inv1   g031(.a(new_n64_), .O(new_n94_));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n95_), .c(new_n94_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n64_), .c(new_n67_), .O(z05));
  aoi21  g040(.a(new_n64_), .b(new_n66_), .c(new_n82_), .O(new_n103_));
  ...
  nand2  g060(.a(new_n80_), .b(new_n79_), .O(new_n123_));
  ...
  oai21  g067(.a(new_n63_), .b(x29), .c(x39), .O(new_n130_));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x35), .c(new_n82_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x40), .c(new_n64_), .d(new_n66_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(x08), .c(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n79_), .c(new_n129_), .O(new_n137_));
  inv1   g075(.a(new_n137_), .O(z11));
  inv1   g076(.a(x35), .O(new_n139_));
  nand3  g077(.a(new_n67_), .b(new_n81_), .c(new_n139_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x27), .c(x10), .O(new_n141_));
  nor2   g079(.a(new_n69_), .b(new_n73_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n141_), .c(x40), .O(new_n143_));
  oai21  g081(.a(new_n69_), .b(x39), .c(new_n143_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x39), .c(new_n145_), .d(new_n73_), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nand2  g088(.a(new_n68_), .b(new_n67_), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n148_), .c(new_n63_), .O(new_n153_));
  inv1   g091(.a(x39), .O(new_n154_));
  nand4  g092(.a(new_n151_), .b(new_n154_), .c(x20), .d(new_n150_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n153_), .c(x27), .O(new_n157_));
  aoi21  g095(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n145_), .d(new_n73_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  aoi21  g098(.a(new_n145_), .b(new_n73_), .c(new_n63_), .O(new_n161_));
  nor2   g099(.a(x19), .b(x18), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n151_), .c(x27), .d(x20), .O(new_n163_));
  oai21  g101(.a(new_n161_), .b(new_n154_), .c(new_n163_), .O(new_n164_));
  nand3  g102(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n165_));
  nor2   g103(.a(x37), .b(x35), .O(new_n166_));
  aoi21  g104(.a(new_n165_), .b(new_n146_), .c(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n82_), .c(x27), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(x40), .c(new_n80_), .d(new_n79_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n164_), .O(z14));
  inv1   g108(.a(x12), .O(new_n171_));
  nor2   g109(.a(new_n117_), .b(new_n171_), .O(z15));
  ...
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n139_), .O(new_n181_));
  nand2  g119(.a(new_n79_), .b(new_n129_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n82_), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(x40), .b(x39), .O(new_n184_));
  oai22  g122(.a(new_n184_), .b(new_n89_), .c(new_n183_), .d(new_n94_), .O(z18));
  nand2  g123(.a(new_n137_), .b(new_n64_), .O(z19));
  oai21  g124(.a(new_n82_), .b(x27), .c(x35), .O(new_n187_));
  and2   g125(.a(new_n187_), .b(new_n130_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n66_), .O(new_n189_));
  nand2  g127(.a(x40), .b(new_n139_), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n188_), .c(new_n79_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z20));
  buf    g131(.a(x39), .O(z08));
endmodule
