...
module FAU ( 
  ...
  nand4  g16(.a(new_n78_), .b(x35), .c(x28), .d(x20), .O(new_n79_));
  nand3  g17(.a(new_n79_), .b(x35), .c(x28), .O(new_n80_));
  nand2  g18(.a(new_n80_), .b(x27), .O(new_n81_));
  nand3  g19(.a(new_n78_), .b(x27), .c(x20), .O(new_n82_));
  inv1   g20(.a(new_n82_), .O(new_n83_));
  aoi21  g21(.a(new_n83_), .b(new_n81_), .c(z08), .O(z02));
  nand2  g22(.a(new_n67_), .b(x27), .O(new_n85_));
  inv1   g23(.a(x27), .O(new_n86_));
  nand2  g24(.a(new_n66_), .b(new_n86_), .O(new_n87_));
  nand4  g25(.a(new_n87_), .b(new_n85_), .c(new_n63_), .d(x21), .O(z03));
  aoi21  g26(.a(new_n66_), .b(new_n86_), .c(x21), .O(new_n89_));
  aoi21  g27(.a(new_n89_), .b(new_n85_), .c(z08), .O(z04));
  nand2  g28(.a(x28), .b(x27), .O(new_n91_));
  nand3  g29(.a(new_n91_), .b(new_n63_), .c(new_n66_), .O(z05));
  ...
  nand2  g43(.a(new_n105_), .b(new_n63_), .O(z07));
  ...
  nand2  g50(.a(new_n112_), .b(x27), .O(new_n113_));
  nand2  g51(.a(new_n113_), .b(new_n63_), .O(z10));
  inv1   g52(.a(x09), .O(new_n115_));
  inv1   g53(.a(x28), .O(new_n116_));
  nand2  g54(.a(x27), .b(x04), .O(new_n117_));
  inv1   g55(.a(x08), .O(new_n118_));
  nand2  g56(.a(new_n86_), .b(new_n118_), .O(new_n119_));
  nand4  g57(.a(new_n119_), .b(new_n117_), .c(x35), .d(new_n116_), .O(new_n120_));
  nand4  g58(.a(new_n120_), .b(new_n63_), .c(new_n71_), .d(new_n115_), .O(new_n121_));
  inv1   g59(.a(new_n121_), .O(z11));
  nand3  g60(.a(new_n68_), .b(new_n63_), .c(x27), .O(z12));
  nand4  g61(.a(new_n68_), .b(new_n63_), .c(x27), .d(x20), .O(new_n124_));
  nor3   g62(.a(new_n124_), .b(x19), .c(x18), .O(z13));
  aoi21  g63(.a(new_n83_), .b(new_n68_), .c(z08), .O(z14));
  ...
  nand2  g69(.a(new_n131_), .b(new_n63_), .O(z16));
  ...
  oai21  g74(.a(x27), .b(new_n118_), .c(new_n136_), .O(new_n137_));
  nand3  g75(.a(new_n137_), .b(x35), .c(new_n116_), .O(new_n138_));
  nand4  g76(.a(new_n138_), .b(new_n63_), .c(new_n71_), .d(new_n115_), .O(z18));
  oai21  g77(.a(x28), .b(new_n118_), .c(new_n86_), .O(new_n140_));
  nand2  g78(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g79(.a(new_n141_), .b(new_n63_), .c(new_n71_), .d(new_n115_), .O(new_n142_));
  inv1   g80(.a(new_n142_), .O(z20));
  inv1   g81(.a(new_n121_), .O(z19));
endmodule
