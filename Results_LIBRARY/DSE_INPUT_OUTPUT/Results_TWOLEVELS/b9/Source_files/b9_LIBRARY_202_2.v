...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x00), .O(new_n81_));
  ...
  nor2   g035(.a(x40), .b(x00), .O(new_n98_));
  ...
  nor2   g045(.a(new_n107_), .b(new_n104_), .O(z05));
  inv1   g046(.a(x00), .O(new_n109_));
  oai22  g047(.a(x40), .b(new_n109_), .c(new_n85_), .d(new_n64_), .O(new_n110_));
  nor2   g048(.a(new_n110_), .b(x37), .O(z06));
  inv1   g049(.a(x03), .O(new_n112_));
  inv1   g050(.a(x31), .O(new_n113_));
  inv1   g051(.a(x33), .O(new_n114_));
  nand2  g052(.a(x17), .b(new_n63_), .O(new_n115_));
  inv1   g053(.a(x25), .O(new_n116_));
  nand3  g054(.a(x40), .b(new_n116_), .c(x00), .O(new_n117_));
  oai21  g055(.a(new_n104_), .b(x38), .c(new_n117_), .O(new_n118_));
  nand4  g056(.a(new_n118_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n119_));
  inv1   g057(.a(x14), .O(new_n120_));
  aoi21  g058(.a(x38), .b(new_n116_), .c(x00), .O(new_n121_));
  nor2   g059(.a(new_n76_), .b(new_n109_), .O(new_n122_));
  oai21  g060(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n119_), .c(new_n112_), .O(z07));
  inv1   g062(.a(new_n77_), .O(new_n125_));
  nand2  g063(.a(new_n81_), .b(new_n125_), .O(z08));
  inv1   g064(.a(x11), .O(new_n127_));
  nand4  g065(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  nor2   g066(.a(new_n128_), .b(new_n127_), .O(z09));
  inv1   g067(.a(x07), .O(new_n130_));
  aoi21  g068(.a(x40), .b(new_n75_), .c(new_n98_), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x05), .O(new_n132_));
  oai21  g070(.a(new_n131_), .b(new_n130_), .c(new_n132_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n87_), .c(new_n65_), .O(new_n134_));
  ...
  nor2   g076(.a(new_n138_), .b(new_n75_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(x05), .c(new_n65_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n137_), .O(z10));
  nand2  g079(.a(new_n81_), .b(new_n64_), .O(new_n142_));
  oai21  g080(.a(new_n86_), .b(x04), .c(x40), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(new_n142_), .c(x08), .O(new_n144_));
  inv1   g082(.a(new_n86_), .O(new_n145_));
  nand2  g083(.a(x27), .b(x04), .O(new_n146_));
  nand2  g084(.a(x39), .b(x29), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x40), .c(new_n98_), .O(new_n148_));
  ...
  oai22  g092(.a(new_n73_), .b(new_n64_), .c(new_n75_), .d(x04), .O(new_n155_));
  oai21  g093(.a(x28), .b(x00), .c(x35), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n70_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(x27), .c(new_n109_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n76_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n155_), .c(new_n154_), .O(z12));
  inv1   g098(.a(x19), .O(new_n161_));
  nand4  g099(.a(new_n81_), .b(new_n72_), .c(x20), .d(new_n161_), .O(new_n162_));
  inv1   g100(.a(x13), .O(new_n163_));
  nand2  g101(.a(x36), .b(x35), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x28), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x40), .c(x39), .d(new_n163_), .O(new_n166_));
  oai22  g104(.a(new_n166_), .b(x04), .c(new_n162_), .d(x18), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x27), .O(new_n168_));
  nand3  g106(.a(new_n139_), .b(new_n163_), .c(new_n65_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(z13));
  nand2  g108(.a(x20), .b(new_n161_), .O(new_n171_));
  nand4  g109(.a(new_n164_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n77_), .c(new_n163_), .d(new_n65_), .O(new_n173_));
  oai21  g111(.a(new_n171_), .b(x18), .c(new_n173_), .O(new_n174_));
  ...
  nand3  g115(.a(x39), .b(new_n163_), .c(new_n65_), .O(new_n178_));
  oai21  g116(.a(new_n73_), .b(new_n64_), .c(new_n178_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n177_), .c(new_n174_), .d(new_n159_), .O(z14));
  nand4  g118(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n81_), .O(z15));
  ...
  nand4  g125(.a(new_n81_), .b(new_n187_), .c(x23), .d(x22), .O(new_n188_));
  ...
  oai22  g133(.a(new_n195_), .b(new_n104_), .c(new_n92_), .d(new_n125_), .O(z18));
  nor2   g134(.a(x40), .b(x35), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n94_), .c(new_n109_), .O(new_n198_));
  ...
  nand2  g139(.a(new_n77_), .b(x29), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(x28), .c(new_n64_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n201_), .c(new_n198_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n83_), .c(new_n193_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n81_), .O(z20));
  nor2   g144(.a(new_n150_), .b(x09), .O(z19));
endmodule
