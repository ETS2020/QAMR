...
module FAU ( 
  ...
  aoi21  g036(.a(new_n98_), .b(new_n93_), .c(new_n88_), .O(z05));
  nand3  g037(.a(new_n98_), .b(new_n70_), .c(new_n93_), .O(new_n100_));
  ...
  oai21  g067(.a(new_n69_), .b(x29), .c(x40), .O(new_n130_));
  nand2  g068(.a(x27), .b(x04), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x35), .c(new_n76_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n76_), .c(new_n117_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x39), .c(new_n70_), .d(new_n92_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(x08), .c(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n73_), .c(new_n129_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n70_), .O(z11));
  nor2   g076(.a(new_n64_), .b(new_n92_), .O(new_n139_));
  inv1   g077(.a(x35), .O(new_n140_));
  nand3  g078(.a(new_n93_), .b(new_n75_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g096(.a(new_n126_), .b(new_n146_), .c(new_n117_), .O(new_n159_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n76_), .c(x27), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x39), .c(new_n74_), .d(new_n73_), .O(new_n168_));
  ...
  oai21  g116(.a(new_n77_), .b(x27), .c(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  inv1   g118(.a(new_n77_), .O(new_n181_));
  nor2   g119(.a(new_n92_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n180_), .c(new_n70_), .d(new_n73_), .O(z18));
  inv1   g122(.a(new_n137_), .O(z19));
  inv1   g123(.a(x08), .O(new_n186_));
  aoi22  g124(.a(new_n178_), .b(x28), .c(new_n70_), .d(new_n186_), .O(new_n187_));
  nand2  g125(.a(new_n83_), .b(x39), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x40), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n140_), .O(new_n190_));
  oai21  g128(.a(new_n187_), .b(x27), .c(new_n190_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n73_), .c(new_n129_), .O(new_n192_));
