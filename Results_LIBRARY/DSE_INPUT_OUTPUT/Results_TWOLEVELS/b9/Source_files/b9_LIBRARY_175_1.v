...
module FAU ( 
  ...
  oai21  g032(.a(new_n94_), .b(new_n91_), .c(x26), .O(new_n95_));
  ...
  nand3  g059(.a(x40), .b(x39), .c(x26), .O(new_n122_));
  ...
  nor2   g091(.a(new_n80_), .b(new_n65_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n75_), .c(new_n64_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n153_), .c(new_n151_), .d(new_n81_), .O(z12));
  inv1   g094(.a(x13), .O(new_n157_));
  nand2  g095(.a(x36), .b(x35), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x28), .c(new_n96_), .O(new_n159_));
  ...
  nand4  g102(.a(new_n72_), .b(new_n96_), .c(x20), .d(new_n162_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand4  g105(.a(new_n132_), .b(x26), .c(new_n157_), .d(new_n65_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n167_), .O(z13));
  nand3  g107(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n170_));
  nand2  g108(.a(new_n157_), .b(new_n65_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x26), .O(new_n172_));
  nand4  g110(.a(new_n158_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(new_n76_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  oai21  g113(.a(new_n149_), .b(new_n73_), .c(new_n171_), .O(new_n176_));
  oai21  g114(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n177_));
  nand3  g115(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(x27), .c(x32), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n83_), .c(new_n105_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n177_), .c(new_n176_), .d(new_n175_), .O(z14));
  ...
  nand4  g133(.a(new_n76_), .b(x29), .c(x26), .d(x08), .O(new_n196_));
  oai21  g134(.a(new_n195_), .b(new_n105_), .c(new_n196_), .O(z18));
  nor2   g135(.a(new_n85_), .b(x27), .O(new_n198_));
  nor2   g136(.a(x35), .b(new_n80_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n142_), .O(new_n200_));
  ...
  oai21  g142(.a(new_n198_), .b(new_n66_), .c(new_n96_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n83_), .c(new_n97_), .O(new_n207_));
