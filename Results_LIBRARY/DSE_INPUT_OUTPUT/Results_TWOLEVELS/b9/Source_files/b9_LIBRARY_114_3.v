...
module FAU ( 
  ...
  nand4  g52(.a(new_n115_), .b(z02), .c(new_n71_), .d(new_n110_), .O(new_n116_));
  inv1   g53(.a(new_n116_), .O(z11));
  oai21  g54(.a(new_n64_), .b(x28), .c(x35), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(new_n66_), .O(new_n119_));
  ...
  nand3  g59(.a(z02), .b(x27), .c(x20), .O(new_n123_));
  nor3   g60(.a(new_n123_), .b(x19), .c(x18), .O(new_n124_));
  nand2  g61(.a(new_n124_), .b(new_n119_), .O(z14));
  ...
  nand4  g77(.a(new_n140_), .b(z02), .c(new_n71_), .d(new_n110_), .O(new_n141_));
  inv1   g78(.a(new_n141_), .O(z20));
  zero   g79(.O(z08));
