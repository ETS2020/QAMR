...
module FAU ( 
  ...
  oai21  g031(.a(new_n93_), .b(new_n90_), .c(x26), .O(new_n94_));
  ...
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n79_), .d(new_n97_), .O(z04));
  ...
  nand3  g053(.a(x40), .b(x39), .c(x26), .O(new_n116_));
  ...
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n81_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n84_), .c(new_n65_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x26), .c(new_n79_), .d(new_n64_), .O(new_n134_));
  ...
  nand3  g076(.a(new_n138_), .b(x35), .c(new_n84_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  oai21  g078(.a(new_n134_), .b(x08), .c(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n82_), .c(new_n132_), .O(new_n142_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x26), .O(new_n147_));
  ...
  nand4  g098(.a(new_n125_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n161_));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n166_), .c(new_n78_), .O(new_n169_));
  ...
  oai22  g124(.a(new_n85_), .b(x27), .c(new_n121_), .d(new_n186_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n66_), .b(x28), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x30), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n79_), .d(new_n132_), .O(z18));
  nand2  g130(.a(new_n142_), .b(new_n79_), .O(z19));
  nor2   g131(.a(new_n84_), .b(x27), .O(new_n194_));
  nor2   g132(.a(x35), .b(new_n78_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n194_), .c(new_n135_), .O(new_n196_));
  inv1   g134(.a(x08), .O(new_n197_));
  aoi21  g135(.a(x35), .b(x27), .c(new_n78_), .O(new_n198_));
  nor2   g136(.a(x40), .b(x27), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n197_), .O(new_n200_));
  oai21  g138(.a(new_n194_), .b(new_n66_), .c(new_n148_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n200_), .c(new_n196_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n82_), .c(new_n132_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n79_), .O(z20));
endmodule
