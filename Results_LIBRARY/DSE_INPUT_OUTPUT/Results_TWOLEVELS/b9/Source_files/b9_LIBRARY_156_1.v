...
module FAU ( 
  ...
  nor2   g052(.a(new_n114_), .b(new_n69_), .O(z08));
  ...
  nand4  g094(.a(new_n154_), .b(new_n114_), .c(x20), .d(new_n153_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  nand4  g097(.a(new_n125_), .b(x39), .c(new_n148_), .d(new_n119_), .O(new_n160_));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n142_), .O(new_n187_));
  nand2  g125(.a(new_n73_), .b(new_n131_), .O(new_n188_));
  ...
  nand2  g130(.a(new_n139_), .b(new_n70_), .O(z19));
  aoi21  g131(.a(x40), .b(new_n69_), .c(x08), .O(new_n194_));
  aoi21  g132(.a(x40), .b(x29), .c(new_n76_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n194_), .c(new_n86_), .O(new_n196_));
  oai21  g134(.a(new_n190_), .b(new_n69_), .c(x40), .O(new_n197_));
