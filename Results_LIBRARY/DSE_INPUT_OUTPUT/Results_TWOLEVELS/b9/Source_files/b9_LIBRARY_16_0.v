...
module FAU ( 
  ...
  nand2  g034(.a(new_n76_), .b(x32), .O(new_n97_));
  ...
  nor2   g042(.a(new_n84_), .b(new_n64_), .O(new_n105_));
  inv1   g043(.a(new_n105_), .O(new_n106_));
  nand3  g044(.a(new_n106_), .b(new_n82_), .c(new_n70_), .O(z05));
  oai21  g045(.a(new_n105_), .b(x37), .c(new_n82_), .O(z06));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n97_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n139_), .c(new_n136_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n72_), .b(x32), .c(x20), .d(new_n159_), .O(new_n162_));
  ...
  inv1   g104(.a(new_n71_), .O(new_n167_));
  oai21  g105(.a(new_n75_), .b(x04), .c(x40), .O(new_n168_));
  aoi21  g106(.a(new_n76_), .b(x32), .c(x13), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n168_), .c(new_n167_), .O(new_n170_));
  nand4  g108(.a(new_n66_), .b(new_n81_), .c(new_n136_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n70_), .O(new_n173_));
  nand3  g111(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n174_));
  nand4  g112(.a(new_n155_), .b(new_n81_), .c(new_n136_), .d(x28), .O(new_n175_));
  nor2   g113(.a(new_n75_), .b(x13), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n175_), .c(x40), .d(new_n65_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand2  g116(.a(new_n136_), .b(new_n64_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(x40), .c(x32), .O(new_n180_));
  nand2  g118(.a(new_n176_), .b(new_n65_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n97_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n64_), .c(new_n180_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n178_), .c(new_n173_), .O(z14));
  ...
  nand2  g130(.a(new_n192_), .b(new_n82_), .O(z17));
  ...
  nand2  g136(.a(new_n136_), .b(new_n198_), .O(new_n199_));
  aoi21  g137(.a(new_n197_), .b(new_n84_), .c(new_n199_), .O(new_n200_));
  oai22  g138(.a(new_n200_), .b(new_n100_), .c(new_n91_), .d(new_n194_), .O(z18));
  oai21  g139(.a(new_n145_), .b(x09), .c(new_n82_), .O(z19));
  nand2  g140(.a(x28), .b(new_n64_), .O(new_n203_));
  aoi22  g141(.a(new_n203_), .b(x35), .c(new_n142_), .d(new_n97_), .O(new_n204_));
  nand2  g142(.a(x40), .b(new_n66_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n137_), .c(x08), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n204_), .c(new_n136_), .O(new_n207_));
