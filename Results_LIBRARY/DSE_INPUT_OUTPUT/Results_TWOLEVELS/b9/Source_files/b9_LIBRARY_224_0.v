...
module FAU ( 
  ...
  aoi21  g033(.a(new_n66_), .b(new_n90_), .c(new_n95_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n94_), .c(new_n93_), .O(z03));
  nand2  g035(.a(new_n66_), .b(new_n90_), .O(new_n98_));
  ...
  aoi21  g040(.a(new_n65_), .b(new_n90_), .c(new_n102_), .O(new_n103_));
  ...
  nor3   g063(.a(new_n93_), .b(new_n66_), .c(new_n125_), .O(new_n126_));
  ...
  oai21  g070(.a(new_n127_), .b(new_n90_), .c(new_n132_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n102_), .c(new_n72_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x39), .c(new_n65_), .d(new_n90_), .O(new_n136_));
  ...
  nand3  g079(.a(new_n141_), .b(x35), .c(new_n102_), .O(new_n142_));
  ...
  oai21  g088(.a(new_n150_), .b(x04), .c(new_n69_), .O(new_n151_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n72_), .c(new_n93_), .O(new_n163_));
  ...
  nand3  g105(.a(z08), .b(new_n153_), .c(new_n72_), .O(new_n168_));
  ...
  nand3  g110(.a(new_n168_), .b(new_n67_), .c(new_n66_), .O(new_n173_));
  aoi21  g111(.a(x40), .b(x27), .c(x39), .O(new_n174_));
  nand3  g112(.a(x40), .b(new_n153_), .c(new_n72_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n90_), .c(new_n174_), .O(new_n176_));
  ...
  oai21  g125(.a(new_n86_), .b(x27), .c(new_n187_), .O(new_n188_));
  ...
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n65_), .d(new_n79_), .O(z18));
  nand2  g130(.a(new_n145_), .b(new_n65_), .O(z19));
  oai22  g131(.a(new_n63_), .b(x35), .c(new_n102_), .d(x27), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n138_), .O(new_n195_));
  oai21  g133(.a(new_n63_), .b(x08), .c(new_n137_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n81_), .O(new_n197_));
  nor2   g135(.a(new_n93_), .b(x08), .O(new_n198_));
  nor2   g136(.a(x39), .b(new_n102_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n90_), .O(new_n200_));
