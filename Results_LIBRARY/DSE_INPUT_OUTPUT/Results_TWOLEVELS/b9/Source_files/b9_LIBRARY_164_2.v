...
module FAU ( 
  ...
  nor2   g069(.a(new_n91_), .b(new_n71_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(new_n83_), .c(new_n131_), .O(new_n133_));
  nand4  g071(.a(x35), .b(new_n82_), .c(x27), .d(new_n71_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n90_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n79_), .c(new_n130_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n64_), .O(z11));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  nor2   g077(.a(new_n63_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n139_), .c(new_n73_), .O(new_n141_));
  oai21  g079(.a(new_n63_), .b(new_n71_), .c(x39), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n68_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n141_), .c(new_n64_), .O(z12));
  inv1   g082(.a(x13), .O(new_n145_));
  nand2  g083(.a(x36), .b(x35), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x28), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x39), .c(new_n145_), .d(new_n71_), .O(new_n148_));
  inv1   g086(.a(x18), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nand4  g088(.a(new_n67_), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n148_), .c(new_n91_), .O(new_n152_));
  nand3  g090(.a(new_n124_), .b(new_n145_), .c(new_n71_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x40), .c(new_n115_), .O(new_n154_));
  ...
  oai21  g096(.a(new_n156_), .b(new_n115_), .c(new_n158_), .O(new_n159_));
  ...
  oai21  g112(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n78_), .b(x30), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n176_), .c(new_n134_), .d(new_n130_), .O(z18));
  inv1   g116(.a(new_n131_), .O(new_n179_));
  inv1   g117(.a(x35), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n91_), .c(new_n90_), .O(new_n181_));
  aoi21  g119(.a(x28), .b(new_n91_), .c(new_n180_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n179_), .c(new_n181_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n79_), .c(new_n130_), .O(new_n184_));
