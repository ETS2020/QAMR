...
module FAU ( 
  ...
  aoi21  g24(.a(new_n63_), .b(new_n87_), .c(new_n80_), .O(new_n88_));
  ...
  nand2  g62(.a(new_n125_), .b(new_n63_), .O(z15));
  ...
  nand2  g68(.a(new_n131_), .b(new_n63_), .O(z17));
  nand2  g69(.a(x27), .b(new_n105_), .O(new_n133_));
  oai21  g70(.a(x27), .b(new_n113_), .c(new_n133_), .O(new_n134_));
  nand3  g71(.a(new_n134_), .b(x35), .c(new_n87_), .O(new_n135_));
  nand4  g72(.a(new_n135_), .b(new_n63_), .c(new_n71_), .d(new_n111_), .O(z18));
  oai21  g73(.a(x28), .b(new_n113_), .c(new_n80_), .O(new_n137_));
  nand2  g74(.a(new_n137_), .b(x35), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(new_n71_), .c(new_n111_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(new_n63_), .O(z20));
  one    g77(.O(z02));
  nand2  g78(.a(new_n116_), .b(new_n63_), .O(z19));
endmodule
