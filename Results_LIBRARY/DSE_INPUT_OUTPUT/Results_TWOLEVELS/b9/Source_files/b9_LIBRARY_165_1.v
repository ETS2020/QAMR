...
module FAU ( 
  ...
  nand2  g031(.a(new_n83_), .b(x27), .O(new_n94_));
  ...
  nand3  g061(.a(new_n123_), .b(new_n85_), .c(new_n72_), .O(new_n124_));
  ...
  nor3   g066(.a(new_n128_), .b(new_n74_), .c(new_n63_), .O(new_n129_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n91_), .c(new_n133_), .O(new_n135_));
  ...
  oai22  g083(.a(new_n145_), .b(new_n99_), .c(new_n74_), .d(x04), .O(new_n146_));
  ...
  nand4  g093(.a(new_n68_), .b(new_n74_), .c(x20), .d(new_n153_), .O(new_n156_));
  ...
  oai21  g098(.a(new_n128_), .b(x13), .c(x39), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(x40), .c(new_n72_), .O(new_n162_));
  ...
  oai22  g117(.a(new_n84_), .b(x27), .c(new_n74_), .d(new_n132_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  nor2   g119(.a(new_n99_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n91_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n64_), .d(new_n80_), .O(z18));
  aoi21  g122(.a(x28), .b(new_n99_), .c(new_n90_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n133_), .O(new_n186_));
  nand2  g124(.a(x39), .b(new_n90_), .O(new_n187_));
