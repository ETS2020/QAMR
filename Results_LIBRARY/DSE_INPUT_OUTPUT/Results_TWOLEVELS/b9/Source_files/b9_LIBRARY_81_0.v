...
module FAU ( 
  ...
  aoi21  g059(.a(x35), .b(new_n105_), .c(x36), .O(new_n122_));
  ...
  nor3   g065(.a(new_n96_), .b(new_n70_), .c(new_n127_), .O(new_n128_));
  ...
  aoi22  g073(.a(new_n135_), .b(x39), .c(new_n81_), .d(new_n64_), .O(new_n136_));
  nand2  g074(.a(x40), .b(new_n75_), .O(new_n137_));
  ...
  nand3  g079(.a(new_n141_), .b(x35), .c(new_n105_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  oai21  g081(.a(new_n136_), .b(x08), .c(new_n143_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n83_), .c(new_n134_), .O(new_n145_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n76_), .c(x39), .O(new_n152_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n157_), .c(new_n75_), .O(new_n161_));
  ...
  nand3  g102(.a(new_n131_), .b(new_n154_), .c(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  nor2   g104(.a(x40), .b(new_n75_), .O(new_n167_));
  ...
  nand2  g131(.a(new_n83_), .b(new_n134_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n105_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n96_), .c(new_n90_), .d(new_n190_), .O(z18));
  inv1   g134(.a(new_n145_), .O(z19));
  oai22  g135(.a(new_n75_), .b(x35), .c(new_n105_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n138_), .O(new_n199_));
  oai21  g137(.a(new_n75_), .b(x08), .c(new_n137_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n66_), .O(new_n201_));
  nor2   g139(.a(new_n96_), .b(x08), .O(new_n202_));
  nor2   g140(.a(x39), .b(new_n105_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n64_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n83_), .c(new_n134_), .O(new_n206_));
