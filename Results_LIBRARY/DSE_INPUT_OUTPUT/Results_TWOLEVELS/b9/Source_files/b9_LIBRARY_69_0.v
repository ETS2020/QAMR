...
module FAU ( 
  ...
  nand2  g036(.a(new_n76_), .b(x26), .O(new_n99_));
  ...
  nand2  g060(.a(new_n82_), .b(new_n122_), .O(z08));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n99_), .c(new_n126_), .O(new_n128_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n87_), .c(new_n142_), .O(new_n144_));
  inv1   g082(.a(x08), .O(new_n145_));
  nand2  g083(.a(x27), .b(new_n65_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n87_), .c(new_n145_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n84_), .c(new_n141_), .O(new_n149_));
  ...
  nand2  g094(.a(new_n156_), .b(x26), .O(new_n157_));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n65_), .c(new_n104_), .O(new_n169_));
  ...
  aoi21  g130(.a(new_n192_), .b(new_n146_), .c(new_n66_), .O(new_n193_));
  nand2  g131(.a(new_n84_), .b(new_n141_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n86_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n104_), .c(new_n93_), .d(new_n122_), .O(z18));
  inv1   g134(.a(new_n142_), .O(new_n197_));
  oai21  g135(.a(new_n66_), .b(new_n64_), .c(new_n145_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n84_), .c(new_n141_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n82_), .O(z20));
  nand2  g140(.a(new_n149_), .b(new_n82_), .O(z19));
endmodule
