...
module FAU ( 
  ...
  oai22  g059(.a(new_n114_), .b(new_n120_), .c(x39), .d(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n78_), .c(new_n119_), .O(new_n123_));
  nand3  g061(.a(new_n70_), .b(x37), .c(x06), .O(new_n124_));
  ...
  nand3  g067(.a(new_n129_), .b(x05), .c(new_n119_), .O(new_n130_));
  ...
  nand2  g092(.a(new_n90_), .b(new_n93_), .O(new_n155_));
  ...
  nand3  g098(.a(new_n129_), .b(new_n149_), .c(new_n119_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  aoi21  g100(.a(new_n149_), .b(new_n119_), .c(new_n69_), .O(new_n163_));
  nand4  g101(.a(x27), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n64_), .c(new_n163_), .d(new_n127_), .O(new_n165_));
  ...
  oai21  g106(.a(new_n168_), .b(new_n76_), .c(x27), .O(new_n169_));
  ...
  nand4  g116(.a(new_n70_), .b(new_n178_), .c(x23), .d(x22), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(new_n177_), .O(z17));
  nand2  g118(.a(x27), .b(new_n119_), .O(new_n181_));
  nand2  g119(.a(new_n86_), .b(x08), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n143_), .O(new_n183_));
  nand2  g121(.a(new_n73_), .b(new_n132_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(new_n76_), .c(new_n184_), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n89_), .c(new_n114_), .d(new_n83_), .O(z18));
  inv1   g124(.a(new_n140_), .O(z19));
  aoi21  g125(.a(new_n69_), .b(x39), .c(x08), .O(new_n188_));
  aoi21  g126(.a(x39), .b(x29), .c(new_n76_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(new_n86_), .O(new_n190_));
  nand2  g128(.a(new_n83_), .b(x40), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x39), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n143_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n190_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n73_), .c(new_n132_), .O(new_n195_));
