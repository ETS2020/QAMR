...
module FAU ( 
  ...
  oai21  g022(.a(new_n84_), .b(new_n81_), .c(x39), .O(new_n85_));
  inv1   g023(.a(x27), .O(new_n86_));
  oai21  g024(.a(x08), .b(new_n82_), .c(x40), .O(new_n87_));
  ...
  oai22  g061(.a(new_n117_), .b(new_n122_), .c(x40), .d(new_n123_), .O(new_n124_));
  ...
  nand4  g089(.a(new_n151_), .b(x40), .c(new_n149_), .d(new_n82_), .O(new_n152_));
  ...
  nand4  g107(.a(new_n169_), .b(x39), .c(new_n74_), .d(new_n73_), .O(new_n170_));
  ...
  aoi21  g125(.a(x40), .b(new_n69_), .c(x08), .O(new_n188_));
  aoi21  g126(.a(x40), .b(x29), .c(new_n101_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(new_n86_), .O(new_n190_));
  nand2  g128(.a(new_n180_), .b(x39), .O(new_n191_));
