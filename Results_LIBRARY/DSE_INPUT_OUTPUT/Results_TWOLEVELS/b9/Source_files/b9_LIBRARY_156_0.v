...
module FAU ( 
  ...
  oai21  g113(.a(new_n80_), .b(x04), .c(x40), .O(new_n176_));
  nand2  g114(.a(new_n81_), .b(x39), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n155_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n71_), .c(new_n70_), .O(new_n179_));
  aoi21  g117(.a(x40), .b(x27), .c(x39), .O(new_n180_));
  oai21  g118(.a(new_n170_), .b(new_n81_), .c(new_n177_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n64_), .c(new_n180_), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n179_), .c(new_n175_), .d(new_n172_), .O(z14));
  inv1   g121(.a(x12), .O(new_n184_));
  nor2   g122(.a(new_n121_), .b(new_n184_), .O(z15));
  ...
  oai22  g134(.a(new_n196_), .b(new_n98_), .c(new_n93_), .d(new_n75_), .O(z18));
  nand2  g135(.a(new_n146_), .b(new_n82_), .O(z19));
  oai22  g136(.a(new_n80_), .b(x35), .c(new_n86_), .d(x27), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n138_), .O(new_n200_));
  oai21  g138(.a(new_n80_), .b(x08), .c(new_n140_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n66_), .O(new_n202_));
  nor2   g140(.a(new_n98_), .b(x08), .O(new_n203_));
  nor2   g141(.a(x39), .b(new_n86_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n203_), .c(new_n64_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n202_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n84_), .c(new_n135_), .O(new_n207_));
