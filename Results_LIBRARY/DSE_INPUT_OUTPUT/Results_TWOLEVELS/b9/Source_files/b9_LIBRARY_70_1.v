...
module FAU ( 
  ...
  oai22  g030(.a(new_n92_), .b(x02), .c(x27), .d(new_n65_), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  aoi21  g032(.a(new_n86_), .b(x04), .c(new_n80_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n94_), .c(x40), .d(x39), .O(z02));
  ...
  aoi21  g061(.a(new_n123_), .b(x29), .c(new_n92_), .O(new_n124_));
  nand4  g062(.a(x40), .b(x39), .c(x29), .d(x05), .O(new_n125_));
  ...
  nand4  g071(.a(new_n133_), .b(x29), .c(x05), .d(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n130_), .O(z10));
  inv1   g073(.a(new_n86_), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(new_n124_), .O(new_n138_));
  nand2  g076(.a(new_n81_), .b(new_n64_), .O(new_n139_));
  oai21  g077(.a(new_n86_), .b(x04), .c(x29), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n139_), .c(x08), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n138_), .c(new_n83_), .O(new_n142_));
  ...
  oai21  g086(.a(new_n73_), .b(new_n64_), .c(new_n92_), .O(new_n149_));
  ...
  nand4  g096(.a(new_n131_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x29), .c(new_n92_), .O(new_n160_));
  or2    g098(.a(new_n160_), .b(new_n158_), .O(z13));
  oai21  g099(.a(x27), .b(new_n151_), .c(x29), .O(new_n162_));
  ...
  nand4  g103(.a(new_n165_), .b(new_n76_), .c(new_n151_), .d(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  inv1   g105(.a(new_n71_), .O(new_n168_));
  oai21  g106(.a(new_n123_), .b(x04), .c(x29), .O(new_n169_));
  nor2   g107(.a(new_n92_), .b(x13), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n169_), .c(new_n168_), .O(new_n171_));
  nand4  g109(.a(new_n66_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n171_), .c(new_n70_), .O(new_n174_));
  nand3  g112(.a(new_n169_), .b(new_n131_), .c(x40), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n64_), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n174_), .c(new_n167_), .d(new_n163_), .O(z14));
  ...
  oai21  g125(.a(new_n86_), .b(x27), .c(new_n75_), .O(new_n188_));
  ...
  aoi22  g131(.a(new_n81_), .b(new_n91_), .c(new_n75_), .d(x28), .O(new_n194_));
  aoi21  g132(.a(x39), .b(x08), .c(new_n80_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n92_), .c(new_n66_), .O(new_n196_));
  oai21  g134(.a(new_n194_), .b(x27), .c(new_n196_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n83_), .c(new_n193_), .O(new_n198_));
