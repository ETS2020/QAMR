...
module FAU ( 
  ...
  nand2  g031(.a(new_n70_), .b(x39), .O(new_n94_));
  ...
  aoi22  g038(.a(new_n100_), .b(new_n93_), .c(new_n99_), .d(x39), .O(z05));
  ...
  oai22  g059(.a(new_n99_), .b(new_n120_), .c(x39), .d(new_n121_), .O(new_n122_));
  ...
  aoi21  g064(.a(new_n76_), .b(new_n75_), .c(new_n70_), .O(new_n127_));
  ...
  oai21  g080(.a(new_n70_), .b(new_n119_), .c(x39), .O(new_n143_));
  ...
  nand4  g086(.a(new_n148_), .b(x39), .c(new_n146_), .d(new_n119_), .O(new_n149_));
  ...
  nand4  g103(.a(new_n165_), .b(x40), .c(new_n76_), .d(new_n75_), .O(new_n166_));
  ...
  aoi21  g120(.a(new_n70_), .b(x39), .c(x08), .O(new_n183_));
  aoi21  g121(.a(x39), .b(x29), .c(new_n135_), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n183_), .c(new_n92_), .O(new_n185_));
  nand2  g123(.a(new_n84_), .b(x40), .O(new_n186_));
