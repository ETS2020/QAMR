...
module FAU ( 
  ...
  nand2  g032(.a(new_n63_), .b(new_n80_), .O(new_n95_));
  ...
  oai21  g042(.a(x40), .b(new_n80_), .c(new_n82_), .O(new_n105_));
  ...
  nand2  g061(.a(new_n123_), .b(x32), .O(new_n124_));
  inv1   g062(.a(x05), .O(new_n125_));
  nand2  g063(.a(new_n118_), .b(x07), .O(new_n126_));
  oai21  g064(.a(new_n118_), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n84_), .c(x27), .O(new_n128_));
  nand3  g066(.a(z08), .b(x30), .c(x05), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n73_), .O(new_n131_));
  ...
  aoi21  g073(.a(new_n135_), .b(new_n104_), .c(x08), .O(new_n136_));
  ...
  aoi22  g079(.a(new_n141_), .b(new_n138_), .c(new_n140_), .d(new_n95_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n136_), .c(new_n79_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x09), .c(new_n64_), .O(z11));
  nand3  g082(.a(new_n69_), .b(new_n81_), .c(new_n137_), .O(new_n145_));
  ...
  inv1   g086(.a(new_n71_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n63_), .c(new_n80_), .O(new_n150_));
  ...
  nand4  g098(.a(new_n158_), .b(new_n80_), .c(x20), .d(new_n157_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  aoi21  g101(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n152_), .d(new_n73_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(z13));
  nand3  g104(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n167_));
  nand3  g105(.a(new_n153_), .b(new_n79_), .c(x28), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(x40), .c(x32), .O(new_n169_));
  nand3  g107(.a(x39), .b(new_n152_), .c(new_n73_), .O(new_n170_));
  and2   g108(.a(new_n170_), .b(x40), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(new_n167_), .O(new_n172_));
  aoi21  g110(.a(x40), .b(x30), .c(x27), .O(new_n173_));
  oai21  g111(.a(x30), .b(new_n82_), .c(x40), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n137_), .O(new_n175_));
  nand2  g113(.a(new_n63_), .b(new_n82_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n175_), .c(x37), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n173_), .c(new_n80_), .O(new_n178_));
  nand3  g116(.a(new_n170_), .b(new_n149_), .c(x40), .O(new_n179_));
  ...
  nand2  g127(.a(x27), .b(new_n73_), .O(new_n190_));
  nand2  g128(.a(new_n68_), .b(x08), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n137_), .O(new_n192_));
