...
module FAU ( 
  ...
  nand4  g027(.a(new_n89_), .b(x40), .c(new_n85_), .d(new_n84_), .O(new_n90_));
  oai21  g028(.a(new_n81_), .b(x04), .c(new_n90_), .O(z01));
  ...
  oai21  g037(.a(x40), .b(new_n84_), .c(new_n99_), .O(z02));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n101_), .c(new_n81_), .O(z04));
  aoi21  g044(.a(x28), .b(x27), .c(x37), .O(new_n107_));
  nor2   g045(.a(new_n107_), .b(new_n81_), .O(z05));
  oai22  g046(.a(x40), .b(x30), .c(new_n86_), .d(new_n64_), .O(new_n109_));
  nor2   g047(.a(new_n109_), .b(x37), .O(z06));
  inv1   g048(.a(new_n81_), .O(new_n111_));
  ...
  nand2  g060(.a(new_n122_), .b(new_n111_), .O(z07));
  nand4  g061(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n111_), .O(z09));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n111_), .O(z10));
  ...
  nand2  g080(.a(new_n142_), .b(new_n93_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n136_), .c(new_n137_), .O(new_n145_));
  nor2   g083(.a(new_n145_), .b(x30), .O(z11));
  ...
  nand3  g089(.a(new_n151_), .b(new_n137_), .c(x30), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n137_), .O(new_n156_));
  ...
  nand3  g100(.a(new_n130_), .b(x40), .c(x39), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n65_), .c(new_n81_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(z13));
  nor2   g104(.a(x40), .b(new_n84_), .O(new_n167_));
  nand3  g105(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n168_));
  nand4  g106(.a(new_n155_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n169_));
  nand3  g107(.a(x39), .b(new_n154_), .c(new_n65_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n137_), .O(new_n172_));
  ...
  nand4  g119(.a(new_n111_), .b(x34), .c(x27), .d(x26), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n181_), .O(z15));
  inv1   g121(.a(x23), .O(new_n184_));
  nand4  g122(.a(new_n111_), .b(new_n184_), .c(x22), .d(x01), .O(new_n185_));
  inv1   g123(.a(new_n185_), .O(z16));
  inv1   g124(.a(x24), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(x23), .c(x22), .d(x01), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n111_), .O(z17));
  nand3  g127(.a(x35), .b(new_n86_), .c(new_n64_), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n138_), .c(new_n93_), .O(new_n191_));
  nand2  g129(.a(new_n142_), .b(new_n136_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n191_), .c(x40), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n84_), .O(z18));
  nand4  g132(.a(new_n144_), .b(x40), .c(new_n84_), .d(new_n136_), .O(new_n195_));
  inv1   g133(.a(new_n195_), .O(z19));
  inv1   g134(.a(new_n138_), .O(new_n197_));
  oai21  g135(.a(new_n66_), .b(new_n64_), .c(new_n93_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n198_), .O(new_n200_));
  nand4  g138(.a(new_n200_), .b(x40), .c(new_n84_), .d(new_n136_), .O(new_n201_));
