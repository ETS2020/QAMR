...
module FAU ( 
  ...
  nor2   g046(.a(new_n108_), .b(new_n83_), .O(z05));
  nand2  g047(.a(new_n81_), .b(new_n64_), .O(new_n110_));
  inv1   g048(.a(x33), .O(new_n111_));
  oai21  g049(.a(x40), .b(new_n111_), .c(new_n86_), .O(new_n112_));
  ...
  nand3  g054(.a(new_n116_), .b(new_n114_), .c(new_n111_), .O(new_n117_));
  ...
  aoi21  g065(.a(x40), .b(new_n75_), .c(new_n99_), .O(new_n128_));
  nand3  g066(.a(x40), .b(x39), .c(x05), .O(new_n129_));
  oai21  g067(.a(new_n128_), .b(new_n127_), .c(new_n129_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n88_), .c(new_n65_), .O(new_n131_));
  ...
  oai21  g090(.a(new_n75_), .b(x04), .c(new_n71_), .O(new_n153_));
  aoi21  g091(.a(new_n111_), .b(new_n86_), .c(new_n66_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(x40), .c(new_n153_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n70_), .O(new_n156_));
  aoi21  g094(.a(new_n111_), .b(x27), .c(x40), .O(new_n157_));
  nand2  g095(.a(x40), .b(x04), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x39), .c(x27), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(new_n156_), .c(new_n152_), .O(z12));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n165_), .c(new_n76_), .O(new_n169_));
  nand4  g107(.a(new_n72_), .b(new_n111_), .c(x20), .d(new_n167_), .O(new_n170_));
  nor2   g108(.a(new_n170_), .b(x18), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(x27), .O(new_n172_));
  nand3  g110(.a(new_n136_), .b(new_n162_), .c(new_n65_), .O(new_n173_));
  ...
  nand2  g119(.a(new_n181_), .b(new_n150_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n85_), .c(new_n84_), .O(new_n183_));
  inv1   g121(.a(new_n177_), .O(new_n184_));
  oai21  g122(.a(new_n151_), .b(new_n73_), .c(new_n184_), .O(new_n185_));
  inv1   g123(.a(z08), .O(new_n186_));
  oai21  g124(.a(new_n180_), .b(new_n64_), .c(new_n186_), .O(new_n187_));
  nand2  g125(.a(new_n100_), .b(x39), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n70_), .c(new_n86_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n187_), .c(new_n81_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n185_), .c(new_n183_), .d(new_n179_), .O(z14));
  nand4  g130(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n81_), .O(z15));
  inv1   g132(.a(x23), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(x22), .c(x01), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n81_), .O(z16));
  inv1   g135(.a(x01), .O(new_n198_));
  inv1   g136(.a(x24), .O(new_n199_));
  nand4  g137(.a(new_n81_), .b(new_n199_), .c(x23), .d(x22), .O(new_n200_));
  ...
  inv1   g142(.a(x09), .O(new_n205_));
  nand2  g143(.a(new_n84_), .b(new_n205_), .O(new_n206_));
  aoi21  g144(.a(new_n204_), .b(new_n86_), .c(new_n206_), .O(new_n207_));
  oai22  g145(.a(new_n207_), .b(new_n83_), .c(new_n93_), .d(new_n186_), .O(z18));
  oai21  g146(.a(new_n146_), .b(x09), .c(new_n81_), .O(z19));
  aoi21  g147(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n210_));
  aoi21  g148(.a(new_n143_), .b(new_n100_), .c(new_n210_), .O(new_n211_));
  nand2  g149(.a(x40), .b(new_n66_), .O(new_n212_));
  aoi21  g150(.a(new_n212_), .b(new_n110_), .c(x08), .O(new_n213_));
  oai21  g151(.a(new_n213_), .b(new_n211_), .c(new_n84_), .O(new_n214_));
