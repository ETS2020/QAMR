...
module FAU ( 
  ...
  nor2   g001(.a(new_n63_), .b(x09), .O(new_n64_));
  ...
  aoi21  g011(.a(new_n73_), .b(new_n72_), .c(new_n63_), .O(new_n74_));
  nand4  g012(.a(new_n74_), .b(x39), .c(new_n65_), .d(x09), .O(new_n75_));
  oai22  g013(.a(new_n75_), .b(x04), .c(new_n71_), .d(new_n64_), .O(z00));
  ...
  oai21  g028(.a(new_n90_), .b(new_n87_), .c(x09), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x40), .O(z02));
  nand2  g030(.a(new_n69_), .b(x27), .O(new_n93_));
  inv1   g031(.a(x21), .O(new_n94_));
  aoi21  g032(.a(new_n68_), .b(new_n67_), .c(new_n94_), .O(new_n95_));
  aoi21  g033(.a(new_n95_), .b(new_n93_), .c(new_n64_), .O(z03));
  aoi21  g034(.a(new_n68_), .b(new_n67_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n93_), .c(new_n64_), .O(z04));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n68_), .c(new_n64_), .O(z05));
  nand3  g038(.a(new_n99_), .b(new_n77_), .c(new_n68_), .O(new_n101_));
  ...
  nand3  g051(.a(new_n113_), .b(new_n77_), .c(x03), .O(new_n114_));
  inv1   g052(.a(new_n114_), .O(z07));
  inv1   g053(.a(x39), .O(new_n116_));
  aoi21  g054(.a(new_n116_), .b(x09), .c(new_n63_), .O(z08));
  inv1   g055(.a(x11), .O(new_n118_));
  nand4  g056(.a(new_n77_), .b(x34), .c(x27), .d(x26), .O(new_n119_));
  ...
  nor2   g068(.a(new_n68_), .b(new_n67_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n64_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(z10));
  aoi21  g071(.a(x27), .b(x04), .c(new_n88_), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(x35), .c(new_n81_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n78_), .c(x40), .O(new_n136_));
  nor2   g074(.a(new_n136_), .b(x09), .O(z11));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n67_), .c(new_n72_), .O(new_n139_));
  inv1   g077(.a(new_n70_), .O(new_n140_));
  oai21  g078(.a(new_n122_), .b(x04), .c(new_n140_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n139_), .c(new_n77_), .O(z12));
  inv1   g080(.a(x13), .O(new_n143_));
  nand2  g081(.a(x36), .b(x35), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x28), .c(new_n63_), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(x39), .c(new_n143_), .d(new_n121_), .O(new_n146_));
  ...
  nand4  g090(.a(new_n127_), .b(x39), .c(new_n143_), .d(new_n121_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x09), .O(new_n154_));
  ...
  nand4  g095(.a(new_n144_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n158_));
  inv1   g096(.a(new_n158_), .O(new_n159_));
  nand4  g097(.a(x40), .b(x39), .c(new_n143_), .d(new_n121_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(new_n157_), .O(new_n161_));
  inv1   g099(.a(x35), .O(new_n162_));
  nand3  g100(.a(new_n68_), .b(new_n162_), .c(x28), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x27), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n79_), .c(new_n78_), .O(new_n165_));
  aoi21  g103(.a(new_n160_), .b(new_n140_), .c(new_n64_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n165_), .c(new_n161_), .O(z14));
  ...
  nand4  g112(.a(new_n77_), .b(new_n174_), .c(x23), .d(x22), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n173_), .O(z17));
  inv1   g114(.a(x09), .O(new_n177_));
  nand2  g115(.a(x27), .b(new_n121_), .O(new_n178_));
  nand2  g116(.a(new_n67_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n162_), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n81_), .c(x30), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(x40), .c(new_n177_), .O(z18));
  nand4  g120(.a(new_n135_), .b(new_n63_), .c(new_n78_), .d(new_n177_), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z19));
  inv1   g122(.a(x08), .O(new_n185_));
  oai21  g123(.a(x28), .b(new_n185_), .c(new_n67_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x35), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n63_), .c(new_n78_), .d(new_n177_), .O(new_n188_));
