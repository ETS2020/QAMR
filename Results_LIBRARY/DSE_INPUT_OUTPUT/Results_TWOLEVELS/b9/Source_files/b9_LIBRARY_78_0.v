...
module FAU ( 
  ...
  nand2  g037(.a(new_n76_), .b(x31), .O(new_n100_));
  ...
  oai21  g047(.a(x40), .b(x31), .c(new_n87_), .O(new_n110_));
  ...
  nand3  g061(.a(new_n120_), .b(x31), .c(new_n118_), .O(new_n124_));
  aoi21  g062(.a(new_n124_), .b(new_n123_), .c(new_n112_), .O(z07));
  inv1   g063(.a(new_n77_), .O(new_n126_));
  nand2  g064(.a(new_n82_), .b(new_n126_), .O(z08));
  ...
  nand2  g069(.a(x40), .b(new_n75_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n100_), .c(new_n131_), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x05), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n133_), .c(new_n89_), .O(new_n136_));
  nand3  g074(.a(new_n82_), .b(x37), .c(x06), .O(new_n137_));
  oai21  g075(.a(new_n136_), .b(x04), .c(new_n137_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x27), .O(new_n139_));
  inv1   g077(.a(x05), .O(new_n140_));
  nand2  g078(.a(new_n86_), .b(new_n85_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(x40), .c(x39), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n65_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n139_), .O(z10));
  oai21  g083(.a(new_n88_), .b(x04), .c(x40), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n109_), .c(x08), .O(new_n147_));
  inv1   g085(.a(new_n88_), .O(new_n148_));
  nand2  g086(.a(x39), .b(x29), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x40), .O(new_n150_));
  nand2  g088(.a(x27), .b(x04), .O(new_n151_));
  aoi22  g089(.a(new_n151_), .b(new_n148_), .c(new_n150_), .d(new_n100_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n147_), .c(new_n85_), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(x09), .O(z11));
  inv1   g092(.a(x10), .O(new_n155_));
  nor3   g093(.a(x37), .b(x36), .c(x35), .O(new_n156_));
  nor2   g094(.a(new_n76_), .b(x27), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n156_), .c(new_n155_), .O(new_n158_));
  inv1   g096(.a(new_n100_), .O(new_n159_));
  nand2  g097(.a(new_n72_), .b(x27), .O(new_n160_));
  aoi21  g098(.a(x39), .b(new_n65_), .c(new_n76_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(new_n160_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n158_), .c(new_n82_), .O(z12));
  ...
  nor2   g110(.a(new_n142_), .b(x13), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n65_), .c(new_n84_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n172_), .O(z13));
  nand3  g113(.a(x20), .b(new_n169_), .c(new_n168_), .O(new_n176_));
  nand4  g114(.a(new_n165_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n177_));
  nand3  g115(.a(x39), .b(new_n164_), .c(new_n65_), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n177_), .c(new_n76_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n159_), .c(new_n176_), .O(new_n181_));
  nand3  g119(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x27), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n86_), .c(new_n85_), .O(new_n184_));
  ...
  nand3  g125(.a(new_n160_), .b(new_n76_), .c(x31), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n187_), .c(new_n181_), .O(z14));
  nand4  g127(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n82_), .O(z15));
  inv1   g129(.a(x23), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(x22), .c(x01), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n82_), .O(z16));
  inv1   g132(.a(x24), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(x23), .c(x22), .d(x01), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n82_), .O(z17));
  nand2  g135(.a(x27), .b(new_n65_), .O(new_n198_));
  nand2  g136(.a(new_n64_), .b(x08), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n198_), .c(new_n66_), .O(new_n200_));
  inv1   g138(.a(x09), .O(new_n201_));
  nand2  g139(.a(new_n85_), .b(new_n201_), .O(new_n202_));
  aoi21  g140(.a(new_n200_), .b(new_n87_), .c(new_n202_), .O(new_n203_));
  oai22  g141(.a(new_n203_), .b(new_n84_), .c(new_n94_), .d(new_n126_), .O(z18));
  oai22  g142(.a(new_n76_), .b(x35), .c(new_n87_), .d(x27), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n149_), .O(new_n206_));
  nor2   g144(.a(x40), .b(x35), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(new_n96_), .c(x31), .O(new_n208_));
  ...
  nand3  g151(.a(new_n213_), .b(new_n85_), .c(new_n201_), .O(new_n214_));
  nand2  g152(.a(new_n214_), .b(new_n82_), .O(z20));
  nor2   g153(.a(new_n153_), .b(x09), .O(z19));
endmodule
