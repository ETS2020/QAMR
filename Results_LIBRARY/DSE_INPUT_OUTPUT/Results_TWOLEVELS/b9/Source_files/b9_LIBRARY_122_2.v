...
module FAU ( 
  ...
  aoi21  g034(.a(new_n68_), .b(new_n92_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g040(.a(new_n64_), .b(new_n92_), .c(new_n83_), .O(new_n103_));
  ...
  nor2   g059(.a(x40), .b(x12), .O(new_n122_));
  ...
  nand3  g063(.a(new_n125_), .b(new_n85_), .c(new_n74_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n75_), .O(new_n149_));
  aoi21  g087(.a(x39), .b(new_n74_), .c(new_n63_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n122_), .c(new_n71_), .O(new_n151_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n74_), .c(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n161_), .O(z13));
  nand3  g102(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n165_));
  nand4  g103(.a(new_n154_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n166_));
  nand3  g104(.a(x39), .b(new_n153_), .c(new_n74_), .O(new_n167_));
  ...
  nand3  g115(.a(new_n71_), .b(new_n63_), .c(new_n177_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n176_), .c(new_n170_), .O(z14));
  nand4  g117(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n63_), .O(z15));
  ...
  oai22  g125(.a(new_n116_), .b(new_n141_), .c(new_n84_), .d(x27), .O(new_n188_));
  ...
  aoi21  g132(.a(new_n142_), .b(new_n140_), .c(new_n194_), .O(new_n195_));
