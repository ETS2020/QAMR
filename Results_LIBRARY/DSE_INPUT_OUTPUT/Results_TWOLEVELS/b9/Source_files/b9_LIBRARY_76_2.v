...
module FAU ( 
  ...
  aoi21  g034(.a(new_n96_), .b(new_n91_), .c(new_n73_), .O(z05));
  nand3  g035(.a(new_n96_), .b(new_n70_), .c(new_n91_), .O(new_n98_));
  ...
  nand2  g057(.a(new_n75_), .b(new_n74_), .O(new_n120_));
  nand3  g058(.a(new_n120_), .b(x39), .c(x05), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n115_), .O(new_n123_));
  nand3  g061(.a(x37), .b(x27), .c(x06), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n123_), .c(new_n70_), .O(z10));
  inv1   g063(.a(x09), .O(new_n126_));
  oai21  g064(.a(new_n69_), .b(x29), .c(x39), .O(new_n127_));
  ...
  nand3  g068(.a(x35), .b(new_n77_), .c(new_n115_), .O(new_n131_));
  aoi22  g069(.a(new_n131_), .b(x40), .c(new_n70_), .d(new_n90_), .O(new_n132_));
  oai21  g070(.a(new_n132_), .b(x08), .c(new_n130_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(new_n74_), .c(new_n126_), .O(new_n134_));
  inv1   g072(.a(new_n134_), .O(z11));
  nor2   g073(.a(new_n64_), .b(new_n90_), .O(new_n136_));
  inv1   g074(.a(x35), .O(new_n137_));
  nand3  g075(.a(new_n91_), .b(new_n76_), .c(new_n137_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x27), .c(x10), .O(new_n139_));
  nor2   g077(.a(new_n136_), .b(new_n115_), .O(new_n140_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n146_), .c(new_n90_), .O(new_n151_));
  inv1   g089(.a(x39), .O(new_n152_));
  nand3  g090(.a(new_n120_), .b(new_n143_), .c(new_n115_), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x40), .c(new_n152_), .O(new_n154_));
  or2    g092(.a(new_n154_), .b(new_n151_), .O(z13));
  aoi21  g093(.a(new_n143_), .b(new_n115_), .c(new_n69_), .O(new_n156_));
  nand4  g094(.a(x27), .b(x20), .c(new_n148_), .d(new_n147_), .O(new_n157_));
  oai22  g095(.a(new_n157_), .b(new_n64_), .c(new_n156_), .d(new_n152_), .O(new_n158_));
  ...
  oai21  g099(.a(new_n161_), .b(new_n77_), .c(x27), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x40), .c(new_n75_), .d(new_n74_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n158_), .O(z14));
  inv1   g102(.a(x12), .O(new_n165_));
  nor2   g103(.a(new_n113_), .b(new_n165_), .O(z15));
  inv1   g104(.a(x23), .O(new_n167_));
  nand4  g105(.a(new_n70_), .b(new_n167_), .c(x22), .d(x01), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(z16));
  inv1   g107(.a(x24), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x23), .c(x22), .d(x01), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n70_), .O(z17));
  inv1   g110(.a(x29), .O(new_n173_));
  oai22  g111(.a(new_n78_), .b(x27), .c(new_n152_), .d(new_n173_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x08), .O(new_n175_));
  nor2   g113(.a(new_n90_), .b(x04), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n84_), .c(x09), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n70_), .d(new_n74_), .O(z18));
  nand2  g116(.a(new_n134_), .b(new_n70_), .O(z19));
  oai21  g117(.a(new_n77_), .b(x27), .c(x35), .O(new_n180_));
  and2   g118(.a(new_n180_), .b(new_n127_), .O(new_n181_));
  nand2  g119(.a(new_n70_), .b(new_n90_), .O(new_n182_));
  nand2  g120(.a(x40), .b(new_n137_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(x08), .O(new_n184_));
  oai21  g122(.a(new_n184_), .b(new_n181_), .c(new_n74_), .O(new_n185_));
