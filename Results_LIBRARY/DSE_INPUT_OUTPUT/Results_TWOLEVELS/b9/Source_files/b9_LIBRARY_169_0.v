...
module FAU ( 
  ...
  oai21  g031(.a(new_n93_), .b(new_n88_), .c(x39), .O(new_n94_));
  nand2  g032(.a(x40), .b(new_n78_), .O(new_n95_));
  ...
  nand2  g043(.a(new_n80_), .b(new_n64_), .O(new_n106_));
  oai21  g044(.a(x40), .b(x39), .c(new_n89_), .O(new_n107_));
  ...
  nor3   g067(.a(new_n97_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  aoi21  g068(.a(new_n128_), .b(new_n65_), .c(new_n130_), .O(new_n131_));
  oai21  g069(.a(x32), .b(x30), .c(x40), .O(new_n132_));
  nor2   g070(.a(new_n132_), .b(new_n78_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x05), .c(new_n65_), .O(new_n134_));
  oai21  g072(.a(new_n131_), .b(new_n64_), .c(new_n134_), .O(z10));
  nand3  g073(.a(x35), .b(new_n89_), .c(new_n65_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x39), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n106_), .c(x08), .O(new_n138_));
  inv1   g076(.a(x29), .O(new_n139_));
  oai21  g077(.a(new_n79_), .b(new_n139_), .c(x39), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  aoi22  g079(.a(new_n141_), .b(new_n84_), .c(new_n140_), .d(new_n95_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n138_), .c(new_n82_), .O(new_n143_));
  nor2   g081(.a(new_n143_), .b(x09), .O(z11));
  inv1   g082(.a(x10), .O(new_n145_));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  nor2   g084(.a(new_n78_), .b(x27), .O(new_n147_));
  ...
  aoi21  g088(.a(x40), .b(new_n65_), .c(new_n78_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n149_), .c(new_n150_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n148_), .c(new_n80_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(x28), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x40), .c(new_n154_), .d(new_n65_), .O(new_n157_));
  inv1   g095(.a(x18), .O(new_n158_));
  inv1   g096(.a(x19), .O(new_n159_));
  nand4  g097(.a(new_n72_), .b(x20), .c(new_n159_), .d(new_n158_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n157_), .c(new_n78_), .O(new_n161_));
  nand4  g099(.a(new_n72_), .b(x40), .c(x20), .d(new_n159_), .O(new_n162_));
  ...
  nand4  g105(.a(new_n155_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n168_));
  nand3  g106(.a(x40), .b(new_n154_), .c(new_n65_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n78_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n149_), .c(new_n167_), .O(new_n172_));
  nand4  g110(.a(x39), .b(new_n70_), .c(new_n66_), .d(x28), .O(new_n173_));
  nand2  g111(.a(x40), .b(new_n64_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(x32), .O(new_n175_));
  oai21  g113(.a(new_n170_), .b(new_n78_), .c(new_n95_), .O(new_n176_));
  aoi22  g114(.a(new_n176_), .b(new_n150_), .c(new_n175_), .d(new_n82_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n172_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nand4  g117(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n179_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x22), .c(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n80_), .O(z16));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(x23), .c(x22), .d(x01), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n80_), .O(z17));
  oai22  g125(.a(new_n90_), .b(x27), .c(new_n120_), .d(new_n139_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n84_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n80_), .d(new_n82_), .O(z18));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  aoi21  g131(.a(new_n140_), .b(new_n95_), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(x39), .b(new_n66_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n106_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n82_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(x09), .O(z20));
  nor2   g136(.a(new_n143_), .b(x09), .O(z19));
endmodule
