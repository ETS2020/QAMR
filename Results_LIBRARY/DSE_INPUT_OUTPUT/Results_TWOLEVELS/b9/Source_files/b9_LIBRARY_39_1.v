...
module FAU ( 
  ...
  aoi21  g070(.a(x39), .b(new_n132_), .c(new_n74_), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n131_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n64_), .b(new_n93_), .O(new_n136_));
  ...
  oai22  g083(.a(new_n145_), .b(new_n93_), .c(new_n74_), .d(x04), .O(new_n146_));
  ...
  aoi21  g094(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n72_), .c(new_n63_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n74_), .c(new_n156_), .O(z13));
  nor2   g097(.a(new_n74_), .b(x04), .O(new_n160_));
  oai21  g098(.a(new_n157_), .b(new_n63_), .c(new_n160_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n93_), .O(new_n162_));
  nand3  g100(.a(x40), .b(new_n148_), .c(new_n72_), .O(new_n163_));
  ...
  nand2  g118(.a(new_n93_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n179_), .O(new_n182_));
  inv1   g120(.a(x09), .O(new_n183_));
  nand2  g121(.a(new_n80_), .b(new_n183_), .O(new_n184_));
  aoi21  g122(.a(new_n182_), .b(new_n83_), .c(new_n184_), .O(new_n185_));
  inv1   g123(.a(new_n90_), .O(new_n186_));
  nand2  g124(.a(z08), .b(new_n186_), .O(new_n187_));
  oai21  g125(.a(new_n185_), .b(new_n79_), .c(new_n187_), .O(z18));
  aoi21  g126(.a(x40), .b(new_n63_), .c(x08), .O(new_n189_));
  aoi21  g127(.a(x40), .b(x29), .c(new_n83_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n189_), .c(new_n93_), .O(new_n191_));
  oai21  g129(.a(new_n186_), .b(new_n63_), .c(x40), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n179_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n80_), .c(new_n183_), .O(new_n195_));
