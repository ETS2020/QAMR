...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x26), .O(new_n81_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n100_), .c(new_n83_), .O(z03));
  ...
  oai22  g045(.a(x40), .b(new_n97_), .c(new_n86_), .d(new_n64_), .O(new_n108_));
  nor2   g046(.a(new_n108_), .b(x37), .O(z06));
  ...
  nor2   g059(.a(new_n121_), .b(new_n80_), .O(z09));
  ...
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n83_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n81_), .d(new_n64_), .O(new_n136_));
  nand2  g074(.a(x39), .b(x29), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x40), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n98_), .O(new_n139_));
  ...
  oai21  g080(.a(new_n136_), .b(x08), .c(new_n142_), .O(new_n143_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n80_), .c(new_n97_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n149_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n80_), .O(new_n155_));
  ...
  nand3  g099(.a(new_n127_), .b(x40), .c(x39), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n65_), .c(new_n83_), .O(new_n164_));
  ...
  nand4  g105(.a(new_n154_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n168_));
  nand3  g106(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n80_), .O(new_n171_));
  ...
  nand3  g116(.a(new_n178_), .b(new_n172_), .c(new_n151_), .O(z14));
  nand4  g117(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n80_), .O(z15));
  ...
  nor2   g128(.a(new_n66_), .b(x28), .O(new_n191_));
  nor2   g129(.a(new_n64_), .b(x04), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n190_), .c(new_n81_), .d(new_n84_), .O(z18));
  nand2  g132(.a(new_n144_), .b(new_n81_), .O(z19));
  nor2   g133(.a(x40), .b(x35), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n93_), .c(new_n97_), .O(new_n197_));
  aoi21  g135(.a(x35), .b(x27), .c(x08), .O(new_n198_));
  aoi21  g136(.a(x39), .b(x29), .c(x35), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(x40), .O(new_n200_));
  nand3  g138(.a(new_n188_), .b(x28), .c(new_n64_), .O(new_n201_));
