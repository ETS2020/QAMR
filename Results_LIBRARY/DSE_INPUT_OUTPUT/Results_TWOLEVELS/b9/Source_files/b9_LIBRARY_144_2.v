...
module FAU ( 
  ...
  nor2   g054(.a(new_n69_), .b(new_n90_), .O(z08));
  ...
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n70_), .d(new_n85_), .O(new_n136_));
  ...
  aoi21  g094(.a(new_n156_), .b(x40), .c(new_n90_), .O(new_n157_));
  ...
  nand2  g126(.a(x40), .b(new_n141_), .O(new_n189_));
