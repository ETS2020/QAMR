...
module FAU ( 
  ...
  aoi22  g031(.a(new_n93_), .b(new_n92_), .c(x28), .d(x04), .O(new_n94_));
  ...
  nand2  g044(.a(new_n82_), .b(new_n64_), .O(new_n107_));
  oai21  g045(.a(x40), .b(x34), .c(new_n86_), .O(new_n108_));
  aoi21  g046(.a(new_n108_), .b(new_n107_), .c(x37), .O(z06));
  ...
  nand2  g063(.a(new_n76_), .b(x34), .O(new_n126_));
  ...
  nand2  g073(.a(new_n85_), .b(new_n84_), .O(new_n136_));
  ...
  aoi21  g079(.a(new_n141_), .b(new_n107_), .c(x08), .O(new_n142_));
  ...
  aoi22  g084(.a(new_n146_), .b(new_n143_), .c(new_n145_), .d(new_n126_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n142_), .c(new_n84_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(x09), .c(new_n82_), .O(z11));
  ...
  nand2  g093(.a(new_n155_), .b(x34), .O(new_n156_));
  ...
  nor2   g104(.a(new_n137_), .b(x13), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n65_), .c(new_n98_), .O(new_n168_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n98_), .c(new_n93_), .d(new_n121_), .O(z18));
  nor2   g135(.a(new_n148_), .b(x09), .O(z19));
  nand2  g136(.a(x28), .b(new_n64_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n145_), .d(new_n126_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n107_), .c(x08), .O(new_n202_));
