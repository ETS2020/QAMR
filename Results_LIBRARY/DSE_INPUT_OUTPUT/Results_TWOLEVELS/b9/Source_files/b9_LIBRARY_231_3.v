...
module FAU ( 
  ...
  aoi21  g54(.a(new_n66_), .b(x27), .c(z08), .O(z12));
  nand4  g55(.a(z02), .b(new_n66_), .c(x27), .d(x20), .O(new_n118_));
  nor3   g56(.a(new_n118_), .b(x19), .c(x18), .O(z13));
  nor2   g57(.a(x19), .b(x18), .O(new_n120_));
  nand3  g58(.a(new_n120_), .b(x27), .c(x20), .O(new_n121_));
  inv1   g59(.a(new_n121_), .O(new_n122_));
  aoi21  g60(.a(new_n122_), .b(new_n66_), .c(z08), .O(z14));
  inv1   g61(.a(x12), .O(new_n124_));
  nor2   g62(.a(new_n102_), .b(new_n124_), .O(z15));
  inv1   g63(.a(x23), .O(new_n126_));
  nand3  g64(.a(new_n126_), .b(x22), .c(x01), .O(new_n127_));
  nand2  g65(.a(new_n127_), .b(z02), .O(z16));
  ...
  nand2  g70(.a(new_n80_), .b(x08), .O(new_n133_));
  oai21  g71(.a(new_n80_), .b(x04), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g75(.a(new_n115_), .b(z02), .O(z19));
