...
module FAU ( 
  ...
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n82_), .O(z03));
  aoi21  g037(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n82_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n80_), .c(new_n70_), .O(z05));
  nand2  g041(.a(new_n80_), .b(new_n64_), .O(new_n104_));
  ...
  aoi21  g060(.a(x35), .b(new_n105_), .c(x36), .O(new_n123_));
  ...
  nor3   g066(.a(new_n82_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g073(.a(x35), .b(new_n105_), .c(new_n65_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n80_), .d(new_n64_), .O(new_n137_));
  nand2  g075(.a(x40), .b(new_n78_), .O(new_n138_));
  ...
  inv1   g089(.a(new_n138_), .O(new_n152_));
  nand2  g090(.a(new_n72_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(x40), .b(new_n65_), .c(new_n78_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(new_n153_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n151_), .c(new_n80_), .O(z12));
  ...
  nand3  g109(.a(x40), .b(new_n157_), .c(new_n65_), .O(new_n172_));
  ...
  aoi21  g134(.a(new_n195_), .b(new_n105_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n82_), .c(new_n90_), .d(new_n119_), .O(z18));
  inv1   g136(.a(new_n146_), .O(z19));
  nand2  g137(.a(x28), .b(new_n64_), .O(new_n200_));
  aoi22  g138(.a(new_n200_), .b(x35), .c(new_n140_), .d(new_n138_), .O(new_n201_));
  nand2  g139(.a(x39), .b(new_n66_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n104_), .c(x08), .O(new_n203_));
