...
module FAU ( 
  ...
  aoi21  g20(.a(new_n83_), .b(new_n80_), .c(new_n64_), .O(z04));
  ...
  nand4  g38(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n103_));
  ...
  nand2  g50(.a(new_n66_), .b(new_n114_), .O(new_n115_));
  nand4  g51(.a(new_n115_), .b(new_n113_), .c(x35), .d(new_n112_), .O(new_n116_));
  nand3  g52(.a(new_n116_), .b(new_n72_), .c(new_n111_), .O(new_n117_));
  nand2  g53(.a(new_n117_), .b(new_n63_), .O(z11));
  nor2   g54(.a(new_n69_), .b(new_n64_), .O(z12));
  nand2  g55(.a(new_n68_), .b(new_n67_), .O(new_n120_));
  nand4  g56(.a(new_n120_), .b(new_n63_), .c(x27), .d(x20), .O(new_n121_));
  nor3   g57(.a(new_n121_), .b(x19), .c(x18), .O(z13));
  nor2   g58(.a(x19), .b(x18), .O(new_n123_));
  nand4  g59(.a(new_n123_), .b(new_n69_), .c(new_n63_), .d(x20), .O(z14));
  inv1   g60(.a(x12), .O(new_n125_));
  nor2   g61(.a(new_n103_), .b(new_n125_), .O(z15));
  ...
  nand2  g68(.a(x27), .b(new_n105_), .O(new_n133_));
  oai21  g69(.a(x27), .b(new_n114_), .c(new_n133_), .O(new_n134_));
  nand3  g70(.a(new_n134_), .b(x35), .c(new_n112_), .O(new_n135_));
  nor2   g71(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g72(.a(new_n136_), .b(new_n135_), .c(new_n64_), .O(z18));
  oai21  g73(.a(x28), .b(new_n114_), .c(new_n66_), .O(new_n138_));
  nand2  g74(.a(new_n138_), .b(x35), .O(new_n139_));
  nand3  g75(.a(new_n139_), .b(new_n72_), .c(new_n111_), .O(new_n140_));
  nand2  g76(.a(new_n140_), .b(new_n63_), .O(z20));
  one    g77(.O(z02));
  zero   g78(.O(z08));
  nand2  g79(.a(new_n117_), .b(new_n63_), .O(z19));
endmodule
