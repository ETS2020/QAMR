...
module FAU ( 
  ...
  nor2   g16(.a(x28), .b(new_n78_), .O(new_n79_));
  inv1   g17(.a(x28), .O(new_n80_));
  nor2   g18(.a(x37), .b(new_n80_), .O(new_n81_));
  aoi21  g19(.a(new_n81_), .b(new_n79_), .c(z08), .O(z02));
  nand2  g20(.a(new_n65_), .b(x27), .O(new_n83_));
  aoi21  g21(.a(new_n64_), .b(new_n78_), .c(z08), .O(new_n84_));
  ...
  aoi21  g27(.a(new_n68_), .b(new_n80_), .c(new_n78_), .O(new_n90_));
  ...
  nand2  g41(.a(new_n103_), .b(new_n68_), .O(z07));
  nand4  g42(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n105_));
  nand2  g43(.a(new_n105_), .b(new_n68_), .O(z09));
  ...
  nand3  g48(.a(new_n110_), .b(new_n68_), .c(x27), .O(new_n111_));
  inv1   g49(.a(new_n111_), .O(z10));
  inv1   g50(.a(x09), .O(new_n113_));
  nand2  g51(.a(x27), .b(x04), .O(new_n114_));
  inv1   g52(.a(x08), .O(new_n115_));
  nand2  g53(.a(new_n78_), .b(new_n115_), .O(new_n116_));
  nand4  g54(.a(new_n116_), .b(new_n114_), .c(x35), .d(new_n80_), .O(new_n117_));
  nand4  g55(.a(new_n117_), .b(new_n68_), .c(new_n71_), .d(new_n113_), .O(new_n118_));
  inv1   g56(.a(new_n118_), .O(z11));
  aoi21  g57(.a(new_n66_), .b(x27), .c(z08), .O(z12));
  nand4  g58(.a(new_n68_), .b(new_n66_), .c(x27), .d(x20), .O(new_n121_));
  ...
  aoi21  g63(.a(new_n125_), .b(new_n66_), .c(z08), .O(z14));
  inv1   g64(.a(x12), .O(new_n127_));
  nand4  g65(.a(new_n68_), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  nor2   g66(.a(new_n128_), .b(new_n127_), .O(z15));
  inv1   g67(.a(x23), .O(new_n130_));
  nand3  g68(.a(new_n130_), .b(x22), .c(x01), .O(new_n131_));
  nand2  g69(.a(new_n131_), .b(new_n68_), .O(z16));
  inv1   g70(.a(x01), .O(new_n133_));
  inv1   g71(.a(x24), .O(new_n134_));
  nand4  g72(.a(new_n68_), .b(new_n134_), .c(x23), .d(x22), .O(new_n135_));
  nor2   g73(.a(new_n135_), .b(new_n133_), .O(z17));
  nand2  g74(.a(x27), .b(new_n107_), .O(new_n137_));
  oai21  g75(.a(x27), .b(new_n115_), .c(new_n137_), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(x35), .c(new_n80_), .O(new_n139_));
  nand4  g77(.a(new_n139_), .b(new_n68_), .c(new_n71_), .d(new_n113_), .O(z18));
  oai21  g78(.a(x28), .b(new_n115_), .c(new_n78_), .O(new_n141_));
  nand2  g79(.a(new_n141_), .b(x35), .O(new_n142_));
  nand4  g80(.a(new_n142_), .b(new_n68_), .c(new_n71_), .d(new_n113_), .O(new_n143_));
  inv1   g81(.a(new_n143_), .O(z20));
  inv1   g82(.a(new_n118_), .O(z19));
endmodule
