...
module FAU ( 
  ...
  inv1   g043(.a(x26), .O(new_n106_));
  oai22  g044(.a(x40), .b(new_n106_), .c(new_n83_), .d(new_n99_), .O(new_n107_));
  ...
  aoi21  g058(.a(new_n120_), .b(x40), .c(new_n106_), .O(z09));
  inv1   g059(.a(x07), .O(new_n122_));
  nor2   g060(.a(x40), .b(x26), .O(new_n123_));
  ...
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n123_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n68_), .b(new_n82_), .c(new_n147_), .O(new_n148_));
  ...
  nand3  g089(.a(new_n71_), .b(new_n63_), .c(new_n106_), .O(new_n152_));
  ...
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n154_), .d(new_n74_), .O(new_n157_));
  ...
  nor2   g100(.a(new_n133_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n74_), .c(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n162_), .O(z13));
  inv1   g103(.a(new_n123_), .O(new_n166_));
  oai21  g104(.a(new_n94_), .b(x04), .c(x40), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n154_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n71_), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n170_));
  nand4  g108(.a(new_n155_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(z08), .c(new_n154_), .d(new_n74_), .O(new_n172_));
  ...
  nand4  g114(.a(new_n176_), .b(new_n173_), .c(new_n169_), .d(new_n64_), .O(z14));
  nand3  g115(.a(x34), .b(x27), .c(x12), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(x40), .c(new_n106_), .O(z15));
  ...
  nand2  g125(.a(x27), .b(new_n74_), .O(new_n188_));
  nand2  g126(.a(new_n99_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n147_), .O(new_n190_));
  inv1   g128(.a(x09), .O(new_n191_));
  nand2  g129(.a(new_n80_), .b(new_n191_), .O(new_n192_));
  aoi21  g130(.a(new_n190_), .b(new_n83_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n65_), .c(new_n187_), .d(new_n90_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n92_), .c(new_n106_), .O(new_n196_));
  ...
  nand3  g138(.a(new_n200_), .b(x28), .c(new_n99_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n199_), .c(new_n196_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n80_), .c(new_n191_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n64_), .O(z20));
