...
module FAU ( 
  ...
  nor2   g032(.a(x40), .b(x06), .O(new_n95_));
  ...
  inv1   g043(.a(x06), .O(new_n106_));
  oai22  g044(.a(x40), .b(new_n106_), .c(new_n82_), .d(new_n68_), .O(new_n107_));
  ...
  nand3  g055(.a(new_n117_), .b(new_n64_), .c(x03), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z07));
  nand2  g057(.a(x40), .b(x39), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n64_), .O(z08));
  nand4  g059(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n64_), .O(z09));
  oai21  g061(.a(new_n69_), .b(new_n68_), .c(x40), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x06), .O(new_n125_));
  ...
  nand3  g092(.a(new_n154_), .b(new_n63_), .c(new_n106_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n152_), .O(z12));
  inv1   g094(.a(x13), .O(new_n157_));
  nand2  g095(.a(x36), .b(x35), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x28), .c(new_n63_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(x39), .c(new_n157_), .d(new_n73_), .O(new_n160_));
  inv1   g098(.a(x18), .O(new_n161_));
  inv1   g099(.a(x19), .O(new_n162_));
  nand4  g100(.a(new_n153_), .b(x20), .c(new_n162_), .d(new_n161_), .O(new_n163_));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n73_), .c(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n165_), .O(z13));
  nand3  g106(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n169_));
  nand4  g107(.a(new_n158_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n170_));
  nand3  g108(.a(x39), .b(new_n157_), .c(new_n73_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n63_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n95_), .c(new_n169_), .O(new_n174_));
  nand3  g112(.a(new_n69_), .b(new_n141_), .c(x28), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n80_), .c(new_n79_), .O(new_n177_));
  nand2  g115(.a(new_n171_), .b(new_n154_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n174_), .c(new_n155_), .O(z14));
  inv1   g119(.a(x12), .O(new_n182_));
  nand4  g120(.a(new_n64_), .b(x34), .c(x27), .d(x26), .O(new_n183_));
  ...
  nand2  g129(.a(x27), .b(new_n73_), .O(new_n192_));
  nand2  g130(.a(new_n68_), .b(x08), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(new_n141_), .O(new_n194_));
  inv1   g132(.a(x09), .O(new_n195_));
  nand2  g133(.a(new_n79_), .b(new_n195_), .O(new_n196_));
  aoi21  g134(.a(new_n194_), .b(new_n82_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n65_), .c(new_n120_), .d(new_n89_), .O(z18));
  nor2   g136(.a(x40), .b(x35), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n91_), .c(new_n106_), .O(new_n200_));
  aoi21  g138(.a(x35), .b(x27), .c(x08), .O(new_n201_));
  aoi21  g139(.a(x39), .b(x29), .c(x35), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n201_), .c(x40), .O(new_n203_));
  nand3  g141(.a(x40), .b(x39), .c(x29), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(x28), .c(new_n68_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n203_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n79_), .c(new_n195_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n64_), .O(z20));
