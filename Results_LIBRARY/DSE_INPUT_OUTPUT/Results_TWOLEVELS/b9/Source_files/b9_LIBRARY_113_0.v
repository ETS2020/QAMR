...
module FAU ( 
  ...
  nand2  g029(.a(new_n69_), .b(new_n89_), .O(new_n92_));
  inv1   g030(.a(x35), .O(new_n93_));
  nand2  g031(.a(x40), .b(new_n93_), .O(new_n94_));
  nand3  g032(.a(new_n94_), .b(new_n92_), .c(new_n83_), .O(new_n95_));
  ...
  aoi21  g038(.a(new_n70_), .b(new_n69_), .c(new_n100_), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n66_), .O(z03));
  aoi21  g040(.a(new_n70_), .b(new_n69_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n99_), .c(new_n66_), .O(z04));
  aoi21  g042(.a(x28), .b(x27), .c(x37), .O(new_n105_));
  nor2   g043(.a(new_n105_), .b(new_n66_), .O(z05));
  oai22  g044(.a(x40), .b(x23), .c(new_n83_), .d(new_n69_), .O(new_n107_));
  ...
  nand2  g057(.a(new_n96_), .b(new_n65_), .O(z08));
  ...
  nand2  g064(.a(new_n64_), .b(x23), .O(new_n127_));
  ...
  nand2  g076(.a(new_n65_), .b(new_n69_), .O(new_n139_));
  ...
  oai21  g080(.a(new_n125_), .b(new_n90_), .c(x40), .O(new_n143_));
  nand2  g081(.a(x27), .b(x04), .O(new_n144_));
  aoi22  g082(.a(new_n144_), .b(new_n142_), .c(new_n143_), .d(new_n127_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n141_), .c(new_n80_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(x09), .c(new_n65_), .O(z11));
  nand3  g085(.a(new_n70_), .b(new_n82_), .c(new_n93_), .O(new_n148_));
  ...
  nand2  g120(.a(new_n182_), .b(new_n65_), .O(z15));
  nand2  g121(.a(x22), .b(x01), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(x40), .c(x23), .O(z16));
  inv1   g123(.a(x24), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x23), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n184_), .c(new_n65_), .O(z17));
  oai22  g126(.a(new_n96_), .b(new_n90_), .c(new_n84_), .d(x27), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n69_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n142_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n65_), .d(new_n80_), .O(z18));
  nor2   g131(.a(new_n146_), .b(x09), .O(z19));
  aoi21  g132(.a(x28), .b(new_n69_), .c(new_n93_), .O(new_n195_));
  aoi21  g133(.a(new_n143_), .b(new_n127_), .c(new_n195_), .O(new_n196_));
  aoi21  g134(.a(new_n139_), .b(new_n94_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n196_), .c(new_n80_), .O(new_n198_));
