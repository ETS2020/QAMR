...
module FAU ( 
  ...
  oai21  g047(.a(new_n107_), .b(x37), .c(new_n82_), .O(z06));
  ...
  nand3  g053(.a(x38), .b(new_n81_), .c(new_n113_), .O(new_n116_));
  inv1   g054(.a(new_n116_), .O(new_n117_));
  oai22  g055(.a(new_n117_), .b(x14), .c(new_n115_), .d(x31), .O(new_n118_));
  ...
  nor2   g079(.a(x40), .b(new_n81_), .O(new_n142_));
  aoi21  g080(.a(x39), .b(x29), .c(new_n76_), .O(new_n143_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n140_), .c(new_n84_), .O(new_n147_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n76_), .c(x25), .O(new_n154_));
  ...
  nand4  g101(.a(new_n72_), .b(x25), .c(x20), .d(new_n161_), .O(new_n164_));
  ...
  oai21  g107(.a(new_n75_), .b(x04), .c(x40), .O(new_n170_));
  nor2   g108(.a(new_n142_), .b(x13), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n170_), .c(new_n169_), .O(new_n172_));
  ...
  nand3  g113(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n176_));
  nand4  g114(.a(new_n157_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(new_n178_));
  nand4  g116(.a(x40), .b(x39), .c(new_n156_), .d(new_n65_), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n178_), .c(new_n176_), .O(new_n180_));
  aoi21  g118(.a(x27), .b(x25), .c(x40), .O(new_n181_));
  nand3  g119(.a(x39), .b(new_n156_), .c(new_n65_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x40), .O(new_n183_));
  oai21  g121(.a(x32), .b(x30), .c(new_n183_), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n64_), .c(new_n181_), .O(new_n185_));
  ...
  nand2  g136(.a(new_n84_), .b(new_n198_), .O(new_n199_));
  aoi21  g137(.a(new_n197_), .b(new_n86_), .c(new_n199_), .O(new_n200_));
  oai22  g138(.a(new_n200_), .b(new_n102_), .c(new_n93_), .d(new_n121_), .O(z18));
  ...
  aoi21  g142(.a(new_n204_), .b(new_n138_), .c(x08), .O(new_n205_));
