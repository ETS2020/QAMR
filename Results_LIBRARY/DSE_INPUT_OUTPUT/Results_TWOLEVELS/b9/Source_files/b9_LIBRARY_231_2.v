...
module FAU ( 
  ...
  nand3  g066(.a(new_n128_), .b(x05), .c(new_n117_), .O(new_n129_));
  ...
  nand3  g071(.a(new_n133_), .b(x35), .c(new_n99_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n99_), .c(new_n117_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n70_), .d(new_n91_), .O(new_n137_));
  ...
  nor2   g078(.a(new_n64_), .b(new_n91_), .O(new_n141_));
  nand3  g079(.a(new_n92_), .b(new_n77_), .c(new_n76_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(x27), .c(x10), .O(new_n143_));
  nor2   g081(.a(new_n141_), .b(new_n117_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x40), .O(new_n145_));
  oai21  g083(.a(new_n141_), .b(x39), .c(new_n145_), .O(z12));
  ...
  nand2  g090(.a(new_n88_), .b(new_n92_), .O(new_n153_));
  ...
  nand4  g093(.a(new_n153_), .b(new_n126_), .c(x20), .d(new_n152_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n128_), .b(new_n147_), .c(new_n117_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  aoi21  g098(.a(new_n147_), .b(new_n117_), .c(new_n69_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .d(new_n126_), .O(new_n163_));
  ...
  nand2  g119(.a(new_n74_), .b(new_n131_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n99_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n73_), .c(new_n120_), .d(new_n83_), .O(z18));
  nand2  g122(.a(new_n139_), .b(new_n70_), .O(z19));
  aoi21  g123(.a(new_n69_), .b(x39), .c(x08), .O(new_n186_));
  aoi21  g124(.a(x39), .b(x29), .c(new_n99_), .O(new_n187_));
