...
module FAU ( 
  ...
  nand4  g040(.a(new_n102_), .b(new_n98_), .c(new_n81_), .d(new_n99_), .O(z04));
  ...
  nand2  g061(.a(x39), .b(x05), .O(new_n124_));
  ...
  nand2  g077(.a(new_n80_), .b(new_n139_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(x35), .c(new_n85_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  oai21  g082(.a(new_n136_), .b(x08), .c(new_n144_), .O(new_n145_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n150_), .c(new_n81_), .O(z12));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n157_), .c(new_n80_), .O(new_n161_));
  nor2   g099(.a(new_n160_), .b(x05), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n161_), .c(x27), .O(new_n163_));
  aoi21  g101(.a(new_n84_), .b(new_n83_), .c(new_n80_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n154_), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(z13));
  nand3  g104(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n167_));
  nand4  g105(.a(new_n155_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  nand3  g107(.a(new_n76_), .b(new_n154_), .c(new_n65_), .O(new_n170_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n151_), .c(new_n97_), .O(new_n175_));
  ...
  nand2  g125(.a(new_n83_), .b(new_n134_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n85_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n97_), .c(new_n92_), .d(new_n75_), .O(z18));
  inv1   g128(.a(new_n146_), .O(z19));
  nor2   g129(.a(x40), .b(x35), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n94_), .c(new_n139_), .O(new_n193_));
  ...
  nand3  g137(.a(new_n199_), .b(new_n83_), .c(new_n134_), .O(new_n200_));
