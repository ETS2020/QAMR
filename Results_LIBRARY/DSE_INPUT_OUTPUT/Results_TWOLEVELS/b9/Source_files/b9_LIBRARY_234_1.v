...
module FAU ( 
  ...
  aoi21  g037(.a(new_n99_), .b(new_n66_), .c(new_n64_), .O(z05));
  nand3  g038(.a(new_n99_), .b(new_n65_), .c(new_n66_), .O(new_n101_));
  ...
  nor2   g068(.a(new_n91_), .b(new_n72_), .O(new_n131_));
  oai22  g069(.a(new_n131_), .b(new_n83_), .c(new_n63_), .d(new_n130_), .O(new_n132_));
  nand2  g070(.a(x39), .b(x04), .O(new_n133_));
  nand4  g071(.a(new_n133_), .b(x35), .c(new_n82_), .d(x27), .O(new_n134_));
  ...
  nor2   g077(.a(new_n114_), .b(x27), .O(new_n140_));
  ...
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n114_), .O(new_n151_));
  ...
  nand4  g092(.a(new_n123_), .b(x39), .c(new_n144_), .d(new_n72_), .O(new_n155_));
  ...
  nand2  g097(.a(new_n159_), .b(new_n68_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nor2   g099(.a(x37), .b(x35), .O(new_n162_));
  aoi21  g100(.a(new_n158_), .b(new_n145_), .c(new_n162_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n82_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n80_), .c(new_n79_), .O(new_n165_));
  nand2  g103(.a(x39), .b(x13), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(x40), .c(new_n72_), .O(new_n167_));
  ...
  nand2  g118(.a(new_n91_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n179_), .O(new_n182_));
  nand2  g120(.a(new_n79_), .b(new_n129_), .O(new_n183_));
  ...
  nor2   g124(.a(new_n63_), .b(new_n130_), .O(new_n187_));
  oai21  g125(.a(new_n179_), .b(new_n91_), .c(new_n90_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n91_), .c(new_n179_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n79_), .c(new_n129_), .O(new_n191_));
