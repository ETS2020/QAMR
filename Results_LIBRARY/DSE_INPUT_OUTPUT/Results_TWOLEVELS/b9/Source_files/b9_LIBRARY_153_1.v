...
module FAU ( 
  ...
  oai21  g035(.a(new_n97_), .b(new_n96_), .c(new_n75_), .O(new_n98_));
  oai21  g036(.a(new_n95_), .b(new_n63_), .c(new_n98_), .O(z02));
  ...
  nand2  g042(.a(x40), .b(new_n63_), .O(new_n105_));
  ...
  aoi21  g064(.a(new_n84_), .b(new_n90_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n125_), .c(x30), .O(new_n128_));
  oai21  g066(.a(new_n84_), .b(x27), .c(new_n90_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x08), .O(new_n130_));
  inv1   g068(.a(x35), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(x04), .c(new_n83_), .O(new_n132_));
  nand2  g070(.a(new_n80_), .b(new_n123_), .O(new_n133_));
  ...
  aoi21  g074(.a(new_n136_), .b(x39), .c(new_n75_), .O(z08));
  ...
  nand3  g082(.a(new_n144_), .b(new_n85_), .c(new_n73_), .O(new_n145_));
  ...
  oai21  g095(.a(new_n131_), .b(x04), .c(x40), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n83_), .c(new_n63_), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(new_n89_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n155_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n80_), .c(new_n123_), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(z11));
  nand3  g101(.a(new_n67_), .b(new_n82_), .c(new_n131_), .O(new_n164_));
  ...
  oai21  g105(.a(new_n69_), .b(x40), .c(new_n167_), .O(z12));
  ...
  nand4  g115(.a(new_n175_), .b(new_n75_), .c(x20), .d(new_n174_), .O(new_n178_));
  ...
  oai21  g123(.a(new_n183_), .b(new_n75_), .c(new_n185_), .O(new_n186_));
  ...
  oai21  g126(.a(new_n188_), .b(new_n83_), .c(x27), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n190_));
  ...
  inv1   g138(.a(new_n91_), .O(new_n201_));
  nor2   g139(.a(new_n75_), .b(x39), .O(new_n202_));
  ...
  aoi21  g143(.a(new_n205_), .b(new_n83_), .c(new_n133_), .O(new_n206_));
  ...
  aoi21  g147(.a(x40), .b(x29), .c(new_n83_), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n209_), .c(new_n66_), .O(new_n211_));
  oai21  g149(.a(new_n91_), .b(new_n63_), .c(x40), .O(new_n212_));
  nand2  g150(.a(new_n212_), .b(new_n131_), .O(new_n213_));
  nand2  g151(.a(new_n213_), .b(new_n211_), .O(new_n214_));
  nand3  g152(.a(new_n214_), .b(new_n80_), .c(new_n123_), .O(new_n215_));
