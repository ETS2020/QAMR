...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n178_, new_n180_, new_n182_, new_n184_, new_n186_, new_n187_,
  ...
  nand2  g031(.a(new_n84_), .b(x04), .O(new_n94_));
  inv1   g032(.a(x09), .O(new_n95_));
  nand4  g033(.a(new_n81_), .b(new_n83_), .c(new_n64_), .d(new_n95_), .O(new_n96_));
  nand2  g034(.a(new_n79_), .b(x39), .O(new_n97_));
  aoi21  g035(.a(new_n96_), .b(new_n73_), .c(new_n97_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n94_), .c(new_n93_), .d(new_n91_), .O(z02));
  inv1   g037(.a(new_n79_), .O(new_n100_));
  oai21  g038(.a(new_n66_), .b(new_n83_), .c(x27), .O(new_n101_));
  inv1   g039(.a(x21), .O(new_n102_));
  inv1   g040(.a(x37), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n64_), .c(new_n102_), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n101_), .c(new_n100_), .O(z03));
  nand2  g043(.a(new_n103_), .b(new_n64_), .O(new_n106_));
  nand4  g044(.a(new_n106_), .b(new_n101_), .c(new_n79_), .d(new_n102_), .O(z04));
  nand2  g045(.a(x28), .b(x27), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n79_), .c(new_n103_), .O(z05));
  aoi21  g047(.a(new_n79_), .b(new_n64_), .c(new_n83_), .O(new_n110_));
  oai21  g048(.a(new_n110_), .b(x37), .c(new_n79_), .O(z06));
  ...
  nand3  g058(.a(new_n120_), .b(new_n79_), .c(x03), .O(new_n121_));
  inv1   g059(.a(new_n121_), .O(z07));
  aoi21  g060(.a(new_n72_), .b(x23), .c(new_n73_), .O(z08));
  ...
  nand4  g065(.a(x40), .b(x39), .c(x23), .d(x05), .O(new_n128_));
  oai21  g066(.a(z08), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n85_), .c(new_n65_), .O(new_n130_));
  nand3  g068(.a(new_n79_), .b(x37), .c(x06), .O(new_n131_));
  ...
  nand3  g087(.a(new_n103_), .b(new_n67_), .c(new_n66_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x27), .c(x10), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n65_), .c(new_n149_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(x23), .O(new_n153_));
  ...
  nand3  g104(.a(new_n135_), .b(new_n155_), .c(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  nand3  g106(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n169_));
  nand4  g107(.a(new_n156_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n74_), .c(new_n155_), .d(new_n65_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand3  g110(.a(new_n103_), .b(new_n66_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n82_), .c(new_n81_), .O(new_n175_));
  aoi21  g113(.a(x39), .b(new_n65_), .c(new_n78_), .O(new_n176_));
  nand2  g114(.a(x40), .b(new_n155_), .O(new_n177_));
  oai22  g115(.a(new_n177_), .b(new_n176_), .c(new_n70_), .d(new_n64_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n175_), .c(new_n172_), .d(new_n79_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nor2   g118(.a(new_n125_), .b(new_n180_), .O(z15));
  nand4  g119(.a(new_n73_), .b(new_n78_), .c(x22), .d(x01), .O(new_n182_));
  ...
  nand2  g126(.a(new_n81_), .b(new_n95_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n83_), .c(new_n189_), .O(new_n190_));
  nand4  g128(.a(new_n74_), .b(x29), .c(x23), .d(x08), .O(new_n191_));
  oai21  g129(.a(new_n190_), .b(new_n100_), .c(new_n191_), .O(z18));
  oai21  g130(.a(new_n147_), .b(x09), .c(new_n79_), .O(z19));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n144_), .O(new_n195_));
  oai21  g133(.a(new_n66_), .b(new_n64_), .c(x23), .O(new_n196_));
  nand2  g134(.a(new_n73_), .b(new_n64_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(x08), .O(new_n198_));
