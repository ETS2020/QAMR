...
module FAU ( 
  ...
  nor2   g052(.a(new_n63_), .b(new_n114_), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n64_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n63_), .O(z09));
  inv1   g057(.a(x07), .O(new_n120_));
  nor2   g058(.a(x40), .b(x26), .O(new_n121_));
  aoi21  g059(.a(x40), .b(new_n114_), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(x40), .b(x39), .c(x05), .O(new_n123_));
  oai21  g061(.a(new_n122_), .b(new_n120_), .c(new_n123_), .O(new_n124_));
  nand3  g062(.a(new_n124_), .b(new_n84_), .c(new_n73_), .O(new_n125_));
  ...
  nor2   g067(.a(new_n129_), .b(new_n114_), .O(new_n130_));
  ...
  aoi21  g083(.a(x39), .b(new_n73_), .c(new_n71_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(x40), .O(new_n147_));
  inv1   g085(.a(x26), .O(new_n148_));
  ...
  nand4  g098(.a(new_n158_), .b(new_n148_), .c(x20), .d(new_n157_), .O(new_n161_));
  ...
  nand3  g105(.a(x39), .b(new_n152_), .c(new_n73_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n63_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n121_), .c(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n69_), .b(new_n143_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n80_), .c(new_n79_), .O(new_n174_));
  oai21  g112(.a(new_n169_), .b(new_n71_), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n171_), .c(new_n150_), .O(z14));
  nand3  g115(.a(x34), .b(x27), .c(x12), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(x40), .c(new_n148_), .O(z15));
  ...
  nand2  g124(.a(new_n68_), .b(x08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n143_), .O(new_n188_));
  ...
  oai22  g129(.a(new_n191_), .b(new_n65_), .c(new_n116_), .d(new_n89_), .O(z18));
  oai22  g130(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n148_), .O(new_n194_));
  ...
  nand2  g135(.a(new_n115_), .b(x29), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(x28), .c(new_n68_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n197_), .c(new_n194_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n79_), .c(new_n189_), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n64_), .O(z20));
  nor2   g140(.a(new_n141_), .b(x09), .O(z19));
endmodule
