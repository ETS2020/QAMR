...
module FAU ( 
  ...
  aoi21  g18(.a(new_n67_), .b(new_n66_), .c(new_n81_), .O(new_n82_));
  aoi21  g19(.a(new_n82_), .b(new_n80_), .c(z08), .O(z03));
  nand2  g20(.a(new_n67_), .b(new_n66_), .O(new_n84_));
  nand4  g21(.a(new_n84_), .b(new_n80_), .c(new_n63_), .d(new_n81_), .O(z04));
  nand2  g22(.a(x28), .b(x27), .O(new_n86_));
  aoi21  g23(.a(new_n86_), .b(new_n67_), .c(z08), .O(z05));
  nand3  g24(.a(new_n86_), .b(new_n63_), .c(new_n67_), .O(new_n88_));
  ...
  nand2  g47(.a(new_n110_), .b(new_n63_), .O(z10));
  inv1   g48(.a(x09), .O(new_n112_));
  inv1   g49(.a(x28), .O(new_n113_));
  nand2  g50(.a(x27), .b(x04), .O(new_n114_));
  inv1   g51(.a(x08), .O(new_n115_));
  nand2  g52(.a(new_n66_), .b(new_n115_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(new_n114_), .c(x35), .d(new_n113_), .O(new_n117_));
  nand4  g54(.a(new_n117_), .b(new_n63_), .c(new_n72_), .d(new_n112_), .O(new_n118_));
  inv1   g55(.a(new_n118_), .O(z11));
  oai21  g56(.a(z08), .b(x28), .c(x35), .O(new_n120_));
  nand2  g57(.a(new_n120_), .b(new_n67_), .O(new_n121_));
  nand3  g58(.a(new_n121_), .b(new_n63_), .c(x27), .O(z12));
  inv1   g59(.a(x19), .O(new_n123_));
  nand3  g60(.a(new_n69_), .b(x20), .c(new_n123_), .O(new_n124_));
  oai21  g61(.a(new_n124_), .b(x18), .c(new_n63_), .O(z13));
  nand3  g62(.a(new_n63_), .b(x27), .c(x20), .O(new_n126_));
  nor3   g63(.a(new_n126_), .b(x19), .c(x18), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(new_n121_), .O(z14));
  inv1   g65(.a(x12), .O(new_n129_));
  nor2   g66(.a(new_n104_), .b(new_n129_), .O(z15));
  inv1   g67(.a(x23), .O(new_n131_));
  nand4  g68(.a(new_n63_), .b(new_n131_), .c(x22), .d(x01), .O(new_n132_));
  inv1   g69(.a(new_n132_), .O(z16));
  inv1   g70(.a(x24), .O(new_n134_));
  nand4  g71(.a(new_n134_), .b(x23), .c(x22), .d(x01), .O(new_n135_));
  nand2  g72(.a(new_n135_), .b(new_n63_), .O(z17));
  nand2  g73(.a(x27), .b(new_n106_), .O(new_n137_));
  oai21  g74(.a(x27), .b(new_n115_), .c(new_n137_), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(x35), .c(new_n113_), .O(new_n139_));
  nand4  g76(.a(new_n139_), .b(new_n63_), .c(new_n72_), .d(new_n112_), .O(z18));
  oai21  g77(.a(x28), .b(new_n115_), .c(new_n66_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(x35), .O(new_n142_));
  nand4  g79(.a(new_n142_), .b(new_n63_), .c(new_n72_), .d(new_n112_), .O(new_n143_));
