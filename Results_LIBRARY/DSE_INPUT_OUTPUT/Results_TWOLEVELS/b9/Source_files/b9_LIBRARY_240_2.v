...
module FAU ( 
  ...
  nand2  g014(.a(new_n74_), .b(x16), .O(new_n77_));
  ...
  nor2   g032(.a(x40), .b(x16), .O(new_n95_));
  inv1   g033(.a(new_n95_), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(new_n94_), .O(z02));
  nand2  g035(.a(new_n65_), .b(x27), .O(new_n98_));
  inv1   g036(.a(x21), .O(new_n99_));
  inv1   g037(.a(x27), .O(new_n100_));
  aoi21  g038(.a(new_n64_), .b(new_n100_), .c(new_n99_), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n78_), .O(z03));
  nand2  g040(.a(new_n64_), .b(new_n100_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n98_), .c(new_n77_), .d(new_n99_), .O(z04));
  nand2  g042(.a(x28), .b(x27), .O(new_n105_));
  nand3  g043(.a(new_n105_), .b(new_n77_), .c(new_n64_), .O(z05));
  aoi21  g044(.a(new_n77_), .b(new_n100_), .c(new_n82_), .O(new_n107_));
  oai21  g045(.a(new_n107_), .b(x37), .c(new_n77_), .O(z06));
  ...
  nand2  g057(.a(new_n119_), .b(new_n77_), .O(z07));
  nor2   g058(.a(new_n74_), .b(new_n70_), .O(z08));
  ...
  aoi21  g063(.a(x40), .b(new_n70_), .c(new_n95_), .O(new_n126_));
  nand3  g064(.a(x40), .b(x39), .c(x05), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n84_), .c(new_n124_), .O(new_n129_));
  nand3  g067(.a(new_n77_), .b(x37), .c(x06), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(x27), .O(new_n132_));
  nor2   g070(.a(x32), .b(x30), .O(new_n133_));
  nor2   g071(.a(new_n133_), .b(new_n74_), .O(new_n134_));
  nand4  g072(.a(new_n134_), .b(x39), .c(x05), .d(new_n124_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n132_), .O(z10));
  nand2  g074(.a(new_n77_), .b(new_n100_), .O(new_n137_));
  ...
  oai21  g083(.a(new_n145_), .b(x09), .c(new_n77_), .O(z11));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  nor2   g085(.a(new_n74_), .b(x27), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n69_), .O(new_n149_));
  inv1   g087(.a(z08), .O(new_n150_));
  oai22  g088(.a(new_n150_), .b(x04), .c(new_n67_), .d(new_n100_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n149_), .c(new_n77_), .O(z12));
  ...
  nand4  g099(.a(new_n134_), .b(x39), .c(new_n153_), .d(new_n124_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n161_), .c(new_n77_), .O(z13));
  oai21  g101(.a(new_n133_), .b(x13), .c(x40), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(z08), .c(new_n124_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n100_), .O(new_n166_));
  ...
  inv1   g109(.a(new_n65_), .O(new_n172_));
  aoi21  g110(.a(new_n169_), .b(z08), .c(new_n172_), .O(new_n173_));
  inv1   g111(.a(x35), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n173_), .c(new_n64_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n171_), .c(new_n166_), .d(new_n77_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nand4  g117(.a(new_n77_), .b(x34), .c(x27), .d(x26), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n179_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand4  g120(.a(new_n77_), .b(new_n182_), .c(x22), .d(x01), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z16));
  inv1   g122(.a(x01), .O(new_n185_));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n77_), .b(new_n186_), .c(x23), .d(x22), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n185_), .O(z17));
  nand2  g126(.a(x27), .b(new_n124_), .O(new_n189_));
  nand2  g127(.a(new_n100_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n174_), .O(new_n191_));
  inv1   g129(.a(x09), .O(new_n192_));
  nand2  g130(.a(new_n79_), .b(new_n192_), .O(new_n193_));
  aoi21  g131(.a(new_n191_), .b(new_n82_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n78_), .c(new_n150_), .d(new_n89_), .O(z18));
  nor2   g133(.a(new_n145_), .b(x09), .O(z19));
  aoi21  g134(.a(x28), .b(new_n100_), .c(new_n174_), .O(new_n197_));
  aoi21  g135(.a(new_n142_), .b(new_n96_), .c(new_n197_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n174_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n137_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n79_), .O(new_n201_));
