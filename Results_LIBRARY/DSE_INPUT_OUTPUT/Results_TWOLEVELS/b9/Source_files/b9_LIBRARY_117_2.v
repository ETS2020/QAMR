...
module FAU ( 
  ...
  nor2   g041(.a(new_n103_), .b(new_n83_), .O(z05));
  aoi21  g042(.a(new_n81_), .b(new_n64_), .c(new_n86_), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(x37), .c(new_n81_), .O(z06));
  ...
  nand3  g056(.a(new_n115_), .b(x40), .c(new_n113_), .O(new_n119_));
  aoi21  g057(.a(new_n119_), .b(new_n118_), .c(new_n107_), .O(z07));
  ...
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n83_), .O(new_n133_));
  ...
  nand2  g077(.a(new_n80_), .b(new_n108_), .O(new_n140_));
  ...
  nor2   g087(.a(new_n80_), .b(x27), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n148_), .O(new_n151_));
  nor2   g089(.a(x40), .b(x31), .O(new_n152_));
  nand2  g090(.a(new_n72_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n65_), .c(new_n80_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(new_n153_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n151_), .c(new_n81_), .O(z12));
  inv1   g094(.a(x13), .O(new_n157_));
  nand2  g095(.a(x36), .b(x35), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x28), .c(new_n80_), .O(new_n159_));
  ...
  nand3  g103(.a(new_n128_), .b(x40), .c(x39), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(x13), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n65_), .c(new_n83_), .O(new_n168_));
  ...
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n80_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n152_), .c(new_n170_), .O(new_n175_));
  ...
  nand2  g132(.a(new_n84_), .b(new_n135_), .O(new_n195_));
  aoi21  g133(.a(new_n194_), .b(new_n86_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n83_), .c(new_n93_), .d(new_n75_), .O(z18));
  inv1   g135(.a(new_n146_), .O(z19));
  nand2  g136(.a(x28), .b(new_n64_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n140_), .d(new_n139_), .O(new_n200_));
  nand2  g138(.a(new_n81_), .b(new_n64_), .O(new_n201_));
