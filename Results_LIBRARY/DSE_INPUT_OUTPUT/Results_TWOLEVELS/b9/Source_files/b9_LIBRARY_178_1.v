...
module FAU ( 
  ...
  aoi21  g033(.a(new_n88_), .b(x04), .c(new_n81_), .O(new_n96_));
  nor2   g034(.a(x27), .b(x08), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(x04), .c(new_n75_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n95_), .d(x40), .O(z02));
  ...
  nor2   g069(.a(new_n131_), .b(new_n81_), .O(new_n132_));
  ...
  nand3  g085(.a(x40), .b(new_n64_), .c(x24), .O(new_n148_));
  ...
  oai21  g089(.a(new_n73_), .b(new_n64_), .c(new_n151_), .O(new_n152_));
  ...
  nand3  g102(.a(new_n132_), .b(new_n154_), .c(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  nand2  g104(.a(x40), .b(x13), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n130_), .c(new_n81_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n151_), .c(new_n64_), .O(new_n169_));
  ...
  nor3   g125(.a(new_n187_), .b(x40), .c(x24), .O(z17));
  ...
  aoi21  g131(.a(new_n193_), .b(new_n139_), .c(x30), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n192_), .c(new_n191_), .O(z18));
  oai21  g133(.a(new_n144_), .b(x09), .c(new_n82_), .O(z19));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n141_), .O(new_n198_));
  oai21  g136(.a(new_n66_), .b(new_n64_), .c(x24), .O(new_n199_));
  nand2  g137(.a(new_n76_), .b(new_n64_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n199_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n198_), .c(new_n85_), .O(new_n202_));
