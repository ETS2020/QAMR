...
module FAU ( 
  ...
  nand2  g65(.a(new_n128_), .b(new_n68_), .O(z16));
  inv1   g66(.a(x01), .O(new_n130_));
  inv1   g67(.a(x24), .O(new_n131_));
  nand4  g68(.a(new_n68_), .b(new_n131_), .c(x23), .d(x22), .O(new_n132_));
  ...
  nand3  g72(.a(new_n135_), .b(x35), .c(new_n111_), .O(new_n136_));
  nor2   g73(.a(x30), .b(x09), .O(new_n137_));
  aoi21  g74(.a(new_n137_), .b(new_n136_), .c(z08), .O(z18));
  inv1   g75(.a(new_n116_), .O(z19));
  oai21  g76(.a(x28), .b(new_n113_), .c(new_n81_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g78(.a(new_n141_), .b(new_n68_), .c(new_n71_), .d(new_n110_), .O(new_n142_));
