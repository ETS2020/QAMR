...
module FAU ( 
  ...
  aoi21  g21(.a(new_n84_), .b(new_n81_), .c(z08), .O(z03));
  ...
  nand3  g26(.a(new_n89_), .b(new_n83_), .c(new_n68_), .O(z05));
  inv1   g27(.a(new_n83_), .O(new_n91_));
  oai21  g28(.a(new_n91_), .b(x37), .c(new_n68_), .O(z06));
  ...
  nand2  g40(.a(new_n103_), .b(x03), .O(new_n104_));
  nand2  g41(.a(new_n104_), .b(new_n68_), .O(z07));
  nand4  g42(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n106_));
  nand2  g43(.a(new_n106_), .b(new_n68_), .O(z09));
  ...
  nand2  g48(.a(new_n111_), .b(x27), .O(new_n112_));
  nand2  g49(.a(new_n112_), .b(new_n68_), .O(z10));
  inv1   g50(.a(x09), .O(new_n114_));
  inv1   g51(.a(x28), .O(new_n115_));
  nor2   g52(.a(x27), .b(x08), .O(new_n116_));
  aoi21  g53(.a(x27), .b(x04), .c(new_n116_), .O(new_n117_));
  nand3  g54(.a(new_n117_), .b(x35), .c(new_n115_), .O(new_n118_));
  nand4  g55(.a(new_n118_), .b(new_n68_), .c(new_n71_), .d(new_n114_), .O(new_n119_));
  nand2  g56(.a(new_n119_), .b(new_n68_), .O(z11));
  nand2  g57(.a(new_n68_), .b(new_n66_), .O(z12));
  inv1   g58(.a(x18), .O(new_n122_));
  inv1   g59(.a(x19), .O(new_n123_));
  nand4  g60(.a(new_n66_), .b(x20), .c(new_n123_), .d(new_n122_), .O(new_n124_));
  nand2  g61(.a(new_n124_), .b(new_n68_), .O(z13));
  nand3  g62(.a(x20), .b(new_n123_), .c(new_n122_), .O(new_n126_));
  nor2   g63(.a(new_n126_), .b(new_n65_), .O(new_n127_));
  aoi21  g64(.a(new_n127_), .b(x27), .c(z08), .O(z14));
  nand4  g65(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n129_));
  nand2  g66(.a(new_n129_), .b(new_n68_), .O(z15));
  inv1   g67(.a(x23), .O(new_n131_));
  nand3  g68(.a(new_n131_), .b(x22), .c(x01), .O(new_n132_));
  nand2  g69(.a(new_n132_), .b(new_n68_), .O(z16));
  inv1   g70(.a(x01), .O(new_n134_));
  inv1   g71(.a(x24), .O(new_n135_));
  nand4  g72(.a(new_n68_), .b(new_n135_), .c(x23), .d(x22), .O(new_n136_));
  nor2   g73(.a(new_n136_), .b(new_n134_), .O(z17));
  nand2  g74(.a(new_n64_), .b(x08), .O(new_n138_));
  oai21  g75(.a(new_n64_), .b(x04), .c(new_n138_), .O(new_n139_));
  nand3  g76(.a(new_n139_), .b(x35), .c(new_n115_), .O(new_n140_));
  nand4  g77(.a(new_n140_), .b(new_n68_), .c(new_n71_), .d(new_n114_), .O(z18));
  inv1   g78(.a(new_n119_), .O(z19));
  oai21  g79(.a(new_n116_), .b(new_n72_), .c(new_n68_), .O(new_n143_));
  oai21  g80(.a(new_n115_), .b(x27), .c(new_n143_), .O(new_n144_));
  nand3  g81(.a(new_n144_), .b(new_n71_), .c(new_n114_), .O(new_n145_));
  nand2  g82(.a(new_n145_), .b(new_n68_), .O(z20));
  one    g83(.O(z02));
endmodule
