...
module FAU ( 
  ...
  aoi21  g034(.a(new_n96_), .b(new_n90_), .c(new_n95_), .O(z04));
  nand2  g035(.a(x28), .b(x27), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n92_), .c(new_n95_), .O(z05));
  nand3  g037(.a(new_n98_), .b(new_n71_), .c(new_n92_), .O(new_n100_));
  ...
  oai21  g076(.a(new_n138_), .b(new_n91_), .c(new_n66_), .O(new_n139_));
  oai22  g077(.a(new_n64_), .b(new_n91_), .c(new_n67_), .d(x04), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n139_), .c(new_n71_), .O(z12));
  ...
  nand2  g085(.a(new_n89_), .b(new_n92_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n145_), .c(new_n70_), .O(new_n150_));
  nand4  g088(.a(new_n148_), .b(new_n67_), .c(x20), .d(new_n147_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(x18), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(x27), .O(new_n153_));
  aoi21  g091(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n142_), .d(new_n117_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(z13));
  nand3  g094(.a(x39), .b(new_n142_), .c(new_n117_), .O(new_n157_));
  nand4  g095(.a(x27), .b(x20), .c(new_n147_), .d(new_n146_), .O(new_n158_));
  ...
  nand3  g102(.a(new_n164_), .b(new_n159_), .c(new_n71_), .O(z14));
  ...
  nand2  g113(.a(x27), .b(new_n117_), .O(new_n176_));
  nand2  g114(.a(new_n91_), .b(x08), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(new_n175_), .O(new_n178_));
  nand2  g116(.a(new_n74_), .b(new_n128_), .O(new_n179_));
  aoi21  g117(.a(new_n178_), .b(new_n77_), .c(new_n179_), .O(new_n180_));
  nand2  g118(.a(x40), .b(x39), .O(new_n181_));
  oai22  g119(.a(new_n181_), .b(new_n84_), .c(new_n180_), .d(new_n95_), .O(z18));
  inv1   g120(.a(new_n136_), .O(z19));
  oai21  g121(.a(new_n77_), .b(x27), .c(x35), .O(new_n184_));
  and2   g122(.a(new_n184_), .b(new_n129_), .O(new_n185_));
  nand2  g123(.a(new_n71_), .b(new_n91_), .O(new_n186_));
  nand2  g124(.a(x40), .b(new_n175_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n185_), .c(new_n74_), .O(new_n189_));
