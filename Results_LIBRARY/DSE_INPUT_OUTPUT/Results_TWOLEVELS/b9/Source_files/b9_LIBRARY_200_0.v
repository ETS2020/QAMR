...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(x07), .O(new_n94_));
  ...
  aoi21  g042(.a(new_n65_), .b(new_n98_), .c(new_n83_), .O(new_n105_));
  ...
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n65_), .d(new_n98_), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n94_), .O(new_n140_));
  ...
  nand2  g087(.a(z08), .b(new_n72_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n67_), .c(new_n66_), .O(new_n151_));
  aoi21  g089(.a(x27), .b(x07), .c(x40), .O(new_n152_));
  oai21  g090(.a(new_n64_), .b(new_n72_), .c(x39), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n98_), .c(new_n152_), .O(new_n154_));
  ...
  nor2   g101(.a(new_n162_), .b(new_n63_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n132_), .b(new_n156_), .c(new_n72_), .O(new_n166_));
  ...
  nor2   g107(.a(new_n64_), .b(x04), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(new_n169_), .c(x39), .d(new_n156_), .O(new_n171_));
  ...
  oai21  g112(.a(new_n64_), .b(x27), .c(new_n174_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n81_), .c(new_n80_), .O(new_n176_));
  oai21  g114(.a(new_n64_), .b(x27), .c(new_n68_), .O(new_n177_));
  oai21  g115(.a(x13), .b(x04), .c(new_n177_), .O(new_n178_));
  aoi21  g116(.a(new_n118_), .b(new_n69_), .c(new_n79_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n178_), .c(new_n176_), .d(new_n172_), .O(z14));
  ...
  oai22  g128(.a(new_n118_), .b(new_n190_), .c(new_n84_), .d(x27), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n173_), .b(x28), .O(new_n193_));
  nor2   g131(.a(new_n98_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n192_), .c(new_n65_), .d(new_n80_), .O(z18));
  nand2  g134(.a(new_n145_), .b(new_n65_), .O(z19));
  nand2  g135(.a(x28), .b(new_n98_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n139_), .d(new_n94_), .O(new_n199_));
  nand2  g137(.a(new_n65_), .b(new_n98_), .O(new_n200_));
