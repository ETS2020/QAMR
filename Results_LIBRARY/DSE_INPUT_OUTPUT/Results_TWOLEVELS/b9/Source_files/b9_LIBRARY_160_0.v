...
module FAU ( 
  ...
  nand3  g050(.a(x38), .b(new_n112_), .c(x00), .O(new_n113_));
  nand2  g051(.a(x40), .b(new_n81_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g053(.a(new_n115_), .b(new_n111_), .c(new_n110_), .d(new_n109_), .O(new_n116_));
  inv1   g054(.a(x14), .O(new_n117_));
  oai21  g055(.a(x25), .b(x00), .c(x38), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n114_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n116_), .c(new_n108_), .O(z07));
  ...
  aoi22  g078(.a(new_n140_), .b(x40), .c(new_n82_), .d(new_n64_), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(x08), .O(new_n142_));
  ...
  aoi22  g084(.a(new_n146_), .b(new_n143_), .c(new_n145_), .d(new_n97_), .O(new_n147_));
  ...
  inv1   g091(.a(new_n97_), .O(new_n154_));
  ...
  nand3  g095(.a(new_n157_), .b(new_n153_), .c(new_n82_), .O(z12));
  ...
  nand4  g109(.a(new_n160_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n172_));
  ...
  oai21  g113(.a(new_n175_), .b(new_n154_), .c(new_n171_), .O(new_n176_));
  nand3  g114(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x27), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n85_), .c(new_n84_), .O(new_n179_));
  ...
  nand3  g120(.a(new_n155_), .b(new_n76_), .c(x38), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n182_), .c(new_n176_), .O(z14));
  inv1   g122(.a(x12), .O(new_n185_));
  nor2   g123(.a(new_n123_), .b(new_n185_), .O(z15));
  inv1   g124(.a(x23), .O(new_n187_));
  nand4  g125(.a(new_n82_), .b(new_n187_), .c(x22), .d(x01), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(z16));
  inv1   g127(.a(x24), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(x23), .c(x22), .d(x01), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n82_), .O(z17));
  nand2  g130(.a(z08), .b(x29), .O(new_n193_));
  oai21  g131(.a(new_n87_), .b(x27), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x08), .O(new_n195_));
  nor2   g133(.a(new_n64_), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n143_), .c(x09), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n195_), .c(new_n82_), .d(new_n84_), .O(z18));
  oai21  g136(.a(new_n148_), .b(x09), .c(new_n82_), .O(z19));
  oai22  g137(.a(new_n76_), .b(x35), .c(new_n86_), .d(x27), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n144_), .O(new_n201_));
  nor2   g139(.a(new_n76_), .b(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n154_), .c(new_n66_), .O(new_n203_));
  nor2   g141(.a(new_n100_), .b(x08), .O(new_n204_));
  nor2   g142(.a(x40), .b(new_n86_), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n204_), .c(new_n64_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n203_), .c(new_n201_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n84_), .O(new_n208_));
  oai21  g146(.a(new_n208_), .b(x09), .c(new_n82_), .O(z20));
endmodule
