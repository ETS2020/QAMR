...
module FAU ( 
  ...
  aoi21  g046(.a(new_n108_), .b(new_n70_), .c(new_n101_), .O(z05));
  ...
  nand4  g053(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n91_), .O(new_n116_));
  ...
  oai21  g065(.a(x39), .b(x31), .c(x40), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x07), .O(new_n129_));
  nand4  g067(.a(x40), .b(x39), .c(new_n91_), .d(x05), .O(new_n130_));
  ...
  nand4  g075(.a(new_n137_), .b(new_n91_), .c(x05), .d(new_n65_), .O(new_n138_));
  oai21  g076(.a(new_n134_), .b(new_n64_), .c(new_n138_), .O(z10));
  inv1   g077(.a(x09), .O(new_n140_));
  aoi21  g078(.a(x40), .b(x31), .c(x27), .O(new_n141_));
  nand3  g079(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n91_), .c(new_n141_), .O(new_n143_));
  aoi21  g081(.a(x39), .b(x29), .c(x31), .O(new_n144_));
  nand2  g082(.a(x27), .b(x04), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(x35), .c(new_n86_), .O(new_n146_));
  oai21  g084(.a(new_n144_), .b(new_n76_), .c(new_n146_), .O(new_n147_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n152_), .c(new_n91_), .O(new_n154_));
  nand2  g092(.a(new_n72_), .b(x27), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n76_), .O(new_n156_));
  ...
  nand4  g104(.a(new_n135_), .b(x39), .c(new_n158_), .d(new_n65_), .O(new_n167_));
  ...
  aoi21  g112(.a(new_n174_), .b(new_n172_), .c(x31), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n76_), .c(new_n171_), .O(new_n176_));
  ...
  nor2   g122(.a(new_n126_), .b(new_n184_), .O(z15));
  ...
  nand2  g133(.a(new_n84_), .b(new_n140_), .O(new_n196_));
  aoi21  g134(.a(new_n195_), .b(new_n86_), .c(new_n196_), .O(new_n197_));
  nand2  g135(.a(new_n77_), .b(new_n91_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n93_), .c(new_n197_), .d(new_n101_), .O(z18));
  nand2  g137(.a(new_n149_), .b(new_n81_), .O(z19));
  nor2   g138(.a(new_n144_), .b(new_n76_), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n202_));
  aoi21  g140(.a(new_n66_), .b(new_n91_), .c(new_n141_), .O(new_n203_));
  oai22  g141(.a(new_n203_), .b(x08), .c(new_n202_), .d(new_n201_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n84_), .c(new_n140_), .O(new_n205_));
