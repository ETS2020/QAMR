...
module FAU ( 
  ...
  nor2   g013(.a(x22), .b(x13), .O(new_n76_));
  ...
  aoi21  g029(.a(new_n91_), .b(new_n87_), .c(new_n76_), .O(z02));
  ...
  nand3  g034(.a(new_n93_), .b(new_n96_), .c(new_n64_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n93_), .d(x21), .O(z03));
  nor2   g036(.a(new_n76_), .b(x21), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n97_), .c(new_n95_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n76_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n93_), .c(new_n96_), .O(new_n103_));
  ...
  nor3   g056(.a(new_n76_), .b(new_n118_), .c(new_n117_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n93_), .O(z09));
  nand2  g059(.a(new_n88_), .b(x07), .O(new_n122_));
  ...
  oai21  g070(.a(new_n66_), .b(new_n64_), .c(new_n132_), .O(new_n133_));
  nand3  g071(.a(x40), .b(x39), .c(x29), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n66_), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n133_), .c(new_n76_), .O(new_n136_));
  inv1   g074(.a(new_n134_), .O(new_n137_));
  nor2   g075(.a(x28), .b(x04), .O(new_n138_));
  aoi21  g076(.a(x27), .b(x04), .c(x28), .O(new_n139_));
  oai22  g077(.a(new_n139_), .b(new_n137_), .c(new_n138_), .d(x08), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(new_n79_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x09), .c(new_n93_), .O(z11));
  ...
  oai22  g083(.a(new_n88_), .b(x04), .c(new_n70_), .d(new_n64_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n145_), .c(new_n76_), .O(z12));
  ...
  inv1   g091(.a(new_n70_), .O(new_n154_));
  ...
  oai21  g096(.a(new_n158_), .b(x04), .c(x22), .O(new_n159_));
  ...
  nor2   g101(.a(new_n88_), .b(x04), .O(new_n164_));
  nand4  g102(.a(new_n149_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(x13), .c(new_n162_), .O(new_n167_));
  ...
  nand2  g108(.a(new_n170_), .b(new_n146_), .O(new_n171_));
  ...
  aoi21  g123(.a(new_n185_), .b(new_n89_), .c(x30), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n184_), .c(new_n93_), .d(new_n181_), .O(z18));
  aoi21  g125(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n137_), .c(new_n133_), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n93_), .c(new_n79_), .d(new_n181_), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z20));
  oai21  g129(.a(new_n141_), .b(x09), .c(new_n93_), .O(z19));
endmodule
