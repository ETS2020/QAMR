...
module FAU ( 
  ...
  nor2   g031(.a(x40), .b(x25), .O(new_n94_));
  ...
  aoi21  g051(.a(x38), .b(new_n113_), .c(x25), .O(new_n114_));
  nor2   g052(.a(new_n63_), .b(x38), .O(new_n115_));
  or2    g053(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g054(.a(new_n116_), .b(new_n112_), .c(new_n111_), .d(new_n110_), .O(new_n117_));
  inv1   g055(.a(x14), .O(new_n118_));
  nor2   g056(.a(new_n63_), .b(new_n106_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(new_n114_), .c(new_n118_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n117_), .c(new_n109_), .O(z07));
  ...
  aoi21  g064(.a(x40), .b(new_n122_), .c(new_n94_), .O(new_n127_));
  nand3  g065(.a(x40), .b(x39), .c(x05), .O(new_n128_));
  oai21  g066(.a(new_n127_), .b(new_n126_), .c(new_n128_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n85_), .c(new_n74_), .O(new_n130_));
  ...
  aoi21  g082(.a(new_n144_), .b(x40), .c(new_n94_), .O(new_n145_));
  nand2  g083(.a(x27), .b(x04), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n143_), .c(new_n145_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n142_), .c(new_n80_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(x09), .O(z11));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n99_), .c(new_n75_), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n74_), .c(new_n63_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n94_), .c(new_n71_), .O(new_n153_));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n74_), .c(new_n65_), .O(new_n165_));
  ...
  nand3  g106(.a(x39), .b(new_n155_), .c(new_n74_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n63_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n94_), .c(new_n167_), .O(new_n172_));
  inv1   g110(.a(x35), .O(new_n173_));
  nand3  g111(.a(new_n68_), .b(new_n173_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n81_), .c(new_n80_), .O(new_n176_));
  oai21  g114(.a(new_n170_), .b(new_n72_), .c(new_n176_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x40), .O(new_n178_));
  nand3  g116(.a(new_n71_), .b(new_n63_), .c(new_n106_), .O(new_n179_));
  ...
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n64_), .d(new_n80_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n90_), .c(new_n106_), .O(new_n196_));
  ...
  nand3  g137(.a(new_n189_), .b(x28), .c(new_n99_), .O(new_n200_));
