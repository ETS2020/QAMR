...
module FAU ( 
  ...
  nand2  g031(.a(x40), .b(new_n66_), .O(new_n94_));
  ...
  oai21  g041(.a(new_n93_), .b(new_n64_), .c(new_n70_), .O(new_n104_));
  and2   g042(.a(new_n104_), .b(new_n81_), .O(z05));
  ...
  nand2  g056(.a(new_n118_), .b(new_n81_), .O(z09));
  ...
  nand2  g061(.a(new_n84_), .b(new_n83_), .O(new_n124_));
  ...
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(new_n81_), .O(z10));
  nand2  g067(.a(new_n81_), .b(new_n64_), .O(new_n130_));
  nand3  g068(.a(x35), .b(new_n93_), .c(new_n65_), .O(new_n131_));
  ...
  nor2   g073(.a(x40), .b(x05), .O(new_n136_));
  aoi21  g074(.a(new_n135_), .b(x40), .c(new_n136_), .O(new_n137_));
  nand2  g075(.a(x27), .b(x04), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n134_), .c(new_n137_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n133_), .c(new_n83_), .O(new_n140_));
  ...
  nand2  g084(.a(new_n146_), .b(new_n80_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(x05), .c(new_n145_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x28), .c(new_n80_), .O(new_n151_));
  ...
  nand3  g095(.a(new_n124_), .b(x40), .c(x39), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x13), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n65_), .c(new_n99_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  aoi21  g099(.a(x39), .b(new_n65_), .c(new_n80_), .O(new_n162_));
  oai21  g100(.a(x40), .b(x05), .c(new_n149_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(new_n146_), .O(new_n164_));
  nand3  g102(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n165_));
  nand4  g103(.a(new_n150_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(z08), .c(new_n149_), .d(new_n65_), .O(new_n167_));
  ...
  nand4  g109(.a(new_n171_), .b(new_n168_), .c(new_n164_), .d(new_n81_), .O(z14));
  ...
  nand4  g114(.a(new_n81_), .b(new_n176_), .c(x22), .d(x01), .O(new_n177_));
  ...
  nand2  g119(.a(x27), .b(new_n65_), .O(new_n182_));
  nand2  g120(.a(new_n64_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n66_), .O(new_n184_));
  inv1   g122(.a(x09), .O(new_n185_));
  nand2  g123(.a(new_n83_), .b(new_n185_), .O(new_n186_));
  aoi21  g124(.a(new_n184_), .b(new_n93_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n99_), .c(new_n90_), .d(new_n75_), .O(z18));
  aoi21  g126(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n137_), .O(new_n190_));
  aoi21  g128(.a(new_n130_), .b(new_n94_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n190_), .c(new_n83_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z20));
  nor2   g131(.a(new_n140_), .b(x09), .O(z19));
endmodule
