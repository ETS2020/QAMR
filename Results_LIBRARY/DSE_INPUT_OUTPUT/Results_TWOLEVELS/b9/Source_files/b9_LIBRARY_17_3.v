...
module FAU ( 
  ...
  nand2  g017(.a(x40), .b(x25), .O(new_n80_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n99_), .c(new_n96_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n96_), .O(z05));
  nand3  g043(.a(new_n104_), .b(new_n80_), .c(new_n70_), .O(new_n106_));
  ...
  aoi21  g050(.a(x38), .b(new_n112_), .c(x25), .O(new_n113_));
  nor2   g051(.a(x40), .b(x38), .O(new_n114_));
  or2    g052(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  ...
  nor2   g056(.a(x40), .b(new_n118_), .O(new_n119_));
  oai21  g057(.a(new_n119_), .b(new_n113_), .c(new_n117_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n116_), .c(new_n108_), .O(z07));
  inv1   g059(.a(x40), .O(new_n122_));
  aoi21  g060(.a(new_n95_), .b(new_n118_), .c(new_n122_), .O(z08));
  ...
  nor3   g068(.a(new_n130_), .b(new_n122_), .c(new_n95_), .O(new_n131_));
  ...
  aoi22  g076(.a(new_n138_), .b(new_n118_), .c(new_n80_), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n118_), .c(new_n122_), .O(new_n141_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n157_), .c(x25), .O(new_n161_));
  nand4  g099(.a(new_n72_), .b(new_n122_), .c(x20), .d(new_n159_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand4  g102(.a(new_n131_), .b(new_n118_), .c(new_n154_), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  oai21  g104(.a(x27), .b(new_n154_), .c(new_n118_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x40), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n169_));
  nand4  g107(.a(new_n155_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n170_));
  ...
  nand4  g113(.a(new_n66_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n176_));
  ...
  nand2  g132(.a(new_n82_), .b(new_n137_), .O(new_n195_));
  aoi21  g133(.a(new_n194_), .b(new_n84_), .c(new_n195_), .O(new_n196_));
  nand4  g134(.a(new_n76_), .b(x29), .c(new_n118_), .d(x08), .O(new_n197_));
  oai21  g135(.a(new_n196_), .b(new_n96_), .c(new_n197_), .O(z18));
  inv1   g136(.a(new_n146_), .O(z19));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  nand2  g138(.a(x35), .b(x27), .O(new_n201_));
  aoi22  g139(.a(new_n201_), .b(new_n118_), .c(new_n122_), .d(new_n64_), .O(new_n202_));
  oai22  g140(.a(new_n202_), .b(x08), .c(new_n200_), .d(new_n141_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n82_), .c(new_n137_), .O(new_n204_));
