...
module FAU ( 
  ...
  nand2  g033(.a(new_n64_), .b(x11), .O(new_n96_));
  ...
  nor2   g042(.a(new_n104_), .b(new_n79_), .O(z05));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n137_), .c(new_n139_), .d(new_n96_), .O(new_n141_));
  ...
  inv1   g083(.a(new_n96_), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n72_), .c(new_n64_), .O(new_n147_));
  ...
  nand3  g102(.a(x39), .b(new_n150_), .c(new_n72_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n64_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n146_), .c(new_n163_), .O(new_n168_));
  nand3  g106(.a(new_n66_), .b(new_n136_), .c(x28), .O(new_n169_));
  ...
  nand3  g112(.a(new_n69_), .b(new_n64_), .c(x11), .O(new_n175_));
  ...
  nand2  g123(.a(x27), .b(new_n72_), .O(new_n186_));
  nand2  g124(.a(new_n99_), .b(x08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n136_), .O(new_n188_));
  ...
  oai22  g129(.a(new_n191_), .b(new_n79_), .c(new_n118_), .d(new_n90_), .O(z18));
  nand2  g130(.a(x28), .b(new_n99_), .O(new_n193_));
  aoi22  g131(.a(new_n193_), .b(x35), .c(new_n139_), .d(new_n96_), .O(new_n194_));
  nand2  g132(.a(x40), .b(new_n136_), .O(new_n195_));
  ...
  nor2   g136(.a(new_n142_), .b(x09), .O(z19));
endmodule
