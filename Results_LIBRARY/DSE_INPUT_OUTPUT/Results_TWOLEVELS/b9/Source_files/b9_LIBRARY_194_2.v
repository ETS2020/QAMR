...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x22), .O(new_n81_));
  ...
  inv1   g043(.a(x22), .O(new_n106_));
  inv1   g044(.a(x28), .O(new_n107_));
  oai22  g045(.a(x40), .b(new_n106_), .c(new_n107_), .d(new_n64_), .O(new_n108_));
  ...
  nor2   g063(.a(x40), .b(x22), .O(new_n126_));
  ...
  aoi22  g076(.a(new_n138_), .b(x40), .c(new_n81_), .d(new_n64_), .O(new_n139_));
  nor2   g077(.a(new_n139_), .b(x08), .O(new_n140_));
  nand2  g078(.a(x39), .b(x29), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n126_), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(new_n86_), .c(new_n142_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n140_), .c(new_n84_), .O(new_n145_));
  ...
  oai21  g090(.a(new_n152_), .b(new_n126_), .c(new_n151_), .O(new_n153_));
  ...
  nand4  g100(.a(new_n72_), .b(new_n106_), .c(x20), .d(new_n160_), .O(new_n163_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n126_), .c(new_n168_), .O(new_n173_));
  ...
  nand3  g117(.a(new_n151_), .b(new_n76_), .c(new_n106_), .O(new_n180_));
  ...
  nand2  g122(.a(new_n184_), .b(x01), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(x40), .c(new_n106_), .O(z16));
  inv1   g124(.a(x24), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(x23), .c(x01), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(x40), .c(new_n106_), .O(z17));
  ...
  aoi21  g132(.a(new_n192_), .b(new_n107_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n83_), .c(new_n93_), .d(new_n121_), .O(z18));
  oai21  g134(.a(new_n145_), .b(x09), .c(new_n81_), .O(z19));
  oai22  g135(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n106_), .O(new_n199_));
