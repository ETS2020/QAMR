...
module FAU ( 
  ...
  oai21  g035(.a(x40), .b(new_n75_), .c(new_n97_), .O(z02));
  ...
  aoi21  g045(.a(new_n81_), .b(new_n64_), .c(new_n92_), .O(new_n108_));
  ...
  nor3   g067(.a(new_n99_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g076(.a(x35), .b(new_n92_), .c(new_n65_), .O(new_n139_));
  ...
  nor2   g090(.a(new_n76_), .b(x27), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  nand2  g092(.a(z08), .b(new_n65_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n71_), .c(new_n70_), .O(new_n156_));
  ...
  nor2   g107(.a(new_n134_), .b(x13), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n65_), .c(new_n99_), .O(new_n171_));
  ...
  nand2  g112(.a(new_n161_), .b(new_n65_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n174_), .c(z08), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand3  g116(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x27), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n84_), .c(new_n83_), .O(new_n181_));
  oai21  g119(.a(new_n153_), .b(new_n73_), .c(new_n175_), .O(new_n182_));
  inv1   g120(.a(z08), .O(new_n183_));
  nand2  g121(.a(new_n72_), .b(x27), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(new_n99_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n182_), .c(new_n181_), .d(new_n178_), .O(z14));
  nand4  g124(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n81_), .O(z15));
  inv1   g126(.a(x23), .O(new_n189_));
  nand4  g127(.a(new_n81_), .b(new_n189_), .c(x22), .d(x01), .O(new_n190_));
  inv1   g128(.a(new_n190_), .O(z16));
  inv1   g129(.a(x24), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(x23), .c(x22), .d(x01), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n81_), .O(z17));
  ...
  nand2  g135(.a(new_n83_), .b(new_n138_), .O(new_n198_));
  aoi21  g136(.a(new_n197_), .b(new_n92_), .c(new_n198_), .O(new_n199_));
  oai22  g137(.a(new_n199_), .b(new_n99_), .c(new_n90_), .d(new_n183_), .O(z18));
  nand2  g138(.a(new_n149_), .b(new_n81_), .O(z19));
  nand2  g139(.a(x28), .b(new_n64_), .O(new_n202_));
  aoi22  g140(.a(new_n202_), .b(x35), .c(new_n143_), .d(new_n141_), .O(new_n203_));
  nand2  g141(.a(new_n81_), .b(new_n64_), .O(new_n204_));
  nand2  g142(.a(x39), .b(new_n66_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n204_), .c(x08), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n203_), .c(new_n83_), .O(new_n207_));
