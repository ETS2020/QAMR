...
module FAU ( 
  ...
  aoi21  g033(.a(new_n71_), .b(x27), .c(new_n95_), .O(new_n96_));
  inv1   g034(.a(x40), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n78_), .O(new_n98_));
  oai21  g036(.a(new_n96_), .b(new_n78_), .c(new_n98_), .O(z03));
  aoi21  g037(.a(x35), .b(x28), .c(x40), .O(new_n100_));
  nor2   g038(.a(new_n83_), .b(new_n78_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(new_n100_), .c(x27), .O(new_n102_));
  nand3  g040(.a(new_n97_), .b(x39), .c(new_n70_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(x21), .O(new_n104_));
  nand3  g042(.a(new_n97_), .b(new_n70_), .c(new_n64_), .O(new_n105_));
  nand3  g043(.a(new_n105_), .b(new_n104_), .c(new_n102_), .O(z04));
  inv1   g044(.a(new_n79_), .O(new_n107_));
  ...
  aoi21  g061(.a(new_n123_), .b(x21), .c(new_n97_), .O(z08));
  ...
  aoi21  g074(.a(new_n136_), .b(x06), .c(new_n107_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(z10));
  inv1   g076(.a(x09), .O(new_n139_));
  nand3  g077(.a(x35), .b(new_n83_), .c(new_n65_), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(x21), .c(new_n79_), .d(new_n64_), .O(new_n141_));
  nand2  g079(.a(x39), .b(x29), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(x21), .O(new_n143_));
  ...
  oai21  g093(.a(new_n155_), .b(new_n97_), .c(new_n154_), .O(new_n156_));
  ...
  nand2  g105(.a(new_n167_), .b(x21), .O(new_n168_));
  ...
  oai22  g132(.a(new_n84_), .b(x27), .c(new_n128_), .d(new_n194_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(x08), .O(new_n196_));
  inv1   g134(.a(new_n84_), .O(new_n197_));
  nor2   g135(.a(new_n64_), .b(x04), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n197_), .c(x30), .O(new_n199_));
  nand4  g137(.a(new_n199_), .b(new_n196_), .c(new_n79_), .d(new_n139_), .O(z18));
  nand2  g138(.a(new_n149_), .b(new_n79_), .O(z19));
  nand2  g139(.a(x28), .b(new_n64_), .O(new_n202_));
  aoi22  g140(.a(new_n202_), .b(x35), .c(new_n143_), .d(x40), .O(new_n203_));
  oai21  g141(.a(new_n66_), .b(new_n64_), .c(x21), .O(new_n204_));
  nand2  g142(.a(new_n97_), .b(new_n64_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n204_), .c(x08), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n203_), .c(new_n81_), .O(new_n207_));
