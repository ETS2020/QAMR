...
module FAU ( 
  ...
  nand2  g036(.a(new_n76_), .b(x00), .O(new_n99_));
  ...
  oai22  g046(.a(x40), .b(x00), .c(new_n86_), .d(new_n64_), .O(new_n109_));
  ...
  nand2  g052(.a(x38), .b(x25), .O(new_n115_));
  nand2  g053(.a(new_n115_), .b(x00), .O(new_n116_));
  oai21  g054(.a(new_n76_), .b(x38), .c(new_n116_), .O(new_n117_));
  nand4  g055(.a(new_n117_), .b(new_n114_), .c(new_n113_), .d(new_n112_), .O(new_n118_));
  inv1   g056(.a(x14), .O(new_n119_));
  inv1   g057(.a(x25), .O(new_n120_));
  aoi21  g058(.a(x38), .b(new_n120_), .c(new_n76_), .O(new_n121_));
  oai21  g059(.a(new_n121_), .b(x00), .c(new_n119_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n118_), .c(new_n111_), .O(z07));
  ...
  nand2  g067(.a(x40), .b(new_n75_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n99_), .c(new_n129_), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x05), .O(new_n132_));
  inv1   g070(.a(new_n132_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n131_), .c(new_n88_), .O(new_n134_));
  nand3  g072(.a(new_n82_), .b(x37), .c(x06), .O(new_n135_));
  oai21  g073(.a(new_n134_), .b(x04), .c(new_n135_), .O(new_n136_));
  ...
  nand2  g079(.a(new_n82_), .b(new_n64_), .O(new_n142_));
  oai21  g080(.a(new_n87_), .b(x04), .c(x40), .O(new_n143_));
  ...
  aoi22  g086(.a(new_n148_), .b(new_n99_), .c(new_n146_), .d(new_n145_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n144_), .c(new_n84_), .O(new_n150_));
  ...
  nand2  g093(.a(new_n86_), .b(x00), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x35), .c(x37), .O(new_n157_));
  nand2  g095(.a(x27), .b(x00), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n157_), .c(new_n76_), .O(new_n159_));
  nand3  g097(.a(new_n159_), .b(new_n155_), .c(new_n154_), .O(z12));
  inv1   g098(.a(x19), .O(new_n161_));
  nand4  g099(.a(new_n82_), .b(new_n72_), .c(x20), .d(new_n161_), .O(new_n162_));
  ...
  nand4  g109(.a(new_n164_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n172_));
  ...
  nand2  g131(.a(new_n84_), .b(new_n193_), .O(new_n194_));
  aoi21  g132(.a(new_n192_), .b(new_n86_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n104_), .c(new_n93_), .d(new_n124_), .O(z18));
  nor2   g134(.a(x40), .b(x35), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n95_), .c(x00), .O(new_n198_));
  ...
  nand3  g142(.a(new_n204_), .b(new_n84_), .c(new_n193_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n82_), .O(z20));
