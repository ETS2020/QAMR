...
module FAU ( 
  ...
  oai22  g027(.a(new_n89_), .b(x02), .c(x27), .d(new_n65_), .O(new_n90_));
  nand2  g028(.a(new_n90_), .b(new_n88_), .O(new_n91_));
  aoi21  g029(.a(new_n83_), .b(x04), .c(new_n77_), .O(new_n92_));
  nand4  g030(.a(new_n92_), .b(new_n91_), .c(x40), .d(x39), .O(z02));
  inv1   g031(.a(new_n78_), .O(new_n94_));
  ...
  nor2   g040(.a(new_n102_), .b(new_n94_), .O(z05));
  aoi21  g041(.a(x40), .b(new_n77_), .c(x27), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(new_n82_), .c(new_n97_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(new_n78_), .O(z06));
  ...
  oai21  g061(.a(new_n72_), .b(new_n122_), .c(new_n123_), .O(new_n124_));
  ...
  oai21  g070(.a(new_n64_), .b(new_n65_), .c(new_n82_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n72_), .O(new_n134_));
  nand2  g072(.a(new_n66_), .b(x29), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n82_), .c(new_n65_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n104_), .c(new_n88_), .O(new_n137_));
  oai21  g075(.a(x39), .b(new_n77_), .c(x40), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n66_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n137_), .c(new_n134_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n80_), .c(new_n132_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n78_), .O(z11));
  nor2   g080(.a(new_n70_), .b(new_n64_), .O(new_n143_));
  nand3  g081(.a(new_n97_), .b(new_n67_), .c(new_n66_), .O(new_n144_));
  nand2  g082(.a(x40), .b(new_n64_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n144_), .c(x10), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n65_), .c(new_n143_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x29), .O(new_n148_));
  oai21  g086(.a(new_n143_), .b(x40), .c(new_n148_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n89_), .O(new_n152_));
  ...
  nand4  g097(.a(new_n126_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x29), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x40), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  oai21  g101(.a(x27), .b(new_n150_), .c(x29), .O(new_n164_));
  ...
  nand4  g105(.a(new_n167_), .b(new_n73_), .c(new_n150_), .d(new_n65_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  inv1   g107(.a(x39), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(x04), .c(x29), .O(new_n171_));
  nor2   g109(.a(new_n89_), .b(x13), .O(new_n172_));
  aoi22  g110(.a(new_n172_), .b(new_n171_), .c(x35), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n66_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n97_), .O(new_n176_));
  nand3  g114(.a(new_n171_), .b(new_n126_), .c(x40), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n64_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n169_), .d(new_n165_), .O(z14));
  nand4  g117(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n78_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(x22), .c(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n78_), .O(z16));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(x23), .c(x22), .d(x01), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n78_), .O(z17));
  ...
  nand2  g128(.a(new_n80_), .b(new_n132_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n82_), .c(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n73_), .b(x29), .c(x08), .O(new_n193_));
  oai21  g131(.a(new_n192_), .b(new_n94_), .c(new_n193_), .O(z18));
  oai21  g132(.a(new_n82_), .b(x27), .c(x35), .O(new_n195_));
  and2   g133(.a(new_n195_), .b(new_n138_), .O(new_n196_));
  nand2  g134(.a(new_n78_), .b(new_n64_), .O(new_n197_));
  aoi21  g135(.a(new_n135_), .b(new_n197_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n80_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(x09), .O(z20));
  nand2  g138(.a(new_n141_), .b(new_n78_), .O(z19));
endmodule
