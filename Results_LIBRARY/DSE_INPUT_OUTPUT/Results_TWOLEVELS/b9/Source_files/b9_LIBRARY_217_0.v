...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(x39), .O(new_n94_));
  ...
  oai22  g041(.a(x40), .b(x39), .c(new_n83_), .d(new_n97_), .O(new_n104_));
  ...
  nand3  g079(.a(new_n141_), .b(new_n80_), .c(new_n133_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n65_), .O(z11));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n66_), .b(new_n82_), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi22  g084(.a(new_n68_), .b(x27), .c(x39), .d(new_n72_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x40), .O(new_n148_));
  nand3  g086(.a(new_n69_), .b(new_n64_), .c(x39), .O(new_n149_));
  ...
  nand4  g104(.a(new_n166_), .b(new_n165_), .c(x40), .d(x39), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n66_), .b(new_n144_), .c(x28), .O(new_n169_));
  oai21  g107(.a(new_n63_), .b(x27), .c(new_n169_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n81_), .c(new_n80_), .O(new_n171_));
  oai21  g109(.a(new_n63_), .b(x04), .c(x40), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n94_), .c(new_n151_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n67_), .c(new_n66_), .O(new_n174_));
  aoi21  g112(.a(x40), .b(x27), .c(x39), .O(new_n175_));
  oai21  g113(.a(new_n166_), .b(new_n64_), .c(new_n94_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n97_), .c(new_n175_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n174_), .c(new_n171_), .d(new_n168_), .O(z14));
  ...
  oai21  g124(.a(new_n84_), .b(x27), .c(new_n134_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  inv1   g126(.a(new_n84_), .O(new_n189_));
  nor2   g127(.a(new_n97_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n188_), .c(new_n65_), .d(new_n80_), .O(z18));
  inv1   g130(.a(new_n134_), .O(new_n193_));
  oai21  g131(.a(new_n144_), .b(new_n97_), .c(new_n137_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n97_), .c(new_n144_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n194_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n80_), .c(new_n133_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n65_), .O(z20));
  nand2  g136(.a(new_n142_), .b(new_n65_), .O(z19));
endmodule
