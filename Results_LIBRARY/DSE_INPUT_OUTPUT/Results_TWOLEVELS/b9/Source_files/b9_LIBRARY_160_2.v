...
module FAU ( 
  ...
  oai21  g044(.a(new_n106_), .b(new_n64_), .c(new_n70_), .O(new_n107_));
  and2   g045(.a(new_n107_), .b(new_n81_), .O(z05));
  ...
  oai21  g056(.a(x25), .b(x00), .c(x40), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(x38), .O(new_n120_));
  ...
  nand3  g077(.a(x35), .b(new_n106_), .c(new_n65_), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(x40), .c(new_n81_), .d(new_n64_), .O(new_n141_));
  ...
  aoi22  g083(.a(new_n145_), .b(new_n85_), .c(new_n144_), .d(new_n97_), .O(new_n146_));
  ...
  oai21  g092(.a(new_n154_), .b(new_n96_), .c(new_n153_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n81_), .O(z12));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n65_), .c(new_n101_), .O(new_n167_));
  ...
  oai21  g111(.a(new_n173_), .b(new_n96_), .c(new_n169_), .O(new_n174_));
  ...
  nand3  g118(.a(new_n153_), .b(new_n76_), .c(new_n100_), .O(new_n181_));
  ...
  aoi21  g132(.a(new_n194_), .b(new_n85_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n81_), .d(new_n83_), .O(z18));
  oai21  g134(.a(new_n147_), .b(x09), .c(new_n81_), .O(z19));
  inv1   g135(.a(x09), .O(new_n198_));
  oai22  g136(.a(new_n76_), .b(x35), .c(new_n106_), .d(x27), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n143_), .O(new_n200_));
  nor2   g138(.a(new_n76_), .b(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n96_), .c(new_n66_), .O(new_n202_));
  nor2   g140(.a(new_n101_), .b(x08), .O(new_n203_));
  nor2   g141(.a(x40), .b(new_n106_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n203_), .c(new_n64_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n202_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n83_), .c(new_n198_), .O(new_n207_));
