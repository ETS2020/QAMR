...
module FAU ( 
  ...
  nor2   g036(.a(x40), .b(x32), .O(new_n99_));
  ...
  aoi21  g047(.a(new_n81_), .b(new_n64_), .c(new_n86_), .O(new_n110_));
  ...
  aoi21  g072(.a(new_n85_), .b(new_n84_), .c(new_n76_), .O(new_n135_));
  ...
  aoi21  g080(.a(new_n142_), .b(x40), .c(new_n99_), .O(new_n143_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n76_), .c(new_n85_), .O(new_n153_));
  ...
  oai21  g101(.a(new_n76_), .b(new_n84_), .c(new_n85_), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n155_), .d(new_n65_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n163_), .c(new_n81_), .O(z13));
  ...
  oai21  g109(.a(new_n76_), .b(new_n84_), .c(new_n64_), .O(new_n172_));
  oai21  g110(.a(x30), .b(new_n86_), .c(x40), .O(new_n173_));
  aoi22  g111(.a(new_n173_), .b(new_n66_), .c(new_n76_), .d(new_n86_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(x37), .c(new_n172_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n85_), .O(new_n176_));
  inv1   g114(.a(new_n71_), .O(new_n177_));
  oai21  g115(.a(new_n75_), .b(x04), .c(x40), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n155_), .c(new_n177_), .O(new_n179_));
  nand3  g117(.a(x39), .b(new_n155_), .c(new_n65_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x40), .c(new_n64_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n81_), .O(new_n182_));
  aoi21  g120(.a(new_n179_), .b(new_n70_), .c(new_n182_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n176_), .c(new_n171_), .O(z14));
  ...
  oai22  g137(.a(new_n199_), .b(new_n83_), .c(new_n93_), .d(new_n123_), .O(z18));
