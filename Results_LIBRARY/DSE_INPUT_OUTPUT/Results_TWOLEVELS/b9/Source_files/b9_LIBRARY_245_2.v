...
module FAU ( 
  ...
  nor2   g036(.a(new_n98_), .b(new_n65_), .O(z05));
  ...
  aoi21  g049(.a(new_n111_), .b(new_n109_), .c(new_n63_), .O(new_n112_));
  aoi21  g050(.a(new_n112_), .b(new_n108_), .c(new_n100_), .O(z07));
  ...
  nand2  g072(.a(new_n64_), .b(new_n68_), .O(new_n135_));
  ...
  aoi21  g078(.a(new_n140_), .b(x40), .c(new_n121_), .O(new_n141_));
  ...
  nor2   g087(.a(new_n71_), .b(x40), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n100_), .O(new_n151_));
  ...
  nor2   g100(.a(new_n131_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n73_), .c(new_n65_), .O(new_n164_));
  ...
  nand3  g105(.a(x39), .b(new_n153_), .c(new_n73_), .O(new_n168_));
  ...
  nand3  g109(.a(new_n69_), .b(new_n145_), .c(x28), .O(new_n172_));
  ...
  nand3  g114(.a(new_n176_), .b(new_n171_), .c(new_n151_), .O(z14));
  inv1   g115(.a(x12), .O(new_n178_));
  nor2   g116(.a(new_n117_), .b(new_n178_), .O(z15));
  ...
  oai22  g124(.a(new_n114_), .b(new_n186_), .c(new_n83_), .d(x27), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n68_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n138_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n64_), .d(new_n79_), .O(z18));
  aoi21  g129(.a(x28), .b(new_n68_), .c(new_n145_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(new_n141_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n145_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n135_), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n79_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z20));
  nor2   g135(.a(new_n143_), .b(x09), .O(z19));
endmodule
