...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(x34), .d(new_n66_), .O(new_n77_));
  ...
  nand2  g031(.a(new_n93_), .b(x34), .O(new_n94_));
  nand2  g032(.a(new_n82_), .b(x27), .O(new_n95_));
  nand2  g033(.a(new_n69_), .b(x28), .O(new_n96_));
  oai21  g034(.a(new_n96_), .b(new_n95_), .c(new_n74_), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n94_), .O(z02));
  nand2  g036(.a(new_n70_), .b(x27), .O(new_n99_));
  nand3  g037(.a(new_n64_), .b(new_n69_), .c(new_n68_), .O(new_n100_));
  ...
  aoi21  g057(.a(new_n119_), .b(x34), .c(new_n74_), .O(z08));
  ...
  nand2  g070(.a(new_n132_), .b(new_n123_), .O(new_n133_));
  nand3  g071(.a(x37), .b(x27), .c(x06), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n64_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  aoi21  g074(.a(x40), .b(new_n63_), .c(x27), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n82_), .c(new_n123_), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x34), .c(new_n137_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x34), .O(new_n141_));
  ...
  aoi21  g089(.a(x39), .b(new_n123_), .c(new_n71_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(x34), .O(new_n153_));
  ...
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n123_), .O(new_n158_));
  ...
  nand4  g104(.a(new_n130_), .b(x34), .c(new_n155_), .d(new_n123_), .O(new_n167_));
  ...
  nand4  g108(.a(new_n156_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n170_), .c(new_n155_), .d(new_n123_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n169_), .O(new_n173_));
  nand3  g111(.a(new_n69_), .b(new_n149_), .c(x28), .O(new_n174_));
  oai21  g112(.a(new_n63_), .b(x27), .c(new_n174_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n80_), .c(new_n79_), .O(new_n176_));
  oai21  g114(.a(new_n119_), .b(x04), .c(x34), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(x40), .c(new_n155_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n70_), .c(new_n69_), .O(new_n179_));
  nand3  g117(.a(x39), .b(new_n155_), .c(new_n123_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x34), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n68_), .c(new_n65_), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n179_), .c(new_n176_), .d(new_n173_), .O(z14));
  ...
  aoi21  g133(.a(new_n195_), .b(new_n194_), .c(new_n149_), .O(new_n196_));
  nand2  g134(.a(new_n79_), .b(new_n136_), .O(new_n197_));
  aoi21  g135(.a(new_n196_), .b(new_n82_), .c(new_n197_), .O(new_n198_));
  nand2  g136(.a(new_n170_), .b(x34), .O(new_n199_));
  oai22  g137(.a(new_n199_), .b(new_n89_), .c(new_n198_), .d(new_n65_), .O(z18));
  inv1   g138(.a(new_n147_), .O(z19));
  nor2   g139(.a(new_n82_), .b(x27), .O(new_n202_));
  nor2   g140(.a(x35), .b(new_n63_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n140_), .O(new_n204_));
  inv1   g142(.a(x08), .O(new_n205_));
  oai21  g143(.a(new_n203_), .b(new_n137_), .c(new_n205_), .O(new_n206_));
  oai21  g144(.a(new_n202_), .b(new_n149_), .c(new_n74_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n206_), .c(new_n204_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n79_), .c(new_n136_), .O(new_n209_));
  nand2  g147(.a(new_n209_), .b(new_n64_), .O(z20));
endmodule
