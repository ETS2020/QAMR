...
module FAU ( 
  ...
  nand3  g040(.a(new_n102_), .b(new_n79_), .c(new_n68_), .O(z05));
  oai22  g041(.a(x40), .b(new_n63_), .c(new_n83_), .d(new_n67_), .O(new_n104_));
  ...
  nand2  g055(.a(new_n94_), .b(new_n79_), .O(z08));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n79_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nor2   g070(.a(x40), .b(x35), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n92_), .c(new_n63_), .O(new_n134_));
  oai21  g072(.a(new_n67_), .b(new_n72_), .c(new_n83_), .O(new_n135_));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  aoi21  g075(.a(x35), .b(x27), .c(x08), .O(new_n138_));
  aoi21  g076(.a(x39), .b(x29), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n138_), .c(x40), .O(new_n140_));
  inv1   g078(.a(x08), .O(new_n141_));
  oai21  g079(.a(x28), .b(x04), .c(new_n141_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(new_n140_), .c(new_n137_), .d(new_n134_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n80_), .c(new_n132_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n79_), .O(z11));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n68_), .b(new_n82_), .c(new_n146_), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x27), .c(x10), .O(new_n148_));
  aoi21  g086(.a(x39), .b(new_n72_), .c(new_n70_), .O(new_n149_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n74_), .c(new_n63_), .O(new_n153_));
  ...
  nand3  g107(.a(x39), .b(new_n155_), .c(new_n72_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n74_), .O(new_n172_));
  nand2  g110(.a(new_n74_), .b(new_n63_), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n172_), .c(new_n168_), .O(new_n175_));
  nand3  g113(.a(new_n68_), .b(new_n146_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n80_), .O(new_n178_));
  nand2  g116(.a(new_n170_), .b(new_n152_), .O(new_n179_));
  ...
  nand2  g123(.a(new_n185_), .b(x01), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(x40), .c(new_n63_), .O(z16));
  nand3  g125(.a(x23), .b(x22), .c(x01), .O(new_n188_));
  nor3   g126(.a(new_n188_), .b(new_n74_), .c(x24), .O(z17));
  oai21  g127(.a(new_n84_), .b(x27), .c(new_n136_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  inv1   g129(.a(new_n84_), .O(new_n192_));
  nor2   g130(.a(new_n67_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n191_), .c(new_n79_), .d(new_n80_), .O(z18));
  nand2  g133(.a(x28), .b(new_n67_), .O(new_n196_));
  nand2  g134(.a(x39), .b(x29), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(x40), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(new_n173_), .c(new_n196_), .d(x35), .O(new_n199_));
  oai21  g137(.a(x40), .b(new_n63_), .c(new_n67_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n146_), .O(new_n201_));
  ...
  nand2  g142(.a(new_n144_), .b(new_n79_), .O(z19));
endmodule
