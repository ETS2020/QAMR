...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x29), .O(new_n81_));
  ...
  nor2   g031(.a(new_n76_), .b(x08), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n93_), .c(new_n92_), .O(new_n95_));
  inv1   g033(.a(new_n87_), .O(new_n96_));
  nor2   g034(.a(new_n96_), .b(new_n76_), .O(new_n97_));
  nor2   g035(.a(x27), .b(x08), .O(new_n98_));
  oai21  g036(.a(new_n98_), .b(new_n97_), .c(x04), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n95_), .c(new_n77_), .O(z02));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n101_), .c(new_n81_), .O(z04));
  ...
  nand2  g064(.a(new_n76_), .b(x29), .O(new_n127_));
  ...
  oai21  g077(.a(new_n87_), .b(x04), .c(x29), .O(new_n140_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n96_), .c(new_n143_), .d(new_n127_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n141_), .c(new_n84_), .O(new_n146_));
  ...
  nand2  g091(.a(new_n153_), .b(x29), .O(new_n154_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n159_), .c(new_n76_), .O(new_n163_));
  nand4  g101(.a(new_n72_), .b(x29), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n136_), .b(new_n156_), .c(new_n65_), .O(new_n167_));
  ...
  nand4  g108(.a(new_n157_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n171_));
  nand3  g109(.a(x39), .b(new_n156_), .c(new_n65_), .O(new_n172_));
  ...
  oai21  g116(.a(new_n173_), .b(new_n150_), .c(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n175_), .c(new_n154_), .O(z14));
  ...
  oai22  g128(.a(new_n87_), .b(x27), .c(new_n121_), .d(new_n93_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n96_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n192_), .c(new_n82_), .d(new_n84_), .O(z18));
  oai22  g133(.a(new_n76_), .b(x35), .c(new_n86_), .d(x27), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n142_), .O(new_n197_));
  aoi21  g135(.a(x35), .b(x27), .c(x08), .O(new_n198_));
  nor2   g136(.a(x40), .b(x35), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(x29), .O(new_n200_));
  nor2   g138(.a(x40), .b(new_n86_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n94_), .c(new_n64_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n200_), .c(new_n197_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n84_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(x09), .c(new_n82_), .O(z20));
  nor2   g143(.a(new_n146_), .b(x09), .O(z19));
endmodule
