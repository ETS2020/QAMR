...
module FAU ( 
  ...
  nor2   g014(.a(x22), .b(new_n76_), .O(new_n77_));
  ...
  oai22  g041(.a(new_n95_), .b(new_n64_), .c(x22), .d(new_n76_), .O(new_n104_));
  ...
  aoi21  g087(.a(new_n149_), .b(x28), .c(new_n119_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n76_), .d(new_n65_), .O(new_n151_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n65_), .c(new_n77_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  nand3  g099(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n162_));
  nor2   g100(.a(new_n89_), .b(x04), .O(new_n163_));
  nand4  g101(.a(new_n149_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n163_), .c(x13), .O(new_n165_));
  inv1   g103(.a(x22), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(new_n76_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(new_n162_), .O(new_n168_));
  nand3  g106(.a(new_n97_), .b(new_n66_), .c(x28), .O(new_n169_));
  ...
  nand2  g111(.a(new_n154_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(x22), .c(x13), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n173_), .c(new_n168_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n94_), .O(z15));
  ...
  nand2  g121(.a(new_n90_), .b(new_n64_), .O(new_n184_));
  ...
  aoi21  g125(.a(new_n187_), .b(new_n90_), .c(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n94_), .d(new_n183_), .O(z18));
  aoi21  g127(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n138_), .c(new_n134_), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n94_), .c(new_n80_), .d(new_n183_), .O(new_n192_));
  inv1   g130(.a(new_n192_), .O(z20));
  oai21  g131(.a(new_n142_), .b(x09), .c(new_n94_), .O(z19));
endmodule
