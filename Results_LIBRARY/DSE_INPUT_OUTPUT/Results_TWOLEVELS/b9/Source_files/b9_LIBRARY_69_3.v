...
module FAU ( 
  ...
  aoi21  g038(.a(new_n100_), .b(new_n96_), .c(new_n99_), .O(z04));
  nand2  g039(.a(x28), .b(x27), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n70_), .c(new_n99_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n78_), .c(new_n70_), .O(new_n104_));
  ...
  oai21  g055(.a(x39), .b(x26), .c(x40), .O(new_n118_));
  inv1   g056(.a(new_n118_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nor2   g058(.a(new_n120_), .b(x40), .O(z09));
  nand2  g059(.a(new_n118_), .b(x07), .O(new_n122_));
  nand4  g060(.a(x40), .b(x39), .c(new_n88_), .d(x05), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n84_), .O(new_n124_));
  ...
  nand2  g066(.a(new_n82_), .b(new_n81_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x40), .O(new_n130_));
  nor2   g068(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n88_), .c(x05), .d(new_n65_), .O(new_n132_));
  ...
  oai21  g074(.a(new_n136_), .b(new_n90_), .c(new_n135_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand2  g076(.a(x27), .b(new_n65_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n90_), .c(new_n138_), .O(new_n140_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n88_), .O(new_n147_));
  ...
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n148_), .O(new_n154_));
  ...
  nand4  g098(.a(new_n129_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n88_), .O(new_n162_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n148_), .c(new_n165_), .O(new_n170_));
  ...
  aoi21  g116(.a(new_n178_), .b(new_n148_), .c(new_n88_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand4  g118(.a(new_n78_), .b(new_n180_), .c(x22), .d(x01), .O(new_n181_));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n139_), .c(new_n66_), .O(new_n187_));
  ...
  nand3  g128(.a(new_n190_), .b(new_n88_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n189_), .b(new_n99_), .c(new_n191_), .O(z18));
  oai21  g130(.a(new_n66_), .b(new_n64_), .c(new_n138_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n190_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n81_), .c(new_n134_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n78_), .O(z20));
  nand2  g135(.a(new_n142_), .b(new_n78_), .O(z19));
endmodule
