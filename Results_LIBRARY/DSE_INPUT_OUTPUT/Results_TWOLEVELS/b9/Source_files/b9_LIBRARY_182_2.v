...
module FAU ( 
  ...
  oai22  g040(.a(x40), .b(new_n102_), .c(new_n82_), .d(new_n91_), .O(new_n103_));
  ...
  inv1   g046(.a(x38), .O(new_n109_));
  oai21  g047(.a(new_n109_), .b(x00), .c(new_n102_), .O(new_n110_));
  oai21  g048(.a(new_n63_), .b(x38), .c(new_n110_), .O(new_n111_));
  nand4  g049(.a(new_n111_), .b(new_n108_), .c(new_n107_), .d(new_n106_), .O(new_n112_));
  inv1   g050(.a(x14), .O(new_n113_));
  oai21  g051(.a(new_n63_), .b(new_n102_), .c(new_n110_), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n112_), .c(new_n105_), .O(z07));
  ...
  nor2   g081(.a(new_n63_), .b(x27), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n73_), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n71_), .c(new_n63_), .O(new_n146_));
  nor2   g084(.a(x40), .b(x25), .O(new_n147_));
  ...
  nand4  g095(.a(new_n67_), .b(new_n102_), .c(x20), .d(new_n155_), .O(new_n158_));
  ...
  nand3  g113(.a(new_n68_), .b(new_n63_), .c(new_n102_), .O(new_n176_));
  ...
  nor2   g125(.a(new_n78_), .b(x30), .O(new_n188_));
