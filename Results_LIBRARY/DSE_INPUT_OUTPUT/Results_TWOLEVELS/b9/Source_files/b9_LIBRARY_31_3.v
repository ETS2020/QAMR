...
module FAU ( 
  ...
  nand2  g015(.a(x40), .b(x34), .O(new_n78_));
  ...
  inv1   g024(.a(x34), .O(new_n87_));
  aoi21  g025(.a(x29), .b(x08), .c(x02), .O(new_n88_));
  nor2   g026(.a(new_n83_), .b(new_n65_), .O(new_n89_));
  ...
  nand3  g031(.a(new_n70_), .b(x28), .c(new_n64_), .O(new_n94_));
  nand2  g032(.a(new_n78_), .b(x39), .O(new_n95_));
  aoi21  g033(.a(new_n94_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n92_), .c(new_n90_), .O(z02));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n70_), .c(new_n99_), .O(z05));
  ...
  nand3  g056(.a(x40), .b(x39), .c(new_n87_), .O(new_n119_));
  inv1   g057(.a(new_n119_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nor2   g059(.a(new_n121_), .b(x40), .O(z09));
  ...
  nand4  g064(.a(x40), .b(x39), .c(new_n87_), .d(x05), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n124_), .O(new_n128_));
  nand3  g066(.a(new_n78_), .b(x37), .c(x06), .O(new_n129_));
  ...
  nand4  g073(.a(new_n135_), .b(new_n87_), .c(x05), .d(new_n65_), .O(new_n136_));
  oai21  g074(.a(new_n131_), .b(new_n64_), .c(new_n136_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  aoi21  g076(.a(x40), .b(x34), .c(x27), .O(new_n139_));
  nand3  g077(.a(x35), .b(new_n123_), .c(new_n65_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n87_), .c(new_n139_), .O(new_n141_));
  aoi21  g079(.a(x39), .b(x29), .c(x34), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n123_), .O(new_n144_));
  oai21  g082(.a(new_n142_), .b(new_n93_), .c(new_n144_), .O(new_n145_));
  ...
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n87_), .O(new_n152_));
  ...
  aoi21  g095(.a(new_n157_), .b(x28), .c(new_n93_), .O(new_n158_));
  ...
  nand4  g102(.a(new_n133_), .b(x39), .c(new_n156_), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n87_), .O(new_n166_));
  ...
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(x34), .O(new_n173_));
  ...
  nand2  g128(.a(new_n83_), .b(new_n64_), .O(new_n191_));
  ...
  aoi21  g133(.a(new_n195_), .b(new_n83_), .c(x09), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n78_), .d(new_n81_), .O(z18));
  inv1   g135(.a(new_n147_), .O(z19));
  nand2  g136(.a(x39), .b(x29), .O(new_n199_));
  nor2   g137(.a(new_n123_), .b(x27), .O(new_n200_));
  nor2   g138(.a(x35), .b(x34), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n199_), .O(new_n202_));
  inv1   g140(.a(x08), .O(new_n203_));
  oai21  g141(.a(new_n201_), .b(new_n139_), .c(new_n203_), .O(new_n204_));
  oai21  g142(.a(new_n200_), .b(new_n66_), .c(new_n93_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n202_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n81_), .c(new_n138_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n78_), .O(z20));
endmodule
