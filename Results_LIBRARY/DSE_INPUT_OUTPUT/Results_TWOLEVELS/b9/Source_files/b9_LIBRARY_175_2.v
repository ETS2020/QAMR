...
module FAU ( 
  ...
  nor2   g060(.a(new_n122_), .b(new_n80_), .O(z09));
  ...
  nand3  g067(.a(new_n129_), .b(x39), .c(x05), .O(new_n130_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n99_), .O(new_n143_));
  ...
  oai21  g089(.a(new_n151_), .b(x04), .c(new_n71_), .O(new_n152_));
  aoi21  g090(.a(new_n85_), .b(new_n98_), .c(new_n66_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(x40), .c(new_n152_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(new_n70_), .O(new_n155_));
  aoi21  g093(.a(x27), .b(new_n98_), .c(x40), .O(new_n156_));
  ...
  nand3  g097(.a(new_n159_), .b(new_n155_), .c(new_n150_), .O(z12));
  ...
  nand4  g106(.a(new_n72_), .b(new_n98_), .c(x20), .d(new_n166_), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(x18), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(x27), .O(new_n171_));
  nand4  g109(.a(new_n129_), .b(x39), .c(new_n161_), .d(new_n65_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(z13));
  nor2   g111(.a(x19), .b(x18), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n148_), .c(new_n72_), .d(x20), .O(new_n175_));
  oai21  g113(.a(x13), .b(x04), .c(new_n175_), .O(new_n176_));
  aoi21  g114(.a(new_n99_), .b(x39), .c(x28), .O(new_n177_));
  nand2  g115(.a(new_n128_), .b(x28), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(z08), .c(x35), .O(new_n179_));
  oai21  g117(.a(new_n179_), .b(new_n177_), .c(new_n70_), .O(new_n180_));
  oai21  g118(.a(new_n128_), .b(new_n75_), .c(new_n64_), .O(new_n181_));
  nand3  g119(.a(x20), .b(new_n166_), .c(new_n165_), .O(new_n182_));
  nand4  g120(.a(new_n162_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(z08), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n182_), .c(new_n104_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n181_), .c(new_n180_), .d(new_n176_), .O(z14));
  nand3  g124(.a(x34), .b(x27), .c(x12), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(x40), .c(new_n98_), .O(z15));
  ...
  nand4  g131(.a(new_n81_), .b(new_n193_), .c(x23), .d(x22), .O(new_n194_));
  ...
  nand2  g137(.a(new_n83_), .b(new_n199_), .O(new_n200_));
  aoi21  g138(.a(new_n198_), .b(new_n85_), .c(new_n200_), .O(new_n201_));
  oai22  g139(.a(new_n201_), .b(new_n104_), .c(new_n92_), .d(new_n75_), .O(z18));
  nor2   g140(.a(x40), .b(x35), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n94_), .c(new_n98_), .O(new_n204_));
  ...
  nand2  g145(.a(z08), .b(x29), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(x28), .c(new_n64_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n207_), .c(new_n204_), .O(new_n210_));
  nand3  g148(.a(new_n210_), .b(new_n83_), .c(new_n199_), .O(new_n211_));
