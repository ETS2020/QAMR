...
module FAU ( 
  ...
  aoi21  g22(.a(new_n85_), .b(new_n81_), .c(z08), .O(z04));
  ...
  inv1   g51(.a(x28), .O(new_n115_));
  nand2  g52(.a(x27), .b(x04), .O(new_n116_));
  inv1   g53(.a(x08), .O(new_n117_));
  nand2  g54(.a(new_n64_), .b(new_n117_), .O(new_n118_));
  nand4  g55(.a(new_n118_), .b(new_n116_), .c(x35), .d(new_n115_), .O(new_n119_));
  nand4  g56(.a(new_n119_), .b(new_n68_), .c(new_n71_), .d(new_n114_), .O(new_n120_));
  inv1   g57(.a(new_n120_), .O(z11));
  nor2   g58(.a(z08), .b(new_n66_), .O(z12));
  inv1   g59(.a(x18), .O(new_n123_));
  inv1   g60(.a(x19), .O(new_n124_));
  nand4  g61(.a(new_n66_), .b(x20), .c(new_n124_), .d(new_n123_), .O(new_n125_));
  nand2  g62(.a(new_n125_), .b(new_n68_), .O(z13));
  nand3  g63(.a(x20), .b(new_n124_), .c(new_n123_), .O(new_n127_));
  nor2   g64(.a(new_n127_), .b(new_n65_), .O(new_n128_));
  aoi21  g65(.a(new_n128_), .b(x27), .c(z08), .O(z14));
  ...
  inv1   g71(.a(x01), .O(new_n135_));
  inv1   g72(.a(x24), .O(new_n136_));
  nand4  g73(.a(new_n68_), .b(new_n136_), .c(x23), .d(x22), .O(new_n137_));
  nor2   g74(.a(new_n137_), .b(new_n135_), .O(z17));
  nand2  g75(.a(x27), .b(new_n108_), .O(new_n139_));
  oai21  g76(.a(x27), .b(new_n117_), .c(new_n139_), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(x35), .c(new_n115_), .O(new_n141_));
  nor2   g78(.a(x30), .b(x09), .O(new_n142_));
  aoi21  g79(.a(new_n142_), .b(new_n141_), .c(z08), .O(z18));
  nand2  g80(.a(new_n120_), .b(new_n68_), .O(z19));
  oai21  g81(.a(x28), .b(new_n117_), .c(new_n64_), .O(new_n145_));
  nand2  g82(.a(new_n145_), .b(x35), .O(new_n146_));
  nand4  g83(.a(new_n146_), .b(new_n68_), .c(new_n71_), .d(new_n114_), .O(new_n147_));
  inv1   g84(.a(new_n147_), .O(z20));
  one    g85(.O(z02));
endmodule
