...
module FAU ( 
  ...
  nand2  g032(.a(new_n68_), .b(x28), .O(new_n95_));
  ...
  aoi21  g056(.a(new_n118_), .b(x11), .c(new_n75_), .O(z08));
  ...
  nand3  g072(.a(x35), .b(new_n83_), .c(new_n122_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x11), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n134_), .c(x08), .O(new_n137_));
  inv1   g075(.a(new_n84_), .O(new_n138_));
  nand2  g076(.a(x39), .b(x29), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(x11), .c(new_n75_), .O(new_n140_));
  ...
  nor2   g082(.a(x27), .b(new_n63_), .O(new_n145_));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n74_), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n122_), .c(new_n63_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n75_), .c(new_n71_), .O(new_n149_));
  ...
  nand4  g097(.a(new_n128_), .b(x39), .c(new_n151_), .d(new_n122_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x11), .O(new_n161_));
  ...
  nand4  g102(.a(new_n152_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n165_));
  nand3  g103(.a(x39), .b(new_n151_), .c(new_n122_), .O(new_n166_));
  ...
  nand2  g111(.a(new_n166_), .b(new_n71_), .O(new_n174_));
  ...
  nand2  g125(.a(x27), .b(new_n122_), .O(new_n188_));
  ...
  inv1   g131(.a(new_n123_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(x29), .c(x11), .d(x08), .O(new_n195_));
  oai21  g133(.a(new_n193_), .b(new_n65_), .c(new_n195_), .O(z18));
  aoi21  g134(.a(x28), .b(new_n99_), .c(new_n170_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n140_), .O(new_n198_));
  oai21  g136(.a(new_n170_), .b(new_n99_), .c(x11), .O(new_n199_));
  nand2  g137(.a(new_n75_), .b(new_n99_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n199_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n198_), .c(new_n80_), .O(new_n202_));
  nor2   g140(.a(new_n202_), .b(x09), .O(z20));
  nor2   g141(.a(new_n143_), .b(x09), .O(z19));
endmodule
