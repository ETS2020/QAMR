...
module FAU ( 
  ...
  aoi21  g033(.a(x40), .b(new_n66_), .c(x28), .O(new_n96_));
  oai21  g034(.a(x27), .b(x08), .c(new_n96_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(x04), .c(new_n95_), .O(new_n98_));
  oai21  g036(.a(new_n94_), .b(x02), .c(new_n98_), .O(z02));
  ...
  nor2   g044(.a(new_n106_), .b(new_n101_), .O(z05));
  ...
  nand2  g061(.a(new_n76_), .b(x34), .O(new_n124_));
  ...
  oai21  g084(.a(new_n146_), .b(x09), .c(new_n82_), .O(z11));
  ...
  nand2  g091(.a(new_n153_), .b(x34), .O(new_n154_));
  ...
  nand2  g136(.a(new_n198_), .b(x34), .O(new_n199_));
  nand2  g137(.a(x35), .b(x27), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(x40), .c(new_n92_), .O(new_n201_));
  nand3  g139(.a(new_n76_), .b(x28), .c(new_n64_), .O(new_n202_));
