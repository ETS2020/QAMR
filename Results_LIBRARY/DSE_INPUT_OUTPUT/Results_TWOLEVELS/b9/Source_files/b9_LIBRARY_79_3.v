...
module FAU ( 
  ...
  nand2  g54(.a(new_n117_), .b(new_n68_), .O(z11));
  oai21  g55(.a(z08), .b(x28), .c(x35), .O(new_n119_));
  nand2  g56(.a(new_n119_), .b(new_n64_), .O(new_n120_));
  nand3  g57(.a(new_n120_), .b(new_n68_), .c(x27), .O(z12));
  nand4  g58(.a(new_n68_), .b(new_n66_), .c(x27), .d(x20), .O(new_n122_));
  nor3   g59(.a(new_n122_), .b(x19), .c(x18), .O(z13));
  nand3  g60(.a(new_n68_), .b(x27), .c(x20), .O(new_n124_));
  nor3   g61(.a(new_n124_), .b(x19), .c(x18), .O(new_n125_));
  nand2  g62(.a(new_n125_), .b(new_n120_), .O(z14));
  nand4  g63(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n127_));
  nand2  g64(.a(new_n127_), .b(new_n68_), .O(z15));
  inv1   g65(.a(x23), .O(new_n129_));
  nand3  g66(.a(new_n129_), .b(x22), .c(x01), .O(new_n130_));
  nand2  g67(.a(new_n130_), .b(new_n68_), .O(z16));
  inv1   g68(.a(x01), .O(new_n132_));
  inv1   g69(.a(x24), .O(new_n133_));
  nand4  g70(.a(new_n68_), .b(new_n133_), .c(x23), .d(x22), .O(new_n134_));
  ...
  inv1   g77(.a(new_n117_), .O(z19));
  oai21  g78(.a(x28), .b(new_n114_), .c(new_n79_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g80(.a(new_n143_), .b(new_n68_), .c(new_n70_), .d(new_n111_), .O(new_n144_));
