...
module FAU ( 
  ...
  nand2  g031(.a(new_n65_), .b(new_n90_), .O(new_n94_));
  nand4  g032(.a(new_n94_), .b(new_n93_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g033(.a(new_n64_), .O(new_n96_));
  aoi21  g034(.a(new_n65_), .b(new_n90_), .c(x21), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n93_), .c(new_n96_), .O(z04));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n64_), .c(new_n65_), .O(z05));
  aoi21  g038(.a(new_n64_), .b(new_n90_), .c(new_n81_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(x37), .c(new_n64_), .O(z06));
  ...
  inv1   g053(.a(x26), .O(new_n116_));
  nand3  g054(.a(x34), .b(x27), .c(x11), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(x40), .c(new_n116_), .O(z09));
  inv1   g056(.a(x05), .O(new_n119_));
  nand2  g057(.a(new_n114_), .b(x07), .O(new_n120_));
  oai21  g058(.a(new_n114_), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  ...
  nor2   g066(.a(new_n65_), .b(new_n90_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n96_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n64_), .d(new_n90_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  nand2  g074(.a(new_n63_), .b(new_n116_), .O(new_n137_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n78_), .c(new_n132_), .O(new_n143_));
  inv1   g081(.a(new_n143_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  nor2   g083(.a(new_n63_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n73_), .O(new_n147_));
  inv1   g085(.a(new_n114_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n71_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n66_), .c(new_n65_), .O(new_n150_));
  aoi21  g088(.a(x27), .b(new_n116_), .c(x40), .O(new_n151_));
  nand2  g089(.a(x40), .b(x04), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x39), .c(x27), .O(new_n153_));
  nor2   g091(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n150_), .c(new_n147_), .O(z12));
  ...
  nand4  g101(.a(new_n67_), .b(new_n116_), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n125_), .b(new_n156_), .c(new_n71_), .O(new_n167_));
  ...
  nand2  g108(.a(new_n156_), .b(new_n71_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x40), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n170_), .c(new_n148_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n169_), .O(new_n174_));
  inv1   g112(.a(x35), .O(new_n175_));
  nand3  g113(.a(new_n65_), .b(new_n175_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n79_), .c(new_n78_), .O(new_n178_));
  oai21  g116(.a(new_n63_), .b(x27), .c(new_n67_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n171_), .O(new_n180_));
  aoi21  g118(.a(new_n114_), .b(new_n68_), .c(new_n96_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n180_), .c(new_n178_), .d(new_n174_), .O(z14));
  nand3  g120(.a(x34), .b(x27), .c(x12), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(x40), .c(new_n116_), .O(z15));
  ...
  nand2  g129(.a(new_n148_), .b(x29), .O(new_n192_));
  oai21  g130(.a(new_n82_), .b(x27), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  nor2   g132(.a(new_n175_), .b(x28), .O(new_n195_));
  nor2   g133(.a(new_n90_), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n195_), .c(x09), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n194_), .c(new_n64_), .d(new_n78_), .O(z18));
  nand2  g136(.a(new_n143_), .b(new_n64_), .O(z19));
  oai22  g137(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n116_), .O(new_n201_));
  aoi21  g139(.a(x35), .b(x27), .c(x08), .O(new_n202_));
  aoi21  g140(.a(x39), .b(x29), .c(x35), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(x40), .O(new_n204_));
  nand3  g142(.a(new_n192_), .b(x28), .c(new_n90_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n201_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n78_), .c(new_n132_), .O(new_n207_));
