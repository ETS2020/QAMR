...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n79_, new_n80_, new_n82_, new_n83_, new_n84_, new_n86_, new_n90_,
  ...
  nor2   g17(.a(new_n64_), .b(x37), .O(new_n80_));
  nand3  g18(.a(new_n80_), .b(new_n79_), .c(new_n64_), .O(z02));
  nand2  g19(.a(new_n68_), .b(x27), .O(new_n82_));
  inv1   g20(.a(x21), .O(new_n83_));
  aoi21  g21(.a(new_n67_), .b(new_n66_), .c(new_n83_), .O(new_n84_));
  aoi21  g22(.a(new_n84_), .b(new_n82_), .c(new_n64_), .O(z03));
  aoi21  g23(.a(new_n67_), .b(new_n66_), .c(x21), .O(new_n86_));
  aoi21  g24(.a(new_n86_), .b(new_n82_), .c(new_n64_), .O(z04));
  nand3  g25(.a(new_n79_), .b(new_n63_), .c(new_n67_), .O(z05));
  nand2  g26(.a(z05), .b(new_n63_), .O(z06));
  ...
  nand2  g39(.a(new_n101_), .b(new_n63_), .O(z07));
  nand4  g40(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n104_));
  nand2  g41(.a(new_n104_), .b(new_n63_), .O(z09));
  ...
  nand2  g55(.a(new_n118_), .b(new_n63_), .O(z11));
  nor2   g56(.a(new_n69_), .b(new_n64_), .O(z12));
  nand2  g57(.a(new_n68_), .b(new_n67_), .O(new_n121_));
  nand4  g58(.a(new_n121_), .b(new_n63_), .c(x27), .d(x20), .O(new_n122_));
  nor3   g59(.a(new_n122_), .b(x19), .c(x18), .O(z13));
  nor2   g60(.a(x19), .b(x18), .O(new_n124_));
  nand4  g61(.a(new_n124_), .b(new_n69_), .c(new_n63_), .d(x20), .O(z14));
  inv1   g62(.a(x12), .O(new_n126_));
  nand4  g63(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n127_));
  ...
  nand2  g71(.a(x27), .b(new_n106_), .O(new_n135_));
  oai21  g72(.a(x27), .b(new_n115_), .c(new_n135_), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n113_), .O(new_n137_));
  nand4  g74(.a(new_n137_), .b(new_n63_), .c(new_n72_), .d(new_n112_), .O(z18));
  inv1   g75(.a(new_n118_), .O(z19));
  oai21  g76(.a(x28), .b(new_n115_), .c(new_n66_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g78(.a(new_n141_), .b(new_n63_), .c(new_n72_), .d(new_n112_), .O(new_n142_));
