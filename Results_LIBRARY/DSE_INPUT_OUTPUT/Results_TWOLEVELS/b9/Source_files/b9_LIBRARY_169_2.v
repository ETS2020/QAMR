...
module FAU ( 
  ...
  nand2  g032(.a(new_n70_), .b(x39), .O(new_n95_));
  ...
  aoi22  g039(.a(new_n101_), .b(new_n94_), .c(new_n100_), .d(x39), .O(z05));
  ...
  oai22  g059(.a(new_n100_), .b(new_n120_), .c(x39), .d(new_n121_), .O(new_n122_));
  ...
  aoi21  g069(.a(x40), .b(new_n131_), .c(new_n67_), .O(new_n132_));
  ...
  nand2  g122(.a(x40), .b(new_n84_), .O(new_n185_));
