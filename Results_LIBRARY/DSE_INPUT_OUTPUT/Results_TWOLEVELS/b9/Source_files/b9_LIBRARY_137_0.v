...
module FAU ( 
  ...
  nor2   g014(.a(new_n63_), .b(new_n76_), .O(z08));
  nand3  g015(.a(z08), .b(x10), .c(new_n66_), .O(new_n78_));
  ...
  nand2  g024(.a(new_n86_), .b(new_n68_), .O(new_n87_));
  ...
  nand2  g039(.a(new_n71_), .b(new_n65_), .O(new_n102_));
  nand4  g040(.a(new_n102_), .b(new_n97_), .c(new_n101_), .d(new_n98_), .O(z04));
  nand2  g041(.a(x28), .b(x27), .O(new_n104_));
  nand3  g042(.a(new_n104_), .b(new_n101_), .c(new_n71_), .O(z05));
  aoi21  g043(.a(new_n101_), .b(new_n65_), .c(new_n85_), .O(new_n106_));
  oai21  g044(.a(new_n106_), .b(x37), .c(new_n101_), .O(z06));
  ...
  nand2  g059(.a(x40), .b(new_n76_), .O(new_n122_));
  nand2  g060(.a(new_n63_), .b(x16), .O(new_n123_));
  ...
  oai21  g064(.a(new_n126_), .b(new_n124_), .c(new_n87_), .O(new_n127_));
  ...
  nand2  g074(.a(new_n101_), .b(new_n65_), .O(new_n137_));
  ...
  inv1   g088(.a(new_n123_), .O(new_n151_));
  aoi21  g089(.a(new_n72_), .b(new_n71_), .c(new_n65_), .O(new_n152_));
  inv1   g090(.a(new_n152_), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n66_), .c(new_n63_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n151_), .c(new_n153_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n150_), .c(new_n101_), .O(z12));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n66_), .c(new_n82_), .O(new_n167_));
  ...
  nand3  g108(.a(x39), .b(new_n157_), .c(new_n66_), .O(new_n171_));
  ...
  nand2  g129(.a(x27), .b(new_n66_), .O(new_n192_));
  nand2  g130(.a(new_n65_), .b(x08), .O(new_n193_));
  ...
  oai22  g135(.a(new_n197_), .b(new_n82_), .c(new_n92_), .d(new_n191_), .O(z18));
  nor2   g136(.a(x40), .b(x35), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n94_), .c(x16), .O(new_n200_));
  ...
  nand3  g142(.a(new_n204_), .b(x28), .c(new_n65_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n203_), .c(new_n200_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n83_), .c(new_n195_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n101_), .O(z20));
