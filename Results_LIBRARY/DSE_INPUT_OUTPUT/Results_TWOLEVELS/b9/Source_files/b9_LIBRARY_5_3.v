...
module FAU ( 
  ...
  aoi21  g20(.a(new_n82_), .b(new_n80_), .c(new_n64_), .O(z02));
  ...
  nand2  g45(.a(new_n108_), .b(new_n63_), .O(z09));
  inv1   g46(.a(x04), .O(new_n110_));
  nand3  g47(.a(new_n74_), .b(x07), .c(new_n110_), .O(new_n111_));
  nand2  g48(.a(x37), .b(x06), .O(new_n112_));
  nand2  g49(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g50(.a(new_n113_), .b(x27), .O(new_n114_));
  nand2  g51(.a(new_n114_), .b(new_n63_), .O(z10));
  inv1   g52(.a(x09), .O(new_n116_));
  nor2   g53(.a(x27), .b(x08), .O(new_n117_));
  aoi21  g54(.a(x27), .b(x04), .c(new_n117_), .O(new_n118_));
  nand3  g55(.a(new_n118_), .b(x35), .c(new_n84_), .O(new_n119_));
  nand4  g56(.a(new_n119_), .b(new_n63_), .c(new_n71_), .d(new_n116_), .O(new_n120_));
  inv1   g57(.a(new_n120_), .O(z11));
  nor2   g58(.a(new_n68_), .b(new_n64_), .O(z12));
  nor2   g59(.a(new_n67_), .b(new_n64_), .O(new_n123_));
  nand3  g60(.a(new_n123_), .b(x27), .c(x20), .O(new_n124_));
  nor3   g61(.a(new_n124_), .b(x19), .c(x18), .O(z13));
  nor2   g62(.a(new_n82_), .b(new_n64_), .O(z14));
  inv1   g63(.a(x12), .O(new_n127_));
  nand4  g64(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  ...
  nand2  g71(.a(new_n134_), .b(new_n63_), .O(z17));
  nand2  g72(.a(new_n66_), .b(x08), .O(new_n136_));
  oai21  g73(.a(new_n66_), .b(x04), .c(new_n136_), .O(new_n137_));
  nand3  g74(.a(new_n137_), .b(x35), .c(new_n84_), .O(new_n138_));
  nand4  g75(.a(new_n138_), .b(new_n63_), .c(new_n71_), .d(new_n116_), .O(z18));
  oai21  g76(.a(new_n117_), .b(new_n72_), .c(new_n63_), .O(new_n140_));
  oai21  g77(.a(new_n84_), .b(x27), .c(new_n140_), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n71_), .c(new_n116_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(new_n63_), .O(z20));
  zero   g80(.O(z08));
  inv1   g81(.a(new_n120_), .O(z19));
endmodule
