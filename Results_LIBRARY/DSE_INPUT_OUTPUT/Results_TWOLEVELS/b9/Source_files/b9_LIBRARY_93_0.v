...
module FAU ( 
  ...
  nor2   g035(.a(x40), .b(new_n78_), .O(new_n98_));
  ...
  aoi21  g043(.a(new_n105_), .b(new_n101_), .c(new_n82_), .O(z04));
  aoi21  g044(.a(x28), .b(x27), .c(x37), .O(new_n107_));
  nor2   g045(.a(new_n107_), .b(new_n82_), .O(z05));
  aoi21  g046(.a(new_n80_), .b(new_n64_), .c(new_n85_), .O(new_n109_));
  ...
  oai21  g066(.a(new_n122_), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  ...
  aoi21  g073(.a(new_n135_), .b(x06), .c(new_n82_), .O(new_n136_));
  ...
  nand2  g082(.a(x40), .b(new_n78_), .O(new_n145_));
  ...
  oai21  g088(.a(new_n78_), .b(x04), .c(new_n150_), .O(new_n151_));
  ...
  nand3  g092(.a(new_n78_), .b(new_n70_), .c(new_n85_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n154_), .c(new_n151_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x40), .O(new_n157_));
  oai21  g095(.a(new_n79_), .b(x04), .c(new_n85_), .O(new_n158_));
  nand2  g096(.a(new_n79_), .b(new_n66_), .O(new_n159_));
  ...
  aoi21  g108(.a(new_n170_), .b(new_n167_), .c(new_n78_), .O(new_n171_));
  ...
  aoi21  g112(.a(new_n84_), .b(new_n83_), .c(new_n79_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(x39), .c(new_n164_), .d(new_n65_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n174_), .O(z13));
  nand3  g115(.a(x20), .b(new_n169_), .c(new_n168_), .O(new_n178_));
  oai22  g116(.a(new_n79_), .b(x35), .c(new_n78_), .d(x36), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n180_));
  nand3  g118(.a(x39), .b(new_n164_), .c(new_n65_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(x40), .c(new_n98_), .O(new_n182_));
  ...
  oai21  g123(.a(new_n78_), .b(x13), .c(new_n85_), .O(new_n186_));
  ...
  nand2  g135(.a(new_n197_), .b(new_n80_), .O(z16));
  inv1   g136(.a(x01), .O(new_n199_));
  inv1   g137(.a(x24), .O(new_n200_));
  nand4  g138(.a(new_n80_), .b(new_n200_), .c(x23), .d(x22), .O(new_n201_));
  ...
  aoi21  g145(.a(new_n205_), .b(new_n85_), .c(new_n207_), .O(new_n208_));
  oai22  g146(.a(new_n208_), .b(new_n82_), .c(new_n92_), .d(new_n122_), .O(z18));
  oai22  g147(.a(new_n78_), .b(x35), .c(new_n85_), .d(x27), .O(new_n210_));
  nand2  g148(.a(new_n210_), .b(new_n143_), .O(new_n211_));
  oai21  g149(.a(new_n78_), .b(x08), .c(new_n145_), .O(new_n212_));
  nand2  g150(.a(new_n212_), .b(new_n66_), .O(new_n213_));
  nor2   g151(.a(new_n82_), .b(x08), .O(new_n214_));
  nor2   g152(.a(x39), .b(new_n85_), .O(new_n215_));
  oai21  g153(.a(new_n215_), .b(new_n214_), .c(new_n64_), .O(new_n216_));
  nand3  g154(.a(new_n216_), .b(new_n213_), .c(new_n211_), .O(new_n217_));
  nand3  g155(.a(new_n217_), .b(new_n83_), .c(new_n206_), .O(new_n218_));
  nand2  g156(.a(new_n218_), .b(new_n80_), .O(z20));
  nor2   g157(.a(new_n148_), .b(x09), .O(z19));
endmodule
