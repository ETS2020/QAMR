...
module FAU ( 
  ...
  nor2   g036(.a(x40), .b(x12), .O(new_n99_));
  ...
  inv1   g047(.a(x12), .O(new_n110_));
  oai22  g048(.a(x40), .b(new_n110_), .c(new_n86_), .d(new_n64_), .O(new_n111_));
  ...
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n99_), .O(new_n142_));
  ...
  nand3  g089(.a(new_n100_), .b(x39), .c(new_n65_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nor2   g091(.a(x37), .b(x35), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(x12), .c(new_n80_), .O(new_n155_));
  nand2  g093(.a(x39), .b(new_n65_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n70_), .c(new_n66_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n155_), .c(new_n153_), .d(new_n150_), .O(z12));
  inv1   g096(.a(x13), .O(new_n159_));
  nand2  g097(.a(x36), .b(x35), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x28), .c(new_n80_), .O(new_n161_));
  ...
  aoi21  g107(.a(new_n169_), .b(new_n65_), .c(new_n83_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n167_), .O(z13));
  nand2  g109(.a(new_n130_), .b(new_n159_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(x40), .c(new_n64_), .O(new_n173_));
  ...
  nand3  g116(.a(new_n85_), .b(new_n84_), .c(x28), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(z08), .c(new_n65_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n66_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n70_), .c(new_n83_), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n177_), .c(new_n173_), .d(new_n153_), .O(z14));
  nand3  g122(.a(x34), .b(x27), .c(x26), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(x40), .c(new_n110_), .O(z15));
  ...
  oai22  g137(.a(new_n199_), .b(new_n83_), .c(new_n93_), .d(new_n75_), .O(z18));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(new_n142_), .O(new_n202_));
  nand2  g140(.a(x40), .b(new_n66_), .O(new_n203_));
  aoi21  g141(.a(new_n203_), .b(new_n136_), .c(x08), .O(new_n204_));
