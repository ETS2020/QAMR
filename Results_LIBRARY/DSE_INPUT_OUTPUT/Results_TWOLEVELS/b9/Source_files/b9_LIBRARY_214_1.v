...
module FAU ( 
  ...
  aoi21  g035(.a(new_n65_), .b(new_n93_), .c(new_n97_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n96_), .c(new_n79_), .O(z03));
  nand2  g037(.a(new_n65_), .b(new_n93_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n96_), .c(new_n64_), .d(new_n97_), .O(z04));
  aoi21  g039(.a(x28), .b(x27), .c(x37), .O(new_n102_));
  nor2   g040(.a(new_n102_), .b(new_n79_), .O(z05));
  aoi21  g041(.a(new_n64_), .b(new_n93_), .c(new_n83_), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(x37), .c(new_n64_), .O(z06));
  ...
  nor2   g054(.a(new_n74_), .b(new_n63_), .O(z08));
  ...
  nand3  g061(.a(new_n123_), .b(new_n85_), .c(new_n71_), .O(new_n124_));
  ...
  nand3  g067(.a(new_n129_), .b(x05), .c(new_n71_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n127_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  oai21  g070(.a(new_n63_), .b(x29), .c(x40), .O(new_n133_));
  ...
  nand3  g074(.a(x35), .b(new_n83_), .c(new_n71_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n64_), .d(new_n93_), .O(new_n138_));
  ...
  nor2   g080(.a(new_n63_), .b(x27), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(new_n73_), .O(new_n144_));
  oai21  g082(.a(new_n63_), .b(new_n71_), .c(x40), .O(new_n145_));
  ...
  nand4  g088(.a(new_n150_), .b(x40), .c(new_n148_), .d(new_n71_), .O(new_n151_));
  ...
  nand4  g093(.a(new_n67_), .b(new_n74_), .c(x20), .d(new_n153_), .O(new_n156_));
  nor2   g094(.a(new_n156_), .b(x18), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n155_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n129_), .b(new_n148_), .c(new_n71_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  aoi21  g098(.a(new_n148_), .b(new_n71_), .c(new_n63_), .O(new_n161_));
  nor2   g099(.a(x19), .b(x18), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(new_n67_), .c(x27), .d(x20), .O(new_n163_));
  oai21  g101(.a(new_n161_), .b(new_n74_), .c(new_n163_), .O(new_n164_));
  ...
  nand4  g115(.a(new_n64_), .b(new_n177_), .c(x23), .d(x22), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n176_), .O(z17));
  nand2  g117(.a(x40), .b(x29), .O(new_n180_));
  oai21  g118(.a(new_n84_), .b(x27), .c(new_n180_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  inv1   g120(.a(new_n84_), .O(new_n183_));
  nor2   g121(.a(new_n93_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n182_), .c(new_n64_), .d(new_n80_), .O(z18));
  nand2  g124(.a(new_n140_), .b(new_n64_), .O(z19));
  aoi22  g125(.a(new_n180_), .b(x28), .c(new_n64_), .d(new_n92_), .O(new_n188_));
  inv1   g126(.a(x35), .O(new_n189_));
  nand2  g127(.a(new_n90_), .b(x39), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x40), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  oai21  g130(.a(new_n188_), .b(x27), .c(new_n192_), .O(new_n193_));
