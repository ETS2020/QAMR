...
module FAU ( 
  ...
  aoi21  g021(.a(x29), .b(x08), .c(new_n70_), .O(new_n84_));
  ...
  oai21  g060(.a(x32), .b(x30), .c(x39), .O(new_n123_));
  oai21  g061(.a(new_n123_), .b(new_n118_), .c(new_n122_), .O(new_n124_));
  ...
  inv1   g089(.a(new_n64_), .O(new_n152_));
  ...
  nor2   g093(.a(x32), .b(x30), .O(new_n156_));
  nor3   g094(.a(new_n156_), .b(x13), .c(x04), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n70_), .c(x39), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n155_), .O(z13));
  inv1   g097(.a(new_n139_), .O(new_n160_));
  nor2   g098(.a(x19), .b(x18), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n160_), .c(new_n152_), .d(x20), .O(new_n162_));
  oai21  g100(.a(x13), .b(x04), .c(new_n162_), .O(new_n163_));
  nand2  g101(.a(new_n123_), .b(new_n91_), .O(new_n164_));
  nand4  g102(.a(new_n147_), .b(new_n75_), .c(new_n74_), .d(x28), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(x39), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  aoi21  g106(.a(new_n156_), .b(x28), .c(new_n67_), .O(new_n169_));
  nand2  g107(.a(new_n67_), .b(new_n77_), .O(new_n170_));
  oai21  g108(.a(new_n169_), .b(x35), .c(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n92_), .c(new_n95_), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n168_), .c(new_n164_), .d(new_n163_), .O(z14));
  inv1   g111(.a(x12), .O(new_n174_));
  nor2   g112(.a(new_n115_), .b(new_n174_), .O(z15));
  inv1   g113(.a(x23), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(x22), .c(x01), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n71_), .O(z16));
  inv1   g116(.a(x24), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(x23), .c(x22), .d(x01), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n71_), .O(z17));
  nand2  g119(.a(x39), .b(x29), .O(new_n182_));
  oai21  g120(.a(new_n78_), .b(x27), .c(new_n182_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  inv1   g122(.a(new_n78_), .O(new_n185_));
  nor2   g123(.a(new_n91_), .b(x04), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n184_), .c(new_n71_), .d(new_n74_), .O(z18));
  nand2  g126(.a(new_n136_), .b(new_n71_), .O(z19));
  aoi21  g127(.a(new_n70_), .b(x39), .c(x08), .O(new_n190_));
  aoi21  g128(.a(x39), .b(x29), .c(new_n77_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n190_), .c(new_n91_), .O(new_n192_));
  inv1   g130(.a(x35), .O(new_n193_));
  oai21  g131(.a(new_n84_), .b(new_n67_), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n192_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n74_), .c(new_n128_), .O(new_n196_));
