...
module FAU ( 
  ...
  oai21  g032(.a(x28), .b(new_n68_), .c(x04), .O(new_n95_));
  nand2  g033(.a(new_n64_), .b(x39), .O(new_n96_));
  ...
  aoi21  g057(.a(new_n119_), .b(x26), .c(new_n74_), .O(z08));
  ...
  nand3  g063(.a(new_n125_), .b(new_n84_), .c(new_n91_), .O(new_n126_));
  ...
  nor3   g068(.a(new_n130_), .b(new_n119_), .c(new_n63_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x05), .c(new_n91_), .O(new_n132_));
  ...
  aoi21  g084(.a(x39), .b(new_n91_), .c(new_n71_), .O(new_n147_));
  ...
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n91_), .O(new_n154_));
  ...
  nand3  g100(.a(new_n131_), .b(new_n151_), .c(new_n91_), .O(new_n163_));
  ...
  nand3  g104(.a(x39), .b(new_n151_), .c(new_n91_), .O(new_n167_));
  ...
  nand2  g112(.a(new_n174_), .b(x26), .O(new_n175_));
  ...
  nand2  g122(.a(x27), .b(new_n91_), .O(new_n185_));
  ...
  nor2   g128(.a(new_n74_), .b(new_n119_), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(x29), .c(x26), .d(x08), .O(new_n192_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n79_), .c(new_n188_), .O(new_n203_));
