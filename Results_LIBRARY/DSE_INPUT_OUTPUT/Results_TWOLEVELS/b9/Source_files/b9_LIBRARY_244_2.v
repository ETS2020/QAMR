...
module FAU ( 
  ...
  nor2   g061(.a(x40), .b(x05), .O(new_n124_));
  aoi21  g062(.a(x40), .b(new_n75_), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g080(.a(new_n142_), .b(x40), .c(new_n124_), .O(new_n143_));
  ...
  oai21  g091(.a(new_n153_), .b(new_n124_), .c(new_n152_), .O(new_n154_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n65_), .c(new_n83_), .O(new_n166_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n124_), .c(new_n168_), .O(new_n173_));
  ...
  nand3  g117(.a(new_n152_), .b(new_n76_), .c(new_n132_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n179_), .c(new_n173_), .O(z14));
  inv1   g119(.a(x12), .O(new_n182_));
  nand4  g120(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n183_));
  ...
  nand2  g133(.a(new_n84_), .b(new_n195_), .O(new_n196_));
  aoi21  g134(.a(new_n194_), .b(new_n86_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n83_), .c(new_n93_), .d(new_n119_), .O(z18));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n143_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n138_), .c(x08), .O(new_n202_));
