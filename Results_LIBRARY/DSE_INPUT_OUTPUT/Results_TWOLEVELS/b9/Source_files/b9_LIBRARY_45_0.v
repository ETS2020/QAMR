...
module FAU ( 
  ...
  nand4  g042(.a(new_n104_), .b(new_n100_), .c(new_n99_), .d(new_n65_), .O(z04));
  nor2   g043(.a(new_n102_), .b(new_n66_), .O(z05));
  ...
  nand2  g063(.a(new_n64_), .b(x21), .O(new_n126_));
  ...
  nor2   g072(.a(new_n134_), .b(new_n124_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x05), .c(new_n74_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n133_), .O(z10));
  nand2  g075(.a(new_n65_), .b(new_n69_), .O(new_n138_));
  oai21  g076(.a(new_n84_), .b(x04), .c(x40), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n138_), .c(x08), .O(new_n140_));
  inv1   g078(.a(new_n84_), .O(new_n141_));
  nor2   g079(.a(x40), .b(new_n63_), .O(new_n142_));
  aoi21  g080(.a(x39), .b(x29), .c(new_n64_), .O(new_n143_));
  ...
  oai21  g084(.a(new_n146_), .b(new_n140_), .c(new_n80_), .O(new_n147_));
  nor2   g085(.a(new_n147_), .b(x09), .O(z11));
  nand3  g086(.a(new_n70_), .b(new_n82_), .c(new_n93_), .O(new_n149_));
  ...
  nand2  g091(.a(new_n153_), .b(x21), .O(new_n154_));
  ...
  nand4  g102(.a(new_n162_), .b(x21), .c(x20), .d(new_n161_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n135_), .b(new_n156_), .c(new_n74_), .O(new_n168_));
  ...
  oai21  g112(.a(new_n174_), .b(new_n142_), .c(new_n170_), .O(new_n175_));
  ...
  nor2   g134(.a(new_n196_), .b(new_n144_), .O(new_n197_));
  aoi21  g135(.a(new_n138_), .b(new_n94_), .c(x08), .O(new_n198_));
