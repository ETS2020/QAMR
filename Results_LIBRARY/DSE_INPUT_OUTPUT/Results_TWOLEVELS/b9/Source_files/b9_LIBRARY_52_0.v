...
module FAU ( 
  ...
  inv1   g032(.a(new_n77_), .O(new_n95_));
  nand2  g033(.a(new_n64_), .b(new_n92_), .O(new_n96_));
  nand2  g034(.a(x40), .b(new_n66_), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(new_n96_), .c(new_n86_), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(x04), .c(new_n95_), .O(new_n99_));
  oai21  g037(.a(new_n94_), .b(x02), .c(new_n99_), .O(z02));
  nand2  g038(.a(new_n71_), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n82_), .b(new_n70_), .c(new_n64_), .O(new_n102_));
  nand4  g040(.a(new_n102_), .b(new_n101_), .c(new_n82_), .d(x21), .O(z03));
  inv1   g041(.a(x21), .O(new_n104_));
  nand4  g042(.a(new_n102_), .b(new_n101_), .c(new_n82_), .d(new_n104_), .O(z04));
  nand2  g043(.a(x28), .b(x27), .O(new_n106_));
  aoi22  g044(.a(new_n106_), .b(new_n70_), .c(new_n76_), .d(new_n81_), .O(z05));
  oai22  g045(.a(x40), .b(x23), .c(new_n86_), .d(new_n64_), .O(new_n108_));
  ...
  nand2  g058(.a(new_n82_), .b(new_n95_), .O(z08));
  ...
  nand2  g064(.a(new_n76_), .b(x23), .O(new_n127_));
  ...
  nor2   g080(.a(x40), .b(new_n81_), .O(new_n143_));
  aoi21  g081(.a(x39), .b(x29), .c(new_n76_), .O(new_n144_));
  nor2   g082(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g083(.a(x27), .b(x04), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(new_n142_), .c(new_n145_), .O(new_n147_));
  ...
  nand2  g093(.a(new_n155_), .b(x23), .O(new_n156_));
  ...
  nand4  g103(.a(new_n72_), .b(x23), .c(x20), .d(new_n163_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(x18), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(x27), .O(new_n168_));
  nand3  g106(.a(new_n136_), .b(new_n158_), .c(new_n65_), .O(new_n169_));
  ...
  oai21  g113(.a(new_n175_), .b(new_n143_), .c(new_n171_), .O(new_n176_));
  ...
  oai21  g117(.a(new_n174_), .b(new_n152_), .c(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x40), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n176_), .c(new_n156_), .O(z14));
  nand4  g120(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n82_), .O(z15));
  nand4  g122(.a(x40), .b(new_n81_), .c(x22), .d(x01), .O(new_n185_));
  ...
  oai22  g127(.a(new_n87_), .b(x27), .c(new_n95_), .d(new_n93_), .O(new_n190_));
  ...
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n82_), .d(new_n84_), .O(z18));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  nor2   g133(.a(new_n195_), .b(new_n145_), .O(new_n196_));
  aoi21  g134(.a(new_n139_), .b(new_n97_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n196_), .c(new_n84_), .O(new_n198_));
