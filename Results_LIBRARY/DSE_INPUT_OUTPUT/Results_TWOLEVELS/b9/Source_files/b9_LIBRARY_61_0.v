...
module FAU ( 
  ...
  aoi21  g036(.a(new_n70_), .b(new_n69_), .c(x21), .O(new_n99_));
  ...
  aoi21  g040(.a(new_n65_), .b(new_n69_), .c(new_n83_), .O(new_n103_));
  ...
  nand3  g066(.a(new_n128_), .b(new_n127_), .c(new_n65_), .O(z10));
  nand2  g067(.a(new_n65_), .b(new_n69_), .O(new_n130_));
  nand3  g068(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n131_));
  ...
  nand2  g075(.a(new_n64_), .b(x12), .O(new_n138_));
  nand2  g076(.a(x27), .b(x04), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n135_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n133_), .c(new_n80_), .O(new_n141_));
  nor2   g079(.a(new_n141_), .b(x09), .O(z11));
  nand3  g080(.a(new_n70_), .b(new_n82_), .c(new_n134_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  aoi21  g082(.a(x39), .b(new_n74_), .c(new_n72_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x40), .O(new_n146_));
  nor2   g084(.a(new_n72_), .b(x40), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x12), .O(new_n148_));
  ...
  aoi21  g098(.a(new_n81_), .b(new_n80_), .c(new_n64_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n150_), .d(new_n74_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n160_), .O(z13));
  inv1   g101(.a(x39), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(x04), .c(x40), .O(new_n165_));
  aoi21  g103(.a(new_n64_), .b(x12), .c(x13), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n165_), .c(x35), .d(x28), .O(new_n167_));
  nand4  g105(.a(new_n134_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(new_n70_), .O(new_n170_));
  nand3  g108(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n171_));
  inv1   g109(.a(new_n116_), .O(new_n172_));
  nand4  g110(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n172_), .c(new_n150_), .d(new_n74_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n171_), .O(new_n175_));
  aoi21  g113(.a(x27), .b(x12), .c(x40), .O(new_n176_));
  nand3  g114(.a(x39), .b(new_n150_), .c(new_n74_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x40), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n124_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n69_), .c(new_n176_), .O(new_n180_));
  ...
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n134_), .O(new_n193_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n66_), .c(new_n116_), .d(new_n90_), .O(z18));
  oai22  g135(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(x12), .O(new_n199_));
  ...
  nand2  g140(.a(new_n172_), .b(x29), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(x28), .c(new_n69_), .O(new_n204_));
  ...
  nor2   g145(.a(new_n141_), .b(x09), .O(z19));
endmodule
