...
module FAU ( 
  ...
  aoi21  g039(.a(new_n101_), .b(new_n65_), .c(new_n79_), .O(z05));
  nand3  g040(.a(new_n101_), .b(new_n64_), .c(new_n65_), .O(new_n103_));
  ...
  nand3  g062(.a(new_n124_), .b(x40), .c(x05), .O(new_n125_));
  ...
  nand4  g086(.a(new_n148_), .b(x40), .c(new_n146_), .d(new_n71_), .O(new_n149_));
  inv1   g087(.a(x18), .O(new_n150_));
  inv1   g088(.a(x19), .O(new_n151_));
  nand4  g089(.a(new_n67_), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n149_), .c(new_n92_), .O(new_n153_));
  nand3  g091(.a(new_n124_), .b(new_n146_), .c(new_n71_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x39), .c(new_n74_), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n153_), .O(z13));
  aoi21  g094(.a(new_n146_), .b(new_n71_), .c(new_n63_), .O(new_n157_));
  nor2   g095(.a(x19), .b(x18), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n67_), .c(x27), .d(x20), .O(new_n159_));
  oai21  g097(.a(new_n157_), .b(new_n74_), .c(new_n159_), .O(new_n160_));
  ...
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n165_));
  ...
  oai21  g113(.a(new_n84_), .b(x27), .c(new_n131_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x08), .O(new_n177_));
  inv1   g115(.a(new_n84_), .O(new_n178_));
  nor2   g116(.a(new_n92_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n177_), .c(new_n64_), .d(new_n80_), .O(z18));
  inv1   g119(.a(new_n131_), .O(new_n182_));
  inv1   g120(.a(x35), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n92_), .c(new_n91_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n92_), .c(new_n183_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n182_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n80_), .c(new_n130_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n64_), .O(z20));
  nand2  g126(.a(new_n138_), .b(new_n64_), .O(z19));
endmodule
