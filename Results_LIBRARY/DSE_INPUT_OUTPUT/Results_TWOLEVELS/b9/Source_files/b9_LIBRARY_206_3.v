// Benchmark "FAU" written by ABC on Tue Aug 18 17:26:47 2020
...
module FAU ( 
  ...
  nand2  g017(.a(x40), .b(x24), .O(new_n80_));
  ...
  nand2  g038(.a(new_n100_), .b(new_n95_), .O(z02));
  nand2  g039(.a(new_n71_), .b(x27), .O(new_n102_));
  nand2  g040(.a(new_n70_), .b(new_n64_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n102_), .c(new_n80_), .d(x21), .O(z03));
  inv1   g042(.a(new_n80_), .O(new_n105_));
  ...
  nand3  g046(.a(new_n108_), .b(new_n80_), .c(new_n70_), .O(z05));
  ...
  nand3  g059(.a(x40), .b(x39), .c(new_n90_), .O(new_n122_));
  ...
  oai21  g066(.a(new_n75_), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n86_), .c(x27), .O(new_n130_));
  ...
  nand3  g076(.a(x35), .b(new_n84_), .c(new_n65_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(new_n90_), .c(new_n80_), .d(new_n64_), .O(new_n140_));
  aoi21  g078(.a(x39), .b(x29), .c(x24), .O(new_n141_));
  nor2   g079(.a(new_n64_), .b(new_n65_), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n85_), .c(new_n141_), .d(new_n96_), .O(new_n143_));
  oai21  g081(.a(new_n140_), .b(x08), .c(new_n143_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n82_), .c(new_n97_), .O(new_n145_));
  inv1   g083(.a(new_n145_), .O(z11));
  inv1   g084(.a(x10), .O(new_n147_));
  nor2   g085(.a(x27), .b(x24), .O(new_n148_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n80_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n96_), .O(new_n155_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(x24), .O(new_n160_));
  nand4  g098(.a(new_n72_), .b(new_n96_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand4  g101(.a(new_n133_), .b(new_n90_), .c(new_n153_), .d(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  nand3  g103(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n166_));
  nand4  g104(.a(new_n154_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n76_), .b(new_n153_), .c(new_n65_), .O(new_n169_));
  ...
  nand3  g111(.a(new_n169_), .b(new_n71_), .c(new_n70_), .O(new_n174_));
  nand2  g112(.a(new_n90_), .b(x13), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n76_), .c(new_n65_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n64_), .c(new_n105_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n174_), .c(new_n173_), .d(new_n170_), .O(z14));
  inv1   g116(.a(x12), .O(new_n179_));
  nor2   g117(.a(new_n125_), .b(new_n179_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x22), .c(x01), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n80_), .O(z16));
  nand4  g121(.a(new_n90_), .b(x23), .c(x22), .d(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n80_), .O(z17));
  ...
  nand2  g126(.a(new_n82_), .b(new_n97_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n84_), .c(new_n189_), .O(new_n190_));
  nand4  g128(.a(new_n76_), .b(x29), .c(new_n90_), .d(x08), .O(new_n191_));
  oai21  g129(.a(new_n190_), .b(new_n105_), .c(new_n191_), .O(z18));
  nand2  g130(.a(new_n145_), .b(new_n80_), .O(z19));
  nand2  g131(.a(x39), .b(x29), .O(new_n194_));
  nor2   g132(.a(new_n84_), .b(x27), .O(new_n195_));
  nor2   g133(.a(x35), .b(x24), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n195_), .c(new_n194_), .O(new_n197_));
  inv1   g135(.a(x08), .O(new_n198_));
  aoi21  g136(.a(x35), .b(x27), .c(x24), .O(new_n199_));
  nor2   g137(.a(x40), .b(x27), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n199_), .c(new_n198_), .O(new_n201_));
  oai21  g139(.a(new_n195_), .b(new_n66_), .c(new_n96_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n201_), .c(new_n197_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n82_), .c(new_n97_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n80_), .O(z20));
endmodule
