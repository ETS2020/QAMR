...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n208_;
  nand2  g000(.a(x40), .b(x31), .O(new_n63_));
  ...
  nand2  g027(.a(x35), .b(new_n81_), .O(new_n90_));
  nor2   g028(.a(x27), .b(x08), .O(new_n91_));
  oai21  g029(.a(new_n91_), .b(new_n90_), .c(x04), .O(new_n92_));
  nand3  g030(.a(new_n92_), .b(new_n89_), .c(x39), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n72_), .O(new_n94_));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n68_), .c(new_n64_), .O(z05));
  nand3  g041(.a(new_n102_), .b(new_n63_), .c(new_n68_), .O(new_n104_));
  ...
  nand3  g055(.a(new_n114_), .b(new_n74_), .c(new_n112_), .O(new_n118_));
  aoi21  g056(.a(new_n118_), .b(new_n117_), .c(new_n106_), .O(z07));
  nand3  g057(.a(x40), .b(x39), .c(new_n72_), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(z08));
  inv1   g059(.a(x11), .O(new_n122_));
  nand4  g060(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  nor2   g061(.a(new_n123_), .b(new_n122_), .O(z09));
  inv1   g062(.a(x04), .O(new_n125_));
  oai21  g063(.a(x39), .b(x31), .c(x40), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(x07), .O(new_n127_));
  nand4  g065(.a(x40), .b(x39), .c(new_n72_), .d(x05), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n127_), .c(new_n82_), .O(new_n129_));
  nand3  g067(.a(new_n63_), .b(x37), .c(x06), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(new_n131_));
  aoi21  g069(.a(new_n129_), .b(new_n125_), .c(new_n131_), .O(new_n132_));
  inv1   g070(.a(x39), .O(new_n133_));
  nor2   g071(.a(x32), .b(x30), .O(new_n134_));
  nor3   g072(.a(new_n134_), .b(new_n74_), .c(new_n133_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n72_), .c(x05), .d(new_n125_), .O(new_n136_));
  oai21  g074(.a(new_n132_), .b(new_n67_), .c(new_n136_), .O(z10));
  inv1   g075(.a(x09), .O(new_n138_));
  aoi21  g076(.a(x40), .b(x31), .c(x27), .O(new_n139_));
  nand3  g077(.a(x35), .b(new_n81_), .c(new_n125_), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n72_), .c(new_n139_), .O(new_n141_));
  aoi21  g079(.a(x39), .b(x29), .c(x31), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n81_), .O(new_n144_));
  oai21  g082(.a(new_n142_), .b(new_n74_), .c(new_n144_), .O(new_n145_));
  oai21  g083(.a(new_n141_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n79_), .c(new_n138_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n63_), .O(z11));
  nor2   g086(.a(x31), .b(x27), .O(new_n149_));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n73_), .O(new_n151_));
  nor2   g089(.a(new_n74_), .b(new_n133_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n125_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n69_), .c(new_n68_), .O(new_n154_));
  inv1   g092(.a(new_n152_), .O(new_n155_));
  nor2   g093(.a(x31), .b(new_n125_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n155_), .c(new_n67_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(new_n154_), .c(new_n151_), .d(new_n63_), .O(z12));
  inv1   g096(.a(x13), .O(new_n159_));
  nand2  g097(.a(x36), .b(x35), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x28), .c(new_n74_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n159_), .d(new_n125_), .O(new_n162_));
  ...
  nor2   g106(.a(new_n134_), .b(new_n133_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n159_), .c(new_n125_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n72_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x40), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n168_), .O(z13));
  nor2   g111(.a(new_n134_), .b(x13), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n125_), .c(x31), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n155_), .c(new_n67_), .O(new_n176_));
  nand3  g114(.a(x20), .b(new_n164_), .c(new_n163_), .O(new_n177_));
  nand4  g115(.a(new_n160_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(new_n179_));
  nand4  g117(.a(x40), .b(x39), .c(new_n159_), .d(new_n125_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n179_), .c(new_n177_), .O(new_n181_));
  nand2  g119(.a(new_n180_), .b(new_n69_), .O(new_n182_));
  inv1   g120(.a(x35), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n68_), .c(new_n64_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n181_), .c(new_n176_), .O(z14));
  inv1   g125(.a(x12), .O(new_n188_));
  nor2   g126(.a(new_n123_), .b(new_n188_), .O(z15));
  inv1   g127(.a(x23), .O(new_n190_));
  nand4  g128(.a(new_n63_), .b(new_n190_), .c(x22), .d(x01), .O(new_n191_));
  ...
  nand2  g133(.a(x27), .b(new_n125_), .O(new_n196_));
  nand2  g134(.a(new_n67_), .b(x08), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n196_), .c(new_n183_), .O(new_n198_));
  nand2  g136(.a(new_n79_), .b(new_n138_), .O(new_n199_));
  aoi21  g137(.a(new_n198_), .b(new_n81_), .c(new_n199_), .O(new_n200_));
  nand2  g138(.a(new_n152_), .b(new_n72_), .O(new_n201_));
  oai22  g139(.a(new_n201_), .b(new_n88_), .c(new_n200_), .d(new_n64_), .O(z18));
  inv1   g140(.a(new_n147_), .O(z19));
  nor2   g141(.a(new_n142_), .b(new_n74_), .O(new_n204_));
  aoi21  g142(.a(x28), .b(new_n67_), .c(new_n183_), .O(new_n205_));
  aoi21  g143(.a(new_n183_), .b(new_n72_), .c(new_n139_), .O(new_n206_));
  oai22  g144(.a(new_n206_), .b(x08), .c(new_n205_), .d(new_n204_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n79_), .c(new_n138_), .O(new_n208_));
