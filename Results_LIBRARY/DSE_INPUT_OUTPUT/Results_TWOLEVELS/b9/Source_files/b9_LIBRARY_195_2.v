...
module FAU ( 
  ...
  nor2   g029(.a(x40), .b(x33), .O(new_n92_));
  ...
  aoi22  g039(.a(new_n101_), .b(new_n65_), .c(new_n63_), .d(x33), .O(z05));
  nand2  g040(.a(new_n64_), .b(new_n96_), .O(new_n103_));
  inv1   g041(.a(x33), .O(new_n104_));
  oai21  g042(.a(x40), .b(new_n104_), .c(new_n81_), .O(new_n105_));
  ...
  nand2  g054(.a(new_n116_), .b(new_n104_), .O(new_n117_));
  ...
  aoi21  g064(.a(x40), .b(new_n126_), .c(new_n92_), .O(new_n127_));
  nand2  g065(.a(z08), .b(x05), .O(new_n128_));
  oai21  g066(.a(new_n127_), .b(new_n125_), .c(new_n128_), .O(new_n129_));
  nand3  g067(.a(new_n129_), .b(new_n83_), .c(new_n71_), .O(new_n130_));
  ...
  nor2   g072(.a(new_n134_), .b(new_n126_), .O(new_n135_));
  ...
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n92_), .O(new_n142_));
  ...
  nand3  g085(.a(new_n65_), .b(new_n80_), .c(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi22  g087(.a(new_n67_), .b(x27), .c(x39), .d(new_n71_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n151_));
  nand3  g089(.a(new_n68_), .b(new_n63_), .c(new_n104_), .O(new_n152_));
  ...
  nand4  g099(.a(new_n67_), .b(new_n104_), .c(x20), .d(new_n159_), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x18), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n161_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n135_), .b(new_n154_), .c(new_n71_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  oai21  g104(.a(new_n126_), .b(x04), .c(x40), .O(new_n167_));
  nor2   g105(.a(new_n92_), .b(x13), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n167_), .c(x35), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n147_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(new_n65_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n173_));
  nand4  g111(.a(new_n155_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n174_));
  nor2   g112(.a(new_n126_), .b(x13), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n174_), .c(x40), .d(new_n71_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  oai21  g115(.a(x33), .b(new_n96_), .c(new_n63_), .O(new_n178_));
  nand2  g116(.a(new_n175_), .b(new_n71_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  oai21  g118(.a(x32), .b(x30), .c(new_n180_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n96_), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n178_), .c(new_n177_), .d(new_n172_), .O(z14));
  inv1   g121(.a(x12), .O(new_n184_));
  nor2   g122(.a(new_n123_), .b(new_n184_), .O(z15));
  ...
  nor2   g132(.a(new_n96_), .b(x04), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n140_), .c(x09), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n64_), .d(new_n78_), .O(z18));
  oai22  g135(.a(new_n63_), .b(x35), .c(new_n81_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n141_), .O(new_n199_));
  nor2   g137(.a(x40), .b(x35), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n88_), .c(new_n104_), .O(new_n201_));
  inv1   g139(.a(x08), .O(new_n202_));
  nand2  g140(.a(x35), .b(x27), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(x40), .c(new_n202_), .O(new_n204_));
  nand3  g142(.a(new_n63_), .b(x28), .c(new_n96_), .O(new_n205_));
  nand4  g143(.a(new_n205_), .b(new_n204_), .c(new_n201_), .d(new_n199_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n78_), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(x09), .c(new_n64_), .O(z20));
  nor2   g146(.a(new_n145_), .b(x09), .O(z19));
endmodule
