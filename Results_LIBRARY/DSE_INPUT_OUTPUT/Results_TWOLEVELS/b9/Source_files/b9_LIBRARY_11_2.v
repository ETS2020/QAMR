...
module FAU ( 
  ...
  oai21  g021(.a(new_n83_), .b(new_n69_), .c(x39), .O(new_n84_));
  inv1   g022(.a(x27), .O(new_n85_));
  inv1   g023(.a(x04), .O(new_n86_));
  oai21  g024(.a(x08), .b(new_n86_), .c(x39), .O(new_n87_));
  ...
  nor2   g053(.a(new_n69_), .b(new_n90_), .O(z08));
  ...
  aoi21  g063(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n126_));
  ...
  aoi21  g068(.a(x40), .b(new_n130_), .c(new_n90_), .O(new_n131_));
  ...
  nand4  g087(.a(new_n149_), .b(x39), .c(new_n147_), .d(new_n86_), .O(new_n150_));
  ...
  aoi21  g095(.a(new_n157_), .b(x40), .c(new_n90_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n155_), .O(z13));
  nand2  g097(.a(x40), .b(x04), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(x39), .c(new_n147_), .O(new_n161_));
  ...
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n147_), .d(new_n86_), .O(new_n165_));
