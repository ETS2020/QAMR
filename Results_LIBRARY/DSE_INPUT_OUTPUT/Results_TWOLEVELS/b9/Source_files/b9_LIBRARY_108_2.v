...
module FAU ( 
  ...
  nor2   g030(.a(x40), .b(x17), .O(new_n93_));
  ...
  aoi21  g041(.a(new_n64_), .b(new_n68_), .c(new_n82_), .O(new_n104_));
  ...
  oai21  g046(.a(new_n63_), .b(new_n66_), .c(x17), .O(new_n109_));
  ...
  nand3  g053(.a(new_n115_), .b(new_n64_), .c(new_n113_), .O(new_n116_));
  ...
  aoi21  g061(.a(x40), .b(new_n118_), .c(new_n93_), .O(new_n124_));
  ...
  nor2   g069(.a(new_n131_), .b(new_n118_), .O(new_n132_));
  ...
  aoi21  g077(.a(new_n139_), .b(x40), .c(new_n93_), .O(new_n140_));
  ...
  nor2   g100(.a(new_n161_), .b(x17), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n132_), .b(new_n154_), .c(new_n73_), .O(new_n165_));
  ...
  oai21  g109(.a(new_n171_), .b(new_n93_), .c(new_n167_), .O(new_n172_));
  nand3  g110(.a(new_n69_), .b(new_n145_), .c(x28), .O(new_n173_));
  ...
  nor2   g131(.a(new_n143_), .b(x09), .O(z19));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n89_), .c(new_n150_), .O(new_n196_));
  ...
  nand2  g139(.a(new_n201_), .b(new_n79_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(x09), .c(new_n64_), .O(z20));
endmodule
