...
module FAU ( 
  ...
  nor2   g032(.a(x40), .b(x11), .O(new_n95_));
  ...
  oai21  g041(.a(new_n82_), .b(new_n99_), .c(new_n65_), .O(new_n104_));
  ...
  nand2  g070(.a(new_n64_), .b(new_n99_), .O(new_n133_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n95_), .c(new_n68_), .O(new_n148_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n71_), .c(new_n78_), .O(new_n161_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n95_), .c(new_n163_), .O(new_n168_));
  ...
  nand3  g113(.a(new_n68_), .b(new_n63_), .c(new_n120_), .O(new_n176_));
  ...
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n169_), .O(new_n189_));
  ...
  oai22  g130(.a(new_n192_), .b(new_n78_), .c(new_n118_), .d(new_n89_), .O(z18));
  aoi21  g131(.a(x28), .b(new_n99_), .c(new_n169_), .O(new_n194_));
  nor2   g132(.a(new_n194_), .b(new_n139_), .O(new_n195_));
  nand2  g133(.a(x40), .b(new_n169_), .O(new_n196_));
