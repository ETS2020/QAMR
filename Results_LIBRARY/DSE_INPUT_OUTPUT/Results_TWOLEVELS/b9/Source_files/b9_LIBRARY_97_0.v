...
module FAU ( 
  ...
  nor2   g019(.a(x40), .b(x39), .O(new_n82_));
  ...
  aoi21  g036(.a(new_n70_), .b(new_n64_), .c(new_n82_), .O(new_n99_));
  ...
  nand2  g055(.a(new_n80_), .b(new_n117_), .O(z08));
  ...
  aoi22  g082(.a(new_n72_), .b(x27), .c(x40), .d(new_n65_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x39), .O(new_n146_));
  nand2  g084(.a(new_n72_), .b(x27), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(x40), .c(new_n78_), .O(new_n148_));
  ...
  nand4  g090(.a(new_n152_), .b(x40), .c(new_n150_), .d(new_n65_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n72_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n78_), .O(new_n157_));
  nand4  g095(.a(new_n72_), .b(x40), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n130_), .b(new_n150_), .c(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  inv1   g100(.a(new_n96_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n164_));
  nand4  g102(.a(new_n151_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n165_));
  nand3  g103(.a(x40), .b(new_n150_), .c(new_n65_), .O(new_n166_));
  ...
  oai22  g124(.a(new_n91_), .b(x27), .c(new_n117_), .d(new_n137_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n64_), .b(x04), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n85_), .c(x09), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n80_), .d(new_n83_), .O(z18));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  aoi21  g130(.a(new_n138_), .b(new_n96_), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(x39), .b(new_n66_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n133_), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n193_), .c(new_n83_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(x09), .O(z20));
  nor2   g135(.a(new_n141_), .b(x09), .O(z19));
endmodule
