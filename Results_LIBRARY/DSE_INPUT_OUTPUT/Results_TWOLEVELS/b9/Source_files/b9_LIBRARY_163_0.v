...
module FAU ( 
  ...
  nand2  g034(.a(new_n76_), .b(x05), .O(new_n97_));
  ...
  oai22  g044(.a(x40), .b(x05), .c(new_n86_), .d(new_n64_), .O(new_n107_));
  ...
  aoi22  g072(.a(new_n134_), .b(x40), .c(new_n82_), .d(new_n64_), .O(new_n135_));
  nand2  g073(.a(x39), .b(x29), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x40), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n97_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n142_), .b(new_n84_), .c(new_n133_), .O(new_n143_));
  ...
  nand3  g087(.a(new_n149_), .b(new_n76_), .c(x05), .O(new_n150_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n155_), .c(new_n76_), .O(new_n159_));
  nor2   g097(.a(new_n158_), .b(new_n81_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(x27), .O(new_n161_));
  nand3  g099(.a(new_n130_), .b(new_n152_), .c(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  oai21  g101(.a(new_n75_), .b(x04), .c(x40), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n97_), .c(new_n152_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n149_), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n167_));
  nand4  g105(.a(new_n153_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(z08), .c(new_n152_), .d(new_n65_), .O(new_n169_));
  ...
  nand4  g111(.a(new_n173_), .b(new_n170_), .c(new_n166_), .d(new_n82_), .O(z14));
  nand4  g112(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n82_), .O(z15));
  ...
  nor2   g123(.a(new_n66_), .b(x28), .O(new_n186_));
  nor2   g124(.a(new_n64_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n185_), .c(new_n82_), .d(new_n84_), .O(z18));
  nand2  g127(.a(new_n143_), .b(new_n82_), .O(z19));
  nand2  g128(.a(x28), .b(new_n64_), .O(new_n191_));
  aoi22  g129(.a(new_n191_), .b(x35), .c(new_n137_), .d(new_n97_), .O(new_n192_));
  nand2  g130(.a(new_n82_), .b(new_n64_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n66_), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(x08), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n192_), .c(new_n84_), .O(new_n196_));
