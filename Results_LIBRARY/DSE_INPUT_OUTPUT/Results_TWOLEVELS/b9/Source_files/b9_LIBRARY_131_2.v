...
module FAU ( 
  ...
  nor2   g035(.a(x40), .b(x31), .O(new_n98_));
  ...
  nand2  g047(.a(new_n81_), .b(new_n64_), .O(new_n110_));
  inv1   g048(.a(x31), .O(new_n111_));
  oai21  g049(.a(x40), .b(new_n111_), .c(new_n85_), .O(new_n112_));
  aoi21  g050(.a(new_n112_), .b(new_n110_), .c(x37), .O(z06));
  ...
  nand4  g055(.a(new_n117_), .b(new_n115_), .c(new_n114_), .d(new_n111_), .O(new_n118_));
  ...
  nand2  g061(.a(new_n123_), .b(new_n81_), .O(z07));
  ...
  aoi21  g066(.a(x40), .b(new_n75_), .c(new_n98_), .O(new_n129_));
  nand3  g067(.a(x40), .b(x39), .c(x05), .O(new_n130_));
  oai21  g068(.a(new_n129_), .b(new_n128_), .c(new_n130_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n87_), .c(new_n65_), .O(new_n132_));
  ...
  nand2  g074(.a(new_n84_), .b(new_n83_), .O(new_n137_));
  ...
  oai21  g079(.a(new_n86_), .b(x04), .c(x40), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n110_), .c(x08), .O(new_n143_));
  inv1   g081(.a(new_n86_), .O(new_n144_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n143_), .c(new_n83_), .O(new_n149_));
  ...
  nand2  g094(.a(new_n156_), .b(new_n111_), .O(new_n157_));
  ...
  oai21  g117(.a(new_n174_), .b(new_n153_), .c(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x40), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n176_), .c(new_n157_), .O(z14));
  ...
  nand2  g124(.a(new_n186_), .b(new_n81_), .O(z16));
  inv1   g125(.a(x01), .O(new_n188_));
  inv1   g126(.a(x24), .O(new_n189_));
  nand4  g127(.a(new_n81_), .b(new_n189_), .c(x23), .d(x22), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(new_n188_), .O(z17));
  inv1   g129(.a(z08), .O(new_n192_));
  ...
  aoi21  g135(.a(new_n195_), .b(new_n85_), .c(new_n197_), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n101_), .c(new_n92_), .d(new_n192_), .O(z18));
  oai21  g137(.a(new_n149_), .b(x09), .c(new_n81_), .O(z19));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n146_), .b(new_n99_), .c(new_n201_), .O(new_n202_));
  nand2  g140(.a(x40), .b(new_n66_), .O(new_n203_));
  aoi21  g141(.a(new_n203_), .b(new_n110_), .c(x08), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n202_), .c(new_n83_), .O(new_n205_));
