...
module FAU ( 
  ...
  nor2   g029(.a(x35), .b(new_n80_), .O(new_n92_));
  ...
  nor2   g035(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n95_), .c(new_n91_), .d(x40), .O(z02));
  ...
  nor2   g044(.a(new_n106_), .b(new_n97_), .O(z05));
  ...
  aoi21  g060(.a(new_n96_), .b(x05), .c(new_n122_), .O(z08));
  ...
  nand2  g065(.a(new_n75_), .b(new_n127_), .O(new_n128_));
  ...
  nor2   g069(.a(new_n131_), .b(new_n96_), .O(new_n132_));
  ...
  nand3  g074(.a(x35), .b(new_n108_), .c(new_n65_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x05), .c(new_n81_), .d(new_n64_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n142_), .b(x35), .c(new_n108_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n132_), .b(new_n154_), .c(x05), .d(new_n65_), .O(new_n165_));
  ...
  aoi21  g126(.a(new_n187_), .b(new_n108_), .c(new_n188_), .O(new_n189_));
  nand4  g127(.a(new_n76_), .b(x29), .c(x08), .d(x05), .O(new_n190_));
  oai21  g128(.a(new_n189_), .b(new_n97_), .c(new_n190_), .O(z18));
  inv1   g129(.a(new_n146_), .O(z19));
  nor2   g130(.a(new_n108_), .b(x27), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n92_), .c(new_n139_), .O(new_n194_));
  inv1   g132(.a(x08), .O(new_n195_));
  aoi21  g133(.a(x35), .b(x27), .c(new_n80_), .O(new_n196_));
  nor2   g134(.a(x40), .b(x27), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n196_), .c(new_n195_), .O(new_n198_));
  oai21  g136(.a(new_n193_), .b(new_n66_), .c(new_n122_), .O(new_n199_));
