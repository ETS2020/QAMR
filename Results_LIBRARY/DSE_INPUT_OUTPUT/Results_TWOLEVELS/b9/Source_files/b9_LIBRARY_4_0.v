...
module FAU ( 
  ...
  oai21  g046(.a(x40), .b(x39), .c(new_n86_), .O(new_n109_));
  ...
  nor3   g066(.a(new_n81_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g076(.a(new_n66_), .b(x28), .c(x39), .O(new_n139_));
  nand2  g077(.a(x40), .b(x04), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n139_), .c(new_n108_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g080(.a(x40), .b(new_n75_), .O(new_n143_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n94_), .c(new_n146_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n142_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n84_), .c(new_n137_), .O(new_n150_));
  inv1   g088(.a(new_n150_), .O(z11));
  nand2  g089(.a(new_n70_), .b(new_n66_), .O(new_n152_));
  aoi22  g090(.a(new_n152_), .b(x27), .c(x39), .d(new_n65_), .O(new_n153_));
  ...
  nand3  g094(.a(new_n75_), .b(new_n70_), .c(new_n86_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n153_), .c(x40), .O(new_n159_));
  oai21  g097(.a(new_n76_), .b(x04), .c(new_n86_), .O(new_n160_));
  nand2  g098(.a(new_n76_), .b(new_n66_), .O(new_n161_));
  ...
  aoi21  g105(.a(new_n167_), .b(x28), .c(new_n76_), .O(new_n168_));
  ...
  aoi21  g113(.a(new_n175_), .b(new_n65_), .c(new_n81_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n174_), .O(z13));
  nand3  g115(.a(x20), .b(new_n171_), .c(new_n170_), .O(new_n178_));
  nand4  g116(.a(new_n167_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n179_));
  nor2   g117(.a(x13), .b(x04), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n179_), .c(z08), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n178_), .O(new_n182_));
  oai22  g120(.a(new_n152_), .b(new_n86_), .c(new_n76_), .d(x27), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n85_), .c(new_n84_), .O(new_n184_));
  nand2  g122(.a(x39), .b(new_n86_), .O(new_n185_));
  nand2  g123(.a(x40), .b(new_n66_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n65_), .O(new_n187_));
  inv1   g125(.a(new_n71_), .O(new_n188_));
  nor2   g126(.a(new_n124_), .b(x13), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n187_), .c(new_n70_), .O(new_n191_));
  aoi21  g129(.a(x40), .b(x27), .c(x39), .O(new_n192_));
  oai21  g130(.a(new_n180_), .b(new_n76_), .c(new_n99_), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n64_), .c(new_n192_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n191_), .c(new_n184_), .d(new_n182_), .O(z14));
  inv1   g133(.a(x12), .O(new_n196_));
  nand4  g134(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n197_));
  ...
  nand4  g141(.a(new_n82_), .b(new_n203_), .c(x23), .d(x22), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(new_n202_), .O(z17));
  inv1   g143(.a(z08), .O(new_n206_));
  ...
  oai22  g149(.a(new_n211_), .b(new_n81_), .c(new_n92_), .d(new_n206_), .O(z18));
  nand2  g150(.a(x28), .b(new_n64_), .O(new_n213_));
  aoi22  g151(.a(new_n213_), .b(x35), .c(new_n145_), .d(new_n143_), .O(new_n214_));
  nand2  g152(.a(x39), .b(new_n66_), .O(new_n215_));
  aoi21  g153(.a(new_n215_), .b(new_n108_), .c(x08), .O(new_n216_));
  oai21  g154(.a(new_n216_), .b(new_n214_), .c(new_n84_), .O(new_n217_));
  nor2   g155(.a(new_n217_), .b(x09), .O(z20));
  inv1   g156(.a(new_n150_), .O(z19));
endmodule
