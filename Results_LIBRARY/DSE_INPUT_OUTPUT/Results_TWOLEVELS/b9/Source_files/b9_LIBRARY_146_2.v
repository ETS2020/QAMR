...
module FAU ( 
  ...
  nor2   g022(.a(new_n64_), .b(new_n72_), .O(new_n85_));
  oai21  g023(.a(new_n84_), .b(x30), .c(new_n85_), .O(z01));
  inv1   g024(.a(x02), .O(new_n87_));
  oai21  g025(.a(new_n75_), .b(x08), .c(x29), .O(new_n88_));
  nand2  g026(.a(new_n88_), .b(new_n87_), .O(new_n89_));
  inv1   g027(.a(x39), .O(new_n90_));
  inv1   g028(.a(x08), .O(new_n91_));
  nand2  g029(.a(new_n80_), .b(new_n91_), .O(new_n92_));
  inv1   g030(.a(x35), .O(new_n93_));
  nor2   g031(.a(new_n93_), .b(x28), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n92_), .c(new_n72_), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n90_), .c(x40), .O(new_n96_));
  nand2  g034(.a(new_n75_), .b(new_n63_), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(new_n96_), .c(new_n89_), .O(z02));
  nand2  g036(.a(new_n67_), .b(x27), .O(new_n99_));
  inv1   g037(.a(x21), .O(new_n100_));
  aoi21  g038(.a(new_n66_), .b(new_n80_), .c(new_n100_), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n64_), .O(z03));
  aoi21  g040(.a(new_n66_), .b(new_n80_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n99_), .c(new_n64_), .O(z04));
  aoi21  g042(.a(new_n82_), .b(new_n66_), .c(new_n64_), .O(z05));
  inv1   g043(.a(x28), .O(new_n106_));
  aoi21  g044(.a(new_n65_), .b(new_n80_), .c(new_n106_), .O(new_n107_));
  ...
  nand2  g064(.a(x35), .b(new_n106_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n126_), .O(new_n128_));
  nand2  g066(.a(new_n122_), .b(x07), .O(new_n129_));
  nand3  g067(.a(x40), .b(x39), .c(x05), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(new_n128_), .c(x27), .O(new_n132_));
  ...
  nor2   g075(.a(new_n66_), .b(new_n80_), .O(new_n138_));
  ...
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n106_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand4  g083(.a(x35), .b(new_n106_), .c(x27), .d(new_n72_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n91_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n133_), .c(new_n141_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n65_), .O(z11));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n80_), .c(new_n74_), .O(new_n152_));
  oai21  g090(.a(new_n122_), .b(x04), .c(new_n69_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n152_), .c(new_n65_), .O(z12));
  ...
  nand3  g101(.a(new_n134_), .b(x40), .c(x39), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x13), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n72_), .c(new_n64_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z13));
  nand3  g105(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n168_));
  nand4  g106(.a(new_n156_), .b(new_n81_), .c(new_n133_), .d(x28), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  nand3  g108(.a(z08), .b(new_n155_), .c(new_n72_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n168_), .O(new_n172_));
  nand3  g110(.a(new_n66_), .b(new_n93_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n81_), .c(new_n133_), .O(new_n175_));
  aoi21  g113(.a(new_n171_), .b(new_n69_), .c(new_n64_), .O(new_n176_));
  ...
  oai21  g125(.a(new_n127_), .b(x27), .c(new_n142_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n64_), .b(x30), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n189_), .c(new_n146_), .d(new_n141_), .O(z18));
  inv1   g129(.a(new_n142_), .O(new_n192_));
  oai21  g130(.a(new_n93_), .b(new_n80_), .c(new_n91_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n80_), .c(new_n93_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n192_), .c(new_n193_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n133_), .c(new_n141_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n65_), .O(z20));
  nand2  g135(.a(new_n149_), .b(new_n65_), .O(z19));
endmodule
