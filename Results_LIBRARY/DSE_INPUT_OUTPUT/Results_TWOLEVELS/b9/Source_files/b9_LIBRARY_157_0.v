...
module FAU ( 
  ...
  oai21  g082(.a(new_n144_), .b(new_n139_), .c(new_n82_), .O(new_n145_));
  ...
  nand2  g090(.a(new_n152_), .b(x10), .O(new_n153_));
  ...
  nand2  g102(.a(new_n164_), .b(new_n65_), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n163_), .c(new_n80_), .O(z13));
  ...
  oai22  g126(.a(new_n85_), .b(x27), .c(new_n117_), .d(new_n141_), .O(new_n189_));
  ...
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n80_), .d(new_n82_), .O(z18));
  oai21  g131(.a(new_n145_), .b(x09), .c(new_n80_), .O(z19));
  ...
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n82_), .O(new_n199_));
