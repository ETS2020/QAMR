...
module FAU ( 
  ...
  nand2  g037(.a(new_n68_), .b(new_n97_), .O(new_n100_));
  ...
  nor2   g068(.a(new_n68_), .b(new_n97_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n65_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n83_), .c(new_n121_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x26), .c(new_n64_), .d(new_n97_), .O(new_n136_));
  ...
  nand3  g078(.a(new_n140_), .b(x35), .c(new_n83_), .O(new_n141_));
  ...
  nor2   g083(.a(x27), .b(new_n63_), .O(new_n146_));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n74_), .O(new_n148_));
  aoi21  g086(.a(x39), .b(new_n121_), .c(new_n63_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n75_), .c(new_n71_), .O(new_n150_));
  ...
  nand4  g098(.a(new_n127_), .b(x39), .c(new_n152_), .d(new_n121_), .O(new_n161_));
  ...
  nand2  g112(.a(new_n167_), .b(new_n71_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x26), .O(new_n177_));
  nand2  g115(.a(new_n71_), .b(new_n75_), .O(new_n178_));
  ...
  nand2  g126(.a(x27), .b(new_n121_), .O(new_n189_));
  nand2  g127(.a(new_n97_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n171_), .O(new_n191_));
  nand2  g129(.a(new_n80_), .b(new_n134_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n83_), .c(new_n192_), .O(new_n193_));
  inv1   g131(.a(new_n123_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(x29), .c(x26), .d(x08), .O(new_n195_));
  oai21  g133(.a(new_n193_), .b(new_n65_), .c(new_n195_), .O(z18));
  inv1   g134(.a(new_n144_), .O(z19));
  nand2  g135(.a(x28), .b(new_n97_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n138_), .d(x40), .O(new_n199_));
  oai21  g137(.a(new_n171_), .b(new_n97_), .c(x26), .O(new_n200_));
  nand2  g138(.a(new_n75_), .b(new_n97_), .O(new_n201_));
