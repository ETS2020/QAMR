...
module FAU ( 
  ...
  nand2  g015(.a(x40), .b(x21), .O(new_n78_));
  ...
  nor2   g033(.a(x28), .b(new_n64_), .O(new_n96_));
  nor2   g034(.a(x37), .b(x27), .O(new_n97_));
  oai21  g035(.a(new_n97_), .b(new_n96_), .c(new_n78_), .O(new_n98_));
  aoi21  g036(.a(x28), .b(x27), .c(x37), .O(new_n99_));
  nor2   g037(.a(new_n99_), .b(x21), .O(new_n100_));
  nor2   g038(.a(x40), .b(x35), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(x27), .c(new_n100_), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n98_), .O(z03));
  aoi21  g041(.a(new_n71_), .b(x27), .c(new_n97_), .O(new_n104_));
  inv1   g042(.a(x40), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(x21), .O(new_n106_));
  oai21  g044(.a(new_n104_), .b(x21), .c(new_n106_), .O(z04));
  aoi21  g045(.a(x40), .b(x21), .c(new_n99_), .O(z05));
  aoi21  g046(.a(x40), .b(x21), .c(x27), .O(new_n109_));
  oai21  g047(.a(new_n109_), .b(new_n83_), .c(new_n70_), .O(new_n110_));
  nand2  g048(.a(new_n110_), .b(new_n78_), .O(z06));
  ...
  aoi21  g062(.a(new_n124_), .b(new_n89_), .c(new_n105_), .O(z08));
  ...
  aoi21  g078(.a(new_n140_), .b(new_n89_), .c(new_n109_), .O(new_n141_));
  aoi21  g079(.a(x39), .b(x29), .c(x21), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n83_), .O(new_n144_));
  oai21  g082(.a(new_n142_), .b(new_n105_), .c(new_n144_), .O(new_n145_));
  ...
  aoi21  g090(.a(x39), .b(new_n65_), .c(x21), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n105_), .c(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n151_), .c(new_n78_), .O(z12));
  inv1   g093(.a(x13), .O(new_n156_));
  nand2  g094(.a(x36), .b(x35), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x28), .c(new_n105_), .O(new_n158_));
  ...
  nand2  g103(.a(new_n165_), .b(new_n89_), .O(new_n166_));
  ...
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(x21), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n105_), .c(new_n169_), .O(new_n174_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n89_), .O(new_n180_));
  nand2  g118(.a(new_n152_), .b(new_n105_), .O(new_n181_));
  ...
  oai22  g130(.a(new_n84_), .b(x27), .c(new_n128_), .d(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  inv1   g132(.a(new_n84_), .O(new_n195_));
  nor2   g133(.a(new_n64_), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n195_), .c(x30), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n194_), .c(new_n78_), .d(new_n139_), .O(z18));
  nand2  g136(.a(new_n147_), .b(new_n78_), .O(z19));
  nor2   g137(.a(new_n142_), .b(new_n105_), .O(new_n200_));
  aoi21  g138(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n201_));
  aoi21  g139(.a(x35), .b(x27), .c(x21), .O(new_n202_));
  nor2   g140(.a(x40), .b(x27), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  oai22  g142(.a(new_n204_), .b(x08), .c(new_n201_), .d(new_n200_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n81_), .c(new_n139_), .O(new_n206_));
