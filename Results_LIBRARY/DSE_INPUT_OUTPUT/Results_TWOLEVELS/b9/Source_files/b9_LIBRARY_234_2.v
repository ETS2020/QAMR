...
module FAU ( 
  ...
  nand2  g016(.a(new_n78_), .b(new_n71_), .O(z00));
  ...
  nand2  g035(.a(new_n66_), .b(new_n97_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n96_), .c(new_n65_), .d(x21), .O(z03));
  ...
  aoi21  g040(.a(new_n102_), .b(new_n66_), .c(new_n64_), .O(z05));
  ...
  nor2   g069(.a(new_n97_), .b(new_n72_), .O(new_n132_));
  oai22  g070(.a(new_n132_), .b(new_n84_), .c(new_n63_), .d(new_n91_), .O(new_n133_));
  nand2  g071(.a(x27), .b(new_n72_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n84_), .c(new_n90_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n80_), .c(new_n131_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n65_), .O(z11));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  nor2   g077(.a(new_n75_), .b(x27), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n139_), .c(new_n74_), .O(new_n141_));
  oai21  g079(.a(new_n63_), .b(x04), .c(new_n69_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n141_), .c(new_n65_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n72_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand4  g087(.a(new_n68_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n147_), .c(new_n75_), .O(new_n151_));
  nand4  g089(.a(new_n68_), .b(new_n63_), .c(x20), .d(new_n149_), .O(new_n152_));
  ...
  nand4  g093(.a(new_n155_), .b(x39), .c(new_n144_), .d(new_n72_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n154_), .O(z13));
  nand3  g095(.a(x39), .b(new_n144_), .c(new_n72_), .O(new_n158_));
  nand3  g096(.a(x20), .b(new_n149_), .c(new_n148_), .O(new_n159_));
  inv1   g097(.a(new_n159_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n68_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n159_), .b(new_n145_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n83_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n81_), .c(new_n80_), .O(new_n166_));
  nand2  g104(.a(x40), .b(x13), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(x39), .c(new_n72_), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n97_), .c(new_n64_), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n166_), .c(new_n162_), .O(z14));
  ...
  nand4  g115(.a(new_n65_), .b(new_n177_), .c(x23), .d(x22), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n176_), .O(z17));
  inv1   g117(.a(x35), .O(new_n180_));
  nand2  g118(.a(new_n97_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n134_), .c(new_n180_), .O(new_n182_));
  nand2  g120(.a(new_n80_), .b(new_n131_), .O(new_n183_));
  aoi21  g121(.a(new_n182_), .b(new_n83_), .c(new_n183_), .O(new_n184_));
  nand3  g122(.a(z08), .b(x29), .c(x08), .O(new_n185_));
  oai21  g123(.a(new_n184_), .b(new_n64_), .c(new_n185_), .O(z18));
  nor2   g124(.a(new_n63_), .b(new_n91_), .O(new_n187_));
  oai21  g125(.a(new_n180_), .b(new_n97_), .c(new_n90_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n97_), .c(new_n180_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n80_), .c(new_n131_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n65_), .O(z20));
  nand2  g130(.a(new_n137_), .b(new_n65_), .O(z19));
endmodule
