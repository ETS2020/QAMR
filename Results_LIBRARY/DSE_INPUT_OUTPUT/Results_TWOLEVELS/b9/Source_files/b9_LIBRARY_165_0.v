...
module FAU ( 
  ...
  oai21  g031(.a(x40), .b(new_n63_), .c(new_n93_), .O(z02));
  nand2  g032(.a(new_n67_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x27), .O(new_n96_));
  aoi21  g034(.a(new_n66_), .b(new_n96_), .c(new_n79_), .O(new_n97_));
  ...
  nor2   g039(.a(new_n101_), .b(new_n79_), .O(z05));
  ...
  nor2   g052(.a(new_n64_), .b(new_n63_), .O(new_n115_));
  ...
  aoi21  g058(.a(x35), .b(new_n88_), .c(x36), .O(new_n121_));
  ...
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n72_), .O(new_n131_));
  oai21  g069(.a(new_n128_), .b(new_n96_), .c(new_n131_), .O(z10));
  nand2  g070(.a(new_n65_), .b(new_n96_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n88_), .c(new_n72_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x39), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n133_), .c(x08), .O(new_n136_));
  nand2  g074(.a(x40), .b(new_n63_), .O(new_n137_));
  inv1   g075(.a(x29), .O(new_n138_));
  oai21  g076(.a(new_n64_), .b(new_n138_), .c(x39), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  aoi22  g078(.a(new_n140_), .b(new_n83_), .c(new_n139_), .d(new_n137_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n136_), .c(new_n80_), .O(new_n142_));
  nor2   g080(.a(new_n142_), .b(x09), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  nor2   g082(.a(new_n64_), .b(x27), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n74_), .O(new_n146_));
  oai21  g084(.a(new_n116_), .b(x04), .c(new_n69_), .O(new_n147_));
  ...
  nand3  g097(.a(new_n130_), .b(new_n149_), .c(new_n72_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  aoi21  g099(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x40), .c(x39), .d(new_n72_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n96_), .O(new_n164_));
  nand3  g102(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n165_));
  nand4  g103(.a(new_n150_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n166_));
  nor2   g104(.a(x13), .b(x04), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n166_), .c(new_n115_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  aoi22  g107(.a(new_n167_), .b(new_n115_), .c(x35), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n66_), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n169_), .c(new_n164_), .d(new_n65_), .O(z14));
  inv1   g112(.a(x12), .O(new_n175_));
  nor2   g113(.a(new_n119_), .b(new_n175_), .O(z15));
  inv1   g114(.a(x23), .O(new_n177_));
  nand4  g115(.a(new_n65_), .b(new_n177_), .c(x22), .d(x01), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(z16));
  inv1   g117(.a(x01), .O(new_n180_));
  inv1   g118(.a(x24), .O(new_n181_));
  nand4  g119(.a(new_n65_), .b(new_n181_), .c(x23), .d(x22), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n180_), .O(z17));
  oai22  g121(.a(new_n116_), .b(new_n138_), .c(new_n89_), .d(x27), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  nor2   g123(.a(new_n96_), .b(x04), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n83_), .c(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n185_), .c(new_n65_), .d(new_n80_), .O(z18));
  aoi21  g126(.a(x28), .b(new_n96_), .c(new_n82_), .O(new_n189_));
  aoi21  g127(.a(new_n139_), .b(new_n137_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(x39), .b(new_n82_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n133_), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n80_), .O(new_n193_));
  nor2   g131(.a(new_n193_), .b(x09), .O(z20));
  nor2   g132(.a(new_n142_), .b(x09), .O(z19));
endmodule
