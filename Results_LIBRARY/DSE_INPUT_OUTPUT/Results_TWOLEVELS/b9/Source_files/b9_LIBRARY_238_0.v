...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(new_n90_), .O(new_n94_));
  nand2  g032(.a(x40), .b(new_n66_), .O(new_n95_));
  nand3  g033(.a(new_n95_), .b(new_n94_), .c(new_n84_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(x04), .c(new_n93_), .O(new_n97_));
  oai21  g035(.a(new_n92_), .b(x02), .c(new_n97_), .O(z02));
  nand2  g036(.a(new_n71_), .b(x27), .O(new_n99_));
  nand3  g037(.a(new_n80_), .b(new_n70_), .c(new_n64_), .O(new_n100_));
  nand4  g038(.a(new_n100_), .b(new_n99_), .c(new_n80_), .d(x21), .O(z03));
  inv1   g039(.a(x21), .O(new_n102_));
  nand4  g040(.a(new_n100_), .b(new_n99_), .c(new_n80_), .d(new_n102_), .O(z04));
  inv1   g041(.a(new_n80_), .O(new_n104_));
  aoi21  g042(.a(x28), .b(x27), .c(x37), .O(new_n105_));
  nor2   g043(.a(new_n105_), .b(new_n104_), .O(z05));
  oai22  g044(.a(x40), .b(x23), .c(new_n84_), .d(new_n64_), .O(new_n107_));
  ...
  nand2  g057(.a(new_n80_), .b(new_n93_), .O(z08));
  ...
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n104_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n84_), .c(new_n65_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n80_), .d(new_n64_), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  nand2  g077(.a(new_n79_), .b(x23), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(x35), .c(new_n84_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  oai21  g082(.a(new_n137_), .b(x08), .c(new_n144_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n82_), .c(new_n135_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n80_), .O(z11));
  ...
  nand3  g090(.a(new_n152_), .b(new_n79_), .c(x23), .O(new_n153_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n65_), .c(new_n104_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(z13));
  inv1   g105(.a(new_n140_), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n169_));
  nand4  g107(.a(new_n156_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n170_));
  nand3  g108(.a(x39), .b(new_n155_), .c(new_n65_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n79_), .O(new_n173_));
  ...
  nand2  g120(.a(new_n182_), .b(new_n80_), .O(z15));
  nand4  g121(.a(x40), .b(new_n78_), .c(x22), .d(x01), .O(new_n184_));
  ...
  oai22  g126(.a(new_n85_), .b(x27), .c(new_n93_), .d(new_n91_), .O(new_n189_));
  ...
  nand4  g131(.a(new_n193_), .b(new_n190_), .c(new_n80_), .d(new_n82_), .O(z18));
  inv1   g132(.a(new_n146_), .O(z19));
  nand2  g133(.a(x28), .b(new_n64_), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(x35), .c(new_n140_), .d(new_n139_), .O(new_n197_));
  nand2  g135(.a(new_n80_), .b(new_n64_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n95_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n197_), .c(new_n82_), .O(new_n200_));
