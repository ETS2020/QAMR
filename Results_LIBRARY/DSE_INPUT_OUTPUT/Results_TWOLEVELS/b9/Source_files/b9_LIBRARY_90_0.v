...
module FAU ( 
  ...
  nand2  g056(.a(new_n82_), .b(new_n118_), .O(z08));
  ...
  nand2  g061(.a(new_n76_), .b(x38), .O(new_n124_));
  ...
  nand2  g091(.a(new_n153_), .b(x38), .O(new_n154_));
  ...
  inv1   g105(.a(new_n124_), .O(new_n168_));
  ...
  oai22  g133(.a(new_n195_), .b(new_n99_), .c(new_n93_), .d(new_n118_), .O(z18));
  oai21  g134(.a(new_n146_), .b(x09), .c(new_n82_), .O(z19));
  nand2  g135(.a(x28), .b(new_n64_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n143_), .d(new_n124_), .O(new_n199_));
