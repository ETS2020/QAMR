...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n70_,
    ...
    new_n80_, new_n83_, new_n85_, new_n88_, new_n89_, new_n90_, new_n91_,
  ...
  nand2  g23(.a(z05), .b(new_n68_), .O(z06));
  ...
  nand2  g38(.a(new_n101_), .b(new_n68_), .O(z09));
  inv1   g39(.a(x04), .O(new_n103_));
  nand3  g40(.a(new_n73_), .b(x07), .c(new_n103_), .O(new_n104_));
  nand2  g41(.a(x37), .b(x06), .O(new_n105_));
  nand2  g42(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g43(.a(new_n106_), .b(new_n68_), .c(x27), .O(new_n107_));
  inv1   g44(.a(new_n107_), .O(z10));
  inv1   g45(.a(x09), .O(new_n109_));
  inv1   g46(.a(x28), .O(new_n110_));
  nor2   g47(.a(x27), .b(x08), .O(new_n111_));
  aoi21  g48(.a(x27), .b(x04), .c(new_n111_), .O(new_n112_));
  nand3  g49(.a(new_n112_), .b(x35), .c(new_n110_), .O(new_n113_));
  nand4  g50(.a(new_n113_), .b(new_n68_), .c(new_n70_), .d(new_n109_), .O(new_n114_));
  inv1   g51(.a(new_n114_), .O(z11));
  aoi21  g52(.a(new_n66_), .b(x27), .c(z08), .O(z12));
  nand4  g53(.a(new_n68_), .b(new_n66_), .c(x27), .d(x20), .O(new_n117_));
  nor3   g54(.a(new_n117_), .b(x19), .c(x18), .O(z13));
  nor2   g55(.a(x19), .b(x18), .O(new_n119_));
  nand3  g56(.a(new_n119_), .b(x27), .c(x20), .O(new_n120_));
  inv1   g57(.a(new_n120_), .O(new_n121_));
  aoi21  g58(.a(new_n121_), .b(new_n66_), .c(z08), .O(z14));
  inv1   g59(.a(x12), .O(new_n123_));
  nand4  g60(.a(new_n68_), .b(x34), .c(x27), .d(x26), .O(new_n124_));
  nor2   g61(.a(new_n124_), .b(new_n123_), .O(z15));
  ...
  nand4  g67(.a(new_n68_), .b(new_n130_), .c(x23), .d(x22), .O(new_n131_));
  nor2   g68(.a(new_n131_), .b(new_n129_), .O(z17));
  nand2  g69(.a(new_n79_), .b(x08), .O(new_n133_));
  oai21  g70(.a(new_n79_), .b(x04), .c(new_n133_), .O(new_n134_));
  nand3  g71(.a(new_n134_), .b(x35), .c(new_n110_), .O(new_n135_));
  nor2   g72(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g73(.a(new_n136_), .b(new_n135_), .c(z08), .O(z18));
  nand2  g74(.a(new_n114_), .b(new_n68_), .O(z19));
  oai21  g75(.a(new_n111_), .b(new_n71_), .c(new_n68_), .O(new_n139_));
  oai21  g76(.a(new_n110_), .b(x27), .c(new_n139_), .O(new_n140_));
  nand3  g77(.a(new_n140_), .b(new_n70_), .c(new_n109_), .O(new_n141_));
