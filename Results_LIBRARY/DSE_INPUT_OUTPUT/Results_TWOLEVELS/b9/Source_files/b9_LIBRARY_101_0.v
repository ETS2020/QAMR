...
module FAU ( 
  ...
  oai21  g042(.a(x40), .b(x39), .c(new_n98_), .O(new_n105_));
  oai21  g043(.a(x40), .b(x39), .c(new_n82_), .O(new_n106_));
  ...
  aoi21  g073(.a(x39), .b(new_n135_), .c(x28), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n105_), .c(new_n71_), .O(new_n137_));
  ...
  nand2  g081(.a(x40), .b(new_n135_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n140_), .c(new_n82_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n142_), .c(new_n138_), .O(new_n147_));
  ...
  inv1   g090(.a(new_n95_), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n71_), .c(new_n74_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(new_n68_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n64_), .O(z12));
  ...
  nand3  g109(.a(x39), .b(new_n157_), .c(new_n71_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n74_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n153_), .c(new_n170_), .O(new_n175_));
  nand2  g113(.a(x39), .b(new_n98_), .O(new_n176_));
  nand4  g114(.a(x40), .b(new_n65_), .c(new_n135_), .d(x28), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(x32), .O(new_n178_));
  oai21  g116(.a(new_n173_), .b(new_n74_), .c(new_n95_), .O(new_n179_));
  aoi22  g117(.a(new_n179_), .b(new_n68_), .c(new_n178_), .d(new_n79_), .O(new_n180_));
  ...
  nand2  g130(.a(new_n98_), .b(x08), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(new_n135_), .O(new_n194_));
  nand2  g132(.a(new_n79_), .b(new_n133_), .O(new_n195_));
  aoi21  g133(.a(new_n194_), .b(new_n82_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n63_), .c(new_n119_), .d(new_n89_), .O(z18));
  nand2  g135(.a(x28), .b(new_n98_), .O(new_n198_));
  nand2  g136(.a(new_n139_), .b(x39), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n143_), .O(new_n200_));
  aoi22  g138(.a(new_n200_), .b(new_n199_), .c(new_n198_), .d(x35), .O(new_n201_));
  nand2  g139(.a(x39), .b(new_n135_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n105_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n201_), .c(new_n79_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(x09), .O(z20));
  nand2  g143(.a(new_n148_), .b(new_n64_), .O(z19));
endmodule
