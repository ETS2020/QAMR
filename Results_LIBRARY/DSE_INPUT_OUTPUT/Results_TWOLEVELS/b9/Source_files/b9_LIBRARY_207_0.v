...
module FAU ( 
  ...
  nand3  g032(.a(new_n94_), .b(new_n92_), .c(new_n77_), .O(z02));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n83_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n81_), .c(new_n70_), .O(z05));
  inv1   g040(.a(x28), .O(new_n103_));
  aoi21  g041(.a(new_n81_), .b(new_n64_), .c(new_n103_), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(x37), .c(new_n81_), .O(z06));
  ...
  nor3   g065(.a(new_n83_), .b(new_n70_), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g072(.a(new_n129_), .b(new_n64_), .c(new_n134_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n103_), .c(new_n65_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n81_), .d(new_n64_), .O(new_n138_));
  ...
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n103_), .O(new_n144_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n76_), .c(x39), .O(new_n154_));
  ...
  nand2  g105(.a(new_n76_), .b(x39), .O(new_n168_));
  ...
  nand2  g113(.a(x39), .b(new_n64_), .O(new_n176_));
  nand4  g114(.a(x40), .b(new_n70_), .c(new_n66_), .d(x28), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(x32), .O(new_n178_));
  oai21  g116(.a(new_n173_), .b(new_n76_), .c(new_n168_), .O(new_n179_));
  aoi22  g117(.a(new_n179_), .b(new_n153_), .c(new_n178_), .d(new_n84_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n175_), .O(z14));
  nand4  g119(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n81_), .O(z15));
  inv1   g121(.a(x23), .O(new_n184_));
  nand4  g122(.a(new_n81_), .b(new_n184_), .c(x22), .d(x01), .O(new_n185_));
  ...
  nand2  g131(.a(new_n84_), .b(new_n136_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n103_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n83_), .c(new_n91_), .d(new_n117_), .O(z18));
  nand2  g134(.a(new_n147_), .b(new_n81_), .O(z19));
  nand2  g135(.a(x28), .b(new_n64_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n141_), .d(new_n139_), .O(new_n199_));
