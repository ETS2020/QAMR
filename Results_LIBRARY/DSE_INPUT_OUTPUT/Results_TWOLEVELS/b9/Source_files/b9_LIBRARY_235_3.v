...
module FAU ( 
  ...
  nand2  g018(.a(x40), .b(x12), .O(new_n81_));
  ...
  inv1   g027(.a(x12), .O(new_n90_));
  inv1   g028(.a(x02), .O(new_n91_));
  nand2  g029(.a(x29), .b(x08), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  oai21  g031(.a(new_n66_), .b(x28), .c(x04), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n93_), .c(new_n76_), .O(new_n95_));
  inv1   g033(.a(x08), .O(new_n96_));
  nand3  g034(.a(new_n64_), .b(new_n96_), .c(x04), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(x39), .O(new_n98_));
  oai21  g036(.a(new_n98_), .b(new_n95_), .c(new_n90_), .O(new_n99_));
  ...
  aoi21  g047(.a(new_n81_), .b(new_n64_), .c(new_n85_), .O(new_n110_));
  oai21  g048(.a(new_n110_), .b(x37), .c(new_n81_), .O(z06));
  ...
  nand3  g060(.a(x40), .b(x39), .c(new_n90_), .O(new_n123_));
  inv1   g061(.a(new_n123_), .O(z08));
  nand4  g062(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(new_n81_), .O(z09));
  oai21  g064(.a(x39), .b(x12), .c(x40), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(x07), .O(new_n128_));
  nand3  g066(.a(new_n77_), .b(new_n90_), .c(x05), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(new_n128_), .c(new_n86_), .O(new_n130_));
  ...
  nand4  g073(.a(new_n135_), .b(new_n90_), .c(x05), .d(new_n65_), .O(new_n136_));
  ...
  aoi22  g078(.a(new_n140_), .b(new_n90_), .c(new_n81_), .d(new_n64_), .O(new_n141_));
  nand2  g079(.a(x39), .b(x29), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n90_), .c(new_n76_), .O(new_n143_));
  ...
  nand2  g086(.a(new_n148_), .b(new_n81_), .O(z11));
  inv1   g087(.a(x10), .O(new_n150_));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  nor2   g089(.a(new_n76_), .b(x27), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  oai21  g091(.a(x27), .b(new_n65_), .c(new_n90_), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x40), .O(new_n155_));
  oai21  g093(.a(new_n75_), .b(x04), .c(new_n90_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(x40), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n71_), .c(new_n70_), .O(new_n158_));
  nand2  g096(.a(new_n127_), .b(new_n64_), .O(new_n159_));
  nand4  g097(.a(new_n159_), .b(new_n158_), .c(new_n155_), .d(new_n153_), .O(z12));
  inv1   g098(.a(x13), .O(new_n161_));
  nand2  g099(.a(x36), .b(x35), .O(new_n162_));
  aoi21  g100(.a(new_n162_), .b(x28), .c(new_n76_), .O(new_n163_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n164_), .c(x12), .O(new_n168_));
  nand4  g106(.a(new_n72_), .b(new_n76_), .c(x20), .d(new_n166_), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(x18), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(x27), .O(new_n171_));
  nand4  g109(.a(new_n135_), .b(new_n161_), .c(new_n90_), .d(new_n65_), .O(new_n172_));
  ...
  oai21  g113(.a(x13), .b(x04), .c(x40), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n175_), .c(x39), .O(new_n177_));
  ...
  oai22  g121(.a(new_n152_), .b(new_n73_), .c(x13), .d(x04), .O(new_n184_));
  oai21  g122(.a(new_n73_), .b(new_n64_), .c(new_n75_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n184_), .c(new_n183_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n90_), .O(new_n187_));
  oai21  g125(.a(new_n73_), .b(new_n64_), .c(new_n76_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n187_), .c(new_n180_), .O(z14));
  nand4  g127(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(x40), .O(z15));
  inv1   g129(.a(x23), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(x22), .c(x01), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n81_), .O(z16));
  inv1   g132(.a(x01), .O(new_n195_));
  inv1   g133(.a(x24), .O(new_n196_));
  nand4  g134(.a(new_n81_), .b(new_n196_), .c(x23), .d(x22), .O(new_n197_));
  ...
  nand2  g139(.a(new_n83_), .b(new_n138_), .O(new_n202_));
  aoi21  g140(.a(new_n201_), .b(new_n85_), .c(new_n202_), .O(new_n203_));
  nand4  g141(.a(new_n77_), .b(x29), .c(new_n90_), .d(x08), .O(new_n204_));
  oai21  g142(.a(new_n203_), .b(new_n101_), .c(new_n204_), .O(z18));
  inv1   g143(.a(new_n148_), .O(z19));
  aoi21  g144(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n207_));
  aoi21  g145(.a(x35), .b(x27), .c(x12), .O(new_n208_));
  nor2   g146(.a(x40), .b(x27), .O(new_n209_));
  oai21  g147(.a(new_n209_), .b(new_n208_), .c(new_n96_), .O(new_n210_));
  oai21  g148(.a(new_n207_), .b(new_n143_), .c(new_n210_), .O(new_n211_));
