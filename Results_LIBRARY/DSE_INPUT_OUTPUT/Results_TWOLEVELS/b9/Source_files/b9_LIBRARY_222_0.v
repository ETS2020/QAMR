...
module FAU ( 
  ...
  nand2  g031(.a(new_n64_), .b(x10), .O(new_n94_));
  ...
  oai22  g043(.a(x40), .b(x10), .c(new_n81_), .d(new_n99_), .O(new_n106_));
  ...
  aoi21  g062(.a(new_n124_), .b(new_n94_), .c(new_n123_), .O(new_n125_));
  ...
  nand2  g075(.a(new_n65_), .b(new_n99_), .O(new_n138_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n94_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n140_), .c(new_n78_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(x09), .O(z11));
  oai21  g085(.a(new_n119_), .b(x04), .c(new_n69_), .O(new_n148_));
  oai21  g086(.a(new_n64_), .b(new_n63_), .c(new_n99_), .O(new_n149_));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n64_), .c(new_n63_), .O(new_n151_));
  inv1   g089(.a(x35), .O(new_n152_));
  aoi21  g090(.a(new_n81_), .b(x10), .c(new_n152_), .O(new_n153_));
  inv1   g091(.a(new_n153_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n64_), .c(new_n66_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(new_n151_), .c(new_n149_), .d(new_n148_), .O(z12));
  ...
  aoi21  g104(.a(new_n166_), .b(new_n72_), .c(new_n96_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n165_), .O(z13));
  nand3  g106(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n169_));
  nand4  g107(.a(new_n158_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(z08), .c(new_n157_), .d(new_n72_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand3  g110(.a(new_n66_), .b(new_n152_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n79_), .c(new_n78_), .O(new_n175_));
  nand3  g113(.a(x39), .b(new_n157_), .c(new_n72_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n69_), .O(new_n177_));
  nor2   g115(.a(new_n99_), .b(new_n63_), .O(new_n178_));
  oai21  g116(.a(new_n153_), .b(x37), .c(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n64_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n177_), .c(new_n175_), .d(new_n172_), .O(z14));
  ...
  nand2  g129(.a(new_n99_), .b(x08), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n152_), .O(new_n193_));
  inv1   g131(.a(x09), .O(new_n194_));
  nand2  g132(.a(new_n78_), .b(new_n194_), .O(new_n195_));
  aoi21  g133(.a(new_n193_), .b(new_n81_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n96_), .c(new_n190_), .d(new_n88_), .O(z18));
  oai21  g135(.a(new_n146_), .b(x09), .c(new_n65_), .O(z19));
  nand2  g136(.a(x28), .b(new_n99_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n143_), .d(new_n94_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n152_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n138_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n78_), .O(new_n203_));
