...
module FAU ( 
  ...
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n71_), .d(new_n87_), .O(new_n137_));
  ...
  oai21  g080(.a(new_n70_), .b(new_n88_), .c(x39), .O(new_n143_));
  ...
  aoi21  g093(.a(new_n155_), .b(x40), .c(new_n67_), .O(new_n156_));
  ...
  nand4  g102(.a(new_n164_), .b(x40), .c(new_n76_), .d(new_n75_), .O(new_n165_));
  ...
  nand2  g124(.a(new_n85_), .b(x40), .O(new_n187_));
