...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x39), .O(new_n96_));
  ...
  nor2   g041(.a(new_n103_), .b(new_n96_), .O(z05));
  nand2  g042(.a(new_n81_), .b(new_n64_), .O(new_n105_));
  inv1   g043(.a(x28), .O(new_n106_));
  oai21  g044(.a(x40), .b(x39), .c(new_n106_), .O(new_n107_));
  aoi21  g045(.a(new_n107_), .b(new_n105_), .c(x37), .O(z06));
  ...
  aoi21  g060(.a(x35), .b(new_n106_), .c(x36), .O(new_n123_));
  ...
  nor3   g066(.a(new_n96_), .b(new_n70_), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g073(.a(new_n130_), .b(new_n64_), .c(new_n135_), .O(z10));
  inv1   g074(.a(x09), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n106_), .c(new_n65_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x39), .c(new_n81_), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(x40), .b(new_n75_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n144_), .b(x35), .c(new_n106_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  oai21  g084(.a(new_n139_), .b(x08), .c(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n83_), .c(new_n137_), .O(new_n148_));
  ...
  nand3  g092(.a(new_n154_), .b(new_n76_), .c(x39), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n153_), .O(z12));
  inv1   g094(.a(x13), .O(new_n157_));
  nand2  g095(.a(x36), .b(x35), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x28), .c(new_n76_), .O(new_n159_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n170_));
  nor2   g108(.a(x13), .b(x04), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n170_), .c(z08), .O(new_n172_));
  ...
  nand2  g114(.a(new_n76_), .b(x39), .O(new_n177_));
  oai21  g115(.a(new_n75_), .b(x04), .c(x40), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n177_), .c(new_n157_), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n71_), .c(new_n70_), .O(new_n180_));
  aoi21  g118(.a(x40), .b(x27), .c(x39), .O(new_n181_));
  oai21  g119(.a(new_n171_), .b(new_n76_), .c(new_n177_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n64_), .c(new_n181_), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n180_), .c(new_n176_), .d(new_n173_), .O(z14));
  nand4  g122(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n81_), .O(z15));
  inv1   g124(.a(x23), .O(new_n187_));
  nand4  g125(.a(new_n81_), .b(new_n187_), .c(x22), .d(x01), .O(new_n188_));
  ...
  nand2  g135(.a(new_n83_), .b(new_n137_), .O(new_n198_));
  aoi21  g136(.a(new_n197_), .b(new_n106_), .c(new_n198_), .O(new_n199_));
  oai22  g137(.a(new_n199_), .b(new_n96_), .c(new_n90_), .d(new_n194_), .O(z18));
  nand2  g138(.a(new_n148_), .b(new_n81_), .O(z19));
  oai22  g139(.a(new_n75_), .b(x35), .c(new_n106_), .d(x27), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n141_), .O(new_n203_));
  oai21  g141(.a(new_n75_), .b(x08), .c(new_n140_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(new_n66_), .O(new_n205_));
  nor2   g143(.a(new_n96_), .b(x08), .O(new_n206_));
  nor2   g144(.a(x39), .b(new_n106_), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(new_n206_), .c(new_n64_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n205_), .c(new_n203_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n83_), .c(new_n137_), .O(new_n210_));
  nand2  g148(.a(new_n210_), .b(new_n81_), .O(z20));
endmodule
