...
module FAU ( 
  ...
  aoi21  g022(.a(x28), .b(x04), .c(new_n69_), .O(new_n85_));
  oai21  g023(.a(x27), .b(x08), .c(x35), .O(new_n86_));
  nand2  g024(.a(new_n86_), .b(x04), .O(new_n87_));
  nand4  g025(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(x39), .O(z02));
  ...
  nand3  g030(.a(new_n70_), .b(new_n92_), .c(new_n91_), .O(new_n93_));
  nand4  g031(.a(new_n93_), .b(new_n90_), .c(new_n70_), .d(x21), .O(z03));
  inv1   g032(.a(x21), .O(new_n95_));
  nand4  g033(.a(new_n93_), .b(new_n90_), .c(new_n70_), .d(new_n95_), .O(z04));
  ...
  nand2  g048(.a(new_n110_), .b(new_n106_), .O(new_n111_));
  ...
  nand2  g054(.a(new_n116_), .b(new_n70_), .O(z09));
  ...
  nand2  g060(.a(new_n74_), .b(new_n73_), .O(new_n123_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n126_), .c(new_n70_), .O(z10));
  ...
  nand4  g073(.a(new_n135_), .b(x35), .c(new_n131_), .d(x27), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n82_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n73_), .c(new_n129_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n70_), .O(z11));
  nand3  g078(.a(new_n92_), .b(new_n76_), .c(new_n75_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  nand2  g080(.a(new_n89_), .b(new_n92_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(new_n118_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n142_), .c(x40), .O(new_n145_));
  oai21  g083(.a(new_n64_), .b(new_n91_), .c(new_n114_), .O(new_n146_));
  ...
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n118_), .O(new_n151_));
  ...
  nand3  g094(.a(new_n123_), .b(new_n148_), .c(new_n118_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(x40), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x39), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n156_), .O(z13));
  nand2  g098(.a(x40), .b(x04), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(x39), .c(new_n148_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n89_), .O(new_n163_));
  nand4  g101(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n92_), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n167_));
  nand4  g105(.a(new_n149_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(x39), .c(new_n148_), .d(new_n118_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  oai21  g108(.a(x27), .b(new_n148_), .c(x40), .O(new_n171_));
  nand3  g109(.a(new_n161_), .b(new_n123_), .c(x39), .O(new_n172_));
  aoi22  g110(.a(new_n172_), .b(new_n91_), .c(new_n171_), .d(x39), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n170_), .c(new_n166_), .O(z14));
  ...
  nor2   g121(.a(new_n75_), .b(x28), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n91_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n130_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n91_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n184_), .c(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n70_), .d(new_n73_), .O(z18));
  inv1   g128(.a(new_n130_), .O(new_n191_));
  oai21  g129(.a(new_n75_), .b(new_n91_), .c(new_n82_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n91_), .c(new_n75_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n73_), .c(new_n129_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n70_), .O(z20));
  nand2  g134(.a(new_n139_), .b(new_n70_), .O(z19));
endmodule
