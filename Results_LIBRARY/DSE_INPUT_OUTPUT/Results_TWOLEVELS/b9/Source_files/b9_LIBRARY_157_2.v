...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n187_, new_n189_, new_n190_, new_n191_, new_n192_, new_n195_,
  ...
  nand4  g008(.a(new_n70_), .b(x40), .c(x39), .d(new_n63_), .O(new_n71_));
  ...
  nand3  g036(.a(new_n87_), .b(new_n72_), .c(new_n98_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n97_), .c(new_n87_), .d(x21), .O(z03));
  inv1   g038(.a(x21), .O(new_n101_));
  nand4  g039(.a(new_n99_), .b(new_n97_), .c(new_n87_), .d(new_n101_), .O(z04));
  nand2  g040(.a(x28), .b(x27), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n87_), .c(new_n72_), .O(z05));
  inv1   g042(.a(x10), .O(new_n105_));
  oai22  g043(.a(x40), .b(new_n105_), .c(new_n81_), .d(new_n98_), .O(new_n106_));
  ...
  nand2  g057(.a(new_n119_), .b(new_n87_), .O(z08));
  nand4  g058(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n121_));
  nand2  g059(.a(new_n121_), .b(new_n87_), .O(z09));
  inv1   g060(.a(x07), .O(new_n123_));
  inv1   g061(.a(x39), .O(new_n124_));
  aoi21  g062(.a(x40), .b(new_n124_), .c(new_n94_), .O(new_n125_));
  nand3  g063(.a(x40), .b(x39), .c(x05), .O(new_n126_));
  oai21  g064(.a(new_n125_), .b(new_n123_), .c(new_n126_), .O(new_n127_));
  nand3  g065(.a(new_n127_), .b(new_n83_), .c(new_n63_), .O(new_n128_));
  nand3  g066(.a(new_n87_), .b(x37), .c(x06), .O(new_n129_));
  ...
  nand2  g075(.a(new_n87_), .b(new_n98_), .O(new_n138_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n142_), .c(x40), .O(new_n143_));
  ...
  nor2   g085(.a(new_n75_), .b(new_n98_), .O(new_n148_));
  nand2  g086(.a(x39), .b(new_n63_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x40), .c(new_n94_), .O(new_n150_));
  nor2   g088(.a(x37), .b(x36), .O(new_n151_));
  aoi22  g089(.a(new_n151_), .b(new_n68_), .c(x40), .d(new_n98_), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(x10), .c(new_n150_), .d(new_n148_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n86_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n154_), .d(new_n63_), .O(new_n157_));
  inv1   g095(.a(x18), .O(new_n158_));
  inv1   g096(.a(x19), .O(new_n159_));
  nand4  g097(.a(new_n74_), .b(x20), .c(new_n159_), .d(new_n158_), .O(new_n160_));
  ...
  nand2  g101(.a(new_n163_), .b(new_n63_), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(new_n162_), .c(new_n87_), .O(z13));
  nand3  g103(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n166_));
  nand4  g104(.a(new_n155_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x39), .b(new_n154_), .c(new_n63_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n86_), .O(new_n170_));
  ...
  oai21  g112(.a(new_n169_), .b(new_n148_), .c(new_n174_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nor2   g114(.a(new_n148_), .b(x40), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n105_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n176_), .c(new_n171_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nand4  g118(.a(new_n87_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n180_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(x22), .c(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n87_), .O(z16));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(x23), .c(x22), .d(x01), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n87_), .O(z17));
  oai22  g126(.a(new_n119_), .b(new_n142_), .c(new_n82_), .d(x27), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n98_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n141_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n87_), .d(new_n79_), .O(z18));
  oai21  g131(.a(new_n146_), .b(x09), .c(new_n87_), .O(z19));
  aoi21  g132(.a(x28), .b(new_n98_), .c(new_n68_), .O(new_n195_));
  aoi21  g133(.a(new_n143_), .b(new_n95_), .c(new_n195_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n68_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n138_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n79_), .O(new_n199_));
