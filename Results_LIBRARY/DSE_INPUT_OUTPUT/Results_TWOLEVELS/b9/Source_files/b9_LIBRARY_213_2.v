...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x18), .O(new_n81_));
  ...
  nor2   g075(.a(x40), .b(x18), .O(new_n138_));
  ...
  oai21  g079(.a(new_n141_), .b(new_n135_), .c(new_n83_), .O(new_n142_));
  ...
  nand4  g094(.a(new_n72_), .b(x20), .c(new_n156_), .d(new_n148_), .O(new_n157_));
  ...
  nor2   g101(.a(new_n138_), .b(x13), .O(new_n164_));
  aoi22  g102(.a(new_n164_), .b(new_n163_), .c(x35), .d(x28), .O(new_n165_));
  nand4  g103(.a(new_n66_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(new_n70_), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n156_), .c(new_n148_), .O(new_n169_));
  nand4  g107(.a(new_n153_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  nand4  g109(.a(x40), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n171_), .c(new_n169_), .O(new_n173_));
  nand3  g111(.a(x39), .b(new_n152_), .c(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x40), .O(new_n175_));
  nor2   g113(.a(new_n138_), .b(new_n125_), .O(new_n176_));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n136_), .c(x09), .O(new_n192_));
  ...
  nand2  g133(.a(new_n195_), .b(new_n148_), .O(new_n196_));
  ...
  nand3  g137(.a(new_n188_), .b(x28), .c(new_n64_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n199_), .c(new_n196_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n83_), .c(new_n194_), .O(new_n202_));
