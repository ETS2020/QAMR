...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x26), .O(new_n64_));
  ...
  oai22  g044(.a(x40), .b(new_n94_), .c(new_n81_), .d(new_n100_), .O(new_n107_));
  ...
  nor2   g060(.a(new_n122_), .b(new_n63_), .O(z09));
  ...
  nor2   g069(.a(new_n65_), .b(new_n100_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n97_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n64_), .d(new_n100_), .O(new_n137_));
  ...
  nand3  g079(.a(new_n141_), .b(x35), .c(new_n81_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  oai21  g081(.a(new_n137_), .b(x08), .c(new_n143_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n78_), .c(new_n135_), .O(new_n145_));
  ...
  nor2   g087(.a(x40), .b(x26), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n71_), .c(new_n63_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n68_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n149_), .c(new_n64_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n63_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x39), .c(new_n154_), .d(new_n71_), .O(new_n157_));
  ...
  nand3  g100(.a(new_n128_), .b(x40), .c(x39), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n71_), .c(new_n97_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(z13));
  nand3  g104(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n167_));
  nand4  g105(.a(new_n155_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n168_));
  nand3  g106(.a(x39), .b(new_n154_), .c(new_n71_), .O(new_n169_));
  ...
  nand2  g114(.a(new_n169_), .b(new_n68_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x40), .O(new_n179_));
  nand3  g117(.a(new_n68_), .b(new_n63_), .c(new_n94_), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(new_n179_), .c(new_n172_), .O(z14));
  nand4  g119(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(new_n63_), .O(z15));
  ...
  nand2  g128(.a(x27), .b(new_n71_), .O(new_n191_));
  nand2  g129(.a(new_n100_), .b(x08), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n173_), .O(new_n193_));
  nand2  g131(.a(new_n78_), .b(new_n135_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n81_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n97_), .c(new_n120_), .d(new_n88_), .O(z18));
  inv1   g134(.a(new_n145_), .O(z19));
  nand2  g135(.a(x28), .b(new_n100_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n139_), .d(new_n95_), .O(new_n199_));
  nand2  g137(.a(new_n64_), .b(new_n100_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n173_), .O(new_n201_));
