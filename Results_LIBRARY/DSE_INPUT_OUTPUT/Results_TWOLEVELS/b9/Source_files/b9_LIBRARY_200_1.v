...
module FAU ( 
  ...
  nand4  g016(.a(new_n78_), .b(x39), .c(new_n72_), .d(x07), .O(new_n79_));
  oai21  g017(.a(new_n79_), .b(x04), .c(new_n71_), .O(z00));
  ...
  nand2  g023(.a(new_n85_), .b(new_n75_), .O(new_n86_));
  ...
  oai21  g031(.a(new_n93_), .b(new_n90_), .c(x07), .O(new_n94_));
  inv1   g032(.a(x18), .O(new_n95_));
  inv1   g033(.a(x19), .O(new_n96_));
  inv1   g034(.a(new_n67_), .O(new_n97_));
  ...
  aoi21  g043(.a(new_n66_), .b(new_n105_), .c(new_n104_), .O(new_n106_));
  aoi21  g044(.a(new_n106_), .b(new_n103_), .c(new_n81_), .O(z03));
  nand2  g045(.a(new_n66_), .b(new_n105_), .O(new_n108_));
  nand4  g046(.a(new_n108_), .b(new_n103_), .c(new_n65_), .d(new_n104_), .O(z04));
  nand2  g047(.a(x28), .b(x27), .O(new_n110_));
  nand3  g048(.a(new_n110_), .b(new_n65_), .c(new_n66_), .O(z05));
  aoi21  g049(.a(new_n65_), .b(new_n105_), .c(new_n84_), .O(new_n112_));
  ...
  nand2  g061(.a(new_n123_), .b(new_n65_), .O(z07));
  nand3  g062(.a(x40), .b(x39), .c(x07), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(z08));
  inv1   g064(.a(x11), .O(new_n127_));
  nand4  g065(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n86_), .c(new_n130_), .O(new_n135_));
  nand2  g073(.a(x37), .b(x06), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n135_), .c(new_n64_), .O(new_n137_));
  nand3  g075(.a(new_n73_), .b(x37), .c(x06), .O(new_n138_));
  ...
  nor2   g080(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(x07), .c(x05), .d(new_n130_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n140_), .O(z10));
  nand2  g083(.a(new_n65_), .b(new_n105_), .O(new_n146_));
  nand3  g084(.a(x35), .b(new_n84_), .c(new_n130_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(x07), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n146_), .c(x08), .O(new_n149_));
  inv1   g087(.a(new_n85_), .O(new_n150_));
  nand2  g088(.a(x39), .b(x29), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x07), .c(new_n73_), .O(new_n152_));
  nand2  g090(.a(x27), .b(x04), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(new_n152_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n149_), .c(new_n82_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x09), .O(z11));
  aoi21  g094(.a(x10), .b(new_n130_), .c(new_n64_), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n132_), .c(new_n105_), .O(new_n158_));
  aoi21  g096(.a(new_n133_), .b(new_n130_), .c(new_n97_), .O(new_n159_));
  nor2   g097(.a(new_n76_), .b(x10), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n159_), .c(new_n66_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n158_), .c(new_n65_), .O(z12));
  inv1   g100(.a(x13), .O(new_n163_));
  nand2  g101(.a(x36), .b(x35), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(x28), .c(new_n73_), .O(new_n165_));
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n163_), .d(new_n130_), .O(new_n166_));
  nand4  g104(.a(new_n68_), .b(x20), .c(new_n96_), .d(new_n95_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n166_), .c(new_n64_), .O(new_n168_));
  nand4  g106(.a(new_n68_), .b(new_n73_), .c(x20), .d(new_n96_), .O(new_n169_));
  nor2   g107(.a(new_n169_), .b(x18), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n168_), .c(x27), .O(new_n171_));
  nand4  g109(.a(new_n143_), .b(new_n163_), .c(x07), .d(new_n130_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n171_), .O(z13));
  nand3  g111(.a(x20), .b(new_n96_), .c(new_n95_), .O(new_n174_));
  nand2  g112(.a(new_n163_), .b(new_n130_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x07), .O(new_n176_));
  nand4  g114(.a(new_n164_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n176_), .c(new_n133_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n174_), .O(new_n179_));
  nand3  g117(.a(new_n66_), .b(new_n74_), .c(x28), .O(new_n180_));
  oai21  g118(.a(x27), .b(new_n64_), .c(new_n180_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n83_), .c(new_n82_), .O(new_n182_));
  oai21  g120(.a(x27), .b(new_n64_), .c(new_n68_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n175_), .O(new_n184_));
  aoi21  g122(.a(new_n132_), .b(new_n69_), .c(new_n81_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n182_), .d(new_n179_), .O(z14));
  inv1   g124(.a(x12), .O(new_n187_));
  nor2   g125(.a(new_n128_), .b(new_n187_), .O(z15));
  ...
  oai22  g134(.a(new_n132_), .b(new_n196_), .c(new_n85_), .d(x27), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(x08), .O(new_n198_));
  nor2   g136(.a(new_n81_), .b(x09), .O(new_n199_));
  nor2   g137(.a(new_n105_), .b(x04), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n150_), .c(x30), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n199_), .c(new_n198_), .O(z18));
  oai21  g140(.a(new_n155_), .b(x09), .c(new_n65_), .O(z19));
  aoi21  g141(.a(x28), .b(new_n105_), .c(new_n74_), .O(new_n204_));
  nor2   g142(.a(new_n204_), .b(new_n152_), .O(new_n205_));
  oai21  g143(.a(new_n74_), .b(new_n105_), .c(x07), .O(new_n206_));
  nand2  g144(.a(new_n73_), .b(new_n105_), .O(new_n207_));
  aoi21  g145(.a(new_n207_), .b(new_n206_), .c(x08), .O(new_n208_));
  oai21  g146(.a(new_n208_), .b(new_n205_), .c(new_n82_), .O(new_n209_));
