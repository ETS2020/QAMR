...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x17), .O(new_n81_));
  ...
  nor2   g034(.a(x40), .b(x17), .O(new_n97_));
  ...
  aoi21  g066(.a(x40), .b(new_n75_), .c(new_n97_), .O(new_n129_));
  ...
  oai22  g091(.a(new_n73_), .b(new_n64_), .c(new_n75_), .d(x04), .O(new_n154_));
  oai21  g092(.a(x28), .b(x17), .c(x35), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n70_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(x27), .c(new_n108_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n76_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n154_), .c(new_n153_), .O(z12));
  ...
  nor2   g105(.a(new_n166_), .b(x17), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n167_), .c(x27), .O(new_n169_));
  nand3  g107(.a(new_n137_), .b(new_n160_), .c(new_n65_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(z13));
  oai21  g109(.a(new_n136_), .b(x13), .c(x40), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n77_), .c(new_n65_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n64_), .O(new_n174_));
  nand3  g112(.a(x20), .b(new_n165_), .c(new_n164_), .O(new_n175_));
  nand4  g113(.a(new_n161_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n77_), .c(new_n160_), .d(new_n65_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  nand3  g116(.a(x39), .b(new_n160_), .c(new_n65_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n71_), .O(new_n180_));
  nand2  g118(.a(new_n136_), .b(x28), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n66_), .O(new_n183_));
  nand3  g121(.a(new_n76_), .b(new_n86_), .c(new_n108_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n183_), .c(new_n180_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n70_), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n178_), .c(new_n174_), .d(new_n81_), .O(z14));
  inv1   g125(.a(x12), .O(new_n188_));
  nor2   g126(.a(new_n126_), .b(new_n188_), .O(z15));
