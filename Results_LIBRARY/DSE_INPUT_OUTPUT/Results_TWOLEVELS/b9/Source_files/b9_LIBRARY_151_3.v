...
module FAU ( 
  ...
  aoi21  g06(.a(new_n68_), .b(x16), .c(z08), .O(z00));
  ...
  nand2  g41(.a(new_n103_), .b(z02), .O(z09));
  ...
  inv1   g52(.a(x27), .O(new_n115_));
  nand2  g53(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g54(.a(new_n116_), .b(new_n113_), .c(x35), .d(new_n112_), .O(new_n117_));
  nand4  g55(.a(new_n117_), .b(z02), .c(new_n70_), .d(new_n111_), .O(new_n118_));
  inv1   g56(.a(new_n118_), .O(z11));
  nand3  g57(.a(new_n67_), .b(z02), .c(x27), .O(z12));
  nand4  g58(.a(new_n67_), .b(z02), .c(x27), .d(x20), .O(new_n121_));
  nor3   g59(.a(new_n121_), .b(x19), .c(x18), .O(z13));
  inv1   g60(.a(x19), .O(new_n123_));
  nand2  g61(.a(x20), .b(new_n123_), .O(new_n124_));
  nor3   g62(.a(new_n124_), .b(new_n66_), .c(x18), .O(new_n125_));
  aoi21  g63(.a(new_n125_), .b(x27), .c(z08), .O(z14));
  inv1   g64(.a(x12), .O(new_n127_));
  nand4  g65(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n128_));
  nor2   g66(.a(new_n128_), .b(new_n127_), .O(z15));
  inv1   g67(.a(x23), .O(new_n130_));
  nand4  g68(.a(z02), .b(new_n130_), .c(x22), .d(x01), .O(new_n131_));
  inv1   g69(.a(new_n131_), .O(z16));
  inv1   g70(.a(x01), .O(new_n133_));
  inv1   g71(.a(x24), .O(new_n134_));
  nand4  g72(.a(z02), .b(new_n134_), .c(x23), .d(x22), .O(new_n135_));
  nor2   g73(.a(new_n135_), .b(new_n133_), .O(z17));
  nand2  g74(.a(x27), .b(new_n105_), .O(new_n137_));
  oai21  g75(.a(x27), .b(new_n114_), .c(new_n137_), .O(new_n138_));
  nand3  g76(.a(new_n138_), .b(x35), .c(new_n112_), .O(new_n139_));
  nor2   g77(.a(x30), .b(x09), .O(new_n140_));
  aoi21  g78(.a(new_n140_), .b(new_n139_), .c(z08), .O(z18));
  oai21  g79(.a(x28), .b(new_n114_), .c(new_n115_), .O(new_n142_));
  nand2  g80(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g81(.a(new_n143_), .b(z02), .c(new_n70_), .d(new_n111_), .O(new_n144_));
  inv1   g82(.a(new_n144_), .O(z20));
  inv1   g83(.a(new_n118_), .O(z19));
endmodule
