...
module FAU ( 
  ...
  nand2  g040(.a(new_n64_), .b(new_n91_), .O(new_n103_));
  ...
  aoi21  g074(.a(new_n136_), .b(new_n103_), .c(x08), .O(new_n137_));
  inv1   g075(.a(x35), .O(new_n138_));
  nor2   g076(.a(new_n138_), .b(x28), .O(new_n139_));
  nor2   g077(.a(x40), .b(x38), .O(new_n140_));
  nand2  g078(.a(x39), .b(x29), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n140_), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(new_n139_), .c(new_n142_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n137_), .c(new_n78_), .O(new_n145_));
  ...
  oai21  g088(.a(new_n150_), .b(new_n140_), .c(new_n68_), .O(new_n151_));
  ...
  nand4  g098(.a(new_n67_), .b(new_n104_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n129_), .b(new_n153_), .c(new_n71_), .O(new_n164_));
  ...
  oai21  g108(.a(new_n170_), .b(new_n140_), .c(new_n166_), .O(new_n171_));
  nand3  g109(.a(new_n65_), .b(new_n138_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n79_), .c(new_n78_), .O(new_n174_));
  nand2  g112(.a(new_n168_), .b(new_n68_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  nand3  g115(.a(new_n68_), .b(new_n63_), .c(new_n104_), .O(new_n178_));
  ...
  nand2  g126(.a(x27), .b(new_n71_), .O(new_n189_));
  nand2  g127(.a(new_n91_), .b(x08), .O(new_n190_));
  ...
  aoi21  g131(.a(new_n191_), .b(new_n81_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n94_), .c(new_n118_), .d(new_n88_), .O(z18));
  oai22  g133(.a(new_n63_), .b(x35), .c(new_n81_), .d(x27), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n141_), .O(new_n197_));
  nor2   g135(.a(new_n63_), .b(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n140_), .c(new_n138_), .O(new_n199_));
  aoi21  g137(.a(new_n63_), .b(x38), .c(x08), .O(new_n200_));
  nor2   g138(.a(x40), .b(new_n81_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n91_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n199_), .c(new_n197_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n78_), .c(new_n192_), .O(new_n204_));
