...
module FAU ( 
  ...
  oai21  g028(.a(x08), .b(new_n73_), .c(x39), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(new_n68_), .O(new_n92_));
  nand2  g030(.a(new_n83_), .b(x04), .O(new_n93_));
  inv1   g031(.a(x39), .O(new_n94_));
  inv1   g032(.a(x09), .O(new_n95_));
  nand4  g033(.a(new_n79_), .b(new_n82_), .c(new_n68_), .d(new_n95_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n94_), .c(new_n65_), .O(new_n97_));
  ...
  aoi21  g072(.a(x40), .b(new_n134_), .c(new_n94_), .O(new_n135_));
  ...
  nand3  g076(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n139_));
  ...
  nand4  g096(.a(new_n156_), .b(new_n94_), .c(x20), .d(new_n155_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  aoi21  g099(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n162_));
  nand4  g100(.a(new_n162_), .b(x39), .c(new_n150_), .d(new_n73_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n161_), .O(z13));
  inv1   g102(.a(new_n71_), .O(new_n165_));
  nand2  g103(.a(x40), .b(x04), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(x39), .c(new_n150_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n169_));
  nand4  g107(.a(new_n151_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x39), .c(new_n150_), .d(new_n73_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand3  g110(.a(new_n69_), .b(new_n144_), .c(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x27), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n80_), .c(new_n79_), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n172_), .c(new_n168_), .d(new_n64_), .O(z14));
  ...
  nand2  g126(.a(new_n79_), .b(new_n95_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n82_), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(x40), .b(x39), .O(new_n191_));
  oai22  g129(.a(new_n191_), .b(new_n89_), .c(new_n190_), .d(new_n65_), .O(z18));
  aoi21  g130(.a(new_n63_), .b(x39), .c(x08), .O(new_n193_));
  aoi21  g131(.a(x39), .b(x29), .c(new_n82_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(new_n68_), .O(new_n195_));
  nand2  g133(.a(new_n89_), .b(x40), .O(new_n196_));
  ...
  nand3  g137(.a(new_n199_), .b(new_n79_), .c(new_n95_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n64_), .O(z20));
  buf    g139(.a(x39), .O(z08));
