...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x14), .O(new_n81_));
  ...
  nand3  g033(.a(new_n95_), .b(new_n93_), .c(new_n77_), .O(z02));
  ...
  nand2  g058(.a(new_n81_), .b(new_n120_), .O(z08));
  ...
  nor2   g063(.a(x40), .b(x14), .O(new_n126_));
  ...
  oai21  g084(.a(new_n146_), .b(x09), .c(new_n81_), .O(z11));
  ...
  oai21  g089(.a(new_n120_), .b(x04), .c(new_n151_), .O(new_n152_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n157_), .c(new_n76_), .O(new_n161_));
  nor2   g099(.a(new_n160_), .b(x14), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n161_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n135_), .b(new_n154_), .c(new_n65_), .O(new_n164_));
  ...
  nand3  g106(.a(new_n77_), .b(new_n154_), .c(new_n65_), .O(new_n169_));
  ...
  aoi21  g111(.a(new_n169_), .b(new_n151_), .c(new_n97_), .O(new_n174_));
  ...
  oai22  g128(.a(new_n190_), .b(new_n97_), .c(new_n92_), .d(new_n120_), .O(z18));
  nor2   g129(.a(new_n146_), .b(x09), .O(z19));
  nor2   g130(.a(x40), .b(x35), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n94_), .c(new_n113_), .O(new_n194_));
  ...
  nand2  g135(.a(new_n77_), .b(x29), .O(new_n198_));
