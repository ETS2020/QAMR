...
module FAU ( 
  ...
  nor2   g015(.a(x40), .b(x26), .O(new_n78_));
  ...
  nand2  g032(.a(new_n94_), .b(x26), .O(new_n95_));
  ...
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n78_), .O(z04));
  ...
  nand2  g055(.a(new_n79_), .b(new_n117_), .O(z08));
  ...
  aoi21  g061(.a(new_n123_), .b(new_n95_), .c(new_n121_), .O(new_n124_));
  ...
  nand2  g074(.a(new_n79_), .b(new_n64_), .O(new_n137_));
  ...
  oai21  g079(.a(new_n122_), .b(new_n141_), .c(x40), .O(new_n142_));
  ...
  nor2   g101(.a(new_n133_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n65_), .c(new_n78_), .O(new_n165_));
  ...
  nand4  g106(.a(new_n156_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n169_));
  nand3  g107(.a(x39), .b(new_n155_), .c(new_n65_), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n94_), .O(new_n172_));
  ...
  oai22  g126(.a(new_n84_), .b(x27), .c(new_n117_), .d(new_n141_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  nor2   g128(.a(new_n64_), .b(x04), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n140_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n79_), .d(new_n81_), .O(z18));
  oai21  g131(.a(new_n145_), .b(x09), .c(new_n79_), .O(z19));
  aoi21  g132(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n195_));
  aoi21  g133(.a(new_n142_), .b(new_n95_), .c(new_n195_), .O(new_n196_));
  nand2  g134(.a(x40), .b(new_n66_), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n137_), .c(x08), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n81_), .O(new_n199_));
