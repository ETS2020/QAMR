...
module FAU ( 
  ...
  oai21  g029(.a(x35), .b(new_n63_), .c(new_n82_), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n91_), .c(x04), .O(new_n93_));
  inv1   g031(.a(x39), .O(new_n94_));
  nor2   g032(.a(new_n65_), .b(new_n94_), .O(new_n95_));
  ...
  aoi21  g055(.a(new_n94_), .b(x23), .c(new_n74_), .O(z08));
  ...
  nand4  g061(.a(x40), .b(x39), .c(x23), .d(x05), .O(new_n124_));
  ...
  nor3   g068(.a(new_n130_), .b(new_n94_), .c(new_n63_), .O(new_n131_));
  ...
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(x23), .O(new_n149_));
  ...
  nand3  g101(.a(new_n131_), .b(new_n152_), .c(new_n122_), .O(new_n164_));
  ...
  nand3  g105(.a(x39), .b(new_n152_), .c(new_n122_), .O(new_n168_));
  ...
  aoi21  g118(.a(new_n180_), .b(new_n74_), .c(x23), .O(z16));
  inv1   g119(.a(x24), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x23), .O(new_n183_));
  oai21  g121(.a(new_n183_), .b(new_n180_), .c(new_n64_), .O(z17));
  ...
  oai21  g132(.a(new_n145_), .b(new_n68_), .c(x23), .O(new_n195_));
