...
module FAU ( 
  ...
  aoi21  g040(.a(new_n63_), .b(new_n96_), .c(new_n83_), .O(new_n103_));
  ...
  aoi21  g054(.a(new_n116_), .b(new_n73_), .c(new_n75_), .O(z08));
  ...
  nand2  g072(.a(x35), .b(x27), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n73_), .O(new_n136_));
  nand2  g074(.a(new_n75_), .b(new_n96_), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(new_n136_), .c(new_n83_), .d(new_n121_), .O(new_n138_));
  ...
  nand3  g081(.a(new_n143_), .b(new_n141_), .c(new_n83_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n140_), .O(new_n145_));
  nand3  g083(.a(new_n141_), .b(x35), .c(new_n83_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n75_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n139_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n80_), .c(new_n133_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n63_), .O(z11));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n96_), .c(new_n74_), .O(new_n152_));
  oai21  g090(.a(new_n122_), .b(x04), .c(new_n70_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n152_), .c(new_n63_), .O(z12));
  ...
  nand4  g101(.a(new_n127_), .b(x39), .c(new_n155_), .d(new_n121_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n73_), .O(new_n165_));
  ...
  inv1   g108(.a(new_n122_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n155_), .c(new_n121_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(new_n168_), .O(new_n173_));
  nand3  g111(.a(new_n67_), .b(new_n142_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n81_), .c(new_n80_), .O(new_n176_));
  aoi21  g114(.a(new_n172_), .b(new_n70_), .c(new_n64_), .O(new_n177_));
  ...
  nand4  g121(.a(new_n73_), .b(x23), .c(x22), .d(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n63_), .O(z17));
  nand2  g123(.a(x27), .b(new_n121_), .O(new_n186_));
  nand2  g124(.a(new_n96_), .b(x08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n142_), .O(new_n188_));
  nand2  g126(.a(new_n80_), .b(new_n133_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n83_), .c(new_n189_), .O(new_n190_));
  nand4  g128(.a(new_n171_), .b(x29), .c(new_n73_), .d(x08), .O(new_n191_));
  oai21  g129(.a(new_n190_), .b(new_n64_), .c(new_n191_), .O(z18));
  aoi21  g130(.a(x28), .b(new_n96_), .c(new_n142_), .O(new_n193_));
  aoi21  g131(.a(new_n140_), .b(new_n73_), .c(new_n75_), .O(new_n194_));
  nand2  g132(.a(new_n137_), .b(new_n136_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n134_), .O(new_n196_));
  oai21  g134(.a(new_n194_), .b(new_n193_), .c(new_n196_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n80_), .c(new_n133_), .O(new_n198_));
  inv1   g136(.a(new_n198_), .O(z20));
  nand2  g137(.a(new_n149_), .b(new_n63_), .O(z19));
endmodule
