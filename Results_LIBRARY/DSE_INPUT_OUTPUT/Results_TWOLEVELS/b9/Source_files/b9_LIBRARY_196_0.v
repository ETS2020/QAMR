...
module FAU ( 
  ...
  aoi21  g039(.a(new_n66_), .b(new_n98_), .c(x21), .O(new_n102_));
  ...
  oai22  g043(.a(x40), .b(x26), .c(new_n82_), .d(new_n98_), .O(new_n106_));
  ...
  nor2   g068(.a(new_n66_), .b(new_n98_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n101_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n65_), .d(new_n98_), .O(new_n136_));
  ...
  nand2  g085(.a(x39), .b(new_n72_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n69_), .O(new_n149_));
  nand2  g087(.a(new_n82_), .b(x26), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x35), .c(x37), .O(new_n151_));
  nand2  g089(.a(x27), .b(x26), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n64_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n149_), .c(new_n147_), .O(z12));
  ...
  nand3  g101(.a(new_n127_), .b(x40), .c(x39), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x13), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n72_), .c(new_n101_), .O(new_n166_));
  ...
  nand4  g107(.a(new_n169_), .b(z08), .c(new_n155_), .d(new_n72_), .O(new_n170_));
  ...
  nand3  g113(.a(x39), .b(new_n155_), .c(new_n72_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n69_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n175_), .c(new_n171_), .d(new_n153_), .O(z14));
  ...
  nand2  g125(.a(x27), .b(new_n72_), .O(new_n188_));
  nand2  g126(.a(new_n98_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n172_), .O(new_n190_));
  nand2  g128(.a(new_n79_), .b(new_n134_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n82_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n101_), .c(new_n119_), .d(new_n89_), .O(z18));
  inv1   g131(.a(new_n144_), .O(z19));
  nand2  g132(.a(x28), .b(new_n98_), .O(new_n195_));
  aoi22  g133(.a(new_n195_), .b(x35), .c(new_n138_), .d(new_n95_), .O(new_n196_));
  nand2  g134(.a(new_n65_), .b(new_n98_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n172_), .O(new_n198_));
