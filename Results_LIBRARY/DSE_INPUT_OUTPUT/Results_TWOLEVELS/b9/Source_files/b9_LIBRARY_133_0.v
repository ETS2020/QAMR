...
module FAU ( 
  ...
  aoi21  g044(.a(new_n82_), .b(new_n64_), .c(new_n87_), .O(new_n107_));
  ...
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n82_), .d(new_n64_), .O(new_n138_));
  nand2  g076(.a(x40), .b(x29), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x39), .O(new_n140_));
  nand2  g078(.a(x40), .b(new_n80_), .O(new_n141_));
  ...
  nand2  g092(.a(new_n81_), .b(x39), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(new_n153_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n152_), .c(new_n82_), .O(z12));
  inv1   g096(.a(x13), .O(new_n159_));
  nand2  g097(.a(x36), .b(x35), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x28), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x40), .c(new_n159_), .d(new_n65_), .O(new_n162_));
  ...
  nand4  g104(.a(new_n72_), .b(x40), .c(x20), .d(new_n164_), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(x18), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n166_), .c(x27), .O(new_n169_));
  nand3  g107(.a(new_n129_), .b(new_n159_), .c(new_n65_), .O(new_n170_));
  ...
  aoi21  g113(.a(new_n175_), .b(new_n173_), .c(new_n81_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n156_), .c(new_n172_), .O(new_n177_));
  nand2  g115(.a(x39), .b(new_n64_), .O(new_n178_));
  nand4  g116(.a(x40), .b(new_n70_), .c(new_n66_), .d(x28), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(x32), .O(new_n180_));
  oai21  g118(.a(new_n175_), .b(new_n81_), .c(new_n155_), .O(new_n181_));
  aoi22  g119(.a(new_n181_), .b(new_n153_), .c(new_n180_), .d(new_n85_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n177_), .O(z14));
  ...
  inv1   g130(.a(x29), .O(new_n193_));
  oai22  g131(.a(new_n88_), .b(x27), .c(new_n75_), .d(new_n193_), .O(new_n194_));
  ...
  oai22  g138(.a(new_n80_), .b(x35), .c(new_n87_), .d(x27), .O(new_n201_));
  nand2  g139(.a(new_n201_), .b(new_n139_), .O(new_n202_));
  oai21  g140(.a(new_n80_), .b(x08), .c(new_n141_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n66_), .O(new_n204_));
  nor2   g142(.a(new_n84_), .b(x08), .O(new_n205_));
  nor2   g143(.a(x39), .b(new_n87_), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n205_), .c(new_n64_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n204_), .c(new_n202_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n85_), .c(new_n136_), .O(new_n209_));
