...
module FAU ( 
  ...
  oai21  g032(.a(new_n81_), .b(x35), .c(new_n94_), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n93_), .c(x04), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n92_), .c(new_n76_), .O(z02));
  ...
  nand4  g041(.a(new_n103_), .b(new_n99_), .c(new_n82_), .d(new_n100_), .O(z04));
  ...
  nor2   g066(.a(new_n128_), .b(new_n80_), .O(new_n129_));
  ...
  nand3  g073(.a(x35), .b(new_n94_), .c(new_n65_), .O(new_n136_));
  ...
  nand2  g079(.a(x40), .b(new_n80_), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi22  g081(.a(new_n143_), .b(new_n139_), .c(new_n142_), .d(new_n141_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n138_), .c(new_n84_), .O(new_n145_));
  ...
  aoi21  g088(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n151_));
  nor2   g089(.a(x40), .b(new_n80_), .O(new_n152_));
  ...
  nand4  g095(.a(new_n157_), .b(x40), .c(new_n155_), .d(new_n65_), .O(new_n158_));
  ...
  nand4  g100(.a(new_n72_), .b(x40), .c(x20), .d(new_n160_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n129_), .b(new_n155_), .c(new_n65_), .O(new_n166_));
  ...
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n81_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n152_), .c(new_n168_), .O(new_n173_));
  ...
  nand2  g114(.a(new_n170_), .b(new_n150_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x40), .O(new_n179_));
  nand3  g117(.a(new_n150_), .b(new_n81_), .c(x39), .O(new_n180_));
  ...
  nand4  g126(.a(new_n82_), .b(new_n188_), .c(x23), .d(x22), .O(new_n189_));
  ...
  aoi21  g133(.a(new_n193_), .b(new_n94_), .c(new_n195_), .O(new_n196_));
  oai22  g134(.a(new_n196_), .b(new_n98_), .c(new_n91_), .d(new_n75_), .O(z18));
  nand2  g135(.a(x28), .b(new_n64_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n142_), .d(new_n141_), .O(new_n199_));
  nand2  g137(.a(x39), .b(new_n66_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n135_), .c(x08), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n199_), .c(new_n84_), .O(new_n202_));
  nor2   g140(.a(new_n202_), .b(x09), .O(z20));
  nor2   g141(.a(new_n145_), .b(x09), .O(z19));
endmodule
