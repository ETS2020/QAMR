// Benchmark "FAU" written by ABC on Tue Aug 18 17:26:49 2020
...
module FAU ( 
  ...
  aoi21  g033(.a(new_n67_), .b(new_n91_), .c(new_n95_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n94_), .c(new_n79_), .O(z03));
  nand2  g035(.a(new_n67_), .b(new_n91_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n94_), .c(new_n65_), .d(new_n95_), .O(z04));
  aoi21  g037(.a(x28), .b(x27), .c(x37), .O(new_n100_));
  nor2   g038(.a(new_n100_), .b(new_n79_), .O(z05));
  inv1   g039(.a(x28), .O(new_n102_));
  aoi21  g040(.a(new_n65_), .b(new_n91_), .c(new_n102_), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(x37), .c(new_n65_), .O(z06));
  ...
  nor3   g064(.a(new_n79_), .b(new_n67_), .c(new_n126_), .O(new_n127_));
  aoi21  g065(.a(new_n125_), .b(new_n73_), .c(new_n127_), .O(new_n128_));
  oai21  g066(.a(x32), .b(x30), .c(x40), .O(new_n129_));
  nor2   g067(.a(new_n129_), .b(new_n63_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x05), .c(new_n73_), .O(new_n131_));
  oai21  g069(.a(new_n128_), .b(new_n91_), .c(new_n131_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n102_), .c(new_n73_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x39), .c(new_n65_), .d(new_n91_), .O(new_n135_));
  nand2  g073(.a(x40), .b(new_n63_), .O(new_n136_));
  ...
  nand3  g078(.a(new_n140_), .b(x35), .c(new_n102_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  oai21  g080(.a(new_n135_), .b(x08), .c(new_n142_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n80_), .c(new_n133_), .O(new_n144_));
  inv1   g082(.a(new_n144_), .O(z11));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  nor2   g084(.a(new_n64_), .b(x27), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n74_), .O(new_n148_));
  nand2  g086(.a(x39), .b(new_n102_), .O(new_n149_));
  nand2  g087(.a(x40), .b(new_n82_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n149_), .c(new_n73_), .O(new_n151_));
  and2   g089(.a(new_n122_), .b(new_n68_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n67_), .O(new_n153_));
  aoi21  g091(.a(x40), .b(x27), .c(x39), .O(new_n154_));
  nand2  g092(.a(x40), .b(x04), .O(new_n155_));
  oai21  g093(.a(x40), .b(new_n63_), .c(new_n155_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n91_), .c(new_n154_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n153_), .c(new_n148_), .O(z12));
  ...
  nand3  g107(.a(new_n130_), .b(new_n159_), .c(new_n73_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(z13));
  nand3  g109(.a(x20), .b(new_n164_), .c(new_n163_), .O(new_n172_));
  oai22  g110(.a(new_n64_), .b(x35), .c(new_n63_), .d(x36), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n174_));
  nor2   g112(.a(x40), .b(new_n63_), .O(new_n175_));
  nand3  g113(.a(x39), .b(new_n159_), .c(new_n73_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(x40), .c(new_n175_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n172_), .O(new_n179_));
  oai21  g117(.a(x37), .b(x35), .c(x27), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  oai21  g119(.a(new_n63_), .b(x13), .c(new_n102_), .O(new_n182_));
  nand4  g120(.a(new_n82_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n67_), .O(new_n185_));
  nand3  g123(.a(new_n81_), .b(new_n80_), .c(new_n91_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n185_), .c(new_n181_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x40), .O(new_n188_));
  oai21  g126(.a(new_n64_), .b(x04), .c(new_n102_), .O(new_n189_));
  nand2  g127(.a(new_n64_), .b(new_n82_), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(x37), .O(new_n191_));
  nor2   g129(.a(x40), .b(x27), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n191_), .c(x39), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n188_), .c(new_n179_), .O(z14));
  ...
  nand4  g139(.a(new_n65_), .b(new_n201_), .c(x23), .d(x22), .O(new_n202_));
  nor2   g140(.a(new_n202_), .b(new_n200_), .O(z17));
  nand2  g141(.a(z08), .b(x29), .O(new_n204_));
  oai21  g142(.a(new_n87_), .b(x27), .c(new_n204_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(x08), .O(new_n206_));
  nor2   g144(.a(new_n91_), .b(x04), .O(new_n207_));
  aoi21  g145(.a(new_n207_), .b(new_n83_), .c(x09), .O(new_n208_));
  nand4  g146(.a(new_n208_), .b(new_n206_), .c(new_n65_), .d(new_n80_), .O(z18));
  nand2  g147(.a(new_n144_), .b(new_n65_), .O(z19));
  oai22  g148(.a(new_n63_), .b(x35), .c(new_n102_), .d(x27), .O(new_n211_));
  nand2  g149(.a(new_n211_), .b(new_n137_), .O(new_n212_));
  oai21  g150(.a(new_n63_), .b(x08), .c(new_n136_), .O(new_n213_));
  nand2  g151(.a(new_n213_), .b(new_n82_), .O(new_n214_));
  nor2   g152(.a(new_n79_), .b(x08), .O(new_n215_));
  nor2   g153(.a(x39), .b(new_n102_), .O(new_n216_));
  oai21  g154(.a(new_n216_), .b(new_n215_), .c(new_n91_), .O(new_n217_));
  nand3  g155(.a(new_n217_), .b(new_n214_), .c(new_n212_), .O(new_n218_));
  nand3  g156(.a(new_n218_), .b(new_n80_), .c(new_n133_), .O(new_n219_));
  nand2  g157(.a(new_n219_), .b(new_n65_), .O(z20));
endmodule
