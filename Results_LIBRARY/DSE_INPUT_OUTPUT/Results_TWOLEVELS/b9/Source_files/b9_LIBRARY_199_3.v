...
module FAU ( 
  ...
  nand3  g005(.a(new_n67_), .b(x27), .c(new_n64_), .O(new_n68_));
  ...
  oai21  g032(.a(new_n94_), .b(new_n91_), .c(new_n63_), .O(new_n95_));
  oai21  g033(.a(new_n92_), .b(x04), .c(x40), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n81_), .c(x27), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(new_n95_), .O(z03));
  oai21  g036(.a(new_n94_), .b(x21), .c(new_n63_), .O(new_n99_));
  nand2  g037(.a(new_n99_), .b(new_n97_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n63_), .c(new_n65_), .O(z05));
  inv1   g040(.a(x27), .O(new_n103_));
  aoi21  g041(.a(new_n63_), .b(new_n103_), .c(new_n81_), .O(new_n104_));
  ...
  nand3  g061(.a(new_n123_), .b(x07), .c(new_n71_), .O(new_n124_));
  oai21  g062(.a(new_n123_), .b(new_n122_), .c(new_n124_), .O(new_n125_));
  aoi22  g063(.a(new_n125_), .b(new_n83_), .c(x37), .d(x06), .O(new_n126_));
  oai21  g064(.a(x32), .b(x30), .c(x39), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n122_), .c(new_n71_), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(x40), .O(new_n129_));
  oai21  g067(.a(new_n126_), .b(new_n103_), .c(new_n129_), .O(z10));
  nand2  g068(.a(new_n63_), .b(new_n103_), .O(new_n131_));
  nand2  g069(.a(new_n82_), .b(new_n71_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n131_), .c(x08), .O(new_n133_));
  inv1   g071(.a(new_n82_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n71_), .c(new_n73_), .O(new_n136_));
  nand3  g074(.a(new_n73_), .b(x27), .c(x04), .O(new_n137_));
  oai21  g075(.a(new_n136_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n133_), .c(new_n78_), .O(new_n139_));
  nor2   g077(.a(new_n139_), .b(x09), .O(z11));
  nor3   g078(.a(x37), .b(x36), .c(x35), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n103_), .c(new_n72_), .O(new_n142_));
  inv1   g080(.a(new_n67_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n103_), .c(new_n123_), .O(new_n144_));
  ...
  nand4  g091(.a(new_n67_), .b(new_n73_), .c(x20), .d(new_n151_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  aoi21  g094(.a(new_n79_), .b(new_n78_), .c(new_n73_), .O(new_n157_));
  ...
  oai22  g098(.a(new_n160_), .b(new_n143_), .c(new_n123_), .d(x13), .O(new_n161_));
  ...
  oai21  g102(.a(new_n164_), .b(new_n81_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n79_), .c(new_n78_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n161_), .c(new_n63_), .O(z14));
  nand4  g105(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n63_), .O(z15));
  inv1   g107(.a(x23), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(x22), .c(x01), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n63_), .O(z16));
  inv1   g110(.a(x01), .O(new_n173_));
  inv1   g111(.a(x24), .O(new_n174_));
  nand4  g112(.a(new_n63_), .b(new_n174_), .c(x23), .d(x22), .O(new_n175_));
  nor2   g113(.a(new_n175_), .b(new_n173_), .O(z17));
  inv1   g114(.a(x09), .O(new_n177_));
  inv1   g115(.a(x29), .O(new_n178_));
  oai22  g116(.a(new_n123_), .b(new_n178_), .c(new_n82_), .d(x27), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n103_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n134_), .c(x30), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n180_), .c(new_n63_), .d(new_n177_), .O(z18));
  aoi21  g121(.a(x28), .b(new_n103_), .c(new_n92_), .O(new_n184_));
  nand2  g122(.a(x35), .b(x27), .O(new_n185_));
  aoi22  g123(.a(new_n185_), .b(new_n71_), .c(new_n73_), .d(new_n103_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(x08), .c(new_n184_), .d(new_n136_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n78_), .c(new_n177_), .O(new_n188_));
