...
module FAU ( 
  ...
  nor2   g035(.a(new_n84_), .b(new_n75_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n97_), .c(new_n95_), .d(x40), .O(z02));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n100_), .c(new_n84_), .O(z04));
  nand2  g043(.a(x28), .b(x27), .O(new_n106_));
  aoi21  g044(.a(new_n106_), .b(new_n70_), .c(new_n84_), .O(z05));
  nand3  g045(.a(new_n106_), .b(new_n82_), .c(new_n70_), .O(new_n108_));
  ...
  aoi21  g058(.a(new_n75_), .b(x22), .c(new_n76_), .O(z08));
  nand4  g059(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n122_));
  nand2  g060(.a(new_n122_), .b(new_n82_), .O(z09));
  inv1   g061(.a(x07), .O(new_n124_));
  nand4  g062(.a(x40), .b(x39), .c(x22), .d(x05), .O(new_n125_));
  oai21  g063(.a(z08), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n89_), .c(new_n65_), .O(new_n127_));
  nand3  g065(.a(new_n82_), .b(x37), .c(x06), .O(new_n128_));
  ...
  nor3   g069(.a(new_n131_), .b(new_n75_), .c(new_n81_), .O(new_n132_));
  ...
  aoi22  g074(.a(new_n136_), .b(x22), .c(new_n82_), .d(new_n64_), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x22), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(x40), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(x35), .c(new_n87_), .O(new_n142_));
  ...
  nand3  g086(.a(x40), .b(new_n64_), .c(x22), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n152_));
  oai22  g090(.a(new_n152_), .b(new_n76_), .c(new_n73_), .d(new_n64_), .O(new_n153_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n158_), .c(new_n81_), .O(new_n162_));
  ...
  nand3  g103(.a(new_n132_), .b(new_n155_), .c(new_n65_), .O(new_n166_));
  ...
  oai21  g107(.a(x13), .b(x04), .c(x40), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n169_), .c(x39), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x22), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x40), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n168_), .O(new_n174_));
  ...
  nand3  g115(.a(x39), .b(new_n155_), .c(new_n65_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n71_), .c(new_n70_), .O(new_n179_));
  nand2  g117(.a(x40), .b(x13), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x39), .c(new_n65_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n64_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n179_), .c(new_n177_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x22), .O(new_n184_));
  oai21  g122(.a(new_n73_), .b(new_n64_), .c(new_n76_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n184_), .c(new_n174_), .O(z14));
  ...
  nand2  g135(.a(new_n85_), .b(new_n135_), .O(new_n198_));
  aoi21  g136(.a(new_n197_), .b(new_n87_), .c(new_n198_), .O(new_n199_));
  nand4  g137(.a(new_n77_), .b(x29), .c(x22), .d(x08), .O(new_n200_));
  oai21  g138(.a(new_n199_), .b(new_n84_), .c(new_n200_), .O(z18));
  nand2  g139(.a(new_n145_), .b(new_n82_), .O(z19));
  nor2   g140(.a(new_n87_), .b(x27), .O(new_n203_));
  nor2   g141(.a(x35), .b(new_n81_), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n203_), .c(new_n138_), .O(new_n205_));
  inv1   g143(.a(x08), .O(new_n206_));
  aoi21  g144(.a(x35), .b(x27), .c(new_n81_), .O(new_n207_));
  nor2   g145(.a(x40), .b(x27), .O(new_n208_));
  oai21  g146(.a(new_n208_), .b(new_n207_), .c(new_n206_), .O(new_n209_));
  oai21  g147(.a(new_n203_), .b(new_n66_), .c(new_n76_), .O(new_n210_));
  nand3  g148(.a(new_n210_), .b(new_n209_), .c(new_n205_), .O(new_n211_));
  nand3  g149(.a(new_n211_), .b(new_n85_), .c(new_n135_), .O(new_n212_));
