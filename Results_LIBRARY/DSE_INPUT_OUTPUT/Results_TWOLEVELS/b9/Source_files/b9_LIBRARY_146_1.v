...
module FAU ( 
  ...
  nand4  g012(.a(new_n74_), .b(x39), .c(x29), .d(new_n65_), .O(new_n75_));
  ...
  nand2  g024(.a(new_n67_), .b(x04), .O(new_n87_));
  inv1   g025(.a(x02), .O(new_n88_));
  nand2  g026(.a(x40), .b(new_n88_), .O(new_n89_));
  aoi21  g027(.a(new_n89_), .b(new_n87_), .c(x08), .O(new_n90_));
  nand3  g028(.a(new_n82_), .b(x40), .c(x04), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x39), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n90_), .c(x29), .O(new_n93_));
  ...
  aoi21  g040(.a(new_n77_), .b(new_n67_), .c(new_n81_), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(x37), .c(new_n77_), .O(z06));
  ...
  nand2  g075(.a(new_n137_), .b(new_n123_), .O(new_n138_));
  nand4  g076(.a(x35), .b(new_n81_), .c(x27), .d(new_n122_), .O(new_n139_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n77_), .O(z11));
  ...
  nand3  g086(.a(new_n148_), .b(new_n146_), .c(new_n77_), .O(z12));
  ...
  nand4  g097(.a(new_n128_), .b(x39), .c(new_n150_), .d(new_n122_), .O(new_n160_));
  ...
  inv1   g104(.a(new_n123_), .O(new_n167_));
  nand4  g105(.a(new_n151_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n168_));
  ...
  aoi22  g109(.a(new_n169_), .b(new_n167_), .c(x35), .d(x28), .O(new_n172_));
  inv1   g110(.a(x35), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n172_), .c(new_n68_), .O(new_n176_));
  nand3  g114(.a(new_n128_), .b(new_n167_), .c(new_n122_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n67_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n171_), .d(new_n165_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nand4  g118(.a(new_n77_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n180_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand4  g121(.a(new_n77_), .b(new_n183_), .c(x22), .d(x01), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(z16));
  inv1   g123(.a(x01), .O(new_n186_));
  inv1   g124(.a(x24), .O(new_n187_));
  nand4  g125(.a(new_n77_), .b(new_n187_), .c(x23), .d(x22), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(new_n186_), .O(z17));
  oai21  g127(.a(new_n82_), .b(x27), .c(new_n123_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n64_), .b(x30), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n191_), .c(new_n139_), .d(new_n135_), .O(z18));
  nor2   g131(.a(new_n173_), .b(new_n67_), .O(new_n194_));
  aoi21  g132(.a(x28), .b(new_n67_), .c(new_n173_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n167_), .c(new_n194_), .d(x08), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n78_), .c(new_n135_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n77_), .O(z20));
  nand2  g136(.a(new_n142_), .b(new_n77_), .O(z19));
endmodule
