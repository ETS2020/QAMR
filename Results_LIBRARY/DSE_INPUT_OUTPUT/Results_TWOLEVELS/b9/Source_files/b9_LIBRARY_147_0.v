...
module FAU ( 
  ...
  nand2  g035(.a(new_n76_), .b(x17), .O(new_n98_));
  ...
  aoi21  g067(.a(new_n129_), .b(new_n98_), .c(new_n128_), .O(new_n130_));
  ...
  oai21  g079(.a(new_n88_), .b(x04), .c(x40), .O(new_n142_));
  ...
  aoi21  g083(.a(new_n76_), .b(x17), .c(new_n145_), .O(new_n146_));
  ...
  nand2  g093(.a(new_n87_), .b(x17), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x35), .c(x37), .O(new_n157_));
  nand2  g095(.a(x27), .b(x17), .O(new_n158_));
  ...
  nor2   g106(.a(new_n167_), .b(new_n81_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(x27), .O(new_n170_));
  nand3  g108(.a(new_n138_), .b(new_n161_), .c(new_n65_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(z13));
  oai21  g110(.a(new_n137_), .b(x13), .c(x40), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n77_), .c(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n64_), .O(new_n175_));
  nand3  g113(.a(x20), .b(new_n166_), .c(new_n165_), .O(new_n176_));
  nand4  g114(.a(new_n162_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n77_), .c(new_n161_), .d(new_n65_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand3  g117(.a(x39), .b(new_n161_), .c(new_n65_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n71_), .O(new_n181_));
  nand2  g119(.a(new_n137_), .b(x28), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x40), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n66_), .O(new_n184_));
  nand3  g122(.a(new_n76_), .b(new_n87_), .c(x17), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n184_), .c(new_n181_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n70_), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n179_), .c(new_n175_), .d(new_n82_), .O(z14));
  ...
  nand2  g130(.a(new_n192_), .b(new_n82_), .O(z16));
  inv1   g131(.a(x24), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(x23), .c(x22), .d(x01), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n82_), .O(z17));
  nand2  g134(.a(new_n77_), .b(x29), .O(new_n197_));
  oai21  g135(.a(new_n88_), .b(x27), .c(new_n197_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(x08), .O(new_n199_));
  nor2   g137(.a(new_n64_), .b(x04), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n144_), .c(x09), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n199_), .c(new_n82_), .d(new_n85_), .O(z18));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(new_n146_), .O(new_n204_));
  nand2  g142(.a(x40), .b(new_n66_), .O(new_n205_));
  aoi21  g143(.a(new_n205_), .b(new_n141_), .c(x08), .O(new_n206_));
