...
module FAU ( 
  ...
  oai21  g034(.a(new_n96_), .b(new_n93_), .c(x17), .O(new_n97_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n84_), .O(z03));
  aoi21  g040(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n99_), .c(new_n84_), .O(z04));
  nand2  g042(.a(x28), .b(x27), .O(new_n105_));
  aoi21  g043(.a(new_n105_), .b(new_n70_), .c(new_n84_), .O(z05));
  ...
  nand2  g049(.a(x17), .b(x15), .O(new_n112_));
  oai21  g050(.a(x40), .b(x17), .c(new_n112_), .O(new_n113_));
  ...
  nand3  g057(.a(new_n119_), .b(new_n82_), .c(new_n117_), .O(new_n120_));
  aoi21  g058(.a(new_n120_), .b(new_n116_), .c(new_n109_), .O(z07));
  aoi21  g059(.a(new_n75_), .b(x17), .c(new_n76_), .O(z08));
  ...
  nand4  g064(.a(x40), .b(x39), .c(x17), .d(x05), .O(new_n127_));
  oai21  g065(.a(z08), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(new_n89_), .c(new_n65_), .O(new_n129_));
  ...
  nand3  g102(.a(new_n134_), .b(new_n154_), .c(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n164_), .O(z13));
  oai21  g104(.a(new_n133_), .b(x13), .c(x17), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n77_), .c(new_n65_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n64_), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n170_));
  nand4  g108(.a(new_n155_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n171_));
  nor2   g109(.a(x13), .b(x04), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n171_), .c(new_n77_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  inv1   g112(.a(new_n71_), .O(new_n175_));
  aoi21  g113(.a(new_n172_), .b(new_n77_), .c(new_n175_), .O(new_n176_));
  nand4  g114(.a(new_n66_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n176_), .c(new_n70_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n174_), .c(new_n169_), .d(new_n82_), .O(z14));
  ...
  nand2  g125(.a(new_n187_), .b(new_n82_), .O(z17));
  nand2  g126(.a(new_n77_), .b(x29), .O(new_n189_));
  oai21  g127(.a(new_n88_), .b(x27), .c(new_n189_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n84_), .b(x09), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n140_), .c(x30), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n192_), .c(new_n191_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n196_));
  nor2   g134(.a(new_n196_), .b(new_n142_), .O(new_n197_));
  oai21  g135(.a(new_n66_), .b(new_n64_), .c(x17), .O(new_n198_));
  nand2  g136(.a(new_n76_), .b(new_n64_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n198_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n197_), .c(new_n85_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z20));
  nor2   g140(.a(new_n145_), .b(x09), .O(z19));
endmodule
