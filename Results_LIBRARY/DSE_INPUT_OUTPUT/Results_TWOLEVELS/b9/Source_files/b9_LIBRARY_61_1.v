...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(new_n66_), .d(x12), .O(new_n77_));
  ...
  oai21  g028(.a(x35), .b(new_n63_), .c(new_n90_), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(x04), .c(new_n63_), .O(new_n92_));
  ...
  aoi21  g042(.a(new_n64_), .b(new_n68_), .c(new_n90_), .O(new_n105_));
  ...
  aoi21  g055(.a(new_n93_), .b(x12), .c(new_n74_), .O(z08));
  ...
  nand2  g071(.a(new_n64_), .b(new_n68_), .O(new_n134_));
  nand2  g072(.a(x40), .b(x04), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x35), .c(new_n90_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(x12), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n134_), .c(x08), .O(new_n138_));
  nor2   g076(.a(new_n81_), .b(x28), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x12), .c(new_n74_), .O(new_n141_));
  ...
  nand3  g083(.a(new_n69_), .b(new_n82_), .c(new_n81_), .O(new_n146_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n70_), .c(new_n69_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n148_), .c(x12), .O(new_n154_));
  oai21  g092(.a(new_n71_), .b(x40), .c(new_n154_), .O(z12));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n159_), .c(new_n63_), .O(new_n164_));
  ...
  nand4  g105(.a(new_n128_), .b(new_n156_), .c(x12), .d(new_n121_), .O(new_n168_));
  ...
  nand2  g131(.a(x27), .b(new_n121_), .O(new_n194_));
  nand2  g132(.a(new_n68_), .b(x08), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n194_), .c(new_n81_), .O(new_n196_));
  inv1   g134(.a(x09), .O(new_n197_));
  nand2  g135(.a(new_n79_), .b(new_n197_), .O(new_n198_));
  aoi21  g136(.a(new_n196_), .b(new_n90_), .c(new_n198_), .O(new_n199_));
  nand4  g137(.a(new_n171_), .b(x29), .c(x12), .d(x08), .O(new_n200_));
  oai21  g138(.a(new_n199_), .b(new_n65_), .c(new_n200_), .O(z18));
  nor2   g139(.a(x35), .b(new_n63_), .O(new_n202_));
  nor2   g140(.a(new_n90_), .b(x27), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n202_), .c(new_n140_), .O(new_n204_));
  inv1   g142(.a(x08), .O(new_n205_));
  aoi21  g143(.a(x35), .b(x27), .c(new_n63_), .O(new_n206_));
  nor2   g144(.a(x40), .b(x27), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(new_n206_), .c(new_n205_), .O(new_n208_));
  oai21  g146(.a(new_n203_), .b(new_n81_), .c(new_n74_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n208_), .c(new_n204_), .O(new_n210_));
  nand3  g148(.a(new_n210_), .b(new_n79_), .c(new_n197_), .O(new_n211_));
  nand2  g149(.a(new_n211_), .b(new_n64_), .O(z20));
  nor2   g150(.a(new_n144_), .b(x09), .O(z19));
endmodule
