...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(x26), .d(new_n66_), .O(new_n78_));
  ...
  nand2  g038(.a(new_n68_), .b(new_n100_), .O(new_n101_));
  ...
  nand3  g056(.a(x40), .b(x39), .c(x26), .O(new_n119_));
  ...
  nor2   g070(.a(new_n68_), .b(new_n100_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(x06), .c(new_n65_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(z10));
  nand3  g073(.a(x35), .b(new_n83_), .c(new_n123_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x26), .c(new_n64_), .d(new_n100_), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x26), .O(new_n139_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n80_), .c(new_n94_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n64_), .O(z11));
  nor3   g084(.a(x37), .b(x36), .c(x35), .O(new_n147_));
  nor2   g085(.a(new_n75_), .b(x27), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n74_), .O(new_n149_));
  oai21  g087(.a(new_n125_), .b(x04), .c(new_n71_), .O(new_n150_));
  ...
  oai21  g114(.a(new_n176_), .b(new_n173_), .c(new_n68_), .O(new_n177_));
  nand3  g115(.a(new_n129_), .b(new_n168_), .c(new_n123_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n100_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n177_), .c(new_n172_), .d(new_n166_), .O(z14));
  ...
  nand2  g127(.a(x27), .b(new_n123_), .O(new_n190_));
  nand2  g128(.a(new_n100_), .b(x08), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(new_n174_), .O(new_n192_));
  nand2  g130(.a(new_n80_), .b(new_n94_), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n83_), .c(new_n193_), .O(new_n194_));
  nand4  g132(.a(new_n168_), .b(x29), .c(x26), .d(x08), .O(new_n195_));
  oai21  g133(.a(new_n194_), .b(new_n65_), .c(new_n195_), .O(z18));
  inv1   g134(.a(new_n145_), .O(z19));
  nand2  g135(.a(x28), .b(new_n100_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n139_), .d(x40), .O(new_n199_));
  oai21  g137(.a(new_n174_), .b(new_n100_), .c(x26), .O(new_n200_));
  nand2  g138(.a(new_n75_), .b(new_n100_), .O(new_n201_));
