...
module FAU ( 
  ...
  nor2   g032(.a(x40), .b(new_n94_), .O(new_n95_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n98_), .c(new_n78_), .O(z04));
  ...
  oai21  g074(.a(new_n66_), .b(x28), .c(x39), .O(new_n137_));
  nand2  g075(.a(x40), .b(x04), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n137_), .c(new_n105_), .O(new_n139_));
  ...
  nand2  g081(.a(x40), .b(new_n94_), .O(new_n144_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n81_), .c(new_n135_), .O(new_n151_));
  inv1   g089(.a(new_n151_), .O(z11));
  oai21  g090(.a(x37), .b(x35), .c(x27), .O(new_n153_));
  oai21  g091(.a(new_n94_), .b(x04), .c(new_n153_), .O(new_n154_));
  ...
  nand3  g095(.a(new_n94_), .b(new_n70_), .c(new_n83_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n157_), .c(new_n154_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x40), .O(new_n160_));
  oai21  g098(.a(new_n142_), .b(x04), .c(new_n83_), .O(new_n161_));
  nand2  g099(.a(new_n142_), .b(new_n66_), .O(new_n162_));
  ...
  aoi21  g106(.a(new_n168_), .b(x28), .c(new_n142_), .O(new_n169_));
  ...
  nand3  g113(.a(new_n128_), .b(x40), .c(x39), .O(new_n176_));
  nor2   g114(.a(new_n176_), .b(x13), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n65_), .c(new_n78_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n175_), .O(z13));
  nand3  g117(.a(x20), .b(new_n172_), .c(new_n171_), .O(new_n180_));
  oai22  g118(.a(new_n142_), .b(x35), .c(new_n94_), .d(x36), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n182_));
  nand3  g120(.a(x39), .b(new_n167_), .c(new_n65_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(x40), .c(new_n95_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n180_), .O(new_n186_));
  nand2  g124(.a(new_n183_), .b(new_n153_), .O(new_n187_));
  oai21  g125(.a(new_n94_), .b(x13), .c(new_n83_), .O(new_n188_));
  nand4  g126(.a(new_n66_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n70_), .O(new_n191_));
  nand3  g129(.a(new_n82_), .b(new_n81_), .c(new_n64_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n191_), .c(new_n187_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x40), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n186_), .c(new_n165_), .O(z14));
  inv1   g133(.a(x12), .O(new_n196_));
  nor2   g134(.a(new_n122_), .b(new_n196_), .O(z15));
  inv1   g135(.a(x23), .O(new_n198_));
  nand4  g136(.a(new_n79_), .b(new_n198_), .c(x22), .d(x01), .O(new_n199_));
  inv1   g137(.a(new_n199_), .O(z16));
  inv1   g138(.a(x24), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(x23), .c(x22), .d(x01), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n79_), .O(z17));
  oai22  g141(.a(new_n84_), .b(x27), .c(new_n119_), .d(new_n141_), .O(new_n204_));
  nand2  g142(.a(new_n204_), .b(x08), .O(new_n205_));
  nor2   g143(.a(new_n64_), .b(x04), .O(new_n206_));
  aoi21  g144(.a(new_n206_), .b(new_n146_), .c(x09), .O(new_n207_));
  nand4  g145(.a(new_n207_), .b(new_n205_), .c(new_n79_), .d(new_n81_), .O(z18));
  nand2  g146(.a(new_n151_), .b(new_n79_), .O(z19));
  aoi21  g147(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n210_));
  aoi21  g148(.a(new_n144_), .b(new_n143_), .c(new_n210_), .O(new_n211_));
  nand2  g149(.a(x39), .b(new_n66_), .O(new_n212_));
  aoi21  g150(.a(new_n212_), .b(new_n105_), .c(x08), .O(new_n213_));
  oai21  g151(.a(new_n213_), .b(new_n211_), .c(new_n81_), .O(new_n214_));
