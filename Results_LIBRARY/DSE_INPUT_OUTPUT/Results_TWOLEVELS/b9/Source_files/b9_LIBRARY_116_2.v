...
module FAU ( 
  ...
  nor2   g071(.a(new_n96_), .b(new_n71_), .O(new_n134_));
  oai22  g072(.a(new_n134_), .b(new_n82_), .c(new_n127_), .d(new_n133_), .O(new_n135_));
  ...
  oai21  g081(.a(new_n127_), .b(x04), .c(new_n68_), .O(new_n144_));
  ...
  nand4  g091(.a(new_n67_), .b(new_n127_), .c(x20), .d(new_n151_), .O(new_n154_));
  ...
  nand3  g096(.a(x39), .b(new_n146_), .c(new_n71_), .O(new_n159_));
  ...
  nand2  g117(.a(new_n78_), .b(new_n132_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(new_n81_), .c(new_n180_), .O(new_n181_));
  oai22  g119(.a(new_n181_), .b(new_n93_), .c(new_n121_), .d(new_n88_), .O(z18));
  nor2   g120(.a(new_n127_), .b(new_n133_), .O(new_n183_));
  oai21  g121(.a(new_n177_), .b(new_n96_), .c(new_n136_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n96_), .c(new_n177_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n78_), .c(new_n132_), .O(new_n187_));
