...
module FAU ( 
  ...
  aoi21  g17(.a(new_n65_), .b(new_n64_), .c(z08), .O(new_n81_));
  ...
  aoi21  g24(.a(new_n69_), .b(new_n87_), .c(new_n64_), .O(new_n88_));
  ...
  nand2  g46(.a(new_n109_), .b(new_n69_), .O(z10));
  ...
  nand4  g51(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n87_), .O(new_n115_));
  nand3  g52(.a(new_n115_), .b(new_n72_), .c(new_n111_), .O(new_n116_));
  nand2  g53(.a(new_n116_), .b(new_n69_), .O(z11));
  ...
  nand2  g58(.a(new_n121_), .b(new_n69_), .O(z13));
  ...
  nand4  g63(.a(new_n69_), .b(x34), .c(x27), .d(x26), .O(new_n127_));
  nor2   g64(.a(new_n127_), .b(new_n126_), .O(z15));
  inv1   g65(.a(x23), .O(new_n129_));
  nand4  g66(.a(new_n69_), .b(new_n129_), .c(x22), .d(x01), .O(new_n130_));
  ...
  nand3  g74(.a(new_n137_), .b(x35), .c(new_n87_), .O(new_n138_));
  nor2   g75(.a(x30), .b(x09), .O(new_n139_));
  aoi21  g76(.a(new_n139_), .b(new_n138_), .c(z08), .O(z18));
  oai21  g77(.a(x28), .b(new_n113_), .c(new_n64_), .O(new_n141_));
  nand2  g78(.a(new_n141_), .b(x35), .O(new_n142_));
  nand3  g79(.a(new_n142_), .b(new_n72_), .c(new_n111_), .O(new_n143_));
  nand2  g80(.a(new_n143_), .b(new_n69_), .O(z20));
  one    g81(.O(z02));
  nand2  g82(.a(new_n116_), .b(new_n69_), .O(z19));
endmodule
