...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x33), .O(new_n81_));
  ...
  nand3  g044(.a(new_n106_), .b(new_n84_), .c(new_n70_), .O(z05));
  oai22  g045(.a(x40), .b(x33), .c(new_n87_), .d(new_n64_), .O(new_n108_));
  ...
  nand4  g060(.a(new_n84_), .b(x34), .c(x27), .d(x26), .O(new_n123_));
  ...
  nand4  g078(.a(new_n140_), .b(x35), .c(new_n87_), .d(x27), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n85_), .c(new_n135_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n84_), .O(z11));
  ...
  nand2  g089(.a(x33), .b(new_n87_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x35), .c(x40), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n70_), .O(new_n154_));
  aoi21  g092(.a(x33), .b(x27), .c(x40), .O(new_n155_));
  nand2  g093(.a(new_n140_), .b(x39), .O(new_n156_));
  ...
  aoi21  g098(.a(new_n160_), .b(x28), .c(new_n148_), .O(new_n161_));
  ...
  nand3  g105(.a(new_n129_), .b(x40), .c(x39), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(x13), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n65_), .c(new_n81_), .O(new_n170_));
  ...
  nand2  g111(.a(new_n159_), .b(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x40), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n173_), .c(z08), .O(new_n176_));
  ...
  oai21  g119(.a(new_n149_), .b(new_n73_), .c(new_n174_), .O(new_n182_));
  oai21  g120(.a(new_n178_), .b(new_n64_), .c(new_n75_), .O(new_n183_));
  oai21  g121(.a(x40), .b(new_n110_), .c(x39), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n70_), .c(new_n87_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n183_), .c(new_n84_), .O(new_n186_));
  ...
  nand2  g130(.a(new_n192_), .b(new_n84_), .O(z16));
  inv1   g131(.a(x24), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(x23), .c(x22), .d(x01), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n84_), .O(z17));
  oai21  g134(.a(new_n88_), .b(x27), .c(new_n136_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(x08), .O(new_n198_));
  nor2   g136(.a(new_n64_), .b(x04), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n94_), .c(x09), .O(new_n200_));
  nand4  g138(.a(new_n200_), .b(new_n198_), .c(new_n84_), .d(new_n85_), .O(z18));
  ...
  nand3  g143(.a(new_n205_), .b(new_n85_), .c(new_n135_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n84_), .O(z20));
  nand2  g145(.a(new_n144_), .b(new_n84_), .O(z19));
endmodule
