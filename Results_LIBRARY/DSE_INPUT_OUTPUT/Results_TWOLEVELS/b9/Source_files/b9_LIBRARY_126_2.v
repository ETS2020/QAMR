...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x09), .O(new_n81_));
  ...
  nor2   g033(.a(x40), .b(x09), .O(new_n96_));
  ...
  inv1   g059(.a(new_n77_), .O(new_n122_));
  nand2  g060(.a(new_n81_), .b(new_n122_), .O(z08));
  ...
  aoi21  g065(.a(x40), .b(new_n75_), .c(new_n96_), .O(new_n128_));
  nand3  g066(.a(x40), .b(x39), .c(x05), .O(new_n129_));
  oai21  g067(.a(new_n128_), .b(new_n127_), .c(new_n129_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n87_), .c(new_n65_), .O(new_n131_));
  ...
  nand2  g073(.a(new_n84_), .b(new_n83_), .O(new_n136_));
  ...
  oai21  g092(.a(new_n122_), .b(x04), .c(new_n154_), .O(new_n155_));
  ...
  nor2   g103(.a(new_n137_), .b(x13), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n65_), .c(new_n99_), .O(new_n167_));
  ...
  nand3  g109(.a(new_n77_), .b(new_n157_), .c(new_n65_), .O(new_n172_));
  ...
  aoi21  g114(.a(new_n172_), .b(new_n154_), .c(new_n99_), .O(new_n177_));
  ...
  oai21  g124(.a(new_n86_), .b(x27), .c(new_n142_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n146_), .c(new_n83_), .d(new_n141_), .O(z18));
  inv1   g127(.a(new_n142_), .O(new_n190_));
  oai21  g128(.a(new_n66_), .b(new_n64_), .c(new_n145_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n83_), .c(new_n141_), .O(new_n194_));
  inv1   g132(.a(new_n194_), .O(z20));
  inv1   g133(.a(new_n149_), .O(z19));
endmodule
