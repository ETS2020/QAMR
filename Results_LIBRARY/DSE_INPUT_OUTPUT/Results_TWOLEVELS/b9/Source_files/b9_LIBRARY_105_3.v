...
module FAU ( 
  ...
  aoi21  g17(.a(new_n67_), .b(new_n66_), .c(z08), .O(new_n80_));
  ...
  inv1   g23(.a(x28), .O(new_n86_));
  aoi21  g24(.a(z02), .b(new_n86_), .c(new_n66_), .O(new_n87_));
  ...
  nand4  g52(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n86_), .O(new_n115_));
  nand4  g53(.a(new_n115_), .b(z02), .c(new_n72_), .d(new_n111_), .O(new_n116_));
  ...
  nand4  g60(.a(new_n122_), .b(new_n69_), .c(z02), .d(x20), .O(z14));
  ...
  nand2  g68(.a(new_n130_), .b(z02), .O(z17));
  nand2  g69(.a(x27), .b(new_n105_), .O(new_n132_));
  oai21  g70(.a(x27), .b(new_n113_), .c(new_n132_), .O(new_n133_));
  nand3  g71(.a(new_n133_), .b(x35), .c(new_n86_), .O(new_n134_));
  nand4  g72(.a(new_n134_), .b(z02), .c(new_n72_), .d(new_n111_), .O(z18));
  inv1   g73(.a(new_n116_), .O(z19));
  oai21  g74(.a(x28), .b(new_n113_), .c(new_n66_), .O(new_n137_));
  nand2  g75(.a(new_n137_), .b(x35), .O(new_n138_));
  nand4  g76(.a(new_n138_), .b(z02), .c(new_n72_), .d(new_n111_), .O(new_n139_));
