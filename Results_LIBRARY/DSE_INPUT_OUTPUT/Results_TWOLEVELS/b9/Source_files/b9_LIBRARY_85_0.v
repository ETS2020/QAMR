...
module FAU ( 
  ...
  nor2   g000(.a(x40), .b(x15), .O(new_n63_));
  inv1   g001(.a(x15), .O(new_n64_));
  oai21  g002(.a(x36), .b(x35), .c(x39), .O(new_n65_));
  ...
  oai21  g007(.a(new_n69_), .b(new_n66_), .c(x27), .O(new_n70_));
  inv1   g008(.a(x04), .O(new_n71_));
  nand3  g009(.a(x39), .b(x10), .c(new_n71_), .O(new_n72_));
  nand2  g010(.a(new_n72_), .b(new_n70_), .O(new_n73_));
  nand3  g011(.a(new_n73_), .b(x40), .c(new_n64_), .O(new_n74_));
  oai21  g012(.a(new_n63_), .b(x16), .c(new_n74_), .O(z00));
  inv1   g013(.a(new_n63_), .O(new_n76_));
  ...
  nand2  g029(.a(new_n91_), .b(x15), .O(new_n92_));
  ...
  nand4  g037(.a(new_n99_), .b(new_n94_), .c(new_n76_), .d(new_n95_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n76_), .c(new_n67_), .O(z05));
  aoi21  g040(.a(new_n76_), .b(new_n96_), .c(new_n80_), .O(new_n103_));
  ...
  nor2   g054(.a(new_n91_), .b(new_n116_), .O(new_n117_));
  inv1   g055(.a(new_n117_), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n76_), .O(z08));
  ...
  nand2  g061(.a(x40), .b(new_n116_), .O(new_n124_));
  ...
  oai21  g065(.a(new_n127_), .b(new_n125_), .c(new_n82_), .O(new_n128_));
  ...
  nand2  g070(.a(new_n78_), .b(new_n77_), .O(new_n133_));
  ...
  nand2  g075(.a(new_n76_), .b(new_n96_), .O(new_n138_));
  oai21  g076(.a(new_n81_), .b(x04), .c(x40), .O(new_n139_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n92_), .O(new_n145_));
  ...
  oai21  g087(.a(new_n149_), .b(new_n96_), .c(new_n148_), .O(new_n150_));
  nand2  g088(.a(new_n69_), .b(x27), .O(new_n151_));
  oai21  g089(.a(new_n118_), .b(x04), .c(new_n151_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n150_), .c(new_n76_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n91_), .O(new_n156_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n78_), .c(new_n77_), .d(x28), .O(new_n167_));
  inv1   g105(.a(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n117_), .b(new_n154_), .c(new_n71_), .O(new_n169_));
  ...
  nand3  g111(.a(new_n173_), .b(new_n78_), .c(new_n77_), .O(new_n174_));
  aoi21  g112(.a(new_n169_), .b(new_n151_), .c(new_n63_), .O(new_n175_));
  ...
  nand4  g121(.a(new_n76_), .b(new_n183_), .c(x23), .d(x22), .O(new_n184_));
  nor2   g122(.a(new_n184_), .b(new_n182_), .O(z17));
  nand2  g123(.a(new_n117_), .b(x29), .O(new_n186_));
  oai21  g124(.a(new_n81_), .b(x27), .c(new_n186_), .O(new_n187_));
  ...
  nand4  g128(.a(new_n190_), .b(new_n188_), .c(new_n76_), .d(new_n77_), .O(z18));
  nor2   g129(.a(x40), .b(x35), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n87_), .c(x15), .O(new_n193_));
