...
module FAU ( 
  ...
  aoi21  g033(.a(new_n66_), .b(new_n95_), .c(new_n94_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n93_), .c(new_n64_), .O(z03));
  aoi21  g035(.a(new_n66_), .b(new_n95_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n93_), .c(new_n64_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n65_), .c(new_n66_), .O(z05));
  inv1   g039(.a(x28), .O(new_n102_));
  aoi21  g040(.a(new_n65_), .b(new_n95_), .c(new_n102_), .O(new_n103_));
  ...
  oai22  g060(.a(new_n116_), .b(new_n121_), .c(x40), .d(new_n122_), .O(new_n123_));
  ...
  and2   g071(.a(x40), .b(x29), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x35), .c(new_n102_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand2  g076(.a(x39), .b(x04), .O(new_n139_));
  nand4  g077(.a(new_n139_), .b(x35), .c(new_n102_), .d(x27), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  oai21  g079(.a(new_n137_), .b(new_n134_), .c(new_n141_), .O(new_n142_));
  ...
  oai21  g085(.a(new_n63_), .b(x04), .c(new_n69_), .O(new_n148_));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n128_), .O(new_n157_));
  nand4  g095(.a(new_n68_), .b(new_n63_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n130_), .b(new_n150_), .c(new_n72_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nand3  g100(.a(x40), .b(new_n150_), .c(new_n72_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n68_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nor2   g105(.a(x37), .b(x35), .O(new_n168_));
  aoi21  g106(.a(new_n164_), .b(new_n151_), .c(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n102_), .c(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n80_), .c(new_n79_), .O(new_n171_));
  nand2  g109(.a(x39), .b(x13), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(x40), .c(new_n72_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n95_), .c(new_n64_), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n171_), .c(new_n167_), .O(z14));
  ...
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(new_n81_), .O(new_n187_));
  nand2  g125(.a(new_n79_), .b(new_n133_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n102_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n64_), .c(new_n116_), .d(new_n88_), .O(z18));
  oai21  g128(.a(new_n81_), .b(new_n95_), .c(new_n138_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n95_), .c(new_n81_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n134_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n79_), .c(new_n133_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n65_), .O(z20));
  nand2  g133(.a(new_n143_), .b(new_n65_), .O(z19));
endmodule
