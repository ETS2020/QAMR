...
module FAU ( 
  ...
  oai22  g041(.a(x40), .b(new_n84_), .c(new_n86_), .d(new_n64_), .O(new_n104_));
  ...
  oai21  g058(.a(new_n120_), .b(x04), .c(x40), .O(new_n121_));
  ...
  nor2   g081(.a(new_n80_), .b(x27), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n142_), .O(new_n145_));
  nor2   g083(.a(x40), .b(x30), .O(new_n146_));
  nand2  g084(.a(new_n72_), .b(x27), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n65_), .c(new_n80_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n146_), .c(new_n147_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n145_), .c(new_n81_), .O(z12));
  ...
  nand2  g097(.a(x40), .b(x32), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n84_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n159_), .c(new_n81_), .O(z13));
  nand3  g101(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n164_));
  nand3  g102(.a(new_n152_), .b(new_n85_), .c(x28), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(x40), .c(x30), .O(new_n166_));
  nand3  g104(.a(x39), .b(new_n151_), .c(new_n65_), .O(new_n167_));
  and2   g105(.a(new_n167_), .b(x40), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n166_), .c(new_n164_), .O(new_n169_));
  nand2  g107(.a(new_n160_), .b(new_n64_), .O(new_n170_));
  oai21  g108(.a(x32), .b(new_n86_), .c(x40), .O(new_n171_));
  nor2   g109(.a(x40), .b(x28), .O(new_n172_));
  aoi21  g110(.a(new_n171_), .b(new_n66_), .c(new_n172_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(x37), .c(new_n170_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n84_), .O(new_n175_));
  nand3  g113(.a(new_n167_), .b(new_n147_), .c(x40), .O(new_n176_));
  ...
  oai21  g125(.a(new_n87_), .b(x27), .c(new_n133_), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n137_), .c(new_n84_), .d(new_n132_), .O(z18));
  inv1   g128(.a(new_n133_), .O(new_n191_));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n94_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n84_), .c(new_n132_), .O(new_n195_));
  inv1   g133(.a(new_n195_), .O(z20));
  inv1   g134(.a(new_n140_), .O(z19));
endmodule
