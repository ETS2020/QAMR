...
module FAU ( 
  ...
  aoi21  g067(.a(x40), .b(new_n75_), .c(new_n99_), .O(new_n130_));
  nand3  g068(.a(x40), .b(x39), .c(x05), .O(new_n131_));
  oai21  g069(.a(new_n130_), .b(new_n129_), .c(new_n131_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(new_n88_), .c(new_n65_), .O(new_n133_));
  ...
  aoi21  g082(.a(new_n144_), .b(x40), .c(new_n99_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n72_), .b(new_n111_), .c(x20), .d(new_n163_), .O(new_n166_));
  nor2   g104(.a(new_n166_), .b(x18), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(x27), .O(new_n168_));
  nand3  g106(.a(new_n138_), .b(new_n158_), .c(new_n65_), .O(new_n169_));
  ...
  oai21  g113(.a(new_n175_), .b(new_n99_), .c(new_n171_), .O(new_n176_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n83_), .c(new_n93_), .d(new_n125_), .O(z18));
  ...
  aoi21  g138(.a(new_n200_), .b(new_n110_), .c(x08), .O(new_n201_));
