// Benchmark "FAU" written by ABC on Tue Aug 18 17:26:04 2020
...
module FAU ( 
  ...
  nand2  g016(.a(new_n78_), .b(x21), .O(new_n79_));
  ...
  nand2  g032(.a(new_n78_), .b(new_n94_), .O(new_n95_));
  nand2  g033(.a(new_n95_), .b(new_n93_), .O(z02));
  nand2  g034(.a(x28), .b(x27), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(x40), .c(new_n70_), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n94_), .O(new_n99_));
  nor2   g037(.a(x37), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n71_), .b(x27), .c(new_n100_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(new_n78_), .c(new_n99_), .O(z03));
  aoi21  g040(.a(new_n97_), .b(new_n70_), .c(new_n94_), .O(new_n103_));
  inv1   g041(.a(new_n100_), .O(new_n104_));
  oai21  g042(.a(x28), .b(new_n64_), .c(new_n104_), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(new_n103_), .c(x40), .O(new_n106_));
  oai21  g044(.a(new_n101_), .b(x21), .c(new_n106_), .O(z04));
  aoi22  g045(.a(new_n97_), .b(new_n70_), .c(new_n78_), .d(x21), .O(z05));
  aoi21  g046(.a(new_n79_), .b(new_n64_), .c(new_n83_), .O(new_n109_));
  oai21  g047(.a(new_n109_), .b(x37), .c(new_n79_), .O(z06));
  ...
  nand2  g058(.a(new_n120_), .b(new_n79_), .O(z07));
  ...
  nand2  g064(.a(new_n122_), .b(x07), .O(new_n127_));
  oai21  g065(.a(new_n122_), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  ...
  inv1   g071(.a(new_n79_), .O(new_n134_));
  ...
  nand3  g076(.a(x35), .b(new_n83_), .c(new_n65_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(x40), .c(new_n79_), .d(new_n64_), .O(new_n140_));
  nand2  g078(.a(x39), .b(x29), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x40), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n95_), .O(new_n143_));
  ...
  oai21  g084(.a(new_n140_), .b(x08), .c(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n81_), .c(new_n138_), .O(new_n148_));
  inv1   g086(.a(new_n148_), .O(z11));
  inv1   g087(.a(x10), .O(new_n150_));
  nor3   g088(.a(x37), .b(x36), .c(x35), .O(new_n151_));
  nor2   g089(.a(new_n78_), .b(x27), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  nor2   g091(.a(x40), .b(x21), .O(new_n154_));
  nand2  g092(.a(new_n72_), .b(x27), .O(new_n155_));
  aoi21  g093(.a(x39), .b(new_n65_), .c(new_n78_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(new_n155_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n153_), .c(new_n79_), .O(z12));
  inv1   g096(.a(x13), .O(new_n159_));
  nand2  g097(.a(x36), .b(x35), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x28), .c(new_n78_), .O(new_n161_));
  ...
  nand3  g105(.a(new_n130_), .b(x40), .c(x39), .O(new_n168_));
  nor2   g106(.a(new_n168_), .b(x13), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n65_), .c(new_n134_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n167_), .O(z13));
  nand3  g109(.a(x20), .b(new_n164_), .c(new_n163_), .O(new_n172_));
  nand4  g110(.a(new_n160_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n173_));
  ...
  oai21  g114(.a(new_n176_), .b(new_n154_), .c(new_n172_), .O(new_n177_));
  ...
  nand2  g120(.a(new_n182_), .b(x40), .O(new_n183_));
  nand3  g121(.a(new_n155_), .b(new_n78_), .c(new_n94_), .O(new_n184_));
  ...
  inv1   g132(.a(x29), .O(new_n195_));
  oai22  g133(.a(new_n84_), .b(x27), .c(new_n122_), .d(new_n195_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(x08), .O(new_n197_));
  inv1   g135(.a(new_n84_), .O(new_n198_));
  nor2   g136(.a(new_n64_), .b(x04), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n198_), .c(x09), .O(new_n200_));
  nand4  g138(.a(new_n200_), .b(new_n197_), .c(new_n79_), .d(new_n81_), .O(z18));
  nand2  g139(.a(new_n148_), .b(new_n79_), .O(z19));
  nand2  g140(.a(x28), .b(new_n64_), .O(new_n203_));
  aoi22  g141(.a(new_n203_), .b(x35), .c(new_n142_), .d(new_n95_), .O(new_n204_));
  nand2  g142(.a(new_n79_), .b(new_n64_), .O(new_n205_));
  nand2  g143(.a(x40), .b(new_n66_), .O(new_n206_));
  aoi21  g144(.a(new_n206_), .b(new_n205_), .c(x08), .O(new_n207_));
  oai21  g145(.a(new_n207_), .b(new_n204_), .c(new_n81_), .O(new_n208_));
