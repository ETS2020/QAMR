...
module FAU ( 
  ...
  aoi21  g036(.a(new_n98_), .b(new_n93_), .c(new_n89_), .O(z05));
  ...
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n70_), .d(new_n86_), .O(new_n137_));
  ...
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n119_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  inv1   g091(.a(new_n64_), .O(new_n154_));
  ...
  nor3   g095(.a(new_n127_), .b(x13), .c(x04), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n69_), .c(x39), .O(new_n159_));
  ...
  nand4  g101(.a(new_n142_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n93_), .O(new_n166_));
  nand2  g104(.a(x40), .b(new_n86_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n168_));
  oai21  g106(.a(x13), .b(x04), .c(new_n168_), .O(new_n169_));
  inv1   g107(.a(x39), .O(new_n170_));
  oai21  g108(.a(new_n127_), .b(new_n170_), .c(new_n86_), .O(new_n171_));
  nand4  g109(.a(new_n149_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n172_));
  ...
  nand4  g113(.a(new_n175_), .b(new_n171_), .c(new_n169_), .d(new_n166_), .O(z14));
  nand4  g114(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n70_), .O(z15));
  ...
  nand2  g123(.a(x27), .b(new_n119_), .O(new_n186_));
  nand2  g124(.a(new_n86_), .b(x08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n142_), .O(new_n188_));
  nand2  g126(.a(new_n73_), .b(new_n131_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n76_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n89_), .c(new_n114_), .d(new_n83_), .O(z18));
  nand2  g129(.a(new_n139_), .b(new_n70_), .O(z19));
  aoi21  g130(.a(new_n69_), .b(x39), .c(x08), .O(new_n193_));
  aoi21  g131(.a(x39), .b(x29), .c(new_n76_), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(new_n86_), .O(new_n195_));
  nand2  g133(.a(new_n83_), .b(x40), .O(new_n196_));
  ...
  nand3  g137(.a(new_n199_), .b(new_n73_), .c(new_n131_), .O(new_n200_));
