...
module FAU ( 
  ...
  nand2  g015(.a(new_n73_), .b(x21), .O(new_n78_));
  ...
  oai21  g030(.a(new_n73_), .b(x35), .c(new_n83_), .O(new_n93_));
  ...
  oai21  g035(.a(new_n83_), .b(new_n64_), .c(new_n97_), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  aoi21  g037(.a(x35), .b(x28), .c(new_n64_), .O(new_n100_));
  inv1   g038(.a(new_n100_), .O(new_n101_));
  aoi21  g039(.a(new_n97_), .b(new_n64_), .c(new_n73_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n101_), .c(new_n99_), .O(z03));
  aoi21  g041(.a(new_n97_), .b(new_n64_), .c(new_n100_), .O(new_n104_));
  nand2  g042(.a(x40), .b(x21), .O(new_n105_));
  oai21  g043(.a(new_n104_), .b(x21), .c(new_n105_), .O(z04));
  and2   g044(.a(new_n98_), .b(new_n78_), .O(z05));
  oai22  g045(.a(x40), .b(new_n96_), .c(new_n83_), .d(new_n64_), .O(new_n108_));
  ...
  nor2   g061(.a(x40), .b(x21), .O(new_n124_));
  aoi21  g062(.a(x40), .b(new_n72_), .c(new_n124_), .O(new_n125_));
  ...
  nor2   g070(.a(new_n132_), .b(new_n72_), .O(new_n133_));
  ...
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(new_n81_), .O(new_n144_));
  ...
  aoi21  g086(.a(x39), .b(new_n65_), .c(new_n148_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(x40), .O(new_n150_));
  nor2   g088(.a(new_n148_), .b(x40), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n96_), .O(new_n152_));
  ...
  nand4  g100(.a(new_n160_), .b(new_n96_), .c(x20), .d(new_n159_), .O(new_n163_));
  ...
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n73_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n124_), .c(new_n168_), .O(new_n173_));
  nand3  g111(.a(new_n97_), .b(new_n66_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n82_), .c(new_n81_), .O(new_n176_));
  oai21  g114(.a(new_n171_), .b(new_n148_), .c(new_n176_), .O(new_n177_));
  ...
  nand2  g131(.a(new_n81_), .b(new_n193_), .O(new_n194_));
  aoi21  g132(.a(new_n192_), .b(new_n83_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n80_), .c(new_n90_), .d(new_n189_), .O(z18));
  nor2   g134(.a(x40), .b(x35), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n92_), .c(new_n96_), .O(new_n198_));
  ...
  nor2   g144(.a(new_n144_), .b(x09), .O(z19));
endmodule
