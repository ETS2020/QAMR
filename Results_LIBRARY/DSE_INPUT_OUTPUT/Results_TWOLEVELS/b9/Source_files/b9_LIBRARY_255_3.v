...
module FAU ( 
  ...
  inv1   g15(.a(new_n69_), .O(new_n78_));
  nor2   g16(.a(new_n64_), .b(x09), .O(new_n79_));
  inv1   g17(.a(x28), .O(new_n80_));
  oai21  g18(.a(new_n80_), .b(x09), .c(new_n71_), .O(new_n81_));
  aoi21  g19(.a(new_n80_), .b(x27), .c(new_n81_), .O(new_n82_));
  aoi21  g20(.a(new_n82_), .b(new_n79_), .c(new_n78_), .O(z02));
  ...
  aoi21  g25(.a(new_n87_), .b(new_n84_), .c(new_n78_), .O(z04));
  nand2  g26(.a(x28), .b(x27), .O(new_n89_));
  nand3  g27(.a(new_n89_), .b(new_n69_), .c(new_n65_), .O(z05));
  nand2  g28(.a(z05), .b(new_n69_), .O(z06));
  ...
  nand2  g49(.a(new_n112_), .b(new_n69_), .O(z10));
  inv1   g50(.a(x09), .O(new_n114_));
  nor2   g51(.a(x27), .b(x08), .O(new_n115_));
  aoi21  g52(.a(x27), .b(x04), .c(new_n115_), .O(new_n116_));
  nand3  g53(.a(new_n116_), .b(x35), .c(new_n80_), .O(new_n117_));
  nand4  g54(.a(new_n117_), .b(new_n69_), .c(new_n71_), .d(new_n114_), .O(new_n118_));
  inv1   g55(.a(new_n118_), .O(z11));
  nor2   g56(.a(new_n78_), .b(new_n67_), .O(z12));
  nand2  g57(.a(new_n66_), .b(new_n65_), .O(new_n121_));
  nand4  g58(.a(new_n69_), .b(new_n121_), .c(x27), .d(x20), .O(new_n122_));
  nor3   g59(.a(new_n122_), .b(x19), .c(x18), .O(z13));
  nor2   g60(.a(x19), .b(x18), .O(new_n124_));
  nand4  g61(.a(new_n124_), .b(new_n69_), .c(new_n67_), .d(x20), .O(z14));
  ...
  nand2  g70(.a(new_n133_), .b(new_n69_), .O(z17));
  nand2  g71(.a(new_n64_), .b(x08), .O(new_n135_));
  oai21  g72(.a(new_n64_), .b(x04), .c(new_n135_), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n80_), .O(new_n137_));
  nor2   g74(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g75(.a(new_n138_), .b(new_n137_), .c(new_n78_), .O(z18));
  oai21  g76(.a(new_n115_), .b(new_n72_), .c(new_n69_), .O(new_n140_));
  oai21  g77(.a(new_n80_), .b(x27), .c(new_n140_), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n71_), .c(new_n114_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(new_n69_), .O(z20));
  zero   g80(.O(z08));
  inv1   g81(.a(new_n118_), .O(z19));
endmodule
