...
module FAU ( 
  ...
  oai22  g039(.a(x40), .b(x39), .c(new_n82_), .d(new_n91_), .O(new_n102_));
  ...
  nor2   g067(.a(new_n65_), .b(new_n91_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n63_), .O(new_n131_));
  ...
  nand3  g073(.a(new_n135_), .b(x35), .c(new_n82_), .O(new_n136_));
  ...
  nand3  g078(.a(new_n140_), .b(new_n79_), .c(new_n133_), .O(new_n141_));
  ...
  nand2  g083(.a(new_n74_), .b(x39), .O(new_n146_));
  inv1   g084(.a(new_n146_), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n71_), .c(new_n74_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(new_n68_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n145_), .c(new_n64_), .O(z12));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n71_), .c(new_n63_), .O(new_n162_));
  ...
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(new_n74_), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n147_), .c(new_n164_), .O(new_n169_));
  nand2  g107(.a(x39), .b(new_n91_), .O(new_n170_));
  inv1   g108(.a(x35), .O(new_n171_));
  nand4  g109(.a(x40), .b(new_n65_), .c(new_n171_), .d(x28), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(x32), .O(new_n173_));
  nand2  g111(.a(new_n166_), .b(x40), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n146_), .O(new_n175_));
  aoi22  g113(.a(new_n175_), .b(new_n68_), .c(new_n173_), .d(new_n79_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n169_), .O(z14));
  ...
  oai21  g124(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n63_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n138_), .d(new_n133_), .O(z18));
  ...
  nand3  g132(.a(new_n194_), .b(new_n79_), .c(new_n133_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n64_), .O(z20));
  nand2  g134(.a(new_n141_), .b(new_n64_), .O(z19));
endmodule
