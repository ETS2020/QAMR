...
module FAU ( 
  ...
  nor2   g027(.a(new_n81_), .b(x28), .O(new_n90_));
  ...
  nor2   g059(.a(x40), .b(x08), .O(new_n122_));
  ...
  oai21  g073(.a(new_n68_), .b(new_n73_), .c(new_n90_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(x40), .O(new_n137_));
  inv1   g075(.a(x08), .O(new_n138_));
  nand2  g076(.a(x35), .b(new_n104_), .O(new_n139_));
  nand2  g077(.a(x27), .b(new_n73_), .O(new_n140_));
  ...
  nand3  g082(.a(new_n69_), .b(new_n82_), .c(new_n81_), .O(new_n145_));
  ...
  nand4  g099(.a(new_n131_), .b(x39), .c(new_n152_), .d(new_n73_), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(new_n161_), .c(new_n64_), .O(z13));
  oai21  g101(.a(new_n94_), .b(x04), .c(x40), .O(new_n164_));
  nor2   g102(.a(new_n122_), .b(x13), .O(new_n165_));
  aoi22  g103(.a(new_n165_), .b(new_n164_), .c(x35), .d(x28), .O(new_n166_));
  nand4  g104(.a(new_n81_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n167_));
  ...
  nand4  g108(.a(new_n153_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n171_));
  ...
  aoi21  g112(.a(x27), .b(new_n138_), .c(x40), .O(new_n175_));
  nor2   g113(.a(new_n130_), .b(new_n94_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n172_), .c(new_n63_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n68_), .c(new_n175_), .O(new_n178_));
  ...
  oai21  g126(.a(x27), .b(new_n138_), .c(new_n140_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(x35), .c(new_n104_), .O(new_n190_));
  nand2  g128(.a(new_n135_), .b(x40), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n79_), .d(new_n134_), .O(z18));
  inv1   g131(.a(new_n143_), .O(z19));
  oai21  g132(.a(new_n81_), .b(new_n68_), .c(new_n138_), .O(new_n195_));
  oai21  g133(.a(new_n104_), .b(x27), .c(x35), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n135_), .c(x40), .O(new_n197_));
