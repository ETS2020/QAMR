...
module FAU ( 
  ...
  oai22  g059(.a(new_n121_), .b(new_n119_), .c(x40), .d(new_n120_), .O(new_n122_));
  ...
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n71_), .d(new_n92_), .O(new_n137_));
  ...
  nand4  g085(.a(new_n147_), .b(x40), .c(new_n145_), .d(new_n118_), .O(new_n148_));
  ...
  nand3  g096(.a(x40), .b(new_n145_), .c(new_n118_), .O(new_n159_));
  ...
  nand2  g123(.a(x39), .b(new_n76_), .O(new_n186_));
