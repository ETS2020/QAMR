...
module FAU ( 
  ...
  aoi21  g027(.a(new_n89_), .b(x04), .c(new_n81_), .O(z01));
  ...
  nand3  g034(.a(new_n96_), .b(new_n93_), .c(x40), .O(new_n97_));
  nand2  g035(.a(new_n97_), .b(x39), .O(new_n98_));
  oai21  g036(.a(new_n76_), .b(x39), .c(new_n98_), .O(z02));
  ...
  nand2  g059(.a(new_n82_), .b(new_n121_), .O(z08));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n87_), .O(new_n128_));
  inv1   g066(.a(x06), .O(new_n129_));
  nor3   g067(.a(new_n81_), .b(new_n70_), .c(new_n129_), .O(new_n130_));
  ...
  oai21  g076(.a(new_n138_), .b(new_n94_), .c(new_n137_), .O(new_n139_));
  inv1   g077(.a(x08), .O(new_n140_));
  nand2  g078(.a(x39), .b(x04), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(x35), .c(new_n86_), .d(x27), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n84_), .c(new_n136_), .O(new_n145_));
  ...
  nand3  g089(.a(new_n151_), .b(new_n71_), .c(new_n70_), .O(new_n152_));
  aoi21  g090(.a(x40), .b(x27), .c(x39), .O(new_n153_));
  nand2  g091(.a(new_n141_), .b(x40), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(new_n64_), .c(new_n153_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n152_), .c(new_n150_), .O(z12));
  ...
  nand3  g105(.a(new_n133_), .b(new_n157_), .c(new_n65_), .O(new_n168_));
  ...
  nand4  g109(.a(new_n171_), .b(new_n141_), .c(new_n77_), .d(new_n157_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand3  g111(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n174_));
  oai21  g112(.a(new_n76_), .b(x27), .c(new_n174_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n85_), .c(new_n84_), .O(new_n176_));
  oai22  g114(.a(new_n149_), .b(new_n73_), .c(x13), .d(x04), .O(new_n177_));
  nand2  g115(.a(new_n72_), .b(x27), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n121_), .c(new_n81_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n177_), .c(new_n176_), .d(new_n173_), .O(z14));
  nand4  g118(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n82_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand4  g121(.a(new_n82_), .b(new_n183_), .c(x22), .d(x01), .O(new_n184_));
  ...
  nand2  g130(.a(new_n84_), .b(new_n136_), .O(new_n193_));
  aoi21  g131(.a(new_n192_), .b(new_n86_), .c(new_n193_), .O(new_n194_));
  oai22  g132(.a(new_n194_), .b(new_n81_), .c(new_n92_), .d(new_n121_), .O(z18));
  inv1   g133(.a(new_n137_), .O(new_n196_));
  oai21  g134(.a(new_n66_), .b(new_n64_), .c(new_n140_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n196_), .c(new_n197_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n84_), .c(new_n136_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n82_), .O(z20));
