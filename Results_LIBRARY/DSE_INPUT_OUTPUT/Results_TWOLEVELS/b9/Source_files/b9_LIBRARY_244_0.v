...
module FAU ( 
  ...
  aoi21  g037(.a(new_n99_), .b(new_n97_), .c(new_n82_), .O(z03));
  nand2  g038(.a(new_n70_), .b(new_n64_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n97_), .c(new_n80_), .d(new_n98_), .O(z04));
  aoi21  g040(.a(x28), .b(x27), .c(x37), .O(new_n103_));
  nor2   g041(.a(new_n103_), .b(new_n82_), .O(z05));
  aoi21  g042(.a(new_n80_), .b(new_n64_), .c(new_n85_), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(x37), .c(new_n80_), .O(z06));
  ...
  nand2  g056(.a(new_n80_), .b(new_n118_), .O(z08));
  nand4  g057(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n80_), .O(z09));
  nand3  g059(.a(new_n80_), .b(x37), .c(x06), .O(new_n122_));
  aoi21  g060(.a(x40), .b(x39), .c(x07), .O(new_n123_));
  inv1   g061(.a(x39), .O(new_n124_));
  nand3  g062(.a(x40), .b(new_n124_), .c(x07), .O(new_n125_));
  oai21  g063(.a(new_n123_), .b(new_n78_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n87_), .c(new_n65_), .O(new_n127_));
  ...
  nand2  g072(.a(new_n80_), .b(new_n64_), .O(new_n135_));
  ...
  nand2  g079(.a(new_n79_), .b(x05), .O(new_n142_));
  ...
  nor2   g086(.a(new_n79_), .b(x27), .O(new_n149_));
  ...
  aoi21  g090(.a(x39), .b(new_n65_), .c(new_n79_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n151_), .c(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n150_), .c(new_n80_), .O(z12));
  inv1   g093(.a(x13), .O(new_n156_));
  nand2  g094(.a(x36), .b(x35), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x28), .c(new_n79_), .O(new_n158_));
  ...
  nor2   g102(.a(new_n131_), .b(x13), .O(new_n165_));
  ...
  aoi21  g109(.a(new_n171_), .b(new_n169_), .c(new_n79_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n151_), .c(new_n168_), .O(new_n173_));
  ...
  oai22  g135(.a(new_n197_), .b(new_n82_), .c(new_n92_), .d(new_n118_), .O(z18));
  nand2  g136(.a(x28), .b(new_n64_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n142_), .d(new_n141_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n66_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n135_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n83_), .O(new_n203_));
