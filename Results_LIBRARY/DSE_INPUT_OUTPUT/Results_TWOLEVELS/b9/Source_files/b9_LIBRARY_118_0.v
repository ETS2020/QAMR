...
module FAU ( 
  ...
  nand2  g036(.a(new_n81_), .b(x14), .O(new_n99_));
  ...
  nand4  g040(.a(new_n102_), .b(new_n101_), .c(new_n82_), .d(x21), .O(z03));
  ...
  oai22  g046(.a(x40), .b(x14), .c(new_n86_), .d(new_n64_), .O(new_n109_));
  nor2   g047(.a(new_n109_), .b(x37), .O(z06));
  ...
  nand2  g055(.a(new_n117_), .b(new_n80_), .O(new_n118_));
  oai21  g056(.a(new_n115_), .b(x31), .c(new_n118_), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(x03), .O(new_n120_));
  nand2  g058(.a(new_n120_), .b(new_n82_), .O(z07));
  ...
  oai21  g063(.a(new_n75_), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  ...
  aoi21  g072(.a(new_n134_), .b(x06), .c(new_n104_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(z10));
  inv1   g074(.a(x09), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x40), .c(new_n82_), .d(new_n64_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x40), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n99_), .O(new_n142_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n159_), .c(new_n81_), .O(new_n163_));
  nor2   g101(.a(new_n162_), .b(new_n80_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n130_), .b(new_n156_), .c(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(z13));
  inv1   g105(.a(new_n99_), .O(new_n168_));
  ...
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n81_), .O(new_n173_));
  ...
  nand4  g120(.a(new_n82_), .b(x34), .c(x27), .d(x26), .O(new_n183_));
  ...
  nand2  g131(.a(new_n84_), .b(new_n137_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n86_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n104_), .c(new_n93_), .d(new_n75_), .O(z18));
  inv1   g134(.a(new_n147_), .O(z19));
  nand2  g135(.a(x28), .b(new_n64_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n141_), .d(new_n99_), .O(new_n199_));
  nand2  g137(.a(new_n82_), .b(new_n64_), .O(new_n200_));
