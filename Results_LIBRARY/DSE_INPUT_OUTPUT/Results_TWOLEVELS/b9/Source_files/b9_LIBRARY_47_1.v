...
module FAU ( 
  ...
  nand2  g032(.a(new_n65_), .b(new_n91_), .O(new_n95_));
  ...
  aoi21  g039(.a(new_n64_), .b(new_n91_), .c(new_n82_), .O(new_n102_));
  ...
  aoi21  g060(.a(new_n80_), .b(new_n79_), .c(new_n74_), .O(new_n123_));
  ...
  nand2  g071(.a(new_n64_), .b(new_n91_), .O(new_n134_));
  ...
  oai21  g080(.a(new_n63_), .b(new_n71_), .c(x40), .O(new_n143_));
  ...
  nand4  g094(.a(new_n123_), .b(x39), .c(new_n146_), .d(new_n71_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  aoi21  g096(.a(new_n146_), .b(new_n71_), .c(new_n63_), .O(new_n159_));
  nor2   g097(.a(x19), .b(x18), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n67_), .c(x27), .d(x20), .O(new_n161_));
  oai21  g099(.a(new_n159_), .b(new_n74_), .c(new_n161_), .O(new_n162_));
  ...
  nand4  g104(.a(new_n166_), .b(x39), .c(new_n80_), .d(new_n79_), .O(new_n167_));
  ...
  oai22  g114(.a(new_n83_), .b(x27), .c(new_n74_), .d(new_n130_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x08), .O(new_n178_));
  nor2   g116(.a(new_n91_), .b(x04), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n129_), .c(x09), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n178_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g119(.a(x35), .O(new_n182_));
  aoi21  g120(.a(x28), .b(new_n91_), .c(new_n182_), .O(new_n183_));
  nor2   g121(.a(new_n183_), .b(new_n131_), .O(new_n184_));
  nand2  g122(.a(x39), .b(new_n182_), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n134_), .c(x08), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n79_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(x09), .O(z20));
  nor2   g126(.a(new_n138_), .b(x09), .O(z19));
endmodule
