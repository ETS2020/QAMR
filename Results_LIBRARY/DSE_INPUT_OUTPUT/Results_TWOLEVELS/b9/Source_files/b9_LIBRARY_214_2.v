...
module FAU ( 
  ...
  aoi22  g075(.a(new_n137_), .b(x40), .c(new_n64_), .d(new_n92_), .O(new_n138_));
  ...
  oai21  g082(.a(new_n63_), .b(new_n71_), .c(x39), .O(new_n145_));
  ...
  nand4  g093(.a(new_n67_), .b(new_n116_), .c(x20), .d(new_n153_), .O(new_n156_));
  ...
  oai21  g101(.a(new_n161_), .b(new_n116_), .c(new_n163_), .O(new_n164_));
  ...
  nand2  g117(.a(x39), .b(x29), .O(new_n180_));
  oai21  g118(.a(new_n83_), .b(x27), .c(new_n180_), .O(new_n181_));
  ...
  nand4  g123(.a(new_n185_), .b(new_n182_), .c(new_n64_), .d(new_n79_), .O(z18));
  nand2  g124(.a(new_n140_), .b(new_n64_), .O(z19));
  aoi22  g125(.a(new_n180_), .b(x28), .c(new_n64_), .d(new_n91_), .O(new_n188_));
  inv1   g126(.a(x35), .O(new_n189_));
  nand2  g127(.a(new_n89_), .b(x40), .O(new_n190_));
