...
module FAU ( 
  ...
  aoi21  g042(.a(new_n81_), .b(new_n64_), .c(new_n85_), .O(new_n105_));
  ...
  nand2  g060(.a(new_n122_), .b(x32), .O(new_n123_));
  ...
  nand3  g065(.a(new_n76_), .b(x30), .c(x05), .O(new_n128_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n80_), .c(new_n84_), .O(new_n147_));
  ...
  nand4  g094(.a(new_n72_), .b(new_n84_), .c(x20), .d(new_n154_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  aoi21  g097(.a(new_n84_), .b(new_n83_), .c(new_n80_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n149_), .d(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nand3  g100(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n163_));
  nand3  g101(.a(new_n150_), .b(new_n83_), .c(x28), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(x40), .c(x32), .O(new_n165_));
  nand3  g103(.a(x39), .b(new_n149_), .c(new_n65_), .O(new_n166_));
  and2   g104(.a(new_n166_), .b(x40), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n165_), .c(new_n163_), .O(new_n168_));
  aoi21  g106(.a(x40), .b(x30), .c(x27), .O(new_n169_));
  oai21  g107(.a(x30), .b(new_n85_), .c(x40), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n66_), .O(new_n171_));
  nand2  g109(.a(new_n80_), .b(new_n85_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(x37), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n169_), .c(new_n84_), .O(new_n174_));
  nand3  g112(.a(new_n166_), .b(new_n146_), .c(x40), .O(new_n175_));
  ...
  nor2   g126(.a(new_n96_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n137_), .d(new_n133_), .O(z18));
  inv1   g128(.a(new_n134_), .O(new_n191_));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n93_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n83_), .c(new_n133_), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n81_), .O(z20));
  nand2  g134(.a(new_n140_), .b(new_n81_), .O(z19));
endmodule
