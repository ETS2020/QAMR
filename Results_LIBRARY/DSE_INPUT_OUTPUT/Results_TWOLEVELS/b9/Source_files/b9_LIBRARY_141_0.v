...
module FAU ( 
  ...
  oai22  g045(.a(x40), .b(x26), .c(new_n87_), .d(new_n64_), .O(new_n108_));
  ...
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n84_), .O(new_n132_));
  ...
  nand3  g081(.a(new_n143_), .b(new_n85_), .c(new_n134_), .O(new_n144_));
  ...
  nand3  g088(.a(new_n150_), .b(new_n81_), .c(x26), .O(new_n151_));
  ...
  nand4  g105(.a(new_n154_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n168_));
  nand3  g106(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n81_), .O(new_n171_));
  ...
  nand4  g131(.a(new_n193_), .b(new_n190_), .c(new_n82_), .d(new_n85_), .O(z18));
  nand2  g132(.a(new_n144_), .b(new_n82_), .O(z19));
  nor2   g133(.a(x40), .b(x35), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n94_), .c(x26), .O(new_n197_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n85_), .c(new_n134_), .O(new_n203_));
