...
module FAU ( 
  ...
  oai21  g044(.a(x40), .b(new_n84_), .c(new_n85_), .O(new_n107_));
  ...
  nor2   g060(.a(x40), .b(x32), .O(new_n123_));
  ...
  aoi21  g068(.a(new_n84_), .b(new_n83_), .c(new_n76_), .O(new_n131_));
  ...
  aoi21  g072(.a(new_n134_), .b(new_n106_), .c(x08), .O(new_n135_));
  inv1   g073(.a(new_n86_), .O(new_n136_));
  nand2  g074(.a(x39), .b(x29), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(x40), .c(new_n123_), .O(new_n138_));
  ...
  oai21  g097(.a(new_n76_), .b(new_n83_), .c(new_n84_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n151_), .d(new_n65_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n159_), .c(new_n81_), .O(z13));
  nand3  g100(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n163_));
  nand4  g101(.a(new_n152_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(z08), .c(new_n151_), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  oai21  g104(.a(new_n76_), .b(new_n83_), .c(new_n64_), .O(new_n167_));
  oai21  g105(.a(x30), .b(new_n85_), .c(x40), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n66_), .c(new_n76_), .d(new_n85_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(x37), .c(new_n167_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n84_), .O(new_n171_));
  oai21  g109(.a(new_n145_), .b(new_n76_), .c(new_n151_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n148_), .c(new_n97_), .O(new_n173_));
  ...
  oai21  g122(.a(new_n86_), .b(x27), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n64_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n136_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n81_), .d(new_n83_), .O(z18));
  nor2   g127(.a(new_n141_), .b(x09), .O(z19));
  oai22  g128(.a(new_n76_), .b(x35), .c(new_n85_), .d(x27), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n137_), .O(new_n192_));
  nor2   g130(.a(x40), .b(x35), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n94_), .c(new_n84_), .O(new_n194_));
  inv1   g132(.a(x08), .O(new_n195_));
  nand2  g133(.a(x35), .b(x27), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(x40), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n76_), .b(x28), .c(new_n64_), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n197_), .c(new_n194_), .d(new_n192_), .O(new_n199_));
