...
module FAU ( 
  ...
  nor2   g072(.a(new_n92_), .b(new_n71_), .O(new_n135_));
  ...
  nand2  g083(.a(z08), .b(new_n71_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n66_), .c(new_n65_), .O(new_n147_));
  aoi21  g085(.a(x27), .b(x23), .c(x40), .O(new_n148_));
  nand2  g086(.a(new_n137_), .b(x39), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(new_n92_), .c(new_n148_), .O(new_n150_));
  ...
  nand4  g097(.a(new_n67_), .b(x23), .c(x20), .d(new_n157_), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x18), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n159_), .c(x27), .O(new_n162_));
  nand3  g100(.a(new_n127_), .b(new_n152_), .c(new_n71_), .O(new_n163_));
  ...
  nand2  g104(.a(new_n152_), .b(new_n71_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x40), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(new_n166_), .c(z08), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n165_), .O(new_n170_));
  inv1   g108(.a(x35), .O(new_n171_));
  nand3  g109(.a(new_n65_), .b(new_n171_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n80_), .c(new_n79_), .O(new_n174_));
  oai21  g112(.a(new_n74_), .b(x27), .c(new_n67_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n167_), .O(new_n176_));
  aoi21  g114(.a(new_n116_), .b(new_n68_), .c(new_n63_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n176_), .c(new_n174_), .d(new_n170_), .O(z14));
  ...
  nand2  g124(.a(new_n92_), .b(x08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(new_n171_), .O(new_n188_));
  nand2  g126(.a(new_n79_), .b(new_n133_), .O(new_n189_));
  aoi21  g127(.a(new_n188_), .b(new_n82_), .c(new_n189_), .O(new_n190_));
  oai22  g128(.a(new_n190_), .b(new_n63_), .c(new_n116_), .d(new_n89_), .O(z18));
  inv1   g129(.a(new_n134_), .O(new_n192_));
  oai21  g130(.a(new_n171_), .b(new_n92_), .c(new_n91_), .O(new_n193_));
  aoi21  g131(.a(x28), .b(new_n92_), .c(new_n171_), .O(new_n194_));
  ...
  nand2  g135(.a(new_n141_), .b(new_n64_), .O(z19));
endmodule
