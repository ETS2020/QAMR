...
module FAU ( 
  ...
  nor2   g030(.a(x40), .b(x20), .O(new_n93_));
  ...
  inv1   g041(.a(x20), .O(new_n104_));
  oai22  g042(.a(x40), .b(new_n104_), .c(new_n82_), .d(new_n68_), .O(new_n105_));
  ...
  nand3  g065(.a(new_n127_), .b(new_n84_), .c(new_n73_), .O(new_n128_));
  ...
  nand4  g071(.a(new_n133_), .b(x39), .c(x05), .d(new_n73_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n131_), .O(z10));
  nand2  g073(.a(new_n64_), .b(new_n68_), .O(new_n136_));
  oai21  g074(.a(new_n83_), .b(x04), .c(x40), .O(new_n137_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n94_), .O(new_n143_));
  ...
  nand2  g089(.a(new_n151_), .b(new_n104_), .O(new_n152_));
  ...
  nand3  g097(.a(new_n159_), .b(x20), .c(new_n158_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x18), .c(new_n157_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x27), .O(new_n162_));
  nand4  g100(.a(new_n133_), .b(x39), .c(new_n154_), .d(new_n73_), .O(new_n163_));
  nand3  g101(.a(new_n163_), .b(new_n162_), .c(new_n64_), .O(z13));
  oai21  g102(.a(new_n71_), .b(new_n63_), .c(x20), .O(new_n165_));
  oai21  g103(.a(new_n124_), .b(x04), .c(new_n165_), .O(new_n166_));
  ...
  oai21  g107(.a(x19), .b(x18), .c(new_n169_), .O(new_n170_));
  nor2   g108(.a(new_n63_), .b(new_n154_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n132_), .c(new_n68_), .O(new_n172_));
  nand2  g110(.a(new_n159_), .b(x20), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x13), .O(new_n174_));
  nand2  g112(.a(new_n155_), .b(new_n104_), .O(new_n175_));
  oai21  g113(.a(x37), .b(x35), .c(new_n175_), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n174_), .c(new_n172_), .O(new_n178_));
  inv1   g116(.a(new_n178_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n170_), .c(new_n166_), .d(x40), .O(z14));
  ...
  oai22  g127(.a(new_n118_), .b(new_n140_), .c(new_n83_), .d(x27), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n68_), .b(x04), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n139_), .c(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n64_), .d(new_n79_), .O(z18));
  nor2   g132(.a(new_n144_), .b(x09), .O(z19));
  aoi21  g133(.a(x28), .b(new_n68_), .c(new_n146_), .O(new_n196_));
  aoi21  g134(.a(new_n141_), .b(new_n94_), .c(new_n196_), .O(new_n197_));
  nand2  g135(.a(x40), .b(new_n146_), .O(new_n198_));
  aoi21  g136(.a(new_n198_), .b(new_n136_), .c(x08), .O(new_n199_));
