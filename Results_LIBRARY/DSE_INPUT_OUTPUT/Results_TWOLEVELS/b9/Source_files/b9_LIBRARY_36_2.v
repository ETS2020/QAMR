...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x07), .O(new_n64_));
  ...
  nor2   g032(.a(x40), .b(x07), .O(new_n95_));
  ...
  oai22  g062(.a(new_n120_), .b(new_n124_), .c(x39), .d(new_n106_), .O(new_n125_));
  ...
  aoi21  g076(.a(new_n138_), .b(x40), .c(new_n95_), .O(new_n139_));
  ...
  nand3  g082(.a(new_n69_), .b(new_n81_), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n73_), .c(new_n71_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(x40), .O(new_n148_));
  nor2   g086(.a(new_n71_), .b(x40), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n106_), .O(new_n150_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n155_), .c(new_n63_), .O(new_n160_));
  nor2   g098(.a(new_n159_), .b(x07), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n160_), .c(x27), .O(new_n162_));
  aoi21  g100(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n163_));
  nand4  g101(.a(new_n163_), .b(x39), .c(new_n152_), .d(new_n73_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n162_), .O(z13));
  inv1   g103(.a(x39), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(x04), .c(x40), .O(new_n167_));
  nor2   g105(.a(new_n95_), .b(x13), .O(new_n168_));
  aoi22  g106(.a(new_n168_), .b(new_n167_), .c(x35), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n144_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(new_n69_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n157_), .c(new_n156_), .O(new_n173_));
  nand4  g111(.a(new_n153_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n174_));
  nor2   g112(.a(new_n166_), .b(x13), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n174_), .c(x40), .d(new_n73_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n173_), .O(new_n177_));
  aoi21  g115(.a(x27), .b(new_n106_), .c(x40), .O(new_n178_));
  nand3  g116(.a(x39), .b(new_n152_), .c(new_n73_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x40), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n127_), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n68_), .c(new_n178_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n177_), .c(new_n172_), .O(z14));
  ...
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(new_n144_), .O(new_n194_));
  ...
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n144_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n139_), .O(new_n200_));
  nand2  g138(.a(x40), .b(new_n144_), .O(new_n201_));
  aoi21  g139(.a(new_n201_), .b(new_n133_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n200_), .c(new_n79_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(x09), .O(z20));
  nor2   g142(.a(new_n142_), .b(x09), .O(z19));
endmodule
