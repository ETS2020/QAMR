...
module FAU ( 
  ...
  nand2  g045(.a(new_n80_), .b(new_n64_), .O(new_n108_));
  oai21  g046(.a(x40), .b(x39), .c(new_n91_), .O(new_n109_));
  ...
  nand2  g082(.a(new_n144_), .b(new_n97_), .O(new_n145_));
  nand2  g083(.a(x27), .b(x04), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(x35), .c(new_n91_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  oai21  g086(.a(new_n142_), .b(x08), .c(new_n148_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n82_), .c(new_n140_), .O(new_n150_));
  ...
  aoi22  g091(.a(new_n72_), .b(x27), .c(x40), .d(new_n65_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n153_), .c(x39), .O(new_n155_));
  nand2  g093(.a(new_n72_), .b(x27), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(x40), .c(new_n78_), .O(new_n157_));
  ...
  nand4  g115(.a(x39), .b(new_n70_), .c(new_n66_), .d(x28), .O(new_n178_));
  nand2  g116(.a(x40), .b(new_n64_), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(x32), .O(new_n180_));
  oai21  g118(.a(new_n175_), .b(new_n78_), .c(new_n97_), .O(new_n181_));
  aoi22  g119(.a(new_n181_), .b(new_n156_), .c(new_n180_), .d(new_n82_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n177_), .O(z14));
  inv1   g121(.a(x12), .O(new_n184_));
  nand4  g122(.a(new_n80_), .b(x34), .c(x27), .d(x26), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n184_), .O(z15));
  inv1   g124(.a(x23), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(x22), .c(x01), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n80_), .O(z16));
  inv1   g127(.a(x24), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(x23), .c(x22), .d(x01), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n80_), .O(z17));
  ...
  nand2  g133(.a(new_n82_), .b(new_n140_), .O(new_n196_));
  aoi21  g134(.a(new_n195_), .b(new_n91_), .c(new_n196_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n99_), .c(new_n89_), .d(new_n122_), .O(z18));
  nand2  g136(.a(new_n150_), .b(new_n80_), .O(z19));
  oai22  g137(.a(new_n78_), .b(x35), .c(new_n91_), .d(x27), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n143_), .O(new_n201_));
  nor2   g139(.a(new_n78_), .b(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n171_), .c(new_n66_), .O(new_n203_));
  nor2   g141(.a(new_n99_), .b(x08), .O(new_n204_));
  nor2   g142(.a(x39), .b(new_n91_), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n204_), .c(new_n64_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n203_), .c(new_n201_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n82_), .c(new_n140_), .O(new_n208_));
