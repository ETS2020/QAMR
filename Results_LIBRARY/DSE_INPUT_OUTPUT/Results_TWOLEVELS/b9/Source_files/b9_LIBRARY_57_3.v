...
module FAU ( 
  ...
  aoi21  g23(.a(new_n85_), .b(new_n65_), .c(new_n78_), .O(z05));
  ...
  aoi21  g50(.a(new_n64_), .b(new_n113_), .c(new_n72_), .O(new_n114_));
  aoi21  g51(.a(x27), .b(x04), .c(x28), .O(new_n115_));
  oai21  g52(.a(new_n114_), .b(new_n78_), .c(new_n115_), .O(new_n116_));
  nand3  g53(.a(new_n116_), .b(new_n71_), .c(new_n112_), .O(new_n117_));
  nand2  g54(.a(new_n117_), .b(z02), .O(z11));
  nor2   g55(.a(new_n78_), .b(new_n67_), .O(z12));
  nand2  g56(.a(new_n66_), .b(new_n65_), .O(new_n120_));
  nand4  g57(.a(z02), .b(new_n120_), .c(x27), .d(x20), .O(new_n121_));
  nor3   g58(.a(new_n121_), .b(x19), .c(x18), .O(z13));
  nor2   g59(.a(x19), .b(x18), .O(new_n123_));
  nand4  g60(.a(new_n123_), .b(z02), .c(new_n67_), .d(x20), .O(z14));
  ...
  inv1   g69(.a(x28), .O(new_n133_));
  nand2  g70(.a(x27), .b(new_n106_), .O(new_n134_));
  oai21  g71(.a(x27), .b(new_n113_), .c(new_n134_), .O(new_n135_));
  nand3  g72(.a(new_n135_), .b(x35), .c(new_n133_), .O(new_n136_));
  nor2   g73(.a(x30), .b(x09), .O(new_n137_));
  aoi21  g74(.a(new_n137_), .b(new_n136_), .c(new_n78_), .O(z18));
  oai21  g75(.a(x28), .b(new_n113_), .c(new_n64_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(x35), .O(new_n140_));
  nand4  g77(.a(new_n140_), .b(z02), .c(new_n71_), .d(new_n112_), .O(new_n141_));
