...
module FAU ( 
  ...
  nand2  g039(.a(new_n64_), .b(new_n68_), .O(new_n102_));
  inv1   g040(.a(x31), .O(new_n103_));
  oai21  g041(.a(x40), .b(new_n103_), .c(new_n82_), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n102_), .c(x37), .O(z06));
  ...
  nand4  g047(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n103_), .O(new_n110_));
  ...
  nor2   g060(.a(x40), .b(x31), .O(new_n123_));
  ...
  aoi21  g075(.a(new_n137_), .b(new_n102_), .c(x08), .O(new_n138_));
  inv1   g076(.a(new_n83_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x40), .c(new_n123_), .O(new_n141_));
  ...
  aoi21  g102(.a(new_n164_), .b(new_n73_), .c(new_n65_), .O(new_n165_));
  ...
  nand3  g106(.a(x39), .b(new_n154_), .c(new_n73_), .O(new_n169_));
  inv1   g107(.a(new_n169_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n168_), .c(new_n63_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n123_), .c(new_n167_), .O(new_n172_));
  ...
  nand3  g115(.a(new_n177_), .b(new_n172_), .c(new_n152_), .O(z14));
  ...
  inv1   g125(.a(z08), .O(new_n188_));
  nand2  g126(.a(x27), .b(new_n73_), .O(new_n189_));
  nand2  g127(.a(new_n68_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n189_), .c(new_n146_), .O(new_n191_));
  ...
  oai22  g132(.a(new_n194_), .b(new_n65_), .c(new_n188_), .d(new_n89_), .O(z18));
  oai22  g133(.a(new_n63_), .b(x35), .c(new_n82_), .d(x27), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n140_), .O(new_n197_));
  oai22  g135(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n103_), .O(new_n199_));
  nand2  g137(.a(x35), .b(x27), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(x40), .c(new_n91_), .O(new_n201_));
  nand3  g139(.a(new_n63_), .b(x28), .c(new_n68_), .O(new_n202_));
  nand4  g140(.a(new_n202_), .b(new_n201_), .c(new_n199_), .d(new_n197_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n79_), .c(new_n192_), .O(new_n204_));
