...
module FAU ( 
  ...
  aoi21  g034(.a(new_n96_), .b(new_n93_), .c(new_n89_), .O(new_n97_));
  nand3  g035(.a(new_n64_), .b(new_n91_), .c(x04), .O(new_n98_));
  nand2  g036(.a(new_n98_), .b(x39), .O(new_n99_));
  oai21  g037(.a(new_n99_), .b(new_n97_), .c(x07), .O(new_n100_));
  ...
  nand4  g045(.a(new_n107_), .b(new_n103_), .c(new_n81_), .d(new_n104_), .O(z04));
  aoi21  g046(.a(x28), .b(x27), .c(x37), .O(new_n109_));
  nor2   g047(.a(new_n109_), .b(new_n102_), .O(z05));
  aoi21  g048(.a(new_n81_), .b(new_n64_), .c(new_n94_), .O(new_n111_));
  oai21  g049(.a(new_n111_), .b(x37), .c(new_n81_), .O(z06));
  ...
  aoi21  g062(.a(new_n124_), .b(x07), .c(new_n89_), .O(z08));
  nand4  g063(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n81_), .O(z09));
  inv1   g065(.a(x05), .O(new_n128_));
  nand3  g066(.a(new_n85_), .b(x27), .c(x07), .O(new_n129_));
  nand2  g067(.a(new_n84_), .b(new_n83_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(x40), .c(x39), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(new_n129_), .c(new_n128_), .O(new_n132_));
  nand4  g070(.a(new_n85_), .b(new_n75_), .c(x27), .d(x07), .O(new_n133_));
  inv1   g071(.a(new_n133_), .O(new_n134_));
  oai21  g072(.a(new_n134_), .b(new_n132_), .c(new_n65_), .O(new_n135_));
  nor2   g073(.a(new_n70_), .b(new_n64_), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(x06), .c(new_n102_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(z10));
  nand2  g076(.a(new_n81_), .b(new_n64_), .O(new_n139_));
  nand3  g077(.a(x35), .b(new_n94_), .c(new_n65_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(x07), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(new_n139_), .c(x08), .O(new_n142_));
  inv1   g080(.a(new_n95_), .O(new_n143_));
  nand2  g081(.a(x39), .b(x29), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x07), .c(new_n89_), .O(new_n145_));
  ...
  nor2   g089(.a(new_n89_), .b(x27), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  oai21  g091(.a(x27), .b(new_n65_), .c(x07), .O(new_n154_));
  nand2  g092(.a(new_n154_), .b(x40), .O(new_n155_));
  nand2  g093(.a(new_n76_), .b(new_n65_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n71_), .c(new_n70_), .O(new_n157_));
  nand2  g095(.a(new_n75_), .b(new_n64_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(z12));
  inv1   g097(.a(x13), .O(new_n160_));
  nand2  g098(.a(x36), .b(x35), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(x28), .c(new_n89_), .O(new_n162_));
  ...
  nand4  g106(.a(new_n130_), .b(x39), .c(new_n160_), .d(new_n65_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x07), .O(new_n170_));
  ...
  nand4  g111(.a(new_n161_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  nand3  g113(.a(new_n76_), .b(new_n160_), .c(new_n65_), .O(new_n176_));
  ...
  nand3  g118(.a(new_n176_), .b(new_n71_), .c(new_n70_), .O(new_n181_));
  nand4  g119(.a(x40), .b(x39), .c(new_n160_), .d(new_n65_), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n64_), .c(new_n102_), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n181_), .c(new_n180_), .d(new_n177_), .O(z14));
  ...
  oai22  g131(.a(new_n95_), .b(x27), .c(new_n75_), .d(new_n92_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x08), .O(new_n195_));
  nor2   g133(.a(new_n64_), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n143_), .c(x30), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n195_), .c(new_n81_), .d(new_n193_), .O(z18));
  nor2   g136(.a(new_n148_), .b(x09), .O(z19));
  nor2   g137(.a(new_n94_), .b(x27), .O(new_n200_));
  ...
  oai21  g142(.a(new_n204_), .b(new_n203_), .c(new_n91_), .O(new_n205_));
  oai21  g143(.a(new_n200_), .b(new_n66_), .c(new_n89_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n205_), .c(new_n202_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n83_), .c(new_n193_), .O(new_n208_));
