...
module FAU ( 
  ...
  aoi21  g036(.a(new_n65_), .b(new_n91_), .c(x21), .O(new_n99_));
  ...
  oai21  g059(.a(new_n116_), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  ...
  nor2   g065(.a(new_n65_), .b(new_n91_), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(x06), .c(new_n94_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n127_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n132_));
  aoi22  g070(.a(new_n132_), .b(x40), .c(new_n64_), .d(new_n91_), .O(new_n133_));
  nand2  g071(.a(x39), .b(x29), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x40), .O(new_n135_));
  inv1   g073(.a(x13), .O(new_n136_));
  nand2  g074(.a(new_n63_), .b(new_n136_), .O(new_n137_));
  ...
  oai21  g079(.a(new_n133_), .b(x08), .c(new_n141_), .O(new_n142_));
  ...
  aoi21  g086(.a(x39), .b(new_n71_), .c(new_n63_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n68_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n147_), .c(new_n64_), .O(z12));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n63_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n136_), .d(new_n71_), .O(new_n154_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n71_), .c(new_n94_), .O(new_n162_));
  ...
  nand3  g103(.a(x39), .b(new_n136_), .c(new_n71_), .O(new_n166_));
  ...
  nand2  g111(.a(new_n166_), .b(new_n68_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand3  g114(.a(new_n68_), .b(new_n63_), .c(new_n136_), .O(new_n177_));
  ...
  nand2  g128(.a(new_n78_), .b(new_n131_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n81_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n94_), .c(new_n116_), .d(new_n88_), .O(z18));
  inv1   g131(.a(new_n143_), .O(z19));
  oai22  g132(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n136_), .O(new_n196_));
  ...
  nand3  g138(.a(new_n200_), .b(x28), .c(new_n91_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n199_), .c(new_n196_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n78_), .c(new_n131_), .O(new_n203_));
