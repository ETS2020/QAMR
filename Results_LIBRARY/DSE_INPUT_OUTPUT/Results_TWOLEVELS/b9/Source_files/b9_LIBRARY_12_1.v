...
module FAU ( 
  ...
  nand3  g066(.a(new_n128_), .b(x40), .c(x05), .O(new_n129_));
  ...
  nand2  g124(.a(x40), .b(x29), .O(new_n187_));
  ...
  nand2  g134(.a(new_n90_), .b(x39), .O(new_n197_));
