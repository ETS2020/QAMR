...
module FAU ( 
  ...
  nor2   g034(.a(x40), .b(x22), .O(new_n97_));
  ...
  aoi21  g044(.a(new_n81_), .b(new_n64_), .c(new_n86_), .O(new_n107_));
  ...
  aoi21  g061(.a(x40), .b(new_n75_), .c(new_n97_), .O(new_n124_));
  ...
  aoi21  g079(.a(new_n141_), .b(x40), .c(new_n97_), .O(new_n142_));
  ...
  nand4  g120(.a(x40), .b(new_n182_), .c(x22), .d(x01), .O(new_n183_));
  inv1   g121(.a(new_n183_), .O(z16));
  nand3  g122(.a(x23), .b(x22), .c(x01), .O(new_n185_));
  nor3   g123(.a(new_n185_), .b(new_n76_), .c(x24), .O(z17));
