// Benchmark "FAU" written by ABC on Tue Aug 18 17:26:12 2020
...
module FAU ( 
  ...
  oai21  g017(.a(new_n66_), .b(x28), .c(new_n67_), .O(new_n80_));
  ...
  oai21  g025(.a(x35), .b(new_n75_), .c(new_n87_), .O(new_n88_));
  aoi21  g026(.a(new_n88_), .b(x04), .c(new_n75_), .O(new_n89_));
  inv1   g027(.a(x39), .O(new_n90_));
  nor2   g028(.a(x27), .b(x08), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(x04), .c(new_n90_), .O(new_n92_));
  nand4  g030(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(x40), .O(z02));
  ...
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n94_), .O(z03));
  aoi21  g038(.a(new_n98_), .b(new_n64_), .c(x21), .O(new_n101_));
  aoi21  g039(.a(new_n101_), .b(new_n96_), .c(new_n94_), .O(z04));
  aoi21  g040(.a(x28), .b(x27), .c(x37), .O(new_n103_));
  nor2   g041(.a(new_n103_), .b(new_n94_), .O(z05));
  aoi21  g042(.a(new_n76_), .b(new_n64_), .c(new_n87_), .O(new_n105_));
  oai21  g043(.a(new_n105_), .b(x37), .c(new_n76_), .O(z06));
  ...
  nand3  g053(.a(new_n115_), .b(new_n76_), .c(x03), .O(new_n116_));
  ...
  nand2  g058(.a(new_n120_), .b(new_n76_), .O(z09));
  nand3  g059(.a(new_n80_), .b(x07), .c(new_n65_), .O(new_n122_));
  nand2  g060(.a(x37), .b(x06), .O(new_n123_));
  aoi21  g061(.a(new_n123_), .b(new_n122_), .c(new_n94_), .O(new_n124_));
  nand4  g062(.a(new_n80_), .b(x40), .c(x39), .d(x05), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(x04), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n124_), .c(x27), .O(new_n127_));
  inv1   g065(.a(x40), .O(new_n128_));
  aoi21  g066(.a(new_n79_), .b(new_n78_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g071(.a(new_n133_), .b(x35), .c(new_n87_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(x05), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n132_), .c(x08), .O(new_n136_));
  nor2   g074(.a(new_n66_), .b(x28), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x05), .c(new_n128_), .O(new_n139_));
  ...
  oai21  g080(.a(new_n142_), .b(x09), .c(new_n76_), .O(z11));
  inv1   g081(.a(x10), .O(new_n144_));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  nor2   g083(.a(new_n128_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(new_n147_));
  oai21  g085(.a(x27), .b(new_n65_), .c(x05), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x40), .O(new_n149_));
  oai21  g087(.a(new_n90_), .b(x04), .c(x05), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x40), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n95_), .c(new_n98_), .O(new_n152_));
  oai21  g090(.a(x39), .b(new_n75_), .c(x40), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n64_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(new_n152_), .c(new_n149_), .d(new_n147_), .O(z12));
  inv1   g093(.a(x13), .O(new_n156_));
  nand2  g094(.a(x36), .b(x35), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x28), .c(new_n128_), .O(new_n158_));
  ...
  nand2  g103(.a(new_n79_), .b(new_n78_), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(x39), .c(new_n156_), .d(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x05), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x40), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n165_), .O(z13));
  nand3  g108(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n171_));
  nand4  g109(.a(new_n157_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n172_));
  oai21  g110(.a(x13), .b(x04), .c(x40), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n172_), .c(x39), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x05), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x40), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n171_), .O(new_n177_));
  nand3  g115(.a(new_n98_), .b(new_n66_), .c(x28), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x27), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n79_), .c(new_n78_), .O(new_n180_));
  oai22  g118(.a(new_n146_), .b(new_n70_), .c(x13), .d(x04), .O(new_n181_));
  oai21  g119(.a(new_n70_), .b(new_n64_), .c(new_n90_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n181_), .c(new_n180_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x05), .O(new_n184_));
  oai21  g122(.a(new_n70_), .b(new_n64_), .c(new_n128_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n184_), .c(new_n177_), .O(z14));
  inv1   g124(.a(x12), .O(new_n187_));
  nand4  g125(.a(new_n76_), .b(x34), .c(x27), .d(x26), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(new_n187_), .O(z15));
  inv1   g127(.a(x23), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(x22), .c(x01), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n76_), .O(z16));
  inv1   g130(.a(x24), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(x23), .c(x22), .d(x01), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n76_), .O(z17));
  inv1   g133(.a(x09), .O(new_n196_));
  nand2  g134(.a(new_n137_), .b(new_n64_), .O(new_n197_));
  ...
  aoi21  g139(.a(new_n201_), .b(new_n137_), .c(x30), .O(new_n202_));
  nand4  g140(.a(new_n202_), .b(new_n200_), .c(new_n76_), .d(new_n196_), .O(z18));
  nor2   g141(.a(new_n142_), .b(x09), .O(z19));
  nor2   g142(.a(x35), .b(new_n75_), .O(new_n205_));
  nor2   g143(.a(new_n87_), .b(x27), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n205_), .c(new_n138_), .O(new_n207_));
  inv1   g145(.a(x08), .O(new_n208_));
  aoi21  g146(.a(x35), .b(x27), .c(new_n75_), .O(new_n209_));
  nor2   g147(.a(x40), .b(x27), .O(new_n210_));
  oai21  g148(.a(new_n210_), .b(new_n209_), .c(new_n208_), .O(new_n211_));
  oai21  g149(.a(new_n206_), .b(new_n66_), .c(new_n128_), .O(new_n212_));
  nand3  g150(.a(new_n212_), .b(new_n211_), .c(new_n207_), .O(new_n213_));
  nand3  g151(.a(new_n213_), .b(new_n78_), .c(new_n196_), .O(new_n214_));
  nand2  g152(.a(new_n214_), .b(new_n76_), .O(z20));
endmodule
