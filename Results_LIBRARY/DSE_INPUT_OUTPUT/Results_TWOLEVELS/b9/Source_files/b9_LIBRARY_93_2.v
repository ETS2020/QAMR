...
module FAU ( 
  ...
  nor2   g022(.a(new_n76_), .b(x28), .O(new_n85_));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n90_), .c(new_n73_), .O(z03));
  aoi21  g033(.a(new_n93_), .b(new_n92_), .c(x21), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n90_), .c(new_n73_), .O(z04));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n73_), .O(z05));
  inv1   g037(.a(x28), .O(new_n100_));
  aoi21  g038(.a(new_n70_), .b(new_n92_), .c(new_n100_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(x37), .c(new_n70_), .O(z06));
  ...
  nand4  g053(.a(new_n70_), .b(x34), .c(x27), .d(x26), .O(new_n116_));
  ...
  nand3  g059(.a(new_n121_), .b(new_n78_), .c(x27), .O(new_n122_));
  nand2  g060(.a(new_n75_), .b(new_n74_), .O(new_n123_));
  ...
  nand2  g071(.a(new_n70_), .b(new_n92_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n100_), .c(new_n118_), .O(new_n135_));
  ...
  nor2   g077(.a(new_n64_), .b(new_n92_), .O(new_n140_));
  nand3  g078(.a(new_n93_), .b(new_n77_), .c(new_n76_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  nor2   g080(.a(new_n140_), .b(new_n118_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(x40), .O(new_n144_));
  oai21  g082(.a(new_n140_), .b(x39), .c(new_n144_), .O(z12));
  ...
  nand2  g089(.a(new_n89_), .b(new_n93_), .O(new_n152_));
  ...
  nand4  g092(.a(new_n152_), .b(new_n130_), .c(x20), .d(new_n151_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  aoi21  g095(.a(new_n75_), .b(new_n74_), .c(new_n69_), .O(new_n158_));
  nand4  g096(.a(new_n158_), .b(x39), .c(new_n146_), .d(new_n118_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  aoi21  g098(.a(new_n146_), .b(new_n118_), .c(new_n69_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n151_), .d(new_n150_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .d(new_n130_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n100_), .c(x27), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x40), .c(new_n75_), .d(new_n74_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n163_), .O(z14));
  nand4  g107(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n70_), .O(z15));
  ...
  nand2  g116(.a(x27), .b(new_n118_), .O(new_n179_));
  ...
  nand2  g120(.a(new_n74_), .b(new_n182_), .O(new_n183_));
  aoi21  g121(.a(new_n181_), .b(new_n100_), .c(new_n183_), .O(new_n184_));
  nand3  g122(.a(new_n83_), .b(x40), .c(x39), .O(new_n185_));
  oai21  g123(.a(new_n184_), .b(new_n73_), .c(new_n185_), .O(z18));
  aoi21  g124(.a(new_n69_), .b(x39), .c(x08), .O(new_n187_));
  aoi21  g125(.a(x39), .b(x29), .c(new_n100_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n187_), .c(new_n92_), .O(new_n189_));
  oai21  g127(.a(new_n83_), .b(new_n69_), .c(x39), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n76_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n74_), .c(new_n182_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n70_), .O(z20));
  buf    g132(.a(x39), .O(z08));
  nor2   g133(.a(new_n138_), .b(x09), .O(z19));
endmodule
