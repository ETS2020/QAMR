...
module FAU ( 
  ...
  nand2  g054(.a(x40), .b(x05), .O(new_n117_));
  ...
  nand3  g058(.a(new_n120_), .b(x40), .c(x05), .O(new_n121_));
  ...
  aoi22  g069(.a(new_n131_), .b(x39), .c(new_n70_), .d(new_n90_), .O(new_n132_));
  ...
  nand4  g083(.a(new_n145_), .b(x40), .c(new_n143_), .d(new_n115_), .O(new_n146_));
  ...
  aoi21  g091(.a(new_n153_), .b(x39), .c(new_n152_), .O(new_n154_));
  ...
  nand4  g100(.a(new_n162_), .b(x39), .c(new_n75_), .d(new_n74_), .O(new_n163_));
  ...
  nand2  g120(.a(x39), .b(new_n137_), .O(new_n183_));
