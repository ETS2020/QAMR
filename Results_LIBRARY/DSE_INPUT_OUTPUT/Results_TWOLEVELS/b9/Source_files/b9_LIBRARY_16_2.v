...
module FAU ( 
  ...
  nor2   g035(.a(x40), .b(x32), .O(new_n98_));
  ...
  nor2   g044(.a(new_n85_), .b(new_n64_), .O(new_n107_));
  inv1   g045(.a(new_n107_), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n81_), .c(new_n70_), .O(z05));
  oai21  g047(.a(new_n107_), .b(x37), .c(new_n81_), .O(z06));
  ...
  nand3  g089(.a(new_n151_), .b(new_n76_), .c(new_n84_), .O(new_n152_));
  ...
  nand4  g099(.a(new_n72_), .b(new_n84_), .c(x20), .d(new_n159_), .O(new_n162_));
  ...
  nor2   g106(.a(new_n75_), .b(x13), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(x40), .d(new_n65_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  aoi21  g109(.a(x40), .b(x30), .c(x27), .O(new_n172_));
  oai21  g110(.a(x30), .b(new_n85_), .c(x40), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n66_), .O(new_n174_));
  nand2  g112(.a(new_n76_), .b(new_n85_), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n174_), .c(x37), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n172_), .c(new_n84_), .O(new_n177_));
  inv1   g115(.a(new_n71_), .O(new_n178_));
  oai21  g116(.a(new_n75_), .b(x04), .c(x40), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n154_), .c(new_n178_), .O(new_n180_));
  nand2  g118(.a(new_n169_), .b(new_n65_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(x40), .c(new_n64_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(new_n81_), .O(new_n183_));
  aoi21  g121(.a(new_n180_), .b(new_n70_), .c(new_n183_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n177_), .c(new_n171_), .O(z14));
  nand4  g123(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n81_), .O(z15));
  inv1   g125(.a(x23), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(x22), .c(x01), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n81_), .O(z16));
  inv1   g128(.a(x24), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(x23), .c(x22), .d(x01), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n81_), .O(z17));
  ...
  aoi21  g137(.a(new_n197_), .b(new_n85_), .c(new_n199_), .O(new_n200_));
  oai22  g138(.a(new_n200_), .b(new_n102_), .c(new_n92_), .d(new_n194_), .O(z18));
  oai21  g139(.a(new_n145_), .b(x09), .c(new_n81_), .O(z19));
  aoi21  g140(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n203_));
  aoi21  g141(.a(new_n142_), .b(new_n99_), .c(new_n203_), .O(new_n204_));
