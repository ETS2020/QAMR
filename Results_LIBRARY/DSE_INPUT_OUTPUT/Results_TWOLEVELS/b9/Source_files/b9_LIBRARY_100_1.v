...
module FAU ( 
  ...
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n73_), .O(z03));
  ...
  aoi21  g037(.a(new_n70_), .b(new_n87_), .c(new_n77_), .O(new_n100_));
  ...
  oai22  g059(.a(new_n114_), .b(new_n120_), .c(x40), .d(new_n121_), .O(new_n122_));
  ...
  aoi21  g065(.a(new_n75_), .b(new_n74_), .c(new_n127_), .O(new_n128_));
  nand4  g066(.a(new_n128_), .b(x39), .c(x05), .d(new_n119_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n126_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  oai21  g069(.a(new_n69_), .b(x29), .c(x40), .O(new_n132_));
  nand2  g070(.a(x27), .b(x04), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x35), .c(new_n77_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n77_), .c(new_n119_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n70_), .d(new_n87_), .O(new_n137_));
  ...
  nor2   g078(.a(new_n64_), .b(new_n87_), .O(new_n141_));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n93_), .b(new_n76_), .c(new_n142_), .O(new_n143_));
  aoi21  g081(.a(new_n143_), .b(x27), .c(x10), .O(new_n144_));
  nor2   g082(.a(new_n141_), .b(new_n119_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x39), .O(new_n146_));
  oai21  g084(.a(new_n141_), .b(x40), .c(new_n146_), .O(z12));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n151_), .c(new_n87_), .O(new_n156_));
  nand2  g094(.a(new_n75_), .b(new_n74_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n148_), .c(new_n119_), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(x39), .c(new_n127_), .O(new_n159_));
  or2    g097(.a(new_n159_), .b(new_n156_), .O(z13));
  aoi21  g098(.a(new_n148_), .b(new_n119_), .c(new_n69_), .O(new_n161_));
  nand4  g099(.a(x27), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n162_));
  oai22  g100(.a(new_n162_), .b(new_n64_), .c(new_n161_), .d(new_n127_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n77_), .c(x27), .O(new_n167_));
  ...
  nand2  g114(.a(new_n176_), .b(new_n70_), .O(z17));
  nand2  g115(.a(x27), .b(new_n119_), .O(new_n178_));
  nand2  g116(.a(new_n87_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n142_), .O(new_n180_));
  nand2  g118(.a(new_n74_), .b(new_n131_), .O(new_n181_));
  aoi21  g119(.a(new_n180_), .b(new_n77_), .c(new_n181_), .O(new_n182_));
  oai22  g120(.a(new_n182_), .b(new_n73_), .c(new_n114_), .d(new_n84_), .O(z18));
  inv1   g121(.a(new_n139_), .O(z19));
  aoi21  g122(.a(x40), .b(new_n69_), .c(x08), .O(new_n185_));
  aoi21  g123(.a(x40), .b(x29), .c(new_n77_), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n185_), .c(new_n87_), .O(new_n187_));
  nand2  g125(.a(new_n84_), .b(x39), .O(new_n188_));
  ...
  nand3  g129(.a(new_n191_), .b(new_n74_), .c(new_n131_), .O(new_n192_));
