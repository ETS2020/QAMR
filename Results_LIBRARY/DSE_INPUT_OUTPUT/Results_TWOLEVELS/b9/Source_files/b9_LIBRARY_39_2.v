...
module FAU ( 
  ...
  aoi21  g034(.a(new_n66_), .b(new_n92_), .c(new_n96_), .O(new_n97_));
  ...
  inv1   g068(.a(new_n83_), .O(new_n131_));
  inv1   g069(.a(x29), .O(new_n132_));
  aoi21  g070(.a(x40), .b(new_n132_), .c(new_n116_), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n131_), .c(new_n133_), .O(new_n135_));
  nand2  g073(.a(new_n64_), .b(new_n92_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n137_));
  ...
  oai22  g083(.a(new_n145_), .b(new_n92_), .c(new_n116_), .d(x04), .O(new_n146_));
  ...
  aoi21  g094(.a(new_n80_), .b(new_n79_), .c(x13), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n72_), .c(new_n63_), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n116_), .c(new_n156_), .O(z13));
  nor2   g097(.a(new_n116_), .b(x04), .O(new_n160_));
  oai21  g098(.a(new_n157_), .b(new_n63_), .c(new_n160_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n92_), .O(new_n162_));
  nand3  g100(.a(x39), .b(new_n148_), .c(new_n72_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n145_), .c(new_n163_), .O(new_n165_));
  nand2  g103(.a(new_n164_), .b(new_n149_), .O(new_n166_));
  oai21  g104(.a(x37), .b(x35), .c(new_n166_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n165_), .c(new_n162_), .d(new_n64_), .O(z14));
  nand4  g107(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n64_), .O(z15));
  ...
  inv1   g116(.a(x35), .O(new_n179_));
  nand2  g117(.a(x27), .b(new_n72_), .O(new_n180_));
  nand2  g118(.a(new_n92_), .b(x08), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n179_), .O(new_n182_));
  inv1   g120(.a(x09), .O(new_n183_));
  nand2  g121(.a(new_n79_), .b(new_n183_), .O(new_n184_));
  aoi21  g122(.a(new_n182_), .b(new_n82_), .c(new_n184_), .O(new_n185_));
  inv1   g123(.a(new_n89_), .O(new_n186_));
  nand2  g124(.a(z08), .b(new_n186_), .O(new_n187_));
  oai21  g125(.a(new_n185_), .b(new_n78_), .c(new_n187_), .O(z18));
  aoi21  g126(.a(new_n63_), .b(x39), .c(x08), .O(new_n189_));
  aoi21  g127(.a(x39), .b(x29), .c(new_n82_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n189_), .c(new_n92_), .O(new_n191_));
  oai21  g129(.a(new_n186_), .b(new_n63_), .c(x39), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n179_), .O(new_n193_));
  ...
  nor2   g134(.a(new_n140_), .b(x09), .O(z19));
endmodule
