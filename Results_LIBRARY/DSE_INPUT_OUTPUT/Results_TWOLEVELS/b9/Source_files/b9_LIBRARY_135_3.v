...
module FAU ( 
  ...
  nand2  g035(.a(new_n68_), .b(new_n67_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n94_), .c(new_n63_), .d(new_n95_), .O(z04));
  ...
  nor2   g056(.a(new_n118_), .b(x40), .O(z09));
  ...
  aoi21  g070(.a(x40), .b(x26), .c(x27), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n82_), .c(new_n120_), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n72_), .c(new_n133_), .O(new_n135_));
  aoi21  g073(.a(x39), .b(x29), .c(x26), .O(new_n136_));
  nand2  g074(.a(x27), .b(x04), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(x35), .c(new_n82_), .O(new_n138_));
  ...
  nor2   g080(.a(x27), .b(x26), .O(new_n143_));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n73_), .O(new_n145_));
  nand2  g083(.a(new_n69_), .b(new_n68_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(x27), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n120_), .c(x26), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n74_), .c(new_n147_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n145_), .c(new_n63_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n74_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n120_), .O(new_n154_));
  ...
  nand4  g097(.a(new_n126_), .b(x39), .c(new_n151_), .d(new_n120_), .O(new_n160_));
  ...
  nand3  g103(.a(x39), .b(new_n151_), .c(new_n120_), .O(new_n166_));
  inv1   g104(.a(new_n166_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n165_), .c(x26), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n74_), .c(new_n164_), .O(new_n169_));
  ...
  nand2  g125(.a(x27), .b(new_n120_), .O(new_n188_));
  nand2  g126(.a(new_n67_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n170_), .O(new_n190_));
  nand2  g128(.a(new_n79_), .b(new_n132_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n82_), .c(new_n191_), .O(new_n192_));
  inv1   g130(.a(x08), .O(new_n193_));
  nor2   g131(.a(x26), .b(new_n193_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(x40), .c(x39), .d(x29), .O(new_n195_));
  oai21  g133(.a(new_n192_), .b(new_n64_), .c(new_n195_), .O(z18));
  inv1   g134(.a(new_n141_), .O(z19));
  nor2   g135(.a(new_n136_), .b(new_n74_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n67_), .c(new_n170_), .O(new_n199_));
  aoi21  g137(.a(x35), .b(x27), .c(x26), .O(new_n200_));
  nor2   g138(.a(x40), .b(x27), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n193_), .O(new_n202_));
  oai21  g140(.a(new_n199_), .b(new_n198_), .c(new_n202_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n79_), .c(new_n132_), .O(new_n204_));
