...
module FAU ( 
  ...
  nand2  g69(.a(new_n66_), .b(x08), .O(new_n133_));
  oai21  g70(.a(new_n66_), .b(x04), .c(new_n133_), .O(new_n134_));
  ...
  oai21  g74(.a(new_n113_), .b(new_n73_), .c(new_n63_), .O(new_n138_));
  oai21  g75(.a(new_n112_), .b(x27), .c(new_n138_), .O(new_n139_));
  nand3  g76(.a(new_n139_), .b(new_n72_), .c(new_n111_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(new_n63_), .O(z20));
  one    g78(.O(z02));
