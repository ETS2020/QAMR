...
module FAU ( 
  ...
  nor2   g037(.a(new_n99_), .b(new_n78_), .O(z05));
  inv1   g038(.a(x28), .O(new_n101_));
  aoi21  g039(.a(new_n64_), .b(new_n94_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g070(.a(new_n132_), .b(x35), .c(new_n101_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n101_), .c(new_n71_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n64_), .d(new_n94_), .O(new_n136_));
  ...
  oai21  g080(.a(new_n63_), .b(new_n71_), .c(x39), .O(new_n143_));
  ...
  nand4  g091(.a(new_n67_), .b(new_n115_), .c(x20), .d(new_n151_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  aoi21  g094(.a(new_n80_), .b(new_n79_), .c(new_n63_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n146_), .d(new_n71_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n156_), .O(z13));
  aoi21  g097(.a(new_n146_), .b(new_n71_), .c(new_n63_), .O(new_n160_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n101_), .c(x27), .O(new_n167_));
  ...
  nand2  g117(.a(new_n94_), .b(x08), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n179_), .c(new_n81_), .O(new_n181_));
  nand2  g119(.a(new_n79_), .b(new_n130_), .O(new_n182_));
  aoi21  g120(.a(new_n181_), .b(new_n101_), .c(new_n182_), .O(new_n183_));
  nand3  g121(.a(z08), .b(x29), .c(x08), .O(new_n184_));
  oai21  g122(.a(new_n183_), .b(new_n78_), .c(new_n184_), .O(z18));
  nand2  g123(.a(new_n138_), .b(new_n64_), .O(z19));
  oai21  g124(.a(new_n101_), .b(x27), .c(x35), .O(new_n187_));
  and2   g125(.a(new_n187_), .b(new_n131_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n94_), .O(new_n189_));
  nand2  g127(.a(x40), .b(new_n81_), .O(new_n190_));
