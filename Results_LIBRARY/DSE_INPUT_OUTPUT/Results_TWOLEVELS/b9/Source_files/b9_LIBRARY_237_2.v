...
module FAU ( 
  ...
  aoi21  g037(.a(new_n71_), .b(new_n90_), .c(new_n99_), .O(new_n100_));
  oai21  g038(.a(new_n100_), .b(x37), .c(new_n71_), .O(z06));
  ...
  oai22  g058(.a(new_n120_), .b(new_n118_), .c(x39), .d(new_n119_), .O(new_n121_));
  nand3  g059(.a(new_n121_), .b(new_n78_), .c(new_n117_), .O(new_n122_));
  nand3  g060(.a(new_n71_), .b(x37), .c(x06), .O(new_n123_));
  nand2  g061(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x27), .O(new_n125_));
  aoi21  g063(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(new_n126_));
  nand4  g064(.a(new_n126_), .b(x39), .c(x05), .d(new_n117_), .O(new_n127_));
  ...
  nand3  g069(.a(new_n131_), .b(x35), .c(new_n99_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n99_), .c(new_n117_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x40), .c(new_n71_), .d(new_n90_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(x08), .c(new_n133_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n74_), .c(new_n129_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n71_), .O(z11));
  nor3   g076(.a(x37), .b(x36), .c(x35), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n90_), .c(new_n66_), .O(new_n140_));
  oai21  g078(.a(new_n70_), .b(new_n117_), .c(x39), .O(new_n141_));
  oai21  g079(.a(new_n64_), .b(new_n90_), .c(new_n141_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n140_), .c(new_n71_), .O(z12));
  inv1   g081(.a(x13), .O(new_n144_));
  nand2  g082(.a(x36), .b(x35), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(x28), .O(new_n146_));
  nand4  g084(.a(new_n146_), .b(x39), .c(new_n144_), .d(new_n117_), .O(new_n147_));
  inv1   g085(.a(x18), .O(new_n148_));
  inv1   g086(.a(x19), .O(new_n149_));
  nand2  g087(.a(new_n88_), .b(new_n91_), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(new_n147_), .c(new_n90_), .O(new_n152_));
  nand2  g090(.a(new_n75_), .b(new_n74_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n144_), .c(new_n117_), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x40), .c(new_n67_), .O(new_n155_));
  or2    g093(.a(new_n155_), .b(new_n152_), .O(z13));
  aoi21  g094(.a(new_n144_), .b(new_n117_), .c(new_n70_), .O(new_n157_));
  nand4  g095(.a(x27), .b(x20), .c(new_n149_), .d(new_n148_), .O(new_n158_));
  ...
  oai21  g100(.a(new_n162_), .b(new_n99_), .c(x27), .O(new_n163_));
  ...
  nand2  g111(.a(x27), .b(new_n117_), .O(new_n174_));
  nand2  g112(.a(new_n90_), .b(x08), .O(new_n175_));
  aoi21  g113(.a(new_n175_), .b(new_n174_), .c(new_n76_), .O(new_n176_));
  nand2  g114(.a(new_n74_), .b(new_n129_), .O(new_n177_));
  aoi21  g115(.a(new_n176_), .b(new_n99_), .c(new_n177_), .O(new_n178_));
  oai22  g116(.a(new_n178_), .b(new_n94_), .c(new_n120_), .d(new_n83_), .O(z18));
  inv1   g117(.a(new_n137_), .O(z19));
  aoi21  g118(.a(new_n70_), .b(x39), .c(x08), .O(new_n181_));
  aoi21  g119(.a(x39), .b(x29), .c(new_n99_), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(new_n90_), .O(new_n183_));
  nand2  g121(.a(new_n83_), .b(x40), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x39), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n76_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n74_), .c(new_n129_), .O(new_n188_));
