...
module FAU ( 
  ...
  nor2   g031(.a(x35), .b(x05), .O(new_n94_));
  nor2   g032(.a(new_n94_), .b(x28), .O(new_n95_));
  oai21  g033(.a(x27), .b(x08), .c(new_n95_), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(x04), .O(new_n97_));
  inv1   g035(.a(new_n81_), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n75_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n97_), .c(new_n93_), .d(x40), .O(z02));
  ...
  aoi21  g041(.a(new_n103_), .b(new_n101_), .c(new_n98_), .O(z03));
  ...
  nor2   g045(.a(new_n107_), .b(new_n98_), .O(z05));
  ...
  aoi21  g060(.a(new_n75_), .b(new_n122_), .c(new_n76_), .O(z08));
  inv1   g061(.a(x11), .O(new_n124_));
  nand4  g062(.a(new_n81_), .b(x34), .c(x27), .d(x26), .O(new_n125_));
  nor2   g063(.a(new_n125_), .b(new_n124_), .O(z09));
  inv1   g064(.a(new_n77_), .O(new_n127_));
  nand4  g065(.a(new_n87_), .b(new_n127_), .c(x07), .d(new_n65_), .O(new_n128_));
  nand2  g066(.a(x37), .b(x06), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x27), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n81_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(new_n122_), .c(new_n81_), .d(new_n64_), .O(new_n135_));
  aoi21  g073(.a(x39), .b(x29), .c(x05), .O(new_n136_));
  nor2   g074(.a(new_n64_), .b(new_n65_), .O(new_n137_));
  oai22  g075(.a(new_n137_), .b(new_n86_), .c(new_n136_), .d(new_n76_), .O(new_n138_));
  oai21  g076(.a(new_n135_), .b(x08), .c(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n83_), .c(new_n133_), .O(new_n140_));
  ...
  oai21  g083(.a(new_n127_), .b(x04), .c(new_n145_), .O(new_n146_));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(x05), .O(new_n155_));
  nand4  g093(.a(new_n72_), .b(new_n76_), .c(x20), .d(new_n153_), .O(new_n156_));
  ...
  nor2   g097(.a(new_n159_), .b(new_n75_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n148_), .c(new_n122_), .d(new_n65_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n153_), .c(new_n152_), .O(new_n163_));
  nand4  g101(.a(new_n149_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n164_));
  inv1   g102(.a(new_n164_), .O(new_n165_));
  nand3  g103(.a(new_n77_), .b(new_n148_), .c(new_n65_), .O(new_n166_));
  ...
  aoi21  g108(.a(new_n166_), .b(new_n145_), .c(new_n98_), .O(new_n171_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n81_), .O(z17));
  nand2  g118(.a(x27), .b(new_n65_), .O(new_n181_));
  nand2  g119(.a(new_n64_), .b(x08), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n66_), .O(new_n183_));
  nand2  g121(.a(new_n83_), .b(new_n133_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(new_n85_), .c(new_n184_), .O(new_n185_));
  nand4  g123(.a(new_n77_), .b(x29), .c(x08), .d(new_n122_), .O(new_n186_));
  oai21  g124(.a(new_n185_), .b(new_n98_), .c(new_n186_), .O(z18));
  inv1   g125(.a(new_n140_), .O(z19));
  nand2  g126(.a(x39), .b(x29), .O(new_n189_));
  nor2   g127(.a(new_n85_), .b(x27), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n94_), .c(new_n189_), .O(new_n191_));
  inv1   g129(.a(x08), .O(new_n192_));
  aoi21  g130(.a(x35), .b(x27), .c(x05), .O(new_n193_));
  nor2   g131(.a(x40), .b(x27), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(new_n192_), .O(new_n195_));
  oai21  g133(.a(new_n190_), .b(new_n66_), .c(new_n76_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n195_), .c(new_n191_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n83_), .c(new_n133_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n81_), .O(z20));
endmodule
