...
module FAU ( 
  ...
  nor2   g016(.a(x40), .b(x30), .O(new_n79_));
  nor2   g017(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g018(.a(new_n80_), .b(new_n77_), .O(z00));
  ...
  nand4  g025(.a(new_n87_), .b(x40), .c(new_n83_), .d(new_n82_), .O(new_n88_));
  ...
  nand3  g039(.a(new_n101_), .b(new_n95_), .c(new_n70_), .O(z05));
  oai22  g040(.a(x40), .b(x30), .c(new_n84_), .d(new_n64_), .O(new_n103_));
  ...
  nand3  g052(.a(new_n114_), .b(new_n95_), .c(x03), .O(new_n115_));
  inv1   g053(.a(new_n115_), .O(z07));
  nand2  g054(.a(x40), .b(x39), .O(new_n117_));
  nand2  g055(.a(new_n95_), .b(new_n117_), .O(z08));
  nand4  g056(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n119_));
  nand2  g057(.a(new_n119_), .b(new_n95_), .O(z09));
  nand2  g058(.a(new_n117_), .b(x07), .O(new_n121_));
  ...
  nand2  g062(.a(new_n83_), .b(new_n82_), .O(new_n125_));
  ...
  nand3  g067(.a(new_n129_), .b(new_n128_), .c(new_n95_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand2  g069(.a(x39), .b(x29), .O(new_n132_));
  nor2   g070(.a(new_n64_), .b(new_n65_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n85_), .c(new_n132_), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n84_), .c(x27), .d(new_n65_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n92_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g075(.a(new_n137_), .b(x40), .c(new_n82_), .d(new_n131_), .O(new_n138_));
  ...
  nor2   g082(.a(x40), .b(new_n82_), .O(new_n145_));
  nand2  g083(.a(new_n72_), .b(x27), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n65_), .c(new_n142_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n145_), .c(new_n146_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n144_), .c(new_n95_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n142_), .O(new_n152_));
  ...
  nand3  g096(.a(new_n125_), .b(x40), .c(x39), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x13), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n65_), .c(new_n79_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(z13));
  nand3  g100(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  nand4  g101(.a(new_n151_), .b(new_n83_), .c(new_n82_), .d(x28), .O(new_n164_));
  nand3  g102(.a(x39), .b(new_n150_), .c(new_n65_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n142_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n145_), .c(new_n163_), .O(new_n168_));
  ...
  nand3  g112(.a(new_n146_), .b(new_n142_), .c(x30), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n168_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nand4  g115(.a(new_n95_), .b(x34), .c(x27), .d(x26), .O(new_n178_));
  nor2   g116(.a(new_n178_), .b(new_n177_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x22), .c(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n95_), .O(z16));
  inv1   g120(.a(x01), .O(new_n183_));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n95_), .b(new_n184_), .c(x23), .d(x22), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n183_), .O(z17));
  oai21  g124(.a(new_n85_), .b(x27), .c(new_n132_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nor2   g126(.a(new_n142_), .b(x30), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n188_), .c(new_n135_), .d(new_n131_), .O(z18));
  inv1   g128(.a(new_n132_), .O(new_n191_));
  ...
  nand4  g132(.a(new_n194_), .b(x40), .c(new_n82_), .d(new_n131_), .O(new_n195_));
  inv1   g133(.a(new_n195_), .O(z20));
  inv1   g134(.a(new_n138_), .O(z19));
endmodule
