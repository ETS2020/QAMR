...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x37), .O(new_n81_));
  ...
  inv1   g027(.a(new_n89_), .O(new_n90_));
  ...
  nand3  g038(.a(new_n71_), .b(x40), .c(x27), .O(new_n101_));
  oai21  g039(.a(x37), .b(new_n66_), .c(new_n76_), .O(new_n102_));
  oai21  g040(.a(new_n92_), .b(new_n64_), .c(new_n70_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(x21), .O(z03));
  oai21  g042(.a(x37), .b(new_n64_), .c(new_n76_), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(x21), .O(new_n106_));
  oai21  g044(.a(x40), .b(x35), .c(x28), .O(new_n107_));
  oai21  g045(.a(new_n107_), .b(new_n64_), .c(new_n70_), .O(new_n108_));
  nand3  g046(.a(new_n108_), .b(new_n106_), .c(new_n101_), .O(z04));
  nand3  g047(.a(new_n70_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g048(.a(new_n76_), .b(new_n70_), .c(new_n110_), .O(z05));
  nand2  g049(.a(new_n103_), .b(new_n81_), .O(z06));
  ...
  nand2  g062(.a(new_n124_), .b(new_n81_), .O(z09));
  nor2   g063(.a(new_n85_), .b(x36), .O(new_n126_));
  nor2   g064(.a(new_n76_), .b(x39), .O(new_n127_));
  oai21  g065(.a(new_n127_), .b(new_n98_), .c(x07), .O(new_n128_));
  nand2  g066(.a(z08), .b(x05), .O(new_n129_));
  ...
  aoi21  g072(.a(new_n130_), .b(x27), .c(new_n134_), .O(new_n135_));
  nand4  g073(.a(x40), .b(x37), .c(x27), .d(x06), .O(new_n136_));
  oai21  g074(.a(new_n135_), .b(x04), .c(new_n136_), .O(z10));
  nand2  g075(.a(new_n81_), .b(new_n64_), .O(new_n138_));
  oai21  g076(.a(new_n93_), .b(x04), .c(x40), .O(new_n139_));
  ...
  aoi22  g081(.a(new_n143_), .b(new_n85_), .c(new_n142_), .d(new_n99_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n140_), .c(new_n83_), .O(new_n145_));
  ...
  oai21  g087(.a(new_n76_), .b(x27), .c(new_n72_), .O(new_n150_));
  oai21  g088(.a(new_n75_), .b(x04), .c(new_n150_), .O(new_n151_));
  nand3  g089(.a(new_n85_), .b(x27), .c(new_n65_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(x35), .c(x27), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(x37), .c(new_n76_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n151_), .c(new_n149_), .O(z12));
  ...
  nand3  g104(.a(new_n166_), .b(new_n164_), .c(new_n81_), .O(z13));
  ...
  oai21  g110(.a(new_n172_), .b(new_n98_), .c(new_n168_), .O(new_n173_));
  ...
  nand3  g115(.a(new_n153_), .b(new_n76_), .c(new_n70_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n177_), .c(new_n176_), .d(new_n173_), .O(z14));
  ...
  nand2  g126(.a(new_n76_), .b(x37), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(x27), .c(new_n65_), .O(new_n190_));
  oai21  g128(.a(new_n138_), .b(new_n188_), .c(new_n190_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(x35), .c(new_n92_), .O(new_n192_));
  inv1   g130(.a(x09), .O(new_n193_));
  nand2  g131(.a(new_n83_), .b(new_n193_), .O(new_n194_));
  aoi22  g132(.a(new_n194_), .b(new_n81_), .c(new_n90_), .d(z08), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n192_), .O(z18));
  nor2   g134(.a(new_n145_), .b(x09), .O(z19));
  aoi21  g135(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n198_));
  aoi21  g136(.a(new_n142_), .b(new_n99_), .c(new_n198_), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n66_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n138_), .c(x08), .O(new_n201_));
