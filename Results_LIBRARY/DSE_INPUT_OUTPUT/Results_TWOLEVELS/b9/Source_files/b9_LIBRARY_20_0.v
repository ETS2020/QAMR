...
module FAU ( 
  ...
  nand2  g036(.a(new_n81_), .b(x10), .O(new_n99_));
  ...
  aoi21  g047(.a(new_n82_), .b(new_n64_), .c(new_n86_), .O(new_n110_));
  ...
  nand3  g066(.a(new_n128_), .b(new_n88_), .c(x27), .O(new_n129_));
  ...
  nand3  g074(.a(new_n136_), .b(new_n135_), .c(new_n82_), .O(z10));
  ...
  nand4  g086(.a(x40), .b(x39), .c(x10), .d(new_n65_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n64_), .O(new_n150_));
  oai21  g088(.a(new_n75_), .b(x04), .c(new_n71_), .O(new_n151_));
  oai21  g089(.a(new_n68_), .b(x10), .c(new_n151_), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(new_n70_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n150_), .c(new_n82_), .O(z12));
  ...
  nor2   g100(.a(new_n161_), .b(new_n80_), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n162_), .c(x27), .O(new_n164_));
  nand3  g102(.a(new_n132_), .b(new_n155_), .c(new_n65_), .O(new_n165_));
  ...
  nor2   g106(.a(new_n81_), .b(x04), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(x39), .d(new_n155_), .O(new_n170_));
  ...
  nor2   g112(.a(new_n81_), .b(x27), .O(new_n175_));
  oai22  g113(.a(new_n175_), .b(new_n73_), .c(x13), .d(x04), .O(new_n176_));
  nand2  g114(.a(new_n72_), .b(x27), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n75_), .c(new_n101_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n176_), .c(new_n174_), .d(new_n171_), .O(z14));
  ...
  nand2  g129(.a(new_n84_), .b(new_n191_), .O(new_n192_));
  aoi21  g130(.a(new_n190_), .b(new_n86_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n101_), .c(new_n93_), .d(new_n75_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n95_), .c(x10), .O(new_n196_));
  ...
  nand3  g138(.a(new_n200_), .b(x28), .c(new_n64_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n199_), .c(new_n196_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n84_), .c(new_n191_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n82_), .O(z20));
  nor2   g142(.a(new_n147_), .b(x09), .O(z19));
endmodule
