...
module FAU ( 
  ...
  nand4  g015(.a(new_n77_), .b(x39), .c(new_n66_), .d(x13), .O(new_n78_));
  ...
  aoi21  g029(.a(new_n84_), .b(x04), .c(new_n63_), .O(new_n92_));
  inv1   g030(.a(x39), .O(new_n93_));
  nor2   g031(.a(x27), .b(x08), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(x04), .c(new_n93_), .O(new_n95_));
  nand4  g033(.a(new_n95_), .b(new_n92_), .c(new_n91_), .d(x40), .O(z02));
  nand2  g034(.a(new_n69_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x21), .O(new_n98_));
  inv1   g036(.a(x27), .O(new_n99_));
  aoi21  g037(.a(new_n68_), .b(new_n99_), .c(new_n98_), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n97_), .c(new_n65_), .O(z03));
  aoi21  g039(.a(new_n68_), .b(new_n99_), .c(x21), .O(new_n102_));
  aoi21  g040(.a(new_n102_), .b(new_n97_), .c(new_n65_), .O(z04));
  ...
  nand2  g044(.a(z05), .b(new_n64_), .O(z06));
  ...
  aoi21  g056(.a(new_n93_), .b(x13), .c(new_n75_), .O(z08));
  ...
  oai21  g063(.a(new_n124_), .b(new_n123_), .c(new_n125_), .O(new_n126_));
  ...
  nor2   g069(.a(new_n68_), .b(new_n99_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n65_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n83_), .c(new_n122_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x13), .c(new_n64_), .d(new_n99_), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x13), .O(new_n139_));
  ...
  oai21  g085(.a(new_n147_), .b(new_n99_), .c(new_n74_), .O(new_n148_));
  oai21  g086(.a(new_n124_), .b(x04), .c(new_n71_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n148_), .c(new_n64_), .O(z12));
  inv1   g088(.a(x18), .O(new_n151_));
  inv1   g089(.a(x19), .O(new_n152_));
  nand4  g090(.a(new_n72_), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n64_), .O(z13));
  nand4  g092(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n155_));
  inv1   g093(.a(new_n155_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n70_), .c(new_n65_), .O(z14));
  ...
  nand2  g099(.a(new_n161_), .b(new_n64_), .O(z16));
  inv1   g100(.a(x01), .O(new_n163_));
  inv1   g101(.a(x24), .O(new_n164_));
  nand4  g102(.a(new_n64_), .b(new_n164_), .c(x23), .d(x22), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n163_), .O(z17));
  inv1   g104(.a(x35), .O(new_n167_));
  nand2  g105(.a(x27), .b(new_n122_), .O(new_n168_));
  nand2  g106(.a(new_n99_), .b(x08), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n168_), .c(new_n167_), .O(new_n170_));
  nand2  g108(.a(new_n80_), .b(new_n135_), .O(new_n171_));
  aoi21  g109(.a(new_n170_), .b(new_n83_), .c(new_n171_), .O(new_n172_));
  inv1   g110(.a(new_n124_), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(x29), .c(x13), .d(x08), .O(new_n174_));
  oai21  g112(.a(new_n172_), .b(new_n65_), .c(new_n174_), .O(z18));
  inv1   g113(.a(new_n145_), .O(z19));
  nor2   g114(.a(new_n83_), .b(x27), .O(new_n177_));
  nor2   g115(.a(x35), .b(new_n63_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n177_), .c(new_n138_), .O(new_n179_));
  inv1   g117(.a(x08), .O(new_n180_));
  aoi21  g118(.a(x35), .b(x27), .c(new_n63_), .O(new_n181_));
  nor2   g119(.a(x40), .b(x27), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n181_), .c(new_n180_), .O(new_n183_));
  oai21  g121(.a(new_n177_), .b(new_n167_), .c(new_n75_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n183_), .c(new_n179_), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(new_n80_), .c(new_n135_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n64_), .O(z20));
endmodule
