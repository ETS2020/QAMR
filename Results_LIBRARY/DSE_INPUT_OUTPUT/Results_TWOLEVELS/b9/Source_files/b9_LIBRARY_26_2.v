...
module FAU ( 
  ...
  nand3  g062(.a(new_n124_), .b(new_n85_), .c(new_n72_), .O(new_n125_));
  ...
  oai21  g082(.a(new_n63_), .b(x04), .c(new_n69_), .O(new_n145_));
  ...
  nand4  g092(.a(new_n68_), .b(new_n63_), .c(x20), .d(new_n152_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand3  g095(.a(new_n130_), .b(new_n147_), .c(new_n72_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x39), .b(new_n147_), .c(new_n72_), .O(new_n160_));
  ...
  aoi21  g103(.a(new_n161_), .b(new_n148_), .c(new_n165_), .O(new_n166_));
  ...
  nand3  g107(.a(new_n169_), .b(x39), .c(new_n72_), .O(new_n170_));
  aoi21  g108(.a(new_n170_), .b(new_n93_), .c(new_n64_), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n168_), .c(new_n164_), .O(z14));
  ...
  nand2  g120(.a(new_n93_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n137_), .c(new_n182_), .O(new_n184_));
  nand2  g122(.a(new_n80_), .b(new_n133_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n83_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n64_), .c(new_n117_), .d(new_n90_), .O(z18));
  nor2   g125(.a(new_n63_), .b(new_n134_), .O(new_n188_));
  oai21  g126(.a(new_n182_), .b(new_n93_), .c(new_n92_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n93_), .c(new_n182_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n80_), .c(new_n133_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n65_), .O(z20));
  nand2  g131(.a(new_n140_), .b(new_n65_), .O(z19));
endmodule
