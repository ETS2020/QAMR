...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x24), .O(new_n81_));
  ...
  nor2   g067(.a(new_n129_), .b(new_n80_), .O(new_n130_));
  ...
  nor2   g088(.a(new_n80_), .b(x27), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  inv1   g090(.a(x39), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(x04), .c(new_n71_), .O(new_n154_));
  aoi21  g092(.a(new_n85_), .b(new_n98_), .c(new_n66_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(x40), .c(new_n154_), .O(new_n156_));
  nand2  g094(.a(new_n156_), .b(new_n70_), .O(new_n157_));
  aoi21  g095(.a(x27), .b(new_n98_), .c(x40), .O(new_n158_));
  nand2  g096(.a(x40), .b(x04), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x39), .c(x27), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n157_), .c(new_n152_), .O(z12));
  ...
  nand4  g108(.a(new_n72_), .b(new_n98_), .c(x20), .d(new_n168_), .O(new_n171_));
  nor2   g109(.a(new_n171_), .b(x18), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(new_n170_), .c(x27), .O(new_n173_));
  nand4  g111(.a(new_n130_), .b(x39), .c(new_n163_), .d(new_n65_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n173_), .O(z13));
  inv1   g113(.a(new_n151_), .O(new_n176_));
  nor2   g114(.a(x19), .b(x18), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n176_), .c(new_n72_), .d(x20), .O(new_n178_));
  oai21  g116(.a(x13), .b(x04), .c(new_n178_), .O(new_n179_));
  aoi21  g117(.a(new_n99_), .b(x39), .c(x28), .O(new_n180_));
  nand2  g118(.a(new_n129_), .b(x28), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(z08), .c(x35), .O(new_n182_));
  oai21  g120(.a(new_n182_), .b(new_n180_), .c(new_n70_), .O(new_n183_));
  oai21  g121(.a(new_n129_), .b(new_n75_), .c(new_n64_), .O(new_n184_));
  nand3  g122(.a(x20), .b(new_n168_), .c(new_n167_), .O(new_n185_));
  nand4  g123(.a(new_n164_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(z08), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n185_), .c(new_n104_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n184_), .c(new_n183_), .d(new_n179_), .O(z14));
  inv1   g127(.a(x12), .O(new_n190_));
  nor2   g128(.a(new_n123_), .b(new_n190_), .O(z15));
  inv1   g129(.a(x23), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(x22), .c(x01), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n81_), .O(z16));
  nand4  g132(.a(new_n98_), .b(x23), .c(x22), .d(x01), .O(new_n195_));
  ...
  nand2  g137(.a(new_n83_), .b(new_n137_), .O(new_n200_));
  aoi21  g138(.a(new_n199_), .b(new_n85_), .c(new_n200_), .O(new_n201_));
  oai22  g139(.a(new_n201_), .b(new_n104_), .c(new_n92_), .d(new_n75_), .O(z18));
  nand2  g140(.a(new_n147_), .b(new_n81_), .O(z19));
  nor2   g141(.a(x40), .b(x35), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n94_), .c(new_n98_), .O(new_n205_));
  ...
  nand2  g146(.a(z08), .b(x29), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(x28), .c(new_n64_), .O(new_n210_));
  nand3  g148(.a(new_n210_), .b(new_n208_), .c(new_n205_), .O(new_n211_));
  nand3  g149(.a(new_n211_), .b(new_n83_), .c(new_n137_), .O(new_n212_));
