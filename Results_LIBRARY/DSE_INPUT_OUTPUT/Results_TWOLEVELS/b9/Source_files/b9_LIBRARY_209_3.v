...
module FAU ( 
  ...
  nor2   g23(.a(new_n86_), .b(z08), .O(z05));
  aoi21  g24(.a(new_n68_), .b(new_n64_), .c(new_n79_), .O(new_n88_));
  oai21  g25(.a(new_n88_), .b(x37), .c(new_n68_), .O(z06));
  ...
  aoi21  g49(.a(x27), .b(x04), .c(new_n112_), .O(new_n113_));
  nand3  g50(.a(new_n113_), .b(x35), .c(new_n79_), .O(new_n114_));
  nand4  g51(.a(new_n114_), .b(new_n68_), .c(new_n71_), .d(new_n111_), .O(new_n115_));
  inv1   g52(.a(new_n115_), .O(z11));
  inv1   g53(.a(new_n65_), .O(new_n117_));
  nor2   g54(.a(z08), .b(new_n64_), .O(new_n118_));
  nand2  g55(.a(new_n118_), .b(new_n117_), .O(z12));
  inv1   g56(.a(x19), .O(new_n120_));
  nand3  g57(.a(new_n66_), .b(x20), .c(new_n120_), .O(new_n121_));
  oai21  g58(.a(new_n121_), .b(x18), .c(new_n68_), .O(z13));
  nor2   g59(.a(x19), .b(x18), .O(new_n123_));
  nand4  g60(.a(new_n123_), .b(new_n118_), .c(new_n117_), .d(x20), .O(z14));
  ...
  nand2  g69(.a(new_n64_), .b(x08), .O(new_n133_));
  oai21  g70(.a(new_n64_), .b(x04), .c(new_n133_), .O(new_n134_));
  nand3  g71(.a(new_n134_), .b(x35), .c(new_n79_), .O(new_n135_));
  nor2   g72(.a(x30), .b(x09), .O(new_n136_));
  aoi21  g73(.a(new_n136_), .b(new_n135_), .c(z08), .O(z18));
  oai21  g74(.a(new_n112_), .b(new_n72_), .c(new_n68_), .O(new_n138_));
  oai21  g75(.a(new_n79_), .b(x27), .c(new_n138_), .O(new_n139_));
