...
module FAU ( 
  ...
  oai21  g033(.a(new_n95_), .b(new_n90_), .c(x00), .O(new_n96_));
  ...
  aoi21  g058(.a(new_n75_), .b(x00), .c(new_n76_), .O(z08));
  ...
  nor3   g070(.a(new_n101_), .b(new_n70_), .c(new_n132_), .O(new_n133_));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n150_), .c(new_n101_), .O(new_n152_));
  ...
  nand4  g102(.a(new_n136_), .b(new_n154_), .c(new_n65_), .d(x00), .O(new_n165_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n150_), .c(new_n101_), .O(new_n175_));
  ...
  aoi21  g128(.a(new_n188_), .b(new_n91_), .c(new_n190_), .O(new_n191_));
  nand4  g129(.a(new_n77_), .b(x29), .c(x08), .d(x00), .O(new_n192_));
  oai21  g130(.a(new_n191_), .b(new_n101_), .c(new_n192_), .O(z18));
  nor2   g131(.a(new_n91_), .b(x27), .O(new_n194_));
  nor2   g132(.a(x35), .b(new_n81_), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n194_), .c(new_n142_), .O(new_n196_));
  ...
  nand3  g140(.a(new_n202_), .b(new_n84_), .c(new_n189_), .O(new_n203_));
