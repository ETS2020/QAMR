...
module FAU ( 
  ...
  nand2  g034(.a(new_n66_), .b(new_n93_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n96_), .c(new_n64_), .d(x21), .O(z03));
  aoi21  g036(.a(new_n66_), .b(new_n93_), .c(x21), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n96_), .c(new_n79_), .O(z04));
  aoi21  g038(.a(x28), .b(x27), .c(x37), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n79_), .O(z05));
  aoi21  g040(.a(new_n64_), .b(new_n93_), .c(new_n83_), .O(new_n103_));
  ...
  nor2   g053(.a(new_n74_), .b(new_n63_), .O(z08));
  ...
  nand3  g060(.a(new_n122_), .b(new_n85_), .c(new_n72_), .O(new_n123_));
  ...
  nand3  g073(.a(x35), .b(new_n83_), .c(new_n72_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n64_), .d(new_n93_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(x08), .c(new_n135_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n80_), .c(new_n131_), .O(new_n139_));
  ...
  inv1   g081(.a(new_n68_), .O(new_n144_));
  oai22  g082(.a(new_n144_), .b(new_n93_), .c(new_n74_), .d(x04), .O(new_n145_));
  ...
  nand4  g087(.a(new_n149_), .b(x40), .c(new_n147_), .d(new_n72_), .O(new_n150_));
  ...
  nand4  g092(.a(new_n68_), .b(new_n74_), .c(x20), .d(new_n152_), .O(new_n155_));
  nor2   g093(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(x27), .O(new_n157_));
  nand3  g095(.a(new_n128_), .b(new_n147_), .c(new_n72_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  oai21  g097(.a(new_n127_), .b(x13), .c(x39), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(x40), .c(new_n72_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n93_), .O(new_n162_));
  nand3  g100(.a(x40), .b(new_n147_), .c(new_n72_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n144_), .c(new_n163_), .O(new_n165_));
  nand2  g103(.a(new_n164_), .b(new_n148_), .O(new_n166_));
  oai21  g104(.a(x37), .b(x35), .c(new_n166_), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(new_n165_), .c(new_n162_), .d(new_n64_), .O(z14));
  ...
  nand2  g116(.a(x40), .b(x29), .O(new_n179_));
  oai21  g117(.a(new_n84_), .b(x27), .c(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  inv1   g119(.a(new_n84_), .O(new_n182_));
  nor2   g120(.a(new_n93_), .b(x04), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(x09), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n181_), .c(new_n64_), .d(new_n80_), .O(z18));
  inv1   g123(.a(new_n139_), .O(z19));
  aoi22  g124(.a(new_n179_), .b(x28), .c(new_n64_), .d(new_n92_), .O(new_n187_));
  inv1   g125(.a(x35), .O(new_n188_));
  nand2  g126(.a(new_n90_), .b(x39), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x40), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  oai21  g129(.a(new_n187_), .b(x27), .c(new_n191_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n131_), .O(new_n193_));
