...
module FAU ( 
  ...
  nand2  g034(.a(new_n76_), .b(x23), .O(new_n97_));
  ...
  aoi21  g039(.a(new_n101_), .b(new_n99_), .c(new_n81_), .O(z03));
  aoi21  g040(.a(new_n70_), .b(new_n64_), .c(x21), .O(new_n103_));
  aoi21  g041(.a(new_n103_), .b(new_n99_), .c(new_n81_), .O(z04));
  ...
  nor2   g073(.a(x40), .b(x35), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n93_), .c(x23), .O(new_n137_));
  inv1   g075(.a(z08), .O(new_n138_));
  oai21  g076(.a(new_n64_), .b(new_n65_), .c(new_n86_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  oai22  g078(.a(new_n76_), .b(x08), .c(x29), .d(new_n64_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x04), .O(new_n142_));
  aoi22  g080(.a(x35), .b(new_n86_), .c(x29), .d(x08), .O(new_n143_));
  oai22  g081(.a(x39), .b(x35), .c(x27), .d(x08), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(x40), .O(new_n145_));
  nand4  g083(.a(new_n145_), .b(new_n142_), .c(new_n140_), .d(new_n137_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n84_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(x09), .c(new_n82_), .O(z11));
  inv1   g086(.a(x10), .O(new_n149_));
  nor3   g087(.a(x37), .b(x36), .c(x35), .O(new_n150_));
  nor2   g088(.a(new_n76_), .b(x27), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  inv1   g090(.a(new_n97_), .O(new_n153_));
  nand2  g091(.a(new_n72_), .b(x27), .O(new_n154_));
  aoi21  g092(.a(x39), .b(new_n65_), .c(new_n76_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(new_n154_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n152_), .c(new_n82_), .O(z12));
  ...
  oai21  g113(.a(new_n175_), .b(new_n153_), .c(new_n171_), .O(new_n176_));
  ...
  nand3  g120(.a(new_n154_), .b(new_n76_), .c(x23), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n182_), .c(new_n176_), .O(z14));
  inv1   g122(.a(x12), .O(new_n185_));
  nor2   g123(.a(new_n121_), .b(new_n185_), .O(z15));
  inv1   g124(.a(x23), .O(new_n187_));
  nand4  g125(.a(x40), .b(new_n187_), .c(x22), .d(x01), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(z16));
  nand3  g127(.a(x23), .b(x22), .c(x01), .O(new_n190_));
  nor2   g128(.a(new_n190_), .b(x24), .O(z17));
  inv1   g129(.a(x29), .O(new_n192_));
  oai22  g130(.a(new_n87_), .b(x27), .c(new_n138_), .d(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  inv1   g132(.a(new_n87_), .O(new_n195_));
  nor2   g133(.a(new_n64_), .b(x04), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n195_), .c(x09), .O(new_n197_));
  nand4  g135(.a(new_n197_), .b(new_n194_), .c(new_n82_), .d(new_n84_), .O(z18));
  aoi21  g136(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n199_));
  oai21  g137(.a(new_n75_), .b(new_n192_), .c(x40), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n97_), .c(new_n199_), .O(new_n201_));
  nand2  g139(.a(new_n82_), .b(new_n64_), .O(new_n202_));
  nand2  g140(.a(x40), .b(new_n66_), .O(new_n203_));
  aoi21  g141(.a(new_n203_), .b(new_n202_), .c(x08), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n201_), .c(new_n84_), .O(new_n205_));
  nor2   g143(.a(new_n205_), .b(x09), .O(z20));
  oai21  g144(.a(new_n147_), .b(x09), .c(new_n82_), .O(z19));
endmodule
