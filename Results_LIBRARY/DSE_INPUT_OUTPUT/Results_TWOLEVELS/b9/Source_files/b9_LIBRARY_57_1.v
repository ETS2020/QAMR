...
module FAU ( 
  ...
  nand3  g023(.a(new_n85_), .b(x35), .c(new_n82_), .O(new_n86_));
  aoi21  g024(.a(new_n86_), .b(x04), .c(new_n81_), .O(new_n87_));
  ...
  aoi21  g031(.a(new_n93_), .b(new_n84_), .c(new_n92_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n89_), .O(z03));
  nand2  g033(.a(new_n93_), .b(new_n84_), .O(new_n96_));
  ...
  aoi21  g037(.a(x40), .b(new_n69_), .c(x27), .O(new_n100_));
  oai21  g038(.a(new_n100_), .b(new_n82_), .c(new_n93_), .O(new_n101_));
  nand2  g039(.a(new_n101_), .b(new_n70_), .O(z06));
  ...
  nand4  g055(.a(new_n70_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  ...
  nand3  g068(.a(new_n130_), .b(new_n129_), .c(new_n70_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand2  g070(.a(x40), .b(x29), .O(new_n133_));
  oai21  g071(.a(new_n84_), .b(new_n120_), .c(new_n82_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g073(.a(x39), .b(new_n75_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n82_), .c(new_n120_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n100_), .c(new_n83_), .O(new_n138_));
  oai21  g076(.a(new_n69_), .b(x29), .c(x40), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n75_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n138_), .c(new_n135_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n73_), .c(new_n132_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n70_), .O(z11));
  nor2   g081(.a(new_n64_), .b(new_n84_), .O(new_n144_));
  nand3  g082(.a(new_n93_), .b(new_n76_), .c(new_n75_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  nor2   g084(.a(new_n144_), .b(new_n120_), .O(new_n147_));
  ...
  nand4  g090(.a(new_n152_), .b(x40), .c(new_n150_), .d(new_n120_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand2  g093(.a(new_n90_), .b(new_n93_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(new_n69_), .O(new_n158_));
  nand4  g096(.a(new_n156_), .b(new_n115_), .c(x20), .d(new_n155_), .O(new_n159_));
  nor2   g097(.a(new_n159_), .b(x18), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n158_), .c(x27), .O(new_n161_));
  nand4  g099(.a(new_n126_), .b(x39), .c(new_n150_), .d(new_n120_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  nand2  g101(.a(x39), .b(x04), .O(new_n164_));
  nand3  g102(.a(new_n164_), .b(x40), .c(new_n150_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n90_), .O(new_n166_));
  ...
  nand2  g107(.a(x39), .b(new_n84_), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n171_));
  oai21  g109(.a(x13), .b(x04), .c(new_n171_), .O(new_n172_));
  nand2  g110(.a(new_n125_), .b(new_n84_), .O(new_n173_));
  nand4  g111(.a(new_n151_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x40), .O(new_n175_));
  nand3  g113(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n175_), .c(new_n89_), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n173_), .c(new_n172_), .d(new_n169_), .O(z14));
  nand4  g116(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n70_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand4  g119(.a(new_n70_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z16));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(x23), .c(x22), .d(x01), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n70_), .O(z17));
  nand2  g124(.a(x27), .b(new_n120_), .O(new_n187_));
  nand2  g125(.a(new_n84_), .b(x08), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n187_), .c(new_n75_), .O(new_n189_));
  nand2  g127(.a(new_n73_), .b(new_n132_), .O(new_n190_));
  aoi21  g128(.a(new_n189_), .b(new_n82_), .c(new_n190_), .O(new_n191_));
  nand3  g129(.a(z08), .b(x29), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n191_), .b(new_n89_), .c(new_n192_), .O(z18));
  oai21  g131(.a(new_n82_), .b(x27), .c(x35), .O(new_n194_));
  and2   g132(.a(new_n194_), .b(new_n139_), .O(new_n195_));
  nand2  g133(.a(new_n70_), .b(new_n84_), .O(new_n196_));
  aoi21  g134(.a(new_n136_), .b(new_n196_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n73_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(x09), .O(z20));
  nand2  g137(.a(new_n142_), .b(new_n70_), .O(z19));
endmodule
