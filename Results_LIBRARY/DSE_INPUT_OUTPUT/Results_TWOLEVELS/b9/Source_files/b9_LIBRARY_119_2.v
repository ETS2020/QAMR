...
module FAU ( 
  ...
  nor2   g031(.a(x40), .b(x18), .O(new_n94_));
  ...
  aoi21  g042(.a(new_n64_), .b(new_n68_), .c(new_n104_), .O(new_n105_));
  ...
  nor3   g068(.a(new_n130_), .b(new_n63_), .c(new_n118_), .O(new_n131_));
  nand3  g069(.a(new_n131_), .b(x05), .c(new_n73_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n129_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nor2   g072(.a(new_n63_), .b(new_n118_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x29), .O(new_n136_));
  oai21  g074(.a(new_n68_), .b(new_n73_), .c(new_n83_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand2  g077(.a(x40), .b(x04), .O(new_n140_));
  nand4  g078(.a(new_n140_), .b(x35), .c(new_n104_), .d(x27), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n79_), .c(new_n134_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n64_), .O(z11));
  nand3  g083(.a(new_n69_), .b(new_n81_), .c(new_n82_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x27), .c(x10), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n73_), .c(new_n71_), .O(new_n148_));
  ...
  nand2  g090(.a(new_n152_), .b(new_n149_), .O(z12));
  ...
  nand4  g097(.a(new_n159_), .b(x20), .c(new_n158_), .d(new_n150_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x27), .O(new_n162_));
  nand3  g100(.a(new_n131_), .b(new_n154_), .c(new_n73_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(new_n162_), .O(z13));
  oai21  g102(.a(new_n118_), .b(x04), .c(x40), .O(new_n165_));
  nor2   g103(.a(new_n94_), .b(x13), .O(new_n166_));
  aoi22  g104(.a(new_n166_), .b(new_n165_), .c(x35), .d(x28), .O(new_n167_));
  nand4  g105(.a(new_n82_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n167_), .c(new_n69_), .O(new_n170_));
  nand3  g108(.a(x20), .b(new_n158_), .c(new_n150_), .O(new_n171_));
  nand4  g109(.a(new_n155_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n135_), .c(new_n154_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  nand2  g112(.a(x27), .b(x20), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(x19), .c(x04), .O(new_n176_));
  oai21  g114(.a(new_n118_), .b(x13), .c(new_n68_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(new_n63_), .O(new_n178_));
  oai21  g116(.a(new_n130_), .b(new_n94_), .c(new_n68_), .O(new_n179_));
  oai21  g117(.a(new_n150_), .b(new_n73_), .c(new_n179_), .O(new_n180_));
  nor2   g118(.a(new_n180_), .b(new_n178_), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n174_), .c(new_n170_), .O(z14));
  ...
  oai21  g129(.a(new_n84_), .b(x27), .c(new_n136_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n68_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n83_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g134(.a(new_n136_), .O(new_n197_));
  oai21  g135(.a(new_n82_), .b(new_n68_), .c(new_n139_), .O(new_n198_));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n82_), .O(new_n199_));
  ...
  nand2  g140(.a(new_n144_), .b(new_n64_), .O(z19));
endmodule
