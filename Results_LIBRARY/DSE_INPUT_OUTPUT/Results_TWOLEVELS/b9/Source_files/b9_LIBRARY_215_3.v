...
module FAU ( 
  ...
  oai21  g025(.a(new_n81_), .b(new_n87_), .c(new_n72_), .O(new_n88_));
  ...
  nand4  g097(.a(new_n127_), .b(x39), .c(new_n150_), .d(new_n87_), .O(new_n160_));
  ...
  oai21  g101(.a(x27), .b(new_n150_), .c(new_n72_), .O(new_n164_));
  ...
  nand4  g105(.a(new_n167_), .b(new_n93_), .c(new_n150_), .d(new_n87_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  inv1   g107(.a(new_n69_), .O(new_n170_));
  oai21  g108(.a(new_n92_), .b(x04), .c(new_n72_), .O(new_n171_));
  nor2   g109(.a(new_n74_), .b(x13), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n171_), .c(new_n170_), .O(new_n173_));
  nand4  g111(.a(new_n143_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n68_), .O(new_n176_));
  nand3  g114(.a(new_n171_), .b(new_n127_), .c(x40), .O(new_n177_));
  ...
  aoi21  g118(.a(new_n180_), .b(new_n74_), .c(new_n72_), .O(z15));
