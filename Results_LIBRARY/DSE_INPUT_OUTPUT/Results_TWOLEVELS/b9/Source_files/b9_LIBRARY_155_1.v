...
module FAU ( 
  ...
  aoi21  g031(.a(new_n86_), .b(x04), .c(new_n80_), .O(new_n94_));
  ...
  nor2   g043(.a(new_n105_), .b(new_n102_), .O(z05));
  aoi21  g044(.a(new_n81_), .b(new_n64_), .c(new_n85_), .O(new_n107_));
  ...
  nand3  g057(.a(x40), .b(x39), .c(x20), .O(new_n120_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n83_), .c(new_n135_), .O(new_n145_));
  ...
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x20), .O(new_n151_));
  inv1   g089(.a(x40), .O(new_n152_));
  oai21  g090(.a(new_n73_), .b(new_n64_), .c(new_n152_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n151_), .O(z12));
  inv1   g092(.a(x13), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n152_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n65_), .O(new_n158_));
  inv1   g096(.a(x19), .O(new_n159_));
  nand3  g097(.a(new_n72_), .b(x20), .c(new_n159_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(x18), .c(new_n158_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x27), .O(new_n162_));
  nand4  g100(.a(new_n128_), .b(x39), .c(new_n155_), .d(new_n65_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x20), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(x40), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n162_), .O(z13));
  nand4  g104(.a(new_n156_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x39), .b(new_n155_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n80_), .O(new_n170_));
  oai22  g108(.a(new_n170_), .b(new_n152_), .c(x19), .d(x18), .O(new_n171_));
  ...
  nand3  g112(.a(new_n168_), .b(new_n71_), .c(new_n70_), .O(new_n175_));
  nand2  g113(.a(x40), .b(x13), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(x39), .c(new_n65_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(new_n64_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n175_), .c(new_n174_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x20), .O(new_n180_));
  nand3  g118(.a(new_n72_), .b(x27), .c(x20), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n152_), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n180_), .c(new_n171_), .O(z14));
  nand4  g121(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n81_), .O(z15));
  ...
  nand2  g132(.a(new_n83_), .b(new_n135_), .O(new_n195_));
  aoi21  g133(.a(new_n194_), .b(new_n85_), .c(new_n195_), .O(new_n196_));
  nand4  g134(.a(new_n76_), .b(x29), .c(x20), .d(x08), .O(new_n197_));
  oai21  g135(.a(new_n196_), .b(new_n102_), .c(new_n197_), .O(z18));
  inv1   g136(.a(new_n145_), .O(z19));
  nor2   g137(.a(new_n85_), .b(x27), .O(new_n200_));
  nor2   g138(.a(x35), .b(new_n80_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n138_), .O(new_n202_));
  inv1   g140(.a(x08), .O(new_n203_));
  aoi21  g141(.a(x35), .b(x27), .c(new_n80_), .O(new_n204_));
  nor2   g142(.a(x40), .b(x27), .O(new_n205_));
  oai21  g143(.a(new_n205_), .b(new_n204_), .c(new_n203_), .O(new_n206_));
  oai21  g144(.a(new_n200_), .b(new_n66_), .c(new_n152_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n206_), .c(new_n202_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n83_), .c(new_n135_), .O(new_n209_));
