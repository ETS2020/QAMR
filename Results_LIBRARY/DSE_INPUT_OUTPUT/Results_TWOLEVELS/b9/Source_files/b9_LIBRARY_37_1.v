...
module FAU ( 
  ...
  aoi21  g063(.a(new_n75_), .b(x33), .c(new_n76_), .O(new_n126_));
  nand4  g064(.a(x40), .b(x39), .c(x33), .d(x05), .O(new_n127_));
  ...
  nor3   g071(.a(new_n133_), .b(new_n75_), .c(new_n81_), .O(new_n134_));
  ...
  nor2   g086(.a(new_n81_), .b(x27), .O(new_n149_));
  ...
  aoi21  g090(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n153_));
  oai21  g091(.a(new_n153_), .b(new_n76_), .c(new_n152_), .O(new_n154_));
  nand3  g092(.a(new_n154_), .b(new_n151_), .c(new_n82_), .O(z12));
  ...
  nand2  g117(.a(new_n179_), .b(x33), .O(new_n180_));
  ...
  nand2  g132(.a(new_n85_), .b(new_n194_), .O(new_n195_));
  aoi21  g133(.a(new_n193_), .b(new_n87_), .c(new_n195_), .O(new_n196_));
  nand2  g134(.a(new_n77_), .b(x33), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n94_), .c(new_n196_), .d(new_n84_), .O(z18));
  oai21  g136(.a(new_n146_), .b(x09), .c(new_n82_), .O(z19));
  aoi21  g137(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(new_n143_), .O(new_n201_));
  nand2  g139(.a(new_n66_), .b(x33), .O(new_n202_));
