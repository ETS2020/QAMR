...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x23), .O(new_n81_));
  ...
  nor2   g062(.a(x40), .b(x23), .O(new_n125_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n140_), .c(new_n143_), .d(new_n141_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n139_), .c(new_n83_), .O(new_n146_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n76_), .c(new_n152_), .O(new_n154_));
  ...
  nand4  g101(.a(new_n72_), .b(new_n152_), .c(x20), .d(new_n161_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n134_), .b(new_n156_), .c(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  aoi21  g106(.a(x39), .b(new_n65_), .c(new_n76_), .O(new_n169_));
  nand2  g107(.a(new_n141_), .b(new_n156_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n169_), .c(new_n153_), .O(new_n171_));
  nand3  g109(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n172_));
  nand4  g110(.a(new_n157_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n77_), .c(new_n156_), .d(new_n65_), .O(new_n174_));
  ...
  nand4  g116(.a(new_n178_), .b(new_n175_), .c(new_n171_), .d(new_n81_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nor2   g118(.a(new_n122_), .b(new_n180_), .O(z15));
  nand2  g119(.a(x22), .b(x01), .O(new_n182_));
  nor2   g120(.a(new_n182_), .b(x23), .O(z16));
  nor4   g121(.a(new_n182_), .b(new_n76_), .c(x24), .d(new_n152_), .O(z17));
  ...
  oai22  g128(.a(new_n190_), .b(new_n97_), .c(new_n92_), .d(new_n119_), .O(z18));
  oai21  g129(.a(new_n146_), .b(x09), .c(new_n81_), .O(z19));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  aoi21  g131(.a(new_n143_), .b(new_n141_), .c(new_n193_), .O(new_n194_));
  nand2  g132(.a(x40), .b(new_n66_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n137_), .c(x08), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n83_), .O(new_n197_));
