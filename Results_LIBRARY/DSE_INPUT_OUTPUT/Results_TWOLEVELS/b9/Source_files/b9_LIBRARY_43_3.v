...
module FAU ( 
  ...
  oai21  g030(.a(new_n92_), .b(new_n90_), .c(new_n89_), .O(new_n93_));
  ...
  nand2  g035(.a(new_n80_), .b(x39), .O(new_n98_));
  aoi21  g036(.a(new_n97_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n95_), .c(new_n93_), .O(z02));
  ...
  nand3  g050(.a(new_n112_), .b(new_n110_), .c(new_n89_), .O(new_n113_));
  ...
  nand3  g058(.a(x40), .b(x39), .c(new_n89_), .O(new_n121_));
  ...
  nand3  g072(.a(new_n134_), .b(new_n133_), .c(new_n80_), .O(z10));
  inv1   g073(.a(x09), .O(new_n136_));
  aoi21  g074(.a(x40), .b(x33), .c(x27), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n91_), .c(new_n65_), .O(new_n138_));
  ...
  nand3  g079(.a(new_n141_), .b(x35), .c(new_n91_), .O(new_n142_));
  oai21  g080(.a(new_n140_), .b(new_n96_), .c(new_n142_), .O(new_n143_));
  ...
  aoi21  g130(.a(new_n191_), .b(new_n91_), .c(new_n192_), .O(new_n193_));
  nand4  g131(.a(new_n76_), .b(new_n89_), .c(x29), .d(x08), .O(new_n194_));
  oai21  g132(.a(new_n193_), .b(new_n102_), .c(new_n194_), .O(z18));
  nand2  g133(.a(new_n145_), .b(new_n80_), .O(z19));
  nor2   g134(.a(new_n140_), .b(new_n96_), .O(new_n197_));
  aoi21  g135(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n198_));
  aoi21  g136(.a(new_n66_), .b(new_n89_), .c(new_n137_), .O(new_n199_));
  oai22  g137(.a(new_n199_), .b(x08), .c(new_n198_), .d(new_n197_), .O(new_n200_));
