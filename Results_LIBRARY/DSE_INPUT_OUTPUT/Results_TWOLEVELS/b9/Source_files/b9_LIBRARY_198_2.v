...
module FAU ( 
  ...
  nand3  g034(.a(new_n64_), .b(new_n68_), .c(new_n93_), .O(new_n97_));
  ...
  oai22  g042(.a(x40), .b(new_n103_), .c(new_n104_), .d(new_n93_), .O(new_n105_));
  ...
  nand3  g049(.a(x38), .b(new_n103_), .c(new_n109_), .O(new_n112_));
  ...
  nor2   g060(.a(x40), .b(x25), .O(new_n123_));
  ...
  nand3  g064(.a(new_n126_), .b(new_n86_), .c(new_n74_), .O(new_n127_));
  ...
  nand3  g072(.a(x35), .b(new_n104_), .c(new_n74_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n64_), .d(new_n93_), .O(new_n136_));
  nor2   g074(.a(new_n136_), .b(x08), .O(new_n137_));
  nand2  g075(.a(x39), .b(x29), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(x40), .c(new_n123_), .O(new_n139_));
  nand2  g077(.a(x27), .b(x04), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(new_n84_), .c(new_n139_), .O(new_n141_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(new_n75_), .O(new_n146_));
  aoi21  g084(.a(x39), .b(new_n74_), .c(new_n63_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n123_), .c(new_n71_), .O(new_n148_));
  ...
  nand4  g095(.a(new_n70_), .b(new_n103_), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n132_), .b(new_n150_), .c(new_n74_), .O(new_n161_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n123_), .c(new_n163_), .O(new_n168_));
  ...
  nand3  g111(.a(new_n71_), .b(new_n63_), .c(new_n103_), .O(new_n174_));
  ...
  oai21  g122(.a(new_n85_), .b(x27), .c(new_n184_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n93_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n84_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n64_), .d(new_n80_), .O(z18));
  nor2   g127(.a(new_n142_), .b(x09), .O(z19));
  oai22  g128(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n103_), .O(new_n192_));
  ...
  nand3  g133(.a(new_n184_), .b(x28), .c(new_n93_), .O(new_n196_));
