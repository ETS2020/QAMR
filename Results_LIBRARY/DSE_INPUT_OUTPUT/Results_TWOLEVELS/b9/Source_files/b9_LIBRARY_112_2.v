...
module FAU ( 
  ...
  aoi21  g039(.a(new_n64_), .b(new_n66_), .c(new_n82_), .O(new_n102_));
  ...
  oai22  g058(.a(new_n115_), .b(new_n119_), .c(x39), .d(new_n120_), .O(new_n121_));
  ...
  nor3   g065(.a(new_n127_), .b(new_n63_), .c(new_n126_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x05), .c(new_n73_), .O(new_n129_));
  ...
  nand3  g073(.a(x35), .b(new_n82_), .c(new_n73_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n64_), .d(new_n66_), .O(new_n137_));
  ...
  nand3  g096(.a(new_n128_), .b(new_n147_), .c(new_n73_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n158_), .O(z13));
  oai21  g098(.a(x27), .b(new_n147_), .c(x40), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x39), .O(new_n162_));
  oai21  g100(.a(new_n63_), .b(new_n73_), .c(x39), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n127_), .c(new_n66_), .O(new_n164_));
  oai21  g102(.a(new_n163_), .b(x13), .c(new_n68_), .O(new_n165_));
  nand4  g103(.a(new_n141_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n67_), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n169_));
  nand4  g107(.a(new_n148_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x39), .c(new_n147_), .d(new_n73_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n168_), .c(new_n164_), .d(new_n162_), .O(z14));
  ...
  oai22  g121(.a(new_n83_), .b(x27), .c(new_n126_), .d(new_n183_), .O(new_n184_));
  ...
  nand4  g126(.a(new_n188_), .b(new_n185_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g127(.a(new_n139_), .O(z19));
  oai21  g128(.a(new_n82_), .b(x27), .c(x35), .O(new_n191_));
  and2   g129(.a(new_n191_), .b(new_n132_), .O(new_n192_));
  nand2  g130(.a(new_n64_), .b(new_n66_), .O(new_n193_));
  nand2  g131(.a(x40), .b(new_n141_), .O(new_n194_));
