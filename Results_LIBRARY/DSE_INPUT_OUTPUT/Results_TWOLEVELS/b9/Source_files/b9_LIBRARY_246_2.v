...
module FAU ( 
  ...
  nand2  g031(.a(new_n75_), .b(new_n63_), .O(new_n94_));
  ...
  nor2   g041(.a(new_n103_), .b(new_n64_), .O(z05));
  oai22  g042(.a(x40), .b(new_n63_), .c(new_n83_), .d(new_n98_), .O(new_n105_));
  ...
  nor2   g070(.a(new_n66_), .b(new_n98_), .O(new_n133_));
  aoi21  g071(.a(new_n133_), .b(x06), .c(new_n64_), .O(new_n134_));
  ...
  nand4  g077(.a(x35), .b(new_n83_), .c(x27), .d(new_n72_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x08), .c(new_n139_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n80_), .c(new_n63_), .O(new_n143_));
  ...
  nand2  g084(.a(x39), .b(new_n72_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n69_), .O(new_n148_));
  oai21  g086(.a(x28), .b(x09), .c(x35), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n66_), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(x27), .c(new_n63_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n75_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n148_), .c(new_n146_), .O(z12));
  inv1   g091(.a(x13), .O(new_n154_));
  nand2  g092(.a(x36), .b(x35), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x28), .c(new_n75_), .O(new_n156_));
  ...
  inv1   g105(.a(new_n120_), .O(new_n168_));
  nand4  g106(.a(new_n155_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n168_), .c(new_n154_), .d(new_n72_), .O(new_n170_));
  ...
  nand3  g113(.a(x39), .b(new_n154_), .c(new_n72_), .O(new_n176_));
  ...
  nand2  g125(.a(new_n98_), .b(new_n63_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n84_), .c(new_n136_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x08), .O(new_n190_));
  oai21  g128(.a(new_n141_), .b(x30), .c(new_n63_), .O(new_n191_));
  nand2  g129(.a(x40), .b(x09), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n191_), .c(new_n190_), .O(z18));
  inv1   g131(.a(new_n143_), .O(z19));
  inv1   g132(.a(new_n136_), .O(new_n195_));
  nor2   g133(.a(new_n172_), .b(new_n98_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n98_), .c(new_n172_), .O(new_n197_));
  oai22  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .d(x08), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n80_), .c(new_n63_), .O(new_n199_));
