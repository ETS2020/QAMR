...
module FAU ( 
  ...
  nand2  g035(.a(new_n65_), .b(new_n91_), .O(new_n98_));
  ...
  oai22  g039(.a(x40), .b(x25), .c(new_n82_), .d(new_n91_), .O(new_n102_));
  ...
  nand3  g046(.a(x40), .b(new_n108_), .c(x00), .O(new_n109_));
  oai21  g047(.a(new_n63_), .b(x38), .c(new_n109_), .O(new_n110_));
  nand4  g048(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n105_), .O(new_n111_));
  inv1   g049(.a(x14), .O(new_n112_));
  inv1   g050(.a(x00), .O(new_n113_));
  aoi21  g051(.a(x38), .b(new_n113_), .c(new_n74_), .O(new_n114_));
  oai21  g052(.a(new_n114_), .b(x25), .c(new_n112_), .O(new_n115_));
  ...
  nor2   g073(.a(new_n91_), .b(new_n71_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n83_), .c(new_n135_), .O(new_n137_));
  nand4  g075(.a(x35), .b(new_n82_), .c(x27), .d(new_n71_), .O(new_n138_));
  ...
  nor2   g081(.a(new_n74_), .b(x27), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n73_), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n71_), .c(new_n74_), .O(new_n146_));
  nor2   g084(.a(x40), .b(new_n108_), .O(new_n147_));
  oai21  g085(.a(new_n147_), .b(new_n146_), .c(new_n68_), .O(new_n148_));
  nand3  g086(.a(new_n148_), .b(new_n145_), .c(new_n64_), .O(z12));
  ...
  aoi21  g094(.a(new_n156_), .b(new_n153_), .c(new_n74_), .O(new_n157_));
  nand4  g095(.a(new_n67_), .b(x25), .c(x20), .d(new_n155_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n128_), .b(new_n150_), .c(new_n71_), .O(new_n161_));
  ...
  nand3  g102(.a(x39), .b(new_n150_), .c(new_n71_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n74_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n147_), .c(new_n163_), .O(new_n168_));
  inv1   g106(.a(x35), .O(new_n169_));
  nand3  g107(.a(new_n65_), .b(new_n169_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  nand2  g110(.a(new_n165_), .b(new_n68_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x40), .O(new_n175_));
  nand3  g113(.a(new_n68_), .b(new_n74_), .c(x25), .O(new_n176_));
  ...
  oai21  g123(.a(new_n83_), .b(x27), .c(new_n135_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n63_), .b(x30), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n187_), .c(new_n138_), .d(new_n134_), .O(z18));
  inv1   g127(.a(new_n135_), .O(new_n190_));
  oai21  g128(.a(new_n169_), .b(new_n91_), .c(new_n90_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n91_), .c(new_n169_), .O(new_n192_));
  ...
  nand2  g133(.a(new_n141_), .b(new_n64_), .O(z19));
endmodule
