...
module FAU ( 
  ...
  aoi21  g036(.a(new_n96_), .b(new_n78_), .c(new_n98_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n95_), .c(new_n94_), .d(new_n92_), .O(z02));
  oai21  g038(.a(new_n66_), .b(new_n84_), .c(x27), .O(new_n101_));
  inv1   g039(.a(x37), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n64_), .O(new_n103_));
  nand4  g041(.a(new_n103_), .b(new_n101_), .c(new_n97_), .d(x21), .O(z03));
  aoi21  g042(.a(new_n102_), .b(new_n64_), .c(x21), .O(new_n105_));
  aoi21  g043(.a(new_n105_), .b(new_n101_), .c(new_n79_), .O(z04));
  nand2  g044(.a(x28), .b(x27), .O(new_n107_));
  nand3  g045(.a(new_n107_), .b(new_n97_), .c(new_n102_), .O(z05));
  ...
  nand3  g057(.a(new_n119_), .b(new_n97_), .c(x03), .O(new_n120_));
  inv1   g058(.a(new_n120_), .O(z07));
  inv1   g059(.a(x39), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(x30), .c(new_n78_), .O(z08));
  nand4  g061(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(new_n97_), .O(z09));
  nand4  g063(.a(new_n86_), .b(new_n72_), .c(x27), .d(x07), .O(new_n126_));
  ...
  nand2  g072(.a(new_n64_), .b(new_n134_), .O(new_n135_));
  nand4  g073(.a(new_n135_), .b(new_n133_), .c(x35), .d(new_n84_), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(new_n78_), .c(new_n82_), .d(new_n132_), .O(new_n137_));
  ...
  aoi21  g079(.a(x39), .b(new_n65_), .c(new_n82_), .O(new_n142_));
  oai22  g080(.a(new_n142_), .b(new_n78_), .c(new_n70_), .d(new_n64_), .O(new_n143_));
  nand3  g081(.a(new_n143_), .b(new_n141_), .c(new_n97_), .O(z12));
  ...
  nand3  g087(.a(x39), .b(new_n149_), .c(new_n65_), .O(new_n150_));
  ...
  nor2   g092(.a(new_n154_), .b(new_n70_), .O(new_n155_));
  aoi21  g093(.a(new_n151_), .b(x40), .c(new_n155_), .O(z14));
  inv1   g094(.a(x12), .O(new_n157_));
  nand4  g095(.a(new_n97_), .b(x34), .c(x27), .d(x26), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(new_n157_), .O(z15));
  inv1   g097(.a(x23), .O(new_n160_));
  nand3  g098(.a(new_n160_), .b(x22), .c(x01), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n97_), .O(z16));
  inv1   g100(.a(x01), .O(new_n163_));
  inv1   g101(.a(x24), .O(new_n164_));
  nand4  g102(.a(new_n97_), .b(new_n164_), .c(x23), .d(x22), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(new_n163_), .O(z17));
  nand2  g104(.a(x27), .b(new_n65_), .O(new_n167_));
  oai21  g105(.a(x27), .b(new_n134_), .c(new_n167_), .O(new_n168_));
  nand3  g106(.a(new_n168_), .b(x35), .c(new_n84_), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n78_), .c(new_n82_), .d(new_n132_), .O(z18));
  oai21  g108(.a(x28), .b(new_n134_), .c(new_n64_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x35), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n78_), .c(new_n82_), .d(new_n132_), .O(new_n173_));
  inv1   g111(.a(new_n173_), .O(z20));
  inv1   g112(.a(new_n137_), .O(z19));
endmodule
