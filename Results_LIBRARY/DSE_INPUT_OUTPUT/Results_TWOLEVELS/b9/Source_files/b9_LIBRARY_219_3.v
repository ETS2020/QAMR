...
module FAU ( 
  ...
  aoi21  g15(.a(new_n77_), .b(x04), .c(new_n64_), .O(z01));
  nand2  g16(.a(new_n68_), .b(x27), .O(new_n79_));
  inv1   g17(.a(x21), .O(new_n80_));
  aoi21  g18(.a(new_n67_), .b(new_n66_), .c(new_n80_), .O(new_n81_));
  aoi21  g19(.a(new_n81_), .b(new_n79_), .c(new_n64_), .O(z03));
  nand2  g20(.a(new_n67_), .b(new_n66_), .O(new_n83_));
  nand4  g21(.a(new_n83_), .b(new_n79_), .c(z02), .d(new_n80_), .O(z04));
  nand2  g22(.a(x28), .b(x27), .O(new_n85_));
  aoi21  g23(.a(new_n85_), .b(new_n67_), .c(new_n64_), .O(z05));
  inv1   g24(.a(new_n85_), .O(new_n87_));
  oai21  g25(.a(new_n87_), .b(x37), .c(z02), .O(z06));
  ...
  inv1   g39(.a(x11), .O(new_n103_));
  nand4  g40(.a(z02), .b(x34), .c(x27), .d(x26), .O(new_n104_));
  nor2   g41(.a(new_n104_), .b(new_n103_), .O(z09));
  ...
  nand3  g46(.a(new_n109_), .b(z02), .c(x27), .O(new_n110_));
  inv1   g47(.a(new_n110_), .O(z10));
  inv1   g48(.a(x09), .O(new_n112_));
  inv1   g49(.a(x28), .O(new_n113_));
  nor2   g50(.a(x27), .b(x08), .O(new_n114_));
  aoi21  g51(.a(x27), .b(x04), .c(new_n114_), .O(new_n115_));
  nand3  g52(.a(new_n115_), .b(x35), .c(new_n113_), .O(new_n116_));
  nand4  g53(.a(new_n116_), .b(z02), .c(new_n72_), .d(new_n112_), .O(new_n117_));
  inv1   g54(.a(new_n117_), .O(z11));
  nor2   g55(.a(new_n69_), .b(new_n64_), .O(z12));
  inv1   g56(.a(x18), .O(new_n120_));
  inv1   g57(.a(x19), .O(new_n121_));
  nand4  g58(.a(new_n69_), .b(x20), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  nand2  g59(.a(new_n122_), .b(z02), .O(z13));
  nand4  g60(.a(x27), .b(x20), .c(new_n121_), .d(new_n120_), .O(new_n124_));
  aoi21  g61(.a(new_n68_), .b(new_n67_), .c(new_n124_), .O(new_n125_));
  nor2   g62(.a(new_n125_), .b(new_n64_), .O(z14));
  inv1   g63(.a(x12), .O(new_n127_));
  nor2   g64(.a(new_n104_), .b(new_n127_), .O(z15));
  inv1   g65(.a(x23), .O(new_n129_));
  nand4  g66(.a(z02), .b(new_n129_), .c(x22), .d(x01), .O(new_n130_));
  inv1   g67(.a(new_n130_), .O(z16));
  inv1   g68(.a(x24), .O(new_n132_));
  nand4  g69(.a(new_n132_), .b(x23), .c(x22), .d(x01), .O(new_n133_));
  nand2  g70(.a(new_n133_), .b(z02), .O(z17));
  nand2  g71(.a(new_n66_), .b(x08), .O(new_n135_));
  oai21  g72(.a(new_n66_), .b(x04), .c(new_n135_), .O(new_n136_));
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n113_), .O(new_n137_));
  nand4  g74(.a(new_n137_), .b(z02), .c(new_n72_), .d(new_n112_), .O(z18));
  nand2  g75(.a(new_n117_), .b(z02), .O(z19));
  oai21  g76(.a(new_n114_), .b(new_n73_), .c(z02), .O(new_n140_));
  oai21  g77(.a(new_n113_), .b(x27), .c(new_n140_), .O(new_n141_));
  nand3  g78(.a(new_n141_), .b(new_n72_), .c(new_n112_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(z02), .O(z20));
  zero   g80(.O(z08));
endmodule
