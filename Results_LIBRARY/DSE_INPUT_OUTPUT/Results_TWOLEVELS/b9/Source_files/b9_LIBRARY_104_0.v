...
module FAU ( 
  ...
  nand2  g033(.a(new_n67_), .b(new_n92_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n95_), .c(new_n65_), .d(x21), .O(z03));
  aoi21  g035(.a(new_n67_), .b(new_n92_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n95_), .c(new_n79_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n65_), .c(new_n67_), .O(z05));
  oai22  g039(.a(x40), .b(x03), .c(new_n83_), .d(new_n92_), .O(new_n102_));
  ...
  nand2  g058(.a(x40), .b(new_n120_), .O(new_n121_));
  nand2  g059(.a(new_n64_), .b(x03), .O(new_n122_));
  ...
  nand2  g073(.a(new_n65_), .b(new_n92_), .O(new_n136_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n122_), .c(new_n140_), .d(new_n139_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(new_n80_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(x09), .c(new_n65_), .O(z11));
  nor3   g083(.a(x37), .b(x36), .c(x35), .O(new_n146_));
  nand2  g084(.a(x40), .b(new_n92_), .O(new_n147_));
  ...
  aoi21  g093(.a(new_n155_), .b(new_n92_), .c(new_n154_), .O(new_n156_));
  ...
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n158_), .d(new_n73_), .O(new_n161_));
  ...
  nor2   g104(.a(new_n132_), .b(x13), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n73_), .c(new_n79_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n166_), .O(z13));
  nand3  g107(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n170_));
  inv1   g108(.a(new_n115_), .O(new_n171_));
  nand4  g109(.a(new_n159_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n172_));
  nand4  g110(.a(new_n172_), .b(new_n171_), .c(new_n158_), .d(new_n73_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n170_), .O(new_n174_));
  nor2   g112(.a(x37), .b(x35), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n147_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n80_), .O(new_n178_));
  nand2  g116(.a(new_n147_), .b(new_n69_), .O(new_n179_));
  oai21  g117(.a(x13), .b(x04), .c(new_n179_), .O(new_n180_));
  oai21  g118(.a(new_n175_), .b(new_n92_), .c(new_n115_), .O(new_n181_));
  nand2  g119(.a(new_n122_), .b(x39), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n67_), .c(new_n83_), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n181_), .c(new_n65_), .O(new_n184_));
  inv1   g122(.a(new_n184_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n180_), .c(new_n178_), .d(new_n174_), .O(z14));
  ...
  oai22  g132(.a(new_n115_), .b(new_n141_), .c(new_n84_), .d(x27), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(x08), .O(new_n196_));
  nor2   g134(.a(new_n92_), .b(x04), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(new_n139_), .c(x09), .O(new_n198_));
  nand4  g136(.a(new_n198_), .b(new_n196_), .c(new_n65_), .d(new_n80_), .O(z18));
  nor2   g137(.a(new_n144_), .b(x09), .O(z19));
  inv1   g138(.a(x35), .O(new_n201_));
  aoi21  g139(.a(x28), .b(new_n92_), .c(new_n201_), .O(new_n202_));
  aoi21  g140(.a(new_n142_), .b(new_n122_), .c(new_n202_), .O(new_n203_));
  nand2  g141(.a(x40), .b(new_n201_), .O(new_n204_));
  aoi21  g142(.a(new_n204_), .b(new_n136_), .c(x08), .O(new_n205_));
