...
module FAU ( 
  ...
  oai22  g044(.a(x40), .b(x12), .c(new_n92_), .d(new_n100_), .O(new_n107_));
  ...
  nand2  g057(.a(new_n95_), .b(new_n65_), .O(z08));
  ...
  nand2  g062(.a(new_n95_), .b(x07), .O(new_n125_));
  oai21  g063(.a(new_n95_), .b(new_n124_), .c(new_n125_), .O(new_n126_));
  ...
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n79_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n92_), .c(new_n72_), .O(new_n136_));
  ...
  nand2  g077(.a(new_n64_), .b(x12), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(x35), .c(new_n92_), .O(new_n143_));
  ...
  nor2   g086(.a(new_n64_), .b(x27), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n148_), .c(new_n74_), .O(new_n150_));
  nand2  g088(.a(x39), .b(new_n72_), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(new_n69_), .O(new_n152_));
  nand2  g090(.a(new_n92_), .b(x12), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x35), .c(x37), .O(new_n154_));
  nand2  g092(.a(x27), .b(x12), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n154_), .c(new_n64_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n152_), .c(new_n150_), .O(z12));
  inv1   g095(.a(x13), .O(new_n158_));
  nand2  g096(.a(x36), .b(x35), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x28), .c(new_n64_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n158_), .d(new_n72_), .O(new_n161_));
  ...
  nand3  g104(.a(new_n128_), .b(x40), .c(x39), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(x13), .O(new_n168_));
  aoi21  g106(.a(new_n168_), .b(new_n72_), .c(new_n79_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n166_), .O(z13));
  aoi21  g108(.a(new_n81_), .b(new_n80_), .c(x13), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(x40), .c(x39), .d(new_n72_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n100_), .O(new_n173_));
  nand3  g111(.a(x20), .b(new_n163_), .c(new_n162_), .O(new_n174_));
  nand4  g112(.a(new_n159_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n175_));
  nand4  g113(.a(new_n175_), .b(new_n96_), .c(new_n158_), .d(new_n72_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand3  g115(.a(x39), .b(new_n158_), .c(new_n72_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n67_), .O(new_n179_));
  nand3  g117(.a(new_n81_), .b(new_n80_), .c(x28), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x40), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n82_), .O(new_n182_));
  nand3  g120(.a(new_n64_), .b(new_n92_), .c(x12), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n182_), .c(new_n179_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n66_), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n177_), .c(new_n173_), .d(new_n65_), .O(z14));
  ...
  nand2  g131(.a(new_n193_), .b(new_n65_), .O(z17));
  nor2   g132(.a(new_n82_), .b(x28), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n100_), .O(new_n196_));
  nand2  g134(.a(new_n96_), .b(x29), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(x08), .O(new_n199_));
  nor2   g137(.a(new_n100_), .b(x04), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n195_), .c(x09), .O(new_n201_));
  nand4  g139(.a(new_n201_), .b(new_n199_), .c(new_n65_), .d(new_n80_), .O(z18));
  inv1   g140(.a(new_n146_), .O(z19));
  nor2   g141(.a(x40), .b(x35), .O(new_n204_));
  oai21  g142(.a(new_n204_), .b(new_n91_), .c(x12), .O(new_n205_));
  ...
  nand3  g146(.a(new_n197_), .b(x28), .c(new_n100_), .O(new_n209_));
  nand3  g147(.a(new_n209_), .b(new_n208_), .c(new_n205_), .O(new_n210_));
  nand3  g148(.a(new_n210_), .b(new_n80_), .c(new_n135_), .O(new_n211_));
