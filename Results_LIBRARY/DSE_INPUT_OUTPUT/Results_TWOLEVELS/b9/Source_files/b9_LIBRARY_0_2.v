...
module FAU ( 
  ...
  oai21  g034(.a(new_n91_), .b(new_n63_), .c(new_n96_), .O(z02));
  ...
  nand3  g063(.a(new_n125_), .b(new_n83_), .c(new_n73_), .O(new_n126_));
  ...
  nand4  g095(.a(new_n155_), .b(new_n92_), .c(x20), .d(new_n154_), .O(new_n158_));
  ...
  oai21  g103(.a(new_n163_), .b(new_n92_), .c(new_n165_), .O(new_n166_));
  ...
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n81_), .O(new_n183_));
  nand2  g121(.a(new_n79_), .b(new_n134_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(new_n93_), .c(new_n184_), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n99_), .c(new_n118_), .d(new_n88_), .O(z18));
