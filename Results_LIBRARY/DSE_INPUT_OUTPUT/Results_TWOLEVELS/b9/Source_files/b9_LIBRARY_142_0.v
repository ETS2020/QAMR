...
module FAU ( 
  ...
  aoi21  g035(.a(new_n66_), .b(new_n91_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n97_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n65_), .c(new_n66_), .O(z05));
  aoi21  g039(.a(new_n65_), .b(new_n91_), .c(new_n82_), .O(new_n102_));
  ...
  oai21  g058(.a(new_n115_), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  ...
  nor2   g066(.a(new_n66_), .b(new_n91_), .O(new_n129_));
  aoi21  g067(.a(new_n129_), .b(x06), .c(new_n97_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(z10));
  inv1   g069(.a(x09), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n82_), .c(new_n72_), .O(new_n133_));
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n65_), .d(new_n91_), .O(new_n134_));
  nand2  g072(.a(x39), .b(x29), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(x40), .O(new_n136_));
  nand2  g074(.a(new_n64_), .b(x26), .O(new_n137_));
  ...
  nor2   g083(.a(new_n123_), .b(x27), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n74_), .O(new_n147_));
  inv1   g085(.a(new_n115_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n72_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n67_), .c(new_n66_), .O(new_n150_));
  aoi21  g088(.a(x27), .b(x26), .c(x40), .O(new_n151_));
  nand2  g089(.a(x39), .b(new_n72_), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(new_n91_), .c(new_n151_), .O(new_n153_));
  nand3  g091(.a(new_n153_), .b(new_n150_), .c(new_n147_), .O(z12));
  ...
  nand4  g100(.a(new_n68_), .b(x26), .c(x20), .d(new_n160_), .O(new_n163_));
  nor2   g101(.a(new_n163_), .b(x18), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n162_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n125_), .b(new_n155_), .c(new_n72_), .O(new_n166_));
  ...
  nand2  g107(.a(new_n155_), .b(new_n72_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x39), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n169_), .c(new_n148_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n168_), .O(new_n173_));
  inv1   g111(.a(x35), .O(new_n174_));
  nand3  g112(.a(new_n66_), .b(new_n174_), .c(x28), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n80_), .c(new_n79_), .O(new_n177_));
  oai21  g115(.a(new_n123_), .b(x27), .c(new_n68_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n170_), .O(new_n179_));
  aoi21  g117(.a(new_n115_), .b(new_n69_), .c(new_n97_), .O(new_n180_));
  nand4  g118(.a(new_n180_), .b(new_n179_), .c(new_n177_), .d(new_n173_), .O(z14));
  ...
  nand2  g128(.a(new_n148_), .b(x29), .O(new_n191_));
  oai21  g129(.a(new_n83_), .b(x27), .c(new_n191_), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n174_), .b(x28), .O(new_n194_));
  nor2   g132(.a(new_n91_), .b(x04), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n194_), .c(x09), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n193_), .c(new_n65_), .d(new_n79_), .O(z18));
  nand2  g135(.a(new_n143_), .b(new_n65_), .O(z19));
  oai22  g136(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(x26), .O(new_n200_));
  ...
  nand3  g141(.a(new_n191_), .b(x28), .c(new_n91_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n203_), .c(new_n200_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n79_), .c(new_n132_), .O(new_n206_));
