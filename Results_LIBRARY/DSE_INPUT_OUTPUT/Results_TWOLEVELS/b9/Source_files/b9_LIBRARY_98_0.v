...
module FAU ( 
  ...
  aoi21  g055(.a(x35), .b(new_n86_), .c(x36), .O(new_n118_));
  ...
  nor3   g061(.a(new_n63_), .b(new_n65_), .c(new_n123_), .O(new_n124_));
  aoi21  g062(.a(new_n122_), .b(new_n71_), .c(new_n124_), .O(new_n125_));
  ...
  oai21  g067(.a(new_n125_), .b(new_n91_), .c(new_n129_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  nand3  g069(.a(x40), .b(x39), .c(x29), .O(new_n132_));
  nor2   g070(.a(new_n91_), .b(new_n71_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n87_), .c(new_n132_), .O(new_n134_));
  nand3  g072(.a(new_n82_), .b(x27), .c(new_n71_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n90_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n79_), .c(new_n131_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n64_), .O(z11));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  nor2   g078(.a(new_n126_), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(new_n73_), .O(new_n142_));
  nor2   g080(.a(new_n74_), .b(x39), .O(new_n143_));
  aoi21  g081(.a(x40), .b(new_n71_), .c(new_n126_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n68_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n142_), .c(new_n64_), .O(z12));
  ...
  aoi21  g091(.a(new_n153_), .b(new_n150_), .c(new_n126_), .O(new_n154_));
  nand4  g092(.a(new_n67_), .b(x40), .c(x20), .d(new_n152_), .O(new_n155_));
  ...
  nand3  g099(.a(x40), .b(new_n147_), .c(new_n71_), .O(new_n162_));
  inv1   g100(.a(new_n162_), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n161_), .c(new_n126_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n143_), .c(new_n160_), .O(new_n165_));
  nand3  g103(.a(new_n65_), .b(new_n81_), .c(x28), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(x27), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n80_), .c(new_n79_), .O(new_n168_));
  nand2  g106(.a(new_n162_), .b(new_n68_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x39), .O(new_n171_));
  nand3  g109(.a(new_n68_), .b(x40), .c(new_n126_), .O(new_n172_));
  ...
  oai21  g119(.a(new_n87_), .b(x27), .c(new_n132_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  nor2   g121(.a(new_n63_), .b(x30), .O(new_n184_));
  nand4  g122(.a(new_n184_), .b(new_n183_), .c(new_n135_), .d(new_n131_), .O(z18));
  inv1   g123(.a(new_n132_), .O(new_n186_));
  oai21  g124(.a(new_n81_), .b(new_n91_), .c(new_n90_), .O(new_n187_));
  aoi21  g125(.a(x28), .b(new_n91_), .c(new_n81_), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n187_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n79_), .c(new_n131_), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n64_), .O(z20));
  nand2  g129(.a(new_n138_), .b(new_n64_), .O(z19));
endmodule
