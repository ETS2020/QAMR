...
module FAU ( 
  ...
  nand3  g17(.a(new_n63_), .b(new_n67_), .c(new_n66_), .O(new_n81_));
  nand4  g18(.a(new_n81_), .b(new_n80_), .c(new_n63_), .d(x21), .O(z03));
  inv1   g19(.a(x21), .O(new_n83_));
  nand4  g20(.a(new_n81_), .b(new_n80_), .c(new_n63_), .d(new_n83_), .O(z04));
  nand2  g21(.a(x28), .b(x27), .O(new_n85_));
  nand3  g22(.a(new_n85_), .b(new_n63_), .c(new_n67_), .O(z05));
  ...
  nand3  g40(.a(new_n75_), .b(x07), .c(new_n104_), .O(new_n105_));
  nand2  g41(.a(x37), .b(x06), .O(new_n106_));
  nand2  g42(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand3  g43(.a(new_n107_), .b(new_n63_), .c(x27), .O(new_n108_));
  inv1   g44(.a(new_n108_), .O(z10));
  inv1   g45(.a(x09), .O(new_n110_));
  inv1   g46(.a(x28), .O(new_n111_));
  nor2   g47(.a(x27), .b(x08), .O(new_n112_));
  aoi21  g48(.a(x27), .b(x04), .c(new_n112_), .O(new_n113_));
  nand3  g49(.a(new_n113_), .b(x35), .c(new_n111_), .O(new_n114_));
  nand4  g50(.a(new_n114_), .b(new_n63_), .c(new_n72_), .d(new_n110_), .O(new_n115_));
  inv1   g51(.a(new_n115_), .O(z11));
  nor2   g52(.a(new_n69_), .b(new_n64_), .O(z12));
  inv1   g53(.a(x18), .O(new_n118_));
  inv1   g54(.a(x19), .O(new_n119_));
  nand4  g55(.a(new_n69_), .b(x20), .c(new_n119_), .d(new_n118_), .O(new_n120_));
  nand2  g56(.a(new_n120_), .b(new_n63_), .O(z13));
  nand4  g57(.a(x27), .b(x20), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  aoi21  g58(.a(new_n68_), .b(new_n67_), .c(new_n122_), .O(new_n123_));
  nor2   g59(.a(new_n123_), .b(new_n64_), .O(z14));
  nand4  g60(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n125_));
  nand2  g61(.a(new_n125_), .b(new_n63_), .O(z15));
  inv1   g62(.a(x23), .O(new_n127_));
  nand3  g63(.a(new_n127_), .b(x22), .c(x01), .O(new_n128_));
  nand2  g64(.a(new_n128_), .b(new_n63_), .O(z16));
  inv1   g65(.a(x01), .O(new_n130_));
  inv1   g66(.a(x24), .O(new_n131_));
  nand4  g67(.a(new_n63_), .b(new_n131_), .c(x23), .d(x22), .O(new_n132_));
  nor2   g68(.a(new_n132_), .b(new_n130_), .O(z17));
  nand2  g69(.a(new_n66_), .b(x08), .O(new_n134_));
  oai21  g70(.a(new_n66_), .b(x04), .c(new_n134_), .O(new_n135_));
  nand3  g71(.a(new_n135_), .b(x35), .c(new_n111_), .O(new_n136_));
  nand4  g72(.a(new_n136_), .b(new_n63_), .c(new_n72_), .d(new_n110_), .O(z18));
  nand2  g73(.a(new_n115_), .b(new_n63_), .O(z19));
  oai21  g74(.a(new_n112_), .b(new_n73_), .c(new_n63_), .O(new_n139_));
  oai21  g75(.a(new_n111_), .b(x27), .c(new_n139_), .O(new_n140_));
  nand3  g76(.a(new_n140_), .b(new_n72_), .c(new_n110_), .O(new_n141_));
  nand2  g77(.a(new_n141_), .b(new_n63_), .O(z20));
  one    g78(.O(z02));
  zero   g79(.O(z08));
endmodule
