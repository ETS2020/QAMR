...
module FAU ( 
  ...
  aoi22  g028(.a(new_n90_), .b(x21), .c(x40), .d(new_n69_), .O(z03));
  inv1   g029(.a(x21), .O(new_n92_));
  aoi22  g030(.a(new_n90_), .b(new_n92_), .c(x40), .d(new_n69_), .O(z04));
  ...
  aoi21  g061(.a(new_n74_), .b(new_n73_), .c(new_n123_), .O(new_n124_));
  nand4  g062(.a(new_n124_), .b(x39), .c(x05), .d(new_n114_), .O(new_n125_));
  ...
  oai21  g067(.a(new_n129_), .b(new_n114_), .c(new_n76_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  inv1   g069(.a(x08), .O(new_n132_));
  aoi21  g070(.a(x40), .b(new_n69_), .c(x27), .O(new_n133_));
  inv1   g071(.a(x35), .O(new_n134_));
  nand2  g072(.a(x39), .b(new_n134_), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(new_n76_), .c(new_n114_), .O(new_n136_));
  oai21  g074(.a(new_n136_), .b(new_n133_), .c(new_n132_), .O(new_n137_));
  oai21  g075(.a(new_n69_), .b(x29), .c(x40), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n137_), .c(new_n131_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n73_), .c(new_n127_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n70_), .O(z11));
  nor2   g080(.a(new_n64_), .b(new_n129_), .O(new_n143_));
  nand3  g081(.a(new_n94_), .b(new_n75_), .c(new_n134_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(x27), .c(x10), .O(new_n145_));
  nor2   g083(.a(new_n143_), .b(new_n114_), .O(new_n146_));
  ...
  nand4  g089(.a(new_n151_), .b(x40), .c(new_n149_), .d(new_n114_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand2  g092(.a(new_n88_), .b(new_n94_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n152_), .c(new_n129_), .O(new_n157_));
  nand2  g095(.a(new_n74_), .b(new_n73_), .O(new_n158_));
  nand3  g096(.a(new_n158_), .b(new_n149_), .c(new_n114_), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(x39), .c(new_n123_), .O(new_n160_));
  or2    g098(.a(new_n160_), .b(new_n157_), .O(z13));
  nand2  g099(.a(x39), .b(x04), .O(new_n162_));
  nand3  g100(.a(new_n162_), .b(x40), .c(new_n149_), .O(new_n163_));
  oai21  g101(.a(new_n64_), .b(new_n129_), .c(new_n163_), .O(new_n164_));
  nand3  g102(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n165_));
  nand4  g103(.a(new_n150_), .b(new_n74_), .c(new_n73_), .d(x28), .O(new_n166_));
  nand4  g104(.a(new_n166_), .b(x40), .c(new_n149_), .d(new_n114_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand3  g106(.a(new_n94_), .b(new_n134_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n74_), .c(new_n73_), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n168_), .c(new_n164_), .d(new_n70_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nand4  g111(.a(new_n70_), .b(x34), .c(x27), .d(x26), .O(new_n174_));
  ...
  nand2  g119(.a(x27), .b(new_n114_), .O(new_n182_));
  nand2  g120(.a(new_n129_), .b(x08), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n182_), .c(new_n134_), .O(new_n184_));
  nand2  g122(.a(new_n73_), .b(new_n127_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(new_n76_), .c(new_n185_), .O(new_n186_));
  oai22  g124(.a(new_n186_), .b(new_n95_), .c(new_n117_), .d(new_n83_), .O(z18));
  oai21  g125(.a(new_n76_), .b(x27), .c(x35), .O(new_n188_));
  and2   g126(.a(new_n188_), .b(new_n138_), .O(new_n189_));
  nand2  g127(.a(new_n70_), .b(new_n129_), .O(new_n190_));
  aoi21  g128(.a(new_n135_), .b(new_n190_), .c(x08), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n73_), .O(new_n192_));
  nor2   g130(.a(new_n192_), .b(x09), .O(z20));
  buf    g131(.a(x40), .O(z08));
  nand2  g132(.a(new_n141_), .b(new_n70_), .O(z19));
endmodule
