...
module FAU ( 
  ...
  nand3  g073(.a(x35), .b(new_n83_), .c(new_n71_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n64_), .d(new_n92_), .O(new_n137_));
  ...
  oai21  g081(.a(new_n63_), .b(new_n71_), .c(x40), .O(new_n144_));
  ...
  oai22  g117(.a(new_n84_), .b(x27), .c(new_n74_), .d(new_n179_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x08), .O(new_n181_));
  inv1   g119(.a(new_n84_), .O(new_n182_));
  nor2   g120(.a(new_n92_), .b(x04), .O(new_n183_));
  ...
  oai21  g124(.a(new_n83_), .b(x27), .c(x35), .O(new_n187_));
  and2   g125(.a(new_n187_), .b(new_n132_), .O(new_n188_));
  nand2  g126(.a(new_n64_), .b(new_n92_), .O(new_n189_));
  inv1   g127(.a(x35), .O(new_n190_));
  nand2  g128(.a(x39), .b(new_n190_), .O(new_n191_));
