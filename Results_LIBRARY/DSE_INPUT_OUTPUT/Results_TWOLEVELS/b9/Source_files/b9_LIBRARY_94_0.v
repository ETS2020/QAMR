...
module FAU ( 
  ...
  oai21  g034(.a(x40), .b(new_n75_), .c(new_n96_), .O(z02));
  ...
  aoi21  g042(.a(new_n81_), .b(new_n64_), .c(new_n91_), .O(new_n105_));
  ...
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n81_), .d(new_n64_), .O(new_n137_));
  ...
  nand3  g080(.a(new_n142_), .b(x35), .c(new_n91_), .O(new_n143_));
  ...
  nand2  g089(.a(z08), .b(new_n65_), .O(new_n152_));
  ...
  nor2   g104(.a(new_n131_), .b(x13), .O(new_n167_));
  ...
  nand2  g109(.a(new_n158_), .b(new_n65_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x40), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n171_), .c(z08), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n170_), .O(new_n175_));
  nand3  g113(.a(new_n70_), .b(new_n66_), .c(x28), .O(new_n176_));
  oai21  g114(.a(new_n76_), .b(x27), .c(new_n176_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n85_), .c(new_n84_), .O(new_n178_));
  oai21  g116(.a(new_n150_), .b(new_n73_), .c(new_n172_), .O(new_n179_));
  inv1   g117(.a(z08), .O(new_n180_));
  nand2  g118(.a(new_n72_), .b(x27), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n180_), .c(new_n83_), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n179_), .c(new_n178_), .d(new_n175_), .O(z14));
  ...
  oai21  g130(.a(new_n92_), .b(x27), .c(new_n192_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(x08), .O(new_n194_));
  nor2   g132(.a(new_n64_), .b(x04), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n86_), .c(x09), .O(new_n196_));
  nand4  g134(.a(new_n196_), .b(new_n194_), .c(new_n81_), .d(new_n84_), .O(z18));
  inv1   g135(.a(new_n146_), .O(z19));
  nand2  g136(.a(x28), .b(new_n64_), .O(new_n199_));
  aoi22  g137(.a(new_n199_), .b(x35), .c(new_n140_), .d(new_n138_), .O(new_n200_));
