...
module FAU ( 
  ...
  oai21  g034(.a(new_n96_), .b(new_n91_), .c(new_n90_), .O(new_n97_));
  ...
  oai21  g059(.a(x39), .b(x09), .c(x40), .O(new_n122_));
  ...
  aoi21  g064(.a(x35), .b(new_n92_), .c(x36), .O(new_n127_));
  nand2  g065(.a(new_n122_), .b(x07), .O(new_n128_));
  nand4  g066(.a(x40), .b(x39), .c(new_n90_), .d(x05), .O(new_n129_));
  ...
  nand4  g074(.a(new_n136_), .b(new_n90_), .c(x05), .d(new_n65_), .O(new_n137_));
  oai21  g075(.a(new_n133_), .b(new_n64_), .c(new_n137_), .O(z10));
  ...
  nand3  g080(.a(new_n86_), .b(x27), .c(new_n65_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n84_), .c(new_n90_), .O(new_n146_));
  ...
  aoi21  g089(.a(new_n151_), .b(new_n150_), .c(new_n99_), .O(new_n152_));
  ...
  aoi21  g112(.a(new_n170_), .b(new_n150_), .c(new_n99_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n171_), .O(z14));
  inv1   g114(.a(x12), .O(new_n177_));
  nor2   g115(.a(new_n125_), .b(new_n177_), .O(z15));
  ...
  oai21  g122(.a(new_n93_), .b(x27), .c(new_n139_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n143_), .c(new_n84_), .d(new_n90_), .O(z18));
  inv1   g125(.a(new_n139_), .O(new_n188_));
  oai21  g126(.a(new_n66_), .b(new_n64_), .c(new_n142_), .O(new_n189_));
  aoi21  g127(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n189_), .O(new_n191_));
  nand3  g129(.a(new_n191_), .b(new_n84_), .c(new_n90_), .O(new_n192_));
