...
module FAU ( 
  ...
  inv1   g51(.a(x27), .O(new_n115_));
  aoi21  g52(.a(new_n115_), .b(new_n114_), .c(new_n71_), .O(new_n116_));
  aoi21  g53(.a(x27), .b(x04), .c(x28), .O(new_n117_));
  oai21  g54(.a(new_n116_), .b(z08), .c(new_n117_), .O(new_n118_));
  nand3  g55(.a(new_n118_), .b(new_n70_), .c(new_n113_), .O(new_n119_));
  nand2  g56(.a(new_n119_), .b(new_n67_), .O(z11));
  aoi21  g57(.a(new_n65_), .b(x27), .c(z08), .O(z12));
  nand4  g58(.a(new_n67_), .b(new_n65_), .c(x27), .d(x20), .O(new_n122_));
  nor3   g59(.a(new_n122_), .b(x19), .c(x18), .O(z13));
  inv1   g60(.a(x19), .O(new_n124_));
  nand2  g61(.a(x20), .b(new_n124_), .O(new_n125_));
  nor3   g62(.a(new_n125_), .b(new_n64_), .c(x18), .O(new_n126_));
  aoi21  g63(.a(new_n126_), .b(x27), .c(z08), .O(z14));
  nand4  g64(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n128_));
  nand2  g65(.a(new_n128_), .b(new_n67_), .O(z15));
  inv1   g66(.a(x23), .O(new_n130_));
  nand4  g67(.a(new_n67_), .b(new_n130_), .c(x22), .d(x01), .O(new_n131_));
  inv1   g68(.a(new_n131_), .O(z16));
  inv1   g69(.a(x24), .O(new_n133_));
  nand4  g70(.a(new_n133_), .b(x23), .c(x22), .d(x01), .O(new_n134_));
  nand2  g71(.a(new_n134_), .b(new_n67_), .O(z17));
  inv1   g72(.a(x28), .O(new_n136_));
  nand2  g73(.a(x27), .b(new_n107_), .O(new_n137_));
  oai21  g74(.a(x27), .b(new_n114_), .c(new_n137_), .O(new_n138_));
  nand3  g75(.a(new_n138_), .b(x35), .c(new_n136_), .O(new_n139_));
  nor2   g76(.a(x30), .b(x09), .O(new_n140_));
  aoi21  g77(.a(new_n140_), .b(new_n139_), .c(z08), .O(z18));
  oai21  g78(.a(x28), .b(new_n114_), .c(new_n115_), .O(new_n142_));
  nand2  g79(.a(new_n142_), .b(x35), .O(new_n143_));
  nand4  g80(.a(new_n143_), .b(new_n67_), .c(new_n70_), .d(new_n113_), .O(new_n144_));
  inv1   g81(.a(new_n144_), .O(z20));
  one    g82(.O(z02));
  nand2  g83(.a(new_n119_), .b(new_n67_), .O(z19));
endmodule
