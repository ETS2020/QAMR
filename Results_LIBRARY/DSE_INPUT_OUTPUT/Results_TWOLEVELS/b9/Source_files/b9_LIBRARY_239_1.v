...
module FAU ( 
  ...
  aoi21  g041(.a(new_n64_), .b(new_n97_), .c(new_n82_), .O(new_n104_));
  ...
  oai22  g060(.a(new_n122_), .b(new_n120_), .c(x40), .d(new_n121_), .O(new_n123_));
  ...
  nand2  g074(.a(new_n64_), .b(new_n97_), .O(new_n137_));
  ...
  nand3  g095(.a(new_n129_), .b(new_n147_), .c(new_n71_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(new_n157_), .O(z13));
  nand3  g097(.a(x40), .b(new_n147_), .c(new_n71_), .O(new_n160_));
  ...
  nand2  g120(.a(new_n79_), .b(new_n182_), .O(new_n183_));
  aoi21  g121(.a(new_n181_), .b(new_n82_), .c(new_n183_), .O(new_n184_));
  oai22  g122(.a(new_n184_), .b(new_n94_), .c(new_n122_), .d(new_n89_), .O(z18));
  aoi21  g123(.a(x40), .b(new_n63_), .c(x08), .O(new_n186_));
  aoi21  g124(.a(x40), .b(x29), .c(new_n82_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n97_), .O(new_n188_));
  nand2  g126(.a(new_n89_), .b(x39), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(x40), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(new_n178_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(new_n188_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n79_), .c(new_n182_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n64_), .O(z20));
  buf    g132(.a(x40), .O(z08));
  nor2   g133(.a(new_n141_), .b(x09), .O(z19));
endmodule
