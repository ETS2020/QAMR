...
module FAU ( 
  ...
  aoi21  g039(.a(new_n64_), .b(new_n68_), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g053(.a(new_n63_), .b(new_n115_), .c(new_n64_), .O(z08));
  nand4  g054(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n64_), .O(z09));
  inv1   g056(.a(x07), .O(new_n119_));
  nor2   g057(.a(x40), .b(x25), .O(new_n120_));
  aoi21  g058(.a(x40), .b(new_n115_), .c(new_n120_), .O(new_n121_));
  ...
  nor2   g073(.a(new_n68_), .b(new_n73_), .O(new_n136_));
  ...
  nand2  g077(.a(new_n139_), .b(new_n91_), .O(new_n140_));
  ...
  nand3  g081(.a(new_n69_), .b(new_n81_), .c(new_n82_), .O(new_n144_));
  ...
  nor2   g085(.a(new_n71_), .b(x40), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n109_), .O(new_n149_));
  ...
  aoi21  g099(.a(new_n161_), .b(new_n73_), .c(new_n65_), .O(new_n162_));
  ...
  nand3  g107(.a(new_n69_), .b(new_n82_), .c(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(x27), .O(new_n171_));
  nand3  g109(.a(new_n171_), .b(new_n80_), .c(new_n79_), .O(new_n172_));
  oai21  g110(.a(new_n167_), .b(new_n71_), .c(new_n172_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x40), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(new_n169_), .c(new_n149_), .O(z14));
  ...
  oai21  g122(.a(new_n84_), .b(x27), .c(new_n135_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n68_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n83_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n64_), .d(new_n79_), .O(z18));
  inv1   g127(.a(new_n135_), .O(new_n190_));
  oai21  g128(.a(new_n82_), .b(new_n68_), .c(new_n91_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n68_), .c(new_n82_), .O(new_n192_));
  ...
  nand2  g133(.a(new_n142_), .b(new_n64_), .O(z19));
endmodule
