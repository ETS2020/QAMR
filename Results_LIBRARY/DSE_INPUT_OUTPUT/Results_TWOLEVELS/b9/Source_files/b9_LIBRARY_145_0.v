...
module FAU ( 
  ...
  nand2  g033(.a(new_n64_), .b(x06), .O(new_n96_));
  ...
  oai22  g043(.a(x40), .b(x06), .c(new_n83_), .d(new_n69_), .O(new_n106_));
  ...
  nand3  g071(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n134_));
  ...
  aoi22  g079(.a(new_n141_), .b(new_n138_), .c(new_n140_), .d(new_n96_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n136_), .c(new_n80_), .O(new_n143_));
  nor2   g081(.a(new_n143_), .b(x09), .O(z11));
  nand3  g082(.a(new_n70_), .b(new_n82_), .c(new_n137_), .O(new_n145_));
  ...
  nand2  g086(.a(new_n71_), .b(new_n70_), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x27), .O(new_n150_));
  nand3  g088(.a(new_n150_), .b(new_n64_), .c(x06), .O(new_n151_));
  ...
  nand4  g096(.a(new_n149_), .b(x20), .c(new_n158_), .d(new_n157_), .O(new_n159_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n74_), .c(new_n66_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z13));
  inv1   g103(.a(new_n96_), .O(new_n166_));
  ...
  nand3  g110(.a(new_n70_), .b(new_n137_), .c(x28), .O(new_n173_));
  ...
  nand4  g118(.a(new_n65_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  ...
  nand2  g127(.a(x27), .b(new_n74_), .O(new_n190_));
  ...
  aoi21  g132(.a(new_n192_), .b(new_n83_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n66_), .c(new_n119_), .d(new_n90_), .O(z18));
  nor2   g134(.a(x40), .b(x35), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n92_), .c(x06), .O(new_n198_));
  ...
  nand3  g140(.a(new_n202_), .b(x28), .c(new_n69_), .O(new_n203_));
