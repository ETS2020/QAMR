...
module FAU ( 
  ...
  oai22  g044(.a(x40), .b(x26), .c(new_n84_), .d(new_n100_), .O(new_n107_));
  ...
  nand2  g060(.a(x40), .b(new_n95_), .O(new_n123_));
  nand2  g061(.a(new_n64_), .b(x26), .O(new_n124_));
  ...
  nand2  g070(.a(new_n82_), .b(new_n81_), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x40), .c(x39), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n75_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n131_), .O(z10));
  nand2  g075(.a(new_n65_), .b(new_n100_), .O(new_n138_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n124_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n140_), .c(new_n81_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(x09), .O(z11));
  inv1   g085(.a(x35), .O(new_n148_));
  nand3  g086(.a(new_n69_), .b(new_n83_), .c(new_n148_), .O(new_n149_));
  aoi21  g087(.a(new_n149_), .b(x27), .c(x10), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n75_), .c(new_n73_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(x40), .O(new_n152_));
  nand3  g090(.a(new_n72_), .b(new_n64_), .c(x26), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n152_), .O(z12));
  inv1   g092(.a(x13), .O(new_n155_));
  nand2  g093(.a(x36), .b(x35), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x28), .c(new_n64_), .O(new_n157_));
  nand4  g095(.a(new_n157_), .b(x39), .c(new_n155_), .d(new_n75_), .O(new_n158_));
  inv1   g096(.a(x18), .O(new_n159_));
  inv1   g097(.a(x19), .O(new_n160_));
  nand4  g098(.a(new_n71_), .b(x20), .c(new_n160_), .d(new_n159_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n158_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(x27), .O(new_n163_));
  nor2   g101(.a(new_n134_), .b(x13), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n75_), .c(new_n66_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n163_), .O(z13));
  oai21  g104(.a(new_n95_), .b(x04), .c(x40), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n124_), .c(new_n155_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n72_), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n170_));
  nand4  g108(.a(new_n156_), .b(new_n82_), .c(new_n81_), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(z08), .c(new_n155_), .d(new_n75_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand3  g111(.a(new_n69_), .b(new_n148_), .c(x28), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(x27), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n82_), .c(new_n81_), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n173_), .c(new_n169_), .d(new_n65_), .O(z14));
  ...
  nand2  g125(.a(x27), .b(new_n75_), .O(new_n188_));
  nand2  g126(.a(new_n100_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n148_), .O(new_n190_));
  inv1   g128(.a(x09), .O(new_n191_));
  nand2  g129(.a(new_n81_), .b(new_n191_), .O(new_n192_));
  aoi21  g130(.a(new_n190_), .b(new_n84_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n66_), .c(new_n187_), .d(new_n91_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n93_), .c(x26), .O(new_n196_));
  ...
  nand3  g138(.a(new_n200_), .b(x28), .c(new_n100_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n199_), .c(new_n196_), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(new_n81_), .c(new_n191_), .O(new_n203_));
  nand2  g141(.a(new_n203_), .b(new_n65_), .O(z20));
  nor2   g142(.a(new_n146_), .b(x09), .O(z19));
endmodule
