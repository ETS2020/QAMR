...
module FAU ( 
  ...
  nor2   g071(.a(new_n97_), .b(new_n71_), .O(new_n134_));
  oai22  g072(.a(new_n134_), .b(new_n83_), .c(new_n74_), .d(new_n133_), .O(new_n135_));
  ...
  oai21  g081(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n144_));
  ...
  nand4  g091(.a(new_n67_), .b(new_n74_), .c(x20), .d(new_n151_), .O(new_n154_));
  nor2   g092(.a(new_n154_), .b(x18), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n153_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n129_), .b(new_n146_), .c(new_n71_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x40), .b(new_n146_), .c(new_n71_), .O(new_n159_));
  nor2   g097(.a(x19), .b(x18), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(new_n67_), .c(x27), .d(x20), .O(new_n161_));
  ...
  aoi21  g116(.a(new_n178_), .b(new_n137_), .c(new_n177_), .O(new_n179_));
  nand2  g117(.a(new_n79_), .b(new_n132_), .O(new_n180_));
  aoi21  g118(.a(new_n179_), .b(new_n82_), .c(new_n180_), .O(new_n181_));
  oai22  g119(.a(new_n181_), .b(new_n94_), .c(new_n122_), .d(new_n89_), .O(z18));
  nor2   g120(.a(new_n74_), .b(new_n133_), .O(new_n183_));
  oai21  g121(.a(new_n177_), .b(new_n97_), .c(new_n136_), .O(new_n184_));
  aoi21  g122(.a(x28), .b(new_n97_), .c(new_n177_), .O(new_n185_));
  oai21  g123(.a(new_n185_), .b(new_n183_), .c(new_n184_), .O(new_n186_));
  nand3  g124(.a(new_n186_), .b(new_n79_), .c(new_n132_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n64_), .O(z20));
  buf    g126(.a(x40), .O(z08));
  nand2  g127(.a(new_n140_), .b(new_n64_), .O(z19));
endmodule
