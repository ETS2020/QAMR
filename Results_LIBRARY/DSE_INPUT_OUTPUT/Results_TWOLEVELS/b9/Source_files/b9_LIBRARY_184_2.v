...
module FAU ( 
  ...
  aoi21  g041(.a(new_n79_), .b(new_n67_), .c(new_n83_), .O(new_n104_));
  ...
  aoi21  g052(.a(new_n114_), .b(new_n112_), .c(new_n74_), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(new_n111_), .c(new_n63_), .O(z07));
  nand4  g054(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n79_), .O(z09));
  nand2  g056(.a(new_n94_), .b(x07), .O(new_n119_));
  ...
  nor2   g064(.a(new_n68_), .b(new_n67_), .O(new_n127_));
  aoi21  g065(.a(new_n127_), .b(x06), .c(new_n64_), .O(new_n128_));
  ...
  nand2  g072(.a(x27), .b(new_n72_), .O(new_n135_));
  ...
  nand2  g076(.a(new_n138_), .b(new_n79_), .O(z11));
  inv1   g077(.a(x35), .O(new_n140_));
  nand3  g078(.a(new_n68_), .b(new_n82_), .c(new_n140_), .O(new_n141_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n142_), .c(x40), .O(new_n146_));
  inv1   g084(.a(new_n70_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n74_), .c(new_n63_), .O(new_n148_));
  ...
  nand3  g097(.a(new_n123_), .b(x40), .c(x39), .O(new_n160_));
  nor2   g098(.a(new_n160_), .b(x13), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n72_), .c(new_n64_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n159_), .O(z13));
  aoi21  g101(.a(new_n74_), .b(new_n63_), .c(x13), .O(new_n164_));
  oai21  g102(.a(new_n144_), .b(new_n74_), .c(new_n164_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n147_), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n167_));
  nand4  g105(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n168_));
  nand4  g106(.a(new_n168_), .b(z08), .c(new_n150_), .d(new_n72_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand3  g108(.a(new_n68_), .b(new_n140_), .c(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(x27), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n81_), .c(new_n80_), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n170_), .c(new_n166_), .d(new_n79_), .O(z14));
  ...
  aoi21  g122(.a(new_n184_), .b(new_n135_), .c(new_n140_), .O(new_n185_));
  nand2  g123(.a(new_n80_), .b(new_n130_), .O(new_n186_));
  aoi21  g124(.a(new_n185_), .b(new_n83_), .c(new_n186_), .O(new_n187_));
  oai22  g125(.a(new_n187_), .b(new_n64_), .c(new_n94_), .d(new_n90_), .O(z18));
  inv1   g126(.a(new_n131_), .O(new_n189_));
  oai21  g127(.a(new_n140_), .b(new_n67_), .c(new_n134_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n67_), .c(new_n140_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n130_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n79_), .O(z20));
  nand2  g132(.a(new_n138_), .b(new_n79_), .O(z19));
endmodule
