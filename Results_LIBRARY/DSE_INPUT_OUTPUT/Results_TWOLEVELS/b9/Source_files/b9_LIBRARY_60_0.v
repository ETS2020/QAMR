...
module FAU ( 
  ...
  inv1   g056(.a(new_n94_), .O(new_n119_));
  ...
  nand2  g062(.a(x40), .b(new_n93_), .O(new_n125_));
  nand2  g063(.a(new_n64_), .b(x00), .O(new_n126_));
  ...
  nand2  g075(.a(new_n137_), .b(new_n72_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n133_), .O(z10));
  nand2  g077(.a(new_n65_), .b(new_n97_), .O(new_n140_));
  oai21  g078(.a(new_n83_), .b(x04), .c(x40), .O(new_n141_));
  ...
  aoi22  g084(.a(new_n146_), .b(new_n126_), .c(new_n144_), .d(new_n143_), .O(new_n147_));
  ...
  oai21  g088(.a(new_n150_), .b(new_n97_), .c(new_n74_), .O(new_n151_));
  oai21  g089(.a(new_n119_), .b(x04), .c(new_n69_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n151_), .c(new_n65_), .O(z12));
  ...
  nor2   g100(.a(new_n136_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n72_), .c(new_n98_), .O(new_n164_));
  ...
  nand3  g106(.a(new_n94_), .b(new_n154_), .c(new_n72_), .O(new_n169_));
  oai21  g107(.a(new_n169_), .b(new_n168_), .c(new_n166_), .O(new_n170_));
  inv1   g108(.a(x35), .O(new_n171_));
  nand3  g109(.a(new_n66_), .b(new_n171_), .c(x28), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x27), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n80_), .c(new_n79_), .O(new_n174_));
  aoi21  g112(.a(new_n169_), .b(new_n69_), .c(new_n98_), .O(new_n175_));
  nand3  g113(.a(new_n175_), .b(new_n174_), .c(new_n170_), .O(z14));
  ...
  nand2  g122(.a(new_n94_), .b(x29), .O(new_n185_));
  oai21  g123(.a(new_n83_), .b(x27), .c(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nor2   g125(.a(new_n97_), .b(x04), .O(new_n188_));
  aoi21  g126(.a(new_n188_), .b(new_n143_), .c(x09), .O(new_n189_));
  nand4  g127(.a(new_n189_), .b(new_n187_), .c(new_n65_), .d(new_n79_), .O(z18));
  nor2   g128(.a(x40), .b(x35), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n91_), .c(x00), .O(new_n192_));
  aoi21  g130(.a(x35), .b(x27), .c(x08), .O(new_n193_));
  aoi21  g131(.a(x39), .b(x29), .c(x35), .O(new_n194_));
  oai21  g132(.a(new_n194_), .b(new_n193_), .c(x40), .O(new_n195_));
  nand3  g133(.a(new_n185_), .b(x28), .c(new_n97_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n195_), .c(new_n192_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n79_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(x09), .c(new_n65_), .O(z20));
  nor2   g137(.a(new_n148_), .b(x09), .O(z19));
endmodule
