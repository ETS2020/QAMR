...
module FAU ( 
  ...
  nor2   g002(.a(new_n64_), .b(x03), .O(new_n65_));
  ...
  oai22  g015(.a(new_n77_), .b(new_n63_), .c(new_n72_), .d(new_n65_), .O(z00));
  ...
  nand2  g035(.a(new_n69_), .b(new_n68_), .O(new_n98_));
  nand4  g036(.a(new_n98_), .b(new_n94_), .c(new_n79_), .d(new_n95_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n69_), .c(new_n65_), .O(z05));
  nand3  g039(.a(new_n100_), .b(new_n79_), .c(new_n69_), .O(new_n102_));
  ...
  nand2  g051(.a(new_n113_), .b(new_n79_), .O(z07));
  inv1   g052(.a(x39), .O(new_n115_));
  aoi21  g053(.a(new_n115_), .b(x03), .c(new_n64_), .O(z08));
  inv1   g054(.a(x11), .O(new_n117_));
  nand4  g055(.a(new_n79_), .b(x34), .c(x27), .d(x26), .O(new_n118_));
  nor2   g056(.a(new_n118_), .b(new_n117_), .O(z09));
  nor2   g057(.a(new_n83_), .b(x36), .O(new_n120_));
  ...
  nand2  g062(.a(new_n64_), .b(x07), .O(new_n125_));
  aoi21  g063(.a(new_n125_), .b(new_n124_), .c(new_n120_), .O(new_n126_));
  inv1   g064(.a(x06), .O(new_n127_));
  nor3   g065(.a(new_n65_), .b(new_n69_), .c(new_n127_), .O(new_n128_));
  aoi21  g066(.a(new_n126_), .b(new_n73_), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(new_n81_), .b(new_n80_), .O(new_n130_));
  nand2  g068(.a(new_n130_), .b(x40), .O(new_n131_));
  nor2   g069(.a(new_n131_), .b(new_n115_), .O(new_n132_));
  nand4  g070(.a(new_n132_), .b(x05), .c(new_n73_), .d(x03), .O(new_n133_));
  oai21  g071(.a(new_n129_), .b(new_n68_), .c(new_n133_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand3  g073(.a(x40), .b(x39), .c(x29), .O(new_n136_));
  nor2   g074(.a(new_n68_), .b(new_n73_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n88_), .c(new_n136_), .O(new_n138_));
  inv1   g076(.a(x08), .O(new_n139_));
  nand3  g077(.a(new_n83_), .b(x27), .c(new_n73_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g080(.a(new_n142_), .b(new_n80_), .c(new_n135_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n79_), .O(z11));
  nor3   g082(.a(x37), .b(x36), .c(x35), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n68_), .c(new_n74_), .O(new_n146_));
  inv1   g084(.a(new_n71_), .O(new_n147_));
  aoi21  g085(.a(x39), .b(new_n73_), .c(new_n63_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n64_), .c(new_n147_), .O(new_n149_));
  nand3  g087(.a(new_n149_), .b(new_n146_), .c(new_n79_), .O(z12));
  inv1   g088(.a(x13), .O(new_n151_));
  nand2  g089(.a(x36), .b(x35), .O(new_n152_));
  aoi21  g090(.a(new_n152_), .b(x28), .c(new_n64_), .O(new_n153_));
  nand4  g091(.a(new_n153_), .b(x39), .c(new_n151_), .d(new_n73_), .O(new_n154_));
  ...
  aoi21  g096(.a(new_n158_), .b(new_n154_), .c(new_n68_), .O(new_n159_));
  nand4  g097(.a(new_n130_), .b(x39), .c(new_n151_), .d(new_n73_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x03), .c(new_n64_), .O(new_n161_));
  or2    g099(.a(new_n161_), .b(new_n159_), .O(z13));
  nand3  g100(.a(x20), .b(new_n156_), .c(new_n155_), .O(new_n163_));
  nand4  g101(.a(new_n152_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n164_));
  nand3  g102(.a(x39), .b(new_n151_), .c(new_n73_), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  aoi21  g104(.a(new_n166_), .b(new_n164_), .c(new_n63_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n64_), .c(new_n163_), .O(new_n168_));
  nand3  g106(.a(new_n69_), .b(new_n82_), .c(x28), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x27), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n81_), .c(new_n80_), .O(new_n171_));
  oai21  g109(.a(new_n166_), .b(new_n71_), .c(new_n171_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x03), .O(new_n173_));
  nand2  g111(.a(new_n147_), .b(new_n64_), .O(new_n174_));
  ...
  nand4  g116(.a(new_n79_), .b(new_n178_), .c(x22), .d(x01), .O(new_n179_));
  ...
  oai21  g122(.a(new_n88_), .b(x27), .c(new_n136_), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(x08), .O(new_n186_));
  nor2   g124(.a(new_n65_), .b(x09), .O(new_n187_));
  nand4  g125(.a(new_n187_), .b(new_n186_), .c(new_n140_), .d(new_n80_), .O(z18));
  inv1   g126(.a(new_n136_), .O(new_n189_));
  oai21  g127(.a(new_n82_), .b(new_n68_), .c(new_n139_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n68_), .c(new_n82_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand3  g130(.a(new_n192_), .b(new_n80_), .c(new_n135_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n79_), .O(z20));
  nand2  g132(.a(new_n143_), .b(new_n79_), .O(z19));
endmodule
