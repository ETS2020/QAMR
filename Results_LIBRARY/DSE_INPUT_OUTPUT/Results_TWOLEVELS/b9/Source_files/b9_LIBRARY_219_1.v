...
module FAU ( 
  ...
  nor2   g030(.a(new_n92_), .b(x28), .O(new_n93_));
  oai21  g031(.a(x27), .b(x08), .c(new_n93_), .O(new_n94_));
  aoi22  g032(.a(new_n94_), .b(x04), .c(new_n91_), .d(new_n90_), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n63_), .c(x40), .O(z02));
  nand2  g034(.a(new_n68_), .b(x27), .O(new_n97_));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi21  g036(.a(new_n67_), .b(new_n66_), .c(new_n98_), .O(new_n99_));
  aoi21  g037(.a(new_n99_), .b(new_n97_), .c(new_n80_), .O(z03));
  nand2  g038(.a(new_n67_), .b(new_n66_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n97_), .c(new_n64_), .d(new_n98_), .O(z04));
  aoi21  g040(.a(x28), .b(x27), .c(x37), .O(new_n103_));
  nor2   g041(.a(new_n103_), .b(new_n80_), .O(z05));
  aoi21  g042(.a(new_n64_), .b(new_n66_), .c(new_n84_), .O(new_n105_));
  ...
  nor2   g055(.a(new_n75_), .b(new_n63_), .O(z08));
  ...
  nand3  g062(.a(new_n124_), .b(new_n86_), .c(new_n73_), .O(new_n125_));
  ...
  aoi21  g066(.a(new_n82_), .b(new_n81_), .c(new_n75_), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(x39), .c(x05), .d(new_n73_), .O(new_n130_));
  ...
  nand3  g072(.a(new_n134_), .b(x35), .c(new_n84_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n84_), .c(new_n73_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n64_), .d(new_n66_), .O(new_n138_));
  ...
  nand3  g079(.a(new_n67_), .b(new_n83_), .c(new_n92_), .O(new_n142_));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n150_), .c(new_n66_), .O(new_n155_));
  nand2  g093(.a(new_n82_), .b(new_n81_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n147_), .c(new_n73_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x39), .c(new_n75_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n155_), .O(z13));
  aoi21  g097(.a(new_n147_), .b(new_n73_), .c(new_n63_), .O(new_n160_));
  nor2   g098(.a(x19), .b(x18), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(new_n153_), .c(x27), .d(x20), .O(new_n162_));
  oai21  g100(.a(new_n160_), .b(new_n75_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g104(.a(new_n166_), .b(new_n84_), .c(x27), .O(new_n167_));
  nand4  g105(.a(new_n167_), .b(x39), .c(new_n82_), .d(new_n81_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n163_), .O(z14));
  inv1   g107(.a(x12), .O(new_n170_));
  nor2   g108(.a(new_n120_), .b(new_n170_), .O(z15));
  ...
  nand2  g114(.a(new_n176_), .b(new_n64_), .O(z17));
  nand2  g115(.a(x40), .b(x29), .O(new_n178_));
  oai21  g116(.a(new_n85_), .b(x27), .c(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  nor2   g118(.a(new_n66_), .b(x04), .O(new_n181_));
  aoi21  g119(.a(new_n181_), .b(new_n93_), .c(x09), .O(new_n182_));
  nand4  g120(.a(new_n182_), .b(new_n180_), .c(new_n64_), .d(new_n81_), .O(z18));
  nand2  g121(.a(new_n140_), .b(new_n64_), .O(z19));
  inv1   g122(.a(x08), .O(new_n185_));
  aoi22  g123(.a(new_n178_), .b(x28), .c(new_n64_), .d(new_n185_), .O(new_n186_));
  nand2  g124(.a(new_n91_), .b(x39), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x40), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(new_n92_), .O(new_n189_));
  oai21  g127(.a(new_n186_), .b(x27), .c(new_n189_), .O(new_n190_));
  nand3  g128(.a(new_n190_), .b(new_n81_), .c(new_n132_), .O(new_n191_));
