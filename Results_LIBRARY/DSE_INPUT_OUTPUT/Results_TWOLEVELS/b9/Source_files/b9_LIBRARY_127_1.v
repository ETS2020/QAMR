...
module FAU ( 
  ...
  nor2   g002(.a(new_n64_), .b(x11), .O(new_n65_));
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(new_n73_), .d(x11), .O(new_n77_));
  ...
  oai21  g036(.a(new_n98_), .b(new_n97_), .c(new_n64_), .O(new_n99_));
  oai21  g037(.a(x27), .b(x08), .c(new_n95_), .O(new_n100_));
  nand2  g038(.a(new_n66_), .b(x39), .O(new_n101_));
  aoi21  g039(.a(new_n100_), .b(x04), .c(new_n101_), .O(new_n102_));
  nand3  g040(.a(new_n102_), .b(new_n99_), .c(new_n90_), .O(z02));
  nand2  g041(.a(new_n68_), .b(x27), .O(new_n104_));
  aoi21  g042(.a(new_n67_), .b(new_n91_), .c(new_n65_), .O(new_n105_));
  nand3  g043(.a(new_n105_), .b(new_n104_), .c(x21), .O(z03));
  inv1   g044(.a(x21), .O(new_n107_));
  nand3  g045(.a(new_n105_), .b(new_n104_), .c(new_n107_), .O(z04));
  nor2   g046(.a(new_n82_), .b(new_n91_), .O(new_n109_));
  inv1   g047(.a(new_n109_), .O(new_n110_));
  nand3  g048(.a(new_n110_), .b(new_n66_), .c(new_n67_), .O(z05));
  oai21  g049(.a(new_n109_), .b(x37), .c(new_n66_), .O(z06));
  inv1   g050(.a(x33), .O(new_n113_));
  nand2  g051(.a(x17), .b(new_n73_), .O(new_n114_));
  ...
  oai21  g079(.a(new_n141_), .b(new_n91_), .c(x11), .O(new_n142_));
  nand2  g080(.a(new_n64_), .b(new_n91_), .O(new_n143_));
  nand4  g081(.a(new_n143_), .b(new_n142_), .c(new_n82_), .d(new_n94_), .O(new_n144_));
  ...
  inv1   g085(.a(x11), .O(new_n148_));
  oai21  g086(.a(x35), .b(new_n148_), .c(new_n82_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n147_), .c(new_n146_), .O(new_n150_));
  oai21  g088(.a(new_n147_), .b(new_n83_), .c(new_n64_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n79_), .c(new_n92_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(new_n66_), .O(z11));
  nor3   g092(.a(x37), .b(x36), .c(x35), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n91_), .c(new_n74_), .O(new_n156_));
  oai21  g094(.a(new_n129_), .b(x04), .c(new_n70_), .O(new_n157_));
  nand3  g095(.a(new_n157_), .b(new_n156_), .c(new_n66_), .O(z12));
  inv1   g096(.a(x13), .O(new_n159_));
  nand2  g097(.a(x36), .b(x35), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(x28), .c(new_n64_), .O(new_n161_));
  nand4  g099(.a(new_n161_), .b(x39), .c(new_n159_), .d(new_n94_), .O(new_n162_));
  inv1   g100(.a(x18), .O(new_n163_));
  inv1   g101(.a(x19), .O(new_n164_));
  nand4  g102(.a(new_n69_), .b(x20), .c(new_n164_), .d(new_n163_), .O(new_n165_));
  aoi21  g103(.a(new_n165_), .b(new_n162_), .c(new_n148_), .O(new_n166_));
  nand4  g104(.a(new_n69_), .b(new_n64_), .c(x20), .d(new_n164_), .O(new_n167_));
  nor2   g105(.a(new_n167_), .b(x18), .O(new_n168_));
  oai21  g106(.a(new_n168_), .b(new_n166_), .c(x27), .O(new_n169_));
  nand4  g107(.a(new_n134_), .b(new_n159_), .c(x11), .d(new_n94_), .O(new_n170_));
  ...
  nand3  g113(.a(new_n175_), .b(new_n159_), .c(new_n94_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n174_), .c(new_n172_), .O(new_n177_));
  nand3  g115(.a(new_n67_), .b(new_n141_), .c(x28), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x27), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n80_), .c(new_n79_), .O(new_n180_));
  aoi21  g118(.a(new_n176_), .b(new_n70_), .c(new_n65_), .O(new_n181_));
  ...
  nand4  g123(.a(new_n66_), .b(new_n185_), .c(x22), .d(x01), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(z16));
  inv1   g125(.a(x01), .O(new_n188_));
  inv1   g126(.a(x24), .O(new_n189_));
  nand4  g127(.a(new_n66_), .b(new_n189_), .c(x23), .d(x22), .O(new_n190_));
  ...
  aoi21  g132(.a(new_n194_), .b(new_n193_), .c(new_n141_), .O(new_n195_));
  aoi21  g133(.a(new_n195_), .b(new_n82_), .c(new_n192_), .O(new_n196_));
  nand4  g134(.a(new_n175_), .b(x29), .c(x11), .d(x08), .O(new_n197_));
  oai21  g135(.a(new_n196_), .b(new_n65_), .c(new_n197_), .O(z18));
  aoi21  g136(.a(x28), .b(new_n91_), .c(new_n141_), .O(new_n199_));
  aoi21  g137(.a(new_n146_), .b(x11), .c(new_n64_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  aoi21  g139(.a(new_n143_), .b(new_n142_), .c(x08), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n201_), .c(new_n79_), .O(new_n203_));
  nor2   g141(.a(new_n203_), .b(x09), .O(z20));
  nand2  g142(.a(new_n153_), .b(new_n66_), .O(z19));
endmodule
