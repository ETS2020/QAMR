...
module FAU ( 
  ...
  aoi22  g026(.a(new_n88_), .b(new_n87_), .c(new_n82_), .d(x04), .O(new_n89_));
  ...
  aoi21  g034(.a(new_n65_), .b(new_n91_), .c(new_n96_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n95_), .c(new_n94_), .O(z03));
  nand2  g036(.a(new_n65_), .b(new_n91_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n95_), .c(new_n64_), .d(new_n96_), .O(z04));
  aoi21  g038(.a(x28), .b(x27), .c(x37), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n94_), .O(z05));
  inv1   g040(.a(x14), .O(new_n103_));
  oai22  g041(.a(x40), .b(new_n103_), .c(new_n81_), .d(new_n91_), .O(new_n104_));
  ...
  aoi22  g048(.a(new_n110_), .b(x38), .c(x17), .d(new_n72_), .O(new_n111_));
  nand4  g049(.a(new_n111_), .b(x40), .c(new_n108_), .d(new_n107_), .O(new_n112_));
  nand2  g050(.a(x38), .b(new_n109_), .O(new_n113_));
  oai21  g051(.a(new_n113_), .b(x00), .c(new_n103_), .O(new_n114_));
  aoi21  g052(.a(new_n114_), .b(new_n112_), .c(new_n106_), .O(z07));
  ...
  nor2   g072(.a(new_n91_), .b(new_n71_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n82_), .c(new_n134_), .O(new_n136_));
  nand2  g074(.a(x27), .b(new_n71_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n82_), .c(new_n90_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n78_), .c(new_n133_), .O(new_n140_));
  ...
  aoi21  g082(.a(x39), .b(new_n71_), .c(new_n63_), .O(new_n145_));
  nor2   g083(.a(x40), .b(x14), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n145_), .c(new_n68_), .O(new_n147_));
  ...
  nor2   g094(.a(new_n155_), .b(x14), .O(new_n157_));
  oai21  g095(.a(new_n157_), .b(new_n156_), .c(x27), .O(new_n158_));
  nand3  g096(.a(new_n127_), .b(new_n149_), .c(new_n71_), .O(new_n159_));
  ...
  nand3  g100(.a(x39), .b(new_n149_), .c(new_n71_), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  aoi21  g102(.a(new_n164_), .b(new_n162_), .c(new_n63_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n146_), .c(new_n161_), .O(new_n166_));
  ...
  nand2  g108(.a(new_n163_), .b(new_n68_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(x40), .O(new_n173_));
  nand3  g111(.a(new_n68_), .b(new_n63_), .c(new_n103_), .O(new_n174_));
  ...
  nand2  g117(.a(new_n179_), .b(new_n64_), .O(z16));
  ...
  nand2  g122(.a(new_n91_), .b(x08), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n137_), .c(new_n167_), .O(new_n186_));
  nand2  g124(.a(new_n78_), .b(new_n133_), .O(new_n187_));
  aoi21  g125(.a(new_n186_), .b(new_n81_), .c(new_n187_), .O(new_n188_));
  oai22  g126(.a(new_n188_), .b(new_n94_), .c(new_n116_), .d(new_n88_), .O(z18));
  inv1   g127(.a(new_n134_), .O(new_n190_));
  oai21  g128(.a(new_n167_), .b(new_n91_), .c(new_n90_), .O(new_n191_));
  aoi21  g129(.a(x28), .b(new_n91_), .c(new_n167_), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n190_), .c(new_n191_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(new_n78_), .c(new_n133_), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(new_n64_), .O(z20));
  nand2  g133(.a(new_n140_), .b(new_n64_), .O(z19));
endmodule
