...
module FAU ( 
  ...
  oai21  g071(.a(new_n70_), .b(x29), .c(x40), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x35), .c(new_n78_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n78_), .c(new_n88_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x39), .c(new_n71_), .d(new_n87_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(x08), .c(new_n137_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n75_), .c(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nor3   g080(.a(x37), .b(x36), .c(x35), .O(new_n143_));
  nor2   g081(.a(new_n70_), .b(x27), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n66_), .O(new_n145_));
  oai21  g083(.a(new_n70_), .b(new_n88_), .c(x40), .O(new_n146_));
  oai21  g084(.a(new_n64_), .b(new_n87_), .c(new_n146_), .O(new_n147_));
  nand3  g085(.a(new_n147_), .b(new_n145_), .c(new_n71_), .O(z12));
  inv1   g086(.a(x13), .O(new_n149_));
  nand2  g087(.a(x36), .b(x35), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x28), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x40), .c(new_n149_), .d(new_n88_), .O(new_n152_));
  inv1   g090(.a(x18), .O(new_n153_));
  inv1   g091(.a(x19), .O(new_n154_));
  nand2  g092(.a(new_n95_), .b(new_n98_), .O(new_n155_));
  nand4  g093(.a(new_n155_), .b(x20), .c(new_n154_), .d(new_n153_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(new_n152_), .c(new_n70_), .O(new_n157_));
  nand4  g095(.a(new_n155_), .b(new_n67_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand4  g098(.a(new_n127_), .b(x39), .c(new_n149_), .d(new_n88_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  aoi21  g100(.a(new_n149_), .b(new_n88_), .c(new_n70_), .O(new_n163_));
  ...
  nand4  g107(.a(new_n169_), .b(x39), .c(new_n76_), .d(new_n75_), .O(new_n170_));
  ...
  nand2  g118(.a(x40), .b(x29), .O(new_n181_));
  ...
  nand3  g133(.a(new_n195_), .b(new_n75_), .c(new_n133_), .O(new_n196_));
