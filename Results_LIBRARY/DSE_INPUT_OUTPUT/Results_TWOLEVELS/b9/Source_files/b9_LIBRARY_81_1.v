...
module FAU ( 
  ...
  nor2   g065(.a(new_n127_), .b(new_n69_), .O(new_n128_));
  ...
  nand3  g073(.a(x35), .b(new_n76_), .c(new_n119_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n70_), .d(new_n86_), .O(new_n137_));
  ...
  nor2   g078(.a(new_n64_), .b(new_n86_), .O(new_n141_));
  inv1   g079(.a(x35), .O(new_n142_));
  nand3  g080(.a(new_n93_), .b(new_n75_), .c(new_n142_), .O(new_n143_));
  ...
  nand3  g098(.a(new_n128_), .b(new_n148_), .c(new_n119_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  aoi21  g100(.a(new_n148_), .b(new_n119_), .c(new_n69_), .O(new_n163_));
  nand4  g101(.a(x27), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n64_), .c(new_n163_), .d(new_n157_), .O(new_n165_));
  ...
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n142_), .O(new_n183_));
  nand2  g121(.a(new_n73_), .b(new_n131_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(new_n76_), .c(new_n184_), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n89_), .c(new_n114_), .d(new_n83_), .O(z18));
  inv1   g124(.a(new_n139_), .O(z19));
  aoi21  g125(.a(x40), .b(new_n69_), .c(x08), .O(new_n188_));
  aoi21  g126(.a(x40), .b(x29), .c(new_n76_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n188_), .c(new_n86_), .O(new_n190_));
  nand2  g128(.a(new_n83_), .b(x39), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x40), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(new_n142_), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n190_), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(new_n73_), .c(new_n131_), .O(new_n195_));
