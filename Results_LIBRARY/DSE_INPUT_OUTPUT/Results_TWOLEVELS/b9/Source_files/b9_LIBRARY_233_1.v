...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(x22), .d(new_n66_), .O(new_n77_));
  ...
  nor2   g031(.a(new_n74_), .b(new_n63_), .O(new_n94_));
  ...
  aoi21  g053(.a(new_n115_), .b(x22), .c(new_n74_), .O(z08));
  ...
  nand2  g071(.a(new_n133_), .b(x22), .O(new_n134_));
  nand2  g072(.a(new_n74_), .b(new_n68_), .O(new_n135_));
  ...
  nand2  g078(.a(new_n140_), .b(x22), .O(new_n141_));
  ...
  nand3  g087(.a(new_n69_), .b(new_n81_), .c(new_n140_), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(x27), .c(x10), .O(new_n151_));
  aoi21  g089(.a(x39), .b(new_n120_), .c(new_n71_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(x22), .O(new_n153_));
  ...
  nand2  g105(.a(new_n167_), .b(x22), .O(new_n168_));
  ...
  nand3  g114(.a(new_n69_), .b(new_n140_), .c(x28), .O(new_n177_));
  ...
  nand2  g119(.a(new_n181_), .b(x22), .O(new_n182_));
  ...
  nand4  g132(.a(new_n194_), .b(new_n192_), .c(new_n64_), .d(new_n132_), .O(z18));
  aoi21  g133(.a(x28), .b(new_n68_), .c(new_n140_), .O(new_n196_));
  aoi21  g134(.a(new_n138_), .b(x22), .c(new_n74_), .O(new_n197_));
  nor2   g135(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  aoi21  g136(.a(new_n135_), .b(new_n134_), .c(x08), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(new_n198_), .c(new_n79_), .O(new_n200_));
  nor2   g138(.a(new_n200_), .b(x09), .O(z20));
  nand2  g139(.a(new_n148_), .b(new_n64_), .O(z19));
endmodule
