...
module FAU ( 
  ...
  nand2  g036(.a(new_n98_), .b(x31), .O(new_n99_));
  ...
  aoi21  g042(.a(new_n104_), .b(new_n101_), .c(new_n84_), .O(z04));
  ...
  nand4  g066(.a(x40), .b(x39), .c(x31), .d(x05), .O(new_n129_));
  oai21  g067(.a(z08), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  nand3  g068(.a(new_n130_), .b(new_n89_), .c(new_n65_), .O(new_n131_));
  ...
  aoi21  g093(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n76_), .c(new_n155_), .O(new_n157_));
  ...
  nand4  g104(.a(new_n135_), .b(x39), .c(new_n159_), .d(new_n65_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(x31), .c(new_n76_), .O(new_n168_));
  or2    g106(.a(new_n168_), .b(new_n166_), .O(z13));
  nand3  g107(.a(x20), .b(new_n164_), .c(new_n163_), .O(new_n170_));
  nand4  g108(.a(new_n160_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n171_));
  nand3  g109(.a(x39), .b(new_n159_), .c(new_n65_), .O(new_n172_));
  inv1   g110(.a(new_n172_), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n171_), .c(new_n81_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n76_), .c(new_n170_), .O(new_n175_));
  ...
  nand2  g116(.a(new_n172_), .b(new_n155_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(x31), .O(new_n181_));
  nand2  g119(.a(new_n155_), .b(new_n76_), .O(new_n182_));
  ...
  nand2  g135(.a(new_n77_), .b(x31), .O(new_n198_));
  oai22  g136(.a(new_n198_), .b(new_n94_), .c(new_n197_), .d(new_n84_), .O(z18));
  nor2   g137(.a(new_n87_), .b(x27), .O(new_n200_));
  nor2   g138(.a(x35), .b(new_n81_), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n200_), .c(new_n145_), .O(new_n202_));
  inv1   g140(.a(x08), .O(new_n203_));
  oai21  g141(.a(new_n201_), .b(new_n140_), .c(new_n203_), .O(new_n204_));
  oai21  g142(.a(new_n200_), .b(new_n66_), .c(new_n76_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n204_), .c(new_n202_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n85_), .c(new_n195_), .O(new_n207_));
  nand2  g145(.a(new_n207_), .b(new_n82_), .O(z20));
  nor2   g146(.a(new_n149_), .b(x09), .O(z19));
endmodule
