...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x05), .O(new_n81_));
  ...
  inv1   g031(.a(z08), .O(new_n94_));
  nand2  g032(.a(new_n64_), .b(new_n91_), .O(new_n95_));
  nand2  g033(.a(x40), .b(new_n66_), .O(new_n96_));
  nand3  g034(.a(new_n96_), .b(new_n95_), .c(new_n85_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(x04), .c(new_n94_), .O(new_n98_));
  oai21  g036(.a(new_n93_), .b(x02), .c(new_n98_), .O(z02));
  ...
  aoi21  g046(.a(new_n81_), .b(new_n64_), .c(new_n85_), .O(new_n109_));
  ...
  nor2   g062(.a(x40), .b(x05), .O(new_n125_));
  ...
  inv1   g078(.a(new_n125_), .O(new_n141_));
  oai21  g079(.a(new_n75_), .b(new_n92_), .c(x40), .O(new_n142_));
  ...
  nor2   g101(.a(new_n162_), .b(x05), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n134_), .b(new_n156_), .c(new_n65_), .O(new_n166_));
  ...
  oai21  g110(.a(new_n172_), .b(new_n125_), .c(new_n168_), .O(new_n173_));
  ...
  nand4  g120(.a(new_n81_), .b(new_n182_), .c(x22), .d(x01), .O(new_n183_));
  ...
  oai22  g125(.a(new_n86_), .b(x27), .c(new_n94_), .d(new_n92_), .O(new_n188_));
  ...
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n81_), .d(new_n83_), .O(z18));
  oai21  g130(.a(new_n145_), .b(x09), .c(new_n81_), .O(z19));
  aoi21  g131(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  aoi21  g132(.a(new_n142_), .b(new_n141_), .c(new_n194_), .O(new_n195_));
  aoi21  g133(.a(new_n137_), .b(new_n96_), .c(x08), .O(new_n196_));
