...
module FAU ( 
  ...
  nor2   g031(.a(new_n93_), .b(x02), .O(new_n94_));
  nor2   g032(.a(x27), .b(x08), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n87_), .c(x04), .O(new_n96_));
  nand2  g034(.a(new_n96_), .b(x39), .O(new_n97_));
  oai21  g035(.a(new_n97_), .b(new_n94_), .c(x40), .O(new_n98_));
  nand2  g036(.a(new_n81_), .b(x07), .O(new_n99_));
  ...
  oai22  g047(.a(x40), .b(x07), .c(new_n86_), .d(new_n64_), .O(new_n110_));
  ...
  nand2  g060(.a(new_n82_), .b(new_n75_), .O(z08));
  ...
  oai21  g065(.a(new_n76_), .b(new_n80_), .c(new_n127_), .O(new_n128_));
  ...
  aoi22  g083(.a(new_n145_), .b(new_n142_), .c(new_n144_), .d(new_n99_), .O(new_n146_));
  ...
  inv1   g089(.a(new_n99_), .O(new_n152_));
  nand2  g090(.a(new_n72_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n154_));
  oai21  g092(.a(new_n154_), .b(new_n152_), .c(new_n153_), .O(new_n155_));
  nand3  g093(.a(new_n155_), .b(new_n151_), .c(new_n82_), .O(z12));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n160_), .c(new_n81_), .O(new_n164_));
  nor2   g102(.a(new_n163_), .b(new_n80_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n164_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n135_), .b(new_n157_), .c(new_n65_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n166_), .O(z13));
  nand3  g106(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n169_));
  nand4  g107(.a(new_n158_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n170_));
  nand3  g108(.a(x39), .b(new_n157_), .c(new_n65_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n81_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n152_), .c(new_n169_), .O(new_n174_));
  ...
  nand3  g118(.a(new_n153_), .b(new_n81_), .c(x07), .O(new_n181_));
  nand3  g119(.a(new_n181_), .b(new_n180_), .c(new_n174_), .O(z14));
  inv1   g120(.a(x12), .O(new_n183_));
  nor2   g121(.a(new_n125_), .b(new_n183_), .O(z15));
  ...
  nand2  g130(.a(new_n81_), .b(new_n80_), .O(new_n193_));
  nand3  g131(.a(new_n193_), .b(x27), .c(new_n65_), .O(new_n194_));
  oai21  g132(.a(new_n138_), .b(new_n192_), .c(new_n194_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(x35), .c(new_n86_), .O(new_n196_));
  inv1   g134(.a(x09), .O(new_n197_));
  nand2  g135(.a(new_n84_), .b(new_n197_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(new_n82_), .c(new_n93_), .d(new_n76_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n196_), .O(z18));
  nor2   g138(.a(x40), .b(x35), .O(new_n201_));
  oai21  g139(.a(new_n201_), .b(new_n95_), .c(x07), .O(new_n202_));
  ...
  nand2  g143(.a(new_n76_), .b(x29), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(x28), .c(new_n64_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n205_), .c(new_n202_), .O(new_n208_));
  nand3  g146(.a(new_n208_), .b(new_n84_), .c(new_n197_), .O(new_n209_));
  nand2  g147(.a(new_n209_), .b(new_n82_), .O(z20));
  nor2   g148(.a(new_n147_), .b(x09), .O(z19));
endmodule
