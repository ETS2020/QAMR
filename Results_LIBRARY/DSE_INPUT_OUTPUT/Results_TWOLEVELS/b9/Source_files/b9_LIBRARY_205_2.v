...
module FAU ( 
  ...
  aoi21  g028(.a(x28), .b(x04), .c(new_n63_), .O(new_n91_));
  oai21  g029(.a(x27), .b(x08), .c(x35), .O(new_n92_));
  nand2  g030(.a(new_n92_), .b(x04), .O(new_n93_));
  nand4  g031(.a(new_n93_), .b(new_n91_), .c(new_n90_), .d(x39), .O(z02));
  nor2   g032(.a(x37), .b(x27), .O(new_n95_));
  aoi21  g033(.a(new_n68_), .b(x27), .c(new_n95_), .O(new_n96_));
  aoi22  g034(.a(new_n96_), .b(x21), .c(new_n63_), .d(x39), .O(z03));
  inv1   g035(.a(x21), .O(new_n98_));
  aoi22  g036(.a(new_n96_), .b(new_n98_), .c(new_n63_), .d(x39), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  nand3  g038(.a(new_n100_), .b(new_n64_), .c(new_n67_), .O(z05));
  inv1   g039(.a(x28), .O(new_n102_));
  aoi21  g040(.a(new_n64_), .b(new_n66_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g068(.a(new_n63_), .b(x29), .c(x39), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x35), .c(new_n102_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n102_), .c(new_n73_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x40), .c(new_n64_), .d(new_n66_), .O(new_n136_));
  ...
  nand3  g077(.a(new_n67_), .b(new_n83_), .c(new_n82_), .O(new_n140_));
  ...
  aoi21  g095(.a(new_n81_), .b(new_n80_), .c(new_n63_), .O(new_n158_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n102_), .c(x27), .O(new_n168_));
  ...
  aoi21  g122(.a(new_n183_), .b(new_n102_), .c(new_n184_), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n79_), .c(new_n116_), .d(new_n89_), .O(z18));
  nand2  g124(.a(new_n138_), .b(new_n64_), .O(z19));
  oai21  g125(.a(new_n102_), .b(x27), .c(x35), .O(new_n188_));
  and2   g126(.a(new_n188_), .b(new_n131_), .O(new_n189_));
  nand2  g127(.a(new_n64_), .b(new_n66_), .O(new_n190_));
  nand2  g128(.a(x40), .b(new_n82_), .O(new_n191_));
