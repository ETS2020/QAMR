...
module FAU ( 
  ...
  oai22  g039(.a(x40), .b(new_n73_), .c(new_n82_), .d(new_n91_), .O(new_n102_));
  ...
  nor2   g059(.a(x40), .b(x10), .O(new_n122_));
  ...
  nand2  g073(.a(new_n64_), .b(new_n91_), .O(new_n136_));
  ...
  aoi21  g078(.a(new_n140_), .b(x40), .c(new_n122_), .O(new_n141_));
  ...
  oai21  g083(.a(new_n121_), .b(x04), .c(x40), .O(new_n146_));
  oai21  g084(.a(x40), .b(x10), .c(new_n146_), .O(new_n147_));
  nor3   g085(.a(x36), .b(x35), .c(x10), .O(new_n148_));
  aoi21  g086(.a(new_n147_), .b(new_n66_), .c(new_n148_), .O(new_n149_));
  nand2  g087(.a(new_n146_), .b(x10), .O(new_n150_));
  aoi21  g088(.a(new_n150_), .b(new_n91_), .c(new_n78_), .O(new_n151_));
  oai21  g089(.a(new_n149_), .b(x37), .c(new_n151_), .O(z12));
  ...
  nor2   g099(.a(new_n132_), .b(x13), .O(new_n162_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n122_), .c(new_n165_), .O(new_n170_));
