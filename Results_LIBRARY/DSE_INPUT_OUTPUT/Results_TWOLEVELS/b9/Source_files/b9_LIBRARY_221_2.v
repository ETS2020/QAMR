...
module FAU ( 
  ...
  nor2   g035(.a(x40), .b(x25), .O(new_n98_));
  ...
  aoi21  g064(.a(x40), .b(new_n75_), .c(new_n98_), .O(new_n127_));
  ...
  aoi21  g080(.a(new_n142_), .b(x40), .c(new_n98_), .O(new_n143_));
  ...
  nand3  g090(.a(new_n152_), .b(new_n76_), .c(new_n116_), .O(new_n153_));
  ...
  nand4  g100(.a(new_n72_), .b(new_n116_), .c(x20), .d(new_n160_), .O(new_n163_));
  ...
  oai21  g106(.a(new_n75_), .b(x04), .c(x40), .O(new_n169_));
  nor2   g107(.a(new_n98_), .b(x13), .O(new_n170_));
  ...
  nand3  g112(.a(x20), .b(new_n160_), .c(new_n159_), .O(new_n175_));
  nand4  g113(.a(new_n156_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n176_));
  inv1   g114(.a(new_n176_), .O(new_n177_));
  nand4  g115(.a(x40), .b(x39), .c(new_n155_), .d(new_n65_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n177_), .c(new_n175_), .O(new_n179_));
  aoi21  g117(.a(x27), .b(new_n116_), .c(x40), .O(new_n180_));
  nand3  g118(.a(x39), .b(new_n155_), .c(new_n65_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x40), .O(new_n182_));
  oai21  g120(.a(x32), .b(x30), .c(new_n182_), .O(new_n183_));
  aoi21  g121(.a(new_n183_), .b(new_n64_), .c(new_n180_), .O(new_n184_));
  nand3  g122(.a(new_n184_), .b(new_n179_), .c(new_n174_), .O(z14));
  ...
  aoi21  g136(.a(new_n196_), .b(new_n85_), .c(new_n198_), .O(new_n199_));
  oai22  g137(.a(new_n199_), .b(new_n102_), .c(new_n92_), .d(new_n122_), .O(z18));
