...
module FAU ( 
  ...
  inv1   g18(.a(z02), .O(new_n81_));
  aoi21  g19(.a(new_n65_), .b(new_n64_), .c(x21), .O(new_n82_));
  aoi21  g20(.a(new_n82_), .b(new_n78_), .c(new_n81_), .O(z04));
  nand2  g21(.a(x28), .b(x27), .O(new_n84_));
  aoi21  g22(.a(new_n84_), .b(new_n65_), .c(new_n81_), .O(z05));
  ...
  nor2   g55(.a(new_n81_), .b(new_n67_), .O(z12));
  inv1   g56(.a(x19), .O(new_n120_));
  nand3  g57(.a(new_n67_), .b(x20), .c(new_n120_), .O(new_n121_));
  oai21  g58(.a(new_n121_), .b(x18), .c(z02), .O(z13));
  ...
  nand2  g74(.a(new_n117_), .b(z02), .O(z19));
  oai21  g75(.a(x28), .b(new_n114_), .c(new_n64_), .O(new_n139_));
  nand2  g76(.a(new_n139_), .b(x35), .O(new_n140_));
  nand4  g77(.a(new_n140_), .b(z02), .c(new_n71_), .d(new_n111_), .O(new_n141_));
