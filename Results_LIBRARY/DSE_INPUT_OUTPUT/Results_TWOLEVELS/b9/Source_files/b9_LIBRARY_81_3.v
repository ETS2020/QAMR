...
module FAU ( 
  ...
  inv1   g13(.a(new_n67_), .O(new_n77_));
  ...
  aoi21  g20(.a(new_n83_), .b(new_n80_), .c(new_n77_), .O(z03));
  ...
  nor2   g24(.a(new_n87_), .b(new_n77_), .O(z05));
  ...
  nand4  g41(.a(new_n67_), .b(x34), .c(x27), .d(x26), .O(new_n106_));
  nor2   g42(.a(new_n106_), .b(new_n105_), .O(z09));
  inv1   g43(.a(x04), .O(new_n108_));
  nand3  g44(.a(new_n72_), .b(x07), .c(new_n108_), .O(new_n109_));
  nand2  g45(.a(x37), .b(x06), .O(new_n110_));
  nand2  g46(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand3  g47(.a(new_n111_), .b(new_n67_), .c(x27), .O(new_n112_));
  ...
  nand4  g54(.a(new_n118_), .b(new_n67_), .c(new_n69_), .d(new_n114_), .O(new_n119_));
  nand2  g55(.a(new_n119_), .b(new_n67_), .O(z11));
  aoi21  g56(.a(new_n65_), .b(x27), .c(new_n77_), .O(z12));
  nand4  g57(.a(new_n67_), .b(new_n65_), .c(x27), .d(x20), .O(new_n122_));
  nor3   g58(.a(new_n122_), .b(x19), .c(x18), .O(z13));
  inv1   g59(.a(x19), .O(new_n124_));
  nand2  g60(.a(x20), .b(new_n124_), .O(new_n125_));
  nor3   g61(.a(new_n125_), .b(new_n64_), .c(x18), .O(new_n126_));
  aoi21  g62(.a(new_n126_), .b(x27), .c(new_n77_), .O(z14));
  nand4  g63(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n128_));
  nand2  g64(.a(new_n128_), .b(new_n67_), .O(z15));
  inv1   g65(.a(x23), .O(new_n130_));
  nand4  g66(.a(new_n67_), .b(new_n130_), .c(x22), .d(x01), .O(new_n131_));
  inv1   g67(.a(new_n131_), .O(z16));
  inv1   g68(.a(x01), .O(new_n133_));
  inv1   g69(.a(x24), .O(new_n134_));
  nand4  g70(.a(new_n67_), .b(new_n134_), .c(x23), .d(x22), .O(new_n135_));
  ...
  nor2   g76(.a(x30), .b(x09), .O(new_n141_));
  aoi21  g77(.a(new_n141_), .b(new_n140_), .c(new_n77_), .O(z18));
  inv1   g78(.a(new_n119_), .O(z19));
  oai21  g79(.a(new_n116_), .b(new_n70_), .c(new_n67_), .O(new_n144_));
  oai21  g80(.a(new_n115_), .b(x27), .c(new_n144_), .O(new_n145_));
  nand3  g81(.a(new_n145_), .b(new_n69_), .c(new_n114_), .O(new_n146_));
  nand2  g82(.a(new_n146_), .b(new_n67_), .O(z20));
  one    g83(.O(z02));
  zero   g84(.O(z08));
endmodule
