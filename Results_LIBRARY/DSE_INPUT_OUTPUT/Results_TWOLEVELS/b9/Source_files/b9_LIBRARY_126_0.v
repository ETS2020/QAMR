...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x09), .O(new_n81_));
  ...
  nand2  g034(.a(new_n76_), .b(x09), .O(new_n97_));
  ...
  oai21  g080(.a(new_n142_), .b(new_n87_), .c(new_n141_), .O(new_n143_));
  inv1   g081(.a(x08), .O(new_n144_));
  nand4  g082(.a(x35), .b(new_n86_), .c(x27), .d(new_n65_), .O(new_n145_));
  nand2  g083(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g084(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand4  g085(.a(new_n147_), .b(x40), .c(new_n84_), .d(new_n140_), .O(new_n148_));
  ...
  oai21  g091(.a(new_n120_), .b(x04), .c(new_n153_), .O(new_n154_));
  ...
  aoi21  g113(.a(new_n171_), .b(new_n153_), .c(new_n81_), .O(new_n176_));
  ...
  oai21  g123(.a(new_n87_), .b(x27), .c(new_n141_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(x08), .O(new_n187_));
  nand3  g125(.a(new_n145_), .b(new_n82_), .c(new_n84_), .O(new_n188_));
  inv1   g126(.a(new_n188_), .O(new_n189_));
  nand3  g127(.a(new_n189_), .b(new_n187_), .c(new_n140_), .O(z18));
  inv1   g128(.a(new_n141_), .O(new_n191_));
  oai21  g129(.a(new_n66_), .b(new_n64_), .c(new_n144_), .O(new_n192_));
  aoi21  g130(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n191_), .c(new_n192_), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(x40), .c(new_n84_), .d(new_n140_), .O(new_n195_));
  inv1   g133(.a(new_n195_), .O(z20));
  inv1   g134(.a(new_n148_), .O(z19));
endmodule
