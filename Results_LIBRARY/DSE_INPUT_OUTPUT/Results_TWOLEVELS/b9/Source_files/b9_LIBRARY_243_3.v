...
module FAU ( 
  ...
  nor2   g040(.a(new_n102_), .b(new_n99_), .O(z05));
  aoi21  g041(.a(x40), .b(x26), .c(x27), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(new_n83_), .c(new_n70_), .O(new_n105_));
  ...
  nand4  g071(.a(new_n133_), .b(new_n89_), .c(x05), .d(new_n65_), .O(new_n134_));
  ...
  aoi21  g075(.a(new_n137_), .b(new_n89_), .c(new_n104_), .O(new_n138_));
  ...
  nand3  g082(.a(new_n144_), .b(new_n81_), .c(new_n136_), .O(new_n145_));
  ...
  aoi21  g118(.a(new_n180_), .b(new_n139_), .c(new_n89_), .O(z15));
  inv1   g119(.a(x23), .O(new_n182_));
  nand4  g120(.a(new_n78_), .b(new_n182_), .c(x22), .d(x01), .O(new_n183_));
  ...
  nand4  g131(.a(new_n193_), .b(new_n191_), .c(new_n78_), .d(new_n136_), .O(z18));
  nand2  g132(.a(new_n145_), .b(new_n78_), .O(z19));
  nor2   g133(.a(new_n140_), .b(new_n139_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n197_));
  aoi21  g135(.a(x35), .b(x27), .c(x26), .O(new_n198_));
  nor2   g136(.a(x40), .b(x27), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  oai22  g138(.a(new_n200_), .b(x08), .c(new_n197_), .d(new_n196_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n81_), .c(new_n136_), .O(new_n202_));
