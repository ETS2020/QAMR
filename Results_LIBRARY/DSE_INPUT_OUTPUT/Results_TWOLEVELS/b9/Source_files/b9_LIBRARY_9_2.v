...
module FAU ( 
  ...
  inv1   g029(.a(x24), .O(new_n92_));
  nand2  g030(.a(new_n63_), .b(new_n92_), .O(new_n93_));
  ...
  aoi21  g042(.a(new_n64_), .b(new_n98_), .c(new_n81_), .O(new_n105_));
  ...
  nor2   g067(.a(new_n65_), .b(new_n98_), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(x06), .c(new_n95_), .O(new_n131_));
  nand2  g069(.a(new_n131_), .b(new_n129_), .O(z10));
  inv1   g070(.a(x09), .O(new_n133_));
  nand3  g071(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n134_));
  aoi22  g072(.a(new_n134_), .b(x40), .c(new_n64_), .d(new_n98_), .O(new_n135_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n71_), .c(new_n95_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n157_), .O(z13));
  nand3  g099(.a(x20), .b(new_n154_), .c(new_n153_), .O(new_n162_));
  nand4  g100(.a(new_n150_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n163_));
  ...
  aoi21  g108(.a(new_n165_), .b(new_n68_), .c(new_n95_), .O(new_n171_));
  ...
  oai22  g118(.a(new_n118_), .b(new_n180_), .c(new_n82_), .d(x27), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x08), .O(new_n182_));
  inv1   g120(.a(new_n82_), .O(new_n183_));
  nor2   g121(.a(new_n98_), .b(x04), .O(new_n184_));
  aoi21  g122(.a(new_n184_), .b(new_n183_), .c(x09), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n182_), .c(new_n64_), .d(new_n78_), .O(z18));
  nand2  g124(.a(new_n143_), .b(new_n64_), .O(z19));
