...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n85_), .c(x40), .O(new_n91_));
  nand2  g029(.a(new_n73_), .b(x39), .O(new_n92_));
  ...
  aoi21  g041(.a(new_n99_), .b(new_n66_), .c(new_n86_), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(x37), .c(new_n99_), .O(z06));
  ...
  aoi22  g075(.a(new_n137_), .b(x39), .c(new_n99_), .d(new_n66_), .O(new_n138_));
  nand2  g076(.a(x40), .b(new_n98_), .O(new_n139_));
  ...
  nand3  g084(.a(new_n146_), .b(new_n78_), .c(new_n136_), .O(new_n147_));
  inv1   g085(.a(new_n147_), .O(z11));
  inv1   g086(.a(x36), .O(new_n149_));
  nand3  g087(.a(new_n67_), .b(new_n149_), .c(new_n80_), .O(new_n150_));
  ...
  nand3  g092(.a(new_n154_), .b(new_n73_), .c(x39), .O(new_n155_));
  ...
  nand2  g114(.a(x39), .b(new_n66_), .O(new_n177_));
  nand4  g115(.a(x40), .b(new_n67_), .c(new_n80_), .d(x28), .O(new_n178_));
  aoi21  g116(.a(new_n178_), .b(new_n177_), .c(x32), .O(new_n179_));
  oai21  g117(.a(new_n174_), .b(new_n73_), .c(new_n92_), .O(new_n180_));
  aoi22  g118(.a(new_n180_), .b(new_n154_), .c(new_n179_), .d(new_n78_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n176_), .O(z14));
  inv1   g120(.a(x12), .O(new_n183_));
  nor2   g121(.a(new_n120_), .b(new_n183_), .O(z15));
  inv1   g122(.a(x23), .O(new_n185_));
  nand4  g123(.a(new_n99_), .b(new_n185_), .c(x22), .d(x01), .O(new_n186_));
  inv1   g124(.a(new_n186_), .O(z16));
  inv1   g125(.a(x24), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(x23), .c(x22), .d(x01), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n99_), .O(z17));
  inv1   g128(.a(x29), .O(new_n191_));
  oai22  g129(.a(new_n117_), .b(new_n191_), .c(new_n87_), .d(x27), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x08), .O(new_n193_));
  nor2   g131(.a(new_n66_), .b(x04), .O(new_n194_));
  aoi21  g132(.a(new_n194_), .b(new_n81_), .c(x09), .O(new_n195_));
  nand4  g133(.a(new_n195_), .b(new_n193_), .c(new_n99_), .d(new_n78_), .O(z18));
  nand2  g134(.a(new_n147_), .b(new_n99_), .O(z19));
  oai22  g135(.a(new_n98_), .b(x35), .c(new_n86_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n140_), .O(new_n199_));
  oai21  g137(.a(new_n98_), .b(x08), .c(new_n139_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n80_), .O(new_n201_));
  nor2   g139(.a(new_n63_), .b(x08), .O(new_n202_));
  nor2   g140(.a(x39), .b(new_n86_), .O(new_n203_));
  ...
  nand2  g144(.a(new_n206_), .b(new_n99_), .O(z20));
endmodule
