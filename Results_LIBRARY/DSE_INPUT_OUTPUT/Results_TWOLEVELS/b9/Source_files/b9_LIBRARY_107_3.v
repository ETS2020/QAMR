...
module FAU ( 
  ...
  aoi21  g17(.a(new_n67_), .b(new_n66_), .c(z08), .O(new_n81_));
  ...
  aoi21  g24(.a(new_n63_), .b(new_n87_), .c(new_n66_), .O(new_n88_));
  ...
  nand2  g54(.a(new_n69_), .b(new_n63_), .O(z12));
  ...
  nand3  g73(.a(new_n136_), .b(x35), .c(new_n87_), .O(new_n137_));
  nor2   g74(.a(x30), .b(x09), .O(new_n138_));
  aoi21  g75(.a(new_n138_), .b(new_n137_), .c(z08), .O(z18));
  oai21  g76(.a(x28), .b(new_n113_), .c(new_n66_), .O(new_n140_));
  nand2  g77(.a(new_n140_), .b(x35), .O(new_n141_));
  nand4  g78(.a(new_n141_), .b(new_n63_), .c(new_n72_), .d(new_n111_), .O(new_n142_));
  inv1   g79(.a(new_n142_), .O(z20));
  one    g80(.O(z02));
  inv1   g81(.a(new_n116_), .O(z19));
endmodule
