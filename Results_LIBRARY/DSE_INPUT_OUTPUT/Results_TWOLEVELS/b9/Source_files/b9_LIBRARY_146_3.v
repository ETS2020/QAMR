...
module FAU ( 
  ...
  nand2  g000(.a(x40), .b(x29), .O(new_n63_));
  ...
  nand2  g026(.a(new_n83_), .b(x40), .O(new_n89_));
  inv1   g027(.a(x08), .O(new_n90_));
  nand2  g028(.a(new_n67_), .b(new_n90_), .O(new_n91_));
  aoi21  g029(.a(new_n91_), .b(new_n89_), .c(new_n88_), .O(new_n92_));
  oai21  g030(.a(new_n74_), .b(x02), .c(x39), .O(new_n93_));
  oai21  g031(.a(new_n93_), .b(new_n92_), .c(new_n72_), .O(new_n94_));
  ...
  aoi21  g041(.a(new_n63_), .b(new_n67_), .c(new_n82_), .O(new_n104_));
  oai21  g042(.a(new_n104_), .b(x37), .c(new_n63_), .O(z06));
  ...
  nand2  g059(.a(new_n121_), .b(new_n63_), .O(z09));
  ...
  nor2   g069(.a(new_n68_), .b(new_n67_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(x06), .c(new_n64_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(z10));
  inv1   g072(.a(x09), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  nand4  g074(.a(new_n136_), .b(new_n91_), .c(x35), .d(new_n82_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n79_), .c(new_n135_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n63_), .O(z11));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  nor2   g078(.a(new_n74_), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(new_n73_), .O(new_n142_));
  inv1   g080(.a(new_n70_), .O(new_n143_));
  oai21  g081(.a(new_n123_), .b(x04), .c(new_n143_), .O(new_n144_));
  ...
  nand4  g086(.a(new_n148_), .b(x39), .c(new_n146_), .d(new_n88_), .O(new_n149_));
  ...
  nand4  g093(.a(new_n128_), .b(x39), .c(new_n146_), .d(new_n88_), .O(new_n156_));
  ...
  oai21  g097(.a(x27), .b(new_n146_), .c(new_n72_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x40), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n151_), .c(new_n150_), .O(new_n162_));
  inv1   g100(.a(new_n123_), .O(new_n163_));
  nand4  g101(.a(new_n147_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n164_));
  nor2   g102(.a(x13), .b(x04), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n164_), .c(new_n163_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  aoi22  g105(.a(new_n165_), .b(new_n163_), .c(x35), .d(x28), .O(new_n168_));
  inv1   g106(.a(x35), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n170_));
  inv1   g108(.a(new_n170_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n168_), .c(new_n68_), .O(new_n172_));
  nand3  g110(.a(new_n128_), .b(new_n163_), .c(new_n88_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n67_), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(new_n172_), .c(new_n167_), .d(new_n161_), .O(z14));
  inv1   g113(.a(x12), .O(new_n176_));
  nand4  g114(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n177_));
  ...
  nand2  g123(.a(x27), .b(new_n88_), .O(new_n186_));
  oai21  g124(.a(x27), .b(new_n90_), .c(new_n186_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(x35), .c(new_n82_), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n63_), .c(new_n79_), .d(new_n135_), .O(z18));
  oai21  g127(.a(x28), .b(new_n90_), .c(new_n67_), .O(new_n190_));
  ...
  nand2  g131(.a(new_n138_), .b(new_n63_), .O(z19));
endmodule
