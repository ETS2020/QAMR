...
module FAU ( 
  ...
  oai21  g032(.a(new_n76_), .b(x35), .c(new_n85_), .O(new_n95_));
  ...
  nor2   g060(.a(x40), .b(x05), .O(new_n123_));
  aoi21  g061(.a(x40), .b(new_n75_), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g088(.a(x39), .b(new_n65_), .c(new_n76_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n123_), .c(new_n150_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n149_), .c(new_n81_), .O(z12));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n65_), .c(new_n98_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n162_), .O(z13));
  nand3  g103(.a(x20), .b(new_n159_), .c(new_n158_), .O(new_n166_));
  nand4  g104(.a(new_n155_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x39), .b(new_n154_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n76_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n123_), .c(new_n166_), .O(new_n171_));
  ...
  nand2  g112(.a(new_n168_), .b(new_n150_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  nand3  g115(.a(new_n150_), .b(new_n76_), .c(new_n131_), .O(new_n178_));
  ...
  nor2   g132(.a(new_n145_), .b(x09), .O(z19));
  nor2   g133(.a(x40), .b(x35), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n94_), .c(new_n131_), .O(new_n197_));
  ...
  nand3  g138(.a(new_n189_), .b(x28), .c(new_n64_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n200_), .c(new_n197_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n83_), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(x09), .c(new_n81_), .O(z20));
endmodule
