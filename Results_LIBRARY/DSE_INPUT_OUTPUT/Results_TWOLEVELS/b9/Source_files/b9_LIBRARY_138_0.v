...
module FAU ( 
  ...
  oai21  g037(.a(new_n99_), .b(new_n64_), .c(new_n63_), .O(new_n100_));
  nand2  g038(.a(new_n67_), .b(x27), .O(new_n101_));
  inv1   g039(.a(x27), .O(new_n102_));
  nand2  g040(.a(new_n66_), .b(new_n102_), .O(new_n103_));
  nand3  g041(.a(new_n103_), .b(new_n101_), .c(new_n100_), .O(z03));
  nand2  g042(.a(new_n99_), .b(x21), .O(new_n105_));
  nand4  g043(.a(new_n105_), .b(new_n103_), .c(new_n101_), .d(new_n65_), .O(z04));
  aoi22  g044(.a(new_n98_), .b(new_n66_), .c(new_n64_), .d(new_n63_), .O(z05));
  nand2  g045(.a(new_n99_), .b(new_n65_), .O(z06));
  ...
  nand3  g073(.a(new_n135_), .b(new_n134_), .c(new_n65_), .O(z10));
  inv1   g074(.a(x09), .O(new_n137_));
  nand2  g075(.a(z08), .b(x29), .O(new_n138_));
  nor2   g076(.a(new_n102_), .b(new_n72_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(new_n83_), .c(new_n138_), .O(new_n140_));
  inv1   g078(.a(x08), .O(new_n141_));
  nand2  g079(.a(x27), .b(new_n72_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n83_), .c(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(new_n79_), .c(new_n137_), .O(new_n145_));
  ...
  oai21  g088(.a(new_n150_), .b(new_n95_), .c(new_n69_), .O(new_n151_));
  ...
  nand4  g098(.a(new_n68_), .b(x21), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n131_), .b(new_n153_), .c(new_n72_), .O(new_n164_));
  ...
  oai21  g108(.a(new_n170_), .b(new_n95_), .c(new_n166_), .O(new_n171_));
  ...
  nand3  g116(.a(new_n69_), .b(new_n64_), .c(x21), .O(new_n179_));
  ...
  inv1   g126(.a(new_n65_), .O(new_n189_));
  nand2  g127(.a(new_n102_), .b(x08), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n142_), .c(new_n172_), .O(new_n191_));
  nand2  g129(.a(new_n79_), .b(new_n137_), .O(new_n192_));
  aoi21  g130(.a(new_n191_), .b(new_n82_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n189_), .c(new_n120_), .d(new_n89_), .O(z18));
  inv1   g132(.a(new_n138_), .O(new_n195_));
  oai21  g133(.a(new_n172_), .b(new_n102_), .c(new_n141_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n102_), .c(new_n172_), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n196_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n79_), .c(new_n137_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n65_), .O(z20));
  nand2  g138(.a(new_n145_), .b(new_n65_), .O(z19));
endmodule
