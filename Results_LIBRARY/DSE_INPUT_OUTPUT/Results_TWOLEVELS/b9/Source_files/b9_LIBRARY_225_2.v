...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x18), .O(new_n64_));
  ...
  nor2   g029(.a(x40), .b(x18), .O(new_n92_));
  inv1   g030(.a(new_n92_), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(new_n91_), .O(z02));
  nand2  g032(.a(new_n66_), .b(x27), .O(new_n95_));
  inv1   g033(.a(x27), .O(new_n96_));
  nand3  g034(.a(new_n64_), .b(new_n65_), .c(new_n96_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n95_), .c(new_n64_), .d(x21), .O(z03));
  inv1   g036(.a(x21), .O(new_n99_));
  nand4  g037(.a(new_n97_), .b(new_n95_), .c(new_n64_), .d(new_n99_), .O(z04));
  nand2  g038(.a(x28), .b(x27), .O(new_n101_));
  nand3  g039(.a(new_n101_), .b(new_n64_), .c(new_n65_), .O(z05));
  inv1   g040(.a(x18), .O(new_n103_));
  oai22  g041(.a(x40), .b(new_n103_), .c(new_n81_), .d(new_n96_), .O(new_n104_));
  nor2   g042(.a(new_n104_), .b(x37), .O(z06));
  inv1   g043(.a(x33), .O(new_n106_));
  nand2  g044(.a(x17), .b(new_n72_), .O(new_n107_));
  ...
  nand2  g055(.a(new_n117_), .b(new_n64_), .O(z08));
  ...
  aoi21  g060(.a(x40), .b(new_n122_), .c(new_n92_), .O(new_n123_));
  inv1   g061(.a(new_n117_), .O(new_n124_));
  nand2  g062(.a(new_n124_), .b(x05), .O(new_n125_));
  oai21  g063(.a(new_n123_), .b(new_n121_), .c(new_n125_), .O(new_n126_));
  nand3  g064(.a(new_n126_), .b(new_n83_), .c(new_n71_), .O(new_n127_));
  nand3  g065(.a(new_n64_), .b(x37), .c(x06), .O(new_n128_));
  nand2  g066(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(x27), .O(new_n130_));
  nor2   g068(.a(x32), .b(x30), .O(new_n131_));
  nor3   g069(.a(new_n131_), .b(new_n63_), .c(new_n122_), .O(new_n132_));
  nand3  g070(.a(new_n132_), .b(x05), .c(new_n71_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n130_), .O(z10));
  nand2  g072(.a(new_n64_), .b(new_n96_), .O(new_n135_));
  oai21  g073(.a(new_n82_), .b(x04), .c(x40), .O(new_n136_));
  aoi21  g074(.a(new_n136_), .b(new_n135_), .c(x08), .O(new_n137_));
  inv1   g075(.a(new_n82_), .O(new_n138_));
  inv1   g076(.a(x29), .O(new_n139_));
  oai21  g077(.a(new_n122_), .b(new_n139_), .c(x40), .O(new_n140_));
  nand2  g078(.a(x27), .b(x04), .O(new_n141_));
  aoi22  g079(.a(new_n141_), .b(new_n138_), .c(new_n140_), .d(new_n93_), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n137_), .c(new_n78_), .O(new_n143_));
  nor2   g081(.a(new_n143_), .b(x09), .O(z11));
  inv1   g082(.a(x35), .O(new_n145_));
  nand3  g083(.a(new_n65_), .b(new_n80_), .c(new_n145_), .O(new_n146_));
  aoi21  g084(.a(new_n146_), .b(x27), .c(x10), .O(new_n147_));
  aoi22  g085(.a(new_n67_), .b(x27), .c(x39), .d(new_n71_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n147_), .c(x40), .O(new_n149_));
  nand3  g087(.a(new_n68_), .b(new_n63_), .c(new_n103_), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(new_n149_), .O(z12));
  inv1   g089(.a(x13), .O(new_n152_));
  nand2  g090(.a(x36), .b(x35), .O(new_n153_));
  aoi21  g091(.a(new_n153_), .b(x28), .c(new_n63_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x39), .c(new_n152_), .d(new_n71_), .O(new_n155_));
  inv1   g093(.a(x19), .O(new_n156_));
  nand4  g094(.a(new_n67_), .b(x20), .c(new_n156_), .d(new_n103_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand3  g097(.a(new_n132_), .b(new_n152_), .c(new_n71_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n159_), .O(z13));
  oai21  g099(.a(new_n122_), .b(x04), .c(x40), .O(new_n162_));
  nor2   g100(.a(new_n92_), .b(x13), .O(new_n163_));
  aoi22  g101(.a(new_n163_), .b(new_n162_), .c(x35), .d(x28), .O(new_n164_));
  nand4  g102(.a(new_n145_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n165_));
  inv1   g103(.a(new_n165_), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(new_n65_), .O(new_n167_));
  nand3  g105(.a(x20), .b(new_n156_), .c(new_n103_), .O(new_n168_));
  nand4  g106(.a(new_n153_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n124_), .c(new_n152_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand2  g109(.a(x27), .b(x20), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(x19), .c(x04), .O(new_n173_));
  oai21  g111(.a(new_n122_), .b(x13), .c(new_n96_), .O(new_n174_));
  aoi21  g112(.a(new_n174_), .b(new_n173_), .c(new_n63_), .O(new_n175_));
  oai21  g113(.a(new_n131_), .b(new_n92_), .c(new_n96_), .O(new_n176_));
  oai21  g114(.a(new_n103_), .b(new_n71_), .c(new_n176_), .O(new_n177_));
  nor2   g115(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n171_), .c(new_n167_), .O(z14));
  nand4  g117(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n180_));
  nand2  g118(.a(new_n180_), .b(new_n64_), .O(z15));
  ...
  oai22  g125(.a(new_n117_), .b(new_n139_), .c(new_n82_), .d(x27), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n96_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n138_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n64_), .d(new_n78_), .O(z18));
  oai21  g130(.a(new_n143_), .b(x09), .c(new_n64_), .O(z19));
  aoi21  g131(.a(x28), .b(new_n96_), .c(new_n145_), .O(new_n194_));
  aoi21  g132(.a(new_n140_), .b(new_n93_), .c(new_n194_), .O(new_n195_));
  nand2  g133(.a(x40), .b(new_n145_), .O(new_n196_));
  aoi21  g134(.a(new_n196_), .b(new_n135_), .c(x08), .O(new_n197_));
  oai21  g135(.a(new_n197_), .b(new_n195_), .c(new_n78_), .O(new_n198_));
