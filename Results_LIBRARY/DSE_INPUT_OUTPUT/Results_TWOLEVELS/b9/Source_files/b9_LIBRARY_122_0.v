...
module FAU ( 
  ...
  nor2   g000(.a(x40), .b(x12), .O(new_n63_));
  ...
  aoi21  g033(.a(new_n66_), .b(new_n91_), .c(new_n95_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n94_), .c(new_n63_), .O(z03));
  inv1   g035(.a(new_n63_), .O(new_n98_));
  nand2  g036(.a(new_n66_), .b(new_n91_), .O(new_n99_));
  ...
  aoi21  g040(.a(new_n98_), .b(new_n91_), .c(new_n82_), .O(new_n103_));
  ...
  oai21  g064(.a(new_n126_), .b(new_n124_), .c(new_n84_), .O(new_n127_));
  nand3  g065(.a(new_n98_), .b(x37), .c(x06), .O(new_n128_));
  ...
  nand2  g074(.a(new_n98_), .b(new_n91_), .O(new_n137_));
  ...
  oai21  g079(.a(new_n121_), .b(new_n141_), .c(x40), .O(new_n142_));
  ...
  oai21  g083(.a(new_n145_), .b(x09), .c(new_n98_), .O(z11));
  ...
  inv1   g087(.a(new_n123_), .O(new_n150_));
  aoi21  g088(.a(x39), .b(new_n72_), .c(new_n74_), .O(new_n151_));
  oai21  g089(.a(new_n151_), .b(new_n150_), .c(new_n69_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n149_), .c(new_n98_), .O(z12));
  ...
  nand3  g105(.a(x39), .b(new_n154_), .c(new_n72_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n74_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n150_), .c(new_n166_), .O(new_n171_));
  ...
  oai21  g113(.a(new_n169_), .b(new_n70_), .c(new_n175_), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x40), .O(new_n177_));
  nand3  g115(.a(new_n69_), .b(new_n74_), .c(x12), .O(new_n178_));
  ...
  nand2  g121(.a(new_n183_), .b(new_n98_), .O(z16));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(x23), .c(x22), .d(x01), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n98_), .O(z17));
  oai22  g125(.a(new_n116_), .b(new_n141_), .c(new_n83_), .d(x27), .O(new_n188_));
  nand2  g126(.a(new_n188_), .b(x08), .O(new_n189_));
  nor2   g127(.a(new_n91_), .b(x04), .O(new_n190_));
  aoi21  g128(.a(new_n190_), .b(new_n140_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n98_), .d(new_n79_), .O(z18));
  nor2   g130(.a(new_n145_), .b(x09), .O(z19));
  aoi21  g131(.a(x28), .b(new_n91_), .c(new_n172_), .O(new_n194_));
  aoi21  g132(.a(new_n142_), .b(new_n123_), .c(new_n194_), .O(new_n195_));
  nand2  g133(.a(x40), .b(new_n172_), .O(new_n196_));
