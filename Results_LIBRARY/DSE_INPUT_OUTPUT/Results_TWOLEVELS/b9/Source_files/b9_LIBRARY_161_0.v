...
module FAU ( 
  ...
  nand2  g036(.a(new_n66_), .b(new_n92_), .O(new_n99_));
  ...
  oai22  g040(.a(x40), .b(x05), .c(new_n83_), .d(new_n92_), .O(new_n103_));
  ...
  oai21  g054(.a(new_n64_), .b(new_n116_), .c(new_n65_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n65_), .O(z09));
  nand3  g057(.a(new_n65_), .b(x37), .c(x06), .O(new_n120_));
  aoi21  g058(.a(x40), .b(x39), .c(x07), .O(new_n121_));
  nand3  g059(.a(x40), .b(new_n116_), .c(x07), .O(new_n122_));
  oai21  g060(.a(new_n121_), .b(new_n63_), .c(new_n122_), .O(new_n123_));
  ...
  nor2   g070(.a(new_n92_), .b(new_n72_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n84_), .c(new_n132_), .O(new_n134_));
  nand4  g072(.a(x35), .b(new_n83_), .c(x27), .d(new_n72_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n91_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(new_n80_), .c(new_n131_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n65_), .O(z11));
  nor3   g077(.a(x37), .b(x36), .c(x35), .O(new_n140_));
  nor2   g078(.a(new_n64_), .b(x27), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(new_n140_), .c(new_n74_), .O(new_n142_));
  aoi21  g080(.a(x39), .b(new_n72_), .c(new_n64_), .O(new_n143_));
  nor2   g081(.a(x40), .b(new_n63_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n143_), .c(new_n69_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n142_), .c(new_n65_), .O(z12));
  ...
  nor2   g092(.a(new_n153_), .b(new_n63_), .O(new_n155_));
  oai21  g093(.a(new_n155_), .b(new_n154_), .c(x27), .O(new_n156_));
  nand3  g094(.a(new_n128_), .b(new_n147_), .c(new_n72_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x20), .b(new_n152_), .c(new_n151_), .O(new_n159_));
  nand4  g097(.a(new_n148_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n160_));
  ...
  oai21  g120(.a(new_n84_), .b(x27), .c(new_n132_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(x08), .O(new_n184_));
  nor2   g122(.a(new_n79_), .b(x30), .O(new_n185_));
  nand4  g123(.a(new_n185_), .b(new_n184_), .c(new_n135_), .d(new_n131_), .O(z18));
  inv1   g124(.a(new_n132_), .O(new_n187_));
  oai21  g125(.a(new_n165_), .b(new_n92_), .c(new_n91_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n92_), .c(new_n165_), .O(new_n189_));
  ...
  nand2  g130(.a(new_n138_), .b(new_n65_), .O(z19));
endmodule
