...
module FAU ( 
  ...
  nand3  g027(.a(new_n66_), .b(new_n89_), .c(x04), .O(new_n90_));
  nand4  g028(.a(new_n90_), .b(new_n88_), .c(x40), .d(x39), .O(z02));
  inv1   g029(.a(x39), .O(new_n92_));
  nand2  g030(.a(new_n73_), .b(new_n92_), .O(new_n93_));
  ...
  aoi21  g038(.a(new_n93_), .b(new_n66_), .c(new_n81_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(x37), .c(new_n93_), .O(z06));
  ...
  nand2  g050(.a(new_n112_), .b(new_n93_), .O(z07));
  nand2  g051(.a(x40), .b(x39), .O(new_n114_));
  nand2  g052(.a(new_n114_), .b(new_n93_), .O(z08));
  nand4  g053(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n116_));
  nand2  g054(.a(new_n116_), .b(new_n93_), .O(z09));
  inv1   g055(.a(x05), .O(new_n118_));
  nand2  g056(.a(new_n114_), .b(x07), .O(new_n119_));
  oai21  g057(.a(new_n114_), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  ...
  nor2   g063(.a(new_n67_), .b(new_n66_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(x06), .c(new_n63_), .O(new_n127_));
  nand2  g065(.a(new_n127_), .b(new_n125_), .O(z10));
  inv1   g066(.a(x09), .O(new_n129_));
  nand3  g067(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n130_));
  aoi22  g068(.a(new_n130_), .b(x39), .c(new_n93_), .d(new_n66_), .O(new_n131_));
  nand2  g069(.a(x40), .b(x29), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(x39), .O(new_n133_));
  nand2  g071(.a(x40), .b(new_n92_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(x35), .c(new_n81_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  oai21  g076(.a(new_n131_), .b(x08), .c(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n78_), .c(new_n129_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n93_), .O(z11));
  ...
  aoi21  g082(.a(x40), .b(new_n71_), .c(new_n69_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n144_), .c(x39), .O(new_n146_));
  nor2   g084(.a(new_n69_), .b(new_n73_), .O(new_n147_));
  nand2  g085(.a(new_n147_), .b(new_n92_), .O(new_n148_));
  ...
  nand3  g097(.a(new_n122_), .b(x40), .c(x39), .O(new_n160_));
  ...
  nand4  g104(.a(x40), .b(x39), .c(new_n150_), .d(new_n71_), .O(new_n167_));
  oai21  g105(.a(new_n167_), .b(new_n166_), .c(new_n164_), .O(new_n168_));
  nand3  g106(.a(new_n67_), .b(new_n142_), .c(x28), .O(new_n169_));
  oai21  g107(.a(new_n73_), .b(x27), .c(new_n169_), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n79_), .c(new_n78_), .O(new_n171_));
  oai21  g109(.a(new_n73_), .b(x04), .c(x39), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n134_), .c(new_n150_), .O(new_n173_));
  nand3  g111(.a(new_n173_), .b(new_n68_), .c(new_n67_), .O(new_n174_));
  aoi21  g112(.a(x40), .b(x27), .c(x39), .O(new_n175_));
  nor2   g113(.a(new_n73_), .b(x13), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n71_), .c(new_n92_), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n66_), .c(new_n175_), .O(new_n178_));
  nand4  g116(.a(new_n178_), .b(new_n174_), .c(new_n171_), .d(new_n168_), .O(z14));
  inv1   g117(.a(x12), .O(new_n180_));
  nand4  g118(.a(new_n93_), .b(x34), .c(x27), .d(x26), .O(new_n181_));
  nor2   g119(.a(new_n181_), .b(new_n180_), .O(z15));
  inv1   g120(.a(x23), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(x22), .c(x01), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(new_n93_), .O(z16));
  inv1   g123(.a(x24), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(x23), .c(x22), .d(x01), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(new_n93_), .O(z17));
  inv1   g126(.a(x29), .O(new_n189_));
  oai22  g127(.a(new_n114_), .b(new_n189_), .c(new_n82_), .d(x27), .O(new_n190_));
  nand2  g128(.a(new_n190_), .b(x08), .O(new_n191_));
  nor2   g129(.a(new_n142_), .b(x28), .O(new_n192_));
  nor2   g130(.a(new_n66_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n191_), .c(new_n93_), .d(new_n78_), .O(z18));
  inv1   g133(.a(new_n140_), .O(z19));
  oai22  g134(.a(new_n92_), .b(x35), .c(new_n81_), .d(x27), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n132_), .O(new_n198_));
  oai21  g136(.a(new_n92_), .b(x08), .c(new_n134_), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n142_), .O(new_n200_));
  nor2   g138(.a(new_n63_), .b(x08), .O(new_n201_));
  nor2   g139(.a(x39), .b(new_n81_), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n201_), .c(new_n66_), .O(new_n203_));
  nand3  g141(.a(new_n203_), .b(new_n200_), .c(new_n198_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n78_), .c(new_n129_), .O(new_n205_));
  nand2  g143(.a(new_n205_), .b(new_n93_), .O(z20));
endmodule
