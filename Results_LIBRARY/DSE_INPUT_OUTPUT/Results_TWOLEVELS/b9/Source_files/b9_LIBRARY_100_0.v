...
module FAU ( 
  ...
  nor2   g029(.a(new_n86_), .b(new_n65_), .O(new_n92_));
  aoi21  g030(.a(new_n91_), .b(new_n90_), .c(new_n92_), .O(new_n93_));
  ...
  nand3  g074(.a(x35), .b(new_n105_), .c(new_n65_), .O(new_n137_));
  ...
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n105_), .O(new_n144_));
  ...
  oai22  g133(.a(new_n195_), .b(new_n83_), .c(new_n91_), .d(new_n190_), .O(z18));
  ...
  oai21  g137(.a(new_n75_), .b(x08), .c(new_n139_), .O(new_n200_));
  ...
  nand3  g143(.a(new_n205_), .b(new_n84_), .c(new_n136_), .O(new_n206_));
