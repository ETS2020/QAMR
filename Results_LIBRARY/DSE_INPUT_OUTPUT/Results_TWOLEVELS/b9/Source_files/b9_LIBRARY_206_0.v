...
module FAU ( 
  ...
  nand2  g036(.a(new_n81_), .b(x24), .O(new_n99_));
  ...
  oai22  g046(.a(x40), .b(x24), .c(new_n86_), .d(new_n64_), .O(new_n109_));
  ...
  aoi21  g073(.a(new_n135_), .b(x06), .c(new_n104_), .O(new_n136_));
  ...
  nand2  g080(.a(new_n142_), .b(new_n99_), .O(new_n143_));
  nand2  g081(.a(x27), .b(x04), .O(new_n144_));
  nand3  g082(.a(new_n144_), .b(x35), .c(new_n86_), .O(new_n145_));
  ...
  nor2   g089(.a(new_n81_), .b(x27), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n151_), .c(new_n150_), .O(new_n153_));
  aoi22  g091(.a(x39), .b(new_n65_), .c(x35), .d(x28), .O(new_n154_));
  nand2  g092(.a(new_n86_), .b(x24), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(x35), .c(x40), .O(new_n156_));
  oai21  g094(.a(new_n156_), .b(new_n154_), .c(new_n70_), .O(new_n157_));
  aoi21  g095(.a(x27), .b(x24), .c(x40), .O(new_n158_));
  oai21  g096(.a(new_n81_), .b(new_n65_), .c(x39), .O(new_n159_));
  aoi21  g097(.a(new_n159_), .b(new_n64_), .c(new_n158_), .O(new_n160_));
  ...
  aoi21  g106(.a(new_n168_), .b(new_n165_), .c(new_n81_), .O(new_n169_));
  nand4  g107(.a(new_n72_), .b(x24), .c(x20), .d(new_n167_), .O(new_n170_));
  nor2   g108(.a(new_n170_), .b(x18), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(x27), .O(new_n172_));
  nand3  g110(.a(new_n131_), .b(new_n162_), .c(new_n65_), .O(new_n173_));
  ...
  nand2  g114(.a(new_n162_), .b(new_n65_), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x40), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n176_), .c(z08), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(new_n175_), .O(new_n180_));
  nor2   g118(.a(x37), .b(x35), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(x28), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x27), .O(new_n183_));
  nand3  g121(.a(new_n183_), .b(new_n85_), .c(new_n84_), .O(new_n184_));
  oai21  g122(.a(new_n152_), .b(new_n73_), .c(new_n177_), .O(new_n185_));
  oai21  g123(.a(new_n181_), .b(new_n64_), .c(new_n75_), .O(new_n186_));
  nand2  g124(.a(new_n99_), .b(x39), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n70_), .c(new_n86_), .O(new_n188_));
  nand3  g126(.a(new_n188_), .b(new_n186_), .c(new_n82_), .O(new_n189_));
  inv1   g127(.a(new_n189_), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n185_), .c(new_n184_), .d(new_n180_), .O(z14));
  inv1   g129(.a(x12), .O(new_n192_));
  nor2   g130(.a(new_n123_), .b(new_n192_), .O(z15));
  inv1   g131(.a(x23), .O(new_n194_));
  nand3  g132(.a(new_n194_), .b(x22), .c(x01), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(new_n82_), .O(z16));
  nand3  g134(.a(x23), .b(x22), .c(x01), .O(new_n197_));
  aoi21  g135(.a(new_n197_), .b(x40), .c(x24), .O(z17));
  ...
  nand2  g139(.a(new_n84_), .b(new_n138_), .O(new_n202_));
  aoi21  g140(.a(new_n201_), .b(new_n86_), .c(new_n202_), .O(new_n203_));
  oai22  g141(.a(new_n203_), .b(new_n104_), .c(new_n93_), .d(new_n75_), .O(z18));
  nand2  g142(.a(new_n148_), .b(new_n82_), .O(z19));
  nor2   g143(.a(x40), .b(x35), .O(new_n206_));
  oai21  g144(.a(new_n206_), .b(new_n95_), .c(x24), .O(new_n207_));
  aoi21  g145(.a(x35), .b(x27), .c(x08), .O(new_n208_));
  aoi21  g146(.a(x39), .b(x29), .c(x35), .O(new_n209_));
  oai21  g147(.a(new_n209_), .b(new_n208_), .c(x40), .O(new_n210_));
  nand2  g148(.a(z08), .b(x29), .O(new_n211_));
  nand3  g149(.a(new_n211_), .b(x28), .c(new_n64_), .O(new_n212_));
  nand3  g150(.a(new_n212_), .b(new_n210_), .c(new_n207_), .O(new_n213_));
