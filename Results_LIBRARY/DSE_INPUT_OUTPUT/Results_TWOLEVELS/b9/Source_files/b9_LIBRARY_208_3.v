...
module FAU ( 
  ...
  aoi21  g22(.a(new_n84_), .b(new_n79_), .c(new_n64_), .O(z04));
  aoi21  g23(.a(x28), .b(x27), .c(x37), .O(new_n86_));
  nor2   g24(.a(new_n86_), .b(new_n64_), .O(z05));
  ...
  nand4  g56(.a(new_n119_), .b(z02), .c(new_n70_), .d(new_n113_), .O(new_n120_));
  inv1   g57(.a(new_n120_), .O(z11));
  nand3  g58(.a(new_n67_), .b(z02), .c(x27), .O(z12));
  nand4  g59(.a(new_n67_), .b(z02), .c(x27), .d(x20), .O(new_n123_));
  nor3   g60(.a(new_n123_), .b(x19), .c(x18), .O(z13));
  inv1   g61(.a(x19), .O(new_n125_));
  nand2  g62(.a(x20), .b(new_n125_), .O(new_n126_));
  nor3   g63(.a(new_n126_), .b(new_n66_), .c(x18), .O(new_n127_));
  aoi21  g64(.a(new_n127_), .b(x27), .c(new_n64_), .O(z14));
  nand4  g65(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n129_));
  nand2  g66(.a(new_n129_), .b(z02), .O(z15));
  ...
  nand2  g79(.a(new_n120_), .b(z02), .O(z19));
  oai21  g80(.a(x28), .b(new_n116_), .c(new_n117_), .O(new_n144_));
  nand2  g81(.a(new_n144_), .b(x35), .O(new_n145_));
  nand4  g82(.a(new_n145_), .b(z02), .c(new_n70_), .d(new_n113_), .O(new_n146_));
