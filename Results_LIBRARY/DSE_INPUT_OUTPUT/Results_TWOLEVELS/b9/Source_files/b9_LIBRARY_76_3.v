...
module FAU ( 
  ...
  nand3  g23(.a(new_n84_), .b(z02), .c(new_n65_), .O(new_n86_));
  inv1   g24(.a(new_n86_), .O(z06));
  ...
  nand2  g45(.a(new_n107_), .b(x27), .O(new_n108_));
  nand2  g46(.a(new_n108_), .b(z02), .O(z10));
  inv1   g47(.a(x09), .O(new_n110_));
  inv1   g48(.a(x28), .O(new_n111_));
  nand2  g49(.a(x27), .b(x04), .O(new_n112_));
  inv1   g50(.a(x08), .O(new_n113_));
  nand2  g51(.a(new_n64_), .b(new_n113_), .O(new_n114_));
  nand4  g52(.a(new_n114_), .b(new_n112_), .c(x35), .d(new_n111_), .O(new_n115_));
  nand4  g53(.a(new_n115_), .b(z02), .c(new_n72_), .d(new_n110_), .O(new_n116_));
  inv1   g54(.a(new_n116_), .O(z11));
  nor2   g55(.a(z08), .b(new_n67_), .O(z12));
  inv1   g56(.a(x18), .O(new_n119_));
  inv1   g57(.a(x19), .O(new_n120_));
  nand4  g58(.a(new_n67_), .b(x20), .c(new_n120_), .d(new_n119_), .O(new_n121_));
  nand2  g59(.a(new_n121_), .b(z02), .O(z13));
  nand4  g60(.a(x27), .b(x20), .c(new_n120_), .d(new_n119_), .O(new_n123_));
  aoi21  g61(.a(new_n66_), .b(new_n65_), .c(new_n123_), .O(new_n124_));
  nor2   g62(.a(new_n124_), .b(z08), .O(z14));
  ...
  nand2  g70(.a(new_n132_), .b(z02), .O(z17));
  nand2  g71(.a(x27), .b(new_n104_), .O(new_n134_));
  oai21  g72(.a(x27), .b(new_n113_), .c(new_n134_), .O(new_n135_));
  nand3  g73(.a(new_n135_), .b(x35), .c(new_n111_), .O(new_n136_));
  nand4  g74(.a(new_n136_), .b(z02), .c(new_n72_), .d(new_n110_), .O(z18));
  nand2  g75(.a(new_n116_), .b(z02), .O(z19));
  oai21  g76(.a(x28), .b(new_n113_), .c(new_n64_), .O(new_n139_));
  nand2  g77(.a(new_n139_), .b(x35), .O(new_n140_));
  nand4  g78(.a(new_n140_), .b(z02), .c(new_n72_), .d(new_n110_), .O(new_n141_));
