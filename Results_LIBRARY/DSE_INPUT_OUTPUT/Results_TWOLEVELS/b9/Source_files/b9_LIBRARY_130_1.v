...
module FAU ( 
  ...
  aoi21  g057(.a(new_n75_), .b(x07), .c(new_n76_), .O(z08));
  ...
  aoi21  g065(.a(new_n127_), .b(new_n126_), .c(new_n81_), .O(new_n128_));
  nand3  g066(.a(new_n76_), .b(x37), .c(x06), .O(new_n129_));
  ...
  oai21  g088(.a(new_n150_), .b(new_n76_), .c(new_n149_), .O(new_n151_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(new_n81_), .O(new_n160_));
  ...
  nand4  g101(.a(new_n133_), .b(new_n153_), .c(x07), .d(new_n65_), .O(new_n164_));
  ...
  oai21  g108(.a(new_n170_), .b(new_n76_), .c(new_n166_), .O(new_n171_));
  ...
  nand2  g114(.a(new_n176_), .b(x07), .O(new_n177_));
  nand2  g115(.a(new_n149_), .b(new_n76_), .O(new_n178_));
  ...
  nand2  g130(.a(new_n84_), .b(new_n192_), .O(new_n193_));
  aoi21  g131(.a(new_n191_), .b(new_n86_), .c(new_n193_), .O(new_n194_));
  nand4  g132(.a(new_n77_), .b(x29), .c(x08), .d(x07), .O(new_n195_));
  oai21  g133(.a(new_n194_), .b(new_n98_), .c(new_n195_), .O(z18));
  nor2   g134(.a(new_n86_), .b(x27), .O(new_n197_));
  nor2   g135(.a(x35), .b(new_n81_), .O(new_n198_));
  oai21  g136(.a(new_n198_), .b(new_n197_), .c(new_n140_), .O(new_n199_));
  inv1   g137(.a(x08), .O(new_n200_));
  aoi21  g138(.a(x35), .b(x27), .c(new_n81_), .O(new_n201_));
  nor2   g139(.a(x40), .b(x27), .O(new_n202_));
  oai21  g140(.a(new_n202_), .b(new_n201_), .c(new_n200_), .O(new_n203_));
  oai21  g141(.a(new_n197_), .b(new_n66_), .c(new_n76_), .O(new_n204_));
  nand3  g142(.a(new_n204_), .b(new_n203_), .c(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n84_), .c(new_n192_), .O(new_n206_));
