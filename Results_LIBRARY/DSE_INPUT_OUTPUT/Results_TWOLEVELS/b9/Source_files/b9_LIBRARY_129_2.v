...
module FAU ( 
  ...
  nor2   g037(.a(new_n99_), .b(new_n89_), .O(z05));
  aoi21  g038(.a(new_n71_), .b(new_n93_), .c(new_n77_), .O(new_n101_));
  ...
  aoi21  g068(.a(x40), .b(new_n130_), .c(new_n67_), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n129_), .c(new_n131_), .O(new_n133_));
  nand2  g071(.a(new_n71_), .b(new_n93_), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n77_), .c(new_n118_), .O(new_n135_));
  ...
  oai21  g078(.a(new_n140_), .b(new_n93_), .c(new_n66_), .O(new_n141_));
  oai21  g079(.a(new_n70_), .b(new_n118_), .c(x39), .O(new_n142_));
  oai21  g080(.a(new_n64_), .b(new_n93_), .c(new_n142_), .O(new_n143_));
  ...
  nand2  g088(.a(new_n90_), .b(new_n94_), .O(new_n151_));
  ...
  aoi21  g094(.a(new_n75_), .b(new_n74_), .c(new_n70_), .O(new_n157_));
  ...
  nand4  g104(.a(new_n166_), .b(x40), .c(new_n75_), .d(new_n74_), .O(new_n167_));
  ...
  aoi21  g121(.a(new_n181_), .b(new_n77_), .c(new_n183_), .O(new_n184_));
  nand2  g122(.a(x40), .b(x39), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n84_), .c(new_n184_), .d(new_n89_), .O(z18));
  aoi21  g124(.a(x28), .b(new_n93_), .c(new_n178_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(new_n131_), .O(new_n188_));
  nand2  g126(.a(x40), .b(new_n178_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n134_), .c(x08), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n188_), .c(new_n74_), .O(new_n191_));
