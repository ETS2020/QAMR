...
module FAU ( 
  ...
  oai22  g044(.a(x40), .b(x22), .c(new_n87_), .d(new_n64_), .O(new_n107_));
  ...
  nand2  g063(.a(new_n76_), .b(x22), .O(new_n126_));
  ...
  nand3  g075(.a(x35), .b(new_n87_), .c(new_n65_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x40), .c(new_n82_), .d(new_n64_), .O(new_n139_));
  nor2   g077(.a(new_n139_), .b(x08), .O(new_n140_));
  ...
  oai21  g083(.a(new_n145_), .b(new_n140_), .c(new_n85_), .O(new_n146_));
  ...
  inv1   g089(.a(new_n126_), .O(new_n152_));
  nand2  g090(.a(new_n72_), .b(x27), .O(new_n153_));
  aoi21  g091(.a(x39), .b(new_n65_), .c(new_n76_), .O(new_n154_));
  ...
  aoi21  g101(.a(new_n163_), .b(new_n160_), .c(new_n76_), .O(new_n164_));
  nand4  g102(.a(new_n72_), .b(x22), .c(x20), .d(new_n162_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n135_), .b(new_n157_), .c(new_n65_), .O(new_n168_));
  ...
  nand3  g115(.a(new_n177_), .b(new_n86_), .c(new_n85_), .O(new_n178_));
  ...
  nand2  g128(.a(new_n190_), .b(new_n82_), .O(z17));
  ...
  oai22  g135(.a(new_n197_), .b(new_n84_), .c(new_n94_), .d(new_n120_), .O(z18));
  oai21  g136(.a(new_n146_), .b(x09), .c(new_n82_), .O(z19));
  oai22  g137(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(x22), .O(new_n201_));
  ...
  nand2  g142(.a(new_n77_), .b(x29), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(x28), .c(new_n64_), .O(new_n206_));
  nand3  g144(.a(new_n206_), .b(new_n204_), .c(new_n201_), .O(new_n207_));
  nand3  g145(.a(new_n207_), .b(new_n85_), .c(new_n195_), .O(new_n208_));
