...
module FAU ( 
  ...
  nand2  g000(.a(x19), .b(x13), .O(new_n63_));
  ...
  aoi21  g026(.a(new_n88_), .b(x04), .c(new_n86_), .O(new_n89_));
  aoi22  g027(.a(new_n89_), .b(new_n75_), .c(x19), .d(x13), .O(z02));
  ...
  aoi21  g033(.a(new_n95_), .b(new_n92_), .c(new_n64_), .O(z03));
  nand2  g034(.a(new_n94_), .b(new_n66_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n92_), .c(new_n63_), .d(new_n93_), .O(z04));
  aoi21  g036(.a(x28), .b(x27), .c(x37), .O(new_n99_));
  nor2   g037(.a(new_n99_), .b(new_n64_), .O(z05));
  aoi22  g038(.a(x28), .b(x27), .c(x19), .d(x13), .O(new_n101_));
  and2   g039(.a(new_n101_), .b(new_n94_), .O(z06));
  ...
  nand2  g064(.a(new_n126_), .b(new_n67_), .O(new_n127_));
  nand3  g065(.a(x37), .b(x27), .c(x06), .O(new_n128_));
  aoi21  g066(.a(new_n128_), .b(new_n127_), .c(new_n64_), .O(z10));
  inv1   g067(.a(x09), .O(new_n130_));
  nand2  g068(.a(new_n75_), .b(x29), .O(new_n131_));
  nand2  g069(.a(x27), .b(x04), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n87_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  inv1   g072(.a(x08), .O(new_n135_));
  nand3  g073(.a(new_n87_), .b(x27), .c(new_n67_), .O(new_n136_));
  nand2  g074(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand4  g076(.a(new_n138_), .b(new_n63_), .c(new_n80_), .d(new_n130_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n63_), .O(z11));
  inv1   g078(.a(x10), .O(new_n141_));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  oai21  g080(.a(new_n142_), .b(new_n66_), .c(new_n141_), .O(new_n143_));
  nand2  g081(.a(new_n75_), .b(new_n67_), .O(new_n144_));
  oai21  g082(.a(new_n72_), .b(new_n66_), .c(new_n144_), .O(new_n145_));
  nand3  g083(.a(new_n145_), .b(new_n143_), .c(new_n63_), .O(z12));
  ...
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n147_), .d(new_n67_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand2  g091(.a(new_n91_), .b(new_n94_), .O(new_n154_));
  ...
  nor3   g095(.a(new_n123_), .b(new_n122_), .c(x13), .O(new_n158_));
  aoi21  g096(.a(new_n158_), .b(new_n67_), .c(new_n64_), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n157_), .O(z13));
  aoi21  g098(.a(x20), .b(new_n153_), .c(x13), .O(new_n161_));
  nor2   g099(.a(x19), .b(new_n152_), .O(new_n162_));
  nand4  g100(.a(new_n149_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n163_));
  inv1   g101(.a(new_n163_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n144_), .c(new_n162_), .d(new_n161_), .O(new_n165_));
  nand4  g103(.a(new_n94_), .b(new_n68_), .c(x28), .d(new_n153_), .O(new_n166_));
  oai21  g104(.a(x27), .b(x13), .c(new_n166_), .O(new_n167_));
  nand3  g105(.a(new_n167_), .b(new_n81_), .c(new_n80_), .O(new_n168_));
  nor2   g106(.a(x13), .b(x04), .O(new_n169_));
  aoi22  g107(.a(new_n169_), .b(new_n75_), .c(new_n154_), .d(x27), .O(new_n170_));
  aoi21  g108(.a(x20), .b(new_n152_), .c(new_n147_), .O(new_n171_));
  oai21  g109(.a(new_n171_), .b(new_n170_), .c(new_n153_), .O(new_n172_));
  nand3  g110(.a(new_n172_), .b(new_n168_), .c(new_n165_), .O(z14));
  inv1   g111(.a(x12), .O(new_n174_));
  nand4  g112(.a(new_n63_), .b(x34), .c(x27), .d(x26), .O(new_n175_));
  ...
  nand2  g119(.a(new_n181_), .b(new_n63_), .O(z17));
  nand2  g120(.a(new_n87_), .b(new_n66_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n131_), .O(new_n184_));
  nand3  g122(.a(new_n136_), .b(new_n80_), .c(new_n130_), .O(new_n185_));
  aoi21  g123(.a(new_n184_), .b(x08), .c(new_n185_), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n64_), .O(z18));
  inv1   g125(.a(new_n139_), .O(z19));
  inv1   g126(.a(new_n131_), .O(new_n189_));
  oai21  g127(.a(new_n68_), .b(new_n66_), .c(new_n135_), .O(new_n190_));
  aoi21  g128(.a(x28), .b(new_n66_), .c(new_n68_), .O(new_n191_));
  oai21  g129(.a(new_n191_), .b(new_n189_), .c(new_n190_), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n63_), .c(new_n80_), .d(new_n130_), .O(new_n193_));
