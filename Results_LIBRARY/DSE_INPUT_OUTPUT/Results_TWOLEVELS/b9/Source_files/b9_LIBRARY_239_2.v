...
module FAU ( 
  ...
  aoi21  g040(.a(new_n64_), .b(new_n96_), .c(new_n81_), .O(new_n103_));
  ...
  aoi21  g071(.a(x40), .b(new_n133_), .c(new_n127_), .O(new_n134_));
  nand2  g072(.a(x27), .b(x04), .O(new_n135_));
  aoi21  g073(.a(new_n135_), .b(new_n132_), .c(new_n134_), .O(new_n136_));
  nand2  g074(.a(new_n64_), .b(new_n96_), .O(new_n137_));
  nand3  g075(.a(x35), .b(new_n81_), .c(new_n71_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(x40), .O(new_n139_));
  aoi21  g077(.a(new_n139_), .b(new_n137_), .c(x08), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n136_), .c(new_n78_), .O(new_n141_));
  ...
  oai21  g082(.a(new_n127_), .b(x04), .c(new_n68_), .O(new_n145_));
  ...
  nand4  g092(.a(new_n67_), .b(new_n127_), .c(x20), .d(new_n152_), .O(new_n155_));
  ...
  nand3  g097(.a(x39), .b(new_n147_), .c(new_n71_), .O(new_n160_));
  ...
  nand2  g120(.a(new_n78_), .b(new_n182_), .O(new_n183_));
  aoi21  g121(.a(new_n181_), .b(new_n81_), .c(new_n183_), .O(new_n184_));
  oai22  g122(.a(new_n184_), .b(new_n93_), .c(new_n121_), .d(new_n88_), .O(z18));
  aoi21  g123(.a(new_n63_), .b(x39), .c(x08), .O(new_n186_));
  aoi21  g124(.a(x39), .b(x29), .c(new_n81_), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n186_), .c(new_n96_), .O(new_n188_));
  nand2  g126(.a(new_n88_), .b(x40), .O(new_n189_));
  ...
  nand3  g130(.a(new_n192_), .b(new_n78_), .c(new_n182_), .O(new_n193_));
