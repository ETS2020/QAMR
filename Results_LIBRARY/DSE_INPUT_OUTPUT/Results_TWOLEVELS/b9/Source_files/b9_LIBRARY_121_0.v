...
module FAU ( 
  ...
  nand3  g062(.a(new_n82_), .b(x37), .c(x06), .O(new_n125_));
  aoi21  g063(.a(x40), .b(x39), .c(x07), .O(new_n126_));
  nand3  g064(.a(x40), .b(new_n75_), .c(x07), .O(new_n127_));
  oai21  g065(.a(new_n126_), .b(new_n81_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g078(.a(new_n76_), .b(x05), .O(new_n141_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n76_), .c(x05), .O(new_n154_));
  ...
  nor2   g101(.a(new_n162_), .b(new_n81_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n163_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n133_), .b(new_n156_), .c(new_n65_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n165_), .O(z13));
  inv1   g105(.a(new_n141_), .O(new_n168_));
  ...
  nand2  g120(.a(new_n182_), .b(new_n82_), .O(z15));
  ...
  nor2   g129(.a(new_n66_), .b(x28), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x04), .O(new_n193_));
  aoi21  g131(.a(new_n193_), .b(new_n192_), .c(x09), .O(new_n194_));
  nand4  g132(.a(new_n194_), .b(new_n191_), .c(new_n82_), .d(new_n84_), .O(z18));
  nand2  g133(.a(new_n147_), .b(new_n82_), .O(z19));
  nand2  g134(.a(x28), .b(new_n64_), .O(new_n197_));
  aoi22  g135(.a(new_n197_), .b(x35), .c(new_n141_), .d(new_n140_), .O(new_n198_));
  nand2  g136(.a(new_n82_), .b(new_n64_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n97_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n198_), .c(new_n84_), .O(new_n201_));
