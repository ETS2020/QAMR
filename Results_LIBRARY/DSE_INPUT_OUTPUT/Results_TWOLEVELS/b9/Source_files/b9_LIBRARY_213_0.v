...
module FAU ( 
  ...
  nand3  g070(.a(x35), .b(new_n86_), .c(new_n65_), .O(new_n133_));
  ...
  nand2  g083(.a(x39), .b(new_n65_), .O(new_n146_));
  nand2  g084(.a(new_n72_), .b(x27), .O(new_n147_));
  and2   g085(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g086(.a(new_n148_), .b(new_n145_), .c(x40), .O(new_n149_));
  nand3  g087(.a(new_n147_), .b(new_n81_), .c(x18), .O(new_n150_));
  ...
  nand4  g094(.a(new_n72_), .b(x20), .c(new_n156_), .d(new_n80_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x27), .O(new_n159_));
  nand4  g097(.a(new_n126_), .b(x39), .c(new_n152_), .d(new_n65_), .O(new_n160_));
  aoi21  g098(.a(new_n160_), .b(new_n159_), .c(new_n81_), .O(z13));
  nand4  g099(.a(x27), .b(x20), .c(new_n156_), .d(new_n80_), .O(new_n162_));
  oai21  g100(.a(x13), .b(x04), .c(new_n162_), .O(new_n163_));
  nand3  g101(.a(new_n146_), .b(new_n71_), .c(new_n70_), .O(new_n164_));
  inv1   g102(.a(x39), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n64_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n164_), .c(new_n163_), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(x40), .O(new_n168_));
  nand2  g106(.a(new_n71_), .b(x13), .O(new_n169_));
  nand4  g107(.a(new_n66_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n70_), .O(new_n172_));
  nand4  g110(.a(new_n153_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(x39), .O(new_n174_));
  nand3  g112(.a(x20), .b(new_n156_), .c(new_n80_), .O(new_n175_));
  oai21  g113(.a(new_n126_), .b(x27), .c(x40), .O(new_n176_));
  aoi21  g114(.a(new_n175_), .b(new_n174_), .c(new_n176_), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n172_), .c(new_n168_), .O(z14));
  ...
  nand2  g123(.a(new_n185_), .b(new_n82_), .O(z17));
  nand2  g124(.a(z08), .b(x29), .O(new_n187_));
  ...
  aoi21  g128(.a(new_n190_), .b(new_n136_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n82_), .d(new_n84_), .O(z18));
  inv1   g130(.a(x09), .O(new_n193_));
  oai22  g131(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n194_));
  nand2  g132(.a(new_n194_), .b(x18), .O(new_n195_));
  ...
  nand3  g136(.a(new_n187_), .b(x28), .c(new_n64_), .O(new_n199_));
  nand3  g137(.a(new_n199_), .b(new_n198_), .c(new_n195_), .O(new_n200_));
  nand3  g138(.a(new_n200_), .b(new_n84_), .c(new_n193_), .O(new_n201_));
