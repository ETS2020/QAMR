...
module FAU ( 
  ...
  aoi21  g031(.a(new_n67_), .b(new_n66_), .c(new_n93_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n92_), .c(new_n63_), .O(z03));
  inv1   g033(.a(new_n63_), .O(new_n96_));
  nand2  g034(.a(new_n67_), .b(new_n66_), .O(new_n97_));
  nand4  g035(.a(new_n97_), .b(new_n92_), .c(new_n96_), .d(new_n93_), .O(z04));
  nand2  g036(.a(x28), .b(x27), .O(new_n99_));
  nand3  g037(.a(new_n99_), .b(new_n96_), .c(new_n67_), .O(z05));
  aoi21  g038(.a(new_n96_), .b(new_n66_), .c(new_n81_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(x37), .c(new_n96_), .O(z06));
  ...
  nand2  g050(.a(new_n112_), .b(new_n96_), .O(z07));
  inv1   g051(.a(x39), .O(new_n114_));
  nor2   g052(.a(new_n73_), .b(new_n114_), .O(z08));
  inv1   g053(.a(x11), .O(new_n116_));
  nand4  g054(.a(new_n96_), .b(x34), .c(x27), .d(x26), .O(new_n117_));
  nor2   g055(.a(new_n117_), .b(new_n116_), .O(z09));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(x40), .b(new_n114_), .O(new_n120_));
  nand2  g058(.a(new_n73_), .b(x10), .O(new_n121_));
  ...
  nand3  g063(.a(new_n96_), .b(x37), .c(x06), .O(new_n126_));
  ...
  nand2  g071(.a(new_n133_), .b(x10), .O(new_n134_));
  oai21  g072(.a(new_n66_), .b(new_n71_), .c(new_n81_), .O(new_n135_));
  ...
  oai21  g078(.a(x28), .b(x04), .c(new_n89_), .O(new_n141_));
  nand4  g079(.a(new_n141_), .b(new_n140_), .c(new_n137_), .d(new_n134_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n78_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(x09), .c(new_n96_), .O(z11));
  inv1   g082(.a(x35), .O(new_n145_));
  nand3  g083(.a(new_n67_), .b(new_n80_), .c(new_n145_), .O(new_n146_));
  ...
  nor2   g087(.a(new_n69_), .b(x40), .O(new_n150_));
  nand2  g088(.a(new_n150_), .b(x10), .O(new_n151_));
  ...
  aoi21  g098(.a(new_n160_), .b(new_n156_), .c(new_n73_), .O(new_n161_));
  nor2   g099(.a(new_n160_), .b(new_n72_), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n161_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n130_), .b(new_n153_), .c(new_n71_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  inv1   g103(.a(new_n121_), .O(new_n166_));
  nand3  g104(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n167_));
  nand4  g105(.a(new_n154_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n168_));
  nand3  g106(.a(x39), .b(new_n153_), .c(new_n71_), .O(new_n169_));
  ...
  nand3  g110(.a(new_n67_), .b(new_n145_), .c(x28), .O(new_n173_));
  ...
  nor2   g117(.a(new_n117_), .b(new_n179_), .O(z15));
  inv1   g118(.a(x23), .O(new_n181_));
  nand4  g119(.a(new_n96_), .b(new_n181_), .c(x22), .d(x01), .O(new_n182_));
  inv1   g120(.a(new_n182_), .O(z16));
  inv1   g121(.a(x01), .O(new_n184_));
  inv1   g122(.a(x24), .O(new_n185_));
  nand4  g123(.a(new_n96_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  oai21  g125(.a(new_n82_), .b(x27), .c(new_n136_), .O(new_n188_));
  ...
  nand4  g130(.a(new_n192_), .b(new_n189_), .c(new_n96_), .d(new_n78_), .O(z18));
  nand2  g131(.a(x28), .b(new_n66_), .O(new_n194_));
  nand2  g132(.a(x39), .b(x29), .O(new_n195_));
  nand2  g133(.a(new_n195_), .b(x40), .O(new_n196_));
  aoi22  g134(.a(new_n196_), .b(new_n121_), .c(new_n194_), .d(x35), .O(new_n197_));
  nand2  g135(.a(new_n96_), .b(new_n66_), .O(new_n198_));
  nand2  g136(.a(x40), .b(new_n145_), .O(new_n199_));
  aoi21  g137(.a(new_n199_), .b(new_n198_), .c(x08), .O(new_n200_));
  oai21  g138(.a(new_n200_), .b(new_n197_), .c(new_n78_), .O(new_n201_));
  nor2   g139(.a(new_n201_), .b(x09), .O(z20));
  oai21  g140(.a(new_n143_), .b(x09), .c(new_n96_), .O(z19));
endmodule
