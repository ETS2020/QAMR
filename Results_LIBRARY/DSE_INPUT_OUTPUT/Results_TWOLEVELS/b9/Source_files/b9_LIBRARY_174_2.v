...
module FAU ( 
  ...
  nor2   g033(.a(x40), .b(x25), .O(new_n96_));
  ...
  nand2  g041(.a(new_n68_), .b(new_n101_), .O(new_n104_));
  ...
  nor2   g053(.a(new_n63_), .b(x38), .O(new_n116_));
  ...
  oai21  g059(.a(new_n121_), .b(new_n115_), .c(new_n119_), .O(new_n122_));
  aoi21  g060(.a(new_n122_), .b(new_n118_), .c(new_n110_), .O(z07));
  inv1   g061(.a(x39), .O(new_n124_));
  nor2   g062(.a(new_n63_), .b(new_n124_), .O(z08));
  nand4  g063(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n126_));
  nand2  g064(.a(new_n126_), .b(new_n64_), .O(z09));
  inv1   g065(.a(x07), .O(new_n128_));
  aoi21  g066(.a(x40), .b(new_n124_), .c(new_n96_), .O(new_n129_));
  ...
  nor2   g074(.a(new_n136_), .b(new_n124_), .O(new_n137_));
  nand3  g075(.a(new_n137_), .b(x05), .c(new_n74_), .O(new_n138_));
  nand2  g076(.a(new_n138_), .b(new_n135_), .O(z10));
  nand2  g077(.a(new_n64_), .b(new_n101_), .O(new_n140_));
  ...
  aoi21  g082(.a(new_n144_), .b(x40), .c(new_n96_), .O(new_n145_));
  ...
  nand3  g088(.a(new_n68_), .b(new_n82_), .c(new_n150_), .O(new_n151_));
  ...
  nand3  g092(.a(new_n71_), .b(new_n63_), .c(new_n120_), .O(new_n155_));
  ...
  nand4  g102(.a(new_n70_), .b(new_n120_), .c(x20), .d(new_n162_), .O(new_n165_));
  nor2   g103(.a(new_n165_), .b(x18), .O(new_n166_));
  oai21  g104(.a(new_n166_), .b(new_n164_), .c(x27), .O(new_n167_));
  nand3  g105(.a(new_n137_), .b(new_n157_), .c(new_n74_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n167_), .O(z13));
  oai21  g107(.a(new_n124_), .b(x04), .c(x40), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n97_), .c(new_n157_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n71_), .O(new_n172_));
  nand3  g110(.a(x20), .b(new_n162_), .c(new_n161_), .O(new_n173_));
  nand4  g111(.a(new_n158_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n174_));
  nand4  g112(.a(new_n174_), .b(z08), .c(new_n157_), .d(new_n74_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand3  g114(.a(new_n68_), .b(new_n150_), .c(x28), .O(new_n177_));
  nand2  g115(.a(new_n177_), .b(x27), .O(new_n178_));
  nand3  g116(.a(new_n178_), .b(new_n81_), .c(new_n80_), .O(new_n179_));
  nand4  g117(.a(new_n179_), .b(new_n176_), .c(new_n172_), .d(new_n64_), .O(z14));
  ...
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n150_), .O(new_n193_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n65_), .c(new_n190_), .d(new_n90_), .O(z18));
  aoi21  g135(.a(x28), .b(new_n101_), .c(new_n150_), .O(new_n198_));
  nor2   g136(.a(new_n198_), .b(new_n145_), .O(new_n199_));
  nand2  g137(.a(x40), .b(new_n150_), .O(new_n200_));
  aoi21  g138(.a(new_n200_), .b(new_n140_), .c(x08), .O(new_n201_));
