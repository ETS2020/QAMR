...
module FAU ( 
  ...
  nand2  g018(.a(new_n76_), .b(x29), .O(new_n81_));
  ...
  nand2  g063(.a(new_n76_), .b(new_n125_), .O(new_n126_));
  ...
  oai21  g067(.a(new_n129_), .b(new_n127_), .c(new_n87_), .O(new_n130_));
  ...
  aoi22  g076(.a(new_n138_), .b(new_n94_), .c(new_n124_), .d(x29), .O(new_n139_));
  ...
  oai21  g080(.a(new_n142_), .b(new_n139_), .c(new_n83_), .O(new_n143_));
  ...
  nand2  g088(.a(new_n150_), .b(new_n125_), .O(new_n151_));
  ...
  nand4  g098(.a(new_n72_), .b(new_n125_), .c(x20), .d(new_n158_), .O(new_n161_));
  nor2   g099(.a(new_n161_), .b(x18), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n160_), .c(x27), .O(new_n163_));
  nand3  g101(.a(new_n135_), .b(new_n153_), .c(new_n65_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n163_), .O(z13));
  inv1   g103(.a(new_n126_), .O(new_n166_));
  ...
  aoi21  g129(.a(new_n191_), .b(new_n94_), .c(x09), .O(new_n192_));
  nand4  g130(.a(new_n192_), .b(new_n190_), .c(new_n81_), .d(new_n83_), .O(z18));
  inv1   g131(.a(x08), .O(new_n194_));
  aoi22  g132(.a(new_n188_), .b(x28), .c(new_n81_), .d(new_n194_), .O(new_n195_));
  aoi21  g133(.a(x39), .b(x08), .c(new_n76_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n125_), .c(new_n66_), .O(new_n197_));
  oai21  g135(.a(new_n195_), .b(x27), .c(new_n197_), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n83_), .O(new_n199_));
  oai21  g137(.a(new_n199_), .b(x09), .c(new_n81_), .O(z20));
  nor2   g138(.a(new_n143_), .b(x09), .O(z19));
endmodule
