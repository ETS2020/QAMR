...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x02), .O(new_n81_));
  ...
  nand2  g063(.a(new_n76_), .b(x02), .O(new_n126_));
  ...
  aoi22  g082(.a(new_n144_), .b(new_n126_), .c(new_n142_), .d(new_n141_), .O(new_n145_));
  ...
  nor2   g087(.a(new_n76_), .b(x27), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(new_n148_), .O(new_n151_));
  oai22  g089(.a(new_n119_), .b(x04), .c(new_n73_), .d(new_n64_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n151_), .c(new_n82_), .O(z12));
  inv1   g091(.a(x19), .O(new_n154_));
  nand4  g092(.a(new_n82_), .b(new_n72_), .c(x20), .d(new_n154_), .O(new_n155_));
  ...
  oai22  g097(.a(new_n159_), .b(x04), .c(new_n155_), .d(x18), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(x27), .O(new_n161_));
  nand3  g099(.a(new_n135_), .b(new_n156_), .c(new_n65_), .O(new_n162_));
  nand2  g100(.a(new_n162_), .b(new_n161_), .O(z13));
  aoi21  g101(.a(new_n85_), .b(new_n84_), .c(x13), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x40), .c(x39), .d(new_n65_), .O(new_n165_));
  nand2  g103(.a(new_n165_), .b(new_n64_), .O(new_n166_));
  nand2  g104(.a(x20), .b(new_n154_), .O(new_n167_));
  nand4  g105(.a(new_n157_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n168_));
  nor2   g106(.a(x13), .b(x04), .O(new_n169_));
  nand3  g107(.a(new_n169_), .b(new_n168_), .c(new_n77_), .O(new_n170_));
  oai21  g108(.a(new_n167_), .b(x18), .c(new_n170_), .O(new_n171_));
  inv1   g109(.a(new_n71_), .O(new_n172_));
  aoi21  g110(.a(new_n169_), .b(new_n77_), .c(new_n172_), .O(new_n173_));
  nand4  g111(.a(new_n66_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n174_));
  inv1   g112(.a(new_n174_), .O(new_n175_));
  oai21  g113(.a(new_n175_), .b(new_n173_), .c(new_n70_), .O(new_n176_));
  nand4  g114(.a(new_n176_), .b(new_n171_), .c(new_n166_), .d(new_n82_), .O(z14));
  nand4  g115(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(new_n82_), .O(z15));
  inv1   g117(.a(x23), .O(new_n180_));
  nand3  g118(.a(new_n180_), .b(x22), .c(x01), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n82_), .O(z16));
  inv1   g120(.a(x01), .O(new_n183_));
  inv1   g121(.a(x24), .O(new_n184_));
  nand4  g122(.a(new_n82_), .b(new_n184_), .c(x23), .d(x22), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n183_), .O(z17));
  nand2  g124(.a(new_n77_), .b(x29), .O(new_n187_));
  ...
  aoi21  g128(.a(new_n190_), .b(new_n141_), .c(x09), .O(new_n191_));
  nand4  g129(.a(new_n191_), .b(new_n189_), .c(new_n82_), .d(new_n84_), .O(z18));
  nor2   g130(.a(x40), .b(x35), .O(new_n193_));
  oai21  g131(.a(new_n193_), .b(new_n95_), .c(x02), .O(new_n194_));
