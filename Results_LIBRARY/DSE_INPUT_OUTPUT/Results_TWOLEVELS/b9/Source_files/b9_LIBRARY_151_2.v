...
module FAU ( 
  ...
  wire new_n63_, new_n64_, new_n65_, new_n66_, new_n67_, new_n68_, new_n69_,
    ...
    new_n95_, new_n97_, new_n98_, new_n100_, new_n101_, new_n102_,
  ...
  nor2   g025(.a(new_n80_), .b(x28), .O(new_n88_));
  oai21  g026(.a(x27), .b(x08), .c(new_n88_), .O(new_n89_));
  aoi22  g027(.a(new_n89_), .b(x04), .c(new_n87_), .d(new_n86_), .O(new_n90_));
  ...
  aoi22  g031(.a(new_n93_), .b(x21), .c(new_n63_), .d(x39), .O(z03));
  inv1   g032(.a(x21), .O(new_n95_));
  aoi22  g033(.a(new_n93_), .b(new_n95_), .c(new_n63_), .d(x39), .O(z04));
  inv1   g034(.a(new_n64_), .O(new_n97_));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n97_), .O(z05));
  inv1   g037(.a(x27), .O(new_n100_));
  inv1   g038(.a(x28), .O(new_n101_));
  aoi21  g039(.a(new_n64_), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g057(.a(new_n119_), .b(new_n82_), .c(x27), .O(new_n120_));
  nand2  g058(.a(new_n79_), .b(new_n78_), .O(new_n121_));
  ...
  aoi21  g066(.a(x40), .b(new_n127_), .c(new_n128_), .O(new_n129_));
  nand2  g067(.a(x27), .b(x04), .O(new_n130_));
  aoi21  g068(.a(new_n130_), .b(new_n88_), .c(new_n129_), .O(new_n131_));
  nand2  g069(.a(new_n64_), .b(new_n100_), .O(new_n132_));
  nand3  g070(.a(x35), .b(new_n101_), .c(new_n71_), .O(new_n133_));
  nand2  g071(.a(new_n133_), .b(x40), .O(new_n134_));
  aoi21  g072(.a(new_n134_), .b(new_n132_), .c(x08), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n131_), .c(new_n78_), .O(new_n136_));
  nor2   g074(.a(new_n136_), .b(x09), .O(z11));
  nor3   g075(.a(x37), .b(x36), .c(x35), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(new_n100_), .c(new_n73_), .O(new_n139_));
  oai21  g077(.a(new_n63_), .b(new_n71_), .c(x39), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n68_), .O(new_n141_));
  ...
  nand4  g088(.a(new_n67_), .b(new_n128_), .c(x20), .d(new_n148_), .O(new_n151_));
  nor2   g089(.a(new_n151_), .b(x18), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(x27), .O(new_n153_));
  aoi21  g091(.a(new_n79_), .b(new_n78_), .c(new_n63_), .O(new_n154_));
  ...
  oai21  g097(.a(new_n157_), .b(new_n128_), .c(new_n159_), .O(new_n160_));
  ...
  oai21  g101(.a(new_n163_), .b(new_n101_), .c(x27), .O(new_n164_));
  nand4  g102(.a(new_n164_), .b(x40), .c(new_n79_), .d(new_n78_), .O(new_n165_));
  ...
  nand2  g114(.a(x40), .b(x39), .O(new_n177_));
  nand2  g115(.a(x27), .b(new_n71_), .O(new_n178_));
  nand2  g116(.a(new_n100_), .b(x08), .O(new_n179_));
  aoi21  g117(.a(new_n179_), .b(new_n178_), .c(new_n80_), .O(new_n180_));
  inv1   g118(.a(x09), .O(new_n181_));
  nand2  g119(.a(new_n78_), .b(new_n181_), .O(new_n182_));
  aoi21  g120(.a(new_n180_), .b(new_n101_), .c(new_n182_), .O(new_n183_));
  oai22  g121(.a(new_n183_), .b(new_n97_), .c(new_n177_), .d(new_n87_), .O(z18));
  aoi21  g122(.a(x28), .b(new_n100_), .c(new_n80_), .O(new_n185_));
  nor2   g123(.a(new_n185_), .b(new_n129_), .O(new_n186_));
  nand2  g124(.a(x40), .b(new_n80_), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n132_), .c(x08), .O(new_n188_));
  oai21  g126(.a(new_n188_), .b(new_n186_), .c(new_n78_), .O(new_n189_));
  nor2   g127(.a(new_n189_), .b(x09), .O(z20));
  buf    g128(.a(x39), .O(z08));
  nor2   g129(.a(new_n136_), .b(x09), .O(z19));
endmodule
