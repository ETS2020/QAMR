...
module FAU ( 
  ...
  nor2   g018(.a(x40), .b(x22), .O(new_n81_));
  ...
  nand2  g034(.a(new_n76_), .b(x22), .O(new_n97_));
  ...
  aoi21  g061(.a(new_n123_), .b(new_n97_), .c(new_n122_), .O(new_n124_));
  nand3  g062(.a(x40), .b(x39), .c(x05), .O(new_n125_));
  inv1   g063(.a(new_n125_), .O(new_n126_));
  oai21  g064(.a(new_n126_), .b(new_n124_), .c(new_n88_), .O(new_n127_));
  ...
  nor2   g079(.a(x40), .b(new_n141_), .O(new_n142_));
  ...
  aoi21  g083(.a(new_n145_), .b(new_n140_), .c(new_n144_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(new_n139_), .c(new_n84_), .O(new_n147_));
  ...
  nand2  g092(.a(new_n154_), .b(x22), .O(new_n155_));
  ...
  oai21  g111(.a(new_n173_), .b(new_n142_), .c(new_n169_), .O(new_n174_));
  ...
  oai21  g115(.a(new_n172_), .b(new_n151_), .c(new_n177_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x40), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n174_), .c(new_n155_), .O(z14));
  ...
  nor3   g123(.a(new_n183_), .b(x24), .c(new_n185_), .O(z17));
