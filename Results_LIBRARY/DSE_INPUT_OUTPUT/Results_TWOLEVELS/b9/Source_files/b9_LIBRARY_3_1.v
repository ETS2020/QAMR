...
module FAU ( 
  ...
  nand3  g077(.a(new_n93_), .b(x27), .c(new_n68_), .O(new_n140_));
  nand2  g078(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand4  g080(.a(new_n142_), .b(new_n64_), .c(new_n84_), .d(new_n134_), .O(new_n143_));
  nand2  g081(.a(new_n143_), .b(new_n64_), .O(z11));
  nor2   g082(.a(x37), .b(x36), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(new_n69_), .c(new_n67_), .O(new_n146_));
  nor2   g084(.a(new_n78_), .b(x04), .O(new_n147_));
  aoi21  g085(.a(new_n75_), .b(x27), .c(new_n147_), .O(new_n148_));
  nor2   g086(.a(new_n148_), .b(new_n65_), .O(new_n149_));
  ...
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n63_), .d(new_n68_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand4  g093(.a(new_n75_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n156_));
  and2   g094(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  aoi21  g095(.a(new_n128_), .b(new_n68_), .c(x19), .O(new_n158_));
  oai22  g096(.a(new_n158_), .b(x13), .c(new_n157_), .d(new_n67_), .O(z13));
  nand2  g097(.a(x20), .b(new_n154_), .O(new_n160_));
  nand4  g098(.a(new_n151_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n161_));
  aoi21  g099(.a(new_n161_), .b(new_n147_), .c(x19), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(x13), .c(new_n160_), .O(new_n163_));
  ...
  oai21  g105(.a(new_n167_), .b(new_n148_), .c(new_n155_), .O(new_n168_));
  nand3  g106(.a(new_n75_), .b(x27), .c(new_n155_), .O(new_n169_));
  nand2  g107(.a(new_n169_), .b(x13), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(new_n168_), .c(new_n163_), .O(z14));
  ...
  nand2  g118(.a(new_n93_), .b(new_n67_), .O(new_n181_));
  nand2  g119(.a(new_n181_), .b(new_n135_), .O(new_n182_));
  nand3  g120(.a(new_n140_), .b(new_n84_), .c(new_n134_), .O(new_n183_));
  ...
  oai21  g125(.a(new_n69_), .b(new_n67_), .c(new_n139_), .O(new_n188_));
  aoi21  g126(.a(x28), .b(new_n67_), .c(new_n69_), .O(new_n189_));
  oai21  g127(.a(new_n189_), .b(new_n187_), .c(new_n188_), .O(new_n190_));
  nand4  g128(.a(new_n190_), .b(new_n64_), .c(new_n84_), .d(new_n134_), .O(new_n191_));
