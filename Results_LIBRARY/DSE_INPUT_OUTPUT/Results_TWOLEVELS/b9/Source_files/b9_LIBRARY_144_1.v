...
module FAU ( 
  ...
  aoi21  g040(.a(new_n70_), .b(new_n85_), .c(new_n77_), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(x37), .c(new_n70_), .O(z06));
  ...
  nor2   g054(.a(new_n90_), .b(new_n69_), .O(z08));
  nand4  g055(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n118_));
  nand2  g056(.a(new_n118_), .b(new_n70_), .O(z09));
  ...
  aoi22  g073(.a(new_n135_), .b(x39), .c(new_n70_), .d(new_n85_), .O(new_n136_));
  ...
  nand3  g093(.a(new_n124_), .b(new_n147_), .c(new_n86_), .O(new_n156_));
  aoi21  g094(.a(new_n156_), .b(x39), .c(new_n90_), .O(new_n157_));
  or2    g095(.a(new_n157_), .b(new_n155_), .O(z13));
  aoi21  g096(.a(new_n147_), .b(new_n86_), .c(new_n69_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n152_), .d(new_n151_), .O(new_n160_));
  oai22  g098(.a(new_n160_), .b(new_n64_), .c(new_n159_), .d(new_n90_), .O(new_n161_));
  ...
  nand4  g103(.a(new_n165_), .b(x39), .c(new_n75_), .d(new_n74_), .O(new_n166_));
  ...
  oai22  g116(.a(new_n78_), .b(x27), .c(new_n90_), .d(new_n178_), .O(new_n179_));
  nand2  g117(.a(new_n179_), .b(x08), .O(new_n180_));
  inv1   g118(.a(new_n78_), .O(new_n181_));
  nor2   g119(.a(new_n85_), .b(x04), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(x09), .O(new_n183_));
  nand4  g121(.a(new_n183_), .b(new_n180_), .c(new_n70_), .d(new_n74_), .O(z18));
  inv1   g122(.a(new_n138_), .O(z19));
  oai21  g123(.a(new_n77_), .b(x27), .c(x35), .O(new_n186_));
  and2   g124(.a(new_n186_), .b(new_n131_), .O(new_n187_));
  nand2  g125(.a(new_n70_), .b(new_n85_), .O(new_n188_));
  nand2  g126(.a(x39), .b(new_n141_), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(x08), .O(new_n190_));
  oai21  g128(.a(new_n190_), .b(new_n187_), .c(new_n74_), .O(new_n191_));
