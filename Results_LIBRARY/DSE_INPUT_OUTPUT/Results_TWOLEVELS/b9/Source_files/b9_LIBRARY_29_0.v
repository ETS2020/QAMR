...
module FAU ( 
  ...
  aoi21  g044(.a(new_n82_), .b(new_n64_), .c(new_n86_), .O(new_n107_));
  ...
  oai21  g062(.a(new_n75_), .b(new_n80_), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g071(.a(new_n133_), .b(x06), .c(new_n98_), .O(new_n134_));
  ...
  nand2  g078(.a(new_n81_), .b(x05), .O(new_n141_));
  ...
  oai21  g083(.a(new_n138_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n84_), .c(new_n136_), .O(new_n147_));
  ...
  nand3  g102(.a(new_n129_), .b(new_n155_), .c(new_n65_), .O(new_n165_));
  ...
  nand2  g125(.a(new_n84_), .b(new_n136_), .O(new_n188_));
  aoi21  g126(.a(new_n187_), .b(new_n86_), .c(new_n188_), .O(new_n189_));
  oai22  g127(.a(new_n189_), .b(new_n98_), .c(new_n93_), .d(new_n75_), .O(z18));
  inv1   g128(.a(new_n147_), .O(z19));
  nor2   g129(.a(x40), .b(x35), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n95_), .c(x05), .O(new_n193_));
  ...
  nand2  g134(.a(new_n76_), .b(x29), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(x28), .c(new_n64_), .O(new_n198_));
  nand3  g136(.a(new_n198_), .b(new_n196_), .c(new_n193_), .O(new_n199_));
