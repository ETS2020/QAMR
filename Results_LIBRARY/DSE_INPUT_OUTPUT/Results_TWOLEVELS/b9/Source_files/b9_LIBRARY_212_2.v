...
module FAU ( 
  ...
  nand3  g018(.a(new_n80_), .b(new_n71_), .c(x04), .O(z01));
  ...
  oai21  g024(.a(new_n86_), .b(new_n70_), .c(x39), .O(z02));
  ...
  aoi21  g032(.a(new_n94_), .b(new_n90_), .c(new_n88_), .O(z03));
  aoi21  g033(.a(new_n93_), .b(new_n92_), .c(x21), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n90_), .c(new_n88_), .O(z04));
  aoi21  g035(.a(x28), .b(x27), .c(x37), .O(new_n98_));
  nor2   g036(.a(new_n98_), .b(new_n88_), .O(z05));
  inv1   g037(.a(x28), .O(new_n100_));
  aoi21  g038(.a(new_n71_), .b(new_n92_), .c(new_n100_), .O(new_n101_));
  oai21  g039(.a(new_n101_), .b(x37), .c(new_n71_), .O(z06));
  ...
  nand2  g051(.a(new_n113_), .b(new_n71_), .O(z07));
  ...
  oai22  g059(.a(new_n121_), .b(new_n119_), .c(x39), .d(new_n120_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n78_), .c(new_n118_), .O(new_n123_));
  ...
  nor2   g065(.a(new_n127_), .b(new_n67_), .O(new_n128_));
  nand3  g066(.a(new_n128_), .b(x05), .c(new_n118_), .O(new_n129_));
  nand2  g067(.a(new_n129_), .b(new_n126_), .O(z10));
  inv1   g068(.a(x09), .O(new_n131_));
  oai21  g069(.a(new_n70_), .b(x29), .c(x39), .O(new_n132_));
  nand2  g070(.a(x27), .b(x04), .O(new_n133_));
  nand3  g071(.a(new_n133_), .b(x35), .c(new_n100_), .O(new_n134_));
  nand2  g072(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g073(.a(x35), .b(new_n100_), .c(new_n118_), .O(new_n136_));
  aoi22  g074(.a(new_n136_), .b(x40), .c(new_n71_), .d(new_n92_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(x08), .c(new_n135_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n74_), .c(new_n131_), .O(new_n139_));
  ...
  nand3  g094(.a(new_n128_), .b(new_n145_), .c(new_n118_), .O(new_n157_));
  nand2  g095(.a(new_n157_), .b(new_n156_), .O(z13));
  nand3  g096(.a(x39), .b(new_n145_), .c(new_n118_), .O(new_n159_));
  nand4  g097(.a(x27), .b(x20), .c(new_n150_), .d(new_n149_), .O(new_n160_));
  oai21  g098(.a(new_n160_), .b(new_n64_), .c(new_n159_), .O(new_n161_));
  nand3  g099(.a(x20), .b(new_n150_), .c(new_n149_), .O(new_n162_));
  nor2   g100(.a(x37), .b(x35), .O(new_n163_));
  aoi21  g101(.a(new_n162_), .b(new_n146_), .c(new_n163_), .O(new_n164_));
  oai21  g102(.a(new_n164_), .b(new_n100_), .c(x27), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(new_n75_), .c(new_n74_), .O(new_n166_));
  nand3  g104(.a(new_n166_), .b(new_n161_), .c(new_n71_), .O(z14));
  inv1   g105(.a(x12), .O(new_n168_));
  nor2   g106(.a(new_n116_), .b(new_n168_), .O(z15));
  inv1   g107(.a(x23), .O(new_n170_));
  nand3  g108(.a(new_n170_), .b(x22), .c(x01), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n71_), .O(z16));
  inv1   g110(.a(x24), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(x23), .c(x22), .d(x01), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n71_), .O(z17));
  nand2  g113(.a(x27), .b(new_n118_), .O(new_n176_));
  nand2  g114(.a(new_n92_), .b(x08), .O(new_n177_));
  aoi21  g115(.a(new_n177_), .b(new_n176_), .c(new_n76_), .O(new_n178_));
  nand2  g116(.a(new_n74_), .b(new_n131_), .O(new_n179_));
  aoi21  g117(.a(new_n178_), .b(new_n100_), .c(new_n179_), .O(new_n180_));
  oai22  g118(.a(new_n180_), .b(new_n88_), .c(new_n121_), .d(new_n83_), .O(z18));
  nand2  g119(.a(new_n139_), .b(new_n71_), .O(z19));
  oai21  g120(.a(new_n100_), .b(x27), .c(x35), .O(new_n183_));
  and2   g121(.a(new_n183_), .b(new_n132_), .O(new_n184_));
  nand2  g122(.a(new_n71_), .b(new_n92_), .O(new_n185_));
  nand2  g123(.a(x40), .b(new_n76_), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(new_n185_), .c(x08), .O(new_n187_));
  oai21  g125(.a(new_n187_), .b(new_n184_), .c(new_n74_), .O(new_n188_));
  nor2   g126(.a(new_n188_), .b(x09), .O(z20));
  buf    g127(.a(x39), .O(z08));
endmodule
