...
module FAU ( 
  ...
  aoi21  g040(.a(x40), .b(new_n63_), .c(x27), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(new_n82_), .c(new_n65_), .O(new_n104_));
  ...
  oai21  g069(.a(new_n96_), .b(new_n71_), .c(new_n82_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  inv1   g071(.a(x08), .O(new_n134_));
  inv1   g072(.a(x35), .O(new_n135_));
  nand2  g073(.a(x39), .b(new_n135_), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(new_n82_), .c(new_n71_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(new_n103_), .c(new_n134_), .O(new_n138_));
  oai21  g076(.a(new_n63_), .b(x29), .c(x40), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n138_), .c(new_n133_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(new_n79_), .c(new_n130_), .O(new_n142_));
  nand2  g080(.a(new_n142_), .b(new_n64_), .O(z11));
  nor3   g081(.a(x37), .b(x36), .c(x35), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n96_), .c(new_n73_), .O(new_n145_));
  oai21  g083(.a(new_n74_), .b(x04), .c(new_n68_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n145_), .c(new_n64_), .O(z12));
  ...
  aoi21  g092(.a(new_n154_), .b(new_n151_), .c(new_n96_), .O(new_n155_));
  nand2  g093(.a(new_n80_), .b(new_n79_), .O(new_n156_));
  nand3  g094(.a(new_n156_), .b(new_n148_), .c(new_n71_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(x39), .c(new_n74_), .O(new_n158_));
  or2    g096(.a(new_n158_), .b(new_n155_), .O(z13));
  nand3  g097(.a(x40), .b(new_n148_), .c(new_n71_), .O(new_n160_));
  ...
  aoi22  g102(.a(new_n164_), .b(new_n149_), .c(new_n65_), .d(new_n135_), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n82_), .c(x27), .O(new_n166_));
  ...
  nor2   g107(.a(new_n118_), .b(new_n169_), .O(z15));
  ...
  oai21  g115(.a(new_n83_), .b(x27), .c(new_n131_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x08), .O(new_n179_));
  nor2   g117(.a(new_n96_), .b(x04), .O(new_n180_));
  aoi21  g118(.a(new_n180_), .b(new_n89_), .c(x09), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n179_), .c(new_n64_), .d(new_n79_), .O(z18));
  oai21  g120(.a(new_n82_), .b(x27), .c(x35), .O(new_n183_));
  and2   g121(.a(new_n183_), .b(new_n139_), .O(new_n184_));
  nand2  g122(.a(new_n64_), .b(new_n96_), .O(new_n185_));
  aoi21  g123(.a(new_n136_), .b(new_n185_), .c(x08), .O(new_n186_));
  oai21  g124(.a(new_n186_), .b(new_n184_), .c(new_n79_), .O(new_n187_));
  nor2   g125(.a(new_n187_), .b(x09), .O(z20));
  buf    g126(.a(x40), .O(z08));
  nand2  g127(.a(new_n142_), .b(new_n64_), .O(z19));
endmodule
