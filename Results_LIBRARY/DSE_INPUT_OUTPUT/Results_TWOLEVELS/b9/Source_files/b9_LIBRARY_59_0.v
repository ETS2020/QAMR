...
module FAU ( 
  ...
  aoi21  g042(.a(new_n65_), .b(new_n69_), .c(new_n83_), .O(new_n105_));
  ...
  nand2  g055(.a(new_n94_), .b(new_n65_), .O(z08));
  ...
  nor2   g068(.a(new_n70_), .b(new_n69_), .O(new_n131_));
  aoi21  g069(.a(new_n131_), .b(x06), .c(new_n66_), .O(new_n132_));
  nand2  g070(.a(new_n132_), .b(new_n130_), .O(z10));
  inv1   g071(.a(x09), .O(new_n134_));
  nand3  g072(.a(x35), .b(new_n83_), .c(new_n74_), .O(new_n135_));
  aoi22  g073(.a(new_n135_), .b(x39), .c(new_n65_), .d(new_n69_), .O(new_n136_));
  nand2  g074(.a(x40), .b(x29), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(x39), .O(new_n138_));
  nand2  g076(.a(x40), .b(new_n63_), .O(new_n139_));
  ...
  inv1   g089(.a(new_n72_), .O(new_n152_));
  nand3  g090(.a(new_n152_), .b(new_n64_), .c(x39), .O(new_n153_));
  ...
  nand4  g095(.a(new_n157_), .b(x40), .c(new_n155_), .d(new_n74_), .O(new_n158_));
  ...
  nand3  g104(.a(new_n127_), .b(new_n155_), .c(new_n74_), .O(new_n167_));
  ...
  nor2   g111(.a(x40), .b(new_n63_), .O(new_n174_));
  oai21  g112(.a(new_n174_), .b(new_n173_), .c(new_n169_), .O(new_n175_));
  nand3  g113(.a(new_n70_), .b(new_n147_), .c(x28), .O(new_n176_));
  nand2  g114(.a(new_n176_), .b(x27), .O(new_n177_));
  nand3  g115(.a(new_n177_), .b(new_n81_), .c(new_n80_), .O(new_n178_));
  nand2  g116(.a(new_n171_), .b(new_n152_), .O(new_n179_));
  ...
  nand2  g131(.a(new_n80_), .b(new_n134_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n83_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n66_), .c(new_n94_), .d(new_n90_), .O(z18));
  nand2  g134(.a(new_n145_), .b(new_n65_), .O(z19));
  nand2  g135(.a(x28), .b(new_n69_), .O(new_n198_));
  aoi22  g136(.a(new_n198_), .b(x35), .c(new_n139_), .d(new_n138_), .O(new_n199_));
  nand2  g137(.a(new_n65_), .b(new_n69_), .O(new_n200_));
  nand2  g138(.a(x39), .b(new_n147_), .O(new_n201_));
