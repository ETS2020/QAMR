...
module FAU ( 
  ...
  nand3  g025(.a(new_n73_), .b(new_n87_), .c(x04), .O(new_n88_));
  ...
  aoi21  g031(.a(new_n93_), .b(new_n73_), .c(new_n92_), .O(new_n94_));
  aoi21  g032(.a(new_n94_), .b(new_n91_), .c(new_n79_), .O(z03));
  nand2  g033(.a(new_n93_), .b(new_n73_), .O(new_n96_));
  nand4  g034(.a(new_n96_), .b(new_n91_), .c(new_n70_), .d(new_n92_), .O(z04));
  aoi21  g035(.a(new_n75_), .b(new_n93_), .c(new_n79_), .O(z05));
  nand3  g036(.a(new_n75_), .b(new_n70_), .c(new_n93_), .O(new_n99_));
  ...
  oai22  g059(.a(new_n113_), .b(new_n120_), .c(x40), .d(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n119_), .c(new_n78_), .O(new_n123_));
  ...
  nand3  g075(.a(x35), .b(new_n84_), .c(new_n78_), .O(new_n138_));
  aoi22  g076(.a(new_n138_), .b(x39), .c(new_n70_), .d(new_n73_), .O(new_n139_));
  oai21  g077(.a(new_n139_), .b(x08), .c(new_n137_), .O(new_n140_));
  nand3  g078(.a(new_n140_), .b(new_n127_), .c(new_n133_), .O(new_n141_));
  inv1   g079(.a(new_n141_), .O(z11));
  nor2   g080(.a(new_n64_), .b(new_n73_), .O(new_n143_));
  inv1   g081(.a(x35), .O(new_n144_));
  nand3  g082(.a(new_n93_), .b(new_n118_), .c(new_n144_), .O(new_n145_));
  aoi21  g083(.a(new_n145_), .b(x27), .c(x10), .O(new_n146_));
  nor2   g084(.a(new_n143_), .b(new_n78_), .O(new_n147_));
  ...
  nand4  g090(.a(new_n152_), .b(x40), .c(new_n150_), .d(new_n78_), .O(new_n153_));
  ...
  nand3  g097(.a(new_n128_), .b(new_n150_), .c(new_n78_), .O(new_n160_));
  ...
  nand4  g123(.a(new_n70_), .b(new_n185_), .c(x23), .d(x22), .O(new_n186_));
  nor2   g124(.a(new_n186_), .b(new_n184_), .O(z17));
  nand2  g125(.a(x27), .b(new_n78_), .O(new_n188_));
  nand2  g126(.a(new_n73_), .b(x08), .O(new_n189_));
  aoi21  g127(.a(new_n189_), .b(new_n188_), .c(new_n144_), .O(new_n190_));
  nand2  g128(.a(new_n127_), .b(new_n133_), .O(new_n191_));
  aoi21  g129(.a(new_n190_), .b(new_n84_), .c(new_n191_), .O(new_n192_));
  oai22  g130(.a(new_n192_), .b(new_n79_), .c(new_n113_), .d(new_n83_), .O(z18));
  nand2  g131(.a(new_n141_), .b(new_n70_), .O(z19));
  aoi21  g132(.a(x40), .b(new_n69_), .c(x08), .O(new_n195_));
  aoi21  g133(.a(x40), .b(x29), .c(new_n84_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n195_), .c(new_n73_), .O(new_n197_));
  nand2  g135(.a(new_n83_), .b(x39), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(x40), .O(new_n199_));
  nand2  g137(.a(new_n199_), .b(new_n144_), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(new_n197_), .O(new_n201_));
  nand3  g139(.a(new_n201_), .b(new_n127_), .c(new_n133_), .O(new_n202_));
  nand2  g140(.a(new_n202_), .b(new_n70_), .O(z20));
endmodule
