...
module FAU ( 
  ...
  aoi21  g040(.a(new_n64_), .b(new_n66_), .c(new_n83_), .O(new_n103_));
  ...
  oai22  g059(.a(new_n116_), .b(new_n120_), .c(x40), .d(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n85_), .c(new_n73_), .O(new_n123_));
  ...
  nor3   g065(.a(new_n127_), .b(new_n75_), .c(new_n63_), .O(new_n128_));
  ...
  aoi22  g074(.a(new_n136_), .b(x39), .c(new_n64_), .d(new_n66_), .O(new_n137_));
  ...
  oai21  g098(.a(x27), .b(new_n147_), .c(x39), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(x40), .O(new_n162_));
  oai21  g100(.a(new_n63_), .b(new_n73_), .c(x40), .O(new_n163_));
  oai21  g101(.a(new_n163_), .b(new_n127_), .c(new_n66_), .O(new_n164_));
  oai21  g102(.a(new_n163_), .b(x13), .c(new_n68_), .O(new_n165_));
  nand4  g103(.a(new_n141_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n166_));
  ...
  nand4  g107(.a(new_n148_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x40), .c(new_n147_), .d(new_n73_), .O(new_n171_));
  ...
  oai22  g121(.a(new_n84_), .b(x27), .c(new_n75_), .d(new_n183_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x08), .O(new_n185_));
  inv1   g123(.a(new_n84_), .O(new_n186_));
  nor2   g124(.a(new_n66_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n186_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n185_), .c(new_n64_), .d(new_n80_), .O(z18));
  inv1   g127(.a(new_n139_), .O(z19));
  oai21  g128(.a(new_n83_), .b(x27), .c(x35), .O(new_n191_));
