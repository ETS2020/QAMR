...
module FAU ( 
  ...
  nand2  g033(.a(new_n80_), .b(new_n84_), .O(new_n96_));
  ...
  oai21  g045(.a(x40), .b(new_n84_), .c(new_n85_), .O(new_n108_));
  ...
  oai21  g062(.a(new_n124_), .b(x04), .c(x40), .O(new_n125_));
  nand2  g063(.a(new_n125_), .b(x32), .O(new_n126_));
  ...
  nand3  g068(.a(z08), .b(x30), .c(x05), .O(new_n131_));
  ...
  aoi21  g075(.a(new_n137_), .b(new_n107_), .c(x08), .O(new_n138_));
  ...
  aoi22  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .d(new_n96_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(new_n83_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(x09), .c(new_n81_), .O(z11));
  ...
  nand3  g088(.a(new_n150_), .b(new_n80_), .c(new_n84_), .O(new_n151_));
  ...
  aoi21  g097(.a(new_n159_), .b(new_n156_), .c(new_n80_), .O(new_n160_));
  nand4  g098(.a(new_n72_), .b(new_n84_), .c(x20), .d(new_n158_), .O(new_n161_));
  ...
  nand4  g102(.a(new_n164_), .b(x39), .c(new_n153_), .d(new_n65_), .O(new_n165_));
  ...
  nand3  g107(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n170_));
  ...
  oai21  g111(.a(x30), .b(new_n85_), .c(x40), .O(new_n174_));
  nand2  g112(.a(new_n174_), .b(new_n66_), .O(new_n175_));
  nand2  g113(.a(new_n80_), .b(new_n85_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n175_), .c(x37), .O(new_n177_));
  oai21  g115(.a(new_n177_), .b(new_n173_), .c(new_n84_), .O(new_n178_));
  nand3  g116(.a(new_n170_), .b(new_n150_), .c(x40), .O(new_n179_));
  ...
  oai22  g127(.a(new_n86_), .b(x27), .c(new_n75_), .d(new_n189_), .O(new_n190_));
