...
module FAU ( 
  ...
  nand2  g039(.a(new_n101_), .b(new_n75_), .O(new_n102_));
  inv1   g040(.a(x28), .O(new_n103_));
  oai21  g041(.a(new_n103_), .b(new_n73_), .c(x39), .O(new_n104_));
  oai21  g042(.a(x27), .b(x08), .c(x35), .O(new_n105_));
  aoi22  g043(.a(new_n105_), .b(x04), .c(new_n104_), .d(x40), .O(new_n106_));
  nand3  g044(.a(new_n106_), .b(new_n102_), .c(new_n93_), .O(z02));
  nand2  g045(.a(new_n68_), .b(x27), .O(new_n108_));
  aoi22  g046(.a(x40), .b(new_n63_), .c(new_n67_), .d(new_n66_), .O(new_n109_));
  ...
  oai21  g068(.a(x37), .b(x28), .c(x39), .O(new_n131_));
  aoi21  g069(.a(x28), .b(x04), .c(new_n131_), .O(new_n132_));
  aoi21  g070(.a(new_n132_), .b(new_n130_), .c(new_n75_), .O(z08));
  ...
  oai21  g075(.a(x40), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g096(.a(new_n63_), .b(new_n73_), .c(x40), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n66_), .O(new_n160_));
  oai21  g098(.a(new_n63_), .b(new_n73_), .c(x40), .O(new_n161_));
  ...
  oai21  g109(.a(new_n171_), .b(new_n169_), .c(x39), .O(new_n172_));
  aoi21  g110(.a(new_n68_), .b(new_n67_), .c(x40), .O(new_n173_));
  ...
  nand3  g119(.a(x39), .b(new_n84_), .c(new_n82_), .O(new_n182_));
