...
module FAU ( 
  ...
  aoi22  g029(.a(new_n91_), .b(x04), .c(new_n89_), .d(new_n88_), .O(new_n92_));
  inv1   g030(.a(x28), .O(new_n93_));
  nand2  g031(.a(new_n93_), .b(x27), .O(new_n94_));
  nand2  g032(.a(new_n67_), .b(x28), .O(new_n95_));
  oai21  g033(.a(new_n95_), .b(new_n94_), .c(new_n75_), .O(new_n96_));
  oai21  g034(.a(new_n92_), .b(new_n63_), .c(new_n96_), .O(z02));
  ...
  nor2   g041(.a(new_n93_), .b(new_n66_), .O(new_n104_));
  ...
  oai22  g062(.a(new_n118_), .b(new_n123_), .c(x40), .d(new_n124_), .O(new_n125_));
  ...
  oai21  g072(.a(new_n63_), .b(x29), .c(x40), .O(new_n135_));
  nand2  g073(.a(x27), .b(x04), .O(new_n136_));
  nand3  g074(.a(new_n136_), .b(x35), .c(new_n93_), .O(new_n137_));
  nand2  g075(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand3  g076(.a(x35), .b(new_n93_), .c(new_n73_), .O(new_n139_));
  aoi22  g077(.a(new_n139_), .b(x39), .c(new_n64_), .d(new_n66_), .O(new_n140_));
  ...
  nand4  g095(.a(new_n155_), .b(new_n75_), .c(x20), .d(new_n154_), .O(new_n158_));
  nor2   g096(.a(new_n158_), .b(x18), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n157_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n131_), .b(new_n149_), .c(new_n73_), .O(new_n161_));
  ...
  oai21  g103(.a(new_n163_), .b(new_n75_), .c(new_n165_), .O(new_n166_));
  ...
  oai21  g107(.a(new_n169_), .b(new_n93_), .c(x27), .O(new_n170_));
  nand4  g108(.a(new_n170_), .b(x39), .c(new_n81_), .d(new_n80_), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n166_), .O(z14));
  inv1   g110(.a(x12), .O(new_n173_));
  nor2   g111(.a(new_n121_), .b(new_n173_), .O(z15));
  ...
  nand2  g118(.a(x27), .b(new_n73_), .O(new_n181_));
  nand2  g119(.a(new_n66_), .b(x08), .O(new_n182_));
  aoi21  g120(.a(new_n182_), .b(new_n181_), .c(new_n82_), .O(new_n183_));
  nand2  g121(.a(new_n80_), .b(new_n134_), .O(new_n184_));
  aoi21  g122(.a(new_n183_), .b(new_n93_), .c(new_n184_), .O(new_n185_));
  oai22  g123(.a(new_n185_), .b(new_n99_), .c(new_n118_), .d(new_n89_), .O(z18));
  nand2  g124(.a(new_n142_), .b(new_n64_), .O(z19));
  oai21  g125(.a(new_n93_), .b(x27), .c(x35), .O(new_n188_));
  and2   g126(.a(new_n188_), .b(new_n135_), .O(new_n189_));
  nand2  g127(.a(new_n64_), .b(new_n66_), .O(new_n190_));
  nand2  g128(.a(x39), .b(new_n82_), .O(new_n191_));
  aoi21  g129(.a(new_n191_), .b(new_n190_), .c(x08), .O(new_n192_));
  oai21  g130(.a(new_n192_), .b(new_n189_), .c(new_n80_), .O(new_n193_));
