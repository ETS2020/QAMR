...
module FAU ( 
  ...
  nor2   g020(.a(new_n68_), .b(x28), .O(new_n83_));
  or2    g021(.a(new_n83_), .b(x36), .O(new_n84_));
  ...
  aoi21  g031(.a(new_n93_), .b(new_n83_), .c(new_n74_), .O(new_n94_));
  oai21  g032(.a(new_n94_), .b(new_n90_), .c(x40), .O(new_n95_));
  inv1   g033(.a(x09), .O(new_n96_));
  oai21  g034(.a(new_n92_), .b(new_n74_), .c(new_n67_), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(new_n81_), .c(new_n96_), .O(new_n98_));
  nor2   g036(.a(x09), .b(new_n74_), .O(new_n99_));
  nor2   g037(.a(x37), .b(x28), .O(new_n100_));
  aoi21  g038(.a(x37), .b(new_n92_), .c(new_n100_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n99_), .c(new_n98_), .d(new_n81_), .O(new_n102_));
  nand2  g040(.a(new_n102_), .b(new_n63_), .O(new_n103_));
  nand2  g041(.a(new_n103_), .b(new_n95_), .O(z02));
  oai21  g042(.a(new_n69_), .b(x28), .c(x35), .O(new_n105_));
  nand2  g043(.a(new_n105_), .b(x27), .O(new_n106_));
  aoi22  g044(.a(new_n76_), .b(x39), .c(x28), .d(x27), .O(new_n107_));
  nand2  g045(.a(new_n107_), .b(new_n69_), .O(new_n108_));
  nand4  g046(.a(new_n108_), .b(new_n106_), .c(new_n65_), .d(x21), .O(z03));
  nor2   g047(.a(new_n64_), .b(x21), .O(new_n110_));
  nand3  g048(.a(new_n110_), .b(new_n108_), .c(new_n106_), .O(z04));
  oai21  g049(.a(x37), .b(x28), .c(x27), .O(new_n112_));
  nor2   g050(.a(new_n76_), .b(new_n63_), .O(new_n113_));
  nor2   g051(.a(x39), .b(x27), .O(new_n114_));
  ...
  nand3  g066(.a(new_n88_), .b(new_n81_), .c(x28), .O(new_n129_));
  nand3  g067(.a(new_n69_), .b(new_n81_), .c(x28), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(new_n131_));
  nand4  g069(.a(new_n131_), .b(new_n129_), .c(new_n88_), .d(new_n96_), .O(new_n132_));
  ...
  nand2  g075(.a(x39), .b(x05), .O(new_n138_));
  oai21  g076(.a(x39), .b(new_n137_), .c(new_n138_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n84_), .c(x27), .O(new_n140_));
  nand2  g078(.a(new_n82_), .b(new_n81_), .O(new_n141_));
  nand3  g079(.a(new_n141_), .b(x39), .c(x05), .O(new_n142_));
  ...
  aoi21  g084(.a(x39), .b(x29), .c(new_n92_), .O(new_n147_));
  ...
  nand2  g088(.a(x39), .b(x28), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x35), .c(new_n76_), .O(new_n152_));
  oai21  g090(.a(new_n152_), .b(new_n150_), .c(new_n91_), .O(new_n153_));
  oai21  g091(.a(new_n76_), .b(x29), .c(x39), .O(new_n154_));
  inv1   g092(.a(x29), .O(new_n155_));
  aoi21  g093(.a(x40), .b(new_n155_), .c(new_n63_), .O(new_n156_));
  ...
  nand3  g097(.a(new_n159_), .b(new_n81_), .c(new_n96_), .O(new_n160_));
  nand2  g098(.a(new_n160_), .b(new_n65_), .O(z11));
  nor3   g099(.a(x37), .b(x36), .c(x35), .O(new_n162_));
  oai21  g100(.a(new_n162_), .b(new_n92_), .c(new_n75_), .O(new_n163_));
  nand2  g101(.a(x40), .b(x04), .O(new_n164_));
  aoi22  g102(.a(new_n164_), .b(x39), .c(x35), .d(x28), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n114_), .c(new_n69_), .O(new_n166_));
  oai21  g104(.a(x39), .b(new_n69_), .c(new_n164_), .O(new_n167_));
  aoi21  g105(.a(new_n167_), .b(new_n92_), .c(new_n64_), .O(new_n168_));
  ...
  nand4  g110(.a(new_n172_), .b(x39), .c(new_n170_), .d(new_n74_), .O(new_n173_));
  inv1   g111(.a(x18), .O(new_n174_));
  inv1   g112(.a(x19), .O(new_n175_));
  nand4  g113(.a(new_n70_), .b(x20), .c(new_n175_), .d(new_n174_), .O(new_n176_));
  aoi21  g114(.a(new_n176_), .b(new_n173_), .c(new_n92_), .O(new_n177_));
  ...
  oai21  g143(.a(x27), .b(new_n91_), .c(new_n205_), .O(new_n206_));
  nand4  g144(.a(new_n206_), .b(new_n65_), .c(x35), .d(new_n67_), .O(new_n207_));
  nand2  g145(.a(new_n76_), .b(x39), .O(new_n208_));
  nand2  g146(.a(new_n81_), .b(new_n96_), .O(new_n209_));
  aoi22  g147(.a(new_n209_), .b(new_n208_), .c(new_n113_), .d(new_n89_), .O(new_n210_));
  nand2  g148(.a(new_n210_), .b(new_n207_), .O(z18));
  aoi21  g149(.a(x28), .b(new_n92_), .c(new_n68_), .O(new_n212_));
  nor2   g150(.a(new_n212_), .b(new_n156_), .O(new_n213_));
  inv1   g151(.a(new_n150_), .O(new_n214_));
  nand2  g152(.a(x40), .b(new_n68_), .O(new_n215_));
  aoi21  g153(.a(new_n215_), .b(new_n214_), .c(x08), .O(new_n216_));
  oai21  g154(.a(new_n216_), .b(new_n213_), .c(new_n81_), .O(new_n217_));
