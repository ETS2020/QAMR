...
module FAU ( 
  ...
  aoi21  g023(.a(x39), .b(x28), .c(new_n85_), .O(new_n86_));
  ...
  aoi22  g034(.a(new_n69_), .b(x39), .c(new_n90_), .d(new_n96_), .O(new_n97_));
  ...
  nand2  g055(.a(new_n117_), .b(x40), .O(new_n118_));
  ...
  nor2   g069(.a(new_n131_), .b(new_n73_), .O(new_n132_));
  ...
  aoi21  g074(.a(x40), .b(new_n136_), .c(new_n73_), .O(new_n137_));
  ...
  oai21  g088(.a(new_n146_), .b(x39), .c(new_n150_), .O(z12));
  ...
  nand4  g110(.a(new_n172_), .b(x40), .c(new_n76_), .d(new_n75_), .O(new_n173_));
  ...
  nand2  g129(.a(x40), .b(new_n85_), .O(new_n192_));
