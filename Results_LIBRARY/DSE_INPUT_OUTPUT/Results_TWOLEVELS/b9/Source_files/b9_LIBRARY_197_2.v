...
module FAU ( 
  ...
  nand2  g018(.a(new_n80_), .b(x30), .O(new_n81_));
  ...
  oai21  g034(.a(x40), .b(x30), .c(new_n96_), .O(z02));
  ...
  oai22  g043(.a(x40), .b(new_n84_), .c(new_n86_), .d(new_n64_), .O(new_n106_));
  ...
  oai21  g059(.a(new_n121_), .b(x04), .c(x40), .O(new_n122_));
  ...
  nand3  g065(.a(z08), .b(x32), .c(x05), .O(new_n128_));
  ...
  nand3  g085(.a(new_n147_), .b(new_n80_), .c(new_n84_), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(new_n146_), .O(z12));
  inv1   g087(.a(x13), .O(new_n150_));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  aoi21  g089(.a(new_n151_), .b(x28), .c(new_n80_), .O(new_n152_));
  ...
  nand2  g096(.a(x40), .b(x32), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(new_n84_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n150_), .d(new_n65_), .O(new_n161_));
  nand3  g099(.a(new_n161_), .b(new_n158_), .c(new_n81_), .O(z13));
  nand3  g100(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n163_));
  nand3  g101(.a(new_n151_), .b(new_n85_), .c(x28), .O(new_n164_));
  ...
  nand2  g106(.a(new_n159_), .b(new_n64_), .O(new_n169_));
  oai21  g107(.a(x32), .b(new_n86_), .c(x40), .O(new_n170_));
  nor2   g108(.a(x40), .b(x28), .O(new_n171_));
  aoi21  g109(.a(new_n170_), .b(new_n66_), .c(new_n171_), .O(new_n172_));
  oai21  g110(.a(new_n172_), .b(x37), .c(new_n169_), .O(new_n173_));
  nand2  g111(.a(new_n173_), .b(new_n84_), .O(new_n174_));
  nand3  g112(.a(new_n166_), .b(new_n147_), .c(x40), .O(new_n175_));
  ...
  nand4  g123(.a(x35), .b(new_n84_), .c(new_n86_), .d(new_n64_), .O(new_n186_));
  nand2  g124(.a(new_n186_), .b(new_n134_), .O(new_n187_));
  nand2  g125(.a(new_n187_), .b(x08), .O(new_n188_));
  nand2  g126(.a(new_n138_), .b(new_n133_), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n84_), .O(new_n190_));
  ...
  oai21  g132(.a(new_n66_), .b(new_n64_), .c(new_n137_), .O(new_n195_));
  aoi21  g133(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n196_));
  oai21  g134(.a(new_n196_), .b(new_n194_), .c(new_n195_), .O(new_n197_));
  nand3  g135(.a(new_n197_), .b(new_n84_), .c(new_n133_), .O(new_n198_));
