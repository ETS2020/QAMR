...
module FAU ( 
  ...
  nand2  g036(.a(new_n76_), .b(x32), .O(new_n99_));
  ...
  nor2   g082(.a(x40), .b(new_n85_), .O(new_n145_));
  aoi21  g083(.a(x39), .b(x29), .c(new_n76_), .O(new_n146_));
  nor2   g084(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g085(.a(x27), .b(x04), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n144_), .c(new_n147_), .O(new_n149_));
  oai21  g087(.a(new_n149_), .b(new_n143_), .c(new_n84_), .O(new_n150_));
  ...
  nand3  g094(.a(new_n156_), .b(new_n76_), .c(x32), .O(new_n157_));
  ...
  oai21  g109(.a(new_n75_), .b(x04), .c(x40), .O(new_n172_));
  nor2   g110(.a(new_n145_), .b(x13), .O(new_n173_));
  aoi21  g111(.a(new_n173_), .b(new_n172_), .c(new_n171_), .O(new_n174_));
  nand4  g112(.a(new_n66_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n175_));
  inv1   g113(.a(new_n175_), .O(new_n176_));
  oai21  g114(.a(new_n176_), .b(new_n174_), .c(new_n70_), .O(new_n177_));
  nand3  g115(.a(x20), .b(new_n164_), .c(new_n163_), .O(new_n178_));
  nand4  g116(.a(new_n160_), .b(new_n85_), .c(new_n84_), .d(x28), .O(new_n179_));
  inv1   g117(.a(new_n179_), .O(new_n180_));
  nand4  g118(.a(x40), .b(x39), .c(new_n159_), .d(new_n65_), .O(new_n181_));
  oai21  g119(.a(new_n181_), .b(new_n180_), .c(new_n178_), .O(new_n182_));
  oai21  g120(.a(x30), .b(x27), .c(x40), .O(new_n183_));
  nand3  g121(.a(x39), .b(new_n159_), .c(new_n65_), .O(new_n184_));
  nand2  g122(.a(new_n184_), .b(x40), .O(new_n185_));
  nand2  g123(.a(new_n185_), .b(new_n99_), .O(new_n186_));
  aoi22  g124(.a(new_n186_), .b(new_n64_), .c(new_n183_), .d(new_n85_), .O(new_n187_));
  nand3  g125(.a(new_n187_), .b(new_n182_), .c(new_n177_), .O(z14));
  nand4  g126(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n189_));
  nand2  g127(.a(new_n189_), .b(new_n82_), .O(z15));
  ...
  nand2  g139(.a(new_n84_), .b(new_n201_), .O(new_n202_));
  aoi21  g140(.a(new_n200_), .b(new_n86_), .c(new_n202_), .O(new_n203_));
  oai22  g141(.a(new_n203_), .b(new_n81_), .c(new_n93_), .d(new_n122_), .O(z18));
  aoi21  g142(.a(x28), .b(new_n64_), .c(new_n66_), .O(new_n205_));
  nor2   g143(.a(new_n205_), .b(new_n147_), .O(new_n206_));
  nand2  g144(.a(x40), .b(new_n66_), .O(new_n207_));
  aoi21  g145(.a(new_n207_), .b(new_n141_), .c(x08), .O(new_n208_));
  oai21  g146(.a(new_n208_), .b(new_n206_), .c(new_n84_), .O(new_n209_));
