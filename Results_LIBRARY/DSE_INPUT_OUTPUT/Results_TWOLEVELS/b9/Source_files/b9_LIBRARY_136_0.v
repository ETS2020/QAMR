...
module FAU ( 
  ...
  aoi21  g034(.a(new_n70_), .b(new_n69_), .c(new_n96_), .O(new_n97_));
  aoi21  g035(.a(new_n97_), .b(new_n95_), .c(new_n66_), .O(z03));
  nand2  g036(.a(new_n70_), .b(new_n69_), .O(new_n99_));
  nand4  g037(.a(new_n99_), .b(new_n95_), .c(new_n65_), .d(new_n96_), .O(z04));
  aoi21  g038(.a(x28), .b(x27), .c(x37), .O(new_n101_));
  nor2   g039(.a(new_n101_), .b(new_n66_), .O(z05));
  nand2  g040(.a(new_n65_), .b(new_n69_), .O(new_n103_));
  oai21  g041(.a(x40), .b(x31), .c(new_n83_), .O(new_n104_));
  aoi21  g042(.a(new_n104_), .b(new_n103_), .c(x37), .O(z06));
  ...
  nand4  g047(.a(new_n109_), .b(new_n107_), .c(new_n106_), .d(new_n63_), .O(new_n110_));
  ...
  nand2  g060(.a(new_n64_), .b(x31), .O(new_n123_));
  nand2  g061(.a(x40), .b(new_n117_), .O(new_n124_));
  ...
  oai21  g075(.a(new_n84_), .b(x04), .c(x40), .O(new_n138_));
  aoi21  g076(.a(new_n138_), .b(new_n103_), .c(x08), .O(new_n139_));
  inv1   g077(.a(new_n84_), .O(new_n140_));
  nand2  g078(.a(x39), .b(x29), .O(new_n141_));
  nand2  g079(.a(new_n141_), .b(x40), .O(new_n142_));
  nand2  g080(.a(x27), .b(x04), .O(new_n143_));
  aoi22  g081(.a(new_n143_), .b(new_n140_), .c(new_n142_), .d(new_n123_), .O(new_n144_));
  oai21  g082(.a(new_n144_), .b(new_n139_), .c(new_n80_), .O(new_n145_));
  nor2   g083(.a(new_n145_), .b(x09), .O(z11));
  inv1   g084(.a(x35), .O(new_n147_));
  nand3  g085(.a(new_n70_), .b(new_n82_), .c(new_n147_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(x27), .c(x10), .O(new_n149_));
  aoi21  g087(.a(x39), .b(new_n74_), .c(new_n72_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x40), .O(new_n151_));
  nor2   g089(.a(new_n72_), .b(x40), .O(new_n152_));
  nand2  g090(.a(new_n152_), .b(x31), .O(new_n153_));
  ...
  nand2  g098(.a(new_n71_), .b(new_n70_), .O(new_n161_));
  ...
  aoi21  g103(.a(new_n165_), .b(new_n74_), .c(new_n66_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(z13));
  inv1   g105(.a(new_n123_), .O(new_n168_));
  ...
  nand3  g112(.a(new_n70_), .b(new_n147_), .c(x28), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x27), .O(new_n176_));
  nand3  g114(.a(new_n176_), .b(new_n81_), .c(new_n80_), .O(new_n177_));
  oai21  g115(.a(new_n172_), .b(new_n72_), .c(new_n177_), .O(new_n178_));
  nand2  g116(.a(new_n178_), .b(x40), .O(new_n179_));
  nand3  g117(.a(new_n179_), .b(new_n174_), .c(new_n153_), .O(z14));
  inv1   g118(.a(x12), .O(new_n181_));
  nor2   g119(.a(new_n120_), .b(new_n181_), .O(z15));
  ...
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n147_), .O(new_n193_));
  ...
  oai22  g134(.a(new_n196_), .b(new_n66_), .c(new_n190_), .d(new_n90_), .O(z18));
  oai22  g135(.a(new_n64_), .b(x35), .c(new_n83_), .d(x27), .O(new_n198_));
  nand2  g136(.a(new_n198_), .b(new_n141_), .O(new_n199_));
  oai22  g137(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n200_));
  nand2  g138(.a(new_n200_), .b(x31), .O(new_n201_));
  nand2  g139(.a(x35), .b(x27), .O(new_n202_));
  nand3  g140(.a(new_n202_), .b(x40), .c(new_n92_), .O(new_n203_));
  nand3  g141(.a(new_n64_), .b(x28), .c(new_n69_), .O(new_n204_));
  nand4  g142(.a(new_n204_), .b(new_n203_), .c(new_n201_), .d(new_n199_), .O(new_n205_));
  nand3  g143(.a(new_n205_), .b(new_n80_), .c(new_n194_), .O(new_n206_));
  nand2  g144(.a(new_n206_), .b(new_n65_), .O(z20));
