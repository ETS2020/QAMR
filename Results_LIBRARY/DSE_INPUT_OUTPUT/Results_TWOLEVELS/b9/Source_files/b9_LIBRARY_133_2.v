...
module FAU ( 
  ...
  oai21  g026(.a(x08), .b(new_n88_), .c(x39), .O(new_n89_));
  ...
  nand3  g054(.a(new_n116_), .b(new_n71_), .c(x03), .O(new_n117_));
  ...
  nand2  g063(.a(new_n76_), .b(new_n75_), .O(new_n126_));
  ...
  oai21  g070(.a(new_n70_), .b(x29), .c(x39), .O(new_n133_));
  nand2  g071(.a(x27), .b(x04), .O(new_n134_));
  nand3  g072(.a(new_n134_), .b(x35), .c(new_n78_), .O(new_n135_));
  nand2  g073(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand3  g074(.a(x35), .b(new_n78_), .c(new_n88_), .O(new_n137_));
  aoi22  g075(.a(new_n137_), .b(x40), .c(new_n71_), .d(new_n87_), .O(new_n138_));
  oai21  g076(.a(new_n138_), .b(x08), .c(new_n136_), .O(new_n139_));
  nand3  g077(.a(new_n139_), .b(new_n75_), .c(new_n132_), .O(new_n140_));
  inv1   g078(.a(new_n140_), .O(z11));
  nor3   g079(.a(x37), .b(x36), .c(x35), .O(new_n142_));
  nor2   g080(.a(new_n70_), .b(x27), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(new_n66_), .O(new_n144_));
  oai21  g082(.a(new_n70_), .b(new_n88_), .c(x39), .O(new_n145_));
  oai21  g083(.a(new_n64_), .b(new_n87_), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n144_), .c(new_n71_), .O(z12));
  inv1   g085(.a(x13), .O(new_n148_));
  nand2  g086(.a(x36), .b(x35), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(x28), .O(new_n150_));
  nand4  g088(.a(new_n150_), .b(x39), .c(new_n148_), .d(new_n88_), .O(new_n151_));
  inv1   g089(.a(x18), .O(new_n152_));
  inv1   g090(.a(x19), .O(new_n153_));
  nand2  g091(.a(new_n95_), .b(new_n98_), .O(new_n154_));
  nand4  g092(.a(new_n154_), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n155_));
  aoi21  g093(.a(new_n155_), .b(new_n151_), .c(new_n70_), .O(new_n156_));
  nand4  g094(.a(new_n154_), .b(new_n67_), .c(x20), .d(new_n153_), .O(new_n157_));
  nor2   g095(.a(new_n157_), .b(x18), .O(new_n158_));
  oai21  g096(.a(new_n158_), .b(new_n156_), .c(x27), .O(new_n159_));
  aoi21  g097(.a(new_n76_), .b(new_n75_), .c(new_n70_), .O(new_n160_));
  nand4  g098(.a(new_n160_), .b(x39), .c(new_n148_), .d(new_n88_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n159_), .O(z13));
  aoi21  g100(.a(new_n148_), .b(new_n88_), .c(new_n70_), .O(new_n163_));
  nand4  g101(.a(x27), .b(x20), .c(new_n153_), .d(new_n152_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n64_), .c(new_n163_), .d(new_n67_), .O(new_n165_));
  ...
  oai21  g106(.a(new_n168_), .b(new_n78_), .c(x27), .O(new_n169_));
  nand4  g107(.a(new_n169_), .b(x40), .c(new_n76_), .d(new_n75_), .O(new_n170_));
  nand2  g108(.a(new_n170_), .b(new_n165_), .O(z14));
  nand4  g109(.a(x34), .b(x27), .c(x26), .d(x12), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n71_), .O(z15));
  inv1   g111(.a(x23), .O(new_n174_));
  nand3  g112(.a(new_n174_), .b(x22), .c(x01), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(new_n71_), .O(z16));
  inv1   g114(.a(x01), .O(new_n177_));
  inv1   g115(.a(x24), .O(new_n178_));
  nand4  g116(.a(new_n71_), .b(new_n178_), .c(x23), .d(x22), .O(new_n179_));
  nor2   g117(.a(new_n179_), .b(new_n177_), .O(z17));
  nand2  g118(.a(x39), .b(x29), .O(new_n181_));
  oai21  g119(.a(new_n79_), .b(x27), .c(new_n181_), .O(new_n182_));
  nand2  g120(.a(new_n182_), .b(x08), .O(new_n183_));
  inv1   g121(.a(new_n79_), .O(new_n184_));
  nor2   g122(.a(new_n87_), .b(x04), .O(new_n185_));
  aoi21  g123(.a(new_n185_), .b(new_n184_), .c(x09), .O(new_n186_));
  nand4  g124(.a(new_n186_), .b(new_n183_), .c(new_n71_), .d(new_n75_), .O(z18));
  nand2  g125(.a(new_n140_), .b(new_n71_), .O(z19));
  inv1   g126(.a(x08), .O(new_n189_));
  aoi22  g127(.a(new_n181_), .b(x28), .c(new_n71_), .d(new_n189_), .O(new_n190_));
  inv1   g128(.a(x35), .O(new_n191_));
  nand2  g129(.a(new_n85_), .b(x40), .O(new_n192_));
  nand2  g130(.a(new_n192_), .b(x39), .O(new_n193_));
  nand2  g131(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  oai21  g132(.a(new_n190_), .b(x27), .c(new_n194_), .O(new_n195_));
  nand3  g133(.a(new_n195_), .b(new_n75_), .c(new_n132_), .O(new_n196_));
  nand2  g134(.a(new_n196_), .b(new_n71_), .O(z20));
  buf    g135(.a(x39), .O(z08));
endmodule
