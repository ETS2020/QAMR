...
module FAU ( 
  ...
  aoi21  g033(.a(new_n70_), .b(new_n69_), .c(new_n95_), .O(new_n96_));
  aoi21  g034(.a(new_n96_), .b(new_n94_), .c(new_n66_), .O(z03));
  aoi21  g035(.a(new_n70_), .b(new_n69_), .c(x21), .O(new_n98_));
  aoi21  g036(.a(new_n98_), .b(new_n94_), .c(new_n66_), .O(z04));
  nand2  g037(.a(x28), .b(x27), .O(new_n100_));
  aoi21  g038(.a(new_n100_), .b(new_n70_), .c(new_n66_), .O(z05));
  nand3  g039(.a(new_n100_), .b(new_n65_), .c(new_n70_), .O(new_n102_));
  ...
  oai21  g053(.a(new_n64_), .b(new_n115_), .c(new_n65_), .O(z08));
  nand4  g054(.a(x34), .b(x27), .c(x26), .d(x11), .O(new_n117_));
  nand2  g055(.a(new_n117_), .b(new_n65_), .O(z09));
  inv1   g056(.a(x07), .O(new_n119_));
  nand2  g057(.a(x40), .b(new_n115_), .O(new_n120_));
  nand2  g058(.a(new_n64_), .b(x13), .O(new_n121_));
  ...
  nor3   g067(.a(new_n129_), .b(new_n64_), .c(new_n115_), .O(new_n130_));
  ...
  aoi22  g071(.a(new_n133_), .b(x40), .c(new_n65_), .d(new_n69_), .O(new_n134_));
  nor2   g072(.a(new_n134_), .b(x08), .O(new_n135_));
  ...
  aoi22  g077(.a(new_n139_), .b(new_n136_), .c(new_n138_), .d(new_n121_), .O(new_n140_));
  oai21  g078(.a(new_n140_), .b(new_n135_), .c(new_n80_), .O(new_n141_));
  oai21  g079(.a(new_n141_), .b(x09), .c(new_n65_), .O(z11));
  inv1   g080(.a(x35), .O(new_n143_));
  nand3  g081(.a(new_n70_), .b(new_n82_), .c(new_n143_), .O(new_n144_));
  ...
  nor2   g085(.a(new_n72_), .b(x40), .O(new_n148_));
  nand2  g086(.a(new_n148_), .b(x13), .O(new_n149_));
  nand2  g087(.a(new_n149_), .b(new_n147_), .O(z12));
  nand2  g088(.a(x36), .b(x35), .O(new_n151_));
  nand2  g089(.a(new_n151_), .b(x28), .O(new_n152_));
  nand4  g090(.a(new_n152_), .b(x39), .c(new_n63_), .d(new_n74_), .O(new_n153_));
  inv1   g091(.a(x18), .O(new_n154_));
  inv1   g092(.a(x19), .O(new_n155_));
  nand2  g093(.a(new_n71_), .b(new_n70_), .O(new_n156_));
  nand4  g094(.a(new_n156_), .b(x20), .c(new_n155_), .d(new_n154_), .O(new_n157_));
  aoi21  g095(.a(new_n157_), .b(new_n153_), .c(new_n64_), .O(new_n158_));
  nor2   g096(.a(new_n157_), .b(new_n63_), .O(new_n159_));
  oai21  g097(.a(new_n159_), .b(new_n158_), .c(x27), .O(new_n160_));
  nand3  g098(.a(new_n130_), .b(new_n63_), .c(new_n74_), .O(new_n161_));
  nand2  g099(.a(new_n161_), .b(new_n160_), .O(z13));
  nor2   g100(.a(new_n72_), .b(new_n64_), .O(new_n163_));
  nand3  g101(.a(x20), .b(new_n155_), .c(new_n154_), .O(new_n164_));
  oai22  g102(.a(new_n164_), .b(new_n163_), .c(new_n115_), .d(x04), .O(new_n165_));
  oai21  g103(.a(new_n129_), .b(x13), .c(new_n69_), .O(new_n166_));
  nand4  g104(.a(new_n151_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n167_));
  nand2  g105(.a(new_n167_), .b(new_n63_), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(new_n164_), .O(new_n169_));
  nand2  g107(.a(new_n71_), .b(x13), .O(new_n170_));
  nand4  g108(.a(new_n143_), .b(new_n81_), .c(new_n80_), .d(x28), .O(new_n171_));
  nand2  g109(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n70_), .c(new_n66_), .O(new_n173_));
  nand4  g111(.a(new_n173_), .b(new_n169_), .c(new_n166_), .d(new_n165_), .O(z14));
  ...
  nor2   g124(.a(new_n69_), .b(x04), .O(new_n187_));
  aoi21  g125(.a(new_n187_), .b(new_n136_), .c(x09), .O(new_n188_));
  nand4  g126(.a(new_n188_), .b(new_n186_), .c(new_n65_), .d(new_n80_), .O(z18));
  nor2   g127(.a(new_n141_), .b(x09), .O(z19));
  oai22  g128(.a(x40), .b(x35), .c(x27), .d(x08), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x13), .O(new_n192_));
  ...
  nand3  g133(.a(new_n184_), .b(x28), .c(new_n69_), .O(new_n196_));
  nand3  g134(.a(new_n196_), .b(new_n195_), .c(new_n192_), .O(new_n197_));
  nand2  g135(.a(new_n197_), .b(new_n80_), .O(new_n198_));
