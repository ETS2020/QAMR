...
module FAU ( 
  ...
  oai21  g029(.a(new_n91_), .b(new_n89_), .c(new_n72_), .O(new_n92_));
  oai21  g030(.a(new_n92_), .b(new_n88_), .c(x40), .O(new_n93_));
  oai21  g031(.a(x08), .b(new_n89_), .c(x40), .O(new_n94_));
  nand2  g032(.a(new_n94_), .b(new_n67_), .O(new_n95_));
  inv1   g033(.a(x39), .O(new_n96_));
  nand3  g034(.a(new_n68_), .b(x28), .c(new_n67_), .O(new_n97_));
  ...
  nand3  g038(.a(new_n63_), .b(new_n68_), .c(new_n67_), .O(new_n101_));
  nand4  g039(.a(new_n101_), .b(new_n100_), .c(new_n63_), .d(x21), .O(z03));
  inv1   g040(.a(x21), .O(new_n103_));
  nand4  g041(.a(new_n101_), .b(new_n100_), .c(new_n63_), .d(new_n103_), .O(z04));
  nand2  g042(.a(x28), .b(x27), .O(new_n105_));
  aoi21  g043(.a(new_n105_), .b(new_n68_), .c(new_n64_), .O(z05));
  nand3  g044(.a(new_n105_), .b(new_n63_), .c(new_n68_), .O(new_n107_));
  ...
  aoi22  g051(.a(new_n113_), .b(x38), .c(x17), .d(new_n65_), .O(new_n114_));
  nand4  g052(.a(new_n114_), .b(new_n74_), .c(new_n111_), .d(new_n110_), .O(new_n115_));
  nand2  g053(.a(x38), .b(new_n112_), .O(new_n116_));
  oai21  g054(.a(new_n116_), .b(x00), .c(new_n72_), .O(new_n117_));
  aoi21  g055(.a(new_n117_), .b(new_n115_), .c(new_n109_), .O(z07));
  aoi21  g056(.a(new_n96_), .b(new_n72_), .c(new_n74_), .O(z08));
  ...
  nor2   g072(.a(new_n67_), .b(new_n89_), .O(new_n135_));
  oai21  g073(.a(new_n135_), .b(new_n83_), .c(new_n134_), .O(new_n136_));
  inv1   g074(.a(x08), .O(new_n137_));
  nand3  g075(.a(new_n91_), .b(x27), .c(new_n89_), .O(new_n138_));
  ...
  nand3  g080(.a(new_n68_), .b(new_n81_), .c(new_n90_), .O(new_n143_));
  nand2  g081(.a(x40), .b(new_n67_), .O(new_n144_));
  aoi21  g082(.a(new_n144_), .b(new_n143_), .c(x10), .O(new_n145_));
  aoi21  g083(.a(x39), .b(new_n89_), .c(new_n70_), .O(new_n146_));
  ...
  nand4  g097(.a(new_n127_), .b(x39), .c(new_n150_), .d(new_n89_), .O(new_n160_));
  ...
  oai21  g128(.a(new_n83_), .b(x27), .c(new_n134_), .O(new_n191_));
  nand2  g129(.a(new_n191_), .b(x08), .O(new_n192_));
  nor2   g130(.a(new_n64_), .b(x09), .O(new_n193_));
  nand4  g131(.a(new_n193_), .b(new_n192_), .c(new_n138_), .d(new_n79_), .O(z18));
  inv1   g132(.a(new_n134_), .O(new_n195_));
  oai21  g133(.a(new_n90_), .b(new_n67_), .c(new_n137_), .O(new_n196_));
  aoi21  g134(.a(x28), .b(new_n67_), .c(new_n90_), .O(new_n197_));
  ...
  nand2  g138(.a(new_n141_), .b(new_n63_), .O(z19));
endmodule
