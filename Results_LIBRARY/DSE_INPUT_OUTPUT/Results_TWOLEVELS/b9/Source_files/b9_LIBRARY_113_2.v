...
module FAU ( 
  ...
  nand2  g001(.a(new_n63_), .b(x23), .O(new_n64_));
  ...
  nand2  g057(.a(new_n95_), .b(new_n64_), .O(z08));
  ...
  nand3  g073(.a(new_n135_), .b(x05), .c(new_n73_), .O(new_n136_));
  ...
  inv1   g079(.a(new_n126_), .O(new_n142_));
  oai21  g080(.a(new_n125_), .b(new_n89_), .c(x40), .O(new_n143_));
  nand2  g081(.a(x27), .b(x04), .O(new_n144_));
  aoi22  g082(.a(new_n144_), .b(new_n141_), .c(new_n143_), .d(new_n142_), .O(new_n145_));
  oai21  g083(.a(new_n145_), .b(new_n140_), .c(new_n79_), .O(new_n146_));
  oai21  g084(.a(new_n146_), .b(x09), .c(new_n64_), .O(z11));
  nand3  g085(.a(new_n69_), .b(new_n81_), .c(new_n92_), .O(new_n148_));
  ...
  nand2  g090(.a(new_n152_), .b(new_n106_), .O(new_n153_));
  ...
  nand4  g101(.a(new_n161_), .b(new_n106_), .c(x20), .d(new_n160_), .O(new_n164_));
  nor2   g102(.a(new_n164_), .b(x18), .O(new_n165_));
  oai21  g103(.a(new_n165_), .b(new_n163_), .c(x27), .O(new_n166_));
  nand3  g104(.a(new_n135_), .b(new_n155_), .c(new_n73_), .O(new_n167_));
  ...
  nand3  g108(.a(x39), .b(new_n155_), .c(new_n73_), .O(new_n171_));
  inv1   g109(.a(new_n171_), .O(new_n172_));
  aoi21  g110(.a(new_n172_), .b(new_n170_), .c(new_n63_), .O(new_n173_));
  oai21  g111(.a(new_n173_), .b(new_n126_), .c(new_n169_), .O(new_n174_));
  nand3  g112(.a(new_n69_), .b(new_n92_), .c(x28), .O(new_n175_));
  ...
  nand3  g120(.a(new_n106_), .b(x22), .c(x01), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n64_), .O(z16));
  inv1   g122(.a(x24), .O(new_n185_));
  nand3  g123(.a(new_n185_), .b(x22), .c(x01), .O(new_n186_));
  aoi21  g124(.a(new_n186_), .b(x40), .c(new_n106_), .O(z17));
  oai22  g125(.a(new_n95_), .b(new_n89_), .c(new_n83_), .d(x27), .O(new_n188_));
  ...
  nor2   g130(.a(new_n146_), .b(x09), .O(z19));
  aoi21  g131(.a(x28), .b(new_n68_), .c(new_n92_), .O(new_n194_));
  aoi21  g132(.a(new_n143_), .b(new_n142_), .c(new_n194_), .O(new_n195_));
  aoi21  g133(.a(new_n138_), .b(new_n93_), .c(x08), .O(new_n196_));
