...
module FAU ( 
  ...
  nand4  g014(.a(new_n76_), .b(x39), .c(new_n66_), .d(x07), .O(new_n77_));
  ...
  oai21  g033(.a(new_n95_), .b(new_n92_), .c(x07), .O(new_n96_));
  ...
  aoi21  g056(.a(new_n118_), .b(x07), .c(new_n74_), .O(z08));
  ...
  nand3  g061(.a(new_n84_), .b(x27), .c(x07), .O(new_n124_));
  oai21  g062(.a(x32), .b(x30), .c(x40), .O(new_n125_));
  or2    g063(.a(new_n125_), .b(new_n118_), .O(new_n126_));
  aoi21  g064(.a(new_n126_), .b(new_n124_), .c(new_n123_), .O(new_n127_));
  nor2   g065(.a(new_n74_), .b(new_n118_), .O(new_n128_));
  inv1   g066(.a(new_n128_), .O(new_n129_));
  nand4  g067(.a(new_n129_), .b(new_n84_), .c(x27), .d(x07), .O(new_n130_));
  inv1   g068(.a(new_n130_), .O(new_n131_));
  oai21  g069(.a(new_n131_), .b(new_n127_), .c(new_n122_), .O(new_n132_));
  ...
  nand2  g073(.a(new_n64_), .b(new_n68_), .O(new_n136_));
  oai21  g074(.a(new_n83_), .b(x04), .c(x07), .O(new_n137_));
  aoi21  g075(.a(new_n137_), .b(new_n136_), .c(x08), .O(new_n138_));
  inv1   g076(.a(new_n83_), .O(new_n139_));
  nand2  g077(.a(x39), .b(x29), .O(new_n140_));
  aoi21  g078(.a(new_n140_), .b(x07), .c(new_n74_), .O(new_n141_));
  nand2  g079(.a(x27), .b(x04), .O(new_n142_));
  aoi21  g080(.a(new_n142_), .b(new_n139_), .c(new_n141_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n138_), .c(new_n79_), .O(new_n144_));
  nor2   g082(.a(new_n144_), .b(x09), .O(z11));
  inv1   g083(.a(x35), .O(new_n146_));
  nand3  g084(.a(new_n69_), .b(new_n81_), .c(new_n146_), .O(new_n147_));
  nand2  g085(.a(x40), .b(new_n68_), .O(new_n148_));
  aoi21  g086(.a(new_n148_), .b(new_n147_), .c(x10), .O(new_n149_));
  aoi21  g087(.a(x39), .b(new_n122_), .c(new_n71_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n149_), .c(x07), .O(new_n151_));
  ...
  nor2   g102(.a(new_n126_), .b(x13), .O(new_n165_));
  nand3  g103(.a(new_n165_), .b(x07), .c(new_n122_), .O(new_n166_));
  nand2  g104(.a(new_n166_), .b(new_n164_), .O(z13));
  oai21  g105(.a(x27), .b(new_n153_), .c(x07), .O(new_n168_));
  nand2  g106(.a(new_n168_), .b(x40), .O(new_n169_));
  nand3  g107(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n170_));
  nand4  g108(.a(new_n154_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n171_));
  nand4  g109(.a(new_n171_), .b(new_n128_), .c(new_n153_), .d(new_n122_), .O(new_n172_));
  nand2  g110(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  oai21  g111(.a(new_n118_), .b(x04), .c(x07), .O(new_n174_));
  nor2   g112(.a(new_n74_), .b(x13), .O(new_n175_));
  aoi22  g113(.a(new_n175_), .b(new_n174_), .c(x35), .d(x28), .O(new_n176_));
  nand4  g114(.a(new_n146_), .b(new_n80_), .c(new_n79_), .d(x28), .O(new_n177_));
  inv1   g115(.a(new_n177_), .O(new_n178_));
  oai21  g116(.a(new_n178_), .b(new_n176_), .c(new_n69_), .O(new_n179_));
  inv1   g117(.a(new_n174_), .O(new_n180_));
  oai21  g118(.a(new_n180_), .b(new_n125_), .c(new_n68_), .O(new_n181_));
  nand4  g119(.a(new_n181_), .b(new_n179_), .c(new_n173_), .d(new_n169_), .O(z14));
  ...
  nand2  g128(.a(x27), .b(new_n122_), .O(new_n191_));
  nand2  g129(.a(new_n68_), .b(x08), .O(new_n192_));
  aoi21  g130(.a(new_n192_), .b(new_n191_), .c(new_n146_), .O(new_n193_));
  inv1   g131(.a(x09), .O(new_n194_));
  nand2  g132(.a(new_n79_), .b(new_n194_), .O(new_n195_));
  aoi21  g133(.a(new_n193_), .b(new_n82_), .c(new_n195_), .O(new_n196_));
  nand4  g134(.a(new_n128_), .b(x29), .c(x08), .d(x07), .O(new_n197_));
  oai21  g135(.a(new_n196_), .b(new_n65_), .c(new_n197_), .O(z18));
  aoi21  g136(.a(x28), .b(new_n68_), .c(new_n146_), .O(new_n199_));
  nor2   g137(.a(new_n199_), .b(new_n141_), .O(new_n200_));
  oai21  g138(.a(new_n146_), .b(new_n68_), .c(x07), .O(new_n201_));
  nand2  g139(.a(new_n74_), .b(new_n68_), .O(new_n202_));
  aoi21  g140(.a(new_n202_), .b(new_n201_), .c(x08), .O(new_n203_));
  oai21  g141(.a(new_n203_), .b(new_n200_), .c(new_n79_), .O(new_n204_));
