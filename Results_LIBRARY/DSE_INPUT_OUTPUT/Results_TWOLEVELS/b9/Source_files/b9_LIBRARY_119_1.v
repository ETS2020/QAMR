...
module FAU ( 
  ...
  oai21  g028(.a(new_n90_), .b(new_n87_), .c(x18), .O(new_n91_));
  nand2  g029(.a(new_n91_), .b(x40), .O(z02));
  inv1   g030(.a(x35), .O(new_n93_));
  oai21  g031(.a(new_n93_), .b(new_n81_), .c(x27), .O(new_n94_));
  ...
  aoi21  g039(.a(new_n64_), .b(new_n68_), .c(new_n81_), .O(new_n102_));
  ...
  aoi21  g053(.a(new_n115_), .b(x18), .c(new_n73_), .O(z08));
  ...
  nand4  g058(.a(x40), .b(x39), .c(x18), .d(x05), .O(new_n121_));
  oai21  g059(.a(z08), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  nand3  g060(.a(new_n122_), .b(new_n83_), .c(new_n119_), .O(new_n123_));
  ...
  nor3   g065(.a(new_n127_), .b(new_n115_), .c(new_n63_), .O(new_n128_));
  ...
  nor2   g070(.a(new_n68_), .b(new_n119_), .O(new_n133_));
  oai21  g071(.a(new_n133_), .b(new_n82_), .c(new_n132_), .O(new_n134_));
  nor2   g072(.a(new_n93_), .b(x28), .O(new_n135_));
  nand3  g073(.a(new_n135_), .b(x27), .c(new_n119_), .O(new_n136_));
  inv1   g074(.a(new_n136_), .O(new_n137_));
  oai21  g075(.a(new_n137_), .b(x08), .c(new_n134_), .O(new_n138_));
  nand3  g076(.a(new_n138_), .b(new_n78_), .c(new_n131_), .O(new_n139_));
  nand2  g077(.a(new_n139_), .b(new_n64_), .O(z11));
  nand3  g078(.a(new_n95_), .b(new_n80_), .c(new_n93_), .O(new_n141_));
  aoi21  g079(.a(new_n141_), .b(x27), .c(x10), .O(new_n142_));
  aoi21  g080(.a(x39), .b(new_n119_), .c(new_n70_), .O(new_n143_));
  oai21  g081(.a(new_n143_), .b(new_n142_), .c(x18), .O(new_n144_));
  oai21  g082(.a(new_n70_), .b(x40), .c(new_n144_), .O(z12));
  inv1   g083(.a(x13), .O(new_n146_));
  nand2  g084(.a(x36), .b(x35), .O(new_n147_));
  aoi21  g085(.a(new_n147_), .b(x28), .c(new_n73_), .O(new_n148_));
  nand4  g086(.a(new_n148_), .b(x39), .c(x18), .d(new_n146_), .O(new_n149_));
  inv1   g087(.a(x19), .O(new_n150_));
  nor2   g088(.a(new_n69_), .b(x40), .O(new_n151_));
  nand4  g089(.a(new_n151_), .b(x20), .c(new_n150_), .d(new_n63_), .O(new_n152_));
  oai21  g090(.a(new_n149_), .b(x04), .c(new_n152_), .O(new_n153_));
  nand2  g091(.a(new_n153_), .b(x27), .O(new_n154_));
  nand3  g092(.a(new_n128_), .b(new_n146_), .c(new_n119_), .O(new_n155_));
  nand2  g093(.a(new_n155_), .b(new_n154_), .O(z13));
  nand2  g094(.a(new_n127_), .b(new_n68_), .O(new_n157_));
  nand4  g095(.a(new_n147_), .b(new_n79_), .c(new_n78_), .d(x28), .O(new_n158_));
  nand2  g096(.a(new_n158_), .b(x18), .O(new_n159_));
  nand2  g097(.a(new_n159_), .b(x40), .O(new_n160_));
  nand3  g098(.a(x20), .b(new_n150_), .c(new_n63_), .O(new_n161_));
  oai21  g099(.a(new_n161_), .b(new_n69_), .c(new_n73_), .O(new_n162_));
  nand3  g100(.a(x39), .b(new_n146_), .c(new_n119_), .O(new_n163_));
  nand2  g101(.a(new_n163_), .b(x18), .O(new_n164_));
  ...
  oai21  g112(.a(new_n82_), .b(x27), .c(new_n132_), .O(new_n175_));
  nand2  g113(.a(new_n175_), .b(x08), .O(new_n176_));
  nor2   g114(.a(new_n65_), .b(x09), .O(new_n177_));
  nand4  g115(.a(new_n177_), .b(new_n176_), .c(new_n136_), .d(new_n78_), .O(z18));
  inv1   g116(.a(new_n132_), .O(new_n179_));
  nor2   g117(.a(new_n93_), .b(new_n68_), .O(new_n180_));
  aoi21  g118(.a(x28), .b(new_n68_), .c(new_n93_), .O(new_n181_));
  oai22  g119(.a(new_n181_), .b(new_n179_), .c(new_n180_), .d(x08), .O(new_n182_));
  nand3  g120(.a(new_n182_), .b(new_n78_), .c(new_n131_), .O(new_n183_));
  nand2  g121(.a(new_n183_), .b(new_n64_), .O(z20));
  nand2  g122(.a(new_n139_), .b(new_n64_), .O(z19));
endmodule
