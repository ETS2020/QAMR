...
module FAU ( 
  ...
  oai21  g033(.a(new_n81_), .b(x35), .c(new_n95_), .O(new_n96_));
  oai21  g034(.a(new_n96_), .b(new_n94_), .c(x04), .O(new_n97_));
  nand3  g035(.a(new_n97_), .b(new_n93_), .c(new_n76_), .O(z02));
  ...
  nand3  g070(.a(x35), .b(new_n95_), .c(new_n65_), .O(new_n133_));
  ...
  nand2  g076(.a(new_n81_), .b(x06), .O(new_n139_));
  ...
  nor2   g083(.a(new_n81_), .b(x27), .O(new_n146_));
  ...
  aoi21  g087(.a(x39), .b(new_n65_), .c(new_n81_), .O(new_n150_));
  oai21  g088(.a(new_n150_), .b(new_n148_), .c(new_n149_), .O(new_n151_));
  nand3  g089(.a(new_n151_), .b(new_n147_), .c(new_n82_), .O(z12));
  inv1   g090(.a(x13), .O(new_n153_));
  nand2  g091(.a(x36), .b(x35), .O(new_n154_));
  aoi21  g092(.a(new_n154_), .b(x28), .c(new_n81_), .O(new_n155_));
  ...
  nand3  g099(.a(new_n126_), .b(x40), .c(x39), .O(new_n162_));
  nor2   g100(.a(new_n162_), .b(x13), .O(new_n163_));
  aoi21  g101(.a(new_n163_), .b(new_n65_), .c(new_n84_), .O(new_n164_));
  nand2  g102(.a(new_n164_), .b(new_n161_), .O(z13));
  nand3  g103(.a(x20), .b(new_n158_), .c(new_n157_), .O(new_n166_));
  nand4  g104(.a(new_n154_), .b(new_n86_), .c(new_n85_), .d(x28), .O(new_n167_));
  nand3  g105(.a(x39), .b(new_n153_), .c(new_n65_), .O(new_n168_));
  inv1   g106(.a(new_n168_), .O(new_n169_));
  aoi21  g107(.a(new_n169_), .b(new_n167_), .c(new_n81_), .O(new_n170_));
  oai21  g108(.a(new_n170_), .b(new_n148_), .c(new_n166_), .O(new_n171_));
  ...
  nand3  g115(.a(new_n149_), .b(new_n81_), .c(x06), .O(new_n178_));
  ...
  nand2  g129(.a(new_n85_), .b(new_n191_), .O(new_n192_));
  aoi21  g130(.a(new_n190_), .b(new_n95_), .c(new_n192_), .O(new_n193_));
  oai22  g131(.a(new_n193_), .b(new_n84_), .c(new_n92_), .d(new_n75_), .O(z18));
  nor2   g132(.a(x40), .b(x35), .O(new_n195_));
  oai21  g133(.a(new_n195_), .b(new_n94_), .c(x06), .O(new_n196_));
