...
module FAU ( 
  ...
  nand2  g036(.a(new_n80_), .b(new_n98_), .O(new_n99_));
  ...
  oai22  g046(.a(x40), .b(new_n98_), .c(new_n85_), .d(new_n64_), .O(new_n109_));
  ...
  nand2  g055(.a(new_n117_), .b(new_n98_), .O(new_n118_));
  ...
  nand3  g075(.a(x35), .b(new_n85_), .c(new_n65_), .O(new_n138_));
  ...
  nand3  g081(.a(new_n143_), .b(x35), .c(new_n85_), .O(new_n144_));
  nand2  g082(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  oai21  g083(.a(new_n139_), .b(x08), .c(new_n145_), .O(new_n146_));
  nand3  g084(.a(new_n146_), .b(new_n83_), .c(new_n137_), .O(new_n147_));
  ...
  nand3  g091(.a(new_n153_), .b(new_n80_), .c(new_n98_), .O(new_n154_));
  ...
  aoi21  g100(.a(new_n162_), .b(new_n159_), .c(new_n80_), .O(new_n163_));
  nor2   g101(.a(new_n162_), .b(x14), .O(new_n164_));
  ...
  nor2   g105(.a(x40), .b(x14), .O(new_n168_));
  nand3  g106(.a(x20), .b(new_n161_), .c(new_n160_), .O(new_n169_));
  nand4  g107(.a(new_n157_), .b(new_n84_), .c(new_n83_), .d(x28), .O(new_n170_));
  ...
  nand2  g131(.a(new_n83_), .b(new_n137_), .O(new_n194_));
  aoi21  g132(.a(new_n193_), .b(new_n85_), .c(new_n194_), .O(new_n195_));
  oai22  g133(.a(new_n195_), .b(new_n104_), .c(new_n92_), .d(new_n75_), .O(z18));
