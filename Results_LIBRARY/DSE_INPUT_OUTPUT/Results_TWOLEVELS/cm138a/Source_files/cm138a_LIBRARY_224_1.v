...
module FAU ( 
  ...
  nor3   g05(.a(x4), .b(x1), .c(x0), .O(new_n20_));
  ...
  nor2   g12(.a(x4), .b(new_n22_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n19_), .c(new_n26_), .O(z2));
  nand2  g14(.a(new_n27_), .b(new_n24_), .O(z3));
  inv1   g15(.a(x3), .O(new_n30_));
  oai21  g16(.a(x5), .b(new_n30_), .c(new_n15_), .O(new_n31_));
  nor2   g17(.a(x4), .b(new_n16_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n31_), .c(new_n22_), .d(new_n26_), .O(z4));
  nand3  g19(.a(new_n17_), .b(x3), .c(x0), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n32_), .c(new_n22_), .O(z5));
  nand4  g22(.a(new_n32_), .b(new_n31_), .c(x1), .d(new_n26_), .O(z6));
  nand3  g23(.a(new_n35_), .b(new_n32_), .c(x1), .O(z7));
endmodule
