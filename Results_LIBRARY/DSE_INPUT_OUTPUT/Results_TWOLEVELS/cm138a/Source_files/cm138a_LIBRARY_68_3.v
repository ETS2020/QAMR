...
module FAU ( 
  ...
  nand4  g16(.a(new_n29_), .b(new_n17_), .c(x1), .d(x0), .O(z3));
  oai21  g17(.a(x1), .b(new_n16_), .c(new_n17_), .O(new_n32_));
  nor2   g18(.a(x5), .b(x4), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(x3), .c(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n32_), .O(z4));
  oai21  g22(.a(x1), .b(x0), .c(new_n17_), .O(new_n37_));
  nand3  g23(.a(new_n33_), .b(x3), .c(x0), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n37_), .O(z5));
  nand2  g26(.a(x2), .b(x1), .O(z6));
  nand2  g27(.a(x2), .b(x1), .O(z7));
endmodule
