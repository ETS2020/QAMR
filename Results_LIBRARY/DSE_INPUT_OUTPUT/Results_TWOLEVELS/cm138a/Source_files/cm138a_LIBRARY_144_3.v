...
module FAU ( 
  ...
  nor2   g12(.a(new_n17_), .b(x0), .O(new_n29_));
  nand4  g13(.a(new_n29_), .b(new_n28_), .c(x3), .d(new_n15_), .O(z4));
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x2), .d(x0), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(new_n15_), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(x3), .O(z5));
