...
module FAU ( 
  ...
  nor2   g16(.a(x4), .b(new_n31_), .O(new_n32_));
  nor2   g17(.a(new_n18_), .b(new_n15_), .O(new_n33_));
  nand4  g18(.a(new_n33_), .b(new_n32_), .c(new_n17_), .d(new_n16_), .O(z5));
  one    g19(.O(z3));
  one    g20(.O(z6));
  nand2  g21(.a(new_n17_), .b(x1), .O(z7));
endmodule
