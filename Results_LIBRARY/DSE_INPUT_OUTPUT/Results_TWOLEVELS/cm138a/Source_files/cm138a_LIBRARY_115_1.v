...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    ...
    new_n33_, new_n35_, new_n36_, new_n39_, new_n40_, new_n41_;
  ...
  nand4  g15(.a(new_n29_), .b(new_n19_), .c(new_n16_), .d(new_n21_), .O(z3));
  inv1   g16(.a(x0), .O(new_n31_));
  nand4  g17(.a(new_n22_), .b(x3), .c(x2), .d(new_n31_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(z4));
  nand4  g20(.a(new_n22_), .b(x3), .c(x2), .d(x0), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(z5));
  nand4  g23(.a(new_n26_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z6));
  nand3  g24(.a(new_n22_), .b(x3), .c(x2), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n28_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(x5), .b(x1), .O(new_n41_));
