...
module FAU ( 
  ...
  nor2   g20(.a(x1), .b(new_n17_), .O(new_n35_));
  and2   g21(.a(x3), .b(x2), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n35_), .c(new_n15_), .d(new_n16_), .O(z5));
  ...
  nand4  g27(.a(new_n36_), .b(new_n41_), .c(new_n15_), .d(new_n16_), .O(z7));
endmodule
