...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n22_, new_n23_,
    new_n24_, new_n25_, new_n29_, new_n30_;
  ...
  nand4  g09(.a(new_n23_), .b(new_n22_), .c(new_n16_), .d(x1), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n15_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x3), .O(z2));
  nand4  g12(.a(new_n19_), .b(new_n17_), .c(x2), .d(new_n15_), .O(z4));
  nand4  g13(.a(new_n23_), .b(new_n22_), .c(x2), .d(x1), .O(new_n29_));
