...
module FAU ( 
  ...
  nand2  g19(.a(x4), .b(new_n17_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n33_), .O(z4));
  nand4  g21(.a(new_n28_), .b(x3), .c(x2), .d(new_n18_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x0), .O(z5));
  nand4  g24(.a(new_n26_), .b(new_n22_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g25(.a(new_n15_), .b(new_n18_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n22_), .c(new_n16_), .d(x0), .O(z7));
endmodule
