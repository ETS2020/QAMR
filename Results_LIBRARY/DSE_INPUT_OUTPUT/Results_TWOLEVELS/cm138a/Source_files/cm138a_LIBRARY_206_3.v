...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    ...
    new_n32_, new_n35_, new_n37_, new_n39_, new_n40_;
  ...
  nand2  g11(.a(x5), .b(new_n23_), .O(new_n26_));
  ...
  nand4  g21(.a(new_n35_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z5));
  nor2   g22(.a(new_n15_), .b(x0), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n19_), .c(new_n16_), .d(x1), .O(z6));
  nand4  g24(.a(new_n21_), .b(x3), .c(x2), .d(x0), .O(new_n39_));
