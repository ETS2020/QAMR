...
module FAU ( 
  ...
  nand4  g13(.a(new_n23_), .b(x3), .c(x1), .d(new_n27_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n21_), .O(z2));
  ...
  nand4  g19(.a(new_n19_), .b(new_n17_), .c(new_n16_), .d(x2), .O(z4));
  nand2  g20(.a(new_n25_), .b(x2), .O(z5));
  nand2  g21(.a(new_n29_), .b(x2), .O(z6));
  nand2  g22(.a(new_n32_), .b(x2), .O(z7));
endmodule
