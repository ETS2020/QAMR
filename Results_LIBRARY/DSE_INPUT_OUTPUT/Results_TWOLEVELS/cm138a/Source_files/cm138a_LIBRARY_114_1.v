...
module FAU ( 
  ...
  nor2   g13(.a(new_n19_), .b(x0), .O(new_n30_));
  nand4  g14(.a(new_n30_), .b(new_n29_), .c(x3), .d(x1), .O(z6));
  nand4  g15(.a(new_n21_), .b(new_n20_), .c(x2), .d(x0), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(x1), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(x3), .O(z7));
  one    g18(.O(z0));
  one    g19(.O(z5));
  nand2  g20(.a(x3), .b(new_n16_), .O(z4));
endmodule
