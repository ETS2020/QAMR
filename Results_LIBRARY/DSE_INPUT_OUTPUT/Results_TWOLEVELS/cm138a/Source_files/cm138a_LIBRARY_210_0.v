...
module FAU ( 
  ...
  nand3  g14(.a(new_n17_), .b(new_n21_), .c(x1), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(x3), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z2));
  nand2  g17(.a(x1), .b(x0), .O(new_n32_));
  nor2   g18(.a(new_n32_), .b(new_n24_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x3), .O(z3));
  nor2   g20(.a(new_n21_), .b(x1), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n17_), .c(x3), .d(new_n15_), .O(z4));
  nand3  g22(.a(new_n23_), .b(new_n22_), .c(x2), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n20_), .c(x3), .O(new_n38_));
  ...
  oai21  g28(.a(new_n37_), .b(new_n32_), .c(x3), .O(new_n43_));
