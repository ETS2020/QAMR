...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n28_, new_n30_, new_n31_, new_n32_,
  ...
  oai21  g23(.a(new_n37_), .b(new_n31_), .c(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z6));
  nand4  g25(.a(new_n28_), .b(new_n32_), .c(new_n15_), .d(x2), .O(z7));
endmodule
