...
module FAU ( 
  ...
  nor2   g23(.a(x1), .b(new_n17_), .O(new_n38_));
  nand4  g24(.a(new_n36_), .b(new_n38_), .c(new_n15_), .d(new_n16_), .O(z5));
  nor2   g25(.a(new_n18_), .b(x0), .O(new_n40_));
  nand4  g26(.a(new_n36_), .b(new_n40_), .c(new_n15_), .d(new_n16_), .O(z6));
  oai21  g27(.a(new_n35_), .b(new_n31_), .c(new_n16_), .O(new_n42_));
