...
module FAU ( 
  ...
  nand3  g09(.a(new_n17_), .b(x1), .c(new_n23_), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(x3), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n15_), .O(z2));
  nor2   g12(.a(new_n19_), .b(new_n23_), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n17_), .c(x3), .d(new_n15_), .O(z3));
  inv1   g14(.a(x4), .O(new_n29_));
  inv1   g15(.a(x5), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n29_), .c(x2), .O(new_n31_));
  inv1   g17(.a(new_n31_), .O(new_n32_));
  nand3  g18(.a(new_n32_), .b(new_n16_), .c(x3), .O(z4));
  oai21  g19(.a(new_n31_), .b(new_n20_), .c(x3), .O(new_n34_));
  inv1   g20(.a(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n34_), .O(z5));
  nand4  g23(.a(new_n32_), .b(x3), .c(x1), .d(new_n23_), .O(z6));
  nand3  g24(.a(new_n32_), .b(new_n27_), .c(x3), .O(z7));
endmodule
