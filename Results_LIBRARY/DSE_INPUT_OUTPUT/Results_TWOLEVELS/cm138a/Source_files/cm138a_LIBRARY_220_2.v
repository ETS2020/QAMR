...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n31_, new_n32_, new_n34_, new_n35_, new_n38_, new_n40_, new_n41_,
    new_n43_;
  ...
  nand2  g18(.a(new_n32_), .b(new_n21_), .O(z2));
  nand2  g19(.a(x1), .b(x0), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n25_), .c(x3), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n21_), .O(z3));
  nand4  g22(.a(new_n17_), .b(new_n16_), .c(x3), .d(x2), .O(z4));
  inv1   g23(.a(new_n27_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n17_), .c(x3), .d(x2), .O(z5));
  nand2  g25(.a(new_n24_), .b(new_n23_), .O(new_n40_));
  oai21  g26(.a(new_n31_), .b(new_n40_), .c(x3), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x2), .O(z6));
  oai21  g28(.a(new_n34_), .b(new_n40_), .c(x3), .O(new_n43_));
