...
module FAU ( 
  ...
  nor2   g15(.a(x4), .b(new_n22_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n16_), .c(new_n15_), .d(x3), .O(z4));
  inv1   g17(.a(x1), .O(new_n32_));
  nand4  g18(.a(new_n23_), .b(x2), .c(new_n32_), .d(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x3), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(z5));
  nor2   g21(.a(new_n32_), .b(x0), .O(new_n36_));
  nand4  g22(.a(new_n30_), .b(new_n36_), .c(new_n15_), .d(x3), .O(z6));
  nor2   g23(.a(new_n32_), .b(new_n19_), .O(new_n38_));
