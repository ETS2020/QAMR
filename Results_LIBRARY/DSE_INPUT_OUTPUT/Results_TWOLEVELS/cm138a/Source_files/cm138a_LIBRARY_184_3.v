...
module FAU ( 
  ...
  nand2  g08(.a(x5), .b(new_n16_), .O(new_n23_));
  ...
  nor2   g21(.a(new_n35_), .b(new_n18_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(z4));
  nand4  g23(.a(new_n20_), .b(x3), .c(x2), .d(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x0), .O(z5));
  ...
  nand4  g29(.a(new_n43_), .b(new_n26_), .c(new_n15_), .d(x0), .O(z7));
endmodule
