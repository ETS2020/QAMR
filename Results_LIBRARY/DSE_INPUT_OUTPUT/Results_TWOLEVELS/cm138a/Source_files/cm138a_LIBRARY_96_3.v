...
module FAU ( 
  ...
  nor2   g11(.a(new_n17_), .b(x0), .O(new_n28_));
  nand4  g12(.a(new_n28_), .b(new_n23_), .c(x3), .d(new_n15_), .O(z4));
  nand4  g13(.a(new_n19_), .b(new_n18_), .c(x2), .d(x0), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n15_), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(x3), .O(z5));
  one    g16(.O(z2));
  one    g17(.O(z3));
  one    g18(.O(z6));
  one    g19(.O(z7));
