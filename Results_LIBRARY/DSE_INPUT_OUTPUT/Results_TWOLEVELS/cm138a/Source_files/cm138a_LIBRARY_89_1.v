...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n35_, new_n36_, new_n38_, new_n39_, new_n40_;
  ...
  nand4  g16(.a(new_n30_), .b(new_n24_), .c(new_n16_), .d(new_n18_), .O(z3));
  ...
  oai21  g24(.a(new_n38_), .b(new_n27_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(x5), .b(x1), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n39_), .O(z6));
  nand4  g27(.a(new_n30_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z7));
endmodule
