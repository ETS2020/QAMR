...
module FAU ( 
  ...
  oai21  g10(.a(new_n17_), .b(x1), .c(new_n15_), .O(new_n26_));
  nand4  g11(.a(new_n19_), .b(new_n18_), .c(x3), .d(new_n15_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(x2), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n26_), .O(z4));
  nand4  g14(.a(new_n19_), .b(new_n18_), .c(x3), .d(new_n16_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x2), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x0), .O(z5));
  oai21  g17(.a(new_n17_), .b(new_n16_), .c(new_n15_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n28_), .O(z6));
  nor2   g19(.a(x5), .b(x4), .O(new_n35_));
  and2   g20(.a(x3), .b(x1), .O(new_n36_));
  nand4  g21(.a(new_n36_), .b(new_n35_), .c(x2), .d(x0), .O(z7));
  one    g22(.O(z3));
endmodule
