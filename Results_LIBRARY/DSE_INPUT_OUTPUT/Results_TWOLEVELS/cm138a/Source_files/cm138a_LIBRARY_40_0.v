...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n27_, new_n28_, new_n29_, new_n32_, new_n33_,
  ...
  oai21  g09(.a(new_n18_), .b(new_n16_), .c(x0), .O(new_n24_));
  nand2  g10(.a(new_n21_), .b(x1), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(new_n24_), .O(z2));
  oai21  g12(.a(x2), .b(new_n15_), .c(x1), .O(new_n27_));
  nand4  g13(.a(new_n20_), .b(new_n19_), .c(x3), .d(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n27_), .O(z3));
  nand4  g16(.a(new_n20_), .b(new_n19_), .c(x3), .d(x2), .O(new_n32_));
  inv1   g17(.a(new_n32_), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n16_), .c(x0), .O(z5));
  nand2  g19(.a(new_n16_), .b(new_n15_), .O(new_n35_));
  oai21  g20(.a(x2), .b(new_n16_), .c(x0), .O(new_n36_));
  nand2  g21(.a(new_n32_), .b(x1), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n36_), .c(new_n35_), .O(z6));
  oai21  g23(.a(new_n18_), .b(new_n15_), .c(x1), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n29_), .O(z7));
  one    g25(.O(z4));
endmodule
