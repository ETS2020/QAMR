...
module FAU ( 
  ...
  nor2   g12(.a(new_n26_), .b(new_n21_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x3), .O(z1));
  ...
  nand3  g22(.a(new_n36_), .b(x3), .c(x2), .O(z4));
  oai21  g23(.a(new_n26_), .b(new_n35_), .c(x3), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z5));
  oai21  g25(.a(new_n29_), .b(new_n35_), .c(x3), .O(new_n40_));
