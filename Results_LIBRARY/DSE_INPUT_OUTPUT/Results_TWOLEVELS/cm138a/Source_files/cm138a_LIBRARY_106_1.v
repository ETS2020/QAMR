...
module FAU ( 
  ...
  nor2   g16(.a(new_n22_), .b(new_n27_), .O(new_n31_));
  nand3  g17(.a(new_n31_), .b(new_n20_), .c(new_n15_), .O(z3));
  nand3  g18(.a(new_n18_), .b(x3), .c(x2), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand3  g20(.a(new_n34_), .b(new_n16_), .c(new_n15_), .O(z4));
  oai21  g21(.a(new_n33_), .b(new_n23_), .c(new_n15_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n25_), .O(z5));
  nand4  g23(.a(new_n34_), .b(new_n15_), .c(x1), .d(new_n27_), .O(z6));
  nand3  g24(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(z7));
endmodule
