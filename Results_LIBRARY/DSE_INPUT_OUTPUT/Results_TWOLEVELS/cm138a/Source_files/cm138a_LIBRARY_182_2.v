...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n18_), .c(new_n22_), .d(new_n16_), .O(z4));
  inv1   g12(.a(x4), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(x3), .c(x2), .d(x0), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n16_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n22_), .O(z5));
  one    g16(.O(z6));
  one    g17(.O(z7));
  nand2  g18(.a(new_n22_), .b(x1), .O(z3));
endmodule
