...
module FAU ( 
  ...
  nand3  g15(.a(new_n29_), .b(new_n18_), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(x1), .O(z2));
  nand3  g18(.a(new_n29_), .b(new_n18_), .c(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x3), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x1), .O(z3));
  nand3  g21(.a(new_n29_), .b(x2), .c(new_n15_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x3), .O(new_n37_));
  nand3  g23(.a(new_n37_), .b(x3), .c(new_n16_), .O(z4));
  nand3  g24(.a(new_n20_), .b(new_n19_), .c(x2), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n26_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n24_), .O(z5));
  nand2  g27(.a(new_n37_), .b(x1), .O(z6));
  nand3  g28(.a(new_n29_), .b(x2), .c(x0), .O(new_n43_));
