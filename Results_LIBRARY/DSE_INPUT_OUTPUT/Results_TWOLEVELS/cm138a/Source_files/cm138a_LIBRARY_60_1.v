...
module FAU ( 
  ...
  nor2   g17(.a(new_n15_), .b(new_n26_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n19_), .c(new_n16_), .d(new_n21_), .O(z3));
  nor2   g19(.a(new_n21_), .b(x0), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g21(.a(new_n22_), .b(x3), .c(x2), .d(x0), .O(new_n36_));
  ...
  nand4  g26(.a(new_n32_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z7));
endmodule
