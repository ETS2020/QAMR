...
module FAU ( 
  ...
  nor2   g23(.a(new_n37_), .b(new_n23_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n16_), .O(z5));
  inv1   g25(.a(x3), .O(new_n40_));
  nor2   g26(.a(x5), .b(new_n40_), .O(new_n41_));
  nor2   g27(.a(new_n18_), .b(new_n17_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n41_), .c(new_n16_), .d(new_n15_), .O(z6));
  oai21  g29(.a(new_n37_), .b(new_n31_), .c(new_n16_), .O(new_n44_));
