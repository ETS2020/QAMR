...
module FAU ( 
  ...
  nand4  g12(.a(new_n26_), .b(new_n24_), .c(new_n16_), .d(new_n18_), .O(z1));
  nand4  g13(.a(new_n19_), .b(x3), .c(new_n18_), .d(x1), .O(new_n28_));
  ...
  nor2   g18(.a(new_n18_), .b(x1), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand3  g20(.a(new_n19_), .b(x3), .c(x2), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n25_), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(x4), .b(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n36_), .O(z5));
  nor2   g24(.a(new_n18_), .b(new_n17_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand4  g26(.a(new_n31_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z7));
endmodule
