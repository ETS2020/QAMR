...
module FAU ( 
  ...
  nor2   g18(.a(x2), .b(new_n17_), .O(new_n33_));
  ...
  nand4  g28(.a(new_n20_), .b(x3), .c(x2), .d(x1), .O(new_n43_));
  nand2  g29(.a(new_n43_), .b(new_n15_), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(x0), .O(z7));
endmodule
