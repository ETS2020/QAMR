...
module FAU ( 
  ...
  nand4  g09(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n15_), .O(new_n26_));
  nand2  g10(.a(new_n26_), .b(new_n16_), .O(new_n27_));
  nand2  g11(.a(new_n27_), .b(x3), .O(z4));
  and2   g12(.a(x2), .b(x0), .O(new_n29_));
  nand4  g13(.a(new_n29_), .b(new_n17_), .c(x3), .d(new_n16_), .O(z5));
  nand2  g14(.a(x3), .b(x1), .O(z7));
  one    g15(.O(z2));
  one    g16(.O(z3));
  one    g17(.O(z6));
endmodule
