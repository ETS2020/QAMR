...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n27_, new_n30_, new_n31_, new_n33_,
  ...
  nand4  g14(.a(new_n25_), .b(new_n15_), .c(x1), .d(x0), .O(z3));
  nand3  g15(.a(new_n20_), .b(x3), .c(x2), .O(new_n30_));
  inv1   g16(.a(new_n30_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n15_), .c(new_n17_), .d(new_n16_), .O(z4));
  nand2  g18(.a(new_n17_), .b(x0), .O(new_n33_));
  oai21  g19(.a(new_n30_), .b(new_n33_), .c(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n23_), .O(z5));
  nand3  g21(.a(new_n31_), .b(new_n27_), .c(new_n15_), .O(z6));
  nand2  g22(.a(x1), .b(x0), .O(new_n37_));
  oai21  g23(.a(new_n30_), .b(new_n37_), .c(new_n15_), .O(new_n38_));
