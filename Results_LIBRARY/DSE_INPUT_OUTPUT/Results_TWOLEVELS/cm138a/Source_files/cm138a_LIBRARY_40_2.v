...
module FAU ( 
  ...
  nand3  g20(.a(new_n34_), .b(new_n33_), .c(new_n16_), .O(z4));
  nor2   g21(.a(new_n34_), .b(new_n27_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n16_), .O(z6));
  nand2  g23(.a(new_n32_), .b(x1), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(x0), .O(z7));
  one    g25(.O(z5));
endmodule
