...
module FAU ( 
  ...
  nor3   g04(.a(x4), .b(x2), .c(x0), .O(new_n19_));
  ...
  oai21  g15(.a(new_n29_), .b(new_n17_), .c(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n21_), .O(z3));
  ...
  nor2   g26(.a(new_n35_), .b(new_n29_), .O(new_n41_));
