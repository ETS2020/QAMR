...
module FAU ( 
  ...
  nand4  g21(.a(new_n26_), .b(new_n35_), .c(new_n15_), .d(x2), .O(z4));
  ...
  nand4  g26(.a(new_n40_), .b(new_n26_), .c(new_n15_), .d(x2), .O(z6));
  nor2   g27(.a(new_n19_), .b(new_n17_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n26_), .c(new_n15_), .d(x0), .O(z7));
endmodule
