...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n30_;
  ...
  nor2   g15(.a(x4), .b(new_n18_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g17(.a(new_n30_), .b(new_n29_), .c(new_n16_), .d(x0), .O(z5));
  nand2  g18(.a(new_n26_), .b(new_n16_), .O(z3));
  nand2  g19(.a(new_n26_), .b(new_n16_), .O(z6));
  nand2  g20(.a(new_n26_), .b(new_n16_), .O(z7));
endmodule
