...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n37_, new_n38_;
  ...
  nand3  g11(.a(new_n25_), .b(x3), .c(new_n16_), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nand3  g13(.a(new_n27_), .b(new_n17_), .c(x0), .O(z1));
  ...
  nand3  g17(.a(new_n25_), .b(x3), .c(x1), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x0), .O(z3));
  nand3  g20(.a(new_n27_), .b(new_n18_), .c(new_n15_), .O(z4));
  nand2  g21(.a(x2), .b(x0), .O(z5));
  oai21  g22(.a(x1), .b(x0), .c(new_n17_), .O(new_n37_));
  nand2  g23(.a(new_n32_), .b(new_n15_), .O(new_n38_));
