...
module FAU ( 
  ...
  nor2   g11(.a(x1), .b(new_n19_), .O(new_n27_));
  nand4  g12(.a(new_n27_), .b(new_n26_), .c(new_n16_), .d(x2), .O(z5));
  nand4  g13(.a(new_n21_), .b(x3), .c(x1), .d(new_n19_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(z6));
  nand4  g16(.a(new_n21_), .b(x3), .c(x1), .d(x0), .O(new_n32_));
