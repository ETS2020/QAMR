...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n35_, new_n38_, new_n39_, new_n41_;
  ...
  inv1   g20(.a(new_n17_), .O(new_n35_));
  nand4  g21(.a(new_n26_), .b(new_n35_), .c(x3), .d(x2), .O(z4));
  nand4  g22(.a(new_n27_), .b(new_n26_), .c(x3), .d(x2), .O(z5));
  nand3  g23(.a(new_n26_), .b(x1), .c(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x2), .O(z6));
  inv1   g26(.a(new_n32_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n26_), .c(x3), .d(x2), .O(z7));
endmodule
