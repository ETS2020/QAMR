...
module FAU ( 
  ...
  nand4  g10(.a(new_n25_), .b(new_n17_), .c(x1), .d(new_n16_), .O(z2));
  nand2  g11(.a(new_n20_), .b(x1), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(x0), .O(z3));
  nand4  g13(.a(new_n25_), .b(x2), .c(new_n15_), .d(new_n16_), .O(z4));
  nand2  g14(.a(new_n15_), .b(x0), .O(z5));
  nand4  g15(.a(new_n25_), .b(x2), .c(x1), .d(new_n16_), .O(z6));
