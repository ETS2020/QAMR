...
module FAU ( 
  ...
  nand4  g08(.a(new_n23_), .b(new_n16_), .c(x2), .d(new_n19_), .O(z4));
  nand3  g09(.a(new_n21_), .b(x3), .c(x0), .O(new_n25_));
  inv1   g10(.a(new_n25_), .O(new_n26_));
  nand4  g11(.a(new_n26_), .b(new_n16_), .c(x2), .d(new_n19_), .O(z5));
  nand4  g12(.a(new_n21_), .b(x3), .c(x1), .d(new_n20_), .O(new_n28_));
  ...
  nor2   g17(.a(new_n19_), .b(new_n20_), .O(new_n33_));
