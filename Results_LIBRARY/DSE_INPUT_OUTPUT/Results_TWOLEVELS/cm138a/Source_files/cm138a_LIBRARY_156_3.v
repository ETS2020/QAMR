// Benchmark "FAU" written by ABC on Wed Aug 19 17:15:57 2020
...
module FAU ( 
  ...
  nor2   g15(.a(x2), .b(new_n25_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n19_), .c(new_n16_), .d(x1), .O(z3));
  nand4  g17(.a(new_n19_), .b(new_n17_), .c(new_n16_), .d(x2), .O(z4));
  nand3  g18(.a(new_n26_), .b(x3), .c(x2), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n22_), .c(new_n16_), .O(new_n34_));
  nand2  g20(.a(x5), .b(new_n21_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n34_), .O(z5));
  nor2   g22(.a(new_n15_), .b(x0), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n19_), .c(new_n16_), .d(x1), .O(z6));
  nor2   g24(.a(new_n15_), .b(new_n25_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n19_), .c(new_n16_), .d(x1), .O(z7));
endmodule
