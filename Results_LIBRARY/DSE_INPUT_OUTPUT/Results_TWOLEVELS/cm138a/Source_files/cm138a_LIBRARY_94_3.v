...
module FAU ( 
  ...
  nand2  g08(.a(x4), .b(new_n19_), .O(new_n23_));
  ...
  nand2  g13(.a(new_n20_), .b(x3), .O(new_n28_));
  nand2  g14(.a(x1), .b(new_n16_), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(new_n28_), .c(new_n15_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n23_), .c(new_n19_), .O(z2));
  nand2  g17(.a(x1), .b(x0), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n28_), .c(new_n15_), .O(new_n33_));
  nand3  g19(.a(new_n33_), .b(new_n15_), .c(new_n19_), .O(z3));
  oai21  g20(.a(new_n28_), .b(new_n18_), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z4));
  oai21  g22(.a(new_n25_), .b(new_n28_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z5));
  nand2  g24(.a(new_n30_), .b(x2), .O(z6));
  nand2  g25(.a(new_n33_), .b(x2), .O(z7));
endmodule
