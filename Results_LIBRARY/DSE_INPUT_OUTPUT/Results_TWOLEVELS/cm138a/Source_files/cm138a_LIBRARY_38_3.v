...
module FAU ( 
  ...
  oai21  g21(.a(new_n23_), .b(new_n33_), .c(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z5));
  inv1   g23(.a(new_n33_), .O(new_n38_));
  nand4  g24(.a(new_n27_), .b(new_n38_), .c(new_n17_), .d(x2), .O(z6));
  oai21  g25(.a(new_n29_), .b(new_n33_), .c(new_n17_), .O(new_n40_));
