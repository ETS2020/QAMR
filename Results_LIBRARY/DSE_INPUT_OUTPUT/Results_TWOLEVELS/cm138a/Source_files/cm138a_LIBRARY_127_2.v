...
module FAU ( 
  ...
  nor2   g16(.a(x2), .b(new_n27_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n17_), .c(x3), .d(x1), .O(z3));
  nand4  g18(.a(new_n17_), .b(new_n16_), .c(x3), .d(x2), .O(z4));
  inv1   g19(.a(x4), .O(new_n34_));
  inv1   g20(.a(x5), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n34_), .c(x2), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n24_), .c(x3), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n22_), .O(z5));
  nand3  g24(.a(new_n17_), .b(x2), .c(new_n27_), .O(new_n39_));
