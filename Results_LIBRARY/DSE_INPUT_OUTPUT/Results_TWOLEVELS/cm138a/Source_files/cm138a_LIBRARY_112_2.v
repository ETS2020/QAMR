...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n22_, new_n23_,
    new_n24_, new_n25_, new_n28_, new_n29_, new_n30_, new_n33_;
  ...
  nand4  g08(.a(new_n23_), .b(x3), .c(new_n22_), .d(x1), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n15_), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(new_n16_), .O(z2));
  nand2  g11(.a(new_n16_), .b(x0), .O(z3));
  inv1   g12(.a(x1), .O(new_n28_));
  nand4  g13(.a(new_n23_), .b(x3), .c(x2), .d(new_n28_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n15_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(z4));
  nor2   g16(.a(new_n22_), .b(new_n28_), .O(new_n33_));
  nand4  g17(.a(new_n33_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z6));
  one    g18(.O(z1));
  one    g19(.O(z5));
  nand2  g20(.a(new_n16_), .b(x0), .O(z7));
endmodule
