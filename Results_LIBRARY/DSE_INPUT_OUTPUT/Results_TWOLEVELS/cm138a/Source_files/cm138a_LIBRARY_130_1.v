...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n35_, new_n36_, new_n37_, new_n39_, new_n42_;
  ...
  nand3  g13(.a(new_n20_), .b(x3), .c(new_n18_), .O(new_n28_));
  inv1   g14(.a(new_n28_), .O(new_n29_));
  nand3  g15(.a(new_n29_), .b(new_n27_), .c(new_n16_), .O(z2));
  nand2  g16(.a(x1), .b(x0), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n28_), .c(new_n16_), .O(new_n32_));
  nand2  g18(.a(x4), .b(x1), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n32_), .O(z3));
  oai21  g20(.a(new_n21_), .b(x0), .c(new_n16_), .O(new_n35_));
  nand3  g21(.a(new_n16_), .b(x2), .c(new_n15_), .O(new_n36_));
  inv1   g22(.a(new_n36_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n35_), .O(z4));
  oai21  g24(.a(new_n21_), .b(new_n17_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n37_), .O(z5));
  nand4  g26(.a(new_n27_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z6));
  inv1   g27(.a(new_n31_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z7));
endmodule
