...
module FAU ( 
  ...
  wire new_n15_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_;
  ...
  nand4  g12(.a(new_n20_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x1), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(x3), .O(z6));
  nand4  g15(.a(new_n20_), .b(new_n19_), .c(x2), .d(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x1), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(x3), .O(z7));
  one    g18(.O(z4));
  nand2  g19(.a(x3), .b(new_n15_), .O(z1));
