...
module FAU ( 
  ...
  nand3  g14(.a(new_n15_), .b(new_n16_), .c(x1), .O(new_n29_));
  ...
  nand4  g20(.a(x3), .b(x2), .c(new_n18_), .d(new_n17_), .O(new_n35_));
  ...
  oai21  g27(.a(new_n41_), .b(x0), .c(new_n16_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n30_), .O(z6));
  oai21  g29(.a(new_n41_), .b(new_n17_), .c(new_n16_), .O(new_n44_));
