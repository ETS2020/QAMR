...
module FAU ( 
  ...
  nand3  g11(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n26_));
  inv1   g12(.a(new_n26_), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n15_), .c(new_n16_), .d(x1), .O(z2));
  nand3  g14(.a(new_n19_), .b(x3), .c(x0), .O(new_n29_));
  inv1   g15(.a(new_n29_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n15_), .c(new_n16_), .d(x1), .O(z3));
  one    g17(.O(z4));
  one    g18(.O(z5));
  one    g19(.O(z6));
  one    g20(.O(z7));
