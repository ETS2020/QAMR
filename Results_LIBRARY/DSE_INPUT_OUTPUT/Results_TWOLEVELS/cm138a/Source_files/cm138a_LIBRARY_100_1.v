...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n23_, new_n24_, new_n26_, new_n28_, new_n29_, new_n30_, new_n32_,
  ...
  nand4  g16(.a(new_n30_), .b(new_n28_), .c(new_n15_), .d(new_n21_), .O(z3));
  inv1   g17(.a(x0), .O(new_n32_));
  nor2   g18(.a(new_n21_), .b(x1), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n28_), .c(new_n15_), .d(new_n32_), .O(z4));
  nand3  g20(.a(new_n16_), .b(x3), .c(x2), .O(new_n35_));
  nor2   g21(.a(new_n35_), .b(new_n23_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(z5));
  nor2   g23(.a(new_n21_), .b(new_n22_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n28_), .c(new_n15_), .d(new_n32_), .O(z6));
  oai21  g25(.a(new_n35_), .b(new_n29_), .c(new_n15_), .O(new_n40_));
  nand2  g26(.a(x5), .b(x2), .O(new_n41_));
