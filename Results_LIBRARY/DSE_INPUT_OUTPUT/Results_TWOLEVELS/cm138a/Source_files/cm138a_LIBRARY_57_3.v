...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    ...
    new_n32_, new_n34_, new_n36_, new_n38_, new_n39_, new_n41_;
  ...
  nand2  g14(.a(x5), .b(new_n26_), .O(new_n29_));
  ...
  nor2   g21(.a(new_n25_), .b(new_n21_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand3  g23(.a(new_n26_), .b(x3), .c(x2), .O(new_n38_));
  nor2   g24(.a(new_n38_), .b(new_n24_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n16_), .O(z6));
  oai21  g26(.a(new_n38_), .b(new_n31_), .c(new_n16_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n29_), .O(z7));
endmodule
