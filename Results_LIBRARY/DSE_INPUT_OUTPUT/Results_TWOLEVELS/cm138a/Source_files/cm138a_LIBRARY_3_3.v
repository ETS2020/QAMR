...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(new_n19_), .c(new_n18_), .d(x3), .O(new_n24_));
  nand2  g10(.a(new_n24_), .b(new_n17_), .O(new_n25_));
  nand2  g11(.a(new_n25_), .b(x0), .O(z1));
  nor2   g12(.a(x2), .b(new_n16_), .O(new_n27_));
  nand2  g13(.a(new_n25_), .b(new_n27_), .O(z2));
  nand3  g14(.a(new_n21_), .b(new_n27_), .c(x0), .O(z3));
  nand3  g15(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n30_));
  inv1   g16(.a(new_n30_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g18(.a(new_n31_), .b(x2), .c(x1), .d(new_n15_), .O(z6));
