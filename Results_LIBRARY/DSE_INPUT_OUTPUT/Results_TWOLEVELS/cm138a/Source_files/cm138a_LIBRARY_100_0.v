...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
  ...
  nand4  g08(.a(new_n25_), .b(new_n17_), .c(x2), .d(new_n21_), .O(z4));
  nand3  g09(.a(new_n23_), .b(x3), .c(x0), .O(new_n27_));
  inv1   g10(.a(new_n27_), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n17_), .c(x2), .d(new_n21_), .O(z5));
  inv1   g12(.a(x3), .O(new_n30_));
  nor2   g13(.a(x4), .b(new_n30_), .O(new_n31_));
  nor2   g14(.a(new_n21_), .b(x0), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n17_), .d(x2), .O(z6));
  nand4  g16(.a(new_n23_), .b(x3), .c(x1), .d(x0), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x2), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n17_), .O(z7));
  one    g19(.O(z0));
  one    g20(.O(z2));
  one    g21(.O(z3));
endmodule
