...
module FAU ( 
  ...
  nand2  g12(.a(new_n24_), .b(new_n17_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(x1), .O(z2));
  nand2  g14(.a(x1), .b(x0), .O(z3));
  inv1   g15(.a(new_n20_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(x2), .c(new_n17_), .O(z4));
  nand3  g17(.a(new_n19_), .b(new_n18_), .c(x3), .O(new_n32_));
  inv1   g18(.a(new_n32_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(x2), .c(new_n15_), .d(x0), .O(z5));
  nand4  g20(.a(new_n33_), .b(x2), .c(x1), .d(new_n17_), .O(z6));
