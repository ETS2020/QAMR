...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    ...
    new_n32_, new_n36_, new_n37_, new_n38_, new_n39_, new_n41_;
  ...
  nand3  g19(.a(new_n20_), .b(x3), .c(x2), .O(z4));
  nand3  g20(.a(new_n23_), .b(x3), .c(x2), .O(z5));
  inv1   g21(.a(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(new_n37_));
  nand3  g23(.a(new_n26_), .b(new_n25_), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n28_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n37_), .O(z6));
  oai21  g26(.a(new_n38_), .b(new_n31_), .c(x3), .O(new_n41_));
