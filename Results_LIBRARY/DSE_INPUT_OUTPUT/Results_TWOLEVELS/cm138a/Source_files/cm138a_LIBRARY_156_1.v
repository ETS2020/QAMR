...
module FAU ( 
  ...
  nor2   g16(.a(new_n15_), .b(new_n21_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n19_), .c(new_n16_), .d(new_n25_), .O(z3));
  nor2   g18(.a(new_n25_), .b(x0), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g20(.a(new_n26_), .b(x3), .c(x2), .d(x0), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(z5));
  inv1   g23(.a(new_n24_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g25(.a(new_n31_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z7));
endmodule
