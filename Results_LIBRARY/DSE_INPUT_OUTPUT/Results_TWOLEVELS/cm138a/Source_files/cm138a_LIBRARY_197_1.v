...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    ...
    new_n33_, new_n34_, new_n35_, new_n37_, new_n40_, new_n41_;
  ...
  nand2  g16(.a(x5), .b(x1), .O(new_n31_));
  ...
  nor2   g22(.a(new_n21_), .b(new_n33_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand4  g24(.a(new_n26_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z6));
  nand3  g25(.a(new_n22_), .b(x3), .c(x2), .O(new_n40_));
