...
module FAU ( 
  ...
  oai21  g12(.a(new_n17_), .b(new_n15_), .c(new_n16_), .O(new_n28_));
  nand2  g13(.a(new_n19_), .b(x0), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n28_), .O(z3));
  nand3  g15(.a(new_n18_), .b(x3), .c(x2), .O(new_n31_));
  inv1   g16(.a(new_n31_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n16_), .c(new_n15_), .O(z4));
  nand2  g18(.a(x2), .b(new_n16_), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(new_n24_), .c(x0), .O(new_n35_));
  nand2  g20(.a(new_n16_), .b(new_n15_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n35_), .O(z5));
  nand3  g22(.a(new_n34_), .b(new_n32_), .c(x0), .O(z7));
  one    g23(.O(z2));
  one    g24(.O(z6));
endmodule
