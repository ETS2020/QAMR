...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n24_, new_n25_, new_n26_, new_n29_, new_n31_, new_n32_;
  ...
  nand4  g14(.a(new_n29_), .b(new_n25_), .c(new_n15_), .d(new_n16_), .O(z4));
  nand4  g15(.a(new_n19_), .b(x3), .c(x2), .d(x1), .O(new_n31_));
