...
module FAU ( 
  ...
  nand3  g09(.a(new_n22_), .b(new_n21_), .c(x2), .O(new_n28_));
  inv1   g10(.a(new_n28_), .O(new_n29_));
  nand4  g11(.a(new_n29_), .b(x3), .c(x1), .d(new_n17_), .O(z6));
  nand4  g12(.a(new_n22_), .b(new_n21_), .c(x2), .d(x0), .O(new_n31_));
  nand2  g13(.a(new_n31_), .b(x1), .O(new_n32_));
  nand2  g14(.a(new_n32_), .b(x3), .O(z7));
  one    g15(.O(z0));
  one    g16(.O(z1));
  one    g17(.O(z4));
  one    g18(.O(z5));
