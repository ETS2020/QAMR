...
module FAU ( 
  ...
  nand3  g12(.a(x3), .b(new_n19_), .c(new_n17_), .O(new_n27_));
  ...
  nand3  g17(.a(x3), .b(new_n19_), .c(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n30_), .O(z3));
  nor2   g20(.a(x1), .b(x0), .O(new_n35_));
  nand2  g21(.a(x3), .b(x2), .O(new_n36_));
  inv1   g22(.a(new_n36_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n35_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g24(.a(x3), .b(x2), .c(new_n18_), .d(x0), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n15_), .O(z5));
  oai21  g27(.a(new_n36_), .b(x0), .c(new_n16_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n30_), .O(z6));
  oai21  g29(.a(new_n36_), .b(new_n17_), .c(new_n16_), .O(new_n44_));
