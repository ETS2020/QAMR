...
module FAU ( 
  ...
  nand3  g13(.a(new_n19_), .b(x3), .c(new_n18_), .O(new_n28_));
  oai21  g14(.a(new_n28_), .b(new_n27_), .c(new_n16_), .O(new_n29_));
  nand2  g15(.a(x5), .b(x1), .O(new_n30_));
  ...
  nand4  g20(.a(new_n19_), .b(x3), .c(x2), .d(new_n17_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(z4));
  nor2   g23(.a(new_n18_), .b(new_n17_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand3  g25(.a(new_n19_), .b(x3), .c(x2), .O(new_n40_));
  oai21  g26(.a(new_n40_), .b(new_n27_), .c(new_n16_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n30_), .O(z6));
  oai21  g28(.a(new_n40_), .b(new_n32_), .c(new_n16_), .O(new_n43_));
