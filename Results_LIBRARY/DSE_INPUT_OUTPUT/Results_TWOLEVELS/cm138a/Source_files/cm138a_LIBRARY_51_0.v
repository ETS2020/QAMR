...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(new_n17_), .c(x3), .d(new_n22_), .O(z2));
  inv1   g10(.a(x4), .O(new_n25_));
  inv1   g11(.a(x5), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n25_), .c(new_n22_), .O(new_n27_));
