...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n22_,
    ...
    new_n32_, new_n34_, new_n35_, new_n38_;
  ...
  oai21  g17(.a(new_n31_), .b(new_n19_), .c(new_n15_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n25_), .O(z3));
  nand3  g19(.a(new_n18_), .b(x3), .c(x2), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n16_), .c(new_n15_), .O(z4));
  nand4  g22(.a(new_n35_), .b(new_n15_), .c(new_n22_), .d(x0), .O(z5));
  oai21  g23(.a(new_n34_), .b(new_n28_), .c(new_n15_), .O(new_n38_));
