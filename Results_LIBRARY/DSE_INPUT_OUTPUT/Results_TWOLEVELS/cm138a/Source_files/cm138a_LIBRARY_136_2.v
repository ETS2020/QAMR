...
module FAU ( 
  ...
  nand2  g08(.a(new_n23_), .b(x0), .O(z3));
  inv1   g09(.a(x5), .O(new_n25_));
  nand4  g10(.a(new_n25_), .b(x3), .c(x2), .d(new_n16_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n15_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n23_), .O(z4));
  and2   g13(.a(x2), .b(x1), .O(new_n29_));
  nand4  g14(.a(new_n29_), .b(new_n18_), .c(new_n23_), .d(new_n15_), .O(z6));
  one    g15(.O(z1));
  one    g16(.O(z7));
  nand2  g17(.a(new_n23_), .b(x0), .O(z5));
endmodule
