...
module FAU ( 
  ...
  nand4  g21(.a(new_n34_), .b(new_n16_), .c(new_n18_), .d(x0), .O(z5));
  oai21  g22(.a(new_n33_), .b(new_n27_), .c(new_n16_), .O(new_n37_));
  nand2  g23(.a(x5), .b(x2), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n37_), .O(z6));
  nand4  g25(.a(new_n34_), .b(new_n16_), .c(x1), .d(x0), .O(z7));
endmodule
