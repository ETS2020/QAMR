...
module FAU ( 
  ...
  nand3  g18(.a(x2), .b(new_n21_), .c(new_n26_), .O(new_n33_));
  inv1   g19(.a(new_n33_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n18_), .O(z4));
  nand3  g21(.a(x2), .b(new_n21_), .c(x0), .O(new_n36_));
  inv1   g22(.a(new_n36_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n18_), .O(z5));
  one    g24(.O(z6));
  one    g25(.O(z7));
endmodule
