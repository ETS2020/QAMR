...
module FAU ( 
  ...
  nor2   g21(.a(x1), .b(new_n17_), .O(new_n36_));
  nor2   g22(.a(new_n29_), .b(new_n19_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n36_), .c(new_n16_), .d(new_n15_), .O(z5));
  nor2   g24(.a(new_n18_), .b(x0), .O(new_n39_));
  nand4  g25(.a(new_n37_), .b(new_n39_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand4  g26(.a(new_n37_), .b(new_n31_), .c(new_n16_), .d(new_n15_), .O(z7));
endmodule
