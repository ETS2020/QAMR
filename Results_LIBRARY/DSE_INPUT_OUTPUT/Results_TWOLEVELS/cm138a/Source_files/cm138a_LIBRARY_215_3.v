...
module FAU ( 
  ...
  nand4  g13(.a(new_n20_), .b(x3), .c(new_n19_), .d(x1), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n15_), .O(new_n29_));
  nor2   g15(.a(x4), .b(x0), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n29_), .O(z2));
  nand2  g17(.a(new_n29_), .b(x0), .O(z3));
  nand4  g18(.a(new_n20_), .b(x3), .c(x2), .d(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n30_), .O(z4));
  nand2  g21(.a(new_n34_), .b(x0), .O(z5));
  nand4  g22(.a(new_n20_), .b(x3), .c(x2), .d(x1), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n30_), .O(z6));
  nand2  g25(.a(new_n38_), .b(x0), .O(z7));
endmodule
