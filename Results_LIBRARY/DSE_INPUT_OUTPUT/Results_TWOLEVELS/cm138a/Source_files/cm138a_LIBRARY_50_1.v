...
module FAU ( 
  ...
  nand4  g13(.a(new_n27_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z2));
  nor2   g14(.a(new_n18_), .b(new_n17_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z3));
  ...
  nand4  g26(.a(new_n40_), .b(new_n29_), .c(new_n16_), .d(new_n15_), .O(z7));
endmodule
