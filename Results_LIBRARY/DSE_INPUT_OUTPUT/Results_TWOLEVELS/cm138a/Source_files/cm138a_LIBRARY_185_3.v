...
module FAU ( 
  ...
  nand4  g18(.a(new_n32_), .b(new_n30_), .c(new_n15_), .d(x2), .O(z4));
  nand2  g19(.a(new_n17_), .b(x0), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x2), .O(z5));
  nand4  g22(.a(new_n27_), .b(new_n32_), .c(new_n15_), .d(x2), .O(z6));
  nand2  g23(.a(x1), .b(x0), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n31_), .c(new_n15_), .O(new_n39_));
