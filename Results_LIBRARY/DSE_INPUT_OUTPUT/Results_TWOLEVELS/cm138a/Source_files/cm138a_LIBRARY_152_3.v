...
module FAU ( 
  ...
  oai21  g21(.a(new_n33_), .b(new_n23_), .c(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n25_), .O(z5));
  oai21  g23(.a(new_n33_), .b(new_n27_), .c(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n25_), .O(z6));
  inv1   g25(.a(new_n33_), .O(new_n40_));
  nand3  g26(.a(new_n40_), .b(new_n30_), .c(new_n17_), .O(z7));
endmodule
