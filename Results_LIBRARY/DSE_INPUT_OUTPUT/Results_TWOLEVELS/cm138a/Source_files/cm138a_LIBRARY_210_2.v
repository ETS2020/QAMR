...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n23_,
    ...
    new_n32_, new_n35_, new_n36_, new_n38_, new_n39_, new_n41_, new_n42_;
  inv1   g00(.a(x2), .O(new_n15_));
  nor2   g01(.a(x1), .b(x0), .O(new_n16_));
  nor2   g02(.a(x5), .b(x4), .O(new_n17_));
  nand4  g03(.a(new_n17_), .b(new_n16_), .c(x3), .d(new_n15_), .O(z0));
  inv1   g04(.a(x1), .O(new_n19_));
  nand3  g05(.a(new_n17_), .b(new_n15_), .c(new_n19_), .O(new_n20_));
  ...
  nand4  g19(.a(new_n17_), .b(new_n16_), .c(x3), .d(x2), .O(z4));
  nand3  g20(.a(new_n17_), .b(x2), .c(new_n19_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x0), .O(z5));
  nand3  g23(.a(new_n24_), .b(new_n23_), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n27_), .c(x3), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n30_), .O(z6));
  nand3  g26(.a(new_n17_), .b(x2), .c(x1), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(x3), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(x0), .O(z7));
endmodule
