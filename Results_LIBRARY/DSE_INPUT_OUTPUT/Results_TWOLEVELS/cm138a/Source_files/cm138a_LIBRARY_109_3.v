...
module FAU ( 
  ...
  nor2   g18(.a(x5), .b(new_n18_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(new_n15_), .d(x3), .O(z4));
  nor2   g20(.a(x1), .b(new_n16_), .O(new_n35_));
  nand4  g21(.a(new_n33_), .b(new_n35_), .c(new_n15_), .d(x3), .O(z5));
  nand4  g22(.a(new_n33_), .b(new_n27_), .c(new_n15_), .d(x3), .O(z6));
