...
module FAU ( 
  ...
  nand2  g19(.a(new_n33_), .b(new_n26_), .O(z3));
  nor2   g20(.a(new_n18_), .b(x1), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n29_), .c(new_n16_), .d(new_n15_), .O(z4));
  ...
  nor2   g25(.a(new_n18_), .b(new_n17_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n29_), .c(new_n16_), .d(new_n15_), .O(z6));
  oai21  g27(.a(new_n37_), .b(new_n32_), .c(new_n16_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n26_), .O(z7));
endmodule
