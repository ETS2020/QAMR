...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n25_, new_n26_, new_n29_, new_n30_, new_n33_, new_n34_;
  ...
  nand4  g09(.a(new_n20_), .b(x3), .c(new_n19_), .d(x1), .O(new_n25_));
  nand2  g10(.a(new_n25_), .b(x0), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n16_), .O(z3));
  nand4  g12(.a(new_n20_), .b(x3), .c(x2), .d(new_n18_), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(x0), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n16_), .O(z5));
  nand4  g15(.a(new_n20_), .b(x3), .c(x2), .d(x1), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(x0), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n16_), .O(z7));
  one    g18(.O(z2));
  one    g19(.O(z4));
  one    g20(.O(z6));
endmodule
