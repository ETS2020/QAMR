...
module FAU ( 
  ...
  oai21  g13(.a(new_n17_), .b(new_n15_), .c(new_n16_), .O(new_n28_));
  ...
  oai21  g21(.a(new_n35_), .b(new_n24_), .c(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n34_), .O(z5));
  oai21  g23(.a(x2), .b(new_n15_), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n31_), .b(x0), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n38_), .O(z7));
  nand2  g26(.a(x1), .b(new_n15_), .O(z6));
endmodule
