// Benchmark "FAU" written by ABC on Wed Aug 19 17:16:03 2020
...
module FAU ( 
  ...
  nor2   g14(.a(new_n28_), .b(new_n21_), .O(new_n29_));
  ...
  nand4  g22(.a(new_n36_), .b(new_n34_), .c(new_n15_), .d(x2), .O(z4));
  inv1   g23(.a(new_n25_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n36_), .c(new_n15_), .d(x2), .O(z5));
  oai21  g25(.a(new_n28_), .b(new_n35_), .c(new_n15_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(x2), .O(z6));
  inv1   g27(.a(new_n31_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n36_), .c(new_n15_), .d(x2), .O(z7));
endmodule
