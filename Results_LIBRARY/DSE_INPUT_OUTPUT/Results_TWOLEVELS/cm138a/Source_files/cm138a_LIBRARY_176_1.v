...
module FAU ( 
  ...
  nand4  g15(.a(new_n29_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z2));
  ...
  oai21  g24(.a(new_n33_), .b(new_n28_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n37_), .O(z6));
  nand3  g26(.a(new_n34_), .b(new_n31_), .c(new_n16_), .O(z7));
endmodule
