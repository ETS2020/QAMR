// Benchmark "FAU" written by ABC on Wed Aug 19 17:15:45 2020
...
module FAU ( 
  ...
  nand2  g15(.a(new_n31_), .b(new_n17_), .O(z6));
  nand4  g16(.a(new_n20_), .b(x3), .c(x2), .d(x0), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(x1), .O(new_n34_));
  nand2  g18(.a(new_n34_), .b(new_n17_), .O(z7));
  one    g19(.O(z0));
  one    g20(.O(z1));
  nand2  g21(.a(new_n17_), .b(new_n28_), .O(z5));
endmodule
