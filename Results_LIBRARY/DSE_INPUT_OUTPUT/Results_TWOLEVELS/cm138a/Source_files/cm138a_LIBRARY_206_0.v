...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_,
    new_n25_, new_n26_, new_n27_, new_n31_, new_n33_, new_n34_;
  ...
  nor2   g13(.a(new_n20_), .b(x0), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(new_n26_), .c(new_n17_), .d(x1), .O(z6));
  nand4  g15(.a(new_n21_), .b(x3), .c(x2), .d(x0), .O(new_n33_));
