...
module FAU ( 
  ...
  nor2   g20(.a(x4), .b(new_n20_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n34_), .c(new_n15_), .d(x3), .O(z5));
  nand4  g22(.a(new_n35_), .b(new_n25_), .c(new_n15_), .d(x3), .O(z6));
  nor2   g23(.a(new_n19_), .b(new_n30_), .O(new_n38_));
  nand4  g24(.a(new_n35_), .b(new_n38_), .c(new_n15_), .d(x3), .O(z7));
endmodule
