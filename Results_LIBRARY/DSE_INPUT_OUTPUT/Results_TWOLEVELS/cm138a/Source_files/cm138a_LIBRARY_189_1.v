...
module FAU ( 
  ...
  nand4  g24(.a(new_n38_), .b(new_n36_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand4  g25(.a(new_n38_), .b(new_n28_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand2  g26(.a(x1), .b(x0), .O(new_n41_));
  oai21  g27(.a(new_n37_), .b(new_n41_), .c(new_n16_), .O(new_n42_));
