...
module FAU ( 
  ...
  oai21  g16(.a(new_n30_), .b(new_n19_), .c(new_n16_), .O(new_n31_));
  ...
  oai21  g21(.a(new_n33_), .b(new_n23_), .c(new_n16_), .O(new_n36_));
  ...
  nand4  g26(.a(new_n34_), .b(new_n16_), .c(x1), .d(x0), .O(z7));
endmodule
