...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    new_n23_, new_n25_, new_n26_, new_n27_, new_n29_, new_n30_, new_n33_,
  ...
  nand3  g19(.a(new_n33_), .b(x3), .c(x2), .O(new_n34_));
  oai21  g20(.a(new_n34_), .b(new_n22_), .c(new_n16_), .O(new_n35_));
  nand2  g21(.a(x5), .b(x2), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n35_), .O(z5));
  oai21  g23(.a(new_n34_), .b(new_n26_), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n36_), .O(z6));
  oai21  g25(.a(new_n34_), .b(new_n29_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n36_), .O(z7));
endmodule
