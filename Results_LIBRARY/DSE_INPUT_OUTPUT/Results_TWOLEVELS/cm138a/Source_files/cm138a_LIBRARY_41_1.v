...
module FAU ( 
  ...
  nand2  g11(.a(x4), .b(x0), .O(new_n26_));
  ...
  nor2   g17(.a(new_n31_), .b(new_n24_), .O(new_n32_));
  ...
  nand2  g25(.a(new_n39_), .b(new_n26_), .O(z5));
  ...
  oai21  g29(.a(new_n38_), .b(new_n31_), .c(new_n16_), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(new_n26_), .O(z7));
endmodule
