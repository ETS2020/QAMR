...
module FAU ( 
  ...
  nor2   g14(.a(x5), .b(x2), .O(new_n29_));
  nor2   g15(.a(new_n17_), .b(new_n16_), .O(new_n30_));
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(new_n15_), .d(x3), .O(z3));
  ...
  nand2  g22(.a(new_n36_), .b(x3), .O(z5));
  ...
  nor2   g26(.a(x5), .b(new_n18_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n30_), .c(new_n15_), .d(x3), .O(z7));
endmodule
