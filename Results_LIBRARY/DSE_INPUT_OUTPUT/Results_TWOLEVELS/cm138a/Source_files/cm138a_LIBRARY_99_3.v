...
module FAU ( 
  ...
  nand2  g13(.a(x4), .b(new_n17_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n27_), .O(z3));
  nand2  g15(.a(new_n18_), .b(x3), .O(new_n30_));
  inv1   g16(.a(new_n30_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n16_), .c(new_n15_), .d(x2), .O(z4));
  nand2  g18(.a(new_n22_), .b(x0), .O(new_n33_));
  oai21  g19(.a(new_n33_), .b(new_n30_), .c(new_n15_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(x2), .O(z5));
  nand2  g21(.a(x1), .b(new_n24_), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n30_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z6));
  inv1   g24(.a(new_n26_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n31_), .c(new_n15_), .d(x2), .O(z7));
endmodule
