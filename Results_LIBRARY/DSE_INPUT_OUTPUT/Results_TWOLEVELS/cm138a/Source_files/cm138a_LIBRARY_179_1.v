...
module FAU ( 
  ...
  oai21  g25(.a(new_n39_), .b(new_n24_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n32_), .O(z6));
  nor2   g27(.a(new_n39_), .b(new_n30_), .O(new_n42_));
