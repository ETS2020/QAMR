...
module FAU ( 
  ...
  oai21  g11(.a(new_n25_), .b(new_n21_), .c(new_n16_), .O(new_n26_));
  nand3  g12(.a(new_n26_), .b(new_n23_), .c(new_n15_), .O(z1));
  nand2  g13(.a(x1), .b(new_n17_), .O(new_n28_));
  nand3  g14(.a(new_n20_), .b(x3), .c(new_n15_), .O(new_n29_));
  oai21  g15(.a(new_n29_), .b(new_n28_), .c(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n23_), .O(z2));
  nand2  g17(.a(x1), .b(x0), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n29_), .c(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n23_), .O(z3));
  nand2  g20(.a(new_n22_), .b(x2), .O(z4));
  nand2  g21(.a(new_n26_), .b(x2), .O(z5));
  oai21  g22(.a(new_n28_), .b(new_n21_), .c(new_n16_), .O(new_n37_));
