...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n35_, new_n38_, new_n40_;
  ...
  nand4  g17(.a(new_n31_), .b(new_n24_), .c(new_n15_), .d(new_n16_), .O(z3));
  ...
  nand4  g22(.a(new_n35_), .b(new_n25_), .c(new_n15_), .d(new_n16_), .O(z5));
  nor2   g23(.a(new_n18_), .b(x0), .O(new_n38_));
  nand4  g24(.a(new_n35_), .b(new_n38_), .c(new_n15_), .d(new_n16_), .O(z6));
