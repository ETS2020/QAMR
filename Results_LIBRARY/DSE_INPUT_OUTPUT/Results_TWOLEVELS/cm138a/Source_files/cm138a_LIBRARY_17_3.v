...
module FAU ( 
  ...
  nand2  g11(.a(x5), .b(new_n18_), .O(new_n26_));
  ...
  nand2  g17(.a(new_n19_), .b(x3), .O(new_n32_));
  oai21  g18(.a(new_n32_), .b(new_n31_), .c(new_n17_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x2), .O(z4));
  nand2  g20(.a(new_n16_), .b(x0), .O(new_n35_));
  oai21  g21(.a(new_n35_), .b(new_n32_), .c(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z5));
  oai21  g23(.a(new_n24_), .b(new_n32_), .c(new_n17_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x2), .O(z6));
  oai21  g25(.a(new_n28_), .b(new_n32_), .c(new_n17_), .O(new_n40_));
  nand3  g26(.a(new_n40_), .b(new_n17_), .c(x2), .O(z7));
endmodule
