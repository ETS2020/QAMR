...
module FAU ( 
  ...
  nor2   g12(.a(x1), .b(new_n16_), .O(new_n27_));
  nand4  g13(.a(new_n27_), .b(new_n26_), .c(new_n15_), .d(new_n19_), .O(z1));
  ...
  nand4  g18(.a(new_n32_), .b(new_n26_), .c(new_n15_), .d(x1), .O(z3));
  ...
  nand4  g22(.a(new_n27_), .b(new_n26_), .c(new_n15_), .d(x2), .O(z5));
