...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n23_, new_n25_, new_n26_, new_n28_, new_n30_, new_n32_,
  ...
  inv1   g13(.a(new_n21_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n15_), .c(x1), .d(new_n16_), .O(z2));
  ...
  nand4  g19(.a(new_n33_), .b(new_n15_), .c(new_n17_), .d(new_n16_), .O(z4));
  nand4  g20(.a(new_n33_), .b(new_n15_), .c(new_n17_), .d(x0), .O(z5));
  nand2  g21(.a(x1), .b(new_n16_), .O(new_n36_));
  oai21  g22(.a(new_n32_), .b(new_n36_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n23_), .O(z6));
  nand3  g24(.a(new_n33_), .b(new_n30_), .c(new_n15_), .O(z7));
endmodule
