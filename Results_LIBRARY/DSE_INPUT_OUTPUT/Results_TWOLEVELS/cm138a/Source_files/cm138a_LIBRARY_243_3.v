...
module FAU ( 
  ...
  oai21  g22(.a(new_n36_), .b(new_n33_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z5));
  nand4  g24(.a(new_n27_), .b(new_n34_), .c(new_n15_), .d(x2), .O(z6));
  oai21  g25(.a(new_n29_), .b(new_n33_), .c(new_n15_), .O(new_n40_));
