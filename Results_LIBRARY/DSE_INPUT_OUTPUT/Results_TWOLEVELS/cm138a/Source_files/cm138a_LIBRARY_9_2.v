// Benchmark "FAU" written by ABC on Wed Aug 19 17:14:55 2020
...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n33_, new_n35_, new_n37_, new_n39_;
  ...
  nor2   g18(.a(new_n16_), .b(new_n15_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(x3), .d(new_n18_), .O(z3));
  inv1   g20(.a(new_n17_), .O(new_n35_));
  nand4  g21(.a(new_n32_), .b(new_n35_), .c(x3), .d(x2), .O(z4));
  inv1   g22(.a(new_n26_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n32_), .c(x3), .d(x2), .O(z5));
  inv1   g24(.a(new_n29_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n32_), .c(x3), .d(x2), .O(z6));
  nand4  g26(.a(new_n33_), .b(new_n32_), .c(x3), .d(x2), .O(z7));
endmodule
