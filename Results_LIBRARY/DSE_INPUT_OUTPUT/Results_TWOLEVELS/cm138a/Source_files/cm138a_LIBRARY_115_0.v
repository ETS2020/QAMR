...
module FAU ( 
  ...
  nand3  g13(.a(new_n21_), .b(x3), .c(x2), .O(new_n29_));
  inv1   g14(.a(new_n29_), .O(new_n30_));
  nand4  g15(.a(new_n30_), .b(new_n17_), .c(x1), .d(new_n19_), .O(z6));
  nand4  g16(.a(new_n21_), .b(x3), .c(x2), .d(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(x1), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n17_), .O(z7));
  one    g19(.O(z0));
