...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n26_, new_n29_, new_n30_, new_n32_, new_n33_;
  ...
  nor2   g11(.a(x2), .b(new_n18_), .O(new_n26_));
  nand4  g12(.a(new_n26_), .b(new_n25_), .c(new_n16_), .d(x0), .O(z3));
  nand4  g13(.a(new_n20_), .b(x3), .c(x2), .d(new_n18_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(z5));
  nand4  g16(.a(new_n20_), .b(x3), .c(x2), .d(x1), .O(new_n32_));
