...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n34_, new_n38_, new_n39_;
  ...
  nand4  g20(.a(new_n34_), .b(new_n32_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g21(.a(new_n34_), .b(new_n25_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand4  g22(.a(new_n34_), .b(new_n27_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand2  g23(.a(x1), .b(x0), .O(new_n38_));
  oai21  g24(.a(new_n33_), .b(new_n38_), .c(new_n16_), .O(new_n39_));
