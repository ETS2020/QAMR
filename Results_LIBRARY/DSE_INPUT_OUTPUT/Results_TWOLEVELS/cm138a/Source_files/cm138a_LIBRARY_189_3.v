...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n35_, new_n37_, new_n40_;
  ...
  nand3  g15(.a(new_n29_), .b(new_n28_), .c(new_n15_), .O(z2));
  ...
  nand3  g24(.a(new_n37_), .b(new_n29_), .c(new_n15_), .O(z6));
  oai21  g25(.a(new_n34_), .b(new_n31_), .c(new_n15_), .O(new_n40_));
