...
module FAU ( 
  ...
  nand3  g20(.a(new_n32_), .b(new_n16_), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(x3), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x2), .O(z4));
  inv1   g23(.a(new_n26_), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n32_), .c(x3), .d(x2), .O(z5));
  inv1   g25(.a(new_n29_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n32_), .c(x3), .d(x2), .O(z6));
  nand4  g27(.a(new_n33_), .b(new_n32_), .c(x3), .d(x2), .O(z7));
endmodule
