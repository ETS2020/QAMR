...
module FAU ( 
  ...
  oai21  g13(.a(new_n27_), .b(new_n21_), .c(new_n15_), .O(new_n28_));
  nand2  g14(.a(new_n28_), .b(new_n23_), .O(z2));
  nor2   g15(.a(new_n17_), .b(new_n16_), .O(new_n30_));
  nand3  g16(.a(new_n30_), .b(new_n25_), .c(new_n15_), .O(z3));
  ...
  oai21  g23(.a(new_n32_), .b(new_n27_), .c(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n23_), .O(z6));
  nand3  g25(.a(new_n33_), .b(new_n30_), .c(new_n15_), .O(z7));
endmodule
