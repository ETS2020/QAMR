...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n24_, new_n26_, new_n28_, new_n29_, new_n30_, new_n32_,
  ...
  nand4  g12(.a(new_n26_), .b(new_n22_), .c(new_n16_), .d(x1), .O(z2));
  inv1   g13(.a(x4), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(x3), .c(new_n15_), .d(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x1), .O(z3));
  nand3  g17(.a(new_n28_), .b(x3), .c(x2), .O(new_n32_));
  ...
  nand4  g22(.a(new_n28_), .b(x3), .c(x2), .d(new_n17_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x1), .O(z6));
  nor2   g25(.a(new_n15_), .b(new_n17_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n22_), .c(new_n16_), .d(x1), .O(z7));
endmodule
