...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n29_, new_n30_, new_n32_, new_n33_;
  ...
  nand2  g13(.a(new_n26_), .b(new_n24_), .O(z3));
  nand4  g14(.a(new_n19_), .b(x3), .c(x2), .d(new_n17_), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n16_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z4));
  nand4  g17(.a(new_n19_), .b(x3), .c(x2), .d(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(new_n15_), .O(z5));
  nand2  g20(.a(new_n30_), .b(new_n26_), .O(z6));
  nand2  g21(.a(new_n33_), .b(new_n26_), .O(z7));
endmodule
