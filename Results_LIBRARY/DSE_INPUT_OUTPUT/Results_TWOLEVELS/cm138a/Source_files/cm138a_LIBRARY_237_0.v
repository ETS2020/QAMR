...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n24_, new_n25_, new_n28_, new_n29_, new_n31_, new_n32_, new_n33_;
  ...
  nand4  g12(.a(new_n20_), .b(x3), .c(x2), .d(new_n18_), .O(new_n28_));
  ...
  nor2   g17(.a(new_n19_), .b(new_n18_), .O(new_n33_));
  nand4  g18(.a(new_n33_), .b(new_n32_), .c(new_n16_), .d(x0), .O(z7));
  one    g19(.O(z4));
