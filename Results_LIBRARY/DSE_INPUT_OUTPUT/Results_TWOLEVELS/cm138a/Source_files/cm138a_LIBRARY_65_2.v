...
module FAU ( 
  ...
  nand4  g12(.a(x3), .b(new_n18_), .c(x1), .d(new_n17_), .O(new_n27_));
  ...
  oai21  g19(.a(new_n33_), .b(x0), .c(new_n16_), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n21_), .c(x2), .d(new_n15_), .O(z4));
  oai21  g21(.a(new_n33_), .b(new_n17_), .c(new_n16_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n21_), .c(x2), .d(new_n15_), .O(z5));
  nand2  g23(.a(x3), .b(x1), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(x0), .c(new_n16_), .O(new_n39_));
  nand3  g25(.a(new_n39_), .b(new_n21_), .c(x2), .O(z6));
  oai21  g26(.a(new_n38_), .b(new_n17_), .c(new_n16_), .O(new_n41_));
  nand3  g27(.a(new_n41_), .b(new_n21_), .c(x2), .O(z7));
endmodule
