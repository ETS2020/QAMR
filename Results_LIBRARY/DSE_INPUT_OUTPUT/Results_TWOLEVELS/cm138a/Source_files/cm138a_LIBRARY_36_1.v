...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n33_, new_n36_, new_n38_, new_n39_, new_n40_;
  ...
  nand4  g20(.a(new_n25_), .b(new_n24_), .c(new_n16_), .d(x2), .O(z5));
  nor2   g21(.a(new_n18_), .b(new_n17_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n24_), .c(new_n16_), .d(new_n15_), .O(z6));
  nand3  g23(.a(new_n19_), .b(x3), .c(x2), .O(new_n38_));
  oai21  g24(.a(new_n38_), .b(new_n30_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(x5), .b(x0), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n39_), .O(z7));
endmodule
