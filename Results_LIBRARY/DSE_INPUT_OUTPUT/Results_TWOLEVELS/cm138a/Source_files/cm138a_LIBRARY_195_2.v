...
module FAU ( 
  ...
  nor2   g22(.a(x1), .b(new_n17_), .O(new_n37_));
  nand2  g23(.a(x3), .b(x2), .O(new_n38_));
  inv1   g24(.a(new_n38_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n37_), .c(new_n15_), .d(new_n16_), .O(z5));
  nor2   g26(.a(new_n18_), .b(x0), .O(new_n41_));
  nand4  g27(.a(new_n39_), .b(new_n41_), .c(new_n15_), .d(new_n16_), .O(z6));
  oai21  g28(.a(new_n38_), .b(new_n31_), .c(new_n16_), .O(new_n43_));
