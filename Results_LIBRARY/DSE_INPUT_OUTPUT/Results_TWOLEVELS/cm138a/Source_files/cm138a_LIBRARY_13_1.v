...
module FAU ( 
  ...
  nand2  g15(.a(x5), .b(x3), .O(new_n30_));
  ...
  nand2  g21(.a(new_n35_), .b(new_n30_), .O(z4));
  nor2   g22(.a(new_n19_), .b(x1), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n25_), .c(new_n15_), .d(x0), .O(z5));
  ...
  nand4  g27(.a(new_n41_), .b(new_n25_), .c(new_n15_), .d(x0), .O(z7));
endmodule
