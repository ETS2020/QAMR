...
module FAU ( 
  ...
  nand4  g09(.a(new_n23_), .b(new_n18_), .c(x3), .d(new_n15_), .O(z1));
  nand2  g10(.a(x1), .b(new_n16_), .O(new_n25_));
  inv1   g11(.a(new_n25_), .O(new_n26_));
  nand4  g12(.a(new_n26_), .b(new_n18_), .c(x3), .d(new_n15_), .O(z2));
  ...
  nand4  g20(.a(new_n34_), .b(x3), .c(new_n17_), .d(new_n16_), .O(z4));
  oai21  g21(.a(new_n33_), .b(new_n22_), .c(x3), .O(new_n36_));
  inv1   g22(.a(x3), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n36_), .O(z5));
  oai21  g25(.a(new_n33_), .b(new_n25_), .c(x3), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n38_), .O(z6));
  nand2  g27(.a(x1), .b(x0), .O(new_n42_));
  oai21  g28(.a(new_n33_), .b(new_n42_), .c(x3), .O(new_n43_));
  nand2  g29(.a(new_n43_), .b(new_n38_), .O(z7));
endmodule
