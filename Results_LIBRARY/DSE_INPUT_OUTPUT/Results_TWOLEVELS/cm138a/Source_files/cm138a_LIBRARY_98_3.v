...
module FAU ( 
  ...
  nand3  g13(.a(x2), .b(new_n21_), .c(new_n28_), .O(new_n29_));
  inv1   g14(.a(new_n29_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n18_), .O(z4));
  nand3  g16(.a(x2), .b(new_n21_), .c(x0), .O(new_n32_));
  inv1   g17(.a(new_n32_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n18_), .O(z5));
  one    g19(.O(z2));
  one    g20(.O(z6));
