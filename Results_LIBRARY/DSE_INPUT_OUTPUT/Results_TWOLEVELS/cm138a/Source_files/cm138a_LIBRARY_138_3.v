...
module FAU ( 
  ...
  nand4  g20(.a(new_n29_), .b(new_n34_), .c(new_n15_), .d(x2), .O(z4));
  inv1   g21(.a(new_n25_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n29_), .c(new_n15_), .d(x2), .O(z5));
  nand4  g23(.a(new_n20_), .b(x3), .c(x2), .d(new_n16_), .O(new_n38_));
