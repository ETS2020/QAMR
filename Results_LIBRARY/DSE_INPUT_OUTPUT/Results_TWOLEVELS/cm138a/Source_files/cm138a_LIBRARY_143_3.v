...
module FAU ( 
  ...
  oai21  g12(.a(x4), .b(x2), .c(new_n16_), .O(new_n27_));
  ...
  oai21  g17(.a(x4), .b(x1), .c(new_n16_), .O(new_n32_));
  ...
  aoi21  g23(.a(new_n16_), .b(x4), .c(x0), .O(new_n38_));
  nand4  g24(.a(new_n38_), .b(new_n37_), .c(new_n16_), .d(x1), .O(z6));
  oai21  g25(.a(x4), .b(new_n15_), .c(new_n16_), .O(new_n40_));
