...
module FAU ( 
  ...
  nand4  g11(.a(new_n25_), .b(new_n24_), .c(new_n17_), .d(new_n16_), .O(z1));
  ...
  oai21  g16(.a(new_n30_), .b(new_n20_), .c(new_n17_), .O(new_n31_));
  nand2  g17(.a(x4), .b(x0), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z3));
  nand3  g19(.a(new_n19_), .b(x3), .c(x2), .O(new_n34_));
  inv1   g20(.a(new_n34_), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n17_), .c(new_n16_), .d(new_n15_), .O(z4));
  nor2   g22(.a(new_n18_), .b(new_n15_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n24_), .c(new_n17_), .d(new_n16_), .O(z5));
  nor2   g24(.a(new_n18_), .b(new_n16_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n24_), .c(new_n17_), .d(new_n15_), .O(z6));
  oai21  g26(.a(new_n34_), .b(new_n30_), .c(new_n17_), .O(new_n41_));
  nand2  g27(.a(new_n41_), .b(new_n32_), .O(z7));
endmodule
