...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n21_, new_n22_, new_n23_, new_n24_, new_n25_,
  ...
  nand2  g08(.a(new_n25_), .b(new_n16_), .O(z4));
  ...
  nor2   g13(.a(x5), .b(new_n30_), .O(new_n31_));
  nor2   g14(.a(new_n22_), .b(x0), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n16_), .d(x2), .O(z6));
  nor2   g16(.a(new_n22_), .b(new_n21_), .O(new_n34_));
  nand4  g17(.a(new_n34_), .b(new_n31_), .c(new_n16_), .d(x2), .O(z7));
  one    g18(.O(z1));
  one    g19(.O(z2));
  one    g20(.O(z3));
endmodule
