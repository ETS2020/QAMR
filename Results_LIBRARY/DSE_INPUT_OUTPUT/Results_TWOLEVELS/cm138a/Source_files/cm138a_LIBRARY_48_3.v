...
module FAU ( 
  ...
  nand4  g19(.a(new_n20_), .b(x3), .c(x2), .d(new_n16_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n23_), .c(new_n17_), .O(z4));
  nand4  g22(.a(new_n20_), .b(x3), .c(x2), .d(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(new_n38_));
  nand3  g24(.a(new_n38_), .b(new_n15_), .c(new_n17_), .O(z5));
