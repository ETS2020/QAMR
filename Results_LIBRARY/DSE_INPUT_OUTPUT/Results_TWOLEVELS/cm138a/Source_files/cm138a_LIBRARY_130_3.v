...
module FAU ( 
  ...
  nand4  g22(.a(new_n26_), .b(new_n29_), .c(new_n15_), .d(x2), .O(z5));
  oai21  g23(.a(new_n28_), .b(x0), .c(new_n15_), .O(new_n38_));
  nand3  g24(.a(new_n15_), .b(x2), .c(x1), .O(new_n39_));
  inv1   g25(.a(new_n39_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n38_), .O(z6));
  oai21  g27(.a(new_n28_), .b(new_n16_), .c(new_n15_), .O(new_n42_));
