...
module FAU ( 
  ...
  nand3  g12(.a(new_n19_), .b(x3), .c(new_n17_), .O(new_n27_));
  inv1   g13(.a(new_n27_), .O(new_n28_));
  nand4  g14(.a(new_n28_), .b(new_n15_), .c(new_n16_), .d(x1), .O(z2));
  nand3  g15(.a(new_n19_), .b(x3), .c(x0), .O(new_n30_));
  inv1   g16(.a(new_n30_), .O(new_n31_));
  nand4  g17(.a(new_n31_), .b(new_n15_), .c(new_n16_), .d(x1), .O(z3));
  nand2  g18(.a(new_n15_), .b(x2), .O(z4));
  one    g19(.O(z6));
  one    g20(.O(z7));
  nand2  g21(.a(new_n15_), .b(x2), .O(z5));
endmodule
