...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n35_, new_n36_, new_n37_, new_n39_;
  ...
  nand3  g15(.a(new_n24_), .b(x3), .c(x1), .O(new_n30_));
  ...
  oai21  g20(.a(new_n16_), .b(new_n15_), .c(new_n17_), .O(new_n35_));
  nand3  g21(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n35_), .O(z5));
  oai21  g24(.a(x1), .b(new_n15_), .c(new_n17_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n31_), .O(z7));
  nand2  g26(.a(x2), .b(new_n15_), .O(z6));
endmodule
