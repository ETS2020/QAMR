...
module FAU ( 
  ...
  nor2   g14(.a(x2), .b(new_n19_), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n17_), .c(x3), .d(new_n15_), .O(z2));
  nand2  g16(.a(x1), .b(x0), .O(new_n31_));
  oai21  g17(.a(new_n31_), .b(new_n24_), .c(x3), .O(new_n32_));
  ...
  oai21  g27(.a(new_n36_), .b(new_n31_), .c(x3), .O(new_n42_));
