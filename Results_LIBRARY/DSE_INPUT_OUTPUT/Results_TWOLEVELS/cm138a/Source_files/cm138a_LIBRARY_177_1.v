...
module FAU ( 
  ...
  nand4  g15(.a(new_n28_), .b(new_n15_), .c(x1), .d(x0), .O(z3));
  ...
  nor2   g19(.a(new_n31_), .b(new_n25_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(z5));
  nand2  g21(.a(x1), .b(new_n16_), .O(new_n36_));
  oai21  g22(.a(new_n31_), .b(new_n36_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n23_), .O(z6));
  nand2  g24(.a(x1), .b(x0), .O(new_n39_));
  oai21  g25(.a(new_n31_), .b(new_n39_), .c(new_n15_), .O(new_n40_));
