...
module FAU ( 
  ...
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(new_n15_), .d(new_n16_), .O(z4));
  ...
  nand4  g24(.a(new_n33_), .b(new_n38_), .c(new_n15_), .d(new_n16_), .O(z6));
  nand4  g25(.a(new_n33_), .b(new_n30_), .c(new_n15_), .d(new_n16_), .O(z7));
endmodule
