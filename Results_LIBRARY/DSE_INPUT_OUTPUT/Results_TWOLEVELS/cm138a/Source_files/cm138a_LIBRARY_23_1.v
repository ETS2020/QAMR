...
module FAU ( 
  ...
  nand3  g21(.a(new_n34_), .b(new_n25_), .c(new_n16_), .O(z5));
  nand4  g22(.a(new_n34_), .b(new_n16_), .c(x1), .d(new_n17_), .O(z6));
  oai21  g23(.a(new_n33_), .b(new_n30_), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(x5), .b(x2), .O(new_n39_));
