...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n21_, new_n22_,
    ...
    new_n32_, new_n34_, new_n36_, new_n37_, new_n39_, new_n41_;
  ...
  nor2   g19(.a(new_n25_), .b(x0), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand4  g21(.a(new_n26_), .b(x3), .c(x2), .d(x0), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(z5));
  inv1   g24(.a(new_n24_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n19_), .c(new_n16_), .d(x2), .O(z6));
  inv1   g26(.a(new_n31_), .O(new_n41_));
