...
module FAU ( 
  ...
  nand4  g21(.a(new_n20_), .b(x3), .c(x2), .d(new_n17_), .O(new_n36_));
  nand2  g22(.a(new_n36_), .b(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x0), .O(z5));
  nor2   g24(.a(new_n19_), .b(x0), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n26_), .c(new_n15_), .d(x1), .O(z6));
  inv1   g26(.a(new_n33_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n15_), .c(x1), .d(x0), .O(z7));
endmodule
