// Benchmark "FAU" written by ABC on Wed Aug 19 17:15:50 2020
...
module FAU ( 
  ...
  oai21  g16(.a(new_n30_), .b(new_n27_), .c(new_n16_), .O(new_n31_));
  nand2  g17(.a(x4), .b(x1), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n31_), .O(z3));
  nand4  g19(.a(new_n19_), .b(x3), .c(x2), .d(new_n17_), .O(new_n34_));
  ...
  nor2   g24(.a(new_n18_), .b(new_n17_), .O(new_n39_));
  nand4  g25(.a(new_n39_), .b(new_n38_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand3  g26(.a(new_n19_), .b(x3), .c(x2), .O(new_n41_));
  oai21  g27(.a(new_n41_), .b(new_n26_), .c(new_n16_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n32_), .O(z6));
  nor2   g29(.a(new_n41_), .b(new_n30_), .O(new_n44_));
  nand2  g30(.a(new_n44_), .b(new_n16_), .O(z7));
endmodule
