...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n22_, new_n25_, new_n26_, new_n28_, new_n30_, new_n32_, new_n33_,
  ...
  nand2  g16(.a(new_n26_), .b(new_n15_), .O(new_n32_));
  nand4  g17(.a(new_n18_), .b(new_n17_), .c(x3), .d(new_n21_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(x2), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n32_), .O(z5));
  nand2  g20(.a(x1), .b(new_n15_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(x2), .O(new_n37_));
  nand4  g22(.a(new_n18_), .b(new_n17_), .c(x3), .d(x2), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n15_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n37_), .O(z6));
  nor2   g25(.a(x5), .b(x4), .O(new_n41_));
  and2   g26(.a(x3), .b(x1), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n36_), .c(new_n41_), .d(x2), .O(z7));
  one    g28(.O(z1));
endmodule
