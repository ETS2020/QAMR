...
module FAU ( 
  ...
  nand2  g20(.a(x4), .b(x2), .O(new_n35_));
  ...
  oai21  g24(.a(new_n33_), .b(new_n27_), .c(new_n16_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n35_), .O(z6));
  inv1   g26(.a(new_n33_), .O(new_n41_));
  nand3  g27(.a(new_n41_), .b(new_n31_), .c(new_n16_), .O(z7));
endmodule
