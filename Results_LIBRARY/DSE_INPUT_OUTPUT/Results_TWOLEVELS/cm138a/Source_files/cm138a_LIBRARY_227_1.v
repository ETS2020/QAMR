...
module FAU ( 
  ...
  nand4  g18(.a(new_n32_), .b(new_n27_), .c(new_n16_), .d(new_n18_), .O(z3));
  ...
  nand4  g23(.a(new_n37_), .b(new_n27_), .c(new_n16_), .d(new_n15_), .O(z5));
  ...
  oai21  g28(.a(new_n39_), .b(new_n31_), .c(new_n16_), .O(new_n43_));
