...
module FAU ( 
  ...
  nor2   g15(.a(new_n29_), .b(new_n21_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n15_), .O(z2));
  nor2   g17(.a(x2), .b(new_n17_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n26_), .c(new_n15_), .d(x0), .O(z3));
  nand3  g19(.a(new_n20_), .b(x3), .c(x2), .O(new_n34_));
  nor2   g20(.a(new_n34_), .b(new_n18_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n15_), .O(z4));
  nor2   g22(.a(new_n19_), .b(x1), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n26_), .c(new_n15_), .d(x0), .O(z5));
  oai21  g24(.a(new_n34_), .b(new_n29_), .c(new_n15_), .O(new_n39_));
