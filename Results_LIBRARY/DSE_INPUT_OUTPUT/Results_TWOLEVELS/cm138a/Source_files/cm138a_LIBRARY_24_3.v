...
module FAU ( 
  ...
  nand4  g17(.a(new_n21_), .b(x2), .c(new_n19_), .d(new_n25_), .O(new_n32_));
  nand2  g18(.a(new_n32_), .b(new_n15_), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x3), .O(z4));
  nor2   g20(.a(x1), .b(new_n25_), .O(new_n35_));
  nor2   g21(.a(x5), .b(new_n20_), .O(new_n36_));
  nand4  g22(.a(new_n36_), .b(new_n35_), .c(new_n15_), .d(x3), .O(z5));
  nand4  g23(.a(new_n21_), .b(x2), .c(x1), .d(new_n25_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x3), .O(z6));
  nor2   g26(.a(new_n19_), .b(new_n25_), .O(new_n41_));
  nand4  g27(.a(new_n36_), .b(new_n41_), .c(new_n15_), .d(x3), .O(z7));
endmodule
