...
module FAU ( 
  ...
  nor2   g11(.a(new_n25_), .b(new_n22_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n16_), .O(z1));
  nor2   g13(.a(x2), .b(new_n21_), .O(new_n28_));
  ...
  nand4  g19(.a(new_n24_), .b(x3), .c(x2), .d(new_n21_), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n16_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n15_), .O(z4));
  nand3  g22(.a(new_n24_), .b(x3), .c(x2), .O(new_n37_));
  oai21  g23(.a(new_n37_), .b(new_n22_), .c(new_n16_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n32_), .O(z5));
  nor2   g25(.a(new_n23_), .b(new_n21_), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z6));
  nor2   g27(.a(new_n37_), .b(new_n30_), .O(new_n42_));
