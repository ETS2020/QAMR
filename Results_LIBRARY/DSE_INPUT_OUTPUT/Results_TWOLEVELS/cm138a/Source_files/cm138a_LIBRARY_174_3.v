...
module FAU ( 
  ...
  oai21  g22(.a(new_n25_), .b(new_n34_), .c(new_n15_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z5));
  oai21  g24(.a(new_n28_), .b(new_n34_), .c(new_n15_), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(x2), .O(z6));
  inv1   g26(.a(new_n34_), .O(new_n41_));
  nand4  g27(.a(new_n32_), .b(new_n41_), .c(new_n15_), .d(x2), .O(z7));
endmodule
