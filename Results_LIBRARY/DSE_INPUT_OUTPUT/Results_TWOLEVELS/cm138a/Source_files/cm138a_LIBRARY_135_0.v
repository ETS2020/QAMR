...
module FAU ( 
  ...
  nand2  g11(.a(new_n21_), .b(x1), .O(new_n26_));
  ...
  nand4  g17(.a(new_n20_), .b(new_n19_), .c(x3), .d(x2), .O(new_n32_));
  ...
  oai21  g23(.a(new_n18_), .b(new_n15_), .c(x1), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n30_), .O(z7));
  nand2  g25(.a(new_n16_), .b(new_n15_), .O(z4));
endmodule
