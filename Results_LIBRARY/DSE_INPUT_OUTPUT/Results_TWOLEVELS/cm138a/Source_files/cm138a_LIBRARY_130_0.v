...
module FAU ( 
  ...
  nor2   g05(.a(x5), .b(new_n20_), .O(new_n21_));
  ...
  nor2   g13(.a(x4), .b(new_n23_), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(new_n21_), .c(x1), .d(new_n30_), .O(z6));
  nand4  g15(.a(new_n31_), .b(new_n21_), .c(x1), .d(x0), .O(z7));
  one    g16(.O(z1));
  one    g17(.O(z4));
  one    g18(.O(z5));
endmodule
