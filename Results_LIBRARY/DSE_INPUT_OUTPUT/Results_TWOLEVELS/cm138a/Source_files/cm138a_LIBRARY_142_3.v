...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    ...
    new_n32_, new_n34_, new_n35_, new_n37_, new_n38_, new_n40_;
  ...
  nand4  g24(.a(new_n38_), .b(new_n37_), .c(new_n15_), .d(x2), .O(z5));
  oai21  g25(.a(new_n28_), .b(new_n34_), .c(new_n15_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(x2), .O(z6));
  nand4  g27(.a(new_n32_), .b(new_n37_), .c(new_n15_), .d(x2), .O(z7));
endmodule
