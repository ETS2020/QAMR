...
module FAU ( 
  ...
  nand2  g10(.a(x5), .b(new_n18_), .O(new_n25_));
  ...
  oai21  g20(.a(new_n23_), .b(new_n32_), .c(new_n17_), .O(new_n35_));
  nand3  g21(.a(new_n35_), .b(new_n17_), .c(x2), .O(z5));
  oai21  g22(.a(new_n27_), .b(new_n32_), .c(new_n17_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(x2), .O(z6));
  nand2  g24(.a(x1), .b(x0), .O(new_n39_));
  oai21  g25(.a(new_n39_), .b(new_n32_), .c(new_n17_), .O(new_n40_));
