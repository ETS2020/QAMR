...
module FAU ( 
  ...
  nor2   g18(.a(x2), .b(new_n16_), .O(new_n33_));
  nand4  g19(.a(new_n33_), .b(new_n32_), .c(new_n15_), .d(x1), .O(z3));
  inv1   g20(.a(new_n18_), .O(new_n35_));
  nand4  g21(.a(new_n32_), .b(new_n35_), .c(new_n15_), .d(x2), .O(z4));
  inv1   g22(.a(new_n25_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n32_), .c(new_n15_), .d(x2), .O(z5));
