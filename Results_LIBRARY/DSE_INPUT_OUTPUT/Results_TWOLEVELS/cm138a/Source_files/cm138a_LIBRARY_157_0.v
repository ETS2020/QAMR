...
module FAU ( 
  ...
  and2   g09(.a(x1), .b(x0), .O(new_n24_));
  nand4  g10(.a(new_n24_), .b(new_n21_), .c(new_n19_), .d(new_n18_), .O(z3));
  nand4  g11(.a(new_n22_), .b(new_n21_), .c(new_n19_), .d(x2), .O(z6));
  nand4  g12(.a(new_n24_), .b(new_n21_), .c(new_n19_), .d(x2), .O(z7));
