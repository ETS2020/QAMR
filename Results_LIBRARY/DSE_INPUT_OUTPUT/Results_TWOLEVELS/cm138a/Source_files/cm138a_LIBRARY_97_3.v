...
module FAU ( 
  ...
  nor2   g17(.a(x4), .b(new_n20_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n16_), .c(new_n15_), .d(x3), .O(z4));
  ...
  nand4  g23(.a(new_n32_), .b(new_n37_), .c(new_n15_), .d(x3), .O(z6));
  nor2   g24(.a(new_n19_), .b(new_n25_), .O(new_n39_));
  nand4  g25(.a(new_n32_), .b(new_n39_), .c(new_n15_), .d(x3), .O(z7));
endmodule
