...
module FAU ( 
  ...
  nand4  g12(.a(new_n19_), .b(x3), .c(x2), .d(new_n17_), .O(new_n29_));
  nand2  g13(.a(new_n29_), .b(new_n16_), .O(new_n30_));
  nand2  g14(.a(new_n30_), .b(new_n15_), .O(z4));
  nand4  g15(.a(new_n19_), .b(x3), .c(x2), .d(x0), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n16_), .O(new_n33_));
  nand2  g17(.a(new_n33_), .b(new_n15_), .O(z5));
