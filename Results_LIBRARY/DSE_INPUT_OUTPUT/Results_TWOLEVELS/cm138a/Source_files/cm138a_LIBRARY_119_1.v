// Benchmark "FAU" written by ABC on Wed Aug 19 17:15:41 2020
...
module FAU ( 
  ...
  nand4  g24(.a(new_n35_), .b(new_n15_), .c(x1), .d(new_n16_), .O(z6));
  nand4  g25(.a(new_n35_), .b(new_n15_), .c(x1), .d(x0), .O(z7));
endmodule
