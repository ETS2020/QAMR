...
module FAU ( 
  ...
  nand2  g09(.a(new_n17_), .b(x1), .O(z3));
  nand4  g10(.a(new_n21_), .b(x2), .c(new_n16_), .d(new_n15_), .O(z4));
  oai21  g11(.a(new_n17_), .b(new_n15_), .c(new_n16_), .O(new_n27_));
  ...
  oai21  g17(.a(x2), .b(new_n16_), .c(x0), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(z6));
