...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n26_, new_n29_, new_n31_, new_n32_;
  ...
  nand4  g13(.a(new_n24_), .b(new_n23_), .c(x3), .d(x1), .O(z3));
  nor2   g14(.a(new_n17_), .b(x0), .O(new_n29_));
  nand4  g15(.a(new_n29_), .b(new_n23_), .c(x3), .d(new_n15_), .O(z4));
  ...
  nand4  g19(.a(new_n29_), .b(new_n23_), .c(x3), .d(x1), .O(z6));
  nand2  g20(.a(new_n32_), .b(new_n26_), .O(z7));
endmodule
