...
module FAU ( 
  ...
  nand4  g07(.a(new_n22_), .b(new_n21_), .c(new_n16_), .d(new_n19_), .O(z2));
  and2   g08(.a(x1), .b(x0), .O(new_n24_));
  nand4  g09(.a(new_n24_), .b(new_n21_), .c(new_n16_), .d(new_n19_), .O(z3));
  nand4  g10(.a(new_n22_), .b(new_n21_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g11(.a(new_n24_), .b(new_n21_), .c(new_n16_), .d(x2), .O(z7));
  one    g12(.O(z1));
  one    g13(.O(z5));
