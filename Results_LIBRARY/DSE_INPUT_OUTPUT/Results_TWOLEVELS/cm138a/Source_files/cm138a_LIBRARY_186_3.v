...
module FAU ( 
  ...
  nand4  g11(.a(new_n18_), .b(x3), .c(x1), .d(new_n16_), .O(new_n26_));
  nand2  g12(.a(new_n26_), .b(new_n15_), .O(new_n27_));
  nand2  g13(.a(new_n27_), .b(new_n21_), .O(z2));
  nand4  g14(.a(new_n18_), .b(x3), .c(x1), .d(x0), .O(new_n29_));
  nand2  g15(.a(new_n29_), .b(new_n15_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(new_n21_), .O(z3));
  nand2  g17(.a(new_n20_), .b(x2), .O(z4));
  nand2  g18(.a(new_n24_), .b(x2), .O(z5));
  nand2  g19(.a(new_n27_), .b(x2), .O(z6));
  nand2  g20(.a(new_n30_), .b(x2), .O(z7));
endmodule
