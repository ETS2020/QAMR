...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n19_, new_n20_, new_n21_, new_n23_, new_n24_,
    new_n25_, new_n26_, new_n28_, new_n29_, new_n30_, new_n32_;
  ...
  nand4  g13(.a(new_n24_), .b(x3), .c(x1), .d(new_n28_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(x2), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(z6));
  nor2   g16(.a(new_n23_), .b(new_n28_), .O(new_n32_));
  nand4  g17(.a(new_n32_), .b(new_n21_), .c(new_n16_), .d(x2), .O(z7));
  one    g18(.O(z3));
