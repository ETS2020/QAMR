...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n20_, new_n21_, new_n22_, new_n24_, new_n25_,
  ...
  nand4  g06(.a(new_n22_), .b(new_n20_), .c(new_n16_), .d(x2), .O(z4));
  ...
  nand4  g13(.a(new_n29_), .b(new_n22_), .c(new_n16_), .d(x2), .O(z6));
  nand4  g14(.a(new_n25_), .b(x3), .c(x1), .d(x0), .O(new_n31_));
  nand2  g15(.a(new_n31_), .b(x2), .O(new_n32_));
  nand2  g16(.a(new_n32_), .b(new_n16_), .O(z7));
  one    g17(.O(z1));
  one    g18(.O(z2));
