...
module FAU ( 
  ...
  nand4  g15(.a(new_n23_), .b(x2), .c(new_n27_), .d(new_n19_), .O(new_n30_));
  nand2  g16(.a(new_n30_), .b(x3), .O(new_n31_));
  nand2  g17(.a(new_n31_), .b(new_n15_), .O(z4));
  nand4  g18(.a(new_n23_), .b(x2), .c(new_n27_), .d(x0), .O(new_n33_));
  nand2  g19(.a(new_n33_), .b(x3), .O(new_n34_));
  nand2  g20(.a(new_n34_), .b(new_n15_), .O(z5));
  nor2   g21(.a(new_n27_), .b(x0), .O(new_n36_));
  nor2   g22(.a(x5), .b(new_n22_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n36_), .c(new_n15_), .d(x3), .O(z6));
  nand4  g24(.a(new_n37_), .b(new_n28_), .c(new_n15_), .d(x3), .O(z7));
endmodule
