...
module FAU ( 
  ...
  nand4  g15(.a(new_n29_), .b(new_n23_), .c(new_n15_), .d(x3), .O(z3));
  nor2   g16(.a(x1), .b(x0), .O(new_n31_));
  nor2   g17(.a(x5), .b(new_n18_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n31_), .c(new_n15_), .d(x3), .O(z4));
  nand4  g19(.a(new_n32_), .b(new_n24_), .c(new_n15_), .d(x3), .O(z5));
  nor2   g20(.a(new_n17_), .b(x0), .O(new_n35_));
  nand4  g21(.a(new_n32_), .b(new_n35_), .c(new_n15_), .d(x3), .O(z6));
