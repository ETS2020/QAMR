...
module FAU ( 
  ...
  oai21  g12(.a(new_n26_), .b(new_n23_), .c(new_n16_), .O(new_n27_));
  nand2  g13(.a(x4), .b(x1), .O(new_n28_));
  ...
  nand4  g18(.a(new_n32_), .b(new_n31_), .c(new_n16_), .d(x0), .O(z3));
  ...
  nand4  g24(.a(new_n38_), .b(new_n16_), .c(new_n15_), .d(x0), .O(z5));
  oai21  g25(.a(new_n37_), .b(new_n26_), .c(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n28_), .O(z6));
  nor2   g27(.a(new_n18_), .b(new_n15_), .O(new_n42_));
  nand4  g28(.a(new_n42_), .b(new_n31_), .c(new_n16_), .d(x0), .O(z7));
endmodule
