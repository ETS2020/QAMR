...
module FAU ( 
  ...
  nand4  g13(.a(new_n20_), .b(new_n15_), .c(x1), .d(new_n27_), .O(z2));
  ...
  oai21  g20(.a(new_n32_), .b(new_n23_), .c(new_n15_), .O(new_n35_));
  nand2  g21(.a(new_n35_), .b(new_n25_), .O(z5));
  nand2  g22(.a(x1), .b(new_n27_), .O(new_n37_));
  ...
  nand2  g26(.a(new_n40_), .b(new_n25_), .O(z7));
endmodule
