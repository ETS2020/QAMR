// Benchmark "FAU" written by ABC on Wed Aug 19 17:15:49 2020
...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_,
    new_n23_, new_n24_, new_n28_, new_n29_, new_n30_;
  ...
  nor2   g12(.a(x5), .b(new_n28_), .O(new_n29_));
  nor2   g13(.a(x4), .b(new_n18_), .O(new_n30_));
  nand4  g14(.a(new_n30_), .b(new_n29_), .c(new_n16_), .d(new_n17_), .O(z4));
  nand4  g15(.a(new_n30_), .b(new_n29_), .c(new_n16_), .d(x0), .O(z5));
