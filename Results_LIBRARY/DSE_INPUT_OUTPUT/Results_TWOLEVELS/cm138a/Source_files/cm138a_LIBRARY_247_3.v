...
module FAU ( 
  ...
  nor2   g18(.a(x1), .b(new_n25_), .O(new_n33_));
  nand4  g19(.a(new_n31_), .b(new_n33_), .c(new_n15_), .d(x3), .O(z5));
  nor2   g20(.a(new_n19_), .b(x0), .O(new_n35_));
  nand4  g21(.a(new_n31_), .b(new_n35_), .c(new_n15_), .d(x3), .O(z6));
  nand4  g22(.a(new_n21_), .b(x2), .c(x1), .d(x0), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n15_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(x3), .O(z7));
endmodule
