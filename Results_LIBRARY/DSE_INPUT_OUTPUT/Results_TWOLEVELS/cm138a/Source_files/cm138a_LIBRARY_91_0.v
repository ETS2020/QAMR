...
module FAU ( 
  ...
  nand4  g08(.a(new_n25_), .b(new_n18_), .c(x2), .d(new_n21_), .O(z4));
  ...
  nand4  g14(.a(new_n31_), .b(new_n18_), .c(x2), .d(new_n21_), .O(z6));
  inv1   g15(.a(x3), .O(new_n33_));
  nor2   g16(.a(x4), .b(new_n33_), .O(new_n34_));
  nor2   g17(.a(new_n22_), .b(new_n21_), .O(new_n35_));
  nand4  g18(.a(new_n35_), .b(new_n34_), .c(new_n18_), .d(x2), .O(z7));
  one    g19(.O(z0));
  one    g20(.O(z1));
  one    g21(.O(z3));
endmodule
