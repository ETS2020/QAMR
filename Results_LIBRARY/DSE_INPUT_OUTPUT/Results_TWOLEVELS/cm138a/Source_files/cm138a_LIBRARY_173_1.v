...
module FAU ( 
  ...
  nand2  g14(.a(x4), .b(x1), .O(new_n29_));
  ...
  inv1   g26(.a(new_n26_), .O(new_n41_));
  nand4  g27(.a(new_n41_), .b(new_n35_), .c(new_n16_), .d(x2), .O(z6));
  inv1   g28(.a(new_n31_), .O(new_n43_));
  nand4  g29(.a(new_n43_), .b(new_n35_), .c(new_n16_), .d(x2), .O(z7));
endmodule
