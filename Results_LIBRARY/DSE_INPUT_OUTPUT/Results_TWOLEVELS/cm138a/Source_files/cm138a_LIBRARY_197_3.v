...
module FAU ( 
  ...
  nand4  g17(.a(new_n20_), .b(x3), .c(new_n19_), .d(x0), .O(new_n32_));
  ...
  nand2  g22(.a(new_n36_), .b(new_n26_), .O(z4));
  nor2   g23(.a(new_n35_), .b(new_n24_), .O(new_n38_));
  nand2  g24(.a(new_n38_), .b(new_n15_), .O(z5));
  nor2   g25(.a(new_n19_), .b(x0), .O(new_n40_));
  nand4  g26(.a(new_n40_), .b(new_n29_), .c(new_n15_), .d(x1), .O(z6));
  nand4  g27(.a(new_n20_), .b(x3), .c(x2), .d(x0), .O(new_n42_));
