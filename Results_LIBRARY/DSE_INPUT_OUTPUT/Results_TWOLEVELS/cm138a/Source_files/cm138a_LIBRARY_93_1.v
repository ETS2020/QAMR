...
module FAU ( 
  ...
  nand4  g16(.a(new_n30_), .b(new_n29_), .c(new_n16_), .d(new_n15_), .O(z2));
  nor2   g17(.a(new_n17_), .b(new_n15_), .O(new_n32_));
  nand4  g18(.a(new_n32_), .b(new_n29_), .c(new_n16_), .d(new_n18_), .O(z3));
  nor2   g19(.a(new_n18_), .b(x1), .O(new_n34_));
  nand4  g20(.a(new_n34_), .b(new_n29_), .c(new_n16_), .d(new_n15_), .O(z4));
  nand3  g21(.a(new_n19_), .b(x3), .c(x2), .O(new_n36_));
  oai21  g22(.a(new_n36_), .b(new_n23_), .c(new_n16_), .O(new_n37_));
  nand2  g23(.a(new_n37_), .b(new_n26_), .O(z5));
  nand4  g24(.a(new_n19_), .b(x3), .c(x2), .d(x1), .O(new_n39_));
  nand2  g25(.a(new_n39_), .b(new_n16_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n15_), .O(z6));
  nand4  g27(.a(new_n32_), .b(new_n29_), .c(new_n16_), .d(x2), .O(z7));
endmodule
