...
module FAU ( 
  ...
  nor2   g20(.a(new_n21_), .b(x0), .O(new_n35_));
  nand4  g21(.a(new_n35_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z4));
  nor2   g22(.a(new_n21_), .b(new_n26_), .O(new_n37_));
  nand4  g23(.a(new_n37_), .b(new_n19_), .c(new_n16_), .d(new_n15_), .O(z5));
  nand3  g24(.a(new_n22_), .b(x3), .c(x2), .O(new_n39_));
  nor2   g25(.a(new_n39_), .b(new_n27_), .O(new_n40_));
  nand2  g26(.a(new_n40_), .b(new_n16_), .O(z6));
  oai21  g27(.a(new_n39_), .b(new_n32_), .c(new_n16_), .O(new_n42_));
  nand2  g28(.a(new_n42_), .b(new_n30_), .O(z7));
endmodule
