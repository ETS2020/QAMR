...
module FAU ( 
  ...
  wire new_n15_, new_n16_, new_n17_, new_n19_, new_n20_, new_n21_, new_n22_,
    new_n23_, new_n27_, new_n28_, new_n29_, new_n31_, new_n32_;
  ...
  nand2  g10(.a(x3), .b(x1), .O(z3));
  inv1   g11(.a(x0), .O(new_n27_));
  nand4  g12(.a(new_n21_), .b(new_n20_), .c(x2), .d(new_n27_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n15_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(x3), .O(z4));
  nand4  g15(.a(new_n21_), .b(new_n20_), .c(x2), .d(x0), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n15_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(x3), .O(z5));
  one    g18(.O(z2));
  one    g19(.O(z6));
