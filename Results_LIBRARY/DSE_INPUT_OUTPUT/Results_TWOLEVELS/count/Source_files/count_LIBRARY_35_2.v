...
module FAU ( 
  ...
  oai21  g002(.a(new_n52_), .b(x14), .c(new_n53_), .O(new_n54_));
  inv1   g003(.a(x14), .O(new_n55_));
  oai21  g004(.a(x16), .b(new_n55_), .c(x18), .O(new_n56_));
  ...
  nand3  g014(.a(new_n63_), .b(new_n58_), .c(new_n57_), .O(new_n66_));
  ...
  oai21  g019(.a(x14), .b(new_n70_), .c(new_n53_), .O(new_n71_));
  ...
  nand3  g026(.a(new_n77_), .b(new_n71_), .c(new_n56_), .O(z02));
  nor2   g027(.a(x16), .b(x12), .O(new_n79_));
  oai21  g028(.a(new_n79_), .b(x18), .c(new_n55_), .O(new_n80_));
  ...
  oai21  g034(.a(new_n73_), .b(new_n85_), .c(new_n65_), .O(new_n86_));
  oai21  g035(.a(new_n86_), .b(new_n84_), .c(x16), .O(new_n87_));
  nand2  g036(.a(new_n87_), .b(new_n80_), .O(z03));
  inv1   g037(.a(x11), .O(new_n89_));
  oai21  g038(.a(x14), .b(new_n89_), .c(new_n53_), .O(new_n90_));
  inv1   g039(.a(x23), .O(new_n91_));
  oai21  g040(.a(x22), .b(x21), .c(new_n58_), .O(new_n92_));
  aoi21  g041(.a(new_n92_), .b(new_n73_), .c(new_n91_), .O(new_n93_));
  ...
  nand3  g048(.a(new_n99_), .b(new_n90_), .c(new_n56_), .O(z04));
  nor2   g049(.a(x16), .b(x10), .O(new_n101_));
  oai21  g050(.a(new_n101_), .b(x18), .c(new_n55_), .O(new_n102_));
  oai21  g051(.a(new_n96_), .b(x19), .c(new_n73_), .O(new_n103_));
  nor2   g052(.a(x24), .b(x23), .O(new_n104_));
  nand3  g053(.a(new_n104_), .b(new_n82_), .c(new_n73_), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(new_n65_), .O(new_n106_));
  aoi21  g055(.a(new_n103_), .b(x24), .c(new_n106_), .O(new_n107_));
  oai21  g056(.a(new_n107_), .b(new_n53_), .c(new_n102_), .O(z05));
  inv1   g057(.a(x09), .O(new_n109_));
  oai21  g058(.a(x14), .b(new_n109_), .c(new_n53_), .O(new_n110_));
  inv1   g059(.a(x25), .O(new_n111_));
  nand2  g060(.a(new_n104_), .b(new_n82_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(new_n58_), .O(new_n113_));
  aoi21  g062(.a(new_n113_), .b(new_n73_), .c(new_n111_), .O(new_n114_));
  nor2   g063(.a(x25), .b(x24), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n94_), .c(new_n74_), .d(new_n60_), .O(new_n116_));
  inv1   g065(.a(new_n116_), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n110_), .c(new_n56_), .O(z06));
  ...
  aoi21  g073(.a(new_n124_), .b(new_n73_), .c(new_n122_), .O(new_n125_));
  nor3   g074(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n94_), .O(new_n127_));
  oai21  g076(.a(new_n127_), .b(new_n75_), .c(new_n65_), .O(new_n128_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n94_), .c(new_n134_), .d(new_n72_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n58_), .O(new_n137_));
  aoi21  g086(.a(new_n137_), .b(new_n73_), .c(new_n133_), .O(new_n138_));
  nand3  g087(.a(new_n82_), .b(new_n60_), .c(new_n63_), .O(new_n139_));
  nor2   g088(.a(x27), .b(x26), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n104_), .c(new_n111_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n139_), .c(new_n65_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n138_), .c(x16), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n132_), .O(z08));
  inv1   g093(.a(x06), .O(new_n145_));
  oai21  g094(.a(x14), .b(new_n145_), .c(new_n53_), .O(new_n146_));
  inv1   g095(.a(x28), .O(new_n147_));
  nand2  g096(.a(new_n140_), .b(new_n115_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n95_), .c(new_n58_), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n73_), .c(new_n147_), .O(new_n150_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n146_), .c(new_n56_), .O(z09));
  inv1   g105(.a(x05), .O(new_n157_));
  oai21  g106(.a(x14), .b(new_n157_), .c(new_n53_), .O(new_n158_));
  inv1   g107(.a(x29), .O(new_n159_));
  nand4  g108(.a(new_n152_), .b(new_n135_), .c(new_n104_), .d(new_n82_), .O(new_n160_));
  aoi21  g109(.a(new_n160_), .b(new_n58_), .c(new_n66_), .O(new_n161_));
  nor2   g110(.a(x29), .b(x28), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n126_), .c(new_n133_), .O(new_n163_));
  oai22  g112(.a(new_n163_), .b(new_n97_), .c(new_n161_), .d(new_n159_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(x16), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n158_), .c(new_n56_), .O(z10));
  nor2   g115(.a(x16), .b(x04), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(x18), .c(new_n55_), .O(new_n168_));
  inv1   g117(.a(x30), .O(new_n169_));
  nand3  g118(.a(new_n162_), .b(new_n135_), .c(new_n133_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n112_), .c(new_n58_), .O(new_n171_));
  aoi21  g120(.a(new_n171_), .b(new_n73_), .c(new_n169_), .O(new_n172_));
  nor2   g121(.a(x30), .b(x29), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n152_), .c(new_n126_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n97_), .c(new_n65_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n172_), .c(x16), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n168_), .O(z11));
  inv1   g126(.a(x03), .O(new_n178_));
  oai21  g127(.a(x14), .b(new_n178_), .c(new_n53_), .O(new_n179_));
  inv1   g128(.a(x31), .O(new_n180_));
  nand3  g129(.a(new_n173_), .b(new_n140_), .c(new_n147_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n123_), .c(new_n58_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n73_), .c(new_n180_), .O(new_n183_));
  ...
  nand3  g136(.a(new_n187_), .b(new_n179_), .c(new_n56_), .O(z12));
  nor2   g137(.a(x16), .b(x02), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(x18), .c(new_n55_), .O(new_n190_));
  inv1   g139(.a(x32), .O(new_n191_));
  nand4  g140(.a(new_n184_), .b(new_n152_), .c(new_n159_), .d(new_n122_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n123_), .c(new_n58_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n73_), .c(new_n191_), .O(new_n194_));
  nor2   g143(.a(x32), .b(x31), .O(new_n195_));
  nand4  g144(.a(new_n195_), .b(new_n173_), .c(new_n152_), .d(new_n135_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n105_), .c(new_n65_), .O(new_n197_));
  ...
  oai21  g152(.a(new_n203_), .b(new_n136_), .c(new_n58_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n73_), .c(new_n202_), .O(new_n205_));
  nor2   g154(.a(x33), .b(x32), .O(new_n206_));
  nand4  g155(.a(new_n206_), .b(new_n184_), .c(new_n162_), .d(new_n140_), .O(new_n207_));
  oai21  g156(.a(new_n207_), .b(new_n116_), .c(new_n65_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n205_), .c(x16), .O(new_n209_));
  nand2  g158(.a(new_n209_), .b(new_n201_), .O(z14));
  inv1   g159(.a(x00), .O(new_n211_));
  oai21  g160(.a(x14), .b(new_n211_), .c(new_n53_), .O(new_n212_));
  inv1   g161(.a(x34), .O(new_n213_));
  nand4  g162(.a(new_n206_), .b(new_n184_), .c(new_n162_), .d(new_n133_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(new_n136_), .c(new_n58_), .O(new_n215_));
  aoi21  g164(.a(new_n215_), .b(new_n73_), .c(new_n213_), .O(new_n216_));
  nand2  g165(.a(new_n162_), .b(new_n140_), .O(new_n217_));
  nand4  g166(.a(new_n184_), .b(new_n213_), .c(new_n202_), .d(new_n191_), .O(new_n218_));
  nor3   g167(.a(new_n218_), .b(new_n217_), .c(new_n116_), .O(new_n219_));
  oai21  g168(.a(new_n219_), .b(new_n216_), .c(x16), .O(new_n220_));
  nand3  g169(.a(new_n220_), .b(new_n212_), .c(new_n56_), .O(z15));
endmodule
