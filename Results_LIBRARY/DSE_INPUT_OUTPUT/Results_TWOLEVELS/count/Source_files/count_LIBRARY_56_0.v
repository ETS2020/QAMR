...
module FAU ( 
  ...
  nor2   g005(.a(x12), .b(x11), .O(new_n57_));
  ...
  aoi21  g023(.a(new_n74_), .b(new_n72_), .c(new_n57_), .O(z02));
  ...
  oai21  g028(.a(new_n66_), .b(new_n78_), .c(new_n79_), .O(new_n80_));
  inv1   g029(.a(x22), .O(new_n81_));
  inv1   g030(.a(new_n70_), .O(new_n82_));
  ...
  nand3  g035(.a(new_n86_), .b(new_n80_), .c(new_n77_), .O(z03));
  nand2  g036(.a(new_n84_), .b(x23), .O(new_n88_));
  ...
  aoi21  g040(.a(new_n91_), .b(new_n88_), .c(new_n66_), .O(new_n92_));
  oai21  g041(.a(new_n92_), .b(x18), .c(new_n76_), .O(new_n93_));
  nand3  g042(.a(new_n66_), .b(x12), .c(new_n78_), .O(new_n94_));
  ...
  nand4  g047(.a(new_n98_), .b(new_n83_), .c(new_n89_), .d(new_n52_), .O(new_n99_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n90_), .c(new_n96_), .O(new_n116_));
  ...
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n57_), .O(z07));
  ...
  aoi21  g078(.a(new_n129_), .b(new_n127_), .c(new_n57_), .O(z08));
  ...
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(new_n63_), .O(new_n148_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n142_), .c(new_n146_), .d(new_n97_), .O(new_n156_));
  ...
  nand3  g109(.a(new_n160_), .b(new_n158_), .c(new_n77_), .O(z11));
  nand4  g110(.a(new_n155_), .b(new_n142_), .c(new_n115_), .d(new_n96_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n91_), .c(x31), .O(new_n163_));
  nand4  g112(.a(new_n96_), .b(new_n140_), .c(new_n81_), .d(new_n69_), .O(new_n164_));
  ...
  nand4  g120(.a(new_n171_), .b(new_n124_), .c(new_n165_), .d(new_n63_), .O(new_n172_));
  ...
  nand4  g138(.a(new_n189_), .b(new_n186_), .c(new_n165_), .d(new_n63_), .O(new_n190_));
  ...
  aoi21  g143(.a(new_n194_), .b(new_n192_), .c(new_n57_), .O(z13));
  ...
  nand4  g147(.a(new_n178_), .b(new_n96_), .c(new_n140_), .d(new_n81_), .O(new_n199_));
  ...
  nand4  g154(.a(new_n205_), .b(new_n202_), .c(new_n200_), .d(new_n82_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(new_n198_), .O(new_n207_));
  nand2  g156(.a(new_n207_), .b(x16), .O(new_n208_));
  inv1   g157(.a(x01), .O(new_n209_));
  aoi21  g158(.a(new_n66_), .b(new_n209_), .c(x18), .O(new_n210_));
  aoi21  g159(.a(new_n210_), .b(new_n208_), .c(new_n57_), .O(z14));
  ...
  nand3  g169(.a(new_n220_), .b(new_n218_), .c(new_n77_), .O(z15));
endmodule
