...
module FAU ( 
  ...
  oai21  g037(.a(new_n69_), .b(x09), .c(new_n88_), .O(new_n89_));
  inv1   g038(.a(x23), .O(new_n90_));
  aoi21  g039(.a(new_n81_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  nand3  g040(.a(new_n90_), .b(new_n79_), .c(new_n72_), .O(new_n92_));
  nor2   g041(.a(new_n92_), .b(new_n65_), .O(new_n93_));
  oai21  g042(.a(new_n93_), .b(new_n91_), .c(x16), .O(new_n94_));
  nand3  g043(.a(new_n94_), .b(new_n89_), .c(new_n58_), .O(z04));
  ...
  oai21  g054(.a(x18), .b(new_n69_), .c(new_n57_), .O(new_n106_));
  ...
  aoi21  g062(.a(x18), .b(x11), .c(new_n59_), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n113_), .c(new_n106_), .O(z06));
  nand2  g064(.a(new_n111_), .b(x26), .O(new_n116_));
  nor3   g065(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n109_), .c(new_n80_), .O(new_n118_));
  ...
  nand4  g090(.a(new_n109_), .b(new_n97_), .c(new_n72_), .d(new_n52_), .O(new_n142_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n117_), .d(new_n93_), .O(new_n155_));
  ...
  oai21  g141(.a(new_n192_), .b(new_n111_), .c(new_n190_), .O(new_n193_));
  ...
  oai21  g146(.a(new_n192_), .b(new_n111_), .c(x34), .O(new_n198_));
  nand4  g147(.a(new_n174_), .b(new_n96_), .c(new_n90_), .d(new_n79_), .O(new_n199_));
