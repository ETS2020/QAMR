...
module FAU ( 
  ...
  nand3  g06(.a(new_n52_), .b(new_n57_), .c(x11), .O(z04));
  oai21  g07(.a(x16), .b(x10), .c(new_n52_), .O(z05));
  oai21  g08(.a(x16), .b(x09), .c(new_n52_), .O(z06));
  nand3  g09(.a(new_n52_), .b(new_n57_), .c(x08), .O(z07));
  nand3  g10(.a(new_n52_), .b(new_n57_), .c(x07), .O(z08));
  nand3  g11(.a(new_n52_), .b(new_n57_), .c(x06), .O(z09));
  oai21  g12(.a(x16), .b(x05), .c(new_n52_), .O(z10));
  oai21  g13(.a(x16), .b(x04), .c(new_n52_), .O(z11));
  nand3  g14(.a(new_n52_), .b(new_n57_), .c(x03), .O(z12));
  oai21  g15(.a(x16), .b(x02), .c(new_n52_), .O(z13));
  nand3  g16(.a(new_n52_), .b(new_n57_), .c(x01), .O(z14));
