...
module FAU ( 
  ...
  nor2   g008(.a(x29), .b(new_n52_), .O(new_n60_));
  aoi21  g009(.a(x29), .b(x18), .c(new_n60_), .O(new_n61_));
  ...
  inv1   g020(.a(new_n60_), .O(new_n72_));
  ...
  aoi21  g033(.a(new_n84_), .b(new_n82_), .c(new_n60_), .O(new_n85_));
  inv1   g034(.a(x22), .O(new_n86_));
  nand4  g035(.a(new_n72_), .b(new_n86_), .c(new_n74_), .d(new_n63_), .O(new_n87_));
  ...
  nand3  g039(.a(new_n90_), .b(new_n58_), .c(new_n63_), .O(new_n91_));
  ...
  nand4  g046(.a(new_n72_), .b(new_n97_), .c(new_n86_), .d(new_n74_), .O(new_n98_));
  nor2   g047(.a(new_n98_), .b(x20), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n56_), .c(new_n55_), .d(x16), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n96_), .O(z04));
  inv1   g050(.a(x24), .O(new_n102_));
  nor2   g051(.a(x23), .b(x22), .O(new_n103_));
  inv1   g052(.a(new_n103_), .O(new_n104_));
  nor3   g053(.a(new_n104_), .b(new_n66_), .c(x21), .O(new_n105_));
  ...
  nand3  g062(.a(new_n113_), .b(new_n111_), .c(new_n73_), .O(z05));
  ...
  nand4  g097(.a(new_n72_), .b(new_n148_), .c(new_n147_), .d(new_n134_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n152_), .b(new_n56_), .c(new_n55_), .d(x16), .O(new_n153_));
  ...
  aoi21  g111(.a(new_n162_), .b(x15), .c(x28), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n148_), .c(new_n147_), .d(new_n134_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(x24), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n97_), .c(new_n86_), .d(new_n74_), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(x20), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n56_), .c(new_n55_), .d(x16), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n161_), .O(z09));
  nor2   g118(.a(x16), .b(x05), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(x18), .c(new_n72_), .O(new_n171_));
  nand2  g120(.a(x29), .b(x28), .O(new_n172_));
  inv1   g121(.a(x28), .O(new_n173_));
  nand3  g122(.a(new_n162_), .b(new_n173_), .c(new_n52_), .O(new_n174_));
  aoi21  g123(.a(new_n174_), .b(new_n172_), .c(x27), .O(new_n175_));
  nor2   g124(.a(new_n162_), .b(new_n148_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n175_), .c(new_n147_), .O(new_n177_));
  nand2  g126(.a(x29), .b(x26), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n134_), .c(new_n102_), .O(new_n180_));
  nand2  g129(.a(new_n126_), .b(x29), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n97_), .O(new_n183_));
  nand2  g132(.a(x29), .b(x23), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n183_), .c(x22), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n74_), .c(new_n63_), .d(new_n56_), .O(new_n186_));
  nand2  g135(.a(new_n91_), .b(x29), .O(new_n187_));
  oai21  g136(.a(new_n186_), .b(x17), .c(new_n187_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(x16), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n171_), .O(z10));
  nand4  g139(.a(new_n90_), .b(new_n58_), .c(new_n63_), .d(x16), .O(new_n191_));
  nor2   g140(.a(x30), .b(x28), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n155_), .c(new_n125_), .d(new_n97_), .O(new_n193_));
  ...
  nand4  g145(.a(new_n196_), .b(new_n140_), .c(new_n105_), .d(new_n148_), .O(new_n197_));
  nand3  g146(.a(new_n197_), .b(x30), .c(x16), .O(new_n198_));
  inv1   g147(.a(x04), .O(new_n199_));
  nand2  g148(.a(new_n53_), .b(new_n199_), .O(new_n200_));
  nand4  g149(.a(new_n200_), .b(new_n198_), .c(new_n195_), .d(new_n73_), .O(z11));
  nand4  g150(.a(new_n103_), .b(new_n75_), .c(new_n58_), .d(x16), .O(new_n202_));
  nor2   g151(.a(x28), .b(x27), .O(new_n203_));
  nor2   g152(.a(x31), .b(x30), .O(new_n204_));
  nand3  g153(.a(new_n204_), .b(new_n203_), .c(new_n140_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n202_), .c(new_n52_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(new_n162_), .O(new_n207_));
  nor2   g156(.a(x30), .b(x29), .O(new_n208_));
  nand4  g157(.a(new_n208_), .b(new_n203_), .c(new_n140_), .d(new_n105_), .O(new_n209_));
  nand3  g158(.a(new_n209_), .b(x31), .c(x16), .O(new_n210_));
  inv1   g159(.a(x03), .O(new_n211_));
  nand2  g160(.a(new_n53_), .b(new_n211_), .O(new_n212_));
  nand4  g161(.a(new_n212_), .b(new_n210_), .c(new_n207_), .d(new_n73_), .O(z12));
  nor2   g162(.a(x16), .b(x02), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(x18), .c(new_n72_), .O(new_n215_));
  inv1   g164(.a(new_n105_), .O(new_n216_));
  oai21  g165(.a(new_n205_), .b(new_n216_), .c(x32), .O(new_n217_));
  nand3  g166(.a(new_n203_), .b(new_n147_), .c(new_n134_), .O(new_n218_));
  inv1   g167(.a(new_n218_), .O(new_n219_));
  nor2   g168(.a(x32), .b(x31), .O(new_n220_));
  nand4  g169(.a(new_n220_), .b(new_n219_), .c(new_n208_), .d(new_n108_), .O(new_n221_));
  aoi21  g170(.a(new_n221_), .b(new_n217_), .c(x15), .O(new_n222_));
  inv1   g171(.a(x32), .O(new_n223_));
  nor2   g172(.a(new_n223_), .b(new_n162_), .O(new_n224_));
  ...
  oai21  g176(.a(new_n227_), .b(x18), .c(new_n72_), .O(new_n228_));
  nand4  g177(.a(new_n220_), .b(new_n192_), .c(new_n155_), .d(new_n134_), .O(new_n229_));
  oai21  g178(.a(new_n229_), .b(new_n109_), .c(x33), .O(new_n230_));
  inv1   g179(.a(x33), .O(new_n231_));
  nand3  g180(.a(new_n204_), .b(new_n231_), .c(new_n223_), .O(new_n232_));
  inv1   g181(.a(new_n232_), .O(new_n233_));
  nand4  g182(.a(new_n233_), .b(new_n196_), .c(new_n155_), .d(new_n127_), .O(new_n234_));
  aoi21  g183(.a(new_n234_), .b(new_n230_), .c(x15), .O(new_n235_));
  nor2   g184(.a(new_n231_), .b(new_n162_), .O(new_n236_));
  oai21  g185(.a(new_n236_), .b(new_n235_), .c(x16), .O(new_n237_));
  nand2  g186(.a(new_n237_), .b(new_n228_), .O(z14));
  inv1   g187(.a(new_n107_), .O(new_n239_));
  nand4  g188(.a(new_n239_), .b(new_n65_), .c(new_n55_), .d(x16), .O(new_n240_));
  nor3   g189(.a(x34), .b(x33), .c(x32), .O(new_n241_));
  nand3  g190(.a(new_n241_), .b(new_n219_), .c(new_n204_), .O(new_n242_));
  oai21  g191(.a(new_n242_), .b(new_n240_), .c(new_n52_), .O(new_n243_));
  nand2  g192(.a(new_n243_), .b(new_n162_), .O(new_n244_));
  nand3  g193(.a(new_n234_), .b(x34), .c(x16), .O(new_n245_));
  inv1   g194(.a(x00), .O(new_n246_));
  nand2  g195(.a(new_n53_), .b(new_n246_), .O(new_n247_));
  nand4  g196(.a(new_n247_), .b(new_n245_), .c(new_n244_), .d(new_n73_), .O(z15));
endmodule
