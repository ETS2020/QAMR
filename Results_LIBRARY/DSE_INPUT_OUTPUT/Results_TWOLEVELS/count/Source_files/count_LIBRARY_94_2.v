...
module FAU ( 
  ...
  oai21  g011(.a(x07), .b(new_n52_), .c(x18), .O(new_n63_));
  ...
  nand2  g062(.a(new_n89_), .b(new_n54_), .O(new_n114_));
  inv1   g063(.a(x23), .O(new_n115_));
  nand3  g064(.a(new_n106_), .b(new_n81_), .c(new_n115_), .O(new_n116_));
  aoi21  g065(.a(new_n116_), .b(new_n55_), .c(new_n114_), .O(new_n117_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n98_), .c(new_n126_), .d(new_n57_), .O(new_n128_));
  oai21  g077(.a(new_n117_), .b(new_n125_), .c(new_n128_), .O(new_n129_));
  aoi21  g078(.a(new_n129_), .b(x16), .c(x18), .O(new_n130_));
  inv1   g079(.a(x07), .O(new_n131_));
  nand2  g080(.a(new_n60_), .b(new_n131_), .O(new_n132_));
  nand2  g081(.a(x27), .b(x26), .O(new_n133_));
  oai21  g082(.a(new_n133_), .b(new_n60_), .c(new_n132_), .O(new_n134_));
  nor2   g083(.a(new_n60_), .b(new_n131_), .O(new_n135_));
  nor2   g084(.a(new_n133_), .b(x19), .O(new_n136_));
  aoi22  g085(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n52_), .O(new_n137_));
  oai21  g086(.a(new_n130_), .b(new_n53_), .c(new_n137_), .O(z08));
  nor2   g087(.a(x27), .b(x26), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(x19), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n107_), .c(x28), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n106_), .c(new_n113_), .d(new_n115_), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(new_n82_), .c(new_n141_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(x16), .O(new_n145_));
  nor2   g094(.a(x16), .b(x06), .O(new_n146_));
  nor2   g095(.a(new_n146_), .b(new_n53_), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n145_), .c(new_n63_), .O(z09));
  inv1   g097(.a(x29), .O(new_n149_));
  inv1   g098(.a(new_n140_), .O(new_n150_));
  inv1   g099(.a(x24), .O(new_n151_));
  nor2   g100(.a(x28), .b(x25), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n90_), .c(new_n151_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(new_n73_), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n150_), .c(new_n149_), .O(new_n155_));
  ...
  nand3  g110(.a(new_n161_), .b(new_n159_), .c(new_n63_), .O(z10));
  inv1   g111(.a(x30), .O(new_n163_));
  nand3  g112(.a(new_n156_), .b(new_n98_), .c(new_n105_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n82_), .O(new_n165_));
  aoi21  g114(.a(new_n165_), .b(new_n150_), .c(new_n163_), .O(new_n166_));
  nor2   g115(.a(x30), .b(x29), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n142_), .c(new_n118_), .O(new_n168_));
  ...
  nand3  g121(.a(new_n172_), .b(new_n170_), .c(new_n63_), .O(z11));
  inv1   g122(.a(x31), .O(new_n174_));
  inv1   g123(.a(x28), .O(new_n175_));
  nand3  g124(.a(new_n167_), .b(new_n139_), .c(new_n175_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n116_), .c(new_n55_), .O(new_n177_));
  aoi21  g126(.a(new_n177_), .b(new_n66_), .c(new_n174_), .O(new_n178_));
  nor2   g127(.a(x31), .b(x30), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n156_), .c(new_n127_), .O(new_n180_));
  ...
  aoi21  g133(.a(new_n184_), .b(new_n182_), .c(new_n53_), .O(z12));
  inv1   g134(.a(x32), .O(new_n186_));
  nand3  g135(.a(new_n174_), .b(new_n125_), .c(new_n113_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(new_n55_), .O(new_n188_));
  nand4  g137(.a(new_n167_), .b(new_n106_), .c(new_n175_), .d(new_n115_), .O(new_n189_));
  nor2   g138(.a(new_n189_), .b(new_n82_), .O(new_n190_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n167_), .c(new_n142_), .d(new_n192_), .O(new_n194_));
  ...
  nand3  g147(.a(new_n198_), .b(new_n196_), .c(new_n63_), .O(z13));
  inv1   g148(.a(x33), .O(new_n200_));
  nor2   g149(.a(x32), .b(x30), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n152_), .c(new_n149_), .d(new_n151_), .O(new_n202_));
  nor2   g151(.a(new_n202_), .b(new_n91_), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n188_), .c(new_n200_), .O(new_n204_));
  nor2   g153(.a(x33), .b(x32), .O(new_n205_));
  nand4  g154(.a(new_n205_), .b(new_n179_), .c(new_n156_), .d(new_n139_), .O(new_n206_));
  ...
  oai21  g160(.a(x18), .b(new_n60_), .c(new_n52_), .O(new_n212_));
  inv1   g161(.a(x34), .O(new_n213_));
  nand4  g162(.a(new_n205_), .b(new_n167_), .c(new_n152_), .d(new_n151_), .O(new_n214_));
  nor2   g163(.a(new_n214_), .b(new_n91_), .O(new_n215_));
  aoi21  g164(.a(new_n215_), .b(new_n188_), .c(new_n213_), .O(new_n216_));
  nor3   g165(.a(x34), .b(x33), .c(x32), .O(new_n217_));
  nand4  g166(.a(new_n217_), .b(new_n179_), .c(new_n156_), .d(new_n139_), .O(new_n218_));
  nor2   g167(.a(new_n218_), .b(new_n107_), .O(new_n219_));
  oai21  g168(.a(new_n219_), .b(new_n216_), .c(x16), .O(new_n220_));
  aoi21  g169(.a(x18), .b(x07), .c(new_n53_), .O(new_n221_));
  nand3  g170(.a(new_n221_), .b(new_n220_), .c(new_n212_), .O(z15));
endmodule
