...
module FAU ( 
  ...
  nand2  g050(.a(new_n94_), .b(new_n56_), .O(new_n102_));
  aoi21  g051(.a(new_n102_), .b(new_n68_), .c(new_n101_), .O(new_n103_));
  ...
  aoi22  g058(.a(new_n109_), .b(new_n53_), .c(x18), .d(new_n52_), .O(new_n110_));
  oai21  g059(.a(new_n107_), .b(new_n100_), .c(new_n110_), .O(z05));
  nor2   g060(.a(new_n104_), .b(x19), .O(new_n112_));
  oai21  g061(.a(new_n112_), .b(new_n84_), .c(x25), .O(new_n113_));
  nor2   g062(.a(x25), .b(x24), .O(new_n114_));
  nand4  g063(.a(new_n114_), .b(new_n93_), .c(new_n74_), .d(new_n58_), .O(new_n115_));
  ...
  nand3  g070(.a(new_n114_), .b(new_n83_), .c(new_n90_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n56_), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n68_), .c(new_n121_), .O(new_n124_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n93_), .c(new_n101_), .d(new_n73_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n56_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n68_), .c(new_n132_), .O(new_n136_));
  inv1   g085(.a(x25), .O(new_n137_));
  nor2   g086(.a(x27), .b(x26), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n104_), .c(new_n137_), .O(new_n139_));
  ...
  nand2  g094(.a(new_n138_), .b(new_n104_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n56_), .O(new_n147_));
  nand3  g096(.a(new_n137_), .b(new_n81_), .c(new_n73_), .O(new_n148_));
  nor2   g097(.a(new_n148_), .b(new_n67_), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n147_), .c(new_n145_), .O(new_n150_));
  ...
  nor3   g102(.a(new_n153_), .b(new_n151_), .c(new_n84_), .O(new_n154_));
  ...
  oai21  g107(.a(new_n61_), .b(x10), .c(x05), .O(new_n159_));
  inv1   g108(.a(x29), .O(new_n160_));
  nand4  g109(.a(new_n152_), .b(new_n133_), .c(new_n104_), .d(new_n83_), .O(new_n161_));
  aoi21  g110(.a(new_n161_), .b(new_n56_), .c(new_n67_), .O(new_n162_));
  nor2   g111(.a(x29), .b(x28), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n125_), .c(new_n95_), .d(new_n132_), .O(new_n164_));
  oai21  g113(.a(new_n162_), .b(new_n160_), .c(new_n164_), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n159_), .O(new_n166_));
  aoi22  g115(.a(new_n109_), .b(new_n52_), .c(x18), .d(new_n53_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n166_), .O(z10));
  inv1   g117(.a(x30), .O(new_n169_));
  nand4  g118(.a(new_n104_), .b(new_n160_), .c(new_n132_), .d(new_n121_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n56_), .O(new_n171_));
  nand3  g120(.a(new_n83_), .b(new_n145_), .c(new_n137_), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n67_), .O(new_n173_));
  aoi21  g122(.a(new_n173_), .b(new_n171_), .c(new_n169_), .O(new_n174_));
  nor2   g123(.a(x30), .b(x29), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n152_), .c(new_n125_), .O(new_n176_));
  nor3   g125(.a(new_n176_), .b(new_n94_), .c(new_n67_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n174_), .c(x16), .O(new_n178_));
  nor2   g127(.a(x16), .b(x04), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n54_), .O(new_n180_));
  nand3  g129(.a(new_n180_), .b(new_n178_), .c(new_n64_), .O(z11));
  inv1   g130(.a(x31), .O(new_n182_));
  nand3  g131(.a(new_n175_), .b(new_n138_), .c(new_n145_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n122_), .c(new_n56_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n68_), .c(new_n182_), .O(new_n185_));
  nor2   g134(.a(x31), .b(x30), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n163_), .c(new_n138_), .d(new_n137_), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n105_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n185_), .c(x16), .O(new_n189_));
  inv1   g138(.a(x03), .O(new_n190_));
  aoi21  g139(.a(new_n61_), .b(new_n190_), .c(x18), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n189_), .c(new_n54_), .O(z12));
  inv1   g141(.a(x32), .O(new_n193_));
  nand4  g142(.a(new_n186_), .b(new_n152_), .c(new_n160_), .d(new_n121_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n122_), .c(new_n56_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n68_), .c(new_n193_), .O(new_n196_));
  nor2   g145(.a(x32), .b(x31), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n175_), .c(new_n152_), .d(new_n133_), .O(new_n198_));
  ...
  aoi21  g151(.a(new_n202_), .b(new_n200_), .c(new_n54_), .O(z13));
  inv1   g152(.a(x33), .O(new_n204_));
  nand4  g153(.a(new_n197_), .b(new_n163_), .c(new_n169_), .d(new_n132_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n134_), .c(new_n56_), .O(new_n206_));
  aoi21  g155(.a(new_n206_), .b(new_n68_), .c(new_n204_), .O(new_n207_));
  nand2  g156(.a(new_n163_), .b(new_n138_), .O(new_n208_));
  nor2   g157(.a(x33), .b(x32), .O(new_n209_));
  nand2  g158(.a(new_n209_), .b(new_n186_), .O(new_n210_));
  nor3   g159(.a(new_n210_), .b(new_n208_), .c(new_n115_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n207_), .c(x16), .O(new_n212_));
  inv1   g161(.a(x01), .O(new_n213_));
  aoi21  g162(.a(new_n61_), .b(new_n213_), .c(x18), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n212_), .c(new_n54_), .O(z14));
  inv1   g164(.a(x34), .O(new_n216_));
  nand3  g165(.a(new_n209_), .b(new_n182_), .c(new_n160_), .O(new_n217_));
  oai21  g166(.a(new_n217_), .b(new_n146_), .c(new_n56_), .O(new_n218_));
  nand4  g167(.a(new_n169_), .b(new_n145_), .c(new_n137_), .d(new_n81_), .O(new_n219_));
  nor2   g168(.a(new_n219_), .b(new_n75_), .O(new_n220_));
  aoi21  g169(.a(new_n220_), .b(new_n218_), .c(new_n216_), .O(new_n221_));
  nand4  g170(.a(new_n186_), .b(new_n216_), .c(new_n204_), .d(new_n193_), .O(new_n222_));
  nor3   g171(.a(new_n222_), .b(new_n208_), .c(new_n115_), .O(new_n223_));
  oai21  g172(.a(new_n223_), .b(new_n221_), .c(x16), .O(new_n224_));
  nor2   g173(.a(x16), .b(x00), .O(new_n225_));
  nor2   g174(.a(new_n225_), .b(new_n54_), .O(new_n226_));
  nand3  g175(.a(new_n226_), .b(new_n224_), .c(new_n64_), .O(z15));
endmodule
