...
module FAU ( 
  ...
  oai21  g006(.a(new_n57_), .b(x02), .c(x18), .O(new_n58_));
  nor2   g007(.a(new_n57_), .b(x02), .O(new_n59_));
  ...
  nand2  g046(.a(new_n89_), .b(new_n71_), .O(new_n98_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n89_), .c(new_n109_), .d(new_n55_), .O(new_n111_));
  ...
  nand3  g070(.a(new_n121_), .b(new_n89_), .c(new_n79_), .O(new_n122_));
  ...
  oai22  g097(.a(new_n148_), .b(new_n90_), .c(new_n140_), .d(new_n145_), .O(new_n149_));
  ...
  oai21  g102(.a(new_n148_), .b(new_n90_), .c(x30), .O(new_n154_));
  ...
  oai21  g120(.a(new_n68_), .b(x11), .c(new_n171_), .O(new_n172_));
  nand3  g121(.a(new_n164_), .b(new_n147_), .c(new_n130_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n101_), .c(x32), .O(new_n174_));
  nor2   g123(.a(x26), .b(x25), .O(new_n175_));
  nor2   g124(.a(x32), .b(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n155_), .c(new_n138_), .d(new_n175_), .O(new_n177_));
  ...
  nand3  g129(.a(new_n180_), .b(new_n172_), .c(new_n58_), .O(z13));
  oai21  g130(.a(new_n177_), .b(new_n101_), .c(x33), .O(new_n182_));
