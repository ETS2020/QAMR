...
module FAU ( 
  ...
  oai21  g005(.a(new_n56_), .b(x04), .c(x15), .O(new_n57_));
  oai21  g006(.a(new_n55_), .b(new_n54_), .c(new_n57_), .O(new_n58_));
  inv1   g007(.a(x15), .O(new_n59_));
  oai21  g008(.a(x18), .b(new_n56_), .c(new_n59_), .O(new_n60_));
  inv1   g009(.a(x04), .O(new_n61_));
  nand2  g010(.a(x18), .b(new_n61_), .O(new_n62_));
  nand3  g011(.a(new_n62_), .b(new_n60_), .c(new_n58_), .O(z00));
  nor2   g012(.a(new_n59_), .b(new_n61_), .O(new_n64_));
  ...
  aoi21  g028(.a(new_n79_), .b(new_n77_), .c(new_n64_), .O(z02));
  nand2  g029(.a(x22), .b(x21), .O(new_n81_));
  nor2   g030(.a(x22), .b(x21), .O(new_n82_));
  nand3  g031(.a(new_n82_), .b(new_n65_), .c(new_n52_), .O(new_n83_));
  ...
  oai21  g048(.a(new_n59_), .b(new_n61_), .c(x18), .O(new_n100_));
  inv1   g049(.a(x24), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand3  g051(.a(new_n102_), .b(new_n82_), .c(new_n68_), .O(new_n103_));
  oai21  g052(.a(new_n95_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(x16), .O(new_n105_));
  nor2   g054(.a(x16), .b(x10), .O(new_n106_));
  nor2   g055(.a(new_n106_), .b(new_n64_), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(z05));
  inv1   g057(.a(x25), .O(new_n109_));
  nand2  g058(.a(new_n102_), .b(new_n82_), .O(new_n110_));
  nor2   g059(.a(new_n110_), .b(new_n67_), .O(new_n111_));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n93_), .c(new_n74_), .d(new_n55_), .O(new_n113_));
  ...
  nor2   g065(.a(new_n116_), .b(new_n64_), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(new_n100_), .O(z06));
  inv1   g067(.a(x26), .O(new_n119_));
  nand3  g068(.a(new_n112_), .b(new_n82_), .c(new_n90_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n53_), .c(new_n67_), .O(new_n121_));
  nor3   g070(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n93_), .O(new_n123_));
  oai22  g072(.a(new_n123_), .b(new_n75_), .c(new_n121_), .d(new_n119_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(x16), .O(new_n125_));
  inv1   g074(.a(x08), .O(new_n126_));
  aoi21  g075(.a(new_n56_), .b(new_n126_), .c(x18), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n125_), .c(new_n64_), .O(z07));
  inv1   g077(.a(x27), .O(new_n129_));
  nor2   g078(.a(x26), .b(x25), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n93_), .c(new_n101_), .d(new_n73_), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n53_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n68_), .c(new_n129_), .O(new_n133_));
  nand3  g082(.a(new_n82_), .b(new_n55_), .c(new_n65_), .O(new_n134_));
  nor2   g083(.a(x27), .b(x26), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n102_), .c(new_n109_), .O(new_n136_));
  ...
  aoi21  g089(.a(new_n140_), .b(new_n138_), .c(new_n64_), .O(z08));
  inv1   g090(.a(x28), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n112_), .c(new_n119_), .d(new_n90_), .O(new_n144_));
  oai22  g093(.a(new_n144_), .b(new_n134_), .c(new_n137_), .d(new_n142_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(x16), .O(new_n146_));
  nor2   g095(.a(x16), .b(x06), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n64_), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n146_), .c(new_n100_), .O(z09));
  inv1   g098(.a(x29), .O(new_n150_));
  nand4  g099(.a(new_n143_), .b(new_n130_), .c(new_n102_), .d(new_n82_), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n53_), .c(new_n67_), .O(new_n152_));
  nor3   g101(.a(x29), .b(x28), .c(x27), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n122_), .c(new_n95_), .O(new_n154_));
  ...
  aoi21  g107(.a(new_n158_), .b(new_n156_), .c(new_n64_), .O(z10));
  oai21  g108(.a(x18), .b(new_n56_), .c(new_n61_), .O(new_n160_));
  nand2  g109(.a(new_n154_), .b(x30), .O(new_n161_));
  nor2   g110(.a(x30), .b(x29), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n143_), .c(new_n122_), .d(new_n95_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(x16), .O(new_n165_));
  aoi21  g114(.a(x18), .b(new_n59_), .c(new_n64_), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n165_), .c(new_n160_), .O(z11));
  inv1   g116(.a(x31), .O(new_n168_));
  nand3  g117(.a(new_n162_), .b(new_n135_), .c(new_n142_), .O(new_n169_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n172_), .c(new_n135_), .d(new_n109_), .O(new_n174_));
  nor2   g123(.a(new_n174_), .b(new_n103_), .O(new_n175_));
  ...
  nand2  g129(.a(new_n143_), .b(new_n130_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nor2   g131(.a(x32), .b(x31), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n162_), .c(new_n182_), .d(new_n111_), .O(new_n184_));
  oai21  g133(.a(new_n175_), .b(new_n180_), .c(new_n184_), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(x16), .O(new_n186_));
  nor2   g135(.a(x16), .b(x02), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n64_), .O(new_n188_));
  nand3  g137(.a(new_n188_), .b(new_n186_), .c(new_n100_), .O(z13));
  inv1   g138(.a(x33), .O(new_n190_));
  inv1   g139(.a(x30), .O(new_n191_));
  nand4  g140(.a(new_n183_), .b(new_n172_), .c(new_n191_), .d(new_n129_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n131_), .c(new_n53_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n68_), .c(new_n190_), .O(new_n194_));
  nand2  g143(.a(new_n172_), .b(new_n135_), .O(new_n195_));
  nor2   g144(.a(x33), .b(x32), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(new_n173_), .O(new_n197_));
  nor3   g146(.a(new_n197_), .b(new_n195_), .c(new_n113_), .O(new_n198_));
  ...
  aoi21  g150(.a(new_n201_), .b(new_n199_), .c(new_n64_), .O(z14));
  inv1   g151(.a(x34), .O(new_n203_));
  nand4  g152(.a(new_n196_), .b(new_n173_), .c(new_n172_), .d(new_n129_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n131_), .c(new_n53_), .O(new_n205_));
  aoi21  g154(.a(new_n205_), .b(new_n68_), .c(new_n203_), .O(new_n206_));
  nand4  g155(.a(new_n173_), .b(new_n203_), .c(new_n190_), .d(new_n180_), .O(new_n207_));
  nor3   g156(.a(new_n207_), .b(new_n195_), .c(new_n113_), .O(new_n208_));
  ...
  aoi21  g160(.a(new_n211_), .b(new_n209_), .c(new_n64_), .O(z15));
endmodule
