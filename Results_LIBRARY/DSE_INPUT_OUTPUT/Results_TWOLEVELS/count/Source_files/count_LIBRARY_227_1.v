...
module FAU ( 
  ...
  oai21  g006(.a(new_n57_), .b(x12), .c(x18), .O(new_n58_));
  nor2   g007(.a(new_n57_), .b(x12), .O(new_n59_));
  ...
  aoi21  g018(.a(x18), .b(x12), .c(new_n59_), .O(new_n70_));
  ...
  oai21  g029(.a(new_n63_), .b(x14), .c(new_n80_), .O(new_n81_));
  ...
  nand3  g036(.a(new_n87_), .b(new_n81_), .c(new_n58_), .O(z03));
  ...
  nand3  g041(.a(new_n92_), .b(new_n68_), .c(new_n72_), .O(new_n93_));
  ...
  aoi21  g050(.a(new_n101_), .b(new_n68_), .c(new_n99_), .O(new_n102_));
  nor2   g051(.a(x24), .b(x23), .O(new_n103_));
  nand3  g052(.a(new_n103_), .b(new_n83_), .c(new_n68_), .O(new_n104_));
  ...
  nand3  g085(.a(new_n83_), .b(new_n55_), .c(new_n65_), .O(new_n137_));
  ...
  aoi21  g103(.a(new_n63_), .b(new_n154_), .c(x18), .O(new_n155_));
  ...
  aoi21  g107(.a(new_n158_), .b(new_n53_), .c(new_n67_), .O(new_n159_));
  ...
  aoi21  g158(.a(new_n63_), .b(new_n209_), .c(x18), .O(new_n210_));
  ...
  aoi21  g168(.a(new_n63_), .b(new_n219_), .c(x18), .O(new_n220_));
