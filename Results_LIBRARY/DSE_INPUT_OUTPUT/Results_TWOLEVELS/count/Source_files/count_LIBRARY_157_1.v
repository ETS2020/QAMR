...
module FAU ( 
  ...
  nand3  g069(.a(new_n120_), .b(new_n109_), .c(new_n97_), .O(new_n121_));
  ...
  nand4  g100(.a(new_n109_), .b(new_n98_), .c(new_n72_), .d(new_n52_), .O(new_n152_));
  nand4  g101(.a(new_n145_), .b(new_n120_), .c(new_n143_), .d(new_n97_), .O(new_n153_));
  ...
  nand3  g123(.a(new_n166_), .b(new_n145_), .c(new_n126_), .O(new_n175_));
