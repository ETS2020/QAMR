...
module FAU ( 
  ...
  oai21  g026(.a(new_n52_), .b(x07), .c(x18), .O(new_n78_));
  ...
  and2   g036(.a(new_n82_), .b(x23), .O(new_n88_));
  nand3  g037(.a(new_n63_), .b(new_n55_), .c(new_n54_), .O(new_n89_));
  ...
  aoi21  g045(.a(x16), .b(x07), .c(new_n52_), .O(new_n97_));
  ...
  aoi22  g054(.a(new_n105_), .b(new_n52_), .c(x18), .d(x07), .O(new_n106_));
  oai21  g055(.a(new_n103_), .b(new_n97_), .c(new_n106_), .O(z05));
  nand2  g056(.a(new_n101_), .b(x25), .O(new_n108_));
  nor2   g057(.a(x25), .b(x24), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n90_), .c(new_n71_), .d(new_n57_), .O(new_n110_));
  ...
  and2   g064(.a(new_n110_), .b(x26), .O(new_n116_));
  ...
  oai21  g073(.a(new_n60_), .b(x10), .c(new_n124_), .O(new_n125_));
  inv1   g074(.a(x27), .O(new_n126_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(new_n100_), .O(new_n128_));
  oai22  g077(.a(new_n128_), .b(new_n82_), .c(new_n119_), .d(new_n126_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n125_), .c(new_n78_), .O(z08));
  inv1   g080(.a(x28), .O(new_n132_));
  nor2   g081(.a(x27), .b(x26), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n109_), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n91_), .c(new_n55_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n65_), .c(new_n132_), .O(new_n136_));
  inv1   g085(.a(x23), .O(new_n137_));
  inv1   g086(.a(x26), .O(new_n138_));
  nor2   g087(.a(x28), .b(x27), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n109_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  ...
  nand4  g096(.a(new_n139_), .b(new_n147_), .c(new_n100_), .d(new_n81_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n55_), .c(new_n89_), .O(new_n149_));
  nor3   g098(.a(x29), .b(x28), .c(x27), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n117_), .c(new_n92_), .O(new_n151_));
  ...
  nand4  g107(.a(new_n158_), .b(new_n139_), .c(new_n117_), .d(new_n92_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n163_), .b(new_n161_), .c(new_n78_), .O(z11));
  nand2  g113(.a(new_n98_), .b(new_n65_), .O(new_n165_));
  nand3  g114(.a(new_n158_), .b(new_n139_), .c(new_n117_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n165_), .c(x31), .O(new_n167_));
  nor2   g116(.a(x29), .b(x28), .O(new_n168_));
  nor2   g117(.a(x31), .b(x30), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n168_), .c(new_n127_), .O(new_n170_));
  or2    g119(.a(new_n170_), .b(new_n101_), .O(new_n171_));
  ...
  oai21  g125(.a(new_n170_), .b(new_n101_), .c(x32), .O(new_n177_));
  nand2  g126(.a(new_n139_), .b(new_n147_), .O(new_n178_));
  ...
  nand3  g135(.a(new_n186_), .b(new_n184_), .c(new_n78_), .O(z13));
  inv1   g136(.a(x33), .O(new_n188_));
  aoi21  g137(.a(new_n181_), .b(new_n102_), .c(new_n188_), .O(new_n189_));
  nand2  g138(.a(new_n168_), .b(new_n133_), .O(new_n190_));
  nor2   g139(.a(x33), .b(x32), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n169_), .O(new_n192_));
  nor3   g141(.a(new_n192_), .b(new_n190_), .c(new_n110_), .O(new_n193_));
  ...
  nand3  g145(.a(new_n196_), .b(new_n194_), .c(new_n78_), .O(z14));
  inv1   g146(.a(x34), .O(new_n198_));
  inv1   g147(.a(x24), .O(new_n199_));
  nand4  g148(.a(new_n147_), .b(new_n90_), .c(new_n199_), .d(new_n70_), .O(new_n200_));
  nand4  g149(.a(new_n191_), .b(new_n169_), .c(new_n168_), .d(new_n126_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n200_), .c(new_n55_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n65_), .c(new_n198_), .O(new_n203_));
  inv1   g152(.a(x32), .O(new_n204_));
  nand4  g153(.a(new_n169_), .b(new_n198_), .c(new_n188_), .d(new_n204_), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(new_n190_), .c(new_n110_), .O(new_n206_));
