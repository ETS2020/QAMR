...
module FAU ( 
  ...
  nand4  g036(.a(new_n87_), .b(new_n65_), .c(new_n71_), .d(new_n64_), .O(new_n88_));
  ...
  nand2  g043(.a(new_n87_), .b(new_n73_), .O(new_n95_));
  nand2  g044(.a(new_n95_), .b(new_n61_), .O(new_n96_));
  aoi21  g045(.a(new_n96_), .b(new_n53_), .c(new_n94_), .O(new_n97_));
  nor2   g046(.a(x22), .b(x21), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n65_), .d(new_n64_), .O(new_n100_));
  ...
  nand3  g056(.a(new_n99_), .b(new_n73_), .c(new_n107_), .O(new_n108_));
  aoi21  g057(.a(new_n108_), .b(new_n61_), .c(new_n54_), .O(new_n109_));
  nor2   g058(.a(x25), .b(x24), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n87_), .c(new_n73_), .d(new_n53_), .O(new_n111_));
  ...
  aoi21  g063(.a(new_n62_), .b(new_n114_), .c(x18), .O(new_n115_));
  ...
  nand4  g068(.a(new_n110_), .b(new_n98_), .c(new_n119_), .d(new_n118_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n61_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n53_), .c(new_n117_), .O(new_n122_));
  nor3   g071(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n87_), .O(new_n124_));
  ...
  aoi21  g076(.a(new_n62_), .b(new_n127_), .c(x18), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n126_), .O(z07));
  inv1   g078(.a(x27), .O(new_n130_));
  nor2   g079(.a(x26), .b(x25), .O(new_n131_));
  nand3  g080(.a(new_n131_), .b(new_n99_), .c(new_n80_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n61_), .c(new_n54_), .O(new_n133_));
  nor3   g082(.a(x27), .b(x26), .c(x25), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n99_), .O(new_n135_));
  oai22  g084(.a(new_n135_), .b(new_n81_), .c(new_n133_), .d(new_n130_), .O(new_n136_));
  ...
  oai21  g089(.a(new_n135_), .b(new_n81_), .c(x28), .O(new_n141_));
  nor3   g090(.a(x25), .b(x24), .c(x23), .O(new_n142_));
  nor3   g091(.a(x28), .b(x27), .c(x26), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n142_), .c(new_n80_), .d(new_n53_), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n141_), .c(new_n62_), .O(new_n145_));
  nor2   g094(.a(x16), .b(x06), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n145_), .c(new_n61_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n59_), .O(z09));
  inv1   g097(.a(x29), .O(new_n149_));
  nand2  g098(.a(new_n143_), .b(new_n110_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(new_n95_), .c(new_n61_), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n53_), .c(new_n149_), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n131_), .c(new_n130_), .d(new_n94_), .O(new_n154_));
  ...
  oai21  g108(.a(new_n154_), .b(new_n88_), .c(x30), .O(new_n160_));
  ...
  aoi21  g114(.a(new_n165_), .b(new_n160_), .c(new_n62_), .O(new_n166_));
  nor2   g115(.a(x16), .b(x04), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n166_), .c(new_n61_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(new_n59_), .O(z11));
  nand4  g118(.a(new_n162_), .b(new_n161_), .c(new_n131_), .d(new_n94_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n88_), .c(x31), .O(new_n171_));
  nor2   g120(.a(x31), .b(x30), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n153_), .O(new_n173_));
  inv1   g122(.a(new_n173_), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n134_), .c(new_n101_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n171_), .c(new_n62_), .O(new_n176_));
  nor2   g125(.a(x16), .b(x03), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(new_n61_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(new_n59_), .O(z12));
  nand4  g128(.a(new_n87_), .b(new_n73_), .c(new_n53_), .d(x16), .O(new_n180_));
  nor2   g129(.a(x27), .b(x26), .O(new_n181_));
  nand3  g130(.a(new_n174_), .b(new_n181_), .c(new_n110_), .O(new_n182_));
  ...
  nand3  g134(.a(new_n110_), .b(new_n98_), .c(new_n119_), .O(new_n186_));
  nand4  g135(.a(new_n172_), .b(new_n161_), .c(new_n149_), .d(new_n117_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n186_), .c(new_n185_), .O(new_n188_));
  aoi21  g137(.a(new_n188_), .b(new_n72_), .c(new_n58_), .O(new_n189_));
  nor2   g138(.a(x16), .b(x02), .O(new_n190_));
  aoi21  g139(.a(new_n189_), .b(x16), .c(new_n190_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(x18), .c(new_n184_), .O(z13));
  nand3  g141(.a(x33), .b(x32), .c(x16), .O(new_n193_));
  oai21  g142(.a(x16), .b(x01), .c(new_n193_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n61_), .O(new_n195_));
  nand4  g144(.a(new_n172_), .b(new_n153_), .c(new_n181_), .d(new_n106_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n100_), .c(x33), .O(new_n197_));
  nand2  g146(.a(new_n161_), .b(new_n131_), .O(new_n198_));
  nor2   g147(.a(x33), .b(x31), .O(new_n199_));
  nand2  g148(.a(new_n199_), .b(new_n162_), .O(new_n200_));
  nor2   g149(.a(new_n200_), .b(new_n198_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n101_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n197_), .c(new_n62_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(x18), .c(new_n58_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n195_), .O(z14));
  oai21  g154(.a(x33), .b(x32), .c(new_n61_), .O(new_n206_));
  oai21  g155(.a(new_n187_), .b(new_n120_), .c(new_n58_), .O(new_n207_));
  nand3  g156(.a(new_n207_), .b(new_n206_), .c(new_n53_), .O(new_n208_));
  nor3   g157(.a(x34), .b(x33), .c(x32), .O(new_n209_));
  nand4  g158(.a(new_n209_), .b(new_n172_), .c(new_n153_), .d(new_n181_), .O(new_n210_));
  ...
  aoi21  g162(.a(new_n62_), .b(new_n213_), .c(x18), .O(new_n214_));
  oai21  g163(.a(new_n212_), .b(new_n62_), .c(new_n214_), .O(z15));
endmodule
