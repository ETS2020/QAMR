...
module FAU ( 
  ...
  oai21  g081(.a(new_n53_), .b(x15), .c(new_n132_), .O(new_n133_));
  inv1   g082(.a(x27), .O(new_n134_));
  nor2   g083(.a(x26), .b(x25), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n92_), .c(new_n99_), .d(new_n72_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n56_), .O(new_n137_));
  aoi21  g086(.a(new_n137_), .b(new_n67_), .c(new_n134_), .O(new_n138_));
  nand3  g087(.a(new_n81_), .b(new_n58_), .c(new_n64_), .O(new_n139_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n133_), .c(new_n63_), .O(z08));
  inv1   g093(.a(x28), .O(new_n145_));
  nand2  g094(.a(new_n140_), .b(new_n114_), .O(new_n146_));
  ...
  nor3   g100(.a(new_n151_), .b(new_n139_), .c(new_n149_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n135_), .c(new_n103_), .d(new_n81_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n56_), .c(new_n66_), .O(new_n159_));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n125_), .c(new_n134_), .O(new_n161_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n140_), .c(new_n145_), .O(new_n179_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n160_), .c(new_n140_), .d(new_n110_), .O(new_n183_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n171_), .c(new_n150_), .d(new_n135_), .O(new_n194_));
  ...
  oai21  g150(.a(new_n201_), .b(new_n136_), .c(new_n56_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n67_), .c(new_n200_), .O(new_n203_));
  nand2  g152(.a(new_n160_), .b(new_n140_), .O(new_n204_));
  ...
  nand4  g161(.a(new_n205_), .b(new_n182_), .c(new_n160_), .d(new_n134_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n136_), .c(new_n56_), .O(new_n214_));
