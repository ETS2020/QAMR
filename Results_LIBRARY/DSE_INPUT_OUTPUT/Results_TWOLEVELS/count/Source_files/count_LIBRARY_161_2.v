...
module FAU ( 
  ...
  nand3  g013(.a(new_n60_), .b(new_n64_), .c(new_n63_), .O(new_n65_));
  ...
  nand3  g029(.a(new_n80_), .b(new_n60_), .c(new_n63_), .O(new_n81_));
  ...
  oai21  g046(.a(x15), .b(new_n52_), .c(x18), .O(new_n98_));
  ...
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n98_), .O(z05));
  ...
  nand4  g059(.a(new_n110_), .b(new_n91_), .c(new_n72_), .d(new_n61_), .O(new_n111_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(new_n98_), .O(z06));
  inv1   g065(.a(x26), .O(new_n117_));
  nand3  g066(.a(new_n110_), .b(new_n80_), .c(new_n88_), .O(new_n118_));
  aoi21  g067(.a(new_n118_), .b(new_n64_), .c(new_n65_), .O(new_n119_));
  nor3   g068(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n91_), .O(new_n121_));
  oai22  g070(.a(new_n121_), .b(new_n73_), .c(new_n119_), .d(new_n117_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(x16), .O(new_n123_));
  inv1   g072(.a(x08), .O(new_n124_));
  aoi21  g073(.a(new_n57_), .b(new_n124_), .c(x18), .O(new_n125_));
  aoi21  g074(.a(new_n125_), .b(new_n123_), .c(new_n53_), .O(z07));
  inv1   g075(.a(x27), .O(new_n127_));
  nor2   g076(.a(x26), .b(x25), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n91_), .c(new_n99_), .d(new_n71_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n64_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n66_), .c(new_n127_), .O(new_n131_));
  nand3  g080(.a(new_n80_), .b(new_n61_), .c(new_n60_), .O(new_n132_));
  ...
  nand4  g090(.a(new_n141_), .b(new_n110_), .c(new_n117_), .d(new_n88_), .O(new_n142_));
  oai22  g091(.a(new_n142_), .b(new_n132_), .c(new_n135_), .d(new_n140_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(x16), .O(new_n144_));
  nor2   g093(.a(x16), .b(x06), .O(new_n145_));
  nor2   g094(.a(new_n145_), .b(new_n53_), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n144_), .c(new_n98_), .O(z09));
  inv1   g096(.a(x29), .O(new_n148_));
  nand4  g097(.a(new_n141_), .b(new_n128_), .c(new_n100_), .d(new_n80_), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n64_), .c(new_n65_), .O(new_n150_));
  nor3   g099(.a(x29), .b(x28), .c(x27), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n120_), .c(new_n93_), .O(new_n152_));
  ...
  aoi21  g104(.a(new_n57_), .b(new_n155_), .c(x18), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(new_n154_), .c(new_n53_), .O(z10));
  oai21  g106(.a(x18), .b(new_n57_), .c(new_n52_), .O(new_n158_));
  nand2  g107(.a(new_n152_), .b(x30), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n141_), .c(new_n120_), .d(new_n93_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  aoi21  g112(.a(x18), .b(x15), .c(new_n53_), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n163_), .c(new_n158_), .O(z11));
  inv1   g114(.a(x31), .O(new_n166_));
  nand3  g115(.a(new_n160_), .b(new_n133_), .c(new_n140_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n118_), .c(new_n64_), .O(new_n168_));
  ...
  nand4  g120(.a(new_n171_), .b(new_n170_), .c(new_n133_), .d(new_n107_), .O(new_n172_));
  ...
  nand2  g127(.a(new_n141_), .b(new_n128_), .O(new_n179_));
  inv1   g128(.a(new_n179_), .O(new_n180_));
  nor2   g129(.a(x32), .b(x31), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n160_), .c(new_n180_), .d(new_n109_), .O(new_n182_));
  ...
  nand3  g135(.a(new_n186_), .b(new_n184_), .c(new_n98_), .O(z13));
  inv1   g136(.a(x33), .O(new_n188_));
  inv1   g137(.a(x30), .O(new_n189_));
  nand4  g138(.a(new_n181_), .b(new_n170_), .c(new_n189_), .d(new_n127_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n129_), .c(new_n64_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n66_), .c(new_n188_), .O(new_n192_));
  nand2  g141(.a(new_n170_), .b(new_n133_), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n171_), .O(new_n195_));
  nor3   g144(.a(new_n195_), .b(new_n193_), .c(new_n111_), .O(new_n196_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n171_), .c(new_n170_), .d(new_n127_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n129_), .c(new_n64_), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n66_), .c(new_n201_), .O(new_n204_));
  nand4  g153(.a(new_n171_), .b(new_n201_), .c(new_n188_), .d(new_n178_), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(new_n193_), .c(new_n111_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n204_), .c(x16), .O(new_n207_));
  inv1   g156(.a(x00), .O(new_n208_));
  aoi21  g157(.a(new_n57_), .b(new_n208_), .c(x18), .O(new_n209_));
