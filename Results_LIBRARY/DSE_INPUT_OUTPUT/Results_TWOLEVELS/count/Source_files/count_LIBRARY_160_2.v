...
module FAU ( 
  ...
  oai21  g006(.a(x11), .b(new_n57_), .c(x18), .O(new_n58_));
  nor2   g007(.a(x11), .b(new_n57_), .O(new_n59_));
  ...
  oai21  g038(.a(new_n89_), .b(x06), .c(new_n88_), .O(new_n90_));
  ...
  nand3  g046(.a(new_n97_), .b(new_n90_), .c(new_n58_), .O(z04));
  ...
  nand3  g052(.a(new_n103_), .b(new_n80_), .c(new_n66_), .O(new_n104_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n94_), .c(new_n72_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g070(.a(new_n114_), .b(new_n80_), .c(new_n91_), .O(new_n122_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n94_), .c(new_n99_), .d(new_n71_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n66_), .c(new_n132_), .O(new_n136_));
  nand3  g085(.a(new_n80_), .b(new_n55_), .c(new_n63_), .O(new_n137_));
  ...
  nand3  g120(.a(new_n171_), .b(new_n151_), .c(new_n125_), .O(new_n172_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n138_), .c(new_n146_), .O(new_n179_));
  ...
  nand4  g138(.a(new_n182_), .b(new_n151_), .c(new_n157_), .d(new_n121_), .O(new_n190_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n171_), .c(new_n151_), .d(new_n133_), .O(new_n194_));
  ...
  aoi21  g146(.a(new_n89_), .b(new_n197_), .c(x18), .O(new_n198_));
  ...
  nand3  g159(.a(new_n210_), .b(new_n208_), .c(new_n58_), .O(z14));
  ...
  aoi21  g168(.a(new_n89_), .b(new_n219_), .c(x18), .O(new_n220_));
