...
module FAU ( 
  ...
  nand3  g033(.a(new_n84_), .b(new_n59_), .c(new_n65_), .O(new_n85_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n93_), .c(new_n113_), .d(new_n59_), .O(new_n115_));
  ...
  nand3  g068(.a(new_n119_), .b(new_n117_), .c(new_n74_), .O(z06));
  aoi21  g069(.a(x16), .b(new_n52_), .c(new_n61_), .O(new_n121_));
  nor2   g070(.a(x26), .b(x25), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n93_), .c(new_n100_), .O(new_n123_));
  nor2   g072(.a(new_n123_), .b(new_n76_), .O(new_n124_));
  aoi21  g073(.a(new_n115_), .b(x26), .c(new_n124_), .O(new_n125_));
  aoi22  g074(.a(new_n54_), .b(new_n61_), .c(x18), .d(new_n52_), .O(new_n126_));
  oai21  g075(.a(new_n125_), .b(new_n121_), .c(new_n126_), .O(z07));
  inv1   g076(.a(x27), .O(new_n128_));
  nor3   g077(.a(x22), .b(x21), .c(x20), .O(new_n129_));
  nor3   g078(.a(x27), .b(x26), .c(x25), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n104_), .c(new_n129_), .d(new_n59_), .O(new_n131_));
  oai21  g080(.a(new_n124_), .b(new_n128_), .c(new_n131_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(x16), .O(new_n133_));
  inv1   g082(.a(x07), .O(new_n134_));
  aoi21  g083(.a(new_n71_), .b(new_n134_), .c(x18), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n133_), .c(new_n62_), .O(z08));
  and2   g085(.a(new_n131_), .b(x28), .O(new_n137_));
  inv1   g086(.a(x26), .O(new_n138_));
  nor2   g087(.a(x28), .b(x27), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n114_), .c(new_n138_), .d(new_n101_), .O(new_n140_));
  ...
  nand3  g093(.a(new_n144_), .b(new_n142_), .c(new_n74_), .O(z09));
  ...
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n103_), .d(new_n128_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g100(.a(x05), .O(new_n152_));
  aoi21  g101(.a(new_n71_), .b(new_n152_), .c(x18), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n151_), .c(new_n62_), .O(z10));
  nand4  g103(.a(new_n148_), .b(new_n122_), .c(new_n128_), .d(new_n100_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n94_), .c(x30), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n139_), .c(new_n147_), .d(new_n103_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(x16), .O(new_n160_));
  inv1   g109(.a(x04), .O(new_n161_));
  aoi21  g110(.a(new_n71_), .b(new_n161_), .c(x18), .O(new_n162_));
  aoi21  g111(.a(new_n162_), .b(new_n160_), .c(new_n62_), .O(z11));
  nand3  g112(.a(new_n157_), .b(new_n139_), .c(new_n147_), .O(new_n164_));
  oai21  g113(.a(new_n164_), .b(new_n94_), .c(x31), .O(new_n165_));
  nor2   g114(.a(x27), .b(x26), .O(new_n166_));
  nor2   g115(.a(x31), .b(x30), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n148_), .c(new_n166_), .d(new_n111_), .O(new_n168_));
  ...
  nor2   g121(.a(new_n172_), .b(new_n62_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n74_), .O(z12));
  oai21  g123(.a(new_n168_), .b(new_n105_), .c(x32), .O(new_n175_));
  nor2   g124(.a(x32), .b(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n157_), .c(new_n139_), .d(new_n122_), .O(new_n177_));
  ...
  aoi21  g131(.a(new_n71_), .b(new_n182_), .c(x18), .O(new_n183_));
  aoi21  g132(.a(new_n183_), .b(new_n181_), .c(new_n62_), .O(z13));
  oai21  g133(.a(new_n177_), .b(new_n105_), .c(x33), .O(new_n185_));
  nand4  g134(.a(new_n111_), .b(new_n100_), .c(new_n101_), .d(new_n82_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n76_), .O(new_n187_));
  nor2   g136(.a(x33), .b(x32), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n167_), .c(new_n148_), .d(new_n166_), .O(new_n189_));
  ...
  aoi21  g143(.a(new_n71_), .b(new_n194_), .c(x18), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n193_), .c(new_n62_), .O(z14));
  oai21  g145(.a(new_n189_), .b(new_n115_), .c(x34), .O(new_n197_));
  nand2  g146(.a(new_n148_), .b(new_n166_), .O(new_n198_));
  ...
  aoi21  g160(.a(new_n71_), .b(new_n211_), .c(x18), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n210_), .c(new_n62_), .O(z15));
endmodule
