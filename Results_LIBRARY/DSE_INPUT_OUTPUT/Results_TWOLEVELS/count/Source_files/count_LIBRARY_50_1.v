...
module FAU ( 
  ...
  nand2  g010(.a(x18), .b(x08), .O(new_n62_));
  ...
  nand2  g021(.a(new_n61_), .b(x18), .O(new_n73_));
  inv1   g022(.a(x21), .O(new_n74_));
  nand4  g023(.a(new_n74_), .b(new_n65_), .c(new_n56_), .d(new_n55_), .O(new_n75_));
  ...
  aoi21  g037(.a(new_n53_), .b(new_n88_), .c(x18), .O(new_n89_));
  aoi21  g038(.a(new_n89_), .b(new_n87_), .c(new_n64_), .O(z03));
  inv1   g039(.a(x23), .O(new_n91_));
  nor2   g040(.a(x20), .b(x19), .O(new_n92_));
  nor2   g041(.a(x23), .b(x22), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n74_), .d(new_n55_), .O(new_n94_));
  ...
  nand3  g049(.a(new_n91_), .b(new_n81_), .c(new_n74_), .O(new_n101_));
  nor2   g050(.a(new_n101_), .b(new_n67_), .O(new_n102_));
  nor2   g051(.a(x24), .b(x23), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n84_), .c(new_n92_), .d(new_n55_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n108_), .b(new_n106_), .c(new_n73_), .O(z05));
  inv1   g058(.a(x25), .O(new_n110_));
  inv1   g059(.a(new_n104_), .O(new_n111_));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n93_), .c(new_n82_), .d(new_n58_), .O(new_n113_));
  ...
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(new_n73_), .O(z06));
  nand2  g067(.a(new_n93_), .b(new_n58_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(x26), .O(new_n120_));
  nor3   g069(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand4  g070(.a(new_n121_), .b(new_n93_), .c(new_n82_), .d(new_n58_), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n120_), .c(new_n53_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(x18), .c(new_n61_), .O(new_n124_));
  nand2  g073(.a(new_n52_), .b(new_n60_), .O(new_n125_));
  nand2  g074(.a(x16), .b(x08), .O(new_n126_));
  aoi22  g075(.a(new_n126_), .b(new_n125_), .c(new_n112_), .d(new_n82_), .O(new_n127_));
  nor3   g076(.a(x16), .b(x15), .c(x08), .O(new_n128_));
  aoi21  g077(.a(new_n127_), .b(x26), .c(new_n128_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n124_), .O(z07));
  nand2  g079(.a(new_n122_), .b(x27), .O(new_n131_));
  nor3   g080(.a(x22), .b(x21), .c(x20), .O(new_n132_));
  nor3   g081(.a(x27), .b(x26), .c(x25), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n103_), .c(new_n132_), .d(new_n58_), .O(new_n134_));
  ...
  aoi21  g087(.a(new_n138_), .b(new_n136_), .c(new_n64_), .O(z08));
  and2   g088(.a(new_n134_), .b(x28), .O(new_n140_));
  inv1   g089(.a(x26), .O(new_n141_));
  nor2   g090(.a(x28), .b(x27), .O(new_n142_));
  nand4  g091(.a(new_n142_), .b(new_n112_), .c(new_n141_), .d(new_n91_), .O(new_n143_));
  ...
  nand3  g096(.a(new_n147_), .b(new_n145_), .c(new_n73_), .O(z09));
  oai21  g097(.a(new_n143_), .b(new_n85_), .c(x29), .O(new_n149_));
  inv1   g098(.a(x27), .O(new_n150_));
  nor2   g099(.a(x29), .b(x28), .O(new_n151_));
  nand4  g100(.a(new_n151_), .b(new_n121_), .c(new_n102_), .d(new_n150_), .O(new_n152_));
  ...
  aoi21  g105(.a(new_n156_), .b(new_n154_), .c(new_n64_), .O(z10));
  nor2   g106(.a(x26), .b(x25), .O(new_n158_));
  nand4  g107(.a(new_n151_), .b(new_n158_), .c(new_n150_), .d(new_n100_), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n94_), .c(x30), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n142_), .c(new_n121_), .d(new_n102_), .O(new_n162_));
  ...
  aoi21  g115(.a(new_n166_), .b(new_n164_), .c(new_n64_), .O(z11));
  nand3  g116(.a(new_n161_), .b(new_n142_), .c(new_n121_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n94_), .c(x31), .O(new_n169_));
  nor2   g118(.a(x27), .b(x26), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n151_), .c(new_n170_), .d(new_n110_), .O(new_n172_));
  or2    g121(.a(new_n172_), .b(new_n104_), .O(new_n173_));
  ...
  nand3  g126(.a(new_n177_), .b(new_n175_), .c(new_n73_), .O(z12));
  oai21  g127(.a(new_n172_), .b(new_n104_), .c(x32), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n161_), .c(new_n142_), .d(new_n158_), .O(new_n181_));
  ...
  aoi21  g136(.a(new_n187_), .b(new_n185_), .c(new_n64_), .O(z13));
  oai21  g137(.a(new_n181_), .b(new_n104_), .c(x33), .O(new_n189_));
  nand4  g138(.a(new_n110_), .b(new_n100_), .c(new_n91_), .d(new_n81_), .O(new_n190_));
  nor2   g139(.a(new_n190_), .b(new_n75_), .O(new_n191_));
  nor2   g140(.a(x33), .b(x32), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n171_), .c(new_n151_), .d(new_n170_), .O(new_n193_));
  ...
  aoi21  g148(.a(new_n199_), .b(new_n197_), .c(new_n64_), .O(z14));
  oai21  g149(.a(new_n193_), .b(new_n113_), .c(x34), .O(new_n201_));
  nand2  g150(.a(new_n151_), .b(new_n170_), .O(new_n202_));
  ...
  nand3  g160(.a(new_n211_), .b(new_n203_), .c(new_n191_), .O(new_n212_));
  ...
  aoi21  g165(.a(new_n216_), .b(new_n214_), .c(new_n64_), .O(z15));
endmodule
