...
module FAU ( 
  ...
  oai21  g009(.a(x15), .b(x00), .c(x18), .O(new_n61_));
  nand3  g010(.a(new_n61_), .b(new_n60_), .c(new_n55_), .O(z00));
  nor2   g011(.a(x15), .b(x00), .O(new_n63_));
  ...
  nand4  g039(.a(new_n90_), .b(new_n89_), .c(new_n71_), .d(new_n56_), .O(new_n91_));
  inv1   g040(.a(new_n91_), .O(new_n92_));
  oai21  g041(.a(new_n92_), .b(new_n88_), .c(x16), .O(new_n93_));
  inv1   g042(.a(x11), .O(new_n94_));
  aoi21  g043(.a(new_n54_), .b(new_n94_), .c(x18), .O(new_n95_));
  ...
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n89_), .d(new_n56_), .O(new_n100_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n90_), .c(new_n107_), .d(new_n59_), .O(new_n109_));
  ...
  nand4  g073(.a(new_n124_), .b(new_n99_), .c(new_n80_), .d(new_n59_), .O(new_n125_));
  ...
  aoi21  g121(.a(new_n54_), .b(new_n172_), .c(x18), .O(new_n173_));
  ...
  aoi21  g140(.a(new_n54_), .b(new_n191_), .c(x18), .O(new_n192_));
  ...
  oai21  g158(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n210_));
  ...
  nand3  g166(.a(new_n217_), .b(new_n210_), .c(new_n61_), .O(z15));
endmodule
