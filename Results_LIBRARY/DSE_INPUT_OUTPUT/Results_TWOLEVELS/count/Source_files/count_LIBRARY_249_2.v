...
module FAU ( 
  ...
  oai21  g026(.a(x07), .b(new_n52_), .c(x18), .O(new_n78_));
  ...
  nand2  g079(.a(new_n130_), .b(new_n100_), .O(new_n131_));
  oai22  g080(.a(new_n131_), .b(new_n82_), .c(new_n65_), .d(new_n129_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(x16), .c(x18), .O(new_n133_));
  inv1   g082(.a(x07), .O(new_n134_));
  oai21  g083(.a(x19), .b(new_n134_), .c(x05), .O(new_n135_));
  nor2   g084(.a(x26), .b(x25), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n92_), .c(new_n99_), .d(new_n70_), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n135_), .c(x27), .O(new_n138_));
  inv1   g087(.a(new_n138_), .O(new_n139_));
  nor3   g088(.a(x16), .b(x07), .c(x05), .O(new_n140_));
  aoi21  g089(.a(new_n139_), .b(x16), .c(new_n140_), .O(new_n141_));
  oai21  g090(.a(new_n133_), .b(new_n53_), .c(new_n141_), .O(z08));
  inv1   g091(.a(x28), .O(new_n143_));
  nor2   g092(.a(x27), .b(x26), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n111_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n93_), .c(new_n55_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n65_), .c(new_n143_), .O(new_n147_));
  nor2   g096(.a(x28), .b(x27), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n111_), .c(new_n118_), .d(new_n88_), .O(new_n149_));
  ...
  oai21  g103(.a(new_n60_), .b(new_n134_), .c(x05), .O(new_n155_));
  inv1   g104(.a(x29), .O(new_n156_));
  nand4  g105(.a(new_n148_), .b(new_n136_), .c(new_n100_), .d(new_n81_), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n55_), .c(new_n91_), .O(new_n158_));
  nor3   g107(.a(x29), .b(x28), .c(x27), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n122_), .c(new_n94_), .O(new_n160_));
  oai21  g109(.a(new_n158_), .b(new_n156_), .c(new_n160_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n155_), .O(new_n162_));
  inv1   g111(.a(x18), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(x16), .O(new_n164_));
  aoi22  g113(.a(new_n164_), .b(new_n52_), .c(x18), .d(x07), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n162_), .O(z10));
  nand2  g115(.a(new_n160_), .b(x30), .O(new_n167_));
  nand3  g116(.a(new_n92_), .b(new_n65_), .c(new_n70_), .O(new_n168_));
  nor2   g117(.a(x30), .b(x29), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n148_), .c(new_n122_), .O(new_n170_));
  ...
  nand3  g124(.a(new_n175_), .b(new_n173_), .c(new_n78_), .O(z11));
  oai21  g125(.a(new_n170_), .b(new_n168_), .c(x31), .O(new_n177_));
  ...
  oai21  g129(.a(new_n180_), .b(new_n101_), .c(new_n177_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(x16), .O(new_n182_));
  nor2   g131(.a(x16), .b(x03), .O(new_n183_));
  nor2   g132(.a(new_n183_), .b(new_n53_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n182_), .c(new_n78_), .O(z12));
  oai21  g134(.a(new_n180_), .b(new_n101_), .c(x32), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n169_), .c(new_n148_), .d(new_n136_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n101_), .c(new_n186_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(x16), .O(new_n190_));
  nor2   g139(.a(x16), .b(x02), .O(new_n191_));
  nor2   g140(.a(new_n191_), .b(new_n53_), .O(new_n192_));
  nand3  g141(.a(new_n192_), .b(new_n190_), .c(new_n78_), .O(z13));
  inv1   g142(.a(x33), .O(new_n194_));
  inv1   g143(.a(x30), .O(new_n195_));
  nand4  g144(.a(new_n187_), .b(new_n178_), .c(new_n195_), .d(new_n129_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n137_), .c(new_n55_), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n65_), .c(new_n194_), .O(new_n198_));
  nand2  g147(.a(new_n178_), .b(new_n144_), .O(new_n199_));
  ...
  nand4  g156(.a(new_n200_), .b(new_n179_), .c(new_n178_), .d(new_n129_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n137_), .c(new_n55_), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n65_), .c(new_n207_), .O(new_n210_));
  inv1   g159(.a(x32), .O(new_n211_));
  nand4  g160(.a(new_n179_), .b(new_n207_), .c(new_n194_), .d(new_n211_), .O(new_n212_));
  nor3   g161(.a(new_n212_), .b(new_n199_), .c(new_n112_), .O(new_n213_));
