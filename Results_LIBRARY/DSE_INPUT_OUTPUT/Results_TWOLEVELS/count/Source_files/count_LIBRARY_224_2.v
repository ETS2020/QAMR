...
module FAU ( 
  ...
  nand4  g051(.a(new_n102_), .b(new_n73_), .c(new_n80_), .d(new_n54_), .O(new_n103_));
  aoi21  g052(.a(new_n103_), .b(new_n101_), .c(x19), .O(new_n104_));
  and2   g053(.a(new_n83_), .b(x24), .O(new_n105_));
  oai21  g054(.a(new_n105_), .b(new_n104_), .c(x16), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n100_), .c(new_n63_), .O(z05));
  inv1   g056(.a(x25), .O(new_n108_));
  nand2  g057(.a(new_n102_), .b(new_n82_), .O(new_n109_));
  ...
  aoi21  g080(.a(x16), .b(x10), .c(new_n52_), .O(new_n132_));
  inv1   g081(.a(x24), .O(new_n133_));
  nor2   g082(.a(x26), .b(x25), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n92_), .c(new_n133_), .d(new_n72_), .O(new_n135_));
  ...
  nand3  g087(.a(new_n138_), .b(new_n102_), .c(new_n108_), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(new_n83_), .O(new_n140_));
  aoi21  g089(.a(new_n137_), .b(x27), .c(new_n140_), .O(new_n141_));
  inv1   g090(.a(x18), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(x16), .O(new_n143_));
  aoi22  g092(.a(new_n143_), .b(new_n52_), .c(x18), .d(x10), .O(new_n144_));
  oai21  g093(.a(new_n141_), .b(new_n132_), .c(new_n144_), .O(z08));
  inv1   g094(.a(x28), .O(new_n146_));
  nor2   g095(.a(x25), .b(x23), .O(new_n147_));
  aoi21  g096(.a(new_n147_), .b(new_n138_), .c(x19), .O(new_n148_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n112_), .c(new_n121_), .d(new_n89_), .O(new_n155_));
  ...
  nand4  g109(.a(new_n82_), .b(new_n67_), .c(new_n146_), .d(new_n133_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n148_), .c(x29), .O(new_n162_));
  inv1   g111(.a(x27), .O(new_n163_));
  nor2   g112(.a(x29), .b(x28), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n125_), .c(new_n94_), .d(new_n163_), .O(new_n165_));
  ...
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n63_), .O(z10));
  inv1   g119(.a(x30), .O(new_n171_));
  nand3  g120(.a(new_n164_), .b(new_n134_), .c(new_n163_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n109_), .c(new_n55_), .O(new_n173_));
  ...
  nor3   g125(.a(new_n176_), .b(new_n93_), .c(new_n66_), .O(new_n177_));
  ...
  aoi21  g129(.a(new_n180_), .b(new_n178_), .c(new_n53_), .O(z11));
  inv1   g130(.a(x31), .O(new_n182_));
  nand3  g131(.a(new_n175_), .b(new_n138_), .c(new_n146_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n122_), .c(new_n55_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n67_), .c(new_n182_), .O(new_n185_));
  nand3  g134(.a(new_n102_), .b(new_n82_), .c(new_n67_), .O(new_n186_));
  nor2   g135(.a(x31), .b(x30), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n164_), .c(new_n138_), .d(new_n108_), .O(new_n188_));
  ...
  aoi21  g141(.a(new_n192_), .b(new_n190_), .c(new_n53_), .O(z12));
  inv1   g142(.a(x32), .O(new_n194_));
  nand2  g143(.a(new_n134_), .b(new_n89_), .O(new_n195_));
  nand2  g144(.a(new_n187_), .b(new_n163_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n195_), .c(new_n55_), .O(new_n197_));
  nand2  g146(.a(new_n164_), .b(new_n150_), .O(new_n198_));
  ...
  nand4  g150(.a(new_n201_), .b(new_n175_), .c(new_n154_), .d(new_n134_), .O(new_n202_));
  nor2   g151(.a(new_n202_), .b(new_n186_), .O(new_n203_));
  ...
  nand4  g157(.a(new_n201_), .b(new_n164_), .c(new_n171_), .d(new_n163_), .O(new_n209_));
  oai21  g158(.a(new_n209_), .b(new_n135_), .c(new_n55_), .O(new_n210_));
  aoi21  g159(.a(new_n210_), .b(new_n67_), .c(new_n208_), .O(new_n211_));
  nor2   g160(.a(x33), .b(x32), .O(new_n212_));
  nand4  g161(.a(new_n212_), .b(new_n187_), .c(new_n164_), .d(new_n138_), .O(new_n213_));
  nor2   g162(.a(new_n213_), .b(new_n115_), .O(new_n214_));
  ...
  nand4  g168(.a(new_n208_), .b(new_n182_), .c(new_n171_), .d(new_n163_), .O(new_n220_));
  oai21  g169(.a(new_n220_), .b(new_n195_), .c(new_n55_), .O(new_n221_));
  nor2   g170(.a(x32), .b(x29), .O(new_n222_));
  nand3  g171(.a(new_n222_), .b(new_n150_), .c(new_n146_), .O(new_n223_));
  nor2   g172(.a(new_n223_), .b(new_n74_), .O(new_n224_));
  aoi21  g173(.a(new_n224_), .b(new_n221_), .c(new_n219_), .O(new_n225_));
  nor3   g174(.a(x34), .b(x33), .c(x32), .O(new_n226_));
  nand4  g175(.a(new_n226_), .b(new_n187_), .c(new_n164_), .d(new_n138_), .O(new_n227_));
  nor2   g176(.a(new_n227_), .b(new_n115_), .O(new_n228_));
  ...
  nand3  g180(.a(new_n231_), .b(new_n229_), .c(new_n63_), .O(z15));
endmodule
