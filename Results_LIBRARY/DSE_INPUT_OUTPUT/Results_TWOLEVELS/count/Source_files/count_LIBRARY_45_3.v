...
module FAU ( 
  ...
  oai21  g012(.a(x18), .b(new_n61_), .c(new_n53_), .O(new_n64_));
  ...
  aoi21  g018(.a(x18), .b(new_n52_), .c(new_n54_), .O(new_n70_));
  nand3  g019(.a(new_n70_), .b(new_n69_), .c(new_n64_), .O(z01));
  ...
  aoi21  g027(.a(new_n61_), .b(new_n78_), .c(new_n54_), .O(new_n79_));
  nand3  g028(.a(new_n79_), .b(new_n77_), .c(new_n72_), .O(z02));
  oai21  g029(.a(x18), .b(new_n61_), .c(new_n52_), .O(new_n81_));
  and2   g030(.a(new_n75_), .b(x22), .O(new_n82_));
  ...
  aoi21  g035(.a(x18), .b(new_n53_), .c(new_n54_), .O(new_n87_));
  nand3  g036(.a(new_n87_), .b(new_n86_), .c(new_n81_), .O(z03));
  inv1   g037(.a(x23), .O(new_n89_));
  oai21  g038(.a(x22), .b(x21), .c(new_n56_), .O(new_n90_));
  aoi21  g039(.a(new_n90_), .b(new_n68_), .c(new_n89_), .O(new_n91_));
  nor2   g040(.a(x23), .b(x22), .O(new_n92_));
  nand3  g041(.a(new_n92_), .b(new_n68_), .c(new_n73_), .O(new_n93_));
  inv1   g042(.a(new_n93_), .O(new_n94_));
  oai21  g043(.a(new_n94_), .b(new_n91_), .c(x16), .O(new_n95_));
  inv1   g044(.a(x11), .O(new_n96_));
  aoi21  g045(.a(new_n61_), .b(new_n96_), .c(x18), .O(new_n97_));
  aoi21  g046(.a(new_n97_), .b(new_n95_), .c(new_n54_), .O(z04));
  inv1   g047(.a(x24), .O(new_n99_));
  nor2   g048(.a(x24), .b(x23), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n83_), .c(new_n68_), .O(new_n101_));
  ...
  aoi21  g053(.a(new_n61_), .b(new_n104_), .c(new_n54_), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n72_), .O(z05));
  inv1   g055(.a(x25), .O(new_n107_));
  nand2  g056(.a(new_n100_), .b(new_n83_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n56_), .O(new_n109_));
  aoi21  g058(.a(new_n109_), .b(new_n68_), .c(new_n107_), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n92_), .c(new_n74_), .d(new_n58_), .O(new_n112_));
  ...
  nand3  g067(.a(new_n111_), .b(new_n83_), .c(new_n89_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n56_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n68_), .c(new_n118_), .O(new_n121_));
  ...
  nand3  g079(.a(new_n130_), .b(new_n100_), .c(new_n107_), .O(new_n131_));
  oai22  g080(.a(new_n131_), .b(new_n84_), .c(new_n124_), .d(new_n129_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(x16), .O(new_n133_));
  nor2   g082(.a(x16), .b(x07), .O(new_n134_));
  nor2   g083(.a(new_n134_), .b(new_n54_), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n72_), .O(z08));
  inv1   g085(.a(x28), .O(new_n137_));
  nand2  g086(.a(new_n92_), .b(new_n73_), .O(new_n138_));
  nand2  g087(.a(new_n130_), .b(new_n111_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n138_), .c(new_n56_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n68_), .c(new_n137_), .O(new_n141_));
  nand2  g090(.a(new_n111_), .b(new_n89_), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n118_), .O(new_n144_));
  nor3   g093(.a(new_n144_), .b(new_n142_), .c(new_n84_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n141_), .c(x16), .O(new_n146_));
  inv1   g095(.a(x06), .O(new_n147_));
  aoi21  g096(.a(new_n61_), .b(new_n147_), .c(x18), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n146_), .c(new_n54_), .O(z09));
  inv1   g098(.a(x29), .O(new_n150_));
  nor2   g099(.a(x26), .b(x25), .O(new_n151_));
  nand4  g100(.a(new_n143_), .b(new_n151_), .c(new_n100_), .d(new_n83_), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n56_), .c(new_n67_), .O(new_n153_));
  nor2   g102(.a(x29), .b(x28), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n122_), .c(new_n129_), .O(new_n155_));
  oai22  g104(.a(new_n155_), .b(new_n93_), .c(new_n153_), .d(new_n150_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g106(.a(x05), .O(new_n158_));
  aoi21  g107(.a(new_n61_), .b(new_n158_), .c(x18), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n54_), .O(z10));
  inv1   g109(.a(x30), .O(new_n161_));
  nand3  g110(.a(new_n154_), .b(new_n151_), .c(new_n129_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n108_), .c(new_n56_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n68_), .c(new_n161_), .O(new_n164_));
  nor2   g113(.a(x30), .b(x29), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n143_), .c(new_n122_), .O(new_n166_));
  ...
  aoi21  g118(.a(new_n61_), .b(new_n169_), .c(x18), .O(new_n170_));
  aoi21  g119(.a(new_n170_), .b(new_n168_), .c(new_n54_), .O(z11));
  inv1   g120(.a(x31), .O(new_n172_));
  nand3  g121(.a(new_n165_), .b(new_n130_), .c(new_n137_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n119_), .c(new_n56_), .O(new_n174_));
  aoi21  g123(.a(new_n174_), .b(new_n68_), .c(new_n172_), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n154_), .c(new_n130_), .d(new_n107_), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n101_), .O(new_n178_));
  ...
  aoi21  g130(.a(new_n181_), .b(new_n179_), .c(new_n54_), .O(z12));
  inv1   g131(.a(x32), .O(new_n183_));
  nand4  g132(.a(new_n176_), .b(new_n143_), .c(new_n150_), .d(new_n118_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n119_), .c(new_n56_), .O(new_n185_));
  aoi21  g134(.a(new_n185_), .b(new_n68_), .c(new_n183_), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n165_), .c(new_n143_), .d(new_n151_), .O(new_n188_));
  nor2   g137(.a(new_n188_), .b(new_n101_), .O(new_n189_));
  ...
  aoi21  g141(.a(new_n192_), .b(new_n190_), .c(new_n54_), .O(z13));
  inv1   g142(.a(x33), .O(new_n194_));
  nand4  g143(.a(new_n151_), .b(new_n92_), .c(new_n99_), .d(new_n73_), .O(new_n195_));
  nand4  g144(.a(new_n187_), .b(new_n154_), .c(new_n161_), .d(new_n129_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n195_), .c(new_n56_), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n68_), .c(new_n194_), .O(new_n198_));
  nand2  g147(.a(new_n154_), .b(new_n130_), .O(new_n199_));
  nor2   g148(.a(x33), .b(x32), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n176_), .O(new_n201_));
  ...
  aoi21  g154(.a(new_n205_), .b(new_n203_), .c(new_n54_), .O(z14));
  inv1   g155(.a(x34), .O(new_n207_));
  nand4  g156(.a(new_n200_), .b(new_n176_), .c(new_n154_), .d(new_n129_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n195_), .c(new_n56_), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n68_), .c(new_n207_), .O(new_n210_));
  nand4  g159(.a(new_n176_), .b(new_n207_), .c(new_n194_), .d(new_n183_), .O(new_n211_));
  ...
  aoi21  g164(.a(new_n215_), .b(new_n213_), .c(new_n54_), .O(z15));
endmodule
