...
module FAU ( 
  ...
  nand3  g024(.a(new_n68_), .b(new_n75_), .c(new_n57_), .O(new_n76_));
  ...
  nand3  g034(.a(new_n85_), .b(new_n83_), .c(new_n58_), .O(z03));
  nand2  g035(.a(new_n81_), .b(x23), .O(new_n87_));
  nor2   g036(.a(x23), .b(x22), .O(new_n88_));
  nand3  g037(.a(new_n88_), .b(new_n65_), .c(new_n71_), .O(new_n89_));
  ...
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n58_), .O(z05));
  ...
  nand4  g059(.a(new_n110_), .b(new_n88_), .c(new_n109_), .d(new_n55_), .O(new_n111_));
  oai21  g060(.a(new_n108_), .b(new_n107_), .c(new_n111_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x16), .O(new_n113_));
  nor2   g062(.a(x16), .b(x09), .O(new_n114_));
  nor2   g063(.a(new_n114_), .b(new_n59_), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(new_n58_), .O(z06));
  oai21  g065(.a(new_n68_), .b(new_n75_), .c(x08), .O(new_n117_));
  inv1   g066(.a(x26), .O(new_n118_));
  inv1   g067(.a(x23), .O(new_n119_));
  nand4  g068(.a(new_n107_), .b(new_n95_), .c(new_n119_), .d(new_n78_), .O(new_n120_));
  nor2   g069(.a(new_n120_), .b(new_n72_), .O(new_n121_));
  nor3   g070(.a(x26), .b(x25), .c(x24), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n88_), .c(new_n79_), .O(new_n123_));
  ...
  aoi22  g076(.a(new_n127_), .b(new_n57_), .c(x18), .d(x13), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n125_), .O(z07));
  nand2  g078(.a(new_n123_), .b(x27), .O(new_n130_));
  nor3   g079(.a(x22), .b(x21), .c(x20), .O(new_n131_));
  nor3   g080(.a(x27), .b(x26), .c(x25), .O(new_n132_));
  nand4  g081(.a(new_n132_), .b(new_n100_), .c(new_n131_), .d(new_n55_), .O(new_n133_));
  ...
  nand3  g086(.a(new_n137_), .b(new_n135_), .c(new_n58_), .O(z08));
  ...
  aoi21  g095(.a(new_n146_), .b(new_n144_), .c(new_n59_), .O(z09));
  inv1   g096(.a(x29), .O(new_n148_));
  nor2   g097(.a(x28), .b(x27), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n110_), .c(new_n118_), .d(new_n119_), .O(new_n150_));
  nor2   g099(.a(new_n150_), .b(new_n81_), .O(new_n151_));
  inv1   g100(.a(x27), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n122_), .c(new_n152_), .O(new_n154_));
  oai22  g103(.a(new_n154_), .b(new_n89_), .c(new_n151_), .d(new_n148_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(x16), .O(new_n156_));
  nor2   g105(.a(x16), .b(x05), .O(new_n157_));
  nor2   g106(.a(new_n157_), .b(new_n59_), .O(new_n158_));
  nand3  g107(.a(new_n158_), .b(new_n156_), .c(new_n58_), .O(z10));
  oai21  g108(.a(new_n154_), .b(new_n89_), .c(x30), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n149_), .c(new_n122_), .d(new_n99_), .O(new_n162_));
  ...
  nand3  g115(.a(new_n166_), .b(new_n164_), .c(new_n58_), .O(z11));
  nand3  g116(.a(new_n161_), .b(new_n149_), .c(new_n122_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n89_), .c(x31), .O(new_n169_));
  nor2   g118(.a(x31), .b(x30), .O(new_n170_));
  nand4  g119(.a(new_n170_), .b(new_n153_), .c(new_n132_), .d(new_n108_), .O(new_n171_));
  ...
  nand3  g124(.a(new_n175_), .b(new_n173_), .c(new_n58_), .O(z12));
  ...
  or2    g130(.a(new_n181_), .b(new_n101_), .O(new_n182_));
  ...
  nand3  g135(.a(new_n186_), .b(new_n184_), .c(new_n58_), .O(z13));
  oai21  g136(.a(new_n181_), .b(new_n101_), .c(x33), .O(new_n188_));
  ...
  nand2  g141(.a(new_n192_), .b(new_n121_), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n188_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(x16), .O(new_n195_));
  inv1   g144(.a(x01), .O(new_n196_));
  aoi21  g145(.a(new_n68_), .b(new_n196_), .c(x18), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n195_), .c(new_n59_), .O(z14));
  ...
  nand3  g158(.a(new_n209_), .b(new_n201_), .c(new_n121_), .O(new_n210_));
  nand2  g159(.a(new_n210_), .b(new_n199_), .O(new_n211_));
  nand2  g160(.a(new_n211_), .b(x16), .O(new_n212_));
  inv1   g161(.a(x00), .O(new_n213_));
  aoi21  g162(.a(new_n68_), .b(new_n213_), .c(x18), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n212_), .c(new_n59_), .O(z15));
endmodule
