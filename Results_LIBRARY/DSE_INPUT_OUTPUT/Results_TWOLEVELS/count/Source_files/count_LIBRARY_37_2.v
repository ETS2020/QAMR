...
module FAU ( 
  ...
  oai21  g036(.a(new_n68_), .b(x02), .c(new_n87_), .O(new_n88_));
  nand2  g037(.a(new_n81_), .b(x23), .O(new_n89_));
  nor2   g038(.a(x23), .b(x22), .O(new_n90_));
  nand3  g039(.a(new_n90_), .b(new_n65_), .c(new_n71_), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(x16), .O(new_n93_));
  nand3  g042(.a(new_n93_), .b(new_n88_), .c(new_n58_), .O(z04));
  inv1   g043(.a(x24), .O(new_n95_));
  nor2   g044(.a(x20), .b(x19), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(new_n52_), .O(new_n97_));
  nand2  g046(.a(new_n90_), .b(new_n71_), .O(new_n98_));
  ...
  aoi21  g053(.a(new_n68_), .b(new_n104_), .c(x18), .O(new_n105_));
  ...
  nand4  g067(.a(new_n107_), .b(new_n95_), .c(new_n118_), .d(new_n78_), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n72_), .O(new_n120_));
  nor3   g069(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n90_), .c(new_n79_), .O(new_n122_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n124_), .c(new_n58_), .O(z07));
  nand2  g076(.a(new_n122_), .b(x27), .O(new_n128_));
  nor3   g077(.a(x22), .b(x21), .c(x20), .O(new_n129_));
  nor3   g078(.a(x27), .b(x26), .c(x25), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n100_), .c(new_n129_), .d(new_n55_), .O(new_n131_));
  ...
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n58_), .O(z08));
  ...
  nand3  g092(.a(new_n143_), .b(new_n141_), .c(new_n58_), .O(z09));
  inv1   g093(.a(x29), .O(new_n145_));
  inv1   g094(.a(x27), .O(new_n146_));
  nor2   g095(.a(x29), .b(x28), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n121_), .c(new_n146_), .O(new_n148_));
  oai22  g097(.a(new_n148_), .b(new_n91_), .c(new_n140_), .d(new_n145_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  nor2   g099(.a(x16), .b(x05), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n59_), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n150_), .c(new_n58_), .O(z10));
  oai21  g102(.a(new_n148_), .b(new_n91_), .c(x30), .O(new_n154_));
  nor2   g103(.a(x30), .b(x29), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n138_), .c(new_n121_), .d(new_n99_), .O(new_n156_));
  ...
  nand3  g110(.a(new_n155_), .b(new_n138_), .c(new_n121_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n91_), .c(x31), .O(new_n163_));
  nor2   g112(.a(x31), .b(x30), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n147_), .c(new_n130_), .d(new_n108_), .O(new_n165_));
  ...
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n58_), .O(z12));
  oai21  g119(.a(x18), .b(new_n68_), .c(new_n57_), .O(new_n171_));
  nand3  g120(.a(new_n164_), .b(new_n147_), .c(new_n130_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n101_), .c(x32), .O(new_n173_));
  nor2   g122(.a(x26), .b(x25), .O(new_n174_));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n155_), .c(new_n138_), .d(new_n174_), .O(new_n176_));
  or2    g125(.a(new_n176_), .b(new_n101_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  aoi21  g128(.a(x18), .b(x11), .c(new_n59_), .O(new_n180_));
  nand3  g129(.a(new_n180_), .b(new_n179_), .c(new_n171_), .O(z13));
  oai21  g130(.a(new_n176_), .b(new_n101_), .c(x33), .O(new_n182_));
  nor2   g131(.a(x27), .b(x26), .O(new_n183_));
  nor2   g132(.a(x33), .b(x32), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n164_), .c(new_n147_), .d(new_n183_), .O(new_n185_));
  ...
  aoi21  g139(.a(new_n68_), .b(new_n190_), .c(x18), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n189_), .c(new_n59_), .O(z14));
  oai21  g141(.a(new_n185_), .b(new_n111_), .c(x34), .O(new_n193_));
  nand2  g142(.a(new_n147_), .b(new_n183_), .O(new_n194_));
  ...
  aoi21  g156(.a(new_n68_), .b(new_n207_), .c(x18), .O(new_n208_));
  aoi21  g157(.a(new_n208_), .b(new_n206_), .c(new_n59_), .O(z15));
endmodule
