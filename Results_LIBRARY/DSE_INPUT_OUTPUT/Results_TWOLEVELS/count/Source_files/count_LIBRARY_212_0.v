...
module FAU ( 
  ...
  nand3  g034(.a(new_n85_), .b(new_n83_), .c(new_n61_), .O(z03));
  ...
  nand2  g057(.a(new_n102_), .b(new_n53_), .O(new_n109_));
  aoi21  g058(.a(new_n109_), .b(new_n65_), .c(new_n108_), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n90_), .c(new_n71_), .d(new_n55_), .O(new_n112_));
  ...
  aoi21  g066(.a(new_n117_), .b(new_n114_), .c(new_n57_), .O(z06));
  inv1   g067(.a(x26), .O(new_n119_));
  nand3  g068(.a(new_n111_), .b(new_n79_), .c(new_n87_), .O(new_n120_));
  ...
  nand3  g077(.a(new_n128_), .b(new_n126_), .c(new_n61_), .O(z07));
  inv1   g078(.a(x02), .O(new_n130_));
  inv1   g079(.a(x07), .O(new_n131_));
  oai21  g080(.a(new_n116_), .b(new_n130_), .c(new_n131_), .O(new_n132_));
  inv1   g081(.a(x27), .O(new_n133_));
  nor2   g082(.a(x26), .b(x25), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n90_), .c(new_n97_), .d(new_n70_), .O(new_n135_));
  nand2  g084(.a(new_n135_), .b(new_n53_), .O(new_n136_));
  aoi21  g085(.a(new_n136_), .b(new_n65_), .c(new_n133_), .O(new_n137_));
  nand3  g086(.a(new_n79_), .b(new_n55_), .c(new_n62_), .O(new_n138_));
  ...
  nand2  g093(.a(new_n139_), .b(new_n111_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n98_), .c(new_n53_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n65_), .c(new_n144_), .O(new_n147_));
  nand2  g096(.a(new_n111_), .b(new_n87_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(new_n101_), .d(new_n79_), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n53_), .c(new_n64_), .O(new_n158_));
  nor2   g107(.a(x29), .b(x28), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n123_), .c(new_n133_), .O(new_n160_));
  oai22  g109(.a(new_n160_), .b(new_n91_), .c(new_n158_), .d(new_n156_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(x16), .O(new_n162_));
  inv1   g111(.a(x05), .O(new_n163_));
  aoi21  g112(.a(new_n116_), .b(new_n163_), .c(x18), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n162_), .c(new_n57_), .O(z10));
  inv1   g114(.a(x30), .O(new_n166_));
  nand3  g115(.a(new_n159_), .b(new_n134_), .c(new_n133_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n102_), .c(new_n53_), .O(new_n168_));
  ...
  nor2   g120(.a(new_n171_), .b(new_n91_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n169_), .c(x16), .O(new_n173_));
  inv1   g122(.a(x04), .O(new_n174_));
  aoi21  g123(.a(new_n116_), .b(new_n174_), .c(x18), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n173_), .c(new_n57_), .O(z11));
  inv1   g125(.a(x31), .O(new_n177_));
  nand3  g126(.a(new_n170_), .b(new_n139_), .c(new_n144_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n120_), .c(new_n53_), .O(new_n179_));
  aoi21  g128(.a(new_n179_), .b(new_n65_), .c(new_n177_), .O(new_n180_));
  inv1   g129(.a(new_n103_), .O(new_n181_));
  nor2   g130(.a(x31), .b(x30), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n159_), .c(new_n139_), .d(new_n108_), .O(new_n183_));
  ...
  nor2   g135(.a(new_n186_), .b(new_n57_), .O(new_n187_));
  nand3  g136(.a(new_n187_), .b(new_n185_), .c(new_n61_), .O(z12));
  oai21  g137(.a(new_n116_), .b(new_n131_), .c(new_n130_), .O(new_n189_));
  inv1   g138(.a(x32), .O(new_n190_));
  nand4  g139(.a(new_n182_), .b(new_n149_), .c(new_n156_), .d(new_n119_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n120_), .c(new_n53_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n65_), .c(new_n190_), .O(new_n193_));
  ...
  nand3  g146(.a(new_n197_), .b(new_n189_), .c(new_n61_), .O(z13));
  inv1   g147(.a(x33), .O(new_n199_));
  nand4  g148(.a(new_n194_), .b(new_n159_), .c(new_n166_), .d(new_n133_), .O(new_n200_));
  oai21  g149(.a(new_n200_), .b(new_n135_), .c(new_n53_), .O(new_n201_));
  ...
  nand2  g153(.a(new_n204_), .b(new_n182_), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(new_n203_), .c(new_n112_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n202_), .c(x16), .O(new_n207_));
  inv1   g156(.a(x01), .O(new_n208_));
  aoi21  g157(.a(new_n116_), .b(new_n208_), .c(x18), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n207_), .c(new_n57_), .O(z14));
  inv1   g159(.a(x34), .O(new_n211_));
  nand4  g160(.a(new_n204_), .b(new_n182_), .c(new_n159_), .d(new_n133_), .O(new_n212_));
  oai21  g161(.a(new_n212_), .b(new_n135_), .c(new_n53_), .O(new_n213_));
  aoi21  g162(.a(new_n213_), .b(new_n65_), .c(new_n211_), .O(new_n214_));
  nand4  g163(.a(new_n182_), .b(new_n211_), .c(new_n199_), .d(new_n190_), .O(new_n215_));
  nor3   g164(.a(new_n215_), .b(new_n203_), .c(new_n112_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n214_), .c(x16), .O(new_n217_));
  nor2   g166(.a(x16), .b(x00), .O(new_n218_));
  nor2   g167(.a(new_n218_), .b(new_n57_), .O(new_n219_));
  nand3  g168(.a(new_n219_), .b(new_n217_), .c(new_n61_), .O(z15));
endmodule
