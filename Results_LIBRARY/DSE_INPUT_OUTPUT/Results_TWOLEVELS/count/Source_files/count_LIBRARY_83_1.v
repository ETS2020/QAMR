...
module FAU ( 
  ...
  oai21  g045(.a(new_n59_), .b(x11), .c(new_n96_), .O(z04));
  oai21  g046(.a(new_n93_), .b(x19), .c(new_n70_), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n78_), .c(new_n70_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(new_n52_), .O(new_n101_));
  aoi21  g050(.a(new_n98_), .b(x24), .c(new_n101_), .O(new_n102_));
  oai22  g051(.a(new_n102_), .b(new_n85_), .c(new_n59_), .d(x10), .O(z05));
  inv1   g052(.a(x25), .O(new_n104_));
  nand2  g053(.a(new_n99_), .b(new_n78_), .O(new_n105_));
  ...
  nand4  g057(.a(new_n108_), .b(new_n91_), .c(new_n72_), .d(new_n54_), .O(new_n109_));
  inv1   g058(.a(new_n109_), .O(new_n110_));
  oai21  g059(.a(new_n110_), .b(new_n107_), .c(x16), .O(new_n111_));
  inv1   g060(.a(x09), .O(new_n112_));
  aoi21  g061(.a(new_n85_), .b(new_n112_), .c(x18), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(new_n111_), .O(z06));
  inv1   g063(.a(x26), .O(new_n115_));
  nand3  g064(.a(new_n108_), .b(new_n78_), .c(new_n88_), .O(new_n116_));
  nand2  g065(.a(new_n116_), .b(new_n64_), .O(new_n117_));
  aoi21  g066(.a(new_n117_), .b(new_n70_), .c(new_n115_), .O(new_n118_));
  ...
  aoi21  g072(.a(new_n85_), .b(new_n123_), .c(x18), .O(new_n124_));
  ...
  nand4  g077(.a(new_n128_), .b(new_n91_), .c(new_n127_), .d(new_n69_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n64_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n70_), .c(new_n126_), .O(new_n131_));
  nand3  g080(.a(new_n78_), .b(new_n54_), .c(new_n61_), .O(new_n132_));
  nor2   g081(.a(x27), .b(x26), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n99_), .c(new_n104_), .O(new_n134_));
  oai21  g083(.a(new_n134_), .b(new_n132_), .c(new_n52_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n131_), .c(x16), .O(new_n136_));
  oai21  g085(.a(new_n59_), .b(x07), .c(new_n136_), .O(z08));
  inv1   g086(.a(x28), .O(new_n138_));
  nand2  g087(.a(new_n133_), .b(new_n108_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n92_), .c(new_n64_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n70_), .c(new_n138_), .O(new_n141_));
  nand2  g090(.a(new_n108_), .b(new_n88_), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n115_), .O(new_n144_));
  nor3   g093(.a(new_n144_), .b(new_n132_), .c(new_n142_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n141_), .c(x16), .O(new_n146_));
  inv1   g095(.a(x06), .O(new_n147_));
  aoi21  g096(.a(new_n85_), .b(new_n147_), .c(x18), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n146_), .O(z09));
  inv1   g098(.a(x29), .O(new_n150_));
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(new_n99_), .d(new_n78_), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n64_), .c(new_n65_), .O(new_n152_));
  nor2   g101(.a(x29), .b(x28), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n119_), .c(new_n126_), .O(new_n154_));
  oai22  g103(.a(new_n154_), .b(new_n94_), .c(new_n152_), .d(new_n150_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g105(.a(x05), .O(new_n157_));
  aoi21  g106(.a(new_n85_), .b(new_n157_), .c(x18), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n156_), .O(z10));
  inv1   g108(.a(x30), .O(new_n160_));
  nand3  g109(.a(new_n153_), .b(new_n128_), .c(new_n126_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n105_), .c(new_n64_), .O(new_n162_));
  ...
  oai21  g114(.a(new_n165_), .b(new_n94_), .c(new_n52_), .O(new_n166_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n133_), .c(new_n138_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n116_), .c(new_n64_), .O(new_n173_));
  aoi21  g122(.a(new_n173_), .b(new_n70_), .c(new_n171_), .O(new_n174_));
  nor2   g123(.a(x31), .b(x30), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n153_), .c(new_n133_), .d(new_n104_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n100_), .c(new_n52_), .O(new_n177_));
  ...
  oai21  g132(.a(new_n183_), .b(new_n116_), .c(new_n64_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n70_), .c(new_n182_), .O(new_n185_));
  nor2   g134(.a(x32), .b(x31), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n164_), .c(new_n143_), .d(new_n128_), .O(new_n187_));
  ...
  aoi21  g139(.a(new_n85_), .b(new_n190_), .c(x18), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n189_), .O(z13));
  inv1   g141(.a(x33), .O(new_n193_));
  nand4  g142(.a(new_n186_), .b(new_n153_), .c(new_n160_), .d(new_n126_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n129_), .c(new_n64_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n70_), .c(new_n193_), .O(new_n196_));
  nand2  g145(.a(new_n153_), .b(new_n133_), .O(new_n197_));
  ...
  aoi21  g151(.a(new_n85_), .b(new_n202_), .c(x18), .O(new_n203_));
  nand2  g152(.a(new_n203_), .b(new_n201_), .O(z14));
  inv1   g153(.a(x34), .O(new_n205_));
  nand4  g154(.a(new_n198_), .b(new_n175_), .c(new_n153_), .d(new_n126_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n129_), .c(new_n64_), .O(new_n207_));
  aoi21  g156(.a(new_n207_), .b(new_n70_), .c(new_n205_), .O(new_n208_));
  ...
  aoi21  g161(.a(new_n85_), .b(new_n212_), .c(x18), .O(new_n213_));
