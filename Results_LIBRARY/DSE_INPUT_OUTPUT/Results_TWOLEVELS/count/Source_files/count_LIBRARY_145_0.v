...
module FAU ( 
  ...
  aoi21  g12(.a(new_n63_), .b(new_n62_), .c(new_n58_), .O(new_n64_));
  nor2   g13(.a(x16), .b(x14), .O(new_n65_));
  oai21  g14(.a(new_n65_), .b(new_n64_), .c(x22), .O(new_n66_));
  nand2  g15(.a(new_n66_), .b(new_n52_), .O(z01));
  nand2  g16(.a(new_n62_), .b(x21), .O(new_n68_));
  inv1   g17(.a(x21), .O(new_n69_));
  nor2   g18(.a(x19), .b(x17), .O(new_n70_));
  nand4  g19(.a(new_n70_), .b(x22), .c(new_n69_), .d(new_n61_), .O(new_n71_));
  ...
  nor2   g24(.a(new_n53_), .b(x18), .O(new_n76_));
  nand3  g25(.a(new_n76_), .b(new_n75_), .c(new_n73_), .O(z02));
  nand4  g26(.a(new_n69_), .b(new_n61_), .c(new_n60_), .d(new_n59_), .O(new_n78_));
  nor2   g27(.a(x16), .b(x12), .O(new_n79_));
  aoi21  g28(.a(new_n78_), .b(x16), .c(new_n79_), .O(new_n80_));
  oai21  g29(.a(new_n80_), .b(new_n53_), .c(new_n52_), .O(z03));
  nand2  g30(.a(x23), .b(x16), .O(new_n82_));
  inv1   g31(.a(x11), .O(new_n83_));
  nand2  g32(.a(new_n58_), .b(new_n83_), .O(new_n84_));
  nand3  g33(.a(new_n84_), .b(new_n82_), .c(new_n76_), .O(z04));
  nor2   g34(.a(x16), .b(x10), .O(new_n86_));
  and2   g35(.a(x24), .b(x16), .O(new_n87_));
  oai21  g36(.a(new_n87_), .b(new_n86_), .c(x22), .O(new_n88_));
  ...
  nand3  g41(.a(new_n92_), .b(new_n90_), .c(new_n76_), .O(z06));
  nor2   g42(.a(x16), .b(x08), .O(new_n94_));
  and2   g43(.a(x26), .b(x16), .O(new_n95_));
  oai21  g44(.a(new_n95_), .b(new_n94_), .c(x22), .O(new_n96_));
  nand2  g45(.a(new_n96_), .b(new_n52_), .O(z07));
  nand2  g46(.a(x27), .b(x16), .O(new_n98_));
  inv1   g47(.a(x07), .O(new_n99_));
  nand2  g48(.a(new_n58_), .b(new_n99_), .O(new_n100_));
  nand3  g49(.a(new_n100_), .b(new_n98_), .c(new_n76_), .O(z08));
  nor2   g50(.a(x16), .b(x06), .O(new_n102_));
  and2   g51(.a(x28), .b(x16), .O(new_n103_));
  oai21  g52(.a(new_n103_), .b(new_n102_), .c(x22), .O(new_n104_));
