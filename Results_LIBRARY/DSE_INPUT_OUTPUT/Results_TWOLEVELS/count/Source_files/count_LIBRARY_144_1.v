...
module FAU ( 
  ...
  oai21  g076(.a(x18), .b(new_n69_), .c(new_n57_), .O(new_n128_));
  nand2  g077(.a(new_n122_), .b(x27), .O(new_n129_));
  ...
  oai22  g098(.a(new_n149_), .b(new_n91_), .c(new_n142_), .d(new_n145_), .O(new_n150_));
  ...
  nand4  g105(.a(new_n156_), .b(new_n140_), .c(new_n121_), .d(new_n100_), .O(new_n157_));
  ...
  nand4  g111(.a(new_n156_), .b(new_n140_), .c(new_n147_), .d(new_n97_), .O(new_n163_));
  ...
  nand3  g117(.a(new_n168_), .b(new_n131_), .c(new_n165_), .O(new_n169_));
  ...
  nand3  g123(.a(new_n166_), .b(new_n148_), .c(new_n131_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n102_), .c(x32), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n156_), .c(new_n140_), .d(new_n147_), .O(new_n178_));
