...
module FAU ( 
  ...
  nand3  g036(.a(new_n87_), .b(new_n86_), .c(new_n57_), .O(new_n88_));
  oai21  g037(.a(new_n85_), .b(new_n59_), .c(new_n88_), .O(z03));
  ...
  aoi21  g047(.a(new_n98_), .b(new_n96_), .c(new_n59_), .O(z04));
  oai21  g048(.a(x18), .b(new_n87_), .c(new_n57_), .O(new_n100_));
  inv1   g049(.a(x24), .O(new_n101_));
  nand2  g050(.a(new_n94_), .b(new_n53_), .O(new_n102_));
  ...
  aoi21  g056(.a(x18), .b(x12), .c(new_n59_), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n107_), .c(new_n100_), .O(z05));
  inv1   g058(.a(x25), .O(new_n110_));
  nand2  g059(.a(new_n104_), .b(new_n82_), .O(new_n111_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n93_), .c(new_n101_), .d(new_n71_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n66_), .c(new_n132_), .O(new_n136_));
  nand3  g085(.a(new_n82_), .b(new_n55_), .c(new_n63_), .O(new_n137_));
  nor2   g086(.a(x27), .b(x26), .O(new_n138_));
  nand3  g087(.a(new_n138_), .b(new_n104_), .c(new_n110_), .O(new_n139_));
  ...
  aoi21  g103(.a(new_n87_), .b(new_n154_), .c(x18), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n153_), .c(new_n59_), .O(z09));
  inv1   g105(.a(x29), .O(new_n157_));
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(new_n104_), .d(new_n82_), .O(new_n158_));
  ...
  nor3   g121(.a(new_n172_), .b(new_n94_), .c(new_n65_), .O(new_n173_));
  ...
  nor2   g143(.a(new_n194_), .b(new_n105_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n192_), .c(x16), .O(new_n196_));
  inv1   g145(.a(x02), .O(new_n197_));
  aoi21  g146(.a(new_n87_), .b(new_n197_), .c(x18), .O(new_n198_));
  ...
  aoi21  g168(.a(new_n87_), .b(new_n219_), .c(x18), .O(new_n220_));
