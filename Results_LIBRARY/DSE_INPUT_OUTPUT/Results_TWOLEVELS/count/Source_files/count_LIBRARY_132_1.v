...
module FAU ( 
  ...
  oai21  g037(.a(x18), .b(new_n60_), .c(new_n52_), .O(new_n89_));
  inv1   g038(.a(x23), .O(new_n90_));
  inv1   g039(.a(new_n83_), .O(new_n91_));
  ...
  aoi21  g045(.a(x18), .b(x06), .c(new_n53_), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n96_), .c(new_n89_), .O(z04));
  inv1   g047(.a(x24), .O(new_n99_));
  nand2  g048(.a(new_n93_), .b(new_n72_), .O(new_n100_));
  ...
  nand4  g060(.a(new_n111_), .b(new_n93_), .c(new_n73_), .d(new_n54_), .O(new_n112_));
  aoi21  g061(.a(new_n112_), .b(new_n110_), .c(x19), .O(new_n113_));
  inv1   g062(.a(x25), .O(new_n114_));
  nor2   g063(.a(new_n95_), .b(new_n114_), .O(new_n115_));
  ...
  nand4  g083(.a(new_n122_), .b(new_n93_), .c(new_n99_), .d(new_n72_), .O(new_n135_));
  ...
  oai21  g094(.a(new_n60_), .b(x11), .c(new_n145_), .O(new_n146_));
  nor2   g095(.a(x27), .b(x24), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(x19), .O(new_n148_));
  nand3  g097(.a(new_n122_), .b(new_n93_), .c(new_n81_), .O(new_n149_));
  ...
  nand4  g101(.a(new_n152_), .b(new_n151_), .c(new_n91_), .d(new_n125_), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n146_), .c(new_n63_), .O(z09));
  inv1   g105(.a(x29), .O(new_n157_));
  nand4  g106(.a(new_n152_), .b(new_n122_), .c(new_n103_), .d(new_n82_), .O(new_n158_));
  ...
  oai22  g111(.a(new_n162_), .b(new_n94_), .c(new_n159_), .d(new_n157_), .O(new_n163_));
  ...
  nand3  g122(.a(new_n173_), .b(new_n152_), .c(new_n160_), .O(new_n174_));
  ...
  nand2  g129(.a(new_n173_), .b(new_n147_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n55_), .O(new_n182_));
  inv1   g131(.a(x28), .O(new_n183_));
  nand4  g132(.a(new_n93_), .b(new_n183_), .c(new_n125_), .d(new_n114_), .O(new_n184_));
  ...
  nand3  g143(.a(new_n111_), .b(new_n82_), .c(new_n90_), .O(new_n195_));
  nand4  g144(.a(new_n187_), .b(new_n152_), .c(new_n157_), .d(new_n125_), .O(new_n196_));
  ...
  nand4  g148(.a(new_n199_), .b(new_n173_), .c(new_n152_), .d(new_n122_), .O(new_n200_));
  ...
  nand4  g155(.a(new_n147_), .b(new_n194_), .c(new_n168_), .d(new_n157_), .O(new_n207_));
  ...
  nand4  g160(.a(new_n111_), .b(new_n93_), .c(new_n73_), .d(new_n57_), .O(new_n212_));
