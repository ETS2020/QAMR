...
module FAU ( 
  ...
  oai21  g014(.a(new_n56_), .b(new_n63_), .c(new_n65_), .O(new_n66_));
  nand2  g015(.a(new_n66_), .b(new_n52_), .O(new_n67_));
  nand2  g016(.a(new_n67_), .b(new_n62_), .O(z01));
  inv1   g017(.a(x21), .O(new_n69_));
  nand4  g018(.a(new_n69_), .b(new_n63_), .c(new_n54_), .d(new_n53_), .O(new_n70_));
  ...
  oai21  g022(.a(new_n73_), .b(x14), .c(new_n62_), .O(z02));
  nand2  g023(.a(new_n70_), .b(x22), .O(new_n75_));
  nor3   g024(.a(x22), .b(x21), .c(x20), .O(new_n76_));
  nand2  g025(.a(new_n76_), .b(new_n56_), .O(new_n77_));
  aoi21  g026(.a(new_n77_), .b(new_n75_), .c(new_n59_), .O(new_n78_));
  nor2   g027(.a(x16), .b(x12), .O(new_n79_));
  oai21  g028(.a(new_n79_), .b(new_n78_), .c(new_n52_), .O(new_n80_));
  nand2  g029(.a(new_n80_), .b(new_n62_), .O(z03));
  nor3   g030(.a(x23), .b(x22), .c(x21), .O(new_n82_));
  aoi22  g031(.a(new_n82_), .b(new_n64_), .c(new_n77_), .d(x23), .O(new_n83_));
  nor2   g032(.a(x16), .b(x11), .O(new_n84_));
  nor3   g033(.a(new_n84_), .b(x18), .c(x14), .O(new_n85_));
  oai21  g034(.a(new_n83_), .b(new_n59_), .c(new_n85_), .O(z04));
  nor2   g035(.a(x20), .b(x19), .O(new_n87_));
  nor2   g036(.a(x23), .b(x22), .O(new_n88_));
  nand4  g037(.a(new_n88_), .b(new_n87_), .c(new_n69_), .d(new_n53_), .O(new_n89_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n88_), .c(new_n99_), .d(new_n56_), .O(new_n101_));
  aoi21  g050(.a(new_n101_), .b(new_n98_), .c(new_n59_), .O(new_n102_));
  ...
  nand4  g056(.a(new_n107_), .b(new_n88_), .c(new_n99_), .d(new_n56_), .O(new_n108_));
  aoi21  g057(.a(new_n108_), .b(new_n106_), .c(new_n59_), .O(new_n109_));
  ...
  nand2  g061(.a(new_n108_), .b(x27), .O(new_n113_));
  nor3   g062(.a(x27), .b(x26), .c(x25), .O(new_n114_));
  nand4  g063(.a(new_n114_), .b(new_n92_), .c(new_n76_), .d(new_n56_), .O(new_n115_));
  aoi21  g064(.a(new_n115_), .b(new_n113_), .c(new_n59_), .O(new_n116_));
  nor2   g065(.a(x16), .b(x07), .O(new_n117_));
  oai21  g066(.a(new_n117_), .b(new_n116_), .c(new_n52_), .O(new_n118_));
  nand2  g067(.a(new_n118_), .b(new_n62_), .O(z08));
  nand2  g068(.a(new_n115_), .b(x28), .O(new_n120_));
  nor3   g069(.a(x25), .b(x24), .c(x23), .O(new_n121_));
  nor3   g070(.a(x28), .b(x27), .c(x26), .O(new_n122_));
  nand4  g071(.a(new_n122_), .b(new_n121_), .c(new_n76_), .d(new_n56_), .O(new_n123_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n107_), .c(new_n82_), .d(new_n64_), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n128_), .c(new_n59_), .O(new_n131_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n135_), .O(new_n139_));
  nor2   g088(.a(new_n139_), .b(new_n89_), .O(new_n140_));
  aoi21  g089(.a(new_n130_), .b(x30), .c(new_n140_), .O(new_n141_));
  nor2   g090(.a(x16), .b(x04), .O(new_n142_));
  nor3   g091(.a(new_n142_), .b(x18), .c(x14), .O(new_n143_));
  oai21  g092(.a(new_n141_), .b(new_n59_), .c(new_n143_), .O(z11));
  oai21  g093(.a(new_n139_), .b(new_n89_), .c(x31), .O(new_n145_));
  nand2  g094(.a(new_n92_), .b(new_n91_), .O(new_n146_));
  ...
  nand4  g100(.a(new_n151_), .b(new_n114_), .c(new_n147_), .d(new_n64_), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n145_), .c(new_n59_), .O(new_n153_));
  nor2   g102(.a(x16), .b(x03), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n153_), .c(new_n52_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n62_), .O(z12));
  nand2  g105(.a(new_n152_), .b(x32), .O(new_n157_));
  nor2   g106(.a(x32), .b(x31), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n138_), .c(new_n137_), .d(new_n136_), .O(new_n159_));
  ...
  nor3   g112(.a(new_n163_), .b(x18), .c(x14), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(new_n162_), .O(z13));
  oai21  g114(.a(new_n159_), .b(new_n93_), .c(x33), .O(new_n166_));
  nor2   g115(.a(x27), .b(x26), .O(new_n167_));
  nor2   g116(.a(x33), .b(x32), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n149_), .c(new_n148_), .d(new_n167_), .O(new_n169_));
  ...
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n52_), .O(z14));
  ...
  nand4  g127(.a(new_n178_), .b(new_n135_), .c(new_n177_), .d(new_n176_), .O(new_n179_));
  nor2   g128(.a(new_n179_), .b(new_n70_), .O(new_n180_));
  nand2  g129(.a(new_n148_), .b(new_n167_), .O(new_n181_));
  ...
  nand3  g139(.a(new_n190_), .b(new_n182_), .c(new_n180_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n175_), .c(new_n59_), .O(new_n192_));
