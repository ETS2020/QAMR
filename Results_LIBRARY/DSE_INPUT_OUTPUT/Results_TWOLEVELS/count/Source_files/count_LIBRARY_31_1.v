...
module FAU ( 
  ...
  nor2   g006(.a(new_n57_), .b(x08), .O(new_n58_));
  ...
  aoi21  g028(.a(x16), .b(x08), .c(new_n57_), .O(new_n80_));
  inv1   g029(.a(x22), .O(new_n81_));
  nor2   g030(.a(x22), .b(x21), .O(new_n82_));
  nand3  g031(.a(new_n82_), .b(new_n64_), .c(new_n52_), .O(new_n83_));
  oai21  g032(.a(new_n81_), .b(new_n72_), .c(new_n83_), .O(new_n84_));
  aoi22  g033(.a(new_n84_), .b(new_n53_), .c(new_n66_), .d(x22), .O(new_n85_));
  inv1   g034(.a(x18), .O(new_n86_));
  nand2  g035(.a(new_n86_), .b(x16), .O(new_n87_));
  aoi22  g036(.a(new_n87_), .b(new_n57_), .c(x18), .d(x08), .O(new_n88_));
  oai21  g037(.a(new_n85_), .b(new_n80_), .c(new_n88_), .O(z03));
  ...
  aoi21  g047(.a(new_n98_), .b(new_n97_), .c(x18), .O(new_n99_));
  aoi21  g048(.a(new_n99_), .b(new_n96_), .c(new_n58_), .O(z04));
  inv1   g049(.a(x24), .O(new_n101_));
  nand2  g050(.a(new_n93_), .b(new_n72_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(new_n53_), .O(new_n103_));
  aoi21  g052(.a(new_n103_), .b(new_n67_), .c(new_n101_), .O(new_n104_));
  nor2   g053(.a(x24), .b(x23), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n82_), .c(new_n67_), .O(new_n106_));
  ...
  aoi21  g069(.a(new_n98_), .b(new_n120_), .c(x18), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n119_), .c(new_n58_), .O(z06));
  aoi21  g071(.a(new_n101_), .b(new_n72_), .c(x19), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n66_), .c(x26), .O(new_n124_));
  nor3   g073(.a(x26), .b(x25), .c(x24), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n93_), .c(new_n73_), .d(new_n55_), .O(new_n126_));
  ...
  oai21  g078(.a(x19), .b(new_n129_), .c(x12), .O(new_n130_));
  nand3  g079(.a(new_n112_), .b(new_n90_), .c(new_n81_), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n130_), .c(x26), .d(x16), .O(new_n132_));
  nand3  g081(.a(new_n98_), .b(new_n57_), .c(new_n129_), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n132_), .c(new_n128_), .O(z07));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x26), .b(x25), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n93_), .c(new_n101_), .d(new_n72_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n53_), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n67_), .c(new_n135_), .O(new_n139_));
  nand3  g088(.a(new_n82_), .b(new_n55_), .c(new_n64_), .O(new_n140_));
  nor2   g089(.a(x27), .b(x26), .O(new_n141_));
  nand3  g090(.a(new_n141_), .b(new_n105_), .c(new_n112_), .O(new_n142_));
  ...
  nand3  g108(.a(new_n159_), .b(new_n157_), .c(new_n60_), .O(z09));
  inv1   g109(.a(x29), .O(new_n161_));
  nand4  g110(.a(new_n154_), .b(new_n136_), .c(new_n105_), .d(new_n82_), .O(new_n162_));
  aoi21  g111(.a(new_n162_), .b(new_n53_), .c(new_n66_), .O(new_n163_));
  nor2   g112(.a(x29), .b(x28), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n125_), .c(new_n135_), .O(new_n165_));
  oai22  g114(.a(new_n165_), .b(new_n94_), .c(new_n163_), .d(new_n161_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(x16), .O(new_n167_));
  inv1   g116(.a(x05), .O(new_n168_));
  aoi21  g117(.a(new_n98_), .b(new_n168_), .c(x18), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n167_), .c(new_n58_), .O(z10));
  inv1   g119(.a(x30), .O(new_n171_));
  nand3  g120(.a(new_n164_), .b(new_n136_), .c(new_n135_), .O(new_n172_));
  ...
  nand3  g124(.a(new_n175_), .b(new_n154_), .c(new_n125_), .O(new_n176_));
  nor2   g125(.a(new_n176_), .b(new_n94_), .O(new_n177_));
  ...
  nand3  g131(.a(new_n116_), .b(new_n82_), .c(new_n90_), .O(new_n183_));
  nand3  g132(.a(new_n175_), .b(new_n141_), .c(new_n148_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n183_), .c(new_n53_), .O(new_n185_));
  aoi21  g134(.a(new_n185_), .b(new_n67_), .c(new_n182_), .O(new_n186_));
  nor2   g135(.a(x31), .b(x30), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n164_), .c(new_n141_), .d(new_n112_), .O(new_n188_));
  ...
  aoi21  g140(.a(new_n98_), .b(new_n191_), .c(x18), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n190_), .c(new_n58_), .O(z12));
  inv1   g142(.a(x32), .O(new_n194_));
  nand4  g143(.a(new_n187_), .b(new_n154_), .c(new_n161_), .d(new_n153_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n183_), .c(new_n53_), .O(new_n196_));
  aoi21  g145(.a(new_n196_), .b(new_n67_), .c(new_n194_), .O(new_n197_));
  nor2   g146(.a(x32), .b(x31), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n175_), .c(new_n154_), .d(new_n136_), .O(new_n199_));
  ...
  aoi21  g151(.a(new_n98_), .b(new_n202_), .c(x18), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n201_), .c(new_n58_), .O(z13));
  inv1   g153(.a(x33), .O(new_n205_));
  nand4  g154(.a(new_n198_), .b(new_n164_), .c(new_n171_), .d(new_n135_), .O(new_n206_));
  ...
  nor2   g163(.a(new_n214_), .b(new_n58_), .O(new_n215_));
  nand3  g164(.a(new_n215_), .b(new_n213_), .c(new_n60_), .O(z14));
  inv1   g165(.a(x34), .O(new_n217_));
  nand4  g166(.a(new_n210_), .b(new_n187_), .c(new_n164_), .d(new_n135_), .O(new_n218_));
  ...
  nor3   g170(.a(new_n221_), .b(new_n209_), .c(new_n117_), .O(new_n222_));
  oai21  g171(.a(new_n222_), .b(new_n220_), .c(x16), .O(new_n223_));
  nor2   g172(.a(x16), .b(x00), .O(new_n224_));
  nor2   g173(.a(new_n224_), .b(new_n58_), .O(new_n225_));
  nand3  g174(.a(new_n225_), .b(new_n223_), .c(new_n60_), .O(z15));
endmodule
