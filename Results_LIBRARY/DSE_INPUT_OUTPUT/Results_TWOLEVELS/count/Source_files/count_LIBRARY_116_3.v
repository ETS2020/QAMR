...
module FAU ( 
  ...
  aoi21  g012(.a(x16), .b(new_n57_), .c(new_n58_), .O(new_n64_));
  ...
  aoi22  g020(.a(new_n71_), .b(new_n58_), .c(x18), .d(new_n57_), .O(new_n72_));
  oai21  g021(.a(new_n69_), .b(new_n64_), .c(new_n72_), .O(z01));
  ...
  aoi21  g037(.a(new_n79_), .b(new_n88_), .c(x18), .O(new_n89_));
  ...
  aoi21  g057(.a(x16), .b(new_n58_), .c(new_n57_), .O(new_n109_));
  inv1   g058(.a(x25), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n99_), .c(new_n91_), .d(new_n82_), .O(new_n111_));
  nor2   g060(.a(new_n111_), .b(new_n75_), .O(new_n112_));
  aoi21  g061(.a(new_n103_), .b(x25), .c(new_n112_), .O(new_n113_));
  aoi22  g062(.a(new_n71_), .b(new_n57_), .c(x18), .d(new_n58_), .O(new_n114_));
  oai21  g063(.a(new_n113_), .b(new_n109_), .c(new_n114_), .O(z06));
  nor2   g064(.a(x21), .b(x20), .O(new_n116_));
  nor2   g065(.a(x23), .b(x22), .O(new_n117_));
  nor2   g066(.a(x25), .b(x24), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n117_), .c(new_n116_), .d(new_n55_), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(x26), .O(new_n120_));
  nor3   g069(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n117_), .c(new_n83_), .O(new_n122_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n102_), .c(new_n84_), .d(new_n55_), .O(new_n130_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n84_), .d(new_n55_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(x16), .O(new_n141_));
  inv1   g090(.a(x06), .O(new_n142_));
  aoi21  g091(.a(new_n79_), .b(new_n142_), .c(x18), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n141_), .c(new_n60_), .O(z09));
  and2   g093(.a(new_n139_), .b(x29), .O(new_n145_));
  nand4  g094(.a(new_n117_), .b(new_n100_), .c(new_n74_), .d(new_n52_), .O(new_n146_));
  inv1   g095(.a(x27), .O(new_n147_));
  nor2   g096(.a(x26), .b(x25), .O(new_n148_));
  nor2   g097(.a(x29), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n147_), .d(new_n99_), .O(new_n150_));
  ...
  oai21  g104(.a(new_n150_), .b(new_n146_), .c(x30), .O(new_n156_));
  nor2   g105(.a(x28), .b(x27), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n157_), .c(new_n121_), .d(new_n94_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g110(.a(x04), .O(new_n162_));
  aoi21  g111(.a(new_n79_), .b(new_n162_), .c(x18), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n161_), .c(new_n60_), .O(z11));
  nand4  g113(.a(new_n158_), .b(new_n157_), .c(new_n148_), .d(new_n99_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n146_), .c(x31), .O(new_n166_));
  nand2  g115(.a(new_n102_), .b(new_n101_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nor2   g117(.a(x31), .b(x30), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n149_), .O(new_n170_));
  inv1   g119(.a(new_n170_), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n129_), .c(new_n168_), .d(new_n68_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n166_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(x16), .O(new_n174_));
  inv1   g123(.a(x03), .O(new_n175_));
  aoi21  g124(.a(new_n79_), .b(new_n175_), .c(x18), .O(new_n176_));
  aoi21  g125(.a(new_n176_), .b(new_n174_), .c(new_n60_), .O(z12));
  nand3  g126(.a(new_n169_), .b(new_n149_), .c(new_n129_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n103_), .c(x32), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n158_), .c(new_n157_), .d(new_n148_), .O(new_n181_));
  ...
  nand4  g139(.a(new_n190_), .b(new_n169_), .c(new_n149_), .d(new_n189_), .O(new_n191_));
  ...
  aoi21  g145(.a(new_n79_), .b(new_n196_), .c(x18), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n195_), .c(new_n60_), .O(z14));
  oai21  g147(.a(new_n191_), .b(new_n119_), .c(x34), .O(new_n199_));
  nand2  g148(.a(new_n149_), .b(new_n189_), .O(new_n200_));
