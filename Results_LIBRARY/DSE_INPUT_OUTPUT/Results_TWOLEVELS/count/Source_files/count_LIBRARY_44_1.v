...
module FAU ( 
  ...
  nand2  g006(.a(x12), .b(new_n57_), .O(new_n58_));
  ...
  aoi21  g029(.a(x16), .b(x06), .c(new_n80_), .O(new_n81_));
  nor3   g030(.a(x22), .b(x21), .c(x20), .O(new_n82_));
  aoi22  g031(.a(new_n82_), .b(new_n55_), .c(new_n74_), .d(x22), .O(new_n83_));
  inv1   g032(.a(x18), .O(new_n84_));
  nand2  g033(.a(new_n84_), .b(x16), .O(new_n85_));
  aoi22  g034(.a(new_n85_), .b(new_n80_), .c(x18), .d(x06), .O(new_n86_));
  oai21  g035(.a(new_n83_), .b(new_n81_), .c(new_n86_), .O(z03));
  ...
  nand3  g050(.a(new_n101_), .b(new_n100_), .c(new_n73_), .O(new_n102_));
  nor2   g051(.a(new_n102_), .b(new_n66_), .O(new_n103_));
  nor2   g052(.a(x24), .b(x23), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n88_), .c(new_n91_), .d(new_n52_), .O(new_n105_));
  oai21  g054(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n92_), .c(new_n113_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n92_), .c(new_n99_), .O(new_n123_));
  oai21  g072(.a(new_n123_), .b(new_n74_), .c(new_n121_), .O(new_n124_));
  ...
  nand3  g079(.a(new_n130_), .b(new_n104_), .c(new_n111_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n89_), .c(new_n129_), .O(new_n132_));
  ...
  oai21  g085(.a(new_n131_), .b(new_n89_), .c(x28), .O(new_n137_));
  nor3   g086(.a(x25), .b(x24), .c(x23), .O(new_n138_));
  nor3   g087(.a(x28), .b(x27), .c(x26), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n138_), .c(new_n82_), .d(new_n55_), .O(new_n140_));
  aoi21  g089(.a(new_n140_), .b(new_n137_), .c(new_n70_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(x18), .c(new_n58_), .O(new_n142_));
  nand3  g091(.a(new_n70_), .b(new_n80_), .c(new_n57_), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n142_), .O(z09));
  nand2  g093(.a(new_n140_), .b(x29), .O(new_n145_));
  inv1   g094(.a(x27), .O(new_n146_));
  nor3   g095(.a(x26), .b(x25), .c(x24), .O(new_n147_));
  nor2   g096(.a(x29), .b(x28), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n103_), .d(new_n146_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n145_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g100(.a(x05), .O(new_n152_));
  aoi21  g101(.a(new_n70_), .b(new_n152_), .c(x18), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n151_), .c(new_n60_), .O(z10));
  nand4  g103(.a(new_n148_), .b(new_n122_), .c(new_n146_), .d(new_n99_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n93_), .c(x30), .O(new_n156_));
  nor2   g105(.a(x28), .b(x27), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n157_), .c(new_n147_), .d(new_n103_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(x16), .O(new_n161_));
  inv1   g110(.a(x04), .O(new_n162_));
  aoi21  g111(.a(new_n70_), .b(new_n162_), .c(x18), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n161_), .c(new_n60_), .O(z11));
  nand3  g113(.a(new_n158_), .b(new_n157_), .c(new_n147_), .O(new_n165_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n148_), .c(new_n167_), .d(new_n112_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(x16), .O(new_n171_));
  nor2   g120(.a(x16), .b(x03), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n60_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n59_), .O(z12));
  nand3  g123(.a(new_n168_), .b(new_n148_), .c(new_n167_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n105_), .c(x32), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n158_), .c(new_n157_), .d(new_n122_), .O(new_n178_));
  or2    g127(.a(new_n178_), .b(new_n105_), .O(new_n179_));
  ...
  nand3  g132(.a(new_n183_), .b(new_n181_), .c(new_n59_), .O(z13));
  oai21  g133(.a(new_n178_), .b(new_n105_), .c(x33), .O(new_n185_));
  nand4  g134(.a(new_n111_), .b(new_n99_), .c(new_n101_), .d(new_n100_), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n74_), .O(new_n187_));
  nor2   g136(.a(x33), .b(x32), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n168_), .c(new_n148_), .d(new_n130_), .O(new_n189_));
  ...
  aoi21  g144(.a(new_n195_), .b(new_n193_), .c(new_n60_), .O(z14));
  oai21  g145(.a(new_n189_), .b(new_n115_), .c(x34), .O(new_n197_));
  nand2  g146(.a(new_n148_), .b(new_n130_), .O(new_n198_));
  ...
  aoi21  g160(.a(new_n70_), .b(new_n211_), .c(x18), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n210_), .c(new_n60_), .O(z15));
endmodule
