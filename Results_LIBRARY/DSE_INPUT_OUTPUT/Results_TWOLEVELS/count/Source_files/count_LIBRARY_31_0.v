...
module FAU ( 
  ...
  oai22  g032(.a(new_n83_), .b(x19), .c(new_n66_), .d(new_n79_), .O(new_n84_));
  aoi21  g033(.a(new_n84_), .b(x16), .c(x18), .O(new_n85_));
  inv1   g034(.a(x12), .O(new_n86_));
  inv1   g035(.a(x16), .O(new_n87_));
  nand3  g036(.a(new_n87_), .b(new_n86_), .c(x08), .O(new_n88_));
  oai21  g037(.a(new_n85_), .b(new_n57_), .c(new_n88_), .O(z03));
  ...
  aoi21  g046(.a(new_n87_), .b(new_n97_), .c(x18), .O(new_n98_));
  aoi21  g047(.a(new_n98_), .b(new_n96_), .c(new_n57_), .O(z04));
  inv1   g048(.a(x24), .O(new_n100_));
  nand2  g049(.a(new_n93_), .b(new_n71_), .O(new_n101_));
  ...
  nand3  g053(.a(new_n104_), .b(new_n82_), .c(new_n66_), .O(new_n105_));
  ...
  nand3  g058(.a(new_n109_), .b(new_n107_), .c(new_n62_), .O(z05));
  ...
  aoi21  g068(.a(new_n87_), .b(new_n119_), .c(x18), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n57_), .O(z06));
  aoi21  g070(.a(new_n100_), .b(new_n71_), .c(x19), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n65_), .c(x26), .O(new_n123_));
  nor3   g072(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand4  g073(.a(new_n124_), .b(new_n93_), .c(new_n72_), .d(new_n55_), .O(new_n125_));
  aoi21  g074(.a(new_n125_), .b(new_n123_), .c(new_n87_), .O(new_n126_));
  oai21  g075(.a(new_n126_), .b(x18), .c(new_n61_), .O(new_n127_));
  inv1   g076(.a(x08), .O(new_n128_));
  oai21  g077(.a(x19), .b(new_n128_), .c(new_n86_), .O(new_n129_));
  nand3  g078(.a(new_n111_), .b(new_n90_), .c(new_n79_), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n129_), .c(x26), .d(x16), .O(new_n131_));
  nand3  g080(.a(new_n87_), .b(x12), .c(new_n128_), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n131_), .c(new_n127_), .O(z07));
  inv1   g082(.a(x27), .O(new_n134_));
  nor2   g083(.a(x26), .b(x25), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n93_), .c(new_n100_), .d(new_n71_), .O(new_n136_));
  nand2  g085(.a(new_n136_), .b(new_n53_), .O(new_n137_));
  aoi21  g086(.a(new_n137_), .b(new_n66_), .c(new_n134_), .O(new_n138_));
  nand3  g087(.a(new_n82_), .b(new_n55_), .c(new_n63_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n135_), .c(new_n104_), .d(new_n82_), .O(new_n161_));
  aoi21  g110(.a(new_n161_), .b(new_n53_), .c(new_n65_), .O(new_n162_));
  nor2   g111(.a(x29), .b(x28), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n124_), .c(new_n134_), .O(new_n164_));
  oai22  g113(.a(new_n164_), .b(new_n94_), .c(new_n162_), .d(new_n160_), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g115(.a(x05), .O(new_n167_));
  aoi21  g116(.a(new_n87_), .b(new_n167_), .c(x18), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n166_), .c(new_n57_), .O(z10));
  inv1   g118(.a(x30), .O(new_n170_));
  nand3  g119(.a(new_n163_), .b(new_n135_), .c(new_n134_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n112_), .c(new_n53_), .O(new_n172_));
  aoi21  g121(.a(new_n172_), .b(new_n66_), .c(new_n170_), .O(new_n173_));
  nor2   g122(.a(x30), .b(x29), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n153_), .c(new_n124_), .O(new_n175_));
  ...
  nor2   g127(.a(new_n178_), .b(new_n57_), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n177_), .c(new_n62_), .O(z11));
  inv1   g129(.a(x31), .O(new_n181_));
  nand3  g130(.a(new_n115_), .b(new_n82_), .c(new_n90_), .O(new_n182_));
  nand3  g131(.a(new_n174_), .b(new_n140_), .c(new_n147_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n182_), .c(new_n53_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n66_), .c(new_n181_), .O(new_n185_));
  nor2   g134(.a(x31), .b(x30), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n163_), .c(new_n140_), .d(new_n111_), .O(new_n187_));
  ...
  aoi21  g139(.a(new_n87_), .b(new_n190_), .c(x18), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n189_), .c(new_n57_), .O(z12));
  inv1   g141(.a(x32), .O(new_n193_));
  nand4  g142(.a(new_n186_), .b(new_n153_), .c(new_n160_), .d(new_n152_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n182_), .c(new_n53_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n66_), .c(new_n193_), .O(new_n196_));
  nor2   g145(.a(x32), .b(x31), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n174_), .c(new_n153_), .d(new_n135_), .O(new_n198_));
  ...
  aoi21  g150(.a(new_n87_), .b(new_n201_), .c(x18), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n200_), .c(new_n57_), .O(z13));
  inv1   g152(.a(x33), .O(new_n204_));
  nand4  g153(.a(new_n197_), .b(new_n163_), .c(new_n170_), .d(new_n134_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n136_), .c(new_n53_), .O(new_n206_));
  aoi21  g155(.a(new_n206_), .b(new_n66_), .c(new_n204_), .O(new_n207_));
  nand2  g156(.a(new_n163_), .b(new_n140_), .O(new_n208_));
  nor2   g157(.a(x33), .b(x32), .O(new_n209_));
  nand2  g158(.a(new_n209_), .b(new_n186_), .O(new_n210_));
  nor3   g159(.a(new_n210_), .b(new_n208_), .c(new_n116_), .O(new_n211_));
  ...
  nand4  g165(.a(new_n209_), .b(new_n186_), .c(new_n163_), .d(new_n134_), .O(new_n217_));
  oai21  g166(.a(new_n217_), .b(new_n136_), .c(new_n53_), .O(new_n218_));
  ...
  nor3   g169(.a(new_n220_), .b(new_n208_), .c(new_n116_), .O(new_n221_));
  oai21  g170(.a(new_n221_), .b(new_n219_), .c(x16), .O(new_n222_));
  nor2   g171(.a(x16), .b(x00), .O(new_n223_));
  nor2   g172(.a(new_n223_), .b(new_n57_), .O(new_n224_));
