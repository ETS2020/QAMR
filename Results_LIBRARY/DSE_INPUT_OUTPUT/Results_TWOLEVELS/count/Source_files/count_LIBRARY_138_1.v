...
module FAU ( 
  ...
  aoi21  g027(.a(x16), .b(x10), .c(new_n57_), .O(new_n79_));
  ...
  aoi22  g032(.a(new_n83_), .b(new_n53_), .c(new_n65_), .d(x22), .O(new_n84_));
  inv1   g033(.a(x18), .O(new_n85_));
  nand2  g034(.a(new_n85_), .b(x16), .O(new_n86_));
  aoi22  g035(.a(new_n86_), .b(new_n57_), .c(x18), .d(x10), .O(new_n87_));
  oai21  g036(.a(new_n84_), .b(new_n79_), .c(new_n87_), .O(z03));
  ...
  aoi21  g046(.a(new_n97_), .b(new_n96_), .c(x18), .O(new_n98_));
  aoi21  g047(.a(new_n98_), .b(new_n95_), .c(new_n59_), .O(z04));
  inv1   g048(.a(x10), .O(new_n100_));
  oai21  g049(.a(new_n97_), .b(x12), .c(new_n100_), .O(new_n101_));
  inv1   g050(.a(x24), .O(new_n102_));
  nand2  g051(.a(new_n93_), .b(new_n53_), .O(new_n103_));
  aoi21  g052(.a(new_n103_), .b(new_n66_), .c(new_n102_), .O(new_n104_));
  ...
  nand3  g057(.a(new_n108_), .b(new_n101_), .c(new_n58_), .O(z05));
  inv1   g058(.a(x25), .O(new_n110_));
  nand2  g059(.a(new_n105_), .b(new_n81_), .O(new_n111_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n92_), .c(new_n72_), .d(new_n55_), .O(new_n115_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n92_), .c(new_n102_), .d(new_n71_), .O(new_n134_));
  ...
  nand3  g087(.a(new_n138_), .b(new_n105_), .c(new_n110_), .O(new_n139_));
  ...
  oai21  g095(.a(new_n146_), .b(new_n93_), .c(new_n53_), .O(new_n147_));
  ...
  aoi21  g103(.a(new_n97_), .b(new_n154_), .c(x18), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n153_), .c(new_n59_), .O(z09));
  inv1   g105(.a(x29), .O(new_n157_));
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(new_n105_), .d(new_n81_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n53_), .c(new_n65_), .O(new_n159_));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n125_), .c(new_n94_), .d(new_n132_), .O(new_n161_));
  ...
  nor2   g113(.a(new_n164_), .b(new_n59_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n163_), .c(new_n58_), .O(z10));
  ...
  nor3   g121(.a(new_n172_), .b(new_n93_), .c(new_n65_), .O(new_n173_));
  ...
  nor2   g132(.a(new_n183_), .b(new_n106_), .O(new_n184_));
  ...
  aoi21  g146(.a(new_n97_), .b(new_n197_), .c(x18), .O(new_n198_));
  ...
  aoi21  g168(.a(new_n97_), .b(new_n219_), .c(x18), .O(new_n220_));
