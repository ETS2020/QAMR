...
module FAU ( 
  ...
  nand3  g008(.a(new_n59_), .b(new_n56_), .c(x01), .O(z00));
  ...
  oai21  g015(.a(new_n66_), .b(new_n65_), .c(x01), .O(new_n67_));
  ...
  nand4  g036(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n52_), .O(new_n88_));
  aoi21  g037(.a(new_n88_), .b(new_n84_), .c(new_n58_), .O(new_n89_));
  nor2   g038(.a(x16), .b(x11), .O(new_n90_));
  oai21  g039(.a(new_n90_), .b(new_n89_), .c(x01), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(new_n61_), .O(z04));
  nand2  g041(.a(new_n88_), .b(x24), .O(new_n93_));
  nor2   g042(.a(x24), .b(x23), .O(new_n94_));
  nand4  g043(.a(new_n94_), .b(new_n82_), .c(new_n86_), .d(new_n52_), .O(new_n95_));
  aoi21  g044(.a(new_n95_), .b(new_n93_), .c(new_n58_), .O(new_n96_));
  nor2   g045(.a(x16), .b(x10), .O(new_n97_));
  oai21  g046(.a(new_n97_), .b(new_n96_), .c(x01), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n61_), .O(z05));
  nand2  g048(.a(new_n95_), .b(x25), .O(new_n100_));
  nor2   g049(.a(x25), .b(x24), .O(new_n101_));
  nand4  g050(.a(new_n101_), .b(new_n87_), .c(new_n69_), .d(new_n55_), .O(new_n102_));
  ...
  nand3  g055(.a(new_n106_), .b(new_n104_), .c(x01), .O(z06));
  ...
  nand2  g062(.a(new_n113_), .b(new_n61_), .O(z07));
  ...
  nand4  g068(.a(new_n119_), .b(new_n94_), .c(new_n77_), .d(new_n55_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n58_), .O(new_n121_));
  nor2   g070(.a(x16), .b(x07), .O(new_n122_));
  oai21  g071(.a(new_n122_), .b(new_n121_), .c(x01), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n61_), .O(z08));
  ...
  oai21  g082(.a(new_n133_), .b(new_n132_), .c(x01), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n61_), .O(z09));
  ...
  nor3   g090(.a(new_n141_), .b(x18), .c(new_n73_), .O(new_n142_));
  ...
  nand2  g105(.a(new_n156_), .b(new_n61_), .O(z11));
  ...
  oai21  g120(.a(new_n171_), .b(new_n170_), .c(x01), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(new_n61_), .O(z12));
  ...
  oai21  g134(.a(new_n185_), .b(new_n184_), .c(x01), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n61_), .O(z13));
  ...
  nand3  g141(.a(new_n192_), .b(x16), .c(x01), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n61_), .O(z14));
  ...
  nand3  g152(.a(new_n203_), .b(new_n201_), .c(x01), .O(z15));
endmodule
