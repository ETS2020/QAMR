...
module FAU ( 
  ...
  aoi21  g013(.a(new_n54_), .b(x20), .c(new_n64_), .O(new_n65_));
  inv1   g014(.a(x14), .O(new_n66_));
  aoi21  g015(.a(new_n60_), .b(new_n66_), .c(x18), .O(new_n67_));
  oai21  g016(.a(new_n65_), .b(new_n60_), .c(new_n67_), .O(z01));
  inv1   g017(.a(x19), .O(new_n69_));
  inv1   g018(.a(x18), .O(new_n70_));
  nand2  g019(.a(x20), .b(new_n70_), .O(new_n71_));
  nand3  g020(.a(new_n71_), .b(new_n69_), .c(new_n61_), .O(new_n72_));
  inv1   g021(.a(x20), .O(new_n73_));
  inv1   g022(.a(x21), .O(new_n74_));
  nand3  g023(.a(new_n53_), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  inv1   g024(.a(new_n75_), .O(new_n76_));
  aoi21  g025(.a(new_n72_), .b(x21), .c(new_n76_), .O(new_n77_));
  inv1   g026(.a(x13), .O(new_n78_));
  aoi21  g027(.a(new_n60_), .b(new_n78_), .c(x18), .O(new_n79_));
  oai21  g028(.a(new_n77_), .b(new_n60_), .c(new_n79_), .O(z02));
  ...
  oai22  g034(.a(new_n85_), .b(x19), .c(new_n64_), .d(new_n81_), .O(new_n86_));
  nor2   g035(.a(x16), .b(x12), .O(new_n87_));
  aoi21  g036(.a(new_n86_), .b(x16), .c(new_n87_), .O(new_n88_));
  oai21  g037(.a(new_n88_), .b(x18), .c(new_n58_), .O(z03));
  inv1   g038(.a(x23), .O(new_n90_));
  oai21  g039(.a(new_n84_), .b(x19), .c(new_n73_), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(new_n70_), .O(new_n92_));
  aoi21  g041(.a(new_n92_), .b(new_n53_), .c(new_n90_), .O(new_n93_));
  ...
  aoi21  g050(.a(new_n95_), .b(new_n69_), .c(new_n63_), .O(new_n102_));
  ...
  oai21  g058(.a(new_n109_), .b(x18), .c(new_n58_), .O(z05));
  aoi21  g059(.a(new_n104_), .b(new_n69_), .c(x20), .O(new_n111_));
  oai21  g060(.a(new_n111_), .b(x18), .c(new_n53_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x25), .O(new_n113_));
  nor2   g062(.a(x25), .b(x24), .O(new_n114_));
  nand3  g063(.a(new_n114_), .b(new_n94_), .c(new_n76_), .O(new_n115_));
  and2   g064(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  inv1   g065(.a(x09), .O(new_n117_));
  aoi21  g066(.a(new_n60_), .b(new_n117_), .c(x18), .O(new_n118_));
  oai21  g067(.a(new_n116_), .b(new_n60_), .c(new_n118_), .O(z06));
  inv1   g068(.a(x26), .O(new_n120_));
  nor3   g069(.a(x25), .b(x24), .c(x23), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n84_), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n69_), .c(new_n63_), .O(new_n123_));
  nor3   g072(.a(x26), .b(x25), .c(x24), .O(new_n124_));
  nand3  g073(.a(new_n124_), .b(new_n94_), .c(new_n76_), .O(new_n125_));
  ...
  oai21  g077(.a(new_n128_), .b(x18), .c(new_n58_), .O(z07));
  inv1   g078(.a(x27), .O(new_n130_));
  nor3   g079(.a(x23), .b(x22), .c(x21), .O(new_n131_));
  nand2  g080(.a(new_n124_), .b(new_n131_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n69_), .c(new_n63_), .O(new_n133_));
  nand3  g082(.a(new_n84_), .b(new_n53_), .c(new_n73_), .O(new_n134_));
  ...
  nand3  g090(.a(new_n141_), .b(new_n114_), .c(new_n131_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n69_), .c(x20), .O(new_n143_));
  oai21  g092(.a(new_n143_), .b(x18), .c(new_n53_), .O(new_n144_));
  nor3   g093(.a(x28), .b(x27), .c(x26), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n121_), .O(new_n146_));
  ...
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n103_), .d(new_n84_), .O(new_n155_));
  aoi21  g104(.a(new_n155_), .b(new_n69_), .c(new_n63_), .O(new_n156_));
  nor3   g105(.a(x29), .b(x28), .c(x27), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n124_), .c(new_n96_), .O(new_n158_));
  ...
  nand4  g112(.a(new_n157_), .b(new_n153_), .c(new_n103_), .d(new_n84_), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n69_), .c(new_n63_), .O(new_n165_));
  nor2   g114(.a(x30), .b(x29), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n154_), .c(new_n124_), .d(new_n96_), .O(new_n167_));
  ...
  oai21  g119(.a(new_n170_), .b(x18), .c(new_n58_), .O(z11));
  nor3   g120(.a(x30), .b(x29), .c(x28), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n141_), .c(new_n121_), .d(new_n84_), .O(new_n173_));
  aoi21  g122(.a(new_n173_), .b(new_n69_), .c(x20), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(x18), .c(new_n53_), .O(new_n175_));
  nor2   g124(.a(x29), .b(x28), .O(new_n176_));
  nor2   g125(.a(x31), .b(x30), .O(new_n177_));
  nand3  g126(.a(new_n177_), .b(new_n176_), .c(new_n135_), .O(new_n178_));
  nor2   g127(.a(new_n178_), .b(new_n106_), .O(new_n179_));
  aoi21  g128(.a(new_n175_), .b(x31), .c(new_n179_), .O(new_n180_));
  inv1   g129(.a(x03), .O(new_n181_));
  aoi21  g130(.a(new_n60_), .b(new_n181_), .c(x18), .O(new_n182_));
  oai21  g131(.a(new_n180_), .b(new_n60_), .c(new_n182_), .O(z12));
  inv1   g132(.a(x32), .O(new_n184_));
  nor3   g133(.a(x31), .b(x30), .c(x29), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n145_), .c(new_n121_), .d(new_n84_), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n69_), .c(new_n63_), .O(new_n187_));
  nand2  g136(.a(new_n154_), .b(new_n153_), .O(new_n188_));
  inv1   g137(.a(new_n188_), .O(new_n189_));
  nor2   g138(.a(x32), .b(x31), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n166_), .c(new_n189_), .d(new_n105_), .O(new_n191_));
  ...
  oai21  g143(.a(new_n194_), .b(x18), .c(new_n58_), .O(z13));
  nor3   g144(.a(x32), .b(x31), .c(x30), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n157_), .c(new_n124_), .d(new_n131_), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n69_), .c(x20), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(x18), .c(new_n53_), .O(new_n199_));
  nand2  g148(.a(new_n176_), .b(new_n141_), .O(new_n200_));
  inv1   g149(.a(x33), .O(new_n201_));
  nand3  g150(.a(new_n177_), .b(new_n201_), .c(new_n184_), .O(new_n202_));
  nor3   g151(.a(new_n202_), .b(new_n200_), .c(new_n115_), .O(new_n203_));
  ...
  oai21  g155(.a(new_n204_), .b(new_n60_), .c(new_n206_), .O(z14));
  nor2   g156(.a(x17), .b(new_n60_), .O(new_n208_));
  nand4  g157(.a(new_n208_), .b(new_n121_), .c(new_n84_), .d(new_n62_), .O(new_n209_));
  nor3   g158(.a(x34), .b(x33), .c(x32), .O(new_n210_));
  nand4  g159(.a(new_n210_), .b(new_n177_), .c(new_n176_), .d(new_n141_), .O(new_n211_));
  oai22  g160(.a(new_n211_), .b(new_n209_), .c(x16), .d(x00), .O(new_n212_));
  nand2  g161(.a(new_n212_), .b(new_n70_), .O(new_n213_));
  inv1   g162(.a(new_n202_), .O(new_n214_));
  nand2  g163(.a(new_n214_), .b(new_n157_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n132_), .c(new_n69_), .O(new_n216_));
  aoi21  g165(.a(new_n216_), .b(new_n64_), .c(new_n60_), .O(new_n217_));
  oai21  g166(.a(new_n217_), .b(x18), .c(x34), .O(new_n218_));
  nand2  g167(.a(new_n218_), .b(new_n213_), .O(z15));
endmodule
