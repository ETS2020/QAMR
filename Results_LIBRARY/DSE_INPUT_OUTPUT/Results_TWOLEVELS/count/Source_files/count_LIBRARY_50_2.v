...
module FAU ( 
  ...
  oai21  g002(.a(new_n53_), .b(x08), .c(new_n52_), .O(new_n54_));
  ...
  aoi21  g044(.a(new_n95_), .b(new_n93_), .c(new_n63_), .O(z04));
  ...
  nand4  g050(.a(new_n101_), .b(new_n81_), .c(new_n89_), .d(new_n55_), .O(new_n102_));
  ...
  oai21  g061(.a(new_n109_), .b(new_n108_), .c(new_n112_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(x16), .O(new_n114_));
  nor2   g063(.a(x16), .b(x09), .O(new_n115_));
  nor2   g064(.a(new_n115_), .b(new_n63_), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n114_), .c(new_n61_), .O(z06));
  aoi21  g066(.a(x16), .b(x15), .c(new_n60_), .O(new_n118_));
  nor2   g067(.a(x26), .b(x25), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n90_), .c(new_n97_), .O(new_n120_));
  nor2   g069(.a(new_n120_), .b(new_n73_), .O(new_n121_));
  aoi21  g070(.a(new_n112_), .b(x26), .c(new_n121_), .O(new_n122_));
  inv1   g071(.a(x18), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(x16), .O(new_n124_));
  aoi22  g073(.a(new_n124_), .b(new_n60_), .c(x18), .d(x15), .O(new_n125_));
  oai21  g074(.a(new_n122_), .b(new_n118_), .c(new_n125_), .O(z07));
  inv1   g075(.a(x27), .O(new_n127_));
  nor3   g076(.a(x22), .b(x21), .c(x20), .O(new_n128_));
  nor3   g077(.a(x27), .b(x26), .c(x25), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n101_), .c(new_n128_), .d(new_n58_), .O(new_n130_));
  oai21  g079(.a(new_n121_), .b(new_n127_), .c(new_n130_), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(x16), .O(new_n132_));
  inv1   g081(.a(x07), .O(new_n133_));
  aoi21  g082(.a(new_n53_), .b(new_n133_), .c(x18), .O(new_n134_));
  aoi21  g083(.a(new_n134_), .b(new_n132_), .c(new_n63_), .O(z08));
  and2   g084(.a(new_n130_), .b(x28), .O(new_n136_));
  inv1   g085(.a(x26), .O(new_n137_));
  nor2   g086(.a(x28), .b(x27), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n111_), .c(new_n137_), .d(new_n98_), .O(new_n139_));
  ...
  nor2   g091(.a(new_n142_), .b(new_n63_), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n141_), .c(new_n61_), .O(z09));
  ...
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n100_), .d(new_n127_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g099(.a(x05), .O(new_n151_));
  aoi21  g100(.a(new_n53_), .b(new_n151_), .c(x18), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n150_), .c(new_n63_), .O(z10));
  nand4  g102(.a(new_n147_), .b(new_n119_), .c(new_n127_), .d(new_n97_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n91_), .c(x30), .O(new_n155_));
  nor2   g104(.a(x30), .b(x29), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n138_), .c(new_n146_), .d(new_n100_), .O(new_n157_));
  ...
  aoi21  g110(.a(new_n161_), .b(new_n159_), .c(new_n63_), .O(z11));
  nand3  g111(.a(new_n156_), .b(new_n138_), .c(new_n146_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n91_), .c(x31), .O(new_n164_));
  nor2   g113(.a(x27), .b(x26), .O(new_n165_));
  nor2   g114(.a(x31), .b(x30), .O(new_n166_));
  nand4  g115(.a(new_n166_), .b(new_n147_), .c(new_n165_), .d(new_n108_), .O(new_n167_));
  or2    g116(.a(new_n167_), .b(new_n102_), .O(new_n168_));
  ...
  nand3  g121(.a(new_n172_), .b(new_n170_), .c(new_n61_), .O(z12));
  oai21  g122(.a(new_n167_), .b(new_n102_), .c(x32), .O(new_n174_));
  nor2   g123(.a(x32), .b(x31), .O(new_n175_));
  nand4  g124(.a(new_n175_), .b(new_n156_), .c(new_n138_), .d(new_n119_), .O(new_n176_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n102_), .c(x33), .O(new_n184_));
  nand4  g133(.a(new_n108_), .b(new_n97_), .c(new_n98_), .d(new_n79_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n73_), .O(new_n186_));
  nor2   g135(.a(x33), .b(x32), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n166_), .c(new_n147_), .d(new_n165_), .O(new_n188_));
  ...
  aoi21  g143(.a(new_n194_), .b(new_n192_), .c(new_n63_), .O(z14));
  oai21  g144(.a(new_n188_), .b(new_n112_), .c(x34), .O(new_n196_));
  nand2  g145(.a(new_n147_), .b(new_n165_), .O(new_n197_));
