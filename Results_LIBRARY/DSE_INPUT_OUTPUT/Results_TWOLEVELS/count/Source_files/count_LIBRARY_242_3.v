...
module FAU ( 
  ...
  oai21  g005(.a(new_n56_), .b(x07), .c(x15), .O(new_n57_));
  ...
  nand4  g031(.a(new_n55_), .b(new_n81_), .c(new_n73_), .d(new_n65_), .O(new_n83_));
  oai21  g032(.a(new_n82_), .b(new_n81_), .c(new_n83_), .O(new_n84_));
  ...
  nand2  g046(.a(new_n90_), .b(new_n73_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n53_), .O(new_n99_));
  aoi21  g048(.a(new_n99_), .b(new_n67_), .c(new_n97_), .O(new_n100_));
  nand3  g049(.a(new_n65_), .b(new_n53_), .c(new_n52_), .O(new_n101_));
  inv1   g050(.a(x23), .O(new_n102_));
  nand4  g051(.a(new_n97_), .b(new_n102_), .c(new_n81_), .d(new_n73_), .O(new_n103_));
  ...
  aoi21  g059(.a(new_n110_), .b(new_n67_), .c(new_n109_), .O(new_n111_));
  ...
  oai21  g076(.a(x18), .b(new_n56_), .c(new_n61_), .O(new_n128_));
  inv1   g077(.a(x27), .O(new_n129_));
  nor3   g078(.a(x27), .b(x26), .c(x25), .O(new_n130_));
  nand3  g079(.a(new_n130_), .b(new_n97_), .c(new_n102_), .O(new_n131_));
  oai22  g080(.a(new_n131_), .b(new_n83_), .c(new_n123_), .d(new_n129_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(x16), .O(new_n133_));
  aoi21  g082(.a(x18), .b(new_n59_), .c(new_n64_), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n128_), .O(z08));
  inv1   g084(.a(x28), .O(new_n136_));
  nor2   g085(.a(x27), .b(x26), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n112_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n98_), .c(new_n53_), .O(new_n139_));
  aoi21  g088(.a(new_n139_), .b(new_n67_), .c(new_n136_), .O(new_n140_));
  nor2   g089(.a(x28), .b(x27), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n112_), .c(new_n119_), .d(new_n102_), .O(new_n142_));
  ...
  aoi21  g095(.a(new_n146_), .b(new_n144_), .c(new_n64_), .O(z09));
  inv1   g096(.a(x29), .O(new_n148_));
  nor2   g097(.a(new_n98_), .b(new_n101_), .O(new_n149_));
  nor3   g098(.a(x29), .b(x28), .c(x27), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n121_), .c(new_n149_), .O(new_n151_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n153_), .c(new_n72_), .O(z10));
  nand2  g105(.a(new_n151_), .b(x30), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand3  g107(.a(new_n158_), .b(new_n141_), .c(new_n121_), .O(new_n159_));
  or2    g108(.a(new_n159_), .b(new_n91_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n157_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(x16), .O(new_n162_));
  nor2   g111(.a(x16), .b(x04), .O(new_n163_));
  nor2   g112(.a(new_n163_), .b(new_n64_), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n162_), .c(new_n72_), .O(z11));
  oai21  g114(.a(new_n159_), .b(new_n91_), .c(x31), .O(new_n166_));
  nor2   g115(.a(x29), .b(x28), .O(new_n167_));
  nor2   g116(.a(x31), .b(x30), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n167_), .c(new_n130_), .d(new_n104_), .O(new_n169_));
  ...
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n72_), .O(z12));
  nand2  g123(.a(new_n169_), .b(x32), .O(new_n175_));
  nor2   g124(.a(x26), .b(x25), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n158_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n141_), .c(new_n176_), .d(new_n104_), .O(new_n180_));
  ...
  nand3  g133(.a(new_n184_), .b(new_n182_), .c(new_n72_), .O(z13));
  nand2  g134(.a(new_n180_), .b(x33), .O(new_n186_));
  nand2  g135(.a(new_n167_), .b(new_n137_), .O(new_n187_));
  inv1   g136(.a(new_n187_), .O(new_n188_));
  nor2   g137(.a(x33), .b(x32), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n188_), .c(new_n168_), .d(new_n114_), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(x16), .O(new_n192_));
  nor2   g141(.a(x16), .b(x01), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n64_), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n192_), .c(new_n72_), .O(z14));
  inv1   g144(.a(x34), .O(new_n196_));
  nand4  g145(.a(new_n176_), .b(new_n90_), .c(new_n97_), .d(new_n73_), .O(new_n197_));
  nand4  g146(.a(new_n189_), .b(new_n168_), .c(new_n167_), .d(new_n129_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n197_), .c(new_n53_), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n67_), .c(new_n196_), .O(new_n200_));
  inv1   g149(.a(new_n113_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n82_), .O(new_n202_));
  nor3   g151(.a(x34), .b(x33), .c(x32), .O(new_n203_));
  nand3  g152(.a(new_n203_), .b(new_n188_), .c(new_n168_), .O(new_n204_));
  ...
  aoi21  g157(.a(new_n208_), .b(new_n206_), .c(new_n64_), .O(z15));
endmodule
