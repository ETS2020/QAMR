...
module FAU ( 
  ...
  oai21  g036(.a(new_n78_), .b(x19), .c(new_n82_), .O(new_n88_));
  nor2   g037(.a(x23), .b(x22), .O(new_n89_));
  nand2  g038(.a(new_n89_), .b(new_n70_), .O(new_n90_));
  inv1   g039(.a(new_n90_), .O(new_n91_));
  aoi22  g040(.a(new_n91_), .b(new_n82_), .c(new_n88_), .d(x23), .O(new_n92_));
  ...
  oai21  g044(.a(new_n91_), .b(x19), .c(new_n82_), .O(new_n96_));
  nor2   g045(.a(x24), .b(x23), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n78_), .c(new_n82_), .O(new_n98_));
  nand2  g047(.a(new_n98_), .b(new_n63_), .O(new_n99_));
  aoi21  g048(.a(new_n96_), .b(x24), .c(new_n99_), .O(new_n100_));
  oai22  g049(.a(new_n100_), .b(new_n58_), .c(new_n68_), .d(x10), .O(z05));
  inv1   g050(.a(x25), .O(new_n102_));
  nand2  g051(.a(new_n97_), .b(new_n78_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n53_), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n82_), .c(new_n102_), .O(new_n105_));
  ...
  nand3  g065(.a(new_n106_), .b(new_n78_), .c(new_n116_), .O(new_n117_));
  nand2  g066(.a(new_n117_), .b(new_n53_), .O(new_n118_));
  aoi21  g067(.a(new_n118_), .b(new_n82_), .c(new_n115_), .O(new_n119_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n89_), .c(new_n128_), .d(new_n70_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n53_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n82_), .c(new_n127_), .O(new_n132_));
  nand3  g081(.a(new_n78_), .b(new_n55_), .c(new_n61_), .O(new_n133_));
  nor2   g082(.a(x27), .b(x26), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n97_), .c(new_n102_), .O(new_n135_));
  oai21  g084(.a(new_n135_), .b(new_n133_), .c(new_n63_), .O(new_n136_));
  oai21  g085(.a(new_n136_), .b(new_n132_), .c(x16), .O(new_n137_));
  oai21  g086(.a(new_n68_), .b(x07), .c(new_n137_), .O(z08));
  inv1   g087(.a(x28), .O(new_n139_));
  nand4  g088(.a(new_n134_), .b(new_n106_), .c(new_n89_), .d(new_n70_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n53_), .O(new_n141_));
  aoi21  g090(.a(new_n141_), .b(new_n82_), .c(new_n139_), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n106_), .c(new_n115_), .d(new_n116_), .O(new_n144_));
  oai21  g093(.a(new_n144_), .b(new_n133_), .c(new_n63_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n142_), .c(x16), .O(new_n146_));
  oai21  g095(.a(new_n68_), .b(x06), .c(new_n146_), .O(z09));
  inv1   g096(.a(x29), .O(new_n148_));
  nand2  g097(.a(new_n91_), .b(new_n82_), .O(new_n149_));
  nand4  g098(.a(new_n143_), .b(new_n129_), .c(new_n97_), .d(new_n78_), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n53_), .c(new_n64_), .O(new_n151_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n129_), .c(new_n127_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n103_), .c(new_n53_), .O(new_n161_));
  aoi21  g110(.a(new_n161_), .b(new_n82_), .c(new_n159_), .O(new_n162_));
  nor2   g111(.a(x30), .b(x29), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n143_), .c(new_n120_), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n149_), .O(new_n165_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n134_), .c(new_n139_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n117_), .c(new_n53_), .O(new_n172_));
  aoi21  g121(.a(new_n172_), .b(new_n82_), .c(new_n170_), .O(new_n173_));
  nor2   g122(.a(x31), .b(x30), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n152_), .c(new_n134_), .d(new_n102_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n98_), .c(new_n63_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n173_), .c(x16), .O(new_n177_));
  inv1   g126(.a(x03), .O(new_n178_));
  nand2  g127(.a(new_n67_), .b(new_n178_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n177_), .O(z12));
  inv1   g129(.a(x32), .O(new_n181_));
  nand4  g130(.a(new_n174_), .b(new_n143_), .c(new_n148_), .d(new_n115_), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(new_n117_), .c(new_n53_), .O(new_n183_));
  aoi21  g132(.a(new_n183_), .b(new_n82_), .c(new_n181_), .O(new_n184_));
  nor2   g133(.a(x32), .b(x31), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n163_), .c(new_n143_), .d(new_n129_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n98_), .c(new_n63_), .O(new_n187_));
  oai21  g136(.a(new_n187_), .b(new_n184_), .c(x16), .O(new_n188_));
  inv1   g137(.a(x02), .O(new_n189_));
  nand2  g138(.a(new_n67_), .b(new_n189_), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(new_n188_), .O(z13));
  inv1   g140(.a(x33), .O(new_n192_));
  nand4  g141(.a(new_n185_), .b(new_n152_), .c(new_n159_), .d(new_n127_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n130_), .c(new_n53_), .O(new_n194_));
  aoi21  g143(.a(new_n194_), .b(new_n82_), .c(new_n192_), .O(new_n195_));
  nor2   g144(.a(x33), .b(x32), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n174_), .c(new_n152_), .d(new_n134_), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n109_), .c(new_n63_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n195_), .c(x16), .O(new_n199_));
  inv1   g148(.a(x01), .O(new_n200_));
  nand2  g149(.a(new_n67_), .b(new_n200_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(new_n199_), .O(z14));
  inv1   g151(.a(x34), .O(new_n203_));
  nand4  g152(.a(new_n196_), .b(new_n174_), .c(new_n152_), .d(new_n127_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n130_), .c(new_n53_), .O(new_n205_));
  aoi21  g154(.a(new_n205_), .b(new_n82_), .c(new_n203_), .O(new_n206_));
  nor3   g155(.a(x34), .b(x33), .c(x32), .O(new_n207_));
  nand4  g156(.a(new_n207_), .b(new_n174_), .c(new_n152_), .d(new_n134_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n109_), .c(new_n63_), .O(new_n209_));
  oai21  g158(.a(new_n209_), .b(new_n206_), .c(x16), .O(new_n210_));
  inv1   g159(.a(x00), .O(new_n211_));
  nand2  g160(.a(new_n67_), .b(new_n211_), .O(new_n212_));
