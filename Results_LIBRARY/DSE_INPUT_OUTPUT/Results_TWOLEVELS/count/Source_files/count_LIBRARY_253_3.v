...
module FAU ( 
  ...
  inv1   g049(.a(new_n62_), .O(new_n101_));
  ...
  nand3  g053(.a(new_n104_), .b(new_n83_), .c(new_n62_), .O(new_n105_));
  oai21  g054(.a(new_n103_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  nor2   g055(.a(x16), .b(x10), .O(new_n107_));
  aoi21  g056(.a(new_n106_), .b(x16), .c(new_n107_), .O(new_n108_));
  oai21  g057(.a(new_n108_), .b(x18), .c(new_n59_), .O(z05));
  aoi21  g058(.a(new_n104_), .b(new_n83_), .c(x19), .O(new_n110_));
  ...
  oai21  g066(.a(new_n117_), .b(x18), .c(new_n59_), .O(z06));
  nor3   g067(.a(x25), .b(x24), .c(x23), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n83_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n68_), .c(x20), .O(new_n121_));
  ...
  oai21  g077(.a(new_n126_), .b(new_n61_), .c(new_n128_), .O(z07));
  inv1   g078(.a(x27), .O(new_n130_));
  nand2  g079(.a(new_n123_), .b(new_n93_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n68_), .c(new_n101_), .O(new_n132_));
  ...
  oai21  g087(.a(new_n138_), .b(x18), .c(new_n59_), .O(z08));
  nor2   g088(.a(x27), .b(x26), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n113_), .c(new_n93_), .O(new_n141_));
  aoi21  g090(.a(new_n141_), .b(new_n68_), .c(x20), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(x18), .c(new_n53_), .O(new_n143_));
  ...
  aoi21  g095(.a(new_n143_), .b(x28), .c(new_n146_), .O(new_n147_));
  inv1   g096(.a(x06), .O(new_n148_));
  aoi21  g097(.a(new_n61_), .b(new_n148_), .c(x18), .O(new_n149_));
  oai21  g098(.a(new_n147_), .b(new_n61_), .c(new_n149_), .O(z09));
  inv1   g099(.a(x29), .O(new_n151_));
  nor2   g100(.a(x26), .b(x25), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n152_), .c(new_n104_), .d(new_n83_), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n68_), .c(new_n101_), .O(new_n155_));
  ...
  oai21  g109(.a(new_n160_), .b(x18), .c(new_n59_), .O(z10));
  nand4  g110(.a(new_n156_), .b(new_n152_), .c(new_n104_), .d(new_n83_), .O(new_n162_));
  aoi21  g111(.a(new_n162_), .b(new_n68_), .c(x20), .O(new_n163_));
  ...
  oai21  g119(.a(new_n168_), .b(new_n61_), .c(new_n170_), .O(z11));
  nor3   g120(.a(x30), .b(x29), .c(x28), .O(new_n172_));
  nand4  g121(.a(new_n172_), .b(new_n140_), .c(new_n119_), .d(new_n83_), .O(new_n173_));
  ...
  nand3  g126(.a(new_n177_), .b(new_n176_), .c(new_n134_), .O(new_n178_));
  ...
  nand4  g133(.a(new_n184_), .b(new_n144_), .c(new_n119_), .d(new_n83_), .O(new_n185_));
  aoi21  g134(.a(new_n185_), .b(new_n68_), .c(x20), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(x18), .c(new_n53_), .O(new_n187_));
  nor2   g136(.a(x32), .b(x31), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n165_), .c(new_n153_), .d(new_n152_), .O(new_n189_));
  ...
  oai21  g142(.a(new_n191_), .b(new_n61_), .c(new_n193_), .O(z13));
  nor3   g143(.a(x32), .b(x31), .c(x30), .O(new_n195_));
  nand4  g144(.a(new_n195_), .b(new_n156_), .c(new_n123_), .d(new_n93_), .O(new_n196_));
  aoi21  g145(.a(new_n196_), .b(new_n68_), .c(x20), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(x18), .c(new_n53_), .O(new_n198_));
  nand2  g147(.a(new_n176_), .b(new_n140_), .O(new_n199_));
  inv1   g148(.a(x32), .O(new_n200_));
  inv1   g149(.a(x33), .O(new_n201_));
  nand3  g150(.a(new_n177_), .b(new_n201_), .c(new_n200_), .O(new_n202_));
  nor3   g151(.a(new_n202_), .b(new_n199_), .c(new_n114_), .O(new_n203_));
  aoi21  g152(.a(new_n198_), .b(x33), .c(new_n203_), .O(new_n204_));
  inv1   g153(.a(x01), .O(new_n205_));
  aoi21  g154(.a(new_n61_), .b(new_n205_), .c(x18), .O(new_n206_));
  oai21  g155(.a(new_n204_), .b(new_n61_), .c(new_n206_), .O(z14));
  oai21  g156(.a(x18), .b(new_n61_), .c(new_n58_), .O(new_n208_));
  inv1   g157(.a(x34), .O(new_n209_));
  nand4  g158(.a(new_n177_), .b(new_n156_), .c(new_n201_), .d(new_n200_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n131_), .c(new_n68_), .O(new_n211_));
  aoi21  g160(.a(new_n211_), .b(new_n62_), .c(new_n209_), .O(new_n212_));
  nand4  g161(.a(new_n177_), .b(new_n209_), .c(new_n201_), .d(new_n200_), .O(new_n213_));
  nor3   g162(.a(new_n213_), .b(new_n199_), .c(new_n114_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(new_n212_), .c(new_n69_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n61_), .c(new_n208_), .O(z15));
endmodule
