...
module FAU ( 
  ...
  oai21  g011(.a(new_n52_), .b(x05), .c(x18), .O(new_n63_));
  ...
  aoi21  g029(.a(new_n73_), .b(new_n57_), .c(new_n80_), .O(new_n81_));
  ...
  aoi21  g047(.a(x16), .b(x05), .c(new_n52_), .O(new_n99_));
  nor2   g048(.a(new_n92_), .b(x19), .O(new_n100_));
  oai21  g049(.a(new_n100_), .b(new_n66_), .c(x24), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand3  g051(.a(new_n102_), .b(new_n82_), .c(new_n67_), .O(new_n103_));
  and2   g052(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  inv1   g053(.a(x18), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(x16), .O(new_n106_));
  aoi22  g055(.a(new_n106_), .b(new_n52_), .c(x18), .d(x05), .O(new_n107_));
  oai21  g056(.a(new_n104_), .b(new_n99_), .c(new_n107_), .O(z05));
  nor2   g057(.a(new_n102_), .b(x19), .O(new_n109_));
  oai21  g058(.a(new_n109_), .b(new_n83_), .c(x25), .O(new_n110_));
  nor2   g059(.a(x23), .b(x22), .O(new_n111_));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n111_), .c(new_n73_), .d(new_n57_), .O(new_n113_));
  ...
  nand3  g068(.a(new_n112_), .b(new_n82_), .c(new_n89_), .O(new_n120_));
  ...
  nand4  g081(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n72_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n55_), .O(new_n134_));
  aoi21  g083(.a(new_n134_), .b(new_n67_), .c(new_n130_), .O(new_n135_));
  ...
  nand2  g093(.a(new_n137_), .b(new_n102_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n55_), .O(new_n146_));
  nand3  g095(.a(new_n136_), .b(new_n80_), .c(new_n72_), .O(new_n147_));
  nor2   g096(.a(new_n147_), .b(new_n66_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n146_), .c(new_n144_), .O(new_n149_));
  nand2  g098(.a(new_n112_), .b(new_n89_), .O(new_n150_));
  nor2   g099(.a(x28), .b(x27), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n119_), .O(new_n152_));
  nor3   g101(.a(new_n152_), .b(new_n150_), .c(new_n83_), .O(new_n153_));
  ...
  nand3  g107(.a(new_n82_), .b(new_n144_), .c(new_n136_), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n55_), .c(new_n66_), .O(new_n160_));
  nor3   g109(.a(x29), .b(x28), .c(x27), .O(new_n161_));
  nand4  g110(.a(new_n161_), .b(new_n123_), .c(new_n92_), .d(new_n67_), .O(new_n162_));
  oai21  g111(.a(new_n160_), .b(new_n158_), .c(new_n162_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(x16), .c(x18), .O(new_n164_));
  inv1   g113(.a(x05), .O(new_n165_));
  oai21  g114(.a(x19), .b(new_n165_), .c(x10), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n145_), .c(x29), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nor3   g117(.a(x16), .b(x10), .c(x05), .O(new_n169_));
  aoi21  g118(.a(new_n168_), .b(x16), .c(new_n169_), .O(new_n170_));
  oai21  g119(.a(new_n164_), .b(new_n53_), .c(new_n170_), .O(z10));
  inv1   g120(.a(x30), .O(new_n172_));
  nand4  g121(.a(new_n102_), .b(new_n158_), .c(new_n130_), .d(new_n119_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(new_n55_), .O(new_n174_));
  nor2   g123(.a(new_n159_), .b(new_n66_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n174_), .c(new_n172_), .O(new_n176_));
  nor2   g125(.a(x30), .b(x29), .O(new_n177_));
  nand3  g126(.a(new_n177_), .b(new_n151_), .c(new_n123_), .O(new_n178_));
  nor3   g127(.a(new_n178_), .b(new_n93_), .c(new_n66_), .O(new_n179_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n137_), .c(new_n144_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n120_), .c(new_n55_), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n67_), .c(new_n184_), .O(new_n187_));
  nor2   g136(.a(x29), .b(x28), .O(new_n188_));
  nor2   g137(.a(x31), .b(x30), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n188_), .c(new_n137_), .d(new_n136_), .O(new_n190_));
  ...
  aoi21  g143(.a(new_n194_), .b(new_n192_), .c(new_n53_), .O(z12));
  inv1   g144(.a(x32), .O(new_n196_));
  nand4  g145(.a(new_n189_), .b(new_n151_), .c(new_n158_), .d(new_n119_), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n120_), .c(new_n55_), .O(new_n198_));
  aoi21  g147(.a(new_n198_), .b(new_n67_), .c(new_n196_), .O(new_n199_));
  nor2   g148(.a(x32), .b(x31), .O(new_n200_));
  nand4  g149(.a(new_n200_), .b(new_n177_), .c(new_n151_), .d(new_n132_), .O(new_n201_));
  ...
  aoi21  g154(.a(new_n205_), .b(new_n203_), .c(new_n53_), .O(z13));
  inv1   g155(.a(x33), .O(new_n207_));
  nand4  g156(.a(new_n200_), .b(new_n188_), .c(new_n172_), .d(new_n130_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n133_), .c(new_n55_), .O(new_n209_));
  aoi21  g158(.a(new_n209_), .b(new_n67_), .c(new_n207_), .O(new_n210_));
  nand2  g159(.a(new_n188_), .b(new_n137_), .O(new_n211_));
  ...
  aoi21  g165(.a(new_n60_), .b(new_n216_), .c(x18), .O(new_n217_));
  aoi21  g166(.a(new_n217_), .b(new_n215_), .c(new_n53_), .O(z14));
  inv1   g167(.a(x34), .O(new_n219_));
  nand3  g168(.a(new_n212_), .b(new_n184_), .c(new_n158_), .O(new_n220_));
  oai21  g169(.a(new_n220_), .b(new_n145_), .c(new_n55_), .O(new_n221_));
  nand4  g170(.a(new_n172_), .b(new_n144_), .c(new_n136_), .d(new_n80_), .O(new_n222_));
  nor2   g171(.a(new_n222_), .b(new_n74_), .O(new_n223_));
  aoi21  g172(.a(new_n223_), .b(new_n221_), .c(new_n219_), .O(new_n224_));
  nand4  g173(.a(new_n189_), .b(new_n219_), .c(new_n207_), .d(new_n196_), .O(new_n225_));
  nor3   g174(.a(new_n225_), .b(new_n211_), .c(new_n113_), .O(new_n226_));
  oai21  g175(.a(new_n226_), .b(new_n224_), .c(x16), .O(new_n227_));
  nor2   g176(.a(x16), .b(x00), .O(new_n228_));
  nor2   g177(.a(new_n228_), .b(new_n53_), .O(new_n229_));
  nand3  g178(.a(new_n229_), .b(new_n227_), .c(new_n63_), .O(z15));
endmodule
