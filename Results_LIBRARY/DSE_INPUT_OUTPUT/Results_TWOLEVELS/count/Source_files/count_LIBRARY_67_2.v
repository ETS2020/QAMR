...
module FAU ( 
  ...
  oai21  g021(.a(new_n60_), .b(x11), .c(new_n72_), .O(new_n73_));
  ...
  nand3  g026(.a(new_n77_), .b(new_n73_), .c(new_n63_), .O(z02));
  ...
  aoi21  g036(.a(x16), .b(x13), .c(new_n52_), .O(new_n88_));
  oai21  g037(.a(new_n81_), .b(x19), .c(new_n67_), .O(new_n89_));
  nor2   g038(.a(x23), .b(x22), .O(new_n90_));
  nand3  g039(.a(new_n90_), .b(new_n67_), .c(new_n74_), .O(new_n91_));
  inv1   g040(.a(new_n91_), .O(new_n92_));
  aoi21  g041(.a(new_n89_), .b(x23), .c(new_n92_), .O(new_n93_));
  inv1   g042(.a(x18), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(x16), .O(new_n95_));
  aoi22  g044(.a(new_n95_), .b(new_n52_), .c(x18), .d(x13), .O(new_n96_));
  oai21  g045(.a(new_n93_), .b(new_n88_), .c(new_n96_), .O(z04));
  inv1   g046(.a(x24), .O(new_n98_));
  nand2  g047(.a(new_n90_), .b(new_n74_), .O(new_n99_));
  ...
  oai22  g069(.a(new_n120_), .b(new_n75_), .c(new_n113_), .d(new_n118_), .O(new_n121_));
  ...
  oai21  g077(.a(new_n128_), .b(new_n99_), .c(new_n55_), .O(new_n129_));
  aoi21  g078(.a(new_n129_), .b(new_n67_), .c(new_n126_), .O(new_n130_));
  ...
  aoi21  g085(.a(new_n136_), .b(new_n134_), .c(new_n53_), .O(z08));
  inv1   g086(.a(x28), .O(new_n138_));
  inv1   g087(.a(x23), .O(new_n139_));
  nor2   g088(.a(x28), .b(x27), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n111_), .c(new_n118_), .d(new_n139_), .O(new_n141_));
  oai22  g090(.a(new_n141_), .b(new_n82_), .c(new_n133_), .d(new_n138_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(x16), .O(new_n143_));
  nor2   g092(.a(x16), .b(x06), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n53_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n143_), .c(new_n63_), .O(z09));
  inv1   g095(.a(x29), .O(new_n147_));
  nand4  g096(.a(new_n140_), .b(new_n127_), .c(new_n102_), .d(new_n81_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n55_), .c(new_n66_), .O(new_n149_));
  nor2   g098(.a(x29), .b(x28), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n119_), .c(new_n126_), .O(new_n151_));
  oai22  g100(.a(new_n151_), .b(new_n91_), .c(new_n149_), .d(new_n147_), .O(new_n152_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n127_), .c(new_n126_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n103_), .c(new_n55_), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n67_), .c(new_n157_), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n140_), .c(new_n119_), .O(new_n162_));
  ...
  nand4  g118(.a(new_n169_), .b(new_n150_), .c(new_n131_), .d(new_n104_), .O(new_n170_));
  oai21  g119(.a(new_n163_), .b(new_n168_), .c(new_n170_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(x16), .O(new_n172_));
  nor2   g121(.a(x16), .b(x03), .O(new_n173_));
  nor2   g122(.a(new_n173_), .b(new_n53_), .O(new_n174_));
  nand3  g123(.a(new_n174_), .b(new_n172_), .c(new_n63_), .O(z12));
  inv1   g124(.a(x32), .O(new_n176_));
  nand3  g125(.a(new_n111_), .b(new_n81_), .c(new_n139_), .O(new_n177_));
  nand4  g126(.a(new_n169_), .b(new_n140_), .c(new_n147_), .d(new_n118_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n177_), .c(new_n55_), .O(new_n179_));
  aoi21  g128(.a(new_n179_), .b(new_n67_), .c(new_n176_), .O(new_n180_));
  nor2   g129(.a(x32), .b(x31), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n161_), .c(new_n140_), .d(new_n127_), .O(new_n182_));
  nor3   g131(.a(new_n182_), .b(new_n103_), .c(new_n66_), .O(new_n183_));
  ...
  nand3  g137(.a(new_n150_), .b(new_n126_), .c(new_n118_), .O(new_n189_));
  ...
  nand3  g145(.a(new_n196_), .b(new_n194_), .c(new_n63_), .O(z14));
  nand2  g146(.a(new_n192_), .b(x34), .O(new_n198_));
  inv1   g147(.a(new_n189_), .O(new_n199_));
  nor3   g148(.a(x34), .b(x33), .c(x32), .O(new_n200_));
  nand4  g149(.a(new_n200_), .b(new_n199_), .c(new_n169_), .d(new_n113_), .O(new_n201_));
  ...
  nand3  g154(.a(new_n205_), .b(new_n203_), .c(new_n63_), .O(z15));
endmodule
