...
module FAU ( 
  ...
  aoi22  g035(.a(new_n86_), .b(new_n85_), .c(new_n81_), .d(x23), .O(new_n87_));
  ...
  aoi21  g040(.a(new_n86_), .b(new_n85_), .c(new_n91_), .O(new_n92_));
  nor2   g041(.a(x24), .b(x23), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n80_), .c(new_n65_), .d(new_n52_), .O(new_n94_));
  ...
  nand4  g050(.a(new_n101_), .b(new_n91_), .c(new_n100_), .d(new_n79_), .O(new_n102_));
  ...
  nand3  g061(.a(new_n112_), .b(new_n109_), .c(new_n91_), .O(new_n113_));
  ...
  nand4  g072(.a(new_n123_), .b(new_n93_), .c(new_n122_), .d(new_n55_), .O(new_n124_));
  oai21  g073(.a(new_n114_), .b(new_n121_), .c(new_n124_), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n63_), .c(x16), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n120_), .O(z08));
  inv1   g076(.a(x26), .O(new_n128_));
  nor2   g077(.a(x28), .b(x27), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n110_), .c(new_n128_), .d(new_n100_), .O(new_n130_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n122_), .d(new_n55_), .O(new_n138_));
  nand4  g087(.a(new_n109_), .b(new_n65_), .c(new_n70_), .d(new_n52_), .O(new_n139_));
  nor2   g088(.a(x29), .b(x28), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n112_), .c(new_n121_), .d(new_n91_), .O(new_n141_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n86_), .d(new_n85_), .O(new_n149_));
  nor2   g098(.a(x30), .b(x29), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n129_), .c(new_n112_), .d(new_n91_), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n139_), .O(new_n152_));
  aoi21  g101(.a(new_n149_), .b(x30), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g140(.a(new_n140_), .b(new_n169_), .O(new_n192_));
  ...
  nand3  g152(.a(new_n203_), .b(new_n63_), .c(x16), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n190_), .O(z15));
endmodule
