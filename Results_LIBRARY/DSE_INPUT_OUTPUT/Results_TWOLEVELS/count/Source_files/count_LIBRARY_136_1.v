...
module FAU ( 
  ...
  oai21  g006(.a(new_n57_), .b(x09), .c(x18), .O(new_n58_));
  nor2   g007(.a(new_n57_), .b(x09), .O(new_n59_));
  ...
  aoi21  g026(.a(new_n77_), .b(new_n75_), .c(new_n59_), .O(z02));
  ...
  aoi21  g038(.a(new_n81_), .b(new_n55_), .c(new_n89_), .O(new_n90_));
  nand3  g039(.a(new_n89_), .b(new_n79_), .c(new_n72_), .O(new_n91_));
  nor2   g040(.a(new_n91_), .b(new_n65_), .O(new_n92_));
  oai21  g041(.a(new_n92_), .b(new_n90_), .c(x16), .O(new_n93_));
  aoi21  g042(.a(x18), .b(x09), .c(new_n59_), .O(new_n94_));
  ...
  oai21  g049(.a(new_n92_), .b(new_n96_), .c(new_n100_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(x16), .O(new_n102_));
  nor2   g051(.a(x16), .b(x10), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n59_), .O(new_n104_));
  nand3  g053(.a(new_n104_), .b(new_n102_), .c(new_n58_), .O(z05));
  inv1   g054(.a(x09), .O(new_n106_));
  oai21  g055(.a(new_n69_), .b(x11), .c(new_n106_), .O(new_n107_));
  nand2  g056(.a(new_n100_), .b(x25), .O(new_n108_));
  ...
  nand3  g063(.a(new_n114_), .b(new_n107_), .c(new_n58_), .O(z06));
  nand2  g064(.a(new_n112_), .b(x26), .O(new_n116_));
  nor3   g065(.a(x26), .b(x25), .c(x24), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n110_), .c(new_n80_), .O(new_n118_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n120_), .c(new_n58_), .O(z07));
  nand2  g072(.a(new_n118_), .b(x27), .O(new_n124_));
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n99_), .c(new_n81_), .d(new_n55_), .O(new_n126_));
  ...
  oai21  g100(.a(new_n146_), .b(new_n142_), .c(x30), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n117_), .d(new_n92_), .O(new_n155_));
  ...
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n59_), .O(z11));
  nand4  g109(.a(new_n154_), .b(new_n153_), .c(new_n144_), .d(new_n96_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n142_), .c(x31), .O(new_n162_));
  nand2  g111(.a(new_n99_), .b(new_n98_), .O(new_n163_));
  inv1   g112(.a(new_n163_), .O(new_n164_));
  nor2   g113(.a(x31), .b(x30), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n145_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n125_), .c(new_n164_), .d(new_n66_), .O(new_n168_));
  ...
  aoi21  g121(.a(new_n172_), .b(new_n170_), .c(new_n59_), .O(z12));
  inv1   g122(.a(x25), .O(new_n174_));
  nor2   g123(.a(x27), .b(x26), .O(new_n175_));
  nand4  g124(.a(new_n165_), .b(new_n145_), .c(new_n175_), .d(new_n174_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n100_), .c(x32), .O(new_n177_));
  nand2  g126(.a(new_n153_), .b(new_n144_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n154_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n179_), .c(new_n164_), .d(new_n66_), .O(new_n183_));
  ...
  aoi21  g136(.a(new_n187_), .b(new_n185_), .c(new_n59_), .O(z13));
  nand4  g137(.a(new_n180_), .b(new_n154_), .c(new_n153_), .d(new_n144_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n100_), .c(x33), .O(new_n190_));
  nor2   g139(.a(x33), .b(x32), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n165_), .c(new_n145_), .d(new_n175_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n112_), .c(new_n190_), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(x16), .O(new_n194_));
  nor2   g143(.a(x16), .b(x01), .O(new_n195_));
  nor2   g144(.a(new_n195_), .b(new_n59_), .O(new_n196_));
  nand3  g145(.a(new_n196_), .b(new_n194_), .c(new_n58_), .O(z14));
  oai21  g146(.a(new_n192_), .b(new_n112_), .c(x34), .O(new_n198_));
  nand4  g147(.a(new_n174_), .b(new_n96_), .c(new_n89_), .d(new_n79_), .O(new_n199_));
  nor2   g148(.a(new_n199_), .b(new_n73_), .O(new_n200_));
  nand2  g149(.a(new_n145_), .b(new_n175_), .O(new_n201_));
