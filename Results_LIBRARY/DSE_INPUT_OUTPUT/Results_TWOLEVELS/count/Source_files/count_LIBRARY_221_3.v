...
module FAU ( 
  ...
  nand3  g020(.a(new_n58_), .b(new_n71_), .c(new_n64_), .O(new_n72_));
  ...
  aoi21  g025(.a(new_n76_), .b(new_n74_), .c(new_n54_), .O(z02));
  oai21  g026(.a(new_n53_), .b(new_n52_), .c(x18), .O(new_n78_));
  inv1   g027(.a(x22), .O(new_n79_));
  inv1   g028(.a(new_n72_), .O(new_n80_));
  nor2   g029(.a(x22), .b(x21), .O(new_n81_));
  nand3  g030(.a(new_n81_), .b(new_n58_), .c(new_n64_), .O(new_n82_));
  ...
  aoi21  g044(.a(x18), .b(new_n52_), .c(new_n54_), .O(new_n96_));
  ...
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n78_), .O(z05));
  and2   g055(.a(new_n101_), .b(x25), .O(new_n107_));
  nor2   g056(.a(x25), .b(x24), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n92_), .O(new_n109_));
  ...
  aoi21  g076(.a(new_n127_), .b(new_n66_), .c(new_n123_), .O(new_n128_));
  ...
  aoi21  g083(.a(new_n134_), .b(new_n132_), .c(new_n54_), .O(z08));
  inv1   g084(.a(x28), .O(new_n136_));
  nor2   g085(.a(x27), .b(x26), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n108_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n124_), .c(new_n56_), .O(new_n139_));
  aoi21  g088(.a(new_n139_), .b(new_n66_), .c(new_n136_), .O(new_n140_));
  inv1   g089(.a(x23), .O(new_n141_));
  nand2  g090(.a(new_n108_), .b(new_n141_), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nand2  g092(.a(new_n143_), .b(new_n115_), .O(new_n144_));
  nor3   g093(.a(new_n144_), .b(new_n142_), .c(new_n82_), .O(new_n145_));
  ...
  oai21  g098(.a(new_n61_), .b(x11), .c(x05), .O(new_n150_));
  inv1   g099(.a(x29), .O(new_n151_));
  nand3  g100(.a(new_n64_), .b(new_n56_), .c(new_n55_), .O(new_n152_));
  nand4  g101(.a(new_n143_), .b(new_n125_), .c(new_n100_), .d(new_n81_), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n56_), .c(new_n152_), .O(new_n154_));
  nor2   g103(.a(x29), .b(x28), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n116_), .c(new_n123_), .O(new_n156_));
  oai22  g105(.a(new_n156_), .b(new_n93_), .c(new_n154_), .d(new_n151_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(new_n150_), .O(new_n158_));
  aoi22  g107(.a(new_n89_), .b(new_n52_), .c(x18), .d(new_n53_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n158_), .O(z10));
  oai21  g109(.a(new_n156_), .b(new_n93_), .c(x30), .O(new_n161_));
  nor2   g110(.a(x30), .b(x29), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n143_), .c(new_n116_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n93_), .c(new_n161_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(x16), .O(new_n165_));
  nor2   g114(.a(x16), .b(x04), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(new_n54_), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n165_), .c(new_n78_), .O(z11));
  oai21  g117(.a(new_n163_), .b(new_n93_), .c(x31), .O(new_n169_));
  nor2   g118(.a(x31), .b(x30), .O(new_n170_));
  nand3  g119(.a(new_n170_), .b(new_n155_), .c(new_n129_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n101_), .c(new_n169_), .O(new_n172_));
  nand2  g121(.a(new_n172_), .b(x16), .O(new_n173_));
  nor2   g122(.a(x16), .b(x03), .O(new_n174_));
  nor2   g123(.a(new_n174_), .b(new_n54_), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n173_), .c(new_n78_), .O(z12));
  inv1   g125(.a(x32), .O(new_n177_));
  nand3  g126(.a(new_n108_), .b(new_n81_), .c(new_n141_), .O(new_n178_));
  nand4  g127(.a(new_n170_), .b(new_n143_), .c(new_n151_), .d(new_n115_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n178_), .c(new_n56_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n66_), .c(new_n177_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n162_), .c(new_n143_), .d(new_n125_), .O(new_n183_));
  ...
  nand2  g138(.a(new_n155_), .b(new_n137_), .O(new_n190_));
  ...
  nand3  g146(.a(new_n197_), .b(new_n195_), .c(new_n78_), .O(z14));
  nand2  g147(.a(new_n193_), .b(x34), .O(new_n199_));
  inv1   g148(.a(new_n190_), .O(new_n200_));
  nor3   g149(.a(x34), .b(x33), .c(x32), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n200_), .c(new_n170_), .d(new_n110_), .O(new_n202_));
  ...
  nand3  g155(.a(new_n206_), .b(new_n204_), .c(new_n78_), .O(z15));
endmodule
