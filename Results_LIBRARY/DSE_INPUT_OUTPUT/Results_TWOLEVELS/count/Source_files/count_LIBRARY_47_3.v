...
module FAU ( 
  ...
  oai21  g029(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n81_));
  nand2  g030(.a(x22), .b(x21), .O(new_n82_));
  nor2   g031(.a(x22), .b(x21), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n65_), .c(new_n55_), .O(new_n84_));
  ...
  aoi21  g036(.a(x18), .b(new_n52_), .c(new_n61_), .O(new_n88_));
  ...
  nand3  g058(.a(new_n109_), .b(new_n107_), .c(new_n64_), .O(z05));
  ...
  nand3  g069(.a(new_n120_), .b(new_n118_), .c(new_n64_), .O(z06));
  ...
  nand3  g086(.a(new_n83_), .b(new_n58_), .c(new_n65_), .O(new_n138_));
  ...
  aoi21  g093(.a(new_n144_), .b(new_n142_), .c(new_n61_), .O(z08));
  ...
  oai21  g151(.a(new_n202_), .b(new_n135_), .c(new_n56_), .O(new_n203_));
  ...
  aoi21  g160(.a(new_n211_), .b(new_n209_), .c(new_n61_), .O(z14));
  inv1   g161(.a(x34), .O(new_n213_));
  nand4  g162(.a(new_n206_), .b(new_n183_), .c(new_n161_), .d(new_n133_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(new_n135_), .c(new_n56_), .O(new_n215_));
