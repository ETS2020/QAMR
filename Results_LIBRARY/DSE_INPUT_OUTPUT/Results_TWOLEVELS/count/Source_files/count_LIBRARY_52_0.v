...
module FAU ( 
  ...
  oai21  g049(.a(x10), .b(x07), .c(x18), .O(new_n101_));
  inv1   g050(.a(x24), .O(new_n102_));
  nor2   g051(.a(x24), .b(x23), .O(new_n103_));
  nand3  g052(.a(new_n103_), .b(new_n78_), .c(new_n64_), .O(new_n104_));
  oai21  g053(.a(new_n93_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n101_), .c(new_n100_), .O(z05));
  inv1   g056(.a(x25), .O(new_n108_));
  nand2  g057(.a(new_n103_), .b(new_n78_), .O(new_n109_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n91_), .c(new_n70_), .d(new_n56_), .O(new_n113_));
  ...
  aoi21  g066(.a(new_n117_), .b(new_n115_), .c(new_n52_), .O(z06));
  ...
  oai21  g076(.a(new_n59_), .b(new_n99_), .c(new_n98_), .O(new_n128_));
  inv1   g077(.a(x27), .O(new_n129_));
  nand3  g078(.a(new_n78_), .b(new_n56_), .c(new_n62_), .O(new_n130_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n128_), .c(new_n101_), .O(z08));
  oai21  g084(.a(new_n132_), .b(new_n130_), .c(x28), .O(new_n136_));
  nor2   g085(.a(x28), .b(x27), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n112_), .c(new_n119_), .d(new_n87_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n130_), .c(new_n136_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(x16), .O(new_n140_));
  nor2   g089(.a(x16), .b(x06), .O(new_n141_));
  nor2   g090(.a(new_n141_), .b(new_n52_), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n140_), .c(new_n101_), .O(z09));
  inv1   g092(.a(x29), .O(new_n144_));
  nor2   g093(.a(x26), .b(x25), .O(new_n145_));
  nand4  g094(.a(new_n137_), .b(new_n145_), .c(new_n103_), .d(new_n78_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n54_), .c(new_n90_), .O(new_n147_));
  nor3   g096(.a(x29), .b(x28), .c(x27), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n121_), .c(new_n93_), .O(new_n149_));
  ...
  aoi21  g102(.a(new_n153_), .b(new_n151_), .c(new_n52_), .O(z10));
  nand2  g103(.a(new_n149_), .b(x30), .O(new_n155_));
  nand3  g104(.a(new_n91_), .b(new_n64_), .c(new_n69_), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n137_), .c(new_n121_), .O(new_n158_));
  or2    g107(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  ...
  nand3  g112(.a(new_n163_), .b(new_n161_), .c(new_n101_), .O(z11));
  oai21  g113(.a(new_n158_), .b(new_n156_), .c(x31), .O(new_n165_));
  nor2   g114(.a(x29), .b(x28), .O(new_n166_));
  nor2   g115(.a(x31), .b(x30), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n166_), .c(new_n131_), .O(new_n168_));
  ...
  nand3  g121(.a(new_n172_), .b(new_n170_), .c(new_n101_), .O(z12));
  inv1   g122(.a(x32), .O(new_n174_));
  nand3  g123(.a(new_n112_), .b(new_n78_), .c(new_n87_), .O(new_n175_));
  nand4  g124(.a(new_n167_), .b(new_n137_), .c(new_n144_), .d(new_n119_), .O(new_n176_));
  oai21  g125(.a(new_n176_), .b(new_n175_), .c(new_n54_), .O(new_n177_));
  aoi21  g126(.a(new_n177_), .b(new_n64_), .c(new_n174_), .O(new_n178_));
  nor2   g127(.a(x32), .b(x31), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n157_), .c(new_n137_), .d(new_n145_), .O(new_n180_));
  ...
  aoi21  g133(.a(new_n184_), .b(new_n182_), .c(new_n52_), .O(z13));
  inv1   g134(.a(x33), .O(new_n186_));
  nand4  g135(.a(new_n145_), .b(new_n91_), .c(new_n102_), .d(new_n69_), .O(new_n187_));
  inv1   g136(.a(x30), .O(new_n188_));
  nand4  g137(.a(new_n179_), .b(new_n166_), .c(new_n188_), .d(new_n129_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n187_), .c(new_n54_), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n64_), .c(new_n186_), .O(new_n191_));
  nand3  g140(.a(new_n166_), .b(new_n129_), .c(new_n119_), .O(new_n192_));
  nor2   g141(.a(x33), .b(x32), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n167_), .O(new_n194_));
  nor3   g143(.a(new_n194_), .b(new_n192_), .c(new_n113_), .O(new_n195_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n167_), .c(new_n166_), .d(new_n129_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n187_), .c(new_n54_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n64_), .c(new_n200_), .O(new_n203_));
  nand4  g152(.a(new_n167_), .b(new_n200_), .c(new_n186_), .d(new_n174_), .O(new_n204_));
  nor3   g153(.a(new_n204_), .b(new_n192_), .c(new_n113_), .O(new_n205_));
