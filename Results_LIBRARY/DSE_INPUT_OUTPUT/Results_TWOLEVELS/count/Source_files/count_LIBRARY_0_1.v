...
module FAU ( 
  ...
  oai21  g006(.a(new_n57_), .b(x11), .c(x18), .O(new_n58_));
  nor2   g007(.a(new_n57_), .b(x11), .O(new_n59_));
  ...
  oai21  g012(.a(x18), .b(new_n63_), .c(new_n57_), .O(new_n64_));
  ...
  aoi21  g017(.a(x18), .b(x11), .c(new_n59_), .O(new_n69_));
  nand3  g018(.a(new_n69_), .b(new_n68_), .c(new_n64_), .O(z01));
  ...
  oai21  g038(.a(new_n63_), .b(x14), .c(new_n89_), .O(new_n90_));
  inv1   g039(.a(x23), .O(new_n91_));
  inv1   g040(.a(new_n80_), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  aoi21  g042(.a(new_n93_), .b(new_n67_), .c(new_n91_), .O(new_n94_));
  nor2   g043(.a(x23), .b(x22), .O(new_n95_));
  nand3  g044(.a(new_n95_), .b(new_n67_), .c(new_n71_), .O(new_n96_));
  inv1   g045(.a(new_n96_), .O(new_n97_));
  oai21  g046(.a(new_n97_), .b(new_n94_), .c(x16), .O(new_n98_));
  nand3  g047(.a(new_n98_), .b(new_n90_), .c(new_n58_), .O(z04));
  inv1   g048(.a(x24), .O(new_n100_));
  nand2  g049(.a(new_n95_), .b(new_n71_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(new_n53_), .O(new_n102_));
  aoi21  g051(.a(new_n102_), .b(new_n67_), .c(new_n100_), .O(new_n103_));
  nand4  g052(.a(new_n80_), .b(new_n67_), .c(new_n100_), .d(new_n91_), .O(new_n104_));
  inv1   g053(.a(new_n104_), .O(new_n105_));
  oai21  g054(.a(new_n105_), .b(new_n103_), .c(x16), .O(new_n106_));
  inv1   g055(.a(x10), .O(new_n107_));
  aoi21  g056(.a(new_n63_), .b(new_n107_), .c(x18), .O(new_n108_));
  aoi21  g057(.a(new_n108_), .b(new_n106_), .c(new_n59_), .O(z05));
  inv1   g058(.a(x25), .O(new_n110_));
  nand3  g059(.a(new_n55_), .b(new_n100_), .c(new_n65_), .O(new_n111_));
  inv1   g060(.a(new_n111_), .O(new_n112_));
  aoi21  g061(.a(new_n112_), .b(new_n102_), .c(new_n110_), .O(new_n113_));
  nor2   g062(.a(x25), .b(x24), .O(new_n114_));
  nand4  g063(.a(new_n114_), .b(new_n95_), .c(new_n72_), .d(new_n55_), .O(new_n115_));
  ...
  nand3  g070(.a(new_n80_), .b(new_n110_), .c(new_n91_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n112_), .c(new_n121_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n133_), .b(new_n80_), .c(new_n91_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n112_), .c(new_n132_), .O(new_n136_));
  nand2  g085(.a(new_n100_), .b(new_n91_), .O(new_n137_));
  nand3  g086(.a(new_n80_), .b(new_n55_), .c(new_n65_), .O(new_n138_));
  nor2   g087(.a(x27), .b(x26), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n110_), .O(new_n140_));
  nor3   g089(.a(new_n140_), .b(new_n138_), .c(new_n137_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n136_), .c(x16), .O(new_n142_));
  nor2   g091(.a(x16), .b(x07), .O(new_n143_));
  nor2   g092(.a(new_n143_), .b(new_n59_), .O(new_n144_));
  nand3  g093(.a(new_n144_), .b(new_n142_), .c(new_n58_), .O(z08));
  inv1   g094(.a(x28), .O(new_n146_));
  oai21  g095(.a(new_n140_), .b(new_n101_), .c(new_n53_), .O(new_n147_));
  aoi21  g096(.a(new_n147_), .b(new_n112_), .c(new_n146_), .O(new_n148_));
  nor2   g097(.a(x28), .b(x27), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n114_), .c(new_n121_), .d(new_n91_), .O(new_n150_));
  ...
  aoi21  g102(.a(new_n63_), .b(new_n153_), .c(x18), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n152_), .c(new_n59_), .O(z09));
  inv1   g104(.a(x29), .O(new_n156_));
  inv1   g105(.a(new_n55_), .O(new_n157_));
  nand3  g106(.a(new_n146_), .b(new_n100_), .c(new_n65_), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n147_), .c(new_n156_), .O(new_n160_));
  nor2   g109(.a(x29), .b(x28), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n125_), .c(new_n132_), .O(new_n162_));
  nor2   g111(.a(new_n162_), .b(new_n96_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n160_), .c(x16), .O(new_n164_));
  inv1   g113(.a(x05), .O(new_n165_));
  aoi21  g114(.a(new_n63_), .b(new_n165_), .c(x18), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n164_), .c(new_n59_), .O(z10));
  inv1   g116(.a(x30), .O(new_n168_));
  nand3  g117(.a(new_n65_), .b(new_n53_), .c(new_n52_), .O(new_n169_));
  nand2  g118(.a(new_n161_), .b(new_n100_), .O(new_n170_));
  nor2   g119(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  aoi21  g120(.a(new_n171_), .b(new_n147_), .c(new_n168_), .O(new_n172_));
  nor2   g121(.a(x30), .b(x29), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n149_), .c(new_n125_), .O(new_n174_));
  ...
  nand3  g127(.a(new_n178_), .b(new_n176_), .c(new_n58_), .O(z11));
  inv1   g128(.a(x31), .O(new_n180_));
  nand3  g129(.a(new_n133_), .b(new_n168_), .c(new_n132_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n101_), .c(new_n53_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n171_), .c(new_n180_), .O(new_n183_));
  nor2   g132(.a(x31), .b(x30), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n161_), .c(new_n139_), .d(new_n110_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n104_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n183_), .c(x16), .O(new_n187_));
  inv1   g136(.a(x03), .O(new_n188_));
  aoi21  g137(.a(new_n63_), .b(new_n188_), .c(x18), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n187_), .c(new_n59_), .O(z12));
  inv1   g139(.a(x32), .O(new_n191_));
  nand4  g140(.a(new_n180_), .b(new_n156_), .c(new_n146_), .d(new_n100_), .O(new_n192_));
  nor2   g141(.a(new_n192_), .b(new_n169_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n182_), .c(new_n191_), .O(new_n194_));
  nor2   g143(.a(x32), .b(x31), .O(new_n195_));
  nand4  g144(.a(new_n195_), .b(new_n173_), .c(new_n149_), .d(new_n133_), .O(new_n196_));
  nor2   g145(.a(new_n196_), .b(new_n104_), .O(new_n197_));
  ...
  nand3  g149(.a(new_n200_), .b(new_n198_), .c(new_n58_), .O(z13));
  inv1   g150(.a(x33), .O(new_n202_));
  nand3  g151(.a(new_n139_), .b(new_n191_), .c(new_n168_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n122_), .c(new_n53_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n193_), .c(new_n202_), .O(new_n205_));
  nor2   g154(.a(x33), .b(x32), .O(new_n206_));
  nand4  g155(.a(new_n206_), .b(new_n184_), .c(new_n161_), .d(new_n139_), .O(new_n207_));
  ...
  nor2   g159(.a(new_n210_), .b(new_n59_), .O(new_n211_));
  nand3  g160(.a(new_n211_), .b(new_n209_), .c(new_n58_), .O(z14));
  inv1   g161(.a(x34), .O(new_n213_));
  nand3  g162(.a(new_n206_), .b(new_n139_), .c(new_n168_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(new_n122_), .c(new_n53_), .O(new_n215_));
  aoi21  g164(.a(new_n215_), .b(new_n193_), .c(new_n213_), .O(new_n216_));
  nor3   g165(.a(x34), .b(x33), .c(x32), .O(new_n217_));
  nand4  g166(.a(new_n217_), .b(new_n184_), .c(new_n161_), .d(new_n139_), .O(new_n218_));
  nor2   g167(.a(new_n218_), .b(new_n115_), .O(new_n219_));
  oai21  g168(.a(new_n219_), .b(new_n216_), .c(x16), .O(new_n220_));
  inv1   g169(.a(x00), .O(new_n221_));
  aoi21  g170(.a(new_n63_), .b(new_n221_), .c(x18), .O(new_n222_));
  aoi21  g171(.a(new_n222_), .b(new_n220_), .c(new_n59_), .O(z15));
endmodule
