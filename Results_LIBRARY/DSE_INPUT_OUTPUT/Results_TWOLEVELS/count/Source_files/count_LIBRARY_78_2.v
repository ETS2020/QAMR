...
module FAU ( 
  ...
  oai21  g002(.a(new_n53_), .b(x07), .c(new_n52_), .O(new_n54_));
  ...
  oai21  g080(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n132_));
  ...
  nand3  g086(.a(new_n81_), .b(new_n58_), .c(new_n63_), .O(new_n138_));
  ...
  aoi21  g091(.a(x18), .b(x15), .c(new_n68_), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n142_), .c(new_n132_), .O(z08));
  inv1   g093(.a(x28), .O(new_n145_));
  nand2  g094(.a(new_n139_), .b(new_n114_), .O(new_n146_));
  ...
  nor3   g100(.a(new_n151_), .b(new_n138_), .c(new_n149_), .O(new_n152_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n134_), .c(new_n103_), .d(new_n81_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n56_), .c(new_n65_), .O(new_n159_));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n125_), .c(new_n133_), .O(new_n161_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n134_), .c(new_n133_), .O(new_n168_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n139_), .c(new_n145_), .O(new_n179_));
  ...
  nand4  g131(.a(new_n182_), .b(new_n160_), .c(new_n139_), .d(new_n110_), .O(new_n183_));
  ...
  nor2   g135(.a(new_n186_), .b(new_n68_), .O(new_n187_));
  ...
  nand4  g142(.a(new_n193_), .b(new_n171_), .c(new_n150_), .d(new_n134_), .O(new_n194_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n160_), .c(new_n167_), .d(new_n133_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n135_), .c(new_n56_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n66_), .c(new_n200_), .O(new_n203_));
  nand2  g152(.a(new_n160_), .b(new_n139_), .O(new_n204_));
  ...
  nor2   g158(.a(new_n209_), .b(new_n68_), .O(new_n210_));
  nand3  g159(.a(new_n210_), .b(new_n208_), .c(new_n61_), .O(z14));
  inv1   g160(.a(x34), .O(new_n212_));
  nand4  g161(.a(new_n205_), .b(new_n182_), .c(new_n160_), .d(new_n133_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n135_), .c(new_n56_), .O(new_n214_));
