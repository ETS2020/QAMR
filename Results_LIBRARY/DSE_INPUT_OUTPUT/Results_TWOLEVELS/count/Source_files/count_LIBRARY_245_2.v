...
module FAU ( 
  ...
  oai21  g037(.a(new_n69_), .b(x10), .c(new_n88_), .O(new_n89_));
  nand2  g038(.a(new_n82_), .b(x23), .O(new_n90_));
  ...
  nand3  g044(.a(new_n95_), .b(new_n89_), .c(new_n58_), .O(z04));
  oai21  g045(.a(x18), .b(new_n69_), .c(new_n57_), .O(new_n97_));
  ...
  nand4  g051(.a(new_n102_), .b(new_n81_), .c(new_n91_), .d(new_n52_), .O(new_n103_));
  oai21  g052(.a(new_n101_), .b(new_n98_), .c(new_n103_), .O(new_n104_));
  nand2  g053(.a(new_n104_), .b(x16), .O(new_n105_));
  aoi21  g054(.a(x18), .b(x11), .c(new_n59_), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n105_), .c(new_n97_), .O(z05));
  nand2  g056(.a(new_n103_), .b(x25), .O(new_n108_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n92_), .c(new_n80_), .O(new_n119_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n102_), .c(new_n126_), .d(new_n55_), .O(new_n128_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n110_), .c(new_n135_), .d(new_n99_), .O(new_n137_));
  ...
  nand3  g094(.a(new_n145_), .b(new_n118_), .c(new_n101_), .O(new_n146_));
  ...
  nand3  g108(.a(new_n159_), .b(new_n118_), .c(new_n101_), .O(new_n160_));
  ...
  nand4  g114(.a(new_n157_), .b(new_n136_), .c(new_n153_), .d(new_n98_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n93_), .c(x31), .O(new_n167_));
  nand2  g116(.a(new_n102_), .b(new_n81_), .O(new_n168_));
  ...
  oai21  g143(.a(new_n194_), .b(new_n103_), .c(x33), .O(new_n195_));
  ...
  nand4  g152(.a(new_n179_), .b(new_n98_), .c(new_n99_), .d(new_n79_), .O(new_n204_));
