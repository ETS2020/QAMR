...
module FAU ( 
  ...
  aoi21  g068(.a(new_n119_), .b(new_n117_), .c(new_n61_), .O(z06));
  ...
  nand3  g079(.a(new_n130_), .b(new_n128_), .c(new_n64_), .O(z07));
  ...
  aoi21  g085(.a(new_n136_), .b(new_n68_), .c(new_n133_), .O(new_n137_));
  nand3  g086(.a(new_n82_), .b(new_n58_), .c(new_n65_), .O(new_n138_));
  ...
  aoi21  g091(.a(x18), .b(new_n52_), .c(new_n61_), .O(new_n143_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n134_), .c(new_n103_), .d(new_n82_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n56_), .c(new_n67_), .O(new_n159_));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n125_), .c(new_n95_), .d(new_n133_), .O(new_n161_));
  ...
  aoi21  g125(.a(new_n176_), .b(new_n174_), .c(new_n61_), .O(z11));
  ...
  nand3  g136(.a(new_n187_), .b(new_n185_), .c(new_n64_), .O(z12));
  ...
  aoi21  g147(.a(new_n198_), .b(new_n196_), .c(new_n61_), .O(z13));
  ...
  aoi21  g151(.a(new_n202_), .b(new_n68_), .c(new_n200_), .O(new_n203_));
  ...
  aoi21  g159(.a(new_n210_), .b(new_n208_), .c(new_n61_), .O(z14));
  ...
  aoi21  g169(.a(new_n220_), .b(new_n218_), .c(new_n61_), .O(z15));
endmodule
