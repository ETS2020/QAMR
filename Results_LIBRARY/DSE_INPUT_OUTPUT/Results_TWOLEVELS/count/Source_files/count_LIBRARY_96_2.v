...
module FAU ( 
  ...
  oai21  g006(.a(x06), .b(new_n57_), .c(x18), .O(new_n58_));
  nor2   g007(.a(x06), .b(new_n57_), .O(new_n59_));
  ...
  aoi21  g026(.a(new_n77_), .b(new_n74_), .c(new_n59_), .O(z02));
  ...
  aoi21  g034(.a(new_n76_), .b(new_n85_), .c(x18), .O(new_n86_));
  ...
  nand3  g069(.a(new_n113_), .b(new_n80_), .c(new_n88_), .O(new_n121_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n129_), .c(new_n58_), .O(z07));
  inv1   g081(.a(x27), .O(new_n133_));
  oai21  g082(.a(new_n125_), .b(new_n99_), .c(new_n53_), .O(new_n134_));
  aoi21  g083(.a(new_n134_), .b(new_n66_), .c(new_n133_), .O(new_n135_));
  nor3   g084(.a(x22), .b(x21), .c(x20), .O(new_n136_));
  ...
  nand4  g094(.a(new_n138_), .b(new_n113_), .c(new_n91_), .d(new_n71_), .O(new_n146_));
  aoi21  g095(.a(new_n146_), .b(new_n53_), .c(new_n65_), .O(new_n147_));
  nor3   g096(.a(x25), .b(x24), .c(x23), .O(new_n148_));
  nor3   g097(.a(x28), .b(x27), .c(x26), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n136_), .c(new_n148_), .d(new_n55_), .O(new_n150_));
  ...
  nand3  g102(.a(new_n76_), .b(new_n153_), .c(new_n57_), .O(new_n154_));
  oai21  g103(.a(new_n152_), .b(new_n59_), .c(new_n154_), .O(z09));
  inv1   g104(.a(x29), .O(new_n156_));
  nand2  g105(.a(new_n146_), .b(new_n53_), .O(new_n157_));
  nand3  g106(.a(new_n55_), .b(new_n145_), .c(new_n63_), .O(new_n158_));
  inv1   g107(.a(new_n158_), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n156_), .O(new_n160_));
  ...
  oai21  g116(.a(x18), .b(new_n76_), .c(new_n57_), .O(new_n168_));
  inv1   g117(.a(x30), .O(new_n169_));
  inv1   g118(.a(new_n55_), .O(new_n170_));
  nand2  g119(.a(new_n161_), .b(new_n63_), .O(new_n171_));
  nor2   g120(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  aoi21  g121(.a(new_n172_), .b(new_n157_), .c(new_n169_), .O(new_n173_));
  nor2   g122(.a(x28), .b(x27), .O(new_n174_));
  nor2   g123(.a(x30), .b(x29), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n174_), .c(new_n126_), .O(new_n176_));
  nor2   g125(.a(new_n176_), .b(new_n92_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n173_), .c(x16), .O(new_n178_));
  aoi21  g127(.a(x18), .b(x06), .c(new_n59_), .O(new_n179_));
  nand3  g128(.a(new_n179_), .b(new_n178_), .c(new_n168_), .O(z11));
  inv1   g129(.a(x31), .O(new_n181_));
  nand3  g130(.a(new_n124_), .b(new_n169_), .c(new_n133_), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(new_n110_), .c(new_n53_), .O(new_n183_));
  aoi21  g132(.a(new_n183_), .b(new_n172_), .c(new_n181_), .O(new_n184_));
  nor2   g133(.a(x31), .b(x30), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n161_), .c(new_n138_), .d(new_n109_), .O(new_n186_));
  ...
  aoi21  g139(.a(new_n190_), .b(new_n188_), .c(new_n59_), .O(z12));
  inv1   g140(.a(x32), .O(new_n192_));
  nand3  g141(.a(new_n181_), .b(new_n156_), .c(new_n145_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n65_), .O(new_n194_));
  aoi21  g143(.a(new_n194_), .b(new_n183_), .c(new_n192_), .O(new_n195_));
  nor2   g144(.a(x32), .b(x31), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n175_), .c(new_n174_), .d(new_n124_), .O(new_n197_));
  nor2   g146(.a(new_n197_), .b(new_n103_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n195_), .c(x16), .O(new_n199_));
  nor2   g148(.a(x16), .b(x02), .O(new_n200_));
  nor2   g149(.a(new_n200_), .b(new_n59_), .O(new_n201_));
  nand3  g150(.a(new_n201_), .b(new_n199_), .c(new_n58_), .O(z13));
  inv1   g151(.a(x33), .O(new_n203_));
  nand4  g152(.a(new_n124_), .b(new_n192_), .c(new_n169_), .d(new_n133_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n110_), .c(new_n53_), .O(new_n205_));
  aoi21  g154(.a(new_n205_), .b(new_n194_), .c(new_n203_), .O(new_n206_));
  inv1   g155(.a(new_n115_), .O(new_n207_));
  nor2   g156(.a(x33), .b(x32), .O(new_n208_));
  nand4  g157(.a(new_n208_), .b(new_n185_), .c(new_n161_), .d(new_n138_), .O(new_n209_));
  ...
  nor2   g161(.a(new_n212_), .b(new_n59_), .O(new_n213_));
  nand3  g162(.a(new_n213_), .b(new_n211_), .c(new_n58_), .O(z14));
  inv1   g163(.a(x34), .O(new_n215_));
  nand3  g164(.a(new_n208_), .b(new_n138_), .c(new_n169_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n121_), .c(new_n53_), .O(new_n217_));
  aoi21  g166(.a(new_n217_), .b(new_n194_), .c(new_n215_), .O(new_n218_));
  nor3   g167(.a(x34), .b(x33), .c(x32), .O(new_n219_));
  nand4  g168(.a(new_n219_), .b(new_n185_), .c(new_n161_), .d(new_n138_), .O(new_n220_));
  nor2   g169(.a(new_n220_), .b(new_n207_), .O(new_n221_));
