...
module FAU ( 
  ...
  nand2  g26(.a(new_n55_), .b(new_n77_), .O(new_n78_));
  ...
  nand2  g32(.a(new_n83_), .b(new_n80_), .O(z06));
  ...
  nor2   g57(.a(x16), .b(x02), .O(new_n109_));
  and2   g58(.a(x32), .b(x16), .O(new_n110_));
  oai21  g59(.a(new_n110_), .b(new_n109_), .c(x20), .O(new_n111_));
  nand2  g60(.a(new_n111_), .b(new_n80_), .O(z13));
  nor2   g61(.a(x16), .b(x01), .O(new_n113_));
  and2   g62(.a(x33), .b(x16), .O(new_n114_));
  oai21  g63(.a(new_n114_), .b(new_n113_), .c(x20), .O(new_n115_));
  nand2  g64(.a(new_n115_), .b(new_n80_), .O(z14));
