...
module FAU ( 
  ...
  oai21  g012(.a(new_n60_), .b(x03), .c(new_n63_), .O(new_n64_));
  ...
  nand3  g031(.a(new_n82_), .b(new_n57_), .c(new_n66_), .O(new_n83_));
  ...
  nand4  g040(.a(new_n91_), .b(new_n90_), .c(new_n72_), .d(new_n54_), .O(new_n92_));
  ...
  nand3  g045(.a(new_n96_), .b(new_n94_), .c(new_n65_), .O(z04));
  inv1   g046(.a(x24), .O(new_n98_));
  inv1   g047(.a(x23), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n80_), .c(new_n72_), .O(new_n100_));
  nor2   g049(.a(new_n100_), .b(new_n68_), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n82_), .c(new_n90_), .d(new_n54_), .O(new_n103_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n91_), .c(new_n98_), .O(new_n119_));
  ...
  aoi21  g072(.a(new_n123_), .b(new_n121_), .c(new_n53_), .O(z07));
  oai21  g073(.a(new_n119_), .b(new_n74_), .c(x27), .O(new_n125_));
  nor3   g074(.a(x22), .b(x21), .c(x20), .O(new_n126_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n102_), .c(new_n126_), .d(new_n57_), .O(new_n128_));
  ...
  nand4  g085(.a(new_n136_), .b(new_n135_), .c(new_n126_), .d(new_n57_), .O(new_n137_));
  ...
  nand3  g090(.a(new_n141_), .b(new_n139_), .c(new_n65_), .O(z09));
  inv1   g091(.a(x26), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n110_), .c(new_n143_), .d(new_n99_), .O(new_n145_));
  oai21  g094(.a(new_n145_), .b(new_n83_), .c(x29), .O(new_n146_));
  nor3   g095(.a(x26), .b(x25), .c(x24), .O(new_n147_));
  nor3   g096(.a(x29), .b(x28), .c(x27), .O(new_n148_));
  nand3  g097(.a(new_n148_), .b(new_n147_), .c(new_n101_), .O(new_n149_));
  ...
  aoi21  g102(.a(new_n153_), .b(new_n151_), .c(new_n53_), .O(z10));
  inv1   g103(.a(x27), .O(new_n155_));
  nor2   g104(.a(x29), .b(x28), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n118_), .c(new_n155_), .d(new_n98_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n92_), .c(x30), .O(new_n158_));
  nor2   g107(.a(x30), .b(x29), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n144_), .O(new_n160_));
  inv1   g109(.a(new_n160_), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n147_), .c(new_n101_), .O(new_n162_));
  ...
  aoi21  g115(.a(new_n166_), .b(new_n164_), .c(new_n53_), .O(z11));
  oai21  g116(.a(new_n60_), .b(new_n63_), .c(x03), .O(new_n168_));
  nand3  g117(.a(new_n159_), .b(new_n144_), .c(new_n147_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n92_), .c(x31), .O(new_n170_));
  inv1   g119(.a(x25), .O(new_n171_));
  nor2   g120(.a(x27), .b(x26), .O(new_n172_));
  nor2   g121(.a(x31), .b(x30), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n156_), .c(new_n172_), .d(new_n171_), .O(new_n174_));
  or2    g123(.a(new_n174_), .b(new_n103_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(new_n170_), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n168_), .O(new_n177_));
  inv1   g126(.a(x18), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  aoi22  g128(.a(new_n179_), .b(new_n52_), .c(x18), .d(x14), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n177_), .O(z12));
  oai21  g130(.a(new_n174_), .b(new_n103_), .c(x32), .O(new_n182_));
  nand4  g131(.a(new_n98_), .b(new_n99_), .c(new_n80_), .d(new_n72_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  inv1   g133(.a(x28), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n155_), .c(new_n143_), .d(new_n171_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  inv1   g136(.a(x29), .O(new_n188_));
  inv1   g137(.a(x30), .O(new_n189_));
  inv1   g138(.a(x31), .O(new_n190_));
  inv1   g139(.a(x32), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n188_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n187_), .c(new_n184_), .d(new_n69_), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n182_), .O(new_n195_));
  ...
  nand4  g149(.a(new_n200_), .b(new_n159_), .c(new_n144_), .d(new_n118_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n103_), .c(x33), .O(new_n202_));
  nor2   g151(.a(x33), .b(x32), .O(new_n203_));
  nand4  g152(.a(new_n203_), .b(new_n173_), .c(new_n156_), .d(new_n172_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n111_), .c(new_n202_), .O(new_n205_));
  nand2  g154(.a(new_n205_), .b(x16), .O(new_n206_));
  nor2   g155(.a(x16), .b(x01), .O(new_n207_));
  nor2   g156(.a(new_n207_), .b(new_n53_), .O(new_n208_));
  nand3  g157(.a(new_n208_), .b(new_n206_), .c(new_n65_), .O(z14));
  oai21  g158(.a(new_n204_), .b(new_n111_), .c(x34), .O(new_n210_));
  inv1   g159(.a(new_n111_), .O(new_n211_));
  nand2  g160(.a(new_n156_), .b(new_n172_), .O(new_n212_));
  inv1   g161(.a(new_n212_), .O(new_n213_));
  nor3   g162(.a(x34), .b(x33), .c(x32), .O(new_n214_));
  nand4  g163(.a(new_n214_), .b(new_n213_), .c(new_n173_), .d(new_n211_), .O(new_n215_));
