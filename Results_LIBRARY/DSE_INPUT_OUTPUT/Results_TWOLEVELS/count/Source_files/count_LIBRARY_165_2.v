...
module FAU ( 
  ...
  aoi21  g035(.a(x16), .b(x15), .c(new_n60_), .O(new_n87_));
  ...
  aoi22  g043(.a(new_n94_), .b(new_n60_), .c(x18), .d(x15), .O(new_n95_));
  ...
  nand3  g052(.a(new_n103_), .b(new_n101_), .c(new_n61_), .O(z05));
  ...
  nor2   g063(.a(new_n114_), .b(new_n63_), .O(new_n115_));
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(new_n61_), .O(z06));
  inv1   g065(.a(x26), .O(new_n117_));
  inv1   g066(.a(x23), .O(new_n118_));
  nand4  g067(.a(new_n105_), .b(new_n97_), .c(new_n118_), .d(new_n78_), .O(new_n119_));
  ...
  nand3  g084(.a(new_n135_), .b(new_n133_), .c(new_n61_), .O(z08));
  ...
  oai21  g094(.a(new_n139_), .b(new_n81_), .c(x29), .O(new_n146_));
  nor3   g095(.a(x23), .b(x22), .c(x21), .O(new_n147_));
  nor3   g096(.a(x29), .b(x28), .c(x27), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n121_), .c(new_n147_), .d(new_n66_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g100(.a(x05), .O(new_n152_));
  aoi21  g101(.a(new_n53_), .b(new_n152_), .c(x18), .O(new_n153_));
  aoi21  g102(.a(new_n153_), .b(new_n151_), .c(new_n63_), .O(z10));
  nand2  g103(.a(new_n149_), .b(x30), .O(new_n155_));
  nor2   g104(.a(x26), .b(x25), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n138_), .c(new_n156_), .d(new_n97_), .O(new_n158_));
  or2    g107(.a(new_n158_), .b(new_n90_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(x16), .O(new_n161_));
  nor2   g110(.a(x16), .b(x04), .O(new_n162_));
  nor2   g111(.a(new_n162_), .b(new_n63_), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n161_), .c(new_n61_), .O(z11));
  oai21  g113(.a(new_n158_), .b(new_n90_), .c(x31), .O(new_n165_));
  ...
  nand4  g119(.a(new_n170_), .b(new_n130_), .c(new_n166_), .d(new_n66_), .O(new_n171_));
  ...
  nor2   g134(.a(new_n185_), .b(new_n63_), .O(new_n186_));
  nand3  g135(.a(new_n186_), .b(new_n184_), .c(new_n61_), .O(z13));
  ...
  aoi21  g162(.a(new_n53_), .b(new_n213_), .c(x18), .O(new_n214_));
  aoi21  g163(.a(new_n214_), .b(new_n212_), .c(new_n63_), .O(z15));
endmodule
