...
module FAU ( 
  ...
  nand3  g058(.a(new_n109_), .b(new_n107_), .c(new_n58_), .O(z05));
  ...
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n59_), .O(z06));
  aoi21  g070(.a(x16), .b(x12), .c(new_n57_), .O(new_n122_));
  ...
  aoi21  g077(.a(new_n125_), .b(x26), .c(new_n128_), .O(new_n129_));
  inv1   g078(.a(x18), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(x16), .O(new_n131_));
  aoi22  g080(.a(new_n131_), .b(new_n57_), .c(x18), .d(x12), .O(new_n132_));
  oai21  g081(.a(new_n129_), .b(new_n122_), .c(new_n132_), .O(z07));
  ...
  nor3   g103(.a(new_n154_), .b(new_n139_), .c(new_n151_), .O(new_n155_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n156_), .c(new_n58_), .O(z09));
  ...
  nand3  g112(.a(new_n163_), .b(new_n126_), .c(new_n134_), .O(new_n164_));
  ...
  nand3  g130(.a(new_n174_), .b(new_n140_), .c(new_n147_), .O(new_n182_));
  ...
  aoi21  g138(.a(new_n87_), .b(new_n189_), .c(x18), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n188_), .c(new_n59_), .O(z12));
  inv1   g140(.a(x32), .O(new_n192_));
  nand4  g141(.a(new_n185_), .b(new_n153_), .c(new_n160_), .d(new_n152_), .O(new_n193_));
  ...
  nand4  g145(.a(new_n196_), .b(new_n174_), .c(new_n153_), .d(new_n135_), .O(new_n197_));
  ...
  nand4  g164(.a(new_n208_), .b(new_n185_), .c(new_n163_), .d(new_n134_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n136_), .c(new_n53_), .O(new_n217_));
  aoi21  g166(.a(new_n217_), .b(new_n66_), .c(new_n215_), .O(new_n218_));
  nand4  g167(.a(new_n185_), .b(new_n215_), .c(new_n203_), .d(new_n192_), .O(new_n219_));
  nor3   g168(.a(new_n219_), .b(new_n207_), .c(new_n116_), .O(new_n220_));
