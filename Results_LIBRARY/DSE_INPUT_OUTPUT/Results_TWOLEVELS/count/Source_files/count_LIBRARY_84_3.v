...
module FAU ( 
  ...
  aoi21  g052(.a(new_n103_), .b(new_n67_), .c(new_n102_), .O(new_n104_));
  nor2   g053(.a(x24), .b(x23), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n83_), .c(new_n67_), .O(new_n106_));
  ...
  nand2  g061(.a(new_n105_), .b(new_n83_), .O(new_n113_));
  ...
  oai21  g071(.a(new_n80_), .b(x12), .c(x08), .O(new_n123_));
  inv1   g072(.a(x26), .O(new_n124_));
  nand3  g073(.a(new_n116_), .b(new_n83_), .c(new_n92_), .O(new_n125_));
  ...
  oai21  g079(.a(new_n130_), .b(new_n127_), .c(new_n123_), .O(new_n131_));
  aoi22  g080(.a(new_n89_), .b(new_n57_), .c(x18), .d(new_n58_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n131_), .O(z07));
  inv1   g082(.a(x27), .O(new_n134_));
  nor2   g083(.a(x26), .b(x25), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n95_), .c(new_n102_), .d(new_n72_), .O(new_n136_));
  ...
  nand3  g089(.a(new_n140_), .b(new_n105_), .c(new_n112_), .O(new_n141_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n135_), .c(new_n105_), .d(new_n83_), .O(new_n160_));
  aoi21  g109(.a(new_n160_), .b(new_n53_), .c(new_n66_), .O(new_n161_));
  nor2   g110(.a(x29), .b(x28), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n128_), .c(new_n97_), .d(new_n134_), .O(new_n163_));
  ...
  oai21  g130(.a(new_n181_), .b(new_n125_), .c(new_n53_), .O(new_n182_));
  ...
  nor2   g134(.a(new_n185_), .b(new_n106_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n183_), .c(x16), .O(new_n187_));
  inv1   g136(.a(x03), .O(new_n188_));
  aoi21  g137(.a(new_n80_), .b(new_n188_), .c(x18), .O(new_n189_));
  ...
  aoi21  g160(.a(new_n80_), .b(new_n211_), .c(x18), .O(new_n212_));
