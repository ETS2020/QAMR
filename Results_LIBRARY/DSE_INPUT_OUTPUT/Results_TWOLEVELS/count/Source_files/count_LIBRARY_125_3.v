...
module FAU ( 
  ...
  oai21  g020(.a(new_n59_), .b(new_n61_), .c(x18), .O(new_n72_));
  ...
  oai21  g154(.a(x18), .b(new_n56_), .c(new_n61_), .O(new_n206_));
  ...
  aoi21  g161(.a(x18), .b(new_n59_), .c(new_n64_), .O(new_n213_));
  nand3  g162(.a(new_n213_), .b(new_n212_), .c(new_n206_), .O(z15));
endmodule
