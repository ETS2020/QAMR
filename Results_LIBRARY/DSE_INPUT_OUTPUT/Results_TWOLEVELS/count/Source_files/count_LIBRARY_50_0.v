...
module FAU ( 
  ...
  nor2   g009(.a(x15), .b(x08), .O(new_n61_));
  ...
  aoi21  g019(.a(new_n54_), .b(new_n70_), .c(x18), .O(new_n71_));
  aoi21  g020(.a(new_n71_), .b(new_n69_), .c(new_n61_), .O(z01));
  inv1   g021(.a(x21), .O(new_n73_));
  nand4  g022(.a(new_n73_), .b(new_n65_), .c(new_n57_), .d(new_n56_), .O(new_n74_));
  ...
  nand3  g027(.a(new_n78_), .b(new_n76_), .c(new_n63_), .O(z02));
  inv1   g028(.a(x22), .O(new_n80_));
  nor2   g029(.a(x21), .b(x20), .O(new_n81_));
  aoi21  g030(.a(new_n81_), .b(new_n59_), .c(new_n80_), .O(new_n82_));
  nor2   g031(.a(x22), .b(x21), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n59_), .c(new_n65_), .O(new_n84_));
  inv1   g033(.a(new_n84_), .O(new_n85_));
  oai21  g034(.a(new_n85_), .b(new_n82_), .c(x16), .O(new_n86_));
  inv1   g035(.a(x12), .O(new_n87_));
  aoi21  g036(.a(new_n54_), .b(new_n87_), .c(x18), .O(new_n88_));
  ...
  nand4  g041(.a(new_n92_), .b(new_n91_), .c(new_n73_), .d(new_n56_), .O(new_n93_));
  ...
  aoi21  g046(.a(new_n97_), .b(new_n95_), .c(new_n61_), .O(z04));
  inv1   g047(.a(x24), .O(new_n99_));
  nand3  g048(.a(new_n90_), .b(new_n80_), .c(new_n73_), .O(new_n100_));
  nor2   g049(.a(new_n100_), .b(new_n67_), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n83_), .c(new_n91_), .d(new_n56_), .O(new_n103_));
  ...
  nor2   g055(.a(new_n106_), .b(new_n61_), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n105_), .c(new_n63_), .O(z05));
  inv1   g057(.a(x25), .O(new_n109_));
  inv1   g058(.a(new_n103_), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n92_), .c(new_n81_), .d(new_n59_), .O(new_n112_));
  ...
  nor2   g064(.a(new_n115_), .b(new_n61_), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n114_), .c(new_n63_), .O(z06));
  nand2  g066(.a(new_n112_), .b(x26), .O(new_n118_));
  nor3   g067(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n92_), .c(new_n81_), .d(new_n59_), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n54_), .O(new_n121_));
  oai21  g070(.a(new_n121_), .b(x18), .c(new_n62_), .O(new_n122_));
  nand3  g071(.a(new_n54_), .b(x15), .c(new_n52_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n122_), .O(z07));
  nand2  g073(.a(new_n120_), .b(x27), .O(new_n125_));
  nor3   g074(.a(x22), .b(x21), .c(x20), .O(new_n126_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n102_), .c(new_n126_), .d(new_n59_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n125_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(x16), .O(new_n130_));
  inv1   g079(.a(x07), .O(new_n131_));
  aoi21  g080(.a(new_n54_), .b(new_n131_), .c(x18), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n130_), .c(new_n61_), .O(z08));
  and2   g082(.a(new_n128_), .b(x28), .O(new_n134_));
  inv1   g083(.a(x26), .O(new_n135_));
  nor2   g084(.a(x28), .b(x27), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n111_), .c(new_n135_), .d(new_n90_), .O(new_n137_));
  ...
  nand3  g090(.a(new_n141_), .b(new_n139_), .c(new_n63_), .O(z09));
  oai21  g091(.a(new_n137_), .b(new_n84_), .c(x29), .O(new_n143_));
  inv1   g092(.a(x27), .O(new_n144_));
  nor2   g093(.a(x29), .b(x28), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n119_), .c(new_n101_), .d(new_n144_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g097(.a(x05), .O(new_n149_));
  aoi21  g098(.a(new_n54_), .b(new_n149_), .c(x18), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n148_), .c(new_n61_), .O(z10));
  nor2   g100(.a(x26), .b(x25), .O(new_n152_));
  nand4  g101(.a(new_n145_), .b(new_n152_), .c(new_n144_), .d(new_n99_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n93_), .c(x30), .O(new_n154_));
  nor2   g103(.a(x30), .b(x29), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n136_), .c(new_n119_), .d(new_n101_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g106(.a(new_n157_), .b(x16), .O(new_n158_));
  inv1   g107(.a(x04), .O(new_n159_));
  aoi21  g108(.a(new_n54_), .b(new_n159_), .c(x18), .O(new_n160_));
  aoi21  g109(.a(new_n160_), .b(new_n158_), .c(new_n61_), .O(z11));
  nand3  g110(.a(new_n155_), .b(new_n136_), .c(new_n119_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n93_), .c(x31), .O(new_n163_));
  nor2   g112(.a(x27), .b(x26), .O(new_n164_));
  nor2   g113(.a(x31), .b(x30), .O(new_n165_));
  nand4  g114(.a(new_n165_), .b(new_n145_), .c(new_n164_), .d(new_n109_), .O(new_n166_));
  or2    g115(.a(new_n166_), .b(new_n103_), .O(new_n167_));
  ...
  nand3  g120(.a(new_n171_), .b(new_n169_), .c(new_n63_), .O(z12));
  oai21  g121(.a(new_n166_), .b(new_n103_), .c(x32), .O(new_n173_));
  nor2   g122(.a(x32), .b(x31), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n155_), .c(new_n136_), .d(new_n152_), .O(new_n175_));
  inv1   g124(.a(new_n175_), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n110_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  inv1   g128(.a(x02), .O(new_n180_));
  aoi21  g129(.a(new_n54_), .b(new_n180_), .c(x18), .O(new_n181_));
  aoi21  g130(.a(new_n181_), .b(new_n179_), .c(new_n61_), .O(z13));
  oai21  g131(.a(new_n175_), .b(new_n103_), .c(x33), .O(new_n183_));
  nand4  g132(.a(new_n109_), .b(new_n99_), .c(new_n90_), .d(new_n80_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n74_), .O(new_n185_));
  nor2   g134(.a(x33), .b(x32), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n165_), .c(new_n145_), .d(new_n164_), .O(new_n187_));
  ...
  aoi21  g141(.a(new_n54_), .b(new_n192_), .c(x18), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n191_), .c(new_n61_), .O(z14));
  oai21  g143(.a(new_n187_), .b(new_n112_), .c(x34), .O(new_n195_));
  nand2  g144(.a(new_n145_), .b(new_n164_), .O(new_n196_));
  ...
  aoi21  g159(.a(new_n210_), .b(new_n208_), .c(new_n61_), .O(z15));
endmodule
