...
module FAU ( 
  ...
  nor2   g008(.a(x15), .b(x12), .O(new_n60_));
  inv1   g009(.a(new_n60_), .O(new_n61_));
  nand2  g010(.a(new_n61_), .b(x18), .O(new_n62_));
  and2   g011(.a(new_n62_), .b(new_n59_), .O(new_n63_));
  oai21  g012(.a(new_n54_), .b(x15), .c(new_n63_), .O(z00));
  ...
  nand3  g020(.a(new_n71_), .b(new_n69_), .c(new_n62_), .O(z01));
  ...
  nand3  g028(.a(new_n79_), .b(new_n77_), .c(new_n62_), .O(z02));
  ...
  oai21  g033(.a(new_n84_), .b(x18), .c(new_n61_), .O(new_n85_));
  nand2  g034(.a(new_n53_), .b(new_n52_), .O(new_n86_));
  nand2  g035(.a(x22), .b(x21), .O(new_n87_));
  oai21  g036(.a(new_n87_), .b(new_n53_), .c(new_n86_), .O(new_n88_));
  nor2   g037(.a(new_n87_), .b(x19), .O(new_n89_));
  aoi22  g038(.a(new_n89_), .b(new_n54_), .c(new_n88_), .d(x15), .O(new_n90_));
  nand2  g039(.a(new_n90_), .b(new_n85_), .O(z03));
  inv1   g040(.a(x23), .O(new_n92_));
  oai21  g041(.a(x22), .b(x21), .c(new_n56_), .O(new_n93_));
  aoi21  g042(.a(new_n93_), .b(new_n68_), .c(new_n92_), .O(new_n94_));
  nor2   g043(.a(x23), .b(x22), .O(new_n95_));
  nand3  g044(.a(new_n95_), .b(new_n68_), .c(new_n73_), .O(new_n96_));
  ...
  nand2  g051(.a(new_n95_), .b(new_n73_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n56_), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n68_), .c(new_n102_), .O(new_n105_));
  nor2   g054(.a(x24), .b(x23), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n82_), .c(new_n68_), .O(new_n107_));
  ...
  aoi21  g060(.a(new_n111_), .b(new_n109_), .c(new_n60_), .O(z05));
  inv1   g061(.a(x25), .O(new_n113_));
  nand2  g062(.a(new_n106_), .b(new_n82_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(new_n56_), .O(new_n115_));
  aoi21  g064(.a(new_n115_), .b(new_n68_), .c(new_n113_), .O(new_n116_));
  nor2   g065(.a(x25), .b(x24), .O(new_n117_));
  nand4  g066(.a(new_n117_), .b(new_n95_), .c(new_n74_), .d(new_n58_), .O(new_n118_));
  inv1   g067(.a(new_n118_), .O(new_n119_));
  oai21  g068(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  inv1   g069(.a(x09), .O(new_n121_));
  aoi21  g070(.a(new_n53_), .b(new_n121_), .c(x18), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n120_), .c(new_n60_), .O(z06));
  inv1   g072(.a(x26), .O(new_n124_));
  nand3  g073(.a(new_n117_), .b(new_n82_), .c(new_n92_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n56_), .O(new_n126_));
  aoi21  g075(.a(new_n126_), .b(new_n68_), .c(new_n124_), .O(new_n127_));
  nor3   g076(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n95_), .O(new_n129_));
  nor2   g078(.a(new_n129_), .b(new_n75_), .O(new_n130_));
  oai21  g079(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  inv1   g080(.a(x08), .O(new_n132_));
  aoi21  g081(.a(new_n53_), .b(new_n132_), .c(x18), .O(new_n133_));
  aoi21  g082(.a(new_n133_), .b(new_n131_), .c(new_n60_), .O(z07));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x26), .b(x25), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n95_), .c(new_n102_), .d(new_n73_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n56_), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n68_), .c(new_n135_), .O(new_n139_));
  nor2   g088(.a(x27), .b(x26), .O(new_n140_));
  nand3  g089(.a(new_n140_), .b(new_n106_), .c(new_n113_), .O(new_n141_));
  ...
  nor2   g093(.a(new_n144_), .b(new_n60_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n143_), .c(new_n62_), .O(z08));
  inv1   g095(.a(x28), .O(new_n147_));
  nand2  g096(.a(new_n140_), .b(new_n117_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n103_), .c(new_n56_), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n68_), .c(new_n147_), .O(new_n150_));
  nand2  g099(.a(new_n117_), .b(new_n92_), .O(new_n151_));
  nor2   g100(.a(x28), .b(x27), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n124_), .O(new_n153_));
  nor3   g102(.a(new_n153_), .b(new_n151_), .c(new_n83_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n150_), .c(x16), .O(new_n155_));
  inv1   g104(.a(x06), .O(new_n156_));
  aoi21  g105(.a(new_n53_), .b(new_n156_), .c(x18), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n155_), .c(new_n60_), .O(z09));
  inv1   g107(.a(x29), .O(new_n159_));
  nand4  g108(.a(new_n152_), .b(new_n136_), .c(new_n106_), .d(new_n82_), .O(new_n160_));
  ...
  oai22  g112(.a(new_n163_), .b(new_n96_), .c(new_n161_), .d(new_n159_), .O(new_n164_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n136_), .c(new_n135_), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n114_), .c(new_n56_), .O(new_n171_));
  ...
  nand3  g127(.a(new_n178_), .b(new_n176_), .c(new_n62_), .O(z11));
  inv1   g128(.a(x31), .O(new_n180_));
  nand3  g129(.a(new_n173_), .b(new_n140_), .c(new_n147_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n125_), .c(new_n56_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n68_), .c(new_n180_), .O(new_n183_));
  nor2   g132(.a(x31), .b(x30), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n162_), .c(new_n140_), .d(new_n113_), .O(new_n185_));
  nor2   g134(.a(new_n185_), .b(new_n107_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n183_), .c(x16), .O(new_n187_));
  inv1   g136(.a(x03), .O(new_n188_));
  aoi21  g137(.a(new_n53_), .b(new_n188_), .c(x18), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n187_), .c(new_n60_), .O(z12));
  inv1   g139(.a(x32), .O(new_n191_));
  nand4  g140(.a(new_n184_), .b(new_n152_), .c(new_n159_), .d(new_n124_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n125_), .c(new_n56_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n68_), .c(new_n191_), .O(new_n194_));
  nor2   g143(.a(x32), .b(x31), .O(new_n195_));
  nand4  g144(.a(new_n195_), .b(new_n173_), .c(new_n152_), .d(new_n136_), .O(new_n196_));
  nor2   g145(.a(new_n196_), .b(new_n107_), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n194_), .c(x16), .O(new_n198_));
  inv1   g147(.a(x02), .O(new_n199_));
  aoi21  g148(.a(new_n53_), .b(new_n199_), .c(x18), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n198_), .c(new_n60_), .O(z13));
  inv1   g150(.a(x33), .O(new_n202_));
  nand4  g151(.a(new_n195_), .b(new_n162_), .c(new_n169_), .d(new_n135_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n137_), .c(new_n56_), .O(new_n204_));
  ...
  nor3   g157(.a(new_n208_), .b(new_n206_), .c(new_n118_), .O(new_n209_));
  ...
  nand3  g161(.a(new_n212_), .b(new_n210_), .c(new_n62_), .O(z14));
  inv1   g162(.a(x34), .O(new_n214_));
  nand4  g163(.a(new_n207_), .b(new_n184_), .c(new_n162_), .d(new_n135_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n137_), .c(new_n56_), .O(new_n216_));
  ...
  nor3   g167(.a(new_n218_), .b(new_n206_), .c(new_n118_), .O(new_n219_));
  oai21  g168(.a(new_n219_), .b(new_n217_), .c(x16), .O(new_n220_));
  nor2   g169(.a(x16), .b(x00), .O(new_n221_));
  nor2   g170(.a(new_n221_), .b(new_n60_), .O(new_n222_));
  nand3  g171(.a(new_n222_), .b(new_n220_), .c(new_n62_), .O(z15));
endmodule
