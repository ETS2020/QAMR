...
module FAU ( 
  ...
  nand3  g027(.a(new_n63_), .b(new_n55_), .c(new_n54_), .O(new_n79_));
  ...
  aoi21  g031(.a(new_n82_), .b(new_n80_), .c(new_n60_), .O(new_n83_));
  oai21  g032(.a(new_n83_), .b(x18), .c(new_n78_), .O(new_n84_));
  inv1   g033(.a(x12), .O(new_n85_));
  nand2  g034(.a(new_n60_), .b(new_n85_), .O(new_n86_));
  nand2  g035(.a(x22), .b(x21), .O(new_n87_));
  oai21  g036(.a(new_n87_), .b(new_n60_), .c(new_n86_), .O(new_n88_));
  nor2   g037(.a(new_n60_), .b(new_n85_), .O(new_n89_));
  nor2   g038(.a(new_n87_), .b(x19), .O(new_n90_));
  aoi22  g039(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(new_n52_), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(new_n84_), .O(z03));
  inv1   g041(.a(x23), .O(new_n93_));
  oai21  g042(.a(x22), .b(x21), .c(new_n55_), .O(new_n94_));
  ...
  aoi21  g050(.a(new_n101_), .b(new_n99_), .c(new_n53_), .O(z04));
  oai21  g051(.a(x18), .b(new_n60_), .c(new_n52_), .O(new_n103_));
  inv1   g052(.a(x24), .O(new_n104_));
  nor2   g053(.a(x24), .b(x23), .O(new_n105_));
  nand3  g054(.a(new_n105_), .b(new_n81_), .c(new_n65_), .O(new_n106_));
  oai21  g055(.a(new_n98_), .b(new_n104_), .c(new_n106_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(x16), .O(new_n108_));
  aoi21  g057(.a(x18), .b(x12), .c(new_n53_), .O(new_n109_));
  nand3  g058(.a(new_n109_), .b(new_n108_), .c(new_n103_), .O(z05));
  nand2  g059(.a(new_n78_), .b(x18), .O(new_n111_));
  nand2  g060(.a(new_n106_), .b(x25), .O(new_n112_));
  nor2   g061(.a(x25), .b(x24), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n96_), .c(new_n71_), .d(new_n57_), .O(new_n114_));
  ...
  nand3  g067(.a(new_n118_), .b(new_n116_), .c(new_n111_), .O(z06));
  inv1   g068(.a(x26), .O(new_n120_));
  nand3  g069(.a(new_n113_), .b(new_n81_), .c(new_n93_), .O(new_n121_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n124_), .c(new_n98_), .O(new_n153_));
  ...
  nand3  g106(.a(new_n157_), .b(new_n155_), .c(new_n111_), .O(z10));
  nand2  g107(.a(new_n153_), .b(x30), .O(new_n159_));
  nand3  g108(.a(new_n96_), .b(new_n65_), .c(new_n70_), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n144_), .c(new_n124_), .O(new_n162_));
  ...
  nand3  g116(.a(new_n167_), .b(new_n165_), .c(new_n111_), .O(z11));
  ...
  oai21  g121(.a(new_n172_), .b(new_n106_), .c(new_n169_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(x16), .O(new_n174_));
  nor2   g123(.a(x16), .b(x03), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(new_n53_), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n174_), .c(new_n111_), .O(z12));
  inv1   g126(.a(x32), .O(new_n178_));
  nand4  g127(.a(new_n171_), .b(new_n144_), .c(new_n151_), .d(new_n120_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n121_), .c(new_n55_), .O(new_n180_));
  ...
  nor2   g133(.a(new_n184_), .b(new_n106_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n181_), .c(x16), .O(new_n186_));
  inv1   g135(.a(x02), .O(new_n187_));
  aoi21  g136(.a(new_n60_), .b(new_n187_), .c(x18), .O(new_n188_));
  aoi21  g137(.a(new_n188_), .b(new_n186_), .c(new_n53_), .O(z13));
  inv1   g138(.a(x33), .O(new_n190_));
  nand4  g139(.a(new_n182_), .b(new_n96_), .c(new_n104_), .d(new_n70_), .O(new_n191_));
  inv1   g140(.a(x30), .O(new_n192_));
  nand4  g141(.a(new_n183_), .b(new_n170_), .c(new_n192_), .d(new_n131_), .O(new_n193_));
  ...
  nor3   g147(.a(new_n198_), .b(new_n196_), .c(new_n114_), .O(new_n199_));
  ...
  aoi21  g151(.a(new_n202_), .b(new_n200_), .c(new_n53_), .O(z14));
  inv1   g152(.a(x34), .O(new_n204_));
  nand4  g153(.a(new_n197_), .b(new_n171_), .c(new_n170_), .d(new_n131_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n191_), .c(new_n55_), .O(new_n206_));
  ...
  nor3   g157(.a(new_n208_), .b(new_n196_), .c(new_n114_), .O(new_n209_));
