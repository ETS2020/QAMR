...
module FAU ( 
  ...
  nand3  g045(.a(new_n63_), .b(new_n54_), .c(new_n53_), .O(new_n97_));
  nand3  g046(.a(new_n90_), .b(new_n78_), .c(new_n70_), .O(new_n98_));
  nor2   g047(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nor2   g048(.a(x24), .b(x23), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n80_), .c(new_n65_), .O(new_n101_));
  ...
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n62_), .O(z05));
  inv1   g055(.a(x25), .O(new_n107_));
  nand2  g056(.a(new_n100_), .b(new_n80_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n54_), .O(new_n109_));
  aoi21  g058(.a(new_n109_), .b(new_n65_), .c(new_n107_), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n91_), .c(new_n71_), .d(new_n56_), .O(new_n112_));
  ...
  nand3  g067(.a(new_n56_), .b(new_n107_), .c(new_n63_), .O(new_n119_));
  ...
  aoi21  g075(.a(new_n59_), .b(new_n126_), .c(x18), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n125_), .c(new_n52_), .O(z07));
  inv1   g077(.a(x27), .O(new_n129_));
  nand2  g078(.a(new_n54_), .b(new_n53_), .O(new_n130_));
  nand3  g079(.a(new_n118_), .b(new_n107_), .c(new_n63_), .O(new_n131_));
  ...
  aoi21  g088(.a(new_n139_), .b(new_n137_), .c(new_n52_), .O(z08));
  oai21  g089(.a(new_n59_), .b(new_n88_), .c(new_n87_), .O(new_n141_));
  ...
  nand4  g093(.a(new_n144_), .b(new_n111_), .c(new_n82_), .d(new_n90_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n141_), .c(new_n62_), .O(z09));
  inv1   g097(.a(x29), .O(new_n149_));
  nor2   g098(.a(x28), .b(x24), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n80_), .c(new_n90_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(new_n54_), .O(new_n152_));
  nand3  g101(.a(new_n129_), .b(new_n118_), .c(new_n107_), .O(new_n153_));
  nor2   g102(.a(new_n153_), .b(new_n97_), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n152_), .c(new_n149_), .O(new_n155_));
  nor2   g104(.a(x29), .b(x28), .O(new_n156_));
  nand3  g105(.a(new_n156_), .b(new_n122_), .c(new_n129_), .O(new_n157_));
  ...
  aoi21  g110(.a(new_n161_), .b(new_n159_), .c(new_n52_), .O(z10));
  nor2   g111(.a(x26), .b(x25), .O(new_n163_));
  nor2   g112(.a(x29), .b(x27), .O(new_n164_));
  aoi21  g113(.a(new_n164_), .b(new_n163_), .c(x19), .O(new_n165_));
  nand4  g114(.a(new_n150_), .b(new_n91_), .c(new_n71_), .d(new_n56_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n165_), .c(x30), .O(new_n167_));
  nor2   g116(.a(x28), .b(x27), .O(new_n168_));
  nor2   g117(.a(x30), .b(x29), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n168_), .c(new_n122_), .d(new_n99_), .O(new_n170_));
  ...
  nand3  g123(.a(new_n174_), .b(new_n172_), .c(new_n62_), .O(z11));
  inv1   g124(.a(x31), .O(new_n176_));
  inv1   g125(.a(x28), .O(new_n177_));
  inv1   g126(.a(x30), .O(new_n178_));
  nand3  g127(.a(new_n178_), .b(new_n177_), .c(new_n96_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n98_), .c(new_n54_), .O(new_n180_));
  nand4  g129(.a(new_n149_), .b(new_n129_), .c(new_n118_), .d(new_n107_), .O(new_n181_));
  nor2   g130(.a(new_n181_), .b(new_n97_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n180_), .c(new_n176_), .O(new_n183_));
  nor2   g132(.a(x31), .b(x30), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n156_), .c(new_n134_), .O(new_n185_));
  ...
  aoi21  g137(.a(new_n59_), .b(new_n188_), .c(x18), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n187_), .c(new_n52_), .O(z12));
  inv1   g139(.a(x32), .O(new_n191_));
  nand4  g140(.a(new_n163_), .b(new_n176_), .c(new_n149_), .d(new_n129_), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(new_n54_), .O(new_n193_));
  nand4  g142(.a(new_n91_), .b(new_n178_), .c(new_n177_), .d(new_n96_), .O(new_n194_));
  nor2   g143(.a(new_n194_), .b(new_n72_), .O(new_n195_));
  aoi21  g144(.a(new_n195_), .b(new_n193_), .c(new_n191_), .O(new_n196_));
  nor2   g145(.a(x32), .b(x31), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n169_), .c(new_n168_), .d(new_n163_), .O(new_n198_));
  nor2   g147(.a(new_n198_), .b(new_n101_), .O(new_n199_));
  ...
  nand3  g151(.a(new_n202_), .b(new_n200_), .c(new_n62_), .O(z13));
  inv1   g152(.a(x33), .O(new_n204_));
  nand4  g153(.a(new_n100_), .b(new_n191_), .c(new_n178_), .d(new_n177_), .O(new_n205_));
  nor2   g154(.a(new_n205_), .b(new_n81_), .O(new_n206_));
  aoi21  g155(.a(new_n206_), .b(new_n193_), .c(new_n204_), .O(new_n207_));
  nand3  g156(.a(new_n156_), .b(new_n129_), .c(new_n118_), .O(new_n208_));
  nor2   g157(.a(x33), .b(x32), .O(new_n209_));
  nand2  g158(.a(new_n209_), .b(new_n184_), .O(new_n210_));
  nor3   g159(.a(new_n210_), .b(new_n208_), .c(new_n112_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n207_), .c(x16), .O(new_n212_));
  nor2   g161(.a(x16), .b(x01), .O(new_n213_));
  nor2   g162(.a(new_n213_), .b(new_n52_), .O(new_n214_));
  nand3  g163(.a(new_n214_), .b(new_n212_), .c(new_n62_), .O(z14));
  inv1   g164(.a(x34), .O(new_n216_));
  nand4  g165(.a(new_n209_), .b(new_n150_), .c(new_n178_), .d(new_n90_), .O(new_n217_));
  nor2   g166(.a(new_n217_), .b(new_n81_), .O(new_n218_));
  aoi21  g167(.a(new_n218_), .b(new_n193_), .c(new_n216_), .O(new_n219_));
  nand4  g168(.a(new_n184_), .b(new_n216_), .c(new_n204_), .d(new_n191_), .O(new_n220_));
  nor3   g169(.a(new_n220_), .b(new_n208_), .c(new_n112_), .O(new_n221_));
  ...
  nand3  g173(.a(new_n224_), .b(new_n222_), .c(new_n62_), .O(z15));
endmodule
