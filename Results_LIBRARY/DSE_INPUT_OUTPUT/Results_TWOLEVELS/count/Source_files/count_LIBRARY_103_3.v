...
module FAU ( 
  ...
  nor2   g032(.a(x30), .b(new_n77_), .O(new_n84_));
  ...
  nand4  g038(.a(new_n89_), .b(new_n68_), .c(new_n88_), .d(new_n52_), .O(new_n90_));
  ...
  nand3  g046(.a(new_n97_), .b(new_n79_), .c(new_n63_), .O(new_n98_));
  ...
  nand2  g050(.a(new_n101_), .b(new_n85_), .O(z05));
  nand2  g051(.a(new_n98_), .b(x25), .O(new_n103_));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n89_), .c(new_n70_), .d(new_n55_), .O(new_n105_));
  aoi21  g054(.a(new_n105_), .b(new_n103_), .c(new_n58_), .O(new_n106_));
  nor2   g055(.a(x16), .b(x09), .O(new_n107_));
  oai21  g056(.a(new_n107_), .b(new_n106_), .c(new_n77_), .O(new_n108_));
  nand2  g057(.a(new_n108_), .b(new_n85_), .O(z06));
  nand2  g058(.a(new_n105_), .b(x26), .O(new_n110_));
  nor3   g059(.a(x26), .b(x25), .c(x24), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n89_), .c(new_n72_), .O(new_n112_));
  aoi21  g061(.a(new_n112_), .b(new_n110_), .c(new_n58_), .O(new_n113_));
  nor2   g062(.a(x16), .b(x08), .O(new_n114_));
  oai21  g063(.a(new_n114_), .b(new_n113_), .c(new_n77_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(new_n85_), .O(z07));
  inv1   g065(.a(x27), .O(new_n117_));
  inv1   g066(.a(x24), .O(new_n118_));
  nor2   g067(.a(x26), .b(x25), .O(new_n119_));
  nand4  g068(.a(new_n119_), .b(new_n89_), .c(new_n118_), .d(new_n88_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n53_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n63_), .c(new_n117_), .O(new_n122_));
  ...
  nand2  g087(.a(new_n138_), .b(new_n85_), .O(z09));
  inv1   g088(.a(x29), .O(new_n140_));
  nor2   g089(.a(x28), .b(x27), .O(new_n141_));
  nand4  g090(.a(new_n141_), .b(new_n119_), .c(new_n97_), .d(new_n79_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n53_), .c(new_n69_), .O(new_n143_));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n119_), .c(new_n117_), .d(new_n118_), .O(new_n145_));
  oai22  g094(.a(new_n145_), .b(new_n90_), .c(new_n143_), .d(new_n140_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n132_), .b(new_n55_), .c(x16), .O(new_n152_));
  nand3  g101(.a(new_n144_), .b(new_n133_), .c(new_n124_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n152_), .c(new_n77_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g104(.a(new_n97_), .b(new_n79_), .O(new_n156_));
  nand3  g105(.a(new_n144_), .b(new_n119_), .c(new_n117_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n156_), .c(new_n53_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n63_), .c(new_n151_), .O(new_n159_));
  nor2   g108(.a(x16), .b(x04), .O(new_n160_));
  aoi21  g109(.a(new_n159_), .b(x16), .c(new_n160_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(x18), .c(new_n155_), .O(z11));
  inv1   g111(.a(x31), .O(new_n163_));
  inv1   g112(.a(x23), .O(new_n164_));
  nand3  g113(.a(new_n104_), .b(new_n79_), .c(new_n164_), .O(new_n165_));
  inv1   g114(.a(x28), .O(new_n166_));
  nor2   g115(.a(x30), .b(x29), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n124_), .c(new_n166_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n165_), .c(new_n53_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n63_), .c(new_n163_), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n144_), .c(new_n124_), .d(new_n123_), .O(new_n172_));
  ...
  oai21  g127(.a(x31), .b(x30), .c(new_n77_), .O(new_n179_));
  oai21  g128(.a(new_n145_), .b(new_n90_), .c(new_n151_), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n179_), .c(new_n178_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n167_), .c(new_n141_), .d(new_n119_), .O(new_n183_));
  ...
  nor2   g135(.a(x18), .b(x16), .O(new_n187_));
  aoi21  g136(.a(new_n187_), .b(new_n186_), .c(new_n84_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n185_), .O(z13));
  inv1   g138(.a(x33), .O(new_n190_));
  nand2  g139(.a(new_n182_), .b(new_n151_), .O(new_n191_));
  nand2  g140(.a(new_n191_), .b(new_n77_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n180_), .c(new_n190_), .O(new_n193_));
  nand2  g142(.a(new_n144_), .b(new_n124_), .O(new_n194_));
  nor2   g143(.a(x33), .b(x32), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n171_), .O(new_n196_));
  nor3   g145(.a(new_n196_), .b(new_n194_), .c(new_n105_), .O(new_n197_));
  oai21  g146(.a(new_n197_), .b(new_n193_), .c(x16), .O(new_n198_));
  inv1   g147(.a(x01), .O(new_n199_));
  aoi21  g148(.a(new_n187_), .b(new_n199_), .c(new_n84_), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n198_), .O(z14));
  inv1   g150(.a(x34), .O(new_n202_));
  nand4  g151(.a(new_n195_), .b(new_n171_), .c(new_n144_), .d(new_n117_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n120_), .c(new_n53_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n63_), .c(new_n202_), .O(new_n205_));
  nand4  g154(.a(new_n171_), .b(new_n202_), .c(new_n190_), .d(new_n178_), .O(new_n206_));
  nor3   g155(.a(new_n206_), .b(new_n194_), .c(new_n105_), .O(new_n207_));
