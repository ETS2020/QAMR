...
module FAU ( 
  ...
  aoi21  g046(.a(x16), .b(new_n58_), .c(new_n57_), .O(new_n98_));
  nor2   g047(.a(x20), .b(x19), .O(new_n99_));
  nor2   g048(.a(x23), .b(x22), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n99_), .c(new_n73_), .d(new_n52_), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n82_), .c(new_n99_), .d(new_n52_), .O(new_n103_));
  inv1   g052(.a(new_n103_), .O(new_n104_));
  aoi21  g053(.a(new_n101_), .b(x24), .c(new_n104_), .O(new_n105_));
  aoi22  g054(.a(new_n95_), .b(new_n57_), .c(x18), .d(new_n58_), .O(new_n106_));
  oai21  g055(.a(new_n105_), .b(new_n98_), .c(new_n106_), .O(z05));
  inv1   g056(.a(x25), .O(new_n108_));
  nor2   g057(.a(x21), .b(x20), .O(new_n109_));
  nor2   g058(.a(x25), .b(x24), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n100_), .c(new_n109_), .d(new_n55_), .O(new_n111_));
  oai21  g060(.a(new_n104_), .b(new_n108_), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g067(.a(new_n108_), .b(new_n118_), .c(new_n90_), .d(new_n80_), .O(new_n119_));
  nor2   g068(.a(new_n119_), .b(new_n74_), .O(new_n120_));
  nor2   g069(.a(x26), .b(x25), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n100_), .c(new_n118_), .O(new_n122_));
  oai22  g071(.a(new_n122_), .b(new_n74_), .c(new_n120_), .d(new_n117_), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(x16), .O(new_n124_));
  nor2   g073(.a(x16), .b(x08), .O(new_n125_));
  nor2   g074(.a(new_n125_), .b(new_n60_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n124_), .c(new_n59_), .O(z07));
  oai21  g076(.a(new_n122_), .b(new_n74_), .c(x27), .O(new_n128_));
  nor3   g077(.a(x22), .b(x21), .c(x20), .O(new_n129_));
  nor3   g078(.a(x27), .b(x26), .c(x25), .O(new_n130_));
  nand4  g079(.a(new_n130_), .b(new_n102_), .c(new_n129_), .d(new_n55_), .O(new_n131_));
  ...
  nand3  g086(.a(new_n137_), .b(new_n102_), .c(new_n108_), .O(new_n138_));
  ...
  nand4  g090(.a(new_n141_), .b(new_n140_), .c(new_n129_), .d(new_n55_), .O(new_n142_));
  ...
  nand4  g097(.a(new_n148_), .b(new_n110_), .c(new_n117_), .d(new_n90_), .O(new_n149_));
  oai21  g098(.a(new_n149_), .b(new_n83_), .c(x29), .O(new_n150_));
  ...
  nand4  g109(.a(new_n160_), .b(new_n121_), .c(new_n159_), .d(new_n118_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n101_), .c(x30), .O(new_n162_));
  ...
  aoi21  g119(.a(new_n170_), .b(new_n168_), .c(new_n60_), .O(z11));
  nand3  g120(.a(new_n163_), .b(new_n148_), .c(new_n151_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n101_), .c(x31), .O(new_n173_));
  nor2   g122(.a(x31), .b(x30), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n160_), .c(new_n130_), .d(new_n104_), .O(new_n175_));
  ...
  nand3  g128(.a(new_n179_), .b(new_n177_), .c(new_n59_), .O(z12));
  nand3  g129(.a(new_n174_), .b(new_n160_), .c(new_n130_), .O(new_n181_));
  oai21  g130(.a(new_n181_), .b(new_n103_), .c(x32), .O(new_n182_));
  nor2   g131(.a(x32), .b(x31), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n163_), .c(new_n148_), .d(new_n121_), .O(new_n184_));
  ...
  nand3  g139(.a(new_n190_), .b(new_n188_), .c(new_n59_), .O(z13));
  oai21  g140(.a(new_n184_), .b(new_n103_), .c(x33), .O(new_n192_));
  inv1   g141(.a(new_n119_), .O(new_n193_));
  inv1   g142(.a(x28), .O(new_n194_));
  inv1   g143(.a(x29), .O(new_n195_));
  nand4  g144(.a(new_n195_), .b(new_n194_), .c(new_n159_), .d(new_n117_), .O(new_n196_));
  ...
  nand4  g152(.a(new_n203_), .b(new_n197_), .c(new_n193_), .d(new_n81_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n192_), .O(new_n205_));
  nand2  g154(.a(new_n205_), .b(x16), .O(new_n206_));
  inv1   g155(.a(x01), .O(new_n207_));
  aoi21  g156(.a(new_n70_), .b(new_n207_), .c(x18), .O(new_n208_));
  aoi21  g157(.a(new_n208_), .b(new_n206_), .c(new_n60_), .O(z14));
  nor2   g158(.a(x33), .b(x32), .O(new_n210_));
  nand4  g159(.a(new_n210_), .b(new_n174_), .c(new_n160_), .d(new_n137_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n111_), .c(x34), .O(new_n212_));
  nor3   g161(.a(x34), .b(x33), .c(x32), .O(new_n213_));
  nand3  g162(.a(new_n213_), .b(new_n197_), .c(new_n174_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(new_n111_), .c(new_n212_), .O(new_n215_));
  nand2  g164(.a(new_n215_), .b(x16), .O(new_n216_));
  nor2   g165(.a(x16), .b(x00), .O(new_n217_));
  nor2   g166(.a(new_n217_), .b(new_n60_), .O(new_n218_));
  nand3  g167(.a(new_n218_), .b(new_n216_), .c(new_n59_), .O(z15));
endmodule
