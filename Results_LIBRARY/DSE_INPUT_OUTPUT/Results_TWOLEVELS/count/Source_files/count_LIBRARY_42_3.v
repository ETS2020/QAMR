...
module FAU ( 
  ...
  oai21  g021(.a(x18), .b(new_n70_), .c(new_n58_), .O(new_n73_));
  ...
  aoi21  g027(.a(x18), .b(new_n57_), .c(new_n60_), .O(new_n79_));
  ...
  aoi21  g046(.a(new_n97_), .b(new_n95_), .c(new_n60_), .O(z04));
  oai21  g047(.a(x18), .b(new_n70_), .c(new_n57_), .O(new_n99_));
  inv1   g048(.a(x24), .O(new_n100_));
  inv1   g049(.a(x23), .O(new_n101_));
  nand3  g050(.a(new_n101_), .b(new_n81_), .c(new_n74_), .O(new_n102_));
  nor2   g051(.a(new_n102_), .b(new_n66_), .O(new_n103_));
  nor2   g052(.a(x24), .b(x23), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n83_), .c(new_n91_), .d(new_n52_), .O(new_n105_));
  oai21  g054(.a(new_n103_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(x16), .O(new_n107_));
  aoi21  g056(.a(x18), .b(new_n58_), .c(new_n60_), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n107_), .c(new_n99_), .O(z05));
  nand2  g058(.a(new_n105_), .b(x25), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n92_), .c(new_n75_), .d(new_n55_), .O(new_n112_));
  ...
  oai21  g069(.a(new_n120_), .b(new_n76_), .c(new_n118_), .O(new_n121_));
  ...
  oai21  g074(.a(new_n120_), .b(new_n76_), .c(x27), .O(new_n126_));
  nor3   g075(.a(x22), .b(x21), .c(x20), .O(new_n127_));
  nor3   g076(.a(x27), .b(x26), .c(x25), .O(new_n128_));
  nand4  g077(.a(new_n128_), .b(new_n104_), .c(new_n127_), .d(new_n55_), .O(new_n129_));
  ...
  aoi21  g082(.a(new_n133_), .b(new_n131_), .c(new_n60_), .O(z08));
  ...
  nor2   g090(.a(new_n141_), .b(new_n60_), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n140_), .c(new_n59_), .O(z09));
  inv1   g092(.a(x26), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n111_), .c(new_n144_), .d(new_n101_), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n84_), .c(x29), .O(new_n147_));
  nor3   g096(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nor3   g097(.a(x29), .b(x28), .c(x27), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n148_), .c(new_n103_), .O(new_n150_));
  nand2  g099(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g100(.a(new_n151_), .b(x16), .O(new_n152_));
  inv1   g101(.a(x05), .O(new_n153_));
  aoi21  g102(.a(new_n70_), .b(new_n153_), .c(x18), .O(new_n154_));
  aoi21  g103(.a(new_n154_), .b(new_n152_), .c(new_n60_), .O(z10));
  inv1   g104(.a(x27), .O(new_n156_));
  nor2   g105(.a(x29), .b(x28), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n119_), .c(new_n156_), .d(new_n100_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n93_), .c(x30), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand2  g109(.a(new_n160_), .b(new_n145_), .O(new_n161_));
  inv1   g110(.a(new_n161_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n148_), .c(new_n103_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(x16), .O(new_n165_));
  inv1   g114(.a(x04), .O(new_n166_));
  aoi21  g115(.a(new_n70_), .b(new_n166_), .c(x18), .O(new_n167_));
  aoi21  g116(.a(new_n167_), .b(new_n165_), .c(new_n60_), .O(z11));
  nand4  g117(.a(new_n160_), .b(new_n145_), .c(new_n119_), .d(new_n100_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n93_), .c(x31), .O(new_n170_));
  nand4  g119(.a(new_n100_), .b(new_n101_), .c(new_n81_), .d(new_n74_), .O(new_n171_));
  ...
  nand4  g127(.a(new_n178_), .b(new_n128_), .c(new_n172_), .d(new_n67_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n170_), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(x16), .O(new_n181_));
  inv1   g130(.a(x03), .O(new_n182_));
  aoi21  g131(.a(new_n70_), .b(new_n182_), .c(x18), .O(new_n183_));
  aoi21  g132(.a(new_n183_), .b(new_n181_), .c(new_n60_), .O(z12));
  ...
  oai21  g137(.a(new_n188_), .b(new_n105_), .c(x32), .O(new_n189_));
  nand4  g138(.a(new_n173_), .b(new_n156_), .c(new_n144_), .d(new_n185_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  inv1   g140(.a(x32), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n176_), .c(new_n175_), .d(new_n174_), .O(new_n193_));
  inv1   g142(.a(new_n193_), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n191_), .c(new_n172_), .d(new_n67_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n189_), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(x16), .O(new_n197_));
  inv1   g146(.a(x02), .O(new_n198_));
  aoi21  g147(.a(new_n70_), .b(new_n198_), .c(x18), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n197_), .c(new_n60_), .O(z13));
  nor2   g149(.a(x32), .b(x31), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n160_), .c(new_n145_), .d(new_n119_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n105_), .c(x33), .O(new_n203_));
  nor2   g152(.a(x33), .b(x32), .O(new_n204_));
  nand4  g153(.a(new_n204_), .b(new_n187_), .c(new_n157_), .d(new_n186_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n112_), .c(new_n203_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(x16), .O(new_n207_));
  nor2   g156(.a(x16), .b(x01), .O(new_n208_));
  nor2   g157(.a(new_n208_), .b(new_n60_), .O(new_n209_));
  nand3  g158(.a(new_n209_), .b(new_n207_), .c(new_n59_), .O(z14));
  oai21  g159(.a(new_n205_), .b(new_n112_), .c(x34), .O(new_n211_));
  inv1   g160(.a(new_n112_), .O(new_n212_));
  nand2  g161(.a(new_n157_), .b(new_n186_), .O(new_n213_));
  inv1   g162(.a(new_n213_), .O(new_n214_));
  nor3   g163(.a(x34), .b(x33), .c(x32), .O(new_n215_));
  nand4  g164(.a(new_n215_), .b(new_n214_), .c(new_n187_), .d(new_n212_), .O(new_n216_));
  nand2  g165(.a(new_n216_), .b(new_n211_), .O(new_n217_));
  nand2  g166(.a(new_n217_), .b(x16), .O(new_n218_));
  nor2   g167(.a(x16), .b(x00), .O(new_n219_));
  nor2   g168(.a(new_n219_), .b(new_n60_), .O(new_n220_));
  nand3  g169(.a(new_n220_), .b(new_n218_), .c(new_n59_), .O(z15));
endmodule
