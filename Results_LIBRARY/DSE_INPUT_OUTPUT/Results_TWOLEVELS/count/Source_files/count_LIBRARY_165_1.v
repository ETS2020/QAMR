...
module FAU ( 
  ...
  nand2  g010(.a(x18), .b(x11), .O(new_n62_));
  ...
  nand4  g021(.a(new_n72_), .b(new_n65_), .c(new_n56_), .d(new_n55_), .O(new_n73_));
  oai21  g022(.a(new_n67_), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  nand2  g023(.a(new_n74_), .b(x16), .O(new_n75_));
  inv1   g024(.a(x13), .O(new_n76_));
  aoi21  g025(.a(new_n53_), .b(new_n76_), .c(x18), .O(new_n77_));
  aoi21  g026(.a(new_n77_), .b(new_n75_), .c(new_n64_), .O(z02));
  nand2  g027(.a(new_n61_), .b(x18), .O(new_n79_));
  ...
  oai21  g037(.a(x19), .b(x17), .c(x23), .O(new_n89_));
  ...
  nand2  g043(.a(new_n52_), .b(new_n60_), .O(new_n95_));
  nand2  g044(.a(x16), .b(x11), .O(new_n96_));
  aoi22  g045(.a(new_n96_), .b(new_n95_), .c(new_n82_), .d(new_n65_), .O(new_n97_));
  nor3   g046(.a(x16), .b(x15), .c(x11), .O(new_n98_));
  aoi21  g047(.a(new_n97_), .b(x23), .c(new_n98_), .O(new_n99_));
  nand2  g048(.a(new_n99_), .b(new_n94_), .O(z04));
  ...
  nand3  g057(.a(new_n108_), .b(new_n106_), .c(new_n79_), .O(z05));
  inv1   g058(.a(x25), .O(new_n110_));
  nand2  g059(.a(new_n90_), .b(new_n55_), .O(new_n111_));
  nand2  g060(.a(new_n103_), .b(new_n82_), .O(new_n112_));
  nor2   g061(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nor2   g062(.a(x21), .b(x20), .O(new_n114_));
  nor2   g063(.a(x25), .b(x24), .O(new_n115_));
  nand4  g064(.a(new_n115_), .b(new_n91_), .c(new_n114_), .d(new_n58_), .O(new_n116_));
  ...
  nand3  g069(.a(new_n120_), .b(new_n118_), .c(new_n79_), .O(z06));
  inv1   g070(.a(x26), .O(new_n122_));
  inv1   g071(.a(x23), .O(new_n123_));
  nand4  g072(.a(new_n110_), .b(new_n101_), .c(new_n123_), .d(new_n80_), .O(new_n124_));
  nor2   g073(.a(new_n124_), .b(new_n73_), .O(new_n125_));
  nor3   g074(.a(x26), .b(x25), .c(x24), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n91_), .c(new_n81_), .O(new_n127_));
  ...
  nand3  g080(.a(new_n131_), .b(new_n129_), .c(new_n79_), .O(z07));
  ...
  nand3  g089(.a(new_n140_), .b(new_n138_), .c(new_n79_), .O(z08));
  nand2  g090(.a(new_n135_), .b(new_n103_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n83_), .c(x28), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n115_), .c(new_n122_), .d(new_n123_), .O(new_n145_));
  or2    g094(.a(new_n145_), .b(new_n83_), .O(new_n146_));
  ...
  nand3  g099(.a(new_n150_), .b(new_n148_), .c(new_n79_), .O(z09));
  oai21  g100(.a(new_n145_), .b(new_n83_), .c(x29), .O(new_n152_));
  nor3   g101(.a(x23), .b(x22), .c(x21), .O(new_n153_));
  nor3   g102(.a(x29), .b(x28), .c(x27), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n126_), .c(new_n153_), .d(new_n67_), .O(new_n155_));
  ...
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n64_), .O(z10));
  nand2  g109(.a(new_n155_), .b(x30), .O(new_n161_));
  nor2   g110(.a(x26), .b(x25), .O(new_n162_));
  nor2   g111(.a(x30), .b(x29), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n144_), .c(new_n162_), .d(new_n101_), .O(new_n164_));
  or2    g113(.a(new_n164_), .b(new_n92_), .O(new_n165_));
  ...
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n79_), .O(z11));
  oai21  g119(.a(new_n164_), .b(new_n92_), .c(x31), .O(new_n171_));
  ...
  nand4  g125(.a(new_n176_), .b(new_n135_), .c(new_n172_), .d(new_n67_), .O(new_n177_));
  ...
  aoi21  g130(.a(new_n181_), .b(new_n179_), .c(new_n64_), .O(z12));
  nand3  g131(.a(new_n174_), .b(new_n173_), .c(new_n135_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n104_), .c(x32), .O(new_n184_));
  nor2   g133(.a(x32), .b(x31), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n163_), .O(new_n186_));
  inv1   g135(.a(new_n186_), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n144_), .c(new_n162_), .d(new_n113_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n184_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(x16), .O(new_n190_));
  nor2   g139(.a(x16), .b(x02), .O(new_n191_));
  nor2   g140(.a(new_n191_), .b(new_n64_), .O(new_n192_));
  nand3  g141(.a(new_n192_), .b(new_n190_), .c(new_n79_), .O(z13));
  nand4  g142(.a(new_n185_), .b(new_n163_), .c(new_n144_), .d(new_n162_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n104_), .c(x33), .O(new_n195_));
  nor2   g144(.a(x27), .b(x26), .O(new_n196_));
  nor2   g145(.a(x33), .b(x32), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n174_), .c(new_n173_), .d(new_n196_), .O(new_n198_));
  or2    g147(.a(new_n198_), .b(new_n116_), .O(new_n199_));
  ...
  nand3  g152(.a(new_n203_), .b(new_n201_), .c(new_n79_), .O(z14));
  oai21  g153(.a(new_n198_), .b(new_n116_), .c(x34), .O(new_n205_));
  nand2  g154(.a(new_n173_), .b(new_n196_), .O(new_n206_));
  ...
  nand3  g164(.a(new_n215_), .b(new_n207_), .c(new_n125_), .O(new_n216_));
