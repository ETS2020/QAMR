...
module FAU ( 
  ...
  nand3  g036(.a(new_n78_), .b(new_n55_), .c(new_n61_), .O(new_n88_));
  ...
  oai21  g042(.a(new_n93_), .b(new_n92_), .c(new_n87_), .O(new_n94_));
  inv1   g043(.a(x33), .O(new_n95_));
  nand2  g044(.a(new_n95_), .b(x18), .O(new_n96_));
  nand2  g045(.a(new_n96_), .b(new_n94_), .O(z04));
  oai21  g046(.a(new_n90_), .b(x19), .c(new_n63_), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n78_), .c(new_n68_), .d(new_n52_), .O(new_n100_));
  ...
  aoi21  g060(.a(new_n111_), .b(new_n106_), .c(new_n58_), .O(new_n112_));
  nor2   g061(.a(x16), .b(x09), .O(new_n113_));
  oai21  g062(.a(new_n113_), .b(new_n112_), .c(new_n87_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(new_n96_), .O(z06));
  inv1   g064(.a(x26), .O(new_n116_));
  inv1   g065(.a(x23), .O(new_n117_));
  nand3  g066(.a(new_n108_), .b(new_n78_), .c(new_n117_), .O(new_n118_));
  aoi21  g067(.a(new_n118_), .b(new_n53_), .c(new_n69_), .O(new_n119_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n107_), .c(new_n128_), .d(new_n70_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n53_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n63_), .c(new_n127_), .O(new_n132_));
  ...
  nand2  g089(.a(new_n107_), .b(new_n70_), .O(new_n141_));
  ...
  nand4  g095(.a(new_n146_), .b(new_n108_), .c(new_n116_), .d(new_n117_), .O(new_n147_));
  ...
  oai21  g101(.a(new_n147_), .b(new_n88_), .c(x29), .O(new_n153_));
  nor2   g102(.a(new_n141_), .b(new_n69_), .O(new_n154_));
  nor3   g103(.a(x29), .b(x28), .c(x27), .O(new_n155_));
  nand3  g104(.a(new_n155_), .b(new_n120_), .c(new_n154_), .O(new_n156_));
  aoi21  g105(.a(new_n156_), .b(new_n153_), .c(new_n58_), .O(new_n157_));
  nor2   g106(.a(x16), .b(x05), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n157_), .c(new_n87_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(new_n96_), .O(z10));
  nand2  g109(.a(new_n155_), .b(new_n120_), .O(new_n161_));
  ...
  nand3  g114(.a(new_n165_), .b(new_n120_), .c(new_n154_), .O(new_n166_));
  aoi21  g115(.a(new_n166_), .b(new_n162_), .c(new_n58_), .O(new_n167_));
  nor2   g116(.a(x16), .b(x04), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n167_), .c(new_n87_), .O(new_n169_));
  nand2  g118(.a(new_n169_), .b(new_n96_), .O(z11));
  nand4  g119(.a(new_n163_), .b(new_n146_), .c(new_n129_), .d(new_n128_), .O(new_n171_));
  ...
  nand3  g125(.a(new_n176_), .b(new_n133_), .c(new_n101_), .O(new_n177_));
  aoi21  g126(.a(new_n177_), .b(new_n172_), .c(new_n58_), .O(new_n178_));
  nor2   g127(.a(x16), .b(x03), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n178_), .c(new_n87_), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n96_), .O(z12));
  inv1   g130(.a(x32), .O(new_n182_));
  inv1   g131(.a(x29), .O(new_n183_));
  nand4  g132(.a(new_n174_), .b(new_n146_), .c(new_n183_), .d(new_n116_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n118_), .c(new_n53_), .O(new_n185_));
  aoi21  g134(.a(new_n185_), .b(new_n63_), .c(new_n182_), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n163_), .c(new_n146_), .d(new_n129_), .O(new_n188_));
  ...
  nand4  g143(.a(new_n194_), .b(new_n99_), .c(new_n78_), .d(new_n68_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n188_), .c(new_n87_), .O(new_n196_));
  nand2  g145(.a(new_n196_), .b(new_n95_), .O(new_n197_));
  inv1   g146(.a(x30), .O(new_n198_));
  nand4  g147(.a(new_n187_), .b(new_n173_), .c(new_n198_), .d(new_n127_), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n130_), .c(new_n53_), .O(new_n200_));
  aoi21  g149(.a(new_n200_), .b(new_n63_), .c(new_n95_), .O(new_n201_));
  nor2   g150(.a(x16), .b(x01), .O(new_n202_));
  aoi21  g151(.a(new_n201_), .b(x16), .c(new_n202_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(x18), .c(new_n197_), .O(z14));
  nand3  g153(.a(x34), .b(x33), .c(x16), .O(new_n205_));
  oai21  g154(.a(x16), .b(x00), .c(new_n205_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(new_n87_), .O(new_n207_));
  oai21  g156(.a(new_n188_), .b(new_n100_), .c(x34), .O(new_n208_));
  nand2  g157(.a(new_n173_), .b(new_n142_), .O(new_n209_));
  nor2   g158(.a(x34), .b(x32), .O(new_n210_));
  nand2  g159(.a(new_n210_), .b(new_n174_), .O(new_n211_));
  nor2   g160(.a(new_n211_), .b(new_n209_), .O(new_n212_));
  nand3  g161(.a(new_n212_), .b(new_n110_), .c(new_n72_), .O(new_n213_));
  aoi21  g162(.a(new_n213_), .b(new_n208_), .c(new_n58_), .O(new_n214_));
  oai21  g163(.a(new_n214_), .b(x18), .c(new_n95_), .O(new_n215_));
  nand2  g164(.a(new_n215_), .b(new_n207_), .O(z15));
endmodule
