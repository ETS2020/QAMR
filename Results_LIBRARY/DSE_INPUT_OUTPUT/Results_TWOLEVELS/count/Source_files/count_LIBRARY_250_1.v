...
module FAU ( 
  ...
  oai21  g018(.a(new_n52_), .b(x00), .c(x18), .O(new_n70_));
  ...
  nand3  g038(.a(new_n80_), .b(new_n57_), .c(new_n63_), .O(new_n90_));
  ...
  aoi21  g044(.a(x18), .b(x00), .c(new_n53_), .O(new_n96_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n92_), .c(new_n98_), .d(new_n71_), .O(new_n128_));
  ...
  nand3  g095(.a(new_n146_), .b(new_n144_), .c(new_n70_), .O(z09));
  ...
  oai21  g104(.a(new_n150_), .b(new_n93_), .c(x30), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n141_), .c(new_n119_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n93_), .c(new_n156_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(x16), .O(new_n160_));
  nor2   g109(.a(x16), .b(x04), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n53_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n160_), .c(new_n70_), .O(z11));
  oai21  g112(.a(new_n158_), .b(new_n93_), .c(x31), .O(new_n164_));
  ...
  nand3  g119(.a(new_n170_), .b(new_n168_), .c(new_n70_), .O(z12));
  ...
  nand3  g127(.a(new_n178_), .b(new_n176_), .c(new_n70_), .O(z13));
  ...
  nand3  g138(.a(new_n189_), .b(new_n187_), .c(new_n70_), .O(z14));
  ...
  oai22  g142(.a(new_n193_), .b(new_n112_), .c(new_n65_), .d(new_n191_), .O(new_n194_));
  aoi21  g143(.a(new_n194_), .b(x16), .c(x18), .O(new_n195_));
  inv1   g144(.a(x00), .O(new_n196_));
  oai21  g145(.a(x19), .b(new_n196_), .c(x11), .O(new_n197_));
  nand4  g146(.a(new_n182_), .b(new_n165_), .c(new_n149_), .d(new_n126_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n128_), .c(new_n197_), .O(new_n199_));
  nor2   g148(.a(new_n199_), .b(new_n191_), .O(new_n200_));
  nor3   g149(.a(x16), .b(x11), .c(x00), .O(new_n201_));
  aoi21  g150(.a(new_n200_), .b(x16), .c(new_n201_), .O(new_n202_));
  oai21  g151(.a(new_n195_), .b(new_n53_), .c(new_n202_), .O(z15));
endmodule
