...
module FAU ( 
  ...
  oai21  g14(.a(new_n65_), .b(new_n64_), .c(x20), .O(new_n66_));
  nand2  g15(.a(new_n66_), .b(new_n52_), .O(z02));
  nor2   g16(.a(x16), .b(x12), .O(new_n68_));
  and2   g17(.a(x22), .b(x16), .O(new_n69_));
  oai21  g18(.a(new_n69_), .b(new_n68_), .c(x20), .O(new_n70_));
  ...
  nand2  g46(.a(new_n60_), .b(new_n97_), .O(new_n98_));
  nand3  g47(.a(new_n98_), .b(new_n96_), .c(new_n62_), .O(z10));
  ...
  nand2  g58(.a(new_n60_), .b(new_n109_), .O(new_n110_));
  nand3  g59(.a(new_n110_), .b(new_n108_), .c(new_n62_), .O(z13));
  nand2  g60(.a(x33), .b(x16), .O(new_n112_));
  inv1   g61(.a(x01), .O(new_n113_));
  nand2  g62(.a(new_n60_), .b(new_n113_), .O(new_n114_));
  nand3  g63(.a(new_n114_), .b(new_n112_), .c(new_n62_), .O(z14));
