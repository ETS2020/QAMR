...
module FAU ( 
  ...
  aoi21  g028(.a(x16), .b(new_n57_), .c(new_n58_), .O(new_n80_));
  nor3   g029(.a(x22), .b(x21), .c(x20), .O(new_n81_));
  aoi22  g030(.a(new_n81_), .b(new_n55_), .c(new_n74_), .d(x22), .O(new_n82_));
  inv1   g031(.a(x18), .O(new_n83_));
  nand2  g032(.a(new_n83_), .b(x16), .O(new_n84_));
  aoi22  g033(.a(new_n84_), .b(new_n58_), .c(x18), .d(new_n57_), .O(new_n85_));
  oai21  g034(.a(new_n82_), .b(new_n80_), .c(new_n85_), .O(z03));
  ...
  nand3  g049(.a(new_n100_), .b(new_n99_), .c(new_n73_), .O(new_n101_));
  nor2   g050(.a(new_n101_), .b(new_n66_), .O(new_n102_));
  nor2   g051(.a(x24), .b(x23), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n87_), .c(new_n90_), .d(new_n52_), .O(new_n104_));
  ...
  aoi21  g056(.a(new_n70_), .b(new_n107_), .c(x18), .O(new_n108_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n91_), .c(new_n112_), .d(new_n55_), .O(new_n114_));
  ...
  aoi21  g066(.a(new_n70_), .b(new_n117_), .c(x18), .O(new_n118_));
  aoi21  g067(.a(new_n118_), .b(new_n116_), .c(new_n60_), .O(z06));
  inv1   g068(.a(x26), .O(new_n120_));
  nand4  g069(.a(new_n110_), .b(new_n98_), .c(new_n100_), .d(new_n99_), .O(new_n121_));
  nor2   g070(.a(new_n121_), .b(new_n74_), .O(new_n122_));
  nor2   g071(.a(x26), .b(x25), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n91_), .c(new_n98_), .O(new_n124_));
  oai22  g073(.a(new_n124_), .b(new_n74_), .c(new_n122_), .d(new_n120_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(x16), .O(new_n126_));
  inv1   g075(.a(x08), .O(new_n127_));
  aoi21  g076(.a(new_n70_), .b(new_n127_), .c(x18), .O(new_n128_));
  aoi21  g077(.a(new_n128_), .b(new_n126_), .c(new_n60_), .O(z07));
  oai21  g078(.a(new_n124_), .b(new_n74_), .c(x27), .O(new_n130_));
  nor3   g079(.a(x27), .b(x26), .c(x25), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n103_), .c(new_n81_), .d(new_n55_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  inv1   g083(.a(x07), .O(new_n135_));
  aoi21  g084(.a(new_n70_), .b(new_n135_), .c(x18), .O(new_n136_));
  aoi21  g085(.a(new_n136_), .b(new_n134_), .c(new_n60_), .O(z08));
  oai21  g086(.a(new_n70_), .b(x12), .c(x06), .O(new_n138_));
  and2   g087(.a(new_n132_), .b(x28), .O(new_n139_));
  nor2   g088(.a(x28), .b(x27), .O(new_n140_));
  nand4  g089(.a(new_n140_), .b(new_n113_), .c(new_n120_), .d(new_n100_), .O(new_n141_));
  nor2   g090(.a(new_n141_), .b(new_n88_), .O(new_n142_));
  oai21  g091(.a(new_n142_), .b(new_n139_), .c(new_n138_), .O(new_n143_));
  aoi22  g092(.a(new_n84_), .b(new_n57_), .c(x18), .d(new_n58_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n143_), .O(z09));
  oai21  g094(.a(new_n141_), .b(new_n88_), .c(x29), .O(new_n146_));
  inv1   g095(.a(x27), .O(new_n147_));
  nor3   g096(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nor2   g097(.a(x29), .b(x28), .O(new_n149_));
  nand4  g098(.a(new_n149_), .b(new_n148_), .c(new_n102_), .d(new_n147_), .O(new_n150_));
  ...
  nand4  g104(.a(new_n149_), .b(new_n123_), .c(new_n147_), .d(new_n98_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n92_), .c(x30), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand4  g107(.a(new_n158_), .b(new_n140_), .c(new_n148_), .d(new_n102_), .O(new_n159_));
  ...
  nand3  g113(.a(new_n158_), .b(new_n140_), .c(new_n148_), .O(new_n165_));
  oai21  g114(.a(new_n165_), .b(new_n92_), .c(x31), .O(new_n166_));
  nor2   g115(.a(x31), .b(x30), .O(new_n167_));
  nand4  g116(.a(new_n167_), .b(new_n149_), .c(new_n131_), .d(new_n111_), .O(new_n168_));
  ...
  nand3  g121(.a(new_n172_), .b(new_n170_), .c(new_n59_), .O(z12));
  nand3  g122(.a(new_n167_), .b(new_n149_), .c(new_n131_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n104_), .c(x32), .O(new_n175_));
  nor2   g124(.a(x32), .b(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n158_), .c(new_n140_), .d(new_n123_), .O(new_n177_));
  or2    g126(.a(new_n177_), .b(new_n104_), .O(new_n178_));
  ...
  nand3  g131(.a(new_n182_), .b(new_n180_), .c(new_n59_), .O(z13));
  oai21  g132(.a(new_n177_), .b(new_n104_), .c(x33), .O(new_n184_));
  nor2   g133(.a(x27), .b(x26), .O(new_n185_));
  nor2   g134(.a(x33), .b(x32), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n167_), .c(new_n149_), .d(new_n185_), .O(new_n187_));
  ...
  aoi21  g142(.a(new_n193_), .b(new_n191_), .c(new_n60_), .O(z14));
  oai21  g143(.a(new_n187_), .b(new_n114_), .c(x34), .O(new_n195_));
  nand2  g144(.a(new_n149_), .b(new_n185_), .O(new_n196_));
  ...
  aoi21  g159(.a(new_n210_), .b(new_n208_), .c(new_n60_), .O(z15));
endmodule
