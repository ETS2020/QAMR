...
module FAU ( 
  ...
  oai21  g027(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n79_));
  nor3   g028(.a(x22), .b(x21), .c(x20), .O(new_n80_));
  aoi22  g029(.a(new_n80_), .b(new_n58_), .c(new_n73_), .d(x22), .O(new_n81_));
  or2    g030(.a(new_n81_), .b(new_n53_), .O(new_n82_));
  aoi21  g031(.a(x18), .b(x15), .c(new_n63_), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(z03));
  inv1   g033(.a(x23), .O(new_n85_));
  aoi21  g034(.a(new_n80_), .b(new_n58_), .c(new_n85_), .O(new_n86_));
  ...
  nand3  g051(.a(new_n102_), .b(new_n100_), .c(new_n61_), .O(z05));
  ...
  aoi21  g062(.a(new_n113_), .b(new_n111_), .c(new_n63_), .O(z06));
  ...
  nand4  g073(.a(new_n124_), .b(new_n97_), .c(new_n80_), .d(new_n58_), .O(new_n125_));
  ...
  aoi21  g087(.a(new_n138_), .b(new_n136_), .c(new_n63_), .O(z09));
  ...
  nand3  g097(.a(new_n148_), .b(new_n146_), .c(new_n61_), .O(z10));
  ...
  aoi21  g107(.a(new_n158_), .b(new_n156_), .c(new_n63_), .O(z11));
  ...
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n61_), .O(z12));
  ...
  aoi21  g129(.a(new_n180_), .b(new_n178_), .c(new_n63_), .O(z13));
  ...
  nor2   g137(.a(new_n188_), .b(new_n63_), .O(new_n189_));
  nand3  g138(.a(new_n189_), .b(new_n187_), .c(new_n61_), .O(z14));
