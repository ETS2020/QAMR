...
module FAU ( 
  ...
  oai21  g011(.a(new_n52_), .b(x12), .c(x18), .O(new_n63_));
  ...
  oai21  g029(.a(new_n53_), .b(x15), .c(new_n80_), .O(new_n81_));
  nand2  g030(.a(x22), .b(x21), .O(new_n82_));
  nor2   g031(.a(x22), .b(x21), .O(new_n83_));
  nand3  g032(.a(new_n83_), .b(new_n64_), .c(new_n55_), .O(new_n84_));
  ...
  nand3  g036(.a(new_n87_), .b(new_n81_), .c(new_n63_), .O(z03));
  ...
  nand3  g057(.a(new_n108_), .b(new_n106_), .c(new_n63_), .O(z05));
  inv1   g058(.a(x25), .O(new_n110_));
  nand2  g059(.a(new_n103_), .b(new_n83_), .O(new_n111_));
  ...
  nand3  g068(.a(new_n119_), .b(new_n117_), .c(new_n63_), .O(z06));
  inv1   g069(.a(x26), .O(new_n121_));
  nand3  g070(.a(new_n114_), .b(new_n83_), .c(new_n89_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(new_n56_), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n67_), .c(new_n121_), .O(new_n124_));
  ...
  nand3  g079(.a(new_n130_), .b(new_n128_), .c(new_n63_), .O(z07));
  ...
  aoi21  g084(.a(new_n135_), .b(new_n67_), .c(new_n132_), .O(new_n136_));
  nand3  g085(.a(new_n83_), .b(new_n58_), .c(new_n64_), .O(new_n137_));
  ...
  aoi21  g092(.a(new_n143_), .b(new_n141_), .c(new_n60_), .O(z08));
  ...
  aoi21  g096(.a(new_n147_), .b(new_n67_), .c(new_n145_), .O(new_n148_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(new_n103_), .d(new_n83_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n56_), .c(new_n66_), .O(new_n159_));
  ...
  aoi21  g114(.a(new_n165_), .b(new_n163_), .c(new_n60_), .O(z10));
  ...
  aoi21  g118(.a(new_n169_), .b(new_n67_), .c(new_n167_), .O(new_n170_));
  ...
  aoi21  g125(.a(new_n176_), .b(new_n174_), .c(new_n60_), .O(z11));
  ...
  aoi21  g129(.a(new_n180_), .b(new_n67_), .c(new_n178_), .O(new_n181_));
  ...
  aoi21  g136(.a(new_n187_), .b(new_n185_), .c(new_n60_), .O(z12));
  ...
  aoi21  g151(.a(new_n202_), .b(new_n67_), .c(new_n200_), .O(new_n203_));
  ...
  aoi21  g159(.a(new_n210_), .b(new_n208_), .c(new_n60_), .O(z14));
  ...
  aoi21  g169(.a(new_n220_), .b(new_n218_), .c(new_n60_), .O(z15));
endmodule
