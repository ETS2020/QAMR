...
module FAU ( 
  ...
  aoi21  g021(.a(new_n72_), .b(new_n69_), .c(new_n62_), .O(z01));
  oai21  g022(.a(new_n52_), .b(new_n61_), .c(x18), .O(new_n74_));
  inv1   g023(.a(x21), .O(new_n75_));
  nand4  g024(.a(new_n75_), .b(new_n65_), .c(new_n57_), .d(new_n56_), .O(new_n76_));
  oai21  g025(.a(new_n68_), .b(new_n75_), .c(new_n76_), .O(new_n77_));
  nand2  g026(.a(new_n77_), .b(x16), .O(new_n78_));
  nor2   g027(.a(x16), .b(x13), .O(new_n79_));
  nor2   g028(.a(new_n79_), .b(new_n62_), .O(new_n80_));
  nand3  g029(.a(new_n80_), .b(new_n78_), .c(new_n74_), .O(z02));
  ...
  and2   g034(.a(new_n85_), .b(new_n59_), .O(new_n86_));
  ...
  aoi21  g038(.a(new_n89_), .b(new_n87_), .c(new_n62_), .O(z03));
  inv1   g039(.a(x23), .O(new_n91_));
  nor2   g040(.a(x20), .b(x19), .O(new_n92_));
  nor2   g041(.a(x23), .b(x22), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n92_), .c(new_n75_), .d(new_n56_), .O(new_n94_));
  ...
  nand3  g047(.a(new_n98_), .b(new_n96_), .c(new_n74_), .O(z04));
  inv1   g048(.a(x24), .O(new_n100_));
  nand3  g049(.a(new_n91_), .b(new_n82_), .c(new_n75_), .O(new_n101_));
  nor2   g050(.a(new_n101_), .b(new_n67_), .O(new_n102_));
  nor2   g051(.a(x22), .b(x21), .O(new_n103_));
  nor2   g052(.a(x24), .b(x23), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n103_), .c(new_n92_), .d(new_n56_), .O(new_n105_));
  oai21  g054(.a(new_n102_), .b(new_n100_), .c(new_n105_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(x16), .O(new_n107_));
  nor2   g056(.a(x16), .b(x10), .O(new_n108_));
  nor2   g057(.a(new_n108_), .b(new_n62_), .O(new_n109_));
  nand3  g058(.a(new_n109_), .b(new_n107_), .c(new_n74_), .O(z05));
  nand2  g059(.a(new_n105_), .b(x25), .O(new_n111_));
  nor2   g060(.a(x21), .b(x20), .O(new_n112_));
  nor2   g061(.a(x25), .b(x24), .O(new_n113_));
  nand4  g062(.a(new_n113_), .b(new_n93_), .c(new_n112_), .d(new_n59_), .O(new_n114_));
  nand2  g063(.a(new_n114_), .b(new_n111_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(x16), .O(new_n116_));
  inv1   g065(.a(x09), .O(new_n117_));
  aoi21  g066(.a(new_n71_), .b(new_n117_), .c(x18), .O(new_n118_));
  aoi21  g067(.a(new_n118_), .b(new_n116_), .c(new_n62_), .O(z06));
  nand2  g068(.a(new_n114_), .b(x26), .O(new_n120_));
  nor3   g069(.a(x26), .b(x25), .c(x24), .O(new_n121_));
  nand3  g070(.a(new_n121_), .b(new_n93_), .c(new_n83_), .O(new_n122_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n124_), .c(new_n74_), .O(z07));
  nand2  g076(.a(new_n122_), .b(x27), .O(new_n128_));
  nor3   g077(.a(x27), .b(x26), .c(x25), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n104_), .c(new_n85_), .d(new_n59_), .O(new_n130_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n132_), .c(new_n74_), .O(z08));
  nand2  g084(.a(new_n130_), .b(x28), .O(new_n136_));
  nor3   g085(.a(x25), .b(x24), .c(x23), .O(new_n137_));
  nor3   g086(.a(x28), .b(x27), .c(x26), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n137_), .c(new_n85_), .d(new_n59_), .O(new_n139_));
  nand2  g088(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(x16), .O(new_n141_));
  inv1   g090(.a(x06), .O(new_n142_));
  aoi21  g091(.a(new_n71_), .b(new_n142_), .c(x18), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n141_), .c(new_n62_), .O(z09));
  aoi21  g093(.a(x16), .b(new_n52_), .c(new_n61_), .O(new_n145_));
  inv1   g094(.a(x27), .O(new_n146_));
  nor2   g095(.a(x26), .b(x25), .O(new_n147_));
  nor2   g096(.a(x29), .b(x28), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n147_), .c(new_n146_), .d(new_n100_), .O(new_n149_));
  nor2   g098(.a(new_n149_), .b(new_n94_), .O(new_n150_));
  aoi21  g099(.a(new_n139_), .b(x29), .c(new_n150_), .O(new_n151_));
  aoi22  g100(.a(new_n54_), .b(new_n61_), .c(x18), .d(new_n52_), .O(new_n152_));
  oai21  g101(.a(new_n151_), .b(new_n145_), .c(new_n152_), .O(z10));
  oai21  g102(.a(new_n149_), .b(new_n94_), .c(x30), .O(new_n154_));
  nor2   g103(.a(x28), .b(x27), .O(new_n155_));
  nor2   g104(.a(x30), .b(x29), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n155_), .c(new_n121_), .d(new_n102_), .O(new_n157_));
  ...
  aoi21  g110(.a(new_n161_), .b(new_n159_), .c(new_n62_), .O(z11));
  nand4  g111(.a(new_n156_), .b(new_n155_), .c(new_n147_), .d(new_n100_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n94_), .c(x31), .O(new_n164_));
  nand2  g113(.a(new_n104_), .b(new_n103_), .O(new_n165_));
  inv1   g114(.a(new_n165_), .O(new_n166_));
  nor2   g115(.a(x31), .b(x30), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n148_), .O(new_n168_));
  inv1   g117(.a(new_n168_), .O(new_n169_));
  nand4  g118(.a(new_n169_), .b(new_n129_), .c(new_n166_), .d(new_n68_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(new_n164_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(x16), .O(new_n172_));
  inv1   g121(.a(x03), .O(new_n173_));
  aoi21  g122(.a(new_n71_), .b(new_n173_), .c(x18), .O(new_n174_));
  aoi21  g123(.a(new_n174_), .b(new_n172_), .c(new_n62_), .O(z12));
  inv1   g124(.a(x25), .O(new_n176_));
  nor2   g125(.a(x27), .b(x26), .O(new_n177_));
  nand4  g126(.a(new_n167_), .b(new_n148_), .c(new_n177_), .d(new_n176_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n105_), .c(x32), .O(new_n179_));
  nand2  g128(.a(new_n155_), .b(new_n147_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nor2   g130(.a(x32), .b(x31), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n156_), .O(new_n183_));
  inv1   g132(.a(new_n183_), .O(new_n184_));
  nand4  g133(.a(new_n184_), .b(new_n181_), .c(new_n166_), .d(new_n68_), .O(new_n185_));
  ...
  aoi21  g138(.a(new_n189_), .b(new_n187_), .c(new_n62_), .O(z13));
  nand4  g139(.a(new_n182_), .b(new_n156_), .c(new_n155_), .d(new_n147_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n105_), .c(x33), .O(new_n192_));
  nor2   g141(.a(x33), .b(x32), .O(new_n193_));
  nand4  g142(.a(new_n193_), .b(new_n167_), .c(new_n148_), .d(new_n177_), .O(new_n194_));
  oai21  g143(.a(new_n194_), .b(new_n114_), .c(new_n192_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(x16), .O(new_n196_));
  nor2   g145(.a(x16), .b(x01), .O(new_n197_));
  nor2   g146(.a(new_n197_), .b(new_n62_), .O(new_n198_));
  nand3  g147(.a(new_n198_), .b(new_n196_), .c(new_n74_), .O(z14));
  oai21  g148(.a(new_n194_), .b(new_n114_), .c(x34), .O(new_n200_));
  nand4  g149(.a(new_n176_), .b(new_n100_), .c(new_n91_), .d(new_n82_), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n76_), .O(new_n202_));
  nand2  g151(.a(new_n148_), .b(new_n177_), .O(new_n203_));
  ...
  nand3  g161(.a(new_n212_), .b(new_n204_), .c(new_n202_), .O(new_n213_));
  nand2  g162(.a(new_n213_), .b(new_n200_), .O(new_n214_));
  nand2  g163(.a(new_n214_), .b(x16), .O(new_n215_));
  inv1   g164(.a(x00), .O(new_n216_));
  aoi21  g165(.a(new_n71_), .b(new_n216_), .c(x18), .O(new_n217_));
  aoi21  g166(.a(new_n217_), .b(new_n215_), .c(new_n62_), .O(z15));
endmodule
