...
module FAU ( 
  ...
  aoi21  g011(.a(new_n61_), .b(x18), .c(new_n62_), .O(new_n63_));
  ...
  oai21  g027(.a(new_n78_), .b(x15), .c(x28), .O(new_n79_));
  ...
  oai21  g034(.a(new_n85_), .b(new_n84_), .c(new_n65_), .O(new_n86_));
  nand2  g035(.a(new_n76_), .b(new_n52_), .O(new_n87_));
  ...
  oai21  g044(.a(new_n95_), .b(new_n94_), .c(new_n65_), .O(new_n96_));
  inv1   g045(.a(x22), .O(new_n97_));
  oai21  g046(.a(new_n74_), .b(x15), .c(x28), .O(new_n98_));
  ...
  oai21  g057(.a(x28), .b(new_n73_), .c(new_n52_), .O(new_n109_));
  ...
  nand2  g081(.a(new_n53_), .b(new_n132_), .O(new_n133_));
  nand4  g082(.a(new_n133_), .b(new_n131_), .c(new_n65_), .d(new_n68_), .O(z06));
  ...
  oai21  g087(.a(new_n138_), .b(new_n137_), .c(new_n65_), .O(new_n139_));
  inv1   g088(.a(x27), .O(new_n140_));
  oai21  g089(.a(x28), .b(new_n140_), .c(new_n52_), .O(new_n141_));
  ...
  nand4  g108(.a(new_n159_), .b(new_n157_), .c(new_n152_), .d(new_n65_), .O(z08));
  ...
  aoi21  g116(.a(new_n165_), .b(new_n52_), .c(new_n167_), .O(new_n168_));
  nand3  g117(.a(x28), .b(x23), .c(new_n52_), .O(new_n169_));
  oai21  g118(.a(new_n168_), .b(x23), .c(new_n169_), .O(new_n170_));
  nor2   g119(.a(new_n75_), .b(x15), .O(new_n171_));
  aoi21  g120(.a(new_n170_), .b(new_n97_), .c(new_n171_), .O(new_n172_));
  nand2  g121(.a(new_n77_), .b(new_n52_), .O(new_n173_));
  oai21  g122(.a(new_n172_), .b(x21), .c(new_n173_), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n66_), .c(new_n56_), .d(new_n55_), .O(new_n175_));
  nand3  g124(.a(new_n153_), .b(new_n59_), .c(new_n66_), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(x28), .c(new_n52_), .O(new_n177_));
  nand2  g126(.a(new_n177_), .b(new_n175_), .O(new_n178_));
  nand2  g127(.a(new_n178_), .b(x16), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n162_), .O(z09));
  oai21  g129(.a(x16), .b(x05), .c(new_n68_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n65_), .O(new_n182_));
  inv1   g131(.a(new_n150_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(new_n120_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n104_), .c(x29), .O(new_n185_));
  inv1   g134(.a(new_n104_), .O(new_n186_));
  nor2   g135(.a(new_n129_), .b(x23), .O(new_n187_));
  nor2   g136(.a(x29), .b(x27), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n163_), .O(new_n189_));
  aoi21  g138(.a(new_n189_), .b(new_n185_), .c(x28), .O(new_n190_));
  nand2  g139(.a(x29), .b(x28), .O(new_n191_));
  nor2   g140(.a(new_n191_), .b(x15), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n190_), .c(x16), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n182_), .O(z10));
  oai21  g143(.a(x16), .b(x04), .c(new_n68_), .O(new_n195_));
  nand2  g144(.a(new_n195_), .b(new_n65_), .O(new_n196_));
  nand2  g145(.a(new_n189_), .b(x30), .O(new_n197_));
  nor2   g146(.a(x30), .b(x29), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n155_), .c(new_n117_), .d(new_n140_), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n197_), .c(x28), .O(new_n200_));
  inv1   g149(.a(x30), .O(new_n201_));
  nor3   g150(.a(new_n201_), .b(new_n61_), .c(x15), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n200_), .c(x16), .O(new_n203_));
  nand2  g152(.a(new_n203_), .b(new_n196_), .O(z11));
  nand3  g153(.a(x31), .b(x28), .c(x16), .O(new_n205_));
  nand2  g154(.a(new_n205_), .b(new_n68_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(new_n52_), .O(new_n207_));
  nand4  g156(.a(new_n115_), .b(new_n91_), .c(new_n59_), .d(x16), .O(new_n208_));
  inv1   g157(.a(x31), .O(new_n209_));
  nand4  g158(.a(new_n188_), .b(new_n155_), .c(new_n209_), .d(new_n201_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n208_), .c(new_n68_), .O(new_n211_));
  nand2  g160(.a(new_n211_), .b(new_n61_), .O(new_n212_));
  nand3  g161(.a(new_n199_), .b(x31), .c(x16), .O(new_n213_));
  nor2   g162(.a(x16), .b(x03), .O(new_n214_));
  nor2   g163(.a(new_n214_), .b(new_n62_), .O(new_n215_));
  nand4  g164(.a(new_n215_), .b(new_n213_), .c(new_n212_), .d(new_n207_), .O(z12));
  nand3  g165(.a(x32), .b(x28), .c(x16), .O(new_n217_));
  ...
  nand3  g170(.a(new_n198_), .b(new_n221_), .c(new_n209_), .O(new_n222_));
  inv1   g171(.a(new_n222_), .O(new_n223_));
  nand3  g172(.a(new_n223_), .b(new_n149_), .c(new_n220_), .O(new_n224_));
  oai21  g173(.a(new_n224_), .b(new_n208_), .c(new_n68_), .O(new_n225_));
  nand2  g174(.a(new_n225_), .b(new_n61_), .O(new_n226_));
  inv1   g175(.a(new_n210_), .O(new_n227_));
  nand2  g176(.a(new_n227_), .b(new_n117_), .O(new_n228_));
  nand3  g177(.a(new_n228_), .b(x32), .c(x16), .O(new_n229_));
  nor2   g178(.a(x16), .b(x02), .O(new_n230_));
  nor2   g179(.a(new_n230_), .b(new_n62_), .O(new_n231_));
  nand4  g180(.a(new_n231_), .b(new_n229_), .c(new_n226_), .d(new_n219_), .O(z13));
  oai21  g181(.a(x16), .b(x01), .c(new_n68_), .O(new_n233_));
  nand2  g182(.a(new_n233_), .b(new_n65_), .O(new_n234_));
  nand3  g183(.a(new_n223_), .b(new_n183_), .c(new_n122_), .O(new_n235_));
  nand2  g184(.a(new_n235_), .b(x33), .O(new_n236_));
  inv1   g185(.a(x33), .O(new_n237_));
  nand4  g186(.a(new_n237_), .b(new_n221_), .c(new_n209_), .d(new_n201_), .O(new_n238_));
  inv1   g187(.a(new_n238_), .O(new_n239_));
  nand4  g188(.a(new_n239_), .b(new_n188_), .c(new_n153_), .d(new_n122_), .O(new_n240_));
  aoi21  g189(.a(new_n240_), .b(new_n236_), .c(x28), .O(new_n241_));
  nor3   g190(.a(new_n237_), .b(new_n61_), .c(x15), .O(new_n242_));
  oai21  g191(.a(new_n242_), .b(new_n241_), .c(x16), .O(new_n243_));
  nand2  g192(.a(new_n243_), .b(new_n234_), .O(z14));
  oai21  g193(.a(x16), .b(x00), .c(new_n68_), .O(new_n245_));
  nand2  g194(.a(new_n245_), .b(new_n65_), .O(new_n246_));
  nand2  g195(.a(new_n240_), .b(x34), .O(new_n247_));
  inv1   g196(.a(x34), .O(new_n248_));
  nand4  g197(.a(new_n248_), .b(new_n237_), .c(new_n221_), .d(new_n209_), .O(new_n249_));
  inv1   g198(.a(new_n249_), .O(new_n250_));
  nand4  g199(.a(new_n250_), .b(new_n198_), .c(new_n149_), .d(new_n130_), .O(new_n251_));
  aoi21  g200(.a(new_n251_), .b(new_n247_), .c(x28), .O(new_n252_));
  nor3   g201(.a(new_n248_), .b(new_n61_), .c(x15), .O(new_n253_));
