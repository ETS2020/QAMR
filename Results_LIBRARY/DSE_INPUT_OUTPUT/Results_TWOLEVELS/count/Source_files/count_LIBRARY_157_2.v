...
module FAU ( 
  ...
  nand3  g044(.a(new_n70_), .b(new_n57_), .c(new_n95_), .O(new_n96_));
  ...
  oai21  g066(.a(x18), .b(new_n70_), .c(new_n95_), .O(new_n118_));
  ...
  aoi21  g072(.a(x18), .b(x11), .c(new_n60_), .O(new_n124_));
  ...
  nand4  g096(.a(new_n147_), .b(new_n146_), .c(new_n101_), .d(new_n145_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  inv1   g099(.a(x05), .O(new_n151_));
  aoi21  g100(.a(new_n70_), .b(new_n151_), .c(x18), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n150_), .c(new_n60_), .O(z10));
  nand4  g102(.a(new_n147_), .b(new_n120_), .c(new_n145_), .d(new_n98_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n92_), .c(x30), .O(new_n155_));
  nor2   g104(.a(x28), .b(x27), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n156_), .c(new_n146_), .d(new_n101_), .O(new_n158_));
  ...
  nand2  g116(.a(new_n167_), .b(new_n147_), .O(new_n168_));
  ...
  nand3  g124(.a(new_n167_), .b(new_n147_), .c(new_n128_), .O(new_n176_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n167_), .c(new_n147_), .d(new_n190_), .O(new_n192_));
  ...
  nand2  g149(.a(new_n147_), .b(new_n190_), .O(new_n201_));
