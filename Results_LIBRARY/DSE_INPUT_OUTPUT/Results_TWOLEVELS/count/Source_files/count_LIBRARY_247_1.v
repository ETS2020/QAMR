...
module FAU ( 
  ...
  oai21  g011(.a(new_n52_), .b(x06), .c(x18), .O(new_n63_));
  ...
  nand3  g029(.a(new_n80_), .b(new_n57_), .c(new_n64_), .O(new_n81_));
  ...
  nand3  g053(.a(new_n104_), .b(new_n102_), .c(new_n63_), .O(z05));
  inv1   g054(.a(x25), .O(new_n106_));
  nand2  g055(.a(new_n99_), .b(new_n80_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(new_n55_), .O(new_n108_));
  aoi21  g057(.a(new_n108_), .b(new_n66_), .c(new_n106_), .O(new_n109_));
  nor2   g058(.a(x25), .b(x24), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n89_), .c(new_n72_), .d(new_n57_), .O(new_n111_));
  ...
  nand3  g066(.a(new_n110_), .b(new_n80_), .c(new_n88_), .O(new_n118_));
  ...
  nand2  g070(.a(new_n121_), .b(new_n89_), .O(new_n122_));
  ...
  nand2  g078(.a(new_n129_), .b(new_n95_), .O(new_n130_));
  oai21  g079(.a(new_n130_), .b(new_n97_), .c(new_n55_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n66_), .c(new_n128_), .O(new_n132_));
  nor2   g081(.a(x27), .b(x26), .O(new_n133_));
  nand3  g082(.a(new_n133_), .b(new_n99_), .c(new_n106_), .O(new_n134_));
  ...
  aoi21  g086(.a(new_n60_), .b(new_n137_), .c(x18), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n136_), .c(new_n53_), .O(z08));
  inv1   g088(.a(x06), .O(new_n140_));
  oai21  g089(.a(new_n60_), .b(x11), .c(new_n140_), .O(new_n141_));
  inv1   g090(.a(x28), .O(new_n142_));
  nor2   g091(.a(x28), .b(x27), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n110_), .c(new_n117_), .d(new_n88_), .O(new_n144_));
  oai22  g093(.a(new_n144_), .b(new_n81_), .c(new_n135_), .d(new_n142_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n141_), .c(new_n63_), .O(z09));
  inv1   g096(.a(x29), .O(new_n148_));
  nand2  g097(.a(new_n143_), .b(new_n129_), .O(new_n149_));
  oai21  g098(.a(new_n149_), .b(new_n107_), .c(new_n55_), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n66_), .c(new_n148_), .O(new_n151_));
  nor2   g100(.a(x29), .b(x28), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n121_), .c(new_n128_), .O(new_n153_));
  ...
  aoi21  g105(.a(new_n60_), .b(new_n156_), .c(x18), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n155_), .c(new_n53_), .O(z10));
  inv1   g107(.a(x30), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n143_), .c(new_n121_), .d(new_n98_), .O(new_n161_));
  oai21  g110(.a(new_n154_), .b(new_n159_), .c(new_n161_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  nor2   g112(.a(x16), .b(x04), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n53_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n163_), .c(new_n63_), .O(z11));
  inv1   g115(.a(x31), .O(new_n167_));
  nand3  g116(.a(new_n160_), .b(new_n133_), .c(new_n142_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n118_), .c(new_n55_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n66_), .c(new_n167_), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n152_), .c(new_n133_), .d(new_n106_), .O(new_n172_));
  ...
  oai21  g126(.a(new_n172_), .b(new_n100_), .c(x32), .O(new_n178_));
  nor2   g127(.a(x32), .b(x31), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n160_), .c(new_n143_), .d(new_n129_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n100_), .c(new_n178_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(x16), .O(new_n182_));
  nor2   g131(.a(x16), .b(x02), .O(new_n183_));
  nor2   g132(.a(new_n183_), .b(new_n53_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n182_), .c(new_n63_), .O(z13));
  oai21  g134(.a(new_n180_), .b(new_n100_), .c(x33), .O(new_n186_));
  nand2  g135(.a(new_n152_), .b(new_n133_), .O(new_n187_));
  ...
  nand2  g139(.a(new_n190_), .b(new_n112_), .O(new_n191_));
  ...
  nand3  g144(.a(new_n195_), .b(new_n193_), .c(new_n63_), .O(z14));
  nand2  g145(.a(new_n191_), .b(x34), .O(new_n197_));
  inv1   g146(.a(new_n187_), .O(new_n198_));
  nor3   g147(.a(x34), .b(x33), .c(x32), .O(new_n199_));
  nand4  g148(.a(new_n199_), .b(new_n198_), .c(new_n171_), .d(new_n112_), .O(new_n200_));
  ...
  nand3  g153(.a(new_n204_), .b(new_n202_), .c(new_n63_), .O(z15));
endmodule
