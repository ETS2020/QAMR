...
module FAU ( 
  ...
  oai21  g019(.a(x07), .b(new_n52_), .c(x18), .O(new_n71_));
  ...
  nand3  g049(.a(new_n100_), .b(new_n80_), .c(new_n66_), .O(new_n101_));
  ...
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n71_), .O(z05));
  inv1   g055(.a(x25), .O(new_n107_));
  nand2  g056(.a(new_n100_), .b(new_n80_), .O(new_n108_));
  nor2   g057(.a(new_n108_), .b(new_n65_), .O(new_n109_));
  ...
  nand3  g065(.a(new_n116_), .b(new_n114_), .c(new_n71_), .O(z06));
  inv1   g066(.a(x26), .O(new_n118_));
  inv1   g067(.a(new_n73_), .O(new_n119_));
  nor3   g068(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n92_), .c(new_n119_), .O(new_n121_));
  oai21  g070(.a(new_n113_), .b(new_n118_), .c(new_n121_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(x16), .O(new_n123_));
  nor2   g072(.a(x16), .b(x08), .O(new_n124_));
  nor2   g073(.a(new_n124_), .b(new_n53_), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n123_), .c(new_n71_), .O(z07));
  inv1   g075(.a(x07), .O(new_n127_));
  oai21  g076(.a(new_n60_), .b(x02), .c(new_n127_), .O(new_n128_));
  and2   g077(.a(new_n121_), .b(x27), .O(new_n129_));
  nand3  g078(.a(new_n80_), .b(new_n57_), .c(new_n63_), .O(new_n130_));
  ...
  nand3  g083(.a(new_n134_), .b(new_n128_), .c(new_n71_), .O(z08));
  ...
  nand3  g091(.a(new_n142_), .b(new_n140_), .c(new_n71_), .O(z09));
  nand3  g092(.a(new_n92_), .b(new_n66_), .c(new_n72_), .O(new_n144_));
  oai21  g093(.a(new_n138_), .b(new_n130_), .c(x29), .O(new_n145_));
  inv1   g094(.a(x27), .O(new_n146_));
  nor2   g095(.a(x29), .b(x28), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n120_), .c(new_n146_), .O(new_n148_));
  ...
  nand3  g101(.a(new_n152_), .b(new_n150_), .c(new_n71_), .O(z10));
  inv1   g102(.a(x30), .O(new_n154_));
  nor2   g103(.a(x26), .b(x25), .O(new_n155_));
  nand3  g104(.a(new_n147_), .b(new_n155_), .c(new_n146_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n108_), .c(new_n55_), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n66_), .c(new_n154_), .O(new_n158_));
  nor2   g107(.a(x30), .b(x29), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n137_), .c(new_n120_), .O(new_n160_));
  ...
  nand3  g115(.a(new_n111_), .b(new_n80_), .c(new_n89_), .O(new_n167_));
  nand3  g116(.a(new_n159_), .b(new_n131_), .c(new_n136_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n167_), .c(new_n55_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n66_), .c(new_n166_), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n147_), .c(new_n131_), .d(new_n107_), .O(new_n172_));
  ...
  oai21  g126(.a(x18), .b(new_n60_), .c(new_n52_), .O(new_n178_));
  inv1   g127(.a(x32), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n159_), .O(new_n181_));
  inv1   g130(.a(new_n181_), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n137_), .c(new_n155_), .d(new_n109_), .O(new_n183_));
  oai21  g132(.a(new_n173_), .b(new_n179_), .c(new_n183_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(x16), .O(new_n185_));
  aoi21  g134(.a(x18), .b(x07), .c(new_n53_), .O(new_n186_));
  nand3  g135(.a(new_n186_), .b(new_n185_), .c(new_n178_), .O(z13));
  inv1   g136(.a(x33), .O(new_n188_));
  nand4  g137(.a(new_n155_), .b(new_n92_), .c(new_n99_), .d(new_n72_), .O(new_n189_));
  nand4  g138(.a(new_n180_), .b(new_n147_), .c(new_n154_), .d(new_n146_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n189_), .c(new_n55_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n66_), .c(new_n188_), .O(new_n192_));
  inv1   g141(.a(new_n112_), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n119_), .O(new_n194_));
  nand2  g143(.a(new_n147_), .b(new_n131_), .O(new_n195_));
  ...
  oai21  g148(.a(new_n199_), .b(new_n192_), .c(x16), .O(new_n200_));
  ...
  oai21  g152(.a(new_n198_), .b(new_n194_), .c(x34), .O(new_n204_));
  nor3   g153(.a(x34), .b(x33), .c(x32), .O(new_n205_));
  nand4  g154(.a(new_n205_), .b(new_n196_), .c(new_n171_), .d(new_n113_), .O(new_n206_));
  ...
  nand3  g159(.a(new_n210_), .b(new_n208_), .c(new_n71_), .O(z15));
endmodule
