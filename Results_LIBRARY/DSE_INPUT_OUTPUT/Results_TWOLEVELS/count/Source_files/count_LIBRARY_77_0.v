...
module FAU ( 
  ...
  wire new_n52_, new_n53_, new_n54_, new_n55_, new_n56_, new_n57_, new_n58_,
    ...
    new_n205_, new_n206_;
  nor2   g000(.a(x14), .b(x03), .O(new_n52_));
  ...
  oai21  g010(.a(new_n57_), .b(new_n60_), .c(new_n61_), .O(new_n62_));
  inv1   g011(.a(new_n52_), .O(new_n63_));
  nand2  g012(.a(new_n63_), .b(x18), .O(new_n64_));
  inv1   g013(.a(x20), .O(new_n65_));
  nor2   g014(.a(new_n54_), .b(new_n65_), .O(new_n66_));
  nor3   g015(.a(x20), .b(x19), .c(x17), .O(new_n67_));
  oai21  g016(.a(new_n67_), .b(new_n66_), .c(x16), .O(new_n68_));
  nand3  g017(.a(new_n68_), .b(new_n64_), .c(new_n62_), .O(z01));
  inv1   g018(.a(x21), .O(new_n70_));
  nor2   g019(.a(x21), .b(x20), .O(new_n71_));
  nand2  g020(.a(new_n71_), .b(new_n54_), .O(new_n72_));
  oai21  g021(.a(new_n67_), .b(new_n70_), .c(new_n72_), .O(new_n73_));
  ...
  aoi21  g033(.a(new_n57_), .b(new_n84_), .c(x18), .O(new_n85_));
  aoi21  g034(.a(new_n85_), .b(new_n83_), .c(new_n52_), .O(z03));
  ...
  nand4  g039(.a(new_n90_), .b(new_n89_), .c(new_n70_), .d(new_n88_), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(new_n87_), .O(new_n92_));
  nand2  g041(.a(new_n92_), .b(x16), .O(new_n93_));
  nor2   g042(.a(x16), .b(x11), .O(new_n94_));
  nor2   g043(.a(new_n94_), .b(new_n52_), .O(new_n95_));
  nand3  g044(.a(new_n95_), .b(new_n93_), .c(new_n64_), .O(z04));
  inv1   g045(.a(x24), .O(new_n97_));
  inv1   g046(.a(new_n91_), .O(new_n98_));
  nor2   g047(.a(x24), .b(x23), .O(new_n99_));
  nand3  g048(.a(new_n99_), .b(new_n80_), .c(new_n67_), .O(new_n100_));
  ...
  aoi21  g052(.a(new_n57_), .b(new_n103_), .c(x18), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n102_), .c(new_n52_), .O(z05));
  inv1   g054(.a(x25), .O(new_n106_));
  nand2  g055(.a(new_n89_), .b(new_n88_), .O(new_n107_));
  inv1   g056(.a(x23), .O(new_n108_));
  nand4  g057(.a(new_n97_), .b(new_n108_), .c(new_n78_), .d(new_n70_), .O(new_n109_));
  nor2   g058(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n90_), .c(new_n71_), .d(new_n54_), .O(new_n112_));
  oai21  g061(.a(new_n110_), .b(new_n106_), .c(new_n112_), .O(new_n113_));
  nand2  g062(.a(new_n113_), .b(x16), .O(new_n114_));
  inv1   g063(.a(x09), .O(new_n115_));
  aoi21  g064(.a(new_n57_), .b(new_n115_), .c(x18), .O(new_n116_));
  ...
  oai22  g070(.a(new_n121_), .b(new_n72_), .c(new_n119_), .d(new_n118_), .O(new_n122_));
  ...
  oai21  g075(.a(new_n121_), .b(new_n72_), .c(x27), .O(new_n127_));
  nor3   g076(.a(x22), .b(x21), .c(x20), .O(new_n128_));
  nor3   g077(.a(x27), .b(x26), .c(x25), .O(new_n129_));
  nand4  g078(.a(new_n129_), .b(new_n99_), .c(new_n128_), .d(new_n54_), .O(new_n130_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n111_), .c(new_n118_), .d(new_n108_), .O(new_n138_));
  oai21  g087(.a(new_n138_), .b(new_n81_), .c(new_n136_), .O(new_n139_));
  ...
  oai21  g092(.a(new_n138_), .b(new_n81_), .c(x29), .O(new_n144_));
  inv1   g093(.a(x27), .O(new_n145_));
  nor2   g094(.a(x29), .b(x28), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n120_), .c(new_n145_), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n91_), .c(new_n144_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(x16), .O(new_n149_));
  inv1   g098(.a(x05), .O(new_n150_));
  aoi21  g099(.a(new_n57_), .b(new_n150_), .c(x18), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n149_), .c(new_n52_), .O(z10));
  oai21  g101(.a(new_n147_), .b(new_n91_), .c(x30), .O(new_n153_));
  nor2   g102(.a(x26), .b(x25), .O(new_n154_));
  nor2   g103(.a(x30), .b(x29), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n137_), .c(new_n154_), .d(new_n97_), .O(new_n156_));
  or2    g105(.a(new_n156_), .b(new_n91_), .O(new_n157_));
  ...
  aoi21  g110(.a(new_n161_), .b(new_n159_), .c(new_n52_), .O(z11));
  oai21  g111(.a(new_n156_), .b(new_n91_), .c(x31), .O(new_n163_));
  inv1   g112(.a(new_n109_), .O(new_n164_));
  ...
  nand4  g119(.a(new_n170_), .b(new_n129_), .c(new_n164_), .d(new_n67_), .O(new_n171_));
  aoi21  g120(.a(new_n171_), .b(new_n163_), .c(new_n57_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(x18), .c(new_n63_), .O(new_n173_));
  nand3  g122(.a(new_n57_), .b(x14), .c(new_n60_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n173_), .O(z12));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n146_), .c(new_n129_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n100_), .c(x32), .O(new_n178_));
  nor2   g127(.a(x32), .b(x31), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n155_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n137_), .c(new_n154_), .d(new_n110_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(x16), .O(new_n184_));
  inv1   g133(.a(x02), .O(new_n185_));
  aoi21  g134(.a(new_n57_), .b(new_n185_), .c(x18), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n184_), .c(new_n52_), .O(z13));
  nand4  g136(.a(new_n179_), .b(new_n155_), .c(new_n137_), .d(new_n154_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n100_), .c(x33), .O(new_n189_));
  nor2   g138(.a(x27), .b(x26), .O(new_n190_));
  nor2   g139(.a(x33), .b(x32), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n176_), .c(new_n146_), .d(new_n190_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n112_), .c(new_n189_), .O(new_n193_));
  ...
  oai21  g146(.a(new_n192_), .b(new_n112_), .c(x34), .O(new_n198_));
  nand2  g147(.a(new_n146_), .b(new_n190_), .O(new_n199_));
  inv1   g148(.a(new_n199_), .O(new_n200_));
  nor3   g149(.a(x34), .b(x33), .c(x32), .O(new_n201_));
  nand3  g150(.a(new_n201_), .b(new_n200_), .c(new_n176_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n112_), .c(new_n198_), .O(new_n203_));
  nand2  g152(.a(new_n203_), .b(x16), .O(new_n204_));
  nor2   g153(.a(x16), .b(x00), .O(new_n205_));
  nor2   g154(.a(new_n205_), .b(new_n52_), .O(new_n206_));
  nand3  g155(.a(new_n206_), .b(new_n204_), .c(new_n64_), .O(z15));
endmodule
