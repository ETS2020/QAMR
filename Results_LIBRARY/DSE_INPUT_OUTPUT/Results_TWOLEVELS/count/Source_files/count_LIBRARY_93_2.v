...
module FAU ( 
  ...
  oai21  g002(.a(new_n53_), .b(x00), .c(new_n52_), .O(new_n54_));
  ...
  aoi21  g025(.a(new_n76_), .b(new_n74_), .c(new_n63_), .O(z02));
  ...
  nand4  g039(.a(new_n90_), .b(new_n89_), .c(new_n71_), .d(new_n55_), .O(new_n91_));
  ...
  nand3  g053(.a(new_n104_), .b(new_n102_), .c(new_n61_), .O(z05));
  ...
  nand3  g062(.a(new_n113_), .b(new_n111_), .c(new_n61_), .O(z06));
  ...
  aoi21  g070(.a(new_n121_), .b(new_n119_), .c(new_n63_), .O(z07));
  ...
  nand3  g078(.a(new_n129_), .b(new_n127_), .c(new_n61_), .O(z08));
  ...
  nand3  g087(.a(new_n138_), .b(new_n136_), .c(new_n61_), .O(z09));
  ...
  nor2   g094(.a(new_n145_), .b(new_n63_), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n144_), .c(new_n61_), .O(z10));
  ...
  nand3  g105(.a(new_n156_), .b(new_n154_), .c(new_n61_), .O(z11));
  ...
  nand4  g109(.a(new_n97_), .b(new_n87_), .c(new_n78_), .d(new_n71_), .O(new_n161_));
  ...
  nand4  g117(.a(new_n168_), .b(new_n124_), .c(new_n162_), .d(new_n66_), .O(new_n169_));
  ...
  nand4  g136(.a(new_n187_), .b(new_n184_), .c(new_n162_), .d(new_n66_), .O(new_n188_));
  ...
  aoi21  g141(.a(new_n192_), .b(new_n190_), .c(new_n63_), .O(z13));
  ...
  aoi21  g157(.a(new_n208_), .b(new_n206_), .c(new_n63_), .O(z14));
  oai21  g158(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n210_));
  nor2   g159(.a(x33), .b(x32), .O(new_n211_));
  nand4  g160(.a(new_n211_), .b(new_n178_), .c(new_n177_), .d(new_n176_), .O(new_n212_));
  oai21  g161(.a(new_n212_), .b(new_n109_), .c(x34), .O(new_n213_));
  nor3   g162(.a(x34), .b(x33), .c(x32), .O(new_n214_));
  nand3  g163(.a(new_n214_), .b(new_n200_), .c(new_n178_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n109_), .c(new_n213_), .O(new_n216_));
  nand2  g165(.a(new_n216_), .b(x16), .O(new_n217_));
  aoi21  g166(.a(x18), .b(x15), .c(new_n63_), .O(new_n218_));
  nand3  g167(.a(new_n218_), .b(new_n217_), .c(new_n210_), .O(z15));
endmodule
