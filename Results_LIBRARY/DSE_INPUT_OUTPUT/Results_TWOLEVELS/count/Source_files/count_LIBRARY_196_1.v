...
module FAU ( 
  ...
  nand2  g006(.a(x18), .b(x14), .O(new_n58_));
  ...
  aoi21  g059(.a(new_n110_), .b(new_n60_), .c(new_n54_), .O(new_n111_));
  ...
  aoi21  g070(.a(new_n121_), .b(new_n64_), .c(new_n66_), .O(new_n122_));
  ...
  oai21  g076(.a(new_n127_), .b(x18), .c(new_n58_), .O(z07));
  ...
  oai21  g085(.a(new_n136_), .b(x18), .c(new_n58_), .O(z08));
  ...
  aoi21  g100(.a(new_n151_), .b(new_n64_), .c(new_n66_), .O(new_n152_));
  ...
  oai21  g106(.a(new_n157_), .b(x18), .c(new_n58_), .O(z10));
  inv1   g107(.a(x30), .O(new_n159_));
  nand2  g108(.a(new_n153_), .b(new_n149_), .O(new_n160_));
  oai21  g109(.a(new_n160_), .b(new_n110_), .c(new_n60_), .O(new_n161_));
  ...
  nor3   g113(.a(new_n164_), .b(new_n90_), .c(new_n66_), .O(new_n165_));
  ...
  oai21  g120(.a(new_n171_), .b(new_n110_), .c(new_n60_), .O(new_n172_));
  ...
  nor3   g125(.a(new_n176_), .b(new_n102_), .c(new_n66_), .O(new_n177_));
  ...
  aoi21  g133(.a(new_n184_), .b(new_n64_), .c(new_n66_), .O(new_n185_));
  ...
  oai21  g140(.a(new_n191_), .b(x18), .c(new_n58_), .O(z13));
