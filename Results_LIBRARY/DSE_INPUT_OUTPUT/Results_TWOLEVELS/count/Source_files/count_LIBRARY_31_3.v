...
module FAU ( 
  ...
  oai21  g029(.a(new_n80_), .b(x08), .c(x12), .O(new_n81_));
  ...
  nor2   g059(.a(new_n110_), .b(new_n60_), .O(new_n111_));
  nand3  g060(.a(new_n111_), .b(new_n109_), .c(new_n59_), .O(z05));
  inv1   g061(.a(x25), .O(new_n113_));
  nand2  g062(.a(new_n106_), .b(new_n83_), .O(new_n114_));
  ...
  aoi21  g070(.a(new_n80_), .b(new_n121_), .c(x18), .O(new_n122_));
  aoi21  g071(.a(new_n122_), .b(new_n120_), .c(new_n60_), .O(z06));
  oai21  g072(.a(new_n80_), .b(x12), .c(x08), .O(new_n124_));
  inv1   g073(.a(x26), .O(new_n125_));
  nand3  g074(.a(new_n117_), .b(new_n83_), .c(new_n92_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n53_), .O(new_n127_));
  aoi21  g076(.a(new_n127_), .b(new_n67_), .c(new_n125_), .O(new_n128_));
  ...
  oai21  g080(.a(new_n131_), .b(new_n128_), .c(new_n124_), .O(new_n132_));
  aoi22  g081(.a(new_n89_), .b(new_n57_), .c(x18), .d(new_n58_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n132_), .O(z07));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x26), .b(x25), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n95_), .c(new_n102_), .d(new_n72_), .O(new_n137_));
  nand2  g086(.a(new_n137_), .b(new_n53_), .O(new_n138_));
  aoi21  g087(.a(new_n138_), .b(new_n67_), .c(new_n135_), .O(new_n139_));
  nand3  g088(.a(new_n83_), .b(new_n55_), .c(new_n64_), .O(new_n140_));
  ...
  nand3  g095(.a(new_n146_), .b(new_n144_), .c(new_n59_), .O(z08));
  inv1   g096(.a(x28), .O(new_n148_));
  nand2  g097(.a(new_n141_), .b(new_n117_), .O(new_n149_));
  oai21  g098(.a(new_n149_), .b(new_n103_), .c(new_n53_), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n67_), .c(new_n148_), .O(new_n151_));
  nand2  g100(.a(new_n117_), .b(new_n92_), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nand2  g102(.a(new_n153_), .b(new_n125_), .O(new_n154_));
  ...
  nand3  g107(.a(new_n158_), .b(new_n156_), .c(new_n59_), .O(z09));
  inv1   g108(.a(x29), .O(new_n160_));
  nand4  g109(.a(new_n153_), .b(new_n136_), .c(new_n106_), .d(new_n83_), .O(new_n161_));
  aoi21  g110(.a(new_n161_), .b(new_n53_), .c(new_n66_), .O(new_n162_));
  nor2   g111(.a(x29), .b(x28), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n129_), .c(new_n135_), .O(new_n164_));
  oai22  g113(.a(new_n164_), .b(new_n96_), .c(new_n162_), .d(new_n160_), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(x16), .O(new_n166_));
  inv1   g115(.a(x05), .O(new_n167_));
  aoi21  g116(.a(new_n80_), .b(new_n167_), .c(x18), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n166_), .c(new_n60_), .O(z10));
  inv1   g118(.a(x30), .O(new_n170_));
  nand3  g119(.a(new_n163_), .b(new_n136_), .c(new_n135_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(new_n114_), .c(new_n53_), .O(new_n172_));
  aoi21  g121(.a(new_n172_), .b(new_n67_), .c(new_n170_), .O(new_n173_));
  ...
  nand3  g128(.a(new_n179_), .b(new_n177_), .c(new_n59_), .O(z11));
  inv1   g129(.a(x31), .O(new_n181_));
  nand3  g130(.a(new_n174_), .b(new_n141_), .c(new_n148_), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(new_n126_), .c(new_n53_), .O(new_n183_));
  aoi21  g132(.a(new_n183_), .b(new_n67_), .c(new_n181_), .O(new_n184_));
  nor2   g133(.a(x31), .b(x30), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n163_), .c(new_n141_), .d(new_n113_), .O(new_n186_));
  ...
  aoi21  g138(.a(new_n80_), .b(new_n189_), .c(x18), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n188_), .c(new_n60_), .O(z12));
  inv1   g140(.a(x32), .O(new_n192_));
  nand4  g141(.a(new_n185_), .b(new_n153_), .c(new_n160_), .d(new_n125_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n126_), .c(new_n53_), .O(new_n194_));
  aoi21  g143(.a(new_n194_), .b(new_n67_), .c(new_n192_), .O(new_n195_));
  nor2   g144(.a(x32), .b(x31), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n174_), .c(new_n153_), .d(new_n136_), .O(new_n197_));
  ...
  aoi21  g149(.a(new_n80_), .b(new_n200_), .c(x18), .O(new_n201_));
  aoi21  g150(.a(new_n201_), .b(new_n199_), .c(new_n60_), .O(z13));
  inv1   g151(.a(x33), .O(new_n203_));
  nand4  g152(.a(new_n196_), .b(new_n163_), .c(new_n170_), .d(new_n135_), .O(new_n204_));
  oai21  g153(.a(new_n204_), .b(new_n137_), .c(new_n53_), .O(new_n205_));
  aoi21  g154(.a(new_n205_), .b(new_n67_), .c(new_n203_), .O(new_n206_));
  nand2  g155(.a(new_n163_), .b(new_n141_), .O(new_n207_));
  nor2   g156(.a(x33), .b(x32), .O(new_n208_));
  nand2  g157(.a(new_n208_), .b(new_n185_), .O(new_n209_));
  nor3   g158(.a(new_n209_), .b(new_n207_), .c(new_n118_), .O(new_n210_));
  ...
  nand4  g164(.a(new_n208_), .b(new_n185_), .c(new_n163_), .d(new_n135_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n137_), .c(new_n53_), .O(new_n217_));
  ...
  nor3   g168(.a(new_n219_), .b(new_n207_), .c(new_n118_), .O(new_n220_));
  ...
  nand3  g172(.a(new_n223_), .b(new_n221_), .c(new_n59_), .O(z15));
endmodule
