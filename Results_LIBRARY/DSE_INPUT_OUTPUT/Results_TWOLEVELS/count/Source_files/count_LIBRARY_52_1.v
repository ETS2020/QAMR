...
module FAU ( 
  ...
  aoi21  g053(.a(x18), .b(x07), .c(new_n53_), .O(new_n105_));
  ...
  oai21  g066(.a(new_n52_), .b(x07), .c(x18), .O(new_n118_));
  inv1   g067(.a(x26), .O(new_n119_));
  nor2   g068(.a(new_n113_), .b(new_n119_), .O(new_n120_));
  ...
  nand3  g075(.a(new_n126_), .b(new_n124_), .c(new_n118_), .O(z07));
  inv1   g076(.a(x07), .O(new_n128_));
  oai21  g077(.a(new_n60_), .b(x10), .c(new_n128_), .O(new_n129_));
  inv1   g078(.a(x27), .O(new_n130_));
  nand3  g079(.a(new_n79_), .b(new_n57_), .c(new_n63_), .O(new_n131_));
  nor3   g080(.a(x27), .b(x26), .c(x25), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n101_), .O(new_n133_));
  oai22  g082(.a(new_n133_), .b(new_n131_), .c(new_n123_), .d(new_n130_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n129_), .c(new_n118_), .O(z08));
  oai21  g085(.a(new_n133_), .b(new_n131_), .c(x28), .O(new_n137_));
  nor2   g086(.a(x28), .b(x27), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n111_), .c(new_n119_), .d(new_n88_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n131_), .c(new_n137_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(x16), .O(new_n141_));
  nor2   g090(.a(x16), .b(x06), .O(new_n142_));
  nor2   g091(.a(new_n142_), .b(new_n53_), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n141_), .c(new_n118_), .O(z09));
  inv1   g093(.a(x29), .O(new_n145_));
  nor2   g094(.a(x26), .b(x25), .O(new_n146_));
  nand4  g095(.a(new_n138_), .b(new_n146_), .c(new_n101_), .d(new_n79_), .O(new_n147_));
  ...
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n118_), .O(z12));
  inv1   g123(.a(x32), .O(new_n175_));
  nand3  g124(.a(new_n111_), .b(new_n79_), .c(new_n88_), .O(new_n176_));
  ...
  nand4  g136(.a(new_n146_), .b(new_n92_), .c(new_n100_), .d(new_n70_), .O(new_n188_));
  inv1   g137(.a(x30), .O(new_n189_));
  nand4  g138(.a(new_n180_), .b(new_n167_), .c(new_n189_), .d(new_n130_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n188_), .c(new_n55_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n65_), .c(new_n187_), .O(new_n192_));
  nand3  g141(.a(new_n167_), .b(new_n130_), .c(new_n119_), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n168_), .O(new_n195_));
  nor3   g144(.a(new_n195_), .b(new_n193_), .c(new_n112_), .O(new_n196_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n168_), .c(new_n167_), .d(new_n130_), .O(new_n202_));
  ...
  nor3   g154(.a(new_n205_), .b(new_n193_), .c(new_n112_), .O(new_n206_));
