...
module FAU ( 
  ...
  nand3  g041(.a(new_n64_), .b(new_n53_), .c(new_n52_), .O(new_n93_));
  ...
  aoi21  g047(.a(new_n77_), .b(new_n98_), .c(x18), .O(new_n99_));
  ...
  aoi21  g057(.a(new_n77_), .b(new_n108_), .c(x18), .O(new_n109_));
  aoi21  g058(.a(new_n109_), .b(new_n107_), .c(new_n58_), .O(z05));
  inv1   g059(.a(x25), .O(new_n111_));
  nand2  g060(.a(new_n104_), .b(new_n81_), .O(new_n112_));
  ...
  aoi21  g068(.a(new_n77_), .b(new_n119_), .c(x18), .O(new_n120_));
  aoi21  g069(.a(new_n120_), .b(new_n118_), .c(new_n58_), .O(z06));
  inv1   g070(.a(x26), .O(new_n122_));
  nand3  g071(.a(new_n115_), .b(new_n81_), .c(new_n90_), .O(new_n123_));
  ...
  aoi21  g081(.a(x16), .b(x02), .c(new_n57_), .O(new_n133_));
  nor2   g082(.a(x26), .b(x25), .O(new_n134_));
  nand4  g083(.a(new_n134_), .b(new_n94_), .c(new_n101_), .d(new_n71_), .O(new_n135_));
  ...
  aoi22  g093(.a(new_n144_), .b(new_n57_), .c(x18), .d(x02), .O(new_n145_));
  oai21  g094(.a(new_n142_), .b(new_n133_), .c(new_n145_), .O(z08));
  ...
  aoi21  g105(.a(new_n77_), .b(new_n156_), .c(x18), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n155_), .c(new_n58_), .O(z09));
  inv1   g107(.a(x29), .O(new_n159_));
  nor2   g108(.a(x28), .b(x27), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n134_), .c(new_n104_), .d(new_n81_), .O(new_n161_));
  aoi21  g110(.a(new_n161_), .b(new_n53_), .c(new_n93_), .O(new_n162_));
  inv1   g111(.a(x27), .O(new_n163_));
  nor2   g112(.a(x29), .b(x28), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n126_), .c(new_n96_), .d(new_n163_), .O(new_n165_));
  oai21  g114(.a(new_n162_), .b(new_n159_), .c(new_n165_), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(x16), .O(new_n167_));
  nor2   g116(.a(x16), .b(x05), .O(new_n168_));
  nor2   g117(.a(new_n168_), .b(new_n58_), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n167_), .c(new_n60_), .O(z10));
  inv1   g119(.a(x30), .O(new_n171_));
  nand3  g120(.a(new_n164_), .b(new_n134_), .c(new_n163_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n112_), .c(new_n53_), .O(new_n173_));
  aoi21  g122(.a(new_n173_), .b(new_n66_), .c(new_n171_), .O(new_n174_));
  nor2   g123(.a(x30), .b(x29), .O(new_n175_));
  nand3  g124(.a(new_n175_), .b(new_n160_), .c(new_n126_), .O(new_n176_));
  nor3   g125(.a(new_n176_), .b(new_n95_), .c(new_n93_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n174_), .c(x16), .O(new_n178_));
  inv1   g127(.a(x04), .O(new_n179_));
  aoi21  g128(.a(new_n77_), .b(new_n179_), .c(x18), .O(new_n180_));
  aoi21  g129(.a(new_n180_), .b(new_n178_), .c(new_n58_), .O(z11));
  inv1   g130(.a(x31), .O(new_n182_));
  nand3  g131(.a(new_n175_), .b(new_n139_), .c(new_n147_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n123_), .c(new_n53_), .O(new_n184_));
  aoi21  g133(.a(new_n184_), .b(new_n66_), .c(new_n182_), .O(new_n185_));
  nor2   g134(.a(x31), .b(x30), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n164_), .c(new_n139_), .d(new_n111_), .O(new_n187_));
  ...
  aoi21  g140(.a(new_n191_), .b(new_n189_), .c(new_n58_), .O(z12));
  nand2  g141(.a(new_n93_), .b(x32), .O(new_n193_));
  nor2   g142(.a(x32), .b(x31), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n175_), .c(new_n160_), .d(new_n134_), .O(new_n195_));
  ...
  oai21  g147(.a(x19), .b(new_n198_), .c(x07), .O(new_n199_));
  nor3   g148(.a(x31), .b(x30), .c(x29), .O(new_n200_));
  nand4  g149(.a(new_n200_), .b(new_n152_), .c(new_n151_), .d(new_n81_), .O(new_n201_));
  nand4  g150(.a(new_n201_), .b(new_n199_), .c(x32), .d(x16), .O(new_n202_));
  nand3  g151(.a(new_n77_), .b(new_n57_), .c(new_n198_), .O(new_n203_));
  and2   g152(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  oai21  g153(.a(new_n197_), .b(new_n58_), .c(new_n204_), .O(z13));
  inv1   g154(.a(x33), .O(new_n206_));
  nand4  g155(.a(new_n194_), .b(new_n164_), .c(new_n171_), .d(new_n163_), .O(new_n207_));
  ...
  nor3   g161(.a(new_n212_), .b(new_n210_), .c(new_n116_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n209_), .c(x16), .O(new_n214_));
  inv1   g163(.a(x01), .O(new_n215_));
  aoi21  g164(.a(new_n77_), .b(new_n215_), .c(x18), .O(new_n216_));
  aoi21  g165(.a(new_n216_), .b(new_n214_), .c(new_n58_), .O(z14));
  inv1   g166(.a(x34), .O(new_n218_));
  nand4  g167(.a(new_n211_), .b(new_n186_), .c(new_n164_), .d(new_n163_), .O(new_n219_));
  oai21  g168(.a(new_n219_), .b(new_n135_), .c(new_n53_), .O(new_n220_));
  aoi21  g169(.a(new_n220_), .b(new_n66_), .c(new_n218_), .O(new_n221_));
  inv1   g170(.a(x32), .O(new_n222_));
  nand4  g171(.a(new_n186_), .b(new_n218_), .c(new_n206_), .d(new_n222_), .O(new_n223_));
  nor3   g172(.a(new_n223_), .b(new_n210_), .c(new_n116_), .O(new_n224_));
  oai21  g173(.a(new_n224_), .b(new_n221_), .c(x16), .O(new_n225_));
  inv1   g174(.a(x00), .O(new_n226_));
  aoi21  g175(.a(new_n77_), .b(new_n226_), .c(x18), .O(new_n227_));
