...
module FAU ( 
  ...
  oai21  g033(.a(new_n84_), .b(new_n58_), .c(new_n77_), .O(z03));
  inv1   g034(.a(x11), .O(new_n86_));
  oai21  g035(.a(x18), .b(new_n86_), .c(new_n58_), .O(new_n87_));
  nor2   g036(.a(new_n80_), .b(x19), .O(new_n88_));
  oai21  g037(.a(new_n88_), .b(new_n63_), .c(x23), .O(new_n89_));
  ...
  nand3  g041(.a(new_n92_), .b(new_n78_), .c(x16), .O(new_n93_));
  ...
  aoi21  g047(.a(new_n98_), .b(new_n53_), .c(new_n63_), .O(new_n99_));
  nor2   g048(.a(x24), .b(x23), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n80_), .c(new_n64_), .O(new_n101_));
  oai21  g050(.a(new_n99_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand3  g051(.a(new_n102_), .b(new_n78_), .c(x16), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n96_), .O(z05));
  inv1   g053(.a(x25), .O(new_n105_));
  nand2  g054(.a(new_n100_), .b(new_n80_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(new_n53_), .O(new_n107_));
  aoi21  g056(.a(new_n107_), .b(new_n64_), .c(new_n105_), .O(new_n108_));
  nor2   g057(.a(x23), .b(x22), .O(new_n109_));
  nor2   g058(.a(x25), .b(x24), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n109_), .c(new_n69_), .d(new_n55_), .O(new_n111_));
  ...
  nand3  g069(.a(new_n110_), .b(new_n80_), .c(new_n120_), .O(new_n121_));
  aoi21  g070(.a(new_n121_), .b(new_n53_), .c(new_n63_), .O(new_n122_));
  nor3   g071(.a(x26), .b(x25), .c(x24), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n109_), .c(new_n71_), .O(new_n124_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n109_), .c(new_n97_), .d(new_n129_), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n53_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n64_), .c(new_n128_), .O(new_n133_));
  nand3  g082(.a(new_n80_), .b(new_n55_), .c(new_n61_), .O(new_n134_));
  nor2   g083(.a(x27), .b(x26), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n100_), .c(new_n105_), .O(new_n136_));
  ...
  nand4  g106(.a(new_n157_), .b(new_n130_), .c(new_n100_), .d(new_n80_), .O(new_n158_));
  ...
  oai22  g110(.a(new_n161_), .b(new_n91_), .c(new_n159_), .d(new_n156_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n78_), .c(x16), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n155_), .O(z10));
  inv1   g113(.a(x30), .O(new_n165_));
  nand2  g114(.a(new_n160_), .b(new_n130_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n106_), .c(new_n53_), .O(new_n167_));
  aoi21  g116(.a(new_n167_), .b(new_n64_), .c(new_n165_), .O(new_n168_));
  nor2   g117(.a(x30), .b(x29), .O(new_n169_));
  nand3  g118(.a(new_n169_), .b(new_n157_), .c(new_n123_), .O(new_n170_));
  ...
  oai21  g125(.a(x18), .b(new_n176_), .c(new_n58_), .O(new_n177_));
  inv1   g126(.a(x31), .O(new_n178_));
  nand3  g127(.a(new_n169_), .b(new_n135_), .c(new_n142_), .O(new_n179_));
  ...
  nand4  g132(.a(new_n183_), .b(new_n182_), .c(new_n135_), .d(new_n105_), .O(new_n184_));
  nor2   g133(.a(new_n184_), .b(new_n101_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n181_), .c(new_n78_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n58_), .c(new_n177_), .O(z12));
  inv1   g136(.a(x02), .O(new_n188_));
  oai21  g137(.a(x18), .b(new_n188_), .c(new_n58_), .O(new_n189_));
  inv1   g138(.a(x32), .O(new_n190_));
  nor3   g139(.a(x31), .b(x30), .c(x29), .O(new_n191_));
  nand4  g140(.a(new_n191_), .b(new_n147_), .c(new_n146_), .d(new_n80_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(new_n53_), .c(new_n63_), .O(new_n193_));
  nor2   g142(.a(new_n106_), .b(new_n63_), .O(new_n194_));
  nand2  g143(.a(new_n157_), .b(new_n130_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  nor2   g145(.a(x32), .b(x31), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n169_), .c(new_n196_), .d(new_n194_), .O(new_n198_));
  oai21  g147(.a(new_n193_), .b(new_n190_), .c(new_n198_), .O(new_n199_));
  nand3  g148(.a(new_n199_), .b(new_n78_), .c(x16), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n189_), .O(z13));
  inv1   g150(.a(x01), .O(new_n202_));
  oai21  g151(.a(x18), .b(new_n202_), .c(new_n58_), .O(new_n203_));
  inv1   g152(.a(x33), .O(new_n204_));
  nor3   g153(.a(x32), .b(x31), .c(x30), .O(new_n205_));
  nand4  g154(.a(new_n205_), .b(new_n160_), .c(new_n123_), .d(new_n90_), .O(new_n206_));
  aoi21  g155(.a(new_n206_), .b(new_n53_), .c(new_n63_), .O(new_n207_));
  nand2  g156(.a(new_n182_), .b(new_n135_), .O(new_n208_));
  inv1   g157(.a(new_n208_), .O(new_n209_));
  nor2   g158(.a(x33), .b(x32), .O(new_n210_));
  nand4  g159(.a(new_n210_), .b(new_n209_), .c(new_n183_), .d(new_n112_), .O(new_n211_));
  oai21  g160(.a(new_n207_), .b(new_n204_), .c(new_n211_), .O(new_n212_));
  nand3  g161(.a(new_n212_), .b(new_n78_), .c(x16), .O(new_n213_));
  nand2  g162(.a(new_n213_), .b(new_n203_), .O(z14));
  inv1   g163(.a(x00), .O(new_n215_));
  oai21  g164(.a(x18), .b(new_n215_), .c(new_n58_), .O(new_n216_));
  inv1   g165(.a(x34), .O(new_n217_));
  nand4  g166(.a(new_n210_), .b(new_n183_), .c(new_n182_), .d(new_n128_), .O(new_n218_));
  oai21  g167(.a(new_n218_), .b(new_n131_), .c(new_n53_), .O(new_n219_));
  aoi21  g168(.a(new_n219_), .b(new_n64_), .c(new_n217_), .O(new_n220_));
  nand4  g169(.a(new_n183_), .b(new_n217_), .c(new_n204_), .d(new_n190_), .O(new_n221_));
  nor3   g170(.a(new_n221_), .b(new_n208_), .c(new_n111_), .O(new_n222_));
  oai21  g171(.a(new_n222_), .b(new_n220_), .c(new_n78_), .O(new_n223_));
  oai21  g172(.a(new_n223_), .b(new_n58_), .c(new_n216_), .O(z15));
endmodule
