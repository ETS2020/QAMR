...
module FAU ( 
  ...
  nand3  g017(.a(new_n62_), .b(new_n68_), .c(x09), .O(new_n69_));
  ...
  aoi21  g026(.a(new_n77_), .b(new_n75_), .c(new_n57_), .O(z02));
  ...
  aoi21  g037(.a(new_n81_), .b(new_n55_), .c(new_n88_), .O(new_n89_));
  nand3  g038(.a(new_n88_), .b(new_n79_), .c(new_n71_), .O(new_n90_));
  ...
  aoi21  g043(.a(new_n94_), .b(new_n92_), .c(new_n57_), .O(z04));
  nand2  g044(.a(new_n61_), .b(x18), .O(new_n96_));
  ...
  nand3  g054(.a(new_n105_), .b(new_n103_), .c(new_n96_), .O(z05));
  ...
  oai21  g061(.a(new_n112_), .b(x18), .c(new_n61_), .O(new_n113_));
  inv1   g062(.a(x09), .O(new_n114_));
  nand3  g063(.a(new_n62_), .b(x14), .c(new_n114_), .O(new_n115_));
  nand2  g064(.a(new_n115_), .b(new_n113_), .O(z06));
  nand2  g065(.a(new_n111_), .b(x26), .O(new_n117_));
  nor3   g066(.a(x26), .b(x25), .c(x24), .O(new_n118_));
  nand3  g067(.a(new_n118_), .b(new_n109_), .c(new_n80_), .O(new_n119_));
  ...
  nand3  g072(.a(new_n123_), .b(new_n121_), .c(new_n96_), .O(z07));
  ...
  nand3  g080(.a(new_n131_), .b(new_n129_), .c(new_n96_), .O(z08));
  ...
  nand4  g091(.a(new_n109_), .b(new_n98_), .c(new_n71_), .d(new_n52_), .O(new_n143_));
  ...
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n118_), .d(new_n91_), .O(new_n156_));
  ...
  aoi21  g109(.a(new_n160_), .b(new_n158_), .c(new_n57_), .O(z11));
  ...
  nand4  g117(.a(new_n168_), .b(new_n126_), .c(new_n165_), .d(new_n72_), .O(new_n169_));
  ...
  nand3  g123(.a(new_n166_), .b(new_n146_), .c(new_n126_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n101_), .c(x32), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n155_), .c(new_n154_), .d(new_n145_), .O(new_n178_));
  ...
  nand3  g132(.a(new_n183_), .b(new_n181_), .c(new_n96_), .O(z13));
  oai21  g133(.a(new_n178_), .b(new_n101_), .c(x33), .O(new_n185_));
  inv1   g134(.a(x25), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n97_), .c(new_n88_), .d(new_n79_), .O(new_n187_));
