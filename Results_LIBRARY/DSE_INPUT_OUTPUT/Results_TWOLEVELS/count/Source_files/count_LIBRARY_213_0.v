...
module FAU ( 
  ...
  aoi21  g026(.a(new_n54_), .b(new_n77_), .c(new_n61_), .O(new_n78_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n82_), .c(new_n99_), .d(new_n56_), .O(new_n101_));
  ...
  aoi21  g053(.a(new_n54_), .b(new_n104_), .c(x18), .O(new_n105_));
  ...
  nand4  g059(.a(new_n110_), .b(new_n109_), .c(new_n73_), .d(new_n59_), .O(new_n111_));
  ...
  oai22  g069(.a(new_n120_), .b(new_n74_), .c(new_n118_), .d(new_n117_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(x16), .O(new_n122_));
  inv1   g071(.a(x08), .O(new_n123_));
  aoi21  g072(.a(new_n54_), .b(new_n123_), .c(x18), .O(new_n124_));
  aoi21  g073(.a(new_n124_), .b(new_n122_), .c(new_n61_), .O(z07));
  ...
  nand4  g077(.a(new_n128_), .b(new_n100_), .c(new_n127_), .d(new_n59_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(x16), .O(new_n131_));
  inv1   g080(.a(x07), .O(new_n132_));
  aoi21  g081(.a(new_n54_), .b(new_n132_), .c(x18), .O(new_n133_));
  aoi21  g082(.a(new_n133_), .b(new_n131_), .c(new_n61_), .O(z08));
  nand2  g083(.a(new_n129_), .b(x28), .O(new_n135_));
  nor3   g084(.a(x25), .b(x24), .c(x23), .O(new_n136_));
  nor3   g085(.a(x28), .b(x27), .c(x26), .O(new_n137_));
  nand4  g086(.a(new_n137_), .b(new_n136_), .c(new_n127_), .d(new_n59_), .O(new_n138_));
  ...
  aoi21  g091(.a(new_n142_), .b(new_n140_), .c(new_n61_), .O(z09));
  inv1   g092(.a(x23), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n110_), .c(new_n117_), .d(new_n144_), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n83_), .c(x29), .O(new_n147_));
  nor3   g096(.a(x29), .b(x28), .c(x27), .O(new_n148_));
  nand4  g097(.a(new_n148_), .b(new_n119_), .c(new_n90_), .d(new_n67_), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n147_), .c(new_n54_), .O(new_n150_));
  oai21  g099(.a(new_n150_), .b(x18), .c(new_n62_), .O(new_n151_));
  nand3  g100(.a(new_n54_), .b(x15), .c(new_n52_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(new_n151_), .O(z10));
  nand2  g102(.a(new_n149_), .b(x30), .O(new_n154_));
  nor2   g103(.a(x26), .b(x25), .O(new_n155_));
  nor2   g104(.a(x30), .b(x29), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n145_), .c(new_n155_), .d(new_n97_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n91_), .c(new_n154_), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(x16), .O(new_n159_));
  nor2   g108(.a(x16), .b(x04), .O(new_n160_));
  nor2   g109(.a(new_n160_), .b(new_n61_), .O(new_n161_));
  ...
  nand3  g116(.a(new_n167_), .b(new_n128_), .c(new_n108_), .O(new_n168_));
  ...
  aoi21  g121(.a(new_n172_), .b(new_n170_), .c(new_n61_), .O(z12));
  nor2   g122(.a(x27), .b(x26), .O(new_n174_));
  nand4  g123(.a(new_n165_), .b(new_n164_), .c(new_n174_), .d(new_n107_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n101_), .c(x32), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n156_), .c(new_n145_), .d(new_n155_), .O(new_n178_));
  oai21  g127(.a(new_n178_), .b(new_n101_), .c(new_n176_), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(x16), .O(new_n180_));
  inv1   g129(.a(x02), .O(new_n181_));
  aoi21  g130(.a(new_n54_), .b(new_n181_), .c(x18), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n180_), .c(new_n61_), .O(z13));
  oai21  g132(.a(new_n178_), .b(new_n101_), .c(x33), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n165_), .c(new_n164_), .d(new_n174_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n111_), .c(new_n184_), .O(new_n187_));
  nand2  g136(.a(new_n187_), .b(x16), .O(new_n188_));
  inv1   g137(.a(x01), .O(new_n189_));
  aoi21  g138(.a(new_n54_), .b(new_n189_), .c(x18), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n188_), .c(new_n61_), .O(z14));
  oai21  g140(.a(new_n186_), .b(new_n111_), .c(x34), .O(new_n192_));
  nand2  g141(.a(new_n164_), .b(new_n174_), .O(new_n193_));
  ...
  nand3  g148(.a(new_n199_), .b(new_n194_), .c(new_n118_), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n192_), .O(new_n201_));
  nand2  g150(.a(new_n201_), .b(x16), .O(new_n202_));
  inv1   g151(.a(x00), .O(new_n203_));
  aoi21  g152(.a(new_n54_), .b(new_n203_), .c(x18), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n202_), .c(new_n61_), .O(z15));
endmodule
