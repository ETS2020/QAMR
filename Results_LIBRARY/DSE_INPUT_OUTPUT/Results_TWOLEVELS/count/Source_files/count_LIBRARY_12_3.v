...
module FAU ( 
  ...
  aoi21  g018(.a(new_n69_), .b(new_n67_), .c(new_n61_), .O(z01));
  oai21  g019(.a(new_n52_), .b(new_n60_), .c(x18), .O(new_n71_));
  ...
  aoi21  g035(.a(new_n86_), .b(new_n84_), .c(new_n61_), .O(z03));
  ...
  aoi21  g044(.a(new_n95_), .b(new_n93_), .c(new_n61_), .O(z04));
  ...
  nand2  g055(.a(new_n89_), .b(new_n55_), .O(new_n107_));
  nand2  g056(.a(new_n99_), .b(new_n81_), .O(new_n108_));
  nor2   g057(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nor2   g058(.a(x21), .b(x20), .O(new_n110_));
  nor2   g059(.a(x25), .b(x24), .O(new_n111_));
  nand4  g060(.a(new_n111_), .b(new_n90_), .c(new_n110_), .d(new_n58_), .O(new_n112_));
  ...
  aoi21  g065(.a(new_n116_), .b(new_n114_), .c(new_n61_), .O(z06));
  inv1   g066(.a(x26), .O(new_n118_));
  inv1   g067(.a(x23), .O(new_n119_));
  nand4  g068(.a(new_n106_), .b(new_n97_), .c(new_n119_), .d(new_n79_), .O(new_n120_));
  nor2   g069(.a(new_n120_), .b(new_n73_), .O(new_n121_));
  nor2   g070(.a(x26), .b(x25), .O(new_n122_));
  nand3  g071(.a(new_n122_), .b(new_n90_), .c(new_n97_), .O(new_n123_));
  oai22  g072(.a(new_n123_), .b(new_n73_), .c(new_n121_), .d(new_n118_), .O(new_n124_));
  nand2  g073(.a(new_n124_), .b(x16), .O(new_n125_));
  nor2   g074(.a(x16), .b(x08), .O(new_n126_));
  nor2   g075(.a(new_n126_), .b(new_n61_), .O(new_n127_));
  nand3  g076(.a(new_n127_), .b(new_n125_), .c(new_n71_), .O(z07));
  oai21  g077(.a(new_n123_), .b(new_n73_), .c(x27), .O(new_n129_));
  nor3   g078(.a(x22), .b(x21), .c(x20), .O(new_n130_));
  nor3   g079(.a(x27), .b(x26), .c(x25), .O(new_n131_));
  nand4  g080(.a(new_n131_), .b(new_n99_), .c(new_n130_), .d(new_n58_), .O(new_n132_));
  ...
  aoi21  g085(.a(new_n136_), .b(new_n134_), .c(new_n61_), .O(z08));
  nand2  g086(.a(new_n132_), .b(x28), .O(new_n138_));
  nor2   g087(.a(x28), .b(x27), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n111_), .c(new_n118_), .d(new_n119_), .O(new_n140_));
  ...
  nand3  g094(.a(new_n145_), .b(new_n143_), .c(new_n71_), .O(z09));
  oai21  g095(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n147_));
  oai21  g096(.a(new_n140_), .b(new_n82_), .c(x29), .O(new_n148_));
  inv1   g097(.a(x27), .O(new_n149_));
  nor2   g098(.a(x29), .b(x28), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n122_), .c(new_n149_), .d(new_n97_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n91_), .c(new_n148_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(x16), .O(new_n153_));
  aoi21  g102(.a(x18), .b(new_n52_), .c(new_n61_), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n153_), .c(new_n147_), .O(z10));
  oai21  g104(.a(new_n151_), .b(new_n91_), .c(x30), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n139_), .c(new_n122_), .d(new_n97_), .O(new_n158_));
  oai21  g107(.a(new_n158_), .b(new_n91_), .c(new_n156_), .O(new_n159_));
  nand2  g108(.a(new_n159_), .b(x16), .O(new_n160_));
  nor2   g109(.a(x16), .b(x04), .O(new_n161_));
  nor2   g110(.a(new_n161_), .b(new_n61_), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n160_), .c(new_n71_), .O(z11));
  oai21  g112(.a(new_n158_), .b(new_n91_), .c(x31), .O(new_n164_));
  inv1   g113(.a(new_n108_), .O(new_n165_));
  nor2   g114(.a(x31), .b(x30), .O(new_n166_));
  nand2  g115(.a(new_n166_), .b(new_n150_), .O(new_n167_));
  inv1   g116(.a(new_n167_), .O(new_n168_));
  nand4  g117(.a(new_n168_), .b(new_n131_), .c(new_n165_), .d(new_n66_), .O(new_n169_));
  ...
  aoi21  g122(.a(new_n173_), .b(new_n171_), .c(new_n61_), .O(z12));
  nand3  g123(.a(new_n166_), .b(new_n150_), .c(new_n131_), .O(new_n175_));
  ...
  nand4  g128(.a(new_n179_), .b(new_n139_), .c(new_n122_), .d(new_n109_), .O(new_n180_));
  nand2  g129(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(x16), .O(new_n182_));
  nor2   g131(.a(x16), .b(x02), .O(new_n183_));
  nor2   g132(.a(new_n183_), .b(new_n61_), .O(new_n184_));
  nand3  g133(.a(new_n184_), .b(new_n182_), .c(new_n71_), .O(z13));
  nand4  g134(.a(new_n177_), .b(new_n157_), .c(new_n139_), .d(new_n122_), .O(new_n186_));
  oai21  g135(.a(new_n186_), .b(new_n100_), .c(x33), .O(new_n187_));
  nor2   g136(.a(x27), .b(x26), .O(new_n188_));
  nor2   g137(.a(x33), .b(x32), .O(new_n189_));
  nand4  g138(.a(new_n189_), .b(new_n166_), .c(new_n150_), .d(new_n188_), .O(new_n190_));
  or2    g139(.a(new_n190_), .b(new_n112_), .O(new_n191_));
  ...
  nand3  g144(.a(new_n195_), .b(new_n193_), .c(new_n71_), .O(z14));
  oai21  g145(.a(new_n190_), .b(new_n112_), .c(x34), .O(new_n197_));
  nand2  g146(.a(new_n150_), .b(new_n188_), .O(new_n198_));
  ...
  nand3  g156(.a(new_n207_), .b(new_n199_), .c(new_n121_), .O(new_n208_));
  nand2  g157(.a(new_n208_), .b(new_n197_), .O(new_n209_));
  nand2  g158(.a(new_n209_), .b(x16), .O(new_n210_));
  inv1   g159(.a(x00), .O(new_n211_));
  aoi21  g160(.a(new_n53_), .b(new_n211_), .c(x18), .O(new_n212_));
  aoi21  g161(.a(new_n212_), .b(new_n210_), .c(new_n61_), .O(z15));
endmodule
