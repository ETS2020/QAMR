...
module FAU ( 
  ...
  aoi21  g037(.a(x16), .b(x10), .c(new_n57_), .O(new_n89_));
  ...
  aoi22  g044(.a(new_n95_), .b(new_n57_), .c(x18), .d(x10), .O(new_n96_));
  oai21  g045(.a(new_n93_), .b(new_n89_), .c(new_n96_), .O(z04));
  nor2   g046(.a(x20), .b(x19), .O(new_n98_));
  nor2   g047(.a(x23), .b(x22), .O(new_n99_));
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n73_), .d(new_n52_), .O(new_n100_));
  nand2  g049(.a(new_n100_), .b(x24), .O(new_n101_));
  nor2   g050(.a(x24), .b(x23), .O(new_n102_));
  nand4  g051(.a(new_n102_), .b(new_n82_), .c(new_n98_), .d(new_n52_), .O(new_n103_));
  aoi21  g052(.a(new_n103_), .b(new_n101_), .c(new_n70_), .O(new_n104_));
  oai21  g053(.a(new_n104_), .b(x18), .c(new_n59_), .O(new_n105_));
  inv1   g054(.a(x10), .O(new_n106_));
  nand3  g055(.a(new_n70_), .b(new_n57_), .c(new_n106_), .O(new_n107_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n99_), .c(new_n111_), .d(new_n55_), .O(new_n113_));
  ...
  aoi21  g066(.a(new_n117_), .b(new_n115_), .c(new_n58_), .O(z06));
  inv1   g067(.a(x26), .O(new_n119_));
  inv1   g068(.a(x24), .O(new_n120_));
  nand4  g069(.a(new_n109_), .b(new_n120_), .c(new_n90_), .d(new_n80_), .O(new_n121_));
  nor2   g070(.a(new_n121_), .b(new_n74_), .O(new_n122_));
  nor2   g071(.a(x26), .b(x25), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n99_), .c(new_n120_), .O(new_n124_));
  oai22  g073(.a(new_n124_), .b(new_n74_), .c(new_n122_), .d(new_n119_), .O(new_n125_));
  ...
  aoi21  g085(.a(new_n70_), .b(new_n136_), .c(x18), .O(new_n137_));
  aoi21  g086(.a(new_n137_), .b(new_n135_), .c(new_n58_), .O(z08));
  nor2   g087(.a(x27), .b(x26), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n102_), .c(new_n109_), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n83_), .c(x28), .O(new_n141_));
  nor3   g090(.a(x25), .b(x24), .c(x23), .O(new_n142_));
  nor3   g091(.a(x28), .b(x27), .c(x26), .O(new_n143_));
  nand4  g092(.a(new_n143_), .b(new_n142_), .c(new_n131_), .d(new_n55_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g094(.a(new_n145_), .b(x16), .O(new_n146_));
  inv1   g095(.a(x06), .O(new_n147_));
  aoi21  g096(.a(new_n70_), .b(new_n147_), .c(x18), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n146_), .c(new_n58_), .O(z09));
  nor2   g098(.a(x28), .b(x27), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n112_), .c(new_n119_), .d(new_n90_), .O(new_n151_));
  ...
  nand3  g103(.a(new_n154_), .b(new_n153_), .c(new_n92_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g106(.a(x05), .O(new_n158_));
  aoi21  g107(.a(new_n70_), .b(new_n158_), .c(x18), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n58_), .O(z10));
  inv1   g109(.a(x27), .O(new_n161_));
  nor2   g110(.a(x29), .b(x28), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n123_), .c(new_n161_), .d(new_n120_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n100_), .c(x30), .O(new_n164_));
  nor2   g113(.a(x30), .b(x29), .O(new_n165_));
  nand2  g114(.a(new_n165_), .b(new_n150_), .O(new_n166_));
  inv1   g115(.a(new_n166_), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n153_), .c(new_n92_), .O(new_n168_));
  ...
  aoi21  g121(.a(new_n172_), .b(new_n170_), .c(new_n58_), .O(z11));
  nand3  g122(.a(new_n165_), .b(new_n150_), .c(new_n153_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n100_), .c(x31), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n162_), .c(new_n132_), .d(new_n110_), .O(new_n177_));
  ...
  nand3  g130(.a(new_n181_), .b(new_n179_), .c(new_n60_), .O(z12));
  nand3  g131(.a(new_n176_), .b(new_n162_), .c(new_n132_), .O(new_n183_));
  oai21  g132(.a(new_n183_), .b(new_n103_), .c(x32), .O(new_n184_));
  nor2   g133(.a(x32), .b(x31), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n165_), .c(new_n150_), .d(new_n123_), .O(new_n186_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n103_), .c(x33), .O(new_n194_));
  inv1   g143(.a(new_n121_), .O(new_n195_));
  inv1   g144(.a(x28), .O(new_n196_));
  inv1   g145(.a(x29), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n196_), .c(new_n161_), .d(new_n119_), .O(new_n198_));
  ...
  nand4  g154(.a(new_n205_), .b(new_n199_), .c(new_n195_), .d(new_n81_), .O(new_n206_));
  nand2  g155(.a(new_n206_), .b(new_n194_), .O(new_n207_));
  nand2  g156(.a(new_n207_), .b(x16), .O(new_n208_));
  inv1   g157(.a(x01), .O(new_n209_));
  aoi21  g158(.a(new_n70_), .b(new_n209_), .c(x18), .O(new_n210_));
  aoi21  g159(.a(new_n210_), .b(new_n208_), .c(new_n58_), .O(z14));
  nor2   g160(.a(x33), .b(x32), .O(new_n212_));
  nand4  g161(.a(new_n212_), .b(new_n176_), .c(new_n162_), .d(new_n139_), .O(new_n213_));
  oai21  g162(.a(new_n213_), .b(new_n113_), .c(x34), .O(new_n214_));
  nor3   g163(.a(x34), .b(x33), .c(x32), .O(new_n215_));
  nand3  g164(.a(new_n215_), .b(new_n199_), .c(new_n176_), .O(new_n216_));
  oai21  g165(.a(new_n216_), .b(new_n113_), .c(new_n214_), .O(new_n217_));
  nand2  g166(.a(new_n217_), .b(x16), .O(new_n218_));
  nor2   g167(.a(x16), .b(x00), .O(new_n219_));
  nor2   g168(.a(new_n219_), .b(new_n58_), .O(new_n220_));
  nand3  g169(.a(new_n220_), .b(new_n218_), .c(new_n60_), .O(z15));
endmodule
