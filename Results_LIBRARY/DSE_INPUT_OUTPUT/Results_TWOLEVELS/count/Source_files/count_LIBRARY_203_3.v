...
module FAU ( 
  ...
  oai21  g027(.a(new_n61_), .b(x10), .c(x12), .O(new_n79_));
  ...
  oai21  g040(.a(x22), .b(x21), .c(new_n56_), .O(new_n92_));
  aoi21  g041(.a(new_n92_), .b(new_n66_), .c(new_n91_), .O(new_n93_));
  nand3  g042(.a(new_n64_), .b(new_n56_), .c(new_n55_), .O(new_n94_));
  ...
  aoi21  g049(.a(new_n100_), .b(new_n98_), .c(new_n54_), .O(z04));
  nand2  g050(.a(new_n88_), .b(new_n52_), .O(new_n102_));
  inv1   g051(.a(x24), .O(new_n103_));
  nor2   g052(.a(x24), .b(x23), .O(new_n104_));
  nand3  g053(.a(new_n104_), .b(new_n81_), .c(new_n66_), .O(new_n105_));
  oai21  g054(.a(new_n97_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand2  g055(.a(new_n106_), .b(x16), .O(new_n107_));
  aoi21  g056(.a(x18), .b(new_n53_), .c(new_n54_), .O(new_n108_));
  nand3  g057(.a(new_n108_), .b(new_n107_), .c(new_n102_), .O(z05));
  oai21  g058(.a(new_n53_), .b(new_n52_), .c(x18), .O(new_n110_));
  nand2  g059(.a(new_n105_), .b(x25), .O(new_n111_));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n95_), .c(new_n72_), .d(new_n58_), .O(new_n113_));
  ...
  nand3  g066(.a(new_n117_), .b(new_n115_), .c(new_n110_), .O(z06));
  inv1   g067(.a(x26), .O(new_n119_));
  nand3  g068(.a(new_n112_), .b(new_n81_), .c(new_n91_), .O(new_n120_));
  ...
  aoi21  g077(.a(new_n128_), .b(new_n126_), .c(new_n54_), .O(z07));
  inv1   g078(.a(x27), .O(new_n130_));
  nand3  g079(.a(new_n81_), .b(new_n58_), .c(new_n64_), .O(new_n131_));
  nor3   g080(.a(x27), .b(x26), .c(x25), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n104_), .O(new_n133_));
  oai22  g082(.a(new_n133_), .b(new_n131_), .c(new_n125_), .d(new_n130_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(x16), .O(new_n135_));
  nor2   g084(.a(x16), .b(x07), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n54_), .O(new_n137_));
  nand3  g086(.a(new_n137_), .b(new_n135_), .c(new_n110_), .O(z08));
  inv1   g087(.a(x28), .O(new_n139_));
  nor2   g088(.a(x27), .b(x26), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(new_n112_), .O(new_n141_));
  oai21  g090(.a(new_n141_), .b(new_n96_), .c(new_n56_), .O(new_n142_));
  aoi21  g091(.a(new_n142_), .b(new_n66_), .c(new_n139_), .O(new_n143_));
  nor2   g092(.a(x28), .b(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n112_), .c(new_n119_), .d(new_n91_), .O(new_n145_));
  ...
  aoi21  g097(.a(new_n61_), .b(new_n148_), .c(x18), .O(new_n149_));
  aoi21  g098(.a(new_n149_), .b(new_n147_), .c(new_n54_), .O(z09));
  inv1   g099(.a(x29), .O(new_n151_));
  nor3   g100(.a(x29), .b(x28), .c(x27), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n123_), .c(new_n97_), .O(new_n153_));
  oai21  g102(.a(new_n146_), .b(new_n151_), .c(new_n153_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(x16), .O(new_n155_));
  nor2   g104(.a(x16), .b(x05), .O(new_n156_));
  nor2   g105(.a(new_n156_), .b(new_n54_), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n155_), .c(new_n110_), .O(z10));
  nand2  g107(.a(new_n153_), .b(x30), .O(new_n159_));
  nand3  g108(.a(new_n95_), .b(new_n66_), .c(new_n71_), .O(new_n160_));
  nor2   g109(.a(x30), .b(x29), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n144_), .c(new_n123_), .O(new_n162_));
  ...
  nand3  g116(.a(new_n167_), .b(new_n165_), .c(new_n110_), .O(z11));
  oai21  g117(.a(new_n162_), .b(new_n160_), .c(x31), .O(new_n169_));
  nor2   g118(.a(x29), .b(x28), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n170_), .c(new_n132_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n105_), .c(new_n169_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(x16), .O(new_n174_));
  nor2   g123(.a(x16), .b(x03), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(new_n54_), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n174_), .c(new_n110_), .O(z12));
  inv1   g126(.a(x32), .O(new_n178_));
  nand4  g127(.a(new_n171_), .b(new_n144_), .c(new_n151_), .d(new_n119_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n120_), .c(new_n56_), .O(new_n180_));
  ...
  nand4  g132(.a(new_n183_), .b(new_n161_), .c(new_n144_), .d(new_n182_), .O(new_n184_));
  ...
  aoi21  g137(.a(new_n188_), .b(new_n186_), .c(new_n54_), .O(z13));
  inv1   g138(.a(x33), .O(new_n190_));
  nand4  g139(.a(new_n182_), .b(new_n95_), .c(new_n103_), .d(new_n71_), .O(new_n191_));
  inv1   g140(.a(x30), .O(new_n192_));
  nand4  g141(.a(new_n183_), .b(new_n170_), .c(new_n192_), .d(new_n130_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n191_), .c(new_n56_), .O(new_n194_));
  aoi21  g143(.a(new_n194_), .b(new_n66_), .c(new_n190_), .O(new_n195_));
  nand2  g144(.a(new_n170_), .b(new_n140_), .O(new_n196_));
  nor2   g145(.a(x33), .b(x32), .O(new_n197_));
  nand2  g146(.a(new_n197_), .b(new_n171_), .O(new_n198_));
  nor3   g147(.a(new_n198_), .b(new_n196_), .c(new_n113_), .O(new_n199_));
  ...
  nand4  g153(.a(new_n197_), .b(new_n171_), .c(new_n170_), .d(new_n130_), .O(new_n205_));
  oai21  g154(.a(new_n205_), .b(new_n191_), .c(new_n56_), .O(new_n206_));
  aoi21  g155(.a(new_n206_), .b(new_n66_), .c(new_n204_), .O(new_n207_));
  nand4  g156(.a(new_n171_), .b(new_n204_), .c(new_n190_), .d(new_n178_), .O(new_n208_));
  nor3   g157(.a(new_n208_), .b(new_n196_), .c(new_n113_), .O(new_n209_));
  ...
  aoi21  g161(.a(new_n212_), .b(new_n210_), .c(new_n54_), .O(z15));
endmodule
