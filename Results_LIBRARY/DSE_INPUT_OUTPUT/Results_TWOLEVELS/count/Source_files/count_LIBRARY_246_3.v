...
module FAU ( 
  ...
  nand3  g024(.a(new_n75_), .b(new_n55_), .c(new_n67_), .O(new_n76_));
  ...
  nand3  g038(.a(new_n83_), .b(new_n62_), .c(new_n82_), .O(new_n90_));
  ...
  nor2   g048(.a(new_n55_), .b(x20), .O(new_n100_));
  inv1   g049(.a(x22), .O(new_n101_));
  nand3  g050(.a(new_n91_), .b(new_n69_), .c(new_n101_), .O(new_n102_));
  aoi21  g051(.a(new_n102_), .b(new_n99_), .c(new_n100_), .O(new_n103_));
  nor2   g052(.a(x25), .b(x24), .O(new_n104_));
  nand4  g053(.a(new_n104_), .b(new_n83_), .c(new_n69_), .d(new_n55_), .O(new_n105_));
  ...
  nor2   g058(.a(x20), .b(new_n99_), .O(new_n110_));
  ...
  inv1   g069(.a(new_n100_), .O(new_n121_));
  nand2  g070(.a(new_n75_), .b(new_n67_), .O(new_n122_));
  nor2   g071(.a(x26), .b(x25), .O(new_n123_));
  nand2  g072(.a(new_n123_), .b(new_n91_), .O(new_n124_));
  oai21  g073(.a(new_n124_), .b(new_n122_), .c(new_n99_), .O(new_n125_));
  aoi21  g074(.a(new_n125_), .b(new_n121_), .c(new_n120_), .O(new_n126_));
  ...
  aoi21  g080(.a(new_n109_), .b(new_n131_), .c(new_n110_), .O(new_n132_));
  nand2  g081(.a(new_n132_), .b(new_n130_), .O(z08));
  inv1   g082(.a(x28), .O(new_n134_));
  nor2   g083(.a(x27), .b(x26), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n104_), .c(new_n83_), .d(new_n69_), .O(new_n136_));
  aoi21  g085(.a(new_n136_), .b(new_n99_), .c(new_n100_), .O(new_n137_));
  inv1   g086(.a(x23), .O(new_n138_));
  nor3   g087(.a(x28), .b(x27), .c(x26), .O(new_n139_));
  nand4  g088(.a(new_n139_), .b(new_n104_), .c(new_n77_), .d(new_n138_), .O(new_n140_));
  oai21  g089(.a(new_n137_), .b(new_n134_), .c(new_n140_), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(x16), .O(new_n142_));
  inv1   g091(.a(x06), .O(new_n143_));
  aoi21  g092(.a(new_n109_), .b(new_n143_), .c(new_n110_), .O(new_n144_));
  nand2  g093(.a(new_n144_), .b(new_n142_), .O(z09));
  nor3   g094(.a(x29), .b(x28), .c(x27), .O(new_n146_));
  and2   g095(.a(new_n146_), .b(new_n113_), .O(new_n147_));
  aoi22  g096(.a(new_n147_), .b(new_n85_), .c(new_n140_), .d(x29), .O(new_n148_));
  ...
  nand2  g100(.a(new_n147_), .b(new_n85_), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n153_), .c(new_n113_), .O(new_n155_));
  ...
  oai21  g109(.a(new_n155_), .b(new_n90_), .c(x31), .O(new_n161_));
  nor2   g110(.a(x29), .b(x28), .O(new_n162_));
  nor2   g111(.a(x31), .b(x30), .O(new_n163_));
  nand4  g112(.a(new_n163_), .b(new_n162_), .c(new_n127_), .d(new_n93_), .O(new_n164_));
  ...
  nand4  g119(.a(new_n104_), .b(new_n75_), .c(new_n138_), .d(new_n67_), .O(new_n171_));
  inv1   g120(.a(x26), .O(new_n172_));
  inv1   g121(.a(x29), .O(new_n173_));
  nand4  g122(.a(new_n163_), .b(new_n153_), .c(new_n173_), .d(new_n172_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n171_), .c(new_n99_), .O(new_n175_));
  aoi21  g124(.a(new_n175_), .b(new_n121_), .c(new_n170_), .O(new_n176_));
  nor2   g125(.a(x32), .b(x31), .O(new_n177_));
  nand4  g126(.a(new_n177_), .b(new_n154_), .c(new_n153_), .d(new_n123_), .O(new_n178_));
  nor3   g127(.a(new_n178_), .b(new_n92_), .c(new_n68_), .O(new_n179_));
  oai21  g128(.a(new_n179_), .b(new_n176_), .c(x16), .O(new_n180_));
  inv1   g129(.a(x02), .O(new_n181_));
  aoi21  g130(.a(new_n109_), .b(new_n181_), .c(new_n110_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n180_), .O(z13));
  inv1   g132(.a(x33), .O(new_n184_));
  nand4  g133(.a(new_n177_), .b(new_n154_), .c(new_n153_), .d(new_n172_), .O(new_n185_));
  oai21  g134(.a(new_n185_), .b(new_n171_), .c(new_n99_), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n121_), .c(new_n184_), .O(new_n187_));
  nor2   g136(.a(x33), .b(x32), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n163_), .c(new_n162_), .d(new_n135_), .O(new_n189_));
  ...
  aoi21  g141(.a(new_n109_), .b(new_n192_), .c(new_n110_), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n191_), .O(z14));
  inv1   g143(.a(x34), .O(new_n195_));
  nor3   g144(.a(x34), .b(x33), .c(x32), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n163_), .c(new_n162_), .d(new_n135_), .O(new_n197_));
  oai22  g146(.a(new_n197_), .b(new_n105_), .c(new_n190_), .d(new_n195_), .O(new_n198_));
