...
module FAU ( 
  ...
  oai21  g023(.a(new_n72_), .b(x18), .c(new_n74_), .O(z02));
  ...
  nand2  g042(.a(new_n93_), .b(new_n74_), .O(z04));
  ...
  oai21  g062(.a(new_n113_), .b(x18), .c(new_n74_), .O(z06));
  ...
  nand2  g080(.a(new_n77_), .b(new_n68_), .O(new_n132_));
  ...
  oai21  g097(.a(new_n148_), .b(x18), .c(new_n74_), .O(z09));
  ...
  nand4  g135(.a(new_n186_), .b(new_n144_), .c(new_n116_), .d(new_n77_), .O(new_n187_));
