...
module FAU ( 
  ...
  aoi21  g12(.a(new_n63_), .b(new_n59_), .c(new_n58_), .O(new_n64_));
  nor2   g13(.a(x16), .b(x14), .O(new_n65_));
  oai21  g14(.a(new_n65_), .b(new_n64_), .c(x21), .O(new_n66_));
  nand2  g15(.a(new_n66_), .b(new_n52_), .O(z01));
  nand3  g16(.a(new_n62_), .b(new_n61_), .c(new_n60_), .O(new_n68_));
  nor2   g17(.a(x16), .b(x13), .O(new_n69_));
  aoi21  g18(.a(new_n68_), .b(x16), .c(new_n69_), .O(new_n70_));
  oai21  g19(.a(new_n70_), .b(new_n53_), .c(new_n52_), .O(z02));
  nor2   g20(.a(new_n53_), .b(x18), .O(new_n72_));
  nand2  g21(.a(x22), .b(x16), .O(new_n73_));
  inv1   g22(.a(x12), .O(new_n74_));
  nand2  g23(.a(new_n58_), .b(new_n74_), .O(new_n75_));
  nand3  g24(.a(new_n75_), .b(new_n73_), .c(new_n72_), .O(z03));
  nand2  g25(.a(x23), .b(x16), .O(new_n77_));
  inv1   g26(.a(x11), .O(new_n78_));
  nand2  g27(.a(new_n58_), .b(new_n78_), .O(new_n79_));
  nand3  g28(.a(new_n79_), .b(new_n77_), .c(new_n72_), .O(z04));
  nand2  g29(.a(x24), .b(x16), .O(new_n81_));
  inv1   g30(.a(x10), .O(new_n82_));
  nand2  g31(.a(new_n58_), .b(new_n82_), .O(new_n83_));
  nand3  g32(.a(new_n83_), .b(new_n81_), .c(new_n72_), .O(z05));
  nor2   g33(.a(x16), .b(x09), .O(new_n85_));
  and2   g34(.a(x25), .b(x16), .O(new_n86_));
  oai21  g35(.a(new_n86_), .b(new_n85_), .c(x21), .O(new_n87_));
  nand2  g36(.a(new_n87_), .b(new_n52_), .O(z06));
  nor2   g37(.a(x16), .b(x08), .O(new_n89_));
  and2   g38(.a(x26), .b(x16), .O(new_n90_));
  oai21  g39(.a(new_n90_), .b(new_n89_), .c(x21), .O(new_n91_));
  nand2  g40(.a(new_n91_), .b(new_n52_), .O(z07));
  nand2  g41(.a(x27), .b(x16), .O(new_n93_));
  inv1   g42(.a(x07), .O(new_n94_));
  nand2  g43(.a(new_n58_), .b(new_n94_), .O(new_n95_));
  nand3  g44(.a(new_n95_), .b(new_n93_), .c(new_n72_), .O(z08));
  nand2  g45(.a(x28), .b(x16), .O(new_n97_));
  inv1   g46(.a(x06), .O(new_n98_));
  nand2  g47(.a(new_n58_), .b(new_n98_), .O(new_n99_));
  nand3  g48(.a(new_n99_), .b(new_n97_), .c(new_n72_), .O(z09));
  nand2  g49(.a(x29), .b(x16), .O(new_n101_));
  inv1   g50(.a(x05), .O(new_n102_));
  nand2  g51(.a(new_n58_), .b(new_n102_), .O(new_n103_));
  nand3  g52(.a(new_n103_), .b(new_n101_), .c(new_n72_), .O(z10));
  nand2  g53(.a(x30), .b(x16), .O(new_n105_));
  inv1   g54(.a(x04), .O(new_n106_));
  nand2  g55(.a(new_n58_), .b(new_n106_), .O(new_n107_));
  nand3  g56(.a(new_n107_), .b(new_n105_), .c(new_n72_), .O(z11));
  ...
  nand3  g72(.a(new_n123_), .b(new_n121_), .c(new_n72_), .O(z15));
endmodule
