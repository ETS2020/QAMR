...
module FAU ( 
  ...
  nand3  g019(.a(new_n54_), .b(new_n70_), .c(new_n61_), .O(new_n71_));
  ...
  oai21  g033(.a(new_n59_), .b(x12), .c(new_n84_), .O(z03));
  oai21  g034(.a(new_n78_), .b(x19), .c(new_n82_), .O(new_n86_));
  nor2   g035(.a(x23), .b(x22), .O(new_n87_));
  nand2  g036(.a(new_n87_), .b(new_n70_), .O(new_n88_));
  inv1   g037(.a(new_n88_), .O(new_n89_));
  aoi22  g038(.a(new_n89_), .b(new_n82_), .c(new_n86_), .d(x23), .O(new_n90_));
  inv1   g039(.a(x11), .O(new_n91_));
  aoi21  g040(.a(new_n69_), .b(new_n91_), .c(x18), .O(new_n92_));
  oai21  g041(.a(new_n90_), .b(new_n69_), .c(new_n92_), .O(z04));
  oai21  g042(.a(new_n89_), .b(x19), .c(new_n82_), .O(new_n94_));
  nor2   g043(.a(x24), .b(x23), .O(new_n95_));
  nand3  g044(.a(new_n95_), .b(new_n78_), .c(new_n82_), .O(new_n96_));
  ...
  nand2  g051(.a(new_n95_), .b(new_n78_), .O(new_n103_));
  ...
  aoi21  g073(.a(new_n69_), .b(new_n124_), .c(x18), .O(new_n125_));
  ...
  nand4  g078(.a(new_n129_), .b(new_n87_), .c(new_n128_), .d(new_n70_), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n64_), .O(new_n131_));
  aoi21  g080(.a(new_n131_), .b(new_n82_), .c(new_n127_), .O(new_n132_));
  nand3  g081(.a(new_n78_), .b(new_n54_), .c(new_n61_), .O(new_n133_));
  nor2   g082(.a(x27), .b(x26), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n95_), .c(new_n102_), .O(new_n135_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n106_), .c(new_n87_), .d(new_n70_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(new_n64_), .O(new_n143_));
  aoi21  g092(.a(new_n143_), .b(new_n82_), .c(new_n141_), .O(new_n144_));
  nor2   g093(.a(x28), .b(x27), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n106_), .c(new_n115_), .d(new_n116_), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n133_), .c(new_n52_), .O(new_n147_));
  oai21  g096(.a(new_n147_), .b(new_n144_), .c(x16), .O(new_n148_));
  oai21  g097(.a(new_n59_), .b(x06), .c(new_n148_), .O(z09));
  inv1   g098(.a(x29), .O(new_n150_));
  nand2  g099(.a(new_n89_), .b(new_n82_), .O(new_n151_));
  nand4  g100(.a(new_n145_), .b(new_n129_), .c(new_n95_), .d(new_n78_), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n64_), .c(new_n65_), .O(new_n153_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n129_), .c(new_n127_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n103_), .c(new_n64_), .O(new_n163_));
  aoi21  g112(.a(new_n163_), .b(new_n82_), .c(new_n161_), .O(new_n164_));
  nor2   g113(.a(x30), .b(x29), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n145_), .c(new_n120_), .O(new_n166_));
  ...
  nand3  g121(.a(new_n165_), .b(new_n134_), .c(new_n141_), .O(new_n173_));
  oai21  g122(.a(new_n173_), .b(new_n117_), .c(new_n64_), .O(new_n174_));
  aoi21  g123(.a(new_n174_), .b(new_n82_), .c(new_n172_), .O(new_n175_));
  nor2   g124(.a(x31), .b(x30), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n154_), .c(new_n134_), .d(new_n102_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n96_), .c(new_n52_), .O(new_n178_));
  ...
  nand4  g132(.a(new_n176_), .b(new_n145_), .c(new_n150_), .d(new_n115_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n117_), .c(new_n64_), .O(new_n185_));
  aoi21  g134(.a(new_n185_), .b(new_n82_), .c(new_n183_), .O(new_n186_));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n165_), .c(new_n145_), .d(new_n129_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n96_), .c(new_n52_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n186_), .c(x16), .O(new_n190_));
  inv1   g139(.a(x02), .O(new_n191_));
  nand2  g140(.a(new_n58_), .b(new_n191_), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(new_n190_), .O(z13));
  inv1   g142(.a(x33), .O(new_n194_));
  nand4  g143(.a(new_n187_), .b(new_n154_), .c(new_n161_), .d(new_n127_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n130_), .c(new_n64_), .O(new_n196_));
  aoi21  g145(.a(new_n196_), .b(new_n82_), .c(new_n194_), .O(new_n197_));
  nor2   g146(.a(x33), .b(x32), .O(new_n198_));
  nand4  g147(.a(new_n198_), .b(new_n176_), .c(new_n154_), .d(new_n134_), .O(new_n199_));
  nor2   g148(.a(new_n199_), .b(new_n109_), .O(new_n200_));
  oai21  g149(.a(new_n200_), .b(new_n197_), .c(x16), .O(new_n201_));
  inv1   g150(.a(x01), .O(new_n202_));
  aoi21  g151(.a(new_n69_), .b(new_n202_), .c(x18), .O(new_n203_));
  nand2  g152(.a(new_n203_), .b(new_n201_), .O(z14));
  inv1   g153(.a(x34), .O(new_n205_));
  nand4  g154(.a(new_n198_), .b(new_n176_), .c(new_n154_), .d(new_n127_), .O(new_n206_));
  oai21  g155(.a(new_n206_), .b(new_n130_), .c(new_n64_), .O(new_n207_));
  aoi21  g156(.a(new_n207_), .b(new_n82_), .c(new_n205_), .O(new_n208_));
  nor3   g157(.a(x34), .b(x33), .c(x32), .O(new_n209_));
  nand4  g158(.a(new_n209_), .b(new_n176_), .c(new_n154_), .d(new_n134_), .O(new_n210_));
  oai21  g159(.a(new_n210_), .b(new_n109_), .c(new_n52_), .O(new_n211_));
  oai21  g160(.a(new_n211_), .b(new_n208_), .c(x16), .O(new_n212_));
  inv1   g161(.a(x00), .O(new_n213_));
  nand2  g162(.a(new_n58_), .b(new_n213_), .O(new_n214_));
