...
module FAU ( 
  ...
  nand4  g050(.a(new_n101_), .b(new_n100_), .c(new_n66_), .d(new_n52_), .O(new_n102_));
  oai21  g051(.a(new_n93_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(x16), .O(new_n104_));
  inv1   g053(.a(x10), .O(new_n105_));
  aoi21  g054(.a(new_n71_), .b(new_n105_), .c(x18), .O(new_n106_));
  ...
  nand3  g064(.a(new_n115_), .b(new_n113_), .c(new_n59_), .O(z06));
  ...
  aoi21  g071(.a(new_n71_), .b(new_n122_), .c(x18), .O(new_n123_));
  aoi21  g072(.a(new_n123_), .b(new_n121_), .c(new_n60_), .O(z07));
  nand2  g073(.a(new_n96_), .b(new_n57_), .O(new_n125_));
  nand2  g074(.a(new_n119_), .b(x27), .O(new_n126_));
  nor3   g075(.a(x27), .b(x26), .c(x25), .O(new_n127_));
  nand4  g076(.a(new_n127_), .b(new_n101_), .c(new_n83_), .d(new_n55_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(x16), .O(new_n130_));
  aoi21  g079(.a(x18), .b(new_n58_), .c(new_n60_), .O(new_n131_));
  ...
  nand4  g084(.a(new_n135_), .b(new_n134_), .c(new_n83_), .d(new_n55_), .O(new_n136_));
  ...
  nand3  g093(.a(new_n144_), .b(new_n118_), .c(new_n143_), .O(new_n145_));
  ...
  nand2  g111(.a(new_n101_), .b(new_n100_), .O(new_n163_));
  ...
  nand4  g148(.a(new_n174_), .b(new_n99_), .c(new_n199_), .d(new_n81_), .O(new_n200_));
