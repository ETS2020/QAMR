...
module FAU ( 
  ...
  oai21  g020(.a(new_n52_), .b(new_n60_), .c(x18), .O(new_n72_));
  ...
  aoi21  g032(.a(x18), .b(new_n52_), .c(new_n61_), .O(new_n84_));
  nand3  g033(.a(new_n84_), .b(new_n83_), .c(new_n80_), .O(z03));
  inv1   g034(.a(x23), .O(new_n86_));
  aoi21  g035(.a(new_n81_), .b(new_n58_), .c(new_n86_), .O(new_n87_));
  inv1   g036(.a(x22), .O(new_n88_));
  nand3  g037(.a(new_n86_), .b(new_n88_), .c(new_n73_), .O(new_n89_));
  ...
  aoi21  g042(.a(new_n93_), .b(new_n91_), .c(new_n61_), .O(z04));
  ...
  nand4  g047(.a(new_n98_), .b(new_n97_), .c(new_n96_), .d(new_n55_), .O(new_n99_));
  ...
  nand3  g052(.a(new_n103_), .b(new_n101_), .c(new_n72_), .O(z05));
  ...
  nand4  g058(.a(new_n109_), .b(new_n108_), .c(new_n107_), .d(new_n58_), .O(new_n110_));
  oai21  g059(.a(new_n106_), .b(new_n105_), .c(new_n110_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(x16), .O(new_n112_));
  inv1   g061(.a(x09), .O(new_n113_));
  aoi21  g062(.a(new_n53_), .b(new_n113_), .c(x18), .O(new_n114_));
  aoi21  g063(.a(new_n114_), .b(new_n112_), .c(new_n61_), .O(z06));
  nand2  g064(.a(new_n110_), .b(x26), .O(new_n116_));
  nor2   g065(.a(x26), .b(x25), .O(new_n117_));
  nand3  g066(.a(new_n117_), .b(new_n108_), .c(new_n95_), .O(new_n118_));
  oai21  g067(.a(new_n118_), .b(new_n74_), .c(new_n116_), .O(new_n119_));
  ...
  oai21  g072(.a(new_n118_), .b(new_n74_), .c(x27), .O(new_n124_));
  nor3   g073(.a(x27), .b(x26), .c(x25), .O(new_n125_));
  nand4  g074(.a(new_n125_), .b(new_n98_), .c(new_n81_), .d(new_n58_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g076(.a(new_n127_), .b(x16), .O(new_n128_));
  inv1   g077(.a(x07), .O(new_n129_));
  aoi21  g078(.a(new_n53_), .b(new_n129_), .c(x18), .O(new_n130_));
  aoi21  g079(.a(new_n130_), .b(new_n128_), .c(new_n61_), .O(z08));
  ...
  aoi21  g087(.a(new_n53_), .b(new_n138_), .c(x18), .O(new_n139_));
  aoi21  g088(.a(new_n139_), .b(new_n137_), .c(new_n61_), .O(z09));
  and2   g089(.a(new_n135_), .b(x29), .O(new_n141_));
  nand4  g090(.a(new_n108_), .b(new_n96_), .c(new_n73_), .d(new_n55_), .O(new_n142_));
  inv1   g091(.a(x27), .O(new_n143_));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n117_), .c(new_n143_), .d(new_n95_), .O(new_n145_));
  ...
  nor2   g097(.a(new_n148_), .b(new_n61_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n147_), .c(new_n72_), .O(z10));
  oai21  g099(.a(new_n145_), .b(new_n142_), .c(x30), .O(new_n151_));
  nor3   g100(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nor2   g101(.a(x28), .b(x27), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand4  g103(.a(new_n154_), .b(new_n153_), .c(new_n152_), .d(new_n90_), .O(new_n155_));
  ...
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n61_), .O(z11));
  nand3  g109(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n161_));
  oai21  g110(.a(new_n161_), .b(new_n142_), .c(x31), .O(new_n162_));
  nor2   g111(.a(x27), .b(x26), .O(new_n163_));
  nor2   g112(.a(x31), .b(x30), .O(new_n164_));
  nand4  g113(.a(new_n164_), .b(new_n144_), .c(new_n163_), .d(new_n105_), .O(new_n165_));
  or2    g114(.a(new_n165_), .b(new_n99_), .O(new_n166_));
  ...
  nand3  g119(.a(new_n170_), .b(new_n168_), .c(new_n72_), .O(z12));
  oai21  g120(.a(new_n165_), .b(new_n99_), .c(x32), .O(new_n172_));
  nand2  g121(.a(new_n153_), .b(new_n117_), .O(new_n173_));
  nor2   g122(.a(x32), .b(x31), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n154_), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand2  g125(.a(new_n176_), .b(new_n106_), .O(new_n177_));
  ...
  aoi21  g132(.a(new_n176_), .b(new_n106_), .c(new_n183_), .O(new_n184_));
  nor2   g133(.a(x33), .b(x32), .O(new_n185_));
  nand4  g134(.a(new_n185_), .b(new_n164_), .c(new_n144_), .d(new_n163_), .O(new_n186_));
  ...
  nor2   g138(.a(new_n189_), .b(new_n61_), .O(new_n190_));
  nand3  g139(.a(new_n190_), .b(new_n188_), .c(new_n72_), .O(z14));
  oai21  g140(.a(new_n186_), .b(new_n110_), .c(x34), .O(new_n192_));
  nand4  g141(.a(new_n105_), .b(new_n95_), .c(new_n86_), .d(new_n88_), .O(new_n193_));
  nor2   g142(.a(new_n193_), .b(new_n74_), .O(new_n194_));
  nand2  g143(.a(new_n144_), .b(new_n163_), .O(new_n195_));
  ...
  nand3  g150(.a(new_n201_), .b(new_n183_), .c(new_n200_), .O(new_n202_));
  nor2   g151(.a(new_n202_), .b(new_n199_), .O(new_n203_));
  nand3  g152(.a(new_n203_), .b(new_n196_), .c(new_n194_), .O(new_n204_));
  nand2  g153(.a(new_n204_), .b(new_n192_), .O(new_n205_));
