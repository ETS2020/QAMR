...
module FAU ( 
  ...
  nand4  g023(.a(new_n74_), .b(new_n67_), .c(new_n53_), .d(new_n52_), .O(new_n75_));
  ...
  nand3  g046(.a(new_n97_), .b(new_n95_), .c(new_n66_), .O(z04));
  inv1   g047(.a(x24), .O(new_n99_));
  nor2   g048(.a(x22), .b(x21), .O(new_n100_));
  nor2   g049(.a(x24), .b(x23), .O(new_n101_));
  nand3  g050(.a(new_n101_), .b(new_n100_), .c(new_n69_), .O(new_n102_));
  ...
  aoi21  g055(.a(new_n106_), .b(new_n104_), .c(new_n64_), .O(z05));
  ...
  aoi21  g064(.a(new_n115_), .b(new_n113_), .c(new_n64_), .O(z06));
  inv1   g065(.a(x26), .O(new_n117_));
  inv1   g066(.a(x25), .O(new_n118_));
  nand4  g067(.a(new_n118_), .b(new_n99_), .c(new_n90_), .d(new_n81_), .O(new_n119_));
  ...
  nand4  g079(.a(new_n130_), .b(new_n101_), .c(new_n83_), .d(new_n55_), .O(new_n131_));
  oai21  g080(.a(new_n124_), .b(new_n129_), .c(new_n131_), .O(new_n132_));
  ...
  nand4  g087(.a(new_n138_), .b(new_n110_), .c(new_n117_), .d(new_n90_), .O(new_n139_));
  ...
  oai22  g096(.a(new_n147_), .b(new_n93_), .c(new_n140_), .d(new_n145_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(x16), .O(new_n149_));
  nor2   g098(.a(x16), .b(x05), .O(new_n150_));
  nor2   g099(.a(new_n150_), .b(new_n64_), .O(new_n151_));
  nand3  g100(.a(new_n151_), .b(new_n149_), .c(new_n66_), .O(z10));
  oai21  g101(.a(new_n147_), .b(new_n93_), .c(x30), .O(new_n153_));
  nor2   g102(.a(x30), .b(x29), .O(new_n154_));
  nand3  g103(.a(new_n154_), .b(new_n138_), .c(new_n122_), .O(new_n155_));
  oai21  g104(.a(new_n155_), .b(new_n93_), .c(new_n153_), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(x16), .O(new_n157_));
  nor2   g106(.a(x16), .b(x04), .O(new_n158_));
  nor2   g107(.a(new_n158_), .b(new_n64_), .O(new_n159_));
  nand3  g108(.a(new_n159_), .b(new_n157_), .c(new_n66_), .O(z11));
  oai21  g109(.a(new_n155_), .b(new_n93_), .c(x31), .O(new_n161_));
  nor2   g110(.a(x31), .b(x30), .O(new_n162_));
  nand3  g111(.a(new_n162_), .b(new_n146_), .c(new_n130_), .O(new_n163_));
  oai21  g112(.a(new_n163_), .b(new_n102_), .c(new_n161_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(x16), .O(new_n165_));
  nor2   g114(.a(x16), .b(x03), .O(new_n166_));
  nor2   g115(.a(new_n166_), .b(new_n64_), .O(new_n167_));
  nand3  g116(.a(new_n167_), .b(new_n165_), .c(new_n66_), .O(z12));
  oai21  g117(.a(new_n163_), .b(new_n102_), .c(x32), .O(new_n169_));
  nor2   g118(.a(x26), .b(x25), .O(new_n170_));
  nor2   g119(.a(x32), .b(x31), .O(new_n171_));
  nand4  g120(.a(new_n171_), .b(new_n154_), .c(new_n138_), .d(new_n170_), .O(new_n172_));
  oai21  g121(.a(new_n172_), .b(new_n102_), .c(new_n169_), .O(new_n173_));
  nand2  g122(.a(new_n173_), .b(x16), .O(new_n174_));
  nor2   g123(.a(x16), .b(x02), .O(new_n175_));
  nor2   g124(.a(new_n175_), .b(new_n64_), .O(new_n176_));
  nand3  g125(.a(new_n176_), .b(new_n174_), .c(new_n66_), .O(z13));
  oai21  g126(.a(new_n172_), .b(new_n102_), .c(x33), .O(new_n178_));
  nor2   g127(.a(x27), .b(x26), .O(new_n179_));
  nor2   g128(.a(x33), .b(x32), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n162_), .c(new_n146_), .d(new_n179_), .O(new_n181_));
  or2    g130(.a(new_n181_), .b(new_n111_), .O(new_n182_));
  ...
  aoi21  g135(.a(new_n186_), .b(new_n184_), .c(new_n64_), .O(z14));
  oai21  g136(.a(new_n181_), .b(new_n111_), .c(x34), .O(new_n188_));
  nand2  g137(.a(new_n146_), .b(new_n179_), .O(new_n189_));
  ...
  nand3  g147(.a(new_n198_), .b(new_n190_), .c(new_n120_), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n188_), .c(new_n57_), .O(new_n200_));
  oai21  g149(.a(new_n200_), .b(x18), .c(new_n65_), .O(new_n201_));
  nand3  g150(.a(new_n57_), .b(new_n60_), .c(new_n56_), .O(new_n202_));
  nand2  g151(.a(new_n202_), .b(new_n201_), .O(z15));
endmodule
