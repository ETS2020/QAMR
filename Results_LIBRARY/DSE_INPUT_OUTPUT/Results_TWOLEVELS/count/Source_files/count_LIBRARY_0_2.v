...
module FAU ( 
  ...
  oai21  g013(.a(new_n64_), .b(x11), .c(new_n63_), .O(new_n65_));
  ...
  oai21  g037(.a(x18), .b(new_n64_), .c(new_n57_), .O(new_n89_));
  ...
  nand3  g042(.a(new_n93_), .b(new_n69_), .c(new_n72_), .O(new_n94_));
  inv1   g043(.a(new_n94_), .O(new_n95_));
  oai21  g044(.a(new_n95_), .b(new_n92_), .c(x16), .O(new_n96_));
  aoi21  g045(.a(x18), .b(x14), .c(new_n59_), .O(new_n97_));
  ...
  nand3  g052(.a(new_n103_), .b(new_n81_), .c(new_n69_), .O(new_n104_));
  ...
  nand4  g063(.a(new_n114_), .b(new_n93_), .c(new_n73_), .d(new_n55_), .O(new_n115_));
  ...
  nand4  g082(.a(new_n133_), .b(new_n93_), .c(new_n99_), .d(new_n72_), .O(new_n134_));
  nand2  g083(.a(new_n134_), .b(new_n53_), .O(new_n135_));
  aoi21  g084(.a(new_n135_), .b(new_n69_), .c(new_n132_), .O(new_n136_));
  nand3  g085(.a(new_n81_), .b(new_n55_), .c(new_n66_), .O(new_n137_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(new_n103_), .d(new_n81_), .O(new_n158_));
  ...
  nor2   g121(.a(new_n172_), .b(new_n94_), .O(new_n173_));
