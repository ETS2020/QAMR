...
module FAU ( 
  ...
  oai21  g026(.a(new_n77_), .b(x32), .c(new_n52_), .O(z02));
  ...
  oai21  g035(.a(new_n86_), .b(x32), .c(new_n52_), .O(z03));
  nor3   g036(.a(x22), .b(x21), .c(x20), .O(new_n88_));
  oai21  g037(.a(new_n88_), .b(x32), .c(new_n54_), .O(new_n89_));
  ...
  nand2  g043(.a(new_n60_), .b(new_n52_), .O(new_n95_));
  nor2   g044(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  oai21  g045(.a(new_n93_), .b(new_n61_), .c(new_n96_), .O(z04));
  inv1   g046(.a(x24), .O(new_n98_));
  nand2  g047(.a(new_n90_), .b(new_n73_), .O(new_n99_));
  ...
  nor2   g055(.a(new_n106_), .b(new_n95_), .O(new_n107_));
  nand2  g056(.a(new_n107_), .b(new_n105_), .O(z05));
  inv1   g057(.a(x25), .O(new_n109_));
  nand3  g058(.a(new_n102_), .b(new_n73_), .c(new_n79_), .O(new_n110_));
  aoi21  g059(.a(new_n110_), .b(new_n60_), .c(new_n55_), .O(new_n111_));
  nor2   g060(.a(x25), .b(x24), .O(new_n112_));
  nand4  g061(.a(new_n112_), .b(new_n90_), .c(new_n73_), .d(new_n54_), .O(new_n113_));
  ...
  nor2   g077(.a(new_n128_), .b(new_n95_), .O(new_n129_));
  nand2  g078(.a(new_n129_), .b(new_n127_), .O(z07));
  inv1   g079(.a(x27), .O(new_n131_));
  nor2   g080(.a(x26), .b(x25), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n102_), .c(new_n88_), .O(new_n133_));
  aoi21  g082(.a(new_n133_), .b(new_n60_), .c(new_n55_), .O(new_n134_));
  nor3   g083(.a(x27), .b(x26), .c(x25), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n102_), .c(new_n88_), .d(new_n54_), .O(new_n136_));
  ...
  nand4  g092(.a(new_n143_), .b(new_n112_), .c(new_n90_), .d(new_n71_), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n64_), .c(new_n66_), .O(new_n145_));
  nor3   g094(.a(x28), .b(x27), .c(x26), .O(new_n146_));
  nand4  g095(.a(new_n146_), .b(new_n120_), .c(new_n88_), .d(new_n54_), .O(new_n147_));
  ...
  oai21  g099(.a(new_n150_), .b(x32), .c(new_n52_), .O(z09));
  ...
  aoi21  g103(.a(new_n154_), .b(new_n54_), .c(new_n152_), .O(new_n155_));
  nor3   g104(.a(x29), .b(x28), .c(x27), .O(new_n156_));
  nand2  g105(.a(new_n156_), .b(new_n124_), .O(new_n157_));
  nor3   g106(.a(new_n157_), .b(new_n91_), .c(new_n66_), .O(new_n158_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n132_), .c(new_n102_), .d(new_n82_), .O(new_n164_));
  ...
  nand4  g116(.a(new_n167_), .b(new_n166_), .c(new_n124_), .d(new_n92_), .O(new_n168_));
  oai21  g117(.a(new_n165_), .b(new_n163_), .c(new_n168_), .O(new_n169_));
  nor2   g118(.a(x16), .b(x04), .O(new_n170_));
  aoi21  g119(.a(new_n169_), .b(x16), .c(new_n170_), .O(new_n171_));
  oai21  g120(.a(new_n171_), .b(x32), .c(new_n52_), .O(z11));
  inv1   g121(.a(x31), .O(new_n173_));
  nor3   g122(.a(x30), .b(x29), .c(x28), .O(new_n174_));
  nand4  g123(.a(new_n174_), .b(new_n143_), .c(new_n120_), .d(new_n82_), .O(new_n175_));
  ...
  nand3  g129(.a(new_n180_), .b(new_n135_), .c(new_n104_), .O(new_n181_));
  oai21  g130(.a(new_n176_), .b(new_n173_), .c(new_n181_), .O(new_n182_));
  nor2   g131(.a(x16), .b(x03), .O(new_n183_));
  aoi21  g132(.a(new_n182_), .b(x16), .c(new_n183_), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(x32), .c(new_n52_), .O(z12));
  nand4  g134(.a(new_n90_), .b(new_n73_), .c(new_n54_), .d(x16), .O(new_n186_));
  nand3  g135(.a(new_n180_), .b(new_n143_), .c(new_n112_), .O(new_n187_));
  oai22  g136(.a(new_n187_), .b(new_n186_), .c(x16), .d(x02), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(new_n60_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n52_), .O(z13));
  inv1   g139(.a(x33), .O(new_n191_));
  nor3   g140(.a(x31), .b(x30), .c(x29), .O(new_n192_));
  nand4  g141(.a(new_n192_), .b(new_n146_), .c(new_n120_), .d(new_n82_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n64_), .c(new_n66_), .O(new_n194_));
  nand3  g143(.a(new_n167_), .b(new_n191_), .c(new_n173_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n166_), .c(new_n132_), .d(new_n104_), .O(new_n197_));
  ...
  oai21  g149(.a(new_n200_), .b(x32), .c(new_n52_), .O(z14));
  inv1   g150(.a(x34), .O(new_n202_));
  nand2  g151(.a(new_n196_), .b(new_n146_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n121_), .c(new_n60_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n54_), .c(new_n202_), .O(new_n205_));
  nor2   g154(.a(x34), .b(x33), .O(new_n206_));
  nand4  g155(.a(new_n206_), .b(new_n178_), .c(new_n177_), .d(new_n143_), .O(new_n207_));
  nor2   g156(.a(new_n207_), .b(new_n113_), .O(new_n208_));
  oai21  g157(.a(new_n208_), .b(new_n205_), .c(x16), .O(new_n209_));
  nor2   g158(.a(x16), .b(x00), .O(new_n210_));
  nor2   g159(.a(new_n210_), .b(new_n95_), .O(new_n211_));
