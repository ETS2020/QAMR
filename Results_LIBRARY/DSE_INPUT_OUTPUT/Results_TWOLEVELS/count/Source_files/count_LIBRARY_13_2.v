...
module FAU ( 
  ...
  oai21  g002(.a(new_n53_), .b(x10), .c(new_n52_), .O(new_n54_));
  ...
  oai21  g044(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n96_));
  ...
  nand4  g049(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n55_), .O(new_n101_));
  oai21  g050(.a(new_n91_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand2  g051(.a(new_n102_), .b(x16), .O(new_n103_));
  aoi21  g052(.a(x18), .b(x15), .c(new_n63_), .O(new_n104_));
  ...
  nand4  g075(.a(new_n126_), .b(new_n100_), .c(new_n80_), .d(new_n58_), .O(new_n127_));
  ...
  nand4  g092(.a(new_n143_), .b(new_n118_), .c(new_n89_), .d(new_n66_), .O(new_n144_));
  ...
  aoi21  g097(.a(new_n148_), .b(new_n146_), .c(new_n63_), .O(z10));
  ...
  nand3  g106(.a(new_n157_), .b(new_n155_), .c(new_n61_), .O(z11));
  ...
  nand3  g115(.a(new_n166_), .b(new_n164_), .c(new_n61_), .O(z12));
  ...
  or2    g121(.a(new_n172_), .b(new_n101_), .O(new_n173_));
  ...
  nand3  g126(.a(new_n177_), .b(new_n175_), .c(new_n61_), .O(z13));
  oai21  g127(.a(new_n172_), .b(new_n101_), .c(x33), .O(new_n179_));
  nand4  g128(.a(new_n106_), .b(new_n97_), .c(new_n87_), .d(new_n78_), .O(new_n180_));
  nor2   g129(.a(new_n180_), .b(new_n72_), .O(new_n181_));
  ...
  aoi21  g139(.a(new_n190_), .b(new_n188_), .c(new_n63_), .O(z14));
  ...
  aoi21  g156(.a(new_n207_), .b(new_n205_), .c(new_n63_), .O(z15));
endmodule
