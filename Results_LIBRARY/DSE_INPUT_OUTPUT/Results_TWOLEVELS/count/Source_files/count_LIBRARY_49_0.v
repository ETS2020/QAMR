...
module FAU ( 
  ...
  aoi21  g039(.a(new_n90_), .b(new_n87_), .c(new_n67_), .O(new_n91_));
  oai21  g040(.a(new_n91_), .b(x18), .c(new_n86_), .O(new_n92_));
  inv1   g041(.a(x11), .O(new_n93_));
  nand3  g042(.a(new_n67_), .b(new_n93_), .c(x08), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(new_n92_), .O(z04));
  inv1   g044(.a(x24), .O(new_n96_));
  inv1   g045(.a(x23), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n77_), .c(new_n70_), .O(new_n98_));
  ...
  aoi21  g054(.a(new_n105_), .b(new_n103_), .c(new_n57_), .O(z05));
  nand2  g055(.a(new_n101_), .b(x25), .O(new_n107_));
  nor2   g056(.a(x21), .b(x20), .O(new_n108_));
  nor2   g057(.a(x25), .b(x24), .O(new_n109_));
  nand4  g058(.a(new_n109_), .b(new_n89_), .c(new_n108_), .d(new_n55_), .O(new_n110_));
  ...
  aoi21  g063(.a(new_n114_), .b(new_n112_), .c(new_n57_), .O(z06));
  nand2  g064(.a(new_n86_), .b(x18), .O(new_n116_));
  inv1   g065(.a(x08), .O(new_n117_));
  oai21  g066(.a(new_n67_), .b(new_n93_), .c(new_n117_), .O(new_n118_));
  nand2  g067(.a(new_n110_), .b(x26), .O(new_n119_));
  nor3   g068(.a(x26), .b(x25), .c(x24), .O(new_n120_));
  nand3  g069(.a(new_n120_), .b(new_n89_), .c(new_n78_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g072(.a(new_n123_), .b(new_n118_), .c(new_n116_), .O(z07));
  ...
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n116_), .O(z08));
  ...
  nand4  g094(.a(new_n145_), .b(new_n120_), .c(new_n99_), .d(new_n144_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g097(.a(x05), .O(new_n149_));
  aoi21  g098(.a(new_n67_), .b(new_n149_), .c(x18), .O(new_n150_));
  aoi21  g099(.a(new_n150_), .b(new_n148_), .c(new_n57_), .O(z10));
  nor2   g100(.a(x26), .b(x25), .O(new_n152_));
  nand4  g101(.a(new_n145_), .b(new_n152_), .c(new_n144_), .d(new_n96_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n90_), .c(x30), .O(new_n154_));
  nor2   g103(.a(x28), .b(x27), .O(new_n155_));
  nor2   g104(.a(x30), .b(x29), .O(new_n156_));
  nand4  g105(.a(new_n156_), .b(new_n155_), .c(new_n120_), .d(new_n99_), .O(new_n157_));
  ...
  nand4  g111(.a(new_n156_), .b(new_n155_), .c(new_n152_), .d(new_n96_), .O(new_n163_));
  ...
  nand3  g123(.a(new_n166_), .b(new_n145_), .c(new_n127_), .O(new_n175_));
  ...
  nand3  g132(.a(new_n183_), .b(new_n181_), .c(new_n116_), .O(z13));
  oai21  g133(.a(new_n178_), .b(new_n101_), .c(x33), .O(new_n185_));
  inv1   g134(.a(x25), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n96_), .c(new_n97_), .d(new_n77_), .O(new_n187_));
  nor2   g136(.a(new_n187_), .b(new_n71_), .O(new_n188_));
  nor2   g137(.a(x27), .b(x26), .O(new_n189_));
  nor2   g138(.a(x33), .b(x32), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n166_), .c(new_n145_), .d(new_n189_), .O(new_n191_));
  ...
  nand2  g148(.a(new_n145_), .b(new_n189_), .O(new_n200_));
