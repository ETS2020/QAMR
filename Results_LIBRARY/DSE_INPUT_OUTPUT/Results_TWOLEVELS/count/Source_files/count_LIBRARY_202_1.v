...
module FAU ( 
  ...
  nor2   g008(.a(new_n52_), .b(x02), .O(new_n60_));
  aoi21  g009(.a(x18), .b(x02), .c(new_n60_), .O(new_n61_));
  nand3  g010(.a(new_n61_), .b(new_n59_), .c(new_n54_), .O(z00));
  oai21  g011(.a(new_n52_), .b(x02), .c(x18), .O(new_n63_));
  ...
  nand3  g084(.a(new_n81_), .b(new_n58_), .c(new_n64_), .O(new_n136_));
  ...
  nand3  g091(.a(new_n142_), .b(new_n140_), .c(new_n63_), .O(z08));
  ...
  nand4  g106(.a(new_n157_), .b(new_n132_), .c(new_n102_), .d(new_n81_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n56_), .c(new_n66_), .O(new_n159_));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n124_), .c(new_n94_), .d(new_n131_), .O(new_n161_));
  oai21  g110(.a(new_n159_), .b(new_n156_), .c(new_n161_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  nor2   g112(.a(x16), .b(x05), .O(new_n164_));
  nor2   g113(.a(new_n164_), .b(new_n60_), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n163_), .c(new_n63_), .O(z10));
  inv1   g115(.a(x30), .O(new_n167_));
  nand3  g116(.a(new_n160_), .b(new_n132_), .c(new_n131_), .O(new_n168_));
  oai21  g117(.a(new_n168_), .b(new_n110_), .c(new_n56_), .O(new_n169_));
  aoi21  g118(.a(new_n169_), .b(new_n67_), .c(new_n167_), .O(new_n170_));
  nor2   g119(.a(x30), .b(x29), .O(new_n171_));
  nand3  g120(.a(new_n171_), .b(new_n157_), .c(new_n124_), .O(new_n172_));
  nor3   g121(.a(new_n172_), .b(new_n93_), .c(new_n66_), .O(new_n173_));
  ...
  nand3  g125(.a(new_n176_), .b(new_n174_), .c(new_n63_), .O(z11));
  ...
  nand4  g131(.a(new_n182_), .b(new_n160_), .c(new_n137_), .d(new_n109_), .O(new_n183_));
  ...
  nand4  g139(.a(new_n190_), .b(new_n171_), .c(new_n157_), .d(new_n132_), .O(new_n191_));
  oai22  g140(.a(new_n191_), .b(new_n103_), .c(new_n67_), .d(new_n189_), .O(new_n192_));
  aoi21  g141(.a(new_n192_), .b(x16), .c(x18), .O(new_n193_));
  inv1   g142(.a(x02), .O(new_n194_));
  oai21  g143(.a(x19), .b(new_n194_), .c(x15), .O(new_n195_));
  nor3   g144(.a(x31), .b(x30), .c(x29), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n149_), .c(new_n148_), .d(new_n81_), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n195_), .c(x32), .d(x16), .O(new_n198_));
  nand3  g147(.a(new_n53_), .b(new_n52_), .c(new_n194_), .O(new_n199_));
  and2   g148(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  oai21  g149(.a(new_n193_), .b(new_n60_), .c(new_n200_), .O(z13));
  inv1   g150(.a(x33), .O(new_n202_));
  nand4  g151(.a(new_n190_), .b(new_n160_), .c(new_n167_), .d(new_n131_), .O(new_n203_));
  oai21  g152(.a(new_n203_), .b(new_n133_), .c(new_n56_), .O(new_n204_));
  aoi21  g153(.a(new_n204_), .b(new_n67_), .c(new_n202_), .O(new_n205_));
  nand2  g154(.a(new_n160_), .b(new_n137_), .O(new_n206_));
  ...
  nand4  g163(.a(new_n207_), .b(new_n182_), .c(new_n160_), .d(new_n131_), .O(new_n215_));
  oai21  g164(.a(new_n215_), .b(new_n133_), .c(new_n56_), .O(new_n216_));
  aoi21  g165(.a(new_n216_), .b(new_n67_), .c(new_n214_), .O(new_n217_));
  nand4  g166(.a(new_n182_), .b(new_n214_), .c(new_n202_), .d(new_n189_), .O(new_n218_));
