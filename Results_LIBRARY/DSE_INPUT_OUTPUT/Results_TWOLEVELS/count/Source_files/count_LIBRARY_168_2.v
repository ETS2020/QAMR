...
module FAU ( 
  ...
  aoi21  g042(.a(new_n93_), .b(new_n91_), .c(new_n89_), .O(new_n94_));
  oai21  g043(.a(new_n94_), .b(x18), .c(new_n59_), .O(new_n95_));
  inv1   g044(.a(x11), .O(new_n96_));
  nand3  g045(.a(new_n89_), .b(new_n96_), .c(new_n57_), .O(new_n97_));
  ...
  aoi21  g067(.a(new_n89_), .b(new_n118_), .c(x18), .O(new_n119_));
  ...
  aoi21  g092(.a(new_n89_), .b(new_n143_), .c(x18), .O(new_n144_));
  ...
  nand4  g108(.a(new_n151_), .b(new_n134_), .c(new_n103_), .d(new_n81_), .O(new_n160_));
  ...
  nand3  g116(.a(new_n167_), .b(new_n165_), .c(new_n60_), .O(z10));
  ...
  aoi21  g126(.a(new_n89_), .b(new_n177_), .c(x18), .O(new_n178_));
  ...
  aoi21  g138(.a(new_n89_), .b(new_n189_), .c(x18), .O(new_n190_));
  ...
  nor2   g171(.a(new_n222_), .b(new_n58_), .O(new_n223_));
  nand3  g172(.a(new_n223_), .b(new_n221_), .c(new_n60_), .O(z15));
endmodule
