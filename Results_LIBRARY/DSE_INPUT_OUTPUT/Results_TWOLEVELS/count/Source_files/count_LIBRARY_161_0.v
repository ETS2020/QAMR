...
module FAU ( 
  ...
  nor2   g000(.a(x15), .b(x04), .O(new_n52_));
  ...
  nand3  g028(.a(new_n79_), .b(new_n59_), .c(new_n62_), .O(new_n80_));
  ...
  oai21  g036(.a(x22), .b(x21), .c(new_n63_), .O(new_n88_));
  ...
  nand4  g058(.a(new_n109_), .b(new_n90_), .c(new_n71_), .d(new_n60_), .O(new_n110_));
  ...
  nand3  g063(.a(new_n114_), .b(new_n112_), .c(new_n97_), .O(z06));
  inv1   g064(.a(x26), .O(new_n116_));
  nand3  g065(.a(new_n109_), .b(new_n79_), .c(new_n87_), .O(new_n117_));
  aoi21  g066(.a(new_n117_), .b(new_n63_), .c(new_n64_), .O(new_n118_));
  nor3   g067(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand2  g068(.a(new_n119_), .b(new_n90_), .O(new_n120_));
  oai22  g069(.a(new_n120_), .b(new_n72_), .c(new_n118_), .d(new_n116_), .O(new_n121_));
  ...
  nand4  g076(.a(new_n127_), .b(new_n90_), .c(new_n98_), .d(new_n70_), .O(new_n128_));
  nand2  g077(.a(new_n128_), .b(new_n63_), .O(new_n129_));
  aoi21  g078(.a(new_n129_), .b(new_n65_), .c(new_n126_), .O(new_n130_));
  nand3  g079(.a(new_n79_), .b(new_n60_), .c(new_n59_), .O(new_n131_));
  nor2   g080(.a(x27), .b(x26), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n99_), .c(new_n106_), .O(new_n133_));
  ...
  nand4  g089(.a(new_n140_), .b(new_n109_), .c(new_n116_), .d(new_n87_), .O(new_n141_));
  oai22  g090(.a(new_n141_), .b(new_n131_), .c(new_n134_), .d(new_n139_), .O(new_n142_));
  nand2  g091(.a(new_n142_), .b(x16), .O(new_n143_));
  nor2   g092(.a(x16), .b(x06), .O(new_n144_));
  nor2   g093(.a(new_n144_), .b(new_n52_), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n143_), .c(new_n97_), .O(z09));
  inv1   g095(.a(x29), .O(new_n147_));
  nand4  g096(.a(new_n140_), .b(new_n127_), .c(new_n99_), .d(new_n79_), .O(new_n148_));
  aoi21  g097(.a(new_n148_), .b(new_n63_), .c(new_n64_), .O(new_n149_));
  nor3   g098(.a(x29), .b(x28), .c(x27), .O(new_n150_));
  nand3  g099(.a(new_n150_), .b(new_n119_), .c(new_n92_), .O(new_n151_));
  ...
  aoi21  g104(.a(new_n155_), .b(new_n153_), .c(new_n52_), .O(z10));
  inv1   g105(.a(x04), .O(new_n157_));
  oai21  g106(.a(new_n56_), .b(new_n55_), .c(new_n157_), .O(new_n158_));
  nand2  g107(.a(new_n151_), .b(x30), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand4  g109(.a(new_n160_), .b(new_n140_), .c(new_n119_), .d(new_n92_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g112(.a(new_n163_), .b(new_n158_), .c(new_n97_), .O(z11));
  inv1   g113(.a(x31), .O(new_n165_));
  nand3  g114(.a(new_n160_), .b(new_n132_), .c(new_n139_), .O(new_n166_));
  oai21  g115(.a(new_n166_), .b(new_n117_), .c(new_n63_), .O(new_n167_));
  ...
  nand4  g119(.a(new_n170_), .b(new_n169_), .c(new_n132_), .d(new_n106_), .O(new_n171_));
  ...
  nand2  g126(.a(new_n140_), .b(new_n127_), .O(new_n178_));
  inv1   g127(.a(new_n178_), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n160_), .c(new_n179_), .d(new_n108_), .O(new_n181_));
  ...
  nand3  g134(.a(new_n185_), .b(new_n183_), .c(new_n97_), .O(z13));
  inv1   g135(.a(x33), .O(new_n187_));
  inv1   g136(.a(x30), .O(new_n188_));
  nand4  g137(.a(new_n180_), .b(new_n169_), .c(new_n188_), .d(new_n126_), .O(new_n189_));
  oai21  g138(.a(new_n189_), .b(new_n128_), .c(new_n63_), .O(new_n190_));
  aoi21  g139(.a(new_n190_), .b(new_n65_), .c(new_n187_), .O(new_n191_));
  nand2  g140(.a(new_n169_), .b(new_n132_), .O(new_n192_));
  nor2   g141(.a(x33), .b(x32), .O(new_n193_));
  nand2  g142(.a(new_n193_), .b(new_n170_), .O(new_n194_));
  nor3   g143(.a(new_n194_), .b(new_n192_), .c(new_n110_), .O(new_n195_));
  ...
  nand4  g149(.a(new_n193_), .b(new_n170_), .c(new_n169_), .d(new_n126_), .O(new_n201_));
  oai21  g150(.a(new_n201_), .b(new_n128_), .c(new_n63_), .O(new_n202_));
  aoi21  g151(.a(new_n202_), .b(new_n65_), .c(new_n200_), .O(new_n203_));
  nand4  g152(.a(new_n170_), .b(new_n200_), .c(new_n187_), .d(new_n177_), .O(new_n204_));
  nor3   g153(.a(new_n204_), .b(new_n192_), .c(new_n110_), .O(new_n205_));
