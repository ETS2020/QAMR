...
module FAU ( 
  ...
  oai21  g037(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(new_n89_));
  ...
  nand3  g045(.a(new_n96_), .b(new_n89_), .c(new_n61_), .O(z04));
  inv1   g046(.a(x24), .O(new_n98_));
  nand2  g047(.a(new_n93_), .b(new_n72_), .O(new_n99_));
  ...
  nand4  g062(.a(new_n113_), .b(new_n93_), .c(new_n73_), .d(new_n55_), .O(new_n114_));
  ...
  nand3  g069(.a(new_n113_), .b(new_n81_), .c(new_n90_), .O(new_n121_));
  ...
  nand4  g081(.a(new_n132_), .b(new_n93_), .c(new_n98_), .d(new_n72_), .O(new_n133_));
  ...
  nand2  g096(.a(new_n113_), .b(new_n90_), .O(new_n148_));
