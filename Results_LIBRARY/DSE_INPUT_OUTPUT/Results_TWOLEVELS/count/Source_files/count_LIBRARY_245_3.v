...
module FAU ( 
  ...
  nand2  g038(.a(new_n83_), .b(x23), .O(new_n90_));
  nor2   g039(.a(x20), .b(x19), .O(new_n91_));
  nor2   g040(.a(x23), .b(x22), .O(new_n92_));
  nand4  g041(.a(new_n92_), .b(new_n91_), .c(new_n73_), .d(new_n52_), .O(new_n93_));
  nand2  g042(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand2  g043(.a(new_n94_), .b(x16), .O(new_n95_));
  aoi21  g044(.a(x18), .b(new_n57_), .c(new_n60_), .O(new_n96_));
  nand3  g045(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z04));
  oai21  g046(.a(x18), .b(new_n70_), .c(new_n57_), .O(new_n98_));
  inv1   g047(.a(x24), .O(new_n99_));
  inv1   g048(.a(x23), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n80_), .c(new_n73_), .O(new_n101_));
  nor2   g050(.a(new_n101_), .b(new_n66_), .O(new_n102_));
  nor2   g051(.a(x24), .b(x23), .O(new_n103_));
  nand4  g052(.a(new_n103_), .b(new_n82_), .c(new_n91_), .d(new_n52_), .O(new_n104_));
  oai21  g053(.a(new_n102_), .b(new_n99_), .c(new_n104_), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(x16), .O(new_n106_));
  aoi21  g055(.a(x18), .b(new_n58_), .c(new_n60_), .O(new_n107_));
  nand3  g056(.a(new_n107_), .b(new_n106_), .c(new_n98_), .O(z05));
  nand2  g057(.a(new_n104_), .b(x25), .O(new_n109_));
  ...
  nor2   g064(.a(new_n115_), .b(new_n60_), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n114_), .c(new_n59_), .O(z06));
  nand2  g066(.a(new_n112_), .b(x26), .O(new_n118_));
  nor3   g067(.a(x26), .b(x25), .c(x24), .O(new_n119_));
  nand3  g068(.a(new_n119_), .b(new_n92_), .c(new_n81_), .O(new_n120_));
  nand2  g069(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(x16), .O(new_n122_));
  inv1   g071(.a(x08), .O(new_n123_));
  aoi21  g072(.a(new_n70_), .b(new_n123_), .c(x18), .O(new_n124_));
  aoi21  g073(.a(new_n124_), .b(new_n122_), .c(new_n60_), .O(z07));
  nand2  g074(.a(new_n120_), .b(x27), .O(new_n126_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n111_), .c(new_n136_), .d(new_n100_), .O(new_n138_));
  or2    g087(.a(new_n138_), .b(new_n83_), .O(new_n139_));
  ...
  nand3  g092(.a(new_n143_), .b(new_n141_), .c(new_n59_), .O(z09));
  oai21  g093(.a(new_n138_), .b(new_n83_), .c(x29), .O(new_n145_));
  nor3   g094(.a(x29), .b(x28), .c(x27), .O(new_n146_));
  nand3  g095(.a(new_n146_), .b(new_n119_), .c(new_n102_), .O(new_n147_));
  nand2  g096(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g097(.a(new_n148_), .b(x16), .O(new_n149_));
  inv1   g098(.a(x05), .O(new_n150_));
  aoi21  g099(.a(new_n70_), .b(new_n150_), .c(x18), .O(new_n151_));
  aoi21  g100(.a(new_n151_), .b(new_n149_), .c(new_n60_), .O(z10));
  inv1   g101(.a(x27), .O(new_n153_));
  nor2   g102(.a(x26), .b(x25), .O(new_n154_));
  nor2   g103(.a(x29), .b(x28), .O(new_n155_));
  nand4  g104(.a(new_n155_), .b(new_n154_), .c(new_n153_), .d(new_n99_), .O(new_n156_));
  oai21  g105(.a(new_n156_), .b(new_n93_), .c(x30), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand2  g107(.a(new_n158_), .b(new_n137_), .O(new_n159_));
  inv1   g108(.a(new_n159_), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n119_), .c(new_n102_), .O(new_n161_));
  nand2  g110(.a(new_n161_), .b(new_n157_), .O(new_n162_));
  nand2  g111(.a(new_n162_), .b(x16), .O(new_n163_));
  inv1   g112(.a(x04), .O(new_n164_));
  aoi21  g113(.a(new_n70_), .b(new_n164_), .c(x18), .O(new_n165_));
  aoi21  g114(.a(new_n165_), .b(new_n163_), .c(new_n60_), .O(z11));
  nand4  g115(.a(new_n158_), .b(new_n137_), .c(new_n154_), .d(new_n99_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n93_), .c(x31), .O(new_n168_));
  ...
  nand4  g122(.a(new_n173_), .b(new_n128_), .c(new_n170_), .d(new_n67_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n168_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(x16), .O(new_n176_));
  inv1   g125(.a(x03), .O(new_n177_));
  aoi21  g126(.a(new_n70_), .b(new_n177_), .c(x18), .O(new_n178_));
  aoi21  g127(.a(new_n178_), .b(new_n176_), .c(new_n60_), .O(z12));
  inv1   g128(.a(x25), .O(new_n180_));
  nor2   g129(.a(x27), .b(x26), .O(new_n181_));
  nand4  g130(.a(new_n171_), .b(new_n155_), .c(new_n181_), .d(new_n180_), .O(new_n182_));
  oai21  g131(.a(new_n182_), .b(new_n104_), .c(x32), .O(new_n183_));
  nand2  g132(.a(new_n137_), .b(new_n154_), .O(new_n184_));
  inv1   g133(.a(new_n184_), .O(new_n185_));
  nor2   g134(.a(x32), .b(x31), .O(new_n186_));
  nand2  g135(.a(new_n186_), .b(new_n158_), .O(new_n187_));
  inv1   g136(.a(new_n187_), .O(new_n188_));
  nand4  g137(.a(new_n188_), .b(new_n185_), .c(new_n170_), .d(new_n67_), .O(new_n189_));
  nand2  g138(.a(new_n189_), .b(new_n183_), .O(new_n190_));
  nand2  g139(.a(new_n190_), .b(x16), .O(new_n191_));
  inv1   g140(.a(x02), .O(new_n192_));
  aoi21  g141(.a(new_n70_), .b(new_n192_), .c(x18), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n191_), .c(new_n60_), .O(z13));
  nand4  g143(.a(new_n186_), .b(new_n158_), .c(new_n137_), .d(new_n154_), .O(new_n195_));
  oai21  g144(.a(new_n195_), .b(new_n104_), .c(x33), .O(new_n196_));
  nor2   g145(.a(x33), .b(x32), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n171_), .c(new_n155_), .d(new_n181_), .O(new_n198_));
  oai21  g147(.a(new_n198_), .b(new_n112_), .c(new_n196_), .O(new_n199_));
  nand2  g148(.a(new_n199_), .b(x16), .O(new_n200_));
  nor2   g149(.a(x16), .b(x01), .O(new_n201_));
  nor2   g150(.a(new_n201_), .b(new_n60_), .O(new_n202_));
  nand3  g151(.a(new_n202_), .b(new_n200_), .c(new_n59_), .O(z14));
  oai21  g152(.a(new_n198_), .b(new_n112_), .c(x34), .O(new_n204_));
  nand4  g153(.a(new_n180_), .b(new_n99_), .c(new_n100_), .d(new_n80_), .O(new_n205_));
  nor2   g154(.a(new_n205_), .b(new_n74_), .O(new_n206_));
  nand2  g155(.a(new_n155_), .b(new_n181_), .O(new_n207_));
  ...
  nand3  g165(.a(new_n216_), .b(new_n208_), .c(new_n206_), .O(new_n217_));
  nand2  g166(.a(new_n217_), .b(new_n204_), .O(new_n218_));
  nand2  g167(.a(new_n218_), .b(x16), .O(new_n219_));
  inv1   g168(.a(x00), .O(new_n220_));
  aoi21  g169(.a(new_n70_), .b(new_n220_), .c(x18), .O(new_n221_));
