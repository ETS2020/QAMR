...
module FAU ( 
  ...
  nand3  g052(.a(new_n103_), .b(new_n85_), .c(new_n66_), .O(new_n104_));
  ...
  nand3  g065(.a(new_n116_), .b(new_n114_), .c(new_n72_), .O(z06));
  ...
  oai22  g081(.a(new_n132_), .b(new_n86_), .c(new_n125_), .d(new_n130_), .O(new_n133_));
  ...
  oai21  g086(.a(new_n132_), .b(new_n86_), .c(x28), .O(new_n138_));
  nor2   g087(.a(x28), .b(x27), .O(new_n139_));
  nand3  g088(.a(new_n139_), .b(new_n119_), .c(new_n118_), .O(new_n140_));
  oai21  g089(.a(new_n140_), .b(new_n86_), .c(new_n138_), .O(new_n141_));
  nand2  g090(.a(new_n141_), .b(x16), .O(new_n142_));
  nor2   g091(.a(x16), .b(x06), .O(new_n143_));
  nor2   g092(.a(new_n143_), .b(new_n54_), .O(new_n144_));
  nand3  g093(.a(new_n144_), .b(new_n142_), .c(new_n72_), .O(z09));
  oai21  g094(.a(new_n140_), .b(new_n86_), .c(x29), .O(new_n146_));
  nor2   g095(.a(x29), .b(x28), .O(new_n147_));
  nand3  g096(.a(new_n147_), .b(new_n123_), .c(new_n130_), .O(new_n148_));
  oai21  g097(.a(new_n148_), .b(new_n93_), .c(new_n146_), .O(new_n149_));
  nand2  g098(.a(new_n149_), .b(x16), .O(new_n150_));
  nor2   g099(.a(x16), .b(x05), .O(new_n151_));
  nor2   g100(.a(new_n151_), .b(new_n54_), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n150_), .c(new_n72_), .O(z10));
  inv1   g102(.a(x30), .O(new_n154_));
  nand2  g103(.a(new_n103_), .b(new_n85_), .O(new_n155_));
  nor2   g104(.a(x26), .b(x25), .O(new_n156_));
  nand3  g105(.a(new_n147_), .b(new_n156_), .c(new_n130_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n155_), .c(new_n56_), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n66_), .c(new_n154_), .O(new_n159_));
  nor2   g108(.a(x30), .b(x29), .O(new_n160_));
  nand3  g109(.a(new_n160_), .b(new_n139_), .c(new_n123_), .O(new_n161_));
  ...
  nand3  g117(.a(new_n168_), .b(new_n147_), .c(new_n131_), .O(new_n169_));
  oai22  g118(.a(new_n169_), .b(new_n104_), .c(new_n162_), .d(new_n167_), .O(new_n170_));
  ...
  oai21  g123(.a(new_n169_), .b(new_n104_), .c(x32), .O(new_n175_));
  nor2   g124(.a(x32), .b(x31), .O(new_n176_));
  nand4  g125(.a(new_n176_), .b(new_n160_), .c(new_n139_), .d(new_n156_), .O(new_n177_));
  ...
  nand3  g130(.a(new_n181_), .b(new_n179_), .c(new_n72_), .O(z13));
  oai21  g131(.a(new_n177_), .b(new_n104_), .c(x33), .O(new_n183_));
  nand3  g132(.a(new_n147_), .b(new_n130_), .c(new_n118_), .O(new_n184_));
  ...
  oai21  g136(.a(new_n187_), .b(new_n112_), .c(new_n183_), .O(new_n188_));
  nand2  g137(.a(new_n188_), .b(x16), .O(new_n189_));
  nor2   g138(.a(x16), .b(x01), .O(new_n190_));
  nor2   g139(.a(new_n190_), .b(new_n54_), .O(new_n191_));
  nand3  g140(.a(new_n191_), .b(new_n189_), .c(new_n72_), .O(z14));
  inv1   g141(.a(x34), .O(new_n193_));
  nand4  g142(.a(new_n156_), .b(new_n92_), .c(new_n99_), .d(new_n73_), .O(new_n194_));
  nand4  g143(.a(new_n185_), .b(new_n168_), .c(new_n147_), .d(new_n130_), .O(new_n195_));
  ...
  nand2  g147(.a(new_n198_), .b(new_n168_), .O(new_n199_));
  nor3   g148(.a(new_n199_), .b(new_n184_), .c(new_n112_), .O(new_n200_));
  ...
  aoi21  g152(.a(new_n203_), .b(new_n201_), .c(new_n54_), .O(z15));
endmodule
