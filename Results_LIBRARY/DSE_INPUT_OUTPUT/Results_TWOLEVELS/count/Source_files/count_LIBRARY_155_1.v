...
module FAU ( 
  ...
  oai21  g019(.a(new_n52_), .b(x02), .c(x18), .O(new_n71_));
  ...
  oai21  g075(.a(x18), .b(new_n60_), .c(new_n52_), .O(new_n127_));
  and2   g076(.a(new_n121_), .b(x27), .O(new_n128_));
  nand3  g077(.a(new_n80_), .b(new_n57_), .c(new_n63_), .O(new_n129_));
  ...
  aoi21  g082(.a(x18), .b(x02), .c(new_n53_), .O(new_n134_));
  nand3  g083(.a(new_n134_), .b(new_n133_), .c(new_n127_), .O(z08));
  ...
  oai22  g087(.a(new_n138_), .b(new_n129_), .c(new_n132_), .d(new_n136_), .O(new_n139_));
  ...
  oai21  g093(.a(new_n138_), .b(new_n129_), .c(x29), .O(new_n145_));
  ...
  nand3  g116(.a(new_n159_), .b(new_n130_), .c(new_n136_), .O(new_n168_));
  ...
  nand4  g120(.a(new_n171_), .b(new_n147_), .c(new_n130_), .d(new_n107_), .O(new_n172_));
  ...
  oai21  g127(.a(new_n60_), .b(x07), .c(new_n178_), .O(new_n179_));
  inv1   g128(.a(x32), .O(new_n180_));
  nor2   g129(.a(x32), .b(x31), .O(new_n181_));
  nand2  g130(.a(new_n181_), .b(new_n159_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nand4  g132(.a(new_n183_), .b(new_n137_), .c(new_n155_), .d(new_n109_), .O(new_n184_));
  oai21  g133(.a(new_n173_), .b(new_n180_), .c(new_n184_), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(x16), .O(new_n186_));
  nand3  g135(.a(new_n186_), .b(new_n179_), .c(new_n71_), .O(z13));
  inv1   g136(.a(x33), .O(new_n188_));
  nand4  g137(.a(new_n155_), .b(new_n92_), .c(new_n99_), .d(new_n72_), .O(new_n189_));
  nand4  g138(.a(new_n181_), .b(new_n147_), .c(new_n154_), .d(new_n146_), .O(new_n190_));
  ...
  nand2  g143(.a(new_n147_), .b(new_n130_), .O(new_n195_));
