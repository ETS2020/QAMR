...
module FAU ( 
  ...
  nor2   g010(.a(new_n58_), .b(new_n57_), .O(new_n62_));
  aoi21  g011(.a(new_n61_), .b(new_n60_), .c(new_n62_), .O(new_n63_));
  ...
  aoi21  g055(.a(new_n106_), .b(new_n104_), .c(new_n62_), .O(z05));
  ...
  aoi21  g065(.a(new_n116_), .b(new_n114_), .c(new_n62_), .O(z06));
  ...
  nand3  g069(.a(new_n120_), .b(new_n110_), .c(new_n81_), .O(new_n121_));
  nand2  g070(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g071(.a(new_n122_), .b(x16), .O(new_n123_));
  aoi21  g072(.a(x18), .b(new_n58_), .c(new_n62_), .O(new_n124_));
  ...
  nor2   g080(.a(new_n131_), .b(new_n62_), .O(new_n132_));
  nand3  g081(.a(new_n132_), .b(new_n130_), .c(new_n59_), .O(z08));
  ...
  aoi21  g090(.a(new_n141_), .b(new_n139_), .c(new_n62_), .O(z09));
  nand2  g091(.a(new_n137_), .b(x29), .O(new_n143_));
  inv1   g092(.a(x27), .O(new_n144_));
  nor2   g093(.a(x29), .b(x28), .O(new_n145_));
  nand4  g094(.a(new_n145_), .b(new_n120_), .c(new_n92_), .d(new_n144_), .O(new_n146_));
  ...
  aoi21  g099(.a(new_n150_), .b(new_n148_), .c(new_n62_), .O(z10));
  nand4  g100(.a(new_n110_), .b(new_n99_), .c(new_n73_), .d(new_n52_), .O(new_n152_));
  nor2   g101(.a(x26), .b(x25), .O(new_n153_));
  nand4  g102(.a(new_n145_), .b(new_n153_), .c(new_n144_), .d(new_n98_), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n152_), .c(x30), .O(new_n155_));
  nor2   g104(.a(x28), .b(x27), .O(new_n156_));
  nor2   g105(.a(x30), .b(x29), .O(new_n157_));
  nand4  g106(.a(new_n157_), .b(new_n156_), .c(new_n120_), .d(new_n92_), .O(new_n158_));
  ...
  oai21  g113(.a(new_n164_), .b(new_n152_), .c(x31), .O(new_n165_));
  ...
  nand3  g124(.a(new_n167_), .b(new_n145_), .c(new_n127_), .O(new_n176_));
  ...
  nand4  g140(.a(new_n191_), .b(new_n167_), .c(new_n145_), .d(new_n190_), .O(new_n192_));
  ...
  aoi21  g147(.a(new_n198_), .b(new_n196_), .c(new_n62_), .O(z14));
  oai21  g148(.a(new_n192_), .b(new_n112_), .c(x34), .O(new_n200_));
  nand2  g149(.a(new_n145_), .b(new_n190_), .O(new_n201_));
