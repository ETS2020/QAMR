...
module FAU ( 
  ...
  oai21  g159(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(new_n211_));
  ...
  nand3  g167(.a(new_n218_), .b(new_n211_), .c(new_n61_), .O(z15));
endmodule
