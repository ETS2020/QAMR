...
module FAU ( 
  ...
  nor2   g008(.a(new_n52_), .b(x05), .O(new_n60_));
  aoi21  g009(.a(x18), .b(x05), .c(new_n60_), .O(new_n61_));
  ...
  oai21  g018(.a(new_n52_), .b(x05), .c(x18), .O(new_n70_));
  inv1   g019(.a(x21), .O(new_n71_));
  nand4  g020(.a(new_n71_), .b(new_n63_), .c(new_n56_), .d(new_n55_), .O(new_n72_));
  ...
  nand3  g029(.a(new_n80_), .b(new_n58_), .c(new_n63_), .O(new_n81_));
  ...
  aoi21  g034(.a(new_n85_), .b(new_n83_), .c(new_n60_), .O(z03));
  ...
  aoi21  g064(.a(new_n115_), .b(new_n113_), .c(new_n60_), .O(z06));
  ...
  nand3  g075(.a(new_n126_), .b(new_n124_), .c(new_n70_), .O(z07));
  ...
  nand3  g093(.a(new_n144_), .b(new_n142_), .c(new_n70_), .O(z09));
  inv1   g094(.a(x05), .O(new_n146_));
  oai21  g095(.a(new_n53_), .b(x15), .c(new_n146_), .O(new_n147_));
  oai21  g096(.a(new_n139_), .b(new_n81_), .c(x29), .O(new_n148_));
  inv1   g097(.a(x27), .O(new_n149_));
  nor2   g098(.a(x29), .b(x28), .O(new_n150_));
  nand4  g099(.a(new_n150_), .b(new_n121_), .c(new_n149_), .d(new_n96_), .O(new_n151_));
  oai21  g100(.a(new_n151_), .b(new_n90_), .c(new_n148_), .O(new_n152_));
  nand2  g101(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g102(.a(new_n153_), .b(new_n147_), .c(new_n70_), .O(z10));
  oai21  g103(.a(new_n151_), .b(new_n90_), .c(x30), .O(new_n155_));
  ...
  nor2   g109(.a(new_n160_), .b(new_n60_), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n159_), .c(new_n70_), .O(z11));
  ...
  nand4  g116(.a(new_n167_), .b(new_n130_), .c(new_n164_), .d(new_n65_), .O(new_n168_));
  ...
  nand3  g122(.a(new_n165_), .b(new_n150_), .c(new_n130_), .O(new_n174_));
  ...
  nor2   g131(.a(new_n182_), .b(new_n60_), .O(new_n183_));
  nand3  g132(.a(new_n183_), .b(new_n181_), .c(new_n70_), .O(z13));
  ...
  nand4  g137(.a(new_n188_), .b(new_n165_), .c(new_n150_), .d(new_n187_), .O(new_n189_));
  ...
  nor2   g142(.a(new_n193_), .b(new_n60_), .O(new_n194_));
  nand3  g143(.a(new_n194_), .b(new_n192_), .c(new_n70_), .O(z14));
  oai21  g144(.a(new_n189_), .b(new_n111_), .c(x34), .O(new_n196_));
  nand2  g145(.a(new_n150_), .b(new_n187_), .O(new_n197_));
  ...
  aoi21  g160(.a(new_n211_), .b(new_n209_), .c(new_n60_), .O(z15));
endmodule
