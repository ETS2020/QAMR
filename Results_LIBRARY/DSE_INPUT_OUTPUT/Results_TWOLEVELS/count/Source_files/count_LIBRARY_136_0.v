...
module FAU ( 
  ...
  nor2   g005(.a(x11), .b(x09), .O(new_n57_));
  ...
  aoi21  g023(.a(new_n67_), .b(new_n74_), .c(x18), .O(new_n75_));
  aoi21  g024(.a(new_n75_), .b(new_n73_), .c(new_n57_), .O(z02));
  ...
  aoi21  g032(.a(new_n67_), .b(new_n83_), .c(x18), .O(new_n84_));
  aoi21  g033(.a(new_n84_), .b(new_n82_), .c(new_n57_), .O(z03));
  oai21  g034(.a(x11), .b(x09), .c(x18), .O(new_n86_));
  inv1   g035(.a(x09), .O(new_n87_));
  inv1   g036(.a(x11), .O(new_n88_));
  oai21  g037(.a(new_n67_), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  inv1   g038(.a(x23), .O(new_n90_));
  aoi21  g039(.a(new_n79_), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  nand3  g040(.a(new_n90_), .b(new_n77_), .c(new_n70_), .O(new_n92_));
  nor2   g041(.a(new_n92_), .b(new_n63_), .O(new_n93_));
  oai21  g042(.a(new_n93_), .b(new_n91_), .c(x16), .O(new_n94_));
  nand3  g043(.a(new_n94_), .b(new_n89_), .c(new_n86_), .O(z04));
  ...
  nand4  g048(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n52_), .O(new_n100_));
  oai21  g049(.a(new_n93_), .b(new_n96_), .c(new_n100_), .O(new_n101_));
  nand2  g050(.a(new_n101_), .b(x16), .O(new_n102_));
  nor2   g051(.a(x16), .b(x10), .O(new_n103_));
  nor2   g052(.a(new_n103_), .b(new_n57_), .O(new_n104_));
  nand3  g053(.a(new_n104_), .b(new_n102_), .c(new_n86_), .O(z05));
  oai21  g054(.a(new_n67_), .b(new_n88_), .c(new_n87_), .O(new_n106_));
  nand2  g055(.a(new_n100_), .b(x25), .O(new_n107_));
  nor2   g056(.a(x21), .b(x20), .O(new_n108_));
  nor2   g057(.a(x23), .b(x22), .O(new_n109_));
  nor2   g058(.a(x25), .b(x24), .O(new_n110_));
  nand4  g059(.a(new_n110_), .b(new_n109_), .c(new_n108_), .d(new_n55_), .O(new_n111_));
  nand2  g060(.a(new_n111_), .b(new_n107_), .O(new_n112_));
  nand2  g061(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g062(.a(new_n113_), .b(new_n106_), .c(new_n86_), .O(z06));
  nand2  g063(.a(new_n111_), .b(x26), .O(new_n115_));
  nor3   g064(.a(x26), .b(x25), .c(x24), .O(new_n116_));
  nand3  g065(.a(new_n116_), .b(new_n109_), .c(new_n78_), .O(new_n117_));
  ...
  nand3  g070(.a(new_n121_), .b(new_n119_), .c(new_n86_), .O(z07));
  nand2  g071(.a(new_n117_), .b(x27), .O(new_n123_));
  nor3   g072(.a(x27), .b(x26), .c(x25), .O(new_n124_));
  nand4  g073(.a(new_n124_), .b(new_n99_), .c(new_n79_), .d(new_n55_), .O(new_n125_));
  nand2  g074(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g075(.a(new_n126_), .b(x16), .O(new_n127_));
  nor2   g076(.a(x16), .b(x07), .O(new_n128_));
  nor2   g077(.a(new_n128_), .b(new_n57_), .O(new_n129_));
  nand3  g078(.a(new_n129_), .b(new_n127_), .c(new_n86_), .O(z08));
  ...
  aoi21  g087(.a(new_n138_), .b(new_n136_), .c(new_n57_), .O(z09));
  and2   g088(.a(new_n134_), .b(x29), .O(new_n140_));
  nand4  g089(.a(new_n109_), .b(new_n97_), .c(new_n70_), .d(new_n52_), .O(new_n141_));
  inv1   g090(.a(x27), .O(new_n142_));
  nor2   g091(.a(x26), .b(x25), .O(new_n143_));
  nor2   g092(.a(x29), .b(x28), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n143_), .c(new_n142_), .d(new_n96_), .O(new_n145_));
  nor2   g094(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  oai21  g095(.a(new_n146_), .b(new_n140_), .c(x16), .O(new_n147_));
  nor2   g096(.a(x16), .b(x05), .O(new_n148_));
  nor2   g097(.a(new_n148_), .b(new_n57_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n147_), .c(new_n86_), .O(z10));
  oai21  g099(.a(new_n145_), .b(new_n141_), .c(x30), .O(new_n151_));
  nor2   g100(.a(x28), .b(x27), .O(new_n152_));
  nor2   g101(.a(x30), .b(x29), .O(new_n153_));
  nand4  g102(.a(new_n153_), .b(new_n152_), .c(new_n116_), .d(new_n93_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(x16), .O(new_n156_));
  inv1   g105(.a(x04), .O(new_n157_));
  aoi21  g106(.a(new_n67_), .b(new_n157_), .c(x18), .O(new_n158_));
  aoi21  g107(.a(new_n158_), .b(new_n156_), .c(new_n57_), .O(z11));
  nand4  g108(.a(new_n153_), .b(new_n152_), .c(new_n143_), .d(new_n96_), .O(new_n160_));
  ...
  nand4  g115(.a(new_n166_), .b(new_n124_), .c(new_n163_), .d(new_n64_), .O(new_n167_));
  nand2  g116(.a(new_n167_), .b(new_n161_), .O(new_n168_));
  nand2  g117(.a(new_n168_), .b(x16), .O(new_n169_));
  inv1   g118(.a(x03), .O(new_n170_));
  aoi21  g119(.a(new_n67_), .b(new_n170_), .c(x18), .O(new_n171_));
  aoi21  g120(.a(new_n171_), .b(new_n169_), .c(new_n57_), .O(z12));
  inv1   g121(.a(x25), .O(new_n173_));
  nor2   g122(.a(x27), .b(x26), .O(new_n174_));
  nand4  g123(.a(new_n164_), .b(new_n144_), .c(new_n174_), .d(new_n173_), .O(new_n175_));
  oai21  g124(.a(new_n175_), .b(new_n100_), .c(x32), .O(new_n176_));
  nand2  g125(.a(new_n152_), .b(new_n143_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  nor2   g127(.a(x32), .b(x31), .O(new_n179_));
  nand2  g128(.a(new_n179_), .b(new_n153_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n178_), .c(new_n163_), .d(new_n64_), .O(new_n182_));
  nand2  g131(.a(new_n182_), .b(new_n176_), .O(new_n183_));
  nand2  g132(.a(new_n183_), .b(x16), .O(new_n184_));
  inv1   g133(.a(x02), .O(new_n185_));
  aoi21  g134(.a(new_n67_), .b(new_n185_), .c(x18), .O(new_n186_));
  aoi21  g135(.a(new_n186_), .b(new_n184_), .c(new_n57_), .O(z13));
  nand4  g136(.a(new_n179_), .b(new_n153_), .c(new_n152_), .d(new_n143_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n100_), .c(x33), .O(new_n189_));
  nor2   g138(.a(x33), .b(x32), .O(new_n190_));
  nand4  g139(.a(new_n190_), .b(new_n164_), .c(new_n144_), .d(new_n174_), .O(new_n191_));
  oai21  g140(.a(new_n191_), .b(new_n111_), .c(new_n189_), .O(new_n192_));
  nand2  g141(.a(new_n192_), .b(x16), .O(new_n193_));
  nor2   g142(.a(x16), .b(x01), .O(new_n194_));
  nor2   g143(.a(new_n194_), .b(new_n57_), .O(new_n195_));
  nand3  g144(.a(new_n195_), .b(new_n193_), .c(new_n86_), .O(z14));
  oai21  g145(.a(new_n191_), .b(new_n111_), .c(x34), .O(new_n197_));
  nand4  g146(.a(new_n173_), .b(new_n96_), .c(new_n90_), .d(new_n77_), .O(new_n198_));
  nor2   g147(.a(new_n198_), .b(new_n71_), .O(new_n199_));
  nand2  g148(.a(new_n144_), .b(new_n174_), .O(new_n200_));
  ...
  nand3  g158(.a(new_n209_), .b(new_n201_), .c(new_n199_), .O(new_n210_));
