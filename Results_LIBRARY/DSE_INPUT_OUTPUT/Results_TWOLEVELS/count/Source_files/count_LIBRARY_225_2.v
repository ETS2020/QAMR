...
module FAU ( 
  ...
  oai21  g046(.a(x19), .b(new_n97_), .c(x00), .O(new_n98_));
  nand4  g047(.a(new_n98_), .b(new_n96_), .c(x23), .d(x16), .O(new_n99_));
  nand3  g048(.a(new_n77_), .b(new_n97_), .c(new_n57_), .O(new_n100_));
  nand3  g049(.a(new_n100_), .b(new_n99_), .c(new_n95_), .O(z04));
  inv1   g050(.a(x24), .O(new_n102_));
  nand2  g051(.a(new_n92_), .b(new_n71_), .O(new_n103_));
  nand2  g052(.a(new_n103_), .b(new_n53_), .O(new_n104_));
  aoi21  g053(.a(new_n104_), .b(new_n66_), .c(new_n102_), .O(new_n105_));
  ...
  aoi21  g060(.a(new_n111_), .b(new_n109_), .c(new_n58_), .O(z05));
  ...
  nand4  g066(.a(new_n117_), .b(new_n92_), .c(new_n72_), .d(new_n55_), .O(new_n118_));
  ...
  nand3  g074(.a(new_n117_), .b(new_n81_), .c(new_n125_), .O(new_n126_));
  ...
  nand4  g086(.a(new_n137_), .b(new_n92_), .c(new_n102_), .d(new_n71_), .O(new_n138_));
  ...
  aoi21  g095(.a(new_n77_), .b(new_n146_), .c(x18), .O(new_n147_));
  ...
  aoi21  g107(.a(new_n77_), .b(new_n158_), .c(x18), .O(new_n159_));
  aoi21  g108(.a(new_n159_), .b(new_n157_), .c(new_n58_), .O(z09));
  inv1   g109(.a(x29), .O(new_n161_));
  nand4  g110(.a(new_n154_), .b(new_n137_), .c(new_n106_), .d(new_n81_), .O(new_n162_));
  aoi21  g111(.a(new_n162_), .b(new_n53_), .c(new_n90_), .O(new_n163_));
  nor2   g112(.a(x29), .b(x28), .O(new_n164_));
  nand3  g113(.a(new_n164_), .b(new_n129_), .c(new_n136_), .O(new_n165_));
  oai22  g114(.a(new_n165_), .b(new_n93_), .c(new_n163_), .d(new_n161_), .O(new_n166_));
  ...
  nand3  g151(.a(new_n202_), .b(new_n200_), .c(new_n60_), .O(z13));
  ...
  aoi21  g163(.a(new_n214_), .b(new_n212_), .c(new_n58_), .O(z14));
  oai21  g164(.a(x18), .b(new_n77_), .c(new_n57_), .O(new_n216_));
  ...
  aoi21  g172(.a(x18), .b(x11), .c(new_n58_), .O(new_n224_));
  nand3  g173(.a(new_n224_), .b(new_n223_), .c(new_n216_), .O(z15));
endmodule
