...
module FAU ( 
  ...
  nor2   g005(.a(x10), .b(x04), .O(new_n57_));
  ...
  aoi21  g043(.a(new_n67_), .b(new_n94_), .c(x18), .O(new_n95_));
  aoi21  g044(.a(new_n95_), .b(new_n93_), .c(new_n57_), .O(z04));
  inv1   g045(.a(x23), .O(new_n97_));
  nand3  g046(.a(new_n97_), .b(new_n79_), .c(new_n72_), .O(new_n98_));
  oai21  g047(.a(new_n98_), .b(new_n63_), .c(x24), .O(new_n99_));
  nor2   g048(.a(x24), .b(x23), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n81_), .c(new_n89_), .d(new_n52_), .O(new_n101_));
  aoi21  g050(.a(new_n101_), .b(new_n99_), .c(new_n67_), .O(new_n102_));
  oai21  g051(.a(new_n102_), .b(x18), .c(new_n70_), .O(new_n103_));
  inv1   g052(.a(x10), .O(new_n104_));
  nand3  g053(.a(new_n67_), .b(new_n104_), .c(x04), .O(new_n105_));
  ...
  aoi21  g092(.a(new_n67_), .b(new_n143_), .c(x18), .O(new_n144_));
  aoi21  g093(.a(new_n144_), .b(new_n142_), .c(new_n57_), .O(z09));
  nand2  g094(.a(new_n140_), .b(x29), .O(new_n146_));
  inv1   g095(.a(x27), .O(new_n147_));
  nor2   g096(.a(new_n98_), .b(new_n63_), .O(new_n148_));
  ...
  nand3  g104(.a(new_n155_), .b(new_n153_), .c(new_n71_), .O(z10));
  inv1   g105(.a(x04), .O(new_n157_));
  oai21  g106(.a(new_n67_), .b(new_n104_), .c(new_n157_), .O(new_n158_));
  nand4  g107(.a(new_n150_), .b(new_n118_), .c(new_n147_), .d(new_n117_), .O(new_n159_));
  oai21  g108(.a(new_n159_), .b(new_n91_), .c(x30), .O(new_n160_));
  nor2   g109(.a(x28), .b(x27), .O(new_n161_));
  nor2   g110(.a(x30), .b(x29), .O(new_n162_));
  nand4  g111(.a(new_n162_), .b(new_n161_), .c(new_n149_), .d(new_n148_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand2  g113(.a(new_n164_), .b(x16), .O(new_n165_));
  nand3  g114(.a(new_n165_), .b(new_n158_), .c(new_n71_), .O(z11));
  nand4  g115(.a(new_n162_), .b(new_n161_), .c(new_n118_), .d(new_n117_), .O(new_n167_));
  oai21  g116(.a(new_n167_), .b(new_n91_), .c(x31), .O(new_n168_));
  nand2  g117(.a(new_n100_), .b(new_n81_), .O(new_n169_));
  inv1   g118(.a(new_n169_), .O(new_n170_));
  nor2   g119(.a(x31), .b(x30), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n150_), .O(new_n172_));
  inv1   g121(.a(new_n172_), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n127_), .c(new_n170_), .d(new_n64_), .O(new_n174_));
  nand2  g123(.a(new_n174_), .b(new_n168_), .O(new_n175_));
  nand2  g124(.a(new_n175_), .b(x16), .O(new_n176_));
  nor2   g125(.a(x16), .b(x03), .O(new_n177_));
  nor2   g126(.a(new_n177_), .b(new_n57_), .O(new_n178_));
  nand3  g127(.a(new_n178_), .b(new_n176_), .c(new_n71_), .O(z12));
  nand4  g128(.a(new_n171_), .b(new_n150_), .c(new_n135_), .d(new_n134_), .O(new_n180_));
  oai21  g129(.a(new_n180_), .b(new_n101_), .c(x32), .O(new_n181_));
  nand2  g130(.a(new_n161_), .b(new_n118_), .O(new_n182_));
  inv1   g131(.a(new_n182_), .O(new_n183_));
  nor2   g132(.a(x32), .b(x31), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(new_n162_), .O(new_n185_));
  inv1   g134(.a(new_n185_), .O(new_n186_));
  nand4  g135(.a(new_n186_), .b(new_n183_), .c(new_n170_), .d(new_n64_), .O(new_n187_));
  ...
  nand4  g141(.a(new_n184_), .b(new_n162_), .c(new_n161_), .d(new_n118_), .O(new_n193_));
  oai21  g142(.a(new_n193_), .b(new_n101_), .c(x33), .O(new_n194_));
  nand4  g143(.a(new_n134_), .b(new_n117_), .c(new_n97_), .d(new_n79_), .O(new_n195_));
  nor2   g144(.a(new_n195_), .b(new_n73_), .O(new_n196_));
  nor2   g145(.a(x33), .b(x32), .O(new_n197_));
  nand4  g146(.a(new_n197_), .b(new_n171_), .c(new_n150_), .d(new_n135_), .O(new_n198_));
  ...
  nor2   g152(.a(new_n203_), .b(new_n57_), .O(new_n204_));
  nand3  g153(.a(new_n204_), .b(new_n202_), .c(new_n71_), .O(z14));
  oai21  g154(.a(new_n198_), .b(new_n110_), .c(x34), .O(new_n206_));
  nand2  g155(.a(new_n150_), .b(new_n135_), .O(new_n207_));
  ...
  nand3  g170(.a(new_n221_), .b(new_n219_), .c(new_n71_), .O(z15));
endmodule
