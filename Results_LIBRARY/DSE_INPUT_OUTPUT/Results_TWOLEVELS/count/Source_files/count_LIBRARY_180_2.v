...
module FAU ( 
  ...
  oai21  g079(.a(x18), .b(new_n53_), .c(new_n60_), .O(new_n131_));
  ...
  aoi21  g090(.a(x18), .b(x15), .c(new_n68_), .O(new_n142_));
  nand3  g091(.a(new_n142_), .b(new_n141_), .c(new_n131_), .O(z08));
  inv1   g092(.a(x28), .O(new_n144_));
  nand2  g093(.a(new_n138_), .b(new_n113_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n133_), .c(new_n102_), .d(new_n81_), .O(new_n157_));
  aoi21  g106(.a(new_n157_), .b(new_n56_), .c(new_n65_), .O(new_n158_));
  nor2   g107(.a(x29), .b(x28), .O(new_n159_));
  nand4  g108(.a(new_n159_), .b(new_n124_), .c(new_n94_), .d(new_n132_), .O(new_n160_));
  ...
  nor3   g120(.a(new_n171_), .b(new_n93_), .c(new_n65_), .O(new_n172_));
  ...
  nand4  g130(.a(new_n181_), .b(new_n159_), .c(new_n138_), .d(new_n109_), .O(new_n182_));
  ...
  nand4  g141(.a(new_n192_), .b(new_n170_), .c(new_n149_), .d(new_n133_), .O(new_n193_));
  ...
  oai21  g149(.a(new_n200_), .b(new_n134_), .c(new_n56_), .O(new_n201_));
  ...
  oai21  g161(.a(new_n212_), .b(new_n134_), .c(new_n56_), .O(new_n213_));
