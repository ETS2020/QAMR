...
module FAU ( 
  ...
  nand2  g016(.a(x18), .b(x01), .O(new_n68_));
  ...
  aoi21  g036(.a(new_n87_), .b(new_n84_), .c(new_n58_), .O(new_n88_));
  nor2   g037(.a(x16), .b(x11), .O(new_n89_));
  oai21  g038(.a(new_n89_), .b(new_n88_), .c(new_n61_), .O(new_n90_));
  nand2  g039(.a(new_n90_), .b(new_n68_), .O(z04));
  nand2  g040(.a(new_n87_), .b(x24), .O(new_n92_));
  nor2   g041(.a(x24), .b(x23), .O(new_n93_));
  nand4  g042(.a(new_n93_), .b(new_n82_), .c(new_n85_), .d(new_n52_), .O(new_n94_));
  ...
  nand2  g046(.a(new_n97_), .b(new_n68_), .O(z05));
  nor2   g047(.a(x21), .b(x20), .O(new_n99_));
  nor2   g048(.a(x25), .b(x24), .O(new_n100_));
  nand4  g049(.a(new_n100_), .b(new_n86_), .c(new_n99_), .d(new_n55_), .O(new_n101_));
  ...
  nand3  g057(.a(new_n108_), .b(new_n86_), .c(new_n72_), .O(new_n109_));
  ...
  nand2  g071(.a(new_n122_), .b(new_n68_), .O(z08));
  inv1   g072(.a(x25), .O(new_n124_));
  nor2   g073(.a(x27), .b(x26), .O(new_n125_));
  nand3  g074(.a(new_n125_), .b(new_n93_), .c(new_n124_), .O(new_n126_));
  oai21  g075(.a(new_n126_), .b(new_n83_), .c(x28), .O(new_n127_));
  ...
  aoi21  g079(.a(new_n130_), .b(new_n127_), .c(new_n58_), .O(new_n131_));
  nor2   g080(.a(x16), .b(x06), .O(new_n132_));
  oai21  g081(.a(new_n132_), .b(new_n131_), .c(new_n61_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(new_n68_), .O(z09));
  inv1   g083(.a(x27), .O(new_n135_));
  nor2   g084(.a(x29), .b(x28), .O(new_n136_));
  nand4  g085(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n114_), .O(new_n137_));
  ...
  oai21  g091(.a(new_n137_), .b(new_n87_), .c(x30), .O(new_n143_));
  inv1   g092(.a(x22), .O(new_n144_));
  inv1   g093(.a(x23), .O(new_n145_));
  nand3  g094(.a(new_n145_), .b(new_n144_), .c(new_n70_), .O(new_n146_));
  ...
  nand3  g100(.a(new_n151_), .b(new_n108_), .c(new_n147_), .O(new_n152_));
  aoi21  g101(.a(new_n152_), .b(new_n143_), .c(new_n58_), .O(new_n153_));
  nor2   g102(.a(x16), .b(x04), .O(new_n154_));
  oai21  g103(.a(new_n154_), .b(new_n153_), .c(new_n61_), .O(new_n155_));
  nand2  g104(.a(new_n155_), .b(new_n68_), .O(z11));
  nand4  g105(.a(new_n149_), .b(new_n148_), .c(new_n115_), .d(new_n114_), .O(new_n157_));
  oai21  g106(.a(new_n157_), .b(new_n87_), .c(x31), .O(new_n158_));
  inv1   g107(.a(new_n64_), .O(new_n159_));
  nand4  g108(.a(new_n114_), .b(new_n145_), .c(new_n144_), .d(new_n70_), .O(new_n160_));
  ...
  nand4  g116(.a(new_n167_), .b(new_n118_), .c(new_n161_), .d(new_n159_), .O(new_n168_));
  aoi21  g117(.a(new_n168_), .b(new_n158_), .c(new_n58_), .O(new_n169_));
  nor2   g118(.a(x16), .b(x03), .O(new_n170_));
  oai21  g119(.a(new_n170_), .b(new_n169_), .c(new_n61_), .O(new_n171_));
  nand2  g120(.a(new_n171_), .b(new_n68_), .O(z12));
  nor2   g121(.a(x31), .b(x30), .O(new_n173_));
  nand4  g122(.a(new_n173_), .b(new_n136_), .c(new_n125_), .d(new_n124_), .O(new_n174_));
  oai21  g123(.a(new_n174_), .b(new_n94_), .c(x32), .O(new_n175_));
  inv1   g124(.a(x26), .O(new_n176_));
  nand4  g125(.a(new_n162_), .b(new_n135_), .c(new_n176_), .d(new_n124_), .O(new_n177_));
  inv1   g126(.a(new_n177_), .O(new_n178_));
  inv1   g127(.a(x32), .O(new_n179_));
  nand4  g128(.a(new_n179_), .b(new_n165_), .c(new_n164_), .d(new_n163_), .O(new_n180_));
  inv1   g129(.a(new_n180_), .O(new_n181_));
  nand4  g130(.a(new_n181_), .b(new_n178_), .c(new_n161_), .d(new_n159_), .O(new_n182_));
  aoi21  g131(.a(new_n182_), .b(new_n175_), .c(new_n58_), .O(new_n183_));
  nor2   g132(.a(x16), .b(x02), .O(new_n184_));
  oai21  g133(.a(new_n184_), .b(new_n183_), .c(new_n61_), .O(new_n185_));
  nand2  g134(.a(new_n185_), .b(new_n68_), .O(z13));
  nor2   g135(.a(x32), .b(x31), .O(new_n187_));
  nand4  g136(.a(new_n187_), .b(new_n149_), .c(new_n148_), .d(new_n115_), .O(new_n188_));
  oai21  g137(.a(new_n188_), .b(new_n94_), .c(x33), .O(new_n189_));
  nand4  g138(.a(new_n124_), .b(new_n114_), .c(new_n145_), .d(new_n144_), .O(new_n190_));
  inv1   g139(.a(new_n190_), .O(new_n191_));
  nand4  g140(.a(new_n163_), .b(new_n162_), .c(new_n135_), .d(new_n176_), .O(new_n192_));
  inv1   g141(.a(new_n192_), .O(new_n193_));
  inv1   g142(.a(x33), .O(new_n194_));
  nand4  g143(.a(new_n194_), .b(new_n179_), .c(new_n165_), .d(new_n164_), .O(new_n195_));
  inv1   g144(.a(new_n195_), .O(new_n196_));
  nand4  g145(.a(new_n196_), .b(new_n193_), .c(new_n191_), .d(new_n72_), .O(new_n197_));
  aoi21  g146(.a(new_n197_), .b(new_n189_), .c(new_n58_), .O(new_n198_));
  nor2   g147(.a(x16), .b(x01), .O(new_n199_));
  oai21  g148(.a(new_n199_), .b(new_n198_), .c(new_n61_), .O(new_n200_));
  nand2  g149(.a(new_n200_), .b(new_n68_), .O(z14));
  aoi21  g150(.a(x33), .b(new_n61_), .c(x32), .O(new_n202_));
  nand4  g151(.a(new_n202_), .b(new_n193_), .c(new_n173_), .d(new_n102_), .O(new_n203_));
  nor2   g152(.a(x34), .b(x33), .O(new_n204_));
  nand3  g153(.a(new_n204_), .b(new_n173_), .c(new_n179_), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(new_n192_), .c(new_n101_), .O(new_n206_));
  ...
  oai21  g158(.a(new_n207_), .b(new_n58_), .c(new_n209_), .O(z15));
endmodule
