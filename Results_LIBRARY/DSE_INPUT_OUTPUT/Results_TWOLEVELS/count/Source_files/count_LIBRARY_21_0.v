...
module FAU ( 
  ...
  oai21  g025(.a(x13), .b(x11), .c(x18), .O(new_n77_));
  ...
  or2    g030(.a(new_n81_), .b(new_n59_), .O(new_n82_));
  nor2   g031(.a(x16), .b(x12), .O(new_n83_));
  nor2   g032(.a(new_n83_), .b(new_n52_), .O(new_n84_));
  nand3  g033(.a(new_n84_), .b(new_n82_), .c(new_n77_), .O(z03));
  ...
  oai21  g039(.a(new_n80_), .b(new_n88_), .c(new_n90_), .O(new_n91_));
  nand2  g040(.a(new_n91_), .b(x16), .O(new_n92_));
  nand3  g041(.a(new_n92_), .b(new_n87_), .c(new_n77_), .O(z04));
  inv1   g042(.a(x24), .O(new_n94_));
  nand2  g043(.a(new_n89_), .b(new_n69_), .O(new_n95_));
  nand2  g044(.a(new_n95_), .b(new_n54_), .O(new_n96_));
  aoi21  g045(.a(new_n96_), .b(new_n64_), .c(new_n94_), .O(new_n97_));
  nor2   g046(.a(x24), .b(x23), .O(new_n98_));
  nand3  g047(.a(new_n98_), .b(new_n78_), .c(new_n64_), .O(new_n99_));
  ...
  nand4  g055(.a(new_n106_), .b(new_n89_), .c(new_n70_), .d(new_n56_), .O(new_n107_));
  ...
  nand3  g071(.a(new_n122_), .b(new_n98_), .c(new_n80_), .O(new_n123_));
  ...
  nand3  g076(.a(new_n127_), .b(new_n125_), .c(new_n77_), .O(z08));
  inv1   g077(.a(x28), .O(new_n129_));
  nor2   g078(.a(x27), .b(x26), .O(new_n130_));
  nand2  g079(.a(new_n130_), .b(new_n106_), .O(new_n131_));
  oai21  g080(.a(new_n131_), .b(new_n95_), .c(new_n54_), .O(new_n132_));
  aoi21  g081(.a(new_n132_), .b(new_n64_), .c(new_n129_), .O(new_n133_));
  inv1   g082(.a(x26), .O(new_n134_));
  nor2   g083(.a(x28), .b(x27), .O(new_n135_));
  nand4  g084(.a(new_n135_), .b(new_n106_), .c(new_n134_), .d(new_n88_), .O(new_n136_));
  nor2   g085(.a(new_n136_), .b(new_n79_), .O(new_n137_));
  ...
  aoi21  g089(.a(new_n140_), .b(new_n138_), .c(new_n52_), .O(z09));
  inv1   g090(.a(x29), .O(new_n142_));
  nor3   g091(.a(x23), .b(x22), .c(x21), .O(new_n143_));
  nor3   g092(.a(x29), .b(x28), .c(x27), .O(new_n144_));
  nand4  g093(.a(new_n144_), .b(new_n114_), .c(new_n143_), .d(new_n64_), .O(new_n145_));
  oai21  g094(.a(new_n137_), .b(new_n142_), .c(new_n145_), .O(new_n146_));
  nand2  g095(.a(new_n146_), .b(x16), .O(new_n147_));
  nor2   g096(.a(x16), .b(x05), .O(new_n148_));
  nor2   g097(.a(new_n148_), .b(new_n52_), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n147_), .c(new_n77_), .O(z10));
  nand2  g099(.a(new_n145_), .b(x30), .O(new_n151_));
  nor2   g100(.a(x30), .b(x29), .O(new_n152_));
  nand3  g101(.a(new_n152_), .b(new_n135_), .c(new_n114_), .O(new_n153_));
  oai21  g102(.a(new_n153_), .b(new_n90_), .c(new_n151_), .O(new_n154_));
  nand2  g103(.a(new_n154_), .b(x16), .O(new_n155_));
  nor2   g104(.a(x16), .b(x04), .O(new_n156_));
  nor2   g105(.a(new_n156_), .b(new_n52_), .O(new_n157_));
  nand3  g106(.a(new_n157_), .b(new_n155_), .c(new_n77_), .O(z11));
  oai21  g107(.a(new_n153_), .b(new_n90_), .c(x31), .O(new_n159_));
  nor2   g108(.a(x29), .b(x28), .O(new_n160_));
  nor2   g109(.a(x31), .b(x30), .O(new_n161_));
  nand3  g110(.a(new_n161_), .b(new_n160_), .c(new_n122_), .O(new_n162_));
  oai21  g111(.a(new_n162_), .b(new_n99_), .c(new_n159_), .O(new_n163_));
  nand2  g112(.a(new_n163_), .b(x16), .O(new_n164_));
  nor2   g113(.a(x16), .b(x03), .O(new_n165_));
  nor2   g114(.a(new_n165_), .b(new_n52_), .O(new_n166_));
  nand3  g115(.a(new_n166_), .b(new_n164_), .c(new_n77_), .O(z12));
  inv1   g116(.a(x32), .O(new_n168_));
  nand3  g117(.a(new_n106_), .b(new_n78_), .c(new_n88_), .O(new_n169_));
  nand4  g118(.a(new_n161_), .b(new_n135_), .c(new_n142_), .d(new_n134_), .O(new_n170_));
  ...
  nand4  g123(.a(new_n174_), .b(new_n152_), .c(new_n135_), .d(new_n173_), .O(new_n175_));
  ...
  aoi21  g128(.a(new_n179_), .b(new_n177_), .c(new_n52_), .O(z13));
  inv1   g129(.a(x33), .O(new_n181_));
  nor2   g130(.a(x33), .b(x32), .O(new_n182_));
  nand4  g131(.a(new_n182_), .b(new_n161_), .c(new_n160_), .d(new_n130_), .O(new_n183_));
  oai22  g132(.a(new_n183_), .b(new_n107_), .c(new_n176_), .d(new_n181_), .O(new_n184_));
  nand2  g133(.a(new_n184_), .b(x16), .O(new_n185_));
  nor2   g134(.a(x16), .b(x01), .O(new_n186_));
  nor2   g135(.a(new_n186_), .b(new_n52_), .O(new_n187_));
  nand3  g136(.a(new_n187_), .b(new_n185_), .c(new_n77_), .O(z14));
  inv1   g137(.a(x34), .O(new_n189_));
  nand4  g138(.a(new_n173_), .b(new_n89_), .c(new_n94_), .d(new_n69_), .O(new_n190_));
  inv1   g139(.a(x27), .O(new_n191_));
  nand4  g140(.a(new_n182_), .b(new_n161_), .c(new_n160_), .d(new_n191_), .O(new_n192_));
  oai21  g141(.a(new_n192_), .b(new_n190_), .c(new_n54_), .O(new_n193_));
  aoi21  g142(.a(new_n193_), .b(new_n64_), .c(new_n189_), .O(new_n194_));
  nand2  g143(.a(new_n160_), .b(new_n130_), .O(new_n195_));
  nand4  g144(.a(new_n161_), .b(new_n189_), .c(new_n181_), .d(new_n168_), .O(new_n196_));
  nor3   g145(.a(new_n196_), .b(new_n195_), .c(new_n107_), .O(new_n197_));
  ...
  aoi21  g149(.a(new_n200_), .b(new_n198_), .c(new_n52_), .O(z15));
endmodule
