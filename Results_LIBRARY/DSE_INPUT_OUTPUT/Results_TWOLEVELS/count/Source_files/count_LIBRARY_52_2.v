...
module FAU ( 
  ...
  nand3  g028(.a(new_n79_), .b(new_n63_), .c(new_n54_), .O(new_n80_));
  ...
  nand3  g039(.a(new_n63_), .b(new_n55_), .c(new_n54_), .O(new_n91_));
  ...
  oai21  g048(.a(new_n60_), .b(x07), .c(new_n99_), .O(new_n100_));
  oai21  g049(.a(x10), .b(new_n52_), .c(x18), .O(new_n101_));
  inv1   g050(.a(x24), .O(new_n102_));
  nor2   g051(.a(x24), .b(x23), .O(new_n103_));
  nand3  g052(.a(new_n103_), .b(new_n79_), .c(new_n65_), .O(new_n104_));
  oai21  g053(.a(new_n94_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  nand2  g054(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g055(.a(new_n106_), .b(new_n101_), .c(new_n100_), .O(z05));
  inv1   g056(.a(x25), .O(new_n108_));
  nand2  g057(.a(new_n103_), .b(new_n79_), .O(new_n109_));
  ...
  nand4  g061(.a(new_n112_), .b(new_n92_), .c(new_n71_), .d(new_n57_), .O(new_n113_));
  ...
  nor2   g074(.a(new_n125_), .b(new_n53_), .O(new_n126_));
  nand3  g075(.a(new_n126_), .b(new_n124_), .c(new_n101_), .O(z07));
  oai21  g076(.a(x18), .b(new_n60_), .c(new_n52_), .O(new_n128_));
  inv1   g077(.a(x27), .O(new_n129_));
  nand3  g078(.a(new_n79_), .b(new_n57_), .c(new_n63_), .O(new_n130_));
  nor3   g079(.a(x27), .b(x26), .c(x25), .O(new_n131_));
  nand2  g080(.a(new_n131_), .b(new_n103_), .O(new_n132_));
  oai22  g081(.a(new_n132_), .b(new_n130_), .c(new_n123_), .d(new_n129_), .O(new_n133_));
  nand2  g082(.a(new_n133_), .b(x16), .O(new_n134_));
  aoi21  g083(.a(x18), .b(x10), .c(new_n53_), .O(new_n135_));
  nand3  g084(.a(new_n135_), .b(new_n134_), .c(new_n128_), .O(z08));
  oai21  g085(.a(new_n132_), .b(new_n130_), .c(x28), .O(new_n137_));
  nor2   g086(.a(x28), .b(x27), .O(new_n138_));
  nand4  g087(.a(new_n138_), .b(new_n112_), .c(new_n119_), .d(new_n88_), .O(new_n139_));
  oai21  g088(.a(new_n139_), .b(new_n130_), .c(new_n137_), .O(new_n140_));
  nand2  g089(.a(new_n140_), .b(x16), .O(new_n141_));
  nor2   g090(.a(x16), .b(x06), .O(new_n142_));
  nor2   g091(.a(new_n142_), .b(new_n53_), .O(new_n143_));
  nand3  g092(.a(new_n143_), .b(new_n141_), .c(new_n101_), .O(z09));
  inv1   g093(.a(x29), .O(new_n145_));
  nor2   g094(.a(x26), .b(x25), .O(new_n146_));
  nand4  g095(.a(new_n138_), .b(new_n146_), .c(new_n103_), .d(new_n79_), .O(new_n147_));
  aoi21  g096(.a(new_n147_), .b(new_n55_), .c(new_n91_), .O(new_n148_));
  nor3   g097(.a(x29), .b(x28), .c(x27), .O(new_n149_));
  nand3  g098(.a(new_n149_), .b(new_n121_), .c(new_n94_), .O(new_n150_));
  ...
  aoi21  g103(.a(new_n154_), .b(new_n152_), .c(new_n53_), .O(z10));
  nand2  g104(.a(new_n150_), .b(x30), .O(new_n156_));
  nand3  g105(.a(new_n92_), .b(new_n65_), .c(new_n70_), .O(new_n157_));
  nor2   g106(.a(x30), .b(x29), .O(new_n158_));
  nand3  g107(.a(new_n158_), .b(new_n138_), .c(new_n121_), .O(new_n159_));
  or2    g108(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  ...
  nand3  g113(.a(new_n164_), .b(new_n162_), .c(new_n101_), .O(z11));
  oai21  g114(.a(new_n159_), .b(new_n157_), .c(x31), .O(new_n166_));
  nor2   g115(.a(x29), .b(x28), .O(new_n167_));
  nor2   g116(.a(x31), .b(x30), .O(new_n168_));
  nand3  g117(.a(new_n168_), .b(new_n167_), .c(new_n131_), .O(new_n169_));
  oai21  g118(.a(new_n169_), .b(new_n104_), .c(new_n166_), .O(new_n170_));
  nand2  g119(.a(new_n170_), .b(x16), .O(new_n171_));
  nor2   g120(.a(x16), .b(x03), .O(new_n172_));
  nor2   g121(.a(new_n172_), .b(new_n53_), .O(new_n173_));
  nand3  g122(.a(new_n173_), .b(new_n171_), .c(new_n101_), .O(z12));
  inv1   g123(.a(x32), .O(new_n175_));
  nand3  g124(.a(new_n112_), .b(new_n79_), .c(new_n88_), .O(new_n176_));
  nand4  g125(.a(new_n168_), .b(new_n138_), .c(new_n145_), .d(new_n119_), .O(new_n177_));
  oai21  g126(.a(new_n177_), .b(new_n176_), .c(new_n55_), .O(new_n178_));
  aoi21  g127(.a(new_n178_), .b(new_n65_), .c(new_n175_), .O(new_n179_));
  nor2   g128(.a(x32), .b(x31), .O(new_n180_));
  nand4  g129(.a(new_n180_), .b(new_n158_), .c(new_n138_), .d(new_n146_), .O(new_n181_));
  ...
  nand4  g136(.a(new_n146_), .b(new_n92_), .c(new_n102_), .d(new_n70_), .O(new_n188_));
  inv1   g137(.a(x30), .O(new_n189_));
  nand4  g138(.a(new_n180_), .b(new_n167_), .c(new_n189_), .d(new_n129_), .O(new_n190_));
  oai21  g139(.a(new_n190_), .b(new_n188_), .c(new_n55_), .O(new_n191_));
  aoi21  g140(.a(new_n191_), .b(new_n65_), .c(new_n187_), .O(new_n192_));
  nand3  g141(.a(new_n167_), .b(new_n129_), .c(new_n119_), .O(new_n193_));
  nor2   g142(.a(x33), .b(x32), .O(new_n194_));
  nand2  g143(.a(new_n194_), .b(new_n168_), .O(new_n195_));
  nor3   g144(.a(new_n195_), .b(new_n193_), .c(new_n113_), .O(new_n196_));
  oai21  g145(.a(new_n196_), .b(new_n192_), .c(x16), .O(new_n197_));
  inv1   g146(.a(x01), .O(new_n198_));
  aoi21  g147(.a(new_n60_), .b(new_n198_), .c(x18), .O(new_n199_));
  aoi21  g148(.a(new_n199_), .b(new_n197_), .c(new_n53_), .O(z14));
  inv1   g149(.a(x34), .O(new_n201_));
  nand4  g150(.a(new_n194_), .b(new_n168_), .c(new_n167_), .d(new_n129_), .O(new_n202_));
  oai21  g151(.a(new_n202_), .b(new_n188_), .c(new_n55_), .O(new_n203_));
  aoi21  g152(.a(new_n203_), .b(new_n65_), .c(new_n201_), .O(new_n204_));
  nand4  g153(.a(new_n168_), .b(new_n201_), .c(new_n187_), .d(new_n175_), .O(new_n205_));
  nor3   g154(.a(new_n205_), .b(new_n193_), .c(new_n113_), .O(new_n206_));
  ...
  aoi21  g158(.a(new_n209_), .b(new_n207_), .c(new_n53_), .O(z15));
endmodule
