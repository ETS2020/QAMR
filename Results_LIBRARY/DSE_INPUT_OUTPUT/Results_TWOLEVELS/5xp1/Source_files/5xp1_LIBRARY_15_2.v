...
module FAU ( 
  ...
  nand2  g41(.a(x6), .b(x3), .O(new_n59_));
  oai22  g42(.a(new_n59_), .b(new_n48_), .c(new_n58_), .d(new_n21_), .O(new_n60_));
  ...
  nand3  g54(.a(x6), .b(new_n21_), .c(new_n18_), .O(new_n72_));
  oai21  g55(.a(x6), .b(new_n21_), .c(new_n72_), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand3  g57(.a(new_n22_), .b(x3), .c(x2), .O(new_n75_));
  oai21  g58(.a(new_n22_), .b(x2), .c(new_n75_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(new_n21_), .O(new_n77_));
  aoi21  g60(.a(new_n59_), .b(new_n18_), .c(new_n48_), .O(new_n78_));
  nor2   g61(.a(x6), .b(x2), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n78_), .c(x1), .O(new_n80_));
  nor2   g63(.a(new_n71_), .b(x2), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n22_), .c(x0), .O(new_n82_));
  nand4  g65(.a(new_n82_), .b(new_n80_), .c(new_n77_), .d(new_n74_), .O(z4));
  nand2  g66(.a(new_n81_), .b(x1), .O(new_n84_));
  oai21  g67(.a(x3), .b(new_n48_), .c(new_n84_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n18_), .O(new_n86_));
  aoi21  g69(.a(new_n48_), .b(x1), .c(new_n71_), .O(new_n87_));
  oai21  g70(.a(x3), .b(x2), .c(x6), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n87_), .c(x0), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n86_), .O(z5));
  nand3  g73(.a(x6), .b(x5), .c(new_n27_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n18_), .c(x6), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n48_), .c(x3), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(x1), .O(new_n94_));
  nand2  g77(.a(new_n81_), .b(new_n21_), .O(new_n95_));
  inv1   g78(.a(new_n95_), .O(new_n96_));
  aoi21  g79(.a(new_n22_), .b(x0), .c(new_n96_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n94_), .O(z6));
  nor2   g81(.a(new_n22_), .b(x3), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(x2), .c(new_n96_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n86_), .c(new_n82_), .O(z7));
  oai21  g84(.a(x2), .b(x0), .c(x6), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(x0), .c(x3), .O(z8));
  nand2  g86(.a(x1), .b(new_n18_), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(new_n23_), .c(new_n22_), .O(new_n105_));
