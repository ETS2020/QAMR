...
module FAU ( 
  ...
  nand4  g22(.a(new_n29_), .b(x6), .c(new_n18_), .d(new_n36_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(x6), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(x5), .c(new_n22_), .O(new_n42_));
  ...
  nand3  g44(.a(new_n61_), .b(new_n23_), .c(x0), .O(new_n62_));
  inv1   g45(.a(new_n62_), .O(new_n63_));
  nand2  g46(.a(new_n35_), .b(new_n22_), .O(new_n64_));
  inv1   g47(.a(x3), .O(new_n65_));
  nand3  g48(.a(x6), .b(new_n65_), .c(x2), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n64_), .c(new_n23_), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n63_), .c(new_n36_), .O(new_n68_));
  aoi21  g51(.a(new_n61_), .b(new_n36_), .c(new_n22_), .O(new_n69_));
  nor2   g52(.a(x6), .b(x0), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(new_n69_), .c(x5), .O(new_n71_));
  nor2   g54(.a(new_n24_), .b(new_n65_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(x2), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n36_), .O(new_n74_));
  nand3  g57(.a(new_n74_), .b(new_n23_), .c(new_n22_), .O(new_n75_));
  nand2  g58(.a(new_n24_), .b(x1), .O(new_n76_));
  nand4  g59(.a(new_n76_), .b(new_n75_), .c(new_n71_), .d(new_n68_), .O(z3));
  nand2  g60(.a(x2), .b(x1), .O(new_n78_));
  nand2  g61(.a(x3), .b(new_n35_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n78_), .c(new_n22_), .O(new_n80_));
  oai21  g63(.a(x3), .b(x0), .c(x2), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n36_), .O(new_n82_));
  oai21  g65(.a(new_n29_), .b(new_n36_), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n80_), .c(x6), .O(new_n84_));
  nand2  g67(.a(new_n65_), .b(new_n22_), .O(new_n85_));
  nand4  g68(.a(new_n85_), .b(new_n24_), .c(x2), .d(new_n36_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n84_), .O(z4));
  nand3  g70(.a(new_n76_), .b(new_n65_), .c(x2), .O(new_n88_));
  nand3  g71(.a(new_n72_), .b(new_n35_), .c(x1), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n22_), .O(new_n91_));
  aoi21  g74(.a(new_n65_), .b(x2), .c(x1), .O(new_n92_));
  nand2  g75(.a(new_n65_), .b(new_n35_), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n29_), .c(new_n24_), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n92_), .c(x0), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n91_), .O(z5));
  nand2  g79(.a(new_n35_), .b(new_n36_), .O(new_n97_));
  oai21  g80(.a(new_n61_), .b(new_n36_), .c(new_n97_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(x3), .O(new_n99_));
  oai21  g82(.a(new_n72_), .b(new_n36_), .c(new_n99_), .O(z6));
  nand2  g83(.a(new_n72_), .b(new_n35_), .O(new_n101_));
  nand4  g84(.a(new_n24_), .b(new_n65_), .c(x2), .d(new_n36_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(x0), .O(new_n104_));
  nand3  g87(.a(new_n65_), .b(x2), .c(new_n36_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n89_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n22_), .O(new_n107_));
  nand3  g90(.a(x3), .b(new_n35_), .c(new_n36_), .O(new_n108_));
  nand4  g91(.a(new_n108_), .b(new_n107_), .c(new_n104_), .d(new_n66_), .O(z7));
  nand2  g92(.a(new_n76_), .b(x3), .O(z8));
  oai21  g93(.a(x1), .b(new_n22_), .c(new_n24_), .O(new_n111_));
