...
module FAU ( 
  ...
  nor2   g58(.a(new_n75_), .b(x2), .O(new_n76_));
  aoi22  g59(.a(new_n76_), .b(x0), .c(new_n74_), .d(new_n38_), .O(new_n77_));
  inv1   g60(.a(new_n61_), .O(new_n78_));
  aoi22  g61(.a(x6), .b(new_n38_), .c(new_n75_), .d(new_n22_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(x2), .c(new_n78_), .O(new_n80_));
  oai21  g63(.a(new_n77_), .b(new_n34_), .c(new_n80_), .O(z4));
  nor3   g64(.a(new_n78_), .b(x3), .c(new_n46_), .O(new_n82_));
  nand4  g65(.a(x6), .b(x3), .c(new_n46_), .d(x1), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n82_), .c(new_n22_), .O(new_n85_));
  aoi21  g68(.a(new_n75_), .b(x2), .c(x1), .O(new_n86_));
  nand2  g69(.a(new_n75_), .b(new_n46_), .O(new_n87_));
  aoi21  g70(.a(new_n87_), .b(new_n23_), .c(new_n34_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n86_), .c(x0), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n85_), .O(z5));
  xor2a  g73(.a(x2), .b(x1), .O(new_n91_));
  oai21  g74(.a(new_n34_), .b(new_n75_), .c(x1), .O(new_n92_));
  oai21  g75(.a(new_n91_), .b(new_n75_), .c(new_n92_), .O(z6));
  nand3  g76(.a(x6), .b(x3), .c(new_n46_), .O(new_n94_));
  nand4  g77(.a(new_n34_), .b(new_n75_), .c(x2), .d(new_n38_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x0), .O(new_n97_));
  nand3  g80(.a(new_n75_), .b(x2), .c(new_n38_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n83_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n22_), .O(new_n100_));
  nor2   g83(.a(new_n34_), .b(x3), .O(new_n101_));
  aoi22  g84(.a(new_n101_), .b(x2), .c(new_n76_), .d(new_n38_), .O(new_n102_));
  nand3  g85(.a(new_n102_), .b(new_n100_), .c(new_n97_), .O(z7));
  aoi21  g86(.a(new_n34_), .b(x1), .c(x3), .O(z8));
  oai21  g87(.a(x6), .b(x0), .c(x5), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n21_), .c(new_n61_), .O(z9));
endmodule
