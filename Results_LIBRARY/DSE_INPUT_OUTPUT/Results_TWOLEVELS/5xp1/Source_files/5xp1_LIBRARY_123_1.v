...
module FAU ( 
  ...
  nand4  g17(.a(new_n22_), .b(x4), .c(new_n27_), .d(x0), .O(new_n35_));
  ...
  aoi21  g63(.a(new_n59_), .b(new_n42_), .c(new_n20_), .O(new_n81_));
  ...
  oai21  g74(.a(new_n27_), .b(x2), .c(new_n19_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n21_), .O(new_n93_));
  nor2   g76(.a(new_n19_), .b(x4), .O(new_n94_));
  nand4  g77(.a(new_n94_), .b(new_n19_), .c(x5), .d(new_n20_), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(x2), .c(new_n27_), .O(new_n96_));
  oai21  g79(.a(new_n96_), .b(new_n21_), .c(new_n93_), .O(z6));
  nand2  g80(.a(x6), .b(new_n21_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n20_), .O(new_n99_));
  aoi21  g82(.a(x4), .b(x1), .c(x6), .O(new_n100_));
  nand2  g83(.a(new_n22_), .b(x4), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n19_), .c(new_n21_), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(new_n100_), .c(x0), .O(new_n103_));
  nand3  g86(.a(new_n19_), .b(x5), .c(x1), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n103_), .c(new_n99_), .O(new_n105_));
  nand3  g88(.a(new_n105_), .b(new_n27_), .c(x2), .O(new_n106_));
  nand2  g89(.a(x6), .b(new_n21_), .O(new_n107_));
  nand3  g90(.a(new_n107_), .b(x3), .c(new_n24_), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n106_), .O(z7));
  aoi21  g92(.a(x6), .b(new_n21_), .c(x3), .O(z8));
  oai21  g93(.a(new_n70_), .b(new_n21_), .c(new_n20_), .O(new_n111_));
  nand3  g94(.a(new_n111_), .b(x5), .c(x4), .O(new_n112_));
  nand2  g95(.a(new_n112_), .b(new_n98_), .O(z9));
endmodule
