...
module FAU ( 
  ...
  nand3  g044(.a(new_n22_), .b(new_n20_), .c(new_n45_), .O(new_n62_));
  ...
  oai21  g049(.a(new_n66_), .b(new_n64_), .c(new_n43_), .O(new_n67_));
  inv1   g050(.a(x3), .O(new_n68_));
  nand4  g051(.a(new_n21_), .b(x4), .c(new_n68_), .d(x1), .O(new_n69_));
  nand2  g052(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  ...
  nand2  g056(.a(new_n18_), .b(new_n43_), .O(new_n74_));
  ...
  nand3  g066(.a(new_n18_), .b(x2), .c(new_n43_), .O(new_n84_));
  ...
  nand3  g072(.a(new_n44_), .b(new_n21_), .c(x1), .O(new_n90_));
  oai21  g073(.a(x2), .b(x1), .c(new_n90_), .O(new_n91_));
  nand2  g074(.a(new_n91_), .b(new_n43_), .O(new_n92_));
  nor2   g075(.a(x3), .b(new_n30_), .O(new_n93_));
  nand2  g076(.a(new_n93_), .b(new_n45_), .O(new_n94_));
  nand3  g077(.a(new_n94_), .b(new_n92_), .c(new_n89_), .O(new_n95_));
  nand2  g078(.a(new_n95_), .b(x5), .O(new_n96_));
  oai21  g079(.a(x6), .b(x3), .c(x1), .O(new_n97_));
  nand3  g080(.a(new_n97_), .b(new_n30_), .c(x0), .O(new_n98_));
  oai21  g081(.a(new_n87_), .b(x0), .c(new_n98_), .O(new_n99_));
  aoi21  g082(.a(new_n99_), .b(new_n18_), .c(new_n40_), .O(new_n100_));
  nand3  g083(.a(new_n100_), .b(new_n96_), .c(new_n86_), .O(z3));
  nand2  g084(.a(new_n68_), .b(new_n30_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(x0), .O(new_n103_));
  aoi21  g086(.a(new_n103_), .b(new_n44_), .c(new_n21_), .O(new_n104_));
  oai21  g087(.a(new_n68_), .b(new_n30_), .c(new_n43_), .O(new_n105_));
  ...
  nand3  g091(.a(new_n108_), .b(x6), .c(new_n45_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(new_n107_), .O(z4));
  aoi21  g093(.a(new_n102_), .b(new_n44_), .c(new_n45_), .O(new_n111_));
  oai21  g094(.a(x3), .b(new_n30_), .c(x6), .O(new_n112_));
  nor2   g095(.a(new_n112_), .b(x1), .O(new_n113_));
  oai21  g096(.a(new_n113_), .b(new_n111_), .c(x0), .O(new_n114_));
  nand2  g097(.a(x3), .b(new_n30_), .O(new_n115_));
  nand3  g098(.a(new_n21_), .b(new_n68_), .c(x2), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n115_), .c(new_n45_), .O(new_n117_));
  nand3  g100(.a(x6), .b(new_n68_), .c(x2), .O(new_n118_));
  inv1   g101(.a(new_n118_), .O(new_n119_));
  oai21  g102(.a(new_n119_), .b(new_n117_), .c(new_n43_), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(new_n114_), .O(z5));
  nand2  g104(.a(new_n115_), .b(x1), .O(new_n122_));
  nand4  g105(.a(x6), .b(x3), .c(new_n30_), .d(new_n45_), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n122_), .O(z6));
  inv1   g107(.a(new_n93_), .O(new_n125_));
  aoi22  g108(.a(new_n115_), .b(new_n125_), .c(new_n21_), .d(new_n45_), .O(z7));
  aoi21  g109(.a(x2), .b(x0), .c(x1), .O(new_n127_));
  oai21  g110(.a(new_n127_), .b(x2), .c(x6), .O(new_n128_));
  aoi21  g111(.a(new_n128_), .b(new_n45_), .c(x3), .O(new_n129_));
  or2    g112(.a(new_n129_), .b(new_n40_), .O(z8));
