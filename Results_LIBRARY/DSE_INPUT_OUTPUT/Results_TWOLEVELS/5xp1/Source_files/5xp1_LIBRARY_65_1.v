...
module FAU ( 
  ...
  aoi21  g60(.a(new_n44_), .b(new_n30_), .c(new_n19_), .O(new_n78_));
  nand2  g61(.a(new_n44_), .b(new_n20_), .O(new_n79_));
  aoi21  g62(.a(new_n79_), .b(new_n61_), .c(x6), .O(new_n80_));
  ...
  nand2  g67(.a(x3), .b(new_n24_), .O(new_n85_));
  nand2  g68(.a(new_n27_), .b(x2), .O(new_n86_));
  oai21  g69(.a(new_n85_), .b(new_n21_), .c(new_n86_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n20_), .O(new_n88_));
  oai21  g71(.a(x2), .b(new_n20_), .c(new_n19_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n21_), .O(new_n90_));
  nand2  g73(.a(new_n44_), .b(new_n61_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(x0), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n88_), .O(z5));
  nor2   g76(.a(x6), .b(x4), .O(new_n94_));
  oai21  g77(.a(new_n94_), .b(new_n36_), .c(x0), .O(new_n95_));
  aoi21  g78(.a(x6), .b(new_n18_), .c(new_n22_), .O(new_n96_));
  oai21  g79(.a(x5), .b(x0), .c(new_n19_), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n96_), .c(x3), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n95_), .c(new_n24_), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n27_), .c(x1), .O(new_n100_));
  nand2  g83(.a(new_n85_), .b(new_n19_), .O(new_n101_));
  nand2  g84(.a(new_n101_), .b(new_n21_), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(new_n100_), .O(z6));
  inv1   g86(.a(new_n75_), .O(new_n104_));
  nand3  g87(.a(new_n86_), .b(new_n85_), .c(new_n104_), .O(z7));
  nor2   g88(.a(new_n75_), .b(x3), .O(z8));
  nand2  g89(.a(new_n63_), .b(x1), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n20_), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(x5), .c(x4), .O(new_n109_));
  nand2  g92(.a(new_n109_), .b(new_n104_), .O(z9));
endmodule
