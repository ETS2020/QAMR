...
module FAU ( 
  ...
  oai21  g19(.a(new_n36_), .b(new_n20_), .c(new_n27_), .O(new_n37_));
  ...
  oai21  g62(.a(new_n75_), .b(new_n19_), .c(new_n79_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n20_), .O(new_n81_));
  aoi21  g64(.a(new_n42_), .b(x1), .c(new_n63_), .O(new_n82_));
  nor2   g65(.a(x3), .b(x2), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n82_), .c(x0), .O(new_n84_));
  nand2  g67(.a(new_n18_), .b(x1), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n84_), .c(new_n81_), .O(z5));
  nand2  g69(.a(new_n61_), .b(x1), .O(new_n87_));
  inv1   g70(.a(new_n87_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n36_), .c(x3), .O(new_n89_));
  oai21  g72(.a(new_n18_), .b(new_n63_), .c(x1), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n89_), .O(z6));
  oai21  g74(.a(new_n75_), .b(x0), .c(x6), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(x1), .O(new_n93_));
  oai21  g76(.a(new_n18_), .b(new_n20_), .c(x1), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(x3), .c(new_n42_), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n93_), .c(new_n79_), .O(z7));
  aoi21  g79(.a(new_n18_), .b(x1), .c(x3), .O(z8));
  oai21  g80(.a(x6), .b(x0), .c(x5), .O(new_n98_));
  oai21  g81(.a(new_n98_), .b(new_n27_), .c(new_n85_), .O(z9));
endmodule
