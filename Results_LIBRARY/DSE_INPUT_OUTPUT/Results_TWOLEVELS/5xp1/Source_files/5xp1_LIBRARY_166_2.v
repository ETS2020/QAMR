...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n119_, new_n120_, new_n121_, new_n122_, new_n123_, new_n127_;
  ...
  oai21  g061(.a(new_n78_), .b(x5), .c(x0), .O(new_n79_));
  ...
  aoi21  g073(.a(new_n90_), .b(new_n66_), .c(x5), .O(new_n91_));
  oai21  g074(.a(new_n91_), .b(new_n35_), .c(new_n89_), .O(new_n92_));
  aoi21  g075(.a(new_n92_), .b(x0), .c(new_n49_), .O(new_n93_));
  nand3  g076(.a(new_n93_), .b(new_n88_), .c(new_n85_), .O(z3));
  nand2  g077(.a(x2), .b(new_n35_), .O(new_n95_));
  nand2  g078(.a(new_n36_), .b(x1), .O(new_n96_));
  aoi21  g079(.a(new_n96_), .b(new_n95_), .c(new_n64_), .O(new_n97_));
  nand3  g080(.a(new_n43_), .b(x1), .c(new_n64_), .O(new_n98_));
  inv1   g081(.a(new_n43_), .O(new_n99_));
  nand2  g082(.a(new_n99_), .b(new_n35_), .O(new_n100_));
  nand3  g083(.a(new_n100_), .b(new_n98_), .c(new_n33_), .O(new_n101_));
  oai21  g084(.a(new_n101_), .b(new_n97_), .c(new_n34_), .O(new_n102_));
  nand2  g085(.a(x2), .b(x1), .O(new_n103_));
  nand2  g086(.a(x3), .b(new_n66_), .O(new_n104_));
  aoi21  g087(.a(new_n104_), .b(new_n103_), .c(new_n64_), .O(new_n105_));
  oai21  g088(.a(x3), .b(x0), .c(x2), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(new_n35_), .O(new_n107_));
  oai21  g090(.a(new_n43_), .b(new_n35_), .c(new_n107_), .O(new_n108_));
  ...
  oai21  g094(.a(new_n104_), .b(new_n35_), .c(new_n111_), .O(new_n112_));
