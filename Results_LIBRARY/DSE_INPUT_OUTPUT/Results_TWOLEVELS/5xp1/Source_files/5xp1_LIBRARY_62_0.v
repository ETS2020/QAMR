...
module FAU ( 
  ...
  nor2   g090(.a(new_n22_), .b(x3), .O(new_n108_));
  nand2  g091(.a(new_n108_), .b(x2), .O(new_n109_));
  oai21  g092(.a(new_n98_), .b(new_n18_), .c(new_n109_), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(new_n49_), .O(new_n111_));
  aoi21  g094(.a(new_n68_), .b(x1), .c(new_n51_), .O(new_n112_));
  nand2  g095(.a(new_n108_), .b(new_n68_), .O(new_n113_));
  ...
  inv1   g099(.a(new_n72_), .O(new_n117_));
  oai21  g100(.a(new_n108_), .b(new_n117_), .c(x1), .O(new_n118_));
  oai21  g101(.a(new_n98_), .b(x1), .c(new_n118_), .O(z6));
  ...
  nand3  g106(.a(x2), .b(new_n18_), .c(x0), .O(new_n124_));
  nand2  g107(.a(x6), .b(new_n68_), .O(new_n125_));
  aoi21  g108(.a(new_n124_), .b(x6), .c(new_n125_), .O(new_n126_));
  nor2   g109(.a(new_n126_), .b(x3), .O(z8));
  inv1   g110(.a(new_n35_), .O(new_n128_));
  oai21  g111(.a(new_n125_), .b(x0), .c(new_n122_), .O(new_n129_));
  nand2  g112(.a(new_n129_), .b(new_n18_), .O(new_n130_));
  nand4  g113(.a(new_n130_), .b(new_n91_), .c(new_n90_), .d(new_n49_), .O(new_n131_));
  nand3  g114(.a(new_n131_), .b(x5), .c(x4), .O(new_n132_));
  nand2  g115(.a(new_n132_), .b(new_n128_), .O(z9));
endmodule
