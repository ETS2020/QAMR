...
module FAU ( 
  ...
  nand3  g44(.a(new_n61_), .b(x2), .c(new_n18_), .O(new_n62_));
  oai21  g45(.a(new_n60_), .b(new_n27_), .c(new_n62_), .O(new_n63_));
  ...
  nand2  g53(.a(x3), .b(new_n34_), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n70_), .c(new_n27_), .O(new_n72_));
  oai21  g55(.a(x3), .b(x0), .c(x2), .O(new_n73_));
  nand2  g56(.a(new_n73_), .b(new_n18_), .O(new_n74_));
  oai21  g57(.a(new_n28_), .b(new_n18_), .c(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n72_), .c(x6), .O(new_n76_));
  nand2  g59(.a(new_n61_), .b(new_n27_), .O(new_n77_));
  nand4  g60(.a(new_n77_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n78_));
  nand2  g61(.a(new_n78_), .b(new_n76_), .O(z4));
  nand3  g62(.a(new_n58_), .b(new_n61_), .c(x2), .O(new_n80_));
  nor2   g63(.a(new_n19_), .b(new_n61_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n34_), .c(x1), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n27_), .O(new_n84_));
  aoi21  g67(.a(new_n61_), .b(x2), .c(x1), .O(new_n85_));
  nand2  g68(.a(new_n61_), .b(new_n34_), .O(new_n86_));
  ...
  nand3  g72(.a(x6), .b(x2), .c(x1), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n60_), .c(x3), .O(new_n92_));
  oai21  g75(.a(new_n81_), .b(new_n18_), .c(new_n92_), .O(z6));
  nand2  g76(.a(new_n81_), .b(new_n34_), .O(new_n94_));
  nand4  g77(.a(new_n19_), .b(new_n61_), .c(x2), .d(new_n18_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x0), .O(new_n97_));
  nand2  g80(.a(new_n82_), .b(new_n62_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n27_), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n34_), .c(new_n18_), .O(new_n100_));
  nand3  g83(.a(x6), .b(new_n61_), .c(x2), .O(new_n101_));
  nand4  g84(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n97_), .O(z7));
  nand2  g85(.a(new_n58_), .b(x3), .O(z8));
  oai21  g86(.a(x6), .b(x0), .c(x5), .O(new_n104_));
  oai21  g87(.a(new_n104_), .b(new_n26_), .c(new_n58_), .O(z9));
endmodule
