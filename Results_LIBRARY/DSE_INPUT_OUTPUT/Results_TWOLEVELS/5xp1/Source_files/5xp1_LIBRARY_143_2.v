...
module FAU ( 
  ...
  nand2  g058(.a(x6), .b(new_n33_), .O(new_n76_));
  nand3  g059(.a(new_n34_), .b(x3), .c(x2), .O(new_n77_));
  aoi21  g060(.a(new_n77_), .b(new_n76_), .c(new_n35_), .O(new_n78_));
  nand3  g061(.a(new_n43_), .b(x5), .c(new_n35_), .O(new_n79_));
  oai21  g062(.a(new_n76_), .b(new_n43_), .c(new_n79_), .O(new_n80_));
  oai21  g063(.a(new_n80_), .b(new_n78_), .c(new_n62_), .O(new_n81_));
  nor3   g064(.a(x6), .b(x3), .c(x2), .O(new_n82_));
  oai21  g065(.a(new_n82_), .b(x5), .c(x1), .O(new_n83_));
  nor2   g066(.a(x6), .b(new_n64_), .O(new_n84_));
  oai21  g067(.a(new_n84_), .b(new_n58_), .c(new_n35_), .O(new_n85_));
  nand2  g068(.a(x5), .b(x2), .O(new_n86_));
  nand3  g069(.a(new_n86_), .b(new_n85_), .c(new_n83_), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(x0), .O(new_n88_));
  nor2   g071(.a(x6), .b(new_n33_), .O(new_n89_));
  inv1   g072(.a(new_n89_), .O(new_n90_));
  nand3  g073(.a(new_n90_), .b(new_n88_), .c(new_n81_), .O(z3));
  nand2  g074(.a(x2), .b(new_n35_), .O(new_n92_));
  nand2  g075(.a(new_n36_), .b(x1), .O(new_n93_));
  aoi21  g076(.a(new_n93_), .b(new_n92_), .c(new_n62_), .O(new_n94_));
  nand3  g077(.a(new_n43_), .b(x1), .c(new_n62_), .O(new_n95_));
  inv1   g078(.a(new_n43_), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(new_n35_), .O(new_n97_));
  nand3  g080(.a(new_n97_), .b(new_n95_), .c(new_n33_), .O(new_n98_));
  oai21  g081(.a(new_n98_), .b(new_n94_), .c(new_n34_), .O(new_n99_));
  nand2  g082(.a(x2), .b(x1), .O(new_n100_));
  nand2  g083(.a(x3), .b(new_n64_), .O(new_n101_));
  aoi21  g084(.a(new_n101_), .b(new_n100_), .c(new_n62_), .O(new_n102_));
  oai21  g085(.a(x3), .b(x0), .c(x2), .O(new_n103_));
  nand2  g086(.a(new_n103_), .b(new_n35_), .O(new_n104_));
  oai21  g087(.a(new_n43_), .b(new_n35_), .c(new_n104_), .O(new_n105_));
  oai21  g088(.a(new_n105_), .b(new_n102_), .c(x6), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(new_n99_), .O(z4));
  nand2  g090(.a(new_n61_), .b(x2), .O(new_n108_));
  oai21  g091(.a(new_n101_), .b(new_n35_), .c(new_n108_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(new_n62_), .O(new_n110_));
  aoi21  g093(.a(x3), .b(x1), .c(x2), .O(new_n111_));
  oai21  g094(.a(new_n111_), .b(new_n96_), .c(x0), .O(new_n112_));
  nand3  g095(.a(new_n112_), .b(new_n110_), .c(new_n90_), .O(z5));
  nand2  g096(.a(x6), .b(new_n19_), .O(new_n114_));
  nand3  g097(.a(new_n114_), .b(new_n33_), .c(x0), .O(new_n115_));
  oai21  g098(.a(x6), .b(new_n62_), .c(x3), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n115_), .c(new_n64_), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n61_), .c(x1), .O(new_n118_));
  inv1   g101(.a(new_n101_), .O(new_n119_));
  aoi21  g102(.a(new_n119_), .b(new_n35_), .c(new_n89_), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(new_n118_), .O(z6));
  nand3  g104(.a(new_n108_), .b(new_n101_), .c(new_n90_), .O(z7));
  nor2   g105(.a(new_n89_), .b(x3), .O(z8));
  aoi21  g106(.a(x6), .b(new_n19_), .c(new_n33_), .O(z9));
endmodule
