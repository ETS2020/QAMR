...
module FAU ( 
  ...
  nor2   g066(.a(x3), .b(new_n70_), .O(new_n84_));
  oai21  g067(.a(new_n84_), .b(new_n83_), .c(new_n18_), .O(new_n85_));
  aoi21  g068(.a(new_n85_), .b(new_n38_), .c(new_n19_), .O(new_n86_));
  nand3  g069(.a(new_n19_), .b(x1), .c(new_n47_), .O(new_n87_));
  inv1   g070(.a(new_n87_), .O(new_n88_));
  oai21  g071(.a(new_n88_), .b(new_n86_), .c(x6), .O(new_n89_));
  nand2  g072(.a(new_n64_), .b(new_n18_), .O(new_n90_));
  inv1   g073(.a(x3), .O(new_n91_));
  nand3  g074(.a(new_n32_), .b(new_n91_), .c(new_n70_), .O(new_n92_));
  aoi21  g075(.a(new_n92_), .b(new_n90_), .c(x5), .O(new_n93_));
  nand3  g076(.a(x5), .b(x2), .c(x1), .O(new_n94_));
  inv1   g077(.a(new_n94_), .O(new_n95_));
  oai21  g078(.a(new_n95_), .b(new_n93_), .c(x0), .O(new_n96_));
  nand3  g079(.a(new_n96_), .b(new_n89_), .c(new_n82_), .O(z3));
  nand2  g080(.a(x3), .b(new_n70_), .O(new_n98_));
  aoi21  g081(.a(new_n98_), .b(new_n49_), .c(new_n47_), .O(new_n99_));
  oai21  g082(.a(x3), .b(x0), .c(x2), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(new_n18_), .O(new_n101_));
  oai21  g084(.a(new_n40_), .b(new_n18_), .c(new_n101_), .O(new_n102_));
  oai21  g085(.a(new_n102_), .b(new_n99_), .c(x6), .O(new_n103_));
  nand3  g086(.a(new_n91_), .b(new_n70_), .c(x1), .O(new_n104_));
  oai21  g087(.a(new_n70_), .b(x1), .c(new_n104_), .O(new_n105_));
  nand3  g088(.a(new_n105_), .b(new_n32_), .c(x0), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(new_n103_), .O(z4));
  nand2  g090(.a(new_n91_), .b(x2), .O(new_n108_));
  oai21  g091(.a(new_n98_), .b(new_n18_), .c(new_n108_), .O(new_n109_));
  nand3  g092(.a(new_n109_), .b(x6), .c(new_n47_), .O(new_n110_));
  inv1   g093(.a(new_n40_), .O(new_n111_));
  ...
  nand3  g097(.a(new_n48_), .b(new_n70_), .c(new_n18_), .O(new_n115_));
  oai21  g098(.a(new_n64_), .b(new_n18_), .c(new_n115_), .O(new_n116_));
  nand2  g099(.a(new_n116_), .b(x3), .O(new_n117_));
  oai21  g100(.a(new_n54_), .b(x5), .c(x0), .O(new_n118_));
  aoi21  g101(.a(new_n118_), .b(new_n20_), .c(new_n70_), .O(new_n119_));
  oai21  g102(.a(new_n119_), .b(new_n91_), .c(x1), .O(new_n120_));
  nand3  g103(.a(new_n120_), .b(new_n117_), .c(new_n48_), .O(z6));
  inv1   g104(.a(new_n98_), .O(new_n122_));
  oai21  g105(.a(new_n122_), .b(new_n84_), .c(x0), .O(new_n123_));
  aoi22  g106(.a(new_n109_), .b(new_n47_), .c(new_n122_), .d(new_n18_), .O(new_n124_));
  oai21  g107(.a(new_n124_), .b(new_n32_), .c(new_n123_), .O(z7));
  nor3   g108(.a(x6), .b(x1), .c(x0), .O(new_n126_));
  oai21  g109(.a(new_n126_), .b(x3), .c(new_n48_), .O(z8));
  nand2  g110(.a(new_n48_), .b(x5), .O(new_n128_));
  nor2   g111(.a(new_n128_), .b(new_n21_), .O(z9));
endmodule
