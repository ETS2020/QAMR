...
module FAU ( 
  ...
  oai21  g073(.a(new_n25_), .b(new_n24_), .c(new_n46_), .O(new_n91_));
  nand3  g074(.a(new_n25_), .b(new_n53_), .c(new_n24_), .O(new_n92_));
  nand2  g075(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g076(.a(new_n93_), .b(new_n18_), .c(x0), .O(new_n94_));
  oai21  g077(.a(new_n90_), .b(new_n18_), .c(new_n94_), .O(z3));
  xor2a  g078(.a(x6), .b(x2), .O(new_n96_));
  nand3  g079(.a(new_n96_), .b(new_n46_), .c(new_n28_), .O(new_n97_));
  nand3  g080(.a(x6), .b(x2), .c(x1), .O(new_n98_));
  aoi21  g081(.a(new_n98_), .b(new_n97_), .c(new_n53_), .O(new_n99_));
  nand3  g082(.a(new_n47_), .b(new_n25_), .c(x1), .O(new_n100_));
  nand3  g083(.a(x6), .b(new_n53_), .c(new_n46_), .O(new_n101_));
  aoi21  g084(.a(new_n101_), .b(new_n100_), .c(x0), .O(new_n102_));
  oai21  g085(.a(new_n102_), .b(new_n99_), .c(x5), .O(new_n103_));
  nand2  g086(.a(x6), .b(x2), .O(new_n104_));
  aoi21  g087(.a(new_n92_), .b(new_n104_), .c(new_n46_), .O(new_n105_));
  nand2  g088(.a(new_n96_), .b(new_n46_), .O(new_n106_));
  nand3  g089(.a(x6), .b(x3), .c(new_n24_), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  oai21  g091(.a(new_n108_), .b(new_n105_), .c(x0), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(new_n103_), .O(z4));
  inv1   g093(.a(new_n36_), .O(new_n111_));
  nand3  g094(.a(x5), .b(new_n53_), .c(new_n28_), .O(new_n112_));
  oai21  g095(.a(new_n53_), .b(new_n28_), .c(new_n112_), .O(new_n113_));
  nand2  g096(.a(new_n113_), .b(x2), .O(new_n114_));
  nand2  g097(.a(x5), .b(x3), .O(new_n115_));
  oai21  g098(.a(new_n53_), .b(new_n46_), .c(x0), .O(new_n116_));
  nand2  g099(.a(x1), .b(new_n28_), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n115_), .c(new_n116_), .O(new_n118_));
  nand2  g101(.a(new_n118_), .b(new_n24_), .O(new_n119_));
  nand3  g102(.a(new_n119_), .b(new_n114_), .c(new_n111_), .O(z5));
  oai21  g103(.a(x5), .b(new_n28_), .c(new_n115_), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(x4), .O(new_n122_));
  nand2  g105(.a(new_n115_), .b(new_n28_), .O(new_n123_));
  oai21  g106(.a(x6), .b(new_n20_), .c(new_n123_), .O(new_n124_));
  aoi21  g107(.a(new_n124_), .b(new_n122_), .c(new_n24_), .O(new_n125_));
  oai21  g108(.a(new_n125_), .b(new_n53_), .c(x1), .O(new_n126_));
  nand4  g109(.a(x5), .b(x3), .c(new_n24_), .d(new_n46_), .O(new_n127_));
  nand2  g110(.a(new_n127_), .b(x5), .O(new_n128_));
  nand2  g111(.a(new_n128_), .b(new_n28_), .O(new_n129_));
  nand4  g112(.a(x3), .b(new_n24_), .c(new_n46_), .d(x0), .O(new_n130_));
  nand3  g113(.a(new_n130_), .b(new_n129_), .c(new_n126_), .O(z6));
  xnor2a g114(.a(x3), .b(x2), .O(new_n132_));
  aoi21  g115(.a(new_n18_), .b(new_n28_), .c(new_n132_), .O(z7));
  nor3   g116(.a(x5), .b(x1), .c(x0), .O(new_n134_));
  oai21  g117(.a(new_n134_), .b(x3), .c(new_n111_), .O(z8));
  nand2  g118(.a(new_n30_), .b(new_n28_), .O(new_n136_));
  nand3  g119(.a(new_n136_), .b(x5), .c(x4), .O(new_n137_));
  nand2  g120(.a(new_n137_), .b(new_n111_), .O(z9));
endmodule
