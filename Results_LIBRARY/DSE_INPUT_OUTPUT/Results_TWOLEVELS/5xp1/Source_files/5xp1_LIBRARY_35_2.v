...
module FAU ( 
  ...
  nor2   g39(.a(new_n23_), .b(new_n22_), .O(new_n57_));
  oai22  g40(.a(new_n57_), .b(new_n18_), .c(new_n19_), .d(new_n22_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n24_), .c(new_n36_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n56_), .O(z2));
  oai21  g43(.a(new_n51_), .b(new_n57_), .c(x1), .O(new_n61_));
  ...
  nand3  g49(.a(new_n23_), .b(x3), .c(new_n22_), .O(new_n67_));
  ...
  aoi21  g54(.a(new_n71_), .b(new_n22_), .c(new_n35_), .O(new_n72_));
  nand3  g55(.a(x3), .b(new_n35_), .c(x0), .O(new_n73_));
  oai21  g56(.a(new_n72_), .b(x1), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x6), .O(new_n75_));
  aoi22  g58(.a(x6), .b(new_n36_), .c(new_n71_), .d(new_n22_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(x2), .O(new_n77_));
  nand2  g60(.a(new_n24_), .b(x1), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n77_), .c(new_n75_), .O(z4));
  nand3  g62(.a(new_n78_), .b(new_n71_), .c(x2), .O(new_n80_));
  nand4  g63(.a(x6), .b(x3), .c(new_n35_), .d(x1), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n80_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n22_), .O(new_n83_));
  nor2   g66(.a(x3), .b(new_n35_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(x1), .O(new_n85_));
  nand2  g68(.a(new_n71_), .b(new_n35_), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n29_), .c(new_n24_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n85_), .c(x0), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n83_), .O(z5));
  xor2a  g72(.a(x2), .b(x1), .O(new_n90_));
  oai21  g73(.a(new_n24_), .b(new_n71_), .c(x1), .O(new_n91_));
  oai21  g74(.a(new_n90_), .b(new_n71_), .c(new_n91_), .O(z6));
  nor2   g75(.a(x2), .b(x0), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(x3), .c(new_n24_), .O(new_n94_));
  nand2  g77(.a(x6), .b(x0), .O(new_n95_));
  aoi21  g78(.a(new_n95_), .b(x1), .c(new_n71_), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n35_), .c(new_n84_), .O(new_n97_));
  oai21  g80(.a(new_n94_), .b(new_n36_), .c(new_n97_), .O(z7));
  aoi21  g81(.a(new_n24_), .b(x1), .c(x3), .O(z8));
  oai21  g82(.a(x1), .b(new_n22_), .c(new_n24_), .O(new_n100_));
