...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n125_, new_n126_, new_n127_, new_n131_, new_n132_;
  ...
  aoi21  g055(.a(x5), .b(new_n30_), .c(new_n43_), .O(new_n73_));
  nand2  g056(.a(new_n22_), .b(new_n30_), .O(new_n74_));
  oai21  g057(.a(new_n73_), .b(x0), .c(new_n74_), .O(new_n75_));
  nand3  g058(.a(new_n75_), .b(new_n18_), .c(new_n38_), .O(new_n76_));
  ...
  inv1   g065(.a(new_n77_), .O(new_n83_));
  oai21  g066(.a(new_n83_), .b(x6), .c(x1), .O(new_n84_));
  nand3  g067(.a(x6), .b(x3), .c(x2), .O(new_n85_));
  aoi21  g068(.a(new_n85_), .b(new_n84_), .c(x5), .O(new_n86_));
  aoi21  g069(.a(new_n57_), .b(new_n55_), .c(new_n22_), .O(new_n87_));
  oai21  g070(.a(new_n87_), .b(new_n86_), .c(new_n41_), .O(new_n88_));
  oai21  g071(.a(x6), .b(x3), .c(x1), .O(new_n89_));
  nand3  g072(.a(x6), .b(new_n18_), .c(x2), .O(new_n90_));
  aoi21  g073(.a(new_n90_), .b(new_n89_), .c(new_n22_), .O(new_n91_));
  oai21  g074(.a(new_n23_), .b(new_n30_), .c(new_n38_), .O(new_n92_));
  nand3  g075(.a(new_n23_), .b(new_n43_), .c(new_n30_), .O(new_n93_));
  aoi21  g076(.a(new_n93_), .b(new_n92_), .c(x5), .O(new_n94_));
  oai21  g077(.a(new_n94_), .b(new_n91_), .c(x0), .O(new_n95_));
  nor2   g078(.a(new_n30_), .b(new_n38_), .O(new_n96_));
  nand3  g079(.a(new_n23_), .b(x5), .c(new_n43_), .O(new_n97_));
  inv1   g080(.a(new_n97_), .O(new_n98_));
  nor2   g081(.a(new_n23_), .b(new_n18_), .O(new_n99_));
  aoi21  g082(.a(new_n98_), .b(new_n96_), .c(new_n99_), .O(new_n100_));
  nand3  g083(.a(new_n100_), .b(new_n95_), .c(new_n88_), .O(z3));
  oai21  g084(.a(x3), .b(x0), .c(x2), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n38_), .O(new_n103_));
  nor2   g086(.a(new_n43_), .b(x2), .O(new_n104_));
  oai21  g087(.a(new_n104_), .b(new_n96_), .c(x0), .O(new_n105_));
  nand2  g088(.a(new_n83_), .b(x1), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(new_n105_), .c(new_n103_), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(x6), .c(new_n18_), .O(new_n108_));
  aoi21  g091(.a(new_n77_), .b(new_n41_), .c(new_n67_), .O(new_n109_));
  nor2   g092(.a(new_n109_), .b(new_n38_), .O(new_n110_));
  nor3   g093(.a(new_n33_), .b(new_n30_), .c(x1), .O(new_n111_));
  oai21  g094(.a(new_n111_), .b(new_n110_), .c(new_n23_), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(new_n108_), .O(z4));
  inv1   g096(.a(new_n99_), .O(new_n114_));
  inv1   g097(.a(new_n104_), .O(new_n115_));
  nand2  g098(.a(new_n43_), .b(x2), .O(new_n116_));
  oai21  g099(.a(new_n115_), .b(new_n38_), .c(new_n116_), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n41_), .O(new_n118_));
  aoi21  g101(.a(x3), .b(x1), .c(x2), .O(new_n119_));
  oai21  g102(.a(new_n119_), .b(new_n83_), .c(x0), .O(new_n120_));
  nand3  g103(.a(new_n120_), .b(new_n118_), .c(new_n114_), .O(z5));
  nand2  g104(.a(x5), .b(x4), .O(new_n122_));
  aoi22  g105(.a(new_n122_), .b(x0), .c(x5), .d(x3), .O(new_n123_));
  aoi22  g106(.a(x6), .b(new_n18_), .c(new_n22_), .d(new_n41_), .O(new_n124_));
  oai22  g107(.a(new_n124_), .b(new_n43_), .c(new_n123_), .d(x6), .O(new_n125_));
  aoi21  g108(.a(new_n125_), .b(x2), .c(new_n43_), .O(new_n126_));
  aoi21  g109(.a(new_n104_), .b(new_n38_), .c(new_n99_), .O(new_n127_));
  oai21  g110(.a(new_n126_), .b(new_n38_), .c(new_n127_), .O(z6));
  nand3  g111(.a(new_n116_), .b(new_n115_), .c(new_n114_), .O(z7));
  nand2  g112(.a(new_n114_), .b(x3), .O(z8));
  nand2  g113(.a(new_n106_), .b(new_n41_), .O(new_n131_));
  nand4  g114(.a(new_n131_), .b(new_n23_), .c(x5), .d(x4), .O(new_n132_));
