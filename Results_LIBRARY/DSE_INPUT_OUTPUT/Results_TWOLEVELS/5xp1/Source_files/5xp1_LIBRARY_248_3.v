...
module FAU ( 
  ...
  nand3  g080(.a(x3), .b(x2), .c(x1), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(new_n35_), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(x6), .c(new_n22_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(new_n97_), .O(z4));
  nand2  g084(.a(new_n19_), .b(x2), .O(new_n102_));
  oai21  g085(.a(new_n86_), .b(new_n33_), .c(new_n102_), .O(new_n103_));
  nand2  g086(.a(new_n103_), .b(new_n22_), .O(new_n104_));
  oai21  g087(.a(new_n19_), .b(new_n33_), .c(new_n18_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n34_), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(new_n26_), .c(x0), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(new_n104_), .O(z5));
  nand2  g091(.a(new_n49_), .b(x4), .O(new_n109_));
  nand2  g092(.a(new_n26_), .b(new_n32_), .O(new_n110_));
  aoi21  g093(.a(new_n110_), .b(new_n109_), .c(new_n22_), .O(new_n111_));
  nand2  g094(.a(new_n26_), .b(x5), .O(new_n112_));
  aoi21  g095(.a(new_n112_), .b(x0), .c(new_n19_), .O(new_n113_));
  oai21  g096(.a(new_n113_), .b(new_n111_), .c(x2), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(x3), .O(new_n115_));
  nand2  g098(.a(new_n115_), .b(x1), .O(new_n116_));
  inv1   g099(.a(new_n86_), .O(new_n117_));
  nor2   g100(.a(new_n26_), .b(new_n22_), .O(new_n118_));
  aoi21  g101(.a(new_n117_), .b(new_n33_), .c(new_n118_), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(new_n116_), .O(z6));
  aoi21  g103(.a(new_n102_), .b(new_n86_), .c(new_n118_), .O(z7));
  oai21  g104(.a(new_n26_), .b(new_n22_), .c(x3), .O(z8));
  aoi21  g105(.a(new_n98_), .b(new_n22_), .c(x6), .O(new_n123_));
  nor2   g106(.a(new_n26_), .b(x0), .O(new_n124_));
  oai21  g107(.a(new_n124_), .b(new_n123_), .c(x5), .O(new_n125_));
  nor2   g108(.a(new_n125_), .b(new_n32_), .O(z9));
endmodule
