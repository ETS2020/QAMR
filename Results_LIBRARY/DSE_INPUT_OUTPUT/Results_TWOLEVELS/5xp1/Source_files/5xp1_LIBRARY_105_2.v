...
module FAU ( 
  ...
  nand4  g18(.a(x4), .b(x3), .c(x2), .d(x1), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(new_n22_), .c(x5), .d(new_n18_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n35_), .O(z1));
  nand2  g21(.a(x6), .b(x4), .O(new_n39_));
  nor2   g22(.a(x6), .b(x4), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(x3), .c(x2), .d(new_n18_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n39_), .c(new_n21_), .O(new_n42_));
  nand4  g25(.a(new_n23_), .b(new_n27_), .c(new_n21_), .d(new_n18_), .O(new_n43_));
  ...
  oai21  g29(.a(new_n46_), .b(new_n42_), .c(x5), .O(new_n47_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n22_), .c(new_n18_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n50_), .O(new_n53_));
  nand4  g36(.a(new_n31_), .b(x6), .c(new_n19_), .d(new_n27_), .O(new_n54_));
  inv1   g37(.a(new_n54_), .O(new_n55_));
  aoi21  g38(.a(new_n53_), .b(x4), .c(new_n55_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n47_), .O(z2));
  aoi21  g40(.a(x3), .b(x2), .c(x6), .O(new_n58_));
  nand3  g41(.a(x6), .b(x3), .c(x2), .O(new_n59_));
  oai21  g42(.a(new_n58_), .b(new_n21_), .c(new_n59_), .O(new_n60_));
  nand2  g43(.a(x6), .b(x1), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n23_), .O(new_n62_));
  nand2  g45(.a(new_n22_), .b(new_n21_), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n62_), .c(new_n19_), .O(new_n64_));
  aoi21  g47(.a(new_n60_), .b(new_n19_), .c(new_n64_), .O(new_n65_));
  nand2  g48(.a(new_n49_), .b(x5), .O(new_n66_));
  nand3  g49(.a(new_n19_), .b(new_n48_), .c(new_n21_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(new_n66_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(x6), .c(x0), .O(new_n69_));
  oai21  g52(.a(new_n65_), .b(x0), .c(new_n69_), .O(z3));
  nand2  g53(.a(x2), .b(x1), .O(new_n71_));
  nand2  g54(.a(x3), .b(new_n48_), .O(new_n72_));
  ...
  oai21  g58(.a(new_n23_), .b(new_n21_), .c(new_n75_), .O(new_n76_));
  oai21  g59(.a(new_n76_), .b(new_n73_), .c(x6), .O(new_n77_));
  xor2a  g60(.a(new_n23_), .b(new_n21_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n22_), .c(new_n18_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(new_n77_), .O(z4));
  inv1   g63(.a(x3), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(x2), .O(new_n82_));
  oai21  g65(.a(new_n72_), .b(new_n21_), .c(new_n82_), .O(new_n83_));
  ...
  oai21  g71(.a(x6), .b(x4), .c(x5), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n18_), .O(new_n90_));
  aoi21  g73(.a(x5), .b(x4), .c(x6), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  aoi21  g75(.a(new_n92_), .b(x2), .c(new_n81_), .O(new_n93_));
  inv1   g76(.a(new_n72_), .O(new_n94_));
  nor2   g77(.a(x6), .b(new_n18_), .O(new_n95_));
  aoi21  g78(.a(new_n94_), .b(new_n21_), .c(new_n95_), .O(new_n96_));
  oai21  g79(.a(new_n93_), .b(new_n21_), .c(new_n96_), .O(z6));
  oai21  g80(.a(new_n81_), .b(x2), .c(x6), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(x0), .O(new_n99_));
  nand2  g82(.a(x1), .b(x0), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(x3), .c(new_n48_), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n99_), .c(new_n82_), .O(z7));
  inv1   g85(.a(new_n95_), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(x3), .O(z8));
  nand3  g87(.a(new_n24_), .b(x5), .c(x4), .O(new_n105_));
