...
module FAU ( 
  ...
  oai21  g094(.a(new_n20_), .b(new_n66_), .c(x3), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(x1), .O(new_n113_));
  oai21  g096(.a(new_n53_), .b(x2), .c(x6), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(new_n52_), .O(new_n115_));
  nand2  g098(.a(new_n20_), .b(x2), .O(new_n116_));
  nand3  g099(.a(new_n116_), .b(new_n115_), .c(new_n113_), .O(z6));
  nand2  g100(.a(new_n53_), .b(x2), .O(new_n118_));
  aoi22  g101(.a(new_n105_), .b(new_n118_), .c(new_n20_), .d(new_n52_), .O(z7));
  nand2  g102(.a(x6), .b(new_n66_), .O(new_n120_));
  nand2  g103(.a(x6), .b(x2), .O(new_n121_));
  nand4  g104(.a(new_n121_), .b(new_n120_), .c(new_n52_), .d(x0), .O(new_n122_));
  nand2  g105(.a(new_n122_), .b(new_n53_), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n45_), .O(z8));
  nand2  g107(.a(new_n27_), .b(x1), .O(new_n125_));
  nand2  g108(.a(new_n125_), .b(new_n20_), .O(new_n126_));
