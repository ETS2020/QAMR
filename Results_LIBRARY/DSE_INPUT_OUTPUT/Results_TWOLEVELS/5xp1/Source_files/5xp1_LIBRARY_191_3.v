...
module FAU ( 
  ...
  oai22  g083(.a(new_n81_), .b(new_n18_), .c(new_n19_), .d(new_n34_), .O(new_n101_));
  ...
  nand2  g089(.a(new_n106_), .b(new_n102_), .O(z5));
  aoi21  g090(.a(new_n20_), .b(new_n45_), .c(new_n33_), .O(new_n108_));
  nand2  g091(.a(x6), .b(x4), .O(new_n109_));
  nor2   g092(.a(x5), .b(x0), .O(new_n110_));
  aoi21  g093(.a(new_n109_), .b(x5), .c(new_n110_), .O(new_n111_));
  oai22  g094(.a(new_n111_), .b(new_n80_), .c(new_n108_), .d(new_n28_), .O(new_n112_));
  aoi21  g095(.a(new_n112_), .b(x2), .c(new_n80_), .O(new_n113_));
  inv1   g096(.a(new_n19_), .O(new_n114_));
  aoi21  g097(.a(new_n114_), .b(new_n34_), .c(new_n77_), .O(new_n115_));
  oai21  g098(.a(new_n113_), .b(new_n34_), .c(new_n115_), .O(z6));
  nand2  g099(.a(new_n24_), .b(x2), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n19_), .O(z7));
  aoi21  g101(.a(x6), .b(x2), .c(x3), .O(z8));
  oai21  g102(.a(new_n20_), .b(new_n18_), .c(x0), .O(new_n120_));
  nor2   g103(.a(new_n20_), .b(x2), .O(new_n121_));
  oai21  g104(.a(new_n121_), .b(new_n105_), .c(x1), .O(new_n122_));
  nand3  g105(.a(new_n121_), .b(new_n34_), .c(new_n28_), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(new_n122_), .c(new_n120_), .O(new_n124_));
