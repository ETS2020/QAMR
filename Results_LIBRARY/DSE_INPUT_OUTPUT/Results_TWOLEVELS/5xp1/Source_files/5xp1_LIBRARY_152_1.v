...
module FAU ( 
  ...
  nor2   g72(.a(new_n89_), .b(x2), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n19_), .c(new_n88_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(x6), .c(x5), .O(new_n93_));
  nand2  g76(.a(new_n55_), .b(new_n28_), .O(new_n94_));
  nand3  g77(.a(new_n94_), .b(new_n35_), .c(x1), .O(new_n95_));
  nand3  g78(.a(new_n95_), .b(new_n93_), .c(new_n87_), .O(z4));
  nand2  g79(.a(new_n89_), .b(x2), .O(new_n97_));
  oai21  g80(.a(new_n91_), .b(new_n36_), .c(new_n97_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n19_), .O(new_n99_));
  aoi21  g82(.a(x3), .b(x1), .c(x2), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(new_n24_), .c(x0), .O(new_n101_));
  nor2   g84(.a(new_n35_), .b(x5), .O(new_n102_));
  inv1   g85(.a(new_n102_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n101_), .c(new_n99_), .O(z5));
  oai22  g87(.a(new_n18_), .b(new_n38_), .c(x3), .d(x0), .O(new_n105_));
  nand2  g88(.a(new_n35_), .b(new_n38_), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(x5), .c(x3), .O(new_n107_));
  oai21  g90(.a(new_n105_), .b(x6), .c(new_n107_), .O(new_n108_));
  aoi21  g91(.a(new_n108_), .b(x2), .c(new_n89_), .O(new_n109_));
  aoi21  g92(.a(new_n90_), .b(new_n36_), .c(new_n102_), .O(new_n110_));
  oai21  g93(.a(new_n109_), .b(new_n36_), .c(new_n110_), .O(z6));
  nand3  g94(.a(new_n103_), .b(new_n97_), .c(new_n91_), .O(z7));
  nor2   g95(.a(new_n102_), .b(x3), .O(z8));
  aoi21  g96(.a(new_n26_), .b(x5), .c(x6), .O(new_n114_));
  oai21  g97(.a(new_n114_), .b(new_n38_), .c(new_n103_), .O(z9));
endmodule
