...
module FAU ( 
  ...
  nand3  g087(.a(x6), .b(new_n86_), .c(new_n47_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n26_), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(x2), .O(new_n107_));
  oai21  g090(.a(new_n86_), .b(new_n18_), .c(x0), .O(new_n108_));
  nand4  g091(.a(x6), .b(x3), .c(x1), .d(new_n47_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(new_n70_), .O(new_n111_));
  nand3  g094(.a(new_n111_), .b(new_n107_), .c(new_n48_), .O(z5));
  nand3  g095(.a(new_n48_), .b(new_n70_), .c(new_n18_), .O(new_n113_));
  oai21  g096(.a(new_n64_), .b(new_n18_), .c(new_n113_), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(x3), .O(new_n115_));
  oai21  g098(.a(new_n54_), .b(x5), .c(x0), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n20_), .c(new_n70_), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n86_), .c(x1), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n115_), .c(new_n48_), .O(z6));
  nand2  g102(.a(new_n86_), .b(x2), .O(new_n120_));
  inv1   g103(.a(new_n120_), .O(new_n121_));
  oai21  g104(.a(new_n121_), .b(new_n94_), .c(x0), .O(new_n122_));
  nand2  g105(.a(new_n94_), .b(x1), .O(new_n123_));
  aoi21  g106(.a(new_n123_), .b(new_n120_), .c(x0), .O(new_n124_));
  nand2  g107(.a(new_n94_), .b(new_n18_), .O(new_n125_));
  inv1   g108(.a(new_n125_), .O(new_n126_));
  oai21  g109(.a(new_n126_), .b(new_n124_), .c(x6), .O(new_n127_));
  nand2  g110(.a(new_n127_), .b(new_n122_), .O(z7));
  nor3   g111(.a(x6), .b(x1), .c(x0), .O(new_n129_));
  oai21  g112(.a(new_n129_), .b(x3), .c(new_n48_), .O(z8));
  oai21  g113(.a(new_n19_), .b(new_n21_), .c(new_n48_), .O(z9));
endmodule
