...
module FAU ( 
  ...
  aoi21  g57(.a(new_n74_), .b(new_n22_), .c(new_n46_), .O(new_n75_));
  nand3  g58(.a(x3), .b(new_n46_), .c(x0), .O(new_n76_));
  oai21  g59(.a(new_n75_), .b(x1), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n77_), .b(x6), .O(new_n78_));
  aoi22  g61(.a(x6), .b(new_n38_), .c(new_n74_), .d(new_n22_), .O(new_n79_));
  nand2  g62(.a(new_n79_), .b(x2), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n78_), .c(new_n61_), .O(z4));
  nand3  g64(.a(new_n61_), .b(new_n74_), .c(x2), .O(new_n82_));
  nor2   g65(.a(new_n34_), .b(new_n74_), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n46_), .c(x1), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n22_), .O(new_n86_));
  aoi21  g69(.a(new_n74_), .b(x2), .c(x1), .O(new_n87_));
  nand2  g70(.a(new_n74_), .b(new_n46_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n23_), .c(new_n34_), .O(new_n89_));
  oai21  g72(.a(new_n89_), .b(new_n87_), .c(x0), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n86_), .O(z5));
  xor2a  g74(.a(x2), .b(x1), .O(new_n92_));
  oai22  g75(.a(new_n92_), .b(new_n74_), .c(new_n83_), .d(new_n38_), .O(z6));
  nand2  g76(.a(new_n83_), .b(new_n46_), .O(new_n94_));
  nand4  g77(.a(new_n34_), .b(new_n74_), .c(x2), .d(new_n38_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(x0), .O(new_n97_));
  nand3  g80(.a(new_n74_), .b(x2), .c(new_n38_), .O(new_n98_));
  nand2  g81(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(new_n22_), .O(new_n100_));
  nand3  g83(.a(x3), .b(new_n46_), .c(new_n38_), .O(new_n101_));
  nand3  g84(.a(x6), .b(new_n74_), .c(x2), .O(new_n102_));
  nand4  g85(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n97_), .O(z7));
  nand2  g86(.a(new_n61_), .b(x3), .O(z8));
  oai21  g87(.a(x1), .b(new_n22_), .c(new_n34_), .O(new_n105_));
