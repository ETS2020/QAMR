...
module FAU ( 
  ...
  nand2  g43(.a(new_n35_), .b(new_n36_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(x5), .c(x0), .O(new_n62_));
  nand2  g45(.a(new_n29_), .b(new_n36_), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n23_), .c(new_n22_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n62_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x6), .O(new_n66_));
  nor2   g49(.a(new_n24_), .b(new_n35_), .O(new_n67_));
  xnor2a g50(.a(x5), .b(x0), .O(new_n68_));
  inv1   g51(.a(x3), .O(new_n69_));
  nand3  g52(.a(x5), .b(new_n69_), .c(new_n22_), .O(new_n70_));
  oai21  g53(.a(new_n68_), .b(new_n67_), .c(new_n70_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(new_n36_), .O(new_n72_));
  nand2  g55(.a(new_n72_), .b(new_n66_), .O(z3));
  nand2  g56(.a(new_n69_), .b(new_n22_), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(x2), .c(x1), .O(new_n75_));
  nand2  g58(.a(x2), .b(x1), .O(new_n76_));
  nand2  g59(.a(new_n35_), .b(x0), .O(new_n77_));
  aoi21  g60(.a(new_n77_), .b(new_n76_), .c(new_n69_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n75_), .c(x6), .O(new_n79_));
  aoi21  g62(.a(x6), .b(new_n36_), .c(new_n22_), .O(new_n80_));
  nor2   g63(.a(x6), .b(new_n69_), .O(new_n81_));
  oai21  g64(.a(new_n81_), .b(new_n80_), .c(x2), .O(new_n82_));
  nand2  g65(.a(new_n24_), .b(x1), .O(new_n83_));
  nand3  g66(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(z4));
  nand2  g67(.a(new_n69_), .b(x2), .O(new_n85_));
  nand4  g68(.a(x6), .b(x3), .c(new_n35_), .d(x1), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n22_), .O(new_n88_));
  aoi21  g71(.a(new_n35_), .b(x1), .c(new_n69_), .O(new_n89_));
  nor2   g72(.a(x3), .b(x2), .O(new_n90_));
  oai21  g73(.a(new_n90_), .b(new_n89_), .c(x0), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n88_), .c(new_n83_), .O(z5));
  nand2  g75(.a(x3), .b(new_n35_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(x6), .c(x1), .O(new_n94_));
  nor2   g77(.a(new_n69_), .b(x2), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n36_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n94_), .O(z6));
  inv1   g80(.a(new_n85_), .O(new_n98_));
  oai21  g81(.a(new_n95_), .b(new_n98_), .c(new_n36_), .O(new_n99_));
  oai21  g82(.a(x1), .b(x0), .c(x3), .O(new_n100_));
  oai21  g83(.a(new_n100_), .b(x2), .c(new_n85_), .O(new_n101_));
