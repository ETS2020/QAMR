...
module FAU ( 
  ...
  nand2  g71(.a(new_n75_), .b(x2), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n18_), .O(new_n91_));
  oai21  g74(.a(new_n75_), .b(new_n21_), .c(new_n34_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n23_), .O(new_n93_));
  nand3  g76(.a(new_n93_), .b(x6), .c(x0), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n91_), .O(z5));
  oai21  g78(.a(new_n22_), .b(x4), .c(x5), .O(new_n96_));
  aoi21  g79(.a(new_n19_), .b(new_n18_), .c(x6), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(x2), .c(new_n75_), .O(new_n99_));
  nor2   g82(.a(x6), .b(new_n18_), .O(new_n100_));
  aoi21  g83(.a(new_n85_), .b(new_n21_), .c(new_n100_), .O(new_n101_));
  oai21  g84(.a(new_n99_), .b(new_n21_), .c(new_n101_), .O(z6));
  nand2  g85(.a(x1), .b(x0), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(x3), .c(new_n34_), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n89_), .c(new_n86_), .O(z7));
  inv1   g88(.a(new_n100_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(x3), .O(z8));
  nand3  g90(.a(new_n24_), .b(x5), .c(x4), .O(new_n108_));
