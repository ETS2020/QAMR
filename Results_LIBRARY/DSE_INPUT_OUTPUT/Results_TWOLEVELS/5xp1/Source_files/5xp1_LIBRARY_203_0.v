...
module FAU ( 
  ...
  nor3   g074(.a(x6), .b(x3), .c(x2), .O(new_n92_));
  oai21  g075(.a(new_n92_), .b(new_n91_), .c(new_n21_), .O(new_n93_));
  nand4  g076(.a(new_n93_), .b(new_n89_), .c(new_n87_), .d(new_n81_), .O(z3));
  nand2  g077(.a(x2), .b(x1), .O(new_n95_));
  nand2  g078(.a(x3), .b(new_n47_), .O(new_n96_));
  aoi21  g079(.a(new_n96_), .b(new_n95_), .c(new_n27_), .O(new_n97_));
  nor2   g080(.a(x3), .b(x0), .O(new_n98_));
  oai21  g081(.a(new_n98_), .b(new_n47_), .c(new_n42_), .O(new_n99_));
  oai21  g082(.a(new_n43_), .b(new_n42_), .c(new_n99_), .O(new_n100_));
  oai21  g083(.a(new_n100_), .b(new_n97_), .c(x6), .O(new_n101_));
  nand3  g084(.a(new_n28_), .b(new_n47_), .c(x1), .O(new_n102_));
  oai21  g085(.a(new_n47_), .b(x1), .c(new_n102_), .O(new_n103_));
  nand3  g086(.a(new_n103_), .b(new_n22_), .c(x0), .O(new_n104_));
  nand2  g087(.a(new_n104_), .b(new_n101_), .O(z4));
  inv1   g088(.a(new_n75_), .O(new_n106_));
  oai21  g089(.a(new_n98_), .b(new_n29_), .c(x2), .O(new_n107_));
  aoi21  g090(.a(x3), .b(x1), .c(new_n27_), .O(new_n108_));
  nor3   g091(.a(new_n28_), .b(new_n42_), .c(x0), .O(new_n109_));
  oai21  g092(.a(new_n109_), .b(new_n108_), .c(new_n47_), .O(new_n110_));
  nand3  g093(.a(new_n110_), .b(new_n107_), .c(new_n106_), .O(z5));
  nand2  g094(.a(x3), .b(new_n42_), .O(new_n112_));
  nand3  g095(.a(new_n22_), .b(new_n28_), .c(x1), .O(new_n113_));
  aoi21  g096(.a(new_n113_), .b(new_n112_), .c(new_n27_), .O(new_n114_));
  nor3   g097(.a(new_n22_), .b(new_n28_), .c(x1), .O(new_n115_));
  oai21  g098(.a(new_n115_), .b(new_n114_), .c(new_n47_), .O(new_n116_));
  oai21  g099(.a(new_n28_), .b(x2), .c(x6), .O(new_n117_));
  nand3  g100(.a(x6), .b(new_n21_), .c(new_n18_), .O(new_n118_));
  ...
  nand2  g105(.a(new_n28_), .b(x2), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(new_n96_), .c(new_n106_), .O(z7));
  aoi21  g107(.a(new_n28_), .b(new_n42_), .c(new_n22_), .O(new_n125_));
  nand2  g108(.a(x6), .b(x1), .O(new_n126_));
  nand3  g109(.a(new_n126_), .b(new_n47_), .c(new_n27_), .O(new_n127_));
  nand2  g110(.a(new_n127_), .b(new_n28_), .O(new_n128_));
  oai21  g111(.a(new_n125_), .b(x0), .c(new_n128_), .O(z8));
  oai21  g112(.a(new_n21_), .b(new_n18_), .c(new_n106_), .O(z9));
endmodule
