...
module FAU ( 
  ...
  nand3  g013(.a(x5), .b(new_n18_), .c(x1), .O(new_n31_));
  ...
  nand2  g056(.a(new_n73_), .b(new_n35_), .O(new_n74_));
  aoi21  g057(.a(new_n74_), .b(new_n22_), .c(new_n72_), .O(new_n75_));
  nand4  g058(.a(new_n75_), .b(new_n70_), .c(new_n60_), .d(new_n57_), .O(z2));
  nand2  g059(.a(new_n63_), .b(x0), .O(new_n77_));
  nand3  g060(.a(new_n21_), .b(x2), .c(new_n61_), .O(new_n78_));
  ...
  nand3  g066(.a(new_n82_), .b(new_n21_), .c(new_n41_), .O(new_n84_));
  inv1   g067(.a(new_n84_), .O(new_n85_));
  oai21  g068(.a(new_n85_), .b(new_n83_), .c(x0), .O(new_n86_));
  nand3  g069(.a(new_n42_), .b(x5), .c(new_n41_), .O(new_n87_));
  nand2  g070(.a(new_n21_), .b(x1), .O(new_n88_));
  nand3  g071(.a(new_n88_), .b(new_n87_), .c(x6), .O(new_n89_));
  nand2  g072(.a(new_n89_), .b(new_n61_), .O(new_n90_));
  nand4  g073(.a(new_n22_), .b(new_n21_), .c(new_n47_), .d(new_n46_), .O(new_n91_));
  nand4  g074(.a(new_n91_), .b(new_n90_), .c(new_n86_), .d(new_n80_), .O(z3));
  nand2  g075(.a(x2), .b(x1), .O(new_n93_));
  nand2  g076(.a(x3), .b(new_n46_), .O(new_n94_));
  aoi21  g077(.a(new_n94_), .b(new_n93_), .c(new_n61_), .O(new_n95_));
  oai21  g078(.a(x3), .b(x0), .c(x2), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(new_n41_), .O(new_n97_));
  oai21  g080(.a(new_n42_), .b(new_n41_), .c(new_n97_), .O(new_n98_));
  oai21  g081(.a(new_n98_), .b(new_n95_), .c(x6), .O(new_n99_));
  nand2  g082(.a(x2), .b(new_n41_), .O(new_n100_));
  oai21  g083(.a(new_n48_), .b(new_n41_), .c(new_n100_), .O(new_n101_));
  nand3  g084(.a(new_n101_), .b(new_n22_), .c(x0), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n99_), .O(z4));
  nand2  g086(.a(new_n47_), .b(x2), .O(new_n104_));
  oai21  g087(.a(new_n94_), .b(new_n41_), .c(new_n104_), .O(new_n105_));
  nand3  g088(.a(new_n105_), .b(x6), .c(new_n61_), .O(new_n106_));
  inv1   g089(.a(new_n42_), .O(new_n107_));
  ...
  oai21  g103(.a(x3), .b(new_n46_), .c(x6), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(new_n61_), .O(new_n122_));
  nand3  g105(.a(new_n47_), .b(x2), .c(x0), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(new_n122_), .c(new_n94_), .O(z7));
  oai21  g107(.a(x1), .b(new_n61_), .c(x6), .O(new_n125_));
  aoi21  g108(.a(new_n125_), .b(new_n61_), .c(x3), .O(z8));
  oai21  g109(.a(x6), .b(x0), .c(x5), .O(new_n127_));
  nor2   g110(.a(new_n127_), .b(new_n18_), .O(z9));
endmodule
