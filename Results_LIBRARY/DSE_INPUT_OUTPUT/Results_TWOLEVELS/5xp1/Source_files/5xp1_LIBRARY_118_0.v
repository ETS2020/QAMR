...
module FAU ( 
  ...
  nand2  g038(.a(new_n22_), .b(new_n55_), .O(new_n56_));
  nand3  g039(.a(new_n56_), .b(new_n54_), .c(new_n47_), .O(z1));
  ...
  nand2  g046(.a(new_n59_), .b(x2), .O(new_n64_));
  inv1   g047(.a(new_n64_), .O(new_n65_));
  oai21  g048(.a(new_n65_), .b(new_n63_), .c(x1), .O(new_n66_));
  oai21  g049(.a(new_n63_), .b(new_n59_), .c(x5), .O(new_n67_));
  nand2  g050(.a(x6), .b(x2), .O(new_n68_));
  nand2  g051(.a(new_n68_), .b(new_n37_), .O(new_n69_));
  nand2  g052(.a(new_n69_), .b(x4), .O(new_n70_));
  nand3  g053(.a(new_n70_), .b(new_n67_), .c(new_n66_), .O(new_n71_));
  nand2  g054(.a(new_n71_), .b(x0), .O(new_n72_));
  nand3  g055(.a(new_n44_), .b(x5), .c(new_n55_), .O(new_n73_));
  nand2  g056(.a(new_n21_), .b(new_n48_), .O(new_n74_));
  aoi21  g057(.a(new_n74_), .b(new_n73_), .c(x1), .O(new_n75_));
  ...
  nand3  g063(.a(new_n80_), .b(new_n72_), .c(new_n62_), .O(z2));
  nand3  g064(.a(x5), .b(x1), .c(x0), .O(new_n82_));
  nand3  g065(.a(new_n21_), .b(x2), .c(new_n55_), .O(new_n83_));
  nand2  g066(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(x3), .O(new_n85_));
  nand3  g068(.a(new_n44_), .b(new_n43_), .c(new_n55_), .O(new_n86_));
  inv1   g069(.a(new_n86_), .O(new_n87_));
  oai21  g070(.a(x6), .b(x2), .c(x1), .O(new_n88_));
  aoi21  g071(.a(new_n88_), .b(new_n68_), .c(new_n55_), .O(new_n89_));
  oai21  g072(.a(new_n89_), .b(new_n87_), .c(x5), .O(new_n90_));
  oai21  g073(.a(x5), .b(new_n43_), .c(x6), .O(new_n91_));
  nand2  g074(.a(new_n91_), .b(new_n55_), .O(new_n92_));
  ...
  aoi21  g082(.a(new_n99_), .b(new_n98_), .c(new_n55_), .O(new_n100_));
  ...
  aoi21  g092(.a(x3), .b(x1), .c(new_n55_), .O(new_n110_));
  nor3   g093(.a(new_n49_), .b(new_n43_), .c(x0), .O(new_n111_));
  oai21  g094(.a(new_n111_), .b(new_n110_), .c(new_n48_), .O(new_n112_));
  nand3  g095(.a(new_n112_), .b(new_n109_), .c(new_n56_), .O(z5));
  nand2  g096(.a(x3), .b(new_n43_), .O(new_n114_));
  nand3  g097(.a(new_n22_), .b(new_n49_), .c(x1), .O(new_n115_));
  aoi21  g098(.a(new_n115_), .b(new_n114_), .c(new_n55_), .O(new_n116_));
  nor3   g099(.a(new_n22_), .b(new_n49_), .c(x1), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n116_), .c(new_n48_), .O(new_n118_));
  oai21  g101(.a(new_n49_), .b(x2), .c(x6), .O(new_n119_));
  nand3  g102(.a(x6), .b(new_n21_), .c(new_n18_), .O(new_n120_));
  nand3  g103(.a(new_n120_), .b(x2), .c(x0), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g105(.a(new_n122_), .b(x1), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n118_), .O(z6));
  nand2  g107(.a(new_n49_), .b(x2), .O(new_n125_));
  nand3  g108(.a(new_n125_), .b(new_n99_), .c(new_n56_), .O(z7));
  aoi21  g109(.a(new_n49_), .b(new_n43_), .c(new_n22_), .O(new_n127_));
  nand2  g110(.a(x6), .b(x1), .O(new_n128_));
  nand3  g111(.a(new_n128_), .b(new_n48_), .c(new_n55_), .O(new_n129_));
  nand2  g112(.a(new_n129_), .b(new_n49_), .O(new_n130_));
  oai21  g113(.a(new_n127_), .b(x0), .c(new_n130_), .O(z8));
  oai21  g114(.a(new_n21_), .b(new_n18_), .c(new_n56_), .O(z9));
endmodule
