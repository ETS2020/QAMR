...
module FAU ( 
  ...
  nor2   g39(.a(new_n56_), .b(new_n18_), .O(new_n57_));
  nand3  g40(.a(new_n22_), .b(new_n18_), .c(new_n20_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x1), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n57_), .c(x6), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n55_), .O(z2));
  nand2  g44(.a(new_n27_), .b(new_n24_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x5), .c(x0), .O(new_n63_));
  oai21  g46(.a(new_n19_), .b(new_n18_), .c(new_n44_), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n22_), .c(new_n20_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(new_n63_), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(x1), .O(new_n67_));
  nand2  g50(.a(x5), .b(new_n20_), .O(new_n68_));
  nand3  g51(.a(new_n22_), .b(new_n27_), .c(x0), .O(new_n69_));
  aoi21  g52(.a(new_n69_), .b(new_n68_), .c(x2), .O(new_n70_));
  ...
  oai21  g57(.a(x5), .b(x1), .c(new_n34_), .O(new_n75_));
  aoi22  g58(.a(new_n75_), .b(x0), .c(new_n59_), .d(x6), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n74_), .c(new_n67_), .O(z3));
  nand2  g60(.a(new_n44_), .b(new_n20_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n62_), .c(x6), .O(new_n79_));
  ...
  aoi22  g66(.a(new_n83_), .b(x2), .c(x6), .d(new_n21_), .O(new_n84_));
  ...
  aoi21  g91(.a(x5), .b(x4), .c(new_n21_), .O(new_n109_));
  nand3  g92(.a(new_n45_), .b(x5), .c(x4), .O(new_n110_));
  oai21  g93(.a(new_n109_), .b(new_n19_), .c(new_n110_), .O(z9));
endmodule
