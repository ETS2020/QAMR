...
module FAU ( 
  ...
  nand2  g041(.a(new_n45_), .b(new_n38_), .O(new_n59_));
  nand2  g042(.a(new_n59_), .b(x5), .O(new_n60_));
  aoi21  g043(.a(new_n60_), .b(new_n58_), .c(new_n21_), .O(new_n61_));
  aoi21  g044(.a(new_n31_), .b(new_n30_), .c(new_n33_), .O(new_n62_));
  nand3  g045(.a(x2), .b(new_n38_), .c(x0), .O(new_n63_));
  oai21  g046(.a(new_n62_), .b(x6), .c(new_n63_), .O(new_n64_));
  oai21  g047(.a(new_n64_), .b(new_n61_), .c(x4), .O(new_n65_));
  oai21  g048(.a(new_n33_), .b(new_n30_), .c(new_n31_), .O(new_n66_));
  nand2  g049(.a(new_n66_), .b(new_n21_), .O(new_n67_));
  nand3  g050(.a(new_n45_), .b(x5), .c(new_n44_), .O(new_n68_));
  nand2  g051(.a(new_n18_), .b(new_n30_), .O(new_n69_));
  nand2  g052(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand2  g053(.a(new_n70_), .b(new_n38_), .O(new_n71_));
  nand2  g054(.a(new_n36_), .b(new_n44_), .O(new_n72_));
  nand3  g055(.a(new_n72_), .b(new_n71_), .c(new_n67_), .O(new_n73_));
  nand2  g056(.a(new_n73_), .b(new_n20_), .O(new_n74_));
  nand3  g057(.a(new_n74_), .b(new_n65_), .c(new_n43_), .O(z2));
  nand3  g058(.a(new_n18_), .b(x3), .c(new_n44_), .O(new_n76_));
  oai21  g059(.a(new_n18_), .b(new_n44_), .c(new_n76_), .O(new_n77_));
  nand2  g060(.a(new_n77_), .b(x2), .O(new_n78_));
  inv1   g061(.a(x3), .O(new_n79_));
  nand2  g062(.a(new_n21_), .b(new_n79_), .O(new_n80_));
  nand3  g063(.a(new_n80_), .b(x5), .c(x0), .O(new_n81_));
  nand2  g064(.a(new_n81_), .b(new_n72_), .O(new_n82_));
  nand2  g065(.a(new_n82_), .b(x1), .O(new_n83_));
  nand2  g066(.a(new_n80_), .b(x1), .O(new_n84_));
  nand3  g067(.a(new_n84_), .b(new_n18_), .c(x0), .O(new_n85_));
  nand2  g068(.a(x6), .b(x1), .O(new_n86_));
  nand3  g069(.a(new_n86_), .b(x5), .c(new_n44_), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(new_n85_), .O(new_n88_));
  nand2  g071(.a(new_n88_), .b(new_n30_), .O(new_n89_));
  nand4  g072(.a(new_n86_), .b(x5), .c(new_n79_), .d(new_n44_), .O(new_n90_));
  and2   g073(.a(new_n90_), .b(new_n43_), .O(new_n91_));
  nand4  g074(.a(new_n91_), .b(new_n89_), .c(new_n83_), .d(new_n78_), .O(z3));
  nor2   g075(.a(x3), .b(x0), .O(new_n93_));
  xor2a  g076(.a(x2), .b(x1), .O(new_n94_));
  nand3  g077(.a(x3), .b(x1), .c(x0), .O(new_n95_));
  oai21  g078(.a(new_n94_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(x6), .O(new_n97_));
  oai21  g080(.a(new_n93_), .b(new_n21_), .c(new_n38_), .O(new_n98_));
  aoi21  g081(.a(new_n79_), .b(x1), .c(new_n30_), .O(new_n99_));
  nor2   g082(.a(new_n99_), .b(x0), .O(new_n100_));
  nor2   g083(.a(x3), .b(x2), .O(new_n101_));
  oai21  g084(.a(new_n101_), .b(new_n100_), .c(new_n21_), .O(new_n102_));
  nand3  g085(.a(new_n102_), .b(new_n98_), .c(new_n97_), .O(z4));
  inv1   g086(.a(new_n45_), .O(new_n104_));
  oai21  g087(.a(new_n101_), .b(new_n104_), .c(x1), .O(new_n105_));
  nand2  g088(.a(new_n79_), .b(x2), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(x6), .c(new_n38_), .O(new_n107_));
  ...
  nand3  g093(.a(new_n21_), .b(new_n79_), .c(x2), .O(new_n111_));
  aoi21  g094(.a(new_n111_), .b(new_n110_), .c(new_n38_), .O(new_n112_));
  nand3  g095(.a(x6), .b(new_n79_), .c(x2), .O(new_n113_));
  inv1   g096(.a(new_n113_), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n112_), .c(new_n44_), .O(new_n115_));
  nand2  g098(.a(new_n115_), .b(new_n109_), .O(z5));
  nand2  g099(.a(new_n110_), .b(x1), .O(new_n117_));
  nand4  g100(.a(x6), .b(x3), .c(new_n30_), .d(new_n38_), .O(new_n118_));
  nand2  g101(.a(new_n118_), .b(new_n117_), .O(z6));
  nand3  g102(.a(new_n110_), .b(new_n106_), .c(new_n43_), .O(z7));
  nor2   g103(.a(new_n40_), .b(x3), .O(z8));
  nand3  g104(.a(new_n45_), .b(new_n21_), .c(new_n44_), .O(new_n122_));
  nand3  g105(.a(new_n122_), .b(x5), .c(x4), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n43_), .O(z9));
endmodule
