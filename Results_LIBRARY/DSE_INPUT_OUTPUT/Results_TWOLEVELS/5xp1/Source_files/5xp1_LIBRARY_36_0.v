...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n113_, new_n116_, new_n118_, new_n119_, new_n120_;
  ...
  oai21  g060(.a(new_n77_), .b(new_n44_), .c(new_n70_), .O(new_n78_));
  ...
  nand3  g065(.a(new_n82_), .b(x5), .c(new_n44_), .O(new_n83_));
  nand2  g066(.a(new_n83_), .b(new_n81_), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(new_n30_), .O(new_n85_));
  inv1   g068(.a(x3), .O(new_n86_));
  nand4  g069(.a(new_n82_), .b(x5), .c(new_n86_), .d(new_n44_), .O(new_n87_));
  and2   g070(.a(new_n87_), .b(new_n43_), .O(new_n88_));
  nand4  g071(.a(new_n88_), .b(new_n85_), .c(new_n79_), .d(new_n76_), .O(z3));
  nand2  g072(.a(x2), .b(x1), .O(new_n90_));
  nand2  g073(.a(x3), .b(new_n30_), .O(new_n91_));
  aoi21  g074(.a(new_n91_), .b(new_n90_), .c(new_n44_), .O(new_n92_));
  oai21  g075(.a(x3), .b(x0), .c(x2), .O(new_n93_));
  nand2  g076(.a(new_n93_), .b(new_n38_), .O(new_n94_));
  oai21  g077(.a(new_n45_), .b(new_n38_), .c(new_n94_), .O(new_n95_));
  oai21  g078(.a(new_n95_), .b(new_n92_), .c(x6), .O(new_n96_));
  oai21  g079(.a(x3), .b(x2), .c(new_n48_), .O(new_n97_));
  nand3  g080(.a(new_n97_), .b(new_n21_), .c(x1), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(new_n96_), .O(z4));
  nand2  g082(.a(new_n86_), .b(x2), .O(new_n100_));
  oai21  g083(.a(new_n91_), .b(new_n38_), .c(new_n100_), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(new_n44_), .O(new_n102_));
  oai21  g085(.a(x2), .b(new_n44_), .c(x6), .O(new_n103_));
  nand2  g086(.a(new_n103_), .b(new_n38_), .O(new_n104_));
  inv1   g087(.a(new_n45_), .O(new_n105_));
  nor2   g088(.a(x3), .b(x2), .O(new_n106_));
  oai21  g089(.a(new_n106_), .b(new_n105_), .c(x0), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n104_), .c(new_n102_), .O(z5));
  oai21  g091(.a(new_n21_), .b(new_n30_), .c(x3), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(x1), .O(new_n110_));
  oai21  g093(.a(new_n86_), .b(x2), .c(x6), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n38_), .O(new_n112_));
  nand2  g095(.a(new_n21_), .b(x2), .O(new_n113_));
  nand3  g096(.a(new_n113_), .b(new_n112_), .c(new_n110_), .O(z6));
  aoi22  g097(.a(new_n100_), .b(new_n91_), .c(new_n21_), .d(new_n38_), .O(z7));
  oai21  g098(.a(x2), .b(new_n38_), .c(x6), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n38_), .c(x3), .O(z8));
  nand2  g100(.a(new_n48_), .b(x1), .O(new_n118_));
