...
module FAU ( 
  ...
  nand4  g17(.a(x5), .b(new_n24_), .c(x3), .d(x2), .O(new_n35_));
  aoi21  g18(.a(new_n35_), .b(new_n34_), .c(new_n25_), .O(new_n36_));
  nand2  g19(.a(new_n24_), .b(x0), .O(new_n37_));
  aoi21  g20(.a(new_n37_), .b(new_n21_), .c(new_n30_), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(new_n36_), .c(new_n18_), .O(new_n39_));
  nand4  g22(.a(new_n26_), .b(x6), .c(x5), .d(new_n24_), .O(new_n40_));
  inv1   g23(.a(new_n40_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n25_), .c(new_n19_), .O(new_n42_));
  ...
  aoi21  g30(.a(new_n46_), .b(new_n31_), .c(new_n47_), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(new_n45_), .c(new_n24_), .O(new_n49_));
  ...
  nand4  g38(.a(new_n26_), .b(new_n24_), .c(new_n25_), .d(new_n19_), .O(new_n56_));
  nand2  g39(.a(new_n27_), .b(x4), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x6), .c(x5), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n55_), .O(z2));
  nand4  g43(.a(new_n18_), .b(new_n30_), .c(x3), .d(new_n19_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n44_), .c(new_n31_), .O(new_n62_));
  ...
  nand3  g50(.a(new_n20_), .b(x5), .c(new_n19_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(new_n18_), .O(new_n70_));
  oai21  g53(.a(new_n18_), .b(x3), .c(x2), .O(new_n71_));
  nand3  g54(.a(new_n71_), .b(new_n25_), .c(new_n19_), .O(new_n72_));
  nand3  g55(.a(x6), .b(x2), .c(x0), .O(new_n73_));
  ...
  nand3  g59(.a(x6), .b(x5), .c(x1), .O(new_n77_));
  ...
  oai21  g64(.a(new_n79_), .b(new_n31_), .c(new_n25_), .O(new_n82_));
  nor2   g65(.a(new_n32_), .b(x2), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n19_), .c(new_n82_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(x6), .c(x5), .O(new_n86_));
  oai21  g69(.a(new_n32_), .b(new_n31_), .c(new_n19_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n33_), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n18_), .c(x1), .O(new_n89_));
  nand3  g72(.a(new_n89_), .b(new_n86_), .c(new_n81_), .O(z4));
  nor2   g73(.a(new_n18_), .b(x5), .O(new_n91_));
  inv1   g74(.a(new_n91_), .O(new_n92_));
  nand2  g75(.a(new_n31_), .b(new_n25_), .O(new_n93_));
  aoi21  g76(.a(new_n93_), .b(new_n26_), .c(new_n19_), .O(new_n94_));
  nand2  g77(.a(new_n83_), .b(x1), .O(new_n95_));
  nand2  g78(.a(new_n32_), .b(x2), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(new_n95_), .c(x0), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n94_), .c(new_n92_), .O(new_n98_));
  nand2  g81(.a(x6), .b(new_n30_), .O(new_n99_));
  nand4  g82(.a(new_n99_), .b(new_n32_), .c(new_n31_), .d(x0), .O(new_n100_));
  ...
  aoi21  g89(.a(new_n83_), .b(new_n25_), .c(new_n91_), .O(new_n107_));
  oai21  g90(.a(new_n106_), .b(new_n25_), .c(new_n107_), .O(z6));
  aoi21  g91(.a(new_n96_), .b(new_n84_), .c(new_n91_), .O(z7));
  nand2  g92(.a(new_n92_), .b(x3), .O(z8));
  nand3  g93(.a(new_n20_), .b(new_n18_), .c(new_n19_), .O(new_n111_));
