...
module FAU ( 
  ...
  aoi21  g60(.a(x6), .b(new_n18_), .c(new_n27_), .O(new_n78_));
  nor2   g61(.a(x6), .b(new_n71_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n78_), .c(x2), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n77_), .c(new_n58_), .O(z4));
  nand3  g64(.a(new_n58_), .b(new_n71_), .c(x2), .O(new_n82_));
  nand4  g65(.a(x6), .b(x3), .c(new_n34_), .d(x1), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(new_n27_), .O(new_n85_));
  nor2   g68(.a(x3), .b(new_n34_), .O(new_n86_));
  ...
  nor2   g78(.a(x2), .b(x0), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(x3), .c(new_n19_), .O(new_n97_));
  nand2  g80(.a(x6), .b(x0), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(x1), .c(new_n71_), .O(new_n99_));
  aoi21  g82(.a(new_n99_), .b(new_n34_), .c(new_n86_), .O(new_n100_));
  oai21  g83(.a(new_n97_), .b(new_n18_), .c(new_n100_), .O(z7));
  aoi21  g84(.a(new_n19_), .b(x1), .c(x3), .O(z8));
