...
module FAU ( 
  ...
  nand2  g61(.a(new_n78_), .b(new_n61_), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n19_), .c(x1), .O(new_n80_));
  nand2  g63(.a(new_n19_), .b(x1), .O(new_n81_));
  nand2  g64(.a(new_n27_), .b(new_n20_), .O(new_n82_));
  nand3  g65(.a(new_n82_), .b(new_n81_), .c(x2), .O(new_n83_));
  oai21  g66(.a(new_n27_), .b(new_n20_), .c(x1), .O(new_n84_));
  nand2  g67(.a(new_n84_), .b(x6), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z4));
  nand2  g69(.a(x3), .b(new_n24_), .O(new_n87_));
  nand2  g70(.a(new_n27_), .b(x2), .O(new_n88_));
  oai21  g71(.a(new_n87_), .b(new_n21_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n20_), .O(new_n90_));
  oai21  g73(.a(x2), .b(new_n20_), .c(new_n19_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n21_), .O(new_n92_));
  nand2  g75(.a(new_n44_), .b(new_n61_), .O(new_n93_));
  ...
  aoi21  g80(.a(x6), .b(new_n18_), .c(new_n22_), .O(new_n98_));
  nor2   g81(.a(x5), .b(x0), .O(new_n99_));
  oai21  g82(.a(new_n99_), .b(new_n98_), .c(x3), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n97_), .c(new_n24_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n27_), .c(x1), .O(new_n102_));
  nand2  g85(.a(new_n87_), .b(new_n19_), .O(new_n103_));
  nor2   g86(.a(new_n19_), .b(new_n27_), .O(new_n104_));
  aoi22  g87(.a(new_n104_), .b(x2), .c(new_n103_), .d(new_n21_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(new_n102_), .O(z6));
  inv1   g89(.a(new_n75_), .O(new_n107_));
  nand3  g90(.a(new_n88_), .b(new_n87_), .c(new_n107_), .O(z7));
  nor2   g91(.a(new_n75_), .b(x3), .O(z8));
  nand2  g92(.a(new_n63_), .b(x1), .O(new_n110_));
  oai21  g93(.a(x6), .b(new_n20_), .c(new_n110_), .O(new_n111_));
