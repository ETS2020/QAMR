...
module FAU ( 
  ...
  nand3  g023(.a(new_n26_), .b(x5), .c(new_n18_), .O(new_n41_));
  oai21  g024(.a(new_n26_), .b(new_n21_), .c(new_n41_), .O(new_n42_));
  nand2  g025(.a(new_n42_), .b(x0), .O(new_n43_));
  aoi21  g026(.a(new_n19_), .b(new_n18_), .c(new_n26_), .O(new_n44_));
  oai21  g027(.a(new_n22_), .b(new_n21_), .c(new_n26_), .O(new_n45_));
  aoi21  g028(.a(new_n45_), .b(x1), .c(new_n19_), .O(new_n46_));
  aoi21  g029(.a(new_n46_), .b(new_n20_), .c(new_n44_), .O(new_n47_));
  nand3  g030(.a(new_n47_), .b(new_n43_), .c(new_n40_), .O(z1));
  ...
  nand2  g052(.a(new_n21_), .b(new_n20_), .O(new_n70_));
  nor2   g053(.a(x3), .b(new_n21_), .O(new_n71_));
  nand2  g054(.a(new_n71_), .b(x1), .O(new_n72_));
  aoi21  g055(.a(new_n72_), .b(new_n70_), .c(new_n19_), .O(new_n73_));
  oai21  g056(.a(new_n73_), .b(new_n69_), .c(new_n26_), .O(new_n74_));
  nand3  g057(.a(x5), .b(x3), .c(x1), .O(new_n75_));
  inv1   g058(.a(new_n75_), .O(new_n76_));
  nor3   g059(.a(x5), .b(x2), .c(x1), .O(new_n77_));
  oai21  g060(.a(new_n77_), .b(new_n76_), .c(x0), .O(new_n78_));
  nand3  g061(.a(new_n19_), .b(x3), .c(x2), .O(new_n79_));
  aoi21  g062(.a(new_n79_), .b(new_n26_), .c(new_n49_), .O(new_n80_));
  nand3  g063(.a(x6), .b(x3), .c(x2), .O(new_n81_));
  oai21  g064(.a(new_n19_), .b(x1), .c(new_n81_), .O(new_n82_));
  oai21  g065(.a(new_n82_), .b(new_n80_), .c(new_n20_), .O(new_n83_));
  nor2   g066(.a(new_n26_), .b(new_n19_), .O(new_n84_));
  inv1   g067(.a(new_n84_), .O(new_n85_));
  nand4  g068(.a(new_n85_), .b(new_n83_), .c(new_n78_), .d(new_n74_), .O(z3));
  nand2  g069(.a(new_n56_), .b(new_n29_), .O(new_n87_));
  nand3  g070(.a(new_n87_), .b(x6), .c(new_n19_), .O(new_n88_));
  inv1   g071(.a(new_n23_), .O(new_n89_));
  aoi21  g072(.a(new_n29_), .b(new_n20_), .c(new_n89_), .O(new_n90_));
  oai21  g073(.a(new_n90_), .b(x6), .c(new_n88_), .O(new_n91_));
  ...
  nand2  g080(.a(new_n97_), .b(new_n49_), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(new_n92_), .O(z4));
  nor2   g082(.a(new_n22_), .b(x2), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x1), .O(new_n101_));
  inv1   g084(.a(new_n101_), .O(new_n102_));
  oai21  g085(.a(new_n102_), .b(new_n71_), .c(new_n20_), .O(new_n103_));
  aoi21  g086(.a(x3), .b(x1), .c(x2), .O(new_n104_));
  oai21  g087(.a(new_n104_), .b(new_n30_), .c(x0), .O(new_n105_));
  nand3  g088(.a(new_n105_), .b(new_n103_), .c(new_n85_), .O(z5));
  ...
  aoi21  g092(.a(new_n26_), .b(x0), .c(x5), .O(new_n110_));
  oai21  g093(.a(new_n110_), .b(new_n109_), .c(x3), .O(new_n111_));
  aoi21  g094(.a(new_n111_), .b(new_n108_), .c(new_n21_), .O(new_n112_));
  oai21  g095(.a(new_n112_), .b(new_n22_), .c(x1), .O(new_n113_));
  aoi21  g096(.a(new_n100_), .b(new_n49_), .c(new_n84_), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(new_n113_), .O(z6));
  nand2  g098(.a(new_n85_), .b(x3), .O(z8));
  nand2  g099(.a(x6), .b(x5), .O(new_n118_));
  nand3  g100(.a(new_n118_), .b(new_n22_), .c(x2), .O(new_n119_));
  oai21  g101(.a(z8), .b(x2), .c(new_n119_), .O(z7));
  nand2  g102(.a(new_n31_), .b(new_n20_), .O(new_n121_));
  nand2  g103(.a(new_n121_), .b(x4), .O(new_n122_));
  aoi21  g104(.a(new_n122_), .b(new_n26_), .c(new_n19_), .O(z9));
endmodule
