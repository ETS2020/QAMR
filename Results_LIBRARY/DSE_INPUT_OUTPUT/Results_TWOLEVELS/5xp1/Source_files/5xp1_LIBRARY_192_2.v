...
module FAU ( 
  ...
  nand3  g20(.a(new_n28_), .b(x6), .c(new_n26_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x6), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(x5), .c(new_n18_), .d(new_n27_), .O(new_n40_));
  ...
  nand2  g56(.a(new_n34_), .b(x0), .O(new_n74_));
  aoi21  g57(.a(new_n74_), .b(new_n73_), .c(new_n70_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n72_), .c(x6), .O(new_n76_));
  aoi21  g59(.a(x6), .b(new_n18_), .c(new_n27_), .O(new_n77_));
  nor2   g60(.a(x6), .b(new_n70_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n77_), .c(x2), .O(new_n79_));
  nand3  g62(.a(new_n79_), .b(new_n76_), .c(new_n58_), .O(z4));
  nand3  g63(.a(new_n58_), .b(new_n70_), .c(x2), .O(new_n81_));
  nand4  g64(.a(x6), .b(x3), .c(new_n34_), .d(x1), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n27_), .O(new_n84_));
  nor2   g67(.a(new_n61_), .b(x1), .O(new_n85_));
  nand2  g68(.a(new_n70_), .b(new_n34_), .O(new_n86_));
  aoi21  g69(.a(new_n86_), .b(new_n28_), .c(new_n19_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n85_), .c(x0), .O(new_n88_));
  nand2  g71(.a(new_n88_), .b(new_n84_), .O(z5));
  nand2  g72(.a(x3), .b(new_n34_), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(x6), .c(x1), .O(new_n91_));
  nand3  g74(.a(x3), .b(new_n34_), .c(new_n18_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n91_), .O(z6));
  nor2   g76(.a(x2), .b(x0), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(x3), .c(new_n19_), .O(new_n95_));
  nand2  g78(.a(x6), .b(x0), .O(new_n96_));
  aoi21  g79(.a(new_n96_), .b(x1), .c(new_n70_), .O(new_n97_));
  aoi21  g80(.a(new_n97_), .b(new_n34_), .c(new_n61_), .O(new_n98_));
  oai21  g81(.a(new_n95_), .b(new_n18_), .c(new_n98_), .O(z7));
  aoi21  g82(.a(new_n19_), .b(x1), .c(x3), .O(z8));
  oai21  g83(.a(x6), .b(x0), .c(x5), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n26_), .c(new_n58_), .O(z9));
endmodule
