...
module FAU ( 
  ...
  nor2   g031(.a(x5), .b(new_n37_), .O(new_n49_));
  nand3  g032(.a(new_n49_), .b(x1), .c(x0), .O(new_n50_));
  aoi21  g033(.a(new_n50_), .b(new_n22_), .c(new_n23_), .O(new_n51_));
  oai21  g034(.a(new_n37_), .b(new_n24_), .c(new_n22_), .O(new_n52_));
  nand3  g035(.a(new_n52_), .b(x1), .c(x0), .O(new_n53_));
  oai21  g036(.a(new_n22_), .b(new_n37_), .c(new_n53_), .O(new_n54_));
  aoi21  g037(.a(new_n54_), .b(new_n18_), .c(new_n51_), .O(new_n55_));
  nand2  g038(.a(new_n55_), .b(new_n48_), .O(z1));
  inv1   g039(.a(x1), .O(new_n57_));
  oai21  g040(.a(new_n18_), .b(new_n19_), .c(new_n57_), .O(new_n58_));
  nand2  g041(.a(x5), .b(new_n19_), .O(new_n59_));
  nand2  g042(.a(new_n18_), .b(new_n24_), .O(new_n60_));
  nand2  g043(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g044(.a(new_n61_), .b(new_n23_), .O(new_n62_));
  oai21  g045(.a(new_n18_), .b(new_n24_), .c(new_n19_), .O(new_n63_));
  ...
  oai21  g056(.a(new_n72_), .b(new_n19_), .c(new_n73_), .O(new_n74_));
  nand2  g057(.a(new_n74_), .b(x4), .O(new_n75_));
  aoi21  g058(.a(x5), .b(x1), .c(x0), .O(new_n76_));
  oai21  g059(.a(new_n76_), .b(new_n72_), .c(new_n37_), .O(new_n77_));
  nand2  g060(.a(new_n77_), .b(new_n75_), .O(new_n78_));
  nand3  g061(.a(new_n78_), .b(x6), .c(new_n23_), .O(new_n79_));
  oai21  g062(.a(new_n71_), .b(x6), .c(new_n79_), .O(z2));
  inv1   g063(.a(new_n59_), .O(new_n81_));
  nor2   g064(.a(x5), .b(new_n19_), .O(new_n82_));
  oai21  g065(.a(new_n82_), .b(new_n81_), .c(new_n57_), .O(new_n83_));
  oai21  g066(.a(new_n60_), .b(new_n19_), .c(new_n59_), .O(new_n84_));
  nand3  g067(.a(new_n84_), .b(new_n22_), .c(new_n23_), .O(new_n85_));
  oai21  g068(.a(x6), .b(x3), .c(x0), .O(new_n86_));
  nand2  g069(.a(new_n24_), .b(x2), .O(new_n87_));
  aoi21  g070(.a(new_n87_), .b(new_n86_), .c(new_n18_), .O(new_n88_));
  nor3   g071(.a(new_n41_), .b(x5), .c(x0), .O(new_n89_));
  oai21  g072(.a(new_n89_), .b(new_n88_), .c(x1), .O(new_n90_));
  nor2   g073(.a(new_n22_), .b(new_n23_), .O(new_n91_));
  inv1   g074(.a(new_n91_), .O(new_n92_));
  nand4  g075(.a(new_n92_), .b(new_n90_), .c(new_n85_), .d(new_n83_), .O(z3));
  oai22  g076(.a(new_n22_), .b(new_n24_), .c(new_n23_), .d(x1), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(x0), .O(new_n95_));
  oai21  g078(.a(new_n28_), .b(x0), .c(new_n25_), .O(new_n96_));
  nand3  g079(.a(new_n96_), .b(new_n22_), .c(x1), .O(new_n97_));
  inv1   g080(.a(new_n41_), .O(new_n98_));
  aoi21  g081(.a(new_n98_), .b(new_n57_), .c(new_n91_), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(new_n97_), .c(new_n95_), .O(z4));
  nand2  g083(.a(x3), .b(new_n23_), .O(new_n101_));
  nand3  g084(.a(new_n22_), .b(new_n24_), .c(x2), .O(new_n102_));
  oai21  g085(.a(new_n101_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  nand2  g086(.a(new_n103_), .b(new_n19_), .O(new_n104_));
  oai21  g087(.a(new_n24_), .b(new_n57_), .c(new_n23_), .O(new_n105_));
  ...
  oai21  g092(.a(new_n49_), .b(new_n45_), .c(x0), .O(new_n110_));
  nor2   g093(.a(x6), .b(new_n18_), .O(new_n111_));
  nor2   g094(.a(x5), .b(x0), .O(new_n112_));
  oai21  g095(.a(new_n112_), .b(new_n111_), .c(x3), .O(new_n113_));
  aoi21  g096(.a(new_n113_), .b(new_n110_), .c(new_n23_), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n24_), .c(x1), .O(new_n115_));
  inv1   g098(.a(new_n101_), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n57_), .c(new_n91_), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n115_), .O(z6));
  nand2  g101(.a(new_n102_), .b(new_n101_), .O(z7));
  nand2  g102(.a(new_n92_), .b(x3), .O(z8));
  aoi21  g103(.a(new_n29_), .b(new_n19_), .c(x6), .O(new_n121_));
  nor2   g104(.a(new_n22_), .b(x2), .O(new_n122_));
  oai21  g105(.a(new_n122_), .b(new_n121_), .c(x5), .O(new_n123_));
  nor2   g106(.a(new_n123_), .b(new_n37_), .O(z9));
endmodule
