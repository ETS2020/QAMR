...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n101_, new_n102_, new_n105_, new_n107_, new_n108_;
  ...
  aoi21  g63(.a(new_n80_), .b(new_n28_), .c(new_n37_), .O(new_n81_));
  nand2  g64(.a(new_n40_), .b(x1), .O(new_n82_));
  oai21  g65(.a(new_n81_), .b(x1), .c(new_n82_), .O(new_n83_));
  oai21  g66(.a(new_n83_), .b(new_n79_), .c(x6), .O(new_n84_));
  xor2a  g67(.a(new_n23_), .b(new_n22_), .O(new_n85_));
  nand3  g68(.a(new_n85_), .b(new_n29_), .c(new_n28_), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n84_), .O(z4));
  nand2  g70(.a(new_n80_), .b(x2), .O(new_n88_));
  ...
  oai21  g77(.a(x6), .b(x4), .c(x5), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n28_), .O(new_n96_));
  aoi21  g79(.a(x5), .b(x4), .c(x6), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(x2), .c(new_n80_), .O(new_n99_));
  inv1   g82(.a(new_n78_), .O(new_n100_));
  nor2   g83(.a(x6), .b(new_n28_), .O(new_n101_));
  aoi21  g84(.a(new_n100_), .b(new_n22_), .c(new_n101_), .O(new_n102_));
  oai21  g85(.a(new_n99_), .b(new_n22_), .c(new_n102_), .O(z6));
  aoi22  g86(.a(new_n88_), .b(new_n78_), .c(new_n29_), .d(x0), .O(z7));
  inv1   g87(.a(new_n101_), .O(new_n105_));
  nand2  g88(.a(new_n105_), .b(x3), .O(z8));
  nand2  g89(.a(new_n82_), .b(new_n29_), .O(new_n107_));
