...
module FAU ( 
  ...
  nand2  g054(.a(new_n22_), .b(x2), .O(new_n72_));
  nand2  g055(.a(x3), .b(x0), .O(new_n73_));
  nand2  g056(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  aoi21  g057(.a(new_n74_), .b(x1), .c(new_n71_), .O(new_n75_));
  nand3  g058(.a(new_n24_), .b(new_n19_), .c(x0), .O(new_n76_));
  ...
  aoi21  g062(.a(new_n79_), .b(new_n26_), .c(new_n38_), .O(new_n80_));
  ...
  oai21  g066(.a(new_n65_), .b(new_n20_), .c(new_n83_), .O(new_n84_));
  ...
  oai21  g070(.a(new_n23_), .b(new_n20_), .c(new_n87_), .O(new_n88_));
  aoi21  g071(.a(new_n59_), .b(new_n79_), .c(new_n26_), .O(new_n89_));
  aoi22  g072(.a(new_n89_), .b(new_n19_), .c(new_n88_), .d(new_n26_), .O(new_n90_));
  ...
  nand2  g078(.a(new_n95_), .b(new_n38_), .O(new_n96_));
  oai21  g079(.a(new_n90_), .b(new_n38_), .c(new_n96_), .O(z4));
  nor2   g080(.a(new_n26_), .b(new_n19_), .O(new_n98_));
  nand2  g081(.a(new_n38_), .b(x0), .O(new_n99_));
  nand3  g082(.a(x3), .b(x1), .c(new_n20_), .O(new_n100_));
  aoi21  g083(.a(new_n100_), .b(new_n99_), .c(new_n98_), .O(new_n101_));
  nand2  g084(.a(x6), .b(x5), .O(new_n102_));
  nand4  g085(.a(new_n102_), .b(new_n22_), .c(x1), .d(x0), .O(new_n103_));
  inv1   g086(.a(new_n103_), .O(new_n104_));
  oai21  g087(.a(new_n104_), .b(new_n101_), .c(new_n21_), .O(new_n105_));
  nand3  g088(.a(new_n102_), .b(x3), .c(x0), .O(new_n106_));
  nand2  g089(.a(x6), .b(x5), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n22_), .c(new_n20_), .O(new_n108_));
  nand2  g091(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(x2), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(new_n105_), .O(z5));
  nor2   g094(.a(x6), .b(x4), .O(new_n112_));
  nor2   g095(.a(x5), .b(new_n18_), .O(new_n113_));
  oai21  g096(.a(new_n113_), .b(new_n112_), .c(x0), .O(new_n114_));
  aoi21  g097(.a(new_n26_), .b(x0), .c(x5), .O(new_n115_));
  oai21  g098(.a(new_n115_), .b(new_n34_), .c(x3), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n114_), .c(new_n21_), .O(new_n117_));
  oai21  g100(.a(new_n117_), .b(new_n22_), .c(x1), .O(new_n118_));
  nor2   g101(.a(new_n22_), .b(x2), .O(new_n119_));
  aoi21  g102(.a(new_n119_), .b(new_n38_), .c(new_n98_), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(new_n118_), .O(z6));
  inv1   g104(.a(new_n119_), .O(new_n122_));
  inv1   g105(.a(new_n98_), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(new_n122_), .c(new_n72_), .O(z7));
  nand3  g107(.a(new_n26_), .b(x2), .c(x0), .O(new_n125_));
  nand2  g108(.a(new_n125_), .b(new_n19_), .O(new_n126_));
  aoi21  g109(.a(new_n126_), .b(x6), .c(x3), .O(z8));
  nand4  g110(.a(new_n40_), .b(new_n26_), .c(x5), .d(x4), .O(new_n128_));
