...
module FAU ( 
  ...
  nand2  g011(.a(new_n20_), .b(new_n28_), .O(new_n29_));
  ...
  nand2  g015(.a(new_n32_), .b(new_n21_), .O(new_n33_));
  ...
  nand4  g024(.a(x6), .b(new_n18_), .c(x3), .d(new_n28_), .O(new_n42_));
  ...
  aoi21  g035(.a(new_n52_), .b(new_n30_), .c(new_n28_), .O(new_n53_));
  ...
  nand4  g054(.a(x5), .b(x3), .c(new_n28_), .d(new_n26_), .O(new_n72_));
  ...
  nand2  g066(.a(new_n29_), .b(x1), .O(new_n84_));
  nand3  g067(.a(new_n84_), .b(new_n19_), .c(x0), .O(new_n85_));
  inv1   g068(.a(new_n85_), .O(new_n86_));
  nand2  g069(.a(new_n32_), .b(new_n25_), .O(new_n87_));
  nand3  g070(.a(new_n20_), .b(x2), .c(x1), .O(new_n88_));
  aoi21  g071(.a(new_n88_), .b(new_n87_), .c(new_n19_), .O(new_n89_));
  oai21  g072(.a(new_n89_), .b(new_n86_), .c(new_n21_), .O(new_n90_));
  nand2  g073(.a(x6), .b(x2), .O(new_n91_));
  aoi21  g074(.a(new_n91_), .b(new_n26_), .c(new_n25_), .O(new_n92_));
  nand4  g075(.a(x6), .b(new_n28_), .c(new_n26_), .d(new_n25_), .O(new_n93_));
  inv1   g076(.a(new_n93_), .O(new_n94_));
  oai21  g077(.a(new_n94_), .b(new_n92_), .c(x5), .O(new_n95_));
  oai21  g078(.a(x6), .b(x2), .c(x1), .O(new_n96_));
  aoi21  g079(.a(new_n96_), .b(new_n91_), .c(x0), .O(new_n97_));
  nand2  g080(.a(new_n36_), .b(x0), .O(new_n98_));
  inv1   g081(.a(new_n98_), .O(new_n99_));
  oai21  g082(.a(new_n99_), .b(new_n97_), .c(new_n19_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(new_n95_), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(x3), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n90_), .O(z3));
  oai22  g086(.a(new_n30_), .b(x2), .c(new_n22_), .d(x1), .O(new_n104_));
  nand2  g087(.a(new_n104_), .b(x0), .O(new_n105_));
  nand2  g088(.a(new_n45_), .b(new_n25_), .O(new_n106_));
  aoi21  g089(.a(new_n106_), .b(new_n29_), .c(x6), .O(new_n107_));
  nand3  g090(.a(x6), .b(x3), .c(x2), .O(new_n108_));
  inv1   g091(.a(new_n108_), .O(new_n109_));
  oai21  g092(.a(new_n109_), .b(new_n107_), .c(x1), .O(new_n110_));
  nand2  g093(.a(x6), .b(new_n28_), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n22_), .O(new_n112_));
  nand3  g095(.a(new_n112_), .b(x3), .c(new_n26_), .O(new_n113_));
  nand3  g096(.a(new_n113_), .b(new_n110_), .c(new_n105_), .O(z4));
  nor2   g097(.a(new_n20_), .b(x2), .O(new_n115_));
  ...
  inv1   g102(.a(new_n29_), .O(new_n120_));
  aoi21  g103(.a(new_n28_), .b(x1), .c(new_n20_), .O(new_n121_));
  oai21  g104(.a(new_n121_), .b(new_n120_), .c(x0), .O(new_n122_));
  nor2   g105(.a(new_n21_), .b(x3), .O(new_n123_));
  inv1   g106(.a(new_n123_), .O(new_n124_));
  nand3  g107(.a(new_n124_), .b(new_n122_), .c(new_n119_), .O(z5));
  aoi21  g108(.a(x5), .b(x4), .c(new_n25_), .O(new_n126_));
  aoi21  g109(.a(x4), .b(x3), .c(new_n19_), .O(new_n127_));
  oai21  g110(.a(new_n127_), .b(new_n126_), .c(new_n21_), .O(new_n128_));
  nand2  g111(.a(new_n19_), .b(new_n25_), .O(new_n129_));
  nand2  g112(.a(x5), .b(x4), .O(new_n130_));
  nand3  g113(.a(new_n130_), .b(new_n129_), .c(new_n21_), .O(new_n131_));
  nand2  g114(.a(new_n131_), .b(x3), .O(new_n132_));
  aoi21  g115(.a(new_n132_), .b(new_n128_), .c(new_n28_), .O(new_n133_));
  nand2  g116(.a(x2), .b(x0), .O(new_n134_));
  nand3  g117(.a(new_n134_), .b(new_n21_), .c(new_n20_), .O(new_n135_));
  inv1   g118(.a(new_n135_), .O(new_n136_));
  oai21  g119(.a(new_n136_), .b(new_n133_), .c(x1), .O(new_n137_));
  aoi21  g120(.a(new_n115_), .b(new_n26_), .c(new_n123_), .O(new_n138_));
  nand2  g121(.a(new_n138_), .b(new_n137_), .O(z6));
  nor2   g122(.a(x6), .b(x3), .O(z8));
  nand2  g123(.a(z8), .b(x2), .O(new_n141_));
  nand2  g124(.a(new_n141_), .b(new_n116_), .O(z7));
  nand2  g125(.a(new_n46_), .b(x1), .O(new_n143_));
  nand2  g126(.a(new_n26_), .b(new_n25_), .O(new_n144_));
  oai21  g127(.a(new_n144_), .b(new_n20_), .c(new_n28_), .O(new_n145_));
  nand2  g128(.a(new_n145_), .b(x6), .O(new_n146_));
  nand3  g129(.a(new_n146_), .b(new_n143_), .c(new_n25_), .O(new_n147_));
  nand3  g130(.a(new_n147_), .b(x5), .c(x4), .O(new_n148_));
  nand2  g131(.a(new_n148_), .b(new_n124_), .O(z9));
endmodule
