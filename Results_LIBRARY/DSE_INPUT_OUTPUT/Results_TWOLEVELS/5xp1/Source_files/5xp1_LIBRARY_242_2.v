...
module FAU ( 
  ...
  aoi21  g40(.a(new_n19_), .b(new_n21_), .c(new_n24_), .O(new_n58_));
  nand3  g41(.a(new_n19_), .b(new_n21_), .c(new_n36_), .O(new_n59_));
  ...
  nand2  g59(.a(new_n70_), .b(new_n22_), .O(new_n77_));
  ...
  aoi22  g68(.a(new_n85_), .b(new_n22_), .c(new_n70_), .d(new_n36_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n23_), .c(new_n21_), .O(new_n87_));
  ...
  aoi21  g90(.a(new_n81_), .b(new_n23_), .c(new_n97_), .O(new_n108_));
