...
module FAU ( 
  ...
  oai21  g045(.a(new_n18_), .b(x2), .c(new_n20_), .O(new_n63_));
  nand2  g046(.a(new_n63_), .b(x0), .O(new_n64_));
  nor2   g047(.a(x6), .b(x3), .O(new_n65_));
  nand2  g048(.a(new_n65_), .b(x2), .O(new_n66_));
  aoi21  g049(.a(new_n66_), .b(new_n64_), .c(new_n32_), .O(new_n67_));
  nand4  g050(.a(new_n32_), .b(x3), .c(x2), .d(new_n19_), .O(new_n68_));
  inv1   g051(.a(new_n68_), .O(new_n69_));
  oai21  g052(.a(new_n69_), .b(new_n67_), .c(x1), .O(new_n70_));
  nand3  g053(.a(new_n32_), .b(new_n33_), .c(x0), .O(new_n71_));
  nor2   g054(.a(new_n18_), .b(new_n32_), .O(new_n72_));
  nand3  g055(.a(new_n72_), .b(new_n27_), .c(new_n19_), .O(new_n73_));
  aoi21  g056(.a(new_n73_), .b(new_n71_), .c(x3), .O(new_n74_));
  nand2  g057(.a(x6), .b(x2), .O(new_n75_));
  oai21  g058(.a(x5), .b(x1), .c(new_n75_), .O(new_n76_));
  nand2  g059(.a(new_n76_), .b(x0), .O(new_n77_));
  nand2  g060(.a(new_n75_), .b(new_n27_), .O(new_n78_));
  nand2  g061(.a(new_n18_), .b(new_n33_), .O(new_n79_));
  nand2  g062(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand3  g063(.a(new_n80_), .b(x5), .c(new_n19_), .O(new_n81_));
  nand2  g064(.a(x6), .b(new_n32_), .O(new_n82_));
  nand3  g065(.a(new_n82_), .b(new_n81_), .c(new_n77_), .O(new_n83_));
  nor2   g066(.a(new_n83_), .b(new_n74_), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(new_n70_), .O(z3));
  nand2  g068(.a(new_n72_), .b(x2), .O(new_n86_));
  nand2  g069(.a(new_n65_), .b(new_n33_), .O(new_n87_));
  aoi21  g070(.a(new_n87_), .b(new_n86_), .c(new_n19_), .O(new_n88_));
  inv1   g071(.a(new_n72_), .O(new_n89_));
  nand2  g072(.a(x3), .b(x2), .O(new_n90_));
  nand3  g073(.a(new_n90_), .b(new_n18_), .c(new_n19_), .O(new_n91_));
  oai21  g074(.a(new_n89_), .b(new_n28_), .c(new_n91_), .O(new_n92_));
  oai21  g075(.a(new_n92_), .b(new_n88_), .c(x1), .O(new_n93_));
  nand2  g076(.a(x3), .b(new_n33_), .O(new_n94_));
  nand3  g077(.a(new_n18_), .b(x2), .c(new_n27_), .O(new_n95_));
  oai21  g078(.a(new_n94_), .b(new_n89_), .c(new_n95_), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(x0), .O(new_n97_));
  oai21  g080(.a(x3), .b(x0), .c(x2), .O(new_n98_));
  nand3  g081(.a(new_n98_), .b(x6), .c(x5), .O(new_n99_));
  nand3  g082(.a(new_n18_), .b(x3), .c(x2), .O(new_n100_));
  ...
  nand2  g086(.a(new_n33_), .b(new_n27_), .O(new_n104_));
  aoi21  g087(.a(new_n104_), .b(new_n28_), .c(new_n19_), .O(new_n105_));
  nand3  g088(.a(x3), .b(new_n33_), .c(x1), .O(new_n106_));
  nand2  g089(.a(new_n20_), .b(x2), .O(new_n107_));
  aoi21  g090(.a(new_n107_), .b(new_n106_), .c(x0), .O(new_n108_));
  oai21  g091(.a(new_n108_), .b(new_n105_), .c(new_n82_), .O(new_n109_));
  aoi21  g092(.a(x6), .b(new_n32_), .c(x3), .O(new_n110_));
  nand4  g093(.a(new_n110_), .b(new_n33_), .c(x1), .d(x0), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n109_), .O(z5));
  nand3  g095(.a(new_n82_), .b(x3), .c(new_n27_), .O(new_n113_));
  nand3  g096(.a(new_n65_), .b(x1), .c(x0), .O(new_n114_));
  nand2  g097(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g098(.a(new_n115_), .b(new_n33_), .O(new_n116_));
  aoi21  g099(.a(x5), .b(x3), .c(new_n18_), .O(new_n117_));
  nor2   g100(.a(new_n117_), .b(new_n33_), .O(new_n118_));
  nand2  g101(.a(new_n18_), .b(new_n19_), .O(new_n119_));
  aoi21  g102(.a(new_n119_), .b(new_n32_), .c(x3), .O(new_n120_));
  oai21  g103(.a(new_n120_), .b(new_n118_), .c(x1), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(new_n116_), .O(z6));
  nand3  g105(.a(new_n107_), .b(new_n94_), .c(new_n82_), .O(z7));
  aoi21  g106(.a(x6), .b(new_n32_), .c(x3), .O(z8));
  nand3  g107(.a(x3), .b(x2), .c(x1), .O(new_n125_));
  aoi21  g108(.a(new_n125_), .b(new_n19_), .c(new_n32_), .O(new_n126_));
  oai21  g109(.a(new_n126_), .b(x6), .c(x4), .O(new_n127_));
  nand2  g110(.a(new_n127_), .b(new_n82_), .O(z9));
endmodule
