...
module FAU ( 
  ...
  inv1   g76(.a(new_n32_), .O(new_n94_));
  aoi21  g77(.a(new_n30_), .b(x1), .c(new_n31_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n94_), .c(x0), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n93_), .c(new_n74_), .O(z5));
  oai22  g80(.a(new_n29_), .b(new_n25_), .c(x3), .d(x0), .O(new_n98_));
  nand2  g81(.a(new_n18_), .b(new_n25_), .O(new_n99_));
  nand3  g82(.a(new_n99_), .b(x5), .c(x3), .O(new_n100_));
  oai21  g83(.a(new_n98_), .b(x6), .c(new_n100_), .O(new_n101_));
  oai21  g84(.a(new_n30_), .b(new_n19_), .c(new_n18_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(new_n29_), .c(x3), .O(new_n103_));
  aoi21  g86(.a(new_n101_), .b(x2), .c(new_n103_), .O(new_n104_));
  nand4  g87(.a(new_n74_), .b(x3), .c(new_n30_), .d(new_n20_), .O(new_n105_));
  oai21  g88(.a(new_n104_), .b(new_n20_), .c(new_n105_), .O(z6));
  nand3  g89(.a(new_n91_), .b(new_n90_), .c(new_n74_), .O(z7));
  aoi21  g90(.a(x6), .b(new_n29_), .c(x3), .O(z8));
  nand2  g91(.a(new_n34_), .b(x1), .O(new_n109_));
  nand3  g92(.a(new_n109_), .b(new_n18_), .c(new_n19_), .O(new_n110_));
