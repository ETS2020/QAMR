...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n113_, new_n117_, new_n118_, new_n119_, new_n120_;
  ...
  nand2  g010(.a(x5), .b(x0), .O(new_n28_));
  nand3  g011(.a(new_n28_), .b(new_n19_), .c(x4), .O(new_n29_));
  inv1   g012(.a(new_n29_), .O(new_n30_));
  oai21  g013(.a(new_n30_), .b(new_n27_), .c(new_n18_), .O(new_n31_));
  nand2  g014(.a(new_n22_), .b(new_n19_), .O(new_n32_));
  aoi21  g015(.a(new_n32_), .b(x5), .c(new_n20_), .O(new_n33_));
  nand4  g016(.a(x6), .b(x5), .c(new_n20_), .d(x1), .O(new_n34_));
  inv1   g017(.a(new_n34_), .O(new_n35_));
  oai21  g018(.a(new_n35_), .b(new_n33_), .c(new_n21_), .O(new_n36_));
  nand2  g019(.a(new_n36_), .b(new_n31_), .O(z0));
  nand3  g020(.a(x6), .b(new_n25_), .c(x2), .O(new_n38_));
  nand3  g021(.a(new_n19_), .b(x5), .c(new_n20_), .O(new_n39_));
  nand2  g022(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand2  g023(.a(new_n40_), .b(x0), .O(new_n41_));
  nand3  g024(.a(new_n22_), .b(x6), .c(new_n20_), .O(new_n42_));
  ...
  nand3  g028(.a(new_n45_), .b(new_n44_), .c(new_n41_), .O(new_n46_));
  ...
  nand2  g040(.a(x2), .b(new_n21_), .O(new_n58_));
  nand3  g041(.a(new_n19_), .b(new_n20_), .c(x3), .O(new_n59_));
  oai21  g042(.a(new_n59_), .b(new_n58_), .c(new_n54_), .O(new_n60_));
  nand2  g043(.a(new_n60_), .b(x1), .O(new_n61_));
  nand4  g044(.a(new_n22_), .b(new_n20_), .c(new_n18_), .d(new_n21_), .O(new_n62_));
  nand3  g045(.a(x4), .b(x3), .c(x2), .O(new_n63_));
  ...
  oai21  g051(.a(new_n26_), .b(new_n68_), .c(new_n18_), .O(new_n69_));
  nand2  g052(.a(new_n69_), .b(x0), .O(new_n70_));
  nand2  g053(.a(new_n28_), .b(new_n18_), .O(new_n71_));
  ...
  nand3  g057(.a(new_n74_), .b(new_n19_), .c(x4), .O(new_n75_));
  nand2  g058(.a(x2), .b(x0), .O(new_n76_));
  nand4  g059(.a(new_n76_), .b(x6), .c(new_n25_), .d(new_n20_), .O(new_n77_));
  nand3  g060(.a(new_n77_), .b(new_n75_), .c(new_n70_), .O(new_n78_));
  inv1   g061(.a(new_n78_), .O(new_n79_));
  nand2  g062(.a(new_n79_), .b(new_n67_), .O(z2));
  nand2  g063(.a(new_n32_), .b(x1), .O(new_n81_));
  ...
  aoi21  g068(.a(new_n85_), .b(new_n32_), .c(new_n25_), .O(new_n86_));
  aoi21  g069(.a(new_n83_), .b(new_n25_), .c(new_n86_), .O(new_n87_));
  nand2  g070(.a(x3), .b(new_n21_), .O(new_n88_));
  nand4  g071(.a(new_n88_), .b(x6), .c(x5), .d(x2), .O(new_n89_));
  nand3  g072(.a(new_n84_), .b(new_n25_), .c(x0), .O(new_n90_));
  nand2  g073(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g074(.a(new_n91_), .b(new_n18_), .O(new_n92_));
  oai21  g075(.a(new_n87_), .b(x0), .c(new_n92_), .O(z3));
  oai21  g076(.a(x6), .b(new_n68_), .c(new_n18_), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(x0), .O(new_n95_));
  nand3  g078(.a(x3), .b(x2), .c(x1), .O(new_n96_));
  inv1   g079(.a(x3), .O(new_n97_));
  nand2  g080(.a(new_n97_), .b(new_n18_), .O(new_n98_));
  aoi21  g081(.a(new_n98_), .b(new_n96_), .c(x0), .O(new_n99_));
  nor2   g082(.a(x2), .b(x1), .O(new_n100_));
  oai21  g083(.a(new_n100_), .b(new_n99_), .c(x6), .O(new_n101_));
  xor2a  g084(.a(new_n22_), .b(new_n18_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n19_), .O(new_n103_));
  nand3  g086(.a(new_n103_), .b(new_n101_), .c(new_n95_), .O(z4));
  nand2  g087(.a(x3), .b(new_n68_), .O(new_n105_));
  nand2  g088(.a(new_n97_), .b(x2), .O(new_n106_));
  oai21  g089(.a(new_n105_), .b(new_n18_), .c(new_n106_), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(new_n21_), .O(new_n108_));
  nand3  g091(.a(new_n97_), .b(x2), .c(new_n18_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(x0), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(new_n108_), .O(z5));
  nand2  g094(.a(x3), .b(new_n68_), .O(new_n112_));
  nand3  g095(.a(new_n112_), .b(x1), .c(new_n21_), .O(new_n113_));
  oai21  g096(.a(new_n105_), .b(x1), .c(new_n113_), .O(z6));
  aoi22  g097(.a(new_n106_), .b(new_n105_), .c(x1), .d(x0), .O(z7));
  aoi21  g098(.a(x1), .b(x0), .c(x3), .O(z8));
  aoi21  g099(.a(x5), .b(x4), .c(x1), .O(new_n117_));
  nand2  g100(.a(x1), .b(new_n21_), .O(new_n118_));
  oai21  g101(.a(new_n118_), .b(new_n22_), .c(new_n19_), .O(new_n119_));
  nand3  g102(.a(new_n119_), .b(x5), .c(x4), .O(new_n120_));
  oai21  g103(.a(new_n117_), .b(new_n21_), .c(new_n120_), .O(z9));
endmodule
