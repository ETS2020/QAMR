...
module FAU ( 
  ...
  nand4  g061(.a(x6), .b(new_n21_), .c(x2), .d(new_n61_), .O(new_n79_));
  ...
  nand2  g067(.a(new_n83_), .b(new_n41_), .O(new_n85_));
  nand3  g068(.a(new_n22_), .b(new_n47_), .c(new_n46_), .O(new_n86_));
  aoi21  g069(.a(new_n86_), .b(new_n85_), .c(x5), .O(new_n87_));
  oai21  g070(.a(new_n87_), .b(new_n84_), .c(x0), .O(new_n88_));
  nand3  g071(.a(new_n42_), .b(x5), .c(new_n41_), .O(new_n89_));
  oai21  g072(.a(x5), .b(new_n41_), .c(new_n89_), .O(new_n90_));
  nand3  g073(.a(new_n90_), .b(x6), .c(new_n61_), .O(new_n91_));
  nand3  g074(.a(new_n91_), .b(new_n88_), .c(new_n81_), .O(z3));
  oai21  g075(.a(x3), .b(x1), .c(x6), .O(new_n93_));
  nand2  g076(.a(new_n93_), .b(new_n61_), .O(new_n94_));
  xor2a  g077(.a(x6), .b(x2), .O(new_n95_));
  nand2  g078(.a(new_n95_), .b(new_n41_), .O(new_n96_));
  aoi21  g079(.a(new_n86_), .b(new_n83_), .c(new_n61_), .O(new_n97_));
  nor2   g080(.a(new_n22_), .b(new_n47_), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(x2), .O(new_n99_));
  inv1   g082(.a(new_n99_), .O(new_n100_));
  oai21  g083(.a(new_n100_), .b(new_n97_), .c(x1), .O(new_n101_));
  nand3  g084(.a(new_n98_), .b(new_n46_), .c(x0), .O(new_n102_));
  ...
  aoi21  g088(.a(x3), .b(x1), .c(new_n61_), .O(new_n106_));
  nor3   g089(.a(new_n47_), .b(new_n41_), .c(x0), .O(new_n107_));
  oai21  g090(.a(new_n107_), .b(new_n106_), .c(new_n46_), .O(new_n108_));
  nand2  g091(.a(new_n22_), .b(new_n61_), .O(new_n109_));
  nand3  g092(.a(new_n109_), .b(new_n108_), .c(new_n105_), .O(z5));
  nand2  g093(.a(x3), .b(new_n41_), .O(new_n111_));
  nand3  g094(.a(new_n22_), .b(new_n47_), .c(x1), .O(new_n112_));
  aoi21  g095(.a(new_n112_), .b(new_n111_), .c(new_n61_), .O(new_n113_));
  inv1   g096(.a(new_n98_), .O(new_n114_));
  nor2   g097(.a(new_n114_), .b(x1), .O(new_n115_));
  oai21  g098(.a(new_n115_), .b(new_n113_), .c(new_n46_), .O(new_n116_));
  aoi21  g099(.a(new_n114_), .b(new_n61_), .c(new_n46_), .O(new_n117_));
  nor2   g100(.a(new_n22_), .b(x3), .O(new_n118_));
  oai21  g101(.a(new_n118_), .b(new_n117_), .c(x1), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(new_n116_), .O(z6));
  nand2  g103(.a(new_n47_), .b(x2), .O(new_n121_));
  nand2  g104(.a(x3), .b(new_n46_), .O(new_n122_));
  nand3  g105(.a(new_n122_), .b(new_n121_), .c(new_n109_), .O(z7));
  nand2  g106(.a(x6), .b(x1), .O(new_n124_));
  nand3  g107(.a(new_n124_), .b(new_n46_), .c(new_n61_), .O(new_n125_));
  nand2  g108(.a(new_n125_), .b(new_n47_), .O(new_n126_));
  nand2  g109(.a(new_n126_), .b(new_n94_), .O(z8));
  oai21  g110(.a(new_n21_), .b(new_n18_), .c(new_n109_), .O(z9));
endmodule
