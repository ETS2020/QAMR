...
module FAU ( 
  ...
  or2    g23(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n38_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x1), .O(new_n43_));
  oai21  g26(.a(new_n19_), .b(x5), .c(new_n40_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x0), .O(new_n45_));
  nand4  g28(.a(new_n39_), .b(new_n19_), .c(x5), .d(new_n20_), .O(new_n46_));
  nand4  g29(.a(new_n46_), .b(new_n45_), .c(new_n43_), .d(new_n36_), .O(z1));
  ...
  nand2  g57(.a(new_n39_), .b(new_n20_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(new_n60_), .c(x6), .O(new_n76_));
  nand3  g59(.a(x6), .b(x3), .c(x0), .O(new_n77_));
  inv1   g60(.a(new_n77_), .O(new_n78_));
  oai21  g61(.a(new_n78_), .b(new_n76_), .c(x1), .O(new_n79_));
  aoi22  g62(.a(new_n19_), .b(x1), .c(new_n27_), .d(new_n20_), .O(new_n80_));
  aoi22  g63(.a(new_n80_), .b(x2), .c(x6), .d(new_n21_), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n79_), .O(z4));
  nand2  g65(.a(new_n27_), .b(x2), .O(new_n83_));
  nand2  g66(.a(x3), .b(new_n24_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n21_), .c(new_n83_), .O(new_n85_));
  nand2  g68(.a(new_n85_), .b(new_n20_), .O(new_n86_));
  oai21  g69(.a(x2), .b(new_n20_), .c(new_n19_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n21_), .O(new_n88_));
  nand2  g71(.a(new_n39_), .b(new_n60_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x0), .O(new_n90_));
  nand3  g73(.a(new_n90_), .b(new_n88_), .c(new_n86_), .O(z5));
  nand2  g74(.a(new_n84_), .b(x1), .O(new_n92_));
  nand4  g75(.a(new_n19_), .b(x3), .c(new_n24_), .d(new_n21_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n92_), .O(z6));
  aoi22  g77(.a(new_n84_), .b(new_n83_), .c(x6), .d(new_n21_), .O(z7));
  aoi21  g78(.a(x6), .b(new_n21_), .c(x3), .O(z8));
  nand2  g79(.a(new_n70_), .b(x1), .O(new_n97_));
  oai21  g80(.a(x6), .b(new_n20_), .c(new_n97_), .O(new_n98_));
