...
module FAU ( 
  ...
  nand3  g41(.a(new_n22_), .b(x3), .c(new_n20_), .O(new_n59_));
  inv1   g42(.a(x3), .O(new_n60_));
  nand3  g43(.a(new_n19_), .b(x5), .c(new_n60_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n59_), .c(new_n24_), .O(new_n62_));
  nand3  g45(.a(x6), .b(new_n22_), .c(new_n20_), .O(new_n63_));
  oai21  g46(.a(new_n27_), .b(new_n20_), .c(new_n63_), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n62_), .c(x1), .O(new_n65_));
  nand2  g48(.a(x2), .b(x1), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n19_), .c(new_n20_), .O(new_n67_));
  oai21  g50(.a(new_n19_), .b(new_n20_), .c(new_n67_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(x5), .O(new_n69_));
  nand3  g52(.a(new_n19_), .b(new_n60_), .c(new_n24_), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(x1), .c(x5), .O(new_n71_));
  aoi22  g54(.a(new_n71_), .b(x0), .c(x6), .d(new_n21_), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n69_), .c(new_n65_), .O(z3));
  aoi21  g56(.a(new_n42_), .b(new_n30_), .c(new_n19_), .O(new_n74_));
  nand2  g57(.a(new_n60_), .b(new_n24_), .O(new_n75_));
  nand2  g58(.a(new_n42_), .b(new_n20_), .O(new_n76_));
  aoi21  g59(.a(new_n76_), .b(new_n75_), .c(x6), .O(new_n77_));
  oai21  g60(.a(new_n77_), .b(new_n74_), .c(x1), .O(new_n78_));
  nand2  g61(.a(new_n60_), .b(new_n20_), .O(new_n79_));
  nand4  g62(.a(new_n79_), .b(new_n19_), .c(x2), .d(new_n21_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n78_), .O(z4));
  aoi21  g64(.a(new_n42_), .b(new_n75_), .c(new_n20_), .O(new_n82_));
  nor2   g65(.a(new_n60_), .b(x2), .O(new_n83_));
  nor2   g66(.a(x3), .b(new_n24_), .O(new_n84_));
  nor2   g67(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  nor2   g68(.a(new_n85_), .b(x0), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n82_), .c(x1), .O(new_n87_));
  nand2  g70(.a(x3), .b(new_n21_), .O(new_n88_));
  aoi21  g71(.a(new_n88_), .b(new_n75_), .c(new_n20_), .O(new_n89_));
  nand2  g72(.a(new_n84_), .b(new_n20_), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n89_), .c(new_n19_), .O(new_n92_));
  ...
  aoi21  g78(.a(new_n95_), .b(x2), .c(new_n60_), .O(new_n96_));
  nand4  g79(.a(new_n19_), .b(x3), .c(new_n24_), .d(new_n21_), .O(new_n97_));
  oai21  g80(.a(new_n96_), .b(new_n21_), .c(new_n97_), .O(z6));
  oai21  g81(.a(new_n84_), .b(new_n83_), .c(x1), .O(new_n99_));
  inv1   g82(.a(new_n83_), .O(new_n100_));
  nand2  g83(.a(new_n84_), .b(x0), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n100_), .c(x1), .O(new_n102_));
  oai21  g85(.a(new_n102_), .b(new_n91_), .c(new_n19_), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n99_), .O(z7));
  oai21  g87(.a(new_n19_), .b(x1), .c(x3), .O(z8));
  aoi21  g88(.a(x3), .b(x2), .c(x6), .O(new_n106_));
  oai22  g89(.a(new_n106_), .b(new_n21_), .c(x6), .d(new_n20_), .O(new_n107_));
