...
module FAU ( 
  ...
  nand4  g027(.a(new_n39_), .b(new_n19_), .c(x5), .d(new_n20_), .O(new_n45_));
  inv1   g028(.a(new_n45_), .O(new_n46_));
  aoi21  g029(.a(new_n44_), .b(x0), .c(new_n46_), .O(new_n47_));
  nand3  g030(.a(new_n47_), .b(new_n43_), .c(new_n36_), .O(z1));
  nand2  g031(.a(new_n29_), .b(x4), .O(new_n49_));
  nor2   g032(.a(new_n22_), .b(new_n20_), .O(new_n50_));
  nand3  g033(.a(x5), .b(x3), .c(x2), .O(new_n51_));
  aoi21  g034(.a(new_n51_), .b(new_n30_), .c(new_n21_), .O(new_n52_));
  ...
  oai21  g038(.a(x5), .b(x0), .c(x4), .O(new_n56_));
  nand3  g039(.a(new_n22_), .b(new_n18_), .c(new_n20_), .O(new_n57_));
  nand2  g040(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand3  g041(.a(new_n58_), .b(x6), .c(x1), .O(new_n59_));
  nand2  g042(.a(new_n59_), .b(new_n55_), .O(z2));
  nand2  g043(.a(new_n27_), .b(new_n24_), .O(new_n61_));
  nand2  g044(.a(new_n61_), .b(x1), .O(new_n62_));
  nand3  g045(.a(new_n62_), .b(new_n22_), .c(x0), .O(new_n63_));
  inv1   g046(.a(new_n63_), .O(new_n64_));
  oai21  g047(.a(new_n24_), .b(new_n21_), .c(new_n20_), .O(new_n65_));
  nor2   g048(.a(x3), .b(new_n24_), .O(new_n66_));
  nand2  g049(.a(new_n66_), .b(x1), .O(new_n67_));
  aoi21  g050(.a(new_n67_), .b(new_n65_), .c(new_n22_), .O(new_n68_));
  oai21  g051(.a(new_n68_), .b(new_n64_), .c(new_n19_), .O(new_n69_));
  nand2  g052(.a(new_n19_), .b(new_n27_), .O(new_n70_));
  nand3  g053(.a(new_n70_), .b(x5), .c(x0), .O(new_n71_));
  nand2  g054(.a(new_n39_), .b(new_n19_), .O(new_n72_));
  nand3  g055(.a(new_n72_), .b(new_n22_), .c(new_n20_), .O(new_n73_));
  nand2  g056(.a(new_n73_), .b(new_n71_), .O(new_n74_));
  nand2  g057(.a(new_n74_), .b(x1), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n69_), .O(z3));
  nand2  g059(.a(new_n39_), .b(new_n20_), .O(new_n77_));
  nand2  g060(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  nand3  g061(.a(new_n78_), .b(new_n19_), .c(x1), .O(new_n79_));
  nand2  g062(.a(new_n19_), .b(x1), .O(new_n80_));
  nand2  g063(.a(new_n27_), .b(new_n20_), .O(new_n81_));
  nand3  g064(.a(new_n81_), .b(new_n80_), .c(x2), .O(new_n82_));
  oai21  g065(.a(new_n27_), .b(new_n20_), .c(x1), .O(new_n83_));
  nand2  g066(.a(new_n83_), .b(x6), .O(new_n84_));
  nand3  g067(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z4));
  aoi21  g068(.a(new_n61_), .b(new_n39_), .c(new_n20_), .O(new_n86_));
  nand2  g069(.a(x3), .b(new_n24_), .O(new_n87_));
  inv1   g070(.a(new_n87_), .O(new_n88_));
  nor2   g071(.a(new_n88_), .b(new_n66_), .O(new_n89_));
  nor2   g072(.a(new_n89_), .b(x0), .O(new_n90_));
  oai21  g073(.a(new_n90_), .b(new_n86_), .c(x1), .O(new_n91_));
  nand2  g074(.a(x3), .b(new_n21_), .O(new_n92_));
  aoi21  g075(.a(new_n92_), .b(new_n61_), .c(new_n20_), .O(new_n93_));
  nand2  g076(.a(new_n66_), .b(new_n20_), .O(new_n94_));
  ...
  oai21  g080(.a(new_n88_), .b(x6), .c(new_n21_), .O(new_n98_));
  nand4  g081(.a(x6), .b(x5), .c(new_n18_), .d(new_n20_), .O(new_n99_));
  inv1   g082(.a(new_n99_), .O(new_n100_));
  oai21  g083(.a(new_n100_), .b(new_n24_), .c(x3), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(x1), .O(new_n102_));
  nand3  g085(.a(x6), .b(x3), .c(x2), .O(new_n103_));
  nand3  g086(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z6));
  nand2  g087(.a(x6), .b(new_n21_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n20_), .O(new_n106_));
  nand2  g089(.a(new_n19_), .b(new_n18_), .O(new_n107_));
  nand2  g090(.a(new_n22_), .b(x4), .O(new_n108_));
  aoi21  g091(.a(new_n108_), .b(new_n107_), .c(new_n20_), .O(new_n109_));
  oai21  g092(.a(new_n109_), .b(new_n40_), .c(x1), .O(new_n110_));
  nand2  g093(.a(new_n80_), .b(x0), .O(new_n111_));
  ...
  nor2   g097(.a(new_n114_), .b(new_n88_), .O(new_n115_));
  nand2  g098(.a(new_n115_), .b(new_n113_), .O(z7));
  nor2   g099(.a(new_n114_), .b(x3), .O(z8));
  nand2  g100(.a(new_n72_), .b(x1), .O(new_n118_));
