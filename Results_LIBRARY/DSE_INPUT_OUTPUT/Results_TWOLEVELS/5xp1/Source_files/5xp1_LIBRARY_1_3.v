...
module FAU ( 
  ...
  oai21  g25(.a(x5), .b(x4), .c(x6), .O(new_n43_));
  nand3  g26(.a(x3), .b(x2), .c(x1), .O(new_n44_));
  nand4  g27(.a(new_n44_), .b(new_n26_), .c(x5), .d(new_n20_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  aoi21  g29(.a(new_n42_), .b(x0), .c(new_n46_), .O(new_n47_));
  ...
  nand2  g44(.a(new_n21_), .b(new_n49_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x4), .c(x0), .O(new_n63_));
  aoi21  g46(.a(new_n21_), .b(new_n49_), .c(new_n20_), .O(new_n64_));
  ...
  aoi21  g57(.a(new_n29_), .b(new_n26_), .c(new_n49_), .O(new_n75_));
  ...
  nand2  g68(.a(new_n22_), .b(new_n20_), .O(new_n86_));
  nand3  g69(.a(new_n86_), .b(new_n26_), .c(x2), .O(new_n87_));
  aoi21  g70(.a(new_n22_), .b(new_n20_), .c(new_n21_), .O(new_n88_));
  oai21  g71(.a(new_n88_), .b(new_n26_), .c(new_n87_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n49_), .O(new_n90_));
  nand2  g73(.a(x6), .b(x5), .O(new_n91_));
  nand3  g74(.a(new_n91_), .b(new_n90_), .c(new_n85_), .O(z4));
  nor2   g75(.a(new_n22_), .b(x2), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(x1), .O(new_n94_));
  oai21  g77(.a(x3), .b(new_n21_), .c(new_n94_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n20_), .O(new_n96_));
  aoi21  g79(.a(x3), .b(x1), .c(x2), .O(new_n97_));
  oai21  g80(.a(new_n97_), .b(new_n30_), .c(x0), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n96_), .c(new_n91_), .O(z5));
  nor2   g82(.a(x6), .b(x4), .O(new_n100_));
  aoi21  g83(.a(new_n19_), .b(x4), .c(new_n100_), .O(new_n101_));
  nand3  g84(.a(new_n26_), .b(new_n19_), .c(x0), .O(new_n102_));
  nand2  g85(.a(new_n102_), .b(x3), .O(new_n103_));
  oai21  g86(.a(new_n101_), .b(new_n20_), .c(new_n103_), .O(new_n104_));
  aoi21  g87(.a(new_n104_), .b(x2), .c(new_n22_), .O(new_n105_));
  aoi22  g88(.a(new_n93_), .b(new_n49_), .c(x6), .d(x5), .O(new_n106_));
  oai21  g89(.a(new_n105_), .b(new_n49_), .c(new_n106_), .O(z6));
  nand2  g90(.a(new_n91_), .b(x3), .O(z8));
  nand2  g91(.a(x6), .b(x5), .O(new_n110_));
  nand3  g92(.a(new_n110_), .b(new_n22_), .c(x2), .O(new_n111_));
  oai21  g93(.a(z8), .b(x2), .c(new_n111_), .O(z7));
  nand2  g94(.a(new_n31_), .b(new_n20_), .O(new_n113_));
  nand4  g95(.a(new_n113_), .b(new_n26_), .c(x5), .d(x4), .O(new_n114_));
