...
module FAU ( 
  ...
  nor2   g63(.a(new_n24_), .b(new_n71_), .O(new_n81_));
  nand3  g64(.a(new_n81_), .b(new_n35_), .c(x1), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n22_), .O(new_n84_));
  aoi21  g67(.a(new_n71_), .b(x2), .c(x1), .O(new_n85_));
  ...
  oai22  g73(.a(new_n90_), .b(new_n71_), .c(new_n81_), .d(new_n36_), .O(z6));
  nand2  g74(.a(new_n81_), .b(new_n35_), .O(new_n92_));
  nand4  g75(.a(new_n24_), .b(new_n71_), .c(x2), .d(new_n36_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(x0), .O(new_n95_));
  nand3  g78(.a(new_n71_), .b(x2), .c(new_n36_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n22_), .O(new_n98_));
  nand3  g81(.a(x3), .b(new_n35_), .c(new_n36_), .O(new_n99_));
  nand3  g82(.a(x6), .b(new_n71_), .c(x2), .O(new_n100_));
  nand4  g83(.a(new_n100_), .b(new_n99_), .c(new_n98_), .d(new_n95_), .O(z7));
  nand2  g84(.a(new_n78_), .b(x3), .O(z8));
  oai21  g85(.a(x1), .b(new_n22_), .c(new_n24_), .O(new_n103_));
