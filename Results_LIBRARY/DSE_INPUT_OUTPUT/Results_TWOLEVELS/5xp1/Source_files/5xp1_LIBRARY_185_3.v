...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    ...
    new_n106_, new_n107_, new_n109_, new_n110_, new_n111_, new_n115_,
    new_n116_, new_n117_;
  ...
  nand2  g091(.a(x3), .b(x2), .O(new_n109_));
  nand3  g092(.a(new_n109_), .b(x3), .c(new_n21_), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(x1), .O(new_n111_));
  oai21  g094(.a(new_n105_), .b(x1), .c(new_n111_), .O(z6));
  aoi22  g095(.a(new_n105_), .b(new_n103_), .c(x1), .d(x0), .O(z7));
  oai21  g096(.a(new_n18_), .b(new_n21_), .c(x3), .O(z8));
  oai21  g097(.a(x6), .b(x0), .c(new_n18_), .O(new_n115_));
  oai21  g098(.a(new_n78_), .b(x0), .c(new_n115_), .O(new_n116_));
