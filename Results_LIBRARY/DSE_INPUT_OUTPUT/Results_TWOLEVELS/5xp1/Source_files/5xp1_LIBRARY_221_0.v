...
module FAU ( 
  ...
  nand4  g062(.a(x6), .b(new_n19_), .c(x2), .d(new_n64_), .O(new_n80_));
  ...
  nand2  g068(.a(new_n84_), .b(new_n41_), .O(new_n86_));
  nand3  g069(.a(new_n33_), .b(new_n47_), .c(new_n46_), .O(new_n87_));
  aoi21  g070(.a(new_n87_), .b(new_n86_), .c(x5), .O(new_n88_));
  oai21  g071(.a(new_n88_), .b(new_n85_), .c(x0), .O(new_n89_));
  nand3  g072(.a(new_n42_), .b(x5), .c(new_n41_), .O(new_n90_));
  oai21  g073(.a(x5), .b(new_n41_), .c(new_n90_), .O(new_n91_));
  nand3  g074(.a(new_n91_), .b(x6), .c(new_n64_), .O(new_n92_));
  nand3  g075(.a(new_n92_), .b(new_n89_), .c(new_n82_), .O(z3));
  oai21  g076(.a(x3), .b(x1), .c(x6), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  xor2a  g078(.a(x6), .b(x2), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(new_n41_), .O(new_n97_));
  aoi21  g080(.a(new_n87_), .b(new_n84_), .c(new_n64_), .O(new_n98_));
  nand3  g081(.a(x6), .b(x3), .c(x2), .O(new_n99_));
  inv1   g082(.a(new_n99_), .O(new_n100_));
  oai21  g083(.a(new_n100_), .b(new_n98_), .c(x1), .O(new_n101_));
  nand4  g084(.a(x6), .b(x3), .c(new_n46_), .d(x0), .O(new_n102_));
  nand4  g085(.a(new_n102_), .b(new_n101_), .c(new_n97_), .d(new_n95_), .O(z4));
  nand3  g086(.a(x3), .b(new_n46_), .c(x1), .O(new_n104_));
  nand2  g087(.a(new_n47_), .b(x2), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g089(.a(new_n106_), .b(x6), .c(new_n64_), .O(new_n107_));
  inv1   g090(.a(new_n42_), .O(new_n108_));
  ...
  nand2  g094(.a(x3), .b(new_n41_), .O(new_n112_));
  nand3  g095(.a(new_n33_), .b(new_n47_), .c(x1), .O(new_n113_));
  aoi21  g096(.a(new_n113_), .b(new_n112_), .c(new_n64_), .O(new_n114_));
  nor3   g097(.a(new_n33_), .b(new_n47_), .c(x1), .O(new_n115_));
  oai21  g098(.a(new_n115_), .b(new_n114_), .c(new_n46_), .O(new_n116_));
  oai21  g099(.a(new_n47_), .b(x2), .c(x6), .O(new_n117_));
  nand3  g100(.a(x6), .b(new_n19_), .c(new_n21_), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(x2), .c(x0), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(x1), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(new_n116_), .O(z6));
  nor2   g105(.a(new_n47_), .b(x2), .O(new_n123_));
  inv1   g106(.a(new_n105_), .O(new_n124_));
  oai21  g107(.a(new_n124_), .b(new_n123_), .c(x0), .O(new_n125_));
  aoi22  g108(.a(new_n106_), .b(new_n64_), .c(new_n123_), .d(new_n41_), .O(new_n126_));
  oai21  g109(.a(new_n126_), .b(new_n33_), .c(new_n125_), .O(z7));
  oai21  g110(.a(x1), .b(new_n64_), .c(x6), .O(new_n128_));
  aoi21  g111(.a(new_n128_), .b(new_n64_), .c(x3), .O(z8));
  oai22  g112(.a(x6), .b(x0), .c(new_n19_), .d(new_n21_), .O(z9));
endmodule
