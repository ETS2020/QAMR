...
module FAU ( 
  ...
  nand2  g082(.a(new_n99_), .b(new_n34_), .O(new_n100_));
  nor2   g083(.a(new_n91_), .b(x2), .O(new_n101_));
  oai21  g084(.a(new_n101_), .b(new_n90_), .c(x0), .O(new_n102_));
  nand3  g085(.a(new_n102_), .b(new_n100_), .c(new_n98_), .O(new_n103_));
  nand3  g086(.a(new_n103_), .b(x6), .c(new_n29_), .O(new_n104_));
  ...
  nand2  g113(.a(x6), .b(new_n29_), .O(new_n131_));
  nand2  g114(.a(x5), .b(x4), .O(new_n132_));
  nand2  g115(.a(new_n21_), .b(new_n39_), .O(new_n133_));
  nand3  g116(.a(new_n133_), .b(new_n132_), .c(new_n131_), .O(new_n134_));
  nand2  g117(.a(new_n134_), .b(x3), .O(new_n135_));
  aoi21  g118(.a(new_n135_), .b(new_n130_), .c(new_n18_), .O(new_n136_));
  oai21  g119(.a(new_n136_), .b(new_n91_), .c(x1), .O(new_n137_));
  aoi21  g120(.a(new_n101_), .b(new_n34_), .c(new_n95_), .O(new_n138_));
  nand2  g121(.a(new_n138_), .b(new_n137_), .O(z6));
  nor2   g122(.a(new_n101_), .b(new_n40_), .O(new_n140_));
  nand2  g123(.a(new_n140_), .b(new_n94_), .O(z7));
  nor2   g124(.a(new_n95_), .b(x3), .O(z8));
  nand2  g125(.a(new_n52_), .b(x5), .O(new_n143_));
  aoi21  g126(.a(new_n143_), .b(new_n22_), .c(new_n29_), .O(z9));
endmodule
