...
module FAU ( 
  ...
  aoi21  g54(.a(new_n71_), .b(new_n27_), .c(new_n34_), .O(new_n72_));
  nand3  g55(.a(x3), .b(new_n34_), .c(x0), .O(new_n73_));
  oai21  g56(.a(new_n72_), .b(x1), .c(new_n73_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x6), .O(new_n75_));
  aoi22  g58(.a(x6), .b(new_n18_), .c(new_n71_), .d(new_n27_), .O(new_n76_));
  nand2  g59(.a(new_n76_), .b(x2), .O(new_n77_));
  nand3  g60(.a(new_n77_), .b(new_n75_), .c(new_n58_), .O(z4));
  nand3  g61(.a(new_n58_), .b(new_n71_), .c(x2), .O(new_n79_));
  nor2   g62(.a(new_n19_), .b(new_n71_), .O(new_n80_));
  nand3  g63(.a(new_n80_), .b(new_n34_), .c(x1), .O(new_n81_));
  nand2  g64(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n27_), .O(new_n83_));
  aoi21  g66(.a(new_n71_), .b(x2), .c(x1), .O(new_n84_));
  nand2  g67(.a(new_n71_), .b(new_n34_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n28_), .c(new_n19_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(new_n84_), .c(x0), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n83_), .O(z5));
  xor2a  g71(.a(x2), .b(x1), .O(new_n89_));
  oai22  g72(.a(new_n89_), .b(new_n71_), .c(new_n80_), .d(new_n18_), .O(z6));
  nand2  g73(.a(new_n80_), .b(new_n34_), .O(new_n91_));
  nand4  g74(.a(new_n19_), .b(new_n71_), .c(x2), .d(new_n18_), .O(new_n92_));
  nand2  g75(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(x0), .O(new_n94_));
  nand3  g77(.a(new_n71_), .b(x2), .c(new_n18_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n27_), .O(new_n97_));
  nand3  g80(.a(x3), .b(new_n34_), .c(new_n18_), .O(new_n98_));
  nand3  g81(.a(x6), .b(new_n71_), .c(x2), .O(new_n99_));
  nand4  g82(.a(new_n99_), .b(new_n98_), .c(new_n97_), .d(new_n94_), .O(z7));
  nand2  g83(.a(new_n58_), .b(x3), .O(z8));
  oai21  g84(.a(x1), .b(new_n27_), .c(new_n19_), .O(new_n102_));
