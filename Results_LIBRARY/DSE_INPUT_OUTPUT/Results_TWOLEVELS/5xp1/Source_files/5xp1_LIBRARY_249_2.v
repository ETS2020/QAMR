...
module FAU ( 
  ...
  nand2  g023(.a(new_n19_), .b(new_n22_), .O(new_n41_));
  ...
  oai21  g049(.a(new_n66_), .b(new_n27_), .c(x6), .O(new_n67_));
  ...
  oai22  g056(.a(new_n73_), .b(new_n37_), .c(new_n72_), .d(new_n22_), .O(new_n74_));
  oai21  g057(.a(new_n19_), .b(new_n22_), .c(new_n23_), .O(new_n75_));
  aoi21  g058(.a(new_n75_), .b(new_n41_), .c(new_n18_), .O(new_n76_));
  aoi21  g059(.a(new_n74_), .b(new_n18_), .c(new_n76_), .O(new_n77_));
  nand3  g060(.a(new_n18_), .b(new_n37_), .c(new_n22_), .O(new_n78_));
  oai21  g061(.a(new_n66_), .b(new_n18_), .c(new_n78_), .O(new_n79_));
  nand3  g062(.a(new_n79_), .b(x6), .c(x0), .O(new_n80_));
  oai21  g063(.a(new_n77_), .b(x0), .c(new_n80_), .O(z3));
  inv1   g064(.a(x3), .O(new_n82_));
  xor2a  g065(.a(x6), .b(x1), .O(new_n83_));
  nand3  g066(.a(new_n83_), .b(new_n82_), .c(new_n28_), .O(new_n84_));
  aoi21  g067(.a(new_n73_), .b(new_n28_), .c(new_n37_), .O(new_n85_));
  nor2   g068(.a(x6), .b(x2), .O(new_n86_));
  oai21  g069(.a(new_n86_), .b(new_n85_), .c(x1), .O(new_n87_));
  oai21  g070(.a(new_n23_), .b(x1), .c(new_n28_), .O(new_n88_));
  nand2  g071(.a(new_n88_), .b(new_n19_), .O(new_n89_));
  oai21  g072(.a(x3), .b(new_n22_), .c(x0), .O(new_n90_));
  oai21  g073(.a(new_n82_), .b(x1), .c(new_n90_), .O(new_n91_));
  nand3  g074(.a(new_n91_), .b(x6), .c(new_n37_), .O(new_n92_));
  nand4  g075(.a(new_n92_), .b(new_n89_), .c(new_n87_), .d(new_n84_), .O(z4));
  ...
  nand3  g090(.a(new_n20_), .b(new_n82_), .c(x1), .O(new_n108_));
  oai21  g091(.a(new_n107_), .b(new_n82_), .c(new_n108_), .O(z6));
  nand3  g092(.a(new_n101_), .b(new_n82_), .c(x2), .O(new_n110_));
