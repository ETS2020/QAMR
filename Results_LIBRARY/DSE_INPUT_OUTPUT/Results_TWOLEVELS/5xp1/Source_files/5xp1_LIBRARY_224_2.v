...
module FAU ( 
  ...
  nand3  g46(.a(new_n63_), .b(new_n18_), .c(x0), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  nand2  g48(.a(new_n46_), .b(new_n22_), .O(new_n66_));
  inv1   g49(.a(x3), .O(new_n67_));
  nand3  g50(.a(x6), .b(new_n67_), .c(x2), .O(new_n68_));
  aoi21  g51(.a(new_n68_), .b(new_n66_), .c(new_n18_), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n65_), .c(new_n38_), .O(new_n70_));
  aoi21  g53(.a(new_n63_), .b(new_n38_), .c(new_n22_), .O(new_n71_));
  nor2   g54(.a(x6), .b(x0), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n71_), .c(x5), .O(new_n73_));
  nor2   g56(.a(new_n34_), .b(new_n67_), .O(new_n74_));
  nand2  g57(.a(new_n74_), .b(x2), .O(new_n75_));
  nand2  g58(.a(new_n75_), .b(new_n38_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n18_), .c(new_n22_), .O(new_n77_));
  nand4  g60(.a(new_n77_), .b(new_n73_), .c(new_n70_), .d(new_n61_), .O(z3));
  nand2  g61(.a(x2), .b(x1), .O(new_n79_));
  nand2  g62(.a(x3), .b(new_n46_), .O(new_n80_));
  aoi21  g63(.a(new_n80_), .b(new_n79_), .c(new_n22_), .O(new_n81_));
  oai21  g64(.a(x3), .b(x0), .c(x2), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(new_n38_), .O(new_n83_));
  oai21  g66(.a(new_n23_), .b(new_n38_), .c(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n81_), .c(x6), .O(new_n85_));
  nand2  g68(.a(new_n67_), .b(new_n22_), .O(new_n86_));
  nand4  g69(.a(new_n86_), .b(new_n34_), .c(x2), .d(new_n38_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n85_), .O(z4));
  nand3  g71(.a(new_n61_), .b(new_n67_), .c(x2), .O(new_n89_));
  nand3  g72(.a(new_n74_), .b(new_n46_), .c(x1), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n22_), .O(new_n92_));
  aoi21  g75(.a(new_n67_), .b(x2), .c(x1), .O(new_n93_));
  nand2  g76(.a(new_n67_), .b(new_n46_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n23_), .c(new_n34_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n93_), .c(x0), .O(new_n96_));
  nand2  g79(.a(new_n96_), .b(new_n92_), .O(z5));
  nand2  g80(.a(x3), .b(new_n46_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(x6), .c(x1), .O(new_n99_));
  nand3  g82(.a(x3), .b(new_n46_), .c(new_n38_), .O(new_n100_));
  nand2  g83(.a(new_n100_), .b(new_n99_), .O(z6));
  nand2  g84(.a(new_n74_), .b(new_n46_), .O(new_n102_));
  nand4  g85(.a(new_n34_), .b(new_n67_), .c(x2), .d(new_n38_), .O(new_n103_));
  nand2  g86(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(x0), .O(new_n105_));
  nand3  g88(.a(new_n67_), .b(x2), .c(new_n38_), .O(new_n106_));
  nand2  g89(.a(new_n106_), .b(new_n90_), .O(new_n107_));
  nand2  g90(.a(new_n107_), .b(new_n22_), .O(new_n108_));
  nand4  g91(.a(new_n108_), .b(new_n105_), .c(new_n100_), .d(new_n68_), .O(z7));
  aoi21  g92(.a(new_n34_), .b(x1), .c(x3), .O(z8));
  oai21  g93(.a(x1), .b(new_n22_), .c(new_n34_), .O(new_n111_));
