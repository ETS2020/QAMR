...
module FAU ( 
  ...
  nand3  g056(.a(new_n73_), .b(x6), .c(x1), .O(new_n74_));
  nand3  g057(.a(new_n24_), .b(x3), .c(new_n19_), .O(new_n75_));
  oai21  g058(.a(new_n24_), .b(new_n19_), .c(new_n75_), .O(new_n76_));
  ...
  nand2  g063(.a(new_n52_), .b(new_n19_), .O(new_n81_));
  nand2  g064(.a(new_n20_), .b(x3), .O(new_n82_));
  aoi21  g065(.a(new_n82_), .b(new_n81_), .c(new_n24_), .O(new_n83_));
  oai21  g066(.a(new_n83_), .b(new_n80_), .c(new_n66_), .O(new_n84_));
  nand2  g067(.a(x6), .b(x1), .O(new_n85_));
  nand4  g068(.a(new_n85_), .b(x5), .c(new_n53_), .d(new_n19_), .O(new_n86_));
  and2   g069(.a(new_n86_), .b(new_n45_), .O(new_n87_));
  nand4  g070(.a(new_n87_), .b(new_n84_), .c(new_n77_), .d(new_n74_), .O(z3));
  nor2   g071(.a(x3), .b(x0), .O(new_n89_));
  xor2a  g072(.a(x2), .b(x1), .O(new_n90_));
  nand3  g073(.a(x3), .b(x1), .c(x0), .O(new_n91_));
  oai21  g074(.a(new_n90_), .b(new_n89_), .c(new_n91_), .O(new_n92_));
  nand2  g075(.a(new_n92_), .b(x6), .O(new_n93_));
  oai21  g076(.a(new_n89_), .b(new_n20_), .c(new_n52_), .O(new_n94_));
  aoi21  g077(.a(new_n53_), .b(x1), .c(new_n66_), .O(new_n95_));
  oai21  g078(.a(new_n95_), .b(x0), .c(new_n69_), .O(new_n96_));
  nand2  g079(.a(new_n96_), .b(new_n20_), .O(new_n97_));
  nand3  g080(.a(new_n97_), .b(new_n94_), .c(new_n93_), .O(z4));
  aoi21  g081(.a(new_n69_), .b(new_n21_), .c(new_n52_), .O(new_n99_));
  nand2  g082(.a(new_n53_), .b(x2), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x6), .O(new_n101_));
  nor2   g084(.a(new_n101_), .b(x1), .O(new_n102_));
  oai21  g085(.a(new_n102_), .b(new_n99_), .c(x0), .O(new_n103_));
  nand2  g086(.a(x3), .b(new_n66_), .O(new_n104_));
  nand3  g087(.a(new_n20_), .b(new_n53_), .c(x2), .O(new_n105_));
  aoi21  g088(.a(new_n105_), .b(new_n104_), .c(new_n52_), .O(new_n106_));
  nand3  g089(.a(x6), .b(new_n53_), .c(x2), .O(new_n107_));
  inv1   g090(.a(new_n107_), .O(new_n108_));
  oai21  g091(.a(new_n108_), .b(new_n106_), .c(new_n19_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(new_n103_), .O(z5));
  nand2  g093(.a(new_n104_), .b(x1), .O(new_n111_));
  nand4  g094(.a(x6), .b(x3), .c(new_n66_), .d(new_n52_), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(new_n111_), .O(z6));
  nand3  g096(.a(new_n104_), .b(new_n100_), .c(new_n45_), .O(z7));
  nor2   g097(.a(new_n44_), .b(x3), .O(z8));
  nand2  g098(.a(new_n27_), .b(x1), .O(new_n116_));
