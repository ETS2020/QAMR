...
module FAU ( 
  ...
  aoi21  g086(.a(new_n27_), .b(x1), .c(new_n28_), .O(new_n104_));
  oai21  g087(.a(new_n104_), .b(new_n22_), .c(x0), .O(new_n105_));
  nor2   g088(.a(new_n24_), .b(x4), .O(new_n106_));
  inv1   g089(.a(new_n106_), .O(new_n107_));
  nand3  g090(.a(new_n107_), .b(new_n105_), .c(new_n103_), .O(z5));
  nor2   g091(.a(x5), .b(new_n18_), .O(new_n109_));
  nor2   g092(.a(x6), .b(x4), .O(new_n110_));
  oai21  g093(.a(new_n110_), .b(new_n109_), .c(x0), .O(new_n111_));
  aoi21  g094(.a(new_n24_), .b(new_n19_), .c(new_n18_), .O(new_n112_));
  nand2  g095(.a(x5), .b(new_n18_), .O(new_n113_));
  aoi21  g096(.a(new_n113_), .b(new_n43_), .c(x6), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n112_), .c(x3), .O(new_n115_));
  aoi21  g098(.a(new_n115_), .b(new_n111_), .c(new_n27_), .O(new_n116_));
  oai21  g099(.a(new_n27_), .b(new_n20_), .c(new_n24_), .O(new_n117_));
  aoi21  g100(.a(new_n117_), .b(new_n18_), .c(x3), .O(new_n118_));
  oai21  g101(.a(new_n118_), .b(new_n116_), .c(x1), .O(new_n119_));
  nand4  g102(.a(new_n107_), .b(x3), .c(new_n27_), .d(new_n21_), .O(new_n120_));
  nand2  g103(.a(new_n120_), .b(new_n119_), .O(z6));
  nand3  g104(.a(new_n107_), .b(new_n101_), .c(new_n100_), .O(z7));
  nor2   g105(.a(new_n106_), .b(x3), .O(z8));
  oai21  g106(.a(new_n29_), .b(x6), .c(x1), .O(new_n124_));
  nand2  g107(.a(new_n27_), .b(new_n20_), .O(new_n125_));
  aoi21  g108(.a(new_n125_), .b(new_n101_), .c(x1), .O(new_n126_));
  oai21  g109(.a(new_n126_), .b(new_n29_), .c(x6), .O(new_n127_));
  nand3  g110(.a(new_n127_), .b(new_n124_), .c(new_n20_), .O(new_n128_));
  nand3  g111(.a(new_n128_), .b(x5), .c(x4), .O(new_n129_));
  nand2  g112(.a(new_n129_), .b(new_n107_), .O(z9));
endmodule
