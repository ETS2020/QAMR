...
module FAU ( 
  ...
  oai21  g059(.a(new_n22_), .b(new_n36_), .c(new_n27_), .O(new_n77_));
  nor2   g060(.a(x6), .b(x3), .O(new_n78_));
  nand2  g061(.a(new_n78_), .b(new_n28_), .O(new_n79_));
  aoi21  g062(.a(new_n79_), .b(new_n77_), .c(new_n63_), .O(new_n80_));
  inv1   g063(.a(new_n44_), .O(new_n81_));
  ...
  oai21  g067(.a(new_n84_), .b(new_n80_), .c(new_n21_), .O(new_n85_));
  nor2   g068(.a(x2), .b(x0), .O(new_n86_));
  nor2   g069(.a(x3), .b(new_n36_), .O(new_n87_));
  oai21  g070(.a(new_n87_), .b(new_n86_), .c(new_n27_), .O(new_n88_));
  nand3  g071(.a(new_n88_), .b(new_n42_), .c(x6), .O(new_n89_));
  nand2  g072(.a(new_n89_), .b(x5), .O(new_n90_));
  nand2  g073(.a(new_n90_), .b(new_n85_), .O(z3));
  nand2  g074(.a(x6), .b(x2), .O(new_n92_));
  nand3  g075(.a(new_n53_), .b(new_n37_), .c(new_n36_), .O(new_n93_));
  aoi21  g076(.a(new_n93_), .b(new_n92_), .c(new_n63_), .O(new_n94_));
  nand4  g077(.a(new_n44_), .b(new_n22_), .c(new_n21_), .d(new_n63_), .O(new_n95_));
  nand2  g078(.a(new_n95_), .b(new_n83_), .O(new_n96_));
  oai21  g079(.a(new_n96_), .b(new_n94_), .c(x1), .O(new_n97_));
  nand2  g080(.a(x6), .b(new_n36_), .O(new_n98_));
  nand2  g081(.a(new_n53_), .b(x2), .O(new_n99_));
  aoi22  g082(.a(new_n99_), .b(new_n98_), .c(new_n37_), .d(new_n63_), .O(new_n100_));
  nand3  g083(.a(x6), .b(new_n37_), .c(new_n63_), .O(new_n101_));
  inv1   g084(.a(new_n101_), .O(new_n102_));
  oai21  g085(.a(new_n102_), .b(new_n100_), .c(new_n27_), .O(new_n103_));
  nand4  g086(.a(x6), .b(x3), .c(new_n36_), .d(x0), .O(new_n104_));
  nand3  g087(.a(new_n104_), .b(new_n103_), .c(new_n97_), .O(z4));
  nand3  g088(.a(x3), .b(new_n36_), .c(x1), .O(new_n106_));
  inv1   g089(.a(new_n106_), .O(new_n107_));
  oai21  g090(.a(new_n107_), .b(new_n87_), .c(new_n63_), .O(new_n108_));
  nand2  g091(.a(new_n22_), .b(x5), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(new_n27_), .O(new_n110_));
  aoi21  g093(.a(new_n110_), .b(x3), .c(x2), .O(new_n111_));
  oai21  g094(.a(new_n111_), .b(new_n81_), .c(x0), .O(new_n112_));
  nand3  g095(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(z5));
  oai21  g096(.a(new_n78_), .b(new_n81_), .c(new_n63_), .O(new_n114_));
  aoi21  g097(.a(x6), .b(new_n18_), .c(new_n36_), .O(new_n115_));
  ...
  aoi21  g101(.a(x3), .b(new_n36_), .c(new_n22_), .O(new_n119_));
  oai21  g102(.a(new_n119_), .b(new_n118_), .c(x1), .O(new_n120_));
  nand4  g103(.a(new_n109_), .b(x3), .c(new_n36_), .d(new_n27_), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(new_n120_), .O(z6));
  nand2  g105(.a(x6), .b(new_n18_), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(new_n21_), .c(x1), .O(new_n124_));
  nand2  g107(.a(new_n124_), .b(new_n22_), .O(new_n125_));
  nand2  g108(.a(new_n125_), .b(x0), .O(new_n126_));
  nand2  g109(.a(x1), .b(new_n63_), .O(new_n127_));
  nand3  g110(.a(new_n127_), .b(new_n126_), .c(new_n110_), .O(new_n128_));
  nand3  g111(.a(new_n128_), .b(x3), .c(new_n36_), .O(new_n129_));
  aoi21  g112(.a(new_n22_), .b(x5), .c(new_n87_), .O(new_n130_));
  nand2  g113(.a(new_n130_), .b(new_n129_), .O(z7));
  nand2  g114(.a(new_n109_), .b(x3), .O(z8));
  nand3  g115(.a(x6), .b(x5), .c(x4), .O(new_n133_));
