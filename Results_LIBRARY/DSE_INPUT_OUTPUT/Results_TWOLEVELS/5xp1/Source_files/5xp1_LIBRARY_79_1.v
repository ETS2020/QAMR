...
module FAU ( 
  ...
  nand4  g067(.a(x6), .b(new_n22_), .c(x2), .d(x0), .O(new_n85_));
  inv1   g068(.a(new_n85_), .O(new_n86_));
  oai21  g069(.a(new_n86_), .b(new_n84_), .c(x1), .O(new_n87_));
  nand3  g070(.a(new_n26_), .b(x2), .c(new_n25_), .O(new_n88_));
  oai21  g071(.a(new_n19_), .b(new_n22_), .c(new_n88_), .O(new_n89_));
  nand2  g072(.a(new_n89_), .b(x0), .O(new_n90_));
  nand2  g073(.a(new_n30_), .b(new_n25_), .O(new_n91_));
  nand3  g074(.a(x6), .b(x3), .c(x2), .O(new_n92_));
  nand4  g075(.a(new_n92_), .b(new_n91_), .c(new_n90_), .d(new_n87_), .O(z4));
  ...
  oai21  g087(.a(new_n22_), .b(x2), .c(new_n19_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n25_), .O(new_n106_));
  nand4  g089(.a(x6), .b(x5), .c(new_n18_), .d(new_n42_), .O(new_n107_));
  inv1   g090(.a(new_n107_), .O(new_n108_));
  oai21  g091(.a(new_n108_), .b(new_n21_), .c(x3), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(x1), .O(new_n110_));
  nand3  g093(.a(new_n110_), .b(new_n106_), .c(new_n92_), .O(z6));
  oai21  g094(.a(new_n19_), .b(x1), .c(new_n42_), .O(new_n112_));
  nand2  g095(.a(x4), .b(x1), .O(new_n113_));
  nand2  g096(.a(new_n113_), .b(new_n19_), .O(new_n114_));
  oai21  g097(.a(new_n62_), .b(new_n25_), .c(new_n114_), .O(new_n115_));
  nand2  g098(.a(new_n115_), .b(x0), .O(new_n116_));
  nand2  g099(.a(new_n38_), .b(x1), .O(new_n117_));
  nand3  g100(.a(new_n117_), .b(new_n116_), .c(new_n112_), .O(new_n118_));
  nand3  g101(.a(new_n118_), .b(new_n22_), .c(x2), .O(new_n119_));
  nand2  g102(.a(x6), .b(new_n25_), .O(new_n120_));
  nand3  g103(.a(new_n120_), .b(x3), .c(new_n21_), .O(new_n121_));
  nand2  g104(.a(new_n121_), .b(new_n119_), .O(z7));
  aoi21  g105(.a(x6), .b(new_n25_), .c(x3), .O(z8));
  aoi21  g106(.a(x5), .b(x4), .c(new_n25_), .O(new_n124_));
  oai21  g107(.a(new_n29_), .b(new_n25_), .c(new_n42_), .O(new_n125_));
  nand3  g108(.a(new_n125_), .b(x5), .c(x4), .O(new_n126_));
  oai21  g109(.a(new_n124_), .b(new_n19_), .c(new_n126_), .O(z9));
endmodule
