...
module FAU ( 
  ...
  nand3  g015(.a(new_n32_), .b(x6), .c(x0), .O(new_n33_));
  nand2  g016(.a(new_n33_), .b(new_n21_), .O(new_n34_));
  nand2  g017(.a(new_n34_), .b(new_n18_), .O(new_n35_));
  nand2  g018(.a(new_n19_), .b(x4), .O(new_n36_));
  nand3  g019(.a(new_n36_), .b(new_n35_), .c(new_n30_), .O(z1));
  nor2   g020(.a(x5), .b(x0), .O(new_n38_));
  nor2   g021(.a(new_n38_), .b(new_n23_), .O(new_n39_));
  nand2  g022(.a(new_n18_), .b(new_n31_), .O(new_n40_));
  ...
  nand2  g055(.a(new_n62_), .b(new_n61_), .O(new_n73_));
  nand2  g056(.a(new_n73_), .b(new_n23_), .O(new_n74_));
  inv1   g057(.a(new_n62_), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n50_), .O(new_n76_));
  ...
  oai21  g062(.a(new_n62_), .b(new_n23_), .c(new_n79_), .O(new_n80_));
  nand4  g063(.a(new_n80_), .b(x5), .c(new_n68_), .d(x2), .O(new_n81_));
  nand3  g064(.a(new_n81_), .b(new_n78_), .c(new_n67_), .O(z3));
  ...
  nand2  g068(.a(new_n85_), .b(new_n58_), .O(new_n86_));
  oai21  g069(.a(new_n86_), .b(new_n83_), .c(x1), .O(new_n87_));
  nand3  g070(.a(x6), .b(x3), .c(new_n31_), .O(new_n88_));
  nand3  g071(.a(new_n75_), .b(x2), .c(new_n23_), .O(new_n89_));
  nand2  g072(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  aoi21  g073(.a(new_n68_), .b(new_n22_), .c(new_n31_), .O(new_n91_));
  oai22  g074(.a(new_n91_), .b(new_n19_), .c(new_n62_), .d(new_n24_), .O(new_n92_));
  aoi22  g075(.a(new_n92_), .b(new_n23_), .c(new_n90_), .d(x0), .O(new_n93_));
  nand2  g076(.a(new_n93_), .b(new_n87_), .O(z4));
  aoi21  g077(.a(new_n32_), .b(new_n24_), .c(new_n22_), .O(new_n95_));
  nand3  g078(.a(new_n68_), .b(x2), .c(new_n22_), .O(new_n96_));
  inv1   g079(.a(new_n96_), .O(new_n97_));
  oai21  g080(.a(new_n97_), .b(new_n95_), .c(new_n36_), .O(new_n98_));
  oai21  g081(.a(x4), .b(new_n23_), .c(new_n19_), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(new_n68_), .c(x0), .O(new_n100_));
  ...
  oai21  g089(.a(x3), .b(x0), .c(new_n42_), .O(new_n107_));
  ...
  nand2  g104(.a(new_n31_), .b(x1), .O(new_n122_));
  oai21  g105(.a(new_n122_), .b(x1), .c(x6), .O(new_n123_));
  aoi21  g106(.a(new_n123_), .b(x4), .c(x3), .O(z8));
