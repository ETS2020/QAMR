...
module FAU ( 
  ...
  oai21  g63(.a(new_n77_), .b(new_n36_), .c(new_n21_), .O(new_n81_));
  oai21  g64(.a(new_n80_), .b(new_n20_), .c(new_n81_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(x6), .O(new_n83_));
  nand2  g66(.a(new_n22_), .b(new_n20_), .O(new_n84_));
  nand2  g67(.a(new_n70_), .b(new_n36_), .O(new_n85_));
  aoi21  g68(.a(new_n85_), .b(new_n84_), .c(new_n21_), .O(new_n86_));
  oai21  g69(.a(new_n86_), .b(x4), .c(new_n18_), .O(new_n87_));
  nand3  g70(.a(new_n87_), .b(new_n83_), .c(new_n79_), .O(z4));
  nand2  g71(.a(new_n70_), .b(x2), .O(new_n89_));
  oai21  g72(.a(new_n80_), .b(new_n21_), .c(new_n89_), .O(new_n90_));
  nand2  g73(.a(new_n90_), .b(new_n20_), .O(new_n91_));
  inv1   g74(.a(new_n85_), .O(new_n92_));
  aoi21  g75(.a(new_n36_), .b(x1), .c(new_n70_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n92_), .c(x0), .O(new_n94_));
  nor2   g77(.a(x6), .b(new_n19_), .O(new_n95_));
  inv1   g78(.a(new_n95_), .O(new_n96_));
  nand3  g79(.a(new_n96_), .b(new_n94_), .c(new_n91_), .O(z5));
  oai21  g80(.a(new_n25_), .b(new_n70_), .c(new_n20_), .O(new_n98_));
  nand3  g81(.a(new_n98_), .b(new_n18_), .c(new_n19_), .O(new_n99_));
  oai21  g82(.a(new_n42_), .b(x6), .c(x3), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(new_n99_), .c(new_n36_), .O(new_n101_));
  oai21  g84(.a(new_n101_), .b(new_n70_), .c(x1), .O(new_n102_));
  inv1   g85(.a(new_n80_), .O(new_n103_));
  aoi21  g86(.a(new_n103_), .b(new_n21_), .c(new_n95_), .O(new_n104_));
  nand2  g87(.a(new_n104_), .b(new_n102_), .O(z6));
  nand4  g88(.a(new_n18_), .b(x4), .c(x1), .d(x0), .O(new_n106_));
  nand3  g89(.a(new_n106_), .b(x3), .c(new_n36_), .O(new_n107_));
  nand3  g90(.a(new_n107_), .b(new_n96_), .c(new_n89_), .O(z7));
  nor2   g91(.a(new_n95_), .b(x3), .O(z8));
  aoi21  g92(.a(x6), .b(new_n25_), .c(new_n19_), .O(z9));
endmodule
