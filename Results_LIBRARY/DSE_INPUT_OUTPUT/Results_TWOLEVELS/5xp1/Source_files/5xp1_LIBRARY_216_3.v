...
module FAU ( 
  ...
  oai22  g022(.a(new_n39_), .b(new_n37_), .c(new_n36_), .d(new_n22_), .O(new_n40_));
  ...
  and2   g039(.a(x6), .b(x4), .O(new_n57_));
  ...
  oai21  g061(.a(new_n78_), .b(new_n77_), .c(x5), .O(new_n79_));
  nand2  g062(.a(new_n28_), .b(new_n18_), .O(new_n80_));
  nand4  g063(.a(new_n80_), .b(new_n23_), .c(x3), .d(x2), .O(new_n81_));
  nand2  g064(.a(new_n81_), .b(new_n79_), .O(new_n82_));
  nand2  g065(.a(new_n82_), .b(new_n22_), .O(new_n83_));
  nand2  g066(.a(new_n50_), .b(x2), .O(new_n84_));
  nand2  g067(.a(new_n69_), .b(x0), .O(new_n85_));
  oai21  g068(.a(new_n84_), .b(new_n19_), .c(new_n85_), .O(new_n86_));
  nand2  g069(.a(new_n86_), .b(new_n18_), .O(new_n87_));
  nand3  g070(.a(x6), .b(x2), .c(x0), .O(new_n88_));
  aoi21  g071(.a(new_n88_), .b(new_n51_), .c(new_n23_), .O(new_n89_));
  aoi21  g072(.a(new_n23_), .b(new_n44_), .c(x1), .O(new_n90_));
  oai22  g073(.a(new_n90_), .b(new_n22_), .c(new_n36_), .d(new_n18_), .O(new_n91_));
  nor2   g074(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand3  g075(.a(new_n92_), .b(new_n87_), .c(new_n83_), .O(z3));
  nand3  g076(.a(new_n28_), .b(x1), .c(new_n22_), .O(new_n94_));
  oai21  g077(.a(new_n28_), .b(x1), .c(new_n94_), .O(new_n95_));
  nand2  g078(.a(new_n95_), .b(new_n44_), .O(new_n96_));
  nand2  g079(.a(new_n28_), .b(new_n50_), .O(new_n97_));
  nand3  g080(.a(x6), .b(x3), .c(x2), .O(new_n98_));
  aoi21  g081(.a(new_n98_), .b(new_n97_), .c(new_n18_), .O(new_n99_));
  nand3  g082(.a(x6), .b(new_n50_), .c(new_n18_), .O(new_n100_));
  inv1   g083(.a(new_n100_), .O(new_n101_));
  oai21  g084(.a(new_n101_), .b(new_n99_), .c(new_n22_), .O(new_n102_));
  nand2  g085(.a(new_n50_), .b(new_n22_), .O(new_n103_));
  nand4  g086(.a(new_n103_), .b(new_n28_), .c(x2), .d(new_n18_), .O(new_n104_));
  nand3  g087(.a(new_n104_), .b(new_n102_), .c(new_n96_), .O(z4));
  nand2  g088(.a(x3), .b(new_n44_), .O(new_n106_));
  oai21  g089(.a(new_n106_), .b(new_n18_), .c(new_n84_), .O(new_n107_));
  nand2  g090(.a(new_n107_), .b(new_n22_), .O(new_n108_));
  nand3  g091(.a(new_n50_), .b(x2), .c(new_n18_), .O(new_n109_));
  nand2  g092(.a(new_n109_), .b(x0), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(new_n108_), .O(z5));
  nand2  g094(.a(x3), .b(new_n44_), .O(new_n112_));
  nand3  g095(.a(new_n112_), .b(x1), .c(new_n22_), .O(new_n113_));
  oai21  g096(.a(new_n106_), .b(x1), .c(new_n113_), .O(z6));
  aoi22  g097(.a(new_n106_), .b(new_n84_), .c(x1), .d(x0), .O(z7));
  aoi21  g098(.a(x1), .b(x0), .c(x3), .O(z8));
  aoi21  g099(.a(x5), .b(x4), .c(x1), .O(new_n117_));
  nand2  g100(.a(x1), .b(new_n22_), .O(new_n118_));
  oai21  g101(.a(new_n118_), .b(new_n32_), .c(new_n28_), .O(new_n119_));
  nand3  g102(.a(new_n119_), .b(x5), .c(x4), .O(new_n120_));
  oai21  g103(.a(new_n117_), .b(new_n22_), .c(new_n120_), .O(z9));
endmodule
