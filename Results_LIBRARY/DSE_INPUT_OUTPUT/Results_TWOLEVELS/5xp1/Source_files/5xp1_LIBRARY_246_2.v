...
module FAU ( 
  ...
  nand4  g22(.a(new_n23_), .b(x6), .c(new_n21_), .d(new_n22_), .O(new_n40_));
  nand2  g23(.a(new_n29_), .b(new_n37_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(new_n40_), .c(x0), .O(new_n42_));
  aoi21  g25(.a(x3), .b(x1), .c(x6), .O(new_n43_));
  ...
  nand2  g43(.a(new_n56_), .b(x0), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(x6), .c(new_n18_), .d(new_n21_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n60_), .c(new_n55_), .O(z2));
  aoi21  g46(.a(new_n23_), .b(new_n29_), .c(new_n22_), .O(new_n64_));
  ...
  nand3  g51(.a(new_n68_), .b(x5), .c(new_n37_), .O(new_n69_));
  nand2  g52(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n28_), .O(new_n71_));
  nor2   g54(.a(x3), .b(new_n37_), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n29_), .c(new_n22_), .O(new_n73_));
  inv1   g56(.a(x3), .O(new_n74_));
  nand2  g57(.a(new_n29_), .b(new_n74_), .O(new_n75_));
  nand3  g58(.a(new_n75_), .b(new_n73_), .c(new_n61_), .O(new_n76_));
  nand3  g59(.a(new_n18_), .b(new_n37_), .c(new_n22_), .O(new_n77_));
  ...
  xor2a  g63(.a(new_n23_), .b(new_n22_), .O(new_n81_));
  nor2   g64(.a(new_n29_), .b(x3), .O(new_n82_));
  aoi22  g65(.a(new_n82_), .b(new_n22_), .c(new_n81_), .d(new_n29_), .O(new_n83_));
  nand2  g66(.a(x2), .b(x1), .O(new_n84_));
  aoi22  g67(.a(new_n56_), .b(new_n84_), .c(new_n74_), .d(new_n28_), .O(new_n85_));
  nand3  g68(.a(x3), .b(new_n37_), .c(x0), .O(new_n86_));
  inv1   g69(.a(new_n86_), .O(new_n87_));
  oai21  g70(.a(new_n87_), .b(new_n85_), .c(x6), .O(new_n88_));
  oai21  g71(.a(new_n83_), .b(x0), .c(new_n88_), .O(z4));
  nand3  g72(.a(x3), .b(new_n37_), .c(x1), .O(new_n90_));
  inv1   g73(.a(new_n90_), .O(new_n91_));
  oai21  g74(.a(new_n91_), .b(new_n72_), .c(new_n28_), .O(new_n92_));
  nand2  g75(.a(new_n23_), .b(x6), .O(new_n93_));
  oai21  g76(.a(new_n29_), .b(x1), .c(x3), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n37_), .c(new_n93_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n28_), .c(new_n92_), .O(z5));
  nand2  g79(.a(new_n29_), .b(x0), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n37_), .O(new_n98_));
  ...
  aoi21  g84(.a(new_n101_), .b(new_n29_), .c(new_n37_), .O(new_n102_));
  aoi21  g85(.a(new_n102_), .b(x1), .c(new_n99_), .O(new_n103_));
  nand2  g86(.a(new_n29_), .b(x0), .O(new_n104_));
  nand3  g87(.a(new_n104_), .b(new_n74_), .c(x1), .O(new_n105_));
  oai21  g88(.a(new_n103_), .b(new_n74_), .c(new_n105_), .O(z6));
  nand3  g89(.a(new_n97_), .b(new_n74_), .c(x2), .O(new_n107_));
  nand2  g90(.a(new_n29_), .b(x0), .O(new_n108_));
  nand3  g91(.a(new_n108_), .b(x3), .c(new_n37_), .O(new_n109_));
  ...
  nand2  g97(.a(new_n114_), .b(new_n97_), .O(z9));
endmodule
