...
module FAU ( 
  ...
  nand4  g10(.a(new_n24_), .b(x6), .c(new_n23_), .d(new_n22_), .O(new_n28_));
  ...
  nand3  g15(.a(new_n32_), .b(x6), .c(new_n18_), .O(new_n33_));
  ...
  nand3  g25(.a(new_n24_), .b(x5), .c(new_n22_), .O(new_n43_));
  ...
  oai21  g33(.a(new_n18_), .b(new_n22_), .c(new_n50_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n19_), .c(new_n21_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n47_), .O(z2));
  nand2  g36(.a(new_n24_), .b(new_n19_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x1), .O(new_n55_));
  nand3  g38(.a(x6), .b(x3), .c(x2), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n55_), .c(x5), .O(new_n57_));
  nand2  g40(.a(new_n19_), .b(new_n21_), .O(new_n58_));
  aoi21  g41(.a(new_n19_), .b(new_n21_), .c(new_n24_), .O(new_n59_));
  oai22  g42(.a(new_n59_), .b(x1), .c(new_n58_), .d(x2), .O(new_n60_));
  ...
  oai21  g50(.a(new_n67_), .b(new_n66_), .c(new_n18_), .O(new_n68_));
  nand2  g51(.a(new_n68_), .b(new_n65_), .O(new_n69_));
  inv1   g52(.a(x3), .O(new_n70_));
  and2   g53(.a(x2), .b(x1), .O(new_n71_));
  nand4  g54(.a(new_n71_), .b(x5), .c(new_n21_), .d(new_n70_), .O(new_n72_));
  aoi21  g55(.a(new_n72_), .b(new_n21_), .c(x6), .O(new_n73_));
  aoi21  g56(.a(new_n69_), .b(x0), .c(new_n73_), .O(new_n74_));
  oai21  g57(.a(new_n61_), .b(x0), .c(new_n74_), .O(z3));
  nand2  g58(.a(x6), .b(x1), .O(new_n76_));
  oai21  g59(.a(new_n58_), .b(x1), .c(new_n76_), .O(new_n77_));
  nand2  g60(.a(new_n70_), .b(new_n22_), .O(new_n78_));
  nand3  g61(.a(new_n78_), .b(new_n77_), .c(x2), .O(new_n79_));
  aoi21  g62(.a(new_n78_), .b(x2), .c(x1), .O(new_n80_));
  nand2  g63(.a(x3), .b(new_n36_), .O(new_n81_));
  inv1   g64(.a(new_n81_), .O(new_n82_));
  nand2  g65(.a(new_n82_), .b(x0), .O(new_n83_));
  inv1   g66(.a(new_n83_), .O(new_n84_));
  oai21  g67(.a(new_n84_), .b(new_n80_), .c(x6), .O(new_n85_));
  oai21  g68(.a(new_n70_), .b(new_n36_), .c(new_n22_), .O(new_n86_));
  oai21  g69(.a(x3), .b(x2), .c(new_n86_), .O(new_n87_));
  nand4  g70(.a(new_n87_), .b(new_n19_), .c(new_n21_), .d(x1), .O(new_n88_));
  nand3  g71(.a(new_n88_), .b(new_n85_), .c(new_n79_), .O(z4));
  nand2  g72(.a(new_n19_), .b(x4), .O(new_n90_));
  nand4  g73(.a(new_n90_), .b(x3), .c(x1), .d(new_n22_), .O(new_n91_));
  inv1   g74(.a(new_n91_), .O(new_n92_));
  oai21  g75(.a(x6), .b(new_n21_), .c(new_n70_), .O(new_n93_));
  nand2  g76(.a(x6), .b(new_n23_), .O(new_n94_));
  aoi21  g77(.a(new_n94_), .b(new_n93_), .c(new_n22_), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n92_), .c(new_n36_), .O(new_n96_));
  nor2   g79(.a(x6), .b(new_n21_), .O(new_n97_));
  nand2  g80(.a(x3), .b(x0), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(new_n78_), .c(new_n97_), .O(new_n99_));
  nand2  g82(.a(new_n99_), .b(x2), .O(new_n100_));
  nand4  g83(.a(new_n21_), .b(x3), .c(new_n23_), .d(x0), .O(new_n101_));
  nand3  g84(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z5));
  oai21  g85(.a(new_n18_), .b(new_n70_), .c(new_n22_), .O(new_n103_));
  nand3  g86(.a(new_n103_), .b(new_n19_), .c(new_n21_), .O(new_n104_));
  ...
  aoi21  g90(.a(new_n82_), .b(new_n23_), .c(new_n97_), .O(new_n108_));
  nand2  g91(.a(new_n108_), .b(new_n107_), .O(z6));
  aoi21  g92(.a(new_n21_), .b(x1), .c(x6), .O(new_n110_));
  aoi21  g93(.a(new_n90_), .b(new_n22_), .c(new_n23_), .O(new_n111_));
  oai21  g94(.a(new_n110_), .b(new_n22_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g99(.a(x6), .b(new_n18_), .c(new_n21_), .O(z9));
endmodule
