...
module FAU ( 
  ...
  nand3  g46(.a(x6), .b(new_n63_), .c(x2), .O(new_n64_));
  aoi21  g47(.a(new_n64_), .b(new_n62_), .c(new_n18_), .O(new_n65_));
  nand3  g48(.a(new_n18_), .b(new_n42_), .c(x0), .O(new_n66_));
  inv1   g49(.a(new_n66_), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n65_), .c(new_n31_), .O(new_n68_));
  inv1   g51(.a(new_n51_), .O(new_n69_));
  nor2   g52(.a(new_n32_), .b(new_n63_), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(x2), .O(new_n71_));
  aoi21  g54(.a(new_n71_), .b(new_n31_), .c(x0), .O(new_n72_));
  oai21  g55(.a(new_n72_), .b(new_n69_), .c(new_n18_), .O(new_n73_));
  inv1   g56(.a(new_n59_), .O(new_n74_));
  aoi21  g57(.a(new_n61_), .b(new_n31_), .c(new_n18_), .O(new_n75_));
  aoi21  g58(.a(new_n75_), .b(x0), .c(new_n74_), .O(new_n76_));
  nand3  g59(.a(new_n76_), .b(new_n73_), .c(new_n68_), .O(z3));
  aoi21  g60(.a(new_n63_), .b(new_n22_), .c(new_n42_), .O(new_n78_));
  nand3  g61(.a(x3), .b(new_n42_), .c(x0), .O(new_n79_));
  oai21  g62(.a(new_n78_), .b(x1), .c(new_n79_), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(x6), .O(new_n81_));
  aoi22  g64(.a(x6), .b(new_n31_), .c(new_n63_), .d(new_n22_), .O(new_n82_));
  aoi21  g65(.a(new_n82_), .b(x2), .c(new_n74_), .O(new_n83_));
  nand2  g66(.a(new_n83_), .b(new_n81_), .O(z4));
  nand3  g67(.a(new_n59_), .b(new_n63_), .c(x2), .O(new_n85_));
  nand3  g68(.a(new_n70_), .b(new_n42_), .c(x1), .O(new_n86_));
  nand2  g69(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g70(.a(new_n87_), .b(new_n22_), .O(new_n88_));
  nor2   g71(.a(x3), .b(new_n42_), .O(new_n89_));
  nor2   g72(.a(new_n89_), .b(x1), .O(new_n90_));
  nand2  g73(.a(new_n63_), .b(new_n42_), .O(new_n91_));
  aoi21  g74(.a(new_n91_), .b(new_n23_), .c(new_n32_), .O(new_n92_));
  oai21  g75(.a(new_n92_), .b(new_n90_), .c(x0), .O(new_n93_));
  nand2  g76(.a(new_n93_), .b(new_n88_), .O(z5));
  xor2a  g77(.a(x2), .b(x1), .O(new_n95_));
  oai21  g78(.a(new_n32_), .b(new_n63_), .c(x1), .O(new_n96_));
  oai21  g79(.a(new_n95_), .b(new_n63_), .c(new_n96_), .O(z6));
  nor2   g80(.a(x2), .b(x0), .O(new_n98_));
  aoi21  g81(.a(new_n98_), .b(x3), .c(new_n32_), .O(new_n99_));
  nand2  g82(.a(x6), .b(x0), .O(new_n100_));
  aoi21  g83(.a(new_n100_), .b(x1), .c(new_n63_), .O(new_n101_));
  aoi21  g84(.a(new_n101_), .b(new_n42_), .c(new_n89_), .O(new_n102_));
  oai21  g85(.a(new_n99_), .b(new_n31_), .c(new_n102_), .O(z7));
  aoi21  g86(.a(new_n32_), .b(x1), .c(x3), .O(z8));
  oai21  g87(.a(x1), .b(new_n22_), .c(new_n32_), .O(new_n105_));
