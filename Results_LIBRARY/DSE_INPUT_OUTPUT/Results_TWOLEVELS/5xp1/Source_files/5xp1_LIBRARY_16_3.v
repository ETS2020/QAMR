...
module FAU ( 
  ...
  aoi21  g007(.a(x1), .b(x0), .c(x6), .O(new_n25_));
  aoi21  g008(.a(new_n24_), .b(new_n18_), .c(new_n25_), .O(new_n26_));
  ...
  nor2   g030(.a(x6), .b(x5), .O(new_n48_));
  nand4  g031(.a(new_n48_), .b(x4), .c(x1), .d(x0), .O(new_n49_));
  aoi21  g032(.a(new_n49_), .b(new_n20_), .c(new_n18_), .O(new_n50_));
  ...
  aoi21  g038(.a(new_n55_), .b(new_n47_), .c(new_n50_), .O(new_n56_));
  nand2  g039(.a(new_n56_), .b(new_n46_), .O(z1));
  ...
  aoi21  g044(.a(new_n60_), .b(new_n18_), .c(new_n61_), .O(new_n62_));
  aoi21  g045(.a(new_n62_), .b(new_n59_), .c(new_n35_), .O(new_n63_));
  ...
  oai21  g051(.a(new_n68_), .b(new_n63_), .c(new_n20_), .O(new_n69_));
  nor2   g052(.a(x5), .b(x1), .O(new_n70_));
  nor2   g053(.a(new_n70_), .b(new_n28_), .O(new_n71_));
  aoi21  g054(.a(x5), .b(x1), .c(new_n71_), .O(new_n72_));
  aoi21  g055(.a(x5), .b(x1), .c(x0), .O(new_n73_));
  oai21  g056(.a(new_n73_), .b(new_n70_), .c(new_n35_), .O(new_n74_));
  oai21  g057(.a(new_n72_), .b(new_n35_), .c(new_n74_), .O(new_n75_));
  nand3  g058(.a(new_n75_), .b(x6), .c(new_n18_), .O(new_n76_));
  nand2  g059(.a(new_n76_), .b(new_n69_), .O(z2));
  nand2  g060(.a(new_n20_), .b(new_n29_), .O(new_n78_));
  nand2  g061(.a(new_n78_), .b(x0), .O(new_n79_));
  nand2  g062(.a(new_n29_), .b(x2), .O(new_n80_));
  aoi21  g063(.a(new_n80_), .b(new_n79_), .c(new_n47_), .O(new_n81_));
  aoi21  g064(.a(x3), .b(x2), .c(x6), .O(new_n82_));
  nor3   g065(.a(new_n82_), .b(x5), .c(x0), .O(new_n83_));
  oai21  g066(.a(new_n83_), .b(new_n81_), .c(x1), .O(new_n84_));
  oai21  g067(.a(new_n78_), .b(x2), .c(x1), .O(new_n85_));
  nand3  g068(.a(new_n85_), .b(new_n47_), .c(x0), .O(new_n86_));
  nand2  g069(.a(x6), .b(x2), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(new_n36_), .O(new_n88_));
  nand2  g071(.a(new_n20_), .b(new_n18_), .O(new_n89_));
  aoi21  g072(.a(new_n89_), .b(new_n88_), .c(new_n47_), .O(new_n90_));
  nor2   g073(.a(new_n20_), .b(new_n18_), .O(new_n91_));
  aoi21  g074(.a(new_n90_), .b(new_n28_), .c(new_n91_), .O(new_n92_));
  nand3  g075(.a(new_n92_), .b(new_n86_), .c(new_n84_), .O(z3));
  oai22  g076(.a(new_n20_), .b(new_n29_), .c(new_n18_), .d(x1), .O(new_n94_));
  nand2  g077(.a(new_n94_), .b(x0), .O(new_n95_));
  oai21  g078(.a(new_n29_), .b(new_n18_), .c(new_n28_), .O(new_n96_));
  ...
  oai22  g084(.a(new_n78_), .b(new_n18_), .c(new_n19_), .d(new_n36_), .O(new_n102_));
  nand2  g085(.a(new_n102_), .b(new_n28_), .O(new_n103_));
  aoi21  g086(.a(x3), .b(x1), .c(x2), .O(new_n104_));
  nand3  g087(.a(new_n20_), .b(x3), .c(x2), .O(new_n105_));
  ...
  aoi22  g092(.a(new_n109_), .b(x0), .c(x5), .d(x3), .O(new_n110_));
  nand3  g093(.a(new_n47_), .b(x3), .c(new_n28_), .O(new_n111_));
  oai21  g094(.a(new_n110_), .b(x6), .c(new_n111_), .O(new_n112_));
  aoi21  g095(.a(new_n112_), .b(x2), .c(new_n29_), .O(new_n113_));
  inv1   g096(.a(new_n19_), .O(new_n114_));
  aoi21  g097(.a(new_n114_), .b(new_n36_), .c(new_n91_), .O(new_n115_));
  oai21  g098(.a(new_n113_), .b(new_n36_), .c(new_n115_), .O(z6));
  nand2  g099(.a(new_n24_), .b(x2), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n19_), .O(z7));
  aoi21  g101(.a(x6), .b(x2), .c(x3), .O(z8));
  nand2  g102(.a(new_n87_), .b(x0), .O(new_n120_));
  nor2   g103(.a(new_n20_), .b(x2), .O(new_n121_));
  oai21  g104(.a(new_n106_), .b(new_n121_), .c(x1), .O(new_n122_));
  nand3  g105(.a(new_n121_), .b(new_n36_), .c(new_n28_), .O(new_n123_));
