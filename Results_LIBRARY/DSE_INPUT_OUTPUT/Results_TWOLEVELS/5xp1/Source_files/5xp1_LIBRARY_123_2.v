...
module FAU ( 
  ...
  nor2   g50(.a(new_n59_), .b(x2), .O(new_n68_));
  aoi21  g51(.a(x2), .b(x1), .c(new_n68_), .O(new_n69_));
  nor2   g52(.a(new_n69_), .b(new_n28_), .O(new_n70_));
  ...
  nand2  g70(.a(new_n43_), .b(new_n23_), .O(new_n88_));
  oai21  g71(.a(new_n64_), .b(new_n23_), .c(new_n88_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(x3), .O(new_n90_));
  oai21  g73(.a(new_n22_), .b(new_n59_), .c(x1), .O(new_n91_));
  nand2  g74(.a(new_n91_), .b(new_n90_), .O(z6));
  nand3  g75(.a(x6), .b(x3), .c(new_n43_), .O(new_n93_));
  nand4  g76(.a(new_n22_), .b(new_n59_), .c(x2), .d(new_n23_), .O(new_n94_));
  nand2  g77(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g78(.a(new_n95_), .b(x0), .O(new_n96_));
  nand2  g79(.a(new_n80_), .b(new_n60_), .O(new_n97_));
  nand2  g80(.a(new_n97_), .b(new_n28_), .O(new_n98_));
  nor2   g81(.a(new_n22_), .b(x3), .O(new_n99_));
  aoi22  g82(.a(new_n99_), .b(x2), .c(new_n68_), .d(new_n23_), .O(new_n100_));
  nand3  g83(.a(new_n100_), .b(new_n98_), .c(new_n96_), .O(z7));
  aoi21  g84(.a(new_n22_), .b(x1), .c(x3), .O(z8));
  oai21  g85(.a(x6), .b(x0), .c(x5), .O(new_n103_));
  oai21  g86(.a(new_n103_), .b(new_n18_), .c(new_n78_), .O(z9));
endmodule
