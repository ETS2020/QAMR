...
module FAU ( 
  ...
  oai21  g73(.a(new_n29_), .b(x3), .c(x1), .O(new_n91_));
  nand2  g74(.a(new_n23_), .b(x6), .O(new_n92_));
  aoi21  g75(.a(new_n91_), .b(new_n37_), .c(new_n92_), .O(new_n93_));
  oai21  g76(.a(new_n93_), .b(new_n28_), .c(new_n90_), .O(z5));
  ...
  nand2  g87(.a(x1), .b(new_n28_), .O(new_n105_));
  oai21  g88(.a(new_n105_), .b(new_n23_), .c(new_n29_), .O(new_n106_));
