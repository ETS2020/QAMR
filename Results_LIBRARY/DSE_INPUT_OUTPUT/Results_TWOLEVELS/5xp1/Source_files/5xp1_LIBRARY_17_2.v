...
module FAU ( 
  ...
  oai21  g060(.a(x6), .b(x1), .c(new_n33_), .O(new_n78_));
  nand2  g061(.a(new_n78_), .b(x0), .O(new_n79_));
  nand2  g062(.a(x6), .b(new_n33_), .O(new_n80_));
  oai21  g063(.a(x6), .b(new_n35_), .c(new_n80_), .O(new_n81_));
  nand3  g064(.a(new_n81_), .b(x3), .c(new_n64_), .O(new_n82_));
  nand3  g065(.a(x5), .b(new_n63_), .c(new_n35_), .O(new_n83_));
  nand3  g066(.a(new_n83_), .b(new_n82_), .c(new_n79_), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(x2), .O(new_n85_));
  nand3  g068(.a(x5), .b(new_n66_), .c(new_n35_), .O(new_n86_));
  oai21  g069(.a(new_n80_), .b(new_n35_), .c(new_n86_), .O(new_n87_));
  nand2  g070(.a(new_n87_), .b(new_n64_), .O(new_n88_));
  nand2  g071(.a(new_n60_), .b(new_n35_), .O(new_n89_));
  aoi21  g072(.a(new_n36_), .b(new_n34_), .c(x5), .O(new_n90_));
  oai21  g073(.a(new_n90_), .b(new_n35_), .c(new_n89_), .O(new_n91_));
  aoi21  g074(.a(new_n91_), .b(x0), .c(new_n49_), .O(new_n92_));
  nand3  g075(.a(new_n92_), .b(new_n88_), .c(new_n85_), .O(z3));
  nand2  g076(.a(new_n53_), .b(new_n36_), .O(new_n94_));
  nand2  g077(.a(x6), .b(x2), .O(new_n95_));
  aoi21  g078(.a(new_n95_), .b(new_n94_), .c(new_n64_), .O(new_n96_));
  nand4  g079(.a(new_n43_), .b(new_n34_), .c(new_n33_), .d(new_n64_), .O(new_n97_));
  nand3  g080(.a(x6), .b(x3), .c(x2), .O(new_n98_));
  nand2  g081(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g082(.a(new_n99_), .b(new_n96_), .c(x1), .O(new_n100_));
  nand3  g083(.a(x6), .b(x3), .c(new_n66_), .O(new_n101_));
  nand3  g084(.a(new_n53_), .b(x2), .c(new_n35_), .O(new_n102_));
  aoi21  g085(.a(new_n102_), .b(new_n101_), .c(new_n64_), .O(new_n103_));
  aoi21  g086(.a(new_n63_), .b(new_n64_), .c(new_n66_), .O(new_n104_));
  inv1   g087(.a(new_n43_), .O(new_n105_));
  nand2  g088(.a(new_n53_), .b(new_n105_), .O(new_n106_));
  oai21  g089(.a(new_n104_), .b(new_n34_), .c(new_n106_), .O(new_n107_));
  aoi21  g090(.a(new_n107_), .b(new_n35_), .c(new_n103_), .O(new_n108_));
  nand2  g091(.a(new_n108_), .b(new_n100_), .O(z4));
  nand2  g092(.a(x3), .b(new_n66_), .O(new_n110_));
  nand2  g093(.a(new_n63_), .b(x2), .O(new_n111_));
  oai21  g094(.a(new_n110_), .b(new_n35_), .c(new_n111_), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(new_n64_), .O(new_n113_));
  aoi21  g096(.a(x3), .b(x1), .c(x2), .O(new_n114_));
  oai21  g097(.a(new_n114_), .b(new_n105_), .c(x0), .O(new_n115_));
  nand3  g098(.a(new_n115_), .b(new_n113_), .c(new_n50_), .O(z5));
  nand2  g099(.a(x6), .b(new_n19_), .O(new_n117_));
  nand3  g100(.a(new_n117_), .b(new_n33_), .c(x0), .O(new_n118_));
  oai21  g101(.a(x6), .b(new_n64_), .c(x3), .O(new_n119_));
  aoi21  g102(.a(new_n119_), .b(new_n118_), .c(new_n66_), .O(new_n120_));
  oai21  g103(.a(new_n120_), .b(new_n63_), .c(x1), .O(new_n121_));
  inv1   g104(.a(new_n110_), .O(new_n122_));
  aoi21  g105(.a(new_n122_), .b(new_n35_), .c(new_n49_), .O(new_n123_));
  nand2  g106(.a(new_n123_), .b(new_n121_), .O(z6));
  aoi21  g107(.a(new_n111_), .b(new_n110_), .c(new_n49_), .O(z7));
  nand2  g108(.a(new_n50_), .b(x3), .O(z8));
  aoi21  g109(.a(x6), .b(new_n19_), .c(new_n33_), .O(z9));
endmodule
