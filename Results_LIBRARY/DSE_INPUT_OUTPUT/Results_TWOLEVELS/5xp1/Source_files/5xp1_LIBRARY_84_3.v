...
module FAU ( 
  ...
  oai21  g022(.a(new_n26_), .b(new_n33_), .c(new_n18_), .O(new_n40_));
  oai21  g023(.a(new_n26_), .b(new_n33_), .c(new_n19_), .O(new_n41_));
  nand2  g024(.a(new_n26_), .b(new_n32_), .O(new_n42_));
  nand3  g025(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(new_n43_));
  nand2  g026(.a(new_n43_), .b(new_n22_), .O(new_n44_));
  oai21  g027(.a(new_n34_), .b(new_n32_), .c(new_n22_), .O(new_n45_));
  nand3  g028(.a(new_n45_), .b(new_n26_), .c(new_n33_), .O(new_n46_));
  ...
  aoi21  g034(.a(new_n51_), .b(new_n50_), .c(new_n22_), .O(new_n52_));
  nor2   g035(.a(new_n26_), .b(new_n33_), .O(new_n53_));
  ...
  aoi21  g041(.a(new_n58_), .b(new_n57_), .c(new_n26_), .O(new_n59_));
  oai21  g042(.a(new_n49_), .b(new_n22_), .c(new_n32_), .O(new_n60_));
  ...
  nand2  g048(.a(new_n20_), .b(x0), .O(new_n66_));
  nor2   g049(.a(x6), .b(new_n49_), .O(new_n67_));
  nand3  g050(.a(new_n67_), .b(x3), .c(x2), .O(new_n68_));
  aoi21  g051(.a(new_n68_), .b(new_n66_), .c(new_n32_), .O(new_n69_));
  aoi21  g052(.a(x5), .b(x0), .c(x2), .O(new_n70_));
  aoi21  g053(.a(x5), .b(x3), .c(x0), .O(new_n71_));
  oai21  g054(.a(new_n71_), .b(new_n70_), .c(x6), .O(new_n72_));
  nand2  g055(.a(new_n67_), .b(x0), .O(new_n73_));
  nand2  g056(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  oai21  g057(.a(new_n74_), .b(new_n69_), .c(new_n33_), .O(new_n75_));
  nand3  g058(.a(new_n75_), .b(new_n65_), .c(new_n55_), .O(z2));
  nor2   g059(.a(x3), .b(x2), .O(new_n77_));
  inv1   g060(.a(new_n77_), .O(new_n78_));
  nand2  g061(.a(new_n51_), .b(new_n32_), .O(new_n79_));
  aoi21  g062(.a(new_n79_), .b(new_n78_), .c(x5), .O(new_n80_));
  nand2  g063(.a(x3), .b(x1), .O(new_n81_));
  nand3  g064(.a(x6), .b(x2), .c(new_n32_), .O(new_n82_));
  aoi21  g065(.a(new_n82_), .b(new_n81_), .c(new_n49_), .O(new_n83_));
  oai21  g066(.a(new_n83_), .b(new_n80_), .c(x0), .O(new_n84_));
  nand3  g067(.a(new_n49_), .b(x3), .c(new_n22_), .O(new_n85_));
  aoi22  g068(.a(new_n85_), .b(new_n27_), .c(new_n26_), .d(new_n32_), .O(new_n86_));
  nand2  g069(.a(new_n86_), .b(x2), .O(new_n87_));
  nand2  g070(.a(new_n42_), .b(x2), .O(new_n88_));
  nand3  g071(.a(new_n88_), .b(x5), .c(new_n22_), .O(new_n89_));
  nand4  g072(.a(new_n89_), .b(new_n87_), .c(new_n84_), .d(new_n55_), .O(z3));
  nand2  g073(.a(x2), .b(new_n32_), .O(new_n91_));
  nand2  g074(.a(new_n77_), .b(x1), .O(new_n92_));
  aoi21  g075(.a(new_n92_), .b(new_n91_), .c(new_n22_), .O(new_n93_));
  nand2  g076(.a(x3), .b(x2), .O(new_n94_));
  nand3  g077(.a(new_n94_), .b(x1), .c(new_n22_), .O(new_n95_));
  oai21  g078(.a(new_n34_), .b(x1), .c(new_n95_), .O(new_n96_));
  oai21  g079(.a(new_n96_), .b(new_n93_), .c(new_n26_), .O(new_n97_));
  nor2   g080(.a(x3), .b(new_n18_), .O(new_n98_));
  nand3  g081(.a(new_n98_), .b(new_n32_), .c(new_n22_), .O(new_n99_));
  nand3  g082(.a(new_n99_), .b(x2), .c(new_n32_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(x6), .O(new_n101_));
  nand2  g084(.a(new_n101_), .b(new_n97_), .O(z4));
  nand2  g085(.a(x6), .b(x1), .O(new_n103_));
  nand3  g086(.a(new_n103_), .b(new_n19_), .c(x2), .O(new_n104_));
  nand4  g087(.a(new_n26_), .b(x3), .c(new_n18_), .d(x1), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(new_n22_), .O(new_n107_));
  nand2  g090(.a(new_n34_), .b(new_n78_), .O(new_n108_));
  nand3  g091(.a(new_n108_), .b(new_n26_), .c(x1), .O(new_n109_));
  oai21  g092(.a(new_n98_), .b(x1), .c(new_n109_), .O(new_n110_));
  nand2  g093(.a(new_n110_), .b(x0), .O(new_n111_));
  nand2  g094(.a(new_n111_), .b(new_n107_), .O(z5));
  oai21  g095(.a(x5), .b(new_n18_), .c(x3), .O(new_n113_));
  nand2  g096(.a(new_n113_), .b(new_n22_), .O(new_n114_));
  nand2  g097(.a(x5), .b(x3), .O(new_n115_));
  nand3  g098(.a(new_n49_), .b(new_n19_), .c(x0), .O(new_n116_));
  aoi21  g099(.a(new_n116_), .b(new_n115_), .c(new_n33_), .O(new_n117_));
  oai21  g100(.a(new_n33_), .b(x3), .c(x0), .O(new_n118_));
  oai21  g101(.a(new_n33_), .b(new_n19_), .c(x5), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  oai21  g103(.a(new_n120_), .b(new_n117_), .c(x2), .O(new_n121_));
  nand2  g104(.a(new_n77_), .b(x0), .O(new_n122_));
  nand3  g105(.a(new_n122_), .b(new_n121_), .c(new_n114_), .O(new_n123_));
  nand3  g106(.a(new_n123_), .b(new_n26_), .c(x1), .O(new_n124_));
  nor2   g107(.a(new_n19_), .b(x2), .O(new_n125_));
  nand2  g108(.a(new_n125_), .b(new_n32_), .O(new_n126_));
  nand2  g109(.a(new_n126_), .b(new_n124_), .O(z6));
  nor2   g110(.a(new_n98_), .b(new_n125_), .O(new_n128_));
  nand2  g111(.a(new_n128_), .b(new_n55_), .O(z7));
  nor2   g112(.a(new_n49_), .b(new_n33_), .O(new_n130_));
  nand4  g113(.a(new_n130_), .b(new_n49_), .c(x2), .d(x0), .O(new_n131_));
  nand2  g114(.a(new_n131_), .b(new_n26_), .O(new_n132_));
  aoi21  g115(.a(new_n132_), .b(x1), .c(x3), .O(z8));
  nand2  g116(.a(new_n67_), .b(x4), .O(new_n134_));
  oai21  g117(.a(new_n134_), .b(new_n34_), .c(new_n26_), .O(new_n135_));
