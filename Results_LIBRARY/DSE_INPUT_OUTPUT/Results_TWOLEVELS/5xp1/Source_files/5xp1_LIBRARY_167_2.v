...
module FAU ( 
  ...
  nor2   g48(.a(new_n56_), .b(x2), .O(new_n66_));
  aoi22  g49(.a(new_n66_), .b(x0), .c(new_n65_), .d(new_n19_), .O(new_n67_));
  aoi22  g50(.a(x6), .b(new_n19_), .c(new_n56_), .d(new_n21_), .O(new_n68_));
  nand2  g51(.a(new_n29_), .b(x1), .O(new_n69_));
  inv1   g52(.a(new_n69_), .O(new_n70_));
  aoi21  g53(.a(new_n68_), .b(x2), .c(new_n70_), .O(new_n71_));
  oai21  g54(.a(new_n67_), .b(new_n29_), .c(new_n71_), .O(z4));
  nor3   g55(.a(new_n70_), .b(x3), .c(new_n40_), .O(new_n73_));
  nand4  g56(.a(x6), .b(x3), .c(new_n40_), .d(x1), .O(new_n74_));
  inv1   g57(.a(new_n74_), .O(new_n75_));
  oai21  g58(.a(new_n75_), .b(new_n73_), .c(new_n21_), .O(new_n76_));
  aoi21  g59(.a(new_n56_), .b(x2), .c(x1), .O(new_n77_));
  nand2  g60(.a(new_n56_), .b(new_n40_), .O(new_n78_));
  aoi21  g61(.a(new_n78_), .b(new_n30_), .c(new_n29_), .O(new_n79_));
  oai21  g62(.a(new_n79_), .b(new_n77_), .c(x0), .O(new_n80_));
  nand2  g63(.a(new_n80_), .b(new_n76_), .O(z5));
  xor2a  g64(.a(x2), .b(x1), .O(new_n82_));
  oai21  g65(.a(new_n29_), .b(new_n56_), .c(x1), .O(new_n83_));
  oai21  g66(.a(new_n82_), .b(new_n56_), .c(new_n83_), .O(z6));
  nand3  g67(.a(x6), .b(x3), .c(new_n40_), .O(new_n85_));
  ...
  nand2  g71(.a(new_n74_), .b(new_n57_), .O(new_n89_));
  nand2  g72(.a(new_n89_), .b(new_n21_), .O(new_n90_));
  nor2   g73(.a(new_n29_), .b(x3), .O(new_n91_));
  aoi22  g74(.a(new_n91_), .b(x2), .c(new_n66_), .d(new_n19_), .O(new_n92_));
  nand3  g75(.a(new_n92_), .b(new_n90_), .c(new_n88_), .O(z7));
  aoi21  g76(.a(new_n29_), .b(x1), .c(x3), .O(z8));
  oai21  g77(.a(x6), .b(x0), .c(x5), .O(new_n95_));
  oai21  g78(.a(new_n95_), .b(new_n18_), .c(new_n69_), .O(z9));
endmodule
