...
module FAU ( 
  ...
  nand3  g057(.a(new_n18_), .b(x2), .c(new_n44_), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g059(.a(new_n76_), .b(x3), .O(new_n77_));
  xnor2a g060(.a(x5), .b(x0), .O(new_n78_));
  nand3  g061(.a(new_n78_), .b(x6), .c(x1), .O(new_n79_));
  nand2  g062(.a(new_n30_), .b(new_n44_), .O(new_n80_));
  inv1   g063(.a(x3), .O(new_n81_));
  nand2  g064(.a(new_n81_), .b(x2), .O(new_n82_));
  aoi21  g065(.a(new_n82_), .b(new_n80_), .c(x1), .O(new_n83_));
  nand3  g066(.a(new_n45_), .b(new_n21_), .c(new_n44_), .O(new_n84_));
  oai21  g067(.a(new_n30_), .b(new_n44_), .c(new_n84_), .O(new_n85_));
  oai21  g068(.a(new_n85_), .b(new_n83_), .c(x5), .O(new_n86_));
  oai21  g069(.a(x6), .b(x3), .c(x1), .O(new_n87_));
  nand4  g070(.a(new_n87_), .b(new_n18_), .c(new_n30_), .d(x0), .O(new_n88_));
  and2   g071(.a(new_n88_), .b(new_n43_), .O(new_n89_));
  nand4  g072(.a(new_n89_), .b(new_n86_), .c(new_n79_), .d(new_n77_), .O(z3));
  oai21  g073(.a(x3), .b(x2), .c(x0), .O(new_n91_));
  aoi21  g074(.a(new_n91_), .b(new_n45_), .c(new_n38_), .O(new_n92_));
  aoi21  g075(.a(new_n81_), .b(new_n44_), .c(new_n30_), .O(new_n93_));
  nor2   g076(.a(new_n93_), .b(x1), .O(new_n94_));
  oai21  g077(.a(new_n94_), .b(new_n92_), .c(x6), .O(new_n95_));
  aoi21  g078(.a(new_n81_), .b(x1), .c(new_n30_), .O(new_n96_));
  nor2   g079(.a(x3), .b(x2), .O(new_n97_));
  nor2   g080(.a(new_n97_), .b(new_n38_), .O(new_n98_));
  oai21  g081(.a(new_n96_), .b(x0), .c(new_n98_), .O(new_n99_));
  nand2  g082(.a(new_n99_), .b(new_n21_), .O(new_n100_));
  nand2  g083(.a(new_n100_), .b(new_n95_), .O(z4));
  inv1   g084(.a(new_n45_), .O(new_n102_));
  oai21  g085(.a(new_n97_), .b(new_n102_), .c(x1), .O(new_n103_));
  nand2  g086(.a(new_n81_), .b(x2), .O(new_n104_));
  nand3  g087(.a(new_n104_), .b(x6), .c(new_n38_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand2  g089(.a(new_n106_), .b(x0), .O(new_n107_));
  nand2  g090(.a(x3), .b(new_n30_), .O(new_n108_));
  nand3  g091(.a(new_n21_), .b(new_n81_), .c(x2), .O(new_n109_));
  aoi21  g092(.a(new_n109_), .b(new_n108_), .c(new_n38_), .O(new_n110_));
  nand3  g093(.a(x6), .b(new_n81_), .c(x2), .O(new_n111_));
  inv1   g094(.a(new_n111_), .O(new_n112_));
  oai21  g095(.a(new_n112_), .b(new_n110_), .c(new_n44_), .O(new_n113_));
  ...
  oai21  g099(.a(new_n81_), .b(x2), .c(x6), .O(new_n117_));
  nand2  g100(.a(new_n117_), .b(new_n38_), .O(new_n118_));
  nand2  g101(.a(new_n21_), .b(x2), .O(new_n119_));
  nand3  g102(.a(new_n119_), .b(new_n118_), .c(new_n116_), .O(z6));
  aoi22  g103(.a(new_n108_), .b(new_n82_), .c(new_n21_), .d(new_n38_), .O(z7));
  aoi21  g104(.a(x2), .b(x0), .c(x1), .O(new_n122_));
  oai21  g105(.a(new_n122_), .b(x2), .c(x6), .O(new_n123_));
  aoi21  g106(.a(new_n123_), .b(new_n38_), .c(x3), .O(z8));
  nand3  g107(.a(new_n84_), .b(x5), .c(x4), .O(new_n125_));
  nand2  g108(.a(new_n125_), .b(new_n43_), .O(z9));
endmodule
