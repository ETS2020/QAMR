...
module FAU ( 
  ...
  inv1   g055(.a(new_n52_), .O(new_n73_));
  nand3  g056(.a(new_n49_), .b(x2), .c(new_n22_), .O(new_n74_));
  nand3  g057(.a(new_n26_), .b(x5), .c(new_n18_), .O(new_n75_));
  nand2  g058(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g059(.a(new_n76_), .b(x3), .O(new_n77_));
  nor2   g060(.a(x6), .b(x4), .O(new_n78_));
  nand2  g061(.a(new_n78_), .b(new_n19_), .O(new_n79_));
  nand2  g062(.a(new_n79_), .b(new_n22_), .O(new_n80_));
  nand3  g063(.a(new_n80_), .b(x5), .c(x2), .O(new_n81_));
  nand3  g064(.a(new_n81_), .b(new_n77_), .c(new_n73_), .O(new_n82_));
  nand2  g065(.a(new_n82_), .b(x1), .O(new_n83_));
  nand2  g066(.a(new_n23_), .b(new_n49_), .O(new_n84_));
  nand2  g067(.a(new_n84_), .b(new_n26_), .O(new_n85_));
  nand2  g068(.a(new_n85_), .b(x0), .O(new_n86_));
  nor2   g069(.a(new_n26_), .b(x1), .O(new_n87_));
  nor2   g070(.a(x6), .b(x0), .O(new_n88_));
  oai21  g071(.a(new_n88_), .b(new_n87_), .c(new_n18_), .O(new_n89_));
  nand2  g072(.a(new_n42_), .b(x1), .O(new_n90_));
  nand3  g073(.a(new_n90_), .b(new_n26_), .c(new_n22_), .O(new_n91_));
  nand3  g074(.a(x6), .b(new_n19_), .c(new_n33_), .O(new_n92_));
  ...
  nand2  g078(.a(new_n52_), .b(new_n95_), .O(new_n96_));
  nand4  g079(.a(new_n96_), .b(new_n94_), .c(new_n86_), .d(new_n83_), .O(z3));
  nand3  g080(.a(new_n26_), .b(x1), .c(new_n22_), .O(new_n98_));
  inv1   g081(.a(new_n98_), .O(new_n99_));
  oai21  g082(.a(new_n99_), .b(new_n87_), .c(new_n34_), .O(new_n100_));
  nand2  g083(.a(new_n61_), .b(x0), .O(new_n101_));
  ...
  oai21  g087(.a(new_n18_), .b(x1), .c(new_n26_), .O(new_n105_));
  nand2  g088(.a(new_n105_), .b(x0), .O(new_n106_));
  nand4  g089(.a(new_n26_), .b(x3), .c(x2), .d(new_n33_), .O(new_n107_));
  nand4  g090(.a(new_n107_), .b(new_n106_), .c(new_n104_), .d(new_n100_), .O(z4));
  nor2   g091(.a(new_n19_), .b(x2), .O(new_n109_));
  inv1   g092(.a(new_n109_), .O(new_n110_));
  nand2  g093(.a(new_n19_), .b(x2), .O(new_n111_));
  oai21  g094(.a(new_n110_), .b(new_n33_), .c(new_n111_), .O(new_n112_));
  nand2  g095(.a(new_n112_), .b(new_n22_), .O(new_n113_));
  aoi21  g096(.a(x3), .b(x1), .c(x2), .O(new_n114_));
  nand2  g097(.a(new_n34_), .b(new_n26_), .O(new_n115_));
  oai21  g098(.a(new_n115_), .b(new_n114_), .c(x0), .O(new_n116_));
  nand2  g099(.a(new_n116_), .b(new_n113_), .O(z5));
  aoi21  g100(.a(new_n49_), .b(x4), .c(new_n78_), .O(new_n118_));
  nand3  g101(.a(new_n26_), .b(new_n49_), .c(x0), .O(new_n119_));
  nand2  g102(.a(new_n119_), .b(x3), .O(new_n120_));
  oai21  g103(.a(new_n118_), .b(new_n22_), .c(new_n120_), .O(new_n121_));
  aoi21  g104(.a(new_n121_), .b(x2), .c(new_n19_), .O(new_n122_));
  nor2   g105(.a(new_n26_), .b(new_n22_), .O(new_n123_));
  aoi21  g106(.a(new_n109_), .b(new_n33_), .c(new_n123_), .O(new_n124_));
  oai21  g107(.a(new_n122_), .b(new_n33_), .c(new_n124_), .O(z6));
  aoi21  g108(.a(new_n111_), .b(new_n110_), .c(new_n123_), .O(z7));
  oai21  g109(.a(new_n26_), .b(new_n22_), .c(x3), .O(z8));
  nand2  g110(.a(new_n95_), .b(x1), .O(new_n128_));
  aoi21  g111(.a(new_n128_), .b(new_n22_), .c(x6), .O(new_n129_));
  nor2   g112(.a(new_n26_), .b(x0), .O(new_n130_));
  oai21  g113(.a(new_n130_), .b(new_n129_), .c(x5), .O(new_n131_));
  nor2   g114(.a(new_n131_), .b(new_n32_), .O(z9));
endmodule
