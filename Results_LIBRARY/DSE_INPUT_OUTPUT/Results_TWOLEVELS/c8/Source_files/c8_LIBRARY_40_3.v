...
module FAU ( 
  ...
  nand2  g005(.a(x18), .b(x01), .O(new_n52_));
  ...
  nand3  g038(.a(x18), .b(new_n84_), .c(x00), .O(new_n85_));
  ...
  nand3  g045(.a(new_n91_), .b(new_n52_), .c(x16), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n87_), .O(z09));
  nor2   g047(.a(new_n89_), .b(new_n57_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  inv1   g050(.a(x18), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n83_), .c(x09), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n96_), .c(new_n52_), .O(z10));
  ...
  oai21  g059(.a(new_n95_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g066(.a(new_n104_), .b(new_n89_), .c(new_n112_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n89_), .c(new_n57_), .O(new_n115_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n123_), .c(new_n104_), .d(new_n89_), .O(new_n156_));
  ...
  nand4  g114(.a(new_n123_), .b(new_n79_), .c(new_n74_), .d(new_n160_), .O(new_n161_));
  nand3  g115(.a(new_n104_), .b(x19), .c(new_n131_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n50_), .d(new_n131_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n52_), .c(x16), .O(new_n164_));
