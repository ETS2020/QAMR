...
module FAU ( 
  ...
  nand3  g012(.a(new_n52_), .b(new_n56_), .c(new_n58_), .O(new_n59_));
  ...
  aoi21  g018(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(z02));
  ...
  oai21  g026(.a(x27), .b(x23), .c(new_n72_), .O(z04));
  ...
  nand2  g043(.a(x18), .b(new_n55_), .O(new_n90_));
  ...
  nand2  g050(.a(new_n58_), .b(x09), .O(new_n97_));
  oai21  g051(.a(new_n90_), .b(new_n96_), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g057(.a(new_n100_), .b(new_n56_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n47_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n99_), .O(z10));
  inv1   g060(.a(x02), .O(new_n107_));
  oai22  g061(.a(new_n90_), .b(new_n107_), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  oai22  g070(.a(new_n90_), .b(new_n116_), .c(x18), .d(new_n66_), .O(new_n117_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n127_), .c(new_n47_), .O(z13));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n110_), .c(new_n76_), .O(new_n137_));
  ...
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(new_n47_), .O(z14));
  inv1   g096(.a(x06), .O(new_n143_));
  oai22  g097(.a(new_n90_), .b(new_n143_), .c(x18), .d(new_n79_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n111_), .d(new_n100_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n111_), .d(new_n100_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n147_), .c(new_n76_), .O(new_n163_));
