...
module FAU ( 
  ...
  nand2  g045(.a(new_n82_), .b(x18), .O(new_n92_));
  ...
  nor2   g049(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  nor2   g050(.a(x20), .b(x17), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n96_), .c(new_n82_), .O(new_n98_));
  inv1   g052(.a(x18), .O(new_n99_));
  nand3  g053(.a(x20), .b(x19), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(x16), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n94_), .O(z10));
  inv1   g057(.a(x02), .O(new_n104_));
  oai22  g058(.a(new_n92_), .b(new_n104_), .c(x18), .d(new_n55_), .O(new_n105_));
  ...
  nor3   g064(.a(new_n57_), .b(new_n82_), .c(x18), .O(new_n111_));
  ...
  oai21  g071(.a(new_n117_), .b(new_n86_), .c(new_n99_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x19), .O(new_n119_));
  nor3   g073(.a(x21), .b(x20), .c(x17), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n84_), .c(new_n95_), .O(new_n122_));
  oai21  g076(.a(new_n120_), .b(new_n117_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n116_), .O(z12));
  ...
  oai21  g083(.a(new_n129_), .b(new_n86_), .c(new_n99_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x19), .O(new_n131_));
  aoi21  g085(.a(new_n121_), .b(new_n97_), .c(new_n129_), .O(new_n132_));
  nand3  g086(.a(new_n95_), .b(new_n82_), .c(new_n81_), .O(new_n133_));
  ...
  oai22  g093(.a(new_n92_), .b(new_n139_), .c(x18), .d(new_n67_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n86_), .O(new_n141_));
  nand3  g095(.a(new_n134_), .b(new_n97_), .c(new_n57_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x24), .O(new_n143_));
  nor3   g097(.a(x24), .b(x23), .c(x22), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n120_), .O(new_n145_));
  ...
  oai21  g107(.a(new_n153_), .b(new_n86_), .c(new_n99_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x19), .O(new_n155_));
  aoi21  g109(.a(new_n144_), .b(new_n120_), .c(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n108_), .b(new_n84_), .O(new_n157_));
  nand3  g111(.a(new_n134_), .b(new_n153_), .c(new_n69_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n156_), .c(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n152_), .O(z15));
  nand2  g115(.a(x18), .b(x07), .O(new_n162_));
  oai21  g116(.a(x18), .b(new_n75_), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n86_), .O(new_n164_));
  oai21  g118(.a(new_n77_), .b(new_n86_), .c(new_n99_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x19), .O(new_n166_));
  oai21  g120(.a(new_n158_), .b(new_n109_), .c(x26), .O(new_n167_));
  nor3   g121(.a(x26), .b(x25), .c(x24), .O(new_n168_));
  nand4  g122(.a(new_n168_), .b(new_n134_), .c(new_n108_), .d(new_n84_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(x16), .O(new_n171_));
  nand3  g125(.a(new_n171_), .b(new_n166_), .c(new_n164_), .O(z16));
  nand3  g126(.a(new_n48_), .b(x27), .c(x17), .O(new_n173_));
  nand2  g127(.a(new_n108_), .b(x19), .O(new_n174_));
  nor3   g128(.a(new_n174_), .b(x18), .c(x17), .O(new_n175_));
  nand3  g129(.a(new_n175_), .b(new_n168_), .c(new_n134_), .O(new_n176_));
  aoi21  g130(.a(new_n176_), .b(new_n173_), .c(new_n86_), .O(z17));
endmodule
