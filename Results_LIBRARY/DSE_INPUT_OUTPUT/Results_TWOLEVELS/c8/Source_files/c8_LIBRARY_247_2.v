...
module FAU ( 
  ...
  aoi21  g085(.a(new_n125_), .b(new_n106_), .c(new_n131_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n116_), .c(new_n97_), .d(new_n87_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand2  g090(.a(new_n91_), .b(x05), .O(new_n137_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n107_), .d(new_n89_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n91_), .b(x06), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n141_), .c(new_n107_), .d(new_n89_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n81_), .b(new_n76_), .c(new_n131_), .O(new_n159_));
