...
module FAU ( 
  ...
  nor2   g040(.a(new_n86_), .b(new_n54_), .O(new_n87_));
  nor3   g041(.a(x20), .b(x19), .c(x17), .O(new_n88_));
  oai21  g042(.a(new_n88_), .b(new_n87_), .c(x16), .O(new_n89_));
  nor2   g043(.a(x18), .b(x16), .O(new_n90_));
  nand2  g044(.a(new_n90_), .b(x09), .O(new_n91_));
  nand3  g045(.a(new_n91_), .b(new_n89_), .c(new_n85_), .O(z10));
  ...
  oai21  g053(.a(new_n88_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n86_), .c(new_n54_), .O(new_n108_));
  ...
  nand2  g071(.a(new_n90_), .b(x12), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n117_), .c(new_n112_), .O(z13));
  oai21  g073(.a(x16), .b(x05), .c(x18), .O(new_n120_));
  aoi21  g074(.a(new_n114_), .b(new_n88_), .c(new_n69_), .O(new_n121_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n98_), .d(new_n86_), .O(new_n136_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n134_), .c(new_n98_), .d(new_n86_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n90_), .b(x15), .O(new_n146_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n96_), .c(x16), .O(new_n152_));
