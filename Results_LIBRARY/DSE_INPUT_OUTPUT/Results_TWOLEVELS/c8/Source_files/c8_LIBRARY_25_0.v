...
module FAU ( 
  ...
  nand2  g22(.a(new_n57_), .b(new_n68_), .O(new_n69_));
  ...
  nor2   g47(.a(new_n86_), .b(new_n93_), .O(new_n94_));
  ...
  oai21  g51(.a(new_n89_), .b(x02), .c(new_n88_), .O(new_n98_));
  nor2   g52(.a(x20), .b(x19), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n83_), .O(new_n100_));
  nand4  g54(.a(new_n56_), .b(new_n93_), .c(new_n84_), .d(new_n83_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n88_), .c(new_n98_), .O(z11));
  oai21  g58(.a(new_n89_), .b(x03), .c(new_n88_), .O(new_n105_));
  nand2  g59(.a(new_n101_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n86_), .c(new_n93_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n88_), .c(new_n105_), .O(z12));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n95_), .c(new_n108_), .d(x23), .O(new_n112_));
  nand3  g66(.a(x18), .b(new_n88_), .c(x04), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n88_), .c(new_n113_), .O(z13));
  oai21  g68(.a(new_n89_), .b(x05), .c(new_n88_), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n95_), .c(new_n68_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n99_), .d(new_n83_), .O(new_n118_));
  ...
  oai21  g75(.a(new_n89_), .b(x06), .c(new_n88_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x23), .O(new_n124_));
  nand4  g78(.a(new_n73_), .b(new_n68_), .c(new_n124_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n102_), .c(new_n118_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n88_), .c(new_n122_), .O(z15));
  ...
  nand3  g91(.a(x18), .b(new_n88_), .c(x07), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  nand4  g93(.a(new_n130_), .b(new_n78_), .c(new_n73_), .d(new_n68_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n83_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n57_), .d(new_n83_), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(new_n81_), .O(z17));
endmodule
