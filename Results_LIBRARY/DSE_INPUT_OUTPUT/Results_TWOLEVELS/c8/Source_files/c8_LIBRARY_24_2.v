...
module FAU ( 
  ...
  aoi21  g032(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n79_));
  ...
  oai21  g048(.a(new_n94_), .b(new_n55_), .c(new_n92_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n87_), .O(new_n96_));
  nand3  g050(.a(new_n57_), .b(new_n51_), .c(new_n83_), .O(new_n97_));
  oai21  g051(.a(new_n85_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n82_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n96_), .O(z10));
  ...
  nand3  g111(.a(new_n157_), .b(new_n124_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n83_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n83_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n82_), .c(x16), .O(new_n161_));
