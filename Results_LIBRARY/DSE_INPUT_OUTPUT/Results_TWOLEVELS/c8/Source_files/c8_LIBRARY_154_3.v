...
module FAU ( 
  ...
  oai21  g051(.a(new_n85_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  ...
  aoi21  g063(.a(new_n103_), .b(new_n85_), .c(new_n63_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n85_), .c(new_n95_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n87_), .b(x11), .O(new_n115_));
  ...
  aoi21  g079(.a(new_n119_), .b(new_n102_), .c(new_n71_), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n111_), .c(new_n96_), .d(new_n82_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n126_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n87_), .b(x13), .O(new_n131_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n103_), .d(new_n85_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n135_), .c(new_n103_), .d(new_n85_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n94_), .c(x16), .O(new_n149_));
  ...
  nor2   g112(.a(new_n58_), .b(new_n82_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n94_), .c(new_n90_), .O(z17));
endmodule
