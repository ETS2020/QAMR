...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(new_n69_), .O(new_n93_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n51_), .c(new_n83_), .O(new_n97_));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n85_), .c(new_n63_), .O(new_n114_));
  ...
  nand3  g082(.a(x18), .b(new_n69_), .c(x05), .O(new_n129_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n63_), .c(new_n104_), .O(new_n133_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n106_), .d(new_n85_), .O(new_n146_));
  ...
  oai22  g104(.a(new_n93_), .b(new_n150_), .c(x18), .d(new_n77_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n106_), .d(new_n85_), .O(new_n155_));
  ...
  nand4  g113(.a(new_n124_), .b(new_n79_), .c(new_n74_), .d(new_n159_), .O(new_n160_));
