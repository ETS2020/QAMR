...
module FAU ( 
  ...
  aoi21  g027(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n74_));
  ...
  nor2   g049(.a(new_n86_), .b(new_n95_), .O(new_n96_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n84_), .O(z11));
  ...
  aoi21  g065(.a(new_n103_), .b(new_n86_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n86_), .c(new_n95_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n84_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  nand2  g072(.a(new_n82_), .b(x12), .O(new_n119_));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n97_), .c(new_n71_), .O(new_n131_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n130_), .c(new_n84_), .O(z14));
  nand2  g092(.a(new_n135_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n103_), .d(new_n86_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n84_), .c(x16), .O(new_n144_));
  nand3  g098(.a(x18), .b(new_n91_), .c(x06), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n144_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  inv1   g101(.a(x18), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(x15), .c(new_n47_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n140_), .c(new_n103_), .d(new_n86_), .O(new_n154_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n140_), .c(new_n71_), .O(new_n159_));
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n132_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n132_), .O(new_n161_));
