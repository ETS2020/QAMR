...
module FAU ( 
  ...
  nor2   g044(.a(new_n79_), .b(x16), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(x01), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n90_), .c(new_n86_), .O(z10));
  ...
  oai21  g053(.a(new_n89_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n87_), .c(new_n54_), .O(new_n108_));
  ...
  nand2  g071(.a(new_n91_), .b(x04), .O(new_n118_));
  ...
  nand2  g081(.a(new_n91_), .b(x05), .O(new_n128_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n98_), .d(new_n87_), .O(new_n136_));
  ...
  nand2  g094(.a(new_n136_), .b(x26), .O(new_n141_));
  nor3   g095(.a(x26), .b(x25), .c(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n134_), .c(new_n98_), .d(new_n87_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n91_), .b(x07), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n145_), .c(new_n140_), .O(z16));
  nor2   g101(.a(x26), .b(x25), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n134_), .c(new_n69_), .O(new_n149_));
  nand3  g103(.a(new_n98_), .b(x19), .c(new_n122_), .O(new_n150_));
  oai22  g104(.a(new_n150_), .b(new_n149_), .c(new_n55_), .d(new_n122_), .O(new_n151_));
