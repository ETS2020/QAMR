...
module FAU ( 
  ...
  aoi21  g013(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n60_));
  ...
  nand2  g039(.a(new_n85_), .b(new_n52_), .O(z08));
  ...
  nand3  g055(.a(new_n101_), .b(new_n98_), .c(new_n85_), .O(z10));
  nand3  g056(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n103_));
  nor2   g057(.a(x21), .b(x20), .O(new_n104_));
  aoi22  g058(.a(new_n104_), .b(new_n89_), .c(new_n103_), .d(x21), .O(new_n105_));
  inv1   g059(.a(x18), .O(new_n106_));
  nor2   g060(.a(new_n106_), .b(x16), .O(new_n107_));
  aoi21  g061(.a(new_n107_), .b(x02), .c(new_n48_), .O(new_n108_));
  oai21  g062(.a(new_n105_), .b(new_n91_), .c(new_n108_), .O(z11));
  nand2  g063(.a(x18), .b(x03), .O(new_n110_));
  nand3  g064(.a(new_n106_), .b(x11), .c(new_n47_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n91_), .O(new_n113_));
  nand2  g067(.a(new_n104_), .b(new_n89_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x22), .O(new_n115_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n100_), .c(new_n125_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x16), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n123_), .c(new_n85_), .O(z13));
  nand2  g084(.a(x18), .b(x05), .O(new_n131_));
  nand3  g085(.a(new_n106_), .b(x13), .c(new_n47_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  nand3  g088(.a(new_n69_), .b(new_n64_), .c(new_n125_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n103_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n137_), .d(new_n87_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n85_), .c(x16), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n126_), .c(new_n104_), .d(new_n89_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n85_), .O(z15));
  nand2  g105(.a(x18), .b(x07), .O(new_n152_));
  nand3  g106(.a(new_n106_), .b(x15), .c(new_n47_), .O(new_n153_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n104_), .d(new_n89_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n126_), .c(new_n74_), .O(new_n163_));
  nand3  g117(.a(new_n104_), .b(x19), .c(new_n87_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n87_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n85_), .O(z17));
endmodule
