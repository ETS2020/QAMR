...
module FAU ( 
  ...
  nand2  g029(.a(new_n48_), .b(new_n67_), .O(z08));
  ...
  nor2   g036(.a(x18), .b(x16), .O(new_n83_));
  nand2  g037(.a(new_n83_), .b(x08), .O(new_n84_));
  nand3  g038(.a(new_n84_), .b(new_n82_), .c(new_n77_), .O(z09));
  oai21  g039(.a(x16), .b(x01), .c(x18), .O(new_n86_));
  inv1   g040(.a(x20), .O(new_n87_));
  nor2   g041(.a(new_n81_), .b(new_n87_), .O(new_n88_));
  nor3   g042(.a(x20), .b(x19), .c(x17), .O(new_n89_));
  oai21  g043(.a(new_n89_), .b(new_n88_), .c(x16), .O(new_n90_));
  nand2  g044(.a(new_n83_), .b(x09), .O(new_n91_));
  nand3  g045(.a(new_n91_), .b(new_n90_), .c(new_n86_), .O(z10));
  ...
  oai21  g054(.a(new_n89_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(x16), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n96_), .O(z11));
  oai21  g057(.a(x16), .b(x03), .c(x18), .O(new_n104_));
  inv1   g058(.a(x22), .O(new_n105_));
  aoi21  g059(.a(new_n99_), .b(new_n81_), .c(new_n105_), .O(new_n106_));
  nor2   g060(.a(x22), .b(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n81_), .c(new_n87_), .O(new_n108_));
  inv1   g062(.a(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n83_), .b(x11), .O(new_n111_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n89_), .c(new_n98_), .O(new_n118_));
  ...
  nand3  g078(.a(new_n87_), .b(new_n79_), .c(new_n78_), .O(new_n125_));
  inv1   g079(.a(x23), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n105_), .c(new_n98_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n125_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n107_), .c(new_n129_), .d(new_n78_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n97_), .c(x16), .O(new_n133_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n117_), .c(new_n99_), .d(new_n81_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n136_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n83_), .b(x14), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n117_), .c(new_n99_), .d(new_n81_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n97_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n145_), .O(z16));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n117_), .c(new_n66_), .O(new_n153_));
  nand3  g107(.a(new_n99_), .b(x19), .c(new_n78_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n67_), .d(new_n78_), .O(new_n155_));
