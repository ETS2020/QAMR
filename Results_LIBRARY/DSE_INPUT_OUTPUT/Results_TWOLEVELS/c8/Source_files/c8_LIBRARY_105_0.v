...
module FAU ( 
  ...
  oai21  g41(.a(new_n83_), .b(x01), .c(new_n87_), .O(new_n88_));
  nor2   g42(.a(new_n81_), .b(new_n53_), .O(new_n89_));
  ...
  oai21  g53(.a(new_n98_), .b(new_n87_), .c(new_n99_), .O(z11));
  ...
  nand2  g58(.a(new_n84_), .b(x03), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n87_), .c(new_n105_), .O(z12));
  oai21  g60(.a(new_n83_), .b(x04), .c(new_n87_), .O(new_n107_));
  ...
  oai21  g64(.a(new_n83_), .b(x05), .c(new_n87_), .O(new_n111_));
  aoi21  g65(.a(new_n108_), .b(new_n90_), .c(new_n68_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n93_), .d(new_n78_), .O(new_n114_));
  ...
  oai21  g79(.a(new_n83_), .b(x07), .c(new_n87_), .O(new_n126_));
