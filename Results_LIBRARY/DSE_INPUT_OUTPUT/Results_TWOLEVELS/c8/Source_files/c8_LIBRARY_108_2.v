...
module FAU ( 
  ...
  nor2   g035(.a(x16), .b(new_n81_), .O(new_n82_));
  aoi21  g036(.a(new_n80_), .b(x16), .c(new_n82_), .O(new_n83_));
  nand3  g037(.a(new_n79_), .b(new_n48_), .c(x08), .O(new_n84_));
  oai21  g038(.a(new_n83_), .b(new_n79_), .c(new_n84_), .O(z09));
  nand2  g039(.a(x18), .b(x01), .O(new_n86_));
  oai21  g040(.a(x18), .b(new_n52_), .c(new_n86_), .O(new_n87_));
  ...
  nand2  g055(.a(new_n101_), .b(new_n90_), .O(new_n102_));
  ...
  oai21  g068(.a(x16), .b(x12), .c(new_n79_), .O(new_n115_));
  nand2  g069(.a(new_n111_), .b(x23), .O(new_n116_));
  nor3   g070(.a(x23), .b(x22), .c(x21), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n100_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nor2   g074(.a(new_n79_), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x04), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n120_), .c(new_n115_), .O(z13));
  oai21  g077(.a(x16), .b(x13), .c(new_n79_), .O(new_n124_));
  inv1   g078(.a(x24), .O(new_n125_));
  aoi21  g079(.a(new_n117_), .b(new_n100_), .c(new_n125_), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n110_), .c(new_n92_), .d(new_n91_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n126_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n121_), .b(x05), .O(new_n131_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n101_), .d(new_n90_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g093(.a(new_n121_), .b(x06), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n139_), .c(new_n133_), .O(z15));
  oai21  g095(.a(x16), .b(x15), .c(new_n79_), .O(new_n142_));
  nand2  g096(.a(new_n137_), .b(x26), .O(new_n143_));
  nor3   g097(.a(x26), .b(x25), .c(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n135_), .c(new_n101_), .d(new_n90_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand2  g101(.a(new_n121_), .b(x07), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n147_), .c(new_n142_), .O(z16));
  nor2   g103(.a(x26), .b(x25), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n135_), .c(new_n125_), .O(new_n151_));
  nand3  g105(.a(new_n101_), .b(x19), .c(new_n91_), .O(new_n152_));
  oai22  g106(.a(new_n152_), .b(new_n151_), .c(new_n58_), .d(new_n91_), .O(new_n153_));
