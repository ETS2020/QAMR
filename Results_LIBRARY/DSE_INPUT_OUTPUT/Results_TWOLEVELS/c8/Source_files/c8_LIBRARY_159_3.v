...
module FAU ( 
  ...
  nand3  g042(.a(new_n88_), .b(new_n52_), .c(x16), .O(new_n89_));
  ...
  oai21  g048(.a(new_n91_), .b(new_n57_), .c(new_n94_), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n52_), .c(x16), .O(new_n96_));
  inv1   g050(.a(x18), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n83_), .c(x09), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n96_), .O(z10));
  nand2  g053(.a(x18), .b(x02), .O(new_n100_));
  oai22  g054(.a(new_n100_), .b(x01), .c(x18), .d(new_n60_), .O(new_n101_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n52_), .c(x16), .O(new_n125_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n113_), .c(new_n93_), .d(new_n92_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(new_n52_), .O(z14));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n91_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n139_), .c(new_n52_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  oai22  g101(.a(new_n147_), .b(x01), .c(x18), .d(new_n79_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n104_), .d(new_n91_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n92_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n50_), .d(new_n92_), .O(new_n159_));
