...
module FAU ( 
  ...
  oai21  g055(.a(new_n95_), .b(new_n60_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g074(.a(new_n89_), .b(x04), .O(new_n121_));
  ...
  nand4  g081(.a(new_n127_), .b(new_n110_), .c(new_n126_), .d(new_n85_), .O(new_n128_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n100_), .d(new_n87_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n135_), .c(new_n100_), .d(new_n87_), .O(new_n147_));
  ...
  nand3  g106(.a(new_n100_), .b(x19), .c(new_n85_), .O(new_n153_));
