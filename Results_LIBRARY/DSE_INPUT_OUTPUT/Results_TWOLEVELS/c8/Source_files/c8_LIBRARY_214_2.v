...
module FAU ( 
  ...
  aoi21  g062(.a(new_n103_), .b(new_n88_), .c(new_n63_), .O(new_n109_));
  ...
  nand2  g075(.a(new_n90_), .b(x04), .O(new_n122_));
  ...
  nand3  g080(.a(new_n94_), .b(new_n86_), .c(new_n85_), .O(new_n127_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n110_), .c(new_n130_), .d(new_n85_), .O(new_n132_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n103_), .d(new_n88_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n90_), .b(x06), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n118_), .c(new_n103_), .d(new_n88_), .O(new_n149_));
