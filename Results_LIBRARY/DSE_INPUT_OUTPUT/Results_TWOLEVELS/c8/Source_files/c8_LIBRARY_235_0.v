...
module FAU ( 
  ...
  oai21  g059(.a(new_n94_), .b(new_n56_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n92_), .c(x16), .O(new_n107_));
  ...
  oai21  g068(.a(new_n112_), .b(new_n61_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n92_), .O(z11));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n92_), .O(z12));
  nand2  g080(.a(new_n88_), .b(new_n69_), .O(new_n127_));
  ...
  nand2  g084(.a(new_n130_), .b(new_n112_), .O(new_n131_));
  ...
  aoi21  g092(.a(new_n130_), .b(new_n112_), .c(new_n138_), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n122_), .c(new_n104_), .d(new_n103_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(new_n92_), .O(z14));
  ...
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n113_), .d(new_n94_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n88_), .b(x15), .c(x04), .O(new_n156_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n149_), .c(new_n113_), .d(new_n94_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n92_), .c(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n158_), .O(z16));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n149_), .c(new_n138_), .O(new_n166_));
  ...
  nand2  g123(.a(new_n169_), .b(new_n92_), .O(z17));
endmodule
