...
module FAU ( 
  ...
  oai21  g057(.a(new_n58_), .b(new_n96_), .c(x18), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x19), .O(new_n105_));
  nor2   g059(.a(new_n58_), .b(new_n92_), .O(new_n106_));
  ...
  nand2  g064(.a(new_n47_), .b(new_n52_), .O(new_n111_));
  ...
  nand3  g071(.a(x21), .b(x19), .c(x18), .O(new_n118_));
  ...
  oai21  g087(.a(new_n111_), .b(new_n71_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n96_), .O(new_n135_));
  nor2   g089(.a(x20), .b(x17), .O(new_n136_));
  nand2  g090(.a(new_n128_), .b(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x23), .O(new_n138_));
  nor2   g092(.a(x23), .b(x22), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n136_), .c(new_n61_), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(new_n138_), .c(x19), .O(new_n141_));
  nand3  g095(.a(x23), .b(x19), .c(x18), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n141_), .c(x16), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n135_), .O(z13));
  nand2  g099(.a(x18), .b(x05), .O(new_n146_));
  oai21  g100(.a(new_n111_), .b(new_n76_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  nand2  g102(.a(new_n140_), .b(x24), .O(new_n149_));
  nor2   g103(.a(x24), .b(x23), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n115_), .c(new_n66_), .d(new_n92_), .O(new_n151_));
  aoi21  g105(.a(new_n151_), .b(new_n149_), .c(x19), .O(new_n152_));
  nand3  g106(.a(x24), .b(x19), .c(x18), .O(new_n153_));
  ...
  oai21  g113(.a(new_n83_), .b(new_n96_), .c(x18), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x19), .O(new_n161_));
  and2   g115(.a(new_n151_), .b(x25), .O(new_n162_));
  nand2  g116(.a(new_n115_), .b(new_n94_), .O(new_n163_));
  ...
  nand3  g121(.a(new_n167_), .b(new_n161_), .c(new_n159_), .O(z15));
  nand2  g122(.a(x18), .b(x07), .O(new_n169_));
  oai21  g123(.a(new_n111_), .b(new_n88_), .c(new_n169_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n96_), .O(new_n171_));
  nand4  g125(.a(new_n164_), .b(new_n139_), .c(new_n115_), .d(new_n92_), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(x26), .O(new_n173_));
  nor2   g127(.a(x26), .b(x25), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n150_), .c(new_n128_), .d(new_n136_), .O(new_n175_));
  ...
  nand3  g134(.a(new_n53_), .b(x27), .c(x17), .O(new_n181_));
  nand2  g135(.a(new_n115_), .b(x19), .O(new_n182_));
  nor3   g136(.a(new_n182_), .b(new_n52_), .c(x17), .O(new_n183_));
  nand4  g137(.a(new_n183_), .b(new_n174_), .c(new_n139_), .d(new_n78_), .O(new_n184_));
  aoi21  g138(.a(new_n184_), .b(new_n181_), .c(new_n96_), .O(z17));
endmodule
