...
module FAU ( 
  ...
  aoi21  g085(.a(new_n125_), .b(new_n107_), .c(new_n75_), .O(new_n132_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n143_), .c(new_n108_), .d(new_n99_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n112_), .b(x15), .O(new_n155_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n98_), .c(x16), .O(new_n161_));
