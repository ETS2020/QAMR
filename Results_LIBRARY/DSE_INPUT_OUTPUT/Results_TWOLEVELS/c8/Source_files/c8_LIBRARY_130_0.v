...
module FAU ( 
  ...
  aoi21  g065(.a(new_n104_), .b(new_n85_), .c(new_n62_), .O(new_n112_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n111_), .c(new_n82_), .O(z12));
  ...
  oai21  g078(.a(new_n116_), .b(new_n122_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n82_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  inv1   g082(.a(x18), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(x13), .c(x06), .O(new_n130_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n134_), .d(new_n83_), .O(new_n136_));
  ...
  aoi21  g094(.a(new_n129_), .b(new_n71_), .c(x16), .O(new_n141_));
  ...
  aoi21  g099(.a(new_n145_), .b(x16), .c(new_n141_), .O(new_n146_));
  nand3  g100(.a(new_n145_), .b(x18), .c(x16), .O(new_n147_));
  oai21  g101(.a(new_n146_), .b(new_n140_), .c(new_n147_), .O(z15));
  ...
  nand4  g107(.a(new_n123_), .b(new_n78_), .c(new_n73_), .d(new_n153_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n105_), .c(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n82_), .O(z16));
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n83_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n154_), .c(new_n50_), .d(new_n83_), .O(new_n159_));
