...
module FAU ( 
  ...
  aoi21  g017(.a(x27), .b(new_n63_), .c(new_n47_), .O(new_n64_));
  oai21  g018(.a(x27), .b(x23), .c(new_n64_), .O(z04));
  inv1   g019(.a(x18), .O(new_n66_));
  inv1   g020(.a(x13), .O(new_n67_));
  nor2   g021(.a(x27), .b(x24), .O(new_n68_));
  aoi21  g022(.a(x27), .b(new_n67_), .c(new_n68_), .O(new_n69_));
  nand2  g023(.a(new_n68_), .b(x13), .O(new_n70_));
  oai21  g024(.a(new_n69_), .b(new_n66_), .c(new_n70_), .O(z05));
  ...
  aoi21  g029(.a(new_n75_), .b(new_n73_), .c(new_n47_), .O(z06));
  inv1   g030(.a(x15), .O(new_n77_));
  aoi21  g031(.a(x27), .b(new_n77_), .c(new_n47_), .O(new_n78_));
  oai21  g032(.a(x27), .b(x26), .c(new_n78_), .O(z07));
  inv1   g033(.a(new_n47_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n51_), .O(z08));
  inv1   g035(.a(x16), .O(new_n82_));
  nand2  g036(.a(x18), .b(x00), .O(new_n83_));
  nand2  g037(.a(new_n66_), .b(x13), .O(new_n84_));
  oai21  g038(.a(new_n84_), .b(new_n48_), .c(new_n83_), .O(new_n85_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n92_), .c(new_n80_), .O(z10));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n80_), .O(z11));
  nand2  g061(.a(x18), .b(x03), .O(new_n108_));
  oai21  g062(.a(new_n84_), .b(new_n60_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n82_), .O(new_n110_));
  nand2  g064(.a(new_n104_), .b(x22), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n94_), .c(new_n93_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n96_), .c(new_n102_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n80_), .O(z13));
  ...
  oai21  g082(.a(new_n66_), .b(new_n82_), .c(new_n84_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n122_), .c(x24), .O(new_n130_));
  inv1   g084(.a(x17), .O(new_n131_));
  inv1   g085(.a(x22), .O(new_n132_));
  inv1   g086(.a(x23), .O(new_n133_));
  aoi21  g087(.a(new_n66_), .b(new_n67_), .c(x24), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n102_), .O(new_n135_));
  nor2   g089(.a(new_n135_), .b(x20), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n50_), .c(new_n131_), .d(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n130_), .c(new_n128_), .O(z14));
  ...
  nand3  g096(.a(new_n142_), .b(new_n112_), .c(new_n96_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n141_), .c(new_n80_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  oai21  g104(.a(x18), .b(new_n77_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n82_), .O(new_n152_));
  nand2  g106(.a(new_n146_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n121_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n104_), .c(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n80_), .O(z16));
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n131_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n51_), .d(new_n131_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n80_), .c(x16), .O(new_n161_));
