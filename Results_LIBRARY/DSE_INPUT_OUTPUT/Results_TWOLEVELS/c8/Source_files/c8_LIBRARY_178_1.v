...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(x04), .O(new_n93_));
  ...
  oai21  g052(.a(new_n85_), .b(new_n54_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n83_), .c(x16), .O(new_n100_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n85_), .c(new_n54_), .O(new_n116_));
  ...
  oai21  g073(.a(x18), .b(x12), .c(new_n87_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n83_), .O(z13));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n105_), .c(new_n73_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n115_), .c(new_n97_), .d(new_n96_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n129_), .c(new_n83_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n106_), .d(new_n85_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n83_), .O(z15));
  nand3  g099(.a(x18), .b(x07), .c(x04), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n106_), .d(new_n85_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n155_), .b(new_n140_), .c(new_n73_), .O(new_n156_));
