...
module FAU ( 
  ...
  nand2  g038(.a(x18), .b(new_n74_), .O(new_n85_));
  ...
  nand3  g045(.a(new_n91_), .b(new_n47_), .c(x16), .O(new_n92_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n104_), .c(new_n47_), .O(z11));
  ...
  aoi21  g067(.a(new_n105_), .b(new_n89_), .c(new_n113_), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n112_), .c(new_n47_), .O(z12));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n99_), .c(new_n71_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n131_), .c(new_n47_), .O(z14));
  nand3  g093(.a(x18), .b(new_n74_), .c(x06), .O(new_n140_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n105_), .d(new_n89_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n105_), .d(new_n89_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n144_), .c(new_n71_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n133_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n133_), .O(new_n162_));
