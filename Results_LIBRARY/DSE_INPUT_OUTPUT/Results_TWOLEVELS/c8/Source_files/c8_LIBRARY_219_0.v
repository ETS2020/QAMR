...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x03), .O(new_n48_));
  ...
  nand2  g026(.a(new_n57_), .b(new_n72_), .O(new_n73_));
  ...
  nand2  g031(.a(new_n57_), .b(new_n77_), .O(new_n78_));
  ...
  nand2  g036(.a(new_n57_), .b(new_n82_), .O(new_n83_));
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(z07));
  nor2   g038(.a(new_n48_), .b(new_n57_), .O(z08));
  ...
  oai21  g065(.a(new_n102_), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n86_), .c(x16), .O(new_n113_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n90_), .c(new_n100_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n86_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  nand3  g078(.a(new_n106_), .b(x12), .c(x03), .O(new_n125_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n86_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  nand3  g111(.a(new_n106_), .b(x15), .c(x03), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n92_), .O(new_n160_));
  nand2  g114(.a(new_n153_), .b(x26), .O(new_n161_));
  nor3   g115(.a(x26), .b(x25), .c(x24), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n129_), .c(new_n110_), .d(new_n90_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n86_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n160_), .O(z16));
  nand4  g120(.a(new_n129_), .b(new_n82_), .c(new_n77_), .d(new_n72_), .O(new_n167_));
  nand3  g121(.a(new_n110_), .b(x19), .c(new_n87_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n57_), .d(new_n87_), .O(new_n169_));
