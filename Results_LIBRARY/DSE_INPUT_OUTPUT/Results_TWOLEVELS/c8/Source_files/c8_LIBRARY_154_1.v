...
module FAU ( 
  ...
  nand2  g25(.a(new_n58_), .b(new_n71_), .O(new_n72_));
  ...
  nand3  g46(.a(new_n48_), .b(new_n86_), .c(x09), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n92_), .O(z10));
  oai21  g48(.a(x18), .b(x10), .c(new_n86_), .O(new_n95_));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n81_), .O(new_n97_));
  nand4  g51(.a(new_n57_), .b(new_n89_), .c(new_n82_), .d(new_n81_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n86_), .c(new_n95_), .O(z11));
  oai21  g55(.a(x18), .b(x11), .c(new_n86_), .O(new_n102_));
  nand2  g56(.a(new_n98_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n84_), .c(new_n89_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n86_), .c(new_n102_), .O(z12));
  ...
  oai21  g65(.a(x18), .b(x13), .c(new_n86_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n91_), .c(new_n71_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n104_), .c(new_n96_), .d(new_n81_), .O(new_n115_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n71_), .c(new_n120_), .d(new_n63_), .O(new_n122_));
  ...
  nand3  g92(.a(new_n138_), .b(new_n127_), .c(new_n71_), .O(new_n139_));
