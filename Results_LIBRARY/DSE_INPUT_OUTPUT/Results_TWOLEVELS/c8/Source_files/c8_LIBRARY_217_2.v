...
module FAU ( 
  ...
  oai21  g057(.a(new_n95_), .b(new_n60_), .c(new_n103_), .O(new_n104_));
  ...
  nand4  g082(.a(new_n128_), .b(new_n111_), .c(new_n127_), .d(new_n85_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n102_), .d(new_n87_), .O(new_n138_));
