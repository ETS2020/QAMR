...
module FAU ( 
  ...
  aoi21  g063(.a(new_n103_), .b(new_n89_), .c(new_n109_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n89_), .c(new_n57_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n91_), .b(x03), .O(new_n115_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n96_), .c(new_n62_), .O(new_n120_));
  ...
  nand3  g081(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n109_), .c(new_n62_), .O(new_n130_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n119_), .c(new_n103_), .d(new_n89_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n119_), .c(new_n103_), .d(new_n89_), .O(new_n150_));
  ...
  nand2  g108(.a(new_n129_), .b(new_n109_), .O(new_n155_));
  inv1   g109(.a(x24), .O(new_n156_));
  nand3  g110(.a(new_n81_), .b(new_n76_), .c(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n87_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n52_), .b(new_n87_), .O(new_n161_));
