...
module FAU ( 
  ...
  nor2   g035(.a(x16), .b(new_n47_), .O(new_n82_));
  aoi21  g036(.a(new_n81_), .b(x16), .c(new_n82_), .O(new_n83_));
  inv1   g037(.a(x16), .O(new_n84_));
  nand3  g038(.a(x18), .b(new_n84_), .c(x00), .O(new_n85_));
  oai21  g039(.a(new_n83_), .b(x18), .c(new_n85_), .O(z09));
  ...
  nand3  g049(.a(new_n95_), .b(new_n90_), .c(x16), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n89_), .O(z10));
  ...
  nor2   g057(.a(x18), .b(x16), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x10), .O(new_n105_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n90_), .c(x16), .O(new_n114_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n90_), .c(x16), .O(new_n123_));
  ...
  nand2  g085(.a(new_n104_), .b(x13), .O(new_n132_));
  ...
  nand2  g094(.a(new_n104_), .b(x14), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n140_), .c(new_n134_), .O(z15));
  oai21  g096(.a(x16), .b(x07), .c(x18), .O(new_n143_));
  ...
  nand2  g102(.a(new_n104_), .b(x15), .O(new_n149_));
  ...
  aoi21  g114(.a(new_n160_), .b(new_n90_), .c(new_n84_), .O(z17));
endmodule
