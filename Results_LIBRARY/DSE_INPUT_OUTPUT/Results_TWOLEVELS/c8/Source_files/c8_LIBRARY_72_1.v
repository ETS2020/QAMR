...
module FAU ( 
  ...
  nor2   g31(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  oai21  g38(.a(x18), .b(x08), .c(new_n84_), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n83_), .O(z09));
  ...
  nand2  g47(.a(new_n93_), .b(new_n79_), .O(new_n94_));
  inv1   g48(.a(x21), .O(new_n95_));
  nand4  g49(.a(new_n95_), .b(new_n88_), .c(new_n80_), .d(new_n79_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n94_), .b(x21), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n48_), .b(new_n84_), .O(new_n99_));
  oai22  g53(.a(new_n99_), .b(new_n55_), .c(new_n98_), .d(new_n84_), .O(z11));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n82_), .c(new_n96_), .d(x22), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n84_), .c(new_n99_), .d(new_n58_), .O(z12));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n82_), .c(new_n88_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n90_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n84_), .c(new_n99_), .d(new_n64_), .O(z13));
  aoi21  g62(.a(new_n106_), .b(new_n90_), .c(new_n69_), .O(new_n109_));
  nor2   g63(.a(x24), .b(x23), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n104_), .c(new_n93_), .d(new_n79_), .O(new_n111_));
  inv1   g65(.a(new_n111_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand3  g67(.a(new_n48_), .b(new_n84_), .c(x13), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(z14));
  oai21  g69(.a(x18), .b(x14), .c(new_n84_), .O(new_n116_));
  inv1   g70(.a(x23), .O(new_n117_));
  inv1   g71(.a(x25), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n69_), .c(new_n117_), .d(new_n60_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n97_), .c(new_n111_), .d(x25), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n84_), .c(new_n116_), .O(z15));
  ...
  inv1   g87(.a(new_n49_), .O(new_n134_));
  nor2   g88(.a(x26), .b(x25), .O(new_n135_));
  nand3  g89(.a(new_n135_), .b(new_n125_), .c(new_n69_), .O(new_n136_));
  nand3  g90(.a(new_n124_), .b(x19), .c(new_n79_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n61_), .d(new_n79_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n134_), .O(z17));
endmodule
