...
module FAU ( 
  ...
  nand2  g057(.a(new_n96_), .b(x10), .O(new_n104_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n94_), .c(new_n60_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n96_), .b(x12), .O(new_n122_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n109_), .c(x16), .O(new_n137_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n118_), .c(new_n100_), .d(new_n92_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n96_), .b(x14), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n118_), .c(new_n100_), .d(new_n92_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n96_), .b(x15), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n147_), .O(z16));
  nand2  g108(.a(new_n130_), .b(new_n65_), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n78_), .c(new_n73_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n100_), .b(x19), .c(new_n127_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n55_), .b(new_n127_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n109_), .c(new_n88_), .O(z17));
endmodule
