...
module FAU ( 
  ...
  aoi21  g022(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n69_));
  ...
  nand2  g053(.a(new_n82_), .b(x10), .O(new_n100_));
  ...
  nand2  g065(.a(new_n111_), .b(new_n98_), .O(new_n112_));
  aoi21  g066(.a(new_n105_), .b(new_n86_), .c(new_n63_), .O(new_n113_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n84_), .O(z13));
  inv1   g081(.a(x24), .O(new_n128_));
  aoi21  g082(.a(new_n123_), .b(new_n104_), .c(new_n128_), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n114_), .c(new_n93_), .d(new_n92_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  inv1   g087(.a(x18), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(x16), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(x05), .c(new_n49_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  nand3  g092(.a(new_n134_), .b(x14), .c(new_n48_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n98_), .O(new_n141_));
  nand2  g095(.a(new_n131_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n105_), .d(new_n86_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n84_), .c(x16), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n105_), .d(new_n86_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n84_), .O(z16));
  nand4  g111(.a(new_n143_), .b(new_n78_), .c(new_n73_), .d(new_n128_), .O(new_n158_));
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n92_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n92_), .O(new_n160_));
