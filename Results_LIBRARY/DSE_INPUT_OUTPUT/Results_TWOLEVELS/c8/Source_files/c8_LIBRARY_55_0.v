...
module FAU ( 
  ...
  oai21  g32(.a(x18), .b(x16), .c(new_n54_), .O(z08));
  ...
  nor2   g43(.a(new_n83_), .b(new_n53_), .O(new_n90_));
  ...
  aoi21  g65(.a(new_n109_), .b(new_n91_), .c(new_n68_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n103_), .c(new_n95_), .d(new_n80_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g70(.a(x18), .b(new_n85_), .c(x05), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n116_), .O(z14));
  oai21  g72(.a(new_n86_), .b(x06), .c(new_n85_), .O(new_n119_));
  inv1   g73(.a(x22), .O(new_n120_));
  inv1   g74(.a(x23), .O(new_n121_));
  nand4  g75(.a(new_n73_), .b(new_n68_), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  ...
  oai21  g79(.a(new_n86_), .b(x07), .c(new_n85_), .O(new_n126_));
