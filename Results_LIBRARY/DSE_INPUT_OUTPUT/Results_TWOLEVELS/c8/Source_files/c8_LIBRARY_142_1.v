...
module FAU ( 
  ...
  nand4  g55(.a(new_n101_), .b(new_n57_), .c(new_n51_), .d(new_n87_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n91_), .c(new_n98_), .O(z11));
  ...
  oai21  g65(.a(x18), .b(x12), .c(new_n91_), .O(new_n112_));
  ...
  aoi21  g70(.a(new_n113_), .b(new_n95_), .c(new_n75_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n108_), .c(new_n99_), .d(new_n87_), .O(new_n119_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n103_), .c(new_n119_), .d(x25), .O(new_n126_));
  nand3  g80(.a(new_n47_), .b(new_n91_), .c(x14), .O(new_n127_));
