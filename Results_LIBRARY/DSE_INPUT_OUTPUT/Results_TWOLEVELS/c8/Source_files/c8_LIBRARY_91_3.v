...
module FAU ( 
  ...
  aoi21  g017(.a(new_n63_), .b(new_n60_), .c(new_n49_), .O(z03));
  ...
  nand2  g031(.a(new_n62_), .b(new_n77_), .O(new_n78_));
  ...
  nor2   g036(.a(new_n49_), .b(new_n62_), .O(z08));
  inv1   g037(.a(x16), .O(new_n84_));
  inv1   g038(.a(x00), .O(new_n85_));
  nand2  g039(.a(new_n53_), .b(x18), .O(new_n86_));
  oai22  g040(.a(new_n86_), .b(new_n85_), .c(x18), .d(new_n47_), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(new_n84_), .O(new_n88_));
  xnor2a g042(.a(x19), .b(x17), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n48_), .c(x16), .O(new_n90_));
  ...
  nor2   g050(.a(new_n96_), .b(new_n53_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n95_), .c(new_n48_), .O(z10));
  inv1   g054(.a(x02), .O(new_n101_));
  oai22  g055(.a(new_n86_), .b(new_n101_), .c(x18), .d(new_n56_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  oai21  g057(.a(x19), .b(x17), .c(x21), .O(new_n104_));
  inv1   g058(.a(x17), .O(new_n105_));
  nor2   g059(.a(x21), .b(x19), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  aoi21  g061(.a(new_n107_), .b(new_n104_), .c(x20), .O(new_n108_));
  inv1   g062(.a(x21), .O(new_n109_));
  nor3   g063(.a(new_n109_), .b(new_n53_), .c(x18), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n108_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n103_), .O(z11));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  oai21  g067(.a(x18), .b(new_n59_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n84_), .O(new_n115_));
  oai21  g069(.a(new_n61_), .b(new_n84_), .c(new_n52_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(x20), .O(new_n117_));
  nor3   g071(.a(x21), .b(x19), .c(x17), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n96_), .c(new_n53_), .O(new_n120_));
  ...
  oai21  g078(.a(x18), .b(new_n65_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n84_), .O(new_n126_));
  oai21  g080(.a(new_n67_), .b(new_n84_), .c(new_n52_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x20), .O(new_n128_));
  aoi21  g082(.a(new_n119_), .b(new_n96_), .c(new_n67_), .O(new_n129_));
  inv1   g083(.a(x19), .O(new_n130_));
  nand3  g084(.a(new_n53_), .b(new_n130_), .c(new_n105_), .O(new_n131_));
  ...
  oai21  g088(.a(new_n134_), .b(new_n129_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n128_), .c(new_n126_), .O(z13));
  ...
  oai21  g093(.a(new_n72_), .b(new_n84_), .c(new_n52_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x20), .O(new_n141_));
  nand3  g095(.a(new_n132_), .b(new_n96_), .c(new_n109_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n119_), .b(new_n98_), .c(new_n72_), .d(new_n67_), .O(new_n144_));
  ...
  nand2  g103(.a(new_n149_), .b(new_n84_), .O(new_n150_));
  oai21  g104(.a(new_n77_), .b(new_n84_), .c(new_n52_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x20), .O(new_n152_));
  nor3   g106(.a(x24), .b(x23), .c(x22), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n118_), .c(new_n77_), .O(new_n154_));
  nor2   g108(.a(x21), .b(x20), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n96_), .O(new_n156_));
  ...
  oai21  g113(.a(new_n159_), .b(new_n154_), .c(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n152_), .c(new_n150_), .O(z15));
  nand2  g115(.a(x18), .b(x07), .O(new_n162_));
  oai21  g116(.a(x18), .b(new_n80_), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n84_), .O(new_n164_));
  inv1   g118(.a(x26), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n84_), .c(new_n52_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x20), .O(new_n167_));
  nand4  g121(.a(new_n157_), .b(new_n132_), .c(new_n106_), .d(new_n105_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x26), .O(new_n169_));
  nor3   g123(.a(x26), .b(x25), .c(x24), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n155_), .c(new_n132_), .d(new_n96_), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(x16), .O(new_n173_));
  nand3  g127(.a(new_n173_), .b(new_n167_), .c(new_n164_), .O(z16));
  nand4  g128(.a(new_n132_), .b(new_n165_), .c(new_n77_), .d(new_n72_), .O(new_n175_));
  nand3  g129(.a(new_n155_), .b(x19), .c(new_n105_), .O(new_n176_));
  oai22  g130(.a(new_n176_), .b(new_n175_), .c(new_n62_), .d(new_n105_), .O(new_n177_));
