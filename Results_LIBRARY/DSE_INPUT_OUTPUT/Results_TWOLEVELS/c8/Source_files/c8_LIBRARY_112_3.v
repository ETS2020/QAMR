...
module FAU ( 
  ...
  nand3  g048(.a(new_n94_), .b(new_n86_), .c(x09), .O(new_n95_));
  ...
  oai21  g056(.a(new_n92_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n94_), .c(x16), .O(new_n104_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n94_), .c(x16), .O(new_n113_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n92_), .c(new_n100_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n94_), .c(x16), .O(new_n122_));
  ...
  nand3  g081(.a(new_n57_), .b(new_n51_), .c(new_n127_), .O(new_n128_));
  inv1   g082(.a(x22), .O(new_n129_));
  inv1   g083(.a(x23), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(new_n100_), .O(new_n131_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n101_), .d(new_n90_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n101_), .d(new_n90_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n94_), .b(new_n86_), .c(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand2  g109(.a(new_n130_), .b(new_n129_), .O(new_n156_));
  inv1   g110(.a(x26), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n76_), .c(new_n71_), .O(new_n158_));
  ...
  nor2   g115(.a(new_n52_), .b(new_n127_), .O(new_n162_));
  aoi21  g116(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n94_), .c(new_n86_), .O(z17));
endmodule
