...
module FAU ( 
  ...
  oai21  g016(.a(x27), .b(x21), .c(new_n62_), .O(z02));
  ...
  nand2  g023(.a(new_n53_), .b(new_n69_), .O(new_n70_));
  aoi21  g024(.a(new_n70_), .b(new_n68_), .c(new_n49_), .O(z04));
  ...
  nand2  g035(.a(new_n81_), .b(new_n53_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  inv1   g037(.a(x00), .O(new_n84_));
  nand2  g038(.a(new_n48_), .b(x18), .O(new_n85_));
  oai22  g039(.a(new_n85_), .b(new_n84_), .c(x18), .d(new_n50_), .O(new_n86_));
  ...
  nand3  g045(.a(new_n91_), .b(new_n81_), .c(x16), .O(new_n92_));
  ...
  nor2   g050(.a(new_n89_), .b(new_n58_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n96_), .c(new_n81_), .O(z10));
  inv1   g054(.a(x02), .O(new_n101_));
  oai22  g055(.a(new_n85_), .b(new_n101_), .c(x18), .d(new_n61_), .O(new_n102_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n81_), .c(x16), .O(new_n108_));
  ...
  nand2  g070(.a(new_n116_), .b(new_n58_), .O(new_n117_));
  nor2   g071(.a(new_n117_), .b(new_n90_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n112_), .c(new_n81_), .O(z12));
  ...
  nand3  g078(.a(new_n124_), .b(new_n98_), .c(new_n104_), .O(new_n125_));
  oai21  g079(.a(new_n118_), .b(new_n69_), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x16), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n123_), .c(new_n81_), .O(z13));
  inv1   g082(.a(x05), .O(new_n129_));
  oai22  g083(.a(new_n85_), .b(new_n129_), .c(x18), .d(new_n72_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n83_), .O(new_n131_));
  nand3  g085(.a(new_n125_), .b(new_n81_), .c(x24), .O(new_n132_));
  inv1   g086(.a(x17), .O(new_n133_));
  inv1   g087(.a(x24), .O(new_n134_));
  inv1   g088(.a(x25), .O(new_n135_));
  oai21  g089(.a(x26), .b(new_n135_), .c(new_n47_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x26), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n134_), .c(new_n69_), .d(new_n113_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(x21), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n58_), .c(new_n52_), .d(new_n133_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n132_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n131_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n85_), .b(new_n144_), .c(x18), .d(new_n75_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n83_), .O(new_n146_));
  nand4  g100(.a(new_n116_), .b(new_n98_), .c(new_n134_), .d(new_n69_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x25), .O(new_n148_));
  nand4  g102(.a(new_n124_), .b(new_n114_), .c(new_n135_), .d(new_n134_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n81_), .c(x16), .O(new_n151_));
  ...
  nand3  g109(.a(x26), .b(x25), .c(new_n47_), .O(new_n156_));
  nand2  g110(.a(new_n48_), .b(new_n135_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n134_), .c(new_n69_), .d(new_n113_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(x21), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n58_), .c(new_n52_), .d(new_n133_), .O(new_n161_));
  aoi21  g115(.a(x24), .b(new_n47_), .c(x23), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n116_), .c(new_n98_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x26), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n155_), .c(new_n81_), .O(z16));
  nand3  g121(.a(new_n81_), .b(x27), .c(x17), .O(new_n168_));
  nor2   g122(.a(new_n52_), .b(x17), .O(new_n169_));
  nor2   g123(.a(new_n157_), .b(x24), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n169_), .c(new_n124_), .d(new_n105_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n168_), .c(new_n83_), .O(z17));
endmodule
