...
module FAU ( 
  ...
  oai21  g067(.a(new_n106_), .b(new_n63_), .c(new_n113_), .O(new_n114_));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n97_), .c(new_n68_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n97_), .c(new_n56_), .O(new_n122_));
  ...
  oai22  g080(.a(new_n93_), .b(new_n126_), .c(x18), .d(new_n73_), .O(new_n127_));
  ...
  oai21  g089(.a(x18), .b(new_n47_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n91_), .O(new_n137_));
  inv1   g091(.a(x24), .O(new_n138_));
  aoi21  g092(.a(new_n130_), .b(new_n106_), .c(new_n138_), .O(new_n139_));
  ...
  nand3  g099(.a(new_n145_), .b(new_n137_), .c(new_n48_), .O(z14));
  nand2  g100(.a(x18), .b(x06), .O(new_n147_));
  oai21  g101(.a(x18), .b(new_n82_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n91_), .O(new_n149_));
  nand2  g103(.a(new_n143_), .b(x25), .O(new_n150_));
  nor2   g104(.a(x23), .b(x22), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n151_), .c(new_n112_), .d(new_n97_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n149_), .c(new_n48_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  oai21  g111(.a(x18), .b(new_n85_), .c(new_n157_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n161_), .b(new_n151_), .c(new_n112_), .d(new_n97_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n159_), .c(new_n48_), .O(z16));
  nand4  g119(.a(new_n151_), .b(new_n87_), .c(new_n80_), .d(new_n138_), .O(new_n166_));
  nand3  g120(.a(new_n112_), .b(x19), .c(new_n140_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n53_), .d(new_n140_), .O(new_n168_));
