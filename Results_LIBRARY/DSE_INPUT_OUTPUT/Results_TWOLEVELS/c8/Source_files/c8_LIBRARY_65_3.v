...
module FAU ( 
  ...
  nand3  g105(.a(new_n151_), .b(new_n74_), .c(new_n122_), .O(new_n152_));
  nor2   g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n96_), .b(x19), .c(new_n124_), .O(new_n154_));
  inv1   g108(.a(new_n154_), .O(new_n155_));
  nor2   g109(.a(new_n58_), .b(new_n124_), .O(new_n156_));
  aoi21  g110(.a(new_n155_), .b(new_n153_), .c(new_n156_), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(new_n106_), .c(new_n102_), .O(z17));
endmodule
