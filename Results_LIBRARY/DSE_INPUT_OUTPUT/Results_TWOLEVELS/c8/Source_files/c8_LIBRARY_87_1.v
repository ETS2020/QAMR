...
module FAU ( 
  ...
  nand3  g53(.a(new_n48_), .b(new_n86_), .c(x10), .O(new_n100_));
  oai21  g54(.a(new_n99_), .b(new_n86_), .c(new_n100_), .O(z11));
  oai21  g55(.a(x18), .b(x11), .c(new_n86_), .O(new_n102_));
  nand2  g56(.a(new_n97_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n84_), .c(new_n54_), .O(new_n105_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n113_), .c(new_n66_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n98_), .c(new_n116_), .d(x25), .O(new_n124_));
  nand3  g78(.a(new_n48_), .b(new_n86_), .c(x14), .O(new_n125_));
  ...
  nand4  g92(.a(new_n129_), .b(new_n77_), .c(new_n121_), .d(new_n113_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n81_), .O(new_n140_));
