...
module FAU ( 
  ...
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n47_), .O(z07));
  aoi21  g035(.a(new_n69_), .b(new_n68_), .c(new_n51_), .O(z08));
  ...
  nand2  g047(.a(new_n69_), .b(x13), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n54_), .c(new_n93_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n88_), .O(new_n96_));
  inv1   g050(.a(x20), .O(new_n97_));
  nor2   g051(.a(new_n86_), .b(new_n97_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  or2    g053(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n105_), .c(new_n83_), .O(z11));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n86_), .c(new_n62_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n86_), .c(new_n97_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n83_), .O(z12));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  oai21  g075(.a(new_n94_), .b(new_n65_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n88_), .O(new_n123_));
  inv1   g077(.a(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n99_), .c(new_n106_), .O(new_n126_));
  oai21  g080(.a(new_n118_), .b(new_n124_), .c(new_n126_), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n83_), .c(x16), .O(new_n128_));
  ...
  oai21  g086(.a(new_n69_), .b(new_n88_), .c(new_n94_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n126_), .c(x24), .O(new_n134_));
  aoi21  g088(.a(new_n69_), .b(new_n68_), .c(x24), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n124_), .c(new_n62_), .d(new_n106_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(x20), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n50_), .c(new_n84_), .d(x16), .O(new_n138_));
  ...
  nand3  g097(.a(new_n143_), .b(new_n116_), .c(new_n99_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n107_), .d(new_n86_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n142_), .c(new_n83_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n69_), .b(x15), .c(x13), .O(new_n152_));
  ...
  nand4  g110(.a(new_n125_), .b(new_n79_), .c(new_n74_), .d(new_n156_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n108_), .c(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n83_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n154_), .O(z16));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n84_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n51_), .d(new_n84_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n83_), .O(z17));
endmodule
