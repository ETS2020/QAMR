...
module FAU ( 
  ...
  nand3  g082(.a(new_n68_), .b(new_n63_), .c(new_n101_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n96_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n113_), .c(new_n131_), .d(new_n85_), .O(new_n133_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n120_), .c(new_n103_), .d(new_n87_), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n120_), .c(new_n103_), .d(new_n87_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n89_), .b(x07), .O(new_n152_));
