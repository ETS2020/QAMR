...
module FAU ( 
  ...
  nand2  g034(.a(new_n48_), .b(x27), .O(new_n81_));
  inv1   g035(.a(x18), .O(new_n82_));
  nand3  g036(.a(new_n53_), .b(new_n47_), .c(new_n82_), .O(new_n83_));
  oai21  g037(.a(new_n81_), .b(x14), .c(new_n83_), .O(z06));
  ...
  oai21  g074(.a(new_n118_), .b(new_n66_), .c(new_n120_), .O(new_n121_));
  ...
  nand2  g079(.a(new_n125_), .b(new_n95_), .O(new_n126_));
  nand2  g080(.a(new_n120_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n104_), .c(new_n61_), .O(new_n129_));
  ...
  nand2  g087(.a(x25), .b(x18), .O(new_n134_));
  oai22  g088(.a(new_n134_), .b(new_n133_), .c(x18), .d(new_n76_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n95_), .O(new_n136_));
  nand3  g090(.a(new_n129_), .b(new_n48_), .c(x24), .O(new_n137_));
  nand2  g091(.a(new_n47_), .b(x18), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n78_), .c(new_n71_), .d(new_n66_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(x21), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n56_), .c(new_n52_), .d(new_n91_), .O(new_n141_));
  ...
  oai21  g100(.a(x18), .b(new_n145_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n95_), .O(new_n148_));
  nand4  g102(.a(new_n52_), .b(new_n82_), .c(new_n91_), .d(x16), .O(new_n149_));
  nor2   g103(.a(x24), .b(x23), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n110_), .c(new_n66_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n149_), .c(new_n82_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n47_), .O(new_n153_));
  nand3  g107(.a(new_n150_), .b(new_n119_), .c(new_n104_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(x25), .c(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n153_), .c(new_n148_), .O(z15));
  inv1   g110(.a(x07), .O(new_n157_));
  oai22  g111(.a(new_n134_), .b(new_n157_), .c(x18), .d(new_n87_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n95_), .O(new_n159_));
  nand2  g113(.a(new_n154_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n128_), .c(new_n118_), .O(new_n162_));
  ...
  nand3  g123(.a(new_n169_), .b(new_n161_), .c(new_n128_), .O(new_n170_));
  aoi21  g124(.a(new_n170_), .b(new_n167_), .c(new_n95_), .O(z17));
endmodule
