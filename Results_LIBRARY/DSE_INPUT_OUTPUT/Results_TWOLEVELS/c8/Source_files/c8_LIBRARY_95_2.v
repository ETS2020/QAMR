...
module FAU ( 
  ...
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(new_n82_), .O(z10));
  ...
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n82_), .O(z11));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n91_), .c(new_n63_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n82_), .O(z12));
  nand3  g075(.a(new_n86_), .b(x12), .c(new_n52_), .O(new_n122_));
  oai21  g076(.a(new_n86_), .b(new_n52_), .c(new_n122_), .O(new_n123_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n82_), .c(x16), .O(new_n129_));
  ...
  aoi21  g087(.a(new_n126_), .b(new_n101_), .c(new_n71_), .O(new_n134_));
  inv1   g088(.a(x17), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n117_), .c(new_n136_), .d(new_n135_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n134_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n133_), .c(new_n82_), .O(z14));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n108_), .d(new_n91_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n146_), .c(new_n71_), .O(new_n162_));
  nand3  g116(.a(new_n108_), .b(x19), .c(new_n135_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n135_), .O(new_n164_));
