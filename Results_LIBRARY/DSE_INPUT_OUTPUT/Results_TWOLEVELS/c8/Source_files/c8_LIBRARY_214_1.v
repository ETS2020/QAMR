...
module FAU ( 
  ...
  nand4  g058(.a(new_n63_), .b(new_n55_), .c(new_n47_), .d(new_n92_), .O(new_n105_));
  ...
  oai21  g063(.a(new_n107_), .b(new_n52_), .c(new_n109_), .O(z11));
  ...
  aoi21  g074(.a(new_n118_), .b(new_n100_), .c(new_n78_), .O(new_n121_));
  ...
  nand4  g082(.a(new_n81_), .b(new_n78_), .c(new_n73_), .d(new_n68_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  aoi22  g084(.a(new_n130_), .b(new_n106_), .c(new_n123_), .d(x25), .O(new_n131_));
  ...
  nand2  g095(.a(new_n108_), .b(x15), .O(new_n142_));
