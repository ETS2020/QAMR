...
module FAU ( 
  ...
  nand3  g059(.a(new_n105_), .b(new_n100_), .c(new_n80_), .O(z11));
  ...
  aoi21  g064(.a(new_n102_), .b(new_n84_), .c(new_n110_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n84_), .c(new_n53_), .O(new_n113_));
  ...
  nand3  g072(.a(new_n118_), .b(x12), .c(x01), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n95_), .c(new_n101_), .O(new_n124_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n123_), .c(new_n102_), .d(new_n84_), .O(new_n147_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n123_), .c(new_n102_), .d(new_n84_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n80_), .O(z16));
  inv1   g113(.a(x24), .O(new_n160_));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n123_), .c(new_n160_), .O(new_n162_));
  nand3  g116(.a(new_n102_), .b(x19), .c(new_n81_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n54_), .d(new_n81_), .O(new_n164_));
