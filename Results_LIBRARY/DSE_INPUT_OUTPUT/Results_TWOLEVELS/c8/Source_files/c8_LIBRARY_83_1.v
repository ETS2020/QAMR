...
module FAU ( 
  ...
  aoi21  g041(.a(x18), .b(new_n47_), .c(new_n53_), .O(z08));
  ...
  oai21  g059(.a(new_n95_), .b(new_n58_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g074(.a(new_n113_), .b(new_n95_), .c(new_n68_), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n95_), .c(new_n58_), .O(new_n123_));
  ...
  oai22  g081(.a(new_n91_), .b(new_n127_), .c(x18), .d(new_n71_), .O(new_n128_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n104_), .d(new_n103_), .O(new_n142_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n113_), .d(new_n95_), .O(new_n152_));
  ...
  oai22  g110(.a(new_n91_), .b(new_n156_), .c(x18), .d(new_n85_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n113_), .d(new_n95_), .O(new_n161_));
  ...
  nand4  g118(.a(new_n150_), .b(new_n83_), .c(new_n80_), .d(new_n139_), .O(new_n165_));
  nand3  g119(.a(new_n113_), .b(x19), .c(new_n103_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n53_), .d(new_n103_), .O(new_n167_));
