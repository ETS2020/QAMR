...
module FAU ( 
  ...
  nand4  g56(.a(new_n102_), .b(new_n93_), .c(new_n85_), .d(new_n84_), .O(new_n103_));
  ...
  nand2  g65(.a(new_n97_), .b(x03), .O(new_n112_));
  ...
  aoi22  g69(.a(new_n115_), .b(new_n95_), .c(new_n110_), .d(x23), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n89_), .c(new_n114_), .O(z13));
  oai21  g71(.a(new_n90_), .b(x05), .c(new_n89_), .O(new_n118_));
  aoi21  g72(.a(new_n115_), .b(new_n95_), .c(new_n70_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n100_), .d(new_n84_), .O(new_n121_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n104_), .c(new_n121_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n97_), .b(x06), .O(new_n128_));
  ...
  nand2  g92(.a(new_n97_), .b(x07), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n138_), .O(z16));
  inv1   g94(.a(new_n48_), .O(new_n141_));
  nand4  g95(.a(new_n131_), .b(new_n80_), .c(new_n75_), .d(new_n70_), .O(new_n142_));
  nand3  g96(.a(new_n130_), .b(x19), .c(new_n84_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n60_), .d(new_n84_), .O(new_n144_));
