...
module FAU ( 
  ...
  nand3  g072(.a(new_n118_), .b(new_n92_), .c(new_n99_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n90_), .b(new_n82_), .c(new_n81_), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n60_), .c(new_n99_), .O(new_n128_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n100_), .d(new_n84_), .O(new_n139_));
  ...
  nand3  g110(.a(new_n100_), .b(x19), .c(new_n81_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n61_), .b(new_n81_), .O(new_n159_));
