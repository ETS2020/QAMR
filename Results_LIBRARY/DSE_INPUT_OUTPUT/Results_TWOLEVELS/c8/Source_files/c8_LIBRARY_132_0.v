...
module FAU ( 
  ...
  oai21  g63(.a(new_n108_), .b(new_n96_), .c(new_n109_), .O(z12));
  oai21  g64(.a(new_n86_), .b(x04), .c(new_n96_), .O(new_n111_));
  ...
  oai21  g68(.a(new_n86_), .b(x05), .c(new_n96_), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n92_), .c(new_n70_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n75_), .b(new_n70_), .c(new_n122_), .d(new_n62_), .O(new_n123_));
