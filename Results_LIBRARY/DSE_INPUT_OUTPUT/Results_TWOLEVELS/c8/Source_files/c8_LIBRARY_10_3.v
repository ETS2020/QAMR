...
module FAU ( 
  ...
  nand3  g045(.a(new_n91_), .b(new_n88_), .c(new_n52_), .O(z09));
  nand2  g046(.a(x18), .b(x01), .O(new_n93_));
  oai22  g047(.a(new_n93_), .b(x00), .c(x18), .d(new_n55_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n89_), .O(new_n95_));
  nor2   g049(.a(x20), .b(x19), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n85_), .O(new_n97_));
  oai21  g051(.a(new_n87_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  ...
  oai22  g055(.a(new_n101_), .b(x00), .c(x18), .d(new_n60_), .O(new_n102_));
  ...
  oai22  g064(.a(new_n110_), .b(x00), .c(x18), .d(new_n65_), .O(new_n111_));
  ...
  oai22  g073(.a(new_n119_), .b(x00), .c(x18), .d(new_n68_), .O(new_n120_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n130_), .c(new_n52_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  oai22  g092(.a(new_n138_), .b(x00), .c(x18), .d(new_n76_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n87_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n105_), .d(new_n87_), .O(new_n153_));
  ...
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n50_), .d(new_n85_), .O(new_n160_));
