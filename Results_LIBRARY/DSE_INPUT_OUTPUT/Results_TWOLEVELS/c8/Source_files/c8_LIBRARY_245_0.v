...
module FAU ( 
  ...
  nand3  g49(.a(x18), .b(new_n89_), .c(x01), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n95_), .O(z10));
  oai21  g51(.a(new_n90_), .b(x02), .c(new_n89_), .O(new_n98_));
  ...
  aoi21  g69(.a(new_n113_), .b(new_n94_), .c(new_n70_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n99_), .d(new_n84_), .O(new_n118_));
  ...
  oai21  g76(.a(new_n90_), .b(x06), .c(new_n89_), .O(new_n123_));
  inv1   g77(.a(x23), .O(new_n124_));
  nand4  g78(.a(new_n75_), .b(new_n70_), .c(new_n124_), .d(new_n62_), .O(new_n125_));
