...
module FAU ( 
  ...
  nand2  g055(.a(new_n56_), .b(new_n47_), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n58_), .c(new_n101_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  oai21  g058(.a(x19), .b(x17), .c(x20), .O(new_n105_));
  nand3  g059(.a(new_n56_), .b(new_n52_), .c(new_n92_), .O(new_n106_));
  ...
  nand2  g067(.a(new_n113_), .b(x20), .O(new_n114_));
  nor2   g068(.a(x21), .b(x20), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n94_), .O(new_n116_));
  oai21  g070(.a(new_n94_), .b(new_n63_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n114_), .c(new_n112_), .O(z11));
  nand2  g073(.a(x18), .b(x03), .O(new_n120_));
  oai21  g074(.a(new_n102_), .b(new_n66_), .c(new_n120_), .O(new_n121_));
  ...
  nor2   g080(.a(new_n68_), .b(new_n56_), .O(new_n127_));
  aoi22  g081(.a(new_n127_), .b(x18), .c(new_n126_), .d(new_n56_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n96_), .c(new_n122_), .O(z12));
  nand2  g083(.a(x18), .b(x04), .O(new_n130_));
  oai21  g084(.a(new_n102_), .b(new_n71_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n96_), .O(new_n132_));
  nand2  g086(.a(new_n125_), .b(x23), .O(new_n133_));
  nor2   g087(.a(x23), .b(x22), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n94_), .c(new_n63_), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n133_), .c(x20), .O(new_n136_));
  nand3  g090(.a(x23), .b(x20), .c(x18), .O(new_n137_));
  ...
  oai21  g095(.a(new_n102_), .b(new_n76_), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n96_), .O(new_n143_));
  nand2  g097(.a(new_n135_), .b(x24), .O(new_n144_));
  nor2   g098(.a(x24), .b(x23), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n123_), .c(new_n68_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n144_), .c(x20), .O(new_n147_));
  nand3  g101(.a(x24), .b(x20), .c(x18), .O(new_n148_));
  ...
  oai21  g106(.a(new_n102_), .b(new_n83_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n96_), .O(new_n154_));
  nand3  g108(.a(new_n63_), .b(new_n52_), .c(new_n92_), .O(new_n155_));
  nand3  g109(.a(new_n78_), .b(new_n73_), .c(new_n68_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n155_), .c(x25), .O(new_n157_));
  nor2   g111(.a(x21), .b(x19), .O(new_n158_));
  nor2   g112(.a(x25), .b(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n134_), .c(new_n158_), .d(new_n92_), .O(new_n160_));
  ...
  nand2  g118(.a(new_n164_), .b(new_n154_), .O(z15));
  nand2  g119(.a(x18), .b(x07), .O(new_n166_));
  oai21  g120(.a(new_n102_), .b(new_n88_), .c(new_n166_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n96_), .O(new_n168_));
  nand2  g122(.a(new_n160_), .b(x26), .O(new_n169_));
  nor2   g123(.a(x26), .b(x25), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n145_), .c(new_n124_), .d(new_n94_), .O(new_n171_));
  ...
  nor2   g131(.a(new_n52_), .b(x17), .O(new_n178_));
  nor3   g132(.a(x26), .b(x25), .c(x24), .O(new_n179_));
  nand4  g133(.a(new_n179_), .b(new_n178_), .c(new_n134_), .d(new_n115_), .O(new_n180_));
