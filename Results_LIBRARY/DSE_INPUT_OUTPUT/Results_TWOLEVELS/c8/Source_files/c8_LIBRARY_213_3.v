...
module FAU ( 
  ...
  oai21  g022(.a(x27), .b(new_n68_), .c(new_n67_), .O(new_n69_));
  inv1   g023(.a(x18), .O(new_n70_));
  nand3  g024(.a(new_n55_), .b(new_n68_), .c(new_n70_), .O(new_n71_));
  nand2  g025(.a(new_n71_), .b(new_n69_), .O(z05));
  ...
  nand2  g039(.a(x18), .b(new_n67_), .O(new_n86_));
  ...
  nand2  g084(.a(new_n70_), .b(x13), .O(new_n131_));
  oai21  g085(.a(new_n86_), .b(new_n130_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n84_), .O(new_n133_));
  inv1   g087(.a(x22), .O(new_n134_));
  inv1   g088(.a(x23), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n134_), .c(new_n105_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n98_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n116_), .c(new_n138_), .d(new_n96_), .O(new_n140_));
  ...
  oai22  g098(.a(new_n86_), .b(new_n144_), .c(x18), .d(new_n73_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n84_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n125_), .c(new_n107_), .d(new_n95_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n125_), .c(new_n107_), .d(new_n95_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n125_), .b(new_n80_), .c(new_n75_), .d(new_n68_), .O(new_n162_));
  nand3  g116(.a(new_n107_), .b(x19), .c(new_n96_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n55_), .d(new_n96_), .O(new_n164_));
