...
module FAU ( 
  ...
  nor2   g047(.a(new_n87_), .b(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(x00), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n93_), .c(new_n88_), .O(z09));
  ...
  nand3  g053(.a(new_n54_), .b(new_n90_), .c(new_n89_), .O(new_n100_));
  oai21  g054(.a(new_n92_), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  ...
  aoi21  g068(.a(new_n108_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n92_), .c(new_n54_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n94_), .b(x03), .O(new_n120_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n107_), .c(new_n60_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n68_), .b(new_n114_), .c(new_n60_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n100_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n116_), .c(new_n136_), .d(new_n89_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n126_), .c(new_n108_), .d(new_n92_), .O(new_n147_));
