...
module FAU ( 
  ...
  nand2  g029(.a(new_n55_), .b(new_n74_), .O(new_n76_));
  oai21  g030(.a(new_n76_), .b(x18), .c(new_n75_), .O(z05));
  ...
  nand3  g049(.a(new_n95_), .b(new_n91_), .c(new_n48_), .O(z09));
  inv1   g050(.a(x01), .O(new_n97_));
  nand2  g051(.a(x18), .b(new_n73_), .O(new_n98_));
  oai22  g052(.a(new_n98_), .b(new_n97_), .c(x18), .d(new_n52_), .O(new_n99_));
  ...
  oai21  g057(.a(new_n90_), .b(new_n54_), .c(new_n103_), .O(new_n104_));
  ...
  oai22  g070(.a(new_n98_), .b(new_n116_), .c(x18), .d(new_n63_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n90_), .c(new_n54_), .O(new_n121_));
  ...
  oai21  g087(.a(x18), .b(new_n92_), .c(x13), .O(new_n134_));
  aoi21  g088(.a(new_n129_), .b(new_n110_), .c(new_n74_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n120_), .c(new_n102_), .d(new_n101_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(x18), .b(new_n92_), .c(x05), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n139_), .c(new_n134_), .O(z14));
  inv1   g095(.a(x06), .O(new_n142_));
  oai22  g096(.a(new_n98_), .b(new_n142_), .c(x18), .d(new_n78_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n111_), .d(new_n90_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n111_), .d(new_n90_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n146_), .b(new_n85_), .c(new_n80_), .d(new_n74_), .O(new_n161_));
  nand3  g115(.a(new_n111_), .b(x19), .c(new_n101_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n101_), .O(new_n163_));
