...
module FAU ( 
  ...
  nand2  g050(.a(new_n89_), .b(x01), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(z10));
  nand2  g052(.a(x18), .b(x02), .O(new_n99_));
  oai21  g053(.a(x18), .b(new_n58_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n47_), .O(new_n101_));
  inv1   g055(.a(x21), .O(new_n102_));
  nor2   g056(.a(x21), .b(x20), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n87_), .O(new_n104_));
  oai21  g058(.a(new_n95_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g062(.a(new_n103_), .b(new_n87_), .c(new_n63_), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n87_), .c(new_n93_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n89_), .b(x03), .O(new_n114_));
  ...
  nand2  g105(.a(new_n68_), .b(new_n63_), .O(new_n152_));
  inv1   g106(.a(x26), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n76_), .c(new_n125_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n85_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n52_), .b(new_n85_), .O(new_n158_));
  aoi21  g112(.a(new_n157_), .b(new_n155_), .c(new_n158_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(x18), .c(new_n47_), .O(z17));
endmodule
