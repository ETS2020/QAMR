...
module FAU ( 
  ...
  nor2   g025(.a(new_n49_), .b(new_n53_), .O(z08));
  nand2  g026(.a(z08), .b(new_n71_), .O(new_n73_));
  inv1   g027(.a(x18), .O(new_n74_));
  nand3  g028(.a(new_n53_), .b(new_n47_), .c(new_n74_), .O(new_n75_));
  ...
  nand2  g055(.a(x23), .b(x18), .O(new_n102_));
  oai22  g056(.a(new_n102_), .b(new_n101_), .c(x18), .d(new_n56_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nor2   g058(.a(new_n94_), .b(new_n49_), .O(new_n105_));
  nand4  g059(.a(new_n48_), .b(new_n58_), .c(new_n52_), .d(new_n92_), .O(new_n106_));
  inv1   g060(.a(new_n106_), .O(new_n107_));
  aoi21  g061(.a(new_n105_), .b(x20), .c(new_n107_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n96_), .c(new_n104_), .O(z10));
  ...
  nand3  g068(.a(new_n114_), .b(new_n48_), .c(x21), .O(new_n115_));
  nand4  g069(.a(new_n48_), .b(new_n61_), .c(new_n58_), .d(new_n52_), .O(new_n116_));
  ...
  oai22  g074(.a(new_n102_), .b(new_n120_), .c(x18), .d(new_n68_), .O(new_n121_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n48_), .c(x22), .O(new_n125_));
  aoi21  g079(.a(new_n47_), .b(x18), .c(x22), .O(new_n126_));
  nand4  g080(.a(new_n126_), .b(new_n61_), .c(new_n58_), .d(new_n52_), .O(new_n127_));
  ...
  nor2   g087(.a(new_n47_), .b(new_n66_), .O(new_n134_));
  nor3   g088(.a(x23), .b(x22), .c(x18), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n134_), .c(new_n61_), .O(new_n136_));
  nand2  g090(.a(x23), .b(x21), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n58_), .c(new_n52_), .d(new_n92_), .O(new_n139_));
  nand2  g093(.a(new_n114_), .b(x23), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n133_), .c(new_n48_), .O(z13));
  ...
  nand4  g101(.a(new_n147_), .b(new_n123_), .c(new_n94_), .d(x16), .O(new_n148_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n113_), .c(new_n61_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(x24), .c(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n150_), .c(new_n146_), .O(z14));
  inv1   g108(.a(x06), .O(new_n155_));
  oai22  g109(.a(new_n102_), .b(new_n155_), .c(x18), .d(new_n82_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n96_), .O(new_n157_));
  nand3  g111(.a(new_n147_), .b(new_n113_), .c(new_n61_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x25), .O(new_n159_));
  inv1   g113(.a(new_n124_), .O(new_n160_));
  nor2   g114(.a(x25), .b(x24), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n151_), .c(new_n160_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n159_), .c(x18), .O(new_n163_));
  nor2   g117(.a(new_n84_), .b(new_n47_), .O(new_n164_));
  oai21  g118(.a(new_n164_), .b(new_n163_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n157_), .O(z15));
  inv1   g120(.a(x07), .O(new_n167_));
  oai22  g121(.a(new_n102_), .b(new_n167_), .c(x18), .d(new_n87_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n96_), .O(new_n169_));
  nand3  g123(.a(new_n161_), .b(new_n66_), .c(new_n61_), .O(new_n170_));
  oai21  g124(.a(new_n170_), .b(new_n114_), .c(x26), .O(new_n171_));
  nor3   g125(.a(x26), .b(x25), .c(x24), .O(new_n172_));
  and2   g126(.a(new_n172_), .b(new_n151_), .O(new_n173_));
  nand2  g127(.a(new_n173_), .b(new_n160_), .O(new_n174_));
  aoi21  g128(.a(new_n174_), .b(new_n171_), .c(x18), .O(new_n175_));
  nor2   g129(.a(new_n89_), .b(new_n47_), .O(new_n176_));
  oai21  g130(.a(new_n176_), .b(new_n175_), .c(x16), .O(new_n177_));
  nand2  g131(.a(new_n177_), .b(new_n169_), .O(z16));
  nand2  g132(.a(z08), .b(x17), .O(new_n179_));
  nor2   g133(.a(x18), .b(x17), .O(new_n180_));
  nand4  g134(.a(new_n180_), .b(new_n173_), .c(new_n123_), .d(x19), .O(new_n181_));
  aoi21  g135(.a(new_n181_), .b(new_n179_), .c(new_n96_), .O(z17));
endmodule
