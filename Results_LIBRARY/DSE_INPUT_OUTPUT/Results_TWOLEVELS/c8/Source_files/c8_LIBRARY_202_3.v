...
module FAU ( 
  ...
  nor2   g052(.a(new_n93_), .b(new_n98_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  inv1   g055(.a(x18), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n87_), .c(x09), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n101_), .c(new_n52_), .O(z10));
  nand2  g058(.a(x18), .b(x02), .O(new_n105_));
  oai22  g059(.a(new_n105_), .b(x01), .c(x18), .d(new_n58_), .O(new_n106_));
  ...
  oai21  g063(.a(new_n100_), .b(new_n60_), .c(new_n109_), .O(new_n110_));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n93_), .c(new_n65_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n93_), .c(new_n98_), .O(new_n118_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n100_), .c(new_n60_), .O(new_n127_));
  ...
  oai22  g085(.a(new_n131_), .b(x01), .c(x18), .d(new_n73_), .O(new_n132_));
  ...
  oai22  g098(.a(new_n144_), .b(x01), .c(x18), .d(new_n76_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n87_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n108_), .d(new_n93_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n108_), .d(new_n93_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n126_), .b(new_n83_), .c(new_n78_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n134_), .O(new_n164_));
