...
module FAU ( 
  ...
  aoi21  g010(.a(x27), .b(x18), .c(new_n56_), .O(new_n57_));
  oai22  g011(.a(new_n57_), .b(x09), .c(x27), .d(x20), .O(z01));
  inv1   g012(.a(x21), .O(new_n59_));
  nand2  g013(.a(new_n53_), .b(new_n59_), .O(new_n60_));
  inv1   g014(.a(x10), .O(new_n61_));
  nand2  g015(.a(x27), .b(new_n61_), .O(new_n62_));
  nand3  g016(.a(new_n62_), .b(new_n60_), .c(new_n48_), .O(z02));
  ...
  nor2   g052(.a(x20), .b(x18), .O(new_n99_));
  aoi22  g053(.a(new_n99_), .b(x09), .c(x18), .d(x01), .O(new_n100_));
  nor3   g054(.a(new_n92_), .b(new_n56_), .c(new_n47_), .O(new_n101_));
  ...
  oai21  g061(.a(new_n59_), .b(new_n94_), .c(x18), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x20), .O(new_n109_));
  ...
  oai21  g071(.a(new_n64_), .b(new_n94_), .c(x18), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x20), .O(new_n119_));
  nor3   g073(.a(x21), .b(x19), .c(x17), .O(new_n120_));
  nor2   g074(.a(new_n120_), .b(new_n64_), .O(new_n121_));
  nand2  g075(.a(new_n52_), .b(new_n90_), .O(new_n122_));
  nand2  g076(.a(new_n64_), .b(new_n59_), .O(new_n123_));
  nor3   g077(.a(new_n123_), .b(new_n122_), .c(x20), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n119_), .c(new_n117_), .O(z12));
  inv1   g080(.a(new_n99_), .O(new_n127_));
  nand2  g081(.a(x18), .b(x04), .O(new_n128_));
  oai21  g082(.a(new_n127_), .b(new_n69_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n94_), .O(new_n130_));
  oai21  g084(.a(new_n123_), .b(new_n122_), .c(x23), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n92_), .c(new_n59_), .O(new_n133_));
  aoi21  g087(.a(new_n133_), .b(new_n131_), .c(x20), .O(new_n134_));
  nand3  g088(.a(x23), .b(x20), .c(x18), .O(new_n135_));
  ...
  oai21  g093(.a(new_n127_), .b(new_n74_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n94_), .O(new_n141_));
  nand2  g095(.a(new_n133_), .b(x24), .O(new_n142_));
  nor3   g096(.a(x24), .b(x23), .c(x22), .O(new_n143_));
  ...
  oai21  g106(.a(new_n79_), .b(new_n94_), .c(x18), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x20), .O(new_n154_));
  aoi21  g108(.a(new_n143_), .b(new_n120_), .c(new_n79_), .O(new_n155_));
  nand3  g109(.a(new_n132_), .b(new_n79_), .c(new_n76_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n111_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n155_), .c(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n154_), .c(new_n152_), .O(z15));
  nand2  g113(.a(x18), .b(x07), .O(new_n160_));
  oai21  g114(.a(x18), .b(new_n84_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n94_), .O(new_n162_));
  oai21  g116(.a(new_n86_), .b(new_n94_), .c(x18), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x20), .O(new_n164_));
  inv1   g118(.a(new_n156_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n120_), .c(new_n86_), .O(new_n166_));
  nor3   g120(.a(x26), .b(x25), .c(x24), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n132_), .O(new_n168_));
  nor2   g122(.a(new_n168_), .b(new_n111_), .O(new_n169_));
  oai21  g123(.a(new_n169_), .b(new_n166_), .c(x16), .O(new_n170_));
  nand3  g124(.a(new_n170_), .b(new_n164_), .c(new_n162_), .O(z16));
  nand2  g125(.a(z08), .b(x17), .O(new_n172_));
  nor2   g126(.a(new_n52_), .b(x17), .O(new_n173_));
  nand4  g127(.a(new_n173_), .b(new_n167_), .c(new_n132_), .d(new_n110_), .O(new_n174_));
  aoi21  g128(.a(new_n174_), .b(new_n172_), .c(new_n94_), .O(z17));
endmodule
