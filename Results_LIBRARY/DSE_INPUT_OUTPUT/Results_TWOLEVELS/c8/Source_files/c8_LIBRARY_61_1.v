...
module FAU ( 
  ...
  oai22  g53(.a(new_n99_), .b(new_n93_), .c(new_n86_), .d(new_n58_), .O(z11));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n83_), .c(new_n97_), .d(x22), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n93_), .c(new_n86_), .d(new_n61_), .O(z12));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n83_), .c(new_n88_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n90_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n93_), .c(new_n86_), .d(new_n64_), .O(z13));
  aoi21  g62(.a(new_n106_), .b(new_n90_), .c(new_n69_), .O(new_n109_));
  nor2   g63(.a(x24), .b(x23), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n104_), .c(new_n94_), .d(new_n81_), .O(new_n111_));
  inv1   g65(.a(new_n111_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g67(.a(new_n85_), .b(x13), .O(new_n114_));
  ...
  aoi22  g74(.a(new_n120_), .b(new_n98_), .c(new_n111_), .d(x25), .O(new_n121_));
  nand2  g75(.a(new_n85_), .b(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n93_), .c(new_n122_), .O(z15));
  nor2   g77(.a(x21), .b(x20), .O(new_n124_));
  nor2   g78(.a(x23), .b(x22), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n83_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n125_), .c(new_n124_), .d(new_n83_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g86(.a(new_n85_), .b(x15), .O(new_n133_));
  ...
  aoi21  g91(.a(new_n137_), .b(new_n136_), .c(new_n93_), .O(z17));
endmodule
