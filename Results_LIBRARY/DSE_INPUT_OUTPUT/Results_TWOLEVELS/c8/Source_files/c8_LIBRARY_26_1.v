...
module FAU ( 
  ...
  nand3  g078(.a(new_n56_), .b(new_n52_), .c(new_n89_), .O(new_n125_));
  nand3  g079(.a(new_n73_), .b(new_n68_), .c(new_n63_), .O(new_n126_));
  oai22  g080(.a(new_n126_), .b(new_n125_), .c(new_n119_), .d(new_n73_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n124_), .c(new_n48_), .O(z13));
  inv1   g083(.a(x05), .O(new_n130_));
  aoi21  g084(.a(x18), .b(new_n130_), .c(x16), .O(new_n131_));
  oai21  g085(.a(new_n126_), .b(new_n125_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n117_), .c(new_n102_), .O(new_n134_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n137_), .c(x16), .O(new_n138_));
  oai21  g092(.a(new_n136_), .b(new_n47_), .c(new_n138_), .O(z14));
  inv1   g093(.a(x06), .O(new_n140_));
  nand2  g094(.a(x18), .b(x13), .O(new_n141_));
  oai22  g095(.a(new_n141_), .b(new_n140_), .c(x18), .d(new_n78_), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n108_), .d(new_n91_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n141_), .b(new_n151_), .c(x18), .d(new_n85_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n93_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  inv1   g108(.a(x24), .O(new_n155_));
  nand4  g109(.a(new_n145_), .b(new_n83_), .c(new_n80_), .d(new_n155_), .O(new_n156_));
  ...
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n53_), .d(new_n89_), .O(new_n161_));
