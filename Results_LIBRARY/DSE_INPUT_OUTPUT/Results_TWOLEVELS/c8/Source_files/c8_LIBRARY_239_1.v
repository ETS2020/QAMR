...
module FAU ( 
  ...
  oai22  g54(.a(new_n100_), .b(new_n86_), .c(new_n93_), .d(new_n58_), .O(z11));
  ...
  aoi21  g65(.a(new_n109_), .b(new_n90_), .c(new_n69_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n104_), .c(new_n95_), .d(new_n81_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n92_), .b(x13), .O(new_n117_));
