...
module FAU ( 
  ...
  nor2   g42(.a(new_n83_), .b(new_n57_), .O(new_n89_));
  ...
  nand4  g50(.a(new_n96_), .b(new_n57_), .c(new_n51_), .d(new_n81_), .O(new_n97_));
  ...
  nand3  g57(.a(new_n103_), .b(new_n83_), .c(new_n57_), .O(new_n104_));
  ...
  nand3  g62(.a(new_n47_), .b(new_n85_), .c(x12), .O(new_n109_));
  oai21  g63(.a(new_n108_), .b(new_n85_), .c(new_n109_), .O(z13));
  inv1   g64(.a(x24), .O(new_n111_));
  aoi21  g65(.a(new_n107_), .b(new_n90_), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n103_), .c(new_n94_), .d(new_n81_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g70(.a(new_n47_), .b(new_n85_), .c(x13), .O(new_n117_));
  ...
  oai21  g79(.a(new_n125_), .b(new_n85_), .c(new_n119_), .O(z15));
  oai21  g80(.a(x18), .b(x15), .c(new_n85_), .O(new_n127_));
