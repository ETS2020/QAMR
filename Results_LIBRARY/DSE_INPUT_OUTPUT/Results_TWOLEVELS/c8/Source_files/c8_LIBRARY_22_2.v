...
module FAU ( 
  ...
  nand3  g042(.a(new_n88_), .b(x08), .c(new_n52_), .O(new_n89_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n84_), .c(x16), .O(new_n96_));
  ...
  nand3  g058(.a(new_n104_), .b(new_n100_), .c(new_n84_), .O(z10));
  nand3  g059(.a(new_n88_), .b(x10), .c(new_n52_), .O(new_n106_));
  oai21  g060(.a(new_n88_), .b(new_n52_), .c(new_n106_), .O(new_n107_));
  ...
  aoi21  g072(.a(new_n110_), .b(new_n93_), .c(new_n118_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n93_), .c(new_n101_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n117_), .c(new_n84_), .O(z12));
  ...
  nand3  g083(.a(new_n129_), .b(new_n103_), .c(new_n109_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n127_), .c(new_n84_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  nand3  g088(.a(new_n88_), .b(x13), .c(new_n52_), .O(new_n135_));
  ...
  nand3  g093(.a(new_n66_), .b(new_n118_), .c(new_n109_), .O(new_n140_));
  ...
  nand3  g102(.a(new_n88_), .b(x14), .c(new_n52_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n129_), .c(new_n110_), .d(new_n93_), .O(new_n154_));
  ...
  nand4  g116(.a(new_n162_), .b(new_n129_), .c(new_n110_), .d(new_n93_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n160_), .c(new_n84_), .O(z16));
  nand4  g120(.a(new_n129_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n167_));
  nand3  g121(.a(new_n110_), .b(x19), .c(new_n138_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n50_), .d(new_n138_), .O(new_n169_));
