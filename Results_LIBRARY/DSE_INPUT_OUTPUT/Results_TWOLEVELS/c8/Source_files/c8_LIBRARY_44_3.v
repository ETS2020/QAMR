...
module FAU ( 
  ...
  inv1   g059(.a(new_n99_), .O(new_n106_));
  nor2   g060(.a(x21), .b(x20), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n86_), .O(new_n108_));
  oai21  g062(.a(new_n106_), .b(new_n94_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x16), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n105_), .c(new_n48_), .O(z11));
  ...
  oai21  g070(.a(new_n116_), .b(new_n88_), .c(new_n115_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x21), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n86_), .c(new_n54_), .O(new_n120_));
  oai21  g074(.a(new_n106_), .b(new_n116_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n118_), .c(new_n114_), .O(z12));
  ...
  oai21  g080(.a(new_n66_), .b(new_n88_), .c(new_n115_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x21), .O(new_n128_));
  nor2   g082(.a(x22), .b(x20), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(new_n86_), .c(new_n66_), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n94_), .O(new_n132_));
  nor2   g086(.a(new_n132_), .b(new_n99_), .O(new_n133_));
  ...
  oai21  g092(.a(new_n71_), .b(new_n88_), .c(new_n115_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x21), .O(new_n140_));
  nand3  g094(.a(new_n131_), .b(new_n86_), .c(new_n54_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x24), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n119_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n99_), .c(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n140_), .c(new_n138_), .O(z14));
  ...
  oai21  g104(.a(new_n76_), .b(new_n88_), .c(new_n115_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x21), .O(new_n152_));
  nor3   g106(.a(x24), .b(x23), .c(x22), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n106_), .c(new_n76_), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n131_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n108_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n154_), .c(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n152_), .c(new_n150_), .O(z15));
  inv1   g113(.a(x07), .O(new_n160_));
  oai22  g114(.a(new_n95_), .b(new_n160_), .c(x18), .d(new_n79_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n88_), .O(new_n162_));
  nand4  g116(.a(new_n155_), .b(new_n131_), .c(new_n98_), .d(new_n83_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x26), .O(new_n164_));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n143_), .c(new_n129_), .d(new_n86_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n164_), .c(x21), .O(new_n167_));
  nand2  g121(.a(x26), .b(x21), .O(new_n168_));
  nor2   g122(.a(new_n168_), .b(x18), .O(new_n169_));
  ...
  nor2   g126(.a(new_n84_), .b(x17), .O(new_n173_));
  nor3   g127(.a(x26), .b(x25), .c(x24), .O(new_n174_));
  nand4  g128(.a(new_n174_), .b(new_n173_), .c(new_n131_), .d(new_n107_), .O(new_n175_));
