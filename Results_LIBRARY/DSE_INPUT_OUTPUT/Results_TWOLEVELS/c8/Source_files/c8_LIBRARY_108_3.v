...
module FAU ( 
  ...
  nand3  g057(.a(new_n103_), .b(new_n88_), .c(x16), .O(new_n104_));
  ...
  nand2  g061(.a(new_n107_), .b(new_n82_), .O(new_n108_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n88_), .c(x16), .O(new_n113_));
  ...
  nor2   g074(.a(x18), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x12), .O(new_n122_));
  ...
  nand2  g084(.a(new_n121_), .b(x13), .O(new_n131_));
  ...
  nand2  g093(.a(new_n121_), .b(x14), .O(new_n140_));
  ...
  nand2  g101(.a(new_n121_), .b(x15), .O(new_n148_));
