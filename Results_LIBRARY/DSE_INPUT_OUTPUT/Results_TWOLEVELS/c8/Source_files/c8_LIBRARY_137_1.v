...
module FAU ( 
  ...
  nand2  g28(.a(new_n52_), .b(new_n74_), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z06));
  inv1   g30(.a(x15), .O(new_n77_));
  aoi21  g31(.a(x27), .b(new_n77_), .c(new_n48_), .O(new_n78_));
  ...
  nand4  g51(.a(new_n97_), .b(new_n90_), .c(new_n51_), .d(new_n81_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n96_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai22  g54(.a(new_n100_), .b(new_n88_), .c(new_n86_), .d(new_n58_), .O(z11));
  oai21  g55(.a(x18), .b(x11), .c(new_n88_), .O(new_n102_));
  nand2  g56(.a(new_n98_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n83_), .c(new_n90_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n88_), .c(new_n102_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n88_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n92_), .c(new_n105_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n88_), .c(new_n108_), .O(z13));
  inv1   g65(.a(x24), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n92_), .c(new_n112_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n104_), .c(new_n95_), .d(new_n81_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g71(.a(new_n85_), .b(x13), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n117_), .O(z14));
  oai21  g73(.a(x18), .b(x14), .c(new_n88_), .O(new_n120_));
  inv1   g74(.a(x23), .O(new_n121_));
  nand4  g75(.a(new_n74_), .b(new_n112_), .c(new_n121_), .d(new_n63_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n99_), .c(new_n115_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n88_), .c(new_n120_), .O(z15));
  ...
  nand2  g88(.a(new_n85_), .b(x15), .O(new_n135_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n88_), .O(z17));
endmodule
