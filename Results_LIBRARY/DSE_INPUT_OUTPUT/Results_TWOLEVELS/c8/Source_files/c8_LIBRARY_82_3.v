...
module FAU ( 
  ...
  nand3  g082(.a(new_n70_), .b(new_n128_), .c(new_n62_), .O(new_n129_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n119_), .c(new_n102_), .d(new_n86_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n88_), .b(x14), .O(new_n143_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n95_), .c(x16), .O(new_n152_));
  ...
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n84_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n84_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n95_), .c(x16), .O(new_n159_));
