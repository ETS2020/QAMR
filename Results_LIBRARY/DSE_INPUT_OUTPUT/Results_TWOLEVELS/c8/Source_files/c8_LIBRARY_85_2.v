...
module FAU ( 
  ...
  oai21  g013(.a(new_n48_), .b(x18), .c(new_n52_), .O(new_n60_));
  oai21  g014(.a(new_n48_), .b(x10), .c(new_n60_), .O(z02));
  ...
  nor2   g041(.a(new_n62_), .b(new_n48_), .O(z08));
  ...
  nand2  g061(.a(x21), .b(x18), .O(new_n108_));
  oai22  g062(.a(new_n108_), .b(new_n106_), .c(x18), .d(new_n107_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n93_), .O(new_n110_));
  nor2   g064(.a(x18), .b(x17), .O(new_n111_));
  nor3   g065(.a(x21), .b(x20), .c(x19), .O(new_n112_));
  aoi22  g066(.a(new_n112_), .b(new_n111_), .c(new_n102_), .d(x21), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n93_), .c(new_n110_), .O(z11));
  inv1   g068(.a(x03), .O(new_n115_));
  oai22  g069(.a(new_n108_), .b(new_n115_), .c(x18), .d(new_n63_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n93_), .O(new_n117_));
  nand2  g071(.a(new_n102_), .b(x22), .O(new_n118_));
  nand4  g072(.a(new_n91_), .b(new_n65_), .c(new_n52_), .d(new_n55_), .O(new_n119_));
  aoi21  g073(.a(new_n119_), .b(new_n118_), .c(x18), .O(new_n120_));
  nor2   g074(.a(new_n65_), .b(new_n52_), .O(new_n121_));
  ...
  nand2  g081(.a(new_n91_), .b(x16), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n55_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n128_), .c(new_n127_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n52_), .O(new_n132_));
  nand3  g086(.a(new_n119_), .b(x23), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n132_), .c(new_n126_), .O(z13));
  ...
  nand4  g091(.a(new_n75_), .b(new_n68_), .c(new_n65_), .d(new_n55_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n128_), .c(new_n127_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n52_), .O(new_n140_));
  nand3  g094(.a(new_n129_), .b(new_n103_), .c(new_n52_), .O(new_n141_));
  ...
  oai22  g098(.a(new_n108_), .b(new_n144_), .c(x18), .d(new_n78_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n93_), .O(new_n146_));
  nand3  g100(.a(new_n75_), .b(new_n68_), .c(new_n65_), .O(new_n147_));
  oai21  g101(.a(new_n147_), .b(new_n102_), .c(x25), .O(new_n148_));
  nor2   g102(.a(x21), .b(x20), .O(new_n149_));
  nor2   g103(.a(x25), .b(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n129_), .c(new_n149_), .d(new_n91_), .O(new_n151_));
  ...
  oai22  g110(.a(new_n108_), .b(new_n156_), .c(x18), .d(new_n85_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n93_), .O(new_n158_));
  nor2   g112(.a(x20), .b(x19), .O(new_n159_));
  nand4  g113(.a(new_n150_), .b(new_n129_), .c(new_n159_), .d(new_n89_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x26), .O(new_n161_));
  nor3   g115(.a(x26), .b(x25), .c(x24), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n129_), .c(new_n149_), .d(new_n91_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n161_), .c(x18), .O(new_n164_));
  nor2   g118(.a(new_n83_), .b(new_n52_), .O(new_n165_));
  ...
  nand2  g122(.a(new_n149_), .b(x19), .O(new_n169_));
  inv1   g123(.a(new_n169_), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n162_), .c(new_n129_), .d(new_n111_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n168_), .c(new_n93_), .O(z17));
endmodule
