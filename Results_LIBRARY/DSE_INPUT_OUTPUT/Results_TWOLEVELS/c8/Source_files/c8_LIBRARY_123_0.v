...
module FAU ( 
  ...
  inv1   g000(.a(x02), .O(new_n47_));
  inv1   g001(.a(x08), .O(new_n48_));
  oai21  g002(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n49_));
  ...
  nor2   g009(.a(x08), .b(x02), .O(new_n56_));
  ...
  aoi21  g015(.a(x27), .b(new_n61_), .c(new_n56_), .O(new_n62_));
  ...
  nand2  g020(.a(new_n54_), .b(new_n66_), .O(new_n67_));
  aoi21  g021(.a(new_n67_), .b(new_n65_), .c(new_n56_), .O(z04));
  ...
  aoi21  g031(.a(x27), .b(new_n77_), .c(new_n56_), .O(new_n78_));
  oai21  g032(.a(x27), .b(x26), .c(new_n78_), .O(z07));
  inv1   g033(.a(new_n56_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n54_), .O(z08));
  ...
  nand3  g044(.a(new_n90_), .b(new_n86_), .c(new_n80_), .O(z09));
  ...
  nor2   g048(.a(new_n85_), .b(new_n53_), .O(new_n95_));
  nor3   g049(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  aoi21  g051(.a(new_n97_), .b(new_n94_), .c(new_n56_), .O(z10));
  nor2   g052(.a(x18), .b(new_n58_), .O(new_n99_));
  aoi21  g053(.a(x18), .b(x02), .c(new_n99_), .O(new_n100_));
  inv1   g054(.a(x21), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n85_), .O(new_n103_));
  oai21  g057(.a(new_n96_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  aoi21  g058(.a(new_n104_), .b(x16), .c(new_n56_), .O(new_n105_));
  oai21  g059(.a(new_n100_), .b(x16), .c(new_n105_), .O(z11));
  ...
  and2   g063(.a(new_n103_), .b(x22), .O(new_n110_));
  inv1   g064(.a(new_n85_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n53_), .O(new_n113_));
  nor2   g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n110_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n109_), .c(new_n80_), .O(z12));
  ...
  oai21  g073(.a(new_n113_), .b(new_n111_), .c(x23), .O(new_n120_));
  ...
  nand3  g084(.a(new_n53_), .b(new_n83_), .c(new_n82_), .O(new_n131_));
  nand3  g085(.a(new_n112_), .b(new_n129_), .c(new_n66_), .O(new_n132_));
  nor2   g086(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n128_), .c(new_n56_), .O(z14));
  ...
  oai21  g092(.a(new_n132_), .b(new_n131_), .c(x25), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n102_), .d(new_n85_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n80_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  oai21  g100(.a(x18), .b(new_n77_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n87_), .O(new_n148_));
  nand2  g102(.a(new_n142_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n102_), .d(new_n85_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n80_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n140_), .c(new_n129_), .O(new_n156_));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n82_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n54_), .d(new_n82_), .O(new_n158_));
