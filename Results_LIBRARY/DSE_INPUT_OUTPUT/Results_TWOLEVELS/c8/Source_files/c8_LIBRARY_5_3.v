...
module FAU ( 
  ...
  oai21  g059(.a(new_n95_), .b(new_n60_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g064(.a(new_n104_), .b(new_n93_), .c(new_n110_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n97_), .b(x11), .O(new_n116_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n104_), .d(new_n93_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n103_), .c(x16), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n104_), .d(new_n93_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n103_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nand2  g108(.a(new_n68_), .b(new_n110_), .O(new_n155_));
  inv1   g109(.a(x25), .O(new_n156_));
  nand3  g110(.a(new_n79_), .b(new_n156_), .c(new_n127_), .O(new_n157_));
  ...
  aoi21  g116(.a(new_n162_), .b(new_n103_), .c(new_n83_), .O(z17));
endmodule
