...
module FAU ( 
  ...
  nor2   g037(.a(x16), .b(new_n47_), .O(new_n84_));
  aoi21  g038(.a(new_n83_), .b(x16), .c(new_n84_), .O(new_n85_));
  inv1   g039(.a(x16), .O(new_n86_));
  nand3  g040(.a(x18), .b(new_n86_), .c(x00), .O(new_n87_));
  oai21  g041(.a(new_n85_), .b(x18), .c(new_n87_), .O(z09));
  oai21  g042(.a(x16), .b(x01), .c(x18), .O(new_n89_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n93_), .c(new_n89_), .O(z10));
  ...
  oai21  g057(.a(new_n92_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n100_), .c(x16), .O(new_n105_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n90_), .c(new_n54_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n100_), .c(x16), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n92_), .c(new_n101_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n94_), .b(x12), .O(new_n122_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n118_), .c(new_n102_), .d(new_n90_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n100_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nand2  g109(.a(new_n130_), .b(new_n63_), .O(new_n156_));
  ...
  nand3  g113(.a(new_n102_), .b(x19), .c(new_n127_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n55_), .b(new_n127_), .O(new_n162_));
  aoi21  g116(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n100_), .c(new_n86_), .O(z17));
endmodule
