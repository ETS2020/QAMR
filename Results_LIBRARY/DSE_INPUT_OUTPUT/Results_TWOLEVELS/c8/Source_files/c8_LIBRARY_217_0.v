...
module FAU ( 
  ...
  nand2  g55(.a(x18), .b(new_n86_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n96_), .c(new_n101_), .d(new_n86_), .O(z11));
  inv1   g57(.a(x03), .O(new_n104_));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n84_), .c(new_n99_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n86_), .c(new_n102_), .d(new_n104_), .O(z12));
  oai21  g61(.a(new_n87_), .b(x04), .c(new_n86_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n112_), .b(new_n86_), .c(new_n108_), .O(z13));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n100_), .c(new_n118_), .d(x25), .O(new_n127_));
  ...
  nand4  g94(.a(new_n131_), .b(new_n78_), .c(new_n124_), .d(new_n115_), .O(new_n141_));
  nand3  g95(.a(new_n130_), .b(x19), .c(new_n82_), .O(new_n142_));
