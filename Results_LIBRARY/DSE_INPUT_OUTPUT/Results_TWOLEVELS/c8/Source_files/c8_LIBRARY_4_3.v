...
module FAU ( 
  ...
  nand2  g033(.a(new_n48_), .b(new_n67_), .O(z08));
  ...
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(new_n101_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n96_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n82_), .O(new_n135_));
  ...
  nand2  g094(.a(new_n140_), .b(new_n90_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n103_), .d(new_n85_), .O(new_n144_));
  ...
  nand2  g107(.a(new_n87_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand4  g109(.a(new_n120_), .b(new_n77_), .c(new_n72_), .d(new_n66_), .O(new_n156_));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n82_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n67_), .d(new_n82_), .O(new_n158_));
