...
module FAU ( 
  ...
  nand2  g56(.a(new_n102_), .b(new_n91_), .O(new_n103_));
  nand4  g57(.a(new_n60_), .b(new_n55_), .c(new_n47_), .d(new_n91_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  nor2   g60(.a(x18), .b(x16), .O(new_n107_));
  inv1   g61(.a(new_n107_), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n62_), .c(new_n106_), .d(new_n52_), .O(z11));
  oai21  g63(.a(x18), .b(x11), .c(new_n52_), .O(new_n110_));
  nand2  g64(.a(new_n104_), .b(x22), .O(new_n111_));
  nor2   g65(.a(x22), .b(x21), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n93_), .c(new_n55_), .O(new_n113_));
  and2   g67(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n52_), .c(new_n110_), .O(z12));
  nor3   g69(.a(x23), .b(x22), .c(x21), .O(new_n116_));
  aoi22  g70(.a(new_n116_), .b(new_n99_), .c(new_n113_), .d(x23), .O(new_n117_));
  oai22  g71(.a(new_n117_), .b(new_n52_), .c(new_n108_), .d(new_n72_), .O(z13));
  aoi21  g72(.a(new_n116_), .b(new_n99_), .c(new_n77_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n112_), .c(new_n102_), .d(new_n91_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand2  g77(.a(new_n107_), .b(x13), .O(new_n124_));
  nand2  g78(.a(new_n124_), .b(new_n123_), .O(z14));
  oai21  g79(.a(x18), .b(x14), .c(new_n52_), .O(new_n126_));
  nand4  g80(.a(new_n80_), .b(new_n77_), .c(new_n70_), .d(new_n65_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n105_), .c(new_n121_), .d(x25), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n52_), .c(new_n126_), .O(z15));
  ...
  nand2  g93(.a(new_n107_), .b(x15), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n139_), .O(z16));
  nor2   g95(.a(new_n47_), .b(x17), .O(new_n142_));
  nand4  g96(.a(new_n142_), .b(new_n136_), .c(new_n132_), .d(new_n131_), .O(new_n143_));
  nand2  g97(.a(x27), .b(x17), .O(new_n144_));
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n52_), .O(z17));
endmodule
