...
module FAU ( 
  ...
  nor2   g000(.a(x25), .b(x24), .O(new_n47_));
  ...
  inv1   g025(.a(new_n47_), .O(new_n72_));
  nand2  g026(.a(new_n72_), .b(x27), .O(new_n73_));
  inv1   g027(.a(x24), .O(new_n74_));
  nand3  g028(.a(new_n51_), .b(x25), .c(new_n74_), .O(new_n75_));
  oai21  g029(.a(new_n73_), .b(x13), .c(new_n75_), .O(z05));
  inv1   g030(.a(x25), .O(new_n77_));
  nand3  g031(.a(new_n51_), .b(new_n77_), .c(x24), .O(new_n78_));
  oai21  g032(.a(new_n73_), .b(x14), .c(new_n78_), .O(z06));
  inv1   g033(.a(x15), .O(new_n80_));
  aoi21  g034(.a(x27), .b(new_n80_), .c(new_n47_), .O(new_n81_));
  oai21  g035(.a(x27), .b(x26), .c(new_n81_), .O(z07));
  nand2  g036(.a(new_n72_), .b(new_n51_), .O(z08));
  ...
  nand3  g045(.a(new_n91_), .b(new_n87_), .c(new_n72_), .O(z09));
  ...
  aoi21  g052(.a(new_n98_), .b(new_n95_), .c(new_n47_), .O(z10));
  nand2  g053(.a(x18), .b(x02), .O(new_n100_));
  oai21  g054(.a(x18), .b(new_n59_), .c(new_n100_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n88_), .O(new_n102_));
  inv1   g056(.a(x21), .O(new_n103_));
  nand3  g057(.a(new_n86_), .b(new_n103_), .c(new_n56_), .O(new_n104_));
  oai21  g058(.a(new_n97_), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n72_), .O(z11));
  ...
  nand3  g066(.a(new_n112_), .b(new_n86_), .c(new_n56_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n72_), .O(z12));
  ...
  oai21  g075(.a(new_n114_), .b(new_n69_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n119_), .c(new_n72_), .O(z13));
  inv1   g078(.a(x13), .O(new_n125_));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n125_), .c(new_n126_), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n72_), .c(new_n88_), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n84_), .O(new_n130_));
  nand2  g084(.a(x24), .b(x17), .O(new_n131_));
  nand4  g085(.a(x25), .b(new_n74_), .c(new_n64_), .d(new_n103_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(new_n131_), .O(new_n133_));
  aoi21  g087(.a(new_n120_), .b(new_n129_), .c(new_n74_), .O(new_n134_));
  aoi21  g088(.a(new_n133_), .b(new_n69_), .c(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n88_), .c(new_n128_), .O(z14));
  ...
  nand4  g094(.a(new_n112_), .b(new_n97_), .c(new_n74_), .d(new_n69_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(x25), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n140_), .c(new_n72_), .O(z15));
  nor2   g097(.a(x18), .b(new_n80_), .O(new_n144_));
  aoi21  g098(.a(x18), .b(x07), .c(new_n144_), .O(new_n145_));
  aoi21  g099(.a(x26), .b(x16), .c(new_n47_), .O(new_n146_));
  oai21  g100(.a(new_n145_), .b(x16), .c(new_n146_), .O(z16));
  nor3   g101(.a(new_n73_), .b(new_n84_), .c(new_n88_), .O(z17));
endmodule
