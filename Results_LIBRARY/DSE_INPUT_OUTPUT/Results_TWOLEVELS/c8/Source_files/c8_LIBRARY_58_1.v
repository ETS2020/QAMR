...
module FAU ( 
  ...
  nor2   g44(.a(new_n86_), .b(new_n54_), .O(new_n91_));
  ...
  oai22  g56(.a(new_n102_), .b(new_n88_), .c(new_n95_), .d(new_n58_), .O(z11));
  ...
  aoi21  g67(.a(new_n111_), .b(new_n92_), .c(new_n71_), .O(new_n114_));
  ...
  nand2  g79(.a(new_n94_), .b(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n88_), .c(new_n126_), .O(z15));
  ...
  nand2  g90(.a(new_n94_), .b(x15), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  inv1   g92(.a(new_n49_), .O(new_n139_));
  nand4  g93(.a(new_n129_), .b(new_n79_), .c(new_n122_), .d(new_n71_), .O(new_n140_));
