...
module FAU ( 
  ...
  nor2   g44(.a(new_n84_), .b(x16), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(x01), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n90_), .O(z10));
  oai21  g47(.a(new_n84_), .b(x02), .c(new_n83_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n78_), .O(new_n96_));
  nand4  g50(.a(new_n56_), .b(new_n87_), .c(new_n79_), .d(new_n78_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n96_), .b(x21), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n83_), .c(new_n94_), .O(z11));
  ...
  nand2  g88(.a(new_n91_), .b(x07), .O(new_n135_));
  ...
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n57_), .d(new_n78_), .O(new_n141_));
