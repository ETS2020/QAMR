...
module FAU ( 
  ...
  nand2  g049(.a(x18), .b(new_n66_), .O(new_n96_));
  ...
  oai21  g053(.a(new_n88_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n48_), .c(x16), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n98_), .O(z10));
  inv1   g056(.a(x02), .O(new_n103_));
  oai22  g057(.a(new_n96_), .b(new_n103_), .c(x18), .d(new_n58_), .O(new_n104_));
  ...
  nand3  g075(.a(x18), .b(new_n66_), .c(x04), .O(new_n122_));
  ...
  oai22  g085(.a(new_n96_), .b(new_n131_), .c(x18), .d(new_n69_), .O(new_n132_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n126_), .c(new_n107_), .d(new_n88_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n48_), .O(z15));
  ...
  nand4  g110(.a(new_n156_), .b(new_n126_), .c(new_n107_), .d(new_n88_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n126_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n161_));
  nand3  g115(.a(new_n107_), .b(x19), .c(new_n85_), .O(new_n162_));
