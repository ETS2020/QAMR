...
module FAU ( 
  ...
  oai21  g055(.a(x18), .b(new_n90_), .c(x10), .O(new_n102_));
  ...
  nand3  g061(.a(x18), .b(new_n90_), .c(x02), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n107_), .c(new_n102_), .O(z11));
  inv1   g063(.a(x03), .O(new_n110_));
  nand2  g064(.a(x18), .b(new_n58_), .O(new_n111_));
  ...
  oai22  g074(.a(new_n111_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n90_), .O(new_n122_));
  nand2  g076(.a(new_n116_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n99_), .c(new_n103_), .O(new_n125_));
  ...
  oai22  g083(.a(new_n111_), .b(new_n129_), .c(x18), .d(new_n71_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n90_), .O(new_n131_));
  nand3  g085(.a(new_n54_), .b(new_n86_), .c(new_n85_), .O(new_n132_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n115_), .c(new_n135_), .d(new_n85_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n104_), .d(new_n88_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n48_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n124_), .c(new_n104_), .d(new_n88_), .O(new_n155_));
