...
module FAU ( 
  ...
  nor2   g033(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  nand2  g060(.a(x18), .b(new_n77_), .O(new_n107_));
  oai22  g061(.a(new_n107_), .b(new_n106_), .c(x18), .d(new_n58_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n84_), .O(new_n109_));
  nand2  g063(.a(new_n102_), .b(x22), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n82_), .c(new_n92_), .O(new_n112_));
  ...
  oai22  g070(.a(new_n107_), .b(new_n116_), .c(x18), .d(new_n64_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n84_), .O(new_n118_));
  ...
  aoi21  g082(.a(new_n120_), .b(new_n94_), .c(new_n128_), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n129_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n127_), .c(new_n48_), .O(z14));
  inv1   g090(.a(x06), .O(new_n137_));
  oai22  g091(.a(new_n107_), .b(new_n137_), .c(x18), .d(new_n72_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n101_), .d(new_n82_), .O(new_n143_));
  ...
  nand3  g100(.a(x18), .b(new_n77_), .c(x07), .O(new_n147_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n101_), .d(new_n82_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n128_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n130_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n61_), .d(new_n130_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n48_), .O(z17));
endmodule
