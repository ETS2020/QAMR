...
module FAU ( 
  ...
  nand2  g054(.a(new_n86_), .b(x10), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z11));
  inv1   g056(.a(x16), .O(new_n103_));
  nand2  g057(.a(x18), .b(x03), .O(new_n104_));
  oai21  g058(.a(x18), .b(new_n63_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  inv1   g060(.a(x18), .O(new_n107_));
  nand2  g061(.a(new_n98_), .b(x22), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n84_), .c(new_n90_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n106_), .O(z12));
  ...
  nand2  g073(.a(new_n86_), .b(x12), .O(new_n120_));
  ...
  nand4  g080(.a(new_n126_), .b(new_n109_), .c(new_n125_), .d(new_n82_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n124_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n86_), .b(x13), .O(new_n130_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n97_), .d(new_n84_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n107_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n136_), .c(new_n97_), .d(new_n84_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n107_), .c(x16), .O(new_n149_));
  ...
  nand3  g106(.a(new_n97_), .b(x19), .c(new_n82_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n52_), .d(new_n82_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n107_), .c(x16), .O(new_n155_));
