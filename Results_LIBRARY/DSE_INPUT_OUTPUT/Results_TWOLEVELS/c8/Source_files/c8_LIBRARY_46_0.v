...
module FAU ( 
  ...
  oai21  g75(.a(new_n86_), .b(x06), .c(new_n96_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n115_), .c(new_n67_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n96_), .c(new_n122_), .O(z15));
  ...
  nand4  g94(.a(new_n130_), .b(new_n78_), .c(new_n124_), .d(new_n115_), .O(new_n141_));
