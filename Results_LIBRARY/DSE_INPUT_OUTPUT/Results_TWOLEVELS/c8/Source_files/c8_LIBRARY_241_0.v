...
module FAU ( 
  ...
  nor2   g50(.a(new_n88_), .b(new_n96_), .O(new_n97_));
  nor3   g51(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n95_), .O(z10));
  oai21  g54(.a(new_n90_), .b(x02), .c(new_n94_), .O(new_n101_));
  nor2   g55(.a(x20), .b(x19), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nand4  g57(.a(new_n59_), .b(new_n96_), .c(new_n50_), .d(new_n86_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n94_), .c(new_n101_), .O(z11));
  nand2  g61(.a(new_n104_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n96_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n91_), .b(x03), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n94_), .c(new_n112_), .O(z12));
  oai21  g67(.a(new_n90_), .b(x04), .c(new_n94_), .O(new_n114_));
  nor3   g68(.a(x23), .b(x22), .c(x21), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n98_), .c(new_n110_), .d(x23), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n94_), .c(new_n114_), .O(z13));
  aoi21  g71(.a(new_n115_), .b(new_n98_), .c(new_n72_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n102_), .d(new_n86_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n91_), .b(x05), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  oai21  g78(.a(new_n90_), .b(x06), .c(new_n94_), .O(new_n125_));
  inv1   g79(.a(x22), .O(new_n126_));
  nand4  g80(.a(new_n77_), .b(new_n72_), .c(new_n67_), .d(new_n126_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n105_), .c(new_n120_), .d(x25), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n94_), .c(new_n125_), .O(z15));
  oai21  g84(.a(new_n90_), .b(x07), .c(new_n94_), .O(new_n131_));
  ...
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n94_), .O(z17));
endmodule
