...
module FAU ( 
  ...
  nand3  g045(.a(new_n91_), .b(new_n47_), .c(x09), .O(new_n92_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n80_), .c(x16), .O(new_n106_));
  nand3  g060(.a(x18), .b(new_n85_), .c(x02), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n106_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  nand3  g063(.a(new_n91_), .b(x11), .c(new_n47_), .O(new_n110_));
  ...
  nand3  g073(.a(new_n91_), .b(x12), .c(new_n47_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n80_), .c(x16), .O(new_n127_));
  ...
  aoi21  g086(.a(new_n124_), .b(new_n102_), .c(new_n132_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n114_), .c(new_n96_), .d(new_n81_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n131_), .c(new_n80_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n103_), .d(new_n83_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n103_), .d(new_n83_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n81_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n81_), .O(new_n161_));
