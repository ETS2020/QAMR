...
module FAU ( 
  ...
  nand3  g041(.a(new_n87_), .b(new_n83_), .c(new_n77_), .O(z09));
  ...
  nand3  g047(.a(new_n92_), .b(new_n80_), .c(new_n79_), .O(new_n94_));
  inv1   g048(.a(new_n94_), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n93_), .c(x16), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n91_), .c(new_n77_), .O(z10));
  nand2  g051(.a(x18), .b(x02), .O(new_n98_));
  inv1   g052(.a(x18), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(x10), .c(x03), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n84_), .O(new_n102_));
  inv1   g056(.a(x21), .O(new_n103_));
  nand4  g057(.a(new_n103_), .b(new_n92_), .c(new_n80_), .d(new_n79_), .O(new_n104_));
  oai21  g058(.a(new_n95_), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n77_), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n102_), .O(z11));
  inv1   g061(.a(x03), .O(new_n108_));
  aoi21  g062(.a(new_n99_), .b(new_n57_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n104_), .b(x22), .O(new_n110_));
  nand4  g064(.a(new_n82_), .b(new_n59_), .c(new_n103_), .d(new_n92_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  aoi21  g066(.a(new_n112_), .b(x16), .c(new_n109_), .O(new_n113_));
  nand3  g067(.a(new_n112_), .b(x18), .c(x16), .O(new_n114_));
  oai21  g068(.a(new_n113_), .b(new_n108_), .c(new_n114_), .O(z12));
  nand2  g069(.a(x18), .b(x04), .O(new_n116_));
  nand3  g070(.a(new_n99_), .b(x12), .c(x03), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n84_), .O(new_n119_));
  nand2  g073(.a(new_n111_), .b(x23), .O(new_n120_));
  ...
  nand4  g084(.a(new_n129_), .b(new_n65_), .c(new_n59_), .d(new_n103_), .O(new_n131_));
  nor2   g085(.a(new_n131_), .b(new_n94_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n128_), .c(new_n77_), .O(z14));
  ...
  nor2   g092(.a(x21), .b(x20), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n139_), .d(new_n82_), .O(new_n142_));
  oai21  g096(.a(new_n132_), .b(new_n138_), .c(new_n142_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n137_), .c(new_n77_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  nand3  g100(.a(new_n99_), .b(x15), .c(x03), .O(new_n147_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n140_), .c(new_n129_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n104_), .c(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n77_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nand3  g109(.a(new_n139_), .b(x19), .c(new_n79_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n152_), .c(new_n60_), .d(new_n79_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n77_), .c(x16), .O(new_n158_));
