...
module FAU ( 
  ...
  aoi21  g020(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n67_));
  ...
  nor2   g031(.a(x18), .b(x13), .O(new_n78_));
  ...
  nand3  g038(.a(new_n84_), .b(new_n80_), .c(x16), .O(new_n85_));
  oai21  g039(.a(new_n79_), .b(x16), .c(new_n85_), .O(z09));
  ...
  nor2   g044(.a(new_n82_), .b(new_n54_), .O(new_n91_));
  nor3   g045(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n90_), .c(new_n80_), .O(z10));
  aoi22  g048(.a(new_n78_), .b(x10), .c(x18), .d(x02), .O(new_n95_));
  inv1   g049(.a(x21), .O(new_n96_));
  nor2   g050(.a(x21), .b(x20), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n82_), .O(new_n98_));
  oai21  g052(.a(new_n92_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n80_), .c(x16), .O(new_n100_));
  oai21  g054(.a(new_n95_), .b(x16), .c(new_n100_), .O(z11));
  ...
  aoi21  g059(.a(new_n97_), .b(new_n82_), .c(new_n105_), .O(new_n106_));
  nor2   g060(.a(x22), .b(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n82_), .c(new_n54_), .O(new_n108_));
  inv1   g062(.a(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n104_), .c(new_n80_), .O(z12));
  nand2  g065(.a(x18), .b(x04), .O(new_n112_));
  nand2  g066(.a(new_n78_), .b(x12), .O(new_n113_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n92_), .c(new_n96_), .O(new_n118_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n117_), .c(new_n97_), .d(new_n82_), .O(new_n140_));
  ...
  nand3  g099(.a(new_n145_), .b(x15), .c(new_n48_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n87_), .O(new_n148_));
  nand2  g102(.a(new_n140_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n117_), .c(new_n97_), .d(new_n82_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n80_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  inv1   g108(.a(x24), .O(new_n155_));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n117_), .c(new_n155_), .O(new_n157_));
  nand3  g111(.a(new_n97_), .b(x19), .c(new_n122_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n122_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n80_), .O(z17));
endmodule
