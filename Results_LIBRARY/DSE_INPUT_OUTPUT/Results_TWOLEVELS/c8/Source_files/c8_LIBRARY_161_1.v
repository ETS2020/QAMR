...
module FAU ( 
  ...
  oai21  g49(.a(new_n95_), .b(new_n55_), .c(new_n93_), .O(z10));
  ...
  nand4  g54(.a(new_n100_), .b(new_n90_), .c(new_n51_), .d(new_n83_), .O(new_n101_));
  ...
  oai22  g60(.a(new_n106_), .b(new_n87_), .c(new_n95_), .d(new_n61_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n87_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n85_), .c(new_n90_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n92_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n87_), .c(new_n108_), .O(z13));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n109_), .c(new_n98_), .d(new_n83_), .O(new_n117_));
  inv1   g71(.a(new_n117_), .O(new_n118_));
  oai21  g72(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g73(.a(new_n94_), .b(x13), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n119_), .O(z14));
  nand4  g75(.a(new_n76_), .b(new_n114_), .c(new_n68_), .d(new_n63_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n124_));
