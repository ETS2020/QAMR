...
module FAU ( 
  ...
  nand4  g55(.a(new_n101_), .b(new_n53_), .c(new_n85_), .d(new_n84_), .O(new_n102_));
  ...
  oai21  g60(.a(new_n89_), .b(x03), .c(new_n98_), .O(new_n107_));
  ...
  oai21  g70(.a(new_n89_), .b(x05), .c(new_n98_), .O(new_n117_));
  aoi21  g71(.a(new_n113_), .b(new_n94_), .c(new_n72_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n99_), .d(new_n84_), .O(new_n120_));
