...
module FAU ( 
  ...
  nand2  g006(.a(new_n52_), .b(x06), .O(new_n53_));
  ...
  aoi22  g022(.a(new_n68_), .b(new_n66_), .c(new_n52_), .d(x06), .O(z03));
  ...
  oai21  g069(.a(new_n107_), .b(new_n60_), .c(new_n115_), .O(new_n116_));
  ...
  aoi21  g075(.a(new_n114_), .b(new_n98_), .c(new_n67_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n98_), .c(new_n55_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n52_), .b(x12), .c(new_n93_), .O(new_n129_));
  ...
  aoi21  g094(.a(new_n133_), .b(new_n107_), .c(new_n75_), .O(new_n141_));
  inv1   g095(.a(x17), .O(new_n142_));
  nor2   g096(.a(x20), .b(x19), .O(new_n143_));
  nor2   g097(.a(x24), .b(x23), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n123_), .c(new_n143_), .d(new_n142_), .O(new_n145_));
  inv1   g099(.a(new_n145_), .O(new_n146_));
  oai21  g100(.a(new_n146_), .b(new_n141_), .c(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n140_), .c(new_n53_), .O(z14));
  nand3  g102(.a(new_n52_), .b(x14), .c(new_n93_), .O(new_n149_));
  oai21  g103(.a(new_n52_), .b(new_n93_), .c(new_n149_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n153_), .c(new_n114_), .d(new_n98_), .O(new_n155_));
  ...
  nand4  g117(.a(new_n163_), .b(new_n153_), .c(new_n114_), .d(new_n98_), .O(new_n164_));
  ...
  nand4  g121(.a(new_n153_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n168_));
  nand3  g122(.a(new_n114_), .b(x19), .c(new_n142_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n168_), .c(new_n48_), .d(new_n142_), .O(new_n170_));
