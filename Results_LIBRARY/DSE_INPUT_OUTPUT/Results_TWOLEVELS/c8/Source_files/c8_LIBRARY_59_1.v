...
module FAU ( 
  ...
  oai21  g20(.a(x27), .b(x22), .c(new_n66_), .O(z03));
  ...
  nand2  g29(.a(new_n52_), .b(new_n75_), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n48_), .O(z05));
  ...
  nand2  g45(.a(new_n47_), .b(new_n91_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n49_), .c(new_n90_), .O(z09));
  ...
  oai21  g50(.a(new_n92_), .b(new_n55_), .c(new_n96_), .O(z10));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n87_), .O(new_n99_));
  nand4  g53(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n87_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n91_), .c(new_n92_), .d(new_n60_), .O(z11));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n89_), .c(new_n100_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n91_), .c(new_n92_), .d(new_n65_), .O(z12));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n89_), .c(new_n57_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n95_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai22  g64(.a(new_n110_), .b(new_n91_), .c(new_n92_), .d(new_n68_), .O(z13));
  aoi21  g65(.a(new_n109_), .b(new_n95_), .c(new_n75_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n107_), .c(new_n98_), .d(new_n87_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g70(.a(new_n47_), .b(new_n91_), .c(x13), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n116_), .O(z14));
  oai21  g72(.a(x18), .b(x14), .c(new_n91_), .O(new_n119_));
  inv1   g73(.a(x22), .O(new_n120_));
  nand4  g74(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n120_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n101_), .c(new_n114_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n91_), .c(new_n119_), .O(z15));
  oai21  g78(.a(x18), .b(x15), .c(new_n91_), .O(new_n125_));
  nor2   g79(.a(x21), .b(x20), .O(new_n126_));
  nor2   g80(.a(x23), .b(x22), .O(new_n127_));
  nor2   g81(.a(x25), .b(x24), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n89_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(x26), .O(new_n130_));
  nor3   g84(.a(x26), .b(x25), .c(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n127_), .c(new_n126_), .d(new_n89_), .O(new_n132_));
  ...
  inv1   g89(.a(new_n48_), .O(new_n136_));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n75_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n87_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n52_), .d(new_n87_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n136_), .O(z17));
endmodule
