...
module FAU ( 
  ...
  nand2  g034(.a(new_n80_), .b(new_n55_), .O(z08));
  inv1   g035(.a(x16), .O(new_n82_));
  nand2  g036(.a(x18), .b(x00), .O(new_n83_));
  inv1   g037(.a(x18), .O(new_n84_));
  nand3  g038(.a(new_n84_), .b(x08), .c(new_n48_), .O(new_n85_));
  ...
  nand3  g045(.a(new_n91_), .b(new_n80_), .c(x16), .O(new_n92_));
  ...
  nor2   g050(.a(new_n89_), .b(new_n54_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n96_), .c(new_n80_), .O(z10));
  nand2  g054(.a(x18), .b(x02), .O(new_n101_));
  nand3  g055(.a(new_n84_), .b(x10), .c(new_n48_), .O(new_n102_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n113_), .c(new_n80_), .O(z12));
  oai21  g074(.a(new_n84_), .b(new_n82_), .c(x04), .O(new_n121_));
  nand2  g075(.a(new_n117_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n98_), .c(new_n105_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x16), .O(new_n126_));
  nand3  g080(.a(new_n84_), .b(new_n82_), .c(x12), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n121_), .O(z13));
  nand2  g082(.a(x18), .b(x05), .O(new_n129_));
  nand3  g083(.a(new_n84_), .b(x13), .c(new_n48_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n82_), .O(new_n132_));
  ...
  nand3  g098(.a(new_n84_), .b(x14), .c(new_n48_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n82_), .O(new_n147_));
  nand2  g101(.a(new_n140_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n123_), .c(new_n106_), .d(new_n89_), .O(new_n150_));
  ...
  nand2  g109(.a(new_n155_), .b(new_n82_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n123_), .c(new_n106_), .d(new_n89_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n80_), .O(z16));
  inv1   g116(.a(x24), .O(new_n163_));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n123_), .c(new_n163_), .O(new_n165_));
  nand3  g119(.a(new_n106_), .b(x19), .c(new_n133_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n55_), .d(new_n133_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n80_), .c(x16), .O(new_n168_));
