...
module FAU ( 
  ...
  nand3  g049(.a(new_n54_), .b(new_n95_), .c(new_n94_), .O(new_n96_));
  oai21  g050(.a(new_n93_), .b(new_n54_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n93_), .c(new_n54_), .O(new_n115_));
  ...
  nand2  g078(.a(new_n107_), .b(x04), .O(new_n125_));
  ...
  nand3  g083(.a(new_n68_), .b(new_n63_), .c(new_n101_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n96_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n132_), .d(new_n94_), .O(new_n134_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n121_), .c(new_n103_), .d(new_n93_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n107_), .b(x06), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n121_), .c(new_n103_), .d(new_n93_), .O(new_n151_));
  ...
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n94_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n55_), .b(new_n94_), .O(new_n162_));
