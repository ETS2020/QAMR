...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x17), .O(new_n47_));
  ...
  oai21  g044(.a(x18), .b(new_n48_), .c(new_n90_), .O(new_n91_));
  ...
  nand2  g049(.a(new_n95_), .b(x17), .O(new_n96_));
  ...
  aoi21  g055(.a(new_n101_), .b(new_n99_), .c(new_n95_), .O(new_n102_));
  nor2   g056(.a(new_n56_), .b(new_n85_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n50_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x18), .O(new_n111_));
  ...
  nand2  g071(.a(new_n50_), .b(x16), .O(new_n118_));
  ...
  nand2  g076(.a(new_n109_), .b(new_n87_), .O(new_n123_));
  ...
  oai21  g080(.a(new_n96_), .b(new_n67_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n100_), .c(new_n61_), .d(new_n85_), .O(new_n132_));
  aoi21  g086(.a(new_n132_), .b(new_n130_), .c(new_n95_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(new_n85_), .O(new_n135_));
  ...
  nand2  g096(.a(new_n142_), .b(x18), .O(new_n143_));
  ...
  nand3  g103(.a(new_n61_), .b(new_n56_), .c(new_n50_), .O(new_n150_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n131_), .c(new_n109_), .d(new_n87_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(new_n154_), .c(new_n95_), .O(new_n157_));
  nor2   g111(.a(new_n75_), .b(new_n85_), .O(new_n158_));
  ...
  oai21  g115(.a(new_n96_), .b(new_n78_), .c(new_n161_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n89_), .O(new_n163_));
  nand4  g117(.a(new_n155_), .b(new_n131_), .c(new_n109_), .d(new_n50_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor3   g119(.a(x26), .b(x25), .c(x24), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n131_), .c(new_n109_), .d(new_n87_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(new_n95_), .O(new_n168_));
  nor2   g122(.a(new_n80_), .b(new_n85_), .O(new_n169_));
  ...
  nor3   g126(.a(new_n172_), .b(new_n95_), .c(x17), .O(new_n173_));
  nand3  g127(.a(new_n173_), .b(new_n166_), .c(new_n131_), .O(new_n174_));
  nand2  g128(.a(x27), .b(x17), .O(new_n175_));
  aoi21  g129(.a(new_n175_), .b(new_n174_), .c(new_n89_), .O(z17));
endmodule
