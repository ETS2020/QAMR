...
module FAU ( 
  ...
  aoi21  g043(.a(new_n89_), .b(new_n87_), .c(new_n55_), .O(z07));
  ...
  nand3  g060(.a(new_n106_), .b(new_n102_), .c(new_n53_), .O(z10));
  inv1   g061(.a(x02), .O(new_n108_));
  oai22  g062(.a(new_n94_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n92_), .O(new_n110_));
  nor2   g064(.a(x21), .b(x20), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n103_), .O(new_n112_));
  ...
  oai22  g070(.a(new_n94_), .b(new_n116_), .c(x18), .d(new_n66_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n103_), .c(new_n58_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n53_), .c(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n118_), .O(z12));
  oai21  g078(.a(x18), .b(new_n73_), .c(new_n94_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n92_), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n92_), .c(new_n94_), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n121_), .c(x23), .O(new_n128_));
  inv1   g082(.a(x17), .O(new_n129_));
  nand4  g083(.a(new_n53_), .b(new_n71_), .c(new_n68_), .d(new_n63_), .O(new_n130_));
  nor2   g084(.a(new_n130_), .b(x20), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n47_), .c(new_n129_), .d(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n128_), .c(new_n126_), .O(z13));
  ...
  aoi21  g091(.a(new_n137_), .b(new_n105_), .c(new_n78_), .O(new_n138_));
  nand3  g092(.a(new_n58_), .b(new_n47_), .c(new_n129_), .O(new_n139_));
  nand3  g093(.a(new_n120_), .b(new_n78_), .c(new_n71_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n139_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n138_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n136_), .c(new_n53_), .O(z14));
  ...
  oai21  g100(.a(new_n140_), .b(new_n139_), .c(x25), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n111_), .d(new_n103_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n146_), .c(new_n53_), .O(z15));
  nand3  g107(.a(x18), .b(x07), .c(x04), .O(new_n154_));
  oai21  g108(.a(x18), .b(new_n86_), .c(new_n154_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n111_), .d(new_n103_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n88_), .c(new_n83_), .d(new_n78_), .O(new_n163_));
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n129_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n48_), .d(new_n129_), .O(new_n165_));
