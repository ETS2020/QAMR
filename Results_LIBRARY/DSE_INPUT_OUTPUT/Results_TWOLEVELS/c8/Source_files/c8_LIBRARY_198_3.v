...
module FAU ( 
  ...
  nand3  g046(.a(new_n92_), .b(new_n90_), .c(new_n87_), .O(z09));
  ...
  oai21  g055(.a(new_n89_), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n97_), .O(z10));
  oai21  g058(.a(x16), .b(x02), .c(x18), .O(new_n105_));
  ...
  nand2  g064(.a(new_n91_), .b(x10), .O(new_n111_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n98_), .c(x16), .O(new_n120_));
  ...
  nand2  g081(.a(new_n91_), .b(x12), .O(new_n128_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n117_), .c(new_n100_), .d(new_n99_), .O(new_n133_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n107_), .d(new_n89_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n107_), .d(new_n89_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n80_), .c(new_n75_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n99_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n55_), .b(new_n99_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n98_), .c(new_n94_), .O(z17));
endmodule
