...
module FAU ( 
  ...
  nor2   g028(.a(x27), .b(x18), .O(new_n75_));
  oai22  g029(.a(new_n75_), .b(x15), .c(x27), .d(x26), .O(z07));
  inv1   g030(.a(new_n49_), .O(new_n77_));
  nand2  g031(.a(new_n77_), .b(new_n55_), .O(z08));
  ...
  oai21  g037(.a(x18), .b(new_n47_), .c(new_n83_), .O(new_n84_));
  nand2  g038(.a(new_n84_), .b(new_n82_), .O(new_n85_));
  nand3  g039(.a(new_n85_), .b(new_n81_), .c(new_n77_), .O(z09));
  nand2  g040(.a(x18), .b(x01), .O(new_n87_));
  oai21  g041(.a(x18), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(new_n82_), .O(new_n89_));
  nor2   g043(.a(new_n80_), .b(new_n54_), .O(new_n90_));
  nor3   g044(.a(x20), .b(x19), .c(x17), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n90_), .c(x16), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n89_), .c(new_n77_), .O(z10));
  nand2  g047(.a(x18), .b(x02), .O(new_n94_));
  oai21  g048(.a(x18), .b(new_n58_), .c(new_n94_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n82_), .O(new_n96_));
  nor2   g050(.a(x21), .b(x20), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n80_), .O(new_n98_));
  oai21  g052(.a(new_n91_), .b(new_n60_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n77_), .O(z11));
  nand3  g055(.a(x18), .b(x15), .c(x03), .O(new_n102_));
  oai21  g056(.a(x18), .b(new_n63_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n82_), .O(new_n104_));
  nand2  g058(.a(new_n98_), .b(x22), .O(new_n105_));
  nor2   g059(.a(x22), .b(x21), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n80_), .c(new_n54_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n77_), .c(x16), .O(new_n109_));
  ...
  nand2  g067(.a(new_n107_), .b(x23), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n77_), .O(z13));
  nand2  g073(.a(x18), .b(x05), .O(new_n120_));
  oai21  g074(.a(x18), .b(new_n69_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n82_), .O(new_n122_));
  inv1   g076(.a(x24), .O(new_n123_));
  aoi21  g077(.a(new_n115_), .b(new_n91_), .c(new_n123_), .O(new_n124_));
  inv1   g078(.a(x17), .O(new_n125_));
  nor2   g079(.a(x20), .b(x19), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n106_), .c(new_n126_), .d(new_n125_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n124_), .c(x16), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n122_), .c(new_n77_), .O(z14));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n97_), .d(new_n80_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n134_), .c(new_n77_), .O(z15));
  inv1   g095(.a(x07), .O(new_n142_));
  nand2  g096(.a(x18), .b(new_n142_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n82_), .c(x15), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x26), .O(new_n145_));
  nor3   g099(.a(x26), .b(x25), .c(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n136_), .c(new_n97_), .d(new_n80_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n77_), .O(z16));
  nor2   g104(.a(x26), .b(x25), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n136_), .c(new_n123_), .O(new_n152_));
  nand3  g106(.a(new_n97_), .b(x19), .c(new_n125_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n55_), .d(new_n125_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n77_), .c(x16), .O(new_n155_));
