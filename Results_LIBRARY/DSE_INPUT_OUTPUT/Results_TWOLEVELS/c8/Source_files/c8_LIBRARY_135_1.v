...
module FAU ( 
  ...
  nor2   g052(.a(new_n94_), .b(new_n56_), .O(new_n99_));
  ...
  nand4  g059(.a(new_n63_), .b(new_n56_), .c(new_n52_), .d(new_n92_), .O(new_n106_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n94_), .c(new_n56_), .O(new_n112_));
  and2   g066(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nor2   g067(.a(x18), .b(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x11), .O(new_n115_));
  oai21  g069(.a(new_n113_), .b(new_n47_), .c(new_n115_), .O(z12));
  oai21  g070(.a(x18), .b(x12), .c(new_n47_), .O(new_n117_));
  nor3   g071(.a(x23), .b(x22), .c(x21), .O(new_n118_));
  aoi22  g072(.a(new_n118_), .b(new_n100_), .c(new_n112_), .d(x23), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n47_), .c(new_n117_), .O(z13));
  oai21  g074(.a(x18), .b(x13), .c(new_n47_), .O(new_n121_));
  aoi21  g075(.a(new_n118_), .b(new_n100_), .c(new_n76_), .O(new_n122_));
  nor2   g076(.a(x24), .b(x23), .O(new_n123_));
  nand4  g077(.a(new_n123_), .b(new_n111_), .c(new_n104_), .d(new_n92_), .O(new_n124_));
  ...
  aoi22  g083(.a(new_n129_), .b(new_n107_), .c(new_n124_), .d(x25), .O(new_n130_));
  nand2  g084(.a(new_n114_), .b(x14), .O(new_n131_));
  ...
  nand2  g095(.a(new_n114_), .b(x15), .O(new_n142_));
