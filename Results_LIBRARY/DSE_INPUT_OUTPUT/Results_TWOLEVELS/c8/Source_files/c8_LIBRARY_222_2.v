...
module FAU ( 
  ...
  nand2  g059(.a(new_n89_), .b(x02), .O(new_n106_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n87_), .c(new_n57_), .O(new_n113_));
  ...
  aoi21  g080(.a(new_n121_), .b(new_n101_), .c(new_n73_), .O(new_n127_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n102_), .d(new_n87_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n136_), .c(new_n73_), .O(new_n153_));
