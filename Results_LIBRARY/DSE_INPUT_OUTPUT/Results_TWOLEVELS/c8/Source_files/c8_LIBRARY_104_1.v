...
module FAU ( 
  ...
  aoi22  g61(.a(new_n107_), .b(new_n92_), .c(new_n104_), .d(x23), .O(new_n108_));
  ...
  nand4  g67(.a(new_n113_), .b(new_n103_), .c(new_n95_), .d(new_n83_), .O(new_n114_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n111_), .c(new_n118_), .d(new_n65_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n98_), .c(new_n114_), .d(x25), .O(new_n122_));
  nand3  g76(.a(new_n47_), .b(new_n87_), .c(x14), .O(new_n123_));
