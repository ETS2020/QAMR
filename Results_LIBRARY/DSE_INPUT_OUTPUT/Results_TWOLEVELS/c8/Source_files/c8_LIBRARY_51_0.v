...
module FAU ( 
  ...
  nor2   g001(.a(x18), .b(x14), .O(new_n48_));
  ...
  nand2  g021(.a(new_n57_), .b(new_n67_), .O(new_n68_));
  ...
  oai21  g028(.a(x27), .b(new_n74_), .c(new_n73_), .O(new_n75_));
  ...
  nand2  g033(.a(new_n57_), .b(new_n79_), .O(new_n80_));
  aoi21  g034(.a(new_n80_), .b(new_n78_), .c(new_n48_), .O(z07));
  inv1   g035(.a(new_n48_), .O(new_n82_));
  nand2  g036(.a(new_n82_), .b(new_n57_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n82_), .O(z09));
  nand2  g047(.a(x18), .b(x01), .O(new_n94_));
  nand2  g048(.a(new_n74_), .b(x14), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n51_), .c(new_n94_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n87_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n82_), .c(x16), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n97_), .O(z10));
  nand2  g057(.a(x18), .b(x02), .O(new_n104_));
  oai21  g058(.a(new_n95_), .b(new_n54_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g062(.a(new_n99_), .b(new_n56_), .c(new_n108_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n82_), .c(x16), .O(new_n110_));
  ...
  inv1   g068(.a(new_n108_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n87_), .c(new_n98_), .O(new_n117_));
  oai21  g071(.a(new_n115_), .b(new_n62_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n82_), .O(z12));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  oai21  g075(.a(new_n95_), .b(new_n65_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n89_), .O(new_n123_));
  nand2  g077(.a(new_n117_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n56_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n100_), .c(new_n124_), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n82_), .c(x16), .O(new_n128_));
  ...
  nor2   g087(.a(new_n126_), .b(new_n100_), .O(new_n134_));
  nand4  g088(.a(new_n116_), .b(new_n99_), .c(new_n133_), .d(new_n67_), .O(new_n135_));
  oai21  g089(.a(new_n134_), .b(new_n133_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n132_), .c(new_n82_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n95_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n89_), .O(new_n141_));
  oai21  g095(.a(new_n74_), .b(new_n89_), .c(new_n95_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n135_), .c(x25), .O(new_n143_));
  aoi21  g097(.a(new_n74_), .b(new_n73_), .c(x25), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n133_), .c(new_n67_), .d(new_n62_), .O(new_n145_));
  nor3   g099(.a(new_n145_), .b(x21), .c(x20), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n85_), .c(new_n84_), .d(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n143_), .c(new_n141_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  oai21  g103(.a(x18), .b(new_n77_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n89_), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n125_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n108_), .c(x26), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n125_), .c(new_n133_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n108_), .c(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n151_), .c(new_n82_), .O(z16));
  nand3  g113(.a(new_n107_), .b(x19), .c(new_n84_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n57_), .d(new_n84_), .O(new_n161_));
