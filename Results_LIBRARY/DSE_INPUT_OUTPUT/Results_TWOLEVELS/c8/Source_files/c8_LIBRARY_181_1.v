...
module FAU ( 
  ...
  nand3  g057(.a(new_n103_), .b(new_n99_), .c(new_n53_), .O(z10));
  ...
  oai22  g067(.a(new_n91_), .b(new_n113_), .c(x18), .d(new_n66_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  nand2  g069(.a(new_n109_), .b(x22), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n100_), .c(new_n58_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n53_), .c(x16), .O(new_n120_));
  ...
  nand4  g088(.a(new_n117_), .b(new_n102_), .c(new_n76_), .d(new_n71_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n53_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n133_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  oai21  g093(.a(x18), .b(new_n81_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n89_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n126_), .c(new_n108_), .d(new_n100_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n141_), .c(new_n53_), .O(z15));
  inv1   g101(.a(x07), .O(new_n148_));
  aoi21  g102(.a(x18), .b(new_n148_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n144_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n126_), .c(new_n108_), .d(new_n100_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(x16), .c(new_n149_), .O(new_n154_));
  inv1   g108(.a(x18), .O(new_n155_));
  nand3  g109(.a(new_n153_), .b(new_n155_), .c(x16), .O(new_n156_));
  oai21  g110(.a(new_n154_), .b(new_n52_), .c(new_n156_), .O(z16));
  inv1   g111(.a(x17), .O(new_n158_));
  nand2  g112(.a(new_n151_), .b(new_n126_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n158_), .O(new_n160_));
