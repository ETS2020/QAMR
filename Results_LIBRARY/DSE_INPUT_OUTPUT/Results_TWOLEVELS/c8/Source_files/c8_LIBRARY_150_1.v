...
module FAU ( 
  ...
  nor2   g027(.a(x27), .b(x18), .O(new_n74_));
  ...
  nor2   g032(.a(new_n48_), .b(x14), .O(new_n79_));
  nor2   g033(.a(new_n79_), .b(new_n58_), .O(z08));
  ...
  nand3  g061(.a(new_n107_), .b(new_n103_), .c(new_n86_), .O(z11));
  inv1   g062(.a(x03), .O(new_n109_));
  oai22  g063(.a(new_n83_), .b(new_n109_), .c(x18), .d(new_n61_), .O(new_n110_));
  ...
  oai21  g068(.a(new_n114_), .b(new_n89_), .c(new_n112_), .O(new_n115_));
  ...
  oai21  g074(.a(new_n114_), .b(new_n89_), .c(x23), .O(new_n121_));
  nor2   g075(.a(x23), .b(x22), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n98_), .c(new_n57_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n86_), .O(z13));
  inv1   g080(.a(x05), .O(new_n127_));
  oai22  g081(.a(new_n83_), .b(new_n127_), .c(x18), .d(new_n69_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n81_), .O(new_n129_));
  nand2  g083(.a(new_n123_), .b(x24), .O(new_n130_));
  nand4  g084(.a(new_n113_), .b(new_n98_), .c(new_n71_), .d(new_n66_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n86_), .c(x16), .O(new_n133_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n122_), .c(new_n104_), .d(new_n88_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n138_), .c(new_n86_), .O(z15));
  inv1   g098(.a(x07), .O(new_n145_));
  oai22  g099(.a(new_n83_), .b(new_n145_), .c(x18), .d(new_n76_), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n113_), .c(new_n149_), .d(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n122_), .c(new_n104_), .d(new_n88_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n152_), .c(new_n49_), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nor3   g110(.a(new_n79_), .b(new_n156_), .c(new_n71_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n155_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n147_), .O(z16));
  nand2  g113(.a(new_n153_), .b(new_n122_), .O(new_n160_));
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n148_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n58_), .d(new_n148_), .O(new_n162_));
