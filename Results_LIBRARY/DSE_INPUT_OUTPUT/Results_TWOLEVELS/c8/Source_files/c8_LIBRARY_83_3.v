...
module FAU ( 
  ...
  nand2  g042(.a(x18), .b(new_n75_), .O(new_n89_));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n93_), .c(new_n67_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n93_), .c(new_n57_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n89_), .b(new_n125_), .c(x18), .d(new_n70_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n47_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n127_), .O(z13));
  oai21  g087(.a(x18), .b(new_n87_), .c(x13), .O(new_n134_));
  inv1   g088(.a(x24), .O(new_n135_));
  aoi21  g089(.a(new_n129_), .b(new_n110_), .c(new_n135_), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n120_), .c(new_n102_), .d(new_n101_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand3  g094(.a(x18), .b(new_n87_), .c(x05), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n140_), .c(new_n134_), .O(z14));
  ...
  nand3  g105(.a(new_n151_), .b(new_n145_), .c(new_n47_), .O(z15));
  inv1   g106(.a(x07), .O(new_n153_));
  oai22  g107(.a(new_n89_), .b(new_n153_), .c(x18), .d(new_n83_), .O(new_n154_));
  ...
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n101_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n101_), .O(new_n165_));
