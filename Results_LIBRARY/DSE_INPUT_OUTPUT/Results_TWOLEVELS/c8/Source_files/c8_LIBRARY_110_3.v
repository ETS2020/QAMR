...
module FAU ( 
  ...
  nand2  g050(.a(new_n90_), .b(x09), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n96_), .c(new_n93_), .O(z10));
  ...
  oai21  g059(.a(new_n95_), .b(new_n62_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g064(.a(new_n104_), .b(new_n88_), .c(new_n110_), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n88_), .c(new_n57_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n90_), .b(x11), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n62_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(new_n90_), .b(x12), .O(new_n124_));
  ...
  nand3  g082(.a(new_n57_), .b(new_n51_), .c(new_n86_), .O(new_n129_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n112_), .c(new_n133_), .d(new_n86_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n103_), .c(x16), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n104_), .d(new_n88_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n103_), .c(x16), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n104_), .d(new_n88_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n90_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand2  g109(.a(new_n130_), .b(new_n110_), .O(new_n156_));
  inv1   g110(.a(x24), .O(new_n157_));
  nand3  g111(.a(new_n81_), .b(new_n76_), .c(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand3  g113(.a(new_n104_), .b(x19), .c(new_n86_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n52_), .b(new_n86_), .O(new_n162_));
  aoi21  g116(.a(new_n161_), .b(new_n159_), .c(new_n162_), .O(new_n163_));
  aoi21  g117(.a(new_n163_), .b(new_n103_), .c(new_n99_), .O(z17));
endmodule
