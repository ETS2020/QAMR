...
module FAU ( 
  ...
  nand2  g030(.a(new_n53_), .b(x24), .O(new_n77_));
  nand3  g031(.a(new_n77_), .b(new_n76_), .c(new_n47_), .O(new_n78_));
  inv1   g032(.a(x24), .O(new_n79_));
  nand3  g033(.a(new_n53_), .b(new_n79_), .c(x13), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n78_), .O(z05));
  ...
  nand2  g048(.a(x18), .b(x13), .O(new_n95_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n111_), .c(new_n48_), .O(z11));
  inv1   g070(.a(x03), .O(new_n117_));
  oai22  g071(.a(new_n95_), .b(new_n117_), .c(x18), .d(new_n68_), .O(new_n118_));
  ...
  oai21  g080(.a(x18), .b(new_n73_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n93_), .O(new_n128_));
  inv1   g082(.a(x17), .O(new_n129_));
  nand3  g083(.a(new_n56_), .b(new_n52_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n122_), .b(x23), .O(new_n131_));
  nand3  g085(.a(new_n71_), .b(new_n66_), .c(new_n61_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n130_), .c(new_n131_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n128_), .c(new_n48_), .O(z13));
  inv1   g089(.a(x05), .O(new_n136_));
  aoi21  g090(.a(x18), .b(new_n136_), .c(x16), .O(new_n137_));
  oai21  g091(.a(new_n132_), .b(new_n130_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n121_), .c(new_n106_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(x16), .c(new_n137_), .O(new_n142_));
  nand3  g096(.a(new_n141_), .b(new_n76_), .c(x16), .O(new_n143_));
  oai21  g097(.a(new_n142_), .b(new_n47_), .c(new_n143_), .O(z14));
  ...
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n112_), .d(new_n104_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n147_), .c(new_n48_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  oai21  g109(.a(x18), .b(new_n89_), .c(new_n155_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n93_), .O(new_n157_));
  nand2  g111(.a(new_n151_), .b(x26), .O(new_n158_));
  nand4  g112(.a(new_n149_), .b(new_n87_), .c(new_n84_), .d(new_n79_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n113_), .c(new_n158_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n157_), .c(new_n48_), .O(z16));
  nand3  g116(.a(new_n112_), .b(x19), .c(new_n129_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n53_), .d(new_n129_), .O(new_n164_));
