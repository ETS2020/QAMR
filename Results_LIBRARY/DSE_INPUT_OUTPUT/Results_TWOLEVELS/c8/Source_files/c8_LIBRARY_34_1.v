...
module FAU ( 
  ...
  nand4  g55(.a(new_n60_), .b(new_n94_), .c(new_n51_), .d(new_n86_), .O(new_n102_));
  ...
  nand2  g61(.a(new_n47_), .b(new_n90_), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n63_), .c(new_n107_), .d(new_n90_), .O(z12));
  ...
  oai22  g67(.a(new_n113_), .b(new_n90_), .c(new_n108_), .d(new_n68_), .O(z13));
  ...
  nand4  g72(.a(new_n118_), .b(new_n110_), .c(new_n100_), .d(new_n86_), .O(new_n119_));
  ...
  nand4  g77(.a(new_n76_), .b(new_n116_), .c(new_n123_), .d(new_n65_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n103_), .c(new_n119_), .d(x25), .O(new_n126_));
  nand3  g80(.a(new_n47_), .b(new_n90_), .c(x14), .O(new_n127_));
  ...
  nand4  g93(.a(new_n131_), .b(new_n81_), .c(new_n76_), .d(new_n116_), .O(new_n140_));
