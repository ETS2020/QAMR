...
module FAU ( 
  ...
  aoi22  g06(.a(new_n52_), .b(new_n49_), .c(x18), .d(new_n47_), .O(z00));
  nand2  g07(.a(x18), .b(new_n47_), .O(new_n54_));
  inv1   g08(.a(x20), .O(new_n55_));
  nand2  g09(.a(new_n51_), .b(new_n55_), .O(new_n56_));
  inv1   g10(.a(x09), .O(new_n57_));
  nand2  g11(.a(x27), .b(new_n57_), .O(new_n58_));
  nand3  g12(.a(new_n58_), .b(new_n56_), .c(new_n54_), .O(z01));
  inv1   g13(.a(x21), .O(new_n60_));
  nand2  g14(.a(new_n51_), .b(new_n60_), .O(new_n61_));
  inv1   g15(.a(x10), .O(new_n62_));
  nand2  g16(.a(x27), .b(new_n62_), .O(new_n63_));
  nand3  g17(.a(new_n63_), .b(new_n61_), .c(new_n54_), .O(z02));
  ...
  nand3  g22(.a(new_n68_), .b(new_n66_), .c(new_n54_), .O(z03));
  ...
  nand3  g27(.a(new_n73_), .b(new_n71_), .c(new_n54_), .O(z04));
  ...
  nand3  g32(.a(new_n78_), .b(new_n76_), .c(new_n54_), .O(z05));
  ...
  nand3  g37(.a(new_n83_), .b(new_n81_), .c(new_n54_), .O(z06));
  inv1   g38(.a(x26), .O(new_n85_));
  nand2  g39(.a(new_n51_), .b(new_n85_), .O(new_n86_));
  inv1   g40(.a(x15), .O(new_n87_));
  nand2  g41(.a(x27), .b(new_n87_), .O(new_n88_));
  nand3  g42(.a(new_n88_), .b(new_n86_), .c(new_n54_), .O(z07));
  nand2  g43(.a(new_n54_), .b(new_n51_), .O(z08));
  inv1   g44(.a(x17), .O(new_n91_));
  nor2   g45(.a(new_n50_), .b(new_n91_), .O(new_n92_));
  nor2   g46(.a(x19), .b(x17), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  oai21  g48(.a(x18), .b(x08), .c(new_n47_), .O(new_n95_));
  ...
  nor2   g53(.a(x18), .b(x16), .O(new_n100_));
  ...
  nand4  g58(.a(new_n60_), .b(new_n55_), .c(new_n50_), .d(new_n91_), .O(new_n105_));
  inv1   g59(.a(new_n105_), .O(new_n106_));
  aoi21  g60(.a(new_n104_), .b(x21), .c(new_n106_), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n47_), .c(new_n101_), .d(new_n62_), .O(z11));
  nor3   g62(.a(x22), .b(x21), .c(x20), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n93_), .c(new_n105_), .d(x22), .O(new_n110_));
  oai22  g64(.a(new_n110_), .b(new_n47_), .c(new_n101_), .d(new_n67_), .O(z12));
  oai21  g65(.a(x18), .b(x12), .c(new_n47_), .O(new_n112_));
  ...
  oai21  g70(.a(new_n116_), .b(new_n47_), .c(new_n112_), .O(z13));
  aoi21  g71(.a(new_n115_), .b(new_n98_), .c(new_n75_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n113_), .c(new_n103_), .d(new_n91_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n100_), .b(x13), .O(new_n123_));
  ...
  aoi22  g80(.a(new_n126_), .b(new_n106_), .c(new_n120_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n100_), .b(x14), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n47_), .c(new_n128_), .O(z15));
  oai21  g83(.a(x18), .b(x15), .c(new_n47_), .O(new_n130_));
  ...
  nand4  g94(.a(new_n132_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n141_));
  nand3  g95(.a(new_n131_), .b(x19), .c(new_n91_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n51_), .d(new_n91_), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(new_n54_), .O(z17));
endmodule
