...
module FAU ( 
  ...
  nand2  g50(.a(new_n90_), .b(x01), .O(new_n97_));
  ...
  nand4  g56(.a(new_n102_), .b(new_n93_), .c(new_n50_), .d(new_n85_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n101_), .b(x21), .c(new_n104_), .O(new_n105_));
  nand2  g59(.a(new_n90_), .b(x02), .O(new_n106_));
  oai21  g60(.a(new_n105_), .b(new_n99_), .c(new_n106_), .O(z11));
  ...
  nand2  g65(.a(new_n90_), .b(x03), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n99_), .c(new_n112_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n95_), .c(new_n110_), .d(x23), .O(new_n115_));
  nand2  g69(.a(new_n90_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n99_), .c(new_n116_), .O(z13));
  oai21  g71(.a(new_n89_), .b(x05), .c(new_n99_), .O(new_n118_));
  aoi21  g72(.a(new_n114_), .b(new_n95_), .c(new_n70_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n100_), .d(new_n85_), .O(new_n121_));
  ...
  nand4  g79(.a(new_n75_), .b(new_n70_), .c(new_n125_), .d(new_n62_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n104_), .c(new_n121_), .d(x25), .O(new_n128_));
  nand2  g82(.a(new_n90_), .b(x06), .O(new_n129_));
  oai21  g83(.a(new_n128_), .b(new_n99_), .c(new_n129_), .O(z15));
  oai21  g84(.a(new_n89_), .b(x07), .c(new_n99_), .O(new_n131_));
  nor2   g85(.a(x21), .b(x20), .O(new_n132_));
  nor2   g86(.a(x23), .b(x22), .O(new_n133_));
  nor2   g87(.a(x25), .b(x24), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n87_), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(x26), .O(new_n136_));
  nor3   g90(.a(x26), .b(x25), .c(x24), .O(new_n137_));
  nand4  g91(.a(new_n137_), .b(new_n133_), .c(new_n132_), .d(new_n87_), .O(new_n138_));
  ...
  nand4  g95(.a(new_n133_), .b(new_n80_), .c(new_n75_), .d(new_n70_), .O(new_n142_));
  nand3  g96(.a(new_n132_), .b(x19), .c(new_n85_), .O(new_n143_));
