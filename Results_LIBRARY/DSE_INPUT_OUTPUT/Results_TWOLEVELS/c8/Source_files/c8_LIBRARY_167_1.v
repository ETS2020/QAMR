...
module FAU ( 
  ...
  nor2   g052(.a(new_n94_), .b(new_n55_), .O(new_n99_));
  ...
  nand4  g059(.a(new_n63_), .b(new_n55_), .c(new_n47_), .d(new_n92_), .O(new_n106_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n94_), .c(new_n55_), .O(new_n113_));
  ...
  nand4  g081(.a(new_n81_), .b(new_n78_), .c(new_n73_), .d(new_n66_), .O(new_n128_));
  ...
  oai21  g086(.a(x18), .b(x15), .c(new_n52_), .O(new_n133_));
