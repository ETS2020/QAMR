...
module FAU ( 
  ...
  nand2  g001(.a(x08), .b(x02), .O(new_n48_));
  ...
  oai21  g035(.a(new_n81_), .b(x02), .c(x08), .O(new_n82_));
  ...
  nand3  g044(.a(new_n90_), .b(new_n87_), .c(new_n82_), .O(z09));
  ...
  aoi21  g052(.a(new_n98_), .b(new_n95_), .c(new_n49_), .O(z10));
  oai21  g053(.a(new_n89_), .b(x08), .c(x02), .O(new_n100_));
  inv1   g054(.a(x21), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  oai21  g057(.a(new_n97_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nand2  g059(.a(new_n81_), .b(x10), .O(new_n106_));
  ...
  and2   g064(.a(new_n103_), .b(x22), .O(new_n111_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n48_), .O(z12));
  ...
  nand3  g085(.a(new_n54_), .b(new_n84_), .c(new_n83_), .O(new_n132_));
  nand3  g086(.a(new_n113_), .b(new_n130_), .c(new_n66_), .O(new_n133_));
  nor2   g087(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n129_), .c(new_n49_), .O(z14));
  ...
  oai21  g093(.a(new_n133_), .b(new_n132_), .c(x25), .O(new_n140_));
  nor2   g094(.a(x23), .b(x22), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n102_), .d(new_n86_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n102_), .d(new_n86_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n83_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n83_), .O(new_n159_));
