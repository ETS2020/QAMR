...
module FAU ( 
  ...
  nand2  g036(.a(x18), .b(new_n69_), .O(new_n83_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n47_), .O(z12));
  ...
  oai21  g080(.a(x18), .b(new_n81_), .c(x13), .O(new_n127_));
  ...
  nand3  g089(.a(x18), .b(new_n81_), .c(x05), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n135_), .c(new_n127_), .O(z14));
  inv1   g091(.a(x06), .O(new_n138_));
  oai22  g092(.a(new_n83_), .b(new_n138_), .c(x18), .d(new_n72_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n103_), .d(new_n87_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n103_), .d(new_n87_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n130_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n130_), .O(new_n160_));
