...
module FAU ( 
  ...
  oai21  g058(.a(new_n94_), .b(new_n60_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n102_), .c(x16), .O(new_n106_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n102_), .c(x16), .O(new_n115_));
  ...
  aoi21  g080(.a(new_n119_), .b(new_n94_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n103_), .d(new_n86_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n88_), .b(x15), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  inv1   g105(.a(x22), .O(new_n152_));
  nand2  g106(.a(new_n68_), .b(new_n152_), .O(new_n153_));
  inv1   g107(.a(x25), .O(new_n154_));
  nand3  g108(.a(new_n79_), .b(new_n154_), .c(new_n126_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n84_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n52_), .b(new_n84_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n102_), .c(new_n98_), .O(z17));
endmodule
