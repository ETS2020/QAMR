...
module FAU ( 
  ...
  aoi21  g072(.a(new_n111_), .b(new_n89_), .c(new_n65_), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n52_), .O(z12));
  ...
  nand4  g092(.a(new_n138_), .b(new_n120_), .c(new_n102_), .d(new_n87_), .O(new_n139_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n147_), .c(new_n111_), .d(new_n89_), .O(new_n155_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n147_), .c(new_n75_), .O(new_n162_));
  nand3  g116(.a(new_n111_), .b(x19), .c(new_n87_), .O(new_n163_));
