...
module FAU ( 
  ...
  inv1   g37(.a(new_n49_), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n55_), .O(z08));
  ...
  nand2  g45(.a(new_n48_), .b(new_n91_), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n47_), .c(new_n90_), .O(z09));
  nor2   g47(.a(new_n89_), .b(new_n54_), .O(new_n94_));
  nor3   g48(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  oai21  g50(.a(new_n92_), .b(new_n52_), .c(new_n96_), .O(z10));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n86_), .O(new_n99_));
  inv1   g53(.a(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n54_), .c(new_n87_), .d(new_n86_), .O(new_n101_));
  ...
  oai22  g60(.a(new_n106_), .b(new_n91_), .c(new_n92_), .d(new_n61_), .O(z12));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n89_), .c(new_n54_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n95_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n91_), .c(new_n92_), .d(new_n64_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n91_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n95_), .c(new_n71_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n108_), .c(new_n98_), .d(new_n86_), .O(new_n116_));
  ...
  nand4  g74(.a(new_n76_), .b(new_n71_), .c(new_n66_), .d(new_n120_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n123_));
  nand3  g77(.a(new_n48_), .b(new_n91_), .c(x14), .O(new_n124_));
  ...
  nand4  g90(.a(new_n128_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n137_));
  nand3  g91(.a(new_n127_), .b(x19), .c(new_n86_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n55_), .d(new_n86_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n84_), .O(z17));
endmodule
