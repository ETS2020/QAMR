...
module FAU ( 
  ...
  nand2  g22(.a(new_n60_), .b(new_n68_), .O(new_n69_));
  ...
  nand2  g27(.a(new_n60_), .b(new_n73_), .O(new_n74_));
  ...
  nor2   g32(.a(new_n48_), .b(new_n60_), .O(z08));
  ...
  nor2   g46(.a(new_n86_), .b(x16), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(x01), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n92_), .O(z10));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n80_), .O(new_n97_));
  inv1   g51(.a(x21), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n89_), .c(new_n81_), .d(new_n80_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  nand2  g55(.a(new_n93_), .b(x02), .O(new_n102_));
  oai21  g56(.a(new_n101_), .b(new_n85_), .c(new_n102_), .O(z11));
  ...
  nand2  g61(.a(new_n93_), .b(x03), .O(new_n108_));
  oai21  g62(.a(new_n107_), .b(new_n85_), .c(new_n108_), .O(z12));
  oai21  g63(.a(new_n86_), .b(x04), .c(new_n85_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n91_), .c(new_n106_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n85_), .c(new_n110_), .O(z13));
  oai21  g67(.a(new_n86_), .b(x05), .c(new_n85_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n91_), .c(new_n68_), .O(new_n115_));
  ...
  oai21  g74(.a(new_n86_), .b(x06), .c(new_n85_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  nand4  g76(.a(new_n73_), .b(new_n68_), .c(new_n122_), .d(new_n59_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n85_), .c(new_n121_), .O(z15));
