...
module FAU ( 
  ...
  oai21  g082(.a(new_n121_), .b(new_n73_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g088(.a(new_n58_), .b(new_n52_), .c(new_n134_), .O(new_n135_));
  nand3  g089(.a(new_n73_), .b(new_n66_), .c(new_n61_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n119_), .c(new_n104_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(x16), .c(new_n133_), .O(new_n141_));
  inv1   g095(.a(x18), .O(new_n142_));
  nand3  g096(.a(new_n140_), .b(new_n142_), .c(x16), .O(new_n143_));
  oai21  g097(.a(new_n141_), .b(new_n47_), .c(new_n143_), .O(z14));
  inv1   g098(.a(x06), .O(new_n145_));
  oai22  g099(.a(new_n91_), .b(new_n145_), .c(x18), .d(new_n78_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n89_), .O(new_n147_));
  nand2  g101(.a(new_n139_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n127_), .c(new_n110_), .d(new_n95_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n127_), .b(new_n85_), .c(new_n80_), .d(new_n158_), .O(new_n159_));
  ...
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n134_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n53_), .d(new_n134_), .O(new_n164_));
