...
module FAU ( 
  ...
  aoi21  g024(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n71_));
  ...
  nand2  g037(.a(new_n83_), .b(new_n52_), .O(z08));
  nor2   g038(.a(x18), .b(x13), .O(new_n85_));
  ...
  oai21  g045(.a(new_n86_), .b(x16), .c(new_n91_), .O(z09));
  ...
  nor2   g050(.a(new_n88_), .b(new_n57_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n96_), .c(new_n83_), .O(z10));
  nand2  g054(.a(x18), .b(x02), .O(new_n101_));
  nand2  g055(.a(new_n85_), .b(x10), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n93_), .O(new_n104_));
  ...
  nand3  g084(.a(new_n57_), .b(new_n51_), .c(new_n130_), .O(new_n131_));
  nand3  g085(.a(new_n68_), .b(new_n114_), .c(new_n105_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n116_), .c(new_n134_), .d(new_n130_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n83_), .c(x16), .O(new_n138_));
  nand3  g092(.a(x18), .b(new_n93_), .c(x05), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n138_), .O(z14));
  nand2  g094(.a(x18), .b(x06), .O(new_n141_));
  inv1   g095(.a(x18), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(x14), .c(new_n47_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n93_), .O(new_n145_));
  nand2  g099(.a(new_n136_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n106_), .d(new_n88_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n142_), .b(x15), .c(new_n47_), .O(new_n153_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n125_), .c(new_n106_), .d(new_n88_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n125_), .b(new_n80_), .c(new_n75_), .d(new_n162_), .O(new_n163_));
  nand3  g117(.a(new_n106_), .b(x19), .c(new_n130_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n130_), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n83_), .c(x16), .O(new_n166_));
