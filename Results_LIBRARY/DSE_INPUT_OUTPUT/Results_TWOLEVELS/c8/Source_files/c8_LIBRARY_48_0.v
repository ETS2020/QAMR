...
module FAU ( 
  ...
  nand3  g63(.a(new_n109_), .b(new_n87_), .c(new_n56_), .O(new_n110_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n99_), .d(new_n85_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n90_), .b(x05), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n122_), .O(z14));
  oai21  g78(.a(new_n89_), .b(x06), .c(new_n93_), .O(new_n125_));
  nand4  g79(.a(new_n77_), .b(new_n117_), .c(new_n69_), .d(new_n64_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n103_), .c(new_n120_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n93_), .c(new_n125_), .O(z15));
  ...
  nand3  g95(.a(new_n141_), .b(new_n131_), .c(new_n117_), .O(new_n142_));
