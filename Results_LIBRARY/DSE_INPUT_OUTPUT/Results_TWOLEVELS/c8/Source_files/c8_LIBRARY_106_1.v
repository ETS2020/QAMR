...
module FAU ( 
  ...
  nand2  g036(.a(x18), .b(x04), .O(new_n83_));
  ...
  oai21  g070(.a(x18), .b(x12), .c(new_n81_), .O(new_n117_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n86_), .O(z13));
  ...
  aoi21  g081(.a(new_n119_), .b(new_n96_), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n126_), .c(new_n86_), .O(z14));
  ...
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n86_), .O(z15));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n103_), .d(new_n94_), .O(new_n151_));
  ...
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n129_), .O(new_n157_));
