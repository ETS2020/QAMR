...
module FAU ( 
  ...
  oai21  g047(.a(new_n93_), .b(x00), .c(new_n92_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n91_), .O(z09));
  nor2   g049(.a(new_n90_), .b(new_n53_), .O(new_n96_));
  nor3   g050(.a(x20), .b(x19), .c(x17), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  nor2   g052(.a(new_n93_), .b(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x01), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n98_), .O(z10));
  ...
  nand2  g060(.a(new_n99_), .b(x02), .O(new_n107_));
  oai21  g061(.a(new_n106_), .b(new_n92_), .c(new_n107_), .O(z11));
  oai21  g062(.a(new_n93_), .b(x03), .c(new_n92_), .O(new_n109_));
  ...
  oai21  g067(.a(new_n113_), .b(new_n92_), .c(new_n109_), .O(z12));
  nor3   g068(.a(x23), .b(x22), .c(x21), .O(new_n115_));
  aoi22  g069(.a(new_n115_), .b(new_n97_), .c(new_n112_), .d(x23), .O(new_n116_));
  nand2  g070(.a(new_n99_), .b(x04), .O(new_n117_));
  oai21  g071(.a(new_n116_), .b(new_n92_), .c(new_n117_), .O(z13));
  aoi21  g072(.a(new_n115_), .b(new_n97_), .c(new_n72_), .O(new_n119_));
  ...
  nand2  g077(.a(new_n99_), .b(x05), .O(new_n124_));
  ...
  nand2  g083(.a(new_n99_), .b(x06), .O(new_n130_));
  oai21  g084(.a(new_n129_), .b(new_n92_), .c(new_n130_), .O(z15));
  oai21  g085(.a(new_n93_), .b(x07), .c(new_n92_), .O(new_n132_));
