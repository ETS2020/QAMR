...
module FAU ( 
  ...
  nand4  g098(.a(new_n144_), .b(new_n133_), .c(new_n97_), .d(new_n84_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n149_), .b(new_n133_), .c(new_n121_), .O(new_n150_));
  nand3  g104(.a(new_n97_), .b(x19), .c(new_n123_), .O(new_n151_));
  oai22  g105(.a(new_n151_), .b(new_n150_), .c(new_n58_), .d(new_n123_), .O(new_n152_));
