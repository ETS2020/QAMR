...
module FAU ( 
  ...
  nand2  g34(.a(new_n60_), .b(new_n80_), .O(new_n81_));
  aoi21  g35(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(z07));
  nor2   g36(.a(new_n48_), .b(new_n60_), .O(z08));
  ...
  nand4  g55(.a(new_n101_), .b(new_n94_), .c(new_n85_), .d(new_n84_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  nor2   g58(.a(new_n90_), .b(x16), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x02), .O(new_n106_));
  oai21  g60(.a(new_n104_), .b(new_n89_), .c(new_n106_), .O(z11));
  nand2  g61(.a(new_n102_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n87_), .c(new_n94_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n105_), .b(x03), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n89_), .c(new_n112_), .O(z12));
  oai21  g67(.a(new_n90_), .b(x04), .c(new_n89_), .O(new_n114_));
  nor3   g68(.a(x23), .b(x22), .c(x21), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n96_), .c(new_n110_), .d(x23), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n89_), .c(new_n114_), .O(z13));
  oai21  g71(.a(new_n90_), .b(x05), .c(new_n89_), .O(new_n118_));
  aoi21  g72(.a(new_n115_), .b(new_n96_), .c(new_n70_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n109_), .c(new_n99_), .d(new_n84_), .O(new_n121_));
  ...
  nand4  g78(.a(new_n75_), .b(new_n70_), .c(new_n65_), .d(new_n59_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n103_), .c(new_n121_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n105_), .b(x06), .O(new_n128_));
  ...
  nand2  g92(.a(new_n105_), .b(x07), .O(new_n139_));
