...
module FAU ( 
  ...
  nand2  g052(.a(x18), .b(x10), .O(new_n99_));
  oai22  g053(.a(new_n99_), .b(new_n98_), .c(x18), .d(new_n58_), .O(new_n100_));
  ...
  oai21  g057(.a(new_n91_), .b(new_n56_), .c(new_n103_), .O(new_n104_));
  ...
  oai21  g061(.a(x18), .b(new_n47_), .c(new_n107_), .O(new_n108_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n109_), .c(new_n48_), .O(z11));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n91_), .c(new_n65_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n91_), .c(new_n56_), .O(new_n122_));
  ...
  oai22  g080(.a(new_n99_), .b(new_n126_), .c(x18), .d(new_n68_), .O(new_n127_));
  ...
  nand2  g084(.a(new_n130_), .b(new_n111_), .O(new_n131_));
  ...
  aoi21  g091(.a(new_n130_), .b(new_n111_), .c(new_n75_), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n121_), .c(new_n102_), .d(new_n89_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n138_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n48_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(x18), .b(new_n80_), .c(new_n144_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n112_), .d(new_n91_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n146_), .c(new_n48_), .O(z15));
  inv1   g107(.a(x07), .O(new_n154_));
  oai22  g108(.a(new_n99_), .b(new_n154_), .c(x18), .d(new_n85_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n112_), .d(new_n91_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n83_), .c(new_n78_), .d(new_n75_), .O(new_n163_));
  nand3  g117(.a(new_n112_), .b(x19), .c(new_n89_), .O(new_n164_));
