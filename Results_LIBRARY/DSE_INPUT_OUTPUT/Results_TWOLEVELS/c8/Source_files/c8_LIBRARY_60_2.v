...
module FAU ( 
  ...
  nand3  g054(.a(new_n54_), .b(new_n87_), .c(new_n86_), .O(new_n101_));
  ...
  nand3  g059(.a(new_n97_), .b(x10), .c(new_n48_), .O(new_n106_));
  ...
  oai21  g068(.a(new_n97_), .b(new_n91_), .c(x03), .O(new_n115_));
  aoi21  g069(.a(new_n110_), .b(new_n89_), .c(new_n65_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n97_), .b(new_n91_), .c(x11), .O(new_n121_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n109_), .c(new_n60_), .O(new_n128_));
  ...
  nand3  g086(.a(new_n97_), .b(x13), .c(new_n48_), .O(new_n133_));
  ...
  nand3  g098(.a(new_n97_), .b(x14), .c(new_n48_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n127_), .c(new_n110_), .d(new_n89_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n97_), .b(x15), .c(new_n48_), .O(new_n155_));
  ...
  nand4  g113(.a(new_n159_), .b(new_n127_), .c(new_n110_), .d(new_n89_), .O(new_n160_));
  ...
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n55_), .d(new_n86_), .O(new_n168_));
