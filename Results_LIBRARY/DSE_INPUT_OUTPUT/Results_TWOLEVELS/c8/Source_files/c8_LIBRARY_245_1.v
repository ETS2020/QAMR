...
module FAU ( 
  ...
  nand3  g49(.a(new_n48_), .b(new_n90_), .c(x09), .O(new_n96_));
  ...
  oai21  g65(.a(x18), .b(x12), .c(new_n90_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n94_), .c(new_n109_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n90_), .c(new_n112_), .O(z13));
  aoi21  g69(.a(new_n113_), .b(new_n94_), .c(new_n71_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n99_), .d(new_n85_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand3  g74(.a(new_n48_), .b(new_n90_), .c(x13), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  oai21  g76(.a(x18), .b(x14), .c(new_n90_), .O(new_n123_));
  inv1   g77(.a(x23), .O(new_n124_));
  nand4  g78(.a(new_n76_), .b(new_n71_), .c(new_n124_), .d(new_n63_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n103_), .c(new_n118_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n90_), .c(new_n123_), .O(z15));
  oai21  g82(.a(x18), .b(x15), .c(new_n90_), .O(new_n129_));
