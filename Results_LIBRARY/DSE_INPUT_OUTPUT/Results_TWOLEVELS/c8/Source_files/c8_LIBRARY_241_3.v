...
module FAU ( 
  ...
  nor2   g041(.a(x16), .b(new_n49_), .O(new_n88_));
  ...
  nand2  g053(.a(new_n99_), .b(x09), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n98_), .c(new_n93_), .O(z10));
  ...
  nand2  g060(.a(new_n99_), .b(x10), .O(new_n107_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n112_), .c(x16), .O(new_n117_));
  ...
  nand2  g078(.a(new_n99_), .b(x12), .O(new_n125_));
  ...
  nand3  g084(.a(new_n94_), .b(new_n51_), .c(new_n130_), .O(new_n131_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n112_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n129_), .O(z14));
  oai21  g094(.a(x16), .b(x06), .c(x18), .O(new_n141_));
  nand2  g095(.a(new_n137_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n121_), .c(new_n103_), .d(new_n95_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n99_), .b(x14), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n146_), .c(new_n141_), .O(z15));
  oai21  g102(.a(x16), .b(x07), .c(x18), .O(new_n149_));
  nand2  g103(.a(new_n144_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n121_), .c(new_n103_), .d(new_n95_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n99_), .b(x15), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  nand4  g110(.a(new_n121_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n157_));
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n130_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n130_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n112_), .c(x16), .O(new_n160_));
