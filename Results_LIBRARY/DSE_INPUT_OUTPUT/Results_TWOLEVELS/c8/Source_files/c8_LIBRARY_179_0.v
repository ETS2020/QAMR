...
module FAU ( 
  ...
  oai21  g065(.a(new_n85_), .b(new_n62_), .c(new_n111_), .O(new_n112_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n88_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n113_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  oai21  g074(.a(new_n85_), .b(new_n67_), .c(new_n120_), .O(new_n121_));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n105_), .c(new_n72_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n115_), .c(new_n97_), .d(new_n96_), .O(new_n134_));
  ...
  oai21  g092(.a(new_n85_), .b(new_n75_), .c(new_n138_), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n106_), .d(new_n95_), .O(new_n144_));
  ...
  oai21  g101(.a(new_n79_), .b(x07), .c(new_n83_), .O(new_n148_));
  nand2  g102(.a(new_n144_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n106_), .d(new_n95_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n88_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n142_), .c(new_n72_), .O(new_n156_));
  nand3  g110(.a(new_n106_), .b(x19), .c(new_n96_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n54_), .d(new_n96_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n88_), .O(z17));
endmodule
