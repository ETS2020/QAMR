...
module FAU ( 
  ...
  nor2   g46(.a(new_n85_), .b(new_n53_), .O(new_n93_));
  ...
  oai21  g63(.a(new_n108_), .b(new_n91_), .c(new_n109_), .O(z12));
  ...
  nand4  g70(.a(new_n116_), .b(new_n106_), .c(new_n97_), .d(new_n82_), .O(new_n117_));
  ...
  oai21  g81(.a(new_n127_), .b(new_n91_), .c(new_n122_), .O(z15));
