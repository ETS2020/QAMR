...
module FAU ( 
  ...
  oai21  g050(.a(new_n83_), .b(new_n93_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n92_), .c(x16), .O(new_n108_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n105_), .d(new_n83_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n105_), .d(new_n83_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n92_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n137_), .c(new_n69_), .O(new_n154_));
  nand3  g108(.a(new_n105_), .b(x19), .c(new_n94_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n61_), .d(new_n94_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n92_), .c(x16), .O(new_n157_));
