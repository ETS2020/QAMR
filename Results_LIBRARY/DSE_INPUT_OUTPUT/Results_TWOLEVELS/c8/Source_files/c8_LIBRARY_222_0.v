...
module FAU ( 
  ...
  nand2  g64(.a(new_n93_), .b(x04), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n86_), .c(new_n111_), .O(z13));
  oai21  g66(.a(new_n87_), .b(x05), .c(new_n86_), .O(new_n113_));
  aoi21  g67(.a(new_n109_), .b(new_n91_), .c(new_n72_), .O(new_n114_));
