...
module FAU ( 
  ...
  aoi22  g037(.a(new_n83_), .b(new_n81_), .c(x18), .d(new_n52_), .O(z06));
  ...
  nand2  g046(.a(x18), .b(x05), .O(new_n93_));
  ...
  oai22  g053(.a(new_n93_), .b(new_n99_), .c(x18), .d(new_n57_), .O(new_n100_));
  ...
  oai21  g059(.a(new_n102_), .b(new_n55_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n53_), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n101_), .O(z10));
  inv1   g062(.a(x02), .O(new_n109_));
  oai22  g063(.a(new_n93_), .b(new_n109_), .c(x18), .d(new_n62_), .O(new_n110_));
  ...
  oai22  g072(.a(new_n93_), .b(new_n118_), .c(x18), .d(new_n67_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n91_), .O(new_n120_));
  nand2  g074(.a(new_n114_), .b(x22), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n102_), .c(new_n55_), .O(new_n123_));
  ...
  oai22  g081(.a(new_n93_), .b(new_n127_), .c(x18), .d(new_n72_), .O(new_n128_));
  ...
  oai21  g089(.a(x18), .b(x13), .c(new_n91_), .O(new_n136_));
  aoi21  g090(.a(new_n131_), .b(new_n112_), .c(new_n75_), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n122_), .c(new_n104_), .d(new_n103_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(new_n53_), .O(z14));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n113_), .d(new_n102_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n113_), .d(new_n102_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n85_), .c(new_n82_), .d(new_n75_), .O(new_n162_));
  nand3  g116(.a(new_n113_), .b(x19), .c(new_n103_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n48_), .d(new_n103_), .O(new_n164_));
