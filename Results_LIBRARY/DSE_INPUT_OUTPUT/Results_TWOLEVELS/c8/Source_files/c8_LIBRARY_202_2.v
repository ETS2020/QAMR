...
module FAU ( 
  ...
  aoi21  g020(.a(new_n66_), .b(new_n64_), .c(new_n53_), .O(z03));
  ...
  aoi21  g027(.a(x27), .b(new_n73_), .c(new_n53_), .O(new_n74_));
  ...
  aoi21  g033(.a(new_n79_), .b(new_n77_), .c(new_n53_), .O(z06));
  ...
  nand3  g051(.a(new_n97_), .b(new_n86_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n93_), .O(z09));
  oai21  g053(.a(new_n90_), .b(new_n88_), .c(x01), .O(new_n100_));
  inv1   g054(.a(x20), .O(new_n101_));
  nor2   g055(.a(new_n95_), .b(new_n101_), .O(new_n102_));
  nor3   g056(.a(x20), .b(x19), .c(x17), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n102_), .c(x16), .O(new_n104_));
  nand3  g058(.a(new_n90_), .b(new_n88_), .c(x09), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n104_), .c(new_n100_), .O(z10));
  nand2  g060(.a(x18), .b(x02), .O(new_n107_));
  nand3  g061(.a(new_n90_), .b(x10), .c(new_n52_), .O(new_n108_));
  ...
  oai21  g066(.a(new_n103_), .b(new_n60_), .c(new_n112_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n86_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n110_), .O(z11));
  nand2  g069(.a(x18), .b(x03), .O(new_n116_));
  oai21  g070(.a(x18), .b(new_n63_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n88_), .O(new_n118_));
  aoi21  g072(.a(new_n111_), .b(new_n95_), .c(new_n65_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n95_), .c(new_n101_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n86_), .O(z12));
  ...
  nand3  g083(.a(new_n129_), .b(new_n103_), .c(new_n60_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n127_), .c(new_n86_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  nand3  g088(.a(new_n90_), .b(x13), .c(new_n52_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n88_), .O(new_n137_));
  inv1   g091(.a(x17), .O(new_n138_));
  nand3  g092(.a(new_n101_), .b(new_n49_), .c(new_n138_), .O(new_n139_));
  nand3  g093(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n139_), .c(x24), .O(new_n141_));
  nor2   g095(.a(x20), .b(x19), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n142_), .d(new_n138_), .O(new_n144_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n129_), .c(new_n111_), .d(new_n95_), .O(new_n154_));
  ...
  oai21  g112(.a(x18), .b(new_n81_), .c(new_n158_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n88_), .O(new_n160_));
  nand2  g114(.a(new_n154_), .b(x26), .O(new_n161_));
  nor3   g115(.a(x26), .b(x25), .c(x24), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n129_), .c(new_n111_), .d(new_n95_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n160_), .c(new_n86_), .O(z16));
  inv1   g120(.a(x24), .O(new_n167_));
  nand4  g121(.a(new_n129_), .b(new_n83_), .c(new_n78_), .d(new_n167_), .O(new_n168_));
  nand3  g122(.a(new_n111_), .b(x19), .c(new_n138_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n168_), .c(new_n50_), .d(new_n138_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(x16), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n86_), .O(z17));
endmodule
