...
module FAU ( 
  ...
  nor2   g006(.a(new_n52_), .b(x01), .O(new_n53_));
  ...
  oai21  g045(.a(x18), .b(new_n55_), .c(new_n86_), .O(new_n92_));
  ...
  oai21  g051(.a(new_n94_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n82_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n93_), .O(z10));
  nand3  g054(.a(x18), .b(x02), .c(x01), .O(new_n101_));
  ...
  nand3  g063(.a(x18), .b(x03), .c(x01), .O(new_n110_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n94_), .c(new_n57_), .O(new_n115_));
  ...
  nand3  g072(.a(x18), .b(x04), .c(x01), .O(new_n119_));
  oai21  g073(.a(x18), .b(new_n70_), .c(new_n119_), .O(new_n120_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n96_), .d(new_n95_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n130_), .c(new_n82_), .O(z14));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n94_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n140_), .c(new_n82_), .O(z15));
  nand3  g101(.a(x18), .b(x07), .c(x01), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n105_), .d(new_n94_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n82_), .c(x16), .O(new_n155_));
  ...
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n95_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n50_), .d(new_n95_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n82_), .O(z17));
endmodule
