...
module FAU ( 
  ...
  nand4  g52(.a(new_n59_), .b(new_n91_), .c(new_n50_), .d(new_n82_), .O(new_n99_));
  ...
  nand3  g58(.a(new_n104_), .b(new_n84_), .c(new_n91_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand3  g60(.a(x18), .b(new_n86_), .c(x03), .O(new_n107_));
  ...
  nand4  g70(.a(new_n116_), .b(new_n104_), .c(new_n97_), .d(new_n82_), .O(new_n117_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n114_), .c(new_n67_), .d(new_n122_), .O(new_n124_));
