...
module FAU ( 
  ...
  oai21  g014(.a(x27), .b(new_n60_), .c(new_n47_), .O(new_n61_));
  nand3  g015(.a(new_n52_), .b(new_n60_), .c(x18), .O(new_n62_));
  nand2  g016(.a(new_n62_), .b(new_n61_), .O(z02));
  ...
  nand3  g049(.a(new_n95_), .b(new_n47_), .c(x09), .O(new_n96_));
  ...
  oai21  g054(.a(new_n87_), .b(new_n57_), .c(new_n100_), .O(new_n101_));
  ...
  aoi22  g058(.a(new_n104_), .b(new_n87_), .c(new_n100_), .d(x21), .O(new_n105_));
  nor2   g059(.a(new_n95_), .b(x16), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(x02), .c(new_n48_), .O(new_n107_));
  oai21  g061(.a(new_n105_), .b(new_n89_), .c(new_n107_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  nand3  g063(.a(new_n95_), .b(x11), .c(new_n47_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n89_), .O(new_n112_));
  nand2  g066(.a(new_n104_), .b(new_n87_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n87_), .c(new_n57_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n95_), .b(x12), .c(new_n47_), .O(new_n121_));
  ...
  nand4  g079(.a(new_n125_), .b(new_n99_), .c(new_n60_), .d(new_n85_), .O(new_n126_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n125_), .c(new_n104_), .d(new_n87_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n125_), .c(new_n104_), .d(new_n87_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n125_), .c(new_n159_), .O(new_n161_));
  nand3  g115(.a(new_n104_), .b(x19), .c(new_n85_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n85_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n83_), .O(z17));
endmodule
