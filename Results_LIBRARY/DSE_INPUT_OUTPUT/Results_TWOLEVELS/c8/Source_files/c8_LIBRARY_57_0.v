...
module FAU ( 
  ...
  oai21  g035(.a(new_n48_), .b(new_n52_), .c(new_n53_), .O(new_n82_));
  oai21  g036(.a(new_n48_), .b(x14), .c(new_n82_), .O(z06));
  ...
  nand2  g045(.a(x25), .b(new_n52_), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n50_), .c(new_n91_), .O(new_n93_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n54_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n94_), .O(z09));
  ...
  nor2   g057(.a(new_n96_), .b(new_n59_), .O(new_n104_));
  nor3   g058(.a(x20), .b(x19), .c(x17), .O(new_n105_));
  oai21  g059(.a(new_n105_), .b(new_n104_), .c(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n103_), .c(new_n54_), .O(z10));
  nand2  g061(.a(x18), .b(x02), .O(new_n108_));
  oai21  g062(.a(new_n92_), .b(new_n64_), .c(new_n108_), .O(new_n109_));
  ...
  oai21  g066(.a(new_n105_), .b(new_n62_), .c(new_n112_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n54_), .c(x16), .O(new_n114_));
  ...
  nor2   g076(.a(new_n122_), .b(new_n97_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n118_), .c(new_n54_), .O(z12));
  nand2  g079(.a(x18), .b(x04), .O(new_n126_));
  oai21  g080(.a(x18), .b(new_n72_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n90_), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n105_), .c(new_n62_), .O(new_n130_));
  oai21  g084(.a(new_n123_), .b(new_n74_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n128_), .c(new_n54_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  oai21  g088(.a(new_n92_), .b(new_n77_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n90_), .O(new_n136_));
  nand3  g090(.a(new_n130_), .b(new_n54_), .c(x24), .O(new_n137_));
  inv1   g091(.a(x17), .O(new_n138_));
  nand2  g092(.a(new_n53_), .b(new_n52_), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n79_), .c(new_n74_), .d(new_n67_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(x21), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n59_), .c(new_n47_), .d(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n137_), .O(new_n143_));
  ...
  oai21  g101(.a(new_n92_), .b(new_n146_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n90_), .O(new_n149_));
  nand4  g103(.a(new_n121_), .b(new_n105_), .c(new_n79_), .d(new_n74_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x25), .O(new_n151_));
  nor2   g105(.a(x20), .b(x19), .O(new_n152_));
  nor2   g106(.a(new_n52_), .b(x17), .O(new_n153_));
  nor3   g107(.a(x25), .b(x24), .c(x23), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n153_), .c(new_n121_), .d(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n149_), .O(z15));
  nand2  g112(.a(x18), .b(x07), .O(new_n159_));
  oai21  g113(.a(new_n92_), .b(new_n86_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n90_), .O(new_n161_));
  nand2  g115(.a(new_n150_), .b(x26), .O(new_n162_));
  nor3   g116(.a(x26), .b(x25), .c(x24), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n129_), .c(new_n119_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(new_n52_), .O(new_n165_));
  nor2   g119(.a(new_n84_), .b(new_n53_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n165_), .c(x16), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n161_), .O(z16));
  nand3  g122(.a(new_n54_), .b(x27), .c(x17), .O(new_n169_));
  nand2  g123(.a(new_n111_), .b(x19), .O(new_n170_));
  inv1   g124(.a(new_n170_), .O(new_n171_));
  nand4  g125(.a(new_n171_), .b(new_n163_), .c(new_n153_), .d(new_n129_), .O(new_n172_));
  aoi21  g126(.a(new_n172_), .b(new_n169_), .c(new_n90_), .O(z17));
endmodule
