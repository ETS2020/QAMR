...
module FAU ( 
  ...
  nand3  g037(.a(new_n83_), .b(x08), .c(new_n48_), .O(new_n84_));
  ...
  nand3  g054(.a(new_n83_), .b(x10), .c(new_n48_), .O(new_n101_));
  ...
  oai21  g059(.a(new_n97_), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g063(.a(new_n83_), .b(x11), .c(new_n48_), .O(new_n110_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n87_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n112_), .O(z12));
  nand3  g072(.a(new_n83_), .b(x12), .c(new_n48_), .O(new_n119_));
  oai21  g073(.a(new_n83_), .b(new_n48_), .c(new_n119_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n87_), .c(x16), .O(new_n126_));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n97_), .c(new_n69_), .O(new_n131_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n130_), .c(new_n87_), .O(z14));
  ...
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n87_), .O(z15));
  ...
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n87_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n69_), .O(new_n159_));
  nand3  g113(.a(new_n104_), .b(x19), .c(new_n132_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n58_), .d(new_n132_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n87_), .c(x16), .O(new_n162_));
