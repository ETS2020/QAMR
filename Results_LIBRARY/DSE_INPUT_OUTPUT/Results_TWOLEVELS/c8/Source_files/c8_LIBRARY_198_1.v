...
module FAU ( 
  ...
  aoi22  g62(.a(new_n108_), .b(new_n90_), .c(new_n104_), .d(x22), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n92_), .c(new_n99_), .d(new_n63_), .O(z12));
  oai21  g64(.a(x18), .b(x12), .c(new_n92_), .O(new_n111_));
  nor2   g65(.a(x22), .b(x21), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n90_), .c(new_n54_), .O(new_n113_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n96_), .c(new_n113_), .d(x23), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n92_), .c(new_n111_), .O(z13));
  oai21  g70(.a(x18), .b(x13), .c(new_n92_), .O(new_n117_));
  aoi21  g71(.a(new_n114_), .b(new_n96_), .c(new_n75_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n112_), .c(new_n102_), .d(new_n87_), .O(new_n120_));
  ...
  nand4  g77(.a(new_n80_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n105_), .c(new_n120_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n98_), .b(x14), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n92_), .c(new_n127_), .O(z15));
  ...
  nand2  g91(.a(new_n98_), .b(x15), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  inv1   g93(.a(new_n49_), .O(new_n140_));
  nor2   g94(.a(x26), .b(x25), .O(new_n141_));
  nand3  g95(.a(new_n141_), .b(new_n130_), .c(new_n75_), .O(new_n142_));
  nand3  g96(.a(new_n129_), .b(x19), .c(new_n87_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n55_), .d(new_n87_), .O(new_n144_));
