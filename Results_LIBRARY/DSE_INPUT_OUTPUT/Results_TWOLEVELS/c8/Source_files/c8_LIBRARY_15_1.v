...
module FAU ( 
  ...
  oai21  g029(.a(new_n48_), .b(x26), .c(new_n52_), .O(new_n76_));
  oai21  g030(.a(new_n48_), .b(x13), .c(new_n76_), .O(z05));
  ...
  aoi21  g050(.a(new_n96_), .b(new_n92_), .c(new_n55_), .O(z09));
  ...
  nand3  g055(.a(new_n58_), .b(new_n47_), .c(new_n89_), .O(new_n102_));
  ...
  nand3  g063(.a(new_n102_), .b(x21), .c(x16), .O(new_n110_));
  inv1   g064(.a(new_n110_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n109_), .c(new_n53_), .O(new_n112_));
  nor3   g066(.a(new_n55_), .b(x21), .c(x20), .O(new_n113_));
  nand4  g067(.a(new_n113_), .b(new_n47_), .c(new_n89_), .d(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(z11));
  ...
  nand3  g074(.a(new_n120_), .b(x22), .c(x16), .O(new_n121_));
  aoi21  g075(.a(new_n121_), .b(new_n118_), .c(new_n55_), .O(new_n122_));
  nand4  g076(.a(new_n53_), .b(new_n66_), .c(new_n61_), .d(new_n58_), .O(new_n123_));
  nor4   g077(.a(new_n123_), .b(x19), .c(x17), .d(new_n93_), .O(new_n124_));
  or2    g078(.a(new_n124_), .b(new_n122_), .O(z12));
  ...
  nand2  g082(.a(x26), .b(new_n52_), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n73_), .c(new_n66_), .d(new_n61_), .O(new_n130_));
  nor4   g084(.a(new_n130_), .b(x20), .c(x19), .d(x17), .O(new_n131_));
  nor3   g085(.a(x22), .b(x21), .c(x20), .O(new_n132_));
  aoi21  g086(.a(new_n132_), .b(new_n91_), .c(new_n73_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n131_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n128_), .c(new_n53_), .O(z13));
  inv1   g089(.a(x13), .O(new_n136_));
  nand2  g090(.a(x18), .b(x05), .O(new_n137_));
  oai21  g091(.a(x18), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n53_), .c(new_n93_), .O(new_n139_));
  nor2   g093(.a(new_n52_), .b(new_n73_), .O(new_n140_));
  nor3   g094(.a(x26), .b(x24), .c(x23), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n140_), .c(new_n66_), .O(new_n142_));
  nand2  g096(.a(x24), .b(x22), .O(new_n143_));
  aoi21  g097(.a(new_n143_), .b(new_n142_), .c(x21), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n58_), .c(new_n47_), .d(new_n89_), .O(new_n145_));
  nand2  g099(.a(new_n120_), .b(x24), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n139_), .O(z14));
  nand2  g103(.a(x18), .b(x06), .O(new_n150_));
  oai21  g104(.a(x18), .b(new_n80_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n93_), .O(new_n152_));
  nand4  g106(.a(new_n58_), .b(new_n47_), .c(new_n89_), .d(x16), .O(new_n153_));
  nor2   g107(.a(x22), .b(x21), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n73_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n153_), .c(new_n83_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n52_), .O(new_n158_));
  nand4  g112(.a(new_n154_), .b(new_n103_), .c(new_n52_), .d(new_n73_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(x25), .c(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n158_), .c(new_n152_), .O(z15));
  nand2  g115(.a(x26), .b(x24), .O(new_n162_));
  oai21  g116(.a(x26), .b(x16), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(x18), .b(x07), .O(new_n164_));
  oai21  g118(.a(x18), .b(new_n85_), .c(new_n164_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand4  g120(.a(new_n155_), .b(new_n52_), .c(new_n73_), .d(new_n66_), .O(new_n167_));
  oai21  g121(.a(new_n167_), .b(new_n120_), .c(new_n162_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n166_), .O(z16));
  nand2  g124(.a(z08), .b(x17), .O(new_n171_));
  inv1   g125(.a(new_n167_), .O(new_n172_));
  nand4  g126(.a(new_n172_), .b(new_n119_), .c(x19), .d(new_n89_), .O(new_n173_));
  aoi21  g127(.a(new_n173_), .b(new_n171_), .c(new_n93_), .O(z17));
endmodule
