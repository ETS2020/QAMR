...
module FAU ( 
  ...
  nand2  g58(.a(new_n96_), .b(x02), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n89_), .c(new_n105_), .O(z11));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n94_), .c(new_n118_), .O(new_n119_));
  ...
  oai21  g78(.a(new_n90_), .b(x06), .c(new_n89_), .O(new_n125_));
  inv1   g79(.a(x23), .O(new_n126_));
  nand4  g80(.a(new_n75_), .b(new_n118_), .c(new_n126_), .d(new_n64_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n103_), .c(new_n121_), .d(x25), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n89_), .c(new_n125_), .O(z15));
  ...
  nand2  g93(.a(new_n96_), .b(x07), .O(new_n140_));
