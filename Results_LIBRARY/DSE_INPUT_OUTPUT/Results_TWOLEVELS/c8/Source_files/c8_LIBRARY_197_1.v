...
module FAU ( 
  ...
  nand2  g43(.a(new_n47_), .b(new_n89_), .O(new_n90_));
  ...
  nand4  g55(.a(new_n101_), .b(new_n93_), .c(new_n51_), .d(new_n85_), .O(new_n102_));
  ...
  oai22  g61(.a(new_n107_), .b(new_n89_), .c(new_n90_), .d(new_n61_), .O(z12));
  ...
  oai22  g66(.a(new_n112_), .b(new_n89_), .c(new_n90_), .d(new_n66_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n89_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n95_), .c(new_n73_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n109_), .c(new_n99_), .d(new_n85_), .O(new_n117_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n73_), .c(new_n68_), .d(new_n63_), .O(new_n123_));
