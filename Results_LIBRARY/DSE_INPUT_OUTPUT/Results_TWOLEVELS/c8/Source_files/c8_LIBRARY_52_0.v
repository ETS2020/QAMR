...
module FAU ( 
  ...
  inv1   g32(.a(new_n47_), .O(new_n79_));
  nand2  g33(.a(new_n79_), .b(new_n51_), .O(z08));
  ...
  nand2  g47(.a(x18), .b(new_n85_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n89_), .c(new_n93_), .O(z10));
  ...
  nand4  g53(.a(new_n99_), .b(new_n90_), .c(new_n50_), .d(new_n81_), .O(new_n100_));
  ...
  inv1   g57(.a(x03), .O(new_n104_));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n83_), .c(new_n100_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n85_), .c(new_n94_), .d(new_n104_), .O(z12));
  inv1   g61(.a(x04), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n83_), .c(new_n90_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n92_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai22  g66(.a(new_n112_), .b(new_n85_), .c(new_n94_), .d(new_n108_), .O(z13));
  oai21  g67(.a(new_n86_), .b(x05), .c(new_n85_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n92_), .c(new_n70_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n109_), .c(new_n97_), .d(new_n81_), .O(new_n117_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n130_), .c(new_n70_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n81_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n51_), .d(new_n81_), .O(new_n142_));
