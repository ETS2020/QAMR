...
module FAU ( 
  ...
  nor2   g002(.a(new_n48_), .b(x04), .O(new_n49_));
  ...
  nand2  g037(.a(x18), .b(x04), .O(new_n84_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n95_), .c(new_n80_), .O(z10));
  ...
  oai21  g072(.a(x18), .b(x12), .c(new_n82_), .O(new_n119_));
  ...
  nand3  g079(.a(x18), .b(x05), .c(x04), .O(new_n126_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n121_), .c(new_n104_), .d(new_n88_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n80_), .c(x16), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n121_), .c(new_n104_), .d(new_n88_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n80_), .O(z16));
  inv1   g111(.a(x24), .O(new_n158_));
  nor2   g112(.a(x26), .b(x25), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n121_), .c(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n129_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n129_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n80_), .c(x16), .O(new_n163_));
