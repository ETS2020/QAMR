...
module FAU ( 
  ...
  nor2   g055(.a(new_n92_), .b(new_n56_), .O(new_n102_));
  nor3   g056(.a(x20), .b(x19), .c(x17), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n102_), .c(x16), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n101_), .c(new_n48_), .O(z10));
  ...
  oai21  g064(.a(new_n103_), .b(new_n61_), .c(new_n110_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(x16), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n108_), .c(new_n48_), .O(z11));
  nand2  g067(.a(x18), .b(x03), .O(new_n114_));
  oai21  g068(.a(x18), .b(new_n68_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n94_), .O(new_n116_));
  aoi21  g070(.a(new_n109_), .b(new_n92_), .c(new_n66_), .O(new_n117_));
  inv1   g071(.a(new_n92_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n56_), .O(new_n120_));
  nor2   g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n117_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n116_), .c(new_n48_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  oai21  g078(.a(x18), .b(new_n73_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n94_), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n103_), .c(new_n61_), .O(new_n128_));
  oai21  g082(.a(new_n121_), .b(new_n71_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n126_), .c(new_n48_), .O(z13));
  nand2  g085(.a(x18), .b(x05), .O(new_n132_));
  nand2  g086(.a(new_n81_), .b(new_n47_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n76_), .c(new_n132_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n94_), .O(new_n135_));
  nand2  g089(.a(new_n128_), .b(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n119_), .c(new_n137_), .d(new_n90_), .O(new_n139_));
  ...
  nand2  g100(.a(new_n139_), .b(x25), .O(new_n147_));
  nand3  g101(.a(new_n127_), .b(new_n81_), .c(new_n78_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n110_), .c(new_n147_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n146_), .c(new_n48_), .O(z15));
  nand2  g105(.a(x18), .b(x07), .O(new_n152_));
  oai21  g106(.a(new_n133_), .b(new_n86_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n94_), .O(new_n154_));
  nand2  g108(.a(new_n139_), .b(x26), .O(new_n155_));
  nor2   g109(.a(x26), .b(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n127_), .c(new_n109_), .d(new_n92_), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(new_n155_), .c(x25), .O(new_n158_));
  nand3  g112(.a(x26), .b(x25), .c(x18), .O(new_n159_));
  ...
  nor2   g117(.a(new_n52_), .b(x17), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nand4  g119(.a(new_n165_), .b(new_n164_), .c(new_n127_), .d(new_n109_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n163_), .c(new_n94_), .O(z17));
endmodule
