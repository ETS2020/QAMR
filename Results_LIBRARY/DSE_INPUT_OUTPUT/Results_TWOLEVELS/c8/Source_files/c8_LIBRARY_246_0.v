...
module FAU ( 
  ...
  nor2   g025(.a(x27), .b(x24), .O(new_n72_));
  aoi21  g026(.a(x27), .b(new_n71_), .c(new_n72_), .O(new_n73_));
  nand2  g027(.a(new_n72_), .b(x13), .O(new_n74_));
  oai21  g028(.a(new_n73_), .b(new_n70_), .c(new_n74_), .O(z05));
  ...
  aoi21  g037(.a(new_n70_), .b(new_n71_), .c(new_n51_), .O(z08));
  inv1   g038(.a(x16), .O(new_n85_));
  nand2  g039(.a(x18), .b(x00), .O(new_n86_));
  nand2  g040(.a(new_n70_), .b(x13), .O(new_n87_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n99_), .c(new_n90_), .O(z10));
  ...
  oai21  g063(.a(new_n102_), .b(new_n59_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(new_n90_), .O(z11));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n92_), .c(new_n64_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n92_), .c(new_n100_), .O(new_n118_));
  ...
  oai21  g076(.a(new_n87_), .b(new_n67_), .c(new_n122_), .O(new_n123_));
  ...
  nand2  g080(.a(new_n126_), .b(new_n102_), .O(new_n127_));
  ...
  oai21  g084(.a(new_n70_), .b(x05), .c(new_n85_), .O(new_n131_));
  inv1   g085(.a(x24), .O(new_n132_));
  aoi21  g086(.a(new_n126_), .b(new_n102_), .c(new_n132_), .O(new_n133_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n131_), .c(new_n90_), .O(z14));
  ...
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n90_), .O(z15));
  ...
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n51_), .d(new_n134_), .O(new_n163_));
