...
module FAU ( 
  ...
  oai21  g034(.a(x27), .b(new_n80_), .c(new_n79_), .O(new_n81_));
  nand2  g035(.a(new_n55_), .b(new_n80_), .O(new_n82_));
  oai21  g036(.a(new_n82_), .b(x18), .c(new_n81_), .O(z07));
  ...
  nand3  g054(.a(new_n100_), .b(new_n97_), .c(new_n48_), .O(z10));
  ...
  nand3  g062(.a(new_n108_), .b(new_n104_), .c(new_n48_), .O(z11));
  ...
  aoi21  g066(.a(new_n105_), .b(new_n88_), .c(new_n65_), .O(new_n113_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n48_), .O(z13));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n99_), .c(new_n73_), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n132_), .d(new_n85_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n131_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n130_), .c(new_n48_), .O(z14));
  nand3  g091(.a(x18), .b(new_n79_), .c(x06), .O(new_n138_));
  ...
  oai21  g101(.a(x18), .b(new_n90_), .c(x15), .O(new_n148_));
  nand2  g102(.a(new_n144_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n105_), .d(new_n88_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(x18), .b(new_n90_), .c(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n142_), .c(new_n73_), .O(new_n157_));
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n85_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n85_), .O(new_n159_));
