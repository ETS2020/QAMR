...
module FAU ( 
  ...
  aoi21  g040(.a(x27), .b(new_n52_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n109_), .c(new_n53_), .O(z11));
  ...
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n58_), .O(new_n120_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n104_), .c(new_n78_), .O(new_n136_));
  ...
  nand3  g096(.a(x18), .b(x15), .c(x06), .O(new_n143_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n95_), .c(x15), .O(new_n155_));
  ...
  nand3  g117(.a(new_n110_), .b(x19), .c(new_n91_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n48_), .d(new_n91_), .O(new_n165_));
