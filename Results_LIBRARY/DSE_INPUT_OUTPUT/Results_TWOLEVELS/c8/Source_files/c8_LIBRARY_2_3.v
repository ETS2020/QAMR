...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(new_n51_), .c(new_n86_), .O(new_n99_));
  oai21  g053(.a(new_n88_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  ...
  aoi21  g067(.a(new_n108_), .b(new_n88_), .c(new_n63_), .O(new_n114_));
  ...
  nand2  g072(.a(new_n90_), .b(x11), .O(new_n119_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n107_), .c(new_n106_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n63_), .c(new_n106_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n99_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n115_), .c(new_n136_), .d(new_n86_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n97_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n108_), .d(new_n88_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n97_), .c(x16), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n125_), .c(new_n108_), .d(new_n88_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n90_), .b(x15), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n151_), .O(z16));
  nand2  g112(.a(new_n133_), .b(new_n63_), .O(new_n159_));
