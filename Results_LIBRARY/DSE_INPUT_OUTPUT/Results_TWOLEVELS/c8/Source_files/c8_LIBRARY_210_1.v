...
module FAU ( 
  ...
  nand4  g54(.a(new_n60_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n90_), .c(new_n98_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n88_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n90_), .c(new_n91_), .d(new_n63_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n90_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n54_), .O(new_n110_));
  ...
  aoi21  g67(.a(new_n111_), .b(new_n95_), .c(new_n73_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n109_), .c(new_n99_), .d(new_n85_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g72(.a(new_n48_), .b(new_n90_), .c(x13), .O(new_n119_));
  ...
  aoi22  g78(.a(new_n124_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n90_), .c(new_n121_), .O(z15));
  oai21  g80(.a(x18), .b(x15), .c(new_n90_), .O(new_n127_));
  ...
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n55_), .d(new_n85_), .O(new_n142_));
