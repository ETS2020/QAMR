...
module FAU ( 
  ...
  nand2  g049(.a(new_n70_), .b(x13), .O(new_n96_));
  ...
  oai21  g055(.a(new_n88_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g059(.a(new_n96_), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n85_), .O(z12));
  nand2  g076(.a(x18), .b(x04), .O(new_n123_));
  oai21  g077(.a(new_n96_), .b(new_n67_), .c(new_n123_), .O(new_n124_));
  ...
  oai21  g085(.a(new_n70_), .b(x05), .c(new_n90_), .O(new_n132_));
  inv1   g086(.a(x24), .O(new_n133_));
  aoi21  g087(.a(new_n127_), .b(new_n108_), .c(new_n133_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n118_), .c(new_n100_), .d(new_n86_), .O(new_n136_));
  ...
  nand3  g114(.a(new_n109_), .b(x19), .c(new_n86_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n51_), .d(new_n86_), .O(new_n162_));
