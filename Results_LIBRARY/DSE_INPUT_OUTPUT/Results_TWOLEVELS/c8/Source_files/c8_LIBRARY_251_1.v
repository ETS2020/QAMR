...
module FAU ( 
  ...
  nor2   g057(.a(new_n103_), .b(new_n55_), .O(new_n104_));
  ...
  oai22  g070(.a(new_n94_), .b(new_n116_), .c(x18), .d(new_n68_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n92_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n103_), .c(new_n55_), .O(new_n121_));
  ...
  nand4  g083(.a(new_n53_), .b(new_n71_), .c(new_n66_), .d(new_n63_), .O(new_n130_));
  ...
  nand3  g092(.a(new_n55_), .b(new_n47_), .c(new_n129_), .O(new_n139_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n88_), .c(new_n81_), .d(new_n78_), .O(new_n163_));
