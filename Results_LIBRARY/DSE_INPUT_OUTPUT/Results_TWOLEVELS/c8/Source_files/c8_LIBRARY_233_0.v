...
module FAU ( 
  ...
  inv1   g36(.a(new_n48_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n54_), .O(z08));
  ...
  nor2   g47(.a(new_n88_), .b(new_n53_), .O(new_n94_));
  ...
  nand4  g56(.a(new_n102_), .b(new_n53_), .c(new_n86_), .d(new_n85_), .O(new_n103_));
  ...
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n53_), .O(new_n110_));
  ...
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n54_), .d(new_n85_), .O(new_n144_));
