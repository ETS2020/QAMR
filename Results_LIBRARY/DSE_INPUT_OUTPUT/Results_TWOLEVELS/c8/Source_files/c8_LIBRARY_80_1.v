...
module FAU ( 
  ...
  nand2  g048(.a(x18), .b(x06), .O(new_n95_));
  ...
  oai21  g053(.a(new_n87_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  ...
  aoi21  g070(.a(new_n108_), .b(new_n87_), .c(new_n116_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n87_), .c(new_n54_), .O(new_n119_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n118_), .c(new_n98_), .d(new_n84_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n134_), .c(new_n83_), .O(z14));
  oai21  g094(.a(x18), .b(x14), .c(new_n89_), .O(new_n141_));
  nand2  g095(.a(new_n137_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n108_), .d(new_n87_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n83_), .O(z15));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n108_), .d(new_n87_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n143_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n158_));
  nand3  g112(.a(new_n108_), .b(x19), .c(new_n84_), .O(new_n159_));
