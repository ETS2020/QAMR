...
module FAU ( 
  ...
  nand2  g25(.a(new_n57_), .b(new_n71_), .O(new_n72_));
  ...
  nor2   g30(.a(new_n48_), .b(new_n57_), .O(z08));
  ...
  inv1   g36(.a(x18), .O(new_n83_));
  nor2   g37(.a(new_n83_), .b(x16), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(x00), .O(new_n85_));
  ...
  nand2  g44(.a(new_n84_), .b(x01), .O(new_n91_));
  nand2  g45(.a(new_n91_), .b(new_n90_), .O(z10));
  inv1   g46(.a(x16), .O(new_n93_));
  nor2   g47(.a(x20), .b(x19), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n78_), .O(new_n95_));
  nand4  g49(.a(new_n56_), .b(new_n87_), .c(new_n79_), .d(new_n78_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n95_), .b(x21), .c(new_n97_), .O(new_n98_));
  nand2  g52(.a(new_n84_), .b(x02), .O(new_n99_));
  oai21  g53(.a(new_n98_), .b(new_n93_), .c(new_n99_), .O(z11));
  oai21  g54(.a(new_n83_), .b(x03), .c(new_n93_), .O(new_n101_));
  nand2  g55(.a(new_n96_), .b(x22), .O(new_n102_));
  nor2   g56(.a(x22), .b(x21), .O(new_n103_));
  nand3  g57(.a(new_n103_), .b(new_n81_), .c(new_n87_), .O(new_n104_));
  and2   g58(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n93_), .c(new_n101_), .O(z12));
  oai21  g60(.a(new_n83_), .b(x04), .c(new_n93_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n89_), .c(new_n104_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n93_), .c(new_n107_), .O(z13));
  oai21  g64(.a(new_n83_), .b(x05), .c(new_n93_), .O(new_n111_));
  inv1   g65(.a(x24), .O(new_n112_));
  aoi21  g66(.a(new_n108_), .b(new_n89_), .c(new_n112_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n103_), .c(new_n94_), .d(new_n78_), .O(new_n115_));
  ...
  nand4  g74(.a(new_n71_), .b(new_n112_), .c(new_n120_), .d(new_n119_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n97_), .c(new_n115_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n84_), .b(x06), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n93_), .c(new_n124_), .O(z15));
  ...
  nand2  g88(.a(new_n84_), .b(x07), .O(new_n135_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n93_), .O(z17));
endmodule
