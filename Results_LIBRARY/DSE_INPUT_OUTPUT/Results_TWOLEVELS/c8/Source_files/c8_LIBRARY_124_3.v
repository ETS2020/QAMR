...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(new_n58_), .O(new_n93_));
  ...
  oai21  g055(.a(x18), .b(new_n87_), .c(x10), .O(new_n102_));
  ...
  nand3  g062(.a(x18), .b(new_n87_), .c(x02), .O(new_n109_));
  ...
  aoi21  g067(.a(new_n105_), .b(new_n85_), .c(new_n63_), .O(new_n114_));
  ...
  oai22  g074(.a(new_n93_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n104_), .c(new_n73_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n115_), .c(new_n97_), .d(new_n83_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n131_), .c(new_n47_), .O(z14));
  ...
  oai22  g102(.a(new_n93_), .b(new_n148_), .c(x18), .d(new_n79_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n105_), .d(new_n85_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n142_), .c(new_n73_), .O(new_n158_));
