...
module FAU ( 
  ...
  aoi21  g070(.a(new_n108_), .b(new_n86_), .c(new_n116_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n86_), .c(new_n54_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n115_), .c(new_n48_), .O(z12));
  ...
  aoi21  g088(.a(new_n127_), .b(new_n107_), .c(new_n69_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n118_), .c(new_n98_), .d(new_n83_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n134_), .c(new_n48_), .O(z14));
  inv1   g094(.a(new_n109_), .O(new_n141_));
  ...
  aoi22  g099(.a(new_n145_), .b(new_n141_), .c(new_n137_), .d(x25), .O(new_n146_));
  nor2   g100(.a(x18), .b(x16), .O(new_n147_));
  aoi21  g101(.a(new_n147_), .b(x14), .c(new_n49_), .O(new_n148_));
  oai21  g102(.a(new_n146_), .b(new_n88_), .c(new_n148_), .O(z15));
  ...
  nand4  g106(.a(new_n143_), .b(new_n142_), .c(new_n108_), .d(new_n86_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n142_), .c(new_n108_), .d(new_n86_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n152_), .c(new_n48_), .O(z16));
  nand4  g113(.a(new_n142_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n160_));
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n83_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n83_), .O(new_n162_));
