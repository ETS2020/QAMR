...
module FAU ( 
  ...
  nor2   g44(.a(new_n82_), .b(new_n90_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n97_), .b(new_n90_), .c(new_n50_), .d(new_n80_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n96_), .b(x21), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n85_), .b(x02), .O(new_n101_));
  oai21  g55(.a(new_n100_), .b(new_n88_), .c(new_n101_), .O(z11));
  oai21  g56(.a(new_n84_), .b(x03), .c(new_n88_), .O(new_n103_));
  nand2  g57(.a(new_n98_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n82_), .c(new_n90_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n88_), .c(new_n103_), .O(z12));
  oai21  g62(.a(new_n84_), .b(x04), .c(new_n88_), .O(new_n109_));
  ...
  aoi21  g67(.a(new_n110_), .b(new_n92_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n105_), .c(new_n95_), .d(new_n80_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n85_), .b(x05), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  oai21  g74(.a(new_n84_), .b(x06), .c(new_n88_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  nand4  g76(.a(new_n73_), .b(new_n113_), .c(new_n122_), .d(new_n62_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n99_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n88_), .c(new_n121_), .O(z15));
  ...
  aoi21  g94(.a(new_n140_), .b(new_n139_), .c(new_n88_), .O(z17));
endmodule
