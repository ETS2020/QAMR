...
module FAU ( 
  ...
  aoi22  g028(.a(new_n74_), .b(x00), .c(new_n51_), .d(x08), .O(new_n75_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n116_), .c(new_n96_), .d(new_n78_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n76_), .O(z16));
  nand4  g108(.a(new_n116_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n155_));
  nand3  g109(.a(new_n96_), .b(x19), .c(new_n125_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n47_), .d(new_n125_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n76_), .O(z17));
