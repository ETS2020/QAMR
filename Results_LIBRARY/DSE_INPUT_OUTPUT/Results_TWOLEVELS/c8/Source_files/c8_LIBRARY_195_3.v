...
module FAU ( 
  ...
  nand2  g055(.a(new_n94_), .b(x10), .O(new_n102_));
  ...
  nand2  g064(.a(new_n94_), .b(x11), .O(new_n111_));
  ...
  nand2  g072(.a(new_n94_), .b(x12), .O(new_n119_));
  ...
  nand2  g091(.a(new_n94_), .b(x14), .O(new_n138_));
  ...
  nand2  g097(.a(new_n135_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n133_), .c(new_n98_), .d(new_n90_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n143_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n142_), .O(z16));
  inv1   g103(.a(x23), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n105_), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  nand3  g106(.a(new_n75_), .b(new_n152_), .c(new_n122_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n98_), .b(x19), .c(new_n81_), .O(new_n155_));
  inv1   g109(.a(new_n155_), .O(new_n156_));
  nor2   g110(.a(new_n58_), .b(new_n81_), .O(new_n157_));
  aoi21  g111(.a(new_n156_), .b(new_n154_), .c(new_n157_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n143_), .c(new_n79_), .O(z17));
endmodule
