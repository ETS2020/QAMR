...
module FAU ( 
  ...
  nand3  g065(.a(new_n111_), .b(new_n97_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n106_), .O(z11));
  oai21  g067(.a(x16), .b(x03), .c(x18), .O(new_n114_));
  aoi21  g068(.a(new_n109_), .b(new_n98_), .c(new_n63_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n98_), .c(new_n54_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(new_n97_), .b(new_n85_), .c(x11), .O(new_n120_));
  ...
  aoi21  g085(.a(new_n126_), .b(new_n108_), .c(new_n73_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n116_), .c(new_n99_), .d(new_n87_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n97_), .b(new_n85_), .c(x13), .O(new_n137_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n109_), .d(new_n98_), .O(new_n154_));
  ...
  nand2  g111(.a(new_n68_), .b(new_n63_), .O(new_n158_));
  ...
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n87_), .O(new_n162_));
  inv1   g116(.a(new_n162_), .O(new_n163_));
  nor2   g117(.a(new_n55_), .b(new_n87_), .O(new_n164_));
  aoi21  g118(.a(new_n163_), .b(new_n161_), .c(new_n164_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n97_), .c(new_n85_), .O(z17));
endmodule
