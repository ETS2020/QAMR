...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n95_), .c(new_n98_), .O(new_n99_));
  ...
  nand2  g060(.a(new_n106_), .b(new_n96_), .O(new_n107_));
  ...
  aoi21  g065(.a(new_n106_), .b(new_n96_), .c(new_n65_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n96_), .c(new_n95_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nor2   g070(.a(x18), .b(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x11), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n116_), .c(new_n111_), .O(z12));
  ...
  nand2  g076(.a(new_n114_), .b(x23), .O(new_n123_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n106_), .d(new_n96_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n106_), .d(new_n96_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n117_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n142_), .c(new_n130_), .O(new_n157_));
  nand3  g111(.a(new_n106_), .b(x19), .c(new_n85_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n85_), .O(new_n159_));
