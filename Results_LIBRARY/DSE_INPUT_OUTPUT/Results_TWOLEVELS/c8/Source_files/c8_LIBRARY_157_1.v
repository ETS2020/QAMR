...
module FAU ( 
  ...
  inv1   g014(.a(new_n48_), .O(new_n61_));
  nand3  g015(.a(new_n61_), .b(x27), .c(new_n60_), .O(new_n62_));
  inv1   g016(.a(x21), .O(new_n63_));
  nand3  g017(.a(new_n52_), .b(new_n47_), .c(new_n63_), .O(new_n64_));
  ...
  aoi21  g025(.a(x27), .b(x21), .c(new_n47_), .O(new_n72_));
  oai22  g026(.a(new_n72_), .b(x13), .c(x27), .d(x24), .O(z05));
  ...
  nand2  g035(.a(new_n61_), .b(new_n52_), .O(z08));
  ...
  aoi21  g044(.a(new_n90_), .b(new_n86_), .c(new_n48_), .O(z09));
  ...
  nand3  g051(.a(new_n97_), .b(new_n94_), .c(new_n61_), .O(z10));
  ...
  nand4  g055(.a(new_n57_), .b(new_n51_), .c(new_n83_), .d(x16), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n47_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n63_), .O(new_n104_));
  inv1   g058(.a(new_n96_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(x21), .c(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n104_), .c(new_n101_), .O(z11));
  nand2  g061(.a(x18), .b(x03), .O(new_n108_));
  oai21  g062(.a(x18), .b(new_n66_), .c(new_n108_), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n61_), .c(new_n87_), .O(new_n110_));
  oai21  g064(.a(new_n96_), .b(x24), .c(new_n63_), .O(new_n111_));
  nor3   g065(.a(x24), .b(x22), .c(x21), .O(new_n112_));
  aoi22  g066(.a(new_n112_), .b(new_n96_), .c(new_n111_), .d(x22), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n87_), .c(new_n110_), .O(z12));
  nand2  g068(.a(x18), .b(x04), .O(new_n115_));
  oai21  g069(.a(x18), .b(new_n69_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n87_), .O(new_n117_));
  nand2  g071(.a(new_n85_), .b(x16), .O(new_n118_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n85_), .c(new_n57_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(x23), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n122_), .c(new_n117_), .O(z13));
  nand3  g080(.a(new_n119_), .b(new_n96_), .c(new_n63_), .O(new_n127_));
  ...
  aoi21  g086(.a(new_n132_), .b(new_n87_), .c(new_n48_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n129_), .O(z14));
  nand2  g088(.a(x18), .b(x06), .O(new_n135_));
  oai21  g089(.a(x18), .b(new_n74_), .c(new_n135_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n61_), .c(new_n87_), .O(new_n137_));
  nand3  g091(.a(new_n119_), .b(new_n85_), .c(new_n57_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x25), .b(x23), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n123_), .c(new_n96_), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n139_), .c(x24), .O(new_n142_));
  ...
  nand2  g099(.a(new_n145_), .b(new_n137_), .O(z15));
  ...
  nand3  g103(.a(new_n119_), .b(new_n79_), .c(new_n143_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n102_), .c(new_n47_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n63_), .O(new_n152_));
  nand3  g106(.a(new_n141_), .b(x26), .c(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n149_), .O(z16));
  nand4  g108(.a(new_n63_), .b(new_n57_), .c(x19), .d(new_n83_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n150_), .c(new_n52_), .d(new_n83_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n61_), .O(z17));
endmodule
