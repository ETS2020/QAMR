...
module FAU ( 
  ...
  nand4  g52(.a(new_n60_), .b(new_n91_), .c(new_n51_), .d(new_n83_), .O(new_n99_));
  ...
  nand3  g58(.a(new_n104_), .b(new_n85_), .c(new_n91_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand3  g60(.a(new_n47_), .b(new_n87_), .c(x11), .O(new_n107_));
  oai21  g61(.a(new_n106_), .b(new_n87_), .c(new_n107_), .O(z12));
  oai21  g62(.a(x18), .b(x12), .c(new_n87_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n93_), .c(new_n105_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n87_), .c(new_n109_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n87_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n93_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n104_), .c(new_n97_), .d(new_n83_), .O(new_n117_));
  ...
  oai21  g74(.a(x18), .b(x14), .c(new_n87_), .O(new_n121_));
  inv1   g75(.a(x22), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n114_), .c(new_n68_), .d(new_n122_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n87_), .c(new_n121_), .O(z15));
  ...
  nand3  g90(.a(new_n47_), .b(new_n87_), .c(x15), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  nor2   g92(.a(new_n51_), .b(x17), .O(new_n139_));
