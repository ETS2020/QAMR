...
module FAU ( 
  ...
  aoi21  g064(.a(new_n105_), .b(new_n87_), .c(new_n65_), .O(new_n111_));
  ...
  aoi21  g081(.a(new_n122_), .b(new_n104_), .c(new_n73_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n112_), .c(new_n96_), .d(new_n85_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n105_), .d(new_n87_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n105_), .d(new_n87_), .O(new_n149_));
