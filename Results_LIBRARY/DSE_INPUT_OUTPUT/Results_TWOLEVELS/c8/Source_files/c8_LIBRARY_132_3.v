...
module FAU ( 
  ...
  nor2   g037(.a(x16), .b(new_n49_), .O(new_n84_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n92_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n91_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n107_), .c(new_n101_), .O(z11));
  ...
  oai21  g073(.a(x16), .b(x04), .c(x18), .O(new_n120_));
  ...
  nand2  g079(.a(new_n108_), .b(x12), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n120_), .O(z13));
  oai21  g081(.a(x16), .b(x05), .c(x18), .O(new_n128_));
  aoi21  g082(.a(new_n122_), .b(new_n103_), .c(new_n71_), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n115_), .c(new_n96_), .d(new_n95_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n108_), .b(x13), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n133_), .c(new_n128_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n104_), .d(new_n94_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n92_), .c(x16), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n104_), .d(new_n94_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n92_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n140_), .c(new_n71_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n95_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n95_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n92_), .c(x16), .O(new_n159_));
