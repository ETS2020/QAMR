...
module FAU ( 
  ...
  oai21  g057(.a(new_n101_), .b(new_n60_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nor2   g059(.a(x18), .b(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(x10), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n105_), .c(new_n100_), .O(z11));
  ...
  nand3  g069(.a(new_n115_), .b(new_n92_), .c(x16), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n101_), .c(new_n60_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(new_n106_), .b(x12), .O(new_n124_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(new_n60_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n96_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n95_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n92_), .c(x16), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n102_), .d(new_n94_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n92_), .c(x16), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n102_), .d(new_n94_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n106_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n120_), .c(new_n71_), .O(new_n157_));
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n95_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n95_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n92_), .c(x16), .O(new_n160_));
