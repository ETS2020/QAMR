...
module FAU ( 
  ...
  nand3  g075(.a(new_n121_), .b(new_n104_), .c(new_n103_), .O(new_n122_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n63_), .c(new_n103_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n121_), .c(new_n105_), .d(new_n90_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n92_), .b(x06), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n121_), .c(new_n105_), .d(new_n90_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n121_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n155_));
  nand3  g109(.a(new_n105_), .b(x19), .c(new_n87_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n55_), .d(new_n87_), .O(new_n157_));
