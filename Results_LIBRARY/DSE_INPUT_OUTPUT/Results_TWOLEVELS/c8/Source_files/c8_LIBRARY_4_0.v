...
module FAU ( 
  ...
  oai21  g32(.a(x18), .b(x16), .c(new_n66_), .O(z08));
  ...
  aoi21  g67(.a(new_n111_), .b(new_n91_), .c(new_n65_), .O(new_n114_));
  ...
  nand4  g76(.a(new_n71_), .b(new_n65_), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n101_), .c(new_n116_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n93_), .b(x06), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n85_), .c(new_n126_), .O(z15));
  oai21  g81(.a(new_n86_), .b(x07), .c(new_n85_), .O(new_n128_));
  ...
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n85_), .O(z17));
endmodule
