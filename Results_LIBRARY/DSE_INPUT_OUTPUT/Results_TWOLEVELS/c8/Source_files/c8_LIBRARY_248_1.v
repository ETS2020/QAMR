...
module FAU ( 
  ...
  nor2   g33(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  nand4  g67(.a(new_n113_), .b(new_n106_), .c(new_n95_), .d(new_n81_), .O(new_n114_));
  ...
  oai21  g76(.a(new_n122_), .b(new_n86_), .c(new_n118_), .O(z15));
