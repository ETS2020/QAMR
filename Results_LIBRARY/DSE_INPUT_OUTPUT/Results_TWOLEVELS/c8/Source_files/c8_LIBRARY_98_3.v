...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n94_), .c(new_n52_), .O(z10));
  inv1   g052(.a(x04), .O(new_n99_));
  nand3  g053(.a(x18), .b(new_n99_), .c(x02), .O(new_n100_));
  ...
  aoi21  g065(.a(new_n104_), .b(new_n85_), .c(new_n65_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n85_), .c(new_n57_), .O(new_n114_));
  ...
  nand2  g071(.a(new_n114_), .b(x23), .O(new_n118_));
  nor2   g072(.a(x23), .b(x22), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n96_), .c(new_n103_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n52_), .c(x16), .O(new_n122_));
  inv1   g076(.a(x18), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n87_), .c(x12), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(z13));
  nand2  g079(.a(x18), .b(x05), .O(new_n126_));
  oai22  g080(.a(new_n126_), .b(x04), .c(x18), .d(new_n71_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n87_), .O(new_n128_));
  nand3  g082(.a(new_n57_), .b(new_n49_), .c(new_n83_), .O(new_n129_));
  inv1   g083(.a(x23), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n65_), .c(new_n103_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n129_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n104_), .d(new_n85_), .O(new_n144_));
  ...
  oai22  g102(.a(new_n148_), .b(x04), .c(x18), .d(new_n77_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n119_), .c(new_n104_), .d(new_n85_), .O(new_n153_));
