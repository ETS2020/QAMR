...
module FAU ( 
  ...
  aoi21  g035(.a(new_n69_), .b(new_n68_), .c(new_n54_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  nand2  g037(.a(x18), .b(x00), .O(new_n84_));
  nand2  g038(.a(new_n69_), .b(x13), .O(new_n85_));
  ...
  oai21  g049(.a(new_n85_), .b(new_n51_), .c(new_n95_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n90_), .b(new_n53_), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g058(.a(new_n85_), .b(new_n57_), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n90_), .c(new_n62_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n90_), .c(new_n53_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n88_), .O(z12));
  ...
  oai21  g085(.a(new_n69_), .b(x05), .c(new_n83_), .O(new_n132_));
  inv1   g086(.a(x24), .O(new_n133_));
  aoi21  g087(.a(new_n127_), .b(new_n108_), .c(new_n133_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n118_), .c(new_n99_), .d(new_n98_), .O(new_n136_));
  inv1   g090(.a(new_n136_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n134_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n132_), .c(new_n88_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  nand3  g094(.a(new_n69_), .b(x14), .c(x13), .O(new_n141_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n109_), .d(new_n90_), .O(new_n147_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n109_), .d(new_n90_), .O(new_n156_));
  ...
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n54_), .d(new_n98_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n88_), .O(z17));
endmodule
