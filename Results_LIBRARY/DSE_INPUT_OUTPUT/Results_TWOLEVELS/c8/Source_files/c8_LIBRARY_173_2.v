...
module FAU ( 
  ...
  oai21  g045(.a(x16), .b(x09), .c(new_n85_), .O(new_n92_));
  nor2   g046(.a(x19), .b(x17), .O(new_n93_));
  nor2   g047(.a(new_n93_), .b(new_n57_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  nor2   g050(.a(new_n85_), .b(x16), .O(new_n97_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n93_), .c(new_n57_), .O(new_n114_));
  ...
  nand2  g077(.a(new_n97_), .b(x04), .O(new_n124_));
  ...
  nand2  g088(.a(new_n97_), .b(x05), .O(new_n135_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n93_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n104_), .d(new_n93_), .O(new_n152_));
