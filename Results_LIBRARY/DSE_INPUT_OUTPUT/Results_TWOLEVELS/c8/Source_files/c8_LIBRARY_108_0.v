...
module FAU ( 
  ...
  oai21  g39(.a(new_n85_), .b(new_n78_), .c(new_n83_), .O(z09));
  ...
  oai21  g45(.a(new_n85_), .b(new_n87_), .c(new_n91_), .O(z10));
  inv1   g46(.a(x02), .O(new_n93_));
  nor2   g47(.a(x20), .b(x19), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n79_), .O(new_n95_));
  nand4  g49(.a(new_n56_), .b(new_n88_), .c(new_n80_), .d(new_n79_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n95_), .b(x21), .c(new_n97_), .O(new_n98_));
  oai22  g52(.a(new_n98_), .b(new_n84_), .c(new_n85_), .d(new_n93_), .O(z11));
  inv1   g53(.a(x03), .O(new_n100_));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n82_), .c(new_n96_), .d(x22), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n84_), .c(new_n85_), .d(new_n100_), .O(z12));
  inv1   g57(.a(x18), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(x04), .c(new_n84_), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n82_), .c(new_n88_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n90_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n84_), .c(new_n105_), .O(z13));
  oai21  g64(.a(new_n104_), .b(x05), .c(new_n84_), .O(new_n111_));
  inv1   g65(.a(x24), .O(new_n112_));
  aoi21  g66(.a(new_n108_), .b(new_n90_), .c(new_n112_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n106_), .c(new_n94_), .d(new_n79_), .O(new_n115_));
  ...
  oai21  g72(.a(new_n104_), .b(x06), .c(new_n84_), .O(new_n119_));
  ...
  aoi22  g77(.a(new_n123_), .b(new_n97_), .c(new_n115_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n84_), .c(new_n119_), .O(z15));
  oai21  g79(.a(new_n104_), .b(x07), .c(new_n84_), .O(new_n126_));
  ...
  nor2   g90(.a(new_n80_), .b(x17), .O(new_n137_));
