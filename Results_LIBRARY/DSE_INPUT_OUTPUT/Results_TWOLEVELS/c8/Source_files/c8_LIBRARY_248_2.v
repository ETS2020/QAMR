...
module FAU ( 
  ...
  oai21  g049(.a(new_n84_), .b(new_n92_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n84_), .c(new_n92_), .O(new_n114_));
  ...
  nand2  g077(.a(new_n86_), .b(x04), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n123_), .c(new_n118_), .O(z13));
  oai21  g079(.a(x16), .b(x13), .c(new_n81_), .O(new_n126_));
  aoi21  g080(.a(new_n120_), .b(new_n103_), .c(new_n69_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n113_), .c(new_n94_), .d(new_n93_), .O(new_n129_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n104_), .d(new_n84_), .O(new_n138_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n104_), .d(new_n84_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n136_), .c(new_n69_), .O(new_n153_));
  nand3  g107(.a(new_n104_), .b(x19), .c(new_n93_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n61_), .d(new_n93_), .O(new_n155_));
