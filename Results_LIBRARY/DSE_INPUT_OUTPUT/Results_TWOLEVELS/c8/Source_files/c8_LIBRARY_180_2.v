...
module FAU ( 
  ...
  nand2  g053(.a(new_n93_), .b(x01), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n99_), .c(new_n96_), .O(z10));
  oai21  g055(.a(x16), .b(x10), .c(new_n87_), .O(new_n102_));
  nor2   g056(.a(x21), .b(x20), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n91_), .O(new_n104_));
  oai21  g058(.a(new_n98_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  ...
  nand3  g082(.a(new_n57_), .b(new_n51_), .c(new_n89_), .O(new_n129_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n112_), .c(new_n132_), .d(new_n89_), .O(new_n134_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n120_), .c(new_n103_), .d(new_n91_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n120_), .c(new_n103_), .d(new_n91_), .O(new_n152_));
  ...
  nand2  g109(.a(new_n70_), .b(new_n110_), .O(new_n156_));
  inv1   g110(.a(x24), .O(new_n157_));
  nand3  g111(.a(new_n83_), .b(new_n78_), .c(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand3  g113(.a(new_n103_), .b(x19), .c(new_n89_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n52_), .b(new_n89_), .O(new_n162_));
