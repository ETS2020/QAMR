...
module FAU ( 
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n47_), .O(z10));
  inv1   g051(.a(x02), .O(new_n98_));
  nand2  g052(.a(x18), .b(new_n66_), .O(new_n99_));
  ...
  oai22  g062(.a(new_n99_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  ...
  oai21  g070(.a(x18), .b(new_n85_), .c(x12), .O(new_n117_));
  ...
  nand3  g076(.a(x18), .b(new_n85_), .c(x04), .O(new_n123_));
  ...
  aoi21  g081(.a(new_n119_), .b(new_n95_), .c(new_n71_), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n81_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n128_), .c(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n127_), .c(new_n47_), .O(z14));
  inv1   g088(.a(x06), .O(new_n135_));
  oai22  g089(.a(new_n99_), .b(new_n135_), .c(x18), .d(new_n74_), .O(new_n136_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n139_), .c(new_n71_), .O(new_n155_));
  ...
  nand2  g112(.a(new_n158_), .b(new_n47_), .O(z17));
endmodule
