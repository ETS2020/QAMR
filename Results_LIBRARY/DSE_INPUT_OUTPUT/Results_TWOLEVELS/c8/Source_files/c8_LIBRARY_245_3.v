...
module FAU ( 
  ...
  nand2  g063(.a(new_n91_), .b(x10), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n109_), .c(new_n103_), .O(z11));
  oai21  g065(.a(x16), .b(x03), .c(x18), .O(new_n112_));
  aoi21  g066(.a(new_n106_), .b(new_n89_), .c(new_n63_), .O(new_n113_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n63_), .c(new_n104_), .O(new_n132_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n98_), .c(x16), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n122_), .c(new_n106_), .d(new_n89_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n91_), .b(x14), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n122_), .c(new_n106_), .d(new_n89_), .O(new_n151_));
  ...
  nand4  g109(.a(new_n122_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n156_));
  nand3  g110(.a(new_n106_), .b(x19), .c(new_n86_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n55_), .d(new_n86_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n98_), .c(x16), .O(new_n159_));
