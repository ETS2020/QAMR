...
module FAU ( 
  ...
  nand4  g47(.a(new_n57_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  aoi21  g49(.a(new_n93_), .b(x21), .c(new_n95_), .O(new_n96_));
  oai22  g50(.a(new_n96_), .b(new_n84_), .c(new_n85_), .d(new_n55_), .O(z11));
  nor3   g51(.a(x22), .b(x21), .c(x20), .O(new_n98_));
  aoi22  g52(.a(new_n98_), .b(new_n82_), .c(new_n94_), .d(x22), .O(new_n99_));
  oai22  g53(.a(new_n99_), .b(new_n84_), .c(new_n85_), .d(new_n61_), .O(z12));
  oai21  g54(.a(x18), .b(x12), .c(new_n84_), .O(new_n101_));
  ...
  aoi22  g58(.a(new_n104_), .b(new_n89_), .c(new_n103_), .d(x23), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n84_), .c(new_n101_), .O(z13));
  oai21  g60(.a(x18), .b(x13), .c(new_n84_), .O(new_n107_));
  inv1   g61(.a(x24), .O(new_n108_));
  aoi21  g62(.a(new_n104_), .b(new_n89_), .c(new_n108_), .O(new_n109_));
  nor2   g63(.a(x24), .b(x23), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n102_), .c(new_n92_), .d(new_n79_), .O(new_n111_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n66_), .d(new_n116_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  aoi22  g73(.a(new_n119_), .b(new_n95_), .c(new_n111_), .d(x25), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n84_), .c(new_n115_), .O(z15));
  oai21  g75(.a(x18), .b(x15), .c(new_n84_), .O(new_n122_));
  nor2   g76(.a(x21), .b(x20), .O(new_n123_));
  nor2   g77(.a(x23), .b(x22), .O(new_n124_));
  nor2   g78(.a(x25), .b(x24), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n82_), .O(new_n126_));
  nand2  g80(.a(new_n126_), .b(x26), .O(new_n127_));
  nor3   g81(.a(x26), .b(x25), .c(x24), .O(new_n128_));
  nand4  g82(.a(new_n128_), .b(new_n124_), .c(new_n123_), .d(new_n82_), .O(new_n129_));
  nand2  g83(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x16), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(new_n122_), .O(z16));
  nor2   g86(.a(new_n80_), .b(x17), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n128_), .c(new_n124_), .d(new_n123_), .O(new_n134_));
  nand2  g88(.a(x27), .b(x17), .O(new_n135_));
  aoi21  g89(.a(new_n135_), .b(new_n134_), .c(new_n84_), .O(z17));
endmodule
