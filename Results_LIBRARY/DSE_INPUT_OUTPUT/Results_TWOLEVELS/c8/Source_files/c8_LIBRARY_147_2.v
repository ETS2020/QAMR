...
module FAU ( 
  ...
  oai21  g024(.a(x27), .b(new_n70_), .c(new_n47_), .O(new_n71_));
  nand3  g025(.a(new_n52_), .b(new_n70_), .c(x18), .O(new_n72_));
  nand2  g026(.a(new_n72_), .b(new_n71_), .O(z04));
  ...
  aoi22  g045(.a(new_n87_), .b(x09), .c(x18), .d(x01), .O(new_n92_));
  ...
  oai21  g050(.a(new_n93_), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n85_), .c(x16), .O(new_n98_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n93_), .c(new_n57_), .O(new_n116_));
  ...
  aoi22  g074(.a(new_n120_), .b(new_n104_), .c(new_n116_), .d(x23), .O(new_n121_));
  inv1   g075(.a(x18), .O(new_n122_));
  nor2   g076(.a(new_n122_), .b(x16), .O(new_n123_));
  aoi21  g077(.a(new_n123_), .b(x04), .c(new_n48_), .O(new_n124_));
  oai21  g078(.a(new_n121_), .b(new_n100_), .c(new_n124_), .O(z13));
  ...
  nand3  g100(.a(new_n122_), .b(x15), .c(new_n47_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n100_), .O(new_n149_));
  nand2  g103(.a(new_n142_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n105_), .d(new_n93_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n85_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n140_), .c(new_n129_), .O(new_n157_));
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n94_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n94_), .O(new_n159_));
