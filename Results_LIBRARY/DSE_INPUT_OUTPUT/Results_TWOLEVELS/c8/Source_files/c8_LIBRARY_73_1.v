...
module FAU ( 
  ...
  oai21  g081(.a(x18), .b(x14), .c(new_n47_), .O(new_n128_));
  nand4  g082(.a(new_n83_), .b(new_n78_), .c(new_n71_), .d(new_n66_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  aoi22  g084(.a(new_n130_), .b(new_n108_), .c(new_n123_), .d(x25), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n47_), .c(new_n128_), .O(z15));
