...
module FAU ( 
  ...
  aoi21  g020(.a(new_n66_), .b(new_n64_), .c(new_n55_), .O(z03));
  ...
  oai21  g059(.a(x18), .b(new_n52_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n53_), .O(z11));
  ...
  oai22  g078(.a(new_n115_), .b(new_n124_), .c(x18), .d(new_n68_), .O(new_n125_));
  ...
  nand3  g089(.a(new_n58_), .b(new_n47_), .c(new_n89_), .O(new_n136_));
  ...
  nand4  g116(.a(new_n128_), .b(new_n83_), .c(new_n80_), .d(new_n75_), .O(new_n163_));
