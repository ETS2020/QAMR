...
module FAU ( 
  ...
  oai21  g049(.a(x18), .b(x08), .c(new_n47_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n95_), .O(z09));
  oai21  g051(.a(x18), .b(x09), .c(new_n47_), .O(new_n98_));
  ...
  nand4  g058(.a(new_n63_), .b(new_n58_), .c(new_n52_), .d(new_n92_), .O(new_n105_));
  inv1   g059(.a(new_n105_), .O(new_n106_));
  aoi21  g060(.a(new_n104_), .b(x21), .c(new_n106_), .O(new_n107_));
  nor2   g061(.a(x18), .b(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x10), .O(new_n109_));
  oai21  g063(.a(new_n107_), .b(new_n47_), .c(new_n109_), .O(z11));
  oai21  g064(.a(x18), .b(x11), .c(new_n47_), .O(new_n111_));
  nand2  g065(.a(new_n105_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n94_), .c(new_n58_), .O(new_n114_));
  and2   g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n47_), .c(new_n111_), .O(z12));
  oai21  g070(.a(x18), .b(x12), .c(new_n47_), .O(new_n117_));
  nor3   g071(.a(x23), .b(x22), .c(x21), .O(new_n118_));
  aoi22  g072(.a(new_n118_), .b(new_n100_), .c(new_n114_), .d(x23), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n47_), .c(new_n117_), .O(z13));
  aoi21  g074(.a(new_n118_), .b(new_n100_), .c(new_n76_), .O(new_n121_));
  nor2   g075(.a(x24), .b(x23), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n113_), .c(new_n103_), .d(new_n92_), .O(new_n123_));
  inv1   g077(.a(new_n123_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n121_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n108_), .b(x13), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n125_), .O(z14));
  nand4  g081(.a(new_n83_), .b(new_n76_), .c(new_n71_), .d(new_n66_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n106_), .c(new_n123_), .d(x25), .O(new_n130_));
  nand2  g084(.a(new_n108_), .b(x14), .O(new_n131_));
  oai21  g085(.a(new_n130_), .b(new_n47_), .c(new_n131_), .O(z15));
  oai21  g086(.a(x18), .b(x15), .c(new_n47_), .O(new_n133_));
  nor2   g087(.a(x21), .b(x20), .O(new_n134_));
  nor2   g088(.a(x23), .b(x22), .O(new_n135_));
  nor2   g089(.a(x25), .b(x24), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n94_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x26), .O(new_n138_));
  nor3   g092(.a(x26), .b(x25), .c(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n135_), .c(new_n134_), .d(new_n94_), .O(new_n140_));
  ...
  nand4  g097(.a(new_n135_), .b(new_n88_), .c(new_n83_), .d(new_n76_), .O(new_n144_));
  nand3  g098(.a(new_n134_), .b(x19), .c(new_n92_), .O(new_n145_));
  oai22  g099(.a(new_n145_), .b(new_n144_), .c(new_n53_), .d(new_n92_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n48_), .O(z17));
endmodule
