...
module FAU ( 
  ...
  nor2   g033(.a(x27), .b(x26), .O(new_n80_));
  aoi21  g034(.a(x27), .b(new_n79_), .c(new_n80_), .O(new_n81_));
  nand2  g035(.a(new_n80_), .b(x15), .O(new_n82_));
  oai21  g036(.a(new_n81_), .b(new_n78_), .c(new_n82_), .O(z07));
  aoi21  g037(.a(new_n78_), .b(new_n79_), .c(new_n54_), .O(z08));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n89_), .c(new_n64_), .O(new_n114_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n85_), .O(z13));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n100_), .c(new_n72_), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n115_), .c(new_n133_), .d(new_n86_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n132_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n131_), .c(new_n85_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  nand3  g093(.a(new_n78_), .b(x15), .c(x14), .O(new_n140_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n106_), .d(new_n89_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n85_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n142_), .O(z15));
  oai21  g103(.a(new_n78_), .b(x07), .c(new_n91_), .O(new_n150_));
  nand2  g104(.a(new_n146_), .b(x26), .O(new_n151_));
  nor3   g105(.a(x26), .b(x25), .c(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n144_), .c(new_n106_), .d(new_n89_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n144_), .c(new_n72_), .O(new_n158_));
  nand3  g112(.a(new_n106_), .b(x19), .c(new_n86_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n54_), .d(new_n86_), .O(new_n160_));
