...
module FAU ( 
  ...
  nand3  g038(.a(new_n84_), .b(x08), .c(x07), .O(new_n85_));
  ...
  nor2   g051(.a(new_n90_), .b(new_n53_), .O(new_n98_));
  ...
  nand3  g056(.a(new_n84_), .b(x10), .c(x07), .O(new_n103_));
  ...
  aoi21  g069(.a(new_n107_), .b(new_n90_), .c(new_n115_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n90_), .c(new_n53_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n114_), .c(new_n88_), .O(z12));
  nand2  g075(.a(x18), .b(x04), .O(new_n122_));
  nand3  g076(.a(new_n84_), .b(x12), .c(x07), .O(new_n123_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n99_), .c(new_n106_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n88_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  nand2  g085(.a(x18), .b(x05), .O(new_n132_));
  nand3  g086(.a(new_n84_), .b(x13), .c(x07), .O(new_n133_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n127_), .c(new_n107_), .d(new_n90_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n88_), .O(z16));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n127_), .c(new_n70_), .O(new_n166_));
  nand3  g120(.a(new_n107_), .b(x19), .c(new_n136_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n54_), .d(new_n136_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n88_), .c(x16), .O(new_n169_));
