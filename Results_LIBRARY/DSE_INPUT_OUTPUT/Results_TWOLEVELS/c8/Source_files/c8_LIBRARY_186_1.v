...
module FAU ( 
  ...
  nand3  g028(.a(new_n74_), .b(x27), .c(new_n73_), .O(new_n75_));
  inv1   g029(.a(x24), .O(new_n76_));
  nand3  g030(.a(new_n52_), .b(new_n47_), .c(new_n76_), .O(new_n77_));
  nand2  g031(.a(new_n77_), .b(new_n75_), .O(z05));
  aoi21  g032(.a(x27), .b(x24), .c(new_n47_), .O(new_n79_));
  oai22  g033(.a(new_n79_), .b(x14), .c(x27), .d(x25), .O(z06));
  inv1   g034(.a(x15), .O(new_n81_));
  aoi21  g035(.a(x27), .b(new_n81_), .c(new_n48_), .O(new_n82_));
  oai21  g036(.a(x27), .b(x26), .c(new_n82_), .O(z07));
  nand2  g037(.a(new_n74_), .b(new_n52_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n74_), .O(z09));
  ...
  nand3  g062(.a(new_n108_), .b(new_n103_), .c(new_n74_), .O(z11));
  ...
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n74_), .O(z12));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n74_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(x18), .b(new_n73_), .c(new_n128_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n74_), .c(new_n89_), .O(new_n130_));
  ...
  aoi21  g088(.a(new_n134_), .b(new_n131_), .c(x23), .O(new_n135_));
  aoi21  g089(.a(new_n123_), .b(new_n132_), .c(new_n76_), .O(new_n136_));
  ...
  nand2  g093(.a(new_n133_), .b(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n106_), .c(new_n47_), .O(new_n141_));
  ...
  aoi21  g099(.a(new_n145_), .b(new_n89_), .c(new_n48_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n142_), .O(z15));
  ...
  nand3  g104(.a(new_n132_), .b(new_n85_), .c(x16), .O(new_n151_));
  nor2   g105(.a(x26), .b(x23), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n114_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n151_), .c(new_n47_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n76_), .O(new_n155_));
  nand4  g109(.a(new_n114_), .b(new_n98_), .c(new_n76_), .d(new_n70_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(x26), .c(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n155_), .c(new_n150_), .O(z16));
  nand3  g112(.a(new_n74_), .b(x27), .c(x17), .O(new_n159_));
  nor2   g113(.a(new_n51_), .b(x17), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n160_), .c(new_n139_), .d(new_n105_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n159_), .c(new_n89_), .O(z17));
endmodule
