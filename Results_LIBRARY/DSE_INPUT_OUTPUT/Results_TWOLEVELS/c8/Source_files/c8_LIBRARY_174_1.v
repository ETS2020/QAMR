...
module FAU ( 
  ...
  nor2   g056(.a(new_n95_), .b(new_n56_), .O(new_n103_));
  ...
  oai22  g078(.a(new_n91_), .b(new_n124_), .c(x18), .d(new_n73_), .O(new_n125_));
  ...
  nand2  g084(.a(new_n130_), .b(new_n126_), .O(z13));
  nand2  g085(.a(x18), .b(x05), .O(new_n132_));
  oai21  g086(.a(x18), .b(new_n76_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n89_), .O(new_n134_));
  aoi21  g088(.a(new_n127_), .b(new_n104_), .c(new_n78_), .O(new_n135_));
  inv1   g089(.a(x17), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n119_), .c(new_n137_), .d(new_n136_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n110_), .d(new_n95_), .O(new_n148_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n47_), .c(new_n152_), .O(z15));
  ...
  nand3  g112(.a(new_n158_), .b(new_n146_), .c(new_n78_), .O(new_n159_));
  ...
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n136_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n53_), .d(new_n136_), .O(new_n164_));
