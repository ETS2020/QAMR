...
module FAU ( 
  ...
  aoi22  g62(.a(new_n108_), .b(new_n92_), .c(new_n105_), .d(x23), .O(new_n109_));
  nor2   g63(.a(new_n86_), .b(x16), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x04), .O(new_n111_));
  oai21  g65(.a(new_n109_), .b(new_n85_), .c(new_n111_), .O(z13));
  aoi21  g66(.a(new_n108_), .b(new_n92_), .c(new_n70_), .O(new_n113_));
