...
module FAU ( 
  ...
  oai21  g057(.a(new_n100_), .b(new_n58_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n53_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n99_), .O(z10));
  inv1   g060(.a(x02), .O(new_n107_));
  oai22  g061(.a(new_n91_), .b(new_n107_), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  oai22  g070(.a(new_n91_), .b(new_n116_), .c(x18), .d(new_n66_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n89_), .O(new_n118_));
  nand2  g072(.a(new_n112_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n100_), .c(new_n58_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n91_), .b(new_n125_), .c(x18), .d(new_n73_), .O(new_n126_));
  ...
  oai22  g097(.a(new_n91_), .b(new_n143_), .c(x18), .d(new_n83_), .O(new_n144_));
