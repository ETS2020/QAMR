...
module FAU ( 
  ...
  nor2   g49(.a(new_n88_), .b(new_n95_), .O(new_n96_));
  ...
  nand4  g55(.a(new_n59_), .b(new_n95_), .c(new_n50_), .d(new_n86_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  nor2   g58(.a(new_n91_), .b(x16), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x02), .O(new_n106_));
  oai21  g60(.a(new_n104_), .b(new_n90_), .c(new_n106_), .O(z11));
  nand2  g61(.a(new_n102_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n95_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g65(.a(new_n105_), .b(x03), .O(new_n112_));
  oai21  g66(.a(new_n111_), .b(new_n90_), .c(new_n112_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n97_), .c(new_n110_), .d(x23), .O(new_n115_));
  nand2  g69(.a(new_n105_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n90_), .c(new_n116_), .O(z13));
  aoi21  g71(.a(new_n114_), .b(new_n97_), .c(new_n72_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n109_), .c(new_n100_), .d(new_n86_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n105_), .b(x05), .O(new_n123_));
  ...
  nand2  g82(.a(new_n105_), .b(x06), .O(new_n129_));
  oai21  g83(.a(new_n128_), .b(new_n90_), .c(new_n129_), .O(z15));
  nor2   g84(.a(x21), .b(x20), .O(new_n131_));
  nor2   g85(.a(x23), .b(x22), .O(new_n132_));
  nor2   g86(.a(x25), .b(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n88_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x26), .O(new_n135_));
  nor3   g89(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n132_), .c(new_n131_), .d(new_n88_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n105_), .b(x07), .O(new_n140_));
  ...
  aoi21  g98(.a(new_n144_), .b(new_n143_), .c(new_n90_), .O(z17));
endmodule
