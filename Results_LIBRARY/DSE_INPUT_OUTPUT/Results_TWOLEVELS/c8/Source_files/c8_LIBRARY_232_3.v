...
module FAU ( 
  ...
  oai22  g059(.a(new_n97_), .b(new_n105_), .c(x18), .d(new_n61_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n84_), .O(new_n107_));
  nand2  g061(.a(new_n101_), .b(x22), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n82_), .c(new_n90_), .O(new_n110_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n116_), .c(new_n48_), .O(z13));
  ...
  aoi21  g080(.a(new_n118_), .b(new_n92_), .c(new_n126_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n125_), .c(new_n48_), .O(z14));
  inv1   g088(.a(x06), .O(new_n135_));
  oai22  g089(.a(new_n97_), .b(new_n135_), .c(x18), .d(new_n72_), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n100_), .d(new_n82_), .O(new_n141_));
  ...
  oai22  g099(.a(new_n97_), .b(new_n145_), .c(x18), .d(new_n75_), .O(new_n146_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n139_), .c(new_n100_), .d(new_n82_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n139_), .c(new_n126_), .O(new_n155_));
  nand3  g109(.a(new_n100_), .b(x19), .c(new_n128_), .O(new_n156_));
