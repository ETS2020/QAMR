...
module FAU ( 
  ...
  nand2  g035(.a(new_n61_), .b(new_n81_), .O(new_n82_));
  aoi21  g036(.a(new_n82_), .b(new_n80_), .c(new_n49_), .O(z07));
  nor2   g037(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  oai21  g067(.a(x18), .b(new_n58_), .c(new_n113_), .O(new_n114_));
  ...
  oai21  g075(.a(x16), .b(x12), .c(new_n85_), .O(new_n122_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n108_), .d(new_n88_), .O(new_n153_));
  ...
  nand2  g110(.a(new_n66_), .b(new_n60_), .O(new_n157_));
  nand3  g111(.a(new_n81_), .b(new_n76_), .c(new_n71_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n97_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n61_), .b(new_n97_), .O(new_n162_));
