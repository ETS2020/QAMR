...
module FAU ( 
  ...
  nand4  g48(.a(new_n57_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n94_), .b(x21), .c(new_n96_), .O(new_n97_));
  oai22  g51(.a(new_n97_), .b(new_n92_), .c(new_n85_), .d(new_n55_), .O(z11));
  oai21  g52(.a(x18), .b(x11), .c(new_n92_), .O(new_n99_));
  nand2  g53(.a(new_n95_), .b(x22), .O(new_n100_));
  nor2   g54(.a(x22), .b(x21), .O(new_n101_));
  nand3  g55(.a(new_n101_), .b(new_n82_), .c(new_n87_), .O(new_n102_));
  and2   g56(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n92_), .c(new_n99_), .O(z12));
  oai21  g58(.a(x18), .b(x12), .c(new_n92_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n89_), .c(new_n102_), .d(x23), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n92_), .c(new_n105_), .O(z13));
  oai21  g62(.a(x18), .b(x13), .c(new_n92_), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n106_), .b(new_n89_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n101_), .c(new_n93_), .d(new_n79_), .O(new_n113_));
  ...
  nand4  g72(.a(new_n72_), .b(new_n110_), .c(new_n118_), .d(new_n117_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n96_), .c(new_n113_), .d(x25), .O(new_n121_));
  nand2  g75(.a(new_n84_), .b(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n92_), .c(new_n122_), .O(z15));
