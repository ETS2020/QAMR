...
module FAU ( 
  ...
  nand3  g024(.a(new_n52_), .b(new_n68_), .c(new_n70_), .O(new_n71_));
  ...
  nand2  g037(.a(x18), .b(new_n67_), .O(new_n84_));
  ...
  nand3  g051(.a(new_n97_), .b(new_n92_), .c(new_n47_), .O(z10));
  ...
  nand2  g080(.a(new_n70_), .b(x13), .O(new_n127_));
  oai21  g081(.a(new_n84_), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n82_), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  nand3  g084(.a(new_n93_), .b(new_n51_), .c(new_n130_), .O(new_n131_));
  inv1   g085(.a(x22), .O(new_n132_));
  inv1   g086(.a(x23), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n132_), .c(new_n102_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n112_), .c(new_n136_), .d(new_n130_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n147_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n121_), .c(new_n103_), .d(new_n94_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n121_), .c(new_n68_), .O(new_n161_));
  nand3  g115(.a(new_n103_), .b(x19), .c(new_n130_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n130_), .O(new_n163_));
