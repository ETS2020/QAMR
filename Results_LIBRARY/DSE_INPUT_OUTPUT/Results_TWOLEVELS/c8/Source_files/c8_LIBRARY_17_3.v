...
module FAU ( 
  ...
  nand3  g036(.a(new_n55_), .b(new_n80_), .c(new_n82_), .O(new_n83_));
  ...
  nand2  g041(.a(x18), .b(new_n79_), .O(new_n88_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n133_), .c(new_n48_), .O(z14));
  ...
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n48_), .O(z15));
  inv1   g104(.a(x07), .O(new_n151_));
  nand2  g105(.a(new_n82_), .b(x15), .O(new_n152_));
  oai21  g106(.a(new_n88_), .b(new_n151_), .c(new_n152_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n145_), .c(new_n108_), .d(new_n97_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n145_), .b(new_n80_), .c(new_n76_), .d(new_n134_), .O(new_n161_));
  nand3  g115(.a(new_n108_), .b(x19), .c(new_n98_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n98_), .O(new_n163_));
