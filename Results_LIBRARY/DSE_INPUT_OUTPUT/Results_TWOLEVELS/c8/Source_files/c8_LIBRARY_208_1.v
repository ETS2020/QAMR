...
module FAU ( 
  ...
  nand4  g54(.a(new_n100_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n99_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n97_), .c(new_n91_), .d(new_n58_), .O(z11));
  ...
  oai22  g66(.a(new_n112_), .b(new_n97_), .c(new_n91_), .d(new_n66_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n97_), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n94_), .c(new_n73_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n107_), .c(new_n98_), .d(new_n85_), .O(new_n117_));
  ...
  nand4  g74(.a(new_n78_), .b(new_n73_), .c(new_n68_), .d(new_n63_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n90_), .b(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n97_), .c(new_n124_), .O(z15));
  ...
  nand2  g88(.a(new_n90_), .b(x15), .O(new_n135_));
  ...
  nand3  g93(.a(new_n126_), .b(x19), .c(new_n85_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n55_), .d(new_n85_), .O(new_n141_));
