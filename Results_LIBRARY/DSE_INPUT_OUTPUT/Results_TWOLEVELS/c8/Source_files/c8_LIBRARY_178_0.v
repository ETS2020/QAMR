...
module FAU ( 
  ...
  nand3  g043(.a(new_n89_), .b(new_n85_), .c(new_n82_), .O(z09));
  ...
  oai21  g052(.a(new_n84_), .b(new_n53_), .c(new_n98_), .O(new_n99_));
  ...
  nand3  g056(.a(new_n92_), .b(x10), .c(x04), .O(new_n103_));
  ...
  oai21  g062(.a(new_n106_), .b(new_n59_), .c(new_n108_), .O(new_n109_));
  ...
  nand3  g066(.a(new_n92_), .b(x11), .c(x04), .O(new_n113_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n84_), .c(new_n53_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n82_), .c(x16), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n115_), .O(z12));
  nand2  g075(.a(new_n92_), .b(new_n67_), .O(new_n122_));
  ...
  aoi21  g086(.a(new_n125_), .b(new_n106_), .c(new_n72_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n117_), .c(new_n97_), .d(new_n96_), .O(new_n135_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n107_), .d(new_n84_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n92_), .b(x15), .c(x04), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n143_), .c(new_n107_), .d(new_n84_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n143_), .c(new_n72_), .O(new_n160_));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n96_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n54_), .d(new_n96_), .O(new_n162_));
