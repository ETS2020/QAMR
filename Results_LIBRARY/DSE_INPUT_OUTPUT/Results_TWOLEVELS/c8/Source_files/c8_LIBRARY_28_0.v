...
module FAU ( 
  ...
  oai21  g027(.a(x27), .b(x26), .c(new_n73_), .O(z07));
  inv1   g028(.a(new_n48_), .O(new_n75_));
  nand2  g029(.a(new_n75_), .b(new_n60_), .O(z08));
  inv1   g030(.a(x16), .O(new_n77_));
  nand2  g031(.a(x18), .b(x00), .O(new_n78_));
  inv1   g032(.a(x18), .O(new_n79_));
  nand3  g033(.a(new_n79_), .b(x08), .c(x06), .O(new_n80_));
  ...
  nand3  g040(.a(new_n86_), .b(new_n75_), .c(x16), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(new_n82_), .O(z09));
  nand2  g042(.a(x18), .b(x01), .O(new_n89_));
  oai21  g043(.a(x18), .b(new_n51_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n91_), .c(new_n75_), .O(z10));
  nand2  g050(.a(x18), .b(x02), .O(new_n97_));
  nand3  g051(.a(new_n79_), .b(x10), .c(x06), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n77_), .O(new_n100_));
  inv1   g054(.a(x21), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n84_), .O(new_n103_));
  oai21  g057(.a(new_n94_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n75_), .c(x16), .O(new_n105_));
  ...
  aoi21  g063(.a(new_n102_), .b(new_n84_), .c(new_n59_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n92_), .O(new_n112_));
  nor2   g066(.a(new_n112_), .b(new_n85_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n75_), .O(z12));
  nand2  g069(.a(x18), .b(x04), .O(new_n116_));
  nand3  g070(.a(new_n79_), .b(x12), .c(x06), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n77_), .O(new_n119_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n75_), .c(x16), .O(new_n124_));
  ...
  nand2  g081(.a(new_n127_), .b(new_n77_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n128_), .c(new_n75_), .O(z14));
  inv1   g091(.a(x06), .O(new_n138_));
  aoi21  g092(.a(new_n79_), .b(new_n69_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n134_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x23), .b(x22), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n102_), .d(new_n84_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  aoi21  g098(.a(new_n144_), .b(x16), .c(new_n139_), .O(new_n145_));
  nand3  g099(.a(new_n144_), .b(x18), .c(x16), .O(new_n146_));
  oai21  g100(.a(new_n145_), .b(new_n138_), .c(new_n146_), .O(z15));
  ...
  nand3  g106(.a(new_n152_), .b(new_n141_), .c(new_n129_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n103_), .c(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n75_), .O(z16));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n131_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n153_), .c(new_n60_), .d(new_n131_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n75_), .O(z17));
endmodule
