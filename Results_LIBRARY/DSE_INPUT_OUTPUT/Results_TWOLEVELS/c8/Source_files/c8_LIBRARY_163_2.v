...
module FAU ( 
  ...
  nand3  g049(.a(new_n95_), .b(new_n91_), .c(x16), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n90_), .O(z09));
  nand2  g051(.a(x18), .b(x01), .O(new_n98_));
  nand3  g052(.a(new_n87_), .b(x09), .c(new_n52_), .O(new_n99_));
  ...
  oai21  g059(.a(new_n93_), .b(new_n102_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n91_), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n101_), .O(z10));
  nand3  g062(.a(new_n87_), .b(x10), .c(new_n52_), .O(new_n109_));
  oai21  g063(.a(new_n87_), .b(new_n52_), .c(new_n109_), .O(new_n110_));
  ...
  aoi21  g075(.a(new_n113_), .b(new_n93_), .c(new_n121_), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n93_), .c(new_n102_), .O(new_n124_));
  inv1   g078(.a(new_n124_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n122_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n120_), .c(new_n91_), .O(z12));
  nand2  g081(.a(x18), .b(x04), .O(new_n128_));
  nand3  g082(.a(new_n87_), .b(x12), .c(new_n52_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n85_), .O(new_n131_));
  nand2  g085(.a(new_n124_), .b(x23), .O(new_n132_));
  nor3   g086(.a(x23), .b(x22), .c(x21), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n112_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n91_), .c(x16), .O(new_n136_));
  ...
  aoi21  g094(.a(new_n133_), .b(new_n112_), .c(new_n73_), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n104_), .d(new_n103_), .O(new_n143_));
  inv1   g097(.a(new_n143_), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n141_), .c(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n140_), .c(new_n91_), .O(z14));
  ...
  nand4  g106(.a(new_n152_), .b(new_n151_), .c(new_n113_), .d(new_n93_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n149_), .c(new_n91_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  nand3  g111(.a(new_n87_), .b(x15), .c(new_n52_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n85_), .O(new_n160_));
  nand2  g114(.a(new_n153_), .b(x26), .O(new_n161_));
  nor3   g115(.a(x26), .b(x25), .c(x24), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n151_), .c(new_n113_), .d(new_n93_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n91_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n160_), .O(z16));
  nor2   g120(.a(x26), .b(x25), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n151_), .c(new_n73_), .O(new_n168_));
  nand3  g122(.a(new_n113_), .b(x19), .c(new_n103_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n168_), .c(new_n50_), .d(new_n103_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(x16), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n91_), .O(z17));
endmodule
