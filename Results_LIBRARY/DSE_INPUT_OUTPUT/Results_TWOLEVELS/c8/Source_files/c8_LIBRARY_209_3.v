...
module FAU ( 
  ...
  nand3  g050(.a(new_n54_), .b(new_n85_), .c(new_n84_), .O(new_n97_));
  oai21  g051(.a(new_n87_), .b(new_n54_), .c(new_n97_), .O(new_n98_));
  ...
  nand2  g077(.a(new_n89_), .b(x12), .O(new_n124_));
  ...
  nand2  g081(.a(new_n127_), .b(new_n92_), .O(new_n128_));
  inv1   g082(.a(x23), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n63_), .c(new_n102_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n97_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n112_), .c(new_n132_), .d(new_n84_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n96_), .c(x16), .O(new_n136_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n120_), .c(new_n104_), .d(new_n87_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n96_), .c(x16), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n120_), .c(new_n104_), .d(new_n87_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n89_), .b(x15), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n147_), .O(z16));
  inv1   g108(.a(x24), .O(new_n155_));
  nand4  g109(.a(new_n120_), .b(new_n79_), .c(new_n74_), .d(new_n155_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n84_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n55_), .d(new_n84_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n96_), .c(x16), .O(new_n159_));
