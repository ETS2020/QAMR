...
module FAU ( 
  ...
  nand2  g34(.a(new_n80_), .b(new_n52_), .O(z08));
  inv1   g35(.a(x17), .O(new_n82_));
  nor2   g36(.a(new_n51_), .b(new_n82_), .O(new_n83_));
  ...
  nand2  g46(.a(new_n47_), .b(new_n86_), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n55_), .c(new_n92_), .O(z10));
  oai21  g48(.a(x18), .b(x10), .c(new_n86_), .O(new_n95_));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n82_), .O(new_n97_));
  inv1   g51(.a(x21), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n89_), .c(new_n51_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n86_), .c(new_n95_), .O(z11));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n84_), .c(new_n99_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n86_), .c(new_n93_), .d(new_n61_), .O(z12));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n84_), .c(new_n89_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n91_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n86_), .c(new_n93_), .d(new_n66_), .O(z13));
  oai21  g64(.a(x18), .b(x13), .c(new_n86_), .O(new_n111_));
  aoi21  g65(.a(new_n108_), .b(new_n91_), .c(new_n71_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n106_), .c(new_n96_), .d(new_n82_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n71_), .c(new_n119_), .d(new_n63_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n100_), .c(new_n114_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n86_), .c(new_n118_), .O(z15));
  ...
  nand3  g90(.a(new_n136_), .b(new_n127_), .c(new_n71_), .O(new_n137_));
  nand3  g91(.a(new_n126_), .b(x19), .c(new_n82_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n52_), .d(new_n82_), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n80_), .O(z17));
endmodule
