...
module FAU ( 
  ...
  nand4  g55(.a(new_n59_), .b(new_n92_), .c(new_n50_), .d(new_n84_), .O(new_n102_));
  ...
  aoi21  g69(.a(new_n113_), .b(new_n94_), .c(new_n72_), .O(new_n116_));
  ...
  nand4  g95(.a(new_n132_), .b(new_n80_), .c(new_n124_), .d(new_n72_), .O(new_n142_));
