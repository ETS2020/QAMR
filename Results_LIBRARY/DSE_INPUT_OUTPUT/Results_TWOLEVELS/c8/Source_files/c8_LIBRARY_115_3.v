...
module FAU ( 
  ...
  nand3  g054(.a(new_n54_), .b(new_n89_), .c(new_n88_), .O(new_n101_));
  oai21  g055(.a(new_n91_), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n100_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n107_), .O(z11));
  oai21  g067(.a(x16), .b(x03), .c(x18), .O(new_n114_));
  inv1   g068(.a(x22), .O(new_n115_));
  aoi21  g069(.a(new_n109_), .b(new_n91_), .c(new_n115_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n54_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g074(.a(new_n93_), .b(x11), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n114_), .O(z12));
  ...
  nand3  g081(.a(new_n127_), .b(new_n108_), .c(new_n60_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n100_), .c(x16), .O(new_n130_));
  ...
  nand3  g088(.a(new_n68_), .b(new_n115_), .c(new_n60_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n101_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n117_), .c(new_n137_), .d(new_n88_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n100_), .c(x16), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n127_), .c(new_n109_), .d(new_n91_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n100_), .c(x16), .O(new_n150_));
