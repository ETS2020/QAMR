...
module FAU ( 
  ...
  oai21  g060(.a(new_n106_), .b(new_n57_), .c(new_n104_), .O(new_n107_));
  ...
  aoi21  g065(.a(new_n111_), .b(new_n109_), .c(new_n105_), .O(new_n112_));
  nor2   g066(.a(new_n59_), .b(new_n85_), .O(new_n113_));
  ...
  oai21  g085(.a(new_n131_), .b(new_n98_), .c(x18), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n85_), .O(new_n133_));
  nand3  g087(.a(new_n121_), .b(new_n87_), .c(new_n120_), .O(new_n134_));
  ...
  oai21  g091(.a(new_n106_), .b(new_n70_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n89_), .O(new_n139_));
  nand3  g093(.a(new_n130_), .b(new_n97_), .c(new_n59_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x24), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n121_), .c(new_n97_), .d(new_n85_), .O(new_n143_));
  aoi21  g097(.a(new_n143_), .b(new_n141_), .c(new_n105_), .O(new_n144_));
  nor2   g098(.a(new_n72_), .b(new_n85_), .O(new_n145_));
  ...
  nand3  g104(.a(new_n110_), .b(new_n50_), .c(x16), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  nand3  g106(.a(new_n130_), .b(new_n152_), .c(new_n72_), .O(new_n153_));
  ...
  nand4  g114(.a(new_n130_), .b(new_n80_), .c(new_n152_), .d(new_n72_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n151_), .c(x18), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n85_), .O(new_n163_));
  ...
  nand3  g120(.a(new_n110_), .b(x19), .c(new_n85_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n161_), .c(new_n51_), .d(new_n85_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n83_), .O(z17));
endmodule
