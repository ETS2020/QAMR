...
module FAU ( 
  ...
  nand2  g042(.a(x18), .b(x07), .O(new_n89_));
  oai22  g043(.a(new_n89_), .b(new_n88_), .c(x18), .d(new_n52_), .O(new_n90_));
  ...
  oai21  g049(.a(new_n81_), .b(new_n92_), .c(new_n95_), .O(new_n96_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n81_), .c(new_n92_), .O(new_n114_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(new_n79_), .O(z14));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n81_), .O(new_n143_));
  ...
  oai21  g100(.a(x18), .b(x15), .c(new_n83_), .O(new_n147_));
  nand2  g101(.a(new_n143_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n141_), .c(new_n104_), .d(new_n81_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n141_), .c(new_n130_), .O(new_n155_));
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n93_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n61_), .d(new_n93_), .O(new_n157_));
