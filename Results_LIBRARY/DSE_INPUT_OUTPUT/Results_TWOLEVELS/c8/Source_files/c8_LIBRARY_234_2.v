...
module FAU ( 
  ...
  nand2  g033(.a(new_n79_), .b(new_n55_), .O(z08));
  nor2   g034(.a(x18), .b(x10), .O(new_n81_));
  aoi22  g035(.a(new_n81_), .b(x08), .c(x18), .d(x00), .O(new_n82_));
  xnor2a g036(.a(x19), .b(x17), .O(new_n83_));
  nand3  g037(.a(new_n83_), .b(new_n79_), .c(x16), .O(new_n84_));
  oai21  g038(.a(new_n82_), .b(x16), .c(new_n84_), .O(z09));
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n79_), .O(z10));
  nor2   g048(.a(x21), .b(x20), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n90_), .O(new_n96_));
  oai21  g050(.a(new_n92_), .b(new_n58_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n79_), .c(x16), .O(new_n98_));
  nand3  g052(.a(x18), .b(new_n86_), .c(x02), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n98_), .O(z11));
  nand2  g054(.a(x18), .b(x03), .O(new_n101_));
  inv1   g055(.a(x18), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(x11), .c(new_n48_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n86_), .O(new_n105_));
  nand2  g059(.a(new_n96_), .b(x22), .O(new_n106_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n79_), .c(x16), .O(new_n110_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n123_), .c(new_n79_), .O(z14));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n95_), .d(new_n90_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n79_), .O(z15));
  nand2  g096(.a(x18), .b(x07), .O(new_n143_));
  nand3  g097(.a(new_n102_), .b(x15), .c(new_n48_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n95_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n79_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n137_), .c(new_n124_), .O(new_n154_));
  nand3  g108(.a(new_n95_), .b(x19), .c(new_n126_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n55_), .d(new_n126_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n79_), .O(z17));
endmodule
