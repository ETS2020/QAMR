...
module FAU ( 
  ...
  oai21  g059(.a(x16), .b(x11), .c(new_n81_), .O(new_n106_));
  inv1   g060(.a(x22), .O(new_n107_));
  aoi21  g061(.a(new_n101_), .b(new_n86_), .c(new_n107_), .O(new_n108_));
  ...
  nand2  g066(.a(new_n88_), .b(x03), .O(new_n113_));
  ...
  nand2  g074(.a(new_n88_), .b(x04), .O(new_n121_));
  ...
  nand2  g084(.a(new_n88_), .b(x05), .O(new_n131_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n101_), .d(new_n86_), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n137_), .c(new_n101_), .d(new_n86_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n88_), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  nand2  g104(.a(new_n66_), .b(new_n107_), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  nand3  g106(.a(new_n77_), .b(new_n152_), .c(new_n124_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n101_), .b(x19), .c(new_n83_), .O(new_n155_));
  inv1   g109(.a(new_n155_), .O(new_n156_));
  nor2   g110(.a(new_n55_), .b(new_n83_), .O(new_n157_));
