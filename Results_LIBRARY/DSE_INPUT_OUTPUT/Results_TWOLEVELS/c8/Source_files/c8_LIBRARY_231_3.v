...
module FAU ( 
  ...
  nand3  g026(.a(new_n55_), .b(new_n70_), .c(new_n72_), .O(new_n73_));
  ...
  nand2  g038(.a(new_n48_), .b(new_n55_), .O(z08));
  inv1   g039(.a(x16), .O(new_n86_));
  inv1   g040(.a(x00), .O(new_n87_));
  nand2  g041(.a(x18), .b(new_n69_), .O(new_n88_));
  ...
  nor2   g053(.a(new_n92_), .b(new_n54_), .O(new_n100_));
  nor3   g054(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  oai21  g055(.a(new_n101_), .b(new_n100_), .c(x16), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n99_), .c(new_n48_), .O(z10));
  ...
  nand3  g072(.a(new_n118_), .b(new_n92_), .c(new_n54_), .O(new_n119_));
  ...
  oai22  g077(.a(new_n88_), .b(new_n123_), .c(x18), .d(new_n64_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n86_), .O(new_n125_));
  nand2  g079(.a(new_n119_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n101_), .c(new_n107_), .O(new_n128_));
  ...
  nand2  g086(.a(new_n72_), .b(x13), .O(new_n133_));
  oai21  g087(.a(new_n88_), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n86_), .O(new_n135_));
  inv1   g089(.a(x17), .O(new_n136_));
  inv1   g090(.a(x19), .O(new_n137_));
  nand3  g091(.a(new_n54_), .b(new_n137_), .c(new_n136_), .O(new_n138_));
  nand3  g092(.a(new_n66_), .b(new_n116_), .c(new_n107_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n138_), .c(x24), .O(new_n140_));
  nor2   g094(.a(x20), .b(x19), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n118_), .c(new_n141_), .d(new_n136_), .O(new_n143_));
  ...
  oai22  g101(.a(new_n88_), .b(new_n147_), .c(x18), .d(new_n75_), .O(new_n148_));
  ...
  oai21  g110(.a(x18), .b(new_n80_), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n86_), .O(new_n158_));
  ...
  nand4  g118(.a(new_n127_), .b(new_n82_), .c(new_n77_), .d(new_n70_), .O(new_n165_));
  nand3  g119(.a(new_n108_), .b(x19), .c(new_n136_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n55_), .d(new_n136_), .O(new_n167_));
