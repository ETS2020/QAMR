...
module FAU ( 
  ...
  nor2   g45(.a(new_n85_), .b(new_n57_), .O(new_n92_));
  nor3   g46(.a(x20), .b(x19), .c(x17), .O(new_n93_));
  oai21  g47(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n91_), .O(z10));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n83_), .O(new_n97_));
  inv1   g51(.a(x21), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n57_), .c(new_n51_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n90_), .c(new_n88_), .d(new_n60_), .O(z11));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n85_), .c(new_n99_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n90_), .c(new_n88_), .d(new_n63_), .O(z12));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n85_), .c(new_n57_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n93_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n90_), .c(new_n88_), .d(new_n66_), .O(z13));
  aoi21  g64(.a(new_n108_), .b(new_n93_), .c(new_n71_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n106_), .c(new_n96_), .d(new_n83_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g69(.a(new_n87_), .b(x13), .O(new_n116_));
  nand2  g70(.a(new_n116_), .b(new_n115_), .O(z14));
  inv1   g71(.a(x22), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  nand4  g73(.a(new_n76_), .b(new_n71_), .c(new_n119_), .d(new_n118_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n100_), .c(new_n113_), .d(x25), .O(new_n122_));
  nand2  g76(.a(new_n87_), .b(x14), .O(new_n123_));
