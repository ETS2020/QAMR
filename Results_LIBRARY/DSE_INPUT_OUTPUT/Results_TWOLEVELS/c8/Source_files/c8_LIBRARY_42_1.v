...
module FAU ( 
  ...
  nor2   g047(.a(new_n85_), .b(new_n93_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n83_), .O(z10));
  ...
  nand3  g059(.a(new_n105_), .b(new_n100_), .c(new_n83_), .O(z11));
  ...
  aoi21  g063(.a(new_n102_), .b(new_n85_), .c(new_n60_), .O(new_n110_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n83_), .O(z12));
  nand3  g069(.a(x18), .b(x04), .c(x00), .O(new_n116_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n83_), .c(x16), .O(new_n123_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n127_), .c(new_n83_), .O(z14));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n102_), .d(new_n85_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n139_), .c(new_n83_), .O(z15));
  nand3  g100(.a(x18), .b(x07), .c(x00), .O(new_n147_));
  oai21  g101(.a(x18), .b(new_n75_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n79_), .O(new_n149_));
  nand2  g103(.a(new_n143_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n102_), .d(new_n85_), .O(new_n152_));
