...
module FAU ( 
  ...
  oai21  g060(.a(new_n97_), .b(new_n60_), .c(new_n106_), .O(new_n107_));
  ...
  aoi21  g082(.a(new_n123_), .b(new_n97_), .c(new_n71_), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n113_), .c(new_n130_), .d(new_n87_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n129_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n99_), .b(x05), .O(new_n135_));
  ...
  nand2  g106(.a(new_n99_), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n147_), .O(z16));
  inv1   g108(.a(x23), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n111_), .O(new_n156_));
