...
module FAU ( 
  ...
  nor2   g49(.a(new_n91_), .b(new_n54_), .O(new_n96_));
  ...
  oai21  g54(.a(new_n100_), .b(new_n52_), .c(new_n98_), .O(z10));
  ...
  oai22  g60(.a(new_n106_), .b(new_n93_), .c(new_n100_), .d(new_n58_), .O(z11));
  oai21  g61(.a(x18), .b(x11), .c(new_n93_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n112_), .b(new_n93_), .c(new_n108_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n97_), .c(new_n111_), .d(x23), .O(new_n115_));
  oai22  g69(.a(new_n115_), .b(new_n93_), .c(new_n100_), .d(new_n66_), .O(z13));
  aoi21  g70(.a(new_n114_), .b(new_n97_), .c(new_n73_), .O(new_n117_));
  ...
  nand2  g75(.a(new_n99_), .b(x13), .O(new_n122_));
  ...
  oai21  g83(.a(x18), .b(x15), .c(new_n93_), .O(new_n130_));
