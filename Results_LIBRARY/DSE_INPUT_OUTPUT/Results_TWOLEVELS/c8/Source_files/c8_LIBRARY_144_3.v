...
module FAU ( 
  ...
  aoi21  g065(.a(new_n106_), .b(new_n86_), .c(new_n65_), .O(new_n112_));
  ...
  aoi21  g082(.a(new_n123_), .b(new_n105_), .c(new_n73_), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n113_), .c(new_n97_), .d(new_n84_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n106_), .d(new_n86_), .O(new_n140_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n138_), .c(new_n106_), .d(new_n86_), .O(new_n150_));
  ...
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n84_), .O(new_n160_));
