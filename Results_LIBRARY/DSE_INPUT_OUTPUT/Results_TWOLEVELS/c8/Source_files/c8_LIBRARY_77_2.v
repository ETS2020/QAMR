...
module FAU ( 
  ...
  nor2   g034(.a(x18), .b(x11), .O(new_n81_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n98_), .c(new_n79_), .O(z11));
  nand2  g058(.a(new_n101_), .b(x22), .O(new_n105_));
  nor2   g059(.a(x22), .b(x21), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n91_), .c(new_n90_), .O(new_n107_));
  and2   g061(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  inv1   g062(.a(x18), .O(new_n109_));
  nor2   g063(.a(new_n109_), .b(x16), .O(new_n110_));
  aoi21  g064(.a(new_n110_), .b(x03), .c(new_n49_), .O(new_n111_));
  oai21  g065(.a(new_n108_), .b(new_n86_), .c(new_n111_), .O(z12));
  ...
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n79_), .O(z13));
  ...
  aoi21  g078(.a(new_n117_), .b(new_n93_), .c(new_n68_), .O(new_n125_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n124_), .c(new_n79_), .O(z14));
  ...
  nand3  g097(.a(new_n109_), .b(x15), .c(new_n48_), .O(new_n144_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n137_), .c(new_n68_), .O(new_n154_));
  nand3  g108(.a(new_n100_), .b(x19), .c(new_n126_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n63_), .d(new_n126_), .O(new_n156_));
