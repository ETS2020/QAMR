...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x03), .O(new_n48_));
  ...
  nand2  g031(.a(new_n48_), .b(new_n61_), .O(z08));
  ...
  nor2   g044(.a(new_n80_), .b(new_n90_), .O(new_n91_));
  nor3   g045(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(new_n48_), .O(z10));
  inv1   g048(.a(x03), .O(new_n95_));
  nand3  g049(.a(x18), .b(new_n95_), .c(x02), .O(new_n96_));
  ...
  oai21  g055(.a(new_n92_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n80_), .c(new_n90_), .O(new_n107_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n82_), .c(x11), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n109_), .O(z12));
  nand2  g066(.a(x18), .b(x04), .O(new_n113_));
  oai22  g067(.a(new_n113_), .b(x03), .c(x18), .d(new_n64_), .O(new_n114_));
  ...
  aoi21  g079(.a(new_n117_), .b(new_n92_), .c(new_n125_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n106_), .c(new_n128_), .d(new_n127_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n126_), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n124_), .c(new_n48_), .O(z14));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n100_), .d(new_n80_), .O(new_n140_));
  ...
  oai22  g098(.a(new_n144_), .b(x03), .c(x18), .d(new_n75_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n82_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n100_), .d(new_n80_), .O(new_n149_));
  ...
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n61_), .d(new_n127_), .O(new_n156_));
