...
module FAU ( 
  ...
  nor2   g001(.a(x25), .b(new_n47_), .O(new_n48_));
  ...
  aoi21  g026(.a(x27), .b(x25), .c(new_n47_), .O(new_n73_));
  oai22  g027(.a(new_n73_), .b(x13), .c(x27), .d(x24), .O(z05));
  inv1   g028(.a(x14), .O(new_n75_));
  inv1   g029(.a(new_n48_), .O(new_n76_));
  nand3  g030(.a(new_n76_), .b(x27), .c(new_n75_), .O(new_n77_));
  inv1   g031(.a(x25), .O(new_n78_));
  nand3  g032(.a(new_n52_), .b(new_n78_), .c(new_n47_), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n77_), .O(z06));
  inv1   g034(.a(x15), .O(new_n81_));
  aoi21  g035(.a(x27), .b(new_n81_), .c(new_n48_), .O(new_n82_));
  oai21  g036(.a(x27), .b(x26), .c(new_n82_), .O(z07));
  nand2  g037(.a(new_n76_), .b(new_n52_), .O(z08));
  ...
  nand3  g046(.a(new_n92_), .b(new_n88_), .c(new_n76_), .O(z09));
  ...
  nor2   g050(.a(new_n87_), .b(new_n57_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  aoi21  g053(.a(new_n99_), .b(new_n96_), .c(new_n48_), .O(z10));
  nor2   g054(.a(x18), .b(new_n60_), .O(new_n101_));
  aoi21  g055(.a(x18), .b(x02), .c(new_n101_), .O(new_n102_));
  inv1   g056(.a(x21), .O(new_n103_));
  nor2   g057(.a(x21), .b(x20), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n87_), .O(new_n105_));
  oai21  g059(.a(new_n98_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(x16), .c(new_n48_), .O(new_n107_));
  oai21  g061(.a(new_n102_), .b(x16), .c(new_n107_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  oai21  g063(.a(x18), .b(new_n63_), .c(new_n109_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n89_), .O(new_n111_));
  aoi21  g065(.a(new_n104_), .b(new_n87_), .c(new_n65_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n57_), .O(new_n114_));
  nor3   g068(.a(new_n114_), .b(x19), .c(x17), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n76_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n68_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n89_), .O(new_n120_));
  nor3   g074(.a(x23), .b(x22), .c(x21), .O(new_n121_));
  nand4  g075(.a(new_n121_), .b(new_n57_), .c(new_n51_), .d(new_n85_), .O(new_n122_));
  oai21  g076(.a(new_n115_), .b(new_n70_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n120_), .c(new_n76_), .O(z13));
  inv1   g079(.a(x13), .O(new_n126_));
  nand2  g080(.a(x18), .b(x05), .O(new_n127_));
  oai21  g081(.a(x18), .b(new_n126_), .c(new_n127_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n76_), .c(new_n89_), .O(new_n129_));
  nand2  g083(.a(new_n121_), .b(new_n98_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x25), .O(new_n131_));
  nand4  g085(.a(new_n113_), .b(new_n98_), .c(new_n47_), .d(new_n70_), .O(new_n132_));
  oai21  g086(.a(new_n131_), .b(new_n47_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n129_), .O(z14));
  nand2  g089(.a(x18), .b(x06), .O(new_n136_));
  oai21  g090(.a(x18), .b(new_n75_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n89_), .O(new_n138_));
  nand2  g092(.a(x25), .b(new_n47_), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n70_), .c(new_n65_), .d(new_n103_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n57_), .c(new_n51_), .d(new_n85_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n131_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n76_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  oai21  g100(.a(x18), .b(new_n81_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n89_), .O(new_n148_));
  nand4  g102(.a(new_n57_), .b(new_n51_), .c(new_n85_), .d(x16), .O(new_n149_));
  nor2   g103(.a(x26), .b(x23), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n113_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n149_), .c(new_n47_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n78_), .O(new_n153_));
  nand4  g107(.a(new_n113_), .b(new_n98_), .c(new_n78_), .d(new_n70_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(x26), .c(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n153_), .c(new_n148_), .O(z16));
  nand3  g110(.a(new_n76_), .b(x27), .c(x17), .O(new_n157_));
  nor2   g111(.a(x23), .b(x22), .O(new_n158_));
  nor2   g112(.a(new_n51_), .b(x17), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n159_), .c(new_n158_), .d(new_n104_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n157_), .c(new_n89_), .O(z17));
endmodule
