...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n90_), .c(new_n51_), .d(new_n83_), .O(new_n100_));
  ...
  oai22  g59(.a(new_n105_), .b(new_n95_), .c(new_n88_), .d(new_n61_), .O(z12));
  oai21  g60(.a(x18), .b(x12), .c(new_n95_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n111_), .b(new_n95_), .c(new_n107_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n95_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n92_), .c(new_n71_), .O(new_n114_));
  ...
  aoi22  g76(.a(new_n122_), .b(new_n101_), .c(new_n116_), .d(x25), .O(new_n123_));
  ...
  nand2  g88(.a(new_n87_), .b(x15), .O(new_n135_));
