...
module FAU ( 
  ...
  nand2  g059(.a(new_n97_), .b(x10), .O(new_n106_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n93_), .c(new_n92_), .O(new_n114_));
  ...
  nand2  g076(.a(new_n122_), .b(new_n95_), .O(new_n123_));
  ...
  aoi21  g081(.a(new_n122_), .b(new_n95_), .c(new_n73_), .O(new_n128_));
  ...
  nand2  g088(.a(new_n97_), .b(x13), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n102_), .d(new_n93_), .O(new_n141_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n139_), .c(new_n102_), .d(new_n93_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n139_), .c(new_n73_), .O(new_n155_));
  nand3  g109(.a(new_n102_), .b(x19), .c(new_n129_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n129_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n111_), .c(x16), .O(new_n158_));
