...
module FAU ( 
  ...
  oai21  g45(.a(x18), .b(x09), .c(new_n91_), .O(new_n92_));
  ...
  nand4  g53(.a(new_n60_), .b(new_n93_), .c(new_n51_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n91_), .c(new_n89_), .d(new_n58_), .O(z11));
  oai21  g57(.a(x18), .b(x11), .c(new_n91_), .O(new_n104_));
  ...
  oai21  g62(.a(new_n108_), .b(new_n91_), .c(new_n104_), .O(z12));
  ...
  oai21  g66(.a(new_n112_), .b(new_n91_), .c(new_n110_), .O(z13));
  oai21  g67(.a(x18), .b(x13), .c(new_n91_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n95_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n115_), .c(new_n68_), .d(new_n122_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n101_), .c(new_n118_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n88_), .b(x14), .O(new_n127_));
  ...
  nand2  g91(.a(new_n88_), .b(x15), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  nand4  g93(.a(new_n130_), .b(new_n79_), .c(new_n123_), .d(new_n115_), .O(new_n140_));
