...
module FAU ( 
  ...
  aoi21  g068(.a(new_n107_), .b(new_n91_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n91_), .c(new_n99_), .O(new_n117_));
  ...
  oai22  g075(.a(new_n87_), .b(new_n121_), .c(x18), .d(new_n68_), .O(new_n122_));
  ...
  oai21  g083(.a(x18), .b(new_n85_), .c(x13), .O(new_n130_));
  aoi21  g084(.a(new_n125_), .b(new_n101_), .c(new_n72_), .O(new_n131_));
  ...
  nand3  g091(.a(x18), .b(new_n85_), .c(x05), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n137_), .c(new_n130_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n91_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n47_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n107_), .d(new_n91_), .O(new_n155_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n144_), .c(new_n72_), .O(new_n160_));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n132_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n132_), .O(new_n162_));
