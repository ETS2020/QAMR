...
module FAU ( 
  ...
  nor2   g062(.a(x18), .b(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x10), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n108_), .c(new_n103_), .O(z11));
  oai21  g065(.a(x16), .b(x03), .c(x18), .O(new_n112_));
  aoi21  g066(.a(new_n105_), .b(new_n98_), .c(new_n65_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n98_), .c(new_n97_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n109_), .b(x11), .O(new_n118_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n104_), .c(new_n60_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g079(.a(new_n109_), .b(x12), .O(new_n126_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n134_), .d(new_n87_), .O(new_n136_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n122_), .c(new_n105_), .d(new_n98_), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n122_), .c(new_n105_), .d(new_n98_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand2  g108(.a(new_n109_), .b(x15), .O(new_n155_));
  ...
  nand3  g112(.a(new_n81_), .b(new_n158_), .c(new_n73_), .O(new_n159_));
  ...
  aoi21  g118(.a(new_n164_), .b(new_n96_), .c(new_n85_), .O(z17));
endmodule
