...
module FAU ( 
  ...
  nand2  g036(.a(new_n76_), .b(x15), .O(new_n83_));
  ...
  nor2   g046(.a(new_n92_), .b(new_n53_), .O(new_n93_));
  ...
  oai21  g051(.a(new_n83_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g078(.a(new_n83_), .b(new_n68_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n81_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  inv1   g081(.a(x19), .O(new_n128_));
  nand3  g082(.a(new_n53_), .b(new_n128_), .c(new_n127_), .O(new_n129_));
  inv1   g083(.a(x23), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n62_), .c(new_n100_), .O(new_n131_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n79_), .c(x16), .O(new_n137_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n141_), .c(new_n79_), .O(z15));
  ...
  nand4  g106(.a(new_n152_), .b(new_n119_), .c(new_n101_), .d(new_n92_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n79_), .c(x16), .O(new_n155_));
  ...
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n54_), .d(new_n127_), .O(new_n161_));
