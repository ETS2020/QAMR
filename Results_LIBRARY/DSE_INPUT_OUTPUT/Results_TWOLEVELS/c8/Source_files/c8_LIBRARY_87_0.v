...
module FAU ( 
  ...
  nand4  g50(.a(new_n96_), .b(new_n53_), .c(new_n81_), .d(new_n80_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n95_), .b(x21), .c(new_n98_), .O(new_n99_));
  nand3  g53(.a(x18), .b(new_n85_), .c(x02), .O(new_n100_));
  oai21  g54(.a(new_n99_), .b(new_n85_), .c(new_n100_), .O(z11));
  oai21  g55(.a(new_n86_), .b(x03), .c(new_n85_), .O(new_n102_));
  nand2  g56(.a(new_n97_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n83_), .c(new_n53_), .O(new_n105_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n113_), .c(new_n65_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n98_), .c(new_n116_), .d(x25), .O(new_n124_));
  nand3  g78(.a(x18), .b(new_n85_), .c(x06), .O(new_n125_));
  oai21  g79(.a(new_n124_), .b(new_n85_), .c(new_n125_), .O(z15));
  oai21  g80(.a(new_n86_), .b(x07), .c(new_n85_), .O(new_n127_));
  ...
  nand4  g92(.a(new_n129_), .b(new_n76_), .c(new_n121_), .d(new_n113_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n80_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n54_), .d(new_n80_), .O(new_n141_));
