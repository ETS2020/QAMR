...
module FAU ( 
  ...
  nor2   g001(.a(x03), .b(x02), .O(new_n48_));
  ...
  nand2  g022(.a(new_n57_), .b(new_n68_), .O(new_n69_));
  ...
  aoi21  g051(.a(new_n97_), .b(new_n93_), .c(new_n48_), .O(z10));
  oai21  g052(.a(x18), .b(x10), .c(x02), .O(new_n99_));
  inv1   g053(.a(x18), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(x10), .c(x03), .O(new_n101_));
  ...
  oai21  g059(.a(new_n96_), .b(new_n56_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n79_), .c(x16), .O(new_n107_));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n96_), .c(new_n68_), .O(new_n130_));
  nand3  g084(.a(new_n94_), .b(new_n82_), .c(new_n81_), .O(new_n131_));
  nand4  g085(.a(new_n68_), .b(new_n121_), .c(new_n112_), .d(new_n56_), .O(new_n132_));
  nor2   g086(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n129_), .c(new_n48_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n104_), .d(new_n84_), .O(new_n142_));
  oai21  g096(.a(new_n133_), .b(new_n139_), .c(new_n142_), .O(new_n143_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n104_), .d(new_n84_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n148_), .c(new_n48_), .O(z16));
  nand2  g108(.a(new_n150_), .b(new_n140_), .O(new_n155_));
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n81_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n57_), .d(new_n81_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n79_), .c(x16), .O(new_n158_));
