...
module FAU ( 
  ...
  nor2   g041(.a(new_n65_), .b(new_n48_), .O(z08));
  ...
  aoi21  g066(.a(new_n112_), .b(x16), .c(new_n65_), .O(new_n113_));
  ...
  oai21  g081(.a(new_n121_), .b(new_n118_), .c(x23), .O(new_n128_));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n109_), .c(new_n76_), .O(new_n137_));
  ...
  oai22  g098(.a(new_n99_), .b(new_n143_), .c(x18), .d(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n93_), .O(new_n146_));
  nor2   g100(.a(x18), .b(x17), .O(new_n147_));
  nor3   g101(.a(x25), .b(x24), .c(x23), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n120_), .d(new_n102_), .O(new_n149_));
  oai21  g103(.a(new_n140_), .b(new_n52_), .c(new_n149_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z15));
  inv1   g106(.a(x07), .O(new_n153_));
  oai22  g107(.a(new_n99_), .b(new_n153_), .c(x18), .d(new_n85_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n93_), .O(new_n155_));
  nand2  g109(.a(new_n139_), .b(x26), .O(new_n156_));
  nor2   g110(.a(x23), .b(x22), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n157_), .c(new_n110_), .d(new_n91_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n156_), .c(x18), .O(new_n160_));
  nor2   g114(.a(new_n83_), .b(new_n52_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n160_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n155_), .O(z16));
  nand2  g117(.a(new_n158_), .b(new_n157_), .O(new_n164_));
  nand3  g118(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n48_), .d(new_n89_), .O(new_n166_));
