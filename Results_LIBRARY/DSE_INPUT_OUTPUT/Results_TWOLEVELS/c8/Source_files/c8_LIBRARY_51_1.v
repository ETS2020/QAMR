...
module FAU ( 
  ...
  nor2   g034(.a(x27), .b(x18), .O(new_n81_));
  oai22  g035(.a(new_n81_), .b(x14), .c(x27), .d(x25), .O(z06));
  ...
  aoi21  g040(.a(new_n86_), .b(new_n84_), .c(new_n60_), .O(z07));
  ...
  nand2  g052(.a(x18), .b(x14), .O(new_n99_));
  ...
  oai21  g057(.a(new_n91_), .b(new_n55_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n53_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n101_), .O(z10));
  inv1   g060(.a(x02), .O(new_n107_));
  oai22  g061(.a(new_n99_), .b(new_n107_), .c(x18), .d(new_n61_), .O(new_n108_));
  ...
  oai21  g065(.a(new_n102_), .b(new_n63_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n91_), .c(new_n68_), .O(new_n118_));
  inv1   g072(.a(new_n91_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n55_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n99_), .b(new_n125_), .c(x18), .d(new_n71_), .O(new_n126_));
  ...
  oai21  g083(.a(new_n122_), .b(new_n73_), .c(new_n129_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n53_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n127_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai21  g087(.a(x18), .b(new_n78_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  aoi21  g089(.a(new_n128_), .b(new_n102_), .c(new_n76_), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n120_), .c(new_n137_), .d(new_n89_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n136_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n53_), .O(z14));
  inv1   g096(.a(x06), .O(new_n143_));
  aoi21  g097(.a(x18), .b(new_n143_), .c(x16), .O(new_n144_));
  nand2  g098(.a(new_n139_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x23), .b(x22), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n110_), .d(new_n91_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  aoi21  g103(.a(new_n149_), .b(x16), .c(new_n144_), .O(new_n150_));
  inv1   g104(.a(x18), .O(new_n151_));
  nand3  g105(.a(new_n149_), .b(new_n151_), .c(x16), .O(new_n152_));
  oai21  g106(.a(new_n150_), .b(new_n52_), .c(new_n152_), .O(z15));
  ...
  nand3  g112(.a(new_n158_), .b(new_n146_), .c(new_n76_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n111_), .c(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n53_), .O(z16));
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n48_), .d(new_n89_), .O(new_n164_));
