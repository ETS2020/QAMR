...
module FAU ( 
  ...
  nand3  g066(.a(new_n112_), .b(new_n93_), .c(new_n54_), .O(new_n113_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n95_), .c(new_n101_), .O(new_n120_));
  ...
  nand3  g084(.a(new_n68_), .b(new_n63_), .c(new_n101_), .O(new_n131_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n102_), .d(new_n93_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n102_), .d(new_n93_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n97_), .b(x07), .O(new_n154_));
