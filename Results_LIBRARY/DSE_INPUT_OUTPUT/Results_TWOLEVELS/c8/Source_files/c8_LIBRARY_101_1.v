...
module FAU ( 
  ...
  nor2   g044(.a(new_n65_), .b(new_n48_), .O(z08));
  ...
  nor2   g059(.a(new_n98_), .b(new_n55_), .O(new_n106_));
  nor3   g060(.a(x20), .b(x19), .c(x17), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n106_), .c(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n105_), .c(new_n53_), .O(z10));
  nor2   g063(.a(x18), .b(new_n62_), .O(new_n110_));
  aoi21  g064(.a(x18), .b(x02), .c(new_n110_), .O(new_n111_));
  nor2   g065(.a(x21), .b(x20), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n98_), .O(new_n113_));
  oai21  g067(.a(new_n107_), .b(new_n60_), .c(new_n113_), .O(new_n114_));
  aoi21  g068(.a(new_n114_), .b(x16), .c(new_n65_), .O(new_n115_));
  oai21  g069(.a(new_n111_), .b(x16), .c(new_n115_), .O(z11));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n98_), .c(new_n68_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n98_), .c(new_n55_), .O(new_n122_));
  ...
  oai21  g079(.a(x18), .b(new_n73_), .c(new_n94_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n92_), .O(new_n127_));
  oai21  g081(.a(x18), .b(new_n92_), .c(new_n94_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n122_), .c(x23), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  nand4  g084(.a(new_n53_), .b(new_n71_), .c(new_n68_), .d(new_n60_), .O(new_n131_));
  nor2   g085(.a(new_n131_), .b(x20), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n47_), .c(new_n130_), .d(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n129_), .c(new_n127_), .O(z13));
  ...
  nand2  g092(.a(new_n138_), .b(new_n130_), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n60_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(x24), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n121_), .c(new_n138_), .d(new_n130_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n53_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n137_), .O(z14));
  nand3  g101(.a(x18), .b(x06), .c(x04), .O(new_n148_));
  oai21  g102(.a(x18), .b(new_n83_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n92_), .O(new_n150_));
  nand2  g104(.a(new_n144_), .b(x25), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n140_), .c(new_n112_), .d(new_n98_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n53_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z15));
  nand3  g110(.a(x18), .b(x07), .c(x04), .O(new_n157_));
  oai21  g111(.a(x18), .b(new_n88_), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n92_), .O(new_n159_));
  nand2  g113(.a(new_n153_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n140_), .c(new_n112_), .d(new_n98_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n53_), .c(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n159_), .O(z16));
  nand4  g119(.a(new_n140_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n166_));
  nand3  g120(.a(new_n112_), .b(x19), .c(new_n130_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n48_), .d(new_n130_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n53_), .c(x16), .O(new_n169_));
  inv1   g123(.a(new_n169_), .O(z17));
endmodule
