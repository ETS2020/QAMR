...
module FAU ( 
  ...
  nand2  g037(.a(new_n71_), .b(x13), .O(new_n84_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n101_), .c(new_n80_), .O(z11));
  nand2  g060(.a(x18), .b(x03), .O(new_n107_));
  oai21  g061(.a(new_n84_), .b(new_n62_), .c(new_n107_), .O(new_n108_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n96_), .c(new_n59_), .O(new_n121_));
  ...
  oai21  g081(.a(new_n71_), .b(new_n82_), .c(new_n84_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n121_), .c(x24), .O(new_n129_));
  inv1   g083(.a(x17), .O(new_n130_));
  inv1   g084(.a(x22), .O(new_n131_));
  aoi21  g085(.a(new_n71_), .b(new_n70_), .c(x24), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n67_), .c(new_n131_), .d(new_n59_), .O(new_n133_));
  nor2   g087(.a(new_n133_), .b(x20), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n50_), .c(new_n130_), .d(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(new_n127_), .O(z14));
  ...
  nand3  g094(.a(new_n140_), .b(new_n111_), .c(new_n96_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x25), .O(new_n142_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n139_), .c(new_n80_), .O(z15));
  ...
  nand2  g106(.a(new_n152_), .b(new_n120_), .O(new_n153_));
  ...
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n130_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n153_), .c(new_n51_), .d(new_n130_), .O(new_n158_));
