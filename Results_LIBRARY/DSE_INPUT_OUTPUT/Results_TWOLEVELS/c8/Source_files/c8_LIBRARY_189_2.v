...
module FAU ( 
  ...
  nand3  g057(.a(new_n103_), .b(new_n100_), .c(new_n84_), .O(z10));
  ...
  nand3  g078(.a(new_n88_), .b(x12), .c(new_n52_), .O(new_n125_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n102_), .c(new_n108_), .O(new_n130_));
  ...
  nand3  g092(.a(new_n57_), .b(new_n49_), .c(new_n138_), .O(new_n139_));
  nand3  g093(.a(new_n68_), .b(new_n117_), .c(new_n108_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n139_), .c(x24), .O(new_n141_));
  nor2   g095(.a(x20), .b(x19), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n142_), .d(new_n138_), .O(new_n144_));
  ...
  nand3  g101(.a(new_n88_), .b(x14), .c(new_n52_), .O(new_n148_));
  oai21  g102(.a(new_n88_), .b(new_n52_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n86_), .O(new_n150_));
  nand2  g104(.a(new_n144_), .b(x25), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n129_), .c(new_n109_), .d(new_n93_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n84_), .c(x16), .O(new_n155_));
