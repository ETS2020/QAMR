...
module FAU ( 
  ...
  oai21  g050(.a(new_n54_), .b(new_n88_), .c(new_n96_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(x19), .O(new_n98_));
  nor2   g052(.a(new_n54_), .b(new_n83_), .O(new_n99_));
  ...
  nand2  g057(.a(new_n84_), .b(x18), .O(new_n104_));
  ...
  nor3   g065(.a(new_n111_), .b(new_n84_), .c(x18), .O(new_n112_));
  ...
  oai22  g081(.a(new_n104_), .b(new_n127_), .c(x18), .d(new_n64_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n88_), .O(new_n129_));
  nor2   g083(.a(x20), .b(x17), .O(new_n130_));
  nand2  g084(.a(new_n122_), .b(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n130_), .c(new_n111_), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n132_), .c(x19), .O(new_n135_));
  nor3   g089(.a(new_n66_), .b(new_n84_), .c(x18), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n129_), .O(z13));
  inv1   g092(.a(x05), .O(new_n139_));
  oai22  g093(.a(new_n104_), .b(new_n139_), .c(x18), .d(new_n69_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n88_), .O(new_n141_));
  nand2  g095(.a(new_n134_), .b(x24), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n108_), .c(new_n118_), .d(new_n83_), .O(new_n144_));
  aoi21  g098(.a(new_n144_), .b(new_n142_), .c(x19), .O(new_n145_));
  nor3   g099(.a(new_n71_), .b(new_n84_), .c(x18), .O(new_n146_));
  ...
  oai21  g105(.a(new_n76_), .b(new_n88_), .c(new_n96_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x19), .O(new_n153_));
  and2   g107(.a(new_n144_), .b(x25), .O(new_n154_));
  nand2  g108(.a(new_n108_), .b(new_n86_), .O(new_n155_));
  nor2   g109(.a(x25), .b(x24), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n133_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n154_), .c(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n153_), .c(new_n151_), .O(z15));
  inv1   g114(.a(x07), .O(new_n161_));
  oai22  g115(.a(new_n104_), .b(new_n161_), .c(x18), .d(new_n79_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n88_), .O(new_n163_));
  nand4  g117(.a(new_n156_), .b(new_n133_), .c(new_n108_), .d(new_n83_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor2   g119(.a(x26), .b(x25), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n143_), .c(new_n122_), .d(new_n130_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(x19), .O(new_n168_));
  nand2  g122(.a(x26), .b(x19), .O(new_n169_));
  nor2   g123(.a(new_n169_), .b(x18), .O(new_n170_));
  oai21  g124(.a(new_n170_), .b(new_n168_), .c(x16), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(new_n163_), .O(z16));
  ...
  nand4  g129(.a(new_n175_), .b(new_n166_), .c(new_n133_), .d(new_n71_), .O(new_n176_));
  aoi21  g130(.a(new_n176_), .b(new_n173_), .c(new_n88_), .O(z17));
endmodule
