...
module FAU ( 
  ...
  nand3  g055(.a(new_n92_), .b(x10), .c(x04), .O(new_n102_));
  ...
  oai21  g061(.a(new_n105_), .b(new_n56_), .c(new_n107_), .O(new_n108_));
  ...
  aoi21  g074(.a(new_n92_), .b(new_n63_), .c(x16), .O(new_n121_));
  ...
  aoi21  g079(.a(new_n125_), .b(x16), .c(new_n121_), .O(new_n126_));
  nand3  g080(.a(new_n125_), .b(x18), .c(x16), .O(new_n127_));
  oai21  g081(.a(new_n126_), .b(new_n120_), .c(new_n127_), .O(z13));
  ...
  aoi21  g086(.a(new_n123_), .b(new_n105_), .c(new_n132_), .O(new_n133_));
  nand3  g087(.a(new_n115_), .b(new_n132_), .c(new_n65_), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(new_n97_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n133_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n131_), .c(new_n79_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  nand3  g092(.a(new_n92_), .b(x14), .c(x04), .O(new_n139_));
  ...
  oai21  g099(.a(new_n135_), .b(new_n142_), .c(new_n145_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n79_), .c(x16), .O(new_n147_));
  ...
  nand4  g106(.a(new_n143_), .b(new_n76_), .c(new_n142_), .d(new_n132_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n107_), .c(new_n152_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n151_), .c(new_n79_), .O(z16));
  nand3  g110(.a(new_n106_), .b(x19), .c(new_n81_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n153_), .c(new_n57_), .d(new_n81_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n79_), .O(z17));
endmodule
