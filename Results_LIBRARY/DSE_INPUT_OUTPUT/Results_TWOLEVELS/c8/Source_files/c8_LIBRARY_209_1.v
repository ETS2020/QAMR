...
module FAU ( 
  ...
  nor2   g051(.a(new_n94_), .b(new_n58_), .O(new_n98_));
  ...
  nand4  g060(.a(new_n61_), .b(new_n58_), .c(new_n47_), .d(new_n92_), .O(new_n107_));
  ...
  nand4  g081(.a(new_n83_), .b(new_n76_), .c(new_n71_), .d(new_n68_), .O(new_n128_));
