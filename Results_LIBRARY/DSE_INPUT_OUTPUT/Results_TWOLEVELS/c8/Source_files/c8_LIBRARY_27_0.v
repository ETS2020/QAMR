...
module FAU ( 
  ...
  oai21  g66(.a(new_n85_), .b(x05), .c(new_n94_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n109_), .b(new_n90_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n104_), .c(new_n96_), .d(new_n80_), .O(new_n117_));
  ...
  oai21  g81(.a(new_n85_), .b(x07), .c(new_n94_), .O(new_n128_));
