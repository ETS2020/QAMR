...
module FAU ( 
  ...
  nand3  g074(.a(new_n120_), .b(new_n92_), .c(x16), .O(new_n121_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n63_), .c(new_n57_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n94_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n108_), .c(new_n129_), .d(new_n80_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n92_), .c(x16), .O(new_n133_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n118_), .c(new_n100_), .d(new_n83_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n92_), .c(x16), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n118_), .c(new_n100_), .d(new_n83_), .O(new_n149_));
  ...
  nand2  g106(.a(new_n126_), .b(new_n63_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n100_), .b(x19), .c(new_n80_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n58_), .b(new_n80_), .O(new_n161_));
