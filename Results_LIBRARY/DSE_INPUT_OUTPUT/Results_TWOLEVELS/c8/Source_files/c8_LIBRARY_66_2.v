...
module FAU ( 
  ...
  nand2  g046(.a(new_n85_), .b(x01), .O(new_n93_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n98_), .O(new_n118_));
  ...
  nand3  g078(.a(new_n89_), .b(new_n51_), .c(new_n81_), .O(new_n125_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n108_), .c(new_n130_), .d(new_n81_), .O(new_n132_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n117_), .c(new_n99_), .d(new_n83_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n117_), .c(new_n99_), .d(new_n83_), .O(new_n148_));
