...
module FAU ( 
  ...
  nand3  g081(.a(new_n127_), .b(new_n103_), .c(new_n63_), .O(new_n128_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n119_), .c(new_n103_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n127_), .c(new_n110_), .d(new_n91_), .O(new_n148_));
  ...
  nand4  g109(.a(new_n127_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n156_));
