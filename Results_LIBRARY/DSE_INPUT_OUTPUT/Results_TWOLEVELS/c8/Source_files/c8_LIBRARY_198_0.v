...
module FAU ( 
  ...
  nor2   g048(.a(new_n89_), .b(new_n53_), .O(new_n95_));
  nor3   g049(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  nor2   g051(.a(new_n92_), .b(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x01), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n97_), .O(z10));
  oai21  g054(.a(new_n92_), .b(x02), .c(new_n91_), .O(new_n101_));
  nor2   g055(.a(x20), .b(x19), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n86_), .O(new_n103_));
  nand4  g057(.a(new_n59_), .b(new_n53_), .c(new_n87_), .d(new_n86_), .O(new_n104_));
  inv1   g058(.a(new_n104_), .O(new_n105_));
  aoi21  g059(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g060(.a(new_n106_), .b(new_n91_), .c(new_n101_), .O(z11));
  nand2  g061(.a(new_n104_), .b(x22), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n89_), .c(new_n53_), .O(new_n110_));
  and2   g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand2  g065(.a(new_n98_), .b(x03), .O(new_n112_));
  oai21  g066(.a(new_n111_), .b(new_n91_), .c(new_n112_), .O(z12));
  oai21  g067(.a(new_n92_), .b(x04), .c(new_n91_), .O(new_n114_));
  nor3   g068(.a(x23), .b(x22), .c(x21), .O(new_n115_));
  aoi22  g069(.a(new_n115_), .b(new_n96_), .c(new_n110_), .d(x23), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n91_), .c(new_n114_), .O(z13));
  oai21  g071(.a(new_n92_), .b(x05), .c(new_n91_), .O(new_n118_));
  aoi21  g072(.a(new_n115_), .b(new_n96_), .c(new_n74_), .O(new_n119_));
  nor2   g073(.a(x24), .b(x23), .O(new_n120_));
  nand4  g074(.a(new_n120_), .b(new_n109_), .c(new_n102_), .d(new_n86_), .O(new_n121_));
  ...
  nand4  g078(.a(new_n79_), .b(new_n74_), .c(new_n69_), .d(new_n64_), .O(new_n125_));
  inv1   g079(.a(new_n125_), .O(new_n126_));
  aoi22  g080(.a(new_n126_), .b(new_n105_), .c(new_n121_), .d(x25), .O(new_n127_));
  nand2  g081(.a(new_n98_), .b(x06), .O(new_n128_));
  oai21  g082(.a(new_n127_), .b(new_n91_), .c(new_n128_), .O(z15));
  nor2   g083(.a(x21), .b(x20), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nor2   g085(.a(x25), .b(x24), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n131_), .c(new_n130_), .d(new_n89_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x26), .O(new_n134_));
  nor3   g088(.a(x26), .b(x25), .c(x24), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n131_), .c(new_n130_), .d(new_n89_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g092(.a(new_n98_), .b(x07), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n138_), .O(z16));
  inv1   g094(.a(new_n48_), .O(new_n141_));
  nor2   g095(.a(x26), .b(x25), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n131_), .c(new_n74_), .O(new_n143_));
  nand3  g097(.a(new_n130_), .b(x19), .c(new_n86_), .O(new_n144_));
