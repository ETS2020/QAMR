...
module FAU ( 
  ...
  nor2   g030(.a(new_n54_), .b(new_n76_), .O(new_n77_));
  oai22  g031(.a(new_n77_), .b(x26), .c(new_n54_), .d(x15), .O(z07));
  inv1   g032(.a(new_n48_), .O(new_n79_));
  nand2  g033(.a(new_n79_), .b(new_n54_), .O(z08));
  ...
  nand3  g043(.a(new_n89_), .b(new_n85_), .c(new_n79_), .O(z09));
  ...
  nor2   g047(.a(new_n84_), .b(new_n53_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n93_), .c(new_n79_), .O(z10));
  ...
  nand3  g055(.a(new_n84_), .b(new_n101_), .c(new_n53_), .O(new_n102_));
  oai21  g056(.a(new_n95_), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n100_), .c(new_n79_), .O(z11));
  nand2  g059(.a(x18), .b(x03), .O(new_n106_));
  nand2  g060(.a(x26), .b(new_n76_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n60_), .c(new_n106_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n86_), .O(new_n109_));
  nand3  g063(.a(new_n102_), .b(new_n79_), .c(x22), .O(new_n110_));
  nor2   g064(.a(new_n48_), .b(x22), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n101_), .c(new_n53_), .d(new_n82_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(x17), .c(new_n110_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n109_), .O(z12));
  nand2  g069(.a(x18), .b(x04), .O(new_n116_));
  oai21  g070(.a(new_n107_), .b(new_n65_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n86_), .O(new_n118_));
  inv1   g072(.a(new_n95_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n84_), .c(new_n53_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n101_), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n119_), .c(new_n122_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n79_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n118_), .O(z13));
  ...
  nor2   g084(.a(new_n124_), .b(new_n119_), .O(new_n131_));
  inv1   g085(.a(x23), .O(new_n132_));
  nand4  g086(.a(new_n120_), .b(new_n95_), .c(new_n70_), .d(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n131_), .b(new_n70_), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g092(.a(new_n138_), .b(new_n86_), .O(new_n139_));
  nand2  g093(.a(new_n133_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n123_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n102_), .c(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n79_), .O(z15));
  inv1   g099(.a(x15), .O(new_n146_));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  oai21  g101(.a(new_n107_), .b(new_n146_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n86_), .O(new_n149_));
  nand2  g103(.a(x26), .b(x23), .O(new_n150_));
  nor2   g104(.a(x26), .b(x25), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n70_), .c(new_n132_), .d(x18), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n150_), .c(x22), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n101_), .c(new_n53_), .d(new_n82_), .O(new_n154_));
  nand3  g108(.a(new_n141_), .b(new_n120_), .c(new_n95_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x26), .O(new_n156_));
  oai21  g110(.a(new_n154_), .b(x17), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n149_), .O(z16));
  nand4  g113(.a(new_n101_), .b(new_n53_), .c(x19), .d(new_n81_), .O(new_n160_));
  nand3  g114(.a(new_n151_), .b(new_n123_), .c(new_n70_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n54_), .d(new_n81_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n79_), .O(z17));
endmodule
