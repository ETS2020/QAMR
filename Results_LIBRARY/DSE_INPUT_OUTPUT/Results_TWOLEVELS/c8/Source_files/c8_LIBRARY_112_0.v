...
module FAU ( 
  ...
  nor2   g45(.a(new_n84_), .b(new_n56_), .O(new_n92_));
  ...
  nand4  g52(.a(new_n98_), .b(new_n56_), .c(new_n50_), .d(new_n82_), .O(new_n99_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n105_), .c(new_n96_), .d(new_n82_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n75_), .b(new_n70_), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  ...
  oai21  g81(.a(new_n86_), .b(x07), .c(new_n90_), .O(new_n128_));
  ...
  nand3  g94(.a(new_n140_), .b(new_n130_), .c(new_n70_), .O(new_n141_));
