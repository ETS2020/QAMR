...
module FAU ( 
  ...
  nand2  g047(.a(x18), .b(x06), .O(new_n94_));
  ...
  nand2  g064(.a(new_n110_), .b(new_n103_), .O(new_n111_));
  oai21  g065(.a(new_n105_), .b(new_n61_), .c(new_n111_), .O(new_n112_));
  aoi21  g066(.a(new_n112_), .b(x16), .c(new_n54_), .O(new_n113_));
  oai21  g067(.a(new_n109_), .b(x16), .c(new_n113_), .O(z11));
  nor2   g068(.a(x18), .b(new_n68_), .O(new_n115_));
  aoi21  g069(.a(x18), .b(x03), .c(new_n115_), .O(new_n116_));
  inv1   g070(.a(new_n111_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n103_), .c(new_n58_), .O(new_n119_));
  oai21  g073(.a(new_n117_), .b(new_n66_), .c(new_n119_), .O(new_n120_));
  aoi21  g074(.a(new_n120_), .b(x16), .c(new_n54_), .O(new_n121_));
  oai21  g075(.a(new_n116_), .b(x16), .c(new_n121_), .O(z12));
  inv1   g076(.a(x04), .O(new_n123_));
  oai22  g077(.a(new_n94_), .b(new_n123_), .c(x18), .d(new_n71_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n92_), .O(new_n125_));
  inv1   g079(.a(new_n105_), .O(new_n126_));
  nand2  g080(.a(new_n119_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n61_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n126_), .c(new_n127_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n53_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n125_), .O(z13));
  inv1   g086(.a(x05), .O(new_n133_));
  oai22  g087(.a(new_n94_), .b(new_n133_), .c(x18), .d(new_n76_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n92_), .O(new_n135_));
  oai21  g089(.a(new_n129_), .b(new_n126_), .c(x24), .O(new_n136_));
  nand4  g090(.a(new_n118_), .b(new_n105_), .c(new_n78_), .d(new_n73_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n136_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n53_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n135_), .O(z14));
  oai21  g094(.a(x18), .b(new_n81_), .c(new_n94_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n92_), .O(new_n142_));
  oai21  g096(.a(x18), .b(new_n92_), .c(new_n94_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(x25), .O(new_n144_));
  inv1   g098(.a(x17), .O(new_n145_));
  aoi21  g099(.a(x18), .b(new_n52_), .c(x25), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n78_), .c(new_n73_), .d(new_n66_), .O(new_n147_));
  nor3   g101(.a(new_n147_), .b(x21), .c(x20), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n49_), .c(new_n145_), .d(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n142_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  oai21  g105(.a(x18), .b(new_n88_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n92_), .O(new_n153_));
  nand3  g107(.a(new_n128_), .b(new_n83_), .c(new_n78_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n111_), .c(x26), .O(new_n155_));
  nand4  g109(.a(new_n128_), .b(new_n86_), .c(new_n83_), .d(new_n78_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n111_), .c(new_n155_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n53_), .O(z16));
  nand3  g113(.a(new_n110_), .b(x19), .c(new_n145_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n156_), .c(new_n50_), .d(new_n145_), .O(new_n161_));
