...
module FAU ( 
  ...
  nand2  g35(.a(new_n81_), .b(new_n60_), .O(z08));
  ...
  nand4  g55(.a(new_n101_), .b(new_n92_), .c(new_n84_), .d(new_n83_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n89_), .b(x02), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n98_), .c(new_n105_), .O(z11));
  ...
  nand2  g64(.a(new_n89_), .b(x03), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n98_), .c(new_n111_), .O(z12));
  ...
  oai21  g70(.a(new_n88_), .b(x05), .c(new_n98_), .O(new_n117_));
  aoi21  g71(.a(new_n113_), .b(new_n94_), .c(new_n68_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n108_), .c(new_n99_), .d(new_n83_), .O(new_n120_));
  ...
  nand4  g94(.a(new_n132_), .b(new_n78_), .c(new_n73_), .d(new_n68_), .O(new_n141_));
  nand3  g95(.a(new_n131_), .b(x19), .c(new_n83_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n60_), .d(new_n83_), .O(new_n143_));
