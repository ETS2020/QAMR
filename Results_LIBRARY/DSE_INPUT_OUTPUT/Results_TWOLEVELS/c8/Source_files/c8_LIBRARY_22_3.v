...
module FAU ( 
  ...
  oai21  g060(.a(new_n101_), .b(new_n104_), .c(new_n106_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n52_), .c(x16), .O(new_n108_));
  inv1   g062(.a(x18), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n85_), .c(x10), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(z11));
  ...
  aoi21  g069(.a(new_n105_), .b(new_n91_), .c(new_n115_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n99_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n114_), .c(new_n52_), .O(z12));
  ...
  nand3  g080(.a(new_n126_), .b(new_n101_), .c(new_n104_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x16), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n124_), .c(new_n52_), .O(z13));
  nand2  g084(.a(x18), .b(x05), .O(new_n131_));
  oai22  g085(.a(new_n131_), .b(x02), .c(x18), .d(new_n69_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n85_), .O(new_n133_));
  inv1   g087(.a(x17), .O(new_n134_));
  nand3  g088(.a(new_n99_), .b(new_n49_), .c(new_n134_), .O(new_n135_));
  nand3  g089(.a(new_n66_), .b(new_n115_), .c(new_n104_), .O(new_n136_));
  ...
  oai22  g098(.a(new_n144_), .b(x02), .c(x18), .d(new_n74_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n85_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n105_), .d(new_n91_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n105_), .d(new_n91_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n52_), .O(z16));
  nand4  g115(.a(new_n126_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n162_));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n134_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n134_), .O(new_n164_));
