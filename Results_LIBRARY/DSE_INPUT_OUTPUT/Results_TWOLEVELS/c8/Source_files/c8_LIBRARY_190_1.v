...
module FAU ( 
  ...
  nor2   g055(.a(new_n91_), .b(new_n58_), .O(new_n102_));
  ...
  aoi21  g075(.a(new_n121_), .b(x16), .c(new_n116_), .O(new_n122_));
  inv1   g076(.a(x18), .O(new_n123_));
  nand3  g077(.a(new_n121_), .b(new_n123_), .c(x16), .O(new_n124_));
  oai21  g078(.a(new_n122_), .b(new_n47_), .c(new_n124_), .O(z12));
  ...
  nand2  g082(.a(new_n120_), .b(x23), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n103_), .c(new_n61_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n128_), .c(new_n48_), .O(z13));
  inv1   g088(.a(x05), .O(new_n135_));
  oai22  g089(.a(new_n99_), .b(new_n135_), .c(x18), .d(new_n73_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n93_), .O(new_n137_));
  aoi22  g091(.a(new_n110_), .b(new_n91_), .c(x18), .d(new_n47_), .O(new_n138_));
  nor2   g092(.a(new_n130_), .b(new_n49_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n138_), .c(x24), .O(new_n140_));
  nand4  g094(.a(new_n48_), .b(new_n75_), .c(new_n70_), .d(new_n117_), .O(new_n141_));
  nor2   g095(.a(new_n141_), .b(x21), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n58_), .c(new_n52_), .d(new_n89_), .O(new_n143_));
  ...
  oai21  g101(.a(x18), .b(new_n78_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n93_), .O(new_n149_));
  nand4  g103(.a(new_n119_), .b(new_n103_), .c(new_n75_), .d(new_n70_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x25), .O(new_n151_));
  nand4  g105(.a(new_n130_), .b(new_n118_), .c(new_n80_), .d(new_n75_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n149_), .c(new_n48_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  oai21  g110(.a(x18), .b(new_n83_), .c(new_n156_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n93_), .O(new_n158_));
  nand2  g112(.a(new_n152_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n130_), .c(new_n118_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n48_), .O(z16));
  nand2  g118(.a(new_n160_), .b(new_n130_), .O(new_n165_));
  nand3  g119(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n53_), .d(new_n89_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n48_), .c(x16), .O(new_n168_));
