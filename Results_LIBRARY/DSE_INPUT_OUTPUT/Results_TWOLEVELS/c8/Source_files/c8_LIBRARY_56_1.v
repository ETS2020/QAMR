...
module FAU ( 
  ...
  oai21  g045(.a(x18), .b(x09), .c(new_n87_), .O(new_n92_));
  nor2   g046(.a(new_n85_), .b(new_n54_), .O(new_n93_));
  nor3   g047(.a(x20), .b(x19), .c(x17), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n92_), .c(new_n81_), .O(z10));
  ...
  nand3  g058(.a(new_n104_), .b(new_n99_), .c(new_n81_), .O(z11));
  ...
  aoi21  g063(.a(new_n101_), .b(new_n85_), .c(new_n109_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n85_), .c(new_n54_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n108_), .c(new_n81_), .O(z12));
  nand3  g069(.a(x18), .b(x04), .c(x01), .O(new_n116_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n81_), .c(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n118_), .O(z13));
  nand3  g078(.a(x18), .b(x05), .c(x01), .O(new_n125_));
  oai21  g079(.a(x18), .b(new_n69_), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n87_), .O(new_n127_));
  nand3  g081(.a(new_n54_), .b(new_n83_), .c(new_n82_), .O(new_n128_));
  nand3  g082(.a(new_n66_), .b(new_n109_), .c(new_n100_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n128_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n82_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n81_), .c(x16), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n120_), .c(new_n101_), .d(new_n85_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n81_), .c(x16), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n101_), .d(new_n85_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n81_), .O(z16));
  inv1   g108(.a(x24), .O(new_n155_));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n120_), .c(new_n155_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n82_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n82_), .O(new_n159_));
