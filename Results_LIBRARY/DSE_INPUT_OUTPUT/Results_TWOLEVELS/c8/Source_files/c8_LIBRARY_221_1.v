...
module FAU ( 
  ...
  nand2  g44(.a(new_n47_), .b(new_n90_), .O(new_n91_));
  ...
  nand4  g74(.a(new_n76_), .b(new_n71_), .c(new_n120_), .d(new_n63_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n123_));
  nand3  g77(.a(new_n47_), .b(new_n90_), .c(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n90_), .c(new_n124_), .O(z15));
  oai21  g79(.a(x18), .b(x15), .c(new_n90_), .O(new_n126_));
  ...
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n52_), .d(new_n86_), .O(new_n139_));
