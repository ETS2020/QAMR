...
module FAU ( 
  ...
  nand3  g052(.a(new_n97_), .b(new_n51_), .c(new_n87_), .O(new_n99_));
  oai21  g053(.a(new_n98_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  ...
  nor2   g063(.a(x18), .b(x16), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x10), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n109_), .c(new_n103_), .O(z11));
  oai21  g066(.a(x16), .b(x03), .c(x18), .O(new_n113_));
  inv1   g067(.a(x22), .O(new_n114_));
  aoi21  g068(.a(new_n106_), .b(new_n98_), .c(new_n114_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n98_), .c(new_n97_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n110_), .b(x11), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n119_), .c(new_n113_), .O(z12));
  ...
  nand3  g080(.a(new_n126_), .b(new_n105_), .c(new_n104_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n96_), .c(x16), .O(new_n129_));
  ...
  nand3  g087(.a(new_n66_), .b(new_n114_), .c(new_n104_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n99_), .c(x24), .O(new_n135_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n96_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n126_), .c(new_n106_), .d(new_n98_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n96_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z15));
  oai21  g104(.a(x16), .b(x07), .c(x18), .O(new_n151_));
  nand2  g105(.a(new_n147_), .b(x26), .O(new_n152_));
  nor3   g106(.a(x26), .b(x25), .c(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n126_), .c(new_n106_), .d(new_n98_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n110_), .b(x15), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n151_), .O(z16));
  nand2  g112(.a(new_n66_), .b(new_n114_), .O(new_n159_));
  nand3  g113(.a(new_n81_), .b(new_n76_), .c(new_n71_), .O(new_n160_));
  ...
  aoi21  g119(.a(new_n165_), .b(new_n96_), .c(new_n85_), .O(z17));
endmodule
