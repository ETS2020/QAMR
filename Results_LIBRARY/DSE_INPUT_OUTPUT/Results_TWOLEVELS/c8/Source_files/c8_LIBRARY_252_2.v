...
module FAU ( 
  ...
  nor2   g063(.a(x21), .b(x19), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n89_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n52_), .O(new_n113_));
  nor2   g067(.a(new_n103_), .b(new_n57_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n113_), .c(new_n108_), .O(z11));
  ...
  nand2  g073(.a(new_n89_), .b(x16), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n47_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n120_), .c(new_n109_), .O(new_n123_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n124_), .c(new_n119_), .O(z12));
  ...
  nand2  g085(.a(new_n91_), .b(x16), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n57_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n132_), .c(new_n109_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n52_), .O(new_n136_));
  nand3  g090(.a(new_n121_), .b(new_n91_), .c(new_n52_), .O(new_n137_));
  ...
  nand2  g094(.a(x20), .b(x18), .O(new_n141_));
  oai22  g095(.a(new_n141_), .b(new_n140_), .c(x18), .d(new_n75_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n93_), .O(new_n143_));
  nand3  g097(.a(new_n133_), .b(new_n91_), .c(new_n57_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n121_), .b(new_n103_), .c(new_n73_), .d(new_n70_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n145_), .c(x18), .O(new_n147_));
  nor2   g101(.a(new_n73_), .b(new_n52_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n147_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n143_), .O(z14));
  inv1   g104(.a(x06), .O(new_n151_));
  oai22  g105(.a(new_n141_), .b(new_n151_), .c(x18), .d(new_n80_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n93_), .O(new_n153_));
  nand3  g107(.a(new_n57_), .b(new_n47_), .c(new_n89_), .O(new_n154_));
  nand3  g108(.a(new_n73_), .b(new_n70_), .c(new_n65_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n154_), .c(x25), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n133_), .c(new_n125_), .d(new_n91_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n156_), .c(x18), .O(new_n159_));
  nor2   g113(.a(new_n78_), .b(new_n52_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n159_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n153_), .O(z15));
  inv1   g116(.a(x07), .O(new_n163_));
  oai22  g117(.a(new_n141_), .b(new_n163_), .c(x18), .d(new_n85_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n93_), .O(new_n165_));
  nand4  g119(.a(new_n157_), .b(new_n133_), .c(new_n110_), .d(new_n89_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x26), .O(new_n167_));
  nor3   g121(.a(x26), .b(x25), .c(x24), .O(new_n168_));
  nand4  g122(.a(new_n168_), .b(new_n133_), .c(new_n125_), .d(new_n91_), .O(new_n169_));
  ...
  nand3  g127(.a(new_n53_), .b(x27), .c(x17), .O(new_n174_));
  nand2  g128(.a(new_n125_), .b(x19), .O(new_n175_));
  nor3   g129(.a(new_n175_), .b(x18), .c(x17), .O(new_n176_));
  nand3  g130(.a(new_n176_), .b(new_n168_), .c(new_n133_), .O(new_n177_));
  aoi21  g131(.a(new_n177_), .b(new_n174_), .c(new_n93_), .O(z17));
endmodule
