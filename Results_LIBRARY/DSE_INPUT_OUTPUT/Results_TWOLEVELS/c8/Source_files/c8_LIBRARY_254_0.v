...
module FAU ( 
  ...
  aoi22  g63(.a(new_n109_), .b(new_n92_), .c(new_n106_), .d(x23), .O(new_n110_));
  ...
  aoi21  g68(.a(new_n109_), .b(new_n92_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n95_), .d(new_n80_), .O(new_n117_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n114_), .c(new_n65_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n99_), .c(new_n117_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n86_), .b(x06), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n89_), .c(new_n126_), .O(z15));
  oai21  g81(.a(new_n85_), .b(x07), .c(new_n89_), .O(new_n128_));
  nor2   g82(.a(x21), .b(x20), .O(new_n129_));
  nor2   g83(.a(x23), .b(x22), .O(new_n130_));
  nor2   g84(.a(x25), .b(x24), .O(new_n131_));
  nand4  g85(.a(new_n131_), .b(new_n130_), .c(new_n129_), .d(new_n83_), .O(new_n132_));
  nand2  g86(.a(new_n132_), .b(x26), .O(new_n133_));
  nor3   g87(.a(x26), .b(x25), .c(x24), .O(new_n134_));
  nand4  g88(.a(new_n134_), .b(new_n130_), .c(new_n129_), .d(new_n83_), .O(new_n135_));
  ...
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n89_), .O(z17));
endmodule
