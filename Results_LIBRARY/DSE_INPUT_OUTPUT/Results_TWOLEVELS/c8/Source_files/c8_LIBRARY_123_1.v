...
module FAU ( 
  ...
  nand2  g006(.a(x08), .b(new_n52_), .O(new_n53_));
  ...
  oai21  g045(.a(x18), .b(x16), .c(x02), .O(new_n92_));
  ...
  nand3  g052(.a(x18), .b(new_n98_), .c(x00), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n97_), .c(new_n93_), .O(z09));
  nand2  g054(.a(x18), .b(x01), .O(new_n101_));
  oai21  g055(.a(x18), .b(new_n56_), .c(new_n101_), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  nor2   g057(.a(new_n96_), .b(new_n58_), .O(new_n104_));
  nor3   g058(.a(x20), .b(x19), .c(x17), .O(new_n105_));
  oai21  g059(.a(new_n105_), .b(new_n104_), .c(x16), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(new_n103_), .c(new_n55_), .O(z10));
  ...
  aoi21  g066(.a(new_n112_), .b(x16), .c(new_n55_), .O(new_n113_));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n96_), .c(new_n66_), .O(new_n118_));
  inv1   g072(.a(new_n96_), .O(new_n119_));
  ...
  nand2  g083(.a(new_n129_), .b(new_n105_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n127_), .c(new_n53_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  oai21  g088(.a(x18), .b(new_n78_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n98_), .O(new_n136_));
  aoi21  g090(.a(new_n129_), .b(new_n105_), .c(new_n76_), .O(new_n137_));
  nand3  g091(.a(new_n58_), .b(new_n47_), .c(new_n94_), .O(new_n138_));
  nand3  g092(.a(new_n120_), .b(new_n76_), .c(new_n73_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n136_), .c(new_n55_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  oai21  g097(.a(x18), .b(new_n81_), .c(new_n143_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n98_), .O(new_n145_));
  oai21  g099(.a(new_n139_), .b(new_n138_), .c(x25), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n110_), .d(new_n96_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n110_), .d(new_n96_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n86_), .c(new_n83_), .d(new_n76_), .O(new_n162_));
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n94_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n48_), .d(new_n94_), .O(new_n164_));
