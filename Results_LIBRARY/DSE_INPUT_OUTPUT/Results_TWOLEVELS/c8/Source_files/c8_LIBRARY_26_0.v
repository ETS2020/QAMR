...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x13), .O(new_n47_));
  ...
  aoi21  g037(.a(new_n73_), .b(new_n72_), .c(new_n51_), .O(z08));
  inv1   g038(.a(new_n47_), .O(new_n85_));
  ...
  oai21  g045(.a(x18), .b(new_n48_), .c(new_n91_), .O(new_n92_));
  ...
  nor2   g052(.a(new_n88_), .b(new_n98_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n85_), .O(z10));
  ...
  oai21  g061(.a(new_n100_), .b(new_n59_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n105_), .c(new_n85_), .O(z11));
  ...
  nand3  g069(.a(new_n115_), .b(new_n88_), .c(new_n98_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n85_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  oai21  g074(.a(x18), .b(new_n67_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n90_), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n100_), .c(new_n59_), .O(new_n124_));
  oai21  g078(.a(new_n117_), .b(new_n69_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n122_), .c(new_n85_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  nand2  g082(.a(new_n73_), .b(x13), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n90_), .O(new_n131_));
  oai21  g085(.a(new_n73_), .b(new_n90_), .c(new_n129_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n124_), .c(x24), .O(new_n133_));
  aoi21  g087(.a(new_n73_), .b(new_n72_), .c(x24), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n69_), .c(new_n64_), .d(new_n59_), .O(new_n135_));
  nor2   g089(.a(new_n135_), .b(x20), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n50_), .c(new_n86_), .d(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n133_), .c(new_n131_), .O(z14));
  nand2  g092(.a(x18), .b(x06), .O(new_n139_));
  nand3  g093(.a(new_n73_), .b(x14), .c(x13), .O(new_n140_));
  ...
  nand3  g097(.a(new_n143_), .b(new_n115_), .c(new_n100_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n123_), .c(new_n106_), .d(new_n88_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n85_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n142_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n73_), .b(x15), .c(x13), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n90_), .O(new_n154_));
  nand2  g108(.a(new_n147_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n123_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n107_), .c(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n85_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n154_), .O(z16));
  nand3  g114(.a(new_n106_), .b(x19), .c(new_n86_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n51_), .d(new_n86_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n85_), .c(x16), .O(new_n163_));
