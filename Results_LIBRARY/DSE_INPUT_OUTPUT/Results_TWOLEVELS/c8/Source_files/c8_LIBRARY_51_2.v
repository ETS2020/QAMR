...
module FAU ( 
  ...
  aoi21  g027(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n74_));
  ...
  inv1   g034(.a(new_n49_), .O(new_n81_));
  nand2  g035(.a(new_n81_), .b(new_n58_), .O(z08));
  ...
  nand3  g045(.a(new_n91_), .b(new_n87_), .c(new_n81_), .O(z09));
  nand2  g046(.a(x18), .b(x01), .O(new_n93_));
  inv1   g047(.a(x18), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n48_), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n52_), .c(new_n93_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n86_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g058(.a(new_n95_), .b(new_n55_), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g069(.a(new_n108_), .b(new_n86_), .c(new_n63_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n86_), .c(new_n98_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n81_), .O(z12));
  nand2  g075(.a(x18), .b(x04), .O(new_n122_));
  oai21  g076(.a(new_n95_), .b(new_n66_), .c(new_n122_), .O(new_n123_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n117_), .c(new_n99_), .d(new_n83_), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n108_), .d(new_n86_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n81_), .c(x16), .O(new_n146_));
  nand3  g100(.a(x18), .b(new_n88_), .c(x06), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n146_), .O(z15));
  ...
  nand4  g107(.a(new_n153_), .b(new_n142_), .c(new_n108_), .d(new_n86_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n81_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n142_), .c(new_n134_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n83_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n58_), .d(new_n83_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n81_), .c(x16), .O(new_n162_));
