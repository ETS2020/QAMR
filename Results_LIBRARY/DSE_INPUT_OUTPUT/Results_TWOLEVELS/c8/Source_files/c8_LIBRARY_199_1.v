...
module FAU ( 
  ...
  nand2  g44(.a(new_n48_), .b(new_n84_), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n52_), .c(new_n90_), .O(z10));
  ...
  oai22  g51(.a(new_n97_), .b(new_n84_), .c(new_n91_), .d(new_n55_), .O(z11));
  oai21  g52(.a(x18), .b(x11), .c(new_n84_), .O(new_n99_));
  ...
  oai21  g57(.a(new_n103_), .b(new_n84_), .c(new_n99_), .O(z12));
  nor3   g58(.a(x23), .b(x22), .c(x21), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n89_), .c(new_n102_), .d(x23), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n84_), .c(new_n91_), .d(new_n64_), .O(z13));
  oai21  g61(.a(x18), .b(x13), .c(new_n84_), .O(new_n108_));
  inv1   g62(.a(x24), .O(new_n109_));
  aoi21  g63(.a(new_n105_), .b(new_n89_), .c(new_n109_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n101_), .c(new_n93_), .d(new_n79_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n108_), .O(z14));
  oai21  g69(.a(x18), .b(x14), .c(new_n84_), .O(new_n116_));
  inv1   g70(.a(x22), .O(new_n117_));
  inv1   g71(.a(x25), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n109_), .c(new_n66_), .d(new_n117_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n96_), .c(new_n112_), .d(x25), .O(new_n121_));
