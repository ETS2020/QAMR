...
module FAU ( 
  ...
  oai21  g017(.a(x27), .b(new_n63_), .c(new_n47_), .O(new_n64_));
  nand3  g018(.a(new_n52_), .b(new_n63_), .c(x18), .O(new_n65_));
  nand2  g019(.a(new_n65_), .b(new_n64_), .O(z03));
  ...
  nor2   g040(.a(x18), .b(x11), .O(new_n87_));
  ...
  nand3  g053(.a(new_n99_), .b(new_n95_), .c(new_n85_), .O(z10));
  ...
  nand3  g062(.a(new_n108_), .b(new_n85_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n104_), .O(z11));
  nand2  g064(.a(new_n107_), .b(x22), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n96_), .c(new_n57_), .O(new_n113_));
  and2   g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  inv1   g068(.a(x18), .O(new_n115_));
  nor2   g069(.a(new_n115_), .b(x16), .O(new_n116_));
  aoi21  g070(.a(new_n116_), .b(x03), .c(new_n48_), .O(new_n117_));
  oai21  g071(.a(new_n114_), .b(new_n92_), .c(new_n117_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  nand3  g073(.a(new_n115_), .b(x12), .c(new_n47_), .O(new_n120_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n124_), .c(new_n106_), .d(new_n96_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n124_), .c(new_n106_), .d(new_n96_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n124_), .c(new_n74_), .O(new_n162_));
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n133_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n52_), .d(new_n133_), .O(new_n164_));
