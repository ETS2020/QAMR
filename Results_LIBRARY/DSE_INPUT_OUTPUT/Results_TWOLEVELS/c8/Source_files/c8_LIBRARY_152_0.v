...
module FAU ( 
  ...
  nand4  g54(.a(new_n100_), .b(new_n53_), .c(new_n84_), .d(new_n83_), .O(new_n101_));
  ...
  aoi22  g66(.a(new_n112_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n113_));
  nand2  g67(.a(new_n89_), .b(x04), .O(new_n114_));
  oai21  g68(.a(new_n113_), .b(new_n97_), .c(new_n114_), .O(z13));
  aoi21  g69(.a(new_n112_), .b(new_n93_), .c(new_n68_), .O(new_n116_));
  ...
  nand4  g79(.a(new_n73_), .b(new_n68_), .c(new_n125_), .d(new_n124_), .O(new_n126_));
  ...
  nand4  g94(.a(new_n131_), .b(new_n78_), .c(new_n73_), .d(new_n68_), .O(new_n141_));
