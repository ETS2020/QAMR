...
module FAU ( 
  ...
  nand4  g55(.a(new_n101_), .b(new_n56_), .c(new_n50_), .d(new_n85_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n90_), .b(x02), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n93_), .c(new_n105_), .O(z11));
  ...
  nand2  g64(.a(new_n90_), .b(x03), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n93_), .c(new_n111_), .O(z12));
  oai21  g66(.a(new_n89_), .b(x04), .c(new_n93_), .O(new_n113_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n96_), .c(new_n109_), .d(x23), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n93_), .c(new_n113_), .O(z13));
  oai21  g70(.a(new_n89_), .b(x05), .c(new_n93_), .O(new_n117_));
  inv1   g71(.a(x24), .O(new_n118_));
  aoi21  g72(.a(new_n114_), .b(new_n96_), .c(new_n118_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n108_), .c(new_n99_), .d(new_n85_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand2  g77(.a(new_n123_), .b(new_n117_), .O(z14));
  inv1   g78(.a(x22), .O(new_n125_));
  nand4  g79(.a(new_n75_), .b(new_n118_), .c(new_n67_), .d(new_n125_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n103_), .c(new_n121_), .d(x25), .O(new_n128_));
  nand2  g82(.a(new_n90_), .b(x06), .O(new_n129_));
  oai21  g83(.a(new_n128_), .b(new_n93_), .c(new_n129_), .O(z15));
  nor2   g84(.a(x21), .b(x20), .O(new_n131_));
  nor2   g85(.a(x23), .b(x22), .O(new_n132_));
  nor2   g86(.a(x25), .b(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n87_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x26), .O(new_n135_));
  nor3   g89(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n132_), .c(new_n131_), .d(new_n87_), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n90_), .b(x07), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(new_n139_), .O(z16));
  nand4  g95(.a(new_n132_), .b(new_n80_), .c(new_n75_), .d(new_n118_), .O(new_n142_));
  nand3  g96(.a(new_n131_), .b(x19), .c(new_n85_), .O(new_n143_));
