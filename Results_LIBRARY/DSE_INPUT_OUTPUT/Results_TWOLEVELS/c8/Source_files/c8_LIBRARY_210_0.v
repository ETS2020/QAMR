...
module FAU ( 
  ...
  aoi21  g21(.a(x27), .b(new_n67_), .c(new_n48_), .O(new_n68_));
  ...
  nand2  g26(.a(new_n54_), .b(new_n72_), .O(new_n73_));
  ...
  nand4  g55(.a(new_n59_), .b(new_n53_), .c(new_n85_), .d(new_n84_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n93_), .c(new_n99_), .O(z11));
  nand2  g59(.a(new_n102_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n87_), .c(new_n53_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g63(.a(new_n90_), .b(x03), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n93_), .c(new_n110_), .O(z12));
  oai21  g65(.a(new_n89_), .b(x04), .c(new_n93_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n96_), .c(new_n108_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n93_), .c(new_n112_), .O(z13));
  aoi21  g69(.a(new_n113_), .b(new_n96_), .c(new_n72_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n100_), .d(new_n84_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n90_), .b(x05), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  oai21  g76(.a(new_n89_), .b(x06), .c(new_n93_), .O(new_n123_));
  ...
  oai21  g81(.a(new_n127_), .b(new_n93_), .c(new_n123_), .O(z15));
  oai21  g82(.a(new_n89_), .b(x07), .c(new_n93_), .O(new_n129_));
  ...
  nand3  g96(.a(new_n130_), .b(x19), .c(new_n84_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n54_), .d(new_n84_), .O(new_n144_));
