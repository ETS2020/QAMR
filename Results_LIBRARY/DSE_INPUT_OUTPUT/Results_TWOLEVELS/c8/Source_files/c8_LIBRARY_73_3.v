...
module FAU ( 
  ...
  aoi21  g065(.a(new_n104_), .b(new_n86_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n86_), .c(new_n96_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n88_), .b(x11), .O(new_n117_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n111_), .c(new_n102_), .O(new_n131_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n95_), .c(x16), .O(new_n137_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n121_), .c(new_n104_), .d(new_n86_), .O(new_n142_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n121_), .c(new_n104_), .d(new_n86_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n95_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nand4  g109(.a(new_n121_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n156_));
