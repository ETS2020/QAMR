...
module FAU ( 
  ...
  oai21  g43(.a(new_n87_), .b(x01), .c(new_n86_), .O(new_n90_));
  ...
  nand4  g52(.a(new_n98_), .b(new_n91_), .c(new_n50_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  nand3  g55(.a(x18), .b(new_n86_), .c(x02), .O(new_n102_));
  oai21  g56(.a(new_n101_), .b(new_n86_), .c(new_n102_), .O(z11));
  oai21  g57(.a(new_n87_), .b(x03), .c(new_n86_), .O(new_n104_));
  nand2  g58(.a(new_n99_), .b(x22), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n84_), .c(new_n91_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n86_), .c(new_n104_), .O(z12));
  oai21  g63(.a(new_n87_), .b(x04), .c(new_n86_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n93_), .c(new_n107_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n86_), .c(new_n110_), .O(z13));
  oai21  g67(.a(new_n87_), .b(x05), .c(new_n86_), .O(new_n114_));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n93_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n96_), .d(new_n82_), .O(new_n118_));
  ...
  oai21  g75(.a(new_n87_), .b(x06), .c(new_n86_), .O(new_n122_));
  nand4  g76(.a(new_n75_), .b(new_n115_), .c(new_n67_), .d(new_n62_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n100_), .c(new_n118_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n86_), .c(new_n122_), .O(z15));
  ...
  nand3  g89(.a(x18), .b(new_n86_), .c(x07), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  inv1   g91(.a(new_n47_), .O(new_n138_));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand3  g93(.a(new_n139_), .b(new_n128_), .c(new_n115_), .O(new_n140_));
  nand3  g94(.a(new_n127_), .b(x19), .c(new_n82_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n51_), .d(new_n82_), .O(new_n142_));
