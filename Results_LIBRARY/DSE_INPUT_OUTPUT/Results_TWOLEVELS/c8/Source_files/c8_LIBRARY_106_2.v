...
module FAU ( 
  ...
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n87_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  nand3  g063(.a(new_n83_), .b(x11), .c(new_n52_), .O(new_n110_));
  ...
  oai21  g072(.a(new_n83_), .b(new_n81_), .c(x04), .O(new_n119_));
  ...
  nand3  g078(.a(new_n83_), .b(new_n81_), .c(x12), .O(new_n125_));
  ...
  aoi21  g084(.a(new_n121_), .b(new_n97_), .c(new_n130_), .O(new_n131_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n129_), .c(new_n87_), .O(z14));
  ...
  nand3  g103(.a(new_n83_), .b(x15), .c(new_n52_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n143_), .c(new_n104_), .d(new_n95_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n132_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n50_), .d(new_n132_), .O(new_n162_));
