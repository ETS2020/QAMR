...
module FAU ( 
  ...
  nand2  g047(.a(new_n93_), .b(x09), .O(new_n94_));
  ...
  nand2  g055(.a(new_n93_), .b(x10), .O(new_n102_));
  ...
  nand2  g064(.a(new_n93_), .b(x11), .O(new_n111_));
  ...
  nand2  g070(.a(new_n108_), .b(x23), .O(new_n117_));
  ...
  nand4  g080(.a(new_n126_), .b(new_n107_), .c(new_n125_), .d(new_n81_), .O(new_n127_));
  ...
  nand3  g093(.a(new_n139_), .b(new_n116_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n136_), .c(new_n98_), .d(new_n89_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n116_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z16));
  inv1   g104(.a(x23), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n105_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n98_), .b(x19), .c(new_n81_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n55_), .b(new_n81_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n116_), .c(new_n79_), .O(z17));
endmodule
