...
module FAU ( 
  ...
  nand2  g044(.a(x18), .b(new_n58_), .O(new_n91_));
  ...
  oai21  g050(.a(new_n83_), .b(new_n94_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n47_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n93_), .O(z10));
  nand3  g053(.a(x18), .b(new_n58_), .c(x02), .O(new_n100_));
  ...
  oai22  g064(.a(new_n91_), .b(new_n110_), .c(x18), .d(new_n61_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n85_), .O(new_n112_));
  nand2  g066(.a(new_n106_), .b(x22), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n83_), .c(new_n94_), .O(new_n115_));
  ...
  oai22  g073(.a(new_n91_), .b(new_n119_), .c(x18), .d(new_n66_), .O(new_n120_));
  ...
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n95_), .d(new_n81_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n130_), .c(new_n47_), .O(z14));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n105_), .d(new_n83_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n140_), .c(new_n47_), .O(z15));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n105_), .d(new_n83_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n105_), .b(x19), .c(new_n81_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n81_), .O(new_n160_));
