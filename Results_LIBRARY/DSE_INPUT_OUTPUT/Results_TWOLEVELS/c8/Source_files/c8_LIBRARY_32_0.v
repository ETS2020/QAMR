...
module FAU ( 
  ...
  aoi21  g70(.a(new_n114_), .b(new_n96_), .c(new_n72_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n108_), .c(new_n100_), .d(new_n84_), .O(new_n119_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n125_));
