...
module FAU ( 
  ...
  nand3  g062(.a(new_n108_), .b(new_n92_), .c(x16), .O(new_n109_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n92_), .c(x16), .O(new_n127_));
  ...
  nand3  g088(.a(new_n92_), .b(new_n86_), .c(x13), .O(new_n135_));
  ...
  nand3  g098(.a(new_n144_), .b(new_n92_), .c(x16), .O(new_n145_));
  ...
  nand3  g106(.a(new_n92_), .b(new_n86_), .c(x15), .O(new_n153_));
