...
module FAU ( 
  ...
  nand2  g055(.a(new_n87_), .b(x02), .O(new_n102_));
  ...
  nand2  g072(.a(new_n87_), .b(x04), .O(new_n119_));
  ...
  aoi21  g076(.a(new_n115_), .b(new_n93_), .c(new_n122_), .O(new_n123_));
  ...
  nand2  g082(.a(new_n87_), .b(x05), .O(new_n129_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n98_), .d(new_n85_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n135_), .c(new_n98_), .d(new_n85_), .O(new_n146_));
  ...
  nand3  g105(.a(new_n98_), .b(x19), .c(new_n83_), .O(new_n152_));
  oai22  g106(.a(new_n152_), .b(new_n151_), .c(new_n52_), .d(new_n83_), .O(new_n153_));
