...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x11), .O(new_n48_));
  ...
  nand2  g045(.a(x18), .b(new_n61_), .O(new_n92_));
  ...
  oai21  g063(.a(x18), .b(new_n86_), .c(x11), .O(new_n110_));
  ...
  nand3  g070(.a(x18), .b(new_n86_), .c(x03), .O(new_n117_));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n104_), .c(new_n69_), .O(new_n131_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n69_), .O(new_n157_));
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n81_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n58_), .d(new_n81_), .O(new_n159_));
