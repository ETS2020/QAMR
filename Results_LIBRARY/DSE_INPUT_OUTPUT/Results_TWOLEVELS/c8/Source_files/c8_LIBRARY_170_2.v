...
module FAU ( 
  ...
  nand3  g071(.a(new_n117_), .b(new_n98_), .c(new_n57_), .O(new_n118_));
  ...
  oai21  g080(.a(new_n126_), .b(new_n93_), .c(x24), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n107_), .c(new_n128_), .d(new_n81_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n117_), .c(new_n99_), .d(new_n84_), .O(new_n139_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n117_), .c(new_n99_), .d(new_n84_), .O(new_n148_));
  ...
  nand2  g105(.a(new_n125_), .b(new_n63_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n99_), .b(x19), .c(new_n81_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n58_), .b(new_n81_), .O(new_n160_));
