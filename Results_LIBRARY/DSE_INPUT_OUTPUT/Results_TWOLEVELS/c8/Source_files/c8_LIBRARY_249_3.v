...
module FAU ( 
  ...
  oai21  g046(.a(new_n79_), .b(new_n89_), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n88_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n87_), .O(z10));
  ...
  nand2  g056(.a(new_n81_), .b(x10), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n102_), .c(new_n96_), .O(z11));
  ...
  nand3  g063(.a(new_n109_), .b(new_n79_), .c(new_n89_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n88_), .c(x16), .O(new_n112_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n99_), .d(new_n79_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n135_), .c(new_n99_), .d(new_n79_), .O(new_n146_));
  ...
  nand3  g104(.a(new_n150_), .b(new_n135_), .c(new_n123_), .O(new_n151_));
  nand3  g105(.a(new_n99_), .b(x19), .c(new_n90_), .O(new_n152_));
  oai22  g106(.a(new_n152_), .b(new_n151_), .c(new_n61_), .d(new_n90_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n88_), .c(x16), .O(new_n154_));
