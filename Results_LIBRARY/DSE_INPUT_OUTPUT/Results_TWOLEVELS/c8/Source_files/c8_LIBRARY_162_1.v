...
module FAU ( 
  ...
  nor2   g048(.a(new_n87_), .b(new_n54_), .O(new_n95_));
  nor3   g049(.a(x20), .b(x19), .c(x17), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n95_), .c(x16), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n94_), .c(new_n85_), .O(z10));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n85_), .O(z11));
  ...
  aoi21  g065(.a(new_n103_), .b(new_n87_), .c(new_n111_), .O(new_n112_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n85_), .O(z12));
  ...
  nand3  g085(.a(new_n54_), .b(new_n131_), .c(new_n130_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n85_), .c(x16), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n122_), .c(new_n103_), .d(new_n87_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n85_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n122_), .c(new_n103_), .d(new_n87_), .O(new_n155_));
  ...
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n130_), .O(new_n163_));
