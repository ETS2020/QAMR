...
module FAU ( 
  ...
  aoi21  g035(.a(new_n66_), .b(new_n67_), .c(new_n54_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  nand2  g037(.a(x18), .b(x00), .O(new_n84_));
  nand2  g038(.a(new_n66_), .b(x13), .O(new_n85_));
  ...
  or2    g051(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n88_), .c(x16), .O(new_n99_));
  ...
  oai21  g084(.a(new_n66_), .b(new_n83_), .c(new_n85_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n124_), .c(x24), .O(new_n132_));
  inv1   g086(.a(x17), .O(new_n133_));
  inv1   g087(.a(x19), .O(new_n134_));
  inv1   g088(.a(x22), .O(new_n135_));
  inv1   g089(.a(x23), .O(new_n136_));
  aoi21  g090(.a(new_n66_), .b(new_n67_), .c(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n104_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(x20), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n134_), .c(new_n133_), .d(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n132_), .c(new_n130_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n66_), .b(x14), .c(x13), .O(new_n143_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n114_), .c(new_n97_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n123_), .c(new_n105_), .d(new_n95_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n88_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n145_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai21  g108(.a(x18), .b(new_n77_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n83_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  inv1   g111(.a(x24), .O(new_n158_));
  nand4  g112(.a(new_n123_), .b(new_n79_), .c(new_n74_), .d(new_n158_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n106_), .c(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n88_), .O(z16));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n133_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n54_), .d(new_n133_), .O(new_n164_));
