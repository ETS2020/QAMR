...
module FAU ( 
  ...
  oai21  g037(.a(x18), .b(new_n48_), .c(new_n55_), .O(z08));
  ...
  nand3  g043(.a(new_n85_), .b(new_n48_), .c(x08), .O(new_n90_));
  ...
  nand2  g047(.a(new_n93_), .b(new_n48_), .O(new_n94_));
  ...
  nand3  g107(.a(x18), .b(new_n48_), .c(x07), .O(new_n154_));
