...
module FAU ( 
  ...
  nand4  g54(.a(new_n60_), .b(new_n93_), .c(new_n51_), .d(new_n85_), .O(new_n101_));
  ...
  oai22  g60(.a(new_n106_), .b(new_n89_), .c(new_n90_), .d(new_n63_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n89_), .O(new_n108_));
  ...
  oai21  g66(.a(new_n112_), .b(new_n89_), .c(new_n108_), .O(z13));
  ...
  nand4  g71(.a(new_n117_), .b(new_n109_), .c(new_n99_), .d(new_n85_), .O(new_n118_));
  ...
  nand4  g76(.a(new_n76_), .b(new_n115_), .c(new_n68_), .d(new_n122_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n102_), .c(new_n118_), .d(x25), .O(new_n125_));
  nand3  g79(.a(new_n47_), .b(new_n89_), .c(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n89_), .c(new_n126_), .O(z15));
  oai21  g81(.a(x18), .b(x15), .c(new_n89_), .O(new_n128_));
  ...
  nand4  g93(.a(new_n130_), .b(new_n81_), .c(new_n76_), .d(new_n115_), .O(new_n140_));
