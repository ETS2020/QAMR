...
module FAU ( 
  ...
  oai21  g038(.a(new_n84_), .b(new_n47_), .c(new_n82_), .O(new_n85_));
  nand2  g039(.a(new_n85_), .b(new_n81_), .O(new_n86_));
  inv1   g040(.a(x17), .O(new_n87_));
  inv1   g041(.a(x19), .O(new_n88_));
  nor3   g042(.a(new_n49_), .b(new_n88_), .c(new_n87_), .O(new_n89_));
  inv1   g043(.a(x20), .O(new_n90_));
  oai21  g044(.a(x24), .b(new_n90_), .c(x18), .O(new_n91_));
  aoi21  g045(.a(new_n91_), .b(x24), .c(x19), .O(new_n92_));
  ...
  oai21  g049(.a(new_n84_), .b(new_n52_), .c(new_n95_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n81_), .O(new_n97_));
  inv1   g051(.a(new_n49_), .O(new_n98_));
  nor2   g052(.a(x19), .b(x17), .O(new_n99_));
  nor2   g053(.a(new_n99_), .b(new_n90_), .O(new_n100_));
  ...
  nand2  g057(.a(new_n103_), .b(new_n97_), .O(z10));
  ...
  nand3  g065(.a(new_n111_), .b(new_n107_), .c(new_n98_), .O(z11));
  nand2  g066(.a(x18), .b(x03), .O(new_n113_));
  oai21  g067(.a(new_n84_), .b(new_n61_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n81_), .O(new_n115_));
  nand3  g069(.a(new_n109_), .b(new_n98_), .c(x22), .O(new_n116_));
  oai21  g070(.a(x24), .b(new_n66_), .c(x18), .O(new_n117_));
  aoi21  g071(.a(new_n117_), .b(x24), .c(x22), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n57_), .c(new_n90_), .d(new_n88_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(x17), .c(new_n116_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n115_), .O(z12));
  nand2  g076(.a(x18), .b(x04), .O(new_n123_));
  oai21  g077(.a(new_n84_), .b(new_n64_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n81_), .O(new_n125_));
  nor2   g079(.a(x22), .b(x21), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n99_), .c(new_n90_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x23), .O(new_n128_));
  nor2   g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n101_), .c(new_n57_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n98_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n125_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  oai21  g088(.a(new_n84_), .b(new_n69_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n81_), .O(new_n136_));
  inv1   g090(.a(x22), .O(new_n137_));
  nand4  g091(.a(x23), .b(new_n137_), .c(new_n57_), .d(new_n90_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n90_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(x24), .c(x18), .O(new_n140_));
  nand4  g094(.a(new_n108_), .b(new_n48_), .c(new_n66_), .d(new_n137_), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n140_), .c(x19), .O(new_n142_));
  nand2  g096(.a(new_n126_), .b(new_n99_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(x24), .c(x18), .O(new_n144_));
  inv1   g098(.a(new_n144_), .O(new_n145_));
  aoi21  g099(.a(new_n142_), .b(new_n87_), .c(new_n145_), .O(new_n146_));
  oai21  g100(.a(new_n146_), .b(new_n81_), .c(new_n136_), .O(z14));
  nand2  g101(.a(x18), .b(x06), .O(new_n148_));
  oai21  g102(.a(new_n84_), .b(new_n72_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n81_), .O(new_n150_));
  nand2  g104(.a(new_n130_), .b(x25), .O(new_n151_));
  nor2   g105(.a(x25), .b(x23), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n126_), .c(new_n101_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n151_), .c(x24), .O(new_n154_));
  nand3  g108(.a(x25), .b(x24), .c(x18), .O(new_n155_));
  ...
  oai21  g113(.a(new_n84_), .b(new_n75_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n81_), .O(new_n161_));
  nand2  g115(.a(new_n153_), .b(x26), .O(new_n162_));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n129_), .c(new_n108_), .d(new_n99_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(x24), .O(new_n165_));
  nand3  g119(.a(x26), .b(x24), .c(x18), .O(new_n166_));
  ...
  nand3  g123(.a(new_n108_), .b(x19), .c(new_n87_), .O(new_n170_));
  nand3  g124(.a(new_n163_), .b(new_n129_), .c(new_n48_), .O(new_n171_));
  oai22  g125(.a(new_n171_), .b(new_n170_), .c(new_n58_), .d(new_n87_), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(x16), .O(new_n173_));
  nand2  g127(.a(new_n173_), .b(new_n98_), .O(z17));
endmodule
