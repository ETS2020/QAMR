...
module FAU ( 
  ...
  oai21  g052(.a(x16), .b(x02), .c(x18), .O(new_n99_));
  ...
  nand2  g058(.a(new_n96_), .b(x10), .O(new_n105_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n110_), .c(x16), .O(new_n115_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n94_), .c(new_n100_), .O(new_n120_));
  ...
  nand3  g084(.a(new_n68_), .b(new_n63_), .c(new_n100_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n112_), .c(new_n133_), .d(new_n128_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n110_), .c(x16), .O(new_n137_));
  ...
  nand2  g094(.a(new_n140_), .b(new_n88_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n101_), .d(new_n92_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n110_), .c(x16), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n101_), .d(new_n92_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n96_), .b(x15), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n119_), .c(new_n73_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n128_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n128_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n110_), .c(x16), .O(new_n160_));
