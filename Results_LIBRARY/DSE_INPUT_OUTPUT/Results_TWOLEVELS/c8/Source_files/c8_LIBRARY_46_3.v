...
module FAU ( 
  ...
  nand3  g070(.a(new_n116_), .b(new_n92_), .c(x16), .O(new_n117_));
  ...
  nand2  g096(.a(new_n107_), .b(x14), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n138_), .c(new_n103_), .d(new_n94_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n92_), .c(x16), .O(new_n152_));
  ...
  nand3  g110(.a(new_n79_), .b(new_n156_), .c(new_n128_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n95_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n52_), .b(new_n95_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n92_), .c(new_n86_), .O(z17));
endmodule
