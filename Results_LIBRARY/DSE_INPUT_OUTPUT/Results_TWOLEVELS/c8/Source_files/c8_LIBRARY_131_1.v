...
module FAU ( 
  ...
  nand2  g32(.a(new_n78_), .b(new_n55_), .O(z08));
  ...
  oai21  g40(.a(new_n86_), .b(new_n47_), .c(new_n84_), .O(z09));
  inv1   g41(.a(x16), .O(new_n88_));
  oai21  g42(.a(x18), .b(x09), .c(new_n88_), .O(new_n89_));
  nor2   g43(.a(new_n83_), .b(new_n54_), .O(new_n90_));
  ...
  oai21  g47(.a(x18), .b(x10), .c(new_n88_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n80_), .O(new_n96_));
  inv1   g50(.a(x21), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n54_), .c(new_n81_), .d(new_n80_), .O(new_n98_));
  ...
  nand3  g58(.a(new_n104_), .b(new_n83_), .c(new_n54_), .O(new_n105_));
  ...
  oai22  g63(.a(new_n109_), .b(new_n88_), .c(new_n86_), .d(new_n64_), .O(z13));
  oai21  g64(.a(x18), .b(x13), .c(new_n88_), .O(new_n111_));
  aoi21  g65(.a(new_n108_), .b(new_n91_), .c(new_n69_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n104_), .c(new_n95_), .d(new_n80_), .O(new_n114_));
  ...
  nand2  g77(.a(new_n85_), .b(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n88_), .c(new_n124_), .O(z15));
  ...
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n69_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n80_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n55_), .d(new_n80_), .O(new_n140_));
