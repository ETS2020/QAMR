...
module FAU ( 
  ...
  nand3  g071(.a(new_n117_), .b(new_n94_), .c(x16), .O(new_n118_));
  ...
  nor2   g079(.a(x18), .b(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x12), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n125_), .c(new_n120_), .O(z13));
  oai21  g082(.a(x16), .b(x05), .c(x18), .O(new_n129_));
  inv1   g083(.a(x24), .O(new_n130_));
  aoi21  g084(.a(new_n122_), .b(new_n105_), .c(new_n130_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n115_), .c(new_n97_), .d(new_n96_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n126_), .b(x13), .O(new_n136_));
  ...
  nand2  g107(.a(new_n126_), .b(x15), .O(new_n154_));
  ...
  nand3  g111(.a(new_n106_), .b(x19), .c(new_n96_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n96_), .O(new_n159_));
