...
module FAU ( 
  ...
  nand2  g21(.a(new_n57_), .b(new_n67_), .O(new_n68_));
  ...
  nand2  g26(.a(new_n57_), .b(new_n72_), .O(new_n73_));
  aoi21  g27(.a(new_n73_), .b(new_n71_), .c(new_n48_), .O(z05));
  inv1   g28(.a(x14), .O(new_n75_));
  aoi21  g29(.a(x27), .b(new_n75_), .c(new_n48_), .O(new_n76_));
  oai21  g30(.a(x27), .b(x25), .c(new_n76_), .O(z06));
  ...
  nand4  g52(.a(new_n56_), .b(new_n92_), .c(new_n83_), .d(new_n82_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  nor2   g55(.a(new_n88_), .b(x16), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(x02), .O(new_n103_));
  oai21  g57(.a(new_n101_), .b(new_n87_), .c(new_n103_), .O(z11));
  oai21  g58(.a(new_n88_), .b(x03), .c(new_n87_), .O(new_n105_));
  nand2  g59(.a(new_n99_), .b(x22), .O(new_n106_));
  ...
  aoi21  g68(.a(new_n112_), .b(new_n94_), .c(new_n72_), .O(new_n115_));
  ...
  nand2  g73(.a(new_n102_), .b(x05), .O(new_n120_));
  nand2  g74(.a(new_n120_), .b(new_n119_), .O(z14));
  oai21  g75(.a(new_n88_), .b(x06), .c(new_n87_), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n124_));
