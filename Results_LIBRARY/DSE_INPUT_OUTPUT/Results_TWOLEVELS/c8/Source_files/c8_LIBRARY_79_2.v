...
module FAU ( 
  ...
  oai21  g067(.a(x16), .b(x11), .c(new_n52_), .O(new_n114_));
  aoi21  g068(.a(new_n109_), .b(new_n94_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n94_), .c(new_n55_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n96_), .b(x03), .O(new_n120_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n101_), .c(new_n60_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n55_), .b(new_n47_), .c(new_n92_), .O(new_n134_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n137_), .d(new_n92_), .O(new_n139_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n126_), .c(new_n109_), .d(new_n94_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n126_), .b(new_n85_), .c(new_n80_), .d(new_n77_), .O(new_n160_));
  nand3  g114(.a(new_n109_), .b(x19), .c(new_n92_), .O(new_n161_));
