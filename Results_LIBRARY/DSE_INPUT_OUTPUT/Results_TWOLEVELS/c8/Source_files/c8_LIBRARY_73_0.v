...
module FAU ( 
  ...
  oai21  g58(.a(new_n87_), .b(x03), .c(new_n86_), .O(new_n105_));
  nand2  g59(.a(new_n101_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n84_), .c(new_n90_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n86_), .c(new_n105_), .O(z12));
  ...
  aoi21  g68(.a(new_n112_), .b(new_n92_), .c(new_n68_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n107_), .c(new_n98_), .d(new_n82_), .O(new_n117_));
  ...
  oai21  g81(.a(new_n127_), .b(new_n86_), .c(new_n122_), .O(z15));
  ...
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n86_), .O(z17));
endmodule
