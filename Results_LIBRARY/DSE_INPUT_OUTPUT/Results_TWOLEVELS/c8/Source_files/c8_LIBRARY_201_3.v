...
module FAU ( 
  ...
  oai21  g020(.a(new_n66_), .b(x18), .c(new_n65_), .O(z03));
  ...
  nand2  g042(.a(x18), .b(new_n63_), .O(new_n89_));
  ...
  nor2   g054(.a(new_n93_), .b(new_n57_), .O(new_n101_));
  nor3   g055(.a(x20), .b(x19), .c(x17), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n101_), .c(x16), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n100_), .c(new_n47_), .O(z10));
  inv1   g058(.a(x02), .O(new_n105_));
  oai22  g059(.a(new_n89_), .b(new_n105_), .c(x18), .d(new_n60_), .O(new_n106_));
  ...
  oai21  g067(.a(x18), .b(new_n87_), .c(x11), .O(new_n114_));
  aoi21  g068(.a(new_n109_), .b(new_n93_), .c(new_n64_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n93_), .c(new_n57_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(x18), .b(new_n87_), .c(x03), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n119_), .c(new_n114_), .O(z12));
  inv1   g075(.a(x04), .O(new_n122_));
  oai22  g076(.a(new_n89_), .b(new_n122_), .c(x18), .d(new_n68_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n87_), .O(new_n124_));
  nand2  g078(.a(new_n117_), .b(x23), .O(new_n125_));
  nor2   g079(.a(x23), .b(x22), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n102_), .c(new_n108_), .O(new_n127_));
  ...
  oai22  g085(.a(new_n89_), .b(new_n131_), .c(x18), .d(new_n73_), .O(new_n132_));
  ...
  nand3  g089(.a(new_n70_), .b(new_n64_), .c(new_n108_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n116_), .c(new_n138_), .d(new_n134_), .O(new_n140_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n109_), .d(new_n93_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n109_), .d(new_n93_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n126_), .c(new_n75_), .O(new_n163_));
  nand3  g117(.a(new_n109_), .b(x19), .c(new_n134_), .O(new_n164_));
