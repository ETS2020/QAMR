...
module FAU ( 
  ...
  nand3  g093(.a(new_n139_), .b(new_n48_), .c(x14), .O(new_n140_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n84_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n142_), .O(z15));
  nand2  g103(.a(new_n146_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n144_), .c(new_n105_), .d(new_n88_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nor2   g108(.a(new_n139_), .b(x16), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(x07), .c(new_n49_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n144_), .c(new_n73_), .O(new_n159_));
  nand3  g113(.a(new_n105_), .b(x19), .c(new_n85_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n85_), .O(new_n161_));
