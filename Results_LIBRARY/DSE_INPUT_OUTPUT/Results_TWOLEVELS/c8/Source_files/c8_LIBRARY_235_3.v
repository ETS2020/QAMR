...
module FAU ( 
  ...
  nand2  g005(.a(x18), .b(x04), .O(new_n52_));
  ...
  inv1   g042(.a(x04), .O(new_n89_));
  nand2  g043(.a(x18), .b(new_n89_), .O(new_n90_));
  oai22  g044(.a(new_n90_), .b(new_n88_), .c(x18), .d(new_n47_), .O(new_n91_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n52_), .c(x16), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n92_), .O(z09));
  inv1   g052(.a(x01), .O(new_n99_));
  oai22  g053(.a(new_n90_), .b(new_n99_), .c(x18), .d(new_n55_), .O(new_n100_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n52_), .c(x16), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n101_), .O(z10));
  ...
  nand2  g066(.a(new_n112_), .b(new_n94_), .O(new_n113_));
  oai21  g067(.a(new_n111_), .b(new_n62_), .c(new_n113_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n52_), .O(z11));
  nand2  g070(.a(x18), .b(x03), .O(new_n117_));
  oai21  g071(.a(x18), .b(new_n65_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n87_), .O(new_n119_));
  aoi21  g073(.a(new_n112_), .b(new_n94_), .c(new_n67_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n94_), .c(new_n57_), .O(new_n122_));
  inv1   g076(.a(new_n122_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n52_), .O(z12));
  nor3   g079(.a(x23), .b(x22), .c(x21), .O(new_n126_));
  aoi22  g080(.a(new_n126_), .b(new_n111_), .c(new_n122_), .d(x23), .O(new_n127_));
  nor2   g081(.a(x18), .b(x16), .O(new_n128_));
  aoi21  g082(.a(new_n128_), .b(x12), .c(new_n53_), .O(new_n129_));
  oai21  g083(.a(new_n127_), .b(new_n87_), .c(new_n129_), .O(z13));
  ...
  aoi21  g088(.a(new_n126_), .b(new_n111_), .c(new_n134_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n121_), .c(new_n103_), .d(new_n102_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n133_), .c(new_n52_), .O(z14));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n112_), .d(new_n94_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n151_), .b(x04), .c(x18), .d(new_n83_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n87_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n112_), .d(new_n94_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n52_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n145_), .c(new_n134_), .O(new_n161_));
  nand3  g115(.a(new_n112_), .b(x19), .c(new_n102_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n50_), .d(new_n102_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n52_), .O(z17));
endmodule
