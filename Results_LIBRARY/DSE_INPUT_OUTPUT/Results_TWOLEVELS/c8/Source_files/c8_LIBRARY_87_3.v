...
module FAU ( 
  ...
  aoi21  g062(.a(new_n102_), .b(new_n85_), .c(new_n108_), .O(new_n109_));
  ...
  nand2  g067(.a(new_n87_), .b(x11), .O(new_n114_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n102_), .d(new_n85_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n100_), .c(x16), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n138_), .c(new_n102_), .d(new_n85_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n87_), .b(x15), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  nand2  g105(.a(new_n66_), .b(new_n108_), .O(new_n152_));
  inv1   g106(.a(x25), .O(new_n153_));
  nand3  g107(.a(new_n77_), .b(new_n153_), .c(new_n125_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n102_), .b(x19), .c(new_n82_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n55_), .b(new_n82_), .O(new_n158_));
  aoi21  g112(.a(new_n157_), .b(new_n155_), .c(new_n158_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n100_), .c(new_n96_), .O(z17));
endmodule
