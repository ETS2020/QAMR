...
module FAU ( 
  ...
  nand2  g044(.a(x18), .b(new_n65_), .O(new_n91_));
  ...
  nor2   g056(.a(new_n95_), .b(new_n57_), .O(new_n103_));
  nor3   g057(.a(x20), .b(x19), .c(x17), .O(new_n104_));
  oai21  g058(.a(new_n104_), .b(new_n103_), .c(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n102_), .c(new_n47_), .O(z10));
  ...
  oai21  g065(.a(new_n104_), .b(new_n62_), .c(new_n111_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x16), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n109_), .c(new_n47_), .O(z11));
  oai21  g068(.a(x18), .b(new_n89_), .c(x11), .O(new_n115_));
  aoi21  g069(.a(new_n110_), .b(new_n95_), .c(new_n66_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n95_), .c(new_n57_), .O(new_n118_));
  inv1   g072(.a(new_n118_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand3  g074(.a(x18), .b(new_n89_), .c(x03), .O(new_n121_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n110_), .d(new_n95_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n146_), .c(new_n47_), .O(z15));
  inv1   g107(.a(x07), .O(new_n154_));
  oai22  g108(.a(new_n91_), .b(new_n154_), .c(x18), .d(new_n83_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n110_), .d(new_n95_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n47_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n156_), .O(z16));
  nand4  g116(.a(new_n148_), .b(new_n85_), .c(new_n80_), .d(new_n135_), .O(new_n163_));
  nand3  g117(.a(new_n110_), .b(x19), .c(new_n137_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n137_), .O(new_n165_));
