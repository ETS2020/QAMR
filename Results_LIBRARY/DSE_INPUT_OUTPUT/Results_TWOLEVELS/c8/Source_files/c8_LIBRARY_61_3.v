...
module FAU ( 
  ...
  nor2   g035(.a(x16), .b(new_n49_), .O(new_n82_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n90_), .c(x16), .O(new_n106_));
  ...
  nand3  g090(.a(new_n136_), .b(new_n90_), .c(x16), .O(new_n137_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n121_), .c(new_n103_), .d(new_n92_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n90_), .c(x16), .O(new_n146_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n90_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z16));
  nor2   g110(.a(x26), .b(x25), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n121_), .c(new_n69_), .O(new_n158_));
  nand3  g112(.a(new_n103_), .b(x19), .c(new_n93_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n52_), .d(new_n93_), .O(new_n160_));
