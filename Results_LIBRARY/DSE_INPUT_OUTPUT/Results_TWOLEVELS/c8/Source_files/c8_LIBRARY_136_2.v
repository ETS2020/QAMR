...
module FAU ( 
  ...
  inv1   g010(.a(new_n53_), .O(new_n57_));
  ...
  nand3  g030(.a(new_n76_), .b(new_n74_), .c(new_n53_), .O(z05));
  ...
  aoi21  g040(.a(new_n86_), .b(new_n84_), .c(new_n57_), .O(z07));
  nor2   g041(.a(new_n57_), .b(new_n48_), .O(z08));
  ...
  nor2   g055(.a(new_n91_), .b(new_n52_), .O(new_n102_));
  nor3   g056(.a(x20), .b(x19), .c(x17), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n102_), .c(x16), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n101_), .c(new_n53_), .O(z10));
  inv1   g059(.a(x02), .O(new_n106_));
  nand2  g060(.a(x20), .b(x18), .O(new_n107_));
  oai22  g061(.a(new_n107_), .b(new_n106_), .c(x18), .d(new_n58_), .O(new_n108_));
  ...
  aoi21  g066(.a(new_n112_), .b(new_n110_), .c(x18), .O(new_n113_));
  nor2   g067(.a(new_n60_), .b(new_n52_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n113_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n109_), .O(z11));
  ...
  inv1   g073(.a(x18), .O(new_n120_));
  nand2  g074(.a(new_n89_), .b(x16), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n47_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n121_), .c(new_n120_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n52_), .O(new_n125_));
  nand3  g079(.a(new_n112_), .b(x22), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n125_), .c(new_n119_), .O(z12));
  inv1   g081(.a(x04), .O(new_n128_));
  oai22  g082(.a(new_n107_), .b(new_n128_), .c(x18), .d(new_n68_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n93_), .O(new_n130_));
  nand2  g084(.a(new_n122_), .b(new_n91_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n103_), .c(new_n60_), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n132_), .c(x18), .O(new_n135_));
  nor2   g089(.a(new_n70_), .b(new_n52_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x16), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n130_), .O(z13));
  nand2  g092(.a(x18), .b(x05), .O(new_n139_));
  oai21  g093(.a(x18), .b(new_n75_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n93_), .O(new_n141_));
  nor2   g095(.a(x24), .b(x23), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n122_), .c(new_n91_), .d(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n120_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n52_), .O(new_n145_));
  nand3  g099(.a(new_n134_), .b(x24), .c(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n145_), .c(new_n141_), .O(z14));
  inv1   g101(.a(x06), .O(new_n148_));
  oai22  g102(.a(new_n107_), .b(new_n148_), .c(x18), .d(new_n80_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n93_), .O(new_n150_));
  nand3  g104(.a(new_n60_), .b(new_n47_), .c(new_n89_), .O(new_n151_));
  nand3  g105(.a(new_n73_), .b(new_n70_), .c(new_n65_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(new_n151_), .c(x25), .O(new_n153_));
  nor2   g107(.a(x25), .b(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n133_), .c(new_n111_), .d(new_n91_), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(new_n153_), .c(x18), .O(new_n156_));
  nor2   g110(.a(new_n78_), .b(new_n52_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n156_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n150_), .O(z15));
  inv1   g113(.a(x07), .O(new_n160_));
  oai22  g114(.a(new_n107_), .b(new_n160_), .c(x18), .d(new_n83_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n93_), .O(new_n162_));
  nor2   g116(.a(x21), .b(x19), .O(new_n163_));
  nand4  g117(.a(new_n154_), .b(new_n163_), .c(new_n133_), .d(new_n89_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor3   g119(.a(x26), .b(x25), .c(x24), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n133_), .c(new_n111_), .d(new_n91_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(x18), .O(new_n168_));
  nor2   g122(.a(new_n85_), .b(new_n52_), .O(new_n169_));
  ...
  nand2  g126(.a(new_n111_), .b(x19), .O(new_n173_));
  nor3   g127(.a(new_n173_), .b(x18), .c(x17), .O(new_n174_));
  nand3  g128(.a(new_n174_), .b(new_n166_), .c(new_n133_), .O(new_n175_));
  aoi21  g129(.a(new_n175_), .b(new_n172_), .c(new_n93_), .O(z17));
endmodule
