...
module FAU ( 
  ...
  nand3  g045(.a(new_n91_), .b(new_n87_), .c(new_n48_), .O(z09));
  ...
  nand2  g055(.a(new_n96_), .b(x18), .O(new_n102_));
  oai22  g056(.a(new_n102_), .b(new_n101_), .c(x18), .d(new_n55_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  oai21  g058(.a(x19), .b(x17), .c(x21), .O(new_n105_));
  nand3  g059(.a(new_n57_), .b(new_n84_), .c(new_n83_), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(new_n105_), .c(x20), .O(new_n107_));
  nor3   g061(.a(new_n57_), .b(new_n96_), .c(x18), .O(new_n108_));
  ...
  oai21  g068(.a(new_n63_), .b(new_n88_), .c(new_n114_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x20), .O(new_n116_));
  nand2  g070(.a(new_n106_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n86_), .c(new_n96_), .O(new_n119_));
  ...
  oai22  g077(.a(new_n102_), .b(new_n123_), .c(x18), .d(new_n66_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n88_), .O(new_n125_));
  nand2  g079(.a(new_n118_), .b(new_n86_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n86_), .c(new_n57_), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(new_n127_), .c(x20), .O(new_n130_));
  nor3   g084(.a(new_n68_), .b(new_n96_), .c(x18), .O(new_n131_));
  ...
  oai21  g091(.a(new_n137_), .b(new_n88_), .c(new_n114_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x20), .O(new_n139_));
  nand2  g093(.a(new_n129_), .b(x24), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n118_), .c(new_n98_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n136_), .O(z14));
  inv1   g099(.a(x06), .O(new_n146_));
  oai22  g100(.a(new_n102_), .b(new_n146_), .c(x18), .d(new_n74_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n88_), .O(new_n148_));
  nand3  g102(.a(new_n137_), .b(new_n68_), .c(new_n63_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n106_), .c(x25), .O(new_n150_));
  nor2   g104(.a(x21), .b(x19), .O(new_n151_));
  nor2   g105(.a(x25), .b(x24), .O(new_n152_));
  nand4  g106(.a(new_n152_), .b(new_n128_), .c(new_n151_), .d(new_n83_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n150_), .c(x20), .O(new_n154_));
  nand2  g108(.a(x25), .b(x20), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(x18), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n154_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n148_), .O(z15));
  inv1   g112(.a(x07), .O(new_n159_));
  oai22  g113(.a(new_n102_), .b(new_n159_), .c(x18), .d(new_n77_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n88_), .O(new_n161_));
  nand2  g115(.a(new_n153_), .b(x26), .O(new_n162_));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n141_), .c(new_n118_), .d(new_n86_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n162_), .c(x20), .O(new_n165_));
  nor3   g119(.a(new_n79_), .b(new_n96_), .c(x18), .O(new_n166_));
  ...
  nand4  g123(.a(new_n57_), .b(new_n96_), .c(x19), .d(new_n83_), .O(new_n170_));
  inv1   g124(.a(new_n170_), .O(new_n171_));
  nand4  g125(.a(new_n171_), .b(new_n163_), .c(new_n128_), .d(new_n137_), .O(new_n172_));
  aoi21  g126(.a(new_n172_), .b(new_n169_), .c(new_n88_), .O(z17));
endmodule
