...
module FAU ( 
  ...
  aoi21  g081(.a(new_n121_), .b(new_n97_), .c(new_n127_), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n112_), .c(new_n129_), .d(new_n87_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n128_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n91_), .b(x05), .O(new_n134_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n102_), .d(new_n89_), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n102_), .d(new_n89_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n91_), .b(x07), .O(new_n152_));
  ...
  nand3  g109(.a(new_n81_), .b(new_n76_), .c(new_n127_), .O(new_n156_));
  ...
  nor2   g113(.a(new_n52_), .b(new_n87_), .O(new_n160_));
