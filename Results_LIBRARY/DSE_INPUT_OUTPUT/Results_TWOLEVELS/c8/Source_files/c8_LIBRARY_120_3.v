...
module FAU ( 
  ...
  nand3  g079(.a(new_n125_), .b(new_n100_), .c(new_n104_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n47_), .O(z13));
  inv1   g083(.a(x05), .O(new_n130_));
  oai22  g084(.a(new_n112_), .b(new_n130_), .c(x18), .d(new_n73_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n91_), .O(new_n132_));
  nand3  g086(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n133_));
  nand3  g087(.a(new_n70_), .b(new_n65_), .c(new_n104_), .O(new_n134_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n105_), .d(new_n89_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n47_), .O(z15));
  inv1   g104(.a(x07), .O(new_n151_));
  oai22  g105(.a(new_n112_), .b(new_n151_), .c(x18), .d(new_n81_), .O(new_n152_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n125_), .c(new_n105_), .d(new_n89_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n47_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n125_), .c(new_n75_), .O(new_n161_));
  nand3  g115(.a(new_n105_), .b(x19), .c(new_n87_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n87_), .O(new_n163_));
