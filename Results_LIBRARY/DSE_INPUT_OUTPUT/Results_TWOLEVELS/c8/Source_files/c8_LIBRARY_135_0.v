...
module FAU ( 
  ...
  nand4  g50(.a(new_n59_), .b(new_n89_), .c(new_n50_), .d(new_n80_), .O(new_n97_));
  ...
  nand3  g56(.a(new_n102_), .b(new_n82_), .c(new_n89_), .O(new_n103_));
  and2   g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  nor2   g58(.a(new_n85_), .b(x16), .O(new_n105_));
  nand2  g59(.a(new_n105_), .b(x03), .O(new_n106_));
  oai21  g60(.a(new_n104_), .b(new_n84_), .c(new_n106_), .O(z12));
  oai21  g61(.a(new_n85_), .b(x04), .c(new_n84_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n91_), .c(new_n103_), .d(x23), .O(new_n110_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n102_), .c(new_n95_), .d(new_n80_), .O(new_n116_));
  ...
  nand4  g75(.a(new_n73_), .b(new_n113_), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n98_), .c(new_n116_), .d(x25), .O(new_n124_));
  nand2  g78(.a(new_n105_), .b(x06), .O(new_n125_));
  ...
  nand2  g89(.a(new_n105_), .b(x07), .O(new_n136_));
