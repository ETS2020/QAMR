...
module FAU ( 
  ...
  aoi21  g029(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n76_));
  ...
  aoi22  g046(.a(new_n85_), .b(x09), .c(x18), .d(x01), .O(new_n93_));
  ...
  oai21  g052(.a(new_n93_), .b(x16), .c(new_n98_), .O(z10));
  ...
  nand2  g057(.a(new_n103_), .b(new_n100_), .O(new_n104_));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n88_), .c(new_n63_), .O(new_n115_));
  ...
  nand2  g076(.a(new_n122_), .b(new_n100_), .O(new_n123_));
  ...
  nand2  g085(.a(new_n131_), .b(new_n100_), .O(new_n132_));
  aoi21  g086(.a(new_n125_), .b(new_n106_), .c(new_n73_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n116_), .c(new_n95_), .d(new_n94_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n132_), .c(new_n83_), .O(z14));
  nand2  g092(.a(new_n135_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n107_), .d(new_n88_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n83_), .c(x16), .O(new_n144_));
  nand3  g098(.a(x18), .b(new_n100_), .c(x06), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n140_), .c(new_n107_), .d(new_n88_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n107_), .b(x19), .c(new_n94_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n94_), .O(new_n161_));
