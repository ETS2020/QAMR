...
module FAU ( 
  ...
  nand2  g17(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g18(.a(new_n64_), .b(new_n61_), .c(new_n48_), .O(z04));
  ...
  nand2  g28(.a(new_n63_), .b(new_n74_), .O(new_n75_));
  aoi21  g29(.a(new_n75_), .b(new_n73_), .c(new_n48_), .O(z07));
  inv1   g30(.a(new_n48_), .O(new_n77_));
  nand2  g31(.a(new_n77_), .b(new_n63_), .O(z08));
  ...
  nand3  g38(.a(x18), .b(new_n84_), .c(x00), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(new_n83_), .O(z09));
  inv1   g40(.a(x18), .O(new_n87_));
  oai21  g41(.a(new_n87_), .b(x01), .c(new_n84_), .O(new_n88_));
  ...
  oai21  g47(.a(new_n87_), .b(x02), .c(new_n84_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n79_), .O(new_n96_));
  inv1   g50(.a(x21), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n89_), .c(new_n80_), .d(new_n79_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n96_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n84_), .c(new_n94_), .O(z11));
  oai21  g55(.a(new_n87_), .b(x03), .c(new_n84_), .O(new_n102_));
  ...
  oai21  g61(.a(new_n87_), .b(x04), .c(new_n84_), .O(new_n108_));
  ...
  oai21  g65(.a(new_n87_), .b(x05), .c(new_n84_), .O(new_n112_));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n109_), .b(new_n91_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n104_), .c(new_n95_), .d(new_n79_), .O(new_n116_));
  ...
  oai21  g73(.a(new_n87_), .b(x06), .c(new_n84_), .O(new_n120_));
  inv1   g74(.a(x22), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n113_), .c(new_n62_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n99_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n84_), .c(new_n120_), .O(z15));
  ...
  nand3  g89(.a(x18), .b(new_n84_), .c(x07), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  nand4  g91(.a(new_n128_), .b(new_n74_), .c(new_n122_), .d(new_n113_), .O(new_n138_));
  nand3  g92(.a(new_n127_), .b(x19), .c(new_n79_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n63_), .d(new_n79_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n77_), .O(z17));
endmodule
