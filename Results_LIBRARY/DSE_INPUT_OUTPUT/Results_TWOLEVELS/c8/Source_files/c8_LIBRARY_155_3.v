...
module FAU ( 
  ...
  nand4  g085(.a(new_n131_), .b(new_n114_), .c(new_n96_), .d(new_n84_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n88_), .b(x13), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n105_), .d(new_n86_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n88_), .b(x14), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n139_), .c(new_n105_), .d(new_n86_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n88_), .b(x15), .O(new_n152_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n156_), .c(new_n129_), .O(new_n158_));
  nor2   g112(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand3  g113(.a(new_n105_), .b(x19), .c(new_n84_), .O(new_n160_));
