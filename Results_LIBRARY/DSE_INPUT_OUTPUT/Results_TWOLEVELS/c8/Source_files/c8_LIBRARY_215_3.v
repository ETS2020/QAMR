...
module FAU ( 
  ...
  nand3  g050(.a(new_n96_), .b(new_n88_), .c(x09), .O(new_n97_));
  ...
  oai21  g057(.a(new_n94_), .b(new_n60_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n96_), .c(x16), .O(new_n105_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n92_), .c(new_n54_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n96_), .c(x16), .O(new_n114_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n94_), .c(new_n60_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n96_), .c(x16), .O(new_n123_));
  ...
  nand3  g084(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n120_), .c(new_n102_), .d(new_n92_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n96_), .b(new_n88_), .c(x14), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n120_), .c(new_n102_), .d(new_n92_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n120_), .c(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n102_), .b(x19), .c(new_n128_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n55_), .d(new_n128_), .O(new_n160_));
