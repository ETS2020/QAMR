...
module FAU ( 
  ...
  nand4  g54(.a(new_n59_), .b(new_n94_), .c(new_n50_), .d(new_n84_), .O(new_n101_));
  ...
  oai21  g58(.a(new_n103_), .b(new_n92_), .c(new_n104_), .O(z11));
  oai21  g59(.a(new_n88_), .b(x03), .c(new_n92_), .O(new_n106_));
  nand2  g60(.a(new_n101_), .b(x22), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n86_), .c(new_n94_), .O(new_n109_));
  and2   g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n92_), .c(new_n106_), .O(z12));
  ...
  oai21  g68(.a(new_n113_), .b(new_n92_), .c(new_n114_), .O(z13));
  oai21  g69(.a(new_n88_), .b(x05), .c(new_n92_), .O(new_n116_));
  aoi21  g70(.a(new_n112_), .b(new_n96_), .c(new_n70_), .O(new_n117_));
