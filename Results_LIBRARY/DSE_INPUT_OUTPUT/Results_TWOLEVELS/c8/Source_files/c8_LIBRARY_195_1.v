...
module FAU ( 
  ...
  inv1   g28(.a(x26), .O(new_n75_));
  nand2  g29(.a(new_n58_), .b(new_n75_), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n49_), .O(z07));
  nor2   g31(.a(new_n49_), .b(new_n58_), .O(z08));
  ...
  nand3  g38(.a(new_n48_), .b(new_n84_), .c(x08), .O(new_n85_));
  ...
  oai21  g46(.a(x18), .b(x10), .c(new_n84_), .O(new_n93_));
  nor2   g47(.a(x20), .b(x19), .O(new_n94_));
  nand2  g48(.a(new_n94_), .b(new_n79_), .O(new_n95_));
  nand4  g49(.a(new_n57_), .b(new_n88_), .c(new_n80_), .d(new_n79_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n95_), .b(x21), .c(new_n97_), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(new_n84_), .c(new_n93_), .O(z11));
  oai21  g53(.a(x18), .b(x11), .c(new_n84_), .O(new_n100_));
  nand2  g54(.a(new_n96_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n82_), .c(new_n88_), .O(new_n103_));
  and2   g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n84_), .c(new_n100_), .O(z12));
  oai21  g59(.a(x18), .b(x12), .c(new_n84_), .O(new_n106_));
  nor3   g60(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n90_), .c(new_n103_), .d(x23), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n84_), .c(new_n106_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n84_), .O(new_n110_));
  inv1   g64(.a(x24), .O(new_n111_));
  aoi21  g65(.a(new_n107_), .b(new_n90_), .c(new_n111_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n102_), .c(new_n94_), .d(new_n79_), .O(new_n114_));
  ...
  nand3  g88(.a(new_n48_), .b(new_n84_), .c(x15), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  inv1   g90(.a(new_n49_), .O(new_n137_));
  nand4  g91(.a(new_n127_), .b(new_n75_), .c(new_n121_), .d(new_n111_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n79_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n58_), .d(new_n79_), .O(new_n140_));
