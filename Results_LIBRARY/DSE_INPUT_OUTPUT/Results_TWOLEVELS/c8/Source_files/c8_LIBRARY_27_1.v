...
module FAU ( 
  ...
  oai21  g45(.a(new_n87_), .b(new_n52_), .c(new_n91_), .O(z10));
  oai21  g46(.a(x18), .b(x10), .c(new_n86_), .O(new_n93_));
  ...
  oai22  g56(.a(new_n102_), .b(new_n86_), .c(new_n87_), .d(new_n61_), .O(z12));
  ...
  oai22  g61(.a(new_n107_), .b(new_n86_), .c(new_n87_), .d(new_n64_), .O(z13));
  oai21  g62(.a(x18), .b(x13), .c(new_n86_), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n106_), .b(new_n90_), .c(new_n110_), .O(new_n111_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n110_), .c(new_n66_), .d(new_n117_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n98_), .c(new_n113_), .d(x25), .O(new_n121_));
  nand3  g75(.a(new_n48_), .b(new_n86_), .c(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n86_), .c(new_n122_), .O(z15));
  oai21  g77(.a(x18), .b(x15), .c(new_n86_), .O(new_n124_));
  nor2   g78(.a(x21), .b(x20), .O(new_n125_));
  nor2   g79(.a(x23), .b(x22), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n84_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(x26), .O(new_n129_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n126_), .c(new_n125_), .d(new_n84_), .O(new_n131_));
