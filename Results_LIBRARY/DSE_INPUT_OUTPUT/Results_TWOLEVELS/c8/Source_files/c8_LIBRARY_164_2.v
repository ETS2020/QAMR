...
module FAU ( 
  ...
  nand3  g051(.a(new_n95_), .b(new_n51_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g061(.a(x18), .b(new_n47_), .c(x02), .O(new_n108_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n65_), .c(new_n60_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n98_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n134_), .d(new_n97_), .O(new_n136_));
  ...
  oai21  g093(.a(x16), .b(x14), .c(new_n85_), .O(new_n140_));
  nand2  g094(.a(new_n136_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n123_), .c(new_n104_), .d(new_n96_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(x18), .b(new_n47_), .c(x06), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n123_), .c(new_n104_), .d(new_n96_), .O(new_n153_));
  ...
  nand2  g110(.a(new_n131_), .b(new_n65_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n104_), .b(x19), .c(new_n97_), .O(new_n161_));
