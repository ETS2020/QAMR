...
module FAU ( 
  ...
  aoi21  g079(.a(new_n120_), .b(new_n94_), .c(new_n71_), .O(new_n126_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n101_), .d(new_n92_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n101_), .b(x19), .c(new_n127_), .O(new_n155_));
