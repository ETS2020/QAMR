...
module FAU ( 
  ...
  nand3  g074(.a(new_n120_), .b(new_n96_), .c(new_n60_), .O(new_n121_));
  ...
  nand3  g082(.a(new_n94_), .b(new_n51_), .c(new_n86_), .O(new_n129_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n86_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n111_), .c(x16), .O(new_n137_));
  ...
  nand2  g094(.a(new_n140_), .b(new_n107_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n120_), .c(new_n101_), .d(new_n88_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n111_), .c(x16), .O(new_n146_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n101_), .d(new_n88_), .O(new_n151_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n120_), .c(new_n73_), .O(new_n157_));
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n86_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n86_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n111_), .c(x16), .O(new_n160_));
