...
module FAU ( 
  ...
  nand2  g32(.a(new_n60_), .b(new_n78_), .O(new_n79_));
  ...
  nand4  g53(.a(new_n99_), .b(new_n92_), .c(new_n83_), .d(new_n82_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  nor2   g56(.a(new_n88_), .b(x16), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x02), .O(new_n104_));
  oai21  g58(.a(new_n102_), .b(new_n87_), .c(new_n104_), .O(z11));
  ...
  nand2  g63(.a(new_n103_), .b(x03), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n87_), .c(new_n110_), .O(z12));
  oai21  g65(.a(new_n88_), .b(x04), .c(new_n87_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n94_), .c(new_n108_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n87_), .c(new_n112_), .O(z13));
  oai21  g69(.a(new_n88_), .b(x05), .c(new_n87_), .O(new_n116_));
  aoi21  g70(.a(new_n113_), .b(new_n94_), .c(new_n68_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n97_), .d(new_n82_), .O(new_n119_));
  ...
  nand4  g78(.a(new_n73_), .b(new_n68_), .c(new_n124_), .d(new_n59_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n101_), .c(new_n119_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n87_), .c(new_n123_), .O(z15));
  ...
  nand2  g91(.a(new_n103_), .b(x07), .O(new_n138_));
