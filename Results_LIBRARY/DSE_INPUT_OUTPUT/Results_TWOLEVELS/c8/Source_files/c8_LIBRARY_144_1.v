...
module FAU ( 
  ...
  nand2  g48(.a(new_n47_), .b(new_n88_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n55_), .c(new_n94_), .O(z10));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n84_), .O(new_n98_));
  nand4  g52(.a(new_n60_), .b(new_n91_), .c(new_n51_), .d(new_n84_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n88_), .c(new_n95_), .d(new_n58_), .O(z11));
  oai21  g56(.a(x18), .b(x11), .c(new_n88_), .O(new_n103_));
  nand2  g57(.a(new_n99_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n86_), .c(new_n91_), .O(new_n106_));
  ...
  oai22  g64(.a(new_n110_), .b(new_n88_), .c(new_n95_), .d(new_n68_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n88_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n93_), .c(new_n73_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n105_), .c(new_n97_), .d(new_n84_), .O(new_n115_));
  ...
  oai21  g72(.a(x18), .b(x14), .c(new_n88_), .O(new_n119_));
  inv1   g73(.a(x23), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n73_), .c(new_n120_), .d(new_n65_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n100_), .c(new_n115_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n88_), .c(new_n119_), .O(z15));
  ...
  nand3  g88(.a(new_n47_), .b(new_n88_), .c(x15), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n73_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n84_), .O(new_n139_));
