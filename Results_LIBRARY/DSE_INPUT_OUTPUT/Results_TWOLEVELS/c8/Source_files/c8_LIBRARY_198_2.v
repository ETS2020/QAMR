...
module FAU ( 
  ...
  nor2   g045(.a(new_n87_), .b(x16), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(x00), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n91_), .c(new_n88_), .O(z09));
  ...
  oai21  g054(.a(new_n90_), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  ...
  nand2  g063(.a(new_n92_), .b(x02), .O(new_n110_));
  ...
  nand2  g080(.a(new_n92_), .b(x04), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n121_), .O(z13));
  oai21  g082(.a(x16), .b(x13), .c(new_n87_), .O(new_n129_));
  aoi21  g083(.a(new_n123_), .b(new_n105_), .c(new_n75_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n116_), .c(new_n99_), .d(new_n98_), .O(new_n132_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n106_), .d(new_n90_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n106_), .d(new_n90_), .O(new_n152_));
  ...
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n98_), .O(new_n160_));
  inv1   g114(.a(new_n160_), .O(new_n161_));
  nor2   g115(.a(new_n55_), .b(new_n98_), .O(new_n162_));
