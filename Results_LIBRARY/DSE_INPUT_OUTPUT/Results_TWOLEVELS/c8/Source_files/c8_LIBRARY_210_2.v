...
module FAU ( 
  ...
  oai21  g069(.a(x16), .b(x12), .c(new_n85_), .O(new_n116_));
  nand2  g070(.a(new_n112_), .b(x23), .O(new_n117_));
  nor2   g071(.a(x23), .b(x22), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n95_), .c(new_n60_), .O(new_n119_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n118_), .c(new_n101_), .d(new_n93_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n97_), .b(x06), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n118_), .c(new_n101_), .d(new_n93_), .O(new_n150_));
