...
module FAU ( 
  ...
  inv1   g080(.a(x18), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n85_), .c(x12), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n126_), .O(z13));
  ...
  aoi21  g087(.a(new_n123_), .b(new_n107_), .c(new_n133_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n117_), .c(new_n99_), .d(new_n98_), .O(new_n136_));
  ...
  nand4  g112(.a(new_n144_), .b(new_n81_), .c(new_n76_), .d(new_n133_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n98_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n98_), .O(new_n161_));
