...
module FAU ( 
  ...
  nand2  g049(.a(new_n95_), .b(x18), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n49_), .O(new_n97_));
  ...
  nand3  g055(.a(x19), .b(new_n48_), .c(x10), .O(new_n102_));
  ...
  nand4  g060(.a(new_n106_), .b(new_n94_), .c(new_n49_), .d(new_n81_), .O(new_n107_));
  aoi21  g061(.a(new_n107_), .b(new_n105_), .c(new_n48_), .O(new_n108_));
  nor2   g062(.a(new_n106_), .b(new_n49_), .O(new_n109_));
  ...
  nand2  g068(.a(new_n81_), .b(x16), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n94_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n115_), .c(x18), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n49_), .O(new_n119_));
  nand3  g073(.a(new_n107_), .b(x22), .c(x16), .O(new_n120_));
  ...
  oai21  g080(.a(new_n126_), .b(new_n95_), .c(x18), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n49_), .O(new_n128_));
  nand3  g082(.a(new_n116_), .b(new_n83_), .c(new_n94_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(x23), .c(x16), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n128_), .c(new_n124_), .O(z13));
  nand2  g085(.a(x18), .b(x05), .O(new_n132_));
  oai21  g086(.a(x18), .b(new_n67_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n85_), .O(new_n134_));
  nand3  g088(.a(new_n116_), .b(new_n69_), .c(new_n64_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n95_), .c(x18), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n49_), .O(new_n137_));
  nor3   g091(.a(x20), .b(x19), .c(x17), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n125_), .c(new_n106_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(x24), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n137_), .c(new_n134_), .O(z14));
  ...
  oai21  g102(.a(new_n148_), .b(new_n146_), .c(x18), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n49_), .O(new_n150_));
  nand4  g104(.a(new_n138_), .b(new_n116_), .c(new_n69_), .d(new_n64_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(x25), .c(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n150_), .c(new_n144_), .O(z15));
  ...
  nand3  g111(.a(new_n157_), .b(new_n125_), .c(new_n69_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n146_), .c(x18), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n49_), .O(new_n160_));
  nand4  g114(.a(new_n147_), .b(new_n125_), .c(new_n145_), .d(new_n83_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(x26), .c(x16), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n160_), .c(new_n156_), .O(z16));
  nand2  g117(.a(z08), .b(x17), .O(new_n164_));
  nor3   g118(.a(x26), .b(x25), .c(x24), .O(new_n165_));
  nor2   g119(.a(new_n49_), .b(x17), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n165_), .c(new_n125_), .d(new_n145_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n164_), .c(new_n85_), .O(z17));
endmodule
