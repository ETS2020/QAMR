...
module FAU ( 
  ...
  oai21  g025(.a(x27), .b(new_n71_), .c(new_n47_), .O(new_n72_));
  nand3  g026(.a(new_n52_), .b(new_n71_), .c(x18), .O(new_n73_));
  nand2  g027(.a(new_n73_), .b(new_n72_), .O(z05));
  ...
  nor2   g037(.a(x18), .b(x13), .O(new_n84_));
  aoi22  g038(.a(new_n84_), .b(x08), .c(x18), .d(x00), .O(new_n85_));
  ...
  oai21  g045(.a(new_n85_), .b(x16), .c(new_n91_), .O(z09));
  ...
  nor2   g051(.a(new_n88_), .b(new_n97_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n86_), .O(z10));
  ...
  nand3  g062(.a(new_n108_), .b(new_n104_), .c(new_n86_), .O(z11));
  ...
  nand3  g068(.a(new_n114_), .b(new_n88_), .c(new_n97_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n86_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  nand2  g073(.a(new_n84_), .b(x12), .O(new_n120_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n105_), .d(new_n88_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n130_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n130_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n86_), .c(x16), .O(new_n163_));
