...
module FAU ( 
  ...
  aoi21  g030(.a(x27), .b(new_n47_), .c(new_n76_), .O(new_n77_));
  ...
  oai22  g055(.a(new_n101_), .b(new_n100_), .c(x18), .d(new_n58_), .O(new_n102_));
  ...
  oai22  g063(.a(new_n101_), .b(new_n109_), .c(x18), .d(new_n61_), .O(new_n110_));
  ...
  aoi21  g074(.a(new_n113_), .b(new_n93_), .c(new_n68_), .O(new_n121_));
  nor2   g075(.a(x22), .b(x21), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n93_), .c(new_n56_), .O(new_n123_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n48_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n129_), .O(z13));
  nand2  g089(.a(x18), .b(x05), .O(new_n136_));
  oai21  g090(.a(x18), .b(new_n47_), .c(new_n136_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n95_), .O(new_n138_));
  inv1   g092(.a(x24), .O(new_n139_));
  aoi21  g093(.a(new_n131_), .b(new_n112_), .c(new_n139_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n104_), .d(new_n91_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n48_), .O(z14));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n113_), .d(new_n93_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n148_), .c(new_n48_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  oai21  g110(.a(x18), .b(new_n87_), .c(new_n156_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n113_), .d(new_n93_), .O(new_n161_));
  ...
  nand4  g118(.a(new_n150_), .b(new_n85_), .c(new_n82_), .d(new_n139_), .O(new_n165_));
  nand3  g119(.a(new_n113_), .b(x19), .c(new_n91_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n53_), .d(new_n91_), .O(new_n167_));
