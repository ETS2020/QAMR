...
module FAU ( 
  ...
  oai22  g61(.a(new_n107_), .b(new_n93_), .c(new_n91_), .d(new_n63_), .O(z12));
  oai21  g62(.a(x18), .b(x12), .c(new_n93_), .O(new_n109_));
  ...
  oai21  g67(.a(new_n113_), .b(new_n93_), .c(new_n109_), .O(z13));
  oai21  g68(.a(x18), .b(x13), .c(new_n93_), .O(new_n115_));
  inv1   g69(.a(x24), .O(new_n116_));
  aoi21  g70(.a(new_n112_), .b(new_n96_), .c(new_n116_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n110_), .c(new_n99_), .d(new_n86_), .O(new_n119_));
  ...
  nand4  g77(.a(new_n76_), .b(new_n116_), .c(new_n68_), .d(new_n123_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n103_), .c(new_n119_), .d(x25), .O(new_n126_));
  ...
  nand2  g91(.a(new_n90_), .b(x15), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  nand4  g93(.a(new_n130_), .b(new_n81_), .c(new_n76_), .d(new_n116_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n86_), .O(new_n141_));
