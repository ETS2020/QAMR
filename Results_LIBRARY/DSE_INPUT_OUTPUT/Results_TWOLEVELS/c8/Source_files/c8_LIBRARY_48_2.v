...
module FAU ( 
  ...
  nor2   g051(.a(new_n85_), .b(x16), .O(new_n98_));
  ...
  oai21  g063(.a(x16), .b(x11), .c(new_n85_), .O(new_n110_));
  aoi21  g064(.a(new_n105_), .b(new_n94_), .c(new_n65_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n98_), .b(x03), .O(new_n116_));
  ...
  nand3  g084(.a(new_n70_), .b(new_n65_), .c(new_n104_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n105_), .d(new_n94_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n98_), .b(x06), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n122_), .c(new_n105_), .d(new_n94_), .O(new_n152_));
