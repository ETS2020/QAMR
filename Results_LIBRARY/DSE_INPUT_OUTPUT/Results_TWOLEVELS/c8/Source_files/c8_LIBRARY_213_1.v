...
module FAU ( 
  ...
  aoi21  g043(.a(x18), .b(new_n52_), .c(new_n48_), .O(z08));
  inv1   g044(.a(x16), .O(new_n91_));
  inv1   g045(.a(x00), .O(new_n92_));
  nand2  g046(.a(x18), .b(x13), .O(new_n93_));
  oai22  g047(.a(new_n93_), .b(new_n92_), .c(x18), .d(new_n50_), .O(new_n94_));
  ...
  oai22  g053(.a(new_n93_), .b(new_n99_), .c(x18), .d(new_n56_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n91_), .O(new_n101_));
  nor2   g055(.a(x19), .b(x17), .O(new_n102_));
  inv1   g056(.a(x17), .O(new_n103_));
  nand3  g057(.a(new_n58_), .b(new_n47_), .c(new_n103_), .O(new_n104_));
  oai21  g058(.a(new_n102_), .b(new_n58_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g084(.a(new_n130_), .b(new_n104_), .c(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n128_), .c(new_n53_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  aoi21  g088(.a(x18), .b(new_n134_), .c(x16), .O(new_n135_));
  oai21  g089(.a(new_n130_), .b(new_n104_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n121_), .c(new_n111_), .O(new_n138_));
  ...
  oai21  g096(.a(new_n140_), .b(new_n52_), .c(new_n142_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n93_), .b(new_n144_), .c(x18), .d(new_n80_), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n112_), .d(new_n102_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n148_), .b(new_n87_), .c(new_n82_), .d(new_n158_), .O(new_n159_));
  oai21  g113(.a(new_n159_), .b(new_n113_), .c(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n53_), .O(z16));
  nand3  g116(.a(new_n112_), .b(x19), .c(new_n103_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n159_), .c(new_n48_), .d(new_n103_), .O(new_n164_));
