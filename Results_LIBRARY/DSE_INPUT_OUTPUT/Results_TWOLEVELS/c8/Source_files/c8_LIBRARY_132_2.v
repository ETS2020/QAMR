...
module FAU ( 
  ...
  nor2   g061(.a(new_n83_), .b(x16), .O(new_n108_));
  ...
  oai21  g073(.a(x16), .b(x12), .c(new_n83_), .O(new_n120_));
  ...
  nand2  g079(.a(new_n108_), .b(x04), .O(new_n126_));
  ...
  nand2  g087(.a(new_n108_), .b(x05), .O(new_n134_));
