...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(x09), .c(new_n52_), .O(new_n99_));
  ...
  oai21  g058(.a(new_n90_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n110_), .c(new_n86_), .O(z11));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n90_), .c(new_n65_), .O(new_n120_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n86_), .O(z12));
  nand2  g079(.a(x18), .b(x04), .O(new_n126_));
  nand3  g080(.a(new_n98_), .b(x12), .c(new_n52_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n86_), .c(x16), .O(new_n134_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n121_), .c(new_n103_), .d(new_n88_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n138_), .c(new_n86_), .O(z14));
  nand2  g098(.a(x18), .b(x06), .O(new_n145_));
  nand3  g099(.a(new_n98_), .b(x14), .c(new_n52_), .O(new_n146_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n112_), .d(new_n90_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n86_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n148_), .O(z15));
  oai21  g109(.a(new_n98_), .b(new_n92_), .c(x07), .O(new_n156_));
  nand2  g110(.a(new_n152_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n150_), .c(new_n112_), .d(new_n90_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n98_), .b(new_n92_), .c(x15), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n161_), .c(new_n156_), .O(z16));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n150_), .c(new_n75_), .O(new_n165_));
  nand3  g119(.a(new_n112_), .b(x19), .c(new_n88_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n50_), .d(new_n88_), .O(new_n167_));
