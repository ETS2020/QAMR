...
module FAU ( 
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n52_), .O(z11));
  ...
  aoi22  g071(.a(new_n117_), .b(new_n96_), .c(new_n113_), .d(x23), .O(new_n118_));
  nor2   g072(.a(x18), .b(x16), .O(new_n119_));
  aoi21  g073(.a(new_n119_), .b(x12), .c(new_n53_), .O(new_n120_));
  oai21  g074(.a(new_n118_), .b(new_n81_), .c(new_n120_), .O(z13));
  ...
  aoi21  g079(.a(new_n117_), .b(new_n96_), .c(new_n125_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n127_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n126_), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n124_), .c(new_n52_), .O(z14));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n103_), .d(new_n94_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n136_), .c(new_n52_), .O(z15));
  nand2  g097(.a(x18), .b(x07), .O(new_n144_));
  oai22  g098(.a(new_n144_), .b(x04), .c(x18), .d(new_n77_), .O(new_n145_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n103_), .d(new_n94_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n103_), .b(x19), .c(new_n127_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n50_), .d(new_n127_), .O(new_n156_));
