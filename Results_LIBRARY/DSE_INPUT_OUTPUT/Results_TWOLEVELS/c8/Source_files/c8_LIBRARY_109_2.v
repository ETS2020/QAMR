...
module FAU ( 
  ...
  oai21  g055(.a(new_n91_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g064(.a(new_n93_), .b(x02), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n110_), .c(new_n105_), .O(z11));
  oai21  g066(.a(x16), .b(x11), .c(new_n87_), .O(new_n113_));
  aoi21  g067(.a(new_n107_), .b(new_n91_), .c(new_n65_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n91_), .c(new_n99_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n93_), .b(x03), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n118_), .c(new_n113_), .O(z12));
  oai21  g074(.a(x16), .b(x12), .c(new_n87_), .O(new_n121_));
  nand2  g075(.a(new_n116_), .b(x23), .O(new_n122_));
  ...
  nand2  g080(.a(new_n93_), .b(x04), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n121_), .O(z13));
  oai21  g082(.a(x16), .b(x13), .c(new_n87_), .O(new_n129_));
  aoi21  g083(.a(new_n123_), .b(new_n106_), .c(new_n73_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n115_), .c(new_n100_), .d(new_n89_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n93_), .b(x05), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n134_), .c(new_n129_), .O(z14));
  oai21  g090(.a(x16), .b(x14), .c(new_n87_), .O(new_n137_));
  nand2  g091(.a(new_n132_), .b(x25), .O(new_n138_));
  nor2   g092(.a(x23), .b(x22), .O(new_n139_));
  nor2   g093(.a(x25), .b(x24), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n107_), .d(new_n91_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n93_), .b(x06), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n143_), .c(new_n137_), .O(z15));
  oai21  g099(.a(x16), .b(x15), .c(new_n87_), .O(new_n146_));
  nand2  g100(.a(new_n141_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n139_), .c(new_n107_), .d(new_n91_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n93_), .b(x07), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  inv1   g107(.a(x23), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n65_), .O(new_n155_));
  nand3  g109(.a(new_n83_), .b(new_n78_), .c(new_n73_), .O(new_n156_));
  ...
  nor2   g113(.a(new_n52_), .b(new_n89_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(x18), .c(new_n47_), .O(z17));
endmodule
