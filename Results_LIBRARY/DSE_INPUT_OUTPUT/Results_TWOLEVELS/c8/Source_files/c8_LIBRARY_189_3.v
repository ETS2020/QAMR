...
module FAU ( 
  ...
  nor2   g053(.a(new_n92_), .b(new_n57_), .O(new_n100_));
  nor3   g054(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  oai21  g055(.a(new_n101_), .b(new_n100_), .c(x16), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n99_), .c(new_n52_), .O(z10));
  ...
  oai22  g077(.a(new_n88_), .b(new_n123_), .c(x18), .d(new_n66_), .O(new_n124_));
  ...
  oai22  g086(.a(new_n88_), .b(new_n132_), .c(x18), .d(new_n71_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n85_), .O(new_n134_));
  inv1   g088(.a(x17), .O(new_n135_));
  nand3  g089(.a(new_n57_), .b(new_n49_), .c(new_n135_), .O(new_n136_));
  nand3  g090(.a(new_n68_), .b(new_n116_), .c(new_n107_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n136_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n118_), .c(new_n139_), .d(new_n135_), .O(new_n141_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n127_), .c(new_n108_), .d(new_n92_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n52_), .c(x16), .O(new_n149_));
  inv1   g103(.a(x18), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n85_), .c(x14), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(z15));
  ...
  nand4  g111(.a(new_n157_), .b(new_n127_), .c(new_n108_), .d(new_n92_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n127_), .c(new_n73_), .O(new_n163_));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n135_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n50_), .d(new_n135_), .O(new_n165_));
