...
module FAU ( 
  ...
  aoi21  g066(.a(new_n105_), .b(new_n87_), .c(new_n65_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n87_), .c(new_n97_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n47_), .O(z12));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n47_), .O(z13));
  nand3  g081(.a(x18), .b(new_n73_), .c(x05), .O(new_n128_));
  oai21  g082(.a(x18), .b(new_n73_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n89_), .O(new_n130_));
  nand3  g084(.a(new_n97_), .b(new_n51_), .c(new_n85_), .O(new_n131_));
  ...
  nand2  g094(.a(x18), .b(new_n73_), .O(new_n141_));
  oai22  g095(.a(new_n141_), .b(new_n140_), .c(x18), .d(new_n76_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n89_), .O(new_n143_));
  nand2  g097(.a(new_n136_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n123_), .c(new_n105_), .d(new_n87_), .O(new_n146_));
  ...
  oai22  g104(.a(new_n141_), .b(new_n150_), .c(x18), .d(new_n81_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n123_), .c(new_n105_), .d(new_n87_), .O(new_n155_));
  ...
  nand3  g115(.a(new_n105_), .b(x19), .c(new_n85_), .O(new_n162_));
