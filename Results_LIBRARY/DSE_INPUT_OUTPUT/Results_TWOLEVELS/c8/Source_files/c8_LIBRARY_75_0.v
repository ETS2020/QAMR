...
module FAU ( 
  ...
  nor2   g030(.a(x27), .b(new_n76_), .O(new_n77_));
  oai22  g031(.a(new_n77_), .b(x15), .c(x27), .d(x26), .O(z07));
  ...
  nand2  g044(.a(new_n76_), .b(x15), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n54_), .c(new_n90_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  nor2   g047(.a(x20), .b(x19), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n81_), .O(new_n95_));
  oai21  g049(.a(new_n83_), .b(new_n56_), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n79_), .c(x16), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n93_), .O(z10));
  nand2  g052(.a(x18), .b(x02), .O(new_n99_));
  oai21  g053(.a(new_n91_), .b(new_n59_), .c(new_n99_), .O(new_n100_));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n103_), .c(new_n70_), .O(new_n130_));
  ...
  oai21  g099(.a(new_n76_), .b(x07), .c(new_n85_), .O(new_n146_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n79_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n140_), .c(new_n70_), .O(new_n154_));
  nand3  g108(.a(new_n104_), .b(x19), .c(new_n81_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n51_), .d(new_n81_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n79_), .c(x16), .O(new_n157_));
