...
module FAU ( 
  ...
  aoi21  g036(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n83_));
  oai21  g037(.a(x27), .b(x26), .c(new_n83_), .O(z07));
  nor2   g038(.a(new_n49_), .b(new_n55_), .O(z08));
  nor2   g039(.a(x18), .b(x15), .O(new_n86_));
  ...
  aoi22  g055(.a(new_n86_), .b(x10), .c(x18), .d(x02), .O(new_n102_));
  ...
  aoi21  g066(.a(new_n104_), .b(new_n90_), .c(new_n65_), .O(new_n113_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n88_), .O(z12));
  inv1   g072(.a(new_n86_), .O(new_n119_));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  oai21  g074(.a(new_n119_), .b(new_n68_), .c(new_n120_), .O(new_n121_));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n103_), .c(new_n75_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n114_), .c(new_n97_), .d(new_n96_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n131_), .c(new_n88_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  oai21  g092(.a(new_n119_), .b(new_n78_), .c(new_n138_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n109_), .O(new_n140_));
  nand2  g094(.a(new_n134_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n104_), .d(new_n90_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n88_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n140_), .O(z15));
  nand2  g101(.a(new_n144_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n142_), .c(new_n104_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n88_), .c(x16), .O(new_n152_));
  nand3  g106(.a(x18), .b(new_n109_), .c(x07), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n152_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n142_), .c(new_n75_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n96_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n55_), .d(new_n96_), .O(new_n158_));
