...
module FAU ( 
  ...
  aoi21  g063(.a(new_n104_), .b(new_n86_), .c(new_n63_), .O(new_n110_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n104_), .d(new_n86_), .O(new_n139_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n104_), .d(new_n86_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n102_), .c(x16), .O(new_n151_));
