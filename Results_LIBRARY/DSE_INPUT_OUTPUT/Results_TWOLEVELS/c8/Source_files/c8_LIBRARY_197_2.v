...
module FAU ( 
  ...
  nand2  g060(.a(new_n98_), .b(x02), .O(new_n107_));
  ...
  oai21  g080(.a(x16), .b(x13), .c(new_n85_), .O(new_n127_));
  aoi21  g081(.a(new_n122_), .b(new_n96_), .c(new_n73_), .O(new_n128_));
  ...
  nand2  g088(.a(new_n98_), .b(x05), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n103_), .d(new_n94_), .O(new_n141_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n139_), .c(new_n103_), .d(new_n94_), .O(new_n149_));
  ...
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n129_), .O(new_n156_));
