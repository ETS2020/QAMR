...
module FAU ( 
  ...
  oai21  g064(.a(x16), .b(x11), .c(new_n85_), .O(new_n111_));
  aoi21  g065(.a(new_n106_), .b(new_n90_), .c(new_n65_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n90_), .c(new_n54_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n92_), .b(x03), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n116_), .c(new_n111_), .O(z12));
  oai21  g072(.a(x16), .b(x12), .c(new_n85_), .O(new_n119_));
  nand2  g073(.a(new_n114_), .b(x23), .O(new_n120_));
  nor2   g074(.a(x23), .b(x22), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n105_), .c(new_n60_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand2  g078(.a(new_n92_), .b(x04), .O(new_n125_));
  ...
  nand2  g082(.a(new_n128_), .b(new_n48_), .O(new_n129_));
  nand3  g083(.a(new_n70_), .b(new_n65_), .c(new_n60_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n98_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n113_), .c(new_n132_), .d(new_n87_), .O(new_n134_));
  ...
  oai21  g091(.a(x16), .b(x14), .c(new_n85_), .O(new_n138_));
  nand2  g092(.a(new_n134_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x25), .b(x24), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n121_), .c(new_n106_), .d(new_n90_), .O(new_n141_));
  ...
  nand3  g098(.a(new_n144_), .b(new_n143_), .c(new_n138_), .O(z15));
  oai21  g099(.a(x16), .b(x15), .c(new_n85_), .O(new_n146_));
  nand2  g100(.a(new_n141_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n121_), .c(new_n106_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n92_), .b(x07), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  inv1   g107(.a(x24), .O(new_n154_));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n121_), .c(new_n154_), .O(new_n156_));
  nand3  g110(.a(new_n106_), .b(x19), .c(new_n87_), .O(new_n157_));
