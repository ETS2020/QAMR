...
module FAU ( 
  ...
  nand2  g034(.a(new_n48_), .b(new_n58_), .O(z08));
  ...
  nand3  g045(.a(new_n67_), .b(x18), .c(x01), .O(new_n92_));
  ...
  aoi21  g066(.a(new_n105_), .b(new_n85_), .c(new_n63_), .O(new_n113_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n104_), .c(new_n57_), .O(new_n125_));
  ...
  oai21  g085(.a(new_n72_), .b(new_n87_), .c(new_n66_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x23), .O(new_n133_));
  nand2  g087(.a(new_n115_), .b(x24), .O(new_n134_));
  nand4  g088(.a(new_n114_), .b(new_n104_), .c(new_n72_), .d(new_n67_), .O(new_n135_));
  ...
  oai21  g096(.a(new_n142_), .b(new_n87_), .c(new_n66_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x23), .O(new_n144_));
  nor3   g098(.a(x24), .b(x22), .c(x21), .O(new_n145_));
  aoi21  g099(.a(new_n145_), .b(new_n104_), .c(new_n142_), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n124_), .O(new_n148_));
  nor2   g102(.a(new_n148_), .b(new_n106_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n146_), .c(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n144_), .c(new_n141_), .O(z15));
  ...
  nand2  g108(.a(x26), .b(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n66_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x23), .O(new_n157_));
  nand4  g111(.a(new_n147_), .b(new_n114_), .c(new_n96_), .d(new_n82_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n124_), .c(new_n105_), .d(new_n85_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n157_), .c(new_n154_), .O(z16));
  nand3  g118(.a(new_n48_), .b(x27), .c(x17), .O(new_n165_));
  nor2   g119(.a(new_n83_), .b(x17), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n160_), .c(new_n124_), .d(new_n105_), .O(new_n167_));
  aoi21  g121(.a(new_n167_), .b(new_n165_), .c(new_n87_), .O(z17));
endmodule
