...
module FAU ( 
  ...
  oai21  g057(.a(new_n90_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g061(.a(new_n98_), .b(x10), .c(new_n52_), .O(new_n108_));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n90_), .c(new_n67_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n90_), .c(new_n57_), .O(new_n122_));
  inv1   g076(.a(new_n122_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n87_), .O(z12));
  ...
  nand3  g087(.a(new_n133_), .b(new_n128_), .c(new_n87_), .O(z13));
  ...
  aoi21  g092(.a(new_n130_), .b(new_n111_), .c(new_n138_), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n121_), .c(new_n102_), .d(new_n88_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n139_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(new_n87_), .O(z14));
  ...
  nand3  g107(.a(new_n153_), .b(new_n87_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n148_), .O(z15));
  nand3  g109(.a(new_n98_), .b(x15), .c(new_n52_), .O(new_n156_));
  oai21  g110(.a(new_n98_), .b(new_n52_), .c(new_n156_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n112_), .d(new_n90_), .O(new_n161_));
  ...
  nand3  g120(.a(new_n112_), .b(x19), .c(new_n88_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n50_), .d(new_n88_), .O(new_n168_));
