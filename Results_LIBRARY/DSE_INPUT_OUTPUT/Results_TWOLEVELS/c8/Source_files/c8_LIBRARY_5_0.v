...
module FAU ( 
  ...
  nand4  g78(.a(new_n124_), .b(new_n116_), .c(new_n67_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n101_), .c(new_n119_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n88_), .b(x06), .O(new_n128_));
  ...
  nand2  g92(.a(new_n88_), .b(x07), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n138_), .O(z16));
  nand4  g94(.a(new_n131_), .b(new_n78_), .c(new_n124_), .d(new_n116_), .O(new_n141_));
