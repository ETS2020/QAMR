...
module FAU ( 
  ...
  nand3  g056(.a(new_n102_), .b(new_n97_), .c(new_n48_), .O(z10));
  inv1   g057(.a(x02), .O(new_n104_));
  inv1   g058(.a(x26), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x18), .O(new_n106_));
  oai22  g060(.a(new_n106_), .b(new_n104_), .c(x18), .d(new_n58_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n90_), .O(new_n108_));
  nand3  g062(.a(new_n100_), .b(new_n48_), .c(x21), .O(new_n109_));
  inv1   g063(.a(x23), .O(new_n110_));
  aoi21  g064(.a(new_n110_), .b(new_n65_), .c(x26), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(x18), .c(x26), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n60_), .c(new_n54_), .d(new_n86_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(x17), .c(new_n109_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n108_), .O(z11));
  inv1   g070(.a(x03), .O(new_n117_));
  oai22  g071(.a(new_n106_), .b(new_n117_), .c(x18), .d(new_n63_), .O(new_n118_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n48_), .c(x22), .O(new_n122_));
  inv1   g076(.a(x18), .O(new_n123_));
  oai21  g077(.a(x26), .b(new_n110_), .c(new_n123_), .O(new_n124_));
  aoi21  g078(.a(new_n124_), .b(x26), .c(x22), .O(new_n125_));
  nand4  g079(.a(new_n125_), .b(new_n60_), .c(new_n54_), .d(new_n86_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(x17), .c(new_n122_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x16), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n119_), .O(z12));
  inv1   g083(.a(x04), .O(new_n130_));
  oai22  g084(.a(new_n106_), .b(new_n130_), .c(x18), .d(new_n68_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n90_), .O(new_n132_));
  nor2   g086(.a(x22), .b(x21), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n88_), .c(new_n54_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x23), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n60_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n100_), .c(new_n135_), .O(new_n138_));
  ...
  nor2   g097(.a(new_n137_), .b(new_n100_), .O(new_n144_));
  nand4  g098(.a(new_n133_), .b(new_n101_), .c(new_n73_), .d(new_n110_), .O(new_n145_));
  oai21  g099(.a(new_n144_), .b(new_n73_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n143_), .c(new_n48_), .O(z14));
  ...
  inv1   g106(.a(new_n121_), .O(new_n153_));
  nand4  g107(.a(new_n136_), .b(new_n153_), .c(new_n78_), .d(new_n73_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n151_), .c(new_n48_), .O(z15));
  ...
  aoi21  g114(.a(new_n110_), .b(new_n65_), .c(x21), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n54_), .c(new_n86_), .d(new_n123_), .O(new_n162_));
  nor3   g116(.a(x25), .b(x24), .c(x21), .O(new_n163_));
  nand4  g117(.a(new_n163_), .b(new_n162_), .c(new_n99_), .d(new_n85_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x26), .O(new_n165_));
  nor3   g119(.a(x26), .b(x25), .c(x24), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n136_), .c(new_n153_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n160_), .c(new_n48_), .O(z16));
  nand2  g124(.a(new_n166_), .b(new_n136_), .O(new_n171_));
  nand3  g125(.a(new_n120_), .b(x19), .c(new_n85_), .O(new_n172_));
  oai22  g126(.a(new_n172_), .b(new_n171_), .c(new_n55_), .d(new_n85_), .O(new_n173_));
