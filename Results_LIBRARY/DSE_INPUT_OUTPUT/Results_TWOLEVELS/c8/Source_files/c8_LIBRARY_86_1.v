...
module FAU ( 
  ...
  nand2  g064(.a(new_n86_), .b(new_n52_), .O(new_n111_));
  oai21  g065(.a(new_n111_), .b(new_n61_), .c(new_n110_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n96_), .O(new_n113_));
  nand3  g067(.a(new_n106_), .b(new_n53_), .c(x21), .O(new_n114_));
  aoi21  g068(.a(new_n71_), .b(new_n68_), .c(x26), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n52_), .c(x26), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(x17), .c(new_n114_), .O(new_n118_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n53_), .c(x22), .O(new_n126_));
  oai21  g080(.a(x26), .b(new_n71_), .c(x18), .O(new_n127_));
  aoi21  g081(.a(new_n127_), .b(x26), .c(x22), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(x17), .c(new_n126_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n123_), .O(z12));
  nand2  g086(.a(x18), .b(x04), .O(new_n133_));
  oai21  g087(.a(new_n111_), .b(new_n73_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n96_), .O(new_n135_));
  nor2   g089(.a(x22), .b(x21), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n94_), .c(new_n58_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x23), .O(new_n138_));
  nor2   g092(.a(x23), .b(x22), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n63_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n106_), .c(new_n138_), .O(new_n141_));
  ...
  nor2   g100(.a(new_n140_), .b(new_n106_), .O(new_n147_));
  nand4  g101(.a(new_n136_), .b(new_n107_), .c(new_n78_), .d(new_n71_), .O(new_n148_));
  oai21  g102(.a(new_n147_), .b(new_n78_), .c(new_n148_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n146_), .c(new_n53_), .O(z14));
  nand2  g105(.a(x18), .b(x06), .O(new_n152_));
  oai21  g106(.a(x18), .b(new_n81_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n96_), .O(new_n154_));
  nand2  g108(.a(new_n148_), .b(x25), .O(new_n155_));
  inv1   g109(.a(new_n125_), .O(new_n156_));
  nand4  g110(.a(new_n139_), .b(new_n156_), .c(new_n83_), .d(new_n78_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n154_), .c(new_n53_), .O(z15));
  nand2  g114(.a(x18), .b(x07), .O(new_n161_));
  oai21  g115(.a(x18), .b(new_n88_), .c(new_n161_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n96_), .O(new_n163_));
  aoi21  g117(.a(new_n71_), .b(new_n68_), .c(x21), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n58_), .c(new_n47_), .d(x18), .O(new_n165_));
  nor3   g119(.a(x25), .b(x24), .c(x21), .O(new_n166_));
  nand4  g120(.a(new_n166_), .b(new_n165_), .c(new_n105_), .d(new_n92_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x26), .O(new_n168_));
  nor3   g122(.a(x26), .b(x25), .c(x24), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(new_n139_), .c(new_n156_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand2  g125(.a(new_n171_), .b(x16), .O(new_n172_));
  nand3  g126(.a(new_n172_), .b(new_n163_), .c(new_n53_), .O(z16));
  nand2  g127(.a(new_n169_), .b(new_n139_), .O(new_n174_));
  nand3  g128(.a(new_n124_), .b(x19), .c(new_n92_), .O(new_n175_));
  oai22  g129(.a(new_n175_), .b(new_n174_), .c(new_n48_), .d(new_n92_), .O(new_n176_));
  nand2  g130(.a(new_n176_), .b(x16), .O(new_n177_));
  nand2  g131(.a(new_n177_), .b(new_n53_), .O(z17));
endmodule
