...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_,
    ...
    new_n73_, new_n75_, new_n76_, new_n78_, new_n79_, new_n80_, new_n83_,
    ...
    new_n160_, new_n161_;
  nor2   g000(.a(x18), .b(x15), .O(new_n47_));
  ...
  aoi21  g026(.a(x27), .b(new_n72_), .c(new_n47_), .O(new_n73_));
  ...
  aoi21  g035(.a(new_n79_), .b(new_n78_), .c(new_n51_), .O(z08));
  ...
  nand3  g061(.a(new_n107_), .b(new_n102_), .c(new_n83_), .O(z11));
  ...
  aoi21  g065(.a(new_n104_), .b(new_n86_), .c(new_n64_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n86_), .c(new_n56_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n111_), .c(new_n83_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  nand2  g072(.a(new_n79_), .b(x15), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n67_), .c(new_n118_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n83_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n121_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai21  g082(.a(new_n119_), .b(new_n72_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n88_), .O(new_n130_));
  nand3  g084(.a(new_n56_), .b(new_n50_), .c(new_n84_), .O(new_n131_));
  nand3  g085(.a(new_n69_), .b(new_n64_), .c(new_n103_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n113_), .c(new_n134_), .d(new_n84_), .O(new_n136_));
