...
module FAU ( 
  ...
  nand3  g020(.a(new_n66_), .b(new_n64_), .c(new_n48_), .O(z03));
  ...
  nand2  g044(.a(x20), .b(x18), .O(new_n91_));
  oai22  g045(.a(new_n91_), .b(new_n90_), .c(x18), .d(new_n50_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n89_), .O(new_n93_));
  nand3  g047(.a(new_n48_), .b(x19), .c(x17), .O(new_n94_));
  inv1   g048(.a(x17), .O(new_n95_));
  nand2  g049(.a(new_n47_), .b(x18), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n52_), .c(new_n95_), .O(new_n97_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n106_), .c(new_n95_), .O(new_n108_));
  oai21  g062(.a(new_n105_), .b(new_n47_), .c(new_n108_), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x16), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n104_), .c(new_n48_), .O(z10));
  inv1   g065(.a(x02), .O(new_n112_));
  oai22  g066(.a(new_n91_), .b(new_n112_), .c(x18), .d(new_n60_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n89_), .O(new_n114_));
  oai21  g068(.a(x19), .b(x17), .c(x21), .O(new_n115_));
  nand3  g069(.a(new_n105_), .b(new_n58_), .c(new_n47_), .O(new_n116_));
  aoi21  g070(.a(new_n116_), .b(new_n115_), .c(x18), .O(new_n117_));
  nor2   g071(.a(new_n58_), .b(new_n47_), .O(new_n118_));
  ...
  nand2  g077(.a(new_n95_), .b(x16), .O(new_n124_));
  nor2   g078(.a(x22), .b(x21), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n52_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n124_), .c(new_n106_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n47_), .O(new_n128_));
  ...
  oai22  g085(.a(new_n91_), .b(new_n131_), .c(x18), .d(new_n70_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n89_), .O(new_n133_));
  nand2  g087(.a(new_n125_), .b(new_n105_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x23), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n107_), .c(new_n58_), .d(new_n95_), .O(new_n137_));
  aoi21  g091(.a(new_n137_), .b(new_n135_), .c(x18), .O(new_n138_));
  nor2   g092(.a(new_n68_), .b(new_n47_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n138_), .c(x16), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n133_), .O(z13));
  inv1   g095(.a(x05), .O(new_n142_));
  oai22  g096(.a(new_n91_), .b(new_n142_), .c(x18), .d(new_n73_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n89_), .O(new_n144_));
  nand3  g098(.a(new_n136_), .b(new_n105_), .c(new_n58_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x24), .O(new_n146_));
  nor2   g100(.a(x24), .b(x23), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n107_), .d(new_n95_), .O(new_n148_));
  aoi21  g102(.a(new_n148_), .b(new_n146_), .c(x18), .O(new_n149_));
  nor2   g103(.a(new_n75_), .b(new_n47_), .O(new_n150_));
  ...
  nand4  g109(.a(new_n58_), .b(new_n52_), .c(new_n95_), .d(x16), .O(new_n156_));
  nand3  g110(.a(new_n136_), .b(new_n80_), .c(new_n75_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n156_), .c(new_n106_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n47_), .O(new_n159_));
  ...
  oai21  g116(.a(x18), .b(new_n83_), .c(new_n162_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n89_), .O(new_n164_));
  nand4  g118(.a(new_n136_), .b(new_n85_), .c(new_n80_), .d(new_n75_), .O(new_n165_));
  oai21  g119(.a(new_n165_), .b(new_n156_), .c(new_n106_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n47_), .O(new_n167_));
  ...
  nand4  g124(.a(new_n58_), .b(new_n47_), .c(x19), .d(new_n95_), .O(new_n171_));
  oai22  g125(.a(new_n171_), .b(new_n165_), .c(new_n53_), .d(new_n95_), .O(new_n172_));
