...
module FAU ( 
  ...
  nand4  g55(.a(new_n101_), .b(new_n92_), .c(new_n51_), .d(new_n85_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n97_), .c(new_n98_), .O(z11));
  oai21  g59(.a(x18), .b(x11), .c(new_n97_), .O(new_n106_));
  ...
  oai22  g67(.a(new_n113_), .b(new_n97_), .c(new_n90_), .d(new_n64_), .O(z13));
  aoi21  g68(.a(new_n112_), .b(new_n94_), .c(new_n71_), .O(new_n115_));
  ...
  nand4  g76(.a(new_n76_), .b(new_n71_), .c(new_n66_), .d(new_n122_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n103_), .c(new_n117_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n89_), .b(x14), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n97_), .c(new_n126_), .O(z15));
  oai21  g81(.a(x18), .b(x15), .c(new_n97_), .O(new_n128_));
  ...
  nand4  g93(.a(new_n130_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n85_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n52_), .d(new_n85_), .O(new_n142_));
