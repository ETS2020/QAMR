...
module FAU ( 
  ...
  nand2  g039(.a(x18), .b(x04), .O(new_n86_));
  ...
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n82_), .O(z10));
  ...
  oai21  g074(.a(x18), .b(new_n66_), .c(new_n86_), .O(new_n121_));
  ...
  aoi21  g085(.a(new_n124_), .b(new_n100_), .c(new_n71_), .O(new_n132_));
  inv1   g086(.a(x17), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n116_), .c(new_n134_), .d(new_n133_), .O(new_n136_));
  ...
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n82_), .O(z15));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n107_), .d(new_n90_), .O(new_n155_));
  ...
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n133_), .O(new_n161_));
