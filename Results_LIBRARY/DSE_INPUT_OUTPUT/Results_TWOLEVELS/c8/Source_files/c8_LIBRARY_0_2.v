...
module FAU ( 
  ...
  nor2   g039(.a(x18), .b(x09), .O(new_n86_));
  ...
  aoi21  g050(.a(new_n91_), .b(x20), .c(new_n96_), .O(new_n97_));
  inv1   g051(.a(x18), .O(new_n98_));
  nor2   g052(.a(new_n98_), .b(x16), .O(new_n99_));
  aoi21  g053(.a(new_n99_), .b(x01), .c(new_n48_), .O(new_n100_));
  oai21  g054(.a(new_n97_), .b(new_n95_), .c(new_n100_), .O(z10));
  nand2  g055(.a(x18), .b(x02), .O(new_n102_));
  nand3  g056(.a(new_n98_), .b(x10), .c(new_n47_), .O(new_n103_));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n90_), .c(new_n66_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n90_), .c(new_n55_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n88_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  nand3  g074(.a(new_n98_), .b(x12), .c(new_n47_), .O(new_n121_));
  ...
  nand2  g079(.a(new_n125_), .b(new_n96_), .O(new_n126_));
  ...
  aoi21  g087(.a(new_n125_), .b(new_n96_), .c(new_n133_), .O(new_n134_));
  inv1   g088(.a(x17), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n115_), .c(new_n136_), .d(new_n135_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n134_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n132_), .c(new_n88_), .O(z14));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n106_), .d(new_n90_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n144_), .c(new_n88_), .O(z15));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n106_), .d(new_n90_), .O(new_n157_));
  ...
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n135_), .O(new_n163_));
