...
module FAU ( 
  ...
  nand3  g46(.a(x18), .b(new_n85_), .c(x01), .O(new_n93_));
  ...
  nand4  g68(.a(new_n114_), .b(new_n104_), .c(new_n96_), .d(new_n80_), .O(new_n115_));
  ...
  nand3  g92(.a(new_n138_), .b(new_n127_), .c(new_n70_), .O(new_n139_));
  nand3  g93(.a(new_n126_), .b(x19), .c(new_n80_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n57_), .d(new_n80_), .O(new_n141_));
