...
module FAU ( 
  ...
  nand3  g047(.a(new_n93_), .b(new_n89_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n88_), .O(z09));
  ...
  nor2   g052(.a(new_n91_), .b(new_n54_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n98_), .c(new_n89_), .O(z10));
  nand2  g056(.a(x18), .b(x02), .O(new_n103_));
  nand3  g057(.a(new_n85_), .b(x10), .c(new_n48_), .O(new_n104_));
  ...
  oai21  g063(.a(new_n100_), .b(new_n107_), .c(new_n109_), .O(new_n110_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n91_), .c(new_n54_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n115_), .c(new_n89_), .O(z12));
  nand2  g076(.a(x18), .b(x04), .O(new_n123_));
  nand3  g077(.a(new_n85_), .b(x12), .c(new_n48_), .O(new_n124_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n100_), .c(new_n107_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n89_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n126_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  nand3  g087(.a(new_n85_), .b(x13), .c(new_n48_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n83_), .O(new_n136_));
  inv1   g090(.a(x17), .O(new_n137_));
  inv1   g091(.a(x19), .O(new_n138_));
  nand3  g092(.a(new_n54_), .b(new_n138_), .c(new_n137_), .O(new_n139_));
  nand3  g093(.a(new_n66_), .b(new_n116_), .c(new_n107_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n139_), .c(x24), .O(new_n141_));
  nor2   g095(.a(x20), .b(x19), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n118_), .c(new_n142_), .d(new_n137_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n89_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n136_), .O(z14));
  ...
  nand4  g106(.a(new_n152_), .b(new_n128_), .c(new_n108_), .d(new_n91_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n89_), .O(z15));
  oai21  g110(.a(new_n85_), .b(new_n83_), .c(x07), .O(new_n157_));
  nand2  g111(.a(new_n153_), .b(x26), .O(new_n158_));
  ...
  nand3  g116(.a(new_n85_), .b(new_n83_), .c(x15), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n162_), .c(new_n157_), .O(z16));
  nor2   g118(.a(x26), .b(x25), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n128_), .c(new_n71_), .O(new_n166_));
  nand3  g120(.a(new_n108_), .b(x19), .c(new_n137_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n55_), .d(new_n137_), .O(new_n168_));
  nand3  g122(.a(new_n168_), .b(new_n89_), .c(x16), .O(new_n169_));
