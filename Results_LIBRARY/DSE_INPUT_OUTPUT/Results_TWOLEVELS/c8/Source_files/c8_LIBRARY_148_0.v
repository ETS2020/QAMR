...
module FAU ( 
  ...
  nand2  g30(.a(new_n57_), .b(new_n76_), .O(new_n77_));
  ...
  nor2   g43(.a(new_n83_), .b(new_n89_), .O(new_n90_));
  nor3   g44(.a(x20), .b(x19), .c(x17), .O(new_n91_));
  oai21  g45(.a(new_n91_), .b(new_n90_), .c(x16), .O(new_n92_));
  nand2  g46(.a(new_n86_), .b(x01), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n92_), .O(z10));
  inv1   g48(.a(x16), .O(new_n95_));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n80_), .O(new_n97_));
  nand4  g51(.a(new_n56_), .b(new_n89_), .c(new_n81_), .d(new_n80_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x21), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n86_), .b(x02), .O(new_n101_));
  oai21  g55(.a(new_n100_), .b(new_n95_), .c(new_n101_), .O(z11));
  oai21  g56(.a(new_n85_), .b(x03), .c(new_n95_), .O(new_n103_));
  nand2  g57(.a(new_n98_), .b(x22), .O(new_n104_));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n83_), .c(new_n89_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n95_), .c(new_n103_), .O(z12));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n91_), .c(new_n106_), .d(x23), .O(new_n110_));
  nand2  g64(.a(new_n86_), .b(x04), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n95_), .c(new_n111_), .O(z13));
  oai21  g66(.a(new_n85_), .b(x05), .c(new_n95_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n109_), .b(new_n91_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n96_), .d(new_n80_), .O(new_n117_));
  ...
  oai21  g74(.a(new_n85_), .b(x06), .c(new_n95_), .O(new_n121_));
  inv1   g75(.a(x23), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n114_), .c(new_n122_), .d(new_n62_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n99_), .c(new_n117_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n95_), .c(new_n121_), .O(z15));
  ...
  nand2  g90(.a(new_n86_), .b(x07), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  nor2   g92(.a(new_n81_), .b(x17), .O(new_n139_));
  nand4  g93(.a(new_n139_), .b(new_n133_), .c(new_n129_), .d(new_n128_), .O(new_n140_));
  nand2  g94(.a(x27), .b(x17), .O(new_n141_));
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n95_), .O(z17));
endmodule
