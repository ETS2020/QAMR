...
module FAU ( 
  ...
  oai22  g064(.a(new_n85_), .b(new_n110_), .c(x18), .d(new_n63_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n83_), .O(new_n112_));
  nand2  g066(.a(new_n106_), .b(x22), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n94_), .c(new_n54_), .O(new_n115_));
  ...
  oai22  g073(.a(new_n85_), .b(new_n119_), .c(x18), .d(new_n68_), .O(new_n120_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n48_), .c(x16), .O(new_n126_));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n104_), .c(new_n73_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n114_), .c(new_n96_), .d(new_n95_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n130_), .c(new_n48_), .O(z14));
  inv1   g090(.a(x06), .O(new_n137_));
  oai22  g091(.a(new_n85_), .b(new_n137_), .c(x18), .d(new_n76_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n105_), .d(new_n94_), .O(new_n143_));
