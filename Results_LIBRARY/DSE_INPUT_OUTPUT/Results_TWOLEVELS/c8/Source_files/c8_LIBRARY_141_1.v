...
module FAU ( 
  ...
  oai22  g078(.a(new_n99_), .b(new_n124_), .c(x18), .d(new_n71_), .O(new_n125_));
  ...
  oai22  g087(.a(new_n99_), .b(new_n133_), .c(x18), .d(new_n76_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  nand3  g089(.a(new_n73_), .b(new_n68_), .c(new_n63_), .O(new_n136_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n128_), .c(new_n110_), .d(new_n91_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n128_), .c(new_n78_), .O(new_n163_));
