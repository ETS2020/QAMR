...
module FAU ( 
  ...
  nand2  g061(.a(new_n102_), .b(x21), .O(new_n108_));
  ...
  aoi21  g065(.a(new_n111_), .b(x16), .c(new_n107_), .O(new_n112_));
  inv1   g066(.a(x18), .O(new_n113_));
  nand3  g067(.a(new_n111_), .b(new_n113_), .c(x16), .O(new_n114_));
  oai21  g068(.a(new_n112_), .b(new_n47_), .c(new_n114_), .O(z11));
  ...
  oai22  g079(.a(new_n99_), .b(new_n125_), .c(x18), .d(new_n70_), .O(new_n126_));
  ...
  aoi21  g091(.a(new_n130_), .b(new_n129_), .c(new_n73_), .O(new_n138_));
  nand3  g092(.a(new_n120_), .b(new_n73_), .c(new_n68_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n102_), .O(new_n140_));
  ...
  oai21  g099(.a(new_n139_), .b(new_n102_), .c(x25), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n109_), .d(new_n91_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n109_), .d(new_n91_), .O(new_n158_));
  ...
  nand4  g115(.a(new_n147_), .b(new_n85_), .c(new_n78_), .d(new_n73_), .O(new_n162_));
  nand3  g116(.a(new_n109_), .b(x19), .c(new_n89_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n53_), .d(new_n89_), .O(new_n164_));
