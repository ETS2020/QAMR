...
module FAU ( 
  ...
  aoi21  g14(.a(x27), .b(new_n60_), .c(new_n47_), .O(new_n61_));
  ...
  nand2  g19(.a(new_n51_), .b(new_n65_), .O(new_n66_));
  aoi21  g20(.a(new_n66_), .b(new_n64_), .c(new_n47_), .O(z04));
  ...
  inv1   g33(.a(x26), .O(new_n80_));
  nand2  g34(.a(new_n51_), .b(new_n80_), .O(new_n81_));
  aoi21  g35(.a(new_n81_), .b(new_n79_), .c(new_n47_), .O(z07));
  ...
  oai21  g52(.a(new_n88_), .b(x02), .c(new_n98_), .O(new_n99_));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  inv1   g55(.a(x21), .O(new_n102_));
  nand4  g56(.a(new_n102_), .b(new_n92_), .c(new_n50_), .d(new_n84_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n101_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai21  g59(.a(new_n105_), .b(new_n98_), .c(new_n99_), .O(z11));
  oai21  g60(.a(new_n88_), .b(x03), .c(new_n98_), .O(new_n107_));
  nand2  g61(.a(new_n103_), .b(x22), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n86_), .c(new_n92_), .O(new_n110_));
  and2   g64(.a(new_n110_), .b(new_n108_), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n98_), .c(new_n107_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n94_), .c(new_n110_), .d(x23), .O(new_n114_));
  nand2  g68(.a(new_n89_), .b(x04), .O(new_n115_));
  oai21  g69(.a(new_n114_), .b(new_n98_), .c(new_n115_), .O(z13));
  aoi21  g70(.a(new_n113_), .b(new_n94_), .c(new_n70_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n109_), .c(new_n100_), .d(new_n84_), .O(new_n119_));
  ...
  inv1   g94(.a(new_n47_), .O(new_n141_));
  nand4  g95(.a(new_n132_), .b(new_n80_), .c(new_n75_), .d(new_n70_), .O(new_n142_));
  nand3  g96(.a(new_n131_), .b(x19), .c(new_n84_), .O(new_n143_));
  oai22  g97(.a(new_n143_), .b(new_n142_), .c(new_n51_), .d(new_n84_), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g99(.a(new_n145_), .b(new_n141_), .O(z17));
endmodule
