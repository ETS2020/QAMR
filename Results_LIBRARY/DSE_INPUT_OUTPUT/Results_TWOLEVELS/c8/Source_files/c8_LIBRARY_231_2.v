...
module FAU ( 
  ...
  nand3  g024(.a(new_n55_), .b(new_n69_), .c(x18), .O(new_n71_));
  ...
  aoi22  g054(.a(new_n85_), .b(x10), .c(x18), .d(x02), .O(new_n101_));
  inv1   g055(.a(x21), .O(new_n102_));
  nor2   g056(.a(x21), .b(x20), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  oai21  g058(.a(new_n98_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n83_), .c(x16), .O(new_n106_));
  oai21  g060(.a(new_n101_), .b(x16), .c(new_n106_), .O(z11));
  ...
  aoi21  g065(.a(new_n103_), .b(new_n88_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n88_), .c(new_n54_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n83_), .O(z12));
  ...
  nand3  g077(.a(new_n123_), .b(new_n98_), .c(new_n102_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n66_), .b(new_n111_), .c(new_n102_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n130_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n113_), .c(new_n133_), .d(new_n128_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n83_), .c(x16), .O(new_n137_));
  nand3  g091(.a(x18), .b(new_n93_), .c(x05), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n137_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  inv1   g094(.a(x18), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(x14), .c(new_n48_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n93_), .O(new_n144_));
  nand2  g098(.a(new_n135_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n123_), .c(new_n103_), .d(new_n88_), .O(new_n147_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n123_), .c(new_n103_), .d(new_n88_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n123_), .b(new_n80_), .c(new_n75_), .d(new_n69_), .O(new_n160_));
  nand3  g114(.a(new_n103_), .b(x19), .c(new_n128_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n128_), .O(new_n162_));
