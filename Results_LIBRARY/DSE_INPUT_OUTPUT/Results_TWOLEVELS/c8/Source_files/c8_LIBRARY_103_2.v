...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n51_), .c(new_n83_), .O(new_n98_));
  oai21  g052(.a(new_n85_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n85_), .c(new_n63_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n85_), .c(new_n97_), .O(new_n117_));
  ...
  oai21  g075(.a(new_n94_), .b(new_n66_), .c(new_n121_), .O(new_n122_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n125_), .c(new_n107_), .d(new_n85_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n142_), .c(new_n82_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n93_), .b(x15), .c(new_n47_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n125_), .c(new_n107_), .d(new_n85_), .O(new_n155_));
  ...
  nand4  g113(.a(new_n125_), .b(new_n78_), .c(new_n73_), .d(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n83_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n52_), .d(new_n83_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n82_), .O(z17));
endmodule
