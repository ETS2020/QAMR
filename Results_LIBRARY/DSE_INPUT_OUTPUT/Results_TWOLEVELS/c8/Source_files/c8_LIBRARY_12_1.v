...
module FAU ( 
  ...
  nand2  g050(.a(new_n96_), .b(x08), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n95_), .O(z09));
  oai21  g052(.a(x18), .b(x09), .c(new_n47_), .O(new_n99_));
  nor2   g053(.a(new_n94_), .b(new_n58_), .O(new_n100_));
  ...
  nand4  g060(.a(new_n61_), .b(new_n58_), .c(new_n52_), .d(new_n92_), .O(new_n107_));
  ...
  aoi22  g072(.a(new_n118_), .b(new_n101_), .c(new_n114_), .d(x23), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n47_), .c(new_n117_), .O(z13));
  oai21  g074(.a(x18), .b(x13), .c(new_n47_), .O(new_n121_));
  aoi21  g075(.a(new_n118_), .b(new_n101_), .c(new_n78_), .O(new_n122_));
  nor2   g076(.a(x24), .b(x23), .O(new_n123_));
  nand4  g077(.a(new_n123_), .b(new_n113_), .c(new_n105_), .d(new_n92_), .O(new_n124_));
  ...
  nand4  g081(.a(new_n81_), .b(new_n78_), .c(new_n71_), .d(new_n66_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n108_), .c(new_n124_), .d(x25), .O(new_n130_));
  nand2  g084(.a(new_n96_), .b(x14), .O(new_n131_));
  ...
  nand2  g095(.a(new_n96_), .b(x15), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n141_), .O(z16));
  nand4  g097(.a(new_n134_), .b(new_n86_), .c(new_n81_), .d(new_n78_), .O(new_n144_));
  nand3  g098(.a(new_n133_), .b(x19), .c(new_n92_), .O(new_n145_));
