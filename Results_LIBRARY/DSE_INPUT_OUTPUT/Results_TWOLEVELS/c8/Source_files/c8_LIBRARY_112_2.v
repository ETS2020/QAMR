...
module FAU ( 
  ...
  nand3  g064(.a(new_n110_), .b(new_n91_), .c(new_n57_), .O(new_n111_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n100_), .O(new_n120_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n119_), .c(new_n101_), .d(new_n91_), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n101_), .d(new_n91_), .O(new_n151_));
