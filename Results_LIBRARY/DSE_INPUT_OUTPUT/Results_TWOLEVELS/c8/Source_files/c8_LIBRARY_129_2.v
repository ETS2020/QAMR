...
module FAU ( 
  ...
  nor2   g040(.a(x18), .b(x09), .O(new_n87_));
  ...
  nand3  g066(.a(new_n102_), .b(x11), .c(new_n47_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n98_), .O(new_n115_));
  nand2  g069(.a(new_n108_), .b(x22), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n92_), .c(new_n55_), .O(new_n118_));
  ...
  nand2  g086(.a(new_n132_), .b(new_n98_), .O(new_n133_));
  aoi21  g087(.a(new_n126_), .b(new_n106_), .c(new_n74_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n117_), .c(new_n94_), .d(new_n93_), .O(new_n136_));
  inv1   g090(.a(new_n136_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n134_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n133_), .c(new_n85_), .O(z14));
  nand2  g093(.a(x18), .b(x06), .O(new_n140_));
  nand3  g094(.a(new_n102_), .b(x14), .c(new_n47_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n98_), .O(new_n143_));
  nand2  g097(.a(new_n136_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x23), .b(x22), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n107_), .d(new_n92_), .O(new_n147_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n98_), .O(new_n153_));
  nand2  g107(.a(new_n147_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n107_), .d(new_n92_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n145_), .c(new_n74_), .O(new_n161_));
  nand3  g115(.a(new_n107_), .b(x19), .c(new_n93_), .O(new_n162_));
