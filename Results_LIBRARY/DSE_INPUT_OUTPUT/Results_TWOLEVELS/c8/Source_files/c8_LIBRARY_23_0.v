...
module FAU ( 
  ...
  nand2  g031(.a(new_n77_), .b(new_n54_), .O(z08));
  ...
  nor2   g043(.a(new_n80_), .b(new_n53_), .O(new_n90_));
  ...
  nand3  g056(.a(new_n74_), .b(x15), .c(x11), .O(new_n103_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n80_), .c(new_n53_), .O(new_n108_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n123_), .c(new_n77_), .O(z14));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n97_), .d(new_n80_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n77_), .O(z15));
  oai21  g096(.a(new_n74_), .b(x07), .c(new_n82_), .O(new_n143_));
  nand2  g097(.a(new_n139_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n137_), .c(new_n97_), .d(new_n80_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n143_), .c(new_n77_), .O(z16));
  nor2   g103(.a(x26), .b(x25), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n137_), .c(new_n124_), .O(new_n151_));
  nand3  g105(.a(new_n97_), .b(x19), .c(new_n126_), .O(new_n152_));
  oai22  g106(.a(new_n152_), .b(new_n151_), .c(new_n54_), .d(new_n126_), .O(new_n153_));
