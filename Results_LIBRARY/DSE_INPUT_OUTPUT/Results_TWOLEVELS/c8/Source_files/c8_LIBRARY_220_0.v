...
module FAU ( 
  ...
  nand3  g043(.a(new_n89_), .b(x08), .c(x07), .O(new_n90_));
  ...
  nand3  g050(.a(new_n89_), .b(x09), .c(x07), .O(new_n97_));
  ...
  nand3  g055(.a(new_n56_), .b(new_n49_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n108_), .c(new_n85_), .O(z11));
  nand2  g068(.a(x18), .b(x03), .O(new_n115_));
  nand3  g069(.a(new_n89_), .b(x11), .c(x07), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n100_), .c(new_n56_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n85_), .c(x16), .O(new_n123_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n129_), .c(new_n110_), .d(new_n100_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n85_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  oai21  g111(.a(x18), .b(new_n82_), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n87_), .O(new_n159_));
  nand2  g113(.a(new_n153_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n129_), .c(new_n110_), .d(new_n100_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n159_), .c(new_n85_), .O(z16));
  nor2   g119(.a(x26), .b(x25), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n129_), .c(new_n74_), .O(new_n167_));
  nand3  g121(.a(new_n110_), .b(x19), .c(new_n101_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n50_), .d(new_n101_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n85_), .O(z17));
endmodule
