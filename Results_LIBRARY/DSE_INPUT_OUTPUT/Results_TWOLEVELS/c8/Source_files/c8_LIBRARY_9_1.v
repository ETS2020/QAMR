...
module FAU ( 
  ...
  nand2  g29(.a(new_n64_), .b(new_n75_), .O(new_n76_));
  aoi21  g30(.a(new_n76_), .b(new_n74_), .c(new_n49_), .O(z07));
  inv1   g31(.a(new_n49_), .O(new_n78_));
  nand2  g32(.a(new_n78_), .b(new_n64_), .O(z08));
  ...
  nand3  g39(.a(new_n48_), .b(new_n85_), .c(x08), .O(new_n86_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n104_), .c(new_n95_), .d(new_n80_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n113_), .c(new_n63_), .d(new_n121_), .O(new_n123_));
  ...
  nand3  g89(.a(new_n48_), .b(new_n85_), .c(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  nand4  g91(.a(new_n128_), .b(new_n75_), .c(new_n122_), .d(new_n113_), .O(new_n138_));
  nand3  g92(.a(new_n127_), .b(x19), .c(new_n80_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n64_), .d(new_n80_), .O(new_n140_));
