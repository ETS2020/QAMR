...
module FAU ( 
  ...
  nor2   g001(.a(new_n47_), .b(x11), .O(new_n48_));
  ...
  nor2   g019(.a(x27), .b(x22), .O(new_n66_));
  aoi21  g020(.a(x27), .b(new_n65_), .c(new_n66_), .O(new_n67_));
  nand2  g021(.a(new_n66_), .b(x11), .O(new_n68_));
  oai21  g022(.a(new_n67_), .b(x18), .c(new_n68_), .O(z03));
  ...
  nand2  g042(.a(new_n88_), .b(new_n52_), .O(z08));
  inv1   g043(.a(x16), .O(new_n90_));
  inv1   g044(.a(x00), .O(new_n91_));
  nand2  g045(.a(x18), .b(x11), .O(new_n92_));
  ...
  nor2   g057(.a(new_n96_), .b(new_n57_), .O(new_n104_));
  inv1   g058(.a(x17), .O(new_n105_));
  nand3  g059(.a(new_n57_), .b(new_n51_), .c(new_n105_), .O(new_n106_));
  inv1   g060(.a(new_n106_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n104_), .c(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n103_), .c(new_n88_), .O(z10));
  ...
  nand3  g070(.a(new_n116_), .b(new_n112_), .c(new_n88_), .O(z11));
  ...
  inv1   g075(.a(new_n114_), .O(new_n122_));
  nor2   g076(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g077(.a(new_n121_), .b(new_n62_), .O(new_n124_));
  nor3   g078(.a(new_n124_), .b(new_n97_), .c(x20), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n123_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n120_), .c(new_n88_), .O(z12));
  ...
  nor2   g084(.a(new_n125_), .b(new_n72_), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n62_), .O(new_n133_));
  nor2   g087(.a(new_n133_), .b(new_n106_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n130_), .c(new_n88_), .O(z13));
  ...
  nor2   g094(.a(new_n134_), .b(new_n140_), .O(new_n141_));
  nor4   g095(.a(new_n124_), .b(new_n106_), .c(x24), .d(x23), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n141_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n139_), .c(new_n88_), .O(z14));
  ...
  nand3  g101(.a(new_n132_), .b(new_n80_), .c(new_n140_), .O(new_n148_));
  oai22  g102(.a(new_n148_), .b(new_n114_), .c(new_n142_), .d(new_n80_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n147_), .c(new_n88_), .O(z15));
  inv1   g105(.a(x07), .O(new_n152_));
  oai22  g106(.a(new_n92_), .b(new_n152_), .c(x18), .d(new_n83_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n90_), .O(new_n154_));
  aoi21  g108(.a(x18), .b(new_n65_), .c(new_n122_), .O(new_n155_));
  inv1   g109(.a(new_n148_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n48_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n155_), .c(x26), .O(new_n158_));
  aoi21  g112(.a(x18), .b(new_n65_), .c(x26), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n80_), .c(new_n140_), .d(new_n72_), .O(new_n160_));
  nor2   g114(.a(new_n160_), .b(x22), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n62_), .c(new_n57_), .d(new_n51_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(x17), .c(new_n158_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n154_), .O(z16));
  nand3  g119(.a(new_n113_), .b(x19), .c(new_n105_), .O(new_n166_));
  nand4  g120(.a(new_n132_), .b(new_n85_), .c(new_n80_), .d(new_n140_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n52_), .d(new_n105_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n88_), .O(z17));
endmodule
