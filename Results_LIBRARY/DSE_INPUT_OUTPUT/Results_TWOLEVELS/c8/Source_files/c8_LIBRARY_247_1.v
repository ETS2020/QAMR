...
module FAU ( 
  ...
  oai22  g65(.a(new_n111_), .b(new_n90_), .c(new_n96_), .d(new_n68_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n90_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n94_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n108_), .c(new_n98_), .d(new_n86_), .O(new_n117_));
  ...
  nand4  g76(.a(new_n76_), .b(new_n114_), .c(new_n122_), .d(new_n65_), .O(new_n123_));
  ...
  nand3  g89(.a(new_n47_), .b(new_n90_), .c(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  nand4  g91(.a(new_n128_), .b(new_n81_), .c(new_n76_), .d(new_n114_), .O(new_n138_));
  nand3  g92(.a(new_n127_), .b(x19), .c(new_n86_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n52_), .d(new_n86_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n84_), .O(z17));
endmodule
