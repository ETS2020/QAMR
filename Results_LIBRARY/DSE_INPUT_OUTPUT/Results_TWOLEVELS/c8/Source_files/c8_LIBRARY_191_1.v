...
module FAU ( 
  ...
  aoi21  g030(.a(new_n76_), .b(new_n74_), .c(new_n60_), .O(z05));
  ...
  aoi21  g035(.a(new_n81_), .b(new_n79_), .c(new_n60_), .O(z06));
  ...
  oai21  g070(.a(x18), .b(new_n52_), .c(new_n116_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n93_), .O(new_n118_));
  inv1   g072(.a(x22), .O(new_n119_));
  aoi21  g073(.a(new_n111_), .b(new_n91_), .c(new_n119_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n91_), .c(new_n55_), .O(new_n122_));
  ...
  oai22  g080(.a(new_n99_), .b(new_n126_), .c(x18), .d(new_n70_), .O(new_n127_));
  ...
  aoi21  g091(.a(new_n130_), .b(new_n110_), .c(new_n75_), .O(new_n138_));
  ...
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n53_), .O(z14));
  ...
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n111_), .d(new_n91_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n111_), .d(new_n91_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n83_), .c(new_n80_), .d(new_n75_), .O(new_n163_));
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n89_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n48_), .d(new_n89_), .O(new_n165_));
