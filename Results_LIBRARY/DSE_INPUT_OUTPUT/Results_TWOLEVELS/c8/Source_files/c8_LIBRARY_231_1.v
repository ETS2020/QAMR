...
module FAU ( 
  ...
  nor2   g058(.a(new_n97_), .b(new_n58_), .O(new_n105_));
  ...
  oai22  g063(.a(new_n93_), .b(new_n109_), .c(x18), .d(new_n63_), .O(new_n110_));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n97_), .c(new_n66_), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n58_), .O(new_n122_));
  nor2   g076(.a(new_n122_), .b(new_n98_), .O(new_n123_));
  ...
  oai22  g080(.a(new_n93_), .b(new_n126_), .c(x18), .d(new_n71_), .O(new_n127_));
  ...
  oai21  g084(.a(new_n123_), .b(new_n73_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g089(.a(new_n130_), .b(x24), .O(new_n136_));
  inv1   g090(.a(x24), .O(new_n137_));
  nand4  g091(.a(new_n121_), .b(new_n106_), .c(new_n137_), .d(new_n73_), .O(new_n138_));
  ...
  aoi22  g100(.a(new_n129_), .b(new_n106_), .c(x18), .d(new_n52_), .O(new_n147_));
  nor2   g101(.a(new_n55_), .b(new_n137_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n147_), .c(x25), .O(new_n149_));
  nand4  g103(.a(new_n53_), .b(new_n82_), .c(new_n137_), .d(new_n73_), .O(new_n150_));
  nor2   g104(.a(new_n150_), .b(x22), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n61_), .c(new_n58_), .d(new_n47_), .O(new_n152_));
  oai21  g106(.a(new_n152_), .b(x17), .c(new_n149_), .O(new_n153_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n82_), .c(new_n137_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n113_), .c(x26), .O(new_n161_));
  nand4  g115(.a(new_n159_), .b(new_n87_), .c(new_n82_), .d(new_n137_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(new_n113_), .c(new_n161_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n158_), .c(new_n53_), .O(z16));
  inv1   g119(.a(x17), .O(new_n166_));
  nand3  g120(.a(new_n112_), .b(x19), .c(new_n166_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n162_), .c(new_n48_), .d(new_n166_), .O(new_n168_));
