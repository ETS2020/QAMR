...
module FAU ( 
  ...
  aoi21  g019(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n66_));
  ...
  nor2   g036(.a(new_n49_), .b(new_n55_), .O(z08));
  ...
  oai21  g051(.a(new_n97_), .b(new_n52_), .c(new_n95_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n90_), .O(new_n99_));
  nand3  g053(.a(new_n54_), .b(new_n86_), .c(new_n85_), .O(new_n100_));
  oai21  g054(.a(new_n88_), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  ...
  oai21  g058(.a(new_n97_), .b(new_n58_), .c(new_n104_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n90_), .O(new_n106_));
  ...
  aoi21  g070(.a(new_n108_), .b(new_n88_), .c(new_n116_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n88_), .c(new_n54_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n115_), .c(new_n84_), .O(z12));
  nand2  g076(.a(new_n119_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n107_), .c(new_n60_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n84_), .c(x16), .O(new_n127_));
  nand3  g081(.a(x18), .b(new_n90_), .c(x04), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n127_), .O(z13));
  nand2  g083(.a(x18), .b(x05), .O(new_n130_));
  nand3  g084(.a(new_n96_), .b(x13), .c(new_n48_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n90_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n116_), .c(new_n60_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n100_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n137_), .d(new_n85_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n84_), .c(x16), .O(new_n141_));
  ...
  nand2  g098(.a(new_n144_), .b(new_n90_), .O(new_n145_));
  nand2  g099(.a(new_n139_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x25), .b(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n124_), .c(new_n108_), .d(new_n88_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n145_), .c(new_n84_), .O(z15));
  nand2  g105(.a(x18), .b(x07), .O(new_n152_));
  oai21  g106(.a(x18), .b(new_n78_), .c(new_n152_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n124_), .c(new_n108_), .d(new_n88_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n124_), .b(new_n80_), .c(new_n75_), .d(new_n70_), .O(new_n161_));
  nand3  g115(.a(new_n108_), .b(x19), .c(new_n85_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n85_), .O(new_n163_));
