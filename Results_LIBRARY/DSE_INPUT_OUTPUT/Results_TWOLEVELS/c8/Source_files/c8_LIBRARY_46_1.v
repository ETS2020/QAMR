...
module FAU ( 
  ...
  nand2  g41(.a(new_n47_), .b(new_n87_), .O(new_n88_));
  ...
  oai21  g47(.a(new_n88_), .b(new_n55_), .c(new_n93_), .O(z10));
  oai21  g48(.a(x18), .b(x10), .c(new_n87_), .O(new_n95_));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n83_), .O(new_n97_));
  nand4  g51(.a(new_n60_), .b(new_n90_), .c(new_n51_), .d(new_n83_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n97_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n87_), .c(new_n95_), .O(z11));
  nor3   g55(.a(x22), .b(x21), .c(x20), .O(new_n102_));
  aoi22  g56(.a(new_n102_), .b(new_n85_), .c(new_n98_), .d(x22), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n87_), .c(new_n88_), .d(new_n63_), .O(z12));
  oai21  g58(.a(x18), .b(x12), .c(new_n87_), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n85_), .c(new_n90_), .O(new_n107_));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n92_), .c(new_n107_), .d(x23), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n87_), .c(new_n105_), .O(z13));
  oai21  g64(.a(x18), .b(x13), .c(new_n87_), .O(new_n111_));
  inv1   g65(.a(x24), .O(new_n112_));
  aoi21  g66(.a(new_n108_), .b(new_n92_), .c(new_n112_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n106_), .c(new_n96_), .d(new_n83_), .O(new_n115_));
  ...
  oai21  g72(.a(x18), .b(x14), .c(new_n87_), .O(new_n119_));
  inv1   g73(.a(x22), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n112_), .c(new_n68_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n99_), .c(new_n115_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n87_), .c(new_n119_), .O(z15));
  ...
  nand4  g91(.a(new_n127_), .b(new_n79_), .c(new_n121_), .d(new_n112_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n83_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n52_), .d(new_n83_), .O(new_n140_));
