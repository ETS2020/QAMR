...
module FAU ( 
  ...
  nand3  g074(.a(new_n68_), .b(new_n63_), .c(new_n58_), .O(new_n121_));
  ...
  nand2  g082(.a(new_n128_), .b(new_n111_), .O(new_n129_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n111_), .c(new_n78_), .O(new_n136_));
  nand4  g090(.a(new_n78_), .b(new_n73_), .c(new_n68_), .d(new_n63_), .O(new_n137_));
  nor2   g091(.a(new_n137_), .b(new_n104_), .O(new_n138_));
  ...
  oai22  g095(.a(new_n91_), .b(new_n141_), .c(x18), .d(new_n81_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n89_), .O(new_n143_));
  nor2   g097(.a(x23), .b(x22), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n112_), .d(new_n95_), .O(new_n146_));
  oai21  g100(.a(new_n138_), .b(new_n83_), .c(new_n146_), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n144_), .c(new_n112_), .d(new_n95_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  aoi21  g109(.a(new_n155_), .b(x16), .c(new_n151_), .O(new_n156_));
  inv1   g110(.a(x18), .O(new_n157_));
  nand3  g111(.a(new_n155_), .b(new_n157_), .c(x16), .O(new_n158_));
  oai21  g112(.a(new_n156_), .b(new_n52_), .c(new_n158_), .O(z16));
  nand2  g113(.a(new_n153_), .b(new_n144_), .O(new_n160_));
  nand3  g114(.a(new_n112_), .b(x19), .c(new_n103_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n48_), .d(new_n103_), .O(new_n162_));
