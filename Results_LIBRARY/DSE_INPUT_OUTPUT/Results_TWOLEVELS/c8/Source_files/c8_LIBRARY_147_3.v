...
module FAU ( 
  ...
  oai21  g027(.a(new_n73_), .b(x18), .c(new_n72_), .O(z04));
  ...
  nand2  g042(.a(x18), .b(new_n70_), .O(new_n89_));
  ...
  oai22  g049(.a(new_n89_), .b(new_n95_), .c(x18), .d(new_n55_), .O(new_n96_));
  ...
  oai21  g055(.a(new_n98_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n47_), .O(z11));
  inv1   g067(.a(x03), .O(new_n114_));
  oai22  g068(.a(new_n89_), .b(new_n114_), .c(x18), .d(new_n65_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  nand2  g070(.a(new_n110_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n98_), .c(new_n57_), .O(new_n119_));
  ...
  aoi21  g088(.a(new_n125_), .b(new_n108_), .c(new_n134_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n118_), .c(new_n100_), .d(new_n99_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n109_), .d(new_n98_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n89_), .b(new_n151_), .c(x18), .d(new_n81_), .O(new_n152_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n109_), .d(new_n98_), .O(new_n156_));
  ...
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n52_), .d(new_n99_), .O(new_n163_));
