...
module FAU ( 
  ...
  oai21  g53(.a(new_n89_), .b(x02), .c(new_n99_), .O(new_n100_));
  nor2   g54(.a(x20), .b(x19), .O(new_n101_));
  nand2  g55(.a(new_n101_), .b(new_n85_), .O(new_n102_));
  nand4  g56(.a(new_n59_), .b(new_n93_), .c(new_n50_), .d(new_n85_), .O(new_n103_));
  ...
  nand3  g62(.a(new_n108_), .b(new_n87_), .c(new_n93_), .O(new_n109_));
  ...
  aoi22  g67(.a(new_n113_), .b(new_n95_), .c(new_n109_), .d(x23), .O(new_n114_));
  nand2  g68(.a(new_n90_), .b(x04), .O(new_n115_));
  oai21  g69(.a(new_n114_), .b(new_n99_), .c(new_n115_), .O(z13));
  aoi21  g70(.a(new_n113_), .b(new_n95_), .c(new_n72_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n108_), .c(new_n101_), .d(new_n85_), .O(new_n119_));
  ...
  oai21  g77(.a(new_n89_), .b(x06), .c(new_n99_), .O(new_n124_));
  inv1   g78(.a(x23), .O(new_n125_));
  nand4  g79(.a(new_n77_), .b(new_n72_), .c(new_n125_), .d(new_n64_), .O(new_n126_));
