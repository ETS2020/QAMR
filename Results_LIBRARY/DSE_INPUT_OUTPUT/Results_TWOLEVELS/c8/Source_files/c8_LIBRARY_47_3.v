...
module FAU ( 
  ...
  oai22  g084(.a(new_n86_), .b(new_n130_), .c(x18), .d(new_n69_), .O(new_n131_));
  ...
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n48_), .O(z15));
  nand2  g106(.a(new_n149_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n125_), .c(new_n106_), .d(new_n90_), .O(new_n155_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n125_), .c(new_n71_), .O(new_n162_));
  nand3  g116(.a(new_n106_), .b(x19), .c(new_n133_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n55_), .d(new_n133_), .O(new_n164_));
