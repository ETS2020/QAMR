...
module FAU ( 
  ...
  nand2  g087(.a(new_n97_), .b(x13), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n133_), .c(new_n125_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n101_), .d(new_n93_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n110_), .c(x16), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n101_), .d(new_n93_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n97_), .b(x15), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  inv1   g107(.a(x22), .O(new_n154_));
  nand2  g108(.a(new_n68_), .b(new_n154_), .O(new_n155_));
  nand3  g109(.a(new_n81_), .b(new_n76_), .c(new_n126_), .O(new_n156_));
  ...
  nor2   g113(.a(new_n52_), .b(new_n128_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n110_), .c(new_n88_), .O(z17));
endmodule
