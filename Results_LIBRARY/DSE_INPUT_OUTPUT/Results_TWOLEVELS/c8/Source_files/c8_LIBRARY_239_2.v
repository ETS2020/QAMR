...
module FAU ( 
  ...
  nand3  g047(.a(new_n54_), .b(new_n84_), .c(new_n83_), .O(new_n94_));
  oai21  g048(.a(new_n86_), .b(new_n54_), .c(new_n94_), .O(new_n95_));
  ...
  nand2  g060(.a(new_n106_), .b(new_n100_), .O(z11));
  oai21  g061(.a(x16), .b(x11), .c(new_n81_), .O(new_n108_));
  inv1   g062(.a(x22), .O(new_n109_));
  aoi21  g063(.a(new_n103_), .b(new_n86_), .c(new_n109_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n86_), .c(new_n54_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n88_), .b(x03), .O(new_n115_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n109_), .c(new_n101_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n94_), .c(x24), .O(new_n130_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n119_), .c(new_n103_), .d(new_n86_), .O(new_n150_));
  ...
  nand2  g107(.a(new_n128_), .b(new_n109_), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n74_), .c(new_n69_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n83_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n55_), .b(new_n83_), .O(new_n160_));
