...
module FAU ( 
  ...
  nand2  g083(.a(new_n86_), .b(x05), .O(new_n130_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n99_), .d(new_n84_), .O(new_n136_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n134_), .c(new_n99_), .d(new_n84_), .O(new_n146_));
  ...
  nand2  g103(.a(new_n68_), .b(new_n63_), .O(new_n150_));
  inv1   g104(.a(x25), .O(new_n151_));
  inv1   g105(.a(x26), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n122_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n150_), .O(new_n154_));
  nand3  g108(.a(new_n99_), .b(x19), .c(new_n124_), .O(new_n155_));
  inv1   g109(.a(new_n155_), .O(new_n156_));
  nor2   g110(.a(new_n55_), .b(new_n124_), .O(new_n157_));
