...
module FAU ( 
  ...
  nor2   g35(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  nand4  g53(.a(new_n99_), .b(new_n92_), .c(new_n84_), .d(new_n83_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n48_), .b(new_n88_), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n55_), .c(new_n102_), .d(new_n88_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n86_), .c(new_n100_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n88_), .c(new_n103_), .d(new_n58_), .O(z12));
  ...
  aoi21  g68(.a(new_n111_), .b(new_n94_), .c(new_n69_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n109_), .c(new_n97_), .d(new_n83_), .O(new_n117_));
  ...
  nand3  g89(.a(new_n48_), .b(new_n88_), .c(x15), .O(new_n136_));
