...
module FAU ( 
  ...
  aoi21  g063(.a(new_n103_), .b(new_n91_), .c(new_n109_), .O(new_n110_));
  ...
  nand2  g068(.a(new_n95_), .b(x11), .O(new_n115_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n101_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z13));
  oai21  g079(.a(x16), .b(x05), .c(x18), .O(new_n126_));
  inv1   g080(.a(x24), .O(new_n127_));
  aoi21  g081(.a(new_n121_), .b(new_n93_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g087(.a(new_n95_), .b(x13), .O(new_n134_));
  ...
  nand3  g097(.a(new_n143_), .b(new_n101_), .c(x16), .O(new_n144_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n140_), .c(new_n127_), .O(new_n155_));
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n83_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n55_), .d(new_n83_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n101_), .c(x16), .O(new_n158_));
