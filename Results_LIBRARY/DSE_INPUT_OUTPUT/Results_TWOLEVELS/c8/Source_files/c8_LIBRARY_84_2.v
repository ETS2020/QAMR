...
module FAU ( 
  ...
  nand2  g048(.a(x19), .b(x18), .O(new_n95_));
  oai22  g049(.a(new_n95_), .b(new_n94_), .c(x18), .d(new_n51_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  nand2  g051(.a(x20), .b(x17), .O(new_n98_));
  inv1   g052(.a(x20), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n48_), .c(new_n84_), .O(new_n100_));
  aoi21  g054(.a(new_n100_), .b(new_n98_), .c(x18), .O(new_n101_));
  nor2   g055(.a(new_n99_), .b(new_n48_), .O(new_n102_));
  ...
  nand2  g063(.a(new_n109_), .b(new_n52_), .O(new_n110_));
  ...
  oai21  g073(.a(new_n119_), .b(new_n117_), .c(new_n52_), .O(new_n120_));
  ...
  oai21  g084(.a(new_n130_), .b(new_n128_), .c(new_n52_), .O(new_n131_));
  ...
  oai21  g094(.a(new_n140_), .b(new_n128_), .c(new_n52_), .O(new_n141_));
  ...
  oai22  g100(.a(new_n95_), .b(new_n146_), .c(x18), .d(new_n74_), .O(new_n147_));
  ...
  oai22  g112(.a(new_n95_), .b(new_n158_), .c(x18), .d(new_n79_), .O(new_n159_));
