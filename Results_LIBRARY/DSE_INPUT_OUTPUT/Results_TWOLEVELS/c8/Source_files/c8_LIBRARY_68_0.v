...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n54_,
    ...
    new_n73_, new_n75_, new_n76_, new_n78_, new_n79_, new_n82_, new_n83_,
  ...
  nand2  g018(.a(new_n51_), .b(new_n64_), .O(new_n65_));
  aoi21  g019(.a(new_n65_), .b(new_n63_), .c(new_n47_), .O(z03));
  ...
  aoi21  g029(.a(x27), .b(new_n75_), .c(new_n47_), .O(new_n76_));
  oai21  g030(.a(x27), .b(x25), .c(new_n76_), .O(z06));
  inv1   g031(.a(x15), .O(new_n78_));
  aoi21  g032(.a(x27), .b(new_n78_), .c(new_n47_), .O(new_n79_));
  ...
  nand3  g044(.a(new_n90_), .b(new_n85_), .c(new_n48_), .O(z09));
  ...
  nand3  g049(.a(new_n56_), .b(new_n82_), .c(x16), .O(new_n96_));
  inv1   g050(.a(new_n96_), .O(new_n97_));
  oai21  g051(.a(new_n97_), .b(new_n95_), .c(new_n50_), .O(new_n98_));
  ...
  nand2  g056(.a(x19), .b(new_n95_), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n59_), .c(new_n102_), .O(new_n104_));
  ...
  aoi21  g062(.a(new_n108_), .b(new_n106_), .c(new_n95_), .O(new_n109_));
  inv1   g063(.a(x21), .O(new_n110_));
  nor2   g064(.a(new_n110_), .b(new_n50_), .O(new_n111_));
  ...
  nand2  g070(.a(new_n82_), .b(x16), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n56_), .O(new_n119_));
  oai21  g073(.a(new_n119_), .b(new_n117_), .c(x18), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n50_), .O(new_n121_));
  nand3  g075(.a(new_n108_), .b(x22), .c(x16), .O(new_n122_));
  ...
  nand2  g083(.a(new_n129_), .b(new_n50_), .O(new_n130_));
  nand3  g084(.a(new_n118_), .b(new_n84_), .c(new_n56_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(x23), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n130_), .c(new_n126_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  oai21  g088(.a(x18), .b(new_n70_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n86_), .O(new_n136_));
  inv1   g090(.a(x23), .O(new_n137_));
  nand3  g091(.a(new_n118_), .b(new_n72_), .c(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n96_), .c(x18), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n50_), .O(new_n140_));
  nand4  g094(.a(new_n127_), .b(new_n56_), .c(new_n50_), .d(new_n82_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(x24), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n140_), .c(new_n136_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(new_n103_), .b(new_n75_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n86_), .O(new_n146_));
  nand3  g100(.a(new_n110_), .b(new_n56_), .c(new_n82_), .O(new_n147_));
  nand3  g101(.a(new_n72_), .b(new_n137_), .c(new_n64_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n147_), .c(x25), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n107_), .d(new_n84_), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n149_), .c(new_n95_), .O(new_n153_));
  and2   g107(.a(x25), .b(x19), .O(new_n154_));
  ...
  oai21  g111(.a(x18), .b(new_n78_), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n86_), .O(new_n159_));
  nand3  g113(.a(new_n107_), .b(new_n82_), .c(x16), .O(new_n160_));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n150_), .c(new_n72_), .O(new_n162_));
  oai21  g116(.a(new_n162_), .b(new_n160_), .c(x18), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n50_), .O(new_n164_));
  nand3  g118(.a(new_n152_), .b(x26), .c(x16), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n164_), .c(new_n159_), .O(z16));
  nand3  g120(.a(new_n107_), .b(x19), .c(new_n82_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n162_), .c(new_n51_), .d(new_n82_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n48_), .O(z17));
endmodule
