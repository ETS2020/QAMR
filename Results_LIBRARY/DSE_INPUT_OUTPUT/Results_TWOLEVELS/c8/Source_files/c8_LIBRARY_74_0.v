...
module FAU ( 
  ...
  nand3  g037(.a(new_n83_), .b(x08), .c(x04), .O(new_n84_));
  ...
  nand3  g088(.a(new_n53_), .b(new_n134_), .c(new_n133_), .O(new_n135_));
  nand3  g089(.a(new_n65_), .b(new_n113_), .c(new_n104_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n115_), .c(new_n138_), .d(new_n133_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n79_), .c(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n132_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  nand3  g098(.a(new_n83_), .b(x14), .c(x04), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n124_), .c(new_n105_), .d(new_n88_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n79_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  oai21  g108(.a(x18), .b(new_n76_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n81_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n124_), .c(new_n105_), .d(new_n88_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n79_), .O(z16));
  inv1   g116(.a(x24), .O(new_n163_));
  nor2   g117(.a(x26), .b(x25), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n124_), .c(new_n163_), .O(new_n165_));
  nand3  g119(.a(new_n105_), .b(x19), .c(new_n133_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n54_), .d(new_n133_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n79_), .c(x16), .O(new_n168_));
