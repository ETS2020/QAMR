...
module FAU ( 
  ...
  nand2  g049(.a(new_n88_), .b(x01), .O(new_n96_));
  ...
  oai21  g054(.a(new_n94_), .b(new_n57_), .c(new_n100_), .O(new_n101_));
  ...
  aoi21  g060(.a(new_n99_), .b(new_n86_), .c(new_n106_), .O(new_n107_));
  nor2   g061(.a(x22), .b(x21), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n86_), .c(new_n92_), .O(new_n109_));
  inv1   g063(.a(new_n109_), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n107_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n88_), .b(x03), .O(new_n112_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n94_), .c(new_n57_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n92_), .b(new_n84_), .c(new_n83_), .O(new_n126_));
  nand3  g080(.a(new_n66_), .b(new_n106_), .c(new_n57_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n126_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n108_), .c(new_n129_), .d(new_n83_), .O(new_n131_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n118_), .c(new_n99_), .d(new_n86_), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n118_), .c(new_n99_), .d(new_n86_), .O(new_n147_));
  ...
  nand2  g105(.a(new_n66_), .b(new_n106_), .O(new_n152_));
  ...
  nor2   g112(.a(new_n58_), .b(new_n83_), .O(new_n159_));
