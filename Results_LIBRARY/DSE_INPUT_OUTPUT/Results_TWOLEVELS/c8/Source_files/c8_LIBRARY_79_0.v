...
module FAU ( 
  ...
  oai21  g28(.a(x18), .b(x16), .c(new_n66_), .O(z08));
  ...
  nand2  g45(.a(new_n91_), .b(new_n76_), .O(new_n92_));
  inv1   g46(.a(x21), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n86_), .c(new_n77_), .d(new_n76_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(new_n95_));
  aoi21  g49(.a(new_n92_), .b(x21), .c(new_n95_), .O(new_n96_));
  nor2   g50(.a(new_n82_), .b(x16), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x02), .O(new_n98_));
  oai21  g52(.a(new_n96_), .b(new_n81_), .c(new_n98_), .O(z11));
  oai21  g53(.a(new_n82_), .b(x03), .c(new_n81_), .O(new_n100_));
  nand2  g54(.a(new_n94_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n79_), .c(new_n86_), .O(new_n103_));
  and2   g57(.a(new_n103_), .b(new_n101_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n81_), .c(new_n100_), .O(z12));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n88_), .c(new_n103_), .d(x23), .O(new_n107_));
  nand2  g61(.a(new_n97_), .b(x04), .O(new_n108_));
  oai21  g62(.a(new_n107_), .b(new_n81_), .c(new_n108_), .O(z13));
  aoi21  g63(.a(new_n106_), .b(new_n88_), .c(new_n65_), .O(new_n110_));
  nor2   g64(.a(x24), .b(x23), .O(new_n111_));
  nand4  g65(.a(new_n111_), .b(new_n102_), .c(new_n91_), .d(new_n76_), .O(new_n112_));
  inv1   g66(.a(new_n112_), .O(new_n113_));
  oai21  g67(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g68(.a(new_n97_), .b(x05), .O(new_n115_));
  nand2  g69(.a(new_n115_), .b(new_n114_), .O(z14));
  oai21  g70(.a(new_n82_), .b(x06), .c(new_n81_), .O(new_n117_));
  inv1   g71(.a(x22), .O(new_n118_));
  inv1   g72(.a(x23), .O(new_n119_));
  inv1   g73(.a(x25), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n65_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n95_), .c(new_n112_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n81_), .c(new_n117_), .O(z15));
  ...
  nand2  g87(.a(new_n97_), .b(x07), .O(new_n134_));
