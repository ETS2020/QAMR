...
module FAU ( 
  ...
  nand3  g061(.a(new_n107_), .b(new_n85_), .c(new_n57_), .O(new_n108_));
  inv1   g062(.a(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n87_), .b(x03), .O(new_n111_));
  ...
  nand3  g078(.a(new_n57_), .b(new_n51_), .c(new_n83_), .O(new_n125_));
  inv1   g079(.a(x23), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n105_), .c(new_n97_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n125_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n107_), .c(new_n129_), .d(new_n83_), .O(new_n131_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n117_), .c(new_n98_), .d(new_n85_), .O(new_n138_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n117_), .c(new_n98_), .d(new_n85_), .O(new_n146_));
  ...
  nand3  g106(.a(new_n152_), .b(new_n117_), .c(new_n151_), .O(new_n153_));
  nand3  g107(.a(new_n98_), .b(x19), .c(new_n83_), .O(new_n154_));
