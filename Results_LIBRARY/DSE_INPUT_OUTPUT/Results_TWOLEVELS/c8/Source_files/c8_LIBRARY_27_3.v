...
module FAU ( 
  ...
  nand2  g055(.a(new_n101_), .b(new_n91_), .O(new_n102_));
  oai21  g056(.a(new_n100_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  nor2   g058(.a(x18), .b(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(x10), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n104_), .c(new_n98_), .O(z11));
  ...
  nand3  g066(.a(new_n112_), .b(new_n91_), .c(new_n54_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n90_), .c(x16), .O(new_n115_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n101_), .d(new_n91_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n90_), .c(x16), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n139_), .c(new_n101_), .d(new_n91_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n105_), .b(x15), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n139_), .c(new_n127_), .O(new_n154_));
  nand3  g108(.a(new_n101_), .b(x19), .c(new_n92_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n55_), .d(new_n92_), .O(new_n156_));
