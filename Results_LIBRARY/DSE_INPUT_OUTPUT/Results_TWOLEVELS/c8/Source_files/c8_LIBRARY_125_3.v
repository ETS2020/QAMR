...
module FAU ( 
  ...
  nand3  g052(.a(new_n54_), .b(new_n87_), .c(new_n86_), .O(new_n99_));
  oai21  g053(.a(new_n89_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n98_), .c(x16), .O(new_n101_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n98_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n105_), .O(z11));
  oai21  g065(.a(x16), .b(x03), .c(x18), .O(new_n112_));
  aoi21  g066(.a(new_n107_), .b(new_n89_), .c(new_n65_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n89_), .c(new_n54_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n91_), .b(x11), .O(new_n118_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n106_), .c(new_n60_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x16), .O(new_n125_));
  nand2  g079(.a(new_n91_), .b(x12), .O(new_n126_));
  ...
  nand4  g088(.a(new_n134_), .b(new_n114_), .c(new_n133_), .d(new_n86_), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n122_), .c(new_n107_), .d(new_n89_), .O(new_n142_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n122_), .c(new_n107_), .d(new_n89_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n91_), .b(x15), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n147_), .O(z16));
  inv1   g108(.a(x24), .O(new_n155_));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n122_), .c(new_n155_), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x19), .c(new_n86_), .O(new_n158_));
