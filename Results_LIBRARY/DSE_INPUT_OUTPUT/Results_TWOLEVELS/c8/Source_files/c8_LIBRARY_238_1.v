...
module FAU ( 
  ...
  oai22  g056(.a(new_n102_), .b(new_n101_), .c(x18), .d(new_n57_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nand3  g058(.a(new_n55_), .b(new_n47_), .c(new_n92_), .O(new_n105_));
  oai21  g059(.a(new_n94_), .b(new_n55_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g074(.a(new_n113_), .b(new_n94_), .c(new_n66_), .O(new_n121_));
  ...
  oai21  g080(.a(x18), .b(new_n71_), .c(new_n102_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n96_), .O(new_n128_));
  oai21  g082(.a(x18), .b(new_n96_), .c(new_n102_), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n123_), .c(x23), .O(new_n130_));
  nand4  g084(.a(new_n53_), .b(new_n73_), .c(new_n66_), .d(new_n63_), .O(new_n131_));
  nor2   g085(.a(new_n131_), .b(x20), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n47_), .c(new_n92_), .d(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n130_), .c(new_n128_), .O(z13));
  ...
  aoi21  g092(.a(new_n138_), .b(new_n112_), .c(new_n76_), .O(new_n139_));
  nand3  g093(.a(new_n122_), .b(new_n76_), .c(new_n73_), .O(new_n140_));
  nor2   g094(.a(new_n140_), .b(new_n105_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n139_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n53_), .O(z14));
  nand3  g097(.a(x18), .b(x06), .c(x04), .O(new_n144_));
  oai21  g098(.a(x18), .b(new_n83_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  oai21  g100(.a(new_n140_), .b(new_n105_), .c(x25), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n113_), .d(new_n94_), .O(new_n150_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n113_), .d(new_n94_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n88_), .c(new_n81_), .d(new_n76_), .O(new_n163_));
  nand3  g117(.a(new_n113_), .b(x19), .c(new_n92_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n48_), .d(new_n92_), .O(new_n165_));
