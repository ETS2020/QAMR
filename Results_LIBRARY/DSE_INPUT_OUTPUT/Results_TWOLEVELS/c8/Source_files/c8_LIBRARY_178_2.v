...
module FAU ( 
  ...
  nand3  g044(.a(new_n90_), .b(new_n86_), .c(new_n83_), .O(z09));
  nand2  g045(.a(x18), .b(x01), .O(new_n92_));
  inv1   g046(.a(x18), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(x09), .c(new_n48_), .O(new_n94_));
  ...
  oai21  g053(.a(new_n85_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  ...
  nand3  g057(.a(new_n93_), .b(x10), .c(new_n48_), .O(new_n104_));
  ...
  nand3  g067(.a(new_n93_), .b(x11), .c(new_n48_), .O(new_n114_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n85_), .c(new_n54_), .O(new_n119_));
  ...
  aoi21  g087(.a(new_n125_), .b(new_n107_), .c(new_n73_), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n118_), .c(new_n98_), .d(new_n97_), .O(new_n136_));
  inv1   g090(.a(new_n136_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n134_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n133_), .c(new_n83_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n85_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n83_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  nand3  g104(.a(new_n93_), .b(x15), .c(new_n48_), .O(new_n151_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n144_), .c(new_n108_), .d(new_n85_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n83_), .c(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n153_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n144_), .c(new_n73_), .O(new_n161_));
