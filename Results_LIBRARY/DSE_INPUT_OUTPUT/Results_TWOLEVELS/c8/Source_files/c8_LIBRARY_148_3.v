...
module FAU ( 
  ...
  nand3  g061(.a(new_n107_), .b(new_n93_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n103_), .O(z11));
  oai21  g063(.a(x16), .b(x03), .c(x18), .O(new_n110_));
  aoi21  g064(.a(new_n105_), .b(new_n95_), .c(new_n63_), .O(new_n111_));
  ...
  nor2   g069(.a(x18), .b(x16), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(x11), .O(new_n117_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n93_), .c(x16), .O(new_n126_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n112_), .c(new_n96_), .d(new_n83_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n116_), .b(x13), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n105_), .d(new_n95_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n116_), .b(x14), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n139_), .c(new_n105_), .d(new_n95_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n93_), .c(x16), .O(new_n153_));
  ...
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n58_), .d(new_n83_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n93_), .c(x16), .O(new_n159_));
