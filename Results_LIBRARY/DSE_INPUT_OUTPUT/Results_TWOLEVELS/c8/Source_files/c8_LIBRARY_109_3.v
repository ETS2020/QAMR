...
module FAU ( 
  ...
  oai21  g056(.a(new_n90_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n108_), .d(new_n90_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n92_), .b(x14), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n140_), .c(new_n108_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n92_), .b(x15), .O(new_n153_));
  ...
  nand3  g110(.a(new_n83_), .b(new_n78_), .c(new_n73_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g112(.a(new_n108_), .b(x19), .c(new_n88_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n52_), .b(new_n88_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n99_), .c(new_n95_), .O(z17));
endmodule
