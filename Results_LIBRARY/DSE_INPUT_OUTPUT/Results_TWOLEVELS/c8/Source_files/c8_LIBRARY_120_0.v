...
module FAU ( 
  ...
  nor2   g013(.a(x27), .b(new_n59_), .O(new_n60_));
  ...
  nand2  g039(.a(new_n85_), .b(new_n51_), .O(z08));
  ...
  nor2   g052(.a(new_n89_), .b(new_n56_), .O(new_n99_));
  ...
  oai21  g056(.a(new_n59_), .b(x02), .c(new_n91_), .O(new_n103_));
  ...
  nand3  g064(.a(new_n59_), .b(x11), .c(x10), .O(new_n111_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n89_), .c(new_n56_), .O(new_n116_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n100_), .c(new_n104_), .O(new_n125_));
  ...
  nand3  g083(.a(new_n59_), .b(x13), .c(x10), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n91_), .O(new_n132_));
  nand3  g086(.a(new_n56_), .b(new_n50_), .c(new_n87_), .O(new_n133_));
  nand3  g087(.a(new_n69_), .b(new_n64_), .c(new_n104_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n133_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n115_), .c(new_n136_), .d(new_n87_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n85_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n124_), .c(new_n105_), .d(new_n89_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n144_), .c(new_n85_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n59_), .b(x15), .c(x10), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n124_), .c(new_n105_), .d(new_n89_), .O(new_n157_));
  ...
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n87_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n51_), .d(new_n87_), .O(new_n164_));
