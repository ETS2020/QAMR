...
module FAU ( 
  ...
  nand4  g51(.a(new_n57_), .b(new_n90_), .c(new_n82_), .d(new_n81_), .O(new_n98_));
  ...
  nand3  g57(.a(new_n103_), .b(new_n84_), .c(new_n90_), .O(new_n104_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n103_), .c(new_n96_), .d(new_n81_), .O(new_n116_));
  ...
  oai21  g73(.a(x18), .b(x14), .c(new_n86_), .O(new_n120_));
  ...
  oai21  g78(.a(new_n124_), .b(new_n86_), .c(new_n120_), .O(z15));
  ...
  nand3  g92(.a(new_n138_), .b(new_n128_), .c(new_n113_), .O(new_n139_));
