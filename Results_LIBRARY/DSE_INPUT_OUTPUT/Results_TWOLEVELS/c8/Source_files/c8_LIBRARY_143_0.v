...
module FAU ( 
  ...
  nand2  g48(.a(x18), .b(new_n86_), .O(new_n95_));
  oai21  g49(.a(new_n95_), .b(new_n90_), .c(new_n94_), .O(z10));
  inv1   g50(.a(x02), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n82_), .O(new_n99_));
  nand4  g53(.a(new_n59_), .b(new_n91_), .c(new_n50_), .d(new_n82_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n86_), .c(new_n95_), .d(new_n97_), .O(z11));
  inv1   g57(.a(x03), .O(new_n104_));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n84_), .c(new_n100_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n86_), .c(new_n95_), .d(new_n104_), .O(z12));
  inv1   g61(.a(x04), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n84_), .c(new_n91_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n93_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai22  g66(.a(new_n112_), .b(new_n86_), .c(new_n95_), .d(new_n108_), .O(z13));
  ...
  nand4  g71(.a(new_n117_), .b(new_n109_), .c(new_n98_), .d(new_n82_), .O(new_n118_));
  ...
  nand4  g78(.a(new_n73_), .b(new_n115_), .c(new_n124_), .d(new_n123_), .O(new_n125_));
