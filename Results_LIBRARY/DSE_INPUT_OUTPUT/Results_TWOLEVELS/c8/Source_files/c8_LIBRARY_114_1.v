...
module FAU ( 
  ...
  nor2   g46(.a(new_n86_), .b(new_n54_), .O(new_n93_));
  ...
  oai22  g59(.a(new_n105_), .b(new_n91_), .c(new_n89_), .d(new_n61_), .O(z12));
  oai21  g60(.a(x18), .b(x12), .c(new_n91_), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n86_), .c(new_n54_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n94_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n91_), .c(new_n107_), .O(z13));
  aoi21  g66(.a(new_n110_), .b(new_n94_), .c(new_n71_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n108_), .c(new_n97_), .d(new_n83_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g71(.a(new_n88_), .b(x13), .O(new_n118_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n71_), .c(new_n121_), .d(new_n63_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n101_), .c(new_n115_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n91_), .c(new_n120_), .O(z15));
  ...
  nand2  g89(.a(new_n88_), .b(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  inv1   g91(.a(new_n49_), .O(new_n138_));
  nand4  g92(.a(new_n128_), .b(new_n79_), .c(new_n122_), .d(new_n71_), .O(new_n139_));
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n83_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n55_), .d(new_n83_), .O(new_n141_));
