...
module FAU ( 
  ...
  oai21  g019(.a(new_n48_), .b(x18), .c(new_n52_), .O(new_n66_));
  oai21  g020(.a(new_n48_), .b(x11), .c(new_n66_), .O(z03));
  ...
  nand2  g052(.a(x22), .b(x18), .O(new_n99_));
  ...
  nand4  g057(.a(new_n53_), .b(new_n58_), .c(new_n47_), .d(new_n89_), .O(new_n104_));
  ...
  aoi21  g064(.a(new_n52_), .b(x18), .c(x21), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n58_), .c(new_n47_), .d(new_n89_), .O(new_n112_));
  nand3  g066(.a(new_n58_), .b(new_n47_), .c(new_n89_), .O(new_n113_));
  inv1   g067(.a(new_n113_), .O(new_n114_));
  oai21  g068(.a(new_n114_), .b(new_n61_), .c(new_n112_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n53_), .O(z11));
  inv1   g071(.a(x03), .O(new_n118_));
  inv1   g072(.a(x11), .O(new_n119_));
  oai22  g073(.a(new_n99_), .b(new_n118_), .c(x18), .d(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n93_), .O(new_n121_));
  inv1   g075(.a(x18), .O(new_n122_));
  nand3  g076(.a(new_n52_), .b(new_n61_), .c(new_n122_), .O(new_n123_));
  oai21  g077(.a(new_n52_), .b(new_n61_), .c(new_n123_), .O(new_n124_));
  nand4  g078(.a(new_n124_), .b(new_n58_), .c(new_n47_), .d(new_n89_), .O(new_n125_));
  nand2  g079(.a(new_n113_), .b(x22), .O(new_n126_));
  ...
  nand2  g086(.a(new_n91_), .b(x16), .O(new_n133_));
  nor2   g087(.a(x23), .b(x21), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n58_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n133_), .c(new_n122_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n52_), .O(new_n137_));
  nand4  g091(.a(new_n91_), .b(new_n52_), .c(new_n61_), .d(new_n58_), .O(new_n138_));
  ...
  nand3  g098(.a(new_n144_), .b(new_n73_), .c(new_n68_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n133_), .c(new_n122_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n52_), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n114_), .c(new_n61_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(x24), .c(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n147_), .c(new_n143_), .O(z14));
  inv1   g105(.a(x06), .O(new_n152_));
  oai22  g106(.a(new_n99_), .b(new_n152_), .c(x18), .d(new_n78_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n93_), .O(new_n154_));
  nand3  g108(.a(new_n73_), .b(new_n68_), .c(new_n61_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n113_), .c(x25), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n148_), .c(new_n144_), .d(new_n91_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n156_), .c(x18), .O(new_n159_));
  nor2   g113(.a(new_n80_), .b(new_n52_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n159_), .c(x16), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n154_), .O(z15));
  inv1   g116(.a(x07), .O(new_n163_));
  oai22  g117(.a(new_n99_), .b(new_n163_), .c(x18), .d(new_n85_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n93_), .O(new_n165_));
  nor2   g119(.a(x20), .b(x19), .O(new_n166_));
  nand4  g120(.a(new_n157_), .b(new_n134_), .c(new_n166_), .d(new_n89_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x26), .O(new_n168_));
  nor3   g122(.a(x26), .b(x25), .c(x24), .O(new_n169_));
  nand4  g123(.a(new_n169_), .b(new_n148_), .c(new_n144_), .d(new_n91_), .O(new_n170_));
  aoi21  g124(.a(new_n170_), .b(new_n168_), .c(x18), .O(new_n171_));
  nor2   g125(.a(new_n83_), .b(new_n52_), .O(new_n172_));
  oai21  g126(.a(new_n172_), .b(new_n171_), .c(x16), .O(new_n173_));
  nand2  g127(.a(new_n173_), .b(new_n165_), .O(z16));
  nand2  g128(.a(new_n169_), .b(new_n148_), .O(new_n175_));
  nand3  g129(.a(new_n144_), .b(x19), .c(new_n89_), .O(new_n176_));
  oai22  g130(.a(new_n176_), .b(new_n175_), .c(new_n48_), .d(new_n89_), .O(new_n177_));
  nand2  g131(.a(new_n177_), .b(x16), .O(new_n178_));
  nand2  g132(.a(new_n178_), .b(new_n53_), .O(z17));
endmodule
