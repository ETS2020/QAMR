...
module FAU ( 
  ...
  oai21  g50(.a(x18), .b(x10), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(x20), .b(x19), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n84_), .O(new_n99_));
  inv1   g53(.a(x21), .O(new_n100_));
  nand4  g54(.a(new_n100_), .b(new_n54_), .c(new_n85_), .d(new_n84_), .O(new_n101_));
  ...
  oai22  g60(.a(new_n106_), .b(new_n96_), .c(new_n90_), .d(new_n61_), .O(z12));
  oai21  g61(.a(x18), .b(x12), .c(new_n96_), .O(new_n108_));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n87_), .c(new_n54_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n93_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n96_), .c(new_n108_), .O(z13));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n111_), .b(new_n93_), .c(new_n114_), .O(new_n115_));
  ...
  oai21  g75(.a(x18), .b(x14), .c(new_n96_), .O(new_n122_));
  nand4  g76(.a(new_n76_), .b(new_n114_), .c(new_n68_), .d(new_n63_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n102_), .c(new_n117_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n96_), .c(new_n122_), .O(z15));
  ...
  nand3  g92(.a(new_n138_), .b(new_n128_), .c(new_n114_), .O(new_n139_));
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n84_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n55_), .d(new_n84_), .O(new_n141_));
