...
module FAU ( 
  ...
  oai21  g36(.a(x18), .b(x16), .c(new_n54_), .O(z08));
  ...
  nand2  g49(.a(new_n90_), .b(x01), .O(new_n96_));
  ...
  oai21  g65(.a(new_n89_), .b(x04), .c(new_n98_), .O(new_n112_));
  ...
  oai21  g69(.a(new_n89_), .b(x05), .c(new_n98_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  aoi21  g71(.a(new_n113_), .b(new_n94_), .c(new_n117_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n107_), .c(new_n99_), .d(new_n84_), .O(new_n120_));
  ...
  nand4  g77(.a(new_n77_), .b(new_n117_), .c(new_n69_), .d(new_n64_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n102_), .c(new_n120_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n90_), .b(x06), .O(new_n127_));
  oai21  g81(.a(new_n126_), .b(new_n98_), .c(new_n127_), .O(z15));
  oai21  g82(.a(new_n89_), .b(x07), .c(new_n98_), .O(new_n129_));
  ...
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n98_), .O(z17));
endmodule
