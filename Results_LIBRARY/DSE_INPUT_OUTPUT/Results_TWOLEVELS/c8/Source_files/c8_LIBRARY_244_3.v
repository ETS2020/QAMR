...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x08), .O(new_n48_));
  ...
  nand3  g046(.a(new_n92_), .b(new_n48_), .c(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n88_), .O(z09));
  inv1   g048(.a(x01), .O(new_n95_));
  nand2  g049(.a(x18), .b(new_n47_), .O(new_n96_));
  oai22  g050(.a(new_n96_), .b(new_n95_), .c(x18), .d(new_n52_), .O(new_n97_));
  ...
  oai21  g060(.a(x18), .b(new_n55_), .c(new_n106_), .O(new_n107_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n57_), .c(new_n111_), .O(new_n112_));
  ...
  aoi21  g072(.a(new_n110_), .b(new_n90_), .c(new_n118_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n90_), .c(new_n99_), .O(new_n121_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n109_), .c(new_n57_), .O(new_n130_));
  ...
  oai22  g088(.a(new_n96_), .b(new_n134_), .c(x18), .d(new_n69_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n85_), .O(new_n136_));
  nand3  g090(.a(new_n66_), .b(new_n118_), .c(new_n57_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n102_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n139_), .d(new_n100_), .O(new_n141_));
  ...
  nand2  g100(.a(new_n146_), .b(new_n85_), .O(new_n147_));
  nand2  g101(.a(new_n141_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n129_), .c(new_n110_), .d(new_n90_), .O(new_n150_));
  ...
  oai22  g108(.a(new_n96_), .b(new_n154_), .c(x18), .d(new_n79_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n85_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n129_), .c(new_n110_), .d(new_n90_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n129_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n163_));
  nand3  g117(.a(new_n110_), .b(x19), .c(new_n100_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n58_), .d(new_n100_), .O(new_n165_));
