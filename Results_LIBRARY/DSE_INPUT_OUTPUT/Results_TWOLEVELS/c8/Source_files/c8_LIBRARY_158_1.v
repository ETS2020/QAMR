...
module FAU ( 
  ...
  aoi21  g069(.a(new_n108_), .b(new_n91_), .c(new_n68_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(new_n58_), .O(new_n118_));
  ...
  nand2  g076(.a(x18), .b(x15), .O(new_n123_));
  oai22  g077(.a(new_n123_), .b(new_n122_), .c(x18), .d(new_n71_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n93_), .O(new_n125_));
  nand2  g079(.a(new_n118_), .b(x23), .O(new_n126_));
  nor2   g080(.a(x23), .b(x22), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n102_), .c(new_n61_), .O(new_n128_));
  ...
  oai22  g086(.a(new_n123_), .b(new_n132_), .c(x18), .d(new_n78_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  nand3  g088(.a(new_n58_), .b(new_n52_), .c(new_n89_), .O(new_n135_));
  ...
  oai22  g098(.a(new_n123_), .b(new_n144_), .c(x18), .d(new_n83_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n93_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n127_), .c(new_n108_), .d(new_n91_), .O(new_n149_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n93_), .c(x15), .O(new_n155_));
  nand2  g109(.a(new_n149_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n127_), .c(new_n108_), .d(new_n91_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n127_), .c(new_n76_), .O(new_n163_));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n89_), .O(new_n164_));
