...
module FAU ( 
  ...
  nor2   g062(.a(new_n85_), .b(x16), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x02), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n108_), .c(new_n102_), .O(z11));
  oai21  g065(.a(x16), .b(x11), .c(new_n85_), .O(new_n112_));
  inv1   g066(.a(x22), .O(new_n113_));
  aoi21  g067(.a(new_n105_), .b(new_n97_), .c(new_n113_), .O(new_n114_));
  ...
  nand2  g072(.a(new_n109_), .b(x03), .O(new_n119_));
  ...
  nand3  g086(.a(new_n66_), .b(new_n113_), .c(new_n103_), .O(new_n133_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n125_), .c(new_n105_), .d(new_n97_), .O(new_n146_));
