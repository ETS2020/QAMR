...
module FAU ( 
  ...
  oai21  g021(.a(x27), .b(new_n67_), .c(new_n47_), .O(new_n68_));
  nand3  g022(.a(new_n52_), .b(new_n67_), .c(x18), .O(new_n69_));
  ...
  nand2  g059(.a(new_n81_), .b(x11), .O(new_n106_));
  ...
  nand3  g078(.a(new_n90_), .b(new_n51_), .c(new_n124_), .O(new_n125_));
  ...
  nand4  g085(.a(new_n131_), .b(new_n110_), .c(new_n130_), .d(new_n124_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n79_), .c(x16), .O(new_n134_));
  nand3  g088(.a(x18), .b(new_n86_), .c(x05), .O(new_n135_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n119_), .c(new_n100_), .d(new_n91_), .O(new_n142_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n119_), .c(new_n100_), .d(new_n91_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n155_), .b(new_n119_), .c(new_n67_), .O(new_n156_));
  nand3  g110(.a(new_n100_), .b(x19), .c(new_n124_), .O(new_n157_));
