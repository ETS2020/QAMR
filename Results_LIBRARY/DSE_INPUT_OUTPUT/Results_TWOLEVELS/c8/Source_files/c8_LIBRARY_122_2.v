...
module FAU ( 
  ...
  nand3  g024(.a(new_n47_), .b(new_n70_), .c(new_n48_), .O(new_n71_));
  oai21  g025(.a(new_n47_), .b(x15), .c(new_n71_), .O(z07));
  nand2  g026(.a(new_n47_), .b(new_n48_), .O(z08));
  nand2  g027(.a(x27), .b(x18), .O(new_n74_));
  inv1   g028(.a(new_n74_), .O(new_n75_));
  aoi22  g029(.a(new_n75_), .b(x00), .c(new_n48_), .d(x08), .O(new_n76_));
  nand2  g030(.a(new_n47_), .b(x18), .O(new_n77_));
  nand2  g031(.a(x19), .b(x17), .O(new_n78_));
  ...
  oai21  g036(.a(new_n76_), .b(x16), .c(new_n82_), .O(z09));
  ...
  nor2   g042(.a(new_n79_), .b(new_n52_), .O(new_n89_));
  nor3   g043(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  oai21  g044(.a(new_n90_), .b(new_n89_), .c(x16), .O(new_n91_));
  nand3  g045(.a(new_n91_), .b(new_n88_), .c(new_n77_), .O(z10));
  ...
  oai21  g052(.a(new_n90_), .b(new_n55_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g059(.a(new_n97_), .b(new_n79_), .c(new_n58_), .O(new_n106_));
  nor2   g060(.a(x22), .b(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n79_), .c(new_n52_), .O(new_n108_));
  inv1   g062(.a(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n105_), .c(new_n77_), .O(z12));
  inv1   g065(.a(x04), .O(new_n112_));
  inv1   g066(.a(x12), .O(new_n113_));
  oai22  g067(.a(new_n74_), .b(new_n112_), .c(x18), .d(new_n113_), .O(new_n114_));
  ...
  aoi21  g079(.a(new_n117_), .b(new_n90_), .c(new_n64_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n107_), .c(new_n128_), .d(new_n127_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n126_), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n125_), .c(new_n77_), .O(z14));
  inv1   g087(.a(x06), .O(new_n134_));
  inv1   g088(.a(x14), .O(new_n135_));
  oai22  g089(.a(new_n74_), .b(new_n134_), .c(x18), .d(new_n135_), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n97_), .d(new_n79_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n77_), .c(x16), .O(new_n143_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n139_), .c(new_n97_), .d(new_n79_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n139_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n155_));
  nand3  g109(.a(new_n97_), .b(x19), .c(new_n127_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n47_), .d(new_n127_), .O(new_n157_));
