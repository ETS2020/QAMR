...
module FAU ( 
  ...
  oai21  g060(.a(new_n95_), .b(new_n57_), .c(new_n106_), .O(new_n107_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(new_n93_), .O(z11));
  ...
  aoi21  g075(.a(new_n114_), .b(new_n95_), .c(new_n67_), .O(new_n122_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n93_), .O(z12));
  ...
  aoi21  g093(.a(new_n130_), .b(new_n113_), .c(new_n139_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n123_), .c(new_n105_), .d(new_n104_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n93_), .O(z14));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n114_), .d(new_n95_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n148_), .c(new_n93_), .O(z15));
  nand2  g109(.a(x18), .b(x07), .O(new_n156_));
  nand3  g110(.a(new_n89_), .b(x15), .c(new_n52_), .O(new_n157_));
  ...
  nand4  g115(.a(new_n161_), .b(new_n150_), .c(new_n114_), .d(new_n95_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n93_), .c(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n159_), .O(z16));
  nor2   g119(.a(x26), .b(x25), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n150_), .c(new_n139_), .O(new_n167_));
  nand3  g121(.a(new_n114_), .b(x19), .c(new_n104_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n50_), .d(new_n104_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n93_), .O(z17));
endmodule
