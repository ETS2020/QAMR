...
module FAU ( 
  ...
  aoi21  g062(.a(new_n102_), .b(new_n92_), .c(new_n108_), .O(new_n109_));
  ...
  nor2   g067(.a(new_n79_), .b(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x03), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n113_), .c(new_n107_), .O(z12));
  oai21  g070(.a(x16), .b(x12), .c(new_n79_), .O(new_n117_));
  ...
  nand2  g076(.a(new_n114_), .b(x04), .O(new_n123_));
  ...
  nand2  g085(.a(new_n114_), .b(x05), .O(new_n132_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n102_), .d(new_n92_), .O(new_n140_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n102_), .d(new_n92_), .O(new_n149_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n138_), .c(new_n126_), .O(new_n154_));
  nand3  g108(.a(new_n102_), .b(x19), .c(new_n81_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n58_), .d(new_n81_), .O(new_n156_));
