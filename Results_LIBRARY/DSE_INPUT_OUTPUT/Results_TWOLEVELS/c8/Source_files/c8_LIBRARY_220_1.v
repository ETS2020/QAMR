...
module FAU ( 
  ...
  nand2  g043(.a(x18), .b(x07), .O(new_n90_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n86_), .O(z11));
  ...
  nand3  g074(.a(new_n120_), .b(new_n86_), .c(x16), .O(new_n121_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n125_), .c(new_n86_), .O(z13));
  ...
  oai21  g106(.a(x18), .b(x15), .c(new_n88_), .O(new_n153_));
  nand2  g107(.a(new_n149_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n127_), .c(new_n109_), .d(new_n99_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n160_), .b(new_n127_), .c(new_n75_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n100_), .O(new_n162_));
