...
module FAU ( 
  ...
  oai21  g047(.a(x16), .b(x09), .c(new_n87_), .O(new_n94_));
  ...
  nand3  g084(.a(new_n95_), .b(new_n51_), .c(new_n130_), .O(new_n131_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n121_), .c(new_n104_), .d(new_n96_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n100_), .b(x06), .O(new_n147_));
