...
module FAU ( 
  ...
  nand2  g042(.a(x18), .b(new_n83_), .O(new_n89_));
  ...
  oai22  g052(.a(new_n89_), .b(new_n98_), .c(x18), .d(new_n52_), .O(new_n99_));
  ...
  oai21  g057(.a(new_n93_), .b(new_n54_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n48_), .c(x16), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n100_), .O(z10));
  inv1   g060(.a(x02), .O(new_n107_));
  oai22  g061(.a(new_n89_), .b(new_n107_), .c(x18), .d(new_n58_), .O(new_n108_));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n93_), .c(new_n65_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n93_), .c(new_n54_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n89_), .b(new_n125_), .c(x18), .d(new_n68_), .O(new_n126_));
  ...
  oai22  g097(.a(new_n89_), .b(new_n143_), .c(x18), .d(new_n78_), .O(new_n144_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n147_), .c(new_n75_), .O(new_n163_));
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n101_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n101_), .O(new_n165_));
