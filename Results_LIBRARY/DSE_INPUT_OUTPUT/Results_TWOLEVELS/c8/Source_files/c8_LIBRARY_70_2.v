...
module FAU ( 
  ...
  nand3  g061(.a(new_n107_), .b(new_n105_), .c(new_n99_), .O(z11));
  oai21  g062(.a(x16), .b(x11), .c(new_n81_), .O(new_n109_));
  inv1   g063(.a(x22), .O(new_n110_));
  aoi21  g064(.a(new_n102_), .b(new_n93_), .c(new_n110_), .O(new_n111_));
  ...
  aoi21  g081(.a(new_n120_), .b(new_n101_), .c(new_n127_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n112_), .c(new_n94_), .d(new_n83_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n106_), .b(x05), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n102_), .d(new_n93_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n106_), .b(x06), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n102_), .d(new_n93_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n106_), .b(x07), .O(new_n150_));
  ...
  nand3  g107(.a(new_n102_), .b(x19), .c(new_n83_), .O(new_n154_));
