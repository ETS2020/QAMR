...
module FAU ( 
  ...
  aoi21  g061(.a(new_n100_), .b(new_n80_), .c(new_n60_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n80_), .c(new_n91_), .O(new_n110_));
  ...
  oai22  g068(.a(new_n114_), .b(x00), .c(x18), .d(new_n64_), .O(new_n115_));
  ...
  aoi21  g080(.a(new_n118_), .b(new_n93_), .c(new_n126_), .O(new_n127_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n100_), .d(new_n80_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(new_n48_), .O(z15));
  nand2  g098(.a(x18), .b(x07), .O(new_n145_));
  oai22  g099(.a(new_n145_), .b(x00), .c(x18), .d(new_n75_), .O(new_n146_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n139_), .c(new_n100_), .d(new_n80_), .O(new_n150_));
  ...
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n61_), .d(new_n128_), .O(new_n157_));
