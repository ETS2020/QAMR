...
module FAU ( 
  ...
  nor2   g030(.a(x27), .b(x25), .O(new_n77_));
  aoi21  g031(.a(x27), .b(new_n76_), .c(new_n77_), .O(new_n78_));
  nand2  g032(.a(new_n77_), .b(x14), .O(new_n79_));
  oai21  g033(.a(new_n78_), .b(new_n75_), .c(new_n79_), .O(z06));
  ...
  nand2  g041(.a(new_n75_), .b(x14), .O(new_n88_));
  ...
  aoi21  g069(.a(new_n107_), .b(new_n92_), .c(new_n115_), .O(new_n116_));
  nor2   g070(.a(x22), .b(x21), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n92_), .c(new_n53_), .O(new_n118_));
  ...
  aoi21  g087(.a(new_n126_), .b(new_n101_), .c(new_n72_), .O(new_n134_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n107_), .d(new_n92_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n75_), .b(x15), .c(x14), .O(new_n153_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n146_), .c(new_n107_), .d(new_n92_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n146_), .c(new_n72_), .O(new_n163_));
  nand3  g117(.a(new_n107_), .b(x19), .c(new_n135_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n54_), .d(new_n135_), .O(new_n165_));
