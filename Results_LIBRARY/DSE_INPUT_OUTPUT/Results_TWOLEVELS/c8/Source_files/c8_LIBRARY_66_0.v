...
module FAU ( 
  ...
  oai21  g39(.a(new_n83_), .b(x01), .c(new_n82_), .O(new_n86_));
  inv1   g40(.a(x20), .O(new_n87_));
  nor2   g41(.a(new_n80_), .b(new_n87_), .O(new_n88_));
  ...
  nand4  g48(.a(new_n94_), .b(new_n87_), .c(new_n50_), .d(new_n78_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(new_n83_), .b(x16), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(x02), .O(new_n99_));
  oai21  g53(.a(new_n97_), .b(new_n82_), .c(new_n99_), .O(z11));
  nand2  g54(.a(new_n95_), .b(x22), .O(new_n101_));
  nor2   g55(.a(x22), .b(x21), .O(new_n102_));
  nand3  g56(.a(new_n102_), .b(new_n80_), .c(new_n87_), .O(new_n103_));
  ...
  nand2  g62(.a(new_n98_), .b(x04), .O(new_n109_));
  oai21  g63(.a(new_n108_), .b(new_n82_), .c(new_n109_), .O(z13));
  aoi21  g64(.a(new_n107_), .b(new_n89_), .c(new_n68_), .O(new_n111_));
  ...
  nand2  g77(.a(new_n98_), .b(x06), .O(new_n124_));
