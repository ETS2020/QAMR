...
module FAU ( 
  ...
  nor2   g038(.a(new_n52_), .b(new_n50_), .O(z08));
  ...
  nand3  g054(.a(new_n56_), .b(new_n49_), .c(new_n87_), .O(new_n101_));
  oai21  g055(.a(new_n89_), .b(new_n56_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n86_), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n100_), .O(z10));
  nand2  g058(.a(x18), .b(x02), .O(new_n105_));
  nand3  g059(.a(new_n97_), .b(x10), .c(x07), .O(new_n106_));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n89_), .c(new_n66_), .O(new_n118_));
  inv1   g072(.a(new_n89_), .O(new_n119_));
  nand3  g073(.a(new_n66_), .b(new_n61_), .c(new_n56_), .O(new_n120_));
  nor2   g074(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  ...
  nand2  g081(.a(new_n127_), .b(new_n109_), .O(new_n128_));
  oai21  g082(.a(new_n121_), .b(new_n71_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x16), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n126_), .c(new_n86_), .O(z13));
  nand2  g085(.a(x18), .b(x05), .O(new_n132_));
  oai21  g086(.a(x18), .b(new_n74_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  inv1   g088(.a(x24), .O(new_n135_));
  aoi21  g089(.a(new_n127_), .b(new_n109_), .c(new_n135_), .O(new_n136_));
  nand4  g090(.a(new_n135_), .b(new_n71_), .c(new_n66_), .d(new_n61_), .O(new_n137_));
  nor2   g091(.a(new_n137_), .b(new_n101_), .O(new_n138_));
  ...
  nand3  g095(.a(new_n97_), .b(x14), .c(x07), .O(new_n142_));
  ...
  oai21  g102(.a(new_n138_), .b(new_n145_), .c(new_n148_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n86_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n144_), .O(z15));
  inv1   g105(.a(x07), .O(new_n152_));
  aoi21  g106(.a(new_n97_), .b(new_n80_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n148_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n146_), .c(new_n110_), .d(new_n89_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  aoi21  g111(.a(new_n157_), .b(x16), .c(new_n153_), .O(new_n158_));
  nand3  g112(.a(new_n157_), .b(x18), .c(x16), .O(new_n159_));
  oai21  g113(.a(new_n158_), .b(new_n152_), .c(new_n159_), .O(z16));
  nand2  g114(.a(new_n155_), .b(new_n146_), .O(new_n161_));
  nand3  g115(.a(new_n110_), .b(x19), .c(new_n87_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n50_), .d(new_n87_), .O(new_n163_));
