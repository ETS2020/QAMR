...
module FAU ( 
  ...
  inv1   g051(.a(new_n86_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(x20), .c(new_n55_), .O(new_n99_));
  nand3  g053(.a(new_n56_), .b(new_n51_), .c(new_n84_), .O(new_n100_));
  ...
  nand2  g060(.a(new_n98_), .b(x21), .O(new_n107_));
  inv1   g061(.a(x21), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n51_), .c(new_n84_), .O(new_n109_));
  aoi21  g063(.a(new_n109_), .b(new_n107_), .c(x20), .O(new_n110_));
  nor3   g064(.a(new_n108_), .b(new_n56_), .c(x18), .O(new_n111_));
  ...
  oai21  g071(.a(new_n117_), .b(new_n88_), .c(new_n55_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x20), .O(new_n119_));
  nor3   g073(.a(x21), .b(x19), .c(x17), .O(new_n120_));
  nor2   g074(.a(x22), .b(x21), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n86_), .c(new_n56_), .O(new_n122_));
  ...
  oai21  g083(.a(new_n129_), .b(new_n88_), .c(new_n55_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x20), .O(new_n131_));
  aoi21  g085(.a(new_n121_), .b(new_n86_), .c(new_n129_), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n108_), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(new_n100_), .O(new_n135_));
  ...
  oai22  g092(.a(new_n95_), .b(new_n138_), .c(x18), .d(new_n68_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n88_), .O(new_n140_));
  nand3  g094(.a(new_n133_), .b(new_n86_), .c(new_n108_), .O(new_n141_));
  ...
  oai21  g114(.a(x18), .b(new_n78_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n88_), .O(new_n162_));
  oai21  g116(.a(new_n80_), .b(new_n88_), .c(new_n55_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x20), .O(new_n164_));
  nand2  g118(.a(new_n155_), .b(x26), .O(new_n165_));
  nor2   g119(.a(x21), .b(x20), .O(new_n166_));
  nor3   g120(.a(x26), .b(x25), .c(x24), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n166_), .c(new_n133_), .d(new_n86_), .O(new_n168_));
  ...
  nand4  g127(.a(new_n173_), .b(new_n167_), .c(new_n166_), .d(new_n133_), .O(new_n174_));
  aoi21  g128(.a(new_n174_), .b(new_n172_), .c(new_n88_), .O(z17));
endmodule
