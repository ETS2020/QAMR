...
module FAU ( 
  ...
  aoi21  g038(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(new_n85_));
  aoi21  g039(.a(new_n81_), .b(x08), .c(new_n85_), .O(new_n86_));
  nand3  g040(.a(x18), .b(new_n81_), .c(x00), .O(new_n87_));
  oai21  g041(.a(new_n86_), .b(x18), .c(new_n87_), .O(z09));
  ...
  nand2  g082(.a(new_n94_), .b(x13), .O(new_n129_));
  ...
  nand2  g088(.a(new_n126_), .b(x25), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n99_), .d(new_n90_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n134_), .c(x16), .O(new_n140_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n136_), .c(new_n99_), .d(new_n90_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n134_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z16));
  inv1   g104(.a(x23), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n106_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n99_), .b(x19), .c(new_n83_), .O(new_n157_));
  ...
  aoi21  g114(.a(new_n160_), .b(new_n134_), .c(new_n81_), .O(z17));
endmodule
