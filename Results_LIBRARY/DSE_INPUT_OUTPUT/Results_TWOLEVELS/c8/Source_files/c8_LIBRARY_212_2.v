...
module FAU ( 
  ...
  nand3  g028(.a(new_n55_), .b(new_n73_), .c(x18), .O(new_n75_));
  nand2  g029(.a(new_n75_), .b(new_n74_), .O(z05));
  ...
  nand2  g038(.a(new_n55_), .b(new_n84_), .O(new_n85_));
  aoi21  g039(.a(new_n85_), .b(new_n83_), .c(new_n49_), .O(z07));
  inv1   g040(.a(new_n49_), .O(new_n87_));
  nand2  g041(.a(new_n87_), .b(new_n55_), .O(z08));
  ...
  oai21  g058(.a(new_n90_), .b(new_n54_), .c(new_n104_), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n87_), .c(x16), .O(new_n106_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n87_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n128_), .O(z13));
  aoi21  g088(.a(new_n130_), .b(new_n111_), .c(new_n73_), .O(new_n135_));
  ...
  nor2   g093(.a(new_n98_), .b(x16), .O(new_n140_));
  aoi21  g094(.a(new_n140_), .b(x05), .c(new_n49_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  nand3  g097(.a(new_n98_), .b(x14), .c(new_n48_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n143_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n92_), .O(new_n146_));
  nand2  g100(.a(new_n137_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n112_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n87_), .c(x16), .O(new_n152_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n148_), .c(new_n112_), .d(new_n90_), .O(new_n159_));
  ...
  nand4  g116(.a(new_n148_), .b(new_n84_), .c(new_n79_), .d(new_n73_), .O(new_n163_));
  nand3  g117(.a(new_n112_), .b(x19), .c(new_n102_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n102_), .O(new_n165_));
  nand3  g119(.a(new_n165_), .b(new_n87_), .c(x16), .O(new_n166_));
