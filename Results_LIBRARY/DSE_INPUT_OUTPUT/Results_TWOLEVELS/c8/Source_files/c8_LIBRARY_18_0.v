...
module FAU ( 
  ...
  nand2  g33(.a(new_n79_), .b(new_n54_), .O(z08));
  ...
  oai21  g49(.a(new_n95_), .b(x02), .c(new_n87_), .O(new_n96_));
  ...
  nand3  g62(.a(new_n108_), .b(new_n85_), .c(new_n53_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n92_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n87_), .c(new_n88_), .d(new_n107_), .O(z13));
  oai21  g66(.a(new_n95_), .b(x05), .c(new_n87_), .O(new_n113_));
  ...
  oai21  g74(.a(new_n95_), .b(x06), .c(new_n87_), .O(new_n121_));
  inv1   g75(.a(x22), .O(new_n122_));
  inv1   g76(.a(x23), .O(new_n123_));
  inv1   g77(.a(x25), .O(new_n124_));
  nand4  g78(.a(new_n124_), .b(new_n114_), .c(new_n123_), .d(new_n122_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n87_), .c(new_n121_), .O(z15));
  oai21  g82(.a(new_n95_), .b(x07), .c(new_n87_), .O(new_n129_));
  ...
  nand4  g93(.a(new_n131_), .b(new_n76_), .c(new_n124_), .d(new_n114_), .O(new_n140_));
  nand3  g94(.a(new_n130_), .b(x19), .c(new_n82_), .O(new_n141_));
