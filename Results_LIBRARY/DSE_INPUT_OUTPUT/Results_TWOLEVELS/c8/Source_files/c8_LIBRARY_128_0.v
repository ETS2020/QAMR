...
module FAU ( 
  ...
  nand4  g54(.a(new_n59_), .b(new_n93_), .c(new_n50_), .d(new_n84_), .O(new_n101_));
  ...
  nand3  g60(.a(new_n106_), .b(new_n86_), .c(new_n93_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n89_), .b(x04), .c(new_n88_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n95_), .c(new_n107_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n88_), .c(new_n112_), .O(z13));
  aoi21  g69(.a(new_n113_), .b(new_n95_), .c(new_n72_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n99_), .d(new_n84_), .O(new_n118_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n72_), .c(new_n67_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n102_), .c(new_n118_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n109_), .b(x06), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n88_), .c(new_n128_), .O(z15));
  oai21  g83(.a(new_n89_), .b(x07), .c(new_n88_), .O(new_n130_));
  ...
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n88_), .O(z17));
endmodule
