...
module FAU ( 
  ...
  aoi21  g019(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n66_));
  ...
  aoi22  g072(.a(new_n118_), .b(new_n95_), .c(new_n114_), .d(x23), .O(new_n119_));
  nor2   g073(.a(new_n99_), .b(x16), .O(new_n120_));
  aoi21  g074(.a(new_n120_), .b(x04), .c(new_n48_), .O(new_n121_));
  oai21  g075(.a(new_n119_), .b(new_n85_), .c(new_n121_), .O(z13));
  ...
  aoi21  g079(.a(new_n118_), .b(new_n95_), .c(new_n70_), .O(new_n126_));
  nor2   g080(.a(x20), .b(x19), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n113_), .c(new_n127_), .d(new_n81_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n126_), .c(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n125_), .c(new_n79_), .O(z14));
  nand2  g086(.a(x18), .b(x06), .O(new_n133_));
  nand3  g087(.a(new_n99_), .b(x14), .c(new_n47_), .O(new_n134_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n104_), .d(new_n83_), .O(new_n140_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n104_), .d(new_n83_), .O(new_n149_));
  ...
  nand3  g107(.a(new_n153_), .b(new_n138_), .c(new_n70_), .O(new_n154_));
  nand3  g108(.a(new_n104_), .b(x19), .c(new_n81_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n81_), .O(new_n156_));
