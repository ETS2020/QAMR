...
module FAU ( 
  ...
  nor2   g044(.a(new_n84_), .b(new_n54_), .O(new_n91_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n93_), .c(new_n48_), .O(z10));
  ...
  nand3  g065(.a(new_n111_), .b(new_n84_), .c(new_n54_), .O(new_n112_));
  ...
  oai22  g070(.a(new_n116_), .b(x01), .c(x18), .d(new_n64_), .O(new_n117_));
  ...
  oai22  g079(.a(new_n125_), .b(x01), .c(x18), .d(new_n69_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n86_), .O(new_n127_));
  nand3  g081(.a(new_n54_), .b(new_n82_), .c(new_n81_), .O(new_n128_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n81_), .O(new_n133_));
  ...
  oai22  g091(.a(new_n137_), .b(x01), .c(x18), .d(new_n72_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n86_), .O(new_n139_));
  nand2  g093(.a(new_n133_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n120_), .c(new_n101_), .d(new_n84_), .O(new_n142_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n101_), .d(new_n84_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n48_), .O(z16));
  ...
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n81_), .O(new_n159_));
