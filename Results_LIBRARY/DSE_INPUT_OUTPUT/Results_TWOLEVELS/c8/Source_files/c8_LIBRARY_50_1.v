...
module FAU ( 
  ...
  oai21  g066(.a(new_n103_), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n103_), .c(new_n78_), .O(new_n136_));
  inv1   g090(.a(x17), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n120_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n136_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n135_), .c(new_n53_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  aoi21  g098(.a(x18), .b(new_n144_), .c(x16), .O(new_n145_));
  nand2  g099(.a(new_n140_), .b(x25), .O(new_n146_));
  nor2   g100(.a(x23), .b(x22), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n111_), .d(new_n95_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(x16), .c(new_n145_), .O(new_n151_));
  inv1   g105(.a(x18), .O(new_n152_));
  nand3  g106(.a(new_n150_), .b(new_n152_), .c(x16), .O(new_n153_));
  oai21  g107(.a(new_n151_), .b(new_n52_), .c(new_n153_), .O(z15));
  ...
  nand3  g113(.a(new_n159_), .b(new_n147_), .c(new_n78_), .O(new_n160_));
  oai21  g114(.a(new_n160_), .b(new_n112_), .c(new_n158_), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n53_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n157_), .O(z16));
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n137_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n160_), .c(new_n48_), .d(new_n137_), .O(new_n165_));
