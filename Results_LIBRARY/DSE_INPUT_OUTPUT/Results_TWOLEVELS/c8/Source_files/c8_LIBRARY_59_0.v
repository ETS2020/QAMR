...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x16), .O(new_n47_));
  ...
  nor2   g038(.a(new_n47_), .b(new_n51_), .O(z08));
  ...
  nor2   g044(.a(new_n90_), .b(x16), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(x00), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n89_), .O(z09));
  nor2   g047(.a(new_n88_), .b(new_n56_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  nand2  g050(.a(new_n91_), .b(x01), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n96_), .O(z10));
  inv1   g052(.a(x16), .O(new_n99_));
  nor2   g053(.a(x20), .b(x19), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand4  g055(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n86_), .O(new_n102_));
  inv1   g056(.a(new_n102_), .O(new_n103_));
  aoi21  g057(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n91_), .b(x02), .O(new_n105_));
  oai21  g059(.a(new_n104_), .b(new_n99_), .c(new_n105_), .O(z11));
  nand2  g060(.a(new_n102_), .b(x22), .O(new_n107_));
  nor2   g061(.a(x22), .b(x21), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n88_), .c(new_n56_), .O(new_n109_));
  and2   g063(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g064(.a(new_n91_), .b(x03), .O(new_n111_));
  oai21  g065(.a(new_n110_), .b(new_n99_), .c(new_n111_), .O(z12));
  nor3   g066(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g067(.a(new_n113_), .b(new_n95_), .c(new_n109_), .d(x23), .O(new_n114_));
  nand2  g068(.a(new_n91_), .b(x04), .O(new_n115_));
  oai21  g069(.a(new_n114_), .b(new_n99_), .c(new_n115_), .O(z13));
  aoi21  g070(.a(new_n113_), .b(new_n95_), .c(new_n74_), .O(new_n117_));
  nor2   g071(.a(x24), .b(x23), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n108_), .c(new_n100_), .d(new_n86_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n91_), .b(x05), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n121_), .O(z14));
  oai21  g077(.a(new_n90_), .b(x06), .c(new_n99_), .O(new_n124_));
  inv1   g078(.a(x22), .O(new_n125_));
  nand4  g079(.a(new_n79_), .b(new_n74_), .c(new_n69_), .d(new_n125_), .O(new_n126_));
  inv1   g080(.a(new_n126_), .O(new_n127_));
  aoi22  g081(.a(new_n127_), .b(new_n103_), .c(new_n119_), .d(x25), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n99_), .c(new_n124_), .O(z15));
  oai21  g083(.a(new_n90_), .b(x07), .c(new_n99_), .O(new_n130_));
  nor2   g084(.a(x21), .b(x20), .O(new_n131_));
  nor2   g085(.a(x23), .b(x22), .O(new_n132_));
  nor2   g086(.a(x25), .b(x24), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n88_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x26), .O(new_n135_));
  nor3   g089(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n132_), .c(new_n131_), .d(new_n88_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n130_), .O(z16));
  inv1   g094(.a(new_n47_), .O(new_n141_));
  nor2   g095(.a(x26), .b(x25), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n132_), .c(new_n74_), .O(new_n143_));
  nand3  g097(.a(new_n131_), .b(x19), .c(new_n86_), .O(new_n144_));
  oai22  g098(.a(new_n144_), .b(new_n143_), .c(new_n51_), .d(new_n86_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n141_), .O(z17));
endmodule
