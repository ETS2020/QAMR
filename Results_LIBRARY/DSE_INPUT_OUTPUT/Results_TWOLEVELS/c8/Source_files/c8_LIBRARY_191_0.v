...
module FAU ( 
  ...
  oai22  g015(.a(new_n61_), .b(x11), .c(x27), .d(x22), .O(z03));
  ...
  nand2  g045(.a(new_n60_), .b(x11), .O(new_n92_));
  ...
  oai21  g051(.a(new_n84_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  ...
  oai21  g055(.a(new_n92_), .b(new_n54_), .c(new_n101_), .O(new_n102_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n56_), .c(new_n106_), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n79_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n103_), .O(z11));
  oai21  g063(.a(new_n60_), .b(x03), .c(new_n86_), .O(new_n110_));
  inv1   g064(.a(x22), .O(new_n111_));
  aoi21  g065(.a(new_n105_), .b(new_n84_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n84_), .c(new_n95_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n79_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  nand3  g072(.a(new_n60_), .b(x12), .c(x11), .O(new_n119_));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n104_), .c(new_n68_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n113_), .c(new_n96_), .d(new_n81_), .O(new_n133_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n105_), .d(new_n84_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n105_), .d(new_n84_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n149_), .c(new_n79_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n68_), .O(new_n157_));
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n81_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n57_), .d(new_n81_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n79_), .c(x16), .O(new_n160_));
