...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n92_), .c(new_n85_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n89_), .c(new_n90_), .d(new_n55_), .O(z11));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n87_), .c(new_n100_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n89_), .c(new_n90_), .d(new_n58_), .O(z12));
  ...
  oai22  g64(.a(new_n110_), .b(new_n89_), .c(new_n90_), .d(new_n64_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n89_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n94_), .c(new_n69_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n107_), .c(new_n97_), .d(new_n84_), .O(new_n115_));
  ...
  nand4  g73(.a(new_n74_), .b(new_n69_), .c(new_n119_), .d(new_n60_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n101_), .c(new_n115_), .d(x25), .O(new_n122_));
  nand3  g76(.a(new_n48_), .b(new_n89_), .c(x14), .O(new_n123_));
  oai21  g77(.a(new_n122_), .b(new_n89_), .c(new_n123_), .O(z15));
  oai21  g78(.a(x18), .b(x15), .c(new_n89_), .O(new_n125_));
  ...
  nand4  g89(.a(new_n127_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n136_));
  nand3  g90(.a(new_n126_), .b(x19), .c(new_n84_), .O(new_n137_));
  oai22  g91(.a(new_n137_), .b(new_n136_), .c(new_n61_), .d(new_n84_), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g93(.a(new_n139_), .b(new_n82_), .O(z17));
endmodule
