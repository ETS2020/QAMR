...
module FAU ( 
  ...
  inv1   g29(.a(x24), .O(new_n76_));
  nand2  g30(.a(new_n51_), .b(new_n76_), .O(new_n77_));
  aoi21  g31(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(z05));
  inv1   g32(.a(x14), .O(new_n79_));
  aoi21  g33(.a(x27), .b(new_n79_), .c(new_n47_), .O(new_n80_));
  oai21  g34(.a(x27), .b(x25), .c(new_n80_), .O(z06));
  inv1   g35(.a(x15), .O(new_n82_));
  aoi21  g36(.a(x27), .b(new_n82_), .c(new_n47_), .O(new_n83_));
  oai21  g37(.a(x27), .b(x26), .c(new_n83_), .O(z07));
  oai21  g38(.a(x18), .b(x16), .c(new_n51_), .O(z08));
  ...
  oai21  g48(.a(new_n90_), .b(x01), .c(new_n94_), .O(new_n95_));
  nor2   g49(.a(new_n88_), .b(new_n56_), .O(new_n96_));
  nor3   g50(.a(x20), .b(x19), .c(x17), .O(new_n97_));
  oai21  g51(.a(new_n97_), .b(new_n96_), .c(x16), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n95_), .O(z10));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand4  g55(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n86_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  nand2  g58(.a(new_n91_), .b(x02), .O(new_n105_));
  oai21  g59(.a(new_n104_), .b(new_n94_), .c(new_n105_), .O(z11));
  nand2  g60(.a(new_n102_), .b(x22), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n88_), .c(new_n56_), .O(new_n109_));
  and2   g63(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand2  g64(.a(new_n91_), .b(x03), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n94_), .c(new_n111_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n97_), .c(new_n109_), .d(x23), .O(new_n114_));
  nand2  g68(.a(new_n91_), .b(x04), .O(new_n115_));
  oai21  g69(.a(new_n114_), .b(new_n94_), .c(new_n115_), .O(z13));
  oai21  g70(.a(new_n90_), .b(x05), .c(new_n94_), .O(new_n117_));
  aoi21  g71(.a(new_n113_), .b(new_n97_), .c(new_n76_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n108_), .c(new_n100_), .d(new_n86_), .O(new_n120_));
  ...
  oai21  g77(.a(new_n90_), .b(x06), .c(new_n94_), .O(new_n124_));
  inv1   g78(.a(x25), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n76_), .c(new_n71_), .d(new_n66_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n103_), .c(new_n120_), .d(x25), .O(new_n128_));
  oai21  g82(.a(new_n128_), .b(new_n94_), .c(new_n124_), .O(z15));
  ...
  nand2  g92(.a(new_n91_), .b(x07), .O(new_n139_));
  ...
  aoi21  g97(.a(new_n143_), .b(new_n142_), .c(new_n94_), .O(z17));
endmodule
