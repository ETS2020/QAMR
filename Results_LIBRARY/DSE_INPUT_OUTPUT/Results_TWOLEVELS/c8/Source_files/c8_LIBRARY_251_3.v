...
module FAU ( 
  ...
  oai22  g053(.a(new_n84_), .b(new_n99_), .c(x18), .d(new_n55_), .O(new_n100_));
  ...
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(z13));
  ...
  aoi21  g080(.a(new_n117_), .b(new_n96_), .c(new_n69_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n126_), .c(new_n48_), .O(z14));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n102_), .d(new_n94_), .O(new_n141_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n139_), .c(new_n102_), .d(new_n94_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n139_), .c(new_n69_), .O(new_n155_));
  nand3  g109(.a(new_n102_), .b(x19), .c(new_n128_), .O(new_n156_));
