...
module FAU ( 
  ...
  nand3  g049(.a(new_n95_), .b(x09), .c(new_n48_), .O(new_n96_));
  ...
  oai21  g054(.a(new_n87_), .b(new_n54_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g058(.a(new_n95_), .b(x10), .c(new_n48_), .O(new_n105_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n83_), .c(x16), .O(new_n113_));
  ...
  aoi21  g072(.a(new_n110_), .b(new_n87_), .c(new_n118_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n87_), .c(new_n54_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n117_), .c(new_n83_), .O(z12));
  ...
  nand3  g086(.a(new_n132_), .b(new_n127_), .c(new_n83_), .O(z13));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n109_), .c(new_n69_), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n120_), .c(new_n99_), .d(new_n84_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(new_n83_), .O(z14));
  oai21  g096(.a(new_n95_), .b(new_n89_), .c(x06), .O(new_n143_));
  nand2  g097(.a(new_n139_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x23), .b(x22), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n110_), .d(new_n87_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n95_), .b(new_n89_), .c(x14), .O(new_n150_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n145_), .c(new_n110_), .d(new_n87_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n145_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n161_));
  nand3  g115(.a(new_n110_), .b(x19), .c(new_n84_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n84_), .O(new_n163_));
