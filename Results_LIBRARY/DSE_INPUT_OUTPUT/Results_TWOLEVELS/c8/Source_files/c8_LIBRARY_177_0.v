...
module FAU ( 
  ...
  nor2   g48(.a(new_n89_), .b(x16), .O(new_n95_));
  ...
  nand2  g57(.a(new_n95_), .b(x02), .O(new_n104_));
  oai21  g58(.a(new_n103_), .b(new_n88_), .c(new_n104_), .O(z11));
  ...
  nand2  g67(.a(new_n95_), .b(x04), .O(new_n114_));
