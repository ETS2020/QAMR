...
module FAU ( 
  ...
  aoi21  g015(.a(new_n61_), .b(new_n59_), .c(new_n47_), .O(z02));
  ...
  aoi21  g045(.a(new_n91_), .b(new_n89_), .c(new_n47_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n88_), .O(z09));
  inv1   g047(.a(x09), .O(new_n94_));
  nand2  g048(.a(x18), .b(x01), .O(new_n95_));
  nand2  g049(.a(x20), .b(new_n54_), .O(new_n96_));
  oai21  g050(.a(new_n96_), .b(new_n94_), .c(new_n95_), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n89_), .O(new_n98_));
  nor2   g052(.a(new_n54_), .b(x17), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n55_), .c(new_n50_), .O(new_n100_));
  oai21  g054(.a(new_n87_), .b(new_n55_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g071(.a(new_n60_), .b(new_n50_), .c(new_n85_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x22), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n87_), .c(new_n55_), .O(new_n121_));
  aoi21  g075(.a(new_n121_), .b(new_n119_), .c(new_n54_), .O(new_n122_));
  nor2   g076(.a(new_n65_), .b(new_n55_), .O(new_n123_));
  ...
  oai21  g080(.a(new_n96_), .b(new_n68_), .c(new_n126_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n89_), .O(new_n128_));
  nand2  g082(.a(new_n120_), .b(new_n87_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(x23), .O(new_n130_));
  nor2   g084(.a(x23), .b(x22), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n111_), .c(new_n60_), .O(new_n132_));
  aoi21  g086(.a(new_n132_), .b(new_n130_), .c(new_n54_), .O(new_n133_));
  nor2   g087(.a(new_n70_), .b(new_n55_), .O(new_n134_));
  ...
  oai21  g091(.a(new_n96_), .b(new_n73_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n89_), .O(new_n139_));
  nand3  g093(.a(new_n131_), .b(new_n87_), .c(new_n60_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n120_), .b(new_n111_), .c(new_n75_), .d(new_n70_), .O(new_n142_));
  aoi21  g096(.a(new_n142_), .b(new_n141_), .c(new_n54_), .O(new_n143_));
  nor2   g097(.a(new_n75_), .b(new_n55_), .O(new_n144_));
  ...
  oai21  g101(.a(new_n96_), .b(new_n78_), .c(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n89_), .O(new_n149_));
  nand3  g103(.a(new_n75_), .b(new_n70_), .c(new_n65_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n118_), .c(x25), .O(new_n151_));
  nor2   g105(.a(x21), .b(x20), .O(new_n152_));
  nor2   g106(.a(x25), .b(x24), .O(new_n153_));
  nand4  g107(.a(new_n153_), .b(new_n152_), .c(new_n131_), .d(new_n87_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(new_n151_), .c(new_n54_), .O(new_n155_));
  and2   g109(.a(x25), .b(x20), .O(new_n156_));
  ...
  oai21  g113(.a(new_n96_), .b(new_n81_), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n89_), .O(new_n161_));
  nand4  g115(.a(new_n153_), .b(new_n131_), .c(new_n107_), .d(new_n85_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x26), .O(new_n163_));
  nor3   g117(.a(x26), .b(x25), .c(x24), .O(new_n164_));
  nand4  g118(.a(new_n164_), .b(new_n152_), .c(new_n131_), .d(new_n87_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n163_), .c(new_n54_), .O(new_n166_));
  and2   g120(.a(x26), .b(x20), .O(new_n167_));
  ...
  nand2  g124(.a(new_n152_), .b(x19), .O(new_n171_));
  inv1   g125(.a(new_n171_), .O(new_n172_));
  nand4  g126(.a(new_n172_), .b(new_n164_), .c(new_n131_), .d(new_n99_), .O(new_n173_));
