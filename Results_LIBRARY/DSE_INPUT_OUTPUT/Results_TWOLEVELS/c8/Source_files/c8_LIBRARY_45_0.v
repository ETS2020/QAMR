...
module FAU ( 
  ...
  oai21  g022(.a(new_n67_), .b(new_n64_), .c(new_n68_), .O(z03));
  ...
  nand2  g042(.a(new_n88_), .b(new_n51_), .O(z08));
  inv1   g043(.a(x16), .O(new_n90_));
  nand2  g044(.a(x18), .b(x00), .O(new_n91_));
  nand3  g045(.a(new_n64_), .b(x11), .c(x08), .O(new_n92_));
  ...
  nor2   g057(.a(new_n96_), .b(new_n56_), .O(new_n104_));
  nor3   g058(.a(x20), .b(x19), .c(x17), .O(new_n105_));
  oai21  g059(.a(new_n105_), .b(new_n104_), .c(x16), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n103_), .c(new_n88_), .O(z10));
  ...
  nand3  g068(.a(new_n114_), .b(new_n110_), .c(new_n88_), .O(z11));
  oai21  g069(.a(new_n64_), .b(x03), .c(new_n90_), .O(new_n116_));
  inv1   g070(.a(x22), .O(new_n117_));
  aoi21  g071(.a(new_n111_), .b(new_n96_), .c(new_n117_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n96_), .c(new_n56_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n116_), .c(new_n88_), .O(z12));
  ...
  nand3  g085(.a(new_n131_), .b(new_n126_), .c(new_n88_), .O(z13));
  ...
  aoi21  g090(.a(new_n128_), .b(new_n105_), .c(new_n136_), .O(new_n137_));
  inv1   g091(.a(x17), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n139_), .d(new_n138_), .O(new_n141_));
  inv1   g095(.a(new_n141_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n137_), .c(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n135_), .c(new_n88_), .O(z14));
  ...
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n111_), .d(new_n96_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n147_), .c(new_n88_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  nand3  g109(.a(new_n64_), .b(x15), .c(x11), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n90_), .O(new_n158_));
  nand2  g112(.a(new_n151_), .b(x26), .O(new_n159_));
  nor3   g113(.a(x26), .b(x25), .c(x24), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n149_), .c(new_n111_), .d(new_n96_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n88_), .c(x16), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n158_), .O(z16));
  nand4  g118(.a(new_n149_), .b(new_n85_), .c(new_n80_), .d(new_n136_), .O(new_n165_));
  nand3  g119(.a(new_n111_), .b(x19), .c(new_n138_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n51_), .d(new_n138_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x16), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n88_), .O(z17));
endmodule
