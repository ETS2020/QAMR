...
module FAU ( 
  ...
  nand3  g041(.a(new_n87_), .b(x08), .c(x06), .O(new_n88_));
  ...
  nand3  g056(.a(new_n102_), .b(new_n99_), .c(new_n83_), .O(z10));
  ...
  nand2  g071(.a(new_n117_), .b(new_n56_), .O(new_n118_));
  nor2   g072(.a(new_n118_), .b(new_n93_), .O(new_n119_));
  ...
  nand3  g076(.a(new_n87_), .b(x12), .c(x06), .O(new_n123_));
  ...
  aoi21  g097(.a(new_n87_), .b(new_n75_), .c(x16), .O(new_n144_));
  ...
  aoi21  g102(.a(new_n148_), .b(x16), .c(new_n144_), .O(new_n149_));
  nand3  g103(.a(new_n148_), .b(x18), .c(x16), .O(new_n150_));
  oai21  g104(.a(new_n149_), .b(new_n143_), .c(new_n150_), .O(z15));
  ...
  nand3  g110(.a(new_n156_), .b(new_n126_), .c(new_n72_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n136_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n50_), .d(new_n136_), .O(new_n162_));
