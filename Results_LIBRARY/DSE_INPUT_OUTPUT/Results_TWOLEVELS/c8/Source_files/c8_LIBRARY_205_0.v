...
module FAU ( 
  ...
  nand2  g001(.a(new_n47_), .b(x26), .O(new_n48_));
  ...
  inv1   g006(.a(x26), .O(new_n53_));
  oai21  g007(.a(new_n53_), .b(new_n52_), .c(new_n47_), .O(new_n54_));
  oai21  g008(.a(new_n47_), .b(x11), .c(new_n54_), .O(z03));
  oai22  g009(.a(new_n48_), .b(x23), .c(new_n47_), .d(x12), .O(z04));
  inv1   g010(.a(x24), .O(new_n57_));
  oai21  g011(.a(new_n53_), .b(new_n57_), .c(new_n47_), .O(new_n58_));
  oai21  g012(.a(new_n47_), .b(x13), .c(new_n58_), .O(z05));
  oai22  g013(.a(new_n48_), .b(x25), .c(new_n47_), .d(x14), .O(z06));
  nor2   g014(.a(new_n47_), .b(x15), .O(z07));
  ...
  aoi21  g051(.a(new_n89_), .b(new_n66_), .c(new_n52_), .O(new_n98_));
  nand2  g052(.a(new_n64_), .b(new_n63_), .O(new_n99_));
  nand3  g053(.a(new_n52_), .b(new_n88_), .c(new_n79_), .O(new_n100_));
  ...
  nand3  g094(.a(new_n119_), .b(new_n63_), .c(x16), .O(new_n141_));
  inv1   g095(.a(x23), .O(new_n142_));
  nand3  g096(.a(new_n132_), .b(new_n120_), .c(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n141_), .c(x27), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n53_), .O(new_n145_));
  nand3  g099(.a(new_n133_), .b(x26), .c(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n145_), .c(new_n140_), .O(z16));
  nand3  g101(.a(new_n120_), .b(new_n79_), .c(x19), .O(new_n148_));
  nor2   g102(.a(x26), .b(x25), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n121_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n148_), .c(new_n63_), .O(new_n151_));
