...
module FAU ( 
  ...
  oai21  g055(.a(new_n95_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  ...
  aoi21  g061(.a(new_n100_), .b(new_n87_), .c(new_n107_), .O(new_n108_));
  ...
  aoi21  g080(.a(new_n121_), .b(new_n95_), .c(new_n69_), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n109_), .c(new_n128_), .d(new_n84_), .O(new_n130_));
  ...
  nand2  g099(.a(new_n145_), .b(new_n115_), .O(new_n146_));
  nand2  g100(.a(new_n139_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n100_), .d(new_n87_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n119_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  inv1   g106(.a(x23), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n107_), .O(new_n154_));
  nand3  g108(.a(new_n79_), .b(new_n74_), .c(new_n69_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand3  g110(.a(new_n100_), .b(x19), .c(new_n84_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n58_), .b(new_n84_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n119_), .c(new_n115_), .O(z17));
endmodule
