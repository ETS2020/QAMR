...
module FAU ( 
  ...
  nand3  g081(.a(new_n70_), .b(new_n127_), .c(new_n62_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n118_), .c(new_n101_), .d(new_n87_), .O(new_n149_));
  ...
  nand3  g109(.a(new_n101_), .b(x19), .c(new_n85_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n85_), .O(new_n157_));
