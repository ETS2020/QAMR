...
module FAU ( 
  ...
  oai21  g050(.a(new_n54_), .b(x01), .c(new_n92_), .O(new_n97_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n113_), .c(new_n87_), .O(z12));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  nand3  g075(.a(new_n54_), .b(x12), .c(x09), .O(new_n122_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n100_), .c(new_n62_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n87_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n124_), .O(z13));
  nand2  g084(.a(x18), .b(x05), .O(new_n131_));
  nand3  g085(.a(new_n54_), .b(x13), .c(x09), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n92_), .O(new_n134_));
  nand3  g088(.a(new_n98_), .b(new_n50_), .c(new_n88_), .O(new_n135_));
  nand3  g089(.a(new_n70_), .b(new_n114_), .c(new_n62_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n135_), .c(x24), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n116_), .c(new_n138_), .d(new_n88_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n87_), .c(x16), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n106_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n146_), .c(new_n87_), .O(z15));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n54_), .b(x15), .c(x09), .O(new_n154_));
  ...
  nand4  g112(.a(new_n158_), .b(new_n126_), .c(new_n106_), .d(new_n90_), .O(new_n159_));
  ...
  nand4  g117(.a(new_n126_), .b(new_n83_), .c(new_n78_), .d(new_n163_), .O(new_n164_));
  nand3  g118(.a(new_n106_), .b(x19), .c(new_n88_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n51_), .d(new_n88_), .O(new_n166_));
