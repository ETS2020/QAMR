...
module FAU ( 
  ...
  aoi21  g037(.a(new_n83_), .b(new_n81_), .c(new_n48_), .O(z06));
  aoi21  g038(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n85_));
  ...
  oai21  g054(.a(new_n100_), .b(new_n55_), .c(new_n98_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  nand3  g056(.a(new_n57_), .b(new_n51_), .c(new_n89_), .O(new_n103_));
  oai21  g057(.a(new_n91_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n88_), .O(z11));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n91_), .c(new_n67_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n91_), .c(new_n57_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n119_), .c(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n88_), .O(z12));
  nand2  g078(.a(x18), .b(x04), .O(new_n125_));
  oai21  g079(.a(new_n100_), .b(new_n70_), .c(new_n125_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n88_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n127_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  oai21  g088(.a(new_n100_), .b(new_n75_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n93_), .O(new_n136_));
  nand3  g090(.a(new_n72_), .b(new_n67_), .c(new_n62_), .O(new_n137_));
  ...
  nand2  g107(.a(new_n150_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n129_), .c(new_n111_), .d(new_n91_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nor2   g112(.a(new_n99_), .b(x16), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(x07), .c(new_n48_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n158_), .O(z16));
  nor2   g115(.a(x26), .b(x25), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n129_), .c(new_n77_), .O(new_n163_));
  nand3  g117(.a(new_n111_), .b(x19), .c(new_n89_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n52_), .d(new_n89_), .O(new_n165_));
