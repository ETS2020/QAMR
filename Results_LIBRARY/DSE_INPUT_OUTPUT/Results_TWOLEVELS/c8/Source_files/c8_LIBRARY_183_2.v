...
module FAU ( 
  ...
  nor2   g002(.a(x16), .b(new_n48_), .O(new_n49_));
  ...
  aoi21  g044(.a(new_n90_), .b(x08), .c(x00), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(x16), .c(new_n89_), .O(z09));
  nor2   g046(.a(new_n88_), .b(new_n54_), .O(new_n93_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n97_), .c(new_n48_), .O(new_n99_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n96_), .c(new_n48_), .O(new_n104_));
  nor2   g058(.a(x20), .b(x19), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n85_), .O(new_n106_));
  nand4  g060(.a(new_n60_), .b(new_n54_), .c(new_n86_), .d(new_n85_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  aoi21  g062(.a(new_n106_), .b(x21), .c(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n96_), .c(new_n104_), .O(z11));
  nand2  g064(.a(x18), .b(x03), .O(new_n111_));
  nand2  g065(.a(new_n90_), .b(x11), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n111_), .c(new_n48_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n96_), .O(new_n114_));
  nand2  g068(.a(new_n107_), .b(x22), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n88_), .c(new_n54_), .O(new_n117_));
  and2   g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n96_), .c(new_n114_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  nand2  g074(.a(new_n90_), .b(x12), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n120_), .c(new_n48_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n96_), .O(new_n123_));
  nor3   g077(.a(x23), .b(x22), .c(x21), .O(new_n124_));
  aoi22  g078(.a(new_n124_), .b(new_n94_), .c(new_n117_), .d(x23), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n96_), .c(new_n123_), .O(z13));
  nand2  g080(.a(x18), .b(x05), .O(new_n127_));
  nand2  g081(.a(new_n90_), .b(x13), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n127_), .c(new_n48_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n96_), .O(new_n130_));
  aoi21  g084(.a(new_n124_), .b(new_n94_), .c(new_n75_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n116_), .c(new_n105_), .d(new_n85_), .O(new_n133_));
  ...
  nand2  g091(.a(new_n90_), .b(x14), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n137_), .c(new_n48_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n96_), .O(new_n140_));
  inv1   g094(.a(x25), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n75_), .c(new_n70_), .d(new_n65_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  aoi22  g097(.a(new_n143_), .b(new_n108_), .c(new_n133_), .d(x25), .O(new_n144_));
  oai21  g098(.a(new_n144_), .b(new_n96_), .c(new_n140_), .O(z15));
  nand2  g099(.a(x18), .b(x07), .O(new_n146_));
  oai21  g100(.a(x18), .b(new_n81_), .c(new_n146_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n96_), .c(new_n48_), .O(new_n148_));
  nor2   g102(.a(x21), .b(x20), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n149_), .d(new_n88_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n150_), .c(new_n149_), .d(new_n88_), .O(new_n155_));
  ...
  nor2   g112(.a(new_n86_), .b(x17), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n154_), .c(new_n150_), .d(new_n149_), .O(new_n160_));
  nand2  g114(.a(x27), .b(x17), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n160_), .c(new_n96_), .O(z17));
endmodule
