...
module FAU ( 
  ...
  oai22  g011(.a(new_n57_), .b(x09), .c(x27), .d(x20), .O(z01));
  inv1   g012(.a(x10), .O(new_n59_));
  aoi21  g013(.a(x27), .b(new_n59_), .c(new_n48_), .O(new_n60_));
  ...
  nor2   g036(.a(new_n48_), .b(new_n52_), .O(z08));
  ...
  nand2  g047(.a(new_n55_), .b(x09), .O(new_n94_));
  nand2  g048(.a(new_n56_), .b(x18), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n93_), .c(new_n94_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n88_), .O(new_n97_));
  nor3   g051(.a(new_n86_), .b(new_n56_), .c(x18), .O(new_n98_));
  ...
  oai21  g059(.a(new_n105_), .b(new_n88_), .c(new_n55_), .O(new_n106_));
  ...
  oai21  g070(.a(new_n116_), .b(new_n88_), .c(new_n55_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(x20), .O(new_n118_));
  nor3   g072(.a(x21), .b(x19), .c(x17), .O(new_n119_));
  nor2   g073(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  nand2  g074(.a(new_n51_), .b(new_n84_), .O(new_n121_));
  nand2  g075(.a(new_n116_), .b(new_n105_), .O(new_n122_));
  nor3   g076(.a(new_n122_), .b(new_n121_), .c(x20), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n118_), .c(new_n115_), .O(z12));
  inv1   g079(.a(x04), .O(new_n126_));
  oai22  g080(.a(new_n95_), .b(new_n126_), .c(x18), .d(new_n65_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n88_), .O(new_n128_));
  oai21  g082(.a(new_n122_), .b(new_n121_), .c(x23), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n86_), .c(new_n105_), .O(new_n131_));
  aoi21  g085(.a(new_n131_), .b(new_n129_), .c(x20), .O(new_n132_));
  nor3   g086(.a(new_n67_), .b(new_n56_), .c(x18), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n132_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n128_), .O(z13));
  inv1   g089(.a(x05), .O(new_n136_));
  oai22  g090(.a(new_n95_), .b(new_n136_), .c(x18), .d(new_n70_), .O(new_n137_));
  ...
  nand2  g094(.a(new_n140_), .b(new_n119_), .O(new_n141_));
  ...
  oai21  g100(.a(x18), .b(new_n75_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n88_), .O(new_n148_));
  inv1   g102(.a(x25), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(new_n88_), .c(new_n55_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x20), .O(new_n151_));
  aoi21  g105(.a(new_n140_), .b(new_n119_), .c(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n130_), .b(new_n149_), .c(new_n72_), .O(new_n153_));
  nor2   g107(.a(new_n153_), .b(new_n109_), .O(new_n154_));
  ...
  oai21  g113(.a(new_n80_), .b(new_n88_), .c(new_n55_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x20), .O(new_n161_));
  inv1   g115(.a(new_n153_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n119_), .c(new_n80_), .O(new_n163_));
  nor3   g117(.a(x26), .b(x25), .c(x24), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n130_), .O(new_n165_));
  nor2   g119(.a(new_n165_), .b(new_n109_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n163_), .c(x16), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n161_), .c(new_n159_), .O(z16));
  nand2  g122(.a(z08), .b(x17), .O(new_n169_));
  nor2   g123(.a(new_n51_), .b(x17), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n164_), .c(new_n130_), .d(new_n108_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n169_), .c(new_n88_), .O(z17));
endmodule
