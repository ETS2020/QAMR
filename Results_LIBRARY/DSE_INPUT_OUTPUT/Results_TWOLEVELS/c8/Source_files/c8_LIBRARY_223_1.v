...
module FAU ( 
  ...
  nand2  g012(.a(new_n50_), .b(new_n58_), .O(new_n59_));
  aoi21  g013(.a(new_n59_), .b(new_n57_), .c(new_n54_), .O(z01));
  ...
  oai22  g056(.a(new_n102_), .b(new_n101_), .c(x18), .d(new_n56_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nand3  g058(.a(new_n58_), .b(new_n49_), .c(new_n92_), .O(new_n105_));
  oai21  g059(.a(new_n94_), .b(new_n58_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n53_), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n104_), .O(z10));
  inv1   g062(.a(x02), .O(new_n109_));
  oai22  g063(.a(new_n102_), .b(new_n109_), .c(x18), .d(new_n61_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n96_), .O(new_n111_));
  inv1   g065(.a(new_n105_), .O(new_n112_));
  nor2   g066(.a(x21), .b(x20), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n94_), .O(new_n114_));
  oai21  g068(.a(new_n112_), .b(new_n63_), .c(new_n114_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n53_), .c(x16), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n111_), .O(z11));
  nand2  g071(.a(x18), .b(x03), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n66_), .c(new_n118_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n96_), .O(new_n120_));
  inv1   g074(.a(new_n114_), .O(new_n121_));
  nor2   g075(.a(new_n121_), .b(new_n68_), .O(new_n122_));
  nand2  g076(.a(new_n68_), .b(new_n63_), .O(new_n123_));
  nor4   g077(.a(new_n123_), .b(x20), .c(x19), .d(x17), .O(new_n124_));
  oai21  g078(.a(new_n124_), .b(new_n122_), .c(x16), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n53_), .O(z12));
  nand2  g080(.a(x18), .b(x04), .O(new_n127_));
  oai21  g081(.a(x18), .b(new_n71_), .c(new_n127_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n96_), .O(new_n129_));
  nor2   g083(.a(x23), .b(x22), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n112_), .c(new_n63_), .O(new_n131_));
  oai21  g085(.a(new_n124_), .b(new_n73_), .c(new_n131_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(x16), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n129_), .c(new_n53_), .O(z13));
  nand2  g088(.a(x18), .b(x05), .O(new_n135_));
  oai21  g089(.a(x18), .b(new_n78_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n96_), .O(new_n137_));
  and2   g091(.a(new_n131_), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n76_), .b(new_n73_), .c(new_n68_), .d(new_n63_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n105_), .O(new_n140_));
  ...
  oai22  g097(.a(new_n102_), .b(new_n143_), .c(x18), .d(new_n83_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n96_), .O(new_n145_));
  nand3  g099(.a(new_n130_), .b(new_n81_), .c(new_n76_), .O(new_n146_));
  oai22  g100(.a(new_n146_), .b(new_n114_), .c(new_n140_), .d(new_n81_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n53_), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(z15));
  oai21  g103(.a(x18), .b(new_n86_), .c(new_n102_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n96_), .O(new_n151_));
  inv1   g105(.a(x18), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n102_), .c(new_n140_), .O(new_n154_));
  nor3   g108(.a(new_n54_), .b(new_n81_), .c(new_n96_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n154_), .c(x26), .O(new_n156_));
  nand4  g110(.a(new_n53_), .b(new_n88_), .c(new_n81_), .d(new_n76_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n73_), .c(new_n68_), .d(new_n63_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(x20), .O(new_n160_));
  nand4  g114(.a(new_n160_), .b(new_n49_), .c(new_n92_), .d(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n151_), .O(z16));
  nand3  g116(.a(new_n113_), .b(x19), .c(new_n92_), .O(new_n163_));
  nand4  g117(.a(new_n130_), .b(new_n88_), .c(new_n81_), .d(new_n76_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n50_), .d(new_n92_), .O(new_n165_));
