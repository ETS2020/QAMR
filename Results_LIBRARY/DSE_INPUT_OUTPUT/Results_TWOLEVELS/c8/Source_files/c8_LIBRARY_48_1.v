...
module FAU ( 
  ...
  oai21  g45(.a(new_n91_), .b(new_n49_), .c(new_n89_), .O(z09));
  inv1   g46(.a(x16), .O(new_n93_));
  oai21  g47(.a(x18), .b(x09), .c(new_n93_), .O(new_n94_));
  nor2   g48(.a(new_n88_), .b(new_n57_), .O(new_n95_));
  ...
  nand4  g55(.a(new_n101_), .b(new_n57_), .c(new_n51_), .d(new_n86_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n100_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n93_), .c(new_n91_), .d(new_n60_), .O(z11));
  oai21  g59(.a(x18), .b(x11), .c(new_n93_), .O(new_n106_));
  nand2  g60(.a(new_n102_), .b(x22), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n88_), .c(new_n57_), .O(new_n109_));
  ...
  oai22  g67(.a(new_n113_), .b(new_n93_), .c(new_n91_), .d(new_n68_), .O(z13));
  inv1   g68(.a(x24), .O(new_n115_));
  aoi21  g69(.a(new_n112_), .b(new_n96_), .c(new_n115_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n108_), .c(new_n99_), .d(new_n86_), .O(new_n118_));
  ...
  oai21  g76(.a(x18), .b(x14), .c(new_n93_), .O(new_n123_));
  nand4  g77(.a(new_n78_), .b(new_n115_), .c(new_n70_), .d(new_n65_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n103_), .c(new_n118_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n93_), .c(new_n123_), .O(z15));
  ...
  nand2  g90(.a(new_n90_), .b(x15), .O(new_n137_));
  nand2  g91(.a(new_n137_), .b(new_n136_), .O(z16));
  nor2   g92(.a(x26), .b(x25), .O(new_n139_));
  nand3  g93(.a(new_n139_), .b(new_n129_), .c(new_n115_), .O(new_n140_));
