...
module FAU ( 
  ...
  aoi21  g038(.a(new_n84_), .b(new_n82_), .c(new_n47_), .O(new_n85_));
  aoi21  g039(.a(new_n47_), .b(x00), .c(new_n85_), .O(new_n86_));
  nand3  g040(.a(new_n81_), .b(new_n47_), .c(x08), .O(new_n87_));
  oai21  g041(.a(new_n86_), .b(new_n81_), .c(new_n87_), .O(z09));
  oai21  g042(.a(x16), .b(x09), .c(new_n81_), .O(new_n89_));
  nor2   g043(.a(x19), .b(x17), .O(new_n90_));
  nor2   g044(.a(new_n90_), .b(new_n57_), .O(new_n91_));
  ...
  nand2  g073(.a(new_n94_), .b(x04), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n119_), .c(new_n114_), .O(z13));
  oai21  g075(.a(x16), .b(x13), .c(new_n81_), .O(new_n122_));
  aoi21  g076(.a(new_n116_), .b(new_n92_), .c(new_n71_), .O(new_n123_));
  nor2   g077(.a(x20), .b(x19), .O(new_n124_));
  nor2   g078(.a(x24), .b(x23), .O(new_n125_));
  nand4  g079(.a(new_n125_), .b(new_n108_), .c(new_n124_), .d(new_n83_), .O(new_n126_));
  ...
  nand2  g086(.a(new_n132_), .b(new_n47_), .O(new_n133_));
  nand2  g087(.a(new_n126_), .b(x25), .O(new_n134_));
  nor2   g088(.a(x23), .b(x22), .O(new_n135_));
  nor2   g089(.a(x25), .b(x24), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n99_), .d(new_n90_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n135_), .c(new_n99_), .d(new_n90_), .O(new_n146_));
  ...
  nand2  g104(.a(new_n150_), .b(new_n106_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n99_), .b(x19), .c(new_n83_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n52_), .b(new_n83_), .O(new_n158_));
