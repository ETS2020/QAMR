...
module FAU ( 
  ...
  nand2  g036(.a(x18), .b(new_n74_), .O(new_n83_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n91_), .c(new_n48_), .O(z10));
  ...
  oai22  g060(.a(new_n83_), .b(new_n106_), .c(x18), .d(new_n61_), .O(new_n107_));
  ...
  oai22  g078(.a(new_n83_), .b(new_n124_), .c(x18), .d(new_n69_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n81_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  inv1   g081(.a(x19), .O(new_n128_));
  nand3  g082(.a(new_n92_), .b(new_n128_), .c(new_n127_), .O(new_n129_));
  inv1   g083(.a(x22), .O(new_n130_));
  nand3  g084(.a(new_n66_), .b(new_n130_), .c(new_n57_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n119_), .c(new_n101_), .d(new_n93_), .O(new_n142_));
  ...
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n58_), .d(new_n127_), .O(new_n159_));
