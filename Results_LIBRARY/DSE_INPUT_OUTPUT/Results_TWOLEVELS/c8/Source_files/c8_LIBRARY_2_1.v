...
module FAU ( 
  ...
  nand4  g56(.a(new_n102_), .b(new_n93_), .c(new_n51_), .d(new_n86_), .O(new_n103_));
  inv1   g57(.a(new_n103_), .O(new_n104_));
  aoi21  g58(.a(new_n101_), .b(x21), .c(new_n104_), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n90_), .c(new_n98_), .d(new_n58_), .O(z11));
  oai21  g60(.a(x18), .b(x11), .c(new_n90_), .O(new_n107_));
  ...
  oai21  g65(.a(new_n111_), .b(new_n90_), .c(new_n107_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n95_), .c(new_n110_), .d(x23), .O(new_n114_));
  oai22  g68(.a(new_n114_), .b(new_n90_), .c(new_n98_), .d(new_n66_), .O(z13));
  aoi21  g69(.a(new_n113_), .b(new_n95_), .c(new_n71_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n109_), .c(new_n100_), .d(new_n86_), .O(new_n118_));
  inv1   g72(.a(new_n118_), .O(new_n119_));
  oai21  g73(.a(new_n119_), .b(new_n116_), .c(x16), .O(new_n120_));
  nand2  g74(.a(new_n97_), .b(x13), .O(new_n121_));
  nand2  g75(.a(new_n121_), .b(new_n120_), .O(z14));
  inv1   g76(.a(x23), .O(new_n123_));
  nand4  g77(.a(new_n76_), .b(new_n71_), .c(new_n123_), .d(new_n63_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n104_), .c(new_n118_), .d(x25), .O(new_n126_));
  nand2  g80(.a(new_n97_), .b(x14), .O(new_n127_));
  ...
  nand4  g93(.a(new_n131_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n140_));
  nand3  g94(.a(new_n130_), .b(x19), .c(new_n86_), .O(new_n141_));
