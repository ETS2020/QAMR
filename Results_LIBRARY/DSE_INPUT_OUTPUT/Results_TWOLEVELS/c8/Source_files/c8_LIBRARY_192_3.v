...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x13), .O(new_n48_));
  ...
  nand2  g038(.a(x18), .b(new_n69_), .O(new_n85_));
  ...
  oai22  g057(.a(new_n85_), .b(new_n103_), .c(x18), .d(new_n58_), .O(new_n104_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n89_), .c(new_n54_), .O(new_n118_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n108_), .d(new_n89_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n108_), .d(new_n89_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n144_), .b(new_n79_), .c(new_n74_), .d(new_n132_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n97_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n97_), .O(new_n161_));
