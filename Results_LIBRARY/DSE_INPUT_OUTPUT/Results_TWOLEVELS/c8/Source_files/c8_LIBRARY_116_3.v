...
module FAU ( 
  ...
  nand2  g038(.a(new_n84_), .b(new_n82_), .O(z09));
  inv1   g039(.a(x01), .O(new_n86_));
  oai22  g040(.a(new_n80_), .b(new_n86_), .c(x18), .d(new_n52_), .O(new_n87_));
  ...
  oai22  g061(.a(new_n80_), .b(new_n107_), .c(x18), .d(new_n58_), .O(new_n108_));
  ...
  oai22  g070(.a(new_n80_), .b(new_n116_), .c(x18), .d(new_n61_), .O(new_n117_));
  ...
  aoi21  g079(.a(new_n120_), .b(new_n101_), .c(new_n125_), .O(new_n126_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n77_), .c(x13), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n130_), .c(new_n48_), .O(z14));
  nand2  g087(.a(x18), .b(x06), .O(new_n134_));
  oai22  g088(.a(new_n134_), .b(x05), .c(x18), .d(new_n67_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n77_), .O(new_n136_));
  nand2  g090(.a(new_n128_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n102_), .d(new_n90_), .O(new_n140_));
  ...
  nand2  g099(.a(new_n145_), .b(new_n77_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n138_), .c(new_n102_), .d(new_n90_), .O(new_n149_));
  ...
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n70_), .d(new_n91_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n48_), .O(z17));
endmodule
