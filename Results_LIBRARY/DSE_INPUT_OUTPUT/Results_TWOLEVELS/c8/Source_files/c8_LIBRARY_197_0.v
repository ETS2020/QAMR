...
module FAU ( 
  ...
  oai21  g44(.a(new_n90_), .b(new_n84_), .c(new_n88_), .O(z09));
  inv1   g45(.a(x18), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(x01), .c(new_n89_), .O(new_n93_));
  ...
  oai21  g52(.a(new_n92_), .b(x02), .c(new_n89_), .O(new_n99_));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n85_), .O(new_n101_));
  inv1   g55(.a(x21), .O(new_n102_));
  nand4  g56(.a(new_n102_), .b(new_n94_), .c(new_n50_), .d(new_n85_), .O(new_n103_));
  ...
  inv1   g60(.a(x03), .O(new_n107_));
  nor3   g61(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n87_), .c(new_n103_), .d(x22), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n89_), .c(new_n90_), .d(new_n107_), .O(z12));
  inv1   g64(.a(x04), .O(new_n111_));
  nor2   g65(.a(x22), .b(x21), .O(new_n112_));
  nand3  g66(.a(new_n112_), .b(new_n87_), .c(new_n94_), .O(new_n113_));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n96_), .c(new_n113_), .d(x23), .O(new_n115_));
  oai22  g69(.a(new_n115_), .b(new_n89_), .c(new_n90_), .d(new_n111_), .O(z13));
  oai21  g70(.a(new_n92_), .b(x05), .c(new_n89_), .O(new_n117_));
  aoi21  g71(.a(new_n114_), .b(new_n96_), .c(new_n72_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n112_), .c(new_n100_), .d(new_n85_), .O(new_n120_));
  ...
  oai21  g77(.a(new_n92_), .b(x06), .c(new_n89_), .O(new_n124_));
  inv1   g78(.a(x25), .O(new_n125_));
  nand4  g79(.a(new_n125_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n126_));
  ...
  oai21  g83(.a(new_n92_), .b(x07), .c(new_n89_), .O(new_n130_));
