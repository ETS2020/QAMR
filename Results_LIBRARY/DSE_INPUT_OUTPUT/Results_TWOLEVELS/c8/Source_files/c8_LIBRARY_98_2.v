...
module FAU ( 
  ...
  nand3  g055(.a(new_n101_), .b(x10), .c(new_n52_), .O(new_n102_));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n86_), .c(new_n65_), .O(new_n114_));
  ...
  nand3  g073(.a(new_n101_), .b(x12), .c(new_n52_), .O(new_n120_));
  oai21  g074(.a(new_n101_), .b(new_n52_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n88_), .O(new_n122_));
  nand2  g076(.a(new_n116_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n97_), .c(new_n105_), .O(new_n125_));
  ...
  nand3  g083(.a(new_n101_), .b(x13), .c(new_n52_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n88_), .O(new_n132_));
  nand3  g086(.a(new_n57_), .b(new_n49_), .c(new_n84_), .O(new_n133_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n124_), .c(new_n106_), .d(new_n86_), .O(new_n148_));
  ...
  nand3  g106(.a(new_n101_), .b(x15), .c(new_n52_), .O(new_n153_));
  ...
  nand3  g118(.a(new_n106_), .b(x19), .c(new_n84_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n50_), .d(new_n84_), .O(new_n166_));
