...
module FAU ( 
  ...
  oai21  g024(.a(new_n48_), .b(x26), .c(new_n52_), .O(new_n71_));
  ...
  nand3  g054(.a(new_n58_), .b(new_n47_), .c(new_n89_), .O(new_n101_));
  oai21  g055(.a(new_n91_), .b(new_n58_), .c(new_n101_), .O(new_n102_));
  ...
  aoi21  g061(.a(new_n107_), .b(new_n105_), .c(x16), .O(new_n108_));
  nand3  g062(.a(new_n101_), .b(x21), .c(x16), .O(new_n109_));
  inv1   g063(.a(new_n109_), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n108_), .c(new_n53_), .O(new_n111_));
  nor3   g065(.a(new_n55_), .b(x21), .c(x20), .O(new_n112_));
  nand4  g066(.a(new_n112_), .b(new_n47_), .c(new_n89_), .d(x16), .O(new_n113_));
  ...
  aoi21  g071(.a(x26), .b(new_n52_), .c(x22), .O(new_n118_));
  nand4  g072(.a(new_n118_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n119_));
  nand3  g073(.a(new_n91_), .b(new_n63_), .c(new_n58_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x22), .O(new_n121_));
  oai21  g075(.a(new_n119_), .b(x17), .c(new_n121_), .O(new_n122_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n53_), .c(new_n93_), .O(new_n128_));
  nand2  g082(.a(x23), .b(x22), .O(new_n129_));
  nand3  g083(.a(new_n83_), .b(new_n52_), .c(new_n68_), .O(new_n130_));
  aoi21  g084(.a(new_n130_), .b(new_n129_), .c(x21), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n58_), .c(new_n47_), .d(new_n89_), .O(new_n132_));
  nand2  g086(.a(new_n120_), .b(x23), .O(new_n133_));
  ...
  nand4  g093(.a(new_n91_), .b(new_n68_), .c(new_n63_), .d(new_n58_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n83_), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n52_), .c(new_n73_), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n83_), .c(new_n73_), .O(new_n144_));
  nor2   g098(.a(new_n144_), .b(new_n120_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n142_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n139_), .O(z14));
  nand2  g101(.a(x18), .b(x06), .O(new_n148_));
  oai21  g102(.a(x18), .b(new_n80_), .c(new_n148_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n53_), .c(new_n93_), .O(new_n150_));
  nand3  g104(.a(new_n73_), .b(new_n68_), .c(new_n63_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n101_), .c(new_n83_), .O(new_n152_));
  aoi21  g106(.a(new_n152_), .b(new_n52_), .c(new_n78_), .O(new_n153_));
  nand4  g107(.a(new_n143_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n120_), .O(new_n155_));
  ...
  oai21  g112(.a(x26), .b(x16), .c(new_n158_), .O(new_n159_));
  ...
  inv1   g116(.a(new_n158_), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(new_n155_), .c(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n162_), .O(z16));
  nand4  g119(.a(new_n63_), .b(new_n58_), .c(x19), .d(new_n89_), .O(new_n166_));
  nand3  g120(.a(new_n143_), .b(new_n78_), .c(new_n73_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n48_), .d(new_n89_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(x16), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(new_n53_), .O(z17));
endmodule
