...
module FAU ( 
  ...
  nand3  g52(.a(new_n47_), .b(new_n92_), .c(x09), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(new_n98_), .O(z10));
  oai21  g54(.a(x18), .b(x10), .c(new_n92_), .O(new_n101_));
  nor2   g55(.a(x20), .b(x19), .O(new_n102_));
  nand2  g56(.a(new_n102_), .b(new_n88_), .O(new_n103_));
  nand4  g57(.a(new_n60_), .b(new_n95_), .c(new_n51_), .d(new_n88_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n92_), .c(new_n101_), .O(z11));
  oai21  g61(.a(x18), .b(x11), .c(new_n92_), .O(new_n108_));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n90_), .c(new_n95_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n92_), .c(new_n108_), .O(z12));
  oai21  g67(.a(x18), .b(x12), .c(new_n92_), .O(new_n114_));
  nor3   g68(.a(x23), .b(x22), .c(x21), .O(new_n115_));
  aoi22  g69(.a(new_n115_), .b(new_n97_), .c(new_n111_), .d(x23), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n92_), .c(new_n114_), .O(z13));
  oai21  g71(.a(x18), .b(x13), .c(new_n92_), .O(new_n118_));
  aoi21  g72(.a(new_n115_), .b(new_n97_), .c(new_n73_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n110_), .c(new_n102_), .d(new_n88_), .O(new_n121_));
  ...
  oai21  g78(.a(x18), .b(x14), .c(new_n92_), .O(new_n125_));
  inv1   g79(.a(x23), .O(new_n126_));
  nand4  g80(.a(new_n78_), .b(new_n73_), .c(new_n126_), .d(new_n65_), .O(new_n127_));
  inv1   g81(.a(new_n127_), .O(new_n128_));
  aoi22  g82(.a(new_n128_), .b(new_n105_), .c(new_n121_), .d(x25), .O(new_n129_));
  oai21  g83(.a(new_n129_), .b(new_n92_), .c(new_n125_), .O(z15));
  oai21  g84(.a(x18), .b(x15), .c(new_n92_), .O(new_n131_));
  ...
  nand4  g95(.a(new_n133_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n142_));
  nand3  g96(.a(new_n132_), .b(x19), .c(new_n88_), .O(new_n143_));
