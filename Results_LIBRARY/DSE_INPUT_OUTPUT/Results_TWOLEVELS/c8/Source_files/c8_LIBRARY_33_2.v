...
module FAU ( 
  ...
  aoi21  g080(.a(new_n120_), .b(new_n96_), .c(new_n71_), .O(new_n127_));
  inv1   g081(.a(x17), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n113_), .c(new_n129_), .d(new_n128_), .O(new_n131_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n104_), .d(new_n88_), .O(new_n151_));
  ...
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n128_), .O(new_n156_));
