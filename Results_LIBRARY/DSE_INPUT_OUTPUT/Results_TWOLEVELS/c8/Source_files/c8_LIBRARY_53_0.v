...
module FAU ( 
  ...
  nor2   g026(.a(x27), .b(x25), .O(new_n73_));
  aoi21  g027(.a(x27), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  nand2  g028(.a(new_n73_), .b(x14), .O(new_n75_));
  oai21  g029(.a(new_n74_), .b(new_n71_), .c(new_n75_), .O(z06));
  ...
  aoi21  g035(.a(new_n71_), .b(new_n72_), .c(new_n57_), .O(z08));
  inv1   g036(.a(x16), .O(new_n83_));
  nand2  g037(.a(x18), .b(x00), .O(new_n84_));
  nand2  g038(.a(new_n71_), .b(x14), .O(new_n85_));
  ...
  nand3  g056(.a(new_n102_), .b(new_n88_), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n97_), .O(z10));
  nand2  g058(.a(x18), .b(x02), .O(new_n105_));
  oai21  g059(.a(new_n85_), .b(new_n54_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n108_), .c(new_n56_), .O(new_n128_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n62_), .c(new_n56_), .O(new_n136_));
  ...
  oai21  g097(.a(new_n71_), .b(x06), .c(new_n83_), .O(new_n144_));
  nand2  g098(.a(new_n140_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n127_), .c(new_n109_), .d(new_n90_), .O(new_n147_));
  ...
  nand3  g105(.a(new_n71_), .b(x15), .c(x14), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n127_), .c(new_n109_), .d(new_n90_), .O(new_n157_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n127_), .c(new_n161_), .O(new_n163_));
  nand3  g117(.a(new_n109_), .b(x19), .c(new_n99_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n57_), .d(new_n99_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n88_), .O(z17));
endmodule
