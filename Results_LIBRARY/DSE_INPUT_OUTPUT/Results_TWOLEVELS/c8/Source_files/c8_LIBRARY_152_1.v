...
module FAU ( 
  ...
  nand4  g53(.a(new_n99_), .b(new_n54_), .c(new_n85_), .d(new_n84_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n98_), .b(x21), .c(new_n101_), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n96_), .c(new_n90_), .d(new_n58_), .O(z11));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n87_), .c(new_n100_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n96_), .c(new_n90_), .d(new_n61_), .O(z12));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n87_), .c(new_n54_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai22  g64(.a(new_n110_), .b(new_n96_), .c(new_n90_), .d(new_n64_), .O(z13));
  aoi21  g65(.a(new_n109_), .b(new_n93_), .c(new_n69_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n107_), .c(new_n97_), .d(new_n84_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n89_), .b(x13), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n116_), .O(z14));
  oai21  g72(.a(x18), .b(x14), .c(new_n96_), .O(new_n119_));
  ...
  aoi22  g77(.a(new_n123_), .b(new_n101_), .c(new_n114_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n96_), .c(new_n119_), .O(z15));
  ...
  nand2  g88(.a(new_n89_), .b(x15), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  nand4  g90(.a(new_n127_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n137_));
  nand3  g91(.a(new_n126_), .b(x19), .c(new_n84_), .O(new_n138_));
