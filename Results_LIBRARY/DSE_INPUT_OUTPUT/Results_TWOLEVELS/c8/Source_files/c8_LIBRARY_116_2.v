...
module FAU ( 
  ...
  aoi22  g037(.a(new_n83_), .b(new_n81_), .c(new_n52_), .d(x05), .O(z06));
  ...
  nand3  g054(.a(new_n52_), .b(x09), .c(new_n93_), .O(new_n101_));
  ...
  oai21  g061(.a(new_n104_), .b(new_n55_), .c(new_n107_), .O(new_n108_));
  ...
  nand3  g065(.a(new_n52_), .b(x10), .c(new_n93_), .O(new_n112_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n53_), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z11));
  nand2  g074(.a(x18), .b(x03), .O(new_n121_));
  nand3  g075(.a(new_n52_), .b(x11), .c(new_n93_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n91_), .O(new_n124_));
  nand2  g078(.a(new_n117_), .b(x22), .O(new_n125_));
  nor2   g079(.a(x22), .b(x21), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n104_), .c(new_n55_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n53_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n124_), .O(z12));
  nand2  g084(.a(x18), .b(x04), .O(new_n131_));
  nand3  g085(.a(new_n52_), .b(x12), .c(new_n93_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n131_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n91_), .O(new_n134_));
  nand2  g088(.a(new_n127_), .b(x23), .O(new_n135_));
  ...
  nand2  g093(.a(new_n139_), .b(new_n134_), .O(z13));
  oai21  g094(.a(new_n52_), .b(new_n91_), .c(x05), .O(new_n141_));
  aoi21  g095(.a(new_n136_), .b(new_n115_), .c(new_n75_), .O(new_n142_));
  nor2   g096(.a(x24), .b(x23), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n126_), .c(new_n106_), .d(new_n105_), .O(new_n144_));
  inv1   g098(.a(new_n144_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n142_), .c(x16), .O(new_n146_));
  nand3  g100(.a(new_n52_), .b(new_n91_), .c(x13), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n146_), .c(new_n141_), .O(z14));
  nand2  g102(.a(x18), .b(x06), .O(new_n149_));
  nand3  g103(.a(new_n52_), .b(x14), .c(new_n93_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n91_), .O(new_n152_));
  nand2  g106(.a(new_n144_), .b(x25), .O(new_n153_));
  nor2   g107(.a(x23), .b(x22), .O(new_n154_));
  nor2   g108(.a(x25), .b(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n154_), .c(new_n116_), .d(new_n104_), .O(new_n156_));
  ...
  oai21  g114(.a(x18), .b(new_n87_), .c(new_n160_), .O(new_n161_));
  ...
  nand4  g118(.a(new_n164_), .b(new_n154_), .c(new_n116_), .d(new_n104_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(x16), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n162_), .c(new_n53_), .O(z16));
  nand4  g122(.a(new_n154_), .b(new_n85_), .c(new_n82_), .d(new_n75_), .O(new_n169_));
  nand3  g123(.a(new_n116_), .b(x19), .c(new_n105_), .O(new_n170_));
  oai22  g124(.a(new_n170_), .b(new_n169_), .c(new_n48_), .d(new_n105_), .O(new_n171_));
