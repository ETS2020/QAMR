...
module FAU ( 
  ...
  oai21  g031(.a(x18), .b(new_n48_), .c(new_n58_), .O(z08));
  ...
  oai21  g048(.a(new_n84_), .b(new_n92_), .c(new_n94_), .O(new_n95_));
  ...
  oai21  g060(.a(x16), .b(x11), .c(new_n79_), .O(new_n107_));
  inv1   g061(.a(x22), .O(new_n108_));
  aoi21  g062(.a(new_n102_), .b(new_n84_), .c(new_n108_), .O(new_n109_));
  ...
  nand2  g067(.a(new_n86_), .b(x03), .O(new_n114_));
  ...
  oai21  g078(.a(x16), .b(x13), .c(new_n79_), .O(new_n125_));
  inv1   g079(.a(x24), .O(new_n126_));
  aoi21  g080(.a(new_n120_), .b(new_n101_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n110_), .c(new_n93_), .d(new_n81_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n86_), .b(x05), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n125_), .O(z14));
  oai21  g087(.a(x16), .b(x14), .c(new_n79_), .O(new_n134_));
  nand2  g088(.a(new_n129_), .b(x25), .O(new_n135_));
  nor2   g089(.a(x23), .b(x22), .O(new_n136_));
  nor2   g090(.a(x25), .b(x24), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n102_), .d(new_n84_), .O(new_n138_));
  ...
  oai21  g096(.a(x16), .b(x15), .c(new_n79_), .O(new_n143_));
  nand2  g097(.a(new_n138_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n136_), .c(new_n102_), .d(new_n84_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand2  g102(.a(new_n86_), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n148_), .c(new_n143_), .O(z16));
  nor2   g104(.a(x26), .b(x25), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n136_), .c(new_n126_), .O(new_n152_));
  nand3  g106(.a(new_n102_), .b(x19), .c(new_n81_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n58_), .d(new_n81_), .O(new_n154_));
