...
module FAU ( 
  ...
  aoi21  g043(.a(new_n89_), .b(new_n86_), .c(new_n48_), .O(new_n90_));
  aoi21  g044(.a(new_n48_), .b(x00), .c(new_n90_), .O(new_n91_));
  nand3  g045(.a(new_n85_), .b(new_n48_), .c(x08), .O(new_n92_));
  oai21  g046(.a(new_n91_), .b(new_n85_), .c(new_n92_), .O(z09));
  ...
  oai21  g053(.a(new_n97_), .b(new_n54_), .c(new_n99_), .O(new_n100_));
  ...
  oai21  g066(.a(x16), .b(x11), .c(new_n85_), .O(new_n113_));
  aoi21  g067(.a(new_n108_), .b(new_n97_), .c(new_n63_), .O(new_n114_));
  ...
  nand3  g072(.a(x18), .b(new_n48_), .c(x03), .O(new_n119_));
  ...
  aoi21  g084(.a(new_n125_), .b(new_n107_), .c(new_n73_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n115_), .c(new_n98_), .d(new_n87_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand3  g089(.a(x18), .b(new_n48_), .c(x05), .O(new_n136_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n108_), .d(new_n97_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n108_), .d(new_n97_), .O(new_n153_));
  ...
  nand2  g110(.a(new_n68_), .b(new_n63_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n87_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n55_), .b(new_n87_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(x18), .c(new_n48_), .O(z17));
endmodule
