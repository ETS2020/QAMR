...
module FAU ( 
  ...
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n97_), .d(new_n81_), .O(new_n117_));
  ...
  oai21  g74(.a(new_n95_), .b(x06), .c(new_n86_), .O(new_n121_));
  ...
  oai21  g81(.a(new_n95_), .b(x07), .c(new_n86_), .O(new_n128_));
  ...
  nor2   g92(.a(new_n82_), .b(x17), .O(new_n139_));
