...
module FAU ( 
  ...
  oai21  g050(.a(new_n96_), .b(new_n55_), .c(new_n94_), .O(new_n97_));
  ...
  oai21  g055(.a(new_n87_), .b(new_n99_), .c(new_n101_), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n84_), .c(x16), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n98_), .O(z10));
  nand2  g058(.a(x18), .b(x02), .O(new_n105_));
  oai21  g059(.a(new_n96_), .b(new_n58_), .c(new_n105_), .O(new_n106_));
  ...
  aoi21  g070(.a(new_n109_), .b(new_n87_), .c(new_n65_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n87_), .c(new_n99_), .O(new_n119_));
  ...
  oai21  g077(.a(new_n96_), .b(new_n68_), .c(new_n123_), .O(new_n124_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n84_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n125_), .O(z13));
  aoi21  g085(.a(new_n127_), .b(new_n108_), .c(new_n71_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n118_), .c(new_n100_), .d(new_n85_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nor2   g090(.a(new_n95_), .b(x16), .O(new_n137_));
  aoi21  g091(.a(new_n137_), .b(x05), .c(new_n48_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n136_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n109_), .d(new_n87_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n109_), .d(new_n87_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n84_), .O(z16));
