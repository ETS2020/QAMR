...
module FAU ( 
  ...
  aoi21  g027(.a(x27), .b(new_n72_), .c(new_n73_), .O(new_n74_));
  oai22  g028(.a(new_n74_), .b(x14), .c(x27), .d(x25), .O(z06));
  ...
  nand3  g058(.a(new_n104_), .b(new_n99_), .c(new_n47_), .O(z11));
  ...
  inv1   g063(.a(new_n82_), .O(new_n110_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n108_), .c(new_n47_), .O(z12));
  ...
  oai21  g075(.a(new_n113_), .b(new_n119_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n47_), .O(z13));
  inv1   g078(.a(x05), .O(new_n125_));
  nand2  g079(.a(new_n73_), .b(x18), .O(new_n126_));
  oai22  g080(.a(new_n126_), .b(new_n125_), .c(x18), .d(new_n67_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n84_), .O(new_n128_));
  nand2  g082(.a(new_n121_), .b(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n111_), .c(new_n130_), .d(new_n80_), .O(new_n132_));
  ...
  nand3  g094(.a(new_n120_), .b(new_n73_), .c(new_n69_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n102_), .c(new_n140_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n139_), .c(new_n47_), .O(z15));
  inv1   g098(.a(x07), .O(new_n145_));
  oai22  g099(.a(new_n126_), .b(new_n145_), .c(x18), .d(new_n76_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n84_), .O(new_n147_));
  nand2  g101(.a(new_n132_), .b(x26), .O(new_n148_));
  nor2   g102(.a(x26), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n120_), .c(new_n101_), .d(new_n82_), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(new_n148_), .c(x25), .O(new_n151_));
  nand2  g105(.a(x26), .b(x25), .O(new_n152_));
  ...
  nand2  g109(.a(z08), .b(x17), .O(new_n156_));
  nor2   g110(.a(new_n51_), .b(x17), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n157_), .c(new_n120_), .d(new_n101_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n156_), .c(new_n84_), .O(z17));
endmodule
