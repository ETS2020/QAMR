...
module FAU ( 
  ...
  nor2   g053(.a(new_n99_), .b(new_n54_), .O(new_n100_));
  ...
  oai22  g058(.a(new_n90_), .b(new_n104_), .c(x18), .d(new_n58_), .O(new_n105_));
  ...
  oai22  g066(.a(new_n90_), .b(new_n112_), .c(x18), .d(new_n63_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n87_), .O(new_n114_));
  nand2  g068(.a(new_n108_), .b(x22), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n99_), .c(new_n54_), .O(new_n117_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n87_), .c(x12), .O(new_n127_));
  ...
  aoi21  g085(.a(new_n122_), .b(new_n101_), .c(new_n73_), .O(new_n132_));
  ...
  nand3  g092(.a(new_n138_), .b(new_n131_), .c(new_n48_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n99_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n107_), .d(new_n99_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n144_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n159_));
  nand3  g113(.a(new_n107_), .b(x19), .c(new_n133_), .O(new_n160_));
