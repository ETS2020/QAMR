...
module FAU ( 
  ...
  nand2  g37(.a(new_n55_), .b(new_n83_), .O(new_n84_));
  aoi21  g38(.a(new_n84_), .b(new_n82_), .c(new_n49_), .O(z07));
  inv1   g39(.a(new_n49_), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n55_), .O(z08));
  inv1   g41(.a(x17), .O(new_n88_));
  inv1   g42(.a(x19), .O(new_n89_));
  nor2   g43(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  ...
  oai21  g48(.a(new_n94_), .b(new_n47_), .c(new_n92_), .O(z09));
  inv1   g49(.a(x16), .O(new_n96_));
  oai21  g50(.a(x18), .b(x09), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(new_n91_), .b(new_n54_), .O(new_n98_));
  ...
  nand4  g57(.a(new_n60_), .b(new_n54_), .c(new_n89_), .d(new_n88_), .O(new_n104_));
  inv1   g58(.a(new_n104_), .O(new_n105_));
  aoi21  g59(.a(new_n103_), .b(x21), .c(new_n105_), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n96_), .c(new_n94_), .d(new_n58_), .O(z11));
  oai21  g61(.a(x18), .b(x11), .c(new_n96_), .O(new_n108_));
  nand2  g62(.a(new_n104_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n91_), .c(new_n54_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n96_), .c(new_n108_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n99_), .c(new_n111_), .d(x23), .O(new_n115_));
  oai22  g69(.a(new_n115_), .b(new_n96_), .c(new_n94_), .d(new_n66_), .O(z13));
  aoi21  g70(.a(new_n114_), .b(new_n99_), .c(new_n73_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n110_), .c(new_n102_), .d(new_n88_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  oai21  g74(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand2  g75(.a(new_n93_), .b(x13), .O(new_n122_));
  nand2  g76(.a(new_n122_), .b(new_n121_), .O(z14));
  inv1   g77(.a(x22), .O(new_n124_));
  nand4  g78(.a(new_n78_), .b(new_n73_), .c(new_n68_), .d(new_n124_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n105_), .c(new_n119_), .d(x25), .O(new_n127_));
  nand2  g81(.a(new_n93_), .b(x14), .O(new_n128_));
  oai21  g82(.a(new_n127_), .b(new_n96_), .c(new_n128_), .O(z15));
  oai21  g83(.a(x18), .b(x15), .c(new_n96_), .O(new_n130_));
  nor2   g84(.a(x21), .b(x20), .O(new_n131_));
  nor2   g85(.a(x23), .b(x22), .O(new_n132_));
  nor2   g86(.a(x25), .b(x24), .O(new_n133_));
  nand4  g87(.a(new_n133_), .b(new_n132_), .c(new_n131_), .d(new_n91_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x26), .O(new_n135_));
  nor3   g89(.a(x26), .b(x25), .c(x24), .O(new_n136_));
  nand4  g90(.a(new_n136_), .b(new_n132_), .c(new_n131_), .d(new_n91_), .O(new_n137_));
  ...
  nand4  g94(.a(new_n132_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n141_));
  nand3  g95(.a(new_n131_), .b(x19), .c(new_n88_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n55_), .d(new_n88_), .O(new_n143_));
  nand2  g97(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g98(.a(new_n144_), .b(new_n86_), .O(z17));
endmodule
