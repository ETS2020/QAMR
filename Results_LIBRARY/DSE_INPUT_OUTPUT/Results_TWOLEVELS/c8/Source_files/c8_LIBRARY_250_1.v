...
module FAU ( 
  ...
  nor2   g48(.a(new_n89_), .b(new_n57_), .O(new_n95_));
  ...
  oai22  g57(.a(new_n103_), .b(new_n91_), .c(new_n92_), .d(new_n60_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n89_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n91_), .c(new_n92_), .d(new_n65_), .O(z12));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n89_), .c(new_n57_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n96_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n91_), .c(new_n92_), .d(new_n70_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n91_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n96_), .c(new_n77_), .O(new_n114_));
  ...
  oai21  g73(.a(x18), .b(x14), .c(new_n91_), .O(new_n120_));
  ...
  oai21  g78(.a(new_n124_), .b(new_n91_), .c(new_n120_), .O(z15));
  ...
  nand3  g88(.a(new_n47_), .b(new_n91_), .c(x15), .O(new_n135_));
