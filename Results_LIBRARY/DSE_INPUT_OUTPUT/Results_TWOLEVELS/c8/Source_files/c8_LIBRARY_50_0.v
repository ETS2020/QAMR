...
module FAU ( 
  ...
  oai21  g030(.a(x27), .b(new_n76_), .c(new_n75_), .O(new_n77_));
  ...
  nand2  g041(.a(new_n76_), .b(x14), .O(new_n88_));
  ...
  oai21  g053(.a(new_n97_), .b(new_n53_), .c(new_n99_), .O(new_n100_));
  ...
  oai21  g057(.a(new_n88_), .b(new_n57_), .c(new_n103_), .O(new_n104_));
  ...
  oai21  g062(.a(new_n98_), .b(new_n106_), .c(new_n108_), .O(new_n109_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n97_), .c(new_n53_), .O(new_n117_));
  oai21  g071(.a(new_n115_), .b(new_n62_), .c(new_n117_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n84_), .O(z12));
  ...
  and2   g077(.a(new_n117_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n106_), .O(new_n126_));
  nor2   g080(.a(new_n126_), .b(new_n99_), .O(new_n127_));
  ...
  nand4  g086(.a(new_n116_), .b(new_n98_), .c(new_n72_), .d(new_n67_), .O(new_n133_));
  oai21  g087(.a(new_n127_), .b(new_n72_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n132_), .c(new_n84_), .O(z14));
  ...
  oai21  g093(.a(new_n76_), .b(new_n86_), .c(new_n88_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n133_), .c(x25), .O(new_n141_));
  inv1   g095(.a(x17), .O(new_n142_));
  inv1   g096(.a(x19), .O(new_n143_));
  aoi21  g097(.a(new_n76_), .b(new_n75_), .c(x25), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n145_));
  nor3   g099(.a(new_n145_), .b(x21), .c(x20), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n143_), .c(new_n142_), .d(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n139_), .O(z15));
  nand2  g102(.a(x18), .b(x07), .O(new_n149_));
  nand3  g103(.a(new_n76_), .b(x15), .c(x14), .O(new_n150_));
  ...
  nand2  g107(.a(new_n153_), .b(new_n125_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n108_), .c(x26), .O(new_n155_));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n125_), .c(new_n72_), .O(new_n157_));
  ...
  nand3  g114(.a(new_n107_), .b(x19), .c(new_n142_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n157_), .c(new_n54_), .d(new_n142_), .O(new_n162_));
