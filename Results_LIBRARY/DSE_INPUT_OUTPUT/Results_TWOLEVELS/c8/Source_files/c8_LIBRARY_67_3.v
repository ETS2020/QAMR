...
module FAU ( 
  ...
  nand3  g033(.a(new_n55_), .b(new_n77_), .c(new_n79_), .O(new_n80_));
  nand2  g034(.a(new_n80_), .b(new_n78_), .O(z06));
  inv1   g035(.a(x15), .O(new_n82_));
  aoi21  g036(.a(x27), .b(new_n82_), .c(new_n49_), .O(new_n83_));
  ...
  nand2  g041(.a(x18), .b(new_n76_), .O(new_n88_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n92_), .c(new_n54_), .O(new_n118_));
  ...
  aoi21  g087(.a(new_n126_), .b(new_n101_), .c(new_n73_), .O(new_n134_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n133_), .c(new_n48_), .O(z14));
  inv1   g095(.a(x06), .O(new_n142_));
  nand2  g096(.a(new_n79_), .b(x14), .O(new_n143_));
  oai21  g097(.a(new_n88_), .b(new_n142_), .c(new_n143_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n107_), .d(new_n92_), .O(new_n149_));
  ...
  oai22  g107(.a(new_n88_), .b(new_n153_), .c(x18), .d(new_n82_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n107_), .d(new_n92_), .O(new_n158_));
  ...
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n55_), .d(new_n135_), .O(new_n165_));
