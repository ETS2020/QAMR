...
module FAU ( 
  ...
  nand2  g059(.a(new_n87_), .b(x02), .O(new_n106_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n85_), .c(new_n93_), .O(new_n113_));
  ...
  nand2  g075(.a(new_n121_), .b(new_n101_), .O(new_n122_));
  ...
  aoi21  g080(.a(new_n121_), .b(new_n101_), .c(new_n71_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n112_), .c(new_n94_), .d(new_n83_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n127_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n87_), .b(x05), .O(new_n132_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n102_), .d(new_n85_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n87_), .b(x06), .O(new_n141_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n136_), .c(new_n102_), .d(new_n85_), .O(new_n146_));
  ...
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n83_), .O(new_n157_));
