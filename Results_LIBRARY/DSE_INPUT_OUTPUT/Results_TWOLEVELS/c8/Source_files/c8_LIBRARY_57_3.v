...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(new_n95_), .c(new_n48_), .O(z10));
  ...
  nor2   g068(.a(new_n114_), .b(new_n89_), .O(new_n115_));
  ...
  oai21  g076(.a(new_n115_), .b(new_n66_), .c(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n120_), .c(new_n48_), .O(z13));
  inv1   g079(.a(x05), .O(new_n126_));
  oai22  g080(.a(new_n84_), .b(new_n126_), .c(x18), .d(new_n69_), .O(new_n127_));
  ...
  nand2  g087(.a(new_n133_), .b(new_n129_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n48_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n128_), .O(z14));
  inv1   g090(.a(x06), .O(new_n137_));
  oai22  g091(.a(new_n84_), .b(new_n137_), .c(x18), .d(new_n74_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n81_), .O(new_n139_));
  nand2  g093(.a(new_n133_), .b(x25), .O(new_n140_));
  nand3  g094(.a(new_n121_), .b(new_n83_), .c(new_n71_), .O(new_n141_));
  oai22  g095(.a(new_n141_), .b(new_n105_), .c(new_n140_), .d(x18), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n139_), .O(z15));
  inv1   g098(.a(x07), .O(new_n145_));
  oai22  g099(.a(new_n84_), .b(new_n145_), .c(x18), .d(new_n77_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n81_), .O(new_n147_));
  nand2  g101(.a(new_n133_), .b(x26), .O(new_n148_));
  nor2   g102(.a(x26), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n121_), .c(new_n104_), .d(new_n88_), .O(new_n150_));
  ...
  inv1   g110(.a(x19), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(x17), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n158_), .c(new_n121_), .d(new_n104_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n156_), .c(new_n81_), .O(z17));
endmodule
