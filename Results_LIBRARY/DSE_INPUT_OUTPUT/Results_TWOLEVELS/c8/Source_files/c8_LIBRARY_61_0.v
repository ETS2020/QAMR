...
module FAU ( 
  ...
  nand2  g45(.a(new_n85_), .b(x01), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n91_), .O(z10));
  ...
  nand2  g60(.a(new_n85_), .b(x03), .O(new_n107_));
  oai21  g61(.a(new_n106_), .b(new_n94_), .c(new_n107_), .O(z12));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n90_), .c(new_n105_), .d(x23), .O(new_n110_));
  nand2  g64(.a(new_n85_), .b(x04), .O(new_n111_));
  oai21  g65(.a(new_n110_), .b(new_n94_), .c(new_n111_), .O(z13));
  aoi21  g66(.a(new_n109_), .b(new_n90_), .c(new_n68_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n104_), .c(new_n95_), .d(new_n80_), .O(new_n115_));
  inv1   g69(.a(new_n115_), .O(new_n116_));
  oai21  g70(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g71(.a(new_n85_), .b(x05), .O(new_n118_));
  nand2  g72(.a(new_n118_), .b(new_n117_), .O(z14));
  inv1   g73(.a(x22), .O(new_n120_));
  inv1   g74(.a(x23), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n68_), .c(new_n121_), .d(new_n120_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n99_), .c(new_n115_), .d(x25), .O(new_n125_));
  nand2  g79(.a(new_n85_), .b(x06), .O(new_n126_));
  oai21  g80(.a(new_n125_), .b(new_n94_), .c(new_n126_), .O(z15));
  ...
  nand2  g90(.a(new_n85_), .b(x07), .O(new_n137_));
  ...
  aoi21  g95(.a(new_n141_), .b(new_n140_), .c(new_n94_), .O(z17));
endmodule
