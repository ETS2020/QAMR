...
module FAU ( 
  ...
  aoi21  g026(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n73_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n104_), .c(new_n84_), .O(z11));
  ...
  nand3  g081(.a(new_n97_), .b(new_n51_), .c(new_n85_), .O(new_n128_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n114_), .c(new_n131_), .d(new_n85_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n84_), .c(x16), .O(new_n135_));
  nand3  g089(.a(x18), .b(new_n89_), .c(x05), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n135_), .O(z14));
  nand2  g091(.a(x18), .b(x06), .O(new_n138_));
  inv1   g092(.a(x18), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(x14), .c(new_n47_), .O(new_n140_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n123_), .c(new_n105_), .d(new_n87_), .O(new_n145_));
  ...
  nand3  g103(.a(new_n139_), .b(x15), .c(new_n47_), .O(new_n150_));
