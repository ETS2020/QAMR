...
module FAU ( 
  ...
  nor2   g44(.a(new_n84_), .b(new_n53_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n97_), .b(new_n53_), .c(new_n82_), .d(new_n81_), .O(new_n98_));
  ...
  nand3  g59(.a(new_n105_), .b(new_n84_), .c(new_n53_), .O(new_n106_));
  and2   g60(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand2  g61(.a(new_n101_), .b(x03), .O(new_n108_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n105_), .c(new_n95_), .d(new_n81_), .O(new_n118_));
  ...
  aoi22  g79(.a(new_n125_), .b(new_n99_), .c(new_n118_), .d(x25), .O(new_n126_));
  ...
  nand2  g90(.a(new_n101_), .b(x07), .O(new_n137_));
  ...
  nand3  g94(.a(new_n128_), .b(x19), .c(new_n81_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n54_), .d(new_n81_), .O(new_n142_));
