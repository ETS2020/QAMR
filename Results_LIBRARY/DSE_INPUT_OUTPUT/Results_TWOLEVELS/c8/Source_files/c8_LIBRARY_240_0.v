...
module FAU ( 
  ...
  nand4  g55(.a(new_n101_), .b(new_n53_), .c(new_n84_), .d(new_n83_), .O(new_n102_));
  ...
  oai21  g64(.a(new_n109_), .b(new_n97_), .c(new_n110_), .O(z12));
  oai21  g65(.a(new_n88_), .b(x04), .c(new_n97_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n97_), .c(new_n112_), .O(z13));
  inv1   g69(.a(x24), .O(new_n116_));
  aoi21  g70(.a(new_n113_), .b(new_n93_), .c(new_n116_), .O(new_n117_));
  ...
  oai21  g77(.a(new_n88_), .b(x06), .c(new_n97_), .O(new_n124_));
  nand4  g78(.a(new_n75_), .b(new_n116_), .c(new_n67_), .d(new_n62_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n103_), .c(new_n119_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n97_), .c(new_n124_), .O(z15));
  ...
  nand3  g94(.a(new_n140_), .b(new_n130_), .c(new_n116_), .O(new_n141_));
