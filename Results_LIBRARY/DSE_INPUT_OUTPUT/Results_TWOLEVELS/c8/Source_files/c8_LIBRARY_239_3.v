...
module FAU ( 
  ...
  nand3  g048(.a(new_n54_), .b(new_n83_), .c(new_n82_), .O(new_n95_));
  oai21  g049(.a(new_n85_), .b(new_n54_), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n94_), .c(x16), .O(new_n97_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n103_), .c(new_n102_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand2  g077(.a(new_n87_), .b(x12), .O(new_n124_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n110_), .c(new_n102_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n95_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n112_), .c(new_n132_), .d(new_n82_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n94_), .c(x16), .O(new_n136_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n104_), .d(new_n85_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n87_), .b(x14), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n104_), .d(new_n85_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n94_), .c(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z16));
  nand2  g108(.a(new_n129_), .b(new_n110_), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n74_), .c(new_n69_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n104_), .b(x19), .c(new_n82_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n55_), .b(new_n82_), .O(new_n161_));
