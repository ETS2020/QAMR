...
module FAU ( 
  ...
  oai22  g056(.a(new_n93_), .b(new_n102_), .c(x18), .d(new_n55_), .O(new_n103_));
  ...
  aoi21  g068(.a(new_n106_), .b(new_n84_), .c(new_n114_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n84_), .c(new_n96_), .O(new_n117_));
  ...
  nand2  g074(.a(new_n117_), .b(x23), .O(new_n121_));
  nor3   g075(.a(x23), .b(x22), .c(x21), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n105_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n48_), .c(x16), .O(new_n125_));
  inv1   g079(.a(x18), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n86_), .c(x12), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(z13));
  ...
  aoi21  g086(.a(new_n122_), .b(new_n105_), .c(new_n132_), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n116_), .c(new_n97_), .d(new_n81_), .O(new_n135_));
  ...
  oai22  g093(.a(new_n139_), .b(x04), .c(x18), .d(new_n72_), .O(new_n140_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n84_), .O(new_n145_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n106_), .d(new_n84_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n81_), .O(new_n160_));
