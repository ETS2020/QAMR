...
module FAU ( 
  ...
  nor2   g006(.a(new_n52_), .b(x07), .O(new_n53_));
  ...
  nand2  g051(.a(x18), .b(x07), .O(new_n98_));
  ...
  oai21  g057(.a(new_n90_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n90_), .c(new_n65_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n90_), .c(new_n101_), .O(new_n121_));
  ...
  oai22  g079(.a(new_n98_), .b(new_n125_), .c(x18), .d(new_n68_), .O(new_n126_));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n110_), .c(new_n75_), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n120_), .c(new_n102_), .d(new_n88_), .O(new_n139_));
  inv1   g093(.a(new_n139_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(new_n86_), .O(z14));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n111_), .d(new_n90_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n86_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n145_), .O(z15));
  oai21  g106(.a(x18), .b(x15), .c(new_n92_), .O(new_n153_));
  nand2  g107(.a(new_n149_), .b(x26), .O(new_n154_));
  nor3   g108(.a(x26), .b(x25), .c(x24), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n147_), .c(new_n111_), .d(new_n90_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n153_), .c(new_n86_), .O(z16));
  nor2   g113(.a(x26), .b(x25), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n147_), .c(new_n75_), .O(new_n161_));
  nand3  g115(.a(new_n111_), .b(x19), .c(new_n88_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n50_), .d(new_n88_), .O(new_n163_));
