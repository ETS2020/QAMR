...
module FAU ( 
  ...
  nor2   g051(.a(new_n89_), .b(new_n97_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n52_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n52_), .O(z11));
  ...
  aoi21  g067(.a(new_n106_), .b(new_n89_), .c(new_n63_), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n89_), .c(new_n97_), .O(new_n116_));
  ...
  nand2  g073(.a(new_n116_), .b(x23), .O(new_n120_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n52_), .c(x16), .O(new_n124_));
  inv1   g078(.a(x18), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n83_), .c(x12), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(z13));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n106_), .d(new_n89_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n52_), .O(z15));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n106_), .d(new_n89_), .O(new_n154_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n71_), .O(new_n159_));
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n132_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n50_), .d(new_n132_), .O(new_n161_));
