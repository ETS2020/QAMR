...
module FAU ( 
  ...
  aoi21  g028(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n75_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n48_), .c(x11), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand2  g059(.a(new_n105_), .b(new_n82_), .O(new_n106_));
  nand2  g060(.a(new_n98_), .b(x22), .O(new_n107_));
  nor2   g061(.a(x22), .b(x21), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n80_), .c(new_n54_), .O(new_n109_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n97_), .d(new_n80_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n136_), .c(new_n77_), .O(z15));
  nand2  g097(.a(new_n140_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n138_), .c(new_n97_), .d(new_n80_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nor2   g102(.a(new_n103_), .b(x16), .O(new_n149_));
  aoi21  g103(.a(new_n149_), .b(x07), .c(new_n49_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(z16));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n138_), .c(new_n125_), .O(new_n153_));
  nand3  g107(.a(new_n97_), .b(x19), .c(new_n127_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n55_), .d(new_n127_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n77_), .c(x16), .O(new_n156_));
