...
module FAU ( 
  ...
  nand3  g046(.a(x18), .b(new_n47_), .c(x00), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n92_), .c(new_n88_), .O(z09));
  oai21  g048(.a(x16), .b(x09), .c(new_n87_), .O(new_n95_));
  inv1   g049(.a(x20), .O(new_n96_));
  nor2   g050(.a(new_n91_), .b(new_n96_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand3  g053(.a(x18), .b(new_n47_), .c(x01), .O(new_n100_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n91_), .c(new_n96_), .O(new_n115_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n98_), .c(new_n60_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n96_), .b(new_n51_), .c(new_n89_), .O(new_n131_));
  inv1   g085(.a(x23), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n65_), .c(new_n60_), .O(new_n133_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n123_), .c(new_n105_), .d(new_n91_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n123_), .c(new_n105_), .d(new_n91_), .O(new_n155_));
  ...
  nand4  g112(.a(new_n123_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n159_));
  nand3  g113(.a(new_n105_), .b(x19), .c(new_n89_), .O(new_n160_));
