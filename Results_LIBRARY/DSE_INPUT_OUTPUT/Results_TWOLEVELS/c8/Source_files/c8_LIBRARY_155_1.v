...
module FAU ( 
  ...
  nand4  g66(.a(new_n112_), .b(new_n104_), .c(new_n95_), .d(new_n83_), .O(new_n113_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n110_), .c(new_n118_), .d(new_n67_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  aoi22  g75(.a(new_n121_), .b(new_n98_), .c(new_n113_), .d(x25), .O(new_n122_));
  oai21  g76(.a(new_n122_), .b(new_n87_), .c(new_n117_), .O(z15));
  ...
  inv1   g88(.a(new_n48_), .O(new_n135_));
  nor2   g89(.a(x26), .b(x25), .O(new_n136_));
  nand3  g90(.a(new_n136_), .b(new_n126_), .c(new_n110_), .O(new_n137_));
  nand3  g91(.a(new_n125_), .b(x19), .c(new_n83_), .O(new_n138_));
  oai22  g92(.a(new_n138_), .b(new_n137_), .c(new_n52_), .d(new_n83_), .O(new_n139_));
