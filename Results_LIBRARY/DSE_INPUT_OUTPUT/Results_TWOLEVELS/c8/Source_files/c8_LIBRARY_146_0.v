...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(x09), .c(x07), .O(new_n98_));
  ...
  oai21  g057(.a(new_n89_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n85_), .c(x16), .O(new_n105_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n59_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n85_), .O(z11));
  ...
  aoi21  g072(.a(new_n111_), .b(new_n89_), .c(new_n64_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n97_), .b(x12), .c(x07), .O(new_n126_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n85_), .c(x16), .O(new_n133_));
  ...
  aoi21  g091(.a(new_n130_), .b(new_n110_), .c(new_n74_), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n120_), .c(new_n102_), .d(new_n87_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n138_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n137_), .c(new_n85_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  nand3  g098(.a(new_n97_), .b(x14), .c(x07), .O(new_n145_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n149_), .c(new_n111_), .d(new_n89_), .O(new_n151_));
  ...
  nand2  g108(.a(new_n97_), .b(new_n82_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n91_), .c(x07), .O(new_n156_));
  nand2  g110(.a(new_n151_), .b(x26), .O(new_n157_));
  nor3   g111(.a(x26), .b(x25), .c(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n149_), .c(new_n111_), .d(new_n89_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n156_), .c(new_n85_), .O(z16));
  nor2   g116(.a(x26), .b(x25), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n149_), .c(new_n74_), .O(new_n164_));
  nand3  g118(.a(new_n111_), .b(x19), .c(new_n87_), .O(new_n165_));
