...
module FAU ( 
  ...
  nor2   g000(.a(x18), .b(x12), .O(new_n47_));
  ...
  aoi21  g021(.a(new_n67_), .b(new_n65_), .c(new_n47_), .O(z03));
  inv1   g022(.a(x18), .O(new_n69_));
  inv1   g023(.a(x12), .O(new_n70_));
  nor2   g024(.a(x27), .b(x23), .O(new_n71_));
  aoi21  g025(.a(x27), .b(new_n70_), .c(new_n71_), .O(new_n72_));
  nand2  g026(.a(new_n71_), .b(x12), .O(new_n73_));
  oai21  g027(.a(new_n72_), .b(new_n69_), .c(new_n73_), .O(z04));
  ...
  aoi21  g038(.a(new_n84_), .b(new_n82_), .c(new_n47_), .O(z07));
  inv1   g039(.a(new_n47_), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(new_n51_), .O(z08));
  inv1   g041(.a(x16), .O(new_n88_));
  nand2  g042(.a(x18), .b(x00), .O(new_n89_));
  nand2  g043(.a(new_n69_), .b(x12), .O(new_n90_));
  oai21  g044(.a(new_n90_), .b(new_n48_), .c(new_n89_), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n88_), .O(new_n92_));
  xnor2a g046(.a(x19), .b(x17), .O(new_n93_));
  nand3  g047(.a(new_n93_), .b(new_n86_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n92_), .O(z09));
  nand2  g049(.a(x18), .b(x01), .O(new_n96_));
  oai21  g050(.a(new_n90_), .b(new_n54_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g056(.a(new_n99_), .b(new_n56_), .c(new_n102_), .O(new_n103_));
  ...
  nand2  g061(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  ...
  oai21  g077(.a(new_n69_), .b(x04), .c(new_n88_), .O(new_n124_));
  nand2  g078(.a(new_n120_), .b(x23), .O(new_n125_));
  nor3   g079(.a(x23), .b(x22), .c(x21), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n109_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(x16), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n124_), .c(new_n86_), .O(z13));
  ...
  aoi21  g088(.a(new_n126_), .b(new_n109_), .c(new_n134_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n119_), .c(new_n101_), .d(new_n100_), .O(new_n137_));
  inv1   g091(.a(new_n137_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n135_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n133_), .c(new_n86_), .O(z14));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n110_), .d(new_n99_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n86_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n69_), .b(x15), .c(x12), .O(new_n152_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n145_), .c(new_n110_), .d(new_n99_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n86_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n154_), .O(z16));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n145_), .c(new_n134_), .O(new_n162_));
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n100_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n51_), .d(new_n100_), .O(new_n164_));
