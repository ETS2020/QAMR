...
module FAU ( 
  ...
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n103_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n96_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n114_), .c(new_n135_), .d(new_n94_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n92_), .c(x16), .O(new_n139_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n123_), .c(new_n105_), .d(new_n93_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n92_), .b(new_n86_), .c(x14), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n123_), .c(new_n105_), .d(new_n93_), .O(new_n154_));
  ...
  nand2  g111(.a(new_n132_), .b(new_n131_), .O(new_n158_));
  nand3  g112(.a(new_n79_), .b(new_n74_), .c(new_n69_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n105_), .b(x19), .c(new_n94_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n55_), .b(new_n94_), .O(new_n163_));
  aoi21  g117(.a(new_n162_), .b(new_n160_), .c(new_n163_), .O(new_n164_));
  aoi21  g118(.a(new_n164_), .b(new_n92_), .c(new_n86_), .O(z17));
endmodule
