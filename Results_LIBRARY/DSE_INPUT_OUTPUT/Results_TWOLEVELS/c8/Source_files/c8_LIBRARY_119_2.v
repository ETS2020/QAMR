...
module FAU ( 
  ...
  nor2   g041(.a(new_n83_), .b(x16), .O(new_n88_));
  nand2  g042(.a(new_n88_), .b(x00), .O(new_n89_));
  nand3  g043(.a(new_n89_), .b(new_n87_), .c(new_n84_), .O(z09));
  ...
  nand4  g091(.a(new_n137_), .b(new_n136_), .c(new_n102_), .d(new_n86_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(x16), .O(new_n140_));
  nand2  g094(.a(new_n88_), .b(x06), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n102_), .d(new_n86_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n136_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n152_));
  nand3  g106(.a(new_n102_), .b(x19), .c(new_n126_), .O(new_n153_));
  oai22  g107(.a(new_n153_), .b(new_n152_), .c(new_n61_), .d(new_n126_), .O(new_n154_));
