...
module FAU ( 
  ...
  nand2  g047(.a(x18), .b(new_n74_), .O(new_n94_));
  ...
  oai22  g057(.a(new_n94_), .b(new_n103_), .c(x18), .d(new_n55_), .O(new_n104_));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n86_), .c(new_n63_), .O(new_n115_));
  ...
  nand4  g089(.a(new_n135_), .b(new_n116_), .c(new_n98_), .d(new_n83_), .O(new_n136_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n86_), .O(new_n146_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n144_), .c(new_n107_), .d(new_n86_), .O(new_n155_));
  ...
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n58_), .d(new_n83_), .O(new_n162_));
