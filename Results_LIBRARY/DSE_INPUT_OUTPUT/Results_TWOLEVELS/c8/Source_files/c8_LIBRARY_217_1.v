...
module FAU ( 
  ...
  aoi22  g57(.a(new_n103_), .b(new_n85_), .c(new_n98_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n87_), .c(new_n101_), .d(new_n63_), .O(z12));
  oai21  g59(.a(x18), .b(x12), .c(new_n87_), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n85_), .c(new_n91_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n87_), .c(new_n106_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n87_), .O(new_n112_));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n109_), .b(new_n93_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n107_), .c(new_n96_), .d(new_n83_), .O(new_n116_));
  ...
  nand4  g76(.a(new_n122_), .b(new_n113_), .c(new_n68_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n99_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n87_), .c(new_n120_), .O(z15));
  oai21  g80(.a(x18), .b(x15), .c(new_n87_), .O(new_n127_));
  ...
  nand4  g92(.a(new_n129_), .b(new_n79_), .c(new_n122_), .d(new_n113_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n83_), .O(new_n140_));
