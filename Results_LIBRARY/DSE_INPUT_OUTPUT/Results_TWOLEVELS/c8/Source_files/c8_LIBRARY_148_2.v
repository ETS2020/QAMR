...
module FAU ( 
  ...
  oai21  g059(.a(new_n103_), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(x18), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n102_), .O(z11));
  oai21  g062(.a(x16), .b(x11), .c(new_n81_), .O(new_n109_));
  aoi21  g063(.a(new_n104_), .b(new_n94_), .c(new_n63_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n94_), .c(new_n93_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nor2   g068(.a(new_n81_), .b(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x03), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n114_), .c(new_n109_), .O(z12));
  ...
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n104_), .d(new_n94_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n115_), .b(x06), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n138_), .c(new_n104_), .d(new_n94_), .O(new_n150_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n138_), .c(new_n128_), .O(new_n155_));
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n83_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n58_), .d(new_n83_), .O(new_n157_));
