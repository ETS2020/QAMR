...
module FAU ( 
  ...
  nor2   g059(.a(new_n98_), .b(new_n56_), .O(new_n106_));
  ...
  oai21  g063(.a(x18), .b(new_n63_), .c(new_n94_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n92_), .O(new_n111_));
  inv1   g065(.a(x17), .O(new_n112_));
  nand3  g066(.a(new_n56_), .b(new_n49_), .c(new_n112_), .O(new_n113_));
  oai21  g067(.a(x18), .b(new_n92_), .c(new_n94_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n113_), .c(x21), .O(new_n115_));
  nand4  g069(.a(new_n53_), .b(new_n61_), .c(new_n56_), .d(new_n49_), .O(new_n116_));
  inv1   g070(.a(new_n116_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n112_), .c(x16), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n115_), .c(new_n111_), .O(z11));
  ...
  nand3  g088(.a(new_n134_), .b(new_n107_), .c(new_n61_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n132_), .c(new_n53_), .O(z13));
  nand3  g092(.a(x18), .b(x05), .c(x02), .O(new_n139_));
  oai21  g093(.a(x18), .b(new_n76_), .c(new_n139_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n92_), .O(new_n141_));
  nand3  g095(.a(new_n73_), .b(new_n66_), .c(new_n61_), .O(new_n142_));
  oai21  g096(.a(new_n142_), .b(new_n113_), .c(x24), .O(new_n143_));
  nor2   g097(.a(x20), .b(x19), .O(new_n144_));
  nor2   g098(.a(x24), .b(x23), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n125_), .c(new_n144_), .d(new_n112_), .O(new_n146_));
  ...
  nand3  g103(.a(x18), .b(x06), .c(x02), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n134_), .c(new_n123_), .d(new_n98_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n53_), .c(x16), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n152_), .O(z15));
  ...
  nand4  g117(.a(new_n163_), .b(new_n134_), .c(new_n123_), .d(new_n98_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n161_), .c(new_n53_), .O(z16));
  nand4  g121(.a(new_n134_), .b(new_n88_), .c(new_n83_), .d(new_n78_), .O(new_n168_));
  nand3  g122(.a(new_n123_), .b(x19), .c(new_n112_), .O(new_n169_));
  oai22  g123(.a(new_n169_), .b(new_n168_), .c(new_n50_), .d(new_n112_), .O(new_n170_));
  nand3  g124(.a(new_n170_), .b(new_n53_), .c(x16), .O(new_n171_));
  inv1   g125(.a(new_n171_), .O(z17));
endmodule
