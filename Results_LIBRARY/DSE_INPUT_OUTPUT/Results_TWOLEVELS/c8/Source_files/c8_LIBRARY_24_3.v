...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(new_n79_), .O(new_n93_));
  oai22  g047(.a(new_n93_), .b(new_n92_), .c(x18), .d(new_n55_), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n87_), .O(new_n95_));
  nand3  g049(.a(new_n57_), .b(new_n51_), .c(new_n83_), .O(new_n96_));
  oai21  g050(.a(new_n85_), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n47_), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n95_), .O(z10));
  inv1   g053(.a(x02), .O(new_n100_));
  oai22  g054(.a(new_n93_), .b(new_n100_), .c(x18), .d(new_n60_), .O(new_n101_));
  ...
  aoi21  g066(.a(new_n104_), .b(new_n85_), .c(new_n112_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n85_), .c(new_n57_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n111_), .c(new_n47_), .O(z12));
  inv1   g072(.a(x04), .O(new_n119_));
  oai22  g073(.a(new_n93_), .b(new_n119_), .c(x18), .d(new_n68_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n87_), .O(new_n121_));
  nand2  g075(.a(new_n115_), .b(x23), .O(new_n122_));
  nor2   g076(.a(x23), .b(x22), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n103_), .c(new_n62_), .O(new_n124_));
  ...
  oai22  g082(.a(new_n93_), .b(new_n128_), .c(x18), .d(new_n73_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n87_), .O(new_n130_));
  nand3  g084(.a(new_n70_), .b(new_n112_), .c(new_n62_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n96_), .c(x24), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n114_), .c(new_n133_), .d(new_n83_), .O(new_n135_));
  ...
  oai22  g093(.a(new_n93_), .b(new_n139_), .c(x18), .d(new_n76_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n87_), .O(new_n141_));
  nand2  g095(.a(new_n135_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n123_), .c(new_n104_), .d(new_n85_), .O(new_n144_));
  ...
  nand3  g101(.a(x18), .b(new_n79_), .c(x07), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n123_), .c(new_n104_), .d(new_n85_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n47_), .c(x16), .O(new_n155_));
  ...
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n83_), .O(new_n161_));
