...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n51_), .c(new_n87_), .O(new_n98_));
  oai21  g052(.a(new_n89_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  ...
  aoi21  g066(.a(new_n107_), .b(new_n89_), .c(new_n63_), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n89_), .c(new_n97_), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  oai21  g070(.a(new_n116_), .b(new_n113_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n91_), .b(x03), .O(new_n118_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n106_), .c(new_n105_), .O(new_n125_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n63_), .c(new_n105_), .O(new_n133_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n124_), .c(new_n107_), .d(new_n89_), .O(new_n146_));
