...
module FAU ( 
  ...
  aoi21  g014(.a(x27), .b(new_n48_), .c(new_n49_), .O(new_n61_));
  ...
  nand3  g041(.a(new_n87_), .b(new_n83_), .c(new_n79_), .O(z09));
  nand2  g042(.a(x18), .b(x01), .O(new_n89_));
  inv1   g043(.a(x18), .O(new_n90_));
  nand2  g044(.a(new_n90_), .b(new_n48_), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n52_), .c(new_n89_), .O(new_n92_));
  ...
  oai21  g051(.a(new_n82_), .b(new_n94_), .c(new_n97_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n79_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n93_), .O(z10));
  nand2  g054(.a(x18), .b(x02), .O(new_n101_));
  oai21  g055(.a(new_n91_), .b(new_n55_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g063(.a(new_n106_), .b(x22), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n82_), .c(new_n94_), .O(new_n112_));
  and2   g066(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nor2   g067(.a(new_n90_), .b(x16), .O(new_n114_));
  aoi21  g068(.a(new_n114_), .b(x03), .c(new_n49_), .O(new_n115_));
  oai21  g069(.a(new_n113_), .b(new_n84_), .c(new_n115_), .O(z12));
  nand2  g070(.a(x18), .b(x04), .O(new_n117_));
  nand3  g071(.a(new_n90_), .b(x12), .c(new_n48_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n84_), .O(new_n120_));
  nand2  g074(.a(new_n112_), .b(x23), .O(new_n121_));
  nor3   g075(.a(x23), .b(x22), .c(x21), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n104_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n79_), .c(x16), .O(new_n125_));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n104_), .c(new_n68_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n111_), .c(new_n96_), .d(new_n95_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n129_), .c(new_n79_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n105_), .d(new_n82_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n79_), .O(z15));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n105_), .d(new_n82_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n79_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n140_), .c(new_n68_), .O(new_n156_));
  nand3  g110(.a(new_n105_), .b(x19), .c(new_n95_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n58_), .d(new_n95_), .O(new_n158_));
