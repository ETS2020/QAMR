...
module FAU ( 
  ...
  oai21  g047(.a(x16), .b(x09), .c(new_n85_), .O(new_n94_));
  ...
  nand2  g052(.a(new_n91_), .b(x01), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n98_), .c(new_n94_), .O(z10));
  oai21  g054(.a(x16), .b(x10), .c(new_n85_), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n89_), .O(new_n103_));
  oai21  g057(.a(new_n97_), .b(new_n60_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nand2  g059(.a(new_n91_), .b(x02), .O(new_n106_));
  ...
  nand2  g063(.a(new_n109_), .b(new_n47_), .O(new_n110_));
  nand2  g064(.a(new_n103_), .b(x22), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n89_), .c(new_n95_), .O(new_n113_));
  ...
  nand3  g081(.a(new_n95_), .b(new_n51_), .c(new_n87_), .O(new_n128_));
  inv1   g082(.a(x22), .O(new_n129_));
  nand3  g083(.a(new_n68_), .b(new_n129_), .c(new_n60_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n128_), .c(x24), .O(new_n131_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n119_), .c(new_n102_), .d(new_n89_), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n119_), .c(new_n102_), .d(new_n89_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand2  g106(.a(new_n91_), .b(x07), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n147_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n119_), .c(new_n73_), .O(new_n156_));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n87_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n52_), .d(new_n87_), .O(new_n158_));
