...
module FAU ( 
  ...
  nand2  g070(.a(new_n107_), .b(x23), .O(new_n117_));
  nor2   g071(.a(x23), .b(x22), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n91_), .c(new_n96_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n116_), .c(x16), .O(new_n121_));
  ...
  nand2  g078(.a(new_n124_), .b(new_n112_), .O(new_n125_));
  nand3  g079(.a(new_n57_), .b(new_n51_), .c(new_n82_), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n104_), .c(new_n96_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n126_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n106_), .c(new_n130_), .d(new_n82_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n116_), .c(x16), .O(new_n134_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n118_), .c(new_n97_), .d(new_n84_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n86_), .b(x14), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n118_), .c(new_n97_), .d(new_n84_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n86_), .b(x15), .O(new_n150_));
  ...
  nand3  g108(.a(new_n97_), .b(x19), .c(new_n82_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n82_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n116_), .c(x16), .O(new_n157_));
