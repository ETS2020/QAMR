...
module FAU ( 
  ...
  oai21  g049(.a(x18), .b(new_n91_), .c(x09), .O(new_n96_));
  nor2   g050(.a(new_n89_), .b(new_n56_), .O(new_n97_));
  nor3   g051(.a(x20), .b(x19), .c(x17), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n97_), .c(x16), .O(new_n99_));
  nand3  g053(.a(x18), .b(new_n91_), .c(x01), .O(new_n100_));
  ...
  oai21  g060(.a(new_n98_), .b(new_n62_), .c(new_n106_), .O(new_n107_));
  ...
  nand2  g074(.a(x18), .b(new_n55_), .O(new_n121_));
  oai22  g075(.a(new_n121_), .b(new_n120_), .c(x18), .d(new_n68_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n91_), .O(new_n123_));
  nand2  g077(.a(new_n116_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n98_), .c(new_n62_), .O(new_n126_));
  ...
  oai22  g084(.a(new_n121_), .b(new_n130_), .c(x18), .d(new_n73_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n91_), .O(new_n132_));
  nand3  g086(.a(new_n56_), .b(new_n51_), .c(new_n87_), .O(new_n133_));
  nand3  g087(.a(new_n70_), .b(new_n113_), .c(new_n62_), .O(new_n134_));
  ...
  oai22  g105(.a(new_n121_), .b(new_n151_), .c(x18), .d(new_n81_), .O(new_n152_));
  ...
  nand4  g114(.a(new_n125_), .b(new_n83_), .c(new_n78_), .d(new_n160_), .O(new_n161_));
