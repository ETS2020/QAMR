...
module FAU ( 
  ...
  nor2   g052(.a(new_n98_), .b(new_n57_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n87_), .O(z10));
  ...
  oai21  g061(.a(new_n100_), .b(new_n62_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n105_), .c(new_n87_), .O(z11));
  nand2  g064(.a(new_n107_), .b(x22), .O(new_n111_));
  nor2   g065(.a(x22), .b(x21), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n98_), .c(new_n57_), .O(new_n113_));
  ...
  oai21  g071(.a(new_n114_), .b(new_n94_), .c(new_n117_), .O(z12));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n106_), .d(new_n98_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n142_), .c(new_n87_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  nand3  g104(.a(new_n115_), .b(x15), .c(new_n47_), .O(new_n151_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n144_), .c(new_n106_), .d(new_n98_), .O(new_n156_));
  ...
  nand4  g113(.a(new_n144_), .b(new_n84_), .c(new_n79_), .d(new_n131_), .O(new_n160_));
