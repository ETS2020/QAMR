...
module FAU ( 
  ...
  nand2  g035(.a(new_n47_), .b(x18), .O(new_n82_));
  nand3  g036(.a(new_n82_), .b(new_n81_), .c(new_n76_), .O(z09));
  nand2  g037(.a(x27), .b(x18), .O(new_n84_));
  inv1   g038(.a(new_n84_), .O(new_n85_));
  aoi22  g039(.a(new_n85_), .b(x01), .c(new_n51_), .d(x09), .O(new_n86_));
  nand3  g040(.a(new_n52_), .b(new_n48_), .c(new_n73_), .O(new_n87_));
  oai21  g041(.a(new_n75_), .b(new_n52_), .c(new_n87_), .O(new_n88_));
  nand3  g042(.a(new_n88_), .b(new_n82_), .c(x16), .O(new_n89_));
  oai21  g043(.a(new_n86_), .b(x16), .c(new_n89_), .O(z10));
  inv1   g044(.a(x10), .O(new_n91_));
  nand2  g045(.a(x18), .b(x02), .O(new_n92_));
  oai21  g046(.a(x18), .b(new_n91_), .c(new_n92_), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n77_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  nor2   g049(.a(x21), .b(x20), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n75_), .O(new_n97_));
  oai21  g051(.a(new_n95_), .b(new_n55_), .c(new_n97_), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(x16), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n94_), .c(new_n82_), .O(z11));
  inv1   g054(.a(x11), .O(new_n101_));
  nand2  g055(.a(x18), .b(x03), .O(new_n102_));
  oai21  g056(.a(x18), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n77_), .O(new_n104_));
  aoi21  g058(.a(new_n96_), .b(new_n75_), .c(new_n58_), .O(new_n105_));
  nor2   g059(.a(x22), .b(x21), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n75_), .c(new_n52_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n105_), .c(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n82_), .O(z12));
  inv1   g064(.a(x12), .O(new_n111_));
  nand2  g065(.a(x18), .b(x04), .O(new_n112_));
  oai21  g066(.a(x18), .b(new_n111_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n77_), .O(new_n114_));
  nand2  g068(.a(new_n107_), .b(x23), .O(new_n115_));
  nor2   g069(.a(x23), .b(x22), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n95_), .c(new_n55_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n82_), .O(z13));
  inv1   g074(.a(x05), .O(new_n121_));
  inv1   g075(.a(x13), .O(new_n122_));
  oai22  g076(.a(new_n84_), .b(new_n121_), .c(x18), .d(new_n122_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n77_), .O(new_n124_));
  nand3  g078(.a(new_n61_), .b(new_n58_), .c(new_n55_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n87_), .c(x24), .O(new_n126_));
  nor2   g080(.a(x20), .b(x19), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n106_), .c(new_n127_), .d(new_n73_), .O(new_n129_));
  ...
  oai22  g088(.a(new_n84_), .b(new_n133_), .c(x18), .d(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n77_), .O(new_n136_));
  nand2  g090(.a(new_n129_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x25), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n96_), .d(new_n75_), .O(new_n139_));
  ...
  oai22  g098(.a(new_n84_), .b(new_n143_), .c(x18), .d(new_n144_), .O(new_n145_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n116_), .c(new_n96_), .d(new_n75_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n116_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n153_));
  nand3  g107(.a(new_n96_), .b(x19), .c(new_n73_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n47_), .d(new_n73_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n82_), .O(z17));
