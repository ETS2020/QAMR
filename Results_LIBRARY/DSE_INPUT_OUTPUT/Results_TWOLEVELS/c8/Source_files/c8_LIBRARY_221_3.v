...
module FAU ( 
  ...
  nand3  g054(.a(new_n100_), .b(new_n94_), .c(x16), .O(new_n101_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n94_), .c(x16), .O(new_n111_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n94_), .c(x16), .O(new_n120_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n94_), .c(x16), .O(new_n129_));
  ...
  nand3  g090(.a(new_n94_), .b(new_n88_), .c(x13), .O(new_n137_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n94_), .c(x16), .O(new_n147_));
  ...
  nand3  g108(.a(new_n94_), .b(new_n88_), .c(x15), .O(new_n155_));
  ...
  aoi21  g118(.a(new_n164_), .b(new_n94_), .c(new_n88_), .O(z17));
endmodule
