...
module FAU ( 
  ...
  nor2   g053(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nor3   g054(.a(x20), .b(x19), .c(x17), .O(new_n101_));
  oai21  g055(.a(new_n101_), .b(new_n100_), .c(x16), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(new_n86_), .O(z10));
  nand3  g057(.a(x18), .b(x02), .c(x01), .O(new_n104_));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n93_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n93_), .c(new_n99_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n114_), .c(new_n86_), .O(z12));
  ...
  nand3  g079(.a(new_n125_), .b(new_n101_), .c(new_n60_), .O(new_n126_));
  ...
  nand3  g083(.a(x18), .b(x05), .c(x01), .O(new_n130_));
  ...
  nand3  g087(.a(new_n99_), .b(new_n49_), .c(new_n133_), .O(new_n134_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n137_), .d(new_n133_), .O(new_n139_));
  ...
  nand3  g096(.a(x18), .b(x06), .c(x01), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n107_), .d(new_n93_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n125_), .c(new_n107_), .d(new_n93_), .O(new_n157_));
  ...
  nand4  g115(.a(new_n125_), .b(new_n83_), .c(new_n78_), .d(new_n161_), .O(new_n162_));
  nand3  g116(.a(new_n107_), .b(x19), .c(new_n133_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n133_), .O(new_n164_));
