...
module FAU ( 
  ...
  nand4  g085(.a(new_n131_), .b(new_n114_), .c(new_n96_), .d(new_n85_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n89_), .b(x05), .O(new_n135_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n139_), .c(new_n105_), .d(new_n87_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n139_), .b(new_n79_), .c(new_n74_), .d(new_n129_), .O(new_n154_));
  nand3  g108(.a(new_n105_), .b(x19), .c(new_n85_), .O(new_n155_));
