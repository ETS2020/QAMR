...
module FAU ( 
  ...
  nor2   g046(.a(new_n86_), .b(new_n92_), .O(new_n93_));
  nor3   g047(.a(x20), .b(x19), .c(x17), .O(new_n94_));
  oai21  g048(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n95_));
  nand2  g049(.a(new_n88_), .b(x09), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n95_), .c(new_n91_), .O(z10));
  oai21  g051(.a(x16), .b(x02), .c(x18), .O(new_n98_));
  nor2   g052(.a(x21), .b(x20), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n86_), .O(new_n100_));
  oai21  g054(.a(new_n94_), .b(new_n60_), .c(new_n100_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(x16), .O(new_n102_));
  nand2  g056(.a(new_n88_), .b(x10), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n102_), .c(new_n98_), .O(z11));
  ...
  nand3  g067(.a(new_n113_), .b(new_n109_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n108_), .O(z12));
  ...
  nand2  g075(.a(new_n88_), .b(x12), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n121_), .c(new_n116_), .O(z13));
  oai21  g077(.a(x16), .b(x05), .c(x18), .O(new_n124_));
  inv1   g078(.a(x24), .O(new_n125_));
  aoi21  g079(.a(new_n118_), .b(new_n94_), .c(new_n125_), .O(new_n126_));
  nor2   g080(.a(x20), .b(x19), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n111_), .c(new_n127_), .d(new_n84_), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(new_n130_), .b(new_n126_), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n88_), .b(x13), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n131_), .c(new_n124_), .O(z14));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n99_), .d(new_n86_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n109_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n145_), .O(z16));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n136_), .c(new_n125_), .O(new_n153_));
  nand3  g107(.a(new_n99_), .b(x19), .c(new_n84_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n52_), .d(new_n84_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n109_), .c(x16), .O(new_n156_));
