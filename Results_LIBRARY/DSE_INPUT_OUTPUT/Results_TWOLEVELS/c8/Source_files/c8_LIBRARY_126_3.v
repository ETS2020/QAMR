...
module FAU ( 
  ...
  oai21  g052(.a(new_n92_), .b(new_n60_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x16), .O(new_n100_));
  nand2  g054(.a(new_n87_), .b(x10), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z11));
  oai21  g056(.a(x16), .b(x03), .c(x18), .O(new_n103_));
  aoi21  g057(.a(new_n97_), .b(new_n85_), .c(new_n65_), .O(new_n104_));
  nor2   g058(.a(x22), .b(x21), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n85_), .c(new_n54_), .O(new_n106_));
  inv1   g060(.a(new_n106_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(new_n104_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n87_), .b(x11), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n108_), .c(new_n103_), .O(z12));
  oai21  g064(.a(x16), .b(x04), .c(x18), .O(new_n111_));
  nand2  g065(.a(new_n106_), .b(x23), .O(new_n112_));
  nor2   g066(.a(x23), .b(x22), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n92_), .c(new_n60_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(x16), .O(new_n116_));
  nand2  g070(.a(new_n87_), .b(x12), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n116_), .c(new_n111_), .O(z13));
  inv1   g072(.a(x16), .O(new_n119_));
  nand2  g073(.a(x18), .b(x05), .O(new_n120_));
  oai21  g074(.a(x18), .b(new_n71_), .c(new_n120_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  inv1   g076(.a(x18), .O(new_n123_));
  nand3  g077(.a(new_n54_), .b(new_n83_), .c(new_n82_), .O(new_n124_));
  inv1   g078(.a(x23), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n65_), .c(new_n60_), .O(new_n126_));
  oai21  g080(.a(new_n126_), .b(new_n124_), .c(x24), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n105_), .c(new_n128_), .d(new_n82_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n127_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n123_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n122_), .O(z14));
  oai21  g087(.a(x16), .b(x06), .c(x18), .O(new_n134_));
  nand2  g088(.a(new_n130_), .b(x25), .O(new_n135_));
  nor2   g089(.a(x25), .b(x24), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n113_), .c(new_n97_), .d(new_n85_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(x16), .O(new_n139_));
  nand2  g093(.a(new_n87_), .b(x14), .O(new_n140_));
  ...
  nand2  g097(.a(new_n143_), .b(new_n119_), .O(new_n144_));
  nand2  g098(.a(new_n137_), .b(x26), .O(new_n145_));
  nor3   g099(.a(x26), .b(x25), .c(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n113_), .c(new_n97_), .d(new_n85_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n123_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z16));
  nand2  g104(.a(new_n125_), .b(new_n65_), .O(new_n151_));
  inv1   g105(.a(x24), .O(new_n152_));
  inv1   g106(.a(x25), .O(new_n153_));
  inv1   g107(.a(x26), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  nor2   g109(.a(new_n155_), .b(new_n151_), .O(new_n156_));
  nand3  g110(.a(new_n97_), .b(x19), .c(new_n82_), .O(new_n157_));
  inv1   g111(.a(new_n157_), .O(new_n158_));
  nor2   g112(.a(new_n55_), .b(new_n82_), .O(new_n159_));
  aoi21  g113(.a(new_n158_), .b(new_n156_), .c(new_n159_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n123_), .c(new_n119_), .O(z17));
endmodule
