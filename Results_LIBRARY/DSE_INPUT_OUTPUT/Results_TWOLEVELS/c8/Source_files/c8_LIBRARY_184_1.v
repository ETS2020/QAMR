...
module FAU ( 
  ...
  oai22  g56(.a(new_n102_), .b(new_n89_), .c(new_n90_), .d(new_n58_), .O(z11));
  oai21  g57(.a(x18), .b(x11), .c(new_n89_), .O(new_n104_));
  nand2  g58(.a(new_n100_), .b(x22), .O(new_n105_));
  nor2   g59(.a(x22), .b(x21), .O(new_n106_));
  nand3  g60(.a(new_n106_), .b(new_n87_), .c(new_n93_), .O(new_n107_));
  and2   g61(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  oai21  g62(.a(new_n108_), .b(new_n89_), .c(new_n104_), .O(z12));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n95_), .c(new_n107_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n89_), .c(new_n90_), .d(new_n66_), .O(z13));
  oai21  g66(.a(x18), .b(x13), .c(new_n89_), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n95_), .c(new_n71_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n106_), .c(new_n98_), .d(new_n85_), .O(new_n116_));
  ...
  nand4  g75(.a(new_n76_), .b(new_n71_), .c(new_n121_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n101_), .c(new_n116_), .d(x25), .O(new_n124_));
  nand3  g78(.a(new_n47_), .b(new_n89_), .c(x14), .O(new_n125_));
  ...
  nand4  g92(.a(new_n129_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n139_));
  nand3  g93(.a(new_n128_), .b(x19), .c(new_n85_), .O(new_n140_));
