...
module FAU ( 
  ...
  nor2   g30(.a(new_n48_), .b(new_n60_), .O(z08));
  ...
  oai21  g40(.a(new_n84_), .b(x01), .c(new_n83_), .O(new_n87_));
  ...
  nand4  g49(.a(new_n95_), .b(new_n88_), .c(new_n79_), .d(new_n78_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n94_), .b(x21), .c(new_n97_), .O(new_n98_));
  nor2   g52(.a(new_n84_), .b(x16), .O(new_n99_));
  nand2  g53(.a(new_n99_), .b(x02), .O(new_n100_));
  oai21  g54(.a(new_n98_), .b(new_n83_), .c(new_n100_), .O(z11));
  ...
  nand2  g59(.a(new_n99_), .b(x03), .O(new_n106_));
  oai21  g60(.a(new_n105_), .b(new_n83_), .c(new_n106_), .O(z12));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n90_), .c(new_n104_), .d(x23), .O(new_n109_));
  nand2  g63(.a(new_n99_), .b(x04), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n83_), .c(new_n110_), .O(z13));
  aoi21  g65(.a(new_n108_), .b(new_n90_), .c(new_n68_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n103_), .c(new_n93_), .d(new_n78_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n99_), .b(x05), .O(new_n117_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n68_), .c(new_n120_), .d(new_n59_), .O(new_n122_));
  ...
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n78_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n60_), .d(new_n78_), .O(new_n141_));
