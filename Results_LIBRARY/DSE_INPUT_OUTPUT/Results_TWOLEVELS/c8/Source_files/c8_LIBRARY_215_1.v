...
module FAU ( 
  ...
  oai22  g57(.a(new_n103_), .b(new_n93_), .c(new_n91_), .d(new_n58_), .O(z11));
  nor3   g58(.a(x22), .b(x21), .c(x20), .O(new_n105_));
  aoi22  g59(.a(new_n105_), .b(new_n88_), .c(new_n101_), .d(x22), .O(new_n106_));
  oai22  g60(.a(new_n106_), .b(new_n93_), .c(new_n91_), .d(new_n63_), .O(z12));
  ...
  oai22  g65(.a(new_n111_), .b(new_n93_), .c(new_n91_), .d(new_n68_), .O(z13));
  inv1   g66(.a(x24), .O(new_n113_));
  aoi21  g67(.a(new_n110_), .b(new_n96_), .c(new_n113_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n108_), .c(new_n99_), .d(new_n85_), .O(new_n116_));
  ...
  oai21  g74(.a(x18), .b(x14), .c(new_n93_), .O(new_n121_));
  inv1   g75(.a(x25), .O(new_n122_));
  nand4  g76(.a(new_n122_), .b(new_n113_), .c(new_n70_), .d(new_n65_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n102_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n93_), .c(new_n121_), .O(z15));
  ...
  aoi21  g94(.a(new_n140_), .b(new_n139_), .c(new_n93_), .O(z17));
endmodule
