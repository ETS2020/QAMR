...
module FAU ( 
  ...
  oai21  g073(.a(new_n117_), .b(new_n68_), .c(new_n119_), .O(new_n120_));
  ...
  oai21  g077(.a(x18), .b(new_n73_), .c(new_n123_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n96_), .O(new_n125_));
  and2   g079(.a(new_n119_), .b(x23), .O(new_n126_));
  inv1   g080(.a(new_n105_), .O(new_n127_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n125_), .c(new_n53_), .O(z13));
  inv1   g086(.a(x05), .O(new_n133_));
  nand2  g087(.a(x18), .b(x06), .O(new_n134_));
  oai22  g088(.a(new_n134_), .b(new_n133_), .c(x18), .d(new_n78_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n96_), .O(new_n136_));
  nand4  g090(.a(new_n118_), .b(new_n105_), .c(new_n76_), .d(new_n71_), .O(new_n137_));
  oai21  g091(.a(new_n130_), .b(new_n76_), .c(new_n137_), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n53_), .c(x16), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(z14));
  oai21  g094(.a(x18), .b(new_n81_), .c(new_n134_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n96_), .O(new_n142_));
  oai21  g096(.a(x18), .b(new_n96_), .c(new_n134_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n137_), .c(x25), .O(new_n144_));
  aoi21  g098(.a(x18), .b(new_n52_), .c(x25), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n76_), .c(new_n71_), .d(new_n68_), .O(new_n146_));
  nor3   g100(.a(new_n146_), .b(x21), .c(x20), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n49_), .c(new_n92_), .d(x16), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n144_), .c(new_n142_), .O(z15));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  oai21  g104(.a(x18), .b(new_n86_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n96_), .O(new_n152_));
  nand3  g106(.a(new_n128_), .b(new_n83_), .c(new_n76_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n111_), .c(x26), .O(new_n154_));
  nand4  g108(.a(new_n128_), .b(new_n88_), .c(new_n83_), .d(new_n76_), .O(new_n155_));
  oai21  g109(.a(new_n155_), .b(new_n111_), .c(new_n154_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand3  g111(.a(new_n157_), .b(new_n152_), .c(new_n53_), .O(z16));
  nand3  g112(.a(new_n110_), .b(x19), .c(new_n92_), .O(new_n159_));
