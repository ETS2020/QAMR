...
module FAU ( 
  ...
  oai21  g069(.a(x18), .b(x12), .c(new_n47_), .O(new_n116_));
  nor3   g070(.a(x23), .b(x22), .c(x21), .O(new_n117_));
  aoi22  g071(.a(new_n117_), .b(new_n100_), .c(new_n113_), .d(x23), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n47_), .c(new_n116_), .O(z13));
  aoi21  g073(.a(new_n117_), .b(new_n100_), .c(new_n76_), .O(new_n120_));
  nor2   g074(.a(x24), .b(x23), .O(new_n121_));
  nand4  g075(.a(new_n121_), .b(new_n112_), .c(new_n104_), .d(new_n92_), .O(new_n122_));
  inv1   g076(.a(new_n122_), .O(new_n123_));
  oai21  g077(.a(new_n123_), .b(new_n120_), .c(x16), .O(new_n124_));
  nor2   g078(.a(x18), .b(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x13), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(z14));
  nand4  g081(.a(new_n83_), .b(new_n76_), .c(new_n73_), .d(new_n66_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  aoi22  g083(.a(new_n129_), .b(new_n107_), .c(new_n122_), .d(x25), .O(new_n130_));
  nand2  g084(.a(new_n125_), .b(x14), .O(new_n131_));
  ...
  nand2  g095(.a(new_n125_), .b(x15), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n141_), .O(z16));
  nand4  g097(.a(new_n134_), .b(new_n88_), .c(new_n83_), .d(new_n76_), .O(new_n144_));
