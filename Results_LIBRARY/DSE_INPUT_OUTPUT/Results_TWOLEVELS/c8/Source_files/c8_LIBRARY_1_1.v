...
module FAU ( 
  ...
  nand2  g055(.a(new_n47_), .b(new_n52_), .O(new_n102_));
  oai21  g056(.a(new_n102_), .b(new_n57_), .c(new_n101_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(new_n96_), .O(new_n104_));
  nor2   g058(.a(new_n55_), .b(new_n92_), .O(new_n105_));
  nor2   g059(.a(x20), .b(x17), .O(new_n106_));
  oai21  g060(.a(new_n106_), .b(new_n105_), .c(new_n47_), .O(new_n107_));
  nand3  g061(.a(x20), .b(x19), .c(x18), .O(new_n108_));
  ...
  oai21  g066(.a(new_n102_), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n96_), .O(new_n114_));
  oai21  g068(.a(x20), .b(x17), .c(x21), .O(new_n115_));
  ...
  nand3  g072(.a(x21), .b(x19), .c(x18), .O(new_n119_));
  ...
  oai21  g079(.a(new_n66_), .b(new_n96_), .c(x18), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x19), .O(new_n127_));
  nor3   g081(.a(x21), .b(x20), .c(x17), .O(new_n128_));
  ...
  nand3  g093(.a(new_n55_), .b(new_n47_), .c(new_n92_), .O(new_n140_));
  nor2   g094(.a(x23), .b(x22), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n63_), .O(new_n142_));
  nor2   g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n139_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n136_), .O(z13));
  nand2  g099(.a(x18), .b(x05), .O(new_n146_));
  oai21  g100(.a(new_n102_), .b(new_n76_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  nand3  g102(.a(new_n141_), .b(new_n106_), .c(new_n63_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x24), .O(new_n150_));
  nor3   g104(.a(x24), .b(x23), .c(x22), .O(new_n151_));
  ...
  aoi21  g116(.a(new_n151_), .b(new_n128_), .c(new_n81_), .O(new_n163_));
  nand2  g117(.a(new_n116_), .b(new_n94_), .O(new_n164_));
  nand3  g118(.a(new_n141_), .b(new_n81_), .c(new_n78_), .O(new_n165_));
  nor2   g119(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n163_), .c(x16), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n162_), .c(new_n160_), .O(z15));
  nand2  g122(.a(x18), .b(x07), .O(new_n169_));
  oai21  g123(.a(x18), .b(new_n86_), .c(new_n169_), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n96_), .O(new_n171_));
  oai21  g125(.a(new_n88_), .b(new_n96_), .c(x18), .O(new_n172_));
  nand2  g126(.a(new_n172_), .b(x19), .O(new_n173_));
  oai21  g127(.a(new_n165_), .b(new_n117_), .c(x26), .O(new_n174_));
  nor3   g128(.a(x26), .b(x25), .c(x24), .O(new_n175_));
  nand4  g129(.a(new_n175_), .b(new_n141_), .c(new_n116_), .d(new_n94_), .O(new_n176_));
  nand2  g130(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  nand2  g131(.a(new_n177_), .b(x16), .O(new_n178_));
  nand3  g132(.a(new_n178_), .b(new_n173_), .c(new_n171_), .O(z16));
  nand3  g133(.a(new_n53_), .b(x27), .c(x17), .O(new_n180_));
  nand2  g134(.a(new_n116_), .b(x19), .O(new_n181_));
  nor3   g135(.a(new_n181_), .b(new_n52_), .c(x17), .O(new_n182_));
  nand3  g136(.a(new_n182_), .b(new_n175_), .c(new_n141_), .O(new_n183_));
  aoi21  g137(.a(new_n183_), .b(new_n180_), .c(new_n96_), .O(z17));
endmodule
