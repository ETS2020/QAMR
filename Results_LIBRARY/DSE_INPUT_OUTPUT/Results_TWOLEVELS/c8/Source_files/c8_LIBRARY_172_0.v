...
module FAU ( 
  ...
  oai21  g040(.a(new_n54_), .b(new_n47_), .c(new_n48_), .O(new_n87_));
  oai21  g041(.a(new_n54_), .b(x15), .c(new_n87_), .O(z07));
  nand2  g042(.a(new_n49_), .b(new_n54_), .O(z08));
  inv1   g043(.a(x16), .O(new_n90_));
  nand2  g044(.a(x18), .b(x00), .O(new_n91_));
  nand2  g045(.a(x26), .b(new_n47_), .O(new_n92_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n49_), .c(x16), .O(new_n99_));
  ...
  nand3  g060(.a(new_n106_), .b(new_n103_), .c(new_n49_), .O(z10));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n49_), .O(z12));
  ...
  oai21  g083(.a(new_n122_), .b(new_n74_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n127_), .c(new_n49_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai21  g087(.a(new_n92_), .b(new_n79_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n90_), .O(new_n135_));
  nand3  g089(.a(new_n129_), .b(new_n49_), .c(x24), .O(new_n136_));
  inv1   g090(.a(x17), .O(new_n137_));
  nand4  g091(.a(new_n49_), .b(new_n77_), .c(new_n74_), .d(new_n67_), .O(new_n138_));
  nor2   g092(.a(new_n138_), .b(x21), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n59_), .c(new_n53_), .d(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n136_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n135_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(new_n92_), .b(new_n84_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n90_), .O(new_n146_));
  nand4  g100(.a(new_n120_), .b(new_n105_), .c(new_n77_), .d(new_n74_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n49_), .c(x25), .O(new_n148_));
  aoi21  g102(.a(new_n48_), .b(new_n47_), .c(x25), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n77_), .c(new_n74_), .d(new_n67_), .O(new_n150_));
  nor2   g104(.a(new_n150_), .b(x21), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n59_), .c(new_n53_), .d(new_n137_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n148_), .O(new_n153_));
  ...
  nor3   g113(.a(x21), .b(x20), .c(x19), .O(new_n160_));
  nor2   g114(.a(new_n82_), .b(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n128_), .c(new_n111_), .d(new_n96_), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n160_), .c(new_n128_), .d(new_n77_), .O(new_n163_));
  oai21  g117(.a(new_n163_), .b(x17), .c(x26), .O(new_n164_));
  nor2   g118(.a(new_n47_), .b(x17), .O(new_n165_));
  nor3   g119(.a(x26), .b(x25), .c(x24), .O(new_n166_));
  and2   g120(.a(new_n166_), .b(new_n128_), .O(new_n167_));
  nand3  g121(.a(new_n167_), .b(new_n165_), .c(new_n160_), .O(new_n168_));
  nand2  g122(.a(new_n168_), .b(new_n164_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand3  g124(.a(new_n170_), .b(new_n159_), .c(new_n49_), .O(z16));
  nand3  g125(.a(new_n49_), .b(x27), .c(x17), .O(new_n172_));
  nand4  g126(.a(new_n167_), .b(new_n165_), .c(new_n111_), .d(x19), .O(new_n173_));
  aoi21  g127(.a(new_n173_), .b(new_n172_), .c(new_n90_), .O(z17));
endmodule
