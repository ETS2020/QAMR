...
module FAU ( 
  ...
  aoi21  g019(.a(x27), .b(x18), .c(new_n48_), .O(new_n66_));
  oai22  g020(.a(new_n66_), .b(x12), .c(x27), .d(x23), .O(z04));
  inv1   g021(.a(x13), .O(new_n68_));
  nand2  g022(.a(x27), .b(new_n68_), .O(new_n69_));
  inv1   g023(.a(x24), .O(new_n70_));
  nand2  g024(.a(new_n58_), .b(new_n70_), .O(new_n71_));
  ...
  nand2  g033(.a(new_n79_), .b(new_n58_), .O(z08));
  ...
  nand3  g046(.a(new_n48_), .b(new_n92_), .c(x09), .O(new_n93_));
  ...
  oai21  g052(.a(new_n84_), .b(new_n96_), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n79_), .c(x16), .O(new_n100_));
  ...
  oai21  g061(.a(new_n105_), .b(new_n57_), .c(new_n107_), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(x16), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n79_), .O(z11));
  ...
  oai21  g086(.a(new_n70_), .b(new_n86_), .c(x18), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x23), .O(new_n134_));
  nand2  g088(.a(new_n116_), .b(x24), .O(new_n135_));
  nand4  g089(.a(new_n115_), .b(new_n105_), .c(new_n70_), .d(new_n48_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n134_), .c(new_n132_), .O(z14));
  ...
  oai21  g097(.a(new_n143_), .b(new_n86_), .c(x18), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x23), .O(new_n145_));
  nor3   g099(.a(x24), .b(x22), .c(x21), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(new_n105_), .c(new_n143_), .O(new_n147_));
  nor2   g101(.a(x25), .b(x24), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n125_), .O(new_n149_));
  nor2   g103(.a(new_n149_), .b(new_n107_), .O(new_n150_));
  oai21  g104(.a(new_n150_), .b(new_n147_), .c(x16), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n145_), .c(new_n142_), .O(z15));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  oai21  g107(.a(x18), .b(new_n76_), .c(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n86_), .O(new_n155_));
  nand2  g109(.a(x26), .b(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x18), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x23), .O(new_n158_));
  nand4  g112(.a(new_n148_), .b(new_n115_), .c(new_n97_), .d(new_n81_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x26), .O(new_n160_));
  nor3   g114(.a(x26), .b(x25), .c(x24), .O(new_n161_));
  nand4  g115(.a(new_n161_), .b(new_n125_), .c(new_n106_), .d(new_n84_), .O(new_n162_));
  ...
  nand3  g119(.a(new_n79_), .b(x27), .c(x17), .O(new_n166_));
  nor2   g120(.a(new_n82_), .b(x17), .O(new_n167_));
  nand4  g121(.a(new_n167_), .b(new_n161_), .c(new_n125_), .d(new_n106_), .O(new_n168_));
  aoi21  g122(.a(new_n168_), .b(new_n166_), .c(new_n86_), .O(z17));
endmodule
