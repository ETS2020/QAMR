...
module FAU ( 
  ...
  nor2   g47(.a(new_n87_), .b(new_n56_), .O(new_n94_));
  ...
  nand4  g53(.a(new_n61_), .b(new_n56_), .c(new_n50_), .d(new_n85_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  nor2   g56(.a(new_n90_), .b(x16), .O(new_n103_));
  nand2  g57(.a(new_n103_), .b(x02), .O(new_n104_));
  oai21  g58(.a(new_n102_), .b(new_n89_), .c(new_n104_), .O(z11));
  oai21  g59(.a(new_n90_), .b(x03), .c(new_n89_), .O(new_n106_));
  nand2  g60(.a(new_n100_), .b(x22), .O(new_n107_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n108_), .c(new_n98_), .d(new_n85_), .O(new_n119_));
  ...
  nand4  g79(.a(new_n75_), .b(new_n116_), .c(new_n125_), .d(new_n124_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n101_), .c(new_n119_), .d(x25), .O(new_n128_));
  nand2  g82(.a(new_n103_), .b(x06), .O(new_n129_));
  ...
  nand4  g95(.a(new_n133_), .b(new_n80_), .c(new_n75_), .d(new_n116_), .O(new_n142_));
