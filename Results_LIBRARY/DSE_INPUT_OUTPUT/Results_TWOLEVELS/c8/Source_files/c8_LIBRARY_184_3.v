...
module FAU ( 
  ...
  oai21  g061(.a(new_n97_), .b(new_n60_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n105_), .c(x16), .O(new_n109_));
  ...
  nand2  g071(.a(new_n99_), .b(x11), .O(new_n118_));
  ...
  nand3  g099(.a(new_n145_), .b(new_n105_), .c(x16), .O(new_n146_));
  ...
  aoi21  g117(.a(new_n163_), .b(new_n105_), .c(new_n85_), .O(z17));
endmodule
