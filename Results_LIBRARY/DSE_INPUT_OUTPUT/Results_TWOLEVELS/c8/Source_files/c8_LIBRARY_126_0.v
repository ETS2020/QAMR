...
module FAU ( 
  ...
  oai21  g53(.a(new_n99_), .b(new_n85_), .c(new_n94_), .O(z11));
  oai21  g54(.a(new_n86_), .b(x03), .c(new_n85_), .O(new_n101_));
  ...
  oai21  g60(.a(new_n86_), .b(x04), .c(new_n85_), .O(new_n107_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n111_), .c(new_n120_), .d(new_n64_), .O(new_n122_));
