...
module FAU ( 
  ...
  oai21  g49(.a(x18), .b(x10), .c(new_n95_), .O(new_n96_));
  nor2   g50(.a(x20), .b(x19), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(new_n83_), .O(new_n98_));
  nand4  g52(.a(new_n60_), .b(new_n90_), .c(new_n51_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n98_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n95_), .c(new_n96_), .O(z11));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n85_), .c(new_n99_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n95_), .c(new_n88_), .d(new_n63_), .O(z12));
  oai21  g59(.a(x18), .b(x12), .c(new_n95_), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n85_), .c(new_n90_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n92_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n95_), .c(new_n106_), .O(z13));
  aoi21  g65(.a(new_n109_), .b(new_n92_), .c(new_n71_), .O(new_n112_));
  nor2   g66(.a(x24), .b(x23), .O(new_n113_));
  nand4  g67(.a(new_n113_), .b(new_n107_), .c(new_n97_), .d(new_n83_), .O(new_n114_));
  inv1   g68(.a(new_n114_), .O(new_n115_));
  oai21  g69(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand2  g70(.a(new_n87_), .b(x13), .O(new_n117_));
  nand2  g71(.a(new_n117_), .b(new_n116_), .O(z14));
  inv1   g72(.a(x22), .O(new_n119_));
  inv1   g73(.a(x23), .O(new_n120_));
  nand4  g74(.a(new_n76_), .b(new_n71_), .c(new_n120_), .d(new_n119_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n100_), .c(new_n114_), .d(x25), .O(new_n123_));
  nand2  g77(.a(new_n87_), .b(x14), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n95_), .c(new_n124_), .O(z15));
  oai21  g79(.a(x18), .b(x15), .c(new_n95_), .O(new_n126_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n95_), .O(z17));
endmodule
