...
module FAU ( 
  ...
  nand2  g047(.a(x18), .b(x05), .O(new_n94_));
  ...
  oai22  g062(.a(new_n94_), .b(new_n108_), .c(x18), .d(new_n63_), .O(new_n109_));
  ...
  oai21  g066(.a(new_n105_), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n103_), .c(new_n56_), .O(new_n121_));
  ...
  nor2   g078(.a(x18), .b(new_n73_), .O(new_n125_));
  aoi21  g079(.a(x18), .b(x04), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n121_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n105_), .c(new_n61_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  aoi21  g084(.a(new_n130_), .b(x16), .c(new_n54_), .O(new_n131_));
  oai21  g085(.a(new_n126_), .b(x16), .c(new_n131_), .O(z13));
  oai21  g086(.a(x18), .b(new_n76_), .c(new_n94_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n92_), .O(new_n134_));
  oai21  g088(.a(x18), .b(new_n92_), .c(new_n94_), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(x24), .O(new_n136_));
  inv1   g090(.a(x17), .O(new_n137_));
  aoi21  g091(.a(x18), .b(new_n52_), .c(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n71_), .c(new_n68_), .d(new_n61_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(x20), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n49_), .c(new_n137_), .d(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n136_), .c(new_n134_), .O(z14));
  nand3  g096(.a(x18), .b(x06), .c(x05), .O(new_n143_));
  ...
  nand3  g100(.a(new_n146_), .b(new_n120_), .c(new_n105_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n128_), .c(new_n111_), .d(new_n103_), .O(new_n150_));
  ...
  oai21  g108(.a(x18), .b(new_n88_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n92_), .O(new_n156_));
  nand2  g110(.a(new_n150_), .b(x26), .O(new_n157_));
  nand4  g111(.a(new_n128_), .b(new_n86_), .c(new_n81_), .d(new_n78_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n112_), .c(new_n157_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n156_), .c(new_n53_), .O(z16));
  nand3  g115(.a(new_n111_), .b(x19), .c(new_n137_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n158_), .c(new_n50_), .d(new_n137_), .O(new_n163_));
