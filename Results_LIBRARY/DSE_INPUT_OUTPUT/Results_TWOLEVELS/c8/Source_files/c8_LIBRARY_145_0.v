...
module FAU ( 
  ...
  nand3  g61(.a(new_n107_), .b(new_n86_), .c(new_n56_), .O(new_n108_));
  ...
  oai21  g69(.a(new_n88_), .b(x05), .c(new_n97_), .O(new_n116_));
  aoi21  g70(.a(new_n113_), .b(new_n93_), .c(new_n72_), .O(new_n117_));
  nor2   g71(.a(x24), .b(x23), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n107_), .c(new_n98_), .d(new_n84_), .O(new_n119_));
  ...
  nand4  g79(.a(new_n125_), .b(new_n72_), .c(new_n67_), .d(new_n124_), .O(new_n126_));
