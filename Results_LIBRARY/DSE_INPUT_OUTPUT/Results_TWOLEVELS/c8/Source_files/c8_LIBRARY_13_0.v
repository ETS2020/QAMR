...
module FAU ( 
  ...
  nand2  g052(.a(new_n65_), .b(x12), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n57_), .c(new_n98_), .O(new_n100_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n79_), .c(x16), .O(new_n106_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n83_), .c(new_n93_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n79_), .c(x16), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n110_), .O(z12));
  oai21  g070(.a(new_n65_), .b(x04), .c(new_n85_), .O(new_n117_));
  ...
  aoi21  g080(.a(new_n119_), .b(new_n95_), .c(new_n70_), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n112_), .c(new_n128_), .d(new_n81_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n127_), .c(x16), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n126_), .c(new_n79_), .O(z14));
  nand2  g087(.a(x18), .b(x06), .O(new_n134_));
  nand3  g088(.a(new_n65_), .b(x14), .c(x12), .O(new_n135_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n139_), .c(new_n103_), .d(new_n83_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n79_), .c(x16), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n139_), .c(new_n103_), .d(new_n83_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n79_), .O(z16));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n139_), .c(new_n70_), .O(new_n155_));
  nand3  g109(.a(new_n103_), .b(x19), .c(new_n81_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n51_), .d(new_n81_), .O(new_n157_));
