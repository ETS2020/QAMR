...
module FAU ( 
  ...
  oai21  g44(.a(new_n90_), .b(new_n83_), .c(new_n88_), .O(z09));
  ...
  nand4  g56(.a(new_n102_), .b(new_n94_), .c(new_n85_), .d(new_n84_), .O(new_n103_));
  ...
  aoi21  g71(.a(new_n114_), .b(new_n96_), .c(new_n68_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n112_), .c(new_n100_), .d(new_n84_), .O(new_n120_));
  ...
  nand4  g79(.a(new_n73_), .b(new_n68_), .c(new_n125_), .d(new_n59_), .O(new_n126_));
  ...
  nand3  g95(.a(new_n131_), .b(x19), .c(new_n84_), .O(new_n142_));
  oai22  g96(.a(new_n142_), .b(new_n141_), .c(new_n60_), .d(new_n84_), .O(new_n143_));
