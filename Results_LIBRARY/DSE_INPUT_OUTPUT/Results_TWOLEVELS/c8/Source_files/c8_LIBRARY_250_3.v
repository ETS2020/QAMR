...
module FAU ( 
  ...
  nand3  g070(.a(new_n116_), .b(new_n104_), .c(x16), .O(new_n117_));
  ...
  aoi21  g082(.a(new_n123_), .b(new_n96_), .c(new_n77_), .O(new_n129_));
  ...
  nand2  g089(.a(new_n98_), .b(x13), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n135_), .c(new_n128_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n105_), .d(new_n94_), .O(new_n142_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n105_), .d(new_n94_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n105_), .b(x19), .c(new_n130_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n130_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n104_), .c(x16), .O(new_n160_));
