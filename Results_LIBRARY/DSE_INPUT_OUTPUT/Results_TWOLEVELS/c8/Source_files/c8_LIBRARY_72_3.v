...
module FAU ( 
  ...
  oai21  g056(.a(new_n91_), .b(new_n100_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n99_), .c(x16), .O(new_n104_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n83_), .c(new_n89_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n99_), .c(x16), .O(new_n113_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n91_), .c(new_n100_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n99_), .c(x16), .O(new_n122_));
  ...
  nand3  g080(.a(new_n89_), .b(new_n81_), .c(new_n80_), .O(new_n127_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n110_), .c(new_n131_), .d(new_n80_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n99_), .c(x16), .O(new_n135_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n119_), .c(new_n101_), .d(new_n83_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n85_), .b(x14), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n119_), .c(new_n101_), .d(new_n83_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n85_), .b(x15), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nand2  g106(.a(new_n128_), .b(new_n60_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n101_), .b(x19), .c(new_n80_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n61_), .b(new_n80_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n99_), .c(new_n95_), .O(z17));
endmodule
