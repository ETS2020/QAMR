...
module FAU ( 
  ...
  oai21  g039(.a(new_n48_), .b(x18), .c(new_n52_), .O(new_n86_));
  oai21  g040(.a(new_n48_), .b(x15), .c(new_n86_), .O(z07));
  ...
  nor2   g051(.a(x18), .b(new_n56_), .O(new_n98_));
  aoi21  g052(.a(x18), .b(x01), .c(new_n98_), .O(new_n99_));
  nand3  g053(.a(new_n58_), .b(new_n47_), .c(new_n89_), .O(new_n100_));
  oai21  g054(.a(new_n91_), .b(new_n58_), .c(new_n100_), .O(new_n101_));
  aoi21  g055(.a(new_n101_), .b(x16), .c(new_n55_), .O(new_n102_));
  oai21  g056(.a(new_n99_), .b(x16), .c(new_n102_), .O(z10));
  inv1   g057(.a(x02), .O(new_n104_));
  nand2  g058(.a(x26), .b(x18), .O(new_n105_));
  oai22  g059(.a(new_n105_), .b(new_n104_), .c(x18), .d(new_n61_), .O(new_n106_));
  nand2  g060(.a(new_n106_), .b(new_n93_), .O(new_n107_));
  nand3  g061(.a(new_n100_), .b(new_n53_), .c(x21), .O(new_n108_));
  nand4  g062(.a(new_n53_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(x17), .c(new_n108_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n107_), .O(z11));
  inv1   g066(.a(x03), .O(new_n113_));
  oai22  g067(.a(new_n105_), .b(new_n113_), .c(x18), .d(new_n66_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n93_), .O(new_n115_));
  nand3  g069(.a(new_n91_), .b(new_n63_), .c(new_n58_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n53_), .c(x22), .O(new_n117_));
  nor2   g071(.a(new_n55_), .b(x22), .O(new_n118_));
  ...
  oai22  g077(.a(new_n105_), .b(new_n123_), .c(x18), .d(new_n73_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n93_), .O(new_n125_));
  nand4  g079(.a(new_n91_), .b(new_n68_), .c(new_n63_), .d(new_n58_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n63_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n100_), .c(new_n127_), .O(new_n130_));
  ...
  nor2   g089(.a(new_n129_), .b(new_n100_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n78_), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n68_), .c(new_n63_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n100_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n135_), .c(new_n53_), .O(z14));
  nor2   g096(.a(x18), .b(new_n81_), .O(new_n143_));
  aoi21  g097(.a(x18), .b(x06), .c(new_n143_), .O(new_n144_));
  nand3  g098(.a(new_n128_), .b(new_n83_), .c(new_n78_), .O(new_n145_));
  oai22  g099(.a(new_n145_), .b(new_n116_), .c(new_n140_), .d(new_n83_), .O(new_n146_));
  aoi21  g100(.a(new_n146_), .b(x16), .c(new_n55_), .O(new_n147_));
  oai21  g101(.a(new_n144_), .b(x16), .c(new_n147_), .O(z15));
  inv1   g102(.a(x15), .O(new_n149_));
  nand2  g103(.a(x18), .b(x07), .O(new_n150_));
  oai21  g104(.a(x18), .b(new_n149_), .c(new_n150_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n93_), .O(new_n152_));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  aoi22  g107(.a(new_n153_), .b(new_n138_), .c(x26), .d(x23), .O(new_n154_));
  nand2  g108(.a(x26), .b(x22), .O(new_n155_));
  oai21  g109(.a(new_n154_), .b(x22), .c(new_n155_), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n63_), .c(new_n58_), .d(new_n47_), .O(new_n157_));
  nand3  g111(.a(new_n83_), .b(new_n78_), .c(new_n63_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n100_), .c(x26), .O(new_n159_));
  oai21  g113(.a(new_n157_), .b(x17), .c(new_n159_), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(x16), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n152_), .c(new_n53_), .O(z16));
  nand4  g116(.a(new_n63_), .b(new_n58_), .c(x19), .d(new_n89_), .O(new_n163_));
  nand3  g117(.a(new_n153_), .b(new_n128_), .c(new_n78_), .O(new_n164_));
