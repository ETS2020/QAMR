...
module FAU ( 
  ...
  nor2   g079(.a(new_n85_), .b(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x04), .O(new_n127_));
  ...
  nand2  g089(.a(new_n126_), .b(x05), .O(new_n136_));
  ...
  nand2  g107(.a(new_n126_), .b(x07), .O(new_n154_));
