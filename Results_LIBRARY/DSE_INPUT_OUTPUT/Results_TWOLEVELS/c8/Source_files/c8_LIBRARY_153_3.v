...
module FAU ( 
  ...
  nand2  g027(.a(new_n52_), .b(new_n72_), .O(new_n74_));
  oai21  g028(.a(new_n74_), .b(x18), .c(new_n73_), .O(z05));
  ...
  nand2  g048(.a(x18), .b(new_n71_), .O(new_n95_));
  ...
  oai22  g058(.a(new_n95_), .b(new_n104_), .c(x18), .d(new_n58_), .O(new_n105_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n115_), .c(new_n47_), .O(z12));
  inv1   g075(.a(x04), .O(new_n122_));
  oai22  g076(.a(new_n95_), .b(new_n122_), .c(x18), .d(new_n68_), .O(new_n123_));
  ...
  oai21  g084(.a(x18), .b(new_n89_), .c(x13), .O(new_n131_));
  aoi21  g085(.a(new_n126_), .b(new_n107_), .c(new_n72_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n117_), .c(new_n99_), .d(new_n85_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(x18), .b(new_n89_), .c(x05), .O(new_n137_));
  ...
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n47_), .O(z15));
  ...
  nand3  g112(.a(new_n158_), .b(new_n143_), .c(new_n72_), .O(new_n159_));
  nand3  g113(.a(new_n108_), .b(x19), .c(new_n85_), .O(new_n160_));
