...
module FAU ( 
  ...
  nand3  g046(.a(new_n92_), .b(new_n89_), .c(new_n48_), .O(z10));
  ...
  nand3  g054(.a(new_n100_), .b(new_n96_), .c(new_n48_), .O(z11));
  nand3  g055(.a(x18), .b(new_n75_), .c(x03), .O(new_n102_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n48_), .O(z13));
  ...
  nand3  g084(.a(new_n130_), .b(new_n122_), .c(new_n48_), .O(z14));
  ...
  oai21  g095(.a(x18), .b(new_n82_), .c(x15), .O(new_n142_));
  nand2  g096(.a(new_n138_), .b(x26), .O(new_n143_));
  nor3   g097(.a(x26), .b(x25), .c(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n136_), .c(new_n97_), .d(new_n80_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(x18), .b(new_n82_), .c(x07), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n147_), .c(new_n142_), .O(z16));
  nor2   g103(.a(x26), .b(x25), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n136_), .c(new_n123_), .O(new_n151_));
  nand3  g105(.a(new_n97_), .b(x19), .c(new_n125_), .O(new_n152_));
  oai22  g106(.a(new_n152_), .b(new_n151_), .c(new_n55_), .d(new_n125_), .O(new_n153_));
