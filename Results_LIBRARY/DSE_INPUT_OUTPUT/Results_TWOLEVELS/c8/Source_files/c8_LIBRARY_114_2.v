...
module FAU ( 
  ...
  nor2   g048(.a(new_n83_), .b(x16), .O(new_n95_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n93_), .c(new_n101_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x16), .O(new_n121_));
  nand2  g075(.a(new_n95_), .b(x04), .O(new_n122_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n118_), .c(new_n102_), .d(new_n91_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n95_), .b(x06), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n118_), .c(new_n102_), .d(new_n91_), .O(new_n152_));
