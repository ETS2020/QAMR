...
module FAU ( 
  ...
  nand3  g082(.a(new_n128_), .b(new_n103_), .c(new_n63_), .O(new_n129_));
  ...
  nand4  g090(.a(new_n120_), .b(new_n103_), .c(new_n76_), .d(new_n73_), .O(new_n137_));
  ...
  oai22  g095(.a(new_n99_), .b(new_n141_), .c(x18), .d(new_n83_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n93_), .O(new_n143_));
  nand2  g097(.a(new_n137_), .b(x25), .O(new_n144_));
  nor2   g098(.a(x25), .b(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n128_), .c(new_n110_), .d(new_n91_), .O(new_n146_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n128_), .c(new_n110_), .d(new_n91_), .O(new_n154_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n47_), .c(new_n158_), .O(z16));
  nand2  g113(.a(new_n153_), .b(new_n128_), .O(new_n160_));
  nand3  g114(.a(new_n110_), .b(x19), .c(new_n89_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n53_), .d(new_n89_), .O(new_n162_));
