...
module FAU ( 
  ...
  nand4  g51(.a(new_n62_), .b(new_n57_), .c(new_n51_), .d(new_n83_), .O(new_n98_));
  ...
  oai22  g57(.a(new_n103_), .b(new_n87_), .c(new_n93_), .d(new_n65_), .O(z12));
  nor2   g58(.a(x22), .b(x21), .O(new_n105_));
  nand3  g59(.a(new_n105_), .b(new_n85_), .c(new_n57_), .O(new_n106_));
  nor3   g60(.a(x23), .b(x22), .c(x21), .O(new_n107_));
  aoi22  g61(.a(new_n107_), .b(new_n91_), .c(new_n106_), .d(x23), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n87_), .c(new_n93_), .d(new_n68_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n87_), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n91_), .c(new_n73_), .O(new_n111_));
  ...
  nand4  g74(.a(new_n120_), .b(new_n73_), .c(new_n119_), .d(new_n118_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n99_), .c(new_n113_), .d(x25), .O(new_n123_));
  ...
  nand3  g87(.a(new_n47_), .b(new_n87_), .c(x15), .O(new_n134_));
