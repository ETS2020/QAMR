...
module FAU ( 
  ...
  nand3  g044(.a(new_n90_), .b(x08), .c(new_n48_), .O(new_n91_));
  ...
  nand2  g052(.a(new_n98_), .b(new_n88_), .O(new_n99_));
  nor2   g053(.a(x19), .b(x17), .O(new_n100_));
  nor2   g054(.a(new_n100_), .b(new_n54_), .O(new_n101_));
  ...
  nand3  g059(.a(new_n90_), .b(x10), .c(new_n48_), .O(new_n106_));
  ...
  oai21  g064(.a(new_n102_), .b(new_n60_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n86_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n108_), .O(z11));
  nand2  g067(.a(x18), .b(x03), .O(new_n114_));
  nand3  g068(.a(new_n90_), .b(x11), .c(new_n48_), .O(new_n115_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n100_), .c(new_n54_), .O(new_n120_));
  ...
  nand3  g077(.a(new_n90_), .b(x12), .c(new_n48_), .O(new_n124_));
  oai21  g078(.a(new_n90_), .b(new_n48_), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n102_), .c(new_n73_), .O(new_n136_));
  inv1   g090(.a(x17), .O(new_n137_));
  nor2   g091(.a(x20), .b(x19), .O(new_n138_));
  nor2   g092(.a(x24), .b(x23), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n119_), .c(new_n138_), .d(new_n137_), .O(new_n140_));
  inv1   g094(.a(new_n140_), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n136_), .c(x16), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n135_), .c(new_n86_), .O(z14));
  nand2  g097(.a(x18), .b(x06), .O(new_n144_));
  oai21  g098(.a(x18), .b(new_n76_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n88_), .O(new_n146_));
  nand2  g100(.a(new_n140_), .b(x25), .O(new_n147_));
  nor2   g101(.a(x23), .b(x22), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n148_), .c(new_n109_), .d(new_n100_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n147_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n146_), .c(new_n86_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n90_), .b(x15), .c(new_n48_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n88_), .O(new_n157_));
  nand2  g111(.a(new_n150_), .b(x26), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n148_), .c(new_n109_), .d(new_n100_), .O(new_n160_));
  ...
  nand4  g117(.a(new_n148_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n164_));
  nand3  g118(.a(new_n109_), .b(x19), .c(new_n137_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n55_), .d(new_n137_), .O(new_n166_));
