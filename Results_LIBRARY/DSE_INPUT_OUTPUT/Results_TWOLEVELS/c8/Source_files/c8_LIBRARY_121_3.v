...
module FAU ( 
  ...
  nand3  g044(.a(new_n90_), .b(new_n52_), .c(x16), .O(new_n91_));
  ...
  nand3  g053(.a(new_n99_), .b(new_n95_), .c(new_n52_), .O(z10));
  ...
  aoi22  g058(.a(new_n104_), .b(new_n96_), .c(new_n103_), .d(x21), .O(new_n105_));
  nor2   g059(.a(x18), .b(x16), .O(new_n106_));
  aoi21  g060(.a(new_n106_), .b(x10), .c(new_n53_), .O(new_n107_));
  oai21  g061(.a(new_n105_), .b(new_n85_), .c(new_n107_), .O(z11));
  nand2  g062(.a(x18), .b(x03), .O(new_n109_));
  oai22  g063(.a(new_n109_), .b(x02), .c(x18), .d(new_n65_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  nand2  g065(.a(new_n104_), .b(new_n96_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x22), .O(new_n113_));
  nor2   g067(.a(x22), .b(x21), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n96_), .c(new_n57_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n52_), .c(x16), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n111_), .O(z12));
  nand2  g072(.a(x18), .b(x04), .O(new_n119_));
  oai22  g073(.a(new_n119_), .b(x02), .c(x18), .d(new_n70_), .O(new_n120_));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n98_), .c(new_n75_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n114_), .c(new_n102_), .d(new_n101_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n130_), .c(new_n52_), .O(z14));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n96_), .O(new_n143_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n104_), .d(new_n96_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n149_), .c(new_n52_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n141_), .c(new_n75_), .O(new_n157_));
  nand3  g111(.a(new_n104_), .b(x19), .c(new_n101_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n50_), .d(new_n101_), .O(new_n159_));
