...
module FAU ( 
  ...
  nor2   g001(.a(new_n47_), .b(x09), .O(new_n48_));
  ...
  oai21  g060(.a(new_n95_), .b(new_n103_), .c(new_n106_), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(x16), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n102_), .c(new_n93_), .O(z10));
  inv1   g063(.a(x02), .O(new_n110_));
  oai22  g064(.a(new_n90_), .b(new_n110_), .c(x18), .d(new_n60_), .O(new_n111_));
  ...
  aoi21  g069(.a(new_n115_), .b(new_n113_), .c(new_n48_), .O(new_n116_));
  nor3   g070(.a(new_n86_), .b(new_n62_), .c(new_n51_), .O(new_n117_));
  ...
  aoi21  g076(.a(new_n114_), .b(new_n95_), .c(new_n67_), .O(new_n123_));
  nand3  g077(.a(new_n67_), .b(new_n62_), .c(new_n103_), .O(new_n124_));
  nor2   g078(.a(new_n124_), .b(new_n96_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n123_), .c(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n122_), .c(new_n93_), .O(z12));
  inv1   g081(.a(x04), .O(new_n128_));
  oai22  g082(.a(new_n90_), .b(new_n128_), .c(x18), .d(new_n70_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n88_), .O(new_n130_));
  nand4  g084(.a(new_n67_), .b(new_n103_), .c(new_n51_), .d(new_n104_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x23), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n105_), .c(new_n62_), .d(new_n104_), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(new_n132_), .c(new_n48_), .O(new_n135_));
  nor3   g089(.a(new_n86_), .b(new_n72_), .c(new_n62_), .O(new_n136_));
  ...
  and2   g095(.a(new_n134_), .b(x24), .O(new_n142_));
  inv1   g096(.a(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n72_), .c(new_n67_), .d(new_n62_), .O(new_n144_));
  nor2   g098(.a(new_n144_), .b(new_n106_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n142_), .c(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n141_), .c(new_n93_), .O(z14));
  ...
  nand4  g105(.a(new_n151_), .b(new_n133_), .c(new_n114_), .d(new_n95_), .O(new_n152_));
  oai21  g106(.a(new_n145_), .b(new_n80_), .c(new_n152_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n150_), .c(new_n93_), .O(z15));
  ...
  nand3  g114(.a(new_n160_), .b(new_n133_), .c(new_n143_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n115_), .c(new_n159_), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(x16), .O(new_n163_));
  nand3  g117(.a(new_n163_), .b(new_n158_), .c(new_n93_), .O(z16));
  nand3  g118(.a(new_n114_), .b(x19), .c(new_n104_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n161_), .c(new_n52_), .d(new_n104_), .O(new_n166_));
  nand3  g120(.a(new_n166_), .b(new_n93_), .c(x16), .O(new_n167_));
