...
module FAU ( 
  ...
  nand3  g082(.a(new_n128_), .b(new_n63_), .c(new_n101_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n96_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n85_), .O(new_n133_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n119_), .c(new_n103_), .d(new_n88_), .O(new_n142_));
