...
module FAU ( 
  ...
  nand3  g068(.a(new_n114_), .b(new_n87_), .c(new_n93_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n103_), .c(x16), .O(new_n117_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n105_), .d(new_n87_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n103_), .c(x16), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n105_), .d(new_n87_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n103_), .c(x16), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n149_), .O(z16));
  nand4  g109(.a(new_n141_), .b(new_n81_), .c(new_n76_), .d(new_n71_), .O(new_n156_));
  nand3  g110(.a(new_n105_), .b(x19), .c(new_n129_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n61_), .d(new_n129_), .O(new_n158_));
