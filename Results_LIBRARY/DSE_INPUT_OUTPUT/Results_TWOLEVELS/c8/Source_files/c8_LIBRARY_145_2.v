...
module FAU ( 
  ...
  nor2   g041(.a(x16), .b(new_n87_), .O(new_n88_));
  aoi21  g042(.a(new_n86_), .b(x16), .c(new_n88_), .O(new_n89_));
  nand3  g043(.a(new_n85_), .b(new_n47_), .c(x08), .O(new_n90_));
  oai21  g044(.a(new_n89_), .b(new_n85_), .c(new_n90_), .O(z09));
  ...
  oai21  g052(.a(new_n95_), .b(new_n57_), .c(new_n98_), .O(new_n99_));
  ...
  nand2  g067(.a(new_n113_), .b(new_n47_), .O(new_n114_));
  nand2  g068(.a(new_n108_), .b(x22), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n95_), .c(new_n57_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(x18), .c(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n114_), .O(z12));
  oai21  g074(.a(x16), .b(x12), .c(new_n85_), .O(new_n121_));
  ...
  nor2   g080(.a(new_n85_), .b(x16), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(x04), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n126_), .c(new_n121_), .O(z13));
  oai21  g083(.a(x16), .b(x13), .c(new_n85_), .O(new_n130_));
  aoi21  g084(.a(new_n123_), .b(new_n106_), .c(new_n73_), .O(new_n131_));
  ...
  nand2  g089(.a(new_n127_), .b(x05), .O(new_n136_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n107_), .d(new_n95_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n127_), .b(x06), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n107_), .d(new_n95_), .O(new_n152_));
  ...
  nand3  g110(.a(new_n156_), .b(new_n140_), .c(new_n73_), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x19), .c(new_n96_), .O(new_n158_));
