...
module FAU ( 
  ...
  oai21  g043(.a(x18), .b(new_n47_), .c(new_n89_), .O(new_n90_));
  ...
  nand3  g048(.a(new_n94_), .b(x09), .c(x06), .O(new_n95_));
  ...
  oai21  g053(.a(new_n86_), .b(new_n53_), .c(new_n99_), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n82_), .c(x16), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n97_), .O(z10));
  nand2  g056(.a(x18), .b(x02), .O(new_n103_));
  nand3  g057(.a(new_n94_), .b(x10), .c(x06), .O(new_n104_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n82_), .c(x16), .O(new_n112_));
  ...
  aoi21  g071(.a(new_n109_), .b(new_n86_), .c(new_n117_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n86_), .c(new_n53_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n116_), .c(new_n82_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  oai21  g078(.a(x18), .b(new_n63_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n88_), .O(new_n126_));
  nand2  g080(.a(new_n120_), .b(x23), .O(new_n127_));
  nor3   g081(.a(x23), .b(x22), .c(x21), .O(new_n128_));
  nand2  g082(.a(new_n128_), .b(new_n108_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(x16), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n126_), .c(new_n82_), .O(z13));
  nand2  g086(.a(x18), .b(x05), .O(new_n133_));
  oai21  g087(.a(x18), .b(new_n66_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n88_), .O(new_n135_));
  aoi21  g089(.a(new_n128_), .b(new_n108_), .c(new_n68_), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n119_), .c(new_n98_), .d(new_n83_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n135_), .c(new_n82_), .O(z14));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n109_), .d(new_n86_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n144_), .c(new_n82_), .O(z15));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n109_), .d(new_n86_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n154_), .c(new_n82_), .O(z16));
  nand4  g114(.a(new_n146_), .b(new_n78_), .c(new_n73_), .d(new_n68_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n83_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n54_), .d(new_n83_), .O(new_n163_));
