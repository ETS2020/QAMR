...
module FAU ( 
  ...
  oai21  g053(.a(new_n93_), .b(new_n60_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(x16), .O(new_n101_));
  nand2  g055(.a(new_n88_), .b(x02), .O(new_n102_));
  nand3  g056(.a(new_n102_), .b(new_n101_), .c(new_n97_), .O(z11));
  oai21  g057(.a(x16), .b(x11), .c(new_n81_), .O(new_n104_));
  aoi21  g058(.a(new_n98_), .b(new_n86_), .c(new_n65_), .O(new_n105_));
  nor2   g059(.a(x22), .b(x21), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n86_), .c(new_n54_), .O(new_n107_));
  inv1   g061(.a(new_n107_), .O(new_n108_));
  oai21  g062(.a(new_n108_), .b(new_n105_), .c(x16), .O(new_n109_));
  nand2  g063(.a(new_n88_), .b(x03), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n109_), .c(new_n104_), .O(z12));
  oai21  g065(.a(x16), .b(x12), .c(new_n81_), .O(new_n112_));
  nand2  g066(.a(new_n107_), .b(x23), .O(new_n113_));
  nor2   g067(.a(x23), .b(x22), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n93_), .c(new_n60_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(x16), .O(new_n117_));
  nand2  g071(.a(new_n88_), .b(x04), .O(new_n118_));
  ...
  nand3  g076(.a(new_n54_), .b(new_n84_), .c(new_n83_), .O(new_n123_));
  inv1   g077(.a(x23), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n65_), .c(new_n60_), .O(new_n125_));
  oai21  g079(.a(new_n125_), .b(new_n123_), .c(x24), .O(new_n126_));
  nor2   g080(.a(x20), .b(x19), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n106_), .c(new_n127_), .d(new_n83_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n126_), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(x18), .c(x16), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n122_), .O(z14));
  oai21  g086(.a(x16), .b(x14), .c(new_n81_), .O(new_n133_));
  nand2  g087(.a(new_n129_), .b(x25), .O(new_n134_));
  nor2   g088(.a(x25), .b(x24), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n114_), .c(new_n98_), .d(new_n86_), .O(new_n136_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n114_), .c(new_n98_), .d(new_n86_), .O(new_n146_));
  ...
  nand2  g103(.a(new_n124_), .b(new_n65_), .O(new_n150_));
  inv1   g104(.a(x24), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  inv1   g106(.a(x26), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n151_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n150_), .O(new_n155_));
  nand3  g109(.a(new_n98_), .b(x19), .c(new_n83_), .O(new_n156_));
