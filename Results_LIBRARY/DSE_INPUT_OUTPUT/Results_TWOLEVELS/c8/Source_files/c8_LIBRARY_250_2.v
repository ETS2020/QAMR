...
module FAU ( 
  ...
  nor2   g052(.a(new_n87_), .b(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x01), .O(new_n100_));
  ...
  oai21  g060(.a(new_n97_), .b(new_n62_), .c(new_n106_), .O(new_n107_));
  ...
  aoi21  g082(.a(new_n123_), .b(new_n97_), .c(new_n77_), .O(new_n129_));
  ...
  nand2  g089(.a(new_n99_), .b(x05), .O(new_n136_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n105_), .d(new_n95_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n99_), .b(x06), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n140_), .c(new_n105_), .d(new_n95_), .O(new_n152_));
