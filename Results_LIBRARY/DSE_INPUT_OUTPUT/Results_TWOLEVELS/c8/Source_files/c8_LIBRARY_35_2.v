...
module FAU ( 
  ...
  oai21  g057(.a(new_n96_), .b(new_n60_), .c(new_n103_), .O(new_n104_));
  ...
  nand2  g076(.a(new_n98_), .b(x04), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n122_), .c(new_n117_), .O(z13));
  oai21  g078(.a(x16), .b(x13), .c(new_n85_), .O(new_n125_));
  inv1   g079(.a(x24), .O(new_n126_));
  aoi21  g080(.a(new_n119_), .b(new_n96_), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g087(.a(new_n98_), .b(x05), .O(new_n134_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n102_), .d(new_n94_), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n102_), .d(new_n94_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n98_), .b(x07), .O(new_n152_));
