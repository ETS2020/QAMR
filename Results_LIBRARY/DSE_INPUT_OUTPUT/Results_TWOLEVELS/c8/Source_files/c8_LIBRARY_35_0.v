...
module FAU ( 
  ...
  oai21  g46(.a(new_n88_), .b(x01), .c(new_n92_), .O(new_n93_));
  inv1   g47(.a(x20), .O(new_n94_));
  nor2   g48(.a(new_n86_), .b(new_n94_), .O(new_n95_));
  ...
  oai21  g52(.a(new_n88_), .b(x02), .c(new_n92_), .O(new_n99_));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n84_), .O(new_n101_));
  nand4  g55(.a(new_n59_), .b(new_n94_), .c(new_n50_), .d(new_n84_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n92_), .c(new_n99_), .O(z11));
  nand2  g59(.a(new_n102_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n86_), .c(new_n94_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nand2  g63(.a(new_n89_), .b(x03), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n92_), .c(new_n110_), .O(z12));
  oai21  g65(.a(new_n88_), .b(x04), .c(new_n92_), .O(new_n112_));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n96_), .c(new_n108_), .d(x23), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n92_), .c(new_n112_), .O(z13));
  oai21  g69(.a(new_n88_), .b(x05), .c(new_n92_), .O(new_n116_));
  inv1   g70(.a(x24), .O(new_n117_));
  aoi21  g71(.a(new_n113_), .b(new_n96_), .c(new_n117_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n107_), .c(new_n100_), .d(new_n84_), .O(new_n120_));
  ...
  nand4  g78(.a(new_n75_), .b(new_n117_), .c(new_n67_), .d(new_n124_), .O(new_n125_));
  ...
  oai21  g82(.a(new_n127_), .b(new_n92_), .c(new_n128_), .O(z15));
  oai21  g83(.a(new_n88_), .b(x07), .c(new_n92_), .O(new_n130_));
  ...
  nand4  g95(.a(new_n132_), .b(new_n80_), .c(new_n75_), .d(new_n117_), .O(new_n142_));
