...
module FAU ( 
  ...
  oai21  g031(.a(x18), .b(new_n48_), .c(new_n55_), .O(z08));
  ...
  nor2   g043(.a(new_n89_), .b(new_n54_), .O(new_n90_));
  nor3   g044(.a(x20), .b(x19), .c(x17), .O(new_n91_));
  oai21  g045(.a(new_n91_), .b(new_n90_), .c(x16), .O(new_n92_));
  nor2   g046(.a(new_n79_), .b(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(x01), .O(new_n94_));
  nand3  g048(.a(new_n94_), .b(new_n92_), .c(new_n88_), .O(z10));
  oai21  g049(.a(x16), .b(x10), .c(new_n79_), .O(new_n96_));
  inv1   g050(.a(x21), .O(new_n97_));
  nor2   g051(.a(x21), .b(x20), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n89_), .O(new_n99_));
  oai21  g053(.a(new_n91_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(x16), .O(new_n101_));
  nand2  g055(.a(new_n93_), .b(x02), .O(new_n102_));
  ...
  aoi21  g059(.a(new_n98_), .b(new_n89_), .c(new_n105_), .O(new_n106_));
  nor2   g060(.a(x22), .b(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n89_), .c(new_n54_), .O(new_n108_));
  inv1   g062(.a(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n93_), .b(x03), .O(new_n111_));
  ...
  nand2  g068(.a(new_n114_), .b(new_n48_), .O(new_n115_));
  nand2  g069(.a(new_n108_), .b(x23), .O(new_n116_));
  ...
  nand3  g073(.a(new_n119_), .b(x18), .c(x16), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n115_), .O(z13));
  oai21  g075(.a(x16), .b(x13), .c(new_n79_), .O(new_n122_));
  aoi21  g076(.a(new_n117_), .b(new_n91_), .c(new_n69_), .O(new_n123_));
  ...
  nand2  g082(.a(new_n93_), .b(x05), .O(new_n129_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n98_), .d(new_n89_), .O(new_n137_));
  ...
  nand2  g096(.a(new_n142_), .b(new_n48_), .O(new_n143_));
  nand2  g097(.a(new_n137_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n135_), .c(new_n98_), .d(new_n89_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(x18), .c(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n143_), .O(z16));
  inv1   g103(.a(x23), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n105_), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  inv1   g106(.a(x26), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n69_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand3  g109(.a(new_n98_), .b(x19), .c(new_n81_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n55_), .b(new_n81_), .O(new_n158_));
  aoi21  g112(.a(new_n157_), .b(new_n155_), .c(new_n158_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(x18), .c(new_n48_), .O(z17));
endmodule
