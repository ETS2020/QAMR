...
module FAU ( 
  ...
  oai21  g030(.a(x27), .b(new_n76_), .c(new_n48_), .O(new_n77_));
  nand3  g031(.a(new_n55_), .b(new_n76_), .c(x18), .O(new_n78_));
  nand2  g032(.a(new_n78_), .b(new_n77_), .O(z06));
  ...
  nor2   g038(.a(x18), .b(x14), .O(new_n85_));
  ...
  nor2   g050(.a(new_n88_), .b(new_n54_), .O(new_n97_));
  ...
  oai21  g059(.a(new_n98_), .b(new_n60_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n111_), .c(new_n83_), .O(z12));
  ...
  nand2  g077(.a(new_n123_), .b(new_n98_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(x16), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n121_), .c(new_n83_), .O(z13));
  ...
  aoi21  g084(.a(new_n123_), .b(new_n98_), .c(new_n73_), .O(new_n131_));
  inv1   g085(.a(x17), .O(new_n132_));
  nor2   g086(.a(x20), .b(x19), .O(new_n133_));
  nor2   g087(.a(x24), .b(x23), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n114_), .c(new_n133_), .d(new_n132_), .O(new_n135_));
  inv1   g089(.a(new_n135_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n131_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n130_), .c(new_n83_), .O(z14));
  nand2  g092(.a(new_n135_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x23), .b(x22), .O(new_n140_));
  nor2   g094(.a(x25), .b(x24), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n104_), .d(new_n88_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n83_), .c(x16), .O(new_n144_));
  nand3  g098(.a(x18), .b(new_n93_), .c(x06), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n144_), .O(z15));
  nand2  g100(.a(x18), .b(x07), .O(new_n147_));
  inv1   g101(.a(x18), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(x15), .c(new_n48_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n140_), .c(new_n104_), .d(new_n88_), .O(new_n154_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n140_), .c(new_n73_), .O(new_n159_));
  nand3  g113(.a(new_n104_), .b(x19), .c(new_n132_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n132_), .O(new_n161_));
