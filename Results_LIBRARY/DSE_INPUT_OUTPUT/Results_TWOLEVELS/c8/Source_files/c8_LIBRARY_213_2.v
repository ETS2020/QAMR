// Benchmark "FAU" written by ABC on Tue Aug 18 15:55:04 2020
...
module FAU ( 
  ...
  oai21  g021(.a(x27), .b(new_n67_), .c(new_n48_), .O(new_n68_));
  nand3  g022(.a(new_n55_), .b(new_n67_), .c(x18), .O(new_n69_));
  nand2  g023(.a(new_n69_), .b(new_n68_), .O(z05));
  ...
  nor2   g035(.a(x18), .b(x13), .O(new_n82_));
  ...
  nand3  g045(.a(new_n54_), .b(new_n91_), .c(new_n90_), .O(new_n92_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n99_), .c(new_n84_), .O(z11));
  nand2  g060(.a(x18), .b(x03), .O(new_n107_));
  nand2  g061(.a(new_n82_), .b(x11), .O(new_n108_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n89_), .c(new_n54_), .O(new_n113_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n101_), .c(new_n100_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(x16), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n119_), .c(new_n84_), .O(z13));
  inv1   g079(.a(x22), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n100_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n92_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n112_), .c(new_n130_), .d(new_n90_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n84_), .c(x16), .O(new_n134_));
  nand3  g088(.a(x18), .b(new_n96_), .c(x05), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n134_), .O(z14));
  nand2  g090(.a(x18), .b(x06), .O(new_n137_));
  inv1   g091(.a(x18), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(x14), .c(new_n48_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n96_), .O(new_n141_));
  nand2  g095(.a(new_n132_), .b(x25), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n121_), .c(new_n102_), .d(new_n89_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n84_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n141_), .O(z15));
  nand2  g101(.a(x18), .b(x07), .O(new_n148_));
  oai21  g102(.a(x18), .b(new_n76_), .c(new_n148_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n121_), .c(new_n102_), .d(new_n89_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n150_), .c(new_n84_), .O(z16));
  nand4  g110(.a(new_n121_), .b(new_n78_), .c(new_n73_), .d(new_n67_), .O(new_n157_));
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n90_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n90_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand2  g114(.a(new_n160_), .b(new_n84_), .O(z17));
endmodule
