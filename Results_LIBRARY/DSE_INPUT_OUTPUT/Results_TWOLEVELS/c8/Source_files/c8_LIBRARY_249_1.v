...
module FAU ( 
  ...
  nor2   g29(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  oai21  g36(.a(x18), .b(x08), .c(new_n82_), .O(new_n83_));
  nand2  g37(.a(new_n83_), .b(new_n81_), .O(z09));
  ...
  oai21  g44(.a(new_n90_), .b(new_n52_), .c(new_n88_), .O(z10));
  oai21  g45(.a(x18), .b(x10), .c(new_n82_), .O(new_n92_));
  nor2   g46(.a(x20), .b(x19), .O(new_n93_));
  nand2  g47(.a(new_n93_), .b(new_n77_), .O(new_n94_));
  inv1   g48(.a(x21), .O(new_n95_));
  nand4  g49(.a(new_n95_), .b(new_n85_), .c(new_n78_), .d(new_n77_), .O(new_n96_));
  inv1   g50(.a(new_n96_), .O(new_n97_));
  aoi21  g51(.a(new_n94_), .b(x21), .c(new_n97_), .O(new_n98_));
  oai21  g52(.a(new_n98_), .b(new_n82_), .c(new_n92_), .O(z11));
  nor3   g53(.a(x22), .b(x21), .c(x20), .O(new_n100_));
  aoi22  g54(.a(new_n100_), .b(new_n80_), .c(new_n96_), .d(x22), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n82_), .c(new_n90_), .d(new_n58_), .O(z12));
  oai21  g56(.a(x18), .b(x12), .c(new_n82_), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n80_), .c(new_n85_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n87_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai21  g61(.a(new_n107_), .b(new_n82_), .c(new_n103_), .O(z13));
  oai21  g62(.a(x18), .b(x13), .c(new_n82_), .O(new_n109_));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n106_), .b(new_n87_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n104_), .c(new_n93_), .d(new_n77_), .O(new_n113_));
  ...
  nand4  g72(.a(new_n118_), .b(new_n110_), .c(new_n117_), .d(new_n60_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n97_), .c(new_n113_), .d(x25), .O(new_n121_));
  nand2  g75(.a(new_n89_), .b(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n82_), .c(new_n122_), .O(z15));
  nor2   g77(.a(x21), .b(x20), .O(new_n124_));
  nor2   g78(.a(x23), .b(x22), .O(new_n125_));
  nor2   g79(.a(x25), .b(x24), .O(new_n126_));
  nand4  g80(.a(new_n126_), .b(new_n125_), .c(new_n124_), .d(new_n80_), .O(new_n127_));
  nand2  g81(.a(new_n127_), .b(x26), .O(new_n128_));
  nor3   g82(.a(x26), .b(x25), .c(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n125_), .c(new_n124_), .d(new_n80_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand2  g85(.a(new_n131_), .b(x16), .O(new_n132_));
  nand2  g86(.a(new_n89_), .b(x15), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n132_), .O(z16));
  nor2   g88(.a(new_n78_), .b(x17), .O(new_n135_));
