...
module FAU ( 
  ...
  nand3  g038(.a(x18), .b(x01), .c(x00), .O(new_n85_));
  ...
  nand3  g045(.a(new_n91_), .b(new_n82_), .c(x16), .O(new_n92_));
  ...
  aoi21  g065(.a(new_n103_), .b(new_n89_), .c(new_n111_), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n89_), .c(new_n57_), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai21  g069(.a(new_n115_), .b(new_n112_), .c(x16), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n110_), .c(new_n82_), .O(z12));
  ...
  nand3  g080(.a(x18), .b(x05), .c(x01), .O(new_n127_));
  ...
  nand3  g084(.a(new_n57_), .b(new_n49_), .c(new_n130_), .O(new_n131_));
  inv1   g085(.a(x23), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n111_), .c(new_n102_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n131_), .c(x24), .O(new_n134_));
  nor2   g088(.a(x20), .b(x19), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand4  g090(.a(new_n136_), .b(new_n113_), .c(new_n135_), .d(new_n130_), .O(new_n137_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n122_), .c(new_n103_), .d(new_n89_), .O(new_n146_));
  ...
  nand3  g103(.a(x18), .b(x07), .c(x01), .O(new_n150_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n122_), .c(new_n103_), .d(new_n89_), .O(new_n155_));
  ...
  nand4  g113(.a(new_n122_), .b(new_n79_), .c(new_n74_), .d(new_n159_), .O(new_n160_));
  nand3  g114(.a(new_n103_), .b(x19), .c(new_n130_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n50_), .d(new_n130_), .O(new_n162_));
