...
module FAU ( 
  ...
  nand2  g006(.a(x03), .b(new_n52_), .O(new_n53_));
  ...
  oai21  g061(.a(x18), .b(x10), .c(x02), .O(new_n108_));
  inv1   g062(.a(x18), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(x10), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(x03), .c(new_n108_), .O(new_n111_));
  ...
  oai21  g071(.a(new_n109_), .b(x16), .c(x02), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x03), .O(new_n119_));
  aoi21  g073(.a(new_n113_), .b(new_n94_), .c(new_n66_), .O(new_n120_));
  ...
  nand3  g077(.a(new_n109_), .b(new_n96_), .c(x11), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n123_), .c(new_n119_), .O(z12));
  ...
  oai21  g084(.a(new_n122_), .b(new_n71_), .c(new_n130_), .O(new_n131_));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n105_), .c(new_n78_), .O(new_n137_));
  nand3  g091(.a(new_n55_), .b(new_n47_), .c(new_n92_), .O(new_n138_));
  nand4  g092(.a(new_n78_), .b(new_n71_), .c(new_n66_), .d(new_n63_), .O(new_n139_));
  nor2   g093(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n137_), .c(x16), .O(new_n141_));
  aoi21  g095(.a(new_n141_), .b(new_n136_), .c(new_n60_), .O(z14));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n113_), .d(new_n94_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n113_), .d(new_n94_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n154_), .c(new_n60_), .O(z16));
  nand2  g114(.a(new_n156_), .b(new_n146_), .O(new_n161_));
  nand3  g115(.a(new_n113_), .b(x19), .c(new_n92_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n48_), .d(new_n92_), .O(new_n163_));
