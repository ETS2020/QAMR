...
module FAU ( 
  ...
  aoi21  g041(.a(x18), .b(new_n52_), .c(new_n48_), .O(z08));
  ...
  oai22  g062(.a(new_n91_), .b(new_n108_), .c(x18), .d(new_n63_), .O(new_n109_));
  ...
  aoi21  g073(.a(new_n112_), .b(new_n95_), .c(new_n68_), .O(new_n120_));
  nand2  g074(.a(new_n68_), .b(new_n61_), .O(new_n121_));
  nor3   g075(.a(new_n121_), .b(new_n96_), .c(x20), .O(new_n122_));
  ...
  nor2   g081(.a(new_n122_), .b(new_n71_), .O(new_n128_));
  nor3   g082(.a(x23), .b(x22), .c(x21), .O(new_n129_));
  and2   g083(.a(new_n129_), .b(new_n111_), .O(new_n130_));
  ...
  oai21  g087(.a(x18), .b(new_n52_), .c(new_n133_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n89_), .O(new_n135_));
  inv1   g089(.a(x24), .O(new_n136_));
  nor2   g090(.a(new_n130_), .b(new_n136_), .O(new_n137_));
  nor4   g091(.a(new_n121_), .b(new_n104_), .c(x24), .d(x23), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n137_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n135_), .c(new_n53_), .O(z14));
  inv1   g094(.a(x06), .O(new_n141_));
  oai22  g095(.a(new_n91_), .b(new_n141_), .c(x18), .d(new_n78_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n89_), .O(new_n143_));
  aoi22  g097(.a(new_n129_), .b(new_n111_), .c(x18), .d(new_n52_), .O(new_n144_));
  nor2   g098(.a(new_n55_), .b(new_n136_), .O(new_n145_));
  oai21  g099(.a(new_n145_), .b(new_n144_), .c(x25), .O(new_n146_));
  nand4  g100(.a(new_n53_), .b(new_n80_), .c(new_n136_), .d(new_n71_), .O(new_n147_));
  nor2   g101(.a(new_n147_), .b(x22), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n61_), .c(new_n58_), .d(new_n47_), .O(new_n149_));
  oai21  g103(.a(new_n149_), .b(x17), .c(new_n146_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n143_), .O(z15));
  nor2   g106(.a(x18), .b(new_n83_), .O(new_n153_));
  aoi21  g107(.a(x18), .b(x07), .c(new_n153_), .O(new_n154_));
  nor2   g108(.a(x23), .b(x22), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n80_), .c(new_n136_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n113_), .c(x26), .O(new_n157_));
  nand4  g111(.a(new_n155_), .b(new_n85_), .c(new_n80_), .d(new_n136_), .O(new_n158_));
  oai21  g112(.a(new_n158_), .b(new_n113_), .c(new_n157_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(x16), .c(new_n55_), .O(new_n160_));
  oai21  g114(.a(new_n154_), .b(x16), .c(new_n160_), .O(z16));
  nand3  g115(.a(new_n112_), .b(x19), .c(new_n103_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n158_), .c(new_n48_), .d(new_n103_), .O(new_n163_));
