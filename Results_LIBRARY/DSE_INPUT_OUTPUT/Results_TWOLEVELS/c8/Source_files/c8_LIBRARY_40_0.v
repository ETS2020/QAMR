...
module FAU ( 
  ...
  aoi21  g013(.a(x27), .b(new_n59_), .c(new_n52_), .O(new_n60_));
  ...
  nor2   g051(.a(new_n90_), .b(new_n56_), .O(new_n98_));
  nor3   g052(.a(x20), .b(x19), .c(x17), .O(new_n99_));
  oai21  g053(.a(new_n99_), .b(new_n98_), .c(x16), .O(new_n100_));
  nand3  g054(.a(new_n100_), .b(new_n97_), .c(new_n81_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n104_), .c(new_n81_), .O(z11));
  ...
  nand3  g070(.a(new_n116_), .b(new_n90_), .c(new_n56_), .O(new_n117_));
  inv1   g071(.a(new_n117_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n115_), .c(x16), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n113_), .c(new_n81_), .O(z12));
  ...
  nand3  g082(.a(new_n128_), .b(new_n123_), .c(new_n81_), .O(z13));
  nand2  g083(.a(x18), .b(x05), .O(new_n130_));
  nand3  g084(.a(new_n85_), .b(x13), .c(x01), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n83_), .O(new_n133_));
  inv1   g087(.a(x17), .O(new_n134_));
  nand3  g088(.a(new_n56_), .b(new_n49_), .c(new_n134_), .O(new_n135_));
  ...
  nand3  g096(.a(new_n142_), .b(new_n81_), .c(x16), .O(new_n143_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n125_), .c(new_n106_), .d(new_n90_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(x16), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n147_), .c(new_n81_), .O(z15));
  nand2  g107(.a(x18), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n85_), .b(x15), .c(x01), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n83_), .O(new_n157_));
  nand2  g111(.a(new_n150_), .b(x26), .O(new_n158_));
  nor3   g112(.a(x26), .b(x25), .c(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n125_), .c(new_n106_), .d(new_n90_), .O(new_n160_));
  ...
  nand4  g118(.a(new_n125_), .b(new_n78_), .c(new_n73_), .d(new_n164_), .O(new_n165_));
  ...
  nand3  g121(.a(new_n167_), .b(new_n81_), .c(x16), .O(new_n168_));
