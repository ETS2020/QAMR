...
module FAU ( 
  ...
  oai21  g073(.a(new_n119_), .b(new_n89_), .c(x18), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(x17), .O(new_n121_));
  nand3  g075(.a(new_n62_), .b(new_n57_), .c(new_n51_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x22), .O(new_n123_));
  nor2   g077(.a(x22), .b(x21), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n87_), .c(new_n57_), .O(new_n125_));
  ...
  oai21  g083(.a(new_n96_), .b(new_n68_), .c(new_n129_), .O(new_n130_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n100_), .c(new_n62_), .O(new_n135_));
  aoi21  g089(.a(new_n135_), .b(new_n133_), .c(x17), .O(new_n136_));
  nand3  g090(.a(x23), .b(x18), .c(x17), .O(new_n137_));
  ...
  oai21  g098(.a(new_n144_), .b(new_n89_), .c(x18), .O(new_n145_));
  ...
  oai21  g107(.a(new_n96_), .b(new_n74_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g113(.a(new_n159_), .b(new_n134_), .c(new_n111_), .d(new_n51_), .O(new_n160_));
  ...
  oai21  g120(.a(new_n96_), .b(new_n79_), .c(new_n166_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n89_), .O(new_n168_));
  ...
  aoi21  g134(.a(new_n180_), .b(new_n179_), .c(new_n89_), .O(z17));
endmodule
