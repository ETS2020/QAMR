...
module FAU ( 
  ...
  oai21  g033(.a(x27), .b(new_n79_), .c(new_n48_), .O(new_n80_));
  nand3  g034(.a(new_n55_), .b(new_n79_), .c(x18), .O(new_n81_));
  nand2  g035(.a(new_n81_), .b(new_n80_), .O(z07));
  nor2   g036(.a(new_n49_), .b(new_n55_), .O(z08));
  nor2   g037(.a(x18), .b(x15), .O(new_n84_));
  ...
  oai21  g042(.a(new_n85_), .b(x16), .c(new_n88_), .O(z09));
  aoi22  g043(.a(new_n84_), .b(x09), .c(x18), .d(x01), .O(new_n90_));
  ...
  nand3  g049(.a(new_n95_), .b(new_n86_), .c(x16), .O(new_n96_));
  oai21  g050(.a(new_n90_), .b(x16), .c(new_n96_), .O(z10));
  aoi22  g051(.a(new_n84_), .b(x10), .c(x18), .d(x02), .O(new_n98_));
  ...
  nand2  g060(.a(new_n84_), .b(x11), .O(new_n107_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n86_), .O(z13));
