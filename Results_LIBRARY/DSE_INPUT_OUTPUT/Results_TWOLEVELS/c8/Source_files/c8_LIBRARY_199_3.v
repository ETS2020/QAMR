...
module FAU ( 
  ...
  oai21  g049(.a(new_n83_), .b(new_n93_), .c(new_n95_), .O(new_n96_));
  ...
  aoi21  g063(.a(new_n103_), .b(new_n83_), .c(new_n109_), .O(new_n110_));
  ...
  nand2  g068(.a(new_n85_), .b(x11), .O(new_n115_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n92_), .c(x16), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n119_), .O(z13));
  oai21  g079(.a(x16), .b(x05), .c(x18), .O(new_n126_));
  inv1   g080(.a(x24), .O(new_n127_));
  aoi21  g081(.a(new_n121_), .b(new_n102_), .c(new_n127_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n111_), .c(new_n94_), .d(new_n80_), .O(new_n130_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n103_), .d(new_n83_), .O(new_n139_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n103_), .d(new_n83_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n85_), .b(x15), .O(new_n150_));
  ...
  nand3  g107(.a(new_n103_), .b(x19), .c(new_n80_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n58_), .d(new_n80_), .O(new_n155_));
