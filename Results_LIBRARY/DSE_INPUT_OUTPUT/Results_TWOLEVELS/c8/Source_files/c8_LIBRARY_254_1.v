...
module FAU ( 
  ...
  oai22  g62(.a(new_n108_), .b(new_n86_), .c(new_n87_), .d(new_n64_), .O(z13));
  oai21  g63(.a(x18), .b(x13), .c(new_n86_), .O(new_n110_));
  ...
  nand4  g73(.a(new_n119_), .b(new_n111_), .c(new_n66_), .d(new_n118_), .O(new_n120_));
