...
module FAU ( 
  ...
  oai21  g56(.a(new_n101_), .b(new_n96_), .c(new_n102_), .O(z11));
  oai21  g57(.a(new_n86_), .b(x03), .c(new_n96_), .O(new_n104_));
  ...
  aoi22  g64(.a(new_n110_), .b(new_n92_), .c(new_n107_), .d(x23), .O(new_n111_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n92_), .c(new_n115_), .O(new_n116_));
  ...
  nand4  g77(.a(new_n123_), .b(new_n115_), .c(new_n122_), .d(new_n64_), .O(new_n124_));
  ...
  oai21  g82(.a(new_n86_), .b(x07), .c(new_n96_), .O(new_n129_));
  ...
  aoi21  g96(.a(new_n142_), .b(new_n141_), .c(new_n96_), .O(z17));
endmodule
