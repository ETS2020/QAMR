...
module FAU ( 
  ...
  oai21  g069(.a(new_n105_), .b(new_n66_), .c(new_n115_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n104_), .O(new_n117_));
  ...
  oai21  g078(.a(new_n105_), .b(new_n71_), .c(new_n124_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n104_), .O(new_n126_));
  nand3  g080(.a(new_n68_), .b(new_n63_), .c(new_n97_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n92_), .c(x24), .O(new_n128_));
  nor2   g082(.a(x20), .b(x19), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n110_), .c(new_n129_), .d(new_n90_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n128_), .O(new_n132_));
  nand3  g086(.a(new_n132_), .b(new_n84_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n126_), .O(z14));
  nand2  g088(.a(x18), .b(x06), .O(new_n135_));
  oai21  g089(.a(new_n105_), .b(new_n74_), .c(new_n135_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n104_), .O(new_n137_));
  nand2  g091(.a(new_n131_), .b(x25), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n119_), .c(new_n99_), .d(new_n89_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand3  g095(.a(new_n141_), .b(new_n84_), .c(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n137_), .O(z15));
  nand2  g097(.a(new_n140_), .b(x26), .O(new_n144_));
  nor3   g098(.a(x26), .b(x25), .c(x24), .O(new_n145_));
  nand4  g099(.a(new_n145_), .b(new_n119_), .c(new_n99_), .d(new_n89_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(x16), .O(new_n148_));
  inv1   g102(.a(x18), .O(new_n149_));
  nor2   g103(.a(new_n149_), .b(x16), .O(new_n150_));
  aoi21  g104(.a(new_n150_), .b(x07), .c(new_n49_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n148_), .O(z16));
  inv1   g106(.a(x24), .O(new_n153_));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n119_), .c(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n99_), .b(x19), .c(new_n90_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n55_), .d(new_n90_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(x16), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n84_), .O(z17));
endmodule
