...
module FAU ( 
  ...
  oai22  g063(.a(new_n109_), .b(new_n108_), .c(x18), .d(new_n62_), .O(new_n110_));
  ...
  oai21  g070(.a(x18), .b(new_n66_), .c(new_n109_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n96_), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n96_), .c(new_n109_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n113_), .c(x22), .O(new_n120_));
  nand4  g074(.a(new_n53_), .b(new_n68_), .c(new_n60_), .d(new_n55_), .O(new_n121_));
  inv1   g075(.a(new_n121_), .O(new_n122_));
  nand4  g076(.a(new_n122_), .b(new_n47_), .c(new_n92_), .d(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n120_), .c(new_n118_), .O(z12));
  nand3  g078(.a(x18), .b(x04), .c(x03), .O(new_n125_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n94_), .c(new_n55_), .O(new_n129_));
  ...
  aoi21  g092(.a(new_n131_), .b(new_n105_), .c(new_n76_), .O(new_n139_));
  nor2   g093(.a(x20), .b(x19), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n128_), .c(new_n140_), .d(new_n92_), .O(new_n142_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n150_), .c(new_n112_), .d(new_n94_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n148_), .c(new_n53_), .O(z15));
  nand3  g109(.a(x18), .b(x07), .c(x03), .O(new_n156_));
  oai21  g110(.a(x18), .b(new_n88_), .c(new_n156_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n160_), .b(new_n150_), .c(new_n112_), .d(new_n94_), .O(new_n161_));
  ...
  nand4  g118(.a(new_n150_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n165_));
  nand3  g119(.a(new_n112_), .b(x19), .c(new_n92_), .O(new_n166_));
  oai22  g120(.a(new_n166_), .b(new_n165_), .c(new_n48_), .d(new_n92_), .O(new_n167_));
