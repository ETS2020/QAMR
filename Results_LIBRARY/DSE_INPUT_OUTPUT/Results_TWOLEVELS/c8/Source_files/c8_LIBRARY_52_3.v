...
module FAU ( 
  ...
  oai21  g050(.a(new_n84_), .b(new_n94_), .c(new_n96_), .O(new_n97_));
  ...
  nand2  g060(.a(new_n86_), .b(x10), .O(new_n107_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n84_), .c(new_n94_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n93_), .c(x16), .O(new_n116_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n93_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n120_), .O(z13));
  oai21  g080(.a(x16), .b(x05), .c(x18), .O(new_n127_));
  aoi21  g081(.a(new_n122_), .b(new_n102_), .c(new_n71_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n113_), .c(new_n95_), .d(new_n82_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n86_), .b(x13), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n103_), .d(new_n84_), .O(new_n139_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n103_), .d(new_n84_), .O(new_n147_));
  ...
  nand3  g111(.a(new_n103_), .b(x19), .c(new_n82_), .O(new_n158_));
