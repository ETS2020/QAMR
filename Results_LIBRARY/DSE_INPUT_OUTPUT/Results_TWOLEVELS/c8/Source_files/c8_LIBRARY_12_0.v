...
module FAU ( 
  ...
  nor2   g43(.a(new_n82_), .b(new_n56_), .O(new_n90_));
  ...
  nand4  g51(.a(new_n97_), .b(new_n56_), .c(new_n50_), .d(new_n80_), .O(new_n98_));
  ...
  nand3  g58(.a(new_n104_), .b(new_n82_), .c(new_n56_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n88_), .c(new_n102_), .O(z12));
  oai21  g61(.a(new_n84_), .b(x04), .c(new_n88_), .O(new_n108_));
  ...
  aoi21  g66(.a(new_n109_), .b(new_n91_), .c(new_n70_), .O(new_n113_));
  ...
  nand4  g75(.a(new_n121_), .b(new_n70_), .c(new_n120_), .d(new_n119_), .O(new_n122_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n128_), .c(new_n70_), .O(new_n140_));
