...
module FAU ( 
  ...
  nor2   g50(.a(new_n90_), .b(x16), .O(new_n97_));
  nand2  g51(.a(new_n97_), .b(x01), .O(new_n98_));
  nand2  g52(.a(new_n98_), .b(new_n96_), .O(z10));
  ...
  nand2  g59(.a(new_n97_), .b(x02), .O(new_n106_));
  oai21  g60(.a(new_n105_), .b(new_n89_), .c(new_n106_), .O(z11));
  oai21  g61(.a(new_n90_), .b(x03), .c(new_n89_), .O(new_n108_));
  nand2  g62(.a(new_n103_), .b(x22), .O(new_n109_));
  nor2   g63(.a(x22), .b(x21), .O(new_n110_));
  nand3  g64(.a(new_n110_), .b(new_n87_), .c(new_n93_), .O(new_n111_));
  and2   g65(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n89_), .c(new_n108_), .O(z12));
  nor3   g67(.a(x23), .b(x22), .c(x21), .O(new_n114_));
  aoi22  g68(.a(new_n114_), .b(new_n95_), .c(new_n111_), .d(x23), .O(new_n115_));
  nand2  g69(.a(new_n97_), .b(x04), .O(new_n116_));
  oai21  g70(.a(new_n115_), .b(new_n89_), .c(new_n116_), .O(z13));
  aoi21  g71(.a(new_n114_), .b(new_n95_), .c(new_n70_), .O(new_n118_));
  nor2   g72(.a(x24), .b(x23), .O(new_n119_));
  nand4  g73(.a(new_n119_), .b(new_n110_), .c(new_n100_), .d(new_n85_), .O(new_n120_));
  inv1   g74(.a(new_n120_), .O(new_n121_));
  oai21  g75(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand2  g76(.a(new_n97_), .b(x05), .O(new_n123_));
  ...
  aoi22  g81(.a(new_n127_), .b(new_n104_), .c(new_n120_), .d(x25), .O(new_n128_));
  nand2  g82(.a(new_n97_), .b(x06), .O(new_n129_));
  oai21  g83(.a(new_n128_), .b(new_n89_), .c(new_n129_), .O(z15));
  oai21  g84(.a(new_n90_), .b(x07), .c(new_n89_), .O(new_n131_));
