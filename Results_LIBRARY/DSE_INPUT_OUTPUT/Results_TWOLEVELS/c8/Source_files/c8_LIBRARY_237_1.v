...
module FAU ( 
  ...
  nor2   g44(.a(new_n85_), .b(new_n54_), .O(new_n91_));
  ...
  nand4  g51(.a(new_n97_), .b(new_n54_), .c(new_n83_), .d(new_n82_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n96_), .b(x21), .c(new_n99_), .O(new_n100_));
  nand2  g54(.a(new_n48_), .b(new_n87_), .O(new_n101_));
  ...
  oai22  g58(.a(new_n104_), .b(new_n87_), .c(new_n101_), .d(new_n61_), .O(z12));
  oai21  g59(.a(x18), .b(x12), .c(new_n87_), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n85_), .c(new_n54_), .O(new_n108_));
  ...
  nand4  g69(.a(new_n115_), .b(new_n107_), .c(new_n95_), .d(new_n82_), .O(new_n116_));
  ...
  nand3  g88(.a(new_n48_), .b(new_n87_), .c(x15), .O(new_n135_));
  nand2  g89(.a(new_n135_), .b(new_n134_), .O(z16));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n127_), .c(new_n113_), .O(new_n138_));
  nand3  g92(.a(new_n126_), .b(x19), .c(new_n82_), .O(new_n139_));
  oai22  g93(.a(new_n139_), .b(new_n138_), .c(new_n55_), .d(new_n82_), .O(new_n140_));
  nand2  g94(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(new_n80_), .O(z17));
endmodule
