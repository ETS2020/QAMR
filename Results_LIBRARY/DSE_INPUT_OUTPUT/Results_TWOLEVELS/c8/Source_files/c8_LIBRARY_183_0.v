...
module FAU ( 
  ...
  nor2   g001(.a(x16), .b(x00), .O(new_n48_));
  ...
  nand3  g044(.a(new_n90_), .b(new_n47_), .c(x00), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n88_), .O(z09));
  nor2   g047(.a(new_n87_), .b(new_n53_), .O(new_n94_));
  ...
  nand3  g052(.a(new_n98_), .b(new_n97_), .c(x00), .O(new_n99_));
