...
module FAU ( 
  ...
  nand2  g036(.a(x18), .b(new_n77_), .O(new_n83_));
  ...
  oai22  g051(.a(new_n83_), .b(new_n97_), .c(x18), .d(new_n58_), .O(new_n98_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n92_), .c(new_n54_), .O(new_n111_));
  ...
  nand3  g084(.a(new_n130_), .b(new_n63_), .c(new_n100_), .O(new_n131_));
  ...
  nand3  g101(.a(x18), .b(new_n77_), .c(x07), .O(new_n148_));
