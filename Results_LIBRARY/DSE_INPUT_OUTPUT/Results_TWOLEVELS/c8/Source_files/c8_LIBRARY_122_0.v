...
module FAU ( 
  ...
  nand2  g014(.a(x23), .b(x18), .O(new_n61_));
  nand2  g015(.a(new_n61_), .b(new_n47_), .O(new_n62_));
  ...
  nand2  g039(.a(new_n85_), .b(new_n79_), .O(z09));
  inv1   g040(.a(x09), .O(new_n87_));
  nand2  g041(.a(x18), .b(x01), .O(new_n88_));
  oai21  g042(.a(x18), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g043(.a(new_n89_), .b(new_n74_), .O(new_n90_));
  nor2   g044(.a(new_n82_), .b(new_n51_), .O(new_n91_));
  ...
  nand3  g056(.a(new_n102_), .b(new_n98_), .c(new_n80_), .O(z11));
  ...
  aoi21  g061(.a(new_n99_), .b(new_n82_), .c(new_n58_), .O(new_n108_));
  nor2   g062(.a(x22), .b(x21), .O(new_n109_));
  nand3  g063(.a(new_n109_), .b(new_n82_), .c(new_n51_), .O(new_n110_));
  ...
  nand3  g075(.a(new_n121_), .b(new_n80_), .c(x16), .O(new_n122_));
  ...
  aoi21  g081(.a(new_n119_), .b(new_n92_), .c(new_n64_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n127_), .c(new_n80_), .O(z14));
  inv1   g089(.a(x14), .O(new_n136_));
  nand2  g090(.a(x18), .b(x06), .O(new_n137_));
  oai21  g091(.a(new_n77_), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n74_), .O(new_n139_));
  nand2  g093(.a(new_n132_), .b(x25), .O(new_n140_));
  nor2   g094(.a(x23), .b(x22), .O(new_n141_));
  nor2   g095(.a(x25), .b(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n99_), .d(new_n82_), .O(new_n143_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n141_), .c(new_n99_), .d(new_n82_), .O(new_n153_));
  ...
  nand4  g110(.a(new_n141_), .b(new_n70_), .c(new_n67_), .d(new_n64_), .O(new_n157_));
  nand3  g111(.a(new_n99_), .b(x19), .c(new_n129_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n47_), .d(new_n129_), .O(new_n159_));
