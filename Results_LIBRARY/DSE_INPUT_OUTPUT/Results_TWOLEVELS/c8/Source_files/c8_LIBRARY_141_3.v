...
module FAU ( 
  ...
  aoi21  g039(.a(x27), .b(new_n85_), .c(new_n48_), .O(new_n86_));
  ...
  nand2  g052(.a(x18), .b(new_n85_), .O(new_n99_));
  oai22  g053(.a(new_n99_), .b(new_n98_), .c(x18), .d(new_n55_), .O(new_n100_));
  nand2  g054(.a(new_n100_), .b(new_n93_), .O(new_n101_));
  nand3  g055(.a(new_n57_), .b(new_n51_), .c(new_n89_), .O(new_n102_));
  oai21  g056(.a(new_n91_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  nand3  g057(.a(new_n103_), .b(new_n47_), .c(x16), .O(new_n104_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n108_), .c(new_n47_), .O(z11));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n91_), .c(new_n67_), .O(new_n118_));
  nor2   g072(.a(x22), .b(x21), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n91_), .c(new_n57_), .O(new_n120_));
  inv1   g074(.a(new_n120_), .O(new_n121_));
  oai21  g075(.a(new_n121_), .b(new_n118_), .c(x16), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n47_), .O(z12));
  ...
  nand3  g082(.a(new_n128_), .b(new_n109_), .c(new_n62_), .O(new_n129_));
  ...
  oai22  g087(.a(new_n99_), .b(new_n133_), .c(x18), .d(new_n75_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  nand3  g089(.a(new_n72_), .b(new_n67_), .c(new_n62_), .O(new_n136_));
  ...
  oai22  g098(.a(new_n99_), .b(new_n144_), .c(x18), .d(new_n80_), .O(new_n145_));
