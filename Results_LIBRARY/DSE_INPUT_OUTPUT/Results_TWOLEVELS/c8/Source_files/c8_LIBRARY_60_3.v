...
module FAU ( 
  ...
  aoi21  g071(.a(new_n117_), .b(x11), .c(new_n49_), .O(new_n118_));
  oai21  g072(.a(new_n116_), .b(new_n90_), .c(new_n118_), .O(z12));
  ...
  oai22  g083(.a(new_n129_), .b(x03), .c(x18), .d(new_n73_), .O(new_n130_));
  ...
  oai22  g094(.a(new_n140_), .b(x03), .c(x18), .d(new_n76_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n90_), .O(new_n142_));
  nand2  g096(.a(new_n136_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n124_), .c(new_n108_), .d(new_n88_), .O(new_n145_));
  ...
  oai22  g103(.a(new_n149_), .b(x03), .c(x18), .d(new_n79_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n124_), .c(new_n108_), .d(new_n88_), .O(new_n154_));
