...
module FAU ( 
  ...
  nand3  g079(.a(new_n125_), .b(new_n106_), .c(new_n62_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n96_), .c(x16), .O(new_n128_));
  ...
  nand3  g087(.a(new_n70_), .b(new_n133_), .c(new_n62_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n99_), .c(x24), .O(new_n135_));
  nor2   g089(.a(x20), .b(x19), .O(new_n136_));
  nor2   g090(.a(x24), .b(x23), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n116_), .c(new_n136_), .d(new_n98_), .O(new_n138_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n125_), .c(new_n107_), .d(new_n97_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n96_), .b(new_n90_), .c(x14), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n125_), .c(new_n107_), .d(new_n97_), .O(new_n153_));
  ...
  nand2  g111(.a(new_n70_), .b(new_n133_), .O(new_n158_));
  inv1   g112(.a(x26), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n80_), .c(new_n75_), .O(new_n160_));
  nor2   g114(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g115(.a(new_n107_), .b(x19), .c(new_n98_), .O(new_n162_));
  inv1   g116(.a(new_n162_), .O(new_n163_));
  nor2   g117(.a(new_n52_), .b(new_n98_), .O(new_n164_));
  aoi21  g118(.a(new_n163_), .b(new_n161_), .c(new_n164_), .O(new_n165_));
  aoi21  g119(.a(new_n165_), .b(new_n96_), .c(new_n90_), .O(z17));
endmodule
