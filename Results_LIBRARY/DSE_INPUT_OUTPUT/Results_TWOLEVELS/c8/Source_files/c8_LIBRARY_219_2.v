...
module FAU ( 
  ...
  oai21  g066(.a(new_n103_), .b(new_n57_), .c(new_n112_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n87_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n110_), .O(z11));
  oai21  g069(.a(new_n107_), .b(new_n93_), .c(x03), .O(new_n116_));
  aoi21  g070(.a(new_n111_), .b(new_n91_), .c(new_n63_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n91_), .c(new_n101_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n107_), .b(new_n93_), .c(x11), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n121_), .c(new_n116_), .O(z12));
  nand2  g077(.a(x18), .b(x04), .O(new_n124_));
  nand3  g078(.a(new_n107_), .b(x12), .c(new_n48_), .O(new_n125_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n129_), .c(new_n111_), .d(new_n91_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n87_), .c(x16), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n150_), .O(z15));
  nand2  g110(.a(x18), .b(x07), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x15), .c(new_n48_), .O(new_n158_));
  ...
  nand4  g116(.a(new_n162_), .b(new_n129_), .c(new_n111_), .d(new_n91_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n87_), .c(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n160_), .O(z16));
  nand4  g120(.a(new_n129_), .b(new_n83_), .c(new_n78_), .d(new_n73_), .O(new_n167_));
  nand3  g121(.a(new_n111_), .b(x19), .c(new_n88_), .O(new_n168_));
  oai22  g122(.a(new_n168_), .b(new_n167_), .c(new_n58_), .d(new_n88_), .O(new_n169_));
  nand2  g123(.a(new_n169_), .b(x16), .O(new_n170_));
  nand2  g124(.a(new_n170_), .b(new_n87_), .O(z17));
endmodule
