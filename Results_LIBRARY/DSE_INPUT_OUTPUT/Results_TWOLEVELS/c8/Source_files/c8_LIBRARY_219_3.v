...
module FAU ( 
  ...
  nand3  g059(.a(x18), .b(new_n105_), .c(x02), .O(new_n106_));
  ...
  oai21  g064(.a(new_n102_), .b(new_n57_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n48_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n108_), .O(z11));
  nand2  g067(.a(new_n110_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n90_), .c(new_n100_), .O(new_n116_));
  and2   g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nor2   g071(.a(x18), .b(x16), .O(new_n118_));
  aoi21  g072(.a(new_n118_), .b(x11), .c(new_n49_), .O(new_n119_));
  oai21  g073(.a(new_n117_), .b(new_n92_), .c(new_n119_), .O(z12));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  oai22  g075(.a(new_n121_), .b(x03), .c(x18), .d(new_n66_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n92_), .O(new_n123_));
  nand2  g077(.a(new_n116_), .b(x23), .O(new_n124_));
  nor2   g078(.a(x23), .b(x22), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n102_), .c(new_n57_), .O(new_n126_));
  ...
  oai22  g084(.a(new_n130_), .b(x03), .c(x18), .d(new_n71_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n92_), .O(new_n132_));
  nand3  g086(.a(new_n100_), .b(new_n88_), .c(new_n87_), .O(new_n133_));
  ...
  oai22  g096(.a(new_n142_), .b(x03), .c(x18), .d(new_n76_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n92_), .O(new_n144_));
  nand2  g098(.a(new_n138_), .b(x25), .O(new_n145_));
  nor2   g099(.a(x25), .b(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n125_), .c(new_n109_), .d(new_n90_), .O(new_n147_));
  ...
  oai22  g105(.a(new_n151_), .b(x03), .c(x18), .d(new_n81_), .O(new_n152_));
  ...
  nand4  g109(.a(new_n155_), .b(new_n125_), .c(new_n109_), .d(new_n90_), .O(new_n156_));
  ...
  nand3  g114(.a(new_n109_), .b(x19), .c(new_n87_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n58_), .d(new_n87_), .O(new_n162_));
