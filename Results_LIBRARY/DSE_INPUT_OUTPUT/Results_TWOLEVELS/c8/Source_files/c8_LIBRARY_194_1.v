...
module FAU ( 
  ...
  nand2  g055(.a(new_n81_), .b(new_n52_), .O(new_n102_));
  ...
  oai21  g060(.a(new_n94_), .b(new_n55_), .c(new_n106_), .O(new_n107_));
  ...
  oai21  g073(.a(new_n102_), .b(new_n66_), .c(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n96_), .O(new_n121_));
  nand2  g075(.a(new_n115_), .b(x22), .O(new_n122_));
  nor2   g076(.a(x22), .b(x21), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n94_), .c(new_n55_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n53_), .c(x16), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n121_), .O(z12));
  ...
  nand2  g086(.a(new_n132_), .b(new_n113_), .O(new_n133_));
  ...
  aoi21  g093(.a(new_n132_), .b(new_n113_), .c(new_n76_), .O(new_n140_));
  nor2   g094(.a(x24), .b(x23), .O(new_n141_));
  nand4  g095(.a(new_n141_), .b(new_n123_), .c(new_n105_), .d(new_n92_), .O(new_n142_));
  inv1   g096(.a(new_n142_), .O(new_n143_));
  oai21  g097(.a(new_n143_), .b(new_n140_), .c(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n139_), .c(new_n53_), .O(z14));
  nand2  g099(.a(x18), .b(x06), .O(new_n146_));
  oai21  g100(.a(new_n102_), .b(new_n83_), .c(new_n146_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n96_), .O(new_n148_));
  nand3  g102(.a(new_n142_), .b(x25), .c(x18), .O(new_n149_));
  nor2   g103(.a(x23), .b(x22), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n81_), .c(new_n76_), .O(new_n151_));
  oai21  g105(.a(new_n151_), .b(new_n115_), .c(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n148_), .O(z15));
  nand2  g108(.a(x18), .b(x07), .O(new_n155_));
  oai21  g109(.a(new_n102_), .b(new_n88_), .c(new_n155_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n96_), .O(new_n157_));
  nand2  g111(.a(new_n142_), .b(x26), .O(new_n158_));
  nor2   g112(.a(x26), .b(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n150_), .c(new_n114_), .d(new_n94_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n158_), .c(x25), .O(new_n161_));
  nand3  g115(.a(x26), .b(x25), .c(x18), .O(new_n162_));
  ...
  nand4  g120(.a(new_n150_), .b(new_n86_), .c(new_n81_), .d(new_n76_), .O(new_n167_));
  oai22  g121(.a(new_n167_), .b(new_n166_), .c(new_n48_), .d(new_n92_), .O(new_n168_));
