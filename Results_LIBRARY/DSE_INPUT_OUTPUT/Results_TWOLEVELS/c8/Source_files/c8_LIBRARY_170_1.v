...
module FAU ( 
  ...
  oai21  g46(.a(new_n92_), .b(new_n52_), .c(new_n90_), .O(z10));
  oai21  g47(.a(x18), .b(x10), .c(new_n84_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n79_), .O(new_n96_));
  nand4  g50(.a(new_n57_), .b(new_n87_), .c(new_n80_), .d(new_n79_), .O(new_n97_));
  inv1   g51(.a(new_n97_), .O(new_n98_));
  aoi21  g52(.a(new_n96_), .b(x21), .c(new_n98_), .O(new_n99_));
  oai21  g53(.a(new_n99_), .b(new_n84_), .c(new_n94_), .O(z11));
  oai21  g54(.a(x18), .b(x11), .c(new_n84_), .O(new_n101_));
  ...
  aoi22  g61(.a(new_n107_), .b(new_n89_), .c(new_n104_), .d(x23), .O(new_n108_));
  oai22  g62(.a(new_n108_), .b(new_n84_), .c(new_n92_), .d(new_n66_), .O(z13));
  inv1   g63(.a(x24), .O(new_n110_));
  aoi21  g64(.a(new_n107_), .b(new_n89_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n103_), .c(new_n95_), .d(new_n79_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g69(.a(new_n91_), .b(x13), .O(new_n116_));
  ...
  nand2  g76(.a(new_n91_), .b(x14), .O(new_n123_));
  oai21  g77(.a(new_n122_), .b(new_n84_), .c(new_n123_), .O(z15));
  ...
  nand2  g87(.a(new_n91_), .b(x15), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(new_n133_), .O(z16));
  inv1   g89(.a(new_n49_), .O(new_n136_));
  nor2   g90(.a(x26), .b(x25), .O(new_n137_));
  nand3  g91(.a(new_n137_), .b(new_n126_), .c(new_n110_), .O(new_n138_));
  nand3  g92(.a(new_n125_), .b(x19), .c(new_n79_), .O(new_n139_));
