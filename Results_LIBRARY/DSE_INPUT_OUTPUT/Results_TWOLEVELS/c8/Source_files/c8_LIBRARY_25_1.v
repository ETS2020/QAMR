...
module FAU ( 
  ...
  nand2  g23(.a(new_n58_), .b(new_n69_), .O(new_n70_));
  ...
  nand2  g33(.a(new_n58_), .b(new_n79_), .O(new_n80_));
  aoi21  g34(.a(new_n80_), .b(new_n78_), .c(new_n49_), .O(z07));
  inv1   g35(.a(new_n49_), .O(new_n82_));
  nand2  g36(.a(new_n82_), .b(new_n58_), .O(z08));
  ...
  oai21  g43(.a(x18), .b(x08), .c(new_n89_), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n88_), .O(z09));
  ...
  nand4  g54(.a(new_n57_), .b(new_n93_), .c(new_n85_), .d(new_n84_), .O(new_n101_));
  inv1   g55(.a(new_n101_), .O(new_n102_));
  aoi21  g56(.a(new_n100_), .b(x21), .c(new_n102_), .O(new_n103_));
  oai21  g57(.a(new_n103_), .b(new_n89_), .c(new_n98_), .O(z11));
  oai21  g58(.a(x18), .b(x11), .c(new_n89_), .O(new_n105_));
  nand2  g59(.a(new_n101_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n87_), .c(new_n93_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  oai21  g63(.a(new_n109_), .b(new_n89_), .c(new_n105_), .O(z12));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n95_), .c(new_n108_), .d(x23), .O(new_n112_));
  nand3  g66(.a(new_n48_), .b(new_n89_), .c(x12), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n89_), .c(new_n113_), .O(z13));
  oai21  g68(.a(x18), .b(x13), .c(new_n89_), .O(new_n115_));
  aoi21  g69(.a(new_n111_), .b(new_n95_), .c(new_n69_), .O(new_n116_));
  nor2   g70(.a(x24), .b(x23), .O(new_n117_));
  nand4  g71(.a(new_n117_), .b(new_n107_), .c(new_n99_), .d(new_n84_), .O(new_n118_));
  ...
  oai21  g75(.a(x18), .b(x14), .c(new_n89_), .O(new_n122_));
  inv1   g76(.a(x22), .O(new_n123_));
  inv1   g77(.a(x23), .O(new_n124_));
  nand4  g78(.a(new_n74_), .b(new_n69_), .c(new_n124_), .d(new_n123_), .O(new_n125_));
  inv1   g79(.a(new_n125_), .O(new_n126_));
  aoi22  g80(.a(new_n126_), .b(new_n102_), .c(new_n118_), .d(x25), .O(new_n127_));
  oai21  g81(.a(new_n127_), .b(new_n89_), .c(new_n122_), .O(z15));
  ...
  nand3  g91(.a(new_n48_), .b(new_n89_), .c(x15), .O(new_n138_));
  nand2  g92(.a(new_n138_), .b(new_n137_), .O(z16));
  nand4  g93(.a(new_n130_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n140_));
  nand3  g94(.a(new_n129_), .b(x19), .c(new_n84_), .O(new_n141_));
  oai22  g95(.a(new_n141_), .b(new_n140_), .c(new_n58_), .d(new_n84_), .O(new_n142_));
