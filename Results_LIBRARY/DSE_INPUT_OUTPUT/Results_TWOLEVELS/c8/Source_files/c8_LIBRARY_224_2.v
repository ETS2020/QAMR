...
module FAU ( 
  ...
  nand3  g040(.a(x19), .b(x18), .c(x17), .O(new_n87_));
  ...
  oai21  g065(.a(new_n60_), .b(new_n92_), .c(x18), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(x17), .O(new_n113_));
  nor2   g067(.a(x21), .b(x20), .O(new_n114_));
  inv1   g068(.a(new_n114_), .O(new_n115_));
  oai22  g069(.a(new_n115_), .b(new_n89_), .c(new_n103_), .d(new_n60_), .O(new_n116_));
  ...
  oai21  g073(.a(new_n95_), .b(new_n63_), .c(new_n119_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n92_), .O(new_n121_));
  nand3  g075(.a(new_n60_), .b(new_n54_), .c(new_n88_), .O(new_n122_));
  ...
  nor2   g080(.a(new_n65_), .b(new_n94_), .O(new_n127_));
  aoi21  g081(.a(new_n127_), .b(x17), .c(new_n126_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n92_), .c(new_n121_), .O(z12));
  ...
  oai21  g087(.a(new_n133_), .b(new_n92_), .c(x18), .O(new_n134_));
  ...
  nand2  g092(.a(new_n138_), .b(new_n60_), .O(new_n139_));
  ...
  oai21  g099(.a(new_n73_), .b(new_n92_), .c(x18), .O(new_n146_));
  ...
  oai21  g108(.a(new_n95_), .b(new_n76_), .c(new_n154_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n92_), .O(new_n156_));
  nand3  g110(.a(new_n73_), .b(new_n133_), .c(new_n65_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n122_), .c(x25), .O(new_n158_));
  nor2   g112(.a(x25), .b(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n138_), .c(new_n114_), .d(new_n88_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n158_), .c(x17), .O(new_n161_));
  nand3  g115(.a(x25), .b(x18), .c(x17), .O(new_n162_));
  ...
  oai21  g120(.a(new_n95_), .b(new_n81_), .c(new_n166_), .O(new_n167_));
  ...
  nand3  g126(.a(x26), .b(x18), .c(x17), .O(new_n173_));
  ...
  nor2   g130(.a(new_n88_), .b(x17), .O(new_n177_));
  nor3   g131(.a(x26), .b(x25), .c(x24), .O(new_n178_));
  nand4  g132(.a(new_n178_), .b(new_n177_), .c(new_n138_), .d(new_n114_), .O(new_n179_));
  nand3  g133(.a(x27), .b(x18), .c(x17), .O(new_n180_));
  aoi21  g134(.a(new_n180_), .b(new_n179_), .c(new_n92_), .O(z17));
endmodule
