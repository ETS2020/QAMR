...
module FAU ( 
  ...
  nand2  g057(.a(new_n95_), .b(x10), .O(new_n104_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n91_), .c(new_n90_), .O(new_n112_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n109_), .c(x16), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n118_), .O(z13));
  oai21  g078(.a(x16), .b(x05), .c(x18), .O(new_n125_));
  aoi21  g079(.a(new_n120_), .b(new_n93_), .c(new_n71_), .O(new_n126_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n100_), .d(new_n91_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n109_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n137_), .c(new_n71_), .O(new_n154_));
  nand3  g108(.a(new_n100_), .b(x19), .c(new_n127_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n127_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n109_), .c(x16), .O(new_n157_));
