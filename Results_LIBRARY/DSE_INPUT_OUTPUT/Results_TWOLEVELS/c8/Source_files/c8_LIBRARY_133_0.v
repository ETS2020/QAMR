...
module FAU ( 
  ...
  oai21  g012(.a(x27), .b(new_n58_), .c(new_n57_), .O(new_n59_));
  ...
  aoi21  g037(.a(new_n58_), .b(new_n57_), .c(new_n54_), .O(z08));
  ...
  oai21  g056(.a(new_n58_), .b(x02), .c(new_n91_), .O(new_n103_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n103_), .c(new_n85_), .O(z11));
  nand2  g063(.a(x18), .b(x03), .O(new_n110_));
  nand3  g064(.a(new_n58_), .b(x11), .c(x10), .O(new_n111_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n89_), .c(new_n53_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n85_), .c(x16), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(new_n113_), .O(z12));
  nand2  g073(.a(x18), .b(x04), .O(new_n120_));
  nand3  g074(.a(new_n58_), .b(x12), .c(x10), .O(new_n121_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n105_), .d(new_n89_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n125_), .c(new_n105_), .d(new_n89_), .O(new_n157_));
  ...
  nand3  g115(.a(new_n161_), .b(new_n125_), .c(new_n73_), .O(new_n162_));
  nand3  g116(.a(new_n105_), .b(x19), .c(new_n86_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n54_), .d(new_n86_), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(x16), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n85_), .O(z17));
endmodule
