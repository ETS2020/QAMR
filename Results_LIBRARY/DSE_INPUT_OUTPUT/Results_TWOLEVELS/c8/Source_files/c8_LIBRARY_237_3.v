...
module FAU ( 
  ...
  nor2   g042(.a(new_n83_), .b(new_n54_), .O(new_n89_));
  nor3   g043(.a(x20), .b(x19), .c(x17), .O(new_n90_));
  oai21  g044(.a(new_n90_), .b(new_n89_), .c(x16), .O(new_n91_));
  nand2  g045(.a(new_n85_), .b(x09), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n91_), .c(new_n88_), .O(z10));
  ...
  nand3  g063(.a(new_n109_), .b(new_n83_), .c(new_n54_), .O(new_n110_));
  ...
  aoi21  g077(.a(new_n116_), .b(new_n90_), .c(new_n123_), .O(new_n124_));
  inv1   g078(.a(x17), .O(new_n125_));
  nor2   g079(.a(x20), .b(x19), .O(new_n126_));
  nor2   g080(.a(x24), .b(x23), .O(new_n127_));
  nand4  g081(.a(new_n127_), .b(new_n109_), .c(new_n126_), .d(new_n125_), .O(new_n128_));
  inv1   g082(.a(new_n128_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n124_), .c(x16), .O(new_n130_));
  nand2  g084(.a(new_n85_), .b(x13), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n130_), .c(new_n122_), .O(z14));
  ...
  nand4  g090(.a(new_n136_), .b(new_n135_), .c(new_n100_), .d(new_n83_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n135_), .c(new_n100_), .d(new_n83_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n98_), .c(x16), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n144_), .O(z16));
  nand2  g104(.a(new_n68_), .b(new_n63_), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  inv1   g106(.a(x26), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n123_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand3  g109(.a(new_n100_), .b(x19), .c(new_n125_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n55_), .b(new_n125_), .O(new_n158_));
  aoi21  g112(.a(new_n157_), .b(new_n155_), .c(new_n158_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n98_), .c(new_n94_), .O(z17));
endmodule
