...
module FAU ( 
  ...
  nand3  g045(.a(new_n91_), .b(new_n90_), .c(x08), .O(new_n92_));
  nand3  g046(.a(new_n92_), .b(new_n89_), .c(new_n85_), .O(z09));
  ...
  nand3  g050(.a(new_n57_), .b(new_n51_), .c(new_n86_), .O(new_n97_));
  oai21  g051(.a(new_n88_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n91_), .c(x16), .O(new_n99_));
  ...
  nand3  g062(.a(new_n108_), .b(new_n91_), .c(x16), .O(new_n109_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n88_), .c(new_n57_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n91_), .c(x16), .O(new_n118_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n91_), .c(x16), .O(new_n127_));
  ...
  nand3  g085(.a(new_n70_), .b(new_n65_), .c(new_n104_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n97_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n115_), .c(new_n134_), .d(new_n86_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n91_), .c(x16), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n124_), .c(new_n106_), .d(new_n88_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n91_), .b(new_n90_), .c(x14), .O(new_n146_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n91_), .c(x16), .O(new_n155_));
  ...
  aoi21  g119(.a(new_n165_), .b(new_n91_), .c(new_n90_), .O(z17));
endmodule
