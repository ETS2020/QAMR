...
module FAU ( 
  ...
  aoi21  g065(.a(new_n103_), .b(new_n94_), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g084(.a(new_n130_), .b(new_n113_), .c(new_n95_), .d(new_n83_), .O(new_n131_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n138_), .c(new_n103_), .d(new_n94_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n107_), .b(x15), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n138_), .c(new_n128_), .O(new_n154_));
  nand3  g108(.a(new_n103_), .b(x19), .c(new_n83_), .O(new_n155_));
