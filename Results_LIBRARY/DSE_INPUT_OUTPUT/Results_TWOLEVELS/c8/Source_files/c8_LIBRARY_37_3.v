...
module FAU ( 
  ...
  nand2  g034(.a(x18), .b(new_n67_), .O(new_n81_));
  ...
  oai22  g051(.a(new_n81_), .b(new_n97_), .c(x18), .d(new_n58_), .O(new_n98_));
  ...
  oai22  g070(.a(new_n81_), .b(new_n116_), .c(x18), .d(new_n64_), .O(new_n117_));
  ...
  nand3  g078(.a(x18), .b(new_n67_), .c(x05), .O(new_n125_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n109_), .c(new_n100_), .O(new_n132_));
  ...
  oai21  g094(.a(x18), .b(new_n70_), .c(new_n140_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n79_), .O(new_n142_));
  nand2  g096(.a(new_n136_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n120_), .c(new_n101_), .d(new_n85_), .O(new_n145_));
  ...
  oai22  g103(.a(new_n81_), .b(new_n149_), .c(x18), .d(new_n75_), .O(new_n150_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n120_), .c(new_n101_), .d(new_n85_), .O(new_n154_));
