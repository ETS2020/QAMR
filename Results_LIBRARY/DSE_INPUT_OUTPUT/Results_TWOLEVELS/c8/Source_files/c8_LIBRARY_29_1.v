...
module FAU ( 
  ...
  oai22  g59(.a(new_n105_), .b(new_n87_), .c(new_n88_), .d(new_n61_), .O(z12));
  ...
  oai22  g64(.a(new_n110_), .b(new_n87_), .c(new_n88_), .d(new_n66_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n87_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n93_), .c(new_n71_), .O(new_n113_));
