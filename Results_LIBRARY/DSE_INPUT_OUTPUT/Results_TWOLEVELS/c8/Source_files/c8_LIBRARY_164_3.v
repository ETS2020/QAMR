...
module FAU ( 
  ...
  nand3  g061(.a(new_n94_), .b(new_n88_), .c(x10), .O(new_n108_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n94_), .c(x16), .O(new_n117_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n94_), .c(x16), .O(new_n126_));
  ...
  nand3  g091(.a(new_n137_), .b(new_n94_), .c(x16), .O(new_n138_));
  ...
  nand3  g099(.a(new_n94_), .b(new_n88_), .c(x14), .O(new_n146_));
  ...
  nand3  g108(.a(new_n154_), .b(new_n94_), .c(x16), .O(new_n155_));
