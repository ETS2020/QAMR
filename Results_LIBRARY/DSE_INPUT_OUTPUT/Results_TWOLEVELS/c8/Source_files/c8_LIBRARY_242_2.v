...
module FAU ( 
  ...
  aoi21  g079(.a(new_n120_), .b(new_n94_), .c(new_n69_), .O(new_n126_));
  ...
  nand2  g086(.a(new_n96_), .b(x05), .O(new_n133_));
  ...
  nand2  g095(.a(new_n96_), .b(x06), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n101_), .d(new_n92_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n96_), .b(x07), .O(new_n150_));
  ...
  nand3  g109(.a(new_n101_), .b(x19), .c(new_n127_), .O(new_n156_));
