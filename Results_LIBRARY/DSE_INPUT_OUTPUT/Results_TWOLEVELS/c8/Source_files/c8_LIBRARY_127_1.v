...
module FAU ( 
  ...
  nand4  g52(.a(new_n98_), .b(new_n91_), .c(new_n51_), .d(new_n83_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  nand3  g55(.a(new_n47_), .b(new_n87_), .c(x10), .O(new_n102_));
  oai21  g56(.a(new_n101_), .b(new_n87_), .c(new_n102_), .O(z11));
  oai21  g57(.a(x18), .b(x11), .c(new_n87_), .O(new_n104_));
  ...
  oai21  g62(.a(new_n108_), .b(new_n87_), .c(new_n104_), .O(z12));
  oai21  g63(.a(x18), .b(x12), .c(new_n87_), .O(new_n110_));
  ...
  nand4  g71(.a(new_n117_), .b(new_n106_), .c(new_n96_), .d(new_n83_), .O(new_n118_));
  ...
  oai21  g75(.a(x18), .b(x14), .c(new_n87_), .O(new_n122_));
  nand4  g76(.a(new_n76_), .b(new_n115_), .c(new_n68_), .d(new_n63_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n100_), .c(new_n118_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n87_), .c(new_n122_), .O(z15));
  ...
  nand3  g89(.a(new_n47_), .b(new_n87_), .c(x15), .O(new_n136_));
