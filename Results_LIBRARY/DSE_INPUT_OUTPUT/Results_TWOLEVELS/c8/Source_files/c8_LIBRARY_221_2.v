...
module FAU ( 
  ...
  oai21  g084(.a(x16), .b(x13), .c(new_n85_), .O(new_n131_));
  aoi21  g085(.a(new_n126_), .b(new_n107_), .c(new_n71_), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n117_), .c(new_n98_), .d(new_n97_), .O(new_n134_));
  inv1   g088(.a(new_n134_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n132_), .c(x16), .O(new_n136_));
  nand3  g090(.a(x18), .b(new_n47_), .c(x05), .O(new_n137_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n108_), .d(new_n96_), .O(new_n145_));
