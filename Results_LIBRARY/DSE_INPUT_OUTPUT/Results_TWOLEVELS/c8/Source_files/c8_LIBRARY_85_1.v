...
module FAU ( 
  ...
  nand2  g062(.a(new_n60_), .b(new_n52_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n62_), .c(new_n108_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n96_), .O(new_n111_));
  nand3  g065(.a(new_n55_), .b(new_n47_), .c(new_n92_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(x21), .c(x18), .O(new_n113_));
  ...
  nor2   g075(.a(x22), .b(x20), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n94_), .O(new_n123_));
  oai21  g077(.a(new_n105_), .b(new_n68_), .c(new_n123_), .O(new_n124_));
  nor2   g078(.a(new_n68_), .b(new_n60_), .O(new_n125_));
  aoi22  g079(.a(new_n125_), .b(x18), .c(new_n124_), .d(new_n60_), .O(new_n126_));
  ...
  oai21  g084(.a(new_n71_), .b(new_n96_), .c(x18), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(x21), .O(new_n132_));
  aoi21  g086(.a(new_n122_), .b(new_n94_), .c(new_n71_), .O(new_n133_));
  nor2   g087(.a(x23), .b(x22), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n60_), .O(new_n135_));
  nor2   g089(.a(new_n135_), .b(new_n112_), .O(new_n136_));
  oai21  g090(.a(new_n136_), .b(new_n133_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n132_), .c(new_n130_), .O(z13));
  ...
  oai21  g095(.a(new_n78_), .b(new_n96_), .c(x18), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x21), .O(new_n143_));
  nand3  g097(.a(new_n134_), .b(new_n94_), .c(new_n55_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x24), .O(new_n145_));
  nor2   g099(.a(x24), .b(x23), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n105_), .c(new_n68_), .d(new_n60_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n141_), .O(z14));
  nand2  g104(.a(x18), .b(x06), .O(new_n151_));
  oai21  g105(.a(new_n109_), .b(new_n81_), .c(new_n151_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n96_), .O(new_n153_));
  nand3  g107(.a(new_n78_), .b(new_n71_), .c(new_n68_), .O(new_n154_));
  oai21  g108(.a(new_n154_), .b(new_n112_), .c(x25), .O(new_n155_));
  nor2   g109(.a(x20), .b(x19), .O(new_n156_));
  nor2   g110(.a(x25), .b(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n134_), .c(new_n156_), .d(new_n92_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n155_), .c(x21), .O(new_n159_));
  nand3  g113(.a(x25), .b(x21), .c(x18), .O(new_n160_));
  ...
  oai21  g118(.a(new_n109_), .b(new_n88_), .c(new_n164_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n96_), .O(new_n166_));
  nand2  g120(.a(new_n158_), .b(x26), .O(new_n167_));
  nor2   g121(.a(x26), .b(x25), .O(new_n168_));
  nand4  g122(.a(new_n168_), .b(new_n146_), .c(new_n122_), .d(new_n94_), .O(new_n169_));
  aoi21  g123(.a(new_n169_), .b(new_n167_), .c(x21), .O(new_n170_));
  nand3  g124(.a(x26), .b(x21), .c(x18), .O(new_n171_));
  inv1   g125(.a(new_n171_), .O(new_n172_));
  oai21  g126(.a(new_n172_), .b(new_n170_), .c(x16), .O(new_n173_));
  ...
  nand4  g131(.a(new_n177_), .b(new_n176_), .c(new_n134_), .d(new_n114_), .O(new_n178_));
