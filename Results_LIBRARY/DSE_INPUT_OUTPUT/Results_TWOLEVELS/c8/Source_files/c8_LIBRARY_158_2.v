...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n94_), .c(new_n82_), .O(z10));
  ...
  nand3  g060(.a(new_n106_), .b(new_n101_), .c(new_n82_), .O(z11));
  ...
  oai21  g082(.a(new_n119_), .b(new_n73_), .c(new_n128_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n87_), .O(new_n130_));
  nand3  g084(.a(new_n57_), .b(new_n51_), .c(new_n83_), .O(new_n131_));
  nand3  g085(.a(new_n70_), .b(new_n65_), .c(new_n102_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n131_), .c(x24), .O(new_n133_));
  nor2   g087(.a(x20), .b(x19), .O(new_n134_));
  nor2   g088(.a(x24), .b(x23), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n112_), .c(new_n134_), .d(new_n83_), .O(new_n136_));
  ...
  oai21  g094(.a(new_n119_), .b(new_n76_), .c(new_n140_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n87_), .O(new_n142_));
  nand2  g096(.a(new_n136_), .b(x25), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n123_), .c(new_n103_), .d(new_n85_), .O(new_n145_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n123_), .c(new_n103_), .d(new_n85_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nor2   g107(.a(new_n118_), .b(x16), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(x07), .c(new_n48_), .O(new_n155_));
