...
module FAU ( 
  ...
  oai21  g35(.a(new_n47_), .b(x16), .c(new_n52_), .O(z08));
  ...
  nand4  g76(.a(new_n122_), .b(new_n112_), .c(new_n70_), .d(new_n121_), .O(new_n123_));
  inv1   g77(.a(new_n123_), .O(new_n124_));
  aoi22  g78(.a(new_n124_), .b(new_n100_), .c(new_n115_), .d(x25), .O(new_n125_));
