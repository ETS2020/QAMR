...
module FAU ( 
  ...
  oai21  g050(.a(new_n86_), .b(new_n94_), .c(new_n96_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(x18), .c(x16), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n93_), .O(z10));
  oai21  g053(.a(x16), .b(x10), .c(new_n81_), .O(new_n100_));
  ...
  aoi21  g062(.a(new_n102_), .b(new_n86_), .c(new_n63_), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n86_), .c(new_n94_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n88_), .b(x03), .O(new_n114_));
  ...
  nand2  g075(.a(new_n88_), .b(x04), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n121_), .c(new_n116_), .O(z13));
  oai21  g077(.a(x16), .b(x13), .c(new_n81_), .O(new_n124_));
  aoi21  g078(.a(new_n118_), .b(new_n101_), .c(new_n71_), .O(new_n125_));
  nor2   g079(.a(x24), .b(x23), .O(new_n126_));
  nand4  g080(.a(new_n126_), .b(new_n110_), .c(new_n95_), .d(new_n83_), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n125_), .c(x16), .O(new_n129_));
  nand2  g083(.a(new_n88_), .b(x05), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(new_n124_), .O(z14));
  oai21  g085(.a(x16), .b(x14), .c(new_n81_), .O(new_n132_));
  nand2  g086(.a(new_n127_), .b(x25), .O(new_n133_));
  nor2   g087(.a(x23), .b(x22), .O(new_n134_));
  nor2   g088(.a(x25), .b(x24), .O(new_n135_));
  nand4  g089(.a(new_n135_), .b(new_n134_), .c(new_n102_), .d(new_n86_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g091(.a(new_n137_), .b(x16), .O(new_n138_));
  nand2  g092(.a(new_n88_), .b(x06), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n134_), .c(new_n102_), .d(new_n86_), .O(new_n146_));
  ...
  nand2  g104(.a(new_n150_), .b(new_n63_), .O(new_n151_));
  inv1   g105(.a(x25), .O(new_n152_));
  inv1   g106(.a(x26), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n152_), .c(new_n71_), .O(new_n154_));
  ...
  nor2   g111(.a(new_n58_), .b(new_n83_), .O(new_n158_));
