...
module FAU ( 
  ...
  nand3  g071(.a(new_n117_), .b(new_n93_), .c(new_n101_), .O(new_n118_));
  ...
  nand3  g079(.a(new_n90_), .b(new_n51_), .c(new_n83_), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n63_), .c(new_n101_), .O(new_n128_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n117_), .c(new_n102_), .d(new_n91_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n95_), .b(x06), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n117_), .c(new_n102_), .d(new_n91_), .O(new_n149_));
  ...
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n83_), .O(new_n157_));
