...
module FAU ( 
  ...
  aoi21  g032(.a(new_n78_), .b(new_n76_), .c(new_n47_), .O(z07));
  aoi21  g033(.a(new_n58_), .b(new_n57_), .c(new_n51_), .O(z08));
  ...
  nand2  g045(.a(new_n58_), .b(x10), .O(new_n92_));
  ...
  nand3  g065(.a(new_n58_), .b(x11), .c(x10), .O(new_n112_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n84_), .c(new_n95_), .O(new_n117_));
  ...
  nand3  g075(.a(new_n58_), .b(x12), .c(x10), .O(new_n122_));
  ...
  nand4  g090(.a(new_n136_), .b(new_n116_), .c(new_n96_), .d(new_n82_), .O(new_n137_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n106_), .d(new_n84_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n81_), .O(z15));
  ...
  nand4  g109(.a(new_n155_), .b(new_n145_), .c(new_n106_), .d(new_n84_), .O(new_n156_));
  ...
  nand3  g115(.a(new_n106_), .b(x19), .c(new_n82_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n51_), .d(new_n82_), .O(new_n163_));
