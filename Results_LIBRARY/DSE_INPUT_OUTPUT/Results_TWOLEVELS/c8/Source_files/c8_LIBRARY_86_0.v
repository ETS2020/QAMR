...
module FAU ( 
  ...
  nor2   g034(.a(new_n54_), .b(new_n80_), .O(new_n81_));
  oai22  g035(.a(new_n81_), .b(x26), .c(new_n54_), .d(x15), .O(z07));
  ...
  nand3  g051(.a(new_n53_), .b(new_n86_), .c(new_n85_), .O(new_n98_));
  oai21  g052(.a(new_n88_), .b(new_n53_), .c(new_n98_), .O(new_n99_));
  ...
  nand2  g056(.a(x26), .b(new_n80_), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n57_), .c(new_n102_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(new_n90_), .O(new_n105_));
  nand3  g059(.a(new_n98_), .b(new_n84_), .c(x21), .O(new_n106_));
  nand4  g060(.a(new_n84_), .b(new_n59_), .c(new_n53_), .d(new_n86_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(x17), .c(new_n106_), .O(new_n108_));
  ...
  nand3  g067(.a(new_n88_), .b(new_n59_), .c(new_n53_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n84_), .c(x22), .O(new_n115_));
  nor2   g069(.a(new_n48_), .b(x22), .O(new_n116_));
  nand4  g070(.a(new_n116_), .b(new_n59_), .c(new_n53_), .d(new_n86_), .O(new_n117_));
  oai21  g071(.a(new_n117_), .b(x17), .c(new_n115_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n113_), .O(z12));
  nand2  g074(.a(x18), .b(x04), .O(new_n121_));
  oai21  g075(.a(new_n103_), .b(new_n67_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n90_), .O(new_n123_));
  nand4  g077(.a(new_n88_), .b(new_n64_), .c(new_n59_), .d(new_n53_), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(x23), .O(new_n125_));
  nor2   g079(.a(x23), .b(x22), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n59_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n98_), .c(new_n125_), .O(new_n128_));
  ...
  nor2   g087(.a(new_n127_), .b(new_n98_), .O(new_n134_));
  nor2   g088(.a(new_n134_), .b(new_n72_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand3  g090(.a(new_n136_), .b(new_n64_), .c(new_n59_), .O(new_n137_));
  nor2   g091(.a(new_n137_), .b(new_n98_), .O(new_n138_));
  ...
  nand3  g097(.a(new_n126_), .b(new_n77_), .c(new_n72_), .O(new_n144_));
  oai22  g098(.a(new_n144_), .b(new_n114_), .c(new_n138_), .d(new_n77_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n143_), .c(new_n84_), .O(z15));
  ...
  aoi22  g106(.a(new_n152_), .b(new_n136_), .c(x26), .d(x23), .O(new_n153_));
  nand2  g107(.a(x26), .b(x22), .O(new_n154_));
  oai21  g108(.a(new_n153_), .b(x22), .c(new_n154_), .O(new_n155_));
  nand4  g109(.a(new_n155_), .b(new_n59_), .c(new_n53_), .d(new_n86_), .O(new_n156_));
  nand3  g110(.a(new_n77_), .b(new_n72_), .c(new_n59_), .O(new_n157_));
  oai21  g111(.a(new_n157_), .b(new_n98_), .c(x26), .O(new_n158_));
  oai21  g112(.a(new_n156_), .b(x17), .c(new_n158_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n151_), .c(new_n84_), .O(z16));
  nand4  g115(.a(new_n59_), .b(new_n53_), .c(x19), .d(new_n85_), .O(new_n162_));
  nand3  g116(.a(new_n152_), .b(new_n126_), .c(new_n72_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n54_), .d(new_n85_), .O(new_n164_));
