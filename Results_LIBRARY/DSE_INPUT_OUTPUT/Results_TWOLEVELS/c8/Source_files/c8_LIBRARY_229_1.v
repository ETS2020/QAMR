...
module FAU ( 
  ...
  nand4  g55(.a(new_n60_), .b(new_n95_), .c(new_n51_), .d(new_n87_), .O(new_n102_));
  ...
  oai22  g60(.a(new_n106_), .b(new_n58_), .c(new_n104_), .d(new_n91_), .O(z11));
  nor3   g61(.a(x22), .b(x21), .c(x20), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n89_), .c(new_n102_), .d(x22), .O(new_n109_));
  oai22  g63(.a(new_n109_), .b(new_n91_), .c(new_n106_), .d(new_n63_), .O(z12));
