...
module FAU ( 
  ...
  nor2   g034(.a(x18), .b(x15), .O(new_n81_));
  ...
  aoi22  g048(.a(new_n81_), .b(x10), .c(x18), .d(x02), .O(new_n95_));
  ...
  inv1   g055(.a(new_n81_), .O(new_n102_));
  nand2  g056(.a(x18), .b(x03), .O(new_n103_));
  oai21  g057(.a(new_n102_), .b(new_n61_), .c(new_n103_), .O(new_n104_));
  ...
  nand3  g070(.a(new_n116_), .b(new_n92_), .c(new_n96_), .O(new_n117_));
  ...
  oai21  g075(.a(new_n102_), .b(new_n69_), .c(new_n121_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(new_n86_), .O(new_n123_));
  inv1   g077(.a(x17), .O(new_n124_));
  inv1   g078(.a(x19), .O(new_n125_));
  nand3  g079(.a(new_n54_), .b(new_n125_), .c(new_n124_), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n63_), .c(new_n96_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n133_), .b(new_n79_), .c(x16), .O(new_n134_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n116_), .c(new_n97_), .d(new_n90_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n138_), .c(new_n79_), .O(z15));
  nand2  g098(.a(new_n141_), .b(x26), .O(new_n145_));
  nor3   g099(.a(x26), .b(x25), .c(x24), .O(new_n146_));
  nand4  g100(.a(new_n146_), .b(new_n116_), .c(new_n97_), .d(new_n90_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g102(.a(new_n148_), .b(new_n79_), .c(x16), .O(new_n149_));
  nand3  g103(.a(x18), .b(new_n86_), .c(x07), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n149_), .O(z16));
  inv1   g105(.a(x24), .O(new_n152_));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n116_), .c(new_n152_), .O(new_n154_));
  nand3  g108(.a(new_n97_), .b(x19), .c(new_n124_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n55_), .d(new_n124_), .O(new_n156_));
