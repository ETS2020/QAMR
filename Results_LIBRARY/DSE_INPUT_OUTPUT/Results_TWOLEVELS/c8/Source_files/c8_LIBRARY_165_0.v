...
module FAU ( 
  ...
  nand2  g050(.a(new_n96_), .b(x18), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n49_), .O(new_n98_));
  ...
  nand2  g056(.a(x19), .b(new_n48_), .O(new_n103_));
  oai21  g057(.a(new_n103_), .b(new_n56_), .c(new_n102_), .O(new_n104_));
  ...
  aoi21  g062(.a(new_n108_), .b(new_n106_), .c(new_n48_), .O(new_n109_));
  inv1   g063(.a(x21), .O(new_n110_));
  nor2   g064(.a(new_n110_), .b(new_n49_), .O(new_n111_));
  ...
  oai21  g068(.a(new_n103_), .b(new_n59_), .c(new_n114_), .O(new_n115_));
  ...
  aoi21  g075(.a(new_n121_), .b(new_n118_), .c(new_n48_), .O(new_n122_));
  nor2   g076(.a(new_n61_), .b(new_n49_), .O(new_n123_));
  ...
  oai21  g080(.a(new_n103_), .b(new_n64_), .c(new_n126_), .O(new_n127_));
  ...
  aoi21  g087(.a(new_n133_), .b(new_n130_), .c(new_n48_), .O(new_n134_));
  nor2   g088(.a(new_n66_), .b(new_n49_), .O(new_n135_));
  ...
  oai21  g096(.a(new_n142_), .b(new_n96_), .c(x18), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n49_), .O(new_n144_));
  ...
  oai21  g106(.a(new_n152_), .b(new_n150_), .c(x18), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n49_), .O(new_n154_));
  ...
  oai21  g113(.a(new_n103_), .b(new_n77_), .c(new_n159_), .O(new_n160_));
  ...
  aoi21  g119(.a(new_n165_), .b(new_n163_), .c(new_n48_), .O(new_n166_));
