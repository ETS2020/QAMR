...
module FAU ( 
  ...
  nor2   g054(.a(new_n91_), .b(new_n55_), .O(new_n101_));
  nand3  g055(.a(new_n55_), .b(new_n47_), .c(new_n89_), .O(new_n102_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n108_), .c(new_n53_), .O(z11));
  inv1   g067(.a(x03), .O(new_n114_));
  nand2  g068(.a(x18), .b(x15), .O(new_n115_));
  oai22  g069(.a(new_n115_), .b(new_n114_), .c(x18), .d(new_n66_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n93_), .O(new_n117_));
  nand2  g071(.a(new_n110_), .b(x22), .O(new_n118_));
  nand4  g072(.a(new_n91_), .b(new_n68_), .c(new_n60_), .d(new_n55_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n53_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n117_), .O(z12));
  inv1   g076(.a(x04), .O(new_n123_));
  oai22  g077(.a(new_n115_), .b(new_n123_), .c(x18), .d(new_n71_), .O(new_n124_));
  ...
  oai21  g086(.a(x18), .b(new_n78_), .c(new_n132_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n93_), .O(new_n134_));
  aoi21  g088(.a(new_n127_), .b(new_n103_), .c(new_n76_), .O(new_n135_));
  nand4  g089(.a(new_n76_), .b(new_n73_), .c(new_n68_), .d(new_n60_), .O(new_n136_));
  nor2   g090(.a(new_n136_), .b(new_n102_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n135_), .c(x16), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n134_), .c(new_n53_), .O(z14));
  inv1   g093(.a(x06), .O(new_n140_));
  oai22  g094(.a(new_n115_), .b(new_n140_), .c(x18), .d(new_n81_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n93_), .O(new_n142_));
  nor2   g096(.a(x23), .b(x22), .O(new_n143_));
  nor2   g097(.a(x25), .b(x24), .O(new_n144_));
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n109_), .d(new_n91_), .O(new_n145_));
  oai21  g099(.a(new_n137_), .b(new_n83_), .c(new_n145_), .O(new_n146_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n143_), .c(new_n109_), .d(new_n91_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  aoi21  g108(.a(new_n154_), .b(x16), .c(new_n150_), .O(new_n155_));
  inv1   g109(.a(x18), .O(new_n156_));
  nand3  g110(.a(new_n154_), .b(new_n156_), .c(x16), .O(new_n157_));
  oai21  g111(.a(new_n155_), .b(new_n52_), .c(new_n157_), .O(z16));
  nand2  g112(.a(new_n152_), .b(new_n143_), .O(new_n159_));
  nand3  g113(.a(new_n109_), .b(x19), .c(new_n89_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n48_), .d(new_n89_), .O(new_n161_));
