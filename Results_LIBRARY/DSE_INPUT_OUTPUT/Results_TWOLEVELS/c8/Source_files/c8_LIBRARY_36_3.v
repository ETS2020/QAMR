...
module FAU ( 
  ...
  nand3  g044(.a(new_n90_), .b(new_n88_), .c(new_n85_), .O(z09));
  ...
  oai21  g054(.a(new_n87_), .b(new_n97_), .c(new_n100_), .O(new_n101_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n87_), .c(new_n97_), .O(new_n119_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n109_), .d(new_n87_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n96_), .c(x16), .O(new_n147_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n143_), .c(new_n109_), .d(new_n87_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n96_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n151_), .O(z16));
  nand2  g111(.a(new_n66_), .b(new_n60_), .O(new_n158_));
  nand3  g112(.a(new_n81_), .b(new_n76_), .c(new_n71_), .O(new_n159_));
  nor2   g113(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n109_), .b(x19), .c(new_n98_), .O(new_n161_));
  inv1   g115(.a(new_n161_), .O(new_n162_));
  nor2   g116(.a(new_n61_), .b(new_n98_), .O(new_n163_));
