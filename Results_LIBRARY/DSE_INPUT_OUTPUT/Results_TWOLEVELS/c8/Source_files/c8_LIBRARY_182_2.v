...
module FAU ( 
  ...
  nor2   g030(.a(new_n55_), .b(x18), .O(new_n77_));
  oai22  g031(.a(new_n77_), .b(x26), .c(new_n55_), .d(x15), .O(z07));
  ...
  nor2   g064(.a(new_n49_), .b(x22), .O(new_n111_));
  nand4  g065(.a(new_n111_), .b(new_n101_), .c(new_n54_), .d(new_n82_), .O(new_n112_));
  ...
  oai22  g070(.a(new_n107_), .b(new_n116_), .c(x18), .d(new_n66_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n86_), .O(new_n118_));
  inv1   g072(.a(new_n95_), .O(new_n119_));
  nor2   g073(.a(x22), .b(x21), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n84_), .c(new_n54_), .O(new_n121_));
  ...
  nand3  g086(.a(new_n132_), .b(new_n120_), .c(new_n95_), .O(new_n133_));
  oai21  g087(.a(new_n131_), .b(new_n71_), .c(new_n133_), .O(new_n134_));
  ...
  oai22  g101(.a(new_n107_), .b(new_n146_), .c(x18), .d(new_n147_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n86_), .O(new_n149_));
  nand2  g103(.a(x26), .b(x23), .O(new_n150_));
  nor2   g104(.a(x23), .b(x18), .O(new_n151_));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n71_), .O(new_n153_));
  aoi21  g107(.a(new_n153_), .b(new_n150_), .c(x22), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n101_), .c(new_n54_), .d(new_n82_), .O(new_n155_));
  nand3  g109(.a(new_n141_), .b(new_n120_), .c(new_n95_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x26), .O(new_n157_));
  oai21  g111(.a(new_n155_), .b(x17), .c(new_n157_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n149_), .O(z16));
  nand4  g114(.a(new_n101_), .b(new_n54_), .c(x19), .d(new_n81_), .O(new_n161_));
  nand3  g115(.a(new_n152_), .b(new_n123_), .c(new_n71_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n55_), .d(new_n81_), .O(new_n163_));
  nand2  g117(.a(new_n163_), .b(x16), .O(new_n164_));
  nand2  g118(.a(new_n164_), .b(new_n79_), .O(z17));
endmodule
