...
module FAU ( 
  ...
  aoi21  g18(.a(x27), .b(new_n64_), .c(new_n48_), .O(new_n65_));
  ...
  nand2  g23(.a(new_n52_), .b(new_n69_), .O(new_n70_));
  aoi21  g24(.a(new_n70_), .b(new_n68_), .c(new_n48_), .O(z05));
  ...
  nor2   g31(.a(new_n48_), .b(new_n52_), .O(z08));
  inv1   g32(.a(x17), .O(new_n79_));
  nor2   g33(.a(new_n51_), .b(new_n79_), .O(new_n80_));
  nor2   g34(.a(x19), .b(x17), .O(new_n81_));
  oai21  g35(.a(new_n81_), .b(new_n80_), .c(x16), .O(new_n82_));
  inv1   g36(.a(x16), .O(new_n83_));
  oai21  g37(.a(x18), .b(x08), .c(new_n83_), .O(new_n84_));
  nand2  g38(.a(new_n84_), .b(new_n82_), .O(z09));
  oai21  g39(.a(x18), .b(x09), .c(new_n83_), .O(new_n86_));
  inv1   g40(.a(x20), .O(new_n87_));
  nor2   g41(.a(new_n81_), .b(new_n87_), .O(new_n88_));
  nor3   g42(.a(x20), .b(x19), .c(x17), .O(new_n89_));
  oai21  g43(.a(new_n89_), .b(new_n88_), .c(x16), .O(new_n90_));
  nand2  g44(.a(new_n90_), .b(new_n86_), .O(z10));
  nor2   g45(.a(x20), .b(x19), .O(new_n92_));
  nand2  g46(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  inv1   g47(.a(x21), .O(new_n94_));
  nand4  g48(.a(new_n94_), .b(new_n87_), .c(new_n51_), .d(new_n79_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  nor2   g51(.a(x18), .b(x16), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  oai22  g53(.a(new_n99_), .b(new_n58_), .c(new_n97_), .d(new_n83_), .O(z11));
  nor3   g54(.a(x22), .b(x21), .c(x20), .O(new_n101_));
  aoi22  g55(.a(new_n101_), .b(new_n81_), .c(new_n95_), .d(x22), .O(new_n102_));
  oai22  g56(.a(new_n102_), .b(new_n83_), .c(new_n99_), .d(new_n61_), .O(z12));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n81_), .c(new_n87_), .O(new_n105_));
  nor3   g59(.a(x23), .b(x22), .c(x21), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n89_), .c(new_n105_), .d(x23), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n83_), .c(new_n99_), .d(new_n64_), .O(z13));
  aoi21  g62(.a(new_n106_), .b(new_n89_), .c(new_n69_), .O(new_n109_));
  nor2   g63(.a(x24), .b(x23), .O(new_n110_));
  nand4  g64(.a(new_n110_), .b(new_n104_), .c(new_n92_), .d(new_n79_), .O(new_n111_));
  inv1   g65(.a(new_n111_), .O(new_n112_));
  oai21  g66(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g67(.a(new_n98_), .b(x13), .O(new_n114_));
  nand2  g68(.a(new_n114_), .b(new_n113_), .O(z14));
  inv1   g69(.a(x22), .O(new_n116_));
  inv1   g70(.a(x23), .O(new_n117_));
  inv1   g71(.a(x25), .O(new_n118_));
  nand4  g72(.a(new_n118_), .b(new_n69_), .c(new_n117_), .d(new_n116_), .O(new_n119_));
  inv1   g73(.a(new_n119_), .O(new_n120_));
  aoi22  g74(.a(new_n120_), .b(new_n96_), .c(new_n111_), .d(x25), .O(new_n121_));
  nand2  g75(.a(new_n98_), .b(x14), .O(new_n122_));
  oai21  g76(.a(new_n121_), .b(new_n83_), .c(new_n122_), .O(z15));
  oai21  g77(.a(x18), .b(x15), .c(new_n83_), .O(new_n124_));
  nor2   g78(.a(x21), .b(x20), .O(new_n125_));
  nor2   g79(.a(x23), .b(x22), .O(new_n126_));
  nor2   g80(.a(x25), .b(x24), .O(new_n127_));
  nand4  g81(.a(new_n127_), .b(new_n126_), .c(new_n125_), .d(new_n81_), .O(new_n128_));
  nand2  g82(.a(new_n128_), .b(x26), .O(new_n129_));
  nor3   g83(.a(x26), .b(x25), .c(x24), .O(new_n130_));
  nand4  g84(.a(new_n130_), .b(new_n126_), .c(new_n125_), .d(new_n81_), .O(new_n131_));
  ...
  nor2   g88(.a(new_n51_), .b(x17), .O(new_n135_));
  nand4  g89(.a(new_n135_), .b(new_n130_), .c(new_n126_), .d(new_n125_), .O(new_n136_));
  nand2  g90(.a(x27), .b(x17), .O(new_n137_));
  aoi21  g91(.a(new_n137_), .b(new_n136_), .c(new_n83_), .O(z17));
endmodule
