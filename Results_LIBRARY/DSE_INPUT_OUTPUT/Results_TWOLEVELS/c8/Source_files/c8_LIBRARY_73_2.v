...
module FAU ( 
  ...
  aoi21  g064(.a(new_n103_), .b(new_n87_), .c(new_n110_), .O(new_n111_));
  ...
  nand2  g069(.a(new_n89_), .b(x03), .O(new_n116_));
  ...
  nand3  g083(.a(new_n129_), .b(new_n110_), .c(new_n101_), .O(new_n130_));
  ...
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n103_), .d(new_n87_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand2  g097(.a(new_n89_), .b(x06), .O(new_n144_));
  ...
  nand4  g104(.a(new_n150_), .b(new_n120_), .c(new_n103_), .d(new_n87_), .O(new_n151_));
  ...
  nand4  g108(.a(new_n120_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n155_));
