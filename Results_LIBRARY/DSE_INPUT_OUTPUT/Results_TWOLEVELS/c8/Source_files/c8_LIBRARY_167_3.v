...
module FAU ( 
  ...
  nor2   g045(.a(new_n85_), .b(new_n91_), .O(new_n92_));
  nor3   g046(.a(x20), .b(x19), .c(x17), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n87_), .b(x09), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(z10));
  ...
  aoi21  g059(.a(new_n98_), .b(new_n85_), .c(new_n105_), .O(new_n106_));
  nor2   g060(.a(x22), .b(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n85_), .c(new_n91_), .O(new_n108_));
  inv1   g062(.a(new_n108_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n106_), .c(x16), .O(new_n110_));
  nand2  g064(.a(new_n87_), .b(x11), .O(new_n111_));
  ...
  nand2  g071(.a(new_n108_), .b(x23), .O(new_n118_));
  nor2   g072(.a(x23), .b(x22), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(new_n93_), .c(new_n57_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n117_), .c(x16), .O(new_n122_));
  ...
  nand2  g079(.a(new_n125_), .b(new_n113_), .O(new_n126_));
  nand3  g080(.a(new_n91_), .b(new_n83_), .c(new_n82_), .O(new_n127_));
  nand3  g081(.a(new_n66_), .b(new_n105_), .c(new_n57_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n127_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n107_), .c(new_n130_), .d(new_n82_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(new_n117_), .c(x16), .O(new_n134_));
  ...
  nand2  g091(.a(new_n137_), .b(new_n113_), .O(new_n138_));
  nand2  g092(.a(new_n132_), .b(x25), .O(new_n139_));
  nor2   g093(.a(x25), .b(x24), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n119_), .c(new_n98_), .d(new_n85_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n117_), .c(x16), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n119_), .c(new_n98_), .d(new_n85_), .O(new_n148_));
  ...
  nand2  g106(.a(new_n66_), .b(new_n105_), .O(new_n153_));
  inv1   g107(.a(x25), .O(new_n154_));
  inv1   g108(.a(x26), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n71_), .O(new_n156_));
  nor2   g110(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand3  g111(.a(new_n98_), .b(x19), .c(new_n82_), .O(new_n158_));
  inv1   g112(.a(new_n158_), .O(new_n159_));
  nor2   g113(.a(new_n58_), .b(new_n82_), .O(new_n160_));
  aoi21  g114(.a(new_n159_), .b(new_n157_), .c(new_n160_), .O(new_n161_));
  aoi21  g115(.a(new_n161_), .b(new_n117_), .c(new_n113_), .O(z17));
endmodule
