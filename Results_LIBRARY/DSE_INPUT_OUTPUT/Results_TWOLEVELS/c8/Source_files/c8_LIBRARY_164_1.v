...
module FAU ( 
  ...
  oai21  g50(.a(new_n91_), .b(new_n55_), .c(new_n96_), .O(z10));
  inv1   g51(.a(x16), .O(new_n98_));
  oai21  g52(.a(x18), .b(x10), .c(new_n98_), .O(new_n99_));
  nor2   g53(.a(x20), .b(x19), .O(new_n100_));
  nand2  g54(.a(new_n100_), .b(new_n86_), .O(new_n101_));
  nand4  g55(.a(new_n60_), .b(new_n93_), .c(new_n51_), .d(new_n86_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n98_), .c(new_n99_), .O(z11));
  nor3   g59(.a(x22), .b(x21), .c(x20), .O(new_n106_));
  aoi22  g60(.a(new_n106_), .b(new_n88_), .c(new_n102_), .d(x22), .O(new_n107_));
  oai22  g61(.a(new_n107_), .b(new_n98_), .c(new_n91_), .d(new_n63_), .O(z12));
  nor2   g62(.a(x22), .b(x21), .O(new_n109_));
  nand3  g63(.a(new_n109_), .b(new_n88_), .c(new_n93_), .O(new_n110_));
  nor3   g64(.a(x23), .b(x22), .c(x21), .O(new_n111_));
  aoi22  g65(.a(new_n111_), .b(new_n95_), .c(new_n110_), .d(x23), .O(new_n112_));
  oai22  g66(.a(new_n112_), .b(new_n98_), .c(new_n91_), .d(new_n68_), .O(z13));
  aoi21  g67(.a(new_n111_), .b(new_n95_), .c(new_n73_), .O(new_n114_));
  nor2   g68(.a(x24), .b(x23), .O(new_n115_));
  nand4  g69(.a(new_n115_), .b(new_n109_), .c(new_n100_), .d(new_n86_), .O(new_n116_));
  inv1   g70(.a(new_n116_), .O(new_n117_));
  oai21  g71(.a(new_n117_), .b(new_n114_), .c(x16), .O(new_n118_));
  nand2  g72(.a(new_n90_), .b(x13), .O(new_n119_));
  nand2  g73(.a(new_n119_), .b(new_n118_), .O(z14));
  oai21  g74(.a(x18), .b(x14), .c(new_n98_), .O(new_n121_));
  ...
  aoi22  g78(.a(new_n124_), .b(new_n103_), .c(new_n116_), .d(x25), .O(new_n125_));
  oai21  g79(.a(new_n125_), .b(new_n98_), .c(new_n121_), .O(z15));
  ...
  nand2  g89(.a(new_n90_), .b(x15), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  nor2   g91(.a(x26), .b(x25), .O(new_n138_));
  nand3  g92(.a(new_n138_), .b(new_n128_), .c(new_n73_), .O(new_n139_));
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n86_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n52_), .d(new_n86_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(new_n84_), .O(z17));
endmodule
