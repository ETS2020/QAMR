...
module FAU ( 
  ...
  nand3  g042(.a(new_n88_), .b(new_n84_), .c(new_n47_), .O(z09));
  inv1   g043(.a(x01), .O(new_n90_));
  nand2  g044(.a(x18), .b(new_n77_), .O(new_n91_));
  oai22  g045(.a(new_n91_), .b(new_n90_), .c(x18), .d(new_n55_), .O(new_n92_));
  nand2  g046(.a(new_n92_), .b(new_n85_), .O(new_n93_));
  nor2   g047(.a(x20), .b(x19), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n81_), .O(new_n95_));
  oai21  g049(.a(new_n83_), .b(new_n57_), .c(new_n95_), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n47_), .c(x16), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n93_), .O(z10));
  inv1   g052(.a(x02), .O(new_n99_));
  oai22  g053(.a(new_n91_), .b(new_n99_), .c(x18), .d(new_n60_), .O(new_n100_));
  ...
  oai22  g063(.a(new_n91_), .b(new_n109_), .c(x18), .d(new_n63_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n85_), .O(new_n111_));
  nand2  g065(.a(new_n105_), .b(x22), .O(new_n112_));
  nor2   g066(.a(x22), .b(x21), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n83_), .c(new_n57_), .O(new_n114_));
  ...
  nand3  g079(.a(new_n125_), .b(new_n120_), .c(new_n47_), .O(z13));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n103_), .c(new_n71_), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n113_), .c(new_n94_), .d(new_n81_), .O(new_n132_));
  inv1   g086(.a(new_n132_), .O(new_n133_));
  oai21  g087(.a(new_n133_), .b(new_n130_), .c(x16), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n129_), .c(new_n47_), .O(z14));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n104_), .d(new_n83_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n47_), .O(z15));
  oai21  g099(.a(x18), .b(new_n85_), .c(x15), .O(new_n146_));
  nand2  g100(.a(new_n142_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n140_), .c(new_n104_), .d(new_n83_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  nand3  g105(.a(x18), .b(new_n85_), .c(x07), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n151_), .c(new_n146_), .O(z16));
  nor2   g107(.a(x26), .b(x25), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n140_), .c(new_n71_), .O(new_n155_));
  nand3  g109(.a(new_n104_), .b(x19), .c(new_n81_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n81_), .O(new_n157_));
