...
module FAU ( 
  ...
  nand2  g050(.a(new_n89_), .b(x09), .O(new_n97_));
  ...
  oai21  g059(.a(new_n95_), .b(new_n57_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(new_n103_), .c(x16), .O(new_n107_));
  nand2  g061(.a(new_n107_), .b(new_n102_), .O(z11));
  oai21  g062(.a(x16), .b(x03), .c(x18), .O(new_n109_));
  aoi21  g063(.a(new_n104_), .b(new_n87_), .c(new_n63_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n87_), .c(new_n93_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n89_), .b(x11), .O(new_n115_));
  ...
  nand3  g073(.a(new_n119_), .b(new_n95_), .c(new_n57_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g076(.a(new_n89_), .b(x12), .O(new_n123_));
  ...
  nand3  g081(.a(new_n93_), .b(new_n85_), .c(new_n84_), .O(new_n128_));
  nand3  g082(.a(new_n68_), .b(new_n63_), .c(new_n57_), .O(new_n129_));
  oai21  g083(.a(new_n129_), .b(new_n128_), .c(x24), .O(new_n130_));
  nor2   g084(.a(x20), .b(x19), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n111_), .c(new_n131_), .d(new_n84_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(new_n130_), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n103_), .c(x16), .O(new_n135_));
  ...
  nand4  g093(.a(new_n139_), .b(new_n119_), .c(new_n104_), .d(new_n87_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n89_), .b(x14), .O(new_n143_));
  ...
  nand2  g100(.a(new_n146_), .b(new_n99_), .O(new_n147_));
  nand2  g101(.a(new_n140_), .b(x26), .O(new_n148_));
  nor3   g102(.a(x26), .b(x25), .c(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n119_), .c(new_n104_), .d(new_n87_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n103_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z16));
  nand2  g107(.a(new_n68_), .b(new_n63_), .O(new_n154_));
  inv1   g108(.a(x25), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n73_), .O(new_n157_));
  ...
  nor2   g114(.a(new_n58_), .b(new_n84_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(new_n103_), .c(new_n99_), .O(z17));
endmodule
