...
module FAU ( 
  ...
  nand4  g55(.a(new_n59_), .b(new_n94_), .c(new_n50_), .d(new_n85_), .O(new_n102_));
  inv1   g56(.a(new_n102_), .O(new_n103_));
  aoi21  g57(.a(new_n101_), .b(x21), .c(new_n103_), .O(new_n104_));
  oai21  g58(.a(new_n104_), .b(new_n89_), .c(new_n99_), .O(z11));
  nand2  g59(.a(new_n102_), .b(x22), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n87_), .c(new_n94_), .O(new_n108_));
  and2   g62(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  nor2   g63(.a(new_n90_), .b(x16), .O(new_n110_));
  nand2  g64(.a(new_n110_), .b(x03), .O(new_n111_));
  oai21  g65(.a(new_n109_), .b(new_n89_), .c(new_n111_), .O(z12));
  nor3   g66(.a(x23), .b(x22), .c(x21), .O(new_n113_));
  aoi22  g67(.a(new_n113_), .b(new_n96_), .c(new_n108_), .d(x23), .O(new_n114_));
  nand2  g68(.a(new_n110_), .b(x04), .O(new_n115_));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n96_), .c(new_n118_), .O(new_n119_));
  nor2   g73(.a(x24), .b(x23), .O(new_n120_));
  nand4  g74(.a(new_n120_), .b(new_n107_), .c(new_n100_), .d(new_n85_), .O(new_n121_));
  ...
  nand4  g79(.a(new_n75_), .b(new_n118_), .c(new_n125_), .d(new_n64_), .O(new_n126_));
  inv1   g80(.a(new_n126_), .O(new_n127_));
  aoi22  g81(.a(new_n127_), .b(new_n103_), .c(new_n121_), .d(x25), .O(new_n128_));
  nand2  g82(.a(new_n110_), .b(x06), .O(new_n129_));
  ...
  nand4  g95(.a(new_n133_), .b(new_n80_), .c(new_n75_), .d(new_n118_), .O(new_n142_));
