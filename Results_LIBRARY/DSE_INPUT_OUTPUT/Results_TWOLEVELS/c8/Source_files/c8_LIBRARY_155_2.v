...
module FAU ( 
  ...
  oai21  g050(.a(new_n87_), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  ...
  oai21  g059(.a(new_n103_), .b(new_n62_), .c(new_n105_), .O(new_n106_));
  nand3  g060(.a(new_n106_), .b(x18), .c(x16), .O(new_n107_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n87_), .c(new_n57_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(x18), .c(x16), .O(new_n116_));
  ...
  nand2  g073(.a(new_n119_), .b(new_n47_), .O(new_n120_));
  ...
  nand3  g078(.a(new_n124_), .b(x18), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n120_), .O(z13));
  oai21  g080(.a(x16), .b(x13), .c(new_n83_), .O(new_n127_));
  inv1   g081(.a(x24), .O(new_n128_));
  aoi21  g082(.a(new_n122_), .b(new_n103_), .c(new_n128_), .O(new_n129_));
  nor2   g083(.a(x24), .b(x23), .O(new_n130_));
  nand4  g084(.a(new_n130_), .b(new_n113_), .c(new_n95_), .d(new_n85_), .O(new_n131_));
  inv1   g085(.a(new_n131_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n129_), .c(x16), .O(new_n133_));
  nand2  g087(.a(new_n89_), .b(x05), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n133_), .c(new_n127_), .O(z14));
  oai21  g089(.a(x16), .b(x14), .c(new_n83_), .O(new_n136_));
  nand2  g090(.a(new_n131_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nor2   g092(.a(x25), .b(x24), .O(new_n139_));
  nand4  g093(.a(new_n139_), .b(new_n138_), .c(new_n104_), .d(new_n87_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g096(.a(new_n89_), .b(x06), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n142_), .c(new_n136_), .O(z15));
  oai21  g098(.a(x16), .b(x15), .c(new_n83_), .O(new_n145_));
  nand2  g099(.a(new_n140_), .b(x26), .O(new_n146_));
  nor3   g100(.a(x26), .b(x25), .c(x24), .O(new_n147_));
  nand4  g101(.a(new_n147_), .b(new_n138_), .c(new_n104_), .d(new_n87_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(x16), .O(new_n150_));
  nand2  g104(.a(new_n89_), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n150_), .c(new_n145_), .O(z16));
  inv1   g106(.a(x23), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n67_), .O(new_n154_));
  inv1   g108(.a(x25), .O(new_n155_));
  inv1   g109(.a(x26), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n155_), .c(new_n128_), .O(new_n157_));
  nor2   g111(.a(new_n157_), .b(new_n154_), .O(new_n158_));
  nand3  g112(.a(new_n104_), .b(x19), .c(new_n85_), .O(new_n159_));
  inv1   g113(.a(new_n159_), .O(new_n160_));
  nor2   g114(.a(new_n52_), .b(new_n85_), .O(new_n161_));
  aoi21  g115(.a(new_n160_), .b(new_n158_), .c(new_n161_), .O(new_n162_));
  aoi21  g116(.a(new_n162_), .b(x18), .c(new_n47_), .O(z17));
endmodule
