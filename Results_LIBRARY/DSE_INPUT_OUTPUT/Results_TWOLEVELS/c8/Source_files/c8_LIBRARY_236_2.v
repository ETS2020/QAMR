...
module FAU ( 
  ...
  nand3  g052(.a(new_n98_), .b(new_n93_), .c(new_n87_), .O(z10));
  nand2  g053(.a(x18), .b(x02), .O(new_n100_));
  nand3  g054(.a(new_n83_), .b(x10), .c(new_n52_), .O(new_n101_));
  ...
  nand3  g061(.a(new_n107_), .b(new_n87_), .c(x16), .O(new_n108_));
  nand2  g062(.a(new_n108_), .b(new_n103_), .O(z11));
  nand2  g063(.a(x18), .b(x03), .O(new_n110_));
  nand3  g064(.a(new_n83_), .b(x11), .c(new_n52_), .O(new_n111_));
  ...
  nand3  g071(.a(new_n117_), .b(new_n87_), .c(x16), .O(new_n118_));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n87_), .O(z13));
  nand3  g082(.a(new_n83_), .b(x13), .c(new_n52_), .O(new_n129_));
  oai21  g083(.a(new_n83_), .b(new_n52_), .c(new_n129_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n81_), .O(new_n131_));
  inv1   g085(.a(x17), .O(new_n132_));
  nand3  g086(.a(new_n94_), .b(new_n49_), .c(new_n132_), .O(new_n133_));
  inv1   g087(.a(x23), .O(new_n134_));
  nand3  g088(.a(new_n134_), .b(new_n63_), .c(new_n104_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n133_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n115_), .c(new_n137_), .d(new_n132_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n87_), .c(x16), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n131_), .O(z14));
  nand2  g096(.a(x18), .b(x06), .O(new_n143_));
  nand3  g097(.a(new_n83_), .b(x14), .c(new_n52_), .O(new_n144_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n124_), .c(new_n105_), .d(new_n95_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n87_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z15));
  nand2  g106(.a(x18), .b(x07), .O(new_n153_));
  oai21  g107(.a(x18), .b(new_n77_), .c(new_n153_), .O(new_n154_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n124_), .c(new_n105_), .d(new_n95_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n87_), .O(z16));
  nor2   g115(.a(x26), .b(x25), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n124_), .c(new_n71_), .O(new_n163_));
  nand3  g117(.a(new_n105_), .b(x19), .c(new_n132_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n50_), .d(new_n132_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n87_), .O(z17));
endmodule
