...
module FAU ( 
  ...
  nand3  g051(.a(new_n97_), .b(new_n47_), .c(x09), .O(new_n98_));
  nand2  g052(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n91_), .O(new_n100_));
  nand3  g054(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n101_));
  oai21  g055(.a(new_n89_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  ...
  nand2  g068(.a(new_n111_), .b(x22), .O(new_n115_));
  ...
  nand3  g073(.a(x18), .b(new_n91_), .c(x03), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n119_), .O(z12));
  ...
  nand3  g080(.a(new_n126_), .b(new_n109_), .c(new_n108_), .O(new_n127_));
  ...
  nand3  g095(.a(new_n141_), .b(new_n85_), .c(x16), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n126_), .c(new_n110_), .d(new_n89_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n126_), .c(new_n110_), .d(new_n89_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n85_), .O(z16));
  nand4  g115(.a(new_n126_), .b(new_n82_), .c(new_n77_), .d(new_n72_), .O(new_n162_));
