...
module FAU ( 
  ...
  nand2  g039(.a(new_n48_), .b(new_n55_), .O(z08));
  ...
  aoi21  g045(.a(new_n91_), .b(new_n88_), .c(new_n87_), .O(new_n92_));
  aoi21  g046(.a(new_n87_), .b(x08), .c(new_n92_), .O(new_n93_));
  nand3  g047(.a(x18), .b(new_n87_), .c(x00), .O(new_n94_));
  oai21  g048(.a(new_n93_), .b(x18), .c(new_n94_), .O(z09));
  ...
  oai21  g063(.a(new_n99_), .b(new_n60_), .c(new_n109_), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n107_), .c(x16), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n106_), .O(z11));
  oai21  g066(.a(x16), .b(x03), .c(x18), .O(new_n113_));
  inv1   g067(.a(x22), .O(new_n114_));
  aoi21  g068(.a(new_n108_), .b(new_n97_), .c(new_n114_), .O(new_n115_));
  ...
  nand2  g073(.a(new_n101_), .b(x11), .O(new_n120_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n99_), .c(new_n60_), .O(new_n127_));
  nand2  g081(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n107_), .c(x16), .O(new_n129_));
  ...
  nand3  g087(.a(new_n54_), .b(new_n90_), .c(new_n89_), .O(new_n134_));
  nand3  g088(.a(new_n68_), .b(new_n114_), .c(new_n60_), .O(new_n135_));
  oai21  g089(.a(new_n135_), .b(new_n134_), .c(x24), .O(new_n136_));
  nor2   g090(.a(x20), .b(x19), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n137_), .d(new_n89_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n107_), .c(x16), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n126_), .c(new_n108_), .d(new_n97_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n146_), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n107_), .c(x16), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n145_), .O(z15));
  oai21  g105(.a(x16), .b(x07), .c(x18), .O(new_n152_));
  nand2  g106(.a(new_n148_), .b(x26), .O(new_n153_));
  nor3   g107(.a(x26), .b(x25), .c(x24), .O(new_n154_));
  nand4  g108(.a(new_n154_), .b(new_n126_), .c(new_n108_), .d(new_n97_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  nand2  g111(.a(new_n101_), .b(x15), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n157_), .c(new_n152_), .O(z16));
  nand2  g113(.a(new_n68_), .b(new_n114_), .O(new_n160_));
  nand3  g114(.a(new_n83_), .b(new_n78_), .c(new_n73_), .O(new_n161_));
  nor2   g115(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand3  g116(.a(new_n108_), .b(x19), .c(new_n89_), .O(new_n163_));
  inv1   g117(.a(new_n163_), .O(new_n164_));
  nor2   g118(.a(new_n55_), .b(new_n89_), .O(new_n165_));
  aoi21  g119(.a(new_n164_), .b(new_n162_), .c(new_n165_), .O(new_n166_));
  aoi21  g120(.a(new_n166_), .b(new_n107_), .c(new_n87_), .O(z17));
endmodule
