...
module FAU ( 
  ...
  nand2  g040(.a(x18), .b(new_n76_), .O(new_n87_));
  ...
  nand3  g047(.a(new_n93_), .b(new_n48_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n94_), .b(new_n89_), .O(z09));
  inv1   g049(.a(x01), .O(new_n96_));
  oai22  g050(.a(new_n87_), .b(new_n96_), .c(x18), .d(new_n52_), .O(new_n97_));
  ...
  oai22  g059(.a(new_n87_), .b(new_n105_), .c(x18), .d(new_n58_), .O(new_n106_));
  ...
  aoi21  g071(.a(new_n110_), .b(new_n91_), .c(new_n63_), .O(new_n118_));
  ...
  aoi21  g089(.a(new_n128_), .b(new_n109_), .c(new_n73_), .O(new_n136_));
  ...
  nand3  g094(.a(new_n140_), .b(new_n135_), .c(new_n48_), .O(z14));
  nand3  g095(.a(x18), .b(new_n76_), .c(x06), .O(new_n142_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n110_), .d(new_n91_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n48_), .c(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n154_), .O(z16));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n146_), .c(new_n73_), .O(new_n162_));
  nand3  g116(.a(new_n110_), .b(x19), .c(new_n99_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n55_), .d(new_n99_), .O(new_n164_));
