...
module FAU ( 
  ...
  nand2  g50(.a(new_n96_), .b(new_n85_), .O(new_n97_));
  inv1   g51(.a(x21), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n57_), .c(new_n51_), .d(new_n85_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai22  g55(.a(new_n101_), .b(new_n89_), .c(new_n90_), .d(new_n60_), .O(z11));
  nor3   g56(.a(x22), .b(x21), .c(x20), .O(new_n103_));
  aoi22  g57(.a(new_n103_), .b(new_n87_), .c(new_n99_), .d(x22), .O(new_n104_));
  oai22  g58(.a(new_n104_), .b(new_n89_), .c(new_n90_), .d(new_n63_), .O(z12));
  oai21  g59(.a(x18), .b(x12), .c(new_n89_), .O(new_n106_));
  nor2   g60(.a(x22), .b(x21), .O(new_n107_));
  nand3  g61(.a(new_n107_), .b(new_n87_), .c(new_n57_), .O(new_n108_));
  nor3   g62(.a(x23), .b(x22), .c(x21), .O(new_n109_));
  aoi22  g63(.a(new_n109_), .b(new_n93_), .c(new_n108_), .d(x23), .O(new_n110_));
  oai21  g64(.a(new_n110_), .b(new_n89_), .c(new_n106_), .O(z13));
  oai21  g65(.a(x18), .b(x13), .c(new_n89_), .O(new_n112_));
  aoi21  g66(.a(new_n109_), .b(new_n93_), .c(new_n73_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n107_), .c(new_n96_), .d(new_n85_), .O(new_n115_));
  ...
  oai21  g72(.a(x18), .b(x14), .c(new_n89_), .O(new_n119_));
  inv1   g73(.a(x22), .O(new_n120_));
  inv1   g74(.a(x25), .O(new_n121_));
  nand4  g75(.a(new_n121_), .b(new_n73_), .c(new_n68_), .d(new_n120_), .O(new_n122_));
  inv1   g76(.a(new_n122_), .O(new_n123_));
  aoi22  g77(.a(new_n123_), .b(new_n100_), .c(new_n115_), .d(x25), .O(new_n124_));
  oai21  g78(.a(new_n124_), .b(new_n89_), .c(new_n119_), .O(z15));
  ...
  nand3  g88(.a(new_n47_), .b(new_n89_), .c(x15), .O(new_n135_));
  ...
  aoi21  g93(.a(new_n139_), .b(new_n138_), .c(new_n89_), .O(z17));
endmodule
