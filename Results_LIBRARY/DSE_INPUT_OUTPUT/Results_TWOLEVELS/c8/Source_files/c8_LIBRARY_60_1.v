...
module FAU ( 
  ...
  nand3  g053(.a(new_n54_), .b(new_n87_), .c(new_n86_), .O(new_n100_));
  ...
  oai22  g058(.a(new_n97_), .b(new_n104_), .c(x18), .d(new_n58_), .O(new_n105_));
  ...
  oai21  g066(.a(x18), .b(x11), .c(new_n91_), .O(new_n113_));
  ...
  nand3  g072(.a(new_n118_), .b(new_n113_), .c(new_n84_), .O(z12));
  ...
  nand3  g081(.a(new_n127_), .b(new_n122_), .c(new_n84_), .O(z13));
  nand3  g082(.a(x18), .b(x05), .c(x03), .O(new_n129_));
  ...
  nand3  g093(.a(x18), .b(x06), .c(x03), .O(new_n140_));
  ...
  nand4  g098(.a(new_n144_), .b(new_n124_), .c(new_n108_), .d(new_n89_), .O(new_n145_));
  ...
  nand3  g102(.a(x18), .b(x07), .c(x03), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n124_), .c(new_n108_), .d(new_n89_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n159_), .b(new_n124_), .c(new_n158_), .O(new_n160_));
  nand3  g114(.a(new_n108_), .b(x19), .c(new_n86_), .O(new_n161_));
  oai22  g115(.a(new_n161_), .b(new_n160_), .c(new_n55_), .d(new_n86_), .O(new_n162_));
