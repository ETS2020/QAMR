...
module FAU ( 
  ...
  nor2   g35(.a(new_n50_), .b(new_n81_), .O(new_n82_));
  ...
  oai21  g40(.a(new_n86_), .b(new_n80_), .c(new_n84_), .O(z09));
  ...
  oai21  g46(.a(new_n86_), .b(new_n88_), .c(new_n92_), .O(z10));
  inv1   g47(.a(x18), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(x02), .c(new_n85_), .O(new_n95_));
  nor2   g49(.a(x20), .b(x19), .O(new_n96_));
  nand2  g50(.a(new_n96_), .b(new_n81_), .O(new_n97_));
  inv1   g51(.a(x21), .O(new_n98_));
  nand4  g52(.a(new_n98_), .b(new_n89_), .c(new_n50_), .d(new_n81_), .O(new_n99_));
  inv1   g53(.a(new_n99_), .O(new_n100_));
  aoi21  g54(.a(new_n97_), .b(x21), .c(new_n100_), .O(new_n101_));
  oai21  g55(.a(new_n101_), .b(new_n85_), .c(new_n95_), .O(z11));
  oai21  g56(.a(new_n94_), .b(x03), .c(new_n85_), .O(new_n103_));
  ...
  oai21  g61(.a(new_n107_), .b(new_n85_), .c(new_n103_), .O(z12));
  oai21  g62(.a(new_n94_), .b(x04), .c(new_n85_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n91_), .c(new_n106_), .d(x23), .O(new_n111_));
  oai21  g65(.a(new_n111_), .b(new_n85_), .c(new_n109_), .O(z13));
  oai21  g66(.a(new_n94_), .b(x05), .c(new_n85_), .O(new_n113_));
  inv1   g67(.a(x24), .O(new_n114_));
  aoi21  g68(.a(new_n110_), .b(new_n91_), .c(new_n114_), .O(new_n115_));
  nor2   g69(.a(x24), .b(x23), .O(new_n116_));
  nand4  g70(.a(new_n116_), .b(new_n105_), .c(new_n96_), .d(new_n81_), .O(new_n117_));
  ...
  oai21  g74(.a(new_n94_), .b(x06), .c(new_n85_), .O(new_n121_));
  inv1   g75(.a(x22), .O(new_n122_));
  inv1   g76(.a(x25), .O(new_n123_));
  nand4  g77(.a(new_n123_), .b(new_n114_), .c(new_n65_), .d(new_n122_), .O(new_n124_));
  inv1   g78(.a(new_n124_), .O(new_n125_));
  aoi22  g79(.a(new_n125_), .b(new_n100_), .c(new_n117_), .d(x25), .O(new_n126_));
  oai21  g80(.a(new_n126_), .b(new_n85_), .c(new_n121_), .O(z15));
  oai21  g81(.a(new_n94_), .b(x07), .c(new_n85_), .O(new_n128_));
