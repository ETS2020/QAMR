...
module FAU ( 
  ...
  nand3  g039(.a(new_n85_), .b(x08), .c(x04), .O(new_n86_));
  ...
  nor2   g052(.a(new_n90_), .b(new_n98_), .O(new_n99_));
  nor3   g053(.a(x20), .b(x19), .c(x17), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n99_), .c(x16), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n97_), .c(new_n81_), .O(z10));
  ...
  nand3  g064(.a(new_n110_), .b(new_n105_), .c(new_n81_), .O(z11));
  ...
  aoi21  g068(.a(new_n107_), .b(new_n90_), .c(new_n62_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n90_), .c(new_n98_), .O(new_n117_));
  ...
  aoi21  g075(.a(new_n85_), .b(new_n65_), .c(x16), .O(new_n122_));
  nand2  g076(.a(new_n117_), .b(x23), .O(new_n123_));
  nor3   g077(.a(x23), .b(x22), .c(x21), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n100_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  aoi21  g080(.a(new_n126_), .b(x16), .c(new_n122_), .O(new_n127_));
  nand3  g081(.a(new_n126_), .b(x18), .c(x16), .O(new_n128_));
  oai21  g082(.a(new_n127_), .b(new_n121_), .c(new_n128_), .O(z13));
  ...
  aoi21  g086(.a(new_n124_), .b(new_n100_), .c(new_n70_), .O(new_n133_));
  inv1   g087(.a(x17), .O(new_n134_));
  nand3  g088(.a(new_n98_), .b(new_n49_), .c(new_n134_), .O(new_n135_));
  nor2   g089(.a(x24), .b(x23), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(new_n116_), .O(new_n137_));
  nor2   g091(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n133_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n132_), .c(new_n81_), .O(z14));
  ...
  nand4  g099(.a(new_n145_), .b(new_n144_), .c(new_n107_), .d(new_n90_), .O(new_n146_));
  oai21  g100(.a(new_n138_), .b(new_n75_), .c(new_n146_), .O(new_n147_));
  ...
  nand3  g112(.a(new_n107_), .b(x19), .c(new_n134_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n155_), .c(new_n50_), .d(new_n134_), .O(new_n160_));
