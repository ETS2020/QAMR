...
module FAU ( 
  ...
  nand2  g54(.a(new_n92_), .b(x02), .O(new_n101_));
  oai21  g55(.a(new_n100_), .b(new_n85_), .c(new_n101_), .O(z11));
  oai21  g56(.a(new_n86_), .b(x03), .c(new_n85_), .O(new_n103_));
  ...
  oai21  g62(.a(new_n86_), .b(x04), .c(new_n85_), .O(new_n109_));
  ...
  aoi21  g66(.a(new_n110_), .b(new_n90_), .c(new_n68_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n105_), .c(new_n95_), .d(new_n80_), .O(new_n115_));
  ...
  nand4  g76(.a(new_n73_), .b(new_n68_), .c(new_n122_), .d(new_n121_), .O(new_n123_));
  ...
  nand3  g93(.a(new_n139_), .b(new_n128_), .c(new_n68_), .O(new_n140_));
