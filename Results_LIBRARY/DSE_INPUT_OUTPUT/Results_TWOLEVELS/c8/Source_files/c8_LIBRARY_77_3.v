...
module FAU ( 
  ...
  nand2  g028(.a(new_n64_), .b(new_n74_), .O(new_n75_));
  ...
  nand2  g033(.a(new_n48_), .b(new_n64_), .O(z08));
  inv1   g034(.a(x16), .O(new_n81_));
  inv1   g035(.a(x00), .O(new_n82_));
  nand2  g036(.a(x18), .b(new_n58_), .O(new_n83_));
  ...
  oai21  g062(.a(x18), .b(new_n81_), .c(x11), .O(new_n109_));
  inv1   g063(.a(x22), .O(new_n110_));
  aoi21  g064(.a(new_n104_), .b(new_n87_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g069(.a(x18), .b(new_n81_), .c(x03), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n115_), .c(new_n109_), .O(z12));
  nand2  g071(.a(x18), .b(x04), .O(new_n118_));
  oai21  g072(.a(x18), .b(new_n61_), .c(new_n118_), .O(new_n119_));
  ...
  aoi21  g083(.a(new_n122_), .b(new_n97_), .c(new_n69_), .O(new_n130_));
  ...
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n104_), .d(new_n87_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(x16), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n140_), .c(new_n48_), .O(z15));
  inv1   g101(.a(x07), .O(new_n148_));
  oai22  g102(.a(new_n83_), .b(new_n148_), .c(x18), .d(new_n77_), .O(new_n149_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n104_), .d(new_n87_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n142_), .c(new_n69_), .O(new_n158_));
  nand3  g112(.a(new_n104_), .b(x19), .c(new_n131_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n64_), .d(new_n131_), .O(new_n160_));
