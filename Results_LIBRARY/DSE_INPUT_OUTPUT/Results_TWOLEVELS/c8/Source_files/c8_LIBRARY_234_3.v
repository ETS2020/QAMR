...
module FAU ( 
  ...
  nand3  g015(.a(new_n55_), .b(new_n59_), .c(new_n61_), .O(new_n62_));
  nand2  g016(.a(new_n62_), .b(new_n60_), .O(z02));
  ...
  nand2  g034(.a(new_n48_), .b(new_n55_), .O(z08));
  inv1   g035(.a(x16), .O(new_n82_));
  inv1   g036(.a(x00), .O(new_n83_));
  nand2  g037(.a(x18), .b(new_n58_), .O(new_n84_));
  ...
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n48_), .O(z10));
  inv1   g051(.a(x02), .O(new_n98_));
  nand2  g052(.a(new_n61_), .b(x10), .O(new_n99_));
  oai21  g053(.a(new_n84_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  ...
  nand2  g071(.a(new_n117_), .b(new_n82_), .O(new_n118_));
  ...
  oai21  g079(.a(x18), .b(new_n72_), .c(new_n125_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(new_n82_), .O(new_n127_));
  inv1   g081(.a(x24), .O(new_n128_));
  aoi21  g082(.a(new_n120_), .b(new_n95_), .c(new_n128_), .O(new_n129_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n102_), .d(new_n93_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n139_), .c(new_n48_), .O(z15));
  inv1   g100(.a(x07), .O(new_n147_));
  oai22  g101(.a(new_n84_), .b(new_n147_), .c(x18), .d(new_n78_), .O(new_n148_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n141_), .c(new_n102_), .d(new_n93_), .O(new_n152_));
  ...
  nand3  g111(.a(new_n102_), .b(x19), .c(new_n130_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n55_), .d(new_n130_), .O(new_n159_));
