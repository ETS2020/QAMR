...
module FAU ( 
  ...
  nand2  g031(.a(z08), .b(new_n76_), .O(new_n78_));
  inv1   g032(.a(x25), .O(new_n79_));
  nand3  g033(.a(new_n52_), .b(new_n79_), .c(new_n47_), .O(new_n80_));
  ...
  nor3   g045(.a(new_n48_), .b(x19), .c(x17), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand2  g047(.a(new_n93_), .b(new_n89_), .O(z09));
  inv1   g048(.a(x01), .O(new_n95_));
  oai22  g049(.a(new_n87_), .b(new_n95_), .c(x18), .d(new_n55_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n85_), .O(new_n97_));
  inv1   g051(.a(new_n48_), .O(new_n98_));
  nor2   g052(.a(x19), .b(x17), .O(new_n99_));
  nand3  g053(.a(new_n57_), .b(new_n51_), .c(new_n90_), .O(new_n100_));
  oai21  g054(.a(new_n99_), .b(new_n57_), .c(new_n100_), .O(new_n101_));
  ...
  and2   g060(.a(new_n100_), .b(x21), .O(new_n107_));
  inv1   g061(.a(x21), .O(new_n108_));
  nand3  g062(.a(new_n99_), .b(new_n108_), .c(new_n57_), .O(new_n109_));
  inv1   g063(.a(new_n109_), .O(new_n110_));
  oai21  g064(.a(new_n110_), .b(new_n107_), .c(x16), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n106_), .c(new_n98_), .O(z11));
  inv1   g066(.a(x03), .O(new_n113_));
  oai22  g067(.a(new_n87_), .b(new_n113_), .c(x18), .d(new_n63_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n85_), .O(new_n115_));
  nand3  g069(.a(new_n109_), .b(new_n98_), .c(x22), .O(new_n116_));
  nor2   g070(.a(new_n48_), .b(x22), .O(new_n117_));
  nand4  g071(.a(new_n117_), .b(new_n108_), .c(new_n57_), .d(new_n51_), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(x17), .c(new_n116_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(x16), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n115_), .O(z12));
  inv1   g075(.a(x04), .O(new_n122_));
  oai22  g076(.a(new_n87_), .b(new_n122_), .c(x18), .d(new_n68_), .O(new_n123_));
  nand2  g077(.a(new_n123_), .b(new_n85_), .O(new_n124_));
  nor2   g078(.a(x22), .b(x21), .O(new_n125_));
  nand3  g079(.a(new_n125_), .b(new_n99_), .c(new_n57_), .O(new_n126_));
  nand3  g080(.a(new_n126_), .b(new_n98_), .c(x23), .O(new_n127_));
  inv1   g081(.a(new_n127_), .O(new_n128_));
  nor2   g082(.a(new_n48_), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n65_), .c(new_n108_), .d(new_n57_), .O(new_n130_));
  nor2   g084(.a(new_n130_), .b(x19), .O(new_n131_));
  aoi21  g085(.a(new_n131_), .b(new_n90_), .c(new_n128_), .O(new_n132_));
  oai21  g086(.a(new_n132_), .b(new_n85_), .c(new_n124_), .O(z13));
  ...
  nor3   g090(.a(x24), .b(x23), .c(x22), .O(new_n137_));
  nand4  g091(.a(new_n137_), .b(new_n108_), .c(new_n57_), .d(new_n51_), .O(new_n138_));
  nor2   g092(.a(x23), .b(x22), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n108_), .O(new_n140_));
  oai21  g094(.a(new_n140_), .b(new_n100_), .c(x24), .O(new_n141_));
  oai21  g095(.a(new_n138_), .b(x17), .c(new_n141_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(x16), .O(new_n143_));
  nand3  g097(.a(new_n143_), .b(new_n136_), .c(new_n98_), .O(z14));
  ...
  xor2a  g101(.a(x25), .b(x24), .O(new_n148_));
  nand2  g102(.a(x25), .b(x23), .O(new_n149_));
  oai21  g103(.a(new_n148_), .b(x23), .c(new_n149_), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n65_), .c(new_n108_), .d(new_n57_), .O(new_n151_));
  nand2  g105(.a(x25), .b(x20), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n51_), .c(new_n90_), .O(new_n154_));
  nand2  g108(.a(new_n125_), .b(new_n99_), .O(new_n155_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n147_), .c(new_n98_), .O(z15));
  nand2  g113(.a(x18), .b(x07), .O(new_n160_));
  oai21  g114(.a(x18), .b(new_n82_), .c(new_n160_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(new_n85_), .O(new_n162_));
  nand4  g116(.a(new_n57_), .b(new_n51_), .c(new_n90_), .d(x16), .O(new_n163_));
  inv1   g117(.a(x23), .O(new_n164_));
  inv1   g118(.a(x26), .O(new_n165_));
  nand4  g119(.a(new_n125_), .b(new_n165_), .c(new_n73_), .d(new_n164_), .O(new_n166_));
  oai21  g120(.a(new_n166_), .b(new_n163_), .c(new_n47_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n79_), .O(new_n168_));
  nand4  g122(.a(new_n139_), .b(new_n110_), .c(new_n79_), .d(new_n73_), .O(new_n169_));
  nand3  g123(.a(new_n169_), .b(x26), .c(x16), .O(new_n170_));
  nand3  g124(.a(new_n170_), .b(new_n168_), .c(new_n162_), .O(z16));
  nand4  g125(.a(new_n108_), .b(new_n57_), .c(x19), .d(new_n90_), .O(new_n172_));
  nand4  g126(.a(new_n139_), .b(new_n165_), .c(new_n79_), .d(new_n73_), .O(new_n173_));
  oai22  g127(.a(new_n173_), .b(new_n172_), .c(new_n52_), .d(new_n90_), .O(new_n174_));
  nand2  g128(.a(new_n174_), .b(x16), .O(new_n175_));
  nand2  g129(.a(new_n175_), .b(new_n98_), .O(z17));
endmodule
