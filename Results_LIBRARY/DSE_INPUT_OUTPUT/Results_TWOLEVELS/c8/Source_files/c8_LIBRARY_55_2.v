...
module FAU ( 
  ...
  oai21  g044(.a(x16), .b(x09), .c(new_n81_), .O(new_n91_));
  nor2   g045(.a(new_n86_), .b(new_n54_), .O(new_n92_));
  nor3   g046(.a(x20), .b(x19), .c(x17), .O(new_n93_));
  oai21  g047(.a(new_n93_), .b(new_n92_), .c(x16), .O(new_n94_));
  nand2  g048(.a(new_n88_), .b(x01), .O(new_n95_));
  nand3  g049(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z10));
  oai21  g050(.a(x16), .b(x10), .c(new_n81_), .O(new_n97_));
  inv1   g051(.a(x21), .O(new_n98_));
  nor2   g052(.a(x21), .b(x20), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n86_), .O(new_n100_));
  oai21  g054(.a(new_n93_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(x16), .O(new_n102_));
  nand2  g056(.a(new_n88_), .b(x02), .O(new_n103_));
  ...
  nand3  g063(.a(new_n109_), .b(new_n86_), .c(new_n54_), .O(new_n110_));
  ...
  oai21  g067(.a(x16), .b(x12), .c(new_n81_), .O(new_n114_));
  nand2  g068(.a(new_n110_), .b(x23), .O(new_n115_));
  nor2   g069(.a(x23), .b(x22), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n93_), .c(new_n98_), .O(new_n117_));
  nand2  g071(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand2  g072(.a(new_n118_), .b(x16), .O(new_n119_));
  nand2  g073(.a(new_n88_), .b(x04), .O(new_n120_));
  ...
  nand3  g078(.a(new_n54_), .b(new_n84_), .c(new_n83_), .O(new_n125_));
  inv1   g079(.a(x22), .O(new_n126_));
  inv1   g080(.a(x23), .O(new_n127_));
  nand3  g081(.a(new_n127_), .b(new_n126_), .c(new_n98_), .O(new_n128_));
  oai21  g082(.a(new_n128_), .b(new_n125_), .c(x24), .O(new_n129_));
  nor2   g083(.a(x20), .b(x19), .O(new_n130_));
  nor2   g084(.a(x24), .b(x23), .O(new_n131_));
  nand4  g085(.a(new_n131_), .b(new_n109_), .c(new_n130_), .d(new_n83_), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n129_), .O(new_n133_));
  nand3  g087(.a(new_n133_), .b(x18), .c(x16), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n124_), .O(z14));
  oai21  g089(.a(x16), .b(x14), .c(new_n81_), .O(new_n136_));
  nand2  g090(.a(new_n132_), .b(x25), .O(new_n137_));
  nor2   g091(.a(x25), .b(x24), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n116_), .c(new_n99_), .d(new_n86_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n88_), .b(x06), .O(new_n142_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n116_), .c(new_n99_), .d(new_n86_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n88_), .b(x07), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  nor2   g105(.a(x26), .b(x25), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n116_), .c(new_n69_), .O(new_n153_));
  nand3  g107(.a(new_n99_), .b(x19), .c(new_n83_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n55_), .d(new_n83_), .O(new_n155_));
