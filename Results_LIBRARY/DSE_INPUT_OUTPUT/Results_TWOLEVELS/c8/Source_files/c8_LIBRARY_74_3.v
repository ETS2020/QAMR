...
module FAU ( 
  ...
  nand3  g055(.a(new_n101_), .b(new_n95_), .c(new_n48_), .O(z10));
  inv1   g056(.a(x02), .O(new_n103_));
  oai22  g057(.a(new_n84_), .b(new_n103_), .c(x18), .d(new_n58_), .O(new_n104_));
  ...
  aoi21  g069(.a(new_n107_), .b(new_n88_), .c(new_n115_), .O(new_n116_));
  ...
  nand3  g074(.a(new_n120_), .b(new_n114_), .c(new_n48_), .O(z12));
  nand3  g075(.a(new_n66_), .b(new_n115_), .c(new_n106_), .O(new_n122_));
  nor2   g076(.a(new_n122_), .b(new_n99_), .O(new_n123_));
  aoi21  g077(.a(new_n118_), .b(x23), .c(new_n123_), .O(new_n124_));
  nor2   g078(.a(x18), .b(x16), .O(new_n125_));
  aoi21  g079(.a(new_n125_), .b(x12), .c(new_n49_), .O(new_n126_));
  oai21  g080(.a(new_n124_), .b(new_n81_), .c(new_n126_), .O(z13));
  nand2  g081(.a(x18), .b(x05), .O(new_n128_));
  oai22  g082(.a(new_n128_), .b(x04), .c(x18), .d(new_n69_), .O(new_n129_));
  nand2  g083(.a(new_n129_), .b(new_n81_), .O(new_n130_));
  oai21  g084(.a(new_n122_), .b(new_n99_), .c(x24), .O(new_n131_));
  nor2   g085(.a(x20), .b(x19), .O(new_n132_));
  nor2   g086(.a(x24), .b(x23), .O(new_n133_));
  nand4  g087(.a(new_n133_), .b(new_n117_), .c(new_n132_), .d(new_n97_), .O(new_n134_));
  ...
  oai22  g092(.a(new_n138_), .b(x04), .c(x18), .d(new_n72_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n81_), .O(new_n140_));
  nand2  g094(.a(new_n134_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n107_), .d(new_n88_), .O(new_n144_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n142_), .c(new_n107_), .d(new_n88_), .O(new_n153_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n142_), .c(new_n157_), .O(new_n159_));
