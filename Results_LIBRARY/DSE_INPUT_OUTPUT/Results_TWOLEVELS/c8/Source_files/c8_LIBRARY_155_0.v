...
module FAU ( 
  ...
  nor2   g44(.a(new_n84_), .b(new_n56_), .O(new_n91_));
  nor3   g45(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  oai21  g46(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand2  g47(.a(x18), .b(new_n86_), .O(new_n94_));
  oai21  g48(.a(new_n94_), .b(new_n90_), .c(new_n93_), .O(z10));
  ...
  oai22  g55(.a(new_n101_), .b(new_n86_), .c(new_n94_), .d(new_n96_), .O(z11));
  inv1   g56(.a(x03), .O(new_n103_));
  nor3   g57(.a(x22), .b(x21), .c(x20), .O(new_n104_));
  aoi22  g58(.a(new_n104_), .b(new_n84_), .c(new_n99_), .d(x22), .O(new_n105_));
  oai22  g59(.a(new_n105_), .b(new_n86_), .c(new_n94_), .d(new_n103_), .O(z12));
  inv1   g60(.a(x04), .O(new_n107_));
  nor2   g61(.a(x22), .b(x21), .O(new_n108_));
  nand3  g62(.a(new_n108_), .b(new_n84_), .c(new_n56_), .O(new_n109_));
  nor3   g63(.a(x23), .b(x22), .c(x21), .O(new_n110_));
  aoi22  g64(.a(new_n110_), .b(new_n92_), .c(new_n109_), .d(x23), .O(new_n111_));
  oai22  g65(.a(new_n111_), .b(new_n86_), .c(new_n94_), .d(new_n107_), .O(z13));
  ...
  nand4  g70(.a(new_n116_), .b(new_n108_), .c(new_n97_), .d(new_n82_), .O(new_n117_));
