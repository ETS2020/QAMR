...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x07), .O(new_n48_));
  ...
  nand2  g029(.a(new_n61_), .b(new_n75_), .O(new_n76_));
  ...
  nand3  g039(.a(new_n85_), .b(new_n81_), .c(new_n48_), .O(z09));
  inv1   g040(.a(x01), .O(new_n87_));
  inv1   g041(.a(x07), .O(new_n88_));
  nand2  g042(.a(x18), .b(new_n88_), .O(new_n89_));
  oai22  g043(.a(new_n89_), .b(new_n87_), .c(x18), .d(new_n52_), .O(new_n90_));
  nand2  g044(.a(new_n90_), .b(new_n82_), .O(new_n91_));
  ...
  oai21  g049(.a(new_n80_), .b(new_n92_), .c(new_n95_), .O(new_n96_));
  ...
  oai22  g072(.a(new_n89_), .b(new_n118_), .c(x18), .d(new_n64_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n82_), .O(new_n120_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n48_), .c(x16), .O(new_n125_));
  ...
  nand3  g089(.a(new_n135_), .b(new_n129_), .c(new_n48_), .O(z14));
  inv1   g090(.a(x06), .O(new_n137_));
  oai22  g091(.a(new_n89_), .b(new_n137_), .c(x18), .d(new_n70_), .O(new_n138_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n104_), .d(new_n80_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n141_), .c(new_n104_), .d(new_n80_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(x16), .O(new_n151_));
  inv1   g105(.a(x18), .O(new_n152_));
  nand3  g106(.a(new_n152_), .b(new_n82_), .c(x15), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n151_), .c(new_n48_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n141_), .c(new_n130_), .O(new_n156_));
  nand3  g110(.a(new_n104_), .b(x19), .c(new_n93_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n61_), .d(new_n93_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n48_), .O(z17));
endmodule
