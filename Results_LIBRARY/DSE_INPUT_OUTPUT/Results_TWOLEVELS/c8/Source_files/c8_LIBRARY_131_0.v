...
module FAU ( 
  ...
  nand2  g31(.a(new_n77_), .b(new_n54_), .O(z08));
  ...
  nor2   g38(.a(new_n84_), .b(x16), .O(new_n85_));
  nand2  g39(.a(new_n85_), .b(x00), .O(new_n86_));
  nand2  g40(.a(new_n86_), .b(new_n83_), .O(z09));
  inv1   g41(.a(x16), .O(new_n88_));
  oai21  g42(.a(new_n84_), .b(x01), .c(new_n88_), .O(new_n89_));
  nor2   g43(.a(new_n82_), .b(new_n53_), .O(new_n90_));
  ...
  oai21  g47(.a(new_n84_), .b(x02), .c(new_n88_), .O(new_n94_));
  nor2   g48(.a(x20), .b(x19), .O(new_n95_));
  nand2  g49(.a(new_n95_), .b(new_n79_), .O(new_n96_));
  inv1   g50(.a(x21), .O(new_n97_));
  nand4  g51(.a(new_n97_), .b(new_n53_), .c(new_n80_), .d(new_n79_), .O(new_n98_));
  inv1   g52(.a(new_n98_), .O(new_n99_));
  aoi21  g53(.a(new_n96_), .b(x21), .c(new_n99_), .O(new_n100_));
  oai21  g54(.a(new_n100_), .b(new_n88_), .c(new_n94_), .O(z11));
  oai21  g55(.a(new_n84_), .b(x03), .c(new_n88_), .O(new_n102_));
  nand2  g56(.a(new_n98_), .b(x22), .O(new_n103_));
  nor2   g57(.a(x22), .b(x21), .O(new_n104_));
  nand3  g58(.a(new_n104_), .b(new_n82_), .c(new_n53_), .O(new_n105_));
  and2   g59(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  oai21  g60(.a(new_n106_), .b(new_n88_), .c(new_n102_), .O(z12));
  nor3   g61(.a(x23), .b(x22), .c(x21), .O(new_n108_));
  aoi22  g62(.a(new_n108_), .b(new_n91_), .c(new_n105_), .d(x23), .O(new_n109_));
  nand2  g63(.a(new_n85_), .b(x04), .O(new_n110_));
  oai21  g64(.a(new_n109_), .b(new_n88_), .c(new_n110_), .O(z13));
  oai21  g65(.a(new_n84_), .b(x05), .c(new_n88_), .O(new_n112_));
  aoi21  g66(.a(new_n108_), .b(new_n91_), .c(new_n68_), .O(new_n113_));
  nor2   g67(.a(x24), .b(x23), .O(new_n114_));
  nand4  g68(.a(new_n114_), .b(new_n104_), .c(new_n95_), .d(new_n79_), .O(new_n115_));
  ...
  nand2  g78(.a(new_n85_), .b(x06), .O(new_n125_));
  ...
  nand4  g83(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n82_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x26), .O(new_n131_));
  nor3   g85(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n128_), .c(new_n127_), .d(new_n82_), .O(new_n133_));
  nand2  g87(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand2  g88(.a(new_n134_), .b(x16), .O(new_n135_));
  nand2  g89(.a(new_n85_), .b(x07), .O(new_n136_));
  nand2  g90(.a(new_n136_), .b(new_n135_), .O(z16));
  nor2   g91(.a(x26), .b(x25), .O(new_n138_));
  nand3  g92(.a(new_n138_), .b(new_n128_), .c(new_n68_), .O(new_n139_));
  nand3  g93(.a(new_n127_), .b(x19), .c(new_n79_), .O(new_n140_));
  oai22  g94(.a(new_n140_), .b(new_n139_), .c(new_n54_), .d(new_n79_), .O(new_n141_));
  nand2  g95(.a(new_n141_), .b(x16), .O(new_n142_));
  nand2  g96(.a(new_n142_), .b(new_n77_), .O(z17));
endmodule
