...
module FAU ( 
  ...
  aoi21  g013(.a(new_n59_), .b(new_n56_), .c(new_n48_), .O(z02));
  ...
  aoi21  g033(.a(new_n52_), .b(new_n51_), .c(new_n58_), .O(z08));
  ...
  nand3  g042(.a(new_n88_), .b(new_n84_), .c(new_n81_), .O(z09));
  oai21  g043(.a(new_n52_), .b(x01), .c(new_n85_), .O(new_n90_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n90_), .c(new_n81_), .O(z10));
  nand2  g049(.a(x18), .b(x02), .O(new_n96_));
  nand3  g050(.a(new_n52_), .b(x10), .c(x09), .O(new_n97_));
  ...
  oai21  g055(.a(new_n93_), .b(new_n57_), .c(new_n101_), .O(new_n102_));
  ...
  nand3  g059(.a(new_n52_), .b(x11), .c(x09), .O(new_n106_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n83_), .c(new_n91_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n81_), .c(x16), .O(new_n113_));
  ...
  nand3  g076(.a(new_n122_), .b(new_n117_), .c(new_n81_), .O(z13));
  ...
  aoi21  g081(.a(new_n119_), .b(new_n93_), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n134_), .b(new_n126_), .c(new_n81_), .O(z14));
  nand2  g089(.a(x18), .b(x06), .O(new_n136_));
  nand3  g090(.a(new_n52_), .b(x14), .c(x09), .O(new_n137_));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n100_), .d(new_n83_), .O(new_n143_));
  ...
  nand3  g101(.a(new_n52_), .b(x15), .c(x09), .O(new_n148_));
  ...
  nand4  g106(.a(new_n152_), .b(new_n141_), .c(new_n100_), .d(new_n83_), .O(new_n153_));
  ...
  nand3  g111(.a(new_n157_), .b(new_n141_), .c(new_n127_), .O(new_n158_));
  nand3  g112(.a(new_n100_), .b(x19), .c(new_n129_), .O(new_n159_));
  oai22  g113(.a(new_n159_), .b(new_n158_), .c(new_n58_), .d(new_n129_), .O(new_n160_));
