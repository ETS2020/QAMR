...
module FAU ( 
  ...
  nand3  g056(.a(new_n102_), .b(new_n48_), .c(x20), .O(new_n103_));
  nand2  g057(.a(new_n47_), .b(x18), .O(new_n104_));
  nand4  g058(.a(new_n104_), .b(new_n58_), .c(new_n52_), .d(new_n89_), .O(new_n105_));
  ...
  nand2  g071(.a(new_n117_), .b(new_n47_), .O(new_n118_));
  nand3  g072(.a(new_n58_), .b(new_n52_), .c(new_n89_), .O(new_n119_));
  nand3  g073(.a(new_n119_), .b(x21), .c(x16), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n118_), .c(new_n112_), .O(z11));
  ...
  nor2   g078(.a(x22), .b(x20), .O(new_n125_));
  ...
  nand3  g085(.a(new_n131_), .b(new_n128_), .c(new_n124_), .O(z12));
  inv1   g086(.a(x04), .O(new_n133_));
  oai22  g087(.a(new_n99_), .b(new_n133_), .c(x18), .d(new_n70_), .O(new_n134_));
  nand2  g088(.a(new_n134_), .b(new_n93_), .O(new_n135_));
  nand2  g089(.a(new_n125_), .b(new_n91_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x23), .O(new_n137_));
  nor2   g091(.a(x23), .b(x22), .O(new_n138_));
  nand4  g092(.a(new_n138_), .b(new_n115_), .c(new_n47_), .d(new_n89_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x18), .O(new_n140_));
  nor2   g094(.a(new_n68_), .b(new_n47_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n125_), .c(new_n91_), .d(x16), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n113_), .O(new_n149_));
  ...
  oai22  g107(.a(new_n99_), .b(new_n153_), .c(x18), .d(new_n78_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n93_), .O(new_n155_));
  nand3  g109(.a(new_n75_), .b(new_n68_), .c(new_n63_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n119_), .c(x25), .O(new_n157_));
  nor2   g111(.a(x25), .b(x24), .O(new_n158_));
  nand4  g112(.a(new_n158_), .b(new_n138_), .c(new_n129_), .d(new_n91_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n157_), .c(x18), .O(new_n160_));
  nor2   g114(.a(new_n80_), .b(new_n47_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n160_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n155_), .O(z15));
  inv1   g117(.a(x07), .O(new_n164_));
  oai22  g118(.a(new_n99_), .b(new_n164_), .c(x18), .d(new_n85_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(new_n93_), .O(new_n166_));
  nand4  g120(.a(new_n158_), .b(new_n138_), .c(new_n115_), .d(new_n89_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(x26), .O(new_n168_));
  nor3   g122(.a(x26), .b(x25), .c(x24), .O(new_n169_));
  nand4  g123(.a(new_n169_), .b(new_n138_), .c(new_n129_), .d(new_n91_), .O(new_n170_));
  aoi21  g124(.a(new_n170_), .b(new_n168_), .c(x18), .O(new_n171_));
  nor2   g125(.a(new_n83_), .b(new_n47_), .O(new_n172_));
  oai21  g126(.a(new_n172_), .b(new_n171_), .c(x16), .O(new_n173_));
  nand2  g127(.a(new_n173_), .b(new_n166_), .O(z16));
  nand2  g128(.a(new_n169_), .b(new_n138_), .O(new_n175_));
  nand3  g129(.a(new_n129_), .b(x19), .c(new_n89_), .O(new_n176_));
  oai22  g130(.a(new_n176_), .b(new_n175_), .c(new_n53_), .d(new_n89_), .O(new_n177_));
