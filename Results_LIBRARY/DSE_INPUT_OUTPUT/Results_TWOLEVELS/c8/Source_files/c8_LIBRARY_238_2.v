...
module FAU ( 
  ...
  aoi21  g070(.a(new_n108_), .b(new_n85_), .c(new_n116_), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n85_), .c(new_n97_), .O(new_n119_));
  inv1   g073(.a(new_n119_), .O(new_n120_));
  oai21  g074(.a(new_n120_), .b(new_n117_), .c(x16), .O(new_n121_));
  nand3  g075(.a(new_n121_), .b(new_n115_), .c(new_n80_), .O(z12));
  nand3  g076(.a(new_n93_), .b(x12), .c(new_n48_), .O(new_n123_));
  oai21  g077(.a(new_n93_), .b(new_n48_), .c(new_n123_), .O(new_n124_));
  ...
  nand4  g091(.a(new_n137_), .b(new_n118_), .c(new_n98_), .d(new_n82_), .O(new_n138_));
  inv1   g092(.a(new_n138_), .O(new_n139_));
  oai21  g093(.a(new_n139_), .b(new_n136_), .c(x16), .O(new_n140_));
  nand3  g094(.a(new_n140_), .b(new_n134_), .c(new_n80_), .O(z14));
  nand2  g095(.a(x18), .b(x06), .O(new_n142_));
  nand3  g096(.a(new_n93_), .b(x14), .c(new_n48_), .O(new_n143_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n147_), .c(new_n108_), .d(new_n85_), .O(new_n149_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n108_), .d(new_n85_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(x16), .O(new_n160_));
  nand3  g114(.a(new_n160_), .b(new_n155_), .c(new_n80_), .O(z16));
  nor2   g115(.a(x26), .b(x25), .O(new_n162_));
  nand3  g116(.a(new_n162_), .b(new_n147_), .c(new_n135_), .O(new_n163_));
  nand3  g117(.a(new_n108_), .b(x19), .c(new_n82_), .O(new_n164_));
  oai22  g118(.a(new_n164_), .b(new_n163_), .c(new_n58_), .d(new_n82_), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x16), .O(new_n166_));
  nand2  g120(.a(new_n166_), .b(new_n80_), .O(z17));
endmodule
