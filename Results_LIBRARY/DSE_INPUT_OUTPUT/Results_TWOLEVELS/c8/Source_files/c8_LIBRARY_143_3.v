...
module FAU ( 
  ...
  nand3  g053(.a(new_n99_), .b(new_n95_), .c(x16), .O(new_n100_));
  ...
  nand2  g060(.a(new_n106_), .b(new_n86_), .O(new_n107_));
  oai21  g061(.a(new_n105_), .b(new_n60_), .c(new_n107_), .O(new_n108_));
  nand3  g062(.a(new_n108_), .b(new_n95_), .c(x16), .O(new_n109_));
  ...
  nand3  g069(.a(new_n115_), .b(new_n86_), .c(new_n96_), .O(new_n116_));
  nand2  g070(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand3  g071(.a(new_n117_), .b(new_n95_), .c(x16), .O(new_n118_));
  ...
  nand3  g080(.a(new_n126_), .b(new_n95_), .c(x16), .O(new_n127_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n115_), .c(new_n97_), .d(new_n84_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n88_), .b(x13), .O(new_n136_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n106_), .d(new_n86_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand2  g098(.a(new_n88_), .b(x14), .O(new_n145_));
  ...
  nand4  g103(.a(new_n149_), .b(new_n140_), .c(new_n106_), .d(new_n86_), .O(new_n150_));
  ...
  nand4  g108(.a(new_n140_), .b(new_n79_), .c(new_n74_), .d(new_n130_), .O(new_n155_));
  nand3  g109(.a(new_n106_), .b(x19), .c(new_n84_), .O(new_n156_));
  oai22  g110(.a(new_n156_), .b(new_n155_), .c(new_n52_), .d(new_n84_), .O(new_n157_));
