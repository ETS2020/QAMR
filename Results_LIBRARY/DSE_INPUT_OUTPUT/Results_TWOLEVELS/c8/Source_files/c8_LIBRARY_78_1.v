...
module FAU ( 
  ...
  oai21  g043(.a(x25), .b(new_n54_), .c(x18), .O(new_n90_));
  aoi21  g044(.a(new_n90_), .b(x25), .c(x19), .O(new_n91_));
  aoi21  g045(.a(new_n91_), .b(new_n87_), .c(new_n89_), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n81_), .c(new_n86_), .O(z09));
  nand2  g047(.a(x18), .b(x01), .O(new_n94_));
  oai21  g048(.a(new_n84_), .b(new_n52_), .c(new_n94_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n81_), .O(new_n96_));
  inv1   g050(.a(new_n49_), .O(new_n97_));
  ...
  nand3  g064(.a(new_n110_), .b(new_n106_), .c(new_n97_), .O(z11));
  nand2  g065(.a(x18), .b(x03), .O(new_n112_));
  oai21  g066(.a(new_n84_), .b(new_n61_), .c(new_n112_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n81_), .O(new_n114_));
  nand3  g068(.a(new_n108_), .b(new_n97_), .c(x22), .O(new_n115_));
  inv1   g069(.a(new_n115_), .O(new_n116_));
  inv1   g070(.a(x22), .O(new_n117_));
  aoi21  g071(.a(new_n71_), .b(new_n66_), .c(x25), .O(new_n118_));
  oai21  g072(.a(new_n118_), .b(new_n83_), .c(x25), .O(new_n119_));
  ...
  oai21  g078(.a(new_n84_), .b(new_n64_), .c(new_n124_), .O(new_n125_));
  ...
  nand3  g082(.a(new_n128_), .b(new_n97_), .c(x23), .O(new_n129_));
  inv1   g083(.a(new_n129_), .O(new_n130_));
  oai21  g084(.a(x25), .b(new_n71_), .c(x18), .O(new_n131_));
  ...
  oai21  g091(.a(new_n84_), .b(new_n69_), .c(new_n137_), .O(new_n138_));
  ...
  oai21  g118(.a(new_n164_), .b(new_n81_), .c(x18), .O(new_n165_));
  nand2  g119(.a(new_n165_), .b(x25), .O(new_n166_));
  oai21  g120(.a(new_n143_), .b(new_n100_), .c(x26), .O(new_n167_));
  nand4  g121(.a(new_n140_), .b(new_n164_), .c(new_n48_), .d(new_n71_), .O(new_n168_));
  ...
  nand2  g128(.a(new_n174_), .b(new_n97_), .O(z17));
endmodule
