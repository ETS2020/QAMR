...
module FAU ( 
  ...
  nand3  g044(.a(x18), .b(new_n47_), .c(x00), .O(new_n91_));
  ...
  nand3  g049(.a(new_n57_), .b(new_n51_), .c(new_n87_), .O(new_n96_));
  oai21  g050(.a(new_n89_), .b(new_n57_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g084(.a(new_n70_), .b(new_n65_), .c(new_n103_), .O(new_n131_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n123_), .c(new_n105_), .d(new_n89_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(x18), .b(new_n47_), .c(x06), .O(new_n145_));
  ...
  nand4  g105(.a(new_n151_), .b(new_n123_), .c(new_n105_), .d(new_n89_), .O(new_n152_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n78_), .c(new_n157_), .O(new_n159_));
