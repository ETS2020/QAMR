...
module FAU ( 
  ...
  oai21  g031(.a(x18), .b(new_n48_), .c(new_n64_), .O(z08));
  ...
  nand2  g083(.a(new_n94_), .b(x05), .O(new_n130_));
  nand3  g084(.a(new_n130_), .b(new_n129_), .c(new_n122_), .O(z14));
  oai21  g085(.a(x16), .b(x14), .c(new_n79_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n94_), .b(x06), .O(new_n139_));
  ...
  nand4  g099(.a(new_n145_), .b(new_n134_), .c(new_n99_), .d(new_n90_), .O(new_n146_));
  ...
  nand2  g103(.a(new_n63_), .b(new_n106_), .O(new_n150_));
  inv1   g104(.a(x25), .O(new_n151_));
  nand3  g105(.a(new_n75_), .b(new_n151_), .c(new_n123_), .O(new_n152_));
  ...
  nor2   g109(.a(new_n64_), .b(new_n81_), .O(new_n156_));
