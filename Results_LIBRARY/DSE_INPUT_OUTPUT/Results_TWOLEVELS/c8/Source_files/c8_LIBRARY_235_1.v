...
module FAU ( 
  ...
  aoi21  g090(.a(new_n128_), .b(new_n111_), .c(new_n136_), .O(new_n137_));
  ...
  nand4  g111(.a(new_n157_), .b(new_n147_), .c(new_n112_), .d(new_n94_), .O(new_n158_));
  ...
  nand3  g116(.a(new_n162_), .b(new_n147_), .c(new_n136_), .O(new_n163_));
