...
module FAU ( 
  ...
  oai21  g052(.a(x19), .b(x17), .c(x20), .O(new_n99_));
  nand3  g053(.a(new_n95_), .b(new_n51_), .c(new_n85_), .O(new_n100_));
  oai21  g054(.a(new_n99_), .b(x18), .c(new_n100_), .O(new_n101_));
  ...
  nor2   g060(.a(new_n60_), .b(new_n89_), .O(new_n107_));
  oai21  g061(.a(new_n107_), .b(x18), .c(x20), .O(new_n108_));
  nor2   g062(.a(x21), .b(x20), .O(new_n109_));
  nand2  g063(.a(new_n109_), .b(new_n87_), .O(new_n110_));
  oai21  g064(.a(new_n87_), .b(new_n60_), .c(new_n110_), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(x16), .O(new_n112_));
  nand3  g066(.a(new_n112_), .b(new_n108_), .c(new_n106_), .O(z11));
  inv1   g067(.a(x03), .O(new_n114_));
  oai22  g068(.a(new_n96_), .b(new_n114_), .c(x18), .d(new_n63_), .O(new_n115_));
  ...
  nor3   g074(.a(new_n65_), .b(new_n95_), .c(x18), .O(new_n121_));
  aoi21  g075(.a(new_n120_), .b(new_n95_), .c(new_n121_), .O(new_n122_));
  oai21  g076(.a(new_n122_), .b(new_n89_), .c(new_n116_), .O(z12));
  inv1   g077(.a(x04), .O(new_n124_));
  oai22  g078(.a(new_n96_), .b(new_n124_), .c(x18), .d(new_n68_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n89_), .O(new_n126_));
  nand2  g080(.a(new_n119_), .b(x23), .O(new_n127_));
  nor2   g081(.a(x23), .b(x22), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n87_), .c(new_n60_), .O(new_n129_));
  aoi21  g083(.a(new_n129_), .b(new_n127_), .c(x20), .O(new_n130_));
  nor3   g084(.a(new_n70_), .b(new_n95_), .c(x18), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n130_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n126_), .O(z13));
  inv1   g087(.a(x05), .O(new_n134_));
  oai22  g088(.a(new_n96_), .b(new_n134_), .c(x18), .d(new_n73_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n89_), .O(new_n136_));
  nand2  g090(.a(new_n129_), .b(x24), .O(new_n137_));
  nor2   g091(.a(x24), .b(x23), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n117_), .c(new_n65_), .O(new_n139_));
  aoi21  g093(.a(new_n139_), .b(new_n137_), .c(x20), .O(new_n140_));
  nor3   g094(.a(new_n75_), .b(new_n95_), .c(x18), .O(new_n141_));
  oai21  g095(.a(new_n141_), .b(new_n140_), .c(x16), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n136_), .O(z14));
  inv1   g097(.a(x06), .O(new_n144_));
  oai22  g098(.a(new_n96_), .b(new_n144_), .c(x18), .d(new_n78_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n89_), .O(new_n146_));
  nand3  g100(.a(new_n60_), .b(new_n51_), .c(new_n85_), .O(new_n147_));
  nand3  g101(.a(new_n75_), .b(new_n70_), .c(new_n65_), .O(new_n148_));
  oai21  g102(.a(new_n148_), .b(new_n147_), .c(x25), .O(new_n149_));
  nor2   g103(.a(x21), .b(x19), .O(new_n150_));
  nor2   g104(.a(x25), .b(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n128_), .c(new_n150_), .d(new_n85_), .O(new_n152_));
  ...
  nand2  g110(.a(new_n156_), .b(new_n146_), .O(z15));
  inv1   g111(.a(x07), .O(new_n158_));
  oai22  g112(.a(new_n96_), .b(new_n158_), .c(x18), .d(new_n81_), .O(new_n159_));
  nand2  g113(.a(new_n159_), .b(new_n89_), .O(new_n160_));
  nand2  g114(.a(new_n152_), .b(x26), .O(new_n161_));
  nor2   g115(.a(x26), .b(x25), .O(new_n162_));
  nand4  g116(.a(new_n162_), .b(new_n138_), .c(new_n118_), .d(new_n87_), .O(new_n163_));
  ...
  nand4  g125(.a(new_n171_), .b(new_n170_), .c(new_n128_), .d(new_n109_), .O(new_n172_));
  aoi21  g126(.a(new_n172_), .b(new_n169_), .c(new_n89_), .O(z17));
endmodule
