...
module FAU ( 
  ...
  nand2  g053(.a(new_n99_), .b(new_n89_), .O(new_n100_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n110_), .c(new_n104_), .O(z11));
  oai21  g067(.a(x16), .b(x11), .c(new_n87_), .O(new_n114_));
  aoi21  g068(.a(new_n107_), .b(new_n98_), .c(new_n65_), .O(new_n115_));
  nor2   g069(.a(x22), .b(x21), .O(new_n116_));
  nand3  g070(.a(new_n116_), .b(new_n98_), .c(new_n57_), .O(new_n117_));
  ...
  oai21  g075(.a(x16), .b(x12), .c(new_n87_), .O(new_n122_));
  nand2  g076(.a(new_n117_), .b(x23), .O(new_n123_));
  nor3   g077(.a(x23), .b(x22), .c(x21), .O(new_n124_));
  nand2  g078(.a(new_n124_), .b(new_n106_), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n123_), .O(new_n126_));
  nand2  g080(.a(new_n126_), .b(x16), .O(new_n127_));
  nand2  g081(.a(new_n111_), .b(x04), .O(new_n128_));
  nand3  g082(.a(new_n128_), .b(new_n127_), .c(new_n122_), .O(z13));
  oai21  g083(.a(x16), .b(x13), .c(new_n87_), .O(new_n130_));
  aoi21  g084(.a(new_n124_), .b(new_n106_), .c(new_n75_), .O(new_n131_));
  nor2   g085(.a(x24), .b(x23), .O(new_n132_));
  nand4  g086(.a(new_n132_), .b(new_n116_), .c(new_n99_), .d(new_n89_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n131_), .c(x16), .O(new_n135_));
  nand2  g089(.a(new_n111_), .b(x05), .O(new_n136_));
  ...
  nand2  g093(.a(new_n139_), .b(new_n47_), .O(new_n140_));
  nand2  g094(.a(new_n133_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n107_), .d(new_n98_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(x18), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n140_), .O(z15));
  oai21  g101(.a(x16), .b(x15), .c(new_n87_), .O(new_n148_));
  nand2  g102(.a(new_n144_), .b(x26), .O(new_n149_));
  nor3   g103(.a(x26), .b(x25), .c(x24), .O(new_n150_));
  nand4  g104(.a(new_n150_), .b(new_n142_), .c(new_n107_), .d(new_n98_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand2  g107(.a(new_n111_), .b(x07), .O(new_n154_));
  nand3  g108(.a(new_n154_), .b(new_n153_), .c(new_n148_), .O(z16));
  nor2   g109(.a(x26), .b(x25), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n142_), .c(new_n75_), .O(new_n157_));
  nand3  g111(.a(new_n107_), .b(x19), .c(new_n89_), .O(new_n158_));
  oai22  g112(.a(new_n158_), .b(new_n157_), .c(new_n52_), .d(new_n89_), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(x18), .c(x16), .O(new_n160_));
