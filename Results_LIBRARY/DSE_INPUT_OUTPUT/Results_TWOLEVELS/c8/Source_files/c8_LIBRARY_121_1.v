...
module FAU ( 
  ...
  nand3  g053(.a(new_n99_), .b(new_n95_), .c(new_n89_), .O(z10));
  oai21  g054(.a(x18), .b(x10), .c(new_n85_), .O(new_n101_));
  nor2   g055(.a(x21), .b(x20), .O(new_n102_));
  nand2  g056(.a(new_n102_), .b(new_n96_), .O(new_n103_));
  oai21  g057(.a(new_n98_), .b(new_n62_), .c(new_n103_), .O(new_n104_));
  nand2  g058(.a(new_n104_), .b(x16), .O(new_n105_));
  nand3  g059(.a(new_n105_), .b(new_n101_), .c(new_n89_), .O(z11));
  nand3  g060(.a(x18), .b(x03), .c(x02), .O(new_n107_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n96_), .c(new_n57_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n89_), .c(x16), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n109_), .O(z12));
  nand3  g069(.a(x18), .b(x04), .c(x02), .O(new_n116_));
  ...
  nand2  g074(.a(new_n120_), .b(new_n98_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand3  g076(.a(new_n122_), .b(new_n89_), .c(x16), .O(new_n123_));
  ...
  nand4  g095(.a(new_n141_), .b(new_n140_), .c(new_n102_), .d(new_n96_), .O(new_n142_));
  nand2  g096(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(x16), .O(new_n144_));
  nand3  g098(.a(new_n144_), .b(new_n138_), .c(new_n89_), .O(z15));
  ...
  nand4  g104(.a(new_n150_), .b(new_n140_), .c(new_n102_), .d(new_n96_), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(x16), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n148_), .c(new_n89_), .O(z16));
  nor2   g108(.a(x26), .b(x25), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n140_), .c(new_n75_), .O(new_n156_));
  nand3  g110(.a(new_n102_), .b(x19), .c(new_n129_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n156_), .c(new_n50_), .d(new_n129_), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n89_), .c(x16), .O(new_n159_));
