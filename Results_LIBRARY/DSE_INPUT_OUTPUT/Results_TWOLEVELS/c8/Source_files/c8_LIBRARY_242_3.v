...
module FAU ( 
  ...
  aoi21  g079(.a(new_n120_), .b(new_n93_), .c(new_n69_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n137_), .c(new_n100_), .d(new_n91_), .O(new_n147_));
  nand2  g101(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand2  g103(.a(new_n95_), .b(x15), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n149_), .c(new_n144_), .O(z16));
  inv1   g105(.a(x23), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n60_), .O(new_n153_));
  nand3  g107(.a(new_n79_), .b(new_n74_), .c(new_n69_), .O(new_n154_));
  nor2   g108(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand3  g109(.a(new_n100_), .b(x19), .c(new_n127_), .O(new_n156_));
  inv1   g110(.a(new_n156_), .O(new_n157_));
  nor2   g111(.a(new_n61_), .b(new_n127_), .O(new_n158_));
  aoi21  g112(.a(new_n157_), .b(new_n155_), .c(new_n158_), .O(new_n159_));
  aoi21  g113(.a(new_n159_), .b(new_n109_), .c(new_n86_), .O(z17));
endmodule
