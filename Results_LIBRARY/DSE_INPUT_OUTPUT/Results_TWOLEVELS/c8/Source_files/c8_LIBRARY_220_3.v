...
module FAU ( 
  ...
  nand2  g039(.a(new_n52_), .b(new_n50_), .O(z08));
  inv1   g040(.a(x16), .O(new_n87_));
  inv1   g041(.a(x00), .O(new_n88_));
  inv1   g042(.a(x07), .O(new_n89_));
  ...
  nand3  g066(.a(new_n112_), .b(new_n107_), .c(new_n52_), .O(z11));
  inv1   g067(.a(x03), .O(new_n114_));
  oai22  g068(.a(new_n90_), .b(new_n114_), .c(x18), .d(new_n65_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n87_), .O(new_n116_));
  nand2  g070(.a(new_n110_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n99_), .c(new_n57_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n52_), .c(x16), .O(new_n121_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n127_), .c(new_n109_), .d(new_n99_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(x16), .O(new_n157_));
  inv1   g111(.a(x18), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n87_), .c(x15), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n157_), .c(new_n52_), .O(z16));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n127_), .c(new_n75_), .O(new_n162_));
  nand3  g116(.a(new_n109_), .b(x19), .c(new_n100_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n50_), .d(new_n100_), .O(new_n164_));
