...
module FAU ( 
  ...
  nor2   g039(.a(new_n81_), .b(x16), .O(new_n86_));
  nand2  g040(.a(new_n86_), .b(x00), .O(new_n87_));
  nand3  g041(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(z09));
  oai21  g042(.a(x16), .b(x09), .c(new_n81_), .O(new_n89_));
  inv1   g043(.a(x20), .O(new_n90_));
  nor2   g044(.a(new_n84_), .b(new_n90_), .O(new_n91_));
  nor3   g045(.a(x20), .b(x19), .c(x17), .O(new_n92_));
  oai21  g046(.a(new_n92_), .b(new_n91_), .c(x16), .O(new_n93_));
  nand2  g047(.a(new_n86_), .b(x01), .O(new_n94_));
  nand3  g048(.a(new_n94_), .b(new_n93_), .c(new_n89_), .O(z10));
  oai21  g049(.a(x16), .b(x10), .c(new_n81_), .O(new_n96_));
  nor2   g050(.a(x21), .b(x20), .O(new_n97_));
  nand2  g051(.a(new_n97_), .b(new_n84_), .O(new_n98_));
  oai21  g052(.a(new_n92_), .b(new_n57_), .c(new_n98_), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(x16), .O(new_n100_));
  nand2  g054(.a(new_n86_), .b(x02), .O(new_n101_));
  nand3  g055(.a(new_n101_), .b(new_n100_), .c(new_n96_), .O(z11));
  ...
  nand2  g059(.a(new_n98_), .b(x22), .O(new_n106_));
  nor2   g060(.a(x22), .b(x21), .O(new_n107_));
  nand3  g061(.a(new_n107_), .b(new_n84_), .c(new_n90_), .O(new_n108_));
  ...
  oai21  g065(.a(x16), .b(x12), .c(new_n81_), .O(new_n112_));
  nand2  g066(.a(new_n108_), .b(x23), .O(new_n113_));
  ...
  nand2  g071(.a(new_n86_), .b(x04), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n117_), .c(new_n112_), .O(z13));
  oai21  g073(.a(x16), .b(x13), .c(new_n81_), .O(new_n120_));
  inv1   g074(.a(x24), .O(new_n121_));
  aoi21  g075(.a(new_n114_), .b(new_n92_), .c(new_n121_), .O(new_n122_));
  inv1   g076(.a(x17), .O(new_n123_));
  nor2   g077(.a(x20), .b(x19), .O(new_n124_));
  nor2   g078(.a(x24), .b(x23), .O(new_n125_));
  nand4  g079(.a(new_n125_), .b(new_n107_), .c(new_n124_), .d(new_n123_), .O(new_n126_));
  inv1   g080(.a(new_n126_), .O(new_n127_));
  oai21  g081(.a(new_n127_), .b(new_n122_), .c(x16), .O(new_n128_));
  nand2  g082(.a(new_n86_), .b(x05), .O(new_n129_));
  nand3  g083(.a(new_n129_), .b(new_n128_), .c(new_n120_), .O(z14));
  oai21  g084(.a(x16), .b(x14), .c(new_n81_), .O(new_n131_));
  nand2  g085(.a(new_n126_), .b(x25), .O(new_n132_));
  nor2   g086(.a(x23), .b(x22), .O(new_n133_));
  nor2   g087(.a(x25), .b(x24), .O(new_n134_));
  nand4  g088(.a(new_n134_), .b(new_n133_), .c(new_n97_), .d(new_n84_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(new_n136_));
  nand2  g090(.a(new_n136_), .b(x16), .O(new_n137_));
  nand2  g091(.a(new_n86_), .b(x06), .O(new_n138_));
  nand3  g092(.a(new_n138_), .b(new_n137_), .c(new_n131_), .O(z15));
  oai21  g093(.a(x16), .b(x15), .c(new_n81_), .O(new_n140_));
  nand2  g094(.a(new_n135_), .b(x26), .O(new_n141_));
  nor3   g095(.a(x26), .b(x25), .c(x24), .O(new_n142_));
  nand4  g096(.a(new_n142_), .b(new_n133_), .c(new_n97_), .d(new_n84_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand2  g099(.a(new_n86_), .b(x07), .O(new_n146_));
  nand3  g100(.a(new_n146_), .b(new_n145_), .c(new_n140_), .O(z16));
  inv1   g101(.a(x23), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(new_n63_), .O(new_n149_));
  inv1   g103(.a(x26), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n74_), .c(new_n121_), .O(new_n151_));
  nor2   g105(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand3  g106(.a(new_n97_), .b(x19), .c(new_n123_), .O(new_n153_));
  inv1   g107(.a(new_n153_), .O(new_n154_));
  nor2   g108(.a(new_n58_), .b(new_n123_), .O(new_n155_));
  aoi21  g109(.a(new_n154_), .b(new_n152_), .c(new_n155_), .O(new_n156_));
  aoi21  g110(.a(new_n156_), .b(x18), .c(new_n48_), .O(z17));
endmodule
