...
module FAU ( 
  ...
  nand3  g034(.a(new_n80_), .b(x08), .c(new_n52_), .O(new_n81_));
  oai21  g035(.a(new_n80_), .b(new_n52_), .c(new_n81_), .O(new_n82_));
  ...
  nand3  g048(.a(new_n94_), .b(new_n90_), .c(new_n84_), .O(z10));
  nand2  g049(.a(x18), .b(x02), .O(new_n96_));
  oai21  g050(.a(x18), .b(new_n60_), .c(new_n96_), .O(new_n97_));
  ...
  nand3  g057(.a(new_n103_), .b(new_n98_), .c(new_n84_), .O(z11));
  nand2  g058(.a(x18), .b(x03), .O(new_n105_));
  nand3  g059(.a(new_n80_), .b(x11), .c(new_n52_), .O(new_n106_));
  ...
  nand3  g069(.a(new_n80_), .b(x12), .c(new_n52_), .O(new_n116_));
  ...
  nand4  g086(.a(new_n132_), .b(new_n110_), .c(new_n131_), .d(new_n130_), .O(new_n133_));
  inv1   g087(.a(new_n133_), .O(new_n134_));
  oai21  g088(.a(new_n134_), .b(new_n129_), .c(x16), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n127_), .c(new_n84_), .O(z14));
  ...
  nand4  g096(.a(new_n142_), .b(new_n141_), .c(new_n100_), .d(new_n91_), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(x16), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n139_), .c(new_n84_), .O(z15));
