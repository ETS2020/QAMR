...
module FAU ( 
  ...
  nand2  g046(.a(x18), .b(x15), .O(new_n93_));
  ...
  oai22  g062(.a(new_n93_), .b(new_n108_), .c(x18), .d(new_n61_), .O(new_n109_));
  ...
  nand4  g074(.a(new_n102_), .b(new_n66_), .c(new_n63_), .d(new_n58_), .O(new_n121_));
  ...
  aoi21  g090(.a(new_n129_), .b(new_n111_), .c(new_n76_), .O(new_n137_));
  nand4  g091(.a(new_n76_), .b(new_n73_), .c(new_n66_), .d(new_n63_), .O(new_n138_));
  ...
  nand4  g100(.a(new_n146_), .b(new_n145_), .c(new_n112_), .d(new_n102_), .O(new_n147_));
  ...
  nand4  g108(.a(new_n154_), .b(new_n145_), .c(new_n112_), .d(new_n102_), .O(new_n155_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n52_), .c(new_n159_), .O(z16));
  nand2  g114(.a(new_n154_), .b(new_n145_), .O(new_n161_));
  nand3  g115(.a(new_n112_), .b(x19), .c(new_n103_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n48_), .d(new_n103_), .O(new_n163_));
