...
module FAU ( 
  ...
  nand4  g48(.a(new_n94_), .b(new_n85_), .c(new_n50_), .d(new_n77_), .O(new_n95_));
  inv1   g49(.a(new_n95_), .O(new_n96_));
  aoi21  g50(.a(new_n93_), .b(x21), .c(new_n96_), .O(new_n97_));
  nand2  g51(.a(new_n89_), .b(x02), .O(new_n98_));
  oai21  g52(.a(new_n97_), .b(new_n81_), .c(new_n98_), .O(z11));
  ...
  aoi21  g64(.a(new_n107_), .b(new_n87_), .c(new_n110_), .O(new_n111_));
  nor2   g65(.a(x24), .b(x23), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(new_n101_), .c(new_n92_), .d(new_n77_), .O(new_n113_));
  inv1   g67(.a(new_n113_), .O(new_n114_));
  oai21  g68(.a(new_n114_), .b(new_n111_), .c(x16), .O(new_n115_));
  nand2  g69(.a(new_n89_), .b(x05), .O(new_n116_));
  ...
  nand2  g77(.a(new_n89_), .b(x06), .O(new_n124_));
  oai21  g78(.a(new_n123_), .b(new_n81_), .c(new_n124_), .O(z15));
  oai21  g79(.a(new_n82_), .b(x07), .c(new_n81_), .O(new_n126_));
  nor2   g80(.a(x21), .b(x20), .O(new_n127_));
  nor2   g81(.a(x23), .b(x22), .O(new_n128_));
  nor2   g82(.a(x25), .b(x24), .O(new_n129_));
  nand4  g83(.a(new_n129_), .b(new_n128_), .c(new_n127_), .d(new_n79_), .O(new_n130_));
  nand2  g84(.a(new_n130_), .b(x26), .O(new_n131_));
  nor3   g85(.a(x26), .b(x25), .c(x24), .O(new_n132_));
  nand4  g86(.a(new_n132_), .b(new_n128_), .c(new_n127_), .d(new_n79_), .O(new_n133_));
  ...
  nand3  g91(.a(new_n137_), .b(new_n128_), .c(new_n110_), .O(new_n138_));
