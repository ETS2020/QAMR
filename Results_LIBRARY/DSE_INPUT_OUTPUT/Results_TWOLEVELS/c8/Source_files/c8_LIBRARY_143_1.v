...
module FAU ( 
  ...
  oai22  g54(.a(new_n100_), .b(new_n87_), .c(new_n94_), .d(new_n58_), .O(z11));
  nor3   g55(.a(x22), .b(x21), .c(x20), .O(new_n102_));
  aoi22  g56(.a(new_n102_), .b(new_n85_), .c(new_n98_), .d(x22), .O(new_n103_));
  oai22  g57(.a(new_n103_), .b(new_n87_), .c(new_n94_), .d(new_n63_), .O(z12));
  ...
  oai22  g62(.a(new_n108_), .b(new_n87_), .c(new_n94_), .d(new_n66_), .O(z13));
  ...
  nand4  g67(.a(new_n113_), .b(new_n105_), .c(new_n96_), .d(new_n83_), .O(new_n114_));
  ...
  nand4  g74(.a(new_n74_), .b(new_n111_), .c(new_n120_), .d(new_n119_), .O(new_n121_));
  inv1   g75(.a(new_n121_), .O(new_n122_));
  aoi22  g76(.a(new_n122_), .b(new_n99_), .c(new_n114_), .d(x25), .O(new_n123_));
  oai21  g77(.a(new_n123_), .b(new_n87_), .c(new_n118_), .O(z15));
  ...
  nor2   g89(.a(new_n51_), .b(x17), .O(new_n136_));
