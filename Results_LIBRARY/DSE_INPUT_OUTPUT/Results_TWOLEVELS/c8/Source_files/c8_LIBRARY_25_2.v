...
module FAU ( 
  ...
  oai21  g035(.a(x18), .b(new_n48_), .c(new_n58_), .O(z08));
  ...
  oai21  g056(.a(new_n96_), .b(new_n57_), .c(new_n102_), .O(new_n103_));
  ...
  aoi21  g062(.a(new_n101_), .b(new_n88_), .c(new_n108_), .O(new_n109_));
  nor2   g063(.a(x22), .b(x21), .O(new_n110_));
  nand3  g064(.a(new_n110_), .b(new_n88_), .c(new_n94_), .O(new_n111_));
  inv1   g065(.a(new_n111_), .O(new_n112_));
  oai21  g066(.a(new_n112_), .b(new_n109_), .c(x16), .O(new_n113_));
  nand2  g067(.a(new_n90_), .b(x03), .O(new_n114_));
  ...
  aoi21  g079(.a(new_n120_), .b(new_n96_), .c(new_n69_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n136_), .c(new_n101_), .d(new_n88_), .O(new_n148_));
  ...
  nand2  g106(.a(new_n152_), .b(new_n108_), .O(new_n153_));
  ...
  nor2   g111(.a(new_n58_), .b(new_n85_), .O(new_n158_));
