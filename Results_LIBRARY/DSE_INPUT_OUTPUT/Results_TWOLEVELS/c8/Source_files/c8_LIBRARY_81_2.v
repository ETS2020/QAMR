...
module FAU ( 
  ...
  aoi21  g022(.a(x27), .b(new_n47_), .c(new_n48_), .O(new_n69_));
  ...
  nor2   g033(.a(x18), .b(x13), .O(new_n80_));
  ...
  nand3  g040(.a(new_n86_), .b(new_n82_), .c(x16), .O(new_n87_));
  oai21  g041(.a(new_n81_), .b(x16), .c(new_n87_), .O(z09));
  inv1   g042(.a(x16), .O(new_n89_));
  nand2  g043(.a(x18), .b(x01), .O(new_n90_));
  oai21  g044(.a(x18), .b(new_n55_), .c(new_n90_), .O(new_n91_));
  nand2  g045(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  inv1   g046(.a(x20), .O(new_n93_));
  nor2   g047(.a(new_n84_), .b(new_n93_), .O(new_n94_));
  nor3   g048(.a(x20), .b(x19), .c(x17), .O(new_n95_));
  oai21  g049(.a(new_n95_), .b(new_n94_), .c(x16), .O(new_n96_));
  nand3  g050(.a(new_n96_), .b(new_n92_), .c(new_n82_), .O(z10));
  ...
  oai21  g056(.a(new_n95_), .b(new_n60_), .c(new_n102_), .O(new_n103_));
  nand2  g057(.a(new_n103_), .b(x16), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n100_), .c(new_n82_), .O(z11));
  ...
  aoi21  g063(.a(new_n101_), .b(new_n84_), .c(new_n109_), .O(new_n110_));
  nor2   g064(.a(x22), .b(x21), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n84_), .c(new_n93_), .O(new_n112_));
  inv1   g066(.a(new_n112_), .O(new_n113_));
  oai21  g067(.a(new_n113_), .b(new_n110_), .c(x16), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n108_), .c(new_n82_), .O(z12));
  ...
  nand2  g074(.a(new_n120_), .b(new_n95_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand2  g076(.a(new_n122_), .b(x16), .O(new_n123_));
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n82_), .O(z13));
  inv1   g078(.a(x24), .O(new_n125_));
  aoi21  g079(.a(new_n120_), .b(new_n95_), .c(new_n125_), .O(new_n126_));
  inv1   g080(.a(x17), .O(new_n127_));
  nor2   g081(.a(x20), .b(x19), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n111_), .c(new_n128_), .d(new_n127_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n126_), .c(x16), .O(new_n132_));
  inv1   g086(.a(x18), .O(new_n133_));
  nor2   g087(.a(new_n133_), .b(x16), .O(new_n134_));
  aoi21  g088(.a(new_n134_), .b(x05), .c(new_n48_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n132_), .O(z14));
  nand2  g090(.a(x18), .b(x06), .O(new_n137_));
  nand3  g091(.a(new_n133_), .b(x14), .c(new_n47_), .O(new_n138_));
  nand2  g092(.a(new_n138_), .b(new_n137_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n89_), .O(new_n140_));
  nand2  g094(.a(new_n130_), .b(x25), .O(new_n141_));
  nor2   g095(.a(x23), .b(x22), .O(new_n142_));
  nor2   g096(.a(x25), .b(x24), .O(new_n143_));
  nand4  g097(.a(new_n143_), .b(new_n142_), .c(new_n101_), .d(new_n84_), .O(new_n144_));
  nand2  g098(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g099(.a(new_n145_), .b(new_n82_), .c(x16), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n140_), .O(z15));
  nand2  g101(.a(x18), .b(x07), .O(new_n148_));
  nand3  g102(.a(new_n133_), .b(x15), .c(new_n47_), .O(new_n149_));
  ...
  nand4  g107(.a(new_n153_), .b(new_n142_), .c(new_n101_), .d(new_n84_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n82_), .c(x16), .O(new_n156_));
  nand2  g110(.a(new_n156_), .b(new_n151_), .O(z16));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n142_), .c(new_n125_), .O(new_n159_));
  nand3  g113(.a(new_n101_), .b(x19), .c(new_n127_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n52_), .d(new_n127_), .O(new_n161_));
  nand2  g115(.a(new_n161_), .b(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n82_), .O(z17));
endmodule
