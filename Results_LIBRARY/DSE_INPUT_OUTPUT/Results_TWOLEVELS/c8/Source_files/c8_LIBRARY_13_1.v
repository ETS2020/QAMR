...
module FAU ( 
  ...
  nor2   g054(.a(new_n91_), .b(new_n56_), .O(new_n101_));
  ...
  nand2  g059(.a(x18), .b(x12), .O(new_n106_));
  oai22  g060(.a(new_n106_), .b(new_n105_), .c(x18), .d(new_n63_), .O(new_n107_));
  ...
  oai21  g064(.a(new_n102_), .b(new_n61_), .c(new_n110_), .O(new_n111_));
  nand3  g065(.a(new_n111_), .b(new_n48_), .c(x16), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n108_), .O(z11));
  inv1   g067(.a(x03), .O(new_n114_));
  oai22  g068(.a(new_n106_), .b(new_n114_), .c(x18), .d(new_n66_), .O(new_n115_));
  nand2  g069(.a(new_n115_), .b(new_n93_), .O(new_n116_));
  nand2  g070(.a(new_n110_), .b(x22), .O(new_n117_));
  nor2   g071(.a(x22), .b(x21), .O(new_n118_));
  nand3  g072(.a(new_n118_), .b(new_n91_), .c(new_n56_), .O(new_n119_));
  nand2  g073(.a(new_n119_), .b(new_n117_), .O(new_n120_));
  nand3  g074(.a(new_n120_), .b(new_n48_), .c(x16), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n116_), .O(z12));
  nand2  g076(.a(x18), .b(x04), .O(new_n123_));
  oai21  g077(.a(x18), .b(new_n47_), .c(new_n123_), .O(new_n124_));
  ...
  aoi21  g088(.a(new_n127_), .b(new_n102_), .c(new_n75_), .O(new_n135_));
  ...
  oai22  g096(.a(new_n106_), .b(new_n142_), .c(x18), .d(new_n80_), .O(new_n143_));
  ...
  nand4  g101(.a(new_n147_), .b(new_n146_), .c(new_n109_), .d(new_n91_), .O(new_n148_));
  ...
  nand4  g110(.a(new_n156_), .b(new_n146_), .c(new_n109_), .d(new_n91_), .O(new_n157_));
  ...
  nand4  g114(.a(new_n146_), .b(new_n83_), .c(new_n78_), .d(new_n75_), .O(new_n161_));
  nand3  g115(.a(new_n109_), .b(x19), .c(new_n89_), .O(new_n162_));
  oai22  g116(.a(new_n162_), .b(new_n161_), .c(new_n53_), .d(new_n89_), .O(new_n163_));
