...
module FAU ( 
  ...
  nand2  g062(.a(new_n55_), .b(new_n52_), .O(new_n109_));
  oai21  g063(.a(new_n109_), .b(new_n61_), .c(new_n108_), .O(new_n110_));
  nand2  g064(.a(new_n110_), .b(new_n96_), .O(new_n111_));
  oai21  g065(.a(x19), .b(x17), .c(x21), .O(new_n112_));
  nand3  g066(.a(new_n63_), .b(new_n47_), .c(new_n92_), .O(new_n113_));
  aoi21  g067(.a(new_n113_), .b(new_n112_), .c(x20), .O(new_n114_));
  nand3  g068(.a(x21), .b(x20), .c(x18), .O(new_n115_));
  ...
  oai21  g084(.a(new_n109_), .b(new_n71_), .c(new_n130_), .O(new_n131_));
  nand2  g085(.a(new_n131_), .b(new_n96_), .O(new_n132_));
  nand2  g086(.a(new_n125_), .b(new_n94_), .O(new_n133_));
  nand2  g087(.a(new_n133_), .b(x23), .O(new_n134_));
  nor2   g088(.a(x23), .b(x22), .O(new_n135_));
  nand3  g089(.a(new_n135_), .b(new_n94_), .c(new_n63_), .O(new_n136_));
  ...
  oai21  g107(.a(new_n109_), .b(new_n83_), .c(new_n153_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(new_n96_), .O(new_n155_));
  nand3  g109(.a(new_n76_), .b(new_n73_), .c(new_n68_), .O(new_n156_));
  oai21  g110(.a(new_n156_), .b(new_n113_), .c(x25), .O(new_n157_));
  nor2   g111(.a(x21), .b(x19), .O(new_n158_));
  nor2   g112(.a(x25), .b(x24), .O(new_n159_));
  nand4  g113(.a(new_n159_), .b(new_n135_), .c(new_n158_), .d(new_n92_), .O(new_n160_));
  aoi21  g114(.a(new_n160_), .b(new_n157_), .c(x20), .O(new_n161_));
  nand3  g115(.a(x25), .b(x20), .c(x18), .O(new_n162_));
  ...
  oai21  g120(.a(new_n109_), .b(new_n86_), .c(new_n166_), .O(new_n167_));
  nand2  g121(.a(new_n167_), .b(new_n96_), .O(new_n168_));
  nand2  g122(.a(new_n160_), .b(x26), .O(new_n169_));
  nor2   g123(.a(x26), .b(x25), .O(new_n170_));
  nand4  g124(.a(new_n170_), .b(new_n148_), .c(new_n125_), .d(new_n94_), .O(new_n171_));
  aoi21  g125(.a(new_n171_), .b(new_n169_), .c(x20), .O(new_n172_));
  nand3  g126(.a(x26), .b(x20), .c(x18), .O(new_n173_));
  ...
  nand4  g131(.a(new_n63_), .b(new_n55_), .c(x19), .d(new_n92_), .O(new_n178_));
  inv1   g132(.a(new_n178_), .O(new_n179_));
  nand4  g133(.a(new_n179_), .b(new_n170_), .c(new_n135_), .d(new_n76_), .O(new_n180_));
