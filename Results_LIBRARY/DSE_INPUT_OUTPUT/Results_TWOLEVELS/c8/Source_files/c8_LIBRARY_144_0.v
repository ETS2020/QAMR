...
module FAU ( 
  ...
  nand4  g53(.a(new_n59_), .b(new_n91_), .c(new_n50_), .d(new_n83_), .O(new_n100_));
  inv1   g54(.a(new_n100_), .O(new_n101_));
  aoi21  g55(.a(new_n99_), .b(x21), .c(new_n101_), .O(new_n102_));
  nand2  g56(.a(new_n95_), .b(x02), .O(new_n103_));
  ...
  nand2  g66(.a(new_n95_), .b(x04), .O(new_n113_));
  oai21  g67(.a(new_n112_), .b(new_n87_), .c(new_n113_), .O(z13));
  oai21  g68(.a(new_n88_), .b(x05), .c(new_n87_), .O(new_n115_));
  ...
  nand4  g78(.a(new_n124_), .b(new_n72_), .c(new_n123_), .d(new_n64_), .O(new_n125_));
