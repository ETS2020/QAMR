...
module FAU ( 
  ...
  aoi21  g063(.a(new_n102_), .b(new_n94_), .c(new_n63_), .O(new_n110_));
  ...
  nand2  g068(.a(new_n106_), .b(x03), .O(new_n115_));
  ...
  nand2  g073(.a(new_n119_), .b(new_n101_), .O(new_n120_));
  nand2  g074(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(x16), .O(new_n122_));
  nand2  g076(.a(new_n106_), .b(x04), .O(new_n123_));
  ...
  aoi21  g080(.a(new_n119_), .b(new_n101_), .c(new_n126_), .O(new_n127_));
  nor2   g081(.a(x24), .b(x23), .O(new_n128_));
  nand4  g082(.a(new_n128_), .b(new_n111_), .c(new_n95_), .d(new_n83_), .O(new_n129_));
