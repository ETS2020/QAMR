...
module FAU ( 
  ...
  nor2   g032(.a(new_n48_), .b(new_n57_), .O(z08));
  ...
  nand3  g053(.a(new_n82_), .b(x10), .c(x04), .O(new_n100_));
  ...
  nand3  g059(.a(new_n105_), .b(new_n86_), .c(x16), .O(new_n106_));
  ...
  aoi21  g072(.a(new_n82_), .b(new_n63_), .c(x16), .O(new_n119_));
  ...
  aoi21  g077(.a(new_n123_), .b(x16), .c(new_n119_), .O(new_n124_));
  nand3  g078(.a(new_n123_), .b(x18), .c(x16), .O(new_n125_));
  oai21  g079(.a(new_n124_), .b(new_n118_), .c(new_n125_), .O(z13));
  ...
  aoi21  g083(.a(new_n121_), .b(new_n96_), .c(new_n68_), .O(new_n130_));
  inv1   g084(.a(x17), .O(new_n131_));
  inv1   g085(.a(x19), .O(new_n132_));
  nand3  g086(.a(new_n93_), .b(new_n132_), .c(new_n131_), .O(new_n133_));
  ...
  oai21  g090(.a(new_n136_), .b(new_n130_), .c(x16), .O(new_n137_));
  nand3  g091(.a(new_n137_), .b(new_n129_), .c(new_n86_), .O(z14));
  ...
  nand4  g098(.a(new_n144_), .b(new_n143_), .c(new_n103_), .d(new_n94_), .O(new_n145_));
  oai21  g099(.a(new_n136_), .b(new_n142_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(x16), .O(new_n147_));
  nand3  g101(.a(new_n147_), .b(new_n141_), .c(new_n86_), .O(z15));
  ...
  nand4  g106(.a(new_n143_), .b(new_n76_), .c(new_n142_), .d(new_n68_), .O(new_n153_));
  oai21  g107(.a(new_n153_), .b(new_n104_), .c(new_n152_), .O(new_n154_));
  nand2  g108(.a(new_n154_), .b(x16), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n151_), .c(new_n86_), .O(z16));
  nand3  g110(.a(new_n103_), .b(x19), .c(new_n131_), .O(new_n157_));
  oai22  g111(.a(new_n157_), .b(new_n153_), .c(new_n57_), .d(new_n131_), .O(new_n158_));
