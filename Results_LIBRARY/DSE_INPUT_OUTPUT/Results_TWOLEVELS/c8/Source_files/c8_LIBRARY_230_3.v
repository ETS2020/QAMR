...
module FAU ( 
  ...
  nand2  g001(.a(x18), .b(x15), .O(new_n48_));
  ...
  nand2  g038(.a(x18), .b(new_n79_), .O(new_n85_));
  ...
  nand3  g050(.a(new_n54_), .b(new_n96_), .c(new_n95_), .O(new_n97_));
  oai21  g051(.a(new_n94_), .b(new_n54_), .c(new_n97_), .O(new_n98_));
  nand3  g052(.a(new_n98_), .b(new_n48_), .c(x16), .O(new_n99_));
  nand2  g053(.a(new_n99_), .b(new_n93_), .O(z10));
  inv1   g054(.a(x02), .O(new_n101_));
  oai22  g055(.a(new_n85_), .b(new_n101_), .c(x18), .d(new_n58_), .O(new_n102_));
  ...
  oai22  g065(.a(new_n85_), .b(new_n111_), .c(x18), .d(new_n61_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n83_), .O(new_n113_));
  nand2  g067(.a(new_n107_), .b(x22), .O(new_n114_));
  nor2   g068(.a(x22), .b(x21), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n94_), .c(new_n54_), .O(new_n116_));
  ...
  oai22  g074(.a(new_n85_), .b(new_n120_), .c(x18), .d(new_n66_), .O(new_n121_));
  nand2  g075(.a(new_n121_), .b(new_n83_), .O(new_n122_));
  nand2  g076(.a(new_n116_), .b(x23), .O(new_n123_));
  nor2   g077(.a(x23), .b(x22), .O(new_n124_));
  nand3  g078(.a(new_n124_), .b(new_n105_), .c(new_n104_), .O(new_n125_));
  ...
  oai21  g102(.a(x18), .b(new_n83_), .c(x15), .O(new_n149_));
  nand2  g103(.a(new_n145_), .b(x26), .O(new_n150_));
  nor3   g104(.a(x26), .b(x25), .c(x24), .O(new_n151_));
  nand4  g105(.a(new_n151_), .b(new_n124_), .c(new_n106_), .d(new_n94_), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(x16), .O(new_n154_));
  nand3  g108(.a(x18), .b(new_n83_), .c(x07), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n154_), .c(new_n149_), .O(z16));
  inv1   g110(.a(x24), .O(new_n157_));
  nor2   g111(.a(x26), .b(x25), .O(new_n158_));
  nand3  g112(.a(new_n158_), .b(new_n124_), .c(new_n157_), .O(new_n159_));
  nand3  g113(.a(new_n106_), .b(x19), .c(new_n95_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n55_), .d(new_n95_), .O(new_n161_));
