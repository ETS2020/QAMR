...
module FAU ( 
  ...
  aoi21  g026(.a(new_n72_), .b(new_n70_), .c(new_n47_), .O(z04));
  ...
  aoi21  g031(.a(new_n77_), .b(new_n75_), .c(new_n47_), .O(z05));
  ...
  aoi21  g036(.a(new_n82_), .b(new_n80_), .c(new_n47_), .O(z06));
  inv1   g037(.a(x15), .O(new_n84_));
  inv1   g038(.a(x18), .O(new_n85_));
  oai21  g039(.a(x27), .b(new_n85_), .c(new_n84_), .O(new_n86_));
  oai21  g040(.a(x27), .b(x26), .c(new_n86_), .O(z07));
  aoi21  g041(.a(new_n85_), .b(new_n84_), .c(new_n51_), .O(z08));
  inv1   g042(.a(new_n47_), .O(new_n89_));
  inv1   g043(.a(x17), .O(new_n90_));
  nor2   g044(.a(new_n50_), .b(new_n90_), .O(new_n91_));
  ...
  oai21  g049(.a(x18), .b(new_n48_), .c(new_n95_), .O(new_n96_));
  nand2  g050(.a(new_n96_), .b(new_n94_), .O(new_n97_));
  nand3  g051(.a(new_n97_), .b(new_n93_), .c(new_n89_), .O(z09));
  nand2  g052(.a(x18), .b(x01), .O(new_n99_));
  nand2  g053(.a(new_n85_), .b(x15), .O(new_n100_));
  oai21  g054(.a(new_n100_), .b(new_n54_), .c(new_n99_), .O(new_n101_));
  nand2  g055(.a(new_n101_), .b(new_n94_), .O(new_n102_));
  nand3  g056(.a(new_n56_), .b(new_n50_), .c(new_n90_), .O(new_n103_));
  oai21  g057(.a(new_n92_), .b(new_n56_), .c(new_n103_), .O(new_n104_));
  nand3  g058(.a(new_n104_), .b(new_n89_), .c(x16), .O(new_n105_));
  ...
  nand3  g068(.a(new_n114_), .b(new_n109_), .c(new_n89_), .O(z11));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n89_), .O(z12));
  ...
  nand3  g083(.a(new_n129_), .b(new_n110_), .c(new_n61_), .O(new_n130_));
  nand2  g084(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand3  g085(.a(new_n131_), .b(new_n89_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n132_), .b(new_n127_), .O(z13));
  nand2  g087(.a(x18), .b(x05), .O(new_n134_));
  oai21  g088(.a(new_n100_), .b(new_n74_), .c(new_n134_), .O(new_n135_));
  nand2  g089(.a(new_n135_), .b(new_n94_), .O(new_n136_));
  nand3  g090(.a(new_n71_), .b(new_n66_), .c(new_n61_), .O(new_n137_));
  oai21  g091(.a(new_n137_), .b(new_n103_), .c(x24), .O(new_n138_));
  nor2   g092(.a(x20), .b(x19), .O(new_n139_));
  nor2   g093(.a(x24), .b(x23), .O(new_n140_));
  nand4  g094(.a(new_n140_), .b(new_n120_), .c(new_n139_), .d(new_n90_), .O(new_n141_));
  nand2  g095(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n89_), .c(x16), .O(new_n143_));
  nand2  g097(.a(new_n143_), .b(new_n136_), .O(z14));
  nand2  g098(.a(x18), .b(x06), .O(new_n145_));
  oai21  g099(.a(new_n100_), .b(new_n79_), .c(new_n145_), .O(new_n146_));
  nand2  g100(.a(new_n146_), .b(new_n94_), .O(new_n147_));
  nand2  g101(.a(new_n141_), .b(x25), .O(new_n148_));
  nor2   g102(.a(x25), .b(x24), .O(new_n149_));
  nand4  g103(.a(new_n149_), .b(new_n129_), .c(new_n111_), .d(new_n92_), .O(new_n150_));
  nand2  g104(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g105(.a(new_n151_), .b(new_n89_), .c(x16), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n147_), .O(z15));
  oai21  g107(.a(new_n85_), .b(x07), .c(new_n94_), .O(new_n154_));
  nand2  g108(.a(new_n150_), .b(x26), .O(new_n155_));
  nor3   g109(.a(x26), .b(x25), .c(x24), .O(new_n156_));
  nand4  g110(.a(new_n156_), .b(new_n129_), .c(new_n111_), .d(new_n92_), .O(new_n157_));
  nand2  g111(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g112(.a(new_n158_), .b(x16), .O(new_n159_));
  nand3  g113(.a(new_n159_), .b(new_n154_), .c(new_n89_), .O(z16));
  nor2   g114(.a(x26), .b(x25), .O(new_n161_));
  nand3  g115(.a(new_n161_), .b(new_n129_), .c(new_n76_), .O(new_n162_));
  nand3  g116(.a(new_n111_), .b(x19), .c(new_n90_), .O(new_n163_));
  oai22  g117(.a(new_n163_), .b(new_n162_), .c(new_n51_), .d(new_n90_), .O(new_n164_));
  nand3  g118(.a(new_n164_), .b(new_n89_), .c(x16), .O(new_n165_));
