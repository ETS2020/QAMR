...
module FAU ( 
  ...
  aoi21  g012(.a(new_n58_), .b(new_n55_), .c(new_n49_), .O(z02));
  ...
  nor2   g032(.a(new_n49_), .b(new_n57_), .O(z08));
  ...
  nor2   g047(.a(new_n93_), .b(x16), .O(new_n94_));
  aoi21  g048(.a(new_n94_), .b(x01), .c(new_n49_), .O(new_n95_));
  nand2  g049(.a(new_n95_), .b(new_n92_), .O(z10));
  nand2  g050(.a(x18), .b(x02), .O(new_n97_));
  nand3  g051(.a(new_n93_), .b(x10), .c(new_n48_), .O(new_n98_));
  ...
  nand3  g060(.a(new_n93_), .b(x11), .c(new_n48_), .O(new_n107_));
  ...
  nand3  g065(.a(new_n111_), .b(new_n82_), .c(new_n89_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  nand3  g067(.a(new_n113_), .b(new_n80_), .c(x16), .O(new_n114_));
  ...
  nand3  g077(.a(new_n123_), .b(new_n118_), .c(new_n80_), .O(z13));
  ...
  aoi21  g082(.a(new_n120_), .b(new_n91_), .c(new_n128_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n93_), .b(x14), .c(new_n48_), .O(new_n138_));
  ...
  nand3  g102(.a(new_n93_), .b(x15), .c(new_n48_), .O(new_n149_));
  ...
  nand3  g112(.a(new_n158_), .b(new_n142_), .c(new_n128_), .O(new_n159_));
  nand3  g113(.a(new_n101_), .b(x19), .c(new_n130_), .O(new_n160_));
  oai22  g114(.a(new_n160_), .b(new_n159_), .c(new_n57_), .d(new_n130_), .O(new_n161_));
