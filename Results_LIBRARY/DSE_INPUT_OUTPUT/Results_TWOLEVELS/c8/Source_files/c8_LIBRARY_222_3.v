...
module FAU ( 
  ...
  oai21  g051(.a(new_n86_), .b(new_n57_), .c(new_n97_), .O(new_n98_));
  ...
  nand2  g060(.a(new_n88_), .b(x10), .O(new_n107_));
  ...
  nand3  g067(.a(new_n113_), .b(new_n86_), .c(new_n57_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(new_n112_), .O(new_n115_));
  nand3  g069(.a(new_n115_), .b(new_n95_), .c(x16), .O(new_n116_));
  ...
  nand3  g078(.a(new_n124_), .b(new_n95_), .c(x16), .O(new_n125_));
  nand2  g079(.a(new_n125_), .b(new_n120_), .O(z13));
  oai21  g080(.a(x16), .b(x05), .c(x18), .O(new_n127_));
  aoi21  g081(.a(new_n122_), .b(new_n102_), .c(new_n73_), .O(new_n128_));
  nor2   g082(.a(x24), .b(x23), .O(new_n129_));
  nand4  g083(.a(new_n129_), .b(new_n113_), .c(new_n96_), .d(new_n84_), .O(new_n130_));
  inv1   g084(.a(new_n130_), .O(new_n131_));
  oai21  g085(.a(new_n131_), .b(new_n128_), .c(x16), .O(new_n132_));
  nand2  g086(.a(new_n88_), .b(x13), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n103_), .d(new_n86_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n88_), .b(x14), .O(new_n142_));
  nand3  g096(.a(new_n142_), .b(new_n141_), .c(new_n135_), .O(z15));
  nand2  g097(.a(x18), .b(x07), .O(new_n144_));
  oai21  g098(.a(x18), .b(new_n79_), .c(new_n144_), .O(new_n145_));
  nand2  g099(.a(new_n145_), .b(new_n91_), .O(new_n146_));
  nand2  g100(.a(new_n139_), .b(x26), .O(new_n147_));
  nor3   g101(.a(x26), .b(x25), .c(x24), .O(new_n148_));
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n103_), .d(new_n86_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n95_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nor2   g106(.a(x26), .b(x25), .O(new_n153_));
  nand3  g107(.a(new_n153_), .b(new_n137_), .c(new_n73_), .O(new_n154_));
  nand3  g108(.a(new_n103_), .b(x19), .c(new_n84_), .O(new_n155_));
  oai22  g109(.a(new_n155_), .b(new_n154_), .c(new_n52_), .d(new_n84_), .O(new_n156_));
  nand3  g110(.a(new_n156_), .b(new_n95_), .c(x16), .O(new_n157_));
