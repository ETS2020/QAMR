...
module FAU ( 
  ...
  nor2   g035(.a(new_n49_), .b(new_n61_), .O(z08));
  ...
  nand3  g066(.a(new_n112_), .b(new_n85_), .c(new_n91_), .O(new_n113_));
  nand2  g067(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand3  g068(.a(new_n114_), .b(new_n101_), .c(x16), .O(new_n115_));
  ...
  aoi21  g079(.a(new_n119_), .b(new_n93_), .c(new_n69_), .O(new_n126_));
  ...
  nand2  g086(.a(new_n87_), .b(x13), .O(new_n133_));
  ...
  nand4  g092(.a(new_n138_), .b(new_n137_), .c(new_n103_), .d(new_n85_), .O(new_n139_));
  nand2  g093(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g094(.a(new_n140_), .b(x16), .O(new_n141_));
  nand2  g095(.a(new_n87_), .b(x14), .O(new_n142_));
  ...
  nand4  g102(.a(new_n148_), .b(new_n137_), .c(new_n103_), .d(new_n85_), .O(new_n149_));
  nand2  g103(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand3  g104(.a(new_n150_), .b(new_n101_), .c(x16), .O(new_n151_));
  nand2  g105(.a(new_n151_), .b(new_n146_), .O(z16));
  nand4  g106(.a(new_n137_), .b(new_n79_), .c(new_n74_), .d(new_n69_), .O(new_n153_));
  nand3  g107(.a(new_n103_), .b(x19), .c(new_n127_), .O(new_n154_));
  oai22  g108(.a(new_n154_), .b(new_n153_), .c(new_n61_), .d(new_n127_), .O(new_n155_));
  nand3  g109(.a(new_n155_), .b(new_n101_), .c(x16), .O(new_n156_));
