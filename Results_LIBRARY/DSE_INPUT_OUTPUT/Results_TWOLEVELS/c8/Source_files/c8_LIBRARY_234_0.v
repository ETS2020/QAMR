...
module FAU ( 
  ...
  nand2  g014(.a(new_n59_), .b(x10), .O(new_n61_));
  oai21  g015(.a(new_n60_), .b(new_n57_), .c(new_n61_), .O(z02));
  ...
  nand2  g037(.a(new_n57_), .b(x10), .O(new_n84_));
  ...
  nor2   g047(.a(new_n93_), .b(new_n53_), .O(new_n94_));
  inv1   g048(.a(x17), .O(new_n95_));
  inv1   g049(.a(x19), .O(new_n96_));
  nand3  g050(.a(new_n53_), .b(new_n96_), .c(new_n95_), .O(new_n97_));
  inv1   g051(.a(new_n97_), .O(new_n98_));
  oai21  g052(.a(new_n98_), .b(new_n94_), .c(x16), .O(new_n99_));
  nand3  g053(.a(new_n99_), .b(new_n92_), .c(new_n80_), .O(z10));
  ...
  nand3  g064(.a(new_n57_), .b(x11), .c(x10), .O(new_n111_));
  nand2  g065(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g066(.a(new_n112_), .b(new_n82_), .O(new_n113_));
  nand2  g067(.a(new_n105_), .b(new_n95_), .O(new_n114_));
  nand2  g068(.a(new_n114_), .b(x22), .O(new_n115_));
  inv1   g069(.a(x22), .O(new_n116_));
  nand4  g070(.a(new_n93_), .b(new_n116_), .c(new_n104_), .d(new_n53_), .O(new_n117_));
  aoi21  g071(.a(new_n117_), .b(new_n115_), .c(new_n48_), .O(new_n118_));
  nor2   g072(.a(x18), .b(x10), .O(new_n119_));
  nor3   g073(.a(new_n119_), .b(new_n116_), .c(new_n96_), .O(new_n120_));
  ...
  aoi21  g089(.a(new_n127_), .b(new_n98_), .c(new_n135_), .O(new_n136_));
  nand4  g090(.a(new_n135_), .b(new_n68_), .c(new_n116_), .d(new_n104_), .O(new_n137_));
  nor2   g091(.a(new_n137_), .b(new_n97_), .O(new_n138_));
  oai21  g092(.a(new_n138_), .b(new_n136_), .c(x16), .O(new_n139_));
  nand3  g093(.a(new_n139_), .b(new_n134_), .c(new_n80_), .O(z14));
  ...
  oai22  g101(.a(new_n147_), .b(new_n106_), .c(new_n138_), .d(new_n144_), .O(new_n148_));
  nand2  g102(.a(new_n148_), .b(x16), .O(new_n149_));
  nand3  g103(.a(new_n149_), .b(new_n143_), .c(new_n80_), .O(z15));
  nand2  g104(.a(x18), .b(x07), .O(new_n151_));
  nand3  g105(.a(new_n57_), .b(x15), .c(x10), .O(new_n152_));
  nand2  g106(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g107(.a(new_n153_), .b(new_n82_), .O(new_n154_));
  nand4  g108(.a(new_n146_), .b(new_n145_), .c(new_n105_), .d(new_n95_), .O(new_n155_));
  nand2  g109(.a(new_n155_), .b(x26), .O(new_n156_));
  nor3   g110(.a(x26), .b(x25), .c(x24), .O(new_n157_));
  nand4  g111(.a(new_n157_), .b(new_n145_), .c(new_n105_), .d(new_n93_), .O(new_n158_));
  aoi21  g112(.a(new_n158_), .b(new_n156_), .c(new_n48_), .O(new_n159_));
  inv1   g113(.a(x26), .O(new_n160_));
  nor3   g114(.a(new_n119_), .b(new_n160_), .c(new_n96_), .O(new_n161_));
  oai21  g115(.a(new_n161_), .b(new_n159_), .c(x16), .O(new_n162_));
  nand2  g116(.a(new_n162_), .b(new_n154_), .O(z16));
  nand2  g117(.a(new_n157_), .b(new_n145_), .O(new_n164_));
  nand3  g118(.a(new_n105_), .b(x19), .c(new_n95_), .O(new_n165_));
  oai22  g119(.a(new_n165_), .b(new_n164_), .c(new_n54_), .d(new_n95_), .O(new_n166_));
