...
module FAU ( 
  ...
  oai21  g18(.a(new_n33_), .b(x2), .c(new_n22_), .O(new_n34_));
  ...
  oai21  g35(.a(new_n50_), .b(new_n33_), .c(new_n28_), .O(new_n51_));
  ...
  oai21  g39(.a(new_n22_), .b(new_n18_), .c(x2), .O(new_n55_));
  nand3  g40(.a(new_n41_), .b(new_n18_), .c(new_n16_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n55_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n54_), .c(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n28_), .b(new_n16_), .O(new_n59_));
  nand3  g44(.a(new_n22_), .b(x3), .c(x2), .O(new_n60_));
  ...
  nand2  g49(.a(new_n64_), .b(new_n58_), .O(z4));
  nand2  g50(.a(new_n53_), .b(new_n50_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x0), .O(new_n67_));
  nand2  g52(.a(new_n26_), .b(new_n23_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(x2), .c(new_n20_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n17_), .O(new_n71_));
  oai21  g56(.a(new_n21_), .b(new_n16_), .c(new_n22_), .O(new_n72_));
  aoi22  g57(.a(new_n72_), .b(x3), .c(new_n31_), .d(new_n20_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n71_), .O(z5));
  nand4  g59(.a(new_n39_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n75_));
  inv1   g60(.a(new_n75_), .O(new_n76_));
  oai21  g61(.a(new_n76_), .b(new_n54_), .c(new_n17_), .O(new_n77_));
  inv1   g62(.a(x4), .O(new_n78_));
  nand3  g63(.a(new_n78_), .b(new_n18_), .c(new_n16_), .O(new_n79_));
  nand2  g64(.a(new_n79_), .b(new_n23_), .O(new_n80_));
  nand3  g65(.a(new_n80_), .b(x1), .c(new_n20_), .O(new_n81_));
