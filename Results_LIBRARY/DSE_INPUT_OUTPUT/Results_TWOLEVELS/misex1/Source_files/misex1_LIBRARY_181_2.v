...
module FAU ( 
  ...
  nand2  g30(.a(x5), .b(x4), .O(new_n46_));
  ...
  nand3  g34(.a(new_n49_), .b(new_n40_), .c(new_n17_), .O(z2));
  ...
  nand3  g40(.a(new_n16_), .b(x2), .c(new_n18_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n45_), .O(new_n57_));
  nand4  g42(.a(new_n57_), .b(new_n41_), .c(new_n19_), .d(new_n28_), .O(new_n58_));
  ...
  oai21  g47(.a(new_n62_), .b(new_n23_), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(x2), .b(new_n18_), .O(new_n64_));
  nand2  g49(.a(new_n19_), .b(new_n26_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n64_), .c(new_n16_), .O(new_n66_));
  aoi21  g51(.a(x5), .b(new_n19_), .c(new_n26_), .O(new_n67_));
  ...
  nand3  g56(.a(new_n71_), .b(new_n19_), .c(new_n26_), .O(new_n72_));
  aoi21  g57(.a(new_n72_), .b(new_n69_), .c(x4), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n66_), .c(new_n28_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n63_), .O(z4));
  nand3  g60(.a(x6), .b(new_n19_), .c(new_n26_), .O(new_n76_));
  aoi21  g61(.a(new_n76_), .b(new_n22_), .c(x0), .O(new_n77_));
  oai21  g62(.a(new_n77_), .b(new_n62_), .c(new_n17_), .O(new_n78_));
  oai21  g63(.a(x4), .b(x3), .c(new_n46_), .O(new_n79_));
  nand3  g64(.a(new_n79_), .b(new_n26_), .c(x1), .O(new_n80_));
  nand2  g65(.a(new_n80_), .b(new_n34_), .O(new_n81_));
  nand2  g66(.a(new_n81_), .b(new_n28_), .O(new_n82_));
  nand2  g67(.a(new_n82_), .b(new_n78_), .O(z5));
  nand2  g68(.a(new_n63_), .b(new_n58_), .O(z6));
endmodule
