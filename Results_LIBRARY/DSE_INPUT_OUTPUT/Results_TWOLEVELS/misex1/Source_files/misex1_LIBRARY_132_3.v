...
module FAU ( 
  ...
  oai21  g33(.a(new_n46_), .b(x1), .c(new_n48_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n21_), .c(new_n20_), .O(new_n50_));
  oai21  g35(.a(new_n46_), .b(new_n33_), .c(new_n50_), .O(z3));
  aoi21  g36(.a(new_n46_), .b(new_n34_), .c(new_n20_), .O(new_n52_));
  ...
  nor2   g40(.a(new_n55_), .b(x5), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(x1), .c(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n54_), .O(z4));
  aoi21  g43(.a(new_n25_), .b(new_n24_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n52_), .c(new_n17_), .O(new_n60_));
  aoi21  g45(.a(new_n56_), .b(new_n20_), .c(x5), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n17_), .c(new_n60_), .O(z5));
  ...
  aoi21  g50(.a(new_n40_), .b(new_n16_), .c(x3), .O(new_n66_));
