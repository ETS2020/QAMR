...
module FAU ( 
  ...
  nand4  g16(.a(new_n31_), .b(new_n24_), .c(x3), .d(new_n18_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n30_), .O(z1));
  nand2  g18(.a(x5), .b(x2), .O(new_n34_));
  nand4  g19(.a(new_n34_), .b(new_n24_), .c(new_n16_), .d(new_n23_), .O(new_n35_));
  aoi21  g20(.a(x4), .b(new_n18_), .c(x3), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(new_n23_), .c(new_n35_), .O(new_n37_));
  ...
  nor2   g26(.a(x6), .b(x5), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(new_n16_), .c(x2), .d(new_n23_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  nand4  g30(.a(new_n31_), .b(new_n24_), .c(new_n16_), .d(x2), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(z3));
  xor2a  g32(.a(x3), .b(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  oai21  g34(.a(new_n16_), .b(x2), .c(new_n17_), .O(new_n50_));
  ...
  nand3  g40(.a(new_n26_), .b(x2), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n49_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n24_), .c(new_n23_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n54_), .O(z5));
  nand4  g44(.a(new_n25_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n49_), .c(new_n24_), .O(new_n61_));
