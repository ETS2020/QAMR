...
module FAU ( 
  ...
  oai21  g43(.a(new_n58_), .b(x0), .c(new_n33_), .O(z5));
  nand2  g44(.a(x3), .b(x1), .O(new_n60_));
  nand2  g45(.a(new_n21_), .b(new_n19_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n20_), .O(new_n62_));
  oai21  g47(.a(new_n23_), .b(x3), .c(new_n20_), .O(new_n63_));
  nor2   g48(.a(new_n63_), .b(new_n19_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n33_), .O(z6));
endmodule
