...
module FAU ( 
  ...
  nand3  g19(.a(x4), .b(new_n28_), .c(x1), .O(new_n35_));
  oai21  g20(.a(new_n34_), .b(x1), .c(new_n35_), .O(new_n36_));
  nand3  g21(.a(new_n36_), .b(new_n19_), .c(new_n22_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n30_), .O(z2));
  nand2  g23(.a(x7), .b(x4), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n28_), .c(x1), .O(new_n40_));
  nand3  g25(.a(new_n32_), .b(x2), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n22_), .O(new_n43_));
  nand3  g28(.a(x2), .b(new_n17_), .c(x0), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x3), .O(z3));
  aoi21  g30(.a(new_n29_), .b(new_n20_), .c(new_n22_), .O(new_n46_));
  oai21  g31(.a(new_n34_), .b(x3), .c(new_n25_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n22_), .c(new_n46_), .O(new_n48_));
  nand2  g33(.a(new_n24_), .b(new_n22_), .O(new_n49_));
  oai21  g34(.a(new_n48_), .b(x1), .c(new_n49_), .O(z4));
  nor2   g35(.a(new_n25_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n46_), .c(new_n17_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n49_), .c(new_n16_), .O(z5));
  nand4  g38(.a(new_n32_), .b(new_n19_), .c(x2), .d(new_n22_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n46_), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n28_), .b(new_n22_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x4), .c(new_n19_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x1), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z6));
endmodule
