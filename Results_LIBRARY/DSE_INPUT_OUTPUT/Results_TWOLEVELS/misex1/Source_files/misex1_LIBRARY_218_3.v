...
module FAU ( 
  ...
  nor2   g17(.a(new_n20_), .b(new_n17_), .O(new_n33_));
  aoi21  g18(.a(new_n32_), .b(new_n30_), .c(new_n33_), .O(new_n34_));
  oai21  g19(.a(new_n28_), .b(x0), .c(new_n34_), .O(z1));
  ...
  nand3  g23(.a(x4), .b(new_n16_), .c(new_n29_), .O(new_n39_));
  ...
  nand3  g30(.a(new_n45_), .b(new_n17_), .c(new_n29_), .O(new_n46_));
  ...
  nor2   g34(.a(x2), .b(x0), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x7), .c(x1), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(z3));
  nand2  g37(.a(new_n18_), .b(x2), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n31_), .c(new_n29_), .O(new_n54_));
  oai21  g39(.a(new_n44_), .b(x3), .c(new_n26_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n29_), .c(new_n54_), .O(new_n56_));
  aoi21  g41(.a(new_n20_), .b(x3), .c(new_n16_), .O(new_n57_));
  oai22  g42(.a(new_n57_), .b(new_n17_), .c(new_n24_), .d(x2), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n29_), .c(new_n33_), .O(new_n59_));
