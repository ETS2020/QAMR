...
module FAU ( 
  ...
  nand2  g22(.a(new_n28_), .b(new_n18_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n19_), .c(new_n16_), .O(new_n40_));
  oai21  g25(.a(new_n31_), .b(x2), .c(new_n19_), .O(new_n41_));
  ...
  nand2  g31(.a(new_n32_), .b(x7), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n18_), .c(x1), .O(new_n48_));
  nand4  g33(.a(new_n24_), .b(new_n19_), .c(x2), .d(new_n16_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n17_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n21_), .O(z3));
  aoi21  g37(.a(new_n19_), .b(x2), .c(new_n16_), .O(new_n53_));
  oai21  g38(.a(new_n28_), .b(x2), .c(x1), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n19_), .c(new_n53_), .O(new_n55_));
  nand4  g40(.a(new_n19_), .b(x2), .c(new_n16_), .d(x0), .O(new_n56_));
  oai21  g41(.a(new_n55_), .b(x0), .c(new_n56_), .O(z4));
  nand2  g42(.a(new_n24_), .b(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x2), .c(new_n16_), .O(new_n59_));
  nand3  g44(.a(new_n29_), .b(new_n18_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n19_), .O(new_n62_));
  nand3  g47(.a(new_n41_), .b(x1), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z5));
  nand2  g49(.a(x3), .b(x1), .O(new_n65_));
  nand3  g50(.a(new_n24_), .b(new_n19_), .c(new_n16_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n65_), .c(new_n18_), .O(new_n67_));
  oai21  g52(.a(new_n31_), .b(x3), .c(new_n18_), .O(new_n68_));
  nor2   g53(.a(new_n68_), .b(new_n16_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n17_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n21_), .O(z6));
endmodule
