...
module FAU ( 
  ...
  nand2  g51(.a(new_n64_), .b(new_n17_), .O(new_n67_));
  aoi21  g52(.a(new_n27_), .b(new_n17_), .c(new_n54_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(x1), .c(new_n67_), .O(z5));
  nand3  g54(.a(new_n22_), .b(new_n34_), .c(new_n19_), .O(new_n70_));
  nor3   g55(.a(new_n70_), .b(new_n16_), .c(x0), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n54_), .c(new_n18_), .O(new_n72_));
  ...
  nand3  g61(.a(new_n76_), .b(new_n72_), .c(new_n44_), .O(z6));
endmodule
