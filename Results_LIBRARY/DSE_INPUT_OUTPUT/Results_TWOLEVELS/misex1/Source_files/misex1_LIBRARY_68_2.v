...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(new_n25_), .c(x0), .O(z1));
  ...
  oai21  g25(.a(x2), .b(new_n17_), .c(new_n40_), .O(z2));
  oai21  g26(.a(x3), .b(x1), .c(x2), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(x0), .O(new_n43_));
  nand3  g28(.a(new_n26_), .b(new_n16_), .c(x1), .O(new_n44_));
  ...
  oai21  g34(.a(x3), .b(new_n16_), .c(x1), .O(new_n50_));
  aoi21  g35(.a(new_n35_), .b(new_n33_), .c(x1), .O(new_n51_));
  nor2   g36(.a(new_n34_), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n20_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n50_), .c(new_n25_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n17_), .O(new_n55_));
  nand4  g40(.a(new_n20_), .b(x2), .c(new_n19_), .d(x0), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n55_), .O(z4));
  aoi21  g42(.a(x5), .b(new_n19_), .c(x3), .O(new_n58_));
  nor2   g43(.a(new_n58_), .b(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n29_), .b(new_n16_), .c(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x0), .c(new_n43_), .O(z5));
  nand2  g46(.a(x3), .b(x1), .O(new_n62_));
  nand2  g47(.a(new_n23_), .b(new_n19_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n62_), .c(new_n16_), .O(new_n64_));
  oai21  g49(.a(new_n26_), .b(x3), .c(new_n16_), .O(new_n65_));
  nor2   g50(.a(new_n65_), .b(new_n19_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n17_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n43_), .O(z6));
endmodule
