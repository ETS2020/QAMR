...
module FAU ( 
  ...
  nand2  g19(.a(x5), .b(new_n34_), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n18_), .c(new_n33_), .O(new_n36_));
  ...
  nand3  g25(.a(new_n40_), .b(new_n32_), .c(new_n25_), .O(z1));
  nand3  g26(.a(new_n33_), .b(new_n20_), .c(new_n18_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n38_), .c(x0), .O(new_n43_));
  nand3  g28(.a(x3), .b(new_n18_), .c(x0), .O(new_n44_));
  inv1   g29(.a(new_n44_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n43_), .c(new_n27_), .O(new_n46_));
  nor2   g31(.a(new_n18_), .b(x0), .O(new_n47_));
  nor2   g32(.a(new_n20_), .b(new_n27_), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n47_), .c(new_n24_), .O(new_n49_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n47_), .c(new_n27_), .O(new_n57_));
  ...
  nand2  g45(.a(new_n33_), .b(new_n20_), .O(new_n61_));
  ...
  oai21  g49(.a(new_n64_), .b(x3), .c(new_n34_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n27_), .c(x3), .O(new_n66_));
  nand3  g51(.a(x6), .b(new_n20_), .c(new_n27_), .O(new_n67_));
  oai21  g52(.a(new_n66_), .b(new_n18_), .c(new_n67_), .O(new_n68_));
  ...
  oai21  g59(.a(new_n35_), .b(x2), .c(new_n20_), .O(new_n75_));
