...
module FAU ( 
  ...
  nand3  g48(.a(new_n40_), .b(new_n50_), .c(new_n19_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(x0), .O(new_n65_));
  nand2  g50(.a(x3), .b(x1), .O(new_n66_));
  nand3  g51(.a(new_n52_), .b(new_n20_), .c(new_n19_), .O(new_n67_));
  aoi21  g52(.a(new_n67_), .b(new_n66_), .c(new_n16_), .O(new_n68_));
  oai21  g53(.a(new_n25_), .b(x3), .c(new_n16_), .O(new_n69_));
  nor2   g54(.a(new_n69_), .b(new_n19_), .O(new_n70_));
