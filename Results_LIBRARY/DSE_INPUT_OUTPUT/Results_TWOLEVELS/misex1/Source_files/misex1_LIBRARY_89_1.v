...
module FAU ( 
  ...
  oai21  g15(.a(new_n30_), .b(new_n20_), .c(new_n23_), .O(new_n31_));
  ...
  nand3  g25(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n41_));
  oai22  g26(.a(new_n41_), .b(new_n30_), .c(new_n40_), .d(x0), .O(z2));
  nand2  g27(.a(x7), .b(x3), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n23_), .c(new_n16_), .d(x1), .O(new_n44_));
  ...
  aoi21  g35(.a(new_n49_), .b(new_n41_), .c(new_n17_), .O(new_n51_));
  nand2  g36(.a(new_n38_), .b(new_n37_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n20_), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n27_), .c(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n51_), .c(new_n19_), .O(new_n55_));
  nand2  g40(.a(new_n23_), .b(new_n16_), .O(new_n56_));
  nand2  g41(.a(x3), .b(x2), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(new_n19_), .O(new_n58_));
  ...
  nand2  g46(.a(new_n61_), .b(new_n55_), .O(z4));
  nor2   g47(.a(new_n27_), .b(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n51_), .c(new_n19_), .O(new_n64_));
  nor2   g49(.a(new_n23_), .b(x2), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n64_), .c(new_n61_), .O(z5));
  nand3  g52(.a(new_n45_), .b(x2), .c(new_n17_), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n51_), .c(new_n19_), .O(new_n70_));
  aoi21  g55(.a(new_n58_), .b(new_n17_), .c(new_n65_), .O(new_n71_));
