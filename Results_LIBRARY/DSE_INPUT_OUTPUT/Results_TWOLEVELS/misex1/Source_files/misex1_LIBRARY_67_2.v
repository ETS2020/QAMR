...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n25_), .c(new_n21_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n32_), .c(x0), .O(new_n35_));
  nand3  g20(.a(x3), .b(new_n21_), .c(x0), .O(new_n36_));
  ...
  nand3  g29(.a(new_n33_), .b(new_n25_), .c(new_n16_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x1), .O(new_n46_));
  oai21  g31(.a(x3), .b(new_n16_), .c(x1), .O(new_n47_));
  nand3  g32(.a(x6), .b(new_n25_), .c(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n46_), .c(new_n17_), .O(new_n50_));
  nand4  g35(.a(x3), .b(new_n16_), .c(new_n21_), .d(x0), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(z4));
  inv1   g37(.a(new_n22_), .O(new_n53_));
  aoi21  g38(.a(new_n16_), .b(new_n21_), .c(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(x3), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n30_), .c(new_n29_), .O(z5));
  inv1   g41(.a(z0), .O(new_n57_));
  nand2  g42(.a(x4), .b(new_n25_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x1), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n36_), .O(new_n60_));
