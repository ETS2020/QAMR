...
module FAU ( 
  ...
  oai21  g16(.a(new_n31_), .b(new_n20_), .c(x4), .O(new_n32_));
  ...
  aoi21  g31(.a(new_n46_), .b(new_n44_), .c(x0), .O(new_n47_));
  nand2  g32(.a(new_n20_), .b(x2), .O(new_n48_));
  nor2   g33(.a(x4), .b(x2), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  oai21  g35(.a(new_n48_), .b(new_n31_), .c(new_n50_), .O(new_n51_));
  or2    g36(.a(new_n51_), .b(new_n47_), .O(z3));
  nand3  g37(.a(x4), .b(x3), .c(new_n16_), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n48_), .c(new_n17_), .O(new_n54_));
  nor2   g39(.a(new_n16_), .b(x0), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n19_), .O(new_n56_));
  nand3  g41(.a(x4), .b(new_n20_), .c(new_n16_), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n37_), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n56_), .O(z4));
  nor3   g45(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n54_), .c(new_n19_), .O(new_n62_));
  nand4  g47(.a(x6), .b(x4), .c(new_n20_), .d(new_n16_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n37_), .c(new_n17_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  nand3  g51(.a(new_n23_), .b(x2), .c(new_n17_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n54_), .c(new_n19_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n50_), .c(new_n18_), .O(z6));
endmodule
