...
module FAU ( 
  ...
  nand2  g21(.a(new_n21_), .b(new_n16_), .O(new_n37_));
  oai21  g22(.a(x5), .b(new_n16_), .c(new_n37_), .O(new_n38_));
  ...
  oai21  g37(.a(new_n52_), .b(new_n33_), .c(new_n51_), .O(z3));
  aoi21  g38(.a(new_n52_), .b(new_n34_), .c(new_n20_), .O(new_n54_));
  ...
  aoi21  g43(.a(new_n58_), .b(new_n20_), .c(x6), .O(new_n59_));
