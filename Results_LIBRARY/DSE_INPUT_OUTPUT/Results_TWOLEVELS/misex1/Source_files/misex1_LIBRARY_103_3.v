...
module FAU ( 
  ...
  oai21  g11(.a(new_n21_), .b(x0), .c(new_n22_), .O(new_n27_));
  ...
  nand3  g40(.a(new_n55_), .b(new_n32_), .c(new_n28_), .O(z4));
  nand2  g41(.a(new_n51_), .b(new_n24_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n21_), .O(new_n58_));
  inv1   g43(.a(x4), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(x1), .c(x6), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x3), .c(new_n34_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n22_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n58_), .O(z5));
  nand4  g48(.a(new_n38_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n51_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n21_), .O(new_n66_));
  nand2  g51(.a(x4), .b(new_n16_), .O(new_n67_));
  nand4  g52(.a(new_n67_), .b(new_n22_), .c(x1), .d(new_n17_), .O(new_n68_));
