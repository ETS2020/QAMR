...
module FAU ( 
  ...
  nand3  g29(.a(new_n29_), .b(x2), .c(new_n18_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n16_), .O(new_n47_));
  nand4  g32(.a(new_n19_), .b(x2), .c(new_n18_), .d(x0), .O(new_n48_));
  and2   g33(.a(new_n48_), .b(new_n24_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(z3));
  oai21  g35(.a(x3), .b(new_n18_), .c(x2), .O(new_n51_));
  oai21  g36(.a(new_n26_), .b(new_n19_), .c(new_n23_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n16_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n49_), .O(z4));
  aoi21  g40(.a(x5), .b(new_n18_), .c(x3), .O(new_n56_));
  nor2   g41(.a(new_n56_), .b(new_n23_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n27_), .c(new_n16_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n48_), .O(z5));
  ...
  nand2  g49(.a(new_n64_), .b(new_n49_), .O(z6));
endmodule
