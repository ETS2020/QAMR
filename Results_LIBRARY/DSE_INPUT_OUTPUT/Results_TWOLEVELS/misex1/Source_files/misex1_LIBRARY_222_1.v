...
module FAU ( 
  ...
  oai21  g40(.a(x4), .b(x2), .c(new_n55_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x1), .O(new_n57_));
  nand4  g42(.a(x6), .b(new_n23_), .c(new_n20_), .d(new_n16_), .O(new_n58_));
  ...
  nand2  g48(.a(x4), .b(new_n16_), .O(new_n64_));
  ...
  oai21  g53(.a(new_n57_), .b(x0), .c(new_n68_), .O(z6));
endmodule
