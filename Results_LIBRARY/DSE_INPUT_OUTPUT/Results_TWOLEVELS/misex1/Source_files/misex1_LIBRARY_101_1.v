...
module FAU ( 
  ...
  nand4  g15(.a(new_n30_), .b(new_n23_), .c(x2), .d(new_n21_), .O(new_n31_));
  ...
  nor2   g26(.a(x5), .b(new_n17_), .O(new_n42_));
  inv1   g27(.a(x6), .O(new_n43_));
  nor2   g28(.a(new_n43_), .b(x2), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(new_n42_), .c(new_n23_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n22_), .c(x0), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n41_), .c(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n35_), .O(z4));
  aoi21  g33(.a(new_n40_), .b(new_n26_), .c(x1), .O(z5));
  aoi21  g34(.a(new_n40_), .b(new_n31_), .c(x1), .O(z6));
endmodule
