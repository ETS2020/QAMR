...
module FAU ( 
  ...
  nand4  g29(.a(new_n22_), .b(x2), .c(new_n17_), .d(x0), .O(new_n45_));
  ...
  nand3  g34(.a(new_n49_), .b(new_n22_), .c(new_n21_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n30_), .O(z4));
  nand2  g38(.a(new_n48_), .b(new_n23_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n17_), .O(new_n55_));
  oai21  g40(.a(new_n17_), .b(x0), .c(new_n16_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x3), .O(new_n57_));
  oai21  g42(.a(x4), .b(new_n22_), .c(x1), .O(new_n58_));
  nand2  g43(.a(x6), .b(new_n22_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n16_), .c(new_n21_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n57_), .c(new_n55_), .O(z5));
  nand4  g47(.a(new_n35_), .b(new_n22_), .c(x2), .d(new_n21_), .O(new_n63_));
