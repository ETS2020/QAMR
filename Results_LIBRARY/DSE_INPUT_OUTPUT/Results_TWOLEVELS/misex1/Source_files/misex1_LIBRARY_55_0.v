...
module FAU ( 
  ...
  nand2  g23(.a(x3), .b(x1), .O(new_n39_));
  nand4  g24(.a(new_n25_), .b(x4), .c(new_n24_), .d(new_n16_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n39_), .c(new_n28_), .O(new_n41_));
  nand2  g26(.a(new_n23_), .b(new_n24_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(x1), .O(new_n43_));
  nand3  g28(.a(new_n29_), .b(x4), .c(new_n24_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x2), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n41_), .c(new_n20_), .O(new_n46_));
  nor2   g31(.a(x2), .b(new_n20_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(x3), .c(new_n23_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x1), .c(new_n46_), .O(z2));
  nand2  g34(.a(new_n42_), .b(x7), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n28_), .c(x1), .O(new_n51_));
  inv1   g36(.a(new_n51_), .O(new_n52_));
  nand3  g37(.a(new_n25_), .b(x4), .c(new_n24_), .O(new_n53_));
  nor3   g38(.a(new_n53_), .b(new_n28_), .c(x1), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n52_), .c(new_n20_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(z3));
  ...
  aoi21  g46(.a(new_n60_), .b(new_n16_), .c(new_n61_), .O(new_n62_));
  oai21  g47(.a(x4), .b(x2), .c(new_n24_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(x1), .c(new_n20_), .O(new_n64_));
  oai21  g49(.a(new_n62_), .b(new_n23_), .c(new_n64_), .O(z4));
  ...
  nand2  g55(.a(new_n23_), .b(new_n16_), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(new_n70_), .c(new_n64_), .O(z5));
  nand2  g57(.a(x2), .b(new_n20_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n26_), .c(new_n58_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x4), .c(new_n16_), .O(new_n75_));
  nand2  g60(.a(new_n75_), .b(new_n64_), .O(z6));
endmodule
