...
module FAU ( 
  ...
  nand2  g12(.a(new_n25_), .b(new_n27_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x1), .O(new_n29_));
  oai21  g14(.a(new_n26_), .b(x3), .c(new_n29_), .O(new_n30_));
  ...
  nand3  g22(.a(new_n37_), .b(new_n27_), .c(new_n16_), .O(new_n38_));
  oai21  g23(.a(new_n25_), .b(x2), .c(new_n27_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(x1), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(new_n38_), .c(x0), .O(z2));
  nand2  g26(.a(new_n28_), .b(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n21_), .c(x1), .O(new_n43_));
  nand3  g28(.a(new_n22_), .b(x2), .c(new_n16_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x0), .O(z3));
  oai21  g30(.a(x3), .b(new_n21_), .c(x1), .O(new_n46_));
  aoi21  g31(.a(new_n36_), .b(new_n34_), .c(x1), .O(new_n47_));
  nor2   g32(.a(new_n35_), .b(x2), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n47_), .c(new_n27_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n46_), .c(new_n24_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(z4));
  aoi21  g37(.a(x5), .b(new_n16_), .c(x3), .O(new_n53_));
  nor2   g38(.a(new_n53_), .b(new_n21_), .O(new_n54_));
  aoi21  g39(.a(new_n30_), .b(new_n21_), .c(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(x0), .c(new_n17_), .O(z5));
  aoi21  g41(.a(new_n22_), .b(x2), .c(x0), .O(new_n57_));
  oai21  g42(.a(x4), .b(x2), .c(new_n27_), .O(new_n58_));
