...
module FAU ( 
  ...
  nand4  g29(.a(new_n19_), .b(x2), .c(new_n16_), .d(x0), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(z3));
  aoi21  g31(.a(new_n19_), .b(x2), .c(new_n16_), .O(new_n47_));
  oai21  g32(.a(new_n31_), .b(x2), .c(x1), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n19_), .c(new_n47_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(x0), .c(new_n45_), .O(z4));
  nand2  g35(.a(new_n41_), .b(new_n17_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(x2), .c(new_n16_), .O(new_n52_));
  oai21  g37(.a(x4), .b(new_n16_), .c(new_n31_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n18_), .c(new_n17_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n52_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(new_n56_));
  nor2   g41(.a(new_n19_), .b(x1), .O(new_n57_));
  aoi21  g42(.a(new_n36_), .b(new_n17_), .c(new_n57_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z5));
  nand2  g44(.a(x3), .b(x1), .O(new_n60_));
  nand3  g45(.a(new_n41_), .b(new_n19_), .c(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n18_), .O(new_n62_));
  oai21  g47(.a(new_n24_), .b(x3), .c(new_n18_), .O(new_n63_));
  nor2   g48(.a(new_n63_), .b(new_n16_), .O(new_n64_));
