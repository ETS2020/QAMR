...
module FAU ( 
  ...
  aoi21  g33(.a(new_n32_), .b(x2), .c(new_n48_), .O(new_n49_));
  nand2  g34(.a(x6), .b(new_n21_), .O(new_n50_));
  oai21  g35(.a(new_n49_), .b(x1), .c(new_n50_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n26_), .c(new_n23_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n47_), .c(x0), .O(z4));
  nand2  g38(.a(new_n29_), .b(new_n21_), .O(new_n54_));
  oai21  g39(.a(new_n32_), .b(x1), .c(new_n26_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x2), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n54_), .c(x0), .O(z5));
  aoi21  g42(.a(new_n22_), .b(x2), .c(x0), .O(new_n58_));
  oai21  g43(.a(x4), .b(x2), .c(new_n26_), .O(new_n59_));
