...
module FAU ( 
  ...
  nor2   g05(.a(x4), .b(new_n18_), .O(new_n21_));
  ...
  nand2  g12(.a(x4), .b(x3), .O(new_n28_));
  ...
  oai21  g18(.a(new_n33_), .b(x2), .c(new_n24_), .O(new_n34_));
  ...
  nand4  g32(.a(new_n37_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n47_), .c(x0), .O(new_n49_));
  nand2  g34(.a(new_n18_), .b(x2), .O(new_n50_));
  oai22  g35(.a(new_n50_), .b(new_n33_), .c(new_n24_), .d(new_n18_), .O(new_n51_));
  or2    g36(.a(new_n51_), .b(new_n49_), .O(z3));
  nand3  g37(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n50_), .c(new_n20_), .O(new_n54_));
  nand2  g39(.a(new_n28_), .b(x2), .O(new_n55_));
  ...
  oai21  g43(.a(new_n58_), .b(new_n54_), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(x1), .b(new_n20_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x2), .c(new_n18_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(x4), .O(new_n62_));
  oai21  g47(.a(x3), .b(new_n16_), .c(new_n24_), .O(new_n63_));
  nor2   g48(.a(new_n63_), .b(new_n17_), .O(new_n64_));
  ...
  nand3  g52(.a(new_n67_), .b(new_n62_), .c(new_n59_), .O(z4));
  aoi21  g53(.a(new_n27_), .b(new_n20_), .c(new_n54_), .O(new_n69_));
  nand3  g54(.a(x4), .b(new_n18_), .c(new_n16_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n63_), .c(new_n17_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n66_), .c(new_n20_), .O(new_n72_));
  oai21  g57(.a(new_n69_), .b(x1), .c(new_n72_), .O(z5));
  nand4  g58(.a(new_n37_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n74_));
  inv1   g59(.a(new_n74_), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n54_), .c(new_n17_), .O(new_n76_));
  nand2  g61(.a(new_n64_), .b(new_n20_), .O(new_n77_));
