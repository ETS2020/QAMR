...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(x2), .c(new_n21_), .O(new_n31_));
  ...
  aoi21  g21(.a(new_n30_), .b(x2), .c(x1), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(x0), .c(new_n19_), .O(z3));
  oai21  g23(.a(new_n27_), .b(new_n18_), .c(x0), .O(new_n39_));
  inv1   g24(.a(new_n39_), .O(new_n40_));
  nor2   g25(.a(x5), .b(new_n17_), .O(new_n41_));
  inv1   g26(.a(x6), .O(new_n42_));
  nor2   g27(.a(new_n42_), .b(x2), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n41_), .c(new_n23_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n22_), .c(x0), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n40_), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n35_), .O(z4));
  aoi21  g32(.a(new_n39_), .b(new_n26_), .c(x1), .O(z5));
  aoi21  g33(.a(new_n39_), .b(new_n31_), .c(x1), .O(z6));
endmodule
