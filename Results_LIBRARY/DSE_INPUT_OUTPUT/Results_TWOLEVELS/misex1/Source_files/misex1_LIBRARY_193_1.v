...
module FAU ( 
  ...
  nand4  g11(.a(new_n26_), .b(new_n23_), .c(x2), .d(new_n19_), .O(new_n27_));
  ...
  oai21  g16(.a(new_n31_), .b(new_n24_), .c(new_n23_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n19_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n30_), .O(z1));
  nand2  g19(.a(x5), .b(x2), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n23_), .c(new_n24_), .d(new_n19_), .O(new_n36_));
  ...
  nand4  g28(.a(new_n43_), .b(new_n24_), .c(x2), .d(new_n19_), .O(new_n44_));
  ...
  oai21  g35(.a(new_n24_), .b(x2), .c(new_n17_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n23_), .c(new_n19_), .O(new_n53_));
  nand2  g38(.a(new_n24_), .b(x2), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(x1), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n53_), .O(z4));
  nand3  g41(.a(new_n26_), .b(x2), .c(new_n17_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n50_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n23_), .c(new_n19_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z5));
  nand4  g45(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n17_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n50_), .c(new_n23_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n19_), .O(new_n63_));
  oai21  g48(.a(x4), .b(x2), .c(new_n24_), .O(new_n64_));
