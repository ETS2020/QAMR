...
module FAU ( 
  ...
  oai21  g16(.a(x5), .b(new_n16_), .c(new_n31_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n20_), .c(new_n19_), .O(new_n33_));
  ...
  aoi21  g30(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n46_));
  oai21  g31(.a(new_n30_), .b(x2), .c(x1), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n20_), .c(new_n46_), .O(new_n48_));
  aoi21  g33(.a(x2), .b(x0), .c(x3), .O(new_n49_));
  oai22  g34(.a(new_n49_), .b(x1), .c(new_n48_), .d(x0), .O(z4));
  nand2  g35(.a(new_n40_), .b(new_n17_), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(x2), .c(new_n19_), .O(new_n52_));
  oai21  g37(.a(x4), .b(new_n19_), .c(new_n30_), .O(new_n53_));
  ...
  nor2   g41(.a(new_n20_), .b(x1), .O(new_n57_));
  aoi21  g42(.a(new_n35_), .b(new_n17_), .c(new_n57_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z5));
  inv1   g44(.a(new_n21_), .O(new_n60_));
  nand2  g45(.a(x3), .b(x1), .O(new_n61_));
  nand3  g46(.a(new_n40_), .b(new_n20_), .c(new_n19_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n61_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n60_), .c(x2), .O(new_n64_));
  nand2  g49(.a(x4), .b(new_n20_), .O(new_n65_));
  nand4  g50(.a(new_n65_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n66_));
