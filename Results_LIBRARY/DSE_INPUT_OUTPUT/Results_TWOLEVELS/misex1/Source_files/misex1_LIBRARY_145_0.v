...
module FAU ( 
  ...
  aoi21  g23(.a(new_n23_), .b(new_n16_), .c(new_n17_), .O(new_n39_));
  aoi21  g24(.a(new_n28_), .b(x1), .c(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x0), .c(new_n32_), .O(z4));
  inv1   g26(.a(new_n24_), .O(new_n42_));
  aoi21  g27(.a(new_n23_), .b(new_n16_), .c(x0), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n42_), .c(x3), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n29_), .O(z5));
