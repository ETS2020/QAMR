...
module FAU ( 
  ...
  oai21  g13(.a(new_n25_), .b(x2), .c(new_n20_), .O(new_n29_));
  nand3  g14(.a(new_n29_), .b(x1), .c(new_n17_), .O(new_n30_));
  ...
  nand2  g20(.a(new_n20_), .b(x2), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(new_n33_), .c(new_n35_), .O(z3));
  ...
  nand2  g30(.a(new_n41_), .b(new_n39_), .O(z5));
endmodule
