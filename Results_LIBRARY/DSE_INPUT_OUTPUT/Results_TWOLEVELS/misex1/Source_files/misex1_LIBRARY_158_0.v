...
module FAU ( 
  ...
  nand3  g31(.a(x7), .b(new_n26_), .c(new_n25_), .O(new_n47_));
  nor3   g32(.a(new_n47_), .b(new_n16_), .c(x1), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(new_n17_), .O(new_n49_));
  nand3  g34(.a(new_n21_), .b(new_n19_), .c(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(z3));
  xor2a  g36(.a(x3), .b(x2), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x0), .O(new_n53_));
  aoi21  g38(.a(new_n37_), .b(new_n35_), .c(x3), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n27_), .c(new_n17_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n53_), .c(x7), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n24_), .O(new_n57_));
  aoi21  g42(.a(new_n25_), .b(x2), .c(new_n24_), .O(new_n58_));
  nand4  g43(.a(x7), .b(x6), .c(new_n25_), .d(new_n16_), .O(new_n59_));
  ...
  nand4  g49(.a(x6), .b(new_n25_), .c(new_n16_), .d(new_n17_), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(x7), .O(new_n67_));
  nand2  g52(.a(new_n58_), .b(new_n17_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n67_), .O(z5));
  nand4  g54(.a(new_n26_), .b(new_n25_), .c(x2), .d(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n53_), .c(x7), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n24_), .O(new_n72_));
  oai21  g57(.a(x4), .b(x2), .c(new_n25_), .O(new_n73_));
