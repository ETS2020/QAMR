...
module FAU ( 
  ...
  oai22  g12(.a(new_n27_), .b(new_n17_), .c(new_n26_), .d(x3), .O(new_n28_));
  ...
  inv1   g36(.a(new_n31_), .O(new_n52_));
  nand2  g37(.a(new_n18_), .b(x2), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n52_), .c(new_n20_), .O(new_n54_));
  aoi21  g39(.a(new_n37_), .b(new_n23_), .c(x0), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n17_), .O(new_n56_));
  inv1   g41(.a(x7), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(x2), .c(new_n18_), .O(new_n58_));
  aoi21  g43(.a(new_n25_), .b(x3), .c(x2), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(x1), .O(new_n60_));
  nand3  g45(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n20_), .c(new_n32_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n56_), .O(z4));
  nor2   g49(.a(new_n23_), .b(x0), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n54_), .c(new_n17_), .O(new_n66_));
  ...
  oai21  g56(.a(new_n25_), .b(x3), .c(new_n16_), .O(new_n72_));
  aoi21  g57(.a(new_n72_), .b(new_n38_), .c(x0), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n57_), .c(x1), .O(new_n74_));
