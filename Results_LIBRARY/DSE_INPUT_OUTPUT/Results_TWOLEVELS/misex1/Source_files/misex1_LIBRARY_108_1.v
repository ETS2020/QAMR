...
module FAU ( 
  ...
  nand3  g26(.a(new_n41_), .b(new_n18_), .c(x1), .O(new_n42_));
  nor2   g27(.a(x6), .b(x5), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n16_), .c(x2), .d(new_n23_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n17_), .O(new_n46_));
  nor2   g31(.a(x6), .b(x3), .O(new_n47_));
  nand4  g32(.a(new_n47_), .b(x2), .c(new_n23_), .d(x0), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(z3));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n16_), .b(x2), .c(new_n17_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n24_), .c(new_n23_), .O(new_n54_));
  nand2  g39(.a(new_n16_), .b(x2), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(x1), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n54_), .O(z4));
  nand3  g42(.a(new_n26_), .b(x2), .c(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n51_), .c(new_n24_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n23_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n56_), .O(z5));
  nand4  g46(.a(new_n25_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n51_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n24_), .c(new_n23_), .O(new_n64_));
