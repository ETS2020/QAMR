...
module FAU ( 
  ...
  nand3  g19(.a(new_n25_), .b(x3), .c(x1), .O(new_n35_));
  ...
  nand3  g28(.a(new_n25_), .b(new_n17_), .c(x1), .O(new_n44_));
  nand3  g29(.a(new_n37_), .b(x2), .c(new_n16_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x0), .O(new_n46_));
  nand3  g31(.a(x2), .b(new_n16_), .c(x0), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(new_n21_), .O(new_n49_));
  nor3   g34(.a(x7), .b(x2), .c(x0), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x4), .c(x1), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(z3));
  aoi21  g37(.a(new_n32_), .b(new_n22_), .c(new_n24_), .O(new_n53_));
  aoi21  g38(.a(x3), .b(new_n17_), .c(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n16_), .O(new_n55_));
  nor2   g40(.a(x3), .b(new_n17_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x0), .c(new_n25_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(x1), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n55_), .O(z4));
  nand3  g44(.a(x6), .b(new_n21_), .c(new_n17_), .O(new_n60_));
  ...
  nand4  g48(.a(new_n37_), .b(new_n21_), .c(x2), .d(new_n24_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n53_), .c(new_n16_), .O(new_n66_));
  nor2   g51(.a(new_n56_), .b(x4), .O(new_n67_));
