...
module FAU ( 
  ...
  oai21  g25(.a(new_n40_), .b(x1), .c(new_n33_), .O(z4));
  nand2  g26(.a(new_n38_), .b(x0), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n25_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n19_), .O(new_n44_));
  nand4  g29(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(z5));
  nand2  g31(.a(new_n42_), .b(new_n29_), .O(new_n47_));
