...
module FAU ( 
  ...
  oai21  g41(.a(new_n16_), .b(x0), .c(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(x3), .O(new_n58_));
  oai21  g43(.a(x4), .b(new_n17_), .c(x1), .O(new_n59_));
  nand2  g44(.a(x6), .b(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n20_), .c(new_n22_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n58_), .c(new_n56_), .O(z5));
