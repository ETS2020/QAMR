...
module FAU ( 
  ...
  oai21  g30(.a(x3), .b(new_n21_), .c(x1), .O(new_n46_));
  nand2  g31(.a(x6), .b(new_n21_), .O(new_n47_));
  oai21  g32(.a(new_n34_), .b(x1), .c(new_n47_), .O(new_n48_));
  ...
  nor2   g36(.a(new_n51_), .b(new_n21_), .O(new_n52_));
  aoi21  g37(.a(new_n29_), .b(new_n21_), .c(new_n52_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x0), .c(new_n17_), .O(z5));
  aoi21  g39(.a(new_n22_), .b(x2), .c(x0), .O(new_n55_));
  oai21  g40(.a(x4), .b(x2), .c(new_n26_), .O(new_n56_));
