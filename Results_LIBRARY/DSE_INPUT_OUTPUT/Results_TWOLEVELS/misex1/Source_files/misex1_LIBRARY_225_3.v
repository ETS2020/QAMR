...
module FAU ( 
  ...
  nor2   g09(.a(new_n24_), .b(new_n19_), .O(new_n25_));
  ...
  aoi22  g15(.a(new_n30_), .b(new_n19_), .c(new_n25_), .d(new_n23_), .O(new_n31_));
  ...
  nand2  g32(.a(new_n25_), .b(new_n23_), .O(new_n48_));
  oai21  g33(.a(x3), .b(new_n19_), .c(x1), .O(new_n49_));
  aoi21  g34(.a(new_n36_), .b(new_n34_), .c(x1), .O(new_n50_));
  nor2   g35(.a(new_n35_), .b(x2), .O(new_n51_));
  ...
  nand2  g39(.a(new_n54_), .b(new_n42_), .O(z4));
  aoi21  g40(.a(x5), .b(new_n23_), .c(x3), .O(new_n56_));
  nor2   g41(.a(new_n56_), .b(new_n19_), .O(new_n57_));
  aoi21  g42(.a(new_n30_), .b(new_n19_), .c(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(x0), .c(new_n22_), .O(z5));
  nand3  g44(.a(x3), .b(new_n19_), .c(x0), .O(new_n60_));
  nand3  g45(.a(new_n24_), .b(x2), .c(new_n16_), .O(new_n61_));
