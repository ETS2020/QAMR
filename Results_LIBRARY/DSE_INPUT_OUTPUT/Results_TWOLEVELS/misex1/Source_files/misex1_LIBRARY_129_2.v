...
module FAU ( 
  ...
  nor2   g15(.a(x1), .b(new_n20_), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(new_n22_), .c(new_n16_), .O(new_n32_));
  ...
  nand4  g31(.a(new_n34_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n47_));
  ...
  nor2   g36(.a(x7), .b(new_n18_), .O(new_n52_));
  aoi21  g37(.a(new_n51_), .b(new_n31_), .c(new_n52_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n49_), .O(z3));
  inv1   g39(.a(new_n52_), .O(new_n55_));
  nand2  g40(.a(new_n22_), .b(new_n16_), .O(new_n56_));
  aoi21  g41(.a(new_n50_), .b(new_n56_), .c(new_n20_), .O(new_n57_));
  oai21  g42(.a(x7), .b(new_n18_), .c(x2), .O(new_n58_));
  nand3  g43(.a(new_n27_), .b(new_n18_), .c(new_n16_), .O(new_n59_));
  ...
  nand3  g51(.a(new_n66_), .b(new_n61_), .c(new_n55_), .O(z4));
  aoi21  g52(.a(new_n26_), .b(new_n20_), .c(new_n57_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(x1), .c(new_n66_), .O(z5));
  nand4  g54(.a(new_n34_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n57_), .c(new_n17_), .O(new_n72_));
  oai21  g57(.a(new_n44_), .b(x2), .c(new_n21_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(x1), .c(new_n20_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(new_n72_), .c(new_n55_), .O(z6));
endmodule
