...
module FAU ( 
  ...
  nand3  g30(.a(new_n28_), .b(new_n16_), .c(x1), .O(new_n46_));
  nand2  g31(.a(new_n34_), .b(new_n19_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n20_), .c(new_n17_), .O(new_n49_));
  inv1   g34(.a(x7), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n16_), .c(x1), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n49_), .c(new_n45_), .O(z3));
  aoi21  g37(.a(new_n43_), .b(new_n23_), .c(new_n17_), .O(new_n53_));
  inv1   g38(.a(x5), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(x2), .c(new_n35_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(x3), .c(new_n26_), .O(new_n56_));
  ...
  aoi21  g45(.a(x1), .b(x0), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n57_), .b(x1), .c(new_n61_), .O(z4));
  nor2   g47(.a(new_n26_), .b(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n53_), .c(new_n19_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n61_), .O(z5));
  nand4  g50(.a(new_n54_), .b(new_n20_), .c(x2), .d(new_n17_), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n53_), .c(new_n19_), .O(new_n68_));
