...
module FAU ( 
  ...
  oai21  g12(.a(new_n20_), .b(x2), .c(new_n27_), .O(z1));
  ...
  oai21  g24(.a(new_n34_), .b(x1), .c(new_n39_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n17_), .O(new_n41_));
  nand3  g26(.a(x2), .b(new_n19_), .c(x0), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x3), .O(z3));
  aoi21  g28(.a(new_n20_), .b(x1), .c(new_n16_), .O(new_n44_));
  nor2   g29(.a(x6), .b(new_n19_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n19_), .c(x3), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n16_), .c(new_n44_), .O(new_n47_));
  ...
  oai21  g35(.a(new_n47_), .b(x0), .c(new_n50_), .O(z4));
  aoi21  g36(.a(x5), .b(new_n19_), .c(x3), .O(new_n52_));
  nor2   g37(.a(new_n52_), .b(new_n16_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n24_), .c(new_n17_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n48_), .O(z5));
  inv1   g40(.a(x4), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n20_), .c(new_n16_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n29_), .c(new_n19_), .O(new_n58_));
  nand3  g43(.a(new_n25_), .b(x2), .c(new_n19_), .O(new_n59_));
