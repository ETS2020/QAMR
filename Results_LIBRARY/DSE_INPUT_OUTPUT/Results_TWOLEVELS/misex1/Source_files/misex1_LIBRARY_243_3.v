...
module FAU ( 
  ...
  oai21  g20(.a(new_n35_), .b(new_n34_), .c(new_n17_), .O(new_n36_));
  oai21  g21(.a(new_n27_), .b(x2), .c(new_n17_), .O(new_n37_));
  ...
  nand3  g26(.a(new_n27_), .b(new_n24_), .c(x1), .O(new_n42_));
  nand2  g27(.a(new_n34_), .b(new_n16_), .O(new_n43_));
  ...
  nand3  g32(.a(new_n47_), .b(new_n45_), .c(new_n20_), .O(z3));
  nand2  g33(.a(x3), .b(new_n24_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n18_), .c(new_n21_), .O(new_n50_));
  ...
  aoi21  g39(.a(new_n17_), .b(x2), .c(new_n16_), .O(new_n55_));
  nand3  g40(.a(x6), .b(new_n17_), .c(new_n24_), .O(new_n56_));
  ...
  oai21  g45(.a(new_n60_), .b(new_n50_), .c(new_n16_), .O(new_n61_));
  nand2  g46(.a(x1), .b(x0), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n61_), .c(new_n58_), .O(z5));
  nand4  g48(.a(new_n51_), .b(new_n17_), .c(x2), .d(new_n21_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n50_), .c(new_n16_), .O(new_n66_));
