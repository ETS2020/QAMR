...
module FAU ( 
  ...
  aoi21  g43(.a(new_n57_), .b(new_n24_), .c(new_n58_), .O(new_n59_));
  oai21  g44(.a(x4), .b(x2), .c(new_n25_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(x1), .c(new_n17_), .O(new_n61_));
  oai21  g46(.a(new_n59_), .b(new_n20_), .c(new_n61_), .O(z4));
  nand3  g47(.a(new_n27_), .b(x2), .c(new_n17_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n55_), .c(x1), .O(new_n64_));
  nand3  g49(.a(new_n30_), .b(new_n16_), .c(new_n17_), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(x4), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n61_), .O(z5));
  nand3  g53(.a(new_n55_), .b(new_n39_), .c(x4), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n24_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n61_), .O(z6));
endmodule
