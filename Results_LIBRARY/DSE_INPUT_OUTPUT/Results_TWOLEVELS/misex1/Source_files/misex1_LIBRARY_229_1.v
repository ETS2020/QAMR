...
module FAU ( 
  ...
  nand3  g20(.a(new_n35_), .b(new_n19_), .c(new_n16_), .O(new_n36_));
  oai21  g21(.a(new_n24_), .b(x2), .c(new_n19_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(x1), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n36_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n17_), .O(new_n40_));
  nor2   g25(.a(new_n19_), .b(x1), .O(new_n41_));
  inv1   g26(.a(new_n41_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(z2));
  nand2  g28(.a(x2), .b(new_n16_), .O(new_n44_));
  oai21  g29(.a(x4), .b(x3), .c(x7), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n18_), .c(x1), .O(new_n46_));
  nand2  g31(.a(new_n31_), .b(new_n19_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n44_), .c(new_n46_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n17_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n21_), .O(z3));
  aoi21  g35(.a(new_n19_), .b(x2), .c(new_n16_), .O(new_n51_));
  oai21  g36(.a(new_n33_), .b(x2), .c(x1), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n19_), .c(new_n51_), .O(new_n53_));
  nand4  g38(.a(new_n19_), .b(x2), .c(new_n16_), .d(x0), .O(new_n54_));
  oai21  g39(.a(new_n53_), .b(x0), .c(new_n54_), .O(z4));
  nand2  g40(.a(new_n31_), .b(new_n17_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(x2), .c(new_n16_), .O(new_n57_));
  oai21  g42(.a(x4), .b(new_n16_), .c(new_n33_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n18_), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n19_), .O(new_n61_));
  nand3  g46(.a(new_n37_), .b(x1), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n61_), .c(new_n42_), .O(z5));
  nand2  g48(.a(x3), .b(x1), .O(new_n64_));
  nand3  g49(.a(new_n31_), .b(new_n19_), .c(new_n16_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n64_), .c(x0), .O(new_n66_));
  nand3  g51(.a(new_n19_), .b(new_n16_), .c(x0), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(x2), .O(new_n69_));
  nand2  g54(.a(x4), .b(new_n19_), .O(new_n70_));
  nand4  g55(.a(new_n70_), .b(new_n18_), .c(x1), .d(new_n17_), .O(new_n71_));
