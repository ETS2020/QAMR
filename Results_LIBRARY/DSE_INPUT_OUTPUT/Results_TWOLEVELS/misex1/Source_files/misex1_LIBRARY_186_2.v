...
module FAU ( 
  ...
  oai21  g37(.a(new_n52_), .b(new_n32_), .c(new_n51_), .O(z3));
  aoi21  g38(.a(new_n52_), .b(new_n33_), .c(new_n20_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n16_), .c(x0), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n17_), .O(new_n56_));
  nor2   g41(.a(x3), .b(new_n16_), .O(new_n57_));
  nor2   g42(.a(new_n57_), .b(new_n36_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n20_), .c(new_n36_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n17_), .c(new_n56_), .O(z4));
  aoi21  g45(.a(new_n24_), .b(new_n23_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n54_), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n58_), .b(x1), .c(new_n20_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z5));
  nand3  g49(.a(new_n48_), .b(x2), .c(new_n20_), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n54_), .c(new_n17_), .O(new_n67_));
  aoi21  g52(.a(new_n40_), .b(new_n16_), .c(x3), .O(new_n68_));
