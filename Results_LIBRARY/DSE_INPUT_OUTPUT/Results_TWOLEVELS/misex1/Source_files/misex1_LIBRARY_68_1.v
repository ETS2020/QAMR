...
module FAU ( 
  ...
  nand3  g16(.a(new_n26_), .b(new_n16_), .c(new_n21_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n30_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n17_), .O(new_n34_));
  nand3  g19(.a(new_n18_), .b(x3), .c(new_n30_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n34_), .O(z2));
  nand3  g21(.a(new_n24_), .b(new_n16_), .c(new_n30_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(x7), .c(new_n21_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(x2), .c(new_n17_), .O(new_n39_));
  nand3  g24(.a(new_n18_), .b(new_n16_), .c(x2), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(z3));
  xor2a  g26(.a(x3), .b(x2), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(x0), .O(new_n43_));
  nand4  g28(.a(new_n26_), .b(new_n16_), .c(new_n30_), .d(new_n17_), .O(new_n44_));
  ...
  nand2  g33(.a(new_n48_), .b(new_n31_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n30_), .c(new_n17_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n46_), .O(z4));
  nand3  g36(.a(new_n42_), .b(new_n21_), .c(x0), .O(new_n52_));
  nand3  g37(.a(new_n48_), .b(new_n31_), .c(new_n30_), .O(new_n53_));
  ...
  oai21  g42(.a(new_n57_), .b(x0), .c(new_n52_), .O(z6));
endmodule
