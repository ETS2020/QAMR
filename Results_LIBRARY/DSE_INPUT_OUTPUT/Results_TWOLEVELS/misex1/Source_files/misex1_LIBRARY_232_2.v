...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(new_n18_), .c(new_n20_), .O(new_n38_));
  nand2  g23(.a(x3), .b(new_n16_), .O(new_n39_));
  inv1   g24(.a(new_n39_), .O(new_n40_));
  nor2   g25(.a(x1), .b(new_n17_), .O(new_n41_));
  aoi22  g26(.a(new_n41_), .b(new_n40_), .c(new_n19_), .d(x1), .O(new_n42_));
  oai21  g27(.a(new_n38_), .b(x0), .c(new_n42_), .O(z2));
  nor2   g28(.a(x5), .b(x3), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(x2), .c(new_n18_), .O(new_n45_));
  inv1   g30(.a(x7), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(x3), .c(new_n16_), .d(x1), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n17_), .O(new_n49_));
  nand3  g34(.a(new_n41_), .b(new_n19_), .c(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(z3));
  nand2  g36(.a(new_n19_), .b(x2), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n39_), .c(new_n17_), .O(new_n53_));
  aoi21  g38(.a(x3), .b(new_n16_), .c(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n18_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n21_), .O(z4));
  oai21  g41(.a(new_n53_), .b(new_n28_), .c(new_n18_), .O(new_n57_));
  oai21  g42(.a(new_n19_), .b(new_n17_), .c(x1), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(z5));
  nand3  g44(.a(new_n44_), .b(x2), .c(new_n17_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n53_), .c(new_n18_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n21_), .O(z6));
endmodule
