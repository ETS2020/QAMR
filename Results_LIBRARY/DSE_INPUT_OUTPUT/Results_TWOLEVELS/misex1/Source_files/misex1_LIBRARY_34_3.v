...
module FAU ( 
  ...
  aoi22  g17(.a(new_n32_), .b(new_n30_), .c(x4), .d(x1), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n29_), .O(z1));
  nand3  g19(.a(new_n21_), .b(x3), .c(x1), .O(new_n35_));
  ...
  aoi21  g26(.a(new_n41_), .b(new_n17_), .c(new_n36_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(x0), .c(new_n33_), .O(z2));
  nand2  g28(.a(x7), .b(x3), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n21_), .c(new_n16_), .d(x1), .O(new_n45_));
  ...
  nand3  g34(.a(new_n30_), .b(new_n18_), .c(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(z3));
  nand2  g36(.a(new_n18_), .b(x2), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n31_), .c(new_n20_), .O(new_n53_));
  ...
  nor2   g41(.a(new_n56_), .b(x4), .O(new_n57_));
  ...
  oai21  g46(.a(new_n61_), .b(new_n53_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n58_), .O(z5));
  nand3  g48(.a(new_n46_), .b(x2), .c(new_n20_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n53_), .c(new_n17_), .O(new_n66_));
  oai21  g51(.a(new_n56_), .b(x0), .c(new_n21_), .O(new_n67_));
