...
module FAU ( 
  ...
  oai21  g10(.a(x6), .b(new_n19_), .c(new_n25_), .O(new_n26_));
  ...
  nand3  g31(.a(new_n46_), .b(new_n28_), .c(x1), .O(new_n47_));
  nand4  g32(.a(new_n25_), .b(new_n19_), .c(x2), .d(new_n16_), .O(new_n48_));
  ...
  nand3  g37(.a(new_n52_), .b(new_n18_), .c(new_n16_), .O(new_n53_));
  ...
  nand3  g45(.a(new_n18_), .b(x3), .c(new_n28_), .O(new_n61_));
  ...
  nand4  g53(.a(new_n25_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n63_), .c(new_n18_), .O(new_n70_));
