...
module FAU ( 
  ...
  oai21  g19(.a(new_n34_), .b(new_n20_), .c(new_n17_), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n30_), .O(z2));
  ...
  oai21  g25(.a(x1), .b(new_n17_), .c(x2), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n19_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(z3));
  xor2a  g28(.a(x3), .b(x2), .O(new_n44_));
  nor2   g29(.a(new_n16_), .b(x0), .O(new_n45_));
  aoi21  g30(.a(new_n44_), .b(x0), .c(new_n45_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(x1), .c(new_n21_), .O(z4));
  nand2  g32(.a(new_n44_), .b(x0), .O(new_n48_));
  nand3  g33(.a(new_n25_), .b(x2), .c(new_n17_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n21_), .O(z5));
  nand3  g37(.a(new_n32_), .b(x2), .c(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n48_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n18_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n21_), .O(z6));
endmodule
