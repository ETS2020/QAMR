...
module FAU ( 
  ...
  nor2   g06(.a(new_n17_), .b(new_n19_), .O(new_n22_));
  nand3  g07(.a(new_n22_), .b(x1), .c(new_n16_), .O(new_n23_));
  oai21  g08(.a(new_n21_), .b(new_n16_), .c(new_n23_), .O(z0));
  inv1   g09(.a(x1), .O(new_n25_));
  nand2  g10(.a(new_n19_), .b(new_n25_), .O(new_n26_));
  oai21  g11(.a(new_n26_), .b(new_n17_), .c(x5), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(x0), .O(new_n28_));
  nor2   g13(.a(x5), .b(x3), .O(new_n29_));
  nor3   g14(.a(new_n29_), .b(new_n19_), .c(x1), .O(new_n30_));
  ...
  nand2  g33(.a(new_n29_), .b(new_n20_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n16_), .O(new_n51_));
  nor2   g36(.a(new_n18_), .b(x3), .O(new_n52_));
  nand4  g37(.a(new_n52_), .b(x2), .c(new_n25_), .d(x0), .O(new_n53_));
  ...
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(new_n18_), .O(new_n58_));
  oai21  g43(.a(new_n18_), .b(x3), .c(x2), .O(new_n59_));
  nand3  g44(.a(new_n38_), .b(new_n17_), .c(new_n19_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n59_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n58_), .c(new_n25_), .O(new_n62_));
  oai21  g47(.a(x3), .b(new_n19_), .c(x1), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n17_), .c(new_n19_), .O(new_n64_));
  ...
  oai21  g53(.a(new_n68_), .b(new_n16_), .c(new_n57_), .O(new_n69_));
  aoi22  g54(.a(new_n69_), .b(x5), .c(new_n22_), .d(new_n16_), .O(new_n70_));
  nor2   g55(.a(x5), .b(new_n16_), .O(new_n71_));
  aoi21  g56(.a(new_n65_), .b(new_n16_), .c(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n70_), .b(x1), .c(new_n72_), .O(z5));
  aoi21  g58(.a(new_n55_), .b(new_n25_), .c(new_n18_), .O(new_n74_));
  nand2  g59(.a(x3), .b(x1), .O(new_n75_));
  nand2  g60(.a(new_n29_), .b(new_n25_), .O(new_n76_));
  aoi21  g61(.a(new_n76_), .b(new_n75_), .c(new_n19_), .O(new_n77_));
  oai21  g62(.a(new_n31_), .b(x3), .c(new_n19_), .O(new_n78_));
  nor2   g63(.a(new_n78_), .b(new_n25_), .O(new_n79_));
  oai21  g64(.a(new_n79_), .b(new_n77_), .c(new_n16_), .O(new_n80_));
  oai21  g65(.a(new_n74_), .b(new_n16_), .c(new_n80_), .O(z6));
endmodule
