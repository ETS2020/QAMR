...
module FAU ( 
  ...
  nand4  g08(.a(x5), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n24_));
  ...
  nand3  g15(.a(new_n30_), .b(new_n22_), .c(new_n17_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n26_), .O(z1));
  inv1   g17(.a(x6), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n16_), .c(new_n21_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n29_), .c(x2), .O(new_n35_));
  inv1   g20(.a(x5), .O(new_n36_));
  nand4  g21(.a(new_n36_), .b(new_n16_), .c(x2), .d(new_n21_), .O(new_n37_));
  inv1   g22(.a(new_n37_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(new_n35_), .c(new_n17_), .O(new_n39_));
  nand3  g24(.a(new_n18_), .b(x3), .c(new_n22_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(z2));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n22_), .c(x1), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n37_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  nand3  g30(.a(new_n18_), .b(new_n16_), .c(x2), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(z3));
  xor2a  g32(.a(x3), .b(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  nand2  g34(.a(x6), .b(new_n22_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n16_), .c(new_n17_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n21_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n31_), .O(z4));
  nand2  g39(.a(new_n49_), .b(new_n24_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n21_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n31_), .O(z5));
  nand4  g42(.a(new_n36_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n49_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n21_), .O(new_n60_));
  nand2  g45(.a(x4), .b(new_n16_), .O(new_n61_));
  nand4  g46(.a(new_n61_), .b(new_n22_), .c(x1), .d(new_n17_), .O(new_n62_));
  nand2  g47(.a(x3), .b(x2), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n62_), .c(new_n60_), .O(z6));
endmodule
