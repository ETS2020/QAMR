...
module FAU ( 
  ...
  oai21  g20(.a(x1), .b(new_n17_), .c(x3), .O(new_n36_));
  ...
  oai21  g27(.a(x1), .b(new_n17_), .c(x2), .O(new_n43_));
  ...
  aoi21  g32(.a(new_n46_), .b(x0), .c(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x1), .c(new_n21_), .O(z4));
  nand2  g34(.a(new_n46_), .b(x0), .O(new_n50_));
  nand3  g35(.a(new_n25_), .b(x2), .c(new_n17_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  aoi22  g38(.a(new_n20_), .b(new_n17_), .c(new_n19_), .d(new_n16_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(z5));
  nand3  g40(.a(new_n32_), .b(x2), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n50_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n18_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n21_), .O(z6));
endmodule
