...
module FAU ( 
  ...
  nand4  g12(.a(new_n25_), .b(new_n16_), .c(new_n24_), .d(x0), .O(new_n28_));
  ...
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n25_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  aoi21  g43(.a(new_n31_), .b(x2), .c(new_n24_), .O(new_n59_));
  nand4  g44(.a(x6), .b(new_n25_), .c(new_n31_), .d(new_n16_), .O(new_n60_));
  ...
  nand3  g49(.a(x3), .b(x2), .c(new_n17_), .O(new_n65_));
  oai21  g50(.a(new_n64_), .b(new_n17_), .c(new_n65_), .O(new_n66_));
  nand4  g51(.a(x6), .b(new_n31_), .c(new_n16_), .d(new_n17_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  aoi21  g53(.a(new_n66_), .b(new_n24_), .c(new_n68_), .O(new_n69_));
  nand2  g54(.a(new_n59_), .b(new_n17_), .O(new_n70_));
  oai21  g55(.a(new_n69_), .b(x5), .c(new_n70_), .O(z5));
  nand3  g56(.a(new_n31_), .b(x2), .c(new_n17_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n54_), .c(new_n25_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n24_), .O(new_n74_));
  oai21  g59(.a(x4), .b(x2), .c(new_n31_), .O(new_n75_));
