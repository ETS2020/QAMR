...
module FAU ( 
  ...
  nand3  g16(.a(new_n23_), .b(new_n22_), .c(new_n16_), .O(new_n32_));
  ...
  nand3  g21(.a(new_n36_), .b(new_n26_), .c(x1), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n34_), .c(x0), .O(z2));
  aoi21  g23(.a(x5), .b(new_n17_), .c(x3), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(new_n26_), .c(new_n16_), .O(new_n40_));
  oai21  g25(.a(new_n36_), .b(new_n16_), .c(x7), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n26_), .c(new_n17_), .O(new_n42_));
  ...
  oai21  g32(.a(new_n23_), .b(x1), .c(new_n22_), .O(new_n48_));
  ...
  nand2  g36(.a(new_n51_), .b(new_n19_), .O(z4));
  nand3  g37(.a(x2), .b(new_n16_), .c(x0), .O(new_n53_));
  nand4  g38(.a(new_n44_), .b(new_n26_), .c(x1), .d(new_n17_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n22_), .O(new_n56_));
  nand2  g41(.a(new_n50_), .b(new_n17_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n56_), .O(z5));
  aoi21  g43(.a(new_n32_), .b(new_n31_), .c(new_n26_), .O(new_n59_));
  oai21  g44(.a(new_n44_), .b(x3), .c(new_n26_), .O(new_n60_));
  nor2   g45(.a(new_n60_), .b(new_n16_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n19_), .O(z6));
endmodule
