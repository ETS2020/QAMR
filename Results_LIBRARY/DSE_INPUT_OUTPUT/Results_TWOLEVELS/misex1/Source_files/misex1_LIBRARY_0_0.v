...
module FAU ( 
  ...
  aoi21  g25(.a(new_n21_), .b(new_n20_), .c(new_n29_), .O(new_n41_));
  aoi21  g26(.a(new_n26_), .b(x1), .c(new_n41_), .O(new_n42_));
  oai21  g27(.a(x2), .b(new_n16_), .c(x3), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n20_), .O(new_n44_));
  oai21  g29(.a(new_n42_), .b(x0), .c(new_n44_), .O(z5));
