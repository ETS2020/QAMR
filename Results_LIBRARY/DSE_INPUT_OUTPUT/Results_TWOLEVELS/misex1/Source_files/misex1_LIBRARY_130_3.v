...
module FAU ( 
  ...
  nand3  g16(.a(new_n31_), .b(new_n21_), .c(new_n16_), .O(new_n32_));
  ...
  nand2  g23(.a(new_n21_), .b(x1), .O(new_n39_));
  ...
  aoi22  g36(.a(new_n51_), .b(new_n31_), .c(x6), .d(x3), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n49_), .O(z3));
  nand3  g38(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n54_));
  aoi21  g39(.a(new_n50_), .b(new_n54_), .c(new_n20_), .O(new_n55_));
  xor2a  g40(.a(x3), .b(x2), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x6), .c(new_n50_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n20_), .c(new_n55_), .O(new_n58_));
  ...
  aoi21  g49(.a(new_n27_), .b(new_n20_), .c(new_n55_), .O(new_n65_));
  oai21  g50(.a(x2), .b(x0), .c(new_n18_), .O(new_n66_));
  aoi22  g51(.a(new_n66_), .b(x6), .c(new_n60_), .d(new_n20_), .O(new_n67_));
  ...
  oai21  g56(.a(new_n44_), .b(x2), .c(new_n25_), .O(new_n72_));
