...
module FAU ( 
  ...
  nand3  g37(.a(new_n52_), .b(new_n51_), .c(x6), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n26_), .O(new_n54_));
  aoi21  g39(.a(new_n29_), .b(x2), .c(new_n26_), .O(new_n55_));
  aoi21  g40(.a(new_n21_), .b(new_n16_), .c(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x0), .c(new_n54_), .O(z4));
  nand2  g42(.a(new_n35_), .b(new_n29_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x2), .c(new_n17_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n51_), .c(x1), .O(new_n60_));
  nor3   g45(.a(x3), .b(x2), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n60_), .c(x6), .O(new_n62_));
  nand2  g47(.a(new_n55_), .b(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z5));
  nand4  g49(.a(new_n35_), .b(new_n29_), .c(x2), .d(new_n17_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n51_), .c(x6), .O(new_n66_));
