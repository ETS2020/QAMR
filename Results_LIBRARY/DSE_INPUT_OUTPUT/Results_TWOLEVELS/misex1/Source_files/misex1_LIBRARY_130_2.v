...
module FAU ( 
  ...
  nor2   g35(.a(x6), .b(new_n18_), .O(new_n51_));
  aoi21  g36(.a(new_n50_), .b(new_n30_), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n49_), .O(z3));
  oai21  g38(.a(new_n50_), .b(new_n31_), .c(x0), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(x6), .b(new_n18_), .c(x2), .O(new_n56_));
  inv1   g41(.a(x6), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n18_), .c(new_n16_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n56_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n55_), .c(new_n17_), .O(new_n60_));
  ...
  inv1   g51(.a(new_n51_), .O(new_n67_));
  nand2  g52(.a(new_n26_), .b(new_n20_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n54_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n65_), .c(new_n67_), .O(z5));
  nand4  g56(.a(new_n34_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n54_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n17_), .O(new_n74_));
  oai21  g59(.a(new_n44_), .b(x2), .c(new_n21_), .O(new_n75_));
