...
module FAU ( 
  ...
  nand4  g26(.a(new_n41_), .b(new_n24_), .c(new_n16_), .d(x1), .O(new_n42_));
  ...
  nand2  g31(.a(new_n18_), .b(x0), .O(new_n47_));
  ...
  nor2   g40(.a(new_n24_), .b(x2), .O(new_n56_));
  aoi21  g41(.a(new_n55_), .b(new_n17_), .c(new_n56_), .O(new_n57_));
  oai21  g42(.a(new_n53_), .b(x1), .c(new_n57_), .O(z4));
  nor2   g43(.a(new_n28_), .b(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n51_), .c(new_n18_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(z5));
  nand3  g46(.a(new_n43_), .b(x2), .c(new_n17_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n51_), .c(new_n18_), .O(new_n64_));
  nor2   g49(.a(new_n54_), .b(new_n18_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n17_), .c(new_n56_), .O(new_n66_));
