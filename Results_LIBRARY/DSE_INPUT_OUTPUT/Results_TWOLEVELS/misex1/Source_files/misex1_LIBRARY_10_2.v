...
module FAU ( 
  ...
  oai21  g38(.a(new_n21_), .b(x1), .c(new_n20_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(x2), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n30_), .c(x0), .O(z5));
  nor2   g41(.a(new_n20_), .b(new_n19_), .O(new_n57_));
  nor2   g42(.a(new_n22_), .b(x1), .O(new_n58_));
