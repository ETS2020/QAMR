...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n25_), .c(new_n20_), .O(new_n34_));
  aoi21  g19(.a(new_n34_), .b(new_n32_), .c(x0), .O(new_n35_));
  nand3  g20(.a(x3), .b(new_n20_), .c(x0), .O(new_n36_));
  ...
  nand2  g27(.a(new_n42_), .b(new_n30_), .O(z3));
  nand2  g28(.a(x3), .b(x2), .O(new_n44_));
  nand3  g29(.a(new_n33_), .b(new_n25_), .c(new_n21_), .O(new_n45_));
