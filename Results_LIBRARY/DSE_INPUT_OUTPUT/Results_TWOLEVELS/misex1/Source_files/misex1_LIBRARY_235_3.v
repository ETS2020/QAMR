...
module FAU ( 
  ...
  aoi21  g41(.a(new_n16_), .b(x2), .c(new_n32_), .O(new_n57_));
  ...
  oai21  g47(.a(new_n62_), .b(new_n52_), .c(new_n32_), .O(new_n63_));
  nand2  g48(.a(x1), .b(x0), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n60_), .O(z5));
  nand3  g50(.a(new_n45_), .b(x2), .c(new_n20_), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n52_), .c(new_n32_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n16_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x1), .c(new_n20_), .O(new_n70_));
