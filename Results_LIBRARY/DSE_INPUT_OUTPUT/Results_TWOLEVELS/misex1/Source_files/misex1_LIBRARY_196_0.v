...
module FAU ( 
  ...
  oai21  g14(.a(x1), .b(new_n17_), .c(x3), .O(new_n30_));
  ...
  oai21  g20(.a(new_n35_), .b(new_n20_), .c(new_n17_), .O(new_n36_));
  nand4  g21(.a(x3), .b(new_n16_), .c(new_n18_), .d(x0), .O(new_n37_));
