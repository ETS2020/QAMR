...
module FAU ( 
  ...
  nand2  g29(.a(new_n35_), .b(x7), .O(new_n45_));
  ...
  oai21  g36(.a(new_n51_), .b(x2), .c(new_n17_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n50_), .c(x1), .O(new_n53_));
  nand4  g38(.a(x6), .b(new_n26_), .c(new_n16_), .d(new_n17_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(x5), .O(new_n56_));
  aoi21  g41(.a(new_n26_), .b(x2), .c(new_n24_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z4));
  nand2  g44(.a(x2), .b(new_n17_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n50_), .c(x5), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n24_), .O(new_n62_));
  nand4  g47(.a(x6), .b(x5), .c(new_n26_), .d(new_n16_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n57_), .c(new_n17_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n62_), .O(z5));
  aoi21  g51(.a(new_n49_), .b(x0), .c(new_n20_), .O(new_n67_));
