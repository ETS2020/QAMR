...
module FAU ( 
  ...
  nand2  g42(.a(new_n57_), .b(new_n51_), .O(z4));
  aoi21  g43(.a(x5), .b(new_n19_), .c(x3), .O(new_n59_));
  nor2   g44(.a(new_n59_), .b(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n30_), .b(new_n16_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n51_), .O(z5));
  inv1   g47(.a(new_n21_), .O(new_n63_));
  nand2  g48(.a(x3), .b(x1), .O(new_n64_));
  nand2  g49(.a(new_n23_), .b(new_n19_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n64_), .c(x0), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n63_), .c(x2), .O(new_n67_));
  nand2  g52(.a(x4), .b(new_n20_), .O(new_n68_));
  nand4  g53(.a(new_n68_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n69_));
