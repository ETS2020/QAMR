...
module FAU ( 
  ...
  oai21  g18(.a(new_n33_), .b(new_n25_), .c(x7), .O(new_n34_));
  ...
  nand3  g23(.a(x7), .b(new_n26_), .c(x2), .O(new_n39_));
  ...
  aoi21  g27(.a(new_n40_), .b(new_n24_), .c(new_n42_), .O(new_n43_));
  ...
  nand3  g32(.a(x7), .b(new_n26_), .c(new_n25_), .O(new_n48_));
  ...
  nand4  g40(.a(new_n37_), .b(new_n25_), .c(new_n16_), .d(new_n17_), .O(new_n56_));
  nand4  g41(.a(new_n56_), .b(new_n55_), .c(new_n54_), .d(x7), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  aoi21  g43(.a(new_n25_), .b(x2), .c(new_n24_), .O(new_n59_));
  nand4  g44(.a(x7), .b(x6), .c(new_n25_), .d(new_n16_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n58_), .O(z4));
  nand3  g48(.a(new_n27_), .b(x2), .c(new_n17_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n54_), .c(x1), .O(new_n65_));
  nand4  g50(.a(x6), .b(new_n25_), .c(new_n16_), .d(new_n17_), .O(new_n66_));
  ...
  nand4  g55(.a(new_n26_), .b(new_n25_), .c(x2), .d(new_n17_), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(new_n54_), .c(x7), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n24_), .O(new_n73_));
