...
module FAU ( 
  ...
  nand4  g44(.a(x6), .b(x4), .c(new_n20_), .d(new_n16_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n37_), .c(new_n17_), .O(new_n62_));
  inv1   g47(.a(x4), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n16_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n62_), .c(new_n59_), .O(z5));
  ...
  nand4  g53(.a(new_n64_), .b(x3), .c(x1), .d(new_n17_), .O(new_n69_));
