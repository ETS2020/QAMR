...
module FAU ( 
  ...
  nand2  g16(.a(new_n21_), .b(new_n20_), .O(new_n32_));
  ...
  nand2  g23(.a(new_n28_), .b(x0), .O(new_n39_));
  ...
  nand3  g27(.a(new_n31_), .b(new_n21_), .c(x1), .O(new_n43_));
  nand3  g28(.a(new_n35_), .b(x2), .c(new_n16_), .O(new_n44_));
  ...
  oai21  g39(.a(new_n37_), .b(x3), .c(new_n25_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n20_), .c(new_n54_), .O(new_n56_));
  nand4  g41(.a(new_n23_), .b(new_n17_), .c(new_n21_), .d(new_n20_), .O(new_n57_));
  inv1   g42(.a(new_n57_), .O(new_n58_));
  aoi21  g43(.a(x3), .b(x1), .c(new_n58_), .O(new_n59_));
  ...
  nand4  g48(.a(new_n35_), .b(new_n17_), .c(x2), .d(new_n20_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n54_), .c(new_n16_), .O(new_n66_));
  oai21  g51(.a(new_n32_), .b(x4), .c(new_n17_), .O(new_n67_));
