...
module FAU ( 
  ...
  oai21  g24(.a(new_n39_), .b(new_n38_), .c(x3), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n27_), .O(z4));
  aoi21  g26(.a(new_n21_), .b(new_n20_), .c(new_n31_), .O(new_n42_));
  aoi21  g27(.a(new_n26_), .b(x1), .c(new_n42_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(x0), .c(new_n30_), .O(z5));
