...
module FAU ( 
  ...
  oai21  g18(.a(new_n31_), .b(x1), .c(x0), .O(new_n34_));
  ...
  nand3  g30(.a(new_n25_), .b(new_n16_), .c(x1), .O(new_n46_));
  nand2  g31(.a(new_n35_), .b(new_n19_), .O(new_n47_));
  ...
  aoi21  g37(.a(new_n43_), .b(new_n30_), .c(new_n17_), .O(new_n53_));
  ...
  nand3  g50(.a(new_n43_), .b(new_n30_), .c(new_n19_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x0), .O(new_n67_));
  nand2  g52(.a(x3), .b(x1), .O(new_n68_));
  nand3  g53(.a(new_n54_), .b(new_n20_), .c(new_n19_), .O(new_n69_));
