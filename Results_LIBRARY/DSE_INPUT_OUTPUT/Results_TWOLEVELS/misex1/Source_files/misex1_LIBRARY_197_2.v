...
module FAU ( 
  ...
  nand2  g54(.a(new_n34_), .b(x0), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n69_), .c(new_n66_), .O(z5));
  aoi21  g56(.a(new_n55_), .b(new_n19_), .c(new_n34_), .O(new_n72_));
  nand2  g57(.a(x3), .b(x1), .O(new_n73_));
  nand2  g58(.a(new_n26_), .b(new_n19_), .O(new_n74_));
  aoi21  g59(.a(new_n74_), .b(new_n73_), .c(new_n16_), .O(new_n75_));
  oai21  g60(.a(new_n28_), .b(x3), .c(new_n16_), .O(new_n76_));
  nor2   g61(.a(new_n76_), .b(new_n19_), .O(new_n77_));
