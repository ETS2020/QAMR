...
module FAU ( 
  ...
  nand3  g18(.a(new_n33_), .b(new_n21_), .c(x1), .O(new_n34_));
  ...
  aoi21  g30(.a(new_n16_), .b(new_n20_), .c(x7), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n17_), .c(new_n45_), .O(z3));
  ...
  aoi21  g35(.a(x3), .b(new_n16_), .c(x0), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n50_), .c(new_n17_), .O(new_n52_));
  aoi21  g37(.a(new_n18_), .b(x2), .c(x7), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n20_), .c(x7), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n17_), .c(new_n52_), .O(z4));
  ...
  nand3  g43(.a(new_n53_), .b(x1), .c(new_n20_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n58_), .O(z5));
  nand4  g45(.a(new_n35_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n61_));
