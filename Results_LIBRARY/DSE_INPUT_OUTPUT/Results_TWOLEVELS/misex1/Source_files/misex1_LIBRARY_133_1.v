...
module FAU ( 
  ...
  nand4  g29(.a(new_n21_), .b(new_n20_), .c(new_n19_), .d(x2), .O(new_n45_));
  ...
  nand3  g34(.a(new_n49_), .b(new_n48_), .c(new_n20_), .O(new_n50_));
  ...
  nand3  g39(.a(new_n26_), .b(x2), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n48_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n20_), .c(new_n24_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n53_), .O(z5));
  nand4  g43(.a(new_n25_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n48_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n20_), .c(new_n24_), .O(new_n61_));
