...
module FAU ( 
  ...
  oai21  g13(.a(x4), .b(new_n19_), .c(new_n22_), .O(new_n29_));
  ...
  nor2   g20(.a(new_n22_), .b(x3), .O(new_n36_));
  aoi21  g21(.a(new_n35_), .b(new_n23_), .c(new_n36_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n33_), .O(z1));
  inv1   g23(.a(new_n23_), .O(new_n39_));
  nand2  g24(.a(x5), .b(x2), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n19_), .c(new_n18_), .O(new_n41_));
  nand3  g26(.a(x4), .b(new_n16_), .c(x1), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x6), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n20_), .c(new_n17_), .O(new_n44_));
  oai21  g29(.a(new_n34_), .b(new_n39_), .c(new_n44_), .O(z2));
  inv1   g30(.a(x4), .O(new_n46_));
  nand3  g31(.a(new_n22_), .b(new_n46_), .c(new_n19_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(x7), .c(x2), .O(new_n48_));
  inv1   g33(.a(x5), .O(new_n49_));
  nand3  g34(.a(new_n22_), .b(new_n49_), .c(new_n19_), .O(new_n50_));
  nor3   g35(.a(new_n50_), .b(new_n16_), .c(x1), .O(new_n51_));
  aoi21  g36(.a(new_n48_), .b(x1), .c(new_n51_), .O(new_n52_));
  oai21  g37(.a(new_n39_), .b(new_n16_), .c(new_n22_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n19_), .O(new_n54_));
  oai21  g39(.a(new_n52_), .b(x0), .c(new_n54_), .O(z3));
  nand3  g40(.a(new_n22_), .b(new_n19_), .c(x2), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n34_), .c(new_n17_), .O(new_n57_));
  aoi21  g42(.a(x5), .b(x2), .c(new_n19_), .O(new_n58_));
  nand2  g43(.a(x3), .b(x2), .O(new_n59_));
  oai21  g44(.a(new_n58_), .b(x6), .c(new_n59_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n17_), .c(new_n57_), .O(new_n61_));
  oai21  g46(.a(new_n29_), .b(x2), .c(new_n19_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(x1), .c(new_n17_), .O(new_n63_));
  oai21  g48(.a(new_n61_), .b(x1), .c(new_n63_), .O(z4));
  inv1   g49(.a(new_n36_), .O(new_n65_));
  nand2  g50(.a(new_n56_), .b(new_n34_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x0), .O(new_n67_));
  nand2  g52(.a(new_n27_), .b(new_n17_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n18_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n63_), .c(new_n65_), .O(z5));
  nor3   g56(.a(new_n50_), .b(new_n16_), .c(x0), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n57_), .c(new_n18_), .O(new_n73_));
  oai21  g58(.a(new_n47_), .b(x2), .c(new_n19_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n17_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n65_), .O(z6));
endmodule
