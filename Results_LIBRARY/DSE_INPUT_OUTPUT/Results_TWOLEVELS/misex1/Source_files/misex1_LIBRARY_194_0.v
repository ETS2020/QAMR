...
module FAU ( 
  ...
  nand2  g02(.a(new_n17_), .b(x5), .O(new_n18_));
  ...
  oai21  g11(.a(new_n26_), .b(new_n16_), .c(new_n24_), .O(new_n27_));
  ...
  aoi21  g18(.a(new_n33_), .b(new_n25_), .c(new_n29_), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(x0), .c(new_n28_), .O(z1));
  nor2   g20(.a(x6), .b(x3), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n20_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n32_), .c(x0), .O(new_n38_));
  nand3  g23(.a(x3), .b(new_n20_), .c(x0), .O(new_n39_));
  inv1   g24(.a(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n38_), .c(new_n25_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n19_), .O(z2));
  ...
  nand2  g31(.a(new_n46_), .b(new_n22_), .O(z3));
  nand2  g32(.a(new_n21_), .b(x2), .O(new_n48_));
  nand2  g33(.a(new_n26_), .b(new_n48_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(x0), .O(new_n50_));
  oai21  g35(.a(new_n36_), .b(x2), .c(new_n16_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n20_), .O(new_n53_));
  oai21  g38(.a(x3), .b(new_n25_), .c(x1), .O(new_n54_));
  nand3  g39(.a(x6), .b(new_n21_), .c(new_n25_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n54_), .c(x5), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n16_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n53_), .O(z4));
  nand2  g43(.a(new_n50_), .b(new_n24_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n20_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(z5));
  nand3  g46(.a(new_n49_), .b(new_n20_), .c(x0), .O(new_n62_));
  oai21  g47(.a(x4), .b(x2), .c(new_n21_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(x1), .c(new_n29_), .O(new_n64_));
