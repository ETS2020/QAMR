...
module FAU ( 
  ...
  aoi21  g14(.a(new_n29_), .b(new_n16_), .c(new_n23_), .O(new_n30_));
  inv1   g15(.a(x1), .O(new_n31_));
  nand4  g16(.a(x3), .b(new_n16_), .c(new_n31_), .d(x0), .O(new_n32_));
  oai21  g17(.a(new_n30_), .b(x0), .c(new_n32_), .O(z1));
  nor2   g18(.a(x5), .b(new_n16_), .O(new_n34_));
  nor2   g19(.a(x6), .b(x2), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n34_), .c(new_n26_), .O(new_n36_));
  oai21  g21(.a(new_n24_), .b(x2), .c(new_n26_), .O(new_n37_));
  ...
  nand3  g29(.a(new_n44_), .b(x2), .c(new_n31_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n19_), .O(new_n47_));
  nand3  g32(.a(new_n17_), .b(new_n31_), .c(x0), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n47_), .O(z3));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  and2   g35(.a(new_n50_), .b(x0), .O(new_n51_));
  inv1   g36(.a(x5), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(x2), .c(new_n35_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x3), .c(new_n22_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n19_), .c(new_n51_), .O(new_n55_));
  oai21  g40(.a(x3), .b(new_n16_), .c(x1), .O(new_n56_));
  nand3  g41(.a(x6), .b(new_n26_), .c(new_n16_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(x0), .O(new_n58_));
  aoi21  g43(.a(x1), .b(x0), .c(new_n58_), .O(new_n59_));
  oai21  g44(.a(new_n55_), .b(x1), .c(new_n59_), .O(z4));
  nor2   g45(.a(new_n22_), .b(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n51_), .c(new_n31_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n59_), .O(z5));
  oai21  g48(.a(new_n50_), .b(x1), .c(x0), .O(new_n64_));
  nand2  g49(.a(x3), .b(x1), .O(new_n65_));
  nand2  g50(.a(new_n44_), .b(new_n31_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n65_), .c(new_n16_), .O(new_n67_));
  oai21  g52(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n68_));
  nor2   g53(.a(new_n68_), .b(new_n31_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n67_), .c(new_n19_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n64_), .O(z6));
endmodule
