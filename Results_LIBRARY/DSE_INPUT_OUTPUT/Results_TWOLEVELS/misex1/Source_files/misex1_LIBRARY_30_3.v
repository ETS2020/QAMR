...
module FAU ( 
  ...
  nand2  g29(.a(x5), .b(x1), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n35_), .O(z2));
  ...
  oai21  g36(.a(new_n47_), .b(new_n33_), .c(new_n51_), .O(z3));
  aoi21  g37(.a(new_n47_), .b(new_n34_), .c(new_n20_), .O(new_n53_));
  ...
  nand4  g41(.a(new_n56_), .b(new_n21_), .c(x1), .d(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n55_), .O(z4));
  aoi21  g43(.a(new_n25_), .b(new_n24_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n53_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(z5));
  nand4  g46(.a(new_n21_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n62_));
