...
module FAU ( 
  ...
  aoi21  g04(.a(new_n19_), .b(new_n16_), .c(x6), .O(new_n20_));
  ...
  nand4  g11(.a(new_n26_), .b(new_n24_), .c(x2), .d(new_n23_), .O(new_n27_));
  nand2  g12(.a(new_n18_), .b(x1), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n27_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n17_), .O(new_n30_));
  nand2  g15(.a(new_n18_), .b(x0), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n16_), .c(new_n24_), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n23_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n30_), .O(z1));
  nand2  g19(.a(x5), .b(x2), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n24_), .c(new_n16_), .d(new_n23_), .O(new_n36_));
  aoi21  g21(.a(x4), .b(new_n18_), .c(x3), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n23_), .c(new_n36_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n17_), .O(new_n39_));
  nor2   g24(.a(x1), .b(new_n17_), .O(new_n40_));
  nand4  g25(.a(new_n40_), .b(new_n24_), .c(x3), .d(new_n18_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(z2));
  oai21  g27(.a(x4), .b(x3), .c(x7), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n18_), .c(x1), .O(new_n44_));
  nor2   g29(.a(x6), .b(x5), .O(new_n45_));
  nand4  g30(.a(new_n45_), .b(new_n16_), .c(x2), .d(new_n23_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n17_), .O(new_n48_));
  nand4  g33(.a(new_n40_), .b(new_n24_), .c(new_n16_), .d(x2), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(z3));
  xor2a  g35(.a(x3), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(x0), .O(new_n52_));
  oai21  g37(.a(new_n16_), .b(x2), .c(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n24_), .c(new_n23_), .O(new_n55_));
  nand2  g40(.a(new_n16_), .b(x2), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(x1), .c(new_n17_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n55_), .O(z4));
  nand3  g43(.a(new_n26_), .b(x2), .c(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n52_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n24_), .c(new_n23_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n57_), .O(z5));
  nand4  g47(.a(new_n25_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n24_), .c(new_n23_), .O(new_n65_));
