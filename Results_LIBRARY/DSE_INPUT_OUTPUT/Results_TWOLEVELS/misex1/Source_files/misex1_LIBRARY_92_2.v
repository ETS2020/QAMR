...
module FAU ( 
  ...
  nand3  g11(.a(x6), .b(new_n21_), .c(new_n18_), .O(new_n27_));
  aoi21  g12(.a(new_n27_), .b(new_n26_), .c(x0), .O(new_n28_));
  nor2   g13(.a(new_n21_), .b(x2), .O(new_n29_));
  ...
  nand3  g29(.a(new_n29_), .b(new_n16_), .c(x0), .O(new_n45_));
  ...
  nand3  g38(.a(new_n53_), .b(new_n52_), .c(new_n22_), .O(z3));
  nand2  g39(.a(new_n21_), .b(x2), .O(new_n55_));
  nand2  g40(.a(x3), .b(new_n18_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n55_), .c(new_n34_), .O(new_n57_));
  aoi21  g42(.a(x3), .b(new_n18_), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n16_), .O(new_n59_));
  oai21  g44(.a(new_n36_), .b(x0), .c(new_n59_), .O(z4));
  oai21  g45(.a(new_n57_), .b(new_n28_), .c(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n35_), .b(new_n34_), .c(new_n17_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n16_), .c(new_n61_), .O(z5));
  nand2  g48(.a(new_n47_), .b(new_n19_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n57_), .c(new_n16_), .O(new_n66_));
