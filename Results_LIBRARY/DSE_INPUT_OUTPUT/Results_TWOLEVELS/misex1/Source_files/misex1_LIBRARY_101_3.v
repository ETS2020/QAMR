...
module FAU ( 
  ...
  nor2   g46(.a(new_n32_), .b(new_n20_), .O(new_n62_));
  aoi21  g47(.a(new_n61_), .b(new_n20_), .c(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n58_), .b(x1), .c(new_n63_), .O(z4));
  nand2  g49(.a(new_n61_), .b(new_n20_), .O(new_n65_));
  nor2   g50(.a(new_n24_), .b(x0), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n54_), .c(new_n32_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n65_), .O(z5));
  nand3  g53(.a(new_n48_), .b(x2), .c(new_n20_), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n54_), .c(new_n32_), .O(new_n71_));
  oai21  g56(.a(x4), .b(x2), .c(new_n16_), .O(new_n72_));
