...
module FAU ( 
  ...
  aoi21  g20(.a(x6), .b(x1), .c(new_n35_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n33_), .O(z1));
  nand2  g22(.a(new_n28_), .b(new_n17_), .O(new_n38_));
  oai21  g23(.a(x5), .b(new_n17_), .c(new_n38_), .O(new_n39_));
  nand3  g24(.a(new_n39_), .b(new_n20_), .c(new_n16_), .O(new_n40_));
  inv1   g25(.a(x4), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(x2), .c(new_n20_), .O(new_n42_));
  ...
  nand4  g32(.a(new_n47_), .b(new_n28_), .c(new_n17_), .d(x1), .O(new_n48_));
  ...
  nand2  g39(.a(x3), .b(new_n17_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n54_), .c(new_n23_), .O(new_n56_));
  aoi21  g41(.a(x3), .b(new_n17_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n16_), .O(new_n58_));
  nand2  g43(.a(new_n20_), .b(x2), .O(new_n59_));
  nand4  g44(.a(new_n59_), .b(new_n28_), .c(x1), .d(new_n23_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n58_), .O(z4));
  aoi21  g46(.a(new_n25_), .b(new_n24_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n56_), .c(new_n16_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n60_), .O(z5));
  nand2  g49(.a(new_n49_), .b(new_n18_), .O(new_n65_));
  inv1   g50(.a(new_n65_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n56_), .c(new_n16_), .O(new_n67_));
  oai21  g52(.a(x4), .b(x2), .c(new_n20_), .O(new_n68_));
  nand4  g53(.a(new_n68_), .b(new_n28_), .c(x1), .d(new_n23_), .O(new_n69_));
