...
module FAU ( 
  ...
  oai21  g17(.a(new_n32_), .b(new_n19_), .c(new_n20_), .O(new_n33_));
  ...
  nand4  g25(.a(new_n40_), .b(new_n20_), .c(new_n19_), .d(new_n31_), .O(new_n41_));
  oai21  g26(.a(new_n26_), .b(x2), .c(new_n19_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(x1), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n17_), .O(new_n45_));
  nand4  g30(.a(new_n21_), .b(new_n20_), .c(x3), .d(new_n16_), .O(new_n46_));
  ...
  nand4  g35(.a(new_n50_), .b(new_n19_), .c(x2), .d(new_n31_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n17_), .O(new_n53_));
  nand4  g38(.a(new_n21_), .b(new_n20_), .c(new_n19_), .d(x2), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(z3));
  xor2a  g40(.a(x3), .b(x2), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x0), .O(new_n57_));
  nand3  g42(.a(new_n40_), .b(new_n19_), .c(new_n17_), .O(new_n58_));
  or2    g43(.a(new_n24_), .b(x0), .O(new_n59_));
  nand4  g44(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(new_n20_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n31_), .O(new_n61_));
  aoi21  g46(.a(new_n19_), .b(x2), .c(new_n31_), .O(new_n62_));
  ...
  nand3  g51(.a(new_n56_), .b(new_n20_), .c(x0), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n59_), .c(new_n20_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n31_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n65_), .O(z5));
  nand4  g55(.a(new_n36_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n71_));
  nand3  g56(.a(new_n71_), .b(new_n57_), .c(new_n20_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n31_), .O(new_n73_));
