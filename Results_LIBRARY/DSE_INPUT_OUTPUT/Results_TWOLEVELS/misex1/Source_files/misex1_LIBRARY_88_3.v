...
module FAU ( 
  ...
  aoi21  g43(.a(new_n16_), .b(x2), .c(new_n32_), .O(new_n59_));
  ...
  nand2  g50(.a(x1), .b(x0), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n65_), .c(new_n62_), .O(z5));
  nand3  g52(.a(new_n48_), .b(x2), .c(new_n20_), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n54_), .c(new_n32_), .O(new_n70_));
