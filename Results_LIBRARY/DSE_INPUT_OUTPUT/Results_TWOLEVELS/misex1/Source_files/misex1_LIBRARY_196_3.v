...
module FAU ( 
  ...
  oai21  g10(.a(new_n16_), .b(x0), .c(new_n20_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(x3), .O(new_n27_));
  oai21  g12(.a(x4), .b(new_n17_), .c(x1), .O(new_n28_));
  nand2  g13(.a(x6), .b(new_n17_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n28_), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n20_), .c(new_n22_), .O(new_n31_));
  ...
  nand4  g25(.a(x3), .b(new_n20_), .c(new_n16_), .d(x0), .O(new_n41_));
  ...
  oai21  g31(.a(x1), .b(new_n22_), .c(new_n17_), .O(new_n47_));
  ...
  nand3  g37(.a(new_n52_), .b(new_n17_), .c(new_n22_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n51_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n16_), .O(new_n55_));
  inv1   g40(.a(x4), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(x1), .c(x6), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x3), .c(new_n33_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n20_), .c(new_n22_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z4));
  nand2  g45(.a(new_n51_), .b(new_n23_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n16_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n31_), .c(new_n27_), .O(z5));
  nand4  g48(.a(new_n37_), .b(new_n17_), .c(x2), .d(new_n22_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n51_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n16_), .O(new_n66_));
  nand2  g51(.a(x4), .b(new_n17_), .O(new_n67_));
  nand4  g52(.a(new_n67_), .b(new_n20_), .c(x1), .d(new_n22_), .O(new_n68_));
