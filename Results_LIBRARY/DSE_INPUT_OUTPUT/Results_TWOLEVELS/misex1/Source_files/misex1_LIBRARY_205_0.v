...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(new_n17_), .c(x2), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n28_), .c(new_n19_), .O(new_n36_));
  nor2   g21(.a(new_n24_), .b(x2), .O(new_n37_));
  aoi22  g22(.a(new_n37_), .b(new_n20_), .c(new_n21_), .d(new_n24_), .O(new_n38_));
  ...
  nand4  g34(.a(new_n49_), .b(new_n16_), .c(x1), .d(new_n19_), .O(new_n50_));
  nand3  g35(.a(new_n20_), .b(new_n24_), .c(x2), .O(new_n51_));
