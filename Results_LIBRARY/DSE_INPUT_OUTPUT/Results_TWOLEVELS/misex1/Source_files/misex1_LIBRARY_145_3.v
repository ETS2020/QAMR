...
module FAU ( 
  ...
  oai21  g14(.a(new_n29_), .b(new_n18_), .c(new_n28_), .O(z1));
  ...
  nand3  g27(.a(new_n31_), .b(new_n22_), .c(x1), .O(new_n43_));
  ...
  aoi21  g36(.a(new_n29_), .b(new_n19_), .c(new_n21_), .O(new_n52_));
  oai21  g37(.a(new_n37_), .b(x3), .c(new_n26_), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n21_), .c(new_n52_), .O(new_n54_));
  nand4  g39(.a(new_n24_), .b(new_n17_), .c(new_n22_), .d(new_n21_), .O(new_n55_));
  inv1   g40(.a(new_n55_), .O(new_n56_));
  aoi21  g41(.a(x3), .b(x1), .c(new_n56_), .O(new_n57_));
  oai21  g42(.a(new_n54_), .b(x1), .c(new_n57_), .O(z4));
  nor2   g43(.a(new_n26_), .b(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n52_), .c(new_n16_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n55_), .O(z5));
  nand4  g46(.a(new_n35_), .b(new_n17_), .c(x2), .d(new_n21_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n52_), .c(new_n16_), .O(new_n64_));
  nor2   g49(.a(x4), .b(x3), .O(new_n65_));
  nand4  g50(.a(new_n65_), .b(new_n22_), .c(x1), .d(new_n21_), .O(new_n66_));
