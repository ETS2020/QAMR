...
module FAU ( 
  ...
  nor2   g15(.a(x2), .b(new_n24_), .O(new_n31_));
  aoi21  g16(.a(new_n30_), .b(x7), .c(new_n31_), .O(new_n32_));
  nand4  g17(.a(new_n19_), .b(x7), .c(x3), .d(new_n16_), .O(new_n33_));
  oai21  g18(.a(new_n32_), .b(x0), .c(new_n33_), .O(z1));
  inv1   g19(.a(x6), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n16_), .O(new_n36_));
  nand3  g21(.a(x7), .b(new_n26_), .c(x2), .O(new_n37_));
  ...
  oai21  g27(.a(new_n42_), .b(new_n25_), .c(x7), .O(new_n43_));
  ...
  nand3  g33(.a(x7), .b(new_n26_), .c(new_n25_), .O(new_n49_));
  ...
  nand4  g41(.a(new_n35_), .b(new_n25_), .c(new_n16_), .d(new_n17_), .O(new_n57_));
  nand4  g42(.a(new_n57_), .b(new_n56_), .c(new_n55_), .d(x7), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n24_), .O(new_n59_));
  aoi21  g44(.a(new_n25_), .b(x2), .c(new_n24_), .O(new_n60_));
  nand4  g45(.a(x7), .b(x6), .c(new_n25_), .d(new_n16_), .O(new_n61_));
  ...
  nand4  g51(.a(x6), .b(new_n25_), .c(new_n16_), .d(new_n17_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(x7), .O(new_n69_));
  nand2  g54(.a(new_n60_), .b(new_n17_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n69_), .O(z5));
  nand2  g56(.a(x2), .b(new_n17_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n27_), .c(new_n55_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(x7), .c(new_n24_), .O(new_n74_));
