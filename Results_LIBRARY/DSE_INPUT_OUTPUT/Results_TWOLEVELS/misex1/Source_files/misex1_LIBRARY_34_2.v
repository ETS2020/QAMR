...
module FAU ( 
  ...
  nor2   g27(.a(x1), .b(new_n20_), .O(new_n43_));
  nor2   g28(.a(x4), .b(new_n17_), .O(new_n44_));
  aoi21  g29(.a(new_n43_), .b(new_n28_), .c(new_n44_), .O(new_n45_));
  ...
  nand4  g34(.a(new_n49_), .b(x4), .c(new_n16_), .d(x1), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n20_), .O(new_n52_));
  nand3  g37(.a(new_n43_), .b(new_n18_), .c(x2), .O(new_n53_));
  ...
  or2    g44(.a(new_n34_), .b(x0), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(z4));
  oai21  g46(.a(new_n57_), .b(new_n27_), .c(new_n17_), .O(new_n62_));
  ...
  oai21  g51(.a(new_n18_), .b(x0), .c(x4), .O(new_n67_));
