...
module FAU ( 
  ...
  nand4  g17(.a(new_n32_), .b(new_n17_), .c(x3), .d(new_n28_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z1));
  nand2  g19(.a(x5), .b(x2), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n17_), .c(new_n24_), .d(new_n16_), .O(new_n36_));
  ...
  nand3  g26(.a(new_n41_), .b(new_n28_), .c(x1), .O(new_n42_));
  nor2   g27(.a(x6), .b(x5), .O(new_n43_));
  nand4  g28(.a(new_n43_), .b(new_n24_), .c(x2), .d(new_n16_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n20_), .O(z3));
  xor2a  g32(.a(x3), .b(x2), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x0), .O(new_n49_));
  oai21  g34(.a(new_n24_), .b(x2), .c(new_n21_), .O(new_n50_));
  ...
  nand3  g38(.a(new_n53_), .b(x1), .c(new_n21_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n52_), .O(z4));
  nand3  g40(.a(new_n26_), .b(x2), .c(new_n21_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n49_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n17_), .c(new_n16_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n54_), .O(z5));
  nand4  g44(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n21_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n49_), .c(new_n17_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n16_), .O(new_n62_));
  oai21  g47(.a(x4), .b(x2), .c(new_n24_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(x1), .c(new_n21_), .O(new_n64_));
