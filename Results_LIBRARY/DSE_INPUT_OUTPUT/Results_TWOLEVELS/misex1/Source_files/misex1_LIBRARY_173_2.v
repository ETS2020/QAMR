...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n39_));
  ...
  oai21  g36(.a(new_n46_), .b(new_n25_), .c(new_n19_), .O(new_n52_));
  nand4  g37(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z5));
  nand4  g39(.a(new_n31_), .b(new_n20_), .c(x2), .d(new_n17_), .O(new_n55_));
  inv1   g40(.a(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n46_), .c(new_n19_), .O(new_n57_));
