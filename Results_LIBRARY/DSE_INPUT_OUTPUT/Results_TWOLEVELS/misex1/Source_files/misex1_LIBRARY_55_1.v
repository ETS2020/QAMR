...
module FAU ( 
  ...
  nor2   g22(.a(x4), .b(new_n26_), .O(new_n38_));
  nand4  g23(.a(new_n38_), .b(new_n25_), .c(new_n16_), .d(x0), .O(new_n39_));
  ...
  nor2   g32(.a(x2), .b(new_n21_), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(x3), .c(x4), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(x1), .c(new_n47_), .O(z2));
