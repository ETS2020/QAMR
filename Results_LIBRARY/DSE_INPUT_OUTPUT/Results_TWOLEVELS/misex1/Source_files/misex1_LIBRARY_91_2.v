...
module FAU ( 
  ...
  nand3  g20(.a(new_n35_), .b(new_n29_), .c(new_n25_), .O(z1));
  ...
  nor2   g49(.a(x5), .b(new_n17_), .O(new_n65_));
  aoi21  g50(.a(new_n64_), .b(new_n17_), .c(new_n65_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n61_), .O(z4));
  nand2  g52(.a(new_n64_), .b(new_n17_), .O(new_n68_));
  nand2  g53(.a(x3), .b(x2), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(x1), .c(new_n17_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n26_), .O(new_n71_));
  nand2  g56(.a(new_n57_), .b(new_n19_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n71_), .c(new_n68_), .O(z5));
  nand2  g58(.a(new_n26_), .b(new_n20_), .O(new_n74_));
  nand3  g59(.a(new_n54_), .b(x5), .c(x0), .O(new_n75_));
  oai21  g60(.a(new_n56_), .b(new_n74_), .c(new_n75_), .O(new_n76_));
