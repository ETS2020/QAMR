...
module FAU ( 
  ...
  nand2  g15(.a(new_n21_), .b(new_n19_), .O(new_n31_));
  ...
  aoi21  g29(.a(new_n33_), .b(x1), .c(new_n20_), .O(new_n45_));
  aoi21  g30(.a(new_n27_), .b(new_n20_), .c(new_n45_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(x0), .c(new_n39_), .O(z4));
  oai21  g32(.a(new_n21_), .b(x1), .c(new_n30_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(x2), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n28_), .c(x0), .O(z5));
  aoi21  g35(.a(new_n21_), .b(x2), .c(x0), .O(new_n51_));
  oai21  g36(.a(x4), .b(x2), .c(new_n33_), .O(new_n52_));
