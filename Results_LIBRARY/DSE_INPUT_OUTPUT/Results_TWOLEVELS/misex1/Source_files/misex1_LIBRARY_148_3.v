...
module FAU ( 
  ...
  aoi21  g17(.a(new_n32_), .b(new_n16_), .c(x6), .O(new_n33_));
  oai22  g18(.a(new_n33_), .b(new_n18_), .c(new_n31_), .d(x0), .O(z1));
  ...
  nand3  g27(.a(new_n32_), .b(new_n21_), .c(new_n16_), .O(new_n43_));
  ...
  nand4  g33(.a(new_n35_), .b(new_n18_), .c(x2), .d(new_n17_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n20_), .O(new_n51_));
  nand3  g36(.a(new_n32_), .b(new_n18_), .c(x2), .O(new_n52_));
  nand2  g37(.a(x6), .b(x3), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(z3));
  nand3  g39(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n18_), .b(x2), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n55_), .c(new_n20_), .O(new_n57_));
  xor2a  g42(.a(x3), .b(x2), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(x6), .c(new_n56_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n20_), .c(new_n57_), .O(new_n60_));
  ...
  aoi21  g51(.a(new_n27_), .b(new_n20_), .c(new_n57_), .O(new_n67_));
  oai21  g52(.a(x2), .b(x0), .c(new_n18_), .O(new_n68_));
  aoi22  g53(.a(new_n68_), .b(x6), .c(new_n62_), .d(new_n20_), .O(new_n69_));
  oai21  g54(.a(new_n67_), .b(x1), .c(new_n69_), .O(z5));
  nand4  g55(.a(new_n35_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n71_));
  inv1   g56(.a(new_n71_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n57_), .c(new_n17_), .O(new_n73_));
  oai21  g58(.a(new_n46_), .b(x2), .c(new_n25_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n20_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n73_), .c(new_n53_), .O(z6));
endmodule
