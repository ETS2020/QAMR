...
module FAU ( 
  ...
  aoi21  g48(.a(new_n25_), .b(new_n24_), .c(x0), .O(new_n64_));
  ...
  nand4  g55(.a(new_n70_), .b(new_n21_), .c(x1), .d(new_n20_), .O(new_n71_));
