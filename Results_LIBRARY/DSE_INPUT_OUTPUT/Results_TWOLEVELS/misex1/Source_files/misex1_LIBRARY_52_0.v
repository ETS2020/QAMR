...
module FAU ( 
  ...
  oai22  g03(.a(new_n18_), .b(new_n17_), .c(x3), .d(x1), .O(z0));
  inv1   g04(.a(x3), .O(new_n20_));
  inv1   g05(.a(x2), .O(new_n21_));
  inv1   g06(.a(x4), .O(new_n22_));
  nand2  g07(.a(new_n22_), .b(new_n21_), .O(new_n23_));
  oai21  g08(.a(new_n23_), .b(x0), .c(x1), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n20_), .O(new_n25_));
  nand2  g10(.a(new_n22_), .b(new_n20_), .O(new_n26_));
  nand3  g11(.a(new_n26_), .b(new_n21_), .c(x1), .O(new_n27_));
  inv1   g12(.a(x1), .O(new_n28_));
  nand3  g13(.a(x3), .b(x2), .c(new_n28_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n27_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nand4  g16(.a(x3), .b(new_n21_), .c(new_n28_), .d(x0), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n31_), .c(new_n25_), .O(z1));
  oai21  g18(.a(x2), .b(new_n16_), .c(x3), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n28_), .O(new_n35_));
  oai21  g20(.a(new_n22_), .b(x2), .c(new_n20_), .O(new_n36_));
  nand3  g21(.a(new_n36_), .b(x1), .c(new_n16_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n35_), .O(z2));
  nand2  g23(.a(new_n26_), .b(x7), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n21_), .c(x1), .d(new_n16_), .O(new_n40_));
  inv1   g25(.a(new_n40_), .O(z3));
  aoi21  g26(.a(new_n21_), .b(new_n28_), .c(new_n20_), .O(new_n42_));
  aoi21  g27(.a(new_n22_), .b(x3), .c(x2), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(x1), .c(new_n42_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(x0), .c(new_n35_), .O(z4));
  aoi21  g30(.a(new_n21_), .b(new_n28_), .c(x0), .O(new_n46_));
  nand3  g31(.a(new_n21_), .b(new_n28_), .c(x0), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(x3), .O(new_n49_));
  nand3  g34(.a(new_n43_), .b(x1), .c(new_n16_), .O(new_n50_));
  ...
  nand2  g38(.a(new_n53_), .b(new_n35_), .O(z6));
endmodule
