...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n20_, new_n21_, new_n22_, new_n23_,
    ...
    new_n41_, new_n42_, new_n44_, new_n46_, new_n47_, new_n48_;
  ...
  nand3  g30(.a(new_n34_), .b(x2), .c(new_n27_), .O(new_n46_));
  inv1   g31(.a(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n39_), .c(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n42_), .O(z6));
endmodule
