...
module FAU ( 
  ...
  oai21  g39(.a(new_n16_), .b(x0), .c(new_n20_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x3), .O(new_n56_));
  oai21  g41(.a(x4), .b(new_n17_), .c(x1), .O(new_n57_));
  nand2  g42(.a(x6), .b(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n20_), .c(new_n22_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n56_), .c(new_n54_), .O(z4));
  nand2  g46(.a(new_n50_), .b(new_n23_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n16_), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n60_), .c(new_n56_), .O(z5));
