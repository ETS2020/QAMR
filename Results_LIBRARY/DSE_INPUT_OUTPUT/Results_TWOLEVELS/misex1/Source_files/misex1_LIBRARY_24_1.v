...
module FAU ( 
  ...
  aoi22  g49(.a(new_n46_), .b(new_n21_), .c(x4), .d(new_n16_), .O(new_n65_));
  oai21  g50(.a(new_n64_), .b(x4), .c(new_n65_), .O(z4));
  nand2  g51(.a(new_n46_), .b(new_n21_), .O(new_n67_));
  nand2  g52(.a(new_n28_), .b(new_n21_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n59_), .c(x1), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n63_), .c(new_n17_), .O(new_n70_));
