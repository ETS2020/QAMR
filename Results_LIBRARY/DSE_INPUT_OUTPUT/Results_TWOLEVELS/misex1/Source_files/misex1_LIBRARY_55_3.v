...
module FAU ( 
  ...
  nand4  g16(.a(x3), .b(new_n17_), .c(new_n16_), .d(x0), .O(new_n32_));
  nand2  g17(.a(new_n32_), .b(new_n31_), .O(z1));
  nand3  g18(.a(new_n25_), .b(x3), .c(x1), .O(new_n34_));
  ...
  aoi21  g27(.a(x4), .b(x1), .c(new_n42_), .O(new_n43_));
  ...
  nand2  g38(.a(x3), .b(new_n17_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n22_), .c(new_n24_), .O(new_n55_));
  ...
  nor2   g43(.a(new_n58_), .b(x4), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(x1), .c(new_n24_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(z4));
  nand3  g46(.a(x6), .b(new_n21_), .c(new_n17_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n29_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n55_), .c(new_n16_), .O(new_n64_));
  oai21  g49(.a(new_n58_), .b(x0), .c(new_n25_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(x1), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n64_), .O(z5));
  nand4  g52(.a(new_n36_), .b(new_n21_), .c(x2), .d(new_n24_), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n55_), .c(new_n16_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n60_), .O(z6));
endmodule
