...
module FAU ( 
  ...
  oai21  g10(.a(new_n24_), .b(x3), .c(new_n25_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n16_), .O(new_n27_));
  nand4  g12(.a(x5), .b(new_n20_), .c(x2), .d(new_n19_), .O(new_n28_));
  ...
  nand2  g30(.a(new_n30_), .b(new_n20_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(new_n43_), .c(new_n45_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n17_), .O(new_n48_));
  nand4  g33(.a(new_n20_), .b(x2), .c(new_n19_), .d(x0), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(z3));
  aoi21  g35(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n51_));
  oai21  g36(.a(new_n32_), .b(x2), .c(x1), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n20_), .c(new_n51_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x0), .c(new_n49_), .O(z4));
  nand2  g39(.a(new_n30_), .b(new_n17_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(x2), .c(new_n19_), .O(new_n56_));
  oai21  g41(.a(x4), .b(new_n19_), .c(new_n32_), .O(new_n57_));
  ...
  nand3  g45(.a(new_n36_), .b(x1), .c(new_n17_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n60_), .c(new_n41_), .O(z5));
  nand2  g47(.a(x3), .b(x1), .O(new_n63_));
  nand3  g48(.a(new_n30_), .b(new_n20_), .c(new_n19_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n63_), .c(new_n16_), .O(new_n65_));
  oai21  g50(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n66_));
  nor2   g51(.a(new_n66_), .b(new_n19_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n65_), .c(new_n17_), .O(new_n68_));
  oai21  g53(.a(new_n16_), .b(new_n17_), .c(new_n20_), .O(new_n69_));
