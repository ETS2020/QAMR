...
module FAU ( 
  ...
  nand2  g13(.a(new_n16_), .b(new_n19_), .O(new_n29_));
  ...
  nand2  g37(.a(new_n52_), .b(new_n43_), .O(z4));
  nand4  g38(.a(new_n45_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n54_));
  oai21  g39(.a(new_n40_), .b(new_n17_), .c(new_n54_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n20_), .O(new_n56_));
  nand2  g41(.a(new_n51_), .b(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n29_), .O(z5));
  inv1   g43(.a(new_n21_), .O(new_n59_));
  aoi21  g44(.a(new_n32_), .b(new_n17_), .c(new_n59_), .O(new_n60_));
  nand2  g45(.a(x4), .b(new_n20_), .O(new_n61_));
  nand4  g46(.a(new_n61_), .b(new_n16_), .c(x1), .d(new_n17_), .O(new_n62_));
  oai21  g47(.a(new_n60_), .b(new_n16_), .c(new_n62_), .O(z6));
endmodule
