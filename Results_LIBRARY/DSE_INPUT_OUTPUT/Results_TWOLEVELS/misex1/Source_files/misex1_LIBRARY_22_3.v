...
module FAU ( 
  ...
  nand3  g51(.a(new_n25_), .b(new_n18_), .c(new_n16_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(x0), .O(new_n68_));
  nand2  g53(.a(x3), .b(x1), .O(new_n69_));
  nand3  g54(.a(new_n53_), .b(new_n17_), .c(new_n16_), .O(new_n70_));
  ...
  oai21  g58(.a(new_n73_), .b(new_n71_), .c(new_n21_), .O(new_n74_));
