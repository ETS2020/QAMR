...
module FAU ( 
  ...
  nand3  g32(.a(new_n47_), .b(x2), .c(new_n23_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n46_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand3  g35(.a(new_n18_), .b(new_n23_), .c(x0), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(z3));
  aoi21  g37(.a(new_n25_), .b(new_n17_), .c(new_n20_), .O(new_n53_));
  inv1   g38(.a(x5), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(x2), .c(new_n38_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(x3), .c(new_n28_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n20_), .c(new_n53_), .O(new_n57_));
  aoi21  g42(.a(new_n16_), .b(x2), .c(new_n23_), .O(new_n58_));
  nand3  g43(.a(x6), .b(new_n16_), .c(new_n24_), .O(new_n59_));
  ...
  oai21  g48(.a(new_n63_), .b(new_n53_), .c(new_n23_), .O(new_n64_));
  nand2  g49(.a(x1), .b(x0), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n61_), .O(z5));
  nand3  g51(.a(new_n25_), .b(new_n17_), .c(new_n23_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(x0), .O(new_n68_));
  nand2  g53(.a(x3), .b(x1), .O(new_n69_));
  nand2  g54(.a(new_n47_), .b(new_n23_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n69_), .c(new_n24_), .O(new_n71_));
  oai21  g56(.a(new_n30_), .b(x3), .c(new_n24_), .O(new_n72_));
  nor2   g57(.a(new_n72_), .b(new_n23_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n71_), .c(new_n20_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n68_), .O(z6));
endmodule
