...
module FAU ( 
  ...
  nand2  g19(.a(new_n26_), .b(x0), .O(new_n35_));
  ...
  nor2   g25(.a(new_n40_), .b(new_n20_), .O(new_n41_));
  aoi21  g26(.a(new_n33_), .b(new_n20_), .c(new_n41_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(x1), .c(new_n25_), .O(z4));
  inv1   g28(.a(new_n40_), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n16_), .c(x0), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n25_), .O(z5));
  inv1   g31(.a(new_n41_), .O(new_n47_));
  nand4  g32(.a(new_n29_), .b(new_n17_), .c(x2), .d(new_n20_), .O(new_n48_));
