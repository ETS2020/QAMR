...
module FAU ( 
  ...
  aoi21  g13(.a(new_n23_), .b(new_n19_), .c(new_n16_), .O(new_n29_));
  oai21  g14(.a(x4), .b(x3), .c(new_n16_), .O(new_n30_));
  ...
  nand3  g20(.a(new_n23_), .b(x2), .c(new_n25_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n19_), .O(new_n38_));
  nand4  g23(.a(new_n17_), .b(x2), .c(new_n25_), .d(x0), .O(new_n39_));
