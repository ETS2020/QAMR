...
module FAU ( 
  ...
  aoi22  g23(.a(new_n38_), .b(new_n36_), .c(x4), .d(x2), .O(new_n39_));
  ...
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n39_), .O(z2));
  ...
  nand2  g41(.a(new_n36_), .b(new_n56_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n16_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x2), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z3));
  nand2  g45(.a(new_n56_), .b(x2), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n37_), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n26_), .b(new_n16_), .c(x2), .O(new_n63_));
  oai21  g48(.a(new_n43_), .b(x3), .c(new_n63_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n17_), .c(new_n62_), .O(new_n65_));
  aoi21  g50(.a(new_n16_), .b(x3), .c(new_n28_), .O(new_n66_));
  oai22  g51(.a(new_n66_), .b(new_n19_), .c(new_n33_), .d(x2), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n17_), .O(new_n68_));
  oai21  g53(.a(new_n65_), .b(x1), .c(new_n68_), .O(z4));
  ...
  nor3   g58(.a(new_n53_), .b(new_n28_), .c(x0), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n62_), .c(new_n19_), .O(new_n75_));
  nand2  g60(.a(x1), .b(new_n17_), .O(new_n76_));
  oai21  g61(.a(new_n76_), .b(new_n20_), .c(new_n16_), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(x2), .O(new_n78_));
  nand2  g63(.a(x4), .b(new_n20_), .O(new_n79_));
  nand4  g64(.a(new_n79_), .b(new_n28_), .c(x1), .d(new_n17_), .O(new_n80_));
  nand3  g65(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(z6));
endmodule
