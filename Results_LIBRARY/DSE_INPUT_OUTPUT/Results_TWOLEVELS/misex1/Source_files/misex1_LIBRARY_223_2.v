...
module FAU ( 
  ...
  nand3  g11(.a(new_n26_), .b(x6), .c(new_n18_), .O(new_n27_));
  oai21  g12(.a(new_n25_), .b(x1), .c(new_n27_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(new_n24_), .O(new_n29_));
  nand4  g14(.a(x3), .b(new_n18_), .c(new_n16_), .d(x0), .O(new_n30_));
  ...
  nand3  g22(.a(new_n37_), .b(x6), .c(x1), .O(new_n38_));
  inv1   g23(.a(new_n38_), .O(new_n39_));
  aoi21  g24(.a(new_n35_), .b(new_n16_), .c(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x0), .c(new_n30_), .O(z2));
  oai21  g26(.a(x4), .b(x3), .c(x7), .O(new_n42_));
  nand4  g27(.a(new_n42_), .b(x6), .c(new_n18_), .d(x1), .O(new_n43_));
  ...
  nand2  g32(.a(new_n47_), .b(new_n22_), .O(z3));
  nand2  g33(.a(new_n21_), .b(x2), .O(new_n49_));
  nand2  g34(.a(x3), .b(new_n18_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n49_), .c(new_n24_), .O(new_n51_));
  oai21  g36(.a(new_n34_), .b(x3), .c(new_n25_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n24_), .c(new_n51_), .O(new_n53_));
  nand2  g38(.a(x3), .b(x1), .O(new_n54_));
  oai21  g39(.a(x3), .b(x2), .c(new_n54_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(x6), .c(new_n24_), .O(new_n56_));
  inv1   g41(.a(new_n56_), .O(new_n57_));
  aoi21  g42(.a(new_n17_), .b(x1), .c(new_n57_), .O(new_n58_));
  oai21  g43(.a(new_n53_), .b(x1), .c(new_n58_), .O(z4));
  nor2   g44(.a(new_n25_), .b(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n51_), .c(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n56_), .O(z5));
  nand2  g47(.a(new_n44_), .b(new_n19_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n51_), .c(new_n16_), .O(new_n65_));
  aoi21  g50(.a(new_n36_), .b(new_n18_), .c(x3), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(x0), .c(x6), .O(new_n67_));
