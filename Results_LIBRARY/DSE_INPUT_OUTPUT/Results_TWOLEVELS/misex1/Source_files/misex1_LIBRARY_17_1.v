...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(new_n27_), .c(x1), .O(z2));
  nand2  g20(.a(x5), .b(new_n16_), .O(new_n36_));
  nand4  g21(.a(new_n36_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n37_));
  ...
  oai21  g26(.a(new_n41_), .b(x1), .c(new_n17_), .O(z4));
  nand2  g27(.a(new_n39_), .b(x0), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n26_), .c(x1), .O(z5));
  nand4  g29(.a(new_n29_), .b(new_n19_), .c(x2), .d(new_n16_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n43_), .c(x1), .O(z6));
endmodule
