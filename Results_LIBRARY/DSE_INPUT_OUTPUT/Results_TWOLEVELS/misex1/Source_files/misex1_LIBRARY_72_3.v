...
module FAU ( 
  ...
  aoi21  g43(.a(new_n16_), .b(x2), .c(new_n43_), .O(new_n59_));
  ...
  nor3   g52(.a(new_n25_), .b(new_n18_), .c(x1), .O(new_n68_));
  nand2  g53(.a(x3), .b(x1), .O(new_n69_));
  nand2  g54(.a(new_n48_), .b(new_n43_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n69_), .c(new_n23_), .O(new_n71_));
  oai21  g56(.a(new_n29_), .b(x3), .c(new_n23_), .O(new_n72_));
  nor2   g57(.a(new_n72_), .b(new_n43_), .O(new_n73_));
