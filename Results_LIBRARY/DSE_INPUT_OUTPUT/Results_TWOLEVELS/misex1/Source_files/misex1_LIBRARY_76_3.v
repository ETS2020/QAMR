...
module FAU ( 
  ...
  nand4  g48(.a(new_n52_), .b(new_n17_), .c(x2), .d(new_n21_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n51_), .c(new_n16_), .O(new_n66_));
  oai21  g51(.a(x4), .b(x2), .c(new_n17_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(x1), .c(new_n21_), .O(new_n68_));
