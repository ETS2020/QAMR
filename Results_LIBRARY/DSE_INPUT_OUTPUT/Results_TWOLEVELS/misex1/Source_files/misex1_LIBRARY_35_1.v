...
module FAU ( 
  ...
  wire new_n16_, new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n23_,
    ...
    new_n40_, new_n41_, new_n43_, new_n44_, new_n46_, new_n48_;
  ...
  oai21  g28(.a(new_n24_), .b(x2), .c(new_n16_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x1), .O(z4));
  nand2  g30(.a(new_n26_), .b(new_n16_), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n43_), .c(x1), .O(z5));
  nand4  g32(.a(new_n31_), .b(new_n24_), .c(x2), .d(new_n16_), .O(new_n48_));
