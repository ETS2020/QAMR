...
module FAU ( 
  ...
  inv1   g26(.a(z0), .O(new_n42_));
  oai21  g27(.a(x4), .b(x3), .c(x7), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n16_), .c(x1), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n36_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n21_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n42_), .O(z3));
  nand2  g32(.a(new_n17_), .b(x2), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n22_), .c(new_n21_), .O(new_n49_));
  nand2  g34(.a(x5), .b(x3), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x2), .O(new_n51_));
  nand3  g36(.a(new_n32_), .b(new_n17_), .c(new_n16_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n51_), .c(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n49_), .c(new_n18_), .O(new_n54_));
  oai21  g39(.a(new_n18_), .b(x0), .c(new_n16_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x3), .O(new_n56_));
  oai21  g41(.a(x4), .b(new_n17_), .c(x1), .O(new_n57_));
  oai21  g42(.a(new_n32_), .b(x3), .c(new_n57_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n16_), .c(new_n21_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n56_), .c(new_n54_), .O(z4));
  inv1   g45(.a(new_n23_), .O(new_n61_));
  oai21  g46(.a(new_n49_), .b(new_n61_), .c(new_n18_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n30_), .O(z5));
  nand3  g48(.a(new_n35_), .b(x2), .c(new_n21_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n49_), .c(new_n18_), .O(new_n66_));
