...
module FAU ( 
  ...
  nand2  g31(.a(new_n19_), .b(x0), .O(new_n47_));
  ...
  aoi21  g40(.a(new_n27_), .b(x2), .c(x3), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n37_), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n55_), .c(new_n40_), .O(z4));
  aoi21  g43(.a(new_n48_), .b(new_n32_), .c(new_n17_), .O(new_n59_));
  nor3   g44(.a(new_n20_), .b(new_n16_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n19_), .O(new_n61_));
  oai21  g46(.a(new_n37_), .b(new_n29_), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n61_), .c(new_n40_), .O(z5));
  nand2  g48(.a(new_n51_), .b(new_n34_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  aoi21  g50(.a(new_n20_), .b(x2), .c(x0), .O(new_n66_));
