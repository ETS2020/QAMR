...
module FAU ( 
  ...
  aoi21  g14(.a(new_n23_), .b(x1), .c(x6), .O(new_n30_));
  oai21  g15(.a(x4), .b(x3), .c(x1), .O(new_n31_));
  oai21  g16(.a(new_n30_), .b(x3), .c(new_n31_), .O(new_n32_));
  aoi21  g17(.a(new_n32_), .b(new_n27_), .c(new_n29_), .O(new_n33_));
  nor2   g18(.a(x1), .b(new_n16_), .O(new_n34_));
  nand2  g19(.a(x3), .b(new_n27_), .O(new_n35_));
  inv1   g20(.a(new_n35_), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n34_), .c(new_n24_), .O(new_n37_));
  ...
  oai21  g29(.a(new_n23_), .b(x2), .c(new_n19_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(x1), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n37_), .O(z2));
  nand2  g34(.a(x5), .b(x0), .O(new_n50_));
  nand2  g35(.a(new_n39_), .b(new_n23_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n50_), .c(new_n27_), .O(new_n52_));
  nand4  g37(.a(new_n23_), .b(new_n27_), .c(x1), .d(new_n16_), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  aoi21  g39(.a(new_n52_), .b(new_n18_), .c(new_n54_), .O(new_n55_));
  nor2   g40(.a(new_n24_), .b(x7), .O(new_n56_));
  ...
  nand3  g46(.a(new_n39_), .b(new_n23_), .c(x2), .O(new_n62_));
  nand3  g47(.a(new_n41_), .b(new_n27_), .c(new_n16_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  or2    g50(.a(new_n28_), .b(x0), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n65_), .c(new_n61_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n18_), .O(new_n68_));
  oai21  g53(.a(x3), .b(new_n27_), .c(x1), .O(new_n69_));
  nand3  g54(.a(x6), .b(new_n19_), .c(new_n27_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n16_), .c(new_n24_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n68_), .O(z4));
  nand2  g58(.a(new_n66_), .b(new_n61_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n18_), .O(new_n75_));
  nand2  g60(.a(new_n75_), .b(new_n72_), .O(z5));
  nand4  g61(.a(new_n39_), .b(new_n23_), .c(new_n19_), .d(x2), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(new_n61_), .O(new_n78_));
  nand2  g63(.a(new_n78_), .b(new_n18_), .O(new_n79_));
  oai21  g64(.a(x4), .b(x2), .c(new_n19_), .O(new_n80_));
