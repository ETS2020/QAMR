...
module FAU ( 
  ...
  aoi21  g10(.a(x6), .b(new_n25_), .c(x1), .O(new_n26_));
  inv1   g11(.a(x5), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n25_), .O(new_n28_));
  nand2  g13(.a(new_n28_), .b(x2), .O(new_n29_));
  oai22  g14(.a(new_n29_), .b(x1), .c(new_n26_), .d(x2), .O(new_n30_));
  nand3  g15(.a(new_n30_), .b(new_n24_), .c(new_n23_), .O(new_n31_));
  nor2   g16(.a(new_n25_), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n16_), .c(x0), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n31_), .O(z1));
  nand2  g19(.a(x3), .b(x1), .O(new_n35_));
  nor2   g20(.a(x5), .b(new_n17_), .O(new_n36_));
  nor2   g21(.a(x6), .b(x2), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n36_), .c(new_n25_), .O(new_n38_));
  ...
  nor3   g28(.a(x5), .b(x4), .c(x3), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(x2), .c(new_n16_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n43_), .c(new_n24_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n23_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n21_), .O(z3));
  oai21  g33(.a(new_n32_), .b(new_n20_), .c(x0), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  aoi21  g35(.a(new_n38_), .b(new_n29_), .c(x4), .O(new_n51_));
  ...
  nand3  g39(.a(x6), .b(new_n25_), .c(new_n17_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n54_), .c(new_n24_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n23_), .O(new_n57_));
  oai21  g42(.a(new_n52_), .b(x1), .c(new_n57_), .O(z4));
  nand4  g43(.a(new_n28_), .b(new_n24_), .c(x2), .d(new_n23_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n49_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n57_), .O(z5));
  nand3  g47(.a(new_n44_), .b(x2), .c(new_n23_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n49_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n16_), .O(new_n65_));
  nand4  g50(.a(new_n53_), .b(new_n24_), .c(x1), .d(new_n23_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n65_), .O(z6));
endmodule
