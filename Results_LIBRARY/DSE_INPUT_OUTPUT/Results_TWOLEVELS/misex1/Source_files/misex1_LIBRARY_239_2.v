...
module FAU ( 
  ...
  nor2   g37(.a(new_n52_), .b(new_n21_), .O(new_n53_));
  aoi21  g38(.a(new_n29_), .b(new_n21_), .c(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x0), .c(new_n17_), .O(z5));
  nor2   g40(.a(new_n26_), .b(new_n16_), .O(new_n56_));
