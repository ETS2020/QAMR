...
module FAU ( 
  ...
  nand2  g14(.a(new_n28_), .b(new_n20_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(x1), .O(new_n31_));
  oai21  g16(.a(new_n29_), .b(x3), .c(new_n31_), .O(new_n32_));
  aoi21  g17(.a(new_n32_), .b(new_n16_), .c(new_n27_), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(x0), .c(new_n25_), .O(z1));
  ...
  nand3  g26(.a(new_n24_), .b(new_n19_), .c(x0), .O(new_n42_));
  ...
  aoi21  g37(.a(new_n51_), .b(new_n23_), .c(new_n17_), .O(new_n53_));
  ...
  nand3  g51(.a(new_n51_), .b(new_n23_), .c(new_n19_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(x0), .O(new_n68_));
  nand2  g53(.a(x3), .b(x1), .O(new_n69_));
  nand2  g54(.a(new_n47_), .b(new_n19_), .O(new_n70_));
