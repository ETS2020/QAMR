...
module FAU ( 
  ...
  oai21  g36(.a(new_n51_), .b(new_n30_), .c(new_n50_), .O(z3));
  aoi21  g37(.a(new_n51_), .b(new_n31_), .c(new_n20_), .O(new_n53_));
  aoi21  g38(.a(x3), .b(new_n16_), .c(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n53_), .c(new_n17_), .O(new_n55_));
  aoi21  g40(.a(new_n18_), .b(x2), .c(x7), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n20_), .c(x7), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n17_), .c(new_n55_), .O(z4));
  ...
  nand3  g46(.a(new_n56_), .b(x1), .c(new_n20_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n61_), .O(z5));
  nand3  g48(.a(new_n47_), .b(x2), .c(new_n20_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n53_), .c(new_n17_), .O(new_n66_));
  aoi21  g51(.a(new_n34_), .b(new_n16_), .c(x3), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(x0), .c(new_n21_), .O(new_n68_));
