...
module FAU ( 
  ...
  nand3  g24(.a(new_n39_), .b(x6), .c(x1), .O(new_n40_));
  inv1   g25(.a(new_n40_), .O(new_n41_));
  aoi21  g26(.a(new_n37_), .b(new_n16_), .c(new_n41_), .O(new_n42_));
  ...
  oai21  g38(.a(new_n36_), .b(x3), .c(new_n28_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n24_), .c(new_n53_), .O(new_n55_));
  nand2  g40(.a(x3), .b(x1), .O(new_n56_));
  oai21  g41(.a(x3), .b(x2), .c(new_n56_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(x6), .c(new_n24_), .O(new_n58_));
  oai21  g43(.a(new_n55_), .b(x1), .c(new_n58_), .O(z4));
  nor2   g44(.a(new_n28_), .b(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n53_), .c(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n58_), .O(z5));
  nand2  g47(.a(new_n46_), .b(new_n19_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n53_), .c(new_n16_), .O(new_n65_));
  oai21  g50(.a(x4), .b(x2), .c(new_n21_), .O(new_n66_));
  nand4  g51(.a(new_n66_), .b(x6), .c(x1), .d(new_n24_), .O(new_n67_));
