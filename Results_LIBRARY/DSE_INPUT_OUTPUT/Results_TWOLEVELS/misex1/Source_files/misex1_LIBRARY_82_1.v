...
module FAU ( 
  ...
  aoi21  g36(.a(new_n50_), .b(new_n31_), .c(new_n17_), .O(new_n52_));
  aoi21  g37(.a(new_n40_), .b(new_n27_), .c(x0), .O(new_n53_));
  ...
  nand4  g43(.a(x6), .b(new_n23_), .c(new_n20_), .d(new_n16_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nor2   g45(.a(new_n23_), .b(x2), .O(new_n61_));
  aoi21  g46(.a(new_n60_), .b(new_n17_), .c(new_n61_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n54_), .O(z4));
  ...
  nand3  g51(.a(new_n46_), .b(x2), .c(new_n17_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n52_), .c(new_n19_), .O(new_n69_));
  aoi21  g54(.a(new_n57_), .b(new_n17_), .c(new_n61_), .O(new_n70_));
