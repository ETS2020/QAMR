...
module FAU ( 
  ...
  nand2  g41(.a(new_n56_), .b(new_n33_), .O(z4));
  ...
  oai21  g45(.a(new_n60_), .b(x0), .c(new_n30_), .O(z5));
  nand3  g46(.a(x3), .b(new_n20_), .c(x0), .O(new_n62_));
  nand3  g47(.a(new_n21_), .b(x2), .c(new_n16_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  oai21  g50(.a(x4), .b(x2), .c(new_n25_), .O(new_n66_));
