...
module FAU ( 
  ...
  oai21  g28(.a(x1), .b(new_n26_), .c(x2), .O(new_n44_));
  ...
  aoi21  g34(.a(new_n19_), .b(new_n23_), .c(new_n17_), .O(new_n50_));
  ...
  nand3  g42(.a(new_n35_), .b(x2), .c(new_n26_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n53_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n18_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n50_), .O(z6));
endmodule
