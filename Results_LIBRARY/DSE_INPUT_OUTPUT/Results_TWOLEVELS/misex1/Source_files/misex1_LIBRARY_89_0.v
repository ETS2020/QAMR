...
module FAU ( 
  ...
  nand3  g52(.a(new_n23_), .b(x2), .c(new_n17_), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n53_), .c(new_n19_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n66_), .c(new_n18_), .O(z6));
endmodule
