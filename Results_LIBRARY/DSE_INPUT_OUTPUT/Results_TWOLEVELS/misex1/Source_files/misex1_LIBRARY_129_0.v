...
module FAU ( 
  ...
  nand2  g56(.a(new_n68_), .b(new_n17_), .O(new_n72_));
  nor3   g57(.a(new_n27_), .b(new_n16_), .c(x0), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n58_), .c(new_n22_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n72_), .O(z5));
  inv1   g60(.a(new_n69_), .O(new_n76_));
  nor3   g61(.a(new_n51_), .b(new_n16_), .c(x0), .O(new_n77_));
  oai21  g62(.a(new_n77_), .b(new_n58_), .c(new_n22_), .O(new_n78_));
  nand2  g63(.a(x7), .b(new_n29_), .O(new_n79_));
  oai21  g64(.a(new_n79_), .b(x2), .c(new_n21_), .O(new_n80_));
  nand3  g65(.a(new_n80_), .b(x1), .c(new_n17_), .O(new_n81_));
  nand3  g66(.a(new_n81_), .b(new_n78_), .c(new_n76_), .O(z6));
endmodule
