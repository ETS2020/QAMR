...
module FAU ( 
  ...
  nand3  g11(.a(x6), .b(new_n18_), .c(new_n24_), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(new_n26_), .O(new_n28_));
  nand3  g13(.a(x3), .b(new_n24_), .c(x1), .O(new_n29_));
  inv1   g14(.a(new_n29_), .O(new_n30_));
  aoi21  g15(.a(new_n28_), .b(new_n16_), .c(new_n30_), .O(new_n31_));
  oai22  g16(.a(new_n31_), .b(x0), .c(new_n25_), .d(new_n21_), .O(z1));
  ...
  inv1   g24(.a(new_n25_), .O(new_n40_));
  aoi22  g25(.a(new_n40_), .b(new_n20_), .c(new_n18_), .d(x1), .O(new_n41_));
  ...
  aoi21  g33(.a(x2), .b(x0), .c(x1), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(x3), .c(new_n48_), .O(z3));
  aoi21  g35(.a(new_n25_), .b(new_n22_), .c(new_n17_), .O(new_n51_));
  aoi21  g36(.a(x3), .b(new_n24_), .c(x0), .O(new_n52_));
  ...
  aoi21  g40(.a(new_n27_), .b(new_n26_), .c(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n51_), .c(new_n16_), .O(new_n57_));
  oai21  g42(.a(new_n18_), .b(new_n17_), .c(x1), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(z5));
  nand3  g44(.a(new_n43_), .b(x2), .c(new_n17_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n51_), .c(new_n16_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n58_), .O(z6));
endmodule
