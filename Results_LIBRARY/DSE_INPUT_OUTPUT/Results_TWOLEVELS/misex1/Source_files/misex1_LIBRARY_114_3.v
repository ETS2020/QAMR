...
module FAU ( 
  ...
  oai22  g17(.a(new_n32_), .b(new_n20_), .c(new_n30_), .d(x0), .O(z1));
  nand3  g18(.a(x4), .b(new_n20_), .c(new_n16_), .O(new_n34_));
  nand2  g19(.a(new_n23_), .b(x3), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n34_), .c(new_n19_), .O(new_n36_));
  nor2   g21(.a(x6), .b(x2), .O(new_n37_));
  aoi21  g22(.a(new_n23_), .b(x2), .c(new_n37_), .O(new_n38_));
  ...
  aoi21  g37(.a(new_n52_), .b(new_n31_), .c(new_n24_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n50_), .O(z3));
  aoi21  g39(.a(new_n51_), .b(new_n41_), .c(new_n17_), .O(new_n55_));
  oai21  g40(.a(new_n38_), .b(x3), .c(new_n26_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n17_), .c(new_n55_), .O(new_n57_));
  oai21  g42(.a(new_n19_), .b(x0), .c(new_n23_), .O(new_n58_));
  nand2  g43(.a(new_n28_), .b(new_n19_), .O(new_n59_));
  nand4  g44(.a(new_n59_), .b(new_n20_), .c(new_n16_), .d(new_n17_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  aoi21  g46(.a(new_n58_), .b(x3), .c(new_n61_), .O(new_n62_));
  ...
  oai21  g53(.a(new_n68_), .b(new_n55_), .c(new_n19_), .O(new_n69_));
  inv1   g54(.a(x4), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n20_), .c(new_n16_), .O(new_n71_));
  aoi21  g56(.a(new_n71_), .b(new_n35_), .c(new_n19_), .O(new_n72_));
