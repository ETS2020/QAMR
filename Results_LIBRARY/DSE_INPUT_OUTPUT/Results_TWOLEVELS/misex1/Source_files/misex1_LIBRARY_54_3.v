...
module FAU ( 
  ...
  nand2  g10(.a(new_n24_), .b(new_n16_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(x1), .O(new_n27_));
  oai21  g12(.a(new_n25_), .b(x3), .c(new_n27_), .O(new_n28_));
  aoi21  g13(.a(new_n28_), .b(new_n21_), .c(new_n23_), .O(new_n29_));
  nand2  g14(.a(x2), .b(x1), .O(new_n30_));
  nand3  g15(.a(new_n18_), .b(x3), .c(new_n21_), .O(new_n31_));
  and2   g16(.a(new_n31_), .b(new_n30_), .O(new_n32_));
  oai21  g17(.a(new_n29_), .b(x0), .c(new_n32_), .O(z1));
  inv1   g18(.a(x1), .O(new_n34_));
  inv1   g19(.a(x6), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n16_), .c(new_n34_), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n27_), .c(x2), .O(new_n37_));
  nor2   g22(.a(x5), .b(x3), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x2), .c(new_n34_), .O(new_n39_));
  inv1   g24(.a(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n37_), .c(new_n17_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n31_), .O(z2));
  nand2  g27(.a(new_n26_), .b(x7), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n21_), .c(x1), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n39_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n17_), .O(new_n46_));
  nand3  g31(.a(new_n18_), .b(new_n16_), .c(x2), .O(new_n47_));
  ...
  nor2   g37(.a(x6), .b(x2), .O(new_n53_));
  aoi21  g38(.a(new_n52_), .b(x2), .c(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x3), .c(new_n22_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n17_), .c(new_n51_), .O(new_n56_));
  nand3  g41(.a(new_n28_), .b(new_n21_), .c(new_n17_), .O(new_n57_));
  oai21  g42(.a(new_n56_), .b(x1), .c(new_n57_), .O(z4));
  nor2   g43(.a(new_n22_), .b(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n51_), .c(new_n34_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n57_), .c(new_n30_), .O(z5));
  nand3  g46(.a(new_n38_), .b(x2), .c(new_n17_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n51_), .c(new_n34_), .O(new_n64_));
  nand2  g49(.a(x4), .b(new_n16_), .O(new_n65_));
  nand4  g50(.a(new_n65_), .b(new_n21_), .c(x1), .d(new_n17_), .O(new_n66_));
