...
module FAU ( 
  ...
  oai21  g08(.a(x2), .b(x0), .c(new_n20_), .O(new_n24_));
  ...
  nand3  g17(.a(new_n16_), .b(new_n17_), .c(x0), .O(new_n33_));
  inv1   g18(.a(new_n33_), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(new_n21_), .c(x3), .O(new_n35_));
  inv1   g20(.a(x0), .O(new_n36_));
  nand3  g21(.a(x4), .b(new_n16_), .c(new_n36_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n20_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(x1), .O(new_n39_));
  nand2  g24(.a(new_n20_), .b(new_n16_), .O(new_n40_));
  oai21  g25(.a(x5), .b(new_n16_), .c(new_n40_), .O(new_n41_));
  nand4  g26(.a(new_n41_), .b(new_n18_), .c(new_n17_), .d(new_n36_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n39_), .c(new_n35_), .O(z2));
  oai21  g28(.a(x4), .b(x3), .c(x7), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n20_), .c(new_n16_), .d(x1), .O(new_n45_));
  ...
  nand4  g34(.a(new_n18_), .b(x2), .c(new_n17_), .d(x0), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(z3));
  nand2  g36(.a(x3), .b(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n18_), .b(x2), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n52_), .c(new_n36_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n16_), .c(x0), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n17_), .O(new_n56_));
  aoi21  g41(.a(new_n40_), .b(new_n18_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x6), .c(x1), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z4));
  oai21  g44(.a(new_n54_), .b(new_n28_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n18_), .b(x2), .O(new_n61_));
  nand4  g46(.a(new_n61_), .b(new_n20_), .c(x1), .d(new_n36_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n60_), .O(z5));
  nand3  g48(.a(new_n46_), .b(x2), .c(new_n36_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n54_), .c(new_n17_), .O(new_n66_));
  inv1   g51(.a(x4), .O(new_n67_));
  nand4  g52(.a(new_n20_), .b(new_n67_), .c(new_n18_), .d(new_n16_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n18_), .c(x0), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(x6), .c(x1), .O(new_n70_));
