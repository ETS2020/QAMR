...
module FAU ( 
  ...
  oai21  g13(.a(new_n28_), .b(x1), .c(new_n18_), .O(new_n29_));
  nand3  g14(.a(x3), .b(new_n20_), .c(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(new_n31_));
  nand3  g16(.a(new_n31_), .b(new_n17_), .c(new_n26_), .O(new_n32_));
  oai21  g17(.a(x7), .b(new_n21_), .c(new_n16_), .O(new_n33_));
  ...
  nand3  g21(.a(new_n27_), .b(new_n21_), .c(new_n18_), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(new_n36_), .c(x2), .O(new_n38_));
  nand4  g23(.a(new_n16_), .b(new_n21_), .c(x2), .d(new_n18_), .O(new_n39_));
  inv1   g24(.a(new_n39_), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n38_), .c(new_n20_), .O(new_n41_));
  inv1   g26(.a(new_n17_), .O(new_n42_));
  nand2  g27(.a(x4), .b(new_n26_), .O(new_n43_));
  aoi21  g28(.a(new_n43_), .b(new_n21_), .c(new_n20_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n18_), .c(new_n42_), .O(new_n45_));
  ...
  nor2   g35(.a(new_n20_), .b(x0), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n50_), .c(new_n26_), .O(new_n52_));
  inv1   g37(.a(new_n52_), .O(new_n53_));
  aoi21  g38(.a(new_n49_), .b(new_n20_), .c(new_n53_), .O(new_n54_));
  ...
  nand4  g42(.a(new_n21_), .b(x2), .c(new_n20_), .d(new_n18_), .O(new_n58_));
  ...
  oai21  g57(.a(x3), .b(new_n26_), .c(x1), .O(new_n73_));
  nand2  g58(.a(new_n28_), .b(new_n26_), .O(new_n74_));
  ...
  aoi21  g62(.a(new_n50_), .b(new_n26_), .c(x3), .O(new_n78_));
  nand4  g63(.a(new_n16_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n79_));
  oai21  g64(.a(new_n78_), .b(new_n20_), .c(new_n79_), .O(new_n80_));
  nand2  g65(.a(new_n80_), .b(new_n18_), .O(new_n81_));
  nand4  g66(.a(new_n61_), .b(new_n17_), .c(new_n20_), .d(x0), .O(new_n82_));
