...
module FAU ( 
  ...
  nand3  g28(.a(new_n24_), .b(new_n37_), .c(new_n20_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(x7), .c(x2), .O(new_n45_));
  nand2  g30(.a(x2), .b(new_n16_), .O(new_n46_));
  oai21  g31(.a(new_n46_), .b(x3), .c(new_n24_), .O(new_n47_));
  aoi21  g32(.a(new_n45_), .b(x1), .c(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n21_), .O(z3));
