...
module FAU ( 
  ...
  nand2  g21(.a(x2), .b(new_n22_), .O(new_n37_));
  oai22  g22(.a(new_n37_), .b(new_n24_), .c(new_n36_), .d(new_n22_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n19_), .O(new_n39_));
  nand4  g24(.a(new_n17_), .b(x2), .c(new_n22_), .d(x0), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(z3));
  inv1   g26(.a(x4), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n16_), .c(x1), .O(new_n43_));
  nand3  g28(.a(new_n23_), .b(x2), .c(new_n22_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x3), .O(new_n45_));
  oai21  g30(.a(new_n23_), .b(x1), .c(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n33_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n45_), .c(new_n19_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n40_), .O(z4));
  nand4  g35(.a(new_n42_), .b(new_n16_), .c(x1), .d(new_n19_), .O(new_n51_));
  oai21  g36(.a(new_n37_), .b(new_n19_), .c(new_n51_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n17_), .O(new_n53_));
  nand2  g38(.a(new_n48_), .b(new_n19_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n53_), .O(z5));
  nand3  g40(.a(new_n17_), .b(new_n22_), .c(x0), .O(new_n56_));
  inv1   g41(.a(new_n56_), .O(new_n57_));
  aoi21  g42(.a(new_n29_), .b(new_n19_), .c(new_n57_), .O(new_n58_));
  nand2  g43(.a(x4), .b(new_n17_), .O(new_n59_));
  nand4  g44(.a(new_n59_), .b(new_n16_), .c(x1), .d(new_n19_), .O(new_n60_));
