...
module FAU ( 
  ...
  nand3  g28(.a(new_n34_), .b(x2), .c(new_n17_), .O(new_n44_));
  nand4  g29(.a(x7), .b(new_n38_), .c(new_n16_), .d(x1), .O(new_n45_));
  ...
  oai21  g34(.a(x7), .b(new_n17_), .c(new_n49_), .O(z3));
  nand2  g35(.a(x3), .b(new_n16_), .O(new_n51_));
  nand2  g36(.a(new_n18_), .b(x2), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n51_), .c(new_n20_), .O(new_n53_));
  ...
  nor2   g42(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n20_), .c(new_n56_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n17_), .c(new_n55_), .O(z4));
  ...
  nand4  g49(.a(new_n34_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n65_));
  ...
  nand4  g53(.a(new_n68_), .b(x7), .c(x1), .d(new_n20_), .O(new_n69_));
