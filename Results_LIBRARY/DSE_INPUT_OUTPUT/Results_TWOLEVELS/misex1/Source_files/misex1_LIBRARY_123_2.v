...
module FAU ( 
  ...
  nand3  g29(.a(new_n44_), .b(new_n42_), .c(new_n32_), .O(z2));
  nand3  g30(.a(new_n34_), .b(x2), .c(new_n17_), .O(new_n46_));
  nand4  g31(.a(x7), .b(new_n38_), .c(new_n16_), .d(x1), .O(new_n47_));
  ...
  nand2  g36(.a(new_n51_), .b(new_n44_), .O(z3));
  nand2  g37(.a(x3), .b(new_n16_), .O(new_n53_));
  nand2  g38(.a(new_n18_), .b(x2), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n20_), .O(new_n55_));
  ...
  nor2   g43(.a(new_n58_), .b(new_n43_), .O(new_n59_));
  ...
  aoi21  g48(.a(new_n59_), .b(new_n20_), .c(new_n43_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n17_), .c(new_n63_), .O(z5));
  nand4  g50(.a(new_n34_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n66_));
