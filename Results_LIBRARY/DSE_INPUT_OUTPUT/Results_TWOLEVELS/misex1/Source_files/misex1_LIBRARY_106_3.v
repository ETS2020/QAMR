...
module FAU ( 
  ...
  oai21  g30(.a(new_n34_), .b(x2), .c(new_n27_), .O(new_n46_));
  ...
  nand4  g35(.a(new_n40_), .b(new_n19_), .c(x2), .d(new_n18_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n50_), .c(x0), .O(new_n52_));
  nand2  g37(.a(new_n19_), .b(x2), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n34_), .c(new_n23_), .O(new_n54_));
  or2    g39(.a(new_n54_), .b(new_n52_), .O(z3));
  aoi21  g40(.a(new_n53_), .b(new_n35_), .c(new_n16_), .O(new_n56_));
  oai21  g41(.a(new_n27_), .b(new_n19_), .c(x2), .O(new_n57_));
  nand3  g42(.a(new_n42_), .b(new_n19_), .c(new_n25_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n57_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n56_), .c(new_n18_), .O(new_n60_));
  nand2  g45(.a(new_n19_), .b(new_n25_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n28_), .c(new_n18_), .O(new_n62_));
  nand3  g47(.a(x6), .b(new_n19_), .c(new_n25_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n60_), .O(z4));
  aoi21  g51(.a(new_n29_), .b(new_n16_), .c(new_n56_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(x1), .c(new_n65_), .O(z5));
  nand4  g53(.a(new_n40_), .b(new_n19_), .c(x2), .d(new_n16_), .O(new_n69_));
  ...
  nand2  g58(.a(new_n73_), .b(new_n28_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n16_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(new_n71_), .c(new_n23_), .O(z6));
endmodule
