...
module FAU ( 
  ...
  aoi22  g20(.a(new_n35_), .b(new_n33_), .c(x5), .d(x1), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n32_), .O(z1));
  nand2  g22(.a(new_n21_), .b(x2), .O(new_n38_));
  ...
  nand3  g35(.a(new_n50_), .b(new_n21_), .c(new_n20_), .O(new_n51_));
  nand3  g36(.a(new_n33_), .b(new_n18_), .c(x2), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(z3));
  aoi21  g38(.a(new_n49_), .b(new_n34_), .c(new_n20_), .O(new_n54_));
  ...
  nor2   g42(.a(new_n57_), .b(x5), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(x1), .c(new_n20_), .O(new_n59_));
  ...
  aoi21  g47(.a(new_n58_), .b(new_n20_), .c(x5), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n17_), .c(new_n62_), .O(z5));
  nand4  g49(.a(new_n21_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n65_));
