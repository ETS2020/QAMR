...
module FAU ( 
  ...
  nor2   g30(.a(new_n39_), .b(x1), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x0), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n26_), .O(z5));
  inv1   g33(.a(new_n41_), .O(z6));
endmodule
