...
module FAU ( 
  ...
  oai21  g17(.a(new_n32_), .b(x0), .c(new_n25_), .O(z1));
  ...
  nand3  g29(.a(new_n28_), .b(new_n16_), .c(x1), .O(new_n45_));
  nand2  g30(.a(new_n34_), .b(new_n19_), .O(new_n46_));
  ...
  oai21  g39(.a(new_n54_), .b(x3), .c(new_n26_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n17_), .c(new_n52_), .O(new_n56_));
  oai21  g41(.a(x3), .b(new_n16_), .c(x1), .O(new_n57_));
  nand3  g42(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nor2   g44(.a(new_n19_), .b(new_n17_), .O(new_n60_));
  aoi21  g45(.a(new_n59_), .b(new_n17_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n56_), .b(x1), .c(new_n61_), .O(z4));
  nand2  g47(.a(new_n59_), .b(new_n17_), .O(new_n63_));
  nor2   g48(.a(new_n26_), .b(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n52_), .c(new_n19_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n63_), .O(z5));
  nand3  g51(.a(new_n42_), .b(new_n23_), .c(new_n19_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(x0), .O(new_n68_));
  nand2  g53(.a(x3), .b(x1), .O(new_n69_));
  nand3  g54(.a(new_n53_), .b(new_n20_), .c(new_n19_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n69_), .c(new_n16_), .O(new_n71_));
  oai21  g56(.a(new_n28_), .b(x3), .c(new_n16_), .O(new_n72_));
  nor2   g57(.a(new_n72_), .b(new_n19_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(new_n71_), .c(new_n17_), .O(new_n74_));
