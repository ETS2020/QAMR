...
module FAU ( 
  ...
  nand2  g36(.a(x3), .b(x1), .O(new_n52_));
  oai22  g37(.a(new_n52_), .b(x0), .c(new_n21_), .d(x1), .O(new_n53_));
  aoi22  g38(.a(new_n53_), .b(x2), .c(new_n19_), .d(x0), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(z5));
  inv1   g40(.a(new_n52_), .O(new_n56_));
  nor3   g41(.a(x5), .b(x3), .c(x1), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(x2), .O(new_n58_));
  nand2  g43(.a(x4), .b(new_n23_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n20_), .c(x1), .O(new_n60_));
