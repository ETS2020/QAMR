...
module FAU ( 
  ...
  nand2  g39(.a(new_n49_), .b(new_n48_), .O(new_n55_));
  nand3  g40(.a(new_n55_), .b(new_n30_), .c(new_n17_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n54_), .O(z5));
  nand2  g42(.a(x4), .b(new_n16_), .O(new_n58_));
  nand4  g43(.a(new_n58_), .b(new_n30_), .c(x1), .d(new_n17_), .O(new_n59_));
