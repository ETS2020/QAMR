...
module FAU ( 
  ...
  nand2  g34(.a(new_n25_), .b(x2), .O(new_n50_));
  nand4  g35(.a(x3), .b(new_n16_), .c(new_n21_), .d(x0), .O(new_n51_));
  and2   g36(.a(new_n51_), .b(new_n50_), .O(new_n52_));
