...
module FAU ( 
  ...
  nand4  g30(.a(x5), .b(new_n40_), .c(new_n16_), .d(x1), .O(new_n46_));
  nand3  g31(.a(new_n32_), .b(x2), .c(new_n17_), .O(new_n47_));
  ...
  oai21  g37(.a(new_n52_), .b(new_n32_), .c(x1), .O(new_n53_));
  ...
  nand4  g45(.a(new_n60_), .b(x5), .c(x1), .d(new_n20_), .O(new_n61_));
  ...
  nand4  g50(.a(new_n32_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n66_));
  ...
  nand4  g54(.a(new_n69_), .b(x5), .c(x1), .d(new_n20_), .O(new_n70_));
