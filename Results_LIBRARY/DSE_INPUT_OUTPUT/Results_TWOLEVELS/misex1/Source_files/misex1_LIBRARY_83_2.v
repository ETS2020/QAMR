...
module FAU ( 
  ...
  aoi21  g30(.a(new_n45_), .b(new_n33_), .c(x1), .O(new_n46_));
  ...
  nand2  g35(.a(new_n25_), .b(x2), .O(new_n51_));
  nand4  g36(.a(x3), .b(new_n21_), .c(new_n20_), .d(x0), .O(new_n52_));
  and2   g37(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  ...
  nand3  g42(.a(new_n57_), .b(new_n51_), .c(new_n29_), .O(z5));
