...
module FAU ( 
  ...
  nand3  g02(.a(new_n16_), .b(new_n17_), .c(x0), .O(new_n18_));
  ...
  oai21  g08(.a(x4), .b(new_n16_), .c(new_n23_), .O(z0));
  inv1   g09(.a(x2), .O(new_n25_));
  inv1   g10(.a(x4), .O(new_n26_));
  aoi21  g11(.a(new_n26_), .b(x3), .c(new_n17_), .O(new_n27_));
  ...
  nand2  g20(.a(new_n17_), .b(x0), .O(new_n36_));
  ...
  nand2  g26(.a(new_n31_), .b(x2), .O(new_n42_));
  nand2  g27(.a(new_n28_), .b(new_n25_), .O(new_n43_));
  ...
  nand2  g33(.a(new_n26_), .b(new_n16_), .O(new_n49_));
  inv1   g34(.a(x7), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x4), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n49_), .c(x2), .O(new_n52_));
  nand4  g37(.a(new_n31_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n53_));
  inv1   g38(.a(new_n53_), .O(new_n54_));
  aoi21  g39(.a(new_n52_), .b(x1), .c(new_n54_), .O(new_n55_));
  nand2  g40(.a(new_n16_), .b(x2), .O(new_n56_));
  oai22  g41(.a(new_n56_), .b(new_n36_), .c(new_n55_), .d(x0), .O(z3));
  nand3  g42(.a(x4), .b(x3), .c(new_n25_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n56_), .c(new_n19_), .O(new_n59_));
  oai21  g44(.a(x4), .b(new_n16_), .c(x2), .O(new_n60_));
  nand3  g45(.a(new_n28_), .b(new_n16_), .c(new_n25_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(x0), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n59_), .c(new_n17_), .O(new_n63_));
  oai21  g48(.a(x4), .b(new_n16_), .c(x1), .O(new_n64_));
  nand2  g49(.a(x6), .b(new_n16_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n64_), .c(x2), .O(new_n66_));
  nand4  g51(.a(x4), .b(x3), .c(x2), .d(x1), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(new_n19_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n63_), .O(z4));
  nand2  g55(.a(new_n58_), .b(new_n56_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(x0), .O(new_n72_));
  nand3  g57(.a(new_n32_), .b(x2), .c(new_n19_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand2  g59(.a(new_n74_), .b(new_n17_), .O(new_n75_));
  nand4  g60(.a(x4), .b(x2), .c(x1), .d(new_n19_), .O(new_n76_));
  aoi21  g61(.a(new_n76_), .b(x4), .c(new_n16_), .O(new_n77_));
  aoi21  g62(.a(new_n66_), .b(new_n19_), .c(new_n77_), .O(new_n78_));
  nand2  g63(.a(new_n78_), .b(new_n75_), .O(z5));
  nand4  g64(.a(new_n31_), .b(new_n16_), .c(x2), .d(new_n19_), .O(new_n80_));
  inv1   g65(.a(new_n80_), .O(new_n81_));
  oai21  g66(.a(new_n81_), .b(new_n59_), .c(new_n17_), .O(new_n82_));
  oai21  g67(.a(new_n49_), .b(x2), .c(new_n21_), .O(new_n83_));
  nand3  g68(.a(new_n83_), .b(x1), .c(new_n19_), .O(new_n84_));
  nand2  g69(.a(new_n84_), .b(new_n82_), .O(z6));
endmodule
