...
module FAU ( 
  ...
  aoi22  g14(.a(new_n29_), .b(new_n21_), .c(new_n23_), .d(new_n16_), .O(new_n30_));
  oai21  g15(.a(new_n30_), .b(x0), .c(new_n17_), .O(z1));
  ...
  nand2  g30(.a(new_n45_), .b(new_n17_), .O(z3));
  nand2  g31(.a(new_n23_), .b(new_n16_), .O(new_n47_));
  ...
  nand3  g36(.a(new_n51_), .b(new_n48_), .c(new_n47_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n17_), .O(z4));
  nand2  g39(.a(new_n29_), .b(new_n21_), .O(new_n55_));
  oai21  g40(.a(new_n32_), .b(x1), .c(new_n26_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x2), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n55_), .c(x0), .O(z5));
  aoi21  g43(.a(new_n22_), .b(x2), .c(x0), .O(new_n59_));
