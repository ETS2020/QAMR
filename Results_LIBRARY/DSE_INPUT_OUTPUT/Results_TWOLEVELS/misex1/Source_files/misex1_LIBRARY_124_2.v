...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(new_n27_), .c(new_n19_), .O(new_n31_));
  nor3   g16(.a(new_n16_), .b(new_n26_), .c(x0), .O(new_n32_));
  oai21  g17(.a(new_n32_), .b(new_n31_), .c(new_n18_), .O(new_n33_));
  inv1   g18(.a(new_n17_), .O(new_n34_));
  nand2  g19(.a(x6), .b(new_n19_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n18_), .c(x2), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n28_), .c(new_n34_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n33_), .O(z1));
  nand3  g23(.a(new_n17_), .b(x3), .c(x0), .O(new_n39_));
  inv1   g24(.a(x6), .O(new_n40_));
  nand3  g25(.a(new_n40_), .b(new_n19_), .c(new_n28_), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n39_), .c(x2), .O(new_n42_));
  nand3  g27(.a(new_n16_), .b(new_n29_), .c(new_n19_), .O(new_n43_));
  nor3   g28(.a(new_n43_), .b(new_n26_), .c(x0), .O(new_n44_));
  ...
  oai21  g50(.a(new_n16_), .b(x3), .c(new_n29_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n16_), .O(new_n67_));
  nand4  g52(.a(new_n67_), .b(x2), .c(new_n18_), .d(new_n28_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z4));
  nand3  g54(.a(new_n26_), .b(x1), .c(new_n28_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(x5), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(x4), .O(new_n72_));
  oai21  g57(.a(x4), .b(new_n19_), .c(new_n16_), .O(new_n73_));
  nand2  g58(.a(new_n73_), .b(new_n18_), .O(new_n74_));
  aoi21  g59(.a(new_n74_), .b(new_n22_), .c(new_n26_), .O(new_n75_));
  oai21  g60(.a(x3), .b(new_n26_), .c(new_n29_), .O(new_n76_));
  oai22  g61(.a(new_n76_), .b(new_n18_), .c(new_n35_), .d(x2), .O(new_n77_));
  oai21  g62(.a(new_n77_), .b(new_n75_), .c(new_n28_), .O(new_n78_));
  nand4  g63(.a(new_n60_), .b(new_n17_), .c(new_n18_), .d(x0), .O(new_n79_));
  nand3  g64(.a(new_n79_), .b(new_n78_), .c(new_n72_), .O(z5));
  oai21  g65(.a(new_n62_), .b(new_n23_), .c(new_n17_), .O(new_n81_));
  nand3  g66(.a(new_n16_), .b(x2), .c(new_n18_), .O(new_n82_));
  oai21  g67(.a(x2), .b(new_n18_), .c(new_n82_), .O(new_n83_));
  nand4  g68(.a(new_n83_), .b(new_n29_), .c(new_n19_), .d(new_n28_), .O(new_n84_));
