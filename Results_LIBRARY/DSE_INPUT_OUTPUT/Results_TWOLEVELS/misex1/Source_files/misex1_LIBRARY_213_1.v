...
module FAU ( 
  ...
  oai21  g33(.a(new_n16_), .b(new_n17_), .c(new_n20_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n19_), .O(new_n50_));
  oai21  g35(.a(new_n48_), .b(x0), .c(new_n50_), .O(z4));
  nand2  g36(.a(new_n40_), .b(new_n17_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x2), .c(new_n19_), .O(new_n53_));
  oai21  g38(.a(x4), .b(new_n19_), .c(new_n30_), .O(new_n54_));
