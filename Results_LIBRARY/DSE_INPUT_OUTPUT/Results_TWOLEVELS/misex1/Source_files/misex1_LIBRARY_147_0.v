...
module FAU ( 
  ...
  nor2   g35(.a(x1), .b(new_n17_), .O(new_n51_));
  nor2   g36(.a(x3), .b(new_n16_), .O(new_n52_));
  nor2   g37(.a(x5), .b(x2), .O(new_n53_));
  aoi21  g38(.a(new_n52_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n50_), .b(x0), .c(new_n54_), .O(z3));
  inv1   g40(.a(new_n53_), .O(new_n56_));
  inv1   g41(.a(new_n52_), .O(new_n57_));
  nand3  g42(.a(x5), .b(x3), .c(new_n16_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n57_), .c(new_n17_), .O(new_n59_));
  aoi21  g44(.a(new_n38_), .b(new_n23_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(new_n19_), .O(new_n61_));
  oai21  g46(.a(x5), .b(x2), .c(x3), .O(new_n62_));
  nand2  g47(.a(new_n25_), .b(x3), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(x5), .c(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n62_), .c(new_n19_), .O(new_n65_));
  nand4  g50(.a(x6), .b(x5), .c(new_n20_), .d(new_n16_), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n65_), .c(new_n17_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n61_), .c(new_n56_), .O(z4));
  ...
  oai21  g59(.a(new_n74_), .b(new_n59_), .c(new_n19_), .O(new_n75_));
  nand2  g60(.a(x4), .b(new_n20_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(x5), .c(new_n16_), .O(new_n77_));
  nand2  g62(.a(new_n77_), .b(new_n40_), .O(new_n78_));
