...
module FAU ( 
  ...
  nor2   g05(.a(x7), .b(new_n18_), .O(new_n21_));
  ...
  nand3  g18(.a(new_n33_), .b(new_n21_), .c(new_n16_), .O(new_n34_));
  ...
  nor2   g38(.a(new_n24_), .b(new_n18_), .O(new_n54_));
  aoi21  g39(.a(new_n53_), .b(new_n33_), .c(new_n54_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n51_), .O(z3));
  inv1   g41(.a(new_n54_), .O(new_n57_));
  nand3  g42(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n58_));
  aoi21  g43(.a(new_n52_), .b(new_n58_), .c(new_n20_), .O(new_n59_));
  nand2  g44(.a(new_n28_), .b(x2), .O(new_n60_));
  inv1   g45(.a(x6), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(new_n18_), .c(new_n16_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n60_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n59_), .c(new_n17_), .O(new_n64_));
  nand2  g49(.a(new_n18_), .b(new_n16_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n25_), .c(new_n17_), .O(new_n66_));
  nand3  g51(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(new_n20_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(new_n64_), .c(new_n57_), .O(z4));
  aoi21  g55(.a(new_n27_), .b(new_n20_), .c(new_n59_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(x1), .c(new_n69_), .O(z5));
  nand4  g57(.a(new_n36_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n59_), .c(new_n17_), .O(new_n75_));
  oai21  g60(.a(new_n46_), .b(x2), .c(new_n25_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(x1), .c(new_n20_), .O(new_n77_));
  nand3  g62(.a(new_n77_), .b(new_n75_), .c(new_n57_), .O(z6));
endmodule
