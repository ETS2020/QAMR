...
module FAU ( 
  ...
  nand2  g20(.a(new_n26_), .b(new_n17_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(x7), .O(new_n37_));
  aoi21  g22(.a(new_n37_), .b(x1), .c(x2), .O(new_n38_));
  nand4  g23(.a(new_n17_), .b(x2), .c(new_n16_), .d(x0), .O(new_n39_));
  ...
  nand3  g28(.a(new_n43_), .b(new_n16_), .c(x0), .O(new_n44_));
  nand2  g29(.a(x3), .b(new_n16_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n20_), .c(new_n25_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(z4));
  aoi21  g32(.a(new_n36_), .b(x2), .c(new_n16_), .O(new_n48_));
  oai21  g33(.a(new_n31_), .b(x3), .c(new_n20_), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(new_n25_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n44_), .O(z5));
  aoi21  g36(.a(new_n42_), .b(new_n36_), .c(new_n16_), .O(new_n52_));
