...
module FAU ( 
  ...
  oai21  g17(.a(x6), .b(x5), .c(x2), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n19_), .c(new_n24_), .O(new_n34_));
  aoi21  g19(.a(x4), .b(new_n16_), .c(x3), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n24_), .c(new_n34_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n17_), .O(new_n37_));
  nand2  g22(.a(new_n16_), .b(x0), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(new_n19_), .c(new_n20_), .O(new_n39_));
  ...
  nor2   g28(.a(x6), .b(x5), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n19_), .c(x2), .d(new_n24_), .O(new_n45_));
  ...
  nand3  g37(.a(new_n19_), .b(new_n16_), .c(new_n17_), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n20_), .O(new_n54_));
  ...
  nand3  g44(.a(new_n59_), .b(new_n51_), .c(new_n20_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n24_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n57_), .O(z5));
  nand4  g47(.a(new_n25_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n51_), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n20_), .c(new_n24_), .O(new_n65_));
