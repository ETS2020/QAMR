...
module FAU ( 
  ...
  nand4  g35(.a(new_n21_), .b(new_n20_), .c(new_n19_), .d(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(z3));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x0), .O(new_n54_));
  nand2  g39(.a(x2), .b(new_n17_), .O(new_n55_));
  nand4  g40(.a(new_n34_), .b(new_n19_), .c(new_n16_), .d(new_n17_), .O(new_n56_));
  nand4  g41(.a(new_n56_), .b(new_n55_), .c(new_n54_), .d(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  aoi21  g43(.a(new_n19_), .b(x2), .c(new_n24_), .O(new_n59_));
  nand4  g44(.a(new_n20_), .b(x6), .c(new_n19_), .d(new_n16_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n58_), .O(z4));
  nand3  g48(.a(new_n26_), .b(x2), .c(new_n17_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n54_), .c(x1), .O(new_n65_));
  nand4  g50(.a(x6), .b(new_n19_), .c(new_n16_), .d(new_n17_), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n65_), .c(new_n20_), .O(new_n68_));
  nand2  g53(.a(new_n59_), .b(new_n17_), .O(new_n69_));
  nand2  g54(.a(new_n69_), .b(new_n68_), .O(z5));
  nand2  g55(.a(x2), .b(new_n17_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n26_), .c(new_n54_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n20_), .c(new_n24_), .O(new_n73_));
