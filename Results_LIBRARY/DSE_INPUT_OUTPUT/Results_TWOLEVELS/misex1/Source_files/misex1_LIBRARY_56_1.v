...
module FAU ( 
  ...
  aoi21  g28(.a(new_n43_), .b(x3), .c(x7), .O(new_n44_));
  ...
  nand4  g33(.a(new_n48_), .b(new_n16_), .c(x2), .d(new_n24_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n17_), .O(new_n51_));
  nand4  g36(.a(new_n32_), .b(new_n23_), .c(new_n16_), .d(x2), .O(new_n52_));
  ...
  nand3  g53(.a(new_n68_), .b(new_n55_), .c(new_n23_), .O(new_n69_));
