...
module FAU ( 
  ...
  nand3  g30(.a(new_n40_), .b(new_n18_), .c(x1), .O(new_n46_));
  nand3  g31(.a(new_n36_), .b(x2), .c(new_n16_), .O(new_n47_));
  ...
  nand2  g53(.a(new_n40_), .b(new_n22_), .O(new_n69_));
  oai22  g54(.a(new_n69_), .b(x2), .c(new_n17_), .d(new_n22_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n25_), .c(new_n17_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n16_), .c(new_n68_), .O(z6));
endmodule
