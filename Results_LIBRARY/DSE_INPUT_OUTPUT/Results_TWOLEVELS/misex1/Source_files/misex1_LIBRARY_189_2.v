...
module FAU ( 
  ...
  nor2   g07(.a(x6), .b(new_n19_), .O(new_n23_));
  ...
  nand2  g15(.a(new_n29_), .b(new_n19_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(x1), .O(new_n32_));
  oai21  g17(.a(new_n30_), .b(x3), .c(new_n32_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n26_), .c(new_n28_), .O(new_n34_));
  nand3  g19(.a(new_n26_), .b(new_n18_), .c(x0), .O(new_n35_));
  ...
  aoi21  g27(.a(new_n42_), .b(new_n40_), .c(x1), .O(new_n43_));
  aoi21  g28(.a(x4), .b(new_n26_), .c(x3), .O(new_n44_));
  ...
  nand2  g32(.a(new_n31_), .b(x7), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n26_), .c(x1), .O(new_n49_));
  nand3  g34(.a(new_n39_), .b(x2), .c(new_n18_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n16_), .O(new_n52_));
  nor2   g37(.a(x1), .b(new_n16_), .O(new_n53_));
  nor2   g38(.a(x3), .b(new_n26_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n23_), .O(new_n55_));
  ...
  oai21  g46(.a(new_n61_), .b(x3), .c(x2), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n42_), .c(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n59_), .c(new_n18_), .O(new_n64_));
  ...
  aoi21  g52(.a(new_n67_), .b(new_n16_), .c(new_n23_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n64_), .O(z4));
  nor2   g54(.a(new_n27_), .b(x0), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n59_), .c(new_n18_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n68_), .O(z5));
  nand3  g57(.a(new_n39_), .b(x2), .c(new_n16_), .O(new_n73_));
  inv1   g58(.a(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(new_n59_), .c(new_n18_), .O(new_n75_));
  oai21  g60(.a(x4), .b(x2), .c(new_n19_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(x1), .c(new_n16_), .O(new_n77_));
  nand3  g62(.a(new_n77_), .b(new_n75_), .c(new_n24_), .O(z6));
endmodule
