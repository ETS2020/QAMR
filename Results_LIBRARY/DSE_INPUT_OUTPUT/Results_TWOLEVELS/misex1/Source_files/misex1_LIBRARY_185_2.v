...
module FAU ( 
  ...
  nor3   g15(.a(new_n30_), .b(new_n27_), .c(x0), .O(new_n31_));
  nor3   g16(.a(x5), .b(x3), .c(x1), .O(new_n32_));
  oai21  g17(.a(new_n32_), .b(new_n31_), .c(x2), .O(new_n33_));
  inv1   g18(.a(x6), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n30_), .c(new_n27_), .O(new_n35_));
  oai21  g20(.a(new_n24_), .b(x0), .c(new_n35_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n19_), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n33_), .c(new_n28_), .O(z2));
  oai21  g23(.a(x4), .b(x3), .c(x7), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n19_), .c(x1), .d(new_n16_), .O(new_n40_));
  ...
  aoi21  g29(.a(x5), .b(new_n27_), .c(x3), .O(new_n45_));
  nor2   g30(.a(new_n45_), .b(new_n19_), .O(new_n46_));
  aoi21  g31(.a(new_n25_), .b(new_n19_), .c(new_n46_), .O(new_n47_));
  ...
  oai21  g36(.a(new_n51_), .b(x0), .c(new_n27_), .O(new_n52_));
