...
module FAU ( 
  ...
  nand2  g26(.a(new_n41_), .b(new_n25_), .O(z2));
  ...
  nand2  g33(.a(new_n19_), .b(x0), .O(new_n49_));
  nand2  g34(.a(new_n20_), .b(x2), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n49_), .c(new_n48_), .O(z3));
  aoi21  g36(.a(new_n50_), .b(new_n23_), .c(new_n17_), .O(new_n52_));
  ...
  nand3  g50(.a(new_n50_), .b(new_n23_), .c(new_n19_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(x0), .O(new_n67_));
  nand2  g52(.a(x3), .b(x1), .O(new_n68_));
  nand2  g53(.a(new_n45_), .b(new_n19_), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n68_), .c(new_n16_), .O(new_n70_));
  oai21  g55(.a(new_n28_), .b(x3), .c(new_n16_), .O(new_n71_));
