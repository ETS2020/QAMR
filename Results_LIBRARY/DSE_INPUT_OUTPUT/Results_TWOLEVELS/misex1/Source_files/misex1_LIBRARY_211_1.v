...
module FAU ( 
  ...
  nand3  g23(.a(new_n23_), .b(x4), .c(new_n16_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(new_n38_), .c(new_n19_), .O(new_n40_));
  aoi21  g25(.a(new_n37_), .b(new_n19_), .c(new_n40_), .O(new_n41_));
  ...
  nand3  g35(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n49_), .c(new_n17_), .O(new_n52_));
  oai21  g37(.a(new_n36_), .b(x3), .c(new_n27_), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n17_), .c(new_n52_), .O(new_n54_));
  nor2   g39(.a(new_n23_), .b(x2), .O(new_n55_));
  aoi21  g40(.a(x3), .b(x2), .c(new_n43_), .O(new_n56_));
  nand3  g41(.a(x6), .b(new_n20_), .c(new_n16_), .O(new_n57_));
  oai21  g42(.a(new_n56_), .b(new_n19_), .c(new_n57_), .O(new_n58_));
  ...
  nand2  g53(.a(new_n68_), .b(new_n38_), .O(new_n69_));
