...
module FAU ( 
  ...
  oai21  g13(.a(new_n28_), .b(new_n24_), .c(new_n17_), .O(new_n29_));
  nor2   g14(.a(x1), .b(new_n17_), .O(new_n30_));
  aoi21  g15(.a(new_n30_), .b(x3), .c(x4), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(x2), .c(new_n29_), .O(z1));
  ...
  nand3  g25(.a(new_n40_), .b(new_n19_), .c(new_n17_), .O(new_n41_));
  nor2   g26(.a(new_n25_), .b(x2), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n41_), .c(new_n36_), .O(z2));
  ...
  aoi21  g37(.a(new_n52_), .b(new_n30_), .c(new_n42_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n50_), .O(z3));
  nand3  g39(.a(new_n25_), .b(x3), .c(new_n16_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n51_), .c(new_n17_), .O(new_n56_));
  oai21  g41(.a(new_n39_), .b(x3), .c(new_n23_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n17_), .c(new_n56_), .O(new_n58_));
  oai21  g43(.a(new_n33_), .b(x3), .c(x1), .O(new_n59_));
  oai21  g44(.a(new_n27_), .b(x2), .c(new_n59_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n17_), .c(new_n42_), .O(new_n61_));
  oai21  g46(.a(new_n58_), .b(x1), .c(new_n61_), .O(z4));
  nor2   g47(.a(new_n23_), .b(x0), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n56_), .c(new_n19_), .O(new_n64_));
  ...
  oai21  g54(.a(x4), .b(x2), .c(new_n69_), .O(new_n70_));
