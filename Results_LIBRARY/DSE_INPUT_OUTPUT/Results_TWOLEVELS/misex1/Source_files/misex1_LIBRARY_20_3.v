...
module FAU ( 
  ...
  nand3  g29(.a(new_n27_), .b(new_n24_), .c(x1), .O(new_n45_));
  nand2  g30(.a(new_n37_), .b(new_n16_), .O(new_n46_));
  ...
  aoi21  g36(.a(new_n32_), .b(new_n18_), .c(new_n21_), .O(new_n52_));
  inv1   g37(.a(x5), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(x2), .c(new_n38_), .O(new_n54_));
  ...
  nand3  g49(.a(new_n32_), .b(new_n18_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(x0), .O(new_n66_));
  nand2  g51(.a(x3), .b(x1), .O(new_n67_));
  nand3  g52(.a(new_n53_), .b(new_n17_), .c(new_n16_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n67_), .c(new_n24_), .O(new_n69_));
  oai21  g54(.a(new_n27_), .b(x3), .c(new_n24_), .O(new_n70_));
  nor2   g55(.a(new_n70_), .b(new_n16_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n69_), .c(new_n21_), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n66_), .O(z6));
endmodule
