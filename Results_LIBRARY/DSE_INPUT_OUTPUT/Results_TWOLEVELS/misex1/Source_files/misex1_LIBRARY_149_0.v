...
module FAU ( 
  ...
  aoi21  g10(.a(new_n25_), .b(x3), .c(x2), .O(new_n26_));
  nand3  g11(.a(new_n26_), .b(x1), .c(new_n16_), .O(new_n27_));
  ...
  aoi21  g21(.a(new_n21_), .b(new_n20_), .c(new_n29_), .O(new_n37_));
  aoi21  g22(.a(new_n26_), .b(x1), .c(new_n37_), .O(new_n38_));
  oai21  g23(.a(x2), .b(new_n16_), .c(x3), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n20_), .O(new_n40_));
  oai21  g25(.a(new_n38_), .b(x0), .c(new_n40_), .O(z4));
  oai21  g26(.a(x4), .b(x2), .c(new_n29_), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(x1), .c(new_n16_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n32_), .O(z6));
  oai21  g29(.a(new_n38_), .b(x0), .c(new_n40_), .O(z5));
endmodule
