...
module FAU ( 
  ...
  nand2  g35(.a(new_n30_), .b(x7), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n40_), .c(x1), .O(new_n52_));
  inv1   g37(.a(new_n52_), .O(new_n53_));
  nand3  g38(.a(new_n38_), .b(x4), .c(new_n19_), .O(new_n54_));
  nor3   g39(.a(new_n54_), .b(new_n40_), .c(x1), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n16_), .O(new_n56_));
  aoi21  g41(.a(new_n34_), .b(new_n19_), .c(new_n29_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n40_), .c(new_n56_), .O(z3));
  inv1   g43(.a(new_n35_), .O(new_n59_));
  nand3  g44(.a(x4), .b(new_n19_), .c(x2), .O(new_n60_));
  ...
  nand4  g48(.a(x4), .b(x3), .c(x1), .d(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(x4), .c(new_n40_), .O(new_n65_));
  aoi21  g50(.a(new_n32_), .b(new_n16_), .c(new_n65_), .O(new_n66_));
  ...
  nor3   g55(.a(new_n54_), .b(new_n40_), .c(x0), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n61_), .c(new_n18_), .O(new_n72_));
  oai21  g57(.a(new_n29_), .b(x3), .c(new_n40_), .O(new_n73_));
