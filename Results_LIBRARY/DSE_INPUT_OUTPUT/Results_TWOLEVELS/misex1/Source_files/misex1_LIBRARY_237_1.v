...
module FAU ( 
  ...
  oai21  g32(.a(new_n44_), .b(new_n31_), .c(new_n19_), .O(new_n48_));
  ...
  oai21  g36(.a(new_n16_), .b(new_n17_), .c(new_n20_), .O(new_n52_));
  ...
  oai21  g43(.a(x4), .b(new_n19_), .c(new_n58_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n16_), .c(new_n17_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n57_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n20_), .O(new_n62_));
  nand2  g47(.a(new_n35_), .b(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(z5));
  inv1   g49(.a(new_n21_), .O(new_n65_));
  nand2  g50(.a(x3), .b(x1), .O(new_n66_));
  nand2  g51(.a(new_n30_), .b(new_n19_), .O(new_n67_));
