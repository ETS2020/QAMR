...
module FAU ( 
  ...
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n36_), .O(z2));
  nand2  g34(.a(new_n29_), .b(x7), .O(new_n50_));
  ...
  nor3   g38(.a(new_n53_), .b(new_n34_), .c(x1), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n52_), .c(new_n17_), .O(new_n55_));
  nand3  g40(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n33_), .c(new_n55_), .O(z3));
  aoi21  g42(.a(new_n56_), .b(new_n35_), .c(new_n17_), .O(new_n58_));
  aoi21  g43(.a(new_n43_), .b(new_n24_), .c(x0), .O(new_n59_));
  ...
  aoi22  g47(.a(new_n62_), .b(x2), .c(new_n31_), .d(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n60_), .O(z4));
  nor2   g49(.a(new_n24_), .b(x0), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n58_), .c(new_n19_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  nand2  g52(.a(new_n62_), .b(x2), .O(new_n68_));
  nor3   g53(.a(new_n53_), .b(new_n34_), .c(x0), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n58_), .c(new_n19_), .O(new_n70_));
  nand2  g55(.a(x4), .b(new_n20_), .O(new_n71_));
  nand4  g56(.a(new_n71_), .b(new_n34_), .c(x1), .d(new_n17_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n70_), .c(new_n68_), .O(z6));
endmodule
