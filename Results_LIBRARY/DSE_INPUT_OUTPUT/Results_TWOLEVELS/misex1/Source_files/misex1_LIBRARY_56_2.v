...
module FAU ( 
  ...
  nand2  g31(.a(new_n17_), .b(x1), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n46_), .c(new_n36_), .O(z2));
  nand4  g33(.a(x7), .b(new_n42_), .c(new_n18_), .d(x1), .O(new_n49_));
  oai21  g34(.a(new_n39_), .b(x1), .c(new_n49_), .O(new_n50_));
  ...
  aoi21  g38(.a(new_n35_), .b(new_n23_), .c(new_n25_), .O(new_n54_));
  aoi21  g39(.a(x3), .b(new_n18_), .c(x0), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n54_), .c(new_n16_), .O(new_n56_));
  nand2  g41(.a(new_n22_), .b(x2), .O(new_n57_));
  nand4  g42(.a(new_n57_), .b(x7), .c(x1), .d(new_n25_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z4));
  aoi21  g44(.a(new_n27_), .b(new_n26_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n54_), .c(new_n16_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n58_), .O(z5));
  nand3  g47(.a(new_n19_), .b(new_n38_), .c(new_n22_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n54_), .c(new_n16_), .O(new_n65_));
  aoi21  g50(.a(new_n42_), .b(new_n18_), .c(x3), .O(new_n66_));
