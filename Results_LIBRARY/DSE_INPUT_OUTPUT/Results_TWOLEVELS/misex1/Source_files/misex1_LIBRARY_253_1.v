...
module FAU ( 
  ...
  aoi21  g12(.a(new_n27_), .b(new_n24_), .c(x1), .O(z1));
  ...
  nand3  g17(.a(new_n32_), .b(new_n17_), .c(new_n29_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n27_), .c(x1), .O(z2));
  ...
  aoi21  g24(.a(new_n38_), .b(new_n25_), .c(new_n29_), .O(new_n40_));
  inv1   g25(.a(new_n40_), .O(new_n41_));
  oai21  g26(.a(new_n17_), .b(x2), .c(new_n29_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x1), .O(z4));
  oai21  g28(.a(new_n40_), .b(new_n23_), .c(new_n16_), .O(new_n44_));
  nand2  g29(.a(x1), .b(new_n29_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n44_), .O(z5));
  nand3  g31(.a(new_n36_), .b(x2), .c(new_n29_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n41_), .c(x1), .O(z6));
endmodule
