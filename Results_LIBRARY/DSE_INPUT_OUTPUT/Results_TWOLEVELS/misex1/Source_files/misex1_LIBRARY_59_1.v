...
module FAU ( 
  ...
  nand4  g13(.a(new_n28_), .b(new_n17_), .c(x2), .d(new_n20_), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n26_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n16_), .O(new_n31_));
  nor3   g16(.a(x6), .b(x3), .c(x2), .O(new_n32_));
  oai21  g17(.a(new_n32_), .b(x1), .c(new_n20_), .O(new_n33_));
  ...
  aoi21  g24(.a(new_n39_), .b(new_n38_), .c(new_n20_), .O(new_n40_));
  nor2   g25(.a(x5), .b(new_n22_), .O(new_n41_));
  ...
  nand2  g31(.a(new_n46_), .b(new_n33_), .O(z4));
  aoi21  g32(.a(new_n24_), .b(new_n20_), .c(new_n40_), .O(new_n48_));
  nor2   g33(.a(new_n48_), .b(x1), .O(z5));
  inv1   g34(.a(new_n29_), .O(new_n50_));
  oai21  g35(.a(new_n40_), .b(new_n50_), .c(new_n16_), .O(new_n51_));
