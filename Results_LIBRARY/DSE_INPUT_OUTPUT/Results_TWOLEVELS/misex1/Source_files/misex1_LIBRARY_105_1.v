...
module FAU ( 
  ...
  aoi21  g23(.a(new_n38_), .b(new_n37_), .c(x6), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(new_n20_), .c(new_n17_), .O(new_n40_));
  ...
  aoi21  g30(.a(new_n45_), .b(new_n43_), .c(x0), .O(new_n46_));
  nand3  g31(.a(new_n23_), .b(new_n19_), .c(x2), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(new_n22_), .O(new_n49_));
  ...
  nand3  g38(.a(new_n22_), .b(new_n19_), .c(x2), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n17_), .O(new_n55_));
  aoi21  g40(.a(x5), .b(x2), .c(new_n19_), .O(new_n56_));
  nand2  g41(.a(x3), .b(x2), .O(new_n57_));
  oai21  g42(.a(new_n56_), .b(x6), .c(new_n57_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n17_), .c(new_n55_), .O(new_n59_));
  oai21  g44(.a(new_n29_), .b(x2), .c(new_n19_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(x1), .c(new_n17_), .O(new_n61_));
  oai21  g46(.a(new_n59_), .b(x1), .c(new_n61_), .O(z4));
  nand2  g47(.a(new_n54_), .b(new_n53_), .O(new_n63_));
  ...
  nand2  g52(.a(x6), .b(new_n19_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n67_), .c(new_n61_), .O(z5));
  nand3  g54(.a(new_n22_), .b(new_n44_), .c(new_n19_), .O(new_n70_));
  nor3   g55(.a(new_n70_), .b(new_n16_), .c(x0), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n55_), .c(new_n18_), .O(new_n72_));
  inv1   g57(.a(x4), .O(new_n73_));
  nand2  g58(.a(new_n22_), .b(new_n73_), .O(new_n74_));
  oai21  g59(.a(new_n74_), .b(x2), .c(new_n19_), .O(new_n75_));
  nand3  g60(.a(new_n75_), .b(x1), .c(new_n17_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(new_n72_), .c(new_n68_), .O(z6));
endmodule
