...
module FAU ( 
  ...
  nand2  g17(.a(x3), .b(new_n23_), .O(new_n33_));
  inv1   g18(.a(new_n33_), .O(new_n34_));
  nand3  g19(.a(new_n34_), .b(new_n32_), .c(x0), .O(new_n35_));
  oai21  g20(.a(new_n31_), .b(x0), .c(new_n35_), .O(z1));
  oai21  g21(.a(new_n34_), .b(x1), .c(x0), .O(new_n37_));
  nor2   g22(.a(x5), .b(new_n23_), .O(new_n38_));
  nor2   g23(.a(x6), .b(x2), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(new_n38_), .c(new_n16_), .O(new_n40_));
  oai21  g25(.a(new_n26_), .b(x2), .c(new_n16_), .O(new_n41_));
