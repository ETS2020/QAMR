...
module FAU ( 
  ...
  oai21  g41(.a(x3), .b(new_n24_), .c(x1), .O(new_n57_));
  nand3  g42(.a(x6), .b(new_n17_), .c(new_n24_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nor2   g44(.a(new_n16_), .b(new_n21_), .O(new_n60_));
  aoi21  g45(.a(new_n59_), .b(new_n21_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n56_), .b(x1), .c(new_n61_), .O(z4));
  nand2  g47(.a(new_n59_), .b(new_n21_), .O(new_n63_));
  nor2   g48(.a(new_n28_), .b(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n52_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n63_), .O(z5));
  nand4  g51(.a(new_n53_), .b(new_n17_), .c(x2), .d(new_n21_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n52_), .c(new_n16_), .O(new_n69_));
  oai21  g54(.a(x4), .b(x2), .c(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(x1), .c(new_n21_), .O(new_n71_));
