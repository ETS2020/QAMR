...
module FAU ( 
  ...
  nand2  g32(.a(new_n19_), .b(x0), .O(new_n48_));
  nand2  g33(.a(new_n20_), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(z3));
  aoi21  g35(.a(new_n49_), .b(new_n23_), .c(new_n17_), .O(new_n51_));
  inv1   g36(.a(x5), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(x2), .c(new_n37_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x3), .c(new_n30_), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n17_), .c(new_n51_), .O(new_n55_));
  inv1   g40(.a(new_n28_), .O(new_n56_));
  nand3  g41(.a(new_n20_), .b(x2), .c(new_n17_), .O(new_n57_));
  nor2   g42(.a(x2), .b(x0), .O(new_n58_));
  aoi22  g43(.a(new_n58_), .b(new_n56_), .c(new_n57_), .d(x1), .O(new_n59_));
  oai21  g44(.a(new_n55_), .b(x1), .c(new_n59_), .O(z4));
  nor2   g45(.a(new_n30_), .b(x0), .O(new_n61_));
