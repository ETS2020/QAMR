...
module FAU ( 
  ...
  nand2  g07(.a(new_n16_), .b(new_n19_), .O(new_n23_));
  oai21  g08(.a(new_n23_), .b(new_n20_), .c(x5), .O(new_n24_));
  ...
  oai21  g24(.a(new_n28_), .b(x2), .c(new_n20_), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(x1), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n39_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n17_), .O(new_n43_));
  nor2   g28(.a(new_n34_), .b(new_n20_), .O(new_n44_));
  nand4  g29(.a(new_n44_), .b(new_n16_), .c(new_n19_), .d(x0), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n43_), .O(z2));
  nor2   g31(.a(new_n16_), .b(x1), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n20_), .c(new_n34_), .O(new_n48_));
  oai21  g33(.a(x4), .b(x3), .c(x7), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n16_), .c(x1), .O(new_n50_));
  nand2  g35(.a(new_n47_), .b(new_n26_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n17_), .O(new_n53_));
  oai21  g38(.a(new_n48_), .b(new_n17_), .c(new_n53_), .O(z3));
  xor2a  g39(.a(x3), .b(x2), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x0), .O(new_n56_));
  nand2  g41(.a(x2), .b(new_n17_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n56_), .c(new_n34_), .O(new_n58_));
  oai21  g43(.a(new_n34_), .b(x3), .c(x2), .O(new_n59_));
  nand3  g44(.a(new_n36_), .b(new_n20_), .c(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n59_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n58_), .c(new_n19_), .O(new_n62_));
  aoi21  g47(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n63_));
  ...
  aoi21  g55(.a(new_n55_), .b(new_n19_), .c(new_n34_), .O(new_n71_));
  nand2  g56(.a(x3), .b(x1), .O(new_n72_));
  nand2  g57(.a(new_n26_), .b(new_n19_), .O(new_n73_));
  aoi21  g58(.a(new_n73_), .b(new_n72_), .c(new_n16_), .O(new_n74_));
  oai21  g59(.a(new_n28_), .b(x3), .c(new_n16_), .O(new_n75_));
  nor2   g60(.a(new_n75_), .b(new_n19_), .O(new_n76_));
  oai21  g61(.a(new_n76_), .b(new_n74_), .c(new_n17_), .O(new_n77_));
  oai21  g62(.a(new_n71_), .b(new_n17_), .c(new_n77_), .O(z6));
endmodule
