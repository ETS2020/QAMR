...
module FAU ( 
  ...
  nor3   g51(.a(new_n34_), .b(new_n18_), .c(x1), .O(new_n67_));
  nand2  g52(.a(x3), .b(x1), .O(new_n68_));
  nand2  g53(.a(new_n48_), .b(new_n32_), .O(new_n69_));
  aoi21  g54(.a(new_n69_), .b(new_n68_), .c(new_n23_), .O(new_n70_));
  oai21  g55(.a(new_n26_), .b(x3), .c(new_n23_), .O(new_n71_));
  nor2   g56(.a(new_n71_), .b(new_n32_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(new_n70_), .c(new_n20_), .O(new_n73_));
  oai21  g58(.a(new_n67_), .b(new_n20_), .c(new_n73_), .O(z6));
endmodule
