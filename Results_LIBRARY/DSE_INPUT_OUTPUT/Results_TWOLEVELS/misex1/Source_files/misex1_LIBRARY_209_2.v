...
module FAU ( 
  ...
  inv1   g31(.a(new_n23_), .O(new_n47_));
  ...
  nor2   g43(.a(new_n26_), .b(new_n16_), .O(new_n59_));
  nor3   g44(.a(x5), .b(x3), .c(x1), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n59_), .c(x2), .O(new_n61_));
  nand2  g46(.a(x4), .b(new_n26_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n21_), .c(x1), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n61_), .c(x0), .O(z6));
endmodule
