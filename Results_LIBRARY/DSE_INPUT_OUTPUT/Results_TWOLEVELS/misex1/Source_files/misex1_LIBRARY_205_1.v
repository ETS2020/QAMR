...
module FAU ( 
  ...
  oai21  g20(.a(new_n32_), .b(x3), .c(new_n35_), .O(new_n36_));
  nand4  g21(.a(new_n36_), .b(new_n31_), .c(new_n16_), .d(new_n17_), .O(new_n37_));
  ...
  oai21  g41(.a(new_n31_), .b(x3), .c(x2), .O(new_n57_));
  nand3  g42(.a(new_n32_), .b(new_n31_), .c(new_n23_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n57_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n56_), .c(new_n27_), .O(new_n60_));
  nand3  g45(.a(new_n34_), .b(new_n31_), .c(new_n16_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n23_), .c(new_n27_), .O(new_n62_));
  nand4  g47(.a(x6), .b(new_n31_), .c(new_n23_), .d(new_n16_), .O(new_n63_));
  ...
  aoi21  g55(.a(new_n70_), .b(new_n21_), .c(new_n56_), .O(new_n71_));
  nand2  g56(.a(new_n31_), .b(new_n33_), .O(new_n72_));
  oai21  g57(.a(new_n72_), .b(x2), .c(new_n23_), .O(new_n73_));
