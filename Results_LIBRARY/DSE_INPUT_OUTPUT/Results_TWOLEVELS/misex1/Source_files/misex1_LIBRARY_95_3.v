...
module FAU ( 
  ...
  oai22  g17(.a(new_n32_), .b(x3), .c(new_n18_), .d(new_n17_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n26_), .c(new_n31_), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(x0), .c(new_n29_), .O(z1));
  nor2   g20(.a(x5), .b(new_n26_), .O(new_n36_));
  nor2   g21(.a(x6), .b(x2), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n36_), .c(new_n25_), .O(new_n38_));
  oai21  g23(.a(new_n16_), .b(x2), .c(new_n25_), .O(new_n39_));
  ...
  oai21  g35(.a(x2), .b(new_n17_), .c(new_n22_), .O(new_n51_));
  ...
  aoi21  g40(.a(new_n38_), .b(new_n30_), .c(x0), .O(new_n56_));
  ...
  nand3  g44(.a(x6), .b(new_n25_), .c(new_n26_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n22_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n57_), .c(new_n52_), .O(z4));
  nor2   g48(.a(new_n30_), .b(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n55_), .c(new_n17_), .O(new_n65_));
  inv1   g50(.a(new_n60_), .O(new_n66_));
  aoi21  g51(.a(new_n25_), .b(x2), .c(new_n17_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n66_), .c(new_n22_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z5));
  nand3  g54(.a(new_n46_), .b(x2), .c(new_n22_), .O(new_n70_));
  nand2  g55(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n17_), .O(new_n72_));
  oai21  g57(.a(new_n59_), .b(x0), .c(new_n72_), .O(z6));
endmodule
