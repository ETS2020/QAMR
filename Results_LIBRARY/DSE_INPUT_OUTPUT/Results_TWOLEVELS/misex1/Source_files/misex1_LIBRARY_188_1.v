...
module FAU ( 
  ...
  aoi22  g47(.a(new_n44_), .b(new_n17_), .c(x4), .d(new_n23_), .O(new_n63_));
  oai21  g48(.a(new_n62_), .b(x4), .c(new_n63_), .O(z4));
  nand2  g49(.a(new_n44_), .b(new_n17_), .O(new_n65_));
  nand2  g50(.a(new_n26_), .b(new_n17_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n57_), .c(x1), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n61_), .c(new_n37_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z5));
  nand4  g54(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n17_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n57_), .c(new_n37_), .O(new_n71_));
