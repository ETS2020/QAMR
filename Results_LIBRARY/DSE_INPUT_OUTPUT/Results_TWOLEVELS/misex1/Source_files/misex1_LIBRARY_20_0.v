...
module FAU ( 
  ...
  oai21  g29(.a(new_n40_), .b(new_n24_), .c(new_n16_), .O(new_n45_));
  oai21  g30(.a(x4), .b(x2), .c(new_n29_), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(x1), .c(new_n24_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n45_), .O(z6));
  nand2  g33(.a(new_n43_), .b(new_n41_), .O(z5));
endmodule
