...
module FAU ( 
  ...
  nand3  g30(.a(x6), .b(new_n39_), .c(new_n21_), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(x7), .c(x2), .O(new_n47_));
  nor2   g32(.a(new_n16_), .b(x1), .O(new_n48_));
  aoi22  g33(.a(new_n48_), .b(new_n45_), .c(new_n47_), .d(x1), .O(new_n49_));
  oai21  g34(.a(new_n20_), .b(new_n16_), .c(x6), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n21_), .O(new_n51_));
  oai21  g36(.a(new_n49_), .b(x0), .c(new_n51_), .O(z3));
  nand3  g37(.a(x6), .b(new_n21_), .c(x2), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(new_n31_), .c(new_n17_), .O(new_n54_));
  aoi21  g39(.a(x6), .b(new_n35_), .c(x3), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n16_), .c(new_n26_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n17_), .c(new_n54_), .O(new_n57_));
  oai21  g42(.a(new_n22_), .b(x2), .c(new_n28_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n17_), .O(new_n59_));
  oai21  g44(.a(new_n57_), .b(x1), .c(new_n59_), .O(z4));
  ...
  oai21  g48(.a(new_n54_), .b(new_n37_), .c(new_n19_), .O(new_n64_));
  oai21  g49(.a(new_n46_), .b(x2), .c(new_n21_), .O(new_n65_));
