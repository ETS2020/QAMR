...
module FAU ( 
  ...
  aoi21  g40(.a(new_n50_), .b(new_n55_), .c(new_n20_), .O(new_n56_));
  oai21  g41(.a(x7), .b(new_n18_), .c(x2), .O(new_n57_));
  nand3  g42(.a(new_n27_), .b(new_n18_), .c(new_n16_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n57_), .c(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n56_), .c(new_n17_), .O(new_n60_));
  nor2   g45(.a(x3), .b(x2), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n22_), .c(x1), .O(new_n62_));
  nand3  g47(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n20_), .c(new_n52_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n60_), .O(z4));
  aoi21  g51(.a(new_n26_), .b(new_n20_), .c(new_n56_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(x1), .c(new_n65_), .O(z5));
  ...
  oai21  g56(.a(new_n44_), .b(x2), .c(new_n21_), .O(new_n72_));
