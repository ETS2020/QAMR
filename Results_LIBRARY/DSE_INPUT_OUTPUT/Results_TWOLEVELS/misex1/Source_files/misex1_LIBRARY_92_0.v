...
module FAU ( 
  ...
  aoi21  g45(.a(new_n59_), .b(new_n16_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(x4), .b(x2), .c(new_n24_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(x1), .c(new_n20_), .O(new_n63_));
  oai21  g48(.a(new_n61_), .b(new_n23_), .c(new_n63_), .O(z4));
  nand3  g49(.a(new_n26_), .b(x2), .c(new_n20_), .O(new_n65_));
  aoi21  g50(.a(new_n65_), .b(new_n57_), .c(x1), .O(new_n66_));
  nand3  g51(.a(new_n30_), .b(new_n28_), .c(new_n20_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n66_), .c(x4), .O(new_n69_));
  nand2  g54(.a(new_n23_), .b(new_n16_), .O(new_n70_));
