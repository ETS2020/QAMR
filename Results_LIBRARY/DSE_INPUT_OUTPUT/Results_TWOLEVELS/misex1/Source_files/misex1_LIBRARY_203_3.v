...
module FAU ( 
  ...
  nand4  g23(.a(x3), .b(new_n20_), .c(new_n16_), .d(x0), .O(new_n39_));
  ...
  oai21  g29(.a(x1), .b(new_n22_), .c(new_n17_), .O(new_n45_));
  ...
  nand2  g34(.a(x6), .b(new_n20_), .O(new_n50_));
  ...
  nand2  g38(.a(new_n53_), .b(new_n30_), .O(z4));
  nand2  g39(.a(new_n49_), .b(new_n23_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n16_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n30_), .O(z5));
  nand4  g42(.a(new_n35_), .b(new_n17_), .c(x2), .d(new_n22_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n49_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n16_), .O(new_n60_));
  nand2  g45(.a(x4), .b(new_n17_), .O(new_n61_));
  nand4  g46(.a(new_n61_), .b(new_n20_), .c(x1), .d(new_n22_), .O(new_n62_));
