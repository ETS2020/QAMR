...
module FAU ( 
  ...
  nand2  g06(.a(x1), .b(new_n18_), .O(new_n22_));
  nand2  g07(.a(x3), .b(x2), .O(new_n23_));
  oai22  g08(.a(new_n23_), .b(new_n22_), .c(new_n21_), .d(x1), .O(z0));
  ...
  oai21  g15(.a(new_n29_), .b(new_n17_), .c(new_n30_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n18_), .O(new_n32_));
  nor2   g17(.a(x1), .b(new_n18_), .O(new_n33_));
  nand4  g18(.a(new_n33_), .b(x6), .c(x3), .d(new_n19_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n32_), .O(z1));
  nand3  g20(.a(x3), .b(new_n19_), .c(x0), .O(new_n36_));
  nand4  g21(.a(new_n26_), .b(new_n16_), .c(x2), .d(new_n18_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n36_), .O(new_n38_));
  nand3  g23(.a(new_n38_), .b(x6), .c(new_n25_), .O(new_n39_));
  inv1   g24(.a(x4), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x2), .c(new_n16_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(x1), .c(new_n18_), .O(new_n42_));
  ...
  nor2   g34(.a(new_n17_), .b(x3), .O(new_n50_));
  nand3  g35(.a(new_n33_), .b(new_n50_), .c(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n49_), .O(z3));
  xor2a  g37(.a(x3), .b(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(x0), .O(new_n54_));
  oai21  g39(.a(new_n26_), .b(x3), .c(new_n19_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n18_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(x6), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n25_), .O(new_n58_));
  aoi21  g43(.a(new_n16_), .b(x2), .c(new_n25_), .O(new_n59_));
  nand2  g44(.a(new_n50_), .b(new_n19_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n18_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n58_), .O(z4));
  nand2  g48(.a(new_n27_), .b(new_n18_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n54_), .c(x1), .O(new_n65_));
  nor3   g50(.a(x3), .b(x2), .c(x0), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n65_), .c(x6), .O(new_n67_));
  nand2  g52(.a(new_n59_), .b(new_n18_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n67_), .O(z5));
  nand3  g54(.a(new_n54_), .b(new_n37_), .c(x6), .O(new_n70_));
