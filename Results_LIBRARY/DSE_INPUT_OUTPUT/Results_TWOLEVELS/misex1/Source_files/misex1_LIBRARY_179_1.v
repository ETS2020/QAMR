...
module FAU ( 
  ...
  nand4  g14(.a(new_n29_), .b(new_n17_), .c(x2), .d(new_n21_), .O(new_n30_));
  oai21  g15(.a(new_n27_), .b(new_n21_), .c(new_n30_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n16_), .O(new_n32_));
  nor3   g17(.a(x6), .b(x3), .c(x2), .O(new_n33_));
  oai21  g18(.a(new_n33_), .b(x1), .c(new_n21_), .O(new_n34_));
  ...
  oai22  g23(.a(new_n38_), .b(new_n20_), .c(new_n37_), .d(x0), .O(z3));
  xnor2a g24(.a(x3), .b(x2), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n21_), .c(new_n30_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n16_), .O(new_n42_));
  nand2  g27(.a(new_n17_), .b(new_n23_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n22_), .c(new_n16_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n21_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n42_), .O(z4));
  nor2   g31(.a(new_n40_), .b(x1), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x0), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n26_), .O(z5));
  inv1   g34(.a(new_n42_), .O(z6));
endmodule
