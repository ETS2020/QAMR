...
module FAU ( 
  ...
  aoi21  g10(.a(new_n25_), .b(new_n24_), .c(new_n16_), .O(new_n26_));
  nand2  g11(.a(new_n26_), .b(new_n23_), .O(new_n27_));
  inv1   g12(.a(x6), .O(new_n28_));
  aoi21  g13(.a(new_n28_), .b(new_n23_), .c(x3), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n16_), .O(new_n30_));
  aoi21  g15(.a(new_n30_), .b(new_n27_), .c(x4), .O(new_n31_));
  nor3   g16(.a(new_n20_), .b(x2), .c(new_n23_), .O(new_n32_));
  oai21  g17(.a(new_n32_), .b(new_n31_), .c(new_n17_), .O(new_n33_));
  inv1   g18(.a(x4), .O(new_n34_));
  nand4  g19(.a(new_n19_), .b(new_n34_), .c(x3), .d(new_n16_), .O(new_n35_));
  ...
  nand4  g24(.a(new_n39_), .b(new_n34_), .c(new_n24_), .d(new_n23_), .O(new_n40_));
  inv1   g25(.a(new_n40_), .O(new_n41_));
  aoi21  g26(.a(x4), .b(new_n16_), .c(x3), .O(new_n42_));
  ...
  aoi21  g40(.a(new_n39_), .b(new_n24_), .c(new_n26_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x0), .c(new_n55_), .O(new_n57_));
  nand3  g42(.a(new_n29_), .b(new_n16_), .c(new_n17_), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  aoi21  g44(.a(new_n57_), .b(new_n23_), .c(new_n59_), .O(new_n60_));
  nand2  g45(.a(new_n43_), .b(new_n17_), .O(new_n61_));
  oai21  g46(.a(new_n60_), .b(x4), .c(new_n61_), .O(z4));
  nand2  g47(.a(new_n26_), .b(new_n17_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n55_), .c(x1), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n59_), .c(new_n34_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n61_), .O(z5));
  nand4  g51(.a(new_n25_), .b(new_n24_), .c(x2), .d(new_n17_), .O(new_n67_));
  nand3  g52(.a(new_n67_), .b(new_n55_), .c(new_n34_), .O(new_n68_));
