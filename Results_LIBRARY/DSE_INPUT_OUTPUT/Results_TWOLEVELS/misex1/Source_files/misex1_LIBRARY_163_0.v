...
module FAU ( 
  ...
  nand2  g54(.a(new_n20_), .b(new_n24_), .O(new_n70_));
  nand3  g55(.a(new_n70_), .b(new_n69_), .c(new_n63_), .O(z5));
  nand2  g56(.a(new_n57_), .b(new_n41_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(x4), .c(new_n24_), .O(new_n73_));
