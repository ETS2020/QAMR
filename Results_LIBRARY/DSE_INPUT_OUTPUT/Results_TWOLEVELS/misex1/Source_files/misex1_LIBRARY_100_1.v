...
module FAU ( 
  ...
  aoi21  g19(.a(new_n34_), .b(new_n21_), .c(x2), .O(new_n35_));
  nand2  g20(.a(new_n35_), .b(new_n33_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n17_), .O(new_n37_));
  nand3  g22(.a(new_n18_), .b(x3), .c(new_n30_), .O(new_n38_));
  nand2  g23(.a(new_n38_), .b(new_n37_), .O(z2));
  nand2  g24(.a(new_n31_), .b(new_n30_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(x7), .c(new_n21_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(x2), .c(new_n17_), .O(new_n42_));
  nand3  g27(.a(new_n18_), .b(new_n16_), .c(x2), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n42_), .O(z3));
  xor2a  g29(.a(x3), .b(x2), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(x0), .O(new_n46_));
  nand2  g31(.a(new_n34_), .b(new_n17_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n21_), .O(new_n49_));
  oai21  g34(.a(x4), .b(new_n21_), .c(new_n26_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n16_), .O(new_n51_));
  nand2  g36(.a(new_n32_), .b(x1), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(new_n51_), .c(new_n30_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n17_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n49_), .O(z4));
  nand3  g40(.a(new_n45_), .b(new_n21_), .c(x0), .O(new_n56_));
  nand2  g41(.a(new_n52_), .b(new_n51_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n30_), .c(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z5));
  nand2  g44(.a(x4), .b(new_n16_), .O(new_n60_));
  nand4  g45(.a(new_n60_), .b(new_n30_), .c(x1), .d(new_n17_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n56_), .O(z6));
endmodule
