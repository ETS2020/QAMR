...
module FAU ( 
  ...
  oai21  g42(.a(new_n34_), .b(x0), .c(new_n57_), .O(z4));
  oai21  g43(.a(new_n55_), .b(new_n27_), .c(new_n17_), .O(new_n59_));
  inv1   g44(.a(x4), .O(new_n60_));
  aoi21  g45(.a(new_n33_), .b(new_n20_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n17_), .c(new_n59_), .O(z5));
