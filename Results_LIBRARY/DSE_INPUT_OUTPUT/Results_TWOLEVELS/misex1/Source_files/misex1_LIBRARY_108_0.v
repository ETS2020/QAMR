...
module FAU ( 
  ...
  oai21  g14(.a(new_n29_), .b(new_n16_), .c(x6), .O(new_n30_));
  ...
  nand4  g19(.a(x6), .b(new_n34_), .c(new_n16_), .d(new_n26_), .O(new_n35_));
  aoi21  g20(.a(new_n35_), .b(new_n33_), .c(new_n19_), .O(new_n36_));
  nor2   g21(.a(x4), .b(x3), .O(new_n37_));
  nor3   g22(.a(new_n37_), .b(x2), .c(new_n26_), .O(new_n38_));
  oai21  g23(.a(new_n38_), .b(new_n36_), .c(new_n18_), .O(new_n39_));
  nand2  g24(.a(new_n39_), .b(new_n31_), .O(z2));
  oai21  g25(.a(x4), .b(x3), .c(x7), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(new_n19_), .c(x1), .O(new_n42_));
  nand2  g27(.a(x2), .b(new_n26_), .O(new_n43_));
  nand3  g28(.a(x6), .b(new_n34_), .c(new_n16_), .O(new_n44_));
  ...
  nand2  g35(.a(x2), .b(new_n18_), .O(new_n51_));
  oai21  g36(.a(new_n50_), .b(new_n18_), .c(new_n51_), .O(new_n52_));
  nor3   g37(.a(x3), .b(x2), .c(x0), .O(new_n53_));
  aoi21  g38(.a(new_n52_), .b(new_n26_), .c(new_n53_), .O(new_n54_));
  aoi21  g39(.a(new_n16_), .b(x2), .c(new_n26_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n18_), .O(new_n56_));
  oai21  g41(.a(new_n54_), .b(new_n17_), .c(new_n56_), .O(z4));
  xor2a  g42(.a(x3), .b(x2), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(x0), .O(new_n59_));
  inv1   g44(.a(new_n24_), .O(new_n60_));
  ...
  oai21  g50(.a(new_n65_), .b(new_n55_), .c(new_n18_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n63_), .O(z5));
  nand4  g52(.a(new_n34_), .b(new_n16_), .c(x2), .d(new_n18_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n59_), .O(new_n69_));
  nand3  g54(.a(new_n69_), .b(x6), .c(new_n26_), .O(new_n70_));
