...
module FAU ( 
  ...
  nand2  g35(.a(x2), .b(new_n19_), .O(new_n51_));
  nand3  g36(.a(new_n39_), .b(new_n16_), .c(new_n20_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n50_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n17_), .O(new_n54_));
  aoi21  g39(.a(new_n35_), .b(new_n20_), .c(x4), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n27_), .c(new_n54_), .O(z3));
  inv1   g41(.a(new_n36_), .O(new_n57_));
  ...
  nand4  g46(.a(new_n16_), .b(x3), .c(x1), .d(new_n17_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n16_), .c(new_n27_), .O(new_n63_));
  aoi21  g48(.a(new_n33_), .b(new_n17_), .c(new_n63_), .O(new_n64_));
  ...
  nor3   g53(.a(new_n52_), .b(new_n27_), .c(x0), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n59_), .c(new_n19_), .O(new_n70_));
  oai21  g55(.a(new_n16_), .b(x3), .c(new_n27_), .O(new_n71_));
  nand3  g56(.a(new_n16_), .b(x3), .c(x2), .O(new_n72_));
