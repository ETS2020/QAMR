...
module FAU ( 
  ...
  aoi21  g29(.a(x3), .b(new_n16_), .c(new_n44_), .O(new_n45_));
  nand2  g30(.a(new_n45_), .b(new_n42_), .O(z3));
  aoi21  g31(.a(new_n20_), .b(x1), .c(new_n16_), .O(new_n47_));
  nor2   g32(.a(x6), .b(new_n19_), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n19_), .c(x3), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n16_), .c(new_n47_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(x0), .c(new_n43_), .O(z4));
  ...
  nand2  g39(.a(new_n54_), .b(new_n45_), .O(z5));
  ...
  nand2  g45(.a(new_n60_), .b(new_n45_), .O(z6));
endmodule
