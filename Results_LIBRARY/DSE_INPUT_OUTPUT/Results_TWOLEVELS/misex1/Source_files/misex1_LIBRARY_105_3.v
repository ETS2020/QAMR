...
module FAU ( 
  ...
  nand4  g15(.a(new_n21_), .b(new_n16_), .c(new_n17_), .d(x0), .O(new_n31_));
  ...
  nand2  g22(.a(new_n21_), .b(x1), .O(new_n38_));
  ...
  nor3   g33(.a(x7), .b(x6), .c(x2), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n20_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(z3));
  inv1   g36(.a(x0), .O(new_n52_));
  nand3  g37(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n53_));
  nand2  g38(.a(new_n18_), .b(x2), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n52_), .O(new_n55_));
  xor2a  g40(.a(x3), .b(x2), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x6), .c(new_n54_), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n52_), .c(new_n55_), .O(new_n58_));
  nand2  g43(.a(new_n18_), .b(new_n16_), .O(new_n59_));
  aoi21  g44(.a(new_n59_), .b(new_n25_), .c(new_n17_), .O(new_n60_));
  nand3  g45(.a(x6), .b(new_n18_), .c(new_n16_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n52_), .O(new_n63_));
  oai21  g48(.a(new_n58_), .b(x1), .c(new_n63_), .O(z4));
  aoi21  g49(.a(new_n27_), .b(new_n52_), .c(new_n55_), .O(new_n65_));
  oai21  g50(.a(x2), .b(x0), .c(new_n18_), .O(new_n66_));
  aoi22  g51(.a(new_n66_), .b(x6), .c(new_n60_), .d(new_n52_), .O(new_n67_));
  oai21  g52(.a(new_n65_), .b(x1), .c(new_n67_), .O(z5));
  nand4  g53(.a(new_n33_), .b(new_n18_), .c(x2), .d(new_n52_), .O(new_n69_));
  inv1   g54(.a(new_n69_), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n55_), .c(new_n17_), .O(new_n71_));
  inv1   g56(.a(x4), .O(new_n72_));
  nand2  g57(.a(new_n72_), .b(new_n18_), .O(new_n73_));
  oai21  g58(.a(new_n73_), .b(x2), .c(new_n25_), .O(new_n74_));
  nand3  g59(.a(new_n74_), .b(x1), .c(new_n52_), .O(new_n75_));
  nand2  g60(.a(x6), .b(x3), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(new_n75_), .c(new_n71_), .O(z6));
endmodule
