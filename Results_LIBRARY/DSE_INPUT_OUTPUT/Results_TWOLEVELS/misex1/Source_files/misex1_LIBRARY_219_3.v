...
module FAU ( 
  ...
  nand2  g20(.a(new_n20_), .b(new_n16_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand3  g22(.a(new_n37_), .b(new_n19_), .c(new_n33_), .O(new_n38_));
  oai21  g23(.a(new_n26_), .b(x2), .c(new_n19_), .O(new_n39_));
  ...
  nor2   g28(.a(new_n16_), .b(x1), .O(new_n44_));
  ...
  nand2  g33(.a(new_n44_), .b(new_n48_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n47_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n17_), .O(new_n51_));
  oai21  g36(.a(new_n45_), .b(new_n17_), .c(new_n51_), .O(z3));
  nor2   g37(.a(x3), .b(x2), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(x0), .c(x6), .O(new_n54_));
  nand2  g39(.a(new_n53_), .b(new_n17_), .O(new_n55_));
  xor2a  g40(.a(x3), .b(x2), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(x0), .O(new_n57_));
  aoi21  g42(.a(new_n57_), .b(new_n55_), .c(x6), .O(new_n58_));
  nor2   g43(.a(new_n16_), .b(x0), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n58_), .c(new_n33_), .O(new_n60_));
  nand2  g45(.a(new_n19_), .b(x2), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(x1), .c(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n60_), .c(new_n54_), .O(z4));
  nand3  g48(.a(new_n56_), .b(new_n20_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n24_), .b(x0), .c(new_n64_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n33_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n62_), .c(new_n54_), .O(z5));
  nand3  g52(.a(new_n48_), .b(x2), .c(new_n17_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n64_), .O(new_n69_));
