...
module FAU ( 
  ...
  oai22  g25(.a(new_n40_), .b(new_n37_), .c(new_n39_), .d(x0), .O(z3));
  nand2  g26(.a(x3), .b(new_n21_), .O(new_n42_));
  aoi21  g27(.a(new_n40_), .b(new_n42_), .c(new_n28_), .O(new_n43_));
  inv1   g28(.a(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n17_), .b(x2), .c(new_n28_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x1), .O(z4));
  oai21  g31(.a(new_n43_), .b(new_n23_), .c(new_n16_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n35_), .O(z5));
  nand3  g33(.a(new_n38_), .b(x2), .c(new_n28_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n44_), .c(x1), .O(z6));
endmodule
