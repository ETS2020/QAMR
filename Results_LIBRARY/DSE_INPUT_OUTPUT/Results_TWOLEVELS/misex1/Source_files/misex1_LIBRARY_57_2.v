...
module FAU ( 
  ...
  nand3  g13(.a(x6), .b(new_n19_), .c(new_n21_), .O(new_n29_));
  ...
  oai21  g34(.a(new_n16_), .b(new_n21_), .c(x5), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(x2), .c(new_n18_), .O(new_n51_));
  inv1   g36(.a(x4), .O(new_n52_));
  nor2   g37(.a(new_n18_), .b(x0), .O(new_n53_));
  nand4  g38(.a(new_n53_), .b(x7), .c(new_n52_), .d(new_n26_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n51_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(new_n56_));
  nand4  g41(.a(new_n53_), .b(new_n16_), .c(new_n31_), .d(new_n26_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n56_), .O(z3));
  nand2  g43(.a(new_n18_), .b(new_n21_), .O(new_n59_));
  oai21  g44(.a(new_n59_), .b(new_n26_), .c(x7), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(x5), .O(new_n61_));
  xor2a  g46(.a(x3), .b(x2), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n18_), .c(x0), .O(new_n63_));
  nand4  g48(.a(x6), .b(new_n19_), .c(new_n26_), .d(new_n21_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n17_), .O(new_n66_));
  nand2  g51(.a(new_n31_), .b(x2), .O(new_n67_));
  nand3  g52(.a(new_n40_), .b(new_n19_), .c(new_n26_), .O(new_n68_));
  aoi21  g53(.a(new_n68_), .b(new_n67_), .c(x1), .O(new_n69_));
  oai21  g54(.a(x7), .b(new_n31_), .c(new_n26_), .O(new_n70_));
  aoi21  g55(.a(new_n70_), .b(new_n19_), .c(new_n18_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n69_), .c(new_n21_), .O(new_n72_));
  nand3  g57(.a(new_n72_), .b(new_n66_), .c(new_n61_), .O(z4));
  nand4  g58(.a(new_n31_), .b(x3), .c(x2), .d(new_n18_), .O(new_n74_));
  inv1   g59(.a(new_n74_), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n71_), .c(new_n21_), .O(new_n76_));
  nand3  g61(.a(new_n76_), .b(new_n66_), .c(new_n61_), .O(z5));
  nand2  g62(.a(new_n31_), .b(new_n19_), .O(new_n78_));
  nand2  g63(.a(x2), .b(new_n18_), .O(new_n79_));
  aoi21  g64(.a(new_n52_), .b(new_n26_), .c(x3), .O(new_n80_));
  oai22  g65(.a(new_n80_), .b(new_n18_), .c(new_n79_), .d(new_n78_), .O(new_n81_));
  nand2  g66(.a(new_n81_), .b(new_n21_), .O(new_n82_));
  nand4  g67(.a(new_n62_), .b(new_n17_), .c(new_n18_), .d(x0), .O(new_n83_));
