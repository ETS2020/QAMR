...
module FAU ( 
  ...
  nand4  g24(.a(new_n39_), .b(x3), .c(new_n16_), .d(x1), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n33_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n17_), .O(new_n42_));
  nand4  g27(.a(new_n19_), .b(x2), .c(new_n18_), .d(x0), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n42_), .O(z3));
  xor2a  g29(.a(x3), .b(x2), .O(new_n45_));
  nor2   g30(.a(new_n16_), .b(x0), .O(new_n46_));
  aoi21  g31(.a(new_n45_), .b(x0), .c(new_n46_), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(x1), .c(new_n21_), .O(z4));
  nand2  g33(.a(new_n45_), .b(x0), .O(new_n49_));
  nand3  g34(.a(new_n25_), .b(x2), .c(new_n17_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n18_), .O(new_n52_));
  aoi22  g37(.a(new_n20_), .b(new_n17_), .c(new_n19_), .d(new_n16_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z5));
  nand3  g39(.a(new_n32_), .b(x2), .c(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n49_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n18_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n53_), .O(z6));
endmodule
