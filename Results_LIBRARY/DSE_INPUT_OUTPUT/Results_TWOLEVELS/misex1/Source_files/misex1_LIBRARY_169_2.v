...
module FAU ( 
  ...
  aoi22  g20(.a(new_n35_), .b(new_n33_), .c(new_n32_), .d(x1), .O(new_n36_));
  ...
  nand3  g37(.a(new_n33_), .b(new_n18_), .c(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z3));
  nand2  g39(.a(new_n18_), .b(x2), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n34_), .c(new_n20_), .O(new_n56_));
  aoi21  g41(.a(x3), .b(new_n16_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(new_n17_), .O(new_n58_));
  nor2   g43(.a(x3), .b(new_n16_), .O(new_n59_));
  nor2   g44(.a(new_n59_), .b(new_n32_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(x1), .c(new_n20_), .O(new_n61_));
  ...
  aoi21  g49(.a(new_n60_), .b(new_n20_), .c(new_n32_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n17_), .c(new_n64_), .O(z5));
  nand3  g51(.a(new_n49_), .b(x2), .c(new_n20_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n56_), .c(new_n17_), .O(new_n69_));
