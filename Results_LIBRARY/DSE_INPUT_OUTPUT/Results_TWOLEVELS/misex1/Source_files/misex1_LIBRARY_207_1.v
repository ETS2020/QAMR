...
module FAU ( 
  ...
  nand3  g20(.a(new_n23_), .b(new_n24_), .c(new_n16_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n35_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n20_), .O(new_n38_));
  inv1   g23(.a(new_n38_), .O(new_n39_));
  oai21  g24(.a(new_n23_), .b(x2), .c(x3), .O(new_n40_));
  nand3  g25(.a(new_n23_), .b(x4), .c(new_n16_), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(new_n40_), .c(new_n19_), .O(new_n42_));
  aoi21  g27(.a(new_n39_), .b(new_n19_), .c(new_n42_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(x0), .c(new_n32_), .O(z2));
  nand2  g29(.a(new_n23_), .b(new_n16_), .O(new_n45_));
  nor2   g30(.a(x5), .b(x3), .O(new_n46_));
  nand3  g31(.a(new_n46_), .b(x2), .c(new_n19_), .O(new_n47_));
  oai21  g32(.a(new_n45_), .b(new_n19_), .c(new_n47_), .O(new_n48_));
  ...
  aoi21  g37(.a(new_n38_), .b(new_n27_), .c(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n52_), .c(new_n19_), .O(new_n54_));
  nand2  g39(.a(x3), .b(x2), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n45_), .c(new_n19_), .O(new_n56_));
  nand4  g41(.a(new_n23_), .b(x6), .c(new_n20_), .d(new_n16_), .O(new_n57_));
  ...
  nand3  g48(.a(new_n46_), .b(x2), .c(new_n17_), .O(new_n64_));
  ...
  nand2  g53(.a(new_n68_), .b(new_n40_), .O(new_n69_));
