...
module FAU ( 
  ...
  nand3  g10(.a(x4), .b(new_n16_), .c(x1), .O(new_n26_));
  inv1   g11(.a(new_n26_), .O(new_n27_));
  aoi21  g12(.a(new_n25_), .b(new_n17_), .c(new_n27_), .O(new_n28_));
