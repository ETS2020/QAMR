...
module FAU ( 
  ...
  aoi21  g22(.a(new_n37_), .b(new_n32_), .c(new_n29_), .O(new_n38_));
  ...
  nand4  g28(.a(new_n43_), .b(x5), .c(new_n24_), .d(x1), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(x0), .c(new_n22_), .O(z3));
  xor2a  g30(.a(x3), .b(x2), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(x0), .O(new_n47_));
  oai21  g32(.a(new_n36_), .b(x2), .c(x5), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(x0), .c(new_n47_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n21_), .O(new_n50_));
  oai21  g35(.a(x3), .b(new_n24_), .c(x1), .O(new_n51_));
  nand3  g36(.a(x6), .b(new_n17_), .c(new_n24_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n51_), .c(new_n29_), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n16_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n50_), .O(z4));
  nand2  g40(.a(new_n47_), .b(new_n26_), .O(new_n56_));
  ...
  nand3  g44(.a(new_n46_), .b(new_n21_), .c(x0), .O(new_n60_));
  oai21  g45(.a(x4), .b(x2), .c(new_n17_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(x1), .c(new_n29_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(x0), .c(new_n60_), .O(z6));
endmodule
