...
module FAU ( 
  ...
  nand3  g18(.a(x3), .b(new_n23_), .c(x0), .O(new_n34_));
  inv1   g19(.a(new_n34_), .O(new_n35_));
  aoi21  g20(.a(new_n33_), .b(new_n21_), .c(new_n35_), .O(new_n36_));
  nand2  g21(.a(x1), .b(new_n21_), .O(new_n37_));
  oai21  g22(.a(new_n36_), .b(x1), .c(new_n37_), .O(z2));
  nand2  g23(.a(x5), .b(new_n21_), .O(new_n39_));
  nand4  g24(.a(new_n39_), .b(new_n17_), .c(x2), .d(new_n16_), .O(new_n40_));
  inv1   g25(.a(new_n40_), .O(z3));
  nand2  g26(.a(new_n17_), .b(x2), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n27_), .c(new_n21_), .O(new_n43_));
  inv1   g28(.a(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n17_), .b(x2), .c(new_n21_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x1), .O(z4));
  aoi21  g31(.a(new_n24_), .b(new_n22_), .c(x0), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n43_), .c(new_n16_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n37_), .O(z5));
  nand4  g34(.a(new_n29_), .b(new_n17_), .c(x2), .d(new_n21_), .O(new_n50_));
  inv1   g35(.a(new_n50_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n43_), .c(new_n16_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n37_), .O(z6));
endmodule
