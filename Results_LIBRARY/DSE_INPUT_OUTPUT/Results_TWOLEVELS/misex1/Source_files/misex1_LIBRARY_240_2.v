...
module FAU ( 
  ...
  oai21  g27(.a(x3), .b(new_n19_), .c(x1), .O(new_n43_));
  nand2  g28(.a(x6), .b(new_n19_), .O(new_n44_));
  oai21  g29(.a(new_n33_), .b(x1), .c(new_n44_), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n24_), .c(new_n21_), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(new_n43_), .c(x0), .O(z4));
  nand2  g32(.a(new_n27_), .b(new_n19_), .O(new_n48_));
  oai21  g33(.a(new_n31_), .b(x1), .c(new_n24_), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(x2), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n48_), .c(x0), .O(z5));
  nor2   g36(.a(new_n24_), .b(new_n30_), .O(new_n52_));
  nor3   g37(.a(x5), .b(x3), .c(x1), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n52_), .c(x2), .O(new_n54_));
  nand2  g39(.a(x4), .b(new_n24_), .O(new_n55_));
