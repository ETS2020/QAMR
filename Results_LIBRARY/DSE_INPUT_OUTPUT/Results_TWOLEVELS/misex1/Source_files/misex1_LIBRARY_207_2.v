...
module FAU ( 
  ...
  nand3  g11(.a(new_n26_), .b(x7), .c(x2), .O(new_n27_));
  ...
  oai22  g16(.a(new_n31_), .b(new_n18_), .c(new_n30_), .d(x3), .O(new_n32_));
  aoi21  g17(.a(new_n32_), .b(new_n24_), .c(new_n28_), .O(new_n33_));
  ...
  nand3  g24(.a(x7), .b(new_n25_), .c(x2), .O(new_n40_));
  nand2  g25(.a(new_n40_), .b(new_n39_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n19_), .O(new_n42_));
  nand3  g27(.a(x7), .b(x3), .c(x2), .O(new_n43_));
  oai21  g28(.a(new_n31_), .b(x2), .c(new_n43_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(x1), .O(new_n45_));
  oai21  g30(.a(new_n42_), .b(x1), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g36(.a(x7), .b(new_n25_), .c(new_n19_), .O(new_n52_));
  nor3   g37(.a(new_n52_), .b(new_n24_), .c(x1), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n51_), .c(new_n16_), .O(new_n54_));
  nand3  g39(.a(x7), .b(new_n19_), .c(x2), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n34_), .c(new_n54_), .O(z3));
  aoi21  g41(.a(new_n55_), .b(new_n35_), .c(new_n16_), .O(new_n57_));
  aoi21  g42(.a(new_n42_), .b(new_n27_), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n18_), .O(new_n59_));
  oai21  g44(.a(x7), .b(new_n24_), .c(x3), .O(new_n60_));
  oai21  g45(.a(x4), .b(new_n19_), .c(new_n24_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n18_), .O(new_n62_));
  nand3  g47(.a(x6), .b(new_n19_), .c(new_n24_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n16_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n59_), .O(z4));
  nor2   g51(.a(new_n27_), .b(x0), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n57_), .c(new_n18_), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n65_), .O(z5));
  nor3   g54(.a(new_n52_), .b(new_n24_), .c(x0), .O(new_n70_));
  oai21  g55(.a(new_n70_), .b(new_n57_), .c(new_n18_), .O(new_n71_));
  oai21  g56(.a(new_n29_), .b(x3), .c(new_n24_), .O(new_n72_));
