...
module FAU ( 
  ...
  aoi22  g15(.a(new_n30_), .b(new_n16_), .c(new_n24_), .d(new_n19_), .O(new_n31_));
  ...
  nor2   g27(.a(new_n42_), .b(new_n19_), .O(new_n43_));
  ...
  nand3  g32(.a(new_n23_), .b(x2), .c(new_n19_), .O(new_n48_));
  ...
  aoi21  g36(.a(new_n51_), .b(new_n27_), .c(x7), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(x1), .c(new_n50_), .O(z3));
  nand2  g38(.a(new_n20_), .b(x2), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n33_), .c(new_n17_), .O(new_n55_));
  inv1   g40(.a(new_n55_), .O(new_n56_));
  oai21  g41(.a(new_n41_), .b(new_n24_), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n56_), .c(new_n32_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n19_), .O(new_n59_));
  aoi21  g44(.a(new_n27_), .b(x2), .c(new_n19_), .O(new_n60_));
  nand3  g45(.a(x6), .b(new_n27_), .c(new_n16_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n60_), .c(new_n17_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n59_), .O(z4));
  nand2  g49(.a(new_n24_), .b(new_n17_), .O(new_n65_));
  ...
  nand3  g53(.a(new_n23_), .b(x2), .c(new_n17_), .O(new_n69_));
