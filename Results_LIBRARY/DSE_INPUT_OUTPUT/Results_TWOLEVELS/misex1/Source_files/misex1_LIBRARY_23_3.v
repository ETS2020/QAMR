...
module FAU ( 
  ...
  nand3  g28(.a(new_n43_), .b(new_n29_), .c(x1), .O(new_n44_));
  ...
  nand4  g33(.a(new_n29_), .b(new_n42_), .c(new_n17_), .d(x1), .O(new_n49_));
  ...
  oai21  g39(.a(new_n54_), .b(x6), .c(x1), .O(new_n55_));
  ...
  nor2   g45(.a(new_n60_), .b(x6), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n24_), .c(x6), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n16_), .c(new_n59_), .O(z4));
  aoi21  g48(.a(new_n26_), .b(new_n25_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n57_), .c(new_n16_), .O(new_n65_));
  nand3  g50(.a(new_n61_), .b(x1), .c(new_n24_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n65_), .O(z5));
  nand3  g52(.a(new_n18_), .b(new_n38_), .c(new_n21_), .O(new_n68_));
  inv1   g53(.a(new_n68_), .O(new_n69_));
  oai21  g54(.a(new_n69_), .b(new_n57_), .c(new_n16_), .O(new_n70_));
  aoi21  g55(.a(new_n42_), .b(new_n17_), .c(x3), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(x0), .c(new_n29_), .O(new_n72_));
