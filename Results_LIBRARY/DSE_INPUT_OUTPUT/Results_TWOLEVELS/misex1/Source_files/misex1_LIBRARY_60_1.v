...
module FAU ( 
  ...
  oai21  g26(.a(new_n33_), .b(x1), .c(new_n41_), .O(new_n42_));
  ...
  aoi21  g30(.a(new_n20_), .b(x1), .c(new_n16_), .O(new_n46_));
  nor2   g31(.a(x6), .b(new_n19_), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n19_), .c(x3), .O(new_n48_));
  aoi21  g33(.a(new_n48_), .b(new_n16_), .c(new_n46_), .O(new_n49_));
  ...
  and2   g39(.a(new_n50_), .b(new_n38_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(z5));
  inv1   g41(.a(x4), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n20_), .c(new_n16_), .O(new_n58_));
  aoi21  g43(.a(new_n58_), .b(new_n29_), .c(new_n19_), .O(new_n59_));
  nand3  g44(.a(new_n25_), .b(x2), .c(new_n19_), .O(new_n60_));
  inv1   g45(.a(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n17_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n55_), .O(z6));
endmodule
