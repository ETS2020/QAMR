...
module FAU ( 
  ...
  oai21  g09(.a(new_n20_), .b(new_n16_), .c(new_n24_), .O(z0));
  ...
  aoi22  g20(.a(new_n35_), .b(new_n23_), .c(new_n17_), .d(x1), .O(new_n36_));
  ...
  nand3  g25(.a(new_n40_), .b(new_n21_), .c(new_n16_), .O(new_n41_));
  inv1   g26(.a(x4), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(x2), .c(new_n21_), .O(new_n43_));
  ...
  inv1   g38(.a(new_n35_), .O(new_n54_));
  ...
  nand4  g43(.a(new_n58_), .b(x7), .c(x1), .d(new_n22_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n57_), .O(z4));
  aoi21  g45(.a(new_n27_), .b(new_n26_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n55_), .c(new_n16_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n59_), .O(z5));
  nand3  g48(.a(new_n19_), .b(new_n38_), .c(new_n21_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n55_), .c(new_n16_), .O(new_n66_));
  oai21  g51(.a(x4), .b(x2), .c(new_n21_), .O(new_n67_));
  nand4  g52(.a(new_n67_), .b(x7), .c(x1), .d(new_n22_), .O(new_n68_));
