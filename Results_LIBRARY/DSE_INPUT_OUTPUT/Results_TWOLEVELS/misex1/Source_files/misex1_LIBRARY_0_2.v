...
module FAU ( 
  ...
  nand3  g08(.a(x6), .b(new_n18_), .c(new_n23_), .O(new_n24_));
  nand2  g09(.a(new_n24_), .b(new_n22_), .O(new_n25_));
  nand3  g10(.a(x3), .b(new_n23_), .c(x1), .O(new_n26_));
  ...
  nor2   g15(.a(new_n18_), .b(new_n16_), .O(new_n31_));
  ...
  aoi21  g21(.a(new_n36_), .b(new_n16_), .c(new_n31_), .O(new_n37_));
  ...
  nand4  g26(.a(new_n41_), .b(x3), .c(new_n23_), .d(x1), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(new_n40_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n17_), .O(new_n44_));
  nand2  g29(.a(new_n44_), .b(new_n20_), .O(z3));
  ...
  aoi21  g33(.a(x3), .b(new_n23_), .c(x0), .O(new_n49_));
  ...
  aoi21  g37(.a(new_n24_), .b(new_n22_), .c(x0), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n48_), .c(new_n16_), .O(new_n54_));
  oai21  g39(.a(new_n18_), .b(new_n17_), .c(x1), .O(new_n55_));
  ...
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z6));
endmodule
