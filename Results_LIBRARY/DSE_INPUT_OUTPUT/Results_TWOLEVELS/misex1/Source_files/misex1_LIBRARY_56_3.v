...
module FAU ( 
  ...
  aoi21  g03(.a(new_n18_), .b(x3), .c(x7), .O(new_n19_));
  ...
  nand3  g17(.a(new_n17_), .b(new_n16_), .c(x0), .O(new_n33_));
  oai21  g18(.a(new_n16_), .b(x0), .c(new_n33_), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(x3), .O(new_n35_));
  inv1   g20(.a(x4), .O(new_n36_));
  nand2  g21(.a(new_n17_), .b(new_n23_), .O(new_n37_));
  oai21  g22(.a(new_n37_), .b(new_n36_), .c(new_n24_), .O(new_n38_));
  ...
  nand4  g27(.a(new_n42_), .b(new_n20_), .c(new_n16_), .d(new_n23_), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n39_), .c(new_n35_), .O(z2));
  nand3  g29(.a(new_n24_), .b(new_n17_), .c(x1), .O(new_n45_));
  ...
  aoi21  g37(.a(new_n52_), .b(new_n51_), .c(new_n23_), .O(new_n53_));
  ...
  nand4  g41(.a(new_n56_), .b(new_n24_), .c(x1), .d(new_n23_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n55_), .O(z4));
  nand3  g43(.a(x6), .b(new_n20_), .c(new_n17_), .O(new_n59_));
  ...
  nand3  g47(.a(new_n46_), .b(x2), .c(new_n23_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n53_), .c(new_n16_), .O(new_n65_));
  nand3  g50(.a(new_n24_), .b(new_n36_), .c(new_n17_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n20_), .c(x0), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(x7), .c(x1), .O(new_n68_));
