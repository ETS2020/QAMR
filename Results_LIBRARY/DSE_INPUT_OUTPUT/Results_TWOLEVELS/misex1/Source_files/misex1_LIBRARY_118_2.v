...
module FAU ( 
  ...
  oai21  g26(.a(new_n41_), .b(x2), .c(new_n22_), .O(new_n42_));
  ...
  nand4  g32(.a(x5), .b(new_n41_), .c(new_n18_), .d(x1), .O(new_n48_));
  nand3  g33(.a(new_n17_), .b(x2), .c(new_n16_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n48_), .c(x0), .O(new_n50_));
  nand3  g35(.a(x2), .b(new_n16_), .c(x0), .O(new_n51_));
  inv1   g36(.a(new_n51_), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n50_), .c(new_n22_), .O(new_n53_));
  nor3   g38(.a(x7), .b(x2), .c(x0), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(new_n17_), .c(x1), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n53_), .O(z3));
  aoi21  g41(.a(new_n35_), .b(new_n23_), .c(new_n25_), .O(new_n57_));
  aoi21  g42(.a(x3), .b(new_n18_), .c(x0), .O(new_n58_));
  oai21  g43(.a(new_n58_), .b(new_n57_), .c(new_n16_), .O(new_n59_));
  nor2   g44(.a(x3), .b(new_n18_), .O(new_n60_));
  nor2   g45(.a(new_n60_), .b(new_n17_), .O(new_n61_));
  nand3  g46(.a(new_n61_), .b(x1), .c(new_n25_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n59_), .O(z4));
  aoi21  g48(.a(new_n27_), .b(new_n26_), .c(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n57_), .c(new_n16_), .O(new_n65_));
  aoi21  g50(.a(new_n61_), .b(new_n25_), .c(new_n17_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n16_), .c(new_n65_), .O(z5));
  nand3  g52(.a(new_n19_), .b(new_n17_), .c(new_n22_), .O(new_n68_));
  ...
  nand4  g56(.a(new_n71_), .b(x5), .c(x1), .d(new_n25_), .O(new_n72_));
