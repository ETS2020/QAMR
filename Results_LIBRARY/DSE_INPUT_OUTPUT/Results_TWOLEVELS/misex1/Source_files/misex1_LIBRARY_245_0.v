...
module FAU ( 
  ...
  nand3  g15(.a(new_n30_), .b(x1), .c(new_n24_), .O(new_n31_));
  nor2   g16(.a(new_n29_), .b(x2), .O(new_n32_));
  ...
  nand3  g24(.a(x3), .b(x1), .c(new_n24_), .O(new_n40_));
  nand2  g25(.a(new_n29_), .b(new_n16_), .O(new_n41_));
  nand2  g26(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g27(.a(new_n42_), .b(x2), .O(new_n43_));
  oai21  g28(.a(new_n32_), .b(new_n24_), .c(new_n16_), .O(new_n44_));
  nand3  g29(.a(new_n18_), .b(x1), .c(new_n24_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(z4));
  aoi21  g31(.a(x4), .b(new_n29_), .c(x2), .O(new_n47_));
  oai21  g32(.a(new_n47_), .b(new_n16_), .c(new_n24_), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n43_), .c(new_n33_), .O(z6));
  nand3  g34(.a(new_n45_), .b(new_n44_), .c(new_n43_), .O(z5));
endmodule
