...
module FAU ( 
  ...
  aoi21  g27(.a(new_n42_), .b(x3), .c(x7), .O(new_n43_));
  ...
  aoi21  g40(.a(new_n37_), .b(new_n19_), .c(new_n26_), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(x0), .c(new_n55_), .O(new_n57_));
  nand4  g42(.a(x6), .b(new_n19_), .c(new_n16_), .d(new_n17_), .O(new_n58_));
  inv1   g43(.a(new_n58_), .O(new_n59_));
  aoi21  g44(.a(new_n57_), .b(new_n24_), .c(new_n59_), .O(new_n60_));
  aoi21  g45(.a(new_n19_), .b(x2), .c(new_n24_), .O(new_n61_));
  ...
  nand3  g49(.a(new_n64_), .b(new_n55_), .c(new_n20_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n24_), .O(new_n66_));
  nand4  g51(.a(new_n20_), .b(x6), .c(new_n19_), .d(new_n16_), .O(new_n67_));
