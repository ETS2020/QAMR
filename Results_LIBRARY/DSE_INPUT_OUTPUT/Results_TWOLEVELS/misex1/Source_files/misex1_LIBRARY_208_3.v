...
module FAU ( 
  ...
  nor2   g17(.a(new_n18_), .b(x2), .O(new_n33_));
  nand3  g18(.a(new_n33_), .b(new_n17_), .c(x0), .O(new_n34_));
  nand2  g19(.a(new_n34_), .b(new_n32_), .O(z1));
  nand2  g20(.a(new_n21_), .b(new_n16_), .O(new_n36_));
  oai21  g21(.a(x5), .b(new_n16_), .c(new_n36_), .O(new_n37_));
  ...
  nand2  g28(.a(x6), .b(x1), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n43_), .c(new_n34_), .O(z2));
  oai21  g30(.a(x4), .b(x3), .c(x7), .O(new_n46_));
  nand4  g31(.a(new_n46_), .b(new_n21_), .c(new_n16_), .d(x1), .O(new_n47_));
  ...
  nand3  g37(.a(new_n52_), .b(new_n17_), .c(x0), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n51_), .O(z3));
  nor2   g39(.a(new_n52_), .b(new_n33_), .O(new_n55_));
  ...
  oai21  g44(.a(new_n59_), .b(x0), .c(new_n21_), .O(new_n60_));
  ...
  nand3  g50(.a(new_n48_), .b(x2), .c(new_n20_), .O(new_n66_));
