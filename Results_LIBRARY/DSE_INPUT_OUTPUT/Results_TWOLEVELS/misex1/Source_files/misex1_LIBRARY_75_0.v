...
module FAU ( 
  ...
  nor2   g17(.a(x2), .b(new_n17_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(x3), .c(new_n20_), .O(new_n34_));
  ...
  nand4  g24(.a(new_n39_), .b(x7), .c(new_n25_), .d(new_n24_), .O(new_n40_));
  ...
  nand4  g28(.a(new_n19_), .b(x7), .c(x3), .d(new_n16_), .O(new_n44_));
  ...
  oai21  g41(.a(new_n56_), .b(new_n27_), .c(new_n17_), .O(new_n57_));
  nand3  g42(.a(new_n57_), .b(new_n55_), .c(x7), .O(new_n58_));
