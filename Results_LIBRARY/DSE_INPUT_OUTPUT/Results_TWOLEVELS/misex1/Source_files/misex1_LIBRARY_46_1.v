...
module FAU ( 
  ...
  oai21  g18(.a(new_n33_), .b(new_n20_), .c(new_n25_), .O(new_n34_));
  ...
  nand3  g29(.a(new_n25_), .b(x3), .c(new_n16_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(new_n33_), .c(new_n44_), .O(z2));
  nand2  g31(.a(new_n37_), .b(x7), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(new_n16_), .c(x1), .O(new_n48_));
  nand2  g33(.a(new_n20_), .b(x2), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(x1), .c(new_n48_), .O(new_n50_));
  nand3  g35(.a(new_n50_), .b(new_n25_), .c(new_n17_), .O(new_n51_));
  or2    g36(.a(new_n49_), .b(new_n33_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(z3));
  aoi21  g38(.a(new_n49_), .b(new_n45_), .c(new_n17_), .O(new_n54_));
  nand3  g39(.a(new_n39_), .b(new_n25_), .c(new_n20_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n23_), .c(x0), .O(new_n56_));
  oai21  g41(.a(new_n56_), .b(new_n54_), .c(new_n19_), .O(new_n57_));
  oai21  g42(.a(new_n25_), .b(x2), .c(x3), .O(new_n58_));
  nand2  g43(.a(new_n26_), .b(x3), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n25_), .c(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n58_), .c(new_n19_), .O(new_n61_));
  nand4  g46(.a(x6), .b(new_n25_), .c(new_n20_), .d(new_n16_), .O(new_n62_));
  inv1   g47(.a(new_n62_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n61_), .c(new_n17_), .O(new_n64_));
  nand2  g49(.a(x5), .b(new_n16_), .O(new_n65_));
  nand3  g50(.a(new_n65_), .b(new_n64_), .c(new_n57_), .O(z4));
  ...
  nand4  g54(.a(new_n25_), .b(new_n20_), .c(x2), .d(new_n17_), .O(new_n70_));
  inv1   g55(.a(new_n70_), .O(new_n71_));
  oai21  g56(.a(new_n71_), .b(new_n54_), .c(new_n19_), .O(new_n72_));
  nand2  g57(.a(x4), .b(new_n20_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n25_), .c(new_n16_), .O(new_n74_));
  oai21  g59(.a(new_n20_), .b(new_n16_), .c(new_n74_), .O(new_n75_));
