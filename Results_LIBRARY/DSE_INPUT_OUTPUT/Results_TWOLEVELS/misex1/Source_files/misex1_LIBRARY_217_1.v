...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(new_n23_), .c(x0), .O(new_n31_));
  ...
  nand4  g19(.a(x3), .b(x2), .c(x1), .d(new_n17_), .O(new_n35_));
  ...
  inv1   g24(.a(z0), .O(new_n40_));
  nand2  g25(.a(x3), .b(x0), .O(new_n41_));
  nand3  g26(.a(new_n29_), .b(new_n28_), .c(new_n17_), .O(new_n42_));
  aoi21  g27(.a(new_n42_), .b(new_n41_), .c(x1), .O(new_n43_));
  aoi21  g28(.a(new_n24_), .b(new_n17_), .c(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(x2), .c(new_n40_), .O(z4));
  aoi21  g30(.a(new_n28_), .b(x2), .c(new_n27_), .O(new_n46_));
  nand3  g31(.a(x6), .b(new_n28_), .c(new_n16_), .O(new_n47_));
  inv1   g32(.a(new_n47_), .O(new_n48_));
  oai21  g33(.a(new_n48_), .b(new_n46_), .c(new_n17_), .O(new_n49_));
  nand4  g34(.a(x3), .b(new_n16_), .c(new_n27_), .d(x0), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n49_), .O(z5));
  oai21  g36(.a(x4), .b(x2), .c(new_n28_), .O(new_n52_));
