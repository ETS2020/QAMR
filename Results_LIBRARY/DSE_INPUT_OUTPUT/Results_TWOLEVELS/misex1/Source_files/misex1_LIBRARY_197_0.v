...
module FAU ( 
  ...
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n28_), .O(new_n55_));
  ...
  oai21  g44(.a(new_n55_), .b(new_n28_), .c(new_n24_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n59_), .O(z5));
  nand3  g46(.a(new_n48_), .b(new_n17_), .c(x0), .O(new_n62_));
  oai21  g47(.a(x4), .b(x2), .c(new_n18_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(x1), .c(new_n28_), .O(new_n64_));
