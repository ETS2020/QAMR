...
module FAU ( 
  ...
  aoi21  g45(.a(new_n20_), .b(new_n26_), .c(x3), .O(new_n61_));
  nor2   g46(.a(new_n61_), .b(new_n17_), .O(new_n62_));
  nand4  g47(.a(x6), .b(new_n20_), .c(new_n19_), .d(new_n26_), .O(new_n63_));
  inv1   g48(.a(new_n63_), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n62_), .c(new_n36_), .O(new_n65_));
  ...
  nand2  g57(.a(new_n62_), .b(new_n36_), .O(new_n73_));
  nand3  g58(.a(new_n73_), .b(new_n72_), .c(new_n24_), .O(z6));
endmodule
