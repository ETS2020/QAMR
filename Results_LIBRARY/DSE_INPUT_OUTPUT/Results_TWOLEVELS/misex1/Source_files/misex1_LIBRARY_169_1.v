...
module FAU ( 
  ...
  nand4  g38(.a(x6), .b(new_n23_), .c(new_n16_), .d(new_n17_), .O(new_n54_));
  inv1   g39(.a(new_n54_), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n25_), .O(new_n56_));
  aoi21  g41(.a(new_n23_), .b(x2), .c(new_n19_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n17_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n56_), .O(z4));
  nand3  g44(.a(x3), .b(x2), .c(new_n17_), .O(new_n60_));
  nand3  g45(.a(new_n60_), .b(new_n50_), .c(new_n25_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n19_), .O(new_n62_));
  nand4  g47(.a(x6), .b(new_n25_), .c(new_n23_), .d(new_n16_), .O(new_n63_));
  ...
  nand2  g52(.a(new_n67_), .b(new_n50_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n25_), .c(new_n19_), .O(new_n69_));
  oai21  g54(.a(x4), .b(x2), .c(new_n23_), .O(new_n70_));
