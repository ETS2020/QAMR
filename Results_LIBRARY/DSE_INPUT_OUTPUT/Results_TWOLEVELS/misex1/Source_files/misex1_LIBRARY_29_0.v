...
module FAU ( 
  ...
  oai21  g13(.a(x2), .b(new_n16_), .c(x3), .O(new_n29_));
  nand2  g14(.a(new_n29_), .b(new_n20_), .O(new_n30_));
  inv1   g15(.a(x3), .O(new_n31_));
  oai21  g16(.a(new_n25_), .b(x2), .c(new_n31_), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(x1), .c(new_n16_), .O(new_n33_));
  nand2  g18(.a(new_n33_), .b(new_n30_), .O(z2));
  oai21  g19(.a(x4), .b(x3), .c(x7), .O(new_n35_));
  nand4  g20(.a(new_n35_), .b(new_n21_), .c(x1), .d(new_n16_), .O(new_n36_));
  oai21  g21(.a(x3), .b(x1), .c(new_n36_), .O(z3));
  aoi21  g22(.a(new_n21_), .b(new_n20_), .c(new_n31_), .O(new_n38_));
  aoi21  g23(.a(new_n26_), .b(x1), .c(new_n38_), .O(new_n39_));
  oai21  g24(.a(new_n39_), .b(x0), .c(new_n30_), .O(z4));
  inv1   g25(.a(new_n22_), .O(new_n41_));
  aoi21  g26(.a(new_n21_), .b(new_n20_), .c(x0), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n41_), .c(x3), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n27_), .O(z5));
  oai21  g29(.a(x4), .b(x2), .c(new_n31_), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(x1), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n30_), .O(z6));
endmodule
