...
module FAU ( 
  ...
  aoi21  g19(.a(x4), .b(new_n17_), .c(x3), .O(new_n35_));
  oai21  g20(.a(new_n35_), .b(new_n16_), .c(new_n34_), .O(new_n36_));
  nand3  g21(.a(new_n36_), .b(new_n24_), .c(new_n23_), .O(new_n37_));
  nand2  g22(.a(new_n37_), .b(new_n31_), .O(z2));
  inv1   g23(.a(x4), .O(new_n39_));
  nand3  g24(.a(new_n24_), .b(new_n39_), .c(new_n20_), .O(new_n40_));
  aoi21  g25(.a(new_n40_), .b(x7), .c(x2), .O(new_n41_));
  nand2  g26(.a(x2), .b(new_n16_), .O(new_n42_));
  nand3  g27(.a(new_n24_), .b(new_n25_), .c(new_n20_), .O(new_n43_));
  oai21  g28(.a(new_n43_), .b(new_n42_), .c(new_n24_), .O(new_n44_));
  aoi21  g29(.a(new_n41_), .b(x1), .c(new_n44_), .O(new_n45_));
  oai21  g30(.a(new_n45_), .b(x0), .c(new_n21_), .O(z3));
  ...
  nand2  g46(.a(x2), .b(new_n23_), .O(new_n62_));
  oai21  g47(.a(new_n62_), .b(new_n43_), .c(new_n48_), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n39_), .b(new_n17_), .c(x3), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n16_), .c(new_n24_), .O(new_n66_));
