...
module FAU ( 
  ...
  oai21  g17(.a(new_n32_), .b(new_n16_), .c(x7), .O(new_n33_));
  ...
  nand4  g24(.a(new_n39_), .b(x7), .c(new_n16_), .d(new_n24_), .O(new_n40_));
  aoi21  g25(.a(x4), .b(new_n19_), .c(x3), .O(new_n41_));
  ...
  nand3  g32(.a(x7), .b(new_n25_), .c(new_n16_), .O(new_n48_));
  nor3   g33(.a(new_n48_), .b(new_n19_), .c(x1), .O(new_n49_));
  oai21  g34(.a(new_n49_), .b(new_n47_), .c(new_n18_), .O(new_n50_));
  nor2   g35(.a(new_n17_), .b(x3), .O(new_n51_));
  ...
  nand3  g54(.a(new_n69_), .b(x7), .c(new_n24_), .O(new_n70_));
