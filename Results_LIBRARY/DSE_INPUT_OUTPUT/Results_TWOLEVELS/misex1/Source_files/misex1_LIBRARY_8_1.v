...
module FAU ( 
  ...
  oai22  g34(.a(new_n49_), .b(new_n30_), .c(new_n23_), .d(x2), .O(new_n50_));
  or2    g35(.a(new_n50_), .b(new_n48_), .O(z3));
  nand3  g36(.a(new_n23_), .b(x3), .c(new_n16_), .O(new_n52_));
  aoi21  g37(.a(new_n52_), .b(new_n49_), .c(new_n17_), .O(new_n53_));
  aoi21  g38(.a(new_n40_), .b(new_n27_), .c(x0), .O(new_n54_));
  ...
  aoi22  g53(.a(new_n58_), .b(new_n17_), .c(x4), .d(new_n16_), .O(new_n69_));
