...
module FAU ( 
  ...
  nand3  g08(.a(x3), .b(new_n21_), .c(x0), .O(new_n24_));
  inv1   g09(.a(new_n24_), .O(new_n25_));
  nor2   g10(.a(new_n25_), .b(new_n23_), .O(new_n26_));
  ...
  aoi21  g18(.a(new_n33_), .b(new_n28_), .c(new_n25_), .O(new_n34_));
  nand2  g19(.a(x1), .b(new_n28_), .O(new_n35_));
  oai21  g20(.a(new_n34_), .b(x1), .c(new_n35_), .O(z2));
  nand2  g21(.a(x5), .b(new_n28_), .O(new_n37_));
  ...
  aoi21  g26(.a(new_n41_), .b(new_n40_), .c(new_n28_), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  oai21  g28(.a(new_n17_), .b(x2), .c(new_n28_), .O(new_n44_));
  aoi21  g29(.a(new_n44_), .b(new_n43_), .c(x1), .O(z4));
  oai21  g30(.a(new_n42_), .b(new_n23_), .c(new_n16_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n35_), .O(z5));
  nand4  g32(.a(new_n29_), .b(new_n17_), .c(x2), .d(new_n28_), .O(new_n48_));
