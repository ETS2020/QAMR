...
module FAU ( 
  ...
  nand4  g13(.a(x3), .b(new_n16_), .c(new_n24_), .d(x0), .O(new_n29_));
  ...
  nand4  g20(.a(new_n35_), .b(x5), .c(new_n26_), .d(new_n24_), .O(new_n36_));
  aoi21  g21(.a(new_n36_), .b(new_n34_), .c(x0), .O(new_n37_));
  nand4  g22(.a(x5), .b(x3), .c(new_n24_), .d(x0), .O(new_n38_));
  ...
  nand3  g29(.a(new_n21_), .b(new_n19_), .c(x2), .O(new_n45_));
  ...
  nand3  g35(.a(new_n50_), .b(new_n48_), .c(x5), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n24_), .O(new_n52_));
  aoi21  g37(.a(new_n26_), .b(x2), .c(new_n24_), .O(new_n53_));
  nand4  g38(.a(x6), .b(x5), .c(new_n26_), .d(new_n16_), .O(new_n54_));
  ...
  oai21  g44(.a(new_n58_), .b(new_n17_), .c(new_n59_), .O(new_n60_));
  nand4  g45(.a(x6), .b(new_n26_), .c(new_n16_), .d(new_n17_), .O(new_n61_));
  inv1   g46(.a(new_n61_), .O(new_n62_));
  aoi21  g47(.a(new_n60_), .b(new_n24_), .c(new_n62_), .O(new_n63_));
  nand2  g48(.a(new_n53_), .b(new_n17_), .O(new_n64_));
  oai21  g49(.a(new_n63_), .b(new_n20_), .c(new_n64_), .O(z5));
  aoi21  g50(.a(new_n47_), .b(x0), .c(new_n20_), .O(new_n66_));
