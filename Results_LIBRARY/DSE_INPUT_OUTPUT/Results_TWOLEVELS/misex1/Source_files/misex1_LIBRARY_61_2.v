...
module FAU ( 
  ...
  aoi21  g31(.a(new_n31_), .b(x2), .c(new_n46_), .O(new_n47_));
  nand2  g32(.a(x6), .b(new_n19_), .O(new_n48_));
  oai21  g33(.a(new_n47_), .b(x1), .c(new_n48_), .O(new_n49_));
  aoi21  g34(.a(new_n49_), .b(new_n24_), .c(new_n21_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n45_), .c(x0), .O(z4));
  aoi21  g36(.a(x5), .b(new_n30_), .c(x3), .O(new_n52_));
  nor2   g37(.a(new_n52_), .b(new_n19_), .O(new_n53_));
  aoi21  g38(.a(new_n27_), .b(new_n19_), .c(new_n53_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x0), .c(new_n39_), .O(z5));
  nor2   g40(.a(new_n24_), .b(new_n30_), .O(new_n56_));
  nor3   g41(.a(x5), .b(x3), .c(x1), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n56_), .c(x2), .O(new_n58_));
  nand2  g43(.a(x4), .b(new_n24_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(new_n19_), .c(x1), .O(new_n60_));
