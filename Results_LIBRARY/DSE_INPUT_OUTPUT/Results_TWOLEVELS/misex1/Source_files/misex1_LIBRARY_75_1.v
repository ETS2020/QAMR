...
module FAU ( 
  ...
  nor2   g16(.a(x2), .b(new_n17_), .O(new_n32_));
  aoi21  g17(.a(new_n32_), .b(x3), .c(x7), .O(new_n33_));
  ...
  nand4  g23(.a(new_n38_), .b(new_n20_), .c(new_n19_), .d(new_n24_), .O(new_n39_));
  ...
  nand4  g27(.a(new_n21_), .b(new_n20_), .c(x3), .d(new_n16_), .O(new_n43_));
  ...
  aoi21  g39(.a(new_n37_), .b(new_n35_), .c(x3), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n26_), .c(new_n17_), .O(new_n56_));
  nand3  g41(.a(new_n56_), .b(new_n54_), .c(new_n20_), .O(new_n57_));
  ...
  nand4  g55(.a(new_n25_), .b(new_n19_), .c(x2), .d(new_n17_), .O(new_n71_));
  nand2  g56(.a(new_n71_), .b(new_n54_), .O(new_n72_));
