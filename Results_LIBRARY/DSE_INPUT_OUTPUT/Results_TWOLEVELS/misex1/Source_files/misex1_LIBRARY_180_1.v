...
module FAU ( 
  ...
  nand4  g34(.a(new_n49_), .b(new_n16_), .c(x2), .d(new_n23_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(new_n52_));
  nand3  g37(.a(new_n35_), .b(new_n31_), .c(x2), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n52_), .O(z3));
  xor2a  g39(.a(x3), .b(x2), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(x0), .O(new_n56_));
  aoi21  g41(.a(new_n40_), .b(new_n16_), .c(new_n25_), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(x0), .c(new_n56_), .O(new_n58_));
  nand3  g43(.a(new_n28_), .b(new_n18_), .c(new_n17_), .O(new_n59_));
  inv1   g44(.a(new_n59_), .O(new_n60_));
  aoi21  g45(.a(new_n58_), .b(new_n23_), .c(new_n60_), .O(new_n61_));
  ...
  oai21  g50(.a(new_n65_), .b(new_n60_), .c(new_n34_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n62_), .O(z5));
  nand4  g52(.a(new_n24_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n56_), .c(new_n34_), .O(new_n69_));
