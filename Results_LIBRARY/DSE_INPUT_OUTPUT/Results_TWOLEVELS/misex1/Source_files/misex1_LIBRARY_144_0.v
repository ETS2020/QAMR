...
module FAU ( 
  ...
  nand2  g14(.a(new_n26_), .b(new_n16_), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z1));
  nand2  g16(.a(x3), .b(x1), .O(new_n32_));
  nand3  g17(.a(new_n23_), .b(new_n22_), .c(new_n16_), .O(new_n33_));
  aoi21  g18(.a(new_n33_), .b(new_n32_), .c(new_n26_), .O(new_n34_));
  ...
  aoi21  g24(.a(x5), .b(new_n17_), .c(x3), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(new_n26_), .c(new_n16_), .O(new_n41_));
  oai21  g26(.a(new_n37_), .b(new_n16_), .c(x7), .O(new_n42_));
  nand3  g27(.a(new_n42_), .b(new_n26_), .c(new_n17_), .O(new_n43_));
  nand2  g28(.a(new_n43_), .b(new_n41_), .O(z3));
  nand3  g29(.a(new_n36_), .b(new_n26_), .c(x1), .O(new_n45_));
  ...
  nand2  g34(.a(new_n49_), .b(new_n38_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n47_), .c(new_n17_), .O(new_n51_));
  nand4  g36(.a(new_n22_), .b(x2), .c(new_n16_), .d(x0), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(new_n51_), .O(z4));
  nand3  g38(.a(x2), .b(new_n16_), .c(x0), .O(new_n54_));
  nand4  g39(.a(new_n36_), .b(new_n26_), .c(x1), .d(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n54_), .O(new_n56_));
  nand2  g41(.a(new_n56_), .b(new_n22_), .O(new_n57_));
  nand2  g42(.a(new_n50_), .b(new_n17_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n57_), .c(new_n30_), .O(z5));
  oai21  g44(.a(new_n36_), .b(x3), .c(new_n26_), .O(new_n60_));
  nor2   g45(.a(new_n60_), .b(new_n16_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n34_), .c(new_n17_), .O(new_n62_));
