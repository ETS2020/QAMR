...
module FAU ( 
  ...
  nand3  g24(.a(new_n25_), .b(new_n16_), .c(x2), .O(new_n40_));
  ...
  nand2  g30(.a(new_n31_), .b(new_n28_), .O(new_n46_));
  ...
  oai21  g34(.a(new_n49_), .b(x0), .c(new_n38_), .O(z2));
  nand2  g35(.a(new_n31_), .b(x7), .O(new_n51_));
  nand3  g36(.a(new_n51_), .b(new_n28_), .c(x1), .O(new_n52_));
  inv1   g37(.a(new_n52_), .O(new_n53_));
  nand3  g38(.a(new_n25_), .b(new_n16_), .c(new_n20_), .O(new_n54_));
  nor3   g39(.a(new_n54_), .b(new_n28_), .c(x1), .O(new_n55_));
  oai21  g40(.a(new_n55_), .b(new_n53_), .c(new_n17_), .O(new_n56_));
  nand3  g41(.a(new_n16_), .b(new_n20_), .c(x2), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n36_), .c(new_n56_), .O(z3));
  aoi21  g43(.a(new_n57_), .b(new_n37_), .c(new_n17_), .O(new_n59_));
  nand3  g44(.a(new_n26_), .b(new_n16_), .c(x2), .O(new_n60_));
  aoi21  g45(.a(new_n60_), .b(new_n44_), .c(x0), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n59_), .c(new_n19_), .O(new_n62_));
  nand2  g47(.a(x1), .b(new_n17_), .O(new_n63_));
  oai21  g48(.a(new_n63_), .b(new_n20_), .c(new_n16_), .O(new_n64_));
  oai21  g49(.a(x4), .b(new_n19_), .c(new_n41_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n20_), .O(new_n66_));
  aoi21  g51(.a(new_n66_), .b(new_n32_), .c(x2), .O(new_n67_));
  aoi22  g52(.a(new_n67_), .b(new_n17_), .c(new_n64_), .d(x2), .O(new_n68_));
  nand2  g53(.a(new_n68_), .b(new_n62_), .O(z4));
  nand4  g54(.a(new_n26_), .b(new_n16_), .c(x2), .d(new_n17_), .O(new_n70_));
  ...
  nor3   g59(.a(new_n54_), .b(new_n28_), .c(x0), .O(new_n75_));
  oai21  g60(.a(new_n75_), .b(new_n59_), .c(new_n19_), .O(new_n76_));
  nand2  g61(.a(x4), .b(new_n20_), .O(new_n77_));
  nand4  g62(.a(new_n77_), .b(new_n28_), .c(x1), .d(new_n17_), .O(new_n78_));
  nand3  g63(.a(new_n78_), .b(new_n76_), .c(new_n74_), .O(z6));
endmodule
