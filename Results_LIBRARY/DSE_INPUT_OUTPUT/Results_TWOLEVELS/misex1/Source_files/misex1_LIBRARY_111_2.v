...
module FAU ( 
  ...
  oai21  g11(.a(new_n26_), .b(new_n22_), .c(x6), .O(new_n27_));
  nand2  g12(.a(new_n27_), .b(x1), .O(new_n28_));
  oai21  g13(.a(x5), .b(x3), .c(x2), .O(new_n29_));
  nand3  g14(.a(x6), .b(new_n22_), .c(new_n18_), .O(new_n30_));
  oai21  g15(.a(new_n29_), .b(x1), .c(new_n30_), .O(new_n31_));
  nand2  g16(.a(new_n31_), .b(new_n25_), .O(new_n32_));
  nand2  g17(.a(x3), .b(new_n18_), .O(new_n33_));
  or2    g18(.a(new_n33_), .b(new_n21_), .O(new_n34_));
  ...
  nor2   g23(.a(new_n38_), .b(x3), .O(new_n39_));
  inv1   g24(.a(x4), .O(new_n40_));
  oai21  g25(.a(new_n40_), .b(x2), .c(new_n22_), .O(new_n41_));
  nand3  g26(.a(new_n41_), .b(x6), .c(x1), .O(new_n42_));
  inv1   g27(.a(new_n42_), .O(new_n43_));
  aoi21  g28(.a(new_n39_), .b(new_n16_), .c(new_n43_), .O(new_n44_));
  oai21  g29(.a(new_n44_), .b(x0), .c(new_n34_), .O(z2));
  nand3  g30(.a(new_n36_), .b(x2), .c(new_n16_), .O(new_n46_));
  nand4  g31(.a(x6), .b(new_n40_), .c(new_n18_), .d(x1), .O(new_n47_));
  aoi21  g32(.a(new_n47_), .b(new_n46_), .c(x0), .O(new_n48_));
  nand3  g33(.a(x2), .b(new_n16_), .c(x0), .O(new_n49_));
  inv1   g34(.a(new_n49_), .O(new_n50_));
  oai21  g35(.a(new_n50_), .b(new_n48_), .c(new_n22_), .O(new_n51_));
  nor3   g36(.a(x7), .b(x2), .c(x0), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n17_), .c(x1), .O(new_n53_));
  nand2  g38(.a(new_n53_), .b(new_n51_), .O(z3));
  aoi21  g39(.a(new_n33_), .b(new_n23_), .c(new_n25_), .O(new_n55_));
  oai21  g40(.a(new_n38_), .b(x3), .c(new_n29_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n25_), .c(new_n55_), .O(new_n57_));
  nand2  g42(.a(x3), .b(x1), .O(new_n58_));
  oai21  g43(.a(x3), .b(x2), .c(new_n58_), .O(new_n59_));
  nand3  g44(.a(new_n59_), .b(x6), .c(new_n25_), .O(new_n60_));
  ...
  nand2  g48(.a(new_n17_), .b(x1), .O(new_n64_));
  nand3  g49(.a(new_n64_), .b(new_n63_), .c(new_n60_), .O(z5));
  nand3  g50(.a(new_n19_), .b(new_n36_), .c(new_n22_), .O(new_n66_));
  inv1   g51(.a(new_n66_), .O(new_n67_));
  oai21  g52(.a(new_n67_), .b(new_n55_), .c(new_n16_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n22_), .O(new_n69_));
  nand4  g54(.a(new_n69_), .b(x6), .c(x1), .d(new_n25_), .O(new_n70_));
