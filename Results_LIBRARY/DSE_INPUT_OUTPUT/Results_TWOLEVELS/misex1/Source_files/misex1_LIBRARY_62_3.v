...
module FAU ( 
  ...
  oai21  g33(.a(new_n19_), .b(new_n16_), .c(new_n48_), .O(z3));
  ...
  nor2   g43(.a(new_n58_), .b(new_n19_), .O(new_n59_));
  aoi21  g44(.a(new_n30_), .b(new_n19_), .c(new_n59_), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(x0), .c(new_n22_), .O(z5));
  nand2  g46(.a(x3), .b(x1), .O(new_n62_));
  nand2  g47(.a(new_n24_), .b(new_n23_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n62_), .c(new_n19_), .O(new_n64_));
  oai21  g49(.a(new_n26_), .b(x3), .c(new_n19_), .O(new_n65_));
  nor2   g50(.a(new_n65_), .b(new_n23_), .O(new_n66_));
  oai21  g51(.a(new_n66_), .b(new_n64_), .c(new_n16_), .O(new_n67_));
  nand2  g52(.a(new_n67_), .b(new_n22_), .O(z6));
endmodule
