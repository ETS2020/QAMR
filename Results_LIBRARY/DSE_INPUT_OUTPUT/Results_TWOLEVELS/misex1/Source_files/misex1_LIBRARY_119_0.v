...
module FAU ( 
  ...
  oai22  g25(.a(new_n16_), .b(new_n21_), .c(new_n40_), .d(x2), .O(new_n41_));
  aoi21  g26(.a(new_n41_), .b(x1), .c(new_n16_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(x0), .c(new_n39_), .O(z2));
  oai21  g28(.a(x4), .b(x3), .c(x7), .O(new_n44_));
  nand3  g29(.a(new_n44_), .b(new_n18_), .c(x1), .O(new_n45_));
  nand4  g30(.a(new_n25_), .b(new_n21_), .c(x2), .d(new_n17_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nand3  g32(.a(new_n47_), .b(x6), .c(new_n24_), .O(new_n48_));
  nand2  g33(.a(new_n48_), .b(new_n22_), .O(z3));
  xor2a  g34(.a(x3), .b(x2), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(x0), .O(new_n51_));
  oai21  g36(.a(new_n25_), .b(x3), .c(new_n18_), .O(new_n52_));
  nand3  g37(.a(new_n52_), .b(x6), .c(new_n24_), .O(new_n53_));
  ...
  nand2  g45(.a(x3), .b(new_n18_), .O(new_n61_));
  aoi21  g46(.a(new_n61_), .b(new_n60_), .c(new_n24_), .O(new_n62_));
  nand2  g47(.a(x5), .b(new_n21_), .O(new_n63_));
  aoi21  g48(.a(new_n63_), .b(new_n26_), .c(new_n16_), .O(new_n64_));
  aoi21  g49(.a(new_n64_), .b(new_n24_), .c(new_n62_), .O(new_n65_));
  oai21  g50(.a(new_n57_), .b(new_n16_), .c(new_n24_), .O(new_n66_));
  oai21  g51(.a(new_n65_), .b(x1), .c(new_n66_), .O(z5));
  oai21  g52(.a(new_n62_), .b(new_n38_), .c(new_n17_), .O(new_n68_));
  oai21  g53(.a(x4), .b(x2), .c(new_n21_), .O(new_n69_));
  nand4  g54(.a(new_n69_), .b(x6), .c(x1), .d(new_n24_), .O(new_n70_));
