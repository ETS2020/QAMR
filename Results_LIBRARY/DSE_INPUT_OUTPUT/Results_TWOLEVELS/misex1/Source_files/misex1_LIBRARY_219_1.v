...
module FAU ( 
  ...
  nand3  g13(.a(new_n28_), .b(new_n21_), .c(new_n20_), .O(new_n29_));
  nand4  g14(.a(x3), .b(new_n16_), .c(new_n17_), .d(x0), .O(new_n30_));
  nand2  g15(.a(new_n30_), .b(new_n29_), .O(z1));
  nand2  g16(.a(x5), .b(x2), .O(new_n32_));
  nand3  g17(.a(new_n32_), .b(new_n18_), .c(new_n17_), .O(new_n33_));
  aoi21  g18(.a(x4), .b(new_n16_), .c(x3), .O(new_n34_));
  oai21  g19(.a(new_n34_), .b(new_n17_), .c(new_n33_), .O(new_n35_));
  nand3  g20(.a(new_n35_), .b(new_n21_), .c(new_n20_), .O(new_n36_));
  nand2  g21(.a(new_n36_), .b(new_n30_), .O(z2));
  inv1   g22(.a(x4), .O(new_n38_));
  nand3  g23(.a(new_n21_), .b(new_n38_), .c(new_n18_), .O(new_n39_));
  aoi21  g24(.a(new_n39_), .b(x7), .c(x2), .O(new_n40_));
  nand2  g25(.a(x2), .b(new_n17_), .O(new_n41_));
  nand3  g26(.a(new_n21_), .b(new_n24_), .c(new_n18_), .O(new_n42_));
  oai21  g27(.a(new_n42_), .b(new_n41_), .c(new_n21_), .O(new_n43_));
  aoi21  g28(.a(new_n40_), .b(x1), .c(new_n43_), .O(new_n44_));
  nand4  g29(.a(new_n18_), .b(x2), .c(new_n17_), .d(x0), .O(new_n45_));
  oai21  g30(.a(new_n44_), .b(x0), .c(new_n45_), .O(z3));
  xor2a  g31(.a(x3), .b(x2), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(x0), .O(new_n48_));
  nand2  g33(.a(x3), .b(new_n16_), .O(new_n49_));
  nand3  g34(.a(new_n49_), .b(new_n21_), .c(new_n20_), .O(new_n50_));
  nand2  g35(.a(new_n50_), .b(new_n48_), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n17_), .O(new_n52_));
  nor2   g37(.a(x3), .b(new_n16_), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n17_), .c(new_n21_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n20_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n52_), .O(z4));
  nand4  g41(.a(new_n25_), .b(new_n21_), .c(x2), .d(new_n20_), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(new_n48_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n17_), .O(new_n59_));
  nand2  g44(.a(new_n59_), .b(new_n55_), .O(z5));
  nand2  g45(.a(x2), .b(new_n20_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(new_n42_), .c(new_n48_), .O(new_n62_));
