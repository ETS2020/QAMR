...
module FAU ( 
  ...
  aoi21  g35(.a(new_n36_), .b(new_n34_), .c(x1), .O(new_n51_));
  nor2   g36(.a(new_n35_), .b(x2), .O(new_n52_));
  oai21  g37(.a(new_n52_), .b(new_n51_), .c(new_n20_), .O(new_n53_));
  nand3  g38(.a(new_n53_), .b(new_n50_), .c(new_n49_), .O(new_n54_));
  nand2  g39(.a(new_n54_), .b(new_n17_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n47_), .O(z4));
  oai21  g41(.a(x3), .b(x1), .c(x2), .O(new_n57_));
  nand2  g42(.a(new_n57_), .b(x0), .O(new_n58_));
  aoi21  g43(.a(x5), .b(new_n19_), .c(x3), .O(new_n59_));
  nor2   g44(.a(new_n59_), .b(new_n16_), .O(new_n60_));
  aoi21  g45(.a(new_n29_), .b(new_n16_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n61_), .b(x0), .c(new_n58_), .O(z5));
