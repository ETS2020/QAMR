...
module FAU ( 
  ...
  nand4  g33(.a(new_n21_), .b(new_n20_), .c(new_n19_), .d(x2), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(z3));
  xor2a  g35(.a(x3), .b(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(x0), .O(new_n52_));
  aoi21  g37(.a(new_n36_), .b(new_n34_), .c(x3), .O(new_n53_));
  oai21  g38(.a(new_n53_), .b(new_n26_), .c(new_n17_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n52_), .c(new_n20_), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n24_), .O(new_n56_));
  aoi21  g41(.a(new_n19_), .b(x2), .c(new_n24_), .O(new_n57_));
  nand4  g42(.a(new_n20_), .b(x6), .c(new_n19_), .d(new_n16_), .O(new_n58_));
  ...
  nand3  g54(.a(new_n69_), .b(new_n52_), .c(new_n20_), .O(new_n70_));
