...
module FAU ( 
  ...
  aoi21  g15(.a(new_n30_), .b(new_n23_), .c(new_n25_), .O(new_n31_));
  inv1   g16(.a(x1), .O(new_n32_));
  nand4  g17(.a(x3), .b(new_n23_), .c(new_n32_), .d(x0), .O(new_n33_));
  oai21  g18(.a(new_n31_), .b(x0), .c(new_n33_), .O(z1));
  nor2   g19(.a(x5), .b(new_n23_), .O(new_n35_));
  nor2   g20(.a(x6), .b(x2), .O(new_n36_));
  oai21  g21(.a(new_n36_), .b(new_n35_), .c(new_n16_), .O(new_n37_));
  oai21  g22(.a(new_n26_), .b(x2), .c(new_n16_), .O(new_n38_));
  ...
  nand2  g27(.a(new_n28_), .b(x7), .O(new_n43_));
  nand3  g28(.a(new_n43_), .b(new_n23_), .c(x1), .O(new_n44_));
  nor2   g29(.a(x5), .b(x3), .O(new_n45_));
  nand3  g30(.a(new_n45_), .b(x2), .c(new_n32_), .O(new_n46_));
  nand2  g31(.a(new_n46_), .b(new_n44_), .O(new_n47_));
  nand2  g32(.a(new_n47_), .b(new_n20_), .O(new_n48_));
  nand3  g33(.a(new_n18_), .b(new_n32_), .c(x0), .O(new_n49_));
  nand2  g34(.a(new_n49_), .b(new_n48_), .O(z3));
  nand2  g35(.a(x3), .b(new_n23_), .O(new_n51_));
  aoi21  g36(.a(new_n51_), .b(new_n17_), .c(new_n20_), .O(new_n52_));
  inv1   g37(.a(x5), .O(new_n53_));
  aoi21  g38(.a(new_n53_), .b(x2), .c(new_n36_), .O(new_n54_));
  oai21  g39(.a(new_n54_), .b(x3), .c(new_n24_), .O(new_n55_));
  aoi21  g40(.a(new_n55_), .b(new_n20_), .c(new_n52_), .O(new_n56_));
  oai21  g41(.a(x3), .b(new_n23_), .c(x1), .O(new_n57_));
  nand3  g42(.a(x6), .b(new_n16_), .c(new_n23_), .O(new_n58_));
  nand2  g43(.a(new_n58_), .b(new_n57_), .O(new_n59_));
  nor2   g44(.a(new_n32_), .b(new_n20_), .O(new_n60_));
  aoi21  g45(.a(new_n59_), .b(new_n20_), .c(new_n60_), .O(new_n61_));
  oai21  g46(.a(new_n56_), .b(x1), .c(new_n61_), .O(z4));
  nand2  g47(.a(new_n59_), .b(new_n20_), .O(new_n63_));
  nor2   g48(.a(new_n24_), .b(x0), .O(new_n64_));
  oai21  g49(.a(new_n64_), .b(new_n52_), .c(new_n32_), .O(new_n65_));
  nand2  g50(.a(new_n65_), .b(new_n63_), .O(z5));
  nand3  g51(.a(new_n45_), .b(x2), .c(new_n20_), .O(new_n67_));
  inv1   g52(.a(new_n67_), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n52_), .c(new_n32_), .O(new_n69_));
  oai21  g54(.a(x4), .b(x2), .c(new_n16_), .O(new_n70_));
