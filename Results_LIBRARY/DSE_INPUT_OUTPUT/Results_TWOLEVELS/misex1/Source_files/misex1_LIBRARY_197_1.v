...
module FAU ( 
  ...
  nand4  g44(.a(new_n21_), .b(x3), .c(x2), .d(new_n20_), .O(new_n60_));
  nand2  g45(.a(new_n60_), .b(new_n50_), .O(new_n61_));
  nand2  g46(.a(new_n61_), .b(new_n17_), .O(new_n62_));
  oai21  g47(.a(new_n57_), .b(x5), .c(new_n20_), .O(new_n63_));
  ...
  aoi21  g52(.a(new_n41_), .b(new_n16_), .c(x3), .O(new_n68_));
  oai21  g53(.a(new_n68_), .b(new_n17_), .c(new_n21_), .O(new_n69_));
