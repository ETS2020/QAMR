...
module FAU ( 
  ...
  aoi21  g40(.a(new_n26_), .b(x2), .c(new_n31_), .O(new_n56_));
  ...
  nand2  g47(.a(x1), .b(x0), .O(new_n63_));
  nand3  g48(.a(new_n63_), .b(new_n62_), .c(new_n59_), .O(z5));
  oai21  g49(.a(new_n50_), .b(x1), .c(x0), .O(new_n65_));
  nand2  g50(.a(x3), .b(x1), .O(new_n66_));
  nand2  g51(.a(new_n44_), .b(new_n31_), .O(new_n67_));
  aoi21  g52(.a(new_n67_), .b(new_n66_), .c(new_n16_), .O(new_n68_));
  oai21  g53(.a(new_n24_), .b(x3), .c(new_n16_), .O(new_n69_));
