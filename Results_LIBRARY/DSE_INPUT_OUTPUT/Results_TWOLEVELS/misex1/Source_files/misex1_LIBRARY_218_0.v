...
module FAU ( 
  ...
  aoi22  g14(.a(new_n29_), .b(new_n16_), .c(new_n24_), .d(new_n19_), .O(new_n30_));
  nand2  g15(.a(x3), .b(new_n16_), .O(new_n31_));
  oai21  g16(.a(new_n31_), .b(new_n17_), .c(x7), .O(new_n32_));
  ...
  aoi21  g25(.a(new_n38_), .b(new_n19_), .c(new_n40_), .O(new_n41_));
  oai21  g26(.a(new_n41_), .b(x0), .c(new_n33_), .O(z2));
  inv1   g27(.a(x7), .O(new_n43_));
  nand2  g28(.a(new_n23_), .b(new_n17_), .O(new_n44_));
  nand2  g29(.a(x7), .b(x0), .O(new_n45_));
  aoi21  g30(.a(new_n45_), .b(new_n44_), .c(x3), .O(new_n46_));
  aoi21  g31(.a(new_n46_), .b(x2), .c(new_n43_), .O(new_n47_));
  oai21  g32(.a(new_n27_), .b(new_n19_), .c(x7), .O(new_n48_));
  nand3  g33(.a(new_n48_), .b(new_n16_), .c(new_n17_), .O(new_n49_));
  oai21  g34(.a(new_n47_), .b(x1), .c(new_n49_), .O(z3));
  nand3  g35(.a(x7), .b(new_n20_), .c(x2), .O(new_n51_));
  nand2  g36(.a(new_n51_), .b(new_n31_), .O(new_n52_));
  nand2  g37(.a(new_n52_), .b(x0), .O(new_n53_));
  oai21  g38(.a(new_n38_), .b(new_n24_), .c(new_n17_), .O(new_n54_));
  nand3  g39(.a(new_n54_), .b(new_n53_), .c(x7), .O(new_n55_));
  nand2  g40(.a(new_n55_), .b(new_n19_), .O(new_n56_));
  aoi21  g41(.a(new_n20_), .b(x2), .c(new_n19_), .O(new_n57_));
  ...
  nand2  g46(.a(new_n24_), .b(new_n17_), .O(new_n62_));
  nand3  g47(.a(new_n62_), .b(new_n53_), .c(x7), .O(new_n63_));
  nand2  g48(.a(new_n63_), .b(new_n19_), .O(new_n64_));
  nand2  g49(.a(new_n64_), .b(new_n60_), .O(z5));
  nand4  g50(.a(new_n23_), .b(new_n20_), .c(x2), .d(new_n17_), .O(new_n66_));
  nand3  g51(.a(new_n66_), .b(new_n53_), .c(x7), .O(new_n67_));
