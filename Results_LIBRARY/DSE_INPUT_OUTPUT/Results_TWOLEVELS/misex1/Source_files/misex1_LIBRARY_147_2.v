...
module FAU ( 
  ...
  oai21  g29(.a(new_n44_), .b(new_n19_), .c(x5), .O(new_n45_));
  ...
  nor2   g34(.a(x1), .b(new_n16_), .O(new_n50_));
  aoi21  g35(.a(new_n50_), .b(new_n19_), .c(new_n35_), .O(new_n51_));
  oai21  g36(.a(new_n51_), .b(new_n24_), .c(new_n49_), .O(z3));
  nand2  g37(.a(x3), .b(new_n24_), .O(new_n53_));
  nand3  g38(.a(x5), .b(new_n19_), .c(x2), .O(new_n54_));
  aoi21  g39(.a(new_n54_), .b(new_n53_), .c(new_n16_), .O(new_n55_));
  nand3  g40(.a(new_n38_), .b(new_n19_), .c(new_n24_), .O(new_n56_));
  aoi21  g41(.a(new_n56_), .b(new_n27_), .c(x0), .O(new_n57_));
  oai21  g42(.a(new_n57_), .b(new_n55_), .c(new_n18_), .O(new_n58_));
  nand3  g43(.a(new_n58_), .b(new_n46_), .c(new_n34_), .O(z4));
  oai21  g44(.a(new_n55_), .b(new_n28_), .c(new_n18_), .O(new_n60_));
  oai21  g45(.a(x5), .b(new_n24_), .c(x3), .O(new_n61_));
  oai21  g46(.a(x4), .b(new_n19_), .c(new_n24_), .O(new_n62_));
  aoi21  g47(.a(new_n62_), .b(new_n61_), .c(new_n18_), .O(new_n63_));
  nand3  g48(.a(x6), .b(new_n19_), .c(new_n24_), .O(new_n64_));
  inv1   g49(.a(new_n64_), .O(new_n65_));
  oai21  g50(.a(new_n65_), .b(new_n63_), .c(new_n16_), .O(new_n66_));
  nand2  g51(.a(new_n66_), .b(new_n60_), .O(z5));
  nand2  g52(.a(new_n54_), .b(new_n53_), .O(new_n68_));
  nand3  g53(.a(new_n68_), .b(new_n18_), .c(x0), .O(new_n69_));
  oai21  g54(.a(new_n30_), .b(x3), .c(new_n24_), .O(new_n70_));
  nand3  g55(.a(x5), .b(x3), .c(x2), .O(new_n71_));
