...
module FAU ( 
  ...
  nand4  g30(.a(x7), .b(new_n38_), .c(new_n16_), .d(x1), .O(new_n46_));
  ...
  aoi21  g34(.a(new_n49_), .b(new_n48_), .c(x3), .O(z3));
  ...
  oai21  g43(.a(new_n58_), .b(new_n17_), .c(new_n55_), .O(z4));
  aoi21  g44(.a(new_n24_), .b(new_n23_), .c(x0), .O(new_n60_));
  oai21  g45(.a(new_n60_), .b(new_n53_), .c(new_n17_), .O(new_n61_));
  nand3  g46(.a(new_n57_), .b(x1), .c(new_n20_), .O(new_n62_));
  nand2  g47(.a(new_n62_), .b(new_n61_), .O(z5));
  nand4  g48(.a(new_n34_), .b(new_n18_), .c(x2), .d(new_n20_), .O(new_n64_));
  ...
  nand4  g52(.a(new_n67_), .b(x7), .c(x1), .d(new_n20_), .O(new_n68_));
