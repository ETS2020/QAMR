...
module FAU ( 
  ...
  oai21  g058(.a(x10), .b(new_n111_), .c(x25), .O(new_n142_));
  nand3  g059(.a(x26), .b(new_n84_), .c(x08), .O(new_n143_));
  nand2  g060(.a(new_n143_), .b(new_n142_), .O(z14));
  ...
  oai21  g069(.a(new_n151_), .b(new_n111_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g075(.a(new_n158_), .b(new_n89_), .O(z18));
  nand2  g076(.a(x08), .b(x00), .O(new_n160_));
  nand2  g077(.a(x30), .b(new_n111_), .O(new_n161_));
  ...
  nand2  g087(.a(new_n170_), .b(new_n89_), .O(z21));
  ...
  nand2  g091(.a(new_n174_), .b(new_n89_), .O(z22));
  ...
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(z24));
  ...
  nand2  g103(.a(new_n186_), .b(new_n89_), .O(z25));
  ...
  nand2  g128(.a(new_n205_), .b(x42), .O(new_n212_));
  nand3  g129(.a(x43), .b(new_n199_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z31));
  inv1   g131(.a(x43), .O(new_n215_));
  aoi21  g132(.a(new_n199_), .b(x09), .c(new_n215_), .O(new_n216_));
