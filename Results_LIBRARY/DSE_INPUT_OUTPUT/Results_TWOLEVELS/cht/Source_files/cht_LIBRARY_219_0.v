...
module FAU ( 
  ...
  nand3  g054(.a(new_n137_), .b(new_n92_), .c(x09), .O(new_n138_));
  inv1   g055(.a(new_n138_), .O(z12));
  nand2  g056(.a(x24), .b(new_n122_), .O(new_n140_));
  nand2  g057(.a(x25), .b(x08), .O(new_n141_));
  nand3  g058(.a(new_n141_), .b(new_n140_), .c(x09), .O(new_n142_));
  and2   g059(.a(new_n142_), .b(new_n92_), .O(z13));
  nand2  g060(.a(x25), .b(new_n122_), .O(new_n144_));
  nand2  g061(.a(x26), .b(x08), .O(new_n145_));
  nand3  g062(.a(new_n145_), .b(new_n144_), .c(x09), .O(new_n146_));
  and2   g063(.a(new_n146_), .b(new_n92_), .O(z14));
  ...
  and2   g067(.a(new_n150_), .b(new_n92_), .O(z15));
