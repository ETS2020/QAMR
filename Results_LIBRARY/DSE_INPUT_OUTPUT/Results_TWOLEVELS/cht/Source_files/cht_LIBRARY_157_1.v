...
module FAU ( 
  ...
  nor2   g052(.a(x24), .b(x08), .O(new_n136_));
  oai21  g053(.a(new_n136_), .b(x23), .c(x22), .O(new_n137_));
  ...
  nand3  g058(.a(new_n141_), .b(x23), .c(new_n90_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(new_n88_), .O(z12));
  nor2   g060(.a(new_n140_), .b(x08), .O(new_n144_));
  ...
  nand2  g158(.a(new_n214_), .b(x45), .O(new_n242_));
  nand3  g159(.a(x46), .b(new_n100_), .c(x09), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n88_), .c(new_n90_), .O(new_n245_));
  inv1   g162(.a(new_n245_), .O(z34));
  inv1   g163(.a(x00), .O(new_n247_));
  nand2  g164(.a(new_n214_), .b(x46), .O(new_n248_));
  oai21  g165(.a(new_n214_), .b(new_n247_), .c(new_n248_), .O(new_n249_));
