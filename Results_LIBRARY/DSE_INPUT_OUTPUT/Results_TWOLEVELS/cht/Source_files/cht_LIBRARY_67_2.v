...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n90_), .O(z12));
  ...
  oai21  g057(.a(new_n139_), .b(new_n110_), .c(new_n140_), .O(new_n141_));
  ...
  nand2  g063(.a(new_n146_), .b(new_n90_), .O(z15));
  ...
  oai21  g090(.a(new_n172_), .b(new_n164_), .c(new_n173_), .O(new_n174_));
  ...
  nor2   g113(.a(new_n189_), .b(x09), .O(new_n197_));
  aoi21  g114(.a(new_n196_), .b(x09), .c(new_n197_), .O(new_n198_));
  ...
  aoi21  g137(.a(new_n200_), .b(x09), .c(new_n220_), .O(new_n221_));
  ...
  nand2  g145(.a(new_n201_), .b(x45), .O(new_n229_));
  nand3  g146(.a(x46), .b(new_n200_), .c(x09), .O(new_n230_));
  aoi21  g147(.a(new_n230_), .b(new_n229_), .c(x10), .O(z34));
  inv1   g148(.a(x46), .O(new_n232_));
  aoi21  g149(.a(new_n200_), .b(x09), .c(new_n232_), .O(new_n233_));
  nand3  g150(.a(new_n200_), .b(x09), .c(x00), .O(new_n234_));
