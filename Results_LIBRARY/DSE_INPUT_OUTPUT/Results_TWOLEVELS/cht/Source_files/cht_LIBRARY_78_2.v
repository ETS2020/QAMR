...
module FAU ( 
  ...
  nand2  g041(.a(x21), .b(new_n115_), .O(new_n125_));
  ...
  nand2  g069(.a(x28), .b(new_n115_), .O(new_n153_));
  nand2  g070(.a(x29), .b(x08), .O(new_n154_));
  aoi21  g071(.a(new_n154_), .b(new_n153_), .c(x10), .O(z17));
  nand2  g072(.a(x29), .b(new_n115_), .O(new_n156_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n94_), .O(z19));
  ...
  nand2  g088(.a(new_n171_), .b(new_n94_), .O(z21));
  ...
  nand2  g096(.a(new_n179_), .b(new_n94_), .O(z23));
  ...
  nand2  g100(.a(new_n183_), .b(new_n94_), .O(z24));
  nand2  g101(.a(x36), .b(new_n164_), .O(new_n185_));
  ...
  aoi21  g112(.a(new_n193_), .b(x09), .c(new_n195_), .O(new_n196_));
  oai21  g113(.a(new_n196_), .b(x10), .c(new_n94_), .O(z27));
  ...
  aoi21  g119(.a(new_n198_), .b(x09), .c(new_n93_), .O(new_n203_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n94_), .O(z29));
  nand2  g124(.a(new_n199_), .b(x41), .O(new_n208_));
  nand3  g125(.a(x42), .b(new_n198_), .c(x09), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z30));
  nand2  g127(.a(new_n199_), .b(x42), .O(new_n211_));
  nand3  g128(.a(x43), .b(new_n198_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z31));
  inv1   g130(.a(x43), .O(new_n214_));
  aoi21  g131(.a(new_n198_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  nand2  g135(.a(new_n218_), .b(new_n94_), .O(z32));
  ...
  nand3  g140(.a(x46), .b(new_n198_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z34));
  nand2  g142(.a(new_n199_), .b(x46), .O(new_n226_));
  nand3  g143(.a(new_n198_), .b(x09), .c(x00), .O(new_n227_));
