...
module FAU ( 
  ...
  nand2  g046(.a(x21), .b(new_n117_), .O(new_n130_));
  oai21  g047(.a(new_n129_), .b(new_n117_), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g054(.a(x23), .b(new_n117_), .O(new_n138_));
  nand2  g055(.a(x24), .b(x08), .O(new_n139_));
  aoi21  g056(.a(new_n139_), .b(new_n138_), .c(x10), .O(z12));
  nand2  g057(.a(x24), .b(new_n117_), .O(new_n141_));
  ...
  oai21  g062(.a(new_n144_), .b(new_n117_), .c(new_n145_), .O(new_n146_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n90_), .O(z26));
  ...
  nand2  g119(.a(x38), .b(new_n167_), .O(new_n203_));
  ...
  oai21  g150(.a(x14), .b(new_n167_), .c(x44), .O(new_n234_));
  nand3  g151(.a(x45), .b(new_n101_), .c(x09), .O(new_n235_));
