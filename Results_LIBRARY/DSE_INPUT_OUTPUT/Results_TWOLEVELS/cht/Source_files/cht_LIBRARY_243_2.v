...
module FAU ( 
  ...
  nand3  g040(.a(new_n123_), .b(new_n86_), .c(new_n84_), .O(new_n124_));
  ...
  nor2   g109(.a(x17), .b(x09), .O(new_n193_));
  oai21  g110(.a(new_n193_), .b(x36), .c(x35), .O(new_n194_));
  nand2  g111(.a(x36), .b(x09), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z24));
  nand2  g113(.a(x37), .b(x09), .O(new_n197_));
  oai21  g114(.a(new_n85_), .b(x09), .c(new_n197_), .O(new_n198_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n86_), .O(z26));
  nand2  g122(.a(x14), .b(x00), .O(new_n206_));
  nand2  g123(.a(x39), .b(new_n101_), .O(new_n207_));
  ...
  oai21  g152(.a(new_n235_), .b(x10), .c(new_n86_), .O(z32));
