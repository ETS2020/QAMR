...
module FAU ( 
  ...
  nand3  g061(.a(new_n144_), .b(new_n89_), .c(x09), .O(new_n145_));
  ...
  nand2  g131(.a(x44), .b(new_n98_), .O(new_n215_));
  ...
  nand2  g135(.a(x45), .b(new_n98_), .O(new_n219_));
  ...
  nand3  g146(.a(new_n229_), .b(new_n89_), .c(x09), .O(new_n230_));
