...
module FAU ( 
  ...
  aoi21  g104(.a(new_n102_), .b(x09), .c(new_n182_), .O(new_n188_));
  nand3  g105(.a(x40), .b(new_n102_), .c(x09), .O(new_n189_));
  ...
  aoi21  g110(.a(new_n102_), .b(x09), .c(new_n193_), .O(new_n194_));
  nand3  g111(.a(x41), .b(new_n102_), .c(x09), .O(new_n195_));
  ...
  nand2  g115(.a(new_n102_), .b(x09), .O(new_n199_));
  ...
  aoi21  g120(.a(new_n102_), .b(x09), .c(new_n203_), .O(new_n204_));
  nand3  g121(.a(x43), .b(new_n102_), .c(x09), .O(new_n205_));
