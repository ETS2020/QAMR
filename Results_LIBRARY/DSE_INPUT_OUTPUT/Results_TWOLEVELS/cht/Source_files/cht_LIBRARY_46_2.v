...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x41), .O(new_n86_));
  ...
  aoi21  g161(.a(new_n102_), .b(x09), .c(x41), .O(new_n245_));
  oai21  g162(.a(new_n245_), .b(x45), .c(x44), .O(new_n246_));
  nand3  g163(.a(x45), .b(new_n102_), .c(x09), .O(new_n247_));
  aoi21  g164(.a(new_n247_), .b(new_n246_), .c(x10), .O(z33));
  aoi21  g165(.a(new_n102_), .b(x09), .c(new_n85_), .O(new_n249_));
