...
module FAU ( 
  ...
  nand2  g093(.a(new_n176_), .b(new_n94_), .O(z25));
  ...
  nand2  g097(.a(new_n180_), .b(new_n94_), .O(z26));
  ...
  nand2  g105(.a(new_n99_), .b(x09), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(x39), .O(new_n190_));
  nand3  g107(.a(x40), .b(new_n99_), .c(x09), .O(new_n191_));
  ...
  aoi21  g116(.a(new_n99_), .b(x09), .c(new_n199_), .O(new_n200_));
  ...
  aoi21  g122(.a(new_n99_), .b(x09), .c(new_n205_), .O(new_n206_));
  nand3  g123(.a(x43), .b(new_n99_), .c(x09), .O(new_n207_));
  ...
  aoi21  g128(.a(new_n99_), .b(x09), .c(new_n211_), .O(new_n212_));
  ...
  nand2  g147(.a(new_n230_), .b(new_n94_), .O(z35));
endmodule
