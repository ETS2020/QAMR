...
module FAU ( 
  ...
  nand2  g102(.a(x35), .b(new_n170_), .O(new_n186_));
  nand2  g103(.a(x36), .b(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z24));
  nand2  g105(.a(x36), .b(new_n170_), .O(new_n189_));
  ...
  aoi21  g147(.a(new_n101_), .b(x09), .c(new_n89_), .O(new_n231_));
  ...
  nand3  g154(.a(new_n101_), .b(x09), .c(x00), .O(new_n238_));
