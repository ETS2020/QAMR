...
module FAU ( 
  ...
  nand2  g005(.a(x31), .b(x10), .O(new_n89_));
  ...
  oai21  g088(.a(x10), .b(new_n171_), .c(x31), .O(new_n172_));
  nand3  g089(.a(x32), .b(new_n84_), .c(x09), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n172_), .O(z20));
  ...
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(z22));
  ...
  nand2  g108(.a(new_n191_), .b(new_n89_), .O(z24));
  ...
  nand2  g121(.a(x38), .b(new_n171_), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z27));
  aoi21  g123(.a(new_n101_), .b(x09), .c(new_n201_), .O(new_n207_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n89_), .O(z28));
