...
module FAU ( 
  ...
  nand2  g004(.a(x43), .b(new_n87_), .O(new_n88_));
  ...
  nand3  g121(.a(new_n204_), .b(new_n88_), .c(new_n94_), .O(new_n205_));
  ...
  oai21  g128(.a(new_n211_), .b(x10), .c(new_n88_), .O(z27));
  aoi21  g129(.a(new_n100_), .b(x09), .c(new_n207_), .O(new_n213_));
  ...
  oai21  g138(.a(new_n221_), .b(new_n219_), .c(new_n94_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n88_), .O(z29));
  ...
  nand3  g148(.a(new_n231_), .b(x43), .c(x15), .O(new_n232_));
  inv1   g149(.a(x43), .O(new_n233_));
  nand3  g150(.a(new_n230_), .b(new_n233_), .c(x42), .O(new_n234_));
  aoi21  g151(.a(new_n234_), .b(new_n232_), .c(x10), .O(z31));
  nand2  g152(.a(x43), .b(x15), .O(new_n236_));
  nand3  g153(.a(new_n233_), .b(new_n100_), .c(x09), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(x44), .O(new_n239_));
  nand3  g156(.a(new_n230_), .b(x43), .c(x15), .O(new_n240_));
