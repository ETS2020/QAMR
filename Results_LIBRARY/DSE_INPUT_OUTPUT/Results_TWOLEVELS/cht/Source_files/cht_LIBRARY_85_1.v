...
module FAU ( 
  ...
  nand3  g033(.a(new_n116_), .b(new_n88_), .c(new_n90_), .O(new_n117_));
  ...
  oai21  g038(.a(new_n121_), .b(x10), .c(new_n88_), .O(z07));
  ...
  nor2   g047(.a(new_n87_), .b(x08), .O(new_n131_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n90_), .O(new_n201_));
  ...
  nand2  g135(.a(x40), .b(x21), .O(new_n219_));
  ...
  nand2  g140(.a(new_n100_), .b(x09), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(x40), .c(x21), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n223_), .c(x10), .O(z29));
  ...
  oai21  g147(.a(new_n230_), .b(new_n228_), .c(new_n90_), .O(new_n231_));
  ...
  oai21  g159(.a(new_n242_), .b(new_n240_), .c(new_n90_), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(new_n88_), .O(z32));
  inv1   g161(.a(x44), .O(new_n245_));
  aoi21  g162(.a(new_n100_), .b(x09), .c(new_n245_), .O(new_n246_));
  nand3  g163(.a(x45), .b(new_n100_), .c(x09), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(new_n246_), .c(new_n90_), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n88_), .O(z33));
  inv1   g167(.a(x45), .O(new_n251_));
  aoi21  g168(.a(new_n100_), .b(x09), .c(new_n251_), .O(new_n252_));
  nand3  g169(.a(x46), .b(new_n100_), .c(x09), .O(new_n253_));
  inv1   g170(.a(new_n253_), .O(new_n254_));
  oai21  g171(.a(new_n254_), .b(new_n252_), .c(new_n90_), .O(new_n255_));
  nand2  g172(.a(new_n255_), .b(new_n88_), .O(z34));
  oai21  g173(.a(x14), .b(new_n175_), .c(x46), .O(new_n257_));
  nand3  g174(.a(new_n100_), .b(x09), .c(x00), .O(new_n258_));
  nand2  g175(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand3  g176(.a(new_n259_), .b(new_n88_), .c(new_n90_), .O(new_n260_));
