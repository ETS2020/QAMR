...
module FAU ( 
  ...
  nand3  g037(.a(new_n120_), .b(new_n89_), .c(new_n91_), .O(new_n121_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n89_), .c(new_n91_), .O(new_n149_));
  ...
  oai21  g070(.a(new_n153_), .b(x10), .c(new_n89_), .O(z14));
  oai21  g071(.a(new_n88_), .b(x08), .c(new_n87_), .O(new_n155_));
  nand2  g072(.a(new_n155_), .b(x26), .O(new_n156_));
  ...
  nand3  g134(.a(new_n217_), .b(new_n89_), .c(new_n91_), .O(new_n218_));
  ...
  aoi21  g142(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n226_));
  ...
  oai21  g151(.a(x14), .b(new_n176_), .c(x43), .O(new_n235_));
  nand3  g152(.a(x44), .b(new_n101_), .c(x09), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n235_), .O(new_n237_));
  nand3  g154(.a(new_n237_), .b(new_n89_), .c(new_n91_), .O(new_n238_));
  ...
  oai21  g160(.a(new_n243_), .b(new_n241_), .c(new_n91_), .O(new_n244_));
