...
module FAU ( 
  ...
  nand2  g087(.a(x33), .b(new_n93_), .O(new_n171_));
  ...
  oai21  g121(.a(x41), .b(x10), .c(new_n93_), .O(new_n205_));
  ...
  nand2  g125(.a(new_n208_), .b(new_n88_), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n205_), .O(z30));
  oai21  g127(.a(x42), .b(x10), .c(new_n93_), .O(new_n211_));
  ...
  oai21  g133(.a(x43), .b(x10), .c(new_n93_), .O(new_n217_));
  ...
  oai21  g139(.a(x44), .b(x10), .c(new_n93_), .O(new_n223_));
  ...
  nand2  g145(.a(new_n194_), .b(x09), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(x45), .O(new_n230_));
  nand3  g147(.a(x46), .b(new_n194_), .c(x09), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n230_), .c(x10), .O(z34));
  nand2  g149(.a(new_n229_), .b(x46), .O(new_n233_));
  nand3  g150(.a(new_n194_), .b(x09), .c(x00), .O(new_n234_));
