...
module FAU ( 
  ...
  nor3   g053(.a(x10), .b(new_n86_), .c(new_n136_), .O(z19));
  ...
  nand3  g067(.a(new_n150_), .b(new_n98_), .c(x08), .O(new_n151_));
  ...
  and2   g081(.a(new_n164_), .b(new_n98_), .O(z25));
  ...
  nand3  g085(.a(new_n168_), .b(new_n98_), .c(x08), .O(new_n169_));
  ...
  oai21  g092(.a(new_n175_), .b(new_n174_), .c(new_n98_), .O(new_n176_));
  nor2   g093(.a(new_n176_), .b(new_n86_), .O(z27));
  nand2  g094(.a(new_n172_), .b(x09), .O(new_n178_));
  ...
  oai21  g116(.a(new_n189_), .b(new_n195_), .c(new_n199_), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(new_n98_), .c(x08), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z32));
  nand2  g119(.a(new_n178_), .b(x44), .O(new_n203_));
  nand3  g120(.a(x45), .b(new_n172_), .c(x09), .O(new_n204_));
  ...
  nand3  g125(.a(x46), .b(new_n172_), .c(x09), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(new_n208_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n98_), .c(x08), .O(new_n211_));
