...
module FAU ( 
  ...
  nand2  g042(.a(x21), .b(new_n93_), .O(new_n126_));
  ...
  nand2  g083(.a(new_n166_), .b(new_n94_), .O(z22));
  ...
  aoi21  g105(.a(new_n99_), .b(x09), .c(new_n182_), .O(new_n189_));
  ...
  nand3  g112(.a(x41), .b(new_n99_), .c(x09), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z29));
  nand2  g114(.a(new_n194_), .b(x41), .O(new_n198_));
  nand3  g115(.a(x42), .b(new_n99_), .c(x09), .O(new_n199_));
  ...
  nand2  g137(.a(new_n220_), .b(new_n94_), .O(z34));
  ...
  nand2  g143(.a(new_n226_), .b(new_n94_), .O(z35));
endmodule
