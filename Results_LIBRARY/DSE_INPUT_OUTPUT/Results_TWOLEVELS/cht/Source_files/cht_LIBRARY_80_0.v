...
module FAU ( 
  ...
  oai21  g050(.a(new_n88_), .b(x08), .c(new_n87_), .O(new_n134_));
  nand2  g051(.a(new_n134_), .b(x21), .O(new_n135_));
  ...
  nand3  g055(.a(x44), .b(x23), .c(x08), .O(new_n139_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n89_), .O(z19));
  ...
  nand3  g124(.a(new_n207_), .b(new_n89_), .c(new_n91_), .O(new_n208_));
  ...
  oai21  g154(.a(new_n237_), .b(x10), .c(new_n89_), .O(z32));
  nand3  g155(.a(x22), .b(new_n102_), .c(x09), .O(new_n239_));
