...
module FAU ( 
  ...
  nor2   g033(.a(x10), .b(new_n92_), .O(new_n117_));
  ...
  nand2  g046(.a(new_n117_), .b(x26), .O(new_n130_));
  ...
  nand2  g052(.a(new_n117_), .b(x29), .O(new_n136_));
  ...
  oai21  g073(.a(new_n155_), .b(new_n142_), .c(new_n156_), .O(new_n157_));
  ...
  nand2  g121(.a(new_n184_), .b(x44), .O(new_n205_));
