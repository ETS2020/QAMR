...
module FAU ( 
  ...
  nand2  g040(.a(new_n123_), .b(new_n94_), .O(z07));
  ...
  oai21  g124(.a(x41), .b(x10), .c(new_n93_), .O(new_n208_));
  ...
  oai21  g130(.a(x42), .b(x10), .c(new_n93_), .O(new_n214_));
  ...
  nand2  g148(.a(new_n204_), .b(x46), .O(new_n232_));
