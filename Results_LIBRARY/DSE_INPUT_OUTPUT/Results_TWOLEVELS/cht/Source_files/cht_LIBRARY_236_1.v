...
module FAU ( 
  ...
  aoi21  g006(.a(x12), .b(new_n89_), .c(x11), .O(new_n90_));
  aoi21  g007(.a(new_n90_), .b(new_n88_), .c(x10), .O(z01));
  nand2  g008(.a(x07), .b(x06), .O(new_n92_));
  aoi21  g009(.a(x13), .b(new_n89_), .c(x11), .O(new_n93_));
  ...
  aoi21  g022(.a(x16), .b(new_n89_), .c(x11), .O(new_n106_));
  ...
  nand3  g062(.a(new_n145_), .b(new_n144_), .c(new_n85_), .O(new_n146_));
  and2   g063(.a(new_n146_), .b(new_n84_), .O(z14));
  ...
  aoi21  g082(.a(x30), .b(new_n113_), .c(x11), .O(new_n166_));
  ...
  and2   g092(.a(new_n175_), .b(new_n84_), .O(z21));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x11), .O(new_n220_));
