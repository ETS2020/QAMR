...
module FAU ( 
  ...
  nor2   g061(.a(x25), .b(x08), .O(new_n145_));
  inv1   g062(.a(x25), .O(new_n146_));
  nor2   g063(.a(new_n87_), .b(new_n146_), .O(new_n147_));
  oai21  g064(.a(new_n147_), .b(new_n145_), .c(x24), .O(new_n148_));
  nand2  g065(.a(new_n147_), .b(x08), .O(new_n149_));
  aoi21  g066(.a(new_n149_), .b(new_n148_), .c(x10), .O(z13));
  nor2   g067(.a(new_n146_), .b(x08), .O(new_n151_));
  ...
  aoi21  g130(.a(new_n100_), .b(x09), .c(x25), .O(new_n214_));
  oai21  g131(.a(new_n214_), .b(x40), .c(x39), .O(new_n215_));
  nand3  g132(.a(x40), .b(new_n100_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z28));
  aoi21  g134(.a(new_n100_), .b(x09), .c(new_n87_), .O(new_n218_));
  ...
  oai21  g139(.a(x14), .b(new_n175_), .c(x41), .O(new_n223_));
  ...
  oai21  g144(.a(x14), .b(new_n175_), .c(x42), .O(new_n228_));
  ...
  oai21  g149(.a(x14), .b(new_n175_), .c(x43), .O(new_n233_));
  ...
  oai21  g154(.a(x14), .b(new_n175_), .c(x44), .O(new_n238_));
