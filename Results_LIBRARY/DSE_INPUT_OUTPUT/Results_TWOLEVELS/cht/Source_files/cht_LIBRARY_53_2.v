...
module FAU ( 
  ...
  nand3  g032(.a(new_n115_), .b(new_n90_), .c(new_n84_), .O(new_n116_));
  ...
  nand3  g072(.a(new_n155_), .b(new_n90_), .c(new_n84_), .O(new_n156_));
  ...
  nor2   g101(.a(x13), .b(x09), .O(new_n185_));
  oai21  g102(.a(new_n185_), .b(x33), .c(x32), .O(new_n186_));
  nand2  g103(.a(x33), .b(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n186_), .c(x10), .O(z21));
  nand2  g105(.a(x34), .b(x09), .O(new_n189_));
  oai21  g106(.a(new_n89_), .b(x09), .c(new_n189_), .O(new_n190_));
