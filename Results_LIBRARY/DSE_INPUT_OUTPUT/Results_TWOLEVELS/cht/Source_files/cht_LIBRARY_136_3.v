...
module FAU ( 
  ...
  nand2  g005(.a(x29), .b(x10), .O(new_n89_));
  ...
  oai21  g080(.a(x10), .b(new_n115_), .c(x29), .O(new_n164_));
  nand3  g081(.a(x30), .b(new_n84_), .c(x08), .O(new_n165_));
  nand2  g082(.a(new_n165_), .b(new_n164_), .O(z18));
  nand2  g083(.a(x08), .b(x00), .O(new_n167_));
  nand2  g084(.a(x30), .b(new_n115_), .O(new_n168_));
  ...
  nand2  g154(.a(new_n237_), .b(new_n89_), .O(z34));
