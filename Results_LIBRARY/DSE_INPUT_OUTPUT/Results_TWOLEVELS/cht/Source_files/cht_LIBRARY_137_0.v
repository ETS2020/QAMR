...
module FAU ( 
  ...
  oai21  g032(.a(new_n85_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand2  g033(.a(new_n116_), .b(new_n84_), .O(new_n117_));
  nand2  g034(.a(new_n117_), .b(new_n87_), .O(z06));
  oai21  g035(.a(x19), .b(new_n114_), .c(x18), .O(new_n119_));
  nand3  g036(.a(x26), .b(x19), .c(x08), .O(new_n120_));
  aoi21  g037(.a(new_n120_), .b(new_n119_), .c(x10), .O(z07));
  inv1   g038(.a(x20), .O(new_n122_));
  nand2  g039(.a(x19), .b(new_n114_), .O(new_n123_));
  oai21  g040(.a(new_n122_), .b(new_n114_), .c(new_n123_), .O(new_n124_));
  nand3  g041(.a(new_n124_), .b(new_n87_), .c(new_n84_), .O(new_n125_));
  ...
  nand2  g055(.a(new_n138_), .b(new_n87_), .O(z11));
  ...
  nand2  g077(.a(new_n160_), .b(new_n87_), .O(z16));
  ...
  nand2  g086(.a(new_n169_), .b(new_n87_), .O(z18));
  ...
  nand3  g171(.a(new_n254_), .b(new_n87_), .c(new_n84_), .O(new_n255_));
