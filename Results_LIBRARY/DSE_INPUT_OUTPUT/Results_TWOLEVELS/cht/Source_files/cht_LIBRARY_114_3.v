...
module FAU ( 
  ...
  nand2  g003(.a(x43), .b(x15), .O(new_n87_));
  ...
  nand3  g031(.a(new_n114_), .b(new_n87_), .c(new_n93_), .O(new_n115_));
  ...
  nand3  g066(.a(new_n149_), .b(new_n87_), .c(new_n93_), .O(new_n150_));
  ...
  aoi21  g129(.a(new_n99_), .b(x09), .c(new_n207_), .O(new_n213_));
  nand3  g130(.a(x40), .b(new_n99_), .c(x09), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(new_n93_), .O(new_n216_));
  ...
  nand2  g146(.a(new_n99_), .b(x09), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(x43), .c(new_n104_), .O(new_n232_));
  ...
  nand2  g152(.a(x43), .b(new_n104_), .O(new_n236_));
  nand3  g153(.a(new_n233_), .b(new_n99_), .c(x09), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(x44), .O(new_n239_));
  nand3  g156(.a(new_n230_), .b(x43), .c(new_n104_), .O(new_n240_));
  ...
  nand3  g161(.a(new_n244_), .b(new_n87_), .c(new_n93_), .O(new_n245_));
  ...
  oai21  g167(.a(new_n250_), .b(new_n248_), .c(new_n93_), .O(new_n251_));
  ...
  oai21  g173(.a(new_n256_), .b(new_n254_), .c(new_n93_), .O(new_n257_));
