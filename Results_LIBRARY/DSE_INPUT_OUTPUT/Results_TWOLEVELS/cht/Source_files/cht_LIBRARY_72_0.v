...
module FAU ( 
  ...
  nand3  g022(.a(new_n105_), .b(x42), .c(new_n89_), .O(new_n106_));
  inv1   g023(.a(new_n106_), .O(z04));
  inv1   g024(.a(x16), .O(new_n108_));
  nand2  g025(.a(x07), .b(x03), .O(new_n109_));
  oai21  g026(.a(new_n108_), .b(x07), .c(new_n109_), .O(new_n110_));
  nand3  g027(.a(new_n110_), .b(x42), .c(new_n89_), .O(new_n111_));
  ...
  nand3  g039(.a(new_n122_), .b(x42), .c(new_n89_), .O(new_n123_));
  ...
  aoi21  g048(.a(x23), .b(x08), .c(new_n86_), .O(new_n132_));
  ...
  nand3  g074(.a(new_n157_), .b(x42), .c(new_n89_), .O(new_n158_));
  ...
  nand3  g095(.a(new_n178_), .b(x42), .c(new_n89_), .O(new_n179_));
  ...
  nand3  g103(.a(new_n186_), .b(x42), .c(new_n89_), .O(new_n187_));
  ...
  nand3  g111(.a(new_n194_), .b(x42), .c(new_n89_), .O(new_n195_));
  ...
  oai21  g118(.a(new_n201_), .b(new_n200_), .c(x42), .O(new_n202_));
  ...
  nand3  g124(.a(new_n207_), .b(x42), .c(new_n89_), .O(new_n208_));
  ...
  nor2   g131(.a(new_n86_), .b(x41), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n204_), .c(x10), .O(z30));
  inv1   g133(.a(new_n204_), .O(new_n217_));
  nor2   g134(.a(x43), .b(new_n86_), .O(new_n218_));
  ...
  oai21  g142(.a(new_n217_), .b(new_n221_), .c(new_n225_), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(x42), .c(new_n89_), .O(new_n227_));
  ...
  aoi21  g151(.a(new_n217_), .b(x00), .c(new_n86_), .O(new_n235_));
