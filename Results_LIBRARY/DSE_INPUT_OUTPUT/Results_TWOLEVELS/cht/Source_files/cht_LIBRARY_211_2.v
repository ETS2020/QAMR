...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n97_), .O(z11));
  ...
  nand2  g060(.a(x25), .b(new_n117_), .O(new_n144_));
  nand2  g061(.a(x26), .b(x08), .O(new_n145_));
  aoi21  g062(.a(new_n145_), .b(new_n144_), .c(x10), .O(z14));
  nand2  g063(.a(x26), .b(new_n117_), .O(new_n147_));
  ...
  nand2  g070(.a(new_n153_), .b(new_n97_), .O(z16));
  ...
  nand2  g078(.a(new_n161_), .b(new_n97_), .O(z18));
  ...
  nand2  g087(.a(new_n170_), .b(new_n97_), .O(z20));
  ...
  nand2  g091(.a(new_n174_), .b(new_n97_), .O(z21));
  ...
  nand2  g106(.a(new_n189_), .b(new_n97_), .O(z25));
  ...
  nand2  g111(.a(new_n194_), .b(new_n97_), .O(z26));
  ...
  oai21  g117(.a(new_n200_), .b(x10), .c(new_n97_), .O(z27));
  ...
  nand2  g128(.a(new_n211_), .b(new_n97_), .O(z29));
  ...
  nand2  g137(.a(new_n220_), .b(new_n97_), .O(z31));
  ...
  nand2  g152(.a(new_n235_), .b(new_n97_), .O(z35));
endmodule
