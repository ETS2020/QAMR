...
module FAU ( 
  ...
  nand3  g038(.a(new_n121_), .b(new_n92_), .c(x09), .O(new_n122_));
  ...
  and2   g074(.a(new_n157_), .b(new_n92_), .O(z16));
  ...
  and2   g078(.a(new_n161_), .b(new_n92_), .O(z17));
  ...
  nand2  g095(.a(new_n172_), .b(x35), .O(new_n179_));
  ...
  and2   g107(.a(new_n190_), .b(new_n92_), .O(z27));
  nand2  g108(.a(x39), .b(x14), .O(new_n192_));
  nand2  g109(.a(x40), .b(new_n188_), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(new_n192_), .c(x09), .O(new_n194_));
  and2   g111(.a(new_n194_), .b(new_n92_), .O(z28));
  inv1   g112(.a(x41), .O(new_n196_));
  nand2  g113(.a(x40), .b(x14), .O(new_n197_));
  oai21  g114(.a(new_n196_), .b(x14), .c(new_n197_), .O(new_n198_));
  nand3  g115(.a(new_n198_), .b(new_n92_), .c(x09), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z29));
  nand2  g117(.a(x41), .b(x14), .O(new_n201_));
  nand2  g118(.a(x42), .b(new_n188_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n201_), .c(x09), .O(new_n203_));
  and2   g120(.a(new_n203_), .b(new_n92_), .O(z30));
