...
module FAU ( 
  ...
  nand2  g001(.a(x13), .b(x09), .O(new_n85_));
  ...
  nand3  g093(.a(x32), .b(new_n95_), .c(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z20));
  nand2  g095(.a(x32), .b(new_n175_), .O(new_n179_));
  nand3  g096(.a(x33), .b(new_n95_), .c(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z21));
  aoi21  g098(.a(x34), .b(new_n84_), .c(x13), .O(new_n182_));
  ...
  nand3  g111(.a(x38), .b(new_n95_), .c(x09), .O(new_n195_));
  ...
  nand3  g116(.a(new_n199_), .b(new_n95_), .c(x09), .O(new_n200_));
  ...
  nand2  g128(.a(new_n211_), .b(new_n95_), .O(new_n212_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n95_), .O(new_n216_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n95_), .O(new_n223_));
  ...
  nand2  g143(.a(new_n226_), .b(new_n95_), .O(new_n227_));
  ...
  nand2  g150(.a(new_n233_), .b(new_n95_), .O(new_n234_));
  ...
  nand2  g161(.a(new_n244_), .b(new_n95_), .O(new_n245_));
