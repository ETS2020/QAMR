...
module FAU ( 
  ...
  nand3  g055(.a(new_n138_), .b(new_n89_), .c(x09), .O(new_n139_));
  ...
  nand3  g077(.a(new_n160_), .b(new_n89_), .c(x09), .O(new_n161_));
  ...
  aoi21  g084(.a(x30), .b(new_n109_), .c(new_n86_), .O(new_n168_));
  ...
  nand2  g102(.a(x39), .b(new_n98_), .O(new_n186_));
  nand3  g103(.a(new_n186_), .b(new_n185_), .c(x09), .O(new_n187_));
  and2   g104(.a(new_n187_), .b(new_n89_), .O(z27));
