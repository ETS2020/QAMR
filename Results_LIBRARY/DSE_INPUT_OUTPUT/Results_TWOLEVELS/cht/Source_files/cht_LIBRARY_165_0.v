...
module FAU ( 
  ...
  oai21  g020(.a(new_n103_), .b(x10), .c(new_n87_), .O(z03));
  inv1   g021(.a(x15), .O(new_n105_));
  nand2  g022(.a(x07), .b(x02), .O(new_n106_));
  oai21  g023(.a(new_n105_), .b(x07), .c(new_n106_), .O(new_n107_));
  nand3  g024(.a(new_n107_), .b(new_n87_), .c(new_n84_), .O(new_n108_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n87_), .c(new_n84_), .O(new_n169_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n87_), .c(new_n84_), .O(new_n193_));
  ...
  oai21  g116(.a(new_n86_), .b(x09), .c(new_n85_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(x36), .O(new_n201_));
  nand2  g118(.a(x37), .b(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z25));
  oai21  g120(.a(x38), .b(new_n176_), .c(x37), .O(new_n204_));
  nand3  g121(.a(x43), .b(x38), .c(x09), .O(new_n205_));
  ...
  oai21  g129(.a(new_n212_), .b(x10), .c(new_n87_), .O(z27));
  aoi21  g130(.a(new_n101_), .b(x09), .c(new_n207_), .O(new_n214_));
  ...
  nand2  g134(.a(new_n217_), .b(new_n87_), .O(z28));
  ...
  nand2  g140(.a(new_n223_), .b(new_n87_), .O(z29));
  ...
  aoi21  g153(.a(new_n101_), .b(x09), .c(new_n86_), .O(new_n237_));
  ...
  nand2  g157(.a(new_n240_), .b(new_n87_), .O(z32));
  oai21  g158(.a(x14), .b(new_n176_), .c(x44), .O(new_n242_));
  nand3  g159(.a(x45), .b(new_n101_), .c(x09), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n87_), .c(new_n84_), .O(new_n245_));
  inv1   g162(.a(new_n245_), .O(z33));
  oai21  g163(.a(x14), .b(new_n176_), .c(x45), .O(new_n247_));
  nand3  g164(.a(x46), .b(new_n101_), .c(x09), .O(new_n248_));
  nand2  g165(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand3  g166(.a(new_n249_), .b(new_n87_), .c(new_n84_), .O(new_n250_));
