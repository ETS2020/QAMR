...
module FAU ( 
  ...
  nand2  g068(.a(x27), .b(new_n117_), .O(new_n152_));
  oai21  g069(.a(new_n151_), .b(new_n117_), .c(new_n152_), .O(new_n153_));
  ...
  nand2  g113(.a(x38), .b(new_n166_), .O(new_n197_));
  ...
  nand2  g120(.a(new_n203_), .b(new_n90_), .O(z28));
  ...
  nand2  g127(.a(new_n199_), .b(x09), .O(new_n211_));
  ...
  aoi21  g147(.a(new_n199_), .b(x09), .c(new_n230_), .O(new_n231_));
  ...
  nand2  g151(.a(new_n234_), .b(new_n90_), .O(z34));
  ...
  nand2  g157(.a(new_n240_), .b(new_n90_), .O(z35));
endmodule
