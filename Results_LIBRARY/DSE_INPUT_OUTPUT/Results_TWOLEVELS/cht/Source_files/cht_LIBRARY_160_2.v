...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n97_), .c(x09), .O(new_n104_));
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  aoi21  g023(.a(x16), .b(new_n97_), .c(x09), .O(new_n107_));
  ...
  aoi21  g088(.a(x30), .b(new_n109_), .c(x09), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n171_), .c(x10), .O(z19));
  inv1   g090(.a(x31), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n84_), .c(x10), .O(z20));
  ...
  nand2  g099(.a(new_n176_), .b(x35), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z24));
  nand2  g101(.a(new_n176_), .b(x36), .O(new_n185_));
  ...
  nand2  g119(.a(new_n176_), .b(x45), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand2  g121(.a(new_n176_), .b(x46), .O(new_n205_));
