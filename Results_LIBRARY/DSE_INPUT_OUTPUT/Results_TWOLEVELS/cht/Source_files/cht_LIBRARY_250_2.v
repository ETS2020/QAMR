...
module FAU ( 
  ...
  oai21  g082(.a(new_n89_), .b(x09), .c(new_n165_), .O(new_n166_));
  ...
  nand2  g087(.a(x32), .b(new_n169_), .O(new_n171_));
  ...
  nand2  g115(.a(x38), .b(new_n169_), .O(new_n199_));
  ...
  aoi21  g128(.a(new_n201_), .b(x09), .c(new_n211_), .O(new_n212_));
  ...
  nand3  g135(.a(x43), .b(new_n201_), .c(x09), .O(new_n219_));
  ...
  nand3  g140(.a(x44), .b(new_n201_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z32));
  nand2  g142(.a(new_n207_), .b(x44), .O(new_n226_));
  nand3  g143(.a(x45), .b(new_n201_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z33));
  nand2  g145(.a(new_n207_), .b(x45), .O(new_n229_));
  nand3  g146(.a(x46), .b(new_n201_), .c(x09), .O(new_n230_));
  ...
  nand3  g150(.a(new_n201_), .b(x09), .c(x00), .O(new_n234_));
