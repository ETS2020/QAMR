...
module FAU ( 
  ...
  nand2  g034(.a(new_n115_), .b(x20), .O(new_n118_));
  inv1   g035(.a(new_n118_), .O(z08));
  nand2  g036(.a(new_n115_), .b(x21), .O(new_n120_));
  ...
  nand2  g050(.a(new_n115_), .b(x28), .O(new_n134_));
  ...
  nand3  g070(.a(new_n153_), .b(new_n89_), .c(x08), .O(new_n154_));
  ...
  oai21  g078(.a(new_n160_), .b(new_n142_), .c(new_n161_), .O(new_n162_));
  nand3  g079(.a(new_n162_), .b(new_n89_), .c(x08), .O(new_n163_));
  ...
  and2   g088(.a(new_n171_), .b(new_n89_), .O(z26));
  ...
  oai21  g095(.a(new_n178_), .b(new_n176_), .c(new_n89_), .O(new_n179_));
  nor2   g096(.a(new_n179_), .b(new_n86_), .O(z27));
  nand2  g097(.a(new_n174_), .b(x09), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(x39), .O(new_n182_));
  nand3  g099(.a(x40), .b(new_n174_), .c(x09), .O(new_n183_));
  ...
  nand3  g104(.a(x41), .b(new_n174_), .c(x09), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand3  g106(.a(new_n189_), .b(new_n89_), .c(x08), .O(new_n190_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n89_), .c(x08), .O(new_n195_));
  ...
  aoi21  g127(.a(new_n210_), .b(new_n207_), .c(x10), .O(z33));
  nand2  g128(.a(new_n181_), .b(x45), .O(new_n212_));
  nand3  g129(.a(x46), .b(new_n174_), .c(x09), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(new_n212_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n89_), .c(x08), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z34));
  nand2  g133(.a(new_n181_), .b(x46), .O(new_n217_));
  oai21  g134(.a(new_n181_), .b(new_n140_), .c(new_n217_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n89_), .c(x08), .O(new_n219_));
