...
module FAU ( 
  ...
  nand2  g073(.a(x27), .b(new_n116_), .O(new_n157_));
  ...
  oai21  g081(.a(new_n163_), .b(new_n116_), .c(new_n164_), .O(new_n165_));
  ...
  nand2  g094(.a(x32), .b(new_n176_), .O(new_n178_));
  ...
  nand2  g103(.a(x34), .b(new_n176_), .O(new_n187_));
  ...
  aoi21  g125(.a(new_n102_), .b(x09), .c(new_n203_), .O(new_n209_));
  nand3  g126(.a(x40), .b(new_n102_), .c(x09), .O(new_n210_));
  ...
  nand2  g130(.a(new_n102_), .b(x09), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(x40), .O(new_n215_));
  nand3  g132(.a(x41), .b(new_n102_), .c(x09), .O(new_n216_));
  ...
  nand2  g140(.a(new_n214_), .b(x43), .O(new_n224_));
  ...
  nand2  g149(.a(new_n214_), .b(x45), .O(new_n233_));
