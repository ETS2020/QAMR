...
module FAU ( 
  ...
  nand2  g059(.a(new_n142_), .b(new_n94_), .O(z13));
  ...
  oai21  g074(.a(new_n156_), .b(new_n114_), .c(new_n157_), .O(new_n158_));
  ...
  nand2  g101(.a(x35), .b(new_n168_), .O(new_n185_));
  oai21  g102(.a(new_n184_), .b(new_n168_), .c(new_n185_), .O(new_n186_));
  ...
  nand2  g137(.a(new_n220_), .b(new_n94_), .O(z32));
