...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n85_), .c(x34), .O(new_n106_));
  ...
  aoi21  g083(.a(x32), .b(x09), .c(x34), .O(new_n167_));
  ...
  aoi21  g091(.a(new_n174_), .b(new_n89_), .c(x10), .O(z22));
  nand4  g092(.a(x35), .b(new_n89_), .c(new_n88_), .d(x09), .O(new_n176_));
  ...
  and2   g097(.a(new_n180_), .b(new_n88_), .O(z24));
  ...
  and2   g101(.a(new_n184_), .b(new_n88_), .O(z25));
  ...
  and2   g105(.a(new_n188_), .b(new_n88_), .O(z26));
  ...
  aoi21  g110(.a(x38), .b(new_n165_), .c(x34), .O(new_n194_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x34), .O(new_n215_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x34), .O(new_n225_));
  ...
  aoi21  g150(.a(new_n233_), .b(x00), .c(x34), .O(new_n234_));
