...
module FAU ( 
  ...
  aoi21  g030(.a(new_n113_), .b(new_n88_), .c(x10), .O(z09));
  inv1   g031(.a(x21), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n88_), .c(x10), .O(z10));
  inv1   g033(.a(x22), .O(new_n117_));
  aoi21  g034(.a(new_n117_), .b(new_n88_), .c(x10), .O(z11));
  nor2   g035(.a(x10), .b(x08), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(x23), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z12));
  nand2  g038(.a(new_n119_), .b(x24), .O(new_n122_));
