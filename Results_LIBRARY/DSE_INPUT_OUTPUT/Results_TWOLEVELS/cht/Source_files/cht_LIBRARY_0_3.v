...
module FAU ( 
  ...
  nand2  g005(.a(x23), .b(x16), .O(new_n89_));
  ...
  nand3  g015(.a(new_n98_), .b(new_n89_), .c(new_n84_), .O(new_n99_));
  ...
  nand3  g042(.a(new_n125_), .b(new_n89_), .c(new_n84_), .O(new_n126_));
  ...
  nand2  g057(.a(new_n140_), .b(new_n89_), .O(z10));
  nand3  g058(.a(new_n89_), .b(x22), .c(new_n118_), .O(new_n142_));
  nand3  g059(.a(x23), .b(new_n113_), .c(x08), .O(new_n143_));
  aoi21  g060(.a(new_n143_), .b(new_n142_), .c(x10), .O(z11));
  inv1   g061(.a(x24), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(x08), .O(new_n146_));
  nand3  g063(.a(new_n146_), .b(x23), .c(new_n113_), .O(new_n147_));
  inv1   g064(.a(x23), .O(new_n148_));
  nand3  g065(.a(x24), .b(new_n148_), .c(x08), .O(new_n149_));
  aoi21  g066(.a(new_n149_), .b(new_n147_), .c(x10), .O(z12));
  nand2  g067(.a(x25), .b(x08), .O(new_n151_));
  oai21  g068(.a(new_n145_), .b(x08), .c(new_n151_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n84_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n89_), .O(z13));
  ...
  nand3  g078(.a(new_n161_), .b(new_n89_), .c(new_n84_), .O(new_n162_));
  ...
  nand2  g088(.a(new_n171_), .b(new_n89_), .O(z17));
  ...
  nand2  g103(.a(new_n186_), .b(new_n89_), .O(z20));
  ...
  nand2  g116(.a(new_n199_), .b(new_n89_), .O(z23));
  ...
  nand2  g121(.a(new_n204_), .b(new_n89_), .O(z24));
  ...
  aoi21  g137(.a(new_n101_), .b(x09), .c(new_n215_), .O(new_n221_));
