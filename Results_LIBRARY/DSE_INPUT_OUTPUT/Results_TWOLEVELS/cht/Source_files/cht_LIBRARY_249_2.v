...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n94_), .O(z10));
  nand2  g052(.a(x22), .b(new_n117_), .O(new_n136_));
  ...
  nand2  g067(.a(new_n150_), .b(new_n94_), .O(z14));
  ...
  nand2  g097(.a(new_n180_), .b(new_n94_), .O(z20));
  ...
  nand2  g102(.a(new_n185_), .b(new_n94_), .O(z21));
  ...
  nand2  g107(.a(new_n190_), .b(new_n94_), .O(z22));
  inv1   g108(.a(x09), .O(new_n192_));
  nand2  g109(.a(x34), .b(new_n192_), .O(new_n193_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n94_), .O(z24));
  ...
  nand2  g121(.a(new_n204_), .b(new_n94_), .O(z25));
  nand2  g122(.a(x37), .b(new_n192_), .O(new_n206_));
  nand2  g123(.a(x38), .b(x09), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z26));
  nand3  g125(.a(x14), .b(new_n88_), .c(x00), .O(new_n209_));
  ...
  nor2   g130(.a(new_n213_), .b(x10), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n192_), .c(new_n93_), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n212_), .O(z27));
  inv1   g133(.a(x39), .O(new_n217_));
  nor2   g134(.a(x14), .b(x09), .O(new_n218_));
  aoi21  g135(.a(x14), .b(new_n88_), .c(new_n218_), .O(new_n219_));
  aoi21  g136(.a(x40), .b(x09), .c(x10), .O(new_n220_));
  oai22  g137(.a(new_n220_), .b(x14), .c(new_n219_), .d(new_n217_), .O(z28));
  ...
  aoi21  g152(.a(x45), .b(x09), .c(x10), .O(new_n236_));
  oai22  g153(.a(new_n236_), .b(x14), .c(new_n219_), .d(new_n235_), .O(z33));
  inv1   g154(.a(x45), .O(new_n238_));
  aoi21  g155(.a(x46), .b(x09), .c(x10), .O(new_n239_));
  oai22  g156(.a(new_n239_), .b(x14), .c(new_n219_), .d(new_n238_), .O(z34));
