...
module FAU ( 
  ...
  aoi21  g055(.a(x24), .b(x08), .c(x28), .O(new_n139_));
  ...
  oai21  g116(.a(new_n199_), .b(new_n198_), .c(new_n85_), .O(new_n200_));
  ...
  aoi21  g123(.a(new_n206_), .b(x09), .c(x28), .O(new_n207_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x28), .O(new_n212_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x28), .O(new_n217_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x28), .O(new_n222_));
  ...
  aoi21  g154(.a(new_n202_), .b(x00), .c(x28), .O(new_n238_));
