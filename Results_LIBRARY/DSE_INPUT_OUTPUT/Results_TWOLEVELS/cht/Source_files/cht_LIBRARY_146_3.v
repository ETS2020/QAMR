...
module FAU ( 
  ...
  nand3  g094(.a(x33), .b(new_n84_), .c(new_n170_), .O(new_n178_));
  ...
  nand3  g100(.a(x35), .b(new_n84_), .c(new_n170_), .O(new_n184_));
  ...
  nand3  g119(.a(new_n199_), .b(x40), .c(new_n84_), .O(new_n203_));
  oai21  g120(.a(new_n202_), .b(new_n170_), .c(new_n203_), .O(z29));
  nand2  g121(.a(new_n199_), .b(x41), .O(new_n205_));
  nand3  g122(.a(x42), .b(new_n101_), .c(x09), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z30));
  nand2  g124(.a(new_n199_), .b(x42), .O(new_n208_));
  ...
  nand3  g128(.a(new_n199_), .b(x43), .c(new_n84_), .O(new_n212_));
  oai21  g129(.a(new_n211_), .b(new_n170_), .c(new_n212_), .O(z32));
  aoi21  g130(.a(x45), .b(new_n101_), .c(x10), .O(new_n214_));
  nand3  g131(.a(new_n199_), .b(x44), .c(new_n84_), .O(new_n215_));
  ...
  nand3  g137(.a(new_n199_), .b(x46), .c(new_n84_), .O(new_n221_));
  oai21  g138(.a(new_n220_), .b(new_n170_), .c(new_n221_), .O(z35));
endmodule
