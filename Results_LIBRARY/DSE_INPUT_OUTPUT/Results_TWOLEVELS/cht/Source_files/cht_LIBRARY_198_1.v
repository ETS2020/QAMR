...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x16), .O(new_n98_));
  ...
  aoi21  g022(.a(x15), .b(new_n97_), .c(x16), .O(new_n106_));
  ...
  oai21  g124(.a(new_n207_), .b(new_n205_), .c(new_n85_), .O(new_n208_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x16), .O(new_n220_));
  ...
  aoi21  g162(.a(new_n210_), .b(x00), .c(x16), .O(new_n246_));
