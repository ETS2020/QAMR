...
module FAU ( 
  ...
  nor2   g106(.a(x37), .b(x09), .O(new_n190_));
  ...
  nand3  g114(.a(new_n88_), .b(x36), .c(new_n175_), .O(new_n198_));
  nand3  g115(.a(x37), .b(x35), .c(x09), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z25));
  nand3  g117(.a(new_n88_), .b(x38), .c(x09), .O(new_n201_));
  nand3  g118(.a(x37), .b(x35), .c(new_n175_), .O(new_n202_));
  ...
  aoi21  g125(.a(new_n206_), .b(x09), .c(new_n208_), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(x10), .c(new_n88_), .O(z27));
  aoi21  g127(.a(new_n101_), .b(x09), .c(new_n204_), .O(new_n211_));
  nand3  g128(.a(x40), .b(new_n101_), .c(x09), .O(new_n212_));
  inv1   g129(.a(new_n212_), .O(new_n213_));
  oai21  g130(.a(new_n213_), .b(new_n211_), .c(new_n90_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n88_), .O(z28));
  ...
  oai21  g142(.a(new_n225_), .b(new_n223_), .c(new_n90_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n88_), .O(z30));
  inv1   g144(.a(x42), .O(new_n228_));
  aoi21  g145(.a(new_n101_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(x43), .b(new_n101_), .c(x09), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(new_n229_), .c(new_n90_), .O(new_n232_));
  ...
  oai21  g165(.a(x14), .b(new_n175_), .c(x46), .O(new_n249_));
