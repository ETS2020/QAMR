...
module FAU ( 
  ...
  aoi21  g120(.a(new_n203_), .b(x09), .c(new_n197_), .O(new_n204_));
  ...
  aoi21  g132(.a(new_n203_), .b(x09), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(x42), .b(new_n203_), .c(x09), .O(new_n217_));
  ...
  aoi21  g138(.a(new_n203_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(x43), .b(new_n203_), .c(x09), .O(new_n223_));
  ...
  aoi21  g144(.a(new_n203_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(x44), .b(new_n203_), .c(x09), .O(new_n229_));
  ...
  aoi21  g150(.a(new_n203_), .b(x09), .c(new_n233_), .O(new_n234_));
  nand3  g151(.a(x45), .b(new_n203_), .c(x09), .O(new_n235_));
  inv1   g152(.a(new_n235_), .O(new_n236_));
  oai21  g153(.a(new_n236_), .b(new_n234_), .c(new_n84_), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n89_), .O(z33));
  nand2  g155(.a(new_n203_), .b(x09), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(x45), .O(new_n240_));
  nand3  g157(.a(x46), .b(new_n203_), .c(x09), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n240_), .c(x10), .O(z34));
  nand2  g159(.a(new_n239_), .b(x46), .O(new_n243_));
