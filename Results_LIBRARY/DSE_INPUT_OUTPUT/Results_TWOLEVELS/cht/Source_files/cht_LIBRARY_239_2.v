...
module FAU ( 
  ...
  aoi21  g031(.a(new_n114_), .b(new_n97_), .c(x10), .O(z08));
  ...
  aoi21  g045(.a(new_n128_), .b(new_n97_), .c(x10), .O(z15));
  ...
  nand3  g058(.a(new_n141_), .b(new_n98_), .c(new_n97_), .O(new_n142_));
  ...
  nand3  g080(.a(new_n163_), .b(new_n162_), .c(new_n97_), .O(new_n164_));
  ...
  nor2   g105(.a(x14), .b(new_n138_), .O(new_n189_));
