...
module FAU ( 
  ...
  nand2  g003(.a(x37), .b(x35), .O(new_n87_));
  ...
  oai21  g055(.a(new_n138_), .b(x10), .c(new_n87_), .O(z11));
  ...
  nand3  g088(.a(new_n171_), .b(new_n87_), .c(new_n89_), .O(new_n172_));
  ...
  nand2  g103(.a(new_n186_), .b(new_n89_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n87_), .O(z22));
  nor2   g105(.a(x35), .b(x09), .O(new_n189_));
  inv1   g106(.a(x35), .O(new_n190_));
  nor2   g107(.a(x37), .b(new_n190_), .O(new_n191_));
  oai21  g108(.a(new_n191_), .b(new_n189_), .c(x34), .O(new_n192_));
  nand2  g109(.a(new_n191_), .b(x09), .O(new_n193_));
  ...
  nand2  g113(.a(new_n196_), .b(new_n89_), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n87_), .O(z24));
  nand3  g115(.a(new_n87_), .b(x36), .c(new_n174_), .O(new_n199_));
  nand3  g116(.a(x37), .b(new_n190_), .c(x09), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z25));
  inv1   g118(.a(x38), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(x09), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(x37), .c(new_n190_), .O(new_n204_));
  ...
  oai21  g139(.a(new_n222_), .b(new_n220_), .c(new_n89_), .O(new_n223_));
  ...
  oai21  g145(.a(new_n228_), .b(new_n226_), .c(new_n89_), .O(new_n229_));
