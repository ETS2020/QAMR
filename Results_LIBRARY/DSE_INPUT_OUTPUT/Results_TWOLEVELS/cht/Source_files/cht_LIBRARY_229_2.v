...
module FAU ( 
  ...
  oai21  g098(.a(new_n89_), .b(x09), .c(new_n181_), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n84_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n90_), .O(z23));
  nand2  g101(.a(x35), .b(new_n174_), .O(new_n185_));
  ...
  aoi21  g119(.a(new_n99_), .b(x09), .c(new_n196_), .O(new_n203_));
  ...
  nand3  g142(.a(x44), .b(new_n99_), .c(x09), .O(new_n226_));
  ...
  nand2  g152(.a(new_n214_), .b(x46), .O(new_n236_));
