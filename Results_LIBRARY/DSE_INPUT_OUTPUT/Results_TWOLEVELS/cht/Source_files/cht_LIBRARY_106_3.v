...
module FAU ( 
  ...
  nand3  g041(.a(x21), .b(new_n88_), .c(new_n112_), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(new_n124_), .O(z10));
  oai21  g043(.a(x23), .b(x10), .c(x08), .O(new_n127_));
  nand3  g044(.a(x22), .b(new_n88_), .c(new_n112_), .O(new_n128_));
  ...
  nand3  g050(.a(x24), .b(new_n88_), .c(new_n112_), .O(new_n134_));
  ...
  nand2  g068(.a(x30), .b(new_n112_), .O(new_n152_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n93_), .O(z23));
  ...
  nand2  g092(.a(new_n175_), .b(new_n93_), .O(z25));
  ...
  nand2  g096(.a(new_n179_), .b(new_n93_), .O(z26));
  ...
  nand2  g139(.a(new_n222_), .b(new_n93_), .O(z35));
endmodule
