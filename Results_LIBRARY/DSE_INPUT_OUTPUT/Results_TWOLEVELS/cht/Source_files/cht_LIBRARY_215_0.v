...
module FAU ( 
  ...
  nand3  g073(.a(new_n156_), .b(new_n89_), .c(x09), .O(new_n157_));
  ...
  nand3  g078(.a(new_n161_), .b(new_n89_), .c(x09), .O(new_n162_));
  ...
  nand2  g119(.a(x41), .b(new_n193_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n202_), .c(x09), .O(new_n204_));
  and2   g121(.a(new_n204_), .b(new_n89_), .O(z29));
  nand2  g122(.a(x41), .b(x14), .O(new_n206_));
  nand2  g123(.a(x42), .b(new_n193_), .O(new_n207_));
  ...
  nand3  g148(.a(new_n231_), .b(new_n89_), .c(x09), .O(new_n232_));
