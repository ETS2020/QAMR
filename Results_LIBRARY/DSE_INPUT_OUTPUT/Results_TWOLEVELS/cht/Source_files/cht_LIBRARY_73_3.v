...
module FAU ( 
  ...
  nand2  g003(.a(x43), .b(x11), .O(new_n87_));
  ...
  oai21  g087(.a(new_n170_), .b(x10), .c(new_n87_), .O(z19));
  ...
  nand2  g092(.a(new_n175_), .b(new_n89_), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n87_), .O(z20));
  ...
  nand2  g097(.a(new_n180_), .b(new_n87_), .O(z21));
  ...
  nand2  g101(.a(new_n184_), .b(new_n89_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n87_), .O(z22));
  ...
  nand2  g106(.a(new_n189_), .b(new_n87_), .O(z23));
  ...
  nand2  g111(.a(new_n194_), .b(new_n87_), .O(z24));
  nand2  g112(.a(x37), .b(x09), .O(new_n196_));
  oai21  g113(.a(new_n191_), .b(x09), .c(new_n196_), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(new_n89_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(new_n87_), .O(z25));
  ...
  oai21  g126(.a(new_n209_), .b(x10), .c(new_n87_), .O(z27));
  ...
  nand2  g131(.a(new_n214_), .b(new_n87_), .O(z28));
  ...
  nand3  g146(.a(new_n229_), .b(x43), .c(new_n84_), .O(new_n230_));
  inv1   g147(.a(x43), .O(new_n231_));
  nand3  g148(.a(new_n228_), .b(new_n231_), .c(x42), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n230_), .c(x10), .O(z31));
  aoi21  g150(.a(new_n99_), .b(x09), .c(new_n231_), .O(new_n234_));
  ...
  oai21  g161(.a(x14), .b(new_n172_), .c(x45), .O(new_n245_));
  nand3  g162(.a(x46), .b(new_n99_), .c(x09), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(new_n245_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(new_n87_), .c(new_n89_), .O(new_n248_));
