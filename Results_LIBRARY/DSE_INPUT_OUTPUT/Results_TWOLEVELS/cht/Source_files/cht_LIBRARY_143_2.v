...
module FAU ( 
  ...
  nand2  g037(.a(x18), .b(new_n116_), .O(new_n121_));
  ...
  nand2  g053(.a(x22), .b(new_n116_), .O(new_n137_));
  ...
  nand2  g059(.a(x24), .b(new_n116_), .O(new_n143_));
  ...
  nand2  g095(.a(x34), .b(new_n171_), .O(new_n179_));
  ...
  nand2  g104(.a(x36), .b(new_n171_), .O(new_n188_));
  ...
  nand2  g116(.a(x38), .b(new_n171_), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z27));
  aoi21  g118(.a(new_n101_), .b(x09), .c(new_n196_), .O(new_n202_));
  ...
  nand2  g123(.a(new_n101_), .b(x09), .O(new_n207_));
  ...
  nand3  g144(.a(x45), .b(new_n101_), .c(x09), .O(new_n228_));
  ...
  nand3  g155(.a(new_n101_), .b(x09), .c(x00), .O(new_n239_));
