...
module FAU ( 
  ...
  nand2  g072(.a(x30), .b(new_n109_), .O(new_n156_));
  ...
  nand3  g082(.a(x33), .b(new_n88_), .c(new_n158_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n165_), .O(z22));
  nand2  g084(.a(x34), .b(new_n158_), .O(new_n168_));
  nand2  g085(.a(x35), .b(x09), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z23));
  oai21  g087(.a(x36), .b(x10), .c(x09), .O(new_n171_));
  nand3  g088(.a(x35), .b(new_n88_), .c(new_n158_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n171_), .O(z24));
  oai21  g090(.a(x37), .b(x10), .c(x09), .O(new_n174_));
  nand3  g091(.a(x36), .b(new_n88_), .c(new_n158_), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(z25));
  oai21  g093(.a(x38), .b(x10), .c(x09), .O(new_n177_));
  nand3  g094(.a(x37), .b(new_n88_), .c(new_n158_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n177_), .O(z26));
  nand2  g096(.a(x14), .b(x00), .O(new_n180_));
  inv1   g097(.a(x14), .O(new_n181_));
  nand2  g098(.a(x39), .b(new_n181_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n180_), .c(new_n88_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(x09), .O(new_n184_));
  nand3  g101(.a(x38), .b(new_n88_), .c(new_n158_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(z27));
  nand2  g103(.a(new_n181_), .b(x09), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(x39), .O(new_n188_));
  nand3  g105(.a(x40), .b(new_n181_), .c(x09), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n188_), .c(x10), .O(z28));
  nand2  g107(.a(new_n187_), .b(x40), .O(new_n191_));
  nand3  g108(.a(x41), .b(new_n181_), .c(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z29));
  nand2  g110(.a(new_n187_), .b(x41), .O(new_n194_));
  nand3  g111(.a(x42), .b(new_n181_), .c(x09), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z30));
  aoi21  g113(.a(x43), .b(new_n181_), .c(x10), .O(new_n197_));
  nand3  g114(.a(new_n187_), .b(x42), .c(new_n88_), .O(new_n198_));
  oai21  g115(.a(new_n197_), .b(new_n158_), .c(new_n198_), .O(z31));
  nand2  g116(.a(new_n187_), .b(x43), .O(new_n200_));
  nand3  g117(.a(x44), .b(new_n181_), .c(x09), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z32));
  aoi21  g119(.a(x45), .b(new_n181_), .c(x10), .O(new_n203_));
  nand3  g120(.a(new_n187_), .b(x44), .c(new_n88_), .O(new_n204_));
  oai21  g121(.a(new_n203_), .b(new_n158_), .c(new_n204_), .O(z33));
  nand2  g122(.a(new_n187_), .b(x45), .O(new_n206_));
  nand3  g123(.a(x46), .b(new_n181_), .c(x09), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z34));
  nand2  g125(.a(new_n187_), .b(x46), .O(new_n209_));
  nand3  g126(.a(new_n181_), .b(x09), .c(x00), .O(new_n210_));
