...
module FAU ( 
  ...
  nand3  g035(.a(new_n118_), .b(new_n87_), .c(new_n84_), .O(new_n119_));
  ...
  oai21  g040(.a(new_n123_), .b(x10), .c(new_n87_), .O(z07));
  ...
  nand2  g096(.a(new_n179_), .b(new_n87_), .O(z20));
  oai21  g097(.a(new_n86_), .b(x09), .c(new_n85_), .O(new_n181_));
  ...
  oai21  g102(.a(new_n85_), .b(x09), .c(new_n185_), .O(new_n186_));
  ...
  nand3  g134(.a(new_n217_), .b(new_n87_), .c(new_n84_), .O(new_n218_));
  ...
  nand3  g142(.a(x33), .b(new_n102_), .c(x09), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n86_), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(x42), .O(new_n228_));
  oai21  g145(.a(x14), .b(new_n189_), .c(x41), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z30));
  oai21  g147(.a(x14), .b(new_n189_), .c(x42), .O(new_n231_));
  ...
  nand2  g163(.a(new_n246_), .b(new_n87_), .O(z33));
  inv1   g164(.a(x45), .O(new_n248_));
  aoi21  g165(.a(new_n102_), .b(x09), .c(new_n248_), .O(new_n249_));
