...
module FAU ( 
  ...
  nand2  g009(.a(x32), .b(x10), .O(new_n93_));
  ...
  oai21  g082(.a(x10), .b(x09), .c(x32), .O(new_n166_));
  ...
  oai21  g091(.a(new_n173_), .b(new_n167_), .c(new_n174_), .O(new_n175_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n93_), .O(z30));
  ...
  nand2  g138(.a(new_n221_), .b(new_n93_), .O(z31));
  ...
  nand2  g144(.a(new_n227_), .b(new_n93_), .O(z32));
  ...
  nand2  g150(.a(new_n233_), .b(new_n93_), .O(z33));
