...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n85_), .c(x37), .O(new_n104_));
  ...
  aoi21  g029(.a(x18), .b(x08), .c(x37), .O(new_n113_));
  ...
  aoi21  g062(.a(x27), .b(x08), .c(x37), .O(new_n146_));
  ...
  nand3  g067(.a(new_n150_), .b(new_n92_), .c(new_n91_), .O(new_n151_));
  ...
  nand3  g099(.a(new_n182_), .b(new_n92_), .c(new_n91_), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z24));
  nand4  g101(.a(new_n92_), .b(x36), .c(new_n91_), .d(new_n163_), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z25));
  nand2  g103(.a(x38), .b(x09), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n92_), .c(x10), .O(z26));
  ...
  oai21  g110(.a(new_n193_), .b(new_n191_), .c(new_n92_), .O(new_n194_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x37), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n212_), .c(x10), .O(z31));
  nor2   g133(.a(x14), .b(new_n163_), .O(new_n217_));
  ...
  aoi21  g146(.a(new_n229_), .b(x09), .c(x37), .O(new_n230_));
  aoi21  g147(.a(new_n230_), .b(new_n227_), .c(x10), .O(z34));
  nand2  g148(.a(new_n196_), .b(x46), .O(new_n232_));
  nand2  g149(.a(new_n217_), .b(x00), .O(new_n233_));
