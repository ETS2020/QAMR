...
module FAU ( 
  ...
  nand3  g032(.a(x18), .b(new_n91_), .c(new_n111_), .O(new_n116_));
  nand2  g033(.a(new_n116_), .b(new_n115_), .O(z07));
  oai21  g034(.a(x20), .b(x10), .c(x08), .O(new_n118_));
  nand3  g035(.a(x19), .b(new_n91_), .c(new_n111_), .O(new_n119_));
  ...
  nand3  g053(.a(x25), .b(new_n91_), .c(new_n111_), .O(new_n137_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n96_), .O(z23));
  ...
  nand2  g088(.a(new_n171_), .b(new_n96_), .O(z24));
  ...
  nand3  g133(.a(x46), .b(new_n98_), .c(x09), .O(new_n217_));
