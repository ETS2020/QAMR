...
module FAU ( 
  ...
  nor2   g046(.a(x40), .b(x08), .O(new_n130_));
  oai21  g047(.a(new_n130_), .b(x21), .c(x20), .O(new_n131_));
  nand2  g048(.a(x21), .b(x08), .O(new_n132_));
  aoi21  g049(.a(new_n132_), .b(new_n131_), .c(x10), .O(z09));
  oai21  g050(.a(x22), .b(new_n115_), .c(x21), .O(new_n134_));
  inv1   g051(.a(x40), .O(new_n135_));
  nand3  g052(.a(new_n135_), .b(x22), .c(x08), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n134_), .c(x10), .O(z10));
  ...
  nand2  g061(.a(new_n144_), .b(new_n90_), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n88_), .O(z12));
  ...
  nand2  g075(.a(new_n158_), .b(new_n90_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n88_), .O(z15));
  ...
  nand2  g080(.a(new_n163_), .b(new_n88_), .O(z16));
  ...
  nand2  g089(.a(new_n172_), .b(new_n88_), .O(z18));
  ...
  nand2  g126(.a(new_n209_), .b(new_n90_), .O(new_n210_));
  ...
  nand3  g136(.a(new_n219_), .b(x40), .c(x21), .O(new_n220_));
  nand3  g137(.a(new_n218_), .b(new_n135_), .c(x39), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z28));
  aoi21  g139(.a(new_n101_), .b(x09), .c(new_n135_), .O(new_n223_));
  ...
  oai21  g169(.a(new_n252_), .b(new_n250_), .c(new_n90_), .O(new_n253_));
