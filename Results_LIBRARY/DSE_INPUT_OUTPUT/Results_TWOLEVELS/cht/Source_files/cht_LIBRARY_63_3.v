...
module FAU ( 
  ...
  nand3  g034(.a(x18), .b(new_n88_), .c(new_n114_), .O(new_n118_));
  ...
  nand3  g070(.a(x30), .b(new_n88_), .c(new_n114_), .O(new_n154_));
  ...
  nand2  g097(.a(x37), .b(new_n161_), .O(new_n181_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n93_), .O(z30));
