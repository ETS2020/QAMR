...
module FAU ( 
  ...
  aoi21  g037(.a(new_n120_), .b(new_n84_), .c(x10), .O(z12));
  ...
  oai21  g077(.a(new_n159_), .b(new_n141_), .c(new_n160_), .O(new_n161_));
  ...
  aoi21  g088(.a(x38), .b(new_n141_), .c(x08), .O(new_n172_));
  ...
  nand3  g108(.a(x43), .b(new_n174_), .c(x09), .O(new_n192_));
  ...
  aoi21  g116(.a(new_n199_), .b(new_n196_), .c(x10), .O(z32));
  ...
  oai21  g122(.a(x14), .b(new_n141_), .c(x45), .O(new_n206_));
  ...
  oai21  g127(.a(x14), .b(new_n141_), .c(x46), .O(new_n211_));
  nand3  g128(.a(new_n174_), .b(x09), .c(x00), .O(new_n212_));
