...
module FAU ( 
  ...
  nand2  g035(.a(new_n118_), .b(new_n96_), .O(z07));
  ...
  nand2  g040(.a(new_n123_), .b(new_n96_), .O(z08));
  ...
  nand2  g048(.a(new_n131_), .b(new_n96_), .O(z10));
  ...
  nand3  g090(.a(x33), .b(new_n91_), .c(new_n167_), .O(new_n174_));
  ...
  nand3  g130(.a(new_n195_), .b(x45), .c(new_n91_), .O(new_n214_));
  oai21  g131(.a(new_n213_), .b(new_n167_), .c(new_n214_), .O(z34));
