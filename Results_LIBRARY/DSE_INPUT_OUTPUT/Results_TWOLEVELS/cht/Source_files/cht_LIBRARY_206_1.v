...
module FAU ( 
  ...
  nand2  g070(.a(x28), .b(new_n120_), .O(new_n154_));
  ...
  nand2  g101(.a(x37), .b(new_n93_), .O(new_n185_));
  ...
  nand3  g135(.a(x44), .b(new_n196_), .c(x09), .O(new_n219_));
