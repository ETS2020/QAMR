...
module FAU ( 
  ...
  nand3  g036(.a(x18), .b(new_n88_), .c(new_n116_), .O(new_n120_));
  ...
  nand3  g051(.a(x23), .b(new_n88_), .c(new_n116_), .O(new_n135_));
  ...
  nand3  g063(.a(x27), .b(new_n88_), .c(new_n116_), .O(new_n147_));
  ...
  nand2  g096(.a(x37), .b(new_n158_), .O(new_n180_));
  ...
  oai21  g105(.a(new_n188_), .b(x10), .c(new_n93_), .O(z27));
  aoi21  g106(.a(new_n100_), .b(x09), .c(new_n183_), .O(new_n190_));
  nand3  g107(.a(x40), .b(new_n100_), .c(x09), .O(new_n191_));
  ...
  nand2  g111(.a(new_n100_), .b(x09), .O(new_n195_));
  ...
  nand3  g116(.a(x42), .b(new_n100_), .c(x09), .O(new_n200_));
  ...
  nand2  g133(.a(new_n195_), .b(x45), .O(new_n217_));
