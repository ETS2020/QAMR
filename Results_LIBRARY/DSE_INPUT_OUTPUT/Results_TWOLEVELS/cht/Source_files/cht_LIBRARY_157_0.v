...
module FAU ( 
  ...
  nand2  g091(.a(x30), .b(new_n115_), .O(new_n175_));
  oai21  g092(.a(new_n115_), .b(new_n174_), .c(new_n175_), .O(new_n176_));
  ...
  and2   g155(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  oai21  g156(.a(new_n239_), .b(x10), .c(new_n89_), .O(z32));
  nand2  g157(.a(new_n218_), .b(x44), .O(new_n241_));
  ...
  nand2  g162(.a(new_n218_), .b(x45), .O(new_n246_));
  ...
  oai21  g168(.a(new_n218_), .b(new_n174_), .c(new_n251_), .O(new_n252_));
  nand3  g169(.a(new_n252_), .b(new_n89_), .c(new_n91_), .O(new_n253_));
