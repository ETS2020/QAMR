...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x44), .O(new_n98_));
  ...
  aoi21  g033(.a(x18), .b(x08), .c(x44), .O(new_n117_));
  ...
  aoi21  g087(.a(x32), .b(x09), .c(x44), .O(new_n171_));
  ...
  nand2  g106(.a(x36), .b(new_n169_), .O(new_n190_));
  aoi21  g107(.a(x37), .b(x09), .c(x44), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n190_), .c(x10), .O(z25));
  inv1   g109(.a(x38), .O(new_n193_));
  nand2  g110(.a(x37), .b(new_n169_), .O(new_n194_));
  oai21  g111(.a(new_n193_), .b(new_n169_), .c(new_n194_), .O(new_n195_));
  ...
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(new_n169_), .O(new_n200_));
  nor2   g117(.a(new_n193_), .b(x09), .O(new_n201_));
  oai21  g118(.a(new_n201_), .b(new_n200_), .c(new_n85_), .O(new_n202_));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x44), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x44), .O(new_n218_));
  ...
  nand4  g141(.a(new_n204_), .b(new_n85_), .c(x43), .d(new_n84_), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(z32));
  nand3  g143(.a(x45), .b(new_n100_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n85_), .c(x10), .O(z33));
  ...
  oai21  g151(.a(new_n204_), .b(new_n164_), .c(new_n234_), .O(new_n235_));
