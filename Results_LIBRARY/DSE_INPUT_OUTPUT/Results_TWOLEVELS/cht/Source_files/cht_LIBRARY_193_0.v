...
module FAU ( 
  ...
  oai21  g033(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n117_));
  nand2  g034(.a(new_n117_), .b(x17), .O(new_n118_));
  nand2  g035(.a(x18), .b(x08), .O(new_n119_));
  aoi21  g036(.a(new_n119_), .b(new_n118_), .c(x10), .O(z06));
  nand2  g037(.a(x19), .b(x08), .O(new_n121_));
  oai21  g038(.a(new_n85_), .b(x08), .c(new_n121_), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(new_n84_), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n87_), .O(z07));
  inv1   g041(.a(x08), .O(new_n125_));
  inv1   g042(.a(x20), .O(new_n126_));
  nand2  g043(.a(x19), .b(new_n125_), .O(new_n127_));
  oai21  g044(.a(new_n126_), .b(new_n125_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g052(.a(x21), .b(new_n125_), .O(new_n136_));
  oai21  g053(.a(new_n135_), .b(new_n125_), .c(new_n136_), .O(new_n137_));
  ...
  nand2  g061(.a(x23), .b(new_n125_), .O(new_n145_));
  oai21  g062(.a(new_n144_), .b(new_n125_), .c(new_n145_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n84_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n87_), .O(z12));
  ...
  nand2  g070(.a(x25), .b(new_n125_), .O(new_n154_));
  oai21  g071(.a(new_n153_), .b(new_n125_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g078(.a(x27), .b(new_n125_), .O(new_n162_));
  oai21  g079(.a(new_n86_), .b(new_n125_), .c(new_n162_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n84_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n87_), .O(z16));
  oai21  g082(.a(x29), .b(new_n125_), .c(x28), .O(new_n166_));
  nand3  g083(.a(x29), .b(x18), .c(x08), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z17));
  inv1   g085(.a(x30), .O(new_n169_));
  nand2  g086(.a(x29), .b(new_n125_), .O(new_n170_));
  oai21  g087(.a(new_n169_), .b(new_n125_), .c(new_n170_), .O(new_n171_));
  ...
  oai21  g137(.a(new_n220_), .b(x10), .c(new_n87_), .O(z28));
  ...
  oai21  g141(.a(new_n224_), .b(x10), .c(new_n87_), .O(z29));
  nand2  g142(.a(new_n217_), .b(x41), .O(new_n226_));
  ...
  nand2  g156(.a(new_n217_), .b(x44), .O(new_n240_));
  nand3  g157(.a(x45), .b(new_n103_), .c(x09), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(new_n87_), .c(new_n84_), .O(new_n243_));
  inv1   g160(.a(new_n243_), .O(z33));
  nand2  g161(.a(new_n217_), .b(x45), .O(new_n245_));
  nand3  g162(.a(x46), .b(new_n103_), .c(x09), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(new_n245_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(new_n87_), .c(new_n84_), .O(new_n248_));
  inv1   g165(.a(new_n248_), .O(z34));
  inv1   g166(.a(x00), .O(new_n250_));
  nand2  g167(.a(new_n217_), .b(x46), .O(new_n251_));
  oai21  g168(.a(new_n217_), .b(new_n250_), .c(new_n251_), .O(new_n252_));
