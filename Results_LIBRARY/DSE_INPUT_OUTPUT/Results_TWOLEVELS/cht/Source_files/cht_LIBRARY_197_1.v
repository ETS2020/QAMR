...
module FAU ( 
  ...
  aoi21  g050(.a(x23), .b(x08), .c(x30), .O(new_n134_));
  ...
  aoi21  g071(.a(x28), .b(x08), .c(x30), .O(new_n155_));
  ...
  aoi21  g079(.a(new_n162_), .b(new_n85_), .c(x10), .O(z18));
  nand4  g080(.a(new_n85_), .b(new_n84_), .c(x08), .d(x00), .O(new_n164_));
  ...
  aoi21  g150(.a(new_n233_), .b(x09), .c(x30), .O(new_n234_));
