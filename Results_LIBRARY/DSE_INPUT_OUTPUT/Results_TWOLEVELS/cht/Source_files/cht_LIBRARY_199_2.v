...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x40), .O(new_n88_));
  ...
  nor2   g162(.a(new_n87_), .b(x14), .O(new_n246_));
  aoi22  g163(.a(new_n246_), .b(x09), .c(new_n219_), .d(x45), .O(new_n247_));
  oai21  g164(.a(new_n247_), .b(x10), .c(new_n88_), .O(z34));
  inv1   g165(.a(x40), .O(new_n249_));
  ...
  nand2  g169(.a(new_n219_), .b(x46), .O(new_n253_));
