...
module FAU ( 
  ...
  nand2  g076(.a(new_n159_), .b(new_n93_), .O(z20));
  ...
  nand2  g091(.a(new_n174_), .b(new_n93_), .O(z24));
  ...
  nand2  g135(.a(new_n218_), .b(new_n93_), .O(z35));
endmodule
