...
module FAU ( 
  ...
  and2   g076(.a(new_n159_), .b(new_n84_), .O(z15));
  ...
  nand3  g095(.a(new_n178_), .b(new_n84_), .c(x09), .O(new_n179_));
  inv1   g096(.a(new_n179_), .O(z19));
  nor2   g097(.a(x10), .b(new_n92_), .O(new_n181_));
  ...
  nand2  g104(.a(new_n181_), .b(x35), .O(new_n188_));
  ...
  and2   g115(.a(new_n198_), .b(new_n84_), .O(z27));
  ...
  nand2  g132(.a(x43), .b(new_n100_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n215_), .c(x09), .O(new_n217_));
  and2   g134(.a(new_n217_), .b(new_n84_), .O(z31));
  ...
  and2   g143(.a(new_n226_), .b(new_n84_), .O(z33));
  ...
  inv1   g149(.a(x00), .O(new_n233_));
  nand2  g150(.a(x46), .b(x14), .O(new_n234_));
  oai21  g151(.a(x14), .b(new_n233_), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n235_), .b(new_n84_), .c(x09), .O(new_n236_));
