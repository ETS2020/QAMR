...
module FAU ( 
  ...
  nand3  g150(.a(new_n233_), .b(x43), .c(x27), .O(new_n234_));
  ...
  aoi21  g154(.a(new_n100_), .b(x09), .c(new_n235_), .O(new_n238_));
  ...
  oai21  g174(.a(new_n257_), .b(new_n255_), .c(new_n94_), .O(new_n258_));
