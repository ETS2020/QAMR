...
module FAU ( 
  ...
  aoi21  g026(.a(new_n109_), .b(new_n94_), .c(x10), .O(z07));
  ...
  aoi21  g041(.a(new_n124_), .b(new_n94_), .c(x10), .O(z14));
  inv1   g042(.a(x26), .O(new_n126_));
  aoi21  g043(.a(new_n126_), .b(new_n94_), .c(x10), .O(z15));
  ...
  nand3  g056(.a(new_n139_), .b(new_n95_), .c(new_n94_), .O(new_n140_));
  ...
  nand3  g074(.a(new_n157_), .b(new_n95_), .c(new_n94_), .O(new_n158_));
  ...
  nand3  g082(.a(new_n165_), .b(new_n164_), .c(new_n94_), .O(new_n166_));
  and2   g083(.a(new_n166_), .b(new_n95_), .O(z26));
  ...
  nand3  g091(.a(x40), .b(new_n96_), .c(x09), .O(new_n175_));
  nand2  g092(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n95_), .c(new_n94_), .O(new_n177_));
  inv1   g094(.a(new_n177_), .O(z28));
  nand2  g095(.a(new_n96_), .b(x09), .O(new_n179_));
  ...
  nand2  g101(.a(new_n179_), .b(x41), .O(new_n185_));
  ...
  nand2  g106(.a(new_n179_), .b(x42), .O(new_n190_));
  ...
  nand2  g116(.a(new_n179_), .b(x44), .O(new_n200_));
  ...
  nand2  g126(.a(new_n179_), .b(x46), .O(new_n210_));
  nor2   g127(.a(x14), .b(new_n136_), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(x00), .c(x08), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n210_), .c(x10), .O(z35));
endmodule
