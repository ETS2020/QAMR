...
module FAU ( 
  ...
  nand3  g096(.a(new_n179_), .b(new_n89_), .c(x08), .O(new_n180_));
  ...
  nand3  g101(.a(new_n184_), .b(new_n89_), .c(x08), .O(new_n185_));
