...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(x08), .c(new_n128_), .O(new_n129_));
  ...
  oai21  g050(.a(new_n132_), .b(new_n112_), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g102(.a(x36), .b(new_n167_), .O(new_n186_));
  ...
  nand2  g114(.a(x38), .b(new_n167_), .O(new_n198_));
  ...
  aoi21  g136(.a(new_n200_), .b(x09), .c(new_n219_), .O(new_n220_));
  ...
  aoi21  g151(.a(new_n200_), .b(x09), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n200_), .b(x09), .c(x00), .O(new_n236_));
  inv1   g153(.a(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(new_n235_), .c(new_n84_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n90_), .O(z35));
endmodule
