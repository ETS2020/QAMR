...
module FAU ( 
  ...
  nand2  g015(.a(x27), .b(x10), .O(new_n99_));
  ...
  oai21  g061(.a(x10), .b(x08), .c(x27), .O(new_n145_));
  nand3  g062(.a(x26), .b(new_n94_), .c(new_n109_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n145_), .O(z15));
  ...
  nand2  g071(.a(new_n154_), .b(new_n99_), .O(z17));
  ...
  nand2  g079(.a(new_n162_), .b(new_n99_), .O(z19));
  ...
  nand2  g084(.a(new_n167_), .b(new_n99_), .O(z20));
  ...
  nand2  g095(.a(x35), .b(new_n169_), .O(new_n179_));
  ...
  nand2  g117(.a(new_n95_), .b(x09), .O(new_n201_));
  ...
  nand2  g126(.a(new_n209_), .b(new_n99_), .O(z30));
  ...
  aoi21  g137(.a(new_n95_), .b(x09), .c(new_n220_), .O(new_n221_));
  ...
  nand2  g141(.a(new_n224_), .b(new_n99_), .O(z33));
  ...
  aoi21  g146(.a(new_n95_), .b(x09), .c(new_n229_), .O(new_n230_));
  nand3  g147(.a(new_n95_), .b(x09), .c(x00), .O(new_n231_));
  inv1   g148(.a(new_n231_), .O(new_n232_));
  oai21  g149(.a(new_n232_), .b(new_n230_), .c(new_n94_), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(new_n99_), .O(z35));
endmodule
