...
module FAU ( 
  ...
  aoi21  g014(.a(x13), .b(new_n97_), .c(x14), .O(new_n98_));
  ...
  aoi21  g019(.a(x15), .b(new_n97_), .c(x14), .O(new_n103_));
  aoi21  g020(.a(new_n103_), .b(new_n102_), .c(x10), .O(z04));
  nand2  g021(.a(x07), .b(x03), .O(new_n105_));
  aoi21  g022(.a(x16), .b(new_n97_), .c(x14), .O(new_n106_));
  ...
  nand2  g124(.a(x39), .b(x09), .O(new_n208_));
  ...
  nand2  g129(.a(x40), .b(x09), .O(new_n213_));
  oai21  g130(.a(new_n212_), .b(x09), .c(new_n213_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n85_), .c(new_n84_), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z28));
  nand2  g133(.a(x40), .b(new_n192_), .O(new_n217_));
  nand2  g134(.a(x41), .b(x09), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(new_n85_), .O(new_n219_));
  and2   g136(.a(new_n219_), .b(new_n84_), .O(z29));
  nand2  g137(.a(x41), .b(new_n192_), .O(new_n221_));
  nand2  g138(.a(x42), .b(x09), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(new_n85_), .O(new_n223_));
  and2   g140(.a(new_n223_), .b(new_n84_), .O(z30));
  nand2  g141(.a(x42), .b(new_n192_), .O(new_n225_));
  nand2  g142(.a(x43), .b(x09), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n225_), .c(new_n85_), .O(new_n227_));
  and2   g144(.a(new_n227_), .b(new_n84_), .O(z31));
  inv1   g145(.a(x43), .O(new_n229_));
  nand2  g146(.a(x44), .b(x09), .O(new_n230_));
  ...
  nand2  g151(.a(x45), .b(x09), .O(new_n235_));
  oai21  g152(.a(new_n234_), .b(x09), .c(new_n235_), .O(new_n236_));
  nand3  g153(.a(new_n236_), .b(new_n85_), .c(new_n84_), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(z33));
  nand2  g155(.a(x45), .b(new_n192_), .O(new_n239_));
  nand2  g156(.a(x46), .b(x09), .O(new_n240_));
  nand3  g157(.a(new_n240_), .b(new_n239_), .c(new_n85_), .O(new_n241_));
  and2   g158(.a(new_n241_), .b(new_n84_), .O(z34));
  nand2  g159(.a(x09), .b(x00), .O(new_n243_));
  aoi21  g160(.a(x46), .b(new_n192_), .c(x14), .O(new_n244_));
