...
module FAU ( 
  ...
  nor2   g009(.a(x14), .b(new_n88_), .O(new_n93_));
  inv1   g010(.a(new_n93_), .O(new_n94_));
  ...
  nand2  g055(.a(new_n138_), .b(new_n94_), .O(z12));
  ...
  nand2  g093(.a(x34), .b(new_n170_), .O(new_n177_));
  ...
  nand2  g110(.a(new_n193_), .b(new_n94_), .O(z26));
  nand3  g111(.a(x14), .b(new_n88_), .c(x00), .O(new_n195_));
  nand2  g112(.a(x39), .b(new_n99_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g114(.a(new_n197_), .b(x09), .O(new_n198_));
  inv1   g115(.a(x38), .O(new_n199_));
  nor2   g116(.a(new_n199_), .b(x10), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n170_), .c(new_n93_), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n198_), .O(z27));
  inv1   g119(.a(x39), .O(new_n203_));
  nor2   g120(.a(x14), .b(x09), .O(new_n204_));
  aoi21  g121(.a(x14), .b(new_n88_), .c(new_n204_), .O(new_n205_));
  aoi21  g122(.a(x40), .b(x09), .c(x10), .O(new_n206_));
  oai22  g123(.a(new_n206_), .b(x14), .c(new_n205_), .d(new_n203_), .O(z28));
  ...
  nand3  g129(.a(x42), .b(new_n99_), .c(x09), .O(new_n213_));
  ...
  aoi21  g141(.a(x46), .b(x09), .c(x10), .O(new_n225_));
  oai22  g142(.a(new_n225_), .b(x14), .c(new_n205_), .d(new_n224_), .O(z34));
