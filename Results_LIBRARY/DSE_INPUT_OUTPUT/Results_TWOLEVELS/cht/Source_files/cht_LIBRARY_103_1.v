...
module FAU ( 
  ...
  nand3  g061(.a(new_n144_), .b(new_n95_), .c(new_n94_), .O(new_n145_));
  ...
  and2   g070(.a(new_n153_), .b(new_n94_), .O(z17));
  ...
  and2   g074(.a(new_n157_), .b(new_n94_), .O(z18));
  ...
  and2   g089(.a(new_n172_), .b(new_n94_), .O(z21));
  ...
  and2   g102(.a(new_n185_), .b(new_n94_), .O(z24));
  nand2  g103(.a(x36), .b(new_n169_), .O(new_n187_));
  nand2  g104(.a(x37), .b(x09), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n187_), .c(new_n95_), .O(new_n189_));
  and2   g106(.a(new_n189_), .b(new_n94_), .O(z25));
  ...
  and2   g110(.a(new_n193_), .b(new_n94_), .O(z26));
  ...
  aoi21  g115(.a(x38), .b(new_n169_), .c(x25), .O(new_n199_));
  ...
  aoi21  g121(.a(new_n204_), .b(x09), .c(x25), .O(new_n205_));
  ...
  nand3  g131(.a(new_n214_), .b(new_n95_), .c(new_n94_), .O(new_n215_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x25), .O(new_n225_));
  ...
  nand3  g146(.a(new_n229_), .b(new_n95_), .c(new_n94_), .O(new_n230_));
  ...
  aoi21  g155(.a(new_n238_), .b(x00), .c(x25), .O(new_n239_));
