...
module FAU ( 
  ...
  nor2   g115(.a(x43), .b(x09), .O(new_n199_));
  oai21  g116(.a(new_n199_), .b(x37), .c(x36), .O(new_n200_));
  nand2  g117(.a(x37), .b(x09), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n200_), .c(x10), .O(z25));
  oai21  g119(.a(x38), .b(new_n175_), .c(x37), .O(new_n203_));
  inv1   g120(.a(x43), .O(new_n204_));
  nand3  g121(.a(new_n204_), .b(x38), .c(x09), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n203_), .c(x10), .O(z26));
  ...
  aoi21  g153(.a(new_n100_), .b(x09), .c(new_n204_), .O(new_n237_));
