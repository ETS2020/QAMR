...
module FAU ( 
  ...
  aoi21  g046(.a(x23), .b(x08), .c(x30), .O(new_n130_));
  ...
  aoi21  g054(.a(x25), .b(x08), .c(x30), .O(new_n138_));
  ...
  nand4  g071(.a(new_n89_), .b(x29), .c(new_n88_), .d(new_n111_), .O(new_n155_));
  inv1   g072(.a(new_n155_), .O(z18));
  nand4  g073(.a(new_n89_), .b(new_n88_), .c(x08), .d(x00), .O(new_n157_));
  ...
  and2   g079(.a(new_n162_), .b(new_n88_), .O(z20));
  ...
  and2   g083(.a(new_n166_), .b(new_n88_), .O(z21));
  ...
  and2   g096(.a(new_n179_), .b(new_n88_), .O(z24));
  ...
  and2   g104(.a(new_n187_), .b(new_n88_), .O(z26));
  ...
  oai21  g110(.a(new_n193_), .b(new_n191_), .c(new_n89_), .O(new_n194_));
  ...
  aoi21  g116(.a(new_n199_), .b(x09), .c(x30), .O(new_n200_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x30), .O(new_n215_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x30), .O(new_n220_));
