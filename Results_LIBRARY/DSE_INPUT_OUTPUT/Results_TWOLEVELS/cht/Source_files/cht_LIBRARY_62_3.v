...
module FAU ( 
  ...
  oai21  g043(.a(x10), .b(new_n111_), .c(x21), .O(new_n127_));
  ...
  oai21  g101(.a(new_n183_), .b(new_n165_), .c(new_n184_), .O(new_n185_));
  ...
  aoi21  g128(.a(new_n198_), .b(x09), .c(new_n211_), .O(new_n212_));
  ...
  aoi21  g134(.a(new_n198_), .b(x09), .c(new_n217_), .O(new_n218_));
  nand3  g135(.a(x44), .b(new_n198_), .c(x09), .O(new_n219_));
  ...
  nand3  g140(.a(x45), .b(new_n198_), .c(x09), .O(new_n224_));
  ...
  aoi21  g149(.a(new_n198_), .b(x09), .c(new_n232_), .O(new_n233_));
  nand3  g150(.a(new_n198_), .b(x09), .c(x00), .O(new_n234_));
