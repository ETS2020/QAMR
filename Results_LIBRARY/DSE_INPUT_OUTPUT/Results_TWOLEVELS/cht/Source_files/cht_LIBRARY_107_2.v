...
module FAU ( 
  ...
  nand2  g049(.a(x22), .b(new_n112_), .O(new_n133_));
  ...
  oai21  g062(.a(new_n93_), .b(x08), .c(new_n145_), .O(new_n146_));
  ...
  nand2  g077(.a(x30), .b(new_n112_), .O(new_n161_));
  ...
  nand2  g129(.a(new_n203_), .b(x43), .O(new_n213_));
  nand3  g130(.a(x44), .b(new_n191_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z32));
  inv1   g132(.a(x44), .O(new_n216_));
  aoi21  g133(.a(new_n191_), .b(x09), .c(new_n216_), .O(new_n217_));
  nand3  g134(.a(x45), .b(new_n191_), .c(x09), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(new_n217_), .c(new_n88_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n94_), .O(z33));
  inv1   g138(.a(x45), .O(new_n222_));
  aoi21  g139(.a(new_n191_), .b(x09), .c(new_n222_), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n191_), .c(x09), .O(new_n224_));
  inv1   g141(.a(new_n224_), .O(new_n225_));
  oai21  g142(.a(new_n225_), .b(new_n223_), .c(new_n88_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(new_n94_), .O(z34));
  inv1   g144(.a(x46), .O(new_n228_));
  aoi21  g145(.a(new_n191_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(new_n191_), .b(x09), .c(x00), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(new_n229_), .c(new_n88_), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n94_), .O(z35));
endmodule
