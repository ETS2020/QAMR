...
module FAU ( 
  ...
  and2   g044(.a(new_n127_), .b(new_n84_), .O(z08));
  ...
  nand3  g057(.a(new_n140_), .b(new_n84_), .c(x09), .O(new_n141_));
  ...
  and2   g062(.a(new_n145_), .b(new_n84_), .O(z12));
  ...
  nand3  g080(.a(new_n163_), .b(new_n84_), .c(x09), .O(new_n164_));
  inv1   g081(.a(new_n164_), .O(z16));
  nand2  g082(.a(x28), .b(new_n115_), .O(new_n166_));
  nand2  g083(.a(x29), .b(x08), .O(new_n167_));
  nand3  g084(.a(new_n167_), .b(new_n166_), .c(x09), .O(new_n168_));
  and2   g085(.a(new_n168_), .b(new_n84_), .O(z17));
  ...
  nand3  g094(.a(new_n177_), .b(new_n84_), .c(x09), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z19));
  nor2   g096(.a(x10), .b(new_n107_), .O(new_n180_));
  ...
  nand2  g105(.a(new_n180_), .b(x36), .O(new_n189_));
  ...
  nand2  g122(.a(x41), .b(new_n100_), .O(new_n206_));
  nand3  g123(.a(new_n206_), .b(new_n205_), .c(x09), .O(new_n207_));
  and2   g124(.a(new_n207_), .b(new_n84_), .O(z29));
  nand2  g125(.a(x41), .b(x14), .O(new_n209_));
  nand2  g126(.a(x42), .b(new_n100_), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(x09), .O(new_n211_));
  and2   g128(.a(new_n211_), .b(new_n84_), .O(z30));
  ...
  nand2  g135(.a(x44), .b(new_n100_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n218_), .c(x09), .O(new_n220_));
  and2   g137(.a(new_n220_), .b(new_n84_), .O(z32));
  ...
  oai21  g145(.a(new_n227_), .b(x14), .c(new_n228_), .O(new_n229_));
  ...
  oai21  g150(.a(x14), .b(new_n232_), .c(new_n233_), .O(new_n234_));
  nand3  g151(.a(new_n234_), .b(new_n84_), .c(x09), .O(new_n235_));
