...
module FAU ( 
  ...
  nand2  g076(.a(new_n159_), .b(new_n99_), .O(z18));
  ...
  nand3  g082(.a(x31), .b(new_n94_), .c(new_n165_), .O(new_n166_));
  ...
  aoi21  g108(.a(x40), .b(new_n95_), .c(x10), .O(new_n192_));
  nand2  g109(.a(new_n95_), .b(x09), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(x39), .c(new_n94_), .O(new_n194_));
  oai21  g111(.a(new_n192_), .b(new_n165_), .c(new_n194_), .O(z28));
  aoi21  g112(.a(x41), .b(new_n95_), .c(x10), .O(new_n196_));
  nand3  g113(.a(new_n193_), .b(x40), .c(new_n94_), .O(new_n197_));
  oai21  g114(.a(new_n196_), .b(new_n165_), .c(new_n197_), .O(z29));
  aoi21  g115(.a(x42), .b(new_n95_), .c(x10), .O(new_n199_));
  nand3  g116(.a(new_n193_), .b(x41), .c(new_n94_), .O(new_n200_));
  oai21  g117(.a(new_n199_), .b(new_n165_), .c(new_n200_), .O(z30));
  aoi21  g118(.a(x43), .b(new_n95_), .c(x10), .O(new_n202_));
  nand3  g119(.a(new_n193_), .b(x42), .c(new_n94_), .O(new_n203_));
  oai21  g120(.a(new_n202_), .b(new_n165_), .c(new_n203_), .O(z31));
  aoi21  g121(.a(x44), .b(new_n95_), .c(x10), .O(new_n205_));
  nand3  g122(.a(new_n193_), .b(x43), .c(new_n94_), .O(new_n206_));
  oai21  g123(.a(new_n205_), .b(new_n165_), .c(new_n206_), .O(z32));
  ...
  nand3  g128(.a(x46), .b(new_n95_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z34));
  nand2  g130(.a(new_n193_), .b(x46), .O(new_n214_));
  nand3  g131(.a(new_n95_), .b(x09), .c(x00), .O(new_n215_));
