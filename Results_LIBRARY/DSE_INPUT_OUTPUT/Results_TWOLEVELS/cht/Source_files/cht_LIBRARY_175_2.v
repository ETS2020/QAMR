...
module FAU ( 
  ...
  nand3  g136(.a(new_n219_), .b(x44), .c(x40), .O(new_n220_));
  aoi21  g137(.a(new_n100_), .b(x09), .c(x40), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(x39), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n220_), .c(x10), .O(z28));
  nand4  g140(.a(new_n88_), .b(x41), .c(new_n100_), .d(x09), .O(new_n224_));
  nand3  g141(.a(new_n218_), .b(x44), .c(x40), .O(new_n225_));
  ...
  aoi21  g150(.a(new_n218_), .b(x42), .c(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(x10), .c(new_n88_), .O(z31));
  oai21  g152(.a(new_n221_), .b(x44), .c(x43), .O(new_n236_));
  ...
  aoi21  g160(.a(new_n243_), .b(new_n239_), .c(x10), .O(z33));
