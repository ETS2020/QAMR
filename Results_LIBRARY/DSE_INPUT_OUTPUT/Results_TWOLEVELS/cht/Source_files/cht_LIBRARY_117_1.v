...
module FAU ( 
  ...
  oai21  g099(.a(x35), .b(x10), .c(new_n93_), .O(new_n183_));
  nand3  g100(.a(x36), .b(new_n88_), .c(x09), .O(new_n184_));
  ...
  oai21  g122(.a(x41), .b(x10), .c(new_n93_), .O(new_n206_));
  ...
  oai21  g128(.a(x42), .b(x10), .c(new_n93_), .O(new_n212_));
