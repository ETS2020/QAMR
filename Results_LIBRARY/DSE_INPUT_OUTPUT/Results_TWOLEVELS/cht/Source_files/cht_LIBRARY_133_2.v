...
module FAU ( 
  ...
  oai21  g049(.a(new_n131_), .b(new_n110_), .c(new_n132_), .O(new_n133_));
  ...
  nand2  g072(.a(new_n155_), .b(new_n90_), .O(z16));
  nand2  g073(.a(x28), .b(new_n110_), .O(new_n157_));
  nand2  g074(.a(x29), .b(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z17));
  nand2  g076(.a(x29), .b(new_n110_), .O(new_n160_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n90_), .O(z28));
  ...
  aoi21  g130(.a(new_n200_), .b(x09), .c(new_n213_), .O(new_n214_));
  nand3  g131(.a(x43), .b(new_n200_), .c(x09), .O(new_n215_));
  ...
  nand2  g146(.a(new_n229_), .b(new_n90_), .O(z34));
