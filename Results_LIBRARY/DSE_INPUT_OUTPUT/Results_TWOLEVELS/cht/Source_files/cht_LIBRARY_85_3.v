...
module FAU ( 
  ...
  nand2  g122(.a(new_n205_), .b(new_n89_), .O(new_n206_));
  ...
  nand2  g135(.a(x40), .b(new_n130_), .O(new_n219_));
  ...
  nand2  g140(.a(new_n99_), .b(x09), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(x40), .c(new_n130_), .O(new_n225_));
  ...
  nand3  g157(.a(x44), .b(new_n99_), .c(x09), .O(new_n241_));
  inv1   g158(.a(new_n241_), .O(new_n242_));
  oai21  g159(.a(new_n242_), .b(new_n240_), .c(new_n89_), .O(new_n243_));
  ...
  oai21  g165(.a(new_n248_), .b(new_n246_), .c(new_n89_), .O(new_n249_));
  ...
  nand3  g174(.a(new_n99_), .b(x09), .c(x00), .O(new_n258_));
  nand2  g175(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand3  g176(.a(new_n259_), .b(new_n87_), .c(new_n89_), .O(new_n260_));
