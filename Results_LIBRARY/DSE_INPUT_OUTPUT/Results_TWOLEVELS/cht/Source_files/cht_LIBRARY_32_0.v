...
module FAU ( 
  ...
  nand3  g014(.a(new_n97_), .b(x12), .c(new_n94_), .O(new_n98_));
  inv1   g015(.a(new_n98_), .O(z03));
  nand2  g016(.a(x07), .b(x02), .O(new_n100_));
  aoi21  g017(.a(x15), .b(new_n85_), .c(new_n86_), .O(new_n101_));
  ...
  and2   g048(.a(new_n131_), .b(new_n94_), .O(z11));
  ...
  and2   g061(.a(new_n144_), .b(new_n94_), .O(z14));
  ...
  and2   g065(.a(new_n148_), .b(new_n94_), .O(z15));
  ...
  and2   g078(.a(new_n161_), .b(new_n94_), .O(z18));
  nand2  g079(.a(x08), .b(x00), .O(new_n163_));
  aoi21  g080(.a(x30), .b(new_n106_), .c(new_n86_), .O(new_n164_));
  ...
  and2   g108(.a(new_n191_), .b(new_n94_), .O(z25));
  ...
  and2   g112(.a(new_n195_), .b(new_n94_), .O(z26));
  ...
  oai21  g118(.a(new_n201_), .b(new_n199_), .c(x12), .O(new_n202_));
  ...
  nand3  g149(.a(new_n232_), .b(x12), .c(new_n94_), .O(new_n233_));
  ...
  nand3  g154(.a(new_n237_), .b(x12), .c(new_n94_), .O(new_n238_));
  inv1   g155(.a(new_n238_), .O(z34));
  nand2  g156(.a(new_n204_), .b(x46), .O(new_n240_));
  aoi21  g157(.a(new_n230_), .b(x00), .c(new_n86_), .O(new_n241_));
