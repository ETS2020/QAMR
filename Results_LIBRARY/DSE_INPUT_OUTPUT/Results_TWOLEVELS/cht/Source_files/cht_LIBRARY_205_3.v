...
module FAU ( 
  ...
  nand2  g015(.a(x21), .b(x10), .O(new_n99_));
  ...
  nand2  g036(.a(new_n119_), .b(new_n94_), .O(new_n120_));
  nand2  g037(.a(new_n120_), .b(new_n99_), .O(z08));
  nand2  g038(.a(x20), .b(new_n107_), .O(new_n122_));
  ...
  nand3  g042(.a(x22), .b(new_n94_), .c(x08), .O(new_n126_));
  ...
  nand2  g048(.a(new_n131_), .b(new_n99_), .O(z11));
  ...
  nand2  g057(.a(new_n140_), .b(new_n99_), .O(z13));
  ...
  nand2  g061(.a(new_n144_), .b(new_n99_), .O(z14));
  ...
  nand2  g079(.a(new_n162_), .b(new_n94_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n99_), .O(z19));
  ...
  nand2  g088(.a(x33), .b(new_n165_), .O(new_n172_));
  nand2  g089(.a(x34), .b(x09), .O(new_n173_));
  aoi21  g090(.a(new_n173_), .b(new_n172_), .c(x10), .O(z22));
  nand2  g091(.a(x34), .b(new_n165_), .O(new_n175_));
  ...
  nand2  g110(.a(x38), .b(new_n165_), .O(new_n194_));
