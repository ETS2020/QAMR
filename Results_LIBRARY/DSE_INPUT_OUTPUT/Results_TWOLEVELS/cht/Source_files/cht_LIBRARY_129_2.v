...
module FAU ( 
  ...
  aoi21  g084(.a(x30), .b(new_n119_), .c(x09), .O(new_n168_));
  ...
  aoi21  g090(.a(new_n173_), .b(new_n88_), .c(x10), .O(z21));
  ...
  aoi21  g116(.a(new_n199_), .b(new_n88_), .c(x10), .O(z34));
  inv1   g117(.a(x46), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n88_), .c(x10), .O(z35));
endmodule
