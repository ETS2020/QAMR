...
module FAU ( 
  ...
  oai21  g055(.a(new_n88_), .b(x08), .c(new_n87_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(x23), .O(new_n140_));
  ...
  oai21  g074(.a(new_n157_), .b(x10), .c(new_n89_), .O(z16));
  ...
  nand3  g088(.a(new_n171_), .b(new_n89_), .c(new_n91_), .O(new_n172_));
  ...
  nand2  g095(.a(new_n178_), .b(new_n89_), .O(z20));
  ...
  nand3  g116(.a(new_n199_), .b(new_n89_), .c(new_n91_), .O(new_n200_));
  ...
  oai21  g133(.a(new_n216_), .b(x10), .c(new_n89_), .O(z28));
  nor2   g134(.a(x14), .b(new_n174_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(new_n87_), .c(new_n88_), .O(new_n219_));
  ...
  nand3  g139(.a(x24), .b(new_n101_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n88_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(x42), .O(new_n225_));
  nand2  g142(.a(new_n213_), .b(x41), .O(new_n226_));
  ...
  oai21  g147(.a(new_n230_), .b(x10), .c(new_n89_), .O(z31));
  nand3  g148(.a(x44), .b(new_n101_), .c(x09), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(new_n233_));
  aoi21  g150(.a(new_n213_), .b(x43), .c(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(x10), .c(new_n89_), .O(z32));
  ...
  nand3  g157(.a(x46), .b(new_n101_), .c(x09), .O(new_n241_));
  inv1   g158(.a(new_n241_), .O(new_n242_));
  aoi21  g159(.a(new_n213_), .b(x45), .c(new_n242_), .O(new_n243_));
  oai21  g160(.a(new_n243_), .b(x10), .c(new_n89_), .O(z34));
  nand2  g161(.a(new_n213_), .b(x46), .O(new_n245_));
  nand2  g162(.a(new_n218_), .b(x00), .O(new_n246_));
  nand2  g163(.a(new_n246_), .b(new_n245_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(new_n89_), .c(new_n91_), .O(new_n248_));
