...
module FAU ( 
  ...
  nand2  g040(.a(new_n119_), .b(x21), .O(new_n124_));
  ...
  and2   g073(.a(new_n156_), .b(new_n85_), .O(z22));
  ...
  aoi21  g136(.a(new_n219_), .b(x00), .c(x08), .O(new_n220_));
