...
module FAU ( 
  ...
  nor2   g008(.a(new_n85_), .b(x07), .O(new_n92_));
  aoi21  g009(.a(x07), .b(x05), .c(new_n92_), .O(new_n93_));
  oai21  g010(.a(new_n93_), .b(x10), .c(new_n86_), .O(z01));
  inv1   g011(.a(x13), .O(new_n95_));
  nand2  g012(.a(x07), .b(x06), .O(new_n96_));
  oai21  g013(.a(new_n95_), .b(x07), .c(new_n96_), .O(new_n97_));
  nand3  g014(.a(new_n97_), .b(new_n86_), .c(new_n84_), .O(new_n98_));
  ...
  nand3  g102(.a(new_n185_), .b(x32), .c(x12), .O(new_n186_));
  ...
  oai21  g158(.a(new_n241_), .b(x10), .c(new_n86_), .O(z32));
