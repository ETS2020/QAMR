...
module FAU ( 
  ...
  oai21  g046(.a(new_n128_), .b(new_n110_), .c(new_n129_), .O(new_n130_));
  ...
  nand2  g052(.a(new_n135_), .b(new_n100_), .O(z12));
  ...
  nand2  g057(.a(new_n140_), .b(new_n100_), .O(z13));
  ...
  nand2  g061(.a(new_n144_), .b(new_n100_), .O(z14));
  ...
  nand2  g091(.a(new_n174_), .b(new_n100_), .O(z22));
  ...
  oai21  g113(.a(new_n196_), .b(x10), .c(new_n100_), .O(z27));
  ...
  nand2  g144(.a(new_n227_), .b(new_n100_), .O(z33));
  ...
  aoi21  g149(.a(new_n95_), .b(x09), .c(new_n232_), .O(new_n233_));
  nand3  g150(.a(new_n95_), .b(x09), .c(x00), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(new_n235_));
  oai21  g152(.a(new_n235_), .b(new_n233_), .c(new_n94_), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n100_), .O(z35));
endmodule
