...
module FAU ( 
  ...
  oai21  g102(.a(new_n89_), .b(new_n169_), .c(new_n185_), .O(new_n186_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n90_), .O(z29));
  ...
  aoi21  g150(.a(new_n201_), .b(x09), .c(new_n233_), .O(new_n234_));
  nand3  g151(.a(new_n201_), .b(x09), .c(x00), .O(new_n235_));
