...
module FAU ( 
  ...
  nand2  g009(.a(x39), .b(x10), .O(new_n93_));
  ...
  nand2  g062(.a(new_n145_), .b(new_n93_), .O(z13));
  ...
  nand2  g078(.a(new_n161_), .b(new_n93_), .O(z17));
  ...
  nand3  g120(.a(x41), .b(new_n100_), .c(x09), .O(new_n204_));
