...
module FAU ( 
  ...
  nand3  g066(.a(x30), .b(new_n88_), .c(new_n109_), .O(new_n150_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n93_), .O(z22));
  ...
  nand2  g087(.a(new_n170_), .b(new_n93_), .O(z24));
  nand2  g088(.a(x36), .b(new_n152_), .O(new_n172_));
  ...
  oai21  g093(.a(new_n175_), .b(new_n152_), .c(new_n176_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n88_), .O(new_n178_));
  nand2  g095(.a(new_n178_), .b(new_n93_), .O(z26));
  ...
  aoi21  g103(.a(new_n186_), .b(x09), .c(new_n180_), .O(new_n187_));
  ...
  nand2  g114(.a(new_n186_), .b(x09), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(x41), .O(new_n199_));
  nand3  g116(.a(x42), .b(new_n186_), .c(x09), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z30));
  inv1   g118(.a(x42), .O(new_n202_));
  aoi21  g119(.a(new_n186_), .b(x09), .c(new_n202_), .O(new_n203_));
  nand3  g120(.a(x43), .b(new_n186_), .c(x09), .O(new_n204_));
  ...
  nand2  g124(.a(new_n198_), .b(x43), .O(new_n208_));
  nand3  g125(.a(x44), .b(new_n186_), .c(x09), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z32));
  inv1   g127(.a(x44), .O(new_n211_));
  aoi21  g128(.a(new_n186_), .b(x09), .c(new_n211_), .O(new_n212_));
  nand3  g129(.a(x45), .b(new_n186_), .c(x09), .O(new_n213_));
  ...
  nand2  g133(.a(new_n198_), .b(x45), .O(new_n217_));
