...
module FAU ( 
  ...
  and2   g032(.a(new_n115_), .b(new_n85_), .O(z07));
  ...
  aoi21  g085(.a(x30), .b(new_n112_), .c(x09), .O(new_n169_));
  ...
  aoi21  g095(.a(new_n178_), .b(new_n84_), .c(x10), .O(z23));
  ...
  nand2  g106(.a(new_n171_), .b(x40), .O(new_n190_));
