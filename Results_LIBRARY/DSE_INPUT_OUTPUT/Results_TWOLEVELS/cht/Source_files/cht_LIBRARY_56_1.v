...
module FAU ( 
  ...
  aoi21  g031(.a(new_n114_), .b(new_n89_), .c(x10), .O(z07));
  ...
  aoi21  g081(.a(x30), .b(new_n111_), .c(x18), .O(new_n165_));
  ...
  aoi21  g117(.a(x38), .b(new_n167_), .c(x18), .O(new_n201_));
  ...
  aoi21  g124(.a(new_n207_), .b(x09), .c(x18), .O(new_n208_));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x18), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x18), .O(new_n218_));
  ...
  aoi21  g139(.a(new_n222_), .b(x09), .c(x18), .O(new_n223_));
  ...
  aoi21  g158(.a(new_n241_), .b(x00), .c(x18), .O(new_n242_));
