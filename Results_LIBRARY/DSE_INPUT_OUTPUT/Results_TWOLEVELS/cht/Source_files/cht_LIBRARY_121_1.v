...
module FAU ( 
  ...
  nand2  g014(.a(x13), .b(new_n86_), .O(new_n98_));
  ...
  nand2  g029(.a(new_n112_), .b(new_n90_), .O(z06));
  ...
  nand2  g088(.a(new_n171_), .b(new_n90_), .O(z21));
  ...
  nand2  g092(.a(new_n175_), .b(new_n90_), .O(z22));
  ...
  nand2  g100(.a(new_n183_), .b(new_n90_), .O(z24));
  ...
  nand2  g113(.a(x38), .b(new_n164_), .O(new_n197_));
  ...
  nand2  g136(.a(new_n219_), .b(new_n90_), .O(z32));
  ...
  nand2  g151(.a(new_n234_), .b(new_n90_), .O(z35));
endmodule
