...
module FAU ( 
  ...
  nand2  g037(.a(new_n120_), .b(new_n93_), .O(z07));
  ...
  nand3  g087(.a(x32), .b(new_n88_), .c(new_n166_), .O(new_n171_));
  ...
  nand3  g096(.a(x35), .b(new_n88_), .c(new_n166_), .O(new_n180_));
  ...
  aoi21  g120(.a(x43), .b(new_n100_), .c(x10), .O(new_n204_));
  nand3  g121(.a(new_n194_), .b(x42), .c(new_n88_), .O(new_n205_));
  oai21  g122(.a(new_n204_), .b(new_n166_), .c(new_n205_), .O(z31));
  ...
  nand3  g127(.a(x45), .b(new_n100_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z33));
  nand2  g129(.a(new_n194_), .b(x45), .O(new_n213_));
  nand3  g130(.a(x46), .b(new_n100_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z34));
  aoi21  g132(.a(new_n100_), .b(x00), .c(x10), .O(new_n216_));
  nand3  g133(.a(new_n194_), .b(x46), .c(new_n88_), .O(new_n217_));
  oai21  g134(.a(new_n216_), .b(new_n166_), .c(new_n217_), .O(z35));
endmodule
