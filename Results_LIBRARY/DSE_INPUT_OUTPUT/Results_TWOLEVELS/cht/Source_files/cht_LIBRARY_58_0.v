...
module FAU ( 
  ...
  nand3  g082(.a(new_n165_), .b(new_n87_), .c(new_n84_), .O(new_n166_));
  inv1   g083(.a(new_n166_), .O(z16));
  oai21  g084(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(x28), .O(new_n169_));
  nand2  g086(.a(x29), .b(x08), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n169_), .c(x10), .O(z17));
  nor2   g088(.a(new_n85_), .b(x08), .O(new_n172_));
  ...
  oai21  g096(.a(x32), .b(new_n179_), .c(x31), .O(new_n180_));
  nand3  g097(.a(x32), .b(x29), .c(x09), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n180_), .c(x10), .O(z20));
  inv1   g099(.a(x33), .O(new_n183_));
  nand2  g100(.a(x32), .b(new_n179_), .O(new_n184_));
  ...
  nand2  g109(.a(x34), .b(new_n179_), .O(new_n193_));
  oai21  g110(.a(new_n192_), .b(new_n179_), .c(new_n193_), .O(new_n194_));
  ...
  nand2  g118(.a(x36), .b(new_n179_), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(new_n179_), .c(new_n202_), .O(new_n203_));
  ...
  oai21  g131(.a(new_n214_), .b(new_n212_), .c(new_n87_), .O(new_n215_));
  nor2   g132(.a(new_n215_), .b(x10), .O(z27));
  inv1   g133(.a(x39), .O(new_n217_));
  nor2   g134(.a(x14), .b(new_n179_), .O(new_n218_));
