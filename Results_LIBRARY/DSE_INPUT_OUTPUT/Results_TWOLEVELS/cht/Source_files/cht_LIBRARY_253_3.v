...
module FAU ( 
  ...
  nand3  g063(.a(x29), .b(new_n84_), .c(new_n110_), .O(new_n147_));
  ...
  nand2  g078(.a(x33), .b(new_n152_), .O(new_n162_));
  ...
  nand2  g101(.a(x38), .b(new_n152_), .O(new_n185_));
  ...
  nand3  g108(.a(x41), .b(new_n98_), .c(x09), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n191_), .c(x10), .O(z29));
  nand2  g110(.a(new_n187_), .b(x41), .O(new_n194_));
  nand3  g111(.a(x42), .b(new_n98_), .c(x09), .O(new_n195_));
  ...
  nand3  g115(.a(x43), .b(new_n98_), .c(x09), .O(new_n199_));
  ...
  nand2  g131(.a(new_n187_), .b(x45), .O(new_n215_));
