...
module FAU ( 
  ...
  nand2  g003(.a(x41), .b(x24), .O(new_n87_));
  ...
  nor2   g053(.a(x24), .b(x08), .O(new_n137_));
  inv1   g054(.a(x24), .O(new_n138_));
  nor2   g055(.a(x41), .b(new_n138_), .O(new_n139_));
  oai21  g056(.a(new_n139_), .b(new_n137_), .c(x23), .O(new_n140_));
  nand2  g057(.a(new_n139_), .b(x08), .O(new_n141_));
  ...
  nand3  g116(.a(new_n199_), .b(new_n87_), .c(new_n89_), .O(new_n200_));
  ...
  nand3  g136(.a(new_n219_), .b(x41), .c(new_n138_), .O(new_n220_));
  inv1   g137(.a(x41), .O(new_n221_));
  nand3  g138(.a(new_n213_), .b(new_n221_), .c(x40), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n220_), .c(x10), .O(z29));
  nand3  g140(.a(new_n221_), .b(new_n99_), .c(x09), .O(new_n224_));
  oai21  g141(.a(new_n221_), .b(x24), .c(new_n224_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(x42), .O(new_n226_));
  nand3  g143(.a(new_n213_), .b(x41), .c(new_n138_), .O(new_n227_));
  ...
  aoi21  g147(.a(new_n213_), .b(x42), .c(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(x10), .c(new_n87_), .O(z31));
  nand3  g149(.a(x44), .b(new_n99_), .c(x09), .O(new_n233_));
  inv1   g150(.a(new_n233_), .O(new_n234_));
  aoi21  g151(.a(new_n213_), .b(x43), .c(new_n234_), .O(new_n235_));
  oai21  g152(.a(new_n235_), .b(x10), .c(new_n87_), .O(z32));
  nand2  g153(.a(new_n213_), .b(x44), .O(new_n237_));
  ...
  aoi21  g160(.a(new_n213_), .b(x45), .c(new_n243_), .O(new_n244_));
