...
module FAU ( 
  ...
  nor2   g070(.a(x42), .b(x08), .O(new_n154_));
  oai21  g071(.a(new_n154_), .b(x27), .c(x26), .O(new_n155_));
  nand2  g072(.a(x27), .b(x08), .O(new_n156_));
  aoi21  g073(.a(new_n156_), .b(new_n155_), .c(x10), .O(z15));
  nor2   g074(.a(new_n87_), .b(x08), .O(new_n158_));
  ...
  nand3  g144(.a(new_n227_), .b(x42), .c(x27), .O(new_n228_));
  inv1   g145(.a(x42), .O(new_n229_));
  nand3  g146(.a(new_n226_), .b(new_n229_), .c(x41), .O(new_n230_));
  aoi21  g147(.a(new_n230_), .b(new_n228_), .c(x10), .O(z30));
  aoi21  g148(.a(new_n100_), .b(x09), .c(new_n229_), .O(new_n232_));
  ...
  oai21  g164(.a(x14), .b(new_n175_), .c(x45), .O(new_n248_));
  ...
  oai21  g169(.a(x14), .b(new_n175_), .c(x46), .O(new_n253_));
