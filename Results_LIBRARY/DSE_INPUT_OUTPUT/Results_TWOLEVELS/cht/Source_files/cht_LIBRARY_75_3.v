...
module FAU ( 
  ...
  nand2  g075(.a(new_n158_), .b(new_n89_), .O(z17));
  nand2  g076(.a(x29), .b(new_n115_), .O(new_n160_));
  nand2  g077(.a(x30), .b(x08), .O(new_n161_));
  aoi21  g078(.a(new_n161_), .b(new_n160_), .c(x10), .O(z18));
  nand2  g079(.a(x08), .b(x00), .O(new_n163_));
  nand2  g080(.a(x30), .b(new_n115_), .O(new_n164_));
  ...
  aoi21  g110(.a(x40), .b(new_n101_), .c(x10), .O(new_n194_));
  nand2  g111(.a(new_n101_), .b(x09), .O(new_n195_));
  nand3  g112(.a(new_n195_), .b(x39), .c(new_n84_), .O(new_n196_));
  oai21  g113(.a(new_n194_), .b(new_n166_), .c(new_n196_), .O(z28));
  nand2  g114(.a(new_n195_), .b(x40), .O(new_n198_));
  nand3  g115(.a(x41), .b(new_n101_), .c(x09), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z29));
  nand2  g117(.a(new_n195_), .b(x41), .O(new_n201_));
  nand3  g118(.a(x42), .b(new_n101_), .c(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z30));
  nand2  g120(.a(new_n195_), .b(x42), .O(new_n204_));
  nand3  g121(.a(x43), .b(new_n101_), .c(x09), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n204_), .c(x10), .O(z31));
  nand2  g123(.a(new_n195_), .b(x43), .O(new_n207_));
  nand3  g124(.a(x44), .b(new_n101_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z32));
  aoi21  g126(.a(x45), .b(new_n101_), .c(x10), .O(new_n210_));
  nand3  g127(.a(new_n195_), .b(x44), .c(new_n84_), .O(new_n211_));
  oai21  g128(.a(new_n210_), .b(new_n166_), .c(new_n211_), .O(z33));
  aoi21  g129(.a(x46), .b(new_n101_), .c(x10), .O(new_n213_));
  nand3  g130(.a(new_n195_), .b(x45), .c(new_n84_), .O(new_n214_));
  oai21  g131(.a(new_n213_), .b(new_n166_), .c(new_n214_), .O(z34));
  nand2  g132(.a(new_n195_), .b(x46), .O(new_n216_));
