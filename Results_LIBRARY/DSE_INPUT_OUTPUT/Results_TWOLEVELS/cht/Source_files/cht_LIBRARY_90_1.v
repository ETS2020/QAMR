...
module FAU ( 
  ...
  nand2  g002(.a(x41), .b(new_n85_), .O(new_n86_));
  ...
  nor2   g096(.a(x41), .b(x09), .O(new_n180_));
  oai21  g097(.a(new_n180_), .b(x33), .c(x32), .O(new_n181_));
  ...
  nand2  g106(.a(x34), .b(new_n188_), .O(new_n190_));
  ...
  nand2  g115(.a(x36), .b(new_n188_), .O(new_n199_));
  ...
  oai21  g130(.a(x14), .b(new_n188_), .c(x39), .O(new_n214_));
  ...
  nand2  g141(.a(x41), .b(x33), .O(new_n225_));
  inv1   g142(.a(x41), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n101_), .c(x09), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(new_n225_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(x42), .O(new_n229_));
  nand2  g146(.a(new_n101_), .b(x09), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(x41), .c(x33), .O(new_n231_));
