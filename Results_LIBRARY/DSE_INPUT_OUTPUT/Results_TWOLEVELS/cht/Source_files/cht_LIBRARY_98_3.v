...
module FAU ( 
  ...
  nand2  g053(.a(new_n136_), .b(new_n93_), .O(z13));
  ...
  nand2  g062(.a(new_n145_), .b(new_n93_), .O(z15));
  ...
  nand2  g070(.a(new_n153_), .b(new_n93_), .O(z17));
  ...
  nand2  g091(.a(x34), .b(new_n161_), .O(new_n175_));
  ...
  aoi21  g113(.a(new_n98_), .b(x09), .c(new_n191_), .O(new_n197_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n93_), .O(z32));
  ...
  nand2  g146(.a(new_n214_), .b(x45), .O(new_n230_));
