...
module FAU ( 
  ...
  and2   g075(.a(new_n158_), .b(new_n84_), .O(z23));
  ...
  aoi21  g094(.a(x38), .b(new_n142_), .c(new_n97_), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n177_), .c(x10), .O(z27));
  oai21  g096(.a(x14), .b(new_n142_), .c(x39), .O(new_n180_));
  inv1   g097(.a(x14), .O(new_n181_));
  nand3  g098(.a(x40), .b(new_n181_), .c(x09), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(new_n180_), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(new_n84_), .c(x08), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z28));
  nand2  g102(.a(new_n181_), .b(x09), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(x40), .O(new_n187_));
  inv1   g104(.a(x41), .O(new_n188_));
  nor2   g105(.a(new_n188_), .b(x14), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(x09), .c(new_n97_), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n187_), .c(x10), .O(z29));
  nand2  g108(.a(new_n186_), .b(x41), .O(new_n192_));
  inv1   g109(.a(x42), .O(new_n193_));
  nor2   g110(.a(new_n193_), .b(x14), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(x09), .c(new_n97_), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n192_), .c(x10), .O(z30));
  nand2  g113(.a(new_n186_), .b(x42), .O(new_n197_));
  inv1   g114(.a(x43), .O(new_n198_));
  nor2   g115(.a(new_n198_), .b(x14), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(x09), .c(new_n97_), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n197_), .c(x10), .O(z31));
  oai21  g118(.a(x14), .b(new_n142_), .c(x43), .O(new_n202_));
  nand3  g119(.a(x44), .b(new_n181_), .c(x09), .O(new_n203_));
  ...
  oai21  g123(.a(x14), .b(new_n142_), .c(x44), .O(new_n207_));
  nand3  g124(.a(x45), .b(new_n181_), .c(x09), .O(new_n208_));
  ...
  nand2  g128(.a(new_n186_), .b(x45), .O(new_n212_));
  inv1   g129(.a(x46), .O(new_n213_));
  nor2   g130(.a(new_n213_), .b(x14), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(x09), .c(new_n97_), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n212_), .c(x10), .O(z34));
  oai21  g133(.a(x14), .b(new_n142_), .c(x46), .O(new_n217_));
  nand3  g134(.a(new_n181_), .b(x09), .c(x00), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n217_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(new_n84_), .c(x08), .O(new_n220_));
