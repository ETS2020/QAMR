...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x21), .O(new_n88_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n90_), .O(new_n198_));
  ...
  oai21  g134(.a(new_n217_), .b(new_n215_), .c(new_n90_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n88_), .O(z28));
  nand3  g136(.a(new_n131_), .b(new_n100_), .c(x09), .O(new_n220_));
