...
module FAU ( 
  ...
  nand2  g001(.a(x45), .b(x41), .O(new_n85_));
  ...
  oai21  g064(.a(new_n147_), .b(x10), .c(new_n85_), .O(z13));
  ...
  nand2  g148(.a(new_n231_), .b(new_n85_), .O(z30));
  ...
  nand2  g161(.a(new_n101_), .b(x09), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n244_), .O(new_n246_));
  nand3  g163(.a(new_n246_), .b(x45), .c(new_n227_), .O(new_n247_));
  ...
  aoi21  g167(.a(new_n101_), .b(x09), .c(new_n248_), .O(new_n251_));
