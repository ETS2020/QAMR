...
module FAU ( 
  ...
  nand4  g017(.a(x14), .b(new_n84_), .c(new_n87_), .d(new_n85_), .O(new_n101_));
  inv1   g018(.a(new_n101_), .O(z03));
  nand2  g019(.a(x07), .b(x02), .O(new_n103_));
  nand2  g020(.a(x15), .b(new_n87_), .O(new_n104_));
  nand3  g021(.a(new_n104_), .b(new_n103_), .c(new_n85_), .O(new_n105_));
  ...
  nand3  g026(.a(new_n109_), .b(new_n84_), .c(new_n85_), .O(new_n110_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n84_), .c(new_n85_), .O(new_n192_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n84_), .c(new_n85_), .O(new_n201_));
  ...
  aoi21  g123(.a(x38), .b(new_n172_), .c(x01), .O(new_n207_));
  ...
  nand3  g165(.a(new_n248_), .b(new_n84_), .c(new_n85_), .O(new_n249_));
