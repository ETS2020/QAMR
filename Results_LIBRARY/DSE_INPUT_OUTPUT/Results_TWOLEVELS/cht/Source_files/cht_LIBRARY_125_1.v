...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x44), .O(new_n93_));
  aoi21  g010(.a(new_n93_), .b(new_n91_), .c(x10), .O(z01));
  nand2  g011(.a(x07), .b(x06), .O(new_n95_));
  aoi21  g012(.a(x13), .b(new_n92_), .c(x44), .O(new_n96_));
  aoi21  g013(.a(new_n96_), .b(new_n95_), .c(x10), .O(z02));
  nand2  g014(.a(x07), .b(x01), .O(new_n98_));
  aoi21  g015(.a(x14), .b(new_n92_), .c(x44), .O(new_n99_));
  aoi21  g016(.a(new_n99_), .b(new_n98_), .c(x10), .O(z03));
  nand2  g017(.a(x07), .b(x02), .O(new_n101_));
  aoi21  g018(.a(x15), .b(new_n92_), .c(x44), .O(new_n102_));
  ...
  aoi21  g050(.a(x23), .b(x08), .c(x44), .O(new_n134_));
  ...
  aoi21  g112(.a(x38), .b(new_n169_), .c(x44), .O(new_n196_));
  ...
  aoi21  g137(.a(new_n220_), .b(new_n85_), .c(x10), .O(z32));
  inv1   g138(.a(x45), .O(new_n222_));
  nand4  g139(.a(new_n85_), .b(new_n199_), .c(new_n84_), .d(x09), .O(new_n223_));
  nor2   g140(.a(new_n223_), .b(new_n222_), .O(z33));
  oai21  g141(.a(x14), .b(new_n169_), .c(x45), .O(new_n225_));
  ...
  nand2  g146(.a(new_n219_), .b(x46), .O(new_n230_));
  nor2   g147(.a(x14), .b(new_n169_), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(x00), .c(x44), .O(new_n232_));
