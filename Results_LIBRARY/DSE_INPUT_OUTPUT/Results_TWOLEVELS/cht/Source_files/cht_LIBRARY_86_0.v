...
module FAU ( 
  ...
  nand2  g038(.a(new_n113_), .b(x23), .O(new_n122_));
  ...
  nand2  g052(.a(new_n113_), .b(x30), .O(new_n136_));
  ...
  and2   g060(.a(new_n143_), .b(new_n84_), .O(z20));
  ...
  nand3  g076(.a(new_n159_), .b(new_n158_), .c(x08), .O(new_n160_));
  and2   g077(.a(new_n160_), .b(new_n84_), .O(z24));
  ...
  aoi21  g091(.a(x38), .b(new_n140_), .c(new_n92_), .O(new_n175_));
