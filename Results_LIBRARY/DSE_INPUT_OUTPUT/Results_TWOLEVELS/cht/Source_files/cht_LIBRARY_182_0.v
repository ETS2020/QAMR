...
module FAU ( 
  ...
  aoi21  g049(.a(x21), .b(x08), .c(new_n132_), .O(new_n133_));
  oai21  g050(.a(new_n133_), .b(x10), .c(new_n89_), .O(z09));
  ...
  nor2   g060(.a(new_n87_), .b(x08), .O(new_n144_));
  ...
  oai21  g093(.a(new_n176_), .b(x10), .c(new_n89_), .O(z19));
  ...
  nand2  g099(.a(new_n182_), .b(new_n89_), .O(z20));
  ...
  nand3  g141(.a(new_n224_), .b(new_n89_), .c(new_n91_), .O(new_n225_));
  ...
  aoi21  g149(.a(new_n102_), .b(x09), .c(new_n88_), .O(new_n233_));
  ...
  nand2  g159(.a(new_n242_), .b(new_n89_), .O(z32));
  ...
  nand3  g168(.a(new_n251_), .b(new_n89_), .c(new_n91_), .O(new_n252_));
  inv1   g169(.a(new_n252_), .O(z34));
  inv1   g170(.a(x46), .O(new_n254_));
  aoi21  g171(.a(new_n102_), .b(x09), .c(new_n254_), .O(new_n255_));
  nand3  g172(.a(new_n102_), .b(x09), .c(x00), .O(new_n256_));
  inv1   g173(.a(new_n256_), .O(new_n257_));
  oai21  g174(.a(new_n257_), .b(new_n255_), .c(new_n91_), .O(new_n258_));
  nand2  g175(.a(new_n258_), .b(new_n89_), .O(z35));
endmodule
