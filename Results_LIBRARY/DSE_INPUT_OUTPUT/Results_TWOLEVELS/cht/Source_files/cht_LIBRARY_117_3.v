...
module FAU ( 
  ...
  nand3  g106(.a(x37), .b(new_n88_), .c(new_n171_), .O(new_n190_));
  ...
  nand3  g123(.a(new_n199_), .b(x41), .c(new_n88_), .O(new_n207_));
  oai21  g124(.a(new_n206_), .b(new_n171_), .c(new_n207_), .O(z30));
  aoi21  g125(.a(x43), .b(new_n193_), .c(x10), .O(new_n209_));
  nand3  g126(.a(new_n199_), .b(x42), .c(new_n88_), .O(new_n210_));
  oai21  g127(.a(new_n209_), .b(new_n171_), .c(new_n210_), .O(z31));
  nand2  g128(.a(new_n199_), .b(x43), .O(new_n212_));
  nand3  g129(.a(x44), .b(new_n193_), .c(x09), .O(new_n213_));
