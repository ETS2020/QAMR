...
module FAU ( 
  ...
  aoi21  g122(.a(new_n205_), .b(x09), .c(new_n198_), .O(new_n206_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n90_), .O(z29));
  nand2  g133(.a(new_n205_), .b(x09), .O(new_n217_));
  ...
  nand2  g140(.a(new_n217_), .b(x43), .O(new_n224_));
  nand3  g141(.a(x44), .b(new_n205_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z32));
  inv1   g143(.a(x44), .O(new_n227_));
  aoi21  g144(.a(new_n205_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(x45), .b(new_n205_), .c(x09), .O(new_n229_));
  ...
  aoi21  g150(.a(new_n205_), .b(x09), .c(new_n233_), .O(new_n234_));
  nand3  g151(.a(x46), .b(new_n205_), .c(x09), .O(new_n235_));
  ...
  aoi21  g156(.a(new_n205_), .b(x09), .c(new_n239_), .O(new_n240_));
