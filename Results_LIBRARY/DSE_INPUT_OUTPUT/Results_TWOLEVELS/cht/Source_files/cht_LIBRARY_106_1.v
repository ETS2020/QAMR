...
module FAU ( 
  ...
  nand2  g037(.a(x20), .b(new_n93_), .O(new_n121_));
  ...
  nand2  g046(.a(x23), .b(new_n93_), .O(new_n130_));
  ...
  nand2  g055(.a(x26), .b(new_n93_), .O(new_n139_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n94_), .O(z23));
  ...
  oai21  g090(.a(new_n172_), .b(new_n154_), .c(new_n173_), .O(new_n174_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n94_), .O(z32));
  nand2  g128(.a(new_n193_), .b(x44), .O(new_n212_));
  nand3  g129(.a(x45), .b(new_n99_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z33));
  nand2  g131(.a(new_n193_), .b(x45), .O(new_n215_));
  nand3  g132(.a(x46), .b(new_n99_), .c(x09), .O(new_n216_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n94_), .O(z35));
endmodule
