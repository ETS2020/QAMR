...
module FAU ( 
  ...
  oai21  g094(.a(new_n177_), .b(new_n175_), .c(new_n89_), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(new_n86_), .O(z27));
  ...
  nand3  g103(.a(x41), .b(new_n173_), .c(x09), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand3  g105(.a(new_n188_), .b(new_n89_), .c(x08), .O(new_n189_));
  ...
  aoi21  g110(.a(new_n193_), .b(x09), .c(new_n86_), .O(new_n194_));
  ...
  nand2  g117(.a(new_n180_), .b(x43), .O(new_n201_));
  ...
  nand3  g128(.a(x46), .b(new_n173_), .c(x09), .O(new_n212_));
  ...
  oai21  g133(.a(new_n180_), .b(new_n138_), .c(new_n216_), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(new_n89_), .c(x08), .O(new_n218_));
