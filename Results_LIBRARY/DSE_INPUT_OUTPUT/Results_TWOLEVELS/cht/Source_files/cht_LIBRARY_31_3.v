...
module FAU ( 
  ...
  nand2  g055(.a(x24), .b(new_n113_), .O(new_n139_));
  ...
  oai21  g086(.a(x32), .b(x10), .c(x09), .O(new_n170_));
  inv1   g087(.a(x09), .O(new_n171_));
  nand3  g088(.a(x31), .b(new_n84_), .c(new_n171_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n170_), .O(z20));
  nand2  g090(.a(x32), .b(new_n171_), .O(new_n174_));
  ...
  nand3  g097(.a(x34), .b(new_n84_), .c(new_n171_), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(z23));
  oai21  g099(.a(x36), .b(x10), .c(x09), .O(new_n183_));
  nand3  g100(.a(x35), .b(new_n84_), .c(new_n171_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(z24));
  nand2  g102(.a(x36), .b(new_n171_), .O(new_n186_));
  ...
  nand2  g114(.a(new_n101_), .b(x09), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(x39), .O(new_n199_));
  nand3  g116(.a(x40), .b(new_n101_), .c(x09), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z28));
  aoi21  g118(.a(x41), .b(new_n101_), .c(x10), .O(new_n202_));
  nand3  g119(.a(new_n198_), .b(x40), .c(new_n84_), .O(new_n203_));
  oai21  g120(.a(new_n202_), .b(new_n171_), .c(new_n203_), .O(z29));
  ...
  aoi21  g124(.a(x43), .b(new_n101_), .c(x10), .O(new_n208_));
  nand3  g125(.a(new_n198_), .b(x42), .c(new_n84_), .O(new_n209_));
  oai21  g126(.a(new_n208_), .b(new_n171_), .c(new_n209_), .O(z31));
  ...
  nand3  g134(.a(x46), .b(new_n101_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z34));
  nand2  g136(.a(new_n198_), .b(x46), .O(new_n220_));
