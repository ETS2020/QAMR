...
module FAU ( 
  ...
  nor2   g049(.a(x44), .b(x08), .O(new_n133_));
  oai21  g050(.a(new_n133_), .b(x22), .c(x21), .O(new_n134_));
  nand2  g051(.a(x22), .b(x08), .O(new_n135_));
  aoi21  g052(.a(new_n135_), .b(new_n134_), .c(x10), .O(z10));
  oai21  g053(.a(x23), .b(new_n114_), .c(x22), .O(new_n137_));
  inv1   g054(.a(x44), .O(new_n138_));
  nand3  g055(.a(new_n138_), .b(x23), .c(x08), .O(new_n139_));
  ...
  nand2  g069(.a(new_n152_), .b(new_n90_), .O(new_n153_));
  ...
  nand2  g087(.a(new_n170_), .b(new_n90_), .O(new_n171_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n88_), .O(z19));
  ...
  nand3  g155(.a(new_n138_), .b(new_n101_), .c(x09), .O(new_n239_));
  oai21  g156(.a(new_n138_), .b(new_n87_), .c(new_n239_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(x45), .O(new_n241_));
  nand3  g158(.a(new_n216_), .b(x44), .c(x22), .O(new_n242_));
