...
module FAU ( 
  ...
  oai21  g034(.a(new_n99_), .b(x08), .c(new_n117_), .O(new_n118_));
  nand2  g035(.a(new_n118_), .b(new_n94_), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(new_n100_), .O(z08));
  nand2  g037(.a(x20), .b(new_n113_), .O(new_n121_));
  ...
  nand2  g047(.a(x23), .b(new_n113_), .O(new_n131_));
  oai21  g048(.a(new_n130_), .b(new_n113_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g054(.a(new_n137_), .b(new_n100_), .O(z13));
  ...
  nand2  g059(.a(new_n142_), .b(new_n100_), .O(z14));
  ...
  nand2  g063(.a(new_n146_), .b(new_n100_), .O(z15));
  nand2  g064(.a(x27), .b(new_n113_), .O(new_n148_));
  ...
  nand2  g074(.a(x30), .b(new_n113_), .O(new_n158_));
  ...
  nand2  g087(.a(new_n170_), .b(new_n100_), .O(z22));
  ...
  nand2  g091(.a(new_n174_), .b(new_n100_), .O(z23));
  ...
  nand2  g096(.a(new_n179_), .b(new_n100_), .O(z24));
  ...
  nand2  g100(.a(new_n183_), .b(new_n100_), .O(z25));
  ...
  oai21  g110(.a(new_n193_), .b(x10), .c(new_n100_), .O(z27));
  ...
  nand2  g123(.a(new_n206_), .b(new_n100_), .O(z30));
  ...
  nand2  g135(.a(new_n218_), .b(new_n100_), .O(z33));
