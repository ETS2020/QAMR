...
module FAU ( 
  ...
  nand3  g099(.a(x34), .b(new_n84_), .c(x09), .O(new_n183_));
  ...
  nand2  g120(.a(x41), .b(new_n100_), .O(new_n204_));
  ...
  nand2  g124(.a(x42), .b(new_n100_), .O(new_n208_));
  ...
  nand2  g132(.a(x44), .b(new_n100_), .O(new_n216_));
  ...
  nand2  g136(.a(x45), .b(new_n100_), .O(new_n220_));
  ...
  nand2  g140(.a(x46), .b(new_n100_), .O(new_n224_));
