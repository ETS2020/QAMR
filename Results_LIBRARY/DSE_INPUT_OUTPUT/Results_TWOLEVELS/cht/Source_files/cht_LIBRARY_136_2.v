...
module FAU ( 
  ...
  nand2  g058(.a(x23), .b(new_n116_), .O(new_n142_));
  ...
  nand2  g067(.a(x25), .b(new_n116_), .O(new_n151_));
  ...
  oai21  g082(.a(new_n89_), .b(x08), .c(new_n165_), .O(new_n166_));
  ...
  aoi21  g127(.a(new_n102_), .b(x09), .c(new_n205_), .O(new_n211_));
  ...
  nand3  g134(.a(x41), .b(new_n102_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z29));
  nand2  g136(.a(new_n216_), .b(x41), .O(new_n220_));
  nand3  g137(.a(x42), .b(new_n102_), .c(x09), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z30));
  nand2  g139(.a(new_n216_), .b(x42), .O(new_n223_));
  ...
  nand3  g147(.a(x45), .b(new_n102_), .c(x09), .O(new_n231_));
  ...
  nand3  g153(.a(x46), .b(new_n102_), .c(x09), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(new_n238_));
  oai21  g155(.a(new_n238_), .b(new_n236_), .c(new_n84_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(new_n90_), .O(z34));
  nand2  g157(.a(new_n216_), .b(x46), .O(new_n241_));
  nand3  g158(.a(new_n102_), .b(x09), .c(x00), .O(new_n242_));
