...
module FAU ( 
  ...
  nand2  g043(.a(new_n126_), .b(new_n90_), .O(z07));
  ...
  nand3  g060(.a(new_n143_), .b(new_n90_), .c(new_n84_), .O(new_n144_));
  ...
  nor2   g067(.a(x12), .b(x08), .O(new_n151_));
  oai21  g068(.a(new_n151_), .b(x25), .c(x24), .O(new_n152_));
  ...
  nand2  g079(.a(new_n162_), .b(new_n90_), .O(z15));
  ...
  nand3  g145(.a(new_n228_), .b(new_n90_), .c(new_n84_), .O(new_n229_));
  ...
  nand3  g150(.a(new_n233_), .b(new_n90_), .c(new_n84_), .O(new_n234_));
  ...
  nand2  g157(.a(new_n240_), .b(new_n90_), .O(z31));
  ...
  nand2  g163(.a(new_n246_), .b(new_n90_), .O(z32));
