...
module FAU ( 
  ...
  nand2  g027(.a(x16), .b(new_n102_), .O(new_n111_));
  ...
  nand3  g046(.a(x22), .b(new_n84_), .c(new_n113_), .O(new_n130_));
  ...
  nor2   g100(.a(new_n183_), .b(x09), .O(new_n184_));
  aoi21  g101(.a(new_n182_), .b(x09), .c(new_n184_), .O(new_n185_));
  oai21  g102(.a(new_n185_), .b(x10), .c(new_n89_), .O(z27));
  inv1   g103(.a(x14), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(x09), .c(new_n180_), .O(new_n188_));
  ...
  nand2  g131(.a(new_n205_), .b(x44), .O(new_n215_));
  nand3  g132(.a(x45), .b(new_n187_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z33));
  inv1   g134(.a(x45), .O(new_n218_));
  aoi21  g135(.a(new_n187_), .b(x09), .c(new_n218_), .O(new_n219_));
  nand3  g136(.a(x46), .b(new_n187_), .c(x09), .O(new_n220_));
  inv1   g137(.a(new_n220_), .O(new_n221_));
  oai21  g138(.a(new_n221_), .b(new_n219_), .c(new_n84_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n89_), .O(z34));
  inv1   g140(.a(x46), .O(new_n224_));
  aoi21  g141(.a(new_n187_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(new_n187_), .b(x09), .c(x00), .O(new_n226_));
