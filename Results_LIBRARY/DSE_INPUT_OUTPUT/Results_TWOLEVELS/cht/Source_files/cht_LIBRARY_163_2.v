...
module FAU ( 
  ...
  nand2  g084(.a(new_n167_), .b(new_n90_), .O(z20));
  ...
  nand2  g093(.a(new_n176_), .b(new_n90_), .O(z22));
  ...
  nand2  g112(.a(x38), .b(new_n169_), .O(new_n196_));
  ...
  nand2  g124(.a(new_n198_), .b(x42), .O(new_n208_));
  nand3  g125(.a(x43), .b(new_n99_), .c(x09), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z31));
  nand2  g127(.a(new_n198_), .b(x43), .O(new_n211_));
  nand3  g128(.a(x44), .b(new_n99_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z32));
  nand2  g130(.a(new_n198_), .b(x44), .O(new_n214_));
  ...
  nand3  g135(.a(x46), .b(new_n99_), .c(x09), .O(new_n219_));
