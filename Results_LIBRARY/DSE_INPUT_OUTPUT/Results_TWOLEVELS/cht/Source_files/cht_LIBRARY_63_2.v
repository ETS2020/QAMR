...
module FAU ( 
  ...
  aoi21  g028(.a(new_n111_), .b(new_n84_), .c(x10), .O(z07));
  ...
  and2   g080(.a(new_n163_), .b(new_n85_), .O(z25));
  ...
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n85_), .O(new_n175_));
  ...
  aoi21  g130(.a(new_n177_), .b(x00), .c(x08), .O(new_n214_));
