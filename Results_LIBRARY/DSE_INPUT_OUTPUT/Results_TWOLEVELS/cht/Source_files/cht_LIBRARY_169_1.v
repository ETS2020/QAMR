...
module FAU ( 
  ...
  nand2  g088(.a(x35), .b(new_n161_), .O(new_n172_));
  ...
  nand2  g105(.a(new_n101_), .b(x09), .O(new_n189_));
  ...
  nand3  g110(.a(x41), .b(new_n101_), .c(x09), .O(new_n194_));
  ...
  nand3  g114(.a(x42), .b(new_n101_), .c(x09), .O(new_n198_));
  ...
  nand2  g124(.a(new_n189_), .b(x43), .O(new_n208_));
  nand3  g125(.a(x44), .b(new_n101_), .c(x09), .O(new_n209_));
  ...
  nand3  g138(.a(new_n101_), .b(x09), .c(x00), .O(new_n222_));
