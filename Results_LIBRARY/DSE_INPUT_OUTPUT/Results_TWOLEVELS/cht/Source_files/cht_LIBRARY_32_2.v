...
module FAU ( 
  ...
  aoi21  g131(.a(new_n202_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  aoi21  g137(.a(new_n202_), .b(x09), .c(new_n220_), .O(new_n221_));
  nand3  g138(.a(x43), .b(new_n202_), .c(x09), .O(new_n222_));
  inv1   g139(.a(new_n222_), .O(new_n223_));
  oai21  g140(.a(new_n223_), .b(new_n221_), .c(new_n84_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n90_), .O(z31));
  inv1   g142(.a(x43), .O(new_n226_));
  aoi21  g143(.a(new_n202_), .b(x09), .c(new_n226_), .O(new_n227_));
  nand3  g144(.a(x44), .b(new_n202_), .c(x09), .O(new_n228_));
  inv1   g145(.a(new_n228_), .O(new_n229_));
  oai21  g146(.a(new_n229_), .b(new_n227_), .c(new_n84_), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n90_), .O(z32));
  nand2  g148(.a(new_n202_), .b(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(x44), .O(new_n233_));
  nand3  g150(.a(x45), .b(new_n202_), .c(x09), .O(new_n234_));
  ...
  aoi21  g156(.a(new_n202_), .b(x09), .c(new_n239_), .O(new_n240_));
  nand3  g157(.a(new_n202_), .b(x09), .c(x00), .O(new_n241_));
