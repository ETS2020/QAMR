...
module FAU ( 
  ...
  nand3  g020(.a(new_n103_), .b(new_n92_), .c(x08), .O(new_n104_));
  ...
  nor3   g055(.a(x10), .b(new_n86_), .c(new_n138_), .O(z19));
  ...
  nand3  g086(.a(new_n169_), .b(new_n92_), .c(x08), .O(new_n170_));
  ...
  nand3  g100(.a(new_n183_), .b(new_n92_), .c(x08), .O(new_n184_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n92_), .c(x08), .O(new_n203_));
  ...
  oai21  g131(.a(new_n180_), .b(new_n138_), .c(new_n214_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n92_), .c(x08), .O(new_n216_));
