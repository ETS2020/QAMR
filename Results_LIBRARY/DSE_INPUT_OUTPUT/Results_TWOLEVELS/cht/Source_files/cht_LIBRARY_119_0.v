...
module FAU ( 
  ...
  oai21  g047(.a(new_n88_), .b(x08), .c(new_n87_), .O(new_n131_));
  nand2  g048(.a(new_n131_), .b(x20), .O(new_n132_));
  nand2  g049(.a(x21), .b(x08), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(new_n132_), .c(x10), .O(z09));
  oai21  g051(.a(x22), .b(new_n116_), .c(x21), .O(new_n135_));
  nand3  g052(.a(x40), .b(x22), .c(x08), .O(new_n136_));
  ...
  oai21  g135(.a(new_n218_), .b(x40), .c(x39), .O(new_n219_));
  nand3  g136(.a(x40), .b(new_n102_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z28));
  aoi21  g138(.a(new_n102_), .b(x09), .c(new_n88_), .O(new_n222_));
  ...
  nand2  g142(.a(new_n225_), .b(new_n89_), .O(z29));
  ...
  oai21  g168(.a(new_n251_), .b(new_n249_), .c(new_n91_), .O(new_n252_));
