...
module FAU ( 
  ...
  nand2  g030(.a(new_n111_), .b(x21), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z09));
  nand2  g032(.a(new_n111_), .b(x22), .O(new_n116_));
  ...
  nand2  g038(.a(new_n111_), .b(x25), .O(new_n122_));
  ...
  nand3  g055(.a(new_n138_), .b(new_n84_), .c(x08), .O(new_n139_));
  ...
  nand3  g060(.a(new_n143_), .b(new_n142_), .c(x08), .O(new_n144_));
  and2   g061(.a(new_n144_), .b(new_n84_), .O(z21));
  inv1   g062(.a(x33), .O(new_n146_));
  nand2  g063(.a(x34), .b(x09), .O(new_n147_));
  oai21  g064(.a(new_n146_), .b(x09), .c(new_n147_), .O(new_n148_));
  nand3  g065(.a(new_n148_), .b(new_n84_), .c(x08), .O(new_n149_));
  ...
  and2   g070(.a(new_n153_), .b(new_n84_), .O(z23));
  ...
  aoi21  g089(.a(x38), .b(new_n141_), .c(new_n92_), .O(new_n173_));
  ...
  nand3  g095(.a(new_n178_), .b(new_n84_), .c(x08), .O(new_n179_));
  ...
  aoi21  g130(.a(new_n213_), .b(x00), .c(new_n92_), .O(new_n214_));
