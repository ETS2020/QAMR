...
module FAU ( 
  ...
  and2   g110(.a(new_n193_), .b(new_n89_), .O(z27));
  ...
  nand2  g131(.a(x44), .b(new_n191_), .O(new_n215_));
  ...
  nand2  g135(.a(x45), .b(new_n191_), .O(new_n219_));
  ...
  nand2  g139(.a(x46), .b(new_n191_), .O(new_n223_));
  nand3  g140(.a(new_n223_), .b(new_n222_), .c(x09), .O(new_n224_));
  and2   g141(.a(new_n224_), .b(new_n89_), .O(z34));
  ...
  and2   g145(.a(new_n228_), .b(new_n89_), .O(z35));
endmodule
