...
module FAU ( 
  ...
  aoi21  g053(.a(x25), .b(x08), .c(new_n86_), .O(new_n137_));
  ...
  aoi21  g074(.a(x30), .b(new_n107_), .c(new_n86_), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z19));
  nor2   g076(.a(x32), .b(new_n86_), .O(new_n160_));
  aoi21  g077(.a(new_n160_), .b(x09), .c(x10), .O(z20));
  inv1   g078(.a(x09), .O(new_n162_));
  nand2  g079(.a(x32), .b(new_n162_), .O(new_n163_));
  nand2  g080(.a(x33), .b(x09), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(new_n163_), .c(x31), .O(new_n165_));
  and2   g082(.a(new_n165_), .b(new_n101_), .O(z21));
  nand2  g083(.a(x33), .b(new_n162_), .O(new_n167_));
  nand2  g084(.a(x34), .b(x09), .O(new_n168_));
  nand3  g085(.a(new_n168_), .b(new_n167_), .c(x31), .O(new_n169_));
  and2   g086(.a(new_n169_), .b(new_n101_), .O(z22));
  nand2  g087(.a(x34), .b(new_n162_), .O(new_n171_));
  nand2  g088(.a(x35), .b(x09), .O(new_n172_));
  nand3  g089(.a(new_n172_), .b(new_n171_), .c(x31), .O(new_n173_));
  and2   g090(.a(new_n173_), .b(new_n101_), .O(z23));
  nand2  g091(.a(x35), .b(new_n162_), .O(new_n175_));
  nand2  g092(.a(x36), .b(x09), .O(new_n176_));
  nand3  g093(.a(new_n176_), .b(new_n175_), .c(x31), .O(new_n177_));
  and2   g094(.a(new_n177_), .b(new_n101_), .O(z24));
  inv1   g095(.a(x36), .O(new_n179_));
  nand2  g096(.a(x37), .b(x09), .O(new_n180_));
  oai21  g097(.a(new_n179_), .b(x09), .c(new_n180_), .O(new_n181_));
  nand3  g098(.a(new_n181_), .b(x31), .c(new_n101_), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z25));
  nand2  g100(.a(x37), .b(new_n162_), .O(new_n184_));
  nand2  g101(.a(x38), .b(x09), .O(new_n185_));
  nand3  g102(.a(new_n185_), .b(new_n184_), .c(x31), .O(new_n186_));
  and2   g103(.a(new_n186_), .b(new_n101_), .O(z26));
  ...
  oai21  g110(.a(new_n193_), .b(new_n191_), .c(x31), .O(new_n194_));
  ...
  nand3  g131(.a(new_n214_), .b(x31), .c(new_n101_), .O(new_n215_));
  ...
  nand3  g136(.a(new_n219_), .b(x31), .c(new_n101_), .O(new_n220_));
  ...
  nand3  g145(.a(new_n228_), .b(x31), .c(new_n101_), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(z34));
  nand2  g147(.a(new_n196_), .b(x46), .O(new_n231_));
  aoi21  g148(.a(new_n202_), .b(x00), .c(new_n86_), .O(new_n232_));
