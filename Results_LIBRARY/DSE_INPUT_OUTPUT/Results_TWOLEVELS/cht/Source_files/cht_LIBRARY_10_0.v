...
module FAU ( 
  ...
  nand3  g024(.a(new_n107_), .b(new_n89_), .c(x08), .O(new_n108_));
  ...
  and2   g071(.a(new_n154_), .b(new_n89_), .O(z22));
  ...
  and2   g080(.a(new_n163_), .b(new_n89_), .O(z24));
  ...
  and2   g084(.a(new_n167_), .b(new_n89_), .O(z25));
  ...
  nand3  g088(.a(new_n171_), .b(new_n89_), .c(x08), .O(new_n172_));
  inv1   g089(.a(new_n172_), .O(z26));
  nand2  g090(.a(x14), .b(x00), .O(new_n174_));
  nand2  g091(.a(x39), .b(new_n100_), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(new_n142_), .O(new_n176_));
  nor2   g093(.a(new_n169_), .b(x09), .O(new_n177_));
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(new_n89_), .O(new_n178_));
  ...
  inv1   g102(.a(new_n180_), .O(new_n186_));
  ...
  nand3  g112(.a(x43), .b(new_n100_), .c(x09), .O(new_n196_));
  oai21  g113(.a(new_n186_), .b(new_n192_), .c(new_n196_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n89_), .c(x08), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z31));
  nand2  g116(.a(new_n180_), .b(x43), .O(new_n200_));
  nand3  g117(.a(x44), .b(new_n100_), .c(x09), .O(new_n201_));
  nand2  g118(.a(new_n201_), .b(new_n200_), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(new_n89_), .c(x08), .O(new_n203_));
  ...
  nand3  g124(.a(new_n207_), .b(new_n89_), .c(x08), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(z33));
  nand2  g126(.a(new_n180_), .b(x45), .O(new_n210_));
  ...
  nand2  g131(.a(new_n180_), .b(x46), .O(new_n215_));
  oai21  g132(.a(new_n180_), .b(new_n140_), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n89_), .c(x08), .O(new_n217_));
