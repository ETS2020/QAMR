...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x22), .O(new_n86_));
  ...
  nand3  g054(.a(new_n137_), .b(x38), .c(x22), .O(new_n138_));
  ...
  nor2   g120(.a(x22), .b(x09), .O(new_n204_));
  oai21  g121(.a(new_n204_), .b(x38), .c(x37), .O(new_n205_));
  ...
  nor2   g127(.a(new_n85_), .b(x09), .O(new_n211_));
