...
module FAU ( 
  ...
  nand2  g067(.a(new_n150_), .b(new_n96_), .O(z15));
  ...
  nand3  g117(.a(new_n196_), .b(x40), .c(new_n91_), .O(new_n201_));
  ...
  nand3  g123(.a(new_n196_), .b(x42), .c(new_n91_), .O(new_n207_));
  oai21  g124(.a(new_n206_), .b(new_n168_), .c(new_n207_), .O(z31));
  aoi21  g125(.a(x44), .b(new_n98_), .c(x10), .O(new_n209_));
  nand3  g126(.a(new_n196_), .b(x43), .c(new_n91_), .O(new_n210_));
  ...
  aoi21  g134(.a(new_n98_), .b(x00), .c(x10), .O(new_n218_));
  nand3  g135(.a(new_n196_), .b(x46), .c(new_n91_), .O(new_n219_));
