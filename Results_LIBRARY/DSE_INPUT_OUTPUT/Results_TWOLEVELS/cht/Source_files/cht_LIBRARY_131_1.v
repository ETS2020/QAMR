...
module FAU ( 
  ...
  nand2  g052(.a(x23), .b(new_n117_), .O(new_n136_));
  nand2  g053(.a(x24), .b(x08), .O(new_n137_));
  aoi21  g054(.a(new_n137_), .b(new_n136_), .c(x10), .O(z12));
  nand2  g055(.a(x24), .b(new_n117_), .O(new_n139_));
  ...
  aoi21  g125(.a(new_n203_), .b(x09), .c(new_n208_), .O(new_n209_));
  nand3  g126(.a(x41), .b(new_n203_), .c(x09), .O(new_n210_));
  ...
  nand3  g138(.a(x43), .b(new_n203_), .c(x09), .O(new_n222_));
  ...
  nand3  g143(.a(x44), .b(new_n203_), .c(x09), .O(new_n227_));
  ...
  aoi21  g155(.a(new_n203_), .b(x09), .c(new_n238_), .O(new_n239_));
