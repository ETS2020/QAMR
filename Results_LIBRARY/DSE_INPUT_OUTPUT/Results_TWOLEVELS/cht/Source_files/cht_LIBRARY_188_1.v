...
module FAU ( 
  ...
  nand3  g027(.a(new_n110_), .b(new_n84_), .c(new_n94_), .O(new_n111_));
  ...
  nand3  g037(.a(new_n120_), .b(new_n84_), .c(new_n94_), .O(new_n121_));
  ...
  nand3  g054(.a(new_n137_), .b(new_n84_), .c(new_n94_), .O(new_n138_));
  ...
  nand3  g063(.a(new_n146_), .b(new_n84_), .c(new_n94_), .O(new_n147_));
  ...
  nand3  g081(.a(new_n164_), .b(new_n84_), .c(new_n94_), .O(new_n165_));
  inv1   g082(.a(new_n165_), .O(z18));
  nand2  g083(.a(x08), .b(x00), .O(new_n167_));
  aoi21  g084(.a(x30), .b(new_n113_), .c(x11), .O(new_n168_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n84_), .c(new_n94_), .O(new_n192_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n84_), .c(new_n94_), .O(new_n201_));
  ...
  oai21  g123(.a(new_n206_), .b(new_n205_), .c(new_n84_), .O(new_n207_));
  ...
  nand3  g129(.a(new_n212_), .b(new_n84_), .c(new_n94_), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x11), .O(new_n218_));
  ...
  nand3  g139(.a(new_n222_), .b(new_n84_), .c(new_n94_), .O(new_n223_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n84_), .c(new_n94_), .O(new_n228_));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(x11), .O(new_n238_));
  ...
  aoi21  g162(.a(new_n220_), .b(x00), .c(x11), .O(new_n246_));
