...
module FAU ( 
  ...
  nand2  g063(.a(new_n146_), .b(new_n94_), .O(z15));
  nand2  g064(.a(x27), .b(new_n110_), .O(new_n148_));
  ...
  nand2  g071(.a(new_n154_), .b(new_n94_), .O(z17));
  ...
  nand2  g083(.a(new_n166_), .b(new_n94_), .O(z20));
  ...
  nand2  g099(.a(new_n182_), .b(new_n94_), .O(z24));
  ...
  nand2  g104(.a(new_n187_), .b(new_n94_), .O(z25));
  ...
  nand2  g112(.a(x38), .b(new_n162_), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z27));
  aoi21  g114(.a(new_n99_), .b(x09), .c(new_n192_), .O(new_n198_));
  nand3  g115(.a(x40), .b(new_n99_), .c(x09), .O(new_n199_));
  ...
  nand2  g124(.a(new_n207_), .b(new_n94_), .O(z29));
  ...
  nand2  g130(.a(new_n213_), .b(new_n94_), .O(z30));
  nand2  g131(.a(new_n99_), .b(x09), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(x42), .O(new_n216_));
  nand3  g133(.a(x43), .b(new_n99_), .c(x09), .O(new_n217_));
  ...
  nand3  g137(.a(x44), .b(new_n99_), .c(x09), .O(new_n221_));
  ...
  nand2  g150(.a(new_n215_), .b(x46), .O(new_n234_));
  nand3  g151(.a(new_n99_), .b(x09), .c(x00), .O(new_n235_));
