...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n85_), .c(x18), .O(new_n101_));
  aoi21  g018(.a(new_n101_), .b(new_n100_), .c(x10), .O(z03));
  nand2  g019(.a(x07), .b(x02), .O(new_n103_));
  aoi21  g020(.a(x15), .b(new_n85_), .c(x18), .O(new_n104_));
  ...
  aoi21  g029(.a(new_n112_), .b(new_n89_), .c(x10), .O(z06));
  ...
  and2   g060(.a(new_n143_), .b(new_n88_), .O(z14));
  ...
  and2   g064(.a(new_n147_), .b(new_n88_), .O(z15));
  ...
  and2   g068(.a(new_n151_), .b(new_n88_), .O(z16));
  nand2  g069(.a(x28), .b(new_n111_), .O(new_n153_));
  nand2  g070(.a(x29), .b(x08), .O(new_n154_));
  nand3  g071(.a(new_n154_), .b(new_n153_), .c(new_n89_), .O(new_n155_));
  and2   g072(.a(new_n155_), .b(new_n88_), .O(z17));
  ...
  and2   g076(.a(new_n159_), .b(new_n88_), .O(z18));
  nand2  g077(.a(x08), .b(x00), .O(new_n161_));
  aoi21  g078(.a(x30), .b(new_n111_), .c(x18), .O(new_n162_));
  ...
  and2   g098(.a(new_n181_), .b(new_n88_), .O(z23));
  ...
  aoi21  g115(.a(x38), .b(new_n169_), .c(x18), .O(new_n199_));
  ...
  aoi21  g127(.a(new_n210_), .b(x09), .c(x18), .O(new_n211_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x18), .O(new_n231_));
  ...
  aoi21  g156(.a(new_n239_), .b(x00), .c(x18), .O(new_n240_));
