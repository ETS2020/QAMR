...
module FAU ( 
  ...
  nand2  g003(.a(x35), .b(x13), .O(new_n87_));
  ...
  nand3  g051(.a(new_n134_), .b(new_n87_), .c(new_n101_), .O(new_n135_));
  ...
  nand3  g056(.a(new_n139_), .b(new_n87_), .c(new_n101_), .O(new_n140_));
  ...
  nand3  g061(.a(new_n144_), .b(new_n87_), .c(new_n101_), .O(new_n145_));
  ...
  nand3  g070(.a(new_n153_), .b(new_n87_), .c(new_n101_), .O(new_n154_));
  ...
  nand3  g075(.a(new_n158_), .b(new_n87_), .c(new_n101_), .O(new_n159_));
  ...
  nand3  g080(.a(new_n163_), .b(new_n87_), .c(new_n101_), .O(new_n164_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n87_), .c(new_n101_), .O(new_n169_));
  ...
  nand3  g095(.a(new_n178_), .b(new_n87_), .c(new_n101_), .O(new_n179_));
  inv1   g096(.a(new_n179_), .O(z20));
  nand2  g097(.a(x33), .b(x09), .O(new_n181_));
  oai21  g098(.a(new_n176_), .b(x09), .c(new_n181_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n87_), .c(new_n101_), .O(new_n183_));
  ...
  nand3  g112(.a(new_n195_), .b(x35), .c(new_n93_), .O(new_n196_));
  ...
  nand3  g123(.a(new_n206_), .b(new_n87_), .c(new_n101_), .O(new_n207_));
  ...
  nand3  g140(.a(new_n223_), .b(new_n87_), .c(new_n101_), .O(new_n224_));
  ...
  nand3  g165(.a(new_n248_), .b(new_n87_), .c(new_n101_), .O(new_n249_));
