...
module FAU ( 
  ...
  oai21  g048(.a(x23), .b(x10), .c(new_n93_), .O(new_n132_));
  nand3  g049(.a(x24), .b(new_n88_), .c(x08), .O(new_n133_));
  ...
  oai21  g054(.a(x25), .b(x10), .c(new_n93_), .O(new_n138_));
  nand3  g055(.a(x26), .b(new_n88_), .c(x08), .O(new_n139_));
  ...
  nand2  g060(.a(x27), .b(new_n93_), .O(new_n144_));
  ...
  nand2  g076(.a(new_n159_), .b(new_n94_), .O(z20));
  ...
  nand2  g084(.a(x34), .b(new_n161_), .O(new_n168_));
  ...
  nand2  g092(.a(x36), .b(new_n161_), .O(new_n176_));
  ...
  aoi21  g106(.a(new_n189_), .b(x09), .c(new_n182_), .O(new_n190_));
  ...
  nand2  g110(.a(new_n193_), .b(new_n94_), .O(z28));
  ...
  nand2  g121(.a(new_n195_), .b(x43), .O(new_n205_));
  nand3  g122(.a(x44), .b(new_n189_), .c(x09), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n205_), .c(x10), .O(z32));
  nand2  g124(.a(new_n195_), .b(x44), .O(new_n208_));
  nand3  g125(.a(x45), .b(new_n189_), .c(x09), .O(new_n209_));
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(x10), .O(z33));
  nand2  g127(.a(new_n195_), .b(x45), .O(new_n211_));
  nand3  g128(.a(x46), .b(new_n189_), .c(x09), .O(new_n212_));
