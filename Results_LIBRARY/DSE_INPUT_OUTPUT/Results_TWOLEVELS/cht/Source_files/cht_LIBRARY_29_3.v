...
module FAU ( 
  ...
  nand2  g003(.a(x39), .b(x18), .O(new_n87_));
  ...
  nand3  g036(.a(new_n119_), .b(new_n117_), .c(x18), .O(new_n120_));
  ...
  nand3  g050(.a(new_n133_), .b(new_n87_), .c(new_n93_), .O(new_n134_));
  ...
  nand3  g055(.a(new_n138_), .b(new_n87_), .c(new_n93_), .O(new_n139_));
  ...
  nand3  g060(.a(new_n143_), .b(new_n87_), .c(new_n93_), .O(new_n144_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n87_), .c(new_n93_), .O(new_n149_));
  ...
  nand2  g127(.a(x39), .b(new_n121_), .O(new_n211_));
  nand2  g128(.a(new_n117_), .b(x14), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(new_n210_), .O(new_n213_));
  nand3  g130(.a(x39), .b(new_n121_), .c(new_n99_), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(x09), .O(new_n216_));
  nand3  g133(.a(new_n87_), .b(x38), .c(new_n177_), .O(new_n217_));
  ...
  oai21  g139(.a(new_n222_), .b(x10), .c(new_n87_), .O(z28));
  nand2  g140(.a(new_n219_), .b(x40), .O(new_n224_));
  ...
  oai21  g148(.a(new_n231_), .b(x10), .c(new_n87_), .O(z30));
  ...
  nand2  g154(.a(new_n219_), .b(x43), .O(new_n238_));
