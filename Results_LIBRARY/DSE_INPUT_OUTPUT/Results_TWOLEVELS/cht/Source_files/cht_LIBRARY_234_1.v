...
module FAU ( 
  ...
  nand2  g057(.a(x23), .b(new_n124_), .O(new_n141_));
  ...
  nand2  g065(.a(x25), .b(new_n124_), .O(new_n149_));
  ...
  oai21  g093(.a(x31), .b(x10), .c(new_n89_), .O(new_n177_));
  nand3  g094(.a(x32), .b(new_n84_), .c(x09), .O(new_n178_));
  ...
  oai21  g099(.a(x33), .b(x10), .c(new_n89_), .O(new_n183_));
  nand3  g100(.a(x34), .b(new_n84_), .c(x09), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(z22));
  oai21  g102(.a(x34), .b(x10), .c(new_n89_), .O(new_n186_));
  nand3  g103(.a(x35), .b(new_n84_), .c(x09), .O(new_n187_));
  ...
  nand3  g150(.a(new_n204_), .b(x09), .c(x00), .O(new_n234_));
