...
module FAU ( 
  ...
  nand2  g061(.a(x25), .b(new_n119_), .O(new_n145_));
  ...
  nand2  g068(.a(new_n151_), .b(new_n97_), .O(z15));
  nand2  g069(.a(x27), .b(new_n119_), .O(new_n153_));
  ...
  nand2  g075(.a(x29), .b(new_n119_), .O(new_n159_));
  ...
  nand2  g086(.a(x32), .b(new_n96_), .O(new_n170_));
  ...
  nand2  g101(.a(x37), .b(new_n96_), .O(new_n185_));
  ...
  oai21  g117(.a(x41), .b(x10), .c(new_n96_), .O(new_n201_));
  ...
  oai21  g126(.a(x43), .b(x10), .c(new_n96_), .O(new_n210_));
