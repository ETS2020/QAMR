...
module FAU ( 
  ...
  nand2  g047(.a(x22), .b(new_n121_), .O(new_n131_));
  ...
  nand3  g108(.a(x38), .b(new_n91_), .c(new_n166_), .O(new_n192_));
  ...
  nand3  g115(.a(new_n194_), .b(x40), .c(new_n91_), .O(new_n199_));
  oai21  g116(.a(new_n198_), .b(new_n166_), .c(new_n199_), .O(z29));
  aoi21  g117(.a(x42), .b(new_n98_), .c(x10), .O(new_n201_));
  nand3  g118(.a(new_n194_), .b(x41), .c(new_n91_), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(new_n166_), .c(new_n202_), .O(z30));
  aoi21  g120(.a(x43), .b(new_n98_), .c(x10), .O(new_n204_));
  nand3  g121(.a(new_n194_), .b(x42), .c(new_n91_), .O(new_n205_));
  ...
  nand3  g130(.a(new_n194_), .b(x45), .c(new_n91_), .O(new_n214_));
