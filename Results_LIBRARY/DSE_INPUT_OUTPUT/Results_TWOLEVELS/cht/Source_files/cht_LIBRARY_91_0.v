...
module FAU ( 
  ...
  nand2  g048(.a(new_n115_), .b(x28), .O(new_n132_));
  inv1   g049(.a(new_n132_), .O(z16));
  nand2  g050(.a(new_n115_), .b(x29), .O(new_n134_));
  inv1   g051(.a(new_n134_), .O(z17));
  nand2  g052(.a(new_n115_), .b(x30), .O(new_n136_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n84_), .c(x08), .O(new_n143_));
  ...
  and2   g065(.a(new_n148_), .b(new_n84_), .O(z21));
  ...
  nor2   g095(.a(new_n178_), .b(new_n102_), .O(z27));
  ...
  aoi21  g110(.a(new_n193_), .b(x09), .c(new_n102_), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n191_), .c(x10), .O(z30));
  inv1   g112(.a(new_n180_), .O(new_n196_));
  ...
  aoi21  g120(.a(new_n203_), .b(x09), .c(new_n102_), .O(new_n204_));
  ...
  aoi21  g125(.a(new_n208_), .b(x09), .c(new_n102_), .O(new_n209_));
  ...
  oai21  g132(.a(new_n180_), .b(new_n138_), .c(new_n215_), .O(new_n216_));
