...
module FAU ( 
  ...
  nand2  g083(.a(x30), .b(new_n114_), .O(new_n167_));
  ...
  nand2  g088(.a(x32), .b(new_n96_), .O(new_n172_));
  ...
  nand2  g094(.a(x34), .b(new_n96_), .O(new_n178_));
  ...
  nand2  g112(.a(new_n99_), .b(x09), .O(new_n196_));
  ...
  oai21  g125(.a(x42), .b(x10), .c(new_n96_), .O(new_n209_));
  ...
  oai21  g143(.a(x46), .b(x10), .c(new_n96_), .O(new_n227_));
