...
module FAU ( 
  ...
  nand2  g001(.a(x28), .b(x18), .O(new_n85_));
  ...
  nor2   g031(.a(x18), .b(x08), .O(new_n115_));
  inv1   g032(.a(x18), .O(new_n116_));
  nor2   g033(.a(x28), .b(new_n116_), .O(new_n117_));
  oai21  g034(.a(new_n117_), .b(new_n115_), .c(x17), .O(new_n118_));
  nand2  g035(.a(new_n117_), .b(x08), .O(new_n119_));
  aoi21  g036(.a(new_n119_), .b(new_n118_), .c(x10), .O(z06));
  nor2   g037(.a(new_n116_), .b(x08), .O(new_n121_));
  ...
  nand3  g084(.a(new_n167_), .b(x28), .c(new_n116_), .O(new_n168_));
  inv1   g085(.a(x28), .O(new_n169_));
  nand3  g086(.a(x29), .b(new_n169_), .c(x08), .O(new_n170_));
  aoi21  g087(.a(new_n170_), .b(new_n168_), .c(x10), .O(z17));
  nand2  g088(.a(x30), .b(x08), .O(new_n172_));
  oai21  g089(.a(new_n166_), .b(x08), .c(new_n172_), .O(new_n173_));
  ...
  nand2  g102(.a(new_n185_), .b(new_n85_), .O(z20));
  ...
  nand2  g106(.a(new_n189_), .b(new_n85_), .O(z21));
  ...
  nand2  g111(.a(new_n194_), .b(new_n85_), .O(z22));
  ...
  nand2  g129(.a(new_n212_), .b(new_n85_), .O(z26));
  nand2  g130(.a(x14), .b(x00), .O(new_n214_));
  nand2  g131(.a(x39), .b(new_n101_), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n214_), .c(new_n181_), .O(new_n216_));
  nor2   g133(.a(new_n209_), .b(x09), .O(new_n217_));
  oai21  g134(.a(new_n217_), .b(new_n216_), .c(new_n85_), .O(new_n218_));
  nor2   g135(.a(new_n218_), .b(x10), .O(z27));
  nand2  g136(.a(new_n101_), .b(x09), .O(new_n220_));
  ...
  oai21  g140(.a(new_n223_), .b(x10), .c(new_n85_), .O(z28));
  ...
  nand2  g145(.a(new_n220_), .b(x41), .O(new_n229_));
  ...
  nand2  g150(.a(new_n220_), .b(x42), .O(new_n234_));
  ...
  aoi21  g157(.a(new_n220_), .b(x43), .c(new_n240_), .O(new_n241_));
  oai21  g158(.a(new_n241_), .b(x10), .c(new_n85_), .O(z32));
  nand2  g159(.a(new_n220_), .b(x44), .O(new_n243_));
  ...
  nand2  g164(.a(new_n220_), .b(x45), .O(new_n248_));
  ...
  nand2  g170(.a(new_n220_), .b(x46), .O(new_n254_));
  oai21  g171(.a(new_n220_), .b(new_n253_), .c(new_n254_), .O(new_n255_));
