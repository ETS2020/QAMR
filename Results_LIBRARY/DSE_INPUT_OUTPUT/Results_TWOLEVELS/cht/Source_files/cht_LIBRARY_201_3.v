...
module FAU ( 
  ...
  nand2  g003(.a(x43), .b(x27), .O(new_n87_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n87_), .c(new_n93_), .O(new_n192_));
  ...
  nand2  g148(.a(new_n99_), .b(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(x43), .c(new_n158_), .O(new_n234_));
  inv1   g151(.a(x43), .O(new_n235_));
  nand3  g152(.a(new_n232_), .b(new_n235_), .c(x42), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(new_n234_), .c(x10), .O(z31));
  aoi21  g154(.a(new_n99_), .b(x09), .c(new_n235_), .O(new_n238_));
