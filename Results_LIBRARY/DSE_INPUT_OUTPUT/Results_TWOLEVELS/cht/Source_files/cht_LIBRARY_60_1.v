...
module FAU ( 
  ...
  oai21  g035(.a(x18), .b(x10), .c(new_n89_), .O(new_n119_));
  nand3  g036(.a(x19), .b(new_n84_), .c(x08), .O(new_n120_));
  ...
  nand2  g050(.a(x23), .b(new_n89_), .O(new_n134_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n90_), .O(z30));
  ...
  nand2  g127(.a(new_n210_), .b(new_n90_), .O(z31));
