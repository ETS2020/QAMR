...
module FAU ( 
  ...
  oai21  g023(.a(new_n89_), .b(x07), .c(new_n106_), .O(new_n107_));
  ...
  oai21  g067(.a(new_n149_), .b(new_n120_), .c(new_n150_), .O(new_n151_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n90_), .O(z16));
  ...
  nand2  g086(.a(new_n169_), .b(new_n90_), .O(z18));
  nand2  g087(.a(x08), .b(x00), .O(new_n171_));
  nand2  g088(.a(x30), .b(new_n120_), .O(new_n172_));
  ...
  nand2  g095(.a(new_n178_), .b(new_n90_), .O(z20));
  ...
  nand2  g099(.a(new_n182_), .b(new_n90_), .O(z21));
  ...
  nand2  g107(.a(new_n190_), .b(new_n90_), .O(z23));
  ...
  nand2  g116(.a(x37), .b(new_n174_), .O(new_n200_));
  ...
  nand2  g123(.a(x38), .b(new_n174_), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z27));
  aoi21  g125(.a(new_n101_), .b(x09), .c(new_n203_), .O(new_n209_));
  ...
  nand2  g129(.a(new_n212_), .b(new_n90_), .O(z28));
  ...
  nand2  g148(.a(new_n101_), .b(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(x43), .O(new_n233_));
  nand3  g150(.a(x44), .b(new_n101_), .c(x09), .O(new_n234_));
  aoi21  g151(.a(new_n234_), .b(new_n233_), .c(x10), .O(z32));
  nand2  g152(.a(new_n232_), .b(x44), .O(new_n236_));
  ...
  nand3  g163(.a(new_n101_), .b(x09), .c(x00), .O(new_n247_));
