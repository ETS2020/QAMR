...
module FAU ( 
  ...
  nand2  g026(.a(x17), .b(new_n89_), .O(new_n110_));
  ...
  oai21  g038(.a(x21), .b(x10), .c(new_n89_), .O(new_n122_));
  nand3  g039(.a(x22), .b(new_n84_), .c(x08), .O(new_n123_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n90_), .O(z26));
  ...
  nand2  g121(.a(new_n204_), .b(new_n90_), .O(z31));
  ...
  nand2  g133(.a(new_n216_), .b(new_n90_), .O(z33));
