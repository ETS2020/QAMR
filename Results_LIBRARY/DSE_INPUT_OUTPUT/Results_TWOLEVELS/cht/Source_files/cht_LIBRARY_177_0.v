...
module FAU ( 
  ...
  nand3  g089(.a(new_n172_), .b(new_n87_), .c(new_n84_), .O(new_n173_));
  ...
  oai21  g115(.a(new_n85_), .b(new_n179_), .c(new_n198_), .O(new_n199_));
  nand2  g116(.a(new_n199_), .b(new_n84_), .O(new_n200_));
  nand2  g117(.a(new_n200_), .b(new_n87_), .O(z24));
  oai21  g118(.a(x37), .b(new_n179_), .c(x36), .O(new_n202_));
  nand3  g119(.a(x44), .b(x37), .c(x09), .O(new_n203_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n87_), .c(new_n84_), .O(new_n228_));
  ...
  nor2   g150(.a(x14), .b(new_n179_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(new_n85_), .c(new_n86_), .O(new_n235_));
  ...
  nand3  g155(.a(x36), .b(new_n101_), .c(x09), .O(new_n239_));
