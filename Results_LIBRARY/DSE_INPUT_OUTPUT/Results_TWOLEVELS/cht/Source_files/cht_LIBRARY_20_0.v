...
module FAU ( 
  ...
  nand3  g023(.a(new_n106_), .b(x45), .c(new_n89_), .O(new_n107_));
  ...
  nand3  g050(.a(new_n133_), .b(x45), .c(new_n89_), .O(new_n134_));
  ...
  nand3  g058(.a(new_n141_), .b(x45), .c(new_n89_), .O(new_n142_));
  ...
  nand3  g081(.a(new_n164_), .b(x45), .c(new_n89_), .O(new_n165_));
  ...
  aoi21  g088(.a(x34), .b(x09), .c(new_n86_), .O(new_n172_));
  ...
  nand3  g117(.a(new_n200_), .b(x45), .c(new_n89_), .O(new_n201_));
  ...
  nand3  g128(.a(new_n211_), .b(x45), .c(new_n89_), .O(new_n212_));
  ...
  nand2  g140(.a(new_n203_), .b(new_n220_), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(x45), .c(new_n89_), .O(new_n225_));
  inv1   g142(.a(new_n225_), .O(z33));
  nor2   g143(.a(x14), .b(new_n167_), .O(new_n227_));
  nor2   g144(.a(x46), .b(new_n86_), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z34));
  nand2  g146(.a(new_n203_), .b(x46), .O(new_n230_));
  aoi21  g147(.a(new_n227_), .b(x00), .c(new_n86_), .O(new_n231_));
