...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x29), .O(new_n86_));
  ...
  nor2   g083(.a(x29), .b(x08), .O(new_n167_));
  inv1   g084(.a(x29), .O(new_n168_));
  nor2   g085(.a(new_n85_), .b(new_n168_), .O(new_n169_));
  oai21  g086(.a(new_n169_), .b(new_n167_), .c(x28), .O(new_n170_));
  nand2  g087(.a(new_n169_), .b(x08), .O(new_n171_));
  aoi21  g088(.a(new_n171_), .b(new_n170_), .c(x10), .O(z17));
  nor2   g089(.a(new_n168_), .b(x08), .O(new_n173_));
  ...
  oai21  g097(.a(x32), .b(new_n180_), .c(x31), .O(new_n181_));
  nand3  g098(.a(x32), .b(new_n168_), .c(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n181_), .c(x10), .O(z20));
  inv1   g100(.a(x33), .O(new_n184_));
  nand2  g101(.a(x32), .b(new_n180_), .O(new_n185_));
  ...
  oai21  g111(.a(new_n193_), .b(new_n180_), .c(new_n194_), .O(new_n195_));
  ...
  nand2  g119(.a(x36), .b(new_n180_), .O(new_n203_));
  oai21  g120(.a(new_n202_), .b(new_n180_), .c(new_n203_), .O(new_n204_));
