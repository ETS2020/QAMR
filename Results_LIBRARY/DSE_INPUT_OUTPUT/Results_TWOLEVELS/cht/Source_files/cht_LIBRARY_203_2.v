...
module FAU ( 
  ...
  nand2  g064(.a(new_n147_), .b(new_n90_), .O(z12));
  ...
  nand2  g073(.a(new_n156_), .b(new_n90_), .O(z14));
  ...
  nand2  g077(.a(new_n160_), .b(new_n90_), .O(z15));
  ...
  nand2  g082(.a(new_n165_), .b(new_n90_), .O(z16));
  ...
  nand2  g091(.a(x30), .b(new_n116_), .O(new_n175_));
  ...
  nand2  g098(.a(new_n181_), .b(new_n90_), .O(z20));
  ...
  nand2  g102(.a(new_n185_), .b(new_n90_), .O(z21));
  ...
  nor2   g123(.a(new_n89_), .b(x09), .O(new_n207_));
  ...
  nand3  g128(.a(x40), .b(new_n102_), .c(x09), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z28));
  nand2  g130(.a(new_n210_), .b(x40), .O(new_n214_));
  nand3  g131(.a(x41), .b(new_n102_), .c(x09), .O(new_n215_));
  ...
  nand2  g156(.a(new_n239_), .b(new_n90_), .O(z33));
  ...
  nand2  g162(.a(new_n245_), .b(new_n90_), .O(z34));
  inv1   g163(.a(x46), .O(new_n247_));
  aoi21  g164(.a(new_n102_), .b(x09), .c(new_n247_), .O(new_n248_));
  ...
  nand2  g168(.a(new_n251_), .b(new_n90_), .O(z35));
endmodule
