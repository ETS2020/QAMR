...
module FAU ( 
  ...
  nand2  g059(.a(x24), .b(new_n118_), .O(new_n143_));
  ...
  nand2  g080(.a(x29), .b(new_n118_), .O(new_n164_));
  ...
  oai21  g118(.a(new_n199_), .b(new_n171_), .c(new_n201_), .O(z28));
  aoi21  g119(.a(x41), .b(new_n193_), .c(x10), .O(new_n203_));
  nand3  g120(.a(new_n200_), .b(x40), .c(new_n88_), .O(new_n204_));
  oai21  g121(.a(new_n203_), .b(new_n171_), .c(new_n204_), .O(z29));
  ...
  nand2  g128(.a(new_n200_), .b(x43), .O(new_n212_));
  ...
  aoi21  g134(.a(x46), .b(new_n193_), .c(x10), .O(new_n218_));
  nand3  g135(.a(new_n200_), .b(x45), .c(new_n88_), .O(new_n219_));
  oai21  g136(.a(new_n218_), .b(new_n171_), .c(new_n219_), .O(z34));
