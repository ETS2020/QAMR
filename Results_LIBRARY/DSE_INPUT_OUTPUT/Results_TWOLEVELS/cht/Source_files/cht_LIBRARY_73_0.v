...
module FAU ( 
  ...
  nand2  g098(.a(new_n181_), .b(new_n88_), .O(z21));
  ...
  aoi21  g144(.a(new_n100_), .b(x09), .c(new_n84_), .O(new_n228_));
  oai21  g145(.a(new_n228_), .b(x43), .c(x42), .O(new_n229_));
  ...
  nand2  g158(.a(new_n241_), .b(new_n88_), .O(z33));
  oai21  g159(.a(x14), .b(new_n173_), .c(x45), .O(new_n243_));
  nand3  g160(.a(x46), .b(new_n100_), .c(x09), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(new_n243_), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(new_n88_), .c(new_n90_), .O(new_n246_));
  inv1   g163(.a(new_n246_), .O(z34));
  inv1   g164(.a(x46), .O(new_n248_));
  aoi21  g165(.a(new_n100_), .b(x09), .c(new_n248_), .O(new_n249_));
  nand3  g166(.a(new_n100_), .b(x09), .c(x00), .O(new_n250_));
  inv1   g167(.a(new_n250_), .O(new_n251_));
  oai21  g168(.a(new_n251_), .b(new_n249_), .c(new_n90_), .O(new_n252_));
