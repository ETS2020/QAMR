...
module FAU ( 
  ...
  nand3  g022(.a(new_n105_), .b(x30), .c(new_n84_), .O(new_n106_));
  ...
  nand3  g042(.a(new_n125_), .b(x30), .c(new_n84_), .O(new_n126_));
  ...
  aoi21  g068(.a(x28), .b(x08), .c(new_n92_), .O(new_n152_));
  ...
  oai21  g073(.a(x29), .b(x08), .c(x30), .O(new_n157_));
  nor2   g074(.a(new_n157_), .b(x10), .O(z18));
  oai21  g075(.a(new_n111_), .b(x00), .c(x30), .O(new_n159_));
  nor2   g076(.a(new_n159_), .b(x10), .O(z19));
  inv1   g077(.a(x31), .O(new_n161_));
  nand2  g078(.a(x32), .b(x09), .O(new_n162_));
  oai21  g079(.a(new_n161_), .b(x09), .c(new_n162_), .O(new_n163_));
  nand3  g080(.a(new_n163_), .b(x30), .c(new_n84_), .O(new_n164_));
  ...
  and2   g108(.a(new_n191_), .b(new_n84_), .O(z26));
  ...
  oai21  g127(.a(x14), .b(new_n166_), .c(x41), .O(new_n211_));
  nand3  g128(.a(x42), .b(new_n200_), .c(x09), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(x30), .c(new_n84_), .O(new_n214_));
  ...
  nand3  g143(.a(x45), .b(new_n200_), .c(x09), .O(new_n227_));
  ...
  nand3  g148(.a(x46), .b(new_n200_), .c(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(x30), .c(new_n84_), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(z34));
  nand2  g152(.a(new_n205_), .b(x46), .O(new_n236_));
  nor2   g153(.a(x14), .b(new_n166_), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(x00), .c(new_n92_), .O(new_n238_));
