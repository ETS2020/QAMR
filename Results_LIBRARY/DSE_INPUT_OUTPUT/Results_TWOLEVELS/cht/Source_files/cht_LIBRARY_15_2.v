...
module FAU ( 
  ...
  nand2  g114(.a(x38), .b(new_n168_), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n197_), .c(x10), .O(z27));
  aoi21  g116(.a(new_n102_), .b(x09), .c(new_n194_), .O(new_n200_));
  nand3  g117(.a(x40), .b(new_n102_), .c(x09), .O(new_n201_));
  ...
  aoi21  g122(.a(new_n102_), .b(x09), .c(new_n205_), .O(new_n206_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n90_), .O(z32));
  nand2  g145(.a(new_n102_), .b(x09), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(x44), .O(new_n230_));
  ...
  nand3  g151(.a(x46), .b(new_n102_), .c(x09), .O(new_n235_));
  ...
  nand2  g155(.a(new_n229_), .b(x46), .O(new_n239_));
  nand3  g156(.a(new_n102_), .b(x09), .c(x00), .O(new_n240_));
