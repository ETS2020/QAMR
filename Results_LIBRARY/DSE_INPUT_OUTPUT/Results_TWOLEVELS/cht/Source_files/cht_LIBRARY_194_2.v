...
module FAU ( 
  ...
  nand2  g029(.a(new_n112_), .b(new_n94_), .O(z06));
  ...
  nand2  g033(.a(new_n116_), .b(new_n94_), .O(z07));
  ...
  nand2  g041(.a(new_n124_), .b(new_n94_), .O(z09));
  ...
  nand2  g050(.a(new_n133_), .b(new_n94_), .O(z11));
  ...
  nand2  g055(.a(x24), .b(new_n108_), .O(new_n139_));
  nand2  g056(.a(x25), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z13));
  nand2  g058(.a(x25), .b(new_n108_), .O(new_n142_));
  ...
  nand2  g066(.a(x27), .b(new_n108_), .O(new_n150_));
  nand2  g067(.a(x28), .b(x08), .O(new_n151_));
  aoi21  g068(.a(new_n151_), .b(new_n150_), .c(x10), .O(z16));
  inv1   g069(.a(x29), .O(new_n153_));
  nand2  g070(.a(x28), .b(new_n108_), .O(new_n154_));
  oai21  g071(.a(new_n153_), .b(new_n108_), .c(new_n154_), .O(new_n155_));
  ...
  nand2  g079(.a(x30), .b(new_n108_), .O(new_n163_));
  ...
  nand2  g085(.a(new_n168_), .b(new_n94_), .O(z20));
  ...
  nand2  g098(.a(new_n181_), .b(new_n94_), .O(z23));
  ...
  oai21  g114(.a(new_n197_), .b(x10), .c(new_n94_), .O(z27));
  ...
  nand2  g125(.a(new_n208_), .b(new_n94_), .O(z29));
  ...
  aoi21  g129(.a(new_n199_), .b(x09), .c(new_n93_), .O(new_n213_));
  ...
  nand2  g143(.a(new_n200_), .b(x45), .O(new_n227_));
  nand3  g144(.a(x46), .b(new_n199_), .c(x09), .O(new_n228_));
