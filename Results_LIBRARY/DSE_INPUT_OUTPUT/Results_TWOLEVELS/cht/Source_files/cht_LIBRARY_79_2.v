...
module FAU ( 
  ...
  nand2  g053(.a(x22), .b(new_n114_), .O(new_n137_));
  ...
  nand2  g060(.a(new_n143_), .b(new_n94_), .O(z12));
  ...
  nand2  g068(.a(new_n151_), .b(new_n94_), .O(z14));
  ...
  nand2  g093(.a(new_n176_), .b(new_n94_), .O(z20));
  ...
  nand2  g102(.a(new_n185_), .b(new_n94_), .O(z22));
  ...
  nand2  g120(.a(x38), .b(new_n178_), .O(new_n204_));
  ...
  nand2  g131(.a(new_n214_), .b(new_n94_), .O(z29));
  ...
  nand3  g136(.a(x43), .b(new_n99_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z31));
  nand2  g138(.a(new_n206_), .b(x43), .O(new_n222_));
  nand3  g139(.a(x44), .b(new_n99_), .c(x09), .O(new_n223_));
  ...
  nand2  g149(.a(new_n232_), .b(new_n94_), .O(z34));
