...
module FAU ( 
  ...
  oai21  g090(.a(new_n93_), .b(new_n169_), .c(new_n173_), .O(new_n174_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n94_), .O(z30));
  ...
  nand2  g150(.a(new_n233_), .b(new_n94_), .O(z34));
  ...
  oai21  g155(.a(new_n238_), .b(new_n236_), .c(new_n88_), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(new_n94_), .O(z35));
endmodule
