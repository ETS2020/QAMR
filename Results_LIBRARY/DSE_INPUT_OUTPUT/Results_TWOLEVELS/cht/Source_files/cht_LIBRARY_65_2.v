...
module FAU ( 
  ...
  nand2  g047(.a(new_n130_), .b(new_n94_), .O(z09));
  ...
  nand2  g052(.a(new_n135_), .b(new_n94_), .O(z10));
  ...
  nand2  g077(.a(x28), .b(new_n119_), .O(new_n161_));
  oai21  g078(.a(new_n160_), .b(new_n119_), .c(new_n161_), .O(new_n162_));
  ...
  nand2  g084(.a(new_n167_), .b(new_n94_), .O(z18));
  nand2  g085(.a(x08), .b(x00), .O(new_n169_));
  nand2  g086(.a(x30), .b(new_n119_), .O(new_n170_));
  ...
  nand2  g096(.a(new_n179_), .b(new_n94_), .O(z21));
  ...
  oai21  g102(.a(new_n93_), .b(new_n172_), .c(new_n185_), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(new_n88_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n94_), .O(z23));
  ...
  oai21  g120(.a(new_n203_), .b(x10), .c(new_n94_), .O(z27));
