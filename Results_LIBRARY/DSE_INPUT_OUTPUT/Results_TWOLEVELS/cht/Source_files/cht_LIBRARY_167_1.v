...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n92_), .c(x30), .O(new_n101_));
  ...
  aoi21  g025(.a(x16), .b(new_n92_), .c(x30), .O(new_n109_));
  ...
  aoi21  g053(.a(x24), .b(x08), .c(x30), .O(new_n137_));
  ...
  aoi21  g113(.a(x38), .b(new_n166_), .c(x30), .O(new_n197_));
  ...
  aoi21  g125(.a(new_n208_), .b(x09), .c(x30), .O(new_n209_));
  ...
  aoi21  g140(.a(new_n223_), .b(x09), .c(x30), .O(new_n224_));
  ...
  aoi21  g154(.a(new_n237_), .b(x00), .c(x30), .O(new_n238_));
