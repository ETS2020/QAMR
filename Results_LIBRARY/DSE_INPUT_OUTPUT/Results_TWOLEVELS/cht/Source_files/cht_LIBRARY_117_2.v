...
module FAU ( 
  ...
  aoi21  g093(.a(new_n176_), .b(new_n84_), .c(x10), .O(z21));
  inv1   g094(.a(x33), .O(new_n178_));
  aoi21  g095(.a(new_n178_), .b(new_n84_), .c(x10), .O(z22));
  inv1   g096(.a(x34), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n84_), .c(x10), .O(z23));
  inv1   g098(.a(x35), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n84_), .c(x10), .O(z24));
  nor2   g100(.a(x10), .b(x09), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(x36), .O(new_n185_));
  ...
  nand2  g107(.a(new_n184_), .b(x39), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z28));
  nand2  g109(.a(new_n184_), .b(x40), .O(new_n193_));
  ...
  nand2  g115(.a(new_n184_), .b(x43), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  nand2  g117(.a(new_n184_), .b(x44), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z33));
  nand2  g119(.a(new_n184_), .b(x45), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  nand2  g121(.a(new_n184_), .b(x46), .O(new_n205_));
