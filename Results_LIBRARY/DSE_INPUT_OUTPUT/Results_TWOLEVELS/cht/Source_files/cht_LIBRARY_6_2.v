...
module FAU ( 
  ...
  nand2  g028(.a(new_n111_), .b(new_n94_), .O(z06));
  ...
  nand2  g055(.a(new_n138_), .b(new_n94_), .O(z14));
  nand2  g056(.a(x26), .b(new_n113_), .O(new_n140_));
  ...
  nand2  g063(.a(new_n146_), .b(new_n94_), .O(z16));
  ...
  nand2  g071(.a(x30), .b(new_n113_), .O(new_n155_));
  ...
  aoi21  g125(.a(new_n193_), .b(x09), .c(new_n93_), .O(new_n209_));
