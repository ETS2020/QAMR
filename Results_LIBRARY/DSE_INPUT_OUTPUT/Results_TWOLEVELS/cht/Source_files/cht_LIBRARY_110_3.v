...
module FAU ( 
  ...
  nand2  g003(.a(x45), .b(x27), .O(new_n87_));
  ...
  nor2   g072(.a(x45), .b(new_n155_), .O(new_n156_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n93_), .O(new_n206_));
  ...
  nand3  g155(.a(new_n238_), .b(x45), .c(new_n155_), .O(new_n239_));
  inv1   g156(.a(x45), .O(new_n240_));
  nand3  g157(.a(new_n214_), .b(new_n240_), .c(x44), .O(new_n241_));
  aoi21  g158(.a(new_n241_), .b(new_n239_), .c(x10), .O(z33));
  nand3  g159(.a(new_n240_), .b(new_n99_), .c(x09), .O(new_n243_));
  oai21  g160(.a(new_n240_), .b(x27), .c(new_n243_), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(x46), .O(new_n245_));
  nand3  g162(.a(new_n214_), .b(x45), .c(new_n155_), .O(new_n246_));
