...
module FAU ( 
  ...
  nand2  g009(.a(x44), .b(x10), .O(new_n93_));
  ...
  nand2  g081(.a(x30), .b(new_n113_), .O(new_n165_));
  ...
  nand2  g107(.a(new_n190_), .b(new_n93_), .O(z25));
  ...
  nand3  g132(.a(new_n202_), .b(x43), .c(new_n88_), .O(new_n216_));
  aoi21  g133(.a(new_n100_), .b(x09), .c(x10), .O(new_n217_));
  oai21  g134(.a(new_n217_), .b(new_n215_), .c(new_n216_), .O(z32));
  nand2  g135(.a(new_n202_), .b(x44), .O(new_n219_));
  nand3  g136(.a(x45), .b(new_n100_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z33));
  nand2  g138(.a(new_n202_), .b(x45), .O(new_n222_));
  ...
  nand2  g146(.a(new_n229_), .b(new_n93_), .O(z35));
endmodule
