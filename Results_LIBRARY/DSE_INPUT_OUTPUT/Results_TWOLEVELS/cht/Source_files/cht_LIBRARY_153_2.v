...
module FAU ( 
  ...
  oai21  g013(.a(new_n89_), .b(x07), .c(new_n96_), .O(new_n97_));
  ...
  nand2  g025(.a(x16), .b(new_n93_), .O(new_n109_));
  ...
  nand2  g105(.a(x35), .b(new_n175_), .O(new_n189_));
  oai21  g106(.a(new_n188_), .b(new_n175_), .c(new_n189_), .O(new_n190_));
  ...
  nand2  g122(.a(x38), .b(new_n175_), .O(new_n206_));
  ...
  nand2  g128(.a(new_n211_), .b(new_n90_), .O(z28));
  ...
  nand3  g141(.a(x43), .b(new_n100_), .c(x09), .O(new_n225_));
  ...
  nand2  g163(.a(new_n219_), .b(x46), .O(new_n247_));
  nand3  g164(.a(new_n100_), .b(x09), .c(x00), .O(new_n248_));
