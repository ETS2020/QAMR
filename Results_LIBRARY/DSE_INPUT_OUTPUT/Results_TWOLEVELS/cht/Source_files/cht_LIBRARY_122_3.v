...
module FAU ( 
  ...
  nand2  g079(.a(new_n162_), .b(new_n89_), .O(z17));
  ...
  nand2  g086(.a(x30), .b(new_n113_), .O(new_n170_));
  ...
  nand3  g093(.a(x32), .b(new_n84_), .c(new_n172_), .O(new_n177_));
  nand2  g094(.a(new_n177_), .b(new_n176_), .O(z21));
  oai21  g095(.a(x34), .b(x10), .c(x09), .O(new_n179_));
  nand3  g096(.a(x33), .b(new_n84_), .c(new_n172_), .O(new_n180_));
  ...
  nand3  g105(.a(x36), .b(new_n84_), .c(new_n172_), .O(new_n189_));
  ...
  nand3  g114(.a(x38), .b(new_n84_), .c(new_n172_), .O(new_n198_));
  ...
  nand3  g118(.a(new_n201_), .b(x39), .c(new_n84_), .O(new_n202_));
  oai21  g119(.a(new_n200_), .b(new_n172_), .c(new_n202_), .O(z28));
  ...
  aoi21  g123(.a(x42), .b(new_n100_), .c(x10), .O(new_n207_));
  nand3  g124(.a(new_n201_), .b(x41), .c(new_n84_), .O(new_n208_));
  oai21  g125(.a(new_n207_), .b(new_n172_), .c(new_n208_), .O(z30));
  ...
  nand2  g129(.a(new_n201_), .b(x43), .O(new_n213_));
  ...
  aoi21  g135(.a(x46), .b(new_n100_), .c(x10), .O(new_n219_));
  nand3  g136(.a(new_n201_), .b(x45), .c(new_n84_), .O(new_n220_));
  oai21  g137(.a(new_n219_), .b(new_n172_), .c(new_n220_), .O(z34));
  aoi21  g138(.a(new_n100_), .b(x00), .c(x10), .O(new_n222_));
  nand3  g139(.a(new_n201_), .b(x46), .c(new_n84_), .O(new_n223_));
  oai21  g140(.a(new_n222_), .b(new_n172_), .c(new_n223_), .O(z35));
endmodule
