...
module FAU ( 
  ...
  nand2  g002(.a(x20), .b(new_n85_), .O(new_n86_));
  ...
  nand3  g018(.a(new_n101_), .b(new_n86_), .c(new_n84_), .O(new_n102_));
  ...
  nand2  g034(.a(new_n117_), .b(new_n86_), .O(z06));
  ...
  nand3  g041(.a(new_n124_), .b(x20), .c(x13), .O(new_n125_));
  ...
  nand3  g047(.a(new_n130_), .b(x20), .c(x13), .O(new_n131_));
  ...
  nand2  g071(.a(new_n154_), .b(new_n86_), .O(z14));
  ...
  nand2  g085(.a(new_n168_), .b(new_n86_), .O(z17));
  ...
  nand2  g089(.a(new_n172_), .b(new_n86_), .O(z18));
  ...
  nand2  g094(.a(new_n177_), .b(new_n86_), .O(z19));
  ...
  oai21  g163(.a(new_n246_), .b(x10), .c(new_n86_), .O(z33));
  ...
  oai21  g167(.a(new_n250_), .b(x10), .c(new_n86_), .O(z34));
