...
module FAU ( 
  ...
  nand2  g050(.a(x21), .b(new_n120_), .O(new_n134_));
  ...
  nand2  g063(.a(x24), .b(new_n120_), .O(new_n147_));
  ...
  aoi21  g091(.a(x30), .b(new_n120_), .c(new_n112_), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z19));
  nand3  g093(.a(x32), .b(new_n84_), .c(x09), .O(new_n177_));
  ...
  nand3  g101(.a(x36), .b(new_n84_), .c(x09), .O(new_n185_));
  ...
  nand2  g112(.a(x40), .b(new_n100_), .O(new_n196_));
  ...
  nand2  g116(.a(x41), .b(new_n100_), .O(new_n200_));
  ...
  nand2  g120(.a(x42), .b(new_n100_), .O(new_n204_));
  ...
  nand2  g124(.a(x43), .b(new_n100_), .O(new_n208_));
  ...
  nand2  g138(.a(x46), .b(new_n100_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(x09), .O(new_n223_));
  and2   g140(.a(new_n223_), .b(new_n84_), .O(z34));
