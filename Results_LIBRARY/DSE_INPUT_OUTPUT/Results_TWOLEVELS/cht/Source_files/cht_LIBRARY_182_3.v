...
module FAU ( 
  ...
  nand2  g003(.a(x42), .b(x23), .O(new_n87_));
  ...
  nand3  g074(.a(new_n157_), .b(new_n87_), .c(new_n89_), .O(new_n158_));
  ...
  nand3  g135(.a(new_n218_), .b(new_n87_), .c(new_n89_), .O(new_n219_));
  ...
  oai21  g146(.a(new_n229_), .b(new_n227_), .c(new_n89_), .O(new_n230_));
  ...
  oai21  g158(.a(new_n241_), .b(new_n239_), .c(new_n89_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n87_), .O(z32));
