...
module FAU ( 
  ...
  nand3  g022(.a(new_n105_), .b(new_n92_), .c(x09), .O(new_n106_));
  inv1   g023(.a(new_n106_), .O(z04));
  inv1   g024(.a(x16), .O(new_n108_));
  nand2  g025(.a(x07), .b(x03), .O(new_n109_));
  oai21  g026(.a(new_n108_), .b(x07), .c(new_n109_), .O(new_n110_));
  nand3  g027(.a(new_n110_), .b(new_n92_), .c(x09), .O(new_n111_));
  ...
  and2   g042(.a(new_n125_), .b(new_n92_), .O(z08));
  ...
  nand3  g051(.a(new_n134_), .b(new_n92_), .c(x09), .O(new_n135_));
  ...
  and2   g061(.a(new_n144_), .b(new_n92_), .O(z12));
  ...
  nand3  g075(.a(new_n158_), .b(new_n92_), .c(x09), .O(new_n159_));
  ...
  and2   g080(.a(new_n163_), .b(new_n92_), .O(z16));
  ...
  nand3  g094(.a(new_n177_), .b(new_n92_), .c(x09), .O(new_n178_));
  ...
  nand3  g108(.a(x38), .b(new_n92_), .c(x09), .O(new_n192_));
  ...
  nand2  g116(.a(x39), .b(x14), .O(new_n200_));
  ...
  nand2  g121(.a(x41), .b(new_n98_), .O(new_n205_));
  nand3  g122(.a(new_n205_), .b(new_n204_), .c(x09), .O(new_n206_));
  and2   g123(.a(new_n206_), .b(new_n92_), .O(z29));
  ...
  nand3  g151(.a(new_n234_), .b(new_n92_), .c(x09), .O(new_n235_));
