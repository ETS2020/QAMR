...
module FAU ( 
  ...
  nand2  g082(.a(x30), .b(new_n112_), .O(new_n166_));
  ...
  aoi21  g139(.a(new_n204_), .b(x09), .c(new_n222_), .O(new_n223_));
  ...
  aoi21  g145(.a(new_n204_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(x44), .b(new_n204_), .c(x09), .O(new_n230_));
  ...
  aoi21  g151(.a(new_n204_), .b(x09), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(x45), .b(new_n204_), .c(x09), .O(new_n236_));
  inv1   g153(.a(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(new_n235_), .c(new_n84_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n90_), .O(z33));
  nand2  g156(.a(new_n204_), .b(x09), .O(new_n240_));
  ...
  nand3  g161(.a(new_n204_), .b(x09), .c(x00), .O(new_n245_));
