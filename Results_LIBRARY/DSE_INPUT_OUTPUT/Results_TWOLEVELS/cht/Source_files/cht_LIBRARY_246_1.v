...
module FAU ( 
  ...
  oai21  g050(.a(x23), .b(x10), .c(new_n93_), .O(new_n134_));
  nand3  g051(.a(x24), .b(new_n88_), .c(x08), .O(new_n135_));
  ...
  aoi21  g106(.a(new_n101_), .b(x09), .c(new_n183_), .O(new_n190_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n94_), .O(z33));
