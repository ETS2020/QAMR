...
module FAU ( 
  ...
  oai21  g031(.a(x10), .b(new_n112_), .c(x18), .O(new_n115_));
  ...
  nand2  g047(.a(x23), .b(new_n112_), .O(new_n131_));
  oai21  g048(.a(new_n130_), .b(new_n112_), .c(new_n131_), .O(new_n132_));
  ...
  nand2  g062(.a(new_n145_), .b(new_n89_), .O(z15));
  nand2  g063(.a(x27), .b(new_n112_), .O(new_n147_));
  nand2  g064(.a(x28), .b(x08), .O(new_n148_));
  aoi21  g065(.a(new_n148_), .b(new_n147_), .c(x10), .O(z16));
  inv1   g066(.a(x29), .O(new_n150_));
  nand2  g067(.a(x28), .b(new_n112_), .O(new_n151_));
  oai21  g068(.a(new_n150_), .b(new_n112_), .c(new_n151_), .O(new_n152_));
  ...
  nand2  g085(.a(new_n168_), .b(new_n89_), .O(z20));
  ...
  aoi21  g118(.a(new_n98_), .b(x09), .c(new_n195_), .O(new_n202_));
  nand3  g119(.a(x40), .b(new_n98_), .c(x09), .O(new_n203_));
  ...
  nand2  g141(.a(new_n98_), .b(x09), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(x43), .O(new_n226_));
  nand3  g143(.a(x44), .b(new_n98_), .c(x09), .O(new_n227_));
  ...
  nand2  g148(.a(new_n225_), .b(x45), .O(new_n232_));
