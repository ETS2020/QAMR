...
module FAU ( 
  ...
  nand2  g035(.a(new_n118_), .b(new_n100_), .O(z07));
  ...
  nand2  g074(.a(new_n157_), .b(new_n100_), .O(z17));
  ...
  nand2  g078(.a(new_n161_), .b(new_n100_), .O(z18));
  ...
  nand2  g083(.a(new_n166_), .b(new_n100_), .O(z19));
  ...
  nand2  g089(.a(new_n172_), .b(new_n100_), .O(z20));
  ...
  nand2  g093(.a(new_n176_), .b(new_n100_), .O(z21));
  nand2  g094(.a(x34), .b(x09), .O(new_n178_));
  oai21  g095(.a(new_n99_), .b(x09), .c(new_n178_), .O(new_n179_));
  nand2  g096(.a(new_n179_), .b(new_n94_), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(new_n100_), .O(z22));
  inv1   g098(.a(x35), .O(new_n182_));
  nand2  g099(.a(x34), .b(new_n168_), .O(new_n183_));
  oai21  g100(.a(new_n182_), .b(new_n168_), .c(new_n183_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n94_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n100_), .O(z23));
  ...
  nand2  g106(.a(new_n189_), .b(new_n100_), .O(z24));
  ...
  nand2  g111(.a(new_n194_), .b(new_n100_), .O(z25));
  ...
  nand2  g121(.a(new_n95_), .b(x09), .O(new_n205_));
  ...
  nand3  g141(.a(x44), .b(new_n95_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z32));
  nand2  g143(.a(new_n205_), .b(x44), .O(new_n227_));
  nand3  g144(.a(x45), .b(new_n95_), .c(x09), .O(new_n228_));
  ...
  nand2  g151(.a(new_n234_), .b(new_n100_), .O(z34));
