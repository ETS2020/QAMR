...
module FAU ( 
  ...
  nand2  g003(.a(x44), .b(x18), .O(new_n87_));
  ...
  nor2   g029(.a(x18), .b(x08), .O(new_n113_));
  inv1   g030(.a(x18), .O(new_n114_));
  nor2   g031(.a(x44), .b(new_n114_), .O(new_n115_));
  oai21  g032(.a(new_n115_), .b(new_n113_), .c(x17), .O(new_n116_));
  nand2  g033(.a(new_n115_), .b(x08), .O(new_n117_));
  aoi21  g034(.a(new_n117_), .b(new_n116_), .c(x10), .O(z06));
  inv1   g035(.a(x44), .O(new_n119_));
  inv1   g036(.a(x19), .O(new_n120_));
  nand2  g037(.a(new_n120_), .b(x08), .O(new_n121_));
  nand3  g038(.a(new_n121_), .b(new_n119_), .c(x18), .O(new_n122_));
  nand3  g039(.a(x19), .b(new_n114_), .c(x08), .O(new_n123_));
  aoi21  g040(.a(new_n123_), .b(new_n122_), .c(x10), .O(z07));
  nor2   g041(.a(new_n120_), .b(x08), .O(new_n125_));
  ...
  aoi21  g142(.a(new_n218_), .b(x40), .c(new_n225_), .O(new_n226_));
  oai21  g143(.a(new_n226_), .b(x10), .c(new_n87_), .O(z29));
  ...
  oai21  g152(.a(new_n235_), .b(x10), .c(new_n87_), .O(z31));
  inv1   g153(.a(x43), .O(new_n237_));
  nand2  g154(.a(new_n218_), .b(new_n237_), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(x44), .c(new_n114_), .O(new_n239_));
  nand3  g156(.a(new_n218_), .b(new_n119_), .c(x43), .O(new_n240_));
  aoi21  g157(.a(new_n240_), .b(new_n239_), .c(x10), .O(z32));
  nor2   g158(.a(x14), .b(new_n179_), .O(new_n242_));
  nand3  g159(.a(x45), .b(new_n99_), .c(x09), .O(new_n243_));
  oai21  g160(.a(new_n242_), .b(new_n119_), .c(new_n243_), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(new_n89_), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n87_), .O(z33));
  nand3  g163(.a(x46), .b(new_n99_), .c(x09), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(new_n248_));
  aoi21  g165(.a(new_n218_), .b(x45), .c(new_n248_), .O(new_n249_));
  oai21  g166(.a(new_n249_), .b(x10), .c(new_n87_), .O(z34));
  nand2  g167(.a(new_n218_), .b(x46), .O(new_n251_));
  nand2  g168(.a(new_n242_), .b(x00), .O(new_n252_));
