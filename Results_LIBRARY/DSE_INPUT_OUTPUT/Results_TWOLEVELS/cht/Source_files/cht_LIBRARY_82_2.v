...
module FAU ( 
  ...
  nand2  g066(.a(x33), .b(new_n145_), .O(new_n150_));
  ...
  oai21  g072(.a(new_n154_), .b(new_n145_), .c(new_n155_), .O(new_n156_));
  ...
  aoi21  g092(.a(x38), .b(new_n145_), .c(x08), .O(new_n176_));
  ...
  oai21  g115(.a(x14), .b(new_n145_), .c(x43), .O(new_n199_));
  nand3  g116(.a(x44), .b(new_n100_), .c(x09), .O(new_n200_));
  ...
  oai21  g130(.a(x14), .b(new_n145_), .c(x46), .O(new_n214_));
  nand3  g131(.a(new_n100_), .b(x09), .c(x00), .O(new_n215_));
