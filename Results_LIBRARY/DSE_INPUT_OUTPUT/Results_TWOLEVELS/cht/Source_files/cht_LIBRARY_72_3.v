...
module FAU ( 
  ...
  nand3  g125(.a(new_n198_), .b(x41), .c(new_n84_), .O(new_n209_));
  aoi21  g126(.a(new_n98_), .b(x09), .c(x10), .O(new_n210_));
  oai21  g127(.a(new_n210_), .b(new_n208_), .c(new_n209_), .O(z30));
  nand3  g128(.a(new_n98_), .b(new_n84_), .c(x09), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(x42), .O(new_n213_));
  nand4  g130(.a(x43), .b(new_n98_), .c(new_n84_), .d(x09), .O(new_n214_));
  ...
  nand2  g138(.a(new_n198_), .b(x44), .O(new_n222_));
