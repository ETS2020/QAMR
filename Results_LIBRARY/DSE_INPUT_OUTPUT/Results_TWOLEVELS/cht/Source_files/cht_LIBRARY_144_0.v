...
module FAU ( 
  ...
  oai21  g050(.a(new_n133_), .b(x10), .c(new_n87_), .O(z09));
  ...
  oai21  g092(.a(new_n175_), .b(x10), .c(new_n87_), .O(z18));
  ...
  nand2  g107(.a(new_n190_), .b(new_n87_), .O(z21));
  ...
  oai21  g127(.a(new_n85_), .b(x09), .c(new_n210_), .O(new_n211_));
  ...
  nor2   g134(.a(new_n217_), .b(x09), .O(new_n218_));
  aoi21  g135(.a(new_n216_), .b(x09), .c(new_n218_), .O(new_n219_));
  oai21  g136(.a(new_n219_), .b(x10), .c(new_n87_), .O(z27));
  aoi21  g137(.a(new_n103_), .b(x09), .c(new_n214_), .O(new_n221_));
  ...
  oai21  g152(.a(x14), .b(new_n182_), .c(x42), .O(new_n236_));
  ...
  oai21  g157(.a(x14), .b(new_n182_), .c(x43), .O(new_n241_));
  nand3  g158(.a(x44), .b(new_n103_), .c(x09), .O(new_n242_));
  ...
  aoi21  g163(.a(new_n103_), .b(x09), .c(new_n246_), .O(new_n247_));
  ...
  nand2  g167(.a(new_n250_), .b(new_n87_), .O(z33));
  aoi21  g168(.a(new_n103_), .b(x09), .c(new_n86_), .O(new_n252_));
  ...
  nand2  g172(.a(new_n255_), .b(new_n87_), .O(z34));
  oai21  g173(.a(x14), .b(new_n182_), .c(x46), .O(new_n257_));
  nand3  g174(.a(new_n103_), .b(x09), .c(x00), .O(new_n258_));
  nand2  g175(.a(new_n258_), .b(new_n257_), .O(new_n259_));
  nand3  g176(.a(new_n259_), .b(new_n87_), .c(new_n84_), .O(new_n260_));
