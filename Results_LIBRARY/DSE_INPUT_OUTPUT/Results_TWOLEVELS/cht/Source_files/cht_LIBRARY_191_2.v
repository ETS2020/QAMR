...
module FAU ( 
  ...
  aoi21  g096(.a(new_n179_), .b(new_n88_), .c(x10), .O(z22));
  inv1   g097(.a(x34), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n88_), .c(x10), .O(z23));
  ...
  aoi21  g114(.a(new_n197_), .b(new_n88_), .c(x10), .O(z31));
  inv1   g115(.a(x43), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n88_), .c(x10), .O(z32));
  inv1   g117(.a(x44), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n88_), .c(x10), .O(z33));
  nand2  g119(.a(new_n174_), .b(x45), .O(new_n203_));
  inv1   g120(.a(new_n203_), .O(z34));
  inv1   g121(.a(x46), .O(new_n205_));
  aoi21  g122(.a(new_n205_), .b(new_n88_), .c(x10), .O(z35));
endmodule
