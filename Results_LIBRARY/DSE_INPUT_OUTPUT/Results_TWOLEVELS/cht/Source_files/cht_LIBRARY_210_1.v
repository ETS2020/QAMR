...
module FAU ( 
  ...
  inv1   g003(.a(x30), .O(new_n87_));
  nand2  g004(.a(x31), .b(new_n87_), .O(new_n88_));
  ...
  nor2   g086(.a(x31), .b(x08), .O(new_n170_));
  oai21  g087(.a(new_n170_), .b(x30), .c(x29), .O(new_n171_));
  nand2  g088(.a(x30), .b(x08), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n171_), .c(x10), .O(z18));
  oai21  g090(.a(x31), .b(new_n115_), .c(new_n87_), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(x00), .O(new_n175_));
