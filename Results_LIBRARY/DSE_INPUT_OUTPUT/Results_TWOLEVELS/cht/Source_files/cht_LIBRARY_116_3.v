...
module FAU ( 
  ...
  nand3  g109(.a(new_n192_), .b(new_n190_), .c(new_n84_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(x09), .O(new_n194_));
  nand3  g111(.a(x38), .b(new_n84_), .c(new_n168_), .O(new_n195_));
  ...
  aoi21  g120(.a(x42), .b(new_n191_), .c(x10), .O(new_n204_));
  nand3  g121(.a(new_n197_), .b(x41), .c(new_n84_), .O(new_n205_));
  oai21  g122(.a(new_n204_), .b(new_n168_), .c(new_n205_), .O(z30));
  ...
  nand3  g127(.a(x44), .b(new_n191_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z32));
  nand2  g129(.a(new_n197_), .b(x44), .O(new_n213_));
  nand3  g130(.a(x45), .b(new_n191_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z33));
  nand2  g132(.a(new_n197_), .b(x45), .O(new_n216_));
  nand3  g133(.a(x46), .b(new_n191_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  aoi21  g135(.a(new_n191_), .b(x00), .c(x10), .O(new_n219_));
  nand3  g136(.a(new_n197_), .b(x46), .c(new_n84_), .O(new_n220_));
  oai21  g137(.a(new_n219_), .b(new_n168_), .c(new_n220_), .O(z35));
endmodule
