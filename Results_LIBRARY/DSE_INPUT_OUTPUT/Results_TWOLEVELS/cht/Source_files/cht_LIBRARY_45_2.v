...
module FAU ( 
  ...
  aoi21  g035(.a(new_n118_), .b(new_n88_), .c(x10), .O(z08));
  nand2  g036(.a(new_n113_), .b(x20), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z09));
  inv1   g038(.a(x21), .O(new_n122_));
  aoi21  g039(.a(new_n122_), .b(new_n88_), .c(x10), .O(z10));
  inv1   g040(.a(x22), .O(new_n124_));
  aoi21  g041(.a(new_n124_), .b(new_n88_), .c(x10), .O(z11));
  nand2  g042(.a(new_n113_), .b(x23), .O(new_n126_));
  inv1   g043(.a(new_n126_), .O(z12));
  nand2  g044(.a(new_n113_), .b(x24), .O(new_n128_));
  inv1   g045(.a(new_n128_), .O(z13));
  inv1   g046(.a(x25), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n88_), .c(x10), .O(z14));
  nand2  g048(.a(new_n113_), .b(x26), .O(new_n132_));
  inv1   g049(.a(new_n132_), .O(z15));
  nand2  g050(.a(new_n113_), .b(x27), .O(new_n134_));
  inv1   g051(.a(new_n134_), .O(z16));
  inv1   g052(.a(x28), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n88_), .c(x10), .O(z17));
  inv1   g054(.a(x29), .O(new_n138_));
  aoi21  g055(.a(new_n138_), .b(new_n88_), .c(x10), .O(z18));
  inv1   g056(.a(x30), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n88_), .c(x10), .O(z19));
  ...
  and2   g079(.a(new_n162_), .b(new_n89_), .O(z24));
  ...
  and2   g083(.a(new_n166_), .b(new_n89_), .O(z25));
  ...
  and2   g087(.a(new_n170_), .b(new_n89_), .O(z26));
  ...
  oai21  g099(.a(x14), .b(new_n142_), .c(x40), .O(new_n183_));
  nand3  g100(.a(x41), .b(new_n98_), .c(x09), .O(new_n184_));
  ...
  oai21  g104(.a(x14), .b(new_n142_), .c(x41), .O(new_n188_));
  ...
  nand2  g110(.a(new_n193_), .b(x42), .O(new_n194_));
  ...
  nand2  g115(.a(new_n193_), .b(x43), .O(new_n199_));
  ...
  nand2  g120(.a(new_n193_), .b(x44), .O(new_n204_));
  inv1   g121(.a(x45), .O(new_n205_));
  nor2   g122(.a(new_n205_), .b(x14), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(x09), .c(x08), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n204_), .c(x10), .O(z33));
  oai21  g125(.a(x14), .b(new_n142_), .c(x45), .O(new_n209_));
  ...
  oai21  g130(.a(x14), .b(new_n142_), .c(x46), .O(new_n214_));
