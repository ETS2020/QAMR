...
module FAU ( 
  ...
  nand3  g020(.a(new_n103_), .b(new_n89_), .c(x08), .O(new_n104_));
  ...
  nor2   g092(.a(new_n175_), .b(new_n86_), .O(z27));
  ...
  nand3  g097(.a(new_n180_), .b(new_n89_), .c(x08), .O(new_n181_));
  ...
  nand3  g102(.a(new_n185_), .b(new_n89_), .c(x08), .O(new_n186_));
  ...
  nand3  g126(.a(new_n209_), .b(new_n89_), .c(x08), .O(new_n210_));
  inv1   g127(.a(new_n210_), .O(z34));
  nand2  g128(.a(new_n177_), .b(x46), .O(new_n212_));
  aoi21  g129(.a(new_n198_), .b(x00), .c(new_n86_), .O(new_n213_));
