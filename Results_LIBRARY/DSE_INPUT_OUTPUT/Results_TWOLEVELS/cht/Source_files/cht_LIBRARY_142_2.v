...
module FAU ( 
  ...
  nand2  g108(.a(x34), .b(new_n176_), .O(new_n192_));
  oai21  g109(.a(new_n191_), .b(new_n176_), .c(new_n192_), .O(new_n193_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n88_), .c(new_n98_), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z24));
  nand2  g116(.a(x36), .b(new_n176_), .O(new_n200_));
  oai21  g117(.a(new_n87_), .b(new_n176_), .c(new_n200_), .O(new_n201_));
  ...
  nand3  g121(.a(x38), .b(new_n186_), .c(x09), .O(new_n205_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n98_), .O(new_n223_));
  ...
  nand2  g144(.a(new_n227_), .b(new_n98_), .O(new_n228_));
  ...
  nand2  g149(.a(new_n232_), .b(new_n98_), .O(new_n233_));
  ...
  nand3  g159(.a(new_n242_), .b(new_n88_), .c(new_n98_), .O(new_n243_));
  ...
  nand2  g164(.a(new_n247_), .b(new_n98_), .O(new_n248_));
  nand2  g165(.a(new_n248_), .b(new_n88_), .O(z34));
  inv1   g166(.a(x46), .O(new_n250_));
  nand3  g167(.a(new_n99_), .b(x09), .c(x00), .O(new_n251_));
  oai21  g168(.a(new_n215_), .b(new_n250_), .c(new_n251_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(new_n98_), .O(new_n253_));
