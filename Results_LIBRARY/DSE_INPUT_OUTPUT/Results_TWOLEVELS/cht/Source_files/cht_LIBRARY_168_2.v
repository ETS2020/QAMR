...
module FAU ( 
  ...
  nand2  g070(.a(x25), .b(new_n120_), .O(new_n154_));
  ...
  aoi21  g093(.a(x30), .b(new_n120_), .c(x09), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z19));
  inv1   g095(.a(x31), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n84_), .c(x10), .O(z20));
  ...
  nand2  g102(.a(new_n181_), .b(x34), .O(new_n186_));
  inv1   g103(.a(new_n186_), .O(z23));
  inv1   g104(.a(x35), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n84_), .c(x10), .O(z24));
  inv1   g106(.a(x36), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n84_), .c(x10), .O(z25));
  nand2  g108(.a(new_n181_), .b(x37), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(z26));
  inv1   g110(.a(x38), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n84_), .c(x10), .O(z27));
  inv1   g112(.a(x39), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n84_), .c(x10), .O(z28));
  inv1   g114(.a(x40), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n84_), .c(x10), .O(z29));
  inv1   g116(.a(x41), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n84_), .c(x10), .O(z30));
  nand2  g118(.a(new_n181_), .b(x42), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z31));
  nand2  g120(.a(new_n181_), .b(x43), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z32));
  inv1   g122(.a(x44), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n84_), .c(x10), .O(z33));
  inv1   g124(.a(x45), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n84_), .c(x10), .O(z34));
  nand2  g126(.a(new_n181_), .b(x46), .O(new_n210_));
