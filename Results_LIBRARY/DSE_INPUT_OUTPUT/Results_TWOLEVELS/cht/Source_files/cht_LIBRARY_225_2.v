...
module FAU ( 
  ...
  nand2  g055(.a(new_n138_), .b(new_n90_), .O(z13));
  ...
  oai21  g062(.a(new_n144_), .b(new_n110_), .c(new_n145_), .O(new_n146_));
  ...
  oai21  g074(.a(new_n156_), .b(new_n110_), .c(new_n157_), .O(new_n158_));
  ...
  oai21  g094(.a(new_n89_), .b(new_n165_), .c(new_n177_), .O(new_n178_));
  ...
  aoi21  g123(.a(new_n198_), .b(x09), .c(new_n206_), .O(new_n207_));
  ...
  nand2  g127(.a(new_n210_), .b(new_n90_), .O(z30));
