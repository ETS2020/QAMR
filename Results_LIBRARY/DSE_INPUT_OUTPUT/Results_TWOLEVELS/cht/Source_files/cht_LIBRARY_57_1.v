...
module FAU ( 
  ...
  oai21  g024(.a(x17), .b(x10), .c(new_n96_), .O(new_n108_));
  nand3  g025(.a(x18), .b(new_n91_), .c(x08), .O(new_n109_));
  ...
  oai21  g060(.a(x29), .b(x10), .c(new_n96_), .O(new_n144_));
  nand3  g061(.a(x30), .b(new_n91_), .c(x08), .O(new_n145_));
  nand2  g062(.a(new_n145_), .b(new_n144_), .O(z18));
  oai21  g063(.a(x30), .b(x10), .c(new_n96_), .O(new_n147_));
  nand3  g064(.a(new_n91_), .b(x08), .c(x00), .O(new_n148_));
  ...
  nand2  g077(.a(new_n160_), .b(new_n97_), .O(z22));
  ...
  nand2  g081(.a(new_n164_), .b(new_n97_), .O(z23));
  ...
  oai21  g097(.a(new_n180_), .b(x10), .c(new_n97_), .O(z27));
  ...
  nand2  g108(.a(new_n191_), .b(new_n97_), .O(z29));
  ...
  nand2  g114(.a(new_n197_), .b(new_n97_), .O(z30));
  ...
  nand2  g123(.a(new_n206_), .b(new_n97_), .O(z32));
  ...
  nand2  g129(.a(new_n212_), .b(new_n97_), .O(z33));
  ...
  nand2  g135(.a(new_n218_), .b(new_n97_), .O(z34));
