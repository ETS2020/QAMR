...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n92_), .c(x45), .O(new_n106_));
  ...
  aoi21  g036(.a(x19), .b(x08), .c(x45), .O(new_n120_));
  ...
  aoi21  g053(.a(x23), .b(x08), .c(x45), .O(new_n137_));
  ...
  aoi21  g074(.a(x28), .b(x08), .c(x45), .O(new_n158_));
  ...
  aoi21  g110(.a(x37), .b(x09), .c(x45), .O(new_n194_));
  ...
  oai21  g121(.a(new_n204_), .b(new_n203_), .c(new_n85_), .O(new_n205_));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(x45), .O(new_n216_));
  ...
  nand4  g148(.a(new_n207_), .b(new_n85_), .c(x44), .d(new_n84_), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(z33));
  inv1   g150(.a(x46), .O(new_n234_));
  nand4  g151(.a(new_n85_), .b(new_n100_), .c(new_n84_), .d(x09), .O(new_n235_));
  nor2   g152(.a(new_n235_), .b(new_n234_), .O(z34));
  nand2  g153(.a(new_n207_), .b(x46), .O(new_n237_));
  aoi21  g154(.a(new_n218_), .b(x00), .c(x45), .O(new_n238_));
