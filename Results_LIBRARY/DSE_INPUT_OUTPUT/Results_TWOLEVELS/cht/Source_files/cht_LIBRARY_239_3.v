...
module FAU ( 
  ...
  aoi21  g104(.a(new_n101_), .b(x09), .c(new_n182_), .O(new_n188_));
  nand3  g105(.a(x40), .b(new_n101_), .c(x09), .O(new_n189_));
  ...
  aoi21  g110(.a(new_n101_), .b(x09), .c(new_n193_), .O(new_n194_));
  nand3  g111(.a(x41), .b(new_n101_), .c(x09), .O(new_n195_));
