...
module FAU ( 
  ...
  inv1   g053(.a(x32), .O(new_n137_));
  nand2  g054(.a(x31), .b(new_n136_), .O(new_n138_));
  oai21  g055(.a(new_n137_), .b(new_n136_), .c(new_n138_), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(new_n95_), .c(x08), .O(new_n140_));
  inv1   g057(.a(new_n140_), .O(z20));
  nand2  g058(.a(x33), .b(x09), .O(new_n142_));
  oai21  g059(.a(new_n137_), .b(x09), .c(new_n142_), .O(new_n143_));
  nand3  g060(.a(new_n143_), .b(new_n95_), .c(x08), .O(new_n144_));
  inv1   g061(.a(new_n144_), .O(z21));
  inv1   g062(.a(x34), .O(new_n146_));
  nand2  g063(.a(x33), .b(new_n136_), .O(new_n147_));
  oai21  g064(.a(new_n146_), .b(new_n136_), .c(new_n147_), .O(new_n148_));
  nand3  g065(.a(new_n148_), .b(new_n95_), .c(x08), .O(new_n149_));
  inv1   g066(.a(new_n149_), .O(z22));
  nand2  g067(.a(x35), .b(x09), .O(new_n151_));
  oai21  g068(.a(new_n146_), .b(x09), .c(new_n151_), .O(new_n152_));
  nand3  g069(.a(new_n152_), .b(new_n95_), .c(x08), .O(new_n153_));
  ...
  and2   g074(.a(new_n157_), .b(new_n95_), .O(z24));
  inv1   g075(.a(x37), .O(new_n159_));
  nand2  g076(.a(x36), .b(new_n136_), .O(new_n160_));
  oai21  g077(.a(new_n159_), .b(new_n136_), .c(new_n160_), .O(new_n161_));
  nand3  g078(.a(new_n161_), .b(new_n95_), .c(x08), .O(new_n162_));
  inv1   g079(.a(new_n162_), .O(z25));
  nand2  g080(.a(x38), .b(x09), .O(new_n164_));
  oai21  g081(.a(new_n159_), .b(x09), .c(new_n164_), .O(new_n165_));
  nand3  g082(.a(new_n165_), .b(new_n95_), .c(x08), .O(new_n166_));
  inv1   g083(.a(new_n166_), .O(z26));
  nand2  g084(.a(x14), .b(x00), .O(new_n168_));
  nand2  g085(.a(x39), .b(new_n96_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(new_n136_), .O(new_n170_));
  inv1   g087(.a(x38), .O(new_n171_));
  nor2   g088(.a(new_n171_), .b(x09), .O(new_n172_));
  oai21  g089(.a(new_n172_), .b(new_n170_), .c(new_n95_), .O(new_n173_));
  ...
  aoi21  g095(.a(new_n178_), .b(x09), .c(new_n86_), .O(new_n179_));
  ...
  nand3  g115(.a(new_n198_), .b(new_n95_), .c(x08), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z32));
  nand2  g117(.a(new_n175_), .b(x44), .O(new_n201_));
  nand3  g118(.a(x45), .b(new_n96_), .c(x09), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n201_), .O(new_n203_));
  nand3  g120(.a(new_n203_), .b(new_n95_), .c(x08), .O(new_n204_));
  inv1   g121(.a(new_n204_), .O(z33));
  nand2  g122(.a(new_n175_), .b(x45), .O(new_n206_));
  nand3  g123(.a(x46), .b(new_n96_), .c(x09), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n206_), .O(new_n208_));
  nand3  g125(.a(new_n208_), .b(new_n95_), .c(x08), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  nand2  g127(.a(new_n175_), .b(x46), .O(new_n211_));
  oai21  g128(.a(new_n175_), .b(new_n134_), .c(new_n211_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n95_), .c(x08), .O(new_n213_));
