...
module FAU ( 
  ...
  nand2  g009(.a(x21), .b(x10), .O(new_n93_));
  ...
  oai21  g039(.a(x10), .b(x08), .c(x21), .O(new_n123_));
  nand3  g040(.a(x20), .b(new_n88_), .c(new_n111_), .O(new_n124_));
  nand2  g041(.a(new_n124_), .b(new_n123_), .O(z09));
  oai21  g042(.a(x10), .b(new_n111_), .c(x21), .O(new_n126_));
  ...
  nand2  g061(.a(new_n144_), .b(new_n93_), .O(z14));
  ...
  nand2  g080(.a(new_n163_), .b(new_n93_), .O(z19));
  ...
  nand2  g089(.a(new_n172_), .b(new_n93_), .O(z21));
