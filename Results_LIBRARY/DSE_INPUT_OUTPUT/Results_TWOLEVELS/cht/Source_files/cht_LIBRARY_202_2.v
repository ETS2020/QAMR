...
module FAU ( 
  ...
  nand3  g042(.a(new_n86_), .b(x20), .c(x08), .O(new_n126_));
  nand3  g043(.a(x26), .b(x19), .c(new_n116_), .O(new_n127_));
  ...
  nand2  g058(.a(new_n141_), .b(new_n86_), .O(z11));
  ...
  nor2   g068(.a(x19), .b(x08), .O(new_n152_));
  oai21  g069(.a(new_n152_), .b(x26), .c(x25), .O(new_n153_));
  nand2  g070(.a(x26), .b(x08), .O(new_n154_));
  aoi21  g071(.a(new_n154_), .b(new_n153_), .c(x10), .O(z14));
  oai21  g072(.a(x27), .b(new_n116_), .c(x26), .O(new_n156_));
  inv1   g073(.a(x19), .O(new_n157_));
  nand3  g074(.a(x27), .b(new_n157_), .c(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n156_), .c(x10), .O(z15));
