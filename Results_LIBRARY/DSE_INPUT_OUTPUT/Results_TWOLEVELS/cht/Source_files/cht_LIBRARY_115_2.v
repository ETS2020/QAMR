...
module FAU ( 
  ...
  nor2   g030(.a(x18), .b(x08), .O(new_n114_));
  inv1   g031(.a(x18), .O(new_n115_));
  nor2   g032(.a(new_n87_), .b(new_n115_), .O(new_n116_));
  oai21  g033(.a(new_n116_), .b(new_n114_), .c(x17), .O(new_n117_));
  nand2  g034(.a(new_n116_), .b(x08), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n117_), .c(x10), .O(z06));
  inv1   g036(.a(x19), .O(new_n120_));
  nand2  g037(.a(new_n120_), .b(x08), .O(new_n121_));
  nand3  g038(.a(new_n121_), .b(x44), .c(x18), .O(new_n122_));
  nand3  g039(.a(x19), .b(new_n115_), .c(x08), .O(new_n123_));
  ...
  oai21  g152(.a(new_n235_), .b(x10), .c(new_n88_), .O(z31));
  nor2   g153(.a(x14), .b(new_n179_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(x18), .c(new_n87_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(x43), .O(new_n239_));
