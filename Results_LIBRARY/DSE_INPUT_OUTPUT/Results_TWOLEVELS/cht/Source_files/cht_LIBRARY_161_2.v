...
module FAU ( 
  ...
  nand2  g038(.a(new_n121_), .b(new_n94_), .O(z09));
  ...
  oai21  g055(.a(new_n137_), .b(new_n108_), .c(new_n138_), .O(new_n139_));
  ...
  nand2  g061(.a(new_n144_), .b(new_n94_), .O(z15));
  ...
  nand2  g068(.a(x29), .b(new_n108_), .O(new_n152_));
  ...
  nand2  g075(.a(new_n158_), .b(new_n94_), .O(z19));
  ...
  nand2  g090(.a(new_n173_), .b(new_n94_), .O(z23));
  ...
  nand2  g094(.a(new_n177_), .b(new_n94_), .O(z24));
  ...
  nand2  g102(.a(new_n185_), .b(new_n94_), .O(z26));
  ...
  oai21  g108(.a(new_n191_), .b(x10), .c(new_n94_), .O(z27));
  ...
  nand2  g114(.a(new_n197_), .b(new_n94_), .O(z28));
  ...
  nand3  g120(.a(x42), .b(new_n193_), .c(x09), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z30));
  inv1   g122(.a(x42), .O(new_n206_));
  aoi21  g123(.a(new_n193_), .b(x09), .c(new_n206_), .O(new_n207_));
  nand3  g124(.a(x43), .b(new_n193_), .c(x09), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(new_n207_), .c(new_n88_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n94_), .O(z31));
  ...
  nand2  g133(.a(new_n216_), .b(new_n94_), .O(z32));
  ...
  nand2  g140(.a(new_n199_), .b(x46), .O(new_n224_));
