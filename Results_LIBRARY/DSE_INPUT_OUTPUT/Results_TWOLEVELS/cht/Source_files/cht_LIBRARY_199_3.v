...
module FAU ( 
  ...
  nand2  g003(.a(x46), .b(x40), .O(new_n87_));
  ...
  oai21  g047(.a(new_n130_), .b(x10), .c(new_n87_), .O(z09));
  ...
  nand3  g060(.a(new_n143_), .b(new_n87_), .c(new_n89_), .O(new_n144_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n89_), .O(new_n196_));
  nand2  g113(.a(new_n196_), .b(new_n87_), .O(z23));
  ...
  oai21  g132(.a(new_n215_), .b(new_n214_), .c(new_n87_), .O(new_n216_));
  ...
  oai21  g138(.a(new_n221_), .b(x10), .c(new_n87_), .O(z28));
  ...
  nand2  g147(.a(new_n218_), .b(x42), .O(new_n231_));
  ...
  nand2  g152(.a(new_n218_), .b(x43), .O(new_n236_));
  ...
  aoi21  g159(.a(new_n218_), .b(x44), .c(new_n242_), .O(new_n243_));
  oai21  g160(.a(new_n243_), .b(x10), .c(new_n87_), .O(z33));
  inv1   g161(.a(x46), .O(new_n245_));
  nor2   g162(.a(new_n245_), .b(x14), .O(new_n246_));
  aoi22  g163(.a(new_n246_), .b(x09), .c(new_n218_), .d(x45), .O(new_n247_));
  oai21  g164(.a(new_n247_), .b(x10), .c(new_n87_), .O(z34));
  nand3  g165(.a(new_n245_), .b(new_n100_), .c(x09), .O(new_n249_));
  oai21  g166(.a(new_n245_), .b(x40), .c(new_n249_), .O(new_n250_));
  nand2  g167(.a(new_n250_), .b(x00), .O(new_n251_));
  inv1   g168(.a(x40), .O(new_n252_));
  nand3  g169(.a(new_n218_), .b(x46), .c(new_n252_), .O(new_n253_));
  aoi21  g170(.a(new_n253_), .b(new_n251_), .c(x10), .O(z35));
endmodule
