...
module FAU ( 
  ...
  oai21  g088(.a(new_n170_), .b(new_n152_), .c(new_n171_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n91_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n97_), .O(z24));
  ...
  nand2  g116(.a(new_n199_), .b(new_n97_), .O(z29));
