...
module FAU ( 
  ...
  oai21  g062(.a(new_n88_), .b(x08), .c(new_n87_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(x24), .O(new_n147_));
  nand2  g064(.a(x25), .b(x08), .O(new_n148_));
  aoi21  g065(.a(new_n148_), .b(new_n147_), .c(x10), .O(z13));
  nor2   g066(.a(new_n87_), .b(x08), .O(new_n150_));
  aoi21  g067(.a(x26), .b(x08), .c(new_n150_), .O(new_n151_));
  oai21  g068(.a(new_n151_), .b(x10), .c(new_n89_), .O(z14));
  ...
  oai21  g089(.a(new_n172_), .b(x10), .c(new_n89_), .O(z19));
  ...
  nand2  g104(.a(new_n187_), .b(new_n89_), .O(z22));
  nand2  g105(.a(x35), .b(x09), .O(new_n189_));
  oai21  g106(.a(new_n184_), .b(x09), .c(new_n189_), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n89_), .c(new_n95_), .O(new_n191_));
  ...
  nand2  g116(.a(new_n199_), .b(new_n95_), .O(new_n200_));
  ...
  oai21  g128(.a(new_n211_), .b(x10), .c(new_n89_), .O(z27));
  aoi21  g129(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n213_));
  oai21  g130(.a(new_n213_), .b(x40), .c(x39), .O(new_n214_));
  ...
  oai21  g138(.a(x14), .b(new_n174_), .c(x41), .O(new_n222_));
