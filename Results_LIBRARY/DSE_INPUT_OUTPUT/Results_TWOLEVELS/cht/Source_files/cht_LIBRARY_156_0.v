...
module FAU ( 
  ...
  nand3  g027(.a(new_n110_), .b(x30), .c(new_n84_), .O(new_n111_));
  ...
  nand3  g063(.a(new_n146_), .b(x30), .c(new_n84_), .O(new_n147_));
  ...
  oai21  g073(.a(new_n113_), .b(x00), .c(x30), .O(new_n157_));
  ...
  nand3  g083(.a(new_n166_), .b(x30), .c(new_n84_), .O(new_n167_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n173_), .c(x30), .O(new_n175_));
  ...
  aoi21  g110(.a(x38), .b(new_n159_), .c(new_n92_), .O(new_n194_));
