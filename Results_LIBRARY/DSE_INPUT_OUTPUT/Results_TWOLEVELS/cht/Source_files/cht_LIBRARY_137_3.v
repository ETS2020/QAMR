...
module FAU ( 
  ...
  nand2  g001(.a(x26), .b(x18), .O(new_n85_));
  ...
  nand3  g033(.a(new_n85_), .b(x19), .c(x08), .O(new_n117_));
  inv1   g034(.a(x08), .O(new_n118_));
  inv1   g035(.a(x26), .O(new_n119_));
  nand3  g036(.a(new_n119_), .b(x18), .c(new_n118_), .O(new_n120_));
  aoi21  g037(.a(new_n120_), .b(new_n117_), .c(x10), .O(z07));
  ...
  nand2  g046(.a(new_n129_), .b(new_n85_), .O(z09));
  inv1   g047(.a(x22), .O(new_n131_));
  nand2  g048(.a(x21), .b(new_n118_), .O(new_n132_));
  oai21  g049(.a(new_n131_), .b(new_n118_), .c(new_n132_), .O(new_n133_));
  ...
  oai21  g058(.a(new_n140_), .b(new_n118_), .c(new_n141_), .O(new_n142_));
  ...
  oai21  g075(.a(new_n157_), .b(new_n118_), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g083(.a(x29), .b(new_n118_), .O(new_n167_));
  oai21  g084(.a(new_n166_), .b(new_n118_), .c(new_n167_), .O(new_n168_));
  nand2  g085(.a(new_n168_), .b(new_n84_), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n85_), .O(z18));
  ...
  nand2  g096(.a(new_n179_), .b(new_n85_), .O(z20));
  ...
  nand2  g109(.a(new_n192_), .b(new_n85_), .O(z23));
