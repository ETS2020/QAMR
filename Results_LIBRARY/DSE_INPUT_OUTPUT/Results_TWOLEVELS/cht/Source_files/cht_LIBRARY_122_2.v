...
module FAU ( 
  ...
  nand3  g047(.a(new_n130_), .b(new_n92_), .c(new_n91_), .O(new_n131_));
  ...
  aoi21  g092(.a(new_n175_), .b(new_n91_), .c(x10), .O(z21));
  inv1   g093(.a(x33), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n91_), .c(x10), .O(z22));
  ...
  aoi21  g100(.a(new_n183_), .b(new_n91_), .c(x10), .O(z25));
  nand2  g101(.a(new_n172_), .b(x37), .O(new_n185_));
  inv1   g102(.a(new_n185_), .O(z26));
  inv1   g103(.a(x38), .O(new_n187_));
  aoi21  g104(.a(new_n187_), .b(new_n91_), .c(x10), .O(z27));
  inv1   g105(.a(x39), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n91_), .c(x10), .O(z28));
  nand2  g107(.a(new_n172_), .b(x40), .O(new_n191_));
  inv1   g108(.a(new_n191_), .O(z29));
  inv1   g109(.a(x41), .O(new_n193_));
  aoi21  g110(.a(new_n193_), .b(new_n91_), .c(x10), .O(z30));
  nand2  g111(.a(new_n172_), .b(x42), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z31));
  nand2  g113(.a(new_n172_), .b(x43), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z32));
  nand2  g115(.a(new_n172_), .b(x44), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z33));
  inv1   g117(.a(x45), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n91_), .c(x10), .O(z34));
  inv1   g119(.a(x46), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n91_), .c(x10), .O(z35));
endmodule
