...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n89_), .O(z08));
  ...
  oai21  g083(.a(x10), .b(new_n163_), .c(x32), .O(new_n167_));
  nand3  g084(.a(x33), .b(new_n84_), .c(x09), .O(new_n168_));
  ...
  nand2  g094(.a(new_n177_), .b(new_n89_), .O(z23));
  ...
  oai21  g105(.a(new_n187_), .b(new_n163_), .c(new_n188_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n84_), .O(new_n190_));
  nand2  g107(.a(new_n190_), .b(new_n89_), .O(z26));
  inv1   g108(.a(x39), .O(new_n192_));
  nand2  g109(.a(x14), .b(x00), .O(new_n193_));
  oai21  g110(.a(new_n192_), .b(x14), .c(new_n193_), .O(new_n194_));
  nor2   g111(.a(new_n187_), .b(x09), .O(new_n195_));
  aoi21  g112(.a(new_n194_), .b(x09), .c(new_n195_), .O(new_n196_));
  oai21  g113(.a(new_n196_), .b(x10), .c(new_n89_), .O(z27));
  ...
  nand3  g132(.a(x43), .b(new_n198_), .c(x09), .O(new_n216_));
  ...
  nand3  g144(.a(x46), .b(new_n198_), .c(x09), .O(new_n228_));
