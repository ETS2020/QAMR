...
module FAU ( 
  ...
  aoi21  g033(.a(x18), .b(x08), .c(x19), .O(new_n117_));
  aoi21  g034(.a(new_n117_), .b(new_n116_), .c(x10), .O(z06));
  nand4  g035(.a(new_n85_), .b(x18), .c(new_n84_), .d(new_n115_), .O(new_n119_));
  inv1   g036(.a(new_n119_), .O(z07));
  nand2  g037(.a(x20), .b(x08), .O(new_n121_));
  aoi21  g038(.a(new_n121_), .b(new_n85_), .c(x10), .O(z08));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(x19), .O(new_n238_));
