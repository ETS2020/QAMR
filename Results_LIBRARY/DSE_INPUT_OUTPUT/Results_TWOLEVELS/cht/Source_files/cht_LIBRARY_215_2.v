...
module FAU ( 
  ...
  and2   g051(.a(new_n134_), .b(new_n89_), .O(z10));
  ...
  and2   g083(.a(new_n166_), .b(new_n89_), .O(z17));
  nand2  g084(.a(x29), .b(new_n131_), .O(new_n168_));
  ...
  aoi21  g097(.a(new_n180_), .b(new_n88_), .c(x10), .O(z21));
  ...
  aoi21  g113(.a(new_n196_), .b(new_n88_), .c(x10), .O(z29));
  inv1   g114(.a(x41), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n88_), .c(x10), .O(z30));
  nand2  g116(.a(new_n177_), .b(x42), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z31));
  inv1   g118(.a(x43), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n88_), .c(x10), .O(z32));
  nand2  g120(.a(new_n177_), .b(x44), .O(new_n204_));
