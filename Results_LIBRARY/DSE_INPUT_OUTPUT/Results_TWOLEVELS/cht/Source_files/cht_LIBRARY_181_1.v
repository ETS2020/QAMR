...
module FAU ( 
  ...
  nand2  g030(.a(x17), .b(new_n89_), .O(new_n114_));
  ...
  nand2  g080(.a(new_n163_), .b(new_n90_), .O(z21));
  ...
  aoi21  g113(.a(new_n99_), .b(x09), .c(new_n196_), .O(new_n197_));
  ...
  nand2  g136(.a(new_n189_), .b(x46), .O(new_n220_));
  nand3  g137(.a(new_n99_), .b(x09), .c(x00), .O(new_n221_));
