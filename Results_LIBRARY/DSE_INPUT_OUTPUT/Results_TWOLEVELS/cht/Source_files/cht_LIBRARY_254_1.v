...
module FAU ( 
  ...
  nand2  g081(.a(x30), .b(new_n137_), .O(new_n165_));
  ...
  oai21  g089(.a(x33), .b(x10), .c(new_n89_), .O(new_n173_));
  nand3  g090(.a(x34), .b(new_n84_), .c(x09), .O(new_n174_));
  ...
  oai21  g124(.a(x42), .b(x10), .c(new_n89_), .O(new_n208_));
  ...
  oai21  g130(.a(x43), .b(x10), .c(new_n89_), .O(new_n214_));
  ...
  oai21  g136(.a(x44), .b(x10), .c(new_n89_), .O(new_n220_));
  ...
  nand2  g142(.a(new_n195_), .b(x45), .O(new_n226_));
