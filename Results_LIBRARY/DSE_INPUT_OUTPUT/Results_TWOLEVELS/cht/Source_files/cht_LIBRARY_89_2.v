...
module FAU ( 
  ...
  oai21  g072(.a(new_n154_), .b(new_n121_), .c(new_n155_), .O(new_n156_));
  ...
  oai21  g085(.a(new_n89_), .b(x09), .c(new_n168_), .O(new_n169_));
  ...
  nand2  g096(.a(new_n179_), .b(new_n90_), .O(z22));
  ...
  nand2  g101(.a(x35), .b(new_n172_), .O(new_n185_));
  oai21  g102(.a(new_n184_), .b(new_n172_), .c(new_n185_), .O(new_n186_));
  ...
  nand2  g108(.a(new_n191_), .b(new_n90_), .O(z25));
  ...
  nand2  g116(.a(x38), .b(new_n172_), .O(new_n200_));
  aoi21  g117(.a(new_n200_), .b(new_n199_), .c(x10), .O(z27));
  nand2  g118(.a(new_n102_), .b(x09), .O(new_n202_));
  ...
  nand3  g123(.a(x41), .b(new_n102_), .c(x09), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z29));
  inv1   g125(.a(x41), .O(new_n209_));
  aoi21  g126(.a(new_n102_), .b(x09), .c(new_n209_), .O(new_n210_));
  ...
  aoi21  g132(.a(new_n102_), .b(x09), .c(new_n215_), .O(new_n216_));
  nand3  g133(.a(x43), .b(new_n102_), .c(x09), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(new_n216_), .c(new_n84_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n90_), .O(z31));
  ...
  nand3  g142(.a(x45), .b(new_n102_), .c(x09), .O(new_n226_));
  ...
  nand2  g146(.a(new_n202_), .b(x45), .O(new_n230_));
  ...
  nand3  g150(.a(new_n102_), .b(x09), .c(x00), .O(new_n234_));
