...
module FAU ( 
  ...
  and2   g042(.a(new_n125_), .b(new_n89_), .O(z08));
  ...
  and2   g060(.a(new_n143_), .b(new_n89_), .O(z12));
  ...
  aoi21  g090(.a(x30), .b(new_n113_), .c(x09), .O(new_n174_));
  ...
  aoi21  g096(.a(new_n179_), .b(new_n88_), .c(x10), .O(z21));
  ...
  nand2  g101(.a(new_n176_), .b(x35), .O(new_n185_));
  ...
  aoi21  g106(.a(new_n189_), .b(new_n88_), .c(x10), .O(z26));
