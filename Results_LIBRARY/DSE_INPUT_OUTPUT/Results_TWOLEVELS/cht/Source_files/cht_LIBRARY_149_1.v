...
module FAU ( 
  ...
  nand3  g042(.a(new_n125_), .b(new_n92_), .c(new_n91_), .O(new_n126_));
  inv1   g043(.a(new_n126_), .O(z09));
  nand2  g044(.a(x21), .b(new_n116_), .O(new_n128_));
  aoi21  g045(.a(x22), .b(x08), .c(x33), .O(new_n129_));
  ...
  aoi21  g053(.a(x24), .b(x08), .c(x33), .O(new_n137_));
  ...
  aoi21  g061(.a(x26), .b(x08), .c(x33), .O(new_n145_));
  ...
  aoi21  g076(.a(x30), .b(x08), .c(x33), .O(new_n160_));
  ...
  aoi21  g090(.a(new_n173_), .b(new_n92_), .c(x10), .O(z21));
  nand4  g091(.a(x34), .b(new_n92_), .c(new_n91_), .d(x09), .O(new_n175_));
  ...
  and2   g101(.a(new_n184_), .b(new_n91_), .O(z24));
  ...
  and2   g105(.a(new_n188_), .b(new_n91_), .O(z25));
  ...
  and2   g109(.a(new_n192_), .b(new_n91_), .O(z26));
  ...
  oai21  g116(.a(new_n199_), .b(new_n197_), .c(new_n92_), .O(new_n200_));
  ...
  aoi21  g155(.a(new_n202_), .b(x00), .c(x33), .O(new_n239_));
