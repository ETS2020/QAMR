...
module FAU ( 
  ...
  and2   g079(.a(new_n162_), .b(new_n84_), .O(z25));
  ...
  oai21  g090(.a(new_n173_), .b(new_n172_), .c(new_n84_), .O(new_n174_));
  nor2   g091(.a(new_n174_), .b(new_n92_), .O(z27));
  ...
  nand3  g096(.a(new_n179_), .b(new_n84_), .c(x08), .O(new_n180_));
  inv1   g097(.a(new_n180_), .O(z28));
  nand2  g098(.a(new_n176_), .b(x40), .O(new_n182_));
  nand3  g099(.a(x41), .b(new_n170_), .c(x09), .O(new_n183_));
  ...
  nand3  g104(.a(x42), .b(new_n170_), .c(x09), .O(new_n188_));
  ...
  aoi21  g111(.a(new_n194_), .b(x09), .c(new_n92_), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n192_), .c(x10), .O(z31));
  inv1   g113(.a(new_n176_), .O(new_n197_));
  ...
  nand3  g119(.a(x45), .b(new_n170_), .c(x09), .O(new_n203_));
  ...
  aoi21  g129(.a(new_n197_), .b(x00), .c(new_n92_), .O(new_n213_));
