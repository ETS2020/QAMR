...
module FAU ( 
  ...
  nand3  g022(.a(new_n105_), .b(x45), .c(new_n84_), .O(new_n106_));
  ...
  nand3  g042(.a(new_n125_), .b(x45), .c(new_n84_), .O(new_n126_));
  ...
  nand3  g054(.a(new_n137_), .b(x45), .c(new_n84_), .O(new_n138_));
  inv1   g055(.a(new_n138_), .O(z12));
  nand2  g056(.a(x24), .b(new_n113_), .O(new_n140_));
  aoi21  g057(.a(x25), .b(x08), .c(new_n92_), .O(new_n141_));
  ...
  aoi21  g074(.a(x30), .b(x08), .c(new_n92_), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z18));
  nand2  g076(.a(x08), .b(x00), .O(new_n160_));
  aoi21  g077(.a(x30), .b(new_n113_), .c(new_n92_), .O(new_n161_));
  ...
  nand3  g095(.a(new_n178_), .b(x45), .c(new_n84_), .O(new_n179_));
  ...
  aoi21  g113(.a(x38), .b(new_n163_), .c(new_n92_), .O(new_n197_));
  ...
  nand3  g119(.a(new_n202_), .b(x45), .c(new_n84_), .O(new_n203_));
  ...
  nand3  g124(.a(new_n207_), .b(x45), .c(new_n84_), .O(new_n208_));
  ...
  nand3  g129(.a(new_n212_), .b(x45), .c(new_n84_), .O(new_n213_));
  ...
  nor2   g142(.a(new_n92_), .b(x44), .O(new_n226_));
  aoi21  g143(.a(new_n226_), .b(new_n215_), .c(x10), .O(z33));
  nor2   g144(.a(x14), .b(new_n163_), .O(new_n228_));
  nor2   g145(.a(x46), .b(new_n92_), .O(new_n229_));
  aoi21  g146(.a(new_n229_), .b(new_n228_), .c(x10), .O(z34));
  nand2  g147(.a(new_n215_), .b(x46), .O(new_n231_));
  aoi21  g148(.a(new_n228_), .b(x00), .c(new_n92_), .O(new_n232_));
