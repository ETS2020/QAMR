...
module FAU ( 
  ...
  aoi21  g150(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n234_));
  ...
  nand2  g166(.a(x45), .b(x42), .O(new_n250_));
  nand3  g167(.a(new_n231_), .b(new_n101_), .c(x09), .O(new_n251_));
  nand2  g168(.a(new_n251_), .b(new_n250_), .O(new_n252_));
  nand2  g169(.a(new_n252_), .b(x46), .O(new_n253_));
  nand3  g170(.a(new_n228_), .b(x45), .c(x42), .O(new_n254_));
