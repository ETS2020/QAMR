...
module FAU ( 
  ...
  nand3  g073(.a(new_n156_), .b(new_n98_), .c(x09), .O(new_n157_));
  ...
  nand3  g078(.a(new_n161_), .b(new_n98_), .c(x09), .O(new_n162_));
  ...
  aoi21  g085(.a(x30), .b(new_n117_), .c(new_n86_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z19));
  nor2   g087(.a(x10), .b(new_n86_), .O(new_n171_));
  ...
  aoi21  g093(.a(new_n176_), .b(x09), .c(x10), .O(z22));
  ...
  nand2  g098(.a(new_n171_), .b(x37), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z25));
  nand2  g100(.a(new_n171_), .b(x38), .O(new_n184_));
  ...
  nand2  g127(.a(x44), .b(new_n192_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(x09), .O(new_n212_));
  and2   g129(.a(new_n212_), .b(new_n98_), .O(z32));
  nand2  g130(.a(x44), .b(x14), .O(new_n214_));
  nand2  g131(.a(x45), .b(new_n192_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(x09), .O(new_n216_));
  and2   g133(.a(new_n216_), .b(new_n98_), .O(z33));
  ...
  nand2  g139(.a(new_n192_), .b(x00), .O(new_n223_));
