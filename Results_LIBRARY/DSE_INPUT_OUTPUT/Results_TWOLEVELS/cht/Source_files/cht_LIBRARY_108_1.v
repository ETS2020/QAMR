...
module FAU ( 
  ...
  nand2  g004(.a(x41), .b(new_n87_), .O(new_n88_));
  ...
  nor2   g054(.a(x41), .b(x08), .O(new_n138_));
  oai21  g055(.a(new_n138_), .b(x24), .c(x23), .O(new_n139_));
  nand2  g056(.a(x24), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z12));
  nor2   g058(.a(new_n87_), .b(x08), .O(new_n142_));
  aoi21  g059(.a(x25), .b(x08), .c(new_n142_), .O(new_n143_));
  oai21  g060(.a(new_n143_), .b(x10), .c(new_n88_), .O(z13));
  ...
  nand3  g068(.a(new_n151_), .b(new_n88_), .c(new_n90_), .O(new_n152_));
  ...
  oai21  g132(.a(new_n215_), .b(x10), .c(new_n88_), .O(z28));
  inv1   g133(.a(x40), .O(new_n217_));
  nand2  g134(.a(new_n212_), .b(new_n217_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(x41), .c(x24), .O(new_n219_));
  inv1   g136(.a(x41), .O(new_n220_));
  nand3  g137(.a(new_n212_), .b(new_n220_), .c(x40), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n219_), .c(x10), .O(z29));
  nand3  g139(.a(new_n220_), .b(new_n100_), .c(x09), .O(new_n223_));
  oai21  g140(.a(new_n220_), .b(new_n87_), .c(new_n223_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(x42), .O(new_n225_));
  nand3  g142(.a(new_n212_), .b(x41), .c(x24), .O(new_n226_));
  ...
  aoi21  g146(.a(new_n212_), .b(x42), .c(new_n229_), .O(new_n230_));
  ...
  aoi21  g150(.a(new_n212_), .b(x43), .c(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(x10), .c(new_n88_), .O(z32));
  nand2  g152(.a(new_n212_), .b(x44), .O(new_n236_));
