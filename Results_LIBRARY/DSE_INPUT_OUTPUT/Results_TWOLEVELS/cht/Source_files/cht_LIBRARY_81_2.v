...
module FAU ( 
  ...
  nand2  g073(.a(x27), .b(new_n124_), .O(new_n157_));
  nand2  g074(.a(x28), .b(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z16));
  nand2  g076(.a(x28), .b(new_n124_), .O(new_n160_));
  ...
  nand2  g083(.a(new_n166_), .b(new_n94_), .O(z18));
  ...
  nand2  g097(.a(new_n180_), .b(new_n94_), .O(z21));
  ...
  nand2  g110(.a(new_n193_), .b(new_n94_), .O(z24));
  ...
  nand2  g118(.a(new_n201_), .b(new_n94_), .O(z26));
  nand3  g119(.a(x14), .b(new_n88_), .c(x00), .O(new_n203_));
  ...
  aoi21  g126(.a(new_n209_), .b(new_n173_), .c(new_n93_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n207_), .O(z27));
  nand2  g128(.a(new_n204_), .b(x09), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(x39), .O(new_n213_));
  nand3  g130(.a(x40), .b(new_n204_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z28));
  inv1   g132(.a(x40), .O(new_n216_));
  nor2   g133(.a(x14), .b(x09), .O(new_n217_));
  aoi21  g134(.a(x14), .b(new_n88_), .c(new_n217_), .O(new_n218_));
  aoi21  g135(.a(x41), .b(x09), .c(x10), .O(new_n219_));
  oai22  g136(.a(new_n219_), .b(x14), .c(new_n218_), .d(new_n216_), .O(z29));
  nand2  g137(.a(new_n212_), .b(x41), .O(new_n221_));
  nand3  g138(.a(x42), .b(new_n204_), .c(x09), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n221_), .c(x10), .O(z30));
  nand2  g140(.a(new_n212_), .b(x42), .O(new_n224_));
  nand3  g141(.a(x43), .b(new_n204_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z31));
  inv1   g143(.a(x43), .O(new_n227_));
  aoi21  g144(.a(x44), .b(x09), .c(x10), .O(new_n228_));
  oai22  g145(.a(new_n228_), .b(x14), .c(new_n218_), .d(new_n227_), .O(z32));
  nand2  g146(.a(new_n212_), .b(x44), .O(new_n230_));
  nand3  g147(.a(x45), .b(new_n204_), .c(x09), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n230_), .c(x10), .O(z33));
  inv1   g149(.a(x45), .O(new_n233_));
  aoi21  g150(.a(x46), .b(x09), .c(x10), .O(new_n234_));
  oai22  g151(.a(new_n234_), .b(x14), .c(new_n218_), .d(new_n233_), .O(z34));
  inv1   g152(.a(x46), .O(new_n236_));
  aoi21  g153(.a(x09), .b(x00), .c(x10), .O(new_n237_));
  oai22  g154(.a(new_n237_), .b(x14), .c(new_n218_), .d(new_n236_), .O(z35));
endmodule
