...
module FAU ( 
  ...
  nand3  g025(.a(new_n108_), .b(new_n84_), .c(new_n85_), .O(new_n109_));
  ...
  nand3  g052(.a(new_n135_), .b(new_n84_), .c(new_n85_), .O(new_n136_));
  ...
  nand3  g119(.a(new_n202_), .b(new_n84_), .c(new_n85_), .O(new_n203_));
  ...
  aoi21  g125(.a(x38), .b(new_n179_), .c(x01), .O(new_n209_));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(x01), .O(new_n221_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x01), .O(new_n226_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x01), .O(new_n231_));
  ...
  nand3  g152(.a(new_n235_), .b(new_n84_), .c(new_n85_), .O(new_n236_));
  ...
  aoi21  g157(.a(new_n240_), .b(x09), .c(x01), .O(new_n241_));
