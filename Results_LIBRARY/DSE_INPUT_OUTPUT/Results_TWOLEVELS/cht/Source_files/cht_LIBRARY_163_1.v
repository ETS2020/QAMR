...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n85_), .c(x22), .O(new_n101_));
  ...
  aoi21  g025(.a(x16), .b(new_n85_), .c(x22), .O(new_n109_));
  ...
  and2   g088(.a(new_n171_), .b(new_n88_), .O(z20));
  ...
  and2   g106(.a(new_n189_), .b(new_n88_), .O(z24));
  ...
  oai21  g122(.a(new_n205_), .b(new_n203_), .c(new_n89_), .O(new_n206_));
  ...
  aoi21  g158(.a(new_n241_), .b(x09), .c(x22), .O(new_n242_));
