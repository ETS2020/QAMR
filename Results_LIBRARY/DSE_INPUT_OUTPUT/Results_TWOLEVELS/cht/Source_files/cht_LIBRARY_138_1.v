...
module FAU ( 
  ...
  nand2  g049(.a(x24), .b(new_n93_), .O(new_n133_));
  ...
  oai21  g058(.a(x27), .b(x10), .c(new_n93_), .O(new_n142_));
  nand3  g059(.a(x28), .b(new_n88_), .c(x08), .O(new_n143_));
  ...
  nand2  g081(.a(new_n164_), .b(new_n94_), .O(z22));
  ...
  nand2  g089(.a(new_n172_), .b(new_n94_), .O(z24));
  ...
  aoi21  g108(.a(new_n99_), .b(x09), .c(new_n191_), .O(new_n192_));
  nand3  g109(.a(x41), .b(new_n99_), .c(x09), .O(new_n193_));
