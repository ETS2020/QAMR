...
module FAU ( 
  ...
  and2   g036(.a(new_n119_), .b(new_n85_), .O(z07));
  ...
  aoi21  g097(.a(new_n180_), .b(new_n84_), .c(x10), .O(z22));
  nor2   g098(.a(x10), .b(x09), .O(new_n182_));
