...
module FAU ( 
  ...
  nand3  g030(.a(x18), .b(new_n91_), .c(new_n109_), .O(new_n114_));
  ...
  nand3  g036(.a(x20), .b(new_n91_), .c(new_n109_), .O(new_n120_));
  ...
  nand3  g057(.a(x27), .b(new_n91_), .c(new_n109_), .O(new_n141_));
  ...
  nand3  g066(.a(x30), .b(new_n91_), .c(new_n109_), .O(new_n150_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n96_), .O(z24));
  ...
  nand2  g116(.a(new_n199_), .b(new_n96_), .O(z29));
  ...
  nand2  g138(.a(new_n221_), .b(new_n96_), .O(z33));
  ...
  nand2  g144(.a(new_n227_), .b(new_n96_), .O(z34));
