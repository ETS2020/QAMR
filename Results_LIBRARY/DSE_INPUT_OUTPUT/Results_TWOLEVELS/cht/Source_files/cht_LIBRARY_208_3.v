...
module FAU ( 
  ...
  aoi21  g110(.a(x40), .b(new_n100_), .c(x10), .O(new_n194_));
  ...
  aoi21  g117(.a(x42), .b(new_n100_), .c(x10), .O(new_n201_));
  nand3  g118(.a(new_n195_), .b(x41), .c(new_n84_), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(new_n166_), .c(new_n202_), .O(z30));
  aoi21  g120(.a(x43), .b(new_n100_), .c(x10), .O(new_n204_));
  nand3  g121(.a(new_n195_), .b(x42), .c(new_n84_), .O(new_n205_));
  oai21  g122(.a(new_n204_), .b(new_n166_), .c(new_n205_), .O(z31));
  aoi21  g123(.a(x44), .b(new_n100_), .c(x10), .O(new_n207_));
  nand3  g124(.a(new_n195_), .b(x43), .c(new_n84_), .O(new_n208_));
  oai21  g125(.a(new_n207_), .b(new_n166_), .c(new_n208_), .O(z32));
  aoi21  g126(.a(x45), .b(new_n100_), .c(x10), .O(new_n210_));
  nand3  g127(.a(new_n195_), .b(x44), .c(new_n84_), .O(new_n211_));
  oai21  g128(.a(new_n210_), .b(new_n166_), .c(new_n211_), .O(z33));
  aoi21  g129(.a(x46), .b(new_n100_), .c(x10), .O(new_n213_));
