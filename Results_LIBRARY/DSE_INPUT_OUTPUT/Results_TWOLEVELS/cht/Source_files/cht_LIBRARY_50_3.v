...
module FAU ( 
  ...
  aoi21  g121(.a(new_n204_), .b(x09), .c(new_n197_), .O(new_n205_));
  ...
  nand2  g132(.a(new_n204_), .b(x09), .O(new_n216_));
  ...
  nand3  g137(.a(x43), .b(new_n204_), .c(x09), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z31));
  nand2  g139(.a(new_n216_), .b(x43), .O(new_n223_));
  nand3  g140(.a(x44), .b(new_n204_), .c(x09), .O(new_n224_));
