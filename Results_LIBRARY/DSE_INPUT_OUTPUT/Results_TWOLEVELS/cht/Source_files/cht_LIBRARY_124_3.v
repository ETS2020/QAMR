...
module FAU ( 
  ...
  nand2  g012(.a(x44), .b(x10), .O(new_n96_));
  ...
  nand2  g027(.a(new_n110_), .b(new_n96_), .O(z06));
  ...
  nand2  g036(.a(new_n119_), .b(new_n96_), .O(z08));
  ...
  nand2  g059(.a(new_n142_), .b(new_n96_), .O(z14));
  ...
  oai21  g069(.a(new_n151_), .b(new_n112_), .c(new_n152_), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n91_), .O(new_n154_));
  nand2  g071(.a(new_n154_), .b(new_n96_), .O(z17));
  ...
  nand2  g075(.a(new_n158_), .b(new_n96_), .O(z18));
  ...
  nand2  g084(.a(new_n167_), .b(new_n96_), .O(z20));
  ...
  nand3  g135(.a(new_n196_), .b(new_n91_), .c(x09), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(x44), .O(new_n220_));
  nand4  g137(.a(x45), .b(new_n196_), .c(new_n91_), .d(x09), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n220_), .O(z33));
  nand2  g139(.a(new_n197_), .b(x45), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n196_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z34));
  nand2  g142(.a(new_n197_), .b(x46), .O(new_n226_));
