...
module FAU ( 
  ...
  nand2  g051(.a(x22), .b(new_n118_), .O(new_n135_));
  ...
  nand2  g068(.a(x27), .b(new_n118_), .O(new_n152_));
  ...
  nand2  g074(.a(x29), .b(new_n118_), .O(new_n158_));
  ...
  nand3  g124(.a(new_n194_), .b(x43), .c(new_n91_), .O(new_n208_));
