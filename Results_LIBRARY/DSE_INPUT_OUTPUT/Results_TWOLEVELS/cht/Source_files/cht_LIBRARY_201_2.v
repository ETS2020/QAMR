...
module FAU ( 
  ...
  nand3  g033(.a(new_n116_), .b(new_n88_), .c(new_n94_), .O(new_n117_));
  ...
  nand3  g052(.a(new_n135_), .b(new_n88_), .c(new_n94_), .O(new_n136_));
  ...
  oai21  g070(.a(new_n153_), .b(x10), .c(new_n88_), .O(z14));
  ...
  nand3  g096(.a(new_n179_), .b(new_n88_), .c(new_n94_), .O(new_n180_));
  ...
  nand2  g101(.a(new_n184_), .b(new_n88_), .O(z21));
  ...
  nand3  g123(.a(new_n206_), .b(new_n88_), .c(new_n94_), .O(new_n207_));
  ...
  oai21  g140(.a(new_n223_), .b(new_n221_), .c(new_n94_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n88_), .O(z29));
  ...
  aoi21  g148(.a(new_n100_), .b(x09), .c(x27), .O(new_n232_));
  oai21  g149(.a(new_n232_), .b(x43), .c(x42), .O(new_n233_));
  nand3  g150(.a(x43), .b(new_n100_), .c(x09), .O(new_n234_));
  aoi21  g151(.a(new_n234_), .b(new_n233_), .c(x10), .O(z31));
  aoi21  g152(.a(new_n100_), .b(x09), .c(new_n87_), .O(new_n236_));
  nand3  g153(.a(x44), .b(new_n100_), .c(x09), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(new_n238_));
  oai21  g155(.a(new_n238_), .b(new_n236_), .c(new_n94_), .O(new_n239_));
  ...
  oai21  g161(.a(new_n244_), .b(new_n242_), .c(new_n94_), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n88_), .O(z33));
  oai21  g163(.a(x14), .b(new_n176_), .c(x45), .O(new_n247_));
  ...
  oai21  g172(.a(new_n255_), .b(new_n253_), .c(new_n94_), .O(new_n256_));
