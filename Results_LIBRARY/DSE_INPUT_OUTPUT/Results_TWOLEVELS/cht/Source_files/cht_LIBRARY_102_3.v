...
module FAU ( 
  ...
  oai21  g065(.a(x10), .b(x08), .c(x28), .O(new_n149_));
  nand3  g066(.a(x27), .b(new_n88_), .c(new_n114_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n149_), .O(z16));
  oai21  g068(.a(x10), .b(new_n114_), .c(x28), .O(new_n152_));
  nand3  g069(.a(x29), .b(new_n88_), .c(x08), .O(new_n153_));
  nand2  g070(.a(new_n153_), .b(new_n152_), .O(z17));
  ...
  nand2  g075(.a(x30), .b(new_n114_), .O(new_n159_));
  ...
  nand2  g088(.a(x33), .b(new_n161_), .O(new_n172_));
  oai21  g089(.a(new_n171_), .b(new_n161_), .c(new_n172_), .O(new_n173_));
  ...
  nand2  g111(.a(x38), .b(new_n161_), .O(new_n195_));
  ...
  nand2  g147(.a(new_n221_), .b(x45), .O(new_n231_));
  nand3  g148(.a(x46), .b(new_n197_), .c(x09), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n231_), .c(x10), .O(z34));
  inv1   g150(.a(x46), .O(new_n234_));
  aoi21  g151(.a(new_n197_), .b(x09), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n197_), .b(x09), .c(x00), .O(new_n236_));
  inv1   g153(.a(new_n236_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(new_n235_), .c(new_n88_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n93_), .O(z35));
endmodule
