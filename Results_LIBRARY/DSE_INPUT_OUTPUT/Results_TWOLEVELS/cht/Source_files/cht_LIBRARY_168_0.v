...
module FAU ( 
  ...
  and2   g073(.a(new_n156_), .b(new_n84_), .O(z14));
  ...
  and2   g077(.a(new_n160_), .b(new_n84_), .O(z15));
  ...
  aoi21  g093(.a(x30), .b(new_n120_), .c(new_n92_), .O(new_n177_));
  ...
  and2   g113(.a(new_n196_), .b(new_n84_), .O(z27));
  nand2  g114(.a(x39), .b(x14), .O(new_n198_));
  nand2  g115(.a(x40), .b(new_n100_), .O(new_n199_));
  ...
  nand2  g123(.a(x42), .b(new_n100_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(new_n206_), .c(x09), .O(new_n208_));
  and2   g125(.a(new_n208_), .b(new_n84_), .O(z30));
  ...
  nand2  g141(.a(x46), .b(new_n100_), .O(new_n225_));
