...
module FAU ( 
  ...
  nand2  g041(.a(x20), .b(new_n114_), .O(new_n125_));
  ...
  nand2  g095(.a(new_n178_), .b(new_n89_), .O(z23));
  ...
  nand2  g111(.a(x38), .b(new_n165_), .O(new_n195_));
  ...
  nand2  g143(.a(new_n226_), .b(x44), .O(new_n227_));
  ...
  nand2  g152(.a(new_n226_), .b(x46), .O(new_n236_));
