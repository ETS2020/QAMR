...
module FAU ( 
  ...
  oai21  g129(.a(x43), .b(x10), .c(new_n96_), .O(new_n213_));
  ...
  oai21  g135(.a(x44), .b(x10), .c(new_n96_), .O(new_n219_));
  ...
  oai21  g141(.a(x45), .b(x10), .c(new_n96_), .O(new_n225_));
  ...
  nand2  g145(.a(new_n228_), .b(new_n91_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n225_), .O(z34));
  oai21  g147(.a(x46), .b(x10), .c(new_n96_), .O(new_n231_));
  ...
  nand2  g151(.a(new_n234_), .b(new_n91_), .O(new_n235_));
