...
module FAU ( 
  ...
  nand2  g035(.a(new_n118_), .b(new_n97_), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(new_n102_), .O(z08));
  inv1   g037(.a(x20), .O(new_n121_));
  nand2  g038(.a(x21), .b(x08), .O(new_n122_));
  oai21  g039(.a(new_n121_), .b(x08), .c(new_n122_), .O(new_n123_));
  nand2  g040(.a(new_n123_), .b(new_n97_), .O(new_n124_));
  nand2  g041(.a(new_n124_), .b(new_n102_), .O(z09));
  ...
  nand2  g046(.a(new_n129_), .b(new_n102_), .O(z10));
  ...
  nand2  g053(.a(new_n136_), .b(new_n97_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n102_), .O(z12));
  ...
  nand2  g059(.a(new_n142_), .b(new_n102_), .O(z13));
  ...
  nand2  g067(.a(new_n150_), .b(new_n102_), .O(z15));
  nand2  g068(.a(x27), .b(new_n109_), .O(new_n152_));
  ...
  nand2  g075(.a(new_n158_), .b(new_n102_), .O(z17));
  ...
  nand2  g080(.a(new_n163_), .b(new_n102_), .O(z18));
  nand2  g081(.a(x08), .b(x00), .O(new_n165_));
  nand2  g082(.a(x30), .b(new_n109_), .O(new_n166_));
  ...
  nand3  g095(.a(x34), .b(new_n97_), .c(new_n169_), .O(new_n179_));
  ...
  nand3  g104(.a(x37), .b(new_n97_), .c(new_n169_), .O(new_n188_));
  ...
  nand2  g110(.a(x38), .b(new_n169_), .O(new_n194_));
  ...
  aoi21  g117(.a(x41), .b(new_n196_), .c(x10), .O(new_n201_));
  nand3  g118(.a(new_n197_), .b(x40), .c(new_n97_), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(new_n169_), .c(new_n202_), .O(z29));
  ...
  aoi21  g123(.a(x43), .b(new_n196_), .c(x10), .O(new_n207_));
  nand3  g124(.a(new_n197_), .b(x42), .c(new_n97_), .O(new_n208_));
  oai21  g125(.a(new_n207_), .b(new_n169_), .c(new_n208_), .O(z31));
  aoi21  g126(.a(x44), .b(new_n196_), .c(x10), .O(new_n210_));
  nand3  g127(.a(new_n197_), .b(x43), .c(new_n97_), .O(new_n211_));
  oai21  g128(.a(new_n210_), .b(new_n169_), .c(new_n211_), .O(z32));
  aoi21  g129(.a(x45), .b(new_n196_), .c(x10), .O(new_n213_));
  nand3  g130(.a(new_n197_), .b(x44), .c(new_n97_), .O(new_n214_));
  oai21  g131(.a(new_n213_), .b(new_n169_), .c(new_n214_), .O(z33));
  aoi21  g132(.a(x46), .b(new_n196_), .c(x10), .O(new_n216_));
  nand3  g133(.a(new_n197_), .b(x45), .c(new_n97_), .O(new_n217_));
  oai21  g134(.a(new_n216_), .b(new_n169_), .c(new_n217_), .O(z34));
  nand2  g135(.a(new_n197_), .b(x46), .O(new_n219_));
  nand3  g136(.a(new_n196_), .b(x09), .c(x00), .O(new_n220_));
