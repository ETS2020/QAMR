...
module FAU ( 
  ...
  aoi21  g068(.a(x26), .b(x08), .c(x42), .O(new_n152_));
  ...
  aoi21  g076(.a(x28), .b(x08), .c(x42), .O(new_n160_));
  ...
  aoi21  g115(.a(x38), .b(x09), .c(x42), .O(new_n199_));
  ...
  aoi21  g121(.a(x38), .b(new_n176_), .c(x42), .O(new_n205_));
  ...
  nand4  g134(.a(new_n207_), .b(new_n85_), .c(x41), .d(new_n84_), .O(new_n218_));
  inv1   g135(.a(new_n218_), .O(z30));
  nand3  g136(.a(x43), .b(new_n100_), .c(x09), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n85_), .c(x10), .O(z31));
  oai21  g138(.a(x14), .b(new_n176_), .c(x43), .O(new_n222_));
  ...
  oai21  g143(.a(x14), .b(new_n176_), .c(x44), .O(new_n227_));
  ...
  oai21  g148(.a(x14), .b(new_n176_), .c(x45), .O(new_n232_));
  ...
  nand2  g153(.a(new_n207_), .b(x46), .O(new_n237_));
  nor2   g154(.a(x14), .b(new_n176_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(x00), .c(x42), .O(new_n239_));
