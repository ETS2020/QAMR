...
module FAU ( 
  ...
  nand3  g033(.a(x19), .b(new_n91_), .c(new_n109_), .O(new_n117_));
  ...
  nand3  g060(.a(x28), .b(new_n91_), .c(new_n109_), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(new_n143_), .O(z17));
  nand2  g062(.a(x29), .b(new_n109_), .O(new_n146_));
  ...
  nand2  g072(.a(new_n155_), .b(new_n96_), .O(z20));
  ...
  nand2  g081(.a(new_n164_), .b(new_n96_), .O(z22));
  ...
  nand2  g085(.a(new_n168_), .b(new_n96_), .O(z23));
  ...
  nand2  g093(.a(new_n176_), .b(new_n96_), .O(z25));
  ...
  oai21  g103(.a(new_n186_), .b(x10), .c(new_n96_), .O(z27));
  ...
  nand2  g113(.a(new_n196_), .b(new_n96_), .O(z29));
  ...
  nand2  g119(.a(new_n202_), .b(new_n96_), .O(z30));
  ...
  nand2  g125(.a(new_n208_), .b(new_n96_), .O(z31));
  ...
  nand3  g134(.a(x46), .b(new_n98_), .c(x09), .O(new_n218_));
