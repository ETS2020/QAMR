...
module FAU ( 
  ...
  nand2  g044(.a(new_n127_), .b(new_n90_), .O(z09));
  ...
  oai21  g108(.a(x38), .b(x10), .c(new_n89_), .O(new_n192_));
  ...
  nand3  g119(.a(x42), .b(new_n101_), .c(x09), .O(new_n203_));
  ...
  oai21  g126(.a(x43), .b(x10), .c(new_n89_), .O(new_n210_));
  ...
  oai21  g132(.a(x44), .b(x10), .c(new_n89_), .O(new_n216_));
  nand2  g133(.a(x44), .b(x14), .O(new_n217_));
  nand3  g134(.a(x45), .b(new_n101_), .c(x09), .O(new_n218_));
  ...
  oai21  g138(.a(x45), .b(x10), .c(new_n89_), .O(new_n222_));
  ...
  oai21  g144(.a(x46), .b(x10), .c(new_n89_), .O(new_n228_));
