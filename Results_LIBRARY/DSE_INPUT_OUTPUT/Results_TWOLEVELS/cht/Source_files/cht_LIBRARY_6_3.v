...
module FAU ( 
  ...
  nand2  g009(.a(x42), .b(x10), .O(new_n93_));
  ...
  nand2  g044(.a(x23), .b(new_n112_), .O(new_n128_));
  nand2  g045(.a(x24), .b(x08), .O(new_n129_));
  aoi21  g046(.a(new_n129_), .b(new_n128_), .c(x10), .O(z12));
  nand2  g047(.a(x24), .b(new_n112_), .O(new_n131_));
  ...
  nand2  g054(.a(new_n137_), .b(new_n93_), .O(z14));
  ...
  nand2  g063(.a(x28), .b(new_n112_), .O(new_n147_));
  ...
  nand2  g070(.a(x30), .b(new_n112_), .O(new_n154_));
  ...
  nand2  g090(.a(new_n173_), .b(new_n93_), .O(z23));
  ...
  nand2  g098(.a(x37), .b(new_n156_), .O(new_n182_));
  oai21  g099(.a(new_n181_), .b(new_n156_), .c(new_n182_), .O(new_n183_));
  ...
  nand2  g119(.a(new_n202_), .b(new_n93_), .O(z29));
  ...
  nand3  g124(.a(new_n192_), .b(new_n88_), .c(x09), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(x42), .O(new_n209_));
  nand4  g126(.a(x43), .b(new_n192_), .c(new_n88_), .d(x09), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n209_), .O(z31));
  nand2  g128(.a(new_n204_), .b(x43), .O(new_n212_));
  nand3  g129(.a(x44), .b(new_n192_), .c(x09), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(x10), .O(z32));
  nand2  g131(.a(new_n204_), .b(x44), .O(new_n215_));
  nand3  g132(.a(x45), .b(new_n192_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z33));
  nand2  g134(.a(new_n204_), .b(x45), .O(new_n218_));
  nand3  g135(.a(x46), .b(new_n192_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z34));
  inv1   g137(.a(x46), .O(new_n221_));
  aoi21  g138(.a(new_n192_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(new_n192_), .b(x09), .c(x00), .O(new_n223_));
