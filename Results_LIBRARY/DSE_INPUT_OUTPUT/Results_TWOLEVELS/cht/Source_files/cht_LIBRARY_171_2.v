...
module FAU ( 
  ...
  aoi21  g097(.a(new_n180_), .b(new_n91_), .c(x10), .O(z20));
  inv1   g098(.a(x32), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n91_), .c(x10), .O(z21));
  inv1   g100(.a(x33), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n91_), .c(x10), .O(z22));
  inv1   g102(.a(x34), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n91_), .c(x10), .O(z23));
  inv1   g104(.a(x35), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n91_), .c(x10), .O(z24));
  inv1   g106(.a(x36), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n91_), .c(x10), .O(z25));
  nor2   g108(.a(x10), .b(x09), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(x37), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z26));
  nand2  g111(.a(new_n192_), .b(x38), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z27));
  nand2  g113(.a(new_n192_), .b(x39), .O(new_n197_));
  inv1   g114(.a(new_n197_), .O(z28));
  inv1   g115(.a(x40), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n91_), .c(x10), .O(z29));
  nand2  g117(.a(new_n192_), .b(x41), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(z30));
  nand2  g119(.a(new_n192_), .b(x42), .O(new_n203_));
  ...
  aoi21  g124(.a(new_n207_), .b(new_n91_), .c(x10), .O(z33));
  nand2  g125(.a(new_n192_), .b(x45), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  nand2  g127(.a(new_n192_), .b(x46), .O(new_n211_));
