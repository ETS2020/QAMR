...
module FAU ( 
  ...
  oai21  g031(.a(new_n85_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand2  g032(.a(new_n115_), .b(new_n84_), .O(new_n116_));
  nand2  g033(.a(new_n116_), .b(new_n86_), .O(z06));
  oai21  g034(.a(x19), .b(new_n113_), .c(x18), .O(new_n118_));
  ...
  oai21  g040(.a(new_n122_), .b(new_n113_), .c(new_n123_), .O(new_n124_));
  ...
  oai21  g066(.a(new_n119_), .b(new_n113_), .c(new_n149_), .O(new_n150_));
