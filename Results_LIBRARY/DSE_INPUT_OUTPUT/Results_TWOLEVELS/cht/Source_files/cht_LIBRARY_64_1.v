...
module FAU ( 
  ...
  nand2  g002(.a(x35), .b(new_n85_), .O(new_n86_));
  ...
  nand2  g094(.a(new_n177_), .b(new_n86_), .O(z20));
  ...
  nand2  g098(.a(new_n181_), .b(new_n86_), .O(z21));
  ...
  nand2  g103(.a(new_n186_), .b(new_n86_), .O(z22));
  ...
  nand2  g107(.a(new_n190_), .b(new_n86_), .O(z23));
  inv1   g108(.a(x36), .O(new_n192_));
  nand2  g109(.a(new_n192_), .b(x09), .O(new_n193_));
  nand3  g110(.a(new_n193_), .b(x35), .c(x17), .O(new_n194_));
