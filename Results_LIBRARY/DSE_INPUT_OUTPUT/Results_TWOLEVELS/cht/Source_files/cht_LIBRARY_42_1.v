...
module FAU ( 
  ...
  nand2  g029(.a(x18), .b(new_n93_), .O(new_n113_));
  ...
  nand2  g066(.a(x30), .b(new_n93_), .O(new_n150_));
  ...
  nand2  g072(.a(new_n155_), .b(new_n94_), .O(z20));
  ...
  nand2  g090(.a(new_n173_), .b(new_n94_), .O(z25));
  ...
  oai21  g100(.a(new_n183_), .b(x10), .c(new_n94_), .O(z27));
  ...
  nand2  g111(.a(new_n194_), .b(new_n94_), .O(z29));
  ...
  nand2  g117(.a(new_n200_), .b(new_n94_), .O(z30));
  ...
  nand2  g123(.a(new_n206_), .b(new_n94_), .O(z31));
  ...
  nand2  g129(.a(new_n212_), .b(new_n94_), .O(z32));
  ...
  nand2  g135(.a(new_n218_), .b(new_n94_), .O(z33));
  ...
  nand2  g141(.a(new_n224_), .b(new_n94_), .O(z34));
