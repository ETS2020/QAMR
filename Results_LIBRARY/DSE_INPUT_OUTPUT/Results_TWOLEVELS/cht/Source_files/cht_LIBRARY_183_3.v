...
module FAU ( 
  ...
  nand2  g001(.a(x40), .b(x35), .O(new_n85_));
  ...
  oai21  g080(.a(new_n163_), .b(x10), .c(new_n85_), .O(z16));
  ...
  nand2  g103(.a(new_n186_), .b(new_n85_), .O(z21));
  ...
  nand2  g108(.a(new_n191_), .b(new_n85_), .O(z22));
  ...
  oai21  g133(.a(new_n216_), .b(x10), .c(new_n85_), .O(z27));
  nand2  g134(.a(new_n101_), .b(x09), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n211_), .O(new_n219_));
  nand3  g136(.a(new_n219_), .b(x40), .c(new_n197_), .O(new_n220_));
  ...
  nand2  g140(.a(x40), .b(new_n197_), .O(new_n224_));
  nand3  g141(.a(new_n221_), .b(new_n101_), .c(x09), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n224_), .O(new_n226_));
  nand2  g143(.a(new_n226_), .b(x41), .O(new_n227_));
  nand3  g144(.a(new_n218_), .b(x40), .c(new_n197_), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z29));
  oai21  g146(.a(x14), .b(new_n178_), .c(x41), .O(new_n230_));
  ...
  nand3  g163(.a(x45), .b(new_n101_), .c(x09), .O(new_n247_));
