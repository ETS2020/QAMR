...
module FAU ( 
  ...
  nor2   g045(.a(x22), .b(x08), .O(new_n129_));
  oai21  g046(.a(new_n129_), .b(x21), .c(x20), .O(new_n130_));
  nand2  g047(.a(x21), .b(x08), .O(new_n131_));
  aoi21  g048(.a(new_n131_), .b(new_n130_), .c(x10), .O(z09));
  oai21  g049(.a(x22), .b(new_n114_), .c(x21), .O(new_n133_));
  nor2   g050(.a(new_n133_), .b(x10), .O(z10));
  inv1   g051(.a(x23), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(x08), .O(new_n136_));
  nand3  g053(.a(new_n136_), .b(x22), .c(x21), .O(new_n137_));
  inv1   g054(.a(x22), .O(new_n138_));
  nand3  g055(.a(x23), .b(new_n138_), .c(x08), .O(new_n139_));
  aoi21  g056(.a(new_n139_), .b(new_n137_), .c(x10), .O(z11));
  nand2  g057(.a(x24), .b(x08), .O(new_n141_));
  oai21  g058(.a(new_n135_), .b(x08), .c(new_n141_), .O(new_n142_));
  ...
  nand2  g065(.a(new_n148_), .b(new_n86_), .O(z13));
  ...
  nand2  g153(.a(new_n236_), .b(new_n86_), .O(z31));
