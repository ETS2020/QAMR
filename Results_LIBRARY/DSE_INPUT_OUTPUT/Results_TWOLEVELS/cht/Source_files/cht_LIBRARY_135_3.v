...
module FAU ( 
  ...
  nand2  g051(.a(new_n134_), .b(new_n93_), .O(z11));
  ...
  nand2  g067(.a(new_n150_), .b(new_n93_), .O(z15));
  ...
  nand2  g072(.a(new_n155_), .b(new_n93_), .O(z16));
  ...
  nand3  g093(.a(x34), .b(new_n88_), .c(new_n166_), .O(new_n177_));
  ...
  nand3  g099(.a(x36), .b(new_n88_), .c(new_n166_), .O(new_n183_));
  ...
  aoi21  g114(.a(x41), .b(new_n98_), .c(x10), .O(new_n198_));
  nand3  g115(.a(new_n194_), .b(x40), .c(new_n88_), .O(new_n199_));
  oai21  g116(.a(new_n198_), .b(new_n166_), .c(new_n199_), .O(z29));
  ...
  aoi21  g126(.a(x45), .b(new_n98_), .c(x10), .O(new_n210_));
  nand3  g127(.a(new_n194_), .b(x44), .c(new_n88_), .O(new_n211_));
  oai21  g128(.a(new_n210_), .b(new_n166_), .c(new_n211_), .O(z33));
  aoi21  g129(.a(x46), .b(new_n98_), .c(x10), .O(new_n213_));
  nand3  g130(.a(new_n194_), .b(x45), .c(new_n88_), .O(new_n214_));
  oai21  g131(.a(new_n213_), .b(new_n166_), .c(new_n214_), .O(z34));
  nand2  g132(.a(new_n194_), .b(x46), .O(new_n216_));
