...
module FAU ( 
  ...
  nand2  g009(.a(x33), .b(x10), .O(new_n93_));
  ...
  nand2  g039(.a(x19), .b(new_n113_), .O(new_n123_));
  ...
  nand2  g054(.a(new_n137_), .b(new_n93_), .O(z11));
  ...
  nand3  g089(.a(x32), .b(new_n88_), .c(new_n168_), .O(new_n173_));
  ...
  nand2  g098(.a(new_n181_), .b(new_n93_), .O(z23));
  nand2  g099(.a(x35), .b(new_n168_), .O(new_n183_));
  nand2  g100(.a(x36), .b(x09), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z24));
  inv1   g102(.a(x37), .O(new_n186_));
  nand2  g103(.a(x36), .b(new_n168_), .O(new_n187_));
  oai21  g104(.a(new_n186_), .b(new_n168_), .c(new_n187_), .O(new_n188_));
  nand2  g105(.a(new_n188_), .b(new_n88_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n93_), .O(z25));
  ...
  nand2  g110(.a(new_n193_), .b(new_n93_), .O(z26));
  ...
  oai21  g117(.a(new_n200_), .b(x10), .c(new_n93_), .O(z27));
  ...
  nand2  g148(.a(new_n231_), .b(new_n93_), .O(z34));
  ...
  oai21  g153(.a(new_n236_), .b(new_n234_), .c(new_n88_), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n93_), .O(z35));
endmodule
