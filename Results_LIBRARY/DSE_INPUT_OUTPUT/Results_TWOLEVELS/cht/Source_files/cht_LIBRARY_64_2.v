...
module FAU ( 
  ...
  nand2  g099(.a(new_n182_), .b(new_n86_), .O(z21));
  ...
  nand2  g108(.a(new_n191_), .b(new_n86_), .O(z23));
  oai21  g109(.a(x36), .b(new_n174_), .c(x35), .O(new_n193_));
  nand3  g110(.a(x36), .b(new_n113_), .c(x09), .O(new_n194_));
  ...
  nand2  g122(.a(x39), .b(new_n100_), .O(new_n206_));
  ...
  nand3  g129(.a(x40), .b(new_n100_), .c(x09), .O(new_n213_));
  inv1   g130(.a(new_n213_), .O(new_n214_));
  aoi21  g131(.a(new_n212_), .b(x39), .c(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(x10), .c(new_n86_), .O(z28));
  ...
  oai21  g156(.a(new_n239_), .b(x10), .c(new_n86_), .O(z33));
