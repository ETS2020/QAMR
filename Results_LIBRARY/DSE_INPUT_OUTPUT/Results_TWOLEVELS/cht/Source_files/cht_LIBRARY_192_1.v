...
module FAU ( 
  ...
  nand2  g031(.a(x18), .b(new_n89_), .O(new_n115_));
  nand2  g032(.a(x19), .b(x08), .O(new_n116_));
  aoi21  g033(.a(new_n116_), .b(new_n115_), .c(x10), .O(z07));
  oai21  g034(.a(x19), .b(x10), .c(new_n89_), .O(new_n118_));
  nand3  g035(.a(x20), .b(new_n84_), .c(x08), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(new_n118_), .O(z08));
  oai21  g037(.a(x20), .b(x10), .c(new_n89_), .O(new_n121_));
  nand3  g038(.a(x21), .b(new_n84_), .c(x08), .O(new_n122_));
  ...
  nand2  g081(.a(x33), .b(new_n154_), .O(new_n165_));
  oai21  g082(.a(new_n164_), .b(new_n154_), .c(new_n165_), .O(new_n166_));
  nand2  g083(.a(new_n166_), .b(new_n84_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n90_), .O(z22));
  ...
  nand2  g089(.a(x35), .b(new_n154_), .O(new_n173_));
  nand2  g090(.a(x36), .b(x09), .O(new_n174_));
  aoi21  g091(.a(new_n174_), .b(new_n173_), .c(x10), .O(z24));
  nand2  g092(.a(x36), .b(new_n154_), .O(new_n176_));
  ...
  nand2  g104(.a(x38), .b(new_n154_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z27));
  inv1   g106(.a(x14), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(x09), .c(new_n184_), .O(new_n191_));
  ...
  nand2  g111(.a(new_n194_), .b(new_n90_), .O(z28));
  inv1   g112(.a(x40), .O(new_n196_));
  aoi21  g113(.a(new_n190_), .b(x09), .c(new_n196_), .O(new_n197_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n90_), .O(z29));
  nand2  g118(.a(new_n190_), .b(x09), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(x41), .O(new_n203_));
  nand3  g120(.a(x42), .b(new_n190_), .c(x09), .O(new_n204_));
  ...
  aoi21  g126(.a(new_n190_), .b(x09), .c(new_n209_), .O(new_n210_));
  nand3  g127(.a(x44), .b(new_n190_), .c(x09), .O(new_n211_));
  inv1   g128(.a(new_n211_), .O(new_n212_));
  oai21  g129(.a(new_n212_), .b(new_n210_), .c(new_n84_), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(new_n90_), .O(z32));
  ...
  aoi21  g138(.a(new_n190_), .b(x09), .c(new_n221_), .O(new_n222_));
  nand3  g139(.a(x46), .b(new_n190_), .c(x09), .O(new_n223_));
  ...
  aoi21  g144(.a(new_n190_), .b(x09), .c(new_n227_), .O(new_n228_));
  nand3  g145(.a(new_n190_), .b(x09), .c(x00), .O(new_n229_));
  inv1   g146(.a(new_n229_), .O(new_n230_));
  oai21  g147(.a(new_n230_), .b(new_n228_), .c(new_n84_), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(new_n90_), .O(z35));
endmodule
