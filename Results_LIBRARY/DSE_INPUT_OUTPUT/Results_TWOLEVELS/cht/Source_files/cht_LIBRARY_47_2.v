...
module FAU ( 
  ...
  oai21  g038(.a(x20), .b(new_n112_), .c(x19), .O(new_n122_));
  nand3  g039(.a(x20), .b(new_n90_), .c(x08), .O(new_n123_));
  ...
  nand3  g044(.a(new_n127_), .b(new_n88_), .c(new_n94_), .O(new_n128_));
  ...
  nand2  g049(.a(new_n132_), .b(new_n88_), .O(z10));
  inv1   g050(.a(x23), .O(new_n134_));
  nand2  g051(.a(x22), .b(new_n112_), .O(new_n135_));
  oai21  g052(.a(new_n134_), .b(new_n112_), .c(new_n135_), .O(new_n136_));
  ...
  nand3  g057(.a(new_n140_), .b(new_n88_), .c(new_n94_), .O(new_n141_));
  ...
  nand3  g071(.a(new_n154_), .b(new_n88_), .c(new_n94_), .O(new_n155_));
  ...
  nand2  g076(.a(new_n159_), .b(new_n88_), .O(z16));
  inv1   g077(.a(x29), .O(new_n161_));
  nand2  g078(.a(x28), .b(new_n112_), .O(new_n162_));
  oai21  g079(.a(new_n161_), .b(new_n112_), .c(new_n162_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n94_), .O(new_n164_));
  nand2  g081(.a(new_n164_), .b(new_n88_), .O(z17));
  ...
  nand2  g085(.a(new_n168_), .b(new_n88_), .O(z18));
  inv1   g086(.a(x00), .O(new_n170_));
  nand2  g087(.a(x30), .b(new_n112_), .O(new_n171_));
  oai21  g088(.a(new_n112_), .b(new_n170_), .c(new_n171_), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n94_), .O(new_n173_));
  nand2  g090(.a(new_n173_), .b(new_n88_), .O(z19));
  ...
  nand3  g095(.a(new_n178_), .b(new_n88_), .c(new_n94_), .O(new_n179_));
  ...
  oai21  g138(.a(new_n221_), .b(x10), .c(new_n88_), .O(z29));
  ...
  and2   g160(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  oai21  g161(.a(new_n244_), .b(x10), .c(new_n88_), .O(z34));
  nand2  g162(.a(new_n214_), .b(x46), .O(new_n246_));
  oai21  g163(.a(new_n214_), .b(new_n170_), .c(new_n246_), .O(new_n247_));
  nand3  g164(.a(new_n247_), .b(new_n88_), .c(new_n94_), .O(new_n248_));
