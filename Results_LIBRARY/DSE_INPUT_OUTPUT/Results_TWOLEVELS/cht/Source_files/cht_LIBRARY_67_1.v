...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n85_), .c(x32), .O(new_n106_));
  ...
  aoi21  g040(.a(x20), .b(x08), .c(x32), .O(new_n124_));
  ...
  aoi21  g057(.a(x24), .b(x08), .c(x32), .O(new_n141_));
  ...
  aoi21  g083(.a(x30), .b(new_n113_), .c(x32), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z19));
  inv1   g085(.a(x09), .O(new_n169_));
  nand4  g086(.a(new_n89_), .b(x31), .c(new_n88_), .d(new_n169_), .O(new_n170_));
  inv1   g087(.a(new_n170_), .O(z20));
  nand2  g088(.a(x33), .b(x09), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n89_), .c(x10), .O(z21));
  ...
  aoi21  g115(.a(x38), .b(new_n169_), .c(x32), .O(new_n199_));
  ...
  aoi21  g126(.a(new_n209_), .b(x09), .c(x32), .O(new_n210_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x32), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n212_), .c(x10), .O(z30));
  oai21  g133(.a(x14), .b(new_n169_), .c(x42), .O(new_n217_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x32), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n222_), .c(x10), .O(z32));
  oai21  g143(.a(x14), .b(new_n169_), .c(x44), .O(new_n227_));
  ...
  oai21  g148(.a(x14), .b(new_n169_), .c(x45), .O(new_n232_));
  nand3  g149(.a(x46), .b(new_n100_), .c(x09), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(new_n232_), .O(new_n234_));
  nand3  g151(.a(new_n234_), .b(new_n89_), .c(new_n88_), .O(new_n235_));
  inv1   g152(.a(new_n235_), .O(z34));
  nand2  g153(.a(new_n206_), .b(x46), .O(new_n237_));
  nor2   g154(.a(x14), .b(new_n169_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(x00), .c(x32), .O(new_n239_));
