...
module FAU ( 
  ...
  nand2  g028(.a(x17), .b(new_n96_), .O(new_n112_));
  nand2  g029(.a(x18), .b(x08), .O(new_n113_));
  aoi21  g030(.a(new_n113_), .b(new_n112_), .c(x10), .O(z06));
  oai21  g031(.a(x18), .b(x10), .c(new_n96_), .O(new_n115_));
  nand3  g032(.a(x19), .b(new_n91_), .c(x08), .O(new_n116_));
  nand2  g033(.a(new_n116_), .b(new_n115_), .O(z07));
  oai21  g034(.a(x19), .b(x10), .c(new_n96_), .O(new_n118_));
  nand3  g035(.a(x20), .b(new_n91_), .c(x08), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(new_n118_), .O(z08));
  nand2  g037(.a(x20), .b(new_n96_), .O(new_n121_));
  nand2  g038(.a(x21), .b(x08), .O(new_n122_));
  aoi21  g039(.a(new_n122_), .b(new_n121_), .c(x10), .O(z09));
  nand2  g040(.a(x21), .b(new_n96_), .O(new_n124_));
  nand2  g041(.a(x22), .b(x08), .O(new_n125_));
  aoi21  g042(.a(new_n125_), .b(new_n124_), .c(x10), .O(z10));
  nand2  g043(.a(x22), .b(new_n96_), .O(new_n127_));
  nand2  g044(.a(x23), .b(x08), .O(new_n128_));
  aoi21  g045(.a(new_n128_), .b(new_n127_), .c(x10), .O(z11));
  nand2  g046(.a(x23), .b(new_n96_), .O(new_n130_));
  nand2  g047(.a(x24), .b(x08), .O(new_n131_));
  aoi21  g048(.a(new_n131_), .b(new_n130_), .c(x10), .O(z12));
  nand2  g049(.a(x24), .b(new_n96_), .O(new_n133_));
  nand2  g050(.a(x25), .b(x08), .O(new_n134_));
  aoi21  g051(.a(new_n134_), .b(new_n133_), .c(x10), .O(z13));
  oai21  g052(.a(x25), .b(x10), .c(new_n96_), .O(new_n136_));
  nand3  g053(.a(x26), .b(new_n91_), .c(x08), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n136_), .O(z14));
  nand2  g055(.a(x26), .b(new_n96_), .O(new_n139_));
  nand2  g056(.a(x27), .b(x08), .O(new_n140_));
  aoi21  g057(.a(new_n140_), .b(new_n139_), .c(x10), .O(z15));
  oai21  g058(.a(x27), .b(x10), .c(new_n96_), .O(new_n142_));
  nand3  g059(.a(x28), .b(new_n91_), .c(x08), .O(new_n143_));
  nand2  g060(.a(new_n143_), .b(new_n142_), .O(z16));
  oai21  g061(.a(x28), .b(x10), .c(new_n96_), .O(new_n145_));
  nand3  g062(.a(x29), .b(new_n91_), .c(x08), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n145_), .O(z17));
  oai21  g064(.a(x29), .b(x10), .c(new_n96_), .O(new_n148_));
  nand3  g065(.a(x30), .b(new_n91_), .c(x08), .O(new_n149_));
  nand2  g066(.a(new_n149_), .b(new_n148_), .O(z18));
  oai21  g067(.a(x30), .b(x10), .c(new_n96_), .O(new_n151_));
  nand3  g068(.a(new_n91_), .b(x08), .c(x00), .O(new_n152_));
  ...
  nand2  g088(.a(new_n171_), .b(new_n97_), .O(z24));
  ...
  nand2  g132(.a(new_n188_), .b(x45), .O(new_n216_));
  nand3  g133(.a(x46), .b(new_n99_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z34));
  nand2  g135(.a(new_n188_), .b(x46), .O(new_n219_));
  nand3  g136(.a(new_n99_), .b(x09), .c(x00), .O(new_n220_));
