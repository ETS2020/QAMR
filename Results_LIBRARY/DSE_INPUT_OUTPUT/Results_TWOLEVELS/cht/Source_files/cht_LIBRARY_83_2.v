...
module FAU ( 
  ...
  aoi21  g033(.a(new_n116_), .b(new_n94_), .c(x10), .O(z09));
  ...
  nand3  g080(.a(new_n163_), .b(new_n162_), .c(new_n94_), .O(new_n164_));
  ...
  nand3  g095(.a(new_n178_), .b(new_n95_), .c(new_n94_), .O(new_n179_));
  ...
  nand3  g100(.a(new_n183_), .b(new_n95_), .c(new_n94_), .O(new_n184_));
  ...
  nand3  g121(.a(new_n204_), .b(new_n95_), .c(new_n94_), .O(new_n205_));
