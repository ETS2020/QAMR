...
module FAU ( 
  ...
  nand2  g086(.a(new_n169_), .b(new_n90_), .O(z21));
  ...
  aoi21  g122(.a(new_n194_), .b(x09), .c(new_n205_), .O(new_n206_));
  ...
  aoi21  g128(.a(new_n194_), .b(x09), .c(new_n211_), .O(new_n212_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n90_), .O(z31));
  nand2  g133(.a(new_n195_), .b(x43), .O(new_n217_));
  nand3  g134(.a(x44), .b(new_n194_), .c(x09), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n217_), .c(x10), .O(z32));
  inv1   g136(.a(x44), .O(new_n220_));
  aoi21  g137(.a(new_n194_), .b(x09), .c(new_n220_), .O(new_n221_));
  ...
  aoi21  g146(.a(new_n194_), .b(x09), .c(new_n229_), .O(new_n230_));
