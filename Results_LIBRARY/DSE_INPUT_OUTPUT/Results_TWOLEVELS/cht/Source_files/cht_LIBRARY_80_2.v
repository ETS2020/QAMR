...
module FAU ( 
  ...
  inv1   g003(.a(x44), .O(new_n87_));
  nand2  g004(.a(new_n87_), .b(x22), .O(new_n88_));
  ...
  nor2   g048(.a(x22), .b(x08), .O(new_n132_));
  inv1   g049(.a(x22), .O(new_n133_));
  nor2   g050(.a(new_n87_), .b(new_n133_), .O(new_n134_));
  oai21  g051(.a(new_n134_), .b(new_n132_), .c(x21), .O(new_n135_));
  nand2  g052(.a(new_n134_), .b(x08), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n135_), .c(x10), .O(z10));
  inv1   g054(.a(x23), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(x08), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(x44), .c(x22), .O(new_n140_));
  nand3  g057(.a(x23), .b(new_n133_), .c(x08), .O(new_n141_));
  ...
  nand3  g152(.a(new_n133_), .b(new_n101_), .c(x09), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n87_), .O(new_n237_));
