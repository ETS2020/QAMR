...
module FAU ( 
  ...
  nand2  g080(.a(new_n163_), .b(new_n89_), .O(z20));
  ...
  nand2  g100(.a(x37), .b(new_n159_), .O(new_n184_));
  ...
  oai21  g107(.a(x10), .b(new_n159_), .c(x38), .O(new_n191_));
  ...
  aoi21  g118(.a(new_n193_), .b(x09), .c(new_n201_), .O(new_n202_));
  nand3  g119(.a(x42), .b(new_n193_), .c(x09), .O(new_n203_));
  ...
  aoi21  g124(.a(new_n193_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand3  g125(.a(x43), .b(new_n193_), .c(x09), .O(new_n209_));
  ...
  aoi21  g130(.a(new_n193_), .b(x09), .c(new_n213_), .O(new_n214_));
  nand3  g131(.a(x44), .b(new_n193_), .c(x09), .O(new_n215_));
  ...
  nand3  g136(.a(x45), .b(new_n193_), .c(x09), .O(new_n220_));
  ...
  nand3  g140(.a(x46), .b(new_n193_), .c(x09), .O(new_n224_));
  ...
  nand2  g144(.a(new_n194_), .b(x46), .O(new_n228_));
  nand3  g145(.a(new_n193_), .b(x09), .c(x00), .O(new_n229_));
