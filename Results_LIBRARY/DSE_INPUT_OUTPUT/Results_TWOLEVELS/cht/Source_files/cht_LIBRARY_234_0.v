...
module FAU ( 
  ...
  nand3  g064(.a(new_n147_), .b(new_n92_), .c(x09), .O(new_n148_));
  ...
  nand3  g087(.a(x33), .b(new_n92_), .c(x09), .O(new_n171_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n92_), .c(x09), .O(new_n195_));
  ...
  nand3  g116(.a(new_n199_), .b(new_n92_), .c(x09), .O(new_n200_));
  ...
  and2   g121(.a(new_n204_), .b(new_n92_), .O(z31));
  ...
  nand2  g128(.a(x45), .b(new_n98_), .O(new_n212_));
  nand3  g129(.a(new_n212_), .b(new_n211_), .c(x09), .O(new_n213_));
  and2   g130(.a(new_n213_), .b(new_n92_), .O(z33));
