...
module FAU ( 
  ...
  nand2  g018(.a(new_n101_), .b(new_n86_), .O(z02));
  inv1   g019(.a(x14), .O(new_n103_));
  nand2  g020(.a(x07), .b(x01), .O(new_n104_));
  oai21  g021(.a(new_n103_), .b(x07), .c(new_n104_), .O(new_n105_));
  nand3  g022(.a(new_n105_), .b(new_n86_), .c(new_n84_), .O(new_n106_));
  ...
  oai21  g057(.a(new_n140_), .b(x10), .c(new_n86_), .O(z10));
  nor2   g058(.a(new_n85_), .b(x08), .O(new_n142_));
  aoi21  g059(.a(x23), .b(x08), .c(new_n142_), .O(new_n143_));
  oai21  g060(.a(new_n143_), .b(x10), .c(new_n86_), .O(z11));
  ...
  nand2  g102(.a(new_n185_), .b(new_n86_), .O(z20));
  ...
  nand2  g120(.a(new_n203_), .b(new_n86_), .O(z24));
  ...
  oai21  g135(.a(new_n218_), .b(x10), .c(new_n86_), .O(z27));
  ...
  nand3  g139(.a(new_n222_), .b(new_n86_), .c(new_n84_), .O(new_n223_));
  ...
  nand2  g146(.a(new_n229_), .b(new_n86_), .O(z29));
  ...
  nand2  g152(.a(new_n235_), .b(new_n86_), .O(z30));
  ...
  nand2  g158(.a(new_n241_), .b(new_n86_), .O(z31));
  ...
  nand2  g174(.a(new_n257_), .b(new_n86_), .O(z34));
  ...
  nand2  g180(.a(new_n263_), .b(new_n86_), .O(z35));
endmodule
