...
module FAU ( 
  ...
  nand2  g042(.a(x21), .b(new_n115_), .O(new_n126_));
  ...
  nand2  g067(.a(x27), .b(new_n115_), .O(new_n151_));
  ...
  oai21  g072(.a(new_n154_), .b(new_n115_), .c(new_n155_), .O(new_n156_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n94_), .O(z18));
  ...
  nand2  g093(.a(new_n176_), .b(new_n94_), .O(z22));
  ...
  oai21  g115(.a(new_n198_), .b(x10), .c(new_n94_), .O(z27));
  ...
  aoi21  g125(.a(new_n200_), .b(x09), .c(new_n208_), .O(new_n209_));
  ...
  aoi21  g131(.a(new_n200_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  aoi21  g143(.a(new_n200_), .b(x09), .c(new_n226_), .O(new_n227_));
  nand3  g144(.a(x45), .b(new_n200_), .c(x09), .O(new_n228_));
  ...
  nand3  g150(.a(x46), .b(new_n200_), .c(x09), .O(new_n234_));
  ...
  nand2  g154(.a(new_n201_), .b(x46), .O(new_n238_));
