...
module FAU ( 
  ...
  nor2   g026(.a(new_n87_), .b(x08), .O(new_n110_));
  aoi21  g027(.a(x18), .b(x08), .c(new_n110_), .O(new_n111_));
  oai21  g028(.a(new_n111_), .b(x10), .c(new_n88_), .O(z06));
  ...
  nand3  g033(.a(new_n116_), .b(new_n88_), .c(new_n113_), .O(new_n117_));
  ...
  nand3  g042(.a(new_n125_), .b(new_n88_), .c(new_n113_), .O(new_n126_));
  ...
  nand3  g047(.a(new_n130_), .b(new_n88_), .c(new_n113_), .O(new_n131_));
  ...
  nand3  g056(.a(new_n139_), .b(new_n88_), .c(new_n113_), .O(new_n140_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n88_), .c(new_n113_), .O(new_n149_));
  ...
  nand3  g074(.a(new_n157_), .b(new_n88_), .c(new_n113_), .O(new_n158_));
  ...
  nand3  g083(.a(new_n166_), .b(new_n88_), .c(new_n113_), .O(new_n167_));
  ...
  nand3  g097(.a(new_n180_), .b(new_n88_), .c(new_n113_), .O(new_n181_));
  ...
  nand3  g106(.a(new_n189_), .b(new_n88_), .c(new_n113_), .O(new_n190_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n88_), .c(new_n113_), .O(new_n195_));
  ...
  nand3  g131(.a(new_n214_), .b(x40), .c(x17), .O(new_n215_));
  ...
  nand3  g135(.a(new_n216_), .b(new_n98_), .c(x09), .O(new_n219_));
  oai21  g136(.a(new_n216_), .b(new_n87_), .c(new_n219_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(x41), .O(new_n221_));
  nand3  g138(.a(new_n213_), .b(x40), .c(x17), .O(new_n222_));
  ...
  nand3  g151(.a(new_n234_), .b(new_n88_), .c(new_n113_), .O(new_n235_));
  ...
  nand3  g164(.a(new_n247_), .b(new_n88_), .c(new_n113_), .O(new_n248_));
