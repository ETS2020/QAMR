...
module FAU ( 
  ...
  nand2  g006(.a(x23), .b(new_n89_), .O(new_n90_));
  ...
  oai21  g029(.a(x23), .b(new_n112_), .c(new_n89_), .O(new_n113_));
  ...
  nand2  g056(.a(new_n139_), .b(new_n90_), .O(z10));
  nand3  g057(.a(new_n90_), .b(x22), .c(new_n117_), .O(new_n141_));
  nand3  g058(.a(x23), .b(x16), .c(x08), .O(new_n142_));
  aoi21  g059(.a(new_n142_), .b(new_n141_), .c(x10), .O(z11));
  inv1   g060(.a(x24), .O(new_n144_));
  nand2  g061(.a(new_n144_), .b(x08), .O(new_n145_));
  nand3  g062(.a(new_n145_), .b(x23), .c(x16), .O(new_n146_));
  ...
  oai21  g067(.a(new_n144_), .b(x08), .c(new_n150_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n84_), .O(new_n152_));
  nand2  g069(.a(new_n152_), .b(new_n90_), .O(z13));
  ...
  nand3  g077(.a(new_n160_), .b(new_n90_), .c(new_n84_), .O(new_n161_));
  ...
  nand2  g087(.a(new_n170_), .b(new_n90_), .O(z17));
  ...
  nand2  g102(.a(new_n185_), .b(new_n90_), .O(z20));
  ...
  nand2  g115(.a(new_n198_), .b(new_n90_), .O(z23));
  ...
  nand2  g120(.a(new_n203_), .b(new_n90_), .O(z24));
  ...
  nand2  g146(.a(new_n229_), .b(new_n90_), .O(z29));
  ...
  nand3  g156(.a(new_n239_), .b(new_n90_), .c(new_n84_), .O(new_n240_));
