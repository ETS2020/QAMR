...
module FAU ( 
  ...
  aoi21  g055(.a(x24), .b(x08), .c(x36), .O(new_n139_));
  ...
  aoi21  g067(.a(x27), .b(x08), .c(x36), .O(new_n151_));
  ...
  aoi21  g088(.a(x32), .b(x09), .c(x36), .O(new_n172_));
  ...
  aoi21  g105(.a(new_n188_), .b(new_n85_), .c(x10), .O(z24));
  nand2  g106(.a(x37), .b(x09), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n85_), .c(x10), .O(z25));
  ...
  aoi21  g116(.a(x38), .b(new_n170_), .c(x36), .O(new_n200_));
