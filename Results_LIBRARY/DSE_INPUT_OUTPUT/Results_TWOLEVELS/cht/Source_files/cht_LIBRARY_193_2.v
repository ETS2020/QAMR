...
module FAU ( 
  ...
  nand3  g033(.a(new_n86_), .b(x17), .c(new_n116_), .O(new_n117_));
  nand3  g034(.a(x28), .b(x18), .c(x08), .O(new_n118_));
  ...
  oai21  g043(.a(new_n125_), .b(new_n116_), .c(new_n126_), .O(new_n127_));
  ...
  oai21  g052(.a(new_n134_), .b(new_n116_), .c(new_n135_), .O(new_n136_));
  ...
  nand2  g060(.a(x23), .b(new_n116_), .O(new_n144_));
  ...
  nand2  g069(.a(x25), .b(new_n116_), .O(new_n153_));
  ...
  oai21  g078(.a(new_n85_), .b(new_n116_), .c(new_n161_), .O(new_n162_));
  nand2  g079(.a(new_n162_), .b(new_n84_), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(new_n86_), .O(z16));
  oai21  g081(.a(x29), .b(new_n116_), .c(x28), .O(new_n165_));
  nand3  g082(.a(x29), .b(new_n120_), .c(x08), .O(new_n166_));
  aoi21  g083(.a(new_n166_), .b(new_n165_), .c(x10), .O(z17));
  inv1   g084(.a(x30), .O(new_n168_));
  nand2  g085(.a(x29), .b(new_n116_), .O(new_n169_));
  oai21  g086(.a(new_n168_), .b(new_n116_), .c(new_n169_), .O(new_n170_));
  ...
  nand3  g147(.a(x43), .b(new_n102_), .c(x09), .O(new_n231_));
