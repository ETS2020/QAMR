...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n92_), .c(x26), .O(new_n96_));
  ...
  aoi21  g020(.a(x15), .b(new_n92_), .c(x26), .O(new_n104_));
  ...
  nand4  g061(.a(new_n85_), .b(x25), .c(new_n84_), .d(new_n116_), .O(new_n145_));
  inv1   g062(.a(new_n145_), .O(z14));
  nand2  g063(.a(x27), .b(x08), .O(new_n147_));
  aoi21  g064(.a(new_n147_), .b(new_n85_), .c(x10), .O(z15));
  ...
  aoi21  g127(.a(new_n210_), .b(x09), .c(x26), .O(new_n211_));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(x26), .O(new_n216_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x26), .O(new_n225_));
  ...
  aoi21  g155(.a(new_n238_), .b(x09), .c(x26), .O(new_n239_));
  aoi21  g156(.a(new_n239_), .b(new_n236_), .c(x10), .O(z34));
  nand2  g157(.a(new_n207_), .b(x46), .O(new_n241_));
  aoi21  g158(.a(new_n206_), .b(x00), .c(x26), .O(new_n242_));
