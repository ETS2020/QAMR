...
module FAU ( 
  ...
  nand2  g044(.a(new_n127_), .b(new_n102_), .O(z10));
  ...
  nand2  g060(.a(new_n143_), .b(new_n102_), .O(z14));
  ...
  nand2  g094(.a(x36), .b(new_n162_), .O(new_n178_));
  nand2  g095(.a(x37), .b(x09), .O(new_n179_));
  aoi21  g096(.a(new_n179_), .b(new_n178_), .c(x10), .O(z25));
  nand2  g097(.a(x37), .b(new_n162_), .O(new_n181_));
  ...
  nand2  g104(.a(x38), .b(new_n162_), .O(new_n188_));
  ...
  nand3  g112(.a(new_n191_), .b(x40), .c(new_n97_), .O(new_n196_));
  oai21  g113(.a(new_n195_), .b(new_n162_), .c(new_n196_), .O(z29));
  aoi21  g114(.a(x42), .b(new_n190_), .c(x10), .O(new_n198_));
  nand3  g115(.a(new_n191_), .b(x41), .c(new_n97_), .O(new_n199_));
  oai21  g116(.a(new_n198_), .b(new_n162_), .c(new_n199_), .O(z30));
  nand2  g117(.a(new_n191_), .b(x42), .O(new_n201_));
  nand3  g118(.a(x43), .b(new_n190_), .c(x09), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z31));
  aoi21  g120(.a(x44), .b(new_n190_), .c(x10), .O(new_n204_));
  nand3  g121(.a(new_n191_), .b(x43), .c(new_n97_), .O(new_n205_));
  oai21  g122(.a(new_n204_), .b(new_n162_), .c(new_n205_), .O(z32));
  nand2  g123(.a(new_n191_), .b(x44), .O(new_n207_));
  nand3  g124(.a(x45), .b(new_n190_), .c(x09), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n207_), .c(x10), .O(z33));
  nand2  g126(.a(new_n191_), .b(x45), .O(new_n210_));
  nand3  g127(.a(x46), .b(new_n190_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z34));
  nand2  g129(.a(new_n191_), .b(x46), .O(new_n213_));
  nand3  g130(.a(new_n190_), .b(x09), .c(x00), .O(new_n214_));
