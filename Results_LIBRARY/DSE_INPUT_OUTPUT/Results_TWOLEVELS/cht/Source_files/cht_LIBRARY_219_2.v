...
module FAU ( 
  ...
  nand3  g062(.a(new_n145_), .b(new_n144_), .c(new_n91_), .O(new_n146_));
  ...
  aoi21  g087(.a(new_n170_), .b(new_n91_), .c(x10), .O(z20));
  ...
  aoi21  g096(.a(new_n179_), .b(new_n91_), .c(x10), .O(z24));
  inv1   g097(.a(x36), .O(new_n181_));
  aoi21  g098(.a(new_n181_), .b(new_n91_), .c(x10), .O(z25));
  ...
  aoi21  g104(.a(new_n187_), .b(new_n91_), .c(x10), .O(z28));
  inv1   g105(.a(x40), .O(new_n189_));
  aoi21  g106(.a(new_n189_), .b(new_n91_), .c(x10), .O(z29));
  inv1   g107(.a(x41), .O(new_n191_));
  aoi21  g108(.a(new_n191_), .b(new_n91_), .c(x10), .O(z30));
  nand2  g109(.a(new_n172_), .b(x42), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z31));
  inv1   g111(.a(x43), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n91_), .c(x10), .O(z32));
  inv1   g113(.a(x44), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n91_), .c(x10), .O(z33));
  nand2  g115(.a(new_n172_), .b(x45), .O(new_n199_));
  inv1   g116(.a(new_n199_), .O(z34));
  nand2  g117(.a(new_n172_), .b(x46), .O(new_n201_));
