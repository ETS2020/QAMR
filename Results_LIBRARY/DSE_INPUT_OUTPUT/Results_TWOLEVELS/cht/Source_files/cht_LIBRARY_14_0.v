...
module FAU ( 
  ...
  nand3  g096(.a(new_n179_), .b(new_n89_), .c(new_n91_), .O(new_n180_));
  ...
  nor2   g111(.a(new_n87_), .b(x09), .O(new_n195_));
  aoi21  g112(.a(x36), .b(x09), .c(new_n195_), .O(new_n196_));
  oai21  g113(.a(new_n196_), .b(x10), .c(new_n89_), .O(z24));
  oai21  g114(.a(new_n195_), .b(x37), .c(x36), .O(new_n198_));
  nand2  g115(.a(x37), .b(x09), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n198_), .c(x10), .O(z25));
  oai21  g117(.a(x38), .b(new_n176_), .c(x37), .O(new_n201_));
  nand3  g118(.a(x38), .b(x35), .c(x09), .O(new_n202_));
  ...
  oai21  g126(.a(new_n209_), .b(x10), .c(new_n89_), .O(z27));
  aoi21  g127(.a(new_n102_), .b(x09), .c(new_n204_), .O(new_n211_));
  ...
  aoi21  g133(.a(new_n102_), .b(x09), .c(new_n216_), .O(new_n217_));
  ...
  nand2  g149(.a(new_n232_), .b(new_n89_), .O(z31));
  oai21  g150(.a(x14), .b(new_n176_), .c(x43), .O(new_n234_));
  nand3  g151(.a(x44), .b(new_n102_), .c(x09), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n234_), .O(new_n236_));
  nand3  g153(.a(new_n236_), .b(new_n89_), .c(new_n91_), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(z32));
  oai21  g155(.a(x14), .b(new_n176_), .c(x44), .O(new_n239_));
  ...
  oai21  g160(.a(x14), .b(new_n176_), .c(x45), .O(new_n244_));
  nand3  g161(.a(x46), .b(new_n102_), .c(x09), .O(new_n245_));
  ...
  oai21  g165(.a(x14), .b(new_n176_), .c(x46), .O(new_n249_));
  nand3  g166(.a(new_n102_), .b(x09), .c(x00), .O(new_n250_));
