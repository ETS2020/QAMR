...
module FAU ( 
  ...
  nand3  g090(.a(x33), .b(new_n84_), .c(new_n167_), .O(new_n174_));
  ...
  nand3  g096(.a(x35), .b(new_n84_), .c(new_n167_), .O(new_n180_));
  ...
  oai21  g120(.a(new_n202_), .b(new_n167_), .c(new_n203_), .O(z30));
  aoi21  g121(.a(x43), .b(new_n194_), .c(x10), .O(new_n205_));
  nand3  g122(.a(new_n195_), .b(x42), .c(new_n84_), .O(new_n206_));
  oai21  g123(.a(new_n205_), .b(new_n167_), .c(new_n206_), .O(z31));
  aoi21  g124(.a(x44), .b(new_n194_), .c(x10), .O(new_n208_));
  nand3  g125(.a(new_n195_), .b(x43), .c(new_n84_), .O(new_n209_));
  oai21  g126(.a(new_n208_), .b(new_n167_), .c(new_n209_), .O(z32));
  aoi21  g127(.a(x45), .b(new_n194_), .c(x10), .O(new_n211_));
  nand3  g128(.a(new_n195_), .b(x44), .c(new_n84_), .O(new_n212_));
  oai21  g129(.a(new_n211_), .b(new_n167_), .c(new_n212_), .O(z33));
  nand2  g130(.a(new_n195_), .b(x45), .O(new_n214_));
  nand3  g131(.a(x46), .b(new_n194_), .c(x09), .O(new_n215_));
  aoi21  g132(.a(new_n215_), .b(new_n214_), .c(x10), .O(z34));
  nand2  g133(.a(new_n195_), .b(x46), .O(new_n217_));
  nand3  g134(.a(new_n194_), .b(x09), .c(x00), .O(new_n218_));
