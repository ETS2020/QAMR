...
module FAU ( 
  ...
  nand2  g072(.a(new_n155_), .b(new_n93_), .O(z18));
  ...
  nand2  g100(.a(x37), .b(new_n166_), .O(new_n184_));
  ...
  nand2  g107(.a(x38), .b(new_n166_), .O(new_n191_));
  ...
  nand3  g133(.a(x45), .b(new_n193_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z33));
  nand2  g135(.a(new_n194_), .b(x45), .O(new_n219_));
  nand3  g136(.a(x46), .b(new_n193_), .c(x09), .O(new_n220_));
