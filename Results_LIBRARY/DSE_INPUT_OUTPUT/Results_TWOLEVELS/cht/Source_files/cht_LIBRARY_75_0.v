...
module FAU ( 
  ...
  nand3  g046(.a(new_n129_), .b(new_n98_), .c(x09), .O(new_n130_));
  ...
  nand3  g051(.a(new_n134_), .b(new_n98_), .c(x09), .O(new_n135_));
  ...
  nand3  g056(.a(new_n139_), .b(new_n98_), .c(x09), .O(new_n140_));
  ...
  and2   g075(.a(new_n158_), .b(new_n98_), .O(z16));
  ...
  nand3  g088(.a(new_n171_), .b(new_n98_), .c(x09), .O(new_n172_));
  inv1   g089(.a(new_n172_), .O(z19));
  nand3  g090(.a(x32), .b(new_n98_), .c(x09), .O(new_n174_));
  ...
  nand3  g102(.a(x38), .b(new_n98_), .c(x09), .O(new_n186_));
  ...
  and2   g108(.a(new_n191_), .b(new_n98_), .O(z27));
  ...
  nand3  g131(.a(new_n214_), .b(new_n98_), .c(x09), .O(new_n215_));
  inv1   g132(.a(new_n215_), .O(z32));
  nand2  g133(.a(x44), .b(x14), .O(new_n217_));
  nand2  g134(.a(x45), .b(new_n189_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(x09), .O(new_n219_));
  and2   g136(.a(new_n219_), .b(new_n98_), .O(z33));
  nand2  g137(.a(x45), .b(x14), .O(new_n221_));
  nand2  g138(.a(x46), .b(new_n189_), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(x09), .O(new_n223_));
  and2   g140(.a(new_n223_), .b(new_n98_), .O(z34));
