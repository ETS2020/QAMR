...
module FAU ( 
  ...
  nand2  g078(.a(new_n161_), .b(new_n99_), .O(z18));
  ...
  nand3  g087(.a(x32), .b(new_n94_), .c(new_n166_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(new_n170_), .O(z21));
  oai21  g089(.a(x34), .b(x10), .c(x09), .O(new_n173_));
  nand3  g090(.a(x33), .b(new_n94_), .c(new_n166_), .O(new_n174_));
  ...
  nand2  g126(.a(new_n195_), .b(x44), .O(new_n210_));
  ...
  nand3  g133(.a(new_n95_), .b(x09), .c(x00), .O(new_n217_));
