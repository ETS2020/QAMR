...
module FAU ( 
  ...
  aoi21  g088(.a(x30), .b(new_n109_), .c(new_n97_), .O(new_n172_));
  ...
  nand2  g101(.a(new_n176_), .b(x37), .O(new_n185_));
  ...
  nand2  g122(.a(x42), .b(new_n205_), .O(new_n206_));
  ...
  nand2  g131(.a(x44), .b(new_n205_), .O(new_n215_));
