...
module FAU ( 
  ...
  nand2  g043(.a(new_n126_), .b(new_n89_), .O(z09));
  ...
  nand2  g067(.a(x26), .b(new_n116_), .O(new_n151_));
  ...
  nand3  g114(.a(x40), .b(new_n100_), .c(x09), .O(new_n198_));
  ...
  aoi21  g122(.a(x43), .b(new_n100_), .c(x10), .O(new_n206_));
  nand3  g123(.a(new_n196_), .b(x42), .c(new_n84_), .O(new_n207_));
  oai21  g124(.a(new_n206_), .b(new_n168_), .c(new_n207_), .O(z31));
  aoi21  g125(.a(x44), .b(new_n100_), .c(x10), .O(new_n209_));
  nand3  g126(.a(new_n196_), .b(x43), .c(new_n84_), .O(new_n210_));
  oai21  g127(.a(new_n209_), .b(new_n168_), .c(new_n210_), .O(z32));
  aoi21  g128(.a(x45), .b(new_n100_), .c(x10), .O(new_n212_));
  nand3  g129(.a(new_n196_), .b(x44), .c(new_n84_), .O(new_n213_));
  oai21  g130(.a(new_n212_), .b(new_n168_), .c(new_n213_), .O(z33));
  nand2  g131(.a(new_n196_), .b(x45), .O(new_n215_));
  nand3  g132(.a(x46), .b(new_n100_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z34));
  aoi21  g134(.a(new_n100_), .b(x00), .c(x10), .O(new_n218_));
  nand3  g135(.a(new_n196_), .b(x46), .c(new_n84_), .O(new_n219_));
  oai21  g136(.a(new_n218_), .b(new_n168_), .c(new_n219_), .O(z35));
endmodule
