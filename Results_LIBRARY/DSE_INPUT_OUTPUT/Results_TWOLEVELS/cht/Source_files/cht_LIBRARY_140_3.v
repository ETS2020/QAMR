...
module FAU ( 
  ...
  nand2  g068(.a(x30), .b(new_n111_), .O(new_n152_));
  ...
  nand2  g102(.a(new_n100_), .b(x09), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(x39), .O(new_n187_));
  nand3  g104(.a(x40), .b(new_n100_), .c(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z28));
  inv1   g106(.a(x40), .O(new_n190_));
  aoi21  g107(.a(new_n100_), .b(x09), .c(new_n190_), .O(new_n191_));
  nand3  g108(.a(x41), .b(new_n100_), .c(x09), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(new_n193_));
  oai21  g110(.a(new_n193_), .b(new_n191_), .c(new_n84_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n89_), .O(z29));
  nand2  g112(.a(new_n186_), .b(x41), .O(new_n196_));
  nand3  g113(.a(x42), .b(new_n100_), .c(x09), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n196_), .c(x10), .O(z30));
  inv1   g115(.a(x42), .O(new_n199_));
  aoi21  g116(.a(new_n100_), .b(x09), .c(new_n199_), .O(new_n200_));
  nand3  g117(.a(x43), .b(new_n100_), .c(x09), .O(new_n201_));
  inv1   g118(.a(new_n201_), .O(new_n202_));
  oai21  g119(.a(new_n202_), .b(new_n200_), .c(new_n84_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n89_), .O(z31));
  nand2  g121(.a(new_n186_), .b(x43), .O(new_n205_));
  nand3  g122(.a(x44), .b(new_n100_), .c(x09), .O(new_n206_));
