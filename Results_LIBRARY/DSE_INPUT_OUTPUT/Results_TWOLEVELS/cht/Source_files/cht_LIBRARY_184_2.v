...
module FAU ( 
  ...
  oai21  g054(.a(new_n136_), .b(new_n114_), .c(new_n137_), .O(new_n138_));
  ...
  nand2  g066(.a(x26), .b(new_n114_), .O(new_n150_));
  ...
  nand2  g074(.a(x28), .b(new_n114_), .O(new_n158_));
  ...
  nand2  g093(.a(new_n176_), .b(new_n90_), .O(z21));
  ...
  nand2  g108(.a(x36), .b(new_n169_), .O(new_n192_));
  oai21  g109(.a(new_n191_), .b(new_n169_), .c(new_n192_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n84_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n90_), .O(z25));
  ...
  nand2  g120(.a(x38), .b(new_n169_), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n203_), .c(x10), .O(z27));
  inv1   g122(.a(x14), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(x09), .c(new_n200_), .O(new_n207_));
  nand3  g124(.a(x40), .b(new_n206_), .c(x09), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(new_n207_), .c(new_n84_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n90_), .O(z28));
  inv1   g128(.a(x40), .O(new_n212_));
  aoi21  g129(.a(new_n206_), .b(x09), .c(new_n212_), .O(new_n213_));
  ...
  nand2  g133(.a(new_n216_), .b(new_n90_), .O(z29));
  inv1   g134(.a(x41), .O(new_n218_));
  aoi21  g135(.a(new_n206_), .b(x09), .c(new_n218_), .O(new_n219_));
  nand3  g136(.a(x42), .b(new_n206_), .c(x09), .O(new_n220_));
  inv1   g137(.a(new_n220_), .O(new_n221_));
  oai21  g138(.a(new_n221_), .b(new_n219_), .c(new_n84_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n90_), .O(z30));
  inv1   g140(.a(x42), .O(new_n224_));
  aoi21  g141(.a(new_n206_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(x43), .b(new_n206_), .c(x09), .O(new_n226_));
  inv1   g143(.a(new_n226_), .O(new_n227_));
  oai21  g144(.a(new_n227_), .b(new_n225_), .c(new_n84_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n90_), .O(z31));
  inv1   g146(.a(x43), .O(new_n230_));
  aoi21  g147(.a(new_n206_), .b(x09), .c(new_n230_), .O(new_n231_));
  nand3  g148(.a(x44), .b(new_n206_), .c(x09), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(new_n233_));
  oai21  g150(.a(new_n233_), .b(new_n231_), .c(new_n84_), .O(new_n234_));
  nand2  g151(.a(new_n234_), .b(new_n90_), .O(z32));
  oai21  g152(.a(x14), .b(new_n169_), .c(x44), .O(new_n236_));
  nand3  g153(.a(x45), .b(new_n206_), .c(x09), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z33));
  inv1   g155(.a(x45), .O(new_n239_));
  aoi21  g156(.a(new_n206_), .b(x09), .c(new_n239_), .O(new_n240_));
  nand3  g157(.a(x46), .b(new_n206_), .c(x09), .O(new_n241_));
  inv1   g158(.a(new_n241_), .O(new_n242_));
  oai21  g159(.a(new_n242_), .b(new_n240_), .c(new_n84_), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(new_n90_), .O(z34));
  inv1   g161(.a(x46), .O(new_n245_));
  aoi21  g162(.a(new_n206_), .b(x09), .c(new_n245_), .O(new_n246_));
  nand3  g163(.a(new_n206_), .b(x09), .c(x00), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(new_n246_), .c(new_n84_), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n90_), .O(z35));
endmodule
