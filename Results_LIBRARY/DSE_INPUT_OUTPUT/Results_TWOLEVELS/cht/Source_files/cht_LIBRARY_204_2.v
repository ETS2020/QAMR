...
module FAU ( 
  ...
  nand2  g052(.a(x23), .b(new_n110_), .O(new_n136_));
  ...
  nand2  g089(.a(new_n172_), .b(new_n94_), .O(z20));
  ...
  nand3  g123(.a(x41), .b(new_n99_), .c(x09), .O(new_n207_));
  ...
  nand2  g139(.a(new_n222_), .b(new_n94_), .O(z32));
  ...
  aoi21  g146(.a(new_n99_), .b(x09), .c(new_n93_), .O(new_n230_));
