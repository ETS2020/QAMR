...
module FAU ( 
  ...
  nand3  g052(.a(new_n135_), .b(new_n92_), .c(x09), .O(new_n136_));
  ...
  nand3  g061(.a(new_n144_), .b(new_n92_), .c(x09), .O(new_n145_));
  ...
  nand3  g080(.a(new_n163_), .b(new_n92_), .c(x09), .O(new_n164_));
  ...
  aoi21  g087(.a(x30), .b(new_n111_), .c(new_n86_), .O(new_n171_));
  ...
  and2   g125(.a(new_n208_), .b(new_n92_), .O(z31));
  nand2  g126(.a(x43), .b(x14), .O(new_n210_));
  nand2  g127(.a(x44), .b(new_n98_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n210_), .c(x09), .O(new_n212_));
  and2   g129(.a(new_n212_), .b(new_n92_), .O(z32));
  nand2  g130(.a(x44), .b(x14), .O(new_n214_));
  nand2  g131(.a(x45), .b(new_n98_), .O(new_n215_));
  nand3  g132(.a(new_n215_), .b(new_n214_), .c(x09), .O(new_n216_));
  and2   g133(.a(new_n216_), .b(new_n92_), .O(z33));
