...
module FAU ( 
  ...
  aoi21  g030(.a(new_n113_), .b(new_n88_), .c(x10), .O(z06));
  nor2   g031(.a(x10), .b(x08), .O(new_n115_));
  nand2  g032(.a(new_n115_), .b(x18), .O(new_n116_));
  inv1   g033(.a(new_n116_), .O(z07));
  nand2  g034(.a(new_n115_), .b(x19), .O(new_n118_));
  inv1   g035(.a(new_n118_), .O(z08));
  nand2  g036(.a(new_n115_), .b(x20), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z09));
  nand2  g038(.a(new_n115_), .b(x21), .O(new_n122_));
  ...
  aoi21  g043(.a(new_n126_), .b(new_n88_), .c(x10), .O(z12));
  inv1   g044(.a(x24), .O(new_n128_));
  aoi21  g045(.a(new_n128_), .b(new_n88_), .c(x10), .O(z13));
  inv1   g046(.a(x25), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n88_), .c(x10), .O(z14));
  nand2  g048(.a(new_n115_), .b(x26), .O(new_n132_));
  inv1   g049(.a(new_n132_), .O(z15));
  nand2  g050(.a(new_n115_), .b(x27), .O(new_n134_));
  inv1   g051(.a(new_n134_), .O(z16));
  nand2  g052(.a(new_n115_), .b(x28), .O(new_n136_));
  ...
  nand2  g134(.a(new_n181_), .b(x46), .O(new_n218_));
  oai21  g135(.a(new_n181_), .b(new_n217_), .c(new_n218_), .O(new_n219_));
