...
module FAU ( 
  ...
  oai21  g078(.a(new_n161_), .b(x10), .c(new_n88_), .O(z15));
  inv1   g079(.a(x28), .O(new_n163_));
  nand2  g080(.a(new_n163_), .b(x08), .O(new_n164_));
  nand3  g081(.a(new_n164_), .b(x32), .c(x27), .O(new_n165_));
  ...
  nor2   g096(.a(x27), .b(x09), .O(new_n180_));
  ...
  oai21  g101(.a(new_n87_), .b(x09), .c(new_n184_), .O(new_n185_));
