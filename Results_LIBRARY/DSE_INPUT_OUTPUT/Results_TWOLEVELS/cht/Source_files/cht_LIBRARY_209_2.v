...
module FAU ( 
  ...
  aoi21  g031(.a(new_n114_), .b(new_n84_), .c(x10), .O(z07));
  inv1   g032(.a(x19), .O(new_n116_));
  aoi21  g033(.a(new_n116_), .b(new_n84_), .c(x10), .O(z08));
  ...
  aoi21  g049(.a(new_n132_), .b(new_n84_), .c(x10), .O(z16));
  ...
  and2   g078(.a(new_n161_), .b(new_n85_), .O(z24));
  ...
  and2   g082(.a(new_n165_), .b(new_n85_), .O(z25));
  ...
  oai21  g094(.a(x14), .b(new_n140_), .c(x39), .O(new_n178_));
  ...
  nand2  g100(.a(new_n179_), .b(x09), .O(new_n184_));
  ...
  nand2  g106(.a(new_n184_), .b(x41), .O(new_n190_));
  ...
  oai21  g116(.a(x14), .b(new_n140_), .c(x43), .O(new_n200_));
  ...
  nand3  g122(.a(x45), .b(new_n179_), .c(x09), .O(new_n206_));
  ...
  nand3  g127(.a(x46), .b(new_n179_), .c(x09), .O(new_n211_));
  ...
  oai21  g131(.a(x14), .b(new_n140_), .c(x46), .O(new_n215_));
