...
module FAU ( 
  ...
  nand2  g041(.a(new_n124_), .b(new_n97_), .O(new_n125_));
  nand2  g042(.a(new_n125_), .b(new_n103_), .O(z09));
  inv1   g043(.a(x21), .O(new_n127_));
  nand2  g044(.a(x22), .b(x08), .O(new_n128_));
  oai21  g045(.a(new_n127_), .b(x08), .c(new_n128_), .O(new_n129_));
  nand2  g046(.a(new_n129_), .b(new_n97_), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(new_n103_), .O(z10));
  ...
  nand2  g054(.a(new_n137_), .b(new_n97_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n103_), .O(z12));
  ...
  nand2  g060(.a(new_n143_), .b(new_n103_), .O(z13));
  ...
  nand2  g075(.a(new_n158_), .b(new_n97_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n103_), .O(z17));
  ...
  nand2  g081(.a(new_n164_), .b(new_n103_), .O(z18));
  ...
  oai21  g103(.a(x37), .b(x10), .c(new_n102_), .O(new_n187_));
  nand3  g104(.a(x38), .b(new_n97_), .c(x09), .O(new_n188_));
  ...
  nand2  g110(.a(x38), .b(new_n102_), .O(new_n194_));
  ...
  oai21  g117(.a(x40), .b(x10), .c(new_n102_), .O(new_n201_));
  ...
  oai21  g126(.a(x42), .b(x10), .c(new_n102_), .O(new_n210_));
  ...
  oai21  g132(.a(x43), .b(x10), .c(new_n102_), .O(new_n216_));
  ...
  oai21  g138(.a(x44), .b(x10), .c(new_n102_), .O(new_n222_));
  ...
  oai21  g144(.a(x45), .b(x10), .c(new_n102_), .O(new_n228_));
  ...
  nand2  g150(.a(new_n197_), .b(x46), .O(new_n234_));
