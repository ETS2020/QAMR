...
module FAU ( 
  ...
  nand2  g003(.a(x31), .b(x12), .O(new_n87_));
  ...
  nand3  g093(.a(new_n176_), .b(x31), .c(new_n89_), .O(new_n177_));
  ...
  nand3  g168(.a(new_n251_), .b(new_n87_), .c(new_n93_), .O(new_n252_));
  ...
  nand3  g173(.a(new_n256_), .b(new_n87_), .c(new_n93_), .O(new_n257_));
