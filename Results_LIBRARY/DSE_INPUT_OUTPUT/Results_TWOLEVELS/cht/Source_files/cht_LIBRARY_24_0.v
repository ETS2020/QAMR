...
module FAU ( 
  ...
  nand3  g022(.a(new_n105_), .b(new_n89_), .c(x09), .O(new_n106_));
  inv1   g023(.a(new_n106_), .O(z04));
  inv1   g024(.a(x16), .O(new_n108_));
  nand2  g025(.a(x07), .b(x03), .O(new_n109_));
  oai21  g026(.a(new_n108_), .b(x07), .c(new_n109_), .O(new_n110_));
  nand3  g027(.a(new_n110_), .b(new_n89_), .c(x09), .O(new_n111_));
  ...
  nand3  g032(.a(new_n115_), .b(new_n89_), .c(x09), .O(new_n116_));
  ...
  nand3  g037(.a(new_n120_), .b(new_n89_), .c(x09), .O(new_n121_));
  ...
  nand3  g042(.a(new_n125_), .b(new_n89_), .c(x09), .O(new_n126_));
  ...
  nand3  g071(.a(new_n154_), .b(new_n89_), .c(x09), .O(new_n155_));
  inv1   g072(.a(new_n155_), .O(z14));
  nand2  g073(.a(x26), .b(new_n133_), .O(new_n157_));
  nand2  g074(.a(x27), .b(x08), .O(new_n158_));
  nand3  g075(.a(new_n158_), .b(new_n157_), .c(x09), .O(new_n159_));
  and2   g076(.a(new_n159_), .b(new_n89_), .O(z15));
  ...
  nand2  g106(.a(new_n177_), .b(x38), .O(new_n190_));
  ...
  and2   g112(.a(new_n195_), .b(new_n89_), .O(z27));
  ...
  and2   g116(.a(new_n199_), .b(new_n89_), .O(z28));
  ...
  nand3  g143(.a(new_n226_), .b(new_n89_), .c(x09), .O(new_n227_));
  inv1   g144(.a(new_n227_), .O(z34));
  nand2  g145(.a(new_n193_), .b(x00), .O(new_n229_));
