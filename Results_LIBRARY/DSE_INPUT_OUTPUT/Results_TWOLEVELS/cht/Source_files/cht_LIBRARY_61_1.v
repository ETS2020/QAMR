...
module FAU ( 
  ...
  oai21  g039(.a(x20), .b(x10), .c(new_n93_), .O(new_n123_));
  nand3  g040(.a(x21), .b(new_n88_), .c(x08), .O(new_n124_));
  ...
  nand2  g063(.a(x28), .b(new_n93_), .O(new_n147_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n94_), .O(z25));
  nand2  g093(.a(x37), .b(new_n156_), .O(new_n177_));
  ...
  nand2  g100(.a(x38), .b(new_n156_), .O(new_n184_));
  aoi21  g101(.a(new_n184_), .b(new_n183_), .c(x10), .O(z27));
  aoi21  g102(.a(new_n101_), .b(x09), .c(new_n180_), .O(new_n186_));
  nand3  g103(.a(x40), .b(new_n101_), .c(x09), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(new_n188_));
  oai21  g105(.a(new_n188_), .b(new_n186_), .c(new_n88_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n94_), .O(z28));
  inv1   g107(.a(x40), .O(new_n191_));
  aoi21  g108(.a(new_n101_), .b(x09), .c(new_n191_), .O(new_n192_));
  nand3  g109(.a(x41), .b(new_n101_), .c(x09), .O(new_n193_));
