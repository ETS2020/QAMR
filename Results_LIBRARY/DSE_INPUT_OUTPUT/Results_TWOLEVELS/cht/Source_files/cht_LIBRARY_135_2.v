...
module FAU ( 
  ...
  nand2  g046(.a(x21), .b(new_n129_), .O(new_n130_));
  ...
  nand2  g050(.a(x22), .b(new_n129_), .O(new_n134_));
  ...
  nand2  g059(.a(x24), .b(new_n129_), .O(new_n143_));
  ...
  nand2  g068(.a(x26), .b(new_n129_), .O(new_n152_));
  ...
  nand2  g072(.a(x27), .b(new_n129_), .O(new_n156_));
  ...
  aoi21  g121(.a(new_n204_), .b(new_n84_), .c(x10), .O(z34));
