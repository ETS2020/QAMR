...
module FAU ( 
  ...
  oai21  g053(.a(new_n135_), .b(new_n104_), .c(new_n136_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n89_), .O(new_n138_));
  nand2  g055(.a(new_n138_), .b(new_n112_), .O(z13));
  nand2  g056(.a(x26), .b(x08), .O(new_n140_));
  oai21  g057(.a(new_n135_), .b(x08), .c(new_n140_), .O(new_n141_));
  nand2  g058(.a(new_n141_), .b(new_n89_), .O(new_n142_));
  nand2  g059(.a(new_n142_), .b(new_n112_), .O(z14));
  inv1   g060(.a(x27), .O(new_n144_));
  nand2  g061(.a(x26), .b(new_n104_), .O(new_n145_));
  oai21  g062(.a(new_n144_), .b(new_n104_), .c(new_n145_), .O(new_n146_));
  nand2  g063(.a(new_n146_), .b(new_n89_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n112_), .O(z15));
  nand2  g065(.a(x28), .b(x08), .O(new_n149_));
  oai21  g066(.a(new_n144_), .b(x08), .c(new_n149_), .O(new_n150_));
  nand2  g067(.a(new_n150_), .b(new_n89_), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n112_), .O(z16));
  ...
  nand2  g076(.a(x30), .b(new_n104_), .O(new_n160_));
  ...
  nand2  g091(.a(new_n174_), .b(new_n89_), .O(new_n175_));
  ...
  oai21  g098(.a(new_n180_), .b(new_n162_), .c(new_n181_), .O(new_n182_));
  ...
  nand2  g104(.a(new_n187_), .b(new_n112_), .O(z26));
  ...
  nand2  g121(.a(new_n204_), .b(new_n112_), .O(z29));
  inv1   g122(.a(x41), .O(new_n206_));
  aoi21  g123(.a(new_n195_), .b(x09), .c(new_n206_), .O(new_n207_));
  nand3  g124(.a(x42), .b(new_n195_), .c(x09), .O(new_n208_));
  inv1   g125(.a(new_n208_), .O(new_n209_));
  oai21  g126(.a(new_n209_), .b(new_n207_), .c(new_n89_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n112_), .O(z30));
  inv1   g128(.a(x42), .O(new_n212_));
  aoi21  g129(.a(new_n195_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x43), .b(new_n195_), .c(x09), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(new_n89_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n112_), .O(z31));
  nand2  g134(.a(new_n196_), .b(x43), .O(new_n218_));
  ...
  oai21  g144(.a(new_n227_), .b(new_n225_), .c(new_n89_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n112_), .O(z34));
