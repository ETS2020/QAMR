...
module FAU ( 
  ...
  oai21  g030(.a(x17), .b(x10), .c(new_n93_), .O(new_n114_));
  nand3  g031(.a(x18), .b(new_n88_), .c(x08), .O(new_n115_));
  nand2  g032(.a(new_n115_), .b(new_n114_), .O(z06));
  nand2  g033(.a(x18), .b(new_n93_), .O(new_n117_));
  nand2  g034(.a(x19), .b(x08), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n117_), .c(x10), .O(z07));
  nand2  g036(.a(x19), .b(new_n93_), .O(new_n120_));
  ...
  oai21  g045(.a(x22), .b(x10), .c(new_n93_), .O(new_n129_));
  nand3  g046(.a(x23), .b(new_n88_), .c(x08), .O(new_n130_));
  ...
  oai21  g051(.a(x24), .b(x10), .c(new_n93_), .O(new_n135_));
  nand3  g052(.a(x25), .b(new_n88_), .c(x08), .O(new_n136_));
  ...
  oai21  g057(.a(x26), .b(x10), .c(new_n93_), .O(new_n141_));
  nand3  g058(.a(x27), .b(new_n88_), .c(x08), .O(new_n142_));
  ...
  oai21  g066(.a(x29), .b(x10), .c(new_n93_), .O(new_n150_));
  nand3  g067(.a(x30), .b(new_n88_), .c(x08), .O(new_n151_));
  nand2  g068(.a(new_n151_), .b(new_n150_), .O(z18));
  nand2  g069(.a(x08), .b(x00), .O(new_n153_));
  nand2  g070(.a(x30), .b(new_n93_), .O(new_n154_));
  ...
  nand2  g080(.a(new_n163_), .b(new_n94_), .O(z21));
  ...
  oai21  g103(.a(new_n186_), .b(x10), .c(new_n94_), .O(z27));
  aoi21  g104(.a(new_n99_), .b(x09), .c(new_n181_), .O(new_n188_));
  ...
  nand2  g109(.a(new_n99_), .b(x09), .O(new_n193_));
