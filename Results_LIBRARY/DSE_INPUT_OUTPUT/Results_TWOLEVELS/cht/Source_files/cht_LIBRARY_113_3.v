...
module FAU ( 
  ...
  nand2  g009(.a(x24), .b(x10), .O(new_n93_));
  ...
  oai21  g052(.a(x10), .b(x08), .c(x24), .O(new_n136_));
  nand3  g053(.a(x23), .b(new_n88_), .c(new_n113_), .O(new_n137_));
  nand2  g054(.a(new_n137_), .b(new_n136_), .O(z12));
  ...
  nand2  g069(.a(new_n152_), .b(new_n93_), .O(z16));
  ...
  nand2  g109(.a(x38), .b(new_n165_), .O(new_n193_));
  ...
  aoi21  g117(.a(new_n195_), .b(x09), .c(new_n200_), .O(new_n201_));
  nand3  g118(.a(x41), .b(new_n195_), .c(x09), .O(new_n202_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n93_), .O(z31));
  nand2  g131(.a(new_n196_), .b(x43), .O(new_n215_));
  ...
  nand3  g138(.a(x46), .b(new_n195_), .c(x09), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n221_), .c(x10), .O(z34));
  inv1   g140(.a(x46), .O(new_n224_));
  aoi21  g141(.a(new_n195_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(new_n195_), .b(x09), .c(x00), .O(new_n226_));
