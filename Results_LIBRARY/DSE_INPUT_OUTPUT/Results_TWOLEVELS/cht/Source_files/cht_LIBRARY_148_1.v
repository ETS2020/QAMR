...
module FAU ( 
  ...
  nor2   g032(.a(new_n85_), .b(x08), .O(new_n116_));
  ...
  nand3  g103(.a(new_n186_), .b(x32), .c(x17), .O(new_n187_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n86_), .O(z23));
  ...
  oai21  g144(.a(new_n227_), .b(x10), .c(new_n86_), .O(z29));
  ...
  oai21  g153(.a(new_n236_), .b(x10), .c(new_n86_), .O(z31));
  ...
  oai21  g157(.a(new_n240_), .b(x10), .c(new_n86_), .O(z32));
  ...
  oai21  g161(.a(new_n244_), .b(x10), .c(new_n86_), .O(z33));
  nand3  g162(.a(x46), .b(new_n102_), .c(x09), .O(new_n246_));
  inv1   g163(.a(new_n246_), .O(new_n247_));
  aoi21  g164(.a(new_n219_), .b(x45), .c(new_n247_), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(x10), .c(new_n86_), .O(z34));
