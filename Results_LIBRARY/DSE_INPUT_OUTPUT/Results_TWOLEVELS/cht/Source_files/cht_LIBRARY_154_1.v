...
module FAU ( 
  ...
  nand2  g051(.a(x21), .b(new_n121_), .O(new_n135_));
  ...
  nand2  g057(.a(x23), .b(new_n121_), .O(new_n141_));
  ...
  nand2  g110(.a(x38), .b(new_n89_), .O(new_n194_));
  ...
  oai21  g117(.a(x40), .b(x10), .c(new_n89_), .O(new_n201_));
