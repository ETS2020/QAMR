...
module FAU ( 
  ...
  aoi21  g025(.a(x18), .b(x08), .c(x31), .O(new_n109_));
  ...
  nand3  g030(.a(new_n113_), .b(new_n101_), .c(new_n100_), .O(new_n114_));
  inv1   g031(.a(new_n114_), .O(z07));
  nand2  g032(.a(x20), .b(x08), .O(new_n116_));
  oai21  g033(.a(new_n111_), .b(x08), .c(new_n116_), .O(new_n117_));
  nand3  g034(.a(new_n117_), .b(new_n101_), .c(new_n100_), .O(new_n118_));
  ...
  nand3  g051(.a(new_n134_), .b(new_n101_), .c(new_n100_), .O(new_n135_));
  ...
  nand3  g056(.a(new_n139_), .b(new_n101_), .c(new_n100_), .O(new_n140_));
  ...
  and2   g100(.a(new_n183_), .b(new_n100_), .O(z24));
  ...
  and2   g104(.a(new_n187_), .b(new_n100_), .O(z25));
  ...
  oai21  g115(.a(new_n198_), .b(new_n197_), .c(new_n101_), .O(new_n199_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x31), .O(new_n215_));
  ...
  aoi21  g136(.a(new_n219_), .b(x09), .c(x31), .O(new_n220_));
  ...
  aoi21  g146(.a(new_n229_), .b(x09), .c(x31), .O(new_n230_));
  ...
  nand3  g150(.a(new_n233_), .b(new_n101_), .c(new_n100_), .O(new_n234_));
  ...
  nand3  g155(.a(new_n238_), .b(new_n101_), .c(new_n100_), .O(new_n239_));
