...
module FAU ( 
  ...
  nand3  g057(.a(new_n140_), .b(new_n84_), .c(x08), .O(new_n141_));
  ...
  and2   g063(.a(new_n146_), .b(new_n84_), .O(z21));
  ...
  aoi21  g090(.a(x38), .b(new_n143_), .c(new_n92_), .O(new_n174_));
  ...
  oai21  g099(.a(x14), .b(new_n143_), .c(x40), .O(new_n183_));
  ...
  oai21  g104(.a(x14), .b(new_n143_), .c(x41), .O(new_n188_));
  ...
  oai21  g109(.a(x14), .b(new_n143_), .c(x42), .O(new_n193_));
  ...
  nand3  g130(.a(new_n176_), .b(x09), .c(x00), .O(new_n214_));
