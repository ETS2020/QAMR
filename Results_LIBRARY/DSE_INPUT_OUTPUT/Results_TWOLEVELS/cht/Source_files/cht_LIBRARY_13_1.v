...
module FAU ( 
  ...
  aoi21  g107(.a(new_n102_), .b(x09), .c(new_n184_), .O(new_n191_));
  nand3  g108(.a(x40), .b(new_n102_), .c(x09), .O(new_n192_));
  ...
  aoi21  g113(.a(new_n102_), .b(x09), .c(new_n196_), .O(new_n197_));
