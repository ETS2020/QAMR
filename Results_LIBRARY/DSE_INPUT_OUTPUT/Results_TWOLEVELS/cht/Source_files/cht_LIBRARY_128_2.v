...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x33), .O(new_n88_));
  ...
  nor2   g099(.a(new_n87_), .b(new_n182_), .O(new_n183_));
  oai21  g100(.a(new_n183_), .b(new_n181_), .c(x32), .O(new_n184_));
  ...
  nand2  g109(.a(x34), .b(new_n191_), .O(new_n193_));
  oai21  g110(.a(new_n192_), .b(new_n191_), .c(new_n193_), .O(new_n194_));
  ...
  nand2  g118(.a(x36), .b(new_n191_), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(new_n191_), .c(new_n202_), .O(new_n203_));
  ...
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(new_n191_), .O(new_n212_));
  ...
  nand2  g133(.a(new_n101_), .b(x09), .O(new_n217_));
  ...
  aoi21  g149(.a(new_n217_), .b(x42), .c(new_n232_), .O(new_n233_));
  oai21  g150(.a(new_n233_), .b(x10), .c(new_n88_), .O(z31));
  nand3  g151(.a(new_n182_), .b(new_n101_), .c(x09), .O(new_n235_));
  inv1   g152(.a(new_n235_), .O(new_n236_));
  oai21  g153(.a(new_n236_), .b(new_n183_), .c(x44), .O(new_n237_));
  nand2  g154(.a(new_n217_), .b(x43), .O(new_n238_));
