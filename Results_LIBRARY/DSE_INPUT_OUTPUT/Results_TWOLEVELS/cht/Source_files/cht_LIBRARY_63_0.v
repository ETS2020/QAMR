...
module FAU ( 
  ...
  nand2  g034(.a(new_n113_), .b(x22), .O(new_n118_));
  ...
  nand2  g048(.a(new_n113_), .b(x29), .O(new_n132_));
  ...
  and2   g071(.a(new_n154_), .b(new_n84_), .O(z23));
  ...
  and2   g080(.a(new_n163_), .b(new_n84_), .O(z25));
  ...
  oai21  g091(.a(new_n174_), .b(new_n173_), .c(new_n84_), .O(new_n175_));
  nor2   g092(.a(new_n175_), .b(new_n92_), .O(z27));
  nor2   g093(.a(x14), .b(new_n138_), .O(new_n177_));
  ...
  aoi21  g098(.a(new_n181_), .b(x09), .c(new_n92_), .O(new_n182_));
  ...
  aoi21  g103(.a(new_n186_), .b(x09), .c(new_n92_), .O(new_n187_));
  ...
  aoi21  g108(.a(new_n191_), .b(x09), .c(new_n92_), .O(new_n192_));
