...
module FAU ( 
  ...
  and2   g043(.a(new_n126_), .b(new_n85_), .O(z08));
  ...
  nand2  g057(.a(x23), .b(new_n123_), .O(new_n141_));
  nand2  g058(.a(x24), .b(x08), .O(new_n142_));
  nand3  g059(.a(new_n142_), .b(new_n141_), .c(new_n84_), .O(new_n143_));
  and2   g060(.a(new_n143_), .b(new_n85_), .O(z12));
  nand2  g061(.a(x24), .b(new_n123_), .O(new_n145_));
  ...
  nand2  g079(.a(x28), .b(new_n123_), .O(new_n163_));
  ...
  nand2  g083(.a(x29), .b(new_n123_), .O(new_n167_));
  ...
  aoi21  g093(.a(new_n176_), .b(new_n84_), .c(x10), .O(z20));
  ...
  nand2  g101(.a(new_n178_), .b(x35), .O(new_n185_));
