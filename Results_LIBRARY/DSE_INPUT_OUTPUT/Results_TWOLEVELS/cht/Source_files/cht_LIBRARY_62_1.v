...
module FAU ( 
  ...
  aoi21  g037(.a(x20), .b(x08), .c(x21), .O(new_n121_));
  aoi21  g038(.a(new_n121_), .b(new_n120_), .c(x10), .O(z08));
  nand4  g039(.a(new_n89_), .b(x20), .c(new_n88_), .d(new_n116_), .O(new_n123_));
  inv1   g040(.a(new_n123_), .O(z09));
  nand2  g041(.a(x22), .b(x08), .O(new_n125_));
  aoi21  g042(.a(new_n125_), .b(new_n89_), .c(x10), .O(z10));
  ...
  and2   g059(.a(new_n142_), .b(new_n88_), .O(z14));
  nand2  g060(.a(x26), .b(new_n116_), .O(new_n144_));
  nand2  g061(.a(x27), .b(x08), .O(new_n145_));
  nand3  g062(.a(new_n145_), .b(new_n144_), .c(new_n89_), .O(new_n146_));
  and2   g063(.a(new_n146_), .b(new_n88_), .O(z15));
  ...
  aoi21  g079(.a(x30), .b(new_n116_), .c(x21), .O(new_n163_));
  ...
  and2   g094(.a(new_n177_), .b(new_n88_), .O(z22));
  ...
  and2   g107(.a(new_n190_), .b(new_n88_), .O(z25));
  ...
  aoi21  g123(.a(new_n206_), .b(x09), .c(x21), .O(new_n207_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x21), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x21), .O(new_n227_));
  ...
  aoi21  g155(.a(new_n209_), .b(x00), .c(x21), .O(new_n239_));
