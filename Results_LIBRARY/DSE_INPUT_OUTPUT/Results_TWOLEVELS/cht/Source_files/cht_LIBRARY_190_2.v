...
module FAU ( 
  ...
  oai21  g033(.a(new_n89_), .b(x08), .c(new_n116_), .O(new_n117_));
  ...
  oai21  g041(.a(new_n123_), .b(new_n112_), .c(new_n124_), .O(new_n125_));
  ...
  aoi21  g114(.a(new_n197_), .b(x09), .c(new_n190_), .O(new_n198_));
  ...
  nand3  g130(.a(x43), .b(new_n197_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z31));
  inv1   g132(.a(x43), .O(new_n216_));
  aoi21  g133(.a(new_n197_), .b(x09), .c(new_n216_), .O(new_n217_));
  ...
  nand2  g138(.a(new_n209_), .b(x44), .O(new_n222_));
  nand3  g139(.a(x45), .b(new_n197_), .c(x09), .O(new_n223_));
  aoi21  g140(.a(new_n223_), .b(new_n222_), .c(x10), .O(z33));
  nand2  g141(.a(new_n209_), .b(x45), .O(new_n225_));
  ...
  nand3  g145(.a(new_n197_), .b(x09), .c(x00), .O(new_n229_));
