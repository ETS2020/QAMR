...
module FAU ( 
  ...
  nand2  g030(.a(x19), .b(new_n110_), .O(new_n114_));
  ...
  nand2  g036(.a(new_n119_), .b(new_n103_), .O(new_n120_));
  nand2  g037(.a(new_n120_), .b(new_n108_), .O(z09));
  ...
  nand2  g062(.a(new_n145_), .b(new_n108_), .O(z14));
  ...
  nand2  g075(.a(new_n158_), .b(new_n103_), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n108_), .O(z18));
  ...
  nand2  g081(.a(new_n164_), .b(new_n108_), .O(z19));
  ...
  nand3  g134(.a(new_n195_), .b(x46), .c(new_n103_), .O(new_n218_));
