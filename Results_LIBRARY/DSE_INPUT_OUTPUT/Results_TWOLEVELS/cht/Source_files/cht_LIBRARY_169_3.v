...
module FAU ( 
  ...
  nand2  g105(.a(new_n100_), .b(x09), .O(new_n189_));
  ...
  nand3  g110(.a(x41), .b(new_n100_), .c(x09), .O(new_n194_));
  ...
  nand3  g114(.a(x42), .b(new_n100_), .c(x09), .O(new_n198_));
  ...
  nand3  g120(.a(x43), .b(new_n100_), .c(x09), .O(new_n204_));
  ...
  nand3  g125(.a(x44), .b(new_n100_), .c(x09), .O(new_n209_));
  ...
  nand2  g132(.a(new_n215_), .b(new_n89_), .O(z33));
