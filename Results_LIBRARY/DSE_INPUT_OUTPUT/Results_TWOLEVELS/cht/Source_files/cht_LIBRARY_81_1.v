...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n92_), .c(x14), .O(new_n96_));
  aoi21  g013(.a(new_n96_), .b(new_n95_), .c(x10), .O(z02));
  nand4  g014(.a(new_n85_), .b(new_n84_), .c(x07), .d(x01), .O(new_n98_));
  inv1   g015(.a(new_n98_), .O(z03));
  nand2  g016(.a(x07), .b(x02), .O(new_n100_));
  aoi21  g017(.a(x15), .b(new_n92_), .c(x14), .O(new_n101_));
  aoi21  g018(.a(new_n101_), .b(new_n100_), .c(x10), .O(z04));
  nand2  g019(.a(x07), .b(x03), .O(new_n103_));
  aoi21  g020(.a(x16), .b(new_n92_), .c(x14), .O(new_n104_));
  ...
  aoi21  g082(.a(x30), .b(new_n106_), .c(x14), .O(new_n166_));
  ...
  nand2  g125(.a(x40), .b(new_n173_), .O(new_n209_));
  nand2  g126(.a(x41), .b(x09), .O(new_n210_));
  nand3  g127(.a(new_n210_), .b(new_n209_), .c(new_n85_), .O(new_n211_));
  and2   g128(.a(new_n211_), .b(new_n84_), .O(z29));
  ...
  nand2  g139(.a(x43), .b(new_n173_), .O(new_n223_));
  nand2  g140(.a(x44), .b(x09), .O(new_n224_));
  nand3  g141(.a(new_n224_), .b(new_n223_), .c(new_n85_), .O(new_n225_));
  and2   g142(.a(new_n225_), .b(new_n84_), .O(z32));
  inv1   g143(.a(x44), .O(new_n227_));
  nand2  g144(.a(x45), .b(x09), .O(new_n228_));
  oai21  g145(.a(new_n227_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(new_n229_), .b(new_n85_), .c(new_n84_), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(z33));
  nand2  g148(.a(x45), .b(new_n173_), .O(new_n232_));
  ...
  nand2  g152(.a(x09), .b(x00), .O(new_n236_));
  aoi21  g153(.a(x46), .b(new_n173_), .c(x14), .O(new_n237_));
