...
module FAU ( 
  ...
  nand2  g001(.a(x40), .b(x38), .O(new_n85_));
  ...
  nand3  g132(.a(new_n215_), .b(new_n85_), .c(x09), .O(new_n216_));
  inv1   g133(.a(x40), .O(new_n217_));
  nand3  g134(.a(new_n217_), .b(x38), .c(new_n180_), .O(new_n218_));
  aoi21  g135(.a(new_n218_), .b(new_n216_), .c(x10), .O(z27));
  aoi21  g136(.a(new_n101_), .b(x09), .c(new_n213_), .O(new_n220_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n85_), .O(z28));
  nand4  g141(.a(new_n85_), .b(x41), .c(new_n101_), .d(x09), .O(new_n225_));
  nand2  g142(.a(new_n101_), .b(x09), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(x40), .c(new_n208_), .O(new_n227_));
  ...
  oai21  g162(.a(x14), .b(new_n180_), .c(x44), .O(new_n246_));
