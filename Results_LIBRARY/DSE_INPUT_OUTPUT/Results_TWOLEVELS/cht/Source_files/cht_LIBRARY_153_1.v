...
module FAU ( 
  ...
  aoi21  g012(.a(new_n95_), .b(new_n89_), .c(x10), .O(z02));
  ...
  and2   g030(.a(new_n113_), .b(new_n88_), .O(z06));
  nand2  g031(.a(x18), .b(new_n110_), .O(new_n115_));
  nand2  g032(.a(x19), .b(x08), .O(new_n116_));
  nand3  g033(.a(new_n116_), .b(new_n115_), .c(new_n89_), .O(new_n117_));
  and2   g034(.a(new_n117_), .b(new_n88_), .O(z07));
  ...
  and2   g047(.a(new_n130_), .b(new_n88_), .O(z10));
  ...
  and2   g051(.a(new_n134_), .b(new_n88_), .O(z11));
  ...
  and2   g064(.a(new_n147_), .b(new_n88_), .O(z14));
  ...
  and2   g091(.a(new_n174_), .b(new_n88_), .O(z20));
  ...
  and2   g100(.a(new_n183_), .b(new_n88_), .O(z22));
  ...
  and2   g104(.a(new_n187_), .b(new_n88_), .O(z23));
  ...
  and2   g108(.a(new_n191_), .b(new_n88_), .O(z24));
  ...
  aoi21  g129(.a(new_n212_), .b(x09), .c(x13), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n217_), .b(x09), .c(x13), .O(new_n218_));
  ...
  aoi21  g144(.a(new_n227_), .b(x09), .c(x13), .O(new_n228_));
  ...
  aoi21  g149(.a(new_n232_), .b(x09), .c(x13), .O(new_n233_));
  ...
  aoi21  g154(.a(new_n237_), .b(x09), .c(x13), .O(new_n238_));
  ...
  aoi21  g159(.a(new_n242_), .b(x09), .c(x13), .O(new_n243_));
  ...
  nand3  g163(.a(new_n246_), .b(new_n89_), .c(new_n88_), .O(new_n247_));
