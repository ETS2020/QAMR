...
module FAU ( 
  ...
  aoi21  g019(.a(x14), .b(new_n102_), .c(x27), .O(new_n103_));
  aoi21  g020(.a(new_n103_), .b(new_n101_), .c(x10), .O(z03));
  nand2  g021(.a(x07), .b(x02), .O(new_n105_));
  aoi21  g022(.a(x15), .b(new_n102_), .c(x27), .O(new_n106_));
  ...
  aoi21  g065(.a(new_n148_), .b(new_n85_), .c(x10), .O(z15));
  nand4  g066(.a(x28), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n150_));
  ...
  aoi21  g078(.a(x30), .b(new_n118_), .c(x27), .O(new_n162_));
  ...
  oai21  g117(.a(new_n200_), .b(new_n199_), .c(new_n85_), .O(new_n201_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x27), .O(new_n217_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x27), .O(new_n226_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x27), .O(new_n231_));
  ...
  aoi21  g154(.a(new_n203_), .b(x00), .c(x27), .O(new_n238_));
