...
module FAU ( 
  ...
  oai21  g091(.a(x10), .b(x09), .c(x34), .O(new_n175_));
  nand3  g092(.a(x33), .b(new_n84_), .c(new_n171_), .O(new_n176_));
  ...
  nand2  g098(.a(x35), .b(new_n171_), .O(new_n182_));
  ...
  nand2  g107(.a(x37), .b(new_n171_), .O(new_n191_));
