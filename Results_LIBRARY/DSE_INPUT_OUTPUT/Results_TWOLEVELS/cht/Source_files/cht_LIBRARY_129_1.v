...
module FAU ( 
  ...
  nand2  g052(.a(x22), .b(new_n114_), .O(new_n136_));
  ...
  nand2  g072(.a(new_n155_), .b(new_n90_), .O(z15));
  ...
  nand2  g082(.a(new_n165_), .b(new_n90_), .O(z17));
  ...
  oai21  g137(.a(x45), .b(x10), .c(new_n89_), .O(new_n221_));
  nand2  g138(.a(x45), .b(x14), .O(new_n222_));
  nand3  g139(.a(x46), .b(new_n101_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n222_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(new_n84_), .O(new_n225_));
  nand2  g142(.a(new_n225_), .b(new_n221_), .O(z34));
