...
module FAU ( 
  ...
  nand3  g092(.a(new_n175_), .b(new_n88_), .c(new_n94_), .O(new_n176_));
  ...
  nand3  g102(.a(new_n185_), .b(new_n88_), .c(new_n94_), .O(new_n186_));
  ...
  oai21  g131(.a(new_n214_), .b(new_n213_), .c(new_n88_), .O(new_n215_));
  nor2   g132(.a(new_n215_), .b(x10), .O(z27));
  nand2  g133(.a(new_n100_), .b(x09), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(x39), .c(x40), .O(new_n219_));
  inv1   g136(.a(x44), .O(new_n220_));
  nand3  g137(.a(new_n217_), .b(new_n220_), .c(x39), .O(new_n221_));
  ...
  nand2  g142(.a(new_n217_), .b(x40), .O(new_n226_));
  aoi21  g143(.a(new_n226_), .b(new_n225_), .c(x10), .O(z29));
  nand2  g144(.a(new_n217_), .b(x41), .O(new_n228_));
  ...
  aoi21  g151(.a(new_n217_), .b(x42), .c(new_n234_), .O(new_n235_));
  oai21  g152(.a(new_n235_), .b(x10), .c(new_n88_), .O(z31));
  inv1   g153(.a(x43), .O(new_n237_));
  nand2  g154(.a(new_n217_), .b(new_n237_), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(x44), .c(x40), .O(new_n239_));
  nand3  g156(.a(new_n217_), .b(new_n220_), .c(x43), .O(new_n240_));
  aoi21  g157(.a(new_n240_), .b(new_n239_), .c(x10), .O(z32));
  nand2  g158(.a(new_n224_), .b(x45), .O(new_n242_));
  nand3  g159(.a(new_n217_), .b(x44), .c(x40), .O(new_n243_));
  ...
  nand2  g169(.a(new_n252_), .b(new_n94_), .O(new_n253_));
