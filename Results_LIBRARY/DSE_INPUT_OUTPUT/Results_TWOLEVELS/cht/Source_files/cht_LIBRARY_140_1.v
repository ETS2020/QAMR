...
module FAU ( 
  ...
  nand2  g028(.a(x17), .b(new_n89_), .O(new_n112_));
  ...
  nand2  g102(.a(new_n101_), .b(x09), .O(new_n186_));
  nand2  g103(.a(new_n186_), .b(x39), .O(new_n187_));
  nand3  g104(.a(x40), .b(new_n101_), .c(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z28));
  inv1   g106(.a(x40), .O(new_n190_));
  aoi21  g107(.a(new_n101_), .b(x09), .c(new_n190_), .O(new_n191_));
  nand3  g108(.a(x41), .b(new_n101_), .c(x09), .O(new_n192_));
  inv1   g109(.a(new_n192_), .O(new_n193_));
  oai21  g110(.a(new_n193_), .b(new_n191_), .c(new_n84_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n90_), .O(z29));
  nand2  g112(.a(new_n186_), .b(x41), .O(new_n196_));
  nand3  g113(.a(x42), .b(new_n101_), .c(x09), .O(new_n197_));
  ...
  nand3  g117(.a(x43), .b(new_n101_), .c(x09), .O(new_n201_));
  ...
  nand3  g126(.a(x45), .b(new_n101_), .c(x09), .O(new_n210_));
  ...
  nand3  g134(.a(new_n101_), .b(x09), .c(x00), .O(new_n218_));
