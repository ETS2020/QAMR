...
module FAU ( 
  ...
  aoi21  g025(.a(x16), .b(new_n102_), .c(x08), .O(new_n109_));
  ...
  and2   g065(.a(new_n148_), .b(new_n85_), .O(z21));
  ...
  nand2  g080(.a(x36), .b(new_n145_), .O(new_n164_));
  ...
  nand2  g085(.a(x37), .b(new_n145_), .O(new_n169_));
  oai21  g086(.a(new_n168_), .b(new_n145_), .c(new_n169_), .O(new_n170_));
  ...
  aoi21  g092(.a(new_n175_), .b(new_n173_), .c(new_n145_), .O(new_n176_));
  nor2   g093(.a(new_n168_), .b(x09), .O(new_n177_));
  oai21  g094(.a(new_n177_), .b(new_n176_), .c(new_n85_), .O(new_n178_));
  nor2   g095(.a(new_n178_), .b(x08), .O(z27));
  nand2  g096(.a(new_n174_), .b(x09), .O(new_n180_));
  nand2  g097(.a(new_n180_), .b(x39), .O(new_n181_));
  nand3  g098(.a(x40), .b(new_n174_), .c(x09), .O(new_n182_));
  ...
  nand3  g103(.a(x41), .b(new_n174_), .c(x09), .O(new_n187_));
  ...
  nor2   g112(.a(x14), .b(new_n145_), .O(new_n196_));
  nand3  g113(.a(x43), .b(new_n174_), .c(x09), .O(new_n197_));
  oai21  g114(.a(new_n196_), .b(new_n192_), .c(new_n197_), .O(new_n198_));
  ...
  nand3  g127(.a(x46), .b(new_n174_), .c(x09), .O(new_n211_));
  oai21  g128(.a(new_n196_), .b(new_n207_), .c(new_n211_), .O(new_n212_));
  ...
  nand2  g132(.a(new_n196_), .b(x00), .O(new_n216_));
