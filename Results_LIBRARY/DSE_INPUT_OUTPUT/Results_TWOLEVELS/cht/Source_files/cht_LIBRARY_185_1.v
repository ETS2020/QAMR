...
module FAU ( 
  ...
  nand2  g038(.a(new_n121_), .b(new_n94_), .O(z07));
  ...
  nand2  g043(.a(new_n126_), .b(new_n94_), .O(z08));
  nand2  g044(.a(x20), .b(new_n114_), .O(new_n128_));
  ...
  nand3  g107(.a(new_n190_), .b(new_n88_), .c(x09), .O(new_n191_));
  oai21  g108(.a(x38), .b(x10), .c(new_n93_), .O(new_n192_));
  ...
  oai21  g120(.a(x42), .b(x10), .c(new_n93_), .O(new_n204_));
  nand2  g121(.a(x42), .b(x14), .O(new_n205_));
  nand3  g122(.a(x43), .b(new_n101_), .c(x09), .O(new_n206_));
  nand2  g123(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n88_), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(new_n204_), .O(z31));
  nand2  g126(.a(new_n194_), .b(x43), .O(new_n210_));
  nand3  g127(.a(x44), .b(new_n101_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z32));
  nand2  g129(.a(new_n194_), .b(x44), .O(new_n213_));
  nand3  g130(.a(x45), .b(new_n101_), .c(x09), .O(new_n214_));
  ...
  oai21  g135(.a(x46), .b(x10), .c(new_n93_), .O(new_n219_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n219_), .O(z35));
endmodule
