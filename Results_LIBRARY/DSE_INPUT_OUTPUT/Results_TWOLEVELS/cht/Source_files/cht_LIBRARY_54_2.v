...
module FAU ( 
  ...
  nand2  g054(.a(x22), .b(new_n133_), .O(new_n138_));
  ...
  and2   g076(.a(new_n159_), .b(new_n85_), .O(z15));
  ...
  nand2  g098(.a(new_n181_), .b(x31), .O(new_n182_));
  inv1   g099(.a(new_n182_), .O(z20));
  nand2  g100(.a(new_n181_), .b(x32), .O(new_n184_));
  inv1   g101(.a(new_n184_), .O(z21));
  inv1   g102(.a(x33), .O(new_n186_));
  aoi21  g103(.a(new_n186_), .b(new_n84_), .c(x10), .O(z22));
  nand2  g104(.a(new_n181_), .b(x34), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z23));
  inv1   g106(.a(x35), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n84_), .c(x10), .O(z24));
  inv1   g108(.a(x36), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n84_), .c(x10), .O(z25));
  inv1   g110(.a(x37), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n84_), .c(x10), .O(z26));
  inv1   g112(.a(x38), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n84_), .c(x10), .O(z27));
  nand2  g114(.a(new_n181_), .b(x39), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z28));
  nand2  g116(.a(new_n181_), .b(x40), .O(new_n200_));
  inv1   g117(.a(new_n200_), .O(z29));
  nand2  g118(.a(new_n181_), .b(x41), .O(new_n202_));
  inv1   g119(.a(new_n202_), .O(z30));
  inv1   g120(.a(x42), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n84_), .c(x10), .O(z31));
  nand2  g122(.a(new_n181_), .b(x43), .O(new_n206_));
  inv1   g123(.a(new_n206_), .O(z32));
  inv1   g124(.a(x44), .O(new_n208_));
  aoi21  g125(.a(new_n208_), .b(new_n84_), .c(x10), .O(z33));
  nand2  g126(.a(new_n181_), .b(x45), .O(new_n210_));
