...
module FAU ( 
  ...
  nand2  g005(.a(x36), .b(x10), .O(new_n89_));
  ...
  nand2  g039(.a(x19), .b(new_n115_), .O(new_n123_));
  ...
  oai21  g100(.a(x10), .b(x09), .c(x36), .O(new_n184_));
  nand3  g101(.a(x35), .b(new_n84_), .c(new_n168_), .O(new_n185_));
  nand2  g102(.a(new_n185_), .b(new_n184_), .O(z24));
  nand2  g103(.a(x36), .b(new_n168_), .O(new_n187_));
  nand2  g104(.a(x37), .b(x09), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z25));
  nand2  g106(.a(x37), .b(new_n168_), .O(new_n190_));
  ...
  nand2  g113(.a(x38), .b(new_n168_), .O(new_n197_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n89_), .O(z32));
  nand2  g141(.a(new_n200_), .b(x44), .O(new_n225_));
  nand3  g142(.a(x45), .b(new_n199_), .c(x09), .O(new_n226_));
