...
module FAU ( 
  ...
  nand3  g076(.a(new_n159_), .b(new_n89_), .c(x08), .O(new_n160_));
  ...
  nand3  g112(.a(new_n195_), .b(new_n89_), .c(x08), .O(new_n196_));
  ...
  aoi21  g130(.a(new_n188_), .b(x00), .c(new_n86_), .O(new_n214_));
