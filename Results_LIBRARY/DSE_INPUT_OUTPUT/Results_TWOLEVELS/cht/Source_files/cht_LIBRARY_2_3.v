...
module FAU ( 
  ...
  nand2  g068(.a(new_n151_), .b(new_n89_), .O(z16));
  ...
  nand2  g077(.a(x30), .b(new_n116_), .O(new_n161_));
  ...
  nand2  g110(.a(x38), .b(new_n163_), .O(new_n194_));
  ...
  nand2  g117(.a(new_n200_), .b(new_n89_), .O(z28));
  inv1   g118(.a(x40), .O(new_n202_));
  aoi21  g119(.a(new_n196_), .b(x09), .c(new_n202_), .O(new_n203_));
  ...
  nand2  g124(.a(new_n196_), .b(x09), .O(new_n208_));
  nand2  g125(.a(new_n208_), .b(x41), .O(new_n209_));
  nand3  g126(.a(x42), .b(new_n196_), .c(x09), .O(new_n210_));
