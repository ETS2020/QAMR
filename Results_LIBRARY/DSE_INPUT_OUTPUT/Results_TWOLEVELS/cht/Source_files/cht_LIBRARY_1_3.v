...
module FAU ( 
  ...
  nand2  g043(.a(x20), .b(new_n120_), .O(new_n127_));
  nand2  g044(.a(x21), .b(x08), .O(new_n128_));
  aoi21  g045(.a(new_n128_), .b(new_n127_), .c(x10), .O(z09));
  nand2  g046(.a(x21), .b(new_n120_), .O(new_n130_));
  ...
  oai21  g051(.a(new_n133_), .b(new_n120_), .c(new_n134_), .O(new_n135_));
  ...
  nand2  g058(.a(x24), .b(new_n120_), .O(new_n142_));
  ...
  oai21  g063(.a(new_n145_), .b(new_n120_), .c(new_n146_), .O(new_n147_));
  ...
  nand2  g074(.a(x28), .b(new_n120_), .O(new_n158_));
  oai21  g075(.a(new_n157_), .b(new_n120_), .c(new_n158_), .O(new_n159_));
  ...
  nand2  g083(.a(x30), .b(new_n120_), .O(new_n167_));
  ...
  nand3  g132(.a(new_n212_), .b(x42), .c(new_n84_), .O(new_n216_));
  inv1   g133(.a(new_n212_), .O(new_n217_));
  oai21  g134(.a(new_n217_), .b(x10), .c(x43), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n216_), .O(z31));
  nand3  g136(.a(new_n101_), .b(new_n84_), .c(x09), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(x43), .O(new_n221_));
  nand4  g138(.a(x44), .b(new_n101_), .c(new_n84_), .d(x09), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n221_), .O(z32));
  nand2  g140(.a(new_n212_), .b(x44), .O(new_n224_));
  nand3  g141(.a(x45), .b(new_n101_), .c(x09), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n224_), .c(x10), .O(z33));
  nand2  g143(.a(new_n212_), .b(x45), .O(new_n227_));
  nand3  g144(.a(x46), .b(new_n101_), .c(x09), .O(new_n228_));
  aoi21  g145(.a(new_n228_), .b(new_n227_), .c(x10), .O(z34));
  nand2  g146(.a(new_n212_), .b(x46), .O(new_n230_));
  nand2  g147(.a(new_n217_), .b(x00), .O(new_n231_));
