...
module FAU ( 
  ...
  nand3  g023(.a(new_n106_), .b(new_n95_), .c(x08), .O(new_n107_));
  ...
  nand3  g067(.a(new_n150_), .b(new_n95_), .c(x08), .O(new_n151_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n95_), .c(x08), .O(new_n169_));
  ...
  aoi21  g091(.a(x38), .b(new_n138_), .c(new_n86_), .O(new_n175_));
  ...
  nand3  g112(.a(new_n195_), .b(new_n95_), .c(x08), .O(new_n196_));
