...
module FAU ( 
  ...
  oai21  g040(.a(new_n123_), .b(x10), .c(new_n86_), .O(z07));
  ...
  oai21  g049(.a(new_n132_), .b(x10), .c(new_n86_), .O(z09));
  ...
  oai21  g126(.a(new_n85_), .b(x09), .c(new_n209_), .O(new_n210_));
  ...
  aoi21  g134(.a(new_n215_), .b(x09), .c(new_n217_), .O(new_n218_));
  oai21  g135(.a(new_n218_), .b(x10), .c(new_n86_), .O(z27));
  aoi21  g136(.a(new_n102_), .b(x09), .c(new_n213_), .O(new_n220_));
  ...
  oai21  g151(.a(x14), .b(new_n181_), .c(x42), .O(new_n235_));
  ...
  oai21  g156(.a(x14), .b(new_n181_), .c(x43), .O(new_n240_));
  ...
  nand2  g172(.a(new_n255_), .b(new_n86_), .O(z34));
  oai21  g173(.a(x14), .b(new_n181_), .c(x46), .O(new_n257_));
