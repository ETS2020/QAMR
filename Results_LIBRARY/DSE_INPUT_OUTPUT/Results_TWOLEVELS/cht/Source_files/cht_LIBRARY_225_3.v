...
module FAU ( 
  ...
  nand2  g046(.a(new_n129_), .b(new_n89_), .O(z11));
  ...
  nand3  g093(.a(x34), .b(new_n84_), .c(new_n164_), .O(new_n177_));
  ...
  nand2  g110(.a(x38), .b(new_n164_), .O(new_n194_));
  ...
  nand2  g138(.a(new_n197_), .b(x45), .O(new_n222_));
  nand3  g139(.a(x46), .b(new_n196_), .c(x09), .O(new_n223_));
