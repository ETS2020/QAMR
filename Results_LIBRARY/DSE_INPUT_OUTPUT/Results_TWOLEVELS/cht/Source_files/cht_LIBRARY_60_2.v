...
module FAU ( 
  ...
  aoi21  g027(.a(new_n110_), .b(new_n94_), .c(x10), .O(z07));
  inv1   g028(.a(x19), .O(new_n112_));
  aoi21  g029(.a(new_n112_), .b(new_n94_), .c(x10), .O(z08));
  ...
  nand2  g036(.a(new_n107_), .b(x23), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z12));
  inv1   g038(.a(x24), .O(new_n122_));
  aoi21  g039(.a(new_n122_), .b(new_n94_), .c(x10), .O(z13));
  nand2  g040(.a(new_n107_), .b(x25), .O(new_n124_));
  inv1   g041(.a(new_n124_), .O(z14));
  nand2  g042(.a(new_n107_), .b(x26), .O(new_n126_));
  ...
  aoi21  g049(.a(new_n132_), .b(new_n94_), .c(x10), .O(z18));
  ...
  nand3  g078(.a(new_n161_), .b(new_n95_), .c(new_n94_), .O(new_n162_));
  ...
  nor2   g112(.a(x14), .b(new_n136_), .O(new_n196_));
  ...
  nand3  g120(.a(new_n203_), .b(new_n95_), .c(new_n94_), .O(new_n204_));
  ...
  nand3  g125(.a(new_n208_), .b(new_n95_), .c(new_n94_), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(z34));
  nand2  g127(.a(new_n175_), .b(x46), .O(new_n211_));
  nand2  g128(.a(new_n196_), .b(x00), .O(new_n212_));
