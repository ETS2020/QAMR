...
module FAU ( 
  ...
  nand2  g118(.a(x41), .b(new_n100_), .O(new_n202_));
  ...
  nand2  g126(.a(x43), .b(new_n100_), .O(new_n210_));
  ...
  nand2  g130(.a(x44), .b(new_n100_), .O(new_n214_));
  nand3  g131(.a(new_n214_), .b(new_n213_), .c(x09), .O(new_n215_));
  and2   g132(.a(new_n215_), .b(new_n89_), .O(z32));
  nand2  g133(.a(x44), .b(x14), .O(new_n217_));
  nand2  g134(.a(x45), .b(new_n100_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(x09), .O(new_n219_));
  and2   g136(.a(new_n219_), .b(new_n89_), .O(z33));
  ...
  and2   g140(.a(new_n223_), .b(new_n89_), .O(z34));
  ...
  and2   g144(.a(new_n227_), .b(new_n89_), .O(z35));
endmodule
