...
module FAU ( 
  ...
  nand2  g013(.a(x13), .b(new_n87_), .O(new_n97_));
  nand3  g014(.a(new_n97_), .b(new_n96_), .c(new_n85_), .O(new_n98_));
  and2   g015(.a(new_n98_), .b(new_n84_), .O(z02));
  ...
  nand3  g030(.a(new_n113_), .b(new_n84_), .c(new_n85_), .O(new_n114_));
  ...
  nand3  g056(.a(new_n139_), .b(new_n84_), .c(new_n85_), .O(new_n140_));
  ...
  nand3  g074(.a(new_n157_), .b(new_n84_), .c(new_n85_), .O(new_n158_));
  ...
  nand2  g085(.a(x30), .b(new_n116_), .O(new_n169_));
  ...
  nand3  g091(.a(new_n174_), .b(new_n84_), .c(new_n85_), .O(new_n175_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n84_), .c(new_n85_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z24));
  nand2  g111(.a(x36), .b(new_n177_), .O(new_n195_));
  ...
  nand2  g115(.a(x37), .b(new_n177_), .O(new_n199_));
  ...
  aoi21  g123(.a(x38), .b(new_n177_), .c(x01), .O(new_n207_));
  ...
  aoi21  g130(.a(new_n213_), .b(x09), .c(x01), .O(new_n214_));
  ...
  nand3  g140(.a(new_n223_), .b(new_n84_), .c(new_n85_), .O(new_n224_));
  ...
  oai21  g147(.a(x14), .b(new_n177_), .c(x43), .O(new_n231_));
  nand3  g148(.a(x44), .b(new_n209_), .c(x09), .O(new_n232_));
  ...
  aoi21  g160(.a(new_n243_), .b(x09), .c(x01), .O(new_n244_));
  ...
  aoi21  g164(.a(new_n247_), .b(x00), .c(x01), .O(new_n248_));
