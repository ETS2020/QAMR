...
module FAU ( 
  ...
  nor2   g009(.a(new_n85_), .b(x07), .O(new_n93_));
  aoi21  g010(.a(x07), .b(x05), .c(new_n93_), .O(new_n94_));
  oai21  g011(.a(new_n94_), .b(x10), .c(new_n87_), .O(z01));
  inv1   g012(.a(x13), .O(new_n96_));
  nand2  g013(.a(x07), .b(x06), .O(new_n97_));
  oai21  g014(.a(new_n96_), .b(x07), .c(new_n97_), .O(new_n98_));
  nand3  g015(.a(new_n98_), .b(new_n87_), .c(new_n84_), .O(new_n99_));
  ...
  oai21  g097(.a(new_n86_), .b(new_n179_), .c(new_n180_), .O(new_n181_));
  ...
  nand3  g101(.a(x33), .b(x12), .c(x09), .O(new_n185_));
  ...
  nand3  g110(.a(new_n193_), .b(new_n87_), .c(new_n84_), .O(new_n194_));
  ...
  oai21  g156(.a(new_n239_), .b(x10), .c(new_n87_), .O(z32));
