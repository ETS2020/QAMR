...
module FAU ( 
  ...
  nand2  g036(.a(new_n119_), .b(new_n87_), .O(z06));
  ...
  oai21  g046(.a(new_n86_), .b(x08), .c(new_n85_), .O(new_n130_));
  nand2  g047(.a(new_n130_), .b(x20), .O(new_n131_));
  ...
  oai21  g053(.a(x23), .b(new_n115_), .c(x22), .O(new_n137_));
  nand3  g054(.a(x23), .b(x21), .c(x08), .O(new_n138_));
  aoi21  g055(.a(new_n138_), .b(new_n137_), .c(x10), .O(z11));
  inv1   g056(.a(x24), .O(new_n140_));
  nand2  g057(.a(x23), .b(new_n115_), .O(new_n141_));
  oai21  g058(.a(new_n140_), .b(new_n115_), .c(new_n141_), .O(new_n142_));
  ...
  nand2  g064(.a(new_n147_), .b(new_n87_), .O(z13));
  ...
  oai21  g085(.a(new_n167_), .b(new_n115_), .c(new_n168_), .O(new_n169_));
