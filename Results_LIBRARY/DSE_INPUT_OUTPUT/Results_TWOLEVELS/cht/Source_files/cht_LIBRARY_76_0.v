...
module FAU ( 
  ...
  nand3  g026(.a(new_n109_), .b(new_n98_), .c(x09), .O(new_n110_));
  ...
  nand3  g036(.a(new_n119_), .b(new_n98_), .c(x09), .O(new_n120_));
  ...
  nand3  g041(.a(new_n124_), .b(new_n98_), .c(x09), .O(new_n125_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n98_), .c(x09), .O(new_n143_));
  ...
  nand3  g084(.a(new_n167_), .b(new_n98_), .c(x09), .O(new_n168_));
  ...
  aoi21  g100(.a(new_n183_), .b(x09), .c(x10), .O(z26));
  ...
  nand3  g114(.a(new_n197_), .b(new_n98_), .c(x09), .O(new_n198_));
  ...
  nand2  g132(.a(x45), .b(new_n186_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n215_), .c(x09), .O(new_n217_));
  and2   g134(.a(new_n217_), .b(new_n98_), .O(z33));
  ...
  and2   g138(.a(new_n221_), .b(new_n98_), .O(z34));
  ...
  and2   g142(.a(new_n225_), .b(new_n98_), .O(z35));
endmodule
