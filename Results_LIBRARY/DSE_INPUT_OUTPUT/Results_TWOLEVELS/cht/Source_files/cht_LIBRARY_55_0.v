...
module FAU ( 
  ...
  nand3  g057(.a(new_n140_), .b(new_n92_), .c(x09), .O(new_n141_));
  ...
  nand2  g096(.a(new_n179_), .b(x34), .O(new_n180_));
  inv1   g097(.a(new_n180_), .O(z22));
  nand2  g098(.a(new_n179_), .b(x35), .O(new_n182_));
  ...
  nand2  g104(.a(new_n179_), .b(x38), .O(new_n188_));
  ...
  nand2  g113(.a(x40), .b(new_n196_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n195_), .c(x09), .O(new_n198_));
  and2   g115(.a(new_n198_), .b(new_n92_), .O(z28));
  nand2  g116(.a(x40), .b(x14), .O(new_n200_));
  nand2  g117(.a(x41), .b(new_n196_), .O(new_n201_));
  ...
  nand2  g121(.a(x42), .b(new_n196_), .O(new_n205_));
  ...
  nand2  g130(.a(x44), .b(new_n196_), .O(new_n214_));
  ...
  nand2  g134(.a(x45), .b(new_n196_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(x09), .O(new_n219_));
  and2   g136(.a(new_n219_), .b(new_n92_), .O(z33));
