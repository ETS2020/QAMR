...
module FAU ( 
  ...
  oai21  g061(.a(new_n143_), .b(new_n111_), .c(new_n144_), .O(new_n145_));
  ...
  oai21  g086(.a(x10), .b(x09), .c(x33), .O(new_n170_));
  ...
  aoi21  g121(.a(new_n100_), .b(x09), .c(new_n204_), .O(new_n205_));
