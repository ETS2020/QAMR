...
module FAU ( 
  ...
  nor2   g100(.a(x12), .b(x09), .O(new_n184_));
  oai21  g101(.a(new_n184_), .b(x33), .c(x32), .O(new_n185_));
  ...
  nand3  g106(.a(x34), .b(new_n90_), .c(x09), .O(new_n190_));
  ...
  nand2  g177(.a(new_n260_), .b(new_n88_), .O(z35));
endmodule
