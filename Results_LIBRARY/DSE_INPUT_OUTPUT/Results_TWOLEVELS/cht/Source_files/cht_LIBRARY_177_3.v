...
module FAU ( 
  ...
  nand2  g001(.a(x44), .b(x36), .O(new_n85_));
  ...
  nand3  g117(.a(new_n85_), .b(x37), .c(x09), .O(new_n201_));
  inv1   g118(.a(x44), .O(new_n202_));
  nand3  g119(.a(new_n202_), .b(x36), .c(new_n177_), .O(new_n203_));
  ...
  oai21  g149(.a(new_n232_), .b(x10), .c(new_n85_), .O(z31));
  inv1   g150(.a(x43), .O(new_n234_));
  nand2  g151(.a(new_n216_), .b(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n235_), .b(x44), .c(new_n196_), .O(new_n236_));
  nand3  g153(.a(new_n216_), .b(new_n202_), .c(x43), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z32));
  nand3  g155(.a(new_n202_), .b(new_n99_), .c(x09), .O(new_n239_));
  oai21  g156(.a(new_n202_), .b(x36), .c(new_n239_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(x45), .O(new_n241_));
  nand3  g158(.a(new_n216_), .b(x44), .c(new_n196_), .O(new_n242_));
