...
module FAU ( 
  ...
  nand2  g009(.a(x41), .b(x10), .O(new_n93_));
  ...
  nand2  g067(.a(new_n150_), .b(new_n93_), .O(z14));
  ...
  nand2  g072(.a(x27), .b(new_n113_), .O(new_n156_));
  ...
  nand2  g080(.a(x29), .b(new_n113_), .O(new_n164_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n93_), .O(z20));
  ...
  oai21  g099(.a(new_n181_), .b(new_n177_), .c(new_n182_), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n88_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n93_), .O(z22));
  ...
  nand2  g119(.a(x38), .b(new_n177_), .O(new_n203_));
  ...
  nand3  g126(.a(new_n205_), .b(x40), .c(new_n88_), .O(new_n210_));
  aoi21  g127(.a(new_n98_), .b(x09), .c(x10), .O(new_n211_));
  oai21  g128(.a(new_n211_), .b(new_n209_), .c(new_n210_), .O(z29));
  nand2  g129(.a(new_n205_), .b(x41), .O(new_n213_));
  nand3  g130(.a(x42), .b(new_n98_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z30));
  nand2  g132(.a(new_n205_), .b(x42), .O(new_n216_));
  nand3  g133(.a(x43), .b(new_n98_), .c(x09), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z31));
  nand2  g135(.a(new_n205_), .b(x43), .O(new_n219_));
  nand3  g136(.a(x44), .b(new_n98_), .c(x09), .O(new_n220_));
