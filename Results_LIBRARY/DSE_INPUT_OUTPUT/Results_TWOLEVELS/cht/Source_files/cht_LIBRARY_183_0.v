...
module FAU ( 
  ...
  nand3  g053(.a(new_n136_), .b(new_n87_), .c(new_n84_), .O(new_n137_));
  ...
  nand3  g068(.a(new_n151_), .b(new_n87_), .c(new_n84_), .O(new_n152_));
  ...
  oai21  g073(.a(new_n156_), .b(x10), .c(new_n87_), .O(z14));
  ...
  nand2  g101(.a(new_n184_), .b(new_n87_), .O(z20));
  ...
  nand2  g110(.a(new_n193_), .b(new_n87_), .O(z22));
  ...
  aoi21  g135(.a(new_n103_), .b(x09), .c(new_n85_), .O(new_n219_));
  ...
  nand3  g139(.a(x35), .b(new_n103_), .c(x09), .O(new_n223_));
  nand2  g140(.a(new_n223_), .b(new_n86_), .O(new_n224_));
  nand2  g141(.a(new_n224_), .b(x41), .O(new_n225_));
  oai21  g142(.a(x14), .b(new_n180_), .c(x40), .O(new_n226_));
  ...
  oai21  g160(.a(x14), .b(new_n180_), .c(x44), .O(new_n244_));
  nand3  g161(.a(x45), .b(new_n103_), .c(x09), .O(new_n245_));
  nand2  g162(.a(new_n245_), .b(new_n244_), .O(new_n246_));
  nand3  g163(.a(new_n246_), .b(new_n87_), .c(new_n84_), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(z33));
  oai21  g165(.a(x14), .b(new_n180_), .c(x45), .O(new_n249_));
