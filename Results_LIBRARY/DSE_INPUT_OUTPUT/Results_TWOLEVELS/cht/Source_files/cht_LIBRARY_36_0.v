...
module FAU ( 
  ...
  and2   g060(.a(new_n143_), .b(new_n84_), .O(z11));
  ...
  and2   g074(.a(new_n157_), .b(new_n84_), .O(z14));
  ...
  and2   g078(.a(new_n161_), .b(new_n84_), .O(z15));
  ...
  and2   g082(.a(new_n165_), .b(new_n84_), .O(z16));
  ...
  and2   g086(.a(new_n169_), .b(new_n84_), .O(z17));
  ...
  nand3  g102(.a(x35), .b(new_n84_), .c(x09), .O(new_n186_));
  ...
  aoi21  g109(.a(new_n192_), .b(x09), .c(x10), .O(z26));
  ...
  nand2  g116(.a(x40), .b(new_n100_), .O(new_n200_));
  ...
  nand2  g125(.a(x42), .b(new_n100_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(x09), .O(new_n210_));
  and2   g127(.a(new_n210_), .b(new_n84_), .O(z30));
