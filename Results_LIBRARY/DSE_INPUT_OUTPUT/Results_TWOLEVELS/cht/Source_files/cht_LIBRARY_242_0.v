...
module FAU ( 
  ...
  inv1   g001(.a(x13), .O(new_n85_));
  inv1   g002(.a(x20), .O(new_n86_));
  ...
  nor2   g013(.a(new_n85_), .b(x07), .O(new_n97_));
  aoi21  g014(.a(x07), .b(x06), .c(new_n97_), .O(new_n98_));
  oai21  g015(.a(new_n98_), .b(x10), .c(new_n87_), .O(z02));
  inv1   g016(.a(x14), .O(new_n100_));
  nand2  g017(.a(x07), .b(x01), .O(new_n101_));
  oai21  g018(.a(new_n100_), .b(x07), .c(new_n101_), .O(new_n102_));
  nand3  g019(.a(new_n102_), .b(new_n87_), .c(new_n84_), .O(new_n103_));
  ...
  nand3  g028(.a(new_n111_), .b(new_n87_), .c(new_n84_), .O(new_n112_));
  ...
  oai21  g040(.a(new_n85_), .b(x08), .c(new_n86_), .O(new_n124_));
  nand2  g041(.a(new_n124_), .b(x19), .O(new_n125_));
  ...
  nand3  g045(.a(x21), .b(x13), .c(x08), .O(new_n129_));
  ...
  nand3  g072(.a(new_n155_), .b(new_n87_), .c(new_n84_), .O(new_n156_));
  ...
  nand2  g082(.a(new_n165_), .b(new_n87_), .O(z17));
  ...
  nand2  g087(.a(new_n170_), .b(new_n87_), .O(z18));
  ...
  nand2  g091(.a(new_n174_), .b(new_n87_), .O(z19));
  ...
  nand2  g101(.a(new_n184_), .b(new_n87_), .O(z21));
  ...
  oai21  g160(.a(new_n243_), .b(x10), .c(new_n87_), .O(z33));
  ...
  oai21  g164(.a(new_n247_), .b(x10), .c(new_n87_), .O(z34));
  ...
  nand3  g168(.a(new_n251_), .b(new_n87_), .c(new_n84_), .O(new_n252_));
