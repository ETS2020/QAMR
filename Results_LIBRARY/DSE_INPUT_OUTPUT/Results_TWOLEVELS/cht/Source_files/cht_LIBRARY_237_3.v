...
module FAU ( 
  ...
  nand2  g069(.a(x28), .b(new_n113_), .O(new_n153_));
  nand2  g070(.a(x29), .b(x08), .O(new_n154_));
  aoi21  g071(.a(new_n154_), .b(new_n153_), .c(x10), .O(z17));
  oai21  g072(.a(x10), .b(x08), .c(x30), .O(new_n156_));
  nand3  g073(.a(x29), .b(new_n84_), .c(new_n113_), .O(new_n157_));
  nand2  g074(.a(new_n157_), .b(new_n156_), .O(z18));
  inv1   g075(.a(x30), .O(new_n159_));
  nor2   g076(.a(x10), .b(new_n113_), .O(new_n160_));
  nand2  g077(.a(new_n160_), .b(x00), .O(new_n161_));
  oai21  g078(.a(new_n160_), .b(new_n159_), .c(new_n161_), .O(z19));
  ...
  nand2  g083(.a(new_n166_), .b(new_n89_), .O(z20));
  ...
  nand2  g106(.a(new_n189_), .b(new_n89_), .O(z26));
  ...
  nand2  g111(.a(x38), .b(new_n168_), .O(new_n195_));
  ...
  nand3  g143(.a(x46), .b(new_n197_), .c(x09), .O(new_n227_));
