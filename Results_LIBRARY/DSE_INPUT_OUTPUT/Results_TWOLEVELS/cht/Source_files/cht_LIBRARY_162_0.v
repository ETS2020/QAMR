...
module FAU ( 
  ...
  aoi21  g028(.a(new_n111_), .b(x08), .c(x10), .O(z08));
  inv1   g029(.a(x21), .O(new_n113_));
  aoi21  g030(.a(new_n113_), .b(x08), .c(x10), .O(z09));
  inv1   g031(.a(x22), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(x08), .c(x10), .O(z10));
  inv1   g033(.a(x23), .O(new_n117_));
  aoi21  g034(.a(new_n117_), .b(x08), .c(x10), .O(z11));
  nor2   g035(.a(x10), .b(new_n86_), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(x24), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z12));
  nand2  g038(.a(new_n119_), .b(x25), .O(new_n122_));
  ...
  nand3  g055(.a(new_n138_), .b(new_n89_), .c(x08), .O(new_n139_));
  ...
  and2   g065(.a(new_n148_), .b(new_n89_), .O(z22));
  inv1   g066(.a(x35), .O(new_n150_));
  nand2  g067(.a(x34), .b(new_n141_), .O(new_n151_));
  oai21  g068(.a(new_n150_), .b(new_n141_), .c(new_n151_), .O(new_n152_));
  ...
  nand3  g103(.a(x42), .b(new_n168_), .c(x09), .O(new_n187_));
  ...
  nand3  g112(.a(x44), .b(new_n168_), .c(x09), .O(new_n196_));
  ...
  nand2  g116(.a(new_n175_), .b(x44), .O(new_n200_));
  ...
  nand2  g121(.a(new_n175_), .b(x45), .O(new_n205_));
