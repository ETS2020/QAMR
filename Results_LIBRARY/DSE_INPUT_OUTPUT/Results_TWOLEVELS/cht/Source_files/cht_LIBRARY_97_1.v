...
module FAU ( 
  ...
  nand2  g002(.a(x33), .b(new_n85_), .O(new_n86_));
  ...
  nor2   g072(.a(x33), .b(x08), .O(new_n156_));
  oai21  g073(.a(new_n156_), .b(x27), .c(x26), .O(new_n157_));
  nand2  g074(.a(x27), .b(x08), .O(new_n158_));
  aoi21  g075(.a(new_n158_), .b(new_n157_), .c(x10), .O(z15));
  nor2   g076(.a(new_n85_), .b(x08), .O(new_n160_));
  ...
  oai21  g086(.a(new_n169_), .b(x10), .c(new_n86_), .O(z18));
  ...
  nand3  g104(.a(new_n187_), .b(x33), .c(x27), .O(new_n188_));
  inv1   g105(.a(x33), .O(new_n189_));
  nand3  g106(.a(x34), .b(new_n189_), .c(x09), .O(new_n190_));
  aoi21  g107(.a(new_n190_), .b(new_n188_), .c(x10), .O(z22));
  nand2  g108(.a(x35), .b(x09), .O(new_n192_));
  oai21  g109(.a(new_n186_), .b(x09), .c(new_n192_), .O(new_n193_));
  nand2  g110(.a(new_n193_), .b(new_n84_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n86_), .O(z23));
  inv1   g112(.a(x36), .O(new_n196_));
  nand2  g113(.a(x35), .b(new_n176_), .O(new_n197_));
  oai21  g114(.a(new_n196_), .b(new_n176_), .c(new_n197_), .O(new_n198_));
  ...
  nand2  g122(.a(x37), .b(new_n176_), .O(new_n206_));
  oai21  g123(.a(new_n205_), .b(new_n176_), .c(new_n206_), .O(new_n207_));
  ...
  oai21  g155(.a(x14), .b(new_n176_), .c(x43), .O(new_n239_));
  ...
  oai21  g160(.a(x14), .b(new_n176_), .c(x44), .O(new_n244_));
