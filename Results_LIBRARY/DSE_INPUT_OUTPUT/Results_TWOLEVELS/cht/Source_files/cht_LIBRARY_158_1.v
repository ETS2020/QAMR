...
module FAU ( 
  ...
  nand2  g096(.a(x34), .b(new_n89_), .O(new_n180_));
  ...
  oai21  g121(.a(x40), .b(x10), .c(new_n89_), .O(new_n205_));
  ...
  oai21  g137(.a(x43), .b(x10), .c(new_n89_), .O(new_n221_));
  nand2  g138(.a(x43), .b(x14), .O(new_n222_));
  ...
  nand2  g142(.a(new_n225_), .b(new_n221_), .O(z32));
  oai21  g143(.a(x44), .b(x10), .c(new_n89_), .O(new_n227_));
  nand2  g144(.a(x44), .b(x14), .O(new_n228_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n227_), .O(z33));
