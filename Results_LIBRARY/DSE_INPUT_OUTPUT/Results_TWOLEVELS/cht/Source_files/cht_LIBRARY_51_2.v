...
module FAU ( 
  ...
  nand2  g050(.a(new_n117_), .b(x27), .O(new_n134_));
  ...
  aoi21  g091(.a(x38), .b(new_n142_), .c(x08), .O(new_n175_));
  ...
  nand3  g105(.a(x42), .b(new_n100_), .c(x09), .O(new_n189_));
  ...
  oai21  g119(.a(x14), .b(new_n142_), .c(x44), .O(new_n203_));
  ...
  oai21  g124(.a(x14), .b(new_n142_), .c(x45), .O(new_n208_));
  ...
  oai21  g129(.a(x14), .b(new_n142_), .c(x46), .O(new_n213_));
