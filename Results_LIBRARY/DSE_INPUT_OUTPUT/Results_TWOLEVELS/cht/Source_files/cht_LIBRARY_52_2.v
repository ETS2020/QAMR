...
module FAU ( 
  ...
  aoi21  g022(.a(x15), .b(new_n102_), .c(x08), .O(new_n106_));
  ...
  nand2  g040(.a(new_n115_), .b(x22), .O(new_n124_));
  inv1   g041(.a(new_n124_), .O(z11));
  nand2  g042(.a(new_n115_), .b(x23), .O(new_n126_));
  ...
  nand2  g054(.a(new_n115_), .b(x29), .O(new_n138_));
  inv1   g055(.a(new_n138_), .O(z18));
  nand2  g056(.a(new_n115_), .b(x30), .O(new_n140_));
