...
module FAU ( 
  ...
  aoi21  g017(.a(x14), .b(new_n92_), .c(x20), .O(new_n101_));
  ...
  nand4  g039(.a(new_n85_), .b(x19), .c(new_n84_), .d(new_n113_), .O(new_n123_));
  inv1   g040(.a(new_n123_), .O(z08));
  nand4  g041(.a(x21), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n125_));
  ...
  oai21  g122(.a(new_n205_), .b(new_n204_), .c(new_n85_), .O(new_n206_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x20), .O(new_n212_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x20), .O(new_n222_));
  ...
  aoi21  g148(.a(new_n231_), .b(x09), .c(x20), .O(new_n232_));
  ...
  aoi21  g153(.a(new_n236_), .b(x09), .c(x20), .O(new_n237_));
