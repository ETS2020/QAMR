...
module FAU ( 
  ...
  nand2  g003(.a(x31), .b(x30), .O(new_n87_));
  ...
  nand2  g038(.a(new_n121_), .b(new_n89_), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(new_n87_), .O(z07));
  ...
  nand2  g047(.a(new_n130_), .b(new_n89_), .O(new_n131_));
  nand2  g048(.a(new_n131_), .b(new_n87_), .O(z09));
  ...
  nand2  g052(.a(new_n135_), .b(new_n89_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(new_n87_), .O(z10));
  nand2  g054(.a(x23), .b(x08), .O(new_n138_));
  oai21  g055(.a(new_n133_), .b(x08), .c(new_n138_), .O(new_n139_));
  nand2  g056(.a(new_n139_), .b(new_n89_), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n87_), .O(z11));
  ...
  nand3  g070(.a(new_n153_), .b(new_n87_), .c(new_n89_), .O(new_n154_));
  ...
  nand2  g077(.a(x27), .b(new_n114_), .O(new_n161_));
  oai21  g078(.a(new_n160_), .b(new_n114_), .c(new_n161_), .O(new_n162_));
  ...
  nand3  g085(.a(new_n87_), .b(x29), .c(new_n114_), .O(new_n169_));
  inv1   g086(.a(x30), .O(new_n170_));
  nor2   g087(.a(x31), .b(new_n170_), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(x08), .O(new_n172_));
  aoi21  g089(.a(new_n172_), .b(new_n169_), .c(x10), .O(z18));
  nor2   g090(.a(x30), .b(new_n114_), .O(new_n174_));
  oai21  g091(.a(new_n174_), .b(new_n171_), .c(x00), .O(new_n175_));
  nand2  g092(.a(new_n171_), .b(new_n114_), .O(new_n176_));
  ...
  nand3  g146(.a(new_n229_), .b(new_n87_), .c(new_n89_), .O(new_n230_));
