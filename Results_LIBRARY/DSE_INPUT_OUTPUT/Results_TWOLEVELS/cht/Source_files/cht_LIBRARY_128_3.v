...
module FAU ( 
  ...
  nand2  g003(.a(x43), .b(x33), .O(new_n87_));
  ...
  nor2   g096(.a(x33), .b(x09), .O(new_n180_));
  inv1   g097(.a(x33), .O(new_n181_));
  nor2   g098(.a(x43), .b(new_n181_), .O(new_n182_));
  oai21  g099(.a(new_n182_), .b(new_n180_), .c(x32), .O(new_n183_));
  nand2  g100(.a(new_n182_), .b(x09), .O(new_n184_));
  ...
  oai21  g145(.a(new_n228_), .b(x10), .c(new_n87_), .O(z30));
  ...
  oai21  g152(.a(new_n234_), .b(x33), .c(new_n235_), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(x44), .O(new_n237_));
  nand3  g154(.a(new_n216_), .b(x43), .c(new_n181_), .O(new_n238_));
  aoi21  g155(.a(new_n238_), .b(new_n237_), .c(x10), .O(z32));
  nand2  g156(.a(new_n216_), .b(x44), .O(new_n240_));
  nand3  g157(.a(x45), .b(new_n100_), .c(x09), .O(new_n241_));
  nand2  g158(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(new_n87_), .c(new_n89_), .O(new_n243_));
  ...
  nand2  g168(.a(new_n251_), .b(new_n89_), .O(new_n252_));
