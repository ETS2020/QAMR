...
module FAU ( 
  ...
  nand3  g026(.a(new_n109_), .b(new_n84_), .c(x09), .O(new_n110_));
  ...
  nand3  g036(.a(new_n119_), .b(new_n84_), .c(x09), .O(new_n120_));
  ...
  aoi21  g085(.a(x30), .b(new_n112_), .c(new_n92_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z19));
  nand3  g087(.a(x32), .b(new_n84_), .c(x09), .O(new_n171_));
  ...
  nand3  g095(.a(x36), .b(new_n84_), .c(x09), .O(new_n179_));
  ...
  nand2  g116(.a(x42), .b(new_n186_), .O(new_n200_));
  ...
  nand2  g120(.a(x43), .b(new_n186_), .O(new_n204_));
  ...
  nand2  g129(.a(x45), .b(new_n186_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(x09), .O(new_n214_));
  and2   g131(.a(new_n214_), .b(new_n84_), .O(z33));
