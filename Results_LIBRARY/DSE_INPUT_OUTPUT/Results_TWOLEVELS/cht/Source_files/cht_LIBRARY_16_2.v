...
module FAU ( 
  ...
  aoi21  g103(.a(new_n186_), .b(new_n84_), .c(x10), .O(z23));
  ...
  aoi21  g109(.a(new_n192_), .b(new_n84_), .c(x10), .O(z26));
  nand2  g110(.a(new_n181_), .b(x38), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z27));
  nand2  g112(.a(new_n181_), .b(x39), .O(new_n196_));
  ...
  aoi21  g119(.a(new_n202_), .b(new_n84_), .c(x10), .O(z31));
  inv1   g120(.a(x43), .O(new_n204_));
  aoi21  g121(.a(new_n204_), .b(new_n84_), .c(x10), .O(z32));
  ...
  aoi21  g127(.a(new_n210_), .b(new_n84_), .c(x10), .O(z35));
endmodule
