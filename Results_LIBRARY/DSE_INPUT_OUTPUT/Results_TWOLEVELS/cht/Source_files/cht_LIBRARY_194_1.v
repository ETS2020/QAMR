...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x42), .O(new_n93_));
  ...
  aoi21  g033(.a(x18), .b(x08), .c(x42), .O(new_n117_));
  ...
  aoi21  g053(.a(x24), .b(x08), .c(x42), .O(new_n137_));
  ...
  aoi21  g065(.a(x27), .b(x08), .c(x42), .O(new_n149_));
  ...
  aoi21  g076(.a(x30), .b(x08), .c(x42), .O(new_n160_));
  ...
  aoi21  g093(.a(x34), .b(x09), .c(x42), .O(new_n177_));
  ...
  oai21  g118(.a(x14), .b(new_n167_), .c(x39), .O(new_n202_));
  ...
  aoi21  g127(.a(new_n210_), .b(x09), .c(x42), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n208_), .c(x10), .O(z29));
  nand4  g129(.a(new_n207_), .b(new_n85_), .c(x41), .d(new_n84_), .O(new_n213_));
