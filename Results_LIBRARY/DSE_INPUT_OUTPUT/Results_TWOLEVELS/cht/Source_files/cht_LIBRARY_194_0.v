...
module FAU ( 
  ...
  nand3  g070(.a(new_n153_), .b(x42), .c(new_n84_), .O(new_n154_));
  ...
  aoi21  g085(.a(x32), .b(x09), .c(new_n92_), .O(new_n169_));
  ...
  aoi21  g093(.a(x34), .b(x09), .c(new_n92_), .O(new_n177_));
  aoi21  g094(.a(new_n177_), .b(new_n176_), .c(x10), .O(z22));
  nand2  g095(.a(x34), .b(new_n167_), .O(new_n179_));
  aoi21  g096(.a(x35), .b(x09), .c(new_n92_), .O(new_n180_));
  ...
  nand3  g110(.a(new_n193_), .b(x42), .c(new_n84_), .O(new_n194_));
  ...
  aoi21  g116(.a(x38), .b(new_n167_), .c(new_n92_), .O(new_n200_));
  ...
  nand3  g121(.a(new_n204_), .b(x42), .c(new_n84_), .O(new_n205_));
  ...
  nand2  g129(.a(new_n207_), .b(new_n209_), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(x42), .c(new_n84_), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(z30));
  inv1   g132(.a(new_n207_), .O(new_n216_));
  nor2   g133(.a(x43), .b(new_n92_), .O(new_n217_));
  ...
  nand3  g138(.a(new_n221_), .b(x42), .c(new_n84_), .O(new_n222_));
  ...
  oai21  g150(.a(x14), .b(new_n167_), .c(x46), .O(new_n234_));
