...
module FAU ( 
  ...
  aoi21  g019(.a(x14), .b(new_n102_), .c(x26), .O(new_n103_));
  ...
  aoi21  g027(.a(x16), .b(new_n102_), .c(x26), .O(new_n111_));
  ...
  aoi21  g045(.a(x21), .b(x08), .c(x26), .O(new_n129_));
  ...
  aoi21  g053(.a(x23), .b(x08), .c(x26), .O(new_n137_));
  ...
  aoi21  g065(.a(new_n148_), .b(new_n85_), .c(x10), .O(z14));
  nand4  g066(.a(x27), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n150_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x26), .O(new_n217_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x26), .O(new_n227_));
  ...
  aoi21  g148(.a(new_n231_), .b(x09), .c(x26), .O(new_n232_));
  ...
  aoi21  g157(.a(new_n240_), .b(x09), .c(x26), .O(new_n241_));
