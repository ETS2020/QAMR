...
module FAU ( 
  ...
  nand3  g056(.a(x26), .b(new_n88_), .c(new_n112_), .O(new_n140_));
  ...
  nand2  g078(.a(new_n161_), .b(new_n93_), .O(z21));
  ...
  oai21  g102(.a(new_n185_), .b(x10), .c(new_n93_), .O(z27));
  ...
  nand2  g136(.a(new_n219_), .b(new_n93_), .O(z33));
  ...
  nand2  g142(.a(new_n225_), .b(new_n93_), .O(z34));
