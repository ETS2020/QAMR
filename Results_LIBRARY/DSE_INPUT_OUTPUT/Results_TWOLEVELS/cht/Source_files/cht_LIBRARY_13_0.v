...
module FAU ( 
  ...
  nand2  g042(.a(new_n113_), .b(x26), .O(new_n126_));
  ...
  aoi21  g096(.a(new_n179_), .b(x09), .c(new_n86_), .O(new_n180_));
  ...
  nand3  g106(.a(new_n189_), .b(new_n98_), .c(x08), .O(new_n190_));
  ...
  nand3  g111(.a(new_n194_), .b(new_n98_), .c(x08), .O(new_n195_));
  ...
  nand3  g116(.a(new_n199_), .b(new_n98_), .c(x08), .O(new_n200_));
  ...
  nand3  g121(.a(new_n204_), .b(new_n98_), .c(x08), .O(new_n205_));
