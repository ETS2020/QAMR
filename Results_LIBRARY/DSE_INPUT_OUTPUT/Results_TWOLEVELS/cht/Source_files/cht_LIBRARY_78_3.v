...
module FAU ( 
  ...
  nand2  g078(.a(new_n161_), .b(new_n93_), .O(z19));
  ...
  nand2  g087(.a(new_n170_), .b(new_n93_), .O(z21));
  ...
  nand3  g118(.a(new_n197_), .b(new_n88_), .c(x09), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(x40), .O(new_n203_));
  nand4  g120(.a(x41), .b(new_n197_), .c(new_n88_), .d(x09), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(new_n203_), .O(z29));
  nand2  g122(.a(new_n198_), .b(x41), .O(new_n206_));
  nand3  g123(.a(x42), .b(new_n197_), .c(x09), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n206_), .c(x10), .O(z30));
  nand2  g125(.a(new_n198_), .b(x42), .O(new_n209_));
  nand3  g126(.a(x43), .b(new_n197_), .c(x09), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n209_), .c(x10), .O(z31));
  inv1   g128(.a(x43), .O(new_n212_));
  aoi21  g129(.a(new_n197_), .b(x09), .c(new_n212_), .O(new_n213_));
  nand3  g130(.a(x44), .b(new_n197_), .c(x09), .O(new_n214_));
  ...
  nand2  g134(.a(new_n198_), .b(x44), .O(new_n218_));
  nand3  g135(.a(x45), .b(new_n197_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z33));
  nand2  g137(.a(new_n198_), .b(x45), .O(new_n221_));
  nand3  g138(.a(x46), .b(new_n197_), .c(x09), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n221_), .c(x10), .O(z34));
  nand2  g140(.a(new_n198_), .b(x46), .O(new_n224_));
  nand3  g141(.a(new_n197_), .b(x09), .c(x00), .O(new_n225_));
