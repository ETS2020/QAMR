...
module FAU ( 
  ...
  nor2   g044(.a(x21), .b(x08), .O(new_n128_));
  inv1   g045(.a(x21), .O(new_n129_));
  nor2   g046(.a(new_n87_), .b(new_n129_), .O(new_n130_));
  oai21  g047(.a(new_n130_), .b(new_n128_), .c(x20), .O(new_n131_));
  nand2  g048(.a(new_n130_), .b(x08), .O(new_n132_));
  aoi21  g049(.a(new_n132_), .b(new_n131_), .c(x10), .O(z09));
  inv1   g050(.a(x22), .O(new_n134_));
  nand2  g051(.a(new_n134_), .b(x08), .O(new_n135_));
  nand3  g052(.a(new_n135_), .b(x40), .c(x21), .O(new_n136_));
  nand3  g053(.a(x22), .b(new_n129_), .c(x08), .O(new_n137_));
  aoi21  g054(.a(new_n137_), .b(new_n136_), .c(x10), .O(z10));
  nor2   g055(.a(new_n134_), .b(x08), .O(new_n139_));
  ...
  aoi21  g132(.a(new_n101_), .b(x09), .c(x21), .O(new_n216_));
  ...
  aoi21  g136(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n220_));
  ...
  oai21  g157(.a(x14), .b(new_n177_), .c(x44), .O(new_n241_));
