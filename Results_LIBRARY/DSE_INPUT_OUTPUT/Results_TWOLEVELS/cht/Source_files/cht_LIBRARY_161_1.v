...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x19), .O(new_n93_));
  ...
  nand4  g037(.a(new_n85_), .b(x18), .c(new_n84_), .d(new_n120_), .O(new_n121_));
  inv1   g038(.a(new_n121_), .O(z07));
  nand4  g039(.a(x20), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n123_));
  inv1   g040(.a(new_n123_), .O(z08));
  nand2  g041(.a(x20), .b(new_n120_), .O(new_n125_));
  ...
  nand2  g055(.a(x23), .b(new_n120_), .O(new_n139_));
  oai21  g056(.a(new_n138_), .b(new_n120_), .c(new_n139_), .O(new_n140_));
  ...
  nand2  g063(.a(x25), .b(new_n120_), .O(new_n147_));
  ...
  nand2  g067(.a(x26), .b(new_n120_), .O(new_n151_));
  ...
  oai21  g073(.a(new_n155_), .b(new_n120_), .c(new_n156_), .O(new_n157_));
  ...
  aoi21  g086(.a(x30), .b(new_n120_), .c(x19), .O(new_n170_));
  ...
  nand2  g103(.a(x34), .b(new_n172_), .O(new_n187_));
  ...
  aoi21  g124(.a(x38), .b(new_n172_), .c(x19), .O(new_n208_));
  ...
  aoi21  g130(.a(new_n213_), .b(x09), .c(x19), .O(new_n214_));
  ...
  aoi21  g145(.a(new_n228_), .b(x09), .c(x19), .O(new_n229_));
  ...
  aoi21  g150(.a(new_n233_), .b(x09), .c(x19), .O(new_n234_));
  ...
  nand3  g163(.a(new_n100_), .b(x09), .c(x00), .O(new_n247_));
