...
module FAU ( 
  ...
  nand2  g099(.a(new_n182_), .b(new_n94_), .O(z26));
  ...
  nand2  g104(.a(x38), .b(new_n161_), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n187_), .c(x10), .O(z27));
  aoi21  g106(.a(new_n101_), .b(x09), .c(new_n184_), .O(new_n190_));
  nand3  g107(.a(x40), .b(new_n101_), .c(x09), .O(new_n191_));
