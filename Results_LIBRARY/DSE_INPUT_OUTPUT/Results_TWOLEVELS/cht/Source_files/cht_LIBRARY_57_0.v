...
module FAU ( 
  ...
  nor2   g035(.a(x10), .b(new_n97_), .O(new_n119_));
  nand2  g036(.a(new_n119_), .b(x20), .O(new_n120_));
  inv1   g037(.a(new_n120_), .O(z08));
  nand2  g038(.a(new_n119_), .b(x21), .O(new_n122_));
  inv1   g039(.a(new_n122_), .O(z09));
  nand2  g040(.a(new_n119_), .b(x22), .O(new_n124_));
  ...
  nand2  g070(.a(x33), .b(new_n144_), .O(new_n154_));
  nand2  g071(.a(x34), .b(x09), .O(new_n155_));
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(x08), .O(new_n156_));
  and2   g073(.a(new_n156_), .b(new_n84_), .O(z22));
  ...
  and2   g077(.a(new_n160_), .b(new_n84_), .O(z23));
  inv1   g078(.a(x36), .O(new_n162_));
  nand2  g079(.a(x35), .b(new_n144_), .O(new_n163_));
  oai21  g080(.a(new_n162_), .b(new_n144_), .c(new_n163_), .O(new_n164_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n84_), .c(x08), .O(new_n174_));
  ...
  aoi21  g096(.a(x38), .b(new_n144_), .c(new_n97_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z27));
  oai21  g098(.a(x14), .b(new_n144_), .c(x39), .O(new_n182_));
  nand3  g099(.a(x40), .b(new_n100_), .c(x09), .O(new_n183_));
  nand2  g100(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand3  g101(.a(new_n184_), .b(new_n84_), .c(x08), .O(new_n185_));
  ...
  aoi21  g122(.a(new_n205_), .b(x09), .c(new_n97_), .O(new_n206_));
  aoi21  g123(.a(new_n206_), .b(new_n203_), .c(x10), .O(z32));
  nand2  g124(.a(new_n187_), .b(x44), .O(new_n208_));
  ...
  nand2  g129(.a(new_n187_), .b(x45), .O(new_n213_));
  ...
  nand2  g134(.a(new_n187_), .b(x46), .O(new_n218_));
  nor2   g135(.a(x14), .b(new_n144_), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(x00), .c(new_n97_), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n218_), .c(x10), .O(z35));
endmodule
