...
module FAU ( 
  ...
  aoi21  g027(.a(x16), .b(new_n85_), .c(x35), .O(new_n111_));
  ...
  aoi21  g077(.a(x30), .b(x08), .c(x35), .O(new_n161_));
  aoi21  g078(.a(new_n161_), .b(new_n160_), .c(x10), .O(z18));
  nand2  g079(.a(x08), .b(x00), .O(new_n163_));
  aoi21  g080(.a(x30), .b(new_n113_), .c(x35), .O(new_n164_));
  ...
  aoi21  g089(.a(x33), .b(x09), .c(x35), .O(new_n173_));
  ...
  nand2  g096(.a(x34), .b(new_n171_), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n89_), .c(x10), .O(z23));
  nand4  g098(.a(x36), .b(new_n89_), .c(new_n88_), .d(x09), .O(new_n182_));
  ...
  aoi21  g151(.a(new_n215_), .b(x00), .c(x35), .O(new_n235_));
