...
module FAU ( 
  ...
  nand2  g043(.a(new_n126_), .b(new_n96_), .O(z11));
  ...
  nand2  g054(.a(new_n137_), .b(new_n96_), .O(z14));
  ...
  nand2  g059(.a(new_n142_), .b(new_n96_), .O(z15));
  ...
  nand3  g083(.a(x32), .b(new_n91_), .c(new_n163_), .O(new_n167_));
  nand2  g084(.a(new_n167_), .b(new_n166_), .O(z21));
  oai21  g085(.a(x34), .b(x10), .c(x09), .O(new_n169_));
  nand3  g086(.a(x33), .b(new_n91_), .c(new_n163_), .O(new_n170_));
  ...
  aoi21  g107(.a(x40), .b(new_n190_), .c(x10), .O(new_n191_));
  nand2  g108(.a(new_n190_), .b(x09), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(x39), .c(new_n91_), .O(new_n193_));
  oai21  g110(.a(new_n191_), .b(new_n163_), .c(new_n193_), .O(z28));
  nand2  g111(.a(new_n192_), .b(x40), .O(new_n195_));
  nand3  g112(.a(x41), .b(new_n190_), .c(x09), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z29));
  aoi21  g114(.a(x42), .b(new_n190_), .c(x10), .O(new_n198_));
  nand3  g115(.a(new_n192_), .b(x41), .c(new_n91_), .O(new_n199_));
