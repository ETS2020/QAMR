...
module FAU ( 
  ...
  nor2   g012(.a(x10), .b(new_n92_), .O(new_n96_));
  nand2  g013(.a(new_n96_), .b(x06), .O(new_n97_));
  oai21  g014(.a(new_n96_), .b(new_n95_), .c(new_n97_), .O(z02));
  ...
  oai21  g096(.a(new_n178_), .b(new_n174_), .c(new_n179_), .O(new_n180_));
  ...
  oai21  g105(.a(new_n187_), .b(new_n174_), .c(new_n188_), .O(new_n189_));
  ...
  nand2  g121(.a(x38), .b(new_n174_), .O(new_n205_));
  ...
  nand3  g163(.a(new_n99_), .b(x09), .c(x00), .O(new_n247_));
