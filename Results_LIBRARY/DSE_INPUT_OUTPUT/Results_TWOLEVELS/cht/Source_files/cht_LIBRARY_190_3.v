...
module FAU ( 
  ...
  oai21  g031(.a(x10), .b(new_n111_), .c(x18), .O(new_n115_));
  ...
  nand2  g059(.a(new_n142_), .b(new_n89_), .O(z14));
  ...
  aoi21  g112(.a(new_n195_), .b(x09), .c(new_n188_), .O(new_n196_));
  ...
  aoi21  g118(.a(new_n195_), .b(x09), .c(new_n201_), .O(new_n202_));
  ...
  nand2  g123(.a(new_n195_), .b(x09), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(x41), .O(new_n208_));
  nand3  g125(.a(x42), .b(new_n195_), .c(x09), .O(new_n209_));
  ...
  aoi21  g131(.a(new_n195_), .b(x09), .c(new_n214_), .O(new_n215_));
  ...
  nand2  g136(.a(new_n207_), .b(x44), .O(new_n220_));
  nand3  g137(.a(x45), .b(new_n195_), .c(x09), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z33));
  nand2  g139(.a(new_n207_), .b(x45), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n195_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z34));
  nand2  g142(.a(new_n207_), .b(x46), .O(new_n226_));
  nand3  g143(.a(new_n195_), .b(x09), .c(x00), .O(new_n227_));
