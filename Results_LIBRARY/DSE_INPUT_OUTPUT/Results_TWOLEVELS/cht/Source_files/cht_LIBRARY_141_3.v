...
module FAU ( 
  ...
  nand2  g005(.a(x10), .b(x02), .O(new_n89_));
  ...
  nand2  g048(.a(new_n131_), .b(new_n89_), .O(z10));
  ...
  nand2  g052(.a(new_n135_), .b(new_n89_), .O(z11));
  ...
  nand2  g108(.a(new_n191_), .b(new_n89_), .O(z25));
  ...
  nand2  g118(.a(x38), .b(new_n166_), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z27));
  aoi21  g120(.a(new_n100_), .b(x09), .c(new_n198_), .O(new_n204_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n89_), .O(z29));
  ...
  nand2  g148(.a(new_n231_), .b(new_n89_), .O(z32));
  oai21  g149(.a(x14), .b(new_n166_), .c(x44), .O(new_n233_));
