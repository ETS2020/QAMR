...
module FAU ( 
  ...
  nand3  g077(.a(new_n160_), .b(x21), .c(new_n84_), .O(new_n161_));
  inv1   g078(.a(new_n161_), .O(z18));
  nand2  g079(.a(x08), .b(x00), .O(new_n163_));
  aoi21  g080(.a(x30), .b(new_n115_), .c(new_n102_), .O(new_n164_));
  ...
  oai21  g120(.a(new_n203_), .b(new_n201_), .c(x21), .O(new_n204_));
  ...
  aoi21  g127(.a(new_n210_), .b(x09), .c(new_n102_), .O(new_n211_));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(new_n102_), .O(new_n221_));
  ...
  nand3  g156(.a(new_n239_), .b(x21), .c(new_n84_), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(z34));
  nand2  g158(.a(new_n207_), .b(x46), .O(new_n242_));
  aoi21  g159(.a(new_n206_), .b(x00), .c(new_n102_), .O(new_n243_));
