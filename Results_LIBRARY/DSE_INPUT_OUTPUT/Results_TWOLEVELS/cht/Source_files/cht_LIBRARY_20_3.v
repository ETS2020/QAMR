...
module FAU ( 
  ...
  nand2  g005(.a(x45), .b(x10), .O(new_n89_));
  ...
  nand2  g054(.a(x23), .b(new_n113_), .O(new_n138_));
  ...
  nand2  g111(.a(new_n194_), .b(new_n89_), .O(z26));
  ...
  nand2  g136(.a(new_n219_), .b(new_n89_), .O(z31));
  ...
  nand3  g146(.a(new_n100_), .b(new_n84_), .c(x09), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(x45), .O(new_n231_));
  nand4  g148(.a(x46), .b(new_n100_), .c(new_n84_), .d(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(z34));
  inv1   g150(.a(x46), .O(new_n234_));
  aoi21  g151(.a(new_n100_), .b(x09), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n100_), .b(x09), .c(x00), .O(new_n236_));
