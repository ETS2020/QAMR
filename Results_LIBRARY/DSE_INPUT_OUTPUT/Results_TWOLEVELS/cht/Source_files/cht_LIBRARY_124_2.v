...
module FAU ( 
  ...
  nand2  g028(.a(new_n111_), .b(new_n97_), .O(z06));
  ...
  nand2  g060(.a(new_n143_), .b(new_n97_), .O(z14));
  ...
  nand2  g072(.a(new_n155_), .b(new_n97_), .O(z17));
  ...
  nand2  g076(.a(new_n159_), .b(new_n97_), .O(z18));
  ...
  nand2  g085(.a(new_n168_), .b(new_n97_), .O(z20));
  ...
  nand2  g103(.a(new_n186_), .b(new_n97_), .O(z25));
  ...
  nand2  g123(.a(new_n206_), .b(new_n97_), .O(z29));
  ...
  nand2  g129(.a(new_n212_), .b(new_n97_), .O(z30));
  ...
  aoi21  g136(.a(new_n197_), .b(x09), .c(new_n96_), .O(new_n220_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n97_), .O(z33));
  nand2  g141(.a(new_n198_), .b(x45), .O(new_n225_));
