...
module FAU ( 
  ...
  nand3  g118(.a(new_n86_), .b(x37), .c(x09), .O(new_n202_));
  nand3  g119(.a(x44), .b(x36), .c(new_n178_), .O(new_n203_));
  ...
  oai21  g151(.a(new_n234_), .b(x36), .c(new_n85_), .O(new_n235_));
  ...
  nand3  g155(.a(new_n197_), .b(new_n100_), .c(x09), .O(new_n239_));
  nand2  g156(.a(new_n239_), .b(new_n85_), .O(new_n240_));
  nand2  g157(.a(new_n240_), .b(x45), .O(new_n241_));
  nand2  g158(.a(new_n216_), .b(x44), .O(new_n242_));
  ...
  nand2  g166(.a(new_n234_), .b(x00), .O(new_n250_));
