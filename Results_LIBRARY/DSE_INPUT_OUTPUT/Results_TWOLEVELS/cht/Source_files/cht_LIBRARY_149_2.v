...
module FAU ( 
  ...
  oai21  g088(.a(new_n89_), .b(new_n167_), .c(new_n171_), .O(new_n172_));
  ...
  oai21  g099(.a(new_n181_), .b(new_n167_), .c(new_n182_), .O(new_n183_));
  ...
  oai21  g152(.a(x14), .b(new_n167_), .c(x45), .O(new_n236_));
