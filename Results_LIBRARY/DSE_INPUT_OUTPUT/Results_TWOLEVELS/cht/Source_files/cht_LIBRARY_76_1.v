...
module FAU ( 
  ...
  nand3  g126(.a(x42), .b(new_n102_), .c(x09), .O(new_n210_));
  ...
  nand3  g132(.a(x44), .b(new_n102_), .c(x09), .O(new_n216_));
  aoi21  g133(.a(new_n216_), .b(new_n215_), .c(x10), .O(z32));
  oai21  g134(.a(x44), .b(x10), .c(new_n89_), .O(new_n218_));
  nand2  g135(.a(x44), .b(x14), .O(new_n219_));
  nand3  g136(.a(x45), .b(new_n102_), .c(x09), .O(new_n220_));
  ...
  oai21  g140(.a(x45), .b(x10), .c(new_n89_), .O(new_n224_));
  nand2  g141(.a(x45), .b(x14), .O(new_n225_));
  nand3  g142(.a(x46), .b(new_n102_), .c(x09), .O(new_n226_));
  ...
  oai21  g146(.a(x46), .b(x10), .c(new_n89_), .O(new_n230_));
  nand3  g147(.a(new_n102_), .b(x09), .c(x00), .O(new_n231_));
