...
module FAU ( 
  ...
  nand2  g002(.a(x38), .b(new_n85_), .O(new_n86_));
  ...
  oai21  g051(.a(new_n85_), .b(new_n115_), .c(new_n134_), .O(new_n135_));
  nand2  g052(.a(new_n135_), .b(new_n84_), .O(new_n136_));
  nand2  g053(.a(new_n136_), .b(new_n86_), .O(z10));
  oai21  g054(.a(x23), .b(new_n115_), .c(x22), .O(new_n138_));
  inv1   g055(.a(x38), .O(new_n139_));
  nand3  g056(.a(new_n139_), .b(x23), .c(x08), .O(new_n140_));
  ...
  nand2  g062(.a(new_n145_), .b(new_n86_), .O(z12));
  ...
  nand2  g075(.a(new_n158_), .b(new_n86_), .O(z15));
  ...
  nand2  g084(.a(new_n167_), .b(new_n86_), .O(z17));
  ...
  nand2  g123(.a(new_n206_), .b(new_n178_), .O(new_n207_));
  nand3  g124(.a(new_n207_), .b(x38), .c(x22), .O(new_n208_));
  nand3  g125(.a(new_n139_), .b(x37), .c(new_n178_), .O(new_n209_));
  ...
  nor2   g130(.a(new_n139_), .b(x09), .O(new_n214_));
  ...
  nand2  g149(.a(new_n232_), .b(new_n86_), .O(z30));
  ...
  oai21  g168(.a(x14), .b(new_n178_), .c(x45), .O(new_n252_));
  ...
  oai21  g173(.a(x14), .b(new_n178_), .c(x46), .O(new_n257_));
