...
module FAU ( 
  ...
  aoi21  g091(.a(x30), .b(new_n133_), .c(x09), .O(new_n175_));
  ...
  aoi21  g105(.a(new_n188_), .b(new_n88_), .c(x10), .O(z25));
  ...
  aoi21  g111(.a(new_n194_), .b(new_n88_), .c(x10), .O(z28));
  ...
  aoi21  g125(.a(new_n208_), .b(new_n88_), .c(x10), .O(z35));
endmodule
