...
module FAU ( 
  ...
  aoi21  g115(.a(x40), .b(new_n198_), .c(x10), .O(new_n199_));
  nand2  g116(.a(new_n198_), .b(x09), .O(new_n200_));
  nand3  g117(.a(new_n200_), .b(x39), .c(new_n84_), .O(new_n201_));
  oai21  g118(.a(new_n199_), .b(new_n170_), .c(new_n201_), .O(z28));
  aoi21  g119(.a(x41), .b(new_n198_), .c(x10), .O(new_n203_));
  nand3  g120(.a(new_n200_), .b(x40), .c(new_n84_), .O(new_n204_));
  oai21  g121(.a(new_n203_), .b(new_n170_), .c(new_n204_), .O(z29));
  ...
  aoi21  g125(.a(x43), .b(new_n198_), .c(x10), .O(new_n209_));
  nand3  g126(.a(new_n200_), .b(x42), .c(new_n84_), .O(new_n210_));
  oai21  g127(.a(new_n209_), .b(new_n170_), .c(new_n210_), .O(z31));
  aoi21  g128(.a(x44), .b(new_n198_), .c(x10), .O(new_n212_));
  nand3  g129(.a(new_n200_), .b(x43), .c(new_n84_), .O(new_n213_));
  oai21  g130(.a(new_n212_), .b(new_n170_), .c(new_n213_), .O(z32));
  aoi21  g131(.a(x45), .b(new_n198_), .c(x10), .O(new_n215_));
  nand3  g132(.a(new_n200_), .b(x44), .c(new_n84_), .O(new_n216_));
  oai21  g133(.a(new_n215_), .b(new_n170_), .c(new_n216_), .O(z33));
  nand2  g134(.a(new_n200_), .b(x45), .O(new_n218_));
  nand3  g135(.a(x46), .b(new_n198_), .c(x09), .O(new_n219_));
  aoi21  g136(.a(new_n219_), .b(new_n218_), .c(x10), .O(z34));
  nand2  g137(.a(new_n200_), .b(x46), .O(new_n221_));
  nand3  g138(.a(new_n198_), .b(x09), .c(x00), .O(new_n222_));
