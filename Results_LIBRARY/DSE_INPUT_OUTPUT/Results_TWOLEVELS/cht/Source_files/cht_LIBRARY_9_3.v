...
module FAU ( 
  ...
  oai21  g071(.a(x10), .b(x08), .c(x29), .O(new_n155_));
  nand3  g072(.a(x28), .b(new_n88_), .c(new_n118_), .O(new_n156_));
  nand2  g073(.a(new_n156_), .b(new_n155_), .O(z17));
  oai21  g074(.a(x10), .b(new_n118_), .c(x29), .O(new_n158_));
  nand3  g075(.a(x30), .b(new_n88_), .c(x08), .O(new_n159_));
  nand2  g076(.a(new_n159_), .b(new_n158_), .O(z18));
  nand2  g077(.a(x08), .b(x00), .O(new_n161_));
  nand2  g078(.a(x30), .b(new_n118_), .O(new_n162_));
  ...
  nand2  g088(.a(new_n171_), .b(new_n93_), .O(z21));
  ...
  nand2  g126(.a(new_n198_), .b(x09), .O(new_n210_));
  ...
  nand3  g137(.a(x44), .b(new_n198_), .c(x09), .O(new_n221_));
  ...
  aoi21  g146(.a(new_n198_), .b(x09), .c(new_n229_), .O(new_n230_));
