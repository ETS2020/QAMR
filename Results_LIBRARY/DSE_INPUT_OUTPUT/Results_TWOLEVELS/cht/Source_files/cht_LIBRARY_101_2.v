...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x32), .O(new_n86_));
  ...
  nand3  g095(.a(new_n86_), .b(x31), .c(new_n178_), .O(new_n179_));
  nand3  g096(.a(x42), .b(x32), .c(x09), .O(new_n180_));
  aoi21  g097(.a(new_n180_), .b(new_n179_), .c(x10), .O(z20));
  inv1   g098(.a(x33), .O(new_n182_));
  nand2  g099(.a(new_n182_), .b(x09), .O(new_n183_));
  nand3  g100(.a(new_n183_), .b(x42), .c(x32), .O(new_n184_));
  ...
  nand2  g109(.a(x34), .b(new_n178_), .O(new_n193_));
  oai21  g110(.a(new_n192_), .b(new_n178_), .c(new_n193_), .O(new_n194_));
  ...
  nand2  g118(.a(x36), .b(new_n178_), .O(new_n202_));
  oai21  g119(.a(new_n201_), .b(new_n178_), .c(new_n202_), .O(new_n203_));
  ...
  aoi21  g133(.a(new_n101_), .b(x09), .c(new_n210_), .O(new_n217_));
  ...
  nand2  g137(.a(new_n220_), .b(new_n86_), .O(z28));
  ...
  aoi21  g143(.a(new_n101_), .b(x09), .c(x32), .O(new_n227_));
  ...
  nand2  g147(.a(x42), .b(x32), .O(new_n231_));
  nand3  g148(.a(new_n185_), .b(new_n101_), .c(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand2  g150(.a(new_n233_), .b(x43), .O(new_n234_));
  oai21  g151(.a(x14), .b(new_n178_), .c(x42), .O(new_n235_));
  aoi21  g152(.a(new_n235_), .b(new_n234_), .c(x10), .O(z31));
  oai21  g153(.a(x14), .b(new_n178_), .c(x43), .O(new_n237_));
