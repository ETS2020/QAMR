...
module FAU ( 
  ...
  nand2  g103(.a(x36), .b(new_n170_), .O(new_n187_));
  oai21  g104(.a(new_n186_), .b(new_n170_), .c(new_n187_), .O(new_n188_));
  ...
  nand2  g115(.a(x38), .b(new_n170_), .O(new_n199_));
  ...
  aoi21  g142(.a(new_n201_), .b(x09), .c(new_n225_), .O(new_n226_));
  ...
  nand2  g146(.a(new_n229_), .b(new_n89_), .O(z32));
  nand2  g147(.a(new_n201_), .b(x09), .O(new_n231_));
  nand2  g148(.a(new_n231_), .b(x44), .O(new_n232_));
  nand3  g149(.a(x45), .b(new_n201_), .c(x09), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(new_n232_), .c(x10), .O(z33));
  nand2  g151(.a(new_n231_), .b(x45), .O(new_n235_));
  nand3  g152(.a(x46), .b(new_n201_), .c(x09), .O(new_n236_));
  aoi21  g153(.a(new_n236_), .b(new_n235_), .c(x10), .O(z34));
  inv1   g154(.a(x46), .O(new_n238_));
  aoi21  g155(.a(new_n201_), .b(x09), .c(new_n238_), .O(new_n239_));
  nand3  g156(.a(new_n201_), .b(x09), .c(x00), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(new_n241_));
  oai21  g158(.a(new_n241_), .b(new_n239_), .c(new_n84_), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n89_), .O(z35));
endmodule
