...
module FAU ( 
  ...
  oai21  g097(.a(new_n179_), .b(new_n164_), .c(new_n180_), .O(new_n181_));
  ...
  aoi21  g115(.a(new_n198_), .b(x09), .c(new_n191_), .O(new_n199_));
  ...
  nand2  g133(.a(new_n204_), .b(x43), .O(new_n217_));
