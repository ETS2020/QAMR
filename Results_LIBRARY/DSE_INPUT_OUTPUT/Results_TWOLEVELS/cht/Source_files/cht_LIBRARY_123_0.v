...
module FAU ( 
  ...
  nand3  g009(.a(new_n92_), .b(x24), .c(new_n89_), .O(new_n93_));
  ...
  nand3  g017(.a(new_n100_), .b(x24), .c(new_n89_), .O(new_n101_));
  ...
  nand3  g025(.a(new_n108_), .b(x24), .c(new_n89_), .O(new_n109_));
  ...
  nand3  g034(.a(new_n117_), .b(x24), .c(new_n89_), .O(new_n118_));
  ...
  oai21  g048(.a(x23), .b(x08), .c(x24), .O(new_n132_));
  nor2   g049(.a(new_n132_), .b(x10), .O(z12));
  oai21  g050(.a(x25), .b(new_n111_), .c(x24), .O(new_n134_));
  nor2   g051(.a(new_n134_), .b(x10), .O(z13));
  nand2  g052(.a(x25), .b(new_n111_), .O(new_n136_));
  nand2  g053(.a(x26), .b(x08), .O(new_n137_));
  nand3  g054(.a(new_n137_), .b(new_n136_), .c(x24), .O(new_n138_));
  and2   g055(.a(new_n138_), .b(new_n89_), .O(z14));
  ...
  nand3  g068(.a(new_n151_), .b(x24), .c(new_n89_), .O(new_n152_));
  inv1   g069(.a(new_n152_), .O(z17));
  nand2  g070(.a(x29), .b(new_n111_), .O(new_n154_));
  nand2  g071(.a(x30), .b(x08), .O(new_n155_));
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(x24), .O(new_n156_));
  and2   g073(.a(new_n156_), .b(new_n89_), .O(z18));
  nand2  g074(.a(x08), .b(x00), .O(new_n158_));
  aoi21  g075(.a(x30), .b(new_n111_), .c(new_n86_), .O(new_n159_));
  ...
  nand3  g103(.a(new_n186_), .b(x24), .c(new_n89_), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(z25));
  nand2  g105(.a(x37), .b(new_n161_), .O(new_n189_));
  nand2  g106(.a(x38), .b(x09), .O(new_n190_));
  nand3  g107(.a(new_n190_), .b(new_n189_), .c(x24), .O(new_n191_));
  and2   g108(.a(new_n191_), .b(new_n89_), .O(z26));
  ...
  aoi21  g113(.a(x38), .b(new_n161_), .c(new_n86_), .O(new_n197_));
  ...
  nand3  g139(.a(new_n222_), .b(x24), .c(new_n89_), .O(new_n223_));
  ...
  nand3  g144(.a(new_n227_), .b(x24), .c(new_n89_), .O(new_n228_));
