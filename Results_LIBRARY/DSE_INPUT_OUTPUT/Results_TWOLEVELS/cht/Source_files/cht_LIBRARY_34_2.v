...
module FAU ( 
  ...
  nand2  g118(.a(new_n201_), .b(new_n114_), .O(new_n202_));
  nand2  g119(.a(new_n202_), .b(new_n88_), .O(z26));
  ...
  oai21  g125(.a(new_n208_), .b(x10), .c(new_n88_), .O(z27));
  aoi21  g126(.a(new_n98_), .b(x09), .c(x38), .O(new_n210_));
  ...
  nand3  g139(.a(new_n222_), .b(new_n88_), .c(new_n114_), .O(new_n223_));
  ...
  oai21  g145(.a(new_n228_), .b(new_n226_), .c(new_n114_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n88_), .O(z31));
  ...
  oai21  g151(.a(new_n234_), .b(new_n232_), .c(new_n114_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n88_), .O(z32));
  oai21  g153(.a(x14), .b(new_n171_), .c(x44), .O(new_n237_));
  nand3  g154(.a(x45), .b(new_n98_), .c(x09), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(new_n237_), .O(new_n239_));
  nand3  g156(.a(new_n239_), .b(new_n88_), .c(new_n114_), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(z33));
  oai21  g158(.a(x14), .b(new_n171_), .c(x45), .O(new_n242_));
  nand3  g159(.a(x46), .b(new_n98_), .c(x09), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(new_n242_), .O(new_n244_));
  nand3  g161(.a(new_n244_), .b(new_n88_), .c(new_n114_), .O(new_n245_));
  ...
  oai21  g167(.a(new_n250_), .b(new_n248_), .c(new_n114_), .O(new_n251_));
