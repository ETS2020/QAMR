...
module FAU ( 
  ...
  nor2   g030(.a(new_n113_), .b(x07), .O(new_n114_));
  aoi21  g031(.a(x07), .b(x03), .c(new_n114_), .O(new_n115_));
  oai21  g032(.a(new_n115_), .b(x10), .c(new_n87_), .O(z05));
  nor2   g033(.a(new_n85_), .b(x08), .O(new_n117_));
  ...
  oai21  g098(.a(new_n86_), .b(new_n180_), .c(new_n181_), .O(new_n182_));
  ...
  nand3  g102(.a(x33), .b(x17), .c(x09), .O(new_n186_));
  ...
  nand2  g112(.a(new_n195_), .b(new_n87_), .O(z23));
  ...
  oai21  g131(.a(new_n214_), .b(new_n213_), .c(new_n87_), .O(new_n215_));
  ...
  oai21  g142(.a(new_n225_), .b(x10), .c(new_n87_), .O(z29));
  ...
  nand3  g148(.a(x43), .b(new_n103_), .c(x09), .O(new_n232_));
  inv1   g149(.a(new_n232_), .O(new_n233_));
  aoi21  g150(.a(new_n217_), .b(x42), .c(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(x10), .c(new_n87_), .O(z31));
  ...
  oai21  g155(.a(new_n238_), .b(x10), .c(new_n87_), .O(z32));
  nand3  g156(.a(x45), .b(new_n103_), .c(x09), .O(new_n240_));
  inv1   g157(.a(new_n240_), .O(new_n241_));
  aoi21  g158(.a(new_n217_), .b(x44), .c(new_n241_), .O(new_n242_));
  oai21  g159(.a(new_n242_), .b(x10), .c(new_n87_), .O(z33));
  nand3  g160(.a(x46), .b(new_n103_), .c(x09), .O(new_n244_));
