...
module FAU ( 
  ...
  nand2  g051(.a(x23), .b(new_n116_), .O(new_n135_));
  ...
  nand2  g141(.a(new_n203_), .b(x43), .O(new_n225_));
  nand3  g142(.a(x44), .b(new_n202_), .c(x09), .O(new_n226_));
  ...
  aoi21  g154(.a(new_n202_), .b(x09), .c(new_n237_), .O(new_n238_));
  nand3  g155(.a(new_n202_), .b(x09), .c(x00), .O(new_n239_));
