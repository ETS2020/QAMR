...
module FAU ( 
  ...
  nand3  g034(.a(new_n117_), .b(new_n89_), .c(new_n95_), .O(new_n118_));
  ...
  nand3  g039(.a(new_n122_), .b(new_n89_), .c(new_n95_), .O(new_n123_));
  ...
  oai21  g044(.a(new_n127_), .b(x10), .c(new_n89_), .O(z08));
  ...
  nand3  g062(.a(new_n145_), .b(new_n89_), .c(new_n95_), .O(new_n146_));
  ...
  oai21  g071(.a(new_n154_), .b(x10), .c(new_n89_), .O(z14));
  ...
  nand3  g082(.a(new_n165_), .b(new_n89_), .c(new_n95_), .O(new_n166_));
  ...
  nand3  g096(.a(new_n179_), .b(new_n89_), .c(new_n95_), .O(new_n180_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n89_), .c(new_n95_), .O(new_n193_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n89_), .c(new_n95_), .O(new_n198_));
  ...
  nand3  g123(.a(new_n206_), .b(new_n89_), .c(new_n95_), .O(new_n207_));
  ...
  oai21  g134(.a(new_n217_), .b(new_n215_), .c(new_n95_), .O(new_n218_));
  ...
  oai21  g140(.a(new_n223_), .b(new_n221_), .c(new_n95_), .O(new_n224_));
  ...
  oai21  g146(.a(new_n229_), .b(new_n227_), .c(new_n95_), .O(new_n230_));
  nand2  g147(.a(new_n230_), .b(new_n89_), .O(z30));
  aoi21  g148(.a(new_n101_), .b(x09), .c(new_n87_), .O(new_n232_));
  ...
  aoi21  g152(.a(new_n101_), .b(x09), .c(new_n88_), .O(new_n236_));
  nand3  g153(.a(x44), .b(new_n101_), .c(x09), .O(new_n237_));
  inv1   g154(.a(new_n237_), .O(new_n238_));
  oai21  g155(.a(new_n238_), .b(new_n236_), .c(new_n95_), .O(new_n239_));
  ...
  oai21  g161(.a(new_n244_), .b(new_n242_), .c(new_n95_), .O(new_n245_));
  ...
  oai21  g172(.a(new_n255_), .b(new_n253_), .c(new_n95_), .O(new_n256_));
