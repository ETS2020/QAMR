...
module FAU ( 
  ...
  nor2   g097(.a(x43), .b(x09), .O(new_n181_));
  oai21  g098(.a(new_n181_), .b(x33), .c(x32), .O(new_n182_));
  ...
  aoi21  g126(.a(new_n209_), .b(new_n208_), .c(new_n189_), .O(new_n210_));
  ...
  aoi21  g139(.a(new_n215_), .b(x40), .c(new_n222_), .O(new_n223_));
  ...
  aoi21  g147(.a(new_n215_), .b(x42), .c(new_n230_), .O(new_n231_));
  ...
  oai21  g151(.a(new_n233_), .b(new_n87_), .c(new_n234_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(x44), .O(new_n236_));
  nand3  g153(.a(new_n215_), .b(x43), .c(x33), .O(new_n237_));
  aoi21  g154(.a(new_n237_), .b(new_n236_), .c(x10), .O(z32));
  nand2  g155(.a(new_n215_), .b(x44), .O(new_n239_));
  ...
  aoi21  g162(.a(new_n215_), .b(x45), .c(new_n245_), .O(new_n246_));
