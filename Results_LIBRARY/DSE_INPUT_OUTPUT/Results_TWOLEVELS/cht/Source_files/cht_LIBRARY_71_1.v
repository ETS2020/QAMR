...
module FAU ( 
  ...
  nand2  g026(.a(x16), .b(new_n103_), .O(new_n110_));
  ...
  oai21  g040(.a(x21), .b(x10), .c(new_n89_), .O(new_n124_));
  nand3  g041(.a(x22), .b(new_n84_), .c(x08), .O(new_n125_));
  ...
  oai21  g055(.a(x26), .b(x10), .c(new_n89_), .O(new_n139_));
  nand3  g056(.a(x27), .b(new_n84_), .c(x08), .O(new_n140_));
  ...
  nand2  g095(.a(x37), .b(new_n159_), .O(new_n179_));
  oai21  g096(.a(new_n178_), .b(new_n159_), .c(new_n179_), .O(new_n180_));
  ...
  oai21  g104(.a(new_n187_), .b(x10), .c(new_n90_), .O(z27));
  ...
  aoi21  g118(.a(new_n189_), .b(x09), .c(new_n201_), .O(new_n202_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n90_), .O(z30));
  inv1   g123(.a(x42), .O(new_n207_));
  aoi21  g124(.a(new_n189_), .b(x09), .c(new_n207_), .O(new_n208_));
  nand3  g125(.a(x43), .b(new_n189_), .c(x09), .O(new_n209_));
  inv1   g126(.a(new_n209_), .O(new_n210_));
  oai21  g127(.a(new_n210_), .b(new_n208_), .c(new_n84_), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n90_), .O(z31));
  nand2  g129(.a(new_n189_), .b(x09), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(x43), .O(new_n214_));
  nand3  g131(.a(x44), .b(new_n189_), .c(x09), .O(new_n215_));
  ...
  nand3  g137(.a(x46), .b(new_n189_), .c(x09), .O(new_n221_));
  aoi21  g138(.a(new_n221_), .b(new_n220_), .c(x10), .O(z34));
  nand2  g139(.a(new_n213_), .b(x46), .O(new_n223_));
  nand3  g140(.a(new_n189_), .b(x09), .c(x00), .O(new_n224_));
