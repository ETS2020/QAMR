...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x32), .O(new_n93_));
  ...
  aoi21  g017(.a(x14), .b(new_n92_), .c(x32), .O(new_n101_));
  aoi21  g018(.a(new_n101_), .b(new_n100_), .c(x10), .O(z03));
  nand2  g019(.a(x07), .b(x02), .O(new_n103_));
  aoi21  g020(.a(x15), .b(new_n92_), .c(x32), .O(new_n104_));
  ...
  aoi21  g029(.a(x18), .b(x08), .c(x32), .O(new_n113_));
  ...
  aoi21  g071(.a(x29), .b(x08), .c(x32), .O(new_n155_));
  ...
  aoi21  g084(.a(new_n167_), .b(new_n85_), .c(x10), .O(z20));
  nand4  g085(.a(x33), .b(new_n85_), .c(new_n84_), .d(x09), .O(new_n169_));
  ...
  aoi21  g111(.a(x38), .b(new_n166_), .c(x32), .O(new_n195_));
  ...
  aoi21  g118(.a(new_n201_), .b(x09), .c(x32), .O(new_n202_));
  ...
  aoi21  g128(.a(new_n211_), .b(x09), .c(x32), .O(new_n212_));
  ...
  aoi21  g133(.a(new_n216_), .b(x09), .c(x32), .O(new_n217_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x32), .O(new_n222_));
  ...
  aoi21  g143(.a(new_n226_), .b(x09), .c(x32), .O(new_n227_));
