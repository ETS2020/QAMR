...
module FAU ( 
  ...
  and2   g086(.a(new_n169_), .b(new_n89_), .O(z18));
  ...
  aoi21  g098(.a(new_n181_), .b(new_n88_), .c(x10), .O(z22));
  nand2  g099(.a(new_n178_), .b(x34), .O(new_n183_));
  inv1   g100(.a(new_n183_), .O(z23));
  inv1   g101(.a(x35), .O(new_n185_));
  aoi21  g102(.a(new_n185_), .b(new_n88_), .c(x10), .O(z24));
  nand2  g103(.a(new_n178_), .b(x36), .O(new_n187_));
  ...
  nand2  g111(.a(new_n178_), .b(x40), .O(new_n195_));
  inv1   g112(.a(new_n195_), .O(z29));
  inv1   g113(.a(x41), .O(new_n197_));
  aoi21  g114(.a(new_n197_), .b(new_n88_), .c(x10), .O(z30));
  inv1   g115(.a(x42), .O(new_n199_));
  aoi21  g116(.a(new_n199_), .b(new_n88_), .c(x10), .O(z31));
  inv1   g117(.a(x43), .O(new_n201_));
  aoi21  g118(.a(new_n201_), .b(new_n88_), .c(x10), .O(z32));
  inv1   g119(.a(x44), .O(new_n203_));
  aoi21  g120(.a(new_n203_), .b(new_n88_), .c(x10), .O(z33));
  nand2  g121(.a(new_n178_), .b(x45), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(z34));
  nand2  g123(.a(new_n178_), .b(x46), .O(new_n207_));
