...
module FAU ( 
  ...
  nand2  g017(.a(x14), .b(new_n87_), .O(new_n101_));
  nand3  g018(.a(new_n101_), .b(new_n100_), .c(new_n85_), .O(new_n102_));
  and2   g019(.a(new_n102_), .b(new_n84_), .O(z03));
  nand4  g020(.a(x15), .b(new_n84_), .c(new_n87_), .d(new_n85_), .O(new_n104_));
  ...
  nand3  g044(.a(new_n127_), .b(new_n84_), .c(new_n85_), .O(new_n128_));
  ...
  nand3  g082(.a(new_n165_), .b(new_n84_), .c(new_n85_), .O(new_n166_));
  ...
  nand3  g105(.a(new_n188_), .b(new_n84_), .c(new_n85_), .O(new_n189_));
  ...
  nor2   g126(.a(new_n209_), .b(x02), .O(z27));
  ...
  aoi21  g132(.a(new_n215_), .b(x09), .c(x02), .O(new_n216_));
  ...
  aoi21  g137(.a(new_n220_), .b(x09), .c(x02), .O(new_n221_));
  ...
  aoi21  g142(.a(new_n225_), .b(x09), .c(x02), .O(new_n226_));
  ...
  aoi21  g147(.a(new_n230_), .b(x09), .c(x02), .O(new_n231_));
  ...
  aoi21  g152(.a(new_n235_), .b(x09), .c(x02), .O(new_n236_));
  ...
  nand3  g156(.a(new_n239_), .b(new_n84_), .c(new_n85_), .O(new_n240_));
  ...
  aoi21  g161(.a(new_n244_), .b(x09), .c(x02), .O(new_n245_));
  aoi21  g162(.a(new_n245_), .b(new_n242_), .c(x10), .O(z34));
  nand2  g163(.a(new_n212_), .b(x46), .O(new_n247_));
  aoi21  g164(.a(new_n211_), .b(x00), .c(x02), .O(new_n248_));
