...
module FAU ( 
  ...
  nand2  g046(.a(x20), .b(new_n126_), .O(new_n130_));
  nand2  g047(.a(x21), .b(x08), .O(new_n131_));
  aoi21  g048(.a(new_n131_), .b(new_n130_), .c(x10), .O(z09));
  nand2  g049(.a(x21), .b(new_n126_), .O(new_n133_));
  ...
  nand2  g096(.a(x32), .b(new_n89_), .O(new_n180_));
  ...
  oai21  g108(.a(x36), .b(x10), .c(new_n89_), .O(new_n192_));
  nand3  g109(.a(x37), .b(new_n84_), .c(x09), .O(new_n193_));
  ...
  nand3  g122(.a(x40), .b(new_n102_), .c(x09), .O(new_n206_));
  ...
  oai21  g126(.a(x40), .b(x10), .c(new_n89_), .O(new_n210_));
  nand2  g127(.a(x40), .b(x14), .O(new_n211_));
  nand3  g128(.a(x41), .b(new_n102_), .c(x09), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nand2  g130(.a(new_n213_), .b(new_n84_), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n210_), .O(z29));
  oai21  g132(.a(x41), .b(x10), .c(new_n89_), .O(new_n216_));
  nand2  g133(.a(x41), .b(x14), .O(new_n217_));
  nand3  g134(.a(x42), .b(new_n102_), .c(x09), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n217_), .O(new_n219_));
  nand2  g136(.a(new_n219_), .b(new_n84_), .O(new_n220_));
  nand2  g137(.a(new_n220_), .b(new_n216_), .O(z30));
  nand2  g138(.a(new_n102_), .b(x09), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(x42), .O(new_n223_));
  nand3  g140(.a(x43), .b(new_n102_), .c(x09), .O(new_n224_));
  aoi21  g141(.a(new_n224_), .b(new_n223_), .c(x10), .O(z31));
  nand2  g142(.a(new_n222_), .b(x43), .O(new_n226_));
  nand3  g143(.a(x44), .b(new_n102_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z32));
  nand2  g145(.a(new_n222_), .b(x44), .O(new_n229_));
  nand3  g146(.a(x45), .b(new_n102_), .c(x09), .O(new_n230_));
  aoi21  g147(.a(new_n230_), .b(new_n229_), .c(x10), .O(z33));
  oai21  g148(.a(x45), .b(x10), .c(new_n89_), .O(new_n232_));
  nand2  g149(.a(x45), .b(x14), .O(new_n233_));
  nand3  g150(.a(x46), .b(new_n102_), .c(x09), .O(new_n234_));
  nand2  g151(.a(new_n234_), .b(new_n233_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n84_), .O(new_n236_));
  nand2  g153(.a(new_n236_), .b(new_n232_), .O(z34));
  nand2  g154(.a(new_n222_), .b(x46), .O(new_n238_));
  nand3  g155(.a(new_n102_), .b(x09), .c(x00), .O(new_n239_));
