...
module FAU ( 
  ...
  nand2  g042(.a(new_n119_), .b(x23), .O(new_n126_));
  ...
  nor3   g059(.a(x10), .b(new_n102_), .c(new_n142_), .O(z19));
  ...
  and2   g087(.a(new_n170_), .b(new_n84_), .O(z25));
  ...
  nand3  g091(.a(new_n174_), .b(new_n84_), .c(x08), .O(new_n175_));
  ...
  oai21  g098(.a(new_n181_), .b(new_n180_), .c(new_n84_), .O(new_n182_));
  nor2   g099(.a(new_n182_), .b(new_n102_), .O(z27));
  ...
  aoi21  g104(.a(new_n187_), .b(x09), .c(new_n102_), .O(new_n188_));
  ...
  aoi21  g109(.a(new_n192_), .b(x09), .c(new_n102_), .O(new_n193_));
  ...
  aoi21  g114(.a(new_n197_), .b(x09), .c(new_n102_), .O(new_n198_));
  aoi21  g115(.a(new_n198_), .b(new_n195_), .c(x10), .O(z30));
  inv1   g116(.a(new_n184_), .O(new_n200_));
  ...
  nand3  g133(.a(new_n216_), .b(new_n84_), .c(x08), .O(new_n217_));
  inv1   g134(.a(new_n217_), .O(z34));
  nand2  g135(.a(new_n184_), .b(x46), .O(new_n219_));
  oai21  g136(.a(new_n184_), .b(new_n142_), .c(new_n219_), .O(new_n220_));
