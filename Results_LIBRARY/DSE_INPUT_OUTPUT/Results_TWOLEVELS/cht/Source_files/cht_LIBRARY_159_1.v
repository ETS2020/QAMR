...
module FAU ( 
  ...
  aoi21  g024(.a(x16), .b(new_n92_), .c(x14), .O(new_n108_));
  ...
  nand2  g124(.a(x38), .b(new_n176_), .O(new_n208_));
  nand2  g125(.a(x39), .b(x09), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(new_n85_), .O(new_n210_));
  and2   g127(.a(new_n210_), .b(new_n84_), .O(z27));
  nand2  g128(.a(x39), .b(new_n176_), .O(new_n212_));
  nand2  g129(.a(x40), .b(x09), .O(new_n213_));
  nand3  g130(.a(new_n213_), .b(new_n212_), .c(new_n85_), .O(new_n214_));
  and2   g131(.a(new_n214_), .b(new_n84_), .O(z28));
  inv1   g132(.a(x40), .O(new_n216_));
  nand2  g133(.a(x41), .b(x09), .O(new_n217_));
  oai21  g134(.a(new_n216_), .b(x09), .c(new_n217_), .O(new_n218_));
  ...
  nand2  g157(.a(x45), .b(new_n176_), .O(new_n241_));
  nand2  g158(.a(x46), .b(x09), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(new_n241_), .c(new_n85_), .O(new_n243_));
  and2   g160(.a(new_n243_), .b(new_n84_), .O(z34));
  inv1   g161(.a(x46), .O(new_n245_));
  nand2  g162(.a(x09), .b(x00), .O(new_n246_));
  oai21  g163(.a(new_n245_), .b(x09), .c(new_n246_), .O(new_n247_));
