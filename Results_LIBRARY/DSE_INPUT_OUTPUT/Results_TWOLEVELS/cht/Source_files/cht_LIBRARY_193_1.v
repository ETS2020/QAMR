...
module FAU ( 
  ...
  nand2  g002(.a(x28), .b(new_n85_), .O(new_n86_));
  ...
  nor2   g032(.a(x28), .b(x08), .O(new_n116_));
  oai21  g033(.a(new_n116_), .b(x18), .c(x17), .O(new_n117_));
  nand2  g034(.a(x18), .b(x08), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n117_), .c(x10), .O(z06));
  nand2  g036(.a(x19), .b(x08), .O(new_n120_));
  oai21  g037(.a(new_n85_), .b(x08), .c(new_n120_), .O(new_n121_));
  nand2  g038(.a(new_n121_), .b(new_n84_), .O(new_n122_));
  nand2  g039(.a(new_n122_), .b(new_n86_), .O(z07));
  inv1   g040(.a(x08), .O(new_n124_));
  inv1   g041(.a(x20), .O(new_n125_));
  nand2  g042(.a(x19), .b(new_n124_), .O(new_n126_));
  oai21  g043(.a(new_n125_), .b(new_n124_), .c(new_n126_), .O(new_n127_));
  ...
  nand2  g051(.a(x21), .b(new_n124_), .O(new_n135_));
  oai21  g052(.a(new_n134_), .b(new_n124_), .c(new_n135_), .O(new_n136_));
  ...
  nand2  g060(.a(x23), .b(new_n124_), .O(new_n144_));
  oai21  g061(.a(new_n143_), .b(new_n124_), .c(new_n144_), .O(new_n145_));
  ...
  nand2  g069(.a(x25), .b(new_n124_), .O(new_n153_));
  oai21  g070(.a(new_n152_), .b(new_n124_), .c(new_n153_), .O(new_n154_));
  ...
  nand3  g082(.a(new_n86_), .b(x29), .c(x08), .O(new_n166_));
  nand3  g083(.a(x28), .b(x18), .c(new_n124_), .O(new_n167_));
  aoi21  g084(.a(new_n167_), .b(new_n166_), .c(x10), .O(z17));
  inv1   g085(.a(x30), .O(new_n169_));
  nand2  g086(.a(x29), .b(new_n124_), .O(new_n170_));
  oai21  g087(.a(new_n169_), .b(new_n124_), .c(new_n170_), .O(new_n171_));
