...
module FAU ( 
  ...
  nand2  g129(.a(new_n212_), .b(new_n86_), .O(z26));
  nand2  g130(.a(x40), .b(x38), .O(new_n214_));
  oai21  g131(.a(x38), .b(new_n181_), .c(new_n214_), .O(new_n215_));
  inv1   g132(.a(x39), .O(new_n216_));
  nand2  g133(.a(x14), .b(x00), .O(new_n217_));
  oai21  g134(.a(new_n216_), .b(x14), .c(new_n217_), .O(new_n218_));
  nand2  g135(.a(new_n218_), .b(new_n215_), .O(new_n219_));
  nand3  g136(.a(x40), .b(x38), .c(new_n181_), .O(new_n220_));
  aoi21  g137(.a(new_n220_), .b(new_n219_), .c(x10), .O(z27));
  aoi21  g138(.a(new_n102_), .b(x09), .c(new_n216_), .O(new_n222_));
  ...
  nand2  g142(.a(new_n225_), .b(new_n86_), .O(z28));
  nand3  g143(.a(new_n209_), .b(new_n102_), .c(x09), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(new_n214_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(x41), .O(new_n229_));
  oai21  g146(.a(x14), .b(new_n181_), .c(x40), .O(new_n230_));
  aoi21  g147(.a(new_n230_), .b(new_n229_), .c(x10), .O(z29));
  oai21  g148(.a(x14), .b(new_n181_), .c(x41), .O(new_n232_));
  ...
  nand2  g164(.a(new_n247_), .b(new_n86_), .O(z32));
  oai21  g165(.a(x14), .b(new_n181_), .c(x44), .O(new_n249_));
  ...
  oai21  g170(.a(x14), .b(new_n181_), .c(x45), .O(new_n254_));
  ...
  oai21  g175(.a(x14), .b(new_n181_), .c(x46), .O(new_n259_));
  nand3  g176(.a(new_n102_), .b(x09), .c(x00), .O(new_n260_));
  nand2  g177(.a(new_n260_), .b(new_n259_), .O(new_n261_));
  nand3  g178(.a(new_n261_), .b(new_n86_), .c(new_n84_), .O(new_n262_));
