...
module FAU ( 
  ...
  oai21  g109(.a(x38), .b(x10), .c(x09), .O(new_n193_));
  nand3  g110(.a(x37), .b(new_n84_), .c(new_n174_), .O(new_n194_));
  nand2  g111(.a(new_n194_), .b(new_n193_), .O(z26));
  nand2  g112(.a(x14), .b(x00), .O(new_n196_));
  nand2  g113(.a(x39), .b(new_n101_), .O(new_n197_));
  nand3  g114(.a(new_n197_), .b(new_n196_), .c(new_n84_), .O(new_n198_));
  nand2  g115(.a(new_n198_), .b(x09), .O(new_n199_));
  nand3  g116(.a(x38), .b(new_n84_), .c(new_n174_), .O(new_n200_));
  ...
  aoi21  g134(.a(x45), .b(new_n101_), .c(x10), .O(new_n218_));
  nand3  g135(.a(new_n202_), .b(x44), .c(new_n84_), .O(new_n219_));
  oai21  g136(.a(new_n218_), .b(new_n174_), .c(new_n219_), .O(z33));
  aoi21  g137(.a(x46), .b(new_n101_), .c(x10), .O(new_n221_));
  nand3  g138(.a(new_n202_), .b(x45), .c(new_n84_), .O(new_n222_));
  oai21  g139(.a(new_n221_), .b(new_n174_), .c(new_n222_), .O(z34));
  aoi21  g140(.a(new_n101_), .b(x00), .c(x10), .O(new_n224_));
  nand3  g141(.a(new_n202_), .b(x46), .c(new_n84_), .O(new_n225_));
  oai21  g142(.a(new_n224_), .b(new_n174_), .c(new_n225_), .O(z35));
endmodule
