...
module FAU ( 
  ...
  nand2  g002(.a(new_n85_), .b(x21), .O(new_n86_));
  ...
  nor2   g045(.a(x21), .b(x08), .O(new_n129_));
  inv1   g046(.a(x21), .O(new_n130_));
  nor2   g047(.a(new_n85_), .b(new_n130_), .O(new_n131_));
  oai21  g048(.a(new_n131_), .b(new_n129_), .c(x20), .O(new_n132_));
  nand2  g049(.a(new_n131_), .b(x08), .O(new_n133_));
  aoi21  g050(.a(new_n133_), .b(new_n132_), .c(x10), .O(z09));
  nor3   g051(.a(new_n129_), .b(new_n85_), .c(x10), .O(z10));
  oai21  g052(.a(x23), .b(new_n114_), .c(x22), .O(new_n136_));
  nand3  g053(.a(x23), .b(new_n130_), .c(x08), .O(new_n137_));
  ...
  nand2  g059(.a(new_n142_), .b(new_n86_), .O(z12));
  ...
  nand2  g063(.a(new_n146_), .b(new_n86_), .O(z13));
