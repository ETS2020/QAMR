...
module FAU ( 
  ...
  nand2  g122(.a(new_n205_), .b(new_n95_), .O(new_n206_));
  ...
  oai21  g152(.a(new_n235_), .b(x10), .c(new_n89_), .O(z32));
  nor2   g153(.a(x14), .b(new_n175_), .O(new_n237_));
  oai21  g154(.a(new_n237_), .b(new_n87_), .c(new_n88_), .O(new_n238_));
  nand2  g155(.a(new_n238_), .b(x44), .O(new_n239_));
  nand3  g156(.a(x45), .b(new_n101_), .c(x09), .O(new_n240_));
  aoi21  g157(.a(new_n240_), .b(new_n239_), .c(x10), .O(z33));
  nand3  g158(.a(x27), .b(new_n101_), .c(x09), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n88_), .O(new_n243_));
  nand2  g160(.a(new_n243_), .b(x46), .O(new_n244_));
  nand2  g161(.a(new_n214_), .b(x45), .O(new_n245_));
  aoi21  g162(.a(new_n245_), .b(new_n244_), .c(x10), .O(z34));
  nand2  g163(.a(new_n214_), .b(x46), .O(new_n247_));
  nand2  g164(.a(new_n237_), .b(x00), .O(new_n248_));
  nand2  g165(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand3  g166(.a(new_n249_), .b(new_n89_), .c(new_n95_), .O(new_n250_));
