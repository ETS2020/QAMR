...
module FAU ( 
  ...
  nand3  g049(.a(x23), .b(new_n88_), .c(new_n114_), .O(new_n133_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n93_), .O(z24));
  ...
  nand2  g100(.a(new_n183_), .b(new_n93_), .O(z26));
  ...
  nand2  g105(.a(x38), .b(new_n161_), .O(new_n189_));
  ...
  nand2  g111(.a(new_n194_), .b(new_n93_), .O(z28));
  ...
  nand3  g126(.a(x44), .b(new_n100_), .c(x09), .O(new_n210_));
  ...
  nand3  g138(.a(new_n100_), .b(x09), .c(x00), .O(new_n222_));
