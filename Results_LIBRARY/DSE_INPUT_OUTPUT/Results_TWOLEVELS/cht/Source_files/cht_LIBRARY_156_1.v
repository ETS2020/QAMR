...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x30), .O(new_n93_));
  ...
  aoi21  g022(.a(x15), .b(new_n92_), .c(x30), .O(new_n106_));
  ...
  aoi21  g031(.a(x18), .b(x08), .c(x30), .O(new_n115_));
  ...
  aoi21  g066(.a(x28), .b(x08), .c(x30), .O(new_n150_));
  aoi21  g067(.a(new_n150_), .b(new_n149_), .c(x10), .O(z16));
  nand2  g068(.a(x28), .b(new_n113_), .O(new_n152_));
  aoi21  g069(.a(x29), .b(x08), .c(x30), .O(new_n153_));
  aoi21  g070(.a(new_n153_), .b(new_n152_), .c(x10), .O(z17));
  nand4  g071(.a(new_n85_), .b(x29), .c(new_n84_), .d(new_n113_), .O(new_n155_));
  inv1   g072(.a(new_n155_), .O(z18));
  nand4  g073(.a(new_n85_), .b(new_n84_), .c(x08), .d(x00), .O(new_n157_));
  ...
  and2   g079(.a(new_n162_), .b(new_n84_), .O(z20));
  ...
  and2   g088(.a(new_n171_), .b(new_n84_), .O(z22));
  ...
  and2   g092(.a(new_n175_), .b(new_n84_), .O(z23));
  inv1   g093(.a(x36), .O(new_n177_));
  nand2  g094(.a(x35), .b(new_n159_), .O(new_n178_));
  oai21  g095(.a(new_n177_), .b(new_n159_), .c(new_n178_), .O(new_n179_));
  ...
  aoi21  g110(.a(x38), .b(new_n159_), .c(x30), .O(new_n194_));
  aoi21  g111(.a(new_n194_), .b(new_n193_), .c(x10), .O(z27));
  oai21  g112(.a(x14), .b(new_n159_), .c(x39), .O(new_n196_));
  ...
  aoi21  g121(.a(new_n204_), .b(x09), .c(x30), .O(new_n205_));
  ...
  aoi21  g126(.a(new_n209_), .b(x09), .c(x30), .O(new_n210_));
  aoi21  g127(.a(new_n210_), .b(new_n207_), .c(x10), .O(z30));
  oai21  g128(.a(x14), .b(new_n159_), .c(x42), .O(new_n212_));
  ...
  oai21  g133(.a(x14), .b(new_n159_), .c(x43), .O(new_n217_));
  ...
  aoi21  g141(.a(new_n224_), .b(x09), .c(x30), .O(new_n225_));
  aoi21  g142(.a(new_n225_), .b(new_n222_), .c(x10), .O(z33));
  oai21  g143(.a(x14), .b(new_n159_), .c(x45), .O(new_n227_));
  ...
  nand2  g148(.a(new_n201_), .b(x46), .O(new_n232_));
  nor2   g149(.a(x14), .b(new_n159_), .O(new_n233_));
  aoi21  g150(.a(new_n233_), .b(x00), .c(x30), .O(new_n234_));
