...
module FAU ( 
  ...
  aoi21  g024(.a(new_n107_), .b(new_n94_), .c(x10), .O(z06));
  ...
  aoi21  g031(.a(new_n114_), .b(new_n94_), .c(x10), .O(z09));
  inv1   g032(.a(x21), .O(new_n116_));
  aoi21  g033(.a(new_n116_), .b(new_n94_), .c(x10), .O(z10));
  inv1   g034(.a(x22), .O(new_n118_));
  aoi21  g035(.a(new_n118_), .b(new_n94_), .c(x10), .O(z11));
  inv1   g036(.a(x23), .O(new_n120_));
  aoi21  g037(.a(new_n120_), .b(new_n94_), .c(x10), .O(z12));
  ...
  aoi21  g045(.a(new_n128_), .b(new_n94_), .c(x10), .O(z16));
  inv1   g046(.a(x28), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n94_), .c(x10), .O(z17));
  nand2  g048(.a(new_n109_), .b(x29), .O(new_n132_));
  inv1   g049(.a(new_n132_), .O(z18));
  inv1   g050(.a(x30), .O(new_n134_));
  aoi21  g051(.a(new_n134_), .b(new_n94_), .c(x10), .O(z19));
  inv1   g052(.a(x31), .O(new_n136_));
  nand2  g053(.a(x32), .b(x09), .O(new_n137_));
  oai21  g054(.a(new_n136_), .b(x09), .c(new_n137_), .O(new_n138_));
  nand3  g055(.a(new_n138_), .b(new_n95_), .c(new_n94_), .O(new_n139_));
  inv1   g056(.a(new_n139_), .O(z20));
  inv1   g057(.a(x09), .O(new_n141_));
  nand2  g058(.a(x32), .b(new_n141_), .O(new_n142_));
  nand2  g059(.a(x33), .b(x09), .O(new_n143_));
  nand3  g060(.a(new_n143_), .b(new_n142_), .c(new_n94_), .O(new_n144_));
  and2   g061(.a(new_n144_), .b(new_n95_), .O(z21));
  nand2  g062(.a(x33), .b(new_n141_), .O(new_n146_));
  nand2  g063(.a(x34), .b(x09), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(new_n146_), .c(new_n94_), .O(new_n148_));
  and2   g065(.a(new_n148_), .b(new_n95_), .O(z22));
  nand2  g066(.a(x34), .b(new_n141_), .O(new_n150_));
  nand2  g067(.a(x35), .b(x09), .O(new_n151_));
  nand3  g068(.a(new_n151_), .b(new_n150_), .c(new_n94_), .O(new_n152_));
  and2   g069(.a(new_n152_), .b(new_n95_), .O(z23));
  inv1   g070(.a(x36), .O(new_n154_));
  nand2  g071(.a(x35), .b(new_n141_), .O(new_n155_));
  oai21  g072(.a(new_n154_), .b(new_n141_), .c(new_n155_), .O(new_n156_));
  nand3  g073(.a(new_n156_), .b(new_n95_), .c(new_n94_), .O(new_n157_));
  ...
  nand2  g080(.a(x37), .b(new_n141_), .O(new_n164_));
  oai21  g081(.a(new_n163_), .b(new_n141_), .c(new_n164_), .O(new_n165_));
  nand3  g082(.a(new_n165_), .b(new_n95_), .c(new_n94_), .O(new_n166_));
  inv1   g083(.a(new_n166_), .O(z26));
  nand2  g084(.a(x14), .b(x00), .O(new_n168_));
  nand2  g085(.a(x39), .b(new_n96_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(new_n141_), .O(new_n170_));
  nor2   g087(.a(new_n163_), .b(x09), .O(new_n171_));
  oai21  g088(.a(new_n171_), .b(new_n170_), .c(new_n95_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(x08), .O(z27));
  nand2  g090(.a(new_n96_), .b(x09), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(x39), .O(new_n175_));
  nand3  g092(.a(x40), .b(new_n96_), .c(x09), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n95_), .c(new_n94_), .O(new_n178_));
  inv1   g095(.a(new_n178_), .O(z28));
  nand2  g096(.a(new_n174_), .b(x40), .O(new_n180_));
  nand3  g097(.a(x41), .b(new_n96_), .c(x09), .O(new_n181_));
  nand2  g098(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g099(.a(new_n182_), .b(new_n95_), .c(new_n94_), .O(new_n183_));
  ...
  aoi21  g104(.a(new_n187_), .b(x09), .c(x08), .O(new_n188_));
  aoi21  g105(.a(new_n188_), .b(new_n185_), .c(x10), .O(z30));
  inv1   g106(.a(new_n174_), .O(new_n190_));
  nand3  g107(.a(x43), .b(new_n96_), .c(x09), .O(new_n191_));
  oai21  g108(.a(new_n190_), .b(new_n186_), .c(new_n191_), .O(new_n192_));
  nand3  g109(.a(new_n192_), .b(new_n95_), .c(new_n94_), .O(new_n193_));
  inv1   g110(.a(new_n193_), .O(z31));
  nand2  g111(.a(new_n174_), .b(x43), .O(new_n195_));
  nand3  g112(.a(x44), .b(new_n96_), .c(x09), .O(new_n196_));
  ...
  aoi21  g127(.a(new_n190_), .b(x00), .c(x08), .O(new_n211_));
