...
module FAU ( 
  ...
  nand2  g009(.a(x45), .b(x10), .O(new_n93_));
  ...
  nand2  g030(.a(new_n113_), .b(new_n93_), .O(z06));
  ...
  nand2  g034(.a(new_n117_), .b(new_n93_), .O(z07));
  ...
  oai21  g056(.a(new_n138_), .b(new_n109_), .c(new_n139_), .O(new_n140_));
  nand2  g057(.a(new_n140_), .b(new_n88_), .O(new_n141_));
  nand2  g058(.a(new_n141_), .b(new_n93_), .O(z13));
  ...
  nand2  g071(.a(new_n154_), .b(new_n93_), .O(z16));
  ...
  oai21  g077(.a(new_n159_), .b(new_n109_), .c(new_n160_), .O(new_n161_));
  ...
  nand2  g083(.a(new_n166_), .b(new_n93_), .O(z19));
  ...
  nand2  g088(.a(new_n171_), .b(new_n93_), .O(z20));
  ...
  nand2  g103(.a(new_n186_), .b(new_n93_), .O(z24));
  ...
  oai21  g116(.a(new_n199_), .b(x10), .c(new_n93_), .O(z27));
  ...
  nand3  g122(.a(x41), .b(new_n98_), .c(x09), .O(new_n206_));
  ...
  nand3  g140(.a(new_n201_), .b(x44), .c(new_n88_), .O(new_n224_));
  aoi21  g141(.a(new_n98_), .b(x09), .c(x10), .O(new_n225_));
  oai21  g142(.a(new_n225_), .b(new_n223_), .c(new_n224_), .O(z33));
  nand3  g143(.a(new_n98_), .b(new_n88_), .c(x09), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(x45), .O(new_n228_));
  nand4  g145(.a(x46), .b(new_n98_), .c(new_n88_), .d(x09), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(new_n228_), .O(z34));
