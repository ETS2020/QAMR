...
module FAU ( 
  ...
  nand3  g032(.a(new_n115_), .b(new_n88_), .c(new_n94_), .O(new_n116_));
  ...
  nand3  g042(.a(new_n125_), .b(new_n88_), .c(new_n94_), .O(new_n126_));
  ...
  oai21  g059(.a(new_n142_), .b(x10), .c(new_n88_), .O(z12));
  ...
  nand3  g067(.a(new_n150_), .b(new_n88_), .c(new_n94_), .O(new_n151_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n88_), .c(new_n94_), .O(new_n201_));
  ...
  nand3  g144(.a(new_n227_), .b(new_n88_), .c(new_n94_), .O(new_n228_));
  inv1   g145(.a(new_n228_), .O(z30));
  aoi21  g146(.a(new_n100_), .b(x09), .c(x15), .O(new_n230_));
  ...
  nand3  g150(.a(new_n105_), .b(new_n100_), .c(x09), .O(new_n234_));
  nand2  g151(.a(new_n234_), .b(new_n87_), .O(new_n235_));
  ...
  nand2  g165(.a(new_n248_), .b(new_n88_), .O(z34));
