...
module FAU ( 
  ...
  nand3  g072(.a(new_n155_), .b(new_n88_), .c(new_n94_), .O(new_n156_));
  ...
  nand3  g094(.a(x32), .b(new_n90_), .c(x09), .O(new_n178_));
  ...
  nand3  g108(.a(new_n191_), .b(new_n88_), .c(new_n94_), .O(new_n192_));
  ...
  nand3  g172(.a(new_n255_), .b(new_n88_), .c(new_n94_), .O(new_n256_));
