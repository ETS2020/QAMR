...
module FAU ( 
  ...
  nand2  g002(.a(x31), .b(new_n85_), .O(new_n86_));
  ...
  nand3  g053(.a(new_n136_), .b(new_n86_), .c(new_n84_), .O(new_n137_));
  ...
  nor2   g083(.a(x31), .b(x08), .O(new_n167_));
  oai21  g084(.a(new_n167_), .b(x29), .c(x28), .O(new_n168_));
  nand2  g085(.a(x29), .b(x08), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z17));
  nor2   g087(.a(new_n85_), .b(x08), .O(new_n171_));
  aoi21  g088(.a(x30), .b(x08), .c(new_n171_), .O(new_n172_));
  oai21  g089(.a(new_n172_), .b(x10), .c(new_n86_), .O(z18));
  ...
  nand3  g096(.a(new_n179_), .b(x31), .c(x29), .O(new_n180_));
  inv1   g097(.a(x31), .O(new_n181_));
  nand3  g098(.a(x32), .b(new_n181_), .c(x09), .O(new_n182_));
  aoi21  g099(.a(new_n182_), .b(new_n180_), .c(x10), .O(z20));
  nand2  g100(.a(x33), .b(x09), .O(new_n184_));
  oai21  g101(.a(new_n178_), .b(x09), .c(new_n184_), .O(new_n185_));
  ...
  nand2  g122(.a(new_n205_), .b(new_n86_), .O(z25));
  ...
  nand3  g126(.a(new_n209_), .b(new_n86_), .c(new_n84_), .O(new_n210_));
  inv1   g127(.a(new_n210_), .O(z26));
  nand2  g128(.a(x14), .b(x00), .O(new_n212_));
  nand2  g129(.a(x39), .b(new_n102_), .O(new_n213_));
  aoi21  g130(.a(new_n213_), .b(new_n212_), .c(new_n188_), .O(new_n214_));
  nor2   g131(.a(new_n207_), .b(x09), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n214_), .c(new_n86_), .O(new_n216_));
  nor2   g133(.a(new_n216_), .b(x10), .O(z27));
  inv1   g134(.a(x39), .O(new_n218_));
  nor2   g135(.a(x14), .b(new_n188_), .O(new_n219_));
  ...
  nand3  g148(.a(new_n231_), .b(new_n86_), .c(new_n84_), .O(new_n232_));
  ...
  nand3  g153(.a(new_n236_), .b(new_n86_), .c(new_n84_), .O(new_n237_));
  ...
  nand2  g173(.a(new_n256_), .b(new_n84_), .O(new_n257_));
  nand2  g174(.a(new_n257_), .b(new_n86_), .O(z35));
endmodule
