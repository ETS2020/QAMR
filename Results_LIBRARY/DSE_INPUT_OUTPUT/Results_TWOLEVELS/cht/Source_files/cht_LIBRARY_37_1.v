...
module FAU ( 
  ...
  nor2   g058(.a(x45), .b(x08), .O(new_n142_));
  oai21  g059(.a(new_n142_), .b(x24), .c(x23), .O(new_n143_));
  ...
  inv1   g063(.a(x45), .O(new_n147_));
  nand3  g064(.a(new_n147_), .b(x25), .c(x08), .O(new_n148_));
  aoi21  g065(.a(new_n148_), .b(new_n146_), .c(x10), .O(z13));
  ...
  aoi21  g164(.a(new_n101_), .b(x09), .c(new_n147_), .O(new_n248_));
