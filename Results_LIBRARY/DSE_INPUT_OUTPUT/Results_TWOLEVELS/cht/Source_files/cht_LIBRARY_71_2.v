...
module FAU ( 
  ...
  aoi21  g030(.a(new_n113_), .b(new_n94_), .c(x10), .O(z07));
  inv1   g031(.a(x19), .O(new_n115_));
  aoi21  g032(.a(new_n115_), .b(new_n94_), .c(x10), .O(z08));
  ...
  aoi21  g037(.a(new_n120_), .b(new_n94_), .c(x10), .O(z10));
  ...
  aoi21  g045(.a(new_n128_), .b(new_n94_), .c(x10), .O(z14));
  inv1   g046(.a(x26), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n94_), .c(x10), .O(z15));
  nand2  g048(.a(new_n117_), .b(x27), .O(new_n132_));
  inv1   g049(.a(new_n132_), .O(z16));
  nand2  g050(.a(new_n117_), .b(x28), .O(new_n134_));
  ...
  nand3  g064(.a(new_n147_), .b(new_n95_), .c(new_n94_), .O(new_n148_));
  ...
  nand3  g077(.a(new_n160_), .b(new_n159_), .c(new_n94_), .O(new_n161_));
  ...
  nand3  g085(.a(new_n168_), .b(new_n167_), .c(new_n94_), .O(new_n169_));
  ...
  nand3  g117(.a(new_n200_), .b(new_n95_), .c(new_n94_), .O(new_n201_));
  ...
  nand3  g132(.a(new_n215_), .b(new_n95_), .c(new_n94_), .O(new_n216_));
