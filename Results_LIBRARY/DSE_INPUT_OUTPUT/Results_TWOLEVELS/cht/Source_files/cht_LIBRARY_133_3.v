...
module FAU ( 
  ...
  nand2  g064(.a(x26), .b(new_n109_), .O(new_n148_));
  ...
  nand2  g072(.a(x28), .b(new_n109_), .O(new_n156_));
  ...
  aoi21  g129(.a(new_n199_), .b(x09), .c(new_n212_), .O(new_n213_));
  ...
  aoi21  g141(.a(new_n199_), .b(x09), .c(new_n224_), .O(new_n225_));
  nand3  g142(.a(x46), .b(new_n199_), .c(x09), .O(new_n226_));
