...
module FAU ( 
  ...
  oai21  g126(.a(new_n85_), .b(new_n181_), .c(new_n209_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n84_), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(new_n86_), .O(z26));
  oai21  g129(.a(x40), .b(new_n181_), .c(new_n85_), .O(new_n213_));
  inv1   g130(.a(x39), .O(new_n214_));
  nand2  g131(.a(x14), .b(x00), .O(new_n215_));
  oai21  g132(.a(new_n214_), .b(x14), .c(new_n215_), .O(new_n216_));
  nand2  g133(.a(new_n216_), .b(new_n213_), .O(new_n217_));
  nand2  g134(.a(x38), .b(new_n181_), .O(new_n218_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n86_), .O(z28));
  nand2  g141(.a(x40), .b(x38), .O(new_n225_));
  inv1   g142(.a(x40), .O(new_n226_));
  nand3  g143(.a(new_n226_), .b(new_n102_), .c(x09), .O(new_n227_));
  nand2  g144(.a(new_n227_), .b(new_n225_), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(x41), .O(new_n229_));
  nand2  g146(.a(new_n102_), .b(x09), .O(new_n230_));
  nand3  g147(.a(new_n230_), .b(x40), .c(x38), .O(new_n231_));
  aoi21  g148(.a(new_n231_), .b(new_n229_), .c(x10), .O(z29));
  oai21  g149(.a(x14), .b(new_n181_), .c(x41), .O(new_n233_));
  ...
  inv1   g175(.a(new_n258_), .O(z34));
  oai21  g176(.a(x14), .b(new_n181_), .c(x46), .O(new_n260_));
  nand3  g177(.a(new_n102_), .b(x09), .c(x00), .O(new_n261_));
  nand2  g178(.a(new_n261_), .b(new_n260_), .O(new_n262_));
  nand3  g179(.a(new_n262_), .b(new_n86_), .c(new_n84_), .O(new_n263_));
