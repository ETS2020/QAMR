...
module FAU ( 
  ...
  nand2  g004(.a(new_n87_), .b(x18), .O(new_n88_));
  ...
  nand3  g036(.a(new_n119_), .b(x39), .c(x18), .O(new_n120_));
  inv1   g037(.a(x18), .O(new_n121_));
  nand3  g038(.a(x19), .b(new_n121_), .c(x08), .O(new_n122_));
  aoi21  g039(.a(new_n122_), .b(new_n120_), .c(x10), .O(z07));
  nor2   g040(.a(new_n118_), .b(x08), .O(new_n124_));
  ...
  nand3  g065(.a(new_n148_), .b(new_n88_), .c(new_n94_), .O(new_n149_));
  ...
  nand3  g074(.a(new_n157_), .b(new_n88_), .c(new_n94_), .O(new_n158_));
  ...
  aoi21  g127(.a(new_n121_), .b(x14), .c(x39), .O(new_n211_));
  ...
  aoi21  g136(.a(new_n217_), .b(x39), .c(new_n219_), .O(new_n220_));
  oai21  g137(.a(new_n220_), .b(x10), .c(new_n88_), .O(z28));
  nand2  g138(.a(new_n217_), .b(x40), .O(new_n222_));
  ...
  aoi21  g145(.a(new_n217_), .b(x41), .c(new_n228_), .O(new_n229_));
  oai21  g146(.a(new_n229_), .b(x10), .c(new_n88_), .O(z30));
  nand2  g147(.a(new_n217_), .b(x42), .O(new_n231_));
  nand3  g148(.a(x43), .b(new_n100_), .c(x09), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n231_), .O(new_n233_));
  nand3  g150(.a(new_n233_), .b(new_n88_), .c(new_n94_), .O(new_n234_));
  inv1   g151(.a(new_n234_), .O(z31));
  nand2  g152(.a(new_n217_), .b(x43), .O(new_n236_));
  nand3  g153(.a(x44), .b(new_n100_), .c(x09), .O(new_n237_));
  nand2  g154(.a(new_n237_), .b(new_n236_), .O(new_n238_));
  nand3  g155(.a(new_n238_), .b(new_n88_), .c(new_n94_), .O(new_n239_));
  inv1   g156(.a(new_n239_), .O(z32));
  nand2  g157(.a(new_n217_), .b(x44), .O(new_n241_));
  nand3  g158(.a(x45), .b(new_n100_), .c(x09), .O(new_n242_));
  nand2  g159(.a(new_n242_), .b(new_n241_), .O(new_n243_));
  nand3  g160(.a(new_n243_), .b(new_n88_), .c(new_n94_), .O(new_n244_));
  inv1   g161(.a(new_n244_), .O(z33));
  nand2  g162(.a(new_n217_), .b(x45), .O(new_n246_));
  nand3  g163(.a(x46), .b(new_n100_), .c(x09), .O(new_n247_));
  and2   g164(.a(new_n247_), .b(new_n246_), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(x10), .c(new_n88_), .O(z34));
  nand2  g166(.a(new_n217_), .b(x46), .O(new_n250_));
  oai21  g167(.a(new_n217_), .b(new_n210_), .c(new_n250_), .O(new_n251_));
