...
module FAU ( 
  ...
  nand2  g031(.a(new_n114_), .b(new_n94_), .O(z06));
  ...
  nand2  g035(.a(new_n118_), .b(new_n94_), .O(z07));
  ...
  oai21  g070(.a(new_n152_), .b(new_n110_), .c(new_n153_), .O(new_n154_));
  ...
  nand2  g081(.a(x30), .b(new_n110_), .O(new_n165_));
  ...
  aoi21  g124(.a(new_n202_), .b(x09), .c(new_n207_), .O(new_n208_));
  ...
  nand2  g134(.a(new_n217_), .b(new_n94_), .O(z30));
  ...
  aoi21  g142(.a(new_n202_), .b(x09), .c(new_n225_), .O(new_n226_));
  ...
  aoi21  g151(.a(new_n202_), .b(x09), .c(new_n234_), .O(new_n235_));
  nand3  g152(.a(new_n202_), .b(x09), .c(x00), .O(new_n236_));
