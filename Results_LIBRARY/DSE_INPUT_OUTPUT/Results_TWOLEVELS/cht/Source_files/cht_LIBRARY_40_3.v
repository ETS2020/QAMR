...
module FAU ( 
  ...
  nand2  g003(.a(x39), .b(x27), .O(new_n87_));
  ...
  nand3  g030(.a(new_n113_), .b(new_n87_), .c(new_n101_), .O(new_n114_));
  ...
  nand3  g035(.a(new_n118_), .b(new_n87_), .c(new_n101_), .O(new_n119_));
  ...
  nand3  g040(.a(new_n123_), .b(new_n87_), .c(new_n101_), .O(new_n124_));
  ...
  nand3  g045(.a(new_n128_), .b(new_n87_), .c(new_n101_), .O(new_n129_));
  ...
  nand3  g059(.a(new_n142_), .b(new_n87_), .c(new_n101_), .O(new_n143_));
  ...
  nand3  g068(.a(new_n151_), .b(new_n87_), .c(new_n101_), .O(new_n152_));
  ...
  nand3  g090(.a(new_n173_), .b(new_n87_), .c(new_n101_), .O(new_n174_));
  ...
  nand3  g105(.a(new_n188_), .b(new_n87_), .c(new_n101_), .O(new_n189_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n87_), .c(new_n101_), .O(new_n198_));
  ...
  nand2  g126(.a(x39), .b(new_n158_), .O(new_n210_));
  inv1   g127(.a(x39), .O(new_n211_));
  nand2  g128(.a(new_n211_), .b(x14), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n210_), .c(new_n209_), .O(new_n213_));
  nand3  g130(.a(x39), .b(new_n158_), .c(new_n97_), .O(new_n214_));
  inv1   g131(.a(new_n214_), .O(new_n215_));
  oai21  g132(.a(new_n215_), .b(new_n213_), .c(x09), .O(new_n216_));
  nand3  g133(.a(new_n87_), .b(x38), .c(new_n176_), .O(new_n217_));
  aoi21  g134(.a(new_n217_), .b(new_n216_), .c(x10), .O(z27));
  nor2   g135(.a(x14), .b(new_n176_), .O(new_n219_));
  nand3  g136(.a(x40), .b(new_n97_), .c(x09), .O(new_n220_));
  oai21  g137(.a(new_n219_), .b(new_n211_), .c(new_n220_), .O(new_n221_));
  nand2  g138(.a(new_n221_), .b(new_n101_), .O(new_n222_));
  nand2  g139(.a(new_n222_), .b(new_n87_), .O(z28));
  ...
  nand2  g143(.a(new_n226_), .b(new_n101_), .O(new_n227_));
  ...
  nand2  g148(.a(new_n231_), .b(new_n101_), .O(new_n232_));
  ...
  nand3  g153(.a(new_n236_), .b(new_n87_), .c(new_n101_), .O(new_n237_));
  ...
  nand2  g158(.a(new_n241_), .b(new_n101_), .O(new_n242_));
  ...
  nand2  g163(.a(new_n246_), .b(new_n101_), .O(new_n247_));
