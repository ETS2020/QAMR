...
module FAU ( 
  ...
  nand2  g004(.a(x19), .b(new_n87_), .O(new_n88_));
  ...
  nand3  g030(.a(new_n113_), .b(new_n88_), .c(new_n93_), .O(new_n114_));
  ...
  nand3  g038(.a(new_n121_), .b(x19), .c(x12), .O(new_n122_));
  ...
  nand3  g063(.a(new_n146_), .b(new_n88_), .c(new_n93_), .O(new_n147_));
  ...
  nand3  g104(.a(new_n187_), .b(new_n88_), .c(new_n93_), .O(new_n188_));
  ...
  nand3  g113(.a(new_n196_), .b(new_n88_), .c(new_n93_), .O(new_n197_));
  ...
  nand3  g122(.a(new_n205_), .b(new_n88_), .c(new_n93_), .O(new_n206_));
  ...
  nand3  g146(.a(new_n229_), .b(new_n88_), .c(new_n93_), .O(new_n230_));
  ...
  nand3  g151(.a(new_n234_), .b(new_n88_), .c(new_n93_), .O(new_n235_));
  ...
  nand3  g156(.a(new_n239_), .b(new_n88_), .c(new_n93_), .O(new_n240_));
