...
module FAU ( 
  ...
  nand2  g015(.a(x26), .b(x10), .O(new_n99_));
  ...
  nand2  g039(.a(new_n122_), .b(new_n99_), .O(z09));
  ...
  oai21  g054(.a(x10), .b(x08), .c(x26), .O(new_n138_));
  nand3  g055(.a(x25), .b(new_n94_), .c(new_n109_), .O(new_n139_));
  ...
  nand2  g064(.a(new_n147_), .b(new_n99_), .O(z16));
  ...
  nand2  g072(.a(new_n155_), .b(new_n99_), .O(z18));
  ...
  nand2  g080(.a(new_n163_), .b(new_n99_), .O(z20));
  ...
  nand2  g085(.a(x33), .b(new_n165_), .O(new_n169_));
  ...
  nand2  g096(.a(new_n179_), .b(new_n99_), .O(z24));
  ...
  nand2  g112(.a(new_n95_), .b(x09), .O(new_n196_));
  ...
  nand2  g121(.a(new_n204_), .b(new_n99_), .O(z29));
  nand2  g122(.a(new_n196_), .b(x41), .O(new_n206_));
  nand3  g123(.a(x42), .b(new_n95_), .c(x09), .O(new_n207_));
  ...
  nand2  g130(.a(new_n213_), .b(new_n99_), .O(z31));
  ...
  nand2  g136(.a(new_n219_), .b(new_n99_), .O(z32));
  nand2  g137(.a(new_n196_), .b(x44), .O(new_n221_));
  nand3  g138(.a(x45), .b(new_n95_), .c(x09), .O(new_n222_));
  ...
  nand3  g142(.a(x46), .b(new_n95_), .c(x09), .O(new_n226_));
