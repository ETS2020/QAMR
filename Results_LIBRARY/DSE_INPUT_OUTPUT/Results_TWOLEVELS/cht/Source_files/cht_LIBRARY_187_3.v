...
module FAU ( 
  ...
  nand3  g108(.a(x38), .b(new_n84_), .c(new_n167_), .O(new_n192_));
  ...
  nand3  g118(.a(new_n194_), .b(x41), .c(new_n84_), .O(new_n202_));
