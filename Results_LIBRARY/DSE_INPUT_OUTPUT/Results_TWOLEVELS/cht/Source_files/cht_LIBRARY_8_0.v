...
module FAU ( 
  ...
  nand2  g048(.a(new_n109_), .b(x30), .O(new_n132_));
  ...
  nand3  g055(.a(new_n138_), .b(new_n95_), .c(x08), .O(new_n139_));
  ...
  nand3  g077(.a(new_n160_), .b(new_n95_), .c(x08), .O(new_n161_));
  ...
  nand3  g094(.a(new_n177_), .b(new_n95_), .c(x08), .O(new_n178_));
  ...
  nand3  g099(.a(new_n182_), .b(new_n95_), .c(x08), .O(new_n183_));
  ...
  nand3  g109(.a(new_n192_), .b(new_n95_), .c(x08), .O(new_n193_));
  ...
  nand3  g114(.a(new_n197_), .b(new_n95_), .c(x08), .O(new_n198_));
  ...
  aoi21  g127(.a(new_n190_), .b(x00), .c(new_n86_), .O(new_n211_));
