...
module FAU ( 
  ...
  oai21  g026(.a(new_n109_), .b(x10), .c(new_n89_), .O(z04));
  ...
  oai21  g046(.a(new_n129_), .b(x10), .c(new_n89_), .O(z09));
  ...
  nand3  g054(.a(new_n137_), .b(new_n89_), .c(new_n91_), .O(new_n138_));
  ...
  nand2  g119(.a(x37), .b(new_n175_), .O(new_n203_));
  oai21  g120(.a(new_n87_), .b(new_n175_), .c(new_n203_), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(new_n91_), .O(new_n205_));
  nand2  g122(.a(new_n205_), .b(new_n89_), .O(z26));
  oai21  g123(.a(new_n88_), .b(new_n175_), .c(new_n87_), .O(new_n207_));
  inv1   g124(.a(x39), .O(new_n208_));
  nand2  g125(.a(x14), .b(x00), .O(new_n209_));
  oai21  g126(.a(new_n208_), .b(x14), .c(new_n209_), .O(new_n210_));
  nand2  g127(.a(new_n210_), .b(new_n207_), .O(new_n211_));
  nand2  g128(.a(x38), .b(new_n175_), .O(new_n212_));
  aoi21  g129(.a(new_n212_), .b(new_n211_), .c(x10), .O(z27));
  oai21  g130(.a(x14), .b(new_n175_), .c(x39), .O(new_n214_));
  nand3  g131(.a(x40), .b(new_n102_), .c(x09), .O(new_n215_));
  ...
  aoi21  g158(.a(new_n102_), .b(x09), .c(new_n87_), .O(new_n242_));
  oai21  g159(.a(new_n242_), .b(x45), .c(x44), .O(new_n243_));
  nand3  g160(.a(x45), .b(new_n102_), .c(x09), .O(new_n244_));
  aoi21  g161(.a(new_n244_), .b(new_n243_), .c(x10), .O(z33));
  aoi21  g162(.a(new_n102_), .b(x09), .c(new_n88_), .O(new_n246_));
  nand3  g163(.a(x46), .b(new_n102_), .c(x09), .O(new_n247_));
  inv1   g164(.a(new_n247_), .O(new_n248_));
  oai21  g165(.a(new_n248_), .b(new_n246_), .c(new_n91_), .O(new_n249_));
  nand2  g166(.a(new_n249_), .b(new_n89_), .O(z34));
  ...
  oai21  g171(.a(new_n254_), .b(new_n252_), .c(new_n91_), .O(new_n255_));
  nand2  g172(.a(new_n255_), .b(new_n89_), .O(z35));
endmodule
