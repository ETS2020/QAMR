...
module FAU ( 
  ...
  nand3  g040(.a(x20), .b(new_n88_), .c(new_n113_), .O(new_n124_));
  ...
  nand3  g046(.a(x22), .b(new_n88_), .c(new_n113_), .O(new_n130_));
  ...
  aoi21  g102(.a(new_n100_), .b(x09), .c(new_n180_), .O(new_n186_));
  nand3  g103(.a(x40), .b(new_n100_), .c(x09), .O(new_n187_));
  inv1   g104(.a(new_n187_), .O(new_n188_));
  oai21  g105(.a(new_n188_), .b(new_n186_), .c(new_n88_), .O(new_n189_));
  nand2  g106(.a(new_n189_), .b(new_n93_), .O(z28));
  inv1   g107(.a(x40), .O(new_n191_));
  aoi21  g108(.a(new_n100_), .b(x09), .c(new_n191_), .O(new_n192_));
  nand3  g109(.a(x41), .b(new_n100_), .c(x09), .O(new_n193_));
