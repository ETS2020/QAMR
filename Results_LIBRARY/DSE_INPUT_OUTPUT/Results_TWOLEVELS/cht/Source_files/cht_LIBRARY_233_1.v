...
module FAU ( 
  ...
  nand2  g048(.a(x22), .b(new_n122_), .O(new_n132_));
  ...
  nand2  g081(.a(x30), .b(new_n122_), .O(new_n165_));
  ...
  oai21  g138(.a(x45), .b(x10), .c(new_n96_), .O(new_n222_));
  ...
  nand3  g145(.a(new_n99_), .b(x09), .c(x00), .O(new_n229_));
