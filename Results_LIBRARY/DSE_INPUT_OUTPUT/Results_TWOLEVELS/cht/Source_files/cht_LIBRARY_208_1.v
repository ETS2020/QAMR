...
module FAU ( 
  ...
  nand2  g054(.a(new_n137_), .b(new_n90_), .O(z13));
  ...
  nand2  g064(.a(new_n147_), .b(new_n90_), .O(z15));
  ...
  nand2  g092(.a(x34), .b(new_n89_), .O(new_n176_));
  ...
  oai21  g110(.a(x39), .b(x10), .c(new_n89_), .O(new_n194_));
  ...
  nand2  g150(.a(new_n200_), .b(x46), .O(new_n234_));
