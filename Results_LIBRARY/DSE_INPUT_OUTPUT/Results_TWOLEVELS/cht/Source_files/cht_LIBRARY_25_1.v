...
module FAU ( 
  ...
  aoi21  g112(.a(new_n190_), .b(x09), .c(new_n195_), .O(new_n196_));
  ...
  aoi21  g118(.a(new_n190_), .b(x09), .c(new_n201_), .O(new_n202_));
  ...
  aoi21  g124(.a(new_n190_), .b(x09), .c(new_n207_), .O(new_n208_));
  ...
  nand2  g137(.a(new_n220_), .b(new_n90_), .O(z33));
  inv1   g138(.a(x45), .O(new_n222_));
  aoi21  g139(.a(new_n190_), .b(x09), .c(new_n222_), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n190_), .c(x09), .O(new_n224_));
  ...
  aoi21  g145(.a(new_n190_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(new_n190_), .b(x09), .c(x00), .O(new_n230_));
