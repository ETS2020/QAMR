...
module FAU ( 
  ...
  nand2  g003(.a(x45), .b(x35), .O(new_n87_));
  ...
  nand2  g115(.a(x36), .b(new_n174_), .O(new_n199_));
  oai21  g116(.a(new_n198_), .b(new_n174_), .c(new_n199_), .O(new_n200_));
  ...
  oai21  g130(.a(x14), .b(new_n174_), .c(x39), .O(new_n214_));
  nand3  g131(.a(x40), .b(new_n99_), .c(x09), .O(new_n215_));
  nand2  g132(.a(new_n215_), .b(new_n214_), .O(new_n216_));
  nand3  g133(.a(new_n216_), .b(new_n87_), .c(new_n93_), .O(new_n217_));
  ...
  oai21  g139(.a(new_n222_), .b(new_n220_), .c(new_n93_), .O(new_n223_));
  ...
  oai21  g145(.a(new_n228_), .b(new_n226_), .c(new_n93_), .O(new_n229_));
  ...
  nand2  g160(.a(new_n99_), .b(x09), .O(new_n244_));
  nand2  g161(.a(new_n244_), .b(new_n243_), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(x45), .c(new_n193_), .O(new_n246_));
  ...
  aoi21  g166(.a(new_n99_), .b(x09), .c(new_n247_), .O(new_n250_));
  ...
  oai21  g171(.a(x14), .b(new_n174_), .c(x46), .O(new_n255_));
