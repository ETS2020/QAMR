...
module FAU ( 
  ...
  nand3  g028(.a(new_n111_), .b(new_n110_), .c(new_n91_), .O(new_n112_));
  and2   g029(.a(new_n112_), .b(new_n92_), .O(z06));
  nand2  g030(.a(x18), .b(new_n109_), .O(new_n114_));
  nand2  g031(.a(x19), .b(x08), .O(new_n115_));
  nand3  g032(.a(new_n115_), .b(new_n114_), .c(new_n91_), .O(new_n116_));
  and2   g033(.a(new_n116_), .b(new_n92_), .O(z07));
  ...
  and2   g060(.a(new_n143_), .b(new_n92_), .O(z13));
  ...
  and2   g069(.a(new_n152_), .b(new_n92_), .O(z15));
  nand2  g070(.a(x27), .b(new_n109_), .O(new_n154_));
  nand2  g071(.a(x28), .b(x08), .O(new_n155_));
  nand3  g072(.a(new_n155_), .b(new_n154_), .c(new_n91_), .O(new_n156_));
  and2   g073(.a(new_n156_), .b(new_n92_), .O(z16));
  ...
  and2   g077(.a(new_n160_), .b(new_n92_), .O(z17));
  ...
  nor2   g087(.a(x10), .b(x09), .O(new_n171_));
  nand2  g088(.a(new_n171_), .b(x32), .O(new_n172_));
  ...
  aoi21  g101(.a(new_n184_), .b(new_n91_), .c(x10), .O(z27));
  nand2  g102(.a(new_n171_), .b(x39), .O(new_n186_));
  inv1   g103(.a(new_n186_), .O(z28));
  nand2  g104(.a(new_n171_), .b(x40), .O(new_n188_));
  inv1   g105(.a(new_n188_), .O(z29));
  nand2  g106(.a(new_n171_), .b(x41), .O(new_n190_));
  inv1   g107(.a(new_n190_), .O(z30));
  inv1   g108(.a(x42), .O(new_n192_));
  aoi21  g109(.a(new_n192_), .b(new_n91_), .c(x10), .O(z31));
  nand2  g110(.a(new_n171_), .b(x43), .O(new_n194_));
  inv1   g111(.a(new_n194_), .O(z32));
  inv1   g112(.a(x44), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n91_), .c(x10), .O(z33));
  nand2  g114(.a(new_n171_), .b(x45), .O(new_n198_));
  inv1   g115(.a(new_n198_), .O(z34));
  nand2  g116(.a(new_n171_), .b(x46), .O(new_n200_));
