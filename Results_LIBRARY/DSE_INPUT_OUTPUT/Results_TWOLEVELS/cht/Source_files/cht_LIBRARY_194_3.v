...
module FAU ( 
  ...
  nand2  g032(.a(new_n115_), .b(new_n93_), .O(z07));
  ...
  nand2  g046(.a(x22), .b(new_n107_), .O(new_n130_));
  ...
  nand2  g093(.a(new_n176_), .b(new_n93_), .O(z22));
  ...
  nand3  g128(.a(new_n198_), .b(new_n88_), .c(x09), .O(new_n212_));
  nand2  g129(.a(new_n212_), .b(x42), .O(new_n213_));
  nand4  g130(.a(x43), .b(new_n198_), .c(new_n88_), .d(x09), .O(new_n214_));
  nand2  g131(.a(new_n214_), .b(new_n213_), .O(z31));
  ...
  aoi21  g136(.a(new_n198_), .b(x09), .c(new_n219_), .O(new_n220_));
  ...
  nand2  g144(.a(new_n199_), .b(x46), .O(new_n228_));
