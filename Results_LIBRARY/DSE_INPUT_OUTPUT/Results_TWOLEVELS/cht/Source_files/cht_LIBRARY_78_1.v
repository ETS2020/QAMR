...
module FAU ( 
  ...
  aoi21  g009(.a(x12), .b(new_n92_), .c(x40), .O(new_n93_));
  ...
  aoi21  g022(.a(x15), .b(new_n92_), .c(x40), .O(new_n106_));
  ...
  aoi21  g031(.a(x18), .b(x08), .c(x40), .O(new_n115_));
  ...
  aoi21  g052(.a(x23), .b(x08), .c(x40), .O(new_n136_));
  ...
  aoi21  g083(.a(x30), .b(new_n113_), .c(x40), .O(new_n167_));
  ...
  aoi21  g092(.a(x33), .b(x09), .c(x40), .O(new_n176_));
  ...
  aoi21  g118(.a(x38), .b(new_n174_), .c(x40), .O(new_n202_));
  aoi21  g119(.a(new_n202_), .b(new_n201_), .c(x10), .O(z27));
  nand2  g120(.a(new_n100_), .b(x09), .O(new_n204_));
  nand4  g121(.a(new_n204_), .b(new_n85_), .c(x39), .d(new_n84_), .O(new_n205_));
  inv1   g122(.a(new_n205_), .O(z28));
  nand3  g123(.a(x41), .b(new_n100_), .c(x09), .O(new_n207_));
  aoi21  g124(.a(new_n207_), .b(new_n85_), .c(x10), .O(z29));
  oai21  g125(.a(x14), .b(new_n174_), .c(x41), .O(new_n209_));
  ...
  oai21  g130(.a(x14), .b(new_n174_), .c(x42), .O(new_n214_));
  ...
  aoi21  g138(.a(new_n221_), .b(x09), .c(x40), .O(new_n222_));
  aoi21  g139(.a(new_n222_), .b(new_n219_), .c(x10), .O(z32));
  oai21  g140(.a(x14), .b(new_n174_), .c(x44), .O(new_n224_));
  ...
  oai21  g145(.a(x14), .b(new_n174_), .c(x45), .O(new_n229_));
  ...
  oai21  g150(.a(x14), .b(new_n174_), .c(x46), .O(new_n234_));
