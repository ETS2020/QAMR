...
module FAU ( 
  ...
  aoi21  g020(.a(x15), .b(new_n92_), .c(x24), .O(new_n104_));
  aoi21  g021(.a(new_n104_), .b(new_n103_), .c(x10), .O(z04));
  nand2  g022(.a(x07), .b(x03), .O(new_n106_));
  aoi21  g023(.a(x16), .b(new_n92_), .c(x24), .O(new_n107_));
  ...
  aoi21  g032(.a(x19), .b(x08), .c(x24), .O(new_n116_));
  ...
  aoi21  g044(.a(x22), .b(x08), .c(x24), .O(new_n128_));
  ...
  aoi21  g052(.a(new_n135_), .b(new_n85_), .c(x10), .O(z12));
  nand4  g053(.a(x25), .b(new_n85_), .c(new_n84_), .d(x08), .O(new_n137_));
  ...
  oai21  g119(.a(new_n202_), .b(new_n201_), .c(new_n85_), .O(new_n203_));
  ...
  aoi21  g130(.a(new_n213_), .b(x09), .c(x24), .O(new_n214_));
  ...
  aoi21  g140(.a(new_n223_), .b(x09), .c(x24), .O(new_n224_));
  ...
  aoi21  g157(.a(new_n216_), .b(x00), .c(x24), .O(new_n241_));
