...
module FAU ( 
  ...
  nand2  g003(.a(x45), .b(x24), .O(new_n87_));
  ...
  nand3  g044(.a(new_n127_), .b(new_n87_), .c(new_n89_), .O(new_n128_));
  ...
  nor2   g057(.a(x45), .b(new_n140_), .O(new_n141_));
  oai21  g058(.a(new_n141_), .b(new_n139_), .c(x23), .O(new_n142_));
  nand2  g059(.a(new_n141_), .b(x08), .O(new_n143_));
  ...
  nand3  g064(.a(new_n147_), .b(new_n145_), .c(x24), .O(new_n148_));
  nand3  g065(.a(x25), .b(new_n140_), .c(x08), .O(new_n149_));
  ...
  nand3  g087(.a(new_n170_), .b(new_n87_), .c(new_n89_), .O(new_n171_));
  ...
  aoi21  g165(.a(new_n100_), .b(x09), .c(new_n145_), .O(new_n249_));
