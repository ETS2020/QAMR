...
module FAU ( 
  ...
  nand2  g067(.a(x25), .b(new_n122_), .O(new_n151_));
  nand2  g068(.a(x26), .b(x08), .O(new_n152_));
  aoi21  g069(.a(new_n152_), .b(new_n151_), .c(x10), .O(z14));
  nand2  g070(.a(x26), .b(new_n122_), .O(new_n154_));
  ...
  nand2  g093(.a(x31), .b(new_n93_), .O(new_n177_));
  ...
  oai21  g142(.a(x45), .b(x10), .c(new_n93_), .O(new_n226_));
  ...
  nand2  g146(.a(new_n229_), .b(new_n88_), .O(new_n230_));
