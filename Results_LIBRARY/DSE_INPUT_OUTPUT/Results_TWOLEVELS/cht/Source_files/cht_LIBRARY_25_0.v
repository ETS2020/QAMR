...
module FAU ( 
  ...
  nand2  g050(.a(x08), .b(x00), .O(new_n134_));
  nor2   g051(.a(new_n134_), .b(x10), .O(z19));
  ...
  nand3  g074(.a(new_n157_), .b(new_n95_), .c(x08), .O(new_n158_));
  ...
  aoi21  g088(.a(x38), .b(new_n136_), .c(new_n86_), .O(new_n172_));
  ...
  nand3  g093(.a(new_n176_), .b(new_n95_), .c(x08), .O(new_n177_));
  ...
  aoi21  g109(.a(new_n192_), .b(x09), .c(new_n86_), .O(new_n193_));
  ...
  aoi21  g128(.a(new_n211_), .b(x00), .c(new_n86_), .O(new_n212_));
