...
module FAU ( 
  ...
  aoi21  g012(.a(x13), .b(new_n85_), .c(x22), .O(new_n96_));
  ...
  aoi21  g020(.a(x15), .b(new_n85_), .c(x22), .O(new_n104_));
  ...
  aoi21  g029(.a(x18), .b(x08), .c(x22), .O(new_n113_));
  ...
  aoi21  g037(.a(x20), .b(x08), .c(x22), .O(new_n121_));
  ...
  aoi21  g045(.a(new_n128_), .b(new_n89_), .c(x10), .O(z10));
  nand2  g046(.a(x23), .b(x08), .O(new_n130_));
  aoi21  g047(.a(new_n130_), .b(new_n89_), .c(x10), .O(z11));
  ...
  and2   g051(.a(new_n134_), .b(new_n88_), .O(z12));
  ...
  and2   g073(.a(new_n156_), .b(new_n88_), .O(z17));
  ...
  and2   g092(.a(new_n175_), .b(new_n88_), .O(z21));
  ...
  oai21  g119(.a(new_n202_), .b(new_n201_), .c(new_n89_), .O(new_n203_));
  ...
  aoi21  g126(.a(new_n209_), .b(x09), .c(x22), .O(new_n210_));
  ...
  aoi21  g131(.a(new_n214_), .b(x09), .c(x22), .O(new_n215_));
  ...
  aoi21  g157(.a(new_n205_), .b(x00), .c(x22), .O(new_n241_));
