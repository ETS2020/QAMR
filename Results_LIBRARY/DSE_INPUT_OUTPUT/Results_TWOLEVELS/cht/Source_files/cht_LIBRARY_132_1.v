...
module FAU ( 
  ...
  nand2  g046(.a(new_n129_), .b(new_n94_), .O(z09));
  ...
  nand2  g081(.a(x29), .b(new_n119_), .O(new_n165_));
  nand2  g082(.a(x30), .b(x08), .O(new_n166_));
  aoi21  g083(.a(new_n166_), .b(new_n165_), .c(x10), .O(z18));
  nand2  g084(.a(x08), .b(x00), .O(new_n168_));
  nand2  g085(.a(x30), .b(new_n119_), .O(new_n169_));
  aoi21  g086(.a(new_n169_), .b(new_n168_), .c(x10), .O(z19));
  oai21  g087(.a(x31), .b(x10), .c(new_n93_), .O(new_n171_));
  nand3  g088(.a(x32), .b(new_n88_), .c(x09), .O(new_n172_));
  nand2  g089(.a(new_n172_), .b(new_n171_), .O(z20));
  oai21  g090(.a(x32), .b(x10), .c(new_n93_), .O(new_n174_));
  nand3  g091(.a(x33), .b(new_n88_), .c(x09), .O(new_n175_));
  ...
  oai21  g102(.a(x36), .b(x10), .c(new_n93_), .O(new_n186_));
  ...
  oai21  g121(.a(x40), .b(x10), .c(new_n93_), .O(new_n205_));
  ...
  nand2  g127(.a(new_n200_), .b(x09), .O(new_n211_));
