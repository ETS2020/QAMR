...
module FAU ( 
  ...
  nand2  g056(.a(new_n139_), .b(new_n90_), .O(z12));
  ...
  nand2  g064(.a(x26), .b(new_n112_), .O(new_n148_));
  ...
  oai21  g072(.a(new_n154_), .b(new_n112_), .c(new_n155_), .O(new_n156_));
  ...
  nand2  g088(.a(x32), .b(new_n168_), .O(new_n172_));
  ...
  nand2  g094(.a(x34), .b(new_n168_), .O(new_n178_));
  ...
  nand2  g107(.a(new_n190_), .b(new_n90_), .O(z26));
  ...
  nand2  g112(.a(x38), .b(new_n168_), .O(new_n196_));
  aoi21  g113(.a(new_n196_), .b(new_n195_), .c(x10), .O(z27));
  nand2  g114(.a(new_n99_), .b(x09), .O(new_n198_));
  ...
  aoi21  g119(.a(new_n99_), .b(x09), .c(new_n202_), .O(new_n203_));
  ...
  nand2  g123(.a(new_n206_), .b(new_n90_), .O(z29));
  inv1   g124(.a(x41), .O(new_n208_));
  aoi21  g125(.a(new_n99_), .b(x09), .c(new_n208_), .O(new_n209_));
  nand3  g126(.a(x42), .b(new_n99_), .c(x09), .O(new_n210_));
  ...
  nand2  g142(.a(new_n198_), .b(x44), .O(new_n226_));
  nand3  g143(.a(x45), .b(new_n99_), .c(x09), .O(new_n227_));
  aoi21  g144(.a(new_n227_), .b(new_n226_), .c(x10), .O(z33));
  nand2  g145(.a(new_n198_), .b(x45), .O(new_n229_));
  nand3  g146(.a(x46), .b(new_n99_), .c(x09), .O(new_n230_));
  ...
  nand3  g150(.a(new_n99_), .b(x09), .c(x00), .O(new_n234_));
