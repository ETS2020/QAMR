...
module FAU ( 
  ...
  nand2  g066(.a(x25), .b(new_n121_), .O(new_n150_));
  ...
  nand3  g100(.a(x33), .b(new_n88_), .c(new_n176_), .O(new_n184_));
  nand2  g101(.a(new_n184_), .b(new_n183_), .O(z22));
  oai21  g102(.a(x35), .b(x10), .c(x09), .O(new_n186_));
  nand3  g103(.a(x34), .b(new_n88_), .c(new_n176_), .O(new_n187_));
  nand2  g104(.a(new_n187_), .b(new_n186_), .O(z23));
  nand2  g105(.a(x35), .b(new_n176_), .O(new_n189_));
  ...
  nand3  g118(.a(x38), .b(new_n88_), .c(new_n176_), .O(new_n202_));
  ...
  aoi21  g133(.a(x44), .b(new_n98_), .c(x10), .O(new_n217_));
  nand3  g134(.a(new_n204_), .b(x43), .c(new_n88_), .O(new_n218_));
  oai21  g135(.a(new_n217_), .b(new_n176_), .c(new_n218_), .O(z32));
  ...
  aoi21  g139(.a(x46), .b(new_n98_), .c(x10), .O(new_n223_));
