...
module FAU ( 
  ...
  nand2  g085(.a(new_n168_), .b(new_n89_), .O(z21));
  ...
  nand2  g092(.a(x35), .b(new_n161_), .O(new_n176_));
  ...
  nand2  g099(.a(x37), .b(new_n161_), .O(new_n183_));
  oai21  g100(.a(new_n182_), .b(new_n161_), .c(new_n183_), .O(new_n184_));
  ...
  oai21  g108(.a(new_n191_), .b(x10), .c(new_n89_), .O(z27));
  ...
  aoi21  g127(.a(new_n193_), .b(x09), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(x43), .b(new_n193_), .c(x09), .O(new_n212_));
  ...
  nand2  g140(.a(new_n223_), .b(new_n89_), .O(z33));
  ...
  aoi21  g145(.a(new_n193_), .b(x09), .c(new_n228_), .O(new_n229_));
  nand3  g146(.a(new_n193_), .b(x09), .c(x00), .O(new_n230_));
  inv1   g147(.a(new_n230_), .O(new_n231_));
  oai21  g148(.a(new_n231_), .b(new_n229_), .c(new_n84_), .O(new_n232_));
  nand2  g149(.a(new_n232_), .b(new_n89_), .O(z35));
endmodule
