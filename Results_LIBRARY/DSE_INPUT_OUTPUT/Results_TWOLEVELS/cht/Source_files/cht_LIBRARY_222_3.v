...
module FAU ( 
  ...
  nand3  g027(.a(x17), .b(new_n88_), .c(new_n110_), .O(new_n111_));
  nand2  g028(.a(new_n111_), .b(new_n109_), .O(z06));
  oai21  g029(.a(x19), .b(x10), .c(x08), .O(new_n113_));
  nand3  g030(.a(x18), .b(new_n88_), .c(new_n110_), .O(new_n114_));
  ...
  nand3  g063(.a(x29), .b(new_n88_), .c(new_n110_), .O(new_n147_));
  nand2  g064(.a(new_n147_), .b(new_n146_), .O(z18));
  oai21  g065(.a(x10), .b(x00), .c(x08), .O(new_n149_));
  nand3  g066(.a(x30), .b(new_n88_), .c(new_n110_), .O(new_n150_));
  ...
  nand2  g073(.a(new_n156_), .b(new_n93_), .O(z20));
  ...
  nand2  g077(.a(new_n160_), .b(new_n93_), .O(z21));
  ...
  nand2  g082(.a(new_n165_), .b(new_n93_), .O(z22));
  nand2  g083(.a(x34), .b(new_n152_), .O(new_n167_));
  ...
  nand2  g090(.a(x36), .b(new_n152_), .O(new_n174_));
  oai21  g091(.a(new_n173_), .b(new_n152_), .c(new_n174_), .O(new_n175_));
  ...
  nand2  g097(.a(new_n180_), .b(new_n93_), .O(z26));
  ...
  oai21  g104(.a(new_n187_), .b(x10), .c(new_n93_), .O(z27));
  nand2  g105(.a(new_n98_), .b(x09), .O(new_n189_));
  ...
  aoi21  g110(.a(new_n98_), .b(x09), .c(new_n193_), .O(new_n194_));
  ...
  nand2  g114(.a(new_n197_), .b(new_n93_), .O(z29));
  ...
  aoi21  g128(.a(new_n98_), .b(x09), .c(new_n211_), .O(new_n212_));
  nand3  g129(.a(x44), .b(new_n98_), .c(x09), .O(new_n213_));
  ...
  aoi21  g134(.a(new_n98_), .b(x09), .c(new_n217_), .O(new_n218_));
  ...
  nand2  g139(.a(new_n189_), .b(x45), .O(new_n223_));
  nand3  g140(.a(x46), .b(new_n98_), .c(x09), .O(new_n224_));
