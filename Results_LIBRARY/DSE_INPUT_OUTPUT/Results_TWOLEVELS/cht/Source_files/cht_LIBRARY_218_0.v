...
module FAU ( 
  ...
  nor2   g086(.a(x10), .b(new_n97_), .O(new_n170_));
  ...
  nand2  g125(.a(x44), .b(new_n186_), .O(new_n209_));
  nand3  g126(.a(new_n209_), .b(new_n208_), .c(x09), .O(new_n210_));
  and2   g127(.a(new_n210_), .b(new_n84_), .O(z32));
  ...
  nand2  g134(.a(x46), .b(new_n186_), .O(new_n218_));
  nand3  g135(.a(new_n218_), .b(new_n217_), .c(x09), .O(new_n219_));
  and2   g136(.a(new_n219_), .b(new_n84_), .O(z34));
  nand2  g137(.a(new_n186_), .b(x00), .O(new_n221_));
  nand2  g138(.a(x46), .b(x14), .O(new_n222_));
  nand3  g139(.a(new_n222_), .b(new_n221_), .c(x09), .O(new_n223_));
  and2   g140(.a(new_n223_), .b(new_n84_), .O(z35));
endmodule
