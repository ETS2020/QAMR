...
module FAU ( 
  ...
  nand2  g051(.a(x22), .b(new_n120_), .O(new_n135_));
  nand2  g052(.a(x23), .b(x08), .O(new_n136_));
  aoi21  g053(.a(new_n136_), .b(new_n135_), .c(x10), .O(z11));
  nand2  g054(.a(x23), .b(new_n120_), .O(new_n138_));
  ...
  oai21  g084(.a(x10), .b(new_n167_), .c(x31), .O(new_n168_));
  nand3  g085(.a(x32), .b(new_n84_), .c(x09), .O(new_n169_));
  nand2  g086(.a(new_n169_), .b(new_n168_), .O(z20));
