...
module FAU ( 
  ...
  nand2  g052(.a(x22), .b(new_n115_), .O(new_n136_));
  ...
  nand2  g090(.a(x33), .b(new_n170_), .O(new_n174_));
  nand2  g091(.a(x34), .b(x09), .O(new_n175_));
  aoi21  g092(.a(new_n175_), .b(new_n174_), .c(x10), .O(z22));
  inv1   g093(.a(x35), .O(new_n177_));
  nand2  g094(.a(x34), .b(new_n170_), .O(new_n178_));
  oai21  g095(.a(new_n177_), .b(new_n170_), .c(new_n178_), .O(new_n179_));
  ...
  aoi21  g117(.a(new_n100_), .b(x09), .c(new_n195_), .O(new_n201_));
