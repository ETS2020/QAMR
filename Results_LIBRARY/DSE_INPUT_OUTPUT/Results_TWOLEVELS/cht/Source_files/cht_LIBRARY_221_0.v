...
module FAU ( 
  ...
  aoi21  g021(.a(new_n104_), .b(x08), .c(x10), .O(z06));
  inv1   g022(.a(x19), .O(new_n106_));
  aoi21  g023(.a(new_n106_), .b(x08), .c(x10), .O(z07));
  nor2   g024(.a(x10), .b(new_n86_), .O(new_n108_));
  nand2  g025(.a(new_n108_), .b(x20), .O(new_n109_));
  inv1   g026(.a(new_n109_), .O(z08));
  nand2  g027(.a(new_n108_), .b(x21), .O(new_n111_));
  inv1   g028(.a(new_n111_), .O(z09));
  nand2  g029(.a(new_n108_), .b(x22), .O(new_n113_));
  inv1   g030(.a(new_n113_), .O(z10));
  nand2  g031(.a(new_n108_), .b(x23), .O(new_n115_));
  inv1   g032(.a(new_n115_), .O(z11));
  inv1   g033(.a(x24), .O(new_n117_));
  aoi21  g034(.a(new_n117_), .b(x08), .c(x10), .O(z12));
  inv1   g035(.a(x25), .O(new_n119_));
  aoi21  g036(.a(new_n119_), .b(x08), .c(x10), .O(z13));
  inv1   g037(.a(x26), .O(new_n121_));
  aoi21  g038(.a(new_n121_), .b(x08), .c(x10), .O(z14));
  inv1   g039(.a(x27), .O(new_n123_));
  aoi21  g040(.a(new_n123_), .b(x08), .c(x10), .O(z15));
  nand2  g041(.a(new_n108_), .b(x28), .O(new_n125_));
  inv1   g042(.a(new_n125_), .O(z16));
  inv1   g043(.a(x29), .O(new_n127_));
  aoi21  g044(.a(new_n127_), .b(x08), .c(x10), .O(z17));
  nand2  g045(.a(new_n108_), .b(x30), .O(new_n129_));
  inv1   g046(.a(new_n129_), .O(z18));
  inv1   g047(.a(x00), .O(new_n131_));
  nor3   g048(.a(x10), .b(new_n86_), .c(new_n131_), .O(z19));
  ...
  nand3  g076(.a(new_n159_), .b(new_n133_), .c(x08), .O(new_n160_));
  inv1   g077(.a(new_n160_), .O(z25));
  nand2  g078(.a(x37), .b(new_n139_), .O(new_n162_));
  nand2  g079(.a(x38), .b(x09), .O(new_n163_));
  nand3  g080(.a(new_n163_), .b(new_n162_), .c(x08), .O(new_n164_));
  and2   g081(.a(new_n164_), .b(new_n133_), .O(z26));
  nand2  g082(.a(x14), .b(x00), .O(new_n166_));
  inv1   g083(.a(x14), .O(new_n167_));
  nand2  g084(.a(x39), .b(new_n167_), .O(new_n168_));
  aoi21  g085(.a(new_n168_), .b(new_n166_), .c(new_n139_), .O(new_n169_));
  inv1   g086(.a(x38), .O(new_n170_));
  nor2   g087(.a(new_n170_), .b(x09), .O(new_n171_));
  oai21  g088(.a(new_n171_), .b(new_n169_), .c(new_n133_), .O(new_n172_));
  nor2   g089(.a(new_n172_), .b(new_n86_), .O(z27));
  nand2  g090(.a(new_n167_), .b(x09), .O(new_n174_));
  nand2  g091(.a(new_n174_), .b(x39), .O(new_n175_));
  nand3  g092(.a(x40), .b(new_n167_), .c(x09), .O(new_n176_));
  nand2  g093(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g094(.a(new_n177_), .b(new_n133_), .c(x08), .O(new_n178_));
  ...
  aoi21  g099(.a(new_n182_), .b(x09), .c(new_n86_), .O(new_n183_));
  ...
  oai21  g127(.a(new_n174_), .b(new_n131_), .c(new_n210_), .O(new_n211_));
  nand3  g128(.a(new_n211_), .b(new_n133_), .c(x08), .O(new_n212_));
