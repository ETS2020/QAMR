...
module FAU ( 
  ...
  nand2  g077(.a(x28), .b(new_n115_), .O(new_n161_));
  ...
  oai21  g121(.a(new_n202_), .b(new_n174_), .c(new_n204_), .O(z28));
  nand2  g122(.a(new_n203_), .b(x40), .O(new_n206_));
  ...
  aoi21  g128(.a(x43), .b(new_n100_), .c(x10), .O(new_n212_));
  nand3  g129(.a(new_n203_), .b(x42), .c(new_n84_), .O(new_n213_));
  oai21  g130(.a(new_n212_), .b(new_n174_), .c(new_n213_), .O(z31));
  nand2  g131(.a(new_n203_), .b(x43), .O(new_n215_));
  ...
  aoi21  g140(.a(new_n100_), .b(x00), .c(x10), .O(new_n224_));
  nand3  g141(.a(new_n203_), .b(x46), .c(new_n84_), .O(new_n225_));
