...
module FAU ( 
  ...
  nand2  g001(.a(x41), .b(x33), .O(new_n85_));
  ...
  nor2   g097(.a(x41), .b(new_n180_), .O(new_n181_));
  oai21  g098(.a(new_n181_), .b(new_n179_), .c(x32), .O(new_n182_));
  nand2  g099(.a(new_n181_), .b(x09), .O(new_n183_));
  ...
  nand2  g107(.a(x34), .b(new_n189_), .O(new_n191_));
  oai21  g108(.a(new_n190_), .b(new_n189_), .c(new_n191_), .O(new_n192_));
  ...
  nand2  g116(.a(x36), .b(new_n189_), .O(new_n200_));
  oai21  g117(.a(new_n199_), .b(new_n189_), .c(new_n200_), .O(new_n201_));
  ...
  oai21  g131(.a(x14), .b(new_n189_), .c(x39), .O(new_n215_));
  ...
  nand2  g142(.a(x41), .b(new_n180_), .O(new_n226_));
  inv1   g143(.a(x41), .O(new_n227_));
  nand3  g144(.a(new_n227_), .b(new_n100_), .c(x09), .O(new_n228_));
  nand2  g145(.a(new_n228_), .b(new_n226_), .O(new_n229_));
  nand2  g146(.a(new_n229_), .b(x42), .O(new_n230_));
  nand2  g147(.a(new_n100_), .b(x09), .O(new_n231_));
  nand3  g148(.a(new_n231_), .b(x41), .c(new_n180_), .O(new_n232_));
  aoi21  g149(.a(new_n232_), .b(new_n230_), .c(x10), .O(z30));
  oai21  g150(.a(x14), .b(new_n189_), .c(x42), .O(new_n234_));
  ...
  nand2  g160(.a(new_n243_), .b(new_n85_), .O(z32));
  ...
  nand2  g172(.a(new_n255_), .b(new_n85_), .O(z34));
  inv1   g173(.a(x46), .O(new_n257_));
  aoi21  g174(.a(new_n100_), .b(x09), .c(new_n257_), .O(new_n258_));
  nand3  g175(.a(new_n100_), .b(x09), .c(x00), .O(new_n259_));
  inv1   g176(.a(new_n259_), .O(new_n260_));
  oai21  g177(.a(new_n260_), .b(new_n258_), .c(new_n84_), .O(new_n261_));
  nand2  g178(.a(new_n261_), .b(new_n85_), .O(z35));
endmodule
