...
module FAU ( 
  ...
  nand2  g049(.a(new_n132_), .b(new_n89_), .O(z09));
  ...
  nand2  g063(.a(new_n146_), .b(new_n89_), .O(z12));
  ...
  nand2  g072(.a(new_n155_), .b(new_n89_), .O(z14));
  ...
  nand2  g076(.a(new_n159_), .b(new_n89_), .O(z15));
  ...
  nand2  g081(.a(new_n164_), .b(new_n89_), .O(z16));
  ...
  nand2  g090(.a(x30), .b(new_n115_), .O(new_n174_));
  ...
  nand2  g101(.a(new_n184_), .b(new_n89_), .O(z21));
  nand2  g102(.a(x33), .b(new_n176_), .O(new_n186_));
  ...
  nand2  g110(.a(x35), .b(new_n176_), .O(new_n194_));
  nand2  g111(.a(x36), .b(x09), .O(new_n195_));
  aoi21  g112(.a(new_n195_), .b(new_n194_), .c(x10), .O(z24));
  nand2  g113(.a(x36), .b(new_n176_), .O(new_n197_));
  ...
  oai21  g123(.a(x10), .b(new_n176_), .c(x38), .O(new_n207_));
  nand2  g124(.a(new_n207_), .b(new_n206_), .O(z27));
  nand2  g125(.a(new_n101_), .b(x09), .O(new_n209_));
  nand2  g126(.a(new_n209_), .b(x39), .O(new_n210_));
  nand3  g127(.a(x40), .b(new_n101_), .c(x09), .O(new_n211_));
  aoi21  g128(.a(new_n211_), .b(new_n210_), .c(x10), .O(z28));
  nand2  g129(.a(new_n209_), .b(x40), .O(new_n213_));
  nand3  g130(.a(x41), .b(new_n101_), .c(x09), .O(new_n214_));
  aoi21  g131(.a(new_n214_), .b(new_n213_), .c(x10), .O(z29));
  inv1   g132(.a(x41), .O(new_n216_));
  aoi21  g133(.a(new_n101_), .b(x09), .c(new_n216_), .O(new_n217_));
  ...
  nand2  g161(.a(new_n244_), .b(new_n89_), .O(z34));
