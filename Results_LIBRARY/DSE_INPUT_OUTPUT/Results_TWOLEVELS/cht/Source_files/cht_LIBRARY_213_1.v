...
module FAU ( 
  ...
  oai21  g119(.a(new_n87_), .b(new_n174_), .c(new_n202_), .O(new_n203_));
  nand2  g120(.a(new_n203_), .b(new_n90_), .O(new_n204_));
  nand2  g121(.a(new_n204_), .b(new_n88_), .O(z26));
  oai21  g122(.a(x45), .b(new_n174_), .c(new_n87_), .O(new_n206_));
  ...
  nand2  g127(.a(x38), .b(new_n174_), .O(new_n211_));
  ...
  oai21  g134(.a(x14), .b(new_n174_), .c(x40), .O(new_n218_));
  ...
  oai21  g158(.a(x14), .b(new_n174_), .c(new_n241_), .O(new_n242_));
  nand3  g159(.a(new_n242_), .b(x45), .c(x38), .O(new_n243_));
  inv1   g160(.a(x45), .O(new_n244_));
  nand2  g161(.a(new_n101_), .b(x09), .O(new_n245_));
  nand3  g162(.a(new_n245_), .b(new_n244_), .c(x44), .O(new_n246_));
  aoi21  g163(.a(new_n246_), .b(new_n243_), .c(x10), .O(z33));
  aoi21  g164(.a(new_n101_), .b(x09), .c(new_n244_), .O(new_n248_));
