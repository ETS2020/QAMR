...
module FAU ( 
  ...
  nand2  g044(.a(new_n127_), .b(new_n93_), .O(z10));
  ...
  nand2  g048(.a(new_n131_), .b(new_n93_), .O(z11));
  ...
  nand2  g053(.a(new_n136_), .b(new_n93_), .O(z12));
  ...
  nand2  g057(.a(new_n140_), .b(new_n93_), .O(z13));
  ...
  nand2  g062(.a(new_n145_), .b(new_n93_), .O(z14));
  ...
  nand2  g073(.a(new_n156_), .b(new_n93_), .O(z17));
  ...
  nand2  g077(.a(new_n160_), .b(new_n93_), .O(z18));
  nand2  g078(.a(x08), .b(x00), .O(new_n162_));
  nand2  g079(.a(x30), .b(new_n114_), .O(new_n163_));
  ...
  nand2  g092(.a(new_n175_), .b(new_n93_), .O(z22));
  ...
  nand2  g096(.a(new_n179_), .b(new_n93_), .O(z23));
  ...
  nand2  g128(.a(new_n211_), .b(new_n93_), .O(z30));
  ...
  aoi21  g136(.a(new_n199_), .b(x09), .c(new_n219_), .O(new_n220_));
  nand3  g137(.a(x44), .b(new_n199_), .c(x09), .O(new_n221_));
  ...
  aoi21  g148(.a(new_n199_), .b(x09), .c(new_n231_), .O(new_n232_));
  nand3  g149(.a(x46), .b(new_n199_), .c(x09), .O(new_n233_));
  inv1   g150(.a(new_n233_), .O(new_n234_));
  oai21  g151(.a(new_n234_), .b(new_n232_), .c(new_n88_), .O(new_n235_));
  nand2  g152(.a(new_n235_), .b(new_n93_), .O(z34));
