...
module FAU ( 
  ...
  oai21  g033(.a(new_n189_), .b(new_n184_), .c(x126), .O(new_n190_));
  ...
  nand3  g082(.a(new_n238_), .b(new_n173_), .c(x044), .O(new_n239_));
  ...
  nand2  g256(.a(new_n411_), .b(x126), .O(new_n413_));
  ...
  oai21  g265(.a(new_n421_), .b(x042), .c(new_n173_), .O(z10));
  ...
  oai22  g327(.a(new_n338_), .b(x030), .c(new_n302_), .d(new_n301_), .O(new_n484_));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z27));
  nor2   g374(.a(x126), .b(x081), .O(z16));
  nor2   g375(.a(x126), .b(x081), .O(z20));
  nor2   g376(.a(x126), .b(x081), .O(z21));
  nor2   g377(.a(x126), .b(x081), .O(z24));
  nor2   g378(.a(x126), .b(x081), .O(z26));
endmodule
