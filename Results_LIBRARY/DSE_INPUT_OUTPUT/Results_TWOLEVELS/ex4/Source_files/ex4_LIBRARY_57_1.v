// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:51 2020
...
module FAU ( 
  ...
  oai21  g261(.a(new_n418_), .b(x043), .c(new_n174_), .O(z11));
  inv1   g262(.a(x044), .O(new_n420_));
  ...
  inv1   g270(.a(new_n427_), .O(z12));
  oai22  g271(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n429_));
  inv1   g272(.a(x101), .O(new_n430_));
  aoi21  g273(.a(new_n260_), .b(new_n430_), .c(x093), .O(new_n431_));
  nand2  g274(.a(new_n251_), .b(new_n250_), .O(new_n432_));
  oai21  g275(.a(new_n432_), .b(new_n431_), .c(new_n277_), .O(new_n433_));
  oai21  g276(.a(new_n260_), .b(x109), .c(x037), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(x117), .O(new_n435_));
  oai21  g278(.a(new_n430_), .b(x061), .c(new_n250_), .O(new_n436_));
  nand3  g279(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n268_), .O(new_n438_));
  aoi21  g281(.a(new_n436_), .b(new_n255_), .c(new_n438_), .O(new_n439_));
  nand4  g282(.a(new_n439_), .b(new_n435_), .c(new_n433_), .d(new_n429_), .O(new_n440_));
  nand4  g283(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(new_n442_));
  aoi21  g285(.a(new_n440_), .b(new_n276_), .c(new_n442_), .O(new_n443_));
  nand3  g286(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n444_));
  oai21  g287(.a(new_n443_), .b(x053), .c(new_n444_), .O(new_n445_));
  aoi21  g288(.a(new_n246_), .b(x029), .c(x021), .O(new_n446_));
  oai21  g289(.a(new_n446_), .b(x077), .c(new_n243_), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n432_), .O(new_n448_));
  nand2  g291(.a(x029), .b(new_n244_), .O(new_n449_));
  aoi21  g292(.a(new_n449_), .b(new_n272_), .c(new_n277_), .O(new_n450_));
  nand2  g293(.a(new_n260_), .b(new_n430_), .O(new_n451_));
  aoi22  g294(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n452_));
  nand3  g295(.a(new_n452_), .b(new_n451_), .c(x029), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(new_n450_), .c(new_n276_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n448_), .c(x053), .O(new_n456_));
  oai21  g299(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n272_), .O(new_n458_));
  nand3  g301(.a(new_n458_), .b(new_n276_), .c(x037), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n456_), .c(new_n268_), .O(new_n461_));
  ...
  nand3  g307(.a(new_n464_), .b(new_n463_), .c(new_n461_), .O(new_n465_));
  aoi21  g308(.a(new_n445_), .b(x005), .c(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x045), .c(new_n174_), .O(z13));
  inv1   g310(.a(x046), .O(new_n468_));
  ...
  nand3  g344(.a(x070), .b(new_n304_), .c(x022), .O(new_n502_));
  nand4  g345(.a(new_n502_), .b(new_n501_), .c(new_n498_), .d(new_n493_), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n172_), .c(new_n468_), .O(new_n504_));
  inv1   g347(.a(new_n504_), .O(z14));
  zero   g348(.O(z07));
  zero   g349(.O(z16));
  zero   g350(.O(z17));
  zero   g351(.O(z18));
  ...
  zero   g358(.O(z26));
  zero   g359(.O(z27));
  nor2   g360(.a(new_n172_), .b(x046), .O(z22));
endmodule
