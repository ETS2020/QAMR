// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:08 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x126), .b(new_n157_), .O(z15));
  ...
  nand2  g098(.a(new_n254_), .b(new_n157_), .O(new_n255_));
  ...
  nand4  g105(.a(new_n261_), .b(new_n255_), .c(new_n251_), .d(new_n247_), .O(new_n262_));
  nand4  g106(.a(new_n258_), .b(x061), .c(x037), .d(new_n243_), .O(new_n263_));
  ...
  oai21  g111(.a(new_n265_), .b(new_n241_), .c(new_n267_), .O(new_n268_));
  ...
  nand3  g130(.a(new_n250_), .b(x085), .c(x053), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(x077), .O(new_n288_));
  nand2  g132(.a(new_n288_), .b(new_n243_), .O(new_n289_));
  nor2   g133(.a(x021), .b(new_n243_), .O(new_n290_));
  nor2   g134(.a(x069), .b(new_n241_), .O(new_n291_));
  aoi22  g135(.a(new_n291_), .b(new_n290_), .c(new_n241_), .d(new_n252_), .O(new_n292_));
  ...
  nand2  g197(.a(new_n353_), .b(new_n159_), .O(z06));
  ...
  nand4  g219(.a(x120), .b(new_n358_), .c(new_n163_), .d(x008), .O(new_n377_));
  inv1   g220(.a(new_n377_), .O(new_n378_));
  aoi21  g221(.a(new_n376_), .b(new_n165_), .c(new_n378_), .O(new_n379_));
  ...
  nand2  g227(.a(new_n384_), .b(new_n168_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n165_), .O(new_n386_));
  aoi21  g229(.a(new_n386_), .b(new_n162_), .c(new_n363_), .O(new_n387_));
  ...
  oai21  g236(.a(new_n393_), .b(new_n387_), .c(new_n164_), .O(new_n394_));
  nand2  g237(.a(new_n357_), .b(x024), .O(new_n395_));
  nand3  g238(.a(new_n395_), .b(new_n359_), .c(new_n358_), .O(new_n396_));
  nand3  g239(.a(new_n396_), .b(new_n165_), .c(x032), .O(new_n397_));
  ...
  aoi21  g245(.a(new_n398_), .b(new_n161_), .c(new_n402_), .O(new_n403_));
  nand2  g246(.a(new_n403_), .b(new_n382_), .O(new_n404_));
  nand3  g247(.a(new_n404_), .b(new_n159_), .c(new_n356_), .O(new_n405_));
  ...
  nand3  g264(.a(new_n421_), .b(new_n159_), .c(new_n415_), .O(new_n422_));
  ...
  nand3  g273(.a(new_n430_), .b(new_n159_), .c(new_n424_), .O(new_n431_));
  ...
  oai21  g282(.a(new_n439_), .b(x044), .c(new_n159_), .O(z12));
  oai22  g283(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n441_));
  nand3  g284(.a(new_n441_), .b(x085), .c(x005), .O(new_n442_));
  inv1   g285(.a(x077), .O(new_n443_));
  aoi22  g286(.a(new_n443_), .b(new_n252_), .c(new_n241_), .d(new_n243_), .O(new_n444_));
  nand3  g287(.a(new_n280_), .b(new_n266_), .c(new_n443_), .O(new_n445_));
  oai22  g288(.a(new_n445_), .b(x053), .c(new_n444_), .d(new_n244_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(x069), .O(new_n447_));
  nand2  g290(.a(new_n445_), .b(new_n241_), .O(new_n448_));
  aoi22  g291(.a(new_n448_), .b(x037), .c(x077), .d(x013), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(new_n447_), .c(new_n442_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n159_), .O(new_n451_));
  nand2  g294(.a(x126), .b(x117), .O(new_n452_));
  oai21  g295(.a(x117), .b(new_n253_), .c(new_n452_), .O(new_n453_));
  aoi21  g296(.a(x069), .b(x037), .c(new_n240_), .O(new_n454_));
  nand2  g297(.a(new_n246_), .b(x029), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n244_), .c(x085), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(new_n454_), .c(new_n443_), .O(new_n457_));
  oai21  g300(.a(x085), .b(new_n243_), .c(new_n457_), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(new_n453_), .O(new_n459_));
  aoi22  g302(.a(new_n248_), .b(new_n270_), .c(new_n256_), .d(new_n252_), .O(new_n460_));
  nand2  g303(.a(x021), .b(x013), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n246_), .c(new_n266_), .d(x029), .O(new_n462_));
  oai21  g305(.a(new_n460_), .b(new_n240_), .c(new_n462_), .O(new_n463_));
  oai21  g306(.a(x125), .b(x101), .c(new_n463_), .O(new_n464_));
  aoi22  g307(.a(new_n276_), .b(new_n242_), .c(x021), .d(x013), .O(new_n465_));
  nor2   g308(.a(new_n258_), .b(x021), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n465_), .c(x005), .O(new_n467_));
  nand4  g310(.a(new_n266_), .b(x069), .c(x029), .d(new_n244_), .O(new_n468_));
  nand3  g311(.a(new_n468_), .b(new_n467_), .c(new_n464_), .O(new_n469_));
  nand3  g312(.a(new_n469_), .b(new_n157_), .c(new_n443_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n459_), .O(new_n471_));
  nand3  g314(.a(new_n157_), .b(new_n266_), .c(x029), .O(new_n472_));
  nand4  g315(.a(x126), .b(x125), .c(new_n253_), .d(x005), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n472_), .c(x013), .O(new_n474_));
  nand4  g317(.a(new_n157_), .b(new_n266_), .c(x029), .d(new_n244_), .O(new_n475_));
  inv1   g318(.a(new_n475_), .O(new_n476_));
  oai21  g319(.a(new_n476_), .b(new_n474_), .c(new_n443_), .O(new_n477_));
  nor2   g320(.a(new_n477_), .b(new_n252_), .O(new_n478_));
  aoi21  g321(.a(new_n471_), .b(new_n241_), .c(new_n478_), .O(new_n479_));
  aoi21  g322(.a(new_n479_), .b(new_n451_), .c(x045), .O(z13));
  nand2  g323(.a(new_n313_), .b(new_n301_), .O(new_n481_));
  oai21  g324(.a(x078), .b(x054), .c(new_n481_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(x086), .c(x006), .O(new_n483_));
  nand2  g326(.a(new_n309_), .b(new_n308_), .O(new_n484_));
  oai21  g327(.a(x078), .b(new_n302_), .c(new_n301_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n484_), .O(new_n486_));
  nand3  g329(.a(new_n338_), .b(new_n334_), .c(x070), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n486_), .c(x054), .O(new_n488_));
  nor3   g331(.a(new_n330_), .b(x078), .c(new_n313_), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n488_), .c(new_n326_), .O(new_n490_));
  ...
  nand4  g336(.a(new_n493_), .b(new_n492_), .c(new_n490_), .d(new_n483_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n159_), .O(new_n495_));
  nand2  g338(.a(x022), .b(x014), .O(new_n496_));
  inv1   g339(.a(x102), .O(new_n497_));
  oai21  g340(.a(x117), .b(new_n497_), .c(new_n318_), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n304_), .c(new_n326_), .O(new_n499_));
  nand2  g342(.a(new_n157_), .b(x006), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(new_n499_), .c(new_n300_), .O(new_n501_));
  nor3   g344(.a(new_n330_), .b(x117), .c(new_n298_), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n501_), .c(new_n299_), .O(new_n503_));
  nand4  g346(.a(new_n157_), .b(new_n326_), .c(x038), .d(x030), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n503_), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n496_), .O(new_n506_));
  nand4  g349(.a(new_n157_), .b(new_n326_), .c(x070), .d(x030), .O(new_n507_));
  nand3  g350(.a(x126), .b(new_n309_), .c(x006), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n302_), .O(new_n510_));
  oai22  g353(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n511_));
  nand2  g354(.a(new_n511_), .b(x102), .O(new_n512_));
  oai21  g355(.a(new_n335_), .b(new_n313_), .c(new_n484_), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n512_), .c(new_n298_), .O(new_n514_));
  nand4  g357(.a(new_n484_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n515_));
  inv1   g358(.a(new_n515_), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(new_n514_), .c(new_n157_), .O(new_n517_));
  inv1   g360(.a(x094), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n335_), .O(new_n519_));
  nand2  g362(.a(x118), .b(new_n308_), .O(new_n520_));
  nand3  g363(.a(new_n520_), .b(new_n519_), .c(new_n481_), .O(new_n521_));
  nand3  g364(.a(new_n521_), .b(x126), .c(x006), .O(new_n522_));
  nand3  g365(.a(new_n522_), .b(new_n517_), .c(new_n510_), .O(new_n523_));
  nand2  g366(.a(new_n523_), .b(new_n299_), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n506_), .O(new_n525_));
  nand3  g368(.a(new_n313_), .b(x014), .c(x006), .O(new_n526_));
  nor4   g369(.a(new_n526_), .b(new_n318_), .c(x062), .d(x054), .O(new_n527_));
  aoi21  g370(.a(new_n525_), .b(new_n334_), .c(new_n527_), .O(new_n528_));
  aoi21  g371(.a(new_n528_), .b(new_n495_), .c(x046), .O(z14));
  zero   g372(.O(z07));
  zero   g373(.O(z16));
  zero   g374(.O(z27));
  nor2   g375(.a(x126), .b(new_n157_), .O(z17));
  nor2   g376(.a(x126), .b(new_n157_), .O(z18));
  nor2   g377(.a(x126), .b(new_n157_), .O(z19));
  nor2   g378(.a(x126), .b(new_n157_), .O(z20));
  nor2   g379(.a(x126), .b(new_n157_), .O(z21));
  nor2   g380(.a(x126), .b(new_n157_), .O(z22));
  nor2   g381(.a(x126), .b(new_n157_), .O(z23));
  nor2   g382(.a(x126), .b(new_n157_), .O(z24));
  nor2   g383(.a(x126), .b(new_n157_), .O(z25));
