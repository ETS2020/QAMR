// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:44 2020
...
module FAU ( 
  ...
  inv1   g153(.a(x024), .O(new_n311_));
  nor2   g154(.a(x088), .b(x056), .O(new_n312_));
  nand2  g155(.a(new_n312_), .b(new_n311_), .O(new_n313_));
  nand2  g156(.a(new_n313_), .b(new_n310_), .O(new_n314_));
  ...
  nand4  g173(.a(x120), .b(new_n330_), .c(new_n161_), .d(x008), .O(new_n331_));
  inv1   g174(.a(new_n331_), .O(new_n332_));
  aoi21  g175(.a(new_n329_), .b(new_n163_), .c(new_n332_), .O(new_n333_));
  nand3  g176(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n334_));
  oai21  g177(.a(new_n333_), .b(x048), .c(new_n334_), .O(new_n335_));
  nand2  g178(.a(new_n335_), .b(x000), .O(new_n336_));
  nand3  g179(.a(new_n159_), .b(new_n162_), .c(x024), .O(new_n337_));
  aoi21  g180(.a(new_n337_), .b(new_n166_), .c(x032), .O(new_n338_));
  nor3   g181(.a(new_n312_), .b(x080), .c(x048), .O(new_n339_));
  oai21  g182(.a(new_n339_), .b(new_n338_), .c(x064), .O(new_n340_));
  nand2  g183(.a(x088), .b(x056), .O(new_n341_));
  aoi21  g184(.a(new_n341_), .b(x024), .c(x016), .O(new_n342_));
  inv1   g185(.a(new_n315_), .O(new_n343_));
  nand4  g186(.a(new_n341_), .b(new_n343_), .c(new_n310_), .d(x024), .O(new_n344_));
  oai21  g187(.a(new_n342_), .b(new_n316_), .c(new_n344_), .O(new_n345_));
  nand2  g188(.a(new_n310_), .b(x024), .O(new_n346_));
  aoi21  g189(.a(new_n346_), .b(new_n312_), .c(new_n161_), .O(new_n347_));
  aoi21  g190(.a(new_n345_), .b(new_n162_), .c(new_n347_), .O(new_n348_));
  oai21  g191(.a(new_n348_), .b(x080), .c(new_n340_), .O(new_n349_));
  nor2   g192(.a(new_n316_), .b(x080), .O(new_n350_));
  aoi21  g193(.a(new_n350_), .b(new_n162_), .c(x072), .O(new_n351_));
  nor2   g194(.a(new_n166_), .b(x008), .O(new_n352_));
  nor2   g195(.a(new_n167_), .b(x048), .O(new_n353_));
  aoi22  g196(.a(new_n353_), .b(new_n352_), .c(x048), .d(x032), .O(new_n354_));
  oai21  g197(.a(new_n351_), .b(new_n160_), .c(new_n354_), .O(new_n355_));
  aoi21  g198(.a(new_n349_), .b(new_n163_), .c(new_n355_), .O(new_n356_));
  nand2  g199(.a(new_n356_), .b(new_n336_), .O(new_n357_));
  ...
  inv1   g228(.a(x044), .O(new_n386_));
  oai22  g229(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n387_));
  nand3  g230(.a(new_n387_), .b(x084), .c(x004), .O(new_n388_));
  oai22  g231(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(x068), .c(x020), .O(new_n390_));
  aoi22  g233(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n390_), .c(new_n388_), .O(new_n392_));
  nand3  g235(.a(new_n392_), .b(new_n157_), .c(new_n386_), .O(new_n393_));
  inv1   g236(.a(new_n393_), .O(z12));
  inv1   g237(.a(x045), .O(new_n395_));
  nand2  g238(.a(x021), .b(x013), .O(new_n396_));
  oai21  g239(.a(new_n278_), .b(x029), .c(new_n396_), .O(new_n397_));
  nor2   g240(.a(x125), .b(x101), .O(new_n398_));
  nor2   g241(.a(x117), .b(x109), .O(new_n399_));
  oai21  g242(.a(new_n398_), .b(x093), .c(new_n399_), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(new_n275_), .O(new_n401_));
  oai21  g244(.a(new_n258_), .b(x109), .c(x037), .O(new_n402_));
  nand2  g245(.a(new_n402_), .b(x117), .O(new_n403_));
  inv1   g246(.a(x101), .O(new_n404_));
  oai21  g247(.a(new_n404_), .b(x061), .c(new_n248_), .O(new_n405_));
  nand3  g248(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(new_n266_), .O(new_n407_));
  aoi21  g250(.a(new_n405_), .b(new_n253_), .c(new_n407_), .O(new_n408_));
  nand4  g251(.a(new_n408_), .b(new_n403_), .c(new_n401_), .d(new_n397_), .O(new_n409_));
  nand4  g252(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n410_));
  inv1   g253(.a(new_n410_), .O(new_n411_));
  aoi21  g254(.a(new_n409_), .b(new_n274_), .c(new_n411_), .O(new_n412_));
  nand3  g255(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n413_));
  oai21  g256(.a(new_n412_), .b(x053), .c(new_n413_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(x005), .O(new_n415_));
  nand2  g258(.a(new_n244_), .b(x029), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(new_n242_), .O(new_n417_));
  nand2  g260(.a(new_n417_), .b(new_n274_), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n241_), .c(new_n399_), .O(new_n419_));
  nor2   g262(.a(new_n240_), .b(x021), .O(new_n420_));
  oai21  g263(.a(new_n420_), .b(new_n278_), .c(x069), .O(new_n421_));
  inv1   g264(.a(new_n398_), .O(new_n422_));
  nand4  g265(.a(new_n422_), .b(new_n396_), .c(new_n244_), .d(x029), .O(new_n423_));
  aoi21  g266(.a(new_n423_), .b(new_n421_), .c(x077), .O(new_n424_));
  oai21  g267(.a(new_n424_), .b(new_n419_), .c(new_n239_), .O(new_n425_));
  nand2  g268(.a(new_n396_), .b(x029), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(new_n270_), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(new_n274_), .c(x037), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n425_), .O(new_n429_));
  oai22  g272(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n430_));
  nand3  g273(.a(new_n430_), .b(x069), .c(x021), .O(new_n431_));
  aoi22  g274(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n431_), .O(new_n433_));
  aoi21  g276(.a(new_n429_), .b(new_n266_), .c(new_n433_), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n415_), .O(new_n435_));
  nand3  g278(.a(new_n435_), .b(new_n157_), .c(new_n395_), .O(new_n436_));
  inv1   g279(.a(new_n436_), .O(z13));
  oai21  g280(.a(x046), .b(x014), .c(x078), .O(new_n438_));
  inv1   g281(.a(x014), .O(new_n439_));
  inv1   g282(.a(x030), .O(new_n440_));
  nor2   g283(.a(x094), .b(x062), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n440_), .O(new_n442_));
  oai21  g285(.a(new_n299_), .b(new_n439_), .c(new_n442_), .O(new_n443_));
  inv1   g286(.a(x102), .O(new_n444_));
  inv1   g287(.a(x126), .O(new_n445_));
  aoi21  g288(.a(new_n445_), .b(new_n444_), .c(x094), .O(new_n446_));
  inv1   g289(.a(x110), .O(new_n447_));
  inv1   g290(.a(x118), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(new_n446_), .c(new_n300_), .O(new_n450_));
  oai21  g293(.a(new_n445_), .b(x110), .c(x038), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(x118), .O(new_n452_));
  oai21  g295(.a(new_n444_), .b(x062), .c(new_n447_), .O(new_n453_));
  nand3  g296(.a(x126), .b(new_n448_), .c(new_n299_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n303_), .O(new_n455_));
  aoi21  g298(.a(new_n453_), .b(new_n296_), .c(new_n455_), .O(new_n456_));
  nand4  g299(.a(new_n456_), .b(new_n452_), .c(new_n450_), .d(new_n443_), .O(new_n457_));
  nor2   g300(.a(x038), .b(new_n439_), .O(new_n458_));
  nor2   g301(.a(new_n445_), .b(x062), .O(new_n459_));
  aoi22  g302(.a(new_n459_), .b(new_n458_), .c(new_n457_), .d(new_n295_), .O(new_n460_));
  nand3  g303(.a(x086), .b(new_n296_), .c(new_n439_), .O(new_n461_));
  oai21  g304(.a(new_n460_), .b(x054), .c(new_n461_), .O(new_n462_));
  nand2  g305(.a(x094), .b(x062), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(x030), .c(x022), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(x078), .c(new_n439_), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n449_), .O(new_n466_));
  nand2  g309(.a(new_n296_), .b(x030), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n441_), .c(new_n300_), .O(new_n468_));
  nand2  g311(.a(new_n445_), .b(new_n444_), .O(new_n469_));
  aoi22  g312(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(new_n469_), .c(x030), .O(new_n471_));
  inv1   g314(.a(new_n471_), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(new_n468_), .c(new_n295_), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n466_), .c(x054), .O(new_n474_));
  oai21  g317(.a(new_n299_), .b(new_n439_), .c(x030), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n441_), .O(new_n476_));
  nand3  g319(.a(new_n476_), .b(new_n295_), .c(x038), .O(new_n477_));
  inv1   g320(.a(new_n477_), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(new_n474_), .c(new_n303_), .O(new_n479_));
  oai22  g322(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(x070), .c(x022), .O(new_n481_));
  nand2  g324(.a(x054), .b(x038), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n481_), .c(new_n479_), .O(new_n483_));
  aoi21  g326(.a(new_n462_), .b(x006), .c(new_n483_), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(x046), .c(new_n438_), .O(z14));
  inv1   g328(.a(new_n157_), .O(z18));
  zero   g329(.O(z07));
  zero   g330(.O(z15));
  zero   g331(.O(z16));
  zero   g332(.O(z17));
  ...
  zero   g337(.O(z25));
  zero   g338(.O(z27));
  inv1   g339(.a(new_n157_), .O(z21));
  inv1   g340(.a(new_n157_), .O(z23));
  inv1   g341(.a(new_n157_), .O(z26));
endmodule
