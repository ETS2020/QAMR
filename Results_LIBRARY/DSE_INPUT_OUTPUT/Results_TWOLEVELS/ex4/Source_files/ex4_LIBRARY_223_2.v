// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:41 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x125), .b(new_n157_), .O(z07));
  ...
  nand2  g279(.a(new_n255_), .b(new_n243_), .O(new_n436_));
  oai21  g280(.a(x077), .b(x053), .c(new_n436_), .O(new_n437_));
  nand3  g281(.a(new_n437_), .b(x085), .c(x005), .O(new_n438_));
  nand2  g282(.a(new_n251_), .b(new_n250_), .O(new_n439_));
  oai21  g283(.a(x077), .b(new_n244_), .c(new_n243_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n439_), .O(new_n441_));
  nand3  g285(.a(new_n280_), .b(new_n276_), .c(x069), .O(new_n442_));
  aoi21  g286(.a(new_n442_), .b(new_n441_), .c(x053), .O(new_n443_));
  nor3   g287(.a(new_n272_), .b(x077), .c(new_n255_), .O(new_n444_));
  oai21  g288(.a(new_n444_), .b(new_n443_), .c(new_n268_), .O(new_n445_));
  oai22  g289(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n446_));
  nand3  g290(.a(new_n446_), .b(x069), .c(x021), .O(new_n447_));
  aoi22  g291(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n448_));
  nand4  g292(.a(new_n448_), .b(new_n447_), .c(new_n445_), .d(new_n438_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n159_), .O(new_n450_));
  nand2  g294(.a(x021), .b(x013), .O(new_n451_));
  inv1   g295(.a(x101), .O(new_n452_));
  oai21  g296(.a(x122), .b(new_n452_), .c(new_n260_), .O(new_n453_));
  nand3  g297(.a(new_n453_), .b(new_n246_), .c(new_n268_), .O(new_n454_));
  nand2  g298(.a(new_n157_), .b(x005), .O(new_n455_));
  aoi21  g299(.a(new_n455_), .b(new_n454_), .c(new_n242_), .O(new_n456_));
  nor3   g300(.a(new_n272_), .b(x122), .c(new_n240_), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(new_n456_), .c(new_n241_), .O(new_n458_));
  nand4  g302(.a(new_n157_), .b(new_n268_), .c(x037), .d(x029), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(new_n458_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n451_), .O(new_n461_));
  nand4  g305(.a(new_n157_), .b(new_n268_), .c(x069), .d(x029), .O(new_n462_));
  nand3  g306(.a(x125), .b(new_n251_), .c(x005), .O(new_n463_));
  nand2  g307(.a(new_n463_), .b(new_n462_), .O(new_n464_));
  nand2  g308(.a(new_n464_), .b(new_n244_), .O(new_n465_));
  oai22  g309(.a(x093), .b(x069), .c(x061), .d(x037), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(x101), .O(new_n467_));
  oai21  g311(.a(new_n277_), .b(new_n255_), .c(new_n439_), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n467_), .c(new_n240_), .O(new_n469_));
  nand4  g313(.a(new_n439_), .b(new_n246_), .c(new_n268_), .d(x029), .O(new_n470_));
  inv1   g314(.a(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(new_n469_), .c(new_n157_), .O(new_n472_));
  inv1   g316(.a(x093), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n277_), .O(new_n474_));
  nand2  g318(.a(x117), .b(new_n250_), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(new_n474_), .c(new_n436_), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(x125), .c(x005), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n472_), .c(new_n465_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n241_), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n461_), .O(new_n480_));
  nand3  g324(.a(new_n255_), .b(x013), .c(x005), .O(new_n481_));
  nor4   g325(.a(new_n481_), .b(new_n260_), .c(x061), .d(x053), .O(new_n482_));
  aoi21  g326(.a(new_n480_), .b(new_n276_), .c(new_n482_), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(new_n450_), .c(x045), .O(z13));
  inv1   g328(.a(x046), .O(new_n485_));
  nand2  g329(.a(x022), .b(x014), .O(new_n486_));
  oai21  g330(.a(new_n337_), .b(x030), .c(new_n486_), .O(new_n487_));
  nor2   g331(.a(x126), .b(x102), .O(new_n488_));
  nor2   g332(.a(x118), .b(x110), .O(new_n489_));
  oai21  g333(.a(new_n488_), .b(x094), .c(new_n489_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n334_), .O(new_n491_));
  oai21  g335(.a(new_n317_), .b(x110), .c(x038), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(x118), .O(new_n493_));
  inv1   g337(.a(x102), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(x062), .c(new_n307_), .O(new_n495_));
  nand3  g339(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n325_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n312_), .c(new_n497_), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n493_), .c(new_n491_), .d(new_n487_), .O(new_n499_));
  nand4  g343(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n500_));
  inv1   g344(.a(new_n500_), .O(new_n501_));
  aoi21  g345(.a(new_n499_), .b(new_n333_), .c(new_n501_), .O(new_n502_));
  nand3  g346(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n503_));
  oai21  g347(.a(new_n502_), .b(x054), .c(new_n503_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(x006), .O(new_n505_));
  nand2  g349(.a(new_n303_), .b(x030), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n301_), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n333_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n300_), .c(new_n489_), .O(new_n509_));
  nor2   g353(.a(new_n299_), .b(x022), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n337_), .c(x070), .O(new_n511_));
  inv1   g355(.a(new_n488_), .O(new_n512_));
  nand4  g356(.a(new_n512_), .b(new_n486_), .c(new_n303_), .d(x030), .O(new_n513_));
  aoi21  g357(.a(new_n513_), .b(new_n511_), .c(x078), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(new_n509_), .c(new_n298_), .O(new_n515_));
  ...
  aoi21  g367(.a(new_n519_), .b(new_n325_), .c(new_n523_), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n505_), .O(new_n525_));
  nand3  g369(.a(new_n525_), .b(new_n159_), .c(new_n485_), .O(new_n526_));
  inv1   g370(.a(new_n526_), .O(z14));
  zero   g371(.O(z15));
  zero   g372(.O(z17));
  zero   g373(.O(z18));
  zero   g374(.O(z20));
  ...
  zero   g376(.O(z25));
  zero   g377(.O(z27));
  nor2   g378(.a(x125), .b(new_n157_), .O(z16));
  nor2   g379(.a(x125), .b(new_n157_), .O(z19));
  nor2   g380(.a(x125), .b(new_n157_), .O(z22));
  nor2   g381(.a(x125), .b(new_n157_), .O(z23));
  nor2   g382(.a(x125), .b(new_n157_), .O(z24));
  nor2   g383(.a(x125), .b(new_n157_), .O(z26));
endmodule
