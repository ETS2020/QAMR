...
module FAU ( 
  ...
  oai21  g229(.a(new_n386_), .b(x043), .c(new_n175_), .O(z11));
  inv1   g230(.a(x044), .O(new_n388_));
  ...
  nand3  g237(.a(new_n394_), .b(new_n175_), .c(new_n388_), .O(new_n395_));
  inv1   g238(.a(new_n395_), .O(z12));
  ...
  nor2   g337(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g338(.a(new_n173_), .b(new_n172_), .O(z20));
  nor2   g339(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g340(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g341(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
