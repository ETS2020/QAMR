...
module FAU ( 
  ...
  nor3   g327(.a(new_n329_), .b(x078), .c(new_n312_), .O(new_n484_));
  ...
  oai21  g336(.a(x114), .b(new_n492_), .c(new_n317_), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n303_), .c(new_n325_), .O(new_n494_));
  nand2  g338(.a(new_n157_), .b(x006), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n494_), .c(new_n299_), .O(new_n496_));
  nor3   g340(.a(new_n329_), .b(x114), .c(new_n297_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n496_), .c(new_n298_), .O(new_n498_));
  nand4  g342(.a(new_n157_), .b(new_n325_), .c(x038), .d(x030), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n498_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n491_), .O(new_n501_));
  nand4  g345(.a(new_n157_), .b(new_n325_), .c(x070), .d(x030), .O(new_n502_));
  nand3  g346(.a(x126), .b(new_n308_), .c(x006), .O(new_n503_));
  ...
  oai21  g351(.a(new_n334_), .b(new_n312_), .c(new_n479_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n507_), .c(new_n297_), .O(new_n509_));
  nand4  g353(.a(new_n479_), .b(new_n303_), .c(new_n325_), .d(x030), .O(new_n510_));
  inv1   g354(.a(new_n510_), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n509_), .c(new_n157_), .O(new_n512_));
  inv1   g356(.a(x094), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n334_), .O(new_n514_));
  nand2  g358(.a(x118), .b(new_n307_), .O(new_n515_));
  ...
  nand3  g364(.a(new_n312_), .b(x014), .c(x006), .O(new_n521_));
  nor4   g365(.a(new_n521_), .b(new_n317_), .c(x062), .d(x054), .O(new_n522_));
  aoi21  g366(.a(new_n520_), .b(new_n333_), .c(new_n522_), .O(new_n523_));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z27));
  nor2   g374(.a(x126), .b(new_n157_), .O(z15));
  nor2   g375(.a(x126), .b(new_n157_), .O(z18));
  nor2   g376(.a(x126), .b(new_n157_), .O(z19));
  nor2   g377(.a(x126), .b(new_n157_), .O(z20));
  nor2   g378(.a(x126), .b(new_n157_), .O(z23));
  nor2   g379(.a(x126), .b(new_n157_), .O(z24));
