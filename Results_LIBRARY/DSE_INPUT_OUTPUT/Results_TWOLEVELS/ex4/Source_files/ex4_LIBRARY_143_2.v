...
module FAU ( 
  ...
  oai22  g063(.a(new_n213_), .b(new_n211_), .c(new_n212_), .d(new_n210_), .O(new_n220_));
  nand3  g064(.a(new_n220_), .b(new_n219_), .c(new_n172_), .O(new_n221_));
  aoi21  g065(.a(new_n221_), .b(new_n218_), .c(new_n208_), .O(z03));
  ...
  nand3  g136(.a(new_n292_), .b(new_n174_), .c(x045), .O(new_n293_));
  inv1   g137(.a(new_n293_), .O(z05));
  inv1   g138(.a(x014), .O(new_n295_));
  aoi21  g139(.a(x046), .b(new_n295_), .c(x019), .O(new_n296_));
  ...
  aoi21  g319(.a(new_n475_), .b(new_n298_), .c(x019), .O(new_n476_));
  ...
  aoi21  g359(.a(new_n511_), .b(new_n172_), .c(new_n515_), .O(new_n516_));
  ...
  nor2   g368(.a(x078), .b(new_n172_), .O(z18));
  nor2   g369(.a(x078), .b(new_n172_), .O(z19));
  nor2   g370(.a(x078), .b(new_n172_), .O(z23));
  nor2   g371(.a(x078), .b(new_n172_), .O(z24));
  nor2   g372(.a(x078), .b(new_n172_), .O(z26));
  nor2   g373(.a(x078), .b(new_n172_), .O(z27));
endmodule
