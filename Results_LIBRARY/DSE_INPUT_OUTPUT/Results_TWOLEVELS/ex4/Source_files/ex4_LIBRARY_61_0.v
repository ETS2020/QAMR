...
module FAU ( 
  ...
  nand3  g265(.a(new_n422_), .b(new_n158_), .c(new_n416_), .O(new_n423_));
  ...
  oai21  g274(.a(new_n431_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nor2   g328(.a(x078), .b(x046), .O(z19));
  nor2   g329(.a(x078), .b(x046), .O(z21));
  nor2   g330(.a(x078), .b(x046), .O(z22));
  nor2   g331(.a(x078), .b(x046), .O(z24));
  nor2   g332(.a(x078), .b(x046), .O(z25));
endmodule
