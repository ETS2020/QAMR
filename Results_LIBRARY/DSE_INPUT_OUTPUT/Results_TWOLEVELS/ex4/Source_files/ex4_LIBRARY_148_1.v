...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x027), .O(z16));
  ...
  oai21  g254(.a(new_n411_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai22  g324(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n482_));
  inv1   g325(.a(x102), .O(new_n483_));
  aoi21  g326(.a(new_n172_), .b(new_n483_), .c(x094), .O(new_n484_));
  nand2  g327(.a(new_n308_), .b(new_n307_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n484_), .c(new_n333_), .O(new_n486_));
  oai21  g329(.a(new_n172_), .b(x110), .c(x038), .O(new_n487_));
  ...
  nand2  g346(.a(new_n172_), .b(new_n483_), .O(new_n504_));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(new_n172_), .b(x027), .O(z18));
  nor2   g374(.a(new_n172_), .b(x027), .O(z20));
  nor2   g375(.a(new_n172_), .b(x027), .O(z24));
endmodule
