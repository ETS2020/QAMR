// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:24 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x008), .O(z16));
  ...
  nand2  g196(.a(x096), .b(new_n166_), .O(new_n354_));
  inv1   g197(.a(x104), .O(new_n355_));
  nand3  g198(.a(x120), .b(new_n355_), .c(new_n159_), .O(new_n356_));
  aoi21  g199(.a(new_n356_), .b(new_n354_), .c(new_n157_), .O(new_n357_));
  inv1   g200(.a(x056), .O(new_n358_));
  inv1   g201(.a(x088), .O(new_n359_));
  nand2  g202(.a(new_n359_), .b(new_n358_), .O(new_n360_));
  aoi21  g203(.a(x024), .b(new_n159_), .c(new_n360_), .O(new_n361_));
  nor2   g204(.a(new_n361_), .b(x080), .O(new_n362_));
  oai21  g205(.a(new_n362_), .b(new_n357_), .c(new_n162_), .O(new_n363_));
  aoi21  g206(.a(new_n363_), .b(new_n161_), .c(x078), .O(new_n364_));
  inv1   g207(.a(x024), .O(new_n365_));
  nor2   g208(.a(new_n365_), .b(x016), .O(new_n366_));
  oai21  g209(.a(new_n366_), .b(new_n360_), .c(new_n158_), .O(new_n367_));
  aoi21  g210(.a(new_n367_), .b(new_n161_), .c(new_n159_), .O(new_n368_));
  oai21  g211(.a(new_n368_), .b(new_n364_), .c(x032), .O(new_n369_));
  inv1   g212(.a(x112), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n355_), .O(new_n371_));
  aoi21  g214(.a(x064), .b(x032), .c(new_n157_), .O(new_n372_));
  nand2  g215(.a(x088), .b(x056), .O(new_n373_));
  nand2  g216(.a(new_n373_), .b(x024), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n165_), .c(x080), .O(new_n375_));
  oai21  g218(.a(new_n375_), .b(new_n372_), .c(new_n371_), .O(new_n376_));
  nor2   g219(.a(x080), .b(new_n166_), .O(new_n377_));
  nand2  g220(.a(new_n377_), .b(x024), .O(new_n378_));
  nand3  g221(.a(x096), .b(new_n359_), .c(x000), .O(new_n379_));
  nand2  g222(.a(new_n379_), .b(new_n378_), .O(new_n380_));
  nand2  g223(.a(new_n380_), .b(new_n160_), .O(new_n381_));
  nor2   g224(.a(x008), .b(new_n157_), .O(new_n382_));
  oai21  g225(.a(new_n382_), .b(new_n377_), .c(new_n360_), .O(new_n383_));
  inv1   g226(.a(x120), .O(new_n384_));
  oai21  g227(.a(new_n384_), .b(x112), .c(new_n365_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(x000), .O(new_n386_));
  inv1   g229(.a(x096), .O(new_n387_));
  nand2  g230(.a(new_n384_), .b(new_n387_), .O(new_n388_));
  nand4  g231(.a(new_n388_), .b(new_n373_), .c(new_n158_), .d(x024), .O(new_n389_));
  nand2  g232(.a(new_n389_), .b(new_n386_), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n159_), .O(new_n391_));
  nand4  g234(.a(new_n391_), .b(new_n383_), .c(new_n381_), .d(new_n376_), .O(new_n392_));
  nand2  g235(.a(x064), .b(x016), .O(new_n393_));
  nand2  g236(.a(x080), .b(x000), .O(new_n394_));
  aoi21  g237(.a(new_n394_), .b(new_n393_), .c(x008), .O(new_n395_));
  aoi21  g238(.a(new_n392_), .b(new_n161_), .c(new_n395_), .O(new_n396_));
  nand3  g239(.a(x064), .b(new_n161_), .c(x016), .O(new_n397_));
  nand3  g240(.a(x080), .b(new_n160_), .c(x000), .O(new_n398_));
  nand2  g241(.a(new_n398_), .b(new_n397_), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(x072), .O(new_n400_));
  oai21  g243(.a(new_n396_), .b(x072), .c(new_n400_), .O(new_n401_));
  nand3  g244(.a(x096), .b(new_n358_), .c(x000), .O(new_n402_));
  aoi21  g245(.a(new_n402_), .b(new_n378_), .c(x032), .O(new_n403_));
  nor2   g246(.a(x016), .b(new_n157_), .O(new_n404_));
  oai21  g247(.a(new_n404_), .b(new_n377_), .c(new_n360_), .O(new_n405_));
  nand4  g248(.a(new_n373_), .b(new_n158_), .c(x024), .d(new_n165_), .O(new_n406_));
  nand3  g249(.a(new_n359_), .b(new_n166_), .c(x000), .O(new_n407_));
  nand2  g250(.a(new_n407_), .b(new_n406_), .O(new_n408_));
  nand2  g251(.a(new_n408_), .b(new_n388_), .O(new_n409_));
  aoi21  g252(.a(new_n384_), .b(new_n365_), .c(x016), .O(new_n410_));
  nand2  g253(.a(x120), .b(x088), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(x056), .c(new_n158_), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(new_n410_), .c(x000), .O(new_n413_));
  nand2  g256(.a(new_n371_), .b(new_n158_), .O(new_n414_));
  nand4  g257(.a(new_n414_), .b(new_n413_), .c(new_n409_), .d(new_n405_), .O(new_n415_));
  oai21  g258(.a(new_n415_), .b(new_n403_), .c(new_n161_), .O(new_n416_));
  nor2   g259(.a(new_n166_), .b(x032), .O(new_n417_));
  aoi21  g260(.a(new_n417_), .b(x016), .c(x072), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n416_), .c(new_n159_), .O(new_n419_));
  aoi21  g262(.a(new_n401_), .b(new_n172_), .c(new_n419_), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n369_), .c(x040), .O(z08));
  oai22  g264(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n422_));
  nand3  g265(.a(new_n422_), .b(x081), .c(x001), .O(new_n423_));
  oai22  g266(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(x065), .c(x017), .O(new_n425_));
  aoi22  g268(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n426_));
  nand3  g269(.a(new_n426_), .b(new_n425_), .c(new_n423_), .O(new_n427_));
  inv1   g270(.a(new_n427_), .O(new_n428_));
  oai21  g271(.a(new_n428_), .b(x041), .c(new_n174_), .O(z09));
  inv1   g272(.a(x042), .O(new_n430_));
  ...
  nand3  g288(.a(new_n445_), .b(new_n174_), .c(new_n439_), .O(new_n446_));
  inv1   g289(.a(new_n446_), .O(z11));
  inv1   g290(.a(x044), .O(new_n448_));
  oai22  g291(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(x084), .c(x004), .O(new_n450_));
  oai22  g293(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n451_));
  nand3  g294(.a(new_n451_), .b(x068), .c(x020), .O(new_n452_));
  aoi22  g295(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n453_));
  nand3  g296(.a(new_n453_), .b(new_n452_), .c(new_n450_), .O(new_n454_));
  nand3  g297(.a(new_n454_), .b(new_n174_), .c(new_n448_), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(z12));
  inv1   g299(.a(x045), .O(new_n457_));
  nand2  g300(.a(x021), .b(x013), .O(new_n458_));
  oai21  g301(.a(new_n280_), .b(x029), .c(new_n458_), .O(new_n459_));
  nor2   g302(.a(x125), .b(x101), .O(new_n460_));
  nor2   g303(.a(x117), .b(x109), .O(new_n461_));
  oai21  g304(.a(new_n460_), .b(x093), .c(new_n461_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n277_), .O(new_n463_));
  oai21  g306(.a(new_n260_), .b(x109), .c(x037), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x117), .O(new_n465_));
  inv1   g308(.a(x101), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x061), .c(new_n250_), .O(new_n467_));
  nand3  g310(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n268_), .O(new_n469_));
  aoi21  g312(.a(new_n467_), .b(new_n255_), .c(new_n469_), .O(new_n470_));
  nand4  g313(.a(new_n470_), .b(new_n465_), .c(new_n463_), .d(new_n459_), .O(new_n471_));
  nand4  g314(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  aoi21  g316(.a(new_n471_), .b(new_n276_), .c(new_n473_), .O(new_n474_));
  nand3  g317(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n475_));
  oai21  g318(.a(new_n474_), .b(x053), .c(new_n475_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(x005), .O(new_n477_));
  oai21  g320(.a(new_n284_), .b(new_n242_), .c(new_n244_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n276_), .O(new_n479_));
  aoi21  g322(.a(new_n479_), .b(new_n243_), .c(new_n461_), .O(new_n480_));
  nor2   g323(.a(new_n242_), .b(x021), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n280_), .c(x069), .O(new_n482_));
  inv1   g325(.a(new_n460_), .O(new_n483_));
  nand4  g326(.a(new_n483_), .b(new_n458_), .c(new_n246_), .d(x029), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n482_), .c(x077), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n480_), .c(new_n241_), .O(new_n486_));
  nand2  g329(.a(new_n458_), .b(x029), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n272_), .O(new_n488_));
  nand3  g331(.a(new_n488_), .b(new_n276_), .c(x037), .O(new_n489_));
  ...
  aoi21  g337(.a(new_n490_), .b(new_n268_), .c(new_n494_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n477_), .O(new_n496_));
  nand3  g339(.a(new_n496_), .b(new_n174_), .c(new_n457_), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(z13));
  oai21  g341(.a(x046), .b(new_n300_), .c(x008), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(x078), .O(new_n500_));
  nand2  g343(.a(x022), .b(x014), .O(new_n501_));
  oai21  g344(.a(new_n336_), .b(x030), .c(new_n501_), .O(new_n502_));
  inv1   g345(.a(x102), .O(new_n503_));
  aoi21  g346(.a(new_n317_), .b(new_n503_), .c(x094), .O(new_n504_));
  nand2  g347(.a(new_n308_), .b(new_n307_), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n504_), .c(new_n333_), .O(new_n506_));
  oai21  g349(.a(new_n317_), .b(x110), .c(x038), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(x118), .O(new_n508_));
  oai21  g351(.a(new_n503_), .b(x062), .c(new_n307_), .O(new_n509_));
  nand3  g352(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n325_), .O(new_n511_));
  aoi21  g354(.a(new_n509_), .b(new_n312_), .c(new_n511_), .O(new_n512_));
  nand4  g355(.a(new_n512_), .b(new_n508_), .c(new_n506_), .d(new_n502_), .O(new_n513_));
  nand4  g356(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n514_));
  inv1   g357(.a(new_n514_), .O(new_n515_));
  aoi21  g358(.a(new_n513_), .b(new_n172_), .c(new_n515_), .O(new_n516_));
  nand3  g359(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n517_));
  oai21  g360(.a(new_n516_), .b(x054), .c(new_n517_), .O(new_n518_));
  aoi21  g361(.a(new_n303_), .b(x030), .c(x022), .O(new_n519_));
  oai21  g362(.a(new_n519_), .b(x078), .c(new_n300_), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n505_), .O(new_n521_));
  nand2  g364(.a(x030), .b(new_n301_), .O(new_n522_));
  aoi21  g365(.a(new_n522_), .b(new_n329_), .c(new_n333_), .O(new_n523_));
  nand2  g366(.a(new_n317_), .b(new_n503_), .O(new_n524_));
  nand4  g367(.a(new_n524_), .b(new_n501_), .c(new_n303_), .d(x030), .O(new_n525_));
  inv1   g368(.a(new_n525_), .O(new_n526_));
  oai21  g369(.a(new_n526_), .b(new_n523_), .c(new_n172_), .O(new_n527_));
  aoi21  g370(.a(new_n527_), .b(new_n521_), .c(x054), .O(new_n528_));
  nand2  g371(.a(new_n501_), .b(x030), .O(new_n529_));
  nand2  g372(.a(new_n529_), .b(new_n329_), .O(new_n530_));
  nand3  g373(.a(new_n530_), .b(new_n172_), .c(x038), .O(new_n531_));
  inv1   g374(.a(new_n531_), .O(new_n532_));
  oai21  g375(.a(new_n532_), .b(new_n528_), .c(new_n325_), .O(new_n533_));
  oai22  g376(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n534_));
  nand3  g377(.a(new_n534_), .b(x070), .c(x022), .O(new_n535_));
  nand2  g378(.a(x054), .b(x038), .O(new_n536_));
  nand3  g379(.a(new_n536_), .b(new_n535_), .c(new_n533_), .O(new_n537_));
  aoi21  g380(.a(new_n518_), .b(x006), .c(new_n537_), .O(new_n538_));
  oai21  g381(.a(new_n538_), .b(x046), .c(new_n500_), .O(z14));
  zero   g382(.O(z07));
  zero   g383(.O(z15));
  zero   g384(.O(z17));
  zero   g385(.O(z18));
  ...
  zero   g387(.O(z23));
  zero   g388(.O(z27));
  nor2   g389(.a(new_n172_), .b(x008), .O(z19));
  nor2   g390(.a(new_n172_), .b(x008), .O(z20));
  nor2   g391(.a(new_n172_), .b(x008), .O(z22));
  nor2   g392(.a(new_n172_), .b(x008), .O(z24));
  nor2   g393(.a(new_n172_), .b(x008), .O(z25));
  nor2   g394(.a(new_n172_), .b(x008), .O(z26));
endmodule
