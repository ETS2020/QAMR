...
module FAU ( 
  ...
  nand3  g319(.a(x070), .b(new_n301_), .c(x022), .O(new_n477_));
  nand3  g320(.a(x086), .b(new_n312_), .c(x006), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n477_), .c(new_n476_), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(x078), .c(new_n297_), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(z14));
  zero   g324(.O(z07));
  zero   g325(.O(z16));
  zero   g326(.O(z17));
  zero   g327(.O(z19));
