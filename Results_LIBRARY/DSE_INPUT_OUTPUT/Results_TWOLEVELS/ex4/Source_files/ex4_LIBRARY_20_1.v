...
module FAU ( 
  ...
  nand3  g320(.a(new_n476_), .b(new_n174_), .c(new_n436_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  aoi21  g322(.a(x070), .b(x038), .c(new_n298_), .O(new_n479_));
  nand2  g323(.a(new_n304_), .b(x030), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n341_), .c(x086), .O(new_n481_));
  oai22  g325(.a(new_n481_), .b(new_n479_), .c(x118), .d(x110), .O(new_n482_));
  nand3  g326(.a(new_n326_), .b(x070), .c(x030), .O(new_n483_));
  nand3  g327(.a(x102), .b(new_n316_), .c(x006), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n313_), .O(new_n486_));
  nand2  g330(.a(x022), .b(x014), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x006), .O(new_n488_));
  oai21  g332(.a(x086), .b(new_n334_), .c(new_n488_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n337_), .O(new_n490_));
  nor2   g334(.a(x126), .b(x102), .O(new_n491_));
  nand4  g335(.a(new_n487_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n492_));
  inv1   g336(.a(x094), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n334_), .c(x006), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n492_), .c(new_n491_), .O(new_n495_));
  oai21  g339(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n302_), .O(new_n497_));
  oai22  g341(.a(new_n309_), .b(x110), .c(new_n493_), .d(x062), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(x126), .O(new_n499_));
  aoi21  g343(.a(x030), .b(new_n299_), .c(x086), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(new_n497_), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(x006), .c(new_n495_), .O(new_n502_));
  nand4  g346(.a(new_n502_), .b(new_n490_), .c(new_n486_), .d(new_n482_), .O(new_n503_));
  nand2  g347(.a(x038), .b(x014), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(x070), .c(x022), .O(new_n505_));
  oai22  g349(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n299_), .O(new_n507_));
  nand2  g351(.a(x030), .b(new_n302_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n330_), .c(x086), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(x054), .c(x038), .O(new_n510_));
  nand4  g354(.a(new_n510_), .b(new_n507_), .c(new_n505_), .d(new_n172_), .O(new_n511_));
  aoi21  g355(.a(new_n503_), .b(new_n300_), .c(new_n511_), .O(new_n512_));
  nor2   g356(.a(new_n512_), .b(x046), .O(z14));
  zero   g357(.O(z16));
  zero   g358(.O(z19));
  zero   g359(.O(z21));
  zero   g360(.O(z22));
  ...
  nor2   g365(.a(new_n172_), .b(x046), .O(z18));
  nor2   g366(.a(new_n172_), .b(x046), .O(z20));
  nor2   g367(.a(new_n172_), .b(x046), .O(z23));
  nor2   g368(.a(new_n172_), .b(x046), .O(z24));
  nor2   g369(.a(new_n172_), .b(x046), .O(z25));
endmodule
