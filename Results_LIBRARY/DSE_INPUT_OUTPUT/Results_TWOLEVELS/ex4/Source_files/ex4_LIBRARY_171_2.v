...
module FAU ( 
  ...
  oai21  g311(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n469_));
  nand2  g312(.a(new_n318_), .b(new_n314_), .O(new_n470_));
  oai22  g313(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n470_), .O(new_n472_));
  oai22  g315(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n473_));
  nand2  g316(.a(x118), .b(new_n298_), .O(new_n474_));
  oai21  g317(.a(x118), .b(x022), .c(new_n474_), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(x126), .c(x086), .O(new_n476_));
  nand4  g319(.a(new_n476_), .b(new_n473_), .c(new_n472_), .d(new_n469_), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n297_), .c(new_n340_), .O(new_n478_));
  nand4  g321(.a(x086), .b(new_n157_), .c(new_n300_), .d(new_n319_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(x006), .O(new_n481_));
  nor2   g324(.a(new_n331_), .b(new_n304_), .O(new_n482_));
  oai22  g325(.a(new_n482_), .b(new_n321_), .c(x118), .d(x110), .O(new_n483_));
  nor2   g326(.a(x038), .b(new_n304_), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n307_), .c(x070), .O(new_n485_));
  nand4  g328(.a(new_n470_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n485_), .c(new_n483_), .O(new_n487_));
  aoi21  g330(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n488_));
  nor2   g331(.a(new_n488_), .b(new_n300_), .O(new_n489_));
  aoi21  g332(.a(new_n487_), .b(new_n340_), .c(new_n489_), .O(new_n490_));
  nor2   g333(.a(new_n301_), .b(x038), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(x022), .c(x046), .O(new_n492_));
  oai21  g335(.a(new_n490_), .b(x086), .c(new_n492_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n297_), .O(new_n494_));
  nand2  g337(.a(x054), .b(x038), .O(new_n495_));
  nand4  g338(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n496_));
  nand2  g339(.a(x078), .b(x014), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n496_), .c(new_n495_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n157_), .O(new_n499_));
  nand3  g342(.a(new_n499_), .b(new_n494_), .c(new_n481_), .O(z14));
  zero   g343(.O(z07));
  zero   g344(.O(z16));
  zero   g345(.O(z17));
  zero   g346(.O(z18));
  ...
  zero   g349(.O(z24));
  zero   g350(.O(z25));
  nor2   g351(.a(x078), .b(new_n157_), .O(z19));
  nor2   g352(.a(x078), .b(new_n157_), .O(z21));
  nor2   g353(.a(x078), .b(new_n157_), .O(z23));
  nor2   g354(.a(x078), .b(new_n157_), .O(z26));
  nor2   g355(.a(x078), .b(new_n157_), .O(z27));
endmodule
