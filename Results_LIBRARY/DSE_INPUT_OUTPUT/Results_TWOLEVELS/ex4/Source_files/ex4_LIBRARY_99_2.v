// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:19 2020
...
module FAU ( 
  ...
  nand2  g172(.a(new_n305_), .b(x062), .O(new_n329_));
  nand2  g173(.a(x118), .b(x022), .O(new_n330_));
  nand2  g174(.a(new_n298_), .b(x110), .O(new_n331_));
  nand3  g175(.a(new_n331_), .b(new_n330_), .c(new_n329_), .O(new_n332_));
  aoi21  g176(.a(new_n332_), .b(new_n318_), .c(new_n302_), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(new_n328_), .O(new_n334_));
  nor2   g178(.a(new_n326_), .b(new_n302_), .O(new_n335_));
  aoi22  g179(.a(new_n335_), .b(new_n300_), .c(new_n334_), .d(new_n313_), .O(new_n336_));
  nand4  g180(.a(new_n336_), .b(new_n325_), .c(new_n317_), .d(new_n311_), .O(new_n337_));
  nand2  g181(.a(new_n299_), .b(new_n319_), .O(new_n338_));
  nand3  g182(.a(new_n338_), .b(new_n300_), .c(new_n320_), .O(new_n339_));
  nand2  g183(.a(x086), .b(new_n299_), .O(new_n340_));
  oai22  g184(.a(new_n340_), .b(x030), .c(x086), .d(x006), .O(new_n341_));
  nand2  g185(.a(new_n341_), .b(x014), .O(new_n342_));
  inv1   g186(.a(x054), .O(new_n343_));
  nand2  g187(.a(new_n303_), .b(x022), .O(new_n344_));
  aoi21  g188(.a(new_n344_), .b(new_n326_), .c(new_n302_), .O(new_n345_));
  oai21  g189(.a(new_n345_), .b(new_n343_), .c(new_n299_), .O(new_n346_));
  nand4  g190(.a(new_n346_), .b(new_n342_), .c(new_n339_), .d(x078), .O(new_n347_));
  aoi21  g191(.a(new_n337_), .b(x054), .c(new_n347_), .O(new_n348_));
  nor2   g192(.a(new_n348_), .b(new_n157_), .O(z06));
  inv1   g193(.a(x024), .O(new_n351_));
  nor2   g194(.a(x088), .b(x056), .O(new_n352_));
  nand2  g195(.a(new_n352_), .b(new_n351_), .O(new_n353_));
  oai21  g196(.a(new_n168_), .b(new_n162_), .c(new_n353_), .O(new_n354_));
  inv1   g197(.a(x096), .O(new_n355_));
  inv1   g198(.a(x120), .O(new_n356_));
  aoi21  g199(.a(new_n356_), .b(new_n355_), .c(x088), .O(new_n357_));
  inv1   g200(.a(x104), .O(new_n358_));
  inv1   g201(.a(x112), .O(new_n359_));
  nand2  g202(.a(new_n359_), .b(new_n358_), .O(new_n360_));
  oai21  g203(.a(new_n360_), .b(new_n357_), .c(new_n169_), .O(new_n361_));
  oai21  g204(.a(new_n356_), .b(x104), .c(x032), .O(new_n362_));
  nand2  g205(.a(new_n362_), .b(x112), .O(new_n363_));
  oai21  g206(.a(new_n355_), .b(x056), .c(new_n358_), .O(new_n364_));
  nand3  g207(.a(x120), .b(new_n359_), .c(new_n168_), .O(new_n365_));
  nand2  g208(.a(new_n365_), .b(new_n161_), .O(new_n366_));
  aoi21  g209(.a(new_n364_), .b(new_n163_), .c(new_n366_), .O(new_n367_));
  nand4  g210(.a(new_n367_), .b(new_n363_), .c(new_n361_), .d(new_n354_), .O(new_n368_));
  nor2   g211(.a(x032), .b(new_n162_), .O(new_n369_));
  nor2   g212(.a(new_n356_), .b(x056), .O(new_n370_));
  aoi22  g213(.a(new_n370_), .b(new_n369_), .c(new_n368_), .d(new_n165_), .O(new_n371_));
  nand3  g214(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n372_));
  oai21  g215(.a(new_n371_), .b(x048), .c(new_n372_), .O(new_n373_));
  nand2  g216(.a(x088), .b(x056), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(x024), .c(x016), .O(new_n375_));
  oai21  g218(.a(new_n375_), .b(x072), .c(new_n162_), .O(new_n376_));
  nand2  g219(.a(new_n376_), .b(new_n360_), .O(new_n377_));
  nand2  g220(.a(x024), .b(new_n168_), .O(new_n378_));
  aoi21  g221(.a(new_n378_), .b(new_n352_), .c(new_n169_), .O(new_n379_));
  nand2  g222(.a(new_n356_), .b(new_n355_), .O(new_n380_));
  aoi22  g223(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n381_));
  nand3  g224(.a(new_n381_), .b(new_n380_), .c(x024), .O(new_n382_));
  inv1   g225(.a(new_n382_), .O(new_n383_));
  oai21  g226(.a(new_n383_), .b(new_n379_), .c(new_n165_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n377_), .c(x048), .O(new_n385_));
  oai21  g228(.a(new_n168_), .b(new_n162_), .c(x024), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(new_n352_), .O(new_n387_));
  nand3  g230(.a(new_n387_), .b(new_n165_), .c(x032), .O(new_n388_));
  inv1   g231(.a(new_n388_), .O(new_n389_));
  oai21  g232(.a(new_n389_), .b(new_n385_), .c(new_n161_), .O(new_n390_));
  oai22  g233(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(x064), .c(x016), .O(new_n392_));
  aoi22  g235(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n393_));
  nand3  g236(.a(new_n393_), .b(new_n392_), .c(new_n390_), .O(new_n394_));
  aoi21  g237(.a(new_n373_), .b(x000), .c(new_n394_), .O(new_n395_));
  oai21  g238(.a(new_n395_), .b(x040), .c(new_n159_), .O(z08));
  ...
  nand3  g255(.a(new_n412_), .b(new_n159_), .c(new_n406_), .O(new_n413_));
  ...
  oai21  g264(.a(new_n421_), .b(x043), .c(new_n159_), .O(z11));
  ...
  oai21  g272(.a(new_n429_), .b(x044), .c(new_n159_), .O(z12));
  inv1   g273(.a(x045), .O(new_n431_));
  nand2  g274(.a(x021), .b(x013), .O(new_n432_));
  oai21  g275(.a(new_n280_), .b(x029), .c(new_n432_), .O(new_n433_));
  nor2   g276(.a(x125), .b(x101), .O(new_n434_));
  nor2   g277(.a(x117), .b(x109), .O(new_n435_));
  oai21  g278(.a(new_n434_), .b(x093), .c(new_n435_), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n277_), .O(new_n437_));
  oai21  g280(.a(new_n260_), .b(x109), .c(x037), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(x117), .O(new_n439_));
  inv1   g282(.a(x101), .O(new_n440_));
  oai21  g283(.a(new_n440_), .b(x061), .c(new_n250_), .O(new_n441_));
  nand3  g284(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n268_), .O(new_n443_));
  aoi21  g286(.a(new_n441_), .b(new_n255_), .c(new_n443_), .O(new_n444_));
  nand4  g287(.a(new_n444_), .b(new_n439_), .c(new_n437_), .d(new_n433_), .O(new_n445_));
  nand4  g288(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n446_));
  inv1   g289(.a(new_n446_), .O(new_n447_));
  aoi21  g290(.a(new_n445_), .b(new_n276_), .c(new_n447_), .O(new_n448_));
  nand3  g291(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n449_));
  oai21  g292(.a(new_n448_), .b(x053), .c(new_n449_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(x005), .O(new_n451_));
  nand2  g294(.a(new_n246_), .b(x029), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(new_n244_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n276_), .O(new_n454_));
  aoi21  g297(.a(new_n454_), .b(new_n243_), .c(new_n435_), .O(new_n455_));
  nor2   g298(.a(new_n242_), .b(x021), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(new_n280_), .c(x069), .O(new_n457_));
  inv1   g300(.a(new_n434_), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n432_), .c(new_n246_), .d(x029), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n457_), .c(x077), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n455_), .c(new_n241_), .O(new_n461_));
  nand2  g304(.a(new_n432_), .b(x029), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n272_), .O(new_n463_));
  nand3  g306(.a(new_n463_), .b(new_n276_), .c(x037), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n461_), .O(new_n465_));
  oai22  g308(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(x069), .c(x021), .O(new_n467_));
  aoi22  g310(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n467_), .O(new_n469_));
  aoi21  g312(.a(new_n465_), .b(new_n268_), .c(new_n469_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n451_), .O(new_n471_));
  nand3  g314(.a(new_n471_), .b(new_n159_), .c(new_n431_), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(z13));
  inv1   g316(.a(x078), .O(new_n474_));
  oai21  g317(.a(new_n306_), .b(x030), .c(new_n308_), .O(new_n475_));
  nand2  g318(.a(new_n318_), .b(new_n314_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n305_), .O(new_n477_));
  ...
  oai21  g325(.a(new_n314_), .b(x062), .c(new_n297_), .O(new_n483_));
  nand3  g326(.a(x126), .b(new_n298_), .c(new_n320_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n302_), .O(new_n485_));
  aoi21  g328(.a(new_n483_), .b(new_n299_), .c(new_n485_), .O(new_n486_));
  nand4  g329(.a(new_n486_), .b(new_n482_), .c(new_n480_), .d(new_n475_), .O(new_n487_));
  nand4  g330(.a(x126), .b(new_n304_), .c(new_n299_), .d(x014), .O(new_n488_));
  inv1   g331(.a(new_n488_), .O(new_n489_));
  aoi21  g332(.a(new_n487_), .b(new_n474_), .c(new_n489_), .O(new_n490_));
  oai22  g333(.a(new_n490_), .b(x054), .c(new_n340_), .d(x014), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(x006), .O(new_n492_));
  oai21  g335(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n474_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n319_), .c(new_n478_), .O(new_n495_));
  nor2   g338(.a(new_n303_), .b(x022), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(new_n306_), .c(x070), .O(new_n497_));
  nand4  g340(.a(new_n476_), .b(new_n327_), .c(new_n308_), .d(x030), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n497_), .c(x078), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n495_), .c(new_n343_), .O(new_n500_));
  inv1   g343(.a(new_n306_), .O(new_n501_));
  oai21  g344(.a(new_n309_), .b(new_n303_), .c(new_n501_), .O(new_n502_));
  nand3  g345(.a(new_n502_), .b(new_n474_), .c(x038), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n500_), .O(new_n504_));
  oai22  g347(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(x070), .c(x022), .O(new_n506_));
  aoi22  g349(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n506_), .O(new_n508_));
  aoi21  g351(.a(new_n504_), .b(new_n302_), .c(new_n508_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n492_), .c(x046), .O(z14));
  zero   g353(.O(z07));
  zero   g354(.O(z16));
  zero   g355(.O(z17));
  zero   g356(.O(z19));
  ...
  zero   g362(.O(z26));
  zero   g363(.O(z27));
  nor2   g364(.a(x078), .b(new_n157_), .O(z18));
  nor2   g365(.a(x078), .b(new_n157_), .O(z22));
endmodule
