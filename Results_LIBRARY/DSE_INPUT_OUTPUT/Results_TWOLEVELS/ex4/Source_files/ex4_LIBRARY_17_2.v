...
module FAU ( 
  ...
  nor2   g001(.a(x084), .b(new_n157_), .O(z16));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(new_n225_), .O(new_n304_));
  ...
  aoi21  g197(.a(new_n349_), .b(x084), .c(new_n353_), .O(new_n354_));
  ...
  aoi22  g274(.a(new_n229_), .b(new_n228_), .c(new_n227_), .d(new_n226_), .O(new_n432_));
  nor2   g275(.a(new_n432_), .b(new_n224_), .O(new_n433_));
  ...
  oai21  g280(.a(new_n437_), .b(new_n433_), .c(x084), .O(new_n438_));
  nand2  g281(.a(new_n437_), .b(new_n157_), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n438_), .c(x044), .O(z12));
  ...
  aoi21  g323(.a(new_n297_), .b(x014), .c(new_n225_), .O(new_n481_));
  ...
  nand4  g339(.a(x126), .b(new_n317_), .c(new_n298_), .d(x014), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n157_), .c(new_n498_), .O(new_n499_));
  nand3  g342(.a(x086), .b(new_n298_), .c(new_n339_), .O(new_n500_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(x084), .b(new_n157_), .O(z17));
  nor2   g372(.a(x084), .b(new_n157_), .O(z18));
  nor2   g373(.a(x084), .b(new_n157_), .O(z19));
  nor2   g374(.a(x084), .b(new_n157_), .O(z21));
  nor2   g375(.a(x084), .b(new_n157_), .O(z23));
  nor2   g376(.a(x084), .b(new_n157_), .O(z24));
  nor2   g377(.a(x084), .b(new_n157_), .O(z27));
endmodule
