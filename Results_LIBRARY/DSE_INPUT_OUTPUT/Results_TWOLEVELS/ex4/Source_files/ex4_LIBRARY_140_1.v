...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x104), .O(z18));
  ...
  oai22  g199(.a(new_n356_), .b(x024), .c(new_n168_), .d(new_n162_), .O(new_n357_));
  ...
  oai21  g205(.a(new_n362_), .b(new_n360_), .c(new_n169_), .O(new_n363_));
  oai21  g206(.a(new_n359_), .b(x112), .c(x032), .O(new_n364_));
  nand2  g207(.a(new_n364_), .b(x104), .O(new_n365_));
  inv1   g208(.a(x112), .O(new_n366_));
  oai21  g209(.a(new_n358_), .b(x056), .c(new_n366_), .O(new_n367_));
  inv1   g210(.a(x104), .O(new_n368_));
  nand3  g211(.a(x120), .b(new_n368_), .c(new_n168_), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(new_n161_), .O(new_n370_));
  aoi21  g213(.a(new_n367_), .b(new_n163_), .c(new_n370_), .O(new_n371_));
  nand4  g214(.a(new_n371_), .b(new_n365_), .c(new_n363_), .d(new_n357_), .O(new_n372_));
  nand4  g215(.a(x120), .b(new_n354_), .c(new_n163_), .d(x008), .O(new_n373_));
  ...
  nand3  g223(.a(new_n356_), .b(new_n161_), .c(new_n164_), .O(new_n381_));
  aoi21  g224(.a(new_n381_), .b(new_n380_), .c(new_n169_), .O(new_n382_));
  oai21  g225(.a(new_n355_), .b(new_n354_), .c(x024), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n168_), .c(new_n361_), .O(new_n384_));
  nand2  g227(.a(new_n359_), .b(new_n358_), .O(new_n385_));
  ...
  oai21  g234(.a(new_n391_), .b(new_n356_), .c(x032), .O(new_n392_));
  aoi21  g235(.a(new_n392_), .b(new_n389_), .c(x080), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n382_), .c(new_n165_), .O(new_n394_));
  nand3  g237(.a(new_n362_), .b(new_n161_), .c(new_n164_), .O(new_n395_));
  ...
  oai22  g320(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n478_));
  inv1   g321(.a(x102), .O(new_n479_));
  aoi21  g322(.a(new_n157_), .b(new_n479_), .c(x094), .O(new_n480_));
  nand2  g323(.a(new_n308_), .b(new_n307_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n480_), .c(new_n333_), .O(new_n482_));
  oai21  g325(.a(new_n157_), .b(x110), .c(x038), .O(new_n483_));
  ...
  nand2  g342(.a(new_n157_), .b(new_n479_), .O(new_n500_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(new_n157_), .b(x104), .O(z27));
endmodule
