...
module FAU ( 
  ...
  oai21  g265(.a(new_n422_), .b(x043), .c(new_n159_), .O(z11));
  ...
  aoi21  g317(.a(x070), .b(x038), .c(new_n298_), .O(new_n475_));
  nand2  g318(.a(new_n304_), .b(x030), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n341_), .c(x086), .O(new_n477_));
  oai22  g320(.a(new_n477_), .b(new_n475_), .c(x118), .d(x110), .O(new_n478_));
  nand3  g321(.a(new_n326_), .b(x070), .c(x030), .O(new_n479_));
  nand3  g322(.a(x102), .b(new_n316_), .c(x006), .O(new_n480_));
  ...
  oai21  g327(.a(x086), .b(new_n334_), .c(new_n484_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n337_), .O(new_n486_));
  nor2   g329(.a(x126), .b(x102), .O(new_n487_));
  nand4  g330(.a(new_n483_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n488_));
  inv1   g331(.a(x094), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(new_n334_), .c(x006), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n488_), .c(new_n487_), .O(new_n491_));
  oai21  g334(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n302_), .O(new_n493_));
  oai22  g336(.a(new_n309_), .b(x110), .c(new_n489_), .d(x062), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(x126), .O(new_n495_));
  aoi21  g338(.a(x030), .b(new_n299_), .c(x086), .O(new_n496_));
  nand3  g339(.a(new_n496_), .b(new_n495_), .c(new_n493_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(x006), .c(new_n491_), .O(new_n498_));
  nand4  g341(.a(new_n498_), .b(new_n486_), .c(new_n482_), .d(new_n478_), .O(new_n499_));
  nand2  g342(.a(x038), .b(x014), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(x070), .c(x022), .O(new_n501_));
  oai22  g344(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n502_));
  nand2  g345(.a(new_n502_), .b(new_n299_), .O(new_n503_));
  nand2  g346(.a(x030), .b(new_n302_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n330_), .c(x086), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(x054), .c(x038), .O(new_n506_));
  nand4  g349(.a(new_n506_), .b(new_n503_), .c(new_n501_), .d(new_n157_), .O(new_n507_));
  aoi21  g350(.a(new_n499_), .b(new_n300_), .c(new_n507_), .O(new_n508_));
  nor2   g351(.a(new_n508_), .b(x046), .O(z14));
  zero   g352(.O(z07));
  zero   g353(.O(z15));
  zero   g354(.O(z17));
  zero   g355(.O(z18));
