...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x018), .O(z07));
  ...
  nand2  g042(.a(new_n198_), .b(new_n193_), .O(new_n199_));
  aoi22  g043(.a(new_n197_), .b(new_n194_), .c(new_n196_), .d(new_n195_), .O(new_n200_));
  oai21  g044(.a(new_n199_), .b(x002), .c(new_n200_), .O(new_n201_));
  nand2  g045(.a(new_n201_), .b(new_n174_), .O(new_n202_));
  inv1   g046(.a(x018), .O(new_n203_));
  inv1   g047(.a(x066), .O(new_n204_));
  oai22  g048(.a(new_n197_), .b(new_n195_), .c(new_n196_), .d(new_n194_), .O(new_n205_));
  nand4  g049(.a(new_n205_), .b(new_n172_), .c(new_n204_), .d(new_n203_), .O(new_n206_));
  aoi21  g050(.a(new_n206_), .b(new_n202_), .c(new_n192_), .O(z02));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(new_n203_), .O(new_n304_));
  ...
  aoi21  g197(.a(new_n349_), .b(x018), .c(new_n353_), .O(new_n354_));
  ...
  nand3  g247(.a(new_n403_), .b(new_n174_), .c(new_n356_), .O(new_n404_));
  ...
  nand3  g256(.a(new_n412_), .b(new_n174_), .c(new_n406_), .O(new_n413_));
  ...
  nand2  g262(.a(new_n418_), .b(new_n174_), .O(new_n419_));
  ...
  oai21  g273(.a(new_n429_), .b(x043), .c(new_n174_), .O(z11));
  ...
  aoi21  g323(.a(new_n297_), .b(x014), .c(new_n203_), .O(new_n480_));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(new_n172_), .b(x018), .O(z17));
  nor2   g374(.a(new_n172_), .b(x018), .O(z19));
  nor2   g375(.a(new_n172_), .b(x018), .O(z22));
  nor2   g376(.a(new_n172_), .b(x018), .O(z23));
  nor2   g377(.a(new_n172_), .b(x018), .O(z24));
endmodule
