...
module FAU ( 
  ...
  inv1   g316(.a(x118), .O(new_n474_));
  oai21  g317(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n475_));
  nand2  g318(.a(new_n301_), .b(x030), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n299_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n312_), .O(new_n478_));
  aoi22  g321(.a(new_n478_), .b(new_n475_), .c(new_n474_), .d(new_n314_), .O(new_n479_));
  nand3  g322(.a(new_n312_), .b(x070), .c(x030), .O(new_n480_));
  nand3  g323(.a(x102), .b(new_n305_), .c(x006), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n480_), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n304_), .O(new_n483_));
  nand2  g326(.a(new_n325_), .b(x006), .O(new_n484_));
  oai21  g327(.a(x086), .b(new_n306_), .c(new_n484_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n329_), .O(new_n486_));
  nand4  g329(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n487_));
  nand3  g330(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n487_), .O(new_n489_));
  oai21  g332(.a(x126), .b(x102), .c(new_n489_), .O(new_n490_));
  nand2  g333(.a(x126), .b(new_n474_), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n298_), .c(x022), .O(new_n492_));
  nand2  g335(.a(x030), .b(new_n343_), .O(new_n493_));
  nand3  g336(.a(x126), .b(x094), .c(new_n305_), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n493_), .c(new_n312_), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n492_), .c(x006), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n490_), .c(new_n486_), .d(new_n483_), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(new_n479_), .c(new_n340_), .O(new_n498_));
  nand3  g341(.a(x126), .b(new_n314_), .c(x038), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n312_), .c(new_n297_), .O(new_n500_));
  nand3  g343(.a(new_n312_), .b(x038), .c(x030), .O(new_n501_));
  oai21  g344(.a(new_n306_), .b(new_n336_), .c(new_n501_), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n500_), .c(new_n343_), .O(new_n503_));
  nand2  g346(.a(x030), .b(new_n336_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n323_), .c(x086), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(x054), .c(x038), .O(new_n506_));
  nand3  g349(.a(x070), .b(new_n304_), .c(x022), .O(new_n507_));
  nand4  g350(.a(new_n507_), .b(new_n506_), .c(new_n503_), .d(new_n498_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n172_), .c(new_n473_), .O(new_n509_));
  inv1   g352(.a(new_n509_), .O(z14));
  zero   g353(.O(z07));
  zero   g354(.O(z18));
  zero   g355(.O(z21));
  zero   g356(.O(z23));
  zero   g357(.O(z24));
  zero   g358(.O(z25));
  nor2   g359(.a(new_n172_), .b(x046), .O(z16));
  nor2   g360(.a(new_n172_), .b(x046), .O(z17));
  nor2   g361(.a(new_n172_), .b(x046), .O(z19));
  nor2   g362(.a(new_n172_), .b(x046), .O(z20));
