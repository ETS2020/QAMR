// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:01 2020
...
module FAU ( 
  ...
  oai21  g230(.a(new_n386_), .b(new_n383_), .c(new_n166_), .O(new_n387_));
  ...
  nand3  g319(.a(new_n475_), .b(new_n160_), .c(new_n435_), .O(new_n476_));
  inv1   g320(.a(new_n476_), .O(z13));
  nand2  g321(.a(x022), .b(x014), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x030), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n330_), .c(x086), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(x054), .c(new_n157_), .O(new_n481_));
  oai21  g325(.a(x124), .b(new_n299_), .c(new_n481_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x038), .O(new_n483_));
  aoi21  g327(.a(x070), .b(x038), .c(new_n298_), .O(new_n484_));
  nand2  g328(.a(new_n303_), .b(x030), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n301_), .c(x086), .O(new_n486_));
  oai22  g330(.a(new_n486_), .b(new_n484_), .c(x118), .d(x110), .O(new_n487_));
  nand3  g331(.a(new_n326_), .b(x070), .c(x030), .O(new_n488_));
  nand3  g332(.a(x102), .b(new_n315_), .c(x006), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n488_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n312_), .O(new_n491_));
  nand2  g335(.a(new_n478_), .b(x006), .O(new_n492_));
  oai21  g336(.a(x086), .b(new_n334_), .c(new_n492_), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n338_), .O(new_n494_));
  nor2   g338(.a(x126), .b(x102), .O(new_n495_));
  nand4  g339(.a(new_n478_), .b(new_n303_), .c(new_n326_), .d(x030), .O(new_n496_));
  inv1   g340(.a(x094), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n334_), .c(x006), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n496_), .c(new_n495_), .O(new_n499_));
  oai21  g343(.a(new_n317_), .b(x118), .c(new_n300_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n335_), .O(new_n501_));
  oai22  g345(.a(new_n308_), .b(x110), .c(new_n497_), .d(x062), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(x126), .O(new_n503_));
  aoi21  g347(.a(x030), .b(new_n322_), .c(x086), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n503_), .c(new_n501_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(x006), .c(new_n499_), .O(new_n506_));
  nand4  g350(.a(new_n506_), .b(new_n494_), .c(new_n491_), .d(new_n487_), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n299_), .O(new_n508_));
  oai22  g352(.a(new_n326_), .b(new_n298_), .c(new_n334_), .d(new_n335_), .O(new_n509_));
  nor2   g353(.a(new_n334_), .b(x038), .O(new_n510_));
  aoi22  g354(.a(new_n510_), .b(x022), .c(new_n509_), .d(new_n322_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n508_), .O(new_n512_));
  nand3  g356(.a(x070), .b(new_n299_), .c(x022), .O(new_n513_));
  nand3  g357(.a(x086), .b(new_n312_), .c(x006), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n513_), .c(new_n322_), .O(new_n515_));
