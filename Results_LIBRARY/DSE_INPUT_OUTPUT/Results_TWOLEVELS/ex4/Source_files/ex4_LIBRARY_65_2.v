...
module FAU ( 
  ...
  oai21  g149(.a(new_n301_), .b(x014), .c(new_n305_), .O(new_n306_));
  nand2  g150(.a(new_n306_), .b(new_n300_), .O(new_n307_));
  nand2  g151(.a(x094), .b(x062), .O(new_n308_));
  oai21  g152(.a(new_n304_), .b(new_n172_), .c(new_n308_), .O(new_n309_));
  aoi21  g153(.a(new_n309_), .b(new_n307_), .c(new_n299_), .O(new_n310_));
  nor2   g154(.a(z07), .b(x054), .O(new_n311_));
  oai21  g155(.a(new_n311_), .b(new_n310_), .c(new_n298_), .O(new_n312_));
  nand2  g156(.a(x118), .b(x110), .O(new_n313_));
  inv1   g157(.a(x070), .O(new_n314_));
  aoi21  g158(.a(new_n314_), .b(new_n298_), .c(x006), .O(new_n315_));
  oai21  g159(.a(x094), .b(x062), .c(new_n300_), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(x022), .c(new_n299_), .O(new_n317_));
  oai21  g161(.a(new_n317_), .b(new_n315_), .c(new_n313_), .O(new_n318_));
  inv1   g162(.a(x102), .O(new_n319_));
  aoi22  g163(.a(x094), .b(x038), .c(x070), .d(x062), .O(new_n320_));
  inv1   g164(.a(x062), .O(new_n321_));
  inv1   g165(.a(x094), .O(new_n322_));
  nand2  g166(.a(new_n322_), .b(new_n321_), .O(new_n323_));
  nand4  g167(.a(new_n323_), .b(x086), .c(new_n300_), .d(x014), .O(new_n324_));
  oai21  g168(.a(new_n320_), .b(x006), .c(new_n324_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n319_), .O(new_n326_));
  inv1   g170(.a(x006), .O(new_n327_));
  nand2  g171(.a(x014), .b(new_n327_), .O(new_n328_));
  nand2  g172(.a(x086), .b(new_n314_), .O(new_n329_));
  oai21  g173(.a(new_n329_), .b(new_n301_), .c(new_n328_), .O(new_n330_));
  nand2  g174(.a(new_n329_), .b(new_n328_), .O(new_n331_));
  aoi22  g175(.a(new_n331_), .b(new_n308_), .c(new_n330_), .d(new_n300_), .O(new_n332_));
  nand3  g176(.a(new_n332_), .b(new_n326_), .c(new_n318_), .O(new_n333_));
  nand2  g177(.a(new_n314_), .b(new_n301_), .O(new_n334_));
  nand2  g178(.a(new_n299_), .b(new_n327_), .O(new_n335_));
  aoi21  g179(.a(new_n335_), .b(new_n334_), .c(new_n172_), .O(new_n336_));
  aoi21  g180(.a(new_n333_), .b(x054), .c(new_n336_), .O(new_n337_));
  nand3  g181(.a(new_n314_), .b(x054), .c(new_n301_), .O(new_n338_));
  nand3  g182(.a(new_n299_), .b(x038), .c(new_n327_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n338_), .O(new_n340_));
  nand2  g184(.a(new_n340_), .b(new_n302_), .O(new_n341_));
  oai21  g185(.a(new_n337_), .b(new_n302_), .c(new_n341_), .O(new_n342_));
  oai21  g186(.a(new_n301_), .b(x006), .c(new_n329_), .O(new_n343_));
  nand2  g187(.a(new_n343_), .b(new_n308_), .O(new_n344_));
  oai21  g188(.a(new_n303_), .b(new_n300_), .c(new_n327_), .O(new_n345_));
  nand2  g189(.a(x126), .b(x102), .O(new_n346_));
  nand4  g190(.a(new_n346_), .b(new_n323_), .c(x086), .d(new_n300_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n345_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(x022), .O(new_n349_));
  nand2  g193(.a(new_n313_), .b(x086), .O(new_n350_));
  nand2  g194(.a(x094), .b(x070), .O(new_n351_));
  nand2  g195(.a(new_n322_), .b(x062), .O(new_n352_));
  aoi21  g196(.a(new_n352_), .b(new_n351_), .c(x126), .O(new_n353_));
  oai21  g197(.a(new_n353_), .b(new_n299_), .c(new_n327_), .O(new_n354_));
  nand4  g198(.a(new_n354_), .b(new_n350_), .c(new_n349_), .d(new_n344_), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(x054), .O(new_n356_));
  nor2   g200(.a(x070), .b(new_n298_), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n301_), .c(new_n302_), .O(new_n358_));
  aoi21  g202(.a(new_n358_), .b(new_n356_), .c(x014), .O(new_n359_));
  aoi21  g203(.a(new_n342_), .b(x126), .c(new_n359_), .O(new_n360_));
  aoi21  g204(.a(new_n360_), .b(new_n312_), .c(new_n297_), .O(z06));
  ...
  nand3  g220(.a(x120), .b(new_n371_), .c(new_n165_), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n158_), .O(new_n378_));
  aoi21  g222(.a(new_n376_), .b(new_n160_), .c(new_n378_), .O(new_n379_));
  ...
  oai21  g231(.a(new_n387_), .b(x072), .c(new_n159_), .O(new_n388_));
  nand2  g232(.a(new_n388_), .b(new_n372_), .O(new_n389_));
  nand2  g233(.a(x024), .b(new_n165_), .O(new_n390_));
  aoi21  g234(.a(new_n390_), .b(new_n364_), .c(new_n166_), .O(new_n391_));
  nand2  g235(.a(new_n368_), .b(new_n367_), .O(new_n392_));
  nand4  g236(.a(new_n386_), .b(new_n392_), .c(new_n362_), .d(x024), .O(new_n393_));
  inv1   g237(.a(new_n393_), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n391_), .c(new_n162_), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n389_), .c(x048), .O(new_n396_));
  nand2  g240(.a(new_n362_), .b(x024), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(new_n364_), .O(new_n398_));
  nand3  g242(.a(new_n398_), .b(new_n162_), .c(x032), .O(new_n399_));
  inv1   g243(.a(new_n399_), .O(new_n400_));
  oai21  g244(.a(new_n400_), .b(new_n396_), .c(new_n158_), .O(new_n401_));
  ...
  aoi21  g249(.a(new_n385_), .b(x000), .c(new_n405_), .O(new_n406_));
  oai21  g250(.a(new_n406_), .b(x040), .c(new_n174_), .O(z08));
  ...
  oai21  g258(.a(new_n414_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai21  g305(.a(new_n284_), .b(new_n242_), .c(new_n244_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n276_), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n243_), .c(new_n445_), .O(new_n464_));
  nor2   g308(.a(new_n242_), .b(x021), .O(new_n465_));
  oai21  g309(.a(new_n465_), .b(new_n280_), .c(x069), .O(new_n466_));
  nand2  g310(.a(new_n260_), .b(new_n450_), .O(new_n467_));
  nand4  g311(.a(new_n467_), .b(new_n442_), .c(new_n246_), .d(x029), .O(new_n468_));
  ...
  nand2  g326(.a(x086), .b(new_n298_), .O(new_n483_));
  inv1   g327(.a(x054), .O(new_n484_));
  inv1   g328(.a(x118), .O(new_n485_));
  nand4  g329(.a(x126), .b(new_n485_), .c(new_n302_), .d(new_n484_), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n483_), .c(x014), .O(new_n487_));
  nor3   g331(.a(x126), .b(x054), .c(x038), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n357_), .c(x102), .O(new_n489_));
  nor2   g333(.a(x118), .b(x110), .O(new_n490_));
  aoi21  g334(.a(x070), .b(x038), .c(new_n490_), .O(new_n491_));
  oai22  g335(.a(x110), .b(x022), .c(x070), .d(x062), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(x126), .O(new_n493_));
  oai21  g337(.a(x094), .b(x030), .c(new_n303_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n493_), .c(new_n352_), .d(new_n299_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n491_), .c(new_n484_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n489_), .c(x078), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n487_), .c(x006), .O(new_n498_));
  nand2  g342(.a(x126), .b(new_n172_), .O(new_n499_));
  nand2  g343(.a(new_n303_), .b(x102), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(new_n490_), .O(new_n501_));
  nand3  g345(.a(x126), .b(new_n321_), .c(new_n301_), .O(new_n502_));
  nand2  g346(.a(new_n303_), .b(x070), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  aoi21  g348(.a(new_n501_), .b(new_n308_), .c(new_n504_), .O(new_n505_));
  nor2   g349(.a(new_n490_), .b(new_n301_), .O(new_n506_));
  aoi21  g350(.a(new_n323_), .b(x070), .c(new_n506_), .O(new_n507_));
  oai21  g351(.a(new_n505_), .b(new_n300_), .c(new_n507_), .O(new_n508_));
  nand3  g352(.a(new_n322_), .b(x030), .c(new_n301_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n490_), .c(new_n172_), .O(new_n510_));
  aoi21  g354(.a(new_n508_), .b(new_n302_), .c(new_n510_), .O(new_n511_));
  nand2  g355(.a(new_n303_), .b(x030), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n322_), .c(new_n321_), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n302_), .c(x038), .O(new_n514_));
  oai21  g358(.a(new_n511_), .b(x054), .c(new_n514_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n299_), .O(new_n516_));
  ...
  and2   g363(.a(new_n519_), .b(new_n518_), .O(new_n520_));
  nand3  g364(.a(new_n520_), .b(new_n516_), .c(new_n498_), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n297_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n174_), .O(z14));
  zero   g367(.O(z15));
  zero   g368(.O(z18));
  zero   g369(.O(z19));
  zero   g370(.O(z22));
  ...
  nor2   g374(.a(x126), .b(new_n172_), .O(z20));
  nor2   g375(.a(x126), .b(new_n172_), .O(z21));
