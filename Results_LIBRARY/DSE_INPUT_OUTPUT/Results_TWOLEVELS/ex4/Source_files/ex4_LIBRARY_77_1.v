// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:28 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x078), .O(z18));
  ...
  nor2   g156(.a(x089), .b(x054), .O(new_n313_));
  ...
  oai22  g287(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n445_));
  inv1   g288(.a(x101), .O(new_n446_));
  aoi21  g289(.a(new_n260_), .b(new_n446_), .c(x093), .O(new_n447_));
  nand2  g290(.a(new_n251_), .b(new_n250_), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(new_n447_), .c(new_n277_), .O(new_n449_));
  oai21  g292(.a(new_n260_), .b(x109), .c(x037), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(x117), .O(new_n451_));
  oai21  g294(.a(new_n446_), .b(x061), .c(new_n250_), .O(new_n452_));
  ...
  oai21  g313(.a(new_n470_), .b(new_n466_), .c(new_n276_), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n464_), .c(x053), .O(new_n472_));
  oai21  g315(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n473_));
  ...
  oai21  g319(.a(new_n476_), .b(new_n472_), .c(new_n268_), .O(new_n477_));
  ...
  oai22  g326(.a(new_n322_), .b(x030), .c(new_n307_), .d(new_n324_), .O(new_n484_));
  aoi21  g327(.a(new_n302_), .b(new_n329_), .c(x094), .O(new_n485_));
  nand2  g328(.a(new_n316_), .b(new_n315_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n485_), .c(new_n317_), .O(new_n487_));
  oai21  g330(.a(new_n302_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x118), .O(new_n489_));
  oai21  g332(.a(new_n329_), .b(x062), .c(new_n315_), .O(new_n490_));
  nand3  g333(.a(x126), .b(new_n316_), .c(new_n307_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n300_), .O(new_n492_));
  ...
  nand4  g337(.a(x126), .b(new_n320_), .c(new_n298_), .d(x014), .O(new_n495_));
  inv1   g338(.a(new_n495_), .O(new_n496_));
  aoi21  g339(.a(new_n494_), .b(new_n299_), .c(new_n496_), .O(new_n497_));
  nand3  g340(.a(x086), .b(new_n298_), .c(new_n324_), .O(new_n498_));
  oai21  g341(.a(new_n497_), .b(x054), .c(new_n498_), .O(new_n499_));
  aoi21  g342(.a(new_n308_), .b(x030), .c(x022), .O(new_n500_));
  ...
  nand2  g346(.a(x030), .b(new_n307_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n503_), .c(new_n317_), .O(new_n505_));
  nand2  g348(.a(new_n302_), .b(new_n329_), .O(new_n506_));
  ...
  oai21  g352(.a(new_n509_), .b(new_n505_), .c(new_n299_), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n502_), .c(x054), .O(new_n511_));
  oai21  g354(.a(new_n325_), .b(new_n319_), .c(new_n503_), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n299_), .c(x038), .O(new_n513_));
  inv1   g356(.a(new_n513_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n511_), .c(new_n300_), .O(new_n515_));
  ...
  nor2   g372(.a(new_n172_), .b(x078), .O(z20));
  nor2   g373(.a(new_n172_), .b(x078), .O(z21));
  nor2   g374(.a(new_n172_), .b(x078), .O(z22));
