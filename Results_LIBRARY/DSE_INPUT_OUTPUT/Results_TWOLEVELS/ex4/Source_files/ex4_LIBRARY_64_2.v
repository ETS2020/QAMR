...
module FAU ( 
  ...
  aoi21  g141(.a(x046), .b(new_n297_), .c(x059), .O(new_n298_));
  ...
  nand4  g219(.a(x120), .b(new_n356_), .c(new_n163_), .d(x008), .O(new_n376_));
  ...
  aoi21  g229(.a(new_n385_), .b(new_n162_), .c(new_n364_), .O(new_n386_));
  ...
  oai21  g235(.a(new_n391_), .b(new_n386_), .c(new_n164_), .O(new_n392_));
  ...
  nand3  g245(.a(new_n401_), .b(new_n159_), .c(new_n354_), .O(new_n402_));
  ...
  oai21  g272(.a(new_n428_), .b(x043), .c(new_n159_), .O(z11));
  ...
  oai21  g280(.a(new_n436_), .b(x044), .c(new_n159_), .O(z12));
  ...
  nand3  g320(.a(new_n476_), .b(new_n159_), .c(new_n438_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  nor2   g322(.a(new_n302_), .b(new_n297_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n301_), .c(new_n330_), .O(new_n480_));
  nand3  g324(.a(new_n480_), .b(new_n326_), .c(new_n334_), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n300_), .c(x059), .O(new_n482_));
  ...
  nand2  g342(.a(x086), .b(new_n297_), .O(new_n499_));
  ...
  nand3  g363(.a(new_n519_), .b(new_n518_), .c(new_n297_), .O(new_n520_));
  and2   g364(.a(new_n520_), .b(x078), .O(new_n521_));
  aoi21  g365(.a(new_n517_), .b(new_n157_), .c(new_n521_), .O(new_n522_));
  ...
  zero   g374(.O(z24));
  zero   g375(.O(z26));
  nor2   g376(.a(x078), .b(new_n157_), .O(z18));
  nor2   g377(.a(x078), .b(new_n157_), .O(z20));
  nor2   g378(.a(x078), .b(new_n157_), .O(z25));
  nor2   g379(.a(x078), .b(new_n157_), .O(z27));
endmodule
