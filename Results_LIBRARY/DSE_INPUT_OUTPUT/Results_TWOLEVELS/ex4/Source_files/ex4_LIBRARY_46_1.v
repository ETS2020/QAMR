// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:27 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x039), .O(z19));
  inv1   g002(.a(z19), .O(new_n159_));
  ...
  inv1   g171(.a(x039), .O(new_n328_));
  oai21  g172(.a(x102), .b(new_n328_), .c(x126), .O(new_n329_));
  nand3  g173(.a(new_n329_), .b(new_n327_), .c(x086), .O(new_n330_));
  nand2  g174(.a(x039), .b(new_n298_), .O(new_n331_));
  aoi21  g175(.a(new_n331_), .b(new_n330_), .c(x030), .O(new_n332_));
  nand3  g176(.a(new_n309_), .b(x039), .c(new_n298_), .O(new_n333_));
  inv1   g177(.a(new_n333_), .O(new_n334_));
  oai21  g178(.a(new_n334_), .b(new_n332_), .c(x054), .O(new_n335_));
  inv1   g179(.a(x030), .O(new_n336_));
  nand4  g180(.a(x086), .b(x039), .c(new_n312_), .d(new_n336_), .O(new_n337_));
  nand2  g181(.a(new_n337_), .b(new_n335_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n325_), .O(new_n339_));
  nand4  g183(.a(x086), .b(new_n308_), .c(x039), .d(new_n336_), .O(new_n340_));
  nand3  g184(.a(new_n157_), .b(x118), .c(new_n298_), .O(new_n341_));
  ...
  oai21  g190(.a(new_n345_), .b(new_n312_), .c(new_n346_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n344_), .O(new_n348_));
  oai21  g192(.a(x070), .b(x038), .c(new_n305_), .O(new_n349_));
  aoi21  g193(.a(new_n349_), .b(new_n348_), .c(x006), .O(new_n350_));
  nand4  g194(.a(new_n327_), .b(new_n305_), .c(x086), .d(new_n336_), .O(new_n351_));
  inv1   g195(.a(new_n351_), .O(new_n352_));
  oai21  g196(.a(new_n352_), .b(new_n350_), .c(x039), .O(new_n353_));
  inv1   g197(.a(x118), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(x110), .O(new_n355_));
  nand3  g199(.a(new_n355_), .b(new_n346_), .c(new_n302_), .O(new_n356_));
  nand3  g200(.a(new_n356_), .b(new_n157_), .c(new_n298_), .O(new_n357_));
  nand3  g201(.a(new_n357_), .b(new_n353_), .c(new_n343_), .O(new_n358_));
  nand2  g202(.a(new_n358_), .b(x054), .O(new_n359_));
  nand2  g203(.a(new_n359_), .b(new_n339_), .O(new_n360_));
  nand3  g204(.a(x038), .b(new_n324_), .c(new_n298_), .O(new_n361_));
  nor4   g205(.a(new_n361_), .b(x126), .c(new_n345_), .d(new_n300_), .O(new_n362_));
  aoi21  g206(.a(new_n360_), .b(x078), .c(new_n362_), .O(new_n363_));
  aoi21  g207(.a(new_n363_), .b(new_n323_), .c(new_n297_), .O(z06));
  ...
  oai21  g213(.a(new_n370_), .b(x024), .c(new_n367_), .O(new_n371_));
  nor2   g214(.a(x120), .b(x096), .O(new_n372_));
  nor2   g215(.a(x112), .b(x104), .O(new_n373_));
  oai21  g216(.a(new_n372_), .b(x088), .c(new_n373_), .O(new_n374_));
  nand2  g217(.a(new_n374_), .b(new_n169_), .O(new_n375_));
  inv1   g218(.a(x120), .O(new_n376_));
  oai21  g219(.a(new_n376_), .b(x104), .c(x032), .O(new_n377_));
  nand2  g220(.a(new_n377_), .b(x112), .O(new_n378_));
  inv1   g221(.a(x096), .O(new_n379_));
  inv1   g222(.a(x104), .O(new_n380_));
  oai21  g223(.a(new_n379_), .b(x056), .c(new_n380_), .O(new_n381_));
  inv1   g224(.a(x112), .O(new_n382_));
  nand3  g225(.a(x120), .b(new_n382_), .c(new_n168_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n161_), .O(new_n384_));
  aoi21  g227(.a(new_n381_), .b(new_n163_), .c(new_n384_), .O(new_n385_));
  nand4  g228(.a(new_n385_), .b(new_n378_), .c(new_n375_), .d(new_n371_), .O(new_n386_));
  nand4  g229(.a(x120), .b(new_n368_), .c(new_n163_), .d(x008), .O(new_n387_));
  inv1   g230(.a(new_n387_), .O(new_n388_));
  aoi21  g231(.a(new_n386_), .b(new_n165_), .c(new_n388_), .O(new_n389_));
  nand3  g232(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n390_));
  oai21  g233(.a(new_n389_), .b(x048), .c(new_n390_), .O(new_n391_));
  nand2  g234(.a(new_n391_), .b(x000), .O(new_n392_));
  nand2  g235(.a(x088), .b(x056), .O(new_n393_));
  nand2  g236(.a(new_n393_), .b(x024), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(new_n168_), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n165_), .O(new_n396_));
  aoi21  g239(.a(new_n396_), .b(new_n162_), .c(new_n373_), .O(new_n397_));
  inv1   g240(.a(x024), .O(new_n398_));
  nor2   g241(.a(new_n398_), .b(x016), .O(new_n399_));
  oai21  g242(.a(new_n399_), .b(new_n370_), .c(x064), .O(new_n400_));
  inv1   g243(.a(new_n372_), .O(new_n401_));
  nand4  g244(.a(new_n393_), .b(new_n401_), .c(new_n367_), .d(x024), .O(new_n402_));
  aoi21  g245(.a(new_n402_), .b(new_n400_), .c(x072), .O(new_n403_));
  oai21  g246(.a(new_n403_), .b(new_n397_), .c(new_n164_), .O(new_n404_));
  nand2  g247(.a(new_n367_), .b(x024), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(new_n369_), .c(new_n368_), .O(new_n406_));
  nand3  g249(.a(new_n406_), .b(new_n165_), .c(x032), .O(new_n407_));
  nand2  g250(.a(new_n407_), .b(new_n404_), .O(new_n408_));
  oai22  g251(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n409_));
  nand3  g252(.a(new_n409_), .b(x064), .c(x016), .O(new_n410_));
  aoi22  g253(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n410_), .O(new_n412_));
  aoi21  g255(.a(new_n408_), .b(new_n161_), .c(new_n412_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n392_), .O(new_n414_));
  nand3  g257(.a(new_n414_), .b(new_n159_), .c(new_n366_), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(z08));
  inv1   g259(.a(x041), .O(new_n417_));
  ...
  nand3  g266(.a(new_n423_), .b(new_n159_), .c(new_n417_), .O(new_n424_));
  inv1   g267(.a(new_n424_), .O(z09));
  oai22  g268(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n426_));
  nand3  g269(.a(new_n426_), .b(x082), .c(x002), .O(new_n427_));
  oai22  g270(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(x066), .c(x018), .O(new_n429_));
  aoi22  g272(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n430_));
  nand3  g273(.a(new_n430_), .b(new_n429_), .c(new_n427_), .O(new_n431_));
  inv1   g274(.a(new_n431_), .O(new_n432_));
  oai21  g275(.a(new_n432_), .b(x042), .c(new_n159_), .O(z10));
  inv1   g276(.a(x043), .O(new_n434_));
  oai22  g277(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n435_));
  nand3  g278(.a(new_n435_), .b(x083), .c(x003), .O(new_n436_));
  oai22  g279(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n437_));
  nand3  g280(.a(new_n437_), .b(x067), .c(x019), .O(new_n438_));
  aoi22  g281(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n439_));
  nand3  g282(.a(new_n439_), .b(new_n438_), .c(new_n436_), .O(new_n440_));
  nand3  g283(.a(new_n440_), .b(new_n159_), .c(new_n434_), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(z11));
  oai22  g285(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n443_));
  nand3  g286(.a(new_n443_), .b(x084), .c(x004), .O(new_n444_));
  oai22  g287(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(x068), .c(x020), .O(new_n446_));
  aoi22  g289(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n447_));
  nand3  g290(.a(new_n447_), .b(new_n446_), .c(new_n444_), .O(new_n448_));
  inv1   g291(.a(new_n448_), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(x044), .c(new_n159_), .O(z12));
  oai22  g293(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n451_));
  inv1   g294(.a(x101), .O(new_n452_));
  aoi21  g295(.a(new_n260_), .b(new_n452_), .c(x093), .O(new_n453_));
  nand2  g296(.a(new_n251_), .b(new_n250_), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(new_n453_), .c(new_n277_), .O(new_n455_));
  oai21  g298(.a(new_n260_), .b(x109), .c(x037), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(x117), .O(new_n457_));
  oai21  g300(.a(new_n452_), .b(x061), .c(new_n250_), .O(new_n458_));
  nand3  g301(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n268_), .O(new_n460_));
  aoi21  g303(.a(new_n458_), .b(new_n255_), .c(new_n460_), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n457_), .c(new_n455_), .d(new_n451_), .O(new_n462_));
  nand4  g305(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n463_));
  inv1   g306(.a(new_n463_), .O(new_n464_));
  aoi21  g307(.a(new_n462_), .b(new_n276_), .c(new_n464_), .O(new_n465_));
  nand3  g308(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n466_));
  oai21  g309(.a(new_n465_), .b(x053), .c(new_n466_), .O(new_n467_));
  aoi21  g310(.a(new_n246_), .b(x029), .c(x021), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(x077), .c(new_n243_), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n454_), .O(new_n470_));
  nand2  g313(.a(x029), .b(new_n244_), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n272_), .c(new_n277_), .O(new_n472_));
  nand2  g315(.a(new_n260_), .b(new_n452_), .O(new_n473_));
  ...
  oai21  g319(.a(new_n476_), .b(new_n472_), .c(new_n276_), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n470_), .c(x053), .O(new_n478_));
  oai21  g321(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n272_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n276_), .c(x037), .O(new_n481_));
  inv1   g324(.a(new_n481_), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n478_), .c(new_n268_), .O(new_n483_));
  ...
  oai21  g331(.a(new_n488_), .b(x045), .c(new_n159_), .O(z13));
  nand2  g332(.a(new_n312_), .b(new_n324_), .O(new_n490_));
  ...
  oai21  g337(.a(x078), .b(new_n316_), .c(new_n324_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n494_), .O(new_n496_));
  nand3  g339(.a(new_n327_), .b(new_n301_), .c(x070), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n496_), .c(x054), .O(new_n498_));
  nor3   g341(.a(new_n326_), .b(x078), .c(new_n312_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n498_), .c(new_n299_), .O(new_n500_));
  ...
  nand2  g347(.a(new_n504_), .b(new_n159_), .O(new_n505_));
  nand2  g348(.a(x022), .b(x014), .O(new_n506_));
  nand2  g349(.a(x126), .b(x039), .O(new_n507_));
  oai21  g350(.a(x126), .b(new_n344_), .c(new_n507_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n309_), .c(new_n299_), .O(new_n509_));
  nand2  g352(.a(new_n157_), .b(x006), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n509_), .c(new_n336_), .O(new_n511_));
  nor3   g354(.a(new_n326_), .b(x126), .c(new_n298_), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(new_n511_), .c(new_n300_), .O(new_n513_));
  nand4  g356(.a(new_n157_), .b(new_n299_), .c(x038), .d(x030), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n506_), .O(new_n516_));
  nand4  g359(.a(x126), .b(new_n354_), .c(x039), .d(x006), .O(new_n517_));
  nand4  g360(.a(new_n157_), .b(new_n299_), .c(x070), .d(x030), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n517_), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n316_), .O(new_n520_));
  oai22  g363(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(x102), .O(new_n522_));
  oai21  g365(.a(new_n308_), .b(new_n312_), .c(new_n494_), .O(new_n523_));
  aoi21  g366(.a(new_n523_), .b(new_n522_), .c(new_n298_), .O(new_n524_));
  nand4  g367(.a(new_n494_), .b(new_n309_), .c(new_n299_), .d(x030), .O(new_n525_));
  inv1   g368(.a(new_n525_), .O(new_n526_));
  oai21  g369(.a(new_n526_), .b(new_n524_), .c(new_n157_), .O(new_n527_));
  inv1   g370(.a(x094), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n308_), .O(new_n529_));
  nand2  g372(.a(x118), .b(new_n493_), .O(new_n530_));
  nand3  g373(.a(new_n530_), .b(new_n529_), .c(new_n490_), .O(new_n531_));
  nand4  g374(.a(new_n531_), .b(x126), .c(x039), .d(x006), .O(new_n532_));
  nand3  g375(.a(new_n532_), .b(new_n527_), .c(new_n520_), .O(new_n533_));
  nand2  g376(.a(new_n533_), .b(new_n300_), .O(new_n534_));
  nand2  g377(.a(new_n534_), .b(new_n516_), .O(new_n535_));
  nand4  g378(.a(x126), .b(new_n345_), .c(new_n300_), .d(x039), .O(new_n536_));
  nor4   g379(.a(new_n536_), .b(x038), .c(new_n324_), .d(new_n298_), .O(new_n537_));
  aoi21  g380(.a(new_n535_), .b(new_n301_), .c(new_n537_), .O(new_n538_));
  aoi21  g381(.a(new_n538_), .b(new_n505_), .c(x046), .O(z14));
  zero   g382(.O(z07));
  zero   g383(.O(z15));
  zero   g384(.O(z16));
  zero   g385(.O(z17));
  ...
  zero   g387(.O(z20));
  zero   g388(.O(z23));
  nor2   g389(.a(new_n157_), .b(x039), .O(z21));
  nor2   g390(.a(new_n157_), .b(x039), .O(z22));
  nor2   g391(.a(new_n157_), .b(x039), .O(z24));
  nor2   g392(.a(new_n157_), .b(x039), .O(z25));
  nor2   g393(.a(new_n157_), .b(x039), .O(z26));
  nor2   g394(.a(new_n157_), .b(x039), .O(z27));
endmodule
