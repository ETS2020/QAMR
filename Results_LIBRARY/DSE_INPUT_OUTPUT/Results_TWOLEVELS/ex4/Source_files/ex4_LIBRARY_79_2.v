// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:32 2020
...
module FAU ( 
  ...
  oai22  g093(.a(x125), .b(x093), .c(x101), .d(new_n249_), .O(new_n250_));
  nand2  g094(.a(new_n250_), .b(x061), .O(new_n251_));
  oai22  g095(.a(x125), .b(new_n249_), .c(x101), .d(new_n157_), .O(new_n252_));
  nand2  g096(.a(new_n252_), .b(x093), .O(new_n253_));
  nand2  g097(.a(x117), .b(x109), .O(new_n254_));
  nand2  g098(.a(new_n249_), .b(new_n157_), .O(new_n255_));
  inv1   g099(.a(x125), .O(new_n256_));
  nand3  g100(.a(new_n256_), .b(x117), .c(x021), .O(new_n257_));
  nand2  g101(.a(new_n257_), .b(x085), .O(new_n258_));
  aoi21  g102(.a(new_n255_), .b(new_n254_), .c(new_n258_), .O(new_n259_));
  nand4  g103(.a(new_n259_), .b(new_n253_), .c(new_n251_), .d(new_n248_), .O(new_n260_));
  nand4  g104(.a(new_n256_), .b(x109), .c(new_n157_), .d(x013), .O(new_n261_));
  inv1   g105(.a(new_n261_), .O(new_n262_));
  aoi21  g106(.a(new_n260_), .b(x053), .c(new_n262_), .O(new_n263_));
  inv1   g107(.a(x085), .O(new_n264_));
  nand3  g108(.a(new_n264_), .b(x037), .c(x013), .O(new_n265_));
  oai21  g109(.a(new_n263_), .b(new_n242_), .c(new_n265_), .O(new_n266_));
  nand3  g110(.a(x085), .b(x053), .c(new_n243_), .O(new_n267_));
  aoi21  g111(.a(new_n267_), .b(x021), .c(new_n157_), .O(new_n268_));
  nand3  g112(.a(new_n247_), .b(x085), .c(x053), .O(new_n269_));
  inv1   g113(.a(new_n269_), .O(new_n270_));
  oai21  g114(.a(new_n270_), .b(new_n268_), .c(new_n249_), .O(new_n271_));
  ...
  nand4  g121(.a(new_n277_), .b(new_n276_), .c(new_n246_), .d(new_n243_), .O(new_n278_));
  aoi21  g122(.a(new_n278_), .b(new_n275_), .c(new_n272_), .O(new_n279_));
  aoi21  g123(.a(new_n246_), .b(new_n243_), .c(new_n247_), .O(new_n280_));
  ...
  nand3  g128(.a(new_n254_), .b(x085), .c(x053), .O(new_n285_));
  nand2  g129(.a(new_n285_), .b(x077), .O(new_n286_));
  nand2  g130(.a(new_n286_), .b(new_n244_), .O(new_n287_));
  nor2   g131(.a(x021), .b(new_n244_), .O(new_n288_));
  nor2   g132(.a(x069), .b(new_n272_), .O(new_n289_));
  aoi22  g133(.a(new_n289_), .b(new_n288_), .c(new_n272_), .d(new_n157_), .O(new_n290_));
  nand3  g134(.a(new_n290_), .b(new_n287_), .c(new_n284_), .O(new_n291_));
  aoi21  g135(.a(new_n266_), .b(new_n241_), .c(new_n291_), .O(new_n292_));
  oai21  g136(.a(new_n292_), .b(new_n240_), .c(new_n159_), .O(z05));
  inv1   g137(.a(x014), .O(new_n294_));
  aoi21  g138(.a(x046), .b(new_n294_), .c(x037), .O(new_n295_));
  ...
  nand4  g163(.a(new_n315_), .b(x062), .c(x038), .d(new_n294_), .O(new_n320_));
  ...
  nand4  g179(.a(new_n335_), .b(new_n303_), .c(new_n300_), .d(new_n298_), .O(new_n336_));
  ...
  nand2  g183(.a(new_n300_), .b(new_n298_), .O(new_n340_));
  ...
  oai22  g187(.a(new_n331_), .b(new_n310_), .c(new_n297_), .d(new_n294_), .O(new_n344_));
  nand3  g188(.a(new_n344_), .b(new_n332_), .c(new_n299_), .O(new_n345_));
  oai21  g189(.a(x054), .b(x038), .c(new_n345_), .O(new_n346_));
  aoi21  g190(.a(new_n343_), .b(x086), .c(new_n346_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n326_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(x046), .O(new_n349_));
  oai21  g193(.a(new_n295_), .b(x078), .c(new_n349_), .O(z06));
  inv1   g194(.a(x040), .O(new_n352_));
  ...
  nand2  g206(.a(new_n363_), .b(new_n169_), .O(new_n364_));
  ...
  nand3  g212(.a(x120), .b(new_n369_), .c(new_n168_), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n161_), .O(new_n371_));
  aoi21  g214(.a(new_n368_), .b(new_n163_), .c(new_n371_), .O(new_n372_));
  nand4  g215(.a(new_n372_), .b(new_n366_), .c(new_n364_), .d(new_n357_), .O(new_n373_));
  nand4  g216(.a(x120), .b(new_n354_), .c(new_n163_), .d(x008), .O(new_n374_));
  inv1   g217(.a(new_n374_), .O(new_n375_));
  aoi21  g218(.a(new_n373_), .b(new_n165_), .c(new_n375_), .O(new_n376_));
  nand3  g219(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n377_));
  ...
  nand2  g224(.a(new_n381_), .b(new_n168_), .O(new_n382_));
  nand2  g225(.a(new_n382_), .b(new_n165_), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n162_), .c(new_n362_), .O(new_n384_));
  ...
  oai21  g232(.a(new_n389_), .b(new_n384_), .c(new_n164_), .O(new_n390_));
  nand2  g233(.a(new_n353_), .b(x024), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n355_), .c(new_n354_), .O(new_n392_));
  nand3  g235(.a(new_n392_), .b(new_n165_), .c(x032), .O(new_n393_));
  ...
  nand4  g241(.a(new_n398_), .b(new_n397_), .c(new_n395_), .d(new_n379_), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(new_n159_), .c(new_n352_), .O(new_n400_));
  inv1   g243(.a(new_n400_), .O(z08));
  ...
  oai21  g251(.a(new_n408_), .b(x041), .c(new_n159_), .O(z09));
  ...
  nand3  g259(.a(new_n416_), .b(new_n159_), .c(new_n410_), .O(new_n417_));
  ...
  oai21  g277(.a(new_n434_), .b(x044), .c(new_n159_), .O(z12));
  nor2   g278(.a(x037), .b(new_n244_), .O(new_n436_));
  nand2  g279(.a(x021), .b(x013), .O(new_n437_));
  oai21  g280(.a(new_n276_), .b(x029), .c(new_n437_), .O(new_n438_));
  inv1   g281(.a(x101), .O(new_n439_));
  aoi21  g282(.a(new_n256_), .b(new_n439_), .c(x061), .O(new_n440_));
  nor2   g283(.a(x117), .b(x109), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n440_), .c(new_n249_), .O(new_n443_));
  oai21  g286(.a(new_n256_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(x117), .O(new_n445_));
  inv1   g288(.a(x109), .O(new_n446_));
  oai21  g289(.a(new_n439_), .b(x093), .c(new_n446_), .O(new_n447_));
  inv1   g290(.a(x117), .O(new_n448_));
  nand3  g291(.a(x125), .b(new_n448_), .c(new_n245_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n264_), .O(new_n450_));
  aoi21  g293(.a(new_n447_), .b(new_n157_), .c(new_n450_), .O(new_n451_));
  nand4  g294(.a(new_n451_), .b(new_n445_), .c(new_n443_), .d(new_n438_), .O(new_n452_));
  nor2   g295(.a(new_n256_), .b(x093), .O(new_n453_));
  aoi22  g296(.a(new_n453_), .b(new_n436_), .c(new_n452_), .d(new_n242_), .O(new_n454_));
  nand3  g297(.a(x085), .b(new_n157_), .c(new_n244_), .O(new_n455_));
  oai21  g298(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  nand3  g299(.a(new_n264_), .b(new_n272_), .c(x029), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n245_), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(new_n157_), .O(new_n459_));
  nand3  g302(.a(new_n276_), .b(new_n264_), .c(new_n272_), .O(new_n460_));
  aoi21  g303(.a(new_n460_), .b(new_n459_), .c(new_n249_), .O(new_n461_));
  nand2  g304(.a(new_n247_), .b(x029), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n245_), .c(new_n441_), .O(new_n463_));
  nand2  g306(.a(new_n256_), .b(new_n439_), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n437_), .c(new_n247_), .d(x029), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n463_), .c(new_n272_), .O(new_n467_));
  nand2  g310(.a(new_n437_), .b(x029), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n273_), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(x037), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n467_), .c(x085), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n461_), .c(new_n242_), .O(new_n472_));
  nand3  g315(.a(new_n442_), .b(new_n264_), .c(new_n272_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n242_), .O(new_n474_));
  nand4  g317(.a(x069), .b(new_n272_), .c(x021), .d(new_n244_), .O(new_n475_));
  oai21  g318(.a(new_n272_), .b(new_n157_), .c(new_n475_), .O(new_n476_));
  aoi21  g319(.a(new_n474_), .b(x013), .c(new_n476_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n472_), .O(new_n478_));
  aoi21  g321(.a(new_n456_), .b(x005), .c(new_n478_), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(x045), .c(new_n159_), .O(z13));
  nor2   g323(.a(new_n299_), .b(new_n294_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n298_), .c(new_n327_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n323_), .c(new_n331_), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n297_), .c(x037), .O(new_n484_));
  nor2   g327(.a(new_n331_), .b(new_n297_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n484_), .c(x038), .O(new_n486_));
  aoi21  g329(.a(new_n327_), .b(new_n298_), .c(new_n481_), .O(new_n487_));
  ...
  nand2  g333(.a(new_n490_), .b(new_n332_), .O(new_n491_));
  oai21  g334(.a(new_n315_), .b(x110), .c(x038), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(x118), .O(new_n493_));
  inv1   g336(.a(x102), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(x062), .c(new_n305_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n310_), .O(new_n496_));
  nor2   g339(.a(new_n315_), .b(x118), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n299_), .c(x086), .O(new_n498_));
  nand4  g341(.a(new_n498_), .b(new_n496_), .c(new_n493_), .d(new_n491_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n487_), .c(new_n297_), .O(new_n500_));
  nand2  g343(.a(x086), .b(new_n294_), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n500_), .c(new_n296_), .O(new_n502_));
  aoi21  g345(.a(new_n301_), .b(x030), .c(x022), .O(new_n503_));
  or2    g346(.a(new_n503_), .b(new_n489_), .O(new_n504_));
  nor2   g347(.a(new_n298_), .b(x022), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n335_), .c(x070), .O(new_n506_));
  inv1   g349(.a(new_n488_), .O(new_n507_));
  nor2   g350(.a(new_n481_), .b(new_n339_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n507_), .c(x030), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n506_), .c(new_n504_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n323_), .c(new_n297_), .O(new_n511_));
  nand2  g354(.a(x038), .b(x014), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(x070), .c(x022), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n511_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n502_), .c(new_n331_), .O(new_n515_));
  nand4  g358(.a(x126), .b(new_n313_), .c(new_n310_), .d(x006), .O(new_n516_));
  oai21  g359(.a(new_n489_), .b(x086), .c(new_n516_), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(new_n297_), .c(x014), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n515_), .O(new_n519_));
  nand3  g362(.a(x070), .b(new_n297_), .c(x022), .O(new_n520_));
  nand3  g363(.a(x086), .b(new_n310_), .c(x006), .O(new_n521_));
  nand3  g364(.a(new_n521_), .b(new_n520_), .c(new_n294_), .O(new_n522_));
  and2   g365(.a(new_n522_), .b(x078), .O(new_n523_));
  aoi21  g366(.a(new_n519_), .b(new_n157_), .c(new_n523_), .O(new_n524_));
  aoi21  g367(.a(new_n524_), .b(new_n486_), .c(x046), .O(z14));
  zero   g368(.O(z07));
  zero   g369(.O(z18));
  zero   g370(.O(z19));
  zero   g371(.O(z21));
  ...
  zero   g374(.O(z25));
  zero   g375(.O(z26));
  nor2   g376(.a(x078), .b(new_n157_), .O(z16));
  nor2   g377(.a(x078), .b(new_n157_), .O(z17));
  nor2   g378(.a(x078), .b(new_n157_), .O(z20));
  nor2   g379(.a(x078), .b(new_n157_), .O(z22));
