...
module FAU ( 
  ...
  wire new_n158_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n471_, new_n473_, new_n474_, new_n475_, new_n476_;
  ...
  aoi21  g315(.a(x054), .b(x038), .c(x014), .O(new_n473_));
  nand3  g316(.a(x070), .b(new_n298_), .c(x022), .O(new_n474_));
  nand3  g317(.a(x086), .b(new_n312_), .c(x006), .O(new_n475_));
  nand4  g318(.a(new_n475_), .b(new_n474_), .c(new_n473_), .d(x078), .O(new_n476_));
  and2   g319(.a(new_n476_), .b(new_n296_), .O(z14));
  zero   g320(.O(z07));
  zero   g321(.O(z16));
  zero   g322(.O(z17));
  zero   g323(.O(z18));
  ...
  nor2   g330(.a(x078), .b(x046), .O(z23));
  nor2   g331(.a(x078), .b(x046), .O(z26));
  nor2   g332(.a(x078), .b(x046), .O(z27));
endmodule
