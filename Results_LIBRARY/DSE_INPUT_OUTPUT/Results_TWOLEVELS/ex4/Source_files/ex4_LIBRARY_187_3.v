...
module FAU ( 
  ...
  nand3  g204(.a(new_n361_), .b(new_n157_), .c(new_n355_), .O(new_n362_));
  ...
  nand3  g213(.a(new_n370_), .b(new_n157_), .c(new_n364_), .O(new_n371_));
  ...
  nand3  g222(.a(new_n379_), .b(new_n157_), .c(new_n373_), .O(new_n380_));
  ...
  oai21  g231(.a(new_n388_), .b(x044), .c(new_n157_), .O(z12));
  inv1   g232(.a(x045), .O(new_n390_));
  nand2  g233(.a(x021), .b(x013), .O(new_n391_));
  oai21  g234(.a(new_n278_), .b(x029), .c(new_n391_), .O(new_n392_));
  nor2   g235(.a(x125), .b(x101), .O(new_n393_));
  nor2   g236(.a(x117), .b(x109), .O(new_n394_));
  oai21  g237(.a(new_n393_), .b(x093), .c(new_n394_), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n275_), .O(new_n396_));
  oai21  g239(.a(new_n258_), .b(x109), .c(x037), .O(new_n397_));
  nand2  g240(.a(new_n397_), .b(x117), .O(new_n398_));
  inv1   g241(.a(x101), .O(new_n399_));
  oai21  g242(.a(new_n399_), .b(x061), .c(new_n248_), .O(new_n400_));
  ...
  nand4  g246(.a(new_n403_), .b(new_n398_), .c(new_n396_), .d(new_n392_), .O(new_n404_));
  ...
  nand2  g253(.a(new_n244_), .b(x029), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n242_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n274_), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n241_), .c(new_n394_), .O(new_n414_));
  nor2   g257(.a(new_n240_), .b(x021), .O(new_n415_));
  oai21  g258(.a(new_n415_), .b(new_n278_), .c(x069), .O(new_n416_));
  inv1   g259(.a(new_n393_), .O(new_n417_));
  nand4  g260(.a(new_n417_), .b(new_n391_), .c(new_n244_), .d(x029), .O(new_n418_));
  aoi21  g261(.a(new_n418_), .b(new_n416_), .c(x077), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(new_n414_), .c(new_n239_), .O(new_n420_));
  nand2  g263(.a(new_n391_), .b(x029), .O(new_n421_));
  ...
  aoi21  g271(.a(new_n424_), .b(new_n266_), .c(new_n428_), .O(new_n429_));
  nand2  g272(.a(new_n429_), .b(new_n410_), .O(new_n430_));
  nand3  g273(.a(new_n430_), .b(new_n157_), .c(new_n390_), .O(new_n431_));
  inv1   g274(.a(new_n431_), .O(z13));
  ...
  inv1   g333(.a(new_n157_), .O(z20));
  inv1   g334(.a(new_n157_), .O(z21));
  inv1   g335(.a(new_n157_), .O(z24));
