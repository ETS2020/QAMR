// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:49 2020
...
module FAU ( 
  ...
  nor2   g149(.a(x079), .b(x054), .O(new_n306_));
  ...
  nand2  g161(.a(x022), .b(x014), .O(new_n318_));
  inv1   g162(.a(new_n318_), .O(new_n319_));
  aoi21  g163(.a(new_n319_), .b(new_n317_), .c(new_n312_), .O(new_n320_));
  oai22  g164(.a(new_n320_), .b(new_n311_), .c(new_n309_), .d(new_n308_), .O(new_n321_));
  nand3  g165(.a(x086), .b(new_n310_), .c(new_n313_), .O(new_n322_));
  inv1   g166(.a(x006), .O(new_n323_));
  inv1   g167(.a(x102), .O(new_n324_));
  nand3  g168(.a(new_n324_), .b(x062), .c(new_n323_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n322_), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(x038), .O(new_n327_));
  inv1   g171(.a(x126), .O(new_n328_));
  nand2  g172(.a(new_n301_), .b(new_n300_), .O(new_n329_));
  nand4  g173(.a(new_n316_), .b(new_n329_), .c(x086), .d(new_n313_), .O(new_n330_));
  nand3  g174(.a(x094), .b(x070), .c(new_n323_), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n330_), .O(new_n332_));
  oai21  g176(.a(new_n328_), .b(new_n324_), .c(new_n332_), .O(new_n333_));
  oai21  g177(.a(new_n303_), .b(new_n313_), .c(new_n329_), .O(new_n334_));
  nand2  g178(.a(new_n315_), .b(x062), .O(new_n335_));
  nand2  g179(.a(x118), .b(x022), .O(new_n336_));
  nand2  g180(.a(new_n309_), .b(x110), .O(new_n337_));
  nand3  g181(.a(new_n337_), .b(new_n336_), .c(new_n335_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n328_), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n334_), .c(x086), .O(new_n340_));
  nand3  g184(.a(new_n303_), .b(x086), .c(new_n310_), .O(new_n341_));
  inv1   g185(.a(new_n341_), .O(new_n342_));
  aoi21  g186(.a(new_n340_), .b(new_n323_), .c(new_n342_), .O(new_n343_));
  nand4  g187(.a(new_n343_), .b(new_n333_), .c(new_n327_), .d(new_n321_), .O(new_n344_));
  ...
  aoi22  g191(.a(new_n347_), .b(new_n301_), .c(new_n346_), .d(x014), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n345_), .O(new_n349_));
  nand3  g193(.a(new_n310_), .b(x054), .c(new_n301_), .O(new_n350_));
  nand3  g194(.a(new_n312_), .b(x038), .c(new_n323_), .O(new_n351_));
  nand3  g195(.a(new_n351_), .b(new_n350_), .c(x014), .O(new_n352_));
  nand3  g196(.a(new_n352_), .b(new_n157_), .c(new_n299_), .O(new_n353_));
  ...
  nor2   g202(.a(x088), .b(x056), .O(new_n360_));
  nand2  g203(.a(new_n360_), .b(new_n359_), .O(new_n361_));
  nand2  g204(.a(new_n361_), .b(new_n358_), .O(new_n362_));
  inv1   g205(.a(x096), .O(new_n363_));
  inv1   g206(.a(x120), .O(new_n364_));
  aoi21  g207(.a(new_n364_), .b(new_n363_), .c(x088), .O(new_n365_));
  inv1   g208(.a(x104), .O(new_n366_));
  inv1   g209(.a(x112), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n366_), .O(new_n368_));
  oai21  g211(.a(new_n368_), .b(new_n365_), .c(new_n169_), .O(new_n369_));
  oai21  g212(.a(new_n364_), .b(x104), .c(x032), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(x112), .O(new_n371_));
  oai21  g214(.a(new_n363_), .b(x056), .c(new_n366_), .O(new_n372_));
  nand3  g215(.a(x120), .b(new_n367_), .c(new_n168_), .O(new_n373_));
  nand2  g216(.a(new_n373_), .b(new_n161_), .O(new_n374_));
  aoi21  g217(.a(new_n372_), .b(new_n163_), .c(new_n374_), .O(new_n375_));
  nand4  g218(.a(new_n375_), .b(new_n371_), .c(new_n369_), .d(new_n362_), .O(new_n376_));
  nor2   g219(.a(x032), .b(new_n162_), .O(new_n377_));
  nor2   g220(.a(new_n364_), .b(x056), .O(new_n378_));
  ...
  aoi21  g225(.a(new_n382_), .b(x024), .c(x016), .O(new_n383_));
  oai21  g226(.a(new_n383_), .b(x072), .c(new_n162_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n368_), .O(new_n385_));
  nand2  g228(.a(x024), .b(new_n168_), .O(new_n386_));
  aoi21  g229(.a(new_n386_), .b(new_n360_), .c(new_n169_), .O(new_n387_));
  nand2  g230(.a(new_n364_), .b(new_n363_), .O(new_n388_));
  nand4  g231(.a(new_n382_), .b(new_n388_), .c(new_n358_), .d(x024), .O(new_n389_));
  inv1   g232(.a(new_n389_), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(new_n387_), .c(new_n165_), .O(new_n391_));
  aoi21  g234(.a(new_n391_), .b(new_n385_), .c(x048), .O(new_n392_));
  nand2  g235(.a(new_n358_), .b(x024), .O(new_n393_));
  nand2  g236(.a(new_n393_), .b(new_n360_), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(new_n165_), .c(x032), .O(new_n395_));
  inv1   g238(.a(new_n395_), .O(new_n396_));
  oai21  g239(.a(new_n396_), .b(new_n392_), .c(new_n161_), .O(new_n397_));
  ...
  and2   g243(.a(new_n400_), .b(new_n399_), .O(new_n401_));
  ...
  nand3  g254(.a(new_n411_), .b(new_n159_), .c(new_n405_), .O(new_n412_));
  inv1   g255(.a(new_n412_), .O(z09));
  inv1   g256(.a(x042), .O(new_n414_));
  oai22  g257(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n415_));
  nand3  g258(.a(new_n415_), .b(x082), .c(x002), .O(new_n416_));
  oai22  g259(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n417_));
  nand3  g260(.a(new_n417_), .b(x066), .c(x018), .O(new_n418_));
  aoi22  g261(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n419_));
  nand3  g262(.a(new_n419_), .b(new_n418_), .c(new_n416_), .O(new_n420_));
  nand3  g263(.a(new_n420_), .b(new_n159_), .c(new_n414_), .O(new_n421_));
  inv1   g264(.a(new_n421_), .O(z10));
  ...
  nand3  g272(.a(new_n429_), .b(new_n159_), .c(new_n423_), .O(new_n430_));
  inv1   g273(.a(new_n430_), .O(z11));
  oai22  g274(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(x084), .c(x004), .O(new_n433_));
  oai22  g276(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n434_));
  nand3  g277(.a(new_n434_), .b(x068), .c(x020), .O(new_n435_));
  aoi22  g278(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n436_));
  nand3  g279(.a(new_n436_), .b(new_n435_), .c(new_n433_), .O(new_n437_));
  inv1   g280(.a(new_n437_), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(x044), .c(new_n159_), .O(z12));
  nand2  g282(.a(x021), .b(x013), .O(new_n440_));
  oai21  g283(.a(new_n280_), .b(x029), .c(new_n440_), .O(new_n441_));
  inv1   g284(.a(x101), .O(new_n442_));
  aoi21  g285(.a(new_n260_), .b(new_n442_), .c(x093), .O(new_n443_));
  nand2  g286(.a(new_n251_), .b(new_n250_), .O(new_n444_));
  oai21  g287(.a(new_n444_), .b(new_n443_), .c(new_n277_), .O(new_n445_));
  oai21  g288(.a(new_n260_), .b(x109), .c(x037), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(x117), .O(new_n447_));
  oai21  g290(.a(new_n442_), .b(x061), .c(new_n250_), .O(new_n448_));
  nand3  g291(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n268_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n255_), .c(new_n450_), .O(new_n451_));
  nand4  g294(.a(new_n451_), .b(new_n447_), .c(new_n445_), .d(new_n441_), .O(new_n452_));
  nand4  g295(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n276_), .c(new_n454_), .O(new_n455_));
  nand3  g298(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n456_));
  oai21  g299(.a(new_n455_), .b(x053), .c(new_n456_), .O(new_n457_));
  aoi21  g300(.a(new_n246_), .b(x029), .c(x021), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(x077), .c(new_n243_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n444_), .O(new_n460_));
  nand2  g303(.a(x029), .b(new_n244_), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n272_), .c(new_n277_), .O(new_n462_));
  nand2  g305(.a(new_n260_), .b(new_n442_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n440_), .c(new_n246_), .d(x029), .O(new_n464_));
  ...
  nand2  g310(.a(new_n440_), .b(x029), .O(new_n468_));
  ...
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n268_), .O(new_n472_));
  ...
  and2   g318(.a(new_n475_), .b(new_n474_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n472_), .O(new_n477_));
  aoi21  g320(.a(new_n457_), .b(x005), .c(new_n477_), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(x045), .c(new_n159_), .O(z13));
  oai21  g322(.a(new_n316_), .b(x030), .c(new_n318_), .O(new_n480_));
  aoi21  g323(.a(new_n328_), .b(new_n324_), .c(x094), .O(new_n481_));
  nand2  g324(.a(new_n309_), .b(new_n308_), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n481_), .c(new_n310_), .O(new_n483_));
  oai21  g326(.a(new_n328_), .b(x110), .c(x038), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(x118), .O(new_n485_));
  oai21  g328(.a(new_n324_), .b(x062), .c(new_n308_), .O(new_n486_));
  nand3  g329(.a(x126), .b(new_n309_), .c(new_n301_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n312_), .O(new_n488_));
  aoi21  g331(.a(new_n486_), .b(new_n298_), .c(new_n488_), .O(new_n489_));
  nand4  g332(.a(new_n489_), .b(new_n485_), .c(new_n483_), .d(new_n480_), .O(new_n490_));
  nand4  g333(.a(x126), .b(new_n314_), .c(new_n298_), .d(x014), .O(new_n491_));
  inv1   g334(.a(new_n491_), .O(new_n492_));
  aoi21  g335(.a(new_n490_), .b(new_n299_), .c(new_n492_), .O(new_n493_));
  nand3  g336(.a(x086), .b(new_n298_), .c(new_n300_), .O(new_n494_));
  oai21  g337(.a(new_n493_), .b(x054), .c(new_n494_), .O(new_n495_));
  aoi21  g338(.a(new_n303_), .b(x030), .c(x022), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(x078), .c(new_n300_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n482_), .O(new_n498_));
  nor2   g341(.a(x094), .b(x062), .O(new_n499_));
  nand2  g342(.a(x030), .b(new_n301_), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(new_n499_), .c(new_n310_), .O(new_n501_));
  nand2  g344(.a(new_n328_), .b(new_n324_), .O(new_n502_));
  nand4  g345(.a(new_n502_), .b(new_n318_), .c(new_n303_), .d(x030), .O(new_n503_));
  inv1   g346(.a(new_n503_), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(new_n501_), .c(new_n299_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n498_), .c(x054), .O(new_n506_));
  oai21  g349(.a(new_n319_), .b(new_n313_), .c(new_n499_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n299_), .c(x038), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(new_n509_));
  oai21  g352(.a(new_n509_), .b(new_n506_), .c(new_n312_), .O(new_n510_));
  ...
  and2   g356(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n510_), .O(new_n515_));
  aoi21  g358(.a(new_n495_), .b(x006), .c(new_n515_), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(x046), .c(new_n159_), .O(z14));
  zero   g360(.O(z07));
  zero   g361(.O(z15));
  zero   g362(.O(z17));
  zero   g363(.O(z18));
  ...
  zero   g365(.O(z23));
  zero   g366(.O(z24));
  nor2   g367(.a(new_n157_), .b(x078), .O(z19));
  nor2   g368(.a(new_n157_), .b(x078), .O(z21));
  nor2   g369(.a(new_n157_), .b(x078), .O(z22));
  nor2   g370(.a(new_n157_), .b(x078), .O(z25));
  nor2   g371(.a(new_n157_), .b(x078), .O(z26));
  nor2   g372(.a(new_n157_), .b(x078), .O(z27));
endmodule
