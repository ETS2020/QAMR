...
module FAU ( 
  ...
  nand2  g201(.a(new_n358_), .b(new_n169_), .O(new_n359_));
  ...
  nand3  g209(.a(x120), .b(new_n366_), .c(new_n168_), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n161_), .O(new_n368_));
  aoi21  g211(.a(new_n365_), .b(new_n163_), .c(new_n368_), .O(new_n369_));
  nand4  g212(.a(new_n369_), .b(new_n362_), .c(new_n359_), .d(new_n355_), .O(new_n370_));
  nand4  g213(.a(x120), .b(new_n352_), .c(new_n163_), .d(x008), .O(new_n371_));
  inv1   g214(.a(new_n371_), .O(new_n372_));
  aoi21  g215(.a(new_n370_), .b(new_n165_), .c(new_n372_), .O(new_n373_));
  ...
  aoi21  g223(.a(new_n380_), .b(new_n162_), .c(new_n357_), .O(new_n381_));
  ...
  oai21  g230(.a(new_n387_), .b(new_n381_), .c(new_n164_), .O(new_n388_));
  ...
  aoi21  g239(.a(new_n392_), .b(new_n161_), .c(new_n396_), .O(new_n397_));
  nand2  g240(.a(new_n397_), .b(new_n376_), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n159_), .c(new_n350_), .O(new_n399_));
  ...
  oai21  g319(.a(new_n306_), .b(x030), .c(new_n307_), .O(new_n477_));
  nand2  g320(.a(new_n317_), .b(new_n313_), .O(new_n478_));
  oai22  g321(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  oai22  g323(.a(x118), .b(x110), .c(new_n300_), .d(new_n299_), .O(new_n481_));
  nand2  g324(.a(x118), .b(new_n297_), .O(new_n482_));
  oai21  g325(.a(x118), .b(x022), .c(new_n482_), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(x126), .c(x086), .O(new_n484_));
  nand4  g327(.a(new_n484_), .b(new_n481_), .c(new_n480_), .d(new_n477_), .O(new_n485_));
  nand3  g328(.a(new_n485_), .b(new_n343_), .c(new_n339_), .O(new_n486_));
  nand4  g329(.a(x086), .b(new_n157_), .c(new_n299_), .d(new_n318_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n486_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x006), .O(new_n489_));
  nor2   g332(.a(new_n325_), .b(new_n303_), .O(new_n490_));
  oai22  g333(.a(new_n490_), .b(new_n320_), .c(x118), .d(x110), .O(new_n491_));
  nor2   g334(.a(x038), .b(new_n303_), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n306_), .c(x070), .O(new_n493_));
  nand4  g336(.a(new_n478_), .b(new_n326_), .c(new_n307_), .d(x030), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n493_), .c(new_n491_), .O(new_n495_));
  aoi21  g338(.a(new_n307_), .b(x030), .c(new_n306_), .O(new_n496_));
  nor2   g339(.a(new_n496_), .b(new_n299_), .O(new_n497_));
  aoi21  g340(.a(new_n495_), .b(new_n339_), .c(new_n497_), .O(new_n498_));
  nor2   g341(.a(new_n300_), .b(x038), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(x022), .c(x046), .O(new_n500_));
  oai21  g343(.a(new_n498_), .b(x086), .c(new_n500_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n343_), .O(new_n502_));
  nand2  g345(.a(x054), .b(x038), .O(new_n503_));
  nand4  g346(.a(x070), .b(new_n339_), .c(x022), .d(new_n318_), .O(new_n504_));
  nand2  g347(.a(x078), .b(x014), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n504_), .c(new_n503_), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n157_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n502_), .c(new_n489_), .O(z14));
  zero   g351(.O(z07));
  zero   g352(.O(z16));
  zero   g353(.O(z17));
  zero   g354(.O(z19));
  zero   g355(.O(z20));
  zero   g356(.O(z24));
  nor2   g357(.a(x078), .b(new_n157_), .O(z18));
  nor2   g358(.a(x078), .b(new_n157_), .O(z21));
  nor2   g359(.a(x078), .b(new_n157_), .O(z22));
  nor2   g360(.a(x078), .b(new_n157_), .O(z23));
  nor2   g361(.a(x078), .b(new_n157_), .O(z25));
  nor2   g362(.a(x078), .b(new_n157_), .O(z26));
  nor2   g363(.a(x078), .b(new_n157_), .O(z27));
endmodule
