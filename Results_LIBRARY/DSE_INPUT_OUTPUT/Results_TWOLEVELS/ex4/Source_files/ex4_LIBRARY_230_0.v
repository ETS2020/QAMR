// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:54 2020
...
module FAU ( 
  ...
  oai21  g084(.a(new_n240_), .b(x013), .c(x087), .O(new_n241_));
  ...
  nor2   g123(.a(x029), .b(new_n247_), .O(new_n280_));
  oai21  g124(.a(new_n280_), .b(new_n249_), .c(new_n279_), .O(new_n281_));
  inv1   g125(.a(new_n275_), .O(new_n282_));
  nand4  g126(.a(new_n282_), .b(new_n251_), .c(new_n248_), .d(new_n245_), .O(new_n283_));
  aoi21  g127(.a(new_n283_), .b(new_n281_), .c(new_n239_), .O(new_n284_));
  oai21  g128(.a(new_n284_), .b(new_n278_), .c(x053), .O(new_n285_));
  inv1   g129(.a(new_n249_), .O(new_n286_));
  nand2  g130(.a(new_n248_), .b(new_n245_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(new_n286_), .O(new_n288_));
  nand3  g132(.a(new_n288_), .b(x077), .c(new_n258_), .O(new_n289_));
  nand2  g133(.a(new_n289_), .b(new_n285_), .O(new_n290_));
  oai22  g134(.a(new_n239_), .b(new_n258_), .c(new_n244_), .d(new_n246_), .O(new_n291_));
  nand3  g135(.a(new_n291_), .b(new_n279_), .c(new_n247_), .O(new_n292_));
  oai21  g136(.a(x053), .b(x037), .c(new_n292_), .O(new_n293_));
  aoi21  g137(.a(new_n290_), .b(x085), .c(new_n293_), .O(new_n294_));
  nand2  g138(.a(new_n294_), .b(new_n274_), .O(new_n295_));
  nand2  g139(.a(new_n295_), .b(x045), .O(new_n296_));
  nand2  g140(.a(new_n296_), .b(new_n242_), .O(z05));
  ...
  nand2  g197(.a(new_n353_), .b(new_n158_), .O(z06));
  inv1   g198(.a(x024), .O(new_n356_));
  nor2   g199(.a(x088), .b(x056), .O(new_n357_));
  nand2  g200(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  oai21  g201(.a(new_n167_), .b(new_n161_), .c(new_n358_), .O(new_n359_));
  inv1   g202(.a(x096), .O(new_n360_));
  inv1   g203(.a(x120), .O(new_n361_));
  aoi21  g204(.a(new_n361_), .b(new_n360_), .c(x088), .O(new_n362_));
  inv1   g205(.a(x104), .O(new_n363_));
  inv1   g206(.a(x112), .O(new_n364_));
  nand2  g207(.a(new_n364_), .b(new_n363_), .O(new_n365_));
  oai21  g208(.a(new_n365_), .b(new_n362_), .c(new_n168_), .O(new_n366_));
  oai21  g209(.a(new_n361_), .b(x104), .c(x032), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(x112), .O(new_n368_));
  oai21  g211(.a(new_n360_), .b(x056), .c(new_n363_), .O(new_n369_));
  nand3  g212(.a(x120), .b(new_n364_), .c(new_n167_), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n160_), .O(new_n371_));
  aoi21  g214(.a(new_n369_), .b(new_n162_), .c(new_n371_), .O(new_n372_));
  nand4  g215(.a(new_n372_), .b(new_n368_), .c(new_n366_), .d(new_n359_), .O(new_n373_));
  nor2   g216(.a(x032), .b(new_n161_), .O(new_n374_));
  nor2   g217(.a(new_n361_), .b(x056), .O(new_n375_));
  aoi22  g218(.a(new_n375_), .b(new_n374_), .c(new_n373_), .d(new_n164_), .O(new_n376_));
  nand3  g219(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n377_));
  ...
  oai21  g223(.a(new_n380_), .b(x072), .c(new_n161_), .O(new_n381_));
  nand2  g224(.a(new_n381_), .b(new_n365_), .O(new_n382_));
  nand2  g225(.a(x024), .b(new_n167_), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n357_), .c(new_n168_), .O(new_n384_));
  nand2  g227(.a(new_n361_), .b(new_n360_), .O(new_n385_));
  aoi22  g228(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n386_));
  nand3  g229(.a(new_n386_), .b(new_n385_), .c(x024), .O(new_n387_));
  inv1   g230(.a(new_n387_), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(new_n384_), .c(new_n164_), .O(new_n389_));
  aoi21  g232(.a(new_n389_), .b(new_n382_), .c(x048), .O(new_n390_));
  oai21  g233(.a(new_n167_), .b(new_n161_), .c(x024), .O(new_n391_));
  nand2  g234(.a(new_n391_), .b(new_n357_), .O(new_n392_));
  nand3  g235(.a(new_n392_), .b(new_n164_), .c(x032), .O(new_n393_));
  inv1   g236(.a(new_n393_), .O(new_n394_));
  oai21  g237(.a(new_n394_), .b(new_n390_), .c(new_n160_), .O(new_n395_));
  ...
  oai21  g243(.a(new_n400_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g251(.a(new_n408_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g259(.a(new_n416_), .b(x042), .c(new_n158_), .O(z10));
  oai22  g260(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(x083), .c(x003), .O(new_n419_));
  oai22  g262(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n420_));
  nand3  g263(.a(new_n420_), .b(x067), .c(x019), .O(new_n421_));
  aoi22  g264(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n422_));
  nand3  g265(.a(new_n422_), .b(new_n421_), .c(new_n419_), .O(new_n423_));
  inv1   g266(.a(new_n423_), .O(new_n424_));
  oai21  g267(.a(new_n424_), .b(x043), .c(new_n158_), .O(z11));
  inv1   g268(.a(x044), .O(new_n426_));
  ...
  nand3  g275(.a(new_n432_), .b(new_n158_), .c(new_n426_), .O(new_n433_));
  inv1   g276(.a(new_n433_), .O(z12));
  oai22  g277(.a(new_n282_), .b(x029), .c(new_n247_), .d(new_n246_), .O(new_n435_));
  inv1   g278(.a(x101), .O(new_n436_));
  aoi21  g279(.a(new_n263_), .b(new_n436_), .c(x093), .O(new_n437_));
  nand2  g280(.a(new_n254_), .b(new_n253_), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(new_n437_), .c(new_n279_), .O(new_n439_));
  oai21  g282(.a(new_n263_), .b(x109), .c(x037), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(x117), .O(new_n441_));
  oai21  g284(.a(new_n436_), .b(x061), .c(new_n253_), .O(new_n442_));
  nand3  g285(.a(x125), .b(new_n254_), .c(new_n247_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n271_), .O(new_n444_));
  aoi21  g287(.a(new_n442_), .b(new_n258_), .c(new_n444_), .O(new_n445_));
  nand4  g288(.a(new_n445_), .b(new_n441_), .c(new_n439_), .d(new_n435_), .O(new_n446_));
  nand4  g289(.a(x125), .b(new_n261_), .c(new_n258_), .d(x013), .O(new_n447_));
  inv1   g290(.a(new_n447_), .O(new_n448_));
  aoi21  g291(.a(new_n446_), .b(new_n239_), .c(new_n448_), .O(new_n449_));
  nand3  g292(.a(x085), .b(new_n258_), .c(new_n246_), .O(new_n450_));
  oai21  g293(.a(new_n449_), .b(x053), .c(new_n450_), .O(new_n451_));
  aoi21  g294(.a(new_n249_), .b(x029), .c(x021), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(x077), .c(new_n246_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n438_), .O(new_n454_));
  nand2  g297(.a(x029), .b(new_n247_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n275_), .c(new_n279_), .O(new_n456_));
  nand2  g299(.a(new_n263_), .b(new_n436_), .O(new_n457_));
  aoi22  g300(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n458_));
  nand3  g301(.a(new_n458_), .b(new_n457_), .c(x029), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n456_), .c(new_n239_), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n454_), .c(x053), .O(new_n462_));
  oai21  g305(.a(new_n247_), .b(new_n246_), .c(x029), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n275_), .O(new_n464_));
  nand3  g307(.a(new_n464_), .b(new_n239_), .c(x037), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n462_), .c(new_n271_), .O(new_n467_));
  ...
  nand3  g313(.a(new_n470_), .b(new_n469_), .c(new_n467_), .O(new_n471_));
  aoi21  g314(.a(new_n451_), .b(x005), .c(new_n471_), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(x045), .c(new_n158_), .O(z13));
  inv1   g316(.a(x046), .O(new_n474_));
  nand2  g317(.a(x022), .b(x014), .O(new_n475_));
  oai21  g318(.a(new_n338_), .b(x030), .c(new_n475_), .O(new_n476_));
  nor2   g319(.a(x126), .b(x102), .O(new_n477_));
  nor2   g320(.a(x118), .b(x110), .O(new_n478_));
  oai21  g321(.a(new_n477_), .b(x094), .c(new_n478_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n335_), .O(new_n480_));
  oai21  g323(.a(new_n318_), .b(x110), .c(x038), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(x118), .O(new_n482_));
  inv1   g325(.a(x102), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(x062), .c(new_n308_), .O(new_n484_));
  nand3  g327(.a(x126), .b(new_n309_), .c(new_n302_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n326_), .O(new_n486_));
  aoi21  g329(.a(new_n484_), .b(new_n313_), .c(new_n486_), .O(new_n487_));
  nand4  g330(.a(new_n487_), .b(new_n482_), .c(new_n480_), .d(new_n476_), .O(new_n488_));
  nand4  g331(.a(x126), .b(new_n316_), .c(new_n313_), .d(x014), .O(new_n489_));
  inv1   g332(.a(new_n489_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n334_), .c(new_n490_), .O(new_n491_));
  nand3  g334(.a(x086), .b(new_n313_), .c(new_n301_), .O(new_n492_));
  oai21  g335(.a(new_n491_), .b(x054), .c(new_n492_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(x006), .O(new_n494_));
  nand2  g337(.a(new_n304_), .b(x030), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n302_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n334_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n301_), .c(new_n478_), .O(new_n498_));
  nor2   g341(.a(new_n300_), .b(x022), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n338_), .c(x070), .O(new_n500_));
  inv1   g343(.a(new_n477_), .O(new_n501_));
  nand4  g344(.a(new_n501_), .b(new_n475_), .c(new_n304_), .d(x030), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n500_), .c(x078), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n498_), .c(new_n299_), .O(new_n504_));
  nand2  g347(.a(new_n475_), .b(x030), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n330_), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n334_), .c(x038), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n504_), .O(new_n508_));
  oai22  g351(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(x070), .c(x022), .O(new_n510_));
  aoi22  g353(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n511_));
  nand2  g354(.a(new_n511_), .b(new_n510_), .O(new_n512_));
  aoi21  g355(.a(new_n508_), .b(new_n326_), .c(new_n512_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n494_), .O(new_n514_));
  nand3  g357(.a(new_n514_), .b(new_n158_), .c(new_n474_), .O(new_n515_));
  inv1   g358(.a(new_n515_), .O(z14));
  zero   g359(.O(z07));
  zero   g360(.O(z18));
  zero   g361(.O(z21));
  zero   g362(.O(z22));
  ...
  zero   g365(.O(z25));
  zero   g366(.O(z27));
  nor2   g367(.a(x087), .b(x077), .O(z16));
  nor2   g368(.a(x087), .b(x077), .O(z17));
  nor2   g369(.a(x087), .b(x077), .O(z19));
  nor2   g370(.a(x087), .b(x077), .O(z20));
  nor2   g371(.a(x087), .b(x077), .O(z26));
endmodule
