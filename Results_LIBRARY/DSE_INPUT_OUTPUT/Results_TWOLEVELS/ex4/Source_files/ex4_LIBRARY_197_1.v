// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:52 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x080), .O(z07));
  ...
  nand3  g160(.a(new_n172_), .b(x118), .c(x022), .O(new_n317_));
  ...
  nand4  g164(.a(new_n172_), .b(x062), .c(x038), .d(new_n300_), .O(new_n321_));
  ...
  inv1   g196(.a(x056), .O(new_n353_));
  inv1   g197(.a(x088), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(new_n353_), .O(new_n355_));
  oai22  g199(.a(new_n355_), .b(x024), .c(new_n165_), .d(new_n159_), .O(new_n356_));
  ...
  oai21  g205(.a(new_n361_), .b(new_n359_), .c(new_n166_), .O(new_n362_));
  oai21  g206(.a(new_n358_), .b(x104), .c(x032), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(x112), .O(new_n364_));
  inv1   g208(.a(x104), .O(new_n365_));
  oai21  g209(.a(new_n357_), .b(x056), .c(new_n365_), .O(new_n366_));
  ...
  nand4  g214(.a(new_n370_), .b(new_n364_), .c(new_n362_), .d(new_n356_), .O(new_n371_));
  nand4  g215(.a(x120), .b(new_n353_), .c(new_n160_), .d(x008), .O(new_n372_));
  inv1   g216(.a(new_n372_), .O(new_n373_));
  aoi21  g217(.a(new_n371_), .b(new_n162_), .c(new_n373_), .O(new_n374_));
  nand3  g218(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n375_));
  oai21  g219(.a(new_n374_), .b(x048), .c(new_n375_), .O(new_n376_));
  nand3  g220(.a(new_n158_), .b(new_n161_), .c(x024), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n165_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(new_n160_), .O(new_n379_));
  nand3  g223(.a(new_n355_), .b(new_n158_), .c(new_n161_), .O(new_n380_));
  aoi21  g224(.a(new_n380_), .b(new_n379_), .c(new_n166_), .O(new_n381_));
  oai21  g225(.a(new_n354_), .b(new_n353_), .c(x024), .O(new_n382_));
  aoi21  g226(.a(new_n382_), .b(new_n165_), .c(new_n360_), .O(new_n383_));
  nand2  g227(.a(new_n358_), .b(new_n357_), .O(new_n384_));
  ...
  oai21  g231(.a(new_n387_), .b(new_n383_), .c(new_n161_), .O(new_n388_));
  inv1   g232(.a(x024), .O(new_n389_));
  aoi21  g233(.a(x016), .b(x008), .c(new_n389_), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(new_n355_), .c(x032), .O(new_n391_));
  aoi21  g235(.a(new_n391_), .b(new_n388_), .c(x080), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n381_), .c(new_n162_), .O(new_n393_));
  nand3  g237(.a(new_n361_), .b(new_n158_), .c(new_n161_), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(new_n162_), .O(new_n395_));
  nand4  g239(.a(x064), .b(new_n161_), .c(x016), .d(new_n159_), .O(new_n396_));
  oai21  g240(.a(new_n161_), .b(new_n160_), .c(new_n396_), .O(new_n397_));
  aoi21  g241(.a(new_n395_), .b(x008), .c(new_n397_), .O(new_n398_));
  nand2  g242(.a(new_n398_), .b(new_n393_), .O(new_n399_));
  aoi21  g243(.a(new_n376_), .b(x000), .c(new_n399_), .O(new_n400_));
  ...
  oai21  g252(.a(new_n408_), .b(x041), .c(new_n174_), .O(z09));
  ...
  nand3  g260(.a(new_n416_), .b(new_n174_), .c(new_n410_), .O(new_n417_));
  ...
  nand3  g278(.a(new_n434_), .b(new_n174_), .c(new_n428_), .O(new_n435_));
  ...
  oai22  g319(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n476_));
  inv1   g320(.a(x102), .O(new_n477_));
  aoi21  g321(.a(new_n172_), .b(new_n477_), .c(x094), .O(new_n478_));
  nand2  g322(.a(new_n308_), .b(new_n307_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n478_), .c(new_n333_), .O(new_n480_));
  oai21  g324(.a(new_n172_), .b(x110), .c(x038), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(x118), .O(new_n482_));
  oai21  g326(.a(new_n477_), .b(x062), .c(new_n307_), .O(new_n483_));
  nand3  g327(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n324_), .O(new_n485_));
  aoi21  g329(.a(new_n483_), .b(new_n312_), .c(new_n485_), .O(new_n486_));
  nand4  g330(.a(new_n486_), .b(new_n482_), .c(new_n480_), .d(new_n476_), .O(new_n487_));
  nand4  g331(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n488_));
  inv1   g332(.a(new_n488_), .O(new_n489_));
  aoi21  g333(.a(new_n487_), .b(new_n332_), .c(new_n489_), .O(new_n490_));
  nand3  g334(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n491_));
  oai21  g335(.a(new_n490_), .b(x054), .c(new_n491_), .O(new_n492_));
  aoi21  g336(.a(new_n303_), .b(x030), .c(x022), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(x078), .c(new_n300_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n479_), .O(new_n495_));
  nand2  g339(.a(x030), .b(new_n301_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n328_), .c(new_n333_), .O(new_n497_));
  nand2  g341(.a(new_n172_), .b(new_n477_), .O(new_n498_));
  ...
  oai21  g345(.a(new_n501_), .b(new_n497_), .c(new_n332_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n495_), .c(x054), .O(new_n503_));
  oai21  g347(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n328_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n332_), .c(x038), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n503_), .c(new_n324_), .O(new_n508_));
  ...
  zero   g364(.O(z23));
  zero   g365(.O(z27));
  nor2   g366(.a(new_n172_), .b(x080), .O(z16));
  nor2   g367(.a(new_n172_), .b(x080), .O(z19));
  nor2   g368(.a(new_n172_), .b(x080), .O(z24));
  nor2   g369(.a(new_n172_), .b(x080), .O(z25));
  nor2   g370(.a(new_n172_), .b(x080), .O(z26));
endmodule
