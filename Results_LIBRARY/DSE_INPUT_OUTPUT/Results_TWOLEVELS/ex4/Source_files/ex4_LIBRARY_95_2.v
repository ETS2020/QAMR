// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:02 2020
...
module FAU ( 
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(x126), .b(new_n172_), .O(z16));
  nor2   g374(.a(x126), .b(new_n172_), .O(z17));
  nor2   g375(.a(x126), .b(new_n172_), .O(z18));
  nor2   g376(.a(x126), .b(new_n172_), .O(z20));
  nor2   g377(.a(x126), .b(new_n172_), .O(z22));
  nor2   g378(.a(x126), .b(new_n172_), .O(z24));
  nor2   g379(.a(x126), .b(new_n172_), .O(z25));
endmodule
