// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:16 2020
...
module FAU ( 
  ...
  nand2  g177(.a(new_n306_), .b(new_n333_), .O(new_n334_));
  nand4  g178(.a(new_n334_), .b(new_n322_), .c(x086), .d(new_n319_), .O(new_n335_));
  nand3  g179(.a(x094), .b(x070), .c(new_n300_), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(new_n335_), .O(new_n337_));
  oai21  g181(.a(new_n301_), .b(new_n329_), .c(new_n337_), .O(new_n338_));
  oai21  g182(.a(new_n307_), .b(new_n319_), .c(new_n334_), .O(new_n339_));
  oai22  g183(.a(new_n316_), .b(new_n306_), .c(x094), .d(new_n320_), .O(new_n340_));
  nand2  g184(.a(new_n340_), .b(new_n301_), .O(new_n341_));
  nand3  g185(.a(new_n341_), .b(new_n339_), .c(x086), .O(new_n342_));
  ...
  nand4  g189(.a(new_n345_), .b(new_n338_), .c(new_n332_), .d(new_n327_), .O(new_n346_));
  ...
  nand3  g198(.a(new_n354_), .b(x096), .c(new_n298_), .O(new_n355_));
  ...
  nand3  g202(.a(new_n162_), .b(x064), .c(x016), .O(new_n359_));
  nand3  g203(.a(x080), .b(new_n159_), .c(x000), .O(new_n360_));
  aoi21  g204(.a(new_n360_), .b(new_n359_), .c(x032), .O(new_n361_));
  nor2   g205(.a(x112), .b(x104), .O(new_n362_));
  inv1   g206(.a(new_n362_), .O(new_n363_));
  oai21  g207(.a(x072), .b(new_n165_), .c(new_n159_), .O(new_n364_));
  ...
  nand3  g212(.a(new_n368_), .b(new_n162_), .c(x064), .O(new_n369_));
  aoi21  g213(.a(new_n369_), .b(new_n365_), .c(x080), .O(new_n370_));
  nand3  g214(.a(x088), .b(new_n162_), .c(x000), .O(new_n371_));
  oai21  g215(.a(new_n166_), .b(new_n165_), .c(new_n371_), .O(new_n372_));
  nand2  g216(.a(new_n372_), .b(new_n159_), .O(new_n373_));
  ...
  nand3  g220(.a(new_n376_), .b(new_n162_), .c(x000), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n373_), .O(new_n378_));
  oai21  g222(.a(new_n378_), .b(new_n370_), .c(new_n161_), .O(new_n379_));
  nand3  g223(.a(new_n368_), .b(new_n158_), .c(new_n162_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(new_n161_), .O(new_n381_));
  aoi22  g225(.a(new_n381_), .b(x032), .c(x072), .d(x008), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n379_), .O(new_n383_));
  oai21  g227(.a(new_n383_), .b(new_n361_), .c(new_n173_), .O(new_n384_));
  oai21  g228(.a(x056), .b(x024), .c(x000), .O(new_n385_));
  nand2  g229(.a(x088), .b(x056), .O(new_n386_));
  nand4  g230(.a(new_n386_), .b(x120), .c(new_n158_), .d(x024), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n385_), .c(new_n298_), .O(new_n388_));
  nand4  g232(.a(new_n386_), .b(x096), .c(new_n158_), .d(x024), .O(new_n389_));
  inv1   g233(.a(new_n389_), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(new_n388_), .c(new_n161_), .O(new_n391_));
  nand4  g235(.a(new_n158_), .b(x078), .c(x032), .d(x024), .O(new_n392_));
  nand2  g236(.a(new_n392_), .b(new_n391_), .O(new_n393_));
  oai21  g237(.a(new_n165_), .b(new_n159_), .c(new_n393_), .O(new_n394_));
  oai22  g238(.a(new_n312_), .b(x032), .c(new_n367_), .d(new_n298_), .O(new_n395_));
  nand2  g239(.a(new_n395_), .b(new_n165_), .O(new_n396_));
  aoi21  g240(.a(x064), .b(x032), .c(new_n362_), .O(new_n397_));
  inv1   g241(.a(x120), .O(new_n398_));
  nand2  g242(.a(new_n367_), .b(new_n166_), .O(new_n399_));
  inv1   g243(.a(x104), .O(new_n400_));
  nand2  g244(.a(x112), .b(new_n400_), .O(new_n401_));
  aoi21  g245(.a(new_n401_), .b(new_n399_), .c(new_n398_), .O(new_n402_));
  oai21  g246(.a(new_n402_), .b(new_n397_), .c(x078), .O(new_n403_));
  oai21  g247(.a(new_n367_), .b(x056), .c(new_n399_), .O(new_n404_));
  nand2  g248(.a(new_n404_), .b(x096), .O(new_n405_));
  nand3  g249(.a(new_n405_), .b(new_n403_), .c(new_n396_), .O(new_n406_));
  nand2  g250(.a(new_n406_), .b(x000), .O(new_n407_));
  nand2  g251(.a(new_n386_), .b(new_n363_), .O(new_n408_));
  oai21  g252(.a(new_n166_), .b(x016), .c(new_n408_), .O(new_n409_));
  nand4  g253(.a(new_n409_), .b(new_n158_), .c(x078), .d(x024), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(new_n407_), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(new_n161_), .O(new_n412_));
  nor2   g256(.a(new_n160_), .b(x008), .O(new_n413_));
  nor2   g257(.a(new_n398_), .b(x104), .O(new_n414_));
  nand4  g258(.a(new_n414_), .b(new_n413_), .c(x096), .d(x000), .O(new_n415_));
  nand3  g259(.a(new_n415_), .b(new_n412_), .c(new_n394_), .O(new_n416_));
  nand4  g260(.a(x120), .b(x078), .c(new_n366_), .d(new_n161_), .O(new_n417_));
  ...
  aoi21  g263(.a(new_n419_), .b(new_n384_), .c(x040), .O(z08));
  ...
  oai21  g298(.a(new_n454_), .b(x044), .c(new_n173_), .O(z12));
  nand2  g299(.a(x021), .b(x013), .O(new_n456_));
  oai21  g300(.a(new_n279_), .b(x029), .c(new_n456_), .O(new_n457_));
  inv1   g301(.a(x101), .O(new_n458_));
  aoi21  g302(.a(new_n259_), .b(new_n458_), .c(x093), .O(new_n459_));
  nand2  g303(.a(new_n250_), .b(new_n249_), .O(new_n460_));
  oai21  g304(.a(new_n460_), .b(new_n459_), .c(new_n276_), .O(new_n461_));
  oai21  g305(.a(new_n259_), .b(x109), .c(x037), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(x117), .O(new_n463_));
  oai21  g307(.a(new_n458_), .b(x061), .c(new_n249_), .O(new_n464_));
  nand3  g308(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(new_n267_), .O(new_n466_));
  aoi21  g310(.a(new_n464_), .b(new_n254_), .c(new_n466_), .O(new_n467_));
  nand4  g311(.a(new_n467_), .b(new_n463_), .c(new_n461_), .d(new_n457_), .O(new_n468_));
  nand4  g312(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n469_));
  inv1   g313(.a(new_n469_), .O(new_n470_));
  aoi21  g314(.a(new_n468_), .b(new_n275_), .c(new_n470_), .O(new_n471_));
  nand3  g315(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n472_));
  oai21  g316(.a(new_n471_), .b(x053), .c(new_n472_), .O(new_n473_));
  aoi21  g317(.a(new_n245_), .b(x029), .c(x021), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(x077), .c(new_n242_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n460_), .O(new_n476_));
  nand2  g320(.a(x029), .b(new_n243_), .O(new_n477_));
  aoi21  g321(.a(new_n477_), .b(new_n271_), .c(new_n276_), .O(new_n478_));
  nand2  g322(.a(new_n259_), .b(new_n458_), .O(new_n479_));
  nand4  g323(.a(new_n479_), .b(new_n456_), .c(new_n245_), .d(x029), .O(new_n480_));
  inv1   g324(.a(new_n480_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n478_), .c(new_n275_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n476_), .c(x053), .O(new_n483_));
  nand2  g327(.a(new_n456_), .b(x029), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n271_), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(new_n275_), .c(x037), .O(new_n486_));
  inv1   g330(.a(new_n486_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n483_), .c(new_n267_), .O(new_n488_));
  ...
  oai21  g337(.a(new_n493_), .b(x045), .c(new_n173_), .O(z13));
  oai21  g338(.a(new_n322_), .b(x030), .c(new_n324_), .O(new_n495_));
  aoi21  g339(.a(new_n301_), .b(new_n329_), .c(x094), .O(new_n496_));
  nand2  g340(.a(new_n316_), .b(new_n315_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n496_), .c(new_n317_), .O(new_n498_));
  oai21  g342(.a(new_n301_), .b(x110), .c(x038), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(x118), .O(new_n500_));
  oai21  g344(.a(new_n329_), .b(x062), .c(new_n315_), .O(new_n501_));
  nand3  g345(.a(x126), .b(new_n316_), .c(new_n306_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n299_), .O(new_n503_));
  aoi21  g347(.a(new_n501_), .b(new_n297_), .c(new_n503_), .O(new_n504_));
  nand4  g348(.a(new_n504_), .b(new_n500_), .c(new_n498_), .d(new_n495_), .O(new_n505_));
  nand4  g349(.a(x126), .b(new_n320_), .c(new_n297_), .d(x014), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  aoi21  g351(.a(new_n505_), .b(new_n298_), .c(new_n507_), .O(new_n508_));
  nand3  g352(.a(x086), .b(new_n297_), .c(new_n333_), .O(new_n509_));
  oai21  g353(.a(new_n508_), .b(x054), .c(new_n509_), .O(new_n510_));
  aoi21  g354(.a(new_n307_), .b(x030), .c(x022), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(x078), .c(new_n333_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n497_), .O(new_n513_));
  nor2   g357(.a(x094), .b(x062), .O(new_n514_));
  nand2  g358(.a(x030), .b(new_n306_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n514_), .c(new_n317_), .O(new_n516_));
  nand2  g360(.a(new_n301_), .b(new_n329_), .O(new_n517_));
  nand4  g361(.a(new_n517_), .b(new_n324_), .c(new_n307_), .d(x030), .O(new_n518_));
  inv1   g362(.a(new_n518_), .O(new_n519_));
  oai21  g363(.a(new_n519_), .b(new_n516_), .c(new_n298_), .O(new_n520_));
  aoi21  g364(.a(new_n520_), .b(new_n513_), .c(x054), .O(new_n521_));
  oai21  g365(.a(new_n325_), .b(new_n319_), .c(new_n514_), .O(new_n522_));
  nand3  g366(.a(new_n522_), .b(new_n298_), .c(x038), .O(new_n523_));
  ...
  aoi21  g373(.a(new_n510_), .b(x006), .c(new_n529_), .O(new_n530_));
  oai21  g374(.a(new_n530_), .b(x046), .c(new_n173_), .O(z14));
  zero   g375(.O(z15));
  zero   g376(.O(z16));
  zero   g377(.O(z17));
  zero   g378(.O(z20));
  ...
  zero   g381(.O(z23));
  zero   g382(.O(z24));
  nor2   g383(.a(x096), .b(x078), .O(z18));
  nor2   g384(.a(x096), .b(x078), .O(z19));
  nor2   g385(.a(x096), .b(x078), .O(z25));
  nor2   g386(.a(x096), .b(x078), .O(z26));
  nor2   g387(.a(x096), .b(x078), .O(z27));
endmodule
