// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:37 2020
...
module FAU ( 
  ...
  nand3  g248(.a(new_n405_), .b(new_n174_), .c(new_n399_), .O(new_n406_));
  ...
  oai21  g257(.a(new_n414_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai21  g265(.a(new_n422_), .b(x043), .c(new_n174_), .O(z11));
  ...
  oai22  g275(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n433_));
  inv1   g276(.a(x101), .O(new_n434_));
  aoi21  g277(.a(new_n260_), .b(new_n434_), .c(x093), .O(new_n435_));
  nand2  g278(.a(new_n251_), .b(new_n250_), .O(new_n436_));
  oai21  g279(.a(new_n436_), .b(new_n435_), .c(new_n277_), .O(new_n437_));
  oai21  g280(.a(new_n260_), .b(x109), .c(x037), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(x117), .O(new_n439_));
  oai21  g282(.a(new_n434_), .b(x061), .c(new_n250_), .O(new_n440_));
  nand3  g283(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(new_n268_), .O(new_n442_));
  aoi21  g285(.a(new_n440_), .b(new_n255_), .c(new_n442_), .O(new_n443_));
  nand4  g286(.a(new_n443_), .b(new_n439_), .c(new_n437_), .d(new_n433_), .O(new_n444_));
  nand4  g287(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n445_));
  inv1   g288(.a(new_n445_), .O(new_n446_));
  aoi21  g289(.a(new_n444_), .b(new_n276_), .c(new_n446_), .O(new_n447_));
  nand3  g290(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n448_));
  oai21  g291(.a(new_n447_), .b(x053), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n246_), .b(x029), .c(x021), .O(new_n450_));
  oai21  g293(.a(new_n450_), .b(x077), .c(new_n243_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n436_), .O(new_n452_));
  nand2  g295(.a(x029), .b(new_n244_), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(new_n272_), .c(new_n277_), .O(new_n454_));
  nand2  g297(.a(new_n260_), .b(new_n434_), .O(new_n455_));
  ...
  oai21  g301(.a(new_n458_), .b(new_n454_), .c(new_n276_), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n452_), .c(x053), .O(new_n460_));
  oai21  g303(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n272_), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n276_), .c(x037), .O(new_n463_));
  inv1   g306(.a(new_n463_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n460_), .c(new_n268_), .O(new_n465_));
  ...
  oai21  g313(.a(new_n470_), .b(x045), .c(new_n174_), .O(z13));
  aoi21  g314(.a(x070), .b(x038), .c(new_n298_), .O(new_n472_));
  nand2  g315(.a(new_n304_), .b(x030), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n341_), .c(x086), .O(new_n474_));
  oai22  g317(.a(new_n474_), .b(new_n472_), .c(x118), .d(x110), .O(new_n475_));
  nand3  g318(.a(new_n326_), .b(x070), .c(x030), .O(new_n476_));
  nand3  g319(.a(x102), .b(new_n316_), .c(x006), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n476_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n313_), .O(new_n479_));
  nand2  g322(.a(x022), .b(x014), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(x006), .O(new_n481_));
  oai21  g324(.a(x086), .b(new_n334_), .c(new_n481_), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n337_), .O(new_n483_));
  nor2   g326(.a(x126), .b(x102), .O(new_n484_));
  nand4  g327(.a(new_n480_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n485_));
  inv1   g328(.a(x094), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n334_), .c(x006), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n485_), .c(new_n484_), .O(new_n488_));
  oai21  g331(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n302_), .O(new_n490_));
  oai22  g333(.a(new_n309_), .b(x110), .c(new_n486_), .d(x062), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(x126), .O(new_n492_));
  aoi21  g335(.a(x030), .b(new_n299_), .c(x086), .O(new_n493_));
  nand3  g336(.a(new_n493_), .b(new_n492_), .c(new_n490_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(x006), .c(new_n488_), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n483_), .c(new_n479_), .d(new_n475_), .O(new_n496_));
  nand2  g339(.a(x038), .b(x014), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(x070), .c(x022), .O(new_n498_));
  oai22  g341(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n299_), .O(new_n500_));
  nand2  g343(.a(x030), .b(new_n302_), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n330_), .c(x086), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(x054), .c(x038), .O(new_n503_));
  nand4  g346(.a(new_n503_), .b(new_n500_), .c(new_n498_), .d(new_n172_), .O(new_n504_));
  aoi21  g347(.a(new_n496_), .b(new_n300_), .c(new_n504_), .O(new_n505_));
  nor2   g348(.a(new_n505_), .b(x046), .O(z14));
  zero   g349(.O(z07));
  zero   g350(.O(z15));
  zero   g351(.O(z19));
  zero   g352(.O(z23));
  ...
  nor2   g358(.a(new_n172_), .b(x046), .O(z20));
  nor2   g359(.a(new_n172_), .b(x046), .O(z21));
  nor2   g360(.a(new_n172_), .b(x046), .O(z22));
  nor2   g361(.a(new_n172_), .b(x046), .O(z25));
endmodule
