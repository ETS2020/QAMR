// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:25 2020
...
module FAU ( 
  ...
  aoi21  g145(.a(new_n301_), .b(new_n300_), .c(x006), .O(new_n302_));
  ...
  aoi21  g152(.a(new_n307_), .b(new_n304_), .c(new_n308_), .O(new_n309_));
  nor2   g153(.a(new_n309_), .b(new_n303_), .O(new_n310_));
  oai22  g154(.a(new_n310_), .b(new_n302_), .c(new_n299_), .d(new_n298_), .O(new_n311_));
  nand3  g155(.a(x086), .b(new_n301_), .c(new_n304_), .O(new_n312_));
  ...
  nand4  g165(.a(new_n321_), .b(new_n307_), .c(x086), .d(new_n304_), .O(new_n322_));
  ...
  oai21  g170(.a(new_n326_), .b(new_n304_), .c(new_n321_), .O(new_n327_));
  oai22  g171(.a(new_n299_), .b(new_n320_), .c(x094), .d(new_n305_), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n318_), .O(new_n329_));
  nand3  g173(.a(new_n329_), .b(new_n327_), .c(x086), .O(new_n330_));
  inv1   g174(.a(new_n326_), .O(new_n331_));
  nor2   g175(.a(new_n331_), .b(new_n303_), .O(new_n332_));
  aoi22  g176(.a(new_n332_), .b(new_n301_), .c(new_n330_), .d(new_n313_), .O(new_n333_));
  nand4  g177(.a(new_n333_), .b(new_n325_), .c(new_n317_), .d(new_n311_), .O(new_n334_));
  nand3  g178(.a(new_n318_), .b(x110), .c(new_n300_), .O(new_n335_));
  aoi21  g179(.a(new_n335_), .b(x086), .c(x006), .O(new_n336_));
  nand3  g180(.a(x086), .b(new_n300_), .c(new_n304_), .O(new_n337_));
  oai21  g181(.a(x070), .b(x022), .c(new_n337_), .O(new_n338_));
  oai21  g182(.a(new_n338_), .b(new_n336_), .c(x014), .O(new_n339_));
  inv1   g183(.a(x054), .O(new_n340_));
  nand2  g184(.a(new_n304_), .b(x022), .O(new_n341_));
  aoi21  g185(.a(new_n341_), .b(new_n331_), .c(new_n303_), .O(new_n342_));
  oai21  g186(.a(new_n342_), .b(new_n340_), .c(new_n300_), .O(new_n343_));
  nand3  g187(.a(new_n301_), .b(x038), .c(new_n320_), .O(new_n344_));
  nand3  g188(.a(new_n344_), .b(new_n343_), .c(new_n339_), .O(new_n345_));
  aoi21  g189(.a(new_n334_), .b(x054), .c(new_n345_), .O(new_n346_));
  nor3   g190(.a(new_n346_), .b(new_n297_), .c(new_n172_), .O(z06));
  inv1   g191(.a(x024), .O(new_n349_));
  nor2   g192(.a(x088), .b(x056), .O(new_n350_));
  nand2  g193(.a(new_n350_), .b(new_n349_), .O(new_n351_));
  oai21  g194(.a(new_n165_), .b(new_n159_), .c(new_n351_), .O(new_n352_));
  inv1   g195(.a(x096), .O(new_n353_));
  inv1   g196(.a(x120), .O(new_n354_));
  aoi21  g197(.a(new_n354_), .b(new_n353_), .c(x088), .O(new_n355_));
  inv1   g198(.a(x104), .O(new_n356_));
  inv1   g199(.a(x112), .O(new_n357_));
  nand2  g200(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  oai21  g201(.a(new_n358_), .b(new_n355_), .c(new_n166_), .O(new_n359_));
  oai21  g202(.a(new_n354_), .b(x104), .c(x032), .O(new_n360_));
  nand2  g203(.a(new_n360_), .b(x112), .O(new_n361_));
  oai21  g204(.a(new_n353_), .b(x056), .c(new_n356_), .O(new_n362_));
  nand3  g205(.a(x120), .b(new_n357_), .c(new_n165_), .O(new_n363_));
  nand2  g206(.a(new_n363_), .b(new_n158_), .O(new_n364_));
  aoi21  g207(.a(new_n362_), .b(new_n160_), .c(new_n364_), .O(new_n365_));
  nand4  g208(.a(new_n365_), .b(new_n361_), .c(new_n359_), .d(new_n352_), .O(new_n366_));
  nor2   g209(.a(x032), .b(new_n159_), .O(new_n367_));
  nor2   g210(.a(new_n354_), .b(x056), .O(new_n368_));
  aoi22  g211(.a(new_n368_), .b(new_n367_), .c(new_n366_), .d(new_n162_), .O(new_n369_));
  nand3  g212(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n370_));
  ...
  oai21  g216(.a(new_n373_), .b(x072), .c(new_n159_), .O(new_n374_));
  nand2  g217(.a(new_n374_), .b(new_n358_), .O(new_n375_));
  nand2  g218(.a(x024), .b(new_n165_), .O(new_n376_));
  aoi21  g219(.a(new_n376_), .b(new_n350_), .c(new_n166_), .O(new_n377_));
  nand2  g220(.a(new_n354_), .b(new_n353_), .O(new_n378_));
  aoi22  g221(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n379_));
  nand3  g222(.a(new_n379_), .b(new_n378_), .c(x024), .O(new_n380_));
  inv1   g223(.a(new_n380_), .O(new_n381_));
  oai21  g224(.a(new_n381_), .b(new_n377_), .c(new_n162_), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(new_n375_), .c(x048), .O(new_n383_));
  oai21  g226(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n350_), .O(new_n385_));
  nand3  g228(.a(new_n385_), .b(new_n162_), .c(x032), .O(new_n386_));
  inv1   g229(.a(new_n386_), .O(new_n387_));
  oai21  g230(.a(new_n387_), .b(new_n383_), .c(new_n158_), .O(new_n388_));
  ...
  aoi21  g235(.a(new_n371_), .b(x000), .c(new_n392_), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(x040), .c(new_n174_), .O(z08));
  inv1   g237(.a(x041), .O(new_n395_));
  ...
  nand3  g244(.a(new_n401_), .b(new_n174_), .c(new_n395_), .O(new_n402_));
  inv1   g245(.a(new_n402_), .O(z09));
  oai22  g246(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n404_));
  nand3  g247(.a(new_n404_), .b(x082), .c(x002), .O(new_n405_));
  ...
  oai21  g253(.a(new_n410_), .b(x042), .c(new_n174_), .O(z10));
  inv1   g254(.a(x043), .O(new_n412_));
  oai22  g255(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n413_));
  nand3  g256(.a(new_n413_), .b(x083), .c(x003), .O(new_n414_));
  oai22  g257(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n415_));
  nand3  g258(.a(new_n415_), .b(x067), .c(x019), .O(new_n416_));
  aoi22  g259(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n417_));
  nand3  g260(.a(new_n417_), .b(new_n416_), .c(new_n414_), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(new_n174_), .c(new_n412_), .O(new_n419_));
  inv1   g262(.a(new_n419_), .O(z11));
  oai22  g263(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n421_));
  nand3  g264(.a(new_n421_), .b(x084), .c(x004), .O(new_n422_));
  oai22  g265(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n423_));
  nand3  g266(.a(new_n423_), .b(x068), .c(x020), .O(new_n424_));
  aoi22  g267(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n425_));
  nand3  g268(.a(new_n425_), .b(new_n424_), .c(new_n422_), .O(new_n426_));
  inv1   g269(.a(new_n426_), .O(new_n427_));
  oai21  g270(.a(new_n427_), .b(x044), .c(new_n174_), .O(z12));
  inv1   g271(.a(x045), .O(new_n429_));
  nand2  g272(.a(x021), .b(x013), .O(new_n430_));
  oai21  g273(.a(new_n280_), .b(x029), .c(new_n430_), .O(new_n431_));
  nor2   g274(.a(x125), .b(x101), .O(new_n432_));
  nor2   g275(.a(x117), .b(x109), .O(new_n433_));
  oai21  g276(.a(new_n432_), .b(x093), .c(new_n433_), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n277_), .O(new_n435_));
  oai21  g278(.a(new_n260_), .b(x109), .c(x037), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(x117), .O(new_n437_));
  inv1   g280(.a(x101), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(x061), .c(new_n250_), .O(new_n439_));
  nand3  g282(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(new_n268_), .O(new_n441_));
  aoi21  g284(.a(new_n439_), .b(new_n255_), .c(new_n441_), .O(new_n442_));
  nand4  g285(.a(new_n442_), .b(new_n437_), .c(new_n435_), .d(new_n431_), .O(new_n443_));
  nand4  g286(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n444_));
  inv1   g287(.a(new_n444_), .O(new_n445_));
  aoi21  g288(.a(new_n443_), .b(new_n276_), .c(new_n445_), .O(new_n446_));
  nand3  g289(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n447_));
  oai21  g290(.a(new_n446_), .b(x053), .c(new_n447_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(x005), .O(new_n449_));
  nand2  g292(.a(new_n246_), .b(x029), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n244_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n276_), .O(new_n452_));
  aoi21  g295(.a(new_n452_), .b(new_n243_), .c(new_n433_), .O(new_n453_));
  nor2   g296(.a(new_n242_), .b(x021), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(new_n280_), .c(x069), .O(new_n455_));
  inv1   g298(.a(new_n432_), .O(new_n456_));
  nand4  g299(.a(new_n456_), .b(new_n430_), .c(new_n246_), .d(x029), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n455_), .c(x077), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(new_n453_), .c(new_n241_), .O(new_n459_));
  nand2  g302(.a(new_n430_), .b(x029), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n272_), .O(new_n461_));
  nand3  g304(.a(new_n461_), .b(new_n276_), .c(x037), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n459_), .O(new_n463_));
  ...
  aoi21  g310(.a(new_n463_), .b(new_n268_), .c(new_n467_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n449_), .O(new_n469_));
  nand3  g312(.a(new_n469_), .b(new_n174_), .c(new_n429_), .O(new_n470_));
  inv1   g313(.a(new_n470_), .O(z13));
  oai21  g314(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n472_));
  nand2  g315(.a(new_n318_), .b(new_n314_), .O(new_n473_));
  oai22  g316(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(new_n473_), .O(new_n475_));
  oai22  g318(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n476_));
  nand2  g319(.a(x118), .b(new_n298_), .O(new_n477_));
  oai21  g320(.a(x118), .b(x022), .c(new_n477_), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(x126), .c(x086), .O(new_n479_));
  nand4  g322(.a(new_n479_), .b(new_n476_), .c(new_n475_), .d(new_n472_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n297_), .c(new_n340_), .O(new_n481_));
  nand4  g324(.a(x086), .b(new_n172_), .c(new_n300_), .d(new_n319_), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(x006), .O(new_n484_));
  nor2   g327(.a(new_n331_), .b(new_n304_), .O(new_n485_));
  oai22  g328(.a(new_n485_), .b(new_n321_), .c(x118), .d(x110), .O(new_n486_));
  nor2   g329(.a(x038), .b(new_n304_), .O(new_n487_));
  oai21  g330(.a(new_n487_), .b(new_n307_), .c(x070), .O(new_n488_));
  nand4  g331(.a(new_n473_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(new_n488_), .c(new_n486_), .O(new_n490_));
  aoi21  g333(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n491_));
  nor2   g334(.a(new_n491_), .b(new_n300_), .O(new_n492_));
  aoi21  g335(.a(new_n490_), .b(new_n340_), .c(new_n492_), .O(new_n493_));
  nor2   g336(.a(new_n301_), .b(x038), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(x022), .c(x046), .O(new_n495_));
  oai21  g338(.a(new_n493_), .b(x086), .c(new_n495_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n297_), .O(new_n497_));
  nand2  g340(.a(x054), .b(x038), .O(new_n498_));
  nand4  g341(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n499_));
  nand2  g342(.a(x078), .b(x014), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n499_), .c(new_n498_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n172_), .O(new_n502_));
  nand3  g345(.a(new_n502_), .b(new_n497_), .c(new_n484_), .O(z14));
  zero   g346(.O(z07));
  zero   g347(.O(z19));
  zero   g348(.O(z22));
  zero   g349(.O(z23));
  zero   g350(.O(z24));
  zero   g351(.O(z27));
  nor2   g352(.a(x078), .b(new_n172_), .O(z16));
  nor2   g353(.a(x078), .b(new_n172_), .O(z17));
  nor2   g354(.a(x078), .b(new_n172_), .O(z18));
  nor2   g355(.a(x078), .b(new_n172_), .O(z20));
  nor2   g356(.a(x078), .b(new_n172_), .O(z21));
  nor2   g357(.a(x078), .b(new_n172_), .O(z25));
  nor2   g358(.a(x078), .b(new_n172_), .O(z26));
endmodule
