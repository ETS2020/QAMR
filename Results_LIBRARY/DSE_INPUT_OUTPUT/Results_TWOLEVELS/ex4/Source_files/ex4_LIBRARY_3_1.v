// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:36 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x078), .O(z16));
  ...
  nand4  g220(.a(x120), .b(new_n359_), .c(new_n160_), .d(x008), .O(new_n378_));
  ...
  aoi21  g230(.a(new_n387_), .b(new_n159_), .c(new_n364_), .O(new_n388_));
  ...
  oai21  g237(.a(new_n394_), .b(new_n388_), .c(new_n161_), .O(new_n395_));
  ...
  aoi21  g246(.a(new_n399_), .b(new_n158_), .c(new_n403_), .O(new_n404_));
  nand2  g247(.a(new_n404_), .b(new_n383_), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(new_n174_), .c(new_n357_), .O(new_n406_));
  inv1   g249(.a(new_n406_), .O(z08));
  inv1   g250(.a(x041), .O(new_n408_));
  oai22  g251(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n409_));
  nand3  g252(.a(new_n409_), .b(x081), .c(x001), .O(new_n410_));
  oai22  g253(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n411_));
  nand3  g254(.a(new_n411_), .b(x065), .c(x017), .O(new_n412_));
  aoi22  g255(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n413_));
  nand3  g256(.a(new_n413_), .b(new_n412_), .c(new_n410_), .O(new_n414_));
  nand3  g257(.a(new_n414_), .b(new_n174_), .c(new_n408_), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(z09));
  inv1   g259(.a(x042), .O(new_n417_));
  ...
  nand3  g266(.a(new_n423_), .b(new_n174_), .c(new_n417_), .O(new_n424_));
  inv1   g267(.a(new_n424_), .O(z10));
  ...
  nand3  g327(.a(new_n484_), .b(new_n174_), .c(new_n444_), .O(new_n485_));
  inv1   g328(.a(new_n485_), .O(z13));
  oai22  g329(.a(new_n340_), .b(x030), .c(new_n305_), .d(new_n304_), .O(new_n487_));
  inv1   g330(.a(x102), .O(new_n488_));
  aoi21  g331(.a(new_n321_), .b(new_n488_), .c(x094), .O(new_n489_));
  nand2  g332(.a(new_n312_), .b(new_n311_), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(new_n489_), .c(new_n337_), .O(new_n491_));
  oai21  g334(.a(new_n321_), .b(x110), .c(x038), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(x118), .O(new_n493_));
  oai21  g336(.a(new_n488_), .b(x062), .c(new_n311_), .O(new_n494_));
  nand3  g337(.a(x126), .b(new_n312_), .c(new_n305_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n329_), .O(new_n496_));
  aoi21  g339(.a(new_n494_), .b(new_n316_), .c(new_n496_), .O(new_n497_));
  nand4  g340(.a(new_n497_), .b(new_n493_), .c(new_n491_), .d(new_n487_), .O(new_n498_));
  nand4  g341(.a(x126), .b(new_n319_), .c(new_n316_), .d(x014), .O(new_n499_));
  inv1   g342(.a(new_n499_), .O(new_n500_));
  aoi21  g343(.a(new_n498_), .b(new_n297_), .c(new_n500_), .O(new_n501_));
  nand3  g344(.a(x086), .b(new_n316_), .c(new_n304_), .O(new_n502_));
  oai21  g345(.a(new_n501_), .b(x054), .c(new_n502_), .O(new_n503_));
  aoi21  g346(.a(new_n307_), .b(x030), .c(x022), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(x078), .c(new_n304_), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n490_), .O(new_n506_));
  nand2  g349(.a(x030), .b(new_n305_), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n333_), .c(new_n337_), .O(new_n508_));
  nand2  g351(.a(new_n321_), .b(new_n488_), .O(new_n509_));
  aoi22  g352(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n509_), .c(x030), .O(new_n511_));
  inv1   g354(.a(new_n511_), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(new_n508_), .c(new_n297_), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n506_), .c(x054), .O(new_n514_));
  oai21  g357(.a(new_n305_), .b(new_n304_), .c(x030), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n333_), .O(new_n516_));
  nand3  g359(.a(new_n516_), .b(new_n297_), .c(x038), .O(new_n517_));
  inv1   g360(.a(new_n517_), .O(new_n518_));
  oai21  g361(.a(new_n518_), .b(new_n514_), .c(new_n329_), .O(new_n519_));
  oai22  g362(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n520_));
  nand3  g363(.a(new_n520_), .b(x070), .c(x022), .O(new_n521_));
  aoi22  g364(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n522_));
  nand3  g365(.a(new_n522_), .b(new_n521_), .c(new_n519_), .O(new_n523_));
  aoi21  g366(.a(new_n503_), .b(x006), .c(new_n523_), .O(new_n524_));
  oai21  g367(.a(new_n524_), .b(x046), .c(new_n174_), .O(z14));
  zero   g368(.O(z07));
  zero   g369(.O(z15));
  zero   g370(.O(z17));
  zero   g371(.O(z22));
  ...
  zero   g375(.O(z26));
  zero   g376(.O(z27));
  nor2   g377(.a(new_n172_), .b(x078), .O(z18));
  nor2   g378(.a(new_n172_), .b(x078), .O(z19));
  nor2   g379(.a(new_n172_), .b(x078), .O(z20));
  nor2   g380(.a(new_n172_), .b(x078), .O(z21));
endmodule
