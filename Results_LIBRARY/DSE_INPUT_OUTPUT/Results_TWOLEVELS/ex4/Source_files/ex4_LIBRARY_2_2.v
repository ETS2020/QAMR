// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:34 2020
...
module FAU ( 
  ...
  nor2   g016(.a(x124), .b(new_n172_), .O(z07));
  ...
  oai21  g313(.a(new_n469_), .b(x045), .c(new_n174_), .O(z13));
  inv1   g314(.a(x046), .O(new_n471_));
  nand2  g315(.a(x022), .b(x014), .O(new_n472_));
  oai21  g316(.a(new_n337_), .b(x030), .c(new_n472_), .O(new_n473_));
  ...
  nand2  g320(.a(new_n476_), .b(new_n334_), .O(new_n477_));
  oai21  g321(.a(new_n317_), .b(x110), .c(x038), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x118), .O(new_n479_));
  inv1   g323(.a(x102), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(x062), .c(new_n307_), .O(new_n481_));
  nand3  g325(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n325_), .O(new_n483_));
  aoi21  g327(.a(new_n481_), .b(new_n312_), .c(new_n483_), .O(new_n484_));
  nand4  g328(.a(new_n484_), .b(new_n479_), .c(new_n477_), .d(new_n473_), .O(new_n485_));
  nand4  g329(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n486_));
  inv1   g330(.a(new_n486_), .O(new_n487_));
  aoi21  g331(.a(new_n485_), .b(new_n333_), .c(new_n487_), .O(new_n488_));
  nand3  g332(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n489_));
  oai21  g333(.a(new_n488_), .b(x054), .c(new_n489_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(x006), .O(new_n491_));
  nand2  g335(.a(new_n303_), .b(x030), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n301_), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n333_), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n300_), .c(new_n475_), .O(new_n495_));
  nor2   g339(.a(new_n299_), .b(x022), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n337_), .c(x070), .O(new_n497_));
  inv1   g341(.a(new_n474_), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n472_), .c(new_n303_), .d(x030), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n497_), .c(x078), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n495_), .c(new_n298_), .O(new_n501_));
  nand2  g345(.a(new_n472_), .b(x030), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n329_), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n333_), .c(x038), .O(new_n504_));
  ...
  aoi21  g353(.a(new_n505_), .b(new_n325_), .c(new_n509_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n491_), .O(new_n511_));
  nand3  g355(.a(new_n511_), .b(new_n174_), .c(new_n471_), .O(new_n512_));
  ...
  zero   g361(.O(z22));
  zero   g362(.O(z27));
  nor2   g363(.a(x124), .b(new_n172_), .O(z16));
  nor2   g364(.a(x124), .b(new_n172_), .O(z17));
  nor2   g365(.a(x124), .b(new_n172_), .O(z18));
  nor2   g366(.a(x124), .b(new_n172_), .O(z23));
  nor2   g367(.a(x124), .b(new_n172_), .O(z24));
  nor2   g368(.a(x124), .b(new_n172_), .O(z25));
  nor2   g369(.a(x124), .b(new_n172_), .O(z26));
endmodule
