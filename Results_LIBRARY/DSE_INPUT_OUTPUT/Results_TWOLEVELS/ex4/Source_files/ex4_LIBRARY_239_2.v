// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:23 2020
...
module FAU ( 
  ...
  nand4  g322(.a(x086), .b(new_n157_), .c(new_n299_), .d(new_n318_), .O(new_n480_));
  ...
  nand2  g342(.a(new_n499_), .b(new_n157_), .O(new_n500_));
  ...
  zero   g350(.O(z23));
  zero   g351(.O(z24));
  nor2   g352(.a(x078), .b(new_n157_), .O(z20));
  nor2   g353(.a(x078), .b(new_n157_), .O(z22));
  nor2   g354(.a(x078), .b(new_n157_), .O(z25));
  nor2   g355(.a(x078), .b(new_n157_), .O(z26));
