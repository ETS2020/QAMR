// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:34 2020
...
module FAU ( 
  ...
  nor2   g015(.a(x078), .b(x059), .O(z18));
  inv1   g016(.a(z18), .O(new_n173_));
  ...
  inv1   g154(.a(x059), .O(new_n311_));
  nor2   g155(.a(new_n311_), .b(x054), .O(new_n312_));
  oai21  g156(.a(new_n312_), .b(new_n310_), .c(new_n296_), .O(new_n313_));
  inv1   g157(.a(x110), .O(new_n314_));
  inv1   g158(.a(x118), .O(new_n315_));
  inv1   g159(.a(x070), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n296_), .c(x006), .O(new_n317_));
  ...
  oai21  g179(.a(new_n306_), .b(new_n318_), .c(new_n331_), .O(new_n336_));
  inv1   g180(.a(x062), .O(new_n337_));
  oai22  g181(.a(new_n315_), .b(new_n305_), .c(x094), .d(new_n337_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n300_), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n336_), .c(x086), .O(new_n340_));
  nor2   g184(.a(new_n307_), .b(new_n298_), .O(new_n341_));
  aoi22  g185(.a(new_n341_), .b(new_n316_), .c(new_n340_), .d(new_n299_), .O(new_n342_));
  ...
  nor2   g189(.a(x070), .b(new_n296_), .O(new_n346_));
  aoi22  g190(.a(new_n346_), .b(new_n305_), .c(new_n345_), .d(x014), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n344_), .O(new_n348_));
  nand3  g192(.a(new_n316_), .b(x054), .c(new_n305_), .O(new_n349_));
  nand3  g193(.a(new_n298_), .b(x038), .c(new_n299_), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n349_), .c(x014), .O(new_n351_));
  nand3  g195(.a(new_n351_), .b(new_n297_), .c(x059), .O(new_n352_));
  inv1   g196(.a(new_n352_), .O(new_n353_));
  aoi21  g197(.a(new_n348_), .b(x078), .c(new_n353_), .O(new_n354_));
  aoi21  g198(.a(new_n354_), .b(new_n313_), .c(new_n295_), .O(z06));
  ...
  nor2   g219(.a(x032), .b(new_n159_), .O(new_n377_));
  nor2   g220(.a(new_n366_), .b(x056), .O(new_n378_));
  aoi22  g221(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n162_), .O(new_n379_));
  ...
  oai21  g227(.a(new_n384_), .b(x072), .c(new_n159_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g229(.a(x024), .b(new_n165_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n359_), .c(new_n166_), .O(new_n388_));
  ...
  oai21  g234(.a(new_n391_), .b(new_n388_), .c(new_n162_), .O(new_n392_));
  ...
  oai21  g240(.a(new_n397_), .b(new_n393_), .c(new_n158_), .O(new_n398_));
  ...
  oai21  g246(.a(new_n403_), .b(x040), .c(new_n173_), .O(z08));
  ...
  nand3  g254(.a(new_n411_), .b(new_n173_), .c(new_n405_), .O(new_n412_));
  ...
  oai21  g272(.a(new_n429_), .b(x043), .c(new_n173_), .O(z11));
  inv1   g273(.a(x044), .O(new_n431_));
  ...
  nand3  g280(.a(new_n437_), .b(new_n173_), .c(new_n431_), .O(new_n438_));
  inv1   g281(.a(new_n438_), .O(z12));
  nand2  g282(.a(x021), .b(x013), .O(new_n440_));
  oai21  g283(.a(new_n279_), .b(x029), .c(new_n440_), .O(new_n441_));
  inv1   g284(.a(x101), .O(new_n442_));
  aoi21  g285(.a(new_n260_), .b(new_n442_), .c(x093), .O(new_n443_));
  nor2   g286(.a(x117), .b(x109), .O(new_n444_));
  inv1   g287(.a(new_n444_), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n443_), .c(new_n276_), .O(new_n446_));
  oai21  g289(.a(new_n260_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g291(.a(new_n442_), .b(x061), .c(new_n250_), .O(new_n449_));
  ...
  nand4  g295(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n441_), .O(new_n453_));
  nand4  g296(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n454_));
  inv1   g297(.a(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n453_), .b(new_n275_), .c(new_n455_), .O(new_n456_));
  nand3  g299(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n457_));
  oai21  g300(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  aoi21  g301(.a(new_n246_), .b(x029), .c(x021), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(x077), .c(new_n243_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n445_), .O(new_n461_));
  nand2  g304(.a(x029), .b(new_n244_), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n271_), .c(new_n276_), .O(new_n463_));
  nand2  g306(.a(new_n260_), .b(new_n442_), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n440_), .c(new_n246_), .d(x029), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n463_), .c(new_n275_), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n461_), .c(x053), .O(new_n468_));
  nand2  g311(.a(new_n440_), .b(x029), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n271_), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(new_n275_), .c(x037), .O(new_n471_));
  inv1   g314(.a(new_n471_), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(new_n468_), .c(new_n268_), .O(new_n473_));
  ...
  aoi21  g320(.a(new_n458_), .b(x005), .c(new_n477_), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(x045), .c(new_n173_), .O(z13));
  oai21  g322(.a(new_n323_), .b(new_n318_), .c(new_n319_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n298_), .c(new_n297_), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n304_), .c(new_n311_), .O(new_n482_));
  nor2   g325(.a(new_n297_), .b(new_n304_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n482_), .c(x038), .O(new_n484_));
  aoi21  g327(.a(new_n319_), .b(new_n318_), .c(new_n323_), .O(new_n485_));
  nor2   g328(.a(x126), .b(x102), .O(new_n486_));
  nor2   g329(.a(x118), .b(x110), .O(new_n487_));
  oai21  g330(.a(new_n486_), .b(x094), .c(new_n487_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n316_), .O(new_n489_));
  oai21  g332(.a(new_n300_), .b(x110), .c(x038), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x118), .O(new_n491_));
  oai21  g334(.a(new_n327_), .b(x062), .c(new_n314_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n296_), .O(new_n493_));
  nor2   g336(.a(new_n300_), .b(x118), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n305_), .c(x086), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n493_), .c(new_n491_), .d(new_n489_), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(new_n485_), .c(new_n304_), .O(new_n497_));
  nand2  g340(.a(x086), .b(new_n322_), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n497_), .c(new_n299_), .O(new_n499_));
  aoi21  g342(.a(new_n306_), .b(x030), .c(x022), .O(new_n500_));
  or2    g343(.a(new_n500_), .b(new_n487_), .O(new_n501_));
  nor2   g344(.a(new_n318_), .b(x022), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n320_), .c(x070), .O(new_n503_));
  inv1   g346(.a(new_n486_), .O(new_n504_));
  nor2   g347(.a(new_n323_), .b(new_n307_), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n504_), .c(x030), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n503_), .c(new_n501_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n298_), .c(new_n304_), .O(new_n508_));
  ...
  oai21  g354(.a(new_n511_), .b(new_n499_), .c(new_n297_), .O(new_n512_));
  nand4  g355(.a(x126), .b(new_n337_), .c(new_n296_), .d(x006), .O(new_n513_));
  oai21  g356(.a(new_n487_), .b(x086), .c(new_n513_), .O(new_n514_));
  nand3  g357(.a(new_n514_), .b(new_n304_), .c(x014), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  nand3  g359(.a(x070), .b(new_n304_), .c(x022), .O(new_n517_));
  nand3  g360(.a(x086), .b(new_n296_), .c(x006), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(new_n517_), .c(new_n322_), .O(new_n519_));
  and2   g362(.a(new_n519_), .b(x078), .O(new_n520_));
  aoi21  g363(.a(new_n516_), .b(x059), .c(new_n520_), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n484_), .c(x046), .O(z14));
  zero   g365(.O(z07));
  zero   g366(.O(z15));
  zero   g367(.O(z16));
  zero   g368(.O(z17));
  ...
  zero   g373(.O(z26));
  zero   g374(.O(z27));
  nor2   g375(.a(x078), .b(x059), .O(z19));
  nor2   g376(.a(x078), .b(x059), .O(z20));
  nor2   g377(.a(x078), .b(x059), .O(z25));
endmodule
