// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:02 2020
...
module FAU ( 
  ...
  oai21  g254(.a(new_n411_), .b(x041), .c(new_n173_), .O(z09));
  ...
  nand3  g279(.a(new_n436_), .b(new_n173_), .c(new_n430_), .O(new_n437_));
  ...
  nand2  g287(.a(new_n444_), .b(new_n276_), .O(new_n445_));
  oai21  g288(.a(new_n259_), .b(x109), .c(x037), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(x117), .O(new_n447_));
  inv1   g290(.a(x101), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(x061), .c(new_n249_), .O(new_n449_));
  nand3  g292(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n267_), .O(new_n451_));
  aoi21  g294(.a(new_n449_), .b(new_n254_), .c(new_n451_), .O(new_n452_));
  nand4  g295(.a(new_n452_), .b(new_n447_), .c(new_n445_), .d(new_n441_), .O(new_n453_));
  nand4  g296(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n454_));
  inv1   g297(.a(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n453_), .b(new_n275_), .c(new_n455_), .O(new_n456_));
  nand3  g299(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n457_));
  oai21  g300(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(x005), .O(new_n459_));
  nand2  g302(.a(new_n245_), .b(x029), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n243_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n275_), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n242_), .c(new_n443_), .O(new_n463_));
  nor2   g306(.a(new_n241_), .b(x021), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n279_), .c(x069), .O(new_n465_));
  inv1   g308(.a(new_n442_), .O(new_n466_));
  nand4  g309(.a(new_n466_), .b(new_n440_), .c(new_n245_), .d(x029), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n465_), .c(x077), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(new_n463_), .c(new_n240_), .O(new_n469_));
  ...
  aoi21  g320(.a(new_n473_), .b(new_n267_), .c(new_n477_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n459_), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n173_), .c(new_n439_), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(z13));
  oai22  g324(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n482_));
  inv1   g325(.a(x102), .O(new_n483_));
  aoi21  g326(.a(new_n316_), .b(new_n483_), .c(x094), .O(new_n484_));
  nand2  g327(.a(new_n307_), .b(new_n306_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n484_), .c(new_n333_), .O(new_n486_));
  oai21  g329(.a(new_n316_), .b(x110), .c(x038), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(x118), .O(new_n488_));
  oai21  g331(.a(new_n483_), .b(x062), .c(new_n306_), .O(new_n489_));
  nand3  g332(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(new_n324_), .O(new_n491_));
  aoi21  g334(.a(new_n489_), .b(new_n311_), .c(new_n491_), .O(new_n492_));
  nand4  g335(.a(new_n492_), .b(new_n488_), .c(new_n486_), .d(new_n482_), .O(new_n493_));
  nand4  g336(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n494_));
  inv1   g337(.a(new_n494_), .O(new_n495_));
  aoi21  g338(.a(new_n493_), .b(new_n332_), .c(new_n495_), .O(new_n496_));
  nand3  g339(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n497_));
  oai21  g340(.a(new_n496_), .b(x054), .c(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n302_), .b(x030), .c(x022), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(x078), .c(new_n299_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n485_), .O(new_n501_));
  nand2  g344(.a(x030), .b(new_n300_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n328_), .c(new_n333_), .O(new_n503_));
  nand2  g346(.a(new_n316_), .b(new_n483_), .O(new_n504_));
  ...
  oai21  g350(.a(new_n507_), .b(new_n503_), .c(new_n332_), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n501_), .c(x054), .O(new_n509_));
  oai21  g352(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n328_), .O(new_n511_));
  nand3  g354(.a(new_n511_), .b(new_n332_), .c(x038), .O(new_n512_));
  inv1   g355(.a(new_n512_), .O(new_n513_));
  oai21  g356(.a(new_n513_), .b(new_n509_), .c(new_n324_), .O(new_n514_));
  ...
  oai21  g362(.a(new_n519_), .b(x046), .c(new_n173_), .O(z14));
  zero   g363(.O(z07));
  zero   g364(.O(z15));
  zero   g365(.O(z17));
  zero   g366(.O(z19));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(x126), .b(x027), .O(z18));
  nor2   g374(.a(x126), .b(x027), .O(z20));
  nor2   g375(.a(x126), .b(x027), .O(z24));
endmodule
