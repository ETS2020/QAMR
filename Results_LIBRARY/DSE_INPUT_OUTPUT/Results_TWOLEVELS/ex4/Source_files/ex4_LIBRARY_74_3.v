// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:23 2020
...
module FAU ( 
  ...
  oai21  g207(.a(new_n364_), .b(x041), .c(new_n160_), .O(z09));
  ...
  oai21  g215(.a(new_n372_), .b(x042), .c(new_n160_), .O(z10));
  inv1   g216(.a(x043), .O(new_n374_));
  ...
  nand3  g223(.a(new_n380_), .b(new_n160_), .c(new_n374_), .O(new_n381_));
  inv1   g224(.a(new_n381_), .O(z11));
  ...
  zero   g332(.O(z26));
  zero   g333(.O(z27));
  nor2   g334(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g335(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g336(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g337(.a(new_n158_), .b(new_n157_), .O(z24));
endmodule
