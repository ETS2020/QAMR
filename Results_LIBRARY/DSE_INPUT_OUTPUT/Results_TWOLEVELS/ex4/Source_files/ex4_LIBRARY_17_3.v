...
module FAU ( 
  ...
  oai21  g139(.a(new_n295_), .b(new_n240_), .c(new_n160_), .O(z05));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x084), .O(new_n304_));
  ...
  nand3  g217(.a(x120), .b(new_n374_), .c(new_n169_), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n162_), .O(new_n376_));
  aoi21  g219(.a(new_n373_), .b(new_n164_), .c(new_n376_), .O(new_n377_));
  nand4  g220(.a(new_n377_), .b(new_n371_), .c(new_n369_), .d(new_n362_), .O(new_n378_));
  nand4  g221(.a(x120), .b(new_n359_), .c(new_n164_), .d(x008), .O(new_n379_));
  inv1   g222(.a(new_n379_), .O(new_n380_));
  aoi21  g223(.a(new_n378_), .b(new_n166_), .c(new_n380_), .O(new_n381_));
  nand3  g224(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n382_));
  ...
  nand2  g229(.a(new_n386_), .b(new_n169_), .O(new_n387_));
  nand2  g230(.a(new_n387_), .b(new_n166_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n163_), .c(new_n367_), .O(new_n389_));
  ...
  oai21  g237(.a(new_n394_), .b(new_n389_), .c(new_n165_), .O(new_n395_));
  ...
  nand3  g247(.a(new_n404_), .b(new_n160_), .c(new_n357_), .O(new_n405_));
  ...
  nand3  g256(.a(new_n413_), .b(new_n160_), .c(new_n407_), .O(new_n414_));
  ...
  oai21  g273(.a(new_n430_), .b(x043), .c(new_n160_), .O(z11));
  ...
  oai21  g281(.a(new_n438_), .b(new_n434_), .c(new_n157_), .O(new_n439_));
  nand2  g282(.a(new_n438_), .b(new_n158_), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n439_), .c(x044), .O(z12));
  ...
  nand3  g322(.a(new_n479_), .b(new_n160_), .c(new_n240_), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(z13));
  aoi21  g324(.a(new_n297_), .b(x014), .c(x084), .O(new_n482_));
  ...
  aoi21  g338(.a(new_n493_), .b(new_n298_), .c(new_n495_), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n492_), .c(new_n490_), .d(new_n485_), .O(new_n497_));
  nand4  g340(.a(x126), .b(new_n317_), .c(new_n298_), .d(x014), .O(new_n498_));
  inv1   g341(.a(new_n498_), .O(new_n499_));
  aoi21  g342(.a(new_n497_), .b(new_n157_), .c(new_n499_), .O(new_n500_));
  nand3  g343(.a(x086), .b(new_n298_), .c(new_n339_), .O(new_n501_));
  ...
  nand2  g348(.a(new_n298_), .b(x030), .O(new_n506_));
