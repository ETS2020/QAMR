...
module FAU ( 
  ...
  nand3  g225(.a(new_n382_), .b(new_n160_), .c(new_n376_), .O(new_n383_));
  ...
  oai21  g234(.a(new_n391_), .b(x044), .c(new_n160_), .O(z12));
  ...
  aoi22  g295(.a(new_n452_), .b(new_n451_), .c(new_n450_), .d(new_n158_), .O(new_n453_));
  ...
  oai21  g308(.a(new_n465_), .b(new_n461_), .c(new_n158_), .O(new_n466_));
  ...
  nand3  g312(.a(new_n469_), .b(new_n158_), .c(x038), .O(new_n470_));
  ...
  zero   g327(.O(z23));
  zero   g328(.O(z24));
  nor2   g329(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g330(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g331(.a(new_n158_), .b(new_n157_), .O(z25));
  nor2   g332(.a(new_n158_), .b(new_n157_), .O(z26));
  nor2   g333(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
