...
module FAU ( 
  ...
  nand3  g244(.a(new_n400_), .b(new_n173_), .c(new_n352_), .O(new_n401_));
  ...
  oai21  g261(.a(new_n417_), .b(x042), .c(new_n173_), .O(z10));
  ...
  oai21  g269(.a(new_n425_), .b(x043), .c(new_n173_), .O(z11));
  ...
  nand3  g277(.a(new_n433_), .b(new_n173_), .c(new_n427_), .O(new_n434_));
  inv1   g278(.a(new_n434_), .O(z12));
  oai22  g279(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n436_));
  inv1   g280(.a(x101), .O(new_n437_));
  aoi21  g281(.a(new_n259_), .b(new_n437_), .c(x093), .O(new_n438_));
  nand2  g282(.a(new_n250_), .b(new_n249_), .O(new_n439_));
  oai21  g283(.a(new_n439_), .b(new_n438_), .c(new_n276_), .O(new_n440_));
  oai21  g284(.a(new_n259_), .b(x109), .c(x037), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(x117), .O(new_n442_));
  oai21  g286(.a(new_n437_), .b(x061), .c(new_n249_), .O(new_n443_));
  ...
  aoi21  g296(.a(new_n245_), .b(x029), .c(x021), .O(new_n453_));
  oai21  g297(.a(new_n453_), .b(x077), .c(new_n242_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n439_), .O(new_n455_));
  nand2  g299(.a(x029), .b(new_n243_), .O(new_n456_));
  aoi21  g300(.a(new_n456_), .b(new_n271_), .c(new_n276_), .O(new_n457_));
  nand2  g301(.a(new_n259_), .b(new_n437_), .O(new_n458_));
  ...
  oai21  g305(.a(new_n461_), .b(new_n457_), .c(new_n275_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n455_), .c(x053), .O(new_n463_));
  oai21  g307(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n464_));
  ...
  oai21  g311(.a(new_n467_), .b(new_n463_), .c(new_n267_), .O(new_n468_));
  ...
  oai21  g317(.a(new_n473_), .b(x045), .c(new_n173_), .O(z13));
