// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:15 2020
...
module FAU ( 
  ...
  inv1   g123(.a(new_n273_), .O(new_n280_));
  nand4  g124(.a(new_n280_), .b(new_n249_), .c(new_n246_), .d(new_n243_), .O(new_n281_));
  aoi21  g125(.a(new_n281_), .b(new_n279_), .c(new_n158_), .O(new_n282_));
  oai21  g126(.a(new_n282_), .b(new_n276_), .c(x053), .O(new_n283_));
  ...
  oai22  g132(.a(new_n158_), .b(new_n256_), .c(new_n242_), .d(new_n244_), .O(new_n289_));
  nand3  g133(.a(new_n289_), .b(new_n277_), .c(new_n245_), .O(new_n290_));
  aoi22  g134(.a(new_n158_), .b(new_n244_), .c(new_n242_), .d(new_n256_), .O(new_n291_));
  ...
  oai21  g207(.a(new_n364_), .b(new_n361_), .c(new_n170_), .O(new_n365_));
  ...
  nand3  g211(.a(x120), .b(new_n363_), .c(new_n169_), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(new_n162_), .O(new_n370_));
  aoi21  g213(.a(new_n368_), .b(new_n164_), .c(new_n370_), .O(new_n371_));
  nand4  g214(.a(new_n371_), .b(new_n367_), .c(new_n365_), .d(new_n358_), .O(new_n372_));
  nand4  g215(.a(x120), .b(new_n157_), .c(new_n164_), .d(x008), .O(new_n373_));
  inv1   g216(.a(new_n373_), .O(new_n374_));
  aoi21  g217(.a(new_n372_), .b(new_n166_), .c(new_n374_), .O(new_n375_));
  nand3  g218(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n376_));
  ...
  oai21  g222(.a(new_n379_), .b(x072), .c(new_n163_), .O(new_n380_));
  nand2  g223(.a(new_n380_), .b(new_n364_), .O(new_n381_));
  nand2  g224(.a(x024), .b(new_n169_), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(new_n356_), .c(new_n170_), .O(new_n383_));
  nand2  g226(.a(new_n360_), .b(new_n359_), .O(new_n384_));
  aoi22  g227(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n385_));
  nand3  g228(.a(new_n385_), .b(new_n384_), .c(x024), .O(new_n386_));
  inv1   g229(.a(new_n386_), .O(new_n387_));
  oai21  g230(.a(new_n387_), .b(new_n383_), .c(new_n166_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n381_), .c(x048), .O(new_n389_));
  oai21  g232(.a(new_n169_), .b(new_n163_), .c(x024), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n356_), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n166_), .c(x032), .O(new_n392_));
  inv1   g235(.a(new_n392_), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n389_), .c(new_n162_), .O(new_n394_));
  ...
  oai21  g242(.a(new_n399_), .b(x040), .c(new_n160_), .O(z08));
  ...
  nand3  g250(.a(new_n407_), .b(new_n160_), .c(new_n401_), .O(new_n408_));
  ...
  oai21  g259(.a(new_n416_), .b(x042), .c(new_n160_), .O(z10));
  ...
  oai21  g267(.a(new_n424_), .b(x043), .c(new_n160_), .O(z11));
  ...
  nand3  g275(.a(new_n432_), .b(new_n160_), .c(new_n426_), .O(new_n433_));
  inv1   g276(.a(new_n433_), .O(z12));
  oai21  g277(.a(x045), .b(new_n244_), .c(new_n157_), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(x077), .O(new_n436_));
  oai22  g279(.a(new_n280_), .b(x029), .c(new_n245_), .d(new_n244_), .O(new_n437_));
  inv1   g280(.a(x101), .O(new_n438_));
  aoi21  g281(.a(new_n261_), .b(new_n438_), .c(x093), .O(new_n439_));
  nand2  g282(.a(new_n252_), .b(new_n251_), .O(new_n440_));
  oai21  g283(.a(new_n440_), .b(new_n439_), .c(new_n277_), .O(new_n441_));
  oai21  g284(.a(new_n261_), .b(x109), .c(x037), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(x117), .O(new_n443_));
  oai21  g286(.a(new_n438_), .b(x061), .c(new_n251_), .O(new_n444_));
  nand3  g287(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n269_), .O(new_n446_));
  aoi21  g289(.a(new_n444_), .b(new_n256_), .c(new_n446_), .O(new_n447_));
  nand4  g290(.a(new_n447_), .b(new_n443_), .c(new_n441_), .d(new_n437_), .O(new_n448_));
  nand4  g291(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n449_));
  inv1   g292(.a(new_n449_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n158_), .c(new_n450_), .O(new_n451_));
  nand3  g294(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n452_));
  oai21  g295(.a(new_n451_), .b(x053), .c(new_n452_), .O(new_n453_));
  aoi21  g296(.a(new_n247_), .b(x029), .c(x021), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(x077), .c(new_n244_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n440_), .O(new_n456_));
  nand2  g299(.a(x029), .b(new_n245_), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n273_), .c(new_n277_), .O(new_n458_));
  nand2  g301(.a(new_n261_), .b(new_n438_), .O(new_n459_));
  aoi22  g302(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n460_));
  nand3  g303(.a(new_n460_), .b(new_n459_), .c(x029), .O(new_n461_));
  inv1   g304(.a(new_n461_), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n458_), .c(new_n158_), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n456_), .c(x053), .O(new_n464_));
  oai21  g307(.a(new_n245_), .b(new_n244_), .c(x029), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n273_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n158_), .c(x037), .O(new_n467_));
  inv1   g310(.a(new_n467_), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(new_n464_), .c(new_n269_), .O(new_n469_));
  oai22  g312(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(x069), .c(x021), .O(new_n471_));
  nand2  g314(.a(x053), .b(x037), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n471_), .c(new_n469_), .O(new_n473_));
  aoi21  g316(.a(new_n453_), .b(x005), .c(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(x045), .c(new_n436_), .O(z13));
  inv1   g318(.a(x046), .O(new_n476_));
  nand2  g319(.a(x022), .b(x014), .O(new_n477_));
  oai21  g320(.a(new_n337_), .b(x030), .c(new_n477_), .O(new_n478_));
  nor2   g321(.a(x126), .b(x102), .O(new_n479_));
  nor2   g322(.a(x118), .b(x110), .O(new_n480_));
  oai21  g323(.a(new_n479_), .b(x094), .c(new_n480_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n334_), .O(new_n482_));
  oai21  g325(.a(new_n317_), .b(x110), .c(x038), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(x118), .O(new_n484_));
  inv1   g327(.a(x102), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(x062), .c(new_n307_), .O(new_n486_));
  nand3  g329(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n325_), .O(new_n488_));
  aoi21  g331(.a(new_n486_), .b(new_n312_), .c(new_n488_), .O(new_n489_));
  nand4  g332(.a(new_n489_), .b(new_n484_), .c(new_n482_), .d(new_n478_), .O(new_n490_));
  nand4  g333(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n491_));
  inv1   g334(.a(new_n491_), .O(new_n492_));
  aoi21  g335(.a(new_n490_), .b(new_n333_), .c(new_n492_), .O(new_n493_));
  nand3  g336(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n494_));
  oai21  g337(.a(new_n493_), .b(x054), .c(new_n494_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(x006), .O(new_n496_));
  nand2  g339(.a(new_n303_), .b(x030), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n301_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n333_), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n300_), .c(new_n480_), .O(new_n500_));
  nor2   g343(.a(new_n299_), .b(x022), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n337_), .c(x070), .O(new_n502_));
  inv1   g345(.a(new_n479_), .O(new_n503_));
  nand4  g346(.a(new_n503_), .b(new_n477_), .c(new_n303_), .d(x030), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n502_), .c(x078), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n500_), .c(new_n298_), .O(new_n506_));
  nand2  g349(.a(new_n477_), .b(x030), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n329_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n333_), .c(x038), .O(new_n509_));
  ...
  aoi21  g357(.a(new_n510_), .b(new_n325_), .c(new_n514_), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n496_), .O(new_n516_));
  nand3  g359(.a(new_n516_), .b(new_n160_), .c(new_n476_), .O(new_n517_));
  inv1   g360(.a(new_n517_), .O(z14));
  zero   g361(.O(z07));
  zero   g362(.O(z17));
  zero   g363(.O(z18));
  zero   g364(.O(z19));
  ...
  zero   g369(.O(z26));
  zero   g370(.O(z27));
  nor2   g371(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g372(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z22));
endmodule
