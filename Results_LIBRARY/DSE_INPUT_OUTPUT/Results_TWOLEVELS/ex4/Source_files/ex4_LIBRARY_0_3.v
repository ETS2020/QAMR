// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:31 2020
...
module FAU ( 
  ...
  inv1   g047(.a(x018), .O(new_n204_));
  oai22  g048(.a(new_n198_), .b(new_n196_), .c(new_n197_), .d(new_n195_), .O(new_n205_));
  nand3  g049(.a(new_n205_), .b(new_n172_), .c(new_n204_), .O(new_n206_));
  ...
  oai21  g167(.a(x102), .b(x066), .c(x126), .O(new_n324_));
  ...
  nand2  g269(.a(new_n425_), .b(new_n175_), .O(new_n426_));
  oai22  g270(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n427_));
  nand4  g271(.a(new_n427_), .b(new_n173_), .c(x066), .d(x018), .O(new_n428_));
  aoi21  g272(.a(new_n428_), .b(new_n426_), .c(x042), .O(z10));
  ...
  oai21  g329(.a(new_n485_), .b(x045), .c(new_n175_), .O(z13));
  oai22  g330(.a(new_n327_), .b(x030), .c(new_n316_), .d(new_n358_), .O(new_n487_));
  aoi21  g331(.a(new_n173_), .b(new_n342_), .c(x094), .O(new_n488_));
  inv1   g332(.a(x110), .O(new_n489_));
  nand2  g333(.a(new_n351_), .b(new_n489_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n488_), .c(new_n308_), .O(new_n491_));
  oai21  g335(.a(new_n173_), .b(x110), .c(x038), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(x118), .O(new_n493_));
  oai21  g337(.a(new_n342_), .b(x062), .c(new_n489_), .O(new_n494_));
  nand3  g338(.a(x126), .b(new_n351_), .c(new_n316_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n299_), .O(new_n496_));
  ...
  nand4  g342(.a(x126), .b(new_n325_), .c(new_n312_), .d(x014), .O(new_n499_));
  inv1   g343(.a(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n498_), .b(new_n301_), .c(new_n500_), .O(new_n501_));
  nand3  g345(.a(x086), .b(new_n312_), .c(new_n358_), .O(new_n502_));
  oai21  g346(.a(new_n501_), .b(x054), .c(new_n502_), .O(new_n503_));
  aoi21  g347(.a(new_n309_), .b(x030), .c(x022), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(x078), .c(new_n358_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n490_), .O(new_n506_));
  nor2   g350(.a(x094), .b(x062), .O(new_n507_));
  nand2  g351(.a(x030), .b(new_n316_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n507_), .c(new_n308_), .O(new_n509_));
  nand2  g353(.a(new_n173_), .b(new_n342_), .O(new_n510_));
  ...
  oai21  g357(.a(new_n513_), .b(new_n509_), .c(new_n301_), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n506_), .c(x054), .O(new_n515_));
  oai21  g359(.a(new_n316_), .b(new_n358_), .c(x030), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n507_), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n301_), .c(x038), .O(new_n518_));
  inv1   g362(.a(new_n518_), .O(new_n519_));
  oai21  g363(.a(new_n519_), .b(new_n515_), .c(new_n299_), .O(new_n520_));
  ...
  nor2   g381(.a(new_n173_), .b(new_n172_), .O(z26));
  nor2   g382(.a(new_n173_), .b(new_n172_), .O(z27));
endmodule
