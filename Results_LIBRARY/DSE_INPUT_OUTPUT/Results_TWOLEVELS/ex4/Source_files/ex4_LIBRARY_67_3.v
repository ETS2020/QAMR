...
module FAU ( 
  ...
  nand3  g074(.a(new_n230_), .b(new_n158_), .c(new_n225_), .O(new_n231_));
  ...
  oai21  g249(.a(new_n405_), .b(x041), .c(new_n160_), .O(z09));
  ...
  nand3  g257(.a(new_n413_), .b(new_n160_), .c(new_n407_), .O(new_n414_));
  ...
  oai21  g275(.a(new_n431_), .b(x044), .c(new_n160_), .O(z12));
  ...
  nand3  g317(.a(new_n473_), .b(new_n160_), .c(new_n433_), .O(new_n474_));
  inv1   g318(.a(new_n474_), .O(z13));
  oai21  g319(.a(x046), .b(new_n300_), .c(new_n158_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(x078), .O(new_n477_));
  oai22  g321(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n478_));
  ...
  oai21  g325(.a(new_n481_), .b(new_n480_), .c(new_n333_), .O(new_n482_));
  ...
  aoi21  g335(.a(new_n489_), .b(new_n157_), .c(new_n491_), .O(new_n492_));
  ...
  aoi21  g342(.a(new_n498_), .b(new_n329_), .c(new_n333_), .O(new_n499_));
  ...
  oai21  g347(.a(new_n503_), .b(new_n499_), .c(new_n157_), .O(new_n504_));
  ...
  nand3  g351(.a(new_n507_), .b(new_n157_), .c(x038), .O(new_n508_));
  ...
  zero   g364(.O(z23));
  zero   g365(.O(z24));
  nor2   g366(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g367(.a(new_n158_), .b(new_n157_), .O(z17));
  nor2   g368(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g369(.a(new_n158_), .b(new_n157_), .O(z19));
  nor2   g370(.a(new_n158_), .b(new_n157_), .O(z25));
  nor2   g371(.a(new_n158_), .b(new_n157_), .O(z26));
  nor2   g372(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
