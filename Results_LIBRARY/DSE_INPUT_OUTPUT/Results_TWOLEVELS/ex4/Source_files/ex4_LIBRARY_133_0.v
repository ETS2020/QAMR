// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:31 2020
...
module FAU ( 
  ...
  inv1   g083(.a(x089), .O(new_n240_));
  aoi21  g084(.a(x045), .b(new_n239_), .c(new_n240_), .O(new_n241_));
  inv1   g085(.a(x005), .O(new_n242_));
  inv1   g086(.a(x053), .O(new_n243_));
  inv1   g087(.a(x029), .O(new_n244_));
  inv1   g088(.a(x021), .O(new_n245_));
  nand2  g089(.a(new_n245_), .b(new_n239_), .O(new_n246_));
  ...
  nand4  g109(.a(new_n261_), .b(x061), .c(x037), .d(new_n239_), .O(new_n266_));
  ...
  oai22  g133(.a(new_n277_), .b(new_n256_), .c(new_n243_), .d(new_n239_), .O(new_n290_));
  ...
  oai21  g195(.a(new_n351_), .b(new_n297_), .c(new_n173_), .O(z06));
  ...
  nand2  g298(.a(x085), .b(new_n239_), .O(new_n455_));
  ...
  nand3  g319(.a(new_n475_), .b(new_n474_), .c(new_n239_), .O(new_n476_));
  and2   g320(.a(new_n476_), .b(x077), .O(new_n477_));
  aoi21  g321(.a(new_n473_), .b(x089), .c(new_n477_), .O(new_n478_));
  ...
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(x089), .b(x077), .O(z18));
  nor2   g371(.a(x089), .b(x077), .O(z19));
  nor2   g372(.a(x089), .b(x077), .O(z22));
  nor2   g373(.a(x089), .b(x077), .O(z23));
  nor2   g374(.a(x089), .b(x077), .O(z24));
  nor2   g375(.a(x089), .b(x077), .O(z27));
endmodule
