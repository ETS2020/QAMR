// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:00 2020
...
module FAU ( 
  ...
  nand3  g253(.a(new_n410_), .b(new_n158_), .c(new_n404_), .O(new_n411_));
  ...
  aoi21  g320(.a(x054), .b(x038), .c(x014), .O(new_n478_));
  nand3  g321(.a(x070), .b(new_n298_), .c(x022), .O(new_n479_));
  nand3  g322(.a(x086), .b(new_n312_), .c(x006), .O(new_n480_));
  nand4  g323(.a(new_n480_), .b(new_n479_), .c(new_n478_), .d(x078), .O(new_n481_));
  and2   g324(.a(new_n481_), .b(new_n296_), .O(z14));
  zero   g325(.O(z07));
  zero   g326(.O(z18));
  zero   g327(.O(z20));
  zero   g328(.O(z22));
  ...
  nor2   g335(.a(x078), .b(x046), .O(z23));
  nor2   g336(.a(x078), .b(x046), .O(z25));
  nor2   g337(.a(x078), .b(x046), .O(z26));
endmodule
