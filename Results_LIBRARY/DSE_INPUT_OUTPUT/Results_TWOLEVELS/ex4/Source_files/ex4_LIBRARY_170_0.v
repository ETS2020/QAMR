// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:01 2020
...
module FAU ( 
  ...
  oai21  g198(.a(new_n167_), .b(new_n161_), .c(new_n355_), .O(new_n356_));
  ...
  oai21  g205(.a(new_n362_), .b(new_n359_), .c(new_n168_), .O(new_n363_));
  ...
  nand3  g209(.a(x120), .b(new_n361_), .c(new_n167_), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n160_), .O(new_n368_));
  ...
  nor2   g213(.a(x032), .b(new_n161_), .O(new_n371_));
  nor2   g214(.a(new_n358_), .b(x056), .O(new_n372_));
  aoi22  g215(.a(new_n372_), .b(new_n371_), .c(new_n370_), .d(new_n164_), .O(new_n373_));
  nand3  g216(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n374_));
  ...
  oai21  g220(.a(new_n377_), .b(x072), .c(new_n161_), .O(new_n378_));
  nand2  g221(.a(new_n378_), .b(new_n362_), .O(new_n379_));
  nand2  g222(.a(x024), .b(new_n167_), .O(new_n380_));
  aoi21  g223(.a(new_n380_), .b(new_n354_), .c(new_n168_), .O(new_n381_));
  ...
  oai21  g228(.a(new_n385_), .b(new_n381_), .c(new_n164_), .O(new_n386_));
  aoi21  g229(.a(new_n386_), .b(new_n379_), .c(x048), .O(new_n387_));
  oai21  g230(.a(new_n167_), .b(new_n161_), .c(x024), .O(new_n388_));
  nand2  g231(.a(new_n388_), .b(new_n354_), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(new_n164_), .c(x032), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n387_), .c(new_n160_), .O(new_n392_));
  ...
  oai21  g240(.a(new_n397_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g248(.a(new_n405_), .b(x041), .c(new_n158_), .O(z09));
  ...
  nand3  g256(.a(new_n413_), .b(new_n158_), .c(new_n407_), .O(new_n414_));
  inv1   g257(.a(new_n414_), .O(z10));
  oai22  g258(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n416_));
  nand3  g259(.a(new_n416_), .b(x083), .c(x003), .O(new_n417_));
  oai22  g260(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(x067), .c(x019), .O(new_n419_));
  aoi22  g262(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n420_));
  nand3  g263(.a(new_n420_), .b(new_n419_), .c(new_n417_), .O(new_n421_));
  inv1   g264(.a(new_n421_), .O(new_n422_));
  oai21  g265(.a(new_n422_), .b(x043), .c(new_n158_), .O(z11));
  oai22  g266(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(x084), .c(x004), .O(new_n425_));
  oai22  g268(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n426_));
  nand3  g269(.a(new_n426_), .b(x068), .c(x020), .O(new_n427_));
  aoi22  g270(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(new_n427_), .c(new_n425_), .O(new_n429_));
  inv1   g272(.a(new_n429_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(x044), .c(new_n158_), .O(z12));
  inv1   g274(.a(x045), .O(new_n432_));
  nand2  g275(.a(x021), .b(x013), .O(new_n433_));
  oai21  g276(.a(new_n279_), .b(x029), .c(new_n433_), .O(new_n434_));
  nor2   g277(.a(x125), .b(x101), .O(new_n435_));
  nor2   g278(.a(x117), .b(x109), .O(new_n436_));
  oai21  g279(.a(new_n435_), .b(x093), .c(new_n436_), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n276_), .O(new_n438_));
  oai21  g281(.a(new_n259_), .b(x109), .c(x037), .O(new_n439_));
  nand2  g282(.a(new_n439_), .b(x117), .O(new_n440_));
  inv1   g283(.a(x101), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(x061), .c(new_n249_), .O(new_n442_));
  nand3  g285(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n267_), .O(new_n444_));
  aoi21  g287(.a(new_n442_), .b(new_n254_), .c(new_n444_), .O(new_n445_));
  nand4  g288(.a(new_n445_), .b(new_n440_), .c(new_n438_), .d(new_n434_), .O(new_n446_));
  nand4  g289(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n447_));
  inv1   g290(.a(new_n447_), .O(new_n448_));
  aoi21  g291(.a(new_n446_), .b(new_n275_), .c(new_n448_), .O(new_n449_));
  nand3  g292(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n450_));
  oai21  g293(.a(new_n449_), .b(x053), .c(new_n450_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(x005), .O(new_n452_));
  nand2  g295(.a(new_n245_), .b(x029), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n243_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n275_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n242_), .c(new_n436_), .O(new_n456_));
  nor2   g299(.a(new_n241_), .b(x021), .O(new_n457_));
  oai21  g300(.a(new_n457_), .b(new_n279_), .c(x069), .O(new_n458_));
  inv1   g301(.a(new_n435_), .O(new_n459_));
  nand4  g302(.a(new_n459_), .b(new_n433_), .c(new_n245_), .d(x029), .O(new_n460_));
  aoi21  g303(.a(new_n460_), .b(new_n458_), .c(x077), .O(new_n461_));
  oai21  g304(.a(new_n461_), .b(new_n456_), .c(new_n240_), .O(new_n462_));
  nand2  g305(.a(new_n433_), .b(x029), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n271_), .O(new_n464_));
  nand3  g307(.a(new_n464_), .b(new_n275_), .c(x037), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n462_), .O(new_n466_));
  oai22  g309(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n467_));
  nand3  g310(.a(new_n467_), .b(x069), .c(x021), .O(new_n468_));
  aoi22  g311(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n468_), .O(new_n470_));
  aoi21  g313(.a(new_n466_), .b(new_n267_), .c(new_n470_), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n452_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n158_), .c(new_n432_), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(z13));
  aoi21  g317(.a(x054), .b(x038), .c(x014), .O(new_n475_));
  nand3  g318(.a(x070), .b(new_n300_), .c(x022), .O(new_n476_));
  nand3  g319(.a(x086), .b(new_n311_), .c(x006), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n476_), .c(x078), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(new_n479_));
  aoi21  g322(.a(new_n479_), .b(new_n475_), .c(x046), .O(z14));
  zero   g323(.O(z07));
  zero   g324(.O(z15));
  zero   g325(.O(z19));
  zero   g326(.O(z20));
  ...
  nor2   g331(.a(x078), .b(x046), .O(z21));
  nor2   g332(.a(x078), .b(x046), .O(z22));
  nor2   g333(.a(x078), .b(x046), .O(z24));
