// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:56 2020
...
module FAU ( 
  ...
  aoi22  g293(.a(new_n245_), .b(new_n243_), .c(new_n244_), .d(new_n242_), .O(new_n450_));
  nand3  g294(.a(new_n270_), .b(new_n241_), .c(new_n245_), .O(new_n451_));
  oai22  g295(.a(new_n451_), .b(x053), .c(new_n450_), .d(new_n279_), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(x069), .O(new_n453_));
  nand2  g297(.a(new_n451_), .b(new_n244_), .O(new_n454_));
  aoi22  g298(.a(new_n454_), .b(x037), .c(x077), .d(x013), .O(new_n455_));
  nand3  g299(.a(new_n455_), .b(new_n453_), .c(new_n449_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n158_), .O(new_n457_));
  inv1   g301(.a(x117), .O(new_n458_));
  oai21  g302(.a(new_n262_), .b(new_n263_), .c(new_n458_), .O(new_n459_));
  aoi21  g303(.a(x069), .b(x037), .c(new_n240_), .O(new_n460_));
  nand2  g304(.a(new_n252_), .b(x029), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n279_), .c(x085), .O(new_n462_));
  oai21  g306(.a(new_n462_), .b(new_n460_), .c(new_n245_), .O(new_n463_));
  oai21  g307(.a(x085), .b(new_n242_), .c(new_n463_), .O(new_n464_));
  ...
  nand3  g313(.a(new_n469_), .b(new_n269_), .c(new_n248_), .O(new_n470_));
  nand3  g314(.a(x101), .b(new_n268_), .c(new_n243_), .O(new_n471_));
  nand3  g315(.a(x125), .b(new_n458_), .c(new_n279_), .O(new_n472_));
  nand4  g316(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n468_), .O(new_n473_));
  nand4  g317(.a(x125), .b(new_n268_), .c(new_n243_), .d(x013), .O(new_n474_));
  inv1   g318(.a(new_n474_), .O(new_n475_));
  aoi21  g319(.a(new_n473_), .b(new_n245_), .c(new_n475_), .O(new_n476_));
  nand3  g320(.a(new_n469_), .b(new_n466_), .c(new_n252_), .O(new_n477_));
  oai21  g321(.a(new_n248_), .b(x021), .c(new_n477_), .O(new_n478_));
  nand4  g322(.a(new_n478_), .b(new_n241_), .c(new_n245_), .d(x029), .O(new_n479_));
  oai21  g323(.a(new_n476_), .b(new_n240_), .c(new_n479_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(x126), .O(new_n481_));
  nor2   g325(.a(new_n277_), .b(new_n458_), .O(new_n482_));
  nand4  g326(.a(new_n482_), .b(new_n263_), .c(new_n245_), .d(x005), .O(new_n483_));
  nand3  g327(.a(new_n483_), .b(new_n481_), .c(new_n465_), .O(new_n484_));
  nand4  g328(.a(new_n466_), .b(x126), .c(new_n241_), .d(new_n245_), .O(new_n485_));
  nor3   g329(.a(new_n485_), .b(new_n243_), .c(new_n267_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n244_), .c(new_n486_), .O(new_n487_));
  aoi21  g331(.a(new_n487_), .b(new_n457_), .c(x045), .O(z13));
  nand2  g332(.a(new_n315_), .b(new_n364_), .O(new_n489_));
  oai21  g333(.a(x078), .b(x054), .c(new_n489_), .O(new_n490_));
  nand3  g334(.a(new_n490_), .b(x086), .c(x006), .O(new_n491_));
  inv1   g335(.a(x110), .O(new_n492_));
  nand2  g336(.a(new_n357_), .b(new_n492_), .O(new_n493_));
  oai21  g337(.a(x078), .b(new_n319_), .c(new_n364_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand3  g339(.a(new_n353_), .b(new_n304_), .c(x070), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(x054), .O(new_n497_));
  nor3   g341(.a(new_n331_), .b(x078), .c(new_n315_), .O(new_n498_));
  ...
  nand4  g346(.a(new_n502_), .b(new_n501_), .c(new_n499_), .d(new_n491_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n158_), .O(new_n504_));
  nand2  g348(.a(x022), .b(x014), .O(new_n505_));
  oai21  g349(.a(new_n458_), .b(new_n328_), .c(new_n262_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n312_), .c(new_n302_), .O(new_n507_));
  nand2  g351(.a(x117), .b(x006), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n507_), .c(new_n337_), .O(new_n509_));
  nor3   g353(.a(new_n331_), .b(new_n458_), .c(new_n301_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n509_), .c(new_n303_), .O(new_n511_));
  nand4  g355(.a(x117), .b(new_n302_), .c(x038), .d(x030), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n505_), .O(new_n514_));
  nand4  g358(.a(x117), .b(new_n302_), .c(x070), .d(x030), .O(new_n515_));
  nand3  g359(.a(x126), .b(new_n357_), .c(x006), .O(new_n516_));
  ...
  oai21  g364(.a(new_n311_), .b(new_n315_), .c(new_n493_), .O(new_n521_));
  aoi21  g365(.a(new_n521_), .b(new_n520_), .c(new_n301_), .O(new_n522_));
  nand4  g366(.a(new_n493_), .b(new_n312_), .c(new_n302_), .d(x030), .O(new_n523_));
  inv1   g367(.a(new_n523_), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(new_n522_), .c(x117), .O(new_n525_));
  nand2  g369(.a(new_n352_), .b(new_n311_), .O(new_n526_));
  nand2  g370(.a(x118), .b(new_n492_), .O(new_n527_));
  nand3  g371(.a(new_n527_), .b(new_n526_), .c(new_n489_), .O(new_n528_));
  nand3  g372(.a(new_n528_), .b(x126), .c(x006), .O(new_n529_));
  nand3  g373(.a(new_n529_), .b(new_n525_), .c(new_n518_), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n303_), .O(new_n531_));
  nand2  g375(.a(new_n531_), .b(new_n514_), .O(new_n532_));
  nand3  g376(.a(new_n315_), .b(x014), .c(x006), .O(new_n533_));
  nor4   g377(.a(new_n533_), .b(new_n262_), .c(x062), .d(x054), .O(new_n534_));
  aoi21  g378(.a(new_n532_), .b(new_n304_), .c(new_n534_), .O(new_n535_));
  aoi21  g379(.a(new_n535_), .b(new_n504_), .c(x046), .O(z14));
  zero   g380(.O(z19));
  zero   g381(.O(z23));
  zero   g382(.O(z25));
  zero   g383(.O(z27));
  nor2   g384(.a(x126), .b(x117), .O(z15));
  nor2   g385(.a(x126), .b(x117), .O(z16));
  nor2   g386(.a(x126), .b(x117), .O(z17));
  nor2   g387(.a(x126), .b(x117), .O(z18));
  nor2   g388(.a(x126), .b(x117), .O(z20));
  nor2   g389(.a(x126), .b(x117), .O(z21));
  nor2   g390(.a(x126), .b(x117), .O(z22));
  nor2   g391(.a(x126), .b(x117), .O(z24));
  nor2   g392(.a(x126), .b(x117), .O(z26));
endmodule
