// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:28 2020
...
module FAU ( 
  ...
  nor2   g016(.a(x126), .b(new_n172_), .O(z17));
  ...
  oai21  g270(.a(new_n427_), .b(x042), .c(new_n174_), .O(z10));
  ...
  nand3  g278(.a(new_n435_), .b(new_n174_), .c(new_n429_), .O(new_n436_));
  ...
  oai21  g287(.a(new_n444_), .b(x044), .c(new_n174_), .O(z12));
  ...
  nand2  g328(.a(new_n311_), .b(new_n359_), .O(new_n486_));
  oai21  g329(.a(x078), .b(x054), .c(new_n486_), .O(new_n487_));
  nand3  g330(.a(new_n487_), .b(x086), .c(x006), .O(new_n488_));
  inv1   g331(.a(x110), .O(new_n489_));
  nand2  g332(.a(new_n352_), .b(new_n489_), .O(new_n490_));
  oai21  g333(.a(x078), .b(new_n315_), .c(new_n359_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n490_), .O(new_n492_));
  nand3  g335(.a(new_n348_), .b(new_n300_), .c(x070), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n492_), .c(x054), .O(new_n494_));
  nor3   g337(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n494_), .c(new_n298_), .O(new_n496_));
  oai22  g339(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(x070), .c(x022), .O(new_n498_));
  aoi22  g341(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n499_));
  nand4  g342(.a(new_n499_), .b(new_n498_), .c(new_n496_), .d(new_n488_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n174_), .O(new_n501_));
  nand2  g344(.a(x022), .b(x014), .O(new_n502_));
  oai21  g345(.a(x117), .b(new_n324_), .c(new_n326_), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n308_), .c(new_n298_), .O(new_n504_));
  nand2  g347(.a(new_n172_), .b(x006), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n504_), .c(new_n334_), .O(new_n506_));
  nor3   g349(.a(new_n328_), .b(x117), .c(new_n297_), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(new_n506_), .c(new_n299_), .O(new_n508_));
  nand4  g351(.a(new_n172_), .b(new_n298_), .c(x038), .d(x030), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n508_), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n502_), .O(new_n511_));
  nand4  g354(.a(new_n172_), .b(new_n298_), .c(x070), .d(x030), .O(new_n512_));
  nand3  g355(.a(x126), .b(new_n352_), .c(x006), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n315_), .O(new_n515_));
  oai22  g358(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(x102), .O(new_n517_));
  oai21  g360(.a(new_n307_), .b(new_n311_), .c(new_n490_), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n517_), .c(new_n297_), .O(new_n519_));
  nand4  g362(.a(new_n490_), .b(new_n308_), .c(new_n298_), .d(x030), .O(new_n520_));
  inv1   g363(.a(new_n520_), .O(new_n521_));
  oai21  g364(.a(new_n521_), .b(new_n519_), .c(new_n172_), .O(new_n522_));
  inv1   g365(.a(x094), .O(new_n523_));
  nand2  g366(.a(new_n523_), .b(new_n307_), .O(new_n524_));
  nand2  g367(.a(x118), .b(new_n489_), .O(new_n525_));
  nand3  g368(.a(new_n525_), .b(new_n524_), .c(new_n486_), .O(new_n526_));
  nand3  g369(.a(new_n526_), .b(x126), .c(x006), .O(new_n527_));
  nand3  g370(.a(new_n527_), .b(new_n522_), .c(new_n515_), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n299_), .O(new_n529_));
  nand2  g372(.a(new_n529_), .b(new_n511_), .O(new_n530_));
  nand3  g373(.a(new_n311_), .b(x014), .c(x006), .O(new_n531_));
  nor4   g374(.a(new_n531_), .b(new_n326_), .c(x062), .d(x054), .O(new_n532_));
  aoi21  g375(.a(new_n530_), .b(new_n300_), .c(new_n532_), .O(new_n533_));
  aoi21  g376(.a(new_n533_), .b(new_n501_), .c(x046), .O(z14));
  zero   g377(.O(z07));
  zero   g378(.O(z15));
  zero   g379(.O(z16));
  zero   g380(.O(z18));
  ...
  zero   g384(.O(z23));
  zero   g385(.O(z26));
  nor2   g386(.a(x126), .b(new_n172_), .O(z21));
  nor2   g387(.a(x126), .b(new_n172_), .O(z24));
  nor2   g388(.a(x126), .b(new_n172_), .O(z25));
  nor2   g389(.a(x126), .b(new_n172_), .O(z27));
endmodule
