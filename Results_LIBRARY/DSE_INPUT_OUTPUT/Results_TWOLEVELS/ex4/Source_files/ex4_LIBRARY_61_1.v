...
module FAU ( 
  ...
  oai21  g313(.a(new_n470_), .b(x045), .c(new_n159_), .O(z13));
  aoi21  g314(.a(x070), .b(x038), .c(new_n298_), .O(new_n472_));
  nand2  g315(.a(new_n304_), .b(x030), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n302_), .c(x086), .O(new_n474_));
  ...
  nand2  g325(.a(new_n482_), .b(new_n338_), .O(new_n483_));
  ...
  nand2  g343(.a(x030), .b(new_n335_), .O(new_n501_));
  ...
  nor3   g348(.a(new_n505_), .b(x078), .c(x046), .O(z14));
  zero   g349(.O(z07));
  zero   g350(.O(z15));
  zero   g351(.O(z18));
  zero   g352(.O(z20));
  ...
  nor2   g357(.a(new_n157_), .b(x046), .O(z19));
  nor2   g358(.a(new_n157_), .b(x046), .O(z21));
  nor2   g359(.a(new_n157_), .b(x046), .O(z22));
  nor2   g360(.a(new_n157_), .b(x046), .O(z24));
  nor2   g361(.a(new_n157_), .b(x046), .O(z25));
endmodule
