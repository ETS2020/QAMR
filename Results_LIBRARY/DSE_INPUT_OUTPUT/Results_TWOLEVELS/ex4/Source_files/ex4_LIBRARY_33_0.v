...
module FAU ( 
  ...
  nand3  g316(.a(x070), .b(new_n300_), .c(x022), .O(new_n474_));
  nand3  g317(.a(x086), .b(new_n311_), .c(x006), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n474_), .c(x078), .O(new_n476_));
  inv1   g319(.a(new_n476_), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n473_), .c(x046), .O(z14));
  zero   g321(.O(z07));
  zero   g322(.O(z15));
  zero   g323(.O(z24));
  zero   g324(.O(z25));
  ...
  nor2   g331(.a(x078), .b(x046), .O(z23));
  nor2   g332(.a(x078), .b(x046), .O(z26));
  nor2   g333(.a(x078), .b(x046), .O(z27));
endmodule
