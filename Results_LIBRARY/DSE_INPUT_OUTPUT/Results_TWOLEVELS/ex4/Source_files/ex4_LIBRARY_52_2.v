// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:39 2020
...
module FAU ( 
  ...
  oai21  g275(.a(new_n432_), .b(x043), .c(new_n174_), .O(z11));
  ...
  oai21  g283(.a(new_n440_), .b(x044), .c(new_n174_), .O(z12));
  ...
  nand2  g290(.a(new_n447_), .b(new_n277_), .O(new_n448_));
  oai21  g291(.a(new_n260_), .b(x109), .c(x037), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(x117), .O(new_n450_));
  inv1   g293(.a(x101), .O(new_n451_));
  oai21  g294(.a(new_n451_), .b(x061), .c(new_n250_), .O(new_n452_));
  nand3  g295(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n268_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n255_), .c(new_n454_), .O(new_n455_));
  nand4  g298(.a(new_n455_), .b(new_n450_), .c(new_n448_), .d(new_n444_), .O(new_n456_));
  nand4  g299(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n457_));
  inv1   g300(.a(new_n457_), .O(new_n458_));
  aoi21  g301(.a(new_n456_), .b(new_n276_), .c(new_n458_), .O(new_n459_));
  nand3  g302(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n460_));
  oai21  g303(.a(new_n459_), .b(x053), .c(new_n460_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(x005), .O(new_n462_));
  nand2  g305(.a(new_n246_), .b(x029), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n244_), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n276_), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n243_), .c(new_n446_), .O(new_n466_));
  nor2   g309(.a(new_n242_), .b(x021), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n280_), .c(x069), .O(new_n468_));
  inv1   g311(.a(new_n445_), .O(new_n469_));
  nand4  g312(.a(new_n469_), .b(new_n443_), .c(new_n246_), .d(x029), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n468_), .c(x077), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n466_), .c(new_n241_), .O(new_n472_));
  nand2  g315(.a(new_n443_), .b(x029), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n272_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n276_), .c(x037), .O(new_n475_));
  ...
  aoi21  g323(.a(new_n476_), .b(new_n268_), .c(new_n480_), .O(new_n481_));
  ...
  oai22  g327(.a(new_n340_), .b(x030), .c(new_n305_), .d(new_n304_), .O(new_n485_));
  inv1   g328(.a(x102), .O(new_n486_));
  aoi21  g329(.a(new_n321_), .b(new_n486_), .c(x094), .O(new_n487_));
  nand2  g330(.a(new_n312_), .b(new_n311_), .O(new_n488_));
  oai21  g331(.a(new_n488_), .b(new_n487_), .c(new_n337_), .O(new_n489_));
  oai21  g332(.a(new_n321_), .b(x110), .c(x038), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x118), .O(new_n491_));
  oai21  g334(.a(new_n486_), .b(x062), .c(new_n311_), .O(new_n492_));
  nand3  g335(.a(x126), .b(new_n312_), .c(new_n305_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n329_), .O(new_n494_));
  aoi21  g337(.a(new_n492_), .b(new_n316_), .c(new_n494_), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n491_), .c(new_n489_), .d(new_n485_), .O(new_n496_));
  nand4  g339(.a(x126), .b(new_n319_), .c(new_n316_), .d(x014), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n297_), .c(new_n498_), .O(new_n499_));
  nand3  g342(.a(x086), .b(new_n316_), .c(new_n304_), .O(new_n500_));
  oai21  g343(.a(new_n499_), .b(x054), .c(new_n500_), .O(new_n501_));
  aoi21  g344(.a(new_n307_), .b(x030), .c(x022), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(x078), .c(new_n304_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n488_), .O(new_n504_));
  nand2  g347(.a(x030), .b(new_n305_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n333_), .c(new_n337_), .O(new_n506_));
  nand2  g349(.a(new_n321_), .b(new_n486_), .O(new_n507_));
  ...
  oai21  g353(.a(new_n510_), .b(new_n506_), .c(new_n297_), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n504_), .c(x054), .O(new_n512_));
  oai21  g355(.a(new_n305_), .b(new_n304_), .c(x030), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n333_), .O(new_n514_));
  nand3  g357(.a(new_n514_), .b(new_n297_), .c(x038), .O(new_n515_));
  inv1   g358(.a(new_n515_), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(new_n512_), .c(new_n329_), .O(new_n517_));
  ...
  oai21  g365(.a(new_n522_), .b(x046), .c(new_n174_), .O(z14));
  zero   g366(.O(z07));
  zero   g367(.O(z18));
  zero   g368(.O(z20));
  zero   g369(.O(z21));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(x078), .b(new_n172_), .O(z16));
  nor2   g374(.a(x078), .b(new_n172_), .O(z17));
  nor2   g375(.a(x078), .b(new_n172_), .O(z19));
  nor2   g376(.a(x078), .b(new_n172_), .O(z22));
  nor2   g377(.a(x078), .b(new_n172_), .O(z23));
  nor2   g378(.a(x078), .b(new_n172_), .O(z24));
endmodule
