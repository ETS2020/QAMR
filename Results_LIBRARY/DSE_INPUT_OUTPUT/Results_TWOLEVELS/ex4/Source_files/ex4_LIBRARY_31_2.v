// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:30 2020
...
module FAU ( 
  ...
  nor2   g016(.a(x115), .b(new_n172_), .O(z07));
  ...
  nand3  g316(.a(x126), .b(new_n306_), .c(x006), .O(new_n473_));
  oai21  g317(.a(x086), .b(new_n299_), .c(new_n473_), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n321_), .O(new_n475_));
  oai21  g319(.a(new_n299_), .b(x022), .c(new_n329_), .O(new_n476_));
  aoi21  g320(.a(new_n476_), .b(new_n325_), .c(x054), .O(new_n477_));
  aoi21  g321(.a(new_n477_), .b(new_n475_), .c(x078), .O(new_n478_));
  and2   g322(.a(x115), .b(x054), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n478_), .c(x038), .O(new_n480_));
  oai21  g324(.a(new_n333_), .b(new_n311_), .c(x006), .O(new_n481_));
  oai21  g325(.a(new_n341_), .b(new_n299_), .c(new_n300_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n325_), .O(new_n483_));
  aoi22  g327(.a(new_n483_), .b(new_n481_), .c(new_n307_), .d(new_n306_), .O(new_n484_));
  nand3  g328(.a(new_n325_), .b(x070), .c(x030), .O(new_n485_));
  nand3  g329(.a(x102), .b(new_n314_), .c(x006), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n311_), .O(new_n488_));
  nand2  g332(.a(x022), .b(x014), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x006), .O(new_n490_));
  oai21  g334(.a(x086), .b(new_n333_), .c(new_n490_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n337_), .O(new_n492_));
  nand4  g336(.a(new_n489_), .b(new_n302_), .c(new_n325_), .d(x030), .O(new_n493_));
  inv1   g337(.a(x094), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n333_), .c(x006), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n493_), .O(new_n496_));
  oai21  g340(.a(x126), .b(x102), .c(new_n496_), .O(new_n497_));
  nand2  g341(.a(x126), .b(new_n307_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n299_), .c(x022), .O(new_n499_));
  nand2  g343(.a(x030), .b(new_n321_), .O(new_n500_));
  nand3  g344(.a(x126), .b(x094), .c(new_n314_), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n500_), .c(new_n325_), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(new_n499_), .c(x006), .O(new_n503_));
  nand4  g347(.a(new_n503_), .b(new_n497_), .c(new_n492_), .d(new_n488_), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(new_n484_), .c(new_n298_), .O(new_n505_));
  oai22  g349(.a(new_n325_), .b(new_n297_), .c(new_n333_), .d(new_n334_), .O(new_n506_));
  nor2   g350(.a(new_n333_), .b(x038), .O(new_n507_));
  aoi22  g351(.a(new_n507_), .b(x022), .c(new_n506_), .d(new_n321_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n505_), .O(new_n509_));
  nand3  g353(.a(x070), .b(new_n298_), .c(x022), .O(new_n510_));
  nand3  g354(.a(x086), .b(new_n311_), .c(x006), .O(new_n511_));
  nand3  g355(.a(new_n511_), .b(new_n510_), .c(new_n321_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(x115), .c(x078), .O(new_n513_));
  inv1   g357(.a(new_n513_), .O(new_n514_));
  aoi21  g358(.a(new_n509_), .b(new_n172_), .c(new_n514_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n480_), .c(x046), .O(z14));
  zero   g360(.O(z20));
  zero   g361(.O(z23));
  zero   g362(.O(z26));
  nor2   g363(.a(x115), .b(new_n172_), .O(z15));
  nor2   g364(.a(x115), .b(new_n172_), .O(z16));
  nor2   g365(.a(x115), .b(new_n172_), .O(z17));
  nor2   g366(.a(x115), .b(new_n172_), .O(z18));
  nor2   g367(.a(x115), .b(new_n172_), .O(z19));
  nor2   g368(.a(x115), .b(new_n172_), .O(z21));
  nor2   g369(.a(x115), .b(new_n172_), .O(z22));
  nor2   g370(.a(x115), .b(new_n172_), .O(z24));
  nor2   g371(.a(x115), .b(new_n172_), .O(z25));
  nor2   g372(.a(x115), .b(new_n172_), .O(z27));
endmodule
