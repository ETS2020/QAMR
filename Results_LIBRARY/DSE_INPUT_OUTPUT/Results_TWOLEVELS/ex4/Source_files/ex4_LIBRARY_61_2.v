...
module FAU ( 
  ...
  inv1   g310(.a(new_n311_), .O(new_n468_));
  oai21  g311(.a(new_n307_), .b(x030), .c(new_n468_), .O(new_n469_));
  nand2  g312(.a(new_n320_), .b(new_n316_), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n306_), .O(new_n471_));
  nor2   g314(.a(x118), .b(x110), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n471_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n301_), .O(new_n474_));
  oai21  g317(.a(new_n320_), .b(x110), .c(x038), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(x118), .O(new_n476_));
  oai21  g319(.a(new_n316_), .b(x062), .c(new_n298_), .O(new_n477_));
  nand3  g320(.a(x126), .b(new_n299_), .c(new_n310_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n303_), .O(new_n479_));
  aoi21  g322(.a(new_n477_), .b(new_n300_), .c(new_n479_), .O(new_n480_));
  nand4  g323(.a(new_n480_), .b(new_n476_), .c(new_n474_), .d(new_n469_), .O(new_n481_));
  nand4  g324(.a(x126), .b(new_n305_), .c(new_n300_), .d(x014), .O(new_n482_));
  inv1   g325(.a(new_n482_), .O(new_n483_));
  aoi21  g326(.a(new_n481_), .b(new_n297_), .c(new_n483_), .O(new_n484_));
  oai22  g327(.a(new_n484_), .b(x054), .c(new_n337_), .d(x014), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(x006), .O(new_n486_));
  oai21  g329(.a(new_n331_), .b(new_n304_), .c(new_n310_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n297_), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n309_), .c(new_n472_), .O(new_n489_));
  nor2   g332(.a(new_n304_), .b(x022), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(new_n307_), .c(x070), .O(new_n491_));
  nand4  g334(.a(new_n470_), .b(new_n326_), .c(new_n468_), .d(x030), .O(new_n492_));
  aoi21  g335(.a(new_n492_), .b(new_n491_), .c(x078), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(new_n489_), .c(new_n340_), .O(new_n494_));
  inv1   g337(.a(new_n307_), .O(new_n495_));
  oai21  g338(.a(new_n311_), .b(new_n304_), .c(new_n495_), .O(new_n496_));
  nand3  g339(.a(new_n496_), .b(new_n297_), .c(x038), .O(new_n497_));
  ...
  aoi21  g345(.a(new_n498_), .b(new_n303_), .c(new_n502_), .O(new_n503_));
  ...
  nor2   g356(.a(x078), .b(new_n157_), .O(z21));
