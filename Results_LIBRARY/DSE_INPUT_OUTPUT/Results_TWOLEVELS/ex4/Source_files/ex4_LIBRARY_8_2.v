// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:46 2020
...
module FAU ( 
  ...
  inv1   g000(.a(x091), .O(new_n157_));
  nor2   g001(.a(x126), .b(new_n157_), .O(z17));
  ...
  nand2  g171(.a(new_n327_), .b(new_n157_), .O(new_n328_));
  nor2   g172(.a(x094), .b(x062), .O(new_n329_));
  aoi21  g173(.a(new_n328_), .b(new_n326_), .c(new_n329_), .O(new_n330_));
  nor2   g174(.a(new_n327_), .b(x006), .O(new_n331_));
  ...
  nand4  g183(.a(new_n327_), .b(x118), .c(new_n157_), .d(new_n298_), .O(new_n340_));
  ...
  nand4  g199(.a(new_n355_), .b(new_n327_), .c(new_n157_), .d(new_n298_), .O(new_n356_));
  ...
  nand3  g205(.a(x038), .b(new_n361_), .c(new_n298_), .O(new_n362_));
  nor4   g206(.a(new_n362_), .b(new_n328_), .c(new_n360_), .d(new_n300_), .O(new_n363_));
  aoi21  g207(.a(new_n359_), .b(x078), .c(new_n363_), .O(new_n364_));
  aoi21  g208(.a(new_n364_), .b(new_n323_), .c(new_n297_), .O(z06));
  ...
  nand2  g218(.a(new_n375_), .b(new_n169_), .O(new_n376_));
  ...
  nand3  g226(.a(x120), .b(new_n383_), .c(new_n168_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n161_), .O(new_n385_));
  aoi21  g228(.a(new_n382_), .b(new_n163_), .c(new_n385_), .O(new_n386_));
  nand4  g229(.a(new_n386_), .b(new_n379_), .c(new_n376_), .d(new_n372_), .O(new_n387_));
  nand4  g230(.a(x120), .b(new_n369_), .c(new_n163_), .d(x008), .O(new_n388_));
  inv1   g231(.a(new_n388_), .O(new_n389_));
  aoi21  g232(.a(new_n387_), .b(new_n165_), .c(new_n389_), .O(new_n390_));
  nand3  g233(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n391_));
  ...
  nand2  g238(.a(new_n395_), .b(new_n168_), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(new_n165_), .O(new_n397_));
  aoi21  g240(.a(new_n397_), .b(new_n162_), .c(new_n374_), .O(new_n398_));
  ...
  oai21  g247(.a(new_n404_), .b(new_n398_), .c(new_n164_), .O(new_n405_));
  nand2  g248(.a(new_n368_), .b(x024), .O(new_n406_));
  nand3  g249(.a(new_n406_), .b(new_n370_), .c(new_n369_), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(new_n165_), .c(x032), .O(new_n408_));
  ...
  aoi21  g256(.a(new_n409_), .b(new_n161_), .c(new_n413_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n393_), .O(new_n415_));
  nand3  g258(.a(new_n415_), .b(new_n159_), .c(new_n367_), .O(new_n416_));
  inv1   g259(.a(new_n416_), .O(z08));
  oai22  g260(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(x081), .c(x001), .O(new_n419_));
  oai22  g262(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n420_));
  nand3  g263(.a(new_n420_), .b(x065), .c(x017), .O(new_n421_));
  aoi22  g264(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n422_));
  nand3  g265(.a(new_n422_), .b(new_n421_), .c(new_n419_), .O(new_n423_));
  inv1   g266(.a(new_n423_), .O(new_n424_));
  oai21  g267(.a(new_n424_), .b(x041), .c(new_n159_), .O(z09));
  inv1   g268(.a(x042), .O(new_n426_));
  oai22  g269(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(x082), .c(x002), .O(new_n428_));
  oai22  g271(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n429_));
  nand3  g272(.a(new_n429_), .b(x066), .c(x018), .O(new_n430_));
  aoi22  g273(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n431_));
  nand3  g274(.a(new_n431_), .b(new_n430_), .c(new_n428_), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(new_n159_), .c(new_n426_), .O(new_n433_));
  inv1   g276(.a(new_n433_), .O(z10));
  inv1   g277(.a(x043), .O(new_n435_));
  oai22  g278(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n436_));
  nand3  g279(.a(new_n436_), .b(x083), .c(x003), .O(new_n437_));
  oai22  g280(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n438_));
  nand3  g281(.a(new_n438_), .b(x067), .c(x019), .O(new_n439_));
  aoi22  g282(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n440_));
  nand3  g283(.a(new_n440_), .b(new_n439_), .c(new_n437_), .O(new_n441_));
  nand3  g284(.a(new_n441_), .b(new_n159_), .c(new_n435_), .O(new_n442_));
  inv1   g285(.a(new_n442_), .O(z11));
  inv1   g286(.a(x044), .O(new_n444_));
  oai22  g287(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(x084), .c(x004), .O(new_n446_));
  oai22  g289(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n447_));
  nand3  g290(.a(new_n447_), .b(x068), .c(x020), .O(new_n448_));
  aoi22  g291(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(new_n448_), .c(new_n446_), .O(new_n450_));
  nand3  g293(.a(new_n450_), .b(new_n159_), .c(new_n444_), .O(new_n451_));
  inv1   g294(.a(new_n451_), .O(z12));
  oai22  g295(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n453_));
  inv1   g296(.a(x101), .O(new_n454_));
  aoi21  g297(.a(new_n260_), .b(new_n454_), .c(x093), .O(new_n455_));
  nand2  g298(.a(new_n251_), .b(new_n250_), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(new_n455_), .c(new_n277_), .O(new_n457_));
  oai21  g300(.a(new_n260_), .b(x109), .c(x037), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(x117), .O(new_n459_));
  oai21  g302(.a(new_n454_), .b(x061), .c(new_n250_), .O(new_n460_));
  nand3  g303(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n268_), .O(new_n462_));
  aoi21  g305(.a(new_n460_), .b(new_n255_), .c(new_n462_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n459_), .c(new_n457_), .d(new_n453_), .O(new_n464_));
  nand4  g307(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  aoi21  g309(.a(new_n464_), .b(new_n276_), .c(new_n466_), .O(new_n467_));
  nand3  g310(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n468_));
  oai21  g311(.a(new_n467_), .b(x053), .c(new_n468_), .O(new_n469_));
  aoi21  g312(.a(new_n246_), .b(x029), .c(x021), .O(new_n470_));
  oai21  g313(.a(new_n470_), .b(x077), .c(new_n243_), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n456_), .O(new_n472_));
  nand2  g315(.a(x029), .b(new_n244_), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n272_), .c(new_n277_), .O(new_n474_));
  nand2  g317(.a(new_n260_), .b(new_n454_), .O(new_n475_));
  aoi22  g318(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n476_));
  nand3  g319(.a(new_n476_), .b(new_n475_), .c(x029), .O(new_n477_));
  inv1   g320(.a(new_n477_), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(new_n474_), .c(new_n276_), .O(new_n479_));
  aoi21  g322(.a(new_n479_), .b(new_n472_), .c(x053), .O(new_n480_));
  oai21  g323(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n272_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n276_), .c(x037), .O(new_n483_));
  inv1   g326(.a(new_n483_), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n480_), .c(new_n268_), .O(new_n485_));
  oai22  g328(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(x069), .c(x021), .O(new_n487_));
  aoi22  g330(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n488_));
  nand3  g331(.a(new_n488_), .b(new_n487_), .c(new_n485_), .O(new_n489_));
  aoi21  g332(.a(new_n469_), .b(x005), .c(new_n489_), .O(new_n490_));
  oai21  g333(.a(new_n490_), .b(x045), .c(new_n159_), .O(z13));
  oai22  g334(.a(new_n349_), .b(x030), .c(new_n316_), .d(new_n361_), .O(new_n492_));
  aoi21  g335(.a(new_n327_), .b(new_n325_), .c(x094), .O(new_n493_));
  inv1   g336(.a(x110), .O(new_n494_));
  nand2  g337(.a(new_n353_), .b(new_n494_), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n493_), .c(new_n308_), .O(new_n496_));
  oai21  g339(.a(new_n327_), .b(x110), .c(x038), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(x118), .O(new_n498_));
  oai21  g341(.a(new_n325_), .b(x062), .c(new_n494_), .O(new_n499_));
  nand3  g342(.a(x126), .b(new_n353_), .c(new_n316_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n299_), .O(new_n501_));
  aoi21  g344(.a(new_n499_), .b(new_n312_), .c(new_n501_), .O(new_n502_));
  nand4  g345(.a(new_n502_), .b(new_n498_), .c(new_n496_), .d(new_n492_), .O(new_n503_));
  nand4  g346(.a(x126), .b(new_n360_), .c(new_n312_), .d(x014), .O(new_n504_));
  inv1   g347(.a(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n503_), .b(new_n301_), .c(new_n505_), .O(new_n506_));
  nand3  g349(.a(x086), .b(new_n312_), .c(new_n361_), .O(new_n507_));
  oai21  g350(.a(new_n506_), .b(x054), .c(new_n507_), .O(new_n508_));
  aoi21  g351(.a(new_n309_), .b(x030), .c(x022), .O(new_n509_));
  oai21  g352(.a(new_n509_), .b(x078), .c(new_n361_), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n495_), .O(new_n511_));
  nand2  g354(.a(x030), .b(new_n316_), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(new_n329_), .c(new_n308_), .O(new_n513_));
  nand2  g356(.a(new_n327_), .b(new_n325_), .O(new_n514_));
  aoi22  g357(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n515_));
  nand3  g358(.a(new_n515_), .b(new_n514_), .c(x030), .O(new_n516_));
  inv1   g359(.a(new_n516_), .O(new_n517_));
  oai21  g360(.a(new_n517_), .b(new_n513_), .c(new_n301_), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n511_), .c(x054), .O(new_n519_));
  oai21  g362(.a(new_n316_), .b(new_n361_), .c(x030), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n329_), .O(new_n521_));
  nand3  g364(.a(new_n521_), .b(new_n301_), .c(x038), .O(new_n522_));
  inv1   g365(.a(new_n522_), .O(new_n523_));
  oai21  g366(.a(new_n523_), .b(new_n519_), .c(new_n299_), .O(new_n524_));
  oai22  g367(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n525_));
  nand3  g368(.a(new_n525_), .b(x070), .c(x022), .O(new_n526_));
  aoi22  g369(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n527_));
  nand3  g370(.a(new_n527_), .b(new_n526_), .c(new_n524_), .O(new_n528_));
  aoi21  g371(.a(new_n508_), .b(x006), .c(new_n528_), .O(new_n529_));
  oai21  g372(.a(new_n529_), .b(x046), .c(new_n159_), .O(z14));
  zero   g373(.O(z07));
  zero   g374(.O(z15));
  zero   g375(.O(z16));
  zero   g376(.O(z18));
  ...
  zero   g379(.O(z26));
  zero   g380(.O(z27));
  nor2   g381(.a(x126), .b(new_n157_), .O(z19));
  nor2   g382(.a(x126), .b(new_n157_), .O(z20));
  nor2   g383(.a(x126), .b(new_n157_), .O(z22));
  nor2   g384(.a(x126), .b(new_n157_), .O(z24));
  nor2   g385(.a(x126), .b(new_n157_), .O(z25));
endmodule
