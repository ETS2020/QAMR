...
module FAU ( 
  ...
  aoi21  g318(.a(x070), .b(x038), .c(new_n298_), .O(new_n476_));
  nand2  g319(.a(new_n304_), .b(x030), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n341_), .c(x086), .O(new_n478_));
  oai22  g321(.a(new_n478_), .b(new_n476_), .c(x118), .d(x110), .O(new_n479_));
  ...
  nand2  g329(.a(new_n486_), .b(new_n337_), .O(new_n487_));
  nor2   g330(.a(x126), .b(x102), .O(new_n488_));
  nand4  g331(.a(new_n484_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n489_));
  inv1   g332(.a(x094), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(new_n334_), .c(x006), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n489_), .c(new_n488_), .O(new_n492_));
  oai21  g335(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n302_), .O(new_n494_));
  oai22  g337(.a(new_n309_), .b(x110), .c(new_n490_), .d(x062), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(x126), .O(new_n496_));
  aoi21  g339(.a(x030), .b(new_n299_), .c(x086), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n496_), .c(new_n494_), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(x006), .c(new_n492_), .O(new_n499_));
  nand4  g342(.a(new_n499_), .b(new_n487_), .c(new_n483_), .d(new_n479_), .O(new_n500_));
  nand2  g343(.a(x038), .b(x014), .O(new_n501_));
  nand3  g344(.a(new_n501_), .b(x070), .c(x022), .O(new_n502_));
  oai22  g345(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n503_));
  ...
  nand4  g350(.a(new_n507_), .b(new_n504_), .c(new_n502_), .d(new_n172_), .O(new_n508_));
  aoi21  g351(.a(new_n500_), .b(new_n300_), .c(new_n508_), .O(new_n509_));
  nor2   g352(.a(new_n509_), .b(x046), .O(z14));
  zero   g353(.O(z07));
  zero   g354(.O(z15));
  zero   g355(.O(z16));
  zero   g356(.O(z19));
