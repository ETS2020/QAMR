// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:30 2020
...
module FAU ( 
  ...
  inv1   g151(.a(new_n157_), .O(z07));
  inv1   g152(.a(x040), .O(new_n309_));
  nand2  g153(.a(x016), .b(x008), .O(new_n310_));
  inv1   g154(.a(x056), .O(new_n311_));
  inv1   g155(.a(x088), .O(new_n312_));
  nand2  g156(.a(new_n312_), .b(new_n311_), .O(new_n313_));
  oai21  g157(.a(new_n313_), .b(x024), .c(new_n310_), .O(new_n314_));
  nor2   g158(.a(x120), .b(x096), .O(new_n315_));
  nor2   g159(.a(x112), .b(x104), .O(new_n316_));
  oai21  g160(.a(new_n315_), .b(x088), .c(new_n316_), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(new_n167_), .O(new_n318_));
  inv1   g162(.a(x120), .O(new_n319_));
  oai21  g163(.a(new_n319_), .b(x104), .c(x032), .O(new_n320_));
  nand2  g164(.a(new_n320_), .b(x112), .O(new_n321_));
  inv1   g165(.a(x096), .O(new_n322_));
  inv1   g166(.a(x104), .O(new_n323_));
  oai21  g167(.a(new_n322_), .b(x056), .c(new_n323_), .O(new_n324_));
  inv1   g168(.a(x112), .O(new_n325_));
  nand3  g169(.a(x120), .b(new_n325_), .c(new_n166_), .O(new_n326_));
  nand2  g170(.a(new_n326_), .b(new_n159_), .O(new_n327_));
  aoi21  g171(.a(new_n324_), .b(new_n161_), .c(new_n327_), .O(new_n328_));
  nand4  g172(.a(new_n328_), .b(new_n321_), .c(new_n318_), .d(new_n314_), .O(new_n329_));
  nand4  g173(.a(x120), .b(new_n311_), .c(new_n161_), .d(x008), .O(new_n330_));
  inv1   g174(.a(new_n330_), .O(new_n331_));
  aoi21  g175(.a(new_n329_), .b(new_n163_), .c(new_n331_), .O(new_n332_));
  nand3  g176(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n333_));
  oai21  g177(.a(new_n332_), .b(x048), .c(new_n333_), .O(new_n334_));
  nand2  g178(.a(new_n334_), .b(x000), .O(new_n335_));
  nand2  g179(.a(x088), .b(x056), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(x024), .O(new_n337_));
  nand2  g181(.a(new_n337_), .b(new_n166_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n163_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n160_), .c(new_n316_), .O(new_n340_));
  inv1   g184(.a(x024), .O(new_n341_));
  nor2   g185(.a(new_n341_), .b(x016), .O(new_n342_));
  oai21  g186(.a(new_n342_), .b(new_n313_), .c(x064), .O(new_n343_));
  inv1   g187(.a(new_n315_), .O(new_n344_));
  nand4  g188(.a(new_n336_), .b(new_n344_), .c(new_n310_), .d(x024), .O(new_n345_));
  aoi21  g189(.a(new_n345_), .b(new_n343_), .c(x072), .O(new_n346_));
  oai21  g190(.a(new_n346_), .b(new_n340_), .c(new_n162_), .O(new_n347_));
  nand2  g191(.a(new_n310_), .b(x024), .O(new_n348_));
  nand3  g192(.a(new_n348_), .b(new_n312_), .c(new_n311_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(new_n163_), .c(x032), .O(new_n350_));
  nand2  g194(.a(new_n350_), .b(new_n347_), .O(new_n351_));
  oai22  g195(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n352_));
  nand3  g196(.a(new_n352_), .b(x064), .c(x016), .O(new_n353_));
  aoi22  g197(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(new_n353_), .O(new_n355_));
  aoi21  g199(.a(new_n351_), .b(new_n159_), .c(new_n355_), .O(new_n356_));
  nand2  g200(.a(new_n356_), .b(new_n335_), .O(new_n357_));
  nand3  g201(.a(new_n357_), .b(new_n157_), .c(new_n309_), .O(new_n358_));
  inv1   g202(.a(new_n358_), .O(z08));
  inv1   g203(.a(x041), .O(new_n360_));
  oai22  g204(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n361_));
  nand3  g205(.a(new_n361_), .b(x081), .c(x001), .O(new_n362_));
  oai22  g206(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n363_));
  nand3  g207(.a(new_n363_), .b(x065), .c(x017), .O(new_n364_));
  aoi22  g208(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n365_));
  nand3  g209(.a(new_n365_), .b(new_n364_), .c(new_n362_), .O(new_n366_));
  nand3  g210(.a(new_n366_), .b(new_n157_), .c(new_n360_), .O(new_n367_));
  inv1   g211(.a(new_n367_), .O(z09));
  inv1   g212(.a(x042), .O(new_n369_));
  ...
  nand3  g219(.a(new_n375_), .b(new_n157_), .c(new_n369_), .O(new_n376_));
  inv1   g220(.a(new_n376_), .O(z10));
  ...
  oai21  g228(.a(new_n384_), .b(x043), .c(new_n157_), .O(z11));
  ...
  nand3  g236(.a(new_n392_), .b(new_n157_), .c(new_n386_), .O(new_n393_));
  inv1   g237(.a(new_n393_), .O(z12));
  inv1   g238(.a(x045), .O(new_n395_));
  nand2  g239(.a(x021), .b(x013), .O(new_n396_));
  oai21  g240(.a(new_n278_), .b(x029), .c(new_n396_), .O(new_n397_));
  nor2   g241(.a(x125), .b(x101), .O(new_n398_));
  nor2   g242(.a(x117), .b(x109), .O(new_n399_));
  oai21  g243(.a(new_n398_), .b(x093), .c(new_n399_), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(new_n275_), .O(new_n401_));
  oai21  g245(.a(new_n258_), .b(x109), .c(x037), .O(new_n402_));
  nand2  g246(.a(new_n402_), .b(x117), .O(new_n403_));
  inv1   g247(.a(x101), .O(new_n404_));
  oai21  g248(.a(new_n404_), .b(x061), .c(new_n248_), .O(new_n405_));
  nand3  g249(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n406_));
  nand2  g250(.a(new_n406_), .b(new_n266_), .O(new_n407_));
  aoi21  g251(.a(new_n405_), .b(new_n253_), .c(new_n407_), .O(new_n408_));
  nand4  g252(.a(new_n408_), .b(new_n403_), .c(new_n401_), .d(new_n397_), .O(new_n409_));
  nand4  g253(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n410_));
  inv1   g254(.a(new_n410_), .O(new_n411_));
  aoi21  g255(.a(new_n409_), .b(new_n274_), .c(new_n411_), .O(new_n412_));
  nand3  g256(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n413_));
  oai21  g257(.a(new_n412_), .b(x053), .c(new_n413_), .O(new_n414_));
  nand2  g258(.a(new_n414_), .b(x005), .O(new_n415_));
  nand2  g259(.a(new_n244_), .b(x029), .O(new_n416_));
  nand2  g260(.a(new_n416_), .b(new_n242_), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n274_), .O(new_n418_));
  aoi21  g262(.a(new_n418_), .b(new_n241_), .c(new_n399_), .O(new_n419_));
  nor2   g263(.a(new_n240_), .b(x021), .O(new_n420_));
  oai21  g264(.a(new_n420_), .b(new_n278_), .c(x069), .O(new_n421_));
  inv1   g265(.a(new_n398_), .O(new_n422_));
  nand4  g266(.a(new_n422_), .b(new_n396_), .c(new_n244_), .d(x029), .O(new_n423_));
  aoi21  g267(.a(new_n423_), .b(new_n421_), .c(x077), .O(new_n424_));
  oai21  g268(.a(new_n424_), .b(new_n419_), .c(new_n239_), .O(new_n425_));
  nand2  g269(.a(new_n396_), .b(x029), .O(new_n426_));
  nand2  g270(.a(new_n426_), .b(new_n270_), .O(new_n427_));
  nand3  g271(.a(new_n427_), .b(new_n274_), .c(x037), .O(new_n428_));
  nand2  g272(.a(new_n428_), .b(new_n425_), .O(new_n429_));
  oai22  g273(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n430_));
  nand3  g274(.a(new_n430_), .b(x069), .c(x021), .O(new_n431_));
  aoi22  g275(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n432_));
  nand2  g276(.a(new_n432_), .b(new_n431_), .O(new_n433_));
  aoi21  g277(.a(new_n429_), .b(new_n266_), .c(new_n433_), .O(new_n434_));
  nand2  g278(.a(new_n434_), .b(new_n415_), .O(new_n435_));
  nand3  g279(.a(new_n435_), .b(new_n157_), .c(new_n395_), .O(new_n436_));
  inv1   g280(.a(new_n436_), .O(z13));
  oai21  g281(.a(x046), .b(x014), .c(x078), .O(new_n438_));
  inv1   g282(.a(x014), .O(new_n439_));
  inv1   g283(.a(x030), .O(new_n440_));
  nor2   g284(.a(x094), .b(x062), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n440_), .O(new_n442_));
  oai21  g286(.a(new_n299_), .b(new_n439_), .c(new_n442_), .O(new_n443_));
  inv1   g287(.a(x102), .O(new_n444_));
  inv1   g288(.a(x126), .O(new_n445_));
  aoi21  g289(.a(new_n445_), .b(new_n444_), .c(x094), .O(new_n446_));
  inv1   g290(.a(x110), .O(new_n447_));
  inv1   g291(.a(x118), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  oai21  g293(.a(new_n449_), .b(new_n446_), .c(new_n300_), .O(new_n450_));
  oai21  g294(.a(new_n445_), .b(x110), .c(x038), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(x118), .O(new_n452_));
  oai21  g296(.a(new_n444_), .b(x062), .c(new_n447_), .O(new_n453_));
  nand3  g297(.a(x126), .b(new_n448_), .c(new_n299_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n303_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n296_), .c(new_n455_), .O(new_n456_));
  nand4  g300(.a(new_n456_), .b(new_n452_), .c(new_n450_), .d(new_n443_), .O(new_n457_));
  nor2   g301(.a(x038), .b(new_n439_), .O(new_n458_));
  nor2   g302(.a(new_n445_), .b(x062), .O(new_n459_));
  aoi22  g303(.a(new_n459_), .b(new_n458_), .c(new_n457_), .d(new_n295_), .O(new_n460_));
  nand3  g304(.a(x086), .b(new_n296_), .c(new_n439_), .O(new_n461_));
  oai21  g305(.a(new_n460_), .b(x054), .c(new_n461_), .O(new_n462_));
  nand2  g306(.a(x094), .b(x062), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(x030), .c(x022), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(x078), .c(new_n439_), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(new_n449_), .O(new_n466_));
  nand2  g310(.a(new_n296_), .b(x030), .O(new_n467_));
  aoi21  g311(.a(new_n467_), .b(new_n441_), .c(new_n300_), .O(new_n468_));
  nand2  g312(.a(new_n445_), .b(new_n444_), .O(new_n469_));
  aoi22  g313(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n470_));
  nand3  g314(.a(new_n470_), .b(new_n469_), .c(x030), .O(new_n471_));
  inv1   g315(.a(new_n471_), .O(new_n472_));
  oai21  g316(.a(new_n472_), .b(new_n468_), .c(new_n295_), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n466_), .c(x054), .O(new_n474_));
  oai21  g318(.a(new_n299_), .b(new_n439_), .c(x030), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n441_), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n295_), .c(x038), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(new_n478_));
  oai21  g322(.a(new_n478_), .b(new_n474_), .c(new_n303_), .O(new_n479_));
  oai22  g323(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n480_));
  nand3  g324(.a(new_n480_), .b(x070), .c(x022), .O(new_n481_));
  nand2  g325(.a(x054), .b(x038), .O(new_n482_));
  nand3  g326(.a(new_n482_), .b(new_n481_), .c(new_n479_), .O(new_n483_));
  aoi21  g327(.a(new_n462_), .b(x006), .c(new_n483_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(x046), .c(new_n438_), .O(z14));
  zero   g329(.O(z17));
  zero   g330(.O(z19));
  zero   g331(.O(z20));
  zero   g332(.O(z21));
  ...
  zero   g334(.O(z23));
  zero   g335(.O(z24));
  inv1   g336(.a(new_n157_), .O(z15));
  inv1   g337(.a(new_n157_), .O(z16));
  inv1   g338(.a(new_n157_), .O(z18));
  inv1   g339(.a(new_n157_), .O(z25));
  inv1   g340(.a(new_n157_), .O(z26));
  inv1   g341(.a(new_n157_), .O(z27));
endmodule
