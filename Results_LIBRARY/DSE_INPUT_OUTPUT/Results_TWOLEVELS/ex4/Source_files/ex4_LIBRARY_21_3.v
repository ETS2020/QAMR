// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:11 2020
...
module FAU ( 
  ...
  oai21  g140(.a(new_n296_), .b(new_n241_), .c(new_n160_), .O(z05));
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x056), .O(new_n305_));
  ...
  and2   g197(.a(new_n353_), .b(new_n158_), .O(new_n354_));
  aoi21  g198(.a(new_n350_), .b(new_n157_), .c(new_n354_), .O(new_n355_));
  ...
  nand4  g220(.a(x120), .b(new_n157_), .c(new_n164_), .d(x008), .O(new_n377_));
  ...
  oai21  g228(.a(new_n384_), .b(x072), .c(new_n163_), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g230(.a(x024), .b(new_n169_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n359_), .c(new_n170_), .O(new_n388_));
  ...
  oai21  g235(.a(new_n391_), .b(new_n388_), .c(new_n166_), .O(new_n392_));
  ...
  oai21  g241(.a(new_n397_), .b(new_n393_), .c(new_n162_), .O(new_n398_));
  ...
  oai21  g247(.a(new_n403_), .b(x040), .c(new_n160_), .O(z08));
  ...
  nand3  g255(.a(new_n411_), .b(new_n160_), .c(new_n405_), .O(new_n412_));
  ...
  oai21  g264(.a(new_n420_), .b(x042), .c(new_n160_), .O(z10));
  ...
  nand3  g321(.a(new_n477_), .b(new_n160_), .c(new_n241_), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(z13));
  aoi21  g323(.a(new_n298_), .b(x014), .c(x056), .O(new_n480_));
  ...
  aoi21  g341(.a(new_n495_), .b(new_n158_), .c(new_n497_), .O(new_n498_));
  ...
  oai21  g352(.a(new_n508_), .b(new_n505_), .c(new_n158_), .O(new_n509_));
  ...
  nand3  g356(.a(new_n512_), .b(new_n158_), .c(x038), .O(new_n513_));
  ...
  oai22  g364(.a(new_n520_), .b(x046), .c(new_n480_), .d(new_n158_), .O(z14));
  zero   g365(.O(z17));
  zero   g366(.O(z18));
  zero   g367(.O(z20));
  zero   g368(.O(z23));
  ...
  nor2   g374(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g375(.a(new_n158_), .b(new_n157_), .O(z19));
  nor2   g376(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g377(.a(new_n158_), .b(new_n157_), .O(z22));
endmodule
