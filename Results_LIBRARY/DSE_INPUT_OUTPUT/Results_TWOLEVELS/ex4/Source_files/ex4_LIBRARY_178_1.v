// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:17 2020
...
module FAU ( 
  ...
  nand2  g187(.a(new_n157_), .b(new_n343_), .O(new_n344_));
  ...
  oai21  g194(.a(new_n168_), .b(new_n162_), .c(new_n350_), .O(new_n351_));
  ...
  oai21  g201(.a(new_n357_), .b(new_n354_), .c(new_n169_), .O(new_n358_));
  ...
  nand3  g205(.a(x120), .b(new_n356_), .c(new_n168_), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(new_n161_), .O(new_n363_));
  aoi21  g207(.a(new_n361_), .b(new_n163_), .c(new_n363_), .O(new_n364_));
  nand4  g208(.a(new_n364_), .b(new_n360_), .c(new_n358_), .d(new_n351_), .O(new_n365_));
  nor2   g209(.a(x032), .b(new_n162_), .O(new_n366_));
  nor2   g210(.a(new_n353_), .b(x056), .O(new_n367_));
  aoi22  g211(.a(new_n367_), .b(new_n366_), .c(new_n365_), .d(new_n165_), .O(new_n368_));
  nand3  g212(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n369_));
  ...
  oai21  g216(.a(new_n372_), .b(x072), .c(new_n162_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n357_), .O(new_n374_));
  nand2  g218(.a(x024), .b(new_n168_), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n349_), .c(new_n169_), .O(new_n376_));
  ...
  oai21  g224(.a(new_n380_), .b(new_n376_), .c(new_n165_), .O(new_n381_));
  aoi21  g225(.a(new_n381_), .b(new_n374_), .c(x048), .O(new_n382_));
  oai21  g226(.a(new_n168_), .b(new_n162_), .c(x024), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n349_), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(new_n165_), .c(x032), .O(new_n385_));
  inv1   g229(.a(new_n385_), .O(new_n386_));
  oai21  g230(.a(new_n386_), .b(new_n382_), .c(new_n161_), .O(new_n387_));
  ...
  oai21  g236(.a(new_n392_), .b(x040), .c(new_n159_), .O(z08));
  ...
  oai21  g244(.a(new_n400_), .b(x041), .c(new_n159_), .O(z09));
  oai22  g245(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(x082), .c(x002), .O(new_n403_));
  oai22  g247(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(x066), .c(x018), .O(new_n405_));
  ...
  oai21  g252(.a(new_n408_), .b(x042), .c(new_n159_), .O(z10));
  oai22  g253(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n410_));
  nand3  g254(.a(new_n410_), .b(x083), .c(x003), .O(new_n411_));
  oai22  g255(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n412_));
  nand3  g256(.a(new_n412_), .b(x067), .c(x019), .O(new_n413_));
  aoi22  g257(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n414_));
  nand3  g258(.a(new_n414_), .b(new_n413_), .c(new_n411_), .O(new_n415_));
  inv1   g259(.a(new_n415_), .O(new_n416_));
  oai21  g260(.a(new_n416_), .b(x043), .c(new_n159_), .O(z11));
  oai22  g261(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n418_));
  nand3  g262(.a(new_n418_), .b(x084), .c(x004), .O(new_n419_));
  oai22  g263(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n420_));
  nand3  g264(.a(new_n420_), .b(x068), .c(x020), .O(new_n421_));
  aoi22  g265(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n422_));
  nand3  g266(.a(new_n422_), .b(new_n421_), .c(new_n419_), .O(new_n423_));
  inv1   g267(.a(new_n423_), .O(new_n424_));
  oai21  g268(.a(new_n424_), .b(x044), .c(new_n159_), .O(z12));
  inv1   g269(.a(x045), .O(new_n426_));
  nand2  g270(.a(x021), .b(x013), .O(new_n427_));
  oai21  g271(.a(new_n280_), .b(x029), .c(new_n427_), .O(new_n428_));
  nor2   g272(.a(x125), .b(x101), .O(new_n429_));
  nor2   g273(.a(x117), .b(x109), .O(new_n430_));
  oai21  g274(.a(new_n429_), .b(x093), .c(new_n430_), .O(new_n431_));
  nand2  g275(.a(new_n431_), .b(new_n277_), .O(new_n432_));
  oai21  g276(.a(new_n260_), .b(x109), .c(x037), .O(new_n433_));
  nand2  g277(.a(new_n433_), .b(x117), .O(new_n434_));
  inv1   g278(.a(x101), .O(new_n435_));
  oai21  g279(.a(new_n435_), .b(x061), .c(new_n250_), .O(new_n436_));
  nand3  g280(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n437_));
  nand2  g281(.a(new_n437_), .b(new_n268_), .O(new_n438_));
  aoi21  g282(.a(new_n436_), .b(new_n255_), .c(new_n438_), .O(new_n439_));
  nand4  g283(.a(new_n439_), .b(new_n434_), .c(new_n432_), .d(new_n428_), .O(new_n440_));
  nand4  g284(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n441_));
  inv1   g285(.a(new_n441_), .O(new_n442_));
  aoi21  g286(.a(new_n440_), .b(new_n276_), .c(new_n442_), .O(new_n443_));
  nand3  g287(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n444_));
  oai21  g288(.a(new_n443_), .b(x053), .c(new_n444_), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x005), .O(new_n446_));
  nand2  g290(.a(new_n246_), .b(x029), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n244_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n276_), .O(new_n449_));
  aoi21  g293(.a(new_n449_), .b(new_n243_), .c(new_n430_), .O(new_n450_));
  nor2   g294(.a(new_n242_), .b(x021), .O(new_n451_));
  oai21  g295(.a(new_n451_), .b(new_n280_), .c(x069), .O(new_n452_));
  inv1   g296(.a(new_n429_), .O(new_n453_));
  nand4  g297(.a(new_n453_), .b(new_n427_), .c(new_n246_), .d(x029), .O(new_n454_));
  aoi21  g298(.a(new_n454_), .b(new_n452_), .c(x077), .O(new_n455_));
  oai21  g299(.a(new_n455_), .b(new_n450_), .c(new_n241_), .O(new_n456_));
  nand2  g300(.a(new_n427_), .b(x029), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n272_), .O(new_n458_));
  nand3  g302(.a(new_n458_), .b(new_n276_), .c(x037), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(new_n456_), .O(new_n460_));
  oai22  g304(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n461_));
  nand3  g305(.a(new_n461_), .b(x069), .c(x021), .O(new_n462_));
  aoi22  g306(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n463_));
  nand2  g307(.a(new_n463_), .b(new_n462_), .O(new_n464_));
  aoi21  g308(.a(new_n460_), .b(new_n268_), .c(new_n464_), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(new_n446_), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(new_n159_), .c(new_n426_), .O(new_n467_));
  inv1   g311(.a(new_n467_), .O(z13));
  inv1   g312(.a(x118), .O(new_n469_));
  oai21  g313(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n470_));
  nand2  g314(.a(new_n301_), .b(x030), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n299_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n312_), .O(new_n473_));
  aoi22  g317(.a(new_n473_), .b(new_n470_), .c(new_n469_), .d(new_n314_), .O(new_n474_));
  nand3  g318(.a(new_n312_), .b(x070), .c(x030), .O(new_n475_));
  nand3  g319(.a(x102), .b(new_n305_), .c(x006), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n475_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n304_), .O(new_n478_));
  nand2  g322(.a(new_n325_), .b(x006), .O(new_n479_));
  oai21  g323(.a(x086), .b(new_n306_), .c(new_n479_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n329_), .O(new_n481_));
  nand4  g325(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n482_));
  nand3  g326(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(new_n482_), .O(new_n484_));
  oai21  g328(.a(x126), .b(x102), .c(new_n484_), .O(new_n485_));
  nand2  g329(.a(x126), .b(new_n469_), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n298_), .c(x022), .O(new_n487_));
  nand2  g331(.a(x030), .b(new_n343_), .O(new_n488_));
  nand3  g332(.a(x126), .b(x094), .c(new_n305_), .O(new_n489_));
  nand3  g333(.a(new_n489_), .b(new_n488_), .c(new_n312_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n487_), .c(x006), .O(new_n491_));
  nand4  g335(.a(new_n491_), .b(new_n485_), .c(new_n481_), .d(new_n478_), .O(new_n492_));
  oai21  g336(.a(new_n492_), .b(new_n474_), .c(new_n340_), .O(new_n493_));
  nand3  g337(.a(x126), .b(new_n314_), .c(x038), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n312_), .c(new_n297_), .O(new_n495_));
  nand3  g339(.a(new_n312_), .b(x038), .c(x030), .O(new_n496_));
  oai21  g340(.a(new_n306_), .b(new_n336_), .c(new_n496_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n495_), .c(new_n343_), .O(new_n498_));
  nand2  g342(.a(x030), .b(new_n336_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n323_), .c(x086), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(x054), .c(x038), .O(new_n501_));
  nor2   g345(.a(new_n306_), .b(x038), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(x022), .c(x078), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n501_), .c(new_n498_), .O(new_n504_));
  inv1   g348(.a(new_n504_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n493_), .c(x046), .O(z14));
  zero   g350(.O(z15));
  zero   g351(.O(z16));
  zero   g352(.O(z17));
  zero   g353(.O(z19));
  ...
  zero   g356(.O(z24));
  zero   g357(.O(z25));
  nor2   g358(.a(new_n157_), .b(x046), .O(z18));
  nor2   g359(.a(new_n157_), .b(x046), .O(z20));
  nor2   g360(.a(new_n157_), .b(x046), .O(z23));
  nor2   g361(.a(new_n157_), .b(x046), .O(z26));
  nor2   g362(.a(new_n157_), .b(x046), .O(z27));
endmodule
