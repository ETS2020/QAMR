...
module FAU ( 
  ...
  inv1   g015(.a(x092), .O(new_n172_));
  nor2   g016(.a(x122), .b(new_n172_), .O(z07));
  ...
  zero   g362(.O(z23));
  zero   g363(.O(z26));
  nor2   g364(.a(x122), .b(new_n172_), .O(z15));
  nor2   g365(.a(x122), .b(new_n172_), .O(z16));
  nor2   g366(.a(x122), .b(new_n172_), .O(z17));
  nor2   g367(.a(x122), .b(new_n172_), .O(z18));
  nor2   g368(.a(x122), .b(new_n172_), .O(z24));
  nor2   g369(.a(x122), .b(new_n172_), .O(z25));
  nor2   g370(.a(x122), .b(new_n172_), .O(z27));
endmodule
