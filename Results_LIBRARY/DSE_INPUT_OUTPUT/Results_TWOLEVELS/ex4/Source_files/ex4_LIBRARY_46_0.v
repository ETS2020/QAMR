// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:26 2020
...
module FAU ( 
  ...
  nand2  g171(.a(new_n327_), .b(x039), .O(new_n328_));
  ...
  nand4  g182(.a(new_n327_), .b(x118), .c(x039), .d(new_n297_), .O(new_n339_));
  ...
  nand4  g198(.a(new_n354_), .b(new_n327_), .c(x039), .d(new_n297_), .O(new_n355_));
  ...
  nand4  g202(.a(new_n327_), .b(x062), .c(x054), .d(x039), .O(new_n359_));
  ...
  oai21  g211(.a(new_n368_), .b(x024), .c(new_n365_), .O(new_n369_));
  ...
  nand2  g215(.a(new_n372_), .b(new_n168_), .O(new_n373_));
  ...
  nand4  g227(.a(x120), .b(new_n366_), .c(new_n162_), .d(x008), .O(new_n385_));
  ...
  aoi21  g237(.a(new_n394_), .b(new_n161_), .c(new_n371_), .O(new_n395_));
  inv1   g238(.a(x024), .O(new_n396_));
  nor2   g239(.a(new_n396_), .b(x016), .O(new_n397_));
  oai21  g240(.a(new_n397_), .b(new_n368_), .c(x064), .O(new_n398_));
  inv1   g241(.a(new_n370_), .O(new_n399_));
  nand4  g242(.a(new_n391_), .b(new_n399_), .c(new_n365_), .d(x024), .O(new_n400_));
  aoi21  g243(.a(new_n400_), .b(new_n398_), .c(x072), .O(new_n401_));
  oai21  g244(.a(new_n401_), .b(new_n395_), .c(new_n163_), .O(new_n402_));
  nand2  g245(.a(new_n365_), .b(x024), .O(new_n403_));
  nand3  g246(.a(new_n403_), .b(new_n367_), .c(new_n366_), .O(new_n404_));
  nand3  g247(.a(new_n404_), .b(new_n164_), .c(x032), .O(new_n405_));
  ...
  aoi21  g253(.a(new_n406_), .b(new_n160_), .c(new_n410_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n390_), .O(new_n412_));
  nand3  g255(.a(new_n412_), .b(new_n158_), .c(new_n364_), .O(new_n413_));
  inv1   g256(.a(new_n413_), .O(z08));
  inv1   g257(.a(x041), .O(new_n415_));
  ...
  oai21  g273(.a(new_n430_), .b(x042), .c(new_n158_), .O(z10));
  ...
  oai21  g290(.a(new_n447_), .b(x044), .c(new_n158_), .O(z12));
  oai22  g291(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n449_));
  inv1   g292(.a(x101), .O(new_n450_));
  aoi21  g293(.a(new_n259_), .b(new_n450_), .c(x093), .O(new_n451_));
  nand2  g294(.a(new_n250_), .b(new_n249_), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n451_), .c(new_n276_), .O(new_n453_));
  oai21  g296(.a(new_n259_), .b(x109), .c(x037), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(x117), .O(new_n455_));
  oai21  g298(.a(new_n450_), .b(x061), .c(new_n249_), .O(new_n456_));
  nand3  g299(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n267_), .O(new_n458_));
  aoi21  g301(.a(new_n456_), .b(new_n254_), .c(new_n458_), .O(new_n459_));
  nand4  g302(.a(new_n459_), .b(new_n455_), .c(new_n453_), .d(new_n449_), .O(new_n460_));
  nand4  g303(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n461_));
  inv1   g304(.a(new_n461_), .O(new_n462_));
  aoi21  g305(.a(new_n460_), .b(new_n275_), .c(new_n462_), .O(new_n463_));
  nand3  g306(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n464_));
  oai21  g307(.a(new_n463_), .b(x053), .c(new_n464_), .O(new_n465_));
  aoi21  g308(.a(new_n245_), .b(x029), .c(x021), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x077), .c(new_n242_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n452_), .O(new_n468_));
  nand2  g311(.a(x029), .b(new_n243_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n271_), .c(new_n276_), .O(new_n470_));
  nand2  g313(.a(new_n259_), .b(new_n450_), .O(new_n471_));
  aoi22  g314(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n471_), .c(x029), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n470_), .c(new_n275_), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n468_), .c(x053), .O(new_n476_));
  oai21  g319(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n271_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n275_), .c(x037), .O(new_n479_));
  inv1   g322(.a(new_n479_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n476_), .c(new_n267_), .O(new_n481_));
  ...
  aoi21  g328(.a(new_n465_), .b(x005), .c(new_n485_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(x045), .c(new_n158_), .O(z13));
  inv1   g330(.a(x014), .O(new_n488_));
  nand2  g331(.a(new_n311_), .b(new_n488_), .O(new_n489_));
  ...
  oai21  g336(.a(x078), .b(new_n315_), .c(new_n488_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand3  g338(.a(new_n348_), .b(new_n300_), .c(x070), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n495_), .c(x054), .O(new_n497_));
  nor3   g340(.a(new_n324_), .b(x078), .c(new_n311_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n497_), .c(new_n298_), .O(new_n499_));
  ...
  inv1   g348(.a(x039), .O(new_n506_));
  oai21  g349(.a(new_n325_), .b(new_n506_), .c(new_n327_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n308_), .c(new_n298_), .O(new_n508_));
  nand2  g351(.a(x039), .b(x006), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n508_), .c(new_n334_), .O(new_n510_));
  nor3   g353(.a(new_n324_), .b(new_n506_), .c(new_n297_), .O(new_n511_));
  oai21  g354(.a(new_n511_), .b(new_n510_), .c(new_n299_), .O(new_n512_));
  nand4  g355(.a(new_n298_), .b(x039), .c(x038), .d(x030), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n512_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n505_), .O(new_n515_));
  nand4  g358(.a(new_n298_), .b(x070), .c(x039), .d(x030), .O(new_n516_));
  nand3  g359(.a(x126), .b(new_n352_), .c(x006), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n516_), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n315_), .O(new_n519_));
  oai22  g362(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(x102), .O(new_n521_));
  oai21  g364(.a(new_n307_), .b(new_n311_), .c(new_n493_), .O(new_n522_));
  aoi21  g365(.a(new_n522_), .b(new_n521_), .c(new_n297_), .O(new_n523_));
  nand4  g366(.a(new_n493_), .b(new_n308_), .c(new_n298_), .d(x030), .O(new_n524_));
  inv1   g367(.a(new_n524_), .O(new_n525_));
  oai21  g368(.a(new_n525_), .b(new_n523_), .c(x039), .O(new_n526_));
  inv1   g369(.a(x094), .O(new_n527_));
  nand2  g370(.a(new_n527_), .b(new_n307_), .O(new_n528_));
  ...
  nand3  g377(.a(new_n311_), .b(x014), .c(x006), .O(new_n535_));
  nor4   g378(.a(new_n535_), .b(new_n327_), .c(x062), .d(x054), .O(new_n536_));
  aoi21  g379(.a(new_n534_), .b(new_n300_), .c(new_n536_), .O(new_n537_));
  ...
  zero   g386(.O(z20));
  zero   g387(.O(z23));
  nor2   g388(.a(x126), .b(x039), .O(z21));
  nor2   g389(.a(x126), .b(x039), .O(z22));
  nor2   g390(.a(x126), .b(x039), .O(z24));
  nor2   g391(.a(x126), .b(x039), .O(z25));
  nor2   g392(.a(x126), .b(x039), .O(z26));
  nor2   g393(.a(x126), .b(x039), .O(z27));
endmodule
