// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:58 2020
...
module FAU ( 
  ...
  nand2  g207(.a(new_n363_), .b(new_n169_), .O(new_n364_));
  ...
  nand3  g215(.a(x120), .b(new_n371_), .c(new_n168_), .O(new_n372_));
  nand2  g216(.a(new_n372_), .b(new_n161_), .O(new_n373_));
  aoi21  g217(.a(new_n370_), .b(new_n163_), .c(new_n373_), .O(new_n374_));
  nand4  g218(.a(new_n374_), .b(new_n367_), .c(new_n364_), .d(new_n360_), .O(new_n375_));
  nand4  g219(.a(x120), .b(new_n357_), .c(new_n163_), .d(x008), .O(new_n376_));
  inv1   g220(.a(new_n376_), .O(new_n377_));
  aoi21  g221(.a(new_n375_), .b(new_n165_), .c(new_n377_), .O(new_n378_));
  nand3  g222(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n379_));
  ...
  nand2  g227(.a(new_n383_), .b(new_n168_), .O(new_n384_));
  nand2  g228(.a(new_n384_), .b(new_n165_), .O(new_n385_));
  aoi21  g229(.a(new_n385_), .b(new_n162_), .c(new_n362_), .O(new_n386_));
  ...
  oai21  g236(.a(new_n392_), .b(new_n386_), .c(new_n164_), .O(new_n393_));
  ...
  nand3  g247(.a(new_n403_), .b(new_n159_), .c(new_n355_), .O(new_n404_));
  ...
  oai21  g282(.a(new_n438_), .b(x044), .c(new_n159_), .O(z12));
  inv1   g283(.a(x077), .O(new_n440_));
  oai22  g284(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n441_));
  inv1   g285(.a(x101), .O(new_n442_));
  aoi21  g286(.a(new_n258_), .b(new_n442_), .c(x093), .O(new_n443_));
  nand2  g287(.a(new_n157_), .b(new_n253_), .O(new_n444_));
  oai21  g288(.a(new_n444_), .b(new_n443_), .c(new_n270_), .O(new_n445_));
  oai21  g289(.a(new_n258_), .b(x109), .c(x037), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(x117), .O(new_n447_));
  oai21  g291(.a(new_n442_), .b(x061), .c(new_n253_), .O(new_n448_));
  nand3  g292(.a(x125), .b(new_n157_), .c(new_n244_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n266_), .O(new_n450_));
  aoi21  g294(.a(new_n448_), .b(new_n252_), .c(new_n450_), .O(new_n451_));
  nand4  g295(.a(new_n451_), .b(new_n447_), .c(new_n445_), .d(new_n441_), .O(new_n452_));
  nand4  g296(.a(x125), .b(new_n256_), .c(new_n252_), .d(x013), .O(new_n453_));
  inv1   g297(.a(new_n453_), .O(new_n454_));
  aoi21  g298(.a(new_n452_), .b(new_n440_), .c(new_n454_), .O(new_n455_));
  nand3  g299(.a(x085), .b(new_n252_), .c(new_n243_), .O(new_n456_));
  ...
  aoi21  g305(.a(new_n461_), .b(new_n276_), .c(new_n270_), .O(new_n462_));
  nand2  g306(.a(new_n258_), .b(new_n442_), .O(new_n463_));
  ...
  oai21  g310(.a(new_n466_), .b(new_n462_), .c(new_n440_), .O(new_n467_));
  ...
  nand3  g314(.a(new_n470_), .b(new_n440_), .c(x037), .O(new_n471_));
  inv1   g315(.a(new_n471_), .O(new_n472_));
  oai21  g316(.a(new_n472_), .b(new_n468_), .c(new_n266_), .O(new_n473_));
  ...
  nand2  g323(.a(new_n313_), .b(new_n301_), .O(new_n480_));
  oai21  g324(.a(x078), .b(x054), .c(new_n480_), .O(new_n481_));
  nand3  g325(.a(new_n481_), .b(x086), .c(x006), .O(new_n482_));
  nand2  g326(.a(new_n309_), .b(new_n308_), .O(new_n483_));
  oai21  g327(.a(x078), .b(new_n302_), .c(new_n301_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  nand3  g329(.a(new_n338_), .b(new_n334_), .c(x070), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n485_), .c(x054), .O(new_n487_));
  nor3   g331(.a(new_n330_), .b(x078), .c(new_n313_), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n487_), .c(new_n326_), .O(new_n489_));
  oai22  g333(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n490_));
  nand3  g334(.a(new_n490_), .b(x070), .c(x022), .O(new_n491_));
  aoi22  g335(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n491_), .c(new_n489_), .d(new_n482_), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n159_), .O(new_n494_));
  nand2  g338(.a(x022), .b(x014), .O(new_n495_));
  inv1   g339(.a(x102), .O(new_n496_));
  oai21  g340(.a(x117), .b(new_n496_), .c(new_n318_), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n304_), .c(new_n326_), .O(new_n498_));
  nand2  g342(.a(new_n157_), .b(x006), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(new_n300_), .O(new_n500_));
  nor3   g344(.a(new_n330_), .b(x117), .c(new_n298_), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(new_n500_), .c(new_n299_), .O(new_n502_));
  nand4  g346(.a(new_n157_), .b(new_n326_), .c(x038), .d(x030), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n495_), .O(new_n505_));
  nand4  g349(.a(new_n157_), .b(new_n326_), .c(x070), .d(x030), .O(new_n506_));
  nand3  g350(.a(x126), .b(new_n309_), .c(x006), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n506_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n302_), .O(new_n509_));
  oai22  g353(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(x102), .O(new_n511_));
  oai21  g355(.a(new_n335_), .b(new_n313_), .c(new_n483_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n511_), .c(new_n298_), .O(new_n513_));
  nand4  g357(.a(new_n483_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n514_));
  inv1   g358(.a(new_n514_), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n513_), .c(new_n157_), .O(new_n516_));
  inv1   g360(.a(x094), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n335_), .O(new_n518_));
  nand2  g362(.a(x118), .b(new_n308_), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(new_n518_), .c(new_n480_), .O(new_n520_));
  nand3  g364(.a(new_n520_), .b(x126), .c(x006), .O(new_n521_));
  nand3  g365(.a(new_n521_), .b(new_n516_), .c(new_n509_), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n299_), .O(new_n523_));
  nand2  g367(.a(new_n523_), .b(new_n505_), .O(new_n524_));
  nand3  g368(.a(new_n313_), .b(x014), .c(x006), .O(new_n525_));
  nor4   g369(.a(new_n525_), .b(new_n318_), .c(x062), .d(x054), .O(new_n526_));
  aoi21  g370(.a(new_n524_), .b(new_n334_), .c(new_n526_), .O(new_n527_));
  aoi21  g371(.a(new_n527_), .b(new_n494_), .c(x046), .O(z14));
  zero   g372(.O(z18));
  zero   g373(.O(z20));
  zero   g374(.O(z22));
  zero   g375(.O(z26));
  nor2   g376(.a(x126), .b(new_n157_), .O(z15));
  nor2   g377(.a(x126), .b(new_n157_), .O(z16));
  nor2   g378(.a(x126), .b(new_n157_), .O(z17));
  nor2   g379(.a(x126), .b(new_n157_), .O(z19));
  nor2   g380(.a(x126), .b(new_n157_), .O(z21));
  nor2   g381(.a(x126), .b(new_n157_), .O(z23));
  nor2   g382(.a(x126), .b(new_n157_), .O(z24));
  nor2   g383(.a(x126), .b(new_n157_), .O(z25));
  nor2   g384(.a(x126), .b(new_n157_), .O(z27));
endmodule
