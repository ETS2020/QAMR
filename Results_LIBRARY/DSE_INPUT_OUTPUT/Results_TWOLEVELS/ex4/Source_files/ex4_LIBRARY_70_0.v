// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:16 2020
...
module FAU ( 
  ...
  nand3  g194(.a(new_n350_), .b(new_n158_), .c(x046), .O(new_n351_));
  inv1   g195(.a(new_n351_), .O(z06));
  ...
  nand3  g317(.a(new_n473_), .b(new_n158_), .c(new_n433_), .O(new_n474_));
  ...
  zero   g361(.O(z24));
  zero   g362(.O(z27));
  nor2   g363(.a(x107), .b(x058), .O(z15));
  nor2   g364(.a(x107), .b(x058), .O(z18));
  nor2   g365(.a(x107), .b(x058), .O(z20));
  nor2   g366(.a(x107), .b(x058), .O(z21));
  nor2   g367(.a(x107), .b(x058), .O(z22));
  nor2   g368(.a(x107), .b(x058), .O(z23));
  nor2   g369(.a(x107), .b(x058), .O(z25));
  nor2   g370(.a(x107), .b(x058), .O(z26));
endmodule
