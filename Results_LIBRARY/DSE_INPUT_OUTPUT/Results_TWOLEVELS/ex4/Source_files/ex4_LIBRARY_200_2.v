// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:01 2020
...
module FAU ( 
  ...
  oai21  g047(.a(x074), .b(x010), .c(x126), .O(new_n204_));
  aoi21  g048(.a(new_n196_), .b(new_n195_), .c(new_n204_), .O(new_n205_));
  nand3  g049(.a(new_n205_), .b(new_n203_), .c(new_n199_), .O(new_n206_));
  ...
  and2   g258(.a(new_n414_), .b(new_n172_), .O(z10));
  ...
  oai21  g337(.a(new_n493_), .b(x042), .c(new_n317_), .O(new_n494_));
  ...
  nor3   g341(.a(new_n329_), .b(x042), .c(new_n297_), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(new_n497_), .c(new_n298_), .O(new_n499_));
  nand4  g343(.a(new_n325_), .b(new_n172_), .c(x038), .d(x030), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n492_), .O(new_n502_));
  nand4  g346(.a(new_n325_), .b(x070), .c(new_n172_), .d(x030), .O(new_n503_));
  ...
  zero   g371(.O(z23));
  zero   g372(.O(z27));
  nor2   g373(.a(x126), .b(new_n172_), .O(z15));
  nor2   g374(.a(x126), .b(new_n172_), .O(z16));
  nor2   g375(.a(x126), .b(new_n172_), .O(z18));
  nor2   g376(.a(x126), .b(new_n172_), .O(z20));
  nor2   g377(.a(x126), .b(new_n172_), .O(z21));
  nor2   g378(.a(x126), .b(new_n172_), .O(z22));
