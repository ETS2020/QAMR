// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:52 2020
...
module FAU ( 
  ...
  oai22  g286(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n443_));
  nand3  g287(.a(new_n443_), .b(x085), .c(x005), .O(new_n444_));
  aoi22  g288(.a(new_n275_), .b(new_n254_), .c(new_n240_), .d(new_n242_), .O(new_n445_));
  nand3  g289(.a(new_n279_), .b(new_n267_), .c(new_n275_), .O(new_n446_));
  oai22  g290(.a(new_n446_), .b(x053), .c(new_n445_), .d(new_n243_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x069), .O(new_n448_));
  nand2  g292(.a(new_n446_), .b(new_n240_), .O(new_n449_));
  aoi22  g293(.a(new_n449_), .b(x037), .c(x077), .d(x013), .O(new_n450_));
  nand3  g294(.a(new_n450_), .b(new_n448_), .c(new_n444_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n158_), .O(new_n452_));
  oai21  g296(.a(new_n326_), .b(new_n249_), .c(new_n250_), .O(new_n453_));
  aoi21  g297(.a(x069), .b(x037), .c(new_n239_), .O(new_n454_));
  nand2  g298(.a(new_n245_), .b(x029), .O(new_n455_));
  aoi21  g299(.a(new_n455_), .b(new_n243_), .c(x085), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(new_n454_), .c(new_n275_), .O(new_n457_));
  oai21  g301(.a(x085), .b(new_n242_), .c(new_n457_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n453_), .O(new_n459_));
  nand2  g303(.a(x021), .b(x013), .O(new_n460_));
  inv1   g304(.a(x093), .O(new_n461_));
  nand3  g305(.a(new_n461_), .b(new_n257_), .c(new_n241_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n460_), .O(new_n463_));
  inv1   g307(.a(x101), .O(new_n464_));
  nand2  g308(.a(new_n259_), .b(new_n464_), .O(new_n465_));
  nand3  g309(.a(new_n465_), .b(new_n461_), .c(new_n276_), .O(new_n466_));
  nand3  g310(.a(x101), .b(new_n257_), .c(new_n254_), .O(new_n467_));
  ...
  nand4  g313(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n470_));
  inv1   g314(.a(new_n470_), .O(new_n471_));
  aoi21  g315(.a(new_n469_), .b(new_n275_), .c(new_n471_), .O(new_n472_));
  nand3  g316(.a(new_n465_), .b(new_n460_), .c(new_n245_), .O(new_n473_));
  oai21  g317(.a(new_n276_), .b(x021), .c(new_n473_), .O(new_n474_));
  nand4  g318(.a(new_n474_), .b(new_n267_), .c(new_n275_), .d(x029), .O(new_n475_));
  oai21  g319(.a(new_n472_), .b(new_n239_), .c(new_n475_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(x126), .O(new_n477_));
  nor2   g321(.a(new_n259_), .b(new_n250_), .O(new_n478_));
  nand4  g322(.a(new_n478_), .b(new_n249_), .c(new_n275_), .d(x005), .O(new_n479_));
  nand3  g323(.a(new_n479_), .b(new_n477_), .c(new_n459_), .O(new_n480_));
  nand4  g324(.a(new_n460_), .b(x126), .c(new_n267_), .d(new_n275_), .O(new_n481_));
  nor3   g325(.a(new_n481_), .b(new_n254_), .c(new_n241_), .O(new_n482_));
  aoi21  g326(.a(new_n480_), .b(new_n240_), .c(new_n482_), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(new_n452_), .c(x045), .O(z13));
  nand2  g328(.a(new_n311_), .b(new_n359_), .O(new_n485_));
  ...
  oai21  g333(.a(x078), .b(new_n315_), .c(new_n359_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n489_), .O(new_n491_));
  nand3  g335(.a(new_n348_), .b(new_n300_), .c(x070), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n491_), .c(x054), .O(new_n493_));
  nor3   g337(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n493_), .c(new_n298_), .O(new_n495_));
  oai22  g339(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(x070), .c(x022), .O(new_n497_));
  aoi22  g341(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n497_), .c(new_n495_), .d(new_n487_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n158_), .O(new_n500_));
  nand2  g344(.a(x022), .b(x014), .O(new_n501_));
  oai21  g345(.a(new_n250_), .b(new_n324_), .c(new_n326_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n308_), .c(new_n298_), .O(new_n503_));
  nand2  g347(.a(x117), .b(x006), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n503_), .c(new_n334_), .O(new_n505_));
  nor3   g349(.a(new_n328_), .b(new_n250_), .c(new_n297_), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n505_), .c(new_n299_), .O(new_n507_));
  nand4  g351(.a(x117), .b(new_n298_), .c(x038), .d(x030), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n507_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n501_), .O(new_n510_));
  nand4  g354(.a(x117), .b(new_n298_), .c(x070), .d(x030), .O(new_n511_));
  nand3  g355(.a(x126), .b(new_n352_), .c(x006), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n315_), .O(new_n514_));
  oai22  g358(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(x102), .O(new_n516_));
  oai21  g360(.a(new_n307_), .b(new_n311_), .c(new_n489_), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n516_), .c(new_n297_), .O(new_n518_));
  nand4  g362(.a(new_n489_), .b(new_n308_), .c(new_n298_), .d(x030), .O(new_n519_));
  inv1   g363(.a(new_n519_), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(new_n518_), .c(x117), .O(new_n521_));
  inv1   g365(.a(x094), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(new_n307_), .O(new_n523_));
  nand2  g367(.a(x118), .b(new_n488_), .O(new_n524_));
  nand3  g368(.a(new_n524_), .b(new_n523_), .c(new_n485_), .O(new_n525_));
  nand3  g369(.a(new_n525_), .b(x126), .c(x006), .O(new_n526_));
  nand3  g370(.a(new_n526_), .b(new_n521_), .c(new_n514_), .O(new_n527_));
  nand2  g371(.a(new_n527_), .b(new_n299_), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n510_), .O(new_n529_));
  nand3  g373(.a(new_n311_), .b(x014), .c(x006), .O(new_n530_));
  nor4   g374(.a(new_n530_), .b(new_n326_), .c(x062), .d(x054), .O(new_n531_));
  aoi21  g375(.a(new_n529_), .b(new_n300_), .c(new_n531_), .O(new_n532_));
  aoi21  g376(.a(new_n532_), .b(new_n500_), .c(x046), .O(z14));
  zero   g377(.O(z16));
  zero   g378(.O(z17));
  zero   g379(.O(z19));
  zero   g380(.O(z22));
  zero   g381(.O(z25));
  zero   g382(.O(z26));
  nor2   g383(.a(x126), .b(x117), .O(z15));
  nor2   g384(.a(x126), .b(x117), .O(z18));
  nor2   g385(.a(x126), .b(x117), .O(z20));
  nor2   g386(.a(x126), .b(x117), .O(z21));
  nor2   g387(.a(x126), .b(x117), .O(z23));
  nor2   g388(.a(x126), .b(x117), .O(z24));
