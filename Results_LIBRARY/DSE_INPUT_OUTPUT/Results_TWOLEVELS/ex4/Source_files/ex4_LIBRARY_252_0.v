...
module FAU ( 
  ...
  oai22  g198(.a(new_n355_), .b(x024), .c(new_n165_), .d(new_n159_), .O(new_n356_));
  ...
  oai21  g204(.a(new_n361_), .b(new_n359_), .c(new_n166_), .O(new_n362_));
  oai21  g205(.a(new_n358_), .b(x104), .c(x032), .O(new_n363_));
  nand2  g206(.a(new_n363_), .b(x112), .O(new_n364_));
  inv1   g207(.a(x104), .O(new_n365_));
  oai21  g208(.a(new_n357_), .b(x056), .c(new_n365_), .O(new_n366_));
  ...
  nand4  g213(.a(new_n370_), .b(new_n364_), .c(new_n362_), .d(new_n356_), .O(new_n371_));
  ...
  nand3  g219(.a(new_n158_), .b(new_n161_), .c(x024), .O(new_n377_));
  nand2  g220(.a(new_n377_), .b(new_n165_), .O(new_n378_));
  nand2  g221(.a(new_n378_), .b(new_n160_), .O(new_n379_));
  nand3  g222(.a(new_n355_), .b(new_n158_), .c(new_n161_), .O(new_n380_));
  aoi21  g223(.a(new_n380_), .b(new_n379_), .c(new_n166_), .O(new_n381_));
  oai21  g224(.a(new_n354_), .b(new_n353_), .c(x024), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(new_n165_), .c(new_n360_), .O(new_n383_));
  nand2  g226(.a(new_n358_), .b(new_n357_), .O(new_n384_));
  ...
  aoi21  g232(.a(x016), .b(x008), .c(new_n389_), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(new_n355_), .c(x032), .O(new_n391_));
  aoi21  g234(.a(new_n391_), .b(new_n388_), .c(x080), .O(new_n392_));
  oai21  g235(.a(new_n392_), .b(new_n381_), .c(new_n162_), .O(new_n393_));
  nand3  g236(.a(new_n361_), .b(new_n158_), .c(new_n161_), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(new_n162_), .O(new_n395_));
  nand4  g238(.a(x064), .b(new_n161_), .c(x016), .d(new_n159_), .O(new_n396_));
  oai21  g239(.a(new_n161_), .b(new_n160_), .c(new_n396_), .O(new_n397_));
  aoi21  g240(.a(new_n395_), .b(x008), .c(new_n397_), .O(new_n398_));
  nand2  g241(.a(new_n398_), .b(new_n393_), .O(new_n399_));
  aoi21  g242(.a(new_n376_), .b(x000), .c(new_n399_), .O(new_n400_));
  ...
  nor2   g335(.a(x078), .b(x046), .O(z19));
  nor2   g336(.a(x078), .b(x046), .O(z21));
  nor2   g337(.a(x078), .b(x046), .O(z25));
endmodule
