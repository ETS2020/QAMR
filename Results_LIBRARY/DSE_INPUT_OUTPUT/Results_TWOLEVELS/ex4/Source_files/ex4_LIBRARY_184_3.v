// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:29 2020
...
module FAU ( 
  ...
  oai22  g091(.a(new_n247_), .b(new_n245_), .c(new_n246_), .d(new_n244_), .O(new_n248_));
  nand3  g092(.a(new_n248_), .b(new_n243_), .c(new_n242_), .O(new_n249_));
  aoi22  g093(.a(new_n247_), .b(new_n244_), .c(new_n246_), .d(new_n245_), .O(new_n250_));
  nand2  g094(.a(new_n250_), .b(new_n249_), .O(new_n251_));
  nand2  g095(.a(new_n251_), .b(new_n175_), .O(new_n252_));
  inv1   g096(.a(x109), .O(new_n253_));
  inv1   g097(.a(x117), .O(new_n254_));
  aoi21  g098(.a(new_n173_), .b(x085), .c(new_n172_), .O(new_n255_));
  nor2   g099(.a(new_n255_), .b(x013), .O(new_n256_));
  oai21  g100(.a(x069), .b(x037), .c(new_n172_), .O(new_n257_));
  nor2   g101(.a(x093), .b(x061), .O(new_n258_));
  oai21  g102(.a(new_n258_), .b(x029), .c(x021), .O(new_n259_));
  nand3  g103(.a(new_n259_), .b(new_n173_), .c(x085), .O(new_n260_));
  aoi21  g104(.a(new_n260_), .b(new_n257_), .c(new_n247_), .O(new_n261_));
  oai22  g105(.a(new_n261_), .b(new_n256_), .c(new_n254_), .d(new_n253_), .O(new_n262_));
  inv1   g106(.a(x029), .O(new_n263_));
  nand2  g107(.a(new_n242_), .b(new_n244_), .O(new_n264_));
  ...
  nand3  g111(.a(new_n267_), .b(x093), .c(x069), .O(new_n268_));
  inv1   g112(.a(x125), .O(new_n269_));
  nand2  g113(.a(x117), .b(x021), .O(new_n270_));
  oai21  g114(.a(x117), .b(new_n253_), .c(new_n270_), .O(new_n271_));
  nand2  g115(.a(new_n271_), .b(new_n269_), .O(new_n272_));
  inv1   g116(.a(x085), .O(new_n273_));
  inv1   g117(.a(x061), .O(new_n274_));
  nor2   g118(.a(x101), .b(new_n274_), .O(new_n275_));
  aoi21  g119(.a(new_n275_), .b(x037), .c(new_n273_), .O(new_n276_));
  nand4  g120(.a(new_n276_), .b(new_n272_), .c(new_n268_), .d(new_n266_), .O(new_n277_));
  nand2  g121(.a(new_n277_), .b(x077), .O(new_n278_));
  nand4  g122(.a(new_n269_), .b(x061), .c(x037), .d(new_n244_), .O(new_n279_));
  nand2  g123(.a(new_n279_), .b(new_n278_), .O(new_n280_));
  nand2  g124(.a(new_n280_), .b(new_n172_), .O(new_n281_));
  inv1   g125(.a(new_n265_), .O(new_n282_));
  nand2  g126(.a(new_n263_), .b(x021), .O(new_n283_));
  nand2  g127(.a(new_n283_), .b(new_n282_), .O(new_n284_));
  nand2  g128(.a(new_n284_), .b(new_n243_), .O(new_n285_));
  inv1   g129(.a(new_n258_), .O(new_n286_));
  nand4  g130(.a(new_n267_), .b(new_n264_), .c(new_n286_), .d(new_n263_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(new_n285_), .O(new_n288_));
  nand4  g132(.a(new_n288_), .b(new_n173_), .c(x085), .d(x077), .O(new_n289_));
  nand3  g133(.a(new_n289_), .b(new_n281_), .c(new_n262_), .O(new_n290_));
  nand3  g134(.a(new_n273_), .b(x037), .c(new_n172_), .O(new_n291_));
  inv1   g135(.a(new_n291_), .O(new_n292_));
  nand2  g136(.a(new_n173_), .b(x085), .O(new_n293_));
  nor4   g137(.a(new_n293_), .b(new_n247_), .c(x037), .d(x029), .O(new_n294_));
  oai21  g138(.a(new_n294_), .b(new_n292_), .c(x013), .O(new_n295_));
  oai22  g139(.a(new_n283_), .b(new_n293_), .c(new_n282_), .d(new_n255_), .O(new_n296_));
  nand3  g140(.a(new_n296_), .b(x077), .c(new_n245_), .O(new_n297_));
  nand2  g141(.a(new_n297_), .b(new_n295_), .O(new_n298_));
  aoi21  g142(.a(new_n290_), .b(x053), .c(new_n298_), .O(new_n299_));
  aoi21  g143(.a(new_n299_), .b(new_n252_), .c(new_n241_), .O(z05));
  ...
  nand3  g164(.a(new_n173_), .b(x118), .c(x022), .O(new_n321_));
  nand2  g165(.a(new_n321_), .b(x086), .O(new_n322_));
  aoi21  g166(.a(new_n320_), .b(x038), .c(new_n322_), .O(new_n323_));
  nand4  g167(.a(new_n323_), .b(new_n318_), .c(new_n315_), .d(new_n308_), .O(new_n324_));
  nand4  g168(.a(new_n173_), .b(x062), .c(x038), .d(new_n304_), .O(new_n325_));
  ...
  oai21  g173(.a(new_n327_), .b(new_n302_), .c(new_n329_), .O(new_n330_));
  nand2  g174(.a(new_n330_), .b(new_n301_), .O(new_n331_));
  ...
  aoi21  g178(.a(new_n334_), .b(x014), .c(new_n313_), .O(new_n335_));
  ...
  oai22  g192(.a(new_n336_), .b(new_n316_), .c(new_n302_), .d(new_n304_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(new_n337_), .c(new_n305_), .O(new_n350_));
  aoi22  g194(.a(new_n336_), .b(new_n304_), .c(new_n302_), .d(new_n316_), .O(new_n351_));
  nand2  g195(.a(new_n351_), .b(new_n350_), .O(new_n352_));
  aoi21  g196(.a(new_n348_), .b(x086), .c(new_n352_), .O(new_n353_));
  nand2  g197(.a(new_n353_), .b(new_n331_), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(x046), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(new_n175_), .O(z06));
  ...
  nand4  g220(.a(new_n377_), .b(new_n370_), .c(new_n367_), .d(new_n363_), .O(new_n378_));
  nand4  g221(.a(x120), .b(new_n360_), .c(new_n160_), .d(x008), .O(new_n379_));
  ...
  aoi21  g231(.a(new_n388_), .b(new_n159_), .c(new_n365_), .O(new_n389_));
  inv1   g232(.a(x024), .O(new_n390_));
  nor2   g233(.a(new_n390_), .b(x016), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n362_), .c(x064), .O(new_n392_));
  inv1   g235(.a(new_n364_), .O(new_n393_));
  nand4  g236(.a(new_n385_), .b(new_n393_), .c(new_n359_), .d(x024), .O(new_n394_));
  aoi21  g237(.a(new_n394_), .b(new_n392_), .c(x072), .O(new_n395_));
  oai21  g238(.a(new_n395_), .b(new_n389_), .c(new_n161_), .O(new_n396_));
  nand2  g239(.a(new_n359_), .b(x024), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(new_n361_), .c(new_n360_), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n162_), .c(x032), .O(new_n399_));
  ...
  aoi21  g247(.a(new_n400_), .b(new_n158_), .c(new_n404_), .O(new_n405_));
  nand2  g248(.a(new_n405_), .b(new_n384_), .O(new_n406_));
  nand3  g249(.a(new_n406_), .b(new_n175_), .c(new_n358_), .O(new_n407_));
  inv1   g250(.a(new_n407_), .O(z08));
  inv1   g251(.a(x041), .O(new_n409_));
  ...
  nand3  g258(.a(new_n415_), .b(new_n175_), .c(new_n409_), .O(new_n416_));
  inv1   g259(.a(new_n416_), .O(z09));
  ...
  oai21  g285(.a(new_n442_), .b(x044), .c(new_n175_), .O(z12));
  oai22  g286(.a(new_n286_), .b(x029), .c(new_n242_), .d(new_n244_), .O(new_n444_));
  inv1   g287(.a(x101), .O(new_n445_));
  nand2  g288(.a(x125), .b(x093), .O(new_n446_));
  oai21  g289(.a(new_n445_), .b(x037), .c(new_n446_), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n274_), .O(new_n448_));
  nand2  g291(.a(new_n254_), .b(new_n253_), .O(new_n449_));
  oai21  g292(.a(new_n243_), .b(new_n245_), .c(new_n449_), .O(new_n450_));
  aoi21  g293(.a(new_n269_), .b(new_n445_), .c(x093), .O(new_n451_));
  nand3  g294(.a(x125), .b(new_n254_), .c(new_n242_), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(new_n273_), .O(new_n453_));
  aoi21  g296(.a(new_n451_), .b(new_n243_), .c(new_n453_), .O(new_n454_));
  nand4  g297(.a(new_n454_), .b(new_n450_), .c(new_n448_), .d(new_n444_), .O(new_n455_));
  nand4  g298(.a(x125), .b(new_n253_), .c(x037), .d(new_n244_), .O(new_n456_));
  inv1   g299(.a(new_n456_), .O(new_n457_));
  aoi21  g300(.a(new_n455_), .b(new_n246_), .c(new_n457_), .O(new_n458_));
  nand3  g301(.a(x085), .b(new_n245_), .c(new_n244_), .O(new_n459_));
  oai21  g302(.a(new_n458_), .b(x077), .c(new_n459_), .O(new_n460_));
  nand3  g303(.a(new_n273_), .b(new_n246_), .c(x029), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n242_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n245_), .O(new_n463_));
  nand3  g306(.a(new_n286_), .b(new_n273_), .c(new_n246_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n463_), .c(new_n243_), .O(new_n465_));
  nand2  g308(.a(new_n265_), .b(x029), .O(new_n466_));
  aoi22  g309(.a(new_n466_), .b(new_n242_), .c(new_n254_), .d(new_n253_), .O(new_n467_));
  nand2  g310(.a(new_n269_), .b(new_n445_), .O(new_n468_));
  aoi22  g311(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n469_));
  nand3  g312(.a(new_n469_), .b(new_n468_), .c(x029), .O(new_n470_));
  inv1   g313(.a(new_n470_), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n246_), .O(new_n472_));
  aoi21  g315(.a(x021), .b(x013), .c(new_n263_), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n286_), .c(x037), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n472_), .c(x085), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n465_), .c(new_n247_), .O(new_n476_));
  nand3  g319(.a(new_n449_), .b(new_n273_), .c(new_n246_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n247_), .O(new_n478_));
  nand4  g321(.a(x069), .b(new_n246_), .c(x021), .d(new_n244_), .O(new_n479_));
  oai21  g322(.a(new_n246_), .b(new_n245_), .c(new_n479_), .O(new_n480_));
  aoi21  g323(.a(new_n478_), .b(x013), .c(new_n480_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n476_), .O(new_n482_));
  aoi21  g325(.a(new_n460_), .b(x005), .c(new_n482_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(x045), .c(new_n175_), .O(z13));
  nand2  g327(.a(new_n316_), .b(new_n304_), .O(new_n485_));
  oai21  g328(.a(x078), .b(x054), .c(new_n485_), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(x086), .c(x006), .O(new_n487_));
  nand2  g330(.a(new_n312_), .b(new_n311_), .O(new_n488_));
  oai21  g331(.a(x078), .b(new_n305_), .c(new_n304_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n488_), .O(new_n490_));
  nand3  g333(.a(new_n340_), .b(new_n336_), .c(x070), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n490_), .c(x054), .O(new_n492_));
  nor3   g335(.a(new_n332_), .b(x078), .c(new_n316_), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(new_n492_), .c(new_n328_), .O(new_n494_));
  ...
  nand4  g340(.a(new_n497_), .b(new_n496_), .c(new_n494_), .d(new_n487_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n175_), .O(new_n499_));
  nor2   g342(.a(new_n305_), .b(new_n304_), .O(new_n500_));
  nand2  g343(.a(x126), .b(new_n172_), .O(new_n501_));
  nand2  g344(.a(new_n173_), .b(x102), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n501_), .c(new_n344_), .O(new_n503_));
  nor2   g346(.a(x126), .b(new_n301_), .O(new_n504_));
  aoi21  g347(.a(new_n503_), .b(new_n328_), .c(new_n504_), .O(new_n505_));
  nand3  g348(.a(new_n340_), .b(new_n173_), .c(x006), .O(new_n506_));
  oai21  g349(.a(new_n505_), .b(new_n303_), .c(new_n506_), .O(new_n507_));
  nand4  g350(.a(new_n173_), .b(new_n328_), .c(x038), .d(x030), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(new_n509_));
  aoi21  g352(.a(new_n507_), .b(new_n302_), .c(new_n509_), .O(new_n510_));
  nand4  g353(.a(x126), .b(new_n312_), .c(x006), .d(new_n172_), .O(new_n511_));
  nand4  g354(.a(new_n173_), .b(new_n328_), .c(x070), .d(x030), .O(new_n512_));
  nand2  g355(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n305_), .O(new_n514_));
  oai22  g357(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(x102), .O(new_n516_));
  nand2  g359(.a(x070), .b(x038), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n488_), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n516_), .c(new_n301_), .O(new_n519_));
  nand4  g362(.a(new_n488_), .b(new_n307_), .c(new_n328_), .d(x030), .O(new_n520_));
  inv1   g363(.a(new_n520_), .O(new_n521_));
  oai21  g364(.a(new_n521_), .b(new_n519_), .c(new_n173_), .O(new_n522_));
  inv1   g365(.a(x094), .O(new_n523_));
  nand2  g366(.a(new_n523_), .b(new_n337_), .O(new_n524_));
  nand2  g367(.a(x118), .b(new_n311_), .O(new_n525_));
  nand3  g368(.a(new_n525_), .b(new_n524_), .c(new_n485_), .O(new_n526_));
  nand4  g369(.a(new_n526_), .b(x126), .c(x006), .d(new_n172_), .O(new_n527_));
  nand3  g370(.a(new_n527_), .b(new_n522_), .c(new_n514_), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n302_), .O(new_n529_));
  oai21  g372(.a(new_n510_), .b(new_n500_), .c(new_n529_), .O(new_n530_));
  nand4  g373(.a(x126), .b(new_n319_), .c(new_n302_), .d(new_n316_), .O(new_n531_));
  nor4   g374(.a(new_n531_), .b(new_n304_), .c(new_n301_), .d(x005), .O(new_n532_));
  aoi21  g375(.a(new_n530_), .b(new_n336_), .c(new_n532_), .O(new_n533_));
  aoi21  g376(.a(new_n533_), .b(new_n499_), .c(x046), .O(z14));
  zero   g377(.O(z07));
  zero   g378(.O(z17));
  zero   g379(.O(z20));
  zero   g380(.O(z22));
  zero   g381(.O(z23));
  zero   g382(.O(z27));
  nor2   g383(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g384(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g385(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g386(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g387(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g388(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g389(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
