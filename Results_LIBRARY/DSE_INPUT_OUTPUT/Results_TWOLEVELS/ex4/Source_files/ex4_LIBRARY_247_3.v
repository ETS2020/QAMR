// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:38 2020
...
module FAU ( 
  ...
  oai21  g209(.a(new_n366_), .b(x041), .c(new_n157_), .O(z09));
  ...
  oai21  g217(.a(new_n374_), .b(x042), .c(new_n157_), .O(z10));
  inv1   g218(.a(x043), .O(new_n376_));
  ...
  nand3  g225(.a(new_n382_), .b(new_n157_), .c(new_n376_), .O(new_n383_));
  inv1   g226(.a(new_n383_), .O(z11));
  ...
  oai21  g234(.a(new_n391_), .b(x044), .c(new_n157_), .O(z12));
  inv1   g235(.a(x045), .O(new_n393_));
  nand2  g236(.a(x021), .b(x013), .O(new_n394_));
  oai21  g237(.a(new_n278_), .b(x029), .c(new_n394_), .O(new_n395_));
  nor2   g238(.a(x125), .b(x101), .O(new_n396_));
  nor2   g239(.a(x117), .b(x109), .O(new_n397_));
  oai21  g240(.a(new_n396_), .b(x093), .c(new_n397_), .O(new_n398_));
  nand2  g241(.a(new_n398_), .b(new_n275_), .O(new_n399_));
  oai21  g242(.a(new_n258_), .b(x109), .c(x037), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(x117), .O(new_n401_));
  inv1   g244(.a(x101), .O(new_n402_));
  oai21  g245(.a(new_n402_), .b(x061), .c(new_n248_), .O(new_n403_));
  nand3  g246(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n404_));
  nand2  g247(.a(new_n404_), .b(new_n266_), .O(new_n405_));
  aoi21  g248(.a(new_n403_), .b(new_n253_), .c(new_n405_), .O(new_n406_));
  nand4  g249(.a(new_n406_), .b(new_n401_), .c(new_n399_), .d(new_n395_), .O(new_n407_));
  nand4  g250(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n408_));
  inv1   g251(.a(new_n408_), .O(new_n409_));
  aoi21  g252(.a(new_n407_), .b(new_n274_), .c(new_n409_), .O(new_n410_));
  nand3  g253(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n411_));
  oai21  g254(.a(new_n410_), .b(x053), .c(new_n411_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(x005), .O(new_n413_));
  nand2  g256(.a(new_n244_), .b(x029), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n242_), .O(new_n415_));
  nand2  g258(.a(new_n415_), .b(new_n274_), .O(new_n416_));
  aoi21  g259(.a(new_n416_), .b(new_n241_), .c(new_n397_), .O(new_n417_));
  nor2   g260(.a(new_n240_), .b(x021), .O(new_n418_));
  oai21  g261(.a(new_n418_), .b(new_n278_), .c(x069), .O(new_n419_));
  inv1   g262(.a(new_n396_), .O(new_n420_));
  nand4  g263(.a(new_n420_), .b(new_n394_), .c(new_n244_), .d(x029), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n419_), .c(x077), .O(new_n422_));
  oai21  g265(.a(new_n422_), .b(new_n417_), .c(new_n239_), .O(new_n423_));
  nand2  g266(.a(new_n394_), .b(x029), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n270_), .O(new_n425_));
  nand3  g268(.a(new_n425_), .b(new_n274_), .c(x037), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(new_n423_), .O(new_n427_));
  oai22  g270(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(x069), .c(x021), .O(new_n429_));
  aoi22  g272(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n430_));
  nand2  g273(.a(new_n430_), .b(new_n429_), .O(new_n431_));
  aoi21  g274(.a(new_n427_), .b(new_n266_), .c(new_n431_), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(new_n413_), .O(new_n433_));
  nand3  g276(.a(new_n433_), .b(new_n157_), .c(new_n393_), .O(new_n434_));
  inv1   g277(.a(new_n434_), .O(z13));
  nand2  g278(.a(x022), .b(x014), .O(new_n436_));
  inv1   g279(.a(x062), .O(new_n437_));
  inv1   g280(.a(x094), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(new_n437_), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(x030), .c(new_n436_), .O(new_n440_));
  inv1   g283(.a(x102), .O(new_n441_));
  inv1   g284(.a(x126), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n438_), .O(new_n444_));
  nor2   g287(.a(x118), .b(x110), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n444_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(new_n300_), .O(new_n447_));
  oai21  g290(.a(new_n442_), .b(x110), .c(x038), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(x118), .O(new_n449_));
  inv1   g292(.a(x110), .O(new_n450_));
  oai21  g293(.a(new_n441_), .b(x062), .c(new_n450_), .O(new_n451_));
  inv1   g294(.a(x118), .O(new_n452_));
  nand3  g295(.a(x126), .b(new_n452_), .c(new_n299_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n303_), .O(new_n454_));
  aoi21  g297(.a(new_n451_), .b(new_n296_), .c(new_n454_), .O(new_n455_));
  nand4  g298(.a(new_n455_), .b(new_n449_), .c(new_n447_), .d(new_n440_), .O(new_n456_));
  nand4  g299(.a(x126), .b(new_n437_), .c(new_n296_), .d(x014), .O(new_n457_));
  inv1   g300(.a(new_n457_), .O(new_n458_));
  aoi21  g301(.a(new_n456_), .b(new_n295_), .c(new_n458_), .O(new_n459_));
  inv1   g302(.a(x014), .O(new_n460_));
  nand3  g303(.a(x086), .b(new_n296_), .c(new_n460_), .O(new_n461_));
  oai21  g304(.a(new_n459_), .b(x054), .c(new_n461_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(x006), .O(new_n463_));
  nand2  g306(.a(x094), .b(x062), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x030), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n299_), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n295_), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n460_), .c(new_n445_), .O(new_n468_));
  inv1   g311(.a(x030), .O(new_n469_));
  nor2   g312(.a(new_n469_), .b(x022), .O(new_n470_));
  oai21  g313(.a(new_n470_), .b(new_n439_), .c(x070), .O(new_n471_));
  nand4  g314(.a(new_n464_), .b(new_n443_), .c(new_n436_), .d(x030), .O(new_n472_));
  aoi21  g315(.a(new_n472_), .b(new_n471_), .c(x078), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n468_), .c(new_n297_), .O(new_n474_));
  nand2  g317(.a(new_n436_), .b(x030), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n438_), .c(new_n437_), .O(new_n476_));
  ...
  aoi21  g325(.a(new_n478_), .b(new_n303_), .c(new_n482_), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n463_), .c(x046), .O(z14));
  inv1   g327(.a(new_n157_), .O(z16));
  zero   g328(.O(z07));
  zero   g329(.O(z15));
  zero   g330(.O(z17));
  zero   g331(.O(z18));
  ...
  zero   g334(.O(z22));
  zero   g335(.O(z25));
  inv1   g336(.a(new_n157_), .O(z19));
  inv1   g337(.a(new_n157_), .O(z23));
  inv1   g338(.a(new_n157_), .O(z24));
  inv1   g339(.a(new_n157_), .O(z26));
  inv1   g340(.a(new_n157_), .O(z27));
endmodule
