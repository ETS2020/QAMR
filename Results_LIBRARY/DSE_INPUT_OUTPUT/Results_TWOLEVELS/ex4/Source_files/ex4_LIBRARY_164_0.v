...
module FAU ( 
  ...
  nand3  g316(.a(x070), .b(new_n301_), .c(x022), .O(new_n474_));
  nand3  g317(.a(x086), .b(new_n312_), .c(x006), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n474_), .c(new_n473_), .O(new_n476_));
  nand3  g319(.a(new_n476_), .b(x078), .c(new_n297_), .O(new_n477_));
  inv1   g320(.a(new_n477_), .O(z14));
  zero   g321(.O(z07));
  zero   g322(.O(z15));
  zero   g323(.O(z16));
  zero   g324(.O(z18));
