// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:39 2020
...
module FAU ( 
  ...
  nand4  g183(.a(new_n327_), .b(x118), .c(new_n172_), .d(new_n298_), .O(new_n340_));
  ...
  nand4  g199(.a(new_n355_), .b(new_n327_), .c(new_n172_), .d(new_n298_), .O(new_n356_));
  ...
  nand3  g204(.a(x038), .b(new_n360_), .c(new_n298_), .O(new_n361_));
  nand2  g205(.a(x062), .b(x054), .O(new_n362_));
  nor3   g206(.a(new_n362_), .b(new_n361_), .c(new_n328_), .O(new_n363_));
  ...
  oai21  g212(.a(new_n165_), .b(new_n159_), .c(new_n368_), .O(new_n369_));
  ...
  oai21  g219(.a(new_n375_), .b(new_n372_), .c(new_n166_), .O(new_n376_));
  ...
  nand3  g223(.a(x120), .b(new_n374_), .c(new_n165_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(new_n158_), .O(new_n381_));
  aoi21  g225(.a(new_n379_), .b(new_n160_), .c(new_n381_), .O(new_n382_));
  nand4  g226(.a(new_n382_), .b(new_n378_), .c(new_n376_), .d(new_n369_), .O(new_n383_));
  nor2   g227(.a(x032), .b(new_n159_), .O(new_n384_));
  nor2   g228(.a(new_n371_), .b(x056), .O(new_n385_));
  aoi22  g229(.a(new_n385_), .b(new_n384_), .c(new_n383_), .d(new_n162_), .O(new_n386_));
  ...
  oai21  g234(.a(new_n390_), .b(x072), .c(new_n159_), .O(new_n391_));
  nand2  g235(.a(new_n391_), .b(new_n375_), .O(new_n392_));
  nand2  g236(.a(x024), .b(new_n165_), .O(new_n393_));
  aoi21  g237(.a(new_n393_), .b(new_n367_), .c(new_n166_), .O(new_n394_));
  ...
  oai21  g242(.a(new_n398_), .b(new_n394_), .c(new_n162_), .O(new_n399_));
  aoi21  g243(.a(new_n399_), .b(new_n392_), .c(x048), .O(new_n400_));
  oai21  g244(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(new_n367_), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(new_n162_), .c(x032), .O(new_n403_));
  inv1   g247(.a(new_n403_), .O(new_n404_));
  oai21  g248(.a(new_n404_), .b(new_n400_), .c(new_n158_), .O(new_n405_));
  ...
  aoi21  g253(.a(new_n388_), .b(x000), .c(new_n409_), .O(new_n410_));
  oai21  g254(.a(new_n410_), .b(x040), .c(new_n174_), .O(z08));
  ...
  nand3  g289(.a(new_n445_), .b(new_n174_), .c(new_n439_), .O(new_n446_));
  inv1   g290(.a(new_n446_), .O(z12));
  oai22  g291(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n448_));
  inv1   g292(.a(x101), .O(new_n449_));
  aoi21  g293(.a(new_n260_), .b(new_n449_), .c(x093), .O(new_n450_));
  nand2  g294(.a(new_n251_), .b(new_n250_), .O(new_n451_));
  oai21  g295(.a(new_n451_), .b(new_n450_), .c(new_n277_), .O(new_n452_));
  oai21  g296(.a(new_n260_), .b(x109), .c(x037), .O(new_n453_));
  nand2  g297(.a(new_n453_), .b(x117), .O(new_n454_));
  oai21  g298(.a(new_n449_), .b(x061), .c(new_n250_), .O(new_n455_));
  nand3  g299(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n268_), .O(new_n457_));
  aoi21  g301(.a(new_n455_), .b(new_n255_), .c(new_n457_), .O(new_n458_));
  nand4  g302(.a(new_n458_), .b(new_n454_), .c(new_n452_), .d(new_n448_), .O(new_n459_));
  nand4  g303(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n460_));
  inv1   g304(.a(new_n460_), .O(new_n461_));
  aoi21  g305(.a(new_n459_), .b(new_n276_), .c(new_n461_), .O(new_n462_));
  nand3  g306(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n463_));
  oai21  g307(.a(new_n462_), .b(x053), .c(new_n463_), .O(new_n464_));
  aoi21  g308(.a(new_n246_), .b(x029), .c(x021), .O(new_n465_));
  oai21  g309(.a(new_n465_), .b(x077), .c(new_n243_), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(new_n451_), .O(new_n467_));
  nand2  g311(.a(x029), .b(new_n244_), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n272_), .c(new_n277_), .O(new_n469_));
  nand2  g313(.a(new_n260_), .b(new_n449_), .O(new_n470_));
  ...
  oai21  g317(.a(new_n473_), .b(new_n469_), .c(new_n276_), .O(new_n474_));
  aoi21  g318(.a(new_n474_), .b(new_n467_), .c(x053), .O(new_n475_));
  oai21  g319(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n272_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n276_), .c(x037), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n475_), .c(new_n268_), .O(new_n480_));
  ...
  oai21  g329(.a(new_n485_), .b(x045), .c(new_n174_), .O(z13));
  nand2  g330(.a(new_n312_), .b(new_n360_), .O(new_n487_));
  oai21  g331(.a(x078), .b(x054), .c(new_n487_), .O(new_n488_));
  nand3  g332(.a(new_n488_), .b(x086), .c(x006), .O(new_n489_));
  inv1   g333(.a(x110), .O(new_n490_));
  nand2  g334(.a(new_n353_), .b(new_n490_), .O(new_n491_));
  oai21  g335(.a(x078), .b(new_n316_), .c(new_n360_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n491_), .O(new_n493_));
  nand3  g337(.a(new_n349_), .b(new_n301_), .c(x070), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n493_), .c(x054), .O(new_n495_));
  nor3   g339(.a(new_n329_), .b(x078), .c(new_n312_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n495_), .c(new_n299_), .O(new_n497_));
  oai22  g341(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(x070), .c(x022), .O(new_n499_));
  aoi22  g343(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n500_));
  nand4  g344(.a(new_n500_), .b(new_n499_), .c(new_n497_), .d(new_n489_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n174_), .O(new_n502_));
  nand2  g346(.a(x022), .b(x014), .O(new_n503_));
  oai21  g347(.a(x113), .b(new_n325_), .c(new_n327_), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n309_), .c(new_n299_), .O(new_n505_));
  nand2  g349(.a(new_n172_), .b(x006), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n505_), .c(new_n335_), .O(new_n507_));
  nor3   g351(.a(new_n329_), .b(x113), .c(new_n298_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n507_), .c(new_n300_), .O(new_n509_));
  nand4  g353(.a(new_n172_), .b(new_n299_), .c(x038), .d(x030), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n509_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n503_), .O(new_n512_));
  nand4  g356(.a(new_n172_), .b(new_n299_), .c(x070), .d(x030), .O(new_n513_));
  nand3  g357(.a(x126), .b(new_n353_), .c(x006), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n316_), .O(new_n516_));
  oai22  g360(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(x102), .O(new_n518_));
  oai21  g362(.a(new_n308_), .b(new_n312_), .c(new_n491_), .O(new_n519_));
  aoi21  g363(.a(new_n519_), .b(new_n518_), .c(new_n298_), .O(new_n520_));
  nand4  g364(.a(new_n491_), .b(new_n309_), .c(new_n299_), .d(x030), .O(new_n521_));
  inv1   g365(.a(new_n521_), .O(new_n522_));
  oai21  g366(.a(new_n522_), .b(new_n520_), .c(new_n172_), .O(new_n523_));
  inv1   g367(.a(x094), .O(new_n524_));
  nand2  g368(.a(new_n524_), .b(new_n308_), .O(new_n525_));
  nand2  g369(.a(x118), .b(new_n490_), .O(new_n526_));
  nand3  g370(.a(new_n526_), .b(new_n525_), .c(new_n487_), .O(new_n527_));
  nand3  g371(.a(new_n527_), .b(x126), .c(x006), .O(new_n528_));
  nand3  g372(.a(new_n528_), .b(new_n523_), .c(new_n516_), .O(new_n529_));
  nand2  g373(.a(new_n529_), .b(new_n300_), .O(new_n530_));
  nand2  g374(.a(new_n530_), .b(new_n512_), .O(new_n531_));
  nand3  g375(.a(new_n312_), .b(x014), .c(x006), .O(new_n532_));
  nor4   g376(.a(new_n532_), .b(new_n327_), .c(x062), .d(x054), .O(new_n533_));
  aoi21  g377(.a(new_n531_), .b(new_n301_), .c(new_n533_), .O(new_n534_));
  aoi21  g378(.a(new_n534_), .b(new_n502_), .c(x046), .O(z14));
  zero   g379(.O(z17));
  zero   g380(.O(z18));
  zero   g381(.O(z19));
  zero   g382(.O(z20));
  ...
  zero   g384(.O(z23));
  zero   g385(.O(z25));
  nor2   g386(.a(x126), .b(new_n172_), .O(z15));
  nor2   g387(.a(x126), .b(new_n172_), .O(z16));
  nor2   g388(.a(x126), .b(new_n172_), .O(z21));
  nor2   g389(.a(x126), .b(new_n172_), .O(z24));
  nor2   g390(.a(x126), .b(new_n172_), .O(z26));
  nor2   g391(.a(x126), .b(new_n172_), .O(z27));
endmodule
