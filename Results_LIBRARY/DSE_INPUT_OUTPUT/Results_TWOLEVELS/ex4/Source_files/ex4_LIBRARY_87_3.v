...
module FAU ( 
  ...
  nand2  g206(.a(new_n362_), .b(new_n170_), .O(new_n363_));
  ...
  nand3  g214(.a(x120), .b(new_n370_), .c(new_n169_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n162_), .O(new_n372_));
  aoi21  g216(.a(new_n369_), .b(new_n164_), .c(new_n372_), .O(new_n373_));
  nand4  g217(.a(new_n373_), .b(new_n366_), .c(new_n363_), .d(new_n359_), .O(new_n374_));
  nand4  g218(.a(x120), .b(new_n356_), .c(new_n164_), .d(x008), .O(new_n375_));
  inv1   g219(.a(new_n375_), .O(new_n376_));
  aoi21  g220(.a(new_n374_), .b(new_n166_), .c(new_n376_), .O(new_n377_));
  nand3  g221(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n378_));
  ...
  nand2  g226(.a(new_n382_), .b(new_n169_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n166_), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n163_), .c(new_n361_), .O(new_n385_));
  ...
  oai21  g235(.a(new_n391_), .b(new_n385_), .c(new_n165_), .O(new_n392_));
  ...
  aoi21  g244(.a(new_n396_), .b(new_n162_), .c(new_n400_), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(new_n380_), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(new_n160_), .c(new_n354_), .O(new_n403_));
  ...
  oai21  g272(.a(new_n428_), .b(x043), .c(new_n160_), .O(z11));
  ...
  nand3  g341(.a(new_n337_), .b(new_n158_), .c(x006), .O(new_n498_));
  oai21  g342(.a(new_n497_), .b(new_n300_), .c(new_n498_), .O(new_n499_));
  nand4  g343(.a(new_n158_), .b(new_n325_), .c(x038), .d(x030), .O(new_n500_));
  inv1   g344(.a(new_n500_), .O(new_n501_));
  aoi21  g345(.a(new_n499_), .b(new_n299_), .c(new_n501_), .O(new_n502_));
  nand4  g346(.a(x126), .b(new_n309_), .c(new_n157_), .d(x006), .O(new_n503_));
  nand4  g347(.a(new_n158_), .b(new_n325_), .c(x070), .d(x030), .O(new_n504_));
  ...
  nand4  g366(.a(x126), .b(new_n316_), .c(new_n157_), .d(new_n299_), .O(new_n523_));
  nor4   g367(.a(new_n523_), .b(x038), .c(new_n301_), .d(new_n298_), .O(new_n524_));
