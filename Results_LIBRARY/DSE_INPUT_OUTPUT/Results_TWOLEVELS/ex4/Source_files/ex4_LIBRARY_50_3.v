// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:35 2020
...
module FAU ( 
  ...
  inv1   g000(.a(x006), .O(new_n157_));
  inv1   g001(.a(x117), .O(new_n158_));
  ...
  oai21  g107(.a(x109), .b(x006), .c(x117), .O(new_n264_));
  ...
  oai21  g134(.a(new_n290_), .b(new_n283_), .c(new_n157_), .O(new_n291_));
  ...
  nor2   g138(.a(new_n272_), .b(new_n243_), .O(new_n295_));
  nand4  g139(.a(new_n295_), .b(x077), .c(new_n245_), .d(new_n284_), .O(new_n296_));
  nor2   g140(.a(new_n296_), .b(x006), .O(new_n297_));
  ...
  nand2  g173(.a(new_n329_), .b(new_n157_), .O(new_n330_));
  ...
  nand2  g208(.a(new_n365_), .b(new_n170_), .O(new_n366_));
  ...
  nand3  g216(.a(x120), .b(new_n373_), .c(new_n169_), .O(new_n374_));
  nand2  g217(.a(new_n374_), .b(new_n162_), .O(new_n375_));
  aoi21  g218(.a(new_n372_), .b(new_n164_), .c(new_n375_), .O(new_n376_));
  nand4  g219(.a(new_n376_), .b(new_n369_), .c(new_n366_), .d(new_n362_), .O(new_n377_));
  nand4  g220(.a(x120), .b(new_n359_), .c(new_n164_), .d(x008), .O(new_n378_));
  inv1   g221(.a(new_n378_), .O(new_n379_));
  aoi21  g222(.a(new_n377_), .b(new_n166_), .c(new_n379_), .O(new_n380_));
  nand3  g223(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n381_));
  ...
  nand2  g228(.a(new_n385_), .b(new_n169_), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(new_n166_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n163_), .c(new_n364_), .O(new_n388_));
  ...
  oai21  g237(.a(new_n394_), .b(new_n388_), .c(new_n165_), .O(new_n395_));
  nand2  g238(.a(new_n358_), .b(x024), .O(new_n396_));
  nand3  g239(.a(new_n396_), .b(new_n360_), .c(new_n359_), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(new_n166_), .c(x032), .O(new_n398_));
  ...
  aoi21  g246(.a(new_n399_), .b(new_n162_), .c(new_n403_), .O(new_n404_));
  nand2  g247(.a(new_n404_), .b(new_n383_), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(new_n160_), .c(new_n357_), .O(new_n406_));
  ...
  oai21  g266(.a(new_n423_), .b(x042), .c(new_n160_), .O(z10));
  ...
  oai21  g274(.a(new_n431_), .b(x043), .c(new_n160_), .O(z11));
  ...
  inv1   g284(.a(new_n266_), .O(new_n442_));
  oai22  g285(.a(new_n442_), .b(x029), .c(new_n285_), .d(new_n244_), .O(new_n443_));
  aoi21  g286(.a(new_n278_), .b(new_n276_), .c(x093), .O(new_n444_));
  nor2   g287(.a(x117), .b(x109), .O(new_n445_));
  inv1   g288(.a(new_n445_), .O(new_n446_));
  oai21  g289(.a(new_n446_), .b(new_n444_), .c(new_n250_), .O(new_n447_));
  oai21  g290(.a(new_n278_), .b(x109), .c(x037), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(x117), .O(new_n449_));
  inv1   g292(.a(x109), .O(new_n450_));
  oai21  g293(.a(new_n276_), .b(x061), .c(new_n450_), .O(new_n451_));
  nand3  g294(.a(x125), .b(new_n158_), .c(new_n285_), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(new_n243_), .O(new_n453_));
  aoi21  g296(.a(new_n451_), .b(new_n245_), .c(new_n453_), .O(new_n454_));
  nand4  g297(.a(new_n454_), .b(new_n449_), .c(new_n447_), .d(new_n443_), .O(new_n455_));
  nor2   g298(.a(x037), .b(new_n244_), .O(new_n456_));
  nor2   g299(.a(new_n278_), .b(x061), .O(new_n457_));
  aoi22  g300(.a(new_n457_), .b(new_n456_), .c(new_n455_), .d(new_n247_), .O(new_n458_));
  nand3  g301(.a(x085), .b(new_n245_), .c(new_n244_), .O(new_n459_));
  oai21  g302(.a(new_n458_), .b(x053), .c(new_n459_), .O(new_n460_));
  nand3  g303(.a(new_n243_), .b(new_n246_), .c(x029), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n285_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n245_), .O(new_n463_));
  nand3  g306(.a(new_n442_), .b(new_n243_), .c(new_n246_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n463_), .c(new_n250_), .O(new_n465_));
  nand2  g308(.a(new_n254_), .b(x029), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n285_), .c(new_n445_), .O(new_n467_));
  nand2  g310(.a(new_n278_), .b(new_n276_), .O(new_n468_));
  ...
  aoi21  g315(.a(x021), .b(x013), .c(new_n284_), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n442_), .c(x037), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n472_), .c(x085), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n465_), .c(new_n247_), .O(new_n476_));
  nand3  g319(.a(new_n446_), .b(new_n243_), .c(new_n246_), .O(new_n477_));
  ...
  oai21  g326(.a(new_n483_), .b(x045), .c(new_n160_), .O(z13));
  ...
  nand2  g331(.a(new_n488_), .b(new_n160_), .O(new_n489_));
  nor2   g332(.a(x086), .b(x006), .O(new_n490_));
  aoi21  g333(.a(new_n158_), .b(x006), .c(new_n490_), .O(new_n491_));
  nor2   g334(.a(new_n491_), .b(new_n302_), .O(new_n492_));
  nand2  g335(.a(x070), .b(x038), .O(new_n493_));
  nand3  g336(.a(new_n493_), .b(new_n158_), .c(x006), .O(new_n494_));
  oai21  g337(.a(new_n343_), .b(new_n301_), .c(new_n303_), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(new_n327_), .c(new_n157_), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n494_), .c(x078), .O(new_n497_));
  oai22  g340(.a(new_n497_), .b(new_n492_), .c(x118), .d(x110), .O(new_n498_));
  nand2  g341(.a(x022), .b(x014), .O(new_n499_));
  oai21  g342(.a(new_n339_), .b(x030), .c(new_n499_), .O(new_n500_));
  inv1   g343(.a(x094), .O(new_n501_));
  inv1   g344(.a(x102), .O(new_n502_));
  nand2  g345(.a(new_n319_), .b(new_n502_), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n501_), .c(new_n336_), .O(new_n504_));
  nor2   g347(.a(new_n310_), .b(x110), .O(new_n505_));
  nor2   g348(.a(x118), .b(x022), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(new_n505_), .c(x126), .O(new_n507_));
  nor2   g350(.a(new_n502_), .b(x062), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n314_), .c(x086), .O(new_n509_));
  nand4  g352(.a(new_n509_), .b(new_n507_), .c(new_n504_), .d(new_n500_), .O(new_n510_));
  nand2  g353(.a(new_n510_), .b(new_n335_), .O(new_n511_));
  nand4  g354(.a(x126), .b(new_n317_), .c(new_n314_), .d(x014), .O(new_n512_));
  nand2  g355(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand3  g356(.a(new_n513_), .b(new_n158_), .c(x006), .O(new_n514_));
  nor2   g357(.a(new_n301_), .b(x022), .O(new_n515_));
  oai21  g358(.a(new_n515_), .b(new_n339_), .c(x070), .O(new_n516_));
  nand4  g359(.a(new_n503_), .b(new_n499_), .c(new_n305_), .d(x030), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n516_), .O(new_n518_));
  nand4  g361(.a(new_n518_), .b(new_n327_), .c(new_n335_), .d(new_n157_), .O(new_n519_));
  nand3  g362(.a(new_n519_), .b(new_n514_), .c(new_n498_), .O(new_n520_));
  nor2   g363(.a(x086), .b(x078), .O(new_n521_));
  nand4  g364(.a(new_n521_), .b(x038), .c(x030), .d(new_n157_), .O(new_n522_));
  nand4  g365(.a(new_n158_), .b(x086), .c(new_n314_), .d(x006), .O(new_n523_));
  nand2  g366(.a(new_n523_), .b(new_n522_), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n302_), .O(new_n525_));
  nand4  g368(.a(new_n327_), .b(x030), .c(new_n303_), .d(new_n157_), .O(new_n526_));
  oai21  g369(.a(new_n491_), .b(new_n331_), .c(new_n526_), .O(new_n527_));
  nand3  g370(.a(new_n527_), .b(new_n335_), .c(x038), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n525_), .O(new_n529_));
  aoi21  g372(.a(new_n520_), .b(new_n300_), .c(new_n529_), .O(new_n530_));
  aoi21  g373(.a(new_n530_), .b(new_n489_), .c(x046), .O(z14));
  zero   g374(.O(z07));
  zero   g375(.O(z16));
  zero   g376(.O(z17));
  zero   g377(.O(z18));
  ...
  zero   g380(.O(z25));
  zero   g381(.O(z27));
  nor2   g382(.a(new_n158_), .b(new_n157_), .O(z19));
  nor2   g383(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g384(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g385(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g386(.a(new_n158_), .b(new_n157_), .O(z26));
endmodule
