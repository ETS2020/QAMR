...
module FAU ( 
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x104), .O(new_n305_));
  ...
  nand3  g215(.a(x120), .b(new_n173_), .c(new_n165_), .O(new_n372_));
  ...
  oai21  g272(.a(new_n428_), .b(x043), .c(new_n175_), .O(z11));
  ...
  nand3  g321(.a(new_n477_), .b(new_n175_), .c(new_n439_), .O(new_n478_));
  ...
  oai21  g328(.a(x104), .b(new_n480_), .c(new_n484_), .O(new_n485_));
  ...
  nand2  g337(.a(new_n493_), .b(new_n299_), .O(new_n494_));
  ...
  nand3  g359(.a(x086), .b(new_n299_), .c(x006), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(new_n515_), .c(new_n340_), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n173_), .c(x078), .O(new_n518_));
  ...
  zero   g372(.O(z26));
  zero   g373(.O(z27));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z17));
