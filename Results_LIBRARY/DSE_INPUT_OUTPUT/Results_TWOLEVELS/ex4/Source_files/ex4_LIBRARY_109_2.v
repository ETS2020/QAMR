...
module FAU ( 
  ...
  oai21  g310(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n468_));
  nand2  g311(.a(new_n318_), .b(new_n314_), .O(new_n469_));
  oai22  g312(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n469_), .O(new_n471_));
  oai22  g314(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n472_));
  nand2  g315(.a(x118), .b(new_n298_), .O(new_n473_));
  ...
  nand3  g319(.a(new_n476_), .b(new_n297_), .c(new_n340_), .O(new_n477_));
  nand4  g320(.a(x086), .b(new_n172_), .c(new_n300_), .d(new_n319_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n477_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(x006), .O(new_n480_));
  nor2   g323(.a(new_n331_), .b(new_n304_), .O(new_n481_));
  oai22  g324(.a(new_n481_), .b(new_n321_), .c(x118), .d(x110), .O(new_n482_));
  nor2   g325(.a(x038), .b(new_n304_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n307_), .c(x070), .O(new_n484_));
  nand4  g327(.a(new_n469_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n485_));
  nand3  g328(.a(new_n485_), .b(new_n484_), .c(new_n482_), .O(new_n486_));
  aoi21  g329(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n487_));
  nor2   g330(.a(new_n487_), .b(new_n300_), .O(new_n488_));
  aoi21  g331(.a(new_n486_), .b(new_n340_), .c(new_n488_), .O(new_n489_));
  nor2   g332(.a(new_n301_), .b(x038), .O(new_n490_));
  ...
  nand4  g337(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n495_));
