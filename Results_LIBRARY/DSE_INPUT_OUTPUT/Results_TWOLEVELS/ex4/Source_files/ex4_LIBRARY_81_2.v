...
module FAU ( 
  ...
  nor2   g001(.a(x113), .b(new_n157_), .O(z18));
  ...
  aoi21  g336(.a(new_n491_), .b(new_n157_), .c(new_n493_), .O(new_n494_));
  ...
  aoi21  g343(.a(new_n500_), .b(new_n329_), .c(new_n333_), .O(new_n501_));
  nand2  g344(.a(new_n317_), .b(new_n481_), .O(new_n502_));
  ...
  oai21  g348(.a(new_n505_), .b(new_n501_), .c(new_n157_), .O(new_n506_));
  ...
  nand3  g352(.a(new_n509_), .b(new_n157_), .c(x038), .O(new_n510_));
  inv1   g353(.a(new_n510_), .O(new_n511_));
  oai21  g354(.a(new_n511_), .b(new_n507_), .c(new_n325_), .O(new_n512_));
  ...
  oai21  g360(.a(new_n517_), .b(x046), .c(new_n479_), .O(z14));
  zero   g361(.O(z07));
  zero   g362(.O(z15));
  zero   g363(.O(z16));
  zero   g364(.O(z17));
  ...
  zero   g367(.O(z22));
  zero   g368(.O(z23));
  nor2   g369(.a(x113), .b(new_n157_), .O(z20));
  nor2   g370(.a(x113), .b(new_n157_), .O(z24));
  nor2   g371(.a(x113), .b(new_n157_), .O(z25));
  nor2   g372(.a(x113), .b(new_n157_), .O(z26));
  nor2   g373(.a(x113), .b(new_n157_), .O(z27));
endmodule
