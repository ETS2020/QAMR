// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:20 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x082), .O(z17));
  ...
  oai21  g169(.a(x102), .b(new_n193_), .c(x126), .O(new_n326_));
  ...
  oai21  g195(.a(new_n351_), .b(new_n349_), .c(x082), .O(new_n352_));
  ...
  aoi22  g262(.a(new_n197_), .b(new_n196_), .c(new_n195_), .d(new_n194_), .O(new_n420_));
  nor2   g263(.a(new_n420_), .b(new_n192_), .O(new_n421_));
  ...
  oai21  g268(.a(new_n425_), .b(new_n421_), .c(x082), .O(new_n426_));
  nand2  g269(.a(new_n425_), .b(new_n157_), .O(new_n427_));
  aoi21  g270(.a(new_n427_), .b(new_n426_), .c(x042), .O(z10));
  inv1   g271(.a(x043), .O(new_n429_));
  ...
  oai21  g287(.a(new_n444_), .b(x044), .c(new_n159_), .O(z12));
  oai22  g288(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n446_));
  inv1   g289(.a(x101), .O(new_n447_));
  aoi21  g290(.a(new_n260_), .b(new_n447_), .c(x093), .O(new_n448_));
  nand2  g291(.a(new_n251_), .b(new_n250_), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(new_n448_), .c(new_n277_), .O(new_n450_));
  oai21  g293(.a(new_n260_), .b(x109), .c(x037), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(x117), .O(new_n452_));
  oai21  g295(.a(new_n447_), .b(x061), .c(new_n250_), .O(new_n453_));
  nand3  g296(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n268_), .O(new_n455_));
  aoi21  g298(.a(new_n453_), .b(new_n255_), .c(new_n455_), .O(new_n456_));
  nand4  g299(.a(new_n456_), .b(new_n452_), .c(new_n450_), .d(new_n446_), .O(new_n457_));
  nand4  g300(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n458_));
  inv1   g301(.a(new_n458_), .O(new_n459_));
  aoi21  g302(.a(new_n457_), .b(new_n276_), .c(new_n459_), .O(new_n460_));
  nand3  g303(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n461_));
  oai21  g304(.a(new_n460_), .b(x053), .c(new_n461_), .O(new_n462_));
  aoi21  g305(.a(new_n246_), .b(x029), .c(x021), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(x077), .c(new_n243_), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n449_), .O(new_n465_));
  nand2  g308(.a(x029), .b(new_n244_), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n272_), .c(new_n277_), .O(new_n467_));
  nand2  g310(.a(new_n260_), .b(new_n447_), .O(new_n468_));
  ...
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n276_), .O(new_n472_));
  aoi21  g315(.a(new_n472_), .b(new_n465_), .c(x053), .O(new_n473_));
  oai21  g316(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(new_n272_), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n276_), .c(x037), .O(new_n476_));
  inv1   g319(.a(new_n476_), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(new_n473_), .c(new_n268_), .O(new_n478_));
  ...
  nand3  g324(.a(new_n481_), .b(new_n480_), .c(new_n478_), .O(new_n482_));
  aoi21  g325(.a(new_n462_), .b(x005), .c(new_n482_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(x045), .c(new_n159_), .O(z13));
  oai22  g327(.a(new_n328_), .b(x030), .c(new_n316_), .d(new_n324_), .O(new_n485_));
  aoi21  g328(.a(new_n157_), .b(new_n343_), .c(x094), .O(new_n486_));
  inv1   g329(.a(x110), .O(new_n487_));
  nand2  g330(.a(new_n353_), .b(new_n487_), .O(new_n488_));
  oai21  g331(.a(new_n488_), .b(new_n486_), .c(new_n308_), .O(new_n489_));
  oai21  g332(.a(new_n157_), .b(x110), .c(x038), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x118), .O(new_n491_));
  oai21  g334(.a(new_n343_), .b(x062), .c(new_n487_), .O(new_n492_));
  nand3  g335(.a(x126), .b(new_n353_), .c(new_n316_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n299_), .O(new_n494_));
  aoi21  g337(.a(new_n492_), .b(new_n312_), .c(new_n494_), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n491_), .c(new_n489_), .d(new_n485_), .O(new_n496_));
  nand4  g339(.a(x126), .b(new_n344_), .c(new_n312_), .d(x014), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n301_), .c(new_n498_), .O(new_n499_));
  nand3  g342(.a(x086), .b(new_n312_), .c(new_n324_), .O(new_n500_));
  oai21  g343(.a(new_n499_), .b(x054), .c(new_n500_), .O(new_n501_));
  aoi21  g344(.a(new_n309_), .b(x030), .c(x022), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(x078), .c(new_n324_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n488_), .O(new_n504_));
  nand2  g347(.a(x030), .b(new_n316_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n327_), .c(new_n308_), .O(new_n506_));
  nand2  g349(.a(new_n157_), .b(new_n343_), .O(new_n507_));
  aoi22  g350(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n507_), .c(x030), .O(new_n509_));
  inv1   g352(.a(new_n509_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n506_), .c(new_n301_), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n504_), .c(x054), .O(new_n512_));
  oai21  g355(.a(new_n316_), .b(new_n324_), .c(x030), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n327_), .O(new_n514_));
  nand3  g357(.a(new_n514_), .b(new_n301_), .c(x038), .O(new_n515_));
  inv1   g358(.a(new_n515_), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(new_n512_), .c(new_n299_), .O(new_n517_));
  oai22  g360(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(x070), .c(x022), .O(new_n519_));
  aoi22  g362(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n520_));
  nand3  g363(.a(new_n520_), .b(new_n519_), .c(new_n517_), .O(new_n521_));
  aoi21  g364(.a(new_n501_), .b(x006), .c(new_n521_), .O(new_n522_));
  oai21  g365(.a(new_n522_), .b(x046), .c(new_n159_), .O(z14));
  zero   g366(.O(z07));
  zero   g367(.O(z15));
  zero   g368(.O(z16));
  zero   g369(.O(z18));
  ...
  zero   g371(.O(z25));
  zero   g372(.O(z26));
  nor2   g373(.a(new_n157_), .b(x082), .O(z19));
  nor2   g374(.a(new_n157_), .b(x082), .O(z20));
  nor2   g375(.a(new_n157_), .b(x082), .O(z21));
  nor2   g376(.a(new_n157_), .b(x082), .O(z22));
  nor2   g377(.a(new_n157_), .b(x082), .O(z23));
  nor2   g378(.a(new_n157_), .b(x082), .O(z27));
endmodule
