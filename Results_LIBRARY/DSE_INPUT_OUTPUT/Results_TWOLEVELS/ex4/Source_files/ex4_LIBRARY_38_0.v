...
module FAU ( 
  ...
  nand3  g257(.a(new_n413_), .b(new_n158_), .c(new_n407_), .O(new_n414_));
  ...
  nand3  g318(.a(new_n474_), .b(new_n158_), .c(new_n434_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(z13));
  aoi21  g320(.a(x054), .b(x038), .c(x014), .O(new_n477_));
  nand3  g321(.a(x070), .b(new_n300_), .c(x022), .O(new_n478_));
  nand3  g322(.a(x086), .b(new_n311_), .c(x006), .O(new_n479_));
  nand3  g323(.a(new_n479_), .b(new_n478_), .c(x078), .O(new_n480_));
  inv1   g324(.a(new_n480_), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n477_), .c(x046), .O(z14));
  zero   g326(.O(z15));
  zero   g327(.O(z21));
  zero   g328(.O(z23));
