...
module FAU ( 
  ...
  nor2   g001(.a(x079), .b(new_n157_), .O(z16));
  ...
  aoi21  g197(.a(new_n349_), .b(x079), .c(new_n353_), .O(new_n354_));
  ...
  aoi21  g322(.a(new_n296_), .b(x014), .c(new_n298_), .O(new_n480_));
  nand2  g323(.a(x022), .b(x014), .O(new_n481_));
  nand2  g324(.a(new_n327_), .b(new_n334_), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  inv1   g326(.a(x102), .O(new_n484_));
  aoi21  g327(.a(new_n345_), .b(new_n484_), .c(x094), .O(new_n485_));
  nor2   g328(.a(x118), .b(x110), .O(new_n486_));
  inv1   g329(.a(new_n486_), .O(new_n487_));
  oai21  g330(.a(new_n487_), .b(new_n485_), .c(new_n330_), .O(new_n488_));
  oai21  g331(.a(new_n345_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g333(.a(new_n484_), .b(x062), .c(new_n314_), .O(new_n491_));
  nand3  g334(.a(x126), .b(new_n313_), .c(new_n331_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n320_), .O(new_n493_));
  aoi21  g336(.a(new_n491_), .b(new_n297_), .c(new_n493_), .O(new_n494_));
  nand4  g337(.a(new_n494_), .b(new_n490_), .c(new_n488_), .d(new_n483_), .O(new_n495_));
  nand4  g338(.a(x126), .b(new_n317_), .c(new_n297_), .d(x014), .O(new_n496_));
  inv1   g339(.a(new_n496_), .O(new_n497_));
  aoi21  g340(.a(new_n495_), .b(new_n157_), .c(new_n497_), .O(new_n498_));
  nand3  g341(.a(x086), .b(new_n297_), .c(new_n339_), .O(new_n499_));
  oai21  g342(.a(new_n498_), .b(x054), .c(new_n499_), .O(new_n500_));
  aoi21  g343(.a(new_n300_), .b(x030), .c(x022), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(x078), .c(new_n339_), .O(new_n502_));
  nand2  g345(.a(new_n502_), .b(new_n487_), .O(new_n503_));
  nand2  g346(.a(x030), .b(new_n331_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n327_), .c(new_n330_), .O(new_n505_));
  nand2  g348(.a(new_n345_), .b(new_n484_), .O(new_n506_));
  nand4  g349(.a(new_n506_), .b(new_n481_), .c(new_n300_), .d(x030), .O(new_n507_));
  inv1   g350(.a(new_n507_), .O(new_n508_));
  oai21  g351(.a(new_n508_), .b(new_n505_), .c(new_n157_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n503_), .c(x054), .O(new_n510_));
  nand2  g353(.a(new_n481_), .b(x030), .O(new_n511_));
  nand2  g354(.a(new_n511_), .b(new_n327_), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n157_), .c(x038), .O(new_n513_));
  inv1   g356(.a(new_n513_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n510_), .c(new_n320_), .O(new_n515_));
  ...
  aoi21  g362(.a(new_n500_), .b(x006), .c(new_n519_), .O(new_n520_));
  oai22  g363(.a(new_n520_), .b(x046), .c(new_n480_), .d(new_n157_), .O(z14));
  zero   g364(.O(z07));
  zero   g365(.O(z15));
  zero   g366(.O(z17));
  zero   g367(.O(z18));
  ...
  zero   g369(.O(z23));
  zero   g370(.O(z24));
  nor2   g371(.a(x079), .b(new_n157_), .O(z19));
  nor2   g372(.a(x079), .b(new_n157_), .O(z21));
  nor2   g373(.a(x079), .b(new_n157_), .O(z22));
  nor2   g374(.a(x079), .b(new_n157_), .O(z25));
  nor2   g375(.a(x079), .b(new_n157_), .O(z26));
  nor2   g376(.a(x079), .b(new_n157_), .O(z27));
endmodule
