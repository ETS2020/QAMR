...
module FAU ( 
  ...
  oai22  g047(.a(new_n197_), .b(new_n195_), .c(new_n196_), .d(new_n194_), .O(new_n204_));
  nand3  g048(.a(new_n204_), .b(new_n203_), .c(new_n172_), .O(new_n205_));
  aoi21  g049(.a(new_n205_), .b(new_n202_), .c(new_n192_), .O(z02));
  ...
  nor2   g148(.a(x054), .b(x018), .O(new_n305_));
  ...
  nand3  g195(.a(new_n351_), .b(new_n298_), .c(new_n172_), .O(new_n352_));
  ...
  nand2  g263(.a(new_n419_), .b(new_n174_), .O(new_n420_));
  oai22  g264(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n421_));
  nand4  g265(.a(new_n421_), .b(x078), .c(x066), .d(x018), .O(new_n422_));
  ...
  oai21  g274(.a(new_n430_), .b(x043), .c(new_n174_), .O(z11));
  ...
  nand3  g324(.a(new_n480_), .b(new_n174_), .c(new_n441_), .O(new_n481_));
  ...
  zero   g370(.O(z26));
  zero   g371(.O(z27));
  nor2   g372(.a(x078), .b(new_n172_), .O(z17));
  nor2   g373(.a(x078), .b(new_n172_), .O(z19));
  nor2   g374(.a(x078), .b(new_n172_), .O(z22));
  nor2   g375(.a(x078), .b(new_n172_), .O(z23));
  nor2   g376(.a(x078), .b(new_n172_), .O(z24));
endmodule
