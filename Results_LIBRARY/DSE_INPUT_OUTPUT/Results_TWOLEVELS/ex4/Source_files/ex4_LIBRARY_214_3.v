// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:26 2020
...
module FAU ( 
  ...
  inv1   g200(.a(x041), .O(new_n357_));
  oai22  g201(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n358_));
  nand3  g202(.a(new_n358_), .b(x081), .c(x001), .O(new_n359_));
  oai22  g203(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n360_));
  nand3  g204(.a(new_n360_), .b(x065), .c(x017), .O(new_n361_));
  aoi22  g205(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n362_));
  nand3  g206(.a(new_n362_), .b(new_n361_), .c(new_n359_), .O(new_n363_));
  nand3  g207(.a(new_n363_), .b(new_n175_), .c(new_n357_), .O(new_n364_));
  inv1   g208(.a(new_n364_), .O(z09));
  oai22  g209(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n366_));
  nand3  g210(.a(new_n366_), .b(x082), .c(x002), .O(new_n367_));
  oai22  g211(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n368_));
  nand3  g212(.a(new_n368_), .b(x066), .c(x018), .O(new_n369_));
  aoi22  g213(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n370_));
  nand3  g214(.a(new_n370_), .b(new_n369_), .c(new_n367_), .O(new_n371_));
  inv1   g215(.a(new_n371_), .O(new_n372_));
  oai21  g216(.a(new_n372_), .b(x042), .c(new_n175_), .O(z10));
  inv1   g217(.a(x043), .O(new_n374_));
  oai22  g218(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n375_));
  nand3  g219(.a(new_n375_), .b(x083), .c(x003), .O(new_n376_));
  oai22  g220(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n377_));
  nand3  g221(.a(new_n377_), .b(x067), .c(x019), .O(new_n378_));
  aoi22  g222(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n379_));
  nand3  g223(.a(new_n379_), .b(new_n378_), .c(new_n376_), .O(new_n380_));
  nand3  g224(.a(new_n380_), .b(new_n175_), .c(new_n374_), .O(new_n381_));
  inv1   g225(.a(new_n381_), .O(z11));
  ...
  oai21  g233(.a(new_n389_), .b(x044), .c(new_n175_), .O(z12));
  oai22  g234(.a(new_n281_), .b(x029), .c(new_n245_), .d(new_n244_), .O(new_n391_));
  inv1   g235(.a(x101), .O(new_n392_));
  aoi21  g236(.a(new_n261_), .b(new_n392_), .c(x093), .O(new_n393_));
  nand2  g237(.a(new_n252_), .b(new_n251_), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n393_), .c(new_n278_), .O(new_n395_));
  oai21  g239(.a(new_n261_), .b(x109), .c(x037), .O(new_n396_));
  nand2  g240(.a(new_n396_), .b(x117), .O(new_n397_));
  oai21  g241(.a(new_n392_), .b(x061), .c(new_n251_), .O(new_n398_));
  nand3  g242(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(new_n269_), .O(new_n400_));
  aoi21  g244(.a(new_n398_), .b(new_n256_), .c(new_n400_), .O(new_n401_));
  nand4  g245(.a(new_n401_), .b(new_n397_), .c(new_n395_), .d(new_n391_), .O(new_n402_));
  nand4  g246(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n403_));
  inv1   g247(.a(new_n403_), .O(new_n404_));
  aoi21  g248(.a(new_n402_), .b(new_n277_), .c(new_n404_), .O(new_n405_));
  nand3  g249(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n406_));
  oai21  g250(.a(new_n405_), .b(x053), .c(new_n406_), .O(new_n407_));
  aoi21  g251(.a(new_n247_), .b(x029), .c(x021), .O(new_n408_));
  oai21  g252(.a(new_n408_), .b(x077), .c(new_n244_), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(new_n394_), .O(new_n410_));
  nand2  g254(.a(x029), .b(new_n245_), .O(new_n411_));
  aoi21  g255(.a(new_n411_), .b(new_n273_), .c(new_n278_), .O(new_n412_));
  nand2  g256(.a(new_n261_), .b(new_n392_), .O(new_n413_));
  aoi22  g257(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n414_));
  nand3  g258(.a(new_n414_), .b(new_n413_), .c(x029), .O(new_n415_));
  inv1   g259(.a(new_n415_), .O(new_n416_));
  oai21  g260(.a(new_n416_), .b(new_n412_), .c(new_n277_), .O(new_n417_));
  aoi21  g261(.a(new_n417_), .b(new_n410_), .c(x053), .O(new_n418_));
  oai21  g262(.a(new_n245_), .b(new_n244_), .c(x029), .O(new_n419_));
  nand2  g263(.a(new_n419_), .b(new_n273_), .O(new_n420_));
  nand3  g264(.a(new_n420_), .b(new_n277_), .c(x037), .O(new_n421_));
  inv1   g265(.a(new_n421_), .O(new_n422_));
  oai21  g266(.a(new_n422_), .b(new_n418_), .c(new_n269_), .O(new_n423_));
  ...
  aoi21  g271(.a(new_n407_), .b(x005), .c(new_n427_), .O(new_n428_));
  oai21  g272(.a(new_n428_), .b(x045), .c(new_n175_), .O(z13));
  oai21  g273(.a(x046), .b(x014), .c(x078), .O(new_n430_));
  inv1   g274(.a(x030), .O(new_n431_));
  nor2   g275(.a(x094), .b(x062), .O(new_n432_));
  nand2  g276(.a(new_n432_), .b(new_n431_), .O(new_n433_));
  oai21  g277(.a(new_n302_), .b(new_n298_), .c(new_n433_), .O(new_n434_));
  inv1   g278(.a(x102), .O(new_n435_));
  inv1   g279(.a(x126), .O(new_n436_));
  aoi21  g280(.a(new_n436_), .b(new_n435_), .c(x094), .O(new_n437_));
  inv1   g281(.a(x110), .O(new_n438_));
  inv1   g282(.a(x118), .O(new_n439_));
  nand2  g283(.a(new_n439_), .b(new_n438_), .O(new_n440_));
  oai21  g284(.a(new_n440_), .b(new_n437_), .c(new_n303_), .O(new_n441_));
  oai21  g285(.a(new_n436_), .b(x110), .c(x038), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(x118), .O(new_n443_));
  oai21  g287(.a(new_n435_), .b(x062), .c(new_n438_), .O(new_n444_));
  nand3  g288(.a(x126), .b(new_n439_), .c(new_n302_), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(new_n306_), .O(new_n446_));
  aoi21  g290(.a(new_n444_), .b(new_n299_), .c(new_n446_), .O(new_n447_));
  nand4  g291(.a(new_n447_), .b(new_n443_), .c(new_n441_), .d(new_n434_), .O(new_n448_));
  nor2   g292(.a(x038), .b(new_n298_), .O(new_n449_));
  nor2   g293(.a(new_n436_), .b(x062), .O(new_n450_));
  aoi22  g294(.a(new_n450_), .b(new_n449_), .c(new_n448_), .d(new_n173_), .O(new_n451_));
  nand3  g295(.a(x086), .b(new_n299_), .c(new_n298_), .O(new_n452_));
  oai21  g296(.a(new_n451_), .b(x054), .c(new_n452_), .O(new_n453_));
  nand2  g297(.a(x094), .b(x062), .O(new_n454_));
  aoi21  g298(.a(new_n454_), .b(x030), .c(x022), .O(new_n455_));
  oai21  g299(.a(new_n455_), .b(x078), .c(new_n298_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n440_), .O(new_n457_));
  nand2  g301(.a(new_n299_), .b(x030), .O(new_n458_));
  aoi21  g302(.a(new_n458_), .b(new_n432_), .c(new_n303_), .O(new_n459_));
  nand2  g303(.a(new_n436_), .b(new_n435_), .O(new_n460_));
  aoi22  g304(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n461_));
  nand3  g305(.a(new_n461_), .b(new_n460_), .c(x030), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n459_), .c(new_n173_), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n457_), .c(x054), .O(new_n465_));
  oai21  g309(.a(new_n302_), .b(new_n298_), .c(x030), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(new_n432_), .O(new_n467_));
  nand3  g311(.a(new_n467_), .b(new_n173_), .c(x038), .O(new_n468_));
  inv1   g312(.a(new_n468_), .O(new_n469_));
  oai21  g313(.a(new_n469_), .b(new_n465_), .c(new_n306_), .O(new_n470_));
  oai22  g314(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(x070), .c(x022), .O(new_n472_));
  nand2  g316(.a(x054), .b(x038), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(new_n472_), .c(new_n470_), .O(new_n474_));
  aoi21  g318(.a(new_n453_), .b(x006), .c(new_n474_), .O(new_n475_));
  oai21  g319(.a(new_n475_), .b(x046), .c(new_n430_), .O(z14));
  zero   g320(.O(z21));
  zero   g321(.O(z23));
  zero   g322(.O(z24));
  zero   g323(.O(z26));
  zero   g324(.O(z27));
  nor2   g325(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g326(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g327(.a(new_n173_), .b(new_n172_), .O(z17));
  nor2   g328(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g329(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g330(.a(new_n173_), .b(new_n172_), .O(z20));
  nor2   g331(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g332(.a(new_n173_), .b(new_n172_), .O(z25));
endmodule
