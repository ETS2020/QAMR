...
module FAU ( 
  ...
  nand2  g027(.a(new_n183_), .b(new_n178_), .O(new_n184_));
  aoi22  g028(.a(new_n182_), .b(new_n179_), .c(new_n181_), .d(new_n180_), .O(new_n185_));
  oai21  g029(.a(new_n184_), .b(x001), .c(new_n185_), .O(new_n186_));
  nand2  g030(.a(new_n186_), .b(new_n160_), .O(new_n187_));
  inv1   g031(.a(x017), .O(new_n188_));
  oai22  g032(.a(new_n182_), .b(new_n180_), .c(new_n181_), .d(new_n179_), .O(new_n189_));
  nand3  g033(.a(new_n189_), .b(new_n157_), .c(new_n188_), .O(new_n190_));
  aoi21  g034(.a(new_n190_), .b(new_n187_), .c(new_n177_), .O(z01));
  ...
  nand4  g253(.a(new_n410_), .b(new_n158_), .c(x065), .d(x017), .O(new_n411_));
  ...
  oai21  g262(.a(new_n419_), .b(x042), .c(new_n160_), .O(z10));
  ...
  nand3  g322(.a(new_n479_), .b(new_n160_), .c(new_n439_), .O(new_n480_));
  ...
  nand2  g338(.a(new_n495_), .b(new_n160_), .O(new_n496_));
  nor2   g339(.a(new_n301_), .b(new_n300_), .O(new_n497_));
  nand2  g340(.a(x126), .b(new_n157_), .O(new_n498_));
  nand2  g341(.a(new_n158_), .b(x102), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n498_), .c(new_n340_), .O(new_n500_));
  nor2   g343(.a(x126), .b(new_n297_), .O(new_n501_));
  aoi21  g344(.a(new_n500_), .b(new_n324_), .c(new_n501_), .O(new_n502_));
  nand3  g345(.a(new_n336_), .b(new_n158_), .c(x006), .O(new_n503_));
  oai21  g346(.a(new_n502_), .b(new_n299_), .c(new_n503_), .O(new_n504_));
  nand4  g347(.a(new_n158_), .b(new_n324_), .c(x038), .d(x030), .O(new_n505_));
  inv1   g348(.a(new_n505_), .O(new_n506_));
  aoi21  g349(.a(new_n504_), .b(new_n298_), .c(new_n506_), .O(new_n507_));
  nand4  g350(.a(x126), .b(new_n308_), .c(new_n157_), .d(x006), .O(new_n508_));
  nand4  g351(.a(new_n158_), .b(new_n324_), .c(x070), .d(x030), .O(new_n509_));
  ...
  nand2  g356(.a(x070), .b(x038), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n485_), .O(new_n515_));
  aoi21  g358(.a(new_n515_), .b(new_n513_), .c(new_n297_), .O(new_n516_));
  nand4  g359(.a(new_n485_), .b(new_n303_), .c(new_n324_), .d(x030), .O(new_n517_));
  inv1   g360(.a(new_n517_), .O(new_n518_));
  oai21  g361(.a(new_n518_), .b(new_n516_), .c(new_n158_), .O(new_n519_));
  ...
  nand4  g366(.a(new_n523_), .b(x126), .c(new_n157_), .d(x006), .O(new_n524_));
  nand3  g367(.a(new_n524_), .b(new_n519_), .c(new_n511_), .O(new_n525_));
  nand2  g368(.a(new_n525_), .b(new_n298_), .O(new_n526_));
  oai21  g369(.a(new_n507_), .b(new_n497_), .c(new_n526_), .O(new_n527_));
  nand3  g370(.a(new_n312_), .b(x014), .c(x006), .O(new_n528_));
  nor4   g371(.a(new_n528_), .b(new_n498_), .c(x062), .d(x054), .O(new_n529_));
  ...
  nor2   g385(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g386(.a(new_n158_), .b(new_n157_), .O(z24));
endmodule
