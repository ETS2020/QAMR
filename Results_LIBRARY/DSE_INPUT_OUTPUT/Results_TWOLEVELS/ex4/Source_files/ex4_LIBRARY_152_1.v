// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:10 2020
...
module FAU ( 
  ...
  aoi21  g320(.a(x070), .b(x038), .c(new_n298_), .O(new_n478_));
  nand2  g321(.a(new_n304_), .b(x030), .O(new_n479_));
  aoi21  g322(.a(new_n479_), .b(new_n341_), .c(x086), .O(new_n480_));
  oai22  g323(.a(new_n480_), .b(new_n478_), .c(x118), .d(x110), .O(new_n481_));
  nand3  g324(.a(new_n326_), .b(x070), .c(x030), .O(new_n482_));
  nand3  g325(.a(x102), .b(new_n316_), .c(x006), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n482_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n313_), .O(new_n485_));
  nand2  g328(.a(x022), .b(x014), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x006), .O(new_n487_));
  oai21  g330(.a(x086), .b(new_n334_), .c(new_n487_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n337_), .O(new_n489_));
  nor2   g332(.a(x126), .b(x102), .O(new_n490_));
  nand4  g333(.a(new_n486_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n491_));
  inv1   g334(.a(x094), .O(new_n492_));
  nand3  g335(.a(new_n492_), .b(new_n334_), .c(x006), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n491_), .c(new_n490_), .O(new_n494_));
  oai21  g337(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n302_), .O(new_n496_));
  oai22  g339(.a(new_n309_), .b(x110), .c(new_n492_), .d(x062), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(x126), .O(new_n498_));
  aoi21  g341(.a(x030), .b(new_n299_), .c(x086), .O(new_n499_));
  nand3  g342(.a(new_n499_), .b(new_n498_), .c(new_n496_), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(x006), .c(new_n494_), .O(new_n501_));
  nand4  g344(.a(new_n501_), .b(new_n489_), .c(new_n485_), .d(new_n481_), .O(new_n502_));
  nand2  g345(.a(x038), .b(x014), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(x070), .c(x022), .O(new_n504_));
  oai22  g347(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n299_), .O(new_n506_));
  nand2  g349(.a(x030), .b(new_n302_), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n330_), .c(x086), .O(new_n508_));
  oai21  g351(.a(new_n508_), .b(x054), .c(x038), .O(new_n509_));
  nand4  g352(.a(new_n509_), .b(new_n506_), .c(new_n504_), .d(new_n172_), .O(new_n510_));
  aoi21  g353(.a(new_n502_), .b(new_n300_), .c(new_n510_), .O(new_n511_));
  nor2   g354(.a(new_n511_), .b(x046), .O(z14));
  zero   g355(.O(z07));
  zero   g356(.O(z15));
  zero   g357(.O(z16));
  zero   g358(.O(z17));
  ...
  nor2   g366(.a(new_n172_), .b(x046), .O(z26));
  nor2   g367(.a(new_n172_), .b(x046), .O(z27));
endmodule
