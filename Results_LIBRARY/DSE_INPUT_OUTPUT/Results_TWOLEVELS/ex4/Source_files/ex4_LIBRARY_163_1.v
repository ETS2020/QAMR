// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:33 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x046), .O(z16));
  ...
  nand4  g181(.a(new_n337_), .b(new_n306_), .c(new_n303_), .d(new_n301_), .O(new_n338_));
  ...
  oai21  g186(.a(new_n341_), .b(x030), .c(new_n342_), .O(new_n343_));
  ...
  oai21  g200(.a(new_n357_), .b(x024), .c(new_n354_), .O(new_n358_));
  ...
  nand2  g204(.a(new_n361_), .b(new_n169_), .O(new_n362_));
  ...
  nand4  g216(.a(x120), .b(new_n355_), .c(new_n163_), .d(x008), .O(new_n374_));
  ...
  aoi21  g226(.a(new_n383_), .b(new_n162_), .c(new_n360_), .O(new_n384_));
  inv1   g227(.a(x024), .O(new_n385_));
  nor2   g228(.a(new_n385_), .b(x016), .O(new_n386_));
  oai21  g229(.a(new_n386_), .b(new_n357_), .c(x064), .O(new_n387_));
  inv1   g230(.a(new_n359_), .O(new_n388_));
  nand4  g231(.a(new_n380_), .b(new_n388_), .c(new_n354_), .d(x024), .O(new_n389_));
  aoi21  g232(.a(new_n389_), .b(new_n387_), .c(x072), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(new_n384_), .c(new_n164_), .O(new_n391_));
  nand2  g234(.a(new_n354_), .b(x024), .O(new_n392_));
  nand3  g235(.a(new_n392_), .b(new_n356_), .c(new_n355_), .O(new_n393_));
  nand3  g236(.a(new_n393_), .b(new_n165_), .c(x032), .O(new_n394_));
  ...
  aoi21  g242(.a(new_n395_), .b(new_n161_), .c(new_n399_), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(new_n379_), .O(new_n401_));
  nand3  g244(.a(new_n401_), .b(new_n159_), .c(new_n353_), .O(new_n402_));
  ...
  nand3  g261(.a(new_n418_), .b(new_n159_), .c(new_n412_), .O(new_n419_));
  inv1   g262(.a(new_n419_), .O(z10));
  ...
  oai21  g279(.a(new_n436_), .b(x044), .c(new_n159_), .O(z12));
  oai22  g280(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n438_));
  inv1   g281(.a(x101), .O(new_n439_));
  aoi21  g282(.a(new_n260_), .b(new_n439_), .c(x093), .O(new_n440_));
  nand2  g283(.a(new_n251_), .b(new_n250_), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(new_n440_), .c(new_n277_), .O(new_n442_));
  oai21  g285(.a(new_n260_), .b(x109), .c(x037), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(x117), .O(new_n444_));
  oai21  g287(.a(new_n439_), .b(x061), .c(new_n250_), .O(new_n445_));
  ...
  nand4  g291(.a(new_n448_), .b(new_n444_), .c(new_n442_), .d(new_n438_), .O(new_n449_));
  ...
  aoi21  g297(.a(new_n246_), .b(x029), .c(x021), .O(new_n455_));
  oai21  g298(.a(new_n455_), .b(x077), .c(new_n243_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n441_), .O(new_n457_));
  nand2  g300(.a(x029), .b(new_n244_), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(new_n272_), .c(new_n277_), .O(new_n459_));
  nand2  g302(.a(new_n260_), .b(new_n439_), .O(new_n460_));
  aoi22  g303(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n461_));
  nand3  g304(.a(new_n461_), .b(new_n460_), .c(x029), .O(new_n462_));
  inv1   g305(.a(new_n462_), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n459_), .c(new_n276_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n457_), .c(x053), .O(new_n465_));
  oai21  g308(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n466_));
  ...
  oai21  g312(.a(new_n469_), .b(new_n465_), .c(new_n268_), .O(new_n470_));
  ...
  nand3  g316(.a(new_n473_), .b(new_n472_), .c(new_n470_), .O(new_n474_));
  aoi21  g317(.a(new_n454_), .b(x005), .c(new_n474_), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(x045), .c(new_n159_), .O(z13));
  aoi21  g319(.a(x070), .b(x038), .c(new_n298_), .O(new_n477_));
  nand2  g320(.a(new_n304_), .b(x030), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n341_), .c(x086), .O(new_n479_));
  oai22  g322(.a(new_n479_), .b(new_n477_), .c(x118), .d(x110), .O(new_n480_));
  nand3  g323(.a(new_n326_), .b(x070), .c(x030), .O(new_n481_));
  nand3  g324(.a(x102), .b(new_n316_), .c(x006), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n313_), .O(new_n484_));
  nand2  g327(.a(x022), .b(x014), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(x006), .O(new_n486_));
  oai21  g329(.a(x086), .b(new_n334_), .c(new_n486_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n337_), .O(new_n488_));
  nor2   g331(.a(x126), .b(x102), .O(new_n489_));
  nand4  g332(.a(new_n485_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n490_));
  inv1   g333(.a(x094), .O(new_n491_));
  nand3  g334(.a(new_n491_), .b(new_n334_), .c(x006), .O(new_n492_));
  aoi21  g335(.a(new_n492_), .b(new_n490_), .c(new_n489_), .O(new_n493_));
  oai21  g336(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n302_), .O(new_n495_));
  oai22  g338(.a(new_n309_), .b(x110), .c(new_n491_), .d(x062), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(x126), .O(new_n497_));
  aoi21  g340(.a(x030), .b(new_n299_), .c(x086), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n497_), .c(new_n495_), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(x006), .c(new_n493_), .O(new_n500_));
  nand4  g343(.a(new_n500_), .b(new_n488_), .c(new_n484_), .d(new_n480_), .O(new_n501_));
  nand2  g344(.a(x038), .b(x014), .O(new_n502_));
  nand3  g345(.a(new_n502_), .b(x070), .c(x022), .O(new_n503_));
  oai22  g346(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n299_), .O(new_n505_));
  nand2  g348(.a(x030), .b(new_n302_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n330_), .c(x086), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(x054), .c(x038), .O(new_n508_));
  nand4  g351(.a(new_n508_), .b(new_n505_), .c(new_n503_), .d(new_n157_), .O(new_n509_));
  aoi21  g352(.a(new_n501_), .b(new_n300_), .c(new_n509_), .O(new_n510_));
  nor2   g353(.a(new_n510_), .b(x046), .O(z14));
  zero   g354(.O(z07));
  zero   g355(.O(z15));
  zero   g356(.O(z17));
  zero   g357(.O(z19));
  ...
  zero   g359(.O(z23));
  zero   g360(.O(z25));
  nor2   g361(.a(new_n157_), .b(x046), .O(z18));
  nor2   g362(.a(new_n157_), .b(x046), .O(z20));
  nor2   g363(.a(new_n157_), .b(x046), .O(z22));
  nor2   g364(.a(new_n157_), .b(x046), .O(z24));
  nor2   g365(.a(new_n157_), .b(x046), .O(z26));
  nor2   g366(.a(new_n157_), .b(x046), .O(z27));
endmodule
