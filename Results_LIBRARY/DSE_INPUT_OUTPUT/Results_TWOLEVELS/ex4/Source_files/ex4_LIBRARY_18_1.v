...
module FAU ( 
  ...
  oai21  g248(.a(new_n404_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai21  g319(.a(new_n334_), .b(new_n313_), .c(x006), .O(new_n476_));
  oai21  g320(.a(new_n342_), .b(new_n301_), .c(new_n302_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n326_), .O(new_n478_));
  aoi22  g322(.a(new_n478_), .b(new_n476_), .c(new_n309_), .d(new_n308_), .O(new_n479_));
  ...
  nand2  g330(.a(new_n486_), .b(new_n338_), .O(new_n487_));
  nand4  g331(.a(new_n484_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n488_));
  ...
  nand2  g336(.a(x126), .b(new_n309_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n301_), .c(x022), .O(new_n494_));
  nand2  g338(.a(x030), .b(new_n299_), .O(new_n495_));
  nand3  g339(.a(x126), .b(x094), .c(new_n316_), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n495_), .c(new_n326_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n494_), .c(x006), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n492_), .c(new_n487_), .d(new_n483_), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n479_), .c(new_n300_), .O(new_n500_));
  nand3  g344(.a(x126), .b(new_n308_), .c(x038), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n326_), .c(new_n298_), .O(new_n502_));
  oai22  g346(.a(new_n327_), .b(new_n301_), .c(new_n334_), .d(new_n335_), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n502_), .c(new_n299_), .O(new_n504_));
  ...
  aoi21  g352(.a(new_n508_), .b(x022), .c(x078), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n507_), .c(new_n504_), .O(new_n510_));
  inv1   g354(.a(new_n510_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n500_), .c(x046), .O(z14));
  zero   g356(.O(z15));
  zero   g357(.O(z16));
  zero   g358(.O(z19));
  zero   g359(.O(z21));
  zero   g360(.O(z24));
  nor2   g361(.a(new_n172_), .b(x046), .O(z17));
  nor2   g362(.a(new_n172_), .b(x046), .O(z18));
  nor2   g363(.a(new_n172_), .b(x046), .O(z20));
  nor2   g364(.a(new_n172_), .b(x046), .O(z22));
  nor2   g365(.a(new_n172_), .b(x046), .O(z23));
  nor2   g366(.a(new_n172_), .b(x046), .O(z25));
  nor2   g367(.a(new_n172_), .b(x046), .O(z26));
  nor2   g368(.a(new_n172_), .b(x046), .O(z27));
endmodule
