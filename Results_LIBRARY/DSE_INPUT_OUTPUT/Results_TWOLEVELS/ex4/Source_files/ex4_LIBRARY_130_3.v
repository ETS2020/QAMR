...
module FAU ( 
  ...
  aoi21  g146(.a(new_n302_), .b(x054), .c(x008), .O(new_n303_));
  ...
  aoi21  g196(.a(new_n348_), .b(new_n159_), .c(new_n352_), .O(new_n353_));
  ...
  oai21  g208(.a(new_n364_), .b(x112), .c(x032), .O(new_n365_));
  nand2  g209(.a(new_n365_), .b(x104), .O(new_n366_));
  ...
  oai21  g325(.a(new_n477_), .b(x008), .c(new_n481_), .O(new_n482_));
  ...
  nand3  g330(.a(new_n486_), .b(x078), .c(new_n159_), .O(new_n487_));
  ...
  zero   g366(.O(z24));
  zero   g367(.O(z26));
  nor2   g368(.a(new_n172_), .b(new_n159_), .O(z17));
  nor2   g369(.a(new_n172_), .b(new_n159_), .O(z18));
  nor2   g370(.a(new_n172_), .b(new_n159_), .O(z19));
  nor2   g371(.a(new_n172_), .b(new_n159_), .O(z20));
  nor2   g372(.a(new_n172_), .b(new_n159_), .O(z21));
  nor2   g373(.a(new_n172_), .b(new_n159_), .O(z25));
  nor2   g374(.a(new_n172_), .b(new_n159_), .O(z27));
endmodule
