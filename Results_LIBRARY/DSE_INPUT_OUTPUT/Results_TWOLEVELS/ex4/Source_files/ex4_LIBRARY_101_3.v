...
module FAU ( 
  ...
  nand3  g074(.a(new_n230_), .b(new_n225_), .c(new_n172_), .O(new_n231_));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x004), .O(new_n304_));
  ...
  oai21  g280(.a(new_n436_), .b(x044), .c(new_n175_), .O(z12));
  ...
  nand3  g320(.a(new_n476_), .b(new_n175_), .c(new_n438_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  aoi21  g322(.a(new_n297_), .b(x014), .c(x004), .O(new_n479_));
  ...
  aoi21  g340(.a(new_n494_), .b(new_n173_), .c(new_n496_), .O(new_n497_));
  ...
  oai21  g351(.a(new_n507_), .b(new_n504_), .c(new_n173_), .O(new_n508_));
  ...
  nand3  g355(.a(new_n511_), .b(new_n173_), .c(x038), .O(new_n512_));
  ...
  oai22  g363(.a(new_n519_), .b(x046), .c(new_n479_), .d(new_n173_), .O(z14));
  zero   g364(.O(z15));
  zero   g365(.O(z18));
  zero   g366(.O(z20));
  zero   g367(.O(z21));
  ...
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z17));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z24));
