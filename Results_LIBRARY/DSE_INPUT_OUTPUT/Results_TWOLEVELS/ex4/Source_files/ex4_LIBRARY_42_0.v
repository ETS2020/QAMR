// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:19 2020
...
module FAU ( 
  ...
  nand2  g170(.a(new_n326_), .b(x089), .O(new_n327_));
  ...
  nand4  g182(.a(new_n326_), .b(x118), .c(x089), .d(new_n297_), .O(new_n339_));
  ...
  nand4  g198(.a(new_n354_), .b(new_n326_), .c(x089), .d(new_n297_), .O(new_n355_));
  ...
  nand3  g203(.a(x038), .b(new_n359_), .c(new_n297_), .O(new_n360_));
  nand2  g204(.a(x062), .b(x054), .O(new_n361_));
  nor3   g205(.a(new_n361_), .b(new_n360_), .c(new_n327_), .O(new_n362_));
  ...
  nand2  g217(.a(new_n374_), .b(new_n166_), .O(new_n375_));
  ...
  nand3  g225(.a(x120), .b(new_n382_), .c(new_n165_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n158_), .O(new_n384_));
  aoi21  g227(.a(new_n381_), .b(new_n160_), .c(new_n384_), .O(new_n385_));
  nand4  g228(.a(new_n385_), .b(new_n378_), .c(new_n375_), .d(new_n371_), .O(new_n386_));
  nand4  g229(.a(x120), .b(new_n368_), .c(new_n160_), .d(x008), .O(new_n387_));
  inv1   g230(.a(new_n387_), .O(new_n388_));
  aoi21  g231(.a(new_n386_), .b(new_n162_), .c(new_n388_), .O(new_n389_));
  nand3  g232(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n390_));
  ...
  nand2  g238(.a(new_n395_), .b(new_n162_), .O(new_n396_));
  aoi21  g239(.a(new_n396_), .b(new_n159_), .c(new_n373_), .O(new_n397_));
  ...
  oai21  g246(.a(new_n403_), .b(new_n397_), .c(new_n161_), .O(new_n404_));
  nand2  g247(.a(new_n367_), .b(x024), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(new_n369_), .c(new_n368_), .O(new_n406_));
  nand3  g249(.a(new_n406_), .b(new_n162_), .c(x032), .O(new_n407_));
  ...
  aoi21  g255(.a(new_n408_), .b(new_n158_), .c(new_n412_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n392_), .O(new_n414_));
  nand3  g257(.a(new_n414_), .b(new_n173_), .c(new_n366_), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(z08));
  oai22  g259(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n417_));
  nand3  g260(.a(new_n417_), .b(x081), .c(x001), .O(new_n418_));
  oai22  g261(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n419_));
  nand3  g262(.a(new_n419_), .b(x065), .c(x017), .O(new_n420_));
  aoi22  g263(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n421_));
  nand3  g264(.a(new_n421_), .b(new_n420_), .c(new_n418_), .O(new_n422_));
  inv1   g265(.a(new_n422_), .O(new_n423_));
  oai21  g266(.a(new_n423_), .b(x041), .c(new_n173_), .O(z09));
  oai22  g267(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n425_));
  nand3  g268(.a(new_n425_), .b(x082), .c(x002), .O(new_n426_));
  oai22  g269(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(x066), .c(x018), .O(new_n428_));
  aoi22  g271(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n429_));
  nand3  g272(.a(new_n429_), .b(new_n428_), .c(new_n426_), .O(new_n430_));
  inv1   g273(.a(new_n430_), .O(new_n431_));
  oai21  g274(.a(new_n431_), .b(x042), .c(new_n173_), .O(z10));
  oai22  g275(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n433_));
  nand3  g276(.a(new_n433_), .b(x083), .c(x003), .O(new_n434_));
  oai22  g277(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n435_));
  nand3  g278(.a(new_n435_), .b(x067), .c(x019), .O(new_n436_));
  aoi22  g279(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n437_));
  nand3  g280(.a(new_n437_), .b(new_n436_), .c(new_n434_), .O(new_n438_));
  inv1   g281(.a(new_n438_), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(x043), .c(new_n173_), .O(z11));
  oai22  g283(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n441_));
  nand3  g284(.a(new_n441_), .b(x084), .c(x004), .O(new_n442_));
  oai22  g285(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n443_));
  nand3  g286(.a(new_n443_), .b(x068), .c(x020), .O(new_n444_));
  aoi22  g287(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(new_n444_), .c(new_n442_), .O(new_n446_));
  inv1   g289(.a(new_n446_), .O(new_n447_));
  oai21  g290(.a(new_n447_), .b(x044), .c(new_n173_), .O(z12));
  inv1   g291(.a(x045), .O(new_n449_));
  nand2  g292(.a(x021), .b(x013), .O(new_n450_));
  oai21  g293(.a(new_n279_), .b(x029), .c(new_n450_), .O(new_n451_));
  nor2   g294(.a(x125), .b(x101), .O(new_n452_));
  nor2   g295(.a(x117), .b(x109), .O(new_n453_));
  oai21  g296(.a(new_n452_), .b(x093), .c(new_n453_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n276_), .O(new_n455_));
  oai21  g298(.a(new_n259_), .b(x109), .c(x037), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(x117), .O(new_n457_));
  inv1   g300(.a(x101), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(x061), .c(new_n249_), .O(new_n459_));
  nand3  g302(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n267_), .O(new_n461_));
  aoi21  g304(.a(new_n459_), .b(new_n254_), .c(new_n461_), .O(new_n462_));
  nand4  g305(.a(new_n462_), .b(new_n457_), .c(new_n455_), .d(new_n451_), .O(new_n463_));
  nand4  g306(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n464_));
  inv1   g307(.a(new_n464_), .O(new_n465_));
  aoi21  g308(.a(new_n463_), .b(new_n275_), .c(new_n465_), .O(new_n466_));
  nand3  g309(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n467_));
  oai21  g310(.a(new_n466_), .b(x053), .c(new_n467_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(x005), .O(new_n469_));
  nand2  g312(.a(new_n245_), .b(x029), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n243_), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n275_), .O(new_n472_));
  aoi21  g315(.a(new_n472_), .b(new_n242_), .c(new_n453_), .O(new_n473_));
  nor2   g316(.a(new_n241_), .b(x021), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n279_), .c(x069), .O(new_n475_));
  inv1   g318(.a(new_n452_), .O(new_n476_));
  nand4  g319(.a(new_n476_), .b(new_n450_), .c(new_n245_), .d(x029), .O(new_n477_));
  aoi21  g320(.a(new_n477_), .b(new_n475_), .c(x077), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(new_n473_), .c(new_n240_), .O(new_n479_));
  nand2  g322(.a(new_n450_), .b(x029), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n271_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n275_), .c(x037), .O(new_n482_));
  ...
  aoi21  g330(.a(new_n483_), .b(new_n267_), .c(new_n487_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n469_), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(new_n173_), .c(new_n449_), .O(new_n490_));
  inv1   g333(.a(new_n490_), .O(z13));
  nand2  g334(.a(new_n311_), .b(new_n359_), .O(new_n492_));
  oai21  g335(.a(x078), .b(x054), .c(new_n492_), .O(new_n493_));
  nand3  g336(.a(new_n493_), .b(x086), .c(x006), .O(new_n494_));
  inv1   g337(.a(x110), .O(new_n495_));
  nand2  g338(.a(new_n352_), .b(new_n495_), .O(new_n496_));
  oai21  g339(.a(x078), .b(new_n315_), .c(new_n359_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n496_), .O(new_n498_));
  nand3  g341(.a(new_n348_), .b(new_n300_), .c(x070), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n498_), .c(x054), .O(new_n500_));
  nor3   g343(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n500_), .c(new_n298_), .O(new_n502_));
  oai22  g345(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(x070), .c(x022), .O(new_n504_));
  aoi22  g347(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n505_));
  nand4  g348(.a(new_n505_), .b(new_n504_), .c(new_n502_), .d(new_n494_), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n173_), .O(new_n507_));
  nand2  g350(.a(x022), .b(x014), .O(new_n508_));
  inv1   g351(.a(x089), .O(new_n509_));
  oai21  g352(.a(new_n324_), .b(new_n509_), .c(new_n326_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n308_), .c(new_n298_), .O(new_n511_));
  nand2  g354(.a(x089), .b(x006), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(new_n511_), .c(new_n334_), .O(new_n513_));
  nor3   g356(.a(new_n328_), .b(new_n509_), .c(new_n297_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n513_), .c(new_n299_), .O(new_n515_));
  nand4  g358(.a(x089), .b(new_n298_), .c(x038), .d(x030), .O(new_n516_));
  nand2  g359(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n508_), .O(new_n518_));
  nand4  g361(.a(x089), .b(new_n298_), .c(x070), .d(x030), .O(new_n519_));
  nand3  g362(.a(x126), .b(new_n352_), .c(x006), .O(new_n520_));
  nand2  g363(.a(new_n520_), .b(new_n519_), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(new_n315_), .O(new_n522_));
  oai22  g365(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n523_));
  nand2  g366(.a(new_n523_), .b(x102), .O(new_n524_));
  oai21  g367(.a(new_n307_), .b(new_n311_), .c(new_n496_), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n524_), .c(new_n297_), .O(new_n526_));
  nand4  g369(.a(new_n496_), .b(new_n308_), .c(new_n298_), .d(x030), .O(new_n527_));
  inv1   g370(.a(new_n527_), .O(new_n528_));
  oai21  g371(.a(new_n528_), .b(new_n526_), .c(x089), .O(new_n529_));
  inv1   g372(.a(x094), .O(new_n530_));
  nand2  g373(.a(new_n530_), .b(new_n307_), .O(new_n531_));
  nand2  g374(.a(x118), .b(new_n495_), .O(new_n532_));
  nand3  g375(.a(new_n532_), .b(new_n531_), .c(new_n492_), .O(new_n533_));
  nand3  g376(.a(new_n533_), .b(x126), .c(x006), .O(new_n534_));
  nand3  g377(.a(new_n534_), .b(new_n529_), .c(new_n522_), .O(new_n535_));
  nand2  g378(.a(new_n535_), .b(new_n299_), .O(new_n536_));
  nand2  g379(.a(new_n536_), .b(new_n518_), .O(new_n537_));
  nand3  g380(.a(new_n311_), .b(x014), .c(x006), .O(new_n538_));
  nor4   g381(.a(new_n538_), .b(new_n326_), .c(x062), .d(x054), .O(new_n539_));
  aoi21  g382(.a(new_n537_), .b(new_n300_), .c(new_n539_), .O(new_n540_));
  aoi21  g383(.a(new_n540_), .b(new_n507_), .c(x046), .O(z14));
  zero   g384(.O(z07));
  zero   g385(.O(z15));
  zero   g386(.O(z17));
  zero   g387(.O(z18));
  ...
  zero   g392(.O(z26));
  zero   g393(.O(z27));
  nor2   g394(.a(x126), .b(x089), .O(z19));
  nor2   g395(.a(x126), .b(x089), .O(z20));
  nor2   g396(.a(x126), .b(x089), .O(z24));
endmodule
