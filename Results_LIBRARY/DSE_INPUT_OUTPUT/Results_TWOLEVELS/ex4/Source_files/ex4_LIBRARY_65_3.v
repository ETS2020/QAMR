...
module FAU ( 
  ...
  nor2   g143(.a(z07), .b(x054), .O(new_n300_));
  inv1   g144(.a(x086), .O(new_n301_));
  nand2  g145(.a(new_n173_), .b(x078), .O(new_n302_));
  ...
  nand3  g150(.a(new_n306_), .b(x022), .c(new_n172_), .O(new_n307_));
  aoi21  g151(.a(new_n307_), .b(new_n305_), .c(new_n301_), .O(new_n308_));
  oai21  g152(.a(new_n308_), .b(new_n300_), .c(new_n299_), .O(new_n309_));
  oai21  g153(.a(x102), .b(x014), .c(new_n302_), .O(new_n310_));
  inv1   g154(.a(x022), .O(new_n311_));
  nor2   g155(.a(x094), .b(x062), .O(new_n312_));
  nor4   g156(.a(new_n312_), .b(new_n301_), .c(x030), .d(new_n311_), .O(new_n313_));
  inv1   g157(.a(x070), .O(new_n314_));
  inv1   g158(.a(x094), .O(new_n315_));
  nor3   g159(.a(new_n315_), .b(new_n314_), .c(x006), .O(new_n316_));
  oai21  g160(.a(new_n316_), .b(new_n313_), .c(new_n310_), .O(new_n317_));
  inv1   g161(.a(new_n312_), .O(new_n318_));
  nand3  g162(.a(new_n318_), .b(new_n306_), .c(x014), .O(new_n319_));
  nand2  g163(.a(x118), .b(x110), .O(new_n320_));
  aoi22  g164(.a(new_n320_), .b(new_n311_), .c(new_n304_), .d(new_n314_), .O(new_n321_));
  nand2  g165(.a(new_n321_), .b(new_n319_), .O(new_n322_));
  nand3  g166(.a(new_n322_), .b(new_n173_), .c(x078), .O(new_n323_));
  inv1   g167(.a(new_n304_), .O(new_n324_));
  nand2  g168(.a(x038), .b(new_n306_), .O(new_n325_));
  aoi21  g169(.a(new_n325_), .b(new_n324_), .c(x070), .O(new_n326_));
  oai21  g170(.a(new_n326_), .b(new_n320_), .c(new_n172_), .O(new_n327_));
  ...
  nand3  g175(.a(new_n331_), .b(x062), .c(new_n172_), .O(new_n332_));
  oai21  g176(.a(new_n302_), .b(new_n172_), .c(new_n332_), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(x038), .O(new_n334_));
  inv1   g178(.a(x062), .O(new_n335_));
  oai22  g179(.a(new_n302_), .b(new_n335_), .c(new_n311_), .d(x014), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(new_n315_), .O(new_n337_));
  inv1   g181(.a(x110), .O(new_n338_));
  nand2  g182(.a(x118), .b(x022), .O(new_n339_));
  oai21  g183(.a(x118), .b(new_n338_), .c(new_n339_), .O(new_n340_));
  nand3  g184(.a(new_n340_), .b(new_n173_), .c(x078), .O(new_n341_));
  aoi21  g185(.a(x062), .b(x030), .c(new_n311_), .O(new_n342_));
  oai21  g186(.a(new_n342_), .b(new_n301_), .c(new_n172_), .O(new_n343_));
  nand4  g187(.a(new_n343_), .b(new_n341_), .c(new_n337_), .d(new_n334_), .O(new_n344_));
  nand2  g188(.a(new_n344_), .b(new_n330_), .O(new_n345_));
  inv1   g189(.a(x078), .O(new_n346_));
  nand4  g190(.a(new_n173_), .b(new_n346_), .c(new_n314_), .d(new_n311_), .O(new_n347_));
  nand4  g191(.a(new_n347_), .b(new_n345_), .c(new_n329_), .d(new_n317_), .O(new_n348_));
  nand2  g192(.a(x078), .b(x014), .O(new_n349_));
  nand2  g193(.a(new_n346_), .b(x038), .O(new_n350_));
  aoi21  g194(.a(new_n350_), .b(new_n349_), .c(x086), .O(new_n351_));
  nand4  g195(.a(x078), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n352_));
  inv1   g196(.a(new_n352_), .O(new_n353_));
  aoi21  g197(.a(new_n351_), .b(new_n330_), .c(new_n353_), .O(new_n354_));
  nand3  g198(.a(new_n314_), .b(x038), .c(new_n311_), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(x078), .O(new_n356_));
  nand2  g200(.a(new_n356_), .b(new_n172_), .O(new_n357_));
  oai21  g201(.a(new_n354_), .b(x126), .c(new_n357_), .O(new_n358_));
  aoi21  g202(.a(new_n348_), .b(x054), .c(new_n358_), .O(new_n359_));
  aoi21  g203(.a(new_n359_), .b(new_n309_), .c(new_n298_), .O(z06));
  ...
  oai21  g250(.a(new_n406_), .b(x040), .c(new_n175_), .O(z08));
  ...
  oai21  g258(.a(new_n414_), .b(x041), .c(new_n175_), .O(z09));
  ...
  oai21  g275(.a(new_n431_), .b(x043), .c(new_n175_), .O(z11));
  ...
  nand3  g325(.a(new_n481_), .b(new_n175_), .c(new_n441_), .O(new_n482_));
  inv1   g326(.a(new_n482_), .O(z13));
  inv1   g327(.a(x054), .O(new_n484_));
  nand2  g328(.a(x022), .b(x014), .O(new_n485_));
  oai21  g329(.a(new_n318_), .b(x030), .c(new_n485_), .O(new_n486_));
  oai22  g330(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x102), .O(new_n488_));
  inv1   g332(.a(x118), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n338_), .O(new_n490_));
  oai21  g334(.a(new_n314_), .b(new_n299_), .c(new_n490_), .O(new_n491_));
  aoi21  g335(.a(new_n320_), .b(x126), .c(x086), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n491_), .c(new_n488_), .d(new_n486_), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n346_), .c(new_n484_), .O(new_n494_));
  nand3  g338(.a(x086), .b(new_n299_), .c(new_n172_), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n494_), .c(new_n330_), .O(new_n496_));
  aoi21  g340(.a(new_n304_), .b(x030), .c(x022), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(x078), .c(new_n172_), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n490_), .O(new_n499_));
  aoi21  g343(.a(new_n485_), .b(x102), .c(x126), .O(new_n500_));
  nand2  g344(.a(x070), .b(new_n311_), .O(new_n501_));
  oai21  g345(.a(new_n500_), .b(new_n324_), .c(new_n501_), .O(new_n502_));
  nor2   g346(.a(new_n312_), .b(new_n314_), .O(new_n503_));
  aoi21  g347(.a(new_n502_), .b(x030), .c(new_n503_), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(x078), .c(new_n499_), .O(new_n505_));
  nand2  g349(.a(new_n485_), .b(x030), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n312_), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n346_), .c(x038), .O(new_n508_));
  inv1   g352(.a(new_n508_), .O(new_n509_));
  aoi21  g353(.a(new_n505_), .b(new_n484_), .c(new_n509_), .O(new_n510_));
  ...
  oai21  g357(.a(new_n484_), .b(new_n299_), .c(new_n349_), .O(new_n514_));
  nor2   g358(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  oai21  g359(.a(new_n510_), .b(x086), .c(new_n515_), .O(new_n516_));
  oai21  g360(.a(new_n516_), .b(new_n496_), .c(new_n298_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n175_), .O(z14));
  zero   g362(.O(z15));
  zero   g363(.O(z18));
  zero   g364(.O(z19));
  zero   g365(.O(z22));
  zero   g366(.O(z25));
  nor2   g367(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g368(.a(new_n173_), .b(new_n172_), .O(z17));
  nor2   g369(.a(new_n173_), .b(new_n172_), .O(z20));
  nor2   g370(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g371(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z24));
