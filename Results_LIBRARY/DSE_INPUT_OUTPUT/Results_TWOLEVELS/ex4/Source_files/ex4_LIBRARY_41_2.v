...
module FAU ( 
  ...
  nor2   g001(.a(x124), .b(new_n157_), .O(z19));
  ...
  aoi21  g197(.a(new_n349_), .b(x124), .c(new_n353_), .O(new_n354_));
  ...
  oai21  g326(.a(new_n298_), .b(new_n479_), .c(new_n483_), .O(new_n484_));
  ...
  nand3  g359(.a(new_n516_), .b(x124), .c(x078), .O(new_n517_));
  ...
  nor2   g372(.a(x124), .b(new_n157_), .O(z22));
  nor2   g373(.a(x124), .b(new_n157_), .O(z23));
  nor2   g374(.a(x124), .b(new_n157_), .O(z25));
  nor2   g375(.a(x124), .b(new_n157_), .O(z26));
endmodule
