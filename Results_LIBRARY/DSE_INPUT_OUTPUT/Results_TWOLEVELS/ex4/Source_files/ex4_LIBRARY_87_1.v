// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:47 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x058), .O(z07));
  ...
  nand3  g262(.a(new_n418_), .b(new_n159_), .c(new_n412_), .O(new_n419_));
  ...
  nand2  g319(.a(new_n312_), .b(new_n300_), .O(new_n476_));
  ...
  oai21  g323(.a(x078), .b(new_n301_), .c(new_n300_), .O(new_n480_));
  ...
  nor3   g327(.a(new_n328_), .b(x078), .c(new_n312_), .O(new_n484_));
  ...
  nand2  g333(.a(new_n489_), .b(new_n159_), .O(new_n490_));
  nand2  g334(.a(x022), .b(x014), .O(new_n491_));
  inv1   g335(.a(x102), .O(new_n492_));
  nand2  g336(.a(x126), .b(x058), .O(new_n493_));
  oai21  g337(.a(x126), .b(new_n492_), .c(new_n493_), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n303_), .c(new_n324_), .O(new_n495_));
  nand2  g339(.a(new_n157_), .b(x006), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(new_n299_), .O(new_n497_));
  nor3   g341(.a(new_n328_), .b(x126), .c(new_n297_), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(new_n497_), .c(new_n298_), .O(new_n499_));
  nand4  g343(.a(new_n157_), .b(new_n324_), .c(x038), .d(x030), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n491_), .O(new_n502_));
  nand4  g346(.a(x126), .b(new_n308_), .c(x058), .d(x006), .O(new_n503_));
  nand4  g347(.a(new_n157_), .b(new_n324_), .c(x070), .d(x030), .O(new_n504_));
  ...
  oai21  g352(.a(new_n333_), .b(new_n312_), .c(new_n479_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n508_), .c(new_n297_), .O(new_n510_));
  nand4  g354(.a(new_n479_), .b(new_n303_), .c(new_n324_), .d(x030), .O(new_n511_));
  inv1   g355(.a(new_n511_), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(new_n510_), .c(new_n157_), .O(new_n513_));
  inv1   g357(.a(x094), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n333_), .O(new_n515_));
  nand2  g359(.a(x118), .b(new_n307_), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(new_n515_), .c(new_n476_), .O(new_n517_));
  nand4  g361(.a(new_n517_), .b(x126), .c(x058), .d(x006), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n513_), .c(new_n506_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n298_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n502_), .O(new_n521_));
  nand4  g365(.a(x126), .b(new_n315_), .c(x058), .d(new_n298_), .O(new_n522_));
  nor4   g366(.a(new_n522_), .b(x038), .c(new_n300_), .d(new_n297_), .O(new_n523_));
  aoi21  g367(.a(new_n521_), .b(new_n332_), .c(new_n523_), .O(new_n524_));
  ...
  zero   g374(.O(z26));
  zero   g375(.O(z27));
  nor2   g376(.a(new_n157_), .b(x058), .O(z17));
  nor2   g377(.a(new_n157_), .b(x058), .O(z18));
  nor2   g378(.a(new_n157_), .b(x058), .O(z19));
  nor2   g379(.a(new_n157_), .b(x058), .O(z23));
  nor2   g380(.a(new_n157_), .b(x058), .O(z24));
  nor2   g381(.a(new_n157_), .b(x058), .O(z25));
endmodule
