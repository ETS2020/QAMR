...
module FAU ( 
  ...
  oai21  g079(.a(x076), .b(x012), .c(x078), .O(new_n236_));
  aoi21  g080(.a(new_n228_), .b(new_n227_), .c(new_n236_), .O(new_n237_));
  nand3  g081(.a(new_n237_), .b(new_n235_), .c(new_n231_), .O(new_n238_));
  and2   g082(.a(new_n238_), .b(x044), .O(z04));
  ...
  nor2   g149(.a(x054), .b(x044), .O(new_n306_));
  ...
  nand3  g196(.a(new_n352_), .b(new_n299_), .c(new_n172_), .O(new_n353_));
  ...
  nand3  g272(.a(new_n428_), .b(new_n174_), .c(new_n422_), .O(new_n429_));
  ...
  nand2  g280(.a(new_n436_), .b(new_n172_), .O(new_n437_));
  nand2  g281(.a(new_n437_), .b(new_n174_), .O(z12));
  inv1   g282(.a(x045), .O(new_n439_));
  nand2  g283(.a(x021), .b(x013), .O(new_n440_));
  oai21  g284(.a(new_n280_), .b(x029), .c(new_n440_), .O(new_n441_));
  ...
  oai21  g303(.a(new_n284_), .b(new_n242_), .c(new_n244_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n276_), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n243_), .c(new_n443_), .O(new_n462_));
  ...
  nand4  g309(.a(new_n465_), .b(new_n440_), .c(new_n246_), .d(x029), .O(new_n466_));
  ...
  nand3  g322(.a(new_n478_), .b(new_n174_), .c(new_n439_), .O(new_n479_));
  ...
  nand3  g331(.a(x126), .b(new_n309_), .c(new_n301_), .O(new_n488_));
  ...
  oai21  g361(.a(new_n517_), .b(x046), .c(new_n174_), .O(z14));
  zero   g362(.O(z16));
  zero   g363(.O(z20));
  zero   g364(.O(z21));
  zero   g365(.O(z23));
  zero   g366(.O(z24));
  nor2   g367(.a(x078), .b(new_n172_), .O(z15));
  nor2   g368(.a(x078), .b(new_n172_), .O(z17));
  nor2   g369(.a(x078), .b(new_n172_), .O(z18));
  nor2   g370(.a(x078), .b(new_n172_), .O(z19));
  nor2   g371(.a(x078), .b(new_n172_), .O(z22));
  nor2   g372(.a(x078), .b(new_n172_), .O(z25));
  nor2   g373(.a(x078), .b(new_n172_), .O(z26));
  nor2   g374(.a(x078), .b(new_n172_), .O(z27));
endmodule
