// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:24 2020
...
module FAU ( 
  ...
  oai21  g257(.a(new_n414_), .b(x042), .c(new_n173_), .O(z10));
  ...
  oai21  g274(.a(new_n431_), .b(x044), .c(new_n173_), .O(z12));
  inv1   g275(.a(x045), .O(new_n433_));
  nand2  g276(.a(x021), .b(x013), .O(new_n434_));
  oai21  g277(.a(new_n279_), .b(x029), .c(new_n434_), .O(new_n435_));
  ...
  nand2  g281(.a(new_n438_), .b(new_n276_), .O(new_n439_));
  oai21  g282(.a(new_n259_), .b(x109), .c(x037), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(x117), .O(new_n441_));
  inv1   g284(.a(x101), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(x061), .c(new_n249_), .O(new_n443_));
  nand3  g286(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n267_), .O(new_n445_));
  aoi21  g288(.a(new_n443_), .b(new_n254_), .c(new_n445_), .O(new_n446_));
  nand4  g289(.a(new_n446_), .b(new_n441_), .c(new_n439_), .d(new_n435_), .O(new_n447_));
  nand4  g290(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n448_));
  inv1   g291(.a(new_n448_), .O(new_n449_));
  aoi21  g292(.a(new_n447_), .b(new_n275_), .c(new_n449_), .O(new_n450_));
  nand3  g293(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n451_));
  oai21  g294(.a(new_n450_), .b(x053), .c(new_n451_), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(x005), .O(new_n453_));
  nand2  g296(.a(new_n245_), .b(x029), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n243_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n275_), .O(new_n456_));
  aoi21  g299(.a(new_n456_), .b(new_n242_), .c(new_n437_), .O(new_n457_));
  nor2   g300(.a(new_n241_), .b(x021), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(new_n279_), .c(x069), .O(new_n459_));
  inv1   g302(.a(new_n436_), .O(new_n460_));
  nand4  g303(.a(new_n460_), .b(new_n434_), .c(new_n245_), .d(x029), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n459_), .c(x077), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n457_), .c(new_n240_), .O(new_n463_));
  nand2  g306(.a(new_n434_), .b(x029), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n271_), .O(new_n465_));
  nand3  g308(.a(new_n465_), .b(new_n275_), .c(x037), .O(new_n466_));
  ...
  aoi21  g314(.a(new_n467_), .b(new_n267_), .c(new_n471_), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n453_), .O(new_n473_));
  nand3  g316(.a(new_n473_), .b(new_n173_), .c(new_n433_), .O(new_n474_));
  ...
  zero   g327(.O(z24));
  zero   g328(.O(z27));
  nor2   g329(.a(x078), .b(x046), .O(z16));
  nor2   g330(.a(x078), .b(x046), .O(z17));
  nor2   g331(.a(x078), .b(x046), .O(z18));
  nor2   g332(.a(x078), .b(x046), .O(z20));
