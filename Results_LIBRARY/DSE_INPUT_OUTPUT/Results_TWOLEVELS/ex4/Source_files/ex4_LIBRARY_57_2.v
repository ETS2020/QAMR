...
module FAU ( 
  ...
  oai21  g238(.a(new_n395_), .b(x040), .c(new_n174_), .O(z08));
  ...
  nand3  g246(.a(new_n403_), .b(new_n174_), .c(new_n397_), .O(new_n404_));
  ...
  oai21  g255(.a(new_n412_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai21  g263(.a(new_n420_), .b(x043), .c(new_n174_), .O(z11));
  ...
  oai21  g312(.a(new_n306_), .b(x030), .c(new_n308_), .O(new_n470_));
  nand2  g313(.a(new_n318_), .b(new_n314_), .O(new_n471_));
  ...
  nand2  g317(.a(new_n474_), .b(new_n300_), .O(new_n475_));
  oai21  g318(.a(new_n318_), .b(x110), .c(x038), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(x118), .O(new_n477_));
  oai21  g320(.a(new_n314_), .b(x062), .c(new_n297_), .O(new_n478_));
  nand3  g321(.a(x126), .b(new_n298_), .c(new_n320_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n302_), .O(new_n480_));
  aoi21  g323(.a(new_n478_), .b(new_n299_), .c(new_n480_), .O(new_n481_));
  nand4  g324(.a(new_n481_), .b(new_n477_), .c(new_n475_), .d(new_n470_), .O(new_n482_));
  nand4  g325(.a(x126), .b(new_n304_), .c(new_n299_), .d(x014), .O(new_n483_));
  inv1   g326(.a(new_n483_), .O(new_n484_));
  aoi21  g327(.a(new_n482_), .b(new_n344_), .c(new_n484_), .O(new_n485_));
  oai22  g328(.a(new_n485_), .b(x054), .c(new_n337_), .d(x014), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x006), .O(new_n487_));
  oai21  g330(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n344_), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n319_), .c(new_n473_), .O(new_n490_));
  nor2   g333(.a(new_n303_), .b(x022), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n306_), .c(x070), .O(new_n492_));
  nand4  g335(.a(new_n471_), .b(new_n327_), .c(new_n308_), .d(x030), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n492_), .c(x078), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(new_n490_), .c(new_n340_), .O(new_n495_));
  inv1   g338(.a(new_n306_), .O(new_n496_));
  oai21  g339(.a(new_n309_), .b(new_n303_), .c(new_n496_), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n344_), .c(x038), .O(new_n498_));
  ...
  aoi21  g346(.a(new_n499_), .b(new_n302_), .c(new_n503_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n487_), .c(x046), .O(z14));
  zero   g348(.O(z07));
  zero   g349(.O(z16));
  zero   g350(.O(z17));
  zero   g351(.O(z18));
  ...
  zero   g358(.O(z26));
  zero   g359(.O(z27));
  nor2   g360(.a(x078), .b(new_n172_), .O(z22));
endmodule
