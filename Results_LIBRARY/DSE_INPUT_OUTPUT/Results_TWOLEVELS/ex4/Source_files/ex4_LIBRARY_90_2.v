...
module FAU ( 
  ...
  nand3  g073(.a(new_n229_), .b(new_n172_), .c(new_n224_), .O(new_n230_));
  ...
  oai21  g279(.a(new_n436_), .b(new_n432_), .c(x126), .O(new_n437_));
  nand2  g280(.a(new_n436_), .b(new_n172_), .O(new_n438_));
  aoi21  g281(.a(new_n438_), .b(new_n437_), .c(x044), .O(z12));
  oai22  g282(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n440_));
  inv1   g283(.a(x101), .O(new_n441_));
  aoi21  g284(.a(new_n259_), .b(new_n441_), .c(x093), .O(new_n442_));
  nand2  g285(.a(new_n250_), .b(new_n249_), .O(new_n443_));
  ...
  oai21  g289(.a(new_n441_), .b(x061), .c(new_n249_), .O(new_n447_));
  ...
  oai21  g310(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n468_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(x126), .b(new_n172_), .O(z20));
  nor2   g372(.a(x126), .b(new_n172_), .O(z27));
endmodule
