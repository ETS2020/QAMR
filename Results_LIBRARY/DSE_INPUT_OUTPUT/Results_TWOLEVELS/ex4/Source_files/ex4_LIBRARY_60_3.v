...
module FAU ( 
  ...
  nand2  g030(.a(new_n186_), .b(new_n175_), .O(new_n187_));
  inv1   g031(.a(x017), .O(new_n188_));
  oai22  g032(.a(new_n182_), .b(new_n180_), .c(new_n181_), .d(new_n179_), .O(new_n189_));
  nand3  g033(.a(new_n189_), .b(new_n172_), .c(new_n188_), .O(new_n190_));
  ...
  nand2  g253(.a(new_n410_), .b(new_n177_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n175_), .O(z09));
  ...
  oai21  g319(.a(new_n476_), .b(x045), .c(new_n175_), .O(z13));
