// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:29 2020
...
module FAU ( 
  ...
  nand2  g099(.a(new_n255_), .b(new_n249_), .O(new_n256_));
  inv1   g100(.a(x061), .O(new_n257_));
  oai21  g101(.a(x101), .b(new_n257_), .c(x117), .O(new_n258_));
  inv1   g102(.a(x125), .O(new_n259_));
  nand3  g103(.a(new_n259_), .b(x109), .c(x021), .O(new_n260_));
  ...
  oai21  g141(.a(new_n297_), .b(x014), .c(x109), .O(new_n298_));
  ...
  aoi22  g285(.a(new_n275_), .b(new_n254_), .c(new_n240_), .d(new_n242_), .O(new_n443_));
  nand3  g286(.a(new_n279_), .b(new_n267_), .c(new_n275_), .O(new_n444_));
  oai22  g287(.a(new_n444_), .b(x053), .c(new_n443_), .d(new_n243_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(x069), .O(new_n446_));
  nand2  g289(.a(new_n444_), .b(new_n240_), .O(new_n447_));
  aoi22  g290(.a(new_n447_), .b(x037), .c(x077), .d(x013), .O(new_n448_));
  nand3  g291(.a(new_n448_), .b(new_n446_), .c(new_n442_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n173_), .O(new_n450_));
  oai21  g293(.a(new_n250_), .b(new_n296_), .c(new_n249_), .O(new_n451_));
  aoi21  g294(.a(x069), .b(x037), .c(new_n239_), .O(new_n452_));
  nand2  g295(.a(new_n245_), .b(x029), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(new_n243_), .c(x085), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(new_n452_), .c(new_n275_), .O(new_n455_));
  oai21  g298(.a(x085), .b(new_n242_), .c(new_n455_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n451_), .O(new_n457_));
  nand2  g300(.a(x021), .b(x013), .O(new_n458_));
  inv1   g301(.a(x093), .O(new_n459_));
  nand3  g302(.a(new_n459_), .b(new_n257_), .c(new_n241_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n458_), .O(new_n461_));
  inv1   g304(.a(x101), .O(new_n462_));
  nand2  g305(.a(new_n259_), .b(new_n462_), .O(new_n463_));
  nand3  g306(.a(new_n463_), .b(new_n459_), .c(new_n276_), .O(new_n464_));
  nand3  g307(.a(x101), .b(new_n257_), .c(new_n254_), .O(new_n465_));
  nand3  g308(.a(x125), .b(new_n249_), .c(new_n243_), .O(new_n466_));
  nand4  g309(.a(new_n466_), .b(new_n465_), .c(new_n464_), .d(new_n461_), .O(new_n467_));
  nand4  g310(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n468_));
  inv1   g311(.a(new_n468_), .O(new_n469_));
  aoi21  g312(.a(new_n467_), .b(new_n275_), .c(new_n469_), .O(new_n470_));
  nand3  g313(.a(new_n463_), .b(new_n458_), .c(new_n245_), .O(new_n471_));
  oai21  g314(.a(new_n276_), .b(x021), .c(new_n471_), .O(new_n472_));
  nand4  g315(.a(new_n472_), .b(new_n267_), .c(new_n275_), .d(x029), .O(new_n473_));
  oai21  g316(.a(new_n470_), .b(new_n239_), .c(new_n473_), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(x078), .O(new_n475_));
  nor2   g318(.a(x077), .b(new_n239_), .O(new_n476_));
  nand4  g319(.a(new_n476_), .b(x125), .c(new_n250_), .d(x109), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n475_), .c(new_n457_), .O(new_n478_));
  nand3  g321(.a(new_n458_), .b(new_n267_), .c(x078), .O(new_n479_));
  nor4   g322(.a(new_n479_), .b(x077), .c(new_n254_), .d(new_n241_), .O(new_n480_));
  aoi21  g323(.a(new_n478_), .b(new_n240_), .c(new_n480_), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n450_), .c(x045), .O(z13));
  oai22  g325(.a(new_n339_), .b(x030), .c(new_n304_), .d(new_n303_), .O(new_n483_));
  inv1   g326(.a(x102), .O(new_n484_));
  aoi21  g327(.a(new_n320_), .b(new_n484_), .c(x094), .O(new_n485_));
  nand2  g328(.a(new_n311_), .b(new_n310_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n485_), .c(new_n336_), .O(new_n487_));
  oai21  g330(.a(new_n320_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x118), .O(new_n489_));
  oai21  g332(.a(new_n484_), .b(x062), .c(new_n310_), .O(new_n490_));
  nand3  g333(.a(x126), .b(new_n311_), .c(new_n304_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n328_), .O(new_n492_));
  aoi21  g335(.a(new_n490_), .b(new_n315_), .c(new_n492_), .O(new_n493_));
  nand4  g336(.a(new_n493_), .b(new_n489_), .c(new_n487_), .d(new_n483_), .O(new_n494_));
  nand4  g337(.a(x126), .b(new_n318_), .c(new_n315_), .d(x014), .O(new_n495_));
  inv1   g338(.a(new_n495_), .O(new_n496_));
  aoi21  g339(.a(new_n494_), .b(new_n296_), .c(new_n496_), .O(new_n497_));
  nand3  g340(.a(x086), .b(new_n315_), .c(new_n303_), .O(new_n498_));
  oai21  g341(.a(new_n497_), .b(x054), .c(new_n498_), .O(new_n499_));
  aoi21  g342(.a(new_n306_), .b(x030), .c(x022), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(x078), .c(new_n303_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n486_), .O(new_n502_));
  nand2  g345(.a(x030), .b(new_n304_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n332_), .c(new_n336_), .O(new_n504_));
  nand2  g347(.a(new_n320_), .b(new_n484_), .O(new_n505_));
  ...
  oai21  g351(.a(new_n508_), .b(new_n504_), .c(new_n296_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n502_), .c(x054), .O(new_n510_));
  oai21  g353(.a(new_n304_), .b(new_n303_), .c(x030), .O(new_n511_));
  nand2  g354(.a(new_n511_), .b(new_n332_), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n296_), .c(x038), .O(new_n513_));
  inv1   g356(.a(new_n513_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n510_), .c(new_n328_), .O(new_n515_));
  ...
  zero   g370(.O(z22));
  zero   g371(.O(z24));
  nor2   g372(.a(x109), .b(x078), .O(z18));
  nor2   g373(.a(x109), .b(x078), .O(z23));
  nor2   g374(.a(x109), .b(x078), .O(z25));
  nor2   g375(.a(x109), .b(x078), .O(z26));
  nor2   g376(.a(x109), .b(x078), .O(z27));
endmodule
