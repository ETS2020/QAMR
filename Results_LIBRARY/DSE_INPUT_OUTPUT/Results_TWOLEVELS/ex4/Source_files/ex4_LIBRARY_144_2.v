// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:52 2020
...
module FAU ( 
  ...
  nor2   g192(.a(new_n348_), .b(new_n172_), .O(z06));
  inv1   g193(.a(x024), .O(new_n350_));
  nor2   g194(.a(x088), .b(x056), .O(new_n351_));
  nand2  g195(.a(new_n351_), .b(new_n350_), .O(new_n352_));
  oai21  g196(.a(new_n165_), .b(new_n159_), .c(new_n352_), .O(new_n353_));
  inv1   g197(.a(x096), .O(new_n354_));
  inv1   g198(.a(x120), .O(new_n355_));
  aoi21  g199(.a(new_n355_), .b(new_n354_), .c(x088), .O(new_n356_));
  inv1   g200(.a(x104), .O(new_n357_));
  inv1   g201(.a(x112), .O(new_n358_));
  nand2  g202(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  oai21  g203(.a(new_n359_), .b(new_n356_), .c(new_n166_), .O(new_n360_));
  oai21  g204(.a(new_n355_), .b(x104), .c(x032), .O(new_n361_));
  nand2  g205(.a(new_n361_), .b(x112), .O(new_n362_));
  oai21  g206(.a(new_n354_), .b(x056), .c(new_n357_), .O(new_n363_));
  nand3  g207(.a(x120), .b(new_n358_), .c(new_n165_), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(new_n158_), .O(new_n365_));
  aoi21  g209(.a(new_n363_), .b(new_n160_), .c(new_n365_), .O(new_n366_));
  nand4  g210(.a(new_n366_), .b(new_n362_), .c(new_n360_), .d(new_n353_), .O(new_n367_));
  nor2   g211(.a(x032), .b(new_n159_), .O(new_n368_));
  nor2   g212(.a(new_n355_), .b(x056), .O(new_n369_));
  aoi22  g213(.a(new_n369_), .b(new_n368_), .c(new_n367_), .d(new_n162_), .O(new_n370_));
  nand3  g214(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n371_));
  oai21  g215(.a(new_n370_), .b(x048), .c(new_n371_), .O(new_n372_));
  nand2  g216(.a(x088), .b(x056), .O(new_n373_));
  aoi21  g217(.a(new_n373_), .b(x024), .c(x016), .O(new_n374_));
  oai21  g218(.a(new_n374_), .b(x072), .c(new_n159_), .O(new_n375_));
  nand2  g219(.a(new_n375_), .b(new_n359_), .O(new_n376_));
  nand2  g220(.a(x024), .b(new_n165_), .O(new_n377_));
  aoi21  g221(.a(new_n377_), .b(new_n351_), .c(new_n166_), .O(new_n378_));
  nand2  g222(.a(new_n355_), .b(new_n354_), .O(new_n379_));
  aoi22  g223(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n380_));
  nand3  g224(.a(new_n380_), .b(new_n379_), .c(x024), .O(new_n381_));
  inv1   g225(.a(new_n381_), .O(new_n382_));
  oai21  g226(.a(new_n382_), .b(new_n378_), .c(new_n162_), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n376_), .c(x048), .O(new_n384_));
  oai21  g228(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n351_), .O(new_n386_));
  nand3  g230(.a(new_n386_), .b(new_n162_), .c(x032), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(new_n388_));
  oai21  g232(.a(new_n388_), .b(new_n384_), .c(new_n158_), .O(new_n389_));
  oai22  g233(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n390_));
  nand3  g234(.a(new_n390_), .b(x064), .c(x016), .O(new_n391_));
  aoi22  g235(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n392_));
  nand3  g236(.a(new_n392_), .b(new_n391_), .c(new_n389_), .O(new_n393_));
  aoi21  g237(.a(new_n372_), .b(x000), .c(new_n393_), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(x040), .c(new_n174_), .O(z08));
  ...
  oai21  g246(.a(new_n402_), .b(x041), .c(new_n174_), .O(z09));
  inv1   g247(.a(x042), .O(new_n404_));
  oai22  g248(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n405_));
  nand3  g249(.a(new_n405_), .b(x082), .c(x002), .O(new_n406_));
  oai22  g250(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n407_));
  nand3  g251(.a(new_n407_), .b(x066), .c(x018), .O(new_n408_));
  aoi22  g252(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n409_));
  nand3  g253(.a(new_n409_), .b(new_n408_), .c(new_n406_), .O(new_n410_));
  nand3  g254(.a(new_n410_), .b(new_n174_), .c(new_n404_), .O(new_n411_));
  inv1   g255(.a(new_n411_), .O(z10));
  oai22  g256(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n413_));
  nand3  g257(.a(new_n413_), .b(x083), .c(x003), .O(new_n414_));
  oai22  g258(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n415_));
  nand3  g259(.a(new_n415_), .b(x067), .c(x019), .O(new_n416_));
  ...
  oai21  g263(.a(new_n419_), .b(x043), .c(new_n174_), .O(z11));
  inv1   g264(.a(x044), .O(new_n421_));
  oai22  g265(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n422_));
  nand3  g266(.a(new_n422_), .b(x084), .c(x004), .O(new_n423_));
  oai22  g267(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(x068), .c(x020), .O(new_n425_));
  aoi22  g269(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n426_));
  nand3  g270(.a(new_n426_), .b(new_n425_), .c(new_n423_), .O(new_n427_));
  nand3  g271(.a(new_n427_), .b(new_n174_), .c(new_n421_), .O(new_n428_));
  inv1   g272(.a(new_n428_), .O(z12));
  oai22  g273(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n430_));
  inv1   g274(.a(x101), .O(new_n431_));
  aoi21  g275(.a(new_n260_), .b(new_n431_), .c(x093), .O(new_n432_));
  nand2  g276(.a(new_n251_), .b(new_n250_), .O(new_n433_));
  oai21  g277(.a(new_n433_), .b(new_n432_), .c(new_n277_), .O(new_n434_));
  oai21  g278(.a(new_n260_), .b(x109), .c(x037), .O(new_n435_));
  nand2  g279(.a(new_n435_), .b(x117), .O(new_n436_));
  oai21  g280(.a(new_n431_), .b(x061), .c(new_n250_), .O(new_n437_));
  nand3  g281(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(new_n268_), .O(new_n439_));
  aoi21  g283(.a(new_n437_), .b(new_n255_), .c(new_n439_), .O(new_n440_));
  nand4  g284(.a(new_n440_), .b(new_n436_), .c(new_n434_), .d(new_n430_), .O(new_n441_));
  nand4  g285(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n442_));
  inv1   g286(.a(new_n442_), .O(new_n443_));
  aoi21  g287(.a(new_n441_), .b(new_n276_), .c(new_n443_), .O(new_n444_));
  nand3  g288(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n445_));
  oai21  g289(.a(new_n444_), .b(x053), .c(new_n445_), .O(new_n446_));
  aoi21  g290(.a(new_n246_), .b(x029), .c(x021), .O(new_n447_));
  oai21  g291(.a(new_n447_), .b(x077), .c(new_n243_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n433_), .O(new_n449_));
  nand2  g293(.a(x029), .b(new_n244_), .O(new_n450_));
  aoi21  g294(.a(new_n450_), .b(new_n272_), .c(new_n277_), .O(new_n451_));
  nand2  g295(.a(new_n260_), .b(new_n431_), .O(new_n452_));
  aoi22  g296(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n453_));
  nand3  g297(.a(new_n453_), .b(new_n452_), .c(x029), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  oai21  g299(.a(new_n455_), .b(new_n451_), .c(new_n276_), .O(new_n456_));
  aoi21  g300(.a(new_n456_), .b(new_n449_), .c(x053), .O(new_n457_));
  oai21  g301(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n272_), .O(new_n459_));
  nand3  g303(.a(new_n459_), .b(new_n276_), .c(x037), .O(new_n460_));
  inv1   g304(.a(new_n460_), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n457_), .c(new_n268_), .O(new_n462_));
  oai22  g306(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n463_));
  nand3  g307(.a(new_n463_), .b(x069), .c(x021), .O(new_n464_));
  aoi22  g308(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n465_));
  nand3  g309(.a(new_n465_), .b(new_n464_), .c(new_n462_), .O(new_n466_));
  aoi21  g310(.a(new_n446_), .b(x005), .c(new_n466_), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(x045), .c(new_n174_), .O(z13));
  oai21  g312(.a(new_n306_), .b(x030), .c(new_n308_), .O(new_n469_));
  nand2  g313(.a(new_n318_), .b(new_n314_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n305_), .O(new_n471_));
  nor2   g315(.a(x118), .b(x110), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n471_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n300_), .O(new_n474_));
  oai21  g318(.a(new_n318_), .b(x110), .c(x038), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(x118), .O(new_n476_));
  oai21  g320(.a(new_n314_), .b(x062), .c(new_n297_), .O(new_n477_));
  nand3  g321(.a(x126), .b(new_n298_), .c(new_n320_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n302_), .O(new_n479_));
  aoi21  g323(.a(new_n477_), .b(new_n299_), .c(new_n479_), .O(new_n480_));
  nand4  g324(.a(new_n480_), .b(new_n476_), .c(new_n474_), .d(new_n469_), .O(new_n481_));
  nand4  g325(.a(x126), .b(new_n304_), .c(new_n299_), .d(x014), .O(new_n482_));
  inv1   g326(.a(new_n482_), .O(new_n483_));
  aoi21  g327(.a(new_n481_), .b(new_n344_), .c(new_n483_), .O(new_n484_));
  oai22  g328(.a(new_n484_), .b(x054), .c(new_n337_), .d(x014), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(x006), .O(new_n486_));
  oai21  g330(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n344_), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n319_), .c(new_n472_), .O(new_n489_));
  nor2   g333(.a(new_n303_), .b(x022), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n306_), .c(x070), .O(new_n491_));
  nand4  g335(.a(new_n470_), .b(new_n327_), .c(new_n308_), .d(x030), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n491_), .c(x078), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n489_), .c(new_n340_), .O(new_n494_));
  inv1   g338(.a(new_n306_), .O(new_n495_));
  oai21  g339(.a(new_n309_), .b(new_n303_), .c(new_n495_), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n344_), .c(x038), .O(new_n497_));
  ...
  aoi21  g346(.a(new_n498_), .b(new_n302_), .c(new_n502_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n486_), .c(x046), .O(z14));
  zero   g348(.O(z20));
  zero   g349(.O(z21));
  zero   g350(.O(z23));
  zero   g351(.O(z25));
  zero   g352(.O(z26));
  zero   g353(.O(z27));
  nor2   g354(.a(x078), .b(new_n172_), .O(z15));
  nor2   g355(.a(x078), .b(new_n172_), .O(z16));
  nor2   g356(.a(x078), .b(new_n172_), .O(z17));
  nor2   g357(.a(x078), .b(new_n172_), .O(z18));
  nor2   g358(.a(x078), .b(new_n172_), .O(z19));
  nor2   g359(.a(x078), .b(new_n172_), .O(z22));
  nor2   g360(.a(x078), .b(new_n172_), .O(z24));
endmodule
