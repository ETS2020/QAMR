// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:00 2020
...
module FAU ( 
  ...
  inv1   g205(.a(x042), .O(new_n363_));
  oai22  g206(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n364_));
  nand3  g207(.a(new_n364_), .b(x082), .c(x002), .O(new_n365_));
  oai22  g208(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n366_));
  nand3  g209(.a(new_n366_), .b(x066), .c(x018), .O(new_n367_));
  aoi22  g210(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n368_));
  nand3  g211(.a(new_n368_), .b(new_n367_), .c(new_n365_), .O(new_n369_));
  nand3  g212(.a(new_n369_), .b(new_n157_), .c(new_n363_), .O(new_n370_));
  inv1   g213(.a(new_n370_), .O(z10));
  inv1   g214(.a(x043), .O(new_n372_));
  oai22  g215(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n373_));
  nand3  g216(.a(new_n373_), .b(x083), .c(x003), .O(new_n374_));
  oai22  g217(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n375_));
  nand3  g218(.a(new_n375_), .b(x067), .c(x019), .O(new_n376_));
  aoi22  g219(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n377_));
  nand3  g220(.a(new_n377_), .b(new_n376_), .c(new_n374_), .O(new_n378_));
  nand3  g221(.a(new_n378_), .b(new_n157_), .c(new_n372_), .O(new_n379_));
  inv1   g222(.a(new_n379_), .O(z11));
  oai22  g223(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n381_));
  nand3  g224(.a(new_n381_), .b(x084), .c(x004), .O(new_n382_));
  oai22  g225(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(x068), .c(x020), .O(new_n384_));
  aoi22  g227(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n385_));
  nand3  g228(.a(new_n385_), .b(new_n384_), .c(new_n382_), .O(new_n386_));
  inv1   g229(.a(new_n386_), .O(new_n387_));
  oai21  g230(.a(new_n387_), .b(x044), .c(new_n157_), .O(z12));
  oai22  g231(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n389_));
  inv1   g232(.a(x101), .O(new_n390_));
  aoi21  g233(.a(new_n258_), .b(new_n390_), .c(x093), .O(new_n391_));
  nand2  g234(.a(new_n249_), .b(new_n248_), .O(new_n392_));
  oai21  g235(.a(new_n392_), .b(new_n391_), .c(new_n275_), .O(new_n393_));
  oai21  g236(.a(new_n258_), .b(x109), .c(x037), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(x117), .O(new_n395_));
  oai21  g238(.a(new_n390_), .b(x061), .c(new_n248_), .O(new_n396_));
  nand3  g239(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n397_));
  nand2  g240(.a(new_n397_), .b(new_n266_), .O(new_n398_));
  aoi21  g241(.a(new_n396_), .b(new_n253_), .c(new_n398_), .O(new_n399_));
  nand4  g242(.a(new_n399_), .b(new_n395_), .c(new_n393_), .d(new_n389_), .O(new_n400_));
  nand4  g243(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n401_));
  inv1   g244(.a(new_n401_), .O(new_n402_));
  aoi21  g245(.a(new_n400_), .b(new_n274_), .c(new_n402_), .O(new_n403_));
  nand3  g246(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n404_));
  oai21  g247(.a(new_n403_), .b(x053), .c(new_n404_), .O(new_n405_));
  aoi21  g248(.a(new_n244_), .b(x029), .c(x021), .O(new_n406_));
  oai21  g249(.a(new_n406_), .b(x077), .c(new_n241_), .O(new_n407_));
  nand2  g250(.a(new_n407_), .b(new_n392_), .O(new_n408_));
  nand2  g251(.a(x029), .b(new_n242_), .O(new_n409_));
  aoi21  g252(.a(new_n409_), .b(new_n270_), .c(new_n275_), .O(new_n410_));
  nand2  g253(.a(new_n258_), .b(new_n390_), .O(new_n411_));
  aoi22  g254(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n412_));
  nand3  g255(.a(new_n412_), .b(new_n411_), .c(x029), .O(new_n413_));
  inv1   g256(.a(new_n413_), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(new_n410_), .c(new_n274_), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n408_), .c(x053), .O(new_n416_));
  oai21  g259(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n417_));
  nand2  g260(.a(new_n417_), .b(new_n270_), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(new_n274_), .c(x037), .O(new_n419_));
  inv1   g262(.a(new_n419_), .O(new_n420_));
  oai21  g263(.a(new_n420_), .b(new_n416_), .c(new_n266_), .O(new_n421_));
  ...
  aoi21  g268(.a(new_n405_), .b(x005), .c(new_n425_), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(x045), .c(new_n157_), .O(z13));
  nand2  g270(.a(x022), .b(x014), .O(new_n428_));
  inv1   g271(.a(x062), .O(new_n429_));
  inv1   g272(.a(x094), .O(new_n430_));
  nand2  g273(.a(new_n430_), .b(new_n429_), .O(new_n431_));
  oai21  g274(.a(new_n431_), .b(x030), .c(new_n428_), .O(new_n432_));
  inv1   g275(.a(x102), .O(new_n433_));
  inv1   g276(.a(x126), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n433_), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(new_n430_), .O(new_n436_));
  nor2   g279(.a(x118), .b(x110), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n436_), .O(new_n438_));
  nand2  g281(.a(new_n438_), .b(new_n300_), .O(new_n439_));
  oai21  g282(.a(new_n434_), .b(x110), .c(x038), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(x118), .O(new_n441_));
  inv1   g284(.a(x110), .O(new_n442_));
  oai21  g285(.a(new_n433_), .b(x062), .c(new_n442_), .O(new_n443_));
  inv1   g286(.a(x118), .O(new_n444_));
  nand3  g287(.a(x126), .b(new_n444_), .c(new_n299_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n303_), .O(new_n446_));
  aoi21  g289(.a(new_n443_), .b(new_n296_), .c(new_n446_), .O(new_n447_));
  nand4  g290(.a(new_n447_), .b(new_n441_), .c(new_n439_), .d(new_n432_), .O(new_n448_));
  nand4  g291(.a(x126), .b(new_n429_), .c(new_n296_), .d(x014), .O(new_n449_));
  inv1   g292(.a(new_n449_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n295_), .c(new_n450_), .O(new_n451_));
  inv1   g294(.a(x014), .O(new_n452_));
  nand3  g295(.a(x086), .b(new_n296_), .c(new_n452_), .O(new_n453_));
  oai21  g296(.a(new_n451_), .b(x054), .c(new_n453_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(x006), .O(new_n455_));
  nand2  g298(.a(x094), .b(x062), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(x030), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n299_), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(new_n295_), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n452_), .c(new_n437_), .O(new_n460_));
  inv1   g303(.a(x030), .O(new_n461_));
  nor2   g304(.a(new_n461_), .b(x022), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n431_), .c(x070), .O(new_n463_));
  nand4  g306(.a(new_n456_), .b(new_n435_), .c(new_n428_), .d(x030), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n463_), .c(x078), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n460_), .c(new_n297_), .O(new_n466_));
  nand2  g309(.a(new_n428_), .b(x030), .O(new_n467_));
  nand3  g310(.a(new_n467_), .b(new_n430_), .c(new_n429_), .O(new_n468_));
  nand3  g311(.a(new_n468_), .b(new_n295_), .c(x038), .O(new_n469_));
  ...
  aoi21  g317(.a(new_n470_), .b(new_n303_), .c(new_n474_), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n455_), .c(x046), .O(z14));
  inv1   g319(.a(new_n157_), .O(z16));
  zero   g320(.O(z07));
  zero   g321(.O(z15));
  zero   g322(.O(z18));
  zero   g323(.O(z20));
  ...
  zero   g325(.O(z26));
  zero   g326(.O(z27));
  inv1   g327(.a(new_n157_), .O(z17));
  inv1   g328(.a(new_n157_), .O(z19));
  inv1   g329(.a(new_n157_), .O(z21));
  inv1   g330(.a(new_n157_), .O(z22));
  inv1   g331(.a(new_n157_), .O(z24));
  inv1   g332(.a(new_n157_), .O(z25));
endmodule
