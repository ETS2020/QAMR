...
module FAU ( 
  ...
  oai21  g315(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n472_));
  nand2  g316(.a(new_n318_), .b(new_n314_), .O(new_n473_));
  oai22  g317(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n473_), .O(new_n475_));
  oai22  g319(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n476_));
  nand2  g320(.a(x118), .b(new_n298_), .O(new_n477_));
  oai21  g321(.a(x118), .b(x022), .c(new_n477_), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(x126), .c(x086), .O(new_n479_));
  nand4  g323(.a(new_n479_), .b(new_n476_), .c(new_n475_), .d(new_n472_), .O(new_n480_));
  nand3  g324(.a(new_n480_), .b(new_n297_), .c(new_n340_), .O(new_n481_));
  nand4  g325(.a(x086), .b(new_n172_), .c(new_n300_), .d(new_n319_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x006), .O(new_n484_));
  nor2   g328(.a(new_n331_), .b(new_n304_), .O(new_n485_));
  oai22  g329(.a(new_n485_), .b(new_n321_), .c(x118), .d(x110), .O(new_n486_));
  nor2   g330(.a(x038), .b(new_n304_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n307_), .c(x070), .O(new_n488_));
  nand4  g332(.a(new_n473_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n489_));
  nand3  g333(.a(new_n489_), .b(new_n488_), .c(new_n486_), .O(new_n490_));
  aoi21  g334(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n491_));
  nor2   g335(.a(new_n491_), .b(new_n300_), .O(new_n492_));
  aoi21  g336(.a(new_n490_), .b(new_n340_), .c(new_n492_), .O(new_n493_));
  nor2   g337(.a(new_n301_), .b(x038), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(x022), .c(x046), .O(new_n495_));
  oai21  g339(.a(new_n493_), .b(x086), .c(new_n495_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n297_), .O(new_n497_));
  nand2  g341(.a(x054), .b(x038), .O(new_n498_));
  nand4  g342(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n499_));
  nand2  g343(.a(x078), .b(x014), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(new_n498_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n172_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n497_), .c(new_n484_), .O(z14));
  zero   g347(.O(z15));
  zero   g348(.O(z16));
  zero   g349(.O(z19));
  zero   g350(.O(z21));
  zero   g351(.O(z24));
  nor2   g352(.a(x078), .b(new_n172_), .O(z17));
  nor2   g353(.a(x078), .b(new_n172_), .O(z18));
  nor2   g354(.a(x078), .b(new_n172_), .O(z20));
