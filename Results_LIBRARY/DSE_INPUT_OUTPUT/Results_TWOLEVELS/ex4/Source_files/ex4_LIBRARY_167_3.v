// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:56 2020
...
module FAU ( 
  ...
  nand3  g047(.a(new_n203_), .b(new_n172_), .c(x042), .O(new_n204_));
  ...
  oai21  g218(.a(new_n375_), .b(x042), .c(new_n172_), .O(z10));
  inv1   g219(.a(x043), .O(new_n377_));
  oai22  g220(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n378_));
  nand3  g221(.a(new_n378_), .b(x083), .c(x003), .O(new_n379_));
  oai22  g222(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n380_));
  nand3  g223(.a(new_n380_), .b(x067), .c(x019), .O(new_n381_));
  aoi22  g224(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n382_));
  nand3  g225(.a(new_n382_), .b(new_n381_), .c(new_n379_), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n172_), .c(new_n377_), .O(new_n384_));
  inv1   g227(.a(new_n384_), .O(z11));
  ...
  oai21  g235(.a(new_n392_), .b(x044), .c(new_n172_), .O(z12));
  oai22  g236(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n394_));
  inv1   g237(.a(x101), .O(new_n395_));
  aoi21  g238(.a(new_n258_), .b(new_n395_), .c(x093), .O(new_n396_));
  nand2  g239(.a(new_n249_), .b(new_n248_), .O(new_n397_));
  oai21  g240(.a(new_n397_), .b(new_n396_), .c(new_n275_), .O(new_n398_));
  oai21  g241(.a(new_n258_), .b(x109), .c(x037), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(x117), .O(new_n400_));
  oai21  g243(.a(new_n395_), .b(x061), .c(new_n248_), .O(new_n401_));
  nand3  g244(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n402_));
  nand2  g245(.a(new_n402_), .b(new_n266_), .O(new_n403_));
  aoi21  g246(.a(new_n401_), .b(new_n253_), .c(new_n403_), .O(new_n404_));
  nand4  g247(.a(new_n404_), .b(new_n400_), .c(new_n398_), .d(new_n394_), .O(new_n405_));
  nand4  g248(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n406_));
  inv1   g249(.a(new_n406_), .O(new_n407_));
  aoi21  g250(.a(new_n405_), .b(new_n274_), .c(new_n407_), .O(new_n408_));
  nand3  g251(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n409_));
  oai21  g252(.a(new_n408_), .b(x053), .c(new_n409_), .O(new_n410_));
  aoi21  g253(.a(new_n244_), .b(x029), .c(x021), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(x077), .c(new_n241_), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n397_), .O(new_n413_));
  nand2  g256(.a(x029), .b(new_n242_), .O(new_n414_));
  aoi21  g257(.a(new_n414_), .b(new_n270_), .c(new_n275_), .O(new_n415_));
  nand2  g258(.a(new_n258_), .b(new_n395_), .O(new_n416_));
  aoi22  g259(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n417_));
  nand3  g260(.a(new_n417_), .b(new_n416_), .c(x029), .O(new_n418_));
  inv1   g261(.a(new_n418_), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(new_n415_), .c(new_n274_), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n413_), .c(x053), .O(new_n421_));
  oai21  g264(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n422_));
  nand2  g265(.a(new_n422_), .b(new_n270_), .O(new_n423_));
  nand3  g266(.a(new_n423_), .b(new_n274_), .c(x037), .O(new_n424_));
  inv1   g267(.a(new_n424_), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(new_n421_), .c(new_n266_), .O(new_n426_));
  ...
  aoi21  g273(.a(new_n410_), .b(x005), .c(new_n430_), .O(new_n431_));
  oai21  g274(.a(new_n431_), .b(x045), .c(new_n172_), .O(z13));
  oai21  g275(.a(x046), .b(x014), .c(x078), .O(new_n433_));
  inv1   g276(.a(x014), .O(new_n434_));
  inv1   g277(.a(x030), .O(new_n435_));
  nor2   g278(.a(x094), .b(x062), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  oai21  g280(.a(new_n299_), .b(new_n434_), .c(new_n437_), .O(new_n438_));
  inv1   g281(.a(x102), .O(new_n439_));
  inv1   g282(.a(x126), .O(new_n440_));
  aoi21  g283(.a(new_n440_), .b(new_n439_), .c(x094), .O(new_n441_));
  inv1   g284(.a(x110), .O(new_n442_));
  inv1   g285(.a(x118), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n442_), .O(new_n444_));
  oai21  g287(.a(new_n444_), .b(new_n441_), .c(new_n300_), .O(new_n445_));
  oai21  g288(.a(new_n440_), .b(x110), .c(x038), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(x118), .O(new_n447_));
  oai21  g290(.a(new_n439_), .b(x062), .c(new_n442_), .O(new_n448_));
  nand3  g291(.a(x126), .b(new_n443_), .c(new_n299_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n303_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n296_), .c(new_n450_), .O(new_n451_));
  nand4  g294(.a(new_n451_), .b(new_n447_), .c(new_n445_), .d(new_n438_), .O(new_n452_));
  nor2   g295(.a(x038), .b(new_n434_), .O(new_n453_));
  nor2   g296(.a(new_n440_), .b(x062), .O(new_n454_));
  aoi22  g297(.a(new_n454_), .b(new_n453_), .c(new_n452_), .d(new_n295_), .O(new_n455_));
  nand3  g298(.a(x086), .b(new_n296_), .c(new_n434_), .O(new_n456_));
  oai21  g299(.a(new_n455_), .b(x054), .c(new_n456_), .O(new_n457_));
  nand2  g300(.a(x094), .b(x062), .O(new_n458_));
  aoi21  g301(.a(new_n458_), .b(x030), .c(x022), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(x078), .c(new_n434_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n444_), .O(new_n461_));
  nand2  g304(.a(new_n296_), .b(x030), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n436_), .c(new_n300_), .O(new_n463_));
  nand2  g306(.a(new_n440_), .b(new_n439_), .O(new_n464_));
  aoi22  g307(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n465_));
  nand3  g308(.a(new_n465_), .b(new_n464_), .c(x030), .O(new_n466_));
  inv1   g309(.a(new_n466_), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n463_), .c(new_n295_), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n461_), .c(x054), .O(new_n469_));
  oai21  g312(.a(new_n299_), .b(new_n434_), .c(x030), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n436_), .O(new_n471_));
  nand3  g314(.a(new_n471_), .b(new_n295_), .c(x038), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n469_), .c(new_n303_), .O(new_n474_));
  oai22  g317(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(x070), .c(x022), .O(new_n476_));
  nand2  g319(.a(x054), .b(x038), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n476_), .c(new_n474_), .O(new_n478_));
  aoi21  g321(.a(new_n457_), .b(x006), .c(new_n478_), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(x046), .c(new_n433_), .O(z14));
  inv1   g323(.a(new_n172_), .O(z15));
  zero   g324(.O(z07));
  zero   g325(.O(z16));
  zero   g326(.O(z17));
  zero   g327(.O(z25));
  inv1   g328(.a(new_n172_), .O(z18));
  inv1   g329(.a(new_n172_), .O(z19));
  inv1   g330(.a(new_n172_), .O(z20));
  inv1   g331(.a(new_n172_), .O(z21));
  inv1   g332(.a(new_n172_), .O(z22));
  inv1   g333(.a(new_n172_), .O(z23));
  inv1   g334(.a(new_n172_), .O(z24));
  inv1   g335(.a(new_n172_), .O(z26));
  inv1   g336(.a(new_n172_), .O(z27));
endmodule
