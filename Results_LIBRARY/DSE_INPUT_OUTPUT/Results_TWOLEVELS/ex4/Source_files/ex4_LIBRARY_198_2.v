// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:57 2020
...
module FAU ( 
  ...
  oai21  g267(.a(new_n423_), .b(x043), .c(new_n174_), .O(z11));
  ...
  oai22  g276(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n433_));
  inv1   g277(.a(x101), .O(new_n434_));
  aoi21  g278(.a(new_n260_), .b(new_n434_), .c(x093), .O(new_n435_));
  nand2  g279(.a(new_n251_), .b(new_n250_), .O(new_n436_));
  oai21  g280(.a(new_n436_), .b(new_n435_), .c(new_n277_), .O(new_n437_));
  oai21  g281(.a(new_n260_), .b(x109), .c(x037), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(x117), .O(new_n439_));
  oai21  g283(.a(new_n434_), .b(x061), .c(new_n250_), .O(new_n440_));
  nand3  g284(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n268_), .O(new_n442_));
  aoi21  g286(.a(new_n440_), .b(new_n255_), .c(new_n442_), .O(new_n443_));
  nand4  g287(.a(new_n443_), .b(new_n439_), .c(new_n437_), .d(new_n433_), .O(new_n444_));
  nand4  g288(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n445_));
  inv1   g289(.a(new_n445_), .O(new_n446_));
  aoi21  g290(.a(new_n444_), .b(new_n276_), .c(new_n446_), .O(new_n447_));
  nand3  g291(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n448_));
  oai21  g292(.a(new_n447_), .b(x053), .c(new_n448_), .O(new_n449_));
  aoi21  g293(.a(new_n246_), .b(x029), .c(x021), .O(new_n450_));
  oai21  g294(.a(new_n450_), .b(x077), .c(new_n243_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n436_), .O(new_n452_));
  nand2  g296(.a(x029), .b(new_n244_), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(new_n272_), .c(new_n277_), .O(new_n454_));
  nand2  g298(.a(new_n260_), .b(new_n434_), .O(new_n455_));
  ...
  oai21  g302(.a(new_n458_), .b(new_n454_), .c(new_n276_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n452_), .c(x053), .O(new_n460_));
  oai21  g304(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n461_));
  ...
  oai21  g314(.a(new_n470_), .b(x045), .c(new_n174_), .O(z13));
  oai21  g315(.a(new_n306_), .b(x030), .c(new_n308_), .O(new_n472_));
  nand2  g316(.a(new_n318_), .b(new_n314_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n305_), .O(new_n474_));
  nor2   g318(.a(x118), .b(x110), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n474_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n300_), .O(new_n477_));
  oai21  g321(.a(new_n318_), .b(x110), .c(x038), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x118), .O(new_n479_));
  oai21  g323(.a(new_n314_), .b(x062), .c(new_n297_), .O(new_n480_));
  nand3  g324(.a(x126), .b(new_n298_), .c(new_n320_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n302_), .O(new_n482_));
  aoi21  g326(.a(new_n480_), .b(new_n299_), .c(new_n482_), .O(new_n483_));
  nand4  g327(.a(new_n483_), .b(new_n479_), .c(new_n477_), .d(new_n472_), .O(new_n484_));
  nand4  g328(.a(x126), .b(new_n304_), .c(new_n299_), .d(x014), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n344_), .c(new_n486_), .O(new_n487_));
  oai22  g331(.a(new_n487_), .b(x054), .c(new_n337_), .d(x014), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x006), .O(new_n489_));
  oai21  g333(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n344_), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n319_), .c(new_n475_), .O(new_n492_));
  nor2   g336(.a(new_n303_), .b(x022), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n306_), .c(x070), .O(new_n494_));
  nand4  g338(.a(new_n473_), .b(new_n327_), .c(new_n308_), .d(x030), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n494_), .c(x078), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n492_), .c(new_n340_), .O(new_n497_));
  inv1   g341(.a(new_n306_), .O(new_n498_));
  oai21  g342(.a(new_n309_), .b(new_n303_), .c(new_n498_), .O(new_n499_));
  nand3  g343(.a(new_n499_), .b(new_n344_), .c(x038), .O(new_n500_));
  ...
  aoi21  g349(.a(new_n501_), .b(new_n302_), .c(new_n505_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n489_), .c(x046), .O(z14));
  zero   g351(.O(z15));
  zero   g352(.O(z17));
  zero   g353(.O(z20));
  zero   g354(.O(z21));
  zero   g355(.O(z22));
  zero   g356(.O(z25));
  nor2   g357(.a(x078), .b(new_n172_), .O(z16));
  nor2   g358(.a(x078), .b(new_n172_), .O(z18));
  nor2   g359(.a(x078), .b(new_n172_), .O(z19));
  nor2   g360(.a(x078), .b(new_n172_), .O(z23));
  nor2   g361(.a(x078), .b(new_n172_), .O(z24));
  nor2   g362(.a(x078), .b(new_n172_), .O(z26));
  nor2   g363(.a(x078), .b(new_n172_), .O(z27));
endmodule
