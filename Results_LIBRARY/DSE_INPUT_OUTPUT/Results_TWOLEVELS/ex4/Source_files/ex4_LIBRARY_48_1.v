...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x103), .O(z07));
  ...
  nand2  g210(.a(x104), .b(x103), .O(new_n367_));
  ...
  nand4  g235(.a(x120), .b(new_n366_), .c(x103), .d(x000), .O(new_n392_));
  ...
  oai22  g316(.a(new_n337_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n473_));
  inv1   g317(.a(x102), .O(new_n474_));
  aoi21  g318(.a(new_n317_), .b(new_n474_), .c(x094), .O(new_n475_));
  nand2  g319(.a(new_n308_), .b(new_n307_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(new_n475_), .c(new_n334_), .O(new_n477_));
  oai21  g321(.a(new_n317_), .b(x110), .c(x038), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x118), .O(new_n479_));
  oai21  g323(.a(new_n474_), .b(x062), .c(new_n307_), .O(new_n480_));
  nand3  g324(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n325_), .O(new_n482_));
  aoi21  g326(.a(new_n480_), .b(new_n312_), .c(new_n482_), .O(new_n483_));
  nand4  g327(.a(new_n483_), .b(new_n479_), .c(new_n477_), .d(new_n473_), .O(new_n484_));
  nand4  g328(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n333_), .c(new_n486_), .O(new_n487_));
  nand3  g331(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n488_));
  oai21  g332(.a(new_n487_), .b(x054), .c(new_n488_), .O(new_n489_));
  aoi21  g333(.a(new_n303_), .b(x030), .c(x022), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(x078), .c(new_n300_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n476_), .O(new_n492_));
  nand2  g336(.a(x030), .b(new_n301_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n329_), .c(new_n334_), .O(new_n494_));
  nand2  g338(.a(new_n317_), .b(new_n474_), .O(new_n495_));
  aoi22  g339(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n495_), .c(x030), .O(new_n497_));
  inv1   g341(.a(new_n497_), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(new_n494_), .c(new_n333_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n492_), .c(x054), .O(new_n500_));
  oai21  g344(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n329_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n333_), .c(x038), .O(new_n503_));
  inv1   g347(.a(new_n503_), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(new_n500_), .c(new_n325_), .O(new_n505_));
  ...
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n505_), .O(new_n509_));
  aoi21  g353(.a(new_n489_), .b(x006), .c(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(x046), .c(new_n159_), .O(z14));
  zero   g355(.O(z15));
  zero   g356(.O(z16));
  zero   g357(.O(z19));
  zero   g358(.O(z20));
  zero   g359(.O(z25));
  nor2   g360(.a(new_n157_), .b(x103), .O(z17));
  nor2   g361(.a(new_n157_), .b(x103), .O(z18));
  nor2   g362(.a(new_n157_), .b(x103), .O(z21));
  nor2   g363(.a(new_n157_), .b(x103), .O(z22));
  nor2   g364(.a(new_n157_), .b(x103), .O(z23));
  nor2   g365(.a(new_n157_), .b(x103), .O(z24));
  nor2   g366(.a(new_n157_), .b(x103), .O(z26));
  nor2   g367(.a(new_n157_), .b(x103), .O(z27));
endmodule
