// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:48 2020
...
module FAU ( 
  ...
  aoi21  g155(.a(new_n311_), .b(new_n308_), .c(new_n303_), .O(new_n312_));
  oai22  g156(.a(new_n312_), .b(new_n302_), .c(new_n299_), .d(new_n298_), .O(new_n313_));
  nand3  g157(.a(x086), .b(new_n301_), .c(new_n304_), .O(new_n314_));
  inv1   g158(.a(x006), .O(new_n315_));
  inv1   g159(.a(x102), .O(new_n316_));
  nand3  g160(.a(new_n316_), .b(x062), .c(new_n315_), .O(new_n317_));
  nand2  g161(.a(new_n317_), .b(new_n314_), .O(new_n318_));
  nand2  g162(.a(new_n318_), .b(x038), .O(new_n319_));
  inv1   g163(.a(x126), .O(new_n320_));
  nand2  g164(.a(new_n310_), .b(new_n309_), .O(new_n321_));
  nand4  g165(.a(new_n321_), .b(new_n307_), .c(x086), .d(new_n304_), .O(new_n322_));
  nand3  g166(.a(x094), .b(x070), .c(new_n315_), .O(new_n323_));
  nand2  g167(.a(new_n323_), .b(new_n322_), .O(new_n324_));
  oai21  g168(.a(new_n320_), .b(new_n316_), .c(new_n324_), .O(new_n325_));
  nand2  g169(.a(x094), .b(x062), .O(new_n326_));
  oai21  g170(.a(new_n326_), .b(new_n304_), .c(new_n321_), .O(new_n327_));
  nand2  g171(.a(new_n306_), .b(x062), .O(new_n328_));
  nand2  g172(.a(x118), .b(x022), .O(new_n329_));
  nand2  g173(.a(new_n299_), .b(x110), .O(new_n330_));
  nand3  g174(.a(new_n330_), .b(new_n329_), .c(new_n328_), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n320_), .O(new_n332_));
  nand3  g176(.a(new_n332_), .b(new_n327_), .c(x086), .O(new_n333_));
  inv1   g177(.a(new_n326_), .O(new_n334_));
  nor2   g178(.a(new_n334_), .b(new_n303_), .O(new_n335_));
  aoi22  g179(.a(new_n335_), .b(new_n301_), .c(new_n333_), .d(new_n315_), .O(new_n336_));
  nand4  g180(.a(new_n336_), .b(new_n325_), .c(new_n319_), .d(new_n313_), .O(new_n337_));
  nand2  g181(.a(new_n300_), .b(new_n309_), .O(new_n338_));
  nand3  g182(.a(new_n338_), .b(new_n301_), .c(new_n310_), .O(new_n339_));
  nand2  g183(.a(x086), .b(new_n300_), .O(new_n340_));
  ...
  nand2  g187(.a(new_n304_), .b(x022), .O(new_n344_));
  aoi21  g188(.a(new_n344_), .b(new_n334_), .c(new_n303_), .O(new_n345_));
  oai21  g189(.a(new_n345_), .b(new_n343_), .c(new_n300_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n342_), .c(new_n339_), .O(new_n347_));
  aoi21  g191(.a(new_n337_), .b(x054), .c(new_n347_), .O(new_n348_));
  nor3   g192(.a(new_n348_), .b(new_n297_), .c(new_n157_), .O(z06));
  inv1   g193(.a(x040), .O(new_n351_));
  ...
  oai21  g198(.a(new_n355_), .b(x024), .c(new_n352_), .O(new_n356_));
  nor2   g199(.a(x120), .b(x096), .O(new_n357_));
  nor2   g200(.a(x112), .b(x104), .O(new_n358_));
  oai21  g201(.a(new_n357_), .b(x088), .c(new_n358_), .O(new_n359_));
  nand2  g202(.a(new_n359_), .b(new_n169_), .O(new_n360_));
  inv1   g203(.a(x120), .O(new_n361_));
  oai21  g204(.a(new_n361_), .b(x104), .c(x032), .O(new_n362_));
  nand2  g205(.a(new_n362_), .b(x112), .O(new_n363_));
  inv1   g206(.a(x096), .O(new_n364_));
  inv1   g207(.a(x104), .O(new_n365_));
  oai21  g208(.a(new_n364_), .b(x056), .c(new_n365_), .O(new_n366_));
  inv1   g209(.a(x112), .O(new_n367_));
  nand3  g210(.a(x120), .b(new_n367_), .c(new_n168_), .O(new_n368_));
  nand2  g211(.a(new_n368_), .b(new_n161_), .O(new_n369_));
  aoi21  g212(.a(new_n366_), .b(new_n163_), .c(new_n369_), .O(new_n370_));
  nand4  g213(.a(new_n370_), .b(new_n363_), .c(new_n360_), .d(new_n356_), .O(new_n371_));
  nand4  g214(.a(x120), .b(new_n353_), .c(new_n163_), .d(x008), .O(new_n372_));
  inv1   g215(.a(new_n372_), .O(new_n373_));
  aoi21  g216(.a(new_n371_), .b(new_n165_), .c(new_n373_), .O(new_n374_));
  ...
  nand2  g223(.a(new_n380_), .b(new_n165_), .O(new_n381_));
  aoi21  g224(.a(new_n381_), .b(new_n162_), .c(new_n358_), .O(new_n382_));
  inv1   g225(.a(x024), .O(new_n383_));
  nor2   g226(.a(new_n383_), .b(x016), .O(new_n384_));
  oai21  g227(.a(new_n384_), .b(new_n355_), .c(x064), .O(new_n385_));
  inv1   g228(.a(new_n357_), .O(new_n386_));
  nand4  g229(.a(new_n378_), .b(new_n386_), .c(new_n352_), .d(x024), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n385_), .c(x072), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(new_n382_), .c(new_n164_), .O(new_n389_));
  nand2  g232(.a(new_n352_), .b(x024), .O(new_n390_));
  nand3  g233(.a(new_n390_), .b(new_n354_), .c(new_n353_), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n165_), .c(x032), .O(new_n392_));
  ...
  aoi21  g240(.a(new_n393_), .b(new_n161_), .c(new_n397_), .O(new_n398_));
  nand2  g241(.a(new_n398_), .b(new_n377_), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(new_n159_), .c(new_n351_), .O(new_n400_));
  ...
  nand3  g251(.a(new_n408_), .b(new_n159_), .c(new_n402_), .O(new_n409_));
  ...
  oai21  g269(.a(new_n426_), .b(x043), .c(new_n159_), .O(z11));
  ...
  oai22  g278(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n436_));
  inv1   g279(.a(x101), .O(new_n437_));
  aoi21  g280(.a(new_n260_), .b(new_n437_), .c(x093), .O(new_n438_));
  nand2  g281(.a(new_n251_), .b(new_n250_), .O(new_n439_));
  ...
  oai21  g285(.a(new_n437_), .b(x061), .c(new_n250_), .O(new_n443_));
  ...
  aoi21  g295(.a(new_n246_), .b(x029), .c(x021), .O(new_n453_));
  oai21  g296(.a(new_n453_), .b(x077), .c(new_n243_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n439_), .O(new_n455_));
  nand2  g298(.a(x029), .b(new_n244_), .O(new_n456_));
  aoi21  g299(.a(new_n456_), .b(new_n272_), .c(new_n277_), .O(new_n457_));
  nand2  g300(.a(new_n260_), .b(new_n437_), .O(new_n458_));
  ...
  oai21  g304(.a(new_n461_), .b(new_n457_), .c(new_n276_), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n455_), .c(x053), .O(new_n463_));
  oai21  g306(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n464_));
  ...
  oai21  g310(.a(new_n467_), .b(new_n463_), .c(new_n268_), .O(new_n468_));
  ...
  oai21  g316(.a(new_n473_), .b(x045), .c(new_n159_), .O(z13));
  inv1   g317(.a(new_n311_), .O(new_n475_));
  oai21  g318(.a(new_n307_), .b(x030), .c(new_n475_), .O(new_n476_));
  nand2  g319(.a(new_n320_), .b(new_n316_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n306_), .O(new_n478_));
  ...
  oai21  g324(.a(new_n320_), .b(x110), .c(x038), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x118), .O(new_n483_));
  oai21  g326(.a(new_n316_), .b(x062), .c(new_n298_), .O(new_n484_));
  nand3  g327(.a(x126), .b(new_n299_), .c(new_n310_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n303_), .O(new_n486_));
  aoi21  g329(.a(new_n484_), .b(new_n300_), .c(new_n486_), .O(new_n487_));
  nand4  g330(.a(new_n487_), .b(new_n483_), .c(new_n481_), .d(new_n476_), .O(new_n488_));
  nand4  g331(.a(x126), .b(new_n305_), .c(new_n300_), .d(x014), .O(new_n489_));
  inv1   g332(.a(new_n489_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n297_), .c(new_n490_), .O(new_n491_));
  oai22  g334(.a(new_n491_), .b(x054), .c(new_n340_), .d(x014), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(x006), .O(new_n493_));
  oai21  g336(.a(new_n334_), .b(new_n304_), .c(new_n310_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n297_), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n309_), .c(new_n479_), .O(new_n496_));
  nor2   g339(.a(new_n304_), .b(x022), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(new_n307_), .c(x070), .O(new_n498_));
  nand4  g341(.a(new_n477_), .b(new_n326_), .c(new_n475_), .d(x030), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n498_), .c(x078), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(new_n496_), .c(new_n343_), .O(new_n501_));
  inv1   g344(.a(new_n307_), .O(new_n502_));
  oai21  g345(.a(new_n311_), .b(new_n304_), .c(new_n502_), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n297_), .c(x038), .O(new_n504_));
  ...
  aoi21  g352(.a(new_n505_), .b(new_n303_), .c(new_n509_), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n493_), .c(x046), .O(z14));
  zero   g354(.O(z07));
  zero   g355(.O(z15));
  zero   g356(.O(z17));
  zero   g357(.O(z18));
  ...
  zero   g361(.O(z25));
  zero   g362(.O(z27));
  nor2   g363(.a(x078), .b(new_n157_), .O(z21));
  nor2   g364(.a(x078), .b(new_n157_), .O(z22));
  nor2   g365(.a(x078), .b(new_n157_), .O(z24));
  nor2   g366(.a(x078), .b(new_n157_), .O(z26));
endmodule
