...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(new_n158_), .O(z07));
  ...
  oai22  g316(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n473_));
  inv1   g317(.a(x102), .O(new_n474_));
  aoi21  g318(.a(new_n172_), .b(new_n474_), .c(x094), .O(new_n475_));
  nand2  g319(.a(new_n308_), .b(new_n307_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(new_n475_), .c(new_n333_), .O(new_n477_));
  oai21  g321(.a(new_n172_), .b(x110), .c(x038), .O(new_n478_));
  ...
  nand2  g338(.a(new_n172_), .b(new_n474_), .O(new_n495_));
  ...
  oai21  g354(.a(new_n510_), .b(x046), .c(new_n174_), .O(z14));
  zero   g355(.O(z15));
  zero   g356(.O(z17));
  zero   g357(.O(z18));
  zero   g358(.O(z20));
  ...
  zero   g361(.O(z23));
  zero   g362(.O(z27));
  nor2   g363(.a(new_n172_), .b(new_n158_), .O(z16));
  nor2   g364(.a(new_n172_), .b(new_n158_), .O(z19));
  nor2   g365(.a(new_n172_), .b(new_n158_), .O(z24));
  nor2   g366(.a(new_n172_), .b(new_n158_), .O(z25));
  nor2   g367(.a(new_n172_), .b(new_n158_), .O(z26));
endmodule
