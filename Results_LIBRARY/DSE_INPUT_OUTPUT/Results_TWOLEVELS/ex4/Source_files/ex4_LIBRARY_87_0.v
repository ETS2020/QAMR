...
module FAU ( 
  ...
  oai21  g355(.a(new_n511_), .b(new_n509_), .c(x058), .O(new_n512_));
  ...
  zero   g373(.O(z26));
  zero   g374(.O(z27));
  nor2   g375(.a(x126), .b(x058), .O(z17));
  nor2   g376(.a(x126), .b(x058), .O(z18));
  nor2   g377(.a(x126), .b(x058), .O(z19));
  nor2   g378(.a(x126), .b(x058), .O(z23));
  nor2   g379(.a(x126), .b(x058), .O(z24));
  nor2   g380(.a(x126), .b(x058), .O(z25));
endmodule
