...
module FAU ( 
  ...
  oai21  g319(.a(new_n334_), .b(new_n313_), .c(x006), .O(new_n477_));
  oai21  g320(.a(new_n342_), .b(new_n301_), .c(new_n302_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n326_), .O(new_n479_));
  aoi22  g322(.a(new_n479_), .b(new_n477_), .c(new_n309_), .d(new_n308_), .O(new_n480_));
  ...
  nand2  g330(.a(new_n487_), .b(new_n338_), .O(new_n488_));
  nand4  g331(.a(new_n485_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n489_));
  ...
  nand2  g336(.a(x126), .b(new_n309_), .O(new_n494_));
  aoi21  g337(.a(new_n494_), .b(new_n301_), .c(x022), .O(new_n495_));
  nand2  g338(.a(x030), .b(new_n299_), .O(new_n496_));
  nand3  g339(.a(x126), .b(x094), .c(new_n316_), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n496_), .c(new_n326_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n495_), .c(x006), .O(new_n499_));
  nand4  g342(.a(new_n499_), .b(new_n493_), .c(new_n488_), .d(new_n484_), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(new_n480_), .c(new_n300_), .O(new_n501_));
  nand3  g344(.a(x126), .b(new_n308_), .c(x038), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n326_), .c(new_n298_), .O(new_n503_));
  oai22  g346(.a(new_n327_), .b(new_n301_), .c(new_n334_), .d(new_n335_), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(new_n503_), .c(new_n299_), .O(new_n505_));
  nand2  g348(.a(x030), .b(new_n335_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n330_), .c(x086), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(x054), .c(x038), .O(new_n508_));
  nand3  g351(.a(x070), .b(new_n313_), .c(x022), .O(new_n509_));
  nand4  g352(.a(new_n509_), .b(new_n508_), .c(new_n505_), .d(new_n501_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n157_), .c(new_n297_), .O(new_n511_));
  inv1   g354(.a(new_n511_), .O(z14));
  zero   g355(.O(z07));
  zero   g356(.O(z15));
  zero   g357(.O(z17));
  zero   g358(.O(z18));
  ...
  zero   g362(.O(z25));
  zero   g363(.O(z27));
  nor2   g364(.a(new_n157_), .b(x046), .O(z21));
  nor2   g365(.a(new_n157_), .b(x046), .O(z22));
