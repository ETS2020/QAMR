...
module FAU ( 
  ...
  oai22  g328(.a(new_n340_), .b(x030), .c(new_n305_), .d(new_n304_), .O(new_n485_));
  inv1   g329(.a(x102), .O(new_n486_));
  aoi21  g330(.a(new_n321_), .b(new_n486_), .c(x094), .O(new_n487_));
  nand2  g331(.a(new_n312_), .b(new_n311_), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n487_), .c(new_n337_), .O(new_n489_));
  oai21  g333(.a(new_n321_), .b(x110), .c(x038), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(x118), .O(new_n491_));
  oai21  g335(.a(new_n486_), .b(x062), .c(new_n311_), .O(new_n492_));
  ...
  aoi21  g345(.a(new_n307_), .b(x030), .c(x022), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(x078), .c(new_n304_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n488_), .O(new_n504_));
  nand2  g348(.a(x030), .b(new_n305_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n333_), .c(new_n337_), .O(new_n506_));
  nand2  g350(.a(new_n321_), .b(new_n486_), .O(new_n507_));
  ...
  oai21  g354(.a(new_n510_), .b(new_n506_), .c(new_n297_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n504_), .c(x054), .O(new_n512_));
  oai21  g356(.a(new_n305_), .b(new_n304_), .c(x030), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n333_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n297_), .c(x038), .O(new_n515_));
  inv1   g359(.a(new_n515_), .O(new_n516_));
  oai21  g360(.a(new_n516_), .b(new_n512_), .c(new_n329_), .O(new_n517_));
  ...
  oai21  g366(.a(new_n522_), .b(x046), .c(new_n174_), .O(z14));
  zero   g367(.O(z16));
  zero   g368(.O(z17));
  zero   g369(.O(z20));
  zero   g370(.O(z23));
  zero   g371(.O(z24));
  nor2   g372(.a(new_n172_), .b(x078), .O(z15));
  nor2   g373(.a(new_n172_), .b(x078), .O(z18));
  nor2   g374(.a(new_n172_), .b(x078), .O(z19));
  nor2   g375(.a(new_n172_), .b(x078), .O(z21));
  nor2   g376(.a(new_n172_), .b(x078), .O(z22));
  nor2   g377(.a(new_n172_), .b(x078), .O(z25));
  nor2   g378(.a(new_n172_), .b(x078), .O(z26));
  nor2   g379(.a(new_n172_), .b(x078), .O(z27));
endmodule
