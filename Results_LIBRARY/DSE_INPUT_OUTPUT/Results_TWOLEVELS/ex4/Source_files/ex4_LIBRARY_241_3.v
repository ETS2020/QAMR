...
module FAU ( 
  ...
  oai21  g200(.a(new_n169_), .b(new_n163_), .c(new_n356_), .O(new_n357_));
  ...
  oai21  g207(.a(new_n363_), .b(new_n360_), .c(new_n170_), .O(new_n364_));
  ...
  nand3  g211(.a(x120), .b(new_n362_), .c(new_n169_), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(new_n162_), .O(new_n369_));
  aoi21  g213(.a(new_n367_), .b(new_n164_), .c(new_n369_), .O(new_n370_));
  nand4  g214(.a(new_n370_), .b(new_n366_), .c(new_n364_), .d(new_n357_), .O(new_n371_));
  nor2   g215(.a(x032), .b(new_n163_), .O(new_n372_));
  nor2   g216(.a(new_n359_), .b(x056), .O(new_n373_));
  aoi22  g217(.a(new_n373_), .b(new_n372_), .c(new_n371_), .d(new_n166_), .O(new_n374_));
  nand3  g218(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n375_));
  ...
  oai21  g222(.a(new_n378_), .b(x072), .c(new_n163_), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(new_n363_), .O(new_n380_));
  nand2  g224(.a(x024), .b(new_n169_), .O(new_n381_));
  aoi21  g225(.a(new_n381_), .b(new_n355_), .c(new_n170_), .O(new_n382_));
  ...
  oai21  g230(.a(new_n386_), .b(new_n382_), .c(new_n166_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n380_), .c(x048), .O(new_n388_));
  oai21  g232(.a(new_n169_), .b(new_n163_), .c(x024), .O(new_n389_));
  nand2  g233(.a(new_n389_), .b(new_n355_), .O(new_n390_));
  nand3  g234(.a(new_n390_), .b(new_n166_), .c(x032), .O(new_n391_));
  inv1   g235(.a(new_n391_), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n388_), .c(new_n162_), .O(new_n393_));
  ...
  oai21  g242(.a(new_n398_), .b(x040), .c(new_n160_), .O(z08));
  ...
  oai21  g250(.a(new_n406_), .b(x041), .c(new_n160_), .O(z09));
  ...
  oai21  g258(.a(new_n414_), .b(x042), .c(new_n160_), .O(z10));
  ...
  nand3  g266(.a(new_n422_), .b(new_n160_), .c(new_n416_), .O(new_n423_));
  ...
  nand3  g275(.a(new_n431_), .b(new_n160_), .c(new_n425_), .O(new_n432_));
  ...
  oai21  g320(.a(x046), .b(new_n301_), .c(new_n158_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(x078), .O(new_n478_));
  oai22  g322(.a(new_n337_), .b(x030), .c(new_n302_), .d(new_n301_), .O(new_n479_));
  ...
  oai21  g326(.a(new_n482_), .b(new_n481_), .c(new_n334_), .O(new_n483_));
  ...
  aoi21  g336(.a(new_n490_), .b(new_n157_), .c(new_n492_), .O(new_n493_));
  ...
  aoi21  g343(.a(new_n499_), .b(new_n330_), .c(new_n334_), .O(new_n500_));
  ...
  oai21  g348(.a(new_n504_), .b(new_n500_), .c(new_n157_), .O(new_n505_));
  ...
  oai21  g360(.a(new_n516_), .b(x046), .c(new_n478_), .O(z14));
  zero   g361(.O(z15));
  zero   g362(.O(z17));
  zero   g363(.O(z19));
  zero   g364(.O(z20));
