...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x036), .O(z07));
  ...
  oai21  g195(.a(new_n351_), .b(new_n349_), .c(x036), .O(new_n352_));
  ...
  oai21  g290(.a(new_n446_), .b(x044), .c(new_n174_), .O(z12));
  ...
  oai22  g330(.a(new_n327_), .b(x030), .c(new_n316_), .d(new_n324_), .O(new_n487_));
  aoi21  g331(.a(new_n172_), .b(new_n343_), .c(x094), .O(new_n488_));
  inv1   g332(.a(x110), .O(new_n489_));
  nand2  g333(.a(new_n353_), .b(new_n489_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n488_), .c(new_n308_), .O(new_n491_));
  oai21  g335(.a(new_n172_), .b(x110), .c(x038), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(x118), .O(new_n493_));
  oai21  g337(.a(new_n343_), .b(x062), .c(new_n489_), .O(new_n494_));
  nand3  g338(.a(x126), .b(new_n353_), .c(new_n316_), .O(new_n495_));
  ...
  nand4  g342(.a(x126), .b(new_n344_), .c(new_n312_), .d(x014), .O(new_n499_));
  inv1   g343(.a(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n498_), .b(new_n301_), .c(new_n500_), .O(new_n501_));
  nand3  g345(.a(x086), .b(new_n312_), .c(new_n324_), .O(new_n502_));
  ...
  nand2  g350(.a(x030), .b(new_n316_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n326_), .c(new_n308_), .O(new_n508_));
  nand2  g352(.a(new_n172_), .b(new_n343_), .O(new_n509_));
  ...
  oai21  g356(.a(new_n512_), .b(new_n508_), .c(new_n301_), .O(new_n513_));
  aoi21  g357(.a(new_n513_), .b(new_n506_), .c(x054), .O(new_n514_));
  oai21  g358(.a(new_n316_), .b(new_n324_), .c(x030), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n326_), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(new_n301_), .c(x038), .O(new_n517_));
  inv1   g361(.a(new_n517_), .O(new_n518_));
  oai21  g362(.a(new_n518_), .b(new_n514_), .c(new_n299_), .O(new_n519_));
  ...
  zero   g373(.O(z24));
  zero   g374(.O(z25));
  nor2   g375(.a(new_n172_), .b(x036), .O(z15));
  nor2   g376(.a(new_n172_), .b(x036), .O(z16));
  nor2   g377(.a(new_n172_), .b(x036), .O(z17));
  nor2   g378(.a(new_n172_), .b(x036), .O(z18));
  nor2   g379(.a(new_n172_), .b(x036), .O(z21));
  nor2   g380(.a(new_n172_), .b(x036), .O(z26));
  nor2   g381(.a(new_n172_), .b(x036), .O(z27));
endmodule
