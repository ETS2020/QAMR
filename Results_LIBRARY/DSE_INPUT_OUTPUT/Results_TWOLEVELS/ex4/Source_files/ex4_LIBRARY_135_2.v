...
module FAU ( 
  ...
  nor2   g016(.a(x078), .b(new_n172_), .O(z18));
  ...
  nor2   g155(.a(x059), .b(x054), .O(new_n312_));
  ...
  aoi21  g324(.a(new_n481_), .b(new_n305_), .c(x059), .O(new_n482_));
  ...
  aoi21  g363(.a(new_n516_), .b(new_n172_), .c(new_n520_), .O(new_n521_));
  ...
  nor2   g376(.a(x078), .b(new_n172_), .O(z20));
