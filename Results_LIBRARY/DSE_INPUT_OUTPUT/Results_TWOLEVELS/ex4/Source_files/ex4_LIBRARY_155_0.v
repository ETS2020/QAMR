...
module FAU ( 
  ...
  oai21  g256(.a(new_n412_), .b(x042), .c(new_n173_), .O(z10));
  ...
  nand3  g264(.a(new_n420_), .b(new_n173_), .c(new_n414_), .O(new_n421_));
