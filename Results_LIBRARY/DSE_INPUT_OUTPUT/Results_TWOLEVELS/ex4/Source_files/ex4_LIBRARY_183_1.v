// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:27 2020
...
module FAU ( 
  ...
  nand3  g244(.a(new_n401_), .b(new_n174_), .c(new_n353_), .O(new_n402_));
  ...
  oai21  g324(.a(new_n334_), .b(new_n313_), .c(x006), .O(new_n482_));
  oai21  g325(.a(new_n342_), .b(new_n301_), .c(new_n302_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n326_), .O(new_n484_));
  aoi22  g327(.a(new_n484_), .b(new_n482_), .c(new_n309_), .d(new_n308_), .O(new_n485_));
  nand3  g328(.a(new_n326_), .b(x070), .c(x030), .O(new_n486_));
  nand3  g329(.a(x102), .b(new_n316_), .c(x006), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n486_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n313_), .O(new_n489_));
  nand2  g332(.a(x022), .b(x014), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x006), .O(new_n491_));
  oai21  g334(.a(x086), .b(new_n334_), .c(new_n491_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n338_), .O(new_n493_));
  nand4  g336(.a(new_n490_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n494_));
  inv1   g337(.a(x094), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(new_n334_), .c(x006), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n494_), .O(new_n497_));
  oai21  g340(.a(x126), .b(x102), .c(new_n497_), .O(new_n498_));
  nand2  g341(.a(x126), .b(new_n309_), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n301_), .c(x022), .O(new_n500_));
  nand2  g343(.a(x030), .b(new_n299_), .O(new_n501_));
  nand3  g344(.a(x126), .b(x094), .c(new_n316_), .O(new_n502_));
  nand3  g345(.a(new_n502_), .b(new_n501_), .c(new_n326_), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n500_), .c(x006), .O(new_n504_));
  nand4  g347(.a(new_n504_), .b(new_n498_), .c(new_n493_), .d(new_n489_), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n485_), .c(new_n300_), .O(new_n506_));
  nand3  g349(.a(x126), .b(new_n308_), .c(x038), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n326_), .c(new_n298_), .O(new_n508_));
  oai22  g351(.a(new_n327_), .b(new_n301_), .c(new_n334_), .d(new_n335_), .O(new_n509_));
  oai21  g352(.a(new_n509_), .b(new_n508_), .c(new_n299_), .O(new_n510_));
  nand2  g353(.a(x030), .b(new_n335_), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n330_), .c(x086), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(x054), .c(x038), .O(new_n513_));
  nand3  g356(.a(x070), .b(new_n313_), .c(x022), .O(new_n514_));
  nand4  g357(.a(new_n514_), .b(new_n513_), .c(new_n510_), .d(new_n506_), .O(new_n515_));
  nand3  g358(.a(new_n515_), .b(new_n172_), .c(new_n297_), .O(new_n516_));
  ...
  zero   g364(.O(z22));
  zero   g365(.O(z24));
  nor2   g366(.a(new_n172_), .b(x046), .O(z16));
  nor2   g367(.a(new_n172_), .b(x046), .O(z18));
  nor2   g368(.a(new_n172_), .b(x046), .O(z21));
  nor2   g369(.a(new_n172_), .b(x046), .O(z23));
  nor2   g370(.a(new_n172_), .b(x046), .O(z25));
  nor2   g371(.a(new_n172_), .b(x046), .O(z26));
  nor2   g372(.a(new_n172_), .b(x046), .O(z27));
endmodule
