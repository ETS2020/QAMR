...
module FAU ( 
  ...
  nor2   g016(.a(x080), .b(new_n172_), .O(z16));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(new_n158_), .O(new_n304_));
  ...
  aoi21  g197(.a(new_n349_), .b(x080), .c(new_n353_), .O(new_n354_));
  ...
  oai21  g281(.a(new_n438_), .b(x044), .c(new_n174_), .O(z12));
  ...
  nand3  g320(.a(new_n477_), .b(new_n174_), .c(new_n240_), .O(new_n478_));
  ...
  oai21  g327(.a(new_n158_), .b(new_n480_), .c(new_n484_), .O(new_n485_));
  ...
  nand3  g360(.a(new_n517_), .b(x080), .c(x078), .O(new_n518_));
  ...
  zero   g367(.O(z20));
  zero   g368(.O(z23));
  nor2   g369(.a(x080), .b(new_n172_), .O(z18));
  nor2   g370(.a(x080), .b(new_n172_), .O(z19));
  nor2   g371(.a(x080), .b(new_n172_), .O(z21));
  nor2   g372(.a(x080), .b(new_n172_), .O(z22));
  nor2   g373(.a(x080), .b(new_n172_), .O(z24));
  nor2   g374(.a(x080), .b(new_n172_), .O(z25));
  nor2   g375(.a(x080), .b(new_n172_), .O(z26));
  nor2   g376(.a(x080), .b(new_n172_), .O(z27));
endmodule
