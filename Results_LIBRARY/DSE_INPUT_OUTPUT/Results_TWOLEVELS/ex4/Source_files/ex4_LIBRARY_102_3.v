// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:24 2020
...
module FAU ( 
  ...
  oai21  g095(.a(new_n251_), .b(new_n244_), .c(new_n247_), .O(new_n252_));
  ...
  oai21  g106(.a(x101), .b(new_n248_), .c(x109), .O(new_n263_));
  ...
  nand4  g111(.a(new_n267_), .b(new_n262_), .c(new_n259_), .d(new_n252_), .O(new_n268_));
  nand4  g112(.a(new_n264_), .b(x061), .c(x037), .d(new_n245_), .O(new_n269_));
  ...
  oai21  g117(.a(new_n271_), .b(new_n243_), .c(new_n273_), .O(new_n274_));
  ...
  aoi21  g121(.a(new_n277_), .b(x013), .c(new_n257_), .O(new_n278_));
  inv1   g122(.a(x077), .O(new_n279_));
  inv1   g123(.a(x069), .O(new_n280_));
  nor2   g124(.a(x029), .b(new_n246_), .O(new_n281_));
  oai21  g125(.a(new_n281_), .b(new_n251_), .c(new_n280_), .O(new_n282_));
  inv1   g126(.a(new_n275_), .O(new_n283_));
  nand4  g127(.a(new_n283_), .b(new_n253_), .c(new_n247_), .d(new_n244_), .O(new_n284_));
  ...
  nand2  g131(.a(new_n287_), .b(new_n250_), .O(new_n288_));
  nand3  g132(.a(new_n288_), .b(x077), .c(new_n260_), .O(new_n289_));
  nand2  g133(.a(new_n289_), .b(new_n286_), .O(new_n290_));
  nand2  g134(.a(new_n290_), .b(x085), .O(new_n291_));
  oai22  g135(.a(new_n279_), .b(new_n260_), .c(new_n243_), .d(new_n245_), .O(new_n292_));
  nand3  g136(.a(new_n292_), .b(new_n280_), .c(new_n246_), .O(new_n293_));
  aoi22  g137(.a(new_n279_), .b(new_n245_), .c(new_n243_), .d(new_n260_), .O(new_n294_));
  nand3  g138(.a(new_n294_), .b(new_n293_), .c(new_n291_), .O(new_n295_));
  aoi21  g139(.a(new_n274_), .b(new_n242_), .c(new_n295_), .O(new_n296_));
  oai21  g140(.a(new_n296_), .b(new_n241_), .c(new_n175_), .O(z05));
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x103), .O(new_n305_));
  nor2   g149(.a(x078), .b(x054), .O(new_n306_));
  oai21  g150(.a(new_n306_), .b(new_n305_), .c(new_n299_), .O(new_n307_));
  ...
  oai21  g159(.a(x126), .b(new_n315_), .c(new_n299_), .O(new_n316_));
  ...
  nand2  g184(.a(new_n299_), .b(new_n340_), .O(new_n341_));
  ...
  aoi21  g198(.a(new_n350_), .b(new_n173_), .c(new_n354_), .O(new_n355_));
  aoi21  g199(.a(new_n355_), .b(new_n307_), .c(new_n298_), .O(z06));
  ...
  nor2   g220(.a(x032), .b(new_n159_), .O(new_n377_));
  nor2   g221(.a(new_n366_), .b(x056), .O(new_n378_));
  aoi22  g222(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n162_), .O(new_n379_));
  ...
  oai21  g228(.a(new_n384_), .b(x072), .c(new_n159_), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g230(.a(x024), .b(new_n165_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n359_), .c(new_n166_), .O(new_n388_));
  ...
  oai21  g235(.a(new_n391_), .b(new_n388_), .c(new_n162_), .O(new_n392_));
  ...
  oai21  g241(.a(new_n397_), .b(new_n393_), .c(new_n158_), .O(new_n398_));
  ...
  oai21  g247(.a(new_n403_), .b(x040), .c(new_n175_), .O(z08));
  ...
  oai21  g255(.a(new_n411_), .b(x041), .c(new_n175_), .O(z09));
  ...
  nand3  g263(.a(new_n419_), .b(new_n175_), .c(new_n413_), .O(new_n420_));
  ...
  nand3  g272(.a(new_n428_), .b(new_n175_), .c(new_n422_), .O(new_n429_));
  ...
  nand3  g281(.a(new_n437_), .b(new_n175_), .c(new_n431_), .O(new_n438_));
  inv1   g282(.a(new_n438_), .O(z12));
  nand2  g283(.a(x021), .b(x013), .O(new_n440_));
  oai21  g284(.a(new_n283_), .b(x029), .c(new_n440_), .O(new_n441_));
  inv1   g285(.a(x101), .O(new_n442_));
  nand2  g286(.a(new_n264_), .b(new_n442_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n249_), .O(new_n444_));
  nor2   g288(.a(x117), .b(x109), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(new_n444_), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(new_n280_), .O(new_n447_));
  oai21  g291(.a(new_n264_), .b(x109), .c(x037), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(x117), .O(new_n449_));
  oai21  g293(.a(new_n442_), .b(x061), .c(new_n255_), .O(new_n450_));
  nand3  g294(.a(x125), .b(new_n256_), .c(new_n246_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n272_), .O(new_n452_));
  aoi21  g296(.a(new_n450_), .b(new_n260_), .c(new_n452_), .O(new_n453_));
  nand4  g297(.a(new_n453_), .b(new_n449_), .c(new_n447_), .d(new_n441_), .O(new_n454_));
  nand4  g298(.a(x125), .b(new_n248_), .c(new_n260_), .d(x013), .O(new_n455_));
  inv1   g299(.a(new_n455_), .O(new_n456_));
  aoi21  g300(.a(new_n454_), .b(new_n279_), .c(new_n456_), .O(new_n457_));
  nand3  g301(.a(x085), .b(new_n260_), .c(new_n245_), .O(new_n458_));
  oai21  g302(.a(new_n457_), .b(x053), .c(new_n458_), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(x005), .O(new_n460_));
  oai21  g304(.a(new_n250_), .b(new_n244_), .c(new_n246_), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n279_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n245_), .c(new_n445_), .O(new_n463_));
  nor2   g307(.a(new_n244_), .b(x021), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n283_), .c(x069), .O(new_n465_));
  nand4  g309(.a(new_n443_), .b(new_n440_), .c(new_n251_), .d(x029), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n465_), .c(x077), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(new_n463_), .c(new_n243_), .O(new_n468_));
  nand2  g312(.a(new_n440_), .b(x029), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n275_), .O(new_n470_));
  nand3  g314(.a(new_n470_), .b(new_n279_), .c(x037), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n468_), .O(new_n472_));
  ...
  nand4  g320(.a(new_n476_), .b(new_n475_), .c(new_n473_), .d(new_n460_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n175_), .c(new_n241_), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(z13));
  aoi21  g323(.a(new_n298_), .b(x014), .c(x103), .O(new_n480_));
  nand2  g324(.a(x022), .b(x014), .O(new_n481_));
  nand2  g325(.a(new_n328_), .b(new_n335_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  inv1   g327(.a(x102), .O(new_n484_));
  aoi21  g328(.a(new_n346_), .b(new_n484_), .c(x094), .O(new_n485_));
  nor2   g329(.a(x118), .b(x110), .O(new_n486_));
  inv1   g330(.a(new_n486_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n485_), .c(new_n331_), .O(new_n488_));
  oai21  g332(.a(new_n346_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g334(.a(new_n484_), .b(x062), .c(new_n315_), .O(new_n491_));
  nand3  g335(.a(x126), .b(new_n314_), .c(new_n332_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n321_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n299_), .c(new_n493_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n490_), .c(new_n488_), .d(new_n483_), .O(new_n495_));
  nand4  g339(.a(x126), .b(new_n318_), .c(new_n299_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n172_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n299_), .c(new_n340_), .O(new_n499_));
  oai21  g343(.a(new_n498_), .b(x054), .c(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n301_), .b(x030), .c(x022), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(x078), .c(new_n340_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n487_), .O(new_n503_));
  nand2  g347(.a(x030), .b(new_n332_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n328_), .c(new_n331_), .O(new_n505_));
  nand2  g349(.a(new_n346_), .b(new_n484_), .O(new_n506_));
  nand4  g350(.a(new_n506_), .b(new_n481_), .c(new_n301_), .d(x030), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n505_), .c(new_n172_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n503_), .c(x054), .O(new_n510_));
  nand2  g354(.a(new_n481_), .b(x030), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n328_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n172_), .c(x038), .O(new_n513_));
  inv1   g357(.a(new_n513_), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(new_n510_), .c(new_n321_), .O(new_n515_));
  oai22  g359(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(x070), .c(x022), .O(new_n517_));
  nand2  g361(.a(x054), .b(x038), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n515_), .O(new_n519_));
  aoi21  g363(.a(new_n500_), .b(x006), .c(new_n519_), .O(new_n520_));
  oai22  g364(.a(new_n520_), .b(x046), .c(new_n480_), .d(new_n172_), .O(z14));
  zero   g365(.O(z15));
  zero   g366(.O(z17));
  zero   g367(.O(z20));
  zero   g368(.O(z22));
  ...
  zero   g370(.O(z25));
  zero   g371(.O(z27));
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g377(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
