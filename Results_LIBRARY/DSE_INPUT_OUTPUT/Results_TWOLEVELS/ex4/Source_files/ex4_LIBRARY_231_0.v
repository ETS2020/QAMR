...
module FAU ( 
  ...
  nand3  g320(.a(new_n476_), .b(new_n158_), .c(new_n436_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  aoi21  g322(.a(x054), .b(x038), .c(x014), .O(new_n479_));
  nand3  g323(.a(x070), .b(new_n301_), .c(x022), .O(new_n480_));
  nand3  g324(.a(x086), .b(new_n312_), .c(x006), .O(new_n481_));
  nand3  g325(.a(new_n481_), .b(new_n480_), .c(new_n479_), .O(new_n482_));
  nand3  g326(.a(new_n482_), .b(x078), .c(new_n297_), .O(new_n483_));
  ...
  nor2   g337(.a(x078), .b(x046), .O(z17));
  nor2   g338(.a(x078), .b(x046), .O(z23));
