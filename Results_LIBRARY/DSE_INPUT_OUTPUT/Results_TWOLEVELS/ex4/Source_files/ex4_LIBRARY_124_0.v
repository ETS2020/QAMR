// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:05 2020
...
module FAU ( 
  ...
  nand2  g165(.a(new_n321_), .b(new_n158_), .O(new_n322_));
  ...
  nand2  g170(.a(x127), .b(new_n326_), .O(new_n327_));
  ...
  nand2  g182(.a(x118), .b(new_n297_), .O(new_n339_));
  ...
  nand4  g198(.a(new_n354_), .b(x127), .c(new_n326_), .d(new_n297_), .O(new_n355_));
  ...
  nand2  g209(.a(x016), .b(x008), .O(new_n366_));
  inv1   g210(.a(x056), .O(new_n367_));
  inv1   g211(.a(x088), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(new_n367_), .O(new_n369_));
  oai21  g213(.a(new_n369_), .b(x024), .c(new_n366_), .O(new_n370_));
  nor2   g214(.a(x120), .b(x096), .O(new_n371_));
  nor2   g215(.a(x112), .b(x104), .O(new_n372_));
  oai21  g216(.a(new_n371_), .b(x088), .c(new_n372_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n168_), .O(new_n374_));
  inv1   g218(.a(x120), .O(new_n375_));
  oai21  g219(.a(new_n375_), .b(x104), .c(x032), .O(new_n376_));
  nand2  g220(.a(new_n376_), .b(x112), .O(new_n377_));
  inv1   g221(.a(x096), .O(new_n378_));
  inv1   g222(.a(x104), .O(new_n379_));
  oai21  g223(.a(new_n378_), .b(x056), .c(new_n379_), .O(new_n380_));
  inv1   g224(.a(x112), .O(new_n381_));
  nand3  g225(.a(x120), .b(new_n381_), .c(new_n167_), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n160_), .O(new_n383_));
  aoi21  g227(.a(new_n380_), .b(new_n162_), .c(new_n383_), .O(new_n384_));
  nand4  g228(.a(new_n384_), .b(new_n377_), .c(new_n374_), .d(new_n370_), .O(new_n385_));
  nand4  g229(.a(x120), .b(new_n367_), .c(new_n162_), .d(x008), .O(new_n386_));
  inv1   g230(.a(new_n386_), .O(new_n387_));
  aoi21  g231(.a(new_n385_), .b(new_n164_), .c(new_n387_), .O(new_n388_));
  nand3  g232(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n389_));
  oai21  g233(.a(new_n388_), .b(x048), .c(new_n389_), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(x000), .O(new_n391_));
  nand2  g235(.a(x088), .b(x056), .O(new_n392_));
  nand2  g236(.a(new_n392_), .b(x024), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(new_n167_), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(new_n164_), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n161_), .c(new_n372_), .O(new_n396_));
  inv1   g240(.a(x024), .O(new_n397_));
  nor2   g241(.a(new_n397_), .b(x016), .O(new_n398_));
  oai21  g242(.a(new_n398_), .b(new_n369_), .c(x064), .O(new_n399_));
  inv1   g243(.a(new_n371_), .O(new_n400_));
  nand4  g244(.a(new_n392_), .b(new_n400_), .c(new_n366_), .d(x024), .O(new_n401_));
  aoi21  g245(.a(new_n401_), .b(new_n399_), .c(x072), .O(new_n402_));
  oai21  g246(.a(new_n402_), .b(new_n396_), .c(new_n163_), .O(new_n403_));
  nand2  g247(.a(new_n366_), .b(x024), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(new_n368_), .c(new_n367_), .O(new_n405_));
  ...
  aoi21  g255(.a(new_n407_), .b(new_n160_), .c(new_n411_), .O(new_n412_));
  nand2  g256(.a(new_n412_), .b(new_n391_), .O(new_n413_));
  nand3  g257(.a(new_n413_), .b(new_n158_), .c(new_n365_), .O(new_n414_));
  inv1   g258(.a(new_n414_), .O(z08));
  ...
  oai21  g266(.a(new_n422_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g274(.a(new_n430_), .b(x042), .c(new_n158_), .O(z10));
  ...
  oai21  g290(.a(new_n446_), .b(x044), .c(new_n158_), .O(z12));
  inv1   g291(.a(x045), .O(new_n448_));
  nand2  g292(.a(x021), .b(x013), .O(new_n449_));
  oai21  g293(.a(new_n279_), .b(x029), .c(new_n449_), .O(new_n450_));
  ...
  oai21  g298(.a(new_n259_), .b(x109), .c(x037), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(x117), .O(new_n456_));
  inv1   g300(.a(x101), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(x061), .c(new_n249_), .O(new_n458_));
  nand3  g302(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(new_n267_), .O(new_n460_));
  aoi21  g304(.a(new_n458_), .b(new_n254_), .c(new_n460_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n456_), .c(new_n454_), .d(new_n450_), .O(new_n462_));
  nand4  g306(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  aoi21  g308(.a(new_n462_), .b(new_n275_), .c(new_n464_), .O(new_n465_));
  nand3  g309(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n466_));
  oai21  g310(.a(new_n465_), .b(x053), .c(new_n466_), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(x005), .O(new_n468_));
  nand2  g312(.a(new_n245_), .b(x029), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n243_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n275_), .O(new_n471_));
  aoi21  g315(.a(new_n471_), .b(new_n242_), .c(new_n452_), .O(new_n472_));
  nor2   g316(.a(new_n241_), .b(x021), .O(new_n473_));
  oai21  g317(.a(new_n473_), .b(new_n279_), .c(x069), .O(new_n474_));
  inv1   g318(.a(new_n451_), .O(new_n475_));
  nand4  g319(.a(new_n475_), .b(new_n449_), .c(new_n245_), .d(x029), .O(new_n476_));
  aoi21  g320(.a(new_n476_), .b(new_n474_), .c(x077), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(new_n472_), .c(new_n240_), .O(new_n478_));
  nand2  g322(.a(new_n449_), .b(x029), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n271_), .O(new_n480_));
  nand3  g324(.a(new_n480_), .b(new_n275_), .c(x037), .O(new_n481_));
  ...
  aoi21  g330(.a(new_n482_), .b(new_n267_), .c(new_n486_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n468_), .O(new_n488_));
  nand3  g332(.a(new_n488_), .b(new_n158_), .c(new_n448_), .O(new_n489_));
  inv1   g333(.a(new_n489_), .O(z13));
  nand2  g334(.a(new_n311_), .b(new_n359_), .O(new_n491_));
  oai21  g335(.a(x078), .b(x054), .c(new_n491_), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(x086), .c(x006), .O(new_n493_));
  inv1   g337(.a(x110), .O(new_n494_));
  nand2  g338(.a(new_n352_), .b(new_n494_), .O(new_n495_));
  oai21  g339(.a(x078), .b(new_n315_), .c(new_n359_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n495_), .O(new_n497_));
  nand3  g341(.a(new_n348_), .b(new_n300_), .c(x070), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n497_), .c(x054), .O(new_n499_));
  nor3   g343(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n499_), .c(new_n298_), .O(new_n501_));
  oai22  g345(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(x070), .c(x022), .O(new_n503_));
  aoi22  g347(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n504_));
  nand4  g348(.a(new_n504_), .b(new_n503_), .c(new_n501_), .d(new_n493_), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n158_), .O(new_n506_));
  nand2  g350(.a(x022), .b(x014), .O(new_n507_));
  inv1   g351(.a(x127), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n324_), .c(new_n326_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n308_), .c(new_n298_), .O(new_n510_));
  nand2  g354(.a(x127), .b(x006), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n510_), .c(new_n334_), .O(new_n512_));
  nor3   g356(.a(new_n328_), .b(new_n508_), .c(new_n297_), .O(new_n513_));
  oai21  g357(.a(new_n513_), .b(new_n512_), .c(new_n299_), .O(new_n514_));
  nand4  g358(.a(x127), .b(new_n298_), .c(x038), .d(x030), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n514_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n507_), .O(new_n517_));
  nand3  g361(.a(x126), .b(new_n352_), .c(x006), .O(new_n518_));
  nand4  g362(.a(x127), .b(new_n298_), .c(x070), .d(x030), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n518_), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n315_), .O(new_n521_));
  oai22  g365(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n522_));
  nand2  g366(.a(new_n522_), .b(x102), .O(new_n523_));
  oai21  g367(.a(new_n307_), .b(new_n311_), .c(new_n495_), .O(new_n524_));
  aoi21  g368(.a(new_n524_), .b(new_n523_), .c(new_n297_), .O(new_n525_));
  nand4  g369(.a(new_n495_), .b(new_n308_), .c(new_n298_), .d(x030), .O(new_n526_));
  inv1   g370(.a(new_n526_), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(new_n525_), .c(x127), .O(new_n528_));
  inv1   g372(.a(x094), .O(new_n529_));
  nand2  g373(.a(new_n529_), .b(new_n307_), .O(new_n530_));
  nand2  g374(.a(x118), .b(new_n494_), .O(new_n531_));
  nand3  g375(.a(new_n531_), .b(new_n530_), .c(new_n491_), .O(new_n532_));
  nand3  g376(.a(new_n532_), .b(x126), .c(x006), .O(new_n533_));
  nand3  g377(.a(new_n533_), .b(new_n528_), .c(new_n521_), .O(new_n534_));
  nand2  g378(.a(new_n534_), .b(new_n299_), .O(new_n535_));
  nand2  g379(.a(new_n535_), .b(new_n517_), .O(new_n536_));
  nand3  g380(.a(new_n311_), .b(x014), .c(x006), .O(new_n537_));
  nor4   g381(.a(new_n537_), .b(new_n326_), .c(x062), .d(x054), .O(new_n538_));
  aoi21  g382(.a(new_n536_), .b(new_n300_), .c(new_n538_), .O(new_n539_));
  aoi21  g383(.a(new_n539_), .b(new_n506_), .c(x046), .O(z14));
  zero   g384(.O(z16));
  zero   g385(.O(z17));
  zero   g386(.O(z22));
  zero   g387(.O(z23));
  ...
  zero   g389(.O(z26));
  zero   g390(.O(z27));
  nor2   g391(.a(x127), .b(x126), .O(z15));
  nor2   g392(.a(x127), .b(x126), .O(z18));
  nor2   g393(.a(x127), .b(x126), .O(z19));
  nor2   g394(.a(x127), .b(x126), .O(z20));
  nor2   g395(.a(x127), .b(x126), .O(z21));
  nor2   g396(.a(x127), .b(x126), .O(z25));
endmodule
