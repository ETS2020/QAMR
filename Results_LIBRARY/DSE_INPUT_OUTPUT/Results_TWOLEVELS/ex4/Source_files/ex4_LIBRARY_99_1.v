...
module FAU ( 
  ...
  inv1   g314(.a(x046), .O(new_n472_));
  inv1   g315(.a(x118), .O(new_n473_));
  oai21  g316(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n474_));
  nand2  g317(.a(new_n301_), .b(x030), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n299_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n312_), .O(new_n477_));
  aoi22  g320(.a(new_n477_), .b(new_n474_), .c(new_n473_), .d(new_n314_), .O(new_n478_));
  nand3  g321(.a(new_n312_), .b(x070), .c(x030), .O(new_n479_));
  nand3  g322(.a(x102), .b(new_n305_), .c(x006), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n304_), .O(new_n482_));
  nand2  g325(.a(new_n325_), .b(x006), .O(new_n483_));
  oai21  g326(.a(x086), .b(new_n306_), .c(new_n483_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n329_), .O(new_n485_));
  nand4  g328(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n486_));
  nand3  g329(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n486_), .O(new_n488_));
  oai21  g331(.a(x126), .b(x102), .c(new_n488_), .O(new_n489_));
  nand2  g332(.a(x126), .b(new_n473_), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n298_), .c(x022), .O(new_n491_));
  nand2  g334(.a(x030), .b(new_n343_), .O(new_n492_));
  nand3  g335(.a(x126), .b(x094), .c(new_n305_), .O(new_n493_));
  nand3  g336(.a(new_n493_), .b(new_n492_), .c(new_n312_), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(new_n491_), .c(x006), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n489_), .c(new_n485_), .d(new_n482_), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(new_n478_), .c(new_n340_), .O(new_n497_));
  nand3  g340(.a(x126), .b(new_n314_), .c(x038), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n312_), .c(new_n297_), .O(new_n499_));
  nand3  g342(.a(new_n312_), .b(x038), .c(x030), .O(new_n500_));
  oai21  g343(.a(new_n306_), .b(new_n336_), .c(new_n500_), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n499_), .c(new_n343_), .O(new_n502_));
  nand2  g345(.a(x030), .b(new_n336_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n323_), .c(x086), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(x054), .c(x038), .O(new_n505_));
  nand3  g348(.a(x070), .b(new_n304_), .c(x022), .O(new_n506_));
  nand4  g349(.a(new_n506_), .b(new_n505_), .c(new_n502_), .d(new_n497_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n157_), .c(new_n472_), .O(new_n508_));
