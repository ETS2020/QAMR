...
module FAU ( 
  ...
  oai21  g141(.a(new_n297_), .b(x014), .c(x119), .O(new_n298_));
  ...
  oai21  g259(.a(new_n415_), .b(x042), .c(new_n158_), .O(z10));
  ...
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(x119), .b(x078), .O(z16));
  nor2   g371(.a(x119), .b(x078), .O(z18));
  nor2   g372(.a(x119), .b(x078), .O(z27));
endmodule
