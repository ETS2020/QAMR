...
module FAU ( 
  ...
  inv1   g314(.a(new_n311_), .O(new_n471_));
  oai21  g315(.a(new_n307_), .b(x030), .c(new_n471_), .O(new_n472_));
  nand2  g316(.a(new_n320_), .b(new_n316_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n306_), .O(new_n474_));
  ...
  oai21  g321(.a(new_n320_), .b(x110), .c(x038), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x118), .O(new_n479_));
  oai21  g323(.a(new_n316_), .b(x062), .c(new_n298_), .O(new_n480_));
  nand3  g324(.a(x126), .b(new_n299_), .c(new_n310_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n303_), .O(new_n482_));
  aoi21  g326(.a(new_n480_), .b(new_n300_), .c(new_n482_), .O(new_n483_));
  nand4  g327(.a(new_n483_), .b(new_n479_), .c(new_n477_), .d(new_n472_), .O(new_n484_));
  nand4  g328(.a(x126), .b(new_n305_), .c(new_n300_), .d(x014), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n297_), .c(new_n486_), .O(new_n487_));
  oai22  g331(.a(new_n487_), .b(x054), .c(new_n337_), .d(x014), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x006), .O(new_n489_));
  oai21  g333(.a(new_n331_), .b(new_n304_), .c(new_n310_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n297_), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n309_), .c(new_n475_), .O(new_n492_));
  nor2   g336(.a(new_n304_), .b(x022), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n307_), .c(x070), .O(new_n494_));
  nand4  g338(.a(new_n473_), .b(new_n326_), .c(new_n471_), .d(x030), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n494_), .c(x078), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n492_), .c(new_n340_), .O(new_n497_));
  inv1   g341(.a(new_n307_), .O(new_n498_));
  oai21  g342(.a(new_n311_), .b(new_n304_), .c(new_n498_), .O(new_n499_));
  nand3  g343(.a(new_n499_), .b(new_n297_), .c(x038), .O(new_n500_));
  ...
  aoi21  g349(.a(new_n501_), .b(new_n303_), .c(new_n505_), .O(new_n506_));
  ...
  zero   g358(.O(z26));
  zero   g359(.O(z27));
  nor2   g360(.a(x078), .b(new_n172_), .O(z17));
