// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:37 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x118), .O(new_n172_));
  nand2  g016(.a(new_n172_), .b(x114), .O(new_n173_));
  ...
  nor2   g150(.a(new_n172_), .b(new_n306_), .O(new_n307_));
  nand2  g151(.a(new_n307_), .b(new_n305_), .O(new_n308_));
  nand2  g152(.a(new_n308_), .b(x070), .O(new_n309_));
  inv1   g153(.a(x038), .O(new_n310_));
  oai21  g154(.a(x126), .b(new_n306_), .c(new_n310_), .O(new_n311_));
  nand2  g155(.a(new_n311_), .b(new_n172_), .O(new_n312_));
  ...
  nand4  g162(.a(new_n318_), .b(new_n312_), .c(new_n309_), .d(new_n303_), .O(new_n319_));
  nand4  g163(.a(new_n315_), .b(x062), .c(x038), .d(new_n299_), .O(new_n320_));
  ...
  oai22  g187(.a(new_n331_), .b(new_n310_), .c(new_n297_), .d(new_n299_), .O(new_n344_));
  nand3  g188(.a(new_n344_), .b(new_n332_), .c(new_n300_), .O(new_n345_));
  aoi22  g189(.a(new_n331_), .b(new_n299_), .c(new_n297_), .d(new_n310_), .O(new_n346_));
  ...
  aoi22  g225(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n382_), .c(x024), .O(new_n384_));
  inv1   g227(.a(new_n384_), .O(new_n385_));
  oai21  g228(.a(new_n385_), .b(new_n381_), .c(new_n162_), .O(new_n386_));
  aoi21  g229(.a(new_n386_), .b(new_n379_), .c(x048), .O(new_n387_));
  oai21  g230(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n388_));
  nand2  g231(.a(new_n388_), .b(new_n354_), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(new_n162_), .c(x032), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n387_), .c(new_n158_), .O(new_n392_));
  ...
  oai21  g240(.a(new_n397_), .b(x040), .c(new_n173_), .O(z08));
  inv1   g241(.a(x041), .O(new_n399_));
  ...
  nand3  g248(.a(new_n405_), .b(new_n173_), .c(new_n399_), .O(new_n406_));
  inv1   g249(.a(new_n406_), .O(z09));
  ...
  nand3  g257(.a(new_n414_), .b(new_n173_), .c(new_n408_), .O(new_n415_));
  inv1   g258(.a(new_n415_), .O(z10));
  inv1   g259(.a(x043), .O(new_n417_));
  ...
  nand3  g266(.a(new_n423_), .b(new_n173_), .c(new_n417_), .O(new_n424_));
  inv1   g267(.a(new_n424_), .O(z11));
  ...
  oai21  g275(.a(new_n432_), .b(x044), .c(new_n173_), .O(z12));
  inv1   g276(.a(x045), .O(new_n434_));
  nand2  g277(.a(x021), .b(x013), .O(new_n435_));
  oai21  g278(.a(new_n279_), .b(x029), .c(new_n435_), .O(new_n436_));
  ...
  nand2  g282(.a(new_n439_), .b(new_n276_), .O(new_n440_));
  oai21  g283(.a(new_n259_), .b(x109), .c(x037), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(x117), .O(new_n442_));
  inv1   g285(.a(x101), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(x061), .c(new_n249_), .O(new_n444_));
  nand3  g287(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n267_), .O(new_n446_));
  aoi21  g289(.a(new_n444_), .b(new_n254_), .c(new_n446_), .O(new_n447_));
  nand4  g290(.a(new_n447_), .b(new_n442_), .c(new_n440_), .d(new_n436_), .O(new_n448_));
  nand4  g291(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n449_));
  inv1   g292(.a(new_n449_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n275_), .c(new_n450_), .O(new_n451_));
  nand3  g294(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n452_));
  oai21  g295(.a(new_n451_), .b(x053), .c(new_n452_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(x005), .O(new_n454_));
  nand2  g297(.a(new_n245_), .b(x029), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n243_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n275_), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n242_), .c(new_n438_), .O(new_n458_));
  nor2   g301(.a(new_n241_), .b(x021), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(new_n279_), .c(x069), .O(new_n460_));
  inv1   g303(.a(new_n437_), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n435_), .c(new_n245_), .d(x029), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n460_), .c(x077), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n458_), .c(new_n240_), .O(new_n464_));
  nand2  g307(.a(new_n435_), .b(x029), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n271_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n275_), .c(x037), .O(new_n467_));
  ...
  aoi21  g315(.a(new_n468_), .b(new_n267_), .c(new_n472_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n454_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n173_), .c(new_n434_), .O(new_n475_));
  inv1   g318(.a(new_n475_), .O(z13));
  oai22  g319(.a(new_n335_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n477_));
  inv1   g320(.a(x102), .O(new_n478_));
  aoi21  g321(.a(new_n315_), .b(new_n478_), .c(x094), .O(new_n479_));
  nand2  g322(.a(new_n172_), .b(new_n306_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n479_), .c(new_n332_), .O(new_n481_));
  oai21  g324(.a(new_n315_), .b(x110), .c(x038), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x118), .O(new_n483_));
  oai21  g326(.a(new_n478_), .b(x062), .c(new_n306_), .O(new_n484_));
  nand3  g327(.a(x126), .b(new_n172_), .c(new_n300_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n323_), .O(new_n486_));
  aoi21  g329(.a(new_n484_), .b(new_n310_), .c(new_n486_), .O(new_n487_));
  nand4  g330(.a(new_n487_), .b(new_n483_), .c(new_n481_), .d(new_n477_), .O(new_n488_));
  nand4  g331(.a(x126), .b(new_n313_), .c(new_n310_), .d(x014), .O(new_n489_));
  inv1   g332(.a(new_n489_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n331_), .c(new_n490_), .O(new_n491_));
  nand3  g334(.a(x086), .b(new_n310_), .c(new_n299_), .O(new_n492_));
  oai21  g335(.a(new_n491_), .b(x054), .c(new_n492_), .O(new_n493_));
  aoi21  g336(.a(new_n302_), .b(x030), .c(x022), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(x078), .c(new_n299_), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n480_), .O(new_n496_));
  nand2  g339(.a(x030), .b(new_n300_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n327_), .c(new_n332_), .O(new_n498_));
  nand2  g341(.a(new_n315_), .b(new_n478_), .O(new_n499_));
  aoi22  g342(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n499_), .c(x030), .O(new_n501_));
  inv1   g344(.a(new_n501_), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n498_), .c(new_n331_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n496_), .c(x054), .O(new_n504_));
  oai21  g347(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n327_), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n331_), .c(x038), .O(new_n507_));
  inv1   g350(.a(new_n507_), .O(new_n508_));
  oai21  g351(.a(new_n508_), .b(new_n504_), .c(new_n323_), .O(new_n509_));
  ...
  aoi21  g356(.a(new_n493_), .b(x006), .c(new_n513_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(x046), .c(new_n173_), .O(z14));
  inv1   g358(.a(new_n173_), .O(z16));
  zero   g359(.O(z07));
  zero   g360(.O(z15));
  zero   g361(.O(z23));
  zero   g362(.O(z24));
  zero   g363(.O(z27));
  inv1   g364(.a(new_n173_), .O(z17));
  inv1   g365(.a(new_n173_), .O(z18));
  inv1   g366(.a(new_n173_), .O(z19));
  inv1   g367(.a(new_n173_), .O(z20));
  inv1   g368(.a(new_n173_), .O(z21));
  inv1   g369(.a(new_n173_), .O(z22));
  inv1   g370(.a(new_n173_), .O(z25));
  inv1   g371(.a(new_n173_), .O(z26));
endmodule
