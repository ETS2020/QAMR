// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:31 2020
...
module FAU ( 
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x127), .O(new_n305_));
  ...
  nand3  g248(.a(new_n404_), .b(new_n175_), .c(new_n357_), .O(new_n405_));
  ...
  oai21  g287(.a(new_n283_), .b(x029), .c(new_n443_), .O(new_n444_));
  inv1   g288(.a(x101), .O(new_n445_));
  nand2  g289(.a(new_n263_), .b(new_n445_), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(new_n248_), .O(new_n447_));
  nor2   g291(.a(x117), .b(x109), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n447_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n280_), .O(new_n450_));
  oai21  g294(.a(new_n263_), .b(x109), .c(x037), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(x117), .O(new_n452_));
  oai21  g296(.a(new_n445_), .b(x061), .c(new_n254_), .O(new_n453_));
  nand3  g297(.a(x125), .b(new_n255_), .c(new_n245_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n271_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n259_), .c(new_n455_), .O(new_n456_));
  nand4  g300(.a(new_n456_), .b(new_n452_), .c(new_n450_), .d(new_n444_), .O(new_n457_));
  nand4  g301(.a(x125), .b(new_n247_), .c(new_n259_), .d(x013), .O(new_n458_));
  inv1   g302(.a(new_n458_), .O(new_n459_));
  aoi21  g303(.a(new_n457_), .b(new_n279_), .c(new_n459_), .O(new_n460_));
  nand3  g304(.a(x085), .b(new_n259_), .c(new_n244_), .O(new_n461_));
  oai21  g305(.a(new_n460_), .b(x053), .c(new_n461_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(x005), .O(new_n463_));
  oai21  g307(.a(new_n249_), .b(new_n243_), .c(new_n245_), .O(new_n464_));
  nand2  g308(.a(new_n464_), .b(new_n279_), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n244_), .c(new_n448_), .O(new_n466_));
  nor2   g310(.a(new_n243_), .b(x021), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(new_n283_), .c(x069), .O(new_n468_));
  nand4  g312(.a(new_n446_), .b(new_n443_), .c(new_n250_), .d(x029), .O(new_n469_));
  aoi21  g313(.a(new_n469_), .b(new_n468_), .c(x077), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n466_), .c(new_n242_), .O(new_n471_));
  nand2  g315(.a(new_n443_), .b(x029), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n275_), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(new_n279_), .c(x037), .O(new_n474_));
  ...
  nand3  g324(.a(new_n480_), .b(new_n175_), .c(new_n442_), .O(new_n481_));
  inv1   g325(.a(new_n481_), .O(z13));
  aoi21  g326(.a(new_n298_), .b(x014), .c(x127), .O(new_n483_));
  ...
  nand4  g342(.a(x126), .b(new_n318_), .c(new_n299_), .d(x014), .O(new_n499_));
  inv1   g343(.a(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n498_), .b(new_n172_), .c(new_n500_), .O(new_n501_));
  nand3  g345(.a(x086), .b(new_n299_), .c(new_n340_), .O(new_n502_));
