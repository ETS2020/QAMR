// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:03 2020
...
module FAU ( 
  ...
  oai21  g262(.a(new_n419_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai22  g280(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n438_));
  nand3  g281(.a(new_n438_), .b(x085), .c(x005), .O(new_n439_));
  aoi22  g282(.a(new_n275_), .b(new_n254_), .c(new_n241_), .d(new_n243_), .O(new_n440_));
  nand3  g283(.a(new_n279_), .b(new_n267_), .c(new_n275_), .O(new_n441_));
  oai22  g284(.a(new_n441_), .b(x053), .c(new_n440_), .d(new_n244_), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(x069), .O(new_n443_));
  nand2  g286(.a(new_n441_), .b(new_n241_), .O(new_n444_));
  aoi22  g287(.a(new_n444_), .b(x037), .c(x077), .d(x013), .O(new_n445_));
  nand3  g288(.a(new_n445_), .b(new_n443_), .c(new_n439_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(new_n174_), .O(new_n447_));
  nand2  g290(.a(x126), .b(x117), .O(new_n448_));
  oai21  g291(.a(x117), .b(new_n250_), .c(new_n448_), .O(new_n449_));
  aoi21  g292(.a(x069), .b(x037), .c(new_n240_), .O(new_n450_));
  nand2  g293(.a(new_n246_), .b(x029), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n244_), .c(x085), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n450_), .c(new_n275_), .O(new_n453_));
  oai21  g296(.a(x085), .b(new_n243_), .c(new_n453_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n449_), .O(new_n455_));
  inv1   g298(.a(x093), .O(new_n456_));
  aoi22  g299(.a(new_n456_), .b(new_n276_), .c(new_n257_), .d(new_n254_), .O(new_n457_));
  nand2  g300(.a(x021), .b(x013), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n246_), .c(new_n267_), .d(x029), .O(new_n459_));
  oai21  g302(.a(new_n457_), .b(new_n240_), .c(new_n459_), .O(new_n460_));
  oai21  g303(.a(x125), .b(x101), .c(new_n460_), .O(new_n461_));
  aoi22  g304(.a(new_n271_), .b(new_n242_), .c(x021), .d(x013), .O(new_n462_));
  nor2   g305(.a(new_n259_), .b(x021), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n462_), .c(x005), .O(new_n464_));
  nand4  g307(.a(new_n267_), .b(x069), .c(x029), .d(new_n244_), .O(new_n465_));
  nand3  g308(.a(new_n465_), .b(new_n464_), .c(new_n461_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n172_), .c(new_n275_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n455_), .O(new_n468_));
  nand3  g311(.a(new_n172_), .b(new_n267_), .c(x029), .O(new_n469_));
  nand4  g312(.a(x126), .b(x125), .c(new_n250_), .d(x005), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n469_), .c(x013), .O(new_n471_));
  nand4  g314(.a(new_n172_), .b(new_n267_), .c(x029), .d(new_n244_), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n471_), .c(new_n275_), .O(new_n474_));
  nor2   g317(.a(new_n474_), .b(new_n254_), .O(new_n475_));
  aoi21  g318(.a(new_n468_), .b(new_n241_), .c(new_n475_), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n447_), .c(x045), .O(z13));
  ...
  zero   g366(.O(z24));
  zero   g367(.O(z25));
  nor2   g368(.a(x126), .b(new_n172_), .O(z22));
  nor2   g369(.a(x126), .b(new_n172_), .O(z23));
  nor2   g370(.a(x126), .b(new_n172_), .O(z26));
  nor2   g371(.a(x126), .b(new_n172_), .O(z27));
endmodule
