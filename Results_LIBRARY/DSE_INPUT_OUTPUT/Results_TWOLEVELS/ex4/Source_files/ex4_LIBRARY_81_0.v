// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:36 2020
...
module FAU ( 
  ...
  oai21  g141(.a(new_n297_), .b(x014), .c(x113), .O(new_n298_));
  ...
  nand3  g259(.a(new_n416_), .b(new_n158_), .c(new_n410_), .O(new_n417_));
  ...
  oai22  g322(.a(new_n339_), .b(x030), .c(new_n304_), .d(new_n303_), .O(new_n480_));
  inv1   g323(.a(x102), .O(new_n481_));
  aoi21  g324(.a(new_n320_), .b(new_n481_), .c(x094), .O(new_n482_));
  nand2  g325(.a(new_n311_), .b(new_n310_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n482_), .c(new_n336_), .O(new_n484_));
  oai21  g327(.a(new_n320_), .b(x110), .c(x038), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(x118), .O(new_n486_));
  oai21  g329(.a(new_n481_), .b(x062), .c(new_n310_), .O(new_n487_));
  nand3  g330(.a(x126), .b(new_n311_), .c(new_n304_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n328_), .O(new_n489_));
  aoi21  g332(.a(new_n487_), .b(new_n315_), .c(new_n489_), .O(new_n490_));
  nand4  g333(.a(new_n490_), .b(new_n486_), .c(new_n484_), .d(new_n480_), .O(new_n491_));
  nand4  g334(.a(x126), .b(new_n318_), .c(new_n315_), .d(x014), .O(new_n492_));
  inv1   g335(.a(new_n492_), .O(new_n493_));
  aoi21  g336(.a(new_n491_), .b(new_n296_), .c(new_n493_), .O(new_n494_));
  nand3  g337(.a(x086), .b(new_n315_), .c(new_n303_), .O(new_n495_));
  oai21  g338(.a(new_n494_), .b(x054), .c(new_n495_), .O(new_n496_));
  aoi21  g339(.a(new_n306_), .b(x030), .c(x022), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(x078), .c(new_n303_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n483_), .O(new_n499_));
  nand2  g342(.a(x030), .b(new_n304_), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(new_n332_), .c(new_n336_), .O(new_n501_));
  nand2  g344(.a(new_n320_), .b(new_n481_), .O(new_n502_));
  ...
  oai21  g348(.a(new_n505_), .b(new_n501_), .c(new_n296_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n499_), .c(x054), .O(new_n507_));
  oai21  g350(.a(new_n304_), .b(new_n303_), .c(x030), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n332_), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n296_), .c(x038), .O(new_n510_));
  inv1   g353(.a(new_n510_), .O(new_n511_));
  oai21  g354(.a(new_n511_), .b(new_n507_), .c(new_n328_), .O(new_n512_));
  ...
  oai21  g360(.a(new_n517_), .b(x046), .c(new_n158_), .O(z14));
  zero   g361(.O(z07));
  zero   g362(.O(z15));
  zero   g363(.O(z16));
  zero   g364(.O(z17));
  ...
  zero   g367(.O(z22));
  zero   g368(.O(z23));
  nor2   g369(.a(x113), .b(x078), .O(z20));
  nor2   g370(.a(x113), .b(x078), .O(z24));
  nor2   g371(.a(x113), .b(x078), .O(z25));
  nor2   g372(.a(x113), .b(x078), .O(z26));
  nor2   g373(.a(x113), .b(x078), .O(z27));
endmodule
