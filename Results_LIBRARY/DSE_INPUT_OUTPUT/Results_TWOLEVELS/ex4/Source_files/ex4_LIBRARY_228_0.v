// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:51 2020
...
module FAU ( 
  ...
  nand3  g256(.a(new_n412_), .b(new_n158_), .c(new_n406_), .O(new_n413_));
  ...
  oai21  g273(.a(new_n429_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nand3  g318(.a(x070), .b(new_n300_), .c(x022), .O(new_n475_));
  nand3  g319(.a(x086), .b(new_n311_), .c(x006), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n475_), .c(x078), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n474_), .c(x046), .O(z14));
  zero   g323(.O(z16));
  zero   g324(.O(z17));
  zero   g325(.O(z18));
  zero   g326(.O(z19));
