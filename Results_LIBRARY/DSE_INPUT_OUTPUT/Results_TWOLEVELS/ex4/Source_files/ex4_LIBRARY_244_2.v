// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:32 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x106), .b(new_n157_), .O(z07));
  ...
  aoi21  g197(.a(new_n349_), .b(x106), .c(new_n353_), .O(new_n354_));
  ...
  nand3  g283(.a(new_n439_), .b(new_n159_), .c(new_n433_), .O(new_n440_));
  ...
  aoi21  g288(.a(new_n260_), .b(new_n444_), .c(x093), .O(new_n445_));
  nor2   g289(.a(x117), .b(x109), .O(new_n446_));
  inv1   g290(.a(new_n446_), .O(new_n447_));
  oai21  g291(.a(new_n447_), .b(new_n445_), .c(new_n277_), .O(new_n448_));
  oai21  g292(.a(new_n260_), .b(x109), .c(x037), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(x117), .O(new_n450_));
  oai21  g294(.a(new_n444_), .b(x061), .c(new_n250_), .O(new_n451_));
  ...
  nand4  g298(.a(new_n454_), .b(new_n450_), .c(new_n448_), .d(new_n443_), .O(new_n455_));
  ...
  oai21  g305(.a(new_n461_), .b(x077), .c(new_n243_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n447_), .O(new_n463_));
  nand2  g307(.a(x029), .b(new_n244_), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n272_), .c(new_n277_), .O(new_n465_));
  nand2  g309(.a(new_n260_), .b(new_n444_), .O(new_n466_));
  nand4  g310(.a(new_n466_), .b(new_n442_), .c(new_n246_), .d(x029), .O(new_n467_));
  inv1   g311(.a(new_n467_), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n465_), .c(new_n276_), .O(new_n469_));
  aoi21  g313(.a(new_n469_), .b(new_n463_), .c(x053), .O(new_n470_));
  nand2  g314(.a(new_n442_), .b(x029), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n272_), .O(new_n472_));
  nand3  g316(.a(new_n472_), .b(new_n276_), .c(x037), .O(new_n473_));
  inv1   g317(.a(new_n473_), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(new_n470_), .c(new_n268_), .O(new_n475_));
  ...
  aoi21  g323(.a(new_n460_), .b(x005), .c(new_n479_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(x045), .c(new_n159_), .O(z13));
  aoi21  g325(.a(new_n296_), .b(x014), .c(new_n298_), .O(new_n482_));
  nand2  g326(.a(x022), .b(x014), .O(new_n483_));
  nand2  g327(.a(new_n327_), .b(new_n334_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  inv1   g329(.a(x102), .O(new_n486_));
  aoi21  g330(.a(new_n345_), .b(new_n486_), .c(x094), .O(new_n487_));
  nor2   g331(.a(x118), .b(x110), .O(new_n488_));
  inv1   g332(.a(new_n488_), .O(new_n489_));
  oai21  g333(.a(new_n489_), .b(new_n487_), .c(new_n330_), .O(new_n490_));
  oai21  g334(.a(new_n345_), .b(x110), .c(x038), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(x118), .O(new_n492_));
  oai21  g336(.a(new_n486_), .b(x062), .c(new_n314_), .O(new_n493_));
  nand3  g337(.a(x126), .b(new_n313_), .c(new_n331_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n320_), .O(new_n495_));
  aoi21  g339(.a(new_n493_), .b(new_n297_), .c(new_n495_), .O(new_n496_));
  nand4  g340(.a(new_n496_), .b(new_n492_), .c(new_n490_), .d(new_n485_), .O(new_n497_));
  nand4  g341(.a(x126), .b(new_n317_), .c(new_n297_), .d(x014), .O(new_n498_));
  inv1   g342(.a(new_n498_), .O(new_n499_));
  aoi21  g343(.a(new_n497_), .b(new_n157_), .c(new_n499_), .O(new_n500_));
  nand3  g344(.a(x086), .b(new_n297_), .c(new_n339_), .O(new_n501_));
  oai21  g345(.a(new_n500_), .b(x054), .c(new_n501_), .O(new_n502_));
  aoi21  g346(.a(new_n300_), .b(x030), .c(x022), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(x078), .c(new_n339_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n489_), .O(new_n505_));
  nand2  g349(.a(x030), .b(new_n331_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n327_), .c(new_n330_), .O(new_n507_));
  nand2  g351(.a(new_n345_), .b(new_n486_), .O(new_n508_));
  nand4  g352(.a(new_n508_), .b(new_n483_), .c(new_n300_), .d(x030), .O(new_n509_));
  inv1   g353(.a(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n507_), .c(new_n157_), .O(new_n511_));
  aoi21  g355(.a(new_n511_), .b(new_n505_), .c(x054), .O(new_n512_));
  nand2  g356(.a(new_n483_), .b(x030), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n327_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n157_), .c(x038), .O(new_n515_));
  inv1   g359(.a(new_n515_), .O(new_n516_));
  oai21  g360(.a(new_n516_), .b(new_n512_), .c(new_n320_), .O(new_n517_));
  oai22  g361(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(x070), .c(x022), .O(new_n519_));
  nand2  g363(.a(x054), .b(x038), .O(new_n520_));
  nand3  g364(.a(new_n520_), .b(new_n519_), .c(new_n517_), .O(new_n521_));
  aoi21  g365(.a(new_n502_), .b(x006), .c(new_n521_), .O(new_n522_));
  oai22  g366(.a(new_n522_), .b(x046), .c(new_n482_), .d(new_n157_), .O(z14));
  zero   g367(.O(z17));
  zero   g368(.O(z21));
  zero   g369(.O(z22));
  zero   g370(.O(z23));
  zero   g371(.O(z24));
  zero   g372(.O(z27));
  nor2   g373(.a(x106), .b(new_n157_), .O(z15));
  nor2   g374(.a(x106), .b(new_n157_), .O(z16));
  nor2   g375(.a(x106), .b(new_n157_), .O(z18));
  nor2   g376(.a(x106), .b(new_n157_), .O(z19));
  nor2   g377(.a(x106), .b(new_n157_), .O(z20));
  nor2   g378(.a(x106), .b(new_n157_), .O(z25));
  nor2   g379(.a(x106), .b(new_n157_), .O(z26));
endmodule
