...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x117), .O(z07));
  ...
  oai21  g282(.a(new_n284_), .b(new_n243_), .c(new_n438_), .O(new_n439_));
  ...
  oai21  g286(.a(new_n442_), .b(new_n440_), .c(new_n248_), .O(new_n443_));
  ...
  nand2  g291(.a(new_n447_), .b(new_n242_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(new_n244_), .c(new_n448_), .O(new_n449_));
  nand4  g293(.a(new_n449_), .b(new_n445_), .c(new_n443_), .d(new_n439_), .O(new_n450_));
  nand4  g294(.a(x125), .b(new_n274_), .c(new_n244_), .d(x013), .O(new_n451_));
  inv1   g295(.a(new_n451_), .O(new_n452_));
  aoi21  g296(.a(new_n450_), .b(new_n258_), .c(new_n452_), .O(new_n453_));
  nand3  g297(.a(x085), .b(new_n244_), .c(new_n243_), .O(new_n454_));
  oai21  g298(.a(new_n453_), .b(x053), .c(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n252_), .b(x029), .c(x021), .O(new_n456_));
  ...
  aoi21  g303(.a(new_n459_), .b(new_n267_), .c(new_n248_), .O(new_n460_));
  ...
  oai21  g308(.a(new_n464_), .b(new_n460_), .c(new_n258_), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n458_), .c(x053), .O(new_n466_));
  oai21  g310(.a(new_n284_), .b(new_n243_), .c(x029), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n267_), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n258_), .c(x037), .O(new_n469_));
  ...
  nand2  g343(.a(new_n172_), .b(new_n479_), .O(new_n500_));
  ...
  zero   g363(.O(z23));
  zero   g364(.O(z27));
  nor2   g365(.a(new_n172_), .b(x117), .O(z15));
  nor2   g366(.a(new_n172_), .b(x117), .O(z16));
  nor2   g367(.a(new_n172_), .b(x117), .O(z17));
  nor2   g368(.a(new_n172_), .b(x117), .O(z18));
  nor2   g369(.a(new_n172_), .b(x117), .O(z20));
  nor2   g370(.a(new_n172_), .b(x117), .O(z24));
  nor2   g371(.a(new_n172_), .b(x117), .O(z25));
