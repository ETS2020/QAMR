// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:44 2020
...
module FAU ( 
  ...
  nand2  g205(.a(new_n361_), .b(new_n166_), .O(new_n362_));
  ...
  nand3  g213(.a(x120), .b(new_n369_), .c(new_n165_), .O(new_n370_));
  nand2  g214(.a(new_n370_), .b(new_n158_), .O(new_n371_));
  aoi21  g215(.a(new_n368_), .b(new_n160_), .c(new_n371_), .O(new_n372_));
  nand4  g216(.a(new_n372_), .b(new_n365_), .c(new_n362_), .d(new_n358_), .O(new_n373_));
  nand4  g217(.a(x120), .b(new_n355_), .c(new_n160_), .d(x008), .O(new_n374_));
  inv1   g218(.a(new_n374_), .O(new_n375_));
  aoi21  g219(.a(new_n373_), .b(new_n162_), .c(new_n375_), .O(new_n376_));
  ...
  nand2  g225(.a(new_n381_), .b(new_n165_), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n162_), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n159_), .c(new_n360_), .O(new_n384_));
  ...
  oai21  g234(.a(new_n390_), .b(new_n384_), .c(new_n161_), .O(new_n391_));
  ...
  aoi21  g243(.a(new_n395_), .b(new_n158_), .c(new_n399_), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(new_n379_), .O(new_n401_));
  nand3  g245(.a(new_n401_), .b(new_n173_), .c(new_n353_), .O(new_n402_));
  ...
  nand3  g281(.a(new_n437_), .b(new_n173_), .c(new_n431_), .O(new_n438_));
  inv1   g282(.a(new_n438_), .O(z12));
  oai22  g283(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n440_));
  inv1   g284(.a(x101), .O(new_n441_));
  aoi21  g285(.a(new_n259_), .b(new_n441_), .c(x093), .O(new_n442_));
  nand2  g286(.a(new_n250_), .b(new_n249_), .O(new_n443_));
  oai21  g287(.a(new_n443_), .b(new_n442_), .c(new_n276_), .O(new_n444_));
  oai21  g288(.a(new_n259_), .b(x109), .c(x037), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x117), .O(new_n446_));
  oai21  g290(.a(new_n441_), .b(x061), .c(new_n249_), .O(new_n447_));
  ...
  nand4  g294(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n440_), .O(new_n451_));
  ...
  aoi21  g300(.a(new_n245_), .b(x029), .c(x021), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(x077), .c(new_n242_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n443_), .O(new_n459_));
  nand2  g303(.a(x029), .b(new_n243_), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n271_), .c(new_n276_), .O(new_n461_));
  nand2  g305(.a(new_n259_), .b(new_n441_), .O(new_n462_));
  aoi22  g306(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n463_));
  nand3  g307(.a(new_n463_), .b(new_n462_), .c(x029), .O(new_n464_));
  inv1   g308(.a(new_n464_), .O(new_n465_));
  oai21  g309(.a(new_n465_), .b(new_n461_), .c(new_n275_), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n459_), .c(x053), .O(new_n467_));
  oai21  g311(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n271_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n275_), .c(x037), .O(new_n470_));
  inv1   g314(.a(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(new_n467_), .c(new_n267_), .O(new_n472_));
  ...
  nand3  g319(.a(new_n475_), .b(new_n474_), .c(new_n472_), .O(new_n476_));
  aoi21  g320(.a(new_n456_), .b(x005), .c(new_n476_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(x045), .c(new_n173_), .O(z13));
  oai22  g322(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n479_));
  inv1   g323(.a(x102), .O(new_n480_));
  aoi21  g324(.a(new_n316_), .b(new_n480_), .c(x094), .O(new_n481_));
  nand2  g325(.a(new_n307_), .b(new_n306_), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(new_n481_), .c(new_n333_), .O(new_n483_));
  oai21  g327(.a(new_n316_), .b(x110), .c(x038), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(x118), .O(new_n485_));
  oai21  g329(.a(new_n480_), .b(x062), .c(new_n306_), .O(new_n486_));
  nand3  g330(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n324_), .O(new_n488_));
  aoi21  g332(.a(new_n486_), .b(new_n311_), .c(new_n488_), .O(new_n489_));
  nand4  g333(.a(new_n489_), .b(new_n485_), .c(new_n483_), .d(new_n479_), .O(new_n490_));
  nand4  g334(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n491_));
  inv1   g335(.a(new_n491_), .O(new_n492_));
  aoi21  g336(.a(new_n490_), .b(new_n332_), .c(new_n492_), .O(new_n493_));
  nand3  g337(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n494_));
  oai21  g338(.a(new_n493_), .b(x054), .c(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n302_), .b(x030), .c(x022), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(x078), .c(new_n299_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n482_), .O(new_n498_));
  nand2  g342(.a(x030), .b(new_n300_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n328_), .c(new_n333_), .O(new_n500_));
  nand2  g344(.a(new_n316_), .b(new_n480_), .O(new_n501_));
  ...
  oai21  g348(.a(new_n504_), .b(new_n500_), .c(new_n332_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n498_), .c(x054), .O(new_n506_));
  oai21  g350(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n328_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n332_), .c(x038), .O(new_n509_));
  inv1   g353(.a(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n506_), .c(new_n324_), .O(new_n511_));
  ...
  oai21  g360(.a(new_n516_), .b(x046), .c(new_n173_), .O(z14));
  zero   g361(.O(z15));
  zero   g362(.O(z17));
  zero   g363(.O(z20));
  zero   g364(.O(z23));
  ...
  zero   g366(.O(z25));
  zero   g367(.O(z27));
  nor2   g368(.a(x126), .b(x079), .O(z16));
  nor2   g369(.a(x126), .b(x079), .O(z18));
  nor2   g370(.a(x126), .b(x079), .O(z19));
  nor2   g371(.a(x126), .b(x079), .O(z21));
  nor2   g372(.a(x126), .b(x079), .O(z22));
  nor2   g373(.a(x126), .b(x079), .O(z26));
endmodule
