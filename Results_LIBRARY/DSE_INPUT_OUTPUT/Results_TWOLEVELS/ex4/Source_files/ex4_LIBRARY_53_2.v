...
module FAU ( 
  ...
  oai21  g309(.a(new_n465_), .b(x045), .c(new_n159_), .O(z13));
  oai21  g310(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n467_));
  nand2  g311(.a(new_n318_), .b(new_n314_), .O(new_n468_));
  oai22  g312(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n468_), .O(new_n470_));
  oai22  g314(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n471_));
  nand2  g315(.a(x118), .b(new_n298_), .O(new_n472_));
  oai21  g316(.a(x118), .b(x022), .c(new_n472_), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(x126), .c(x086), .O(new_n474_));
  nand4  g318(.a(new_n474_), .b(new_n471_), .c(new_n470_), .d(new_n467_), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(new_n297_), .c(new_n340_), .O(new_n476_));
  nand4  g320(.a(x086), .b(new_n157_), .c(new_n300_), .d(new_n319_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n476_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x006), .O(new_n479_));
  nor2   g323(.a(new_n331_), .b(new_n304_), .O(new_n480_));
  oai22  g324(.a(new_n480_), .b(new_n321_), .c(x118), .d(x110), .O(new_n481_));
  nor2   g325(.a(x038), .b(new_n304_), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(new_n307_), .c(x070), .O(new_n483_));
  nand4  g327(.a(new_n468_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n484_));
  nand3  g328(.a(new_n484_), .b(new_n483_), .c(new_n481_), .O(new_n485_));
  aoi21  g329(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n486_));
  nor2   g330(.a(new_n486_), .b(new_n300_), .O(new_n487_));
  aoi21  g331(.a(new_n485_), .b(new_n340_), .c(new_n487_), .O(new_n488_));
  nor2   g332(.a(new_n301_), .b(x038), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(x022), .c(x046), .O(new_n490_));
  oai21  g334(.a(new_n488_), .b(x086), .c(new_n490_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n297_), .O(new_n492_));
  nand2  g336(.a(x054), .b(x038), .O(new_n493_));
  nand4  g337(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n494_));
  nand2  g338(.a(x078), .b(x014), .O(new_n495_));
  nand3  g339(.a(new_n495_), .b(new_n494_), .c(new_n493_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n157_), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n492_), .c(new_n479_), .O(z14));
  zero   g342(.O(z15));
  zero   g343(.O(z16));
  zero   g344(.O(z17));
  zero   g345(.O(z19));
  ...
  zero   g348(.O(z25));
  zero   g349(.O(z27));
  nor2   g350(.a(x078), .b(new_n157_), .O(z18));
  nor2   g351(.a(x078), .b(new_n157_), .O(z20));
  nor2   g352(.a(x078), .b(new_n157_), .O(z21));
  nor2   g353(.a(x078), .b(new_n157_), .O(z24));
  nor2   g354(.a(x078), .b(new_n157_), .O(z26));
endmodule
