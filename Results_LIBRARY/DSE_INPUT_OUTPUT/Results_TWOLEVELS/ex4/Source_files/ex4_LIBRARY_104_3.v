// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:28 2020
...
module FAU ( 
  ...
  oai22  g189(.a(new_n172_), .b(new_n313_), .c(new_n299_), .d(new_n301_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n334_), .c(new_n302_), .O(new_n347_));
  aoi22  g191(.a(new_n172_), .b(new_n301_), .c(new_n299_), .d(new_n313_), .O(new_n348_));
  ...
  oai21  g205(.a(new_n360_), .b(x088), .c(new_n361_), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(new_n166_), .O(new_n363_));
  inv1   g207(.a(x120), .O(new_n364_));
  oai21  g208(.a(new_n364_), .b(x104), .c(x032), .O(new_n365_));
  nand2  g209(.a(new_n365_), .b(x112), .O(new_n366_));
  inv1   g210(.a(x096), .O(new_n367_));
  inv1   g211(.a(x104), .O(new_n368_));
  oai21  g212(.a(new_n367_), .b(x056), .c(new_n368_), .O(new_n369_));
  inv1   g213(.a(x112), .O(new_n370_));
  nand3  g214(.a(x120), .b(new_n370_), .c(new_n165_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n158_), .O(new_n372_));
  aoi21  g216(.a(new_n369_), .b(new_n160_), .c(new_n372_), .O(new_n373_));
  nand4  g217(.a(new_n373_), .b(new_n366_), .c(new_n363_), .d(new_n359_), .O(new_n374_));
  nand4  g218(.a(x120), .b(new_n356_), .c(new_n160_), .d(x008), .O(new_n375_));
  ...
  nand2  g226(.a(new_n382_), .b(new_n165_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n162_), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n159_), .c(new_n361_), .O(new_n385_));
  inv1   g229(.a(x024), .O(new_n386_));
  nor2   g230(.a(new_n386_), .b(x016), .O(new_n387_));
  oai21  g231(.a(new_n387_), .b(new_n358_), .c(x064), .O(new_n388_));
  inv1   g232(.a(new_n360_), .O(new_n389_));
  nand4  g233(.a(new_n381_), .b(new_n389_), .c(new_n355_), .d(x024), .O(new_n390_));
  aoi21  g234(.a(new_n390_), .b(new_n388_), .c(x072), .O(new_n391_));
  oai21  g235(.a(new_n391_), .b(new_n385_), .c(new_n161_), .O(new_n392_));
  ...
  aoi21  g244(.a(new_n396_), .b(new_n158_), .c(new_n400_), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(new_n380_), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(new_n175_), .c(new_n354_), .O(new_n403_));
  inv1   g247(.a(new_n403_), .O(z08));
  inv1   g248(.a(x041), .O(new_n405_));
  ...
  nand3  g255(.a(new_n411_), .b(new_n175_), .c(new_n405_), .O(new_n412_));
  inv1   g256(.a(new_n412_), .O(z09));
  ...
  nand3  g264(.a(new_n420_), .b(new_n175_), .c(new_n414_), .O(new_n421_));
  ...
  oai21  g273(.a(new_n429_), .b(x043), .c(new_n175_), .O(z11));
  ...
  oai21  g281(.a(new_n437_), .b(x044), .c(new_n175_), .O(z12));
  inv1   g282(.a(x045), .O(new_n439_));
  nand2  g283(.a(x021), .b(x013), .O(new_n440_));
  oai21  g284(.a(new_n281_), .b(x029), .c(new_n440_), .O(new_n441_));
  ...
  nand3  g293(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n269_), .O(new_n451_));
  aoi21  g295(.a(new_n449_), .b(new_n256_), .c(new_n451_), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n447_), .c(new_n445_), .d(new_n441_), .O(new_n453_));
  nand4  g297(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n277_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n457_));
  oai21  g301(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(x005), .O(new_n459_));
  nand2  g303(.a(new_n247_), .b(x029), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n245_), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n277_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n244_), .c(new_n443_), .O(new_n463_));
  nor2   g307(.a(new_n243_), .b(x021), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n281_), .c(x069), .O(new_n465_));
  inv1   g309(.a(new_n442_), .O(new_n466_));
  nand4  g310(.a(new_n466_), .b(new_n440_), .c(new_n247_), .d(x029), .O(new_n467_));
  aoi21  g311(.a(new_n467_), .b(new_n465_), .c(x077), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n463_), .c(new_n242_), .O(new_n469_));
  nand2  g313(.a(new_n440_), .b(x029), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n273_), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n277_), .c(x037), .O(new_n472_));
  ...
  aoi21  g321(.a(new_n473_), .b(new_n269_), .c(new_n477_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n459_), .O(new_n479_));
  nand3  g323(.a(new_n479_), .b(new_n175_), .c(new_n439_), .O(new_n480_));
  inv1   g324(.a(new_n480_), .O(z13));
  oai21  g325(.a(x046), .b(new_n301_), .c(new_n173_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x078), .O(new_n483_));
  oai22  g327(.a(new_n337_), .b(x030), .c(new_n302_), .d(new_n301_), .O(new_n484_));
  inv1   g328(.a(x102), .O(new_n485_));
  aoi21  g329(.a(new_n318_), .b(new_n485_), .c(x094), .O(new_n486_));
  nand2  g330(.a(new_n309_), .b(new_n308_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n486_), .c(new_n334_), .O(new_n488_));
  oai21  g332(.a(new_n318_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g334(.a(new_n485_), .b(x062), .c(new_n308_), .O(new_n491_));
  nand3  g335(.a(x126), .b(new_n309_), .c(new_n302_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n326_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n313_), .c(new_n493_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n490_), .c(new_n488_), .d(new_n484_), .O(new_n495_));
  nand4  g339(.a(x126), .b(new_n316_), .c(new_n313_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n172_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n313_), .c(new_n301_), .O(new_n499_));
  oai21  g343(.a(new_n498_), .b(x054), .c(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n304_), .b(x030), .c(x022), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(x078), .c(new_n301_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n487_), .O(new_n503_));
  nand2  g347(.a(x030), .b(new_n302_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n330_), .c(new_n334_), .O(new_n505_));
  nand2  g349(.a(new_n318_), .b(new_n485_), .O(new_n506_));
  aoi22  g350(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n506_), .c(x030), .O(new_n508_));
  inv1   g352(.a(new_n508_), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(new_n505_), .c(new_n172_), .O(new_n510_));
  aoi21  g354(.a(new_n510_), .b(new_n503_), .c(x054), .O(new_n511_));
  oai21  g355(.a(new_n302_), .b(new_n301_), .c(x030), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n330_), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n172_), .c(x038), .O(new_n514_));
  inv1   g358(.a(new_n514_), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n511_), .c(new_n326_), .O(new_n516_));
  ...
  aoi21  g364(.a(new_n500_), .b(x006), .c(new_n520_), .O(new_n521_));
  oai21  g365(.a(new_n521_), .b(x046), .c(new_n483_), .O(z14));
  zero   g366(.O(z15));
  zero   g367(.O(z16));
  zero   g368(.O(z21));
  zero   g369(.O(z24));
  zero   g370(.O(z26));
  nor2   g371(.a(new_n173_), .b(new_n172_), .O(z17));
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z20));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g377(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g378(.a(new_n173_), .b(new_n172_), .O(z27));
endmodule
