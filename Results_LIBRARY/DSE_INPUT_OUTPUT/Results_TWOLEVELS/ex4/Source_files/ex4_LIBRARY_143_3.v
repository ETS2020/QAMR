...
module FAU ( 
  ...
  nand2  g059(.a(new_n215_), .b(new_n210_), .O(new_n216_));
  aoi22  g060(.a(new_n214_), .b(new_n211_), .c(new_n213_), .d(new_n212_), .O(new_n217_));
  oai21  g061(.a(new_n216_), .b(x003), .c(new_n217_), .O(new_n218_));
  nand2  g062(.a(new_n218_), .b(new_n175_), .O(new_n219_));
  inv1   g063(.a(x067), .O(new_n220_));
  oai22  g064(.a(new_n214_), .b(new_n212_), .c(new_n213_), .d(new_n211_), .O(new_n221_));
  nand3  g065(.a(new_n221_), .b(new_n220_), .c(new_n172_), .O(new_n222_));
  aoi21  g066(.a(new_n222_), .b(new_n219_), .c(new_n209_), .O(z03));
  ...
  nand3  g258(.a(new_n414_), .b(new_n175_), .c(new_n408_), .O(new_n415_));
  ...
  nand2  g266(.a(new_n422_), .b(new_n209_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n175_), .O(z11));
  ...
  oai21  g315(.a(new_n471_), .b(x045), .c(new_n175_), .O(z13));
  ...
  oai21  g319(.a(new_n475_), .b(x054), .c(new_n173_), .O(new_n476_));
  oai21  g320(.a(new_n298_), .b(x019), .c(new_n476_), .O(new_n477_));
  ...
  nand3  g354(.a(new_n510_), .b(x078), .c(new_n172_), .O(new_n511_));
  inv1   g355(.a(new_n511_), .O(new_n512_));
  aoi21  g356(.a(new_n507_), .b(new_n173_), .c(new_n512_), .O(new_n513_));
  ...
  nor2   g367(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g368(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g369(.a(new_n173_), .b(new_n172_), .O(z26));
