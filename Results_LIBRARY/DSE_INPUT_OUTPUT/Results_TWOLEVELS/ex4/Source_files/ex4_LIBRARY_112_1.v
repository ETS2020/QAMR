...
module FAU ( 
  ...
  zero   g371(.O(z17));
  zero   g372(.O(z26));
  nor2   g373(.a(new_n172_), .b(x117), .O(z19));
  nor2   g374(.a(new_n172_), .b(x117), .O(z20));
  nor2   g375(.a(new_n172_), .b(x117), .O(z21));
  nor2   g376(.a(new_n172_), .b(x117), .O(z22));
  nor2   g377(.a(new_n172_), .b(x117), .O(z23));
  nor2   g378(.a(new_n172_), .b(x117), .O(z24));
  nor2   g379(.a(new_n172_), .b(x117), .O(z25));
  nor2   g380(.a(new_n172_), .b(x117), .O(z27));
endmodule
