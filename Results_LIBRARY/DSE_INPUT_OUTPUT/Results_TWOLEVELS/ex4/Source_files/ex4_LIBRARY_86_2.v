// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:45 2020
...
module FAU ( 
  ...
  oai22  g282(.a(new_n279_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n440_));
  inv1   g283(.a(x101), .O(new_n441_));
  aoi21  g284(.a(new_n259_), .b(new_n441_), .c(x093), .O(new_n442_));
  nand2  g285(.a(new_n172_), .b(new_n250_), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(new_n442_), .c(new_n276_), .O(new_n444_));
  oai21  g287(.a(new_n259_), .b(x109), .c(x037), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(x117), .O(new_n446_));
  oai21  g289(.a(new_n441_), .b(x061), .c(new_n250_), .O(new_n447_));
  nand3  g290(.a(x125), .b(new_n172_), .c(new_n244_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n267_), .O(new_n449_));
  aoi21  g292(.a(new_n447_), .b(new_n254_), .c(new_n449_), .O(new_n450_));
  nand4  g293(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n440_), .O(new_n451_));
  ...
  nand3  g297(.a(x085), .b(new_n254_), .c(new_n243_), .O(new_n455_));
  ...
  nand2  g304(.a(new_n259_), .b(new_n441_), .O(new_n462_));
  aoi22  g305(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n463_));
  nand3  g306(.a(new_n463_), .b(new_n462_), .c(x029), .O(new_n464_));
  inv1   g307(.a(new_n464_), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n461_), .c(new_n275_), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n459_), .c(x053), .O(new_n467_));
  oai21  g310(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n468_));
  ...
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n267_), .O(new_n472_));
  ...
  aoi21  g319(.a(new_n456_), .b(x005), .c(new_n476_), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(x045), .c(new_n174_), .O(z13));
  oai22  g321(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n479_));
  inv1   g322(.a(x102), .O(new_n480_));
  aoi21  g323(.a(new_n316_), .b(new_n480_), .c(x094), .O(new_n481_));
  nand2  g324(.a(new_n307_), .b(new_n306_), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n481_), .c(new_n333_), .O(new_n483_));
  oai21  g326(.a(new_n316_), .b(x110), .c(x038), .O(new_n484_));
  ...
  nand2  g330(.a(new_n487_), .b(new_n324_), .O(new_n488_));
  ...
  aoi21  g335(.a(new_n490_), .b(new_n332_), .c(new_n492_), .O(new_n493_));
  ...
  aoi21  g342(.a(new_n499_), .b(new_n328_), .c(new_n333_), .O(new_n500_));
  nand2  g343(.a(new_n316_), .b(new_n480_), .O(new_n501_));
  ...
  oai21  g347(.a(new_n504_), .b(new_n500_), .c(new_n332_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n498_), .c(x054), .O(new_n506_));
  oai21  g349(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n328_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n332_), .c(x038), .O(new_n509_));
  inv1   g352(.a(new_n509_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n506_), .c(new_n324_), .O(new_n511_));
  ...
  zero   g365(.O(z26));
  zero   g366(.O(z27));
  nor2   g367(.a(x126), .b(new_n172_), .O(z16));
  nor2   g368(.a(x126), .b(new_n172_), .O(z17));
  nor2   g369(.a(x126), .b(new_n172_), .O(z18));
  nor2   g370(.a(x126), .b(new_n172_), .O(z19));
  nor2   g371(.a(x126), .b(new_n172_), .O(z21));
  nor2   g372(.a(x126), .b(new_n172_), .O(z23));
endmodule
