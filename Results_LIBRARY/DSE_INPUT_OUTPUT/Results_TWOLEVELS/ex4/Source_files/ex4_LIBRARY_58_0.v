// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:53 2020
...
module FAU ( 
  ...
  nand2  g025(.a(new_n181_), .b(new_n176_), .O(new_n182_));
  aoi22  g026(.a(new_n180_), .b(new_n177_), .c(new_n179_), .d(new_n178_), .O(new_n183_));
  oai21  g027(.a(new_n182_), .b(x001), .c(new_n183_), .O(new_n184_));
  nand2  g028(.a(new_n184_), .b(new_n158_), .O(new_n185_));
  inv1   g029(.a(x017), .O(new_n186_));
  inv1   g030(.a(x065), .O(new_n187_));
  oai22  g031(.a(new_n180_), .b(new_n178_), .c(new_n179_), .d(new_n177_), .O(new_n188_));
  nand4  g032(.a(new_n188_), .b(x126), .c(new_n187_), .d(new_n186_), .O(new_n189_));
  aoi21  g033(.a(new_n189_), .b(new_n185_), .c(new_n175_), .O(z01));
  ...
  oai21  g262(.a(new_n419_), .b(x042), .c(new_n158_), .O(z10));
  ...
  nand2  g338(.a(new_n495_), .b(new_n158_), .O(new_n496_));
  nand2  g339(.a(x102), .b(x065), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n316_), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n302_), .c(new_n324_), .O(new_n499_));
  nand2  g342(.a(x065), .b(x006), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(new_n499_), .c(new_n298_), .O(new_n501_));
  nor3   g344(.a(new_n328_), .b(new_n187_), .c(new_n296_), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n501_), .c(new_n297_), .O(new_n503_));
  nand4  g346(.a(new_n324_), .b(x065), .c(x038), .d(x030), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n503_), .O(new_n505_));
  oai21  g348(.a(new_n300_), .b(new_n299_), .c(new_n505_), .O(new_n506_));
  nand4  g349(.a(new_n324_), .b(x070), .c(x065), .d(x030), .O(new_n507_));
  nand3  g350(.a(x126), .b(new_n307_), .c(x006), .O(new_n508_));
  ...
  oai21  g355(.a(new_n333_), .b(new_n311_), .c(new_n485_), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n512_), .c(new_n296_), .O(new_n514_));
  nand4  g357(.a(new_n485_), .b(new_n302_), .c(new_n324_), .d(x030), .O(new_n515_));
  inv1   g358(.a(new_n515_), .O(new_n516_));
  oai21  g359(.a(new_n516_), .b(new_n514_), .c(x065), .O(new_n517_));
  inv1   g360(.a(x094), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n333_), .O(new_n519_));
  nand2  g362(.a(x118), .b(new_n306_), .O(new_n520_));
  nand3  g363(.a(new_n520_), .b(new_n519_), .c(new_n482_), .O(new_n521_));
  ...
  nand3  g368(.a(new_n311_), .b(x014), .c(x006), .O(new_n526_));
  nor4   g369(.a(new_n526_), .b(new_n316_), .c(x062), .d(x054), .O(new_n527_));
  aoi21  g370(.a(new_n525_), .b(new_n332_), .c(new_n527_), .O(new_n528_));
  aoi21  g371(.a(new_n528_), .b(new_n496_), .c(x046), .O(z14));
  zero   g372(.O(z07));
  zero   g373(.O(z15));
  zero   g374(.O(z17));
  zero   g375(.O(z18));
  ...
  zero   g379(.O(z26));
  zero   g380(.O(z27));
  nor2   g381(.a(x126), .b(x065), .O(z20));
  nor2   g382(.a(x126), .b(x065), .O(z22));
  nor2   g383(.a(x126), .b(x065), .O(z23));
  nor2   g384(.a(x126), .b(x065), .O(z24));
endmodule
