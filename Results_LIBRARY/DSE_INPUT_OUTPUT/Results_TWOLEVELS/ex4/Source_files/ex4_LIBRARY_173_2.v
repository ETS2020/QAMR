// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:07 2020
...
module FAU ( 
  ...
  nand3  g163(.a(new_n263_), .b(x118), .c(x022), .O(new_n320_));
  ...
  nand4  g167(.a(new_n263_), .b(x062), .c(x038), .d(new_n303_), .O(new_n324_));
  ...
  nand2  g198(.a(new_n354_), .b(new_n159_), .O(z06));
  ...
  oai21  g257(.a(new_n413_), .b(x041), .c(new_n159_), .O(z09));
  ...
  nand2  g287(.a(new_n443_), .b(new_n246_), .O(new_n444_));
  oai22  g288(.a(new_n444_), .b(x053), .c(new_n442_), .d(new_n285_), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x069), .O(new_n446_));
  nand2  g290(.a(new_n444_), .b(new_n245_), .O(new_n447_));
  aoi22  g291(.a(new_n447_), .b(x037), .c(x077), .d(x013), .O(new_n448_));
  nand3  g292(.a(new_n448_), .b(new_n446_), .c(new_n441_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n159_), .O(new_n450_));
  inv1   g294(.a(x109), .O(new_n451_));
  nand2  g295(.a(x126), .b(x117), .O(new_n452_));
  oai21  g296(.a(x117), .b(new_n451_), .c(new_n452_), .O(new_n453_));
  aoi21  g297(.a(x069), .b(x037), .c(new_n241_), .O(new_n454_));
  nand2  g298(.a(new_n253_), .b(x029), .O(new_n455_));
  aoi21  g299(.a(new_n455_), .b(new_n285_), .c(x085), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(new_n454_), .c(new_n246_), .O(new_n457_));
  oai21  g301(.a(x085), .b(new_n243_), .c(new_n457_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n453_), .O(new_n459_));
  nor2   g303(.a(x061), .b(x037), .O(new_n460_));
  nor2   g304(.a(x093), .b(x069), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n460_), .c(x005), .O(new_n462_));
  nand2  g306(.a(x021), .b(x013), .O(new_n463_));
  nand4  g307(.a(new_n463_), .b(new_n253_), .c(new_n242_), .d(x029), .O(new_n464_));
  nand2  g308(.a(new_n464_), .b(new_n462_), .O(new_n465_));
  oai21  g309(.a(x125), .b(x101), .c(new_n465_), .O(new_n466_));
  aoi22  g310(.a(new_n266_), .b(new_n284_), .c(x021), .d(x013), .O(new_n467_));
  nor2   g311(.a(new_n278_), .b(x021), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n467_), .c(x005), .O(new_n469_));
  nand4  g313(.a(new_n242_), .b(x069), .c(x029), .d(new_n285_), .O(new_n470_));
  nand3  g314(.a(new_n470_), .b(new_n469_), .c(new_n466_), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n157_), .c(new_n246_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n459_), .O(new_n473_));
  nand3  g317(.a(new_n157_), .b(new_n242_), .c(x029), .O(new_n474_));
  nand4  g318(.a(x126), .b(x125), .c(new_n451_), .d(x005), .O(new_n475_));
  aoi21  g319(.a(new_n475_), .b(new_n474_), .c(x013), .O(new_n476_));
  nand4  g320(.a(new_n157_), .b(new_n242_), .c(x029), .d(new_n285_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(new_n478_));
  oai21  g322(.a(new_n478_), .b(new_n476_), .c(new_n246_), .O(new_n479_));
  nor2   g323(.a(new_n479_), .b(new_n244_), .O(new_n480_));
  aoi21  g324(.a(new_n473_), .b(new_n245_), .c(new_n480_), .O(new_n481_));
  ...
  nand2  g348(.a(new_n263_), .b(new_n484_), .O(new_n505_));
  ...
  oai21  g364(.a(new_n520_), .b(x046), .c(new_n159_), .O(z14));
  zero   g365(.O(z15));
  zero   g366(.O(z16));
  zero   g367(.O(z17));
  zero   g368(.O(z19));
  ...
  zero   g370(.O(z23));
  zero   g371(.O(z26));
  nor2   g372(.a(x126), .b(new_n157_), .O(z18));
  nor2   g373(.a(x126), .b(new_n157_), .O(z20));
  nor2   g374(.a(x126), .b(new_n157_), .O(z21));
  nor2   g375(.a(x126), .b(new_n157_), .O(z24));
  nor2   g376(.a(x126), .b(new_n157_), .O(z25));
