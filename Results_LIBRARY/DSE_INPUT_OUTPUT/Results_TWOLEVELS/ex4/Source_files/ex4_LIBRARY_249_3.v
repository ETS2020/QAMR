// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:41 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x117), .O(new_n172_));
  inv1   g016(.a(x126), .O(new_n173_));
  nor2   g017(.a(new_n173_), .b(new_n172_), .O(z21));
  inv1   g018(.a(z21), .O(new_n175_));
  ...
  nand2  g089(.a(x077), .b(x053), .O(new_n246_));
  oai21  g090(.a(new_n245_), .b(new_n244_), .c(new_n246_), .O(new_n247_));
  nand3  g091(.a(new_n247_), .b(new_n243_), .c(new_n242_), .O(new_n248_));
  ...
  nand2  g103(.a(new_n254_), .b(x053), .O(new_n260_));
  aoi22  g104(.a(new_n260_), .b(new_n245_), .c(new_n259_), .d(new_n244_), .O(new_n261_));
  nand3  g105(.a(new_n261_), .b(new_n258_), .c(new_n248_), .O(new_n262_));
  nand2  g106(.a(new_n262_), .b(new_n175_), .O(new_n263_));
  oai21  g107(.a(x126), .b(x109), .c(x117), .O(new_n264_));
  aoi21  g108(.a(new_n249_), .b(new_n245_), .c(x005), .O(new_n265_));
  ...
  oai22  g112(.a(new_n268_), .b(new_n259_), .c(new_n243_), .d(x013), .O(new_n269_));
  ...
  oai21  g134(.a(new_n290_), .b(new_n283_), .c(new_n173_), .O(new_n291_));
  ...
  nand2  g169(.a(new_n325_), .b(new_n175_), .O(new_n326_));
  ...
  nand2  g175(.a(new_n172_), .b(new_n301_), .O(new_n332_));
  aoi21  g176(.a(new_n332_), .b(new_n331_), .c(x030), .O(new_n333_));
  nand3  g177(.a(new_n312_), .b(new_n172_), .c(new_n301_), .O(new_n334_));
  inv1   g178(.a(new_n334_), .O(new_n335_));
  oai21  g179(.a(new_n335_), .b(new_n333_), .c(x054), .O(new_n336_));
  inv1   g180(.a(x030), .O(new_n337_));
  nand4  g181(.a(new_n172_), .b(x086), .c(new_n315_), .d(new_n337_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n336_), .O(new_n339_));
  oai21  g183(.a(x022), .b(x014), .c(new_n339_), .O(new_n340_));
  nand4  g184(.a(new_n172_), .b(x086), .c(new_n311_), .d(new_n337_), .O(new_n341_));
  nand3  g185(.a(new_n173_), .b(x118), .c(new_n301_), .O(new_n342_));
  ...
  oai21  g190(.a(new_n328_), .b(new_n315_), .c(new_n346_), .O(new_n347_));
  ...
  oai21  g196(.a(new_n352_), .b(new_n350_), .c(new_n172_), .O(new_n353_));
  ...
  nand3  g200(.a(new_n356_), .b(new_n173_), .c(new_n301_), .O(new_n357_));
  nand3  g201(.a(new_n357_), .b(new_n353_), .c(new_n344_), .O(new_n358_));
  ...
  inv1   g211(.a(x056), .O(new_n369_));
  inv1   g212(.a(x088), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n369_), .O(new_n371_));
  oai21  g214(.a(new_n371_), .b(x024), .c(new_n368_), .O(new_n372_));
  nor2   g215(.a(x120), .b(x096), .O(new_n373_));
  nor2   g216(.a(x112), .b(x104), .O(new_n374_));
  oai21  g217(.a(new_n373_), .b(x088), .c(new_n374_), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n166_), .O(new_n376_));
  inv1   g219(.a(x120), .O(new_n377_));
  oai21  g220(.a(new_n377_), .b(x104), .c(x032), .O(new_n378_));
  nand2  g221(.a(new_n378_), .b(x112), .O(new_n379_));
  inv1   g222(.a(x096), .O(new_n380_));
  inv1   g223(.a(x104), .O(new_n381_));
  oai21  g224(.a(new_n380_), .b(x056), .c(new_n381_), .O(new_n382_));
  inv1   g225(.a(x112), .O(new_n383_));
  nand3  g226(.a(x120), .b(new_n383_), .c(new_n165_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n158_), .O(new_n385_));
  aoi21  g228(.a(new_n382_), .b(new_n160_), .c(new_n385_), .O(new_n386_));
  nand4  g229(.a(new_n386_), .b(new_n379_), .c(new_n376_), .d(new_n372_), .O(new_n387_));
  nand4  g230(.a(x120), .b(new_n369_), .c(new_n160_), .d(x008), .O(new_n388_));
  inv1   g231(.a(new_n388_), .O(new_n389_));
  aoi21  g232(.a(new_n387_), .b(new_n162_), .c(new_n389_), .O(new_n390_));
  nand3  g233(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n391_));
  oai21  g234(.a(new_n390_), .b(x048), .c(new_n391_), .O(new_n392_));
  nand2  g235(.a(new_n392_), .b(x000), .O(new_n393_));
  nand2  g236(.a(x088), .b(x056), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(x024), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n165_), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(new_n162_), .O(new_n397_));
  aoi21  g240(.a(new_n397_), .b(new_n159_), .c(new_n374_), .O(new_n398_));
  inv1   g241(.a(x024), .O(new_n399_));
  nor2   g242(.a(new_n399_), .b(x016), .O(new_n400_));
  oai21  g243(.a(new_n400_), .b(new_n371_), .c(x064), .O(new_n401_));
  inv1   g244(.a(new_n373_), .O(new_n402_));
  nand4  g245(.a(new_n394_), .b(new_n402_), .c(new_n368_), .d(x024), .O(new_n403_));
  aoi21  g246(.a(new_n403_), .b(new_n401_), .c(x072), .O(new_n404_));
  oai21  g247(.a(new_n404_), .b(new_n398_), .c(new_n161_), .O(new_n405_));
  nand2  g248(.a(new_n368_), .b(x024), .O(new_n406_));
  nand3  g249(.a(new_n406_), .b(new_n370_), .c(new_n369_), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(new_n162_), .c(x032), .O(new_n408_));
  nand2  g251(.a(new_n408_), .b(new_n405_), .O(new_n409_));
  oai22  g252(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n410_));
  nand3  g253(.a(new_n410_), .b(x064), .c(x016), .O(new_n411_));
  aoi22  g254(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n412_));
  nand2  g255(.a(new_n412_), .b(new_n411_), .O(new_n413_));
  aoi21  g256(.a(new_n409_), .b(new_n158_), .c(new_n413_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n393_), .O(new_n415_));
  nand3  g258(.a(new_n415_), .b(new_n175_), .c(new_n367_), .O(new_n416_));
  inv1   g259(.a(new_n416_), .O(z08));
  inv1   g260(.a(x041), .O(new_n418_));
  oai22  g261(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n419_));
  nand3  g262(.a(new_n419_), .b(x081), .c(x001), .O(new_n420_));
  oai22  g263(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n421_));
  nand3  g264(.a(new_n421_), .b(x065), .c(x017), .O(new_n422_));
  aoi22  g265(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n423_));
  nand3  g266(.a(new_n423_), .b(new_n422_), .c(new_n420_), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(new_n175_), .c(new_n418_), .O(new_n425_));
  inv1   g268(.a(new_n425_), .O(z09));
  inv1   g269(.a(x042), .O(new_n427_));
  oai22  g270(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(x082), .c(x002), .O(new_n429_));
  oai22  g272(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n430_));
  nand3  g273(.a(new_n430_), .b(x066), .c(x018), .O(new_n431_));
  aoi22  g274(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(new_n431_), .c(new_n429_), .O(new_n433_));
  nand3  g276(.a(new_n433_), .b(new_n175_), .c(new_n427_), .O(new_n434_));
  inv1   g277(.a(new_n434_), .O(z10));
  inv1   g278(.a(x043), .O(new_n436_));
  oai22  g279(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n437_));
  nand3  g280(.a(new_n437_), .b(x083), .c(x003), .O(new_n438_));
  oai22  g281(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n439_));
  nand3  g282(.a(new_n439_), .b(x067), .c(x019), .O(new_n440_));
  aoi22  g283(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n441_));
  nand3  g284(.a(new_n441_), .b(new_n440_), .c(new_n438_), .O(new_n442_));
  nand3  g285(.a(new_n442_), .b(new_n175_), .c(new_n436_), .O(new_n443_));
  inv1   g286(.a(new_n443_), .O(z11));
  inv1   g287(.a(x044), .O(new_n445_));
  ...
  nand3  g294(.a(new_n451_), .b(new_n175_), .c(new_n445_), .O(new_n452_));
  inv1   g295(.a(new_n452_), .O(z12));
  nand2  g296(.a(new_n266_), .b(new_n284_), .O(new_n454_));
  oai21  g297(.a(new_n285_), .b(new_n244_), .c(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n278_), .b(new_n276_), .c(x093), .O(new_n456_));
  inv1   g299(.a(x109), .O(new_n457_));
  nand2  g300(.a(new_n172_), .b(new_n457_), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(new_n456_), .c(new_n249_), .O(new_n459_));
  oai21  g302(.a(new_n278_), .b(x109), .c(x037), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(x117), .O(new_n461_));
  oai21  g304(.a(new_n276_), .b(x061), .c(new_n457_), .O(new_n462_));
  nand3  g305(.a(x125), .b(new_n172_), .c(new_n285_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n243_), .O(new_n464_));
  aoi21  g307(.a(new_n462_), .b(new_n245_), .c(new_n464_), .O(new_n465_));
  nand4  g308(.a(new_n465_), .b(new_n461_), .c(new_n459_), .d(new_n455_), .O(new_n466_));
  nor2   g309(.a(x037), .b(new_n244_), .O(new_n467_));
  nor2   g310(.a(new_n278_), .b(x061), .O(new_n468_));
  aoi22  g311(.a(new_n468_), .b(new_n467_), .c(new_n466_), .d(new_n259_), .O(new_n469_));
  nand3  g312(.a(x085), .b(new_n245_), .c(new_n244_), .O(new_n470_));
  oai21  g313(.a(new_n469_), .b(x053), .c(new_n470_), .O(new_n471_));
  aoi21  g314(.a(new_n253_), .b(x029), .c(x021), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(x077), .c(new_n244_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n458_), .O(new_n474_));
  nand2  g317(.a(x029), .b(new_n285_), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n266_), .c(new_n249_), .O(new_n476_));
  nand2  g319(.a(new_n278_), .b(new_n276_), .O(new_n477_));
  aoi22  g320(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n477_), .c(x029), .O(new_n479_));
  inv1   g322(.a(new_n479_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n476_), .c(new_n259_), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n474_), .c(x053), .O(new_n482_));
  oai21  g325(.a(new_n285_), .b(new_n244_), .c(x029), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n266_), .O(new_n484_));
  nand3  g327(.a(new_n484_), .b(new_n259_), .c(x037), .O(new_n485_));
  inv1   g328(.a(new_n485_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n482_), .c(new_n243_), .O(new_n487_));
  oai22  g330(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n488_));
  nand3  g331(.a(new_n488_), .b(x069), .c(x021), .O(new_n489_));
  aoi22  g332(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(new_n489_), .c(new_n487_), .O(new_n491_));
  aoi21  g334(.a(new_n471_), .b(x005), .c(new_n491_), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(x045), .c(new_n175_), .O(z13));
  nand2  g336(.a(new_n315_), .b(new_n361_), .O(new_n494_));
  oai21  g337(.a(x078), .b(x054), .c(new_n494_), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(x086), .c(x006), .O(new_n496_));
  inv1   g339(.a(x110), .O(new_n497_));
  nand2  g340(.a(new_n354_), .b(new_n497_), .O(new_n498_));
  oai21  g341(.a(x078), .b(new_n319_), .c(new_n361_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n498_), .O(new_n500_));
  nand3  g343(.a(new_n330_), .b(new_n304_), .c(x070), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n500_), .c(x054), .O(new_n502_));
  nand2  g345(.a(new_n330_), .b(new_n304_), .O(new_n503_));
  nor2   g346(.a(new_n503_), .b(new_n315_), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(new_n502_), .c(new_n302_), .O(new_n505_));
  oai22  g348(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(x070), .c(x022), .O(new_n507_));
  aoi22  g350(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n508_));
  nand4  g351(.a(new_n508_), .b(new_n507_), .c(new_n505_), .d(new_n496_), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n175_), .O(new_n510_));
  nor2   g353(.a(new_n319_), .b(new_n361_), .O(new_n511_));
  inv1   g354(.a(new_n312_), .O(new_n512_));
  nand2  g355(.a(x126), .b(new_n172_), .O(new_n513_));
  nand2  g356(.a(new_n173_), .b(x102), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(new_n513_), .c(new_n512_), .O(new_n515_));
  nor2   g358(.a(x126), .b(new_n301_), .O(new_n516_));
  aoi21  g359(.a(new_n515_), .b(new_n302_), .c(new_n516_), .O(new_n517_));
  nand3  g360(.a(new_n330_), .b(new_n173_), .c(x006), .O(new_n518_));
  oai21  g361(.a(new_n517_), .b(new_n337_), .c(new_n518_), .O(new_n519_));
  nand4  g362(.a(new_n173_), .b(new_n302_), .c(x038), .d(x030), .O(new_n520_));
  inv1   g363(.a(new_n520_), .O(new_n521_));
  aoi21  g364(.a(new_n519_), .b(new_n303_), .c(new_n521_), .O(new_n522_));
  nand4  g365(.a(x126), .b(new_n354_), .c(new_n172_), .d(x006), .O(new_n523_));
  nand4  g366(.a(new_n173_), .b(new_n302_), .c(x070), .d(x030), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n523_), .O(new_n525_));
  nand2  g368(.a(new_n525_), .b(new_n319_), .O(new_n526_));
  oai22  g369(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n527_));
  nand2  g370(.a(new_n527_), .b(x102), .O(new_n528_));
  nand2  g371(.a(x070), .b(x038), .O(new_n529_));
  nand2  g372(.a(new_n529_), .b(new_n498_), .O(new_n530_));
  aoi21  g373(.a(new_n530_), .b(new_n528_), .c(new_n301_), .O(new_n531_));
  nand4  g374(.a(new_n498_), .b(new_n312_), .c(new_n302_), .d(x030), .O(new_n532_));
  inv1   g375(.a(new_n532_), .O(new_n533_));
  oai21  g376(.a(new_n533_), .b(new_n531_), .c(new_n173_), .O(new_n534_));
  nand2  g377(.a(new_n329_), .b(new_n311_), .O(new_n535_));
  nand2  g378(.a(x118), .b(new_n497_), .O(new_n536_));
  nand3  g379(.a(new_n536_), .b(new_n535_), .c(new_n494_), .O(new_n537_));
  nand4  g380(.a(new_n537_), .b(x126), .c(new_n172_), .d(x006), .O(new_n538_));
  nand3  g381(.a(new_n538_), .b(new_n534_), .c(new_n526_), .O(new_n539_));
  nand2  g382(.a(new_n539_), .b(new_n303_), .O(new_n540_));
  oai21  g383(.a(new_n522_), .b(new_n511_), .c(new_n540_), .O(new_n541_));
  nand3  g384(.a(new_n315_), .b(x014), .c(x006), .O(new_n542_));
  nor4   g385(.a(new_n542_), .b(new_n513_), .c(x062), .d(x054), .O(new_n543_));
  aoi21  g386(.a(new_n541_), .b(new_n304_), .c(new_n543_), .O(new_n544_));
  aoi21  g387(.a(new_n544_), .b(new_n510_), .c(x046), .O(z14));
  zero   g388(.O(z07));
  zero   g389(.O(z15));
  zero   g390(.O(z16));
  zero   g391(.O(z17));
  ...
  zero   g395(.O(z23));
  zero   g396(.O(z27));
  nor2   g397(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g398(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g399(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g400(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
