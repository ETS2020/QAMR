// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:21 2020
...
module FAU ( 
  ...
  inv1   g231(.a(x045), .O(new_n388_));
  nand2  g232(.a(x021), .b(x013), .O(new_n389_));
  oai21  g233(.a(new_n278_), .b(x029), .c(new_n389_), .O(new_n390_));
  nor2   g234(.a(x125), .b(x101), .O(new_n391_));
  nor2   g235(.a(x117), .b(x109), .O(new_n392_));
  oai21  g236(.a(new_n391_), .b(x093), .c(new_n392_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(new_n275_), .O(new_n394_));
  oai21  g238(.a(new_n258_), .b(x109), .c(x037), .O(new_n395_));
  nand2  g239(.a(new_n395_), .b(x117), .O(new_n396_));
  inv1   g240(.a(x101), .O(new_n397_));
  oai21  g241(.a(new_n397_), .b(x061), .c(new_n248_), .O(new_n398_));
  nand3  g242(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(new_n266_), .O(new_n400_));
  aoi21  g244(.a(new_n398_), .b(new_n253_), .c(new_n400_), .O(new_n401_));
  nand4  g245(.a(new_n401_), .b(new_n396_), .c(new_n394_), .d(new_n390_), .O(new_n402_));
  nand4  g246(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n403_));
  inv1   g247(.a(new_n403_), .O(new_n404_));
  aoi21  g248(.a(new_n402_), .b(new_n274_), .c(new_n404_), .O(new_n405_));
  nand3  g249(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n406_));
  oai21  g250(.a(new_n405_), .b(x053), .c(new_n406_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(x005), .O(new_n408_));
  nand2  g252(.a(new_n244_), .b(x029), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(new_n242_), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(new_n274_), .O(new_n411_));
  aoi21  g255(.a(new_n411_), .b(new_n241_), .c(new_n392_), .O(new_n412_));
  nor2   g256(.a(new_n240_), .b(x021), .O(new_n413_));
  oai21  g257(.a(new_n413_), .b(new_n278_), .c(x069), .O(new_n414_));
  inv1   g258(.a(new_n391_), .O(new_n415_));
  nand4  g259(.a(new_n415_), .b(new_n389_), .c(new_n244_), .d(x029), .O(new_n416_));
  aoi21  g260(.a(new_n416_), .b(new_n414_), .c(x077), .O(new_n417_));
  oai21  g261(.a(new_n417_), .b(new_n412_), .c(new_n239_), .O(new_n418_));
  nand2  g262(.a(new_n389_), .b(x029), .O(new_n419_));
  nand2  g263(.a(new_n419_), .b(new_n270_), .O(new_n420_));
  nand3  g264(.a(new_n420_), .b(new_n274_), .c(x037), .O(new_n421_));
  ...
  aoi21  g270(.a(new_n422_), .b(new_n266_), .c(new_n426_), .O(new_n427_));
  nand2  g271(.a(new_n427_), .b(new_n408_), .O(new_n428_));
  nand3  g272(.a(new_n428_), .b(new_n157_), .c(new_n388_), .O(new_n429_));
  inv1   g273(.a(new_n429_), .O(z13));
  oai21  g274(.a(x046), .b(x014), .c(x078), .O(new_n431_));
  inv1   g275(.a(x014), .O(new_n432_));
  inv1   g276(.a(x030), .O(new_n433_));
  nor2   g277(.a(x094), .b(x062), .O(new_n434_));
  nand2  g278(.a(new_n434_), .b(new_n433_), .O(new_n435_));
  oai21  g279(.a(new_n299_), .b(new_n432_), .c(new_n435_), .O(new_n436_));
  ...
  oai21  g286(.a(new_n442_), .b(new_n439_), .c(new_n300_), .O(new_n443_));
  ...
  nand3  g290(.a(x126), .b(new_n441_), .c(new_n299_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n303_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(new_n296_), .c(new_n448_), .O(new_n449_));
  nand4  g293(.a(new_n449_), .b(new_n445_), .c(new_n443_), .d(new_n436_), .O(new_n450_));
  nor2   g294(.a(x038), .b(new_n432_), .O(new_n451_));
  nor2   g295(.a(new_n438_), .b(x062), .O(new_n452_));
  aoi22  g296(.a(new_n452_), .b(new_n451_), .c(new_n450_), .d(new_n295_), .O(new_n453_));
  nand3  g297(.a(x086), .b(new_n296_), .c(new_n432_), .O(new_n454_));
  ...
  oai21  g301(.a(new_n457_), .b(x078), .c(new_n432_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n442_), .O(new_n459_));
  nand2  g303(.a(new_n296_), .b(x030), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n434_), .c(new_n300_), .O(new_n461_));
  ...
  oai21  g309(.a(new_n465_), .b(new_n461_), .c(new_n295_), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n459_), .c(x054), .O(new_n467_));
  oai21  g311(.a(new_n299_), .b(new_n432_), .c(x030), .O(new_n468_));
  ...
  oai21  g315(.a(new_n471_), .b(new_n467_), .c(new_n303_), .O(new_n472_));
  ...
  oai21  g321(.a(new_n477_), .b(x046), .c(new_n431_), .O(z14));
  zero   g322(.O(z17));
  zero   g323(.O(z20));
  zero   g324(.O(z21));
  zero   g325(.O(z22));
