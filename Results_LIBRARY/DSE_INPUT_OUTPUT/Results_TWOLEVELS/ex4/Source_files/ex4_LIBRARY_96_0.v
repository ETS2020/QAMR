...
module FAU ( 
  ...
  nand3  g195(.a(new_n351_), .b(x095), .c(new_n298_), .O(new_n352_));
  ...
  nand3  g319(.a(new_n475_), .b(new_n173_), .c(new_n239_), .O(new_n476_));
  ...
  aoi21  g363(.a(new_n515_), .b(x095), .c(new_n519_), .O(new_n520_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(x095), .b(x078), .O(z15));
  nor2   g372(.a(x095), .b(x078), .O(z16));
  nor2   g373(.a(x095), .b(x078), .O(z17));
  nor2   g374(.a(x095), .b(x078), .O(z18));
  nor2   g375(.a(x095), .b(x078), .O(z19));
  nor2   g376(.a(x095), .b(x078), .O(z22));
