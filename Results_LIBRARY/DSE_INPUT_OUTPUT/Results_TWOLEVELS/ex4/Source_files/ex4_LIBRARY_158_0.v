// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:23 2020
...
module FAU ( 
  ...
  nor2   g107(.a(new_n254_), .b(x013), .O(new_n264_));
  nand3  g108(.a(new_n264_), .b(new_n259_), .c(x061), .O(new_n265_));
  inv1   g109(.a(new_n265_), .O(new_n266_));
  aoi21  g110(.a(new_n263_), .b(x077), .c(new_n266_), .O(new_n267_));
  inv1   g111(.a(x085), .O(new_n268_));
  nand3  g112(.a(new_n268_), .b(x037), .c(x013), .O(new_n269_));
  oai21  g113(.a(new_n267_), .b(new_n240_), .c(new_n269_), .O(new_n270_));
  nand2  g114(.a(new_n270_), .b(new_n239_), .O(new_n271_));
  ...
  aoi21  g118(.a(new_n274_), .b(x013), .c(new_n251_), .O(new_n275_));
  inv1   g119(.a(x077), .O(new_n276_));
  inv1   g120(.a(x069), .O(new_n277_));
  nor2   g121(.a(x029), .b(new_n243_), .O(new_n278_));
  oai21  g122(.a(new_n278_), .b(new_n245_), .c(new_n277_), .O(new_n279_));
  inv1   g123(.a(new_n272_), .O(new_n280_));
  nand4  g124(.a(new_n280_), .b(new_n247_), .c(new_n244_), .d(new_n241_), .O(new_n281_));
  aoi21  g125(.a(new_n281_), .b(new_n279_), .c(new_n276_), .O(new_n282_));
  oai21  g126(.a(new_n282_), .b(new_n275_), .c(x053), .O(new_n283_));
  inv1   g127(.a(new_n245_), .O(new_n284_));
  nand2  g128(.a(new_n244_), .b(new_n241_), .O(new_n285_));
  nand2  g129(.a(new_n285_), .b(new_n284_), .O(new_n286_));
  nand3  g130(.a(new_n286_), .b(x077), .c(new_n254_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(new_n283_), .O(new_n288_));
  oai22  g132(.a(new_n276_), .b(new_n254_), .c(new_n240_), .d(new_n242_), .O(new_n289_));
  nand3  g133(.a(new_n289_), .b(new_n277_), .c(new_n243_), .O(new_n290_));
  aoi22  g134(.a(new_n276_), .b(new_n242_), .c(new_n240_), .d(new_n254_), .O(new_n291_));
  ...
  nand2  g139(.a(new_n295_), .b(new_n173_), .O(z05));
  ...
  inv1   g156(.a(x101), .O(new_n313_));
  nor2   g157(.a(new_n313_), .b(x054), .O(new_n314_));
  oai21  g158(.a(new_n314_), .b(new_n312_), .c(new_n298_), .O(new_n315_));
  inv1   g159(.a(x110), .O(new_n316_));
  inv1   g160(.a(x118), .O(new_n317_));
  inv1   g161(.a(x070), .O(new_n318_));
  aoi21  g162(.a(new_n318_), .b(new_n298_), .c(x006), .O(new_n319_));
  ...
  aoi21  g170(.a(new_n326_), .b(new_n324_), .c(new_n300_), .O(new_n327_));
  oai22  g171(.a(new_n327_), .b(new_n319_), .c(new_n317_), .d(new_n316_), .O(new_n328_));
  nand3  g172(.a(x086), .b(new_n318_), .c(new_n320_), .O(new_n329_));
  inv1   g173(.a(x102), .O(new_n330_));
  nand3  g174(.a(new_n330_), .b(x062), .c(new_n301_), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n329_), .O(new_n332_));
  nand2  g176(.a(new_n332_), .b(x038), .O(new_n333_));
  inv1   g177(.a(x014), .O(new_n334_));
  nand2  g178(.a(new_n307_), .b(new_n334_), .O(new_n335_));
  nand4  g179(.a(new_n335_), .b(new_n323_), .c(x086), .d(new_n320_), .O(new_n336_));
  nand3  g180(.a(x094), .b(x070), .c(new_n301_), .O(new_n337_));
  nand2  g181(.a(new_n337_), .b(new_n336_), .O(new_n338_));
  oai21  g182(.a(new_n302_), .b(new_n330_), .c(new_n338_), .O(new_n339_));
  oai21  g183(.a(new_n308_), .b(new_n320_), .c(new_n335_), .O(new_n340_));
  oai22  g184(.a(new_n317_), .b(new_n307_), .c(x094), .d(new_n321_), .O(new_n341_));
  nand2  g185(.a(new_n341_), .b(new_n302_), .O(new_n342_));
  nand3  g186(.a(new_n342_), .b(new_n340_), .c(x086), .O(new_n343_));
  nand3  g187(.a(new_n308_), .b(x086), .c(new_n318_), .O(new_n344_));
  inv1   g188(.a(new_n344_), .O(new_n345_));
  aoi21  g189(.a(new_n343_), .b(new_n301_), .c(new_n345_), .O(new_n346_));
  nand4  g190(.a(new_n346_), .b(new_n339_), .c(new_n333_), .d(new_n328_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(x054), .O(new_n348_));
  oai22  g192(.a(x086), .b(x006), .c(x070), .d(x022), .O(new_n349_));
  nor2   g193(.a(x070), .b(new_n298_), .O(new_n350_));
  aoi22  g194(.a(new_n350_), .b(new_n307_), .c(new_n349_), .d(x014), .O(new_n351_));
  nand2  g195(.a(new_n351_), .b(new_n348_), .O(new_n352_));
  nand3  g196(.a(new_n318_), .b(x054), .c(new_n307_), .O(new_n353_));
  nand3  g197(.a(new_n300_), .b(x038), .c(new_n301_), .O(new_n354_));
  nand3  g198(.a(new_n354_), .b(new_n353_), .c(x014), .O(new_n355_));
  nand3  g199(.a(new_n355_), .b(x101), .c(new_n299_), .O(new_n356_));
  inv1   g200(.a(new_n356_), .O(new_n357_));
  aoi21  g201(.a(new_n352_), .b(x078), .c(new_n357_), .O(new_n358_));
  aoi21  g202(.a(new_n358_), .b(new_n315_), .c(new_n297_), .O(z06));
  inv1   g203(.a(x040), .O(new_n360_));
  nand2  g204(.a(x016), .b(x008), .O(new_n361_));
  inv1   g205(.a(x056), .O(new_n362_));
  inv1   g206(.a(x088), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(new_n362_), .O(new_n364_));
  oai21  g208(.a(new_n364_), .b(x024), .c(new_n361_), .O(new_n365_));
  inv1   g209(.a(x096), .O(new_n366_));
  inv1   g210(.a(x120), .O(new_n367_));
  nand2  g211(.a(new_n367_), .b(new_n366_), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(new_n363_), .O(new_n369_));
  nor2   g213(.a(x112), .b(x104), .O(new_n370_));
  nand2  g214(.a(new_n370_), .b(new_n369_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n166_), .O(new_n372_));
  oai21  g216(.a(new_n367_), .b(x104), .c(x032), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(x112), .O(new_n374_));
  inv1   g218(.a(x104), .O(new_n375_));
  oai21  g219(.a(new_n366_), .b(x056), .c(new_n375_), .O(new_n376_));
  inv1   g220(.a(x112), .O(new_n377_));
  nand3  g221(.a(x120), .b(new_n377_), .c(new_n165_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(new_n158_), .O(new_n379_));
  aoi21  g223(.a(new_n376_), .b(new_n160_), .c(new_n379_), .O(new_n380_));
  nand4  g224(.a(new_n380_), .b(new_n374_), .c(new_n372_), .d(new_n365_), .O(new_n381_));
  nand4  g225(.a(x120), .b(new_n362_), .c(new_n160_), .d(x008), .O(new_n382_));
  inv1   g226(.a(new_n382_), .O(new_n383_));
  aoi21  g227(.a(new_n381_), .b(new_n162_), .c(new_n383_), .O(new_n384_));
  nand3  g228(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n385_));
  ...
  nand2  g234(.a(new_n390_), .b(new_n162_), .O(new_n391_));
  aoi21  g235(.a(new_n391_), .b(new_n159_), .c(new_n370_), .O(new_n392_));
  inv1   g236(.a(x024), .O(new_n393_));
  nor2   g237(.a(new_n393_), .b(x016), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n364_), .c(x064), .O(new_n395_));
  nand4  g239(.a(new_n388_), .b(new_n368_), .c(new_n361_), .d(x024), .O(new_n396_));
  aoi21  g240(.a(new_n396_), .b(new_n395_), .c(x072), .O(new_n397_));
  oai21  g241(.a(new_n397_), .b(new_n392_), .c(new_n161_), .O(new_n398_));
  nand2  g242(.a(new_n361_), .b(x024), .O(new_n399_));
  nand3  g243(.a(new_n399_), .b(new_n363_), .c(new_n362_), .O(new_n400_));
  ...
  aoi21  g250(.a(new_n402_), .b(new_n158_), .c(new_n406_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(new_n387_), .O(new_n408_));
  nand3  g252(.a(new_n408_), .b(new_n173_), .c(new_n360_), .O(new_n409_));
  inv1   g253(.a(new_n409_), .O(z08));
  inv1   g254(.a(x041), .O(new_n411_));
  oai22  g255(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n412_));
  nand3  g256(.a(new_n412_), .b(x081), .c(x001), .O(new_n413_));
  oai22  g257(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n414_));
  ...
  nand3  g270(.a(new_n426_), .b(new_n173_), .c(new_n420_), .O(new_n427_));
  ...
  nand3  g279(.a(new_n435_), .b(new_n173_), .c(new_n429_), .O(new_n436_));
  ...
  oai21  g288(.a(new_n444_), .b(x044), .c(new_n173_), .O(z12));
  nand3  g289(.a(new_n276_), .b(x069), .c(x021), .O(new_n446_));
  nand3  g290(.a(x085), .b(new_n242_), .c(x005), .O(new_n447_));
  aoi21  g291(.a(new_n447_), .b(new_n446_), .c(x037), .O(new_n448_));
  nor2   g292(.a(x117), .b(x109), .O(new_n449_));
  inv1   g293(.a(new_n449_), .O(new_n450_));
  oai21  g294(.a(x077), .b(new_n243_), .c(new_n242_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n450_), .O(new_n452_));
  nand3  g296(.a(new_n280_), .b(new_n276_), .c(x069), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(new_n452_), .c(x085), .O(new_n454_));
  nand3  g298(.a(x093), .b(new_n276_), .c(x005), .O(new_n455_));
  oai21  g299(.a(new_n277_), .b(new_n243_), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n242_), .O(new_n457_));
  nand3  g301(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n268_), .O(new_n459_));
  nand3  g303(.a(new_n459_), .b(new_n276_), .c(x005), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n457_), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n454_), .c(new_n240_), .O(new_n462_));
  nand3  g306(.a(new_n280_), .b(new_n268_), .c(new_n276_), .O(new_n463_));
  nand2  g307(.a(new_n463_), .b(new_n240_), .O(new_n464_));
  aoi22  g308(.a(new_n464_), .b(x037), .c(x077), .d(x013), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(new_n462_), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n448_), .c(new_n173_), .O(new_n467_));
  oai21  g311(.a(x061), .b(x029), .c(x005), .O(new_n468_));
  nand4  g312(.a(new_n245_), .b(x125), .c(new_n268_), .d(x029), .O(new_n469_));
  aoi21  g313(.a(new_n469_), .b(new_n468_), .c(new_n299_), .O(new_n470_));
  nand4  g314(.a(new_n245_), .b(x101), .c(new_n268_), .d(x029), .O(new_n471_));
  inv1   g315(.a(new_n471_), .O(new_n472_));
  oai21  g316(.a(new_n472_), .b(new_n470_), .c(new_n240_), .O(new_n473_));
  nand4  g317(.a(new_n268_), .b(x078), .c(x037), .d(x029), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n473_), .O(new_n475_));
  oai21  g319(.a(new_n243_), .b(new_n242_), .c(new_n475_), .O(new_n476_));
  inv1   g320(.a(x093), .O(new_n477_));
  oai22  g321(.a(new_n313_), .b(x037), .c(new_n477_), .d(new_n299_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n243_), .O(new_n479_));
  aoi21  g323(.a(x069), .b(x037), .c(new_n449_), .O(new_n480_));
  nand2  g324(.a(new_n477_), .b(new_n277_), .O(new_n481_));
  nand2  g325(.a(x117), .b(new_n249_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n481_), .c(new_n259_), .O(new_n483_));
  oai21  g327(.a(new_n483_), .b(new_n480_), .c(x078), .O(new_n484_));
  oai21  g328(.a(new_n477_), .b(x061), .c(new_n481_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(x101), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(new_n484_), .c(new_n479_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x005), .O(new_n488_));
  oai22  g332(.a(new_n449_), .b(new_n284_), .c(new_n277_), .d(x021), .O(new_n489_));
  nand4  g333(.a(new_n489_), .b(new_n268_), .c(x078), .d(x029), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n488_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n240_), .O(new_n492_));
  nor2   g336(.a(new_n259_), .b(x109), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n264_), .c(x101), .d(x005), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n492_), .c(new_n476_), .O(new_n495_));
  nand4  g339(.a(x125), .b(x078), .c(new_n257_), .d(new_n240_), .O(new_n496_));
  nor4   g340(.a(new_n496_), .b(x037), .c(new_n242_), .d(new_n239_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n276_), .c(new_n497_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n467_), .c(x045), .O(z13));
  oai21  g343(.a(new_n323_), .b(x030), .c(new_n325_), .O(new_n500_));
  aoi21  g344(.a(new_n302_), .b(new_n330_), .c(x094), .O(new_n501_));
  nand2  g345(.a(new_n317_), .b(new_n316_), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(new_n501_), .c(new_n318_), .O(new_n503_));
  oai21  g347(.a(new_n302_), .b(x110), .c(x038), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(x118), .O(new_n505_));
  oai21  g349(.a(new_n330_), .b(x062), .c(new_n316_), .O(new_n506_));
  nand3  g350(.a(x126), .b(new_n317_), .c(new_n307_), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n300_), .O(new_n508_));
  aoi21  g352(.a(new_n506_), .b(new_n298_), .c(new_n508_), .O(new_n509_));
  nand4  g353(.a(new_n509_), .b(new_n505_), .c(new_n503_), .d(new_n500_), .O(new_n510_));
  nand4  g354(.a(x126), .b(new_n321_), .c(new_n298_), .d(x014), .O(new_n511_));
  inv1   g355(.a(new_n511_), .O(new_n512_));
  aoi21  g356(.a(new_n510_), .b(new_n299_), .c(new_n512_), .O(new_n513_));
  nand3  g357(.a(x086), .b(new_n298_), .c(new_n334_), .O(new_n514_));
  oai21  g358(.a(new_n513_), .b(x054), .c(new_n514_), .O(new_n515_));
  aoi21  g359(.a(new_n308_), .b(x030), .c(x022), .O(new_n516_));
  oai21  g360(.a(new_n516_), .b(x078), .c(new_n334_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n502_), .O(new_n518_));
  nor2   g362(.a(x094), .b(x062), .O(new_n519_));
  nand2  g363(.a(x030), .b(new_n307_), .O(new_n520_));
  aoi21  g364(.a(new_n520_), .b(new_n519_), .c(new_n318_), .O(new_n521_));
  nand2  g365(.a(new_n302_), .b(new_n330_), .O(new_n522_));
  nand4  g366(.a(new_n522_), .b(new_n325_), .c(new_n308_), .d(x030), .O(new_n523_));
  inv1   g367(.a(new_n523_), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(new_n521_), .c(new_n299_), .O(new_n525_));
  aoi21  g369(.a(new_n525_), .b(new_n518_), .c(x054), .O(new_n526_));
  oai21  g370(.a(new_n326_), .b(new_n320_), .c(new_n519_), .O(new_n527_));
  nand3  g371(.a(new_n527_), .b(new_n299_), .c(x038), .O(new_n528_));
  inv1   g372(.a(new_n528_), .O(new_n529_));
  oai21  g373(.a(new_n529_), .b(new_n526_), .c(new_n300_), .O(new_n530_));
  ...
  nand3  g377(.a(new_n533_), .b(new_n532_), .c(new_n530_), .O(new_n534_));
  aoi21  g378(.a(new_n515_), .b(x006), .c(new_n534_), .O(new_n535_));
  oai21  g379(.a(new_n535_), .b(x046), .c(new_n173_), .O(z14));
  zero   g380(.O(z16));
  zero   g381(.O(z18));
  zero   g382(.O(z19));
  zero   g383(.O(z21));
  zero   g384(.O(z22));
  nor2   g385(.a(x101), .b(x078), .O(z15));
  nor2   g386(.a(x101), .b(x078), .O(z17));
  nor2   g387(.a(x101), .b(x078), .O(z20));
  nor2   g388(.a(x101), .b(x078), .O(z23));
  nor2   g389(.a(x101), .b(x078), .O(z24));
  nor2   g390(.a(x101), .b(x078), .O(z25));
  nor2   g391(.a(x101), .b(x078), .O(z26));
  nor2   g392(.a(x101), .b(x078), .O(z27));
endmodule
