// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:32 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x089), .O(new_n172_));
  nor2   g016(.a(new_n172_), .b(x077), .O(z07));
  ...
  aoi21  g084(.a(x045), .b(new_n240_), .c(x089), .O(new_n241_));
  ...
  oai21  g091(.a(new_n247_), .b(new_n244_), .c(new_n246_), .O(new_n248_));
  ...
  nand4  g109(.a(new_n261_), .b(x061), .c(x037), .d(new_n240_), .O(new_n266_));
  ...
  oai21  g114(.a(new_n268_), .b(new_n243_), .c(new_n270_), .O(new_n271_));
  nand2  g115(.a(new_n271_), .b(new_n242_), .O(new_n272_));
  ...
  nand4  g125(.a(new_n281_), .b(new_n249_), .c(new_n246_), .d(new_n244_), .O(new_n282_));
  ...
  nand2  g129(.a(new_n246_), .b(new_n244_), .O(new_n286_));
  ...
  oai22  g133(.a(new_n277_), .b(new_n256_), .c(new_n243_), .d(new_n240_), .O(new_n290_));
  nand3  g134(.a(new_n290_), .b(new_n278_), .c(new_n245_), .O(new_n291_));
  oai21  g135(.a(x053), .b(x037), .c(new_n291_), .O(new_n292_));
  aoi21  g136(.a(new_n289_), .b(x085), .c(new_n292_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(new_n272_), .O(new_n294_));
  nand2  g138(.a(new_n294_), .b(x045), .O(new_n295_));
  oai21  g139(.a(new_n241_), .b(x077), .c(new_n295_), .O(z05));
  ...
  oai22  g190(.a(new_n333_), .b(new_n313_), .c(new_n299_), .d(new_n301_), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(new_n334_), .c(new_n302_), .O(new_n348_));
  aoi22  g192(.a(new_n333_), .b(new_n301_), .c(new_n299_), .d(new_n313_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(new_n348_), .c(new_n346_), .O(new_n350_));
  aoi21  g194(.a(new_n328_), .b(new_n298_), .c(new_n350_), .O(new_n351_));
  oai21  g195(.a(new_n351_), .b(new_n297_), .c(new_n174_), .O(z06));
  nand2  g196(.a(x016), .b(x008), .O(new_n353_));
  inv1   g197(.a(x024), .O(new_n354_));
  nor2   g198(.a(x088), .b(x056), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(new_n354_), .O(new_n356_));
  nand2  g200(.a(new_n356_), .b(new_n353_), .O(new_n357_));
  nor2   g201(.a(x120), .b(x096), .O(new_n358_));
  nor2   g202(.a(x112), .b(x104), .O(new_n359_));
  oai21  g203(.a(new_n358_), .b(x088), .c(new_n359_), .O(new_n360_));
  nand2  g204(.a(new_n360_), .b(new_n166_), .O(new_n361_));
  inv1   g205(.a(x120), .O(new_n362_));
  oai21  g206(.a(new_n362_), .b(x104), .c(x032), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(x112), .O(new_n364_));
  inv1   g208(.a(x096), .O(new_n365_));
  inv1   g209(.a(x104), .O(new_n366_));
  oai21  g210(.a(new_n365_), .b(x056), .c(new_n366_), .O(new_n367_));
  inv1   g211(.a(x112), .O(new_n368_));
  nand3  g212(.a(x120), .b(new_n368_), .c(new_n165_), .O(new_n369_));
  nand2  g213(.a(new_n369_), .b(new_n158_), .O(new_n370_));
  aoi21  g214(.a(new_n367_), .b(new_n160_), .c(new_n370_), .O(new_n371_));
  nand4  g215(.a(new_n371_), .b(new_n364_), .c(new_n361_), .d(new_n357_), .O(new_n372_));
  nor2   g216(.a(x032), .b(new_n159_), .O(new_n373_));
  nor2   g217(.a(new_n362_), .b(x056), .O(new_n374_));
  ...
  inv1   g221(.a(new_n359_), .O(new_n378_));
  nand2  g222(.a(x088), .b(x056), .O(new_n379_));
  aoi21  g223(.a(new_n379_), .b(x024), .c(x016), .O(new_n380_));
  oai21  g224(.a(new_n380_), .b(x072), .c(new_n159_), .O(new_n381_));
  nand2  g225(.a(new_n381_), .b(new_n378_), .O(new_n382_));
  nand2  g226(.a(x024), .b(new_n165_), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n355_), .c(new_n166_), .O(new_n384_));
  inv1   g228(.a(new_n358_), .O(new_n385_));
  nand4  g229(.a(new_n379_), .b(new_n385_), .c(new_n353_), .d(x024), .O(new_n386_));
  inv1   g230(.a(new_n386_), .O(new_n387_));
  oai21  g231(.a(new_n387_), .b(new_n384_), .c(new_n162_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n382_), .c(x048), .O(new_n389_));
  nand2  g233(.a(new_n353_), .b(x024), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(new_n355_), .O(new_n391_));
  ...
  oai21  g260(.a(new_n416_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai21  g268(.a(new_n424_), .b(x043), .c(new_n174_), .O(z11));
  ...
  nand3  g276(.a(new_n432_), .b(new_n174_), .c(new_n426_), .O(new_n433_));
  inv1   g277(.a(new_n433_), .O(z12));
  nor2   g278(.a(new_n245_), .b(new_n240_), .O(new_n435_));
  oai21  g279(.a(new_n435_), .b(new_n244_), .c(new_n273_), .O(new_n436_));
  nand3  g280(.a(new_n436_), .b(new_n269_), .c(new_n277_), .O(new_n437_));
  aoi21  g281(.a(new_n437_), .b(new_n243_), .c(x089), .O(new_n438_));
  nor2   g282(.a(new_n277_), .b(new_n243_), .O(new_n439_));
  oai21  g283(.a(new_n439_), .b(new_n438_), .c(x037), .O(new_n440_));
  aoi21  g284(.a(new_n273_), .b(new_n244_), .c(new_n435_), .O(new_n441_));
  nor2   g285(.a(x125), .b(x101), .O(new_n442_));
  nor2   g286(.a(x117), .b(x109), .O(new_n443_));
  oai21  g287(.a(new_n442_), .b(x093), .c(new_n443_), .O(new_n444_));
  ...
  oai21  g292(.a(new_n448_), .b(x061), .c(new_n251_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n256_), .O(new_n450_));
  nor2   g294(.a(new_n261_), .b(x117), .O(new_n451_));
  aoi21  g295(.a(new_n451_), .b(new_n245_), .c(x085), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n450_), .c(new_n447_), .d(new_n445_), .O(new_n453_));
  oai21  g297(.a(new_n453_), .b(new_n441_), .c(new_n243_), .O(new_n454_));
  nand2  g298(.a(x085), .b(new_n240_), .O(new_n455_));
  aoi21  g299(.a(new_n455_), .b(new_n454_), .c(new_n242_), .O(new_n456_));
  aoi21  g300(.a(new_n247_), .b(x029), .c(x021), .O(new_n457_));
  or2    g301(.a(new_n457_), .b(new_n443_), .O(new_n458_));
  nor2   g302(.a(new_n244_), .b(x021), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(new_n281_), .c(x069), .O(new_n460_));
  inv1   g304(.a(new_n442_), .O(new_n461_));
  nor2   g305(.a(new_n435_), .b(new_n285_), .O(new_n462_));
  nand3  g306(.a(new_n462_), .b(new_n461_), .c(x029), .O(new_n463_));
  nand3  g307(.a(new_n463_), .b(new_n460_), .c(new_n458_), .O(new_n464_));
  nand3  g308(.a(new_n464_), .b(new_n269_), .c(new_n243_), .O(new_n465_));
  nand2  g309(.a(x037), .b(x013), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(x069), .c(x021), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n465_), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n456_), .c(new_n277_), .O(new_n469_));
  nand4  g313(.a(x125), .b(new_n259_), .c(new_n256_), .d(x005), .O(new_n470_));
  oai21  g314(.a(new_n443_), .b(x085), .c(new_n470_), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n243_), .c(x013), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n469_), .O(new_n473_));
  nand3  g317(.a(x069), .b(new_n243_), .c(x021), .O(new_n474_));
  nand3  g318(.a(x085), .b(new_n256_), .c(x005), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(new_n474_), .c(new_n240_), .O(new_n476_));
  and2   g320(.a(new_n476_), .b(x077), .O(new_n477_));
  aoi21  g321(.a(new_n473_), .b(new_n172_), .c(new_n477_), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n440_), .c(x045), .O(z13));
  nand2  g323(.a(x022), .b(x014), .O(new_n480_));
  oai21  g324(.a(new_n337_), .b(x030), .c(new_n480_), .O(new_n481_));
  inv1   g325(.a(x102), .O(new_n482_));
  aoi21  g326(.a(new_n318_), .b(new_n482_), .c(x094), .O(new_n483_));
  nor2   g327(.a(x118), .b(x110), .O(new_n484_));
  inv1   g328(.a(new_n484_), .O(new_n485_));
  oai21  g329(.a(new_n485_), .b(new_n483_), .c(new_n334_), .O(new_n486_));
  oai21  g330(.a(new_n318_), .b(x110), .c(x038), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x118), .O(new_n488_));
  oai21  g332(.a(new_n482_), .b(x062), .c(new_n308_), .O(new_n489_));
  nand3  g333(.a(x126), .b(new_n309_), .c(new_n302_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n326_), .O(new_n491_));
  aoi21  g335(.a(new_n489_), .b(new_n313_), .c(new_n491_), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n488_), .c(new_n486_), .d(new_n481_), .O(new_n493_));
  nand4  g337(.a(x126), .b(new_n316_), .c(new_n313_), .d(x014), .O(new_n494_));
  inv1   g338(.a(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n493_), .b(new_n333_), .c(new_n495_), .O(new_n496_));
  nand3  g340(.a(x086), .b(new_n313_), .c(new_n301_), .O(new_n497_));
  oai21  g341(.a(new_n496_), .b(x054), .c(new_n497_), .O(new_n498_));
  aoi21  g342(.a(new_n304_), .b(x030), .c(x022), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(x078), .c(new_n301_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n485_), .O(new_n501_));
  nand2  g345(.a(x030), .b(new_n302_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n329_), .c(new_n334_), .O(new_n503_));
  nand2  g347(.a(new_n318_), .b(new_n482_), .O(new_n504_));
  nand4  g348(.a(new_n504_), .b(new_n480_), .c(new_n304_), .d(x030), .O(new_n505_));
  inv1   g349(.a(new_n505_), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n503_), .c(new_n333_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n501_), .c(x054), .O(new_n508_));
  nand2  g352(.a(new_n480_), .b(x030), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n329_), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(new_n333_), .c(x038), .O(new_n511_));
  inv1   g355(.a(new_n511_), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(new_n508_), .c(new_n326_), .O(new_n513_));
  ...
  nand3  g360(.a(new_n516_), .b(new_n515_), .c(new_n513_), .O(new_n517_));
  aoi21  g361(.a(new_n498_), .b(x006), .c(new_n517_), .O(new_n518_));
  oai21  g362(.a(new_n518_), .b(x046), .c(new_n174_), .O(z14));
  zero   g363(.O(z15));
  zero   g364(.O(z16));
  zero   g365(.O(z17));
  zero   g366(.O(z20));
  ...
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(new_n172_), .b(x077), .O(z18));
  nor2   g371(.a(new_n172_), .b(x077), .O(z19));
  nor2   g372(.a(new_n172_), .b(x077), .O(z22));
  nor2   g373(.a(new_n172_), .b(x077), .O(z23));
  nor2   g374(.a(new_n172_), .b(x077), .O(z24));
  nor2   g375(.a(new_n172_), .b(x077), .O(z27));
endmodule
