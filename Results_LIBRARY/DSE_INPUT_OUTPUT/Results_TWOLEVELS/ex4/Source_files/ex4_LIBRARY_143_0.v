// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:51 2020
...
module FAU ( 
  ...
  nand2  g057(.a(new_n213_), .b(new_n208_), .O(new_n214_));
  aoi22  g058(.a(new_n212_), .b(new_n209_), .c(new_n211_), .d(new_n210_), .O(new_n215_));
  oai21  g059(.a(new_n214_), .b(x003), .c(new_n215_), .O(new_n216_));
  nand2  g060(.a(new_n216_), .b(new_n173_), .O(new_n217_));
  inv1   g061(.a(x019), .O(new_n218_));
  inv1   g062(.a(x067), .O(new_n219_));
  oai22  g063(.a(new_n212_), .b(new_n210_), .c(new_n211_), .d(new_n209_), .O(new_n220_));
  nand4  g064(.a(new_n220_), .b(x078), .c(new_n219_), .d(new_n218_), .O(new_n221_));
  aoi21  g065(.a(new_n221_), .b(new_n217_), .c(new_n207_), .O(z03));
  ...
  oai22  g132(.a(new_n275_), .b(new_n254_), .c(new_n240_), .d(new_n242_), .O(new_n289_));
  nand3  g133(.a(new_n289_), .b(new_n276_), .c(new_n243_), .O(new_n290_));
  aoi22  g134(.a(new_n275_), .b(new_n242_), .c(new_n240_), .d(new_n254_), .O(new_n291_));
  nand4  g135(.a(new_n291_), .b(new_n290_), .c(new_n288_), .d(new_n270_), .O(new_n292_));
  nand3  g136(.a(new_n292_), .b(new_n173_), .c(x045), .O(new_n293_));
  inv1   g137(.a(new_n293_), .O(z05));
  inv1   g138(.a(x014), .O(new_n295_));
  aoi21  g139(.a(x046), .b(new_n295_), .c(new_n218_), .O(new_n296_));
  ...
  nand2  g195(.a(x016), .b(x008), .O(new_n352_));
  ...
  nor2   g200(.a(x120), .b(x096), .O(new_n357_));
  nor2   g201(.a(x112), .b(x104), .O(new_n358_));
  oai21  g202(.a(new_n357_), .b(x088), .c(new_n358_), .O(new_n359_));
  nand2  g203(.a(new_n359_), .b(new_n166_), .O(new_n360_));
  inv1   g204(.a(x120), .O(new_n361_));
  oai21  g205(.a(new_n361_), .b(x104), .c(x032), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(x112), .O(new_n363_));
  inv1   g207(.a(x096), .O(new_n364_));
  inv1   g208(.a(x104), .O(new_n365_));
  oai21  g209(.a(new_n364_), .b(x056), .c(new_n365_), .O(new_n366_));
  inv1   g210(.a(x112), .O(new_n367_));
  nand3  g211(.a(x120), .b(new_n367_), .c(new_n165_), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(new_n158_), .O(new_n369_));
  aoi21  g213(.a(new_n366_), .b(new_n160_), .c(new_n369_), .O(new_n370_));
  nand4  g214(.a(new_n370_), .b(new_n363_), .c(new_n360_), .d(new_n356_), .O(new_n371_));
  nor2   g215(.a(x032), .b(new_n159_), .O(new_n372_));
  nor2   g216(.a(new_n361_), .b(x056), .O(new_n373_));
  aoi22  g217(.a(new_n373_), .b(new_n372_), .c(new_n371_), .d(new_n162_), .O(new_n374_));
  nand3  g218(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n375_));
  oai21  g219(.a(new_n374_), .b(x048), .c(new_n375_), .O(new_n376_));
  inv1   g220(.a(new_n358_), .O(new_n377_));
  ...
  aoi21  g226(.a(new_n382_), .b(new_n354_), .c(new_n166_), .O(new_n383_));
  inv1   g227(.a(new_n357_), .O(new_n384_));
  nand4  g228(.a(new_n378_), .b(new_n384_), .c(new_n352_), .d(x024), .O(new_n385_));
  inv1   g229(.a(new_n385_), .O(new_n386_));
  oai21  g230(.a(new_n386_), .b(new_n383_), .c(new_n162_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n381_), .c(x048), .O(new_n388_));
  nand2  g232(.a(new_n352_), .b(x024), .O(new_n389_));
  nand2  g233(.a(new_n389_), .b(new_n354_), .O(new_n390_));
  nand3  g234(.a(new_n390_), .b(new_n162_), .c(x032), .O(new_n391_));
  inv1   g235(.a(new_n391_), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n388_), .c(new_n158_), .O(new_n393_));
  ...
  oai21  g242(.a(new_n398_), .b(x040), .c(new_n173_), .O(z08));
  ...
  oai21  g250(.a(new_n406_), .b(x041), .c(new_n173_), .O(z09));
  ...
  nand3  g258(.a(new_n414_), .b(new_n173_), .c(new_n408_), .O(new_n415_));
  ...
  nand2  g266(.a(new_n422_), .b(new_n207_), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n173_), .O(z11));
  ...
  oai21  g275(.a(new_n431_), .b(x044), .c(new_n173_), .O(z12));
  nand2  g276(.a(x021), .b(x013), .O(new_n433_));
  oai21  g277(.a(new_n279_), .b(x029), .c(new_n433_), .O(new_n434_));
  ...
  oai21  g282(.a(new_n438_), .b(new_n436_), .c(new_n276_), .O(new_n439_));
  oai21  g283(.a(new_n259_), .b(x109), .c(x037), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(x117), .O(new_n441_));
  oai21  g285(.a(new_n435_), .b(x061), .c(new_n249_), .O(new_n442_));
  nand3  g286(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n267_), .O(new_n444_));
  aoi21  g288(.a(new_n442_), .b(new_n254_), .c(new_n444_), .O(new_n445_));
  nand4  g289(.a(new_n445_), .b(new_n441_), .c(new_n439_), .d(new_n434_), .O(new_n446_));
  nand4  g290(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n447_));
  inv1   g291(.a(new_n447_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(new_n275_), .c(new_n448_), .O(new_n449_));
  nand3  g293(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n450_));
  oai21  g294(.a(new_n449_), .b(x053), .c(new_n450_), .O(new_n451_));
  aoi21  g295(.a(new_n245_), .b(x029), .c(x021), .O(new_n452_));
  oai21  g296(.a(new_n452_), .b(x077), .c(new_n242_), .O(new_n453_));
  nand2  g297(.a(new_n453_), .b(new_n438_), .O(new_n454_));
  nand2  g298(.a(x029), .b(new_n243_), .O(new_n455_));
  aoi21  g299(.a(new_n455_), .b(new_n271_), .c(new_n276_), .O(new_n456_));
  nand2  g300(.a(new_n259_), .b(new_n435_), .O(new_n457_));
  nand4  g301(.a(new_n457_), .b(new_n433_), .c(new_n245_), .d(x029), .O(new_n458_));
  inv1   g302(.a(new_n458_), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(new_n456_), .c(new_n275_), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n454_), .c(x053), .O(new_n461_));
  ...
  aoi21  g314(.a(new_n451_), .b(x005), .c(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(x045), .c(new_n173_), .O(z13));
  nor2   g316(.a(new_n300_), .b(new_n295_), .O(new_n473_));
  oai21  g317(.a(new_n473_), .b(new_n299_), .c(new_n328_), .O(new_n474_));
  nand3  g318(.a(new_n474_), .b(new_n324_), .c(new_n332_), .O(new_n475_));
  aoi21  g319(.a(new_n475_), .b(new_n298_), .c(new_n218_), .O(new_n476_));
  nor2   g320(.a(new_n332_), .b(new_n298_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(new_n476_), .c(x038), .O(new_n478_));
  aoi21  g322(.a(new_n328_), .b(new_n299_), .c(new_n473_), .O(new_n479_));
  ...
  nand2  g326(.a(new_n482_), .b(new_n333_), .O(new_n483_));
  oai21  g327(.a(new_n316_), .b(x110), .c(x038), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(x118), .O(new_n485_));
  inv1   g329(.a(x102), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(x062), .c(new_n306_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n311_), .O(new_n488_));
  nor2   g332(.a(new_n316_), .b(x118), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n300_), .c(x086), .O(new_n490_));
  nand4  g334(.a(new_n490_), .b(new_n488_), .c(new_n485_), .d(new_n483_), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n479_), .c(new_n298_), .O(new_n492_));
  nand2  g336(.a(x086), .b(new_n295_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n492_), .c(new_n297_), .O(new_n494_));
  aoi21  g338(.a(new_n302_), .b(x030), .c(x022), .O(new_n495_));
  or2    g339(.a(new_n495_), .b(new_n481_), .O(new_n496_));
  nor2   g340(.a(new_n299_), .b(x022), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n336_), .c(x070), .O(new_n498_));
  inv1   g342(.a(new_n480_), .O(new_n499_));
  nor2   g343(.a(new_n473_), .b(new_n340_), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(x030), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n498_), .c(new_n496_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n324_), .c(new_n298_), .O(new_n503_));
  ...
  oai21  g350(.a(new_n506_), .b(new_n494_), .c(new_n332_), .O(new_n507_));
  nand4  g351(.a(x126), .b(new_n314_), .c(new_n311_), .d(x006), .O(new_n508_));
  oai21  g352(.a(new_n481_), .b(x086), .c(new_n508_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n298_), .c(x014), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n507_), .O(new_n511_));
  nand3  g355(.a(x070), .b(new_n298_), .c(x022), .O(new_n512_));
  nand3  g356(.a(x086), .b(new_n311_), .c(x006), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n512_), .c(new_n295_), .O(new_n514_));
  and2   g358(.a(new_n514_), .b(x078), .O(new_n515_));
  aoi21  g359(.a(new_n511_), .b(x019), .c(new_n515_), .O(new_n516_));
  ...
  zero   g365(.O(z22));
  zero   g366(.O(z25));
  nor2   g367(.a(x078), .b(x019), .O(z16));
  nor2   g368(.a(x078), .b(x019), .O(z18));
  nor2   g369(.a(x078), .b(x019), .O(z19));
  nor2   g370(.a(x078), .b(x019), .O(z23));
  nor2   g371(.a(x078), .b(x019), .O(z24));
  nor2   g372(.a(x078), .b(x019), .O(z26));
  nor2   g373(.a(x078), .b(x019), .O(z27));
endmodule
