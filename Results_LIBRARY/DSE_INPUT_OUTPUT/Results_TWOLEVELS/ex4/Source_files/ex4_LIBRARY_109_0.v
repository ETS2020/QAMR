// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:36 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n158_, new_n159_, new_n160_, new_n161_, new_n162_,
    ...
    new_n472_, new_n473_, new_n474_, new_n475_;
  ...
  nand4  g317(.a(new_n474_), .b(new_n473_), .c(new_n472_), .d(x078), .O(new_n475_));
  and2   g318(.a(new_n475_), .b(new_n296_), .O(z14));
  zero   g319(.O(z07));
  zero   g320(.O(z15));
  zero   g321(.O(z19));
  zero   g322(.O(z23));
  ...
  zero   g324(.O(z26));
  zero   g325(.O(z27));
  nor2   g326(.a(x078), .b(x046), .O(z17));
  nor2   g327(.a(x078), .b(x046), .O(z18));
  nor2   g328(.a(x078), .b(x046), .O(z20));
  nor2   g329(.a(x078), .b(x046), .O(z21));
  nor2   g330(.a(x078), .b(x046), .O(z22));
  nor2   g331(.a(x078), .b(x046), .O(z25));
endmodule
