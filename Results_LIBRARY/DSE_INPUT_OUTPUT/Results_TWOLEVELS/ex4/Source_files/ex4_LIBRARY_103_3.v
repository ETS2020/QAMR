...
module FAU ( 
  ...
  nand4  g218(.a(x120), .b(new_n358_), .c(new_n164_), .d(x008), .O(new_n376_));
  ...
  nand3  g226(.a(new_n360_), .b(new_n162_), .c(new_n165_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n383_), .c(new_n170_), .O(new_n385_));
  nand2  g228(.a(x088), .b(x056), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(x024), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n169_), .c(new_n364_), .O(new_n388_));
  nand2  g231(.a(new_n362_), .b(new_n158_), .O(new_n389_));
  ...
  oai21  g327(.a(x096), .b(new_n480_), .c(new_n484_), .O(new_n485_));
