...
module FAU ( 
  ...
  oai21  g246(.a(new_n403_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g316(.a(new_n306_), .b(x030), .c(new_n308_), .O(new_n474_));
  nand2  g317(.a(new_n318_), .b(new_n314_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n305_), .O(new_n476_));
  ...
  oai21  g322(.a(new_n318_), .b(x110), .c(x038), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(x118), .O(new_n481_));
  oai21  g324(.a(new_n314_), .b(x062), .c(new_n297_), .O(new_n482_));
  nand3  g325(.a(x126), .b(new_n298_), .c(new_n320_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n302_), .O(new_n484_));
  aoi21  g327(.a(new_n482_), .b(new_n299_), .c(new_n484_), .O(new_n485_));
  nand4  g328(.a(new_n485_), .b(new_n481_), .c(new_n479_), .d(new_n474_), .O(new_n486_));
  nand4  g329(.a(x126), .b(new_n304_), .c(new_n299_), .d(x014), .O(new_n487_));
  inv1   g330(.a(new_n487_), .O(new_n488_));
  aoi21  g331(.a(new_n486_), .b(new_n344_), .c(new_n488_), .O(new_n489_));
  oai22  g332(.a(new_n489_), .b(x054), .c(new_n337_), .d(x014), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x006), .O(new_n491_));
  oai21  g334(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n344_), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n319_), .c(new_n477_), .O(new_n494_));
  nor2   g337(.a(new_n303_), .b(x022), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n306_), .c(x070), .O(new_n496_));
  nand4  g339(.a(new_n475_), .b(new_n327_), .c(new_n308_), .d(x030), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n496_), .c(x078), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n494_), .c(new_n340_), .O(new_n499_));
  inv1   g342(.a(new_n306_), .O(new_n500_));
  oai21  g343(.a(new_n309_), .b(new_n303_), .c(new_n500_), .O(new_n501_));
  nand3  g344(.a(new_n501_), .b(new_n344_), .c(x038), .O(new_n502_));
  ...
  aoi21  g350(.a(new_n503_), .b(new_n302_), .c(new_n507_), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n491_), .c(x046), .O(z14));
  zero   g352(.O(z07));
  zero   g353(.O(z15));
  zero   g354(.O(z16));
  zero   g355(.O(z19));
  ...
  nor2   g363(.a(x078), .b(new_n157_), .O(z22));
