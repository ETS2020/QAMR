...
module FAU ( 
  ...
  nor2   g156(.a(x056), .b(x054), .O(new_n313_));
  ...
  nand4  g220(.a(x120), .b(new_n157_), .c(new_n163_), .d(x008), .O(new_n377_));
  ...
  nand3  g324(.a(new_n480_), .b(new_n159_), .c(new_n440_), .O(new_n481_));
