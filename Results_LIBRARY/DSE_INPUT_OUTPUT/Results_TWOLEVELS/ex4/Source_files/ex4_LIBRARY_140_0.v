...
module FAU ( 
  ...
  oai22  g199(.a(new_n356_), .b(x024), .c(new_n167_), .d(new_n161_), .O(new_n357_));
  ...
  oai21  g205(.a(new_n362_), .b(new_n360_), .c(new_n168_), .O(new_n363_));
  ...
  nand3  g211(.a(x120), .b(new_n368_), .c(new_n167_), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(new_n160_), .O(new_n370_));
  aoi21  g213(.a(new_n367_), .b(new_n162_), .c(new_n370_), .O(new_n371_));
  nand4  g214(.a(new_n371_), .b(new_n365_), .c(new_n363_), .d(new_n357_), .O(new_n372_));
  nand4  g215(.a(x120), .b(new_n354_), .c(new_n162_), .d(x008), .O(new_n373_));
  inv1   g216(.a(new_n373_), .O(new_n374_));
  aoi21  g217(.a(new_n372_), .b(new_n164_), .c(new_n374_), .O(new_n375_));
  nand3  g218(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n376_));
  oai21  g219(.a(new_n375_), .b(x048), .c(new_n376_), .O(new_n377_));
  nand3  g220(.a(new_n160_), .b(new_n163_), .c(x024), .O(new_n378_));
  nand2  g221(.a(new_n378_), .b(new_n167_), .O(new_n379_));
  nand2  g222(.a(new_n379_), .b(new_n162_), .O(new_n380_));
  nand3  g223(.a(new_n356_), .b(new_n160_), .c(new_n163_), .O(new_n381_));
  aoi21  g224(.a(new_n381_), .b(new_n380_), .c(new_n168_), .O(new_n382_));
  oai21  g225(.a(new_n355_), .b(new_n354_), .c(x024), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n167_), .c(new_n361_), .O(new_n384_));
  ...
  oai21  g231(.a(new_n388_), .b(new_n384_), .c(new_n163_), .O(new_n389_));
  ...
  oai21  g236(.a(new_n393_), .b(new_n382_), .c(new_n164_), .O(new_n394_));
  nand3  g237(.a(new_n362_), .b(new_n160_), .c(new_n163_), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n164_), .O(new_n396_));
  nand4  g239(.a(x064), .b(new_n163_), .c(x016), .d(new_n161_), .O(new_n397_));
  oai21  g240(.a(new_n163_), .b(new_n162_), .c(new_n397_), .O(new_n398_));
  ...
  oai21  g268(.a(new_n425_), .b(x043), .c(new_n158_), .O(z11));
  ...
  oai21  g276(.a(new_n433_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nand3  g318(.a(new_n475_), .b(new_n158_), .c(new_n435_), .O(new_n476_));
