// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:25 2020
...
module FAU ( 
  ...
  aoi21  g108(.a(new_n248_), .b(new_n244_), .c(x005), .O(new_n265_));
  ...
  oai22  g112(.a(new_n268_), .b(new_n258_), .c(new_n242_), .d(x013), .O(new_n269_));
  nand2  g113(.a(new_n269_), .b(new_n264_), .O(new_n270_));
  inv1   g114(.a(new_n252_), .O(new_n271_));
  ...
  nand4  g185(.a(new_n263_), .b(x118), .c(new_n172_), .d(new_n301_), .O(new_n342_));
  ...
  inv1   g194(.a(new_n331_), .O(new_n351_));
  nand4  g195(.a(new_n351_), .b(new_n308_), .c(x086), .d(new_n337_), .O(new_n352_));
  inv1   g196(.a(new_n352_), .O(new_n353_));
  oai21  g197(.a(new_n353_), .b(new_n350_), .c(x126), .O(new_n354_));
  inv1   g198(.a(x118), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(x110), .O(new_n356_));
  nand3  g200(.a(new_n356_), .b(new_n346_), .c(new_n305_), .O(new_n357_));
  nand4  g201(.a(new_n357_), .b(new_n263_), .c(new_n172_), .d(new_n301_), .O(new_n358_));
  nand3  g202(.a(new_n358_), .b(new_n354_), .c(new_n344_), .O(new_n359_));
  nand2  g203(.a(new_n359_), .b(x054), .O(new_n360_));
  oai21  g204(.a(new_n340_), .b(new_n327_), .c(new_n360_), .O(new_n361_));
  inv1   g205(.a(x062), .O(new_n362_));
  inv1   g206(.a(x014), .O(new_n363_));
  nand3  g207(.a(x038), .b(new_n363_), .c(new_n301_), .O(new_n364_));
  nor4   g208(.a(new_n364_), .b(new_n330_), .c(new_n362_), .d(new_n303_), .O(new_n365_));
  aoi21  g209(.a(new_n361_), .b(x078), .c(new_n365_), .O(new_n366_));
  aoi21  g210(.a(new_n366_), .b(new_n326_), .c(new_n300_), .O(z06));
  inv1   g211(.a(x040), .O(new_n368_));
  nand2  g212(.a(x016), .b(x008), .O(new_n369_));
  inv1   g213(.a(x056), .O(new_n370_));
  inv1   g214(.a(x088), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n370_), .O(new_n372_));
  oai21  g216(.a(new_n372_), .b(x024), .c(new_n369_), .O(new_n373_));
  nor2   g217(.a(x120), .b(x096), .O(new_n374_));
  nor2   g218(.a(x112), .b(x104), .O(new_n375_));
  oai21  g219(.a(new_n374_), .b(x088), .c(new_n375_), .O(new_n376_));
  nand2  g220(.a(new_n376_), .b(new_n166_), .O(new_n377_));
  inv1   g221(.a(x120), .O(new_n378_));
  oai21  g222(.a(new_n378_), .b(x104), .c(x032), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(x112), .O(new_n380_));
  inv1   g224(.a(x096), .O(new_n381_));
  inv1   g225(.a(x104), .O(new_n382_));
  oai21  g226(.a(new_n381_), .b(x056), .c(new_n382_), .O(new_n383_));
  inv1   g227(.a(x112), .O(new_n384_));
  nand3  g228(.a(x120), .b(new_n384_), .c(new_n165_), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n158_), .O(new_n386_));
  aoi21  g230(.a(new_n383_), .b(new_n160_), .c(new_n386_), .O(new_n387_));
  nand4  g231(.a(new_n387_), .b(new_n380_), .c(new_n377_), .d(new_n373_), .O(new_n388_));
  nand4  g232(.a(x120), .b(new_n370_), .c(new_n160_), .d(x008), .O(new_n389_));
  inv1   g233(.a(new_n389_), .O(new_n390_));
  aoi21  g234(.a(new_n388_), .b(new_n162_), .c(new_n390_), .O(new_n391_));
  nand3  g235(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n392_));
  oai21  g236(.a(new_n391_), .b(x048), .c(new_n392_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(x000), .O(new_n394_));
  nand2  g238(.a(x088), .b(x056), .O(new_n395_));
  nand2  g239(.a(new_n395_), .b(x024), .O(new_n396_));
  nand2  g240(.a(new_n396_), .b(new_n165_), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(new_n162_), .O(new_n398_));
  aoi21  g242(.a(new_n398_), .b(new_n159_), .c(new_n375_), .O(new_n399_));
  inv1   g243(.a(x024), .O(new_n400_));
  nor2   g244(.a(new_n400_), .b(x016), .O(new_n401_));
  oai21  g245(.a(new_n401_), .b(new_n372_), .c(x064), .O(new_n402_));
  inv1   g246(.a(new_n374_), .O(new_n403_));
  nand4  g247(.a(new_n395_), .b(new_n403_), .c(new_n369_), .d(x024), .O(new_n404_));
  aoi21  g248(.a(new_n404_), .b(new_n402_), .c(x072), .O(new_n405_));
  oai21  g249(.a(new_n405_), .b(new_n399_), .c(new_n161_), .O(new_n406_));
  nand2  g250(.a(new_n369_), .b(x024), .O(new_n407_));
  nand3  g251(.a(new_n407_), .b(new_n371_), .c(new_n370_), .O(new_n408_));
  nand3  g252(.a(new_n408_), .b(new_n162_), .c(x032), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(new_n406_), .O(new_n410_));
  oai22  g254(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n411_));
  nand3  g255(.a(new_n411_), .b(x064), .c(x016), .O(new_n412_));
  aoi22  g256(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n412_), .O(new_n414_));
  aoi21  g258(.a(new_n410_), .b(new_n158_), .c(new_n414_), .O(new_n415_));
  nand2  g259(.a(new_n415_), .b(new_n394_), .O(new_n416_));
  nand3  g260(.a(new_n416_), .b(new_n174_), .c(new_n368_), .O(new_n417_));
  inv1   g261(.a(new_n417_), .O(z08));
  oai22  g262(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n419_));
  nand3  g263(.a(new_n419_), .b(x081), .c(x001), .O(new_n420_));
  oai22  g264(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n421_));
  nand3  g265(.a(new_n421_), .b(x065), .c(x017), .O(new_n422_));
  ...
  oai21  g269(.a(new_n425_), .b(x041), .c(new_n174_), .O(z09));
  oai22  g270(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n427_));
  nand3  g271(.a(new_n427_), .b(x082), .c(x002), .O(new_n428_));
  oai22  g272(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n429_));
  nand3  g273(.a(new_n429_), .b(x066), .c(x018), .O(new_n430_));
  aoi22  g274(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n431_));
  nand3  g275(.a(new_n431_), .b(new_n430_), .c(new_n428_), .O(new_n432_));
  inv1   g276(.a(new_n432_), .O(new_n433_));
  oai21  g277(.a(new_n433_), .b(x042), .c(new_n174_), .O(z10));
  inv1   g278(.a(x043), .O(new_n435_));
  oai22  g279(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n436_));
  nand3  g280(.a(new_n436_), .b(x083), .c(x003), .O(new_n437_));
  oai22  g281(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n438_));
  nand3  g282(.a(new_n438_), .b(x067), .c(x019), .O(new_n439_));
  aoi22  g283(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n440_));
  nand3  g284(.a(new_n440_), .b(new_n439_), .c(new_n437_), .O(new_n441_));
  nand3  g285(.a(new_n441_), .b(new_n174_), .c(new_n435_), .O(new_n442_));
  inv1   g286(.a(new_n442_), .O(z11));
  ...
  oai21  g294(.a(new_n450_), .b(x044), .c(new_n174_), .O(z12));
  nand2  g295(.a(new_n266_), .b(new_n284_), .O(new_n452_));
  oai21  g296(.a(new_n285_), .b(new_n243_), .c(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n278_), .b(new_n276_), .c(x093), .O(new_n454_));
  inv1   g298(.a(x109), .O(new_n455_));
  nand2  g299(.a(new_n172_), .b(new_n455_), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(new_n454_), .c(new_n248_), .O(new_n457_));
  oai21  g301(.a(new_n278_), .b(x109), .c(x037), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(x117), .O(new_n459_));
  oai21  g303(.a(new_n276_), .b(x061), .c(new_n455_), .O(new_n460_));
  nand3  g304(.a(x125), .b(new_n172_), .c(new_n285_), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n242_), .O(new_n462_));
  aoi21  g306(.a(new_n460_), .b(new_n244_), .c(new_n462_), .O(new_n463_));
  nand4  g307(.a(new_n463_), .b(new_n459_), .c(new_n457_), .d(new_n453_), .O(new_n464_));
  nor2   g308(.a(x037), .b(new_n243_), .O(new_n465_));
  nor2   g309(.a(new_n278_), .b(x061), .O(new_n466_));
  aoi22  g310(.a(new_n466_), .b(new_n465_), .c(new_n464_), .d(new_n258_), .O(new_n467_));
  nand3  g311(.a(x085), .b(new_n244_), .c(new_n243_), .O(new_n468_));
  oai21  g312(.a(new_n467_), .b(x053), .c(new_n468_), .O(new_n469_));
  aoi21  g313(.a(new_n252_), .b(x029), .c(x021), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(x077), .c(new_n243_), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n456_), .O(new_n472_));
  nand2  g316(.a(x029), .b(new_n285_), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n266_), .c(new_n248_), .O(new_n474_));
  nand2  g318(.a(new_n278_), .b(new_n276_), .O(new_n475_));
  aoi22  g319(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n475_), .c(x029), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(new_n478_));
  oai21  g322(.a(new_n478_), .b(new_n474_), .c(new_n258_), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n472_), .c(x053), .O(new_n480_));
  oai21  g324(.a(new_n285_), .b(new_n243_), .c(x029), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n266_), .O(new_n482_));
  nand3  g326(.a(new_n482_), .b(new_n258_), .c(x037), .O(new_n483_));
  inv1   g327(.a(new_n483_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n480_), .c(new_n242_), .O(new_n485_));
  ...
  aoi21  g333(.a(new_n469_), .b(x005), .c(new_n489_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(x045), .c(new_n174_), .O(z13));
  oai22  g335(.a(new_n351_), .b(x030), .c(new_n319_), .d(new_n363_), .O(new_n492_));
  aoi21  g336(.a(new_n263_), .b(new_n328_), .c(x094), .O(new_n493_));
  inv1   g337(.a(x110), .O(new_n494_));
  nand2  g338(.a(new_n355_), .b(new_n494_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n493_), .c(new_n311_), .O(new_n496_));
  oai21  g340(.a(new_n263_), .b(x110), .c(x038), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(x118), .O(new_n498_));
  oai21  g342(.a(new_n328_), .b(x062), .c(new_n494_), .O(new_n499_));
  nand3  g343(.a(x126), .b(new_n355_), .c(new_n319_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n302_), .O(new_n501_));
  aoi21  g345(.a(new_n499_), .b(new_n315_), .c(new_n501_), .O(new_n502_));
  nand4  g346(.a(new_n502_), .b(new_n498_), .c(new_n496_), .d(new_n492_), .O(new_n503_));
  nand4  g347(.a(x126), .b(new_n362_), .c(new_n315_), .d(x014), .O(new_n504_));
  inv1   g348(.a(new_n504_), .O(new_n505_));
  aoi21  g349(.a(new_n503_), .b(new_n304_), .c(new_n505_), .O(new_n506_));
  nand3  g350(.a(x086), .b(new_n315_), .c(new_n363_), .O(new_n507_));
  oai21  g351(.a(new_n506_), .b(x054), .c(new_n507_), .O(new_n508_));
  aoi21  g352(.a(new_n312_), .b(x030), .c(x022), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(x078), .c(new_n363_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n495_), .O(new_n511_));
  nand2  g355(.a(x030), .b(new_n319_), .O(new_n512_));
  aoi21  g356(.a(new_n512_), .b(new_n331_), .c(new_n311_), .O(new_n513_));
  nand2  g357(.a(new_n263_), .b(new_n328_), .O(new_n514_));
  ...
  aoi21  g362(.a(new_n518_), .b(new_n511_), .c(x054), .O(new_n519_));
  oai21  g363(.a(new_n319_), .b(new_n363_), .c(x030), .O(new_n520_));
  nand2  g364(.a(new_n520_), .b(new_n331_), .O(new_n521_));
  nand3  g365(.a(new_n521_), .b(new_n304_), .c(x038), .O(new_n522_));
  inv1   g366(.a(new_n522_), .O(new_n523_));
  oai21  g367(.a(new_n523_), .b(new_n519_), .c(new_n302_), .O(new_n524_));
  oai22  g368(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n525_));
  nand3  g369(.a(new_n525_), .b(x070), .c(x022), .O(new_n526_));
  aoi22  g370(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n527_));
  nand3  g371(.a(new_n527_), .b(new_n526_), .c(new_n524_), .O(new_n528_));
  aoi21  g372(.a(new_n508_), .b(x006), .c(new_n528_), .O(new_n529_));
  oai21  g373(.a(new_n529_), .b(x046), .c(new_n174_), .O(z14));
  zero   g374(.O(z15));
  zero   g375(.O(z17));
  zero   g376(.O(z20));
  zero   g377(.O(z21));
  zero   g378(.O(z22));
  zero   g379(.O(z23));
  nor2   g380(.a(x126), .b(new_n172_), .O(z16));
  nor2   g381(.a(x126), .b(new_n172_), .O(z18));
  nor2   g382(.a(x126), .b(new_n172_), .O(z19));
  nor2   g383(.a(x126), .b(new_n172_), .O(z24));
  nor2   g384(.a(x126), .b(new_n172_), .O(z25));
  nor2   g385(.a(x126), .b(new_n172_), .O(z26));
  nor2   g386(.a(x126), .b(new_n172_), .O(z27));
endmodule
