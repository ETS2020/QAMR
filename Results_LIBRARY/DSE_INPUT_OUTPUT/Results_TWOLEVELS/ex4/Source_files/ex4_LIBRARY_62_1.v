// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:02 2020
...
module FAU ( 
  ...
  nor2   g015(.a(new_n158_), .b(x078), .O(z16));
  ...
  oai21  g138(.a(new_n294_), .b(new_n239_), .c(new_n173_), .O(z05));
  ...
  nor2   g155(.a(x080), .b(x054), .O(new_n312_));
  ...
  nand3  g195(.a(new_n351_), .b(new_n158_), .c(new_n298_), .O(new_n352_));
  ...
  oai21  g281(.a(new_n438_), .b(x044), .c(new_n173_), .O(z12));
  ...
  nand3  g320(.a(new_n477_), .b(new_n173_), .c(new_n239_), .O(new_n478_));
  ...
  aoi21  g324(.a(new_n481_), .b(new_n305_), .c(x080), .O(new_n482_));
  ...
  nor2   g347(.a(new_n323_), .b(new_n308_), .O(new_n505_));
  ...
  nand4  g355(.a(x126), .b(new_n337_), .c(new_n297_), .d(x006), .O(new_n513_));
  ...
  zero   g368(.O(z20));
  zero   g369(.O(z23));
  nor2   g370(.a(new_n158_), .b(x078), .O(z18));
  nor2   g371(.a(new_n158_), .b(x078), .O(z19));
  nor2   g372(.a(new_n158_), .b(x078), .O(z21));
  nor2   g373(.a(new_n158_), .b(x078), .O(z22));
  nor2   g374(.a(new_n158_), .b(x078), .O(z24));
  nor2   g375(.a(new_n158_), .b(x078), .O(z25));
  nor2   g376(.a(new_n158_), .b(x078), .O(z26));
  nor2   g377(.a(new_n158_), .b(x078), .O(z27));
endmodule
