...
module FAU ( 
  ...
  oai21  g260(.a(new_n417_), .b(x043), .c(new_n159_), .O(z11));
  ...
  oai21  g268(.a(new_n425_), .b(x044), .c(new_n159_), .O(z12));
  ...
  oai21  g307(.a(new_n464_), .b(x045), .c(new_n159_), .O(z13));
  inv1   g308(.a(new_n311_), .O(new_n466_));
  oai21  g309(.a(new_n307_), .b(x030), .c(new_n466_), .O(new_n467_));
  nand2  g310(.a(new_n320_), .b(new_n316_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n306_), .O(new_n469_));
  nor2   g312(.a(x118), .b(x110), .O(new_n470_));
  nand2  g313(.a(new_n470_), .b(new_n469_), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n301_), .O(new_n472_));
  oai21  g315(.a(new_n320_), .b(x110), .c(x038), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(x118), .O(new_n474_));
  oai21  g317(.a(new_n316_), .b(x062), .c(new_n298_), .O(new_n475_));
  nand3  g318(.a(x126), .b(new_n299_), .c(new_n310_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n303_), .O(new_n477_));
  aoi21  g320(.a(new_n475_), .b(new_n300_), .c(new_n477_), .O(new_n478_));
  nand4  g321(.a(new_n478_), .b(new_n474_), .c(new_n472_), .d(new_n467_), .O(new_n479_));
  nand4  g322(.a(x126), .b(new_n305_), .c(new_n300_), .d(x014), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(new_n481_));
  aoi21  g324(.a(new_n479_), .b(new_n297_), .c(new_n481_), .O(new_n482_));
  oai22  g325(.a(new_n482_), .b(x054), .c(new_n337_), .d(x014), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(x006), .O(new_n484_));
  oai21  g327(.a(new_n331_), .b(new_n304_), .c(new_n310_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n297_), .O(new_n486_));
  aoi21  g329(.a(new_n486_), .b(new_n309_), .c(new_n470_), .O(new_n487_));
  nor2   g330(.a(new_n304_), .b(x022), .O(new_n488_));
  oai21  g331(.a(new_n488_), .b(new_n307_), .c(x070), .O(new_n489_));
  nand4  g332(.a(new_n468_), .b(new_n326_), .c(new_n466_), .d(x030), .O(new_n490_));
  aoi21  g333(.a(new_n490_), .b(new_n489_), .c(x078), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n487_), .c(new_n340_), .O(new_n492_));
  inv1   g335(.a(new_n307_), .O(new_n493_));
  oai21  g336(.a(new_n311_), .b(new_n304_), .c(new_n493_), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n297_), .c(x038), .O(new_n495_));
  ...
  aoi21  g343(.a(new_n496_), .b(new_n303_), .c(new_n500_), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n484_), .c(x046), .O(z14));
  zero   g345(.O(z07));
  zero   g346(.O(z21));
  zero   g347(.O(z22));
  zero   g348(.O(z25));
  ...
  nor2   g354(.a(x078), .b(new_n157_), .O(z19));
