...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x034), .O(z16));
  ...
  nand4  g038(.a(new_n172_), .b(new_n194_), .c(x050), .d(new_n193_), .O(new_n195_));
  inv1   g039(.a(x002), .O(new_n196_));
  inv1   g040(.a(x082), .O(new_n197_));
  nand3  g041(.a(new_n197_), .b(x034), .c(new_n196_), .O(new_n198_));
  nand2  g042(.a(new_n198_), .b(new_n195_), .O(new_n199_));
  nand2  g043(.a(new_n199_), .b(x010), .O(new_n200_));
  inv1   g044(.a(x050), .O(new_n201_));
  inv1   g045(.a(x034), .O(new_n202_));
  inv1   g046(.a(x074), .O(new_n203_));
  oai21  g047(.a(x078), .b(new_n203_), .c(new_n202_), .O(new_n204_));
  nand3  g048(.a(new_n204_), .b(new_n197_), .c(new_n196_), .O(new_n205_));
  nand3  g049(.a(new_n194_), .b(x034), .c(new_n193_), .O(new_n206_));
  aoi21  g050(.a(new_n206_), .b(new_n205_), .c(new_n201_), .O(new_n207_));
  nor3   g051(.a(z16), .b(x074), .c(x010), .O(new_n208_));
  nand3  g052(.a(new_n172_), .b(new_n201_), .c(new_n202_), .O(new_n209_));
  nand4  g053(.a(x074), .b(new_n194_), .c(x034), .d(new_n193_), .O(new_n210_));
  nand2  g054(.a(new_n210_), .b(new_n209_), .O(new_n211_));
  nor3   g055(.a(new_n211_), .b(new_n208_), .c(new_n207_), .O(new_n212_));
  aoi21  g056(.a(new_n212_), .b(new_n200_), .c(new_n192_), .O(z02));
  ...
  nand3  g071(.a(new_n227_), .b(new_n174_), .c(x043), .O(new_n228_));
  ...
  nand2  g088(.a(new_n244_), .b(new_n174_), .O(z04));
  ...
  aoi21  g152(.a(new_n308_), .b(x054), .c(new_n202_), .O(new_n309_));
  ...
  and2   g201(.a(new_n357_), .b(new_n172_), .O(new_n358_));
  aoi21  g202(.a(new_n354_), .b(x034), .c(new_n358_), .O(new_n359_));
  ...
  nand2  g266(.a(new_n423_), .b(new_n192_), .O(new_n424_));
  nand2  g267(.a(new_n424_), .b(new_n174_), .O(z10));
  ...
  oai21  g325(.a(new_n482_), .b(x045), .c(new_n174_), .O(z13));
  aoi21  g326(.a(new_n302_), .b(x014), .c(new_n202_), .O(new_n484_));
  ...
  aoi21  g344(.a(new_n499_), .b(new_n172_), .c(new_n501_), .O(new_n502_));
  ...
  oai21  g355(.a(new_n512_), .b(new_n509_), .c(new_n172_), .O(new_n513_));
  ...
  oai22  g367(.a(new_n524_), .b(x046), .c(new_n484_), .d(new_n172_), .O(z14));
  zero   g368(.O(z07));
  zero   g369(.O(z15));
  zero   g370(.O(z17));
  zero   g371(.O(z18));
  ...
  zero   g376(.O(z25));
  zero   g377(.O(z26));
  nor2   g378(.a(new_n172_), .b(x034), .O(z19));
  nor2   g379(.a(new_n172_), .b(x034), .O(z23));
  nor2   g380(.a(new_n172_), .b(x034), .O(z27));
endmodule
