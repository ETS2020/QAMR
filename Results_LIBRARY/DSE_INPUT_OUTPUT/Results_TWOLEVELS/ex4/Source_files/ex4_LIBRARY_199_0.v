// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:59 2020
...
module FAU ( 
  ...
  nand3  g196(.a(new_n352_), .b(x108), .c(new_n298_), .O(new_n353_));
  ...
  inv1   g225(.a(new_n364_), .O(new_n383_));
  nand2  g226(.a(x088), .b(x056), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(x024), .c(x016), .O(new_n385_));
  oai21  g228(.a(new_n385_), .b(x072), .c(new_n161_), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(new_n383_), .O(new_n387_));
  nand2  g230(.a(x024), .b(new_n167_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n360_), .c(new_n168_), .O(new_n389_));
  inv1   g232(.a(new_n363_), .O(new_n390_));
  nand4  g233(.a(new_n384_), .b(new_n390_), .c(new_n358_), .d(x024), .O(new_n391_));
  inv1   g234(.a(new_n391_), .O(new_n392_));
  oai21  g235(.a(new_n392_), .b(new_n389_), .c(new_n164_), .O(new_n393_));
  aoi21  g236(.a(new_n393_), .b(new_n387_), .c(x048), .O(new_n394_));
  nand2  g237(.a(new_n358_), .b(x024), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n360_), .O(new_n396_));
  ...
  oai21  g255(.a(new_n412_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g263(.a(new_n420_), .b(x042), .c(new_n158_), .O(z10));
  ...
  nand2  g285(.a(new_n261_), .b(new_n442_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n246_), .O(new_n444_));
  nor2   g287(.a(x117), .b(x109), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n444_), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(new_n278_), .O(new_n447_));
  oai21  g290(.a(new_n261_), .b(x109), .c(x037), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(x117), .O(new_n449_));
  oai21  g292(.a(new_n442_), .b(x061), .c(new_n252_), .O(new_n450_));
  nand3  g293(.a(x125), .b(new_n253_), .c(new_n243_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n269_), .O(new_n452_));
  aoi21  g295(.a(new_n450_), .b(new_n257_), .c(new_n452_), .O(new_n453_));
  nand4  g296(.a(new_n453_), .b(new_n449_), .c(new_n447_), .d(new_n441_), .O(new_n454_));
  nand4  g297(.a(x125), .b(new_n245_), .c(new_n257_), .d(x013), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(new_n456_));
  aoi21  g299(.a(new_n454_), .b(new_n277_), .c(new_n456_), .O(new_n457_));
  nand3  g300(.a(x085), .b(new_n257_), .c(new_n242_), .O(new_n458_));
  oai21  g301(.a(new_n457_), .b(x053), .c(new_n458_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(x005), .O(new_n460_));
  oai21  g303(.a(new_n247_), .b(new_n241_), .c(new_n243_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n277_), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n242_), .c(new_n445_), .O(new_n463_));
  nor2   g306(.a(new_n241_), .b(x021), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n281_), .c(x069), .O(new_n465_));
  nand4  g308(.a(new_n443_), .b(new_n440_), .c(new_n248_), .d(x029), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n465_), .c(x077), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n463_), .c(new_n240_), .O(new_n468_));
  nand2  g311(.a(new_n440_), .b(x029), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n273_), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(new_n277_), .c(x037), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n468_), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n269_), .O(new_n473_));
  ...
  nand4  g319(.a(new_n476_), .b(new_n475_), .c(new_n473_), .d(new_n460_), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n158_), .c(new_n439_), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(z13));
  oai21  g322(.a(new_n324_), .b(new_n319_), .c(new_n320_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n299_), .c(new_n298_), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n305_), .c(new_n312_), .O(new_n482_));
  nor2   g325(.a(new_n298_), .b(new_n305_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n482_), .c(x038), .O(new_n484_));
  aoi21  g327(.a(new_n320_), .b(new_n319_), .c(new_n324_), .O(new_n485_));
  ...
  nand2  g331(.a(new_n488_), .b(new_n317_), .O(new_n489_));
  oai21  g332(.a(new_n301_), .b(x110), .c(x038), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x118), .O(new_n491_));
  oai21  g334(.a(new_n328_), .b(x062), .c(new_n315_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n297_), .O(new_n493_));
  nor2   g336(.a(new_n301_), .b(x118), .O(new_n494_));
  ...
  oai21  g339(.a(new_n496_), .b(new_n485_), .c(new_n305_), .O(new_n497_));
  nand2  g340(.a(x086), .b(new_n323_), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n497_), .c(new_n300_), .O(new_n499_));
  aoi21  g342(.a(new_n307_), .b(x030), .c(x022), .O(new_n500_));
  or2    g343(.a(new_n500_), .b(new_n487_), .O(new_n501_));
  nor2   g344(.a(new_n319_), .b(x022), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(new_n321_), .c(x070), .O(new_n503_));
  inv1   g346(.a(new_n486_), .O(new_n504_));
  nor2   g347(.a(new_n324_), .b(new_n308_), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n504_), .c(x030), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n503_), .c(new_n501_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n299_), .c(new_n305_), .O(new_n508_));
  ...
  oai21  g354(.a(new_n511_), .b(new_n499_), .c(new_n298_), .O(new_n512_));
  nand4  g355(.a(x126), .b(new_n338_), .c(new_n297_), .d(x006), .O(new_n513_));
  oai21  g356(.a(new_n487_), .b(x086), .c(new_n513_), .O(new_n514_));
  nand3  g357(.a(new_n514_), .b(new_n305_), .c(x014), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  nand3  g359(.a(x070), .b(new_n305_), .c(x022), .O(new_n517_));
  nand3  g360(.a(x086), .b(new_n297_), .c(x006), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(new_n517_), .c(new_n323_), .O(new_n519_));
  and2   g362(.a(new_n519_), .b(x078), .O(new_n520_));
  aoi21  g363(.a(new_n516_), .b(x108), .c(new_n520_), .O(new_n521_));
  ...
  zero   g371(.O(z22));
  zero   g372(.O(z26));
  nor2   g373(.a(x108), .b(x078), .O(z18));
  nor2   g374(.a(x108), .b(x078), .O(z23));
  nor2   g375(.a(x108), .b(x078), .O(z24));
  nor2   g376(.a(x108), .b(x078), .O(z25));
  nor2   g377(.a(x108), .b(x078), .O(z27));
endmodule
