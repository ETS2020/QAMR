// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:06 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x076), .O(z07));
  ...
  inv1   g179(.a(new_n329_), .O(new_n336_));
  nand4  g180(.a(new_n336_), .b(new_n305_), .c(new_n302_), .d(new_n299_), .O(new_n337_));
  aoi21  g181(.a(new_n337_), .b(new_n335_), .c(new_n172_), .O(new_n338_));
  oai21  g182(.a(new_n338_), .b(new_n332_), .c(x054), .O(new_n339_));
  ...
  oai22  g188(.a(new_n172_), .b(new_n312_), .c(new_n298_), .d(new_n300_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n333_), .c(new_n301_), .O(new_n346_));
  aoi22  g190(.a(new_n172_), .b(new_n300_), .c(new_n298_), .d(new_n312_), .O(new_n347_));
  ...
  oai21  g241(.a(new_n397_), .b(x040), .c(new_n174_), .O(z08));
  ...
  oai21  g274(.a(new_n430_), .b(x044), .c(new_n174_), .O(z12));
  inv1   g275(.a(x045), .O(new_n432_));
  nand2  g276(.a(x021), .b(x013), .O(new_n433_));
  oai21  g277(.a(new_n280_), .b(x029), .c(new_n433_), .O(new_n434_));
  nor2   g278(.a(x125), .b(x101), .O(new_n435_));
  nor2   g279(.a(x117), .b(x109), .O(new_n436_));
  oai21  g280(.a(new_n435_), .b(x093), .c(new_n436_), .O(new_n437_));
  nand2  g281(.a(new_n437_), .b(new_n277_), .O(new_n438_));
  oai21  g282(.a(new_n260_), .b(x109), .c(x037), .O(new_n439_));
  nand2  g283(.a(new_n439_), .b(x117), .O(new_n440_));
  inv1   g284(.a(x101), .O(new_n441_));
  oai21  g285(.a(new_n441_), .b(x061), .c(new_n250_), .O(new_n442_));
  nand3  g286(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n268_), .O(new_n444_));
  aoi21  g288(.a(new_n442_), .b(new_n255_), .c(new_n444_), .O(new_n445_));
  nand4  g289(.a(new_n445_), .b(new_n440_), .c(new_n438_), .d(new_n434_), .O(new_n446_));
  nand4  g290(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n447_));
  inv1   g291(.a(new_n447_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(new_n276_), .c(new_n448_), .O(new_n449_));
  nand3  g293(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n450_));
  oai21  g294(.a(new_n449_), .b(x053), .c(new_n450_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(x005), .O(new_n452_));
  nand2  g296(.a(new_n246_), .b(x029), .O(new_n453_));
  nand2  g297(.a(new_n453_), .b(new_n244_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n276_), .O(new_n455_));
  aoi21  g299(.a(new_n455_), .b(new_n243_), .c(new_n436_), .O(new_n456_));
  nor2   g300(.a(new_n242_), .b(x021), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(new_n280_), .c(x069), .O(new_n458_));
  inv1   g302(.a(new_n435_), .O(new_n459_));
  nand4  g303(.a(new_n459_), .b(new_n433_), .c(new_n246_), .d(x029), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n458_), .c(x077), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n456_), .c(new_n241_), .O(new_n462_));
  nand2  g306(.a(new_n433_), .b(x029), .O(new_n463_));
  nand2  g307(.a(new_n463_), .b(new_n272_), .O(new_n464_));
  nand3  g308(.a(new_n464_), .b(new_n276_), .c(x037), .O(new_n465_));
  ...
  aoi21  g314(.a(new_n466_), .b(new_n268_), .c(new_n470_), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n452_), .O(new_n472_));
  nand3  g316(.a(new_n472_), .b(new_n174_), .c(new_n432_), .O(new_n473_));
  inv1   g317(.a(new_n473_), .O(z13));
  oai21  g318(.a(x046), .b(new_n300_), .c(x076), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(x078), .O(new_n476_));
  oai22  g320(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n477_));
  inv1   g321(.a(x102), .O(new_n478_));
  aoi21  g322(.a(new_n317_), .b(new_n478_), .c(x094), .O(new_n479_));
  nand2  g323(.a(new_n308_), .b(new_n307_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n479_), .c(new_n333_), .O(new_n481_));
  oai21  g325(.a(new_n317_), .b(x110), .c(x038), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x118), .O(new_n483_));
  oai21  g327(.a(new_n478_), .b(x062), .c(new_n307_), .O(new_n484_));
  nand3  g328(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n325_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n312_), .c(new_n486_), .O(new_n487_));
  nand4  g331(.a(new_n487_), .b(new_n483_), .c(new_n481_), .d(new_n477_), .O(new_n488_));
  nand4  g332(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n489_));
  inv1   g333(.a(new_n489_), .O(new_n490_));
  aoi21  g334(.a(new_n488_), .b(new_n172_), .c(new_n490_), .O(new_n491_));
  nand3  g335(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n492_));
  oai21  g336(.a(new_n491_), .b(x054), .c(new_n492_), .O(new_n493_));
  aoi21  g337(.a(new_n303_), .b(x030), .c(x022), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(x078), .c(new_n300_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n480_), .O(new_n496_));
  nand2  g340(.a(x030), .b(new_n301_), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n329_), .c(new_n333_), .O(new_n498_));
  nand2  g342(.a(new_n317_), .b(new_n478_), .O(new_n499_));
  aoi22  g343(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(x030), .O(new_n501_));
  inv1   g345(.a(new_n501_), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(new_n498_), .c(new_n172_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n496_), .c(x054), .O(new_n504_));
  oai21  g348(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n329_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n172_), .c(x038), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n504_), .c(new_n325_), .O(new_n509_));
  oai22  g353(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(x070), .c(x022), .O(new_n511_));
  nand2  g355(.a(x054), .b(x038), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n511_), .c(new_n509_), .O(new_n513_));
  aoi21  g357(.a(new_n493_), .b(x006), .c(new_n513_), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(x046), .c(new_n476_), .O(z14));
  zero   g359(.O(z18));
  zero   g360(.O(z19));
  zero   g361(.O(z20));
  zero   g362(.O(z23));
  zero   g363(.O(z26));
  nor2   g364(.a(new_n172_), .b(x076), .O(z15));
  nor2   g365(.a(new_n172_), .b(x076), .O(z16));
  nor2   g366(.a(new_n172_), .b(x076), .O(z17));
  nor2   g367(.a(new_n172_), .b(x076), .O(z21));
  nor2   g368(.a(new_n172_), .b(x076), .O(z22));
  nor2   g369(.a(new_n172_), .b(x076), .O(z24));
  nor2   g370(.a(new_n172_), .b(x076), .O(z25));
  nor2   g371(.a(new_n172_), .b(x076), .O(z27));
endmodule
