// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:00 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x012), .O(z15));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(new_n226_), .O(new_n304_));
  ...
  aoi21  g197(.a(new_n349_), .b(x012), .c(new_n353_), .O(new_n354_));
  ...
  oai21  g215(.a(new_n363_), .b(x056), .c(new_n372_), .O(new_n373_));
  inv1   g216(.a(x112), .O(new_n374_));
  nand3  g217(.a(x120), .b(new_n374_), .c(new_n168_), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n161_), .O(new_n376_));
  aoi21  g219(.a(new_n373_), .b(new_n163_), .c(new_n376_), .O(new_n377_));
  nand4  g220(.a(new_n377_), .b(new_n371_), .c(new_n369_), .d(new_n362_), .O(new_n378_));
  nand4  g221(.a(x120), .b(new_n359_), .c(new_n163_), .d(x008), .O(new_n379_));
  inv1   g222(.a(new_n379_), .O(new_n380_));
  aoi21  g223(.a(new_n378_), .b(new_n165_), .c(new_n380_), .O(new_n381_));
  nand3  g224(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n382_));
  oai21  g225(.a(new_n381_), .b(x048), .c(new_n382_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(x000), .O(new_n384_));
  nand2  g227(.a(x088), .b(x056), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(x024), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(new_n168_), .O(new_n387_));
  nand2  g230(.a(new_n387_), .b(new_n165_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n162_), .c(new_n367_), .O(new_n389_));
  inv1   g232(.a(x024), .O(new_n390_));
  nor2   g233(.a(new_n390_), .b(x016), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n361_), .c(x064), .O(new_n392_));
  nand4  g235(.a(new_n385_), .b(new_n365_), .c(new_n358_), .d(x024), .O(new_n393_));
  aoi21  g236(.a(new_n393_), .b(new_n392_), .c(x072), .O(new_n394_));
  oai21  g237(.a(new_n394_), .b(new_n389_), .c(new_n164_), .O(new_n395_));
  ...
  nand2  g242(.a(new_n399_), .b(new_n161_), .O(new_n400_));
  oai22  g243(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n401_));
  nand3  g244(.a(new_n401_), .b(x064), .c(x016), .O(new_n402_));
  aoi22  g245(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n403_));
  nand4  g246(.a(new_n403_), .b(new_n402_), .c(new_n400_), .d(new_n384_), .O(new_n404_));
  nand3  g247(.a(new_n404_), .b(new_n159_), .c(new_n357_), .O(new_n405_));
  ...
  oai21  g256(.a(new_n413_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g264(.a(new_n421_), .b(x042), .c(new_n159_), .O(z10));
  oai22  g265(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n423_));
  nand3  g266(.a(new_n423_), .b(x083), .c(x003), .O(new_n424_));
  oai22  g267(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n425_));
  nand3  g268(.a(new_n425_), .b(x067), .c(x019), .O(new_n426_));
  aoi22  g269(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(new_n426_), .c(new_n424_), .O(new_n428_));
  inv1   g271(.a(new_n428_), .O(new_n429_));
  oai21  g272(.a(new_n429_), .b(x043), .c(new_n159_), .O(z11));
  oai22  g273(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n431_));
  nand3  g274(.a(new_n431_), .b(x084), .c(x004), .O(new_n432_));
  nand2  g275(.a(new_n228_), .b(new_n226_), .O(new_n433_));
  oai21  g276(.a(x076), .b(new_n228_), .c(new_n433_), .O(new_n434_));
  nand3  g277(.a(new_n434_), .b(x068), .c(x020), .O(new_n435_));
  nand2  g278(.a(x052), .b(x036), .O(new_n436_));
  nand3  g279(.a(new_n436_), .b(new_n435_), .c(new_n432_), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n157_), .O(new_n438_));
  nand3  g281(.a(x068), .b(new_n227_), .c(x020), .O(new_n439_));
  nand3  g282(.a(x084), .b(new_n228_), .c(x004), .O(new_n440_));
  nand4  g283(.a(new_n440_), .b(new_n439_), .c(new_n436_), .d(new_n229_), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(x012), .O(new_n442_));
  aoi21  g285(.a(new_n442_), .b(new_n438_), .c(x044), .O(z12));
  inv1   g286(.a(x045), .O(new_n444_));
  nand2  g287(.a(x021), .b(x013), .O(new_n445_));
  oai21  g288(.a(new_n282_), .b(x029), .c(new_n445_), .O(new_n446_));
  inv1   g289(.a(x101), .O(new_n447_));
  nand2  g290(.a(new_n262_), .b(new_n447_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n247_), .O(new_n449_));
  nor2   g292(.a(x117), .b(x109), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n449_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n279_), .O(new_n452_));
  oai21  g295(.a(new_n262_), .b(x109), .c(x037), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(x117), .O(new_n454_));
  oai21  g297(.a(new_n447_), .b(x061), .c(new_n253_), .O(new_n455_));
  nand3  g298(.a(x125), .b(new_n254_), .c(new_n244_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n270_), .O(new_n457_));
  aoi21  g300(.a(new_n455_), .b(new_n258_), .c(new_n457_), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n454_), .c(new_n452_), .d(new_n446_), .O(new_n459_));
  nand4  g302(.a(x125), .b(new_n246_), .c(new_n258_), .d(x013), .O(new_n460_));
  inv1   g303(.a(new_n460_), .O(new_n461_));
  aoi21  g304(.a(new_n459_), .b(new_n278_), .c(new_n461_), .O(new_n462_));
  nand3  g305(.a(x085), .b(new_n258_), .c(new_n243_), .O(new_n463_));
  oai21  g306(.a(new_n462_), .b(x053), .c(new_n463_), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x005), .O(new_n465_));
  oai21  g308(.a(new_n248_), .b(new_n242_), .c(new_n244_), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n278_), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n243_), .c(new_n450_), .O(new_n468_));
  nor2   g311(.a(new_n242_), .b(x021), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n282_), .c(x069), .O(new_n470_));
  nand4  g313(.a(new_n448_), .b(new_n445_), .c(new_n249_), .d(x029), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n470_), .c(x077), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(new_n468_), .c(new_n241_), .O(new_n473_));
  nand2  g316(.a(new_n445_), .b(x029), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(new_n274_), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n278_), .c(x037), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n473_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n270_), .O(new_n478_));
  ...
  nand4  g324(.a(new_n481_), .b(new_n480_), .c(new_n478_), .d(new_n465_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n159_), .c(new_n444_), .O(new_n483_));
  inv1   g326(.a(new_n483_), .O(z13));
  nand3  g327(.a(x126), .b(new_n314_), .c(x006), .O(new_n485_));
  oai21  g328(.a(x086), .b(new_n334_), .c(new_n485_), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(new_n339_), .O(new_n487_));
  oai21  g330(.a(new_n334_), .b(x022), .c(new_n327_), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n320_), .c(x054), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n487_), .c(x078), .O(new_n490_));
  inv1   g333(.a(x054), .O(new_n491_));
  nor2   g334(.a(new_n491_), .b(new_n226_), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n490_), .c(x038), .O(new_n493_));
  nand3  g336(.a(x070), .b(new_n491_), .c(x022), .O(new_n494_));
  nand3  g337(.a(x086), .b(new_n298_), .c(x006), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(new_n494_), .c(new_n339_), .O(new_n496_));
  nand3  g339(.a(new_n496_), .b(x078), .c(x012), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  oai21  g341(.a(new_n330_), .b(new_n298_), .c(x006), .O(new_n499_));
  oai21  g342(.a(new_n301_), .b(new_n334_), .c(new_n299_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n320_), .O(new_n501_));
  aoi22  g344(.a(new_n501_), .b(new_n499_), .c(new_n313_), .d(new_n314_), .O(new_n502_));
  nand3  g345(.a(new_n320_), .b(x070), .c(x030), .O(new_n503_));
  nand3  g346(.a(x102), .b(new_n317_), .c(x006), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n503_), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n298_), .O(new_n506_));
  nand2  g349(.a(x022), .b(x014), .O(new_n507_));
  aoi22  g350(.a(new_n507_), .b(x006), .c(new_n320_), .d(x070), .O(new_n508_));
  or2    g351(.a(new_n508_), .b(new_n327_), .O(new_n509_));
  nand4  g352(.a(new_n507_), .b(new_n300_), .c(new_n320_), .d(x030), .O(new_n510_));
  inv1   g353(.a(x094), .O(new_n511_));
  nand3  g354(.a(new_n511_), .b(new_n330_), .c(x006), .O(new_n512_));
  nand2  g355(.a(new_n512_), .b(new_n510_), .O(new_n513_));
  oai21  g356(.a(x126), .b(x102), .c(new_n513_), .O(new_n514_));
  nand2  g357(.a(x126), .b(new_n313_), .O(new_n515_));
  aoi21  g358(.a(new_n515_), .b(new_n334_), .c(x022), .O(new_n516_));
  nand2  g359(.a(x030), .b(new_n339_), .O(new_n517_));
  nand3  g360(.a(x126), .b(x094), .c(new_n317_), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(new_n517_), .c(new_n320_), .O(new_n519_));
  oai21  g362(.a(new_n519_), .b(new_n516_), .c(x006), .O(new_n520_));
  nand4  g363(.a(new_n520_), .b(new_n514_), .c(new_n509_), .d(new_n506_), .O(new_n521_));
  oai21  g364(.a(new_n521_), .b(new_n502_), .c(new_n491_), .O(new_n522_));
  oai22  g365(.a(new_n320_), .b(new_n344_), .c(new_n330_), .d(new_n331_), .O(new_n523_));
  nor2   g366(.a(new_n330_), .b(x038), .O(new_n524_));
  aoi22  g367(.a(new_n524_), .b(x022), .c(new_n523_), .d(new_n339_), .O(new_n525_));
  nand2  g368(.a(new_n525_), .b(new_n522_), .O(new_n526_));
  aoi21  g369(.a(new_n526_), .b(new_n157_), .c(new_n498_), .O(new_n527_));
  aoi21  g370(.a(new_n527_), .b(new_n493_), .c(x046), .O(z14));
  zero   g371(.O(z07));
  zero   g372(.O(z16));
  zero   g373(.O(z19));
  zero   g374(.O(z23));
  zero   g375(.O(z24));
  nor2   g376(.a(new_n157_), .b(x012), .O(z17));
  nor2   g377(.a(new_n157_), .b(x012), .O(z18));
  nor2   g378(.a(new_n157_), .b(x012), .O(z20));
  nor2   g379(.a(new_n157_), .b(x012), .O(z21));
  nor2   g380(.a(new_n157_), .b(x012), .O(z22));
  nor2   g381(.a(new_n157_), .b(x012), .O(z25));
  nor2   g382(.a(new_n157_), .b(x012), .O(z26));
  nor2   g383(.a(new_n157_), .b(x012), .O(z27));
endmodule
