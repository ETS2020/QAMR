// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:17 2020
...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x096), .O(new_n304_));
  ...
  nand3  g199(.a(new_n162_), .b(x064), .c(x016), .O(new_n356_));
  nand3  g200(.a(x080), .b(new_n159_), .c(x000), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n356_), .c(x032), .O(new_n358_));
  nor2   g202(.a(x112), .b(x104), .O(new_n359_));
  inv1   g203(.a(new_n359_), .O(new_n360_));
  oai21  g204(.a(x072), .b(new_n165_), .c(new_n159_), .O(new_n361_));
  ...
  nand3  g209(.a(new_n365_), .b(new_n162_), .c(x064), .O(new_n366_));
  aoi21  g210(.a(new_n366_), .b(new_n362_), .c(x080), .O(new_n367_));
  nand3  g211(.a(x088), .b(new_n162_), .c(x000), .O(new_n368_));
  oai21  g212(.a(new_n166_), .b(new_n165_), .c(new_n368_), .O(new_n369_));
  nand2  g213(.a(new_n369_), .b(new_n159_), .O(new_n370_));
  ...
  nand3  g217(.a(new_n373_), .b(new_n162_), .c(x000), .O(new_n374_));
  nand2  g218(.a(new_n374_), .b(new_n370_), .O(new_n375_));
  oai21  g219(.a(new_n375_), .b(new_n367_), .c(new_n161_), .O(new_n376_));
  nand3  g220(.a(new_n365_), .b(new_n158_), .c(new_n162_), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n161_), .O(new_n378_));
  aoi22  g222(.a(new_n378_), .b(x032), .c(x072), .d(x008), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(new_n376_), .O(new_n380_));
  oai21  g224(.a(new_n380_), .b(new_n358_), .c(new_n175_), .O(new_n381_));
  oai21  g225(.a(x056), .b(x024), .c(x000), .O(new_n382_));
  nand2  g226(.a(x088), .b(x056), .O(new_n383_));
  nand4  g227(.a(new_n383_), .b(x120), .c(new_n158_), .d(x024), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n382_), .c(x096), .O(new_n385_));
  inv1   g229(.a(x024), .O(new_n386_));
  nand4  g230(.a(new_n383_), .b(x096), .c(new_n158_), .d(new_n172_), .O(new_n387_));
  nor2   g231(.a(new_n387_), .b(new_n386_), .O(new_n388_));
  oai21  g232(.a(new_n388_), .b(new_n385_), .c(new_n161_), .O(new_n389_));
  nand4  g233(.a(new_n173_), .b(new_n158_), .c(x032), .d(x024), .O(new_n390_));
  nand2  g234(.a(new_n390_), .b(new_n389_), .O(new_n391_));
  oai21  g235(.a(new_n165_), .b(new_n159_), .c(new_n391_), .O(new_n392_));
  nand3  g236(.a(x096), .b(new_n172_), .c(new_n160_), .O(new_n393_));
  oai21  g237(.a(x096), .b(new_n364_), .c(new_n393_), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(new_n165_), .O(new_n395_));
  aoi21  g239(.a(x064), .b(x032), .c(new_n359_), .O(new_n396_));
  inv1   g240(.a(x120), .O(new_n397_));
  nand2  g241(.a(new_n364_), .b(new_n166_), .O(new_n398_));
  inv1   g242(.a(x104), .O(new_n399_));
  nand2  g243(.a(x112), .b(new_n399_), .O(new_n400_));
  aoi21  g244(.a(new_n400_), .b(new_n398_), .c(new_n397_), .O(new_n401_));
  oai21  g245(.a(new_n401_), .b(new_n396_), .c(new_n173_), .O(new_n402_));
  oai21  g246(.a(new_n364_), .b(x056), .c(new_n398_), .O(new_n403_));
  nand3  g247(.a(new_n403_), .b(x096), .c(new_n172_), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(new_n402_), .c(new_n395_), .O(new_n405_));
  nand2  g249(.a(new_n405_), .b(x000), .O(new_n406_));
  nand2  g250(.a(new_n383_), .b(new_n360_), .O(new_n407_));
  oai21  g251(.a(new_n166_), .b(x016), .c(new_n407_), .O(new_n408_));
  nand4  g252(.a(new_n408_), .b(new_n173_), .c(new_n158_), .d(x024), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(new_n406_), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(new_n161_), .O(new_n411_));
  nor2   g255(.a(new_n160_), .b(x008), .O(new_n412_));
  nor2   g256(.a(new_n397_), .b(x104), .O(new_n413_));
  nand4  g257(.a(new_n413_), .b(new_n412_), .c(new_n172_), .d(x000), .O(new_n414_));
  nand3  g258(.a(new_n414_), .b(new_n411_), .c(new_n392_), .O(new_n415_));
  nand4  g259(.a(x120), .b(new_n173_), .c(new_n363_), .d(new_n161_), .O(new_n416_));
  nor4   g260(.a(new_n416_), .b(x032), .c(new_n159_), .d(new_n157_), .O(new_n417_));
  aoi21  g261(.a(new_n415_), .b(new_n162_), .c(new_n417_), .O(new_n418_));
  aoi21  g262(.a(new_n418_), .b(new_n381_), .c(x040), .O(z08));
  ...
  nand3  g270(.a(new_n426_), .b(new_n175_), .c(new_n420_), .O(new_n427_));
  inv1   g271(.a(new_n427_), .O(z09));
  inv1   g272(.a(x042), .O(new_n429_));
  ...
  nand3  g279(.a(new_n435_), .b(new_n175_), .c(new_n429_), .O(new_n436_));
  inv1   g280(.a(new_n436_), .O(z10));
  ...
  nand3  g288(.a(new_n444_), .b(new_n175_), .c(new_n438_), .O(new_n445_));
  ...
  oai21  g297(.a(new_n453_), .b(x044), .c(new_n175_), .O(z12));
  nand2  g298(.a(x021), .b(x013), .O(new_n455_));
  oai21  g299(.a(new_n281_), .b(x029), .c(new_n455_), .O(new_n456_));
  inv1   g300(.a(x101), .O(new_n457_));
  aoi21  g301(.a(new_n262_), .b(new_n457_), .c(x093), .O(new_n458_));
  nor2   g302(.a(x117), .b(x109), .O(new_n459_));
  inv1   g303(.a(new_n459_), .O(new_n460_));
  oai21  g304(.a(new_n460_), .b(new_n458_), .c(new_n278_), .O(new_n461_));
  oai21  g305(.a(new_n262_), .b(x109), .c(x037), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(x117), .O(new_n463_));
  oai21  g307(.a(new_n457_), .b(x061), .c(new_n252_), .O(new_n464_));
  nand3  g308(.a(x125), .b(new_n253_), .c(new_n246_), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(new_n270_), .O(new_n466_));
  aoi21  g310(.a(new_n464_), .b(new_n257_), .c(new_n466_), .O(new_n467_));
  nand4  g311(.a(new_n467_), .b(new_n463_), .c(new_n461_), .d(new_n456_), .O(new_n468_));
  nand4  g312(.a(x125), .b(new_n260_), .c(new_n257_), .d(x013), .O(new_n469_));
  inv1   g313(.a(new_n469_), .O(new_n470_));
  aoi21  g314(.a(new_n468_), .b(new_n277_), .c(new_n470_), .O(new_n471_));
  nand3  g315(.a(x085), .b(new_n257_), .c(new_n245_), .O(new_n472_));
  oai21  g316(.a(new_n471_), .b(x053), .c(new_n472_), .O(new_n473_));
  aoi21  g317(.a(new_n248_), .b(x029), .c(x021), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(x077), .c(new_n245_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n460_), .O(new_n476_));
  nand2  g320(.a(x029), .b(new_n246_), .O(new_n477_));
  aoi21  g321(.a(new_n477_), .b(new_n273_), .c(new_n278_), .O(new_n478_));
  nand2  g322(.a(new_n262_), .b(new_n457_), .O(new_n479_));
  nand4  g323(.a(new_n479_), .b(new_n455_), .c(new_n248_), .d(x029), .O(new_n480_));
  inv1   g324(.a(new_n480_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n478_), .c(new_n277_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n476_), .c(x053), .O(new_n483_));
  nand2  g327(.a(new_n455_), .b(x029), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n273_), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(new_n277_), .c(x037), .O(new_n486_));
  inv1   g330(.a(new_n486_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n483_), .c(new_n270_), .O(new_n488_));
  ...
  aoi21  g336(.a(new_n473_), .b(x005), .c(new_n492_), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(x045), .c(new_n175_), .O(z13));
  aoi21  g338(.a(new_n297_), .b(x014), .c(x096), .O(new_n495_));
  ...
  zero   g386(.O(z23));
  zero   g387(.O(z24));
  nor2   g388(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g389(.a(new_n173_), .b(new_n172_), .O(z19));
