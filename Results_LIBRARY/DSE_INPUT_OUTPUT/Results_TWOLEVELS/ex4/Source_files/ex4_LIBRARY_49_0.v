// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:33 2020
...
module FAU ( 
  ...
  inv1   g280(.a(x045), .O(new_n438_));
  nand2  g281(.a(x021), .b(x013), .O(new_n439_));
  oai21  g282(.a(new_n279_), .b(x029), .c(new_n439_), .O(new_n440_));
  nor2   g283(.a(x125), .b(x101), .O(new_n441_));
  nor2   g284(.a(x117), .b(x109), .O(new_n442_));
  oai21  g285(.a(new_n441_), .b(x093), .c(new_n442_), .O(new_n443_));
  ...
  oai21  g290(.a(new_n447_), .b(x061), .c(new_n249_), .O(new_n448_));
  nand3  g291(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n267_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n254_), .c(new_n450_), .O(new_n451_));
  nand4  g294(.a(new_n451_), .b(new_n446_), .c(new_n444_), .d(new_n440_), .O(new_n452_));
  nand4  g295(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n275_), .c(new_n454_), .O(new_n455_));
  nand3  g298(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n456_));
  oai21  g299(.a(new_n455_), .b(x053), .c(new_n456_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(x005), .O(new_n458_));
  nand2  g301(.a(new_n245_), .b(x029), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n243_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n275_), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n242_), .c(new_n442_), .O(new_n462_));
  nor2   g305(.a(new_n241_), .b(x021), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n279_), .c(x069), .O(new_n464_));
  inv1   g307(.a(new_n441_), .O(new_n465_));
  nand4  g308(.a(new_n465_), .b(new_n439_), .c(new_n245_), .d(x029), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n464_), .c(x077), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n462_), .c(new_n240_), .O(new_n468_));
  nand2  g311(.a(new_n439_), .b(x029), .O(new_n469_));
  ...
  aoi21  g319(.a(new_n472_), .b(new_n267_), .c(new_n476_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n458_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n173_), .c(new_n438_), .O(new_n479_));
  inv1   g322(.a(new_n479_), .O(z13));
  oai22  g323(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n481_));
  inv1   g324(.a(x102), .O(new_n482_));
  aoi21  g325(.a(new_n316_), .b(new_n482_), .c(x094), .O(new_n483_));
  nand2  g326(.a(new_n307_), .b(new_n306_), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n483_), .c(new_n333_), .O(new_n485_));
  oai21  g328(.a(new_n316_), .b(x110), .c(x038), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x118), .O(new_n487_));
  oai21  g330(.a(new_n482_), .b(x062), .c(new_n306_), .O(new_n488_));
  nand3  g331(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n324_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n311_), .c(new_n490_), .O(new_n491_));
  nand4  g334(.a(new_n491_), .b(new_n487_), .c(new_n485_), .d(new_n481_), .O(new_n492_));
  nand4  g335(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n493_));
  inv1   g336(.a(new_n493_), .O(new_n494_));
  aoi21  g337(.a(new_n492_), .b(new_n332_), .c(new_n494_), .O(new_n495_));
  nand3  g338(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n496_));
  oai21  g339(.a(new_n495_), .b(x054), .c(new_n496_), .O(new_n497_));
  aoi21  g340(.a(new_n302_), .b(x030), .c(x022), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(x078), .c(new_n299_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n484_), .O(new_n500_));
  nand2  g343(.a(x030), .b(new_n300_), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n328_), .c(new_n333_), .O(new_n502_));
  nand2  g345(.a(new_n316_), .b(new_n482_), .O(new_n503_));
  aoi22  g346(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n504_));
  nand3  g347(.a(new_n504_), .b(new_n503_), .c(x030), .O(new_n505_));
  inv1   g348(.a(new_n505_), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(new_n502_), .c(new_n332_), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n500_), .c(x054), .O(new_n508_));
  oai21  g351(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n328_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n332_), .c(x038), .O(new_n511_));
  inv1   g354(.a(new_n511_), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(new_n508_), .c(new_n324_), .O(new_n513_));
  oai22  g356(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n514_));
  nand3  g357(.a(new_n514_), .b(x070), .c(x022), .O(new_n515_));
  aoi22  g358(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n516_));
  nand3  g359(.a(new_n516_), .b(new_n515_), .c(new_n513_), .O(new_n517_));
  aoi21  g360(.a(new_n497_), .b(x006), .c(new_n517_), .O(new_n518_));
  oai21  g361(.a(new_n518_), .b(x046), .c(new_n173_), .O(z14));
  zero   g362(.O(z07));
  zero   g363(.O(z18));
  zero   g364(.O(z19));
  zero   g365(.O(z20));
  zero   g366(.O(z22));
  zero   g367(.O(z26));
  nor2   g368(.a(x126), .b(x103), .O(z16));
  nor2   g369(.a(x126), .b(x103), .O(z17));
  nor2   g370(.a(x126), .b(x103), .O(z21));
  nor2   g371(.a(x126), .b(x103), .O(z23));
  nor2   g372(.a(x126), .b(x103), .O(z24));
  nor2   g373(.a(x126), .b(x103), .O(z25));
  nor2   g374(.a(x126), .b(x103), .O(z27));
endmodule
