...
module FAU ( 
  ...
  nand3  g320(.a(new_n477_), .b(new_n159_), .c(new_n437_), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(z13));
  oai21  g322(.a(new_n334_), .b(new_n313_), .c(x006), .O(new_n480_));
  oai21  g323(.a(new_n342_), .b(new_n301_), .c(new_n302_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n326_), .O(new_n482_));
  aoi22  g325(.a(new_n482_), .b(new_n480_), .c(new_n309_), .d(new_n308_), .O(new_n483_));
  nand3  g326(.a(new_n326_), .b(x070), .c(x030), .O(new_n484_));
  nand3  g327(.a(x102), .b(new_n316_), .c(x006), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n484_), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(new_n313_), .O(new_n487_));
  nand2  g330(.a(x022), .b(x014), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x006), .O(new_n489_));
  oai21  g332(.a(x086), .b(new_n334_), .c(new_n489_), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(new_n338_), .O(new_n491_));
  nand4  g334(.a(new_n488_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n492_));
  inv1   g335(.a(x094), .O(new_n493_));
  nand3  g336(.a(new_n493_), .b(new_n334_), .c(x006), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n492_), .O(new_n495_));
  oai21  g338(.a(x126), .b(x102), .c(new_n495_), .O(new_n496_));
  nand2  g339(.a(x126), .b(new_n309_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n301_), .c(x022), .O(new_n498_));
  nand2  g341(.a(x030), .b(new_n299_), .O(new_n499_));
  nand3  g342(.a(x126), .b(x094), .c(new_n316_), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n499_), .c(new_n326_), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n498_), .c(x006), .O(new_n502_));
  nand4  g345(.a(new_n502_), .b(new_n496_), .c(new_n491_), .d(new_n487_), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n483_), .c(new_n300_), .O(new_n504_));
  nand3  g347(.a(x126), .b(new_n308_), .c(x038), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n326_), .c(new_n298_), .O(new_n506_));
  oai22  g349(.a(new_n327_), .b(new_n301_), .c(new_n334_), .d(new_n335_), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(new_n506_), .c(new_n299_), .O(new_n508_));
  nand2  g351(.a(x030), .b(new_n335_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n330_), .c(x086), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(x054), .c(x038), .O(new_n511_));
  nand3  g354(.a(x070), .b(new_n313_), .c(x022), .O(new_n512_));
  nand4  g355(.a(new_n512_), .b(new_n511_), .c(new_n508_), .d(new_n504_), .O(new_n513_));
  nand3  g356(.a(new_n513_), .b(new_n157_), .c(new_n297_), .O(new_n514_));
