// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:17 2020
...
module FAU ( 
  ...
  oai22  g206(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n363_));
  nand3  g207(.a(new_n363_), .b(x082), .c(x002), .O(new_n364_));
  oai22  g208(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n365_));
  nand3  g209(.a(new_n365_), .b(x066), .c(x018), .O(new_n366_));
  aoi22  g210(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n367_));
  nand3  g211(.a(new_n367_), .b(new_n366_), .c(new_n364_), .O(new_n368_));
  inv1   g212(.a(new_n368_), .O(new_n369_));
  oai21  g213(.a(new_n369_), .b(x042), .c(new_n157_), .O(z10));
  oai22  g214(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n371_));
  nand3  g215(.a(new_n371_), .b(x083), .c(x003), .O(new_n372_));
  oai22  g216(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n373_));
  nand3  g217(.a(new_n373_), .b(x067), .c(x019), .O(new_n374_));
  aoi22  g218(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n375_));
  nand3  g219(.a(new_n375_), .b(new_n374_), .c(new_n372_), .O(new_n376_));
  inv1   g220(.a(new_n376_), .O(new_n377_));
  oai21  g221(.a(new_n377_), .b(x043), .c(new_n157_), .O(z11));
  inv1   g222(.a(x044), .O(new_n379_));
  oai22  g223(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n380_));
  nand3  g224(.a(new_n380_), .b(x084), .c(x004), .O(new_n381_));
  oai22  g225(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(x068), .c(x020), .O(new_n383_));
  aoi22  g227(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(new_n383_), .c(new_n381_), .O(new_n385_));
  nand3  g229(.a(new_n385_), .b(new_n157_), .c(new_n379_), .O(new_n386_));
  inv1   g230(.a(new_n386_), .O(z12));
  oai22  g231(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n388_));
  inv1   g232(.a(x101), .O(new_n389_));
  aoi21  g233(.a(new_n258_), .b(new_n389_), .c(x093), .O(new_n390_));
  nand2  g234(.a(new_n249_), .b(new_n248_), .O(new_n391_));
  oai21  g235(.a(new_n391_), .b(new_n390_), .c(new_n275_), .O(new_n392_));
  oai21  g236(.a(new_n258_), .b(x109), .c(x037), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(x117), .O(new_n394_));
  oai21  g238(.a(new_n389_), .b(x061), .c(new_n248_), .O(new_n395_));
  nand3  g239(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n396_));
  nand2  g240(.a(new_n396_), .b(new_n266_), .O(new_n397_));
  aoi21  g241(.a(new_n395_), .b(new_n253_), .c(new_n397_), .O(new_n398_));
  nand4  g242(.a(new_n398_), .b(new_n394_), .c(new_n392_), .d(new_n388_), .O(new_n399_));
  nand4  g243(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n400_));
  inv1   g244(.a(new_n400_), .O(new_n401_));
  aoi21  g245(.a(new_n399_), .b(new_n274_), .c(new_n401_), .O(new_n402_));
  nand3  g246(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n403_));
  oai21  g247(.a(new_n402_), .b(x053), .c(new_n403_), .O(new_n404_));
  aoi21  g248(.a(new_n244_), .b(x029), .c(x021), .O(new_n405_));
  oai21  g249(.a(new_n405_), .b(x077), .c(new_n241_), .O(new_n406_));
  nand2  g250(.a(new_n406_), .b(new_n391_), .O(new_n407_));
  nand2  g251(.a(x029), .b(new_n242_), .O(new_n408_));
  aoi21  g252(.a(new_n408_), .b(new_n270_), .c(new_n275_), .O(new_n409_));
  nand2  g253(.a(new_n258_), .b(new_n389_), .O(new_n410_));
  aoi22  g254(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n411_));
  nand3  g255(.a(new_n411_), .b(new_n410_), .c(x029), .O(new_n412_));
  inv1   g256(.a(new_n412_), .O(new_n413_));
  oai21  g257(.a(new_n413_), .b(new_n409_), .c(new_n274_), .O(new_n414_));
  aoi21  g258(.a(new_n414_), .b(new_n407_), .c(x053), .O(new_n415_));
  oai21  g259(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n416_));
  nand2  g260(.a(new_n416_), .b(new_n270_), .O(new_n417_));
  nand3  g261(.a(new_n417_), .b(new_n274_), .c(x037), .O(new_n418_));
  inv1   g262(.a(new_n418_), .O(new_n419_));
  oai21  g263(.a(new_n419_), .b(new_n415_), .c(new_n266_), .O(new_n420_));
  oai22  g264(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n421_));
  nand3  g265(.a(new_n421_), .b(x069), .c(x021), .O(new_n422_));
  aoi22  g266(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n423_));
  nand3  g267(.a(new_n423_), .b(new_n422_), .c(new_n420_), .O(new_n424_));
  aoi21  g268(.a(new_n404_), .b(x005), .c(new_n424_), .O(new_n425_));
  oai21  g269(.a(new_n425_), .b(x045), .c(new_n157_), .O(z13));
  nand2  g270(.a(x022), .b(x014), .O(new_n427_));
  inv1   g271(.a(x062), .O(new_n428_));
  inv1   g272(.a(x094), .O(new_n429_));
  nand2  g273(.a(new_n429_), .b(new_n428_), .O(new_n430_));
  oai21  g274(.a(new_n430_), .b(x030), .c(new_n427_), .O(new_n431_));
  inv1   g275(.a(x102), .O(new_n432_));
  inv1   g276(.a(x126), .O(new_n433_));
  nand2  g277(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  nand2  g278(.a(new_n434_), .b(new_n429_), .O(new_n435_));
  nor2   g279(.a(x118), .b(x110), .O(new_n436_));
  nand2  g280(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  nand2  g281(.a(new_n437_), .b(new_n300_), .O(new_n438_));
  oai21  g282(.a(new_n433_), .b(x110), .c(x038), .O(new_n439_));
  nand2  g283(.a(new_n439_), .b(x118), .O(new_n440_));
  inv1   g284(.a(x110), .O(new_n441_));
  oai21  g285(.a(new_n432_), .b(x062), .c(new_n441_), .O(new_n442_));
  inv1   g286(.a(x118), .O(new_n443_));
  nand3  g287(.a(x126), .b(new_n443_), .c(new_n299_), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(new_n303_), .O(new_n445_));
  aoi21  g289(.a(new_n442_), .b(new_n296_), .c(new_n445_), .O(new_n446_));
  nand4  g290(.a(new_n446_), .b(new_n440_), .c(new_n438_), .d(new_n431_), .O(new_n447_));
  nand4  g291(.a(x126), .b(new_n428_), .c(new_n296_), .d(x014), .O(new_n448_));
  inv1   g292(.a(new_n448_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n295_), .c(new_n449_), .O(new_n450_));
  inv1   g294(.a(x014), .O(new_n451_));
  nand3  g295(.a(x086), .b(new_n296_), .c(new_n451_), .O(new_n452_));
  oai21  g296(.a(new_n450_), .b(x054), .c(new_n452_), .O(new_n453_));
  nand2  g297(.a(new_n453_), .b(x006), .O(new_n454_));
  nand2  g298(.a(x094), .b(x062), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(x030), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n299_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n295_), .O(new_n458_));
  aoi21  g302(.a(new_n458_), .b(new_n451_), .c(new_n436_), .O(new_n459_));
  inv1   g303(.a(x030), .O(new_n460_));
  nor2   g304(.a(new_n460_), .b(x022), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n430_), .c(x070), .O(new_n462_));
  nand4  g306(.a(new_n455_), .b(new_n434_), .c(new_n427_), .d(x030), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n462_), .c(x078), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n459_), .c(new_n297_), .O(new_n465_));
  nand2  g309(.a(new_n427_), .b(x030), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(new_n429_), .c(new_n428_), .O(new_n467_));
  nand3  g311(.a(new_n467_), .b(new_n295_), .c(x038), .O(new_n468_));
  ...
  aoi22  g315(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n471_), .O(new_n473_));
  aoi21  g317(.a(new_n469_), .b(new_n303_), .c(new_n473_), .O(new_n474_));
  aoi21  g318(.a(new_n474_), .b(new_n454_), .c(x046), .O(z14));
  zero   g319(.O(z15));
  zero   g320(.O(z16));
  zero   g321(.O(z18));
  zero   g322(.O(z19));
  ...
  inv1   g329(.a(new_n157_), .O(z22));
  inv1   g330(.a(new_n157_), .O(z25));
  inv1   g331(.a(new_n157_), .O(z27));
endmodule
