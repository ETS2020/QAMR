// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:32 2020
...
module FAU ( 
  ...
  nand2  g099(.a(new_n252_), .b(x085), .O(new_n256_));
  oai21  g100(.a(new_n256_), .b(new_n244_), .c(x077), .O(new_n257_));
  ...
  nor2   g111(.a(x069), .b(x061), .O(new_n268_));
  ...
  inv1   g126(.a(x127), .O(new_n283_));
  nand4  g127(.a(new_n262_), .b(x085), .c(x061), .d(new_n270_), .O(new_n284_));
  oai21  g128(.a(x093), .b(x005), .c(new_n284_), .O(new_n285_));
  nand2  g129(.a(new_n285_), .b(new_n263_), .O(new_n286_));
  nand3  g130(.a(new_n273_), .b(x069), .c(new_n240_), .O(new_n287_));
  oai21  g131(.a(new_n256_), .b(x029), .c(new_n287_), .O(new_n288_));
  nor2   g132(.a(x093), .b(new_n241_), .O(new_n289_));
  aoi22  g133(.a(new_n289_), .b(new_n265_), .c(new_n288_), .d(x061), .O(new_n290_));
  aoi21  g134(.a(new_n290_), .b(new_n286_), .c(new_n283_), .O(new_n291_));
  oai21  g135(.a(new_n291_), .b(new_n282_), .c(x053), .O(new_n292_));
  aoi21  g136(.a(new_n263_), .b(new_n270_), .c(new_n271_), .O(new_n293_));
  nand2  g137(.a(x127), .b(new_n261_), .O(new_n294_));
  oai21  g138(.a(new_n293_), .b(new_n261_), .c(new_n294_), .O(new_n295_));
  nand3  g139(.a(new_n295_), .b(x085), .c(new_n243_), .O(new_n296_));
  nand2  g140(.a(new_n296_), .b(new_n292_), .O(new_n297_));
  nand4  g141(.a(x127), .b(new_n275_), .c(x061), .d(x053), .O(new_n298_));
  nor4   g142(.a(new_n298_), .b(new_n243_), .c(x013), .d(x005), .O(new_n299_));
  aoi21  g143(.a(new_n297_), .b(x077), .c(new_n299_), .O(new_n300_));
  aoi21  g144(.a(new_n300_), .b(new_n260_), .c(new_n239_), .O(z05));
  ...
  nand3  g199(.a(new_n355_), .b(new_n158_), .c(x046), .O(new_n356_));
  ...
  nor2   g221(.a(x032), .b(new_n161_), .O(new_n378_));
  nor2   g222(.a(new_n367_), .b(x056), .O(new_n379_));
  aoi22  g223(.a(new_n379_), .b(new_n378_), .c(new_n377_), .d(new_n164_), .O(new_n380_));
  ...
  oai21  g229(.a(new_n385_), .b(x072), .c(new_n161_), .O(new_n386_));
  nand2  g230(.a(new_n386_), .b(new_n383_), .O(new_n387_));
  nand2  g231(.a(x024), .b(new_n167_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n360_), .c(new_n168_), .O(new_n389_));
  ...
  oai21  g236(.a(new_n392_), .b(new_n389_), .c(new_n164_), .O(new_n393_));
  ...
  oai21  g242(.a(new_n398_), .b(new_n394_), .c(new_n160_), .O(new_n399_));
  ...
  oai21  g248(.a(new_n404_), .b(x040), .c(new_n158_), .O(z08));
  ...
  nand3  g288(.a(new_n444_), .b(new_n245_), .c(new_n244_), .O(new_n445_));
  oai21  g289(.a(new_n442_), .b(new_n265_), .c(new_n445_), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(x021), .O(new_n447_));
  nand2  g291(.a(new_n444_), .b(new_n244_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n245_), .O(new_n449_));
  ...
  nor2   g299(.a(new_n265_), .b(x021), .O(new_n456_));
  ...
  oai22  g304(.a(new_n275_), .b(x069), .c(new_n273_), .d(x037), .O(new_n461_));
  nor2   g305(.a(new_n265_), .b(new_n243_), .O(new_n462_));
  inv1   g306(.a(x117), .O(new_n463_));
  nand3  g307(.a(x125), .b(new_n463_), .c(new_n248_), .O(new_n464_));
  oai21  g308(.a(new_n462_), .b(new_n443_), .c(new_n464_), .O(new_n465_));
  aoi21  g309(.a(new_n461_), .b(new_n261_), .c(new_n465_), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n460_), .c(new_n240_), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(new_n459_), .c(x127), .O(new_n468_));
  nand3  g312(.a(new_n453_), .b(new_n241_), .c(x029), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n240_), .O(new_n470_));
  ...
  oai21  g318(.a(x085), .b(new_n265_), .c(new_n474_), .O(new_n475_));
  oai21  g319(.a(new_n475_), .b(new_n473_), .c(x093), .O(new_n476_));
  aoi21  g320(.a(new_n476_), .b(new_n468_), .c(x053), .O(new_n477_));
  nand2  g321(.a(x101), .b(new_n265_), .O(new_n478_));
  inv1   g322(.a(x109), .O(new_n479_));
  nand3  g323(.a(x125), .b(new_n479_), .c(new_n242_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n478_), .c(new_n240_), .O(new_n481_));
  nand2  g325(.a(new_n453_), .b(x029), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n271_), .c(x085), .O(new_n483_));
  oai21  g327(.a(new_n483_), .b(new_n481_), .c(x127), .O(new_n484_));
  nand2  g328(.a(x093), .b(new_n241_), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n484_), .c(new_n243_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n477_), .c(new_n245_), .O(new_n487_));
  ...
  nand3  g371(.a(new_n527_), .b(new_n158_), .c(new_n489_), .O(new_n528_));
  ...
  zero   g379(.O(z24));
  zero   g380(.O(z27));
  nor2   g381(.a(x127), .b(x093), .O(z18));
  nor2   g382(.a(x127), .b(x093), .O(z20));
  nor2   g383(.a(x127), .b(x093), .O(z21));
  nor2   g384(.a(x127), .b(x093), .O(z25));
  nor2   g385(.a(x127), .b(x093), .O(z26));
endmodule
