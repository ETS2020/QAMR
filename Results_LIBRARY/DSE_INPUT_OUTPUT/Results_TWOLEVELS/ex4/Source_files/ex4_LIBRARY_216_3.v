...
module FAU ( 
  ...
  nor2   g095(.a(new_n251_), .b(new_n173_), .O(new_n252_));
  ...
  nand2  g290(.a(new_n447_), .b(new_n175_), .O(new_n448_));
  nand2  g291(.a(x109), .b(new_n172_), .O(new_n449_));
  oai21  g292(.a(new_n251_), .b(x109), .c(new_n449_), .O(new_n450_));
  ...
  nand3  g310(.a(new_n467_), .b(new_n173_), .c(new_n276_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n456_), .O(new_n469_));
  nand3  g312(.a(new_n173_), .b(new_n268_), .c(x029), .O(new_n470_));
  nand4  g313(.a(x125), .b(new_n251_), .c(new_n172_), .d(x005), .O(new_n471_));
  aoi21  g314(.a(new_n471_), .b(new_n470_), .c(x013), .O(new_n472_));
  nand4  g315(.a(new_n173_), .b(new_n268_), .c(x029), .d(new_n245_), .O(new_n473_));
  ...
  oai21  g321(.a(x046), .b(new_n300_), .c(new_n173_), .O(new_n479_));
  ...
  nand2  g332(.a(new_n489_), .b(new_n325_), .O(new_n490_));
  ...
  aoi21  g337(.a(new_n492_), .b(new_n172_), .c(new_n494_), .O(new_n495_));
  ...
  aoi21  g344(.a(new_n501_), .b(new_n329_), .c(new_n333_), .O(new_n502_));
  nand2  g345(.a(new_n317_), .b(new_n482_), .O(new_n503_));
  ...
  oai21  g349(.a(new_n506_), .b(new_n502_), .c(new_n172_), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n500_), .c(x054), .O(new_n508_));
  oai21  g351(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n329_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n172_), .c(x038), .O(new_n511_));
  inv1   g354(.a(new_n511_), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(new_n508_), .c(new_n325_), .O(new_n513_));
  ...
  zero   g368(.O(z22));
  zero   g369(.O(z24));
  nor2   g370(.a(new_n173_), .b(new_n172_), .O(z18));
