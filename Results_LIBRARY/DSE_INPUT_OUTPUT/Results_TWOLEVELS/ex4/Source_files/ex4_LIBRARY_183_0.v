...
module FAU ( 
  ...
  aoi21  g324(.a(x054), .b(x038), .c(x014), .O(new_n482_));
  nand3  g325(.a(x070), .b(new_n298_), .c(x022), .O(new_n483_));
  nand3  g326(.a(x086), .b(new_n312_), .c(x006), .O(new_n484_));
  nand3  g327(.a(new_n484_), .b(new_n483_), .c(new_n482_), .O(new_n485_));
  nand3  g328(.a(new_n485_), .b(x078), .c(new_n296_), .O(new_n486_));
  ...
  zero   g334(.O(z22));
  zero   g335(.O(z24));
  nor2   g336(.a(x078), .b(x046), .O(z16));
  nor2   g337(.a(x078), .b(x046), .O(z18));
  nor2   g338(.a(x078), .b(x046), .O(z21));
  nor2   g339(.a(x078), .b(x046), .O(z23));
  nor2   g340(.a(x078), .b(x046), .O(z25));
  nor2   g341(.a(x078), .b(x046), .O(z26));
  nor2   g342(.a(x078), .b(x046), .O(z27));
endmodule
