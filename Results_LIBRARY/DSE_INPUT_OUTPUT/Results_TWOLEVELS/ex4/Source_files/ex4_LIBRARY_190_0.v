...
module FAU ( 
  ...
  nand3  g196(.a(new_n352_), .b(x111), .c(new_n298_), .O(new_n353_));
  ...
  oai21  g283(.a(new_n279_), .b(x029), .c(new_n439_), .O(new_n440_));
  ...
  nand4  g306(.a(new_n462_), .b(new_n439_), .c(new_n245_), .d(x029), .O(new_n463_));
  ...
  oai21  g321(.a(new_n477_), .b(x045), .c(new_n158_), .O(z13));
  oai21  g322(.a(new_n316_), .b(x030), .c(new_n318_), .O(new_n479_));
  aoi21  g323(.a(new_n328_), .b(new_n324_), .c(x094), .O(new_n480_));
  nand2  g324(.a(new_n309_), .b(new_n308_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n480_), .c(new_n310_), .O(new_n482_));
  oai21  g326(.a(new_n328_), .b(x110), .c(x038), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x118), .O(new_n484_));
  oai21  g328(.a(new_n324_), .b(x062), .c(new_n308_), .O(new_n485_));
  nand3  g329(.a(x126), .b(new_n309_), .c(new_n300_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n312_), .O(new_n487_));
  ...
  nand4  g333(.a(x126), .b(new_n314_), .c(new_n297_), .d(x014), .O(new_n490_));
  ...
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(new_n310_), .O(new_n500_));
  nand2  g344(.a(new_n328_), .b(new_n324_), .O(new_n501_));
  nand4  g345(.a(new_n501_), .b(new_n318_), .c(new_n302_), .d(x030), .O(new_n502_));
  ...
  oai21  g349(.a(new_n319_), .b(new_n313_), .c(new_n498_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n298_), .c(x038), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n505_), .c(new_n312_), .O(new_n509_));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(x111), .b(x078), .O(z16));
  nor2   g369(.a(x111), .b(x078), .O(z20));
  nor2   g370(.a(x111), .b(x078), .O(z21));
  nor2   g371(.a(x111), .b(x078), .O(z22));
  nor2   g372(.a(x111), .b(x078), .O(z24));
endmodule
