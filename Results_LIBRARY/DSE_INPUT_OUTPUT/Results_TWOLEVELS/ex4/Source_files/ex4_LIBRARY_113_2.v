...
module FAU ( 
  ...
  nand2  g016(.a(new_n172_), .b(x079), .O(new_n173_));
  ...
  nand3  g159(.a(new_n172_), .b(x118), .c(x022), .O(new_n316_));
  ...
  nand4  g163(.a(new_n172_), .b(x062), .c(x038), .d(new_n299_), .O(new_n320_));
  ...
  oai22  g322(.a(new_n335_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n479_));
  inv1   g323(.a(x102), .O(new_n480_));
  aoi21  g324(.a(new_n172_), .b(new_n480_), .c(x094), .O(new_n481_));
  nand2  g325(.a(new_n307_), .b(new_n306_), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(new_n481_), .c(new_n332_), .O(new_n483_));
  oai21  g327(.a(new_n172_), .b(x110), .c(x038), .O(new_n484_));
  ...
  nand2  g331(.a(new_n487_), .b(new_n323_), .O(new_n488_));
  ...
  aoi21  g336(.a(new_n490_), .b(new_n331_), .c(new_n492_), .O(new_n493_));
  ...
  aoi21  g343(.a(new_n499_), .b(new_n327_), .c(new_n332_), .O(new_n500_));
  nand2  g344(.a(new_n172_), .b(new_n480_), .O(new_n501_));
  ...
  oai21  g348(.a(new_n504_), .b(new_n500_), .c(new_n331_), .O(new_n505_));
  ...
  nand3  g352(.a(new_n508_), .b(new_n331_), .c(x038), .O(new_n509_));
  inv1   g353(.a(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n506_), .c(new_n323_), .O(new_n511_));
  ...
  zero   g366(.O(z25));
  zero   g367(.O(z27));
  inv1   g368(.a(new_n173_), .O(z16));
  inv1   g369(.a(new_n173_), .O(z18));
  inv1   g370(.a(new_n173_), .O(z19));
  inv1   g371(.a(new_n173_), .O(z21));
  inv1   g372(.a(new_n173_), .O(z22));
  inv1   g373(.a(new_n173_), .O(z26));
endmodule
