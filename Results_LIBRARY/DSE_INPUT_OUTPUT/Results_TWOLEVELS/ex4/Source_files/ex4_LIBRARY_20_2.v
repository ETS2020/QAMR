...
module FAU ( 
  ...
  oai21  g318(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n475_));
  nand2  g319(.a(new_n318_), .b(new_n314_), .O(new_n476_));
  oai22  g320(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n476_), .O(new_n478_));
  oai22  g322(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n479_));
  nand2  g323(.a(x118), .b(new_n298_), .O(new_n480_));
  oai21  g324(.a(x118), .b(x022), .c(new_n480_), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(x126), .c(x086), .O(new_n482_));
  nand4  g326(.a(new_n482_), .b(new_n479_), .c(new_n478_), .d(new_n475_), .O(new_n483_));
  nand3  g327(.a(new_n483_), .b(new_n297_), .c(new_n340_), .O(new_n484_));
  nand4  g328(.a(x086), .b(new_n172_), .c(new_n300_), .d(new_n319_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n484_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(x006), .O(new_n487_));
  nor2   g331(.a(new_n331_), .b(new_n304_), .O(new_n488_));
  oai22  g332(.a(new_n488_), .b(new_n321_), .c(x118), .d(x110), .O(new_n489_));
  nor2   g333(.a(x038), .b(new_n304_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n307_), .c(x070), .O(new_n491_));
  nand4  g335(.a(new_n476_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n491_), .c(new_n489_), .O(new_n493_));
  aoi21  g337(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n494_));
  nor2   g338(.a(new_n494_), .b(new_n300_), .O(new_n495_));
  aoi21  g339(.a(new_n493_), .b(new_n340_), .c(new_n495_), .O(new_n496_));
  nor2   g340(.a(new_n301_), .b(x038), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(x022), .c(x046), .O(new_n498_));
  oai21  g342(.a(new_n496_), .b(x086), .c(new_n498_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n297_), .O(new_n500_));
  nand2  g344(.a(x054), .b(x038), .O(new_n501_));
  nand4  g345(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n502_));
  nand2  g346(.a(x078), .b(x014), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n502_), .c(new_n501_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n172_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n500_), .c(new_n487_), .O(z14));
  zero   g350(.O(z16));
  zero   g351(.O(z19));
  zero   g352(.O(z21));
  zero   g353(.O(z22));
  ...
  nor2   g357(.a(x078), .b(new_n172_), .O(z17));
  nor2   g358(.a(x078), .b(new_n172_), .O(z18));
  nor2   g359(.a(x078), .b(new_n172_), .O(z20));
  nor2   g360(.a(x078), .b(new_n172_), .O(z23));
  nor2   g361(.a(x078), .b(new_n172_), .O(z24));
  nor2   g362(.a(x078), .b(new_n172_), .O(z25));
endmodule
