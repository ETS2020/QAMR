...
module FAU ( 
  ...
  oai21  g256(.a(new_n413_), .b(x041), .c(new_n175_), .O(z09));
  ...
  nand4  g297(.a(x125), .b(new_n260_), .c(new_n257_), .d(x013), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(new_n456_));
  aoi21  g299(.a(new_n454_), .b(new_n277_), .c(new_n456_), .O(new_n457_));
  nand3  g300(.a(x085), .b(new_n257_), .c(new_n245_), .O(new_n458_));
  oai21  g301(.a(new_n457_), .b(x053), .c(new_n458_), .O(new_n459_));
  aoi21  g302(.a(new_n248_), .b(x029), .c(x021), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(x077), .c(new_n245_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n446_), .O(new_n462_));
  nand2  g305(.a(x029), .b(new_n246_), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n273_), .c(new_n278_), .O(new_n464_));
  nand2  g307(.a(new_n262_), .b(new_n443_), .O(new_n465_));
  nand4  g308(.a(new_n465_), .b(new_n441_), .c(new_n248_), .d(x029), .O(new_n466_));
  inv1   g309(.a(new_n466_), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n464_), .c(new_n277_), .O(new_n468_));
  ...
  oai21  g322(.a(new_n479_), .b(x045), .c(new_n175_), .O(z13));
  aoi21  g323(.a(new_n297_), .b(x014), .c(x089), .O(new_n481_));
  ...
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g377(.a(new_n173_), .b(new_n172_), .O(z27));
endmodule
