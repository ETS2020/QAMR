// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:52 2020
...
module FAU ( 
  ...
  nor2   g002(.a(new_n158_), .b(x064), .O(z15));
  ...
  nand2  g010(.a(new_n166_), .b(new_n161_), .O(new_n167_));
  aoi22  g011(.a(new_n165_), .b(new_n162_), .c(new_n164_), .d(new_n163_), .O(new_n168_));
  oai21  g012(.a(new_n167_), .b(x000), .c(new_n168_), .O(new_n169_));
  nand2  g013(.a(new_n169_), .b(new_n160_), .O(new_n170_));
  ...
  nand4  g017(.a(new_n173_), .b(new_n158_), .c(new_n172_), .d(new_n171_), .O(new_n174_));
  ...
  nand3  g137(.a(new_n293_), .b(new_n160_), .c(x045), .O(new_n294_));
  ...
  aoi21  g146(.a(new_n302_), .b(x054), .c(new_n172_), .O(new_n303_));
  ...
  aoi21  g196(.a(new_n348_), .b(x064), .c(new_n352_), .O(new_n353_));
  ...
  oai21  g208(.a(new_n365_), .b(new_n363_), .c(new_n172_), .O(new_n366_));
  oai21  g209(.a(new_n362_), .b(x104), .c(x032), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(x112), .O(new_n368_));
  inv1   g211(.a(x104), .O(new_n369_));
  oai21  g212(.a(new_n361_), .b(x056), .c(new_n369_), .O(new_n370_));
  inv1   g213(.a(x112), .O(new_n371_));
  nand3  g214(.a(x120), .b(new_n371_), .c(new_n171_), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(new_n161_), .O(new_n373_));
  aoi21  g216(.a(new_n370_), .b(new_n163_), .c(new_n373_), .O(new_n374_));
  nand4  g217(.a(new_n374_), .b(new_n368_), .c(new_n366_), .d(new_n360_), .O(new_n375_));
  nand4  g218(.a(x120), .b(new_n172_), .c(new_n357_), .d(x008), .O(new_n376_));
  ...
  nand3  g223(.a(new_n161_), .b(new_n164_), .c(x024), .O(new_n381_));
  nand2  g224(.a(new_n381_), .b(new_n171_), .O(new_n382_));
  nand2  g225(.a(new_n382_), .b(new_n163_), .O(new_n383_));
  nand3  g226(.a(new_n359_), .b(new_n161_), .c(new_n164_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n383_), .c(new_n172_), .O(new_n385_));
  nand2  g228(.a(x088), .b(x056), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(x024), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n171_), .c(new_n364_), .O(new_n388_));
  nand2  g231(.a(new_n362_), .b(new_n361_), .O(new_n389_));
  nand4  g232(.a(new_n386_), .b(new_n389_), .c(new_n356_), .d(x024), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n388_), .c(new_n164_), .O(new_n392_));
  and2   g235(.a(new_n356_), .b(x024), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n359_), .c(x032), .O(new_n394_));
  aoi21  g237(.a(new_n394_), .b(new_n392_), .c(x080), .O(new_n395_));
  oai21  g238(.a(new_n395_), .b(new_n385_), .c(new_n165_), .O(new_n396_));
  nand3  g239(.a(new_n365_), .b(new_n161_), .c(new_n164_), .O(new_n397_));
  nand2  g240(.a(new_n397_), .b(new_n165_), .O(new_n398_));
  nand4  g241(.a(x064), .b(new_n164_), .c(x016), .d(new_n162_), .O(new_n399_));
  oai21  g242(.a(new_n164_), .b(new_n163_), .c(new_n399_), .O(new_n400_));
  aoi21  g243(.a(new_n398_), .b(x008), .c(new_n400_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n396_), .O(new_n402_));
  aoi21  g245(.a(new_n380_), .b(x000), .c(new_n402_), .O(new_n403_));
  oai21  g246(.a(new_n403_), .b(x040), .c(new_n160_), .O(z08));
  ...
  oai21  g288(.a(new_n439_), .b(x061), .c(new_n250_), .O(new_n446_));
  ...
  nand2  g303(.a(new_n260_), .b(new_n439_), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n437_), .c(new_n246_), .d(x029), .O(new_n462_));
  ...
  aoi21  g319(.a(new_n296_), .b(x014), .c(new_n172_), .O(new_n477_));
  nand2  g320(.a(x022), .b(x014), .O(new_n478_));
  nand2  g321(.a(new_n326_), .b(new_n333_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  inv1   g323(.a(x102), .O(new_n481_));
  aoi21  g324(.a(new_n344_), .b(new_n481_), .c(x094), .O(new_n482_));
  nor2   g325(.a(x118), .b(x110), .O(new_n483_));
  inv1   g326(.a(new_n483_), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n482_), .c(new_n329_), .O(new_n485_));
  oai21  g328(.a(new_n344_), .b(x110), .c(x038), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x118), .O(new_n487_));
  oai21  g330(.a(new_n481_), .b(x062), .c(new_n313_), .O(new_n488_));
  nand3  g331(.a(x126), .b(new_n312_), .c(new_n330_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n319_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n297_), .c(new_n490_), .O(new_n491_));
  nand4  g334(.a(new_n491_), .b(new_n487_), .c(new_n485_), .d(new_n480_), .O(new_n492_));
  nand4  g335(.a(x126), .b(new_n316_), .c(new_n297_), .d(x014), .O(new_n493_));
  inv1   g336(.a(new_n493_), .O(new_n494_));
  aoi21  g337(.a(new_n492_), .b(new_n158_), .c(new_n494_), .O(new_n495_));
  nand3  g338(.a(x086), .b(new_n297_), .c(new_n338_), .O(new_n496_));
  oai21  g339(.a(new_n495_), .b(x054), .c(new_n496_), .O(new_n497_));
  aoi21  g340(.a(new_n299_), .b(x030), .c(x022), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(x078), .c(new_n338_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n484_), .O(new_n500_));
  nand2  g343(.a(x030), .b(new_n330_), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n326_), .c(new_n329_), .O(new_n502_));
  nand2  g345(.a(new_n344_), .b(new_n481_), .O(new_n503_));
  nand4  g346(.a(new_n503_), .b(new_n478_), .c(new_n299_), .d(x030), .O(new_n504_));
  inv1   g347(.a(new_n504_), .O(new_n505_));
  oai21  g348(.a(new_n505_), .b(new_n502_), .c(new_n158_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n500_), .c(x054), .O(new_n507_));
  nand2  g350(.a(new_n478_), .b(x030), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n326_), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n158_), .c(x038), .O(new_n510_));
  inv1   g353(.a(new_n510_), .O(new_n511_));
  oai21  g354(.a(new_n511_), .b(new_n507_), .c(new_n319_), .O(new_n512_));
  oai22  g355(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n513_));
  nand3  g356(.a(new_n513_), .b(x070), .c(x022), .O(new_n514_));
  nand2  g357(.a(x054), .b(x038), .O(new_n515_));
  nand3  g358(.a(new_n515_), .b(new_n514_), .c(new_n512_), .O(new_n516_));
  aoi21  g359(.a(new_n497_), .b(x006), .c(new_n516_), .O(new_n517_));
  oai22  g360(.a(new_n517_), .b(x046), .c(new_n477_), .d(new_n158_), .O(z14));
  zero   g361(.O(z07));
  zero   g362(.O(z16));
  zero   g363(.O(z17));
  zero   g364(.O(z20));
  ...
  zero   g366(.O(z25));
  zero   g367(.O(z27));
  nor2   g368(.a(new_n158_), .b(x064), .O(z18));
  nor2   g369(.a(new_n158_), .b(x064), .O(z19));
  nor2   g370(.a(new_n158_), .b(x064), .O(z21));
  nor2   g371(.a(new_n158_), .b(x064), .O(z22));
  nor2   g372(.a(new_n158_), .b(x064), .O(z23));
  nor2   g373(.a(new_n158_), .b(x064), .O(z26));
endmodule
