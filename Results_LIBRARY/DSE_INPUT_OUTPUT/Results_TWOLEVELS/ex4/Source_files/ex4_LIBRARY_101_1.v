...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x004), .O(z07));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(new_n224_), .O(new_n304_));
  ...
  aoi21  g197(.a(new_n349_), .b(x004), .c(new_n353_), .O(new_n354_));
  ...
  aoi21  g322(.a(new_n297_), .b(x014), .c(new_n224_), .O(new_n479_));
  ...
  nand4  g338(.a(x126), .b(new_n317_), .c(new_n298_), .d(x014), .O(new_n495_));
  inv1   g339(.a(new_n495_), .O(new_n496_));
  aoi21  g340(.a(new_n494_), .b(new_n172_), .c(new_n496_), .O(new_n497_));
  nand3  g341(.a(x086), .b(new_n298_), .c(new_n339_), .O(new_n498_));
  ...
  oai21  g351(.a(new_n507_), .b(new_n504_), .c(new_n172_), .O(new_n508_));
  ...
  nand3  g355(.a(new_n511_), .b(new_n172_), .c(x038), .O(new_n512_));
  ...
  oai22  g363(.a(new_n519_), .b(x046), .c(new_n479_), .d(new_n172_), .O(z14));
  zero   g364(.O(z15));
  zero   g365(.O(z18));
  zero   g366(.O(z20));
  zero   g367(.O(z21));
  ...
  zero   g369(.O(z26));
  zero   g370(.O(z27));
  nor2   g371(.a(new_n172_), .b(x004), .O(z16));
  nor2   g372(.a(new_n172_), .b(x004), .O(z17));
  nor2   g373(.a(new_n172_), .b(x004), .O(z19));
  nor2   g374(.a(new_n172_), .b(x004), .O(z22));
  nor2   g375(.a(new_n172_), .b(x004), .O(z24));
  nor2   g376(.a(new_n172_), .b(x004), .O(z25));
endmodule
