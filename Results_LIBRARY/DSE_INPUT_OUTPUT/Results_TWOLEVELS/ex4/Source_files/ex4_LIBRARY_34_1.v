// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:34 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x046), .O(z07));
  ...
  inv1   g191(.a(x024), .O(new_n348_));
  nor2   g192(.a(x088), .b(x056), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(new_n348_), .O(new_n350_));
  oai21  g194(.a(new_n165_), .b(new_n159_), .c(new_n350_), .O(new_n351_));
  inv1   g195(.a(x096), .O(new_n352_));
  inv1   g196(.a(x120), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n352_), .c(x088), .O(new_n354_));
  inv1   g198(.a(x104), .O(new_n355_));
  inv1   g199(.a(x112), .O(new_n356_));
  nand2  g200(.a(new_n356_), .b(new_n355_), .O(new_n357_));
  oai21  g201(.a(new_n357_), .b(new_n354_), .c(new_n166_), .O(new_n358_));
  oai21  g202(.a(new_n353_), .b(x104), .c(x032), .O(new_n359_));
  nand2  g203(.a(new_n359_), .b(x112), .O(new_n360_));
  oai21  g204(.a(new_n352_), .b(x056), .c(new_n355_), .O(new_n361_));
  nand3  g205(.a(x120), .b(new_n356_), .c(new_n165_), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(new_n158_), .O(new_n363_));
  aoi21  g207(.a(new_n361_), .b(new_n160_), .c(new_n363_), .O(new_n364_));
  nand4  g208(.a(new_n364_), .b(new_n360_), .c(new_n358_), .d(new_n351_), .O(new_n365_));
  nor2   g209(.a(x032), .b(new_n159_), .O(new_n366_));
  nor2   g210(.a(new_n353_), .b(x056), .O(new_n367_));
  aoi22  g211(.a(new_n367_), .b(new_n366_), .c(new_n365_), .d(new_n162_), .O(new_n368_));
  nand3  g212(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n369_));
  oai21  g213(.a(new_n368_), .b(x048), .c(new_n369_), .O(new_n370_));
  nand2  g214(.a(x088), .b(x056), .O(new_n371_));
  aoi21  g215(.a(new_n371_), .b(x024), .c(x016), .O(new_n372_));
  oai21  g216(.a(new_n372_), .b(x072), .c(new_n159_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n357_), .O(new_n374_));
  nand2  g218(.a(x024), .b(new_n165_), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(new_n349_), .c(new_n166_), .O(new_n376_));
  nand2  g220(.a(new_n353_), .b(new_n352_), .O(new_n377_));
  aoi22  g221(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n378_));
  nand3  g222(.a(new_n378_), .b(new_n377_), .c(x024), .O(new_n379_));
  inv1   g223(.a(new_n379_), .O(new_n380_));
  oai21  g224(.a(new_n380_), .b(new_n376_), .c(new_n162_), .O(new_n381_));
  aoi21  g225(.a(new_n381_), .b(new_n374_), .c(x048), .O(new_n382_));
  oai21  g226(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n349_), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(new_n162_), .c(x032), .O(new_n385_));
  inv1   g229(.a(new_n385_), .O(new_n386_));
  oai21  g230(.a(new_n386_), .b(new_n382_), .c(new_n158_), .O(new_n387_));
  oai22  g231(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n388_));
  nand3  g232(.a(new_n388_), .b(x064), .c(x016), .O(new_n389_));
  aoi22  g233(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n390_));
  nand3  g234(.a(new_n390_), .b(new_n389_), .c(new_n387_), .O(new_n391_));
  aoi21  g235(.a(new_n370_), .b(x000), .c(new_n391_), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(x040), .c(new_n174_), .O(z08));
  oai22  g237(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n394_));
  nand3  g238(.a(new_n394_), .b(x081), .c(x001), .O(new_n395_));
  oai22  g239(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n396_));
  nand3  g240(.a(new_n396_), .b(x065), .c(x017), .O(new_n397_));
  aoi22  g241(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n398_));
  nand3  g242(.a(new_n398_), .b(new_n397_), .c(new_n395_), .O(new_n399_));
  inv1   g243(.a(new_n399_), .O(new_n400_));
  oai21  g244(.a(new_n400_), .b(x041), .c(new_n174_), .O(z09));
  inv1   g245(.a(x042), .O(new_n402_));
  oai22  g246(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n403_));
  nand3  g247(.a(new_n403_), .b(x082), .c(x002), .O(new_n404_));
  oai22  g248(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n405_));
  nand3  g249(.a(new_n405_), .b(x066), .c(x018), .O(new_n406_));
  aoi22  g250(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n407_));
  nand3  g251(.a(new_n407_), .b(new_n406_), .c(new_n404_), .O(new_n408_));
  nand3  g252(.a(new_n408_), .b(new_n174_), .c(new_n402_), .O(new_n409_));
  inv1   g253(.a(new_n409_), .O(z10));
  ...
  nand3  g261(.a(new_n417_), .b(new_n174_), .c(new_n411_), .O(new_n418_));
  ...
  oai21  g274(.a(new_n280_), .b(x029), .c(new_n430_), .O(new_n431_));
  ...
  nand2  g278(.a(new_n434_), .b(new_n277_), .O(new_n435_));
  oai21  g279(.a(new_n260_), .b(x109), .c(x037), .O(new_n436_));
  nand2  g280(.a(new_n436_), .b(x117), .O(new_n437_));
  inv1   g281(.a(x101), .O(new_n438_));
  oai21  g282(.a(new_n438_), .b(x061), .c(new_n250_), .O(new_n439_));
  nand3  g283(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n268_), .O(new_n441_));
  aoi21  g285(.a(new_n439_), .b(new_n255_), .c(new_n441_), .O(new_n442_));
  nand4  g286(.a(new_n442_), .b(new_n437_), .c(new_n435_), .d(new_n431_), .O(new_n443_));
  nand4  g287(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n444_));
  inv1   g288(.a(new_n444_), .O(new_n445_));
  aoi21  g289(.a(new_n443_), .b(new_n276_), .c(new_n445_), .O(new_n446_));
  nand3  g290(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n447_));
  oai21  g291(.a(new_n446_), .b(x053), .c(new_n447_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(x005), .O(new_n449_));
  nand2  g293(.a(new_n246_), .b(x029), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n244_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n276_), .O(new_n452_));
  aoi21  g296(.a(new_n452_), .b(new_n243_), .c(new_n433_), .O(new_n453_));
  nor2   g297(.a(new_n242_), .b(x021), .O(new_n454_));
  oai21  g298(.a(new_n454_), .b(new_n280_), .c(x069), .O(new_n455_));
  inv1   g299(.a(new_n432_), .O(new_n456_));
  nand4  g300(.a(new_n456_), .b(new_n430_), .c(new_n246_), .d(x029), .O(new_n457_));
  aoi21  g301(.a(new_n457_), .b(new_n455_), .c(x077), .O(new_n458_));
  oai21  g302(.a(new_n458_), .b(new_n453_), .c(new_n241_), .O(new_n459_));
  nand2  g303(.a(new_n430_), .b(x029), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n272_), .O(new_n461_));
  nand3  g305(.a(new_n461_), .b(new_n276_), .c(x037), .O(new_n462_));
  ...
  aoi21  g311(.a(new_n463_), .b(new_n268_), .c(new_n467_), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n449_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n174_), .c(new_n429_), .O(new_n470_));
  inv1   g314(.a(new_n470_), .O(z13));
  inv1   g315(.a(x118), .O(new_n472_));
  oai21  g316(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n473_));
  nand2  g317(.a(new_n301_), .b(x030), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n299_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n312_), .O(new_n476_));
  aoi22  g320(.a(new_n476_), .b(new_n473_), .c(new_n472_), .d(new_n314_), .O(new_n477_));
  nand3  g321(.a(new_n312_), .b(x070), .c(x030), .O(new_n478_));
  nand3  g322(.a(x102), .b(new_n305_), .c(x006), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n304_), .O(new_n481_));
  nand2  g325(.a(new_n325_), .b(x006), .O(new_n482_));
  oai21  g326(.a(x086), .b(new_n306_), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(new_n329_), .O(new_n484_));
  nand4  g328(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n485_));
  nand3  g329(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  oai21  g331(.a(x126), .b(x102), .c(new_n487_), .O(new_n488_));
  nand2  g332(.a(x126), .b(new_n472_), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n298_), .c(x022), .O(new_n490_));
  nand2  g334(.a(x030), .b(new_n343_), .O(new_n491_));
  nand3  g335(.a(x126), .b(x094), .c(new_n305_), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n491_), .c(new_n312_), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n490_), .c(x006), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n488_), .c(new_n484_), .d(new_n481_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n477_), .c(new_n340_), .O(new_n496_));
  nand3  g340(.a(x126), .b(new_n314_), .c(x038), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n312_), .c(new_n297_), .O(new_n498_));
  nand3  g342(.a(new_n312_), .b(x038), .c(x030), .O(new_n499_));
  oai21  g343(.a(new_n306_), .b(new_n336_), .c(new_n499_), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n498_), .c(new_n343_), .O(new_n501_));
  nand2  g345(.a(x030), .b(new_n336_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n323_), .c(x086), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(x054), .c(x038), .O(new_n504_));
  nor2   g348(.a(new_n306_), .b(x038), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(x022), .c(x078), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n504_), .c(new_n501_), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n496_), .c(x046), .O(z14));
  zero   g353(.O(z15));
  zero   g354(.O(z17));
  zero   g355(.O(z19));
  zero   g356(.O(z20));
  ...
  zero   g359(.O(z25));
  zero   g360(.O(z26));
  nor2   g361(.a(new_n172_), .b(x046), .O(z16));
  nor2   g362(.a(new_n172_), .b(x046), .O(z18));
  nor2   g363(.a(new_n172_), .b(x046), .O(z22));
  nor2   g364(.a(new_n172_), .b(x046), .O(z23));
  nor2   g365(.a(new_n172_), .b(x046), .O(z27));
endmodule
