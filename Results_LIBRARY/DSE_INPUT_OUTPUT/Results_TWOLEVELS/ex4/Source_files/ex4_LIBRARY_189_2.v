...
module FAU ( 
  ...
  nand2  g001(.a(new_n157_), .b(x097), .O(new_n158_));
  ...
  nand3  g159(.a(new_n157_), .b(x118), .c(x022), .O(new_n316_));
  ...
  nand4  g163(.a(new_n157_), .b(x062), .c(x038), .d(new_n299_), .O(new_n320_));
  ...
  nand2  g194(.a(new_n350_), .b(new_n158_), .O(z06));
  ...
  nand2  g341(.a(new_n157_), .b(new_n478_), .O(new_n499_));
  ...
  oai21  g357(.a(new_n514_), .b(x046), .c(new_n158_), .O(z14));
  inv1   g358(.a(new_n158_), .O(z17));
  zero   g359(.O(z07));
  zero   g360(.O(z15));
  zero   g361(.O(z16));
  zero   g362(.O(z18));
  zero   g363(.O(z21));
  zero   g364(.O(z22));
  inv1   g365(.a(new_n158_), .O(z19));
  inv1   g366(.a(new_n158_), .O(z20));
  inv1   g367(.a(new_n158_), .O(z23));
  inv1   g368(.a(new_n158_), .O(z24));
  inv1   g369(.a(new_n158_), .O(z25));
  inv1   g370(.a(new_n158_), .O(z26));
  inv1   g371(.a(new_n158_), .O(z27));
endmodule
