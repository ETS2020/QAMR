...
module FAU ( 
  ...
  oai21  g205(.a(new_n361_), .b(x041), .c(new_n172_), .O(z09));
  ...
  nand3  g213(.a(new_n369_), .b(new_n172_), .c(new_n363_), .O(new_n370_));
  ...
  oai21  g235(.a(new_n278_), .b(x029), .c(new_n391_), .O(new_n392_));
  ...
  nand2  g239(.a(new_n395_), .b(new_n275_), .O(new_n396_));
  oai21  g240(.a(new_n258_), .b(x109), .c(x037), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(x117), .O(new_n398_));
  inv1   g242(.a(x101), .O(new_n399_));
  oai21  g243(.a(new_n399_), .b(x061), .c(new_n248_), .O(new_n400_));
  ...
  nand2  g254(.a(new_n244_), .b(x029), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(new_n242_), .O(new_n412_));
  nand2  g256(.a(new_n412_), .b(new_n274_), .O(new_n413_));
  aoi21  g257(.a(new_n413_), .b(new_n241_), .c(new_n394_), .O(new_n414_));
  nor2   g258(.a(new_n240_), .b(x021), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(new_n278_), .c(x069), .O(new_n416_));
  inv1   g260(.a(new_n393_), .O(new_n417_));
  nand4  g261(.a(new_n417_), .b(new_n391_), .c(new_n244_), .d(x029), .O(new_n418_));
  aoi21  g262(.a(new_n418_), .b(new_n416_), .c(x077), .O(new_n419_));
  oai21  g263(.a(new_n419_), .b(new_n414_), .c(new_n239_), .O(new_n420_));
  ...
  aoi21  g272(.a(new_n424_), .b(new_n266_), .c(new_n428_), .O(new_n429_));
  nand2  g273(.a(new_n429_), .b(new_n410_), .O(new_n430_));
  nand3  g274(.a(new_n430_), .b(new_n172_), .c(new_n390_), .O(new_n431_));
  ...
  zero   g327(.O(z21));
  zero   g328(.O(z24));
  inv1   g329(.a(new_n172_), .O(z17));
  inv1   g330(.a(new_n172_), .O(z18));
  inv1   g331(.a(new_n172_), .O(z20));
