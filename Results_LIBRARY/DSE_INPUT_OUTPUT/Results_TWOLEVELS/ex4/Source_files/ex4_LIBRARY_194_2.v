// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:47 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x110), .b(new_n157_), .O(z16));
  ...
  nand3  g142(.a(new_n298_), .b(x086), .c(x054), .O(new_n299_));
  ...
  oai22  g151(.a(new_n307_), .b(new_n303_), .c(x022), .d(x014), .O(new_n308_));
  nand2  g152(.a(x126), .b(x102), .O(new_n309_));
  inv1   g153(.a(x038), .O(new_n310_));
  inv1   g154(.a(x070), .O(new_n311_));
  oai22  g155(.a(new_n305_), .b(new_n311_), .c(new_n304_), .d(new_n310_), .O(new_n312_));
  nand2  g156(.a(new_n312_), .b(new_n309_), .O(new_n313_));
  oai21  g157(.a(x070), .b(x038), .c(new_n298_), .O(new_n314_));
  inv1   g158(.a(x086), .O(new_n315_));
  inv1   g159(.a(x126), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(x022), .c(new_n315_), .O(new_n317_));
  nand4  g161(.a(new_n317_), .b(new_n314_), .c(new_n313_), .d(new_n308_), .O(new_n318_));
  nand3  g162(.a(new_n318_), .b(x078), .c(x054), .O(new_n319_));
  nand3  g163(.a(new_n315_), .b(x038), .c(x014), .O(new_n320_));
  nand2  g164(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  nand2  g165(.a(new_n321_), .b(new_n302_), .O(new_n322_));
  nand2  g166(.a(new_n311_), .b(x038), .O(new_n323_));
  aoi21  g167(.a(new_n323_), .b(new_n299_), .c(x022), .O(new_n324_));
  inv1   g168(.a(x054), .O(new_n325_));
  nor2   g169(.a(x070), .b(new_n325_), .O(new_n326_));
  oai21  g170(.a(new_n326_), .b(new_n310_), .c(new_n307_), .O(new_n327_));
  inv1   g171(.a(x022), .O(new_n328_));
  nand2  g172(.a(new_n305_), .b(new_n304_), .O(new_n329_));
  nand3  g173(.a(new_n329_), .b(new_n309_), .c(x054), .O(new_n330_));
  aoi22  g174(.a(new_n330_), .b(x038), .c(new_n328_), .d(new_n297_), .O(new_n331_));
  nand2  g175(.a(new_n329_), .b(new_n298_), .O(new_n332_));
  aoi21  g176(.a(new_n332_), .b(new_n323_), .c(new_n325_), .O(new_n333_));
  oai21  g177(.a(new_n333_), .b(new_n331_), .c(new_n303_), .O(new_n334_));
  aoi21  g178(.a(new_n334_), .b(new_n327_), .c(new_n315_), .O(new_n335_));
  oai21  g179(.a(new_n335_), .b(new_n324_), .c(x078), .O(new_n336_));
  nor2   g180(.a(x022), .b(new_n297_), .O(new_n337_));
  aoi22  g181(.a(new_n337_), .b(new_n326_), .c(new_n325_), .d(new_n310_), .O(new_n338_));
  nand4  g182(.a(new_n338_), .b(new_n336_), .c(new_n322_), .d(new_n301_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(x046), .O(new_n340_));
  nand2  g184(.a(new_n340_), .b(new_n159_), .O(z06));
  ...
  nand2  g194(.a(new_n351_), .b(new_n169_), .O(new_n352_));
  ...
  nand3  g202(.a(x120), .b(new_n359_), .c(new_n168_), .O(new_n360_));
  ...
  nand4  g206(.a(x120), .b(new_n345_), .c(new_n163_), .d(x008), .O(new_n364_));
  inv1   g207(.a(new_n364_), .O(new_n365_));
  aoi21  g208(.a(new_n363_), .b(new_n165_), .c(new_n365_), .O(new_n366_));
  nand3  g209(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n367_));
  ...
  aoi21  g216(.a(new_n373_), .b(new_n162_), .c(new_n350_), .O(new_n374_));
  ...
  oai21  g223(.a(new_n380_), .b(new_n374_), .c(new_n164_), .O(new_n381_));
  nand2  g224(.a(new_n344_), .b(x024), .O(new_n382_));
  nand3  g225(.a(new_n382_), .b(new_n346_), .c(new_n345_), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(new_n165_), .c(x032), .O(new_n384_));
  ...
  aoi21  g232(.a(new_n385_), .b(new_n161_), .c(new_n389_), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n369_), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n159_), .c(new_n343_), .O(new_n392_));
  inv1   g235(.a(new_n392_), .O(z08));
  inv1   g236(.a(x041), .O(new_n394_));
  ...
  nand3  g243(.a(new_n400_), .b(new_n159_), .c(new_n394_), .O(new_n401_));
  inv1   g244(.a(new_n401_), .O(z09));
  inv1   g245(.a(x042), .O(new_n403_));
  ...
  oai21  g309(.a(new_n466_), .b(x045), .c(new_n159_), .O(z13));
  oai21  g310(.a(x046), .b(new_n297_), .c(x110), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(x078), .O(new_n469_));
  nand3  g312(.a(new_n157_), .b(new_n311_), .c(x006), .O(new_n470_));
  oai21  g313(.a(x086), .b(new_n297_), .c(new_n470_), .O(new_n471_));
  oai21  g314(.a(x118), .b(x110), .c(new_n471_), .O(new_n472_));
  oai22  g315(.a(new_n329_), .b(x030), .c(new_n328_), .d(new_n297_), .O(new_n473_));
  inv1   g316(.a(x102), .O(new_n474_));
  nand2  g317(.a(new_n316_), .b(new_n474_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n304_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n298_), .O(new_n477_));
  nand3  g320(.a(x102), .b(new_n305_), .c(new_n311_), .O(new_n478_));
  oai21  g321(.a(new_n316_), .b(new_n298_), .c(new_n478_), .O(new_n479_));
  aoi21  g322(.a(new_n477_), .b(new_n310_), .c(new_n479_), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(new_n473_), .c(x110), .O(new_n481_));
  oai22  g324(.a(x118), .b(x022), .c(x094), .d(x070), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x126), .O(new_n483_));
  aoi21  g326(.a(x110), .b(new_n310_), .c(x086), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n483_), .c(x078), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n481_), .c(x006), .O(new_n486_));
  nand2  g329(.a(x110), .b(new_n157_), .O(new_n487_));
  oai21  g330(.a(new_n298_), .b(x110), .c(new_n487_), .O(new_n488_));
  oai21  g331(.a(new_n306_), .b(new_n303_), .c(new_n328_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(new_n488_), .O(new_n490_));
  nand2  g333(.a(new_n329_), .b(new_n157_), .O(new_n491_));
  inv1   g334(.a(x110), .O(new_n492_));
  nand3  g335(.a(new_n492_), .b(x030), .c(new_n328_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n491_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(x070), .O(new_n495_));
  aoi21  g338(.a(x022), .b(x014), .c(new_n306_), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n475_), .c(new_n492_), .d(x030), .O(new_n497_));
  nand3  g340(.a(new_n497_), .b(new_n495_), .c(new_n490_), .O(new_n498_));
  nor3   g341(.a(new_n311_), .b(new_n328_), .c(x014), .O(new_n499_));
  aoi21  g342(.a(new_n498_), .b(new_n315_), .c(new_n499_), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n486_), .c(new_n472_), .O(new_n501_));
  nand3  g344(.a(x086), .b(new_n310_), .c(x006), .O(new_n502_));
  nand4  g345(.a(new_n492_), .b(new_n315_), .c(x038), .d(x030), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n297_), .O(new_n505_));
  aoi21  g348(.a(new_n493_), .b(new_n491_), .c(x086), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(x054), .c(x038), .O(new_n507_));
  nand4  g350(.a(new_n157_), .b(x070), .c(new_n310_), .d(x022), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n507_), .c(new_n505_), .O(new_n509_));
  aoi21  g352(.a(new_n501_), .b(new_n325_), .c(new_n509_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(x046), .c(new_n469_), .O(z14));
  zero   g354(.O(z07));
  zero   g355(.O(z15));
  zero   g356(.O(z21));
  zero   g357(.O(z23));
  ...
  zero   g359(.O(z25));
  zero   g360(.O(z27));
  nor2   g361(.a(x110), .b(new_n157_), .O(z17));
  nor2   g362(.a(x110), .b(new_n157_), .O(z18));
  nor2   g363(.a(x110), .b(new_n157_), .O(z19));
  nor2   g364(.a(x110), .b(new_n157_), .O(z20));
  nor2   g365(.a(x110), .b(new_n157_), .O(z22));
  nor2   g366(.a(x110), .b(new_n157_), .O(z26));
endmodule
