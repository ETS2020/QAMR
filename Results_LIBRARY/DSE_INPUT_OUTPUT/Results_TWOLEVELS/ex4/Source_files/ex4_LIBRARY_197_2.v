...
module FAU ( 
  ...
  nor2   g015(.a(x126), .b(new_n158_), .O(z07));
  ...
  zero   g361(.O(z23));
  zero   g362(.O(z27));
  nor2   g363(.a(x126), .b(new_n158_), .O(z16));
  nor2   g364(.a(x126), .b(new_n158_), .O(z19));
  nor2   g365(.a(x126), .b(new_n158_), .O(z24));
  nor2   g366(.a(x126), .b(new_n158_), .O(z25));
  nor2   g367(.a(x126), .b(new_n158_), .O(z26));
endmodule
