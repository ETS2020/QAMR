// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:45 2020
...
module FAU ( 
  ...
  wire new_n157_, new_n159_, new_n160_, new_n161_, new_n162_, new_n163_,
    ...
    new_n508_, new_n509_, new_n510_, new_n511_;
  inv1   g000(.a(x070), .O(new_n157_));
  ...
  aoi21  g141(.a(x046), .b(new_n297_), .c(x070), .O(new_n298_));
  inv1   g142(.a(x110), .O(new_n299_));
  inv1   g143(.a(x118), .O(new_n300_));
  nand2  g144(.a(x078), .b(x038), .O(new_n301_));
  aoi21  g145(.a(new_n301_), .b(new_n157_), .c(x006), .O(new_n302_));
  ...
  nand3  g151(.a(new_n307_), .b(x078), .c(new_n304_), .O(new_n308_));
  nand2  g152(.a(x022), .b(x014), .O(new_n309_));
  inv1   g153(.a(new_n309_), .O(new_n310_));
  aoi21  g154(.a(new_n310_), .b(new_n308_), .c(new_n303_), .O(new_n311_));
  oai22  g155(.a(new_n311_), .b(new_n302_), .c(new_n300_), .d(new_n299_), .O(new_n312_));
  inv1   g156(.a(x022), .O(new_n313_));
  nand2  g157(.a(x126), .b(x102), .O(new_n314_));
  nand3  g158(.a(new_n314_), .b(new_n307_), .c(x086), .O(new_n315_));
  nand2  g159(.a(new_n315_), .b(x006), .O(new_n316_));
  nand2  g160(.a(new_n316_), .b(new_n304_), .O(new_n317_));
  inv1   g161(.a(x006), .O(new_n318_));
  nand2  g162(.a(x094), .b(x062), .O(new_n319_));
  nand2  g163(.a(new_n319_), .b(new_n318_), .O(new_n320_));
  aoi22  g164(.a(new_n320_), .b(new_n317_), .c(new_n313_), .d(new_n297_), .O(new_n321_));
  nand3  g165(.a(x086), .b(new_n157_), .c(new_n304_), .O(new_n322_));
  inv1   g166(.a(x126), .O(new_n323_));
  nand3  g167(.a(new_n323_), .b(x118), .c(new_n318_), .O(new_n324_));
  nand2  g168(.a(new_n324_), .b(new_n322_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(x022), .O(new_n326_));
  nand3  g170(.a(new_n319_), .b(x086), .c(new_n157_), .O(new_n327_));
  inv1   g171(.a(x102), .O(new_n328_));
  nand3  g172(.a(new_n328_), .b(x062), .c(x038), .O(new_n329_));
  nand3  g173(.a(new_n323_), .b(new_n300_), .c(x110), .O(new_n330_));
  nand3  g174(.a(new_n330_), .b(new_n329_), .c(x086), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n318_), .O(new_n332_));
  nand3  g176(.a(new_n332_), .b(new_n327_), .c(new_n326_), .O(new_n333_));
  oai21  g177(.a(new_n333_), .b(new_n321_), .c(x078), .O(new_n334_));
  nand2  g178(.a(new_n314_), .b(x094), .O(new_n335_));
  nand2  g179(.a(new_n323_), .b(x062), .O(new_n336_));
  aoi21  g180(.a(new_n336_), .b(new_n335_), .c(new_n157_), .O(new_n337_));
  nor2   g181(.a(x070), .b(x022), .O(new_n338_));
  aoi22  g182(.a(new_n338_), .b(x014), .c(new_n337_), .d(new_n318_), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n334_), .c(new_n312_), .O(new_n340_));
  inv1   g184(.a(x038), .O(new_n341_));
  nand4  g185(.a(x086), .b(x078), .c(new_n341_), .d(new_n304_), .O(new_n342_));
  nand3  g186(.a(new_n303_), .b(x038), .c(new_n318_), .O(new_n343_));
  nand2  g187(.a(new_n343_), .b(new_n342_), .O(new_n344_));
  nand2  g188(.a(new_n344_), .b(x014), .O(new_n345_));
  inv1   g189(.a(new_n319_), .O(new_n346_));
  oai21  g190(.a(x030), .b(new_n313_), .c(new_n346_), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(x086), .c(x078), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(x054), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(new_n341_), .O(new_n350_));
  nand4  g194(.a(x078), .b(new_n157_), .c(x038), .d(new_n313_), .O(new_n351_));
  nand3  g195(.a(new_n351_), .b(new_n350_), .c(new_n345_), .O(new_n352_));
  aoi21  g196(.a(new_n340_), .b(x054), .c(new_n352_), .O(new_n353_));
  oai22  g197(.a(new_n353_), .b(new_n296_), .c(new_n298_), .d(x078), .O(z06));
  ...
  nand4  g220(.a(x120), .b(new_n358_), .c(new_n163_), .d(x008), .O(new_n378_));
  ...
  aoi21  g230(.a(new_n387_), .b(new_n162_), .c(new_n366_), .O(new_n388_));
  ...
  oai21  g236(.a(new_n393_), .b(new_n388_), .c(new_n164_), .O(new_n394_));
  ...
  nand2  g246(.a(new_n403_), .b(new_n383_), .O(new_n404_));
  ...
  nand3  g256(.a(new_n413_), .b(new_n159_), .c(new_n407_), .O(new_n414_));
  ...
  oai21  g286(.a(new_n280_), .b(x029), .c(new_n443_), .O(new_n444_));
  inv1   g287(.a(x101), .O(new_n445_));
  aoi21  g288(.a(new_n261_), .b(new_n445_), .c(x093), .O(new_n446_));
  nor2   g289(.a(x117), .b(x109), .O(new_n447_));
  inv1   g290(.a(new_n447_), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(new_n446_), .c(new_n277_), .O(new_n449_));
  oai21  g292(.a(new_n261_), .b(x109), .c(x037), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(x117), .O(new_n451_));
  oai21  g294(.a(new_n445_), .b(x061), .c(new_n251_), .O(new_n452_));
  nand3  g295(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n269_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n256_), .c(new_n454_), .O(new_n455_));
  nand4  g298(.a(new_n455_), .b(new_n451_), .c(new_n449_), .d(new_n444_), .O(new_n456_));
  nand4  g299(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n457_));
  inv1   g300(.a(new_n457_), .O(new_n458_));
  aoi21  g301(.a(new_n456_), .b(new_n276_), .c(new_n458_), .O(new_n459_));
  nand3  g302(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n460_));
  oai21  g303(.a(new_n459_), .b(x053), .c(new_n460_), .O(new_n461_));
  aoi21  g304(.a(new_n247_), .b(x029), .c(x021), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(x077), .c(new_n244_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n448_), .O(new_n464_));
  nand2  g307(.a(x029), .b(new_n245_), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n272_), .c(new_n277_), .O(new_n466_));
  nand2  g309(.a(new_n261_), .b(new_n445_), .O(new_n467_));
  nand4  g310(.a(new_n467_), .b(new_n443_), .c(new_n247_), .d(x029), .O(new_n468_));
  inv1   g311(.a(new_n468_), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n466_), .c(new_n276_), .O(new_n470_));
  ...
  inv1   g326(.a(x078), .O(new_n484_));
  inv1   g327(.a(new_n307_), .O(new_n485_));
  oai21  g328(.a(new_n310_), .b(new_n304_), .c(new_n485_), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n303_), .c(new_n484_), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n483_), .c(x070), .O(new_n488_));
  nor2   g331(.a(new_n484_), .b(new_n483_), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n488_), .c(x038), .O(new_n490_));
  aoi21  g333(.a(new_n319_), .b(x030), .c(x022), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(x086), .c(new_n318_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n484_), .O(new_n493_));
  nand2  g336(.a(new_n303_), .b(x014), .O(new_n494_));
  aoi22  g337(.a(new_n494_), .b(new_n493_), .c(new_n300_), .d(new_n299_), .O(new_n495_));
  nand2  g338(.a(new_n323_), .b(new_n328_), .O(new_n496_));
  nand3  g339(.a(new_n496_), .b(new_n319_), .c(new_n303_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n318_), .c(new_n304_), .O(new_n498_));
  nor2   g341(.a(new_n485_), .b(new_n318_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n498_), .c(new_n309_), .O(new_n500_));
  aoi21  g343(.a(new_n323_), .b(new_n328_), .c(new_n346_), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(x086), .c(x006), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n500_), .c(x078), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n495_), .c(new_n157_), .O(new_n504_));
  nand3  g347(.a(x078), .b(x070), .c(x022), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n504_), .O(new_n506_));
  nand3  g349(.a(new_n484_), .b(new_n157_), .c(new_n297_), .O(new_n507_));
  oai21  g350(.a(new_n484_), .b(x038), .c(new_n507_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(x086), .c(x006), .O(new_n509_));
  oai21  g352(.a(new_n484_), .b(new_n297_), .c(new_n509_), .O(new_n510_));
  aoi21  g353(.a(new_n506_), .b(new_n483_), .c(new_n510_), .O(new_n511_));
  aoi21  g354(.a(new_n511_), .b(new_n490_), .c(x046), .O(z14));
  zero   g355(.O(z07));
  zero   g356(.O(z16));
  zero   g357(.O(z17));
  zero   g358(.O(z18));
  ...
  zero   g363(.O(z25));
  zero   g364(.O(z26));
  nor2   g365(.a(x078), .b(new_n157_), .O(z19));
  nor2   g366(.a(x078), .b(new_n157_), .O(z23));
  nor2   g367(.a(x078), .b(new_n157_), .O(z27));
endmodule
