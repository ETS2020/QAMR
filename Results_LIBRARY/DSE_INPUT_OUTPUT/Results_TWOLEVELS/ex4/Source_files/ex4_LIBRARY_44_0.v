// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:23 2020
...
module FAU ( 
  ...
  nand4  g106(.a(new_n258_), .b(x093), .c(x037), .d(new_n242_), .O(new_n263_));
  ...
  oai21  g143(.a(new_n299_), .b(x014), .c(x037), .O(new_n300_));
  ...
  nor2   g182(.a(x030), .b(new_n306_), .O(new_n339_));
  oai21  g183(.a(new_n339_), .b(new_n308_), .c(new_n338_), .O(new_n340_));
  inv1   g184(.a(new_n334_), .O(new_n341_));
  nand4  g185(.a(new_n341_), .b(new_n310_), .c(new_n307_), .d(new_n304_), .O(new_n342_));
  aoi21  g186(.a(new_n342_), .b(new_n340_), .c(new_n298_), .O(new_n343_));
  oai21  g187(.a(new_n343_), .b(new_n337_), .c(x054), .O(new_n344_));
  inv1   g188(.a(new_n308_), .O(new_n345_));
  nand2  g189(.a(new_n307_), .b(new_n304_), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n345_), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(x078), .c(new_n317_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n344_), .O(new_n349_));
  oai22  g193(.a(new_n298_), .b(new_n317_), .c(new_n303_), .d(new_n305_), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n338_), .c(new_n306_), .O(new_n351_));
  oai21  g195(.a(x054), .b(x038), .c(new_n351_), .O(new_n352_));
  aoi21  g196(.a(new_n349_), .b(x086), .c(new_n352_), .O(new_n353_));
  nand2  g197(.a(new_n353_), .b(new_n333_), .O(new_n354_));
  nand2  g198(.a(new_n354_), .b(x046), .O(new_n355_));
  nand2  g199(.a(new_n355_), .b(new_n301_), .O(z06));
  inv1   g200(.a(x024), .O(new_n357_));
  nor2   g201(.a(x088), .b(x056), .O(new_n358_));
  nand2  g202(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  oai21  g203(.a(new_n165_), .b(new_n159_), .c(new_n359_), .O(new_n360_));
  ...
  aoi22  g230(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n387_));
  nand3  g231(.a(new_n387_), .b(new_n386_), .c(x024), .O(new_n388_));
  inv1   g232(.a(new_n388_), .O(new_n389_));
  oai21  g233(.a(new_n389_), .b(new_n385_), .c(new_n162_), .O(new_n390_));
  aoi21  g234(.a(new_n390_), .b(new_n383_), .c(x048), .O(new_n391_));
  oai21  g235(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n392_));
  ...
  inv1   g281(.a(x077), .O(new_n438_));
  oai22  g282(.a(new_n280_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n439_));
  inv1   g283(.a(x101), .O(new_n440_));
  oai22  g284(.a(new_n258_), .b(x069), .c(new_n440_), .d(x037), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n256_), .O(new_n442_));
  nand2  g286(.a(new_n251_), .b(new_n253_), .O(new_n443_));
  oai21  g287(.a(new_n270_), .b(new_n252_), .c(new_n443_), .O(new_n444_));
  nand2  g288(.a(x117), .b(new_n253_), .O(new_n445_));
  oai21  g289(.a(x117), .b(x021), .c(new_n445_), .O(new_n446_));
  nand3  g290(.a(x101), .b(new_n270_), .c(new_n247_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n266_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(x125), .c(new_n448_), .O(new_n449_));
  nand4  g293(.a(new_n449_), .b(new_n444_), .c(new_n442_), .d(new_n439_), .O(new_n450_));
  nand4  g294(.a(x125), .b(new_n247_), .c(new_n252_), .d(x013), .O(new_n451_));
  inv1   g295(.a(new_n451_), .O(new_n452_));
  aoi21  g296(.a(new_n450_), .b(new_n438_), .c(new_n452_), .O(new_n453_));
  nand3  g297(.a(x085), .b(new_n252_), .c(new_n242_), .O(new_n454_));
  oai21  g298(.a(new_n453_), .b(x053), .c(new_n454_), .O(new_n455_));
  nand3  g299(.a(new_n266_), .b(new_n240_), .c(x029), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n243_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n252_), .O(new_n458_));
  nand3  g302(.a(new_n280_), .b(new_n266_), .c(new_n240_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n458_), .c(new_n270_), .O(new_n460_));
  nand2  g304(.a(new_n245_), .b(x029), .O(new_n461_));
  aoi22  g305(.a(new_n461_), .b(new_n243_), .c(new_n251_), .d(new_n253_), .O(new_n462_));
  nand2  g306(.a(new_n258_), .b(new_n440_), .O(new_n463_));
  aoi22  g307(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n464_));
  ...
  aoi21  g311(.a(x021), .b(x013), .c(new_n241_), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n280_), .c(x037), .O(new_n469_));
  aoi21  g313(.a(new_n469_), .b(new_n467_), .c(x085), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n460_), .c(new_n438_), .O(new_n471_));
  nand3  g315(.a(new_n443_), .b(new_n266_), .c(new_n240_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n438_), .O(new_n473_));
  nand4  g317(.a(x069), .b(new_n240_), .c(x021), .d(new_n242_), .O(new_n474_));
  oai21  g318(.a(new_n240_), .b(new_n252_), .c(new_n474_), .O(new_n475_));
  aoi21  g319(.a(new_n473_), .b(x013), .c(new_n475_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n471_), .O(new_n477_));
  aoi21  g321(.a(new_n455_), .b(x005), .c(new_n477_), .O(new_n478_));
  oai21  g322(.a(new_n478_), .b(x045), .c(new_n173_), .O(z13));
  oai22  g323(.a(new_n341_), .b(x030), .c(new_n306_), .d(new_n305_), .O(new_n480_));
  inv1   g324(.a(x102), .O(new_n481_));
  aoi21  g325(.a(new_n322_), .b(new_n481_), .c(x094), .O(new_n482_));
  nand2  g326(.a(new_n313_), .b(new_n312_), .O(new_n483_));
  oai21  g327(.a(new_n483_), .b(new_n482_), .c(new_n338_), .O(new_n484_));
  oai21  g328(.a(new_n322_), .b(x110), .c(x038), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(x118), .O(new_n486_));
  oai21  g330(.a(new_n481_), .b(x062), .c(new_n312_), .O(new_n487_));
  nand3  g331(.a(x126), .b(new_n313_), .c(new_n306_), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(new_n330_), .O(new_n489_));
  aoi21  g333(.a(new_n487_), .b(new_n317_), .c(new_n489_), .O(new_n490_));
  nand4  g334(.a(new_n490_), .b(new_n486_), .c(new_n484_), .d(new_n480_), .O(new_n491_));
  nand4  g335(.a(x126), .b(new_n320_), .c(new_n317_), .d(x014), .O(new_n492_));
  inv1   g336(.a(new_n492_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n298_), .c(new_n493_), .O(new_n494_));
  nand3  g338(.a(x086), .b(new_n317_), .c(new_n305_), .O(new_n495_));
  oai21  g339(.a(new_n494_), .b(x054), .c(new_n495_), .O(new_n496_));
  aoi21  g340(.a(new_n308_), .b(x030), .c(x022), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(x078), .c(new_n305_), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n483_), .O(new_n499_));
  nand2  g343(.a(x030), .b(new_n306_), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(new_n334_), .c(new_n338_), .O(new_n501_));
  nand2  g345(.a(new_n322_), .b(new_n481_), .O(new_n502_));
  aoi22  g346(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n502_), .c(x030), .O(new_n504_));
  inv1   g348(.a(new_n504_), .O(new_n505_));
  oai21  g349(.a(new_n505_), .b(new_n501_), .c(new_n298_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n499_), .c(x054), .O(new_n507_));
  oai21  g351(.a(new_n306_), .b(new_n305_), .c(x030), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n334_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n298_), .c(x038), .O(new_n510_));
  inv1   g354(.a(new_n510_), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n507_), .c(new_n330_), .O(new_n512_));
  ...
  oai21  g361(.a(new_n517_), .b(x046), .c(new_n173_), .O(z14));
  zero   g362(.O(z15));
  zero   g363(.O(z19));
  zero   g364(.O(z21));
  zero   g365(.O(z22));
  zero   g366(.O(z23));
  zero   g367(.O(z27));
  nor2   g368(.a(x078), .b(x037), .O(z16));
  nor2   g369(.a(x078), .b(x037), .O(z17));
  nor2   g370(.a(x078), .b(x037), .O(z18));
  nor2   g371(.a(x078), .b(x037), .O(z20));
  nor2   g372(.a(x078), .b(x037), .O(z24));
  nor2   g373(.a(x078), .b(x037), .O(z25));
  nor2   g374(.a(x078), .b(x037), .O(z26));
endmodule
