// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:39 2020
...
module FAU ( 
  ...
  aoi21  g047(.a(new_n203_), .b(new_n198_), .c(new_n157_), .O(new_n204_));
  nor2   g048(.a(x050), .b(x034), .O(new_n205_));
  oai21  g049(.a(new_n205_), .b(new_n204_), .c(x078), .O(new_n206_));
  inv1   g050(.a(new_n205_), .O(new_n207_));
  nand3  g051(.a(new_n200_), .b(x050), .c(new_n199_), .O(new_n208_));
  nand3  g052(.a(new_n194_), .b(x034), .c(new_n193_), .O(new_n209_));
  nand4  g053(.a(new_n209_), .b(new_n208_), .c(new_n207_), .d(x010), .O(new_n210_));
  nand2  g054(.a(new_n210_), .b(new_n157_), .O(new_n211_));
  aoi21  g055(.a(new_n211_), .b(new_n206_), .c(new_n192_), .O(z02));
  ...
  nand3  g070(.a(new_n226_), .b(new_n159_), .c(x043), .O(new_n227_));
  ...
  oai21  g262(.a(new_n418_), .b(x041), .c(new_n159_), .O(z09));
  nand2  g263(.a(x050), .b(x010), .O(new_n420_));
  nand3  g264(.a(new_n420_), .b(x082), .c(x002), .O(new_n421_));
  nand2  g265(.a(x034), .b(x010), .O(new_n422_));
  nand3  g266(.a(new_n422_), .b(x066), .c(x018), .O(new_n423_));
  nand2  g267(.a(x050), .b(x034), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(new_n423_), .c(new_n421_), .O(new_n425_));
  nand2  g269(.a(new_n425_), .b(new_n157_), .O(new_n426_));
  nand3  g270(.a(x066), .b(new_n196_), .c(x018), .O(new_n427_));
  nand3  g271(.a(x082), .b(new_n201_), .c(x002), .O(new_n428_));
  nand3  g272(.a(new_n428_), .b(new_n427_), .c(new_n195_), .O(new_n429_));
  nand2  g273(.a(new_n429_), .b(x074), .O(new_n430_));
  nand2  g274(.a(new_n430_), .b(new_n424_), .O(new_n431_));
  nand2  g275(.a(new_n431_), .b(x078), .O(new_n432_));
  aoi21  g276(.a(new_n432_), .b(new_n426_), .c(x042), .O(z10));
  ...
  oai21  g284(.a(new_n440_), .b(x043), .c(new_n159_), .O(z11));
  ...
  nand3  g292(.a(new_n448_), .b(new_n159_), .c(new_n442_), .O(new_n449_));
  inv1   g293(.a(new_n449_), .O(z12));
  inv1   g294(.a(x045), .O(new_n451_));
  nand2  g295(.a(x021), .b(x013), .O(new_n452_));
  oai21  g296(.a(new_n285_), .b(x029), .c(new_n452_), .O(new_n453_));
  nor2   g297(.a(x125), .b(x101), .O(new_n454_));
  nor2   g298(.a(x117), .b(x109), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x093), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n282_), .O(new_n457_));
  oai21  g301(.a(new_n265_), .b(x109), .c(x037), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(x117), .O(new_n459_));
  inv1   g303(.a(x101), .O(new_n460_));
  oai21  g304(.a(new_n460_), .b(x061), .c(new_n255_), .O(new_n461_));
  nand3  g305(.a(x125), .b(new_n256_), .c(new_n249_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n273_), .O(new_n463_));
  aoi21  g307(.a(new_n461_), .b(new_n260_), .c(new_n463_), .O(new_n464_));
  nand4  g308(.a(new_n464_), .b(new_n459_), .c(new_n457_), .d(new_n453_), .O(new_n465_));
  nand4  g309(.a(x125), .b(new_n263_), .c(new_n260_), .d(x013), .O(new_n466_));
  inv1   g310(.a(new_n466_), .O(new_n467_));
  aoi21  g311(.a(new_n465_), .b(new_n281_), .c(new_n467_), .O(new_n468_));
  nand3  g312(.a(x085), .b(new_n260_), .c(new_n248_), .O(new_n469_));
  oai21  g313(.a(new_n468_), .b(x053), .c(new_n469_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(x005), .O(new_n471_));
  nand2  g315(.a(new_n251_), .b(x029), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n249_), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n281_), .O(new_n474_));
  aoi21  g318(.a(new_n474_), .b(new_n248_), .c(new_n455_), .O(new_n475_));
  nor2   g319(.a(new_n247_), .b(x021), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(new_n285_), .c(x069), .O(new_n477_));
  inv1   g321(.a(new_n454_), .O(new_n478_));
  nand4  g322(.a(new_n478_), .b(new_n452_), .c(new_n251_), .d(x029), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n477_), .c(x077), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n475_), .c(new_n246_), .O(new_n481_));
  nand2  g325(.a(new_n452_), .b(x029), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n277_), .O(new_n483_));
  nand3  g327(.a(new_n483_), .b(new_n281_), .c(x037), .O(new_n484_));
  ...
  aoi21  g333(.a(new_n485_), .b(new_n273_), .c(new_n489_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n471_), .O(new_n491_));
  nand3  g335(.a(new_n491_), .b(new_n159_), .c(new_n451_), .O(new_n492_));
  inv1   g336(.a(new_n492_), .O(z13));
  oai22  g337(.a(new_n345_), .b(x030), .c(new_n310_), .d(new_n309_), .O(new_n494_));
  inv1   g338(.a(x102), .O(new_n495_));
  aoi21  g339(.a(new_n326_), .b(new_n495_), .c(x094), .O(new_n496_));
  nor2   g340(.a(x118), .b(x110), .O(new_n497_));
  inv1   g341(.a(new_n497_), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(new_n496_), .c(new_n342_), .O(new_n499_));
  oai21  g343(.a(new_n326_), .b(x110), .c(x038), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(x118), .O(new_n501_));
  oai21  g345(.a(new_n495_), .b(x062), .c(new_n316_), .O(new_n502_));
  nand3  g346(.a(x126), .b(new_n317_), .c(new_n310_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n334_), .O(new_n504_));
  aoi21  g348(.a(new_n502_), .b(new_n321_), .c(new_n504_), .O(new_n505_));
  nand4  g349(.a(new_n505_), .b(new_n501_), .c(new_n499_), .d(new_n494_), .O(new_n506_));
  nand4  g350(.a(x126), .b(new_n324_), .c(new_n321_), .d(x014), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  aoi21  g352(.a(new_n506_), .b(new_n302_), .c(new_n508_), .O(new_n509_));
  nand3  g353(.a(x086), .b(new_n321_), .c(new_n309_), .O(new_n510_));
  oai21  g354(.a(new_n509_), .b(x054), .c(new_n510_), .O(new_n511_));
  nand3  g355(.a(new_n334_), .b(new_n307_), .c(x030), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n310_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n321_), .O(new_n514_));
  nand3  g358(.a(new_n345_), .b(new_n334_), .c(new_n307_), .O(new_n515_));
  aoi21  g359(.a(new_n515_), .b(new_n514_), .c(new_n342_), .O(new_n516_));
  nand2  g360(.a(new_n312_), .b(x030), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n310_), .c(new_n497_), .O(new_n518_));
  nand2  g362(.a(new_n326_), .b(new_n495_), .O(new_n519_));
  aoi22  g363(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n520_));
  nand3  g364(.a(new_n520_), .b(new_n519_), .c(x030), .O(new_n521_));
  inv1   g365(.a(new_n521_), .O(new_n522_));
  oai21  g366(.a(new_n522_), .b(new_n518_), .c(new_n307_), .O(new_n523_));
  aoi21  g367(.a(x022), .b(x014), .c(new_n308_), .O(new_n524_));
  oai21  g368(.a(new_n524_), .b(new_n345_), .c(x038), .O(new_n525_));
  aoi21  g369(.a(new_n525_), .b(new_n523_), .c(x086), .O(new_n526_));
  oai21  g370(.a(new_n526_), .b(new_n516_), .c(new_n302_), .O(new_n527_));
  nand3  g371(.a(new_n498_), .b(new_n334_), .c(new_n307_), .O(new_n528_));
  nand2  g372(.a(new_n528_), .b(new_n302_), .O(new_n529_));
  nand4  g373(.a(x070), .b(new_n307_), .c(x022), .d(new_n309_), .O(new_n530_));
  oai21  g374(.a(new_n307_), .b(new_n321_), .c(new_n530_), .O(new_n531_));
  aoi21  g375(.a(new_n529_), .b(x014), .c(new_n531_), .O(new_n532_));
  nand2  g376(.a(new_n532_), .b(new_n527_), .O(new_n533_));
  aoi21  g377(.a(new_n511_), .b(x006), .c(new_n533_), .O(new_n534_));
  ...
  zero   g384(.O(z26));
  zero   g385(.O(z27));
  nor2   g386(.a(x078), .b(new_n157_), .O(z15));
  nor2   g387(.a(x078), .b(new_n157_), .O(z17));
  nor2   g388(.a(x078), .b(new_n157_), .O(z18));
  nor2   g389(.a(x078), .b(new_n157_), .O(z21));
  nor2   g390(.a(x078), .b(new_n157_), .O(z22));
  nor2   g391(.a(x078), .b(new_n157_), .O(z25));
endmodule
