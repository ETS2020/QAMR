...
module FAU ( 
  ...
  nand2  g300(.a(new_n245_), .b(x029), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n243_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n275_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n242_), .c(new_n440_), .O(new_n460_));
  ...
  nand4  g307(.a(new_n463_), .b(new_n437_), .c(new_n245_), .d(x029), .O(new_n464_));
  ...
  nand3  g320(.a(new_n476_), .b(new_n173_), .c(new_n436_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  aoi21  g322(.a(x054), .b(x038), .c(x014), .O(new_n479_));
  nand3  g323(.a(x070), .b(new_n298_), .c(x022), .O(new_n480_));
  nand3  g324(.a(x086), .b(new_n312_), .c(x006), .O(new_n481_));
  nand4  g325(.a(new_n481_), .b(new_n480_), .c(new_n479_), .d(x078), .O(new_n482_));
  and2   g326(.a(new_n482_), .b(new_n296_), .O(z14));
  zero   g327(.O(z16));
  zero   g328(.O(z19));
  zero   g329(.O(z21));
  zero   g330(.O(z22));
  zero   g331(.O(z26));
  zero   g332(.O(z27));
  nor2   g333(.a(x078), .b(x046), .O(z15));
  nor2   g334(.a(x078), .b(x046), .O(z17));
  nor2   g335(.a(x078), .b(x046), .O(z18));
  nor2   g336(.a(x078), .b(x046), .O(z20));
