...
module FAU ( 
  ...
  oai21  g154(.a(new_n165_), .b(new_n159_), .c(new_n311_), .O(new_n312_));
  ...
  oai21  g161(.a(new_n318_), .b(new_n315_), .c(new_n166_), .O(new_n319_));
  ...
  nand3  g165(.a(x120), .b(new_n317_), .c(new_n165_), .O(new_n323_));
  nand2  g166(.a(new_n323_), .b(new_n158_), .O(new_n324_));
  aoi21  g167(.a(new_n322_), .b(new_n160_), .c(new_n324_), .O(new_n325_));
  nand4  g168(.a(new_n325_), .b(new_n321_), .c(new_n319_), .d(new_n312_), .O(new_n326_));
  nor2   g169(.a(x032), .b(new_n159_), .O(new_n327_));
  nor2   g170(.a(new_n314_), .b(x056), .O(new_n328_));
  aoi22  g171(.a(new_n328_), .b(new_n327_), .c(new_n326_), .d(new_n162_), .O(new_n329_));
  nand3  g172(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n330_));
  ...
  oai21  g176(.a(new_n333_), .b(x072), .c(new_n159_), .O(new_n334_));
  nand2  g177(.a(new_n334_), .b(new_n318_), .O(new_n335_));
  nand2  g178(.a(x024), .b(new_n165_), .O(new_n336_));
  aoi21  g179(.a(new_n336_), .b(new_n310_), .c(new_n166_), .O(new_n337_));
  ...
  oai21  g184(.a(new_n341_), .b(new_n337_), .c(new_n162_), .O(new_n342_));
  aoi21  g185(.a(new_n342_), .b(new_n335_), .c(x048), .O(new_n343_));
  oai21  g186(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n344_));
  nand2  g187(.a(new_n344_), .b(new_n310_), .O(new_n345_));
  nand3  g188(.a(new_n345_), .b(new_n162_), .c(x032), .O(new_n346_));
  inv1   g189(.a(new_n346_), .O(new_n347_));
  oai21  g190(.a(new_n347_), .b(new_n343_), .c(new_n158_), .O(new_n348_));
  ...
  oai21  g196(.a(new_n353_), .b(x040), .c(new_n172_), .O(z08));
  inv1   g197(.a(x041), .O(new_n355_));
  oai22  g198(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n356_));
  nand3  g199(.a(new_n356_), .b(x081), .c(x001), .O(new_n357_));
  oai22  g200(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n358_));
  nand3  g201(.a(new_n358_), .b(x065), .c(x017), .O(new_n359_));
  aoi22  g202(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n360_));
  nand3  g203(.a(new_n360_), .b(new_n359_), .c(new_n357_), .O(new_n361_));
  nand3  g204(.a(new_n361_), .b(new_n172_), .c(new_n355_), .O(new_n362_));
  inv1   g205(.a(new_n362_), .O(z09));
  ...
  oai21  g213(.a(new_n370_), .b(x042), .c(new_n172_), .O(z10));
  ...
  nand3  g221(.a(new_n378_), .b(new_n172_), .c(new_n372_), .O(new_n379_));
  ...
  oai21  g230(.a(new_n387_), .b(x044), .c(new_n172_), .O(z12));
  inv1   g231(.a(x045), .O(new_n389_));
  nand2  g232(.a(x021), .b(x013), .O(new_n390_));
  oai21  g233(.a(new_n278_), .b(x029), .c(new_n390_), .O(new_n391_));
  nor2   g234(.a(x125), .b(x101), .O(new_n392_));
  nor2   g235(.a(x117), .b(x109), .O(new_n393_));
  oai21  g236(.a(new_n392_), .b(x093), .c(new_n393_), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(new_n275_), .O(new_n395_));
  oai21  g238(.a(new_n258_), .b(x109), .c(x037), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(x117), .O(new_n397_));
  inv1   g240(.a(x101), .O(new_n398_));
  oai21  g241(.a(new_n398_), .b(x061), .c(new_n248_), .O(new_n399_));
  nand3  g242(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(new_n266_), .O(new_n401_));
  aoi21  g244(.a(new_n399_), .b(new_n253_), .c(new_n401_), .O(new_n402_));
  nand4  g245(.a(new_n402_), .b(new_n397_), .c(new_n395_), .d(new_n391_), .O(new_n403_));
  nand4  g246(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n404_));
  inv1   g247(.a(new_n404_), .O(new_n405_));
  aoi21  g248(.a(new_n403_), .b(new_n274_), .c(new_n405_), .O(new_n406_));
  nand3  g249(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n407_));
  oai21  g250(.a(new_n406_), .b(x053), .c(new_n407_), .O(new_n408_));
  nand2  g251(.a(new_n408_), .b(x005), .O(new_n409_));
  nand2  g252(.a(new_n244_), .b(x029), .O(new_n410_));
  nand2  g253(.a(new_n410_), .b(new_n242_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n274_), .O(new_n412_));
  aoi21  g255(.a(new_n412_), .b(new_n241_), .c(new_n393_), .O(new_n413_));
  nor2   g256(.a(new_n240_), .b(x021), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(new_n278_), .c(x069), .O(new_n415_));
  inv1   g258(.a(new_n392_), .O(new_n416_));
  nand4  g259(.a(new_n416_), .b(new_n390_), .c(new_n244_), .d(x029), .O(new_n417_));
  aoi21  g260(.a(new_n417_), .b(new_n415_), .c(x077), .O(new_n418_));
  oai21  g261(.a(new_n418_), .b(new_n413_), .c(new_n239_), .O(new_n419_));
  nand2  g262(.a(new_n390_), .b(x029), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(new_n270_), .O(new_n421_));
  nand3  g264(.a(new_n421_), .b(new_n274_), .c(x037), .O(new_n422_));
  nand2  g265(.a(new_n422_), .b(new_n419_), .O(new_n423_));
  oai22  g266(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(x069), .c(x021), .O(new_n425_));
  aoi22  g268(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n426_));
  nand2  g269(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  aoi21  g270(.a(new_n423_), .b(new_n266_), .c(new_n427_), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n409_), .O(new_n429_));
  nand3  g272(.a(new_n429_), .b(new_n172_), .c(new_n389_), .O(new_n430_));
  inv1   g273(.a(new_n430_), .O(z13));
  ...
  zero   g327(.O(z24));
  zero   g328(.O(z27));
  inv1   g329(.a(new_n172_), .O(z16));
  inv1   g330(.a(new_n172_), .O(z17));
  inv1   g331(.a(new_n172_), .O(z18));
  inv1   g332(.a(new_n172_), .O(z20));
  inv1   g333(.a(new_n172_), .O(z21));
  inv1   g334(.a(new_n172_), .O(z25));
