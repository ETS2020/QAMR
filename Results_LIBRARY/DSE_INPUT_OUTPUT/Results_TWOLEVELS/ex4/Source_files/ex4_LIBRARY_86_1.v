// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:44 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x117), .O(z15));
  ...
  nand2  g343(.a(new_n172_), .b(new_n480_), .O(new_n501_));
  ...
  zero   g365(.O(z26));
  zero   g366(.O(z27));
  nor2   g367(.a(new_n172_), .b(x117), .O(z16));
  nor2   g368(.a(new_n172_), .b(x117), .O(z17));
  nor2   g369(.a(new_n172_), .b(x117), .O(z18));
  nor2   g370(.a(new_n172_), .b(x117), .O(z19));
  nor2   g371(.a(new_n172_), .b(x117), .O(z21));
  nor2   g372(.a(new_n172_), .b(x117), .O(z23));
endmodule
