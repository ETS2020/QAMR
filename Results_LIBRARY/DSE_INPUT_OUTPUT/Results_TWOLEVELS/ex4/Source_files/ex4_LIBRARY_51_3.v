// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:37 2020
...
module FAU ( 
  ...
  nand2  g218(.a(new_n375_), .b(new_n170_), .O(new_n376_));
  ...
  nand3  g226(.a(x120), .b(new_n383_), .c(new_n169_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n162_), .O(new_n385_));
  aoi21  g228(.a(new_n382_), .b(new_n164_), .c(new_n385_), .O(new_n386_));
  nand4  g229(.a(new_n386_), .b(new_n379_), .c(new_n376_), .d(new_n372_), .O(new_n387_));
  nand4  g230(.a(x120), .b(new_n369_), .c(new_n164_), .d(x008), .O(new_n388_));
  inv1   g231(.a(new_n388_), .O(new_n389_));
  aoi21  g232(.a(new_n387_), .b(new_n166_), .c(new_n389_), .O(new_n390_));
  nand3  g233(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n391_));
  ...
  nand2  g238(.a(new_n395_), .b(new_n169_), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(new_n166_), .O(new_n397_));
  aoi21  g240(.a(new_n397_), .b(new_n163_), .c(new_n374_), .O(new_n398_));
  ...
  oai21  g247(.a(new_n404_), .b(new_n398_), .c(new_n165_), .O(new_n405_));
  nand2  g248(.a(new_n368_), .b(x024), .O(new_n406_));
  nand3  g249(.a(new_n406_), .b(new_n370_), .c(new_n369_), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(new_n166_), .c(x032), .O(new_n408_));
  ...
  aoi21  g256(.a(new_n409_), .b(new_n162_), .c(new_n413_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n393_), .O(new_n415_));
  nand3  g258(.a(new_n415_), .b(new_n160_), .c(new_n367_), .O(new_n416_));
  ...
  nand3  g267(.a(new_n424_), .b(new_n160_), .c(new_n418_), .O(new_n425_));
  ...
  oai21  g276(.a(new_n433_), .b(x042), .c(new_n160_), .O(z10));
  ...
  nand3  g284(.a(new_n441_), .b(new_n160_), .c(new_n435_), .O(new_n442_));
  ...
  oai21  g293(.a(new_n450_), .b(x044), .c(new_n160_), .O(z12));
  inv1   g294(.a(new_n266_), .O(new_n452_));
  oai22  g295(.a(new_n452_), .b(x029), .c(new_n285_), .d(new_n244_), .O(new_n453_));
  aoi21  g296(.a(new_n278_), .b(new_n276_), .c(x093), .O(new_n454_));
  nor2   g297(.a(x117), .b(x109), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(new_n454_), .c(new_n250_), .O(new_n457_));
  oai21  g300(.a(new_n278_), .b(x109), .c(x037), .O(new_n458_));
  nand2  g301(.a(new_n458_), .b(x117), .O(new_n459_));
  inv1   g302(.a(x109), .O(new_n460_));
  oai21  g303(.a(new_n276_), .b(x061), .c(new_n460_), .O(new_n461_));
  nand3  g304(.a(x125), .b(new_n157_), .c(new_n285_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n243_), .O(new_n463_));
  aoi21  g306(.a(new_n461_), .b(new_n245_), .c(new_n463_), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n459_), .c(new_n457_), .d(new_n453_), .O(new_n465_));
  nor2   g308(.a(x037), .b(new_n244_), .O(new_n466_));
  nor2   g309(.a(new_n278_), .b(x061), .O(new_n467_));
  aoi22  g310(.a(new_n467_), .b(new_n466_), .c(new_n465_), .d(new_n247_), .O(new_n468_));
  nand3  g311(.a(x085), .b(new_n245_), .c(new_n244_), .O(new_n469_));
  oai21  g312(.a(new_n468_), .b(x053), .c(new_n469_), .O(new_n470_));
  nand3  g313(.a(new_n243_), .b(new_n246_), .c(x029), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n285_), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n245_), .O(new_n473_));
  nand3  g316(.a(new_n452_), .b(new_n243_), .c(new_n246_), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n473_), .c(new_n250_), .O(new_n475_));
  nand2  g318(.a(new_n254_), .b(x029), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(new_n285_), .c(new_n455_), .O(new_n477_));
  nand2  g320(.a(new_n278_), .b(new_n276_), .O(new_n478_));
  aoi22  g321(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n478_), .c(x029), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n477_), .c(new_n246_), .O(new_n482_));
  aoi21  g325(.a(x021), .b(x013), .c(new_n284_), .O(new_n483_));
  oai21  g326(.a(new_n483_), .b(new_n452_), .c(x037), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n482_), .c(x085), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n475_), .c(new_n247_), .O(new_n486_));
  nand3  g329(.a(new_n456_), .b(new_n243_), .c(new_n246_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n247_), .O(new_n488_));
  nand4  g331(.a(x069), .b(new_n246_), .c(x021), .d(new_n244_), .O(new_n489_));
  oai21  g332(.a(new_n246_), .b(new_n245_), .c(new_n489_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(x013), .c(new_n490_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n486_), .O(new_n492_));
  aoi21  g335(.a(new_n470_), .b(x005), .c(new_n492_), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(x045), .c(new_n160_), .O(z13));
  oai22  g337(.a(new_n330_), .b(x030), .c(new_n319_), .d(new_n361_), .O(new_n495_));
  aoi21  g338(.a(new_n158_), .b(new_n345_), .c(x094), .O(new_n496_));
  inv1   g339(.a(x110), .O(new_n497_));
  nand2  g340(.a(new_n354_), .b(new_n497_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n496_), .c(new_n311_), .O(new_n499_));
  oai21  g342(.a(new_n158_), .b(x110), .c(x038), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(x118), .O(new_n501_));
  oai21  g344(.a(new_n345_), .b(x062), .c(new_n497_), .O(new_n502_));
  nand3  g345(.a(x126), .b(new_n354_), .c(new_n319_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n302_), .O(new_n504_));
  aoi21  g347(.a(new_n502_), .b(new_n315_), .c(new_n504_), .O(new_n505_));
  nand4  g348(.a(new_n505_), .b(new_n501_), .c(new_n499_), .d(new_n495_), .O(new_n506_));
  nand4  g349(.a(x126), .b(new_n328_), .c(new_n315_), .d(x014), .O(new_n507_));
  inv1   g350(.a(new_n507_), .O(new_n508_));
  aoi21  g351(.a(new_n506_), .b(new_n304_), .c(new_n508_), .O(new_n509_));
  nand3  g352(.a(x086), .b(new_n315_), .c(new_n361_), .O(new_n510_));
  oai21  g353(.a(new_n509_), .b(x054), .c(new_n510_), .O(new_n511_));
  aoi21  g354(.a(new_n312_), .b(x030), .c(x022), .O(new_n512_));
  oai21  g355(.a(new_n512_), .b(x078), .c(new_n361_), .O(new_n513_));
  nand2  g356(.a(new_n513_), .b(new_n498_), .O(new_n514_));
  nor2   g357(.a(x094), .b(x062), .O(new_n515_));
  nand2  g358(.a(x030), .b(new_n319_), .O(new_n516_));
  aoi21  g359(.a(new_n516_), .b(new_n515_), .c(new_n311_), .O(new_n517_));
  nand2  g360(.a(new_n158_), .b(new_n345_), .O(new_n518_));
  ...
  oai21  g364(.a(new_n521_), .b(new_n517_), .c(new_n304_), .O(new_n522_));
  aoi21  g365(.a(new_n522_), .b(new_n514_), .c(x054), .O(new_n523_));
  oai21  g366(.a(new_n319_), .b(new_n361_), .c(x030), .O(new_n524_));
  nand2  g367(.a(new_n524_), .b(new_n515_), .O(new_n525_));
  nand3  g368(.a(new_n525_), .b(new_n304_), .c(x038), .O(new_n526_));
  inv1   g369(.a(new_n526_), .O(new_n527_));
  oai21  g370(.a(new_n527_), .b(new_n523_), .c(new_n302_), .O(new_n528_));
  ...
  aoi21  g375(.a(new_n511_), .b(x006), .c(new_n532_), .O(new_n533_));
  oai21  g376(.a(new_n533_), .b(x046), .c(new_n160_), .O(z14));
  zero   g377(.O(z07));
  zero   g378(.O(z16));
  zero   g379(.O(z17));
  zero   g380(.O(z19));
  ...
  zero   g384(.O(z24));
  zero   g385(.O(z25));
  nor2   g386(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g387(.a(new_n158_), .b(new_n157_), .O(z22));
