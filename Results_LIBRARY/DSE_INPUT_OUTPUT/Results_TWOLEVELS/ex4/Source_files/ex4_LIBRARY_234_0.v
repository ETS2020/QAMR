...
module FAU ( 
  ...
  oai21  g256(.a(new_n413_), .b(x042), .c(new_n158_), .O(z10));
  ...
  aoi21  g312(.a(x054), .b(x038), .c(x014), .O(new_n470_));
  nand3  g313(.a(x070), .b(new_n298_), .c(x022), .O(new_n471_));
  nand3  g314(.a(x086), .b(new_n312_), .c(x006), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n471_), .c(new_n470_), .O(new_n473_));
  nand3  g316(.a(new_n473_), .b(x078), .c(new_n296_), .O(new_n474_));
  inv1   g317(.a(new_n474_), .O(z14));
  zero   g318(.O(z07));
  zero   g319(.O(z21));
  zero   g320(.O(z22));
  zero   g321(.O(z25));
  zero   g322(.O(z26));
  zero   g323(.O(z27));
  nor2   g324(.a(x078), .b(x046), .O(z16));
  nor2   g325(.a(x078), .b(x046), .O(z17));
  nor2   g326(.a(x078), .b(x046), .O(z18));
  nor2   g327(.a(x078), .b(x046), .O(z19));
  nor2   g328(.a(x078), .b(x046), .O(z20));
  nor2   g329(.a(x078), .b(x046), .O(z23));
  nor2   g330(.a(x078), .b(x046), .O(z24));
endmodule
