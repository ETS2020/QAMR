...
module FAU ( 
  ...
  aoi21  g139(.a(x046), .b(new_n295_), .c(new_n192_), .O(new_n296_));
  ...
  nand4  g217(.a(x120), .b(new_n355_), .c(new_n162_), .d(x008), .O(new_n375_));
  ...
  aoi21  g227(.a(new_n384_), .b(new_n161_), .c(new_n363_), .O(new_n385_));
  ...
  oai21  g233(.a(new_n390_), .b(new_n385_), .c(new_n163_), .O(new_n391_));
  ...
  nand3  g243(.a(new_n400_), .b(new_n158_), .c(new_n353_), .O(new_n401_));
  ...
  nand3  g278(.a(new_n435_), .b(new_n158_), .c(new_n429_), .O(new_n436_));
  ...
  aoi21  g323(.a(new_n480_), .b(new_n298_), .c(new_n192_), .O(new_n481_));
  ...
  aoi21  g363(.a(new_n516_), .b(x082), .c(new_n520_), .O(new_n521_));
  ...
  zero   g370(.O(z25));
  zero   g371(.O(z26));
  nor2   g372(.a(x082), .b(x078), .O(z16));
  nor2   g373(.a(x082), .b(x078), .O(z18));
  nor2   g374(.a(x082), .b(x078), .O(z22));
  nor2   g375(.a(x082), .b(x078), .O(z23));
  nor2   g376(.a(x082), .b(x078), .O(z24));
  nor2   g377(.a(x082), .b(x078), .O(z27));
endmodule
