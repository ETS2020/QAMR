// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:38 2020
...
module FAU ( 
  ...
  nand4  g217(.a(x120), .b(new_n356_), .c(new_n162_), .d(x008), .O(new_n375_));
  inv1   g218(.a(new_n375_), .O(new_n376_));
  aoi21  g219(.a(new_n374_), .b(new_n164_), .c(new_n376_), .O(new_n377_));
  ...
  nand2  g225(.a(new_n382_), .b(new_n167_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n164_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n161_), .c(new_n361_), .O(new_n385_));
  ...
  oai21  g234(.a(new_n391_), .b(new_n385_), .c(new_n163_), .O(new_n392_));
  ...
  aoi21  g243(.a(new_n396_), .b(new_n160_), .c(new_n400_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n380_), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(new_n158_), .c(new_n354_), .O(new_n403_));
  ...
  nand3  g254(.a(new_n411_), .b(new_n158_), .c(new_n405_), .O(new_n412_));
  ...
  nand3  g263(.a(new_n420_), .b(new_n158_), .c(new_n414_), .O(new_n421_));
  ...
  oai21  g272(.a(new_n429_), .b(x043), .c(new_n158_), .O(z11));
  ...
  oai21  g358(.a(new_n515_), .b(x046), .c(new_n158_), .O(z14));
  zero   g359(.O(z07));
  zero   g360(.O(z15));
  zero   g361(.O(z16));
  zero   g362(.O(z18));
  zero   g363(.O(z21));
  zero   g364(.O(z22));
  nor2   g365(.a(x126), .b(x097), .O(z19));
  nor2   g366(.a(x126), .b(x097), .O(z20));
  nor2   g367(.a(x126), .b(x097), .O(z23));
  nor2   g368(.a(x126), .b(x097), .O(z24));
  nor2   g369(.a(x126), .b(x097), .O(z25));
  nor2   g370(.a(x126), .b(x097), .O(z26));
  nor2   g371(.a(x126), .b(x097), .O(z27));
endmodule
