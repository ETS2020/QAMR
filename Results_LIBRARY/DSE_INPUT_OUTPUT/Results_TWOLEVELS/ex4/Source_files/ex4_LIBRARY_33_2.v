// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:33 2020
...
module FAU ( 
  ...
  nand2  g150(.a(x022), .b(x014), .O(new_n307_));
  aoi21  g151(.a(new_n306_), .b(new_n303_), .c(new_n307_), .O(new_n308_));
  nor2   g152(.a(new_n308_), .b(new_n302_), .O(new_n309_));
  oai22  g153(.a(new_n309_), .b(new_n301_), .c(new_n298_), .d(new_n297_), .O(new_n310_));
  nand3  g154(.a(x086), .b(new_n300_), .c(new_n303_), .O(new_n311_));
  inv1   g155(.a(x006), .O(new_n312_));
  inv1   g156(.a(x102), .O(new_n313_));
  nand3  g157(.a(new_n313_), .b(x062), .c(new_n312_), .O(new_n314_));
  ...
  nand4  g164(.a(new_n320_), .b(new_n306_), .c(x086), .d(new_n303_), .O(new_n321_));
  nand3  g165(.a(x094), .b(x070), .c(new_n312_), .O(new_n322_));
  nand2  g166(.a(new_n322_), .b(new_n321_), .O(new_n323_));
  oai21  g167(.a(new_n317_), .b(new_n313_), .c(new_n323_), .O(new_n324_));
  nor2   g168(.a(new_n305_), .b(new_n304_), .O(new_n325_));
  inv1   g169(.a(new_n325_), .O(new_n326_));
  oai21  g170(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n327_));
  oai22  g171(.a(new_n298_), .b(new_n319_), .c(x094), .d(new_n304_), .O(new_n328_));
  aoi21  g172(.a(new_n328_), .b(new_n317_), .c(new_n302_), .O(new_n329_));
  nand2  g173(.a(new_n329_), .b(new_n327_), .O(new_n330_));
  nor2   g174(.a(new_n325_), .b(new_n302_), .O(new_n331_));
  aoi22  g175(.a(new_n331_), .b(new_n300_), .c(new_n330_), .d(new_n312_), .O(new_n332_));
  nand4  g176(.a(new_n332_), .b(new_n324_), .c(new_n316_), .d(new_n310_), .O(new_n333_));
  nand3  g177(.a(new_n317_), .b(x110), .c(new_n299_), .O(new_n334_));
  aoi21  g178(.a(new_n334_), .b(x086), .c(x006), .O(new_n335_));
  nand3  g179(.a(x086), .b(new_n299_), .c(new_n303_), .O(new_n336_));
  oai21  g180(.a(x070), .b(x022), .c(new_n336_), .O(new_n337_));
  oai21  g181(.a(new_n337_), .b(new_n335_), .c(x014), .O(new_n338_));
  inv1   g182(.a(x054), .O(new_n339_));
  nand2  g183(.a(new_n303_), .b(x022), .O(new_n340_));
  aoi21  g184(.a(new_n340_), .b(new_n325_), .c(new_n302_), .O(new_n341_));
  oai21  g185(.a(new_n341_), .b(new_n339_), .c(new_n299_), .O(new_n342_));
  inv1   g186(.a(x078), .O(new_n343_));
  nor2   g187(.a(x070), .b(new_n299_), .O(new_n344_));
  aoi21  g188(.a(new_n344_), .b(new_n319_), .c(new_n343_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n342_), .c(new_n338_), .O(new_n346_));
  aoi21  g190(.a(new_n333_), .b(x054), .c(new_n346_), .O(new_n347_));
  nor2   g191(.a(new_n347_), .b(new_n172_), .O(z06));
  inv1   g192(.a(x024), .O(new_n350_));
  nor2   g193(.a(x088), .b(x056), .O(new_n351_));
  nand2  g194(.a(new_n351_), .b(new_n350_), .O(new_n352_));
  oai21  g195(.a(new_n165_), .b(new_n159_), .c(new_n352_), .O(new_n353_));
  inv1   g196(.a(x096), .O(new_n354_));
  inv1   g197(.a(x120), .O(new_n355_));
  aoi21  g198(.a(new_n355_), .b(new_n354_), .c(x088), .O(new_n356_));
  inv1   g199(.a(x104), .O(new_n357_));
  inv1   g200(.a(x112), .O(new_n358_));
  nand2  g201(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  oai21  g202(.a(new_n359_), .b(new_n356_), .c(new_n166_), .O(new_n360_));
  oai21  g203(.a(new_n355_), .b(x104), .c(x032), .O(new_n361_));
  nand2  g204(.a(new_n361_), .b(x112), .O(new_n362_));
  oai21  g205(.a(new_n354_), .b(x056), .c(new_n357_), .O(new_n363_));
  nand3  g206(.a(x120), .b(new_n358_), .c(new_n165_), .O(new_n364_));
  nand2  g207(.a(new_n364_), .b(new_n158_), .O(new_n365_));
  aoi21  g208(.a(new_n363_), .b(new_n160_), .c(new_n365_), .O(new_n366_));
  nand4  g209(.a(new_n366_), .b(new_n362_), .c(new_n360_), .d(new_n353_), .O(new_n367_));
  nor2   g210(.a(x032), .b(new_n159_), .O(new_n368_));
  nor2   g211(.a(new_n355_), .b(x056), .O(new_n369_));
  aoi22  g212(.a(new_n369_), .b(new_n368_), .c(new_n367_), .d(new_n162_), .O(new_n370_));
  nand3  g213(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n371_));
  oai21  g214(.a(new_n370_), .b(x048), .c(new_n371_), .O(new_n372_));
  nand2  g215(.a(x088), .b(x056), .O(new_n373_));
  aoi21  g216(.a(new_n373_), .b(x024), .c(x016), .O(new_n374_));
  oai21  g217(.a(new_n374_), .b(x072), .c(new_n159_), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n359_), .O(new_n376_));
  nand2  g219(.a(x024), .b(new_n165_), .O(new_n377_));
  aoi21  g220(.a(new_n377_), .b(new_n351_), .c(new_n166_), .O(new_n378_));
  nand2  g221(.a(new_n355_), .b(new_n354_), .O(new_n379_));
  aoi22  g222(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n380_));
  nand3  g223(.a(new_n380_), .b(new_n379_), .c(x024), .O(new_n381_));
  inv1   g224(.a(new_n381_), .O(new_n382_));
  oai21  g225(.a(new_n382_), .b(new_n378_), .c(new_n162_), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n376_), .c(x048), .O(new_n384_));
  oai21  g227(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n351_), .O(new_n386_));
  nand3  g229(.a(new_n386_), .b(new_n162_), .c(x032), .O(new_n387_));
  inv1   g230(.a(new_n387_), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(new_n384_), .c(new_n158_), .O(new_n389_));
  oai22  g232(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n390_));
  nand3  g233(.a(new_n390_), .b(x064), .c(x016), .O(new_n391_));
  aoi22  g234(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n392_));
  nand3  g235(.a(new_n392_), .b(new_n391_), .c(new_n389_), .O(new_n393_));
  aoi21  g236(.a(new_n372_), .b(x000), .c(new_n393_), .O(new_n394_));
  oai21  g237(.a(new_n394_), .b(x040), .c(new_n174_), .O(z08));
  inv1   g238(.a(x041), .O(new_n396_));
  oai22  g239(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(x081), .c(x001), .O(new_n398_));
  oai22  g241(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(x065), .c(x017), .O(new_n400_));
  aoi22  g243(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n401_));
  nand3  g244(.a(new_n401_), .b(new_n400_), .c(new_n398_), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(new_n174_), .c(new_n396_), .O(new_n403_));
  inv1   g246(.a(new_n403_), .O(z09));
  oai22  g247(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(x082), .c(x002), .O(new_n406_));
  oai22  g249(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(x066), .c(x018), .O(new_n408_));
  aoi22  g251(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n409_));
  nand3  g252(.a(new_n409_), .b(new_n408_), .c(new_n406_), .O(new_n410_));
  inv1   g253(.a(new_n410_), .O(new_n411_));
  oai21  g254(.a(new_n411_), .b(x042), .c(new_n174_), .O(z10));
  inv1   g255(.a(x043), .O(new_n413_));
  oai22  g256(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n414_));
  nand3  g257(.a(new_n414_), .b(x083), .c(x003), .O(new_n415_));
  ...
  inv1   g263(.a(new_n420_), .O(z11));
  inv1   g264(.a(x044), .O(new_n422_));
  ...
  inv1   g272(.a(new_n429_), .O(z12));
  oai22  g273(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n431_));
  inv1   g274(.a(x101), .O(new_n432_));
  aoi21  g275(.a(new_n260_), .b(new_n432_), .c(x093), .O(new_n433_));
  nand2  g276(.a(new_n251_), .b(new_n250_), .O(new_n434_));
  oai21  g277(.a(new_n434_), .b(new_n433_), .c(new_n277_), .O(new_n435_));
  oai21  g278(.a(new_n260_), .b(x109), .c(x037), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(x117), .O(new_n437_));
  oai21  g280(.a(new_n432_), .b(x061), .c(new_n250_), .O(new_n438_));
  ...
  aoi21  g290(.a(new_n246_), .b(x029), .c(x021), .O(new_n448_));
  oai21  g291(.a(new_n448_), .b(x077), .c(new_n243_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n434_), .O(new_n450_));
  nand2  g293(.a(x029), .b(new_n244_), .O(new_n451_));
  aoi21  g294(.a(new_n451_), .b(new_n272_), .c(new_n277_), .O(new_n452_));
  nand2  g295(.a(new_n260_), .b(new_n432_), .O(new_n453_));
  ...
  oai21  g299(.a(new_n456_), .b(new_n452_), .c(new_n276_), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n450_), .c(x053), .O(new_n458_));
  oai21  g301(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n459_));
  ...
  oai21  g305(.a(new_n462_), .b(new_n458_), .c(new_n268_), .O(new_n463_));
  ...
  oai21  g311(.a(new_n468_), .b(x045), .c(new_n174_), .O(z13));
  oai21  g312(.a(new_n306_), .b(x030), .c(new_n307_), .O(new_n470_));
  nand2  g313(.a(new_n317_), .b(new_n313_), .O(new_n471_));
  oai22  g314(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n471_), .O(new_n473_));
  oai22  g316(.a(x118), .b(x110), .c(new_n300_), .d(new_n299_), .O(new_n474_));
  nand2  g317(.a(x118), .b(new_n297_), .O(new_n475_));
  oai21  g318(.a(x118), .b(x022), .c(new_n475_), .O(new_n476_));
  aoi21  g319(.a(new_n476_), .b(x126), .c(x086), .O(new_n477_));
  nand4  g320(.a(new_n477_), .b(new_n474_), .c(new_n473_), .d(new_n470_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n343_), .c(new_n339_), .O(new_n479_));
  nand4  g322(.a(x086), .b(new_n172_), .c(new_n299_), .d(new_n318_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(x006), .O(new_n482_));
  nor2   g325(.a(new_n325_), .b(new_n303_), .O(new_n483_));
  oai22  g326(.a(new_n483_), .b(new_n320_), .c(x118), .d(x110), .O(new_n484_));
  nor2   g327(.a(x038), .b(new_n303_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n306_), .c(x070), .O(new_n486_));
  nand4  g329(.a(new_n471_), .b(new_n326_), .c(new_n307_), .d(x030), .O(new_n487_));
  nand3  g330(.a(new_n487_), .b(new_n486_), .c(new_n484_), .O(new_n488_));
  aoi21  g331(.a(new_n307_), .b(x030), .c(new_n306_), .O(new_n489_));
  nor2   g332(.a(new_n489_), .b(new_n299_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n339_), .c(new_n490_), .O(new_n491_));
  nor2   g334(.a(new_n300_), .b(x038), .O(new_n492_));
  aoi21  g335(.a(new_n492_), .b(x022), .c(x046), .O(new_n493_));
  oai21  g336(.a(new_n491_), .b(x086), .c(new_n493_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n343_), .O(new_n495_));
  nand2  g338(.a(x054), .b(x038), .O(new_n496_));
  nand4  g339(.a(x070), .b(new_n339_), .c(x022), .d(new_n318_), .O(new_n497_));
  nand2  g340(.a(x078), .b(x014), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n497_), .c(new_n496_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n172_), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n495_), .c(new_n482_), .O(z14));
  zero   g344(.O(z07));
  zero   g345(.O(z15));
  zero   g346(.O(z24));
  zero   g347(.O(z25));
  nor2   g348(.a(x078), .b(new_n172_), .O(z17));
  nor2   g349(.a(x078), .b(new_n172_), .O(z18));
  nor2   g350(.a(x078), .b(new_n172_), .O(z19));
  nor2   g351(.a(x078), .b(new_n172_), .O(z20));
  nor2   g352(.a(x078), .b(new_n172_), .O(z21));
  nor2   g353(.a(x078), .b(new_n172_), .O(z22));
  nor2   g354(.a(x078), .b(new_n172_), .O(z23));
  nor2   g355(.a(x078), .b(new_n172_), .O(z26));
  nor2   g356(.a(x078), .b(new_n172_), .O(z27));
endmodule
