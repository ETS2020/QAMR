// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:32 2020
...
module FAU ( 
  ...
  oai22  g146(.a(new_n172_), .b(new_n302_), .c(new_n301_), .d(new_n300_), .O(new_n303_));
  nand2  g147(.a(new_n303_), .b(new_n299_), .O(new_n304_));
  inv1   g148(.a(x022), .O(new_n305_));
  inv1   g149(.a(x070), .O(new_n306_));
  nand2  g150(.a(new_n301_), .b(new_n300_), .O(new_n307_));
  nand4  g151(.a(new_n307_), .b(x078), .c(new_n306_), .d(new_n305_), .O(new_n308_));
  nand2  g152(.a(new_n302_), .b(new_n301_), .O(new_n309_));
  nand3  g153(.a(new_n309_), .b(new_n308_), .c(new_n304_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(new_n173_), .O(new_n311_));
  nand3  g155(.a(new_n306_), .b(x054), .c(new_n305_), .O(new_n312_));
  nand3  g156(.a(new_n312_), .b(new_n309_), .c(x014), .O(new_n313_));
  nand2  g157(.a(new_n313_), .b(new_n172_), .O(new_n314_));
  aoi21  g158(.a(new_n314_), .b(new_n311_), .c(new_n298_), .O(z06));
  inv1   g159(.a(x040), .O(new_n317_));
  ...
  oai21  g164(.a(new_n321_), .b(x024), .c(new_n318_), .O(new_n322_));
  nor2   g165(.a(x120), .b(x096), .O(new_n323_));
  nor2   g166(.a(x112), .b(x104), .O(new_n324_));
  oai21  g167(.a(new_n323_), .b(x088), .c(new_n324_), .O(new_n325_));
  nand2  g168(.a(new_n325_), .b(new_n166_), .O(new_n326_));
  inv1   g169(.a(x120), .O(new_n327_));
  oai21  g170(.a(new_n327_), .b(x104), .c(x032), .O(new_n328_));
  nand2  g171(.a(new_n328_), .b(x112), .O(new_n329_));
  inv1   g172(.a(x096), .O(new_n330_));
  inv1   g173(.a(x104), .O(new_n331_));
  oai21  g174(.a(new_n330_), .b(x056), .c(new_n331_), .O(new_n332_));
  inv1   g175(.a(x112), .O(new_n333_));
  nand3  g176(.a(x120), .b(new_n333_), .c(new_n165_), .O(new_n334_));
  nand2  g177(.a(new_n334_), .b(new_n158_), .O(new_n335_));
  aoi21  g178(.a(new_n332_), .b(new_n160_), .c(new_n335_), .O(new_n336_));
  nand4  g179(.a(new_n336_), .b(new_n329_), .c(new_n326_), .d(new_n322_), .O(new_n337_));
  nand4  g180(.a(x120), .b(new_n319_), .c(new_n160_), .d(x008), .O(new_n338_));
  inv1   g181(.a(new_n338_), .O(new_n339_));
  aoi21  g182(.a(new_n337_), .b(new_n162_), .c(new_n339_), .O(new_n340_));
  nand3  g183(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n341_));
  oai21  g184(.a(new_n340_), .b(x048), .c(new_n341_), .O(new_n342_));
  nand2  g185(.a(new_n342_), .b(x000), .O(new_n343_));
  nand2  g186(.a(x088), .b(x056), .O(new_n344_));
  nand2  g187(.a(new_n344_), .b(x024), .O(new_n345_));
  nand2  g188(.a(new_n345_), .b(new_n165_), .O(new_n346_));
  nand2  g189(.a(new_n346_), .b(new_n162_), .O(new_n347_));
  aoi21  g190(.a(new_n347_), .b(new_n159_), .c(new_n324_), .O(new_n348_));
  inv1   g191(.a(x024), .O(new_n349_));
  nor2   g192(.a(new_n349_), .b(x016), .O(new_n350_));
  oai21  g193(.a(new_n350_), .b(new_n321_), .c(x064), .O(new_n351_));
  inv1   g194(.a(new_n323_), .O(new_n352_));
  nand4  g195(.a(new_n344_), .b(new_n352_), .c(new_n318_), .d(x024), .O(new_n353_));
  aoi21  g196(.a(new_n353_), .b(new_n351_), .c(x072), .O(new_n354_));
  oai21  g197(.a(new_n354_), .b(new_n348_), .c(new_n161_), .O(new_n355_));
  nand2  g198(.a(new_n318_), .b(x024), .O(new_n356_));
  nand3  g199(.a(new_n356_), .b(new_n320_), .c(new_n319_), .O(new_n357_));
  nand3  g200(.a(new_n357_), .b(new_n162_), .c(x032), .O(new_n358_));
  nand2  g201(.a(new_n358_), .b(new_n355_), .O(new_n359_));
  ...
  aoi21  g206(.a(new_n359_), .b(new_n158_), .c(new_n363_), .O(new_n364_));
  nand2  g207(.a(new_n364_), .b(new_n343_), .O(new_n365_));
  nand3  g208(.a(new_n365_), .b(new_n175_), .c(new_n317_), .O(new_n366_));
  inv1   g209(.a(new_n366_), .O(z08));
  inv1   g210(.a(x041), .O(new_n368_));
  ...
  oai21  g234(.a(new_n391_), .b(x043), .c(new_n175_), .O(z11));
  inv1   g235(.a(x044), .O(new_n393_));
  ...
  nand3  g242(.a(new_n399_), .b(new_n175_), .c(new_n393_), .O(new_n400_));
  inv1   g243(.a(new_n400_), .O(z12));
  oai22  g244(.a(new_n281_), .b(x029), .c(new_n245_), .d(new_n244_), .O(new_n402_));
  inv1   g245(.a(x101), .O(new_n403_));
  aoi21  g246(.a(new_n261_), .b(new_n403_), .c(x093), .O(new_n404_));
  nand2  g247(.a(new_n252_), .b(new_n251_), .O(new_n405_));
  oai21  g248(.a(new_n405_), .b(new_n404_), .c(new_n278_), .O(new_n406_));
  oai21  g249(.a(new_n261_), .b(x109), .c(x037), .O(new_n407_));
  nand2  g250(.a(new_n407_), .b(x117), .O(new_n408_));
  oai21  g251(.a(new_n403_), .b(x061), .c(new_n251_), .O(new_n409_));
  nand3  g252(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n410_));
  nand2  g253(.a(new_n410_), .b(new_n269_), .O(new_n411_));
  aoi21  g254(.a(new_n409_), .b(new_n256_), .c(new_n411_), .O(new_n412_));
  nand4  g255(.a(new_n412_), .b(new_n408_), .c(new_n406_), .d(new_n402_), .O(new_n413_));
  nand4  g256(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n414_));
  inv1   g257(.a(new_n414_), .O(new_n415_));
  aoi21  g258(.a(new_n413_), .b(new_n277_), .c(new_n415_), .O(new_n416_));
  nand3  g259(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n417_));
  oai21  g260(.a(new_n416_), .b(x053), .c(new_n417_), .O(new_n418_));
  aoi21  g261(.a(new_n247_), .b(x029), .c(x021), .O(new_n419_));
  oai21  g262(.a(new_n419_), .b(x077), .c(new_n244_), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(new_n405_), .O(new_n421_));
  nand2  g264(.a(x029), .b(new_n245_), .O(new_n422_));
  aoi21  g265(.a(new_n422_), .b(new_n273_), .c(new_n278_), .O(new_n423_));
  nand2  g266(.a(new_n261_), .b(new_n403_), .O(new_n424_));
  ...
  oai21  g270(.a(new_n427_), .b(new_n423_), .c(new_n277_), .O(new_n428_));
  aoi21  g271(.a(new_n428_), .b(new_n421_), .c(x053), .O(new_n429_));
  oai21  g272(.a(new_n245_), .b(new_n244_), .c(x029), .O(new_n430_));
  nand2  g273(.a(new_n430_), .b(new_n273_), .O(new_n431_));
  nand3  g274(.a(new_n431_), .b(new_n277_), .c(x037), .O(new_n432_));
  inv1   g275(.a(new_n432_), .O(new_n433_));
  oai21  g276(.a(new_n433_), .b(new_n429_), .c(new_n269_), .O(new_n434_));
  ...
  aoi21  g281(.a(new_n418_), .b(x005), .c(new_n438_), .O(new_n439_));
  oai21  g282(.a(new_n439_), .b(x045), .c(new_n175_), .O(z13));
  oai21  g283(.a(x046), .b(new_n300_), .c(new_n173_), .O(new_n441_));
  nand2  g284(.a(new_n441_), .b(x078), .O(new_n442_));
  inv1   g285(.a(x030), .O(new_n443_));
  nor2   g286(.a(x094), .b(x062), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n443_), .O(new_n445_));
  oai21  g288(.a(new_n305_), .b(new_n300_), .c(new_n445_), .O(new_n446_));
  inv1   g289(.a(x102), .O(new_n447_));
  inv1   g290(.a(x126), .O(new_n448_));
  aoi21  g291(.a(new_n448_), .b(new_n447_), .c(x094), .O(new_n449_));
  inv1   g292(.a(x110), .O(new_n450_));
  inv1   g293(.a(x118), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n450_), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n449_), .c(new_n306_), .O(new_n453_));
  oai21  g296(.a(new_n448_), .b(x110), .c(x038), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(x118), .O(new_n455_));
  oai21  g298(.a(new_n447_), .b(x062), .c(new_n450_), .O(new_n456_));
  nor2   g299(.a(new_n448_), .b(x118), .O(new_n457_));
  aoi22  g300(.a(new_n457_), .b(new_n305_), .c(new_n456_), .d(new_n301_), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n455_), .c(new_n453_), .d(new_n446_), .O(new_n459_));
  inv1   g302(.a(x062), .O(new_n460_));
  nand4  g303(.a(x126), .b(x094), .c(new_n460_), .d(x014), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n173_), .O(new_n462_));
  aoi21  g305(.a(new_n459_), .b(new_n172_), .c(new_n462_), .O(new_n463_));
  oai22  g306(.a(new_n463_), .b(x054), .c(new_n173_), .d(x014), .O(new_n464_));
  nand2  g307(.a(x094), .b(x062), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(x030), .c(x022), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(x078), .c(new_n300_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n452_), .O(new_n468_));
  nand2  g311(.a(x030), .b(new_n305_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n444_), .c(new_n306_), .O(new_n470_));
  nand2  g313(.a(new_n448_), .b(new_n447_), .O(new_n471_));
  aoi22  g314(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n471_), .c(x030), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n470_), .c(new_n172_), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n468_), .c(x054), .O(new_n476_));
  oai21  g319(.a(new_n305_), .b(new_n300_), .c(x030), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n444_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n172_), .c(x038), .O(new_n479_));
  inv1   g322(.a(new_n479_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n476_), .c(new_n173_), .O(new_n481_));
  oai22  g324(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(x070), .c(x022), .O(new_n483_));
  nand2  g326(.a(x054), .b(x038), .O(new_n484_));
  nand3  g327(.a(new_n484_), .b(new_n483_), .c(new_n481_), .O(new_n485_));
  aoi21  g328(.a(new_n464_), .b(x006), .c(new_n485_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(x046), .c(new_n442_), .O(z14));
  zero   g330(.O(z07));
  zero   g331(.O(z20));
  zero   g332(.O(z22));
  zero   g333(.O(z25));
  zero   g334(.O(z26));
  zero   g335(.O(z27));
  nor2   g336(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g337(.a(new_n173_), .b(new_n172_), .O(z17));
  nor2   g338(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g339(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g340(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g341(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g342(.a(new_n173_), .b(new_n172_), .O(z24));
endmodule
