// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:18 2020
...
module FAU ( 
  ...
  oai21  g210(.a(new_n366_), .b(x041), .c(new_n157_), .O(z09));
  inv1   g211(.a(x042), .O(new_n368_));
  ...
  nand3  g218(.a(new_n374_), .b(new_n157_), .c(new_n368_), .O(new_n375_));
  inv1   g219(.a(new_n375_), .O(z10));
  ...
  oai22  g229(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n386_));
  nand3  g230(.a(new_n386_), .b(x084), .c(x004), .O(new_n387_));
  oai22  g231(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n388_));
  nand3  g232(.a(new_n388_), .b(x068), .c(x020), .O(new_n389_));
  aoi22  g233(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n390_));
  nand3  g234(.a(new_n390_), .b(new_n389_), .c(new_n387_), .O(new_n391_));
  inv1   g235(.a(new_n391_), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(x044), .c(new_n157_), .O(z12));
  oai22  g237(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n394_));
  inv1   g238(.a(x101), .O(new_n395_));
  aoi21  g239(.a(new_n258_), .b(new_n395_), .c(x093), .O(new_n396_));
  nand2  g240(.a(new_n249_), .b(new_n248_), .O(new_n397_));
  oai21  g241(.a(new_n397_), .b(new_n396_), .c(new_n275_), .O(new_n398_));
  oai21  g242(.a(new_n258_), .b(x109), .c(x037), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(x117), .O(new_n400_));
  oai21  g244(.a(new_n395_), .b(x061), .c(new_n248_), .O(new_n401_));
  ...
  nand4  g248(.a(new_n404_), .b(new_n400_), .c(new_n398_), .d(new_n394_), .O(new_n405_));
  ...
  aoi21  g254(.a(new_n244_), .b(x029), .c(x021), .O(new_n411_));
  oai21  g255(.a(new_n411_), .b(x077), .c(new_n241_), .O(new_n412_));
  nand2  g256(.a(new_n412_), .b(new_n397_), .O(new_n413_));
  nand2  g257(.a(x029), .b(new_n242_), .O(new_n414_));
  aoi21  g258(.a(new_n414_), .b(new_n270_), .c(new_n275_), .O(new_n415_));
  nand2  g259(.a(new_n258_), .b(new_n395_), .O(new_n416_));
  aoi22  g260(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n417_));
  nand3  g261(.a(new_n417_), .b(new_n416_), .c(x029), .O(new_n418_));
  inv1   g262(.a(new_n418_), .O(new_n419_));
  oai21  g263(.a(new_n419_), .b(new_n415_), .c(new_n274_), .O(new_n420_));
  aoi21  g264(.a(new_n420_), .b(new_n413_), .c(x053), .O(new_n421_));
  oai21  g265(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n422_));
  ...
  oai21  g269(.a(new_n425_), .b(new_n421_), .c(new_n266_), .O(new_n426_));
  oai22  g270(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n427_));
  nand3  g271(.a(new_n427_), .b(x069), .c(x021), .O(new_n428_));
  aoi22  g272(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n429_));
  nand3  g273(.a(new_n429_), .b(new_n428_), .c(new_n426_), .O(new_n430_));
  aoi21  g274(.a(new_n410_), .b(x005), .c(new_n430_), .O(new_n431_));
  oai21  g275(.a(new_n431_), .b(x045), .c(new_n157_), .O(z13));
  oai21  g276(.a(x046), .b(x014), .c(x078), .O(new_n433_));
  inv1   g277(.a(x014), .O(new_n434_));
  inv1   g278(.a(x030), .O(new_n435_));
  nor2   g279(.a(x094), .b(x062), .O(new_n436_));
  nand2  g280(.a(new_n436_), .b(new_n435_), .O(new_n437_));
  oai21  g281(.a(new_n299_), .b(new_n434_), .c(new_n437_), .O(new_n438_));
  inv1   g282(.a(x102), .O(new_n439_));
  inv1   g283(.a(x126), .O(new_n440_));
  aoi21  g284(.a(new_n440_), .b(new_n439_), .c(x094), .O(new_n441_));
  inv1   g285(.a(x110), .O(new_n442_));
  inv1   g286(.a(x118), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n442_), .O(new_n444_));
  oai21  g288(.a(new_n444_), .b(new_n441_), .c(new_n300_), .O(new_n445_));
  oai21  g289(.a(new_n440_), .b(x110), .c(x038), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(x118), .O(new_n447_));
  oai21  g291(.a(new_n439_), .b(x062), .c(new_n442_), .O(new_n448_));
  nand3  g292(.a(x126), .b(new_n443_), .c(new_n299_), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(new_n303_), .O(new_n450_));
  aoi21  g294(.a(new_n448_), .b(new_n296_), .c(new_n450_), .O(new_n451_));
  nand4  g295(.a(new_n451_), .b(new_n447_), .c(new_n445_), .d(new_n438_), .O(new_n452_));
  nor2   g296(.a(x038), .b(new_n434_), .O(new_n453_));
  nor2   g297(.a(new_n440_), .b(x062), .O(new_n454_));
  aoi22  g298(.a(new_n454_), .b(new_n453_), .c(new_n452_), .d(new_n295_), .O(new_n455_));
  nand3  g299(.a(x086), .b(new_n296_), .c(new_n434_), .O(new_n456_));
  oai21  g300(.a(new_n455_), .b(x054), .c(new_n456_), .O(new_n457_));
  nand2  g301(.a(x094), .b(x062), .O(new_n458_));
  aoi21  g302(.a(new_n458_), .b(x030), .c(x022), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(x078), .c(new_n434_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n444_), .O(new_n461_));
  nand2  g305(.a(new_n296_), .b(x030), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n436_), .c(new_n300_), .O(new_n463_));
  nand2  g307(.a(new_n440_), .b(new_n439_), .O(new_n464_));
  aoi22  g308(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n465_));
  nand3  g309(.a(new_n465_), .b(new_n464_), .c(x030), .O(new_n466_));
  inv1   g310(.a(new_n466_), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(new_n463_), .c(new_n295_), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n461_), .c(x054), .O(new_n469_));
  oai21  g313(.a(new_n299_), .b(new_n434_), .c(x030), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n436_), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n295_), .c(x038), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(new_n473_));
  oai21  g317(.a(new_n473_), .b(new_n469_), .c(new_n303_), .O(new_n474_));
  oai22  g318(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(x070), .c(x022), .O(new_n476_));
  nand2  g320(.a(x054), .b(x038), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n476_), .c(new_n474_), .O(new_n478_));
  aoi21  g322(.a(new_n457_), .b(x006), .c(new_n478_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(x046), .c(new_n433_), .O(z14));
  zero   g324(.O(z16));
  zero   g325(.O(z17));
  zero   g326(.O(z18));
  zero   g327(.O(z19));
  ...
  zero   g329(.O(z23));
  zero   g330(.O(z25));
  inv1   g331(.a(new_n157_), .O(z15));
  inv1   g332(.a(new_n157_), .O(z20));
  inv1   g333(.a(new_n157_), .O(z22));
  inv1   g334(.a(new_n157_), .O(z24));
  inv1   g335(.a(new_n157_), .O(z26));
  inv1   g336(.a(new_n157_), .O(z27));
endmodule
