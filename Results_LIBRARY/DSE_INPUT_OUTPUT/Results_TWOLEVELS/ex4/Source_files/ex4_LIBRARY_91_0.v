// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:55 2020
...
module FAU ( 
  ...
  oai21  g258(.a(new_n414_), .b(x042), .c(new_n158_), .O(z10));
  ...
  nand2  g318(.a(new_n311_), .b(new_n299_), .O(new_n475_));
  oai21  g319(.a(x078), .b(x054), .c(new_n475_), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(x086), .c(x006), .O(new_n477_));
  nand2  g321(.a(new_n307_), .b(new_n306_), .O(new_n478_));
  oai21  g322(.a(x078), .b(new_n300_), .c(new_n299_), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand3  g324(.a(new_n336_), .b(new_n332_), .c(x070), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n480_), .c(x054), .O(new_n482_));
  nor3   g326(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n483_));
  oai21  g327(.a(new_n483_), .b(new_n482_), .c(new_n324_), .O(new_n484_));
  oai22  g328(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(x070), .c(x022), .O(new_n486_));
  aoi22  g330(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n487_));
  nand4  g331(.a(new_n487_), .b(new_n486_), .c(new_n484_), .d(new_n477_), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(new_n158_), .O(new_n489_));
  nand2  g333(.a(x114), .b(x102), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n316_), .O(new_n491_));
  nand3  g335(.a(new_n491_), .b(new_n302_), .c(new_n324_), .O(new_n492_));
  nand2  g336(.a(x114), .b(x006), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n492_), .c(new_n298_), .O(new_n494_));
  inv1   g338(.a(x114), .O(new_n495_));
  nor3   g339(.a(new_n328_), .b(new_n495_), .c(new_n296_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n494_), .c(new_n297_), .O(new_n497_));
  nand4  g341(.a(x114), .b(new_n324_), .c(x038), .d(x030), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n497_), .O(new_n499_));
  oai21  g343(.a(new_n300_), .b(new_n299_), .c(new_n499_), .O(new_n500_));
  nand4  g344(.a(x114), .b(new_n324_), .c(x070), .d(x030), .O(new_n501_));
  nand3  g345(.a(x126), .b(new_n307_), .c(x006), .O(new_n502_));
  ...
  oai21  g350(.a(new_n333_), .b(new_n311_), .c(new_n478_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n506_), .c(new_n296_), .O(new_n508_));
  nand4  g352(.a(new_n478_), .b(new_n302_), .c(new_n324_), .d(x030), .O(new_n509_));
  inv1   g353(.a(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n508_), .c(x114), .O(new_n511_));
  inv1   g355(.a(x094), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n333_), .O(new_n513_));
  nand2  g357(.a(x118), .b(new_n306_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n513_), .c(new_n475_), .O(new_n515_));
  nand3  g359(.a(new_n515_), .b(x126), .c(x006), .O(new_n516_));
  ...
  nand3  g363(.a(new_n311_), .b(x014), .c(x006), .O(new_n520_));
  nor4   g364(.a(new_n520_), .b(new_n316_), .c(x062), .d(x054), .O(new_n521_));
  aoi21  g365(.a(new_n519_), .b(new_n332_), .c(new_n521_), .O(new_n522_));
  aoi21  g366(.a(new_n522_), .b(new_n489_), .c(x046), .O(z14));
  zero   g367(.O(z16));
  zero   g368(.O(z17));
  zero   g369(.O(z21));
  zero   g370(.O(z22));
  zero   g371(.O(z25));
  zero   g372(.O(z27));
  nor2   g373(.a(x126), .b(x114), .O(z15));
  nor2   g374(.a(x126), .b(x114), .O(z18));
  nor2   g375(.a(x126), .b(x114), .O(z19));
  nor2   g376(.a(x126), .b(x114), .O(z20));
  nor2   g377(.a(x126), .b(x114), .O(z23));
  nor2   g378(.a(x126), .b(x114), .O(z24));
  nor2   g379(.a(x126), .b(x114), .O(z26));
endmodule
