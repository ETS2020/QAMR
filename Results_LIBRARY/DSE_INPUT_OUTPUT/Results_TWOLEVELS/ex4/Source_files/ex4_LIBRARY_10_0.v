...
module FAU ( 
  ...
  nand2  g341(.a(x086), .b(new_n295_), .O(new_n498_));
  ...
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n295_), .O(new_n519_));
  and2   g363(.a(new_n519_), .b(x078), .O(new_n520_));
  aoi21  g364(.a(new_n516_), .b(x122), .c(new_n520_), .O(new_n521_));
  ...
  zero   g372(.O(z24));
  zero   g373(.O(z26));
  nor2   g374(.a(x122), .b(x078), .O(z15));
  nor2   g375(.a(x122), .b(x078), .O(z19));
  nor2   g376(.a(x122), .b(x078), .O(z22));
  nor2   g377(.a(x122), .b(x078), .O(z25));
  nor2   g378(.a(x122), .b(x078), .O(z27));
endmodule
