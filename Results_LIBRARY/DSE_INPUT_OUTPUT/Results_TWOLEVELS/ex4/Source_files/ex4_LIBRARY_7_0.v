// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:43 2020
...
module FAU ( 
  ...
  nand3  g322(.a(new_n479_), .b(new_n158_), .c(new_n439_), .O(new_n480_));
  ...
  nand4  g327(.a(new_n484_), .b(new_n483_), .c(new_n482_), .d(x078), .O(new_n485_));
  and2   g328(.a(new_n485_), .b(new_n296_), .O(z14));
  zero   g329(.O(z07));
  zero   g330(.O(z15));
  zero   g331(.O(z16));
  zero   g332(.O(z17));
  ...
  zero   g337(.O(z25));
  zero   g338(.O(z27));
  nor2   g339(.a(x078), .b(x046), .O(z21));
  nor2   g340(.a(x078), .b(x046), .O(z23));
