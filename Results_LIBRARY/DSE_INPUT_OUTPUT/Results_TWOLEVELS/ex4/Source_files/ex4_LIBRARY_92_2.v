...
module FAU ( 
  ...
  nand2  g334(.a(new_n315_), .b(new_n364_), .O(new_n491_));
  ...
  nand2  g338(.a(new_n357_), .b(new_n494_), .O(new_n495_));
  oai21  g339(.a(x078), .b(new_n319_), .c(new_n364_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n495_), .O(new_n497_));
  nand3  g341(.a(new_n353_), .b(new_n304_), .c(x070), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n497_), .c(x054), .O(new_n499_));
  nor3   g343(.a(new_n331_), .b(x078), .c(new_n315_), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n499_), .c(new_n302_), .O(new_n501_));
  ...
  nand2  g349(.a(new_n505_), .b(new_n159_), .O(new_n506_));
  nand2  g350(.a(x022), .b(x014), .O(new_n507_));
  oai21  g351(.a(x117), .b(new_n328_), .c(new_n263_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n312_), .c(new_n302_), .O(new_n509_));
  nand2  g353(.a(new_n157_), .b(x006), .O(new_n510_));
  aoi21  g354(.a(new_n510_), .b(new_n509_), .c(new_n337_), .O(new_n511_));
  nor3   g355(.a(new_n331_), .b(x117), .c(new_n301_), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(new_n511_), .c(new_n303_), .O(new_n513_));
  nand4  g357(.a(new_n157_), .b(new_n302_), .c(x038), .d(x030), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n507_), .O(new_n516_));
  nand4  g360(.a(new_n157_), .b(new_n302_), .c(x070), .d(x030), .O(new_n517_));
  nand3  g361(.a(x126), .b(new_n357_), .c(x006), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(new_n517_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n319_), .O(new_n520_));
  oai22  g364(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(x102), .O(new_n522_));
  oai21  g366(.a(new_n311_), .b(new_n315_), .c(new_n495_), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n522_), .c(new_n301_), .O(new_n524_));
  nand4  g368(.a(new_n495_), .b(new_n312_), .c(new_n302_), .d(x030), .O(new_n525_));
  inv1   g369(.a(new_n525_), .O(new_n526_));
  oai21  g370(.a(new_n526_), .b(new_n524_), .c(new_n157_), .O(new_n527_));
  nand2  g371(.a(new_n352_), .b(new_n311_), .O(new_n528_));
  nand2  g372(.a(x118), .b(new_n494_), .O(new_n529_));
  nand3  g373(.a(new_n529_), .b(new_n528_), .c(new_n491_), .O(new_n530_));
  nand3  g374(.a(new_n530_), .b(x126), .c(x006), .O(new_n531_));
  nand3  g375(.a(new_n531_), .b(new_n527_), .c(new_n520_), .O(new_n532_));
  nand2  g376(.a(new_n532_), .b(new_n303_), .O(new_n533_));
  nand2  g377(.a(new_n533_), .b(new_n516_), .O(new_n534_));
  nand3  g378(.a(new_n315_), .b(x014), .c(x006), .O(new_n535_));
  nor4   g379(.a(new_n535_), .b(new_n263_), .c(x062), .d(x054), .O(new_n536_));
  aoi21  g380(.a(new_n534_), .b(new_n304_), .c(new_n536_), .O(new_n537_));
  aoi21  g381(.a(new_n537_), .b(new_n506_), .c(x046), .O(z14));
  zero   g382(.O(z19));
  zero   g383(.O(z23));
  zero   g384(.O(z25));
  zero   g385(.O(z27));
  nor2   g386(.a(x126), .b(new_n157_), .O(z15));
  nor2   g387(.a(x126), .b(new_n157_), .O(z16));
  nor2   g388(.a(x126), .b(new_n157_), .O(z17));
  nor2   g389(.a(x126), .b(new_n157_), .O(z18));
  nor2   g390(.a(x126), .b(new_n157_), .O(z20));
  nor2   g391(.a(x126), .b(new_n157_), .O(z21));
  nor2   g392(.a(x126), .b(new_n157_), .O(z22));
  nor2   g393(.a(x126), .b(new_n157_), .O(z24));
  nor2   g394(.a(x126), .b(new_n157_), .O(z26));
endmodule
