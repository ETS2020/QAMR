// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:22 2020
...
module FAU ( 
  ...
  aoi21  g137(.a(new_n271_), .b(new_n157_), .c(new_n293_), .O(new_n294_));
  oai21  g138(.a(new_n294_), .b(new_n241_), .c(new_n160_), .O(z05));
  inv1   g139(.a(x046), .O(new_n296_));
  inv1   g140(.a(x038), .O(new_n297_));
  nor2   g141(.a(x022), .b(x014), .O(new_n298_));
  nand2  g142(.a(x094), .b(x062), .O(new_n299_));
  inv1   g143(.a(new_n299_), .O(new_n300_));
  oai21  g144(.a(new_n298_), .b(x030), .c(new_n300_), .O(new_n301_));
  nand3  g145(.a(new_n301_), .b(x086), .c(x078), .O(new_n302_));
  aoi21  g146(.a(new_n302_), .b(x054), .c(x005), .O(new_n303_));
  nor2   g147(.a(x078), .b(x054), .O(new_n304_));
  oai21  g148(.a(new_n304_), .b(new_n303_), .c(new_n297_), .O(new_n305_));
  aoi21  g149(.a(new_n300_), .b(x030), .c(new_n298_), .O(new_n306_));
  nand2  g150(.a(x126), .b(x102), .O(new_n307_));
  nand2  g151(.a(new_n307_), .b(x094), .O(new_n308_));
  and2   g152(.a(x118), .b(x110), .O(new_n309_));
  ...
  oai21  g157(.a(x126), .b(new_n313_), .c(new_n297_), .O(new_n314_));
  ...
  nor2   g163(.a(x126), .b(new_n312_), .O(new_n320_));
  aoi21  g164(.a(new_n320_), .b(x022), .c(new_n319_), .O(new_n321_));
  nand4  g165(.a(new_n321_), .b(new_n318_), .c(new_n315_), .d(new_n311_), .O(new_n322_));
  oai21  g166(.a(new_n322_), .b(new_n306_), .c(x054), .O(new_n323_));
  nand2  g167(.a(new_n319_), .b(x014), .O(new_n324_));
  ...
  oai21  g171(.a(new_n312_), .b(new_n313_), .c(new_n327_), .O(new_n328_));
  inv1   g172(.a(x070), .O(new_n329_));
  inv1   g173(.a(x022), .O(new_n330_));
  nor2   g174(.a(x030), .b(new_n330_), .O(new_n331_));
  oai21  g175(.a(new_n331_), .b(new_n299_), .c(new_n329_), .O(new_n332_));
  inv1   g176(.a(x030), .O(new_n333_));
  nor2   g177(.a(new_n326_), .b(new_n298_), .O(new_n334_));
  nand3  g178(.a(new_n334_), .b(new_n307_), .c(new_n333_), .O(new_n335_));
  nand3  g179(.a(new_n335_), .b(new_n332_), .c(new_n328_), .O(new_n336_));
  nand3  g180(.a(new_n336_), .b(x086), .c(x054), .O(new_n337_));
  inv1   g181(.a(x014), .O(new_n338_));
  nand2  g182(.a(new_n297_), .b(new_n338_), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n329_), .c(new_n330_), .O(new_n340_));
  ...
  nand4  g188(.a(new_n344_), .b(x062), .c(x038), .d(new_n343_), .O(new_n345_));
  oai21  g189(.a(new_n309_), .b(new_n319_), .c(new_n345_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(x054), .c(new_n338_), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n342_), .O(new_n348_));
  nand3  g192(.a(new_n329_), .b(x054), .c(new_n330_), .O(new_n349_));
  nand3  g193(.a(new_n319_), .b(x038), .c(new_n343_), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n349_), .c(x014), .O(new_n351_));
  and2   g195(.a(new_n351_), .b(new_n158_), .O(new_n352_));
  aoi21  g196(.a(new_n348_), .b(new_n157_), .c(new_n352_), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n305_), .c(new_n296_), .O(z06));
  ...
  nand2  g206(.a(new_n363_), .b(new_n170_), .O(new_n364_));
  ...
  nand3  g214(.a(x120), .b(new_n371_), .c(new_n169_), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(new_n162_), .O(new_n373_));
  aoi21  g216(.a(new_n370_), .b(new_n164_), .c(new_n373_), .O(new_n374_));
  nand4  g217(.a(new_n374_), .b(new_n367_), .c(new_n364_), .d(new_n360_), .O(new_n375_));
  nor2   g218(.a(x032), .b(new_n163_), .O(new_n376_));
  nor2   g219(.a(new_n365_), .b(x056), .O(new_n377_));
  aoi22  g220(.a(new_n377_), .b(new_n376_), .c(new_n375_), .d(new_n166_), .O(new_n378_));
  nand3  g221(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n379_));
  oai21  g222(.a(new_n378_), .b(x048), .c(new_n379_), .O(new_n380_));
  inv1   g223(.a(new_n362_), .O(new_n381_));
  nand2  g224(.a(x088), .b(x056), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(x024), .c(x016), .O(new_n383_));
  oai21  g226(.a(new_n383_), .b(x072), .c(new_n163_), .O(new_n384_));
  nand2  g227(.a(new_n384_), .b(new_n381_), .O(new_n385_));
  nand2  g228(.a(x024), .b(new_n169_), .O(new_n386_));
  aoi21  g229(.a(new_n386_), .b(new_n358_), .c(new_n170_), .O(new_n387_));
  inv1   g230(.a(new_n361_), .O(new_n388_));
  nand4  g231(.a(new_n382_), .b(new_n388_), .c(new_n356_), .d(x024), .O(new_n389_));
  inv1   g232(.a(new_n389_), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(new_n387_), .c(new_n166_), .O(new_n391_));
  aoi21  g234(.a(new_n391_), .b(new_n385_), .c(x048), .O(new_n392_));
  nand2  g235(.a(new_n356_), .b(x024), .O(new_n393_));
  nand2  g236(.a(new_n393_), .b(new_n358_), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(new_n166_), .c(x032), .O(new_n395_));
  ...
  oai21  g245(.a(new_n402_), .b(x040), .c(new_n160_), .O(z08));
  ...
  oai21  g253(.a(new_n410_), .b(x041), .c(new_n160_), .O(z09));
  ...
  nand3  g261(.a(new_n418_), .b(new_n160_), .c(new_n412_), .O(new_n419_));
  ...
  oai21  g270(.a(new_n427_), .b(x043), .c(new_n160_), .O(z11));
  ...
  oai21  g278(.a(new_n435_), .b(x044), .c(new_n160_), .O(z12));
  nand2  g279(.a(x021), .b(x013), .O(new_n437_));
  oai21  g280(.a(new_n280_), .b(x029), .c(new_n437_), .O(new_n438_));
  inv1   g281(.a(x101), .O(new_n439_));
  aoi21  g282(.a(new_n261_), .b(new_n439_), .c(x093), .O(new_n440_));
  nor2   g283(.a(x117), .b(x109), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n440_), .c(new_n277_), .O(new_n443_));
  oai21  g286(.a(new_n261_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(x117), .O(new_n445_));
  oai21  g288(.a(new_n439_), .b(x061), .c(new_n251_), .O(new_n446_));
  nand3  g289(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n269_), .O(new_n448_));
  aoi21  g291(.a(new_n446_), .b(new_n256_), .c(new_n448_), .O(new_n449_));
  nand4  g292(.a(new_n449_), .b(new_n445_), .c(new_n443_), .d(new_n438_), .O(new_n450_));
  nand4  g293(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n451_));
  inv1   g294(.a(new_n451_), .O(new_n452_));
  aoi21  g295(.a(new_n450_), .b(new_n276_), .c(new_n452_), .O(new_n453_));
  nand3  g296(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n454_));
  oai21  g297(.a(new_n453_), .b(x053), .c(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n247_), .b(x029), .c(x021), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(x077), .c(new_n244_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n442_), .O(new_n458_));
  nand2  g301(.a(x029), .b(new_n245_), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n272_), .c(new_n277_), .O(new_n460_));
  nand2  g303(.a(new_n261_), .b(new_n439_), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n437_), .c(new_n247_), .d(x029), .O(new_n462_));
  inv1   g305(.a(new_n462_), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n460_), .c(new_n276_), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(new_n458_), .c(x053), .O(new_n465_));
  ...
  oai21  g312(.a(new_n469_), .b(new_n465_), .c(new_n269_), .O(new_n470_));
  ...
  aoi21  g317(.a(new_n455_), .b(x005), .c(new_n474_), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(x045), .c(new_n160_), .O(z13));
  nand3  g319(.a(x126), .b(new_n313_), .c(x006), .O(new_n477_));
  oai21  g320(.a(x086), .b(new_n333_), .c(new_n477_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n338_), .O(new_n479_));
  oai21  g322(.a(new_n333_), .b(x022), .c(new_n326_), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(new_n319_), .c(x054), .O(new_n481_));
  aoi21  g324(.a(new_n481_), .b(new_n479_), .c(x078), .O(new_n482_));
  inv1   g325(.a(x054), .O(new_n483_));
  nor2   g326(.a(new_n483_), .b(x005), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(new_n482_), .c(x038), .O(new_n485_));
  nand3  g328(.a(x070), .b(new_n483_), .c(x022), .O(new_n486_));
  nand3  g329(.a(x086), .b(new_n297_), .c(x006), .O(new_n487_));
  nand3  g330(.a(new_n487_), .b(new_n486_), .c(new_n338_), .O(new_n488_));
  nand3  g331(.a(new_n488_), .b(x078), .c(new_n157_), .O(new_n489_));
  inv1   g332(.a(new_n489_), .O(new_n490_));
  oai21  g333(.a(new_n329_), .b(new_n297_), .c(x006), .O(new_n491_));
  oai21  g334(.a(new_n300_), .b(new_n333_), .c(new_n298_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n319_), .O(new_n493_));
  aoi22  g336(.a(new_n493_), .b(new_n491_), .c(new_n312_), .d(new_n313_), .O(new_n494_));
  nand3  g337(.a(new_n319_), .b(x070), .c(x030), .O(new_n495_));
  nand3  g338(.a(x102), .b(new_n316_), .c(x006), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n495_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n297_), .O(new_n498_));
  nand2  g341(.a(x022), .b(x014), .O(new_n499_));
  aoi22  g342(.a(new_n499_), .b(x006), .c(new_n319_), .d(x070), .O(new_n500_));
  or2    g343(.a(new_n500_), .b(new_n326_), .O(new_n501_));
  nand4  g344(.a(new_n499_), .b(new_n299_), .c(new_n319_), .d(x030), .O(new_n502_));
  inv1   g345(.a(x094), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n329_), .c(x006), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n502_), .O(new_n505_));
  oai21  g348(.a(x126), .b(x102), .c(new_n505_), .O(new_n506_));
  nand2  g349(.a(x126), .b(new_n312_), .O(new_n507_));
  aoi21  g350(.a(new_n507_), .b(new_n333_), .c(x022), .O(new_n508_));
  nand2  g351(.a(x030), .b(new_n338_), .O(new_n509_));
  nand3  g352(.a(x126), .b(x094), .c(new_n316_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n509_), .c(new_n319_), .O(new_n511_));
  ...
  oai21  g356(.a(new_n513_), .b(new_n494_), .c(new_n483_), .O(new_n514_));
  oai22  g357(.a(new_n319_), .b(new_n343_), .c(new_n329_), .d(new_n330_), .O(new_n515_));
  nor2   g358(.a(new_n329_), .b(x038), .O(new_n516_));
  aoi22  g359(.a(new_n516_), .b(x022), .c(new_n515_), .d(new_n338_), .O(new_n517_));
  nand2  g360(.a(new_n517_), .b(new_n514_), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n158_), .c(new_n490_), .O(new_n519_));
  ...
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g374(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g375(.a(new_n158_), .b(new_n157_), .O(z26));
endmodule
