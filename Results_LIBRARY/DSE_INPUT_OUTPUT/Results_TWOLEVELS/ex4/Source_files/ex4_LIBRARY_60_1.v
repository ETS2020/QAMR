...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x065), .O(z16));
  ...
  nand4  g033(.a(new_n189_), .b(new_n172_), .c(new_n188_), .d(new_n187_), .O(new_n190_));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(new_n172_), .b(x065), .O(z17));
  nor2   g369(.a(new_n172_), .b(x065), .O(z18));
  nor2   g370(.a(new_n172_), .b(x065), .O(z23));
  nor2   g371(.a(new_n172_), .b(x065), .O(z24));
endmodule
