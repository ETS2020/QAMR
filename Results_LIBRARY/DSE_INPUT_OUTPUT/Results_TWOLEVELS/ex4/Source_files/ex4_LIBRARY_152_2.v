...
module FAU ( 
  ...
  nand4  g326(.a(x086), .b(new_n172_), .c(new_n300_), .d(new_n319_), .O(new_n484_));
  ...
  nand2  g346(.a(new_n503_), .b(new_n172_), .O(new_n504_));
  ...
  zero   g356(.O(z23));
  zero   g357(.O(z24));
  nor2   g358(.a(x078), .b(new_n172_), .O(z25));
  nor2   g359(.a(x078), .b(new_n172_), .O(z26));
