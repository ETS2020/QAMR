// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:21 2020
...
module FAU ( 
  ...
  nor2   g151(.a(x110), .b(new_n297_), .O(new_n308_));
  nor2   g152(.a(x118), .b(new_n304_), .O(new_n309_));
  oai21  g153(.a(new_n309_), .b(new_n308_), .c(new_n298_), .O(new_n310_));
  ...
  nand2  g161(.a(new_n317_), .b(new_n311_), .O(new_n318_));
  inv1   g162(.a(x070), .O(new_n319_));
  nor2   g163(.a(x030), .b(new_n299_), .O(new_n320_));
  oai21  g164(.a(new_n320_), .b(new_n301_), .c(new_n319_), .O(new_n321_));
  nand2  g165(.a(new_n299_), .b(new_n298_), .O(new_n322_));
  nand2  g166(.a(x126), .b(x102), .O(new_n323_));
  nand4  g167(.a(new_n323_), .b(new_n315_), .c(new_n322_), .d(new_n312_), .O(new_n324_));
  nand3  g168(.a(new_n324_), .b(new_n321_), .c(new_n318_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(x078), .O(new_n326_));
  aoi21  g170(.a(new_n326_), .b(new_n310_), .c(new_n307_), .O(new_n327_));
  inv1   g171(.a(x006), .O(new_n328_));
  oai21  g172(.a(new_n301_), .b(new_n312_), .c(new_n322_), .O(new_n329_));
  oai22  g173(.a(new_n314_), .b(new_n319_), .c(new_n313_), .d(new_n296_), .O(new_n330_));
  nand2  g174(.a(new_n330_), .b(new_n323_), .O(new_n331_));
  oai21  g175(.a(x070), .b(x038), .c(new_n311_), .O(new_n332_));
  inv1   g176(.a(x126), .O(new_n333_));
  nand2  g177(.a(x118), .b(x022), .O(new_n334_));
  oai21  g178(.a(x118), .b(new_n304_), .c(new_n334_), .O(new_n335_));
  aoi21  g179(.a(new_n335_), .b(new_n333_), .c(new_n307_), .O(new_n336_));
  nand4  g180(.a(new_n336_), .b(new_n332_), .c(new_n331_), .d(new_n329_), .O(new_n337_));
  nand3  g181(.a(new_n337_), .b(x078), .c(new_n328_), .O(new_n338_));
  nor2   g182(.a(new_n304_), .b(x078), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n319_), .c(new_n299_), .O(new_n340_));
  nand2  g184(.a(new_n340_), .b(new_n338_), .O(new_n341_));
  oai21  g185(.a(new_n341_), .b(new_n327_), .c(x054), .O(new_n342_));
  nand2  g186(.a(x078), .b(x014), .O(new_n343_));
  nand2  g187(.a(new_n339_), .b(x038), .O(new_n344_));
  aoi21  g188(.a(new_n344_), .b(new_n343_), .c(x086), .O(new_n345_));
  nand2  g189(.a(new_n296_), .b(new_n298_), .O(new_n346_));
  nand4  g190(.a(new_n346_), .b(x078), .c(new_n319_), .d(new_n299_), .O(new_n347_));
  nand2  g191(.a(new_n339_), .b(new_n298_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  aoi21  g193(.a(new_n345_), .b(new_n328_), .c(new_n349_), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n342_), .c(new_n306_), .O(new_n351_));
  and2   g195(.a(new_n351_), .b(x046), .O(z06));
  inv1   g196(.a(x040), .O(new_n353_));
  nand2  g197(.a(x016), .b(x008), .O(new_n354_));
  inv1   g198(.a(x056), .O(new_n355_));
  inv1   g199(.a(x088), .O(new_n356_));
  nand2  g200(.a(new_n356_), .b(new_n355_), .O(new_n357_));
  oai21  g201(.a(new_n357_), .b(x024), .c(new_n354_), .O(new_n358_));
  nor2   g202(.a(x120), .b(x096), .O(new_n359_));
  nor2   g203(.a(x112), .b(x104), .O(new_n360_));
  oai21  g204(.a(new_n359_), .b(x088), .c(new_n360_), .O(new_n361_));
  nand2  g205(.a(new_n361_), .b(new_n168_), .O(new_n362_));
  inv1   g206(.a(x120), .O(new_n363_));
  oai21  g207(.a(new_n363_), .b(x104), .c(x032), .O(new_n364_));
  nand2  g208(.a(new_n364_), .b(x112), .O(new_n365_));
  inv1   g209(.a(x096), .O(new_n366_));
  inv1   g210(.a(x104), .O(new_n367_));
  oai21  g211(.a(new_n366_), .b(x056), .c(new_n367_), .O(new_n368_));
  ...
  nand4  g216(.a(new_n372_), .b(new_n365_), .c(new_n362_), .d(new_n358_), .O(new_n373_));
  nand4  g217(.a(x120), .b(new_n355_), .c(new_n162_), .d(x008), .O(new_n374_));
  ...
  aoi21  g227(.a(new_n383_), .b(new_n161_), .c(new_n360_), .O(new_n384_));
  inv1   g228(.a(x024), .O(new_n385_));
  nor2   g229(.a(new_n385_), .b(x016), .O(new_n386_));
  oai21  g230(.a(new_n386_), .b(new_n357_), .c(x064), .O(new_n387_));
  inv1   g231(.a(new_n359_), .O(new_n388_));
  nand4  g232(.a(new_n380_), .b(new_n388_), .c(new_n354_), .d(x024), .O(new_n389_));
  aoi21  g233(.a(new_n389_), .b(new_n387_), .c(x072), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(new_n384_), .c(new_n163_), .O(new_n391_));
  nand2  g235(.a(new_n354_), .b(x024), .O(new_n392_));
  nand3  g236(.a(new_n392_), .b(new_n356_), .c(new_n355_), .O(new_n393_));
  nand3  g237(.a(new_n393_), .b(new_n164_), .c(x032), .O(new_n394_));
  ...
  aoi21  g243(.a(new_n395_), .b(new_n160_), .c(new_n399_), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(new_n379_), .O(new_n401_));
  nand3  g245(.a(new_n401_), .b(new_n158_), .c(new_n353_), .O(new_n402_));
  ...
  oai21  g254(.a(new_n410_), .b(x041), .c(new_n158_), .O(z09));
  ...
  nand3  g262(.a(new_n418_), .b(new_n158_), .c(new_n412_), .O(new_n419_));
  inv1   g263(.a(new_n419_), .O(z10));
  inv1   g264(.a(x043), .O(new_n421_));
  ...
  nand3  g271(.a(new_n427_), .b(new_n158_), .c(new_n421_), .O(new_n428_));
  inv1   g272(.a(new_n428_), .O(z11));
  inv1   g273(.a(x044), .O(new_n430_));
  ...
  nand3  g280(.a(new_n436_), .b(new_n158_), .c(new_n430_), .O(new_n437_));
  inv1   g281(.a(new_n437_), .O(z12));
  oai22  g282(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n439_));
  inv1   g283(.a(x101), .O(new_n440_));
  aoi21  g284(.a(new_n259_), .b(new_n440_), .c(x093), .O(new_n441_));
  nand2  g285(.a(new_n250_), .b(new_n249_), .O(new_n442_));
  oai21  g286(.a(new_n442_), .b(new_n441_), .c(new_n276_), .O(new_n443_));
  oai21  g287(.a(new_n259_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x117), .O(new_n445_));
  oai21  g289(.a(new_n440_), .b(x061), .c(new_n249_), .O(new_n446_));
  nand3  g290(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n267_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(new_n254_), .c(new_n448_), .O(new_n449_));
  nand4  g293(.a(new_n449_), .b(new_n445_), .c(new_n443_), .d(new_n439_), .O(new_n450_));
  nand4  g294(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n451_));
  inv1   g295(.a(new_n451_), .O(new_n452_));
  aoi21  g296(.a(new_n450_), .b(new_n275_), .c(new_n452_), .O(new_n453_));
  nand3  g297(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n454_));
  oai21  g298(.a(new_n453_), .b(x053), .c(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n245_), .b(x029), .c(x021), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(x077), .c(new_n242_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n442_), .O(new_n458_));
  nand2  g302(.a(x029), .b(new_n243_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n271_), .c(new_n276_), .O(new_n460_));
  nand2  g304(.a(new_n259_), .b(new_n440_), .O(new_n461_));
  aoi22  g305(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n462_));
  nand3  g306(.a(new_n462_), .b(new_n461_), .c(x029), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n460_), .c(new_n275_), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n458_), .c(x053), .O(new_n466_));
  oai21  g310(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n271_), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n275_), .c(x037), .O(new_n469_));
  ...
  nand3  g318(.a(new_n474_), .b(new_n473_), .c(new_n471_), .O(new_n475_));
  aoi21  g319(.a(new_n455_), .b(x005), .c(new_n475_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(x045), .c(new_n158_), .O(z13));
  inv1   g321(.a(x054), .O(new_n478_));
  nand3  g322(.a(x110), .b(new_n307_), .c(new_n478_), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n297_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(x014), .O(new_n481_));
  oai22  g325(.a(new_n307_), .b(new_n328_), .c(new_n319_), .d(new_n299_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n298_), .O(new_n483_));
  oai22  g327(.a(x086), .b(x054), .c(new_n319_), .d(x038), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(x022), .O(new_n485_));
  nand2  g329(.a(new_n301_), .b(x030), .O(new_n486_));
  nand2  g330(.a(new_n315_), .b(x070), .O(new_n487_));
  aoi21  g331(.a(new_n487_), .b(new_n486_), .c(x086), .O(new_n488_));
  nor2   g332(.a(new_n319_), .b(new_n296_), .O(new_n489_));
  inv1   g333(.a(x118), .O(new_n490_));
  aoi21  g334(.a(x126), .b(new_n490_), .c(x086), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n489_), .c(new_n328_), .O(new_n492_));
  oai21  g336(.a(new_n492_), .b(new_n488_), .c(new_n478_), .O(new_n493_));
  nand3  g337(.a(new_n315_), .b(new_n307_), .c(x038), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n493_), .c(new_n485_), .d(new_n483_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n297_), .O(new_n496_));
  nand2  g340(.a(x054), .b(x038), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n496_), .O(new_n498_));
  nand3  g342(.a(x070), .b(new_n478_), .c(x022), .O(new_n499_));
  nand3  g343(.a(x086), .b(new_n296_), .c(x006), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n499_), .c(new_n497_), .O(new_n501_));
  aoi22  g345(.a(new_n501_), .b(x078), .c(new_n498_), .d(x110), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n481_), .c(x046), .O(z14));
  zero   g347(.O(z16));
  zero   g348(.O(z18));
  zero   g349(.O(z21));
  zero   g350(.O(z22));
  ...
  zero   g353(.O(z25));
  zero   g354(.O(z27));
  nor2   g355(.a(x110), .b(x078), .O(z15));
  nor2   g356(.a(x110), .b(x078), .O(z17));
  nor2   g357(.a(x110), .b(x078), .O(z19));
  nor2   g358(.a(x110), .b(x078), .O(z20));
  nor2   g359(.a(x110), .b(x078), .O(z26));
endmodule
