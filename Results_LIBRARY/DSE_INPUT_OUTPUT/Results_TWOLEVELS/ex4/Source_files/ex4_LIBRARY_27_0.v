...
module FAU ( 
  ...
  aoi21  g321(.a(x054), .b(x038), .c(x014), .O(new_n478_));
  nand3  g322(.a(x070), .b(new_n298_), .c(x022), .O(new_n479_));
  nand3  g323(.a(x086), .b(new_n312_), .c(x006), .O(new_n480_));
  nand4  g324(.a(new_n480_), .b(new_n479_), .c(new_n478_), .d(x078), .O(new_n481_));
  and2   g325(.a(new_n481_), .b(new_n296_), .O(z14));
  zero   g326(.O(z15));
  zero   g327(.O(z20));
  zero   g328(.O(z21));
  zero   g329(.O(z22));
  ...
  zero   g332(.O(z26));
  zero   g333(.O(z27));
  nor2   g334(.a(x078), .b(x046), .O(z16));
  nor2   g335(.a(x078), .b(x046), .O(z17));
  nor2   g336(.a(x078), .b(x046), .O(z18));
