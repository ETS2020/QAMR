...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x079), .O(new_n304_));
  ...
  nand2  g207(.a(new_n364_), .b(new_n170_), .O(new_n365_));
  ...
  nand3  g215(.a(x120), .b(new_n372_), .c(new_n169_), .O(new_n373_));
  nand2  g216(.a(new_n373_), .b(new_n162_), .O(new_n374_));
  aoi21  g217(.a(new_n371_), .b(new_n164_), .c(new_n374_), .O(new_n375_));
  nand4  g218(.a(new_n375_), .b(new_n368_), .c(new_n365_), .d(new_n361_), .O(new_n376_));
  nor2   g219(.a(x032), .b(new_n163_), .O(new_n377_));
  nor2   g220(.a(new_n366_), .b(x056), .O(new_n378_));
  aoi22  g221(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n166_), .O(new_n379_));
  nand3  g222(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n380_));
  ...
  oai21  g227(.a(new_n384_), .b(x072), .c(new_n163_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g229(.a(x024), .b(new_n169_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n359_), .c(new_n170_), .O(new_n388_));
  ...
  oai21  g234(.a(new_n391_), .b(new_n388_), .c(new_n166_), .O(new_n392_));
  ...
  oai21  g281(.a(new_n438_), .b(x044), .c(new_n160_), .O(z12));
  ...
  oai21  g321(.a(new_n478_), .b(x045), .c(new_n160_), .O(z13));
  aoi21  g322(.a(new_n297_), .b(x014), .c(x079), .O(new_n480_));
  ...
  nand4  g338(.a(x126), .b(new_n317_), .c(new_n298_), .d(x014), .O(new_n496_));
  inv1   g339(.a(new_n496_), .O(new_n497_));
  aoi21  g340(.a(new_n495_), .b(new_n157_), .c(new_n497_), .O(new_n498_));
  nand3  g341(.a(x086), .b(new_n298_), .c(new_n339_), .O(new_n499_));
