...
module FAU ( 
  ...
  aoi22  g198(.a(new_n164_), .b(new_n162_), .c(new_n163_), .d(new_n161_), .O(new_n355_));
  inv1   g199(.a(x056), .O(new_n356_));
  inv1   g200(.a(x088), .O(new_n357_));
  nand2  g201(.a(new_n357_), .b(new_n356_), .O(new_n358_));
  nand3  g202(.a(new_n358_), .b(new_n160_), .c(new_n164_), .O(new_n359_));
  oai22  g203(.a(new_n359_), .b(x048), .c(new_n355_), .d(new_n167_), .O(new_n360_));
  nand2  g204(.a(new_n360_), .b(x064), .O(new_n361_));
  nand2  g205(.a(new_n359_), .b(new_n163_), .O(new_n362_));
  ...
  nand2  g210(.a(x112), .b(x103), .O(new_n367_));
  ...
  nand3  g226(.a(new_n382_), .b(new_n357_), .c(new_n168_), .O(new_n383_));
  nand3  g227(.a(x096), .b(new_n356_), .c(new_n162_), .O(new_n384_));
  nand3  g228(.a(x120), .b(new_n366_), .c(new_n167_), .O(new_n385_));
  nand4  g229(.a(new_n385_), .b(new_n384_), .c(new_n383_), .d(new_n379_), .O(new_n386_));
  nand4  g230(.a(x120), .b(new_n356_), .c(new_n162_), .d(x008), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(new_n388_));
  aoi21  g232(.a(new_n386_), .b(new_n164_), .c(new_n388_), .O(new_n389_));
  nand3  g233(.a(new_n382_), .b(new_n376_), .c(new_n370_), .O(new_n390_));
  oai21  g234(.a(new_n168_), .b(x016), .c(new_n390_), .O(new_n391_));
  nand4  g235(.a(new_n391_), .b(new_n160_), .c(new_n164_), .d(x024), .O(new_n392_));
  oai21  g236(.a(new_n389_), .b(new_n159_), .c(new_n392_), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(x103), .O(new_n394_));
  nor2   g238(.a(new_n381_), .b(x112), .O(new_n395_));
  nand4  g239(.a(new_n395_), .b(x104), .c(new_n164_), .d(x000), .O(new_n396_));
  nand3  g240(.a(new_n396_), .b(new_n394_), .c(new_n375_), .O(new_n397_));
  nand4  g241(.a(new_n376_), .b(x103), .c(new_n160_), .d(new_n164_), .O(new_n398_));
  nor3   g242(.a(new_n398_), .b(new_n162_), .c(new_n377_), .O(new_n399_));
  aoi21  g243(.a(new_n397_), .b(new_n163_), .c(new_n399_), .O(new_n400_));
  ...
  zero   g360(.O(z20));
  zero   g361(.O(z25));
  nor2   g362(.a(x104), .b(x103), .O(z17));
  nor2   g363(.a(x104), .b(x103), .O(z18));
  nor2   g364(.a(x104), .b(x103), .O(z21));
  nor2   g365(.a(x104), .b(x103), .O(z22));
  nor2   g366(.a(x104), .b(x103), .O(z23));
  nor2   g367(.a(x104), .b(x103), .O(z24));
  nor2   g368(.a(x104), .b(x103), .O(z26));
  nor2   g369(.a(x104), .b(x103), .O(z27));
endmodule
