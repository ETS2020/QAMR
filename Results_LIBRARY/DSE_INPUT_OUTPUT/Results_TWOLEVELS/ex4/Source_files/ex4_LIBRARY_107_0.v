...
module FAU ( 
  ...
  nand3  g315(.a(new_n471_), .b(new_n173_), .c(new_n431_), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(z13));
  aoi21  g317(.a(x054), .b(x038), .c(x014), .O(new_n474_));
  nand3  g318(.a(x070), .b(new_n301_), .c(x022), .O(new_n475_));
  nand3  g319(.a(x086), .b(new_n312_), .c(x006), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n475_), .c(new_n474_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(x078), .c(new_n297_), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(z14));
  zero   g323(.O(z17));
  zero   g324(.O(z18));
  zero   g325(.O(z19));
  zero   g326(.O(z20));
