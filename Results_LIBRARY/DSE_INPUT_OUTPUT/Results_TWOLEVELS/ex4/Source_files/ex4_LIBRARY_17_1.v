// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:03 2020
...
module FAU ( 
  ...
  nand3  g073(.a(new_n229_), .b(new_n157_), .c(new_n224_), .O(new_n230_));
  ...
  nand2  g081(.a(new_n237_), .b(new_n159_), .O(z04));
  ...
  nor2   g155(.a(x084), .b(x054), .O(new_n312_));
  ...
  nor2   g167(.a(new_n306_), .b(new_n323_), .O(new_n324_));
  aoi21  g168(.a(new_n324_), .b(new_n322_), .c(new_n299_), .O(new_n325_));
  oai22  g169(.a(new_n325_), .b(new_n317_), .c(new_n315_), .d(new_n314_), .O(new_n326_));
  nand3  g170(.a(x086), .b(new_n316_), .c(new_n318_), .O(new_n327_));
  inv1   g171(.a(x102), .O(new_n328_));
  nand3  g172(.a(new_n328_), .b(x062), .c(new_n300_), .O(new_n329_));
  nand2  g173(.a(new_n329_), .b(new_n327_), .O(new_n330_));
  nand2  g174(.a(new_n330_), .b(x038), .O(new_n331_));
  nand2  g175(.a(new_n306_), .b(new_n323_), .O(new_n332_));
  nand4  g176(.a(new_n332_), .b(new_n321_), .c(x086), .d(new_n318_), .O(new_n333_));
  nand3  g177(.a(x094), .b(x070), .c(new_n300_), .O(new_n334_));
  nand2  g178(.a(new_n334_), .b(new_n333_), .O(new_n335_));
  oai21  g179(.a(new_n301_), .b(new_n328_), .c(new_n335_), .O(new_n336_));
  oai21  g180(.a(new_n307_), .b(new_n318_), .c(new_n332_), .O(new_n337_));
  nand2  g181(.a(x118), .b(x022), .O(new_n338_));
  oai21  g182(.a(x094), .b(new_n319_), .c(new_n338_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n301_), .O(new_n340_));
  nand3  g184(.a(new_n340_), .b(new_n337_), .c(x086), .O(new_n341_));
  nand3  g185(.a(new_n307_), .b(x086), .c(new_n316_), .O(new_n342_));
  inv1   g186(.a(new_n342_), .O(new_n343_));
  aoi21  g187(.a(new_n341_), .b(new_n300_), .c(new_n343_), .O(new_n344_));
  nand4  g188(.a(new_n344_), .b(new_n336_), .c(new_n331_), .d(new_n326_), .O(new_n345_));
  nand2  g189(.a(new_n345_), .b(x054), .O(new_n346_));
  oai22  g190(.a(x086), .b(x006), .c(x070), .d(x022), .O(new_n347_));
  nor2   g191(.a(x070), .b(new_n297_), .O(new_n348_));
  aoi22  g192(.a(new_n348_), .b(new_n306_), .c(new_n347_), .d(x014), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(new_n346_), .O(new_n350_));
  nand3  g194(.a(new_n316_), .b(x054), .c(new_n306_), .O(new_n351_));
  nand3  g195(.a(new_n299_), .b(x038), .c(new_n300_), .O(new_n352_));
  nand3  g196(.a(new_n352_), .b(new_n351_), .c(x014), .O(new_n353_));
  nand3  g197(.a(new_n353_), .b(new_n157_), .c(new_n298_), .O(new_n354_));
  inv1   g198(.a(new_n354_), .O(new_n355_));
  aoi21  g199(.a(new_n350_), .b(x078), .c(new_n355_), .O(new_n356_));
  aoi21  g200(.a(new_n356_), .b(new_n313_), .c(new_n296_), .O(z06));
  inv1   g201(.a(x040), .O(new_n359_));
  nand2  g202(.a(x016), .b(x008), .O(new_n360_));
  inv1   g203(.a(x056), .O(new_n361_));
  inv1   g204(.a(x088), .O(new_n362_));
  nand2  g205(.a(new_n362_), .b(new_n361_), .O(new_n363_));
  oai21  g206(.a(new_n363_), .b(x024), .c(new_n360_), .O(new_n364_));
  nor2   g207(.a(x120), .b(x096), .O(new_n365_));
  nor2   g208(.a(x112), .b(x104), .O(new_n366_));
  oai21  g209(.a(new_n365_), .b(x088), .c(new_n366_), .O(new_n367_));
  nand2  g210(.a(new_n367_), .b(new_n169_), .O(new_n368_));
  inv1   g211(.a(x120), .O(new_n369_));
  oai21  g212(.a(new_n369_), .b(x104), .c(x032), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(x112), .O(new_n371_));
  inv1   g214(.a(x096), .O(new_n372_));
  inv1   g215(.a(x104), .O(new_n373_));
  oai21  g216(.a(new_n372_), .b(x056), .c(new_n373_), .O(new_n374_));
  ...
  nand4  g221(.a(new_n378_), .b(new_n371_), .c(new_n368_), .d(new_n364_), .O(new_n379_));
  nand4  g222(.a(x120), .b(new_n361_), .c(new_n163_), .d(x008), .O(new_n380_));
  ...
  aoi21  g232(.a(new_n389_), .b(new_n162_), .c(new_n366_), .O(new_n390_));
  inv1   g233(.a(x024), .O(new_n391_));
  nor2   g234(.a(new_n391_), .b(x016), .O(new_n392_));
  oai21  g235(.a(new_n392_), .b(new_n363_), .c(x064), .O(new_n393_));
  inv1   g236(.a(new_n365_), .O(new_n394_));
  nand4  g237(.a(new_n386_), .b(new_n394_), .c(new_n360_), .d(x024), .O(new_n395_));
  aoi21  g238(.a(new_n395_), .b(new_n393_), .c(x072), .O(new_n396_));
  oai21  g239(.a(new_n396_), .b(new_n390_), .c(new_n164_), .O(new_n397_));
  nand2  g240(.a(new_n360_), .b(x024), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n362_), .c(new_n361_), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(new_n165_), .c(x032), .O(new_n400_));
  ...
  aoi21  g248(.a(new_n401_), .b(new_n161_), .c(new_n405_), .O(new_n406_));
  nand2  g249(.a(new_n406_), .b(new_n385_), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(new_n159_), .c(new_n359_), .O(new_n408_));
  inv1   g251(.a(new_n408_), .O(z08));
  inv1   g252(.a(x041), .O(new_n410_));
  ...
  oai21  g284(.a(new_n441_), .b(new_n437_), .c(x078), .O(new_n442_));
  nand2  g285(.a(new_n441_), .b(new_n157_), .O(new_n443_));
  aoi21  g286(.a(new_n443_), .b(new_n442_), .c(x044), .O(z12));
  inv1   g287(.a(x045), .O(new_n445_));
  nand2  g288(.a(x021), .b(x013), .O(new_n446_));
  oai21  g289(.a(new_n279_), .b(x029), .c(new_n446_), .O(new_n447_));
  nor2   g290(.a(x125), .b(x101), .O(new_n448_));
  nor2   g291(.a(x117), .b(x109), .O(new_n449_));
  oai21  g292(.a(new_n448_), .b(x093), .c(new_n449_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n276_), .O(new_n451_));
  oai21  g294(.a(new_n259_), .b(x109), .c(x037), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(x117), .O(new_n453_));
  inv1   g296(.a(x101), .O(new_n454_));
  oai21  g297(.a(new_n454_), .b(x061), .c(new_n249_), .O(new_n455_));
  nand3  g298(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n267_), .O(new_n457_));
  aoi21  g300(.a(new_n455_), .b(new_n254_), .c(new_n457_), .O(new_n458_));
  nand4  g301(.a(new_n458_), .b(new_n453_), .c(new_n451_), .d(new_n447_), .O(new_n459_));
  nand4  g302(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n460_));
  inv1   g303(.a(new_n460_), .O(new_n461_));
  aoi21  g304(.a(new_n459_), .b(new_n275_), .c(new_n461_), .O(new_n462_));
  nand3  g305(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n463_));
  oai21  g306(.a(new_n462_), .b(x053), .c(new_n463_), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x005), .O(new_n465_));
  nand2  g308(.a(new_n245_), .b(x029), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n243_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n275_), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n242_), .c(new_n449_), .O(new_n469_));
  nor2   g312(.a(new_n241_), .b(x021), .O(new_n470_));
  oai21  g313(.a(new_n470_), .b(new_n279_), .c(x069), .O(new_n471_));
  inv1   g314(.a(new_n448_), .O(new_n472_));
  nand4  g315(.a(new_n472_), .b(new_n446_), .c(new_n245_), .d(x029), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n471_), .c(x077), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n469_), .c(new_n240_), .O(new_n475_));
  nand2  g318(.a(new_n446_), .b(x029), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n271_), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n275_), .c(x037), .O(new_n478_));
  ...
  aoi21  g326(.a(new_n479_), .b(new_n267_), .c(new_n483_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n465_), .O(new_n485_));
  nand3  g328(.a(new_n485_), .b(new_n159_), .c(new_n445_), .O(new_n486_));
  inv1   g329(.a(new_n486_), .O(z13));
  oai22  g330(.a(new_n321_), .b(x030), .c(new_n306_), .d(new_n323_), .O(new_n488_));
  aoi21  g331(.a(new_n301_), .b(new_n328_), .c(x094), .O(new_n489_));
  ...
  oai21  g335(.a(new_n301_), .b(x110), .c(x038), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(x118), .O(new_n494_));
  oai21  g337(.a(new_n328_), .b(x062), .c(new_n314_), .O(new_n495_));
  nand3  g338(.a(x126), .b(new_n315_), .c(new_n306_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n299_), .O(new_n497_));
  aoi21  g340(.a(new_n495_), .b(new_n297_), .c(new_n497_), .O(new_n498_));
  nand4  g341(.a(new_n498_), .b(new_n494_), .c(new_n492_), .d(new_n488_), .O(new_n499_));
  nand4  g342(.a(x126), .b(new_n319_), .c(new_n297_), .d(x014), .O(new_n500_));
  inv1   g343(.a(new_n500_), .O(new_n501_));
  aoi21  g344(.a(new_n499_), .b(new_n298_), .c(new_n501_), .O(new_n502_));
  nand3  g345(.a(x086), .b(new_n297_), .c(new_n323_), .O(new_n503_));
  oai21  g346(.a(new_n502_), .b(x054), .c(new_n503_), .O(new_n504_));
  nand3  g347(.a(new_n299_), .b(new_n305_), .c(x030), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(new_n306_), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n297_), .O(new_n507_));
  nand3  g350(.a(new_n321_), .b(new_n299_), .c(new_n305_), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n507_), .c(new_n316_), .O(new_n509_));
  nand2  g352(.a(new_n307_), .b(x030), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n306_), .c(new_n490_), .O(new_n511_));
  nand2  g354(.a(new_n301_), .b(new_n328_), .O(new_n512_));
  ...
  oai21  g358(.a(new_n515_), .b(new_n511_), .c(new_n305_), .O(new_n516_));
  nor2   g359(.a(new_n324_), .b(new_n318_), .O(new_n517_));
  oai21  g360(.a(new_n517_), .b(new_n321_), .c(x038), .O(new_n518_));
  aoi21  g361(.a(new_n518_), .b(new_n516_), .c(x086), .O(new_n519_));
  oai21  g362(.a(new_n519_), .b(new_n509_), .c(new_n298_), .O(new_n520_));
  nand3  g363(.a(new_n491_), .b(new_n299_), .c(new_n305_), .O(new_n521_));
  nand2  g364(.a(new_n521_), .b(new_n298_), .O(new_n522_));
  nand4  g365(.a(x070), .b(new_n305_), .c(x022), .d(new_n323_), .O(new_n523_));
  oai21  g366(.a(new_n305_), .b(new_n297_), .c(new_n523_), .O(new_n524_));
  aoi21  g367(.a(new_n522_), .b(x014), .c(new_n524_), .O(new_n525_));
  nand2  g368(.a(new_n525_), .b(new_n520_), .O(new_n526_));
  aoi21  g369(.a(new_n504_), .b(x006), .c(new_n526_), .O(new_n527_));
  oai21  g370(.a(new_n527_), .b(x046), .c(new_n159_), .O(z14));
  zero   g371(.O(z07));
  zero   g372(.O(z15));
  zero   g373(.O(z20));
  zero   g374(.O(z22));
  zero   g375(.O(z25));
  zero   g376(.O(z26));
  nor2   g377(.a(new_n157_), .b(x078), .O(z17));
  nor2   g378(.a(new_n157_), .b(x078), .O(z18));
  nor2   g379(.a(new_n157_), .b(x078), .O(z19));
  nor2   g380(.a(new_n157_), .b(x078), .O(z21));
  nor2   g381(.a(new_n157_), .b(x078), .O(z23));
  nor2   g382(.a(new_n157_), .b(x078), .O(z24));
  nor2   g383(.a(new_n157_), .b(x078), .O(z27));
endmodule
