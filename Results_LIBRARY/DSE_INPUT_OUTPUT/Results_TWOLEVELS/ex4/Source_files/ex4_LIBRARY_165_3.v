// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:36 2020
...
module FAU ( 
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x055), .O(new_n305_));
  ...
  oai21  g283(.a(new_n283_), .b(x029), .c(new_n439_), .O(new_n440_));
  inv1   g284(.a(x101), .O(new_n441_));
  nand2  g285(.a(new_n264_), .b(new_n441_), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n249_), .O(new_n443_));
  nor2   g287(.a(x117), .b(x109), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(new_n443_), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(new_n280_), .O(new_n446_));
  oai21  g290(.a(new_n264_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g292(.a(new_n441_), .b(x061), .c(new_n255_), .O(new_n449_));
  nand3  g293(.a(x125), .b(new_n256_), .c(new_n246_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n272_), .O(new_n451_));
  aoi21  g295(.a(new_n449_), .b(new_n260_), .c(new_n451_), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n440_), .O(new_n453_));
  nand4  g297(.a(x125), .b(new_n248_), .c(new_n260_), .d(x013), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n279_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(x085), .b(new_n260_), .c(new_n245_), .O(new_n457_));
  oai21  g301(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(x005), .O(new_n459_));
  oai21  g303(.a(new_n250_), .b(new_n244_), .c(new_n246_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n279_), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n245_), .c(new_n444_), .O(new_n462_));
  nor2   g306(.a(new_n244_), .b(x021), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n283_), .c(x069), .O(new_n464_));
  nand4  g308(.a(new_n442_), .b(new_n439_), .c(new_n251_), .d(x029), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n464_), .c(x077), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n462_), .c(new_n243_), .O(new_n467_));
  nand2  g311(.a(new_n439_), .b(x029), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n275_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n279_), .c(x037), .O(new_n470_));
  ...
  nand3  g320(.a(new_n476_), .b(new_n160_), .c(new_n241_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  aoi21  g322(.a(new_n298_), .b(x014), .c(x055), .O(new_n479_));
  nand2  g323(.a(x022), .b(x014), .O(new_n480_));
  nand2  g324(.a(new_n328_), .b(new_n335_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n480_), .O(new_n482_));
  inv1   g326(.a(x102), .O(new_n483_));
  aoi21  g327(.a(new_n346_), .b(new_n483_), .c(x094), .O(new_n484_));
  nor2   g328(.a(x118), .b(x110), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n484_), .c(new_n331_), .O(new_n487_));
  oai21  g331(.a(new_n346_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x118), .O(new_n489_));
  oai21  g333(.a(new_n483_), .b(x062), .c(new_n315_), .O(new_n490_));
  nand3  g334(.a(x126), .b(new_n314_), .c(new_n332_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n321_), .O(new_n492_));
  aoi21  g336(.a(new_n490_), .b(new_n299_), .c(new_n492_), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n489_), .c(new_n487_), .d(new_n482_), .O(new_n494_));
  nand4  g338(.a(x126), .b(new_n318_), .c(new_n299_), .d(x014), .O(new_n495_));
  inv1   g339(.a(new_n495_), .O(new_n496_));
  aoi21  g340(.a(new_n494_), .b(new_n158_), .c(new_n496_), .O(new_n497_));
  nand3  g341(.a(x086), .b(new_n299_), .c(new_n340_), .O(new_n498_));
  oai21  g342(.a(new_n497_), .b(x054), .c(new_n498_), .O(new_n499_));
  aoi21  g343(.a(new_n301_), .b(x030), .c(x022), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(x078), .c(new_n340_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n486_), .O(new_n502_));
  nand2  g346(.a(x030), .b(new_n332_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n328_), .c(new_n331_), .O(new_n504_));
  nand2  g348(.a(new_n346_), .b(new_n483_), .O(new_n505_));
  nand4  g349(.a(new_n505_), .b(new_n480_), .c(new_n301_), .d(x030), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n504_), .c(new_n158_), .O(new_n508_));
  ...
  oai21  g357(.a(new_n513_), .b(new_n509_), .c(new_n321_), .O(new_n514_));
  ...
  oai22  g363(.a(new_n519_), .b(x046), .c(new_n479_), .d(new_n158_), .O(z14));
  zero   g364(.O(z16));
  zero   g365(.O(z18));
  zero   g366(.O(z19));
  zero   g367(.O(z20));
  ...
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z17));
