...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x066), .O(z07));
  ...
  oai21  g169(.a(x102), .b(new_n204_), .c(x126), .O(new_n326_));
  ...
  oai21  g195(.a(new_n351_), .b(new_n349_), .c(x066), .O(new_n352_));
  ...
  nand4  g304(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n461_));
  ...
  oai22  g331(.a(new_n328_), .b(x030), .c(new_n316_), .d(new_n324_), .O(new_n488_));
  aoi21  g332(.a(new_n172_), .b(new_n343_), .c(x094), .O(new_n489_));
  ...
  oai21  g336(.a(new_n172_), .b(x110), .c(x038), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(x118), .O(new_n494_));
  oai21  g338(.a(new_n343_), .b(x062), .c(new_n490_), .O(new_n495_));
  nand3  g339(.a(x126), .b(new_n353_), .c(new_n316_), .O(new_n496_));
  ...
  oai21  g359(.a(new_n316_), .b(new_n324_), .c(x030), .O(new_n516_));
  ...
  oai21  g369(.a(new_n525_), .b(x046), .c(new_n174_), .O(z14));
  zero   g370(.O(z15));
  zero   g371(.O(z17));
  zero   g372(.O(z18));
  zero   g373(.O(z21));
  zero   g374(.O(z25));
  nor2   g375(.a(new_n172_), .b(x066), .O(z16));
  nor2   g376(.a(new_n172_), .b(x066), .O(z19));
  nor2   g377(.a(new_n172_), .b(x066), .O(z20));
  nor2   g378(.a(new_n172_), .b(x066), .O(z22));
  nor2   g379(.a(new_n172_), .b(x066), .O(z23));
  nor2   g380(.a(new_n172_), .b(x066), .O(z24));
  nor2   g381(.a(new_n172_), .b(x066), .O(z26));
  nor2   g382(.a(new_n172_), .b(x066), .O(z27));
endmodule
