// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:43 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x126), .b(new_n157_), .O(z18));
  inv1   g002(.a(z18), .O(new_n159_));
  ...
  oai22  g200(.a(new_n357_), .b(x024), .c(new_n168_), .d(new_n162_), .O(new_n358_));
  ...
  oai21  g206(.a(new_n363_), .b(new_n361_), .c(new_n169_), .O(new_n364_));
  oai21  g207(.a(new_n360_), .b(x112), .c(x032), .O(new_n365_));
  nand2  g208(.a(new_n365_), .b(x104), .O(new_n366_));
  inv1   g209(.a(x112), .O(new_n367_));
  oai21  g210(.a(new_n359_), .b(x056), .c(new_n367_), .O(new_n368_));
  nand3  g211(.a(x120), .b(new_n157_), .c(new_n168_), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(new_n161_), .O(new_n370_));
  aoi21  g213(.a(new_n368_), .b(new_n163_), .c(new_n370_), .O(new_n371_));
  nand4  g214(.a(new_n371_), .b(new_n366_), .c(new_n364_), .d(new_n358_), .O(new_n372_));
  nand4  g215(.a(x120), .b(new_n355_), .c(new_n163_), .d(x008), .O(new_n373_));
  inv1   g216(.a(new_n373_), .O(new_n374_));
  aoi21  g217(.a(new_n372_), .b(new_n165_), .c(new_n374_), .O(new_n375_));
  nand3  g218(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n376_));
  oai21  g219(.a(new_n375_), .b(x048), .c(new_n376_), .O(new_n377_));
  nand3  g220(.a(new_n161_), .b(new_n164_), .c(x024), .O(new_n378_));
  nand2  g221(.a(new_n378_), .b(new_n168_), .O(new_n379_));
  nand2  g222(.a(new_n379_), .b(new_n163_), .O(new_n380_));
  nand3  g223(.a(new_n357_), .b(new_n161_), .c(new_n164_), .O(new_n381_));
  aoi21  g224(.a(new_n381_), .b(new_n380_), .c(new_n169_), .O(new_n382_));
  oai21  g225(.a(new_n356_), .b(new_n355_), .c(x024), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n168_), .c(new_n362_), .O(new_n384_));
  nand2  g227(.a(new_n360_), .b(new_n359_), .O(new_n385_));
  ...
  aoi21  g233(.a(x016), .b(x008), .c(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n357_), .c(x032), .O(new_n392_));
  aoi21  g235(.a(new_n392_), .b(new_n389_), .c(x080), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n382_), .c(new_n165_), .O(new_n394_));
  nand3  g237(.a(new_n363_), .b(new_n161_), .c(new_n164_), .O(new_n395_));
  nand2  g238(.a(new_n395_), .b(new_n165_), .O(new_n396_));
  nand4  g239(.a(x064), .b(new_n164_), .c(x016), .d(new_n162_), .O(new_n397_));
  oai21  g240(.a(new_n164_), .b(new_n163_), .c(new_n397_), .O(new_n398_));
  aoi21  g241(.a(new_n396_), .b(x008), .c(new_n398_), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(new_n394_), .O(new_n400_));
  aoi21  g243(.a(new_n377_), .b(x000), .c(new_n400_), .O(new_n401_));
  oai21  g244(.a(new_n401_), .b(x040), .c(new_n159_), .O(z08));
  ...
  oai21  g252(.a(new_n409_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g260(.a(new_n417_), .b(x042), .c(new_n159_), .O(z10));
  ...
  oai21  g268(.a(new_n425_), .b(x043), .c(new_n159_), .O(z11));
  ...
  oai21  g276(.a(new_n433_), .b(x044), .c(new_n159_), .O(z12));
  ...
  nand3  g318(.a(new_n475_), .b(new_n159_), .c(new_n435_), .O(new_n476_));
  inv1   g319(.a(new_n476_), .O(z13));
  oai22  g320(.a(new_n337_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n478_));
  inv1   g321(.a(x102), .O(new_n479_));
  aoi21  g322(.a(new_n317_), .b(new_n479_), .c(x094), .O(new_n480_));
  nand2  g323(.a(new_n308_), .b(new_n307_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n480_), .c(new_n334_), .O(new_n482_));
  oai21  g325(.a(new_n317_), .b(x110), .c(x038), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(x118), .O(new_n484_));
  oai21  g327(.a(new_n479_), .b(x062), .c(new_n307_), .O(new_n485_));
  ...
  aoi21  g337(.a(new_n303_), .b(x030), .c(x022), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(x078), .c(new_n300_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n481_), .O(new_n497_));
  nand2  g340(.a(x030), .b(new_n301_), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n329_), .c(new_n334_), .O(new_n499_));
  nand2  g342(.a(new_n317_), .b(new_n479_), .O(new_n500_));
  ...
  oai21  g346(.a(new_n503_), .b(new_n499_), .c(new_n333_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n497_), .c(x054), .O(new_n505_));
  oai21  g348(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n506_));
  ...
  oai21  g352(.a(new_n509_), .b(new_n505_), .c(new_n325_), .O(new_n510_));
  ...
  oai21  g358(.a(new_n515_), .b(x046), .c(new_n159_), .O(z14));
  zero   g359(.O(z07));
  zero   g360(.O(z15));
  zero   g361(.O(z16));
  zero   g362(.O(z17));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(x126), .b(new_n157_), .O(z27));
endmodule
