...
module FAU ( 
  ...
  nand3  g248(.a(new_n405_), .b(new_n158_), .c(new_n399_), .O(new_n406_));
  ...
  oai21  g257(.a(new_n414_), .b(x042), .c(new_n158_), .O(z10));
  ...
  nand3  g316(.a(new_n473_), .b(new_n158_), .c(new_n433_), .O(new_n474_));
  inv1   g317(.a(new_n474_), .O(z13));
  aoi21  g318(.a(x054), .b(x038), .c(x014), .O(new_n476_));
  nand3  g319(.a(x070), .b(new_n300_), .c(x022), .O(new_n477_));
  nand3  g320(.a(x086), .b(new_n311_), .c(x006), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n477_), .c(x078), .O(new_n479_));
  inv1   g322(.a(new_n479_), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(new_n476_), .c(x046), .O(z14));
  zero   g324(.O(z07));
  zero   g325(.O(z15));
  zero   g326(.O(z16));
  zero   g327(.O(z18));
  ...
  zero   g332(.O(z26));
  zero   g333(.O(z27));
  nor2   g334(.a(x078), .b(x046), .O(z21));
  nor2   g335(.a(x078), .b(x046), .O(z24));
  nor2   g336(.a(x078), .b(x046), .O(z25));
endmodule
