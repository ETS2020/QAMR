// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:04 2020
...
module FAU ( 
  ...
  oai22  g276(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n433_));
  inv1   g277(.a(x101), .O(new_n434_));
  aoi21  g278(.a(new_n259_), .b(new_n434_), .c(x093), .O(new_n435_));
  nand2  g279(.a(new_n250_), .b(new_n249_), .O(new_n436_));
  oai21  g280(.a(new_n436_), .b(new_n435_), .c(new_n276_), .O(new_n437_));
  oai21  g281(.a(new_n259_), .b(x109), .c(x037), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(x117), .O(new_n439_));
  oai21  g283(.a(new_n434_), .b(x061), .c(new_n249_), .O(new_n440_));
  nand3  g284(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n267_), .O(new_n442_));
  aoi21  g286(.a(new_n440_), .b(new_n254_), .c(new_n442_), .O(new_n443_));
  nand4  g287(.a(new_n443_), .b(new_n439_), .c(new_n437_), .d(new_n433_), .O(new_n444_));
  nand4  g288(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n445_));
  inv1   g289(.a(new_n445_), .O(new_n446_));
  aoi21  g290(.a(new_n444_), .b(new_n275_), .c(new_n446_), .O(new_n447_));
  nand3  g291(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n448_));
  oai21  g292(.a(new_n447_), .b(x053), .c(new_n448_), .O(new_n449_));
  aoi21  g293(.a(new_n245_), .b(x029), .c(x021), .O(new_n450_));
  oai21  g294(.a(new_n450_), .b(x077), .c(new_n242_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n436_), .O(new_n452_));
  nand2  g296(.a(x029), .b(new_n243_), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(new_n271_), .c(new_n276_), .O(new_n454_));
  nand2  g298(.a(new_n259_), .b(new_n434_), .O(new_n455_));
  aoi22  g299(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n456_));
  nand3  g300(.a(new_n456_), .b(new_n455_), .c(x029), .O(new_n457_));
  inv1   g301(.a(new_n457_), .O(new_n458_));
  oai21  g302(.a(new_n458_), .b(new_n454_), .c(new_n275_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n452_), .c(x053), .O(new_n460_));
  oai21  g304(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n271_), .O(new_n462_));
  nand3  g306(.a(new_n462_), .b(new_n275_), .c(x037), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n460_), .c(new_n267_), .O(new_n465_));
  ...
  nand3  g312(.a(new_n468_), .b(new_n467_), .c(new_n465_), .O(new_n469_));
  aoi21  g313(.a(new_n449_), .b(x005), .c(new_n469_), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(x045), .c(new_n173_), .O(z13));
  aoi21  g315(.a(x054), .b(x038), .c(x014), .O(new_n472_));
  nand3  g316(.a(x070), .b(new_n298_), .c(x022), .O(new_n473_));
  nand3  g317(.a(x086), .b(new_n312_), .c(x006), .O(new_n474_));
  nand3  g318(.a(new_n474_), .b(new_n473_), .c(new_n472_), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(x078), .c(new_n296_), .O(new_n476_));
  inv1   g320(.a(new_n476_), .O(z14));
  zero   g321(.O(z17));
  zero   g322(.O(z18));
  zero   g323(.O(z20));
  zero   g324(.O(z21));
  ...
  nor2   g331(.a(x078), .b(x046), .O(z19));
  nor2   g332(.a(x078), .b(x046), .O(z24));
  nor2   g333(.a(x078), .b(x046), .O(z25));
endmodule
