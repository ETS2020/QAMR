// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:34 2020
...
module FAU ( 
  ...
  nand3  g159(.a(new_n315_), .b(x054), .c(new_n306_), .O(new_n316_));
  nand3  g160(.a(new_n299_), .b(x038), .c(new_n300_), .O(new_n317_));
  nand3  g161(.a(new_n317_), .b(new_n316_), .c(x014), .O(new_n318_));
  nand3  g162(.a(new_n318_), .b(new_n298_), .c(x007), .O(new_n319_));
  inv1   g163(.a(new_n319_), .O(new_n320_));
  inv1   g164(.a(x110), .O(new_n321_));
  inv1   g165(.a(x118), .O(new_n322_));
  aoi21  g166(.a(new_n315_), .b(new_n297_), .c(x006), .O(new_n323_));
  ...
  nor2   g172(.a(new_n306_), .b(new_n328_), .O(new_n329_));
  aoi21  g173(.a(new_n329_), .b(new_n327_), .c(new_n299_), .O(new_n330_));
  oai22  g174(.a(new_n330_), .b(new_n323_), .c(new_n322_), .d(new_n321_), .O(new_n331_));
  nand3  g175(.a(x086), .b(new_n315_), .c(new_n324_), .O(new_n332_));
  inv1   g176(.a(x102), .O(new_n333_));
  nand3  g177(.a(new_n333_), .b(x062), .c(new_n300_), .O(new_n334_));
  nand2  g178(.a(new_n334_), .b(new_n332_), .O(new_n335_));
  nand2  g179(.a(new_n335_), .b(x038), .O(new_n336_));
  nand2  g180(.a(new_n306_), .b(new_n328_), .O(new_n337_));
  nand4  g181(.a(new_n337_), .b(new_n326_), .c(x086), .d(new_n324_), .O(new_n338_));
  nand3  g182(.a(x094), .b(x070), .c(new_n300_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n338_), .O(new_n340_));
  oai21  g184(.a(new_n301_), .b(new_n333_), .c(new_n340_), .O(new_n341_));
  oai21  g185(.a(new_n307_), .b(new_n324_), .c(new_n337_), .O(new_n342_));
  inv1   g186(.a(x062), .O(new_n343_));
  oai22  g187(.a(new_n322_), .b(new_n306_), .c(x094), .d(new_n343_), .O(new_n344_));
  nand2  g188(.a(new_n344_), .b(new_n301_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n342_), .c(x086), .O(new_n346_));
  nor2   g190(.a(new_n308_), .b(new_n299_), .O(new_n347_));
  aoi22  g191(.a(new_n347_), .b(new_n315_), .c(new_n346_), .d(new_n300_), .O(new_n348_));
  nand4  g192(.a(new_n348_), .b(new_n341_), .c(new_n336_), .d(new_n331_), .O(new_n349_));
  nand2  g193(.a(new_n349_), .b(x054), .O(new_n350_));
  oai22  g194(.a(x086), .b(x006), .c(x070), .d(x022), .O(new_n351_));
  nor2   g195(.a(x070), .b(new_n297_), .O(new_n352_));
  aoi22  g196(.a(new_n352_), .b(new_n306_), .c(new_n351_), .d(x014), .O(new_n353_));
  nand2  g197(.a(new_n353_), .b(new_n350_), .O(new_n354_));
  aoi21  g198(.a(new_n354_), .b(x078), .c(new_n320_), .O(new_n355_));
  ...
  nand2  g212(.a(new_n369_), .b(new_n168_), .O(new_n370_));
  ...
  nand3  g218(.a(x120), .b(new_n375_), .c(new_n167_), .O(new_n376_));
  nand2  g219(.a(new_n376_), .b(new_n160_), .O(new_n377_));
  aoi21  g220(.a(new_n374_), .b(new_n162_), .c(new_n377_), .O(new_n378_));
  nand4  g221(.a(new_n378_), .b(new_n372_), .c(new_n370_), .d(new_n363_), .O(new_n379_));
  nand4  g222(.a(x120), .b(new_n360_), .c(new_n162_), .d(x008), .O(new_n380_));
  inv1   g223(.a(new_n380_), .O(new_n381_));
  aoi21  g224(.a(new_n379_), .b(new_n164_), .c(new_n381_), .O(new_n382_));
  nand3  g225(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n383_));
  ...
  nand2  g230(.a(new_n387_), .b(new_n167_), .O(new_n388_));
  nand2  g231(.a(new_n388_), .b(new_n164_), .O(new_n389_));
  aoi21  g232(.a(new_n389_), .b(new_n161_), .c(new_n368_), .O(new_n390_));
  ...
  oai21  g238(.a(new_n395_), .b(new_n390_), .c(new_n163_), .O(new_n396_));
  nand2  g239(.a(new_n359_), .b(x024), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(new_n361_), .c(new_n360_), .O(new_n398_));
  nand3  g241(.a(new_n398_), .b(new_n164_), .c(x032), .O(new_n399_));
  ...
  nand3  g248(.a(new_n405_), .b(new_n158_), .c(new_n358_), .O(new_n406_));
  ...
  nand3  g257(.a(new_n414_), .b(new_n158_), .c(new_n408_), .O(new_n415_));
  ...
  nand3  g266(.a(new_n423_), .b(new_n158_), .c(new_n417_), .O(new_n424_));
  ...
  oai21  g275(.a(new_n432_), .b(x043), .c(new_n158_), .O(z11));
  ...
  nand3  g283(.a(new_n440_), .b(new_n158_), .c(new_n434_), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(z12));
  inv1   g285(.a(x045), .O(new_n443_));
  nand2  g286(.a(x021), .b(x013), .O(new_n444_));
  oai21  g287(.a(new_n281_), .b(x029), .c(new_n444_), .O(new_n445_));
  inv1   g288(.a(x101), .O(new_n446_));
  nand2  g289(.a(new_n261_), .b(new_n446_), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n246_), .O(new_n448_));
  nor2   g291(.a(x117), .b(x109), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n278_), .O(new_n451_));
  oai21  g294(.a(new_n261_), .b(x109), .c(x037), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(x117), .O(new_n453_));
  oai21  g296(.a(new_n446_), .b(x061), .c(new_n252_), .O(new_n454_));
  nand3  g297(.a(x125), .b(new_n253_), .c(new_n243_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n269_), .O(new_n456_));
  aoi21  g299(.a(new_n454_), .b(new_n257_), .c(new_n456_), .O(new_n457_));
  nand4  g300(.a(new_n457_), .b(new_n453_), .c(new_n451_), .d(new_n445_), .O(new_n458_));
  nand4  g301(.a(x125), .b(new_n245_), .c(new_n257_), .d(x013), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(new_n460_));
  aoi21  g303(.a(new_n458_), .b(new_n277_), .c(new_n460_), .O(new_n461_));
  nand3  g304(.a(x085), .b(new_n257_), .c(new_n242_), .O(new_n462_));
  oai21  g305(.a(new_n461_), .b(x053), .c(new_n462_), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(x005), .O(new_n464_));
  oai21  g307(.a(new_n247_), .b(new_n241_), .c(new_n243_), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n277_), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n242_), .c(new_n449_), .O(new_n467_));
  nor2   g310(.a(new_n241_), .b(x021), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(new_n281_), .c(x069), .O(new_n469_));
  nand4  g312(.a(new_n447_), .b(new_n444_), .c(new_n248_), .d(x029), .O(new_n470_));
  aoi21  g313(.a(new_n470_), .b(new_n469_), .c(x077), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n240_), .O(new_n472_));
  nand2  g315(.a(new_n444_), .b(x029), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n273_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n277_), .c(x037), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n472_), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n269_), .O(new_n477_));
  ...
  nand4  g323(.a(new_n480_), .b(new_n479_), .c(new_n477_), .d(new_n464_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n158_), .c(new_n443_), .O(new_n482_));
  inv1   g325(.a(new_n482_), .O(z13));
  oai21  g326(.a(new_n329_), .b(new_n324_), .c(new_n325_), .O(new_n484_));
  nand3  g327(.a(new_n484_), .b(new_n299_), .c(new_n298_), .O(new_n485_));
  aoi21  g328(.a(new_n485_), .b(new_n305_), .c(new_n312_), .O(new_n486_));
  nor2   g329(.a(new_n298_), .b(new_n305_), .O(new_n487_));
  oai21  g330(.a(new_n487_), .b(new_n486_), .c(x038), .O(new_n488_));
  aoi21  g331(.a(new_n325_), .b(new_n324_), .c(new_n329_), .O(new_n489_));
  ...
  nand2  g335(.a(new_n492_), .b(new_n315_), .O(new_n493_));
  oai21  g336(.a(new_n301_), .b(x110), .c(x038), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(x118), .O(new_n495_));
  oai21  g338(.a(new_n333_), .b(x062), .c(new_n321_), .O(new_n496_));
  nand2  g339(.a(new_n496_), .b(new_n297_), .O(new_n497_));
  nor2   g340(.a(new_n301_), .b(x118), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n306_), .c(x086), .O(new_n499_));
  nand4  g342(.a(new_n499_), .b(new_n497_), .c(new_n495_), .d(new_n493_), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(new_n489_), .c(new_n305_), .O(new_n501_));
  nand2  g344(.a(x086), .b(new_n328_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n501_), .c(new_n300_), .O(new_n503_));
  aoi21  g346(.a(new_n307_), .b(x030), .c(x022), .O(new_n504_));
  or2    g347(.a(new_n504_), .b(new_n491_), .O(new_n505_));
  nor2   g348(.a(new_n324_), .b(x022), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(new_n326_), .c(x070), .O(new_n507_));
  inv1   g350(.a(new_n490_), .O(new_n508_));
  nor2   g351(.a(new_n329_), .b(new_n308_), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n508_), .c(x030), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n507_), .c(new_n505_), .O(new_n511_));
  nand3  g354(.a(new_n511_), .b(new_n299_), .c(new_n305_), .O(new_n512_));
  ...
  oai21  g358(.a(new_n515_), .b(new_n503_), .c(new_n298_), .O(new_n516_));
  nand4  g359(.a(x126), .b(new_n343_), .c(new_n297_), .d(x006), .O(new_n517_));
  oai21  g360(.a(new_n491_), .b(x086), .c(new_n517_), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(new_n305_), .c(x014), .O(new_n519_));
  nand2  g362(.a(new_n519_), .b(new_n516_), .O(new_n520_));
  nand3  g363(.a(x070), .b(new_n305_), .c(x022), .O(new_n521_));
  nand3  g364(.a(x086), .b(new_n297_), .c(x006), .O(new_n522_));
  nand3  g365(.a(new_n522_), .b(new_n521_), .c(new_n328_), .O(new_n523_));
  and2   g366(.a(new_n523_), .b(x078), .O(new_n524_));
  aoi21  g367(.a(new_n520_), .b(x007), .c(new_n524_), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n488_), .c(x046), .O(z14));
  zero   g369(.O(z07));
  zero   g370(.O(z17));
  zero   g371(.O(z18));
  zero   g372(.O(z19));
  ...
  zero   g377(.O(z26));
  zero   g378(.O(z27));
  nor2   g379(.a(x078), .b(x007), .O(z16));
  nor2   g380(.a(x078), .b(x007), .O(z22));
  nor2   g381(.a(x078), .b(x007), .O(z24));
endmodule
