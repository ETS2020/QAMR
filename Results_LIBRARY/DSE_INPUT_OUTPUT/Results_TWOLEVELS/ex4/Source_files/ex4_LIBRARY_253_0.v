...
module FAU ( 
  ...
  oai21  g273(.a(new_n429_), .b(x042), .c(new_n158_), .O(z10));
  ...
  oai22  g332(.a(new_n353_), .b(x030), .c(new_n319_), .d(new_n364_), .O(new_n489_));
  aoi21  g333(.a(new_n262_), .b(new_n328_), .c(x094), .O(new_n490_));
  ...
  oai21  g337(.a(new_n262_), .b(x110), .c(x038), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(x118), .O(new_n495_));
  oai21  g339(.a(new_n328_), .b(x062), .c(new_n491_), .O(new_n496_));
  ...
  oai21  g360(.a(new_n319_), .b(new_n364_), .c(x030), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n331_), .O(new_n518_));
  ...
  zero   g374(.O(z23));
  zero   g375(.O(z25));
  nor2   g376(.a(x126), .b(x117), .O(z15));
  nor2   g377(.a(x126), .b(x117), .O(z17));
  nor2   g378(.a(x126), .b(x117), .O(z19));
  nor2   g379(.a(x126), .b(x117), .O(z21));
  nor2   g380(.a(x126), .b(x117), .O(z22));
  nor2   g381(.a(x126), .b(x117), .O(z24));
