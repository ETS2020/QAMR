...
module FAU ( 
  ...
  nand2  g330(.a(new_n312_), .b(new_n311_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n486_), .c(new_n337_), .O(new_n488_));
  oai21  g332(.a(new_n321_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g334(.a(new_n485_), .b(x062), .c(new_n311_), .O(new_n491_));
  nand3  g335(.a(x126), .b(new_n312_), .c(new_n305_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n329_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n316_), .c(new_n493_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n490_), .c(new_n488_), .d(new_n484_), .O(new_n495_));
  nand4  g339(.a(x126), .b(new_n319_), .c(new_n316_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n297_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n316_), .c(new_n304_), .O(new_n499_));
  oai21  g343(.a(new_n498_), .b(x054), .c(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n307_), .b(x030), .c(x022), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(x078), .c(new_n304_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n487_), .O(new_n503_));
  nand2  g347(.a(x030), .b(new_n305_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n333_), .c(new_n337_), .O(new_n505_));
  nand2  g349(.a(new_n321_), .b(new_n485_), .O(new_n506_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n505_), .c(new_n297_), .O(new_n510_));
  aoi21  g354(.a(new_n510_), .b(new_n503_), .c(x054), .O(new_n511_));
  oai21  g355(.a(new_n305_), .b(new_n304_), .c(x030), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n333_), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n297_), .c(x038), .O(new_n514_));
  inv1   g358(.a(new_n514_), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n511_), .c(new_n329_), .O(new_n516_));
  ...
  zero   g369(.O(z24));
  zero   g370(.O(z26));
  nor2   g371(.a(new_n172_), .b(x078), .O(z17));
  nor2   g372(.a(new_n172_), .b(x078), .O(z18));
  nor2   g373(.a(new_n172_), .b(x078), .O(z19));
  nor2   g374(.a(new_n172_), .b(x078), .O(z20));
  nor2   g375(.a(new_n172_), .b(x078), .O(z22));
  nor2   g376(.a(new_n172_), .b(x078), .O(z23));
  nor2   g377(.a(new_n172_), .b(x078), .O(z25));
  nor2   g378(.a(new_n172_), .b(x078), .O(z27));
endmodule
