...
module FAU ( 
  ...
  nand3  g227(.a(new_n384_), .b(new_n157_), .c(new_n378_), .O(new_n385_));
  ...
  oai21  g236(.a(new_n393_), .b(x044), .c(new_n157_), .O(z12));
  oai22  g237(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n395_));
  inv1   g238(.a(x101), .O(new_n396_));
  aoi21  g239(.a(new_n258_), .b(new_n396_), .c(x093), .O(new_n397_));
  nand2  g240(.a(new_n249_), .b(new_n248_), .O(new_n398_));
  oai21  g241(.a(new_n398_), .b(new_n397_), .c(new_n275_), .O(new_n399_));
  oai21  g242(.a(new_n258_), .b(x109), .c(x037), .O(new_n400_));
  nand2  g243(.a(new_n400_), .b(x117), .O(new_n401_));
  oai21  g244(.a(new_n396_), .b(x061), .c(new_n248_), .O(new_n402_));
  nand3  g245(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n403_));
  nand2  g246(.a(new_n403_), .b(new_n266_), .O(new_n404_));
  aoi21  g247(.a(new_n402_), .b(new_n253_), .c(new_n404_), .O(new_n405_));
  nand4  g248(.a(new_n405_), .b(new_n401_), .c(new_n399_), .d(new_n395_), .O(new_n406_));
  nand4  g249(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n407_));
  inv1   g250(.a(new_n407_), .O(new_n408_));
  aoi21  g251(.a(new_n406_), .b(new_n274_), .c(new_n408_), .O(new_n409_));
  nand3  g252(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n410_));
  oai21  g253(.a(new_n409_), .b(x053), .c(new_n410_), .O(new_n411_));
  aoi21  g254(.a(new_n244_), .b(x029), .c(x021), .O(new_n412_));
  oai21  g255(.a(new_n412_), .b(x077), .c(new_n241_), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n398_), .O(new_n414_));
  nand2  g257(.a(x029), .b(new_n242_), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n270_), .c(new_n275_), .O(new_n416_));
  nand2  g259(.a(new_n258_), .b(new_n396_), .O(new_n417_));
  aoi22  g260(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(new_n417_), .c(x029), .O(new_n419_));
  inv1   g262(.a(new_n419_), .O(new_n420_));
  oai21  g263(.a(new_n420_), .b(new_n416_), .c(new_n274_), .O(new_n421_));
  aoi21  g264(.a(new_n421_), .b(new_n414_), .c(x053), .O(new_n422_));
  oai21  g265(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n270_), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(new_n274_), .c(x037), .O(new_n425_));
  inv1   g268(.a(new_n425_), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(new_n422_), .c(new_n266_), .O(new_n427_));
  ...
  aoi21  g274(.a(new_n411_), .b(x005), .c(new_n431_), .O(new_n432_));
  oai21  g275(.a(new_n432_), .b(x045), .c(new_n157_), .O(z13));
  oai21  g276(.a(x046), .b(x014), .c(x078), .O(new_n434_));
  inv1   g277(.a(x014), .O(new_n435_));
  inv1   g278(.a(x030), .O(new_n436_));
  nor2   g279(.a(x094), .b(x062), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n436_), .O(new_n438_));
  oai21  g281(.a(new_n299_), .b(new_n435_), .c(new_n438_), .O(new_n439_));
  ...
  oai21  g288(.a(new_n445_), .b(new_n442_), .c(new_n300_), .O(new_n446_));
  ...
  nand3  g292(.a(x126), .b(new_n444_), .c(new_n299_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n303_), .O(new_n451_));
  aoi21  g294(.a(new_n449_), .b(new_n296_), .c(new_n451_), .O(new_n452_));
  nand4  g295(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n439_), .O(new_n453_));
  nor2   g296(.a(x038), .b(new_n435_), .O(new_n454_));
  nor2   g297(.a(new_n441_), .b(x062), .O(new_n455_));
  aoi22  g298(.a(new_n455_), .b(new_n454_), .c(new_n453_), .d(new_n295_), .O(new_n456_));
  nand3  g299(.a(x086), .b(new_n296_), .c(new_n435_), .O(new_n457_));
  ...
  oai21  g303(.a(new_n460_), .b(x078), .c(new_n435_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n445_), .O(new_n462_));
  nand2  g305(.a(new_n296_), .b(x030), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n437_), .c(new_n300_), .O(new_n464_));
  ...
  oai21  g311(.a(new_n468_), .b(new_n464_), .c(new_n295_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n462_), .c(x054), .O(new_n470_));
  oai21  g313(.a(new_n299_), .b(new_n435_), .c(x030), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n437_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n295_), .c(x038), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n470_), .c(new_n303_), .O(new_n475_));
  ...
  oai21  g323(.a(new_n480_), .b(x046), .c(new_n434_), .O(z14));
  inv1   g324(.a(new_n157_), .O(z15));
  zero   g325(.O(z07));
  zero   g326(.O(z18));
  zero   g327(.O(z20));
  zero   g328(.O(z22));
  zero   g329(.O(z24));
  zero   g330(.O(z27));
  inv1   g331(.a(new_n157_), .O(z16));
  inv1   g332(.a(new_n157_), .O(z17));
  inv1   g333(.a(new_n157_), .O(z19));
  inv1   g334(.a(new_n157_), .O(z21));
  inv1   g335(.a(new_n157_), .O(z23));
  inv1   g336(.a(new_n157_), .O(z25));
