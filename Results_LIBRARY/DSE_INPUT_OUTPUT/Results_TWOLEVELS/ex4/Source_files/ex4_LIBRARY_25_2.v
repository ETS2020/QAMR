...
module FAU ( 
  ...
  oai21  g314(.a(new_n470_), .b(x045), .c(new_n159_), .O(z13));
  ...
  nand4  g325(.a(x086), .b(new_n157_), .c(new_n300_), .d(new_n319_), .O(new_n482_));
  ...
  nand2  g345(.a(new_n501_), .b(new_n157_), .O(new_n502_));
  ...
  zero   g352(.O(z23));
  zero   g353(.O(z25));
  nor2   g354(.a(x078), .b(new_n157_), .O(z15));
  ...
  nor2   g359(.a(x078), .b(new_n157_), .O(z27));
endmodule
