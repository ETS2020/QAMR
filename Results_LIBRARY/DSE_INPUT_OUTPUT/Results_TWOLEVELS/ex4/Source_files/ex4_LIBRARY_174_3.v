...
module FAU ( 
  ...
  nand2  g069(.a(x036), .b(x012), .O(new_n226_));
  nand2  g070(.a(x076), .b(x052), .O(new_n227_));
  aoi21  g071(.a(new_n227_), .b(new_n226_), .c(x084), .O(new_n228_));
  nand2  g072(.a(new_n228_), .b(new_n225_), .O(new_n229_));
  inv1   g073(.a(x020), .O(new_n230_));
  nand2  g074(.a(x052), .b(x012), .O(new_n231_));
  nand2  g075(.a(x076), .b(x036), .O(new_n232_));
  aoi21  g076(.a(new_n232_), .b(new_n231_), .c(x068), .O(new_n233_));
  inv1   g077(.a(x012), .O(new_n234_));
  inv1   g078(.a(x076), .O(new_n235_));
  aoi21  g079(.a(new_n235_), .b(new_n234_), .c(x078), .O(new_n236_));
  oai21  g080(.a(x052), .b(x036), .c(new_n236_), .O(new_n237_));
  aoi21  g081(.a(new_n233_), .b(new_n230_), .c(new_n237_), .O(new_n238_));
  aoi21  g082(.a(new_n238_), .b(new_n229_), .c(new_n172_), .O(z04));
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x044), .O(new_n304_));
  ...
  nand2  g281(.a(new_n437_), .b(new_n175_), .O(z12));
  ...
  aoi21  g323(.a(new_n297_), .b(x014), .c(x044), .O(new_n480_));
  ...
  zero   g368(.O(z23));
  zero   g369(.O(z24));
  nor2   g370(.a(new_n173_), .b(new_n172_), .O(z15));
