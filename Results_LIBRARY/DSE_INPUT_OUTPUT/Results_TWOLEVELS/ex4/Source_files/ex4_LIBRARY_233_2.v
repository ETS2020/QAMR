// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:13 2020
...
module FAU ( 
  ...
  nor2   g016(.a(x078), .b(new_n172_), .O(z17));
  ...
  oai21  g274(.a(new_n431_), .b(x044), .c(new_n174_), .O(z12));
  ...
  zero   g353(.O(z25));
  zero   g354(.O(z27));
  nor2   g355(.a(x078), .b(new_n172_), .O(z18));
  nor2   g356(.a(x078), .b(new_n172_), .O(z21));
  nor2   g357(.a(x078), .b(new_n172_), .O(z23));
