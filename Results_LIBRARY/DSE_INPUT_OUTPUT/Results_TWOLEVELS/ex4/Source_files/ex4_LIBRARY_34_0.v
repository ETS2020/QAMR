...
module FAU ( 
  ...
  nand3  g320(.a(x070), .b(new_n300_), .c(x022), .O(new_n477_));
  nand3  g321(.a(x086), .b(new_n311_), .c(x006), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n477_), .c(x078), .O(new_n479_));
  inv1   g323(.a(new_n479_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n476_), .c(x046), .O(z14));
  zero   g325(.O(z15));
  zero   g326(.O(z17));
  zero   g327(.O(z19));
  zero   g328(.O(z20));
  ...
  zero   g331(.O(z25));
  zero   g332(.O(z26));
  nor2   g333(.a(x078), .b(x046), .O(z16));
  nor2   g334(.a(x078), .b(x046), .O(z18));
  nor2   g335(.a(x078), .b(x046), .O(z22));
  nor2   g336(.a(x078), .b(x046), .O(z23));
