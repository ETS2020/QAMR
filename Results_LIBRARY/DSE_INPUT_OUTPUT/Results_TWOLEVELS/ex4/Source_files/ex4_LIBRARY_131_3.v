// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:25 2020
...
module FAU ( 
  ...
  nand2  g157(.a(new_n304_), .b(new_n301_), .O(new_n314_));
  nand3  g158(.a(new_n314_), .b(new_n313_), .c(new_n306_), .O(new_n315_));
  nand2  g159(.a(new_n315_), .b(new_n175_), .O(new_n316_));
  inv1   g160(.a(x102), .O(new_n317_));
  nand3  g161(.a(new_n317_), .b(x062), .c(new_n172_), .O(new_n318_));
  oai21  g162(.a(x126), .b(x118), .c(new_n318_), .O(new_n319_));
  nand2  g163(.a(new_n319_), .b(x038), .O(new_n320_));
  oai21  g164(.a(x102), .b(x022), .c(x126), .O(new_n321_));
  nand3  g165(.a(new_n321_), .b(x094), .c(x070), .O(new_n322_));
  inv1   g166(.a(x110), .O(new_n323_));
  nand2  g167(.a(x118), .b(x022), .O(new_n324_));
  oai21  g168(.a(x118), .b(new_n323_), .c(new_n324_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n173_), .O(new_n326_));
  nand2  g170(.a(new_n309_), .b(x030), .O(new_n327_));
  nand3  g171(.a(new_n327_), .b(new_n172_), .c(x014), .O(new_n328_));
  nand4  g172(.a(new_n328_), .b(new_n326_), .c(new_n322_), .d(new_n320_), .O(new_n329_));
  inv1   g173(.a(x030), .O(new_n330_));
  nand2  g174(.a(new_n308_), .b(new_n307_), .O(new_n331_));
  nand2  g175(.a(new_n321_), .b(x014), .O(new_n332_));
  oai21  g176(.a(x126), .b(new_n172_), .c(new_n332_), .O(new_n333_));
  nand3  g177(.a(new_n333_), .b(new_n331_), .c(new_n330_), .O(new_n334_));
  nand2  g178(.a(x118), .b(x110), .O(new_n335_));
  nand2  g179(.a(new_n335_), .b(new_n172_), .O(new_n336_));
  inv1   g180(.a(x070), .O(new_n337_));
  nand3  g181(.a(new_n310_), .b(new_n173_), .c(new_n337_), .O(new_n338_));
  nand3  g182(.a(new_n338_), .b(new_n336_), .c(new_n334_), .O(new_n339_));
  aoi22  g183(.a(new_n339_), .b(x086), .c(new_n329_), .d(new_n299_), .O(new_n340_));
  nand2  g184(.a(new_n335_), .b(x086), .O(new_n341_));
  nand3  g185(.a(x062), .b(x038), .c(new_n299_), .O(new_n342_));
  aoi21  g186(.a(new_n342_), .b(new_n341_), .c(x126), .O(new_n343_));
  nand3  g187(.a(new_n337_), .b(new_n172_), .c(x014), .O(new_n344_));
  inv1   g188(.a(new_n344_), .O(new_n345_));
  aoi21  g189(.a(new_n343_), .b(new_n301_), .c(new_n345_), .O(new_n346_));
  oai21  g190(.a(new_n340_), .b(new_n304_), .c(new_n346_), .O(new_n347_));
  nand4  g191(.a(x086), .b(new_n302_), .c(new_n330_), .d(x014), .O(new_n348_));
  oai21  g192(.a(x070), .b(new_n302_), .c(new_n348_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(x078), .c(new_n172_), .O(new_n350_));
  inv1   g194(.a(new_n350_), .O(new_n351_));
  aoi21  g195(.a(new_n347_), .b(x054), .c(new_n351_), .O(new_n352_));
  aoi21  g196(.a(new_n352_), .b(new_n316_), .c(new_n298_), .O(z06));
  ...
  nand4  g228(.a(new_n379_), .b(new_n385_), .c(new_n355_), .d(x024), .O(new_n386_));
  inv1   g229(.a(new_n386_), .O(new_n387_));
  oai21  g230(.a(new_n387_), .b(new_n384_), .c(new_n162_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n382_), .c(x048), .O(new_n389_));
  nand2  g232(.a(new_n355_), .b(x024), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n357_), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n162_), .c(x032), .O(new_n392_));
  inv1   g235(.a(new_n392_), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n389_), .c(new_n158_), .O(new_n394_));
  ...
  oai21  g251(.a(new_n408_), .b(x041), .c(new_n175_), .O(z09));
  ...
  oai21  g259(.a(new_n416_), .b(x042), .c(new_n175_), .O(z10));
  ...
  oai21  g267(.a(new_n424_), .b(x043), .c(new_n175_), .O(z11));
  ...
  oai21  g275(.a(new_n432_), .b(x044), .c(new_n175_), .O(z12));
  inv1   g276(.a(x045), .O(new_n434_));
  nand2  g277(.a(x021), .b(x013), .O(new_n435_));
  oai21  g278(.a(new_n281_), .b(x029), .c(new_n435_), .O(new_n436_));
  ...
  aoi21  g293(.a(new_n448_), .b(new_n277_), .c(new_n450_), .O(new_n451_));
  ...
  nand2  g297(.a(new_n247_), .b(x029), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n245_), .O(new_n456_));
  nand2  g299(.a(new_n456_), .b(new_n277_), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(new_n244_), .c(new_n438_), .O(new_n458_));
  nor2   g301(.a(new_n243_), .b(x021), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(new_n281_), .c(x069), .O(new_n460_));
  inv1   g303(.a(new_n437_), .O(new_n461_));
  nand4  g304(.a(new_n461_), .b(new_n435_), .c(new_n247_), .d(x029), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n460_), .c(x077), .O(new_n463_));
  oai21  g306(.a(new_n463_), .b(new_n458_), .c(new_n242_), .O(new_n464_));
  nand2  g307(.a(new_n435_), .b(x029), .O(new_n465_));
  nand2  g308(.a(new_n465_), .b(new_n273_), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n277_), .c(x037), .O(new_n467_));
  ...
  aoi21  g315(.a(new_n468_), .b(new_n269_), .c(new_n472_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n454_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n175_), .c(new_n434_), .O(new_n475_));
  inv1   g318(.a(new_n475_), .O(z13));
  oai22  g319(.a(x078), .b(x054), .c(x038), .d(x014), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(x086), .c(x006), .O(new_n478_));
  nand3  g321(.a(new_n331_), .b(new_n300_), .c(new_n304_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n303_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(x038), .O(new_n481_));
  nand2  g324(.a(x078), .b(x014), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n481_), .c(new_n478_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n175_), .O(new_n484_));
  nor2   g327(.a(x118), .b(x110), .O(new_n485_));
  oai21  g328(.a(new_n309_), .b(new_n330_), .c(new_n172_), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n173_), .c(new_n304_), .O(new_n487_));
  nand2  g330(.a(new_n172_), .b(x014), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n487_), .c(new_n485_), .O(new_n489_));
  oai21  g332(.a(x126), .b(x102), .c(new_n172_), .O(new_n490_));
  nand3  g333(.a(new_n173_), .b(x102), .c(new_n301_), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n490_), .c(new_n309_), .O(new_n492_));
  nor2   g335(.a(new_n337_), .b(x022), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(new_n492_), .c(x030), .O(new_n494_));
  nand3  g337(.a(new_n331_), .b(x070), .c(new_n172_), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n494_), .c(x078), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(new_n489_), .c(new_n300_), .O(new_n497_));
  oai21  g340(.a(x126), .b(x014), .c(x022), .O(new_n498_));
  oai21  g341(.a(new_n331_), .b(x030), .c(new_n498_), .O(new_n499_));
  nand2  g342(.a(x102), .b(new_n307_), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(new_n323_), .c(x038), .O(new_n501_));
  nand2  g344(.a(x102), .b(new_n308_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n323_), .c(x070), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n501_), .c(new_n173_), .O(new_n504_));
  oai21  g347(.a(new_n337_), .b(new_n302_), .c(x118), .O(new_n505_));
  nand2  g348(.a(new_n335_), .b(x126), .O(new_n506_));
  nand2  g349(.a(new_n506_), .b(new_n505_), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n172_), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(new_n504_), .c(new_n499_), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n304_), .c(x006), .O(new_n510_));
  nand4  g353(.a(new_n173_), .b(x070), .c(x022), .d(new_n301_), .O(new_n511_));
  nand3  g354(.a(new_n511_), .b(new_n510_), .c(new_n497_), .O(new_n512_));
  nand4  g355(.a(new_n498_), .b(new_n300_), .c(x038), .d(x030), .O(new_n513_));
  nand4  g356(.a(new_n173_), .b(x070), .c(new_n302_), .d(x022), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(new_n513_), .c(x078), .O(new_n515_));
  aoi21  g358(.a(new_n512_), .b(new_n303_), .c(new_n515_), .O(new_n516_));
  aoi21  g359(.a(new_n516_), .b(new_n484_), .c(x046), .O(z14));
  zero   g360(.O(z07));
  zero   g361(.O(z16));
  zero   g362(.O(z17));
  zero   g363(.O(z18));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g369(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g370(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g371(.a(new_n173_), .b(new_n172_), .O(z23));
