...
module FAU ( 
  ...
  zero   g372(.O(z26));
  zero   g373(.O(z27));
  nor2   g374(.a(new_n172_), .b(x117), .O(z16));
  nor2   g375(.a(new_n172_), .b(x117), .O(z17));
  nor2   g376(.a(new_n172_), .b(x117), .O(z18));
  nor2   g377(.a(new_n172_), .b(x117), .O(z20));
  nor2   g378(.a(new_n172_), .b(x117), .O(z22));
  nor2   g379(.a(new_n172_), .b(x117), .O(z24));
  nor2   g380(.a(new_n172_), .b(x117), .O(z25));
endmodule
