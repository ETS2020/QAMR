...
module FAU ( 
  ...
  nor2   g156(.a(x055), .b(x054), .O(new_n313_));
  ...
  nand3  g323(.a(new_n479_), .b(new_n159_), .c(new_n439_), .O(new_n480_));
  inv1   g324(.a(new_n480_), .O(z13));
  oai22  g325(.a(new_n322_), .b(x030), .c(new_n307_), .d(new_n324_), .O(new_n482_));
  aoi21  g326(.a(new_n302_), .b(new_n329_), .c(x094), .O(new_n483_));
  nand2  g327(.a(new_n316_), .b(new_n315_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n483_), .c(new_n317_), .O(new_n485_));
  oai21  g329(.a(new_n302_), .b(x110), .c(x038), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(x118), .O(new_n487_));
  oai21  g331(.a(new_n329_), .b(x062), .c(new_n315_), .O(new_n488_));
  nand3  g332(.a(x126), .b(new_n316_), .c(new_n307_), .O(new_n489_));
  ...
  nand4  g336(.a(x126), .b(new_n320_), .c(new_n298_), .d(x014), .O(new_n493_));
  inv1   g337(.a(new_n493_), .O(new_n494_));
  aoi21  g338(.a(new_n492_), .b(new_n299_), .c(new_n494_), .O(new_n495_));
  nand3  g339(.a(x086), .b(new_n298_), .c(new_n324_), .O(new_n496_));
  oai21  g340(.a(new_n495_), .b(x054), .c(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n308_), .b(x030), .c(x022), .O(new_n498_));
  ...
  nand2  g345(.a(x030), .b(new_n307_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n501_), .c(new_n317_), .O(new_n503_));
  nand2  g347(.a(new_n302_), .b(new_n329_), .O(new_n504_));
  ...
  oai21  g351(.a(new_n507_), .b(new_n503_), .c(new_n299_), .O(new_n508_));
  ...
  oai21  g356(.a(new_n512_), .b(new_n509_), .c(new_n300_), .O(new_n513_));
  ...
  zero   g369(.O(z26));
  zero   g370(.O(z27));
  nor2   g371(.a(x078), .b(new_n157_), .O(z15));
