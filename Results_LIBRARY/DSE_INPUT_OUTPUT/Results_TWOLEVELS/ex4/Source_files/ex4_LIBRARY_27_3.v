// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:23 2020
...
module FAU ( 
  ...
  oai21  g218(.a(new_n374_), .b(x042), .c(new_n157_), .O(z10));
  oai22  g219(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n376_));
  nand3  g220(.a(new_n376_), .b(x083), .c(x003), .O(new_n377_));
  oai22  g221(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n378_));
  nand3  g222(.a(new_n378_), .b(x067), .c(x019), .O(new_n379_));
  aoi22  g223(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n380_));
  nand3  g224(.a(new_n380_), .b(new_n379_), .c(new_n377_), .O(new_n381_));
  inv1   g225(.a(new_n381_), .O(new_n382_));
  oai21  g226(.a(new_n382_), .b(x043), .c(new_n157_), .O(z11));
  oai22  g227(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(x084), .c(x004), .O(new_n385_));
  oai22  g229(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n386_));
  nand3  g230(.a(new_n386_), .b(x068), .c(x020), .O(new_n387_));
  aoi22  g231(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n388_));
  nand3  g232(.a(new_n388_), .b(new_n387_), .c(new_n385_), .O(new_n389_));
  inv1   g233(.a(new_n389_), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(x044), .c(new_n157_), .O(z12));
  inv1   g235(.a(x045), .O(new_n392_));
  nand2  g236(.a(x021), .b(x013), .O(new_n393_));
  oai21  g237(.a(new_n278_), .b(x029), .c(new_n393_), .O(new_n394_));
  nor2   g238(.a(x125), .b(x101), .O(new_n395_));
  nor2   g239(.a(x117), .b(x109), .O(new_n396_));
  oai21  g240(.a(new_n395_), .b(x093), .c(new_n396_), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(new_n275_), .O(new_n398_));
  oai21  g242(.a(new_n258_), .b(x109), .c(x037), .O(new_n399_));
  nand2  g243(.a(new_n399_), .b(x117), .O(new_n400_));
  inv1   g244(.a(x101), .O(new_n401_));
  oai21  g245(.a(new_n401_), .b(x061), .c(new_n248_), .O(new_n402_));
  ...
  nand4  g249(.a(new_n405_), .b(new_n400_), .c(new_n398_), .d(new_n394_), .O(new_n406_));
  ...
  nand2  g255(.a(new_n411_), .b(x005), .O(new_n412_));
  nand2  g256(.a(new_n244_), .b(x029), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n242_), .O(new_n414_));
  nand2  g258(.a(new_n414_), .b(new_n274_), .O(new_n415_));
  aoi21  g259(.a(new_n415_), .b(new_n241_), .c(new_n396_), .O(new_n416_));
  nor2   g260(.a(new_n240_), .b(x021), .O(new_n417_));
  oai21  g261(.a(new_n417_), .b(new_n278_), .c(x069), .O(new_n418_));
  inv1   g262(.a(new_n395_), .O(new_n419_));
  nand4  g263(.a(new_n419_), .b(new_n393_), .c(new_n244_), .d(x029), .O(new_n420_));
  aoi21  g264(.a(new_n420_), .b(new_n418_), .c(x077), .O(new_n421_));
  oai21  g265(.a(new_n421_), .b(new_n416_), .c(new_n239_), .O(new_n422_));
  nand2  g266(.a(new_n393_), .b(x029), .O(new_n423_));
  ...
  aoi21  g274(.a(new_n426_), .b(new_n266_), .c(new_n430_), .O(new_n431_));
  nand2  g275(.a(new_n431_), .b(new_n412_), .O(new_n432_));
  nand3  g276(.a(new_n432_), .b(new_n157_), .c(new_n392_), .O(new_n433_));
  inv1   g277(.a(new_n433_), .O(z13));
  oai21  g278(.a(x046), .b(x014), .c(x078), .O(new_n435_));
  inv1   g279(.a(x014), .O(new_n436_));
  inv1   g280(.a(x030), .O(new_n437_));
  nor2   g281(.a(x094), .b(x062), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(new_n437_), .O(new_n439_));
  oai21  g283(.a(new_n299_), .b(new_n436_), .c(new_n439_), .O(new_n440_));
  ...
  oai21  g290(.a(new_n446_), .b(new_n443_), .c(new_n300_), .O(new_n447_));
  ...
  nand3  g294(.a(x126), .b(new_n445_), .c(new_n299_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n303_), .O(new_n452_));
  aoi21  g296(.a(new_n450_), .b(new_n296_), .c(new_n452_), .O(new_n453_));
  nand4  g297(.a(new_n453_), .b(new_n449_), .c(new_n447_), .d(new_n440_), .O(new_n454_));
  nor2   g298(.a(x038), .b(new_n436_), .O(new_n455_));
  nor2   g299(.a(new_n442_), .b(x062), .O(new_n456_));
  aoi22  g300(.a(new_n456_), .b(new_n455_), .c(new_n454_), .d(new_n295_), .O(new_n457_));
  nand3  g301(.a(x086), .b(new_n296_), .c(new_n436_), .O(new_n458_));
  ...
  oai21  g305(.a(new_n461_), .b(x078), .c(new_n436_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n446_), .O(new_n463_));
  nand2  g307(.a(new_n296_), .b(x030), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n438_), .c(new_n300_), .O(new_n465_));
  ...
  oai21  g313(.a(new_n469_), .b(new_n465_), .c(new_n295_), .O(new_n470_));
  aoi21  g314(.a(new_n470_), .b(new_n463_), .c(x054), .O(new_n471_));
  oai21  g315(.a(new_n299_), .b(new_n436_), .c(x030), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n438_), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(new_n295_), .c(x038), .O(new_n474_));
  inv1   g318(.a(new_n474_), .O(new_n475_));
  oai21  g319(.a(new_n475_), .b(new_n471_), .c(new_n303_), .O(new_n476_));
  oai22  g320(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(x070), .c(x022), .O(new_n478_));
  nand2  g322(.a(x054), .b(x038), .O(new_n479_));
  nand3  g323(.a(new_n479_), .b(new_n478_), .c(new_n476_), .O(new_n480_));
  aoi21  g324(.a(new_n459_), .b(x006), .c(new_n480_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(x046), .c(new_n435_), .O(z14));
  zero   g326(.O(z15));
  zero   g327(.O(z20));
  zero   g328(.O(z21));
  zero   g329(.O(z22));
  ...
  zero   g332(.O(z26));
  zero   g333(.O(z27));
  inv1   g334(.a(new_n157_), .O(z16));
  inv1   g335(.a(new_n157_), .O(z17));
  inv1   g336(.a(new_n157_), .O(z18));
  inv1   g337(.a(new_n157_), .O(z19));
  inv1   g338(.a(new_n157_), .O(z24));
endmodule
