...
module FAU ( 
  ...
  nand3  g048(.a(new_n204_), .b(new_n172_), .c(new_n203_), .O(new_n205_));
  ...
  nand3  g257(.a(new_n413_), .b(new_n174_), .c(new_n365_), .O(new_n414_));
  ...
  oai21  g266(.a(new_n422_), .b(x041), .c(new_n174_), .O(z09));
  ...
  nand2  g271(.a(new_n427_), .b(new_n174_), .O(new_n428_));
  oai22  g272(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n429_));
  nand4  g273(.a(new_n429_), .b(x126), .c(x066), .d(x018), .O(new_n430_));
  ...
  nor2   g377(.a(x126), .b(new_n172_), .O(z19));
