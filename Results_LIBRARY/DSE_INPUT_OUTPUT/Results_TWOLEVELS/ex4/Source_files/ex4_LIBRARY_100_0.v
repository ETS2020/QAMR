...
module FAU ( 
  ...
  oai21  g248(.a(new_n404_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g256(.a(new_n412_), .b(x042), .c(new_n158_), .O(z10));
  ...
  oai21  g264(.a(new_n420_), .b(x043), .c(new_n158_), .O(z11));
  ...
  oai21  g276(.a(new_n279_), .b(x029), .c(new_n432_), .O(new_n433_));
  ...
  nand2  g295(.a(new_n245_), .b(x029), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(new_n243_), .O(new_n453_));
  nand2  g297(.a(new_n453_), .b(new_n275_), .O(new_n454_));
  aoi21  g298(.a(new_n454_), .b(new_n242_), .c(new_n435_), .O(new_n455_));
  nor2   g299(.a(new_n241_), .b(x021), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(new_n279_), .c(x069), .O(new_n457_));
  inv1   g301(.a(new_n434_), .O(new_n458_));
  nand4  g302(.a(new_n458_), .b(new_n432_), .c(new_n245_), .d(x029), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n457_), .c(x077), .O(new_n460_));
  oai21  g304(.a(new_n460_), .b(new_n455_), .c(new_n240_), .O(new_n461_));
  ...
  aoi21  g313(.a(new_n465_), .b(new_n267_), .c(new_n469_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n451_), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n158_), .c(new_n431_), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(z13));
  aoi21  g317(.a(x054), .b(x038), .c(x014), .O(new_n474_));
  nand3  g318(.a(x070), .b(new_n298_), .c(x022), .O(new_n475_));
  nand3  g319(.a(x086), .b(new_n312_), .c(x006), .O(new_n476_));
  nand4  g320(.a(new_n476_), .b(new_n475_), .c(new_n474_), .d(x078), .O(new_n477_));
  and2   g321(.a(new_n477_), .b(new_n296_), .O(z14));
  zero   g322(.O(z17));
  zero   g323(.O(z20));
  zero   g324(.O(z21));
  zero   g325(.O(z22));
