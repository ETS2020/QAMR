// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:06 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x124), .O(new_n172_));
  nor2   g016(.a(new_n172_), .b(x107), .O(z07));
  ...
  oai21  g200(.a(new_n165_), .b(new_n159_), .c(new_n356_), .O(new_n357_));
  ...
  oai21  g230(.a(new_n386_), .b(new_n382_), .c(new_n162_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n380_), .c(x048), .O(new_n388_));
  oai21  g232(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n389_));
  ...
  nand3  g250(.a(new_n406_), .b(new_n174_), .c(new_n400_), .O(new_n407_));
  ...
  oai21  g259(.a(new_n415_), .b(x042), .c(new_n174_), .O(z10));
  ...
  nand3  g267(.a(new_n423_), .b(new_n174_), .c(new_n417_), .O(new_n424_));
  ...
  oai21  g276(.a(new_n432_), .b(x044), .c(new_n174_), .O(z12));
  ...
  oai21  g322(.a(new_n337_), .b(x030), .c(new_n478_), .O(new_n479_));
  ...
  nand2  g326(.a(new_n482_), .b(new_n334_), .O(new_n483_));
  oai21  g327(.a(new_n317_), .b(x110), .c(x038), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(x118), .O(new_n485_));
  inv1   g329(.a(x102), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(x062), .c(new_n307_), .O(new_n487_));
  nand3  g331(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(new_n325_), .O(new_n489_));
  aoi21  g333(.a(new_n487_), .b(new_n312_), .c(new_n489_), .O(new_n490_));
  nand4  g334(.a(new_n490_), .b(new_n485_), .c(new_n483_), .d(new_n479_), .O(new_n491_));
  nand4  g335(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n492_));
  inv1   g336(.a(new_n492_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n333_), .c(new_n493_), .O(new_n494_));
  nand3  g338(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n495_));
  oai21  g339(.a(new_n494_), .b(x054), .c(new_n495_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(x006), .O(new_n497_));
  nand2  g341(.a(new_n303_), .b(x030), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n301_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n333_), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(new_n300_), .c(new_n481_), .O(new_n501_));
  nor2   g345(.a(new_n299_), .b(x022), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(new_n337_), .c(x070), .O(new_n503_));
  inv1   g347(.a(new_n480_), .O(new_n504_));
  nand4  g348(.a(new_n504_), .b(new_n478_), .c(new_n303_), .d(x030), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n503_), .c(x078), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(new_n501_), .c(new_n298_), .O(new_n507_));
  nand2  g351(.a(new_n478_), .b(x030), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n329_), .O(new_n509_));
  nand3  g353(.a(new_n509_), .b(new_n333_), .c(x038), .O(new_n510_));
  ...
  aoi21  g359(.a(new_n511_), .b(new_n325_), .c(new_n515_), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n497_), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n174_), .c(new_n477_), .O(new_n518_));
  inv1   g362(.a(new_n518_), .O(z14));
  zero   g363(.O(z17));
  zero   g364(.O(z18));
  zero   g365(.O(z21));
  zero   g366(.O(z23));
  zero   g367(.O(z25));
  nor2   g368(.a(new_n172_), .b(x107), .O(z15));
  nor2   g369(.a(new_n172_), .b(x107), .O(z16));
  nor2   g370(.a(new_n172_), .b(x107), .O(z19));
  nor2   g371(.a(new_n172_), .b(x107), .O(z20));
  nor2   g372(.a(new_n172_), .b(x107), .O(z22));
  nor2   g373(.a(new_n172_), .b(x107), .O(z24));
  nor2   g374(.a(new_n172_), .b(x107), .O(z26));
  nor2   g375(.a(new_n172_), .b(x107), .O(z27));
endmodule
