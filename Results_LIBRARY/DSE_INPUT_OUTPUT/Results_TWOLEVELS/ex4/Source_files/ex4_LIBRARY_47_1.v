// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:28 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x043), .O(z07));
  ...
  oai21  g139(.a(new_n295_), .b(new_n240_), .c(new_n174_), .O(z05));
  inv1   g140(.a(x046), .O(new_n297_));
  inv1   g141(.a(x038), .O(new_n298_));
  inv1   g142(.a(x043), .O(new_n299_));
  ...
  aoi21  g198(.a(new_n350_), .b(x043), .c(new_n354_), .O(new_n355_));
  ...
  oai21  g247(.a(new_n403_), .b(x040), .c(new_n174_), .O(z08));
  ...
  nand3  g255(.a(new_n411_), .b(new_n174_), .c(new_n405_), .O(new_n412_));
  ...
  nand3  g264(.a(new_n420_), .b(new_n174_), .c(new_n414_), .O(new_n421_));
  ...
  nand2  g270(.a(x051), .b(x035), .O(new_n427_));
  aoi21  g271(.a(x075), .b(x011), .c(x078), .O(new_n428_));
  nand4  g272(.a(new_n428_), .b(new_n427_), .c(new_n426_), .d(new_n424_), .O(new_n429_));
  and2   g273(.a(new_n429_), .b(new_n299_), .O(z11));
  ...
  oai21  g284(.a(new_n282_), .b(x029), .c(new_n440_), .O(new_n441_));
  inv1   g285(.a(x101), .O(new_n442_));
  nand2  g286(.a(new_n263_), .b(new_n442_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n248_), .O(new_n444_));
  nor2   g288(.a(x117), .b(x109), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(new_n444_), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(new_n279_), .O(new_n447_));
  oai21  g291(.a(new_n263_), .b(x109), .c(x037), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(x117), .O(new_n449_));
  oai21  g293(.a(new_n442_), .b(x061), .c(new_n254_), .O(new_n450_));
  nand3  g294(.a(x125), .b(new_n255_), .c(new_n245_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n271_), .O(new_n452_));
  aoi21  g296(.a(new_n450_), .b(new_n259_), .c(new_n452_), .O(new_n453_));
  nand4  g297(.a(new_n453_), .b(new_n449_), .c(new_n447_), .d(new_n441_), .O(new_n454_));
  nand4  g298(.a(x125), .b(new_n247_), .c(new_n259_), .d(x013), .O(new_n455_));
  inv1   g299(.a(new_n455_), .O(new_n456_));
  aoi21  g300(.a(new_n454_), .b(new_n278_), .c(new_n456_), .O(new_n457_));
  nand3  g301(.a(x085), .b(new_n259_), .c(new_n244_), .O(new_n458_));
  oai21  g302(.a(new_n457_), .b(x053), .c(new_n458_), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(x005), .O(new_n460_));
  oai21  g304(.a(new_n249_), .b(new_n243_), .c(new_n245_), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n278_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n244_), .c(new_n445_), .O(new_n463_));
  nor2   g307(.a(new_n243_), .b(x021), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n282_), .c(x069), .O(new_n465_));
  nand4  g309(.a(new_n443_), .b(new_n440_), .c(new_n250_), .d(x029), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n465_), .c(x077), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(new_n463_), .c(new_n242_), .O(new_n468_));
  nand2  g312(.a(new_n440_), .b(x029), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n274_), .O(new_n470_));
  nand3  g314(.a(new_n470_), .b(new_n278_), .c(x037), .O(new_n471_));
  nand2  g315(.a(new_n471_), .b(new_n468_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n271_), .O(new_n473_));
  ...
  nand3  g321(.a(new_n477_), .b(new_n174_), .c(new_n240_), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(z13));
  nand3  g323(.a(x126), .b(new_n315_), .c(x006), .O(new_n480_));
  oai21  g324(.a(x086), .b(new_n335_), .c(new_n480_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n340_), .O(new_n482_));
  oai21  g326(.a(new_n335_), .b(x022), .c(new_n328_), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(new_n321_), .c(x054), .O(new_n484_));
  aoi21  g328(.a(new_n484_), .b(new_n482_), .c(x078), .O(new_n485_));
  inv1   g329(.a(x054), .O(new_n486_));
  nor2   g330(.a(new_n486_), .b(new_n299_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n485_), .c(x038), .O(new_n488_));
  oai21  g332(.a(new_n331_), .b(new_n298_), .c(x006), .O(new_n489_));
  oai21  g333(.a(new_n302_), .b(new_n335_), .c(new_n300_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n321_), .O(new_n491_));
  aoi22  g335(.a(new_n491_), .b(new_n489_), .c(new_n314_), .d(new_n315_), .O(new_n492_));
  nand3  g336(.a(new_n321_), .b(x070), .c(x030), .O(new_n493_));
  nand3  g337(.a(x102), .b(new_n318_), .c(x006), .O(new_n494_));
  ...
  aoi22  g341(.a(new_n497_), .b(x006), .c(new_n321_), .d(x070), .O(new_n498_));
  or2    g342(.a(new_n498_), .b(new_n328_), .O(new_n499_));
  nand4  g343(.a(new_n497_), .b(new_n301_), .c(new_n321_), .d(x030), .O(new_n500_));
  inv1   g344(.a(x094), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n331_), .c(x006), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n500_), .O(new_n503_));
  oai21  g347(.a(x126), .b(x102), .c(new_n503_), .O(new_n504_));
  nand2  g348(.a(x126), .b(new_n314_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n335_), .c(x022), .O(new_n506_));
  nand2  g350(.a(x030), .b(new_n340_), .O(new_n507_));
  nand3  g351(.a(x126), .b(x094), .c(new_n318_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n321_), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(new_n506_), .c(x006), .O(new_n510_));
  nand4  g354(.a(new_n510_), .b(new_n504_), .c(new_n499_), .d(new_n496_), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n492_), .c(new_n486_), .O(new_n512_));
  oai22  g356(.a(new_n321_), .b(new_n345_), .c(new_n331_), .d(new_n332_), .O(new_n513_));
  nor2   g357(.a(new_n331_), .b(x038), .O(new_n514_));
  aoi22  g358(.a(new_n514_), .b(x022), .c(new_n513_), .d(new_n340_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  nand3  g360(.a(x070), .b(new_n486_), .c(x022), .O(new_n517_));
  nand3  g361(.a(x086), .b(new_n298_), .c(x006), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n340_), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(x078), .c(x043), .O(new_n520_));
  inv1   g364(.a(new_n520_), .O(new_n521_));
  aoi21  g365(.a(new_n516_), .b(new_n172_), .c(new_n521_), .O(new_n522_));
  aoi21  g366(.a(new_n522_), .b(new_n488_), .c(x046), .O(z14));
  zero   g367(.O(z15));
  zero   g368(.O(z16));
  zero   g369(.O(z18));
  zero   g370(.O(z19));
  ...
  zero   g373(.O(z25));
  zero   g374(.O(z26));
  nor2   g375(.a(new_n172_), .b(x043), .O(z17));
  nor2   g376(.a(new_n172_), .b(x043), .O(z20));
  nor2   g377(.a(new_n172_), .b(x043), .O(z22));
  nor2   g378(.a(new_n172_), .b(x043), .O(z24));
  nor2   g379(.a(new_n172_), .b(x043), .O(z27));
endmodule
