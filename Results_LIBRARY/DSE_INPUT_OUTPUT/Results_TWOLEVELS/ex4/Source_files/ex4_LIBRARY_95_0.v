...
module FAU ( 
  ...
  zero   g373(.O(z26));
  zero   g374(.O(z27));
  nor2   g375(.a(x126), .b(x117), .O(z16));
  nor2   g376(.a(x126), .b(x117), .O(z17));
  nor2   g377(.a(x126), .b(x117), .O(z18));
  nor2   g378(.a(x126), .b(x117), .O(z20));
  nor2   g379(.a(x126), .b(x117), .O(z22));
  nor2   g380(.a(x126), .b(x117), .O(z24));
  nor2   g381(.a(x126), .b(x117), .O(z25));
endmodule
