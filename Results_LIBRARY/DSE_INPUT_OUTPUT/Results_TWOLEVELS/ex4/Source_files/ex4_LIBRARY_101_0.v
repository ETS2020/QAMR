...
module FAU ( 
  ...
  nor2   g148(.a(x054), .b(new_n223_), .O(new_n305_));
  ...
  nand3  g156(.a(new_n312_), .b(new_n298_), .c(x004), .O(new_n313_));
  ...
  nand3  g253(.a(new_n409_), .b(new_n173_), .c(new_n403_), .O(new_n410_));
  ...
  nand3  g320(.a(new_n476_), .b(new_n173_), .c(new_n437_), .O(new_n477_));
  ...
  zero   g365(.O(z26));
  zero   g366(.O(z27));
  nor2   g367(.a(x078), .b(x004), .O(z16));
  nor2   g368(.a(x078), .b(x004), .O(z17));
  nor2   g369(.a(x078), .b(x004), .O(z19));
  nor2   g370(.a(x078), .b(x004), .O(z22));
  nor2   g371(.a(x078), .b(x004), .O(z24));
  nor2   g372(.a(x078), .b(x004), .O(z25));
endmodule
