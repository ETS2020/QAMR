// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:28 2020
...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x100), .O(new_n304_));
  ...
  nand3  g217(.a(x120), .b(new_n373_), .c(new_n169_), .O(new_n374_));
  nand2  g218(.a(new_n374_), .b(new_n162_), .O(new_n375_));
  aoi21  g219(.a(new_n372_), .b(new_n164_), .c(new_n375_), .O(new_n376_));
  nand4  g220(.a(new_n376_), .b(new_n370_), .c(new_n368_), .d(new_n361_), .O(new_n377_));
  nand4  g221(.a(x120), .b(new_n358_), .c(new_n164_), .d(x008), .O(new_n378_));
  inv1   g222(.a(new_n378_), .O(new_n379_));
  aoi21  g223(.a(new_n377_), .b(new_n166_), .c(new_n379_), .O(new_n380_));
  nand3  g224(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n381_));
  ...
  nand2  g229(.a(new_n385_), .b(new_n169_), .O(new_n386_));
  nand2  g230(.a(new_n386_), .b(new_n166_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n163_), .c(new_n366_), .O(new_n388_));
  ...
  oai21  g237(.a(new_n393_), .b(new_n388_), .c(new_n165_), .O(new_n394_));
  ...
  nand2  g242(.a(new_n398_), .b(new_n162_), .O(new_n399_));
  ...
  nand3  g247(.a(new_n403_), .b(new_n160_), .c(new_n356_), .O(new_n404_));
  ...
  oai21  g256(.a(new_n412_), .b(x041), .c(new_n160_), .O(z09));
  ...
  nand3  g264(.a(new_n420_), .b(new_n160_), .c(new_n414_), .O(new_n421_));
  ...
  aoi21  g286(.a(new_n261_), .b(new_n442_), .c(x093), .O(new_n443_));
  nor2   g287(.a(x117), .b(x109), .O(new_n444_));
  inv1   g288(.a(new_n444_), .O(new_n445_));
  oai21  g289(.a(new_n445_), .b(new_n443_), .c(new_n278_), .O(new_n446_));
  oai21  g290(.a(new_n261_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g292(.a(new_n442_), .b(x061), .c(new_n251_), .O(new_n449_));
  ...
  nand4  g296(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n441_), .O(new_n453_));
  ...
  aoi21  g302(.a(new_n247_), .b(x029), .c(x021), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(x077), .c(new_n244_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n445_), .O(new_n461_));
  nand2  g305(.a(x029), .b(new_n245_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n273_), .c(new_n278_), .O(new_n463_));
  nand2  g307(.a(new_n261_), .b(new_n442_), .O(new_n464_));
  nand4  g308(.a(new_n464_), .b(new_n440_), .c(new_n247_), .d(x029), .O(new_n465_));
  inv1   g309(.a(new_n465_), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n463_), .c(new_n277_), .O(new_n467_));
  aoi21  g311(.a(new_n467_), .b(new_n461_), .c(x053), .O(new_n468_));
  nand2  g312(.a(new_n440_), .b(x029), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n273_), .O(new_n470_));
  nand3  g314(.a(new_n470_), .b(new_n277_), .c(x037), .O(new_n471_));
  inv1   g315(.a(new_n471_), .O(new_n472_));
  oai21  g316(.a(new_n472_), .b(new_n468_), .c(new_n269_), .O(new_n473_));
  ...
  oai21  g322(.a(new_n478_), .b(x045), .c(new_n160_), .O(z13));
  aoi21  g323(.a(new_n297_), .b(x014), .c(x100), .O(new_n480_));
  ...
  aoi21  g341(.a(new_n495_), .b(new_n157_), .c(new_n497_), .O(new_n498_));
  ...
  oai21  g352(.a(new_n508_), .b(new_n505_), .c(new_n157_), .O(new_n509_));
  ...
  nand3  g356(.a(new_n512_), .b(new_n157_), .c(x038), .O(new_n513_));
  ...
  oai22  g364(.a(new_n520_), .b(x046), .c(new_n480_), .d(new_n157_), .O(z14));
  zero   g365(.O(z16));
  zero   g366(.O(z17));
  zero   g367(.O(z19));
  zero   g368(.O(z20));
  ...
  zero   g371(.O(z25));
  zero   g372(.O(z26));
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z15));
  nor2   g374(.a(new_n158_), .b(new_n157_), .O(z18));
