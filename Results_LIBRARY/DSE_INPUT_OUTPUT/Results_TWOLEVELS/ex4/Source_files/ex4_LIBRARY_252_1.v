...
module FAU ( 
  ...
  oai21  g315(.a(new_n472_), .b(x045), .c(new_n174_), .O(z13));
  oai21  g316(.a(new_n334_), .b(new_n313_), .c(x006), .O(new_n474_));
  oai21  g317(.a(new_n342_), .b(new_n301_), .c(new_n302_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n326_), .O(new_n476_));
  aoi22  g319(.a(new_n476_), .b(new_n474_), .c(new_n309_), .d(new_n308_), .O(new_n477_));
  nand3  g320(.a(new_n326_), .b(x070), .c(x030), .O(new_n478_));
  nand3  g321(.a(x102), .b(new_n316_), .c(x006), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n313_), .O(new_n481_));
  nand2  g324(.a(x022), .b(x014), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x006), .O(new_n483_));
  oai21  g326(.a(x086), .b(new_n334_), .c(new_n483_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n338_), .O(new_n485_));
  nand4  g328(.a(new_n482_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n486_));
  ...
  nand2  g333(.a(x126), .b(new_n309_), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n301_), .c(x022), .O(new_n492_));
  nand2  g335(.a(x030), .b(new_n299_), .O(new_n493_));
  nand3  g336(.a(x126), .b(x094), .c(new_n316_), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n493_), .c(new_n326_), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n492_), .c(x006), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n490_), .c(new_n485_), .d(new_n481_), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(new_n477_), .c(new_n300_), .O(new_n498_));
  nand3  g341(.a(x126), .b(new_n308_), .c(x038), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(new_n326_), .c(new_n298_), .O(new_n500_));
  oai22  g343(.a(new_n327_), .b(new_n301_), .c(new_n334_), .d(new_n335_), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n500_), .c(new_n299_), .O(new_n502_));
  nand2  g345(.a(x030), .b(new_n335_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n330_), .c(x086), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(x054), .c(x038), .O(new_n505_));
  nand3  g348(.a(x070), .b(new_n313_), .c(x022), .O(new_n506_));
  nand4  g349(.a(new_n506_), .b(new_n505_), .c(new_n502_), .d(new_n498_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n172_), .c(new_n297_), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(z14));
  zero   g352(.O(z07));
  zero   g353(.O(z16));
  zero   g354(.O(z20));
  zero   g355(.O(z22));
  ...
  nor2   g361(.a(new_n172_), .b(x046), .O(z18));
  nor2   g362(.a(new_n172_), .b(x046), .O(z19));
  nor2   g363(.a(new_n172_), .b(x046), .O(z21));
  nor2   g364(.a(new_n172_), .b(x046), .O(z25));
endmodule
