...
module FAU ( 
  ...
  nand2  g009(.a(new_n165_), .b(new_n160_), .O(new_n166_));
  aoi22  g010(.a(new_n164_), .b(new_n161_), .c(new_n163_), .d(new_n162_), .O(new_n167_));
  oai21  g011(.a(new_n166_), .b(x000), .c(new_n167_), .O(new_n168_));
  nand2  g012(.a(new_n168_), .b(new_n159_), .O(new_n169_));
  inv1   g013(.a(x016), .O(new_n170_));
  inv1   g014(.a(x064), .O(new_n171_));
  oai22  g015(.a(new_n164_), .b(new_n162_), .c(new_n163_), .d(new_n161_), .O(new_n172_));
  nand4  g016(.a(new_n172_), .b(x078), .c(new_n171_), .d(new_n170_), .O(new_n173_));
  aoi21  g017(.a(new_n173_), .b(new_n169_), .c(new_n157_), .O(z00));
  ...
  nand3  g032(.a(new_n188_), .b(new_n159_), .c(x041), .O(new_n189_));
  ...
  nor2   g148(.a(new_n171_), .b(x054), .O(new_n305_));
  ...
  nand3  g195(.a(new_n351_), .b(new_n298_), .c(x064), .O(new_n352_));
  ...
  oai21  g209(.a(new_n366_), .b(new_n364_), .c(new_n171_), .O(new_n367_));
  ...
  nand3  g215(.a(x120), .b(new_n372_), .c(new_n170_), .O(new_n373_));
  ...
  nand4  g219(.a(x120), .b(new_n171_), .c(new_n358_), .d(x008), .O(new_n377_));
  ...
  oai21  g357(.a(new_n514_), .b(x046), .c(new_n159_), .O(z14));
  zero   g358(.O(z07));
  zero   g359(.O(z16));
  zero   g360(.O(z17));
  zero   g361(.O(z20));
  ...
  zero   g363(.O(z25));
  zero   g364(.O(z27));
  nor2   g365(.a(x078), .b(x064), .O(z18));
  nor2   g366(.a(x078), .b(x064), .O(z19));
  nor2   g367(.a(x078), .b(x064), .O(z21));
  nor2   g368(.a(x078), .b(x064), .O(z22));
  nor2   g369(.a(x078), .b(x064), .O(z23));
  nor2   g370(.a(x078), .b(x064), .O(z26));
endmodule
