// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:01 2020
...
module FAU ( 
  ...
  nand2  g200(.a(new_n357_), .b(new_n169_), .O(new_n358_));
  ...
  nand3  g208(.a(x120), .b(new_n365_), .c(new_n168_), .O(new_n366_));
  nand2  g209(.a(new_n366_), .b(new_n161_), .O(new_n367_));
  aoi21  g210(.a(new_n364_), .b(new_n163_), .c(new_n367_), .O(new_n368_));
  nand4  g211(.a(new_n368_), .b(new_n361_), .c(new_n358_), .d(new_n354_), .O(new_n369_));
  nand4  g212(.a(x120), .b(new_n351_), .c(new_n163_), .d(x008), .O(new_n370_));
  inv1   g213(.a(new_n370_), .O(new_n371_));
  aoi21  g214(.a(new_n369_), .b(new_n165_), .c(new_n371_), .O(new_n372_));
  nand3  g215(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n373_));
  ...
  nand2  g220(.a(new_n377_), .b(new_n168_), .O(new_n378_));
  nand2  g221(.a(new_n378_), .b(new_n165_), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(new_n162_), .c(new_n356_), .O(new_n380_));
  ...
  oai21  g229(.a(new_n386_), .b(new_n380_), .c(new_n164_), .O(new_n387_));
  nand2  g230(.a(new_n350_), .b(x024), .O(new_n388_));
  nand3  g231(.a(new_n388_), .b(new_n352_), .c(new_n351_), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(new_n165_), .c(x032), .O(new_n390_));
  ...
  aoi21  g238(.a(new_n391_), .b(new_n161_), .c(new_n395_), .O(new_n396_));
  nand2  g239(.a(new_n396_), .b(new_n375_), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(new_n159_), .c(new_n349_), .O(new_n398_));
  ...
  nand3  g249(.a(new_n406_), .b(new_n159_), .c(new_n400_), .O(new_n407_));
  ...
  nand3  g258(.a(new_n415_), .b(new_n159_), .c(new_n409_), .O(new_n416_));
  ...
  nand3  g267(.a(new_n424_), .b(new_n159_), .c(new_n418_), .O(new_n425_));
  ...
  oai22  g277(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n435_));
  inv1   g278(.a(x101), .O(new_n436_));
  aoi21  g279(.a(new_n260_), .b(new_n436_), .c(x093), .O(new_n437_));
  nand2  g280(.a(new_n251_), .b(new_n250_), .O(new_n438_));
  oai21  g281(.a(new_n438_), .b(new_n437_), .c(new_n277_), .O(new_n439_));
  oai21  g282(.a(new_n260_), .b(x109), .c(x037), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(x117), .O(new_n441_));
  oai21  g284(.a(new_n436_), .b(x061), .c(new_n250_), .O(new_n442_));
  nand3  g285(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n443_));
  nand2  g286(.a(new_n443_), .b(new_n268_), .O(new_n444_));
  aoi21  g287(.a(new_n442_), .b(new_n255_), .c(new_n444_), .O(new_n445_));
  nand4  g288(.a(new_n445_), .b(new_n441_), .c(new_n439_), .d(new_n435_), .O(new_n446_));
  nand4  g289(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n447_));
  inv1   g290(.a(new_n447_), .O(new_n448_));
  aoi21  g291(.a(new_n446_), .b(new_n276_), .c(new_n448_), .O(new_n449_));
  nand3  g292(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n450_));
  oai21  g293(.a(new_n449_), .b(x053), .c(new_n450_), .O(new_n451_));
  aoi21  g294(.a(new_n246_), .b(x029), .c(x021), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(x077), .c(new_n243_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(new_n438_), .O(new_n454_));
  nand2  g297(.a(x029), .b(new_n244_), .O(new_n455_));
  aoi21  g298(.a(new_n455_), .b(new_n272_), .c(new_n277_), .O(new_n456_));
  nand2  g299(.a(new_n260_), .b(new_n436_), .O(new_n457_));
  ...
  oai21  g303(.a(new_n460_), .b(new_n456_), .c(new_n276_), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n454_), .c(x053), .O(new_n462_));
  oai21  g305(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n463_));
  nand2  g306(.a(new_n463_), .b(new_n272_), .O(new_n464_));
  nand3  g307(.a(new_n464_), .b(new_n276_), .c(x037), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n462_), .c(new_n268_), .O(new_n467_));
  ...
  oai21  g315(.a(new_n472_), .b(x045), .c(new_n159_), .O(z13));
  oai21  g316(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n474_));
  nand2  g317(.a(new_n318_), .b(new_n314_), .O(new_n475_));
  oai22  g318(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n475_), .O(new_n477_));
  oai22  g320(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n478_));
  nand2  g321(.a(x118), .b(new_n298_), .O(new_n479_));
  oai21  g322(.a(x118), .b(x022), .c(new_n479_), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(x126), .c(x086), .O(new_n481_));
  nand4  g324(.a(new_n481_), .b(new_n478_), .c(new_n477_), .d(new_n474_), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n297_), .c(new_n340_), .O(new_n483_));
  nand4  g326(.a(x086), .b(new_n157_), .c(new_n300_), .d(new_n319_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(x006), .O(new_n486_));
  nor2   g329(.a(new_n331_), .b(new_n304_), .O(new_n487_));
  oai22  g330(.a(new_n487_), .b(new_n321_), .c(x118), .d(x110), .O(new_n488_));
  nor2   g331(.a(x038), .b(new_n304_), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n307_), .c(x070), .O(new_n490_));
  nand4  g333(.a(new_n475_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n491_));
  nand3  g334(.a(new_n491_), .b(new_n490_), .c(new_n488_), .O(new_n492_));
  aoi21  g335(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n493_));
  nor2   g336(.a(new_n493_), .b(new_n300_), .O(new_n494_));
  aoi21  g337(.a(new_n492_), .b(new_n340_), .c(new_n494_), .O(new_n495_));
  nor2   g338(.a(new_n301_), .b(x038), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(x022), .c(x046), .O(new_n497_));
  oai21  g340(.a(new_n495_), .b(x086), .c(new_n497_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n297_), .O(new_n499_));
  nand2  g342(.a(x054), .b(x038), .O(new_n500_));
  nand4  g343(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n501_));
  nand2  g344(.a(x078), .b(x014), .O(new_n502_));
  nand3  g345(.a(new_n502_), .b(new_n501_), .c(new_n500_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n157_), .O(new_n504_));
  nand3  g347(.a(new_n504_), .b(new_n499_), .c(new_n486_), .O(z14));
  zero   g348(.O(z07));
  zero   g349(.O(z18));
  zero   g350(.O(z20));
  zero   g351(.O(z22));
  zero   g352(.O(z24));
  zero   g353(.O(z27));
  nor2   g354(.a(x078), .b(new_n157_), .O(z16));
  nor2   g355(.a(x078), .b(new_n157_), .O(z17));
  nor2   g356(.a(x078), .b(new_n157_), .O(z19));
  nor2   g357(.a(x078), .b(new_n157_), .O(z21));
  nor2   g358(.a(x078), .b(new_n157_), .O(z23));
