// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:15 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x122), .O(new_n172_));
  nor2   g016(.a(new_n172_), .b(x092), .O(z07));
  ...
  nand3  g195(.a(new_n351_), .b(new_n174_), .c(x046), .O(new_n352_));
  inv1   g196(.a(new_n352_), .O(z06));
  ...
  nand3  g246(.a(new_n402_), .b(new_n174_), .c(new_n354_), .O(new_n403_));
  ...
  oai21  g255(.a(new_n411_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai21  g263(.a(new_n419_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai22  g319(.a(new_n337_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n476_));
  inv1   g320(.a(x102), .O(new_n477_));
  aoi21  g321(.a(new_n317_), .b(new_n477_), .c(x094), .O(new_n478_));
  nand2  g322(.a(new_n308_), .b(new_n307_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n478_), .c(new_n334_), .O(new_n480_));
  oai21  g324(.a(new_n317_), .b(x110), .c(x038), .O(new_n481_));
  ...
  nand2  g328(.a(new_n484_), .b(new_n325_), .O(new_n485_));
  ...
  aoi21  g333(.a(new_n487_), .b(new_n333_), .c(new_n489_), .O(new_n490_));
  ...
  aoi21  g340(.a(new_n496_), .b(new_n329_), .c(new_n334_), .O(new_n497_));
  nand2  g341(.a(new_n317_), .b(new_n477_), .O(new_n498_));
  ...
  oai21  g345(.a(new_n501_), .b(new_n497_), .c(new_n333_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n495_), .c(x054), .O(new_n503_));
  oai21  g347(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n329_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n333_), .c(x038), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n503_), .c(new_n325_), .O(new_n508_));
  ...
  zero   g362(.O(z23));
  zero   g363(.O(z26));
  nor2   g364(.a(new_n172_), .b(x092), .O(z15));
  nor2   g365(.a(new_n172_), .b(x092), .O(z16));
  nor2   g366(.a(new_n172_), .b(x092), .O(z17));
  nor2   g367(.a(new_n172_), .b(x092), .O(z18));
  nor2   g368(.a(new_n172_), .b(x092), .O(z24));
  nor2   g369(.a(new_n172_), .b(x092), .O(z25));
  nor2   g370(.a(new_n172_), .b(x092), .O(z27));
endmodule
