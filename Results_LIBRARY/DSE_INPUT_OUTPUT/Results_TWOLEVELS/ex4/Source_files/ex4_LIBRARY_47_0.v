...
module FAU ( 
  ...
  nand3  g195(.a(new_n351_), .b(new_n298_), .c(x043), .O(new_n352_));
  ...
  nand2  g269(.a(x051), .b(x035), .O(new_n426_));
  aoi21  g270(.a(x075), .b(x011), .c(new_n298_), .O(new_n427_));
  nand4  g271(.a(new_n427_), .b(new_n426_), .c(new_n425_), .d(new_n423_), .O(new_n428_));
  and2   g272(.a(new_n428_), .b(new_n305_), .O(z11));
  ...
  nand3  g320(.a(new_n476_), .b(new_n173_), .c(new_n239_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  inv1   g322(.a(x054), .O(new_n479_));
  oai21  g323(.a(new_n317_), .b(new_n313_), .c(new_n314_), .O(new_n480_));
  nand3  g324(.a(new_n480_), .b(new_n312_), .c(new_n298_), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n479_), .c(new_n305_), .O(new_n482_));
  nor2   g326(.a(new_n298_), .b(new_n479_), .O(new_n483_));
  ...
  nand2  g336(.a(new_n492_), .b(new_n297_), .O(new_n493_));
  nor2   g337(.a(new_n326_), .b(x118), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n300_), .c(x086), .O(new_n495_));
  ...
  nand2  g341(.a(x086), .b(new_n299_), .O(new_n498_));
  ...
  oai21  g355(.a(new_n511_), .b(new_n499_), .c(new_n298_), .O(new_n512_));
  nand4  g356(.a(x126), .b(new_n333_), .c(new_n297_), .d(x006), .O(new_n513_));
  ...
  nand3  g361(.a(x086), .b(new_n297_), .c(x006), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n299_), .O(new_n519_));
  and2   g363(.a(new_n519_), .b(x078), .O(new_n520_));
  aoi21  g364(.a(new_n516_), .b(x043), .c(new_n520_), .O(new_n521_));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z26));
  nor2   g374(.a(x078), .b(x043), .O(z17));
  nor2   g375(.a(x078), .b(x043), .O(z20));
  nor2   g376(.a(x078), .b(x043), .O(z22));
  nor2   g377(.a(x078), .b(x043), .O(z24));
  nor2   g378(.a(x078), .b(x043), .O(z27));
endmodule
