...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x087), .O(z16));
  ...
  nand4  g343(.a(new_n172_), .b(new_n324_), .c(x038), .d(x030), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  nand2  g345(.a(new_n502_), .b(new_n492_), .O(new_n503_));
  nand4  g346(.a(x126), .b(new_n308_), .c(x087), .d(x006), .O(new_n504_));
  nand4  g347(.a(new_n172_), .b(new_n324_), .c(x070), .d(x030), .O(new_n505_));
  ...
  oai21  g356(.a(new_n513_), .b(new_n511_), .c(new_n172_), .O(new_n514_));
  ...
  nand4  g361(.a(new_n518_), .b(x126), .c(x087), .d(x006), .O(new_n519_));
  ...
  nand3  g365(.a(new_n312_), .b(x014), .c(x006), .O(new_n523_));
  nor4   g366(.a(new_n523_), .b(new_n494_), .c(x062), .d(x054), .O(new_n524_));
  ...
  zero   g375(.O(z26));
  zero   g376(.O(z27));
  nor2   g377(.a(new_n172_), .b(x087), .O(z17));
  nor2   g378(.a(new_n172_), .b(x087), .O(z20));
  nor2   g379(.a(new_n172_), .b(x087), .O(z22));
  nor2   g380(.a(new_n172_), .b(x087), .O(z23));
  nor2   g381(.a(new_n172_), .b(x087), .O(z25));
endmodule
