// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:42 2020
...
module FAU ( 
  ...
  nor2   g016(.a(x126), .b(new_n172_), .O(z18));
  ...
  nand2  g170(.a(new_n326_), .b(new_n172_), .O(new_n327_));
  ...
  nand4  g182(.a(new_n326_), .b(x118), .c(new_n172_), .d(new_n297_), .O(new_n339_));
  ...
  nand4  g198(.a(new_n354_), .b(new_n326_), .c(new_n172_), .d(new_n297_), .O(new_n355_));
  ...
  oai21  g253(.a(new_n410_), .b(x040), .c(new_n174_), .O(z08));
  ...
  nand3  g286(.a(new_n443_), .b(new_n174_), .c(new_n437_), .O(new_n444_));
  ...
  aoi22  g290(.a(new_n275_), .b(new_n254_), .c(new_n241_), .d(new_n243_), .O(new_n448_));
  nand3  g291(.a(new_n279_), .b(new_n267_), .c(new_n275_), .O(new_n449_));
  oai22  g292(.a(new_n449_), .b(x053), .c(new_n448_), .d(new_n244_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(x069), .O(new_n451_));
  nand2  g294(.a(new_n449_), .b(new_n241_), .O(new_n452_));
  aoi22  g295(.a(new_n452_), .b(x037), .c(x077), .d(x013), .O(new_n453_));
  nand3  g296(.a(new_n453_), .b(new_n451_), .c(new_n447_), .O(new_n454_));
  nand2  g297(.a(new_n454_), .b(new_n174_), .O(new_n455_));
  nand2  g298(.a(x126), .b(x117), .O(new_n456_));
  oai21  g299(.a(x117), .b(new_n250_), .c(new_n456_), .O(new_n457_));
  aoi21  g300(.a(x069), .b(x037), .c(new_n240_), .O(new_n458_));
  nand2  g301(.a(new_n246_), .b(x029), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n244_), .c(x085), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(new_n458_), .c(new_n275_), .O(new_n461_));
  oai21  g304(.a(x085), .b(new_n243_), .c(new_n461_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n457_), .O(new_n463_));
  inv1   g306(.a(x093), .O(new_n464_));
  aoi22  g307(.a(new_n464_), .b(new_n276_), .c(new_n257_), .d(new_n254_), .O(new_n465_));
  nand2  g308(.a(x021), .b(x013), .O(new_n466_));
  nand4  g309(.a(new_n466_), .b(new_n246_), .c(new_n267_), .d(x029), .O(new_n467_));
  oai21  g310(.a(new_n465_), .b(new_n240_), .c(new_n467_), .O(new_n468_));
  oai21  g311(.a(x125), .b(x101), .c(new_n468_), .O(new_n469_));
  aoi22  g312(.a(new_n271_), .b(new_n242_), .c(x021), .d(x013), .O(new_n470_));
  nor2   g313(.a(new_n259_), .b(x021), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n470_), .c(x005), .O(new_n472_));
  nand4  g315(.a(new_n267_), .b(x069), .c(x029), .d(new_n244_), .O(new_n473_));
  nand3  g316(.a(new_n473_), .b(new_n472_), .c(new_n469_), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(new_n172_), .c(new_n275_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n463_), .O(new_n476_));
  nand3  g319(.a(new_n172_), .b(new_n267_), .c(x029), .O(new_n477_));
  nand4  g320(.a(x126), .b(x125), .c(new_n250_), .d(x005), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n477_), .c(x013), .O(new_n479_));
  nand4  g322(.a(new_n172_), .b(new_n267_), .c(x029), .d(new_n244_), .O(new_n480_));
  inv1   g323(.a(new_n480_), .O(new_n481_));
  oai21  g324(.a(new_n481_), .b(new_n479_), .c(new_n275_), .O(new_n482_));
  nor2   g325(.a(new_n482_), .b(new_n254_), .O(new_n483_));
  aoi21  g326(.a(new_n476_), .b(new_n241_), .c(new_n483_), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n455_), .c(x045), .O(z13));
  oai22  g328(.a(new_n348_), .b(x030), .c(new_n315_), .d(new_n360_), .O(new_n486_));
  aoi21  g329(.a(new_n326_), .b(new_n324_), .c(x094), .O(new_n487_));
  inv1   g330(.a(x110), .O(new_n488_));
  nand2  g331(.a(new_n352_), .b(new_n488_), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n487_), .c(new_n307_), .O(new_n490_));
  oai21  g333(.a(new_n326_), .b(x110), .c(x038), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(x118), .O(new_n492_));
  oai21  g335(.a(new_n324_), .b(x062), .c(new_n488_), .O(new_n493_));
  nand3  g336(.a(x126), .b(new_n352_), .c(new_n315_), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(new_n298_), .O(new_n495_));
  aoi21  g338(.a(new_n493_), .b(new_n311_), .c(new_n495_), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n492_), .c(new_n490_), .d(new_n486_), .O(new_n497_));
  nand4  g340(.a(x126), .b(new_n359_), .c(new_n311_), .d(x014), .O(new_n498_));
  inv1   g341(.a(new_n498_), .O(new_n499_));
  aoi21  g342(.a(new_n497_), .b(new_n300_), .c(new_n499_), .O(new_n500_));
  nand3  g343(.a(x086), .b(new_n311_), .c(new_n360_), .O(new_n501_));
  oai21  g344(.a(new_n500_), .b(x054), .c(new_n501_), .O(new_n502_));
  aoi21  g345(.a(new_n308_), .b(x030), .c(x022), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(x078), .c(new_n360_), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n489_), .O(new_n505_));
  nand2  g348(.a(x030), .b(new_n315_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n328_), .c(new_n307_), .O(new_n507_));
  nand2  g350(.a(new_n326_), .b(new_n324_), .O(new_n508_));
  aoi22  g351(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n509_));
  nand3  g352(.a(new_n509_), .b(new_n508_), .c(x030), .O(new_n510_));
  inv1   g353(.a(new_n510_), .O(new_n511_));
  oai21  g354(.a(new_n511_), .b(new_n507_), .c(new_n300_), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(new_n505_), .c(x054), .O(new_n513_));
  oai21  g356(.a(new_n315_), .b(new_n360_), .c(x030), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n328_), .O(new_n515_));
  nand3  g358(.a(new_n515_), .b(new_n300_), .c(x038), .O(new_n516_));
  inv1   g359(.a(new_n516_), .O(new_n517_));
  oai21  g360(.a(new_n517_), .b(new_n513_), .c(new_n298_), .O(new_n518_));
  oai22  g361(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n519_));
  nand3  g362(.a(new_n519_), .b(x070), .c(x022), .O(new_n520_));
  aoi22  g363(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n521_));
  nand3  g364(.a(new_n521_), .b(new_n520_), .c(new_n518_), .O(new_n522_));
  aoi21  g365(.a(new_n502_), .b(x006), .c(new_n522_), .O(new_n523_));
  oai21  g366(.a(new_n523_), .b(x046), .c(new_n174_), .O(z14));
  zero   g367(.O(z07));
  zero   g368(.O(z15));
  zero   g369(.O(z16));
  zero   g370(.O(z17));
  ...
  nor2   g373(.a(x126), .b(new_n172_), .O(z20));
  nor2   g374(.a(x126), .b(new_n172_), .O(z21));
  nor2   g375(.a(x126), .b(new_n172_), .O(z22));
  nor2   g376(.a(x126), .b(new_n172_), .O(z23));
  nor2   g377(.a(x126), .b(new_n172_), .O(z24));
  nor2   g378(.a(x126), .b(new_n172_), .O(z25));
  nor2   g379(.a(x126), .b(new_n172_), .O(z27));
endmodule
