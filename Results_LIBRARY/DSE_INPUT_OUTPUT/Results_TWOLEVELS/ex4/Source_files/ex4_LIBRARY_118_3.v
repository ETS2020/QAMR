...
module FAU ( 
  ...
  nand3  g196(.a(new_n352_), .b(x046), .c(new_n157_), .O(new_n353_));
  ...
  and2   g267(.a(new_n423_), .b(new_n157_), .O(z11));
  ...
  oai21  g321(.a(new_n338_), .b(x030), .c(new_n477_), .O(new_n478_));
  ...
  oai21  g340(.a(new_n342_), .b(new_n300_), .c(new_n302_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n334_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n301_), .c(new_n480_), .O(new_n499_));
  nor2   g343(.a(new_n300_), .b(x022), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n338_), .c(x070), .O(new_n501_));
  nand2  g345(.a(new_n318_), .b(new_n485_), .O(new_n502_));
  nand4  g346(.a(new_n502_), .b(new_n477_), .c(new_n304_), .d(x030), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n501_), .c(x078), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(new_n499_), .c(new_n299_), .O(new_n505_));
  ...
  aoi21  g357(.a(new_n509_), .b(new_n326_), .c(new_n513_), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n496_), .c(x046), .O(z14));
  zero   g359(.O(z17));
  zero   g360(.O(z18));
  zero   g361(.O(z19));
  zero   g362(.O(z20));
  zero   g363(.O(z21));
  zero   g364(.O(z22));
  nor2   g365(.a(new_n158_), .b(new_n157_), .O(z15));
  nor2   g366(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g367(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g368(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g369(.a(new_n158_), .b(new_n157_), .O(z25));
  nor2   g370(.a(new_n158_), .b(new_n157_), .O(z26));
