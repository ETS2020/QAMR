...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x056), .O(z07));
  ...
  aoi21  g198(.a(new_n350_), .b(x056), .c(new_n354_), .O(new_n355_));
  ...
  aoi21  g207(.a(new_n363_), .b(new_n362_), .c(x056), .O(new_n364_));
  nor2   g208(.a(x112), .b(x104), .O(new_n365_));
  inv1   g209(.a(new_n365_), .O(new_n366_));
  oai21  g210(.a(new_n366_), .b(new_n364_), .c(new_n169_), .O(new_n367_));
  oai21  g211(.a(new_n363_), .b(x104), .c(x032), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(x112), .O(new_n369_));
  inv1   g213(.a(x104), .O(new_n370_));
  oai21  g214(.a(new_n362_), .b(x088), .c(new_n370_), .O(new_n371_));
  ...
  nand4  g219(.a(new_n375_), .b(new_n369_), .c(new_n367_), .d(new_n361_), .O(new_n376_));
  nor2   g220(.a(x032), .b(new_n162_), .O(new_n377_));
  nor2   g221(.a(new_n363_), .b(x088), .O(new_n378_));
  ...
  nand2  g228(.a(new_n384_), .b(new_n366_), .O(new_n385_));
  nand2  g229(.a(x024), .b(new_n168_), .O(new_n386_));
  aoi21  g230(.a(new_n386_), .b(new_n359_), .c(new_n169_), .O(new_n387_));
  nand2  g231(.a(new_n363_), .b(new_n362_), .O(new_n388_));
  nand4  g232(.a(new_n382_), .b(new_n388_), .c(new_n357_), .d(x024), .O(new_n389_));
  ...
  nand2  g236(.a(new_n357_), .b(x024), .O(new_n393_));
  ...
  aoi21  g245(.a(new_n381_), .b(x000), .c(new_n401_), .O(new_n402_));
  ...
  zero   g370(.O(z26));
  zero   g371(.O(z27));
  nor2   g372(.a(new_n157_), .b(x056), .O(z15));
  nor2   g373(.a(new_n157_), .b(x056), .O(z16));
  nor2   g374(.a(new_n157_), .b(x056), .O(z19));
  nor2   g375(.a(new_n157_), .b(x056), .O(z21));
  nor2   g376(.a(new_n157_), .b(x056), .O(z22));
endmodule
