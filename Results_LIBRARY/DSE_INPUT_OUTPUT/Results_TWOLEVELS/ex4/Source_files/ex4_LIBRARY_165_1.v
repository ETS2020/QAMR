...
module FAU ( 
  ...
  aoi21  g198(.a(new_n350_), .b(x055), .c(new_n354_), .O(new_n355_));
  ...
  nand3  g320(.a(new_n476_), .b(new_n159_), .c(new_n240_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  aoi21  g322(.a(new_n297_), .b(x014), .c(new_n299_), .O(new_n479_));
  ...
  nand4  g338(.a(x126), .b(new_n318_), .c(new_n298_), .d(x014), .O(new_n495_));
  inv1   g339(.a(new_n495_), .O(new_n496_));
  aoi21  g340(.a(new_n494_), .b(new_n157_), .c(new_n496_), .O(new_n497_));
  nand3  g341(.a(x086), .b(new_n298_), .c(new_n340_), .O(new_n498_));
  ...
  zero   g370(.O(z26));
  zero   g371(.O(z27));
  nor2   g372(.a(new_n157_), .b(x055), .O(z15));
  nor2   g373(.a(new_n157_), .b(x055), .O(z17));
  nor2   g374(.a(new_n157_), .b(x055), .O(z22));
  nor2   g375(.a(new_n157_), .b(x055), .O(z23));
  nor2   g376(.a(new_n157_), .b(x055), .O(z24));
endmodule
