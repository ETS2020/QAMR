...
module FAU ( 
  ...
  nand3  g266(.a(new_n422_), .b(new_n173_), .c(new_n416_), .O(new_n423_));
  ...
  oai22  g316(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n473_));
  inv1   g317(.a(x102), .O(new_n474_));
  aoi21  g318(.a(new_n316_), .b(new_n474_), .c(x094), .O(new_n475_));
  nand2  g319(.a(new_n307_), .b(new_n306_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(new_n475_), .c(new_n333_), .O(new_n477_));
  oai21  g321(.a(new_n316_), .b(x110), .c(x038), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(x118), .O(new_n479_));
  oai21  g323(.a(new_n474_), .b(x062), .c(new_n306_), .O(new_n480_));
  nand3  g324(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n324_), .O(new_n482_));
  aoi21  g326(.a(new_n480_), .b(new_n311_), .c(new_n482_), .O(new_n483_));
  nand4  g327(.a(new_n483_), .b(new_n479_), .c(new_n477_), .d(new_n473_), .O(new_n484_));
  nand4  g328(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n485_));
  inv1   g329(.a(new_n485_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n332_), .c(new_n486_), .O(new_n487_));
  nand3  g331(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n488_));
  oai21  g332(.a(new_n487_), .b(x054), .c(new_n488_), .O(new_n489_));
  aoi21  g333(.a(new_n302_), .b(x030), .c(x022), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(x078), .c(new_n299_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n476_), .O(new_n492_));
  nand2  g336(.a(x030), .b(new_n300_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n328_), .c(new_n333_), .O(new_n494_));
  nand2  g338(.a(new_n316_), .b(new_n474_), .O(new_n495_));
  ...
  oai21  g342(.a(new_n498_), .b(new_n494_), .c(new_n332_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n492_), .c(x054), .O(new_n500_));
  oai21  g344(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n328_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n332_), .c(x038), .O(new_n503_));
  inv1   g347(.a(new_n503_), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(new_n500_), .c(new_n324_), .O(new_n505_));
  ...
  oai21  g354(.a(new_n510_), .b(x046), .c(new_n173_), .O(z14));
  zero   g355(.O(z15));
  zero   g356(.O(z17));
  zero   g357(.O(z18));
  zero   g358(.O(z20));
  ...
  zero   g361(.O(z23));
  zero   g362(.O(z27));
  nor2   g363(.a(x126), .b(x080), .O(z16));
  nor2   g364(.a(x126), .b(x080), .O(z19));
  nor2   g365(.a(x126), .b(x080), .O(z24));
  nor2   g366(.a(x126), .b(x080), .O(z25));
  nor2   g367(.a(x126), .b(x080), .O(z26));
endmodule
