...
module FAU ( 
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x095), .O(new_n305_));
  ...
  oai21  g264(.a(new_n420_), .b(x042), .c(new_n175_), .O(z10));
  ...
  nand3  g320(.a(new_n476_), .b(new_n175_), .c(new_n241_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  nand3  g322(.a(x126), .b(new_n315_), .c(x006), .O(new_n479_));
  oai21  g323(.a(x086), .b(new_n335_), .c(new_n479_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n340_), .O(new_n481_));
  oai21  g325(.a(new_n335_), .b(x022), .c(new_n328_), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n321_), .c(x054), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(new_n481_), .c(x078), .O(new_n484_));
  inv1   g328(.a(x054), .O(new_n485_));
  nor2   g329(.a(x095), .b(new_n485_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n484_), .c(x038), .O(new_n487_));
  oai21  g331(.a(new_n331_), .b(new_n299_), .c(x006), .O(new_n488_));
  oai21  g332(.a(new_n302_), .b(new_n335_), .c(new_n300_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n321_), .O(new_n490_));
  aoi22  g334(.a(new_n490_), .b(new_n488_), .c(new_n314_), .d(new_n315_), .O(new_n491_));
  nand3  g335(.a(new_n321_), .b(x070), .c(x030), .O(new_n492_));
  nand3  g336(.a(x102), .b(new_n318_), .c(x006), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n492_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n299_), .O(new_n495_));
  nand2  g339(.a(x022), .b(x014), .O(new_n496_));
  aoi22  g340(.a(new_n496_), .b(x006), .c(new_n321_), .d(x070), .O(new_n497_));
  or2    g341(.a(new_n497_), .b(new_n328_), .O(new_n498_));
  nand4  g342(.a(new_n496_), .b(new_n301_), .c(new_n321_), .d(x030), .O(new_n499_));
  inv1   g343(.a(x094), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n331_), .c(x006), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n499_), .O(new_n502_));
  oai21  g346(.a(x126), .b(x102), .c(new_n502_), .O(new_n503_));
  nand2  g347(.a(x126), .b(new_n314_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n335_), .c(x022), .O(new_n505_));
  nand2  g349(.a(x030), .b(new_n340_), .O(new_n506_));
  nand3  g350(.a(x126), .b(x094), .c(new_n318_), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n506_), .c(new_n321_), .O(new_n508_));
  ...
  oai22  g355(.a(new_n321_), .b(new_n345_), .c(new_n331_), .d(new_n332_), .O(new_n512_));
  nor2   g356(.a(new_n331_), .b(x038), .O(new_n513_));
  aoi22  g357(.a(new_n513_), .b(x022), .c(new_n512_), .d(new_n340_), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n511_), .O(new_n515_));
  nand3  g359(.a(x070), .b(new_n485_), .c(x022), .O(new_n516_));
  nand3  g360(.a(x086), .b(new_n299_), .c(x006), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n516_), .c(new_n340_), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n173_), .c(x078), .O(new_n519_));
  inv1   g363(.a(new_n519_), .O(new_n520_));
  aoi21  g364(.a(new_n515_), .b(new_n172_), .c(new_n520_), .O(new_n521_));
