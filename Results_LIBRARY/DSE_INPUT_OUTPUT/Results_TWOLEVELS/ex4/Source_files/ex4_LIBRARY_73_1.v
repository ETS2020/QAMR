// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:22 2020
...
module FAU ( 
  ...
  oai21  g142(.a(new_n298_), .b(x014), .c(new_n172_), .O(new_n299_));
  ...
  nand3  g248(.a(new_n404_), .b(new_n174_), .c(new_n356_), .O(new_n405_));
  ...
  oai21  g257(.a(new_n413_), .b(x041), .c(new_n174_), .O(z09));
  ...
  nand3  g265(.a(new_n421_), .b(new_n174_), .c(new_n415_), .O(new_n422_));
  ...
  oai22  g285(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n442_));
  inv1   g286(.a(x101), .O(new_n443_));
  aoi21  g287(.a(new_n260_), .b(new_n443_), .c(x093), .O(new_n444_));
  nand2  g288(.a(new_n251_), .b(new_n250_), .O(new_n445_));
  oai21  g289(.a(new_n445_), .b(new_n444_), .c(new_n277_), .O(new_n446_));
  oai21  g290(.a(new_n260_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g292(.a(new_n443_), .b(x061), .c(new_n250_), .O(new_n449_));
  nand3  g293(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n268_), .O(new_n451_));
  aoi21  g295(.a(new_n449_), .b(new_n255_), .c(new_n451_), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n442_), .O(new_n453_));
  nand4  g297(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n276_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n457_));
  oai21  g301(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  aoi21  g302(.a(new_n246_), .b(x029), .c(x021), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(x077), .c(new_n243_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n445_), .O(new_n461_));
  nand2  g305(.a(x029), .b(new_n244_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n272_), .c(new_n277_), .O(new_n463_));
  nand2  g307(.a(new_n260_), .b(new_n443_), .O(new_n464_));
  ...
  oai21  g311(.a(new_n467_), .b(new_n463_), .c(new_n276_), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n461_), .c(x053), .O(new_n469_));
  oai21  g313(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n470_));
  ...
  oai21  g323(.a(new_n479_), .b(x045), .c(new_n174_), .O(z13));
  oai22  g324(.a(new_n340_), .b(x030), .c(new_n305_), .d(new_n304_), .O(new_n481_));
  inv1   g325(.a(x102), .O(new_n482_));
  aoi21  g326(.a(new_n321_), .b(new_n482_), .c(x094), .O(new_n483_));
  nand2  g327(.a(new_n312_), .b(new_n311_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n483_), .c(new_n337_), .O(new_n485_));
  oai21  g329(.a(new_n321_), .b(x110), .c(x038), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(x118), .O(new_n487_));
  oai21  g331(.a(new_n482_), .b(x062), .c(new_n311_), .O(new_n488_));
  nand3  g332(.a(x126), .b(new_n312_), .c(new_n305_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n329_), .O(new_n490_));
  aoi21  g334(.a(new_n488_), .b(new_n316_), .c(new_n490_), .O(new_n491_));
  nand4  g335(.a(new_n491_), .b(new_n487_), .c(new_n485_), .d(new_n481_), .O(new_n492_));
  nand4  g336(.a(x126), .b(new_n319_), .c(new_n316_), .d(x014), .O(new_n493_));
  inv1   g337(.a(new_n493_), .O(new_n494_));
  aoi21  g338(.a(new_n492_), .b(new_n297_), .c(new_n494_), .O(new_n495_));
  nand3  g339(.a(x086), .b(new_n316_), .c(new_n304_), .O(new_n496_));
  oai21  g340(.a(new_n495_), .b(x054), .c(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n307_), .b(x030), .c(x022), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(x078), .c(new_n304_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n484_), .O(new_n500_));
  nand2  g344(.a(x030), .b(new_n305_), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n333_), .c(new_n337_), .O(new_n502_));
  nand2  g346(.a(new_n321_), .b(new_n482_), .O(new_n503_));
  ...
  oai21  g350(.a(new_n506_), .b(new_n502_), .c(new_n297_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n500_), .c(x054), .O(new_n508_));
  oai21  g352(.a(new_n305_), .b(new_n304_), .c(x030), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n333_), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(new_n297_), .c(x038), .O(new_n511_));
  inv1   g355(.a(new_n511_), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(new_n508_), .c(new_n329_), .O(new_n513_));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(new_n172_), .b(x078), .O(z15));
  nor2   g369(.a(new_n172_), .b(x078), .O(z16));
  nor2   g370(.a(new_n172_), .b(x078), .O(z17));
  nor2   g371(.a(new_n172_), .b(x078), .O(z18));
  nor2   g372(.a(new_n172_), .b(x078), .O(z19));
  nor2   g373(.a(new_n172_), .b(x078), .O(z23));
  nor2   g374(.a(new_n172_), .b(x078), .O(z24));
  nor2   g375(.a(new_n172_), .b(x078), .O(z25));
endmodule
