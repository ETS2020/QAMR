// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:51 2020
...
module FAU ( 
  ...
  oai22  g041(.a(new_n197_), .b(new_n196_), .c(new_n157_), .d(new_n195_), .O(new_n198_));
  nand3  g042(.a(new_n198_), .b(new_n194_), .c(new_n193_), .O(new_n199_));
  inv1   g043(.a(x018), .O(new_n200_));
  inv1   g044(.a(x066), .O(new_n201_));
  oai22  g045(.a(new_n197_), .b(new_n157_), .c(new_n196_), .d(new_n195_), .O(new_n202_));
  nand3  g046(.a(new_n202_), .b(new_n201_), .c(new_n200_), .O(new_n203_));
  aoi22  g047(.a(new_n197_), .b(new_n195_), .c(new_n196_), .d(new_n157_), .O(new_n204_));
  ...
  nand2  g082(.a(new_n238_), .b(new_n160_), .O(z04));
  ...
  nand2  g166(.a(new_n322_), .b(new_n160_), .O(new_n323_));
  ...
  oai21  g172(.a(x102), .b(x034), .c(x126), .O(new_n329_));
  nand3  g173(.a(new_n329_), .b(new_n328_), .c(x086), .O(new_n330_));
  nand2  g174(.a(new_n157_), .b(new_n298_), .O(new_n331_));
  aoi21  g175(.a(new_n331_), .b(new_n330_), .c(x030), .O(new_n332_));
  nand3  g176(.a(new_n309_), .b(new_n157_), .c(new_n298_), .O(new_n333_));
  inv1   g177(.a(new_n333_), .O(new_n334_));
  oai21  g178(.a(new_n334_), .b(new_n332_), .c(x054), .O(new_n335_));
  inv1   g179(.a(x030), .O(new_n336_));
  nand2  g180(.a(new_n157_), .b(new_n336_), .O(new_n337_));
  nand2  g181(.a(x086), .b(new_n312_), .O(new_n338_));
  oai21  g182(.a(new_n338_), .b(new_n337_), .c(new_n335_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n325_), .O(new_n340_));
  nand2  g184(.a(x086), .b(new_n308_), .O(new_n341_));
  nand3  g185(.a(new_n158_), .b(x118), .c(new_n298_), .O(new_n342_));
  oai21  g186(.a(new_n341_), .b(new_n337_), .c(new_n342_), .O(new_n343_));
  nand2  g187(.a(new_n343_), .b(x022), .O(new_n344_));
  inv1   g188(.a(x102), .O(new_n345_));
  nand2  g189(.a(x094), .b(x070), .O(new_n346_));
  oai21  g190(.a(new_n326_), .b(new_n312_), .c(new_n346_), .O(new_n347_));
  ...
  nand4  g194(.a(new_n328_), .b(new_n305_), .c(x086), .d(new_n336_), .O(new_n351_));
  ...
  nand3  g200(.a(new_n356_), .b(new_n158_), .c(new_n298_), .O(new_n357_));
  ...
  nor4   g205(.a(new_n361_), .b(x126), .c(new_n326_), .d(new_n300_), .O(new_n362_));
  ...
  nand2  g217(.a(new_n373_), .b(new_n170_), .O(new_n374_));
  ...
  nand3  g225(.a(x120), .b(new_n381_), .c(new_n169_), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n162_), .O(new_n383_));
  aoi21  g227(.a(new_n380_), .b(new_n164_), .c(new_n383_), .O(new_n384_));
  nand4  g228(.a(new_n384_), .b(new_n377_), .c(new_n374_), .d(new_n370_), .O(new_n385_));
  nand4  g229(.a(x120), .b(new_n367_), .c(new_n164_), .d(x008), .O(new_n386_));
  inv1   g230(.a(new_n386_), .O(new_n387_));
  aoi21  g231(.a(new_n385_), .b(new_n166_), .c(new_n387_), .O(new_n388_));
  nand3  g232(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n389_));
  ...
  nand2  g237(.a(new_n393_), .b(new_n169_), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(new_n166_), .O(new_n395_));
  aoi21  g239(.a(new_n395_), .b(new_n163_), .c(new_n372_), .O(new_n396_));
  ...
  oai21  g246(.a(new_n402_), .b(new_n396_), .c(new_n165_), .O(new_n403_));
  nand2  g247(.a(new_n366_), .b(x024), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(new_n368_), .c(new_n367_), .O(new_n405_));
  nand3  g249(.a(new_n405_), .b(new_n166_), .c(x032), .O(new_n406_));
  ...
  aoi21  g255(.a(new_n407_), .b(new_n162_), .c(new_n411_), .O(new_n412_));
  nand2  g256(.a(new_n412_), .b(new_n391_), .O(new_n413_));
  nand3  g257(.a(new_n413_), .b(new_n160_), .c(new_n365_), .O(new_n414_));
  ...
  oai21  g266(.a(new_n422_), .b(x041), .c(new_n160_), .O(z09));
  nand3  g267(.a(new_n160_), .b(x074), .c(x010), .O(new_n424_));
  nand3  g268(.a(x082), .b(new_n157_), .c(x002), .O(new_n425_));
  nand4  g269(.a(new_n158_), .b(x066), .c(new_n196_), .d(x018), .O(new_n426_));
  aoi21  g270(.a(new_n426_), .b(new_n425_), .c(x010), .O(new_n427_));
  oai21  g271(.a(x126), .b(x074), .c(x034), .O(new_n428_));
  nand3  g272(.a(new_n428_), .b(x082), .c(x002), .O(new_n429_));
  nand3  g273(.a(x066), .b(new_n157_), .c(x018), .O(new_n430_));
  aoi21  g274(.a(new_n430_), .b(new_n429_), .c(x050), .O(new_n431_));
  nand3  g275(.a(new_n158_), .b(x050), .c(x034), .O(new_n432_));
  nand4  g276(.a(new_n197_), .b(x066), .c(new_n157_), .d(x018), .O(new_n433_));
  nand2  g277(.a(new_n433_), .b(new_n432_), .O(new_n434_));
  nor3   g278(.a(new_n434_), .b(new_n431_), .c(new_n427_), .O(new_n435_));
  aoi21  g279(.a(new_n435_), .b(new_n424_), .c(x042), .O(z10));
  ...
  nand3  g287(.a(new_n443_), .b(new_n160_), .c(new_n437_), .O(new_n444_));
  ...
  oai21  g296(.a(new_n452_), .b(x044), .c(new_n160_), .O(z12));
  oai22  g297(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n454_));
  inv1   g298(.a(x101), .O(new_n455_));
  aoi21  g299(.a(new_n260_), .b(new_n455_), .c(x093), .O(new_n456_));
  nand2  g300(.a(new_n251_), .b(new_n250_), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(new_n456_), .c(new_n277_), .O(new_n458_));
  oai21  g302(.a(new_n260_), .b(x109), .c(x037), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(x117), .O(new_n460_));
  oai21  g304(.a(new_n455_), .b(x061), .c(new_n250_), .O(new_n461_));
  nand3  g305(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n268_), .O(new_n463_));
  aoi21  g307(.a(new_n461_), .b(new_n255_), .c(new_n463_), .O(new_n464_));
  nand4  g308(.a(new_n464_), .b(new_n460_), .c(new_n458_), .d(new_n454_), .O(new_n465_));
  nand4  g309(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n466_));
  inv1   g310(.a(new_n466_), .O(new_n467_));
  aoi21  g311(.a(new_n465_), .b(new_n276_), .c(new_n467_), .O(new_n468_));
  nand3  g312(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n469_));
  oai21  g313(.a(new_n468_), .b(x053), .c(new_n469_), .O(new_n470_));
  aoi21  g314(.a(new_n246_), .b(x029), .c(x021), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(x077), .c(new_n243_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n457_), .O(new_n473_));
  nand2  g317(.a(x029), .b(new_n244_), .O(new_n474_));
  aoi21  g318(.a(new_n474_), .b(new_n272_), .c(new_n277_), .O(new_n475_));
  nand2  g319(.a(new_n260_), .b(new_n455_), .O(new_n476_));
  aoi22  g320(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n476_), .c(x029), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n475_), .c(new_n276_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n473_), .c(x053), .O(new_n481_));
  oai21  g325(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n272_), .O(new_n483_));
  nand3  g327(.a(new_n483_), .b(new_n276_), .c(x037), .O(new_n484_));
  inv1   g328(.a(new_n484_), .O(new_n485_));
  oai21  g329(.a(new_n485_), .b(new_n481_), .c(new_n268_), .O(new_n486_));
  oai22  g330(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n487_));
  nand3  g331(.a(new_n487_), .b(x069), .c(x021), .O(new_n488_));
  aoi22  g332(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n489_));
  nand3  g333(.a(new_n489_), .b(new_n488_), .c(new_n486_), .O(new_n490_));
  aoi21  g334(.a(new_n470_), .b(x005), .c(new_n490_), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(x045), .c(new_n160_), .O(z13));
  oai22  g336(.a(new_n328_), .b(x030), .c(new_n316_), .d(new_n324_), .O(new_n493_));
  aoi21  g337(.a(new_n158_), .b(new_n345_), .c(x094), .O(new_n494_));
  inv1   g338(.a(x110), .O(new_n495_));
  nand2  g339(.a(new_n354_), .b(new_n495_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n494_), .c(new_n308_), .O(new_n497_));
  oai21  g341(.a(new_n158_), .b(x110), .c(x038), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(x118), .O(new_n499_));
  oai21  g343(.a(new_n345_), .b(x062), .c(new_n495_), .O(new_n500_));
  nand3  g344(.a(x126), .b(new_n354_), .c(new_n316_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n299_), .O(new_n502_));
  aoi21  g346(.a(new_n500_), .b(new_n312_), .c(new_n502_), .O(new_n503_));
  nand4  g347(.a(new_n503_), .b(new_n499_), .c(new_n497_), .d(new_n493_), .O(new_n504_));
  nand4  g348(.a(x126), .b(new_n326_), .c(new_n312_), .d(x014), .O(new_n505_));
  inv1   g349(.a(new_n505_), .O(new_n506_));
  aoi21  g350(.a(new_n504_), .b(new_n301_), .c(new_n506_), .O(new_n507_));
  oai22  g351(.a(new_n507_), .b(x054), .c(new_n338_), .d(x014), .O(new_n508_));
  aoi21  g352(.a(new_n309_), .b(x030), .c(x022), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(x078), .c(new_n324_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n496_), .O(new_n511_));
  nor2   g355(.a(x094), .b(x062), .O(new_n512_));
  nand2  g356(.a(x030), .b(new_n316_), .O(new_n513_));
  aoi21  g357(.a(new_n513_), .b(new_n512_), .c(new_n308_), .O(new_n514_));
  nand2  g358(.a(new_n158_), .b(new_n345_), .O(new_n515_));
  ...
  oai21  g362(.a(new_n518_), .b(new_n514_), .c(new_n301_), .O(new_n519_));
  aoi21  g363(.a(new_n519_), .b(new_n511_), .c(x054), .O(new_n520_));
  oai21  g364(.a(new_n316_), .b(new_n324_), .c(x030), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n512_), .O(new_n522_));
  nand3  g366(.a(new_n522_), .b(new_n301_), .c(x038), .O(new_n523_));
  ...
  zero   g379(.O(z25));
  zero   g380(.O(z27));
  nor2   g381(.a(new_n158_), .b(new_n157_), .O(z15));
  nor2   g382(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g383(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g384(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g385(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g386(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g387(.a(new_n158_), .b(new_n157_), .O(z26));
endmodule
