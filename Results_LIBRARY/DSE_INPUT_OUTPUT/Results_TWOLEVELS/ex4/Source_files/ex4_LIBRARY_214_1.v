...
module FAU ( 
  ...
  oai21  g270(.a(new_n426_), .b(x044), .c(new_n174_), .O(z12));
  ...
  oai21  g311(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n468_));
  nand2  g312(.a(new_n301_), .b(x030), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n299_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n312_), .O(new_n471_));
  aoi22  g315(.a(new_n471_), .b(new_n468_), .c(new_n467_), .d(new_n314_), .O(new_n472_));
  nand3  g316(.a(new_n312_), .b(x070), .c(x030), .O(new_n473_));
  nand3  g317(.a(x102), .b(new_n305_), .c(x006), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n473_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n304_), .O(new_n476_));
  nand2  g320(.a(new_n325_), .b(x006), .O(new_n477_));
  oai21  g321(.a(x086), .b(new_n306_), .c(new_n477_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n329_), .O(new_n479_));
  nand4  g323(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n480_));
  nand3  g324(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n480_), .O(new_n482_));
  oai21  g326(.a(x126), .b(x102), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(x126), .b(new_n467_), .O(new_n484_));
  aoi21  g328(.a(new_n484_), .b(new_n298_), .c(x022), .O(new_n485_));
  nand2  g329(.a(x030), .b(new_n343_), .O(new_n486_));
  nand3  g330(.a(x126), .b(x094), .c(new_n305_), .O(new_n487_));
  nand3  g331(.a(new_n487_), .b(new_n486_), .c(new_n312_), .O(new_n488_));
  oai21  g332(.a(new_n488_), .b(new_n485_), .c(x006), .O(new_n489_));
  nand4  g333(.a(new_n489_), .b(new_n483_), .c(new_n479_), .d(new_n476_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n472_), .c(new_n340_), .O(new_n491_));
  nand3  g335(.a(x126), .b(new_n314_), .c(x038), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n312_), .c(new_n297_), .O(new_n493_));
  nand3  g337(.a(new_n312_), .b(x038), .c(x030), .O(new_n494_));
  oai21  g338(.a(new_n306_), .b(new_n336_), .c(new_n494_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n493_), .c(new_n343_), .O(new_n496_));
  nand2  g340(.a(x030), .b(new_n336_), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n323_), .c(x086), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(x054), .c(x038), .O(new_n499_));
  nor2   g343(.a(new_n306_), .b(x038), .O(new_n500_));
  aoi21  g344(.a(new_n500_), .b(x022), .c(x078), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n499_), .c(new_n496_), .O(new_n502_));
  inv1   g346(.a(new_n502_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n491_), .c(x046), .O(z14));
  zero   g348(.O(z21));
  zero   g349(.O(z23));
  zero   g350(.O(z24));
  zero   g351(.O(z26));
  zero   g352(.O(z27));
  nor2   g353(.a(new_n172_), .b(x046), .O(z15));
  nor2   g354(.a(new_n172_), .b(x046), .O(z16));
  nor2   g355(.a(new_n172_), .b(x046), .O(z17));
  nor2   g356(.a(new_n172_), .b(x046), .O(z18));
  nor2   g357(.a(new_n172_), .b(x046), .O(z19));
  nor2   g358(.a(new_n172_), .b(x046), .O(z20));
  nor2   g359(.a(new_n172_), .b(x046), .O(z22));
  nor2   g360(.a(new_n172_), .b(x046), .O(z25));
endmodule
