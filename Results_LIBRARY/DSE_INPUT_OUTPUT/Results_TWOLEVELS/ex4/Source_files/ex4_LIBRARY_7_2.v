...
module FAU ( 
  ...
  oai21  g320(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n478_));
  nand2  g321(.a(new_n318_), .b(new_n314_), .O(new_n479_));
  oai22  g322(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  oai22  g324(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n482_));
  nand2  g325(.a(x118), .b(new_n298_), .O(new_n483_));
  ...
  nand3  g329(.a(new_n486_), .b(new_n297_), .c(new_n340_), .O(new_n487_));
  nand4  g330(.a(x086), .b(new_n157_), .c(new_n300_), .d(new_n319_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n487_), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(x006), .O(new_n490_));
  nor2   g333(.a(new_n331_), .b(new_n304_), .O(new_n491_));
  oai22  g334(.a(new_n491_), .b(new_n321_), .c(x118), .d(x110), .O(new_n492_));
  nor2   g335(.a(x038), .b(new_n304_), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(new_n307_), .c(x070), .O(new_n494_));
  nand4  g337(.a(new_n479_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(new_n494_), .c(new_n492_), .O(new_n496_));
  aoi21  g339(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n497_));
  nor2   g340(.a(new_n497_), .b(new_n300_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n340_), .c(new_n498_), .O(new_n499_));
  nor2   g342(.a(new_n301_), .b(x038), .O(new_n500_));
  ...
  nand4  g347(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n505_));
  nand2  g348(.a(x078), .b(x014), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n505_), .c(new_n504_), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n157_), .O(new_n508_));
  ...
  zero   g360(.O(z25));
  zero   g361(.O(z27));
  nor2   g362(.a(x078), .b(new_n157_), .O(z21));
  nor2   g363(.a(x078), .b(new_n157_), .O(z23));
  nor2   g364(.a(x078), .b(new_n157_), .O(z26));
endmodule
