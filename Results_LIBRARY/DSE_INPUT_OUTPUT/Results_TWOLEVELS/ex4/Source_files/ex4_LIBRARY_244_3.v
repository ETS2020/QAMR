...
module FAU ( 
  ...
  aoi21  g325(.a(new_n297_), .b(x014), .c(x106), .O(new_n482_));
  ...
  nand4  g341(.a(x126), .b(new_n317_), .c(new_n298_), .d(x014), .O(new_n498_));
  inv1   g342(.a(new_n498_), .O(new_n499_));
  aoi21  g343(.a(new_n497_), .b(new_n157_), .c(new_n499_), .O(new_n500_));
  nand3  g344(.a(x086), .b(new_n298_), .c(new_n339_), .O(new_n501_));
  ...
  nand2  g349(.a(new_n298_), .b(x030), .O(new_n506_));
