...
module FAU ( 
  ...
  nand3  g195(.a(new_n351_), .b(new_n159_), .c(x046), .O(new_n352_));
  ...
  oai22  g320(.a(new_n337_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n477_));
  ...
  oai21  g324(.a(new_n480_), .b(new_n479_), .c(new_n334_), .O(new_n481_));
  ...
  aoi21  g334(.a(new_n488_), .b(new_n333_), .c(new_n490_), .O(new_n491_));
  ...
  aoi21  g341(.a(new_n497_), .b(new_n329_), .c(new_n334_), .O(new_n498_));
  ...
  oai21  g346(.a(new_n502_), .b(new_n498_), .c(new_n333_), .O(new_n503_));
  ...
  nand3  g350(.a(new_n506_), .b(new_n333_), .c(x038), .O(new_n507_));
  ...
  oai21  g358(.a(new_n514_), .b(x046), .c(new_n159_), .O(z14));
  zero   g359(.O(z16));
  zero   g360(.O(z17));
  zero   g361(.O(z19));
  zero   g362(.O(z24));
  zero   g363(.O(z27));
  nor2   g364(.a(new_n157_), .b(x058), .O(z15));
  nor2   g365(.a(new_n157_), .b(x058), .O(z18));
  nor2   g366(.a(new_n157_), .b(x058), .O(z20));
  nor2   g367(.a(new_n157_), .b(x058), .O(z21));
  nor2   g368(.a(new_n157_), .b(x058), .O(z22));
  nor2   g369(.a(new_n157_), .b(x058), .O(z23));
  nor2   g370(.a(new_n157_), .b(x058), .O(z25));
  nor2   g371(.a(new_n157_), .b(x058), .O(z26));
endmodule
