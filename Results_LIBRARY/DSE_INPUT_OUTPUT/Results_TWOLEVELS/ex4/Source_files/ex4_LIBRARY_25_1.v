...
module FAU ( 
  ...
  aoi21  g319(.a(x070), .b(x038), .c(new_n298_), .O(new_n476_));
  nand2  g320(.a(new_n304_), .b(x030), .O(new_n477_));
  aoi21  g321(.a(new_n477_), .b(new_n341_), .c(x086), .O(new_n478_));
  oai22  g322(.a(new_n478_), .b(new_n476_), .c(x118), .d(x110), .O(new_n479_));
  nand3  g323(.a(new_n326_), .b(x070), .c(x030), .O(new_n480_));
  nand3  g324(.a(x102), .b(new_n316_), .c(x006), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n480_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n313_), .O(new_n483_));
  nand2  g327(.a(x022), .b(x014), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(x006), .O(new_n485_));
  oai21  g329(.a(x086), .b(new_n334_), .c(new_n485_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n337_), .O(new_n487_));
  nor2   g331(.a(x126), .b(x102), .O(new_n488_));
  nand4  g332(.a(new_n484_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n489_));
  inv1   g333(.a(x094), .O(new_n490_));
  nand3  g334(.a(new_n490_), .b(new_n334_), .c(x006), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n489_), .c(new_n488_), .O(new_n492_));
  oai21  g336(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(new_n302_), .O(new_n494_));
  oai22  g338(.a(new_n309_), .b(x110), .c(new_n490_), .d(x062), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(x126), .O(new_n496_));
  aoi21  g340(.a(x030), .b(new_n299_), .c(x086), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n496_), .c(new_n494_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(x006), .c(new_n492_), .O(new_n499_));
  nand4  g343(.a(new_n499_), .b(new_n487_), .c(new_n483_), .d(new_n479_), .O(new_n500_));
  nand2  g344(.a(x038), .b(x014), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(x070), .c(x022), .O(new_n502_));
  oai22  g346(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n299_), .O(new_n504_));
  nand2  g348(.a(x030), .b(new_n302_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n330_), .c(x086), .O(new_n506_));
  oai21  g350(.a(new_n506_), .b(x054), .c(x038), .O(new_n507_));
  nand4  g351(.a(new_n507_), .b(new_n504_), .c(new_n502_), .d(new_n157_), .O(new_n508_));
  aoi21  g352(.a(new_n500_), .b(new_n300_), .c(new_n508_), .O(new_n509_));
  nor2   g353(.a(new_n509_), .b(x046), .O(z14));
  zero   g354(.O(z16));
  zero   g355(.O(z17));
  zero   g356(.O(z18));
  zero   g357(.O(z19));
