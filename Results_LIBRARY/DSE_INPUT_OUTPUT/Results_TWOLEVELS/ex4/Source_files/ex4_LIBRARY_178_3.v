// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:18 2020
...
module FAU ( 
  ...
  oai21  g157(.a(new_n169_), .b(new_n163_), .c(new_n313_), .O(new_n314_));
  ...
  oai21  g164(.a(new_n320_), .b(new_n317_), .c(new_n170_), .O(new_n321_));
  ...
  nand3  g168(.a(x120), .b(new_n319_), .c(new_n169_), .O(new_n325_));
  nand2  g169(.a(new_n325_), .b(new_n162_), .O(new_n326_));
  aoi21  g170(.a(new_n324_), .b(new_n164_), .c(new_n326_), .O(new_n327_));
  nand4  g171(.a(new_n327_), .b(new_n323_), .c(new_n321_), .d(new_n314_), .O(new_n328_));
  nor2   g172(.a(x032), .b(new_n163_), .O(new_n329_));
  nor2   g173(.a(new_n316_), .b(x056), .O(new_n330_));
  aoi22  g174(.a(new_n330_), .b(new_n329_), .c(new_n328_), .d(new_n166_), .O(new_n331_));
  nand3  g175(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n332_));
  ...
  oai21  g179(.a(new_n335_), .b(x072), .c(new_n163_), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(new_n320_), .O(new_n337_));
  nand2  g181(.a(x024), .b(new_n169_), .O(new_n338_));
  aoi21  g182(.a(new_n338_), .b(new_n312_), .c(new_n170_), .O(new_n339_));
  ...
  oai21  g187(.a(new_n343_), .b(new_n339_), .c(new_n166_), .O(new_n344_));
  aoi21  g188(.a(new_n344_), .b(new_n337_), .c(x048), .O(new_n345_));
  oai21  g189(.a(new_n169_), .b(new_n163_), .c(x024), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n312_), .O(new_n347_));
  nand3  g191(.a(new_n347_), .b(new_n166_), .c(x032), .O(new_n348_));
  inv1   g192(.a(new_n348_), .O(new_n349_));
  oai21  g193(.a(new_n349_), .b(new_n345_), .c(new_n162_), .O(new_n350_));
  ...
  oai21  g199(.a(new_n355_), .b(x040), .c(new_n160_), .O(z08));
  ...
  oai21  g207(.a(new_n363_), .b(x041), .c(new_n160_), .O(z09));
  ...
  oai21  g215(.a(new_n371_), .b(x042), .c(new_n160_), .O(z10));
  oai22  g216(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n373_));
  nand3  g217(.a(new_n373_), .b(x083), .c(x003), .O(new_n374_));
  oai22  g218(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n375_));
  nand3  g219(.a(new_n375_), .b(x067), .c(x019), .O(new_n376_));
  aoi22  g220(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n377_));
  nand3  g221(.a(new_n377_), .b(new_n376_), .c(new_n374_), .O(new_n378_));
  inv1   g222(.a(new_n378_), .O(new_n379_));
  oai21  g223(.a(new_n379_), .b(x043), .c(new_n160_), .O(z11));
  ...
  oai21  g231(.a(new_n387_), .b(x044), .c(new_n160_), .O(z12));
  inv1   g232(.a(x045), .O(new_n389_));
  nand2  g233(.a(x021), .b(x013), .O(new_n390_));
  oai21  g234(.a(new_n281_), .b(x029), .c(new_n390_), .O(new_n391_));
  nor2   g235(.a(x125), .b(x101), .O(new_n392_));
  nor2   g236(.a(x117), .b(x109), .O(new_n393_));
  oai21  g237(.a(new_n392_), .b(x093), .c(new_n393_), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(new_n278_), .O(new_n395_));
  oai21  g239(.a(new_n261_), .b(x109), .c(x037), .O(new_n396_));
  nand2  g240(.a(new_n396_), .b(x117), .O(new_n397_));
  inv1   g241(.a(x101), .O(new_n398_));
  oai21  g242(.a(new_n398_), .b(x061), .c(new_n251_), .O(new_n399_));
  nand3  g243(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(new_n269_), .O(new_n401_));
  aoi21  g245(.a(new_n399_), .b(new_n256_), .c(new_n401_), .O(new_n402_));
  nand4  g246(.a(new_n402_), .b(new_n397_), .c(new_n395_), .d(new_n391_), .O(new_n403_));
  nand4  g247(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n404_));
  inv1   g248(.a(new_n404_), .O(new_n405_));
  aoi21  g249(.a(new_n403_), .b(new_n277_), .c(new_n405_), .O(new_n406_));
  nand3  g250(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n407_));
  oai21  g251(.a(new_n406_), .b(x053), .c(new_n407_), .O(new_n408_));
  nand2  g252(.a(new_n408_), .b(x005), .O(new_n409_));
  nand2  g253(.a(new_n247_), .b(x029), .O(new_n410_));
  nand2  g254(.a(new_n410_), .b(new_n245_), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(new_n277_), .O(new_n412_));
  aoi21  g256(.a(new_n412_), .b(new_n244_), .c(new_n393_), .O(new_n413_));
  nor2   g257(.a(new_n243_), .b(x021), .O(new_n414_));
  oai21  g258(.a(new_n414_), .b(new_n281_), .c(x069), .O(new_n415_));
  inv1   g259(.a(new_n392_), .O(new_n416_));
  nand4  g260(.a(new_n416_), .b(new_n390_), .c(new_n247_), .d(x029), .O(new_n417_));
  aoi21  g261(.a(new_n417_), .b(new_n415_), .c(x077), .O(new_n418_));
  oai21  g262(.a(new_n418_), .b(new_n413_), .c(new_n242_), .O(new_n419_));
  nand2  g263(.a(new_n390_), .b(x029), .O(new_n420_));
  nand2  g264(.a(new_n420_), .b(new_n273_), .O(new_n421_));
  nand3  g265(.a(new_n421_), .b(new_n277_), .c(x037), .O(new_n422_));
  nand2  g266(.a(new_n422_), .b(new_n419_), .O(new_n423_));
  oai22  g267(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(x069), .c(x021), .O(new_n425_));
  aoi22  g269(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n426_));
  nand2  g270(.a(new_n426_), .b(new_n425_), .O(new_n427_));
  aoi21  g271(.a(new_n423_), .b(new_n269_), .c(new_n427_), .O(new_n428_));
  nand2  g272(.a(new_n428_), .b(new_n409_), .O(new_n429_));
  nand3  g273(.a(new_n429_), .b(new_n160_), .c(new_n389_), .O(new_n430_));
  inv1   g274(.a(new_n430_), .O(z13));
  oai21  g275(.a(x046), .b(x014), .c(x078), .O(new_n432_));
  inv1   g276(.a(x030), .O(new_n433_));
  nor2   g277(.a(x094), .b(x062), .O(new_n434_));
  nand2  g278(.a(new_n434_), .b(new_n433_), .O(new_n435_));
  oai21  g279(.a(new_n302_), .b(new_n298_), .c(new_n435_), .O(new_n436_));
  inv1   g280(.a(x102), .O(new_n437_));
  inv1   g281(.a(x126), .O(new_n438_));
  aoi21  g282(.a(new_n438_), .b(new_n437_), .c(x094), .O(new_n439_));
  inv1   g283(.a(x110), .O(new_n440_));
  inv1   g284(.a(x118), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(new_n440_), .O(new_n442_));
  oai21  g286(.a(new_n442_), .b(new_n439_), .c(new_n303_), .O(new_n443_));
  oai21  g287(.a(new_n438_), .b(x110), .c(x038), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x118), .O(new_n445_));
  oai21  g289(.a(new_n437_), .b(x062), .c(new_n440_), .O(new_n446_));
  nand3  g290(.a(x126), .b(new_n441_), .c(new_n302_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n306_), .O(new_n448_));
  aoi21  g292(.a(new_n446_), .b(new_n299_), .c(new_n448_), .O(new_n449_));
  nand4  g293(.a(new_n449_), .b(new_n445_), .c(new_n443_), .d(new_n436_), .O(new_n450_));
  nor2   g294(.a(x038), .b(new_n298_), .O(new_n451_));
  nor2   g295(.a(new_n438_), .b(x062), .O(new_n452_));
  aoi22  g296(.a(new_n452_), .b(new_n451_), .c(new_n450_), .d(new_n158_), .O(new_n453_));
  nand3  g297(.a(x086), .b(new_n299_), .c(new_n298_), .O(new_n454_));
  oai21  g298(.a(new_n453_), .b(x054), .c(new_n454_), .O(new_n455_));
  nand2  g299(.a(x094), .b(x062), .O(new_n456_));
  aoi21  g300(.a(new_n456_), .b(x030), .c(x022), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(x078), .c(new_n298_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n442_), .O(new_n459_));
  nand2  g303(.a(new_n299_), .b(x030), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n434_), .c(new_n303_), .O(new_n461_));
  nand2  g305(.a(new_n438_), .b(new_n437_), .O(new_n462_));
  aoi22  g306(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n463_));
  nand3  g307(.a(new_n463_), .b(new_n462_), .c(x030), .O(new_n464_));
  inv1   g308(.a(new_n464_), .O(new_n465_));
  oai21  g309(.a(new_n465_), .b(new_n461_), .c(new_n158_), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n459_), .c(x054), .O(new_n467_));
  oai21  g311(.a(new_n302_), .b(new_n298_), .c(x030), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n434_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n158_), .c(x038), .O(new_n470_));
  inv1   g314(.a(new_n470_), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(new_n467_), .c(new_n306_), .O(new_n472_));
  oai22  g316(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(x070), .c(x022), .O(new_n474_));
  nand2  g318(.a(x054), .b(x038), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(new_n474_), .c(new_n472_), .O(new_n476_));
  aoi21  g320(.a(new_n455_), .b(x006), .c(new_n476_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(x046), .c(new_n432_), .O(z14));
  zero   g322(.O(z15));
  zero   g323(.O(z16));
  zero   g324(.O(z17));
  zero   g325(.O(z19));
  ...
  zero   g328(.O(z24));
  zero   g329(.O(z25));
  nor2   g330(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g331(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g332(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g333(.a(new_n158_), .b(new_n157_), .O(z26));
