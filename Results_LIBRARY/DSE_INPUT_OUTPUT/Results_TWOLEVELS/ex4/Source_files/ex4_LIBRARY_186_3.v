// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:33 2020
...
module FAU ( 
  ...
  nand3  g161(.a(new_n173_), .b(x118), .c(x022), .O(new_n318_));
  nand2  g162(.a(new_n318_), .b(x086), .O(new_n319_));
  aoi21  g163(.a(new_n317_), .b(x038), .c(new_n319_), .O(new_n320_));
  nand4  g164(.a(new_n320_), .b(new_n315_), .c(new_n312_), .d(new_n305_), .O(new_n321_));
  nand4  g165(.a(new_n173_), .b(x062), .c(x038), .d(new_n301_), .O(new_n322_));
  ...
  oai21  g170(.a(new_n324_), .b(new_n299_), .c(new_n326_), .O(new_n327_));
  nand2  g171(.a(new_n327_), .b(new_n298_), .O(new_n328_));
  ...
  aoi21  g175(.a(new_n331_), .b(x014), .c(new_n310_), .O(new_n332_));
  ...
  oai22  g189(.a(new_n333_), .b(new_n313_), .c(new_n299_), .d(new_n301_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n334_), .c(new_n302_), .O(new_n347_));
  aoi22  g191(.a(new_n333_), .b(new_n301_), .c(new_n299_), .d(new_n313_), .O(new_n348_));
  ...
  nand2  g196(.a(new_n352_), .b(new_n175_), .O(z06));
  nand2  g197(.a(new_n160_), .b(new_n159_), .O(new_n354_));
  oai21  g198(.a(x072), .b(x048), .c(new_n354_), .O(new_n355_));
  nand3  g199(.a(new_n355_), .b(x080), .c(x000), .O(new_n356_));
  inv1   g200(.a(x104), .O(new_n357_));
  inv1   g201(.a(x112), .O(new_n358_));
  nand2  g202(.a(new_n358_), .b(new_n357_), .O(new_n359_));
  oai21  g203(.a(x072), .b(new_n165_), .c(new_n159_), .O(new_n360_));
  ...
  nand3  g208(.a(new_n364_), .b(new_n162_), .c(x064), .O(new_n365_));
  aoi21  g209(.a(new_n365_), .b(new_n361_), .c(x048), .O(new_n366_));
  nand2  g210(.a(new_n364_), .b(new_n162_), .O(new_n367_));
  nor2   g211(.a(new_n367_), .b(new_n160_), .O(new_n368_));
  oai21  g212(.a(new_n368_), .b(new_n366_), .c(new_n158_), .O(new_n369_));
  oai22  g213(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n370_));
  nand3  g214(.a(new_n370_), .b(x064), .c(x016), .O(new_n371_));
  aoi22  g215(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n372_));
  nand4  g216(.a(new_n372_), .b(new_n371_), .c(new_n369_), .d(new_n356_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n175_), .O(new_n374_));
  nor2   g218(.a(new_n165_), .b(new_n159_), .O(new_n375_));
  inv1   g219(.a(x024), .O(new_n376_));
  nand2  g220(.a(new_n172_), .b(x096), .O(new_n377_));
  nand2  g221(.a(new_n173_), .b(x120), .O(new_n378_));
  nand2  g222(.a(x088), .b(x056), .O(new_n379_));
  inv1   g223(.a(new_n379_), .O(new_n380_));
  aoi21  g224(.a(new_n378_), .b(new_n377_), .c(new_n380_), .O(new_n381_));
  nor2   g225(.a(x120), .b(new_n157_), .O(new_n382_));
  aoi21  g226(.a(new_n381_), .b(new_n158_), .c(new_n382_), .O(new_n383_));
  nand3  g227(.a(new_n364_), .b(new_n172_), .c(x000), .O(new_n384_));
  oai21  g228(.a(new_n383_), .b(new_n376_), .c(new_n384_), .O(new_n385_));
  nand4  g229(.a(new_n172_), .b(new_n158_), .c(x032), .d(x024), .O(new_n386_));
  inv1   g230(.a(new_n386_), .O(new_n387_));
  aoi21  g231(.a(new_n385_), .b(new_n161_), .c(new_n387_), .O(new_n388_));
  nand4  g232(.a(new_n172_), .b(new_n158_), .c(x064), .d(x024), .O(new_n389_));
  nand2  g233(.a(new_n358_), .b(x000), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(new_n378_), .c(new_n389_), .O(new_n391_));
  nand2  g235(.a(new_n391_), .b(new_n165_), .O(new_n392_));
  oai22  g236(.a(x088), .b(x064), .c(x056), .d(x032), .O(new_n393_));
  nand2  g237(.a(new_n393_), .b(x096), .O(new_n394_));
  nand2  g238(.a(x064), .b(x032), .O(new_n395_));
  nand2  g239(.a(new_n395_), .b(new_n359_), .O(new_n396_));
  aoi21  g240(.a(new_n396_), .b(new_n394_), .c(new_n157_), .O(new_n397_));
  nand4  g241(.a(new_n379_), .b(new_n359_), .c(new_n158_), .d(x024), .O(new_n398_));
  inv1   g242(.a(new_n398_), .O(new_n399_));
  oai21  g243(.a(new_n399_), .b(new_n397_), .c(new_n172_), .O(new_n400_));
  nand2  g244(.a(new_n363_), .b(new_n166_), .O(new_n401_));
  nand2  g245(.a(x112), .b(new_n357_), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(new_n401_), .c(new_n354_), .O(new_n403_));
  nand4  g247(.a(new_n403_), .b(new_n173_), .c(x120), .d(x000), .O(new_n404_));
  nand3  g248(.a(new_n404_), .b(new_n400_), .c(new_n392_), .O(new_n405_));
  nand2  g249(.a(new_n405_), .b(new_n161_), .O(new_n406_));
  oai21  g250(.a(new_n388_), .b(new_n375_), .c(new_n406_), .O(new_n407_));
  nand3  g251(.a(new_n160_), .b(x008), .c(x000), .O(new_n408_));
  nor4   g252(.a(new_n408_), .b(new_n378_), .c(x056), .d(x048), .O(new_n409_));
  aoi21  g253(.a(new_n407_), .b(new_n162_), .c(new_n409_), .O(new_n410_));
  aoi21  g254(.a(new_n410_), .b(new_n374_), .c(x040), .O(z08));
  ...
  oai21  g262(.a(new_n418_), .b(x041), .c(new_n175_), .O(z09));
  oai22  g263(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n420_));
  nand3  g264(.a(new_n420_), .b(x082), .c(x002), .O(new_n421_));
  oai22  g265(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n422_));
  nand3  g266(.a(new_n422_), .b(x066), .c(x018), .O(new_n423_));
  aoi22  g267(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(new_n423_), .c(new_n421_), .O(new_n425_));
  inv1   g269(.a(new_n425_), .O(new_n426_));
  oai21  g270(.a(new_n426_), .b(x042), .c(new_n175_), .O(z10));
  ...
  oai21  g278(.a(new_n434_), .b(x043), .c(new_n175_), .O(z11));
  ...
  nand3  g286(.a(new_n442_), .b(new_n175_), .c(new_n436_), .O(new_n443_));
  inv1   g287(.a(new_n443_), .O(z12));
  inv1   g288(.a(x045), .O(new_n445_));
  nand2  g289(.a(x021), .b(x013), .O(new_n446_));
  oai21  g290(.a(new_n281_), .b(x029), .c(new_n446_), .O(new_n447_));
  nor2   g291(.a(x125), .b(x101), .O(new_n448_));
  nor2   g292(.a(x117), .b(x109), .O(new_n449_));
  oai21  g293(.a(new_n448_), .b(x093), .c(new_n449_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n278_), .O(new_n451_));
  oai21  g295(.a(new_n261_), .b(x109), .c(x037), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(x117), .O(new_n453_));
  inv1   g297(.a(x101), .O(new_n454_));
  oai21  g298(.a(new_n454_), .b(x061), .c(new_n251_), .O(new_n455_));
  nand3  g299(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n269_), .O(new_n457_));
  aoi21  g301(.a(new_n455_), .b(new_n256_), .c(new_n457_), .O(new_n458_));
  nand4  g302(.a(new_n458_), .b(new_n453_), .c(new_n451_), .d(new_n447_), .O(new_n459_));
  nand4  g303(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n460_));
  inv1   g304(.a(new_n460_), .O(new_n461_));
  aoi21  g305(.a(new_n459_), .b(new_n277_), .c(new_n461_), .O(new_n462_));
  nand3  g306(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n463_));
  oai21  g307(.a(new_n462_), .b(x053), .c(new_n463_), .O(new_n464_));
  nand2  g308(.a(new_n464_), .b(x005), .O(new_n465_));
  nand2  g309(.a(new_n247_), .b(x029), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(new_n245_), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n277_), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n244_), .c(new_n449_), .O(new_n469_));
  nor2   g313(.a(new_n243_), .b(x021), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n281_), .c(x069), .O(new_n471_));
  inv1   g315(.a(new_n448_), .O(new_n472_));
  nand4  g316(.a(new_n472_), .b(new_n446_), .c(new_n247_), .d(x029), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n471_), .c(x077), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(new_n469_), .c(new_n242_), .O(new_n475_));
  nand2  g319(.a(new_n446_), .b(x029), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n273_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n277_), .c(x037), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n475_), .O(new_n479_));
  ...
  aoi21  g327(.a(new_n479_), .b(new_n269_), .c(new_n483_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n465_), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(new_n175_), .c(new_n445_), .O(new_n486_));
  inv1   g330(.a(new_n486_), .O(z13));
  oai22  g331(.a(new_n337_), .b(x030), .c(new_n302_), .d(new_n301_), .O(new_n488_));
  inv1   g332(.a(x102), .O(new_n489_));
  aoi21  g333(.a(new_n173_), .b(new_n489_), .c(x094), .O(new_n490_));
  nand2  g334(.a(new_n309_), .b(new_n308_), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n490_), .c(new_n334_), .O(new_n492_));
  oai21  g336(.a(new_n173_), .b(x110), .c(x038), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(x118), .O(new_n494_));
  oai21  g338(.a(new_n489_), .b(x062), .c(new_n308_), .O(new_n495_));
  nand3  g339(.a(x126), .b(new_n309_), .c(new_n302_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n325_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n313_), .c(new_n497_), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n494_), .c(new_n492_), .d(new_n488_), .O(new_n499_));
  nand4  g343(.a(x126), .b(new_n316_), .c(new_n313_), .d(x014), .O(new_n500_));
  inv1   g344(.a(new_n500_), .O(new_n501_));
  aoi21  g345(.a(new_n499_), .b(new_n333_), .c(new_n501_), .O(new_n502_));
  nand3  g346(.a(x086), .b(new_n313_), .c(new_n301_), .O(new_n503_));
  oai21  g347(.a(new_n502_), .b(x054), .c(new_n503_), .O(new_n504_));
  aoi21  g348(.a(new_n304_), .b(x030), .c(x022), .O(new_n505_));
  oai21  g349(.a(new_n505_), .b(x078), .c(new_n301_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n491_), .O(new_n507_));
  nand2  g351(.a(x030), .b(new_n302_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n329_), .c(new_n334_), .O(new_n509_));
  nand2  g353(.a(new_n173_), .b(new_n489_), .O(new_n510_));
  ...
  oai21  g357(.a(new_n513_), .b(new_n509_), .c(new_n333_), .O(new_n514_));
  aoi21  g358(.a(new_n514_), .b(new_n507_), .c(x054), .O(new_n515_));
  oai21  g359(.a(new_n302_), .b(new_n301_), .c(x030), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n329_), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n333_), .c(x038), .O(new_n518_));
  inv1   g362(.a(new_n518_), .O(new_n519_));
  oai21  g363(.a(new_n519_), .b(new_n515_), .c(new_n325_), .O(new_n520_));
  oai22  g364(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n521_));
  nand3  g365(.a(new_n521_), .b(x070), .c(x022), .O(new_n522_));
  aoi22  g366(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n523_));
  nand3  g367(.a(new_n523_), .b(new_n522_), .c(new_n520_), .O(new_n524_));
  aoi21  g368(.a(new_n504_), .b(x006), .c(new_n524_), .O(new_n525_));
  oai21  g369(.a(new_n525_), .b(x046), .c(new_n175_), .O(z14));
  zero   g370(.O(z17));
  zero   g371(.O(z18));
  zero   g372(.O(z19));
  zero   g373(.O(z20));
  zero   g374(.O(z24));
  zero   g375(.O(z27));
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g377(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g378(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g379(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g380(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g381(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g382(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
