...
module FAU ( 
  ...
  aoi21  g141(.a(x046), .b(new_n297_), .c(x091), .O(new_n298_));
  ...
  nand4  g219(.a(x120), .b(new_n357_), .c(new_n163_), .d(x008), .O(new_n377_));
  ...
  aoi21  g229(.a(new_n386_), .b(new_n162_), .c(new_n365_), .O(new_n387_));
  ...
  oai21  g235(.a(new_n392_), .b(new_n387_), .c(new_n164_), .O(new_n393_));
  ...
  nand3  g245(.a(new_n402_), .b(new_n159_), .c(new_n355_), .O(new_n403_));
  ...
  nand3  g320(.a(new_n477_), .b(new_n159_), .c(new_n240_), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(z13));
  nor2   g322(.a(new_n302_), .b(new_n297_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n301_), .c(new_n330_), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(new_n326_), .c(new_n334_), .O(new_n482_));
  aoi21  g325(.a(new_n482_), .b(new_n300_), .c(x091), .O(new_n483_));
  ...
  nand2  g342(.a(x086), .b(new_n297_), .O(new_n500_));
  ...
  nand3  g363(.a(new_n520_), .b(new_n519_), .c(new_n297_), .O(new_n521_));
  and2   g364(.a(new_n521_), .b(x078), .O(new_n522_));
  aoi21  g365(.a(new_n518_), .b(new_n157_), .c(new_n522_), .O(new_n523_));
  ...
  nor2   g376(.a(new_n157_), .b(x078), .O(z20));
  nor2   g377(.a(new_n157_), .b(x078), .O(z21));
  nor2   g378(.a(new_n157_), .b(x078), .O(z24));
  nor2   g379(.a(new_n157_), .b(x078), .O(z27));
endmodule
