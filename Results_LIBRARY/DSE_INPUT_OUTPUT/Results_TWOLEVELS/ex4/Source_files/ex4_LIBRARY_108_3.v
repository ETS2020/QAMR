...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x127), .O(new_n304_));
  ...
  oai21  g287(.a(new_n443_), .b(new_n441_), .c(new_n278_), .O(new_n444_));
  ...
  oai21  g308(.a(new_n464_), .b(new_n461_), .c(new_n277_), .O(new_n465_));
  ...
  oai21  g320(.a(new_n476_), .b(x045), .c(new_n160_), .O(z13));
  inv1   g321(.a(x054), .O(new_n478_));
  nand2  g322(.a(x022), .b(x014), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(x030), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n327_), .c(x086), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(x054), .c(new_n157_), .O(new_n482_));
  oai21  g326(.a(x127), .b(new_n478_), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x038), .O(new_n484_));
  aoi21  g328(.a(x070), .b(x038), .c(new_n344_), .O(new_n485_));
  nand2  g329(.a(new_n300_), .b(x030), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n299_), .c(x086), .O(new_n487_));
  oai22  g331(.a(new_n487_), .b(new_n485_), .c(x118), .d(x110), .O(new_n488_));
  nand3  g332(.a(new_n320_), .b(x070), .c(x030), .O(new_n489_));
  nand3  g333(.a(x102), .b(new_n317_), .c(x006), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n489_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n298_), .O(new_n492_));
  aoi22  g336(.a(new_n479_), .b(x006), .c(new_n320_), .d(x070), .O(new_n493_));
  or2    g337(.a(new_n493_), .b(new_n327_), .O(new_n494_));
  nor2   g338(.a(x126), .b(x102), .O(new_n495_));
  nand4  g339(.a(new_n479_), .b(new_n300_), .c(new_n320_), .d(x030), .O(new_n496_));
  inv1   g340(.a(x094), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(new_n330_), .c(x006), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n496_), .c(new_n495_), .O(new_n499_));
  oai21  g343(.a(new_n345_), .b(x118), .c(new_n334_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n331_), .O(new_n501_));
  oai22  g345(.a(new_n313_), .b(x110), .c(new_n497_), .d(x062), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(x126), .O(new_n503_));
  aoi21  g347(.a(x030), .b(new_n339_), .c(x086), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n503_), .c(new_n501_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(x006), .c(new_n499_), .O(new_n506_));
  nand4  g350(.a(new_n506_), .b(new_n494_), .c(new_n492_), .d(new_n488_), .O(new_n507_));
  nand2  g351(.a(new_n507_), .b(new_n478_), .O(new_n508_));
  oai22  g352(.a(new_n320_), .b(new_n344_), .c(new_n330_), .d(new_n331_), .O(new_n509_));
  nor2   g353(.a(new_n330_), .b(x038), .O(new_n510_));
  aoi22  g354(.a(new_n510_), .b(x022), .c(new_n509_), .d(new_n339_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n508_), .O(new_n512_));
  nand3  g356(.a(x070), .b(new_n478_), .c(x022), .O(new_n513_));
  nand3  g357(.a(x086), .b(new_n298_), .c(x006), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n513_), .c(new_n339_), .O(new_n515_));
  nand3  g359(.a(new_n515_), .b(new_n158_), .c(x078), .O(new_n516_));
  inv1   g360(.a(new_n516_), .O(new_n517_));
  aoi21  g361(.a(new_n512_), .b(new_n157_), .c(new_n517_), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n484_), .c(x046), .O(z14));
  zero   g363(.O(z17));
  zero   g364(.O(z19));
  zero   g365(.O(z26));
  ...
  nor2   g369(.a(new_n158_), .b(new_n157_), .O(z20));
  nor2   g370(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g371(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g372(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g374(.a(new_n158_), .b(new_n157_), .O(z25));
  nor2   g375(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
