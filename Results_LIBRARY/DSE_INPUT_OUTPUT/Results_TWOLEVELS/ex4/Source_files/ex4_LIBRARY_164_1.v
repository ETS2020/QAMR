// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:34 2020
...
module FAU ( 
  ...
  nand3  g244(.a(new_n401_), .b(new_n159_), .c(new_n395_), .O(new_n402_));
  ...
  oai21  g253(.a(new_n410_), .b(x042), .c(new_n159_), .O(z10));
  ...
  oai21  g310(.a(new_n467_), .b(x045), .c(new_n159_), .O(z13));
  inv1   g311(.a(x046), .O(new_n469_));
  inv1   g312(.a(x118), .O(new_n470_));
  oai21  g313(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n471_));
  nand2  g314(.a(new_n301_), .b(x030), .O(new_n472_));
  nand2  g315(.a(new_n472_), .b(new_n299_), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n312_), .O(new_n474_));
  aoi22  g317(.a(new_n474_), .b(new_n471_), .c(new_n470_), .d(new_n314_), .O(new_n475_));
  nand3  g318(.a(new_n312_), .b(x070), .c(x030), .O(new_n476_));
  nand3  g319(.a(x102), .b(new_n305_), .c(x006), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n476_), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n304_), .O(new_n479_));
  nand2  g322(.a(new_n325_), .b(x006), .O(new_n480_));
  oai21  g323(.a(x086), .b(new_n306_), .c(new_n480_), .O(new_n481_));
  nand2  g324(.a(new_n481_), .b(new_n329_), .O(new_n482_));
  nand4  g325(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n483_));
  nand3  g326(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  oai21  g328(.a(x126), .b(x102), .c(new_n485_), .O(new_n486_));
  nand2  g329(.a(x126), .b(new_n470_), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n298_), .c(x022), .O(new_n488_));
  nand2  g331(.a(x030), .b(new_n343_), .O(new_n489_));
  nand3  g332(.a(x126), .b(x094), .c(new_n305_), .O(new_n490_));
  nand3  g333(.a(new_n490_), .b(new_n489_), .c(new_n312_), .O(new_n491_));
  oai21  g334(.a(new_n491_), .b(new_n488_), .c(x006), .O(new_n492_));
  nand4  g335(.a(new_n492_), .b(new_n486_), .c(new_n482_), .d(new_n479_), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(new_n475_), .c(new_n340_), .O(new_n494_));
  nand3  g337(.a(x126), .b(new_n314_), .c(x038), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n312_), .c(new_n297_), .O(new_n496_));
  nand3  g339(.a(new_n312_), .b(x038), .c(x030), .O(new_n497_));
  oai21  g340(.a(new_n306_), .b(new_n336_), .c(new_n497_), .O(new_n498_));
  oai21  g341(.a(new_n498_), .b(new_n496_), .c(new_n343_), .O(new_n499_));
  nand2  g342(.a(x030), .b(new_n336_), .O(new_n500_));
  aoi21  g343(.a(new_n500_), .b(new_n323_), .c(x086), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(x054), .c(x038), .O(new_n502_));
  nand3  g345(.a(x070), .b(new_n304_), .c(x022), .O(new_n503_));
  nand4  g346(.a(new_n503_), .b(new_n502_), .c(new_n499_), .d(new_n494_), .O(new_n504_));
  nand3  g347(.a(new_n504_), .b(new_n157_), .c(new_n469_), .O(new_n505_));
  inv1   g348(.a(new_n505_), .O(z14));
  zero   g349(.O(z07));
  zero   g350(.O(z15));
  zero   g351(.O(z16));
  zero   g352(.O(z18));
  ...
  zero   g354(.O(z23));
  zero   g355(.O(z26));
  nor2   g356(.a(new_n157_), .b(x046), .O(z19));
  nor2   g357(.a(new_n157_), .b(x046), .O(z20));
  nor2   g358(.a(new_n157_), .b(x046), .O(z22));
  nor2   g359(.a(new_n157_), .b(x046), .O(z24));
  nor2   g360(.a(new_n157_), .b(x046), .O(z25));
  nor2   g361(.a(new_n157_), .b(x046), .O(z27));
endmodule
