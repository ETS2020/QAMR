// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:12 2020
...
module FAU ( 
  ...
  oai21  g241(.a(new_n397_), .b(x040), .c(new_n173_), .O(z08));
  ...
  oai21  g249(.a(new_n405_), .b(x041), .c(new_n173_), .O(z09));
  ...
  oai21  g257(.a(new_n413_), .b(x042), .c(new_n173_), .O(z10));
  ...
  nand2  g319(.a(new_n311_), .b(new_n299_), .O(new_n476_));
  oai21  g320(.a(x078), .b(x054), .c(new_n476_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(x086), .c(x006), .O(new_n478_));
  nand2  g322(.a(new_n307_), .b(new_n306_), .O(new_n479_));
  oai21  g323(.a(x078), .b(new_n300_), .c(new_n299_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  nand3  g325(.a(new_n336_), .b(new_n332_), .c(x070), .O(new_n482_));
  aoi21  g326(.a(new_n482_), .b(new_n481_), .c(x054), .O(new_n483_));
  nor3   g327(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n483_), .c(new_n324_), .O(new_n485_));
  oai22  g329(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(x070), .c(x022), .O(new_n487_));
  aoi22  g331(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n488_));
  nand4  g332(.a(new_n488_), .b(new_n487_), .c(new_n485_), .d(new_n478_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n173_), .O(new_n490_));
  nand2  g334(.a(x123), .b(x102), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n316_), .O(new_n492_));
  nand3  g336(.a(new_n492_), .b(new_n302_), .c(new_n324_), .O(new_n493_));
  nand2  g337(.a(x123), .b(x006), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n493_), .c(new_n298_), .O(new_n495_));
  inv1   g339(.a(x123), .O(new_n496_));
  nor3   g340(.a(new_n328_), .b(new_n496_), .c(new_n296_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n495_), .c(new_n297_), .O(new_n498_));
  nand4  g342(.a(x123), .b(new_n324_), .c(x038), .d(x030), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n498_), .O(new_n500_));
  oai21  g344(.a(new_n300_), .b(new_n299_), .c(new_n500_), .O(new_n501_));
  nand4  g345(.a(x123), .b(new_n324_), .c(x070), .d(x030), .O(new_n502_));
  nand3  g346(.a(x126), .b(new_n307_), .c(x006), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n502_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n300_), .O(new_n505_));
  oai22  g349(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(x102), .O(new_n507_));
  oai21  g351(.a(new_n333_), .b(new_n311_), .c(new_n479_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n507_), .c(new_n296_), .O(new_n509_));
  nand4  g353(.a(new_n479_), .b(new_n302_), .c(new_n324_), .d(x030), .O(new_n510_));
  inv1   g354(.a(new_n510_), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n509_), .c(x123), .O(new_n512_));
  inv1   g356(.a(x094), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n333_), .O(new_n514_));
  nand2  g358(.a(x118), .b(new_n306_), .O(new_n515_));
  nand3  g359(.a(new_n515_), .b(new_n514_), .c(new_n476_), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(x126), .c(x006), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n512_), .c(new_n505_), .O(new_n518_));
  nand2  g362(.a(new_n518_), .b(new_n297_), .O(new_n519_));
  nand2  g363(.a(new_n519_), .b(new_n501_), .O(new_n520_));
  nand3  g364(.a(new_n311_), .b(x014), .c(x006), .O(new_n521_));
  nor4   g365(.a(new_n521_), .b(new_n316_), .c(x062), .d(x054), .O(new_n522_));
  aoi21  g366(.a(new_n520_), .b(new_n332_), .c(new_n522_), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n490_), .c(x046), .O(z14));
  zero   g368(.O(z15));
  zero   g369(.O(z21));
  zero   g370(.O(z27));
  nor2   g371(.a(x126), .b(x123), .O(z16));
  nor2   g372(.a(x126), .b(x123), .O(z17));
  nor2   g373(.a(x126), .b(x123), .O(z18));
  nor2   g374(.a(x126), .b(x123), .O(z19));
  nor2   g375(.a(x126), .b(x123), .O(z20));
  nor2   g376(.a(x126), .b(x123), .O(z22));
  nor2   g377(.a(x126), .b(x123), .O(z23));
  nor2   g378(.a(x126), .b(x123), .O(z24));
  nor2   g379(.a(x126), .b(x123), .O(z25));
  nor2   g380(.a(x126), .b(x123), .O(z26));
endmodule
