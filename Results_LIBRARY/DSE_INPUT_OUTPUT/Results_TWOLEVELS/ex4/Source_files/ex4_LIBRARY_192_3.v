// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:44 2020
...
module FAU ( 
  ...
  nor2   g095(.a(new_n173_), .b(new_n251_), .O(new_n252_));
  nand2  g096(.a(new_n252_), .b(new_n250_), .O(new_n253_));
  nand2  g097(.a(new_n253_), .b(x069), .O(new_n254_));
  inv1   g098(.a(x037), .O(new_n255_));
  oai21  g099(.a(x125), .b(new_n251_), .c(new_n255_), .O(new_n256_));
  nand2  g100(.a(new_n256_), .b(new_n173_), .O(new_n257_));
  ...
  nand4  g107(.a(new_n263_), .b(new_n257_), .c(new_n254_), .d(new_n248_), .O(new_n264_));
  nand4  g108(.a(new_n260_), .b(x061), .c(x037), .d(new_n244_), .O(new_n265_));
  ...
  oai21  g113(.a(new_n267_), .b(new_n242_), .c(new_n269_), .O(new_n270_));
  nand2  g114(.a(new_n270_), .b(new_n241_), .O(new_n271_));
  ...
  oai22  g132(.a(new_n276_), .b(new_n255_), .c(new_n242_), .d(new_n244_), .O(new_n289_));
  nand3  g133(.a(new_n289_), .b(new_n277_), .c(new_n245_), .O(new_n290_));
  aoi22  g134(.a(new_n276_), .b(new_n244_), .c(new_n242_), .d(new_n255_), .O(new_n291_));
  ...
  nand2  g195(.a(new_n351_), .b(new_n175_), .O(z06));
  ...
  nand3  g245(.a(new_n401_), .b(new_n175_), .c(new_n353_), .O(new_n402_));
  ...
  oai21  g254(.a(new_n410_), .b(x041), .c(new_n175_), .O(z09));
  ...
  nand3  g262(.a(new_n418_), .b(new_n175_), .c(new_n412_), .O(new_n419_));
  ...
  oai21  g271(.a(new_n427_), .b(x043), .c(new_n175_), .O(z11));
  ...
  oai22  g281(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n438_));
  nand3  g282(.a(new_n438_), .b(x085), .c(x005), .O(new_n439_));
  aoi22  g283(.a(new_n276_), .b(new_n255_), .c(new_n242_), .d(new_n244_), .O(new_n440_));
  nand3  g284(.a(new_n280_), .b(new_n268_), .c(new_n276_), .O(new_n441_));
  oai22  g285(.a(new_n441_), .b(x053), .c(new_n440_), .d(new_n245_), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(x069), .O(new_n443_));
  nand2  g287(.a(new_n441_), .b(new_n242_), .O(new_n444_));
  aoi22  g288(.a(new_n444_), .b(x037), .c(x077), .d(x013), .O(new_n445_));
  nand3  g289(.a(new_n445_), .b(new_n443_), .c(new_n439_), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(new_n175_), .O(new_n447_));
  nand2  g291(.a(x117), .b(new_n172_), .O(new_n448_));
  oai21  g292(.a(x117), .b(new_n251_), .c(new_n448_), .O(new_n449_));
  aoi21  g293(.a(x069), .b(x037), .c(new_n241_), .O(new_n450_));
  nand2  g294(.a(new_n247_), .b(x029), .O(new_n451_));
  aoi21  g295(.a(new_n451_), .b(new_n245_), .c(x085), .O(new_n452_));
  oai21  g296(.a(new_n452_), .b(new_n450_), .c(new_n276_), .O(new_n453_));
  oai21  g297(.a(x085), .b(new_n244_), .c(new_n453_), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n449_), .O(new_n455_));
  inv1   g299(.a(x093), .O(new_n456_));
  aoi22  g300(.a(new_n456_), .b(new_n277_), .c(new_n258_), .d(new_n255_), .O(new_n457_));
  nand2  g301(.a(x021), .b(x013), .O(new_n458_));
  nand4  g302(.a(new_n458_), .b(new_n247_), .c(new_n268_), .d(x029), .O(new_n459_));
  oai21  g303(.a(new_n457_), .b(new_n241_), .c(new_n459_), .O(new_n460_));
  oai21  g304(.a(x125), .b(x101), .c(new_n460_), .O(new_n461_));
  aoi22  g305(.a(new_n272_), .b(new_n243_), .c(x021), .d(x013), .O(new_n462_));
  nor2   g306(.a(new_n260_), .b(x021), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n462_), .c(x005), .O(new_n464_));
  nand4  g308(.a(new_n268_), .b(x069), .c(x029), .d(new_n245_), .O(new_n465_));
  nand3  g309(.a(new_n465_), .b(new_n464_), .c(new_n461_), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(new_n173_), .c(new_n276_), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n455_), .O(new_n468_));
  nand3  g312(.a(new_n173_), .b(new_n268_), .c(x029), .O(new_n469_));
  nand4  g313(.a(x125), .b(new_n251_), .c(new_n172_), .d(x005), .O(new_n470_));
  aoi21  g314(.a(new_n470_), .b(new_n469_), .c(x013), .O(new_n471_));
  nand4  g315(.a(new_n173_), .b(new_n268_), .c(x029), .d(new_n245_), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(new_n473_));
  oai21  g317(.a(new_n473_), .b(new_n471_), .c(new_n276_), .O(new_n474_));
  nor2   g318(.a(new_n474_), .b(new_n255_), .O(new_n475_));
  aoi21  g319(.a(new_n468_), .b(new_n242_), .c(new_n475_), .O(new_n476_));
  aoi21  g320(.a(new_n476_), .b(new_n447_), .c(x045), .O(z13));
  oai22  g321(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(x070), .c(x022), .O(new_n479_));
  aoi22  g323(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(new_n175_), .O(new_n482_));
  nor2   g326(.a(x086), .b(x006), .O(new_n483_));
  aoi21  g327(.a(new_n173_), .b(x006), .c(new_n483_), .O(new_n484_));
  nor2   g328(.a(new_n484_), .b(new_n299_), .O(new_n485_));
  nand2  g329(.a(x070), .b(x038), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(new_n173_), .c(x006), .O(new_n487_));
  oai21  g331(.a(new_n340_), .b(new_n298_), .c(new_n300_), .O(new_n488_));
  nand3  g332(.a(new_n488_), .b(new_n324_), .c(new_n172_), .O(new_n489_));
  aoi21  g333(.a(new_n489_), .b(new_n487_), .c(x078), .O(new_n490_));
  oai22  g334(.a(new_n490_), .b(new_n485_), .c(x118), .d(x110), .O(new_n491_));
  nand2  g335(.a(x022), .b(x014), .O(new_n492_));
  oai21  g336(.a(new_n336_), .b(x030), .c(new_n492_), .O(new_n493_));
  inv1   g337(.a(x094), .O(new_n494_));
  inv1   g338(.a(x102), .O(new_n495_));
  nand2  g339(.a(new_n316_), .b(new_n495_), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n494_), .c(new_n333_), .O(new_n497_));
  nor2   g341(.a(new_n307_), .b(x110), .O(new_n498_));
  nor2   g342(.a(x118), .b(x022), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n498_), .c(x126), .O(new_n500_));
  nor2   g344(.a(new_n495_), .b(x062), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n311_), .c(x086), .O(new_n502_));
  nand4  g346(.a(new_n502_), .b(new_n500_), .c(new_n497_), .d(new_n493_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n332_), .O(new_n504_));
  nand4  g348(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n504_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n173_), .c(x006), .O(new_n507_));
  nor2   g351(.a(new_n298_), .b(x022), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n336_), .c(x070), .O(new_n509_));
  nand4  g353(.a(new_n496_), .b(new_n492_), .c(new_n302_), .d(x030), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n509_), .O(new_n511_));
  nand4  g355(.a(new_n511_), .b(new_n324_), .c(new_n332_), .d(new_n172_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n507_), .c(new_n491_), .O(new_n513_));
  nor2   g357(.a(x086), .b(x078), .O(new_n514_));
  nand4  g358(.a(new_n514_), .b(x038), .c(x030), .d(new_n172_), .O(new_n515_));
  nand4  g359(.a(new_n173_), .b(x086), .c(new_n311_), .d(x006), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n515_), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n299_), .O(new_n518_));
  nand4  g362(.a(new_n324_), .b(x030), .c(new_n300_), .d(new_n172_), .O(new_n519_));
  oai21  g363(.a(new_n484_), .b(new_n328_), .c(new_n519_), .O(new_n520_));
  nand3  g364(.a(new_n520_), .b(new_n332_), .c(x038), .O(new_n521_));
  nand2  g365(.a(new_n521_), .b(new_n518_), .O(new_n522_));
  aoi21  g366(.a(new_n513_), .b(new_n297_), .c(new_n522_), .O(new_n523_));
  aoi21  g367(.a(new_n523_), .b(new_n482_), .c(x046), .O(z14));
  zero   g368(.O(z16));
  zero   g369(.O(z17));
  zero   g370(.O(z18));
  zero   g371(.O(z19));
  ...
  zero   g376(.O(z26));
  zero   g377(.O(z27));
  nor2   g378(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g379(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g380(.a(new_n173_), .b(new_n172_), .O(z24));
endmodule
