// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:46 2020
...
module FAU ( 
  ...
  nand3  g136(.a(new_n292_), .b(new_n172_), .c(x045), .O(new_n293_));
  ...
  oai22  g202(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n360_));
  nand3  g203(.a(new_n360_), .b(x081), .c(x001), .O(new_n361_));
  oai22  g204(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n362_));
  nand3  g205(.a(new_n362_), .b(x065), .c(x017), .O(new_n363_));
  aoi22  g206(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n364_));
  nand3  g207(.a(new_n364_), .b(new_n363_), .c(new_n361_), .O(new_n365_));
  inv1   g208(.a(new_n365_), .O(new_n366_));
  oai21  g209(.a(new_n366_), .b(x041), .c(new_n172_), .O(z09));
  inv1   g210(.a(x042), .O(new_n368_));
  ...
  nand3  g217(.a(new_n374_), .b(new_n172_), .c(new_n368_), .O(new_n375_));
  inv1   g218(.a(new_n375_), .O(z10));
  oai22  g219(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n377_));
  nand3  g220(.a(new_n377_), .b(x083), .c(x003), .O(new_n378_));
  oai22  g221(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n379_));
  nand3  g222(.a(new_n379_), .b(x067), .c(x019), .O(new_n380_));
  aoi22  g223(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n381_));
  nand3  g224(.a(new_n381_), .b(new_n380_), .c(new_n378_), .O(new_n382_));
  inv1   g225(.a(new_n382_), .O(new_n383_));
  oai21  g226(.a(new_n383_), .b(x043), .c(new_n172_), .O(z11));
  oai22  g227(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n385_));
  nand3  g228(.a(new_n385_), .b(x084), .c(x004), .O(new_n386_));
  oai22  g229(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n387_));
  nand3  g230(.a(new_n387_), .b(x068), .c(x020), .O(new_n388_));
  aoi22  g231(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(new_n388_), .c(new_n386_), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(x044), .c(new_n172_), .O(z12));
  oai22  g235(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n393_));
  inv1   g236(.a(x101), .O(new_n394_));
  aoi21  g237(.a(new_n258_), .b(new_n394_), .c(x093), .O(new_n395_));
  nand2  g238(.a(new_n249_), .b(new_n248_), .O(new_n396_));
  oai21  g239(.a(new_n396_), .b(new_n395_), .c(new_n275_), .O(new_n397_));
  oai21  g240(.a(new_n258_), .b(x109), .c(x037), .O(new_n398_));
  nand2  g241(.a(new_n398_), .b(x117), .O(new_n399_));
  oai21  g242(.a(new_n394_), .b(x061), .c(new_n248_), .O(new_n400_));
  nand3  g243(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n266_), .O(new_n402_));
  aoi21  g245(.a(new_n400_), .b(new_n253_), .c(new_n402_), .O(new_n403_));
  nand4  g246(.a(new_n403_), .b(new_n399_), .c(new_n397_), .d(new_n393_), .O(new_n404_));
  nand4  g247(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n405_));
  inv1   g248(.a(new_n405_), .O(new_n406_));
  aoi21  g249(.a(new_n404_), .b(new_n274_), .c(new_n406_), .O(new_n407_));
  nand3  g250(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n408_));
  oai21  g251(.a(new_n407_), .b(x053), .c(new_n408_), .O(new_n409_));
  aoi21  g252(.a(new_n244_), .b(x029), .c(x021), .O(new_n410_));
  oai21  g253(.a(new_n410_), .b(x077), .c(new_n241_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n396_), .O(new_n412_));
  nand2  g255(.a(x029), .b(new_n242_), .O(new_n413_));
  aoi21  g256(.a(new_n413_), .b(new_n270_), .c(new_n275_), .O(new_n414_));
  nand2  g257(.a(new_n258_), .b(new_n394_), .O(new_n415_));
  aoi22  g258(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n416_));
  nand3  g259(.a(new_n416_), .b(new_n415_), .c(x029), .O(new_n417_));
  inv1   g260(.a(new_n417_), .O(new_n418_));
  oai21  g261(.a(new_n418_), .b(new_n414_), .c(new_n274_), .O(new_n419_));
  aoi21  g262(.a(new_n419_), .b(new_n412_), .c(x053), .O(new_n420_));
  oai21  g263(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n421_));
  nand2  g264(.a(new_n421_), .b(new_n270_), .O(new_n422_));
  nand3  g265(.a(new_n422_), .b(new_n274_), .c(x037), .O(new_n423_));
  inv1   g266(.a(new_n423_), .O(new_n424_));
  oai21  g267(.a(new_n424_), .b(new_n420_), .c(new_n266_), .O(new_n425_));
  oai22  g268(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n426_));
  nand3  g269(.a(new_n426_), .b(x069), .c(x021), .O(new_n427_));
  aoi22  g270(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n428_));
  nand3  g271(.a(new_n428_), .b(new_n427_), .c(new_n425_), .O(new_n429_));
  aoi21  g272(.a(new_n409_), .b(x005), .c(new_n429_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(x045), .c(new_n172_), .O(z13));
  oai21  g274(.a(x046), .b(x014), .c(x078), .O(new_n432_));
  inv1   g275(.a(x014), .O(new_n433_));
  inv1   g276(.a(x030), .O(new_n434_));
  nor2   g277(.a(x094), .b(x062), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(new_n434_), .O(new_n436_));
  oai21  g279(.a(new_n299_), .b(new_n433_), .c(new_n436_), .O(new_n437_));
  inv1   g280(.a(x102), .O(new_n438_));
  inv1   g281(.a(x126), .O(new_n439_));
  aoi21  g282(.a(new_n439_), .b(new_n438_), .c(x094), .O(new_n440_));
  inv1   g283(.a(x110), .O(new_n441_));
  inv1   g284(.a(x118), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(new_n440_), .c(new_n300_), .O(new_n444_));
  oai21  g287(.a(new_n439_), .b(x110), .c(x038), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(x118), .O(new_n446_));
  oai21  g289(.a(new_n438_), .b(x062), .c(new_n441_), .O(new_n447_));
  nand3  g290(.a(x126), .b(new_n442_), .c(new_n299_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n303_), .O(new_n449_));
  aoi21  g292(.a(new_n447_), .b(new_n296_), .c(new_n449_), .O(new_n450_));
  nand4  g293(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n437_), .O(new_n451_));
  nor2   g294(.a(x038), .b(new_n433_), .O(new_n452_));
  nor2   g295(.a(new_n439_), .b(x062), .O(new_n453_));
  aoi22  g296(.a(new_n453_), .b(new_n452_), .c(new_n451_), .d(new_n295_), .O(new_n454_));
  nand3  g297(.a(x086), .b(new_n296_), .c(new_n433_), .O(new_n455_));
  oai21  g298(.a(new_n454_), .b(x054), .c(new_n455_), .O(new_n456_));
  nand2  g299(.a(x094), .b(x062), .O(new_n457_));
  aoi21  g300(.a(new_n457_), .b(x030), .c(x022), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(x078), .c(new_n433_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n443_), .O(new_n460_));
  nand2  g303(.a(new_n296_), .b(x030), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n435_), .c(new_n300_), .O(new_n462_));
  nand2  g305(.a(new_n439_), .b(new_n438_), .O(new_n463_));
  aoi22  g306(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n464_));
  nand3  g307(.a(new_n464_), .b(new_n463_), .c(x030), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n462_), .c(new_n295_), .O(new_n467_));
  aoi21  g310(.a(new_n467_), .b(new_n460_), .c(x054), .O(new_n468_));
  oai21  g311(.a(new_n299_), .b(new_n433_), .c(x030), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n435_), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(new_n295_), .c(x038), .O(new_n471_));
  inv1   g314(.a(new_n471_), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(new_n468_), .c(new_n303_), .O(new_n473_));
  oai22  g316(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n474_));
  nand3  g317(.a(new_n474_), .b(x070), .c(x022), .O(new_n475_));
  nand2  g318(.a(x054), .b(x038), .O(new_n476_));
  nand3  g319(.a(new_n476_), .b(new_n475_), .c(new_n473_), .O(new_n477_));
  aoi21  g320(.a(new_n456_), .b(x006), .c(new_n477_), .O(new_n478_));
  oai21  g321(.a(new_n478_), .b(x046), .c(new_n432_), .O(z14));
  inv1   g322(.a(new_n172_), .O(z16));
  zero   g323(.O(z07));
  zero   g324(.O(z15));
  zero   g325(.O(z19));
  zero   g326(.O(z20));
  ...
  zero   g329(.O(z26));
  zero   g330(.O(z27));
  inv1   g331(.a(new_n172_), .O(z17));
  inv1   g332(.a(new_n172_), .O(z18));
  inv1   g333(.a(new_n172_), .O(z22));
  inv1   g334(.a(new_n172_), .O(z23));
  inv1   g335(.a(new_n172_), .O(z24));
endmodule
