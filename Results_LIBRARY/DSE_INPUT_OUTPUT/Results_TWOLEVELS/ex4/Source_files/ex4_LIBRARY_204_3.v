// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:09 2020
...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x092), .O(new_n304_));
  ...
  nand3  g264(.a(new_n421_), .b(new_n160_), .c(new_n415_), .O(new_n422_));
  ...
  oai21  g322(.a(new_n479_), .b(x045), .c(new_n160_), .O(z13));
  inv1   g323(.a(x054), .O(new_n481_));
  nand2  g324(.a(x022), .b(x014), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x030), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n327_), .c(x086), .O(new_n484_));
  oai21  g327(.a(new_n484_), .b(x054), .c(new_n157_), .O(new_n485_));
  oai21  g328(.a(x092), .b(new_n481_), .c(new_n485_), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x038), .O(new_n487_));
  aoi21  g330(.a(x070), .b(x038), .c(new_n344_), .O(new_n488_));
  nand2  g331(.a(new_n300_), .b(x030), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n299_), .c(x086), .O(new_n490_));
  ...
  aoi22  g338(.a(new_n482_), .b(x006), .c(new_n320_), .d(x070), .O(new_n496_));
  or2    g339(.a(new_n496_), .b(new_n327_), .O(new_n497_));
  nor2   g340(.a(x126), .b(x102), .O(new_n498_));
  nand4  g341(.a(new_n482_), .b(new_n300_), .c(new_n320_), .d(x030), .O(new_n499_));
  ...
  oai21  g345(.a(new_n345_), .b(x118), .c(new_n334_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n331_), .O(new_n504_));
  oai22  g347(.a(new_n313_), .b(x110), .c(new_n500_), .d(x062), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(x126), .O(new_n506_));
  aoi21  g349(.a(x030), .b(new_n339_), .c(x086), .O(new_n507_));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z19));
