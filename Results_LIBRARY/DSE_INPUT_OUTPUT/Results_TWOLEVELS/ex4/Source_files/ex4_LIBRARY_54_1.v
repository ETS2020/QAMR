// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:43 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x081), .O(z07));
  ...
  oai21  g033(.a(new_n188_), .b(x017), .c(new_n189_), .O(new_n190_));
  oai21  g034(.a(new_n190_), .b(new_n185_), .c(new_n172_), .O(new_n191_));
  nand2  g035(.a(new_n190_), .b(x081), .O(new_n192_));
  aoi21  g036(.a(new_n192_), .b(new_n191_), .c(new_n176_), .O(z01));
  ...
  nand3  g051(.a(new_n207_), .b(new_n174_), .c(x042), .O(new_n208_));
  ...
  nand2  g068(.a(new_n224_), .b(new_n174_), .O(z03));
  ...
  nand3  g083(.a(new_n239_), .b(new_n174_), .c(x044), .O(new_n240_));
  inv1   g084(.a(new_n240_), .O(z04));
  ...
  nand3  g162(.a(new_n172_), .b(x118), .c(x022), .O(new_n319_));
  ...
  nand4  g166(.a(new_n172_), .b(x062), .c(x038), .d(new_n302_), .O(new_n323_));
  ...
  aoi22  g249(.a(new_n182_), .b(new_n181_), .c(new_n180_), .d(new_n179_), .O(new_n406_));
  nor2   g250(.a(new_n406_), .b(new_n177_), .O(new_n407_));
  ...
  nand2  g256(.a(new_n411_), .b(new_n172_), .O(new_n413_));
  ...
  oai21  g265(.a(new_n421_), .b(x042), .c(new_n174_), .O(z10));
  ...
  nand3  g273(.a(new_n429_), .b(new_n174_), .c(new_n423_), .O(new_n430_));
  ...
  nand3  g282(.a(new_n438_), .b(new_n174_), .c(new_n432_), .O(new_n439_));
  inv1   g283(.a(new_n439_), .O(z12));
  inv1   g284(.a(x045), .O(new_n441_));
  nand2  g285(.a(x021), .b(x013), .O(new_n442_));
  oai21  g286(.a(new_n282_), .b(x029), .c(new_n442_), .O(new_n443_));
  ...
  oai21  g294(.a(new_n450_), .b(x061), .c(new_n252_), .O(new_n451_));
  nand3  g295(.a(x125), .b(new_n253_), .c(new_n246_), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(new_n270_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n257_), .c(new_n453_), .O(new_n454_));
  nand4  g298(.a(new_n454_), .b(new_n449_), .c(new_n447_), .d(new_n443_), .O(new_n455_));
  nand4  g299(.a(x125), .b(new_n260_), .c(new_n257_), .d(x013), .O(new_n456_));
  inv1   g300(.a(new_n456_), .O(new_n457_));
  aoi21  g301(.a(new_n455_), .b(new_n278_), .c(new_n457_), .O(new_n458_));
  nand3  g302(.a(x085), .b(new_n257_), .c(new_n245_), .O(new_n459_));
  oai21  g303(.a(new_n458_), .b(x053), .c(new_n459_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(x005), .O(new_n461_));
  nand2  g305(.a(new_n248_), .b(x029), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n246_), .O(new_n463_));
  nand2  g307(.a(new_n463_), .b(new_n278_), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n245_), .c(new_n445_), .O(new_n465_));
  nor2   g309(.a(new_n244_), .b(x021), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n282_), .c(x069), .O(new_n467_));
  inv1   g311(.a(new_n444_), .O(new_n468_));
  nand4  g312(.a(new_n468_), .b(new_n442_), .c(new_n248_), .d(x029), .O(new_n469_));
  aoi21  g313(.a(new_n469_), .b(new_n467_), .c(x077), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n465_), .c(new_n243_), .O(new_n471_));
  ...
  aoi21  g323(.a(new_n475_), .b(new_n270_), .c(new_n479_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n461_), .O(new_n481_));
  nand3  g325(.a(new_n481_), .b(new_n174_), .c(new_n441_), .O(new_n482_));
  inv1   g326(.a(new_n482_), .O(z13));
  oai22  g327(.a(new_n338_), .b(x030), .c(new_n303_), .d(new_n302_), .O(new_n484_));
  inv1   g328(.a(x102), .O(new_n485_));
  aoi21  g329(.a(new_n172_), .b(new_n485_), .c(x094), .O(new_n486_));
  nand2  g330(.a(new_n310_), .b(new_n309_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n486_), .c(new_n335_), .O(new_n488_));
  oai21  g332(.a(new_n172_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g334(.a(new_n485_), .b(x062), .c(new_n309_), .O(new_n491_));
  nand3  g335(.a(x126), .b(new_n310_), .c(new_n303_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n326_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n314_), .c(new_n493_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n490_), .c(new_n488_), .d(new_n484_), .O(new_n495_));
  nand4  g339(.a(x126), .b(new_n317_), .c(new_n314_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n334_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n314_), .c(new_n302_), .O(new_n499_));
  oai21  g343(.a(new_n498_), .b(x054), .c(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n305_), .b(x030), .c(x022), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(x078), .c(new_n302_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n487_), .O(new_n503_));
  nand2  g347(.a(x030), .b(new_n303_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n330_), .c(new_n335_), .O(new_n505_));
  nand2  g349(.a(new_n172_), .b(new_n485_), .O(new_n506_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n505_), .c(new_n334_), .O(new_n510_));
  aoi21  g354(.a(new_n510_), .b(new_n503_), .c(x054), .O(new_n511_));
  oai21  g355(.a(new_n303_), .b(new_n302_), .c(x030), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n330_), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n334_), .c(x038), .O(new_n514_));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z27));
  nor2   g374(.a(new_n172_), .b(x081), .O(z16));
  nor2   g375(.a(new_n172_), .b(x081), .O(z20));
  nor2   g376(.a(new_n172_), .b(x081), .O(z21));
  nor2   g377(.a(new_n172_), .b(x081), .O(z24));
  nor2   g378(.a(new_n172_), .b(x081), .O(z26));
endmodule
