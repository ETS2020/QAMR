// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:53 2020
...
module FAU ( 
  ...
  nor2   g015(.a(x126), .b(x084), .O(z17));
  inv1   g016(.a(z17), .O(new_n173_));
  ...
  aoi22  g272(.a(new_n228_), .b(new_n227_), .c(new_n226_), .d(new_n225_), .O(new_n430_));
  nor2   g273(.a(new_n430_), .b(new_n223_), .O(new_n431_));
  ...
  oai21  g278(.a(new_n435_), .b(new_n431_), .c(x084), .O(new_n436_));
  nand2  g279(.a(new_n435_), .b(x126), .O(new_n437_));
  aoi21  g280(.a(new_n437_), .b(new_n436_), .c(x044), .O(z12));
  ...
  oai21  g319(.a(new_n476_), .b(x045), .c(new_n173_), .O(z13));
  ...
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(x126), .b(x084), .O(z20));
  nor2   g371(.a(x126), .b(x084), .O(z27));
endmodule
