...
module FAU ( 
  ...
  oai21  g063(.a(x075), .b(x011), .c(x078), .O(new_n220_));
  aoi21  g064(.a(new_n212_), .b(new_n211_), .c(new_n220_), .O(new_n221_));
  nand3  g065(.a(new_n221_), .b(new_n219_), .c(new_n215_), .O(new_n222_));
  and2   g066(.a(new_n222_), .b(x043), .O(z03));
  ...
  nor2   g149(.a(x054), .b(x043), .O(new_n306_));
  ...
  nand3  g195(.a(new_n351_), .b(new_n299_), .c(new_n172_), .O(new_n352_));
  ...
  oai21  g227(.a(new_n383_), .b(x072), .c(new_n159_), .O(new_n384_));
  nand2  g228(.a(new_n384_), .b(new_n381_), .O(new_n385_));
  nand2  g229(.a(x024), .b(new_n165_), .O(new_n386_));
  aoi21  g230(.a(new_n386_), .b(new_n358_), .c(new_n166_), .O(new_n387_));
  ...
  oai21  g234(.a(new_n390_), .b(new_n387_), .c(new_n162_), .O(new_n391_));
  ...
  oai21  g240(.a(new_n396_), .b(new_n392_), .c(new_n158_), .O(new_n397_));
  ...
  nand2  g271(.a(new_n427_), .b(new_n172_), .O(new_n428_));
  nand2  g272(.a(new_n428_), .b(new_n174_), .O(z11));
  ...
  nand2  g285(.a(new_n263_), .b(new_n441_), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n248_), .O(new_n443_));
  ...
  oai21  g290(.a(new_n263_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g292(.a(new_n441_), .b(x061), .c(new_n254_), .O(new_n449_));
  nand3  g293(.a(x125), .b(new_n255_), .c(new_n245_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n271_), .O(new_n451_));
  ...
  nand4  g297(.a(x125), .b(new_n247_), .c(new_n259_), .d(x013), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n278_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(x085), .b(new_n259_), .c(new_n244_), .O(new_n457_));
  oai21  g301(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(x005), .O(new_n459_));
  oai21  g303(.a(new_n249_), .b(new_n243_), .c(new_n245_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n278_), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n244_), .c(new_n444_), .O(new_n462_));
  nor2   g306(.a(new_n243_), .b(x021), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n282_), .c(x069), .O(new_n464_));
  nand4  g308(.a(new_n442_), .b(new_n439_), .c(new_n250_), .d(x029), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n464_), .c(x077), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n462_), .c(new_n242_), .O(new_n467_));
  ...
  nand3  g320(.a(new_n476_), .b(new_n174_), .c(new_n240_), .O(new_n477_));
  ...
  aoi21  g325(.a(new_n481_), .b(new_n479_), .c(x043), .O(new_n482_));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z26));
  nor2   g374(.a(x078), .b(new_n172_), .O(z17));
  nor2   g375(.a(x078), .b(new_n172_), .O(z20));
  nor2   g376(.a(x078), .b(new_n172_), .O(z22));
  nor2   g377(.a(x078), .b(new_n172_), .O(z24));
  nor2   g378(.a(x078), .b(new_n172_), .O(z27));
endmodule
