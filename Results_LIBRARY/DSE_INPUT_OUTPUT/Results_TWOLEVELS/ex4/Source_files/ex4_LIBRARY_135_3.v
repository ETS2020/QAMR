// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:35 2020
...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x059), .O(new_n304_));
  ...
  oai21  g246(.a(new_n403_), .b(x040), .c(new_n175_), .O(z08));
  ...
  nand3  g254(.a(new_n411_), .b(new_n175_), .c(new_n405_), .O(new_n412_));
  ...
  nand3  g263(.a(new_n420_), .b(new_n175_), .c(new_n414_), .O(new_n421_));
  ...
  oai21  g272(.a(new_n429_), .b(x043), .c(new_n175_), .O(z11));
  ...
  nand3  g280(.a(new_n437_), .b(new_n175_), .c(new_n431_), .O(new_n438_));
  ...
  aoi21  g285(.a(new_n262_), .b(new_n442_), .c(x093), .O(new_n443_));
  nor2   g286(.a(x117), .b(x109), .O(new_n444_));
  inv1   g287(.a(new_n444_), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n443_), .c(new_n278_), .O(new_n446_));
  oai21  g289(.a(new_n262_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g291(.a(new_n442_), .b(x061), .c(new_n252_), .O(new_n449_));
  nand3  g292(.a(x125), .b(new_n253_), .c(new_n246_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n270_), .O(new_n451_));
  aoi21  g294(.a(new_n449_), .b(new_n257_), .c(new_n451_), .O(new_n452_));
  nand4  g295(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n441_), .O(new_n453_));
  nand4  g296(.a(x125), .b(new_n260_), .c(new_n257_), .d(x013), .O(new_n454_));
  inv1   g297(.a(new_n454_), .O(new_n455_));
  aoi21  g298(.a(new_n453_), .b(new_n277_), .c(new_n455_), .O(new_n456_));
  nand3  g299(.a(x085), .b(new_n257_), .c(new_n245_), .O(new_n457_));
  oai21  g300(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  aoi21  g301(.a(new_n248_), .b(x029), .c(x021), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(x077), .c(new_n245_), .O(new_n460_));
  nand2  g303(.a(new_n460_), .b(new_n445_), .O(new_n461_));
  nand2  g304(.a(x029), .b(new_n246_), .O(new_n462_));
  aoi21  g305(.a(new_n462_), .b(new_n273_), .c(new_n278_), .O(new_n463_));
  nand2  g306(.a(new_n262_), .b(new_n442_), .O(new_n464_));
  nand4  g307(.a(new_n464_), .b(new_n440_), .c(new_n248_), .d(x029), .O(new_n465_));
  inv1   g308(.a(new_n465_), .O(new_n466_));
  oai21  g309(.a(new_n466_), .b(new_n463_), .c(new_n277_), .O(new_n467_));
  ...
  oai21  g315(.a(new_n472_), .b(new_n468_), .c(new_n270_), .O(new_n473_));
  ...
  oai21  g321(.a(new_n478_), .b(x045), .c(new_n175_), .O(z13));
  ...
  oai21  g326(.a(new_n483_), .b(x054), .c(new_n173_), .O(new_n484_));
  oai21  g327(.a(x059), .b(new_n480_), .c(new_n484_), .O(new_n485_));
  ...
  nand3  g358(.a(x086), .b(new_n298_), .c(x006), .O(new_n516_));
  nand3  g359(.a(new_n516_), .b(new_n515_), .c(new_n339_), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(x078), .c(new_n172_), .O(new_n518_));
  inv1   g361(.a(new_n518_), .O(new_n519_));
  aoi21  g362(.a(new_n514_), .b(new_n173_), .c(new_n519_), .O(new_n520_));
