...
module FAU ( 
  ...
  aoi21  g315(.a(x070), .b(x038), .c(new_n298_), .O(new_n472_));
  nand2  g316(.a(new_n304_), .b(x030), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n302_), .c(x086), .O(new_n474_));
  oai22  g318(.a(new_n474_), .b(new_n472_), .c(x118), .d(x110), .O(new_n475_));
  nand3  g319(.a(new_n326_), .b(x070), .c(x030), .O(new_n476_));
  nand3  g320(.a(x102), .b(new_n316_), .c(x006), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n476_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n313_), .O(new_n479_));
  nand2  g323(.a(x022), .b(x014), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(x006), .O(new_n481_));
  oai21  g325(.a(x086), .b(new_n334_), .c(new_n481_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n338_), .O(new_n483_));
  nor2   g327(.a(x126), .b(x102), .O(new_n484_));
  nand4  g328(.a(new_n480_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n485_));
  inv1   g329(.a(x094), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(new_n334_), .c(x006), .O(new_n487_));
  aoi21  g331(.a(new_n487_), .b(new_n485_), .c(new_n484_), .O(new_n488_));
  oai21  g332(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n335_), .O(new_n490_));
  oai22  g334(.a(new_n309_), .b(x110), .c(new_n486_), .d(x062), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(x126), .O(new_n492_));
  aoi21  g336(.a(x030), .b(new_n299_), .c(x086), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(new_n492_), .c(new_n490_), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(x006), .c(new_n488_), .O(new_n495_));
  nand4  g339(.a(new_n495_), .b(new_n483_), .c(new_n479_), .d(new_n475_), .O(new_n496_));
  nand2  g340(.a(x038), .b(x014), .O(new_n497_));
  nand3  g341(.a(new_n497_), .b(x070), .c(x022), .O(new_n498_));
  oai22  g342(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n299_), .O(new_n500_));
  nand2  g344(.a(x030), .b(new_n335_), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n330_), .c(x086), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(x054), .c(x038), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n500_), .c(new_n498_), .O(new_n504_));
  aoi21  g348(.a(new_n496_), .b(new_n300_), .c(new_n504_), .O(new_n505_));
  nor3   g349(.a(new_n505_), .b(x078), .c(x046), .O(z14));
  zero   g350(.O(z17));
  zero   g351(.O(z18));
  zero   g352(.O(z20));
  zero   g353(.O(z21));
