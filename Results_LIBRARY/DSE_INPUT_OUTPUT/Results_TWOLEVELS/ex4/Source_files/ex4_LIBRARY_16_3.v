// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:01 2020
...
module FAU ( 
  ...
  nand2  g140(.a(new_n296_), .b(new_n160_), .O(z05));
  ...
  nand3  g151(.a(new_n307_), .b(new_n304_), .c(new_n158_), .O(new_n308_));
  inv1   g152(.a(new_n308_), .O(new_n309_));
  aoi21  g153(.a(new_n309_), .b(new_n301_), .c(new_n157_), .O(z06));
  inv1   g154(.a(x024), .O(new_n312_));
  nor2   g155(.a(x088), .b(x056), .O(new_n313_));
  nand2  g156(.a(new_n313_), .b(new_n312_), .O(new_n314_));
  oai21  g157(.a(new_n169_), .b(new_n163_), .c(new_n314_), .O(new_n315_));
  inv1   g158(.a(x096), .O(new_n316_));
  inv1   g159(.a(x120), .O(new_n317_));
  aoi21  g160(.a(new_n317_), .b(new_n316_), .c(x088), .O(new_n318_));
  inv1   g161(.a(x104), .O(new_n319_));
  inv1   g162(.a(x112), .O(new_n320_));
  nand2  g163(.a(new_n320_), .b(new_n319_), .O(new_n321_));
  oai21  g164(.a(new_n321_), .b(new_n318_), .c(new_n170_), .O(new_n322_));
  oai21  g165(.a(new_n317_), .b(x104), .c(x032), .O(new_n323_));
  nand2  g166(.a(new_n323_), .b(x112), .O(new_n324_));
  oai21  g167(.a(new_n316_), .b(x056), .c(new_n319_), .O(new_n325_));
  nand3  g168(.a(x120), .b(new_n320_), .c(new_n169_), .O(new_n326_));
  nand2  g169(.a(new_n326_), .b(new_n162_), .O(new_n327_));
  aoi21  g170(.a(new_n325_), .b(new_n164_), .c(new_n327_), .O(new_n328_));
  nand4  g171(.a(new_n328_), .b(new_n324_), .c(new_n322_), .d(new_n315_), .O(new_n329_));
  nor2   g172(.a(x032), .b(new_n163_), .O(new_n330_));
  nor2   g173(.a(new_n317_), .b(x056), .O(new_n331_));
  aoi22  g174(.a(new_n331_), .b(new_n330_), .c(new_n329_), .d(new_n166_), .O(new_n332_));
  nand3  g175(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n333_));
  oai21  g176(.a(new_n332_), .b(x048), .c(new_n333_), .O(new_n334_));
  nand2  g177(.a(x088), .b(x056), .O(new_n335_));
  aoi21  g178(.a(new_n335_), .b(x024), .c(x016), .O(new_n336_));
  oai21  g179(.a(new_n336_), .b(x072), .c(new_n163_), .O(new_n337_));
  nand2  g180(.a(new_n337_), .b(new_n321_), .O(new_n338_));
  nand2  g181(.a(x024), .b(new_n169_), .O(new_n339_));
  aoi21  g182(.a(new_n339_), .b(new_n313_), .c(new_n170_), .O(new_n340_));
  nand2  g183(.a(new_n317_), .b(new_n316_), .O(new_n341_));
  aoi22  g184(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n342_));
  nand3  g185(.a(new_n342_), .b(new_n341_), .c(x024), .O(new_n343_));
  inv1   g186(.a(new_n343_), .O(new_n344_));
  oai21  g187(.a(new_n344_), .b(new_n340_), .c(new_n166_), .O(new_n345_));
  aoi21  g188(.a(new_n345_), .b(new_n338_), .c(x048), .O(new_n346_));
  oai21  g189(.a(new_n169_), .b(new_n163_), .c(x024), .O(new_n347_));
  nand2  g190(.a(new_n347_), .b(new_n313_), .O(new_n348_));
  nand3  g191(.a(new_n348_), .b(new_n166_), .c(x032), .O(new_n349_));
  inv1   g192(.a(new_n349_), .O(new_n350_));
  oai21  g193(.a(new_n350_), .b(new_n346_), .c(new_n162_), .O(new_n351_));
  ...
  nand3  g197(.a(new_n354_), .b(new_n353_), .c(new_n351_), .O(new_n355_));
  aoi21  g198(.a(new_n334_), .b(x000), .c(new_n355_), .O(new_n356_));
  oai21  g199(.a(new_n356_), .b(x040), .c(new_n160_), .O(z08));
  inv1   g200(.a(x041), .O(new_n358_));
  oai22  g201(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n359_));
  nand3  g202(.a(new_n359_), .b(x081), .c(x001), .O(new_n360_));
  oai22  g203(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n361_));
  nand3  g204(.a(new_n361_), .b(x065), .c(x017), .O(new_n362_));
  aoi22  g205(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n363_));
  nand3  g206(.a(new_n363_), .b(new_n362_), .c(new_n360_), .O(new_n364_));
  nand3  g207(.a(new_n364_), .b(new_n160_), .c(new_n358_), .O(new_n365_));
  inv1   g208(.a(new_n365_), .O(z09));
  oai22  g209(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(x082), .c(x002), .O(new_n368_));
  oai22  g211(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n369_));
  nand3  g212(.a(new_n369_), .b(x066), .c(x018), .O(new_n370_));
  aoi22  g213(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n371_));
  nand3  g214(.a(new_n371_), .b(new_n370_), .c(new_n368_), .O(new_n372_));
  inv1   g215(.a(new_n372_), .O(new_n373_));
  oai21  g216(.a(new_n373_), .b(x042), .c(new_n160_), .O(z10));
  oai22  g217(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n375_));
  nand3  g218(.a(new_n375_), .b(x083), .c(x003), .O(new_n376_));
  oai22  g219(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n377_));
  nand3  g220(.a(new_n377_), .b(x067), .c(x019), .O(new_n378_));
  aoi22  g221(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n379_));
  nand3  g222(.a(new_n379_), .b(new_n378_), .c(new_n376_), .O(new_n380_));
  inv1   g223(.a(new_n380_), .O(new_n381_));
  oai21  g224(.a(new_n381_), .b(x043), .c(new_n160_), .O(z11));
  inv1   g225(.a(x044), .O(new_n383_));
  oai22  g226(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n384_));
  nand3  g227(.a(new_n384_), .b(x084), .c(x004), .O(new_n385_));
  oai22  g228(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n386_));
  nand3  g229(.a(new_n386_), .b(x068), .c(x020), .O(new_n387_));
  aoi22  g230(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n388_));
  nand3  g231(.a(new_n388_), .b(new_n387_), .c(new_n385_), .O(new_n389_));
  nand3  g232(.a(new_n389_), .b(new_n160_), .c(new_n383_), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(z12));
  inv1   g234(.a(x045), .O(new_n392_));
  nand2  g235(.a(x021), .b(x013), .O(new_n393_));
  oai21  g236(.a(new_n281_), .b(x029), .c(new_n393_), .O(new_n394_));
  nor2   g237(.a(x125), .b(x101), .O(new_n395_));
  nor2   g238(.a(x117), .b(x109), .O(new_n396_));
  oai21  g239(.a(new_n395_), .b(x093), .c(new_n396_), .O(new_n397_));
  nand2  g240(.a(new_n397_), .b(new_n278_), .O(new_n398_));
  oai21  g241(.a(new_n261_), .b(x109), .c(x037), .O(new_n399_));
  nand2  g242(.a(new_n399_), .b(x117), .O(new_n400_));
  inv1   g243(.a(x101), .O(new_n401_));
  oai21  g244(.a(new_n401_), .b(x061), .c(new_n251_), .O(new_n402_));
  nand3  g245(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n403_));
  nand2  g246(.a(new_n403_), .b(new_n269_), .O(new_n404_));
  aoi21  g247(.a(new_n402_), .b(new_n256_), .c(new_n404_), .O(new_n405_));
  nand4  g248(.a(new_n405_), .b(new_n400_), .c(new_n398_), .d(new_n394_), .O(new_n406_));
  nand4  g249(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n407_));
  inv1   g250(.a(new_n407_), .O(new_n408_));
  aoi21  g251(.a(new_n406_), .b(new_n277_), .c(new_n408_), .O(new_n409_));
  nand3  g252(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n410_));
  oai21  g253(.a(new_n409_), .b(x053), .c(new_n410_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(x005), .O(new_n412_));
  nand2  g255(.a(new_n247_), .b(x029), .O(new_n413_));
  nand2  g256(.a(new_n413_), .b(new_n245_), .O(new_n414_));
  nand2  g257(.a(new_n414_), .b(new_n277_), .O(new_n415_));
  aoi21  g258(.a(new_n415_), .b(new_n244_), .c(new_n396_), .O(new_n416_));
  nor2   g259(.a(new_n243_), .b(x021), .O(new_n417_));
  oai21  g260(.a(new_n417_), .b(new_n281_), .c(x069), .O(new_n418_));
  inv1   g261(.a(new_n395_), .O(new_n419_));
  nand4  g262(.a(new_n419_), .b(new_n393_), .c(new_n247_), .d(x029), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n418_), .c(x077), .O(new_n421_));
  oai21  g264(.a(new_n421_), .b(new_n416_), .c(new_n242_), .O(new_n422_));
  nand2  g265(.a(new_n393_), .b(x029), .O(new_n423_));
  nand2  g266(.a(new_n423_), .b(new_n273_), .O(new_n424_));
  nand3  g267(.a(new_n424_), .b(new_n277_), .c(x037), .O(new_n425_));
  nand2  g268(.a(new_n425_), .b(new_n422_), .O(new_n426_));
  oai22  g269(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n427_));
  nand3  g270(.a(new_n427_), .b(x069), .c(x021), .O(new_n428_));
  aoi22  g271(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n429_));
  nand2  g272(.a(new_n429_), .b(new_n428_), .O(new_n430_));
  aoi21  g273(.a(new_n426_), .b(new_n269_), .c(new_n430_), .O(new_n431_));
  nand2  g274(.a(new_n431_), .b(new_n412_), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(new_n160_), .c(new_n392_), .O(new_n433_));
  inv1   g276(.a(new_n433_), .O(z13));
  oai21  g277(.a(x046), .b(x014), .c(x078), .O(new_n435_));
  inv1   g278(.a(x030), .O(new_n436_));
  nor2   g279(.a(x094), .b(x062), .O(new_n437_));
  nand2  g280(.a(new_n437_), .b(new_n436_), .O(new_n438_));
  oai21  g281(.a(new_n302_), .b(new_n298_), .c(new_n438_), .O(new_n439_));
  inv1   g282(.a(x102), .O(new_n440_));
  inv1   g283(.a(x126), .O(new_n441_));
  aoi21  g284(.a(new_n441_), .b(new_n440_), .c(x094), .O(new_n442_));
  inv1   g285(.a(x110), .O(new_n443_));
  inv1   g286(.a(x118), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n443_), .O(new_n445_));
  oai21  g288(.a(new_n445_), .b(new_n442_), .c(new_n303_), .O(new_n446_));
  oai21  g289(.a(new_n441_), .b(x110), .c(x038), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(x118), .O(new_n448_));
  oai21  g291(.a(new_n440_), .b(x062), .c(new_n443_), .O(new_n449_));
  nand3  g292(.a(x126), .b(new_n444_), .c(new_n302_), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(new_n306_), .O(new_n451_));
  aoi21  g294(.a(new_n449_), .b(new_n299_), .c(new_n451_), .O(new_n452_));
  nand4  g295(.a(new_n452_), .b(new_n448_), .c(new_n446_), .d(new_n439_), .O(new_n453_));
  nor2   g296(.a(x038), .b(new_n298_), .O(new_n454_));
  nor2   g297(.a(new_n441_), .b(x062), .O(new_n455_));
  aoi22  g298(.a(new_n455_), .b(new_n454_), .c(new_n453_), .d(new_n158_), .O(new_n456_));
  nand3  g299(.a(x086), .b(new_n299_), .c(new_n298_), .O(new_n457_));
  oai21  g300(.a(new_n456_), .b(x054), .c(new_n457_), .O(new_n458_));
  nand2  g301(.a(x094), .b(x062), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(x030), .c(x022), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(x078), .c(new_n298_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n445_), .O(new_n462_));
  nand2  g305(.a(new_n299_), .b(x030), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n437_), .c(new_n303_), .O(new_n464_));
  nand2  g307(.a(new_n441_), .b(new_n440_), .O(new_n465_));
  aoi22  g308(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n466_));
  nand3  g309(.a(new_n466_), .b(new_n465_), .c(x030), .O(new_n467_));
  inv1   g310(.a(new_n467_), .O(new_n468_));
  oai21  g311(.a(new_n468_), .b(new_n464_), .c(new_n158_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n462_), .c(x054), .O(new_n470_));
  oai21  g313(.a(new_n302_), .b(new_n298_), .c(x030), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n437_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n158_), .c(x038), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(new_n474_));
  oai21  g317(.a(new_n474_), .b(new_n470_), .c(new_n306_), .O(new_n475_));
  oai22  g318(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n476_));
  nand3  g319(.a(new_n476_), .b(x070), .c(x022), .O(new_n477_));
  nand2  g320(.a(x054), .b(x038), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n477_), .c(new_n475_), .O(new_n479_));
  aoi21  g322(.a(new_n458_), .b(x006), .c(new_n479_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(x046), .c(new_n435_), .O(z14));
  zero   g324(.O(z07));
  zero   g325(.O(z15));
  zero   g326(.O(z16));
  zero   g327(.O(z18));
  ...
  zero   g332(.O(z26));
  zero   g333(.O(z27));
  nor2   g334(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g335(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g336(.a(new_n158_), .b(new_n157_), .O(z25));
endmodule
