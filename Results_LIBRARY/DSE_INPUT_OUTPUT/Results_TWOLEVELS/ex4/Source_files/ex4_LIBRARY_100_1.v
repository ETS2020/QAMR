// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:20 2020
...
module FAU ( 
  ...
  nor2   g145(.a(x022), .b(x014), .O(new_n302_));
  ...
  nand4  g166(.a(new_n318_), .b(x062), .c(x038), .d(new_n299_), .O(new_n323_));
  ...
  oai22  g171(.a(new_n327_), .b(new_n299_), .c(new_n325_), .d(new_n300_), .O(new_n328_));
  ...
  nor2   g179(.a(x030), .b(new_n335_), .O(new_n336_));
  oai21  g180(.a(new_n336_), .b(new_n304_), .c(new_n334_), .O(new_n337_));
  inv1   g181(.a(new_n330_), .O(new_n338_));
  nand4  g182(.a(new_n338_), .b(new_n306_), .c(new_n303_), .d(new_n301_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n337_), .c(new_n157_), .O(new_n340_));
  oai21  g184(.a(new_n340_), .b(new_n333_), .c(x054), .O(new_n341_));
  inv1   g185(.a(new_n304_), .O(new_n342_));
  oai21  g186(.a(new_n302_), .b(x030), .c(new_n342_), .O(new_n343_));
  nand3  g187(.a(new_n343_), .b(x078), .c(new_n313_), .O(new_n344_));
  nand2  g188(.a(new_n344_), .b(new_n341_), .O(new_n345_));
  oai22  g189(.a(new_n157_), .b(new_n313_), .c(new_n300_), .d(new_n299_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n334_), .c(new_n335_), .O(new_n347_));
  aoi22  g191(.a(new_n157_), .b(new_n299_), .c(new_n300_), .d(new_n313_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n347_), .O(new_n349_));
  aoi21  g193(.a(new_n345_), .b(x086), .c(new_n349_), .O(new_n350_));
  aoi21  g194(.a(new_n350_), .b(new_n329_), .c(new_n297_), .O(z06));
  inv1   g195(.a(x024), .O(new_n352_));
  nor2   g196(.a(x088), .b(x056), .O(new_n353_));
  nand2  g197(.a(new_n353_), .b(new_n352_), .O(new_n354_));
  oai21  g198(.a(new_n168_), .b(new_n162_), .c(new_n354_), .O(new_n355_));
  inv1   g199(.a(x096), .O(new_n356_));
  inv1   g200(.a(x120), .O(new_n357_));
  aoi21  g201(.a(new_n357_), .b(new_n356_), .c(x088), .O(new_n358_));
  inv1   g202(.a(x104), .O(new_n359_));
  inv1   g203(.a(x112), .O(new_n360_));
  nand2  g204(.a(new_n360_), .b(new_n359_), .O(new_n361_));
  oai21  g205(.a(new_n361_), .b(new_n358_), .c(new_n169_), .O(new_n362_));
  oai21  g206(.a(new_n357_), .b(x104), .c(x032), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(x112), .O(new_n364_));
  oai21  g208(.a(new_n356_), .b(x056), .c(new_n359_), .O(new_n365_));
  nand3  g209(.a(x120), .b(new_n360_), .c(new_n168_), .O(new_n366_));
  nand2  g210(.a(new_n366_), .b(new_n161_), .O(new_n367_));
  aoi21  g211(.a(new_n365_), .b(new_n163_), .c(new_n367_), .O(new_n368_));
  nand4  g212(.a(new_n368_), .b(new_n364_), .c(new_n362_), .d(new_n355_), .O(new_n369_));
  nor2   g213(.a(x032), .b(new_n162_), .O(new_n370_));
  nor2   g214(.a(new_n357_), .b(x056), .O(new_n371_));
  aoi22  g215(.a(new_n371_), .b(new_n370_), .c(new_n369_), .d(new_n165_), .O(new_n372_));
  nand3  g216(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n373_));
  oai21  g217(.a(new_n372_), .b(x048), .c(new_n373_), .O(new_n374_));
  nand2  g218(.a(x088), .b(x056), .O(new_n375_));
  aoi21  g219(.a(new_n375_), .b(x024), .c(x016), .O(new_n376_));
  oai21  g220(.a(new_n376_), .b(x072), .c(new_n162_), .O(new_n377_));
  nand2  g221(.a(new_n377_), .b(new_n361_), .O(new_n378_));
  nand2  g222(.a(x024), .b(new_n168_), .O(new_n379_));
  aoi21  g223(.a(new_n379_), .b(new_n353_), .c(new_n169_), .O(new_n380_));
  nand2  g224(.a(new_n357_), .b(new_n356_), .O(new_n381_));
  aoi22  g225(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(new_n381_), .c(x024), .O(new_n383_));
  inv1   g227(.a(new_n383_), .O(new_n384_));
  oai21  g228(.a(new_n384_), .b(new_n380_), .c(new_n165_), .O(new_n385_));
  aoi21  g229(.a(new_n385_), .b(new_n378_), .c(x048), .O(new_n386_));
  oai21  g230(.a(new_n168_), .b(new_n162_), .c(x024), .O(new_n387_));
  nand2  g231(.a(new_n387_), .b(new_n353_), .O(new_n388_));
  nand3  g232(.a(new_n388_), .b(new_n165_), .c(x032), .O(new_n389_));
  inv1   g233(.a(new_n389_), .O(new_n390_));
  oai21  g234(.a(new_n390_), .b(new_n386_), .c(new_n161_), .O(new_n391_));
  oai22  g235(.a(x072), .b(x032), .c(x048), .d(x008), .O(new_n392_));
  nand3  g236(.a(new_n392_), .b(x064), .c(x016), .O(new_n393_));
  aoi22  g237(.a(x072), .b(x008), .c(x048), .d(x032), .O(new_n394_));
  nand3  g238(.a(new_n394_), .b(new_n393_), .c(new_n391_), .O(new_n395_));
  aoi21  g239(.a(new_n374_), .b(x000), .c(new_n395_), .O(new_n396_));
  oai21  g240(.a(new_n396_), .b(x040), .c(new_n159_), .O(z08));
  ...
  oai21  g248(.a(new_n404_), .b(x041), .c(new_n159_), .O(z09));
  oai22  g249(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n406_));
  nand3  g250(.a(new_n406_), .b(x082), .c(x002), .O(new_n407_));
  oai22  g251(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n408_));
  nand3  g252(.a(new_n408_), .b(x066), .c(x018), .O(new_n409_));
  ...
  oai21  g256(.a(new_n412_), .b(x042), .c(new_n159_), .O(z10));
  oai22  g257(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n414_));
  nand3  g258(.a(new_n414_), .b(x083), .c(x003), .O(new_n415_));
  oai22  g259(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n416_));
  nand3  g260(.a(new_n416_), .b(x067), .c(x019), .O(new_n417_));
  aoi22  g261(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n418_));
  nand3  g262(.a(new_n418_), .b(new_n417_), .c(new_n415_), .O(new_n419_));
  inv1   g263(.a(new_n419_), .O(new_n420_));
  oai21  g264(.a(new_n420_), .b(x043), .c(new_n159_), .O(z11));
  inv1   g265(.a(x044), .O(new_n422_));
  ...
  nand3  g272(.a(new_n428_), .b(new_n159_), .c(new_n422_), .O(new_n429_));
  inv1   g273(.a(new_n429_), .O(z12));
  inv1   g274(.a(x045), .O(new_n431_));
  nand2  g275(.a(x021), .b(x013), .O(new_n432_));
  oai21  g276(.a(new_n280_), .b(x029), .c(new_n432_), .O(new_n433_));
  nor2   g277(.a(x125), .b(x101), .O(new_n434_));
  nor2   g278(.a(x117), .b(x109), .O(new_n435_));
  oai21  g279(.a(new_n434_), .b(x093), .c(new_n435_), .O(new_n436_));
  nand2  g280(.a(new_n436_), .b(new_n277_), .O(new_n437_));
  oai21  g281(.a(new_n260_), .b(x109), .c(x037), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(x117), .O(new_n439_));
  inv1   g283(.a(x101), .O(new_n440_));
  oai21  g284(.a(new_n440_), .b(x061), .c(new_n250_), .O(new_n441_));
  ...
  nand4  g288(.a(new_n444_), .b(new_n439_), .c(new_n437_), .d(new_n433_), .O(new_n445_));
  ...
  nand2  g294(.a(new_n450_), .b(x005), .O(new_n451_));
  nand2  g295(.a(new_n246_), .b(x029), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(new_n244_), .O(new_n453_));
  nand2  g297(.a(new_n453_), .b(new_n276_), .O(new_n454_));
  aoi21  g298(.a(new_n454_), .b(new_n243_), .c(new_n435_), .O(new_n455_));
  nor2   g299(.a(new_n242_), .b(x021), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(new_n280_), .c(x069), .O(new_n457_));
  inv1   g301(.a(new_n434_), .O(new_n458_));
  nand4  g302(.a(new_n458_), .b(new_n432_), .c(new_n246_), .d(x029), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n457_), .c(x077), .O(new_n460_));
  oai21  g304(.a(new_n460_), .b(new_n455_), .c(new_n241_), .O(new_n461_));
  nand2  g305(.a(new_n432_), .b(x029), .O(new_n462_));
  ...
  oai22  g309(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(x069), .c(x021), .O(new_n467_));
  aoi22  g311(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n467_), .O(new_n469_));
  aoi21  g313(.a(new_n465_), .b(new_n268_), .c(new_n469_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n451_), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n159_), .c(new_n431_), .O(new_n472_));
  inv1   g316(.a(new_n472_), .O(z13));
  oai21  g317(.a(new_n334_), .b(new_n313_), .c(x006), .O(new_n474_));
  oai21  g318(.a(new_n342_), .b(new_n301_), .c(new_n302_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n326_), .O(new_n476_));
  aoi22  g320(.a(new_n476_), .b(new_n474_), .c(new_n309_), .d(new_n308_), .O(new_n477_));
  nand3  g321(.a(new_n326_), .b(x070), .c(x030), .O(new_n478_));
  nand3  g322(.a(x102), .b(new_n316_), .c(x006), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n313_), .O(new_n481_));
  nand2  g325(.a(x022), .b(x014), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x006), .O(new_n483_));
  oai21  g327(.a(x086), .b(new_n334_), .c(new_n483_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n338_), .O(new_n485_));
  nand4  g329(.a(new_n482_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n486_));
  inv1   g330(.a(x094), .O(new_n487_));
  nand3  g331(.a(new_n487_), .b(new_n334_), .c(x006), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(new_n486_), .O(new_n489_));
  oai21  g333(.a(x126), .b(x102), .c(new_n489_), .O(new_n490_));
  nand2  g334(.a(x126), .b(new_n309_), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n301_), .c(x022), .O(new_n492_));
  nand2  g336(.a(x030), .b(new_n299_), .O(new_n493_));
  nand3  g337(.a(x126), .b(x094), .c(new_n316_), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n493_), .c(new_n326_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n492_), .c(x006), .O(new_n496_));
  nand4  g340(.a(new_n496_), .b(new_n490_), .c(new_n485_), .d(new_n481_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n477_), .c(new_n300_), .O(new_n498_));
  nand3  g342(.a(x126), .b(new_n308_), .c(x038), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n326_), .c(new_n298_), .O(new_n500_));
  oai22  g344(.a(new_n327_), .b(new_n301_), .c(new_n334_), .d(new_n335_), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(new_n500_), .c(new_n299_), .O(new_n502_));
  nand2  g346(.a(x030), .b(new_n335_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n330_), .c(x086), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(x054), .c(x038), .O(new_n505_));
  nor2   g349(.a(new_n334_), .b(x038), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(x022), .c(x078), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n505_), .c(new_n502_), .O(new_n508_));
  inv1   g352(.a(new_n508_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n498_), .c(x046), .O(z14));
  zero   g354(.O(z17));
  zero   g355(.O(z20));
  zero   g356(.O(z21));
  zero   g357(.O(z22));
  ...
  zero   g359(.O(z25));
  zero   g360(.O(z27));
  nor2   g361(.a(new_n157_), .b(x046), .O(z15));
  nor2   g362(.a(new_n157_), .b(x046), .O(z16));
  nor2   g363(.a(new_n157_), .b(x046), .O(z18));
  nor2   g364(.a(new_n157_), .b(x046), .O(z19));
  nor2   g365(.a(new_n157_), .b(x046), .O(z24));
  nor2   g366(.a(new_n157_), .b(x046), .O(z26));
endmodule
