...
module FAU ( 
  ...
  nor2   g356(.a(new_n334_), .b(x038), .O(new_n514_));
  aoi21  g357(.a(new_n514_), .b(x022), .c(x078), .O(new_n515_));
  nand3  g358(.a(new_n515_), .b(new_n513_), .c(new_n510_), .O(new_n516_));
  inv1   g359(.a(new_n516_), .O(new_n517_));
  aoi21  g360(.a(new_n517_), .b(new_n506_), .c(x046), .O(z14));
  zero   g361(.O(z07));
  zero   g362(.O(z15));
  zero   g363(.O(z16));
  zero   g364(.O(z17));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z27));
  nor2   g371(.a(new_n157_), .b(x046), .O(z21));
  nor2   g372(.a(new_n157_), .b(x046), .O(z23));
  nor2   g373(.a(new_n157_), .b(x046), .O(z26));
endmodule
