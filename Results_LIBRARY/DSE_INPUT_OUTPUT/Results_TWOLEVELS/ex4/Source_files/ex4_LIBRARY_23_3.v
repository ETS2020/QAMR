// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:14 2020
...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x106), .O(new_n304_));
  ...
  nand3  g256(.a(new_n412_), .b(new_n160_), .c(new_n406_), .O(new_n413_));
  ...
  nand3  g265(.a(new_n421_), .b(new_n160_), .c(new_n415_), .O(new_n422_));
  ...
  nand3  g274(.a(new_n430_), .b(new_n160_), .c(new_n424_), .O(new_n431_));
  ...
  nand3  g283(.a(new_n439_), .b(new_n160_), .c(new_n433_), .O(new_n440_));
  ...
  oai21  g291(.a(new_n447_), .b(new_n445_), .c(new_n278_), .O(new_n448_));
  oai21  g292(.a(new_n262_), .b(x109), .c(x037), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(x117), .O(new_n450_));
  oai21  g294(.a(new_n444_), .b(x061), .c(new_n252_), .O(new_n451_));
  ...
  aoi21  g304(.a(new_n248_), .b(x029), .c(x021), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(x077), .c(new_n245_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n447_), .O(new_n463_));
  nand2  g307(.a(x029), .b(new_n246_), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n273_), .c(new_n278_), .O(new_n465_));
  nand2  g309(.a(new_n262_), .b(new_n444_), .O(new_n466_));
  nand4  g310(.a(new_n466_), .b(new_n442_), .c(new_n248_), .d(x029), .O(new_n467_));
  inv1   g311(.a(new_n467_), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n465_), .c(new_n277_), .O(new_n469_));
  ...
  oai21  g324(.a(new_n480_), .b(x045), .c(new_n160_), .O(z13));
  inv1   g325(.a(x054), .O(new_n482_));
  nand2  g326(.a(x022), .b(x014), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x030), .O(new_n484_));
  aoi21  g328(.a(new_n484_), .b(new_n327_), .c(x086), .O(new_n485_));
  oai21  g329(.a(new_n485_), .b(x054), .c(new_n157_), .O(new_n486_));
  oai21  g330(.a(x106), .b(new_n482_), .c(new_n486_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x038), .O(new_n488_));
  aoi21  g332(.a(x070), .b(x038), .c(new_n344_), .O(new_n489_));
  nand2  g333(.a(new_n300_), .b(x030), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n299_), .c(x086), .O(new_n491_));
  oai22  g335(.a(new_n491_), .b(new_n489_), .c(x118), .d(x110), .O(new_n492_));
  nand3  g336(.a(new_n320_), .b(x070), .c(x030), .O(new_n493_));
  nand3  g337(.a(x102), .b(new_n317_), .c(x006), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n298_), .O(new_n496_));
  aoi22  g340(.a(new_n483_), .b(x006), .c(new_n320_), .d(x070), .O(new_n497_));
  or2    g341(.a(new_n497_), .b(new_n327_), .O(new_n498_));
  nor2   g342(.a(x126), .b(x102), .O(new_n499_));
  nand4  g343(.a(new_n483_), .b(new_n300_), .c(new_n320_), .d(x030), .O(new_n500_));
  inv1   g344(.a(x094), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n330_), .c(x006), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n500_), .c(new_n499_), .O(new_n503_));
  oai21  g347(.a(new_n345_), .b(x118), .c(new_n334_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n331_), .O(new_n505_));
  oai22  g349(.a(new_n313_), .b(x110), .c(new_n501_), .d(x062), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(x126), .O(new_n507_));
  aoi21  g351(.a(x030), .b(new_n339_), .c(x086), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n505_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(x006), .c(new_n503_), .O(new_n510_));
  nand4  g354(.a(new_n510_), .b(new_n498_), .c(new_n496_), .d(new_n492_), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n482_), .O(new_n512_));
  oai22  g356(.a(new_n320_), .b(new_n344_), .c(new_n330_), .d(new_n331_), .O(new_n513_));
  nor2   g357(.a(new_n330_), .b(x038), .O(new_n514_));
  aoi22  g358(.a(new_n514_), .b(x022), .c(new_n513_), .d(new_n339_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  nand3  g360(.a(x070), .b(new_n482_), .c(x022), .O(new_n517_));
  nand3  g361(.a(x086), .b(new_n298_), .c(x006), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n339_), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(new_n158_), .c(x078), .O(new_n520_));
  inv1   g364(.a(new_n520_), .O(new_n521_));
  aoi21  g365(.a(new_n516_), .b(new_n157_), .c(new_n521_), .O(new_n522_));
  ...
  nor2   g376(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g377(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g378(.a(new_n158_), .b(new_n157_), .O(z25));
  nor2   g379(.a(new_n158_), .b(new_n157_), .O(z26));
endmodule
