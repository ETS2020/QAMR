...
module FAU ( 
  ...
  oai22  g072(.a(new_n228_), .b(new_n227_), .c(new_n226_), .d(new_n172_), .O(new_n229_));
  nand3  g073(.a(new_n229_), .b(new_n225_), .c(new_n224_), .O(new_n230_));
  inv1   g074(.a(x020), .O(new_n231_));
  inv1   g075(.a(x068), .O(new_n232_));
  oai22  g076(.a(new_n228_), .b(new_n226_), .c(new_n227_), .d(new_n172_), .O(new_n233_));
  nand3  g077(.a(new_n233_), .b(new_n232_), .c(new_n231_), .O(new_n234_));
  aoi22  g078(.a(new_n228_), .b(new_n172_), .c(new_n227_), .d(new_n226_), .O(new_n235_));
  ...
  nor2   g367(.a(x126), .b(new_n172_), .O(z22));
  nor2   g368(.a(x126), .b(new_n172_), .O(z23));
