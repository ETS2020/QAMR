...
module FAU ( 
  ...
  nor2   g001(.a(x084), .b(new_n157_), .O(z07));
  ...
  oai21  g319(.a(x046), .b(new_n300_), .c(x084), .O(new_n476_));
  ...
  zero   g364(.O(z23));
  zero   g365(.O(z24));
  nor2   g366(.a(x084), .b(new_n157_), .O(z16));
  nor2   g367(.a(x084), .b(new_n157_), .O(z17));
  nor2   g368(.a(x084), .b(new_n157_), .O(z18));
  nor2   g369(.a(x084), .b(new_n157_), .O(z19));
  nor2   g370(.a(x084), .b(new_n157_), .O(z25));
  nor2   g371(.a(x084), .b(new_n157_), .O(z26));
  nor2   g372(.a(x084), .b(new_n157_), .O(z27));
endmodule
