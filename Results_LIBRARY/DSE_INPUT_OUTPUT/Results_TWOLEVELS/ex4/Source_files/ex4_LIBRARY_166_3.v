...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x105), .O(new_n304_));
  ...
  oai21  g263(.a(new_n419_), .b(x042), .c(new_n175_), .O(z10));
  ...
  oai21  g279(.a(new_n435_), .b(x044), .c(new_n175_), .O(z12));
  nand2  g280(.a(x021), .b(x013), .O(new_n437_));
  oai21  g281(.a(new_n281_), .b(x029), .c(new_n437_), .O(new_n438_));
  inv1   g282(.a(x101), .O(new_n439_));
  aoi21  g283(.a(new_n262_), .b(new_n439_), .c(x093), .O(new_n440_));
  nor2   g284(.a(x117), .b(x109), .O(new_n441_));
  inv1   g285(.a(new_n441_), .O(new_n442_));
  oai21  g286(.a(new_n442_), .b(new_n440_), .c(new_n278_), .O(new_n443_));
  oai21  g287(.a(new_n262_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x117), .O(new_n445_));
  oai21  g289(.a(new_n439_), .b(x061), .c(new_n252_), .O(new_n446_));
  ...
  aoi21  g299(.a(new_n248_), .b(x029), .c(x021), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(x077), .c(new_n245_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n442_), .O(new_n458_));
  nand2  g302(.a(x029), .b(new_n246_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n273_), .c(new_n278_), .O(new_n460_));
  nand2  g304(.a(new_n262_), .b(new_n439_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n437_), .c(new_n248_), .d(x029), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n460_), .c(new_n277_), .O(new_n464_));
  ...
  oai21  g313(.a(new_n469_), .b(new_n465_), .c(new_n270_), .O(new_n470_));
  ...
  aoi21  g323(.a(new_n479_), .b(new_n327_), .c(x086), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(x054), .c(new_n172_), .O(new_n481_));
  oai21  g325(.a(x105), .b(new_n477_), .c(new_n481_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x038), .O(new_n483_));
  aoi21  g327(.a(x070), .b(x038), .c(new_n344_), .O(new_n484_));
  nand2  g328(.a(new_n300_), .b(x030), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n299_), .c(x086), .O(new_n486_));
  oai22  g330(.a(new_n486_), .b(new_n484_), .c(x118), .d(x110), .O(new_n487_));
  nand3  g331(.a(new_n320_), .b(x070), .c(x030), .O(new_n488_));
  nand3  g332(.a(x102), .b(new_n317_), .c(x006), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n488_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n298_), .O(new_n491_));
  aoi22  g335(.a(new_n478_), .b(x006), .c(new_n320_), .d(x070), .O(new_n492_));
  or2    g336(.a(new_n492_), .b(new_n327_), .O(new_n493_));
  nor2   g337(.a(x126), .b(x102), .O(new_n494_));
  nand4  g338(.a(new_n478_), .b(new_n300_), .c(new_n320_), .d(x030), .O(new_n495_));
  inv1   g339(.a(x094), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n330_), .c(x006), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n495_), .c(new_n494_), .O(new_n498_));
  oai21  g342(.a(new_n345_), .b(x118), .c(new_n334_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n331_), .O(new_n500_));
  oai22  g344(.a(new_n313_), .b(x110), .c(new_n496_), .d(x062), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(x126), .O(new_n502_));
  aoi21  g346(.a(x030), .b(new_n339_), .c(x086), .O(new_n503_));
  ...
  oai22  g351(.a(new_n320_), .b(new_n344_), .c(new_n330_), .d(new_n331_), .O(new_n508_));
  nor2   g352(.a(new_n330_), .b(x038), .O(new_n509_));
  aoi22  g353(.a(new_n509_), .b(x022), .c(new_n508_), .d(new_n339_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n507_), .O(new_n511_));
  nand3  g355(.a(x070), .b(new_n477_), .c(x022), .O(new_n512_));
  nand3  g356(.a(x086), .b(new_n298_), .c(x006), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n512_), .c(new_n339_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n173_), .c(x078), .O(new_n515_));
  inv1   g359(.a(new_n515_), .O(new_n516_));
  aoi21  g360(.a(new_n511_), .b(new_n172_), .c(new_n516_), .O(new_n517_));
  ...
  zero   g368(.O(z26));
  zero   g369(.O(z27));
  nor2   g370(.a(new_n173_), .b(new_n172_), .O(z16));
