// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:45 2020
...
module FAU ( 
  ...
  oai21  g195(.a(new_n168_), .b(new_n162_), .c(new_n351_), .O(new_n352_));
  ...
  oai21  g202(.a(new_n358_), .b(new_n355_), .c(new_n169_), .O(new_n359_));
  ...
  nand3  g206(.a(x120), .b(new_n357_), .c(new_n168_), .O(new_n363_));
  nand2  g207(.a(new_n363_), .b(new_n161_), .O(new_n364_));
  aoi21  g208(.a(new_n362_), .b(new_n163_), .c(new_n364_), .O(new_n365_));
  nand4  g209(.a(new_n365_), .b(new_n361_), .c(new_n359_), .d(new_n352_), .O(new_n366_));
  nor2   g210(.a(x032), .b(new_n162_), .O(new_n367_));
  nor2   g211(.a(new_n354_), .b(x056), .O(new_n368_));
  aoi22  g212(.a(new_n368_), .b(new_n367_), .c(new_n366_), .d(new_n165_), .O(new_n369_));
  nand3  g213(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n370_));
  ...
  oai21  g217(.a(new_n373_), .b(x072), .c(new_n162_), .O(new_n374_));
  nand2  g218(.a(new_n374_), .b(new_n358_), .O(new_n375_));
  nand2  g219(.a(x024), .b(new_n168_), .O(new_n376_));
  aoi21  g220(.a(new_n376_), .b(new_n350_), .c(new_n169_), .O(new_n377_));
  ...
  oai21  g225(.a(new_n381_), .b(new_n377_), .c(new_n165_), .O(new_n382_));
  aoi21  g226(.a(new_n382_), .b(new_n375_), .c(x048), .O(new_n383_));
  oai21  g227(.a(new_n168_), .b(new_n162_), .c(x024), .O(new_n384_));
  nand2  g228(.a(new_n384_), .b(new_n350_), .O(new_n385_));
  nand3  g229(.a(new_n385_), .b(new_n165_), .c(x032), .O(new_n386_));
  ...
  oai21  g237(.a(new_n393_), .b(x040), .c(new_n159_), .O(z08));
  ...
  nand3  g245(.a(new_n401_), .b(new_n159_), .c(new_n395_), .O(new_n402_));
  ...
  nand3  g254(.a(new_n410_), .b(new_n159_), .c(new_n404_), .O(new_n411_));
  ...
  nand3  g263(.a(new_n419_), .b(new_n159_), .c(new_n413_), .O(new_n420_));
  inv1   g264(.a(new_n420_), .O(z11));
  ...
  oai21  g317(.a(new_n306_), .b(x030), .c(new_n307_), .O(new_n474_));
  nand2  g318(.a(new_n317_), .b(new_n313_), .O(new_n475_));
  oai22  g319(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n475_), .O(new_n477_));
  oai22  g321(.a(x118), .b(x110), .c(new_n300_), .d(new_n299_), .O(new_n478_));
  nand2  g322(.a(x118), .b(new_n297_), .O(new_n479_));
  oai21  g323(.a(x118), .b(x022), .c(new_n479_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(x126), .c(x086), .O(new_n481_));
  nand4  g325(.a(new_n481_), .b(new_n478_), .c(new_n477_), .d(new_n474_), .O(new_n482_));
  nand3  g326(.a(new_n482_), .b(new_n343_), .c(new_n339_), .O(new_n483_));
  nand4  g327(.a(x086), .b(new_n157_), .c(new_n299_), .d(new_n318_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(x006), .O(new_n486_));
  nor2   g330(.a(new_n325_), .b(new_n303_), .O(new_n487_));
  oai22  g331(.a(new_n487_), .b(new_n320_), .c(x118), .d(x110), .O(new_n488_));
  nor2   g332(.a(x038), .b(new_n303_), .O(new_n489_));
  oai21  g333(.a(new_n489_), .b(new_n306_), .c(x070), .O(new_n490_));
  nand4  g334(.a(new_n475_), .b(new_n326_), .c(new_n307_), .d(x030), .O(new_n491_));
  nand3  g335(.a(new_n491_), .b(new_n490_), .c(new_n488_), .O(new_n492_));
  aoi21  g336(.a(new_n307_), .b(x030), .c(new_n306_), .O(new_n493_));
  nor2   g337(.a(new_n493_), .b(new_n299_), .O(new_n494_));
  aoi21  g338(.a(new_n492_), .b(new_n339_), .c(new_n494_), .O(new_n495_));
  nor2   g339(.a(new_n300_), .b(x038), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(x022), .c(x046), .O(new_n497_));
  oai21  g341(.a(new_n495_), .b(x086), .c(new_n497_), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n343_), .O(new_n499_));
  nand2  g343(.a(x054), .b(x038), .O(new_n500_));
  nand4  g344(.a(x070), .b(new_n339_), .c(x022), .d(new_n318_), .O(new_n501_));
  nand2  g345(.a(x078), .b(x014), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n501_), .c(new_n500_), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(new_n157_), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n499_), .c(new_n486_), .O(z14));
  zero   g349(.O(z15));
  zero   g350(.O(z21));
  zero   g351(.O(z23));
  nor2   g352(.a(x078), .b(new_n157_), .O(z16));
  nor2   g353(.a(x078), .b(new_n157_), .O(z17));
  nor2   g354(.a(x078), .b(new_n157_), .O(z18));
  nor2   g355(.a(x078), .b(new_n157_), .O(z19));
  nor2   g356(.a(x078), .b(new_n157_), .O(z20));
  nor2   g357(.a(x078), .b(new_n157_), .O(z22));
  nor2   g358(.a(x078), .b(new_n157_), .O(z24));
  nor2   g359(.a(x078), .b(new_n157_), .O(z25));
  nor2   g360(.a(x078), .b(new_n157_), .O(z26));
  nor2   g361(.a(x078), .b(new_n157_), .O(z27));
endmodule
