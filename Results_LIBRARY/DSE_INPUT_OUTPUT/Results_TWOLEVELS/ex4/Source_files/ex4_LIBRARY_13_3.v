...
module FAU ( 
  ...
  oai21  g049(.a(new_n205_), .b(new_n195_), .c(new_n172_), .O(new_n206_));
  nand2  g050(.a(new_n205_), .b(new_n173_), .O(new_n207_));
  ...
  nand2  g262(.a(new_n419_), .b(new_n193_), .O(new_n420_));
  nand2  g263(.a(new_n420_), .b(new_n175_), .O(z10));
  ...
  nand2  g346(.a(new_n173_), .b(new_n483_), .O(new_n504_));
  ...
  oai21  g362(.a(new_n519_), .b(x046), .c(new_n175_), .O(z14));
  zero   g363(.O(z07));
  zero   g364(.O(z17));
  zero   g365(.O(z18));
  zero   g366(.O(z20));
  ...
  zero   g369(.O(z24));
  zero   g370(.O(z25));
  nor2   g371(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z19));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z26));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z27));
endmodule
