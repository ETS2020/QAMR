// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:02 2020
...
module FAU ( 
  ...
  nand3  g213(.a(x120), .b(new_n370_), .c(new_n165_), .O(new_n371_));
  nand2  g214(.a(new_n371_), .b(new_n158_), .O(new_n372_));
  aoi21  g215(.a(new_n369_), .b(new_n160_), .c(new_n372_), .O(new_n373_));
  nand4  g216(.a(new_n373_), .b(new_n366_), .c(new_n363_), .d(new_n359_), .O(new_n374_));
  nand4  g217(.a(x120), .b(new_n356_), .c(new_n160_), .d(x008), .O(new_n375_));
  ...
  aoi21  g227(.a(new_n384_), .b(new_n159_), .c(new_n361_), .O(new_n385_));
  ...
  oai21  g234(.a(new_n391_), .b(new_n385_), .c(new_n161_), .O(new_n392_));
  nand2  g235(.a(new_n355_), .b(x024), .O(new_n393_));
  nand3  g236(.a(new_n393_), .b(new_n357_), .c(new_n356_), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(new_n162_), .c(x032), .O(new_n395_));
  ...
  aoi21  g243(.a(new_n396_), .b(new_n158_), .c(new_n400_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n380_), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(x126), .c(new_n354_), .O(new_n403_));
  ...
  inv1   g282(.a(x045), .O(new_n440_));
  nand2  g283(.a(x021), .b(x013), .O(new_n441_));
  oai21  g284(.a(new_n279_), .b(x029), .c(new_n441_), .O(new_n442_));
  nor2   g285(.a(x125), .b(x101), .O(new_n443_));
  nor2   g286(.a(x117), .b(x109), .O(new_n444_));
  oai21  g287(.a(new_n443_), .b(x093), .c(new_n444_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n276_), .O(new_n446_));
  oai21  g289(.a(new_n259_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(x117), .O(new_n448_));
  inv1   g291(.a(x101), .O(new_n449_));
  oai21  g292(.a(new_n449_), .b(x061), .c(new_n249_), .O(new_n450_));
  nand3  g293(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n267_), .O(new_n452_));
  aoi21  g295(.a(new_n450_), .b(new_n254_), .c(new_n452_), .O(new_n453_));
  nand4  g296(.a(new_n453_), .b(new_n448_), .c(new_n446_), .d(new_n442_), .O(new_n454_));
  nand4  g297(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(new_n456_));
  aoi21  g299(.a(new_n454_), .b(new_n275_), .c(new_n456_), .O(new_n457_));
  nand3  g300(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n458_));
  oai21  g301(.a(new_n457_), .b(x053), .c(new_n458_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(x005), .O(new_n460_));
  nand2  g303(.a(new_n245_), .b(x029), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n243_), .O(new_n462_));
  nand2  g305(.a(new_n462_), .b(new_n275_), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n242_), .c(new_n444_), .O(new_n464_));
  nor2   g307(.a(new_n241_), .b(x021), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n279_), .c(x069), .O(new_n466_));
  inv1   g309(.a(new_n443_), .O(new_n467_));
  nand4  g310(.a(new_n467_), .b(new_n441_), .c(new_n245_), .d(x029), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n466_), .c(x077), .O(new_n469_));
  oai21  g312(.a(new_n469_), .b(new_n464_), .c(new_n240_), .O(new_n470_));
  nand2  g313(.a(new_n441_), .b(x029), .O(new_n471_));
  nand2  g314(.a(new_n471_), .b(new_n271_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n275_), .c(x037), .O(new_n473_));
  ...
  aoi21  g321(.a(new_n474_), .b(new_n267_), .c(new_n478_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n460_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(new_n173_), .c(new_n440_), .O(new_n481_));
  inv1   g324(.a(new_n481_), .O(z13));
  oai22  g325(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n483_));
  inv1   g326(.a(x102), .O(new_n484_));
  aoi21  g327(.a(new_n316_), .b(new_n484_), .c(x094), .O(new_n485_));
  nand2  g328(.a(new_n307_), .b(new_n306_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n485_), .c(new_n333_), .O(new_n487_));
  oai21  g330(.a(new_n316_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(x118), .O(new_n489_));
  oai21  g332(.a(new_n484_), .b(x062), .c(new_n306_), .O(new_n490_));
  nand3  g333(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n324_), .O(new_n492_));
  aoi21  g335(.a(new_n490_), .b(new_n311_), .c(new_n492_), .O(new_n493_));
  nand4  g336(.a(new_n493_), .b(new_n489_), .c(new_n487_), .d(new_n483_), .O(new_n494_));
  nand4  g337(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n495_));
  inv1   g338(.a(new_n495_), .O(new_n496_));
  aoi21  g339(.a(new_n494_), .b(new_n332_), .c(new_n496_), .O(new_n497_));
  nand3  g340(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n498_));
  oai21  g341(.a(new_n497_), .b(x054), .c(new_n498_), .O(new_n499_));
  aoi21  g342(.a(new_n302_), .b(x030), .c(x022), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(x078), .c(new_n299_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n486_), .O(new_n502_));
  nand2  g345(.a(x030), .b(new_n300_), .O(new_n503_));
  aoi21  g346(.a(new_n503_), .b(new_n328_), .c(new_n333_), .O(new_n504_));
  nand2  g347(.a(new_n316_), .b(new_n484_), .O(new_n505_));
  ...
  oai21  g351(.a(new_n508_), .b(new_n504_), .c(new_n332_), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(new_n502_), .c(x054), .O(new_n510_));
  oai21  g353(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n511_));
  nand2  g354(.a(new_n511_), .b(new_n328_), .O(new_n512_));
  nand3  g355(.a(new_n512_), .b(new_n332_), .c(x038), .O(new_n513_));
  inv1   g356(.a(new_n513_), .O(new_n514_));
  oai21  g357(.a(new_n514_), .b(new_n510_), .c(new_n324_), .O(new_n515_));
  ...
  oai21  g363(.a(new_n520_), .b(x046), .c(new_n173_), .O(z14));
  zero   g364(.O(z07));
  zero   g365(.O(z15));
  zero   g366(.O(z18));
  zero   g367(.O(z25));
  zero   g368(.O(z26));
  nor2   g369(.a(x126), .b(x040), .O(z17));
  nor2   g370(.a(x126), .b(x040), .O(z19));
  nor2   g371(.a(x126), .b(x040), .O(z20));
  nor2   g372(.a(x126), .b(x040), .O(z21));
  nor2   g373(.a(x126), .b(x040), .O(z22));
  nor2   g374(.a(x126), .b(x040), .O(z23));
  nor2   g375(.a(x126), .b(x040), .O(z24));
  nor2   g376(.a(x126), .b(x040), .O(z27));
endmodule
