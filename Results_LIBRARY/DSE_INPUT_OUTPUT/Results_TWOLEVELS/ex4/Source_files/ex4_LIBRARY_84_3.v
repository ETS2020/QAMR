...
module FAU ( 
  ...
  nand3  g324(.a(x126), .b(new_n312_), .c(x006), .O(new_n481_));
  oai21  g325(.a(x086), .b(new_n300_), .c(new_n481_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n301_), .O(new_n483_));
  oai21  g327(.a(new_n300_), .b(x022), .c(new_n335_), .O(new_n484_));
  aoi21  g328(.a(new_n484_), .b(new_n325_), .c(x054), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n483_), .c(x078), .O(new_n486_));
  nor2   g330(.a(new_n299_), .b(x015), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n486_), .c(x038), .O(new_n488_));
  oai21  g332(.a(new_n329_), .b(new_n311_), .c(x006), .O(new_n489_));
  nor2   g333(.a(new_n342_), .b(new_n300_), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(new_n303_), .c(new_n325_), .O(new_n491_));
  aoi22  g335(.a(new_n491_), .b(new_n489_), .c(new_n310_), .d(new_n312_), .O(new_n492_));
  nand3  g336(.a(new_n325_), .b(x070), .c(x030), .O(new_n493_));
  nand3  g337(.a(x102), .b(new_n315_), .c(x006), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n311_), .O(new_n496_));
  nand2  g340(.a(x022), .b(x014), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(x006), .O(new_n498_));
  oai21  g342(.a(x086), .b(new_n329_), .c(new_n498_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n339_), .O(new_n500_));
  nand4  g344(.a(new_n497_), .b(new_n304_), .c(new_n325_), .d(x030), .O(new_n501_));
  nand3  g345(.a(new_n306_), .b(new_n329_), .c(x006), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n501_), .O(new_n503_));
  oai21  g347(.a(x126), .b(x102), .c(new_n503_), .O(new_n504_));
  nand2  g348(.a(x126), .b(new_n310_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n300_), .c(x022), .O(new_n506_));
  nand2  g350(.a(x030), .b(new_n301_), .O(new_n507_));
  nand3  g351(.a(x126), .b(x094), .c(new_n315_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n507_), .c(new_n325_), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(new_n506_), .c(x006), .O(new_n510_));
  nand4  g354(.a(new_n510_), .b(new_n504_), .c(new_n500_), .d(new_n496_), .O(new_n511_));
  oai21  g355(.a(new_n511_), .b(new_n492_), .c(new_n299_), .O(new_n512_));
  oai22  g356(.a(new_n325_), .b(new_n298_), .c(new_n329_), .d(new_n302_), .O(new_n513_));
  nor2   g357(.a(new_n329_), .b(x038), .O(new_n514_));
  aoi22  g358(.a(new_n514_), .b(x022), .c(new_n513_), .d(new_n301_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  nand3  g360(.a(x070), .b(new_n299_), .c(x022), .O(new_n517_));
  nand3  g361(.a(x086), .b(new_n311_), .c(x006), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n301_), .O(new_n519_));
  nand3  g363(.a(new_n519_), .b(x078), .c(new_n157_), .O(new_n520_));
  inv1   g364(.a(new_n520_), .O(new_n521_));
  aoi21  g365(.a(new_n516_), .b(new_n158_), .c(new_n521_), .O(new_n522_));
  ...
  nor2   g377(.a(new_n158_), .b(new_n157_), .O(z18));
