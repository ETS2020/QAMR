...
module FAU ( 
  ...
  oai22  g331(.a(new_n333_), .b(x030), .c(new_n319_), .d(new_n327_), .O(new_n488_));
  aoi21  g332(.a(new_n157_), .b(new_n347_), .c(x094), .O(new_n489_));
  inv1   g333(.a(x110), .O(new_n490_));
  nand2  g334(.a(new_n357_), .b(new_n490_), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n489_), .c(new_n311_), .O(new_n492_));
  oai21  g336(.a(new_n157_), .b(x110), .c(x038), .O(new_n493_));
  nand2  g337(.a(new_n493_), .b(x118), .O(new_n494_));
  oai21  g338(.a(new_n347_), .b(x062), .c(new_n490_), .O(new_n495_));
  nand3  g339(.a(x126), .b(new_n357_), .c(new_n319_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n302_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n315_), .c(new_n497_), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n494_), .c(new_n492_), .d(new_n488_), .O(new_n499_));
  nand4  g343(.a(x126), .b(new_n331_), .c(new_n315_), .d(x014), .O(new_n500_));
  inv1   g344(.a(new_n500_), .O(new_n501_));
  aoi21  g345(.a(new_n499_), .b(new_n304_), .c(new_n501_), .O(new_n502_));
  nand3  g346(.a(x086), .b(new_n315_), .c(new_n327_), .O(new_n503_));
  oai21  g347(.a(new_n502_), .b(x054), .c(new_n503_), .O(new_n504_));
  aoi21  g348(.a(new_n312_), .b(x030), .c(x022), .O(new_n505_));
  oai21  g349(.a(new_n505_), .b(x078), .c(new_n327_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n491_), .O(new_n507_));
  nor2   g351(.a(x094), .b(x062), .O(new_n508_));
  nand2  g352(.a(x030), .b(new_n319_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n508_), .c(new_n311_), .O(new_n510_));
  nand2  g354(.a(new_n157_), .b(new_n347_), .O(new_n511_));
  ...
  oai21  g360(.a(new_n319_), .b(new_n327_), .c(x030), .O(new_n517_));
  nand2  g361(.a(new_n517_), .b(new_n508_), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n304_), .c(x038), .O(new_n519_));
  inv1   g363(.a(new_n519_), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(new_n516_), .c(new_n302_), .O(new_n521_));
  ...
  and2   g368(.a(new_n524_), .b(new_n523_), .O(new_n525_));
  nand2  g369(.a(new_n525_), .b(new_n521_), .O(new_n526_));
  aoi21  g370(.a(new_n504_), .b(x006), .c(new_n526_), .O(new_n527_));
  oai21  g371(.a(new_n527_), .b(x046), .c(new_n159_), .O(z14));
  zero   g372(.O(z16));
  zero   g373(.O(z18));
  zero   g374(.O(z20));
  zero   g375(.O(z23));
  zero   g376(.O(z25));
  nor2   g377(.a(new_n157_), .b(x117), .O(z15));
  nor2   g378(.a(new_n157_), .b(x117), .O(z17));
  nor2   g379(.a(new_n157_), .b(x117), .O(z19));
  nor2   g380(.a(new_n157_), .b(x117), .O(z21));
  nor2   g381(.a(new_n157_), .b(x117), .O(z22));
  nor2   g382(.a(new_n157_), .b(x117), .O(z24));
