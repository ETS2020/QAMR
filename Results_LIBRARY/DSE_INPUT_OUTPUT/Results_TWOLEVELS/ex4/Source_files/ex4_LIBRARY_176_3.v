// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:14 2020
...
module FAU ( 
  ...
  nor2   g160(.a(x120), .b(x096), .O(new_n318_));
  nor2   g161(.a(x112), .b(x104), .O(new_n319_));
  oai21  g162(.a(new_n318_), .b(x088), .c(new_n319_), .O(new_n320_));
  nand2  g163(.a(new_n320_), .b(new_n166_), .O(new_n321_));
  inv1   g164(.a(x120), .O(new_n322_));
  oai21  g165(.a(new_n322_), .b(x104), .c(x032), .O(new_n323_));
  nand2  g166(.a(new_n323_), .b(x112), .O(new_n324_));
  inv1   g167(.a(x096), .O(new_n325_));
  inv1   g168(.a(x104), .O(new_n326_));
  oai21  g169(.a(new_n325_), .b(x056), .c(new_n326_), .O(new_n327_));
  inv1   g170(.a(x112), .O(new_n328_));
  nand3  g171(.a(x120), .b(new_n328_), .c(new_n165_), .O(new_n329_));
  nand2  g172(.a(new_n329_), .b(new_n158_), .O(new_n330_));
  aoi21  g173(.a(new_n327_), .b(new_n160_), .c(new_n330_), .O(new_n331_));
  nand4  g174(.a(new_n331_), .b(new_n324_), .c(new_n321_), .d(new_n317_), .O(new_n332_));
  nand4  g175(.a(x120), .b(new_n314_), .c(new_n160_), .d(x008), .O(new_n333_));
  inv1   g176(.a(new_n333_), .O(new_n334_));
  aoi21  g177(.a(new_n332_), .b(new_n162_), .c(new_n334_), .O(new_n335_));
  nand3  g178(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n336_));
  oai21  g179(.a(new_n335_), .b(x048), .c(new_n336_), .O(new_n337_));
  nand2  g180(.a(new_n337_), .b(x000), .O(new_n338_));
  ...
  aoi21  g185(.a(new_n342_), .b(new_n159_), .c(new_n319_), .O(new_n343_));
  inv1   g186(.a(x024), .O(new_n344_));
  nor2   g187(.a(new_n344_), .b(x016), .O(new_n345_));
  oai21  g188(.a(new_n345_), .b(new_n316_), .c(x064), .O(new_n346_));
  inv1   g189(.a(new_n318_), .O(new_n347_));
  nand4  g190(.a(new_n339_), .b(new_n347_), .c(new_n313_), .d(x024), .O(new_n348_));
  aoi21  g191(.a(new_n348_), .b(new_n346_), .c(x072), .O(new_n349_));
  oai21  g192(.a(new_n349_), .b(new_n343_), .c(new_n161_), .O(new_n350_));
  nand2  g193(.a(new_n313_), .b(x024), .O(new_n351_));
  nand3  g194(.a(new_n351_), .b(new_n315_), .c(new_n314_), .O(new_n352_));
  nand3  g195(.a(new_n352_), .b(new_n162_), .c(x032), .O(new_n353_));
  ...
  aoi21  g201(.a(new_n354_), .b(new_n158_), .c(new_n358_), .O(new_n359_));
  nand2  g202(.a(new_n359_), .b(new_n338_), .O(new_n360_));
  nand3  g203(.a(new_n360_), .b(new_n175_), .c(new_n312_), .O(new_n361_));
  inv1   g204(.a(new_n361_), .O(z08));
  oai22  g205(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n363_));
  nand3  g206(.a(new_n363_), .b(x081), .c(x001), .O(new_n364_));
  oai22  g207(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n365_));
  nand3  g208(.a(new_n365_), .b(x065), .c(x017), .O(new_n366_));
  aoi22  g209(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n367_));
  nand3  g210(.a(new_n367_), .b(new_n366_), .c(new_n364_), .O(new_n368_));
  inv1   g211(.a(new_n368_), .O(new_n369_));
  oai21  g212(.a(new_n369_), .b(x041), .c(new_n175_), .O(z09));
  inv1   g213(.a(x042), .O(new_n371_));
  ...
  nand3  g220(.a(new_n377_), .b(new_n175_), .c(new_n371_), .O(new_n378_));
  inv1   g221(.a(new_n378_), .O(z10));
  inv1   g222(.a(x043), .O(new_n380_));
  oai22  g223(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n381_));
  nand3  g224(.a(new_n381_), .b(x083), .c(x003), .O(new_n382_));
  oai22  g225(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n383_));
  nand3  g226(.a(new_n383_), .b(x067), .c(x019), .O(new_n384_));
  aoi22  g227(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n385_));
  nand3  g228(.a(new_n385_), .b(new_n384_), .c(new_n382_), .O(new_n386_));
  nand3  g229(.a(new_n386_), .b(new_n175_), .c(new_n380_), .O(new_n387_));
  inv1   g230(.a(new_n387_), .O(z11));
  ...
  oai21  g238(.a(new_n395_), .b(x044), .c(new_n175_), .O(z12));
  inv1   g239(.a(x045), .O(new_n397_));
  nand2  g240(.a(x021), .b(x013), .O(new_n398_));
  oai21  g241(.a(new_n281_), .b(x029), .c(new_n398_), .O(new_n399_));
  ...
  nand2  g245(.a(new_n402_), .b(new_n278_), .O(new_n403_));
  oai21  g246(.a(new_n261_), .b(x109), .c(x037), .O(new_n404_));
  nand2  g247(.a(new_n404_), .b(x117), .O(new_n405_));
  inv1   g248(.a(x101), .O(new_n406_));
  oai21  g249(.a(new_n406_), .b(x061), .c(new_n251_), .O(new_n407_));
  nand3  g250(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n408_));
  nand2  g251(.a(new_n408_), .b(new_n269_), .O(new_n409_));
  aoi21  g252(.a(new_n407_), .b(new_n256_), .c(new_n409_), .O(new_n410_));
  nand4  g253(.a(new_n410_), .b(new_n405_), .c(new_n403_), .d(new_n399_), .O(new_n411_));
  nand4  g254(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n412_));
  inv1   g255(.a(new_n412_), .O(new_n413_));
  aoi21  g256(.a(new_n411_), .b(new_n277_), .c(new_n413_), .O(new_n414_));
  nand3  g257(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n415_));
  oai21  g258(.a(new_n414_), .b(x053), .c(new_n415_), .O(new_n416_));
  nand2  g259(.a(new_n416_), .b(x005), .O(new_n417_));
  nand2  g260(.a(new_n247_), .b(x029), .O(new_n418_));
  nand2  g261(.a(new_n418_), .b(new_n245_), .O(new_n419_));
  nand2  g262(.a(new_n419_), .b(new_n277_), .O(new_n420_));
  aoi21  g263(.a(new_n420_), .b(new_n244_), .c(new_n401_), .O(new_n421_));
  nor2   g264(.a(new_n243_), .b(x021), .O(new_n422_));
  oai21  g265(.a(new_n422_), .b(new_n281_), .c(x069), .O(new_n423_));
  inv1   g266(.a(new_n400_), .O(new_n424_));
  nand4  g267(.a(new_n424_), .b(new_n398_), .c(new_n247_), .d(x029), .O(new_n425_));
  aoi21  g268(.a(new_n425_), .b(new_n423_), .c(x077), .O(new_n426_));
  oai21  g269(.a(new_n426_), .b(new_n421_), .c(new_n242_), .O(new_n427_));
  nand2  g270(.a(new_n398_), .b(x029), .O(new_n428_));
  nand2  g271(.a(new_n428_), .b(new_n273_), .O(new_n429_));
  nand3  g272(.a(new_n429_), .b(new_n277_), .c(x037), .O(new_n430_));
  nand2  g273(.a(new_n430_), .b(new_n427_), .O(new_n431_));
  oai22  g274(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n432_));
  nand3  g275(.a(new_n432_), .b(x069), .c(x021), .O(new_n433_));
  aoi22  g276(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n434_));
  nand2  g277(.a(new_n434_), .b(new_n433_), .O(new_n435_));
  aoi21  g278(.a(new_n431_), .b(new_n269_), .c(new_n435_), .O(new_n436_));
  nand2  g279(.a(new_n436_), .b(new_n417_), .O(new_n437_));
  nand3  g280(.a(new_n437_), .b(new_n175_), .c(new_n397_), .O(new_n438_));
  inv1   g281(.a(new_n438_), .O(z13));
  oai21  g282(.a(x046), .b(x014), .c(x078), .O(new_n440_));
  inv1   g283(.a(x030), .O(new_n441_));
  nor2   g284(.a(x094), .b(x062), .O(new_n442_));
  nand2  g285(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  oai21  g286(.a(new_n302_), .b(new_n298_), .c(new_n443_), .O(new_n444_));
  inv1   g287(.a(x102), .O(new_n445_));
  inv1   g288(.a(x126), .O(new_n446_));
  aoi21  g289(.a(new_n446_), .b(new_n445_), .c(x094), .O(new_n447_));
  inv1   g290(.a(x110), .O(new_n448_));
  inv1   g291(.a(x118), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n448_), .O(new_n450_));
  oai21  g293(.a(new_n450_), .b(new_n447_), .c(new_n303_), .O(new_n451_));
  oai21  g294(.a(new_n446_), .b(x110), .c(x038), .O(new_n452_));
  nand2  g295(.a(new_n452_), .b(x118), .O(new_n453_));
  oai21  g296(.a(new_n445_), .b(x062), .c(new_n448_), .O(new_n454_));
  nand3  g297(.a(x126), .b(new_n449_), .c(new_n302_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n306_), .O(new_n456_));
  aoi21  g299(.a(new_n454_), .b(new_n299_), .c(new_n456_), .O(new_n457_));
  nand4  g300(.a(new_n457_), .b(new_n453_), .c(new_n451_), .d(new_n444_), .O(new_n458_));
  nor2   g301(.a(x038), .b(new_n298_), .O(new_n459_));
  nor2   g302(.a(new_n446_), .b(x062), .O(new_n460_));
  aoi22  g303(.a(new_n460_), .b(new_n459_), .c(new_n458_), .d(new_n173_), .O(new_n461_));
  nand3  g304(.a(x086), .b(new_n299_), .c(new_n298_), .O(new_n462_));
  oai21  g305(.a(new_n461_), .b(x054), .c(new_n462_), .O(new_n463_));
  nand2  g306(.a(x094), .b(x062), .O(new_n464_));
  aoi21  g307(.a(new_n464_), .b(x030), .c(x022), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(x078), .c(new_n298_), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n450_), .O(new_n467_));
  nand2  g310(.a(new_n299_), .b(x030), .O(new_n468_));
  aoi21  g311(.a(new_n468_), .b(new_n442_), .c(new_n303_), .O(new_n469_));
  nand2  g312(.a(new_n446_), .b(new_n445_), .O(new_n470_));
  aoi22  g313(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n471_));
  nand3  g314(.a(new_n471_), .b(new_n470_), .c(x030), .O(new_n472_));
  inv1   g315(.a(new_n472_), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n469_), .c(new_n173_), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n467_), .c(x054), .O(new_n475_));
  oai21  g318(.a(new_n302_), .b(new_n298_), .c(x030), .O(new_n476_));
  nand2  g319(.a(new_n476_), .b(new_n442_), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n173_), .c(x038), .O(new_n478_));
  inv1   g321(.a(new_n478_), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(new_n475_), .c(new_n306_), .O(new_n480_));
  oai22  g323(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n481_));
  nand3  g324(.a(new_n481_), .b(x070), .c(x022), .O(new_n482_));
  nand2  g325(.a(x054), .b(x038), .O(new_n483_));
  nand3  g326(.a(new_n483_), .b(new_n482_), .c(new_n480_), .O(new_n484_));
  aoi21  g327(.a(new_n463_), .b(x006), .c(new_n484_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(x046), .c(new_n440_), .O(z14));
  zero   g329(.O(z07));
  zero   g330(.O(z15));
  zero   g331(.O(z16));
  zero   g332(.O(z17));
  ...
  zero   g337(.O(z23));
  zero   g338(.O(z26));
  nor2   g339(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g340(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g341(.a(new_n173_), .b(new_n172_), .O(z27));
endmodule
