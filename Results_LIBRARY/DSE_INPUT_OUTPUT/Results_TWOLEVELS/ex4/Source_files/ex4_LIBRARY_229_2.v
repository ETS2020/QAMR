// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:52 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x085), .b(new_n157_), .O(z15));
  ...
  aoi21  g095(.a(new_n242_), .b(new_n244_), .c(x005), .O(new_n252_));
  ...
  oai21  g101(.a(new_n257_), .b(new_n252_), .c(x077), .O(new_n258_));
  aoi22  g102(.a(new_n258_), .b(x013), .c(x117), .d(x109), .O(new_n259_));
  inv1   g103(.a(x029), .O(new_n260_));
  nand2  g104(.a(new_n241_), .b(new_n243_), .O(new_n261_));
  nand2  g105(.a(x093), .b(x061), .O(new_n262_));
  oai21  g106(.a(new_n262_), .b(new_n260_), .c(new_n261_), .O(new_n263_));
  nand2  g107(.a(x125), .b(x101), .O(new_n264_));
  nand3  g108(.a(new_n264_), .b(x093), .c(x069), .O(new_n265_));
  inv1   g109(.a(x125), .O(new_n266_));
  inv1   g110(.a(x109), .O(new_n267_));
  nand2  g111(.a(x117), .b(x021), .O(new_n268_));
  oai21  g112(.a(x117), .b(new_n267_), .c(new_n268_), .O(new_n269_));
  nand2  g113(.a(new_n269_), .b(new_n266_), .O(new_n270_));
  inv1   g114(.a(x101), .O(new_n271_));
  nand3  g115(.a(new_n271_), .b(x061), .c(x037), .O(new_n272_));
  nand4  g116(.a(new_n272_), .b(new_n270_), .c(new_n265_), .d(new_n263_), .O(new_n273_));
  nand4  g117(.a(new_n266_), .b(x061), .c(x037), .d(new_n243_), .O(new_n274_));
  inv1   g118(.a(new_n274_), .O(new_n275_));
  aoi21  g119(.a(new_n273_), .b(x077), .c(new_n275_), .O(new_n276_));
  inv1   g120(.a(new_n262_), .O(new_n277_));
  nand2  g121(.a(new_n260_), .b(x021), .O(new_n278_));
  aoi21  g122(.a(new_n278_), .b(new_n277_), .c(x069), .O(new_n279_));
  nand4  g123(.a(new_n264_), .b(new_n261_), .c(new_n255_), .d(new_n260_), .O(new_n280_));
  inv1   g124(.a(new_n280_), .O(new_n281_));
  oai21  g125(.a(new_n281_), .b(new_n279_), .c(x077), .O(new_n282_));
  oai21  g126(.a(new_n276_), .b(x005), .c(new_n282_), .O(new_n283_));
  oai21  g127(.a(new_n283_), .b(new_n259_), .c(x053), .O(new_n284_));
  nand2  g128(.a(new_n261_), .b(new_n260_), .O(new_n285_));
  nand2  g129(.a(new_n285_), .b(new_n277_), .O(new_n286_));
  nand3  g130(.a(new_n286_), .b(x077), .c(new_n244_), .O(new_n287_));
  nand2  g131(.a(new_n287_), .b(new_n284_), .O(new_n288_));
  inv1   g132(.a(x005), .O(new_n289_));
  inv1   g133(.a(x085), .O(new_n290_));
  oai22  g134(.a(new_n246_), .b(new_n245_), .c(new_n244_), .d(new_n243_), .O(new_n291_));
  nand4  g135(.a(new_n291_), .b(new_n290_), .c(new_n157_), .d(new_n289_), .O(new_n292_));
  inv1   g136(.a(new_n292_), .O(new_n293_));
  aoi21  g137(.a(new_n288_), .b(x085), .c(new_n293_), .O(new_n294_));
  aoi21  g138(.a(new_n294_), .b(new_n251_), .c(new_n240_), .O(z05));
  ...
  oai22  g189(.a(new_n332_), .b(new_n311_), .c(new_n297_), .d(new_n299_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n333_), .c(new_n300_), .O(new_n347_));
  aoi22  g191(.a(new_n332_), .b(new_n299_), .c(new_n297_), .d(new_n311_), .O(new_n348_));
  nand4  g192(.a(new_n348_), .b(new_n347_), .c(new_n345_), .d(new_n327_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(x085), .c(x046), .O(new_n350_));
  ...
  nor2   g200(.a(x120), .b(x096), .O(new_n358_));
  nor2   g201(.a(x112), .b(x104), .O(new_n359_));
  oai21  g202(.a(new_n358_), .b(x088), .c(new_n359_), .O(new_n360_));
  nand2  g203(.a(new_n360_), .b(new_n169_), .O(new_n361_));
  inv1   g204(.a(x120), .O(new_n362_));
  oai21  g205(.a(new_n362_), .b(x104), .c(x032), .O(new_n363_));
  nand2  g206(.a(new_n363_), .b(x112), .O(new_n364_));
  inv1   g207(.a(x096), .O(new_n365_));
  inv1   g208(.a(x104), .O(new_n366_));
  oai21  g209(.a(new_n365_), .b(x056), .c(new_n366_), .O(new_n367_));
  inv1   g210(.a(x112), .O(new_n368_));
  ...
  nand4  g214(.a(new_n371_), .b(new_n364_), .c(new_n361_), .d(new_n357_), .O(new_n372_));
  nor2   g215(.a(x032), .b(new_n162_), .O(new_n373_));
  nor2   g216(.a(new_n362_), .b(x056), .O(new_n374_));
  aoi22  g217(.a(new_n374_), .b(new_n373_), .c(new_n372_), .d(new_n165_), .O(new_n375_));
  nand3  g218(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n376_));
  oai21  g219(.a(new_n375_), .b(x048), .c(new_n376_), .O(new_n377_));
  inv1   g220(.a(new_n359_), .O(new_n378_));
  nand2  g221(.a(x088), .b(x056), .O(new_n379_));
  aoi21  g222(.a(new_n379_), .b(x024), .c(x016), .O(new_n380_));
  oai21  g223(.a(new_n380_), .b(x072), .c(new_n162_), .O(new_n381_));
  nand2  g224(.a(new_n381_), .b(new_n378_), .O(new_n382_));
  nand2  g225(.a(x024), .b(new_n168_), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(new_n355_), .c(new_n169_), .O(new_n384_));
  inv1   g227(.a(new_n358_), .O(new_n385_));
  nand4  g228(.a(new_n379_), .b(new_n385_), .c(new_n353_), .d(x024), .O(new_n386_));
  inv1   g229(.a(new_n386_), .O(new_n387_));
  oai21  g230(.a(new_n387_), .b(new_n384_), .c(new_n165_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n382_), .c(x048), .O(new_n389_));
  nand2  g232(.a(new_n353_), .b(x024), .O(new_n390_));
  nand2  g233(.a(new_n390_), .b(new_n355_), .O(new_n391_));
  nand3  g234(.a(new_n391_), .b(new_n165_), .c(x032), .O(new_n392_));
  inv1   g235(.a(new_n392_), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n389_), .c(new_n161_), .O(new_n394_));
  ...
  oai21  g242(.a(new_n399_), .b(x040), .c(new_n159_), .O(z08));
  ...
  oai21  g250(.a(new_n407_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g267(.a(new_n424_), .b(x043), .c(new_n159_), .O(z11));
  ...
  nand2  g281(.a(new_n438_), .b(new_n159_), .O(new_n439_));
  inv1   g282(.a(x117), .O(new_n440_));
  aoi21  g283(.a(x069), .b(x037), .c(new_n289_), .O(new_n441_));
  nand2  g284(.a(new_n262_), .b(x029), .O(new_n442_));
  aoi21  g285(.a(new_n442_), .b(new_n241_), .c(x085), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(new_n441_), .c(new_n246_), .O(new_n444_));
  nand2  g287(.a(new_n290_), .b(x013), .O(new_n445_));
  aoi22  g288(.a(new_n445_), .b(new_n444_), .c(new_n440_), .d(new_n267_), .O(new_n446_));
  nand2  g289(.a(x021), .b(x013), .O(new_n447_));
  oai21  g290(.a(new_n255_), .b(x029), .c(new_n447_), .O(new_n448_));
  nand2  g291(.a(new_n266_), .b(new_n271_), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(new_n254_), .c(new_n242_), .O(new_n450_));
  nor2   g293(.a(new_n440_), .b(x109), .O(new_n451_));
  nor2   g294(.a(x117), .b(x021), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n451_), .c(x125), .O(new_n453_));
  nand3  g296(.a(x101), .b(new_n253_), .c(new_n244_), .O(new_n454_));
  nand4  g297(.a(new_n454_), .b(new_n453_), .c(new_n450_), .d(new_n448_), .O(new_n455_));
  nand4  g298(.a(x125), .b(new_n253_), .c(new_n244_), .d(x013), .O(new_n456_));
  inv1   g299(.a(new_n456_), .O(new_n457_));
  aoi21  g300(.a(new_n455_), .b(new_n246_), .c(new_n457_), .O(new_n458_));
  nor2   g301(.a(new_n260_), .b(x021), .O(new_n459_));
  oai21  g302(.a(new_n459_), .b(new_n255_), .c(x069), .O(new_n460_));
  nand4  g303(.a(new_n449_), .b(new_n447_), .c(new_n262_), .d(x029), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n460_), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n290_), .c(new_n246_), .O(new_n463_));
  oai21  g306(.a(new_n458_), .b(new_n289_), .c(new_n463_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n446_), .c(new_n245_), .O(new_n465_));
  nand2  g308(.a(new_n447_), .b(x029), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(new_n256_), .O(new_n467_));
  nand4  g310(.a(new_n467_), .b(new_n290_), .c(new_n246_), .d(x037), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n465_), .O(new_n469_));
  oai22  g312(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(x085), .c(x005), .O(new_n471_));
  inv1   g314(.a(new_n471_), .O(new_n472_));
  aoi21  g315(.a(new_n469_), .b(new_n157_), .c(new_n472_), .O(new_n473_));
  aoi21  g316(.a(new_n473_), .b(new_n439_), .c(x045), .O(z13));
  nand2  g317(.a(x022), .b(x014), .O(new_n475_));
  oai21  g318(.a(new_n336_), .b(x030), .c(new_n475_), .O(new_n476_));
  inv1   g319(.a(x102), .O(new_n477_));
  aoi21  g320(.a(new_n316_), .b(new_n477_), .c(x094), .O(new_n478_));
  nor2   g321(.a(x118), .b(x110), .O(new_n479_));
  inv1   g322(.a(new_n479_), .O(new_n480_));
  oai21  g323(.a(new_n480_), .b(new_n478_), .c(new_n333_), .O(new_n481_));
  oai21  g324(.a(new_n316_), .b(x110), .c(x038), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x118), .O(new_n483_));
  oai21  g326(.a(new_n477_), .b(x062), .c(new_n306_), .O(new_n484_));
  nand3  g327(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(new_n324_), .O(new_n486_));
  aoi21  g329(.a(new_n484_), .b(new_n311_), .c(new_n486_), .O(new_n487_));
  nand4  g330(.a(new_n487_), .b(new_n483_), .c(new_n481_), .d(new_n476_), .O(new_n488_));
  nand4  g331(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n489_));
  inv1   g332(.a(new_n489_), .O(new_n490_));
  aoi21  g333(.a(new_n488_), .b(new_n332_), .c(new_n490_), .O(new_n491_));
  nand3  g334(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n492_));
  ...
  aoi21  g340(.a(new_n497_), .b(new_n328_), .c(new_n333_), .O(new_n498_));
  nand2  g341(.a(new_n316_), .b(new_n477_), .O(new_n499_));
  nand4  g342(.a(new_n499_), .b(new_n475_), .c(new_n302_), .d(x030), .O(new_n500_));
  inv1   g343(.a(new_n500_), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n498_), .c(new_n332_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n496_), .c(x054), .O(new_n503_));
  nand2  g346(.a(new_n475_), .b(x030), .O(new_n504_));
  nand2  g347(.a(new_n504_), .b(new_n328_), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n332_), .c(x038), .O(new_n506_));
  inv1   g349(.a(new_n506_), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(new_n503_), .c(new_n324_), .O(new_n508_));
  ...
  aoi21  g355(.a(new_n493_), .b(x006), .c(new_n512_), .O(new_n513_));
  oai21  g356(.a(new_n513_), .b(x046), .c(new_n159_), .O(z14));
  zero   g357(.O(z07));
  zero   g358(.O(z16));
  zero   g359(.O(z18));
  zero   g360(.O(z21));
  zero   g361(.O(z25));
  zero   g362(.O(z27));
  nor2   g363(.a(x085), .b(new_n157_), .O(z17));
  nor2   g364(.a(x085), .b(new_n157_), .O(z19));
  nor2   g365(.a(x085), .b(new_n157_), .O(z20));
  nor2   g366(.a(x085), .b(new_n157_), .O(z22));
  nor2   g367(.a(x085), .b(new_n157_), .O(z23));
  nor2   g368(.a(x085), .b(new_n157_), .O(z24));
  nor2   g369(.a(x085), .b(new_n157_), .O(z26));
endmodule
