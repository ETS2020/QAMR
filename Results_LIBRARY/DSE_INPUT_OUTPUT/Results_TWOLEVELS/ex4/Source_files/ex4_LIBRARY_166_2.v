// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:54 2020
...
module FAU ( 
  ...
  aoi21  g197(.a(new_n349_), .b(x105), .c(new_n353_), .O(new_n354_));
  ...
  oai21  g287(.a(new_n261_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x117), .O(new_n445_));
  oai21  g289(.a(new_n439_), .b(x061), .c(new_n251_), .O(new_n446_));
  ...
  aoi21  g299(.a(new_n247_), .b(x029), .c(x021), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(x077), .c(new_n244_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n442_), .O(new_n458_));
  nand2  g302(.a(x029), .b(new_n245_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n272_), .c(new_n277_), .O(new_n460_));
  nand2  g304(.a(new_n261_), .b(new_n439_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n437_), .c(new_n247_), .d(x029), .O(new_n462_));
  ...
  nand3  g320(.a(x126), .b(new_n314_), .c(x006), .O(new_n477_));
  oai21  g321(.a(x086), .b(new_n334_), .c(new_n477_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n339_), .O(new_n479_));
  oai21  g323(.a(new_n334_), .b(x022), .c(new_n327_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n320_), .c(x054), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n479_), .c(x078), .O(new_n482_));
  inv1   g326(.a(x054), .O(new_n483_));
  nor2   g327(.a(new_n298_), .b(new_n483_), .O(new_n484_));
  oai21  g328(.a(new_n484_), .b(new_n482_), .c(x038), .O(new_n485_));
  oai21  g329(.a(new_n330_), .b(new_n297_), .c(x006), .O(new_n486_));
  oai21  g330(.a(new_n301_), .b(new_n334_), .c(new_n299_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n320_), .O(new_n488_));
  aoi22  g332(.a(new_n488_), .b(new_n486_), .c(new_n313_), .d(new_n314_), .O(new_n489_));
  nand3  g333(.a(new_n320_), .b(x070), .c(x030), .O(new_n490_));
  nand3  g334(.a(x102), .b(new_n317_), .c(x006), .O(new_n491_));
  ...
  aoi22  g338(.a(new_n494_), .b(x006), .c(new_n320_), .d(x070), .O(new_n495_));
  or2    g339(.a(new_n495_), .b(new_n327_), .O(new_n496_));
  nand4  g340(.a(new_n494_), .b(new_n300_), .c(new_n320_), .d(x030), .O(new_n497_));
  inv1   g341(.a(x094), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n330_), .c(x006), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n497_), .O(new_n500_));
  oai21  g344(.a(x126), .b(x102), .c(new_n500_), .O(new_n501_));
  nand2  g345(.a(x126), .b(new_n313_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n334_), .c(x022), .O(new_n503_));
  nand2  g347(.a(x030), .b(new_n339_), .O(new_n504_));
  nand3  g348(.a(x126), .b(x094), .c(new_n317_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n320_), .O(new_n506_));
  ...
  oai22  g353(.a(new_n320_), .b(new_n344_), .c(new_n330_), .d(new_n331_), .O(new_n510_));
  nor2   g354(.a(new_n330_), .b(x038), .O(new_n511_));
  aoi22  g355(.a(new_n511_), .b(x022), .c(new_n510_), .d(new_n339_), .O(new_n512_));
  ...
  nand3  g359(.a(new_n515_), .b(new_n514_), .c(new_n339_), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(x105), .c(x078), .O(new_n517_));
  ...
  zero   g370(.O(z26));
  zero   g371(.O(z27));
  nor2   g372(.a(x105), .b(new_n172_), .O(z16));
  nor2   g373(.a(x105), .b(new_n172_), .O(z18));
  nor2   g374(.a(x105), .b(new_n172_), .O(z21));
  nor2   g375(.a(x105), .b(new_n172_), .O(z22));
  nor2   g376(.a(x105), .b(new_n172_), .O(z23));
endmodule
