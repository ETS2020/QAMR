// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:26 2020
...
module FAU ( 
  ...
  nand3  g318(.a(x070), .b(new_n298_), .c(x022), .O(new_n476_));
  nand3  g319(.a(x086), .b(new_n312_), .c(x006), .O(new_n477_));
  nand4  g320(.a(new_n477_), .b(new_n476_), .c(new_n475_), .d(x078), .O(new_n478_));
  and2   g321(.a(new_n478_), .b(new_n296_), .O(z14));
  zero   g322(.O(z07));
  zero   g323(.O(z15));
  zero   g324(.O(z17));
  zero   g325(.O(z18));
