// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:35 2020
...
module FAU ( 
  ...
  nor2   g148(.a(x127), .b(x054), .O(new_n305_));
  ...
  nor2   g159(.a(new_n300_), .b(new_n299_), .O(new_n316_));
  ...
  nand2  g169(.a(new_n300_), .b(new_n299_), .O(new_n326_));
  ...
  oai21  g174(.a(new_n302_), .b(new_n312_), .c(new_n326_), .O(new_n331_));
  ...
  nor2   g188(.a(x070), .b(new_n297_), .O(new_n345_));
  aoi22  g189(.a(new_n345_), .b(new_n300_), .c(new_n344_), .d(x014), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n343_), .O(new_n347_));
  nand3  g191(.a(new_n309_), .b(x054), .c(new_n300_), .O(new_n348_));
  nand3  g192(.a(new_n311_), .b(x038), .c(new_n320_), .O(new_n349_));
  nand3  g193(.a(new_n349_), .b(new_n348_), .c(x014), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n157_), .c(new_n298_), .O(new_n351_));
  inv1   g195(.a(new_n351_), .O(new_n352_));
  aoi21  g196(.a(new_n347_), .b(x078), .c(new_n352_), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(new_n306_), .c(new_n296_), .O(z06));
  ...
  nand2  g206(.a(new_n362_), .b(new_n169_), .O(new_n363_));
  ...
  nor2   g218(.a(x032), .b(new_n162_), .O(new_n375_));
  nor2   g219(.a(new_n364_), .b(x056), .O(new_n376_));
  aoi22  g220(.a(new_n376_), .b(new_n375_), .c(new_n374_), .d(new_n165_), .O(new_n377_));
  ...
  oai21  g226(.a(new_n382_), .b(x072), .c(new_n162_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n380_), .O(new_n384_));
  nand2  g228(.a(x024), .b(new_n168_), .O(new_n385_));
  aoi21  g229(.a(new_n385_), .b(new_n357_), .c(new_n169_), .O(new_n386_));
  inv1   g230(.a(new_n360_), .O(new_n387_));
  nand4  g231(.a(new_n381_), .b(new_n387_), .c(new_n355_), .d(x024), .O(new_n388_));
  inv1   g232(.a(new_n388_), .O(new_n389_));
  oai21  g233(.a(new_n389_), .b(new_n386_), .c(new_n165_), .O(new_n390_));
  aoi21  g234(.a(new_n390_), .b(new_n384_), .c(x048), .O(new_n391_));
  nand2  g235(.a(new_n355_), .b(x024), .O(new_n392_));
  nand2  g236(.a(new_n392_), .b(new_n357_), .O(new_n393_));
  nand3  g237(.a(new_n393_), .b(new_n165_), .c(x032), .O(new_n394_));
  inv1   g238(.a(new_n394_), .O(new_n395_));
  oai21  g239(.a(new_n395_), .b(new_n391_), .c(new_n161_), .O(new_n396_));
  ...
  oai21  g245(.a(new_n401_), .b(x040), .c(new_n159_), .O(z08));
  ...
  nand3  g261(.a(new_n417_), .b(new_n159_), .c(new_n411_), .O(new_n418_));
  ...
  oai21  g270(.a(new_n426_), .b(x043), .c(new_n159_), .O(z11));
  ...
  nand3  g278(.a(new_n434_), .b(new_n159_), .c(new_n428_), .O(new_n435_));
  ...
  aoi21  g283(.a(new_n260_), .b(new_n439_), .c(x093), .O(new_n440_));
  nor2   g284(.a(x117), .b(x109), .O(new_n441_));
  inv1   g285(.a(new_n441_), .O(new_n442_));
  oai21  g286(.a(new_n442_), .b(new_n440_), .c(new_n277_), .O(new_n443_));
  oai21  g287(.a(new_n260_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x117), .O(new_n445_));
  oai21  g289(.a(new_n439_), .b(x061), .c(new_n250_), .O(new_n446_));
  ...
  aoi21  g299(.a(new_n246_), .b(x029), .c(x021), .O(new_n456_));
  oai21  g300(.a(new_n456_), .b(x077), .c(new_n243_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n442_), .O(new_n458_));
  nand2  g302(.a(x029), .b(new_n244_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n272_), .c(new_n277_), .O(new_n460_));
  nand2  g304(.a(new_n260_), .b(new_n439_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n437_), .c(new_n246_), .d(x029), .O(new_n462_));
  inv1   g306(.a(new_n462_), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n460_), .c(new_n276_), .O(new_n464_));
  ...
  oai21  g313(.a(new_n469_), .b(new_n465_), .c(new_n268_), .O(new_n470_));
  ...
  oai21  g319(.a(new_n475_), .b(x045), .c(new_n159_), .O(z13));
  inv1   g320(.a(x054), .O(new_n477_));
  oai21  g321(.a(new_n316_), .b(new_n312_), .c(new_n313_), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n311_), .c(new_n298_), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n477_), .c(x127), .O(new_n480_));
  nor2   g324(.a(new_n298_), .b(new_n477_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n480_), .c(x038), .O(new_n482_));
  aoi21  g326(.a(new_n313_), .b(new_n312_), .c(new_n316_), .O(new_n483_));
  nor2   g327(.a(x126), .b(x102), .O(new_n484_));
  nor2   g328(.a(x118), .b(x110), .O(new_n485_));
  oai21  g329(.a(new_n484_), .b(x094), .c(new_n485_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n309_), .O(new_n487_));
  oai21  g331(.a(new_n325_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x118), .O(new_n489_));
  oai21  g333(.a(new_n321_), .b(x062), .c(new_n307_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n297_), .O(new_n491_));
  nor2   g335(.a(new_n325_), .b(x118), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n300_), .c(x086), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n491_), .c(new_n489_), .d(new_n487_), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n483_), .c(new_n477_), .O(new_n495_));
  nand2  g339(.a(x086), .b(new_n299_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(new_n320_), .O(new_n497_));
  aoi21  g341(.a(new_n302_), .b(x030), .c(x022), .O(new_n498_));
  or2    g342(.a(new_n498_), .b(new_n485_), .O(new_n499_));
  nor2   g343(.a(new_n312_), .b(x022), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n314_), .c(x070), .O(new_n501_));
  inv1   g345(.a(new_n484_), .O(new_n502_));
  nor2   g346(.a(new_n316_), .b(new_n339_), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n502_), .c(x030), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n501_), .c(new_n499_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n311_), .c(new_n477_), .O(new_n506_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n497_), .c(new_n298_), .O(new_n510_));
  nand4  g354(.a(x126), .b(new_n332_), .c(new_n297_), .d(x006), .O(new_n511_));
  oai21  g355(.a(new_n485_), .b(x086), .c(new_n511_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n477_), .c(x014), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n510_), .O(new_n514_));
  nand3  g358(.a(x070), .b(new_n477_), .c(x022), .O(new_n515_));
  nand3  g359(.a(x086), .b(new_n297_), .c(x006), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(new_n515_), .c(new_n299_), .O(new_n517_));
  and2   g361(.a(new_n517_), .b(x078), .O(new_n518_));
  aoi21  g362(.a(new_n514_), .b(new_n157_), .c(new_n518_), .O(new_n519_));
  aoi21  g363(.a(new_n519_), .b(new_n482_), .c(x046), .O(z14));
  zero   g364(.O(z17));
  zero   g365(.O(z19));
  zero   g366(.O(z26));
  nor2   g367(.a(new_n157_), .b(x078), .O(z15));
  nor2   g368(.a(new_n157_), .b(x078), .O(z16));
  nor2   g369(.a(new_n157_), .b(x078), .O(z18));
  nor2   g370(.a(new_n157_), .b(x078), .O(z20));
  nor2   g371(.a(new_n157_), .b(x078), .O(z21));
  nor2   g372(.a(new_n157_), .b(x078), .O(z22));
  nor2   g373(.a(new_n157_), .b(x078), .O(z23));
  nor2   g374(.a(new_n157_), .b(x078), .O(z24));
  nor2   g375(.a(new_n157_), .b(x078), .O(z25));
  nor2   g376(.a(new_n157_), .b(x078), .O(z27));
endmodule
