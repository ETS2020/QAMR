...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x005), .O(z15));
  ...
  aoi21  g146(.a(new_n302_), .b(x054), .c(new_n241_), .O(new_n303_));
  ...
  and2   g195(.a(new_n351_), .b(new_n157_), .O(new_n352_));
  aoi21  g196(.a(new_n348_), .b(x005), .c(new_n352_), .O(new_n353_));
  ...
  nor2   g218(.a(x032), .b(new_n162_), .O(new_n376_));
  nor2   g219(.a(new_n365_), .b(x056), .O(new_n377_));
  aoi22  g220(.a(new_n377_), .b(new_n376_), .c(new_n375_), .d(new_n165_), .O(new_n378_));
  ...
  aoi21  g229(.a(new_n386_), .b(new_n358_), .c(new_n169_), .O(new_n387_));
  ...
  oai21  g245(.a(new_n402_), .b(x040), .c(new_n159_), .O(z08));
  ...
  oai21  g270(.a(new_n427_), .b(x043), .c(new_n159_), .O(z11));
  ...
  oai21  g278(.a(new_n435_), .b(x044), .c(new_n159_), .O(z12));
  ...
  nor2   g326(.a(new_n483_), .b(new_n241_), .O(new_n484_));
  ...
  nand3  g331(.a(new_n488_), .b(x078), .c(x005), .O(new_n489_));
  ...
  aoi21  g361(.a(new_n518_), .b(new_n157_), .c(new_n490_), .O(new_n519_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z27));
  nor2   g371(.a(new_n157_), .b(x005), .O(z16));
  nor2   g372(.a(new_n157_), .b(x005), .O(z19));
  nor2   g373(.a(new_n157_), .b(x005), .O(z21));
  nor2   g374(.a(new_n157_), .b(x005), .O(z22));
  nor2   g375(.a(new_n157_), .b(x005), .O(z26));
endmodule
