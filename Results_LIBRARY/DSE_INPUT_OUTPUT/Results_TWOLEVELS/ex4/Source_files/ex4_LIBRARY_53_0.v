...
module FAU ( 
  ...
  nand3  g315(.a(x070), .b(new_n298_), .c(x022), .O(new_n472_));
  nand3  g316(.a(x086), .b(new_n312_), .c(x006), .O(new_n473_));
  nand4  g317(.a(new_n473_), .b(new_n472_), .c(new_n471_), .d(x078), .O(new_n474_));
  and2   g318(.a(new_n474_), .b(new_n296_), .O(z14));
  zero   g319(.O(z15));
  zero   g320(.O(z16));
  zero   g321(.O(z17));
  zero   g322(.O(z19));
