// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:22 2020
...
module FAU ( 
  ...
  nand3  g073(.a(new_n229_), .b(new_n224_), .c(new_n172_), .O(new_n230_));
  ...
  nor2   g148(.a(x054), .b(x004), .O(new_n305_));
  oai21  g149(.a(new_n305_), .b(new_n304_), .c(new_n297_), .O(new_n306_));
  inv1   g150(.a(x070), .O(new_n307_));
  nand3  g151(.a(new_n307_), .b(x054), .c(new_n300_), .O(new_n308_));
  inv1   g152(.a(x006), .O(new_n309_));
  inv1   g153(.a(x086), .O(new_n310_));
  nand3  g154(.a(new_n310_), .b(x038), .c(new_n309_), .O(new_n311_));
  nand3  g155(.a(new_n311_), .b(new_n308_), .c(x014), .O(new_n312_));
  nand3  g156(.a(new_n312_), .b(new_n298_), .c(new_n172_), .O(new_n313_));
  inv1   g157(.a(new_n313_), .O(new_n314_));
  inv1   g158(.a(x110), .O(new_n315_));
  inv1   g159(.a(x118), .O(new_n316_));
  aoi21  g160(.a(new_n307_), .b(new_n297_), .c(x006), .O(new_n317_));
  ...
  aoi21  g168(.a(new_n324_), .b(new_n322_), .c(new_n310_), .O(new_n325_));
  oai22  g169(.a(new_n325_), .b(new_n317_), .c(new_n316_), .d(new_n315_), .O(new_n326_));
  nand3  g170(.a(x086), .b(new_n307_), .c(new_n318_), .O(new_n327_));
  inv1   g171(.a(x102), .O(new_n328_));
  nand3  g172(.a(new_n328_), .b(x062), .c(new_n309_), .O(new_n329_));
  nand2  g173(.a(new_n329_), .b(new_n327_), .O(new_n330_));
  nand2  g174(.a(new_n330_), .b(x038), .O(new_n331_));
  inv1   g175(.a(x126), .O(new_n332_));
  nand2  g176(.a(new_n300_), .b(new_n299_), .O(new_n333_));
  nand4  g177(.a(new_n321_), .b(new_n333_), .c(x086), .d(new_n318_), .O(new_n334_));
  nand3  g178(.a(x094), .b(x070), .c(new_n309_), .O(new_n335_));
  nand2  g179(.a(new_n335_), .b(new_n334_), .O(new_n336_));
  oai21  g180(.a(new_n332_), .b(new_n328_), .c(new_n336_), .O(new_n337_));
  oai21  g181(.a(new_n302_), .b(new_n318_), .c(new_n333_), .O(new_n338_));
  nand2  g182(.a(new_n320_), .b(x062), .O(new_n339_));
  nand2  g183(.a(x118), .b(x022), .O(new_n340_));
  nand2  g184(.a(new_n316_), .b(x110), .O(new_n341_));
  nand3  g185(.a(new_n341_), .b(new_n340_), .c(new_n339_), .O(new_n342_));
  nand2  g186(.a(new_n342_), .b(new_n332_), .O(new_n343_));
  nand3  g187(.a(new_n343_), .b(new_n338_), .c(x086), .O(new_n344_));
  nand3  g188(.a(new_n302_), .b(x086), .c(new_n307_), .O(new_n345_));
  inv1   g189(.a(new_n345_), .O(new_n346_));
  aoi21  g190(.a(new_n344_), .b(new_n309_), .c(new_n346_), .O(new_n347_));
  nand4  g191(.a(new_n347_), .b(new_n337_), .c(new_n331_), .d(new_n326_), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(x054), .O(new_n349_));
  oai22  g193(.a(x086), .b(x006), .c(x070), .d(x022), .O(new_n350_));
  nor2   g194(.a(x070), .b(new_n297_), .O(new_n351_));
  aoi22  g195(.a(new_n351_), .b(new_n300_), .c(new_n350_), .d(x014), .O(new_n352_));
  nand2  g196(.a(new_n352_), .b(new_n349_), .O(new_n353_));
  aoi21  g197(.a(new_n353_), .b(x078), .c(new_n314_), .O(new_n354_));
  ...
  inv1   g208(.a(x112), .O(new_n365_));
  nand2  g209(.a(new_n365_), .b(new_n364_), .O(new_n366_));
  oai21  g210(.a(new_n366_), .b(new_n363_), .c(new_n166_), .O(new_n367_));
  oai21  g211(.a(new_n362_), .b(x104), .c(x032), .O(new_n368_));
  nand2  g212(.a(new_n368_), .b(x112), .O(new_n369_));
  oai21  g213(.a(new_n361_), .b(x056), .c(new_n364_), .O(new_n370_));
  nand3  g214(.a(x120), .b(new_n365_), .c(new_n165_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n158_), .O(new_n372_));
  aoi21  g216(.a(new_n370_), .b(new_n160_), .c(new_n372_), .O(new_n373_));
  nand4  g217(.a(new_n373_), .b(new_n369_), .c(new_n367_), .d(new_n360_), .O(new_n374_));
  nor2   g218(.a(x032), .b(new_n159_), .O(new_n375_));
  nor2   g219(.a(new_n362_), .b(x056), .O(new_n376_));
  ...
  aoi21  g224(.a(new_n380_), .b(x024), .c(x016), .O(new_n381_));
  oai21  g225(.a(new_n381_), .b(x072), .c(new_n159_), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n366_), .O(new_n383_));
  nand2  g227(.a(x024), .b(new_n165_), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n358_), .c(new_n166_), .O(new_n385_));
  nand2  g229(.a(new_n362_), .b(new_n361_), .O(new_n386_));
  nand4  g230(.a(new_n380_), .b(new_n386_), .c(new_n356_), .d(x024), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(new_n388_));
  oai21  g232(.a(new_n388_), .b(new_n385_), .c(new_n162_), .O(new_n389_));
  aoi21  g233(.a(new_n389_), .b(new_n383_), .c(x048), .O(new_n390_));
  nand2  g234(.a(new_n356_), .b(x024), .O(new_n391_));
  nand2  g235(.a(new_n391_), .b(new_n358_), .O(new_n392_));
  nand3  g236(.a(new_n392_), .b(new_n162_), .c(x032), .O(new_n393_));
  inv1   g237(.a(new_n393_), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n390_), .c(new_n158_), .O(new_n395_));
  ...
  oai21  g245(.a(new_n401_), .b(x040), .c(new_n174_), .O(z08));
  inv1   g246(.a(x041), .O(new_n403_));
  ...
  nand3  g253(.a(new_n409_), .b(new_n174_), .c(new_n403_), .O(new_n410_));
  inv1   g254(.a(new_n410_), .O(z09));
  ...
  oai21  g262(.a(new_n418_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai21  g282(.a(new_n279_), .b(x029), .c(new_n438_), .O(new_n439_));
  nor2   g283(.a(x125), .b(x101), .O(new_n440_));
  nor2   g284(.a(x117), .b(x109), .O(new_n441_));
  oai21  g285(.a(new_n440_), .b(x093), .c(new_n441_), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n276_), .O(new_n443_));
  oai21  g287(.a(new_n259_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x117), .O(new_n445_));
  inv1   g289(.a(x101), .O(new_n446_));
  oai21  g290(.a(new_n446_), .b(x061), .c(new_n249_), .O(new_n447_));
  nand3  g291(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n267_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n254_), .c(new_n449_), .O(new_n450_));
  nand4  g294(.a(new_n450_), .b(new_n445_), .c(new_n443_), .d(new_n439_), .O(new_n451_));
  nand4  g295(.a(x125), .b(new_n257_), .c(new_n254_), .d(x013), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n275_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x085), .b(new_n254_), .c(new_n242_), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(x005), .O(new_n457_));
  oai21  g301(.a(new_n283_), .b(new_n241_), .c(new_n243_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n275_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n242_), .c(new_n441_), .O(new_n460_));
  nor2   g304(.a(new_n241_), .b(x021), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n279_), .c(x069), .O(new_n462_));
  inv1   g306(.a(new_n440_), .O(new_n463_));
  nand4  g307(.a(new_n463_), .b(new_n438_), .c(new_n245_), .d(x029), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n462_), .c(x077), .O(new_n465_));
  oai21  g309(.a(new_n465_), .b(new_n460_), .c(new_n240_), .O(new_n466_));
  ...
  aoi21  g318(.a(new_n470_), .b(new_n267_), .c(new_n474_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n457_), .O(new_n476_));
  nand3  g320(.a(new_n476_), .b(new_n174_), .c(new_n437_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  oai21  g322(.a(new_n321_), .b(x030), .c(new_n323_), .O(new_n479_));
  aoi21  g323(.a(new_n332_), .b(new_n328_), .c(x094), .O(new_n480_));
  nand2  g324(.a(new_n316_), .b(new_n315_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n480_), .c(new_n307_), .O(new_n482_));
  oai21  g326(.a(new_n332_), .b(x110), .c(x038), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x118), .O(new_n484_));
  oai21  g328(.a(new_n328_), .b(x062), .c(new_n315_), .O(new_n485_));
  nand3  g329(.a(x126), .b(new_n316_), .c(new_n300_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n310_), .O(new_n487_));
  aoi21  g331(.a(new_n485_), .b(new_n297_), .c(new_n487_), .O(new_n488_));
  nand4  g332(.a(new_n488_), .b(new_n484_), .c(new_n482_), .d(new_n479_), .O(new_n489_));
  nand4  g333(.a(x126), .b(new_n319_), .c(new_n297_), .d(x014), .O(new_n490_));
  inv1   g334(.a(new_n490_), .O(new_n491_));
  aoi21  g335(.a(new_n489_), .b(new_n298_), .c(new_n491_), .O(new_n492_));
  nand3  g336(.a(x086), .b(new_n297_), .c(new_n299_), .O(new_n493_));
  oai21  g337(.a(new_n492_), .b(x054), .c(new_n493_), .O(new_n494_));
  aoi21  g338(.a(new_n302_), .b(x030), .c(x022), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(x078), .c(new_n299_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n481_), .O(new_n497_));
  nor2   g341(.a(x094), .b(x062), .O(new_n498_));
  nand2  g342(.a(x030), .b(new_n300_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n498_), .c(new_n307_), .O(new_n500_));
  nand2  g344(.a(new_n332_), .b(new_n328_), .O(new_n501_));
  nand4  g345(.a(new_n501_), .b(new_n323_), .c(new_n302_), .d(x030), .O(new_n502_));
  inv1   g346(.a(new_n502_), .O(new_n503_));
  oai21  g347(.a(new_n503_), .b(new_n500_), .c(new_n298_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n497_), .c(x054), .O(new_n505_));
  oai21  g349(.a(new_n324_), .b(new_n318_), .c(new_n498_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n298_), .c(x038), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n505_), .c(new_n310_), .O(new_n509_));
  oai22  g353(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(x070), .c(x022), .O(new_n511_));
  aoi22  g355(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n512_));
  and2   g356(.a(new_n512_), .b(new_n511_), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n509_), .O(new_n514_));
  aoi21  g358(.a(new_n494_), .b(x006), .c(new_n514_), .O(new_n515_));
  ...
  zero   g365(.O(z26));
  zero   g366(.O(z27));
  nor2   g367(.a(x078), .b(new_n172_), .O(z16));
  nor2   g368(.a(x078), .b(new_n172_), .O(z17));
  nor2   g369(.a(x078), .b(new_n172_), .O(z19));
  nor2   g370(.a(x078), .b(new_n172_), .O(z22));
  nor2   g371(.a(x078), .b(new_n172_), .O(z24));
  nor2   g372(.a(x078), .b(new_n172_), .O(z25));
endmodule
