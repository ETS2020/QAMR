...
module FAU ( 
  ...
  oai22  g073(.a(new_n229_), .b(new_n228_), .c(new_n227_), .d(new_n172_), .O(new_n230_));
  nand3  g074(.a(new_n230_), .b(new_n226_), .c(new_n225_), .O(new_n231_));
  inv1   g075(.a(x020), .O(new_n232_));
  inv1   g076(.a(x068), .O(new_n233_));
  oai22  g077(.a(new_n229_), .b(new_n227_), .c(new_n228_), .d(new_n172_), .O(new_n234_));
  nand3  g078(.a(new_n234_), .b(new_n233_), .c(new_n232_), .O(new_n235_));
  aoi22  g079(.a(new_n229_), .b(new_n172_), .c(new_n228_), .d(new_n227_), .O(new_n236_));
  nand3  g080(.a(new_n236_), .b(new_n235_), .c(new_n231_), .O(new_n237_));
  nand2  g081(.a(new_n237_), .b(x044), .O(new_n238_));
  nand2  g082(.a(new_n238_), .b(new_n175_), .O(z04));
  ...
  nand3  g138(.a(new_n294_), .b(new_n175_), .c(x045), .O(new_n295_));
  ...
  nand3  g160(.a(new_n173_), .b(x118), .c(x022), .O(new_n317_));
  ...
  nand4  g164(.a(new_n173_), .b(x062), .c(x038), .d(new_n300_), .O(new_n321_));
  ...
  oai21  g241(.a(new_n397_), .b(x040), .c(new_n175_), .O(z08));
  ...
  oai21  g249(.a(new_n405_), .b(x041), .c(new_n175_), .O(z09));
  ...
  nand3  g257(.a(new_n413_), .b(new_n175_), .c(new_n407_), .O(new_n414_));
  ...
  nand3  g266(.a(new_n422_), .b(new_n175_), .c(new_n416_), .O(new_n423_));
  ...
  oai21  g275(.a(new_n431_), .b(x044), .c(new_n175_), .O(z12));
  ...
  nand2  g341(.a(new_n173_), .b(new_n477_), .O(new_n498_));
  ...
  oai21  g357(.a(new_n513_), .b(x046), .c(new_n175_), .O(z14));
  zero   g358(.O(z19));
  zero   g359(.O(z20));
  zero   g360(.O(z21));
  zero   g361(.O(z24));
  zero   g362(.O(z26));
  nor2   g363(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g364(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g365(.a(new_n173_), .b(new_n172_), .O(z17));
  nor2   g366(.a(new_n173_), .b(new_n172_), .O(z18));
  nor2   g367(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g368(.a(new_n173_), .b(new_n172_), .O(z23));
