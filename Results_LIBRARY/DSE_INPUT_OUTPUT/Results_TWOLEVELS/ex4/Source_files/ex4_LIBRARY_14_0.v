// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:58 2020
...
module FAU ( 
  ...
  nand3  g217(.a(x120), .b(new_n373_), .c(new_n167_), .O(new_n374_));
  nand2  g218(.a(new_n374_), .b(new_n160_), .O(new_n375_));
  aoi21  g219(.a(new_n372_), .b(new_n162_), .c(new_n375_), .O(new_n376_));
  nand4  g220(.a(new_n376_), .b(new_n369_), .c(new_n366_), .d(new_n362_), .O(new_n377_));
  nand4  g221(.a(x120), .b(new_n359_), .c(new_n162_), .d(x008), .O(new_n378_));
  inv1   g222(.a(new_n378_), .O(new_n379_));
  aoi21  g223(.a(new_n377_), .b(new_n164_), .c(new_n379_), .O(new_n380_));
  nand3  g224(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n381_));
  ...
  nand2  g229(.a(new_n385_), .b(new_n167_), .O(new_n386_));
  nand2  g230(.a(new_n386_), .b(new_n164_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n161_), .c(new_n364_), .O(new_n388_));
  ...
  oai21  g238(.a(new_n394_), .b(new_n388_), .c(new_n163_), .O(new_n395_));
  nand2  g239(.a(new_n358_), .b(x024), .O(new_n396_));
  nand3  g240(.a(new_n396_), .b(new_n360_), .c(new_n359_), .O(new_n397_));
  nand3  g241(.a(new_n397_), .b(new_n164_), .c(x032), .O(new_n398_));
  ...
  aoi21  g247(.a(new_n399_), .b(new_n160_), .c(new_n403_), .O(new_n404_));
  nand2  g248(.a(new_n404_), .b(new_n383_), .O(new_n405_));
  nand3  g249(.a(new_n405_), .b(new_n158_), .c(new_n357_), .O(new_n406_));
  ...
  oai21  g258(.a(new_n414_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g266(.a(new_n422_), .b(x042), .c(new_n158_), .O(z10));
  ...
  oai21  g283(.a(new_n439_), .b(x044), .c(new_n158_), .O(z12));
  inv1   g284(.a(x077), .O(new_n441_));
  oai22  g285(.a(new_n280_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n442_));
  inv1   g286(.a(x101), .O(new_n443_));
  oai22  g287(.a(new_n258_), .b(x069), .c(new_n443_), .d(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(new_n256_), .O(new_n445_));
  nand2  g289(.a(new_n251_), .b(new_n253_), .O(new_n446_));
  oai21  g290(.a(new_n270_), .b(new_n252_), .c(new_n446_), .O(new_n447_));
  nand2  g291(.a(x117), .b(new_n253_), .O(new_n448_));
  oai21  g292(.a(x117), .b(x021), .c(new_n448_), .O(new_n449_));
  nand3  g293(.a(x101), .b(new_n270_), .c(new_n247_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n266_), .O(new_n451_));
  aoi21  g295(.a(new_n449_), .b(x125), .c(new_n451_), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n447_), .c(new_n445_), .d(new_n442_), .O(new_n453_));
  nand4  g297(.a(x125), .b(new_n247_), .c(new_n252_), .d(x013), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n441_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(x085), .b(new_n252_), .c(new_n242_), .O(new_n457_));
  oai21  g301(.a(new_n456_), .b(x053), .c(new_n457_), .O(new_n458_));
  nand3  g302(.a(new_n266_), .b(new_n240_), .c(x029), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(new_n243_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n252_), .O(new_n461_));
  nand3  g305(.a(new_n280_), .b(new_n266_), .c(new_n240_), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n461_), .c(new_n270_), .O(new_n463_));
  nand2  g307(.a(new_n245_), .b(x029), .O(new_n464_));
  aoi22  g308(.a(new_n464_), .b(new_n243_), .c(new_n251_), .d(new_n253_), .O(new_n465_));
  nand2  g309(.a(new_n258_), .b(new_n443_), .O(new_n466_));
  aoi22  g310(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n467_));
  nand3  g311(.a(new_n467_), .b(new_n466_), .c(x029), .O(new_n468_));
  inv1   g312(.a(new_n468_), .O(new_n469_));
  oai21  g313(.a(new_n469_), .b(new_n465_), .c(new_n240_), .O(new_n470_));
  aoi21  g314(.a(x021), .b(x013), .c(new_n241_), .O(new_n471_));
  oai21  g315(.a(new_n471_), .b(new_n280_), .c(x037), .O(new_n472_));
  aoi21  g316(.a(new_n472_), .b(new_n470_), .c(x085), .O(new_n473_));
  oai21  g317(.a(new_n473_), .b(new_n463_), .c(new_n441_), .O(new_n474_));
  nand3  g318(.a(new_n446_), .b(new_n266_), .c(new_n240_), .O(new_n475_));
  nand2  g319(.a(new_n475_), .b(new_n441_), .O(new_n476_));
  nand4  g320(.a(x069), .b(new_n240_), .c(x021), .d(new_n242_), .O(new_n477_));
  oai21  g321(.a(new_n240_), .b(new_n252_), .c(new_n477_), .O(new_n478_));
  aoi21  g322(.a(new_n476_), .b(x013), .c(new_n478_), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n474_), .O(new_n480_));
  aoi21  g324(.a(new_n458_), .b(x005), .c(new_n480_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(x045), .c(new_n158_), .O(z13));
  oai22  g326(.a(new_n341_), .b(x030), .c(new_n306_), .d(new_n305_), .O(new_n483_));
  inv1   g327(.a(x102), .O(new_n484_));
  aoi21  g328(.a(new_n322_), .b(new_n484_), .c(x094), .O(new_n485_));
  nand2  g329(.a(new_n313_), .b(new_n312_), .O(new_n486_));
  oai21  g330(.a(new_n486_), .b(new_n485_), .c(new_n338_), .O(new_n487_));
  oai21  g331(.a(new_n322_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x118), .O(new_n489_));
  oai21  g333(.a(new_n484_), .b(x062), .c(new_n312_), .O(new_n490_));
  nand3  g334(.a(x126), .b(new_n313_), .c(new_n306_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n330_), .O(new_n492_));
  aoi21  g336(.a(new_n490_), .b(new_n317_), .c(new_n492_), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n489_), .c(new_n487_), .d(new_n483_), .O(new_n494_));
  nand4  g338(.a(x126), .b(new_n320_), .c(new_n317_), .d(x014), .O(new_n495_));
  inv1   g339(.a(new_n495_), .O(new_n496_));
  aoi21  g340(.a(new_n494_), .b(new_n298_), .c(new_n496_), .O(new_n497_));
  nand3  g341(.a(x086), .b(new_n317_), .c(new_n305_), .O(new_n498_));
  oai21  g342(.a(new_n497_), .b(x054), .c(new_n498_), .O(new_n499_));
  aoi21  g343(.a(new_n308_), .b(x030), .c(x022), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(x078), .c(new_n305_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n486_), .O(new_n502_));
  nand2  g346(.a(x030), .b(new_n306_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n334_), .c(new_n338_), .O(new_n504_));
  nand2  g348(.a(new_n322_), .b(new_n484_), .O(new_n505_));
  ...
  oai21  g352(.a(new_n508_), .b(new_n504_), .c(new_n298_), .O(new_n509_));
  aoi21  g353(.a(new_n509_), .b(new_n502_), .c(x054), .O(new_n510_));
  oai21  g354(.a(new_n306_), .b(new_n305_), .c(x030), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n334_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n298_), .c(x038), .O(new_n513_));
  inv1   g357(.a(new_n513_), .O(new_n514_));
  oai21  g358(.a(new_n514_), .b(new_n510_), .c(new_n330_), .O(new_n515_));
  ...
  oai21  g364(.a(new_n520_), .b(x046), .c(new_n158_), .O(z14));
  zero   g365(.O(z22));
  zero   g366(.O(z27));
  nor2   g367(.a(x078), .b(x037), .O(z15));
  nor2   g368(.a(x078), .b(x037), .O(z16));
  nor2   g369(.a(x078), .b(x037), .O(z17));
  nor2   g370(.a(x078), .b(x037), .O(z18));
  nor2   g371(.a(x078), .b(x037), .O(z19));
  nor2   g372(.a(x078), .b(x037), .O(z20));
  nor2   g373(.a(x078), .b(x037), .O(z21));
  nor2   g374(.a(x078), .b(x037), .O(z23));
  nor2   g375(.a(x078), .b(x037), .O(z24));
  nor2   g376(.a(x078), .b(x037), .O(z25));
  nor2   g377(.a(x078), .b(x037), .O(z26));
endmodule
