// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:11 2020
...
module FAU ( 
  ...
  oai21  g141(.a(new_n297_), .b(x014), .c(x084), .O(new_n298_));
  ...
  oai21  g201(.a(new_n167_), .b(new_n161_), .c(new_n357_), .O(new_n358_));
  ...
  oai21  g208(.a(new_n364_), .b(new_n361_), .c(new_n168_), .O(new_n365_));
  ...
  nand3  g212(.a(x120), .b(new_n363_), .c(new_n167_), .O(new_n369_));
  ...
  oai21  g223(.a(new_n379_), .b(x072), .c(new_n161_), .O(new_n380_));
  nand2  g224(.a(new_n380_), .b(new_n364_), .O(new_n381_));
  nand2  g225(.a(x024), .b(new_n167_), .O(new_n382_));
  aoi21  g226(.a(new_n382_), .b(new_n356_), .c(new_n168_), .O(new_n383_));
  ...
  oai21  g231(.a(new_n387_), .b(new_n383_), .c(new_n164_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n381_), .c(x048), .O(new_n389_));
  oai21  g233(.a(new_n167_), .b(new_n161_), .c(x024), .O(new_n390_));
  ...
  oai21  g251(.a(new_n407_), .b(x041), .c(new_n158_), .O(z09));
  ...
  nand2  g299(.a(new_n245_), .b(x029), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n243_), .O(new_n457_));
  nand2  g301(.a(new_n457_), .b(new_n275_), .O(new_n458_));
  aoi21  g302(.a(new_n458_), .b(new_n242_), .c(new_n439_), .O(new_n459_));
  nor2   g303(.a(new_n241_), .b(x021), .O(new_n460_));
  oai21  g304(.a(new_n460_), .b(new_n279_), .c(x069), .O(new_n461_));
  inv1   g305(.a(new_n438_), .O(new_n462_));
  nand4  g306(.a(new_n462_), .b(new_n436_), .c(new_n245_), .d(x029), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n461_), .c(x077), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n459_), .c(new_n240_), .O(new_n465_));
  ...
  aoi21  g317(.a(new_n469_), .b(new_n267_), .c(new_n473_), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n455_), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(new_n158_), .c(new_n435_), .O(new_n476_));
  inv1   g320(.a(new_n476_), .O(z13));
  oai22  g321(.a(new_n339_), .b(x030), .c(new_n304_), .d(new_n303_), .O(new_n478_));
  inv1   g322(.a(x102), .O(new_n479_));
  aoi21  g323(.a(new_n320_), .b(new_n479_), .c(x094), .O(new_n480_));
  nand2  g324(.a(new_n311_), .b(new_n310_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n480_), .c(new_n336_), .O(new_n482_));
  oai21  g326(.a(new_n320_), .b(x110), .c(x038), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x118), .O(new_n484_));
  oai21  g328(.a(new_n479_), .b(x062), .c(new_n310_), .O(new_n485_));
  nand3  g329(.a(x126), .b(new_n311_), .c(new_n304_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n328_), .O(new_n487_));
  aoi21  g331(.a(new_n485_), .b(new_n315_), .c(new_n487_), .O(new_n488_));
  nand4  g332(.a(new_n488_), .b(new_n484_), .c(new_n482_), .d(new_n478_), .O(new_n489_));
  nand4  g333(.a(x126), .b(new_n318_), .c(new_n315_), .d(x014), .O(new_n490_));
  inv1   g334(.a(new_n490_), .O(new_n491_));
  aoi21  g335(.a(new_n489_), .b(new_n296_), .c(new_n491_), .O(new_n492_));
  nand3  g336(.a(x086), .b(new_n315_), .c(new_n303_), .O(new_n493_));
  oai21  g337(.a(new_n492_), .b(x054), .c(new_n493_), .O(new_n494_));
  aoi21  g338(.a(new_n306_), .b(x030), .c(x022), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(x078), .c(new_n303_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n481_), .O(new_n497_));
  nand2  g341(.a(x030), .b(new_n304_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n332_), .c(new_n336_), .O(new_n499_));
  nand2  g343(.a(new_n320_), .b(new_n479_), .O(new_n500_));
  ...
  oai21  g347(.a(new_n503_), .b(new_n499_), .c(new_n296_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n497_), .c(x054), .O(new_n505_));
  oai21  g349(.a(new_n304_), .b(new_n303_), .c(x030), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n332_), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n296_), .c(x038), .O(new_n508_));
  inv1   g352(.a(new_n508_), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(new_n505_), .c(new_n328_), .O(new_n510_));
  ...
  oai21  g359(.a(new_n515_), .b(x046), .c(new_n158_), .O(z14));
  zero   g360(.O(z15));
  zero   g361(.O(z20));
  zero   g362(.O(z21));
  zero   g363(.O(z22));
  zero   g364(.O(z23));
  zero   g365(.O(z24));
  nor2   g366(.a(x084), .b(x078), .O(z16));
  nor2   g367(.a(x084), .b(x078), .O(z17));
  nor2   g368(.a(x084), .b(x078), .O(z18));
  nor2   g369(.a(x084), .b(x078), .O(z19));
  nor2   g370(.a(x084), .b(x078), .O(z25));
  nor2   g371(.a(x084), .b(x078), .O(z26));
  nor2   g372(.a(x084), .b(x078), .O(z27));
endmodule
