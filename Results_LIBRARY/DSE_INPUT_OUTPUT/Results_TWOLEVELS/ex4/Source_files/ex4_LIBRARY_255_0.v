// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:52 2020
...
module FAU ( 
  ...
  oai21  g206(.a(new_n362_), .b(new_n359_), .c(new_n168_), .O(new_n363_));
  ...
  nand3  g210(.a(x120), .b(new_n361_), .c(new_n167_), .O(new_n367_));
  nand2  g211(.a(new_n367_), .b(new_n160_), .O(new_n368_));
  ...
  nor2   g214(.a(x032), .b(new_n161_), .O(new_n371_));
  nor2   g215(.a(new_n358_), .b(x056), .O(new_n372_));
  aoi22  g216(.a(new_n372_), .b(new_n371_), .c(new_n370_), .d(new_n164_), .O(new_n373_));
  nand3  g217(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n374_));
  ...
  oai21  g221(.a(new_n377_), .b(x072), .c(new_n161_), .O(new_n378_));
  nand2  g222(.a(new_n378_), .b(new_n362_), .O(new_n379_));
  nand2  g223(.a(x024), .b(new_n167_), .O(new_n380_));
  aoi21  g224(.a(new_n380_), .b(new_n354_), .c(new_n168_), .O(new_n381_));
  ...
  oai21  g229(.a(new_n385_), .b(new_n381_), .c(new_n164_), .O(new_n386_));
  aoi21  g230(.a(new_n386_), .b(new_n379_), .c(x048), .O(new_n387_));
  oai21  g231(.a(new_n167_), .b(new_n161_), .c(x024), .O(new_n388_));
  nand2  g232(.a(new_n388_), .b(new_n354_), .O(new_n389_));
  nand3  g233(.a(new_n389_), .b(new_n164_), .c(x032), .O(new_n390_));
  inv1   g234(.a(new_n390_), .O(new_n391_));
  oai21  g235(.a(new_n391_), .b(new_n387_), .c(new_n160_), .O(new_n392_));
  ...
  oai21  g241(.a(new_n397_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g249(.a(new_n405_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g257(.a(new_n413_), .b(x042), .c(new_n158_), .O(z10));
  inv1   g258(.a(x043), .O(new_n415_));
  ...
  nand3  g265(.a(new_n421_), .b(new_n158_), .c(new_n415_), .O(new_n422_));
  ...
  oai21  g274(.a(new_n430_), .b(x044), .c(new_n158_), .O(z12));
  oai22  g275(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n432_));
  nand3  g276(.a(new_n432_), .b(x085), .c(x005), .O(new_n433_));
  aoi22  g277(.a(new_n275_), .b(new_n254_), .c(new_n240_), .d(new_n242_), .O(new_n434_));
  nand3  g278(.a(new_n279_), .b(new_n267_), .c(new_n275_), .O(new_n435_));
  oai22  g279(.a(new_n435_), .b(x053), .c(new_n434_), .d(new_n243_), .O(new_n436_));
  nand2  g280(.a(new_n436_), .b(x069), .O(new_n437_));
  nand2  g281(.a(new_n435_), .b(new_n240_), .O(new_n438_));
  aoi22  g282(.a(new_n438_), .b(x037), .c(x077), .d(x013), .O(new_n439_));
  nand3  g283(.a(new_n439_), .b(new_n437_), .c(new_n433_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n158_), .O(new_n441_));
  oai21  g285(.a(new_n316_), .b(new_n249_), .c(new_n250_), .O(new_n442_));
  aoi21  g286(.a(x069), .b(x037), .c(new_n239_), .O(new_n443_));
  nand2  g287(.a(new_n245_), .b(x029), .O(new_n444_));
  aoi21  g288(.a(new_n444_), .b(new_n243_), .c(x085), .O(new_n445_));
  oai21  g289(.a(new_n445_), .b(new_n443_), .c(new_n275_), .O(new_n446_));
  oai21  g290(.a(x085), .b(new_n242_), .c(new_n446_), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(new_n442_), .O(new_n448_));
  nand2  g292(.a(x021), .b(x013), .O(new_n449_));
  inv1   g293(.a(x093), .O(new_n450_));
  nand3  g294(.a(new_n450_), .b(new_n257_), .c(new_n241_), .O(new_n451_));
  nand2  g295(.a(new_n451_), .b(new_n449_), .O(new_n452_));
  inv1   g296(.a(x101), .O(new_n453_));
  nand2  g297(.a(new_n259_), .b(new_n453_), .O(new_n454_));
  nand3  g298(.a(new_n454_), .b(new_n450_), .c(new_n276_), .O(new_n455_));
  nand3  g299(.a(x101), .b(new_n257_), .c(new_n254_), .O(new_n456_));
  nand3  g300(.a(x125), .b(new_n250_), .c(new_n243_), .O(new_n457_));
  ...
  nand3  g305(.a(new_n454_), .b(new_n449_), .c(new_n245_), .O(new_n462_));
  oai21  g306(.a(new_n276_), .b(x021), .c(new_n462_), .O(new_n463_));
  nand4  g307(.a(new_n463_), .b(new_n267_), .c(new_n275_), .d(x029), .O(new_n464_));
  oai21  g308(.a(new_n461_), .b(new_n239_), .c(new_n464_), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(x126), .O(new_n466_));
  nor2   g310(.a(new_n259_), .b(new_n250_), .O(new_n467_));
  nand4  g311(.a(new_n467_), .b(new_n249_), .c(new_n275_), .d(x005), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n466_), .c(new_n448_), .O(new_n469_));
  nand4  g313(.a(new_n449_), .b(x126), .c(new_n267_), .d(new_n275_), .O(new_n470_));
  nor3   g314(.a(new_n470_), .b(new_n254_), .c(new_n241_), .O(new_n471_));
  aoi21  g315(.a(new_n469_), .b(new_n240_), .c(new_n471_), .O(new_n472_));
  aoi21  g316(.a(new_n472_), .b(new_n441_), .c(x045), .O(z13));
  nand2  g317(.a(new_n311_), .b(new_n299_), .O(new_n474_));
  oai21  g318(.a(x078), .b(x054), .c(new_n474_), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(x086), .c(x006), .O(new_n476_));
  nand2  g320(.a(new_n307_), .b(new_n306_), .O(new_n477_));
  oai21  g321(.a(x078), .b(new_n300_), .c(new_n299_), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n477_), .O(new_n479_));
  nand3  g323(.a(new_n336_), .b(new_n332_), .c(x070), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n479_), .c(x054), .O(new_n481_));
  nor3   g325(.a(new_n328_), .b(x078), .c(new_n311_), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(new_n481_), .c(new_n324_), .O(new_n483_));
  oai22  g327(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n484_));
  nand3  g328(.a(new_n484_), .b(x070), .c(x022), .O(new_n485_));
  aoi22  g329(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n486_));
  nand4  g330(.a(new_n486_), .b(new_n485_), .c(new_n483_), .d(new_n476_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n158_), .O(new_n488_));
  nand2  g332(.a(x117), .b(x102), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n316_), .O(new_n490_));
  nand3  g334(.a(new_n490_), .b(new_n302_), .c(new_n324_), .O(new_n491_));
  nand2  g335(.a(x117), .b(x006), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n491_), .c(new_n298_), .O(new_n493_));
  nor3   g337(.a(new_n328_), .b(new_n250_), .c(new_n296_), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n493_), .c(new_n297_), .O(new_n495_));
  nand4  g339(.a(x117), .b(new_n324_), .c(x038), .d(x030), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n495_), .O(new_n497_));
  oai21  g341(.a(new_n300_), .b(new_n299_), .c(new_n497_), .O(new_n498_));
  nand4  g342(.a(x117), .b(new_n324_), .c(x070), .d(x030), .O(new_n499_));
  ...
  oai21  g348(.a(new_n333_), .b(new_n311_), .c(new_n477_), .O(new_n505_));
  aoi21  g349(.a(new_n505_), .b(new_n504_), .c(new_n296_), .O(new_n506_));
  nand4  g350(.a(new_n477_), .b(new_n302_), .c(new_n324_), .d(x030), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n506_), .c(x117), .O(new_n509_));
  inv1   g353(.a(x094), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n333_), .O(new_n511_));
  nand2  g355(.a(x118), .b(new_n306_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n511_), .c(new_n474_), .O(new_n513_));
  ...
  aoi21  g364(.a(new_n520_), .b(new_n488_), .c(x046), .O(z14));
  zero   g365(.O(z16));
  zero   g366(.O(z17));
  zero   g367(.O(z19));
  zero   g368(.O(z21));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(x126), .b(x117), .O(z15));
  nor2   g374(.a(x126), .b(x117), .O(z18));
  nor2   g375(.a(x126), .b(x117), .O(z20));
  nor2   g376(.a(x126), .b(x117), .O(z23));
  nor2   g377(.a(x126), .b(x117), .O(z25));
endmodule
