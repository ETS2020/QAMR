// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:20 2020
...
module FAU ( 
  ...
  inv1   g015(.a(x106), .O(new_n172_));
  nor2   g016(.a(x118), .b(new_n172_), .O(z17));
  inv1   g017(.a(z17), .O(new_n174_));
  ...
  aoi21  g152(.a(new_n308_), .b(new_n307_), .c(x022), .O(new_n309_));
  ...
  oai21  g158(.a(new_n314_), .b(new_n309_), .c(new_n306_), .O(new_n315_));
  nand2  g159(.a(new_n311_), .b(x054), .O(new_n316_));
  aoi22  g160(.a(new_n316_), .b(new_n301_), .c(new_n303_), .d(new_n300_), .O(new_n317_));
  nand3  g161(.a(new_n317_), .b(new_n315_), .c(new_n305_), .O(new_n318_));
  nand2  g162(.a(new_n318_), .b(new_n174_), .O(new_n319_));
  inv1   g163(.a(x110), .O(new_n320_));
  nand2  g164(.a(x118), .b(new_n320_), .O(new_n321_));
  oai21  g165(.a(x118), .b(x106), .c(new_n321_), .O(new_n322_));
  aoi21  g166(.a(new_n306_), .b(new_n301_), .c(x006), .O(new_n323_));
  ...
  aoi21  g173(.a(new_n329_), .b(x086), .c(new_n323_), .O(new_n330_));
  oai22  g174(.a(new_n330_), .b(new_n303_), .c(new_n299_), .d(x014), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n322_), .O(new_n332_));
  inv1   g176(.a(x102), .O(new_n333_));
  inv1   g177(.a(x126), .O(new_n334_));
  aoi22  g178(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n335_));
  inv1   g179(.a(x022), .O(new_n336_));
  nand2  g180(.a(new_n336_), .b(new_n300_), .O(new_n337_));
  nand4  g181(.a(new_n337_), .b(new_n327_), .c(x086), .d(new_n324_), .O(new_n338_));
  oai21  g182(.a(new_n335_), .b(x006), .c(new_n338_), .O(new_n339_));
  oai21  g183(.a(new_n334_), .b(new_n333_), .c(new_n339_), .O(new_n340_));
  oai21  g184(.a(new_n310_), .b(new_n324_), .c(new_n337_), .O(new_n341_));
  oai21  g185(.a(x126), .b(new_n336_), .c(new_n341_), .O(new_n342_));
  nand2  g186(.a(new_n342_), .b(new_n298_), .O(new_n343_));
  nand4  g187(.a(x086), .b(new_n306_), .c(new_n324_), .d(x022), .O(new_n344_));
  nand3  g188(.a(new_n344_), .b(new_n343_), .c(new_n340_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(x118), .c(x078), .O(new_n346_));
  nand2  g190(.a(new_n346_), .b(new_n332_), .O(new_n347_));
  nand3  g191(.a(x118), .b(x086), .c(new_n324_), .O(new_n348_));
  nand4  g192(.a(new_n334_), .b(x110), .c(new_n172_), .d(new_n298_), .O(new_n349_));
  aoi21  g193(.a(new_n349_), .b(new_n348_), .c(new_n300_), .O(new_n350_));
  nand4  g194(.a(x118), .b(x086), .c(new_n324_), .d(x022), .O(new_n351_));
  inv1   g195(.a(new_n351_), .O(new_n352_));
  oai21  g196(.a(new_n352_), .b(new_n350_), .c(x078), .O(new_n353_));
  nor2   g197(.a(new_n353_), .b(x038), .O(new_n354_));
  aoi21  g198(.a(new_n347_), .b(x054), .c(new_n354_), .O(new_n355_));
  aoi21  g199(.a(new_n355_), .b(new_n319_), .c(new_n297_), .O(z06));
  inv1   g200(.a(x024), .O(new_n358_));
  nor2   g201(.a(x088), .b(x056), .O(new_n359_));
  nand2  g202(.a(new_n359_), .b(new_n358_), .O(new_n360_));
  oai21  g203(.a(new_n165_), .b(new_n159_), .c(new_n360_), .O(new_n361_));
  ...
  oai21  g210(.a(new_n367_), .b(new_n364_), .c(new_n166_), .O(new_n368_));
  oai21  g211(.a(new_n363_), .b(x104), .c(x032), .O(new_n369_));
  nand2  g212(.a(new_n369_), .b(x112), .O(new_n370_));
  oai21  g213(.a(new_n362_), .b(x056), .c(new_n365_), .O(new_n371_));
  nand3  g214(.a(x120), .b(new_n366_), .c(new_n165_), .O(new_n372_));
  nand2  g215(.a(new_n372_), .b(new_n158_), .O(new_n373_));
  aoi21  g216(.a(new_n371_), .b(new_n160_), .c(new_n373_), .O(new_n374_));
  nand4  g217(.a(new_n374_), .b(new_n370_), .c(new_n368_), .d(new_n361_), .O(new_n375_));
  nor2   g218(.a(x032), .b(new_n159_), .O(new_n376_));
  nor2   g219(.a(new_n363_), .b(x056), .O(new_n377_));
  aoi22  g220(.a(new_n377_), .b(new_n376_), .c(new_n375_), .d(new_n162_), .O(new_n378_));
  ...
  aoi21  g224(.a(new_n381_), .b(x024), .c(x016), .O(new_n382_));
  oai21  g225(.a(new_n382_), .b(x072), .c(new_n159_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n367_), .O(new_n384_));
  nand2  g227(.a(x024), .b(new_n165_), .O(new_n385_));
  aoi21  g228(.a(new_n385_), .b(new_n359_), .c(new_n166_), .O(new_n386_));
  nand2  g229(.a(new_n363_), .b(new_n362_), .O(new_n387_));
  aoi22  g230(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n388_));
  nand3  g231(.a(new_n388_), .b(new_n387_), .c(x024), .O(new_n389_));
  inv1   g232(.a(new_n389_), .O(new_n390_));
  oai21  g233(.a(new_n390_), .b(new_n386_), .c(new_n162_), .O(new_n391_));
  aoi21  g234(.a(new_n391_), .b(new_n384_), .c(x048), .O(new_n392_));
  oai21  g235(.a(new_n165_), .b(new_n159_), .c(x024), .O(new_n393_));
  nand2  g236(.a(new_n393_), .b(new_n359_), .O(new_n394_));
  nand3  g237(.a(new_n394_), .b(new_n162_), .c(x032), .O(new_n395_));
  inv1   g238(.a(new_n395_), .O(new_n396_));
  oai21  g239(.a(new_n396_), .b(new_n392_), .c(new_n158_), .O(new_n397_));
  ...
  aoi21  g244(.a(new_n380_), .b(x000), .c(new_n401_), .O(new_n402_));
  oai21  g245(.a(new_n402_), .b(x040), .c(new_n174_), .O(z08));
  ...
  nand3  g253(.a(new_n410_), .b(new_n174_), .c(new_n404_), .O(new_n411_));
  ...
  oai22  g324(.a(x078), .b(x054), .c(x038), .d(x014), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(x086), .c(x006), .O(new_n483_));
  aoi22  g326(.a(new_n303_), .b(new_n301_), .c(new_n302_), .d(new_n300_), .O(new_n484_));
  nand3  g327(.a(new_n327_), .b(new_n299_), .c(new_n303_), .O(new_n485_));
  oai22  g328(.a(new_n485_), .b(x054), .c(new_n484_), .d(new_n336_), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(x070), .O(new_n487_));
  nand2  g330(.a(new_n485_), .b(new_n302_), .O(new_n488_));
  aoi22  g331(.a(new_n488_), .b(x038), .c(x078), .d(x014), .O(new_n489_));
  nand3  g332(.a(new_n489_), .b(new_n487_), .c(new_n483_), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(new_n174_), .O(new_n491_));
  inv1   g334(.a(x118), .O(new_n492_));
  oai21  g335(.a(new_n320_), .b(x106), .c(new_n492_), .O(new_n493_));
  aoi21  g336(.a(x070), .b(x038), .c(new_n298_), .O(new_n494_));
  nand2  g337(.a(new_n310_), .b(x030), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(new_n336_), .c(x086), .O(new_n496_));
  oai21  g339(.a(new_n496_), .b(new_n494_), .c(new_n303_), .O(new_n497_));
  oai21  g340(.a(x086), .b(new_n300_), .c(new_n497_), .O(new_n498_));
  nand2  g341(.a(new_n498_), .b(new_n493_), .O(new_n499_));
  nand2  g342(.a(x022), .b(x014), .O(new_n500_));
  nand3  g343(.a(new_n326_), .b(new_n325_), .c(new_n324_), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  nand2  g345(.a(new_n334_), .b(new_n333_), .O(new_n503_));
  nand3  g346(.a(new_n503_), .b(new_n326_), .c(new_n306_), .O(new_n504_));
  nand3  g347(.a(x102), .b(new_n325_), .c(new_n301_), .O(new_n505_));
  nand3  g348(.a(x126), .b(new_n492_), .c(new_n336_), .O(new_n506_));
  nand4  g349(.a(new_n506_), .b(new_n505_), .c(new_n504_), .d(new_n502_), .O(new_n507_));
  nand4  g350(.a(x126), .b(new_n325_), .c(new_n301_), .d(x014), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(new_n509_));
  aoi21  g352(.a(new_n507_), .b(new_n303_), .c(new_n509_), .O(new_n510_));
  nand3  g353(.a(new_n503_), .b(new_n500_), .c(new_n310_), .O(new_n511_));
  oai21  g354(.a(new_n306_), .b(x022), .c(new_n511_), .O(new_n512_));
  nand4  g355(.a(new_n512_), .b(new_n299_), .c(new_n303_), .d(x030), .O(new_n513_));
  oai21  g356(.a(new_n510_), .b(new_n298_), .c(new_n513_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n172_), .O(new_n515_));
  nor2   g358(.a(new_n334_), .b(new_n492_), .O(new_n516_));
  nand4  g359(.a(new_n516_), .b(new_n320_), .c(new_n303_), .d(x006), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(new_n515_), .c(new_n499_), .O(new_n518_));
  nand3  g361(.a(new_n500_), .b(new_n172_), .c(new_n299_), .O(new_n519_));
  nor4   g362(.a(new_n519_), .b(x078), .c(new_n301_), .d(new_n324_), .O(new_n520_));
  aoi21  g363(.a(new_n518_), .b(new_n302_), .c(new_n520_), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n491_), .c(x046), .O(z14));
  zero   g365(.O(z07));
  zero   g366(.O(z15));
  zero   g367(.O(z16));
  zero   g368(.O(z19));
  zero   g369(.O(z23));
  nor2   g370(.a(x118), .b(new_n172_), .O(z18));
  nor2   g371(.a(x118), .b(new_n172_), .O(z20));
  nor2   g372(.a(x118), .b(new_n172_), .O(z21));
  nor2   g373(.a(x118), .b(new_n172_), .O(z22));
  nor2   g374(.a(x118), .b(new_n172_), .O(z24));
  nor2   g375(.a(x118), .b(new_n172_), .O(z25));
  nor2   g376(.a(x118), .b(new_n172_), .O(z26));
  nor2   g377(.a(x118), .b(new_n172_), .O(z27));
endmodule
