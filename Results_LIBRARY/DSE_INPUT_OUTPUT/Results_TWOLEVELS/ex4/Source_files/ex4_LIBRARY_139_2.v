...
module FAU ( 
  ...
  nor2   g001(.a(x083), .b(new_n157_), .O(z07));
  ...
  aoi22  g263(.a(new_n213_), .b(new_n212_), .c(new_n211_), .d(new_n210_), .O(new_n420_));
  nor2   g264(.a(new_n420_), .b(new_n208_), .O(new_n421_));
  ...
  oai21  g269(.a(new_n425_), .b(new_n421_), .c(x083), .O(new_n426_));
  nand2  g270(.a(new_n425_), .b(new_n157_), .O(new_n427_));
  aoi21  g271(.a(new_n427_), .b(new_n426_), .c(x043), .O(z11));
  ...
  nor2   g325(.a(new_n209_), .b(new_n298_), .O(new_n482_));
  ...
  nand3  g359(.a(new_n515_), .b(x083), .c(x078), .O(new_n516_));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(x083), .b(new_n157_), .O(z18));
  nor2   g374(.a(x083), .b(new_n157_), .O(z24));
  nor2   g375(.a(x083), .b(new_n157_), .O(z25));
endmodule
