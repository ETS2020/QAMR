...
module FAU ( 
  ...
  nand2  g037(.a(x034), .b(x010), .O(new_n194_));
  nand2  g038(.a(x074), .b(x050), .O(new_n195_));
  aoi21  g039(.a(new_n195_), .b(new_n194_), .c(x082), .O(new_n196_));
  nand2  g040(.a(new_n196_), .b(new_n193_), .O(new_n197_));
  inv1   g041(.a(x018), .O(new_n198_));
  nand2  g042(.a(x050), .b(x010), .O(new_n199_));
  nand2  g043(.a(x074), .b(x034), .O(new_n200_));
  aoi21  g044(.a(new_n200_), .b(new_n199_), .c(x066), .O(new_n201_));
  inv1   g045(.a(x010), .O(new_n202_));
  inv1   g046(.a(x074), .O(new_n203_));
  aoi21  g047(.a(new_n203_), .b(new_n202_), .c(x126), .O(new_n204_));
  oai21  g048(.a(x050), .b(x034), .c(new_n204_), .O(new_n205_));
  aoi21  g049(.a(new_n201_), .b(new_n198_), .c(new_n205_), .O(new_n206_));
  aoi21  g050(.a(new_n206_), .b(new_n197_), .c(new_n172_), .O(z02));
  ...
  and2   g257(.a(new_n413_), .b(new_n172_), .O(z10));
  ...
  nand2  g333(.a(new_n489_), .b(new_n175_), .O(new_n490_));
  nor2   g334(.a(new_n301_), .b(new_n300_), .O(new_n491_));
  nand2  g335(.a(x126), .b(new_n172_), .O(new_n492_));
  nand2  g336(.a(new_n173_), .b(x102), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n492_), .c(new_n340_), .O(new_n494_));
  nor2   g338(.a(x126), .b(new_n297_), .O(new_n495_));
  aoi21  g339(.a(new_n494_), .b(new_n324_), .c(new_n495_), .O(new_n496_));
  nand3  g340(.a(new_n336_), .b(new_n173_), .c(x006), .O(new_n497_));
  oai21  g341(.a(new_n496_), .b(new_n299_), .c(new_n497_), .O(new_n498_));
  nand4  g342(.a(new_n173_), .b(new_n324_), .c(x038), .d(x030), .O(new_n499_));
  inv1   g343(.a(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n498_), .b(new_n298_), .c(new_n500_), .O(new_n501_));
  nand4  g345(.a(x126), .b(new_n308_), .c(new_n172_), .d(x006), .O(new_n502_));
  nand4  g346(.a(new_n173_), .b(new_n324_), .c(x070), .d(x030), .O(new_n503_));
  ...
  aoi21  g353(.a(new_n509_), .b(new_n507_), .c(new_n297_), .O(new_n510_));
  nand4  g354(.a(new_n479_), .b(new_n303_), .c(new_n324_), .d(x030), .O(new_n511_));
  inv1   g355(.a(new_n511_), .O(new_n512_));
  oai21  g356(.a(new_n512_), .b(new_n510_), .c(new_n173_), .O(new_n513_));
  ...
  nand4  g361(.a(new_n517_), .b(x126), .c(new_n172_), .d(x006), .O(new_n518_));
  ...
  nand4  g365(.a(x126), .b(new_n315_), .c(new_n298_), .d(new_n172_), .O(new_n522_));
  ...
  zero   g371(.O(z23));
  zero   g372(.O(z27));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z15));
