...
module FAU ( 
  ...
  oai22  g073(.a(new_n229_), .b(new_n228_), .c(new_n172_), .d(new_n227_), .O(new_n230_));
  nand3  g074(.a(new_n230_), .b(new_n226_), .c(new_n225_), .O(new_n231_));
  inv1   g075(.a(x020), .O(new_n232_));
  inv1   g076(.a(x068), .O(new_n233_));
  oai22  g077(.a(new_n229_), .b(new_n172_), .c(new_n228_), .d(new_n227_), .O(new_n234_));
  nand3  g078(.a(new_n234_), .b(new_n233_), .c(new_n232_), .O(new_n235_));
  aoi22  g079(.a(new_n229_), .b(new_n227_), .c(new_n228_), .d(new_n172_), .O(new_n236_));
  ...
  nand3  g257(.a(new_n413_), .b(new_n175_), .c(new_n365_), .O(new_n414_));
  ...
  oai21  g266(.a(new_n422_), .b(x041), .c(new_n175_), .O(z09));
  ...
  oai21  g274(.a(new_n430_), .b(x042), .c(new_n175_), .O(z10));
  ...
  oai21  g291(.a(new_n447_), .b(x044), .c(new_n175_), .O(z12));
  ...
  aoi21  g332(.a(new_n173_), .b(new_n345_), .c(x094), .O(new_n489_));
  inv1   g333(.a(x110), .O(new_n490_));
  nand2  g334(.a(new_n354_), .b(new_n490_), .O(new_n491_));
  ...
  oai21  g338(.a(new_n345_), .b(x062), .c(new_n490_), .O(new_n495_));
  nand3  g339(.a(x126), .b(new_n354_), .c(new_n316_), .O(new_n496_));
  ...
  nand2  g353(.a(new_n173_), .b(new_n345_), .O(new_n510_));
  ...
  nor2   g379(.a(new_n173_), .b(new_n172_), .O(z18));
