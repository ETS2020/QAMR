...
module FAU ( 
  ...
  aoi21  g320(.a(x070), .b(x038), .c(new_n298_), .O(new_n477_));
  nand2  g321(.a(new_n304_), .b(x030), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n341_), .c(x086), .O(new_n479_));
  ...
  nand2  g331(.a(new_n487_), .b(new_n337_), .O(new_n488_));
  nor2   g332(.a(x126), .b(x102), .O(new_n489_));
  nand4  g333(.a(new_n485_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n490_));
  inv1   g334(.a(x094), .O(new_n491_));
  nand3  g335(.a(new_n491_), .b(new_n334_), .c(x006), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n490_), .c(new_n489_), .O(new_n493_));
  oai21  g337(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n302_), .O(new_n495_));
  oai22  g339(.a(new_n309_), .b(x110), .c(new_n491_), .d(x062), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(x126), .O(new_n497_));
  aoi21  g341(.a(x030), .b(new_n299_), .c(x086), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n497_), .c(new_n495_), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(x006), .c(new_n493_), .O(new_n500_));
  nand4  g344(.a(new_n500_), .b(new_n488_), .c(new_n484_), .d(new_n480_), .O(new_n501_));
  nand2  g345(.a(x038), .b(x014), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(x070), .c(x022), .O(new_n503_));
  oai22  g347(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n299_), .O(new_n505_));
  nand2  g349(.a(x030), .b(new_n302_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n330_), .c(x086), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(x054), .c(x038), .O(new_n508_));
  nand4  g352(.a(new_n508_), .b(new_n505_), .c(new_n503_), .d(new_n157_), .O(new_n509_));
  aoi21  g353(.a(new_n501_), .b(new_n300_), .c(new_n509_), .O(new_n510_));
  nor2   g354(.a(new_n510_), .b(x046), .O(z14));
  zero   g355(.O(z17));
  zero   g356(.O(z18));
  zero   g357(.O(z19));
  zero   g358(.O(z22));
  nor2   g359(.a(new_n157_), .b(x046), .O(z15));
  nor2   g360(.a(new_n157_), .b(x046), .O(z16));
  nor2   g361(.a(new_n157_), .b(x046), .O(z20));
  nor2   g362(.a(new_n157_), .b(x046), .O(z21));
  nor2   g363(.a(new_n157_), .b(x046), .O(z23));
  nor2   g364(.a(new_n157_), .b(x046), .O(z24));
  nor2   g365(.a(new_n157_), .b(x046), .O(z25));
  nor2   g366(.a(new_n157_), .b(x046), .O(z26));
  nor2   g367(.a(new_n157_), .b(x046), .O(z27));
endmodule
