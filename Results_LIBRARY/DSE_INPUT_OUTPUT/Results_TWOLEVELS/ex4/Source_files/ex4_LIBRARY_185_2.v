// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:31 2020
...
module FAU ( 
  ...
  aoi21  g181(.a(new_n337_), .b(new_n335_), .c(new_n157_), .O(new_n338_));
  ...
  oai22  g188(.a(new_n157_), .b(new_n312_), .c(new_n298_), .d(new_n300_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n333_), .c(new_n301_), .O(new_n346_));
  aoi22  g190(.a(new_n157_), .b(new_n300_), .c(new_n298_), .d(new_n312_), .O(new_n347_));
  ...
  nand3  g213(.a(x120), .b(new_n369_), .c(new_n168_), .O(new_n370_));
  nand2  g214(.a(new_n370_), .b(new_n161_), .O(new_n371_));
  aoi21  g215(.a(new_n368_), .b(new_n163_), .c(new_n371_), .O(new_n372_));
  nand4  g216(.a(new_n372_), .b(new_n365_), .c(new_n362_), .d(new_n358_), .O(new_n373_));
  nand4  g217(.a(x120), .b(new_n355_), .c(new_n163_), .d(x008), .O(new_n374_));
  inv1   g218(.a(new_n374_), .O(new_n375_));
  aoi21  g219(.a(new_n373_), .b(new_n165_), .c(new_n375_), .O(new_n376_));
  ...
  nand2  g225(.a(new_n381_), .b(new_n168_), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n165_), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(new_n162_), .c(new_n360_), .O(new_n384_));
  ...
  oai21  g234(.a(new_n390_), .b(new_n384_), .c(new_n164_), .O(new_n391_));
  ...
  aoi21  g243(.a(new_n395_), .b(new_n161_), .c(new_n399_), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(new_n379_), .O(new_n401_));
  nand3  g245(.a(new_n401_), .b(new_n159_), .c(new_n353_), .O(new_n402_));
  ...
  oai21  g254(.a(new_n410_), .b(x041), .c(new_n159_), .O(z09));
  ...
  nand2  g286(.a(new_n442_), .b(new_n277_), .O(new_n443_));
  oai21  g287(.a(new_n260_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(x117), .O(new_n445_));
  inv1   g289(.a(x101), .O(new_n446_));
  oai21  g290(.a(new_n446_), .b(x061), .c(new_n250_), .O(new_n447_));
  nand3  g291(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n268_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n255_), .c(new_n449_), .O(new_n450_));
  nand4  g294(.a(new_n450_), .b(new_n445_), .c(new_n443_), .d(new_n439_), .O(new_n451_));
  nand4  g295(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n276_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(x005), .O(new_n457_));
  nand2  g301(.a(new_n246_), .b(x029), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n244_), .O(new_n459_));
  nand2  g303(.a(new_n459_), .b(new_n276_), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n243_), .c(new_n441_), .O(new_n461_));
  nor2   g305(.a(new_n242_), .b(x021), .O(new_n462_));
  oai21  g306(.a(new_n462_), .b(new_n280_), .c(x069), .O(new_n463_));
  inv1   g307(.a(new_n440_), .O(new_n464_));
  nand4  g308(.a(new_n464_), .b(new_n438_), .c(new_n246_), .d(x029), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n463_), .c(x077), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n461_), .c(new_n241_), .O(new_n467_));
  nand2  g311(.a(new_n438_), .b(x029), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n272_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n276_), .c(x037), .O(new_n470_));
  ...
  aoi21  g319(.a(new_n471_), .b(new_n268_), .c(new_n475_), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n457_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n159_), .c(new_n437_), .O(new_n478_));
  inv1   g322(.a(new_n478_), .O(z13));
  oai21  g323(.a(x046), .b(new_n300_), .c(x105), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(x078), .O(new_n481_));
  oai22  g325(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n482_));
  inv1   g326(.a(x102), .O(new_n483_));
  aoi21  g327(.a(new_n317_), .b(new_n483_), .c(x094), .O(new_n484_));
  nand2  g328(.a(new_n308_), .b(new_n307_), .O(new_n485_));
  oai21  g329(.a(new_n485_), .b(new_n484_), .c(new_n333_), .O(new_n486_));
  oai21  g330(.a(new_n317_), .b(x110), .c(x038), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x118), .O(new_n488_));
  oai21  g332(.a(new_n483_), .b(x062), .c(new_n307_), .O(new_n489_));
  nand3  g333(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n325_), .O(new_n491_));
  aoi21  g335(.a(new_n489_), .b(new_n312_), .c(new_n491_), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n488_), .c(new_n486_), .d(new_n482_), .O(new_n493_));
  nand4  g337(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n494_));
  inv1   g338(.a(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n493_), .b(new_n157_), .c(new_n495_), .O(new_n496_));
  nand3  g340(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n497_));
  oai21  g341(.a(new_n496_), .b(x054), .c(new_n497_), .O(new_n498_));
  aoi21  g342(.a(new_n303_), .b(x030), .c(x022), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(x078), .c(new_n300_), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n485_), .O(new_n501_));
  nand2  g345(.a(x030), .b(new_n301_), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n329_), .c(new_n333_), .O(new_n503_));
  nand2  g347(.a(new_n317_), .b(new_n483_), .O(new_n504_));
  ...
  oai21  g351(.a(new_n507_), .b(new_n503_), .c(new_n157_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n501_), .c(x054), .O(new_n509_));
  oai21  g353(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n329_), .O(new_n511_));
  nand3  g355(.a(new_n511_), .b(new_n157_), .c(x038), .O(new_n512_));
  inv1   g356(.a(new_n512_), .O(new_n513_));
  oai21  g357(.a(new_n513_), .b(new_n509_), .c(new_n325_), .O(new_n514_));
  oai22  g358(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n515_));
  nand3  g359(.a(new_n515_), .b(x070), .c(x022), .O(new_n516_));
  nand2  g360(.a(x054), .b(x038), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n516_), .c(new_n514_), .O(new_n518_));
  aoi21  g362(.a(new_n498_), .b(x006), .c(new_n518_), .O(new_n519_));
  oai21  g363(.a(new_n519_), .b(x046), .c(new_n481_), .O(z14));
  zero   g364(.O(z15));
  zero   g365(.O(z16));
  zero   g366(.O(z17));
  zero   g367(.O(z23));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z27));
  nor2   g371(.a(x105), .b(new_n157_), .O(z18));
  nor2   g372(.a(x105), .b(new_n157_), .O(z19));
  nor2   g373(.a(x105), .b(new_n157_), .O(z20));
  nor2   g374(.a(x105), .b(new_n157_), .O(z21));
  nor2   g375(.a(x105), .b(new_n157_), .O(z22));
  nor2   g376(.a(x105), .b(new_n157_), .O(z26));
endmodule
