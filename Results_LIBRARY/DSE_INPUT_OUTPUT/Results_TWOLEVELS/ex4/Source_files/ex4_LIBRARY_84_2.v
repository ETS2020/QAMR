// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:41 2020
...
module FAU ( 
  ...
  aoi21  g140(.a(x046), .b(new_n296_), .c(x015), .O(new_n297_));
  ...
  oai21  g253(.a(new_n409_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g261(.a(new_n417_), .b(x042), .c(new_n159_), .O(z10));
  ...
  oai21  g278(.a(new_n434_), .b(x044), .c(new_n159_), .O(z12));
  ...
  oai21  g285(.a(new_n441_), .b(new_n439_), .c(new_n277_), .O(new_n442_));
  oai21  g286(.a(new_n260_), .b(x109), .c(x037), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(x117), .O(new_n444_));
  oai21  g288(.a(new_n438_), .b(x061), .c(new_n250_), .O(new_n445_));
  ...
  aoi21  g298(.a(new_n246_), .b(x029), .c(x021), .O(new_n455_));
  oai21  g299(.a(new_n455_), .b(x077), .c(new_n243_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n441_), .O(new_n457_));
  nand2  g301(.a(x029), .b(new_n244_), .O(new_n458_));
  aoi21  g302(.a(new_n458_), .b(new_n272_), .c(new_n277_), .O(new_n459_));
  nand2  g303(.a(new_n260_), .b(new_n438_), .O(new_n460_));
  nand4  g304(.a(new_n460_), .b(new_n436_), .c(new_n246_), .d(x029), .O(new_n461_));
  inv1   g305(.a(new_n461_), .O(new_n462_));
  oai21  g306(.a(new_n462_), .b(new_n459_), .c(new_n276_), .O(new_n463_));
  ...
  oai21  g312(.a(new_n468_), .b(new_n464_), .c(new_n268_), .O(new_n469_));
  ...
  oai21  g318(.a(new_n474_), .b(x045), .c(new_n159_), .O(z13));
  nor2   g319(.a(new_n301_), .b(new_n296_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(new_n300_), .c(new_n329_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n325_), .c(new_n333_), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n299_), .c(x015), .O(new_n479_));
  nor2   g323(.a(new_n333_), .b(new_n299_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n479_), .c(x038), .O(new_n481_));
  aoi21  g325(.a(new_n329_), .b(new_n300_), .c(new_n476_), .O(new_n482_));
  ...
  nand2  g329(.a(new_n485_), .b(new_n334_), .O(new_n486_));
  oai21  g330(.a(new_n317_), .b(x110), .c(x038), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x118), .O(new_n488_));
  inv1   g332(.a(x102), .O(new_n489_));
  oai21  g333(.a(new_n489_), .b(x062), .c(new_n307_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n312_), .O(new_n491_));
  nor2   g335(.a(new_n317_), .b(x118), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n301_), .c(x086), .O(new_n493_));
  nand4  g337(.a(new_n493_), .b(new_n491_), .c(new_n488_), .d(new_n486_), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n482_), .c(new_n299_), .O(new_n495_));
  nand2  g339(.a(x086), .b(new_n296_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(new_n298_), .O(new_n497_));
  aoi21  g341(.a(new_n303_), .b(x030), .c(x022), .O(new_n498_));
  or2    g342(.a(new_n498_), .b(new_n484_), .O(new_n499_));
  nor2   g343(.a(new_n300_), .b(x022), .O(new_n500_));
  oai21  g344(.a(new_n500_), .b(new_n337_), .c(x070), .O(new_n501_));
  inv1   g345(.a(new_n483_), .O(new_n502_));
  nor2   g346(.a(new_n476_), .b(new_n341_), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n502_), .c(x030), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n501_), .c(new_n499_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n325_), .c(new_n299_), .O(new_n506_));
  nand2  g350(.a(x038), .b(x014), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(x070), .c(x022), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n506_), .O(new_n509_));
  oai21  g353(.a(new_n509_), .b(new_n497_), .c(new_n333_), .O(new_n510_));
  nand4  g354(.a(x126), .b(new_n315_), .c(new_n312_), .d(x006), .O(new_n511_));
  oai21  g355(.a(new_n484_), .b(x086), .c(new_n511_), .O(new_n512_));
  nand3  g356(.a(new_n512_), .b(new_n299_), .c(x014), .O(new_n513_));
  nand2  g357(.a(new_n513_), .b(new_n510_), .O(new_n514_));
  nand3  g358(.a(x070), .b(new_n299_), .c(x022), .O(new_n515_));
  nand3  g359(.a(x086), .b(new_n312_), .c(x006), .O(new_n516_));
  nand3  g360(.a(new_n516_), .b(new_n515_), .c(new_n296_), .O(new_n517_));
  and2   g361(.a(new_n517_), .b(x078), .O(new_n518_));
  aoi21  g362(.a(new_n514_), .b(new_n157_), .c(new_n518_), .O(new_n519_));
  aoi21  g363(.a(new_n519_), .b(new_n481_), .c(x046), .O(z14));
  zero   g364(.O(z16));
  zero   g365(.O(z17));
  zero   g366(.O(z19));
  zero   g367(.O(z20));
  ...
  nor2   g375(.a(x078), .b(new_n157_), .O(z22));
  nor2   g376(.a(x078), .b(new_n157_), .O(z27));
endmodule
