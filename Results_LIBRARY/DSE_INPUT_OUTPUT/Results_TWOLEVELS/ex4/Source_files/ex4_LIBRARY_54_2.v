...
module FAU ( 
  ...
  nand2  g033(.a(new_n188_), .b(x126), .O(new_n190_));
  ...
  oai21  g255(.a(new_n411_), .b(new_n407_), .c(x126), .O(new_n412_));
  ...
  oai22  g327(.a(new_n337_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n484_));
  ...
  aoi21  g348(.a(new_n504_), .b(new_n329_), .c(new_n334_), .O(new_n505_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n505_), .c(new_n333_), .O(new_n510_));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z27));
  nor2   g374(.a(x126), .b(new_n172_), .O(z16));
  nor2   g375(.a(x126), .b(new_n172_), .O(z20));
  nor2   g376(.a(x126), .b(new_n172_), .O(z21));
  nor2   g377(.a(x126), .b(new_n172_), .O(z24));
  nor2   g378(.a(x126), .b(new_n172_), .O(z26));
endmodule
