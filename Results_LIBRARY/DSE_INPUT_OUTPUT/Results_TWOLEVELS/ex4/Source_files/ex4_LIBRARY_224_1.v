...
module FAU ( 
  ...
  oai21  g257(.a(new_n414_), .b(x042), .c(new_n159_), .O(z10));
  ...
  oai21  g274(.a(new_n431_), .b(x044), .c(new_n159_), .O(z12));
  ...
  nand3  g316(.a(new_n473_), .b(new_n159_), .c(new_n433_), .O(new_n474_));
  inv1   g317(.a(new_n474_), .O(z13));
  inv1   g318(.a(x118), .O(new_n476_));
  oai21  g319(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n477_));
  nand2  g320(.a(new_n301_), .b(x030), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n299_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n312_), .O(new_n480_));
  aoi22  g323(.a(new_n480_), .b(new_n477_), .c(new_n476_), .d(new_n314_), .O(new_n481_));
  nand3  g324(.a(new_n312_), .b(x070), .c(x030), .O(new_n482_));
  nand3  g325(.a(x102), .b(new_n305_), .c(x006), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n482_), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n304_), .O(new_n485_));
  nand2  g328(.a(new_n325_), .b(x006), .O(new_n486_));
  oai21  g329(.a(x086), .b(new_n306_), .c(new_n486_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n329_), .O(new_n488_));
  nand4  g331(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n489_));
  nand3  g332(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(new_n489_), .O(new_n491_));
  oai21  g334(.a(x126), .b(x102), .c(new_n491_), .O(new_n492_));
  nand2  g335(.a(x126), .b(new_n476_), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n298_), .c(x022), .O(new_n494_));
  nand2  g337(.a(x030), .b(new_n343_), .O(new_n495_));
  nand3  g338(.a(x126), .b(x094), .c(new_n305_), .O(new_n496_));
  nand3  g339(.a(new_n496_), .b(new_n495_), .c(new_n312_), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(new_n494_), .c(x006), .O(new_n498_));
  nand4  g341(.a(new_n498_), .b(new_n492_), .c(new_n488_), .d(new_n485_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n481_), .c(new_n340_), .O(new_n500_));
  nand3  g343(.a(x126), .b(new_n314_), .c(x038), .O(new_n501_));
  aoi21  g344(.a(new_n501_), .b(new_n312_), .c(new_n297_), .O(new_n502_));
  nand3  g345(.a(new_n312_), .b(x038), .c(x030), .O(new_n503_));
  oai21  g346(.a(new_n306_), .b(new_n336_), .c(new_n503_), .O(new_n504_));
  oai21  g347(.a(new_n504_), .b(new_n502_), .c(new_n343_), .O(new_n505_));
  nand2  g348(.a(x030), .b(new_n336_), .O(new_n506_));
  aoi21  g349(.a(new_n506_), .b(new_n323_), .c(x086), .O(new_n507_));
  oai21  g350(.a(new_n507_), .b(x054), .c(x038), .O(new_n508_));
  nor2   g351(.a(new_n306_), .b(x038), .O(new_n509_));
  aoi21  g352(.a(new_n509_), .b(x022), .c(x078), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n508_), .c(new_n505_), .O(new_n511_));
  inv1   g354(.a(new_n511_), .O(new_n512_));
  aoi21  g355(.a(new_n512_), .b(new_n500_), .c(x046), .O(z14));
  zero   g356(.O(z07));
  zero   g357(.O(z16));
  zero   g358(.O(z17));
  zero   g359(.O(z19));
  zero   g360(.O(z20));
  zero   g361(.O(z24));
  nor2   g362(.a(new_n157_), .b(x046), .O(z18));
  nor2   g363(.a(new_n157_), .b(x046), .O(z21));
  ...
  nor2   g368(.a(new_n157_), .b(x046), .O(z27));
endmodule
