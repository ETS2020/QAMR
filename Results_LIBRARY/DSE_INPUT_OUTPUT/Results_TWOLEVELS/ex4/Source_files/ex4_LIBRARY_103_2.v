...
module FAU ( 
  ...
  nor2   g001(.a(x096), .b(new_n157_), .O(z16));
  ...
  aoi21  g197(.a(new_n349_), .b(x096), .c(new_n353_), .O(new_n354_));
  ...
  nand4  g217(.a(new_n374_), .b(new_n368_), .c(new_n366_), .d(new_n361_), .O(new_n375_));
  nand4  g218(.a(x120), .b(new_n358_), .c(new_n163_), .d(x008), .O(new_n376_));
  ...
  nand3  g226(.a(new_n360_), .b(new_n161_), .c(new_n164_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n383_), .c(new_n169_), .O(new_n385_));
  nand2  g228(.a(x088), .b(x056), .O(new_n386_));
  nand2  g229(.a(new_n386_), .b(x024), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n168_), .c(new_n364_), .O(new_n388_));
  nand2  g231(.a(new_n362_), .b(new_n298_), .O(new_n389_));
  nand4  g232(.a(new_n386_), .b(new_n389_), .c(new_n357_), .d(x024), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n388_), .c(new_n164_), .O(new_n392_));
  and2   g235(.a(new_n357_), .b(x024), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(new_n360_), .c(x032), .O(new_n394_));
  ...
  nand3  g360(.a(new_n517_), .b(x096), .c(x078), .O(new_n518_));
  ...
  zero   g370(.O(z26));
  zero   g371(.O(z27));
  nor2   g372(.a(x096), .b(new_n157_), .O(z19));
  nor2   g373(.a(x096), .b(new_n157_), .O(z20));
  nor2   g374(.a(x096), .b(new_n157_), .O(z21));
  nor2   g375(.a(x096), .b(new_n157_), .O(z22));
  nor2   g376(.a(x096), .b(new_n157_), .O(z24));
endmodule
