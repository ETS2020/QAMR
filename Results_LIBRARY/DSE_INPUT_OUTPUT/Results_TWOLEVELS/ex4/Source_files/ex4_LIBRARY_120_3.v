// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:57 2020
...
module FAU ( 
  ...
  nand3  g079(.a(new_n235_), .b(new_n157_), .c(x044), .O(new_n236_));
  ...
  oai22  g212(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n369_));
  nand3  g213(.a(new_n369_), .b(x082), .c(x002), .O(new_n370_));
  oai22  g214(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n371_));
  nand3  g215(.a(new_n371_), .b(x066), .c(x018), .O(new_n372_));
  aoi22  g216(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n373_));
  nand3  g217(.a(new_n373_), .b(new_n372_), .c(new_n370_), .O(new_n374_));
  inv1   g218(.a(new_n374_), .O(new_n375_));
  oai21  g219(.a(new_n375_), .b(x042), .c(new_n157_), .O(z10));
  inv1   g220(.a(x043), .O(new_n377_));
  ...
  nand3  g227(.a(new_n383_), .b(new_n157_), .c(new_n377_), .O(new_n384_));
  inv1   g228(.a(new_n384_), .O(z11));
  ...
  oai22  g238(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n395_));
  inv1   g239(.a(x101), .O(new_n396_));
  aoi21  g240(.a(new_n258_), .b(new_n396_), .c(x093), .O(new_n397_));
  nand2  g241(.a(new_n249_), .b(new_n248_), .O(new_n398_));
  oai21  g242(.a(new_n398_), .b(new_n397_), .c(new_n275_), .O(new_n399_));
  oai21  g243(.a(new_n258_), .b(x109), .c(x037), .O(new_n400_));
  nand2  g244(.a(new_n400_), .b(x117), .O(new_n401_));
  oai21  g245(.a(new_n396_), .b(x061), .c(new_n248_), .O(new_n402_));
  nand3  g246(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n403_));
  nand2  g247(.a(new_n403_), .b(new_n266_), .O(new_n404_));
  aoi21  g248(.a(new_n402_), .b(new_n253_), .c(new_n404_), .O(new_n405_));
  nand4  g249(.a(new_n405_), .b(new_n401_), .c(new_n399_), .d(new_n395_), .O(new_n406_));
  nand4  g250(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n407_));
  inv1   g251(.a(new_n407_), .O(new_n408_));
  aoi21  g252(.a(new_n406_), .b(new_n274_), .c(new_n408_), .O(new_n409_));
  nand3  g253(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n410_));
  oai21  g254(.a(new_n409_), .b(x053), .c(new_n410_), .O(new_n411_));
  aoi21  g255(.a(new_n244_), .b(x029), .c(x021), .O(new_n412_));
  oai21  g256(.a(new_n412_), .b(x077), .c(new_n241_), .O(new_n413_));
  nand2  g257(.a(new_n413_), .b(new_n398_), .O(new_n414_));
  nand2  g258(.a(x029), .b(new_n242_), .O(new_n415_));
  aoi21  g259(.a(new_n415_), .b(new_n270_), .c(new_n275_), .O(new_n416_));
  nand2  g260(.a(new_n258_), .b(new_n396_), .O(new_n417_));
  aoi22  g261(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n418_));
  nand3  g262(.a(new_n418_), .b(new_n417_), .c(x029), .O(new_n419_));
  inv1   g263(.a(new_n419_), .O(new_n420_));
  oai21  g264(.a(new_n420_), .b(new_n416_), .c(new_n274_), .O(new_n421_));
  aoi21  g265(.a(new_n421_), .b(new_n414_), .c(x053), .O(new_n422_));
  oai21  g266(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n270_), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(new_n274_), .c(x037), .O(new_n425_));
  inv1   g269(.a(new_n425_), .O(new_n426_));
  oai21  g270(.a(new_n426_), .b(new_n422_), .c(new_n266_), .O(new_n427_));
  oai22  g271(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n428_));
  nand3  g272(.a(new_n428_), .b(x069), .c(x021), .O(new_n429_));
  aoi22  g273(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n430_));
  nand3  g274(.a(new_n430_), .b(new_n429_), .c(new_n427_), .O(new_n431_));
  aoi21  g275(.a(new_n411_), .b(x005), .c(new_n431_), .O(new_n432_));
  oai21  g276(.a(new_n432_), .b(x045), .c(new_n157_), .O(z13));
  ...
  zero   g327(.O(z19));
  zero   g328(.O(z22));
  inv1   g329(.a(new_n157_), .O(z15));
  inv1   g330(.a(new_n157_), .O(z16));
  inv1   g331(.a(new_n157_), .O(z20));
  inv1   g332(.a(new_n157_), .O(z21));
  inv1   g333(.a(new_n157_), .O(z23));
  inv1   g334(.a(new_n157_), .O(z24));
  inv1   g335(.a(new_n157_), .O(z25));
  inv1   g336(.a(new_n157_), .O(z26));
  inv1   g337(.a(new_n157_), .O(z27));
endmodule
