...
module FAU ( 
  ...
  oai22  g040(.a(new_n172_), .b(new_n196_), .c(new_n195_), .d(new_n194_), .O(new_n197_));
  nand3  g041(.a(new_n197_), .b(new_n193_), .c(new_n192_), .O(new_n198_));
  inv1   g042(.a(x018), .O(new_n199_));
  inv1   g043(.a(x066), .O(new_n200_));
  oai22  g044(.a(new_n172_), .b(new_n195_), .c(new_n196_), .d(new_n194_), .O(new_n201_));
  nand3  g045(.a(new_n201_), .b(new_n200_), .c(new_n199_), .O(new_n202_));
  aoi22  g046(.a(new_n172_), .b(new_n194_), .c(new_n196_), .d(new_n195_), .O(new_n203_));
  ...
  aoi21  g140(.a(x046), .b(new_n296_), .c(x074), .O(new_n297_));
  ...
  nand3  g317(.a(new_n474_), .b(new_n174_), .c(new_n436_), .O(new_n475_));
  ...
  aoi21  g322(.a(new_n479_), .b(new_n299_), .c(x074), .O(new_n480_));
  ...
  aoi21  g362(.a(new_n515_), .b(new_n172_), .c(new_n519_), .O(new_n520_));
  ...
  zero   g371(.O(z25));
  zero   g372(.O(z27));
  nor2   g373(.a(x078), .b(new_n172_), .O(z18));
  nor2   g374(.a(x078), .b(new_n172_), .O(z21));
  nor2   g375(.a(x078), .b(new_n172_), .O(z24));
