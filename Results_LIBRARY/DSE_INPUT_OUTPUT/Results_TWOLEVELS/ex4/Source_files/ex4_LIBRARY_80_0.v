// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:34 2020
...
module FAU ( 
  ...
  oai21  g141(.a(new_n297_), .b(x014), .c(x098), .O(new_n298_));
  ...
  nand2  g305(.a(new_n245_), .b(x029), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n243_), .O(new_n463_));
  nand2  g307(.a(new_n463_), .b(new_n275_), .O(new_n464_));
  aoi21  g308(.a(new_n464_), .b(new_n242_), .c(new_n445_), .O(new_n465_));
  nor2   g309(.a(new_n241_), .b(x021), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n279_), .c(x069), .O(new_n467_));
  inv1   g311(.a(new_n444_), .O(new_n468_));
  nand4  g312(.a(new_n468_), .b(new_n442_), .c(new_n245_), .d(x029), .O(new_n469_));
  aoi21  g313(.a(new_n469_), .b(new_n467_), .c(x077), .O(new_n470_));
  oai21  g314(.a(new_n470_), .b(new_n465_), .c(new_n240_), .O(new_n471_));
  ...
  aoi21  g323(.a(new_n475_), .b(new_n267_), .c(new_n479_), .O(new_n480_));
  ...
  oai22  g327(.a(new_n339_), .b(x030), .c(new_n304_), .d(new_n303_), .O(new_n484_));
  inv1   g328(.a(x102), .O(new_n485_));
  aoi21  g329(.a(new_n320_), .b(new_n485_), .c(x094), .O(new_n486_));
  nand2  g330(.a(new_n311_), .b(new_n310_), .O(new_n487_));
  oai21  g331(.a(new_n487_), .b(new_n486_), .c(new_n336_), .O(new_n488_));
  oai21  g332(.a(new_n320_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g334(.a(new_n485_), .b(x062), .c(new_n310_), .O(new_n491_));
  nand3  g335(.a(x126), .b(new_n311_), .c(new_n304_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n328_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n315_), .c(new_n493_), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n490_), .c(new_n488_), .d(new_n484_), .O(new_n495_));
  nand4  g339(.a(x126), .b(new_n318_), .c(new_n315_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n296_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n315_), .c(new_n303_), .O(new_n499_));
  oai21  g343(.a(new_n498_), .b(x054), .c(new_n499_), .O(new_n500_));
  aoi21  g344(.a(new_n306_), .b(x030), .c(x022), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(x078), .c(new_n303_), .O(new_n502_));
  nand2  g346(.a(new_n502_), .b(new_n487_), .O(new_n503_));
  nand2  g347(.a(x030), .b(new_n304_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(new_n332_), .c(new_n336_), .O(new_n505_));
  nand2  g349(.a(new_n320_), .b(new_n485_), .O(new_n506_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n505_), .c(new_n296_), .O(new_n510_));
  aoi21  g354(.a(new_n510_), .b(new_n503_), .c(x054), .O(new_n511_));
  oai21  g355(.a(new_n304_), .b(new_n303_), .c(x030), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n332_), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n296_), .c(x038), .O(new_n514_));
  inv1   g358(.a(new_n514_), .O(new_n515_));
  oai21  g359(.a(new_n515_), .b(new_n511_), .c(new_n328_), .O(new_n516_));
  ...
  zero   g369(.O(z23));
  zero   g370(.O(z24));
  nor2   g371(.a(x098), .b(x078), .O(z15));
  nor2   g372(.a(x098), .b(x078), .O(z18));
  nor2   g373(.a(x098), .b(x078), .O(z19));
  nor2   g374(.a(x098), .b(x078), .O(z21));
  nor2   g375(.a(x098), .b(x078), .O(z22));
  nor2   g376(.a(x098), .b(x078), .O(z25));
  nor2   g377(.a(x098), .b(x078), .O(z26));
  nor2   g378(.a(x098), .b(x078), .O(z27));
endmodule
