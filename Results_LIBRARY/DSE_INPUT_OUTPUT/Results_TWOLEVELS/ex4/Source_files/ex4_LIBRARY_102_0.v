...
module FAU ( 
  ...
  nand3  g196(.a(new_n352_), .b(x103), .c(new_n298_), .O(new_n353_));
  ...
  nand3  g271(.a(new_n427_), .b(new_n173_), .c(new_n421_), .O(new_n428_));
  ...
  zero   g367(.O(z25));
  zero   g368(.O(z27));
  nor2   g369(.a(x103), .b(x078), .O(z16));
  nor2   g370(.a(x103), .b(x078), .O(z18));
  nor2   g371(.a(x103), .b(x078), .O(z19));
  nor2   g372(.a(x103), .b(x078), .O(z21));
  nor2   g373(.a(x103), .b(x078), .O(z23));
  nor2   g374(.a(x103), .b(x078), .O(z26));
endmodule
