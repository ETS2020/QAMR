...
module FAU ( 
  ...
  nor2   g149(.a(x054), .b(x047), .O(new_n306_));
  ...
  aoi21  g289(.a(new_n260_), .b(new_n445_), .c(x093), .O(new_n446_));
  nand2  g290(.a(new_n251_), .b(new_n250_), .O(new_n447_));
  oai21  g291(.a(new_n447_), .b(new_n446_), .c(new_n277_), .O(new_n448_));
  oai21  g292(.a(new_n260_), .b(x109), .c(x037), .O(new_n449_));
  nand2  g293(.a(new_n449_), .b(x117), .O(new_n450_));
  oai21  g294(.a(new_n445_), .b(x061), .c(new_n250_), .O(new_n451_));
  ...
  nand2  g309(.a(new_n260_), .b(new_n445_), .O(new_n466_));
  nand4  g310(.a(new_n466_), .b(new_n443_), .c(new_n246_), .d(x029), .O(new_n467_));
  ...
  oai21  g325(.a(new_n481_), .b(x045), .c(new_n159_), .O(z13));
  ...
  nand3  g333(.a(x126), .b(new_n309_), .c(new_n301_), .O(new_n490_));
  ...
  nand4  g337(.a(x126), .b(new_n314_), .c(new_n298_), .d(x014), .O(new_n494_));
  inv1   g338(.a(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n493_), .b(new_n299_), .c(new_n495_), .O(new_n496_));
  nand3  g340(.a(x086), .b(new_n298_), .c(new_n300_), .O(new_n497_));
  ...
  nand4  g349(.a(new_n505_), .b(new_n318_), .c(new_n303_), .d(x030), .O(new_n506_));
  inv1   g350(.a(new_n506_), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(new_n504_), .c(new_n299_), .O(new_n508_));
  aoi21  g352(.a(new_n508_), .b(new_n501_), .c(x054), .O(new_n509_));
  oai21  g353(.a(new_n319_), .b(new_n313_), .c(new_n502_), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(new_n299_), .c(x038), .O(new_n511_));
  ...
  oai21  g363(.a(new_n519_), .b(x046), .c(new_n159_), .O(z14));
  zero   g364(.O(z18));
  zero   g365(.O(z19));
  zero   g366(.O(z20));
  zero   g367(.O(z22));
  zero   g368(.O(z23));
  zero   g369(.O(z27));
  nor2   g370(.a(x078), .b(new_n157_), .O(z15));
  nor2   g371(.a(x078), .b(new_n157_), .O(z16));
  nor2   g372(.a(x078), .b(new_n157_), .O(z17));
  nor2   g373(.a(x078), .b(new_n157_), .O(z21));
  nor2   g374(.a(x078), .b(new_n157_), .O(z24));
  nor2   g375(.a(x078), .b(new_n157_), .O(z25));
  nor2   g376(.a(x078), .b(new_n157_), .O(z26));
endmodule
