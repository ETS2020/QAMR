// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:18 2020
...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x117), .O(z15));
  ...
  nand2  g178(.a(x117), .b(new_n301_), .O(new_n335_));
  aoi21  g179(.a(new_n335_), .b(new_n334_), .c(x030), .O(new_n336_));
  nand3  g180(.a(new_n312_), .b(x117), .c(new_n301_), .O(new_n337_));
  inv1   g181(.a(new_n337_), .O(new_n338_));
  oai21  g182(.a(new_n338_), .b(new_n336_), .c(x054), .O(new_n339_));
  inv1   g183(.a(x030), .O(new_n340_));
  nand4  g184(.a(x117), .b(x086), .c(new_n315_), .d(new_n340_), .O(new_n341_));
  nand2  g185(.a(new_n341_), .b(new_n339_), .O(new_n342_));
  nand2  g186(.a(new_n342_), .b(new_n328_), .O(new_n343_));
  nand4  g187(.a(x117), .b(x086), .c(new_n311_), .d(new_n340_), .O(new_n344_));
  nand3  g188(.a(new_n157_), .b(x118), .c(new_n301_), .O(new_n345_));
  aoi21  g189(.a(new_n345_), .b(new_n344_), .c(new_n319_), .O(new_n346_));
  inv1   g190(.a(x102), .O(new_n347_));
  nand2  g191(.a(x062), .b(x038), .O(new_n348_));
  ...
  nand4  g197(.a(new_n333_), .b(new_n308_), .c(x086), .d(new_n340_), .O(new_n354_));
  ...
  oai21  g205(.a(new_n361_), .b(new_n346_), .c(x054), .O(new_n362_));
  nand2  g206(.a(new_n362_), .b(new_n343_), .O(new_n363_));
  nand3  g207(.a(x038), .b(new_n327_), .c(new_n301_), .O(new_n364_));
  nor4   g208(.a(new_n364_), .b(x126), .c(new_n331_), .d(new_n303_), .O(new_n365_));
  ...
  nor2   g212(.a(x088), .b(x056), .O(new_n370_));
  nand2  g213(.a(new_n370_), .b(new_n369_), .O(new_n371_));
  oai21  g214(.a(new_n168_), .b(new_n162_), .c(new_n371_), .O(new_n372_));
  inv1   g215(.a(x096), .O(new_n373_));
  inv1   g216(.a(x120), .O(new_n374_));
  aoi21  g217(.a(new_n374_), .b(new_n373_), .c(x088), .O(new_n375_));
  inv1   g218(.a(x104), .O(new_n376_));
  inv1   g219(.a(x112), .O(new_n377_));
  nand2  g220(.a(new_n377_), .b(new_n376_), .O(new_n378_));
  oai21  g221(.a(new_n378_), .b(new_n375_), .c(new_n169_), .O(new_n379_));
  oai21  g222(.a(new_n374_), .b(x104), .c(x032), .O(new_n380_));
  nand2  g223(.a(new_n380_), .b(x112), .O(new_n381_));
  oai21  g224(.a(new_n373_), .b(x056), .c(new_n376_), .O(new_n382_));
  nand3  g225(.a(x120), .b(new_n377_), .c(new_n168_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n161_), .O(new_n384_));
  aoi21  g227(.a(new_n382_), .b(new_n163_), .c(new_n384_), .O(new_n385_));
  nand4  g228(.a(new_n385_), .b(new_n381_), .c(new_n379_), .d(new_n372_), .O(new_n386_));
  nor2   g229(.a(x032), .b(new_n162_), .O(new_n387_));
  nor2   g230(.a(new_n374_), .b(x056), .O(new_n388_));
  aoi22  g231(.a(new_n388_), .b(new_n387_), .c(new_n386_), .d(new_n165_), .O(new_n389_));
  ...
  aoi21  g235(.a(new_n392_), .b(x024), .c(x016), .O(new_n393_));
  oai21  g236(.a(new_n393_), .b(x072), .c(new_n162_), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(new_n378_), .O(new_n395_));
  nand2  g238(.a(x024), .b(new_n168_), .O(new_n396_));
  aoi21  g239(.a(new_n396_), .b(new_n370_), .c(new_n169_), .O(new_n397_));
  nand2  g240(.a(new_n374_), .b(new_n373_), .O(new_n398_));
  aoi22  g241(.a(x088), .b(x056), .c(x016), .d(x008), .O(new_n399_));
  nand3  g242(.a(new_n399_), .b(new_n398_), .c(x024), .O(new_n400_));
  inv1   g243(.a(new_n400_), .O(new_n401_));
  oai21  g244(.a(new_n401_), .b(new_n397_), .c(new_n165_), .O(new_n402_));
  aoi21  g245(.a(new_n402_), .b(new_n395_), .c(x048), .O(new_n403_));
  oai21  g246(.a(new_n168_), .b(new_n162_), .c(x024), .O(new_n404_));
  nand2  g247(.a(new_n404_), .b(new_n370_), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(new_n165_), .c(x032), .O(new_n406_));
  inv1   g249(.a(new_n406_), .O(new_n407_));
  oai21  g250(.a(new_n407_), .b(new_n403_), .c(new_n161_), .O(new_n408_));
  ...
  aoi21  g256(.a(new_n391_), .b(x000), .c(new_n413_), .O(new_n414_));
  oai21  g257(.a(new_n414_), .b(x040), .c(new_n159_), .O(z08));
  oai22  g258(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n416_));
  nand3  g259(.a(new_n416_), .b(x081), .c(x001), .O(new_n417_));
  oai22  g260(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n418_));
  nand3  g261(.a(new_n418_), .b(x065), .c(x017), .O(new_n419_));
  ...
  oai21  g265(.a(new_n422_), .b(x041), .c(new_n159_), .O(z09));
  ...
  oai21  g273(.a(new_n430_), .b(x042), .c(new_n159_), .O(z10));
  inv1   g274(.a(x043), .O(new_n432_));
  ...
  oai21  g290(.a(new_n447_), .b(x044), .c(new_n159_), .O(z12));
  oai22  g291(.a(x077), .b(x053), .c(x037), .d(x013), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(x085), .c(x005), .O(new_n450_));
  aoi22  g293(.a(new_n246_), .b(new_n244_), .c(new_n245_), .d(new_n243_), .O(new_n451_));
  nand3  g294(.a(new_n270_), .b(new_n242_), .c(new_n246_), .O(new_n452_));
  oai22  g295(.a(new_n452_), .b(x053), .c(new_n451_), .d(new_n279_), .O(new_n453_));
  nand2  g296(.a(new_n453_), .b(x069), .O(new_n454_));
  nand2  g297(.a(new_n452_), .b(new_n245_), .O(new_n455_));
  aoi22  g298(.a(new_n455_), .b(x037), .c(x077), .d(x013), .O(new_n456_));
  nand3  g299(.a(new_n456_), .b(new_n454_), .c(new_n450_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n159_), .O(new_n458_));
  oai21  g301(.a(x126), .b(new_n263_), .c(new_n329_), .O(new_n459_));
  aoi21  g302(.a(x069), .b(x037), .c(new_n241_), .O(new_n460_));
  nand2  g303(.a(new_n253_), .b(x029), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n279_), .c(x085), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n460_), .c(new_n246_), .O(new_n463_));
  oai21  g306(.a(x085), .b(new_n243_), .c(new_n463_), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(new_n459_), .O(new_n465_));
  nand2  g308(.a(x021), .b(x013), .O(new_n466_));
  nand3  g309(.a(new_n269_), .b(new_n268_), .c(new_n267_), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n466_), .O(new_n468_));
  nand2  g311(.a(new_n277_), .b(new_n276_), .O(new_n469_));
  nand3  g312(.a(new_n469_), .b(new_n269_), .c(new_n249_), .O(new_n470_));
  nand3  g313(.a(x101), .b(new_n268_), .c(new_n244_), .O(new_n471_));
  nand3  g314(.a(x125), .b(new_n329_), .c(new_n279_), .O(new_n472_));
  nand4  g315(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n468_), .O(new_n473_));
  nand4  g316(.a(x125), .b(new_n268_), .c(new_n244_), .d(x013), .O(new_n474_));
  inv1   g317(.a(new_n474_), .O(new_n475_));
  aoi21  g318(.a(new_n473_), .b(new_n246_), .c(new_n475_), .O(new_n476_));
  nand3  g319(.a(new_n469_), .b(new_n466_), .c(new_n253_), .O(new_n477_));
  oai21  g320(.a(new_n249_), .b(x021), .c(new_n477_), .O(new_n478_));
  nand4  g321(.a(new_n478_), .b(new_n242_), .c(new_n246_), .d(x029), .O(new_n479_));
  oai21  g322(.a(new_n476_), .b(new_n241_), .c(new_n479_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n157_), .O(new_n481_));
  nor2   g324(.a(new_n277_), .b(new_n329_), .O(new_n482_));
  nand4  g325(.a(new_n482_), .b(new_n263_), .c(new_n246_), .d(x005), .O(new_n483_));
  nand3  g326(.a(new_n483_), .b(new_n481_), .c(new_n465_), .O(new_n484_));
  nand3  g327(.a(new_n466_), .b(new_n157_), .c(new_n242_), .O(new_n485_));
  nor4   g328(.a(new_n485_), .b(x077), .c(new_n244_), .d(new_n267_), .O(new_n486_));
  aoi21  g329(.a(new_n484_), .b(new_n245_), .c(new_n486_), .O(new_n487_));
  aoi21  g330(.a(new_n487_), .b(new_n458_), .c(x045), .O(z13));
  oai22  g331(.a(new_n333_), .b(x030), .c(new_n319_), .d(new_n327_), .O(new_n489_));
  aoi21  g332(.a(new_n157_), .b(new_n347_), .c(x094), .O(new_n490_));
  inv1   g333(.a(x110), .O(new_n491_));
  nand2  g334(.a(new_n357_), .b(new_n491_), .O(new_n492_));
  oai21  g335(.a(new_n492_), .b(new_n490_), .c(new_n311_), .O(new_n493_));
  oai21  g336(.a(new_n157_), .b(x110), .c(x038), .O(new_n494_));
  nand2  g337(.a(new_n494_), .b(x118), .O(new_n495_));
  oai21  g338(.a(new_n347_), .b(x062), .c(new_n491_), .O(new_n496_));
  nand3  g339(.a(x126), .b(new_n357_), .c(new_n319_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n302_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n315_), .c(new_n498_), .O(new_n499_));
  nand4  g342(.a(new_n499_), .b(new_n495_), .c(new_n493_), .d(new_n489_), .O(new_n500_));
  nand4  g343(.a(x126), .b(new_n331_), .c(new_n315_), .d(x014), .O(new_n501_));
  inv1   g344(.a(new_n501_), .O(new_n502_));
  aoi21  g345(.a(new_n500_), .b(new_n304_), .c(new_n502_), .O(new_n503_));
  nand3  g346(.a(x086), .b(new_n315_), .c(new_n327_), .O(new_n504_));
  oai21  g347(.a(new_n503_), .b(x054), .c(new_n504_), .O(new_n505_));
  aoi21  g348(.a(new_n312_), .b(x030), .c(x022), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(x078), .c(new_n327_), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n492_), .O(new_n508_));
  nor2   g351(.a(x094), .b(x062), .O(new_n509_));
  nand2  g352(.a(x030), .b(new_n319_), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n509_), .c(new_n311_), .O(new_n511_));
  nand2  g354(.a(new_n157_), .b(new_n347_), .O(new_n512_));
  ...
  oai21  g358(.a(new_n515_), .b(new_n511_), .c(new_n304_), .O(new_n516_));
  aoi21  g359(.a(new_n516_), .b(new_n508_), .c(x054), .O(new_n517_));
  oai21  g360(.a(new_n319_), .b(new_n327_), .c(x030), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n509_), .O(new_n519_));
  nand3  g362(.a(new_n519_), .b(new_n304_), .c(x038), .O(new_n520_));
  inv1   g363(.a(new_n520_), .O(new_n521_));
  oai21  g364(.a(new_n521_), .b(new_n517_), .c(new_n302_), .O(new_n522_));
  ...
  and2   g368(.a(new_n525_), .b(new_n524_), .O(new_n526_));
  nand2  g369(.a(new_n526_), .b(new_n522_), .O(new_n527_));
  aoi21  g370(.a(new_n505_), .b(x006), .c(new_n527_), .O(new_n528_));
  oai21  g371(.a(new_n528_), .b(x046), .c(new_n159_), .O(z14));
  zero   g372(.O(z07));
  zero   g373(.O(z17));
  zero   g374(.O(z18));
  zero   g375(.O(z19));
  ...
  zero   g378(.O(z24));
  zero   g379(.O(z25));
  nor2   g380(.a(new_n157_), .b(x117), .O(z16));
  nor2   g381(.a(new_n157_), .b(x117), .O(z20));
  nor2   g382(.a(new_n157_), .b(x117), .O(z21));
  nor2   g383(.a(new_n157_), .b(x117), .O(z26));
  nor2   g384(.a(new_n157_), .b(x117), .O(z27));
endmodule
