// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:28 2020
...
module FAU ( 
  ...
  nand3  g278(.a(new_n435_), .b(new_n172_), .c(new_n395_), .O(new_n436_));
  inv1   g279(.a(new_n436_), .O(z13));
  nand2  g280(.a(x022), .b(x014), .O(new_n438_));
  inv1   g281(.a(x062), .O(new_n439_));
  inv1   g282(.a(x094), .O(new_n440_));
  nand2  g283(.a(new_n440_), .b(new_n439_), .O(new_n441_));
  oai21  g284(.a(new_n441_), .b(x030), .c(new_n438_), .O(new_n442_));
  inv1   g285(.a(x102), .O(new_n443_));
  inv1   g286(.a(x126), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(new_n443_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n440_), .O(new_n446_));
  nor2   g289(.a(x118), .b(x110), .O(new_n447_));
  nand2  g290(.a(new_n447_), .b(new_n446_), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(new_n300_), .O(new_n449_));
  oai21  g292(.a(new_n444_), .b(x110), .c(x038), .O(new_n450_));
  nand2  g293(.a(new_n450_), .b(x118), .O(new_n451_));
  inv1   g294(.a(x110), .O(new_n452_));
  oai21  g295(.a(new_n443_), .b(x062), .c(new_n452_), .O(new_n453_));
  inv1   g296(.a(x118), .O(new_n454_));
  nand3  g297(.a(x126), .b(new_n454_), .c(new_n299_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n303_), .O(new_n456_));
  aoi21  g299(.a(new_n453_), .b(new_n296_), .c(new_n456_), .O(new_n457_));
  nand4  g300(.a(new_n457_), .b(new_n451_), .c(new_n449_), .d(new_n442_), .O(new_n458_));
  nand4  g301(.a(x126), .b(new_n439_), .c(new_n296_), .d(x014), .O(new_n459_));
  inv1   g302(.a(new_n459_), .O(new_n460_));
  aoi21  g303(.a(new_n458_), .b(new_n295_), .c(new_n460_), .O(new_n461_));
  inv1   g304(.a(x014), .O(new_n462_));
  nand3  g305(.a(x086), .b(new_n296_), .c(new_n462_), .O(new_n463_));
  oai21  g306(.a(new_n461_), .b(x054), .c(new_n463_), .O(new_n464_));
  nand2  g307(.a(new_n464_), .b(x006), .O(new_n465_));
  nand2  g308(.a(x094), .b(x062), .O(new_n466_));
  nand2  g309(.a(new_n466_), .b(x030), .O(new_n467_));
  nand2  g310(.a(new_n467_), .b(new_n299_), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n295_), .O(new_n469_));
  aoi21  g312(.a(new_n469_), .b(new_n462_), .c(new_n447_), .O(new_n470_));
  inv1   g313(.a(x030), .O(new_n471_));
  nor2   g314(.a(new_n471_), .b(x022), .O(new_n472_));
  oai21  g315(.a(new_n472_), .b(new_n441_), .c(x070), .O(new_n473_));
  nand4  g316(.a(new_n466_), .b(new_n445_), .c(new_n438_), .d(x030), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n473_), .c(x078), .O(new_n475_));
  oai21  g318(.a(new_n475_), .b(new_n470_), .c(new_n297_), .O(new_n476_));
  nand2  g319(.a(new_n438_), .b(x030), .O(new_n477_));
  nand3  g320(.a(new_n477_), .b(new_n440_), .c(new_n439_), .O(new_n478_));
  nand3  g321(.a(new_n478_), .b(new_n295_), .c(x038), .O(new_n479_));
  ...
  aoi21  g327(.a(new_n480_), .b(new_n303_), .c(new_n484_), .O(new_n485_));
  ...
  zero   g334(.O(z22));
  zero   g335(.O(z24));
  inv1   g336(.a(new_n172_), .O(z16));
  inv1   g337(.a(new_n172_), .O(z18));
  inv1   g338(.a(new_n172_), .O(z21));
  inv1   g339(.a(new_n172_), .O(z23));
  inv1   g340(.a(new_n172_), .O(z25));
  inv1   g341(.a(new_n172_), .O(z26));
  inv1   g342(.a(new_n172_), .O(z27));
endmodule
