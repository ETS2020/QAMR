// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:26 2020
...
module FAU ( 
  ...
  nand2  g112(.a(new_n268_), .b(new_n172_), .O(new_n269_));
  ...
  oai21  g129(.a(new_n285_), .b(new_n282_), .c(x085), .O(new_n286_));
  nand2  g130(.a(new_n286_), .b(new_n275_), .O(new_n287_));
  nand3  g131(.a(new_n249_), .b(x085), .c(x053), .O(new_n288_));
  nand2  g132(.a(new_n288_), .b(x077), .O(new_n289_));
  nand2  g133(.a(new_n289_), .b(new_n242_), .O(new_n290_));
  nor2   g134(.a(x021), .b(new_n242_), .O(new_n291_));
  nor2   g135(.a(x069), .b(new_n240_), .O(new_n292_));
  aoi22  g136(.a(new_n292_), .b(new_n291_), .c(new_n240_), .d(new_n252_), .O(new_n293_));
  nand2  g137(.a(new_n293_), .b(new_n290_), .O(new_n294_));
  aoi21  g138(.a(new_n287_), .b(x077), .c(new_n294_), .O(new_n295_));
  nand2  g139(.a(new_n295_), .b(new_n269_), .O(new_n296_));
  ...
  nor2   g169(.a(x022), .b(x014), .O(new_n326_));
  ...
  nand2  g174(.a(new_n330_), .b(new_n172_), .O(new_n331_));
  aoi21  g175(.a(new_n331_), .b(new_n329_), .c(new_n327_), .O(new_n332_));
  nor2   g176(.a(new_n330_), .b(x006), .O(new_n333_));
  aoi21  g177(.a(new_n332_), .b(x086), .c(new_n333_), .O(new_n334_));
  nand3  g178(.a(new_n311_), .b(x126), .c(new_n300_), .O(new_n335_));
  oai21  g179(.a(new_n334_), .b(x030), .c(new_n335_), .O(new_n336_));
  inv1   g180(.a(x030), .O(new_n337_));
  nand4  g181(.a(x126), .b(x086), .c(new_n314_), .d(new_n337_), .O(new_n338_));
  inv1   g182(.a(new_n338_), .O(new_n339_));
  aoi21  g183(.a(new_n336_), .b(x054), .c(new_n339_), .O(new_n340_));
  nand4  g184(.a(x126), .b(x086), .c(new_n310_), .d(new_n337_), .O(new_n341_));
  nand4  g185(.a(new_n330_), .b(x118), .c(new_n300_), .d(new_n172_), .O(new_n342_));
  ...
  oai21  g192(.a(x070), .b(x038), .c(new_n307_), .O(new_n349_));
  aoi21  g193(.a(new_n349_), .b(new_n348_), .c(x006), .O(new_n350_));
  inv1   g194(.a(new_n327_), .O(new_n351_));
  nand4  g195(.a(new_n351_), .b(new_n307_), .c(x086), .d(new_n337_), .O(new_n352_));
  ...
  nand3  g200(.a(new_n356_), .b(new_n346_), .c(new_n304_), .O(new_n357_));
  nand4  g201(.a(new_n357_), .b(new_n330_), .c(new_n300_), .d(new_n172_), .O(new_n358_));
  nand3  g202(.a(new_n358_), .b(new_n354_), .c(new_n344_), .O(new_n359_));
  nand2  g203(.a(new_n359_), .b(x054), .O(new_n360_));
  oai21  g204(.a(new_n340_), .b(new_n326_), .c(new_n360_), .O(new_n361_));
  nand4  g205(.a(new_n330_), .b(x062), .c(x054), .d(x038), .O(new_n362_));
  nor4   g206(.a(new_n362_), .b(x014), .c(x006), .d(x005), .O(new_n363_));
  ...
  nand3  g258(.a(new_n415_), .b(new_n174_), .c(new_n367_), .O(new_n416_));
  ...
  oai21  g267(.a(new_n424_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai21  g275(.a(new_n432_), .b(x042), .c(new_n174_), .O(z10));
  ...
  nand3  g283(.a(new_n440_), .b(new_n174_), .c(new_n434_), .O(new_n441_));
  inv1   g284(.a(new_n441_), .O(z11));
  inv1   g285(.a(x044), .O(new_n443_));
  oai22  g286(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n444_));
  nand3  g287(.a(new_n444_), .b(x084), .c(x004), .O(new_n445_));
  oai22  g288(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n446_));
  nand3  g289(.a(new_n446_), .b(x068), .c(x020), .O(new_n447_));
  aoi22  g290(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n448_));
  nand3  g291(.a(new_n448_), .b(new_n447_), .c(new_n445_), .O(new_n449_));
  nand3  g292(.a(new_n449_), .b(new_n174_), .c(new_n443_), .O(new_n450_));
  inv1   g293(.a(new_n450_), .O(z12));
  ...
  nand2  g298(.a(new_n455_), .b(new_n174_), .O(new_n456_));
  nor2   g299(.a(x085), .b(x005), .O(new_n457_));
  aoi21  g300(.a(x126), .b(x005), .c(new_n457_), .O(new_n458_));
  nor2   g301(.a(new_n458_), .b(new_n242_), .O(new_n459_));
  nand2  g302(.a(x069), .b(x037), .O(new_n460_));
  nand3  g303(.a(new_n460_), .b(x126), .c(x005), .O(new_n461_));
  oai21  g304(.a(new_n283_), .b(new_n241_), .c(new_n243_), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n266_), .c(new_n172_), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n461_), .c(x077), .O(new_n464_));
  oai22  g307(.a(new_n464_), .b(new_n459_), .c(x117), .d(x109), .O(new_n465_));
  inv1   g308(.a(x077), .O(new_n466_));
  nand2  g309(.a(x021), .b(x013), .O(new_n467_));
  oai21  g310(.a(new_n280_), .b(x029), .c(new_n467_), .O(new_n468_));
  inv1   g311(.a(x101), .O(new_n469_));
  nand2  g312(.a(new_n258_), .b(new_n469_), .O(new_n470_));
  nand3  g313(.a(new_n470_), .b(new_n247_), .c(new_n270_), .O(new_n471_));
  nor2   g314(.a(new_n251_), .b(x109), .O(new_n472_));
  nor2   g315(.a(x117), .b(x021), .O(new_n473_));
  oai21  g316(.a(new_n473_), .b(new_n472_), .c(x125), .O(new_n474_));
  nor2   g317(.a(new_n469_), .b(x061), .O(new_n475_));
  aoi21  g318(.a(new_n475_), .b(new_n252_), .c(x085), .O(new_n476_));
  nand4  g319(.a(new_n476_), .b(new_n474_), .c(new_n471_), .d(new_n468_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n466_), .O(new_n478_));
  nand4  g321(.a(x125), .b(new_n256_), .c(new_n252_), .d(x013), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(x126), .c(x005), .O(new_n481_));
  nor2   g324(.a(new_n241_), .b(x021), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n280_), .c(x069), .O(new_n483_));
  nand4  g326(.a(new_n470_), .b(new_n467_), .c(new_n245_), .d(x029), .O(new_n484_));
  nand2  g327(.a(new_n484_), .b(new_n483_), .O(new_n485_));
  nand4  g328(.a(new_n485_), .b(new_n266_), .c(new_n466_), .d(new_n172_), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n481_), .c(new_n465_), .O(new_n487_));
  nor2   g330(.a(x085), .b(x077), .O(new_n488_));
  nand4  g331(.a(new_n488_), .b(x037), .c(x029), .d(new_n172_), .O(new_n489_));
  nand4  g332(.a(x126), .b(x085), .c(new_n252_), .d(x005), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(new_n489_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n242_), .O(new_n492_));
  nand4  g335(.a(new_n266_), .b(x029), .c(new_n243_), .d(new_n172_), .O(new_n493_));
  oai21  g336(.a(new_n458_), .b(new_n276_), .c(new_n493_), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n466_), .c(x037), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(new_n492_), .O(new_n496_));
  aoi21  g339(.a(new_n487_), .b(new_n240_), .c(new_n496_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n456_), .c(x045), .O(z13));
  inv1   g341(.a(x014), .O(new_n499_));
  oai22  g342(.a(new_n351_), .b(x030), .c(new_n318_), .d(new_n499_), .O(new_n500_));
  aoi21  g343(.a(new_n330_), .b(new_n328_), .c(x094), .O(new_n501_));
  inv1   g344(.a(x110), .O(new_n502_));
  nand2  g345(.a(new_n355_), .b(new_n502_), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n501_), .c(new_n310_), .O(new_n504_));
  oai21  g347(.a(new_n330_), .b(x110), .c(x038), .O(new_n505_));
  nand2  g348(.a(new_n505_), .b(x118), .O(new_n506_));
  oai21  g349(.a(new_n328_), .b(x062), .c(new_n502_), .O(new_n507_));
  nand3  g350(.a(x126), .b(new_n355_), .c(new_n318_), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n301_), .O(new_n509_));
  aoi21  g352(.a(new_n507_), .b(new_n314_), .c(new_n509_), .O(new_n510_));
  nand4  g353(.a(new_n510_), .b(new_n506_), .c(new_n504_), .d(new_n500_), .O(new_n511_));
  nor2   g354(.a(x038), .b(new_n499_), .O(new_n512_));
  nor2   g355(.a(new_n330_), .b(x062), .O(new_n513_));
  aoi22  g356(.a(new_n513_), .b(new_n512_), .c(new_n511_), .d(new_n303_), .O(new_n514_));
  nand3  g357(.a(x086), .b(new_n314_), .c(new_n499_), .O(new_n515_));
  oai21  g358(.a(new_n514_), .b(x054), .c(new_n515_), .O(new_n516_));
  aoi21  g359(.a(new_n311_), .b(x030), .c(x022), .O(new_n517_));
  oai21  g360(.a(new_n517_), .b(x078), .c(new_n499_), .O(new_n518_));
  nand2  g361(.a(new_n518_), .b(new_n503_), .O(new_n519_));
  nand2  g362(.a(x030), .b(new_n318_), .O(new_n520_));
  aoi21  g363(.a(new_n520_), .b(new_n327_), .c(new_n310_), .O(new_n521_));
  nand2  g364(.a(new_n330_), .b(new_n328_), .O(new_n522_));
  aoi22  g365(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n523_));
  nand3  g366(.a(new_n523_), .b(new_n522_), .c(x030), .O(new_n524_));
  inv1   g367(.a(new_n524_), .O(new_n525_));
  oai21  g368(.a(new_n525_), .b(new_n521_), .c(new_n303_), .O(new_n526_));
  aoi21  g369(.a(new_n526_), .b(new_n519_), .c(x054), .O(new_n527_));
  oai21  g370(.a(new_n318_), .b(new_n499_), .c(x030), .O(new_n528_));
  nand2  g371(.a(new_n528_), .b(new_n327_), .O(new_n529_));
  nand3  g372(.a(new_n529_), .b(new_n303_), .c(x038), .O(new_n530_));
  inv1   g373(.a(new_n530_), .O(new_n531_));
  oai21  g374(.a(new_n531_), .b(new_n527_), .c(new_n301_), .O(new_n532_));
  oai22  g375(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n533_));
  nand3  g376(.a(new_n533_), .b(x070), .c(x022), .O(new_n534_));
  aoi22  g377(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n535_));
  nand3  g378(.a(new_n535_), .b(new_n534_), .c(new_n532_), .O(new_n536_));
  aoi21  g379(.a(new_n516_), .b(x006), .c(new_n536_), .O(new_n537_));
  oai21  g380(.a(new_n537_), .b(x046), .c(new_n174_), .O(z14));
  zero   g381(.O(z07));
  zero   g382(.O(z15));
  zero   g383(.O(z16));
  zero   g384(.O(z17));
  ...
  zero   g386(.O(z21));
  zero   g387(.O(z22));
  nor2   g388(.a(x126), .b(new_n172_), .O(z19));
  nor2   g389(.a(x126), .b(new_n172_), .O(z23));
  nor2   g390(.a(x126), .b(new_n172_), .O(z24));
  nor2   g391(.a(x126), .b(new_n172_), .O(z25));
  nor2   g392(.a(x126), .b(new_n172_), .O(z26));
  nor2   g393(.a(x126), .b(new_n172_), .O(z27));
endmodule
