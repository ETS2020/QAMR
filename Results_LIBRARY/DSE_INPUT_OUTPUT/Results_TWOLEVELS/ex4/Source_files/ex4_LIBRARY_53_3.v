// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:40 2020
...
module FAU ( 
  ...
  nand2  g032(.a(new_n188_), .b(new_n157_), .O(z01));
  ...
  oai21  g155(.a(new_n166_), .b(new_n160_), .c(new_n311_), .O(new_n312_));
  ...
  oai21  g162(.a(new_n318_), .b(new_n315_), .c(new_n167_), .O(new_n319_));
  ...
  nand3  g166(.a(x120), .b(new_n317_), .c(new_n166_), .O(new_n323_));
  nand2  g167(.a(new_n323_), .b(new_n159_), .O(new_n324_));
  aoi21  g168(.a(new_n322_), .b(new_n161_), .c(new_n324_), .O(new_n325_));
  nand4  g169(.a(new_n325_), .b(new_n321_), .c(new_n319_), .d(new_n312_), .O(new_n326_));
  nor2   g170(.a(x032), .b(new_n160_), .O(new_n327_));
  nor2   g171(.a(new_n314_), .b(x056), .O(new_n328_));
  aoi22  g172(.a(new_n328_), .b(new_n327_), .c(new_n326_), .d(new_n163_), .O(new_n329_));
  nand3  g173(.a(x080), .b(new_n161_), .c(new_n160_), .O(new_n330_));
  ...
  oai21  g177(.a(new_n333_), .b(x072), .c(new_n160_), .O(new_n334_));
  nand2  g178(.a(new_n334_), .b(new_n318_), .O(new_n335_));
  nand2  g179(.a(x024), .b(new_n166_), .O(new_n336_));
  aoi21  g180(.a(new_n336_), .b(new_n310_), .c(new_n167_), .O(new_n337_));
  ...
  oai21  g185(.a(new_n341_), .b(new_n337_), .c(new_n163_), .O(new_n342_));
  aoi21  g186(.a(new_n342_), .b(new_n335_), .c(x048), .O(new_n343_));
  oai21  g187(.a(new_n166_), .b(new_n160_), .c(x024), .O(new_n344_));
  nand2  g188(.a(new_n344_), .b(new_n310_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n163_), .c(x032), .O(new_n346_));
  inv1   g190(.a(new_n346_), .O(new_n347_));
  oai21  g191(.a(new_n347_), .b(new_n343_), .c(new_n159_), .O(new_n348_));
  ...
  oai21  g197(.a(new_n353_), .b(x040), .c(new_n157_), .O(z08));
  oai22  g198(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n355_));
  nand3  g199(.a(new_n355_), .b(x081), .c(x001), .O(new_n356_));
  oai22  g200(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n357_));
  nand3  g201(.a(new_n357_), .b(x065), .c(x017), .O(new_n358_));
  aoi22  g202(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n359_));
  nand3  g203(.a(new_n359_), .b(new_n358_), .c(new_n356_), .O(new_n360_));
  inv1   g204(.a(new_n360_), .O(new_n361_));
  oai21  g205(.a(new_n361_), .b(x041), .c(new_n157_), .O(z09));
  inv1   g206(.a(x042), .O(new_n363_));
  oai22  g207(.a(x074), .b(x050), .c(x034), .d(x010), .O(new_n364_));
  nand3  g208(.a(new_n364_), .b(x082), .c(x002), .O(new_n365_));
  oai22  g209(.a(x074), .b(x034), .c(x050), .d(x010), .O(new_n366_));
  nand3  g210(.a(new_n366_), .b(x066), .c(x018), .O(new_n367_));
  aoi22  g211(.a(x074), .b(x010), .c(x050), .d(x034), .O(new_n368_));
  nand3  g212(.a(new_n368_), .b(new_n367_), .c(new_n365_), .O(new_n369_));
  nand3  g213(.a(new_n369_), .b(new_n157_), .c(new_n363_), .O(new_n370_));
  inv1   g214(.a(new_n370_), .O(z10));
  oai22  g215(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n372_));
  nand3  g216(.a(new_n372_), .b(x083), .c(x003), .O(new_n373_));
  oai22  g217(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n374_));
  nand3  g218(.a(new_n374_), .b(x067), .c(x019), .O(new_n375_));
  aoi22  g219(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n376_));
  nand3  g220(.a(new_n376_), .b(new_n375_), .c(new_n373_), .O(new_n377_));
  inv1   g221(.a(new_n377_), .O(new_n378_));
  oai21  g222(.a(new_n378_), .b(x043), .c(new_n157_), .O(z11));
  inv1   g223(.a(x044), .O(new_n380_));
  oai22  g224(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n381_));
  nand3  g225(.a(new_n381_), .b(x084), .c(x004), .O(new_n382_));
  oai22  g226(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n383_));
  nand3  g227(.a(new_n383_), .b(x068), .c(x020), .O(new_n384_));
  aoi22  g228(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n385_));
  nand3  g229(.a(new_n385_), .b(new_n384_), .c(new_n382_), .O(new_n386_));
  nand3  g230(.a(new_n386_), .b(new_n157_), .c(new_n380_), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(z12));
  oai22  g232(.a(new_n278_), .b(x029), .c(new_n242_), .d(new_n241_), .O(new_n389_));
  inv1   g233(.a(x101), .O(new_n390_));
  aoi21  g234(.a(new_n258_), .b(new_n390_), .c(x093), .O(new_n391_));
  nand2  g235(.a(new_n249_), .b(new_n248_), .O(new_n392_));
  oai21  g236(.a(new_n392_), .b(new_n391_), .c(new_n275_), .O(new_n393_));
  oai21  g237(.a(new_n258_), .b(x109), .c(x037), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(x117), .O(new_n395_));
  oai21  g239(.a(new_n390_), .b(x061), .c(new_n248_), .O(new_n396_));
  nand3  g240(.a(x125), .b(new_n249_), .c(new_n242_), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(new_n266_), .O(new_n398_));
  aoi21  g242(.a(new_n396_), .b(new_n253_), .c(new_n398_), .O(new_n399_));
  nand4  g243(.a(new_n399_), .b(new_n395_), .c(new_n393_), .d(new_n389_), .O(new_n400_));
  nand4  g244(.a(x125), .b(new_n256_), .c(new_n253_), .d(x013), .O(new_n401_));
  inv1   g245(.a(new_n401_), .O(new_n402_));
  aoi21  g246(.a(new_n400_), .b(new_n274_), .c(new_n402_), .O(new_n403_));
  nand3  g247(.a(x085), .b(new_n253_), .c(new_n241_), .O(new_n404_));
  oai21  g248(.a(new_n403_), .b(x053), .c(new_n404_), .O(new_n405_));
  aoi21  g249(.a(new_n244_), .b(x029), .c(x021), .O(new_n406_));
  oai21  g250(.a(new_n406_), .b(x077), .c(new_n241_), .O(new_n407_));
  nand2  g251(.a(new_n407_), .b(new_n392_), .O(new_n408_));
  nand2  g252(.a(x029), .b(new_n242_), .O(new_n409_));
  aoi21  g253(.a(new_n409_), .b(new_n270_), .c(new_n275_), .O(new_n410_));
  nand2  g254(.a(new_n258_), .b(new_n390_), .O(new_n411_));
  aoi22  g255(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n412_));
  nand3  g256(.a(new_n412_), .b(new_n411_), .c(x029), .O(new_n413_));
  inv1   g257(.a(new_n413_), .O(new_n414_));
  oai21  g258(.a(new_n414_), .b(new_n410_), .c(new_n274_), .O(new_n415_));
  aoi21  g259(.a(new_n415_), .b(new_n408_), .c(x053), .O(new_n416_));
  oai21  g260(.a(new_n242_), .b(new_n241_), .c(x029), .O(new_n417_));
  nand2  g261(.a(new_n417_), .b(new_n270_), .O(new_n418_));
  nand3  g262(.a(new_n418_), .b(new_n274_), .c(x037), .O(new_n419_));
  inv1   g263(.a(new_n419_), .O(new_n420_));
  oai21  g264(.a(new_n420_), .b(new_n416_), .c(new_n266_), .O(new_n421_));
  oai22  g265(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n422_));
  nand3  g266(.a(new_n422_), .b(x069), .c(x021), .O(new_n423_));
  aoi22  g267(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n424_));
  nand3  g268(.a(new_n424_), .b(new_n423_), .c(new_n421_), .O(new_n425_));
  aoi21  g269(.a(new_n405_), .b(x005), .c(new_n425_), .O(new_n426_));
  oai21  g270(.a(new_n426_), .b(x045), .c(new_n157_), .O(z13));
  oai21  g271(.a(x046), .b(x014), .c(x078), .O(new_n428_));
  inv1   g272(.a(x014), .O(new_n429_));
  inv1   g273(.a(x030), .O(new_n430_));
  nor2   g274(.a(x094), .b(x062), .O(new_n431_));
  nand2  g275(.a(new_n431_), .b(new_n430_), .O(new_n432_));
  oai21  g276(.a(new_n299_), .b(new_n429_), .c(new_n432_), .O(new_n433_));
  inv1   g277(.a(x102), .O(new_n434_));
  inv1   g278(.a(x126), .O(new_n435_));
  aoi21  g279(.a(new_n435_), .b(new_n434_), .c(x094), .O(new_n436_));
  inv1   g280(.a(x110), .O(new_n437_));
  inv1   g281(.a(x118), .O(new_n438_));
  nand2  g282(.a(new_n438_), .b(new_n437_), .O(new_n439_));
  oai21  g283(.a(new_n439_), .b(new_n436_), .c(new_n300_), .O(new_n440_));
  oai21  g284(.a(new_n435_), .b(x110), .c(x038), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(x118), .O(new_n442_));
  oai21  g286(.a(new_n434_), .b(x062), .c(new_n437_), .O(new_n443_));
  nand3  g287(.a(x126), .b(new_n438_), .c(new_n299_), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(new_n303_), .O(new_n445_));
  aoi21  g289(.a(new_n443_), .b(new_n296_), .c(new_n445_), .O(new_n446_));
  nand4  g290(.a(new_n446_), .b(new_n442_), .c(new_n440_), .d(new_n433_), .O(new_n447_));
  nor2   g291(.a(x038), .b(new_n429_), .O(new_n448_));
  nor2   g292(.a(new_n435_), .b(x062), .O(new_n449_));
  aoi22  g293(.a(new_n449_), .b(new_n448_), .c(new_n447_), .d(new_n295_), .O(new_n450_));
  nand3  g294(.a(x086), .b(new_n296_), .c(new_n429_), .O(new_n451_));
  oai21  g295(.a(new_n450_), .b(x054), .c(new_n451_), .O(new_n452_));
  nand2  g296(.a(x094), .b(x062), .O(new_n453_));
  aoi21  g297(.a(new_n453_), .b(x030), .c(x022), .O(new_n454_));
  oai21  g298(.a(new_n454_), .b(x078), .c(new_n429_), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(new_n439_), .O(new_n456_));
  nand2  g300(.a(new_n296_), .b(x030), .O(new_n457_));
  aoi21  g301(.a(new_n457_), .b(new_n431_), .c(new_n300_), .O(new_n458_));
  nand2  g302(.a(new_n435_), .b(new_n434_), .O(new_n459_));
  aoi22  g303(.a(x094), .b(x062), .c(x022), .d(x014), .O(new_n460_));
  nand3  g304(.a(new_n460_), .b(new_n459_), .c(x030), .O(new_n461_));
  inv1   g305(.a(new_n461_), .O(new_n462_));
  oai21  g306(.a(new_n462_), .b(new_n458_), .c(new_n295_), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n456_), .c(x054), .O(new_n464_));
  oai21  g308(.a(new_n299_), .b(new_n429_), .c(x030), .O(new_n465_));
  nand2  g309(.a(new_n465_), .b(new_n431_), .O(new_n466_));
  nand3  g310(.a(new_n466_), .b(new_n295_), .c(x038), .O(new_n467_));
  inv1   g311(.a(new_n467_), .O(new_n468_));
  oai21  g312(.a(new_n468_), .b(new_n464_), .c(new_n303_), .O(new_n469_));
  oai22  g313(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n470_));
  nand3  g314(.a(new_n470_), .b(x070), .c(x022), .O(new_n471_));
  nand2  g315(.a(x054), .b(x038), .O(new_n472_));
  nand3  g316(.a(new_n472_), .b(new_n471_), .c(new_n469_), .O(new_n473_));
  aoi21  g317(.a(new_n452_), .b(x006), .c(new_n473_), .O(new_n474_));
  oai21  g318(.a(new_n474_), .b(x046), .c(new_n428_), .O(z14));
  zero   g319(.O(z15));
  zero   g320(.O(z16));
  zero   g321(.O(z17));
  zero   g322(.O(z19));
  ...
  zero   g325(.O(z25));
  zero   g326(.O(z27));
  inv1   g327(.a(new_n157_), .O(z18));
  inv1   g328(.a(new_n157_), .O(z20));
  inv1   g329(.a(new_n157_), .O(z21));
  inv1   g330(.a(new_n157_), .O(z24));
  inv1   g331(.a(new_n157_), .O(z26));
endmodule
