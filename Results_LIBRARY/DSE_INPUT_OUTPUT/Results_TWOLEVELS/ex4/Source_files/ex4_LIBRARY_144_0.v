...
module FAU ( 
  ...
  oai21  g265(.a(new_n421_), .b(x043), .c(new_n173_), .O(z11));
  ...
  nand3  g273(.a(new_n429_), .b(new_n173_), .c(new_n423_), .O(new_n430_));
  ...
  oai21  g313(.a(new_n469_), .b(x045), .c(new_n173_), .O(z13));
  aoi21  g314(.a(x054), .b(x038), .c(x014), .O(new_n471_));
  nand3  g315(.a(x070), .b(new_n301_), .c(x022), .O(new_n472_));
  nand3  g316(.a(x086), .b(new_n312_), .c(x006), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(new_n472_), .c(new_n471_), .O(new_n474_));
  nand3  g318(.a(new_n474_), .b(x078), .c(new_n297_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(z14));
  zero   g320(.O(z20));
  zero   g321(.O(z21));
  zero   g322(.O(z23));
  zero   g323(.O(z25));
  zero   g324(.O(z26));
  zero   g325(.O(z27));
  nor2   g326(.a(x078), .b(x046), .O(z15));
  nor2   g327(.a(x078), .b(x046), .O(z16));
  nor2   g328(.a(x078), .b(x046), .O(z17));
  nor2   g329(.a(x078), .b(x046), .O(z18));
  nor2   g330(.a(x078), .b(x046), .O(z19));
  nor2   g331(.a(x078), .b(x046), .O(z22));
