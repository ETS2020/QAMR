...
module FAU ( 
  ...
  nand2  g016(.a(new_n172_), .b(x027), .O(new_n173_));
  ...
  oai22  g323(.a(new_n335_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n481_));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  inv1   g373(.a(new_n173_), .O(z18));
  inv1   g374(.a(new_n173_), .O(z20));
  inv1   g375(.a(new_n173_), .O(z24));
endmodule
