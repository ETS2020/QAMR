...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x079), .O(z07));
  ...
  oai22  g322(.a(new_n336_), .b(x030), .c(new_n301_), .d(new_n300_), .O(new_n479_));
  inv1   g323(.a(x102), .O(new_n480_));
  aoi21  g324(.a(new_n172_), .b(new_n480_), .c(x094), .O(new_n481_));
  nand2  g325(.a(new_n308_), .b(new_n307_), .O(new_n482_));
  ...
  oai21  g329(.a(new_n480_), .b(x062), .c(new_n307_), .O(new_n486_));
  nand3  g330(.a(x126), .b(new_n308_), .c(new_n301_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n324_), .O(new_n488_));
  aoi21  g332(.a(new_n486_), .b(new_n312_), .c(new_n488_), .O(new_n489_));
  nand4  g333(.a(new_n489_), .b(new_n485_), .c(new_n483_), .d(new_n479_), .O(new_n490_));
  nand4  g334(.a(x126), .b(new_n315_), .c(new_n312_), .d(x014), .O(new_n491_));
  inv1   g335(.a(new_n491_), .O(new_n492_));
  aoi21  g336(.a(new_n490_), .b(new_n332_), .c(new_n492_), .O(new_n493_));
  nand3  g337(.a(x086), .b(new_n312_), .c(new_n300_), .O(new_n494_));
  oai21  g338(.a(new_n493_), .b(x054), .c(new_n494_), .O(new_n495_));
  aoi21  g339(.a(new_n303_), .b(x030), .c(x022), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(x078), .c(new_n300_), .O(new_n497_));
  nand2  g341(.a(new_n497_), .b(new_n482_), .O(new_n498_));
  nand2  g342(.a(x030), .b(new_n301_), .O(new_n499_));
  ...
  oai21  g350(.a(new_n301_), .b(new_n300_), .c(x030), .O(new_n507_));
  ...
  zero   g366(.O(z25));
  zero   g367(.O(z27));
  nor2   g368(.a(new_n172_), .b(x079), .O(z16));
  nor2   g369(.a(new_n172_), .b(x079), .O(z18));
  nor2   g370(.a(new_n172_), .b(x079), .O(z19));
  nor2   g371(.a(new_n172_), .b(x079), .O(z21));
  nor2   g372(.a(new_n172_), .b(x079), .O(z22));
  nor2   g373(.a(new_n172_), .b(x079), .O(z26));
endmodule
