...
module FAU ( 
  ...
  oai21  g320(.a(new_n307_), .b(x030), .c(new_n308_), .O(new_n477_));
  nand2  g321(.a(new_n318_), .b(new_n314_), .O(new_n478_));
  oai22  g322(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  oai22  g324(.a(x118), .b(x110), .c(new_n301_), .d(new_n300_), .O(new_n481_));
  nand2  g325(.a(x118), .b(new_n298_), .O(new_n482_));
  oai21  g326(.a(x118), .b(x022), .c(new_n482_), .O(new_n483_));
  aoi21  g327(.a(new_n483_), .b(x126), .c(x086), .O(new_n484_));
  nand4  g328(.a(new_n484_), .b(new_n481_), .c(new_n480_), .d(new_n477_), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(new_n297_), .c(new_n340_), .O(new_n486_));
  nand4  g330(.a(x086), .b(new_n157_), .c(new_n300_), .d(new_n319_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n486_), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x006), .O(new_n489_));
  nor2   g333(.a(new_n331_), .b(new_n304_), .O(new_n490_));
  oai22  g334(.a(new_n490_), .b(new_n321_), .c(x118), .d(x110), .O(new_n491_));
  nor2   g335(.a(x038), .b(new_n304_), .O(new_n492_));
  oai21  g336(.a(new_n492_), .b(new_n307_), .c(x070), .O(new_n493_));
  nand4  g337(.a(new_n478_), .b(new_n326_), .c(new_n308_), .d(x030), .O(new_n494_));
  nand3  g338(.a(new_n494_), .b(new_n493_), .c(new_n491_), .O(new_n495_));
  aoi21  g339(.a(new_n308_), .b(x030), .c(new_n307_), .O(new_n496_));
  nor2   g340(.a(new_n496_), .b(new_n300_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n340_), .c(new_n497_), .O(new_n498_));
  nor2   g342(.a(new_n301_), .b(x038), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(x022), .c(x046), .O(new_n500_));
  oai21  g344(.a(new_n498_), .b(x086), .c(new_n500_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n297_), .O(new_n502_));
  nand2  g346(.a(x054), .b(x038), .O(new_n503_));
  nand4  g347(.a(x070), .b(new_n340_), .c(x022), .d(new_n319_), .O(new_n504_));
  nand2  g348(.a(x078), .b(x014), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n503_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n157_), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n502_), .c(new_n489_), .O(z14));
  zero   g352(.O(z17));
  zero   g353(.O(z19));
  zero   g354(.O(z20));
  zero   g355(.O(z21));
  ...
  zero   g357(.O(z23));
  zero   g358(.O(z24));
  nor2   g359(.a(x078), .b(new_n157_), .O(z15));
  nor2   g360(.a(x078), .b(new_n157_), .O(z16));
  nor2   g361(.a(x078), .b(new_n157_), .O(z18));
  nor2   g362(.a(x078), .b(new_n157_), .O(z25));
  nor2   g363(.a(x078), .b(new_n157_), .O(z26));
  nor2   g364(.a(x078), .b(new_n157_), .O(z27));
endmodule
