// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:53 2020
...
module FAU ( 
  ...
  nand4  g178(.a(new_n157_), .b(x086), .c(new_n312_), .d(new_n334_), .O(new_n335_));
  nand2  g179(.a(new_n335_), .b(new_n333_), .O(new_n336_));
  oai21  g180(.a(x022), .b(x014), .c(new_n336_), .O(new_n337_));
  nand4  g181(.a(new_n157_), .b(x086), .c(new_n308_), .d(new_n334_), .O(new_n338_));
  ...
  oai21  g209(.a(new_n169_), .b(new_n163_), .c(new_n365_), .O(new_n366_));
  ...
  oai21  g216(.a(new_n372_), .b(new_n369_), .c(new_n170_), .O(new_n373_));
  ...
  nand3  g220(.a(x120), .b(new_n371_), .c(new_n169_), .O(new_n377_));
  ...
  aoi21  g234(.a(new_n390_), .b(new_n364_), .c(new_n170_), .O(new_n391_));
  ...
  oai21  g239(.a(new_n395_), .b(new_n391_), .c(new_n166_), .O(new_n396_));
  aoi21  g240(.a(new_n396_), .b(new_n389_), .c(x048), .O(new_n397_));
  oai21  g241(.a(new_n169_), .b(new_n163_), .c(x024), .O(new_n398_));
  ...
  aoi22  g286(.a(new_n276_), .b(new_n255_), .c(new_n242_), .d(new_n244_), .O(new_n443_));
  nand3  g287(.a(new_n280_), .b(new_n268_), .c(new_n276_), .O(new_n444_));
  oai22  g288(.a(new_n444_), .b(x053), .c(new_n443_), .d(new_n245_), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x069), .O(new_n446_));
  nand2  g290(.a(new_n444_), .b(new_n242_), .O(new_n447_));
  ...
  aoi21  g296(.a(x069), .b(x037), .c(new_n241_), .O(new_n453_));
  nand2  g297(.a(new_n247_), .b(x029), .O(new_n454_));
  aoi21  g298(.a(new_n454_), .b(new_n245_), .c(x085), .O(new_n455_));
  oai21  g299(.a(new_n455_), .b(new_n453_), .c(new_n276_), .O(new_n456_));
  ...
  aoi22  g303(.a(new_n459_), .b(new_n277_), .c(new_n258_), .d(new_n255_), .O(new_n460_));
  nand2  g304(.a(x021), .b(x013), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n247_), .c(new_n268_), .d(x029), .O(new_n462_));
  oai21  g306(.a(new_n460_), .b(new_n241_), .c(new_n462_), .O(new_n463_));
  oai21  g307(.a(x125), .b(x101), .c(new_n463_), .O(new_n464_));
  aoi22  g308(.a(new_n272_), .b(new_n243_), .c(x021), .d(x013), .O(new_n465_));
  nor2   g309(.a(new_n260_), .b(x021), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n465_), .c(x005), .O(new_n467_));
  nand4  g311(.a(new_n268_), .b(x069), .c(x029), .d(new_n245_), .O(new_n468_));
  nand3  g312(.a(new_n468_), .b(new_n467_), .c(new_n464_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n157_), .c(new_n276_), .O(new_n470_));
  nand2  g314(.a(new_n470_), .b(new_n458_), .O(new_n471_));
  nand3  g315(.a(new_n157_), .b(new_n268_), .c(x029), .O(new_n472_));
  nand4  g316(.a(new_n158_), .b(x125), .c(new_n251_), .d(x005), .O(new_n473_));
  aoi21  g317(.a(new_n473_), .b(new_n472_), .c(x013), .O(new_n474_));
  nand4  g318(.a(new_n157_), .b(new_n268_), .c(x029), .d(new_n245_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(new_n474_), .c(new_n276_), .O(new_n477_));
  nor2   g321(.a(new_n477_), .b(new_n255_), .O(new_n478_));
  aoi21  g322(.a(new_n471_), .b(new_n242_), .c(new_n478_), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n450_), .c(x045), .O(z13));
  nand2  g324(.a(new_n312_), .b(new_n358_), .O(new_n481_));
  oai21  g325(.a(x078), .b(x054), .c(new_n481_), .O(new_n482_));
  nand3  g326(.a(new_n482_), .b(x086), .c(x006), .O(new_n483_));
  inv1   g327(.a(x110), .O(new_n484_));
  nand2  g328(.a(new_n351_), .b(new_n484_), .O(new_n485_));
  oai21  g329(.a(x078), .b(new_n316_), .c(new_n358_), .O(new_n486_));
  nand2  g330(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  nand3  g331(.a(new_n327_), .b(new_n301_), .c(x070), .O(new_n488_));
  aoi21  g332(.a(new_n488_), .b(new_n487_), .c(x054), .O(new_n489_));
  nand2  g333(.a(new_n327_), .b(new_n301_), .O(new_n490_));
  nor2   g334(.a(new_n490_), .b(new_n312_), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(new_n489_), .c(new_n299_), .O(new_n492_));
  oai22  g336(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n493_));
  nand3  g337(.a(new_n493_), .b(x070), .c(x022), .O(new_n494_));
  aoi22  g338(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n495_));
  nand4  g339(.a(new_n495_), .b(new_n494_), .c(new_n492_), .d(new_n483_), .O(new_n496_));
  nand2  g340(.a(new_n496_), .b(new_n160_), .O(new_n497_));
  nor2   g341(.a(new_n316_), .b(new_n358_), .O(new_n498_));
  inv1   g342(.a(new_n309_), .O(new_n499_));
  nand2  g343(.a(x126), .b(new_n157_), .O(new_n500_));
  nand2  g344(.a(new_n158_), .b(x102), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n500_), .c(new_n499_), .O(new_n502_));
  nor2   g346(.a(x126), .b(new_n298_), .O(new_n503_));
  aoi21  g347(.a(new_n502_), .b(new_n299_), .c(new_n503_), .O(new_n504_));
  nand3  g348(.a(new_n327_), .b(new_n158_), .c(x006), .O(new_n505_));
  oai21  g349(.a(new_n504_), .b(new_n334_), .c(new_n505_), .O(new_n506_));
  nand4  g350(.a(new_n158_), .b(new_n299_), .c(x038), .d(x030), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  aoi21  g352(.a(new_n506_), .b(new_n300_), .c(new_n508_), .O(new_n509_));
  nand4  g353(.a(x126), .b(new_n351_), .c(new_n157_), .d(x006), .O(new_n510_));
  nand4  g354(.a(new_n158_), .b(new_n299_), .c(x070), .d(x030), .O(new_n511_));
  nand2  g355(.a(new_n511_), .b(new_n510_), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n316_), .O(new_n513_));
  oai22  g357(.a(x094), .b(x070), .c(x062), .d(x038), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(x102), .O(new_n515_));
  nand2  g359(.a(x070), .b(x038), .O(new_n516_));
  nand2  g360(.a(new_n516_), .b(new_n485_), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n515_), .c(new_n298_), .O(new_n518_));
  nand4  g362(.a(new_n485_), .b(new_n309_), .c(new_n299_), .d(x030), .O(new_n519_));
  inv1   g363(.a(new_n519_), .O(new_n520_));
  oai21  g364(.a(new_n520_), .b(new_n518_), .c(new_n158_), .O(new_n521_));
  nand2  g365(.a(new_n326_), .b(new_n308_), .O(new_n522_));
  nand2  g366(.a(x118), .b(new_n484_), .O(new_n523_));
  nand3  g367(.a(new_n523_), .b(new_n522_), .c(new_n481_), .O(new_n524_));
  nand4  g368(.a(new_n524_), .b(x126), .c(new_n157_), .d(x006), .O(new_n525_));
  nand3  g369(.a(new_n525_), .b(new_n521_), .c(new_n513_), .O(new_n526_));
  nand2  g370(.a(new_n526_), .b(new_n300_), .O(new_n527_));
  oai21  g371(.a(new_n509_), .b(new_n498_), .c(new_n527_), .O(new_n528_));
  nand3  g372(.a(new_n312_), .b(x014), .c(x006), .O(new_n529_));
  nor4   g373(.a(new_n529_), .b(new_n500_), .c(x062), .d(x054), .O(new_n530_));
  aoi21  g374(.a(new_n528_), .b(new_n301_), .c(new_n530_), .O(new_n531_));
  aoi21  g375(.a(new_n531_), .b(new_n497_), .c(x046), .O(z14));
  zero   g376(.O(z16));
  zero   g377(.O(z17));
  zero   g378(.O(z19));
  zero   g379(.O(z22));
  ...
  nor2   g385(.a(new_n158_), .b(new_n157_), .O(z21));
  nor2   g386(.a(new_n158_), .b(new_n157_), .O(z23));
  nor2   g387(.a(new_n158_), .b(new_n157_), .O(z24));
  nor2   g388(.a(new_n158_), .b(new_n157_), .O(z27));
endmodule
