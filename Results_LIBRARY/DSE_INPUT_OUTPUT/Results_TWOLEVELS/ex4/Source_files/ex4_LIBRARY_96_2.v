// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:04 2020
...
module FAU ( 
  ...
  aoi21  g198(.a(new_n350_), .b(x095), .c(new_n354_), .O(new_n355_));
  ...
  oai21  g264(.a(new_n420_), .b(x042), .c(new_n174_), .O(z10));
  ...
  nand2  g324(.a(new_n480_), .b(x030), .O(new_n481_));
  aoi21  g325(.a(new_n481_), .b(new_n328_), .c(x086), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(x054), .c(new_n172_), .O(new_n483_));
  oai21  g327(.a(new_n299_), .b(new_n479_), .c(new_n483_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(x038), .O(new_n485_));
  aoi21  g329(.a(x070), .b(x038), .c(new_n345_), .O(new_n486_));
  nand2  g330(.a(new_n301_), .b(x030), .O(new_n487_));
  aoi21  g331(.a(new_n487_), .b(new_n300_), .c(x086), .O(new_n488_));
  oai22  g332(.a(new_n488_), .b(new_n486_), .c(x118), .d(x110), .O(new_n489_));
  ...
  aoi22  g337(.a(new_n480_), .b(x006), .c(new_n321_), .d(x070), .O(new_n494_));
  or2    g338(.a(new_n494_), .b(new_n328_), .O(new_n495_));
  nor2   g339(.a(x126), .b(x102), .O(new_n496_));
  nand4  g340(.a(new_n480_), .b(new_n301_), .c(new_n321_), .d(x030), .O(new_n497_));
  ...
  oai21  g344(.a(new_n346_), .b(x118), .c(new_n335_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n332_), .O(new_n502_));
  oai22  g346(.a(new_n314_), .b(x110), .c(new_n498_), .d(x062), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(x126), .O(new_n504_));
  aoi21  g348(.a(x030), .b(new_n340_), .c(x086), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n502_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(x006), .c(new_n500_), .O(new_n507_));
  nand4  g351(.a(new_n507_), .b(new_n495_), .c(new_n493_), .d(new_n489_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n479_), .O(new_n509_));
  ...
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(x095), .b(new_n172_), .O(z15));
  nor2   g371(.a(x095), .b(new_n172_), .O(z16));
  nor2   g372(.a(x095), .b(new_n172_), .O(z17));
  nor2   g373(.a(x095), .b(new_n172_), .O(z18));
  nor2   g374(.a(x095), .b(new_n172_), .O(z19));
  nor2   g375(.a(x095), .b(new_n172_), .O(z22));
  nor2   g376(.a(x095), .b(new_n172_), .O(z27));
endmodule
