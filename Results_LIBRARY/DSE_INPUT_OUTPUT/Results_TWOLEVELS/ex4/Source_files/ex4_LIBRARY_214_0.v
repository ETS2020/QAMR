...
module FAU ( 
  ...
  oai21  g274(.a(new_n430_), .b(x044), .c(new_n173_), .O(z12));
  ...
  nand3  g315(.a(x070), .b(new_n300_), .c(x022), .O(new_n472_));
  nand3  g316(.a(x086), .b(new_n311_), .c(x006), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(new_n472_), .c(x078), .O(new_n474_));
  inv1   g318(.a(new_n474_), .O(new_n475_));
  aoi21  g319(.a(new_n475_), .b(new_n471_), .c(x046), .O(z14));
  zero   g320(.O(z21));
  zero   g321(.O(z23));
  zero   g322(.O(z24));
  zero   g323(.O(z26));
  zero   g324(.O(z27));
  nor2   g325(.a(x078), .b(x046), .O(z15));
  nor2   g326(.a(x078), .b(x046), .O(z16));
  nor2   g327(.a(x078), .b(x046), .O(z17));
  nor2   g328(.a(x078), .b(x046), .O(z18));
  nor2   g329(.a(x078), .b(x046), .O(z19));
  nor2   g330(.a(x078), .b(x046), .O(z20));
