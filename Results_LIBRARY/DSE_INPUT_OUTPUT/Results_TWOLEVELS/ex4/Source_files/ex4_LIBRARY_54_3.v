...
module FAU ( 
  ...
  oai21  g255(.a(new_n411_), .b(new_n407_), .c(new_n173_), .O(new_n412_));
  ...
  oai21  g265(.a(new_n421_), .b(x042), .c(new_n175_), .O(z10));
  ...
  nand3  g282(.a(new_n438_), .b(new_n175_), .c(new_n432_), .O(new_n439_));
  ...
  nand2  g349(.a(new_n173_), .b(new_n485_), .O(new_n506_));
  ...
  oai21  g365(.a(new_n521_), .b(x046), .c(new_n175_), .O(z14));
  zero   g366(.O(z15));
  zero   g367(.O(z17));
  zero   g368(.O(z18));
  zero   g369(.O(z19));
  ...
  zero   g372(.O(z25));
  zero   g373(.O(z27));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z20));
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z21));
