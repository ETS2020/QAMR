// Benchmark "FAU" written by ABC on Sat Aug 22 02:44:58 2020
...
module FAU ( 
  ...
  nand2  g029(.a(new_n185_), .b(new_n174_), .O(new_n186_));
  inv1   g030(.a(x017), .O(new_n187_));
  oai22  g031(.a(new_n181_), .b(new_n179_), .c(new_n180_), .d(new_n178_), .O(new_n188_));
  nand3  g032(.a(new_n188_), .b(new_n172_), .c(new_n187_), .O(new_n189_));
  aoi21  g033(.a(new_n189_), .b(new_n186_), .c(new_n176_), .O(z01));
  ...
  nand3  g080(.a(new_n236_), .b(new_n174_), .c(x044), .O(new_n237_));
  ...
  nand3  g245(.a(new_n402_), .b(new_n174_), .c(new_n354_), .O(new_n403_));
  ...
  nand2  g253(.a(new_n410_), .b(new_n176_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n174_), .O(z09));
  ...
  oai22  g281(.a(new_n279_), .b(x029), .c(new_n243_), .d(new_n242_), .O(new_n439_));
  inv1   g282(.a(x101), .O(new_n440_));
  aoi21  g283(.a(new_n259_), .b(new_n440_), .c(x093), .O(new_n441_));
  nand2  g284(.a(new_n250_), .b(new_n249_), .O(new_n442_));
  oai21  g285(.a(new_n442_), .b(new_n441_), .c(new_n276_), .O(new_n443_));
  oai21  g286(.a(new_n259_), .b(x109), .c(x037), .O(new_n444_));
  nand2  g287(.a(new_n444_), .b(x117), .O(new_n445_));
  oai21  g288(.a(new_n440_), .b(x061), .c(new_n249_), .O(new_n446_));
  ...
  nand4  g292(.a(new_n449_), .b(new_n445_), .c(new_n443_), .d(new_n439_), .O(new_n450_));
  ...
  aoi21  g298(.a(new_n245_), .b(x029), .c(x021), .O(new_n456_));
  oai21  g299(.a(new_n456_), .b(x077), .c(new_n242_), .O(new_n457_));
  nand2  g300(.a(new_n457_), .b(new_n442_), .O(new_n458_));
  nand2  g301(.a(x029), .b(new_n243_), .O(new_n459_));
  aoi21  g302(.a(new_n459_), .b(new_n271_), .c(new_n276_), .O(new_n460_));
  nand2  g303(.a(new_n259_), .b(new_n440_), .O(new_n461_));
  aoi22  g304(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n462_));
  nand3  g305(.a(new_n462_), .b(new_n461_), .c(x029), .O(new_n463_));
  inv1   g306(.a(new_n463_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(new_n460_), .c(new_n275_), .O(new_n465_));
  aoi21  g308(.a(new_n465_), .b(new_n458_), .c(x053), .O(new_n466_));
  oai21  g309(.a(new_n243_), .b(new_n242_), .c(x029), .O(new_n467_));
  ...
  oai21  g313(.a(new_n470_), .b(new_n466_), .c(new_n267_), .O(new_n471_));
  ...
  aoi21  g318(.a(new_n455_), .b(x005), .c(new_n475_), .O(new_n476_));
  oai21  g319(.a(new_n476_), .b(x045), .c(new_n174_), .O(z13));
  ...
  oai21  g358(.a(new_n515_), .b(x046), .c(new_n174_), .O(z14));
  zero   g359(.O(z07));
  zero   g360(.O(z15));
  zero   g361(.O(z19));
  zero   g362(.O(z20));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(x126), .b(new_n172_), .O(z17));
  nor2   g369(.a(x126), .b(new_n172_), .O(z18));
  nor2   g370(.a(x126), .b(new_n172_), .O(z23));
  nor2   g371(.a(x126), .b(new_n172_), .O(z24));
endmodule
