// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:30 2020
...
module FAU ( 
  ...
  nand3  g255(.a(new_n412_), .b(new_n174_), .c(new_n406_), .O(new_n413_));
  ...
  oai21  g264(.a(new_n421_), .b(x042), .c(new_n174_), .O(z10));
  ...
  nand2  g320(.a(new_n312_), .b(new_n300_), .O(new_n478_));
  ...
  oai21  g324(.a(x078), .b(new_n301_), .c(new_n300_), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  nand3  g326(.a(new_n337_), .b(new_n333_), .c(x070), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n483_), .c(x054), .O(new_n485_));
  nor3   g328(.a(new_n329_), .b(x078), .c(new_n312_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n485_), .c(new_n325_), .O(new_n487_));
  ...
  oai21  g337(.a(new_n494_), .b(x087), .c(new_n317_), .O(new_n495_));
  nand3  g338(.a(new_n495_), .b(new_n303_), .c(new_n325_), .O(new_n496_));
  nand2  g339(.a(new_n172_), .b(x006), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n496_), .c(new_n299_), .O(new_n498_));
  nor3   g341(.a(new_n329_), .b(x087), .c(new_n297_), .O(new_n499_));
  oai21  g342(.a(new_n499_), .b(new_n498_), .c(new_n298_), .O(new_n500_));
  nand4  g343(.a(new_n172_), .b(new_n325_), .c(x038), .d(x030), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n500_), .O(new_n502_));
  nand2  g345(.a(new_n502_), .b(new_n493_), .O(new_n503_));
  nand4  g346(.a(new_n172_), .b(new_n325_), .c(x070), .d(x030), .O(new_n504_));
  nand3  g347(.a(x126), .b(new_n308_), .c(x006), .O(new_n505_));
  ...
  oai21  g352(.a(new_n334_), .b(new_n312_), .c(new_n481_), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n509_), .c(new_n297_), .O(new_n511_));
  nand4  g354(.a(new_n481_), .b(new_n303_), .c(new_n325_), .d(x030), .O(new_n512_));
  inv1   g355(.a(new_n512_), .O(new_n513_));
  oai21  g356(.a(new_n513_), .b(new_n511_), .c(new_n172_), .O(new_n514_));
  inv1   g357(.a(x094), .O(new_n515_));
  nand2  g358(.a(new_n515_), .b(new_n334_), .O(new_n516_));
  nand2  g359(.a(x118), .b(new_n307_), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(new_n516_), .c(new_n478_), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(x126), .c(x006), .O(new_n519_));
  ...
  nor4   g366(.a(new_n523_), .b(new_n317_), .c(x062), .d(x054), .O(new_n524_));
  aoi21  g367(.a(new_n522_), .b(new_n333_), .c(new_n524_), .O(new_n525_));
  aoi21  g368(.a(new_n525_), .b(new_n492_), .c(x046), .O(z14));
  zero   g369(.O(z07));
  zero   g370(.O(z15));
  zero   g371(.O(z18));
  zero   g372(.O(z19));
  ...
  nor2   g378(.a(x126), .b(new_n172_), .O(z20));
