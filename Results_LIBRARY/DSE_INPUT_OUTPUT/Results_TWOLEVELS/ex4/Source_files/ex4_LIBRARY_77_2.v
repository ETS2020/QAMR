// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:29 2020
...
module FAU ( 
  ...
  nor2   g016(.a(x089), .b(new_n172_), .O(z18));
  inv1   g017(.a(z18), .O(new_n174_));
  ...
  oai21  g138(.a(new_n294_), .b(new_n240_), .c(new_n174_), .O(z05));
  inv1   g139(.a(x046), .O(new_n296_));
  inv1   g140(.a(x038), .O(new_n297_));
  inv1   g141(.a(x089), .O(new_n298_));
  ...
  aoi21  g197(.a(new_n349_), .b(x089), .c(new_n353_), .O(new_n354_));
  ...
  nand3  g217(.a(x120), .b(new_n374_), .c(new_n165_), .O(new_n375_));
  nand2  g218(.a(new_n375_), .b(new_n158_), .O(new_n376_));
  aoi21  g219(.a(new_n373_), .b(new_n160_), .c(new_n376_), .O(new_n377_));
  nand4  g220(.a(new_n377_), .b(new_n371_), .c(new_n369_), .d(new_n362_), .O(new_n378_));
  nand4  g221(.a(x120), .b(new_n359_), .c(new_n160_), .d(x008), .O(new_n379_));
  inv1   g222(.a(new_n379_), .O(new_n380_));
  aoi21  g223(.a(new_n378_), .b(new_n162_), .c(new_n380_), .O(new_n381_));
  nand3  g224(.a(x080), .b(new_n160_), .c(new_n159_), .O(new_n382_));
  ...
  nand2  g230(.a(new_n387_), .b(new_n162_), .O(new_n388_));
  aoi21  g231(.a(new_n388_), .b(new_n159_), .c(new_n367_), .O(new_n389_));
  ...
  oai21  g237(.a(new_n394_), .b(new_n389_), .c(new_n161_), .O(new_n395_));
  nand2  g238(.a(new_n358_), .b(x024), .O(new_n396_));
  nand3  g239(.a(new_n396_), .b(new_n360_), .c(new_n359_), .O(new_n397_));
  nand3  g240(.a(new_n397_), .b(new_n162_), .c(x032), .O(new_n398_));
  ...
  nand3  g247(.a(new_n404_), .b(new_n174_), .c(new_n357_), .O(new_n405_));
  ...
  oai21  g256(.a(new_n413_), .b(x041), .c(new_n174_), .O(z09));
  ...
  nand3  g264(.a(new_n421_), .b(new_n174_), .c(new_n415_), .O(new_n422_));
  ...
  nand3  g273(.a(new_n430_), .b(new_n174_), .c(new_n424_), .O(new_n431_));
  ...
  oai21  g282(.a(new_n439_), .b(x044), .c(new_n174_), .O(z12));
  nand2  g283(.a(x021), .b(x013), .O(new_n441_));
  oai21  g284(.a(new_n280_), .b(x029), .c(new_n441_), .O(new_n442_));
  inv1   g285(.a(x101), .O(new_n443_));
  aoi21  g286(.a(new_n261_), .b(new_n443_), .c(x093), .O(new_n444_));
  nor2   g287(.a(x117), .b(x109), .O(new_n445_));
  inv1   g288(.a(new_n445_), .O(new_n446_));
  oai21  g289(.a(new_n446_), .b(new_n444_), .c(new_n277_), .O(new_n447_));
  oai21  g290(.a(new_n261_), .b(x109), .c(x037), .O(new_n448_));
  nand2  g291(.a(new_n448_), .b(x117), .O(new_n449_));
  oai21  g292(.a(new_n443_), .b(x061), .c(new_n251_), .O(new_n450_));
  nand3  g293(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n451_));
  nand2  g294(.a(new_n451_), .b(new_n269_), .O(new_n452_));
  aoi21  g295(.a(new_n450_), .b(new_n256_), .c(new_n452_), .O(new_n453_));
  nand4  g296(.a(new_n453_), .b(new_n449_), .c(new_n447_), .d(new_n442_), .O(new_n454_));
  nand4  g297(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n455_));
  inv1   g298(.a(new_n455_), .O(new_n456_));
  aoi21  g299(.a(new_n454_), .b(new_n276_), .c(new_n456_), .O(new_n457_));
  nand3  g300(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n458_));
  oai21  g301(.a(new_n457_), .b(x053), .c(new_n458_), .O(new_n459_));
  aoi21  g302(.a(new_n247_), .b(x029), .c(x021), .O(new_n460_));
  oai21  g303(.a(new_n460_), .b(x077), .c(new_n244_), .O(new_n461_));
  nand2  g304(.a(new_n461_), .b(new_n446_), .O(new_n462_));
  nand2  g305(.a(x029), .b(new_n245_), .O(new_n463_));
  aoi21  g306(.a(new_n463_), .b(new_n272_), .c(new_n277_), .O(new_n464_));
  nand2  g307(.a(new_n261_), .b(new_n443_), .O(new_n465_));
  nand4  g308(.a(new_n465_), .b(new_n441_), .c(new_n247_), .d(x029), .O(new_n466_));
  inv1   g309(.a(new_n466_), .O(new_n467_));
  oai21  g310(.a(new_n467_), .b(new_n464_), .c(new_n276_), .O(new_n468_));
  ...
  oai21  g322(.a(new_n479_), .b(x045), .c(new_n174_), .O(z13));
  aoi21  g323(.a(new_n296_), .b(x014), .c(new_n298_), .O(new_n481_));
  nand2  g324(.a(x022), .b(x014), .O(new_n482_));
  nand2  g325(.a(new_n327_), .b(new_n334_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n482_), .O(new_n484_));
  inv1   g327(.a(x102), .O(new_n485_));
  aoi21  g328(.a(new_n345_), .b(new_n485_), .c(x094), .O(new_n486_));
  nor2   g329(.a(x118), .b(x110), .O(new_n487_));
  inv1   g330(.a(new_n487_), .O(new_n488_));
  oai21  g331(.a(new_n488_), .b(new_n486_), .c(new_n330_), .O(new_n489_));
  oai21  g332(.a(new_n345_), .b(x110), .c(x038), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(x118), .O(new_n491_));
  oai21  g334(.a(new_n485_), .b(x062), .c(new_n314_), .O(new_n492_));
  nand3  g335(.a(x126), .b(new_n313_), .c(new_n331_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n320_), .O(new_n494_));
  aoi21  g337(.a(new_n492_), .b(new_n297_), .c(new_n494_), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n491_), .c(new_n489_), .d(new_n484_), .O(new_n496_));
  nand4  g339(.a(x126), .b(new_n317_), .c(new_n297_), .d(x014), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n172_), .c(new_n498_), .O(new_n499_));
  nand3  g342(.a(x086), .b(new_n297_), .c(new_n339_), .O(new_n500_));
  oai21  g343(.a(new_n499_), .b(x054), .c(new_n500_), .O(new_n501_));
  aoi21  g344(.a(new_n300_), .b(x030), .c(x022), .O(new_n502_));
  oai21  g345(.a(new_n502_), .b(x078), .c(new_n339_), .O(new_n503_));
  nand2  g346(.a(new_n503_), .b(new_n488_), .O(new_n504_));
  nand2  g347(.a(x030), .b(new_n331_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n327_), .c(new_n330_), .O(new_n506_));
  nand2  g349(.a(new_n345_), .b(new_n485_), .O(new_n507_));
  nand4  g350(.a(new_n507_), .b(new_n482_), .c(new_n300_), .d(x030), .O(new_n508_));
  inv1   g351(.a(new_n508_), .O(new_n509_));
  oai21  g352(.a(new_n509_), .b(new_n506_), .c(new_n172_), .O(new_n510_));
  aoi21  g353(.a(new_n510_), .b(new_n504_), .c(x054), .O(new_n511_));
  nand2  g354(.a(new_n482_), .b(x030), .O(new_n512_));
  nand2  g355(.a(new_n512_), .b(new_n327_), .O(new_n513_));
  nand3  g356(.a(new_n513_), .b(new_n172_), .c(x038), .O(new_n514_));
  inv1   g357(.a(new_n514_), .O(new_n515_));
  oai21  g358(.a(new_n515_), .b(new_n511_), .c(new_n320_), .O(new_n516_));
  oai22  g359(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(x070), .c(x022), .O(new_n518_));
  nand2  g361(.a(x054), .b(x038), .O(new_n519_));
  nand3  g362(.a(new_n519_), .b(new_n518_), .c(new_n516_), .O(new_n520_));
  aoi21  g363(.a(new_n501_), .b(x006), .c(new_n520_), .O(new_n521_));
  oai22  g364(.a(new_n521_), .b(x046), .c(new_n481_), .d(new_n172_), .O(z14));
  zero   g365(.O(z07));
  zero   g366(.O(z15));
  zero   g367(.O(z16));
  zero   g368(.O(z17));
  ...
  zero   g370(.O(z24));
  zero   g371(.O(z26));
  nor2   g372(.a(x089), .b(new_n172_), .O(z19));
  nor2   g373(.a(x089), .b(new_n172_), .O(z20));
  nor2   g374(.a(x089), .b(new_n172_), .O(z21));
  nor2   g375(.a(x089), .b(new_n172_), .O(z22));
  nor2   g376(.a(x089), .b(new_n172_), .O(z25));
  nor2   g377(.a(x089), .b(new_n172_), .O(z27));
endmodule
