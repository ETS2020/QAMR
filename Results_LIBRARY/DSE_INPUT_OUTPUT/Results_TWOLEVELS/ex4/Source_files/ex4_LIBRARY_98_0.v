...
module FAU ( 
  ...
  oai21  g282(.a(new_n438_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nand3  g324(.a(new_n480_), .b(new_n158_), .c(new_n440_), .O(new_n481_));
  ...
  zero   g372(.O(z24));
  zero   g373(.O(z27));
  nor2   g374(.a(x113), .b(x078), .O(z19));
  nor2   g375(.a(x113), .b(x078), .O(z20));
  nor2   g376(.a(x113), .b(x078), .O(z25));
  nor2   g377(.a(x113), .b(x078), .O(z26));
endmodule
