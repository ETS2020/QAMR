...
module FAU ( 
  ...
  oai22  g041(.a(new_n172_), .b(new_n197_), .c(new_n196_), .d(new_n195_), .O(new_n198_));
  nand3  g042(.a(new_n198_), .b(new_n194_), .c(new_n193_), .O(new_n199_));
  inv1   g043(.a(x018), .O(new_n200_));
  inv1   g044(.a(x066), .O(new_n201_));
  oai22  g045(.a(new_n172_), .b(new_n196_), .c(new_n197_), .d(new_n195_), .O(new_n202_));
  nand3  g046(.a(new_n202_), .b(new_n201_), .c(new_n200_), .O(new_n203_));
  aoi22  g047(.a(new_n172_), .b(new_n195_), .c(new_n197_), .d(new_n196_), .O(new_n204_));
  ...
  oai22  g188(.a(new_n173_), .b(new_n311_), .c(new_n298_), .d(new_n321_), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n333_), .c(new_n334_), .O(new_n346_));
  aoi22  g190(.a(new_n173_), .b(new_n321_), .c(new_n298_), .d(new_n311_), .O(new_n347_));
  ...
  oai21  g242(.a(new_n399_), .b(x040), .c(new_n175_), .O(z08));
  ...
  nand3  g250(.a(new_n407_), .b(new_n175_), .c(new_n401_), .O(new_n408_));
  ...
  oai21  g276(.a(new_n433_), .b(x044), .c(new_n175_), .O(z12));
  ...
  nand3  g318(.a(new_n475_), .b(new_n175_), .c(new_n435_), .O(new_n476_));
  ...
  oai21  g323(.a(new_n480_), .b(x054), .c(new_n173_), .O(new_n481_));
  oai21  g324(.a(x074), .b(new_n298_), .c(new_n481_), .O(new_n482_));
  ...
  nand3  g358(.a(new_n515_), .b(x078), .c(new_n172_), .O(new_n516_));
  inv1   g359(.a(new_n516_), .O(new_n517_));
  aoi21  g360(.a(new_n512_), .b(new_n173_), .c(new_n517_), .O(new_n518_));
  ...
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
