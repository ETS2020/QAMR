...
module FAU ( 
  ...
  nor2   g016(.a(x103), .b(new_n172_), .O(z07));
  ...
  aoi21  g198(.a(new_n350_), .b(x103), .c(new_n354_), .O(new_n355_));
  ...
  aoi21  g323(.a(new_n297_), .b(x014), .c(new_n299_), .O(new_n480_));
  ...
  nand4  g339(.a(x126), .b(new_n318_), .c(new_n298_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n172_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n298_), .c(new_n340_), .O(new_n499_));
  ...
  zero   g370(.O(z25));
  zero   g371(.O(z27));
  nor2   g372(.a(x103), .b(new_n172_), .O(z16));
  nor2   g373(.a(x103), .b(new_n172_), .O(z18));
  nor2   g374(.a(x103), .b(new_n172_), .O(z19));
  nor2   g375(.a(x103), .b(new_n172_), .O(z21));
  nor2   g376(.a(x103), .b(new_n172_), .O(z23));
  nor2   g377(.a(x103), .b(new_n172_), .O(z26));
endmodule
