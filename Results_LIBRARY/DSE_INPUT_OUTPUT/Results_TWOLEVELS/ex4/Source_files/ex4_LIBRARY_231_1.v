...
module FAU ( 
  ...
  inv1   g319(.a(x118), .O(new_n476_));
  oai21  g320(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n477_));
  nand2  g321(.a(new_n301_), .b(x030), .O(new_n478_));
  nand2  g322(.a(new_n478_), .b(new_n299_), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(new_n312_), .O(new_n480_));
  aoi22  g324(.a(new_n480_), .b(new_n477_), .c(new_n476_), .d(new_n314_), .O(new_n481_));
  nand3  g325(.a(new_n312_), .b(x070), .c(x030), .O(new_n482_));
  nand3  g326(.a(x102), .b(new_n305_), .c(x006), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(new_n482_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n304_), .O(new_n485_));
  nand2  g329(.a(new_n325_), .b(x006), .O(new_n486_));
  oai21  g330(.a(x086), .b(new_n306_), .c(new_n486_), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(new_n329_), .O(new_n488_));
  nand4  g332(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n489_));
  nand3  g333(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n489_), .O(new_n491_));
  oai21  g335(.a(x126), .b(x102), .c(new_n491_), .O(new_n492_));
  nand2  g336(.a(x126), .b(new_n476_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n298_), .c(x022), .O(new_n494_));
  nand2  g338(.a(x030), .b(new_n343_), .O(new_n495_));
  nand3  g339(.a(x126), .b(x094), .c(new_n305_), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n495_), .c(new_n312_), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n494_), .c(x006), .O(new_n498_));
  nand4  g342(.a(new_n498_), .b(new_n492_), .c(new_n488_), .d(new_n485_), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n481_), .c(new_n340_), .O(new_n500_));
  nand3  g344(.a(x126), .b(new_n314_), .c(x038), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n312_), .c(new_n297_), .O(new_n502_));
  nand3  g346(.a(new_n312_), .b(x038), .c(x030), .O(new_n503_));
  oai21  g347(.a(new_n306_), .b(new_n336_), .c(new_n503_), .O(new_n504_));
  oai21  g348(.a(new_n504_), .b(new_n502_), .c(new_n343_), .O(new_n505_));
  nand2  g349(.a(x030), .b(new_n336_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n323_), .c(x086), .O(new_n507_));
  oai21  g351(.a(new_n507_), .b(x054), .c(x038), .O(new_n508_));
  nand3  g352(.a(x070), .b(new_n304_), .c(x022), .O(new_n509_));
  nand4  g353(.a(new_n509_), .b(new_n508_), .c(new_n505_), .d(new_n500_), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(new_n157_), .c(new_n475_), .O(new_n511_));
  ...
  zero   g362(.O(z24));
  zero   g363(.O(z25));
  nor2   g364(.a(new_n157_), .b(x046), .O(z15));
  nor2   g365(.a(new_n157_), .b(x046), .O(z17));
  nor2   g366(.a(new_n157_), .b(x046), .O(z23));
