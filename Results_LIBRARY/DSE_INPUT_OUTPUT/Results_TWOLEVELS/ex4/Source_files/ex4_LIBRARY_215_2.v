// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:27 2020
...
module FAU ( 
  ...
  nor2   g001(.a(x100), .b(new_n157_), .O(z07));
  ...
  aoi21  g197(.a(new_n349_), .b(x100), .c(new_n353_), .O(new_n354_));
  ...
  oai21  g289(.a(new_n445_), .b(new_n443_), .c(new_n277_), .O(new_n446_));
  oai21  g290(.a(new_n260_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g292(.a(new_n442_), .b(x061), .c(new_n250_), .O(new_n449_));
  ...
  nand2  g307(.a(new_n260_), .b(new_n442_), .O(new_n464_));
  nand4  g308(.a(new_n464_), .b(new_n440_), .c(new_n246_), .d(x029), .O(new_n465_));
  inv1   g309(.a(new_n465_), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n463_), .c(new_n276_), .O(new_n467_));
  ...
  aoi21  g323(.a(new_n296_), .b(x014), .c(new_n298_), .O(new_n480_));
  ...
  nand4  g339(.a(x126), .b(new_n317_), .c(new_n297_), .d(x014), .O(new_n496_));
  inv1   g340(.a(new_n496_), .O(new_n497_));
  aoi21  g341(.a(new_n495_), .b(new_n157_), .c(new_n497_), .O(new_n498_));
  nand3  g342(.a(x086), .b(new_n297_), .c(new_n339_), .O(new_n499_));
  ...
  nand2  g347(.a(new_n297_), .b(x030), .O(new_n504_));
  ...
  zero   g371(.O(z25));
  zero   g372(.O(z26));
  nor2   g373(.a(x100), .b(new_n157_), .O(z15));
  nor2   g374(.a(x100), .b(new_n157_), .O(z18));
  nor2   g375(.a(x100), .b(new_n157_), .O(z21));
  nor2   g376(.a(x100), .b(new_n157_), .O(z23));
  nor2   g377(.a(x100), .b(new_n157_), .O(z27));
endmodule
