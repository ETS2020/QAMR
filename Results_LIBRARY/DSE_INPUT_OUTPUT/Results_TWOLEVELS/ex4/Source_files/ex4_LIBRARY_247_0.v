// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:37 2020
...
module FAU ( 
  ...
  nand3  g323(.a(x070), .b(new_n298_), .c(x022), .O(new_n481_));
  nand3  g324(.a(x086), .b(new_n312_), .c(x006), .O(new_n482_));
  nand3  g325(.a(new_n482_), .b(new_n481_), .c(new_n480_), .O(new_n483_));
  nand3  g326(.a(new_n483_), .b(x078), .c(new_n296_), .O(new_n484_));
  inv1   g327(.a(new_n484_), .O(z14));
  zero   g328(.O(z07));
  zero   g329(.O(z15));
  zero   g330(.O(z17));
  zero   g331(.O(z18));
  ...
  zero   g334(.O(z22));
  zero   g335(.O(z25));
  nor2   g336(.a(x078), .b(x046), .O(z19));
  nor2   g337(.a(x078), .b(x046), .O(z23));
  nor2   g338(.a(x078), .b(x046), .O(z24));
