...
module FAU ( 
  ...
  nor2   g001(.a(x113), .b(new_n157_), .O(z07));
  ...
  nand3  g271(.a(new_n427_), .b(new_n159_), .c(new_n421_), .O(new_n428_));
  ...
  oai21  g324(.a(x046), .b(new_n300_), .c(x113), .O(new_n481_));
  ...
  oai21  g352(.a(new_n508_), .b(new_n504_), .c(new_n157_), .O(new_n509_));
  ...
  zero   g372(.O(z24));
  zero   g373(.O(z27));
  nor2   g374(.a(x113), .b(new_n157_), .O(z19));
  nor2   g375(.a(x113), .b(new_n157_), .O(z20));
  nor2   g376(.a(x113), .b(new_n157_), .O(z25));
  nor2   g377(.a(x113), .b(new_n157_), .O(z26));
endmodule
