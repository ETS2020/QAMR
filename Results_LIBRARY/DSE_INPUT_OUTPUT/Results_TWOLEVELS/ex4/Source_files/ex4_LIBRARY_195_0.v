// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:48 2020
...
module FAU ( 
  ...
  oai22  g319(.a(new_n336_), .b(x030), .c(new_n300_), .d(new_n299_), .O(new_n476_));
  inv1   g320(.a(x102), .O(new_n477_));
  aoi21  g321(.a(new_n316_), .b(new_n477_), .c(x094), .O(new_n478_));
  nand2  g322(.a(new_n307_), .b(new_n306_), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(new_n478_), .c(new_n333_), .O(new_n480_));
  oai21  g324(.a(new_n316_), .b(x110), .c(x038), .O(new_n481_));
  nand2  g325(.a(new_n481_), .b(x118), .O(new_n482_));
  oai21  g326(.a(new_n477_), .b(x062), .c(new_n306_), .O(new_n483_));
  nand3  g327(.a(x126), .b(new_n307_), .c(new_n300_), .O(new_n484_));
  nand2  g328(.a(new_n484_), .b(new_n324_), .O(new_n485_));
  aoi21  g329(.a(new_n483_), .b(new_n311_), .c(new_n485_), .O(new_n486_));
  nand4  g330(.a(new_n486_), .b(new_n482_), .c(new_n480_), .d(new_n476_), .O(new_n487_));
  nand4  g331(.a(x126), .b(new_n314_), .c(new_n311_), .d(x014), .O(new_n488_));
  inv1   g332(.a(new_n488_), .O(new_n489_));
  aoi21  g333(.a(new_n487_), .b(new_n332_), .c(new_n489_), .O(new_n490_));
  nand3  g334(.a(x086), .b(new_n311_), .c(new_n299_), .O(new_n491_));
  oai21  g335(.a(new_n490_), .b(x054), .c(new_n491_), .O(new_n492_));
  aoi21  g336(.a(new_n302_), .b(x030), .c(x022), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(x078), .c(new_n299_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n479_), .O(new_n495_));
  nand2  g339(.a(x030), .b(new_n300_), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n328_), .c(new_n333_), .O(new_n497_));
  nand2  g341(.a(new_n316_), .b(new_n477_), .O(new_n498_));
  ...
  oai21  g347(.a(new_n300_), .b(new_n299_), .c(x030), .O(new_n504_));
  ...
  oai21  g357(.a(new_n513_), .b(x046), .c(new_n158_), .O(z14));
  zero   g358(.O(z19));
  zero   g359(.O(z20));
  zero   g360(.O(z21));
  zero   g361(.O(z24));
  zero   g362(.O(z26));
  nor2   g363(.a(x126), .b(x117), .O(z15));
  nor2   g364(.a(x126), .b(x117), .O(z16));
  nor2   g365(.a(x126), .b(x117), .O(z17));
  nor2   g366(.a(x126), .b(x117), .O(z18));
  nor2   g367(.a(x126), .b(x117), .O(z22));
  nor2   g368(.a(x126), .b(x117), .O(z23));
  nor2   g369(.a(x126), .b(x117), .O(z25));
  nor2   g370(.a(x126), .b(x117), .O(z27));
endmodule
