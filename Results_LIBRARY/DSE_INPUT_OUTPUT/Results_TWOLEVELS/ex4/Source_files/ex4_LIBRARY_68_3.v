...
module FAU ( 
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x119), .O(new_n305_));
  ...
  nor2   g220(.a(x032), .b(new_n163_), .O(new_n377_));
  nor2   g221(.a(new_n366_), .b(x056), .O(new_n378_));
  aoi22  g222(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n166_), .O(new_n379_));
  ...
  oai21  g263(.a(new_n419_), .b(x042), .c(new_n160_), .O(z10));
  ...
  oai21  g279(.a(new_n435_), .b(x044), .c(new_n160_), .O(z12));
  nand2  g280(.a(x021), .b(x013), .O(new_n437_));
  oai21  g281(.a(new_n283_), .b(x029), .c(new_n437_), .O(new_n438_));
  inv1   g282(.a(x101), .O(new_n439_));
  nand2  g283(.a(new_n264_), .b(new_n439_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n249_), .O(new_n441_));
  nor2   g285(.a(x117), .b(x109), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n280_), .O(new_n444_));
  oai21  g288(.a(new_n264_), .b(x109), .c(x037), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x117), .O(new_n446_));
  oai21  g290(.a(new_n439_), .b(x061), .c(new_n255_), .O(new_n447_));
  nand3  g291(.a(x125), .b(new_n256_), .c(new_n246_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n272_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n260_), .c(new_n449_), .O(new_n450_));
  nand4  g294(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n438_), .O(new_n451_));
  nand4  g295(.a(x125), .b(new_n248_), .c(new_n260_), .d(x013), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n279_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x085), .b(new_n260_), .c(new_n245_), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(x005), .O(new_n457_));
  oai21  g301(.a(new_n250_), .b(new_n244_), .c(new_n246_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n279_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n245_), .c(new_n442_), .O(new_n460_));
  nor2   g304(.a(new_n244_), .b(x021), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n283_), .c(x069), .O(new_n462_));
  nand4  g306(.a(new_n440_), .b(new_n437_), .c(new_n251_), .d(x029), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n462_), .c(x077), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n460_), .c(new_n243_), .O(new_n465_));
  nand2  g309(.a(new_n437_), .b(x029), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(new_n275_), .O(new_n467_));
  nand3  g311(.a(new_n467_), .b(new_n279_), .c(x037), .O(new_n468_));
  ...
  nand3  g318(.a(new_n474_), .b(new_n160_), .c(new_n241_), .O(new_n475_));
  ...
  aoi21  g323(.a(new_n479_), .b(new_n328_), .c(x086), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(x054), .c(new_n157_), .O(new_n481_));
  oai21  g325(.a(x119), .b(new_n477_), .c(new_n481_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x038), .O(new_n483_));
  aoi21  g327(.a(x070), .b(x038), .c(new_n345_), .O(new_n484_));
  nand2  g328(.a(new_n301_), .b(x030), .O(new_n485_));
  aoi21  g329(.a(new_n485_), .b(new_n300_), .c(x086), .O(new_n486_));
  oai22  g330(.a(new_n486_), .b(new_n484_), .c(x118), .d(x110), .O(new_n487_));
  nand3  g331(.a(new_n321_), .b(x070), .c(x030), .O(new_n488_));
  nand3  g332(.a(x102), .b(new_n318_), .c(x006), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n488_), .O(new_n490_));
  nand2  g334(.a(new_n490_), .b(new_n299_), .O(new_n491_));
  aoi22  g335(.a(new_n478_), .b(x006), .c(new_n321_), .d(x070), .O(new_n492_));
  or2    g336(.a(new_n492_), .b(new_n328_), .O(new_n493_));
  nor2   g337(.a(x126), .b(x102), .O(new_n494_));
  nand4  g338(.a(new_n478_), .b(new_n301_), .c(new_n321_), .d(x030), .O(new_n495_));
  inv1   g339(.a(x094), .O(new_n496_));
  nand3  g340(.a(new_n496_), .b(new_n331_), .c(x006), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n495_), .c(new_n494_), .O(new_n498_));
  oai21  g342(.a(new_n346_), .b(x118), .c(new_n335_), .O(new_n499_));
  nand2  g343(.a(new_n499_), .b(new_n332_), .O(new_n500_));
  oai22  g344(.a(new_n314_), .b(x110), .c(new_n496_), .d(x062), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(x126), .O(new_n502_));
  aoi21  g346(.a(x030), .b(new_n340_), .c(x086), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n502_), .c(new_n500_), .O(new_n504_));
  aoi21  g348(.a(new_n504_), .b(x006), .c(new_n498_), .O(new_n505_));
  nand4  g349(.a(new_n505_), .b(new_n493_), .c(new_n491_), .d(new_n487_), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(new_n477_), .O(new_n507_));
  oai22  g351(.a(new_n321_), .b(new_n345_), .c(new_n331_), .d(new_n332_), .O(new_n508_));
  nor2   g352(.a(new_n331_), .b(x038), .O(new_n509_));
  aoi22  g353(.a(new_n509_), .b(x022), .c(new_n508_), .d(new_n340_), .O(new_n510_));
  nand2  g354(.a(new_n510_), .b(new_n507_), .O(new_n511_));
  nand3  g355(.a(x070), .b(new_n477_), .c(x022), .O(new_n512_));
  nand3  g356(.a(x086), .b(new_n299_), .c(x006), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n512_), .c(new_n340_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n158_), .c(x078), .O(new_n515_));
  inv1   g359(.a(new_n515_), .O(new_n516_));
  aoi21  g360(.a(new_n511_), .b(new_n157_), .c(new_n516_), .O(new_n517_));
  ...
  zero   g365(.O(z26));
  zero   g366(.O(z27));
  nor2   g367(.a(new_n158_), .b(new_n157_), .O(z15));
