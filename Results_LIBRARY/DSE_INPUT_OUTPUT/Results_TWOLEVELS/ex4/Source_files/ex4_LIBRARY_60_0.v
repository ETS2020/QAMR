...
module FAU ( 
  ...
  nand2  g028(.a(new_n184_), .b(new_n173_), .O(new_n185_));
  ...
  nand2  g253(.a(new_n410_), .b(new_n175_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n173_), .O(z09));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(x126), .b(x065), .O(z17));
  nor2   g369(.a(x126), .b(x065), .O(z18));
  nor2   g370(.a(x126), .b(x065), .O(z23));
  nor2   g371(.a(x126), .b(x065), .O(z24));
endmodule
