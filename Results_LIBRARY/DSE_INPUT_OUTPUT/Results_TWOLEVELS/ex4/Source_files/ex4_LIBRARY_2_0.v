...
module FAU ( 
  ...
  oai21  g273(.a(new_n429_), .b(x044), .c(new_n173_), .O(z12));
  ...
  oai21  g312(.a(new_n468_), .b(x045), .c(new_n173_), .O(z13));
  inv1   g313(.a(x046), .O(new_n470_));
  nand2  g314(.a(x022), .b(x014), .O(new_n471_));
  oai21  g315(.a(new_n336_), .b(x030), .c(new_n471_), .O(new_n472_));
  ...
  nand2  g319(.a(new_n475_), .b(new_n333_), .O(new_n476_));
  oai21  g320(.a(new_n316_), .b(x110), .c(x038), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(x118), .O(new_n478_));
  inv1   g322(.a(x102), .O(new_n479_));
  oai21  g323(.a(new_n479_), .b(x062), .c(new_n306_), .O(new_n480_));
  ...
  nand2  g334(.a(new_n302_), .b(x030), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n300_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n332_), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n299_), .c(new_n474_), .O(new_n494_));
  nor2   g338(.a(new_n298_), .b(x022), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n336_), .c(x070), .O(new_n496_));
  inv1   g340(.a(new_n473_), .O(new_n497_));
  nand4  g341(.a(new_n497_), .b(new_n471_), .c(new_n302_), .d(x030), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n496_), .c(x078), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n494_), .c(new_n297_), .O(new_n500_));
  ...
  aoi21  g352(.a(new_n504_), .b(new_n324_), .c(new_n508_), .O(new_n509_));
  nand2  g353(.a(new_n509_), .b(new_n490_), .O(new_n510_));
  nand3  g354(.a(new_n510_), .b(new_n173_), .c(new_n470_), .O(new_n511_));
  ...
  zero   g360(.O(z22));
  zero   g361(.O(z27));
  nor2   g362(.a(x124), .b(x113), .O(z16));
  nor2   g363(.a(x124), .b(x113), .O(z17));
  nor2   g364(.a(x124), .b(x113), .O(z18));
  nor2   g365(.a(x124), .b(x113), .O(z23));
  nor2   g366(.a(x124), .b(x113), .O(z24));
  nor2   g367(.a(x124), .b(x113), .O(z25));
  nor2   g368(.a(x124), .b(x113), .O(z26));
endmodule
