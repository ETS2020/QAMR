// Benchmark "FAU" written by ABC on Sat Aug 22 02:43:25 2020
...
module FAU ( 
  ...
  nand3  g248(.a(new_n404_), .b(new_n159_), .c(new_n398_), .O(new_n405_));
  ...
  nand3  g316(.a(new_n472_), .b(new_n159_), .c(new_n432_), .O(new_n473_));
  ...
  zero   g358(.O(z23));
  zero   g359(.O(z27));
  nor2   g360(.a(new_n157_), .b(x046), .O(z17));
  nor2   g361(.a(new_n157_), .b(x046), .O(z19));
  nor2   g362(.a(new_n157_), .b(x046), .O(z21));
  nor2   g363(.a(new_n157_), .b(x046), .O(z24));
  nor2   g364(.a(new_n157_), .b(x046), .O(z25));
