...
module FAU ( 
  ...
  oai21  g261(.a(new_n418_), .b(x043), .c(new_n159_), .O(z11));
  ...
  inv1   g314(.a(x118), .O(new_n472_));
  oai21  g315(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n473_));
  nand2  g316(.a(new_n301_), .b(x030), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(new_n299_), .O(new_n475_));
  nand2  g318(.a(new_n475_), .b(new_n312_), .O(new_n476_));
  aoi22  g319(.a(new_n476_), .b(new_n473_), .c(new_n472_), .d(new_n314_), .O(new_n477_));
  nand3  g320(.a(new_n312_), .b(x070), .c(x030), .O(new_n478_));
  nand3  g321(.a(x102), .b(new_n305_), .c(x006), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n478_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n304_), .O(new_n481_));
  nand2  g324(.a(new_n325_), .b(x006), .O(new_n482_));
  oai21  g325(.a(x086), .b(new_n306_), .c(new_n482_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n329_), .O(new_n484_));
  nand4  g327(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n485_));
  nand3  g328(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n486_));
  nand2  g329(.a(new_n486_), .b(new_n485_), .O(new_n487_));
  oai21  g330(.a(x126), .b(x102), .c(new_n487_), .O(new_n488_));
  nand2  g331(.a(x126), .b(new_n472_), .O(new_n489_));
  aoi21  g332(.a(new_n489_), .b(new_n298_), .c(x022), .O(new_n490_));
  nand2  g333(.a(x030), .b(new_n343_), .O(new_n491_));
  nand3  g334(.a(x126), .b(x094), .c(new_n305_), .O(new_n492_));
  nand3  g335(.a(new_n492_), .b(new_n491_), .c(new_n312_), .O(new_n493_));
  oai21  g336(.a(new_n493_), .b(new_n490_), .c(x006), .O(new_n494_));
  nand4  g337(.a(new_n494_), .b(new_n488_), .c(new_n484_), .d(new_n481_), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n477_), .c(new_n340_), .O(new_n496_));
  nand3  g339(.a(x126), .b(new_n314_), .c(x038), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n312_), .c(new_n297_), .O(new_n498_));
  nand3  g341(.a(new_n312_), .b(x038), .c(x030), .O(new_n499_));
  oai21  g342(.a(new_n306_), .b(new_n336_), .c(new_n499_), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(new_n498_), .c(new_n343_), .O(new_n501_));
  nand2  g344(.a(x030), .b(new_n336_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n323_), .c(x086), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(x054), .c(x038), .O(new_n504_));
  nor2   g347(.a(new_n306_), .b(x038), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(x022), .c(x078), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n504_), .c(new_n501_), .O(new_n507_));
  inv1   g350(.a(new_n507_), .O(new_n508_));
  aoi21  g351(.a(new_n508_), .b(new_n496_), .c(x046), .O(z14));
  zero   g352(.O(z07));
  zero   g353(.O(z15));
  zero   g354(.O(z16));
  zero   g355(.O(z18));
