// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:24 2020
...
module FAU ( 
  ...
  oai21  g031(.a(x073), .b(x009), .c(x078), .O(new_n188_));
  aoi21  g032(.a(new_n180_), .b(new_n179_), .c(new_n188_), .O(new_n189_));
  nand3  g033(.a(new_n189_), .b(new_n187_), .c(new_n183_), .O(new_n190_));
  and2   g034(.a(new_n190_), .b(x041), .O(z01));
  ...
  nand3  g145(.a(new_n301_), .b(x110), .c(new_n300_), .O(new_n302_));
  oai21  g146(.a(new_n299_), .b(x030), .c(new_n302_), .O(new_n303_));
  nand2  g147(.a(new_n303_), .b(x014), .O(new_n304_));
  ...
  oai21  g152(.a(x030), .b(new_n306_), .c(new_n308_), .O(new_n309_));
  aoi21  g153(.a(new_n309_), .b(x086), .c(new_n305_), .O(new_n310_));
  aoi21  g154(.a(new_n310_), .b(new_n304_), .c(new_n298_), .O(new_n311_));
  nor2   g155(.a(x054), .b(x041), .O(new_n312_));
  oai21  g156(.a(new_n312_), .b(new_n311_), .c(new_n297_), .O(new_n313_));
  inv1   g157(.a(x110), .O(new_n314_));
  inv1   g158(.a(x118), .O(new_n315_));
  inv1   g159(.a(x070), .O(new_n316_));
  aoi21  g160(.a(new_n316_), .b(new_n297_), .c(x006), .O(new_n317_));
  ...
  nor2   g166(.a(new_n306_), .b(new_n322_), .O(new_n323_));
  aoi21  g167(.a(new_n323_), .b(new_n321_), .c(new_n299_), .O(new_n324_));
  oai22  g168(.a(new_n324_), .b(new_n317_), .c(new_n315_), .d(new_n314_), .O(new_n325_));
  nand3  g169(.a(x086), .b(new_n316_), .c(new_n318_), .O(new_n326_));
  inv1   g170(.a(x102), .O(new_n327_));
  nand3  g171(.a(new_n327_), .b(x062), .c(new_n300_), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n326_), .O(new_n329_));
  nand2  g173(.a(new_n329_), .b(x038), .O(new_n330_));
  nand2  g174(.a(new_n306_), .b(new_n322_), .O(new_n331_));
  nand4  g175(.a(new_n331_), .b(new_n320_), .c(x086), .d(new_n318_), .O(new_n332_));
  nand3  g176(.a(x094), .b(x070), .c(new_n300_), .O(new_n333_));
  nand2  g177(.a(new_n333_), .b(new_n332_), .O(new_n334_));
  oai21  g178(.a(new_n301_), .b(new_n327_), .c(new_n334_), .O(new_n335_));
  oai21  g179(.a(new_n307_), .b(new_n318_), .c(new_n331_), .O(new_n336_));
  inv1   g180(.a(x062), .O(new_n337_));
  oai22  g181(.a(new_n315_), .b(new_n306_), .c(x094), .d(new_n337_), .O(new_n338_));
  nand2  g182(.a(new_n338_), .b(new_n301_), .O(new_n339_));
  nand3  g183(.a(new_n339_), .b(new_n336_), .c(x086), .O(new_n340_));
  nor2   g184(.a(new_n308_), .b(new_n299_), .O(new_n341_));
  aoi22  g185(.a(new_n341_), .b(new_n316_), .c(new_n340_), .d(new_n300_), .O(new_n342_));
  nand4  g186(.a(new_n342_), .b(new_n335_), .c(new_n330_), .d(new_n325_), .O(new_n343_));
  ...
  aoi22  g190(.a(new_n346_), .b(new_n306_), .c(new_n345_), .d(x014), .O(new_n347_));
  nand2  g191(.a(new_n347_), .b(new_n344_), .O(new_n348_));
  nand3  g192(.a(new_n316_), .b(x054), .c(new_n306_), .O(new_n349_));
  nand3  g193(.a(new_n299_), .b(x038), .c(new_n300_), .O(new_n350_));
  nand3  g194(.a(new_n350_), .b(new_n349_), .c(x014), .O(new_n351_));
  nand3  g195(.a(new_n351_), .b(new_n298_), .c(new_n157_), .O(new_n352_));
  inv1   g196(.a(new_n352_), .O(new_n353_));
  aoi21  g197(.a(new_n348_), .b(x078), .c(new_n353_), .O(new_n354_));
  aoi21  g198(.a(new_n354_), .b(new_n313_), .c(new_n296_), .O(z06));
  ...
  nand2  g207(.a(new_n364_), .b(new_n169_), .O(new_n365_));
  ...
  aoi21  g217(.a(new_n371_), .b(new_n163_), .c(new_n374_), .O(new_n375_));
  nand4  g218(.a(new_n375_), .b(new_n368_), .c(new_n365_), .d(new_n361_), .O(new_n376_));
  nor2   g219(.a(x032), .b(new_n162_), .O(new_n377_));
  nor2   g220(.a(new_n366_), .b(x056), .O(new_n378_));
  aoi22  g221(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n165_), .O(new_n379_));
  nand3  g222(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n380_));
  oai21  g223(.a(new_n379_), .b(x048), .c(new_n380_), .O(new_n381_));
  inv1   g224(.a(new_n363_), .O(new_n382_));
  nand2  g225(.a(x088), .b(x056), .O(new_n383_));
  aoi21  g226(.a(new_n383_), .b(x024), .c(x016), .O(new_n384_));
  oai21  g227(.a(new_n384_), .b(x072), .c(new_n162_), .O(new_n385_));
  nand2  g228(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g229(.a(x024), .b(new_n168_), .O(new_n387_));
  aoi21  g230(.a(new_n387_), .b(new_n359_), .c(new_n169_), .O(new_n388_));
  inv1   g231(.a(new_n362_), .O(new_n389_));
  nand4  g232(.a(new_n383_), .b(new_n389_), .c(new_n357_), .d(x024), .O(new_n390_));
  inv1   g233(.a(new_n390_), .O(new_n391_));
  oai21  g234(.a(new_n391_), .b(new_n388_), .c(new_n165_), .O(new_n392_));
  aoi21  g235(.a(new_n392_), .b(new_n386_), .c(x048), .O(new_n393_));
  nand2  g236(.a(new_n357_), .b(x024), .O(new_n394_));
  nand2  g237(.a(new_n394_), .b(new_n359_), .O(new_n395_));
  nand3  g238(.a(new_n395_), .b(new_n165_), .c(x032), .O(new_n396_));
  inv1   g239(.a(new_n396_), .O(new_n397_));
  oai21  g240(.a(new_n397_), .b(new_n393_), .c(new_n161_), .O(new_n398_));
  ...
  aoi21  g245(.a(new_n381_), .b(x000), .c(new_n402_), .O(new_n403_));
  oai21  g246(.a(new_n403_), .b(x040), .c(new_n159_), .O(z08));
  oai22  g247(.a(x073), .b(x049), .c(x033), .d(x009), .O(new_n405_));
  nand3  g248(.a(new_n405_), .b(x081), .c(x001), .O(new_n406_));
  oai22  g249(.a(x073), .b(x033), .c(x049), .d(x009), .O(new_n407_));
  nand3  g250(.a(new_n407_), .b(x065), .c(x017), .O(new_n408_));
  aoi22  g251(.a(x073), .b(x009), .c(x049), .d(x033), .O(new_n409_));
  nand3  g252(.a(new_n409_), .b(new_n408_), .c(new_n406_), .O(new_n410_));
  nand2  g253(.a(new_n410_), .b(new_n157_), .O(new_n411_));
  nand2  g254(.a(new_n411_), .b(new_n159_), .O(z09));
  inv1   g255(.a(x042), .O(new_n413_));
  ...
  nand3  g262(.a(new_n419_), .b(new_n159_), .c(new_n413_), .O(new_n420_));
  inv1   g263(.a(new_n420_), .O(z10));
  ...
  oai21  g271(.a(new_n428_), .b(x043), .c(new_n159_), .O(z11));
  ...
  nand2  g281(.a(x021), .b(x013), .O(new_n439_));
  oai21  g282(.a(new_n280_), .b(x029), .c(new_n439_), .O(new_n440_));
  inv1   g283(.a(x101), .O(new_n441_));
  aoi21  g284(.a(new_n261_), .b(new_n441_), .c(x093), .O(new_n442_));
  nor2   g285(.a(x117), .b(x109), .O(new_n443_));
  inv1   g286(.a(new_n443_), .O(new_n444_));
  oai21  g287(.a(new_n444_), .b(new_n442_), .c(new_n277_), .O(new_n445_));
  oai21  g288(.a(new_n261_), .b(x109), .c(x037), .O(new_n446_));
  nand2  g289(.a(new_n446_), .b(x117), .O(new_n447_));
  oai21  g290(.a(new_n441_), .b(x061), .c(new_n251_), .O(new_n448_));
  nand3  g291(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n449_));
  nand2  g292(.a(new_n449_), .b(new_n269_), .O(new_n450_));
  aoi21  g293(.a(new_n448_), .b(new_n256_), .c(new_n450_), .O(new_n451_));
  nand4  g294(.a(new_n451_), .b(new_n447_), .c(new_n445_), .d(new_n440_), .O(new_n452_));
  nand4  g295(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n453_));
  inv1   g296(.a(new_n453_), .O(new_n454_));
  aoi21  g297(.a(new_n452_), .b(new_n276_), .c(new_n454_), .O(new_n455_));
  nand3  g298(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n456_));
  oai21  g299(.a(new_n455_), .b(x053), .c(new_n456_), .O(new_n457_));
  aoi21  g300(.a(new_n247_), .b(x029), .c(x021), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(x077), .c(new_n244_), .O(new_n459_));
  nand2  g302(.a(new_n459_), .b(new_n444_), .O(new_n460_));
  nand2  g303(.a(x029), .b(new_n245_), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n272_), .c(new_n277_), .O(new_n462_));
  nand2  g305(.a(new_n261_), .b(new_n441_), .O(new_n463_));
  nand4  g306(.a(new_n463_), .b(new_n439_), .c(new_n247_), .d(x029), .O(new_n464_));
  inv1   g307(.a(new_n464_), .O(new_n465_));
  oai21  g308(.a(new_n465_), .b(new_n462_), .c(new_n276_), .O(new_n466_));
  aoi21  g309(.a(new_n466_), .b(new_n460_), .c(x053), .O(new_n467_));
  nand2  g310(.a(new_n439_), .b(x029), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n272_), .O(new_n469_));
  nand3  g312(.a(new_n469_), .b(new_n276_), .c(x037), .O(new_n470_));
  inv1   g313(.a(new_n470_), .O(new_n471_));
  oai21  g314(.a(new_n471_), .b(new_n467_), .c(new_n269_), .O(new_n472_));
  oai22  g315(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n473_));
  nand3  g316(.a(new_n473_), .b(x069), .c(x021), .O(new_n474_));
  aoi22  g317(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(new_n474_), .c(new_n472_), .O(new_n476_));
  aoi21  g319(.a(new_n457_), .b(x005), .c(new_n476_), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(x045), .c(new_n159_), .O(z13));
  oai21  g321(.a(new_n323_), .b(new_n318_), .c(new_n319_), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n299_), .c(new_n298_), .O(new_n480_));
  aoi21  g323(.a(new_n480_), .b(new_n305_), .c(x041), .O(new_n481_));
  nor2   g324(.a(new_n298_), .b(new_n305_), .O(new_n482_));
  oai21  g325(.a(new_n482_), .b(new_n481_), .c(x038), .O(new_n483_));
  aoi21  g326(.a(new_n319_), .b(new_n318_), .c(new_n323_), .O(new_n484_));
  nor2   g327(.a(x126), .b(x102), .O(new_n485_));
  nor2   g328(.a(x118), .b(x110), .O(new_n486_));
  oai21  g329(.a(new_n485_), .b(x094), .c(new_n486_), .O(new_n487_));
  nand2  g330(.a(new_n487_), .b(new_n316_), .O(new_n488_));
  oai21  g331(.a(new_n301_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g332(.a(new_n489_), .b(x118), .O(new_n490_));
  oai21  g333(.a(new_n327_), .b(x062), .c(new_n314_), .O(new_n491_));
  nand2  g334(.a(new_n491_), .b(new_n297_), .O(new_n492_));
  nor2   g335(.a(new_n301_), .b(x118), .O(new_n493_));
  aoi21  g336(.a(new_n493_), .b(new_n306_), .c(x086), .O(new_n494_));
  nand4  g337(.a(new_n494_), .b(new_n492_), .c(new_n490_), .d(new_n488_), .O(new_n495_));
  oai21  g338(.a(new_n495_), .b(new_n484_), .c(new_n305_), .O(new_n496_));
  nand2  g339(.a(x086), .b(new_n322_), .O(new_n497_));
  aoi21  g340(.a(new_n497_), .b(new_n496_), .c(new_n300_), .O(new_n498_));
  aoi21  g341(.a(new_n307_), .b(x030), .c(x022), .O(new_n499_));
  or2    g342(.a(new_n499_), .b(new_n486_), .O(new_n500_));
  nor2   g343(.a(new_n318_), .b(x022), .O(new_n501_));
  oai21  g344(.a(new_n501_), .b(new_n320_), .c(x070), .O(new_n502_));
  inv1   g345(.a(new_n485_), .O(new_n503_));
  nor2   g346(.a(new_n323_), .b(new_n308_), .O(new_n504_));
  nand3  g347(.a(new_n504_), .b(new_n503_), .c(x030), .O(new_n505_));
  nand3  g348(.a(new_n505_), .b(new_n502_), .c(new_n500_), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n299_), .c(new_n305_), .O(new_n507_));
  nand2  g350(.a(x038), .b(x014), .O(new_n508_));
  nand3  g351(.a(new_n508_), .b(x070), .c(x022), .O(new_n509_));
  nand2  g352(.a(new_n509_), .b(new_n507_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n498_), .c(new_n298_), .O(new_n511_));
  nand4  g354(.a(x126), .b(new_n337_), .c(new_n297_), .d(x006), .O(new_n512_));
  oai21  g355(.a(new_n486_), .b(x086), .c(new_n512_), .O(new_n513_));
  nand3  g356(.a(new_n513_), .b(new_n305_), .c(x014), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n511_), .O(new_n515_));
  nand3  g358(.a(x070), .b(new_n305_), .c(x022), .O(new_n516_));
  nand3  g359(.a(x086), .b(new_n297_), .c(x006), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(new_n516_), .c(new_n322_), .O(new_n518_));
  and2   g361(.a(new_n518_), .b(x078), .O(new_n519_));
  aoi21  g362(.a(new_n515_), .b(new_n157_), .c(new_n519_), .O(new_n520_));
  aoi21  g363(.a(new_n520_), .b(new_n483_), .c(x046), .O(z14));
  zero   g364(.O(z07));
  zero   g365(.O(z15));
  zero   g366(.O(z22));
  zero   g367(.O(z23));
  zero   g368(.O(z26));
  zero   g369(.O(z27));
  nor2   g370(.a(x078), .b(new_n157_), .O(z17));
  nor2   g371(.a(x078), .b(new_n157_), .O(z18));
  nor2   g372(.a(x078), .b(new_n157_), .O(z19));
  nor2   g373(.a(x078), .b(new_n157_), .O(z20));
  nor2   g374(.a(x078), .b(new_n157_), .O(z21));
  nor2   g375(.a(x078), .b(new_n157_), .O(z24));
  nor2   g376(.a(x078), .b(new_n157_), .O(z25));
endmodule
