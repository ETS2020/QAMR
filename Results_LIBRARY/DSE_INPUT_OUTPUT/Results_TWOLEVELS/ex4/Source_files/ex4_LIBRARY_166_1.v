...
module FAU ( 
  ...
  nor2   g148(.a(x105), .b(x054), .O(new_n305_));
  ...
  nand3  g194(.a(new_n350_), .b(new_n172_), .c(new_n298_), .O(new_n351_));
  ...
  oai21  g320(.a(new_n316_), .b(new_n312_), .c(new_n313_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n311_), .c(new_n298_), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n476_), .c(x105), .O(new_n479_));
  nor2   g323(.a(new_n298_), .b(new_n476_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n479_), .c(x038), .O(new_n481_));
  aoi21  g325(.a(new_n313_), .b(new_n312_), .c(new_n316_), .O(new_n482_));
  ...
  nand2  g329(.a(new_n485_), .b(new_n309_), .O(new_n486_));
  oai21  g330(.a(new_n325_), .b(x110), .c(x038), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x118), .O(new_n488_));
  oai21  g332(.a(new_n321_), .b(x062), .c(new_n307_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n297_), .O(new_n490_));
  nor2   g334(.a(new_n325_), .b(x118), .O(new_n491_));
  ...
  nand2  g338(.a(x086), .b(new_n299_), .O(new_n495_));
  ...
  nor2   g342(.a(new_n312_), .b(x022), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n314_), .c(x070), .O(new_n500_));
  inv1   g344(.a(new_n483_), .O(new_n501_));
  nor2   g345(.a(new_n316_), .b(new_n339_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n501_), .c(x030), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n500_), .c(new_n498_), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n311_), .c(new_n476_), .O(new_n505_));
  ...
  nand4  g353(.a(x126), .b(new_n332_), .c(new_n297_), .d(x006), .O(new_n510_));
  ...
  nand3  g359(.a(new_n515_), .b(new_n514_), .c(new_n299_), .O(new_n516_));
  and2   g360(.a(new_n516_), .b(x078), .O(new_n517_));
  aoi21  g361(.a(new_n513_), .b(new_n172_), .c(new_n517_), .O(new_n518_));
