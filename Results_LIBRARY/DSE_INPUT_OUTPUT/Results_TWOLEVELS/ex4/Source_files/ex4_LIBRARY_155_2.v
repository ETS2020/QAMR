...
module FAU ( 
  ...
  oai21  g254(.a(new_n410_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai21  g316(.a(new_n306_), .b(x030), .c(new_n308_), .O(new_n473_));
  nand2  g317(.a(new_n318_), .b(new_n314_), .O(new_n474_));
  nand2  g318(.a(new_n474_), .b(new_n305_), .O(new_n475_));
  nor2   g319(.a(x118), .b(x110), .O(new_n476_));
  nand2  g320(.a(new_n476_), .b(new_n475_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n300_), .O(new_n478_));
  oai21  g322(.a(new_n318_), .b(x110), .c(x038), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(x118), .O(new_n480_));
  oai21  g324(.a(new_n314_), .b(x062), .c(new_n297_), .O(new_n481_));
  nand3  g325(.a(x126), .b(new_n298_), .c(new_n320_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(new_n302_), .O(new_n483_));
  aoi21  g327(.a(new_n481_), .b(new_n299_), .c(new_n483_), .O(new_n484_));
  nand4  g328(.a(new_n484_), .b(new_n480_), .c(new_n478_), .d(new_n473_), .O(new_n485_));
  nand4  g329(.a(x126), .b(new_n304_), .c(new_n299_), .d(x014), .O(new_n486_));
  inv1   g330(.a(new_n486_), .O(new_n487_));
  aoi21  g331(.a(new_n485_), .b(new_n344_), .c(new_n487_), .O(new_n488_));
  oai22  g332(.a(new_n488_), .b(x054), .c(new_n337_), .d(x014), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x006), .O(new_n490_));
  oai21  g334(.a(new_n326_), .b(new_n303_), .c(new_n320_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n344_), .O(new_n492_));
  aoi21  g336(.a(new_n492_), .b(new_n319_), .c(new_n476_), .O(new_n493_));
  nor2   g337(.a(new_n303_), .b(x022), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(new_n306_), .c(x070), .O(new_n495_));
  nand4  g339(.a(new_n474_), .b(new_n327_), .c(new_n308_), .d(x030), .O(new_n496_));
  aoi21  g340(.a(new_n496_), .b(new_n495_), .c(x078), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(new_n493_), .c(new_n340_), .O(new_n498_));
  inv1   g342(.a(new_n306_), .O(new_n499_));
  oai21  g343(.a(new_n309_), .b(new_n303_), .c(new_n499_), .O(new_n500_));
  nand3  g344(.a(new_n500_), .b(new_n344_), .c(x038), .O(new_n501_));
  ...
  aoi21  g350(.a(new_n502_), .b(new_n302_), .c(new_n506_), .O(new_n507_));
  aoi21  g351(.a(new_n507_), .b(new_n490_), .c(x046), .O(z14));
  zero   g352(.O(z15));
  zero   g353(.O(z16));
  zero   g354(.O(z17));
  zero   g355(.O(z18));
  ...
  nor2   g361(.a(x078), .b(new_n172_), .O(z23));
