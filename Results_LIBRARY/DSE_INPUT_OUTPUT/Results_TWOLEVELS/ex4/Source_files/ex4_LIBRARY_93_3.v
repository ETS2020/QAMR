// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:59 2020
...
module FAU ( 
  ...
  nand3  g042(.a(new_n198_), .b(new_n158_), .c(new_n193_), .O(new_n199_));
  ...
  nand2  g205(.a(new_n362_), .b(new_n170_), .O(new_n363_));
  ...
  nand3  g213(.a(x120), .b(new_n370_), .c(new_n169_), .O(new_n371_));
  nand2  g214(.a(new_n371_), .b(new_n162_), .O(new_n372_));
  aoi21  g215(.a(new_n369_), .b(new_n164_), .c(new_n372_), .O(new_n373_));
  nand4  g216(.a(new_n373_), .b(new_n366_), .c(new_n363_), .d(new_n359_), .O(new_n374_));
  nand4  g217(.a(x120), .b(new_n356_), .c(new_n164_), .d(x008), .O(new_n375_));
  inv1   g218(.a(new_n375_), .O(new_n376_));
  aoi21  g219(.a(new_n374_), .b(new_n166_), .c(new_n376_), .O(new_n377_));
  nand3  g220(.a(x080), .b(new_n164_), .c(new_n163_), .O(new_n378_));
  ...
  nand2  g225(.a(new_n382_), .b(new_n169_), .O(new_n383_));
  nand2  g226(.a(new_n383_), .b(new_n166_), .O(new_n384_));
  aoi21  g227(.a(new_n384_), .b(new_n163_), .c(new_n361_), .O(new_n385_));
  ...
  oai21  g234(.a(new_n391_), .b(new_n385_), .c(new_n165_), .O(new_n392_));
  ...
  aoi21  g243(.a(new_n396_), .b(new_n162_), .c(new_n400_), .O(new_n401_));
  nand2  g244(.a(new_n401_), .b(new_n380_), .O(new_n402_));
  nand3  g245(.a(new_n402_), .b(new_n160_), .c(new_n354_), .O(new_n403_));
  ...
  nand3  g254(.a(new_n411_), .b(new_n160_), .c(new_n405_), .O(new_n412_));
  ...
  oai21  g263(.a(new_n420_), .b(x042), .c(new_n160_), .O(z10));
  ...
  nand3  g271(.a(new_n428_), .b(new_n160_), .c(new_n422_), .O(new_n429_));
  ...
  nand3  g280(.a(new_n437_), .b(new_n160_), .c(new_n431_), .O(new_n438_));
  inv1   g281(.a(new_n438_), .O(z12));
  oai22  g282(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n440_));
  inv1   g283(.a(x101), .O(new_n441_));
  aoi21  g284(.a(new_n260_), .b(new_n441_), .c(x093), .O(new_n442_));
  nand2  g285(.a(new_n251_), .b(new_n250_), .O(new_n443_));
  oai21  g286(.a(new_n443_), .b(new_n442_), .c(new_n277_), .O(new_n444_));
  ...
  nand2  g304(.a(new_n260_), .b(new_n441_), .O(new_n462_));
  ...
  oai21  g308(.a(new_n465_), .b(new_n461_), .c(new_n276_), .O(new_n466_));
  ...
  oai21  g320(.a(new_n477_), .b(x045), .c(new_n160_), .O(z13));
  nand3  g321(.a(x126), .b(new_n306_), .c(x006), .O(new_n479_));
  oai21  g322(.a(x086), .b(new_n299_), .c(new_n479_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n321_), .O(new_n481_));
  oai21  g324(.a(new_n299_), .b(x022), .c(new_n329_), .O(new_n482_));
  aoi21  g325(.a(new_n482_), .b(new_n325_), .c(x054), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n481_), .c(x078), .O(new_n484_));
  nor2   g327(.a(x082), .b(new_n298_), .O(new_n485_));
  oai21  g328(.a(new_n485_), .b(new_n484_), .c(x038), .O(new_n486_));
  oai21  g329(.a(new_n333_), .b(new_n311_), .c(x006), .O(new_n487_));
  oai21  g330(.a(new_n341_), .b(new_n299_), .c(new_n300_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n325_), .O(new_n489_));
  aoi22  g332(.a(new_n489_), .b(new_n487_), .c(new_n307_), .d(new_n306_), .O(new_n490_));
  nand3  g333(.a(new_n325_), .b(x070), .c(x030), .O(new_n491_));
  nand3  g334(.a(x102), .b(new_n314_), .c(x006), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n491_), .O(new_n493_));
  nand2  g336(.a(new_n493_), .b(new_n311_), .O(new_n494_));
  nand2  g337(.a(x022), .b(x014), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(x006), .O(new_n496_));
  oai21  g339(.a(x086), .b(new_n333_), .c(new_n496_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n337_), .O(new_n498_));
  nand4  g341(.a(new_n495_), .b(new_n302_), .c(new_n325_), .d(x030), .O(new_n499_));
  inv1   g342(.a(x094), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n333_), .c(x006), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(new_n499_), .O(new_n502_));
  oai21  g345(.a(x126), .b(x102), .c(new_n502_), .O(new_n503_));
  nand2  g346(.a(x126), .b(new_n307_), .O(new_n504_));
  aoi21  g347(.a(new_n504_), .b(new_n299_), .c(x022), .O(new_n505_));
  nand2  g348(.a(x030), .b(new_n321_), .O(new_n506_));
  nand3  g349(.a(x126), .b(x094), .c(new_n314_), .O(new_n507_));
  nand3  g350(.a(new_n507_), .b(new_n506_), .c(new_n325_), .O(new_n508_));
  oai21  g351(.a(new_n508_), .b(new_n505_), .c(x006), .O(new_n509_));
  nand4  g352(.a(new_n509_), .b(new_n503_), .c(new_n498_), .d(new_n494_), .O(new_n510_));
  oai21  g353(.a(new_n510_), .b(new_n490_), .c(new_n298_), .O(new_n511_));
  oai22  g354(.a(new_n325_), .b(new_n297_), .c(new_n333_), .d(new_n334_), .O(new_n512_));
  nor2   g355(.a(new_n333_), .b(x038), .O(new_n513_));
  aoi22  g356(.a(new_n513_), .b(x022), .c(new_n512_), .d(new_n321_), .O(new_n514_));
  nand2  g357(.a(new_n514_), .b(new_n511_), .O(new_n515_));
  nand3  g358(.a(x070), .b(new_n298_), .c(x022), .O(new_n516_));
  nand3  g359(.a(x086), .b(new_n311_), .c(x006), .O(new_n517_));
  nand3  g360(.a(new_n517_), .b(new_n516_), .c(new_n321_), .O(new_n518_));
  nand3  g361(.a(new_n518_), .b(new_n158_), .c(x078), .O(new_n519_));
  inv1   g362(.a(new_n519_), .O(new_n520_));
  aoi21  g363(.a(new_n515_), .b(new_n157_), .c(new_n520_), .O(new_n521_));
  aoi21  g364(.a(new_n521_), .b(new_n486_), .c(x046), .O(z14));
  zero   g365(.O(z07));
  zero   g366(.O(z17));
  zero   g367(.O(z19));
  zero   g368(.O(z20));
  ...
  zero   g370(.O(z25));
  zero   g371(.O(z26));
  nor2   g372(.a(new_n158_), .b(new_n157_), .O(z16));
  nor2   g373(.a(new_n158_), .b(new_n157_), .O(z18));
  nor2   g374(.a(new_n158_), .b(new_n157_), .O(z22));
  nor2   g375(.a(new_n158_), .b(new_n157_), .O(z23));
