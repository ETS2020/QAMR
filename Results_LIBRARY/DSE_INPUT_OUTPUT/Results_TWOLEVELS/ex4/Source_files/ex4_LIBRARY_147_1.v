...
module FAU ( 
  ...
  aoi21  g141(.a(x046), .b(new_n297_), .c(x124), .O(new_n298_));
  ...
  nand3  g318(.a(new_n474_), .b(new_n159_), .c(new_n436_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(z13));
  nor2   g320(.a(new_n302_), .b(new_n297_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(new_n301_), .c(new_n330_), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n326_), .c(new_n334_), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n300_), .c(x124), .O(new_n480_));
  ...
  nand2  g340(.a(x086), .b(new_n297_), .O(new_n497_));
  ...
  nand3  g361(.a(new_n517_), .b(new_n516_), .c(new_n297_), .O(new_n518_));
  and2   g362(.a(new_n518_), .b(x078), .O(new_n519_));
  aoi21  g363(.a(new_n515_), .b(new_n157_), .c(new_n519_), .O(new_n520_));
  ...
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(new_n157_), .b(x078), .O(z16));
  nor2   g371(.a(new_n157_), .b(x078), .O(z18));
  nor2   g372(.a(new_n157_), .b(x078), .O(z19));
  nor2   g373(.a(new_n157_), .b(x078), .O(z20));
  nor2   g374(.a(new_n157_), .b(x078), .O(z21));
  nor2   g375(.a(new_n157_), .b(x078), .O(z22));
