// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:03 2020
...
module FAU ( 
  ...
  nand3  g248(.a(new_n405_), .b(new_n159_), .c(new_n399_), .O(new_n406_));
  ...
  oai21  g314(.a(new_n471_), .b(x045), .c(new_n159_), .O(z13));
  aoi21  g315(.a(x070), .b(x038), .c(new_n298_), .O(new_n473_));
  nand2  g316(.a(new_n304_), .b(x030), .O(new_n474_));
  aoi21  g317(.a(new_n474_), .b(new_n341_), .c(x086), .O(new_n475_));
  oai22  g318(.a(new_n475_), .b(new_n473_), .c(x118), .d(x110), .O(new_n476_));
  nand3  g319(.a(new_n326_), .b(x070), .c(x030), .O(new_n477_));
  nand3  g320(.a(x102), .b(new_n316_), .c(x006), .O(new_n478_));
  nand2  g321(.a(new_n478_), .b(new_n477_), .O(new_n479_));
  nand2  g322(.a(new_n479_), .b(new_n313_), .O(new_n480_));
  ...
  nand2  g326(.a(new_n483_), .b(new_n337_), .O(new_n484_));
  nor2   g327(.a(x126), .b(x102), .O(new_n485_));
  nand4  g328(.a(new_n481_), .b(new_n304_), .c(new_n326_), .d(x030), .O(new_n486_));
  inv1   g329(.a(x094), .O(new_n487_));
  nand3  g330(.a(new_n487_), .b(new_n334_), .c(x006), .O(new_n488_));
  aoi21  g331(.a(new_n488_), .b(new_n486_), .c(new_n485_), .O(new_n489_));
  oai21  g332(.a(new_n318_), .b(x118), .c(new_n301_), .O(new_n490_));
  nand2  g333(.a(new_n490_), .b(new_n302_), .O(new_n491_));
  oai22  g334(.a(new_n309_), .b(x110), .c(new_n487_), .d(x062), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(x126), .O(new_n493_));
  aoi21  g336(.a(x030), .b(new_n299_), .c(x086), .O(new_n494_));
  nand3  g337(.a(new_n494_), .b(new_n493_), .c(new_n491_), .O(new_n495_));
  aoi21  g338(.a(new_n495_), .b(x006), .c(new_n489_), .O(new_n496_));
  nand4  g339(.a(new_n496_), .b(new_n484_), .c(new_n480_), .d(new_n476_), .O(new_n497_));
  nand2  g340(.a(x038), .b(x014), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(x070), .c(x022), .O(new_n499_));
  oai22  g342(.a(new_n327_), .b(new_n301_), .c(new_n326_), .d(new_n298_), .O(new_n500_));
  nand2  g343(.a(new_n500_), .b(new_n299_), .O(new_n501_));
  nand2  g344(.a(x030), .b(new_n302_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n330_), .c(x086), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(x054), .c(x038), .O(new_n504_));
  nand4  g347(.a(new_n504_), .b(new_n501_), .c(new_n499_), .d(new_n157_), .O(new_n505_));
  aoi21  g348(.a(new_n497_), .b(new_n300_), .c(new_n505_), .O(new_n506_));
  nor2   g349(.a(new_n506_), .b(x046), .O(z14));
  zero   g350(.O(z07));
  zero   g351(.O(z16));
  zero   g352(.O(z17));
  zero   g353(.O(z18));
  ...
  zero   g356(.O(z24));
  zero   g357(.O(z25));
  nor2   g358(.a(new_n157_), .b(x046), .O(z19));
  nor2   g359(.a(new_n157_), .b(x046), .O(z21));
