// Benchmark "FAU" written by ABC on Sat Aug 22 02:46:33 2020
...
module FAU ( 
  ...
  oai22  g225(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n382_));
  nand3  g226(.a(new_n382_), .b(x084), .c(x004), .O(new_n383_));
  oai22  g227(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n384_));
  nand3  g228(.a(new_n384_), .b(x068), .c(x020), .O(new_n385_));
  aoi22  g229(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n386_));
  nand3  g230(.a(new_n386_), .b(new_n385_), .c(new_n383_), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(new_n388_));
  oai21  g232(.a(new_n388_), .b(x044), .c(new_n175_), .O(z12));
  inv1   g233(.a(x045), .O(new_n390_));
  nand2  g234(.a(x021), .b(x013), .O(new_n391_));
  oai21  g235(.a(new_n281_), .b(x029), .c(new_n391_), .O(new_n392_));
  nor2   g236(.a(x125), .b(x101), .O(new_n393_));
  nor2   g237(.a(x117), .b(x109), .O(new_n394_));
  oai21  g238(.a(new_n393_), .b(x093), .c(new_n394_), .O(new_n395_));
  nand2  g239(.a(new_n395_), .b(new_n278_), .O(new_n396_));
  oai21  g240(.a(new_n261_), .b(x109), .c(x037), .O(new_n397_));
  nand2  g241(.a(new_n397_), .b(x117), .O(new_n398_));
  inv1   g242(.a(x101), .O(new_n399_));
  oai21  g243(.a(new_n399_), .b(x061), .c(new_n251_), .O(new_n400_));
  nand3  g244(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(new_n269_), .O(new_n402_));
  aoi21  g246(.a(new_n400_), .b(new_n256_), .c(new_n402_), .O(new_n403_));
  nand4  g247(.a(new_n403_), .b(new_n398_), .c(new_n396_), .d(new_n392_), .O(new_n404_));
  nand4  g248(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n405_));
  inv1   g249(.a(new_n405_), .O(new_n406_));
  aoi21  g250(.a(new_n404_), .b(new_n277_), .c(new_n406_), .O(new_n407_));
  nand3  g251(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n408_));
  oai21  g252(.a(new_n407_), .b(x053), .c(new_n408_), .O(new_n409_));
  nand2  g253(.a(new_n409_), .b(x005), .O(new_n410_));
  nand2  g254(.a(new_n247_), .b(x029), .O(new_n411_));
  nand2  g255(.a(new_n411_), .b(new_n245_), .O(new_n412_));
  nand2  g256(.a(new_n412_), .b(new_n277_), .O(new_n413_));
  aoi21  g257(.a(new_n413_), .b(new_n244_), .c(new_n394_), .O(new_n414_));
  nor2   g258(.a(new_n243_), .b(x021), .O(new_n415_));
  oai21  g259(.a(new_n415_), .b(new_n281_), .c(x069), .O(new_n416_));
  inv1   g260(.a(new_n393_), .O(new_n417_));
  nand4  g261(.a(new_n417_), .b(new_n391_), .c(new_n247_), .d(x029), .O(new_n418_));
  aoi21  g262(.a(new_n418_), .b(new_n416_), .c(x077), .O(new_n419_));
  oai21  g263(.a(new_n419_), .b(new_n414_), .c(new_n242_), .O(new_n420_));
  nand2  g264(.a(new_n391_), .b(x029), .O(new_n421_));
  nand2  g265(.a(new_n421_), .b(new_n273_), .O(new_n422_));
  nand3  g266(.a(new_n422_), .b(new_n277_), .c(x037), .O(new_n423_));
  nand2  g267(.a(new_n423_), .b(new_n420_), .O(new_n424_));
  oai22  g268(.a(x077), .b(x037), .c(x053), .d(x013), .O(new_n425_));
  nand3  g269(.a(new_n425_), .b(x069), .c(x021), .O(new_n426_));
  aoi22  g270(.a(x077), .b(x013), .c(x053), .d(x037), .O(new_n427_));
  nand2  g271(.a(new_n427_), .b(new_n426_), .O(new_n428_));
  aoi21  g272(.a(new_n424_), .b(new_n269_), .c(new_n428_), .O(new_n429_));
  nand2  g273(.a(new_n429_), .b(new_n410_), .O(new_n430_));
  nand3  g274(.a(new_n430_), .b(new_n175_), .c(new_n390_), .O(new_n431_));
  inv1   g275(.a(new_n431_), .O(z13));
  nand2  g276(.a(x022), .b(x014), .O(new_n433_));
  inv1   g277(.a(x062), .O(new_n434_));
  inv1   g278(.a(x094), .O(new_n435_));
  nand2  g279(.a(new_n435_), .b(new_n434_), .O(new_n436_));
  oai21  g280(.a(new_n436_), .b(x030), .c(new_n433_), .O(new_n437_));
  inv1   g281(.a(x102), .O(new_n438_));
  inv1   g282(.a(x126), .O(new_n439_));
  nand2  g283(.a(new_n439_), .b(new_n438_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n435_), .O(new_n441_));
  nor2   g285(.a(x118), .b(x110), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n303_), .O(new_n444_));
  oai21  g288(.a(new_n439_), .b(x110), .c(x038), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x118), .O(new_n446_));
  inv1   g290(.a(x110), .O(new_n447_));
  oai21  g291(.a(new_n438_), .b(x062), .c(new_n447_), .O(new_n448_));
  inv1   g292(.a(x118), .O(new_n449_));
  nand3  g293(.a(x126), .b(new_n449_), .c(new_n302_), .O(new_n450_));
  nand2  g294(.a(new_n450_), .b(new_n306_), .O(new_n451_));
  aoi21  g295(.a(new_n448_), .b(new_n299_), .c(new_n451_), .O(new_n452_));
  nand4  g296(.a(new_n452_), .b(new_n446_), .c(new_n444_), .d(new_n437_), .O(new_n453_));
  nand4  g297(.a(x126), .b(new_n434_), .c(new_n299_), .d(x014), .O(new_n454_));
  inv1   g298(.a(new_n454_), .O(new_n455_));
  aoi21  g299(.a(new_n453_), .b(new_n173_), .c(new_n455_), .O(new_n456_));
  nand3  g300(.a(x086), .b(new_n299_), .c(new_n298_), .O(new_n457_));
  oai21  g301(.a(new_n456_), .b(x054), .c(new_n457_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(x006), .O(new_n459_));
  nand2  g303(.a(x094), .b(x062), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(x030), .O(new_n461_));
  nand2  g305(.a(new_n461_), .b(new_n302_), .O(new_n462_));
  nand2  g306(.a(new_n462_), .b(new_n173_), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n298_), .c(new_n442_), .O(new_n464_));
  inv1   g308(.a(x030), .O(new_n465_));
  nor2   g309(.a(new_n465_), .b(x022), .O(new_n466_));
  oai21  g310(.a(new_n466_), .b(new_n436_), .c(x070), .O(new_n467_));
  nand4  g311(.a(new_n460_), .b(new_n440_), .c(new_n433_), .d(x030), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n467_), .c(x078), .O(new_n469_));
  oai21  g313(.a(new_n469_), .b(new_n464_), .c(new_n300_), .O(new_n470_));
  nand2  g314(.a(new_n433_), .b(x030), .O(new_n471_));
  nand3  g315(.a(new_n471_), .b(new_n435_), .c(new_n434_), .O(new_n472_));
  nand3  g316(.a(new_n472_), .b(new_n173_), .c(x038), .O(new_n473_));
  nand2  g317(.a(new_n473_), .b(new_n470_), .O(new_n474_));
  oai22  g318(.a(x078), .b(x038), .c(x054), .d(x014), .O(new_n475_));
  nand3  g319(.a(new_n475_), .b(x070), .c(x022), .O(new_n476_));
  aoi22  g320(.a(x078), .b(x014), .c(x054), .d(x038), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n476_), .O(new_n478_));
  aoi21  g322(.a(new_n474_), .b(new_n306_), .c(new_n478_), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n459_), .c(x046), .O(z14));
  zero   g324(.O(z17));
  zero   g325(.O(z18));
  zero   g326(.O(z19));
  zero   g327(.O(z20));
  ...
  zero   g331(.O(z25));
  zero   g332(.O(z27));
  nor2   g333(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g334(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g335(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g336(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
