// Benchmark "FAU" written by ABC on Sat Aug 22 02:48:00 2020
...
module FAU ( 
  ...
  nor2   g217(.a(x032), .b(new_n161_), .O(new_n374_));
  nor2   g218(.a(new_n363_), .b(x056), .O(new_n375_));
  aoi22  g219(.a(new_n375_), .b(new_n374_), .c(new_n373_), .d(new_n164_), .O(new_n376_));
  nand3  g220(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n377_));
  oai21  g221(.a(new_n376_), .b(x048), .c(new_n377_), .O(new_n378_));
  inv1   g222(.a(new_n360_), .O(new_n379_));
  nand2  g223(.a(x088), .b(x056), .O(new_n380_));
  aoi21  g224(.a(new_n380_), .b(x024), .c(x016), .O(new_n381_));
  oai21  g225(.a(new_n381_), .b(x072), .c(new_n161_), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n379_), .O(new_n383_));
  nand2  g227(.a(x024), .b(new_n167_), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n356_), .c(new_n168_), .O(new_n385_));
  inv1   g229(.a(new_n359_), .O(new_n386_));
  nand4  g230(.a(new_n380_), .b(new_n386_), .c(new_n354_), .d(x024), .O(new_n387_));
  inv1   g231(.a(new_n387_), .O(new_n388_));
  oai21  g232(.a(new_n388_), .b(new_n385_), .c(new_n164_), .O(new_n389_));
  aoi21  g233(.a(new_n389_), .b(new_n383_), .c(x048), .O(new_n390_));
  nand2  g234(.a(new_n354_), .b(x024), .O(new_n391_));
  nand2  g235(.a(new_n391_), .b(new_n356_), .O(new_n392_));
  nand3  g236(.a(new_n392_), .b(new_n164_), .c(x032), .O(new_n393_));
  inv1   g237(.a(new_n393_), .O(new_n394_));
  oai21  g238(.a(new_n394_), .b(new_n390_), .c(new_n160_), .O(new_n395_));
  ...
  oai21  g244(.a(new_n400_), .b(x040), .c(new_n158_), .O(z08));
  ...
  nand3  g252(.a(new_n408_), .b(new_n158_), .c(new_n402_), .O(new_n409_));
  ...
  oai21  g261(.a(new_n417_), .b(x042), .c(new_n158_), .O(z10));
  ...
  nand3  g269(.a(new_n425_), .b(new_n158_), .c(new_n419_), .O(new_n426_));
  ...
  oai21  g278(.a(new_n434_), .b(x044), .c(new_n158_), .O(z12));
  ...
  nand2  g283(.a(new_n261_), .b(new_n439_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n246_), .O(new_n441_));
  ...
  oai21  g290(.a(new_n439_), .b(x061), .c(new_n252_), .O(new_n447_));
  nand3  g291(.a(x125), .b(new_n253_), .c(new_n243_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n269_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n257_), .c(new_n449_), .O(new_n450_));
  nand4  g294(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n438_), .O(new_n451_));
  nand4  g295(.a(x125), .b(new_n245_), .c(new_n257_), .d(x013), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n277_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x085), .b(new_n257_), .c(new_n242_), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(x005), .O(new_n457_));
  oai21  g301(.a(new_n247_), .b(new_n241_), .c(new_n243_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n277_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n242_), .c(new_n442_), .O(new_n460_));
  nor2   g304(.a(new_n241_), .b(x021), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n281_), .c(x069), .O(new_n462_));
  nand4  g306(.a(new_n440_), .b(new_n437_), .c(new_n248_), .d(x029), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n462_), .c(x077), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n460_), .c(new_n240_), .O(new_n465_));
  ...
  nand2  g313(.a(new_n469_), .b(new_n269_), .O(new_n470_));
  ...
  nand3  g318(.a(new_n474_), .b(new_n158_), .c(new_n436_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(z13));
  nor2   g320(.a(new_n302_), .b(new_n296_), .O(new_n477_));
  oai21  g321(.a(new_n477_), .b(new_n301_), .c(new_n330_), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n326_), .c(new_n334_), .O(new_n479_));
  aoi21  g323(.a(new_n479_), .b(new_n300_), .c(new_n297_), .O(new_n480_));
  nor2   g324(.a(new_n334_), .b(new_n300_), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(new_n480_), .c(x038), .O(new_n482_));
  aoi21  g326(.a(new_n330_), .b(new_n301_), .c(new_n477_), .O(new_n483_));
  ...
  nand2  g330(.a(new_n486_), .b(new_n335_), .O(new_n487_));
  oai21  g331(.a(new_n318_), .b(x110), .c(x038), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(x118), .O(new_n489_));
  inv1   g333(.a(x102), .O(new_n490_));
  oai21  g334(.a(new_n490_), .b(x062), .c(new_n308_), .O(new_n491_));
  nand2  g335(.a(new_n491_), .b(new_n313_), .O(new_n492_));
  nor2   g336(.a(new_n318_), .b(x118), .O(new_n493_));
  aoi21  g337(.a(new_n493_), .b(new_n302_), .c(x086), .O(new_n494_));
  nand4  g338(.a(new_n494_), .b(new_n492_), .c(new_n489_), .d(new_n487_), .O(new_n495_));
  oai21  g339(.a(new_n495_), .b(new_n483_), .c(new_n300_), .O(new_n496_));
  nand2  g340(.a(x086), .b(new_n296_), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n496_), .c(new_n299_), .O(new_n498_));
  aoi21  g342(.a(new_n304_), .b(x030), .c(x022), .O(new_n499_));
  or2    g343(.a(new_n499_), .b(new_n485_), .O(new_n500_));
  nor2   g344(.a(new_n301_), .b(x022), .O(new_n501_));
  oai21  g345(.a(new_n501_), .b(new_n338_), .c(x070), .O(new_n502_));
  inv1   g346(.a(new_n484_), .O(new_n503_));
  nor2   g347(.a(new_n477_), .b(new_n342_), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n503_), .c(x030), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n502_), .c(new_n500_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n326_), .c(new_n300_), .O(new_n507_));
  ...
  oai21  g354(.a(new_n510_), .b(new_n498_), .c(new_n334_), .O(new_n511_));
  nand4  g355(.a(x126), .b(new_n316_), .c(new_n313_), .d(x006), .O(new_n512_));
  oai21  g356(.a(new_n485_), .b(x086), .c(new_n512_), .O(new_n513_));
  nand3  g357(.a(new_n513_), .b(new_n300_), .c(x014), .O(new_n514_));
  nand2  g358(.a(new_n514_), .b(new_n511_), .O(new_n515_));
  nand3  g359(.a(x070), .b(new_n300_), .c(x022), .O(new_n516_));
  nand3  g360(.a(x086), .b(new_n313_), .c(x006), .O(new_n517_));
  nand3  g361(.a(new_n517_), .b(new_n516_), .c(new_n296_), .O(new_n518_));
  and2   g362(.a(new_n518_), .b(x078), .O(new_n519_));
  aoi21  g363(.a(new_n515_), .b(x124), .c(new_n519_), .O(new_n520_));
  aoi21  g364(.a(new_n520_), .b(new_n482_), .c(x046), .O(z14));
  zero   g365(.O(z15));
  zero   g366(.O(z17));
  zero   g367(.O(z23));
  zero   g368(.O(z25));
  zero   g369(.O(z26));
  nor2   g370(.a(x124), .b(x078), .O(z16));
  nor2   g371(.a(x124), .b(x078), .O(z18));
  nor2   g372(.a(x124), .b(x078), .O(z19));
  nor2   g373(.a(x124), .b(x078), .O(z20));
  nor2   g374(.a(x124), .b(x078), .O(z21));
  nor2   g375(.a(x124), .b(x078), .O(z22));
  nor2   g376(.a(x124), .b(x078), .O(z24));
  nor2   g377(.a(x124), .b(x078), .O(z27));
endmodule
