...
module FAU ( 
  ...
  nand3  g074(.a(new_n230_), .b(new_n172_), .c(new_n225_), .O(new_n231_));
  ...
  oai21  g279(.a(new_n436_), .b(new_n432_), .c(new_n173_), .O(new_n437_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(new_n173_), .b(new_n172_), .O(z20));
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z27));
endmodule
