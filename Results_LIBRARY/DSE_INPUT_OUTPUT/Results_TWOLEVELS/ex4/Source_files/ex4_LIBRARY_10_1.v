// Benchmark "FAU" written by ABC on Sat Aug 22 02:42:50 2020
...
module FAU ( 
  ...
  aoi21  g140(.a(x046), .b(new_n296_), .c(x122), .O(new_n297_));
  ...
  nor2   g178(.a(new_n312_), .b(x030), .O(new_n335_));
  ...
  inv1   g211(.a(x104), .O(new_n368_));
  oai21  g212(.a(new_n359_), .b(x056), .c(new_n368_), .O(new_n369_));
  inv1   g213(.a(x112), .O(new_n370_));
  nand3  g214(.a(x120), .b(new_n370_), .c(new_n168_), .O(new_n371_));
  nand2  g215(.a(new_n371_), .b(new_n161_), .O(new_n372_));
  aoi21  g216(.a(new_n369_), .b(new_n163_), .c(new_n372_), .O(new_n373_));
  nand4  g217(.a(new_n373_), .b(new_n367_), .c(new_n365_), .d(new_n358_), .O(new_n374_));
  nand4  g218(.a(x120), .b(new_n355_), .c(new_n163_), .d(x008), .O(new_n375_));
  inv1   g219(.a(new_n375_), .O(new_n376_));
  aoi21  g220(.a(new_n374_), .b(new_n165_), .c(new_n376_), .O(new_n377_));
  nand3  g221(.a(x080), .b(new_n163_), .c(new_n162_), .O(new_n378_));
  oai21  g222(.a(new_n377_), .b(x048), .c(new_n378_), .O(new_n379_));
  nand2  g223(.a(new_n379_), .b(x000), .O(new_n380_));
  nand2  g224(.a(x088), .b(x056), .O(new_n381_));
  nand2  g225(.a(new_n381_), .b(x024), .O(new_n382_));
  nand2  g226(.a(new_n382_), .b(new_n168_), .O(new_n383_));
  nand2  g227(.a(new_n383_), .b(new_n165_), .O(new_n384_));
  aoi21  g228(.a(new_n384_), .b(new_n162_), .c(new_n363_), .O(new_n385_));
  inv1   g229(.a(x024), .O(new_n386_));
  nor2   g230(.a(new_n386_), .b(x016), .O(new_n387_));
  oai21  g231(.a(new_n387_), .b(new_n357_), .c(x064), .O(new_n388_));
  nand4  g232(.a(new_n381_), .b(new_n361_), .c(new_n354_), .d(x024), .O(new_n389_));
  aoi21  g233(.a(new_n389_), .b(new_n388_), .c(x072), .O(new_n390_));
  ...
  nand3  g237(.a(new_n393_), .b(new_n165_), .c(x032), .O(new_n394_));
  ...
  nand4  g243(.a(new_n399_), .b(new_n398_), .c(new_n396_), .d(new_n380_), .O(new_n400_));
  nand3  g244(.a(new_n400_), .b(new_n159_), .c(new_n353_), .O(new_n401_));
  inv1   g245(.a(new_n401_), .O(z08));
  ...
  nand3  g253(.a(new_n409_), .b(new_n159_), .c(new_n403_), .O(new_n410_));
  ...
  oai21  g262(.a(new_n418_), .b(x042), .c(new_n159_), .O(z10));
  ...
  oai21  g282(.a(new_n280_), .b(x029), .c(new_n438_), .O(new_n439_));
  inv1   g283(.a(x101), .O(new_n440_));
  aoi21  g284(.a(new_n261_), .b(new_n440_), .c(x093), .O(new_n441_));
  nor2   g285(.a(x117), .b(x109), .O(new_n442_));
  inv1   g286(.a(new_n442_), .O(new_n443_));
  oai21  g287(.a(new_n443_), .b(new_n441_), .c(new_n277_), .O(new_n444_));
  oai21  g288(.a(new_n261_), .b(x109), .c(x037), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x117), .O(new_n446_));
  oai21  g290(.a(new_n440_), .b(x061), .c(new_n251_), .O(new_n447_));
  nand3  g291(.a(x125), .b(new_n252_), .c(new_n245_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n269_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n256_), .c(new_n449_), .O(new_n450_));
  nand4  g294(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n439_), .O(new_n451_));
  nand4  g295(.a(x125), .b(new_n259_), .c(new_n256_), .d(x013), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n276_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x085), .b(new_n256_), .c(new_n244_), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  aoi21  g300(.a(new_n247_), .b(x029), .c(x021), .O(new_n457_));
  oai21  g301(.a(new_n457_), .b(x077), .c(new_n244_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n443_), .O(new_n459_));
  nand2  g303(.a(x029), .b(new_n245_), .O(new_n460_));
  aoi21  g304(.a(new_n460_), .b(new_n272_), .c(new_n277_), .O(new_n461_));
  nand2  g305(.a(new_n261_), .b(new_n440_), .O(new_n462_));
  nand4  g306(.a(new_n462_), .b(new_n438_), .c(new_n247_), .d(x029), .O(new_n463_));
  inv1   g307(.a(new_n463_), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n461_), .c(new_n276_), .O(new_n465_));
  aoi21  g309(.a(new_n465_), .b(new_n459_), .c(x053), .O(new_n466_));
  ...
  oai21  g314(.a(new_n470_), .b(new_n466_), .c(new_n269_), .O(new_n471_));
  ...
  aoi21  g319(.a(new_n456_), .b(x005), .c(new_n475_), .O(new_n476_));
  oai21  g320(.a(new_n476_), .b(x045), .c(new_n159_), .O(z13));
  nor2   g321(.a(new_n301_), .b(new_n296_), .O(new_n478_));
  oai21  g322(.a(new_n478_), .b(new_n300_), .c(new_n329_), .O(new_n479_));
  nand3  g323(.a(new_n479_), .b(new_n325_), .c(new_n333_), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n299_), .c(x122), .O(new_n481_));
  nor2   g325(.a(new_n333_), .b(new_n299_), .O(new_n482_));
  oai21  g326(.a(new_n482_), .b(new_n481_), .c(x038), .O(new_n483_));
  aoi21  g327(.a(new_n329_), .b(new_n300_), .c(new_n478_), .O(new_n484_));
  ...
  nand2  g331(.a(new_n487_), .b(new_n334_), .O(new_n488_));
  oai21  g332(.a(new_n317_), .b(x110), .c(x038), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(x118), .O(new_n490_));
  inv1   g334(.a(x102), .O(new_n491_));
  oai21  g335(.a(new_n491_), .b(x062), .c(new_n307_), .O(new_n492_));
  nand2  g336(.a(new_n492_), .b(new_n312_), .O(new_n493_));
  nor2   g337(.a(new_n317_), .b(x118), .O(new_n494_));
  aoi21  g338(.a(new_n494_), .b(new_n301_), .c(x086), .O(new_n495_));
  nand4  g339(.a(new_n495_), .b(new_n493_), .c(new_n490_), .d(new_n488_), .O(new_n496_));
  oai21  g340(.a(new_n496_), .b(new_n484_), .c(new_n299_), .O(new_n497_));
  nand2  g341(.a(x086), .b(new_n296_), .O(new_n498_));
  aoi21  g342(.a(new_n498_), .b(new_n497_), .c(new_n298_), .O(new_n499_));
  aoi21  g343(.a(new_n303_), .b(x030), .c(x022), .O(new_n500_));
  or2    g344(.a(new_n500_), .b(new_n486_), .O(new_n501_));
  nor2   g345(.a(new_n300_), .b(x022), .O(new_n502_));
  oai21  g346(.a(new_n502_), .b(new_n337_), .c(x070), .O(new_n503_));
  inv1   g347(.a(new_n485_), .O(new_n504_));
  nor2   g348(.a(new_n478_), .b(new_n341_), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(x030), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n503_), .c(new_n501_), .O(new_n507_));
  nand3  g351(.a(new_n507_), .b(new_n325_), .c(new_n299_), .O(new_n508_));
  ...
  oai21  g355(.a(new_n511_), .b(new_n499_), .c(new_n333_), .O(new_n512_));
  nand4  g356(.a(x126), .b(new_n315_), .c(new_n312_), .d(x006), .O(new_n513_));
  oai21  g357(.a(new_n486_), .b(x086), .c(new_n513_), .O(new_n514_));
  nand3  g358(.a(new_n514_), .b(new_n299_), .c(x014), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  nand3  g360(.a(x070), .b(new_n299_), .c(x022), .O(new_n517_));
  nand3  g361(.a(x086), .b(new_n312_), .c(x006), .O(new_n518_));
  nand3  g362(.a(new_n518_), .b(new_n517_), .c(new_n296_), .O(new_n519_));
  and2   g363(.a(new_n519_), .b(x078), .O(new_n520_));
  aoi21  g364(.a(new_n516_), .b(new_n157_), .c(new_n520_), .O(new_n521_));
  aoi21  g365(.a(new_n521_), .b(new_n483_), .c(x046), .O(z14));
  zero   g366(.O(z16));
  zero   g367(.O(z17));
  zero   g368(.O(z18));
  zero   g369(.O(z20));
  ...
  zero   g372(.O(z24));
  zero   g373(.O(z26));
  nor2   g374(.a(new_n157_), .b(x078), .O(z15));
  nor2   g375(.a(new_n157_), .b(x078), .O(z19));
  nor2   g376(.a(new_n157_), .b(x078), .O(z22));
  nor2   g377(.a(new_n157_), .b(x078), .O(z25));
  nor2   g378(.a(new_n157_), .b(x078), .O(z27));
endmodule
