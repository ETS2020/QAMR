...
module FAU ( 
  ...
  aoi21  g148(.a(new_n304_), .b(x054), .c(x039), .O(new_n305_));
  ...
  aoi21  g323(.a(new_n298_), .b(x014), .c(x039), .O(new_n481_));
  ...
  aoi21  g337(.a(new_n492_), .b(new_n299_), .c(new_n494_), .O(new_n495_));
  nand4  g338(.a(new_n495_), .b(new_n491_), .c(new_n489_), .d(new_n484_), .O(new_n496_));
  nand4  g339(.a(x126), .b(new_n318_), .c(new_n299_), .d(x014), .O(new_n497_));
  inv1   g340(.a(new_n497_), .O(new_n498_));
  aoi21  g341(.a(new_n496_), .b(new_n158_), .c(new_n498_), .O(new_n499_));
  nand3  g342(.a(x086), .b(new_n299_), .c(new_n340_), .O(new_n500_));
  ...
  oai21  g352(.a(new_n509_), .b(new_n506_), .c(new_n158_), .O(new_n510_));
  ...
  nand3  g356(.a(new_n513_), .b(new_n158_), .c(x038), .O(new_n514_));
  ...
  oai22  g364(.a(new_n521_), .b(x046), .c(new_n481_), .d(new_n158_), .O(z14));
  zero   g365(.O(z07));
  zero   g366(.O(z16));
  zero   g367(.O(z17));
  zero   g368(.O(z20));
