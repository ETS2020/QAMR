// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:13 2020
...
module FAU ( 
  ...
  aoi21  g323(.a(x054), .b(x038), .c(x014), .O(new_n481_));
  nand3  g324(.a(x070), .b(new_n300_), .c(x022), .O(new_n482_));
  nand3  g325(.a(x086), .b(new_n311_), .c(x006), .O(new_n483_));
  nand3  g326(.a(new_n483_), .b(new_n482_), .c(x078), .O(new_n484_));
  inv1   g327(.a(new_n484_), .O(new_n485_));
  aoi21  g328(.a(new_n485_), .b(new_n481_), .c(x046), .O(z14));
  zero   g329(.O(z07));
  zero   g330(.O(z15));
  zero   g331(.O(z16));
  zero   g332(.O(z17));
