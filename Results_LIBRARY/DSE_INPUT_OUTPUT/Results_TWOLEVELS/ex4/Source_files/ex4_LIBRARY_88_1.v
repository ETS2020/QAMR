// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:49 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x012), .O(z07));
  ...
  oai21  g278(.a(new_n280_), .b(x029), .c(new_n434_), .O(new_n435_));
  ...
  nand2  g282(.a(new_n438_), .b(new_n277_), .O(new_n439_));
  oai21  g283(.a(new_n260_), .b(x109), .c(x037), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(x117), .O(new_n441_));
  inv1   g285(.a(x101), .O(new_n442_));
  oai21  g286(.a(new_n442_), .b(x061), .c(new_n250_), .O(new_n443_));
  nand3  g287(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n444_));
  nand2  g288(.a(new_n444_), .b(new_n268_), .O(new_n445_));
  aoi21  g289(.a(new_n443_), .b(new_n255_), .c(new_n445_), .O(new_n446_));
  nand4  g290(.a(new_n446_), .b(new_n441_), .c(new_n439_), .d(new_n435_), .O(new_n447_));
  nand4  g291(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n448_));
  inv1   g292(.a(new_n448_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n276_), .c(new_n449_), .O(new_n450_));
  nand3  g294(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n451_));
  oai21  g295(.a(new_n450_), .b(x053), .c(new_n451_), .O(new_n452_));
  nand2  g296(.a(new_n452_), .b(x005), .O(new_n453_));
  nand2  g297(.a(new_n246_), .b(x029), .O(new_n454_));
  nand2  g298(.a(new_n454_), .b(new_n244_), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(new_n276_), .O(new_n456_));
  aoi21  g300(.a(new_n456_), .b(new_n243_), .c(new_n437_), .O(new_n457_));
  nor2   g301(.a(new_n242_), .b(x021), .O(new_n458_));
  oai21  g302(.a(new_n458_), .b(new_n280_), .c(x069), .O(new_n459_));
  inv1   g303(.a(new_n436_), .O(new_n460_));
  nand4  g304(.a(new_n460_), .b(new_n434_), .c(new_n246_), .d(x029), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n459_), .c(x077), .O(new_n462_));
  oai21  g306(.a(new_n462_), .b(new_n457_), .c(new_n241_), .O(new_n463_));
  ...
  aoi21  g315(.a(new_n467_), .b(new_n268_), .c(new_n471_), .O(new_n472_));
  nand2  g316(.a(new_n472_), .b(new_n453_), .O(new_n473_));
  nand3  g317(.a(new_n473_), .b(new_n174_), .c(new_n433_), .O(new_n474_));
  ...
  zero   g361(.O(z24));
  zero   g362(.O(z26));
  nor2   g363(.a(new_n172_), .b(x012), .O(z15));
  nor2   g364(.a(new_n172_), .b(x012), .O(z16));
  nor2   g365(.a(new_n172_), .b(x012), .O(z17));
  nor2   g366(.a(new_n172_), .b(x012), .O(z18));
  nor2   g367(.a(new_n172_), .b(x012), .O(z22));
  nor2   g368(.a(new_n172_), .b(x012), .O(z23));
  nor2   g369(.a(new_n172_), .b(x012), .O(z25));
  nor2   g370(.a(new_n172_), .b(x012), .O(z27));
endmodule
