...
module FAU ( 
  ...
  oai21  g227(.a(new_n384_), .b(x043), .c(new_n172_), .O(z11));
  ...
  nand3  g235(.a(new_n392_), .b(new_n172_), .c(new_n386_), .O(new_n393_));
  ...
  oai21  g275(.a(new_n432_), .b(x045), .c(new_n172_), .O(z13));
  ...
  zero   g333(.O(z23));
  zero   g334(.O(z24));
  inv1   g335(.a(new_n172_), .O(z25));
  inv1   g336(.a(new_n172_), .O(z26));
  inv1   g337(.a(new_n172_), .O(z27));
endmodule
