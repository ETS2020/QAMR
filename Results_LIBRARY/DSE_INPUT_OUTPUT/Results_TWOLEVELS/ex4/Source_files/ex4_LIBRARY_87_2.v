...
module FAU ( 
  ...
  nand4  g218(.a(x120), .b(new_n356_), .c(new_n163_), .d(x008), .O(new_n375_));
  ...
  aoi21  g228(.a(new_n384_), .b(new_n162_), .c(new_n361_), .O(new_n385_));
  ...
  oai21  g235(.a(new_n391_), .b(new_n385_), .c(new_n164_), .O(new_n392_));
  ...
  aoi21  g244(.a(new_n396_), .b(new_n161_), .c(new_n400_), .O(new_n401_));
  nand2  g245(.a(new_n401_), .b(new_n380_), .O(new_n402_));
  nand3  g246(.a(new_n402_), .b(new_n159_), .c(new_n354_), .O(new_n403_));
  ...
  nand2  g334(.a(new_n490_), .b(new_n159_), .O(new_n491_));
  nand2  g335(.a(x022), .b(x014), .O(new_n492_));
  inv1   g336(.a(x102), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(x058), .c(new_n317_), .O(new_n494_));
  ...
  nor3   g341(.a(new_n329_), .b(x058), .c(new_n297_), .O(new_n498_));
  oai21  g342(.a(new_n498_), .b(new_n497_), .c(new_n298_), .O(new_n499_));
  nand4  g343(.a(new_n325_), .b(new_n157_), .c(x038), .d(x030), .O(new_n500_));
  nand2  g344(.a(new_n500_), .b(new_n499_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n492_), .O(new_n502_));
  nand4  g346(.a(new_n325_), .b(x070), .c(new_n157_), .d(x030), .O(new_n503_));
  ...
  zero   g374(.O(z26));
  zero   g375(.O(z27));
  nor2   g376(.a(x126), .b(new_n157_), .O(z17));
  nor2   g377(.a(x126), .b(new_n157_), .O(z18));
  nor2   g378(.a(x126), .b(new_n157_), .O(z19));
  nor2   g379(.a(x126), .b(new_n157_), .O(z23));
  nor2   g380(.a(x126), .b(new_n157_), .O(z24));
  nor2   g381(.a(x126), .b(new_n157_), .O(z25));
endmodule
