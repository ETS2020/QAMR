// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:13 2020
...
module FAU ( 
  ...
  inv1   g155(.a(x119), .O(new_n312_));
  nor2   g156(.a(new_n312_), .b(x054), .O(new_n313_));
  oai21  g157(.a(new_n313_), .b(new_n311_), .c(new_n297_), .O(new_n314_));
  inv1   g158(.a(x110), .O(new_n315_));
  inv1   g159(.a(x118), .O(new_n316_));
  inv1   g160(.a(x070), .O(new_n317_));
  aoi21  g161(.a(new_n317_), .b(new_n297_), .c(x006), .O(new_n318_));
  ...
  oai21  g180(.a(new_n307_), .b(new_n319_), .c(new_n332_), .O(new_n337_));
  inv1   g181(.a(x062), .O(new_n338_));
  oai22  g182(.a(new_n316_), .b(new_n306_), .c(x094), .d(new_n338_), .O(new_n339_));
  nand2  g183(.a(new_n339_), .b(new_n301_), .O(new_n340_));
  nand3  g184(.a(new_n340_), .b(new_n337_), .c(x086), .O(new_n341_));
  nor2   g185(.a(new_n308_), .b(new_n299_), .O(new_n342_));
  aoi22  g186(.a(new_n342_), .b(new_n317_), .c(new_n341_), .d(new_n300_), .O(new_n343_));
  ...
  nor2   g190(.a(x070), .b(new_n297_), .O(new_n347_));
  aoi22  g191(.a(new_n347_), .b(new_n306_), .c(new_n346_), .d(x014), .O(new_n348_));
  nand2  g192(.a(new_n348_), .b(new_n345_), .O(new_n349_));
  nand3  g193(.a(new_n317_), .b(x054), .c(new_n306_), .O(new_n350_));
  nand3  g194(.a(new_n299_), .b(x038), .c(new_n300_), .O(new_n351_));
  nand3  g195(.a(new_n351_), .b(new_n350_), .c(x014), .O(new_n352_));
  nand3  g196(.a(new_n352_), .b(x119), .c(new_n298_), .O(new_n353_));
  inv1   g197(.a(new_n353_), .O(new_n354_));
  aoi21  g198(.a(new_n349_), .b(x078), .c(new_n354_), .O(new_n355_));
  aoi21  g199(.a(new_n355_), .b(new_n314_), .c(new_n296_), .O(z06));
  nand2  g200(.a(x016), .b(x008), .O(new_n357_));
  inv1   g201(.a(x024), .O(new_n358_));
  ...
  nand2  g208(.a(new_n364_), .b(new_n168_), .O(new_n365_));
  ...
  nand3  g216(.a(x120), .b(new_n372_), .c(new_n167_), .O(new_n373_));
  nand2  g217(.a(new_n373_), .b(new_n160_), .O(new_n374_));
  aoi21  g218(.a(new_n371_), .b(new_n162_), .c(new_n374_), .O(new_n375_));
  nand4  g219(.a(new_n375_), .b(new_n368_), .c(new_n365_), .d(new_n361_), .O(new_n376_));
  nor2   g220(.a(x032), .b(new_n161_), .O(new_n377_));
  nor2   g221(.a(new_n366_), .b(x056), .O(new_n378_));
  aoi22  g222(.a(new_n378_), .b(new_n377_), .c(new_n376_), .d(new_n164_), .O(new_n379_));
  nand3  g223(.a(x080), .b(new_n162_), .c(new_n161_), .O(new_n380_));
  oai21  g224(.a(new_n379_), .b(x048), .c(new_n380_), .O(new_n381_));
  inv1   g225(.a(new_n363_), .O(new_n382_));
  nand2  g226(.a(x088), .b(x056), .O(new_n383_));
  aoi21  g227(.a(new_n383_), .b(x024), .c(x016), .O(new_n384_));
  oai21  g228(.a(new_n384_), .b(x072), .c(new_n161_), .O(new_n385_));
  nand2  g229(.a(new_n385_), .b(new_n382_), .O(new_n386_));
  nand2  g230(.a(x024), .b(new_n167_), .O(new_n387_));
  aoi21  g231(.a(new_n387_), .b(new_n359_), .c(new_n168_), .O(new_n388_));
  inv1   g232(.a(new_n362_), .O(new_n389_));
  nand4  g233(.a(new_n383_), .b(new_n389_), .c(new_n357_), .d(x024), .O(new_n390_));
  inv1   g234(.a(new_n390_), .O(new_n391_));
  oai21  g235(.a(new_n391_), .b(new_n388_), .c(new_n164_), .O(new_n392_));
  aoi21  g236(.a(new_n392_), .b(new_n386_), .c(x048), .O(new_n393_));
  nand2  g237(.a(new_n357_), .b(x024), .O(new_n394_));
  nand2  g238(.a(new_n394_), .b(new_n359_), .O(new_n395_));
  nand3  g239(.a(new_n395_), .b(new_n164_), .c(x032), .O(new_n396_));
  inv1   g240(.a(new_n396_), .O(new_n397_));
  oai21  g241(.a(new_n397_), .b(new_n393_), .c(new_n160_), .O(new_n398_));
  ...
  nand3  g245(.a(new_n401_), .b(new_n400_), .c(new_n398_), .O(new_n402_));
  aoi21  g246(.a(new_n381_), .b(x000), .c(new_n402_), .O(new_n403_));
  oai21  g247(.a(new_n403_), .b(x040), .c(new_n158_), .O(z08));
  ...
  oai21  g255(.a(new_n411_), .b(x041), .c(new_n158_), .O(z09));
  ...
  oai21  g263(.a(new_n419_), .b(x042), .c(new_n158_), .O(z10));
  ...
  oai21  g271(.a(new_n427_), .b(x043), .c(new_n158_), .O(z11));
  ...
  oai21  g279(.a(new_n435_), .b(x044), .c(new_n158_), .O(z12));
  nand2  g280(.a(x021), .b(x013), .O(new_n437_));
  oai21  g281(.a(new_n281_), .b(x029), .c(new_n437_), .O(new_n438_));
  inv1   g282(.a(x101), .O(new_n439_));
  nand2  g283(.a(new_n262_), .b(new_n439_), .O(new_n440_));
  nand2  g284(.a(new_n440_), .b(new_n247_), .O(new_n441_));
  nor2   g285(.a(x117), .b(x109), .O(new_n442_));
  nand2  g286(.a(new_n442_), .b(new_n441_), .O(new_n443_));
  nand2  g287(.a(new_n443_), .b(new_n278_), .O(new_n444_));
  oai21  g288(.a(new_n262_), .b(x109), .c(x037), .O(new_n445_));
  nand2  g289(.a(new_n445_), .b(x117), .O(new_n446_));
  oai21  g290(.a(new_n439_), .b(x061), .c(new_n253_), .O(new_n447_));
  nand3  g291(.a(x125), .b(new_n254_), .c(new_n244_), .O(new_n448_));
  nand2  g292(.a(new_n448_), .b(new_n270_), .O(new_n449_));
  aoi21  g293(.a(new_n447_), .b(new_n258_), .c(new_n449_), .O(new_n450_));
  nand4  g294(.a(new_n450_), .b(new_n446_), .c(new_n444_), .d(new_n438_), .O(new_n451_));
  nand4  g295(.a(x125), .b(new_n246_), .c(new_n258_), .d(x013), .O(new_n452_));
  inv1   g296(.a(new_n452_), .O(new_n453_));
  aoi21  g297(.a(new_n451_), .b(new_n277_), .c(new_n453_), .O(new_n454_));
  nand3  g298(.a(x085), .b(new_n258_), .c(new_n243_), .O(new_n455_));
  oai21  g299(.a(new_n454_), .b(x053), .c(new_n455_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(x005), .O(new_n457_));
  oai21  g301(.a(new_n248_), .b(new_n242_), .c(new_n244_), .O(new_n458_));
  nand2  g302(.a(new_n458_), .b(new_n277_), .O(new_n459_));
  aoi21  g303(.a(new_n459_), .b(new_n243_), .c(new_n442_), .O(new_n460_));
  nor2   g304(.a(new_n242_), .b(x021), .O(new_n461_));
  oai21  g305(.a(new_n461_), .b(new_n281_), .c(x069), .O(new_n462_));
  nand4  g306(.a(new_n440_), .b(new_n437_), .c(new_n249_), .d(x029), .O(new_n463_));
  aoi21  g307(.a(new_n463_), .b(new_n462_), .c(x077), .O(new_n464_));
  oai21  g308(.a(new_n464_), .b(new_n460_), .c(new_n241_), .O(new_n465_));
  nand2  g309(.a(new_n437_), .b(x029), .O(new_n466_));
  nand2  g310(.a(new_n466_), .b(new_n273_), .O(new_n467_));
  nand3  g311(.a(new_n467_), .b(new_n277_), .c(x037), .O(new_n468_));
  nand2  g312(.a(new_n468_), .b(new_n465_), .O(new_n469_));
  nand2  g313(.a(new_n469_), .b(new_n270_), .O(new_n470_));
  ...
  nand4  g317(.a(new_n473_), .b(new_n472_), .c(new_n470_), .d(new_n457_), .O(new_n474_));
  nand3  g318(.a(new_n474_), .b(new_n158_), .c(new_n239_), .O(new_n475_));
  inv1   g319(.a(new_n475_), .O(z13));
  oai21  g320(.a(new_n324_), .b(new_n319_), .c(new_n320_), .O(new_n477_));
  nand3  g321(.a(new_n477_), .b(new_n299_), .c(new_n298_), .O(new_n478_));
  aoi21  g322(.a(new_n478_), .b(new_n305_), .c(new_n312_), .O(new_n479_));
  nor2   g323(.a(new_n298_), .b(new_n305_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n479_), .c(x038), .O(new_n481_));
  aoi21  g325(.a(new_n320_), .b(new_n319_), .c(new_n324_), .O(new_n482_));
  nor2   g326(.a(x126), .b(x102), .O(new_n483_));
  nor2   g327(.a(x118), .b(x110), .O(new_n484_));
  oai21  g328(.a(new_n483_), .b(x094), .c(new_n484_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n317_), .O(new_n486_));
  oai21  g330(.a(new_n301_), .b(x110), .c(x038), .O(new_n487_));
  nand2  g331(.a(new_n487_), .b(x118), .O(new_n488_));
  oai21  g332(.a(new_n328_), .b(x062), .c(new_n315_), .O(new_n489_));
  nand2  g333(.a(new_n489_), .b(new_n297_), .O(new_n490_));
  nor2   g334(.a(new_n301_), .b(x118), .O(new_n491_));
  aoi21  g335(.a(new_n491_), .b(new_n306_), .c(x086), .O(new_n492_));
  nand4  g336(.a(new_n492_), .b(new_n490_), .c(new_n488_), .d(new_n486_), .O(new_n493_));
  oai21  g337(.a(new_n493_), .b(new_n482_), .c(new_n305_), .O(new_n494_));
  nand2  g338(.a(x086), .b(new_n323_), .O(new_n495_));
  aoi21  g339(.a(new_n495_), .b(new_n494_), .c(new_n300_), .O(new_n496_));
  aoi21  g340(.a(new_n307_), .b(x030), .c(x022), .O(new_n497_));
  or2    g341(.a(new_n497_), .b(new_n484_), .O(new_n498_));
  nor2   g342(.a(new_n319_), .b(x022), .O(new_n499_));
  oai21  g343(.a(new_n499_), .b(new_n321_), .c(x070), .O(new_n500_));
  inv1   g344(.a(new_n483_), .O(new_n501_));
  nor2   g345(.a(new_n324_), .b(new_n308_), .O(new_n502_));
  nand3  g346(.a(new_n502_), .b(new_n501_), .c(x030), .O(new_n503_));
  nand3  g347(.a(new_n503_), .b(new_n500_), .c(new_n498_), .O(new_n504_));
  nand3  g348(.a(new_n504_), .b(new_n299_), .c(new_n305_), .O(new_n505_));
  ...
  oai21  g352(.a(new_n508_), .b(new_n496_), .c(new_n298_), .O(new_n509_));
  nand4  g353(.a(x126), .b(new_n338_), .c(new_n297_), .d(x006), .O(new_n510_));
  oai21  g354(.a(new_n484_), .b(x086), .c(new_n510_), .O(new_n511_));
  nand3  g355(.a(new_n511_), .b(new_n305_), .c(x014), .O(new_n512_));
  nand2  g356(.a(new_n512_), .b(new_n509_), .O(new_n513_));
  nand3  g357(.a(x070), .b(new_n305_), .c(x022), .O(new_n514_));
  nand3  g358(.a(x086), .b(new_n297_), .c(x006), .O(new_n515_));
  nand3  g359(.a(new_n515_), .b(new_n514_), .c(new_n323_), .O(new_n516_));
  and2   g360(.a(new_n516_), .b(x078), .O(new_n517_));
  aoi21  g361(.a(new_n513_), .b(x119), .c(new_n517_), .O(new_n518_));
  aoi21  g362(.a(new_n518_), .b(new_n481_), .c(x046), .O(z14));
  zero   g363(.O(z17));
  zero   g364(.O(z20));
  zero   g365(.O(z21));
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(x119), .b(x078), .O(z15));
  nor2   g369(.a(x119), .b(x078), .O(z16));
  nor2   g370(.a(x119), .b(x078), .O(z18));
  nor2   g371(.a(x119), .b(x078), .O(z19));
  nor2   g372(.a(x119), .b(x078), .O(z22));
  nor2   g373(.a(x119), .b(x078), .O(z23));
  nor2   g374(.a(x119), .b(x078), .O(z24));
  nor2   g375(.a(x119), .b(x078), .O(z25));
endmodule
