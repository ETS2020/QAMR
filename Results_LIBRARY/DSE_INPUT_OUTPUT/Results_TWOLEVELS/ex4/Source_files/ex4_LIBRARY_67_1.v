...
module FAU ( 
  ...
  oai21  g201(.a(new_n168_), .b(new_n162_), .c(new_n357_), .O(new_n358_));
  ...
  oai21  g231(.a(new_n387_), .b(new_n383_), .c(new_n165_), .O(new_n388_));
  aoi21  g232(.a(new_n388_), .b(new_n381_), .c(x048), .O(new_n389_));
  oai21  g233(.a(new_n168_), .b(new_n162_), .c(x024), .O(new_n390_));
  ...
  zero   g364(.O(z23));
  zero   g365(.O(z24));
  nor2   g366(.a(new_n157_), .b(x078), .O(z16));
  nor2   g367(.a(new_n157_), .b(x078), .O(z17));
  nor2   g368(.a(new_n157_), .b(x078), .O(z18));
  nor2   g369(.a(new_n157_), .b(x078), .O(z19));
