...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x073), .O(z07));
  ...
  nor2   g252(.a(new_n178_), .b(new_n185_), .O(new_n409_));
  oai21  g253(.a(new_n409_), .b(new_n408_), .c(new_n172_), .O(new_n410_));
  inv1   g254(.a(new_n409_), .O(new_n411_));
  nand3  g255(.a(x065), .b(new_n178_), .c(x017), .O(new_n412_));
  nand3  g256(.a(x081), .b(new_n185_), .c(x001), .O(new_n413_));
  nand4  g257(.a(new_n413_), .b(new_n412_), .c(new_n411_), .d(new_n189_), .O(new_n414_));
  ...
  oai21  g267(.a(new_n423_), .b(x042), .c(new_n174_), .O(z10));
  ...
  oai22  g285(.a(new_n282_), .b(x029), .c(new_n246_), .d(new_n245_), .O(new_n442_));
  inv1   g286(.a(x101), .O(new_n443_));
  aoi21  g287(.a(new_n262_), .b(new_n443_), .c(x093), .O(new_n444_));
  nand2  g288(.a(new_n253_), .b(new_n252_), .O(new_n445_));
  oai21  g289(.a(new_n445_), .b(new_n444_), .c(new_n279_), .O(new_n446_));
  oai21  g290(.a(new_n262_), .b(x109), .c(x037), .O(new_n447_));
  nand2  g291(.a(new_n447_), .b(x117), .O(new_n448_));
  oai21  g292(.a(new_n443_), .b(x061), .c(new_n252_), .O(new_n449_));
  ...
  aoi21  g306(.a(new_n462_), .b(new_n274_), .c(new_n279_), .O(new_n463_));
  nand2  g307(.a(new_n262_), .b(new_n443_), .O(new_n464_));
  ...
  oai21  g311(.a(new_n467_), .b(new_n463_), .c(new_n278_), .O(new_n468_));
  aoi21  g312(.a(new_n468_), .b(new_n461_), .c(x053), .O(new_n469_));
  oai21  g313(.a(new_n246_), .b(new_n245_), .c(x029), .O(new_n470_));
  ...
  oai21  g317(.a(new_n473_), .b(new_n469_), .c(new_n270_), .O(new_n474_));
  ...
  nand2  g346(.a(new_n172_), .b(new_n482_), .O(new_n503_));
  ...
  zero   g369(.O(z25));
  zero   g370(.O(z26));
  nor2   g371(.a(new_n172_), .b(x073), .O(z15));
  nor2   g372(.a(new_n172_), .b(x073), .O(z21));
  nor2   g373(.a(new_n172_), .b(x073), .O(z22));
  nor2   g374(.a(new_n172_), .b(x073), .O(z23));
  nor2   g375(.a(new_n172_), .b(x073), .O(z27));
endmodule
