// Benchmark "FAU" written by ABC on Sat Aug 22 02:50:07 2020
...
module FAU ( 
  ...
  oai22  g072(.a(new_n172_), .b(new_n228_), .c(new_n227_), .d(new_n226_), .O(new_n229_));
  nand3  g073(.a(new_n229_), .b(new_n225_), .c(new_n224_), .O(new_n230_));
  inv1   g074(.a(x020), .O(new_n231_));
  inv1   g075(.a(x068), .O(new_n232_));
  oai22  g076(.a(new_n172_), .b(new_n227_), .c(new_n228_), .d(new_n226_), .O(new_n233_));
  nand3  g077(.a(new_n233_), .b(new_n232_), .c(new_n231_), .O(new_n234_));
  aoi22  g078(.a(new_n172_), .b(new_n226_), .c(new_n228_), .d(new_n227_), .O(new_n235_));
  ...
  nand2  g283(.a(new_n439_), .b(new_n276_), .O(new_n440_));
  oai21  g284(.a(new_n259_), .b(x109), .c(x037), .O(new_n441_));
  nand2  g285(.a(new_n441_), .b(x117), .O(new_n442_));
  inv1   g286(.a(x101), .O(new_n443_));
  oai21  g287(.a(new_n443_), .b(x061), .c(new_n249_), .O(new_n444_));
  ...
  nand2  g298(.a(new_n245_), .b(x029), .O(new_n455_));
  nand2  g299(.a(new_n455_), .b(new_n243_), .O(new_n456_));
  nand2  g300(.a(new_n456_), .b(new_n275_), .O(new_n457_));
  aoi21  g301(.a(new_n457_), .b(new_n242_), .c(new_n438_), .O(new_n458_));
  nor2   g302(.a(new_n241_), .b(x021), .O(new_n459_));
  oai21  g303(.a(new_n459_), .b(new_n279_), .c(x069), .O(new_n460_));
  inv1   g304(.a(new_n437_), .O(new_n461_));
  nand4  g305(.a(new_n461_), .b(new_n435_), .c(new_n245_), .d(x029), .O(new_n462_));
  aoi21  g306(.a(new_n462_), .b(new_n460_), .c(x077), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n458_), .c(new_n240_), .O(new_n464_));
  ...
  aoi21  g316(.a(new_n468_), .b(new_n267_), .c(new_n472_), .O(new_n473_));
  ...
  oai22  g320(.a(new_n339_), .b(x030), .c(new_n304_), .d(new_n303_), .O(new_n477_));
  inv1   g321(.a(x102), .O(new_n478_));
  aoi21  g322(.a(new_n320_), .b(new_n478_), .c(x094), .O(new_n479_));
  nand2  g323(.a(new_n311_), .b(new_n310_), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(new_n479_), .c(new_n336_), .O(new_n481_));
  oai21  g325(.a(new_n320_), .b(x110), .c(x038), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x118), .O(new_n483_));
  oai21  g327(.a(new_n478_), .b(x062), .c(new_n310_), .O(new_n484_));
  nand3  g328(.a(x126), .b(new_n311_), .c(new_n304_), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(new_n328_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n315_), .c(new_n486_), .O(new_n487_));
  nand4  g331(.a(new_n487_), .b(new_n483_), .c(new_n481_), .d(new_n477_), .O(new_n488_));
  nand4  g332(.a(x126), .b(new_n318_), .c(new_n315_), .d(x014), .O(new_n489_));
  inv1   g333(.a(new_n489_), .O(new_n490_));
  aoi21  g334(.a(new_n488_), .b(new_n296_), .c(new_n490_), .O(new_n491_));
  nand3  g335(.a(x086), .b(new_n315_), .c(new_n303_), .O(new_n492_));
  oai21  g336(.a(new_n491_), .b(x054), .c(new_n492_), .O(new_n493_));
  aoi21  g337(.a(new_n306_), .b(x030), .c(x022), .O(new_n494_));
  oai21  g338(.a(new_n494_), .b(x078), .c(new_n303_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n480_), .O(new_n496_));
  nand2  g340(.a(x030), .b(new_n304_), .O(new_n497_));
  aoi21  g341(.a(new_n497_), .b(new_n332_), .c(new_n336_), .O(new_n498_));
  nand2  g342(.a(new_n320_), .b(new_n478_), .O(new_n499_));
  ...
  oai21  g346(.a(new_n502_), .b(new_n498_), .c(new_n296_), .O(new_n503_));
  aoi21  g347(.a(new_n503_), .b(new_n496_), .c(x054), .O(new_n504_));
  oai21  g348(.a(new_n304_), .b(new_n303_), .c(x030), .O(new_n505_));
  nand2  g349(.a(new_n505_), .b(new_n332_), .O(new_n506_));
  nand3  g350(.a(new_n506_), .b(new_n296_), .c(x038), .O(new_n507_));
  inv1   g351(.a(new_n507_), .O(new_n508_));
  oai21  g352(.a(new_n508_), .b(new_n504_), .c(new_n328_), .O(new_n509_));
  ...
  oai21  g358(.a(new_n514_), .b(x046), .c(new_n174_), .O(z14));
  zero   g359(.O(z18));
  zero   g360(.O(z19));
  zero   g361(.O(z20));
  zero   g362(.O(z23));
  zero   g363(.O(z26));
  nor2   g364(.a(x078), .b(new_n172_), .O(z15));
  nor2   g365(.a(x078), .b(new_n172_), .O(z16));
  nor2   g366(.a(x078), .b(new_n172_), .O(z17));
  nor2   g367(.a(x078), .b(new_n172_), .O(z21));
  nor2   g368(.a(x078), .b(new_n172_), .O(z22));
  nor2   g369(.a(x078), .b(new_n172_), .O(z24));
  nor2   g370(.a(x078), .b(new_n172_), .O(z25));
  nor2   g371(.a(x078), .b(new_n172_), .O(z27));
endmodule
