// Benchmark "FAU" written by ABC on Sat Aug 22 02:45:18 2020
...
module FAU ( 
  ...
  aoi21  g183(.a(new_n339_), .b(new_n337_), .c(new_n173_), .O(new_n340_));
  ...
  oai22  g189(.a(new_n173_), .b(new_n312_), .c(new_n299_), .d(new_n322_), .O(new_n346_));
  nand3  g190(.a(new_n346_), .b(new_n334_), .c(new_n335_), .O(new_n347_));
  aoi22  g191(.a(new_n173_), .b(new_n322_), .c(new_n299_), .d(new_n312_), .O(new_n348_));
  ...
  oai21  g243(.a(new_n399_), .b(x040), .c(new_n175_), .O(z08));
  ...
  nand3  g251(.a(new_n407_), .b(new_n175_), .c(new_n401_), .O(new_n408_));
  ...
  nand3  g260(.a(new_n416_), .b(new_n175_), .c(new_n410_), .O(new_n417_));
  ...
  oai21  g269(.a(new_n425_), .b(x043), .c(new_n175_), .O(z11));
  ...
  nand3  g320(.a(new_n476_), .b(new_n175_), .c(new_n436_), .O(new_n477_));
  inv1   g321(.a(new_n477_), .O(z13));
  nand2  g322(.a(x022), .b(x014), .O(new_n479_));
  nand2  g323(.a(new_n479_), .b(x030), .O(new_n480_));
  aoi21  g324(.a(new_n480_), .b(new_n330_), .c(x086), .O(new_n481_));
  oai21  g325(.a(new_n481_), .b(x054), .c(new_n173_), .O(new_n482_));
  oai21  g326(.a(x063), .b(new_n299_), .c(new_n482_), .O(new_n483_));
  nand2  g327(.a(new_n483_), .b(x038), .O(new_n484_));
  aoi21  g328(.a(x070), .b(x038), .c(new_n298_), .O(new_n485_));
  nand2  g329(.a(new_n303_), .b(x030), .O(new_n486_));
  aoi21  g330(.a(new_n486_), .b(new_n301_), .c(x086), .O(new_n487_));
  oai22  g331(.a(new_n487_), .b(new_n485_), .c(x118), .d(x110), .O(new_n488_));
  ...
  nand2  g336(.a(new_n479_), .b(x006), .O(new_n493_));
  oai21  g337(.a(x086), .b(new_n334_), .c(new_n493_), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n338_), .O(new_n495_));
  nor2   g339(.a(x126), .b(x102), .O(new_n496_));
  nand4  g340(.a(new_n479_), .b(new_n303_), .c(new_n326_), .d(x030), .O(new_n497_));
  inv1   g341(.a(x094), .O(new_n498_));
  nand3  g342(.a(new_n498_), .b(new_n334_), .c(x006), .O(new_n499_));
  aoi21  g343(.a(new_n499_), .b(new_n497_), .c(new_n496_), .O(new_n500_));
  oai21  g344(.a(new_n317_), .b(x118), .c(new_n300_), .O(new_n501_));
  nand2  g345(.a(new_n501_), .b(new_n335_), .O(new_n502_));
  oai22  g346(.a(new_n308_), .b(x110), .c(new_n498_), .d(x062), .O(new_n503_));
  nand2  g347(.a(new_n503_), .b(x126), .O(new_n504_));
  aoi21  g348(.a(x030), .b(new_n322_), .c(x086), .O(new_n505_));
  nand3  g349(.a(new_n505_), .b(new_n504_), .c(new_n502_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(x006), .c(new_n500_), .O(new_n507_));
  nand4  g351(.a(new_n507_), .b(new_n495_), .c(new_n492_), .d(new_n488_), .O(new_n508_));
  nand2  g352(.a(new_n508_), .b(new_n299_), .O(new_n509_));
  ...
  nand3  g360(.a(new_n516_), .b(x078), .c(new_n172_), .O(new_n517_));
  inv1   g361(.a(new_n517_), .O(new_n518_));
  aoi21  g362(.a(new_n513_), .b(new_n173_), .c(new_n518_), .O(new_n519_));
  ...
  zero   g369(.O(z24));
  zero   g370(.O(z27));
  nor2   g371(.a(new_n173_), .b(new_n172_), .O(z15));
  nor2   g372(.a(new_n173_), .b(new_n172_), .O(z16));
  nor2   g373(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g374(.a(new_n173_), .b(new_n172_), .O(z23));
  nor2   g375(.a(new_n173_), .b(new_n172_), .O(z25));
  nor2   g376(.a(new_n173_), .b(new_n172_), .O(z26));
endmodule
