...
module FAU ( 
  ...
  inv1   g015(.a(x121), .O(new_n172_));
  nor2   g016(.a(new_n172_), .b(x114), .O(z07));
  ...
  zero   g371(.O(z26));
  zero   g372(.O(z27));
  nor2   g373(.a(new_n172_), .b(x114), .O(z15));
  nor2   g374(.a(new_n172_), .b(x114), .O(z16));
  nor2   g375(.a(new_n172_), .b(x114), .O(z19));
  nor2   g376(.a(new_n172_), .b(x114), .O(z22));
  nor2   g377(.a(new_n172_), .b(x114), .O(z23));
  nor2   g378(.a(new_n172_), .b(x114), .O(z24));
  nor2   g379(.a(new_n172_), .b(x114), .O(z25));
endmodule
