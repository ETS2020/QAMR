// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:23 2020
...
module FAU ( 
  ...
  aoi21  g146(.a(new_n302_), .b(x054), .c(new_n159_), .O(new_n303_));
  ...
  and2   g195(.a(new_n351_), .b(new_n172_), .O(new_n352_));
  aoi21  g196(.a(new_n348_), .b(x008), .c(new_n352_), .O(new_n353_));
  ...
  aoi21  g323(.a(new_n479_), .b(new_n326_), .c(x086), .O(new_n480_));
  oai21  g324(.a(new_n480_), .b(x054), .c(new_n172_), .O(new_n481_));
  oai21  g325(.a(new_n477_), .b(new_n159_), .c(new_n481_), .O(new_n482_));
  nand2  g326(.a(new_n482_), .b(x038), .O(new_n483_));
  nand3  g327(.a(x070), .b(new_n477_), .c(x022), .O(new_n484_));
  nand3  g328(.a(x086), .b(new_n297_), .c(x006), .O(new_n485_));
  nand3  g329(.a(new_n485_), .b(new_n484_), .c(new_n338_), .O(new_n486_));
  nand3  g330(.a(new_n486_), .b(x078), .c(x008), .O(new_n487_));
  inv1   g331(.a(new_n487_), .O(new_n488_));
  aoi21  g332(.a(x070), .b(x038), .c(new_n343_), .O(new_n489_));
  nand2  g333(.a(new_n299_), .b(x030), .O(new_n490_));
  aoi21  g334(.a(new_n490_), .b(new_n298_), .c(x086), .O(new_n491_));
  oai22  g335(.a(new_n491_), .b(new_n489_), .c(x118), .d(x110), .O(new_n492_));
  nand3  g336(.a(new_n319_), .b(x070), .c(x030), .O(new_n493_));
  nand3  g337(.a(x102), .b(new_n316_), .c(x006), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(new_n493_), .O(new_n495_));
  nand2  g339(.a(new_n495_), .b(new_n297_), .O(new_n496_));
  aoi22  g340(.a(new_n478_), .b(x006), .c(new_n319_), .d(x070), .O(new_n497_));
  or2    g341(.a(new_n497_), .b(new_n326_), .O(new_n498_));
  nor2   g342(.a(x126), .b(x102), .O(new_n499_));
  nand4  g343(.a(new_n478_), .b(new_n299_), .c(new_n319_), .d(x030), .O(new_n500_));
  inv1   g344(.a(x094), .O(new_n501_));
  nand3  g345(.a(new_n501_), .b(new_n329_), .c(x006), .O(new_n502_));
  aoi21  g346(.a(new_n502_), .b(new_n500_), .c(new_n499_), .O(new_n503_));
  oai21  g347(.a(new_n344_), .b(x118), .c(new_n333_), .O(new_n504_));
  nand2  g348(.a(new_n504_), .b(new_n330_), .O(new_n505_));
  oai22  g349(.a(new_n312_), .b(x110), .c(new_n501_), .d(x062), .O(new_n506_));
  nand2  g350(.a(new_n506_), .b(x126), .O(new_n507_));
  aoi21  g351(.a(x030), .b(new_n338_), .c(x086), .O(new_n508_));
  ...
  nand2  g355(.a(new_n511_), .b(new_n477_), .O(new_n512_));
  oai22  g356(.a(new_n319_), .b(new_n343_), .c(new_n329_), .d(new_n330_), .O(new_n513_));
  nor2   g357(.a(new_n329_), .b(x038), .O(new_n514_));
  aoi22  g358(.a(new_n514_), .b(x022), .c(new_n513_), .d(new_n338_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n512_), .O(new_n516_));
  aoi21  g360(.a(new_n516_), .b(new_n172_), .c(new_n488_), .O(new_n517_));
  aoi21  g361(.a(new_n517_), .b(new_n483_), .c(x046), .O(z14));
  zero   g362(.O(z15));
  zero   g363(.O(z16));
  zero   g364(.O(z22));
  zero   g365(.O(z23));
  zero   g366(.O(z24));
  zero   g367(.O(z26));
  nor2   g368(.a(new_n172_), .b(x008), .O(z17));
  nor2   g369(.a(new_n172_), .b(x008), .O(z18));
  nor2   g370(.a(new_n172_), .b(x008), .O(z19));
  nor2   g371(.a(new_n172_), .b(x008), .O(z20));
  nor2   g372(.a(new_n172_), .b(x008), .O(z21));
  nor2   g373(.a(new_n172_), .b(x008), .O(z25));
  nor2   g374(.a(new_n172_), .b(x008), .O(z27));
endmodule
