// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:16 2020
...
module FAU ( 
  ...
  aoi21  g147(.a(new_n303_), .b(x054), .c(x047), .O(new_n304_));
  ...
  oai21  g290(.a(new_n446_), .b(new_n444_), .c(new_n278_), .O(new_n447_));
  ...
  oai21  g311(.a(new_n467_), .b(new_n464_), .c(new_n277_), .O(new_n468_));
  ...
  aoi21  g324(.a(new_n297_), .b(x014), .c(x047), .O(new_n481_));
  ...
  nand4  g340(.a(x126), .b(new_n317_), .c(new_n298_), .d(x014), .O(new_n497_));
  inv1   g341(.a(new_n497_), .O(new_n498_));
  aoi21  g342(.a(new_n496_), .b(new_n158_), .c(new_n498_), .O(new_n499_));
  nand3  g343(.a(x086), .b(new_n298_), .c(new_n339_), .O(new_n500_));
  ...
  oai21  g353(.a(new_n509_), .b(new_n506_), .c(new_n158_), .O(new_n510_));
  ...
  nand3  g357(.a(new_n513_), .b(new_n158_), .c(x038), .O(new_n514_));
  ...
  oai22  g365(.a(new_n521_), .b(x046), .c(new_n481_), .d(new_n158_), .O(z14));
  zero   g366(.O(z18));
  zero   g367(.O(z19));
  zero   g368(.O(z20));
  zero   g369(.O(z22));
  ...
  nor2   g378(.a(new_n158_), .b(new_n157_), .O(z26));
endmodule
