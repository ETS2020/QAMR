...
module FAU ( 
  ...
  nor2   g001(.a(new_n157_), .b(x078), .O(z19));
  ...
  nor2   g155(.a(x124), .b(x054), .O(new_n312_));
  ...
  nand3  g195(.a(new_n351_), .b(new_n157_), .c(new_n298_), .O(new_n352_));
  ...
  aoi21  g323(.a(new_n480_), .b(new_n305_), .c(x124), .O(new_n481_));
  ...
  zero   g370(.O(z24));
  zero   g371(.O(z27));
  nor2   g372(.a(new_n157_), .b(x078), .O(z20));
