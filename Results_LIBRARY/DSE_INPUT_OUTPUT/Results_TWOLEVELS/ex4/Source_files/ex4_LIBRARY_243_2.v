...
module FAU ( 
  ...
  nor2   g001(.a(x092), .b(new_n157_), .O(z15));
  ...
  oai21  g207(.a(new_n364_), .b(new_n361_), .c(new_n169_), .O(new_n365_));
  ...
  nand3  g211(.a(x120), .b(new_n363_), .c(new_n168_), .O(new_n369_));
  ...
  oai21  g222(.a(new_n379_), .b(x072), .c(new_n162_), .O(new_n380_));
  nand2  g223(.a(new_n380_), .b(new_n364_), .O(new_n381_));
  nand2  g224(.a(x024), .b(new_n168_), .O(new_n382_));
  aoi21  g225(.a(new_n382_), .b(new_n356_), .c(new_n169_), .O(new_n383_));
  ...
  oai21  g229(.a(new_n386_), .b(new_n383_), .c(new_n165_), .O(new_n387_));
  ...
  nand2  g320(.a(new_n477_), .b(x030), .O(new_n478_));
  aoi21  g321(.a(new_n478_), .b(new_n329_), .c(x086), .O(new_n479_));
  oai21  g322(.a(new_n479_), .b(x054), .c(new_n157_), .O(new_n480_));
  nand2  g323(.a(x092), .b(x054), .O(new_n481_));
  ...
  nand2  g334(.a(new_n477_), .b(x006), .O(new_n492_));
  ...
  nand4  g338(.a(new_n477_), .b(new_n302_), .c(new_n325_), .d(x030), .O(new_n496_));
  ...
  nand3  g358(.a(new_n515_), .b(x092), .c(x078), .O(new_n516_));
  inv1   g359(.a(new_n516_), .O(new_n517_));
  aoi21  g360(.a(new_n512_), .b(new_n157_), .c(new_n517_), .O(new_n518_));
  ...
  zero   g366(.O(z26));
  zero   g367(.O(z27));
  nor2   g368(.a(x092), .b(new_n157_), .O(z17));
  nor2   g369(.a(x092), .b(new_n157_), .O(z19));
  nor2   g370(.a(x092), .b(new_n157_), .O(z20));
  nor2   g371(.a(x092), .b(new_n157_), .O(z21));
  nor2   g372(.a(x092), .b(new_n157_), .O(z23));
  nor2   g373(.a(x092), .b(new_n157_), .O(z24));
  nor2   g374(.a(x092), .b(new_n157_), .O(z25));
endmodule
