// Benchmark "FAU" written by ABC on Sat Aug 22 02:51:34 2020
...
module FAU ( 
  ...
  aoi21  g319(.a(x054), .b(x038), .c(x014), .O(new_n477_));
  nand3  g320(.a(x070), .b(new_n301_), .c(x022), .O(new_n478_));
  nand3  g321(.a(x086), .b(new_n312_), .c(x006), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n478_), .c(new_n477_), .O(new_n480_));
  nand3  g323(.a(new_n480_), .b(x078), .c(new_n297_), .O(new_n481_));
  inv1   g324(.a(new_n481_), .O(z14));
  zero   g325(.O(z07));
  zero   g326(.O(z18));
  zero   g327(.O(z21));
  zero   g328(.O(z23));
  zero   g329(.O(z24));
  zero   g330(.O(z25));
  nor2   g331(.a(x078), .b(x046), .O(z16));
  nor2   g332(.a(x078), .b(x046), .O(z17));
  nor2   g333(.a(x078), .b(x046), .O(z19));
  nor2   g334(.a(x078), .b(x046), .O(z20));
  nor2   g335(.a(x078), .b(x046), .O(z22));
