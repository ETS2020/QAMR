// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:09 2020
...
module FAU ( 
  ...
  inv1   g148(.a(x044), .O(new_n305_));
  nor2   g149(.a(x054), .b(new_n305_), .O(new_n306_));
  ...
  nand2  g172(.a(new_n300_), .b(new_n299_), .O(new_n329_));
  ...
  oai21  g177(.a(new_n302_), .b(new_n313_), .c(new_n329_), .O(new_n334_));
  ...
  nand3  g184(.a(new_n302_), .b(x086), .c(new_n310_), .O(new_n341_));
  ...
  aoi21  g207(.a(new_n363_), .b(new_n362_), .c(x088), .O(new_n364_));
  inv1   g208(.a(x104), .O(new_n365_));
  inv1   g209(.a(x112), .O(new_n366_));
  nand2  g210(.a(new_n366_), .b(new_n365_), .O(new_n367_));
  oai21  g211(.a(new_n367_), .b(new_n364_), .c(new_n166_), .O(new_n368_));
  oai21  g212(.a(new_n363_), .b(x104), .c(x032), .O(new_n369_));
  nand2  g213(.a(new_n369_), .b(x112), .O(new_n370_));
  oai21  g214(.a(new_n362_), .b(x056), .c(new_n365_), .O(new_n371_));
  nand3  g215(.a(x120), .b(new_n366_), .c(new_n165_), .O(new_n372_));
  nand2  g216(.a(new_n372_), .b(new_n158_), .O(new_n373_));
  aoi21  g217(.a(new_n371_), .b(new_n160_), .c(new_n373_), .O(new_n374_));
  nand4  g218(.a(new_n374_), .b(new_n370_), .c(new_n368_), .d(new_n361_), .O(new_n375_));
  nor2   g219(.a(x032), .b(new_n159_), .O(new_n376_));
  nor2   g220(.a(new_n363_), .b(x056), .O(new_n377_));
  aoi22  g221(.a(new_n377_), .b(new_n376_), .c(new_n375_), .d(new_n162_), .O(new_n378_));
  ...
  nand2  g227(.a(new_n383_), .b(new_n367_), .O(new_n384_));
  nand2  g228(.a(x024), .b(new_n165_), .O(new_n385_));
  aoi21  g229(.a(new_n385_), .b(new_n359_), .c(new_n166_), .O(new_n386_));
  nand2  g230(.a(new_n363_), .b(new_n362_), .O(new_n387_));
  nand4  g231(.a(new_n381_), .b(new_n387_), .c(new_n357_), .d(x024), .O(new_n388_));
  ...
  nand2  g235(.a(new_n357_), .b(x024), .O(new_n392_));
  nand2  g236(.a(new_n392_), .b(new_n359_), .O(new_n393_));
  ...
  oai21  g246(.a(new_n402_), .b(x040), .c(new_n173_), .O(z08));
  ...
  nand3  g254(.a(new_n410_), .b(new_n173_), .c(new_n404_), .O(new_n411_));
  ...
  nand3  g263(.a(new_n419_), .b(new_n173_), .c(new_n413_), .O(new_n420_));
  ...
  nand3  g272(.a(new_n428_), .b(new_n173_), .c(new_n422_), .O(new_n429_));
  ...
  nand2  g278(.a(x052), .b(x036), .O(new_n435_));
  aoi21  g279(.a(x076), .b(x012), .c(new_n298_), .O(new_n436_));
  nand4  g280(.a(new_n436_), .b(new_n435_), .c(new_n434_), .d(new_n432_), .O(new_n437_));
  and2   g281(.a(new_n437_), .b(new_n305_), .O(z12));
  inv1   g282(.a(x045), .O(new_n439_));
  nand2  g283(.a(x021), .b(x013), .O(new_n440_));
  oai21  g284(.a(new_n279_), .b(x029), .c(new_n440_), .O(new_n441_));
  ...
  nand2  g288(.a(new_n444_), .b(new_n276_), .O(new_n445_));
  oai21  g289(.a(new_n259_), .b(x109), .c(x037), .O(new_n446_));
  nand2  g290(.a(new_n446_), .b(x117), .O(new_n447_));
  inv1   g291(.a(x101), .O(new_n448_));
  oai21  g292(.a(new_n448_), .b(x061), .c(new_n249_), .O(new_n449_));
  ...
  nand4  g296(.a(new_n452_), .b(new_n447_), .c(new_n445_), .d(new_n441_), .O(new_n453_));
  ...
  oai21  g303(.a(new_n283_), .b(new_n241_), .c(new_n243_), .O(new_n460_));
  nand2  g304(.a(new_n460_), .b(new_n275_), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n242_), .c(new_n443_), .O(new_n462_));
  nor2   g306(.a(new_n241_), .b(x021), .O(new_n463_));
  oai21  g307(.a(new_n463_), .b(new_n279_), .c(x069), .O(new_n464_));
  inv1   g308(.a(new_n442_), .O(new_n465_));
  nand4  g309(.a(new_n465_), .b(new_n440_), .c(new_n245_), .d(x029), .O(new_n466_));
  aoi21  g310(.a(new_n466_), .b(new_n464_), .c(x077), .O(new_n467_));
  oai21  g311(.a(new_n467_), .b(new_n462_), .c(new_n240_), .O(new_n468_));
  ...
  aoi21  g320(.a(new_n472_), .b(new_n267_), .c(new_n476_), .O(new_n477_));
  nand2  g321(.a(new_n477_), .b(new_n459_), .O(new_n478_));
  nand3  g322(.a(new_n478_), .b(new_n173_), .c(new_n439_), .O(new_n479_));
  inv1   g323(.a(new_n479_), .O(z13));
  oai21  g324(.a(new_n316_), .b(x030), .c(new_n318_), .O(new_n481_));
  aoi21  g325(.a(new_n328_), .b(new_n324_), .c(x094), .O(new_n482_));
  nand2  g326(.a(new_n309_), .b(new_n308_), .O(new_n483_));
  oai21  g327(.a(new_n483_), .b(new_n482_), .c(new_n310_), .O(new_n484_));
  oai21  g328(.a(new_n328_), .b(x110), .c(x038), .O(new_n485_));
  nand2  g329(.a(new_n485_), .b(x118), .O(new_n486_));
  oai21  g330(.a(new_n324_), .b(x062), .c(new_n308_), .O(new_n487_));
  nand3  g331(.a(x126), .b(new_n309_), .c(new_n300_), .O(new_n488_));
  nand2  g332(.a(new_n488_), .b(new_n312_), .O(new_n489_));
  aoi21  g333(.a(new_n487_), .b(new_n297_), .c(new_n489_), .O(new_n490_));
  nand4  g334(.a(new_n490_), .b(new_n486_), .c(new_n484_), .d(new_n481_), .O(new_n491_));
  nand4  g335(.a(x126), .b(new_n314_), .c(new_n297_), .d(x014), .O(new_n492_));
  inv1   g336(.a(new_n492_), .O(new_n493_));
  aoi21  g337(.a(new_n491_), .b(new_n298_), .c(new_n493_), .O(new_n494_));
  nand3  g338(.a(x086), .b(new_n297_), .c(new_n299_), .O(new_n495_));
  oai21  g339(.a(new_n494_), .b(x054), .c(new_n495_), .O(new_n496_));
  aoi21  g340(.a(new_n302_), .b(x030), .c(x022), .O(new_n497_));
  oai21  g341(.a(new_n497_), .b(x078), .c(new_n299_), .O(new_n498_));
  nand2  g342(.a(new_n498_), .b(new_n483_), .O(new_n499_));
  nor2   g343(.a(x094), .b(x062), .O(new_n500_));
  nand2  g344(.a(x030), .b(new_n300_), .O(new_n501_));
  aoi21  g345(.a(new_n501_), .b(new_n500_), .c(new_n310_), .O(new_n502_));
  nand2  g346(.a(new_n328_), .b(new_n324_), .O(new_n503_));
  nand4  g347(.a(new_n503_), .b(new_n318_), .c(new_n302_), .d(x030), .O(new_n504_));
  inv1   g348(.a(new_n504_), .O(new_n505_));
  oai21  g349(.a(new_n505_), .b(new_n502_), .c(new_n298_), .O(new_n506_));
  aoi21  g350(.a(new_n506_), .b(new_n499_), .c(x054), .O(new_n507_));
  oai21  g351(.a(new_n319_), .b(new_n313_), .c(new_n500_), .O(new_n508_));
  nand3  g352(.a(new_n508_), .b(new_n298_), .c(x038), .O(new_n509_));
  inv1   g353(.a(new_n509_), .O(new_n510_));
  oai21  g354(.a(new_n510_), .b(new_n507_), .c(new_n312_), .O(new_n511_));
  ...
  and2   g358(.a(new_n514_), .b(new_n513_), .O(new_n515_));
  nand2  g359(.a(new_n515_), .b(new_n511_), .O(new_n516_));
  ...
  zero   g365(.O(z23));
  zero   g366(.O(z24));
  nor2   g367(.a(x078), .b(x044), .O(z15));
  nor2   g368(.a(x078), .b(x044), .O(z17));
  nor2   g369(.a(x078), .b(x044), .O(z18));
  nor2   g370(.a(x078), .b(x044), .O(z19));
  nor2   g371(.a(x078), .b(x044), .O(z22));
  nor2   g372(.a(x078), .b(x044), .O(z25));
  nor2   g373(.a(x078), .b(x044), .O(z26));
  nor2   g374(.a(x078), .b(x044), .O(z27));
endmodule
