// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:59 2020
...
module FAU ( 
  ...
  aoi22  g294(.a(new_n246_), .b(new_n244_), .c(new_n245_), .d(new_n243_), .O(new_n451_));
  nand3  g295(.a(new_n270_), .b(new_n242_), .c(new_n246_), .O(new_n452_));
  ...
  oai21  g302(.a(x126), .b(new_n263_), .c(new_n329_), .O(new_n459_));
  aoi21  g303(.a(x069), .b(x037), .c(new_n241_), .O(new_n460_));
  nand2  g304(.a(new_n253_), .b(x029), .O(new_n461_));
  aoi21  g305(.a(new_n461_), .b(new_n279_), .c(x085), .O(new_n462_));
  oai21  g306(.a(new_n462_), .b(new_n460_), .c(new_n246_), .O(new_n463_));
  oai21  g307(.a(x085), .b(new_n243_), .c(new_n463_), .O(new_n464_));
  nand2  g308(.a(new_n464_), .b(new_n459_), .O(new_n465_));
  nand2  g309(.a(x021), .b(x013), .O(new_n466_));
  nand3  g310(.a(new_n269_), .b(new_n268_), .c(new_n267_), .O(new_n467_));
  nand2  g311(.a(new_n467_), .b(new_n466_), .O(new_n468_));
  nand2  g312(.a(new_n277_), .b(new_n276_), .O(new_n469_));
  nand3  g313(.a(new_n469_), .b(new_n269_), .c(new_n249_), .O(new_n470_));
  nand3  g314(.a(x101), .b(new_n268_), .c(new_n244_), .O(new_n471_));
  nand3  g315(.a(x125), .b(new_n329_), .c(new_n279_), .O(new_n472_));
  nand4  g316(.a(new_n472_), .b(new_n471_), .c(new_n470_), .d(new_n468_), .O(new_n473_));
  nand4  g317(.a(x125), .b(new_n268_), .c(new_n244_), .d(x013), .O(new_n474_));
  inv1   g318(.a(new_n474_), .O(new_n475_));
  aoi21  g319(.a(new_n473_), .b(new_n246_), .c(new_n475_), .O(new_n476_));
  nand3  g320(.a(new_n469_), .b(new_n466_), .c(new_n253_), .O(new_n477_));
  oai21  g321(.a(new_n249_), .b(x021), .c(new_n477_), .O(new_n478_));
  nand4  g322(.a(new_n478_), .b(new_n242_), .c(new_n246_), .d(x029), .O(new_n479_));
  oai21  g323(.a(new_n476_), .b(new_n241_), .c(new_n479_), .O(new_n480_));
  nand2  g324(.a(new_n480_), .b(new_n157_), .O(new_n481_));
  nor2   g325(.a(new_n277_), .b(new_n329_), .O(new_n482_));
  nand4  g326(.a(new_n482_), .b(new_n263_), .c(new_n246_), .d(x005), .O(new_n483_));
  nand3  g327(.a(new_n483_), .b(new_n481_), .c(new_n465_), .O(new_n484_));
  nand3  g328(.a(new_n466_), .b(new_n157_), .c(new_n242_), .O(new_n485_));
  nor4   g329(.a(new_n485_), .b(x077), .c(new_n244_), .d(new_n267_), .O(new_n486_));
  aoi21  g330(.a(new_n484_), .b(new_n245_), .c(new_n486_), .O(new_n487_));
  aoi21  g331(.a(new_n487_), .b(new_n458_), .c(x045), .O(z13));
  oai22  g332(.a(new_n333_), .b(x030), .c(new_n319_), .d(new_n327_), .O(new_n489_));
  aoi21  g333(.a(new_n157_), .b(new_n347_), .c(x094), .O(new_n490_));
  ...
  oai21  g337(.a(new_n157_), .b(x110), .c(x038), .O(new_n494_));
  nand2  g338(.a(new_n494_), .b(x118), .O(new_n495_));
  oai21  g339(.a(new_n347_), .b(x062), .c(new_n491_), .O(new_n496_));
  nand3  g340(.a(x126), .b(new_n357_), .c(new_n319_), .O(new_n497_));
  ...
  nand2  g355(.a(new_n157_), .b(new_n347_), .O(new_n512_));
  ...
  oai21  g361(.a(new_n319_), .b(new_n327_), .c(x030), .O(new_n518_));
  ...
  zero   g378(.O(z24));
  zero   g379(.O(z26));
  nor2   g380(.a(new_n157_), .b(x117), .O(z17));
  nor2   g381(.a(new_n157_), .b(x117), .O(z19));
  nor2   g382(.a(new_n157_), .b(x117), .O(z21));
  nor2   g383(.a(new_n157_), .b(x117), .O(z23));
  nor2   g384(.a(new_n157_), .b(x117), .O(z25));
  nor2   g385(.a(new_n157_), .b(x117), .O(z27));
endmodule
