// Benchmark "FAU" written by ABC on Sat Aug 22 02:47:24 2020
...
module FAU ( 
  ...
  nand3  g149(.a(new_n305_), .b(x086), .c(x078), .O(new_n306_));
  nand2  g150(.a(new_n306_), .b(x054), .O(new_n307_));
  nand2  g151(.a(new_n307_), .b(new_n300_), .O(new_n308_));
  nand2  g152(.a(new_n302_), .b(new_n299_), .O(new_n309_));
  nand3  g153(.a(new_n309_), .b(new_n308_), .c(new_n304_), .O(new_n310_));
  nand2  g154(.a(new_n310_), .b(new_n174_), .O(new_n311_));
  nand2  g155(.a(x118), .b(x110), .O(new_n312_));
  inv1   g156(.a(x070), .O(new_n313_));
  aoi21  g157(.a(new_n313_), .b(new_n300_), .c(x006), .O(new_n314_));
  nor2   g158(.a(x094), .b(x062), .O(new_n315_));
  nor3   g159(.a(new_n315_), .b(new_n298_), .c(x030), .O(new_n316_));
  oai21  g160(.a(new_n316_), .b(new_n314_), .c(x126), .O(new_n317_));
  nand2  g161(.a(x086), .b(new_n172_), .O(new_n318_));
  aoi21  g162(.a(new_n318_), .b(new_n317_), .c(new_n302_), .O(new_n319_));
  inv1   g163(.a(x126), .O(new_n320_));
  nor3   g164(.a(new_n320_), .b(new_n298_), .c(x014), .O(new_n321_));
  oai21  g165(.a(new_n321_), .b(new_n319_), .c(new_n312_), .O(new_n322_));
  inv1   g166(.a(x102), .O(new_n323_));
  nand2  g167(.a(x126), .b(new_n323_), .O(new_n324_));
  oai21  g168(.a(x126), .b(x022), .c(new_n324_), .O(new_n325_));
  inv1   g169(.a(x062), .O(new_n326_));
  inv1   g170(.a(x094), .O(new_n327_));
  oai22  g171(.a(new_n327_), .b(new_n313_), .c(new_n326_), .d(new_n300_), .O(new_n328_));
  nand2  g172(.a(new_n328_), .b(new_n297_), .O(new_n329_));
  nand2  g173(.a(new_n316_), .b(x014), .O(new_n330_));
  nand2  g174(.a(new_n330_), .b(new_n329_), .O(new_n331_));
  nand2  g175(.a(new_n331_), .b(new_n325_), .O(new_n332_));
  inv1   g176(.a(x030), .O(new_n333_));
  oai22  g177(.a(new_n326_), .b(new_n333_), .c(x022), .d(x014), .O(new_n334_));
  nand2  g178(.a(new_n327_), .b(x022), .O(new_n335_));
  aoi21  g179(.a(new_n335_), .b(new_n334_), .c(x006), .O(new_n336_));
  oai21  g180(.a(new_n315_), .b(x102), .c(x070), .O(new_n337_));
  nand3  g181(.a(new_n337_), .b(new_n333_), .c(x022), .O(new_n338_));
  nand2  g182(.a(new_n305_), .b(new_n313_), .O(new_n339_));
  aoi21  g183(.a(new_n339_), .b(new_n338_), .c(new_n298_), .O(new_n340_));
  oai21  g184(.a(new_n340_), .b(new_n336_), .c(x126), .O(new_n341_));
  nand4  g185(.a(new_n327_), .b(new_n172_), .c(x014), .d(new_n297_), .O(new_n342_));
  nand3  g186(.a(new_n342_), .b(new_n341_), .c(new_n332_), .O(new_n343_));
  nand2  g187(.a(new_n343_), .b(x078), .O(new_n344_));
  nand3  g188(.a(new_n313_), .b(new_n172_), .c(x014), .O(new_n345_));
  nand3  g189(.a(new_n345_), .b(new_n344_), .c(new_n322_), .O(new_n346_));
  aoi21  g190(.a(new_n172_), .b(new_n299_), .c(new_n320_), .O(new_n347_));
  nand4  g191(.a(new_n347_), .b(x086), .c(new_n300_), .d(new_n333_), .O(new_n348_));
  nand3  g192(.a(new_n313_), .b(x038), .c(new_n172_), .O(new_n349_));
  aoi21  g193(.a(new_n349_), .b(new_n348_), .c(new_n302_), .O(new_n350_));
  aoi21  g194(.a(new_n346_), .b(x054), .c(new_n350_), .O(new_n351_));
  aoi21  g195(.a(new_n351_), .b(new_n311_), .c(new_n296_), .O(z06));
  ...
  oai21  g211(.a(new_n359_), .b(x056), .c(new_n368_), .O(new_n369_));
  ...
  nand4  g216(.a(new_n373_), .b(new_n367_), .c(new_n365_), .d(new_n358_), .O(new_n374_));
  nor2   g217(.a(x032), .b(new_n159_), .O(new_n375_));
  nor2   g218(.a(new_n360_), .b(x056), .O(new_n376_));
  ...
  inv1   g222(.a(new_n363_), .O(new_n380_));
  ...
  aoi21  g228(.a(new_n385_), .b(new_n356_), .c(new_n166_), .O(new_n386_));
  nand4  g229(.a(new_n381_), .b(new_n361_), .c(new_n354_), .d(x024), .O(new_n387_));
  inv1   g230(.a(new_n387_), .O(new_n388_));
  oai21  g231(.a(new_n388_), .b(new_n386_), .c(new_n162_), .O(new_n389_));
  aoi21  g232(.a(new_n389_), .b(new_n384_), .c(x048), .O(new_n390_));
  ...
  oai21  g237(.a(new_n394_), .b(new_n390_), .c(new_n158_), .O(new_n395_));
  ...
  aoi21  g242(.a(new_n379_), .b(x000), .c(new_n399_), .O(new_n400_));
  oai21  g243(.a(new_n400_), .b(x040), .c(new_n174_), .O(z08));
  ...
  oai21  g251(.a(new_n408_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai21  g267(.a(new_n424_), .b(x043), .c(new_n174_), .O(z11));
  ...
  oai21  g275(.a(new_n432_), .b(x044), .c(new_n174_), .O(z12));
  ...
  oai21  g297(.a(new_n284_), .b(new_n242_), .c(new_n244_), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n276_), .O(new_n456_));
  aoi21  g299(.a(new_n456_), .b(new_n243_), .c(new_n438_), .O(new_n457_));
  nor2   g300(.a(new_n242_), .b(x021), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(new_n280_), .c(x069), .O(new_n459_));
  nand2  g302(.a(new_n260_), .b(new_n443_), .O(new_n460_));
  nand4  g303(.a(new_n460_), .b(new_n435_), .c(new_n246_), .d(x029), .O(new_n461_));
  aoi21  g304(.a(new_n461_), .b(new_n459_), .c(x077), .O(new_n462_));
  oai21  g305(.a(new_n462_), .b(new_n457_), .c(new_n241_), .O(new_n463_));
  nand2  g306(.a(new_n435_), .b(x029), .O(new_n464_));
  ...
  nand2  g310(.a(new_n467_), .b(new_n268_), .O(new_n468_));
  ...
  nand4  g314(.a(new_n471_), .b(new_n470_), .c(new_n468_), .d(new_n454_), .O(new_n472_));
  nand3  g315(.a(new_n472_), .b(new_n174_), .c(new_n434_), .O(new_n473_));
  inv1   g316(.a(new_n473_), .O(z13));
  oai22  g317(.a(x078), .b(x054), .c(x038), .d(x014), .O(new_n475_));
  nand3  g318(.a(new_n475_), .b(x086), .c(x006), .O(new_n476_));
  nor3   g319(.a(new_n315_), .b(x086), .c(x078), .O(new_n477_));
  oai21  g320(.a(new_n477_), .b(x054), .c(x038), .O(new_n478_));
  nand2  g321(.a(x078), .b(x014), .O(new_n479_));
  nand3  g322(.a(new_n479_), .b(new_n478_), .c(new_n476_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n174_), .O(new_n481_));
  nand2  g324(.a(x070), .b(x038), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(x006), .O(new_n483_));
  nand3  g326(.a(new_n305_), .b(new_n298_), .c(x030), .O(new_n484_));
  aoi21  g327(.a(new_n484_), .b(new_n483_), .c(x078), .O(new_n485_));
  nor2   g328(.a(x086), .b(new_n299_), .O(new_n486_));
  oai21  g329(.a(new_n486_), .b(new_n485_), .c(new_n172_), .O(new_n487_));
  nand4  g330(.a(x126), .b(new_n298_), .c(new_n302_), .d(x022), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n487_), .O(new_n489_));
  oai21  g332(.a(x118), .b(x110), .c(new_n489_), .O(new_n490_));
  oai21  g333(.a(x086), .b(new_n313_), .c(new_n297_), .O(new_n491_));
  nand2  g334(.a(new_n315_), .b(new_n333_), .O(new_n492_));
  nand2  g335(.a(new_n492_), .b(new_n491_), .O(new_n493_));
  nand2  g336(.a(new_n320_), .b(new_n323_), .O(new_n494_));
  nand4  g337(.a(new_n494_), .b(new_n305_), .c(new_n298_), .d(x030), .O(new_n495_));
  nand2  g338(.a(new_n482_), .b(x102), .O(new_n496_));
  oai21  g339(.a(new_n320_), .b(x118), .c(new_n496_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(x006), .O(new_n498_));
  nand3  g341(.a(new_n498_), .b(new_n495_), .c(new_n493_), .O(new_n499_));
  nand2  g342(.a(new_n499_), .b(new_n172_), .O(new_n500_));
  inv1   g343(.a(x110), .O(new_n501_));
  nand2  g344(.a(new_n501_), .b(x006), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n484_), .c(x014), .O(new_n503_));
  nand2  g346(.a(x094), .b(new_n326_), .O(new_n504_));
  nand2  g347(.a(new_n327_), .b(new_n313_), .O(new_n505_));
  aoi21  g348(.a(new_n505_), .b(new_n504_), .c(new_n297_), .O(new_n506_));
  oai21  g349(.a(new_n506_), .b(new_n503_), .c(x126), .O(new_n507_));
  nand2  g350(.a(new_n507_), .b(new_n500_), .O(new_n508_));
  nand2  g351(.a(new_n508_), .b(new_n302_), .O(new_n509_));
  nand4  g352(.a(x126), .b(x070), .c(x022), .d(new_n299_), .O(new_n510_));
  nand3  g353(.a(new_n510_), .b(new_n509_), .c(new_n490_), .O(new_n511_));
  nand4  g354(.a(new_n298_), .b(x038), .c(x030), .d(new_n172_), .O(new_n512_));
  nand4  g355(.a(x126), .b(x070), .c(new_n300_), .d(x022), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n512_), .c(x078), .O(new_n514_));
  aoi21  g357(.a(new_n511_), .b(new_n301_), .c(new_n514_), .O(new_n515_));
  aoi21  g358(.a(new_n515_), .b(new_n481_), .c(x046), .O(z14));
  zero   g359(.O(z07));
  zero   g360(.O(z16));
  zero   g361(.O(z17));
  zero   g362(.O(z18));
  ...
  nor2   g368(.a(x126), .b(new_n172_), .O(z21));
  nor2   g369(.a(x126), .b(new_n172_), .O(z22));
  nor2   g370(.a(x126), .b(new_n172_), .O(z23));
  nor2   g371(.a(x126), .b(new_n172_), .O(z25));
endmodule
