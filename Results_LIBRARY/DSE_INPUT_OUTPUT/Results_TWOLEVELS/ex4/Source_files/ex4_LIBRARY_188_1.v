// Benchmark "FAU" written by ABC on Sat Aug 22 02:49:36 2020
...
module FAU ( 
  ...
  nor2   g016(.a(new_n172_), .b(x046), .O(z17));
  ...
  oai21  g244(.a(new_n401_), .b(x041), .c(new_n174_), .O(z09));
  ...
  oai21  g252(.a(new_n409_), .b(x042), .c(new_n174_), .O(z10));
  oai22  g253(.a(x075), .b(x051), .c(x035), .d(x011), .O(new_n411_));
  nand3  g254(.a(new_n411_), .b(x083), .c(x003), .O(new_n412_));
  oai22  g255(.a(x075), .b(x035), .c(x051), .d(x011), .O(new_n413_));
  nand3  g256(.a(new_n413_), .b(x067), .c(x019), .O(new_n414_));
  aoi22  g257(.a(x075), .b(x011), .c(x051), .d(x035), .O(new_n415_));
  nand3  g258(.a(new_n415_), .b(new_n414_), .c(new_n412_), .O(new_n416_));
  inv1   g259(.a(new_n416_), .O(new_n417_));
  oai21  g260(.a(new_n417_), .b(x043), .c(new_n174_), .O(z11));
  oai22  g261(.a(x076), .b(x052), .c(x036), .d(x012), .O(new_n419_));
  nand3  g262(.a(new_n419_), .b(x084), .c(x004), .O(new_n420_));
  oai22  g263(.a(x076), .b(x036), .c(x052), .d(x012), .O(new_n421_));
  nand3  g264(.a(new_n421_), .b(x068), .c(x020), .O(new_n422_));
  aoi22  g265(.a(x076), .b(x012), .c(x052), .d(x036), .O(new_n423_));
  nand3  g266(.a(new_n423_), .b(new_n422_), .c(new_n420_), .O(new_n424_));
  inv1   g267(.a(new_n424_), .O(new_n425_));
  oai21  g268(.a(new_n425_), .b(x044), .c(new_n174_), .O(z12));
  oai22  g269(.a(new_n280_), .b(x029), .c(new_n244_), .d(new_n243_), .O(new_n427_));
  inv1   g270(.a(x101), .O(new_n428_));
  aoi21  g271(.a(new_n260_), .b(new_n428_), .c(x093), .O(new_n429_));
  nand2  g272(.a(new_n251_), .b(new_n250_), .O(new_n430_));
  oai21  g273(.a(new_n430_), .b(new_n429_), .c(new_n277_), .O(new_n431_));
  oai21  g274(.a(new_n260_), .b(x109), .c(x037), .O(new_n432_));
  nand2  g275(.a(new_n432_), .b(x117), .O(new_n433_));
  oai21  g276(.a(new_n428_), .b(x061), .c(new_n250_), .O(new_n434_));
  nand3  g277(.a(x125), .b(new_n251_), .c(new_n244_), .O(new_n435_));
  nand2  g278(.a(new_n435_), .b(new_n268_), .O(new_n436_));
  aoi21  g279(.a(new_n434_), .b(new_n255_), .c(new_n436_), .O(new_n437_));
  nand4  g280(.a(new_n437_), .b(new_n433_), .c(new_n431_), .d(new_n427_), .O(new_n438_));
  nand4  g281(.a(x125), .b(new_n258_), .c(new_n255_), .d(x013), .O(new_n439_));
  inv1   g282(.a(new_n439_), .O(new_n440_));
  aoi21  g283(.a(new_n438_), .b(new_n276_), .c(new_n440_), .O(new_n441_));
  nand3  g284(.a(x085), .b(new_n255_), .c(new_n243_), .O(new_n442_));
  oai21  g285(.a(new_n441_), .b(x053), .c(new_n442_), .O(new_n443_));
  aoi21  g286(.a(new_n246_), .b(x029), .c(x021), .O(new_n444_));
  oai21  g287(.a(new_n444_), .b(x077), .c(new_n243_), .O(new_n445_));
  nand2  g288(.a(new_n445_), .b(new_n430_), .O(new_n446_));
  nand2  g289(.a(x029), .b(new_n244_), .O(new_n447_));
  aoi21  g290(.a(new_n447_), .b(new_n272_), .c(new_n277_), .O(new_n448_));
  nand2  g291(.a(new_n260_), .b(new_n428_), .O(new_n449_));
  aoi22  g292(.a(x093), .b(x061), .c(x021), .d(x013), .O(new_n450_));
  nand3  g293(.a(new_n450_), .b(new_n449_), .c(x029), .O(new_n451_));
  inv1   g294(.a(new_n451_), .O(new_n452_));
  oai21  g295(.a(new_n452_), .b(new_n448_), .c(new_n276_), .O(new_n453_));
  aoi21  g296(.a(new_n453_), .b(new_n446_), .c(x053), .O(new_n454_));
  oai21  g297(.a(new_n244_), .b(new_n243_), .c(x029), .O(new_n455_));
  nand2  g298(.a(new_n455_), .b(new_n272_), .O(new_n456_));
  nand3  g299(.a(new_n456_), .b(new_n276_), .c(x037), .O(new_n457_));
  inv1   g300(.a(new_n457_), .O(new_n458_));
  oai21  g301(.a(new_n458_), .b(new_n454_), .c(new_n268_), .O(new_n459_));
  ...
  nand3  g305(.a(new_n462_), .b(new_n461_), .c(new_n459_), .O(new_n463_));
  aoi21  g306(.a(new_n443_), .b(x005), .c(new_n463_), .O(new_n464_));
  oai21  g307(.a(new_n464_), .b(x045), .c(new_n174_), .O(z13));
  inv1   g308(.a(x118), .O(new_n466_));
  oai21  g309(.a(new_n306_), .b(new_n304_), .c(x006), .O(new_n467_));
  nand2  g310(.a(new_n301_), .b(x030), .O(new_n468_));
  nand2  g311(.a(new_n468_), .b(new_n299_), .O(new_n469_));
  nand2  g312(.a(new_n469_), .b(new_n312_), .O(new_n470_));
  aoi22  g313(.a(new_n470_), .b(new_n467_), .c(new_n466_), .d(new_n314_), .O(new_n471_));
  nand3  g314(.a(new_n312_), .b(x070), .c(x030), .O(new_n472_));
  nand3  g315(.a(x102), .b(new_n305_), .c(x006), .O(new_n473_));
  nand2  g316(.a(new_n473_), .b(new_n472_), .O(new_n474_));
  nand2  g317(.a(new_n474_), .b(new_n304_), .O(new_n475_));
  nand2  g318(.a(new_n325_), .b(x006), .O(new_n476_));
  oai21  g319(.a(x086), .b(new_n306_), .c(new_n476_), .O(new_n477_));
  nand2  g320(.a(new_n477_), .b(new_n329_), .O(new_n478_));
  nand4  g321(.a(new_n325_), .b(new_n301_), .c(new_n312_), .d(x030), .O(new_n479_));
  nand3  g322(.a(new_n307_), .b(new_n306_), .c(x006), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n479_), .O(new_n481_));
  oai21  g324(.a(x126), .b(x102), .c(new_n481_), .O(new_n482_));
  nand2  g325(.a(x126), .b(new_n466_), .O(new_n483_));
  aoi21  g326(.a(new_n483_), .b(new_n298_), .c(x022), .O(new_n484_));
  nand2  g327(.a(x030), .b(new_n343_), .O(new_n485_));
  nand3  g328(.a(x126), .b(x094), .c(new_n305_), .O(new_n486_));
  nand3  g329(.a(new_n486_), .b(new_n485_), .c(new_n312_), .O(new_n487_));
  oai21  g330(.a(new_n487_), .b(new_n484_), .c(x006), .O(new_n488_));
  nand4  g331(.a(new_n488_), .b(new_n482_), .c(new_n478_), .d(new_n475_), .O(new_n489_));
  oai21  g332(.a(new_n489_), .b(new_n471_), .c(new_n340_), .O(new_n490_));
  nand3  g333(.a(x126), .b(new_n314_), .c(x038), .O(new_n491_));
  aoi21  g334(.a(new_n491_), .b(new_n312_), .c(new_n297_), .O(new_n492_));
  nand3  g335(.a(new_n312_), .b(x038), .c(x030), .O(new_n493_));
  oai21  g336(.a(new_n306_), .b(new_n336_), .c(new_n493_), .O(new_n494_));
  oai21  g337(.a(new_n494_), .b(new_n492_), .c(new_n343_), .O(new_n495_));
  nand2  g338(.a(x030), .b(new_n336_), .O(new_n496_));
  aoi21  g339(.a(new_n496_), .b(new_n323_), .c(x086), .O(new_n497_));
  oai21  g340(.a(new_n497_), .b(x054), .c(x038), .O(new_n498_));
  nor2   g341(.a(new_n306_), .b(x038), .O(new_n499_));
  aoi21  g342(.a(new_n499_), .b(x022), .c(x078), .O(new_n500_));
  nand3  g343(.a(new_n500_), .b(new_n498_), .c(new_n495_), .O(new_n501_));
  inv1   g344(.a(new_n501_), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n490_), .c(x046), .O(z14));
  zero   g346(.O(z07));
  zero   g347(.O(z15));
  zero   g348(.O(z16));
  zero   g349(.O(z21));
  zero   g350(.O(z25));
  nor2   g351(.a(new_n172_), .b(x046), .O(z18));
  nor2   g352(.a(new_n172_), .b(x046), .O(z19));
  nor2   g353(.a(new_n172_), .b(x046), .O(z20));
  nor2   g354(.a(new_n172_), .b(x046), .O(z22));
  nor2   g355(.a(new_n172_), .b(x046), .O(z23));
  nor2   g356(.a(new_n172_), .b(x046), .O(z24));
  nor2   g357(.a(new_n172_), .b(x046), .O(z26));
  nor2   g358(.a(new_n172_), .b(x046), .O(z27));
endmodule
