...
module FAU ( 
  ...
  oai22  g073(.a(new_n172_), .b(new_n229_), .c(new_n228_), .d(new_n227_), .O(new_n230_));
  nand3  g074(.a(new_n230_), .b(new_n226_), .c(new_n225_), .O(new_n231_));
  inv1   g075(.a(x020), .O(new_n232_));
  inv1   g076(.a(x068), .O(new_n233_));
  oai22  g077(.a(new_n172_), .b(new_n228_), .c(new_n229_), .d(new_n227_), .O(new_n234_));
  nand3  g078(.a(new_n234_), .b(new_n233_), .c(new_n232_), .O(new_n235_));
  aoi22  g079(.a(new_n172_), .b(new_n227_), .c(new_n229_), .d(new_n228_), .O(new_n236_));
  ...
  oai21  g266(.a(new_n422_), .b(x043), .c(new_n175_), .O(z11));
  ...
  oai21  g318(.a(x046), .b(new_n300_), .c(new_n172_), .O(new_n475_));
  ...
  aoi21  g334(.a(new_n488_), .b(new_n173_), .c(new_n490_), .O(new_n491_));
  ...
  oai21  g346(.a(new_n502_), .b(new_n498_), .c(new_n173_), .O(new_n503_));
  ...
  nand3  g350(.a(new_n506_), .b(new_n173_), .c(x038), .O(new_n507_));
  ...
  nor2   g367(.a(new_n173_), .b(new_n172_), .O(z21));
  nor2   g368(.a(new_n173_), .b(new_n172_), .O(z22));
  nor2   g369(.a(new_n173_), .b(new_n172_), .O(z24));
  nor2   g370(.a(new_n173_), .b(new_n172_), .O(z25));
