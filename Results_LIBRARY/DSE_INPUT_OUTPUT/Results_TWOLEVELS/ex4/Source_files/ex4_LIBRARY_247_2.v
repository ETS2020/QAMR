...
module FAU ( 
  ...
  inv1   g320(.a(new_n311_), .O(new_n478_));
  oai21  g321(.a(new_n307_), .b(x030), .c(new_n478_), .O(new_n479_));
  nand2  g322(.a(new_n320_), .b(new_n316_), .O(new_n480_));
  nand2  g323(.a(new_n480_), .b(new_n306_), .O(new_n481_));
  nor2   g324(.a(x118), .b(x110), .O(new_n482_));
  nand2  g325(.a(new_n482_), .b(new_n481_), .O(new_n483_));
  nand2  g326(.a(new_n483_), .b(new_n301_), .O(new_n484_));
  oai21  g327(.a(new_n320_), .b(x110), .c(x038), .O(new_n485_));
  nand2  g328(.a(new_n485_), .b(x118), .O(new_n486_));
  oai21  g329(.a(new_n316_), .b(x062), .c(new_n298_), .O(new_n487_));
  nand3  g330(.a(x126), .b(new_n299_), .c(new_n310_), .O(new_n488_));
  nand2  g331(.a(new_n488_), .b(new_n303_), .O(new_n489_));
  aoi21  g332(.a(new_n487_), .b(new_n300_), .c(new_n489_), .O(new_n490_));
  nand4  g333(.a(new_n490_), .b(new_n486_), .c(new_n484_), .d(new_n479_), .O(new_n491_));
  nand4  g334(.a(x126), .b(new_n305_), .c(new_n300_), .d(x014), .O(new_n492_));
  inv1   g335(.a(new_n492_), .O(new_n493_));
  aoi21  g336(.a(new_n491_), .b(new_n297_), .c(new_n493_), .O(new_n494_));
  oai22  g337(.a(new_n494_), .b(x054), .c(new_n340_), .d(x014), .O(new_n495_));
  nand2  g338(.a(new_n495_), .b(x006), .O(new_n496_));
  oai21  g339(.a(new_n334_), .b(new_n304_), .c(new_n310_), .O(new_n497_));
  nand2  g340(.a(new_n497_), .b(new_n297_), .O(new_n498_));
  aoi21  g341(.a(new_n498_), .b(new_n309_), .c(new_n482_), .O(new_n499_));
  nor2   g342(.a(new_n304_), .b(x022), .O(new_n500_));
  oai21  g343(.a(new_n500_), .b(new_n307_), .c(x070), .O(new_n501_));
  nand4  g344(.a(new_n480_), .b(new_n326_), .c(new_n478_), .d(x030), .O(new_n502_));
  aoi21  g345(.a(new_n502_), .b(new_n501_), .c(x078), .O(new_n503_));
  oai21  g346(.a(new_n503_), .b(new_n499_), .c(new_n343_), .O(new_n504_));
  inv1   g347(.a(new_n307_), .O(new_n505_));
  oai21  g348(.a(new_n311_), .b(new_n304_), .c(new_n505_), .O(new_n506_));
  nand3  g349(.a(new_n506_), .b(new_n297_), .c(x038), .O(new_n507_));
  ...
  aoi21  g355(.a(new_n508_), .b(new_n303_), .c(new_n512_), .O(new_n513_));
  aoi21  g356(.a(new_n513_), .b(new_n496_), .c(x046), .O(z14));
  zero   g357(.O(z07));
  zero   g358(.O(z15));
  zero   g359(.O(z17));
  zero   g360(.O(z18));
  ...
  nor2   g367(.a(x078), .b(new_n157_), .O(z24));
  nor2   g368(.a(x078), .b(new_n157_), .O(z26));
  nor2   g369(.a(x078), .b(new_n157_), .O(z27));
endmodule
