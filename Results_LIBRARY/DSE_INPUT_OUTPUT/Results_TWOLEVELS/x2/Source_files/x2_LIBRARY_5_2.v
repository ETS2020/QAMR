...
module FAU ( 
  ...
  nand4  g30(.a(new_n47_), .b(new_n43_), .c(new_n19_), .d(x6), .O(z5));
  nand2  g31(.a(new_n19_), .b(new_n39_), .O(new_n49_));
  aoi21  g32(.a(new_n36_), .b(x8), .c(new_n21_), .O(new_n50_));
  nand3  g33(.a(x8), .b(new_n21_), .c(x5), .O(new_n51_));
  inv1   g34(.a(new_n51_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n50_), .c(x9), .O(new_n53_));
  nand2  g36(.a(new_n44_), .b(new_n21_), .O(new_n54_));
