...
module FAU ( 
  ...
  nor2   g22(.a(new_n31_), .b(x5), .O(new_n40_));
  nor2   g23(.a(new_n40_), .b(x6), .O(new_n41_));
  inv1   g24(.a(new_n41_), .O(new_n42_));
  nand3  g25(.a(new_n29_), .b(x9), .c(x5), .O(new_n43_));
  ...
  aoi21  g31(.a(x8), .b(new_n18_), .c(new_n28_), .O(new_n49_));
  ...
  nor2   g37(.a(new_n54_), .b(new_n41_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n51_), .O(z5));
  nand3  g39(.a(x9), .b(new_n19_), .c(x7), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x6), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x5), .O(new_n59_));
  nor2   g42(.a(new_n31_), .b(new_n19_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n25_), .c(new_n18_), .O(new_n61_));
  inv1   g44(.a(x2), .O(new_n62_));
  nand3  g45(.a(new_n37_), .b(x9), .c(new_n62_), .O(new_n63_));
  nand4  g46(.a(new_n31_), .b(x7), .c(x4), .d(x3), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x8), .O(new_n66_));
  nor2   g49(.a(x9), .b(x6), .O(new_n67_));
  nor2   g50(.a(new_n67_), .b(new_n40_), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n66_), .c(new_n61_), .d(new_n59_), .O(z6));
endmodule
