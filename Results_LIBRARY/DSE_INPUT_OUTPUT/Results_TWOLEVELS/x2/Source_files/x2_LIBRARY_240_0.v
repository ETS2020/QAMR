...
module FAU ( 
  ...
  nand4  g26(.a(x3), .b(new_n43_), .c(new_n42_), .d(new_n41_), .O(new_n44_));
  aoi21  g27(.a(new_n40_), .b(x7), .c(new_n44_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n38_), .c(new_n31_), .O(z3));
  inv1   g29(.a(x6), .O(new_n47_));
  oai21  g30(.a(x9), .b(x3), .c(new_n47_), .O(new_n48_));
  aoi21  g31(.a(x9), .b(new_n18_), .c(new_n19_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(x9), .c(new_n23_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n48_), .c(new_n27_), .O(z4));
  xnor2a g34(.a(x8), .b(x7), .O(new_n52_));
  nand4  g35(.a(new_n52_), .b(x2), .c(new_n42_), .d(new_n41_), .O(new_n53_));
  nand3  g36(.a(x8), .b(new_n23_), .c(x5), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n53_), .c(x6), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x9), .O(new_n56_));
  inv1   g39(.a(x4), .O(new_n57_));
  aoi21  g40(.a(x7), .b(new_n57_), .c(new_n18_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(x9), .c(x6), .O(new_n59_));
  ...
  nand3  g46(.a(new_n63_), .b(new_n24_), .c(x3), .O(new_n64_));
  inv1   g47(.a(new_n54_), .O(new_n65_));
  nand3  g48(.a(new_n43_), .b(new_n42_), .c(new_n41_), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(x8), .c(new_n23_), .O(new_n67_));
