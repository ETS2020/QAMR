...
module FAU ( 
  ...
  nand2  g32(.a(new_n18_), .b(new_n22_), .O(new_n50_));
  oai21  g33(.a(new_n31_), .b(new_n22_), .c(new_n50_), .O(new_n51_));
  ...
  nand2  g43(.a(new_n31_), .b(new_n60_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n22_), .c(x5), .O(new_n62_));
  ...
  nand4  g50(.a(new_n67_), .b(new_n62_), .c(new_n39_), .d(x6), .O(z6));
endmodule
