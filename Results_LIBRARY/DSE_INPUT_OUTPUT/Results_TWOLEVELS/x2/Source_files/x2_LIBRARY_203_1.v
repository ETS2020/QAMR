...
module FAU ( 
  ...
  aoi21  g18(.a(new_n18_), .b(new_n25_), .c(new_n35_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n22_), .O(z4));
  nand2  g20(.a(new_n20_), .b(new_n25_), .O(new_n38_));
  nand2  g21(.a(x9), .b(x8), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(new_n25_), .c(new_n38_), .O(new_n40_));
  ...
  oai21  g35(.a(new_n52_), .b(new_n26_), .c(new_n25_), .O(new_n53_));
  aoi21  g36(.a(new_n32_), .b(x8), .c(new_n18_), .O(new_n54_));
