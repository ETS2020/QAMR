...
module FAU ( 
  ...
  nor2   g22(.a(x7), .b(x4), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(x9), .c(x8), .O(new_n41_));
  oai21  g24(.a(x9), .b(new_n21_), .c(new_n23_), .O(new_n42_));
  inv1   g25(.a(x6), .O(new_n43_));
  aoi21  g26(.a(new_n19_), .b(x4), .c(new_n43_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n42_), .c(new_n41_), .O(z4));
  nand2  g28(.a(x9), .b(x8), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n23_), .c(new_n28_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(x2), .c(new_n34_), .d(new_n33_), .O(new_n48_));
  nand2  g31(.a(x7), .b(x3), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(x8), .c(new_n18_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n19_), .O(new_n51_));
  inv1   g34(.a(new_n46_), .O(new_n52_));
  inv1   g35(.a(x5), .O(new_n53_));
  nor2   g36(.a(x7), .b(new_n53_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n52_), .c(new_n43_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n51_), .c(new_n48_), .O(z5));
  nand3  g39(.a(new_n35_), .b(new_n34_), .c(new_n33_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(x8), .c(new_n23_), .O(new_n58_));
  nand3  g41(.a(x8), .b(new_n23_), .c(x5), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n58_), .c(x9), .O(new_n61_));
  nor2   g44(.a(z2), .b(new_n43_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n61_), .O(z6));
endmodule
