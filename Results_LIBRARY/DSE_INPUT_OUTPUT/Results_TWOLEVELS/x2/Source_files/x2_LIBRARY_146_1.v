...
module FAU ( 
  ...
  oai22  g16(.a(new_n26_), .b(x7), .c(new_n31_), .d(x5), .O(z2));
  ...
  oai21  g23(.a(new_n31_), .b(x5), .c(new_n40_), .O(new_n41_));
  nand2  g24(.a(new_n31_), .b(new_n18_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n41_), .c(new_n30_), .O(z4));
  nand2  g26(.a(x8), .b(new_n18_), .O(new_n44_));
  inv1   g27(.a(x0), .O(new_n45_));
  inv1   g28(.a(x1), .O(new_n46_));
  nand4  g29(.a(new_n29_), .b(x2), .c(new_n46_), .d(new_n45_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n44_), .c(new_n31_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n40_), .c(x5), .O(new_n49_));
  ...
  nand3  g38(.a(new_n37_), .b(x8), .c(new_n55_), .O(new_n56_));
  nand4  g39(.a(new_n56_), .b(new_n44_), .c(new_n29_), .d(x5), .O(new_n57_));
  ...
  nand3  g44(.a(new_n61_), .b(new_n58_), .c(new_n41_), .O(z6));
endmodule
