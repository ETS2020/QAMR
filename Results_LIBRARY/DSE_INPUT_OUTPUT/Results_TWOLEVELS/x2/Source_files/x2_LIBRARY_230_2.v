...
module FAU ( 
  ...
  nand4  g20(.a(new_n37_), .b(new_n25_), .c(new_n35_), .d(new_n34_), .O(z3));
  inv1   g21(.a(x6), .O(new_n39_));
  oai21  g22(.a(x9), .b(new_n18_), .c(new_n39_), .O(new_n40_));
  aoi21  g23(.a(x9), .b(new_n19_), .c(x0), .O(new_n41_));
  ...
  aoi21  g32(.a(new_n47_), .b(new_n34_), .c(new_n49_), .O(new_n50_));
  nand3  g33(.a(x8), .b(new_n23_), .c(x5), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(x6), .c(new_n31_), .O(new_n52_));
  inv1   g35(.a(x4), .O(new_n53_));
  nand3  g36(.a(x7), .b(new_n53_), .c(x3), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(new_n18_), .c(x9), .O(new_n55_));
  nor2   g38(.a(new_n55_), .b(new_n52_), .O(new_n56_));
  oai21  g39(.a(new_n50_), .b(x0), .c(new_n56_), .O(z5));
  inv1   g40(.a(x5), .O(new_n58_));
  oai22  g41(.a(new_n43_), .b(new_n58_), .c(new_n48_), .d(x0), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n23_), .O(new_n60_));
  nand3  g43(.a(x9), .b(new_n35_), .c(new_n34_), .O(new_n61_));
  nand4  g44(.a(new_n31_), .b(x8), .c(x4), .d(x3), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n61_), .c(x0), .O(new_n63_));
  nor2   g46(.a(new_n31_), .b(x8), .O(new_n64_));
  oai21  g47(.a(new_n64_), .b(new_n63_), .c(x7), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n60_), .c(new_n40_), .O(z6));
endmodule
