...
module FAU ( 
  ...
  xor2a  g03(.a(x9), .b(x8), .O(new_n21_));
  ...
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(x8), .d(new_n20_), .O(z3));
  ...
  nand4  g18(.a(new_n20_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  ...
  nand3  g29(.a(new_n18_), .b(new_n33_), .c(new_n20_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(new_n46_), .c(new_n23_), .d(x6), .O(z6));
endmodule
