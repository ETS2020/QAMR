...
module FAU ( 
  ...
  nand4  g17(.a(new_n34_), .b(new_n30_), .c(new_n27_), .d(x6), .O(z4));
  ...
  nand3  g34(.a(new_n31_), .b(x9), .c(new_n51_), .O(new_n52_));
  ...
  nand4  g38(.a(new_n55_), .b(new_n50_), .c(new_n27_), .d(x6), .O(z6));
endmodule
