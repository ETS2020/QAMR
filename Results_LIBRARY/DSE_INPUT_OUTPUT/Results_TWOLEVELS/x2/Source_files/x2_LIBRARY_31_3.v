...
module FAU ( 
  ...
  nand4  g22(.a(new_n33_), .b(new_n39_), .c(new_n24_), .d(new_n38_), .O(new_n40_));
  ...
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n37_), .O(z4));
  nand3  g29(.a(x9), .b(x8), .c(x7), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n33_), .c(new_n39_), .O(new_n48_));
  nand4  g31(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x6), .O(new_n50_));
  aoi21  g33(.a(new_n48_), .b(new_n38_), .c(new_n50_), .O(new_n51_));
  ...
  oai21  g38(.a(new_n51_), .b(x1), .c(new_n55_), .O(z5));
