...
module FAU ( 
  ...
  nor2   g13(.a(new_n18_), .b(x0), .O(new_n31_));
  inv1   g14(.a(new_n31_), .O(new_n32_));
  nand2  g15(.a(new_n24_), .b(x8), .O(new_n33_));
  inv1   g16(.a(x8), .O(new_n34_));
  oai21  g17(.a(x9), .b(new_n34_), .c(new_n20_), .O(new_n35_));
  nand4  g18(.a(new_n35_), .b(new_n33_), .c(new_n32_), .d(x6), .O(z4));
  nand4  g19(.a(x9), .b(x8), .c(new_n20_), .d(x5), .O(new_n37_));
  ...
  nand2  g27(.a(x9), .b(new_n34_), .O(new_n45_));
  ...
  aoi21  g32(.a(new_n49_), .b(new_n18_), .c(new_n31_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n48_), .c(new_n39_), .O(z6));
endmodule
