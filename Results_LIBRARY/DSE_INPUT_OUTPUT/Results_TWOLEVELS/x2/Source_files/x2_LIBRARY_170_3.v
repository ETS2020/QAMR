...
module FAU ( 
  ...
  oai21  g04(.a(new_n21_), .b(x5), .c(x9), .O(new_n22_));
  ...
  nand3  g15(.a(new_n21_), .b(x9), .c(new_n32_), .O(new_n33_));
  nand2  g16(.a(new_n18_), .b(new_n26_), .O(new_n34_));
  ...
  nand4  g38(.a(new_n55_), .b(new_n50_), .c(new_n30_), .d(x6), .O(z6));
endmodule
