...
module FAU ( 
  ...
  oai21  g06(.a(new_n20_), .b(x7), .c(new_n21_), .O(new_n24_));
  inv1   g07(.a(x0), .O(new_n25_));
  inv1   g08(.a(x1), .O(new_n26_));
  inv1   g09(.a(x2), .O(new_n27_));
  nand4  g10(.a(new_n21_), .b(new_n27_), .c(new_n26_), .d(new_n25_), .O(new_n28_));
  ...
  nand4  g17(.a(new_n20_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n35_));
