...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n27_, new_n30_, new_n31_, new_n33_, new_n34_, new_n36_,
  ...
  nand3  g10(.a(new_n27_), .b(new_n21_), .c(new_n18_), .O(z1));
  nor3   g11(.a(x9), .b(x8), .c(x7), .O(z2));
  nor2   g12(.a(x1), .b(x0), .O(new_n30_));
  aoi21  g13(.a(x9), .b(x8), .c(x2), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(new_n30_), .c(new_n25_), .d(new_n19_), .O(z3));
  inv1   g15(.a(x6), .O(new_n33_));
  nand2  g16(.a(x9), .b(new_n33_), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n25_), .c(new_n22_), .O(z4));
  ...
  nand2  g23(.a(new_n21_), .b(new_n33_), .O(new_n41_));
  ...
  oai21  g29(.a(new_n46_), .b(new_n18_), .c(x7), .O(new_n47_));
