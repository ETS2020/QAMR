...
module FAU ( 
  ...
  oai21  g06(.a(new_n22_), .b(x5), .c(new_n23_), .O(z1));
  ...
  oai21  g12(.a(new_n21_), .b(x5), .c(x9), .O(new_n30_));
  inv1   g13(.a(x6), .O(new_n31_));
  aoi21  g14(.a(new_n18_), .b(new_n25_), .c(new_n31_), .O(new_n32_));
  ...
  aoi21  g25(.a(x9), .b(x5), .c(new_n31_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n42_), .c(new_n38_), .O(z5));
  ...
  nand3  g34(.a(new_n51_), .b(new_n46_), .c(new_n43_), .O(z6));
endmodule
