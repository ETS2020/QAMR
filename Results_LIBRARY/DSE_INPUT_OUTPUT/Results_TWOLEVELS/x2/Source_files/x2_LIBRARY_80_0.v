...
module FAU ( 
  ...
  oai21  g07(.a(x7), .b(new_n21_), .c(new_n18_), .O(new_n25_));
  nand2  g08(.a(x9), .b(x8), .O(new_n26_));
  nand3  g09(.a(new_n26_), .b(new_n25_), .c(new_n24_), .O(z1));
  nand4  g10(.a(new_n18_), .b(new_n22_), .c(new_n20_), .d(x2), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  nand2  g12(.a(new_n18_), .b(new_n21_), .O(new_n30_));
  aoi21  g13(.a(x9), .b(new_n22_), .c(new_n21_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(x9), .c(new_n20_), .O(new_n32_));
  oai21  g15(.a(new_n18_), .b(new_n22_), .c(x7), .O(new_n33_));
  nand4  g16(.a(new_n33_), .b(new_n32_), .c(new_n26_), .d(new_n30_), .O(z3));
  inv1   g17(.a(x6), .O(new_n35_));
  nand2  g18(.a(new_n30_), .b(new_n35_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n32_), .c(new_n26_), .O(z4));
  ...
  nand3  g25(.a(new_n42_), .b(new_n39_), .c(new_n38_), .O(new_n43_));
  ...
  oai21  g34(.a(new_n51_), .b(new_n35_), .c(x9), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n49_), .O(z5));
  nand4  g36(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n40_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n18_), .c(x2), .O(new_n56_));
  nand3  g39(.a(new_n21_), .b(new_n39_), .c(new_n38_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(x8), .c(new_n20_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n51_), .c(x9), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n56_), .c(new_n36_), .O(z6));
endmodule
