...
module FAU ( 
  ...
  nand3  g05(.a(new_n19_), .b(new_n18_), .c(x5), .O(new_n23_));
  ...
  nand3  g10(.a(new_n27_), .b(x9), .c(x5), .O(new_n28_));
  ...
  oai21  g15(.a(new_n29_), .b(x5), .c(new_n32_), .O(z2));
  ...
  oai21  g27(.a(new_n27_), .b(new_n44_), .c(x9), .O(new_n45_));
  inv1   g28(.a(x6), .O(new_n46_));
  aoi21  g29(.a(new_n29_), .b(new_n18_), .c(new_n46_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n45_), .O(z4));
  nand4  g31(.a(new_n27_), .b(x2), .c(new_n38_), .d(new_n37_), .O(new_n49_));
  aoi21  g32(.a(x8), .b(new_n18_), .c(new_n44_), .O(new_n50_));
  ...
  aoi21  g38(.a(new_n55_), .b(new_n29_), .c(new_n46_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n52_), .O(z5));
  nand4  g40(.a(new_n29_), .b(x8), .c(x4), .d(x3), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n34_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x7), .O(new_n60_));
  nor2   g43(.a(new_n29_), .b(new_n19_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n24_), .c(new_n18_), .O(new_n62_));
  nand4  g45(.a(x8), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x5), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x9), .O(new_n65_));
  nand4  g48(.a(new_n65_), .b(new_n62_), .c(new_n60_), .d(x6), .O(z6));
endmodule
