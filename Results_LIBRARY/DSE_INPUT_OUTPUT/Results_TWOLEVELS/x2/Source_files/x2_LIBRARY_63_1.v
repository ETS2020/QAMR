...
module FAU ( 
  ...
  aoi21  g36(.a(new_n53_), .b(new_n52_), .c(new_n43_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n51_), .c(new_n50_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x3), .O(new_n56_));
  oai21  g39(.a(new_n19_), .b(new_n43_), .c(new_n29_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(z5));
  nand4  g41(.a(x9), .b(x8), .c(x5), .d(x3), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n24_), .c(new_n18_), .O(new_n61_));
  nand2  g44(.a(x9), .b(new_n19_), .O(new_n62_));
  nand3  g45(.a(new_n29_), .b(x8), .c(x4), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n62_), .c(new_n34_), .O(new_n64_));
  nand4  g47(.a(x9), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n65_));
  inv1   g48(.a(new_n65_), .O(new_n66_));
  oai21  g49(.a(new_n66_), .b(new_n64_), .c(x7), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n61_), .c(new_n44_), .d(x6), .O(z6));
endmodule
