...
module FAU ( 
  ...
  oai21  g21(.a(new_n18_), .b(new_n22_), .c(new_n38_), .O(new_n39_));
  nand4  g22(.a(new_n20_), .b(x2), .c(new_n32_), .d(new_n31_), .O(new_n40_));
  ...
  aoi22  g27(.a(new_n44_), .b(new_n25_), .c(x9), .d(x8), .O(new_n45_));
  ...
  nand3  g33(.a(new_n18_), .b(new_n22_), .c(new_n20_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n50_), .c(new_n39_), .O(z6));
endmodule
