...
module FAU ( 
  ...
  nor2   g31(.a(new_n31_), .b(new_n19_), .O(new_n49_));
  ...
  nand3  g35(.a(new_n49_), .b(new_n18_), .c(x5), .O(new_n53_));
  ...
  aoi21  g40(.a(x8), .b(x6), .c(x9), .O(new_n58_));
  aoi21  g41(.a(new_n57_), .b(new_n28_), .c(new_n58_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n55_), .c(new_n52_), .O(z5));
  nand4  g43(.a(x9), .b(x8), .c(x5), .d(x4), .O(new_n61_));
  inv1   g44(.a(new_n61_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n25_), .c(new_n18_), .O(new_n63_));
  nor2   g46(.a(x2), .b(x1), .O(new_n64_));
  aoi21  g47(.a(new_n64_), .b(new_n39_), .c(new_n19_), .O(new_n65_));
  nand3  g48(.a(new_n31_), .b(x8), .c(x3), .O(new_n66_));
  oai21  g49(.a(new_n65_), .b(new_n31_), .c(new_n66_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(x7), .c(x4), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n63_), .c(new_n46_), .O(z6));
endmodule
