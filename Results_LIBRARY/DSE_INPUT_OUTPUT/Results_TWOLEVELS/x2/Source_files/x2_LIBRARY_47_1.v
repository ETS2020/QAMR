...
module FAU ( 
  ...
  nand2  g18(.a(new_n18_), .b(new_n24_), .O(new_n36_));
  inv1   g19(.a(x6), .O(new_n37_));
  oai21  g20(.a(new_n18_), .b(x7), .c(new_n37_), .O(new_n38_));
  nand2  g21(.a(new_n28_), .b(new_n27_), .O(new_n39_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n38_), .c(new_n36_), .O(z5));
  nand4  g28(.a(x9), .b(new_n29_), .c(new_n28_), .d(new_n27_), .O(new_n46_));
  ...
  nand3  g32(.a(new_n49_), .b(new_n38_), .c(new_n26_), .O(z6));
endmodule
