...
module FAU ( 
  ...
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n27_), .d(new_n23_), .O(z3));
  inv1   g16(.a(x6), .O(new_n34_));
  aoi21  g17(.a(x9), .b(x8), .c(new_n34_), .O(new_n35_));
  nand2  g18(.a(new_n19_), .b(new_n18_), .O(new_n36_));
  oai21  g19(.a(new_n35_), .b(new_n18_), .c(new_n36_), .O(z4));
  nand2  g20(.a(new_n19_), .b(new_n20_), .O(new_n38_));
  oai21  g21(.a(new_n19_), .b(x7), .c(new_n34_), .O(new_n39_));
  nand3  g22(.a(x9), .b(x8), .c(x2), .O(new_n40_));
  inv1   g23(.a(x4), .O(new_n41_));
  nand3  g24(.a(new_n19_), .b(new_n41_), .c(x3), .O(new_n42_));
  oai21  g25(.a(new_n40_), .b(new_n30_), .c(new_n42_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x7), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n39_), .c(new_n38_), .O(z5));
  ...
  aoi21  g33(.a(new_n50_), .b(new_n31_), .c(z2), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n49_), .c(new_n39_), .O(z6));
endmodule
