...
module FAU ( 
  ...
  nand2  g13(.a(new_n22_), .b(x1), .O(new_n31_));
  ...
  oai21  g21(.a(new_n22_), .b(x1), .c(x9), .O(new_n39_));
  ...
  oai21  g34(.a(new_n47_), .b(x1), .c(new_n51_), .O(z5));
  ...
  aoi21  g44(.a(x9), .b(x1), .c(new_n61_), .O(new_n62_));
