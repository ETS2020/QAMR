...
module FAU ( 
  ...
  nand2  g31(.a(x9), .b(new_n20_), .O(new_n49_));
  ...
  inv1   g35(.a(new_n41_), .O(new_n53_));
  aoi21  g36(.a(new_n19_), .b(x8), .c(x7), .O(new_n54_));
  nor2   g37(.a(new_n19_), .b(x2), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n53_), .c(new_n54_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n52_), .c(new_n40_), .O(z6));
endmodule
