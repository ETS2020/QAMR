...
module FAU ( 
  ...
  oai21  g02(.a(new_n19_), .b(new_n18_), .c(x8), .O(z0));
  oai21  g03(.a(new_n19_), .b(x8), .c(x7), .O(new_n21_));
  oai21  g04(.a(x9), .b(x8), .c(new_n18_), .O(new_n22_));
  ...
  aoi21  g22(.a(x8), .b(new_n18_), .c(new_n39_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n38_), .c(new_n35_), .O(z5));
  oai21  g24(.a(new_n19_), .b(x8), .c(new_n18_), .O(new_n42_));
  inv1   g25(.a(x2), .O(new_n43_));
  nand4  g26(.a(x9), .b(new_n43_), .c(new_n33_), .d(new_n32_), .O(new_n44_));
  nand3  g27(.a(new_n19_), .b(x4), .c(x3), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x8), .O(new_n47_));
  nor2   g30(.a(new_n19_), .b(x8), .O(new_n48_));
  aoi21  g31(.a(new_n48_), .b(x7), .c(new_n39_), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n47_), .c(new_n42_), .O(z6));
endmodule
