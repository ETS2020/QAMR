...
module FAU ( 
  ...
  oai21  g06(.a(new_n22_), .b(x7), .c(new_n23_), .O(z1));
  inv1   g07(.a(x7), .O(new_n25_));
  nand2  g08(.a(new_n22_), .b(new_n25_), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(z2));
  aoi21  g10(.a(x9), .b(new_n20_), .c(x0), .O(new_n28_));
  nor2   g11(.a(x2), .b(x1), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n26_), .d(new_n23_), .O(z3));
  inv1   g13(.a(x6), .O(new_n31_));
  aoi21  g14(.a(x9), .b(x8), .c(new_n31_), .O(new_n32_));
  nand2  g15(.a(new_n18_), .b(new_n20_), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n20_), .c(new_n25_), .O(new_n34_));
  oai21  g17(.a(new_n32_), .b(new_n25_), .c(new_n34_), .O(z4));
  ...
  oai21  g30(.a(new_n47_), .b(new_n20_), .c(x9), .O(new_n48_));
  nand4  g31(.a(new_n21_), .b(x7), .c(x4), .d(x3), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(new_n48_), .c(new_n36_), .d(new_n26_), .O(z6));
endmodule
