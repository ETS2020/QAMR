...
module FAU ( 
  ...
  nand4  g15(.a(new_n19_), .b(new_n18_), .c(new_n23_), .d(x0), .O(new_n33_));
  ...
  nand3  g25(.a(new_n42_), .b(x2), .c(new_n41_), .O(new_n43_));
  ...
  oai21  g30(.a(x8), .b(new_n27_), .c(new_n47_), .O(new_n48_));
  nand2  g31(.a(new_n23_), .b(x5), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n31_), .c(x6), .O(new_n50_));
  aoi21  g33(.a(new_n48_), .b(new_n19_), .c(new_n50_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n45_), .O(z5));
  inv1   g35(.a(x2), .O(new_n53_));
  nand3  g36(.a(x7), .b(new_n53_), .c(new_n41_), .O(new_n54_));
  ...
  oai21  g40(.a(new_n19_), .b(x8), .c(new_n57_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x7), .O(new_n59_));
  inv1   g42(.a(x6), .O(new_n60_));
  nand3  g43(.a(x9), .b(x8), .c(x5), .O(new_n61_));
  oai21  g44(.a(new_n20_), .b(new_n27_), .c(new_n61_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n23_), .c(new_n60_), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n59_), .c(new_n56_), .O(z6));
endmodule
