...
module FAU ( 
  ...
  nand3  g14(.a(new_n26_), .b(x9), .c(x2), .O(new_n32_));
  ...
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(x8), .d(x6), .O(z5));
  inv1   g21(.a(x6), .O(new_n39_));
  oai21  g22(.a(new_n18_), .b(x8), .c(new_n39_), .O(new_n40_));
  ...
  oai21  g29(.a(new_n46_), .b(new_n41_), .c(x8), .O(new_n47_));
