...
module FAU ( 
  ...
  and2   g22(.a(new_n34_), .b(new_n39_), .O(new_n40_));
  ...
  nand3  g26(.a(new_n29_), .b(x9), .c(new_n24_), .O(new_n44_));
  ...
  nand4  g38(.a(new_n55_), .b(new_n51_), .c(new_n33_), .d(x6), .O(z5));
  nand3  g39(.a(new_n39_), .b(new_n48_), .c(new_n47_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x8), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x9), .c(new_n24_), .O(new_n59_));
  nand3  g42(.a(new_n22_), .b(x4), .c(x3), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n59_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x7), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n43_), .c(new_n34_), .O(z6));
endmodule
