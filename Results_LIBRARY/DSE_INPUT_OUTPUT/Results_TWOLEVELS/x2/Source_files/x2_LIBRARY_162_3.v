...
module FAU ( 
  ...
  oai21  g12(.a(new_n20_), .b(x8), .c(new_n29_), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n20_), .c(x6), .O(z4));
  inv1   g14(.a(x6), .O(new_n32_));
  oai21  g15(.a(new_n20_), .b(new_n29_), .c(new_n32_), .O(new_n33_));
  ...
  oai21  g28(.a(new_n45_), .b(new_n19_), .c(new_n29_), .O(new_n46_));
