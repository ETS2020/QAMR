...
module FAU ( 
  ...
  oai21  g28(.a(new_n45_), .b(new_n26_), .c(new_n23_), .O(new_n46_));
  nand4  g29(.a(new_n46_), .b(new_n43_), .c(new_n21_), .d(x6), .O(z5));
  nand2  g30(.a(new_n21_), .b(new_n39_), .O(new_n48_));
  aoi21  g31(.a(new_n36_), .b(x8), .c(new_n23_), .O(new_n49_));
  nand3  g32(.a(x8), .b(new_n23_), .c(x5), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n49_), .c(x9), .O(new_n52_));
  nand2  g35(.a(new_n26_), .b(new_n23_), .O(new_n53_));
