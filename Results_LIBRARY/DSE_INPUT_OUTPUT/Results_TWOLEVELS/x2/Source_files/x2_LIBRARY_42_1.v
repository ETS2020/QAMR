...
module FAU ( 
  ...
  nand2  g06(.a(new_n19_), .b(x8), .O(new_n24_));
  oai21  g07(.a(new_n24_), .b(x7), .c(new_n23_), .O(z1));
  nand2  g08(.a(new_n24_), .b(new_n18_), .O(new_n26_));
  inv1   g09(.a(new_n26_), .O(z2));
  oai21  g10(.a(new_n19_), .b(x7), .c(new_n20_), .O(new_n28_));
  ...
  nor2   g17(.a(new_n19_), .b(new_n18_), .O(new_n35_));
  nor2   g18(.a(x9), .b(x7), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(new_n35_), .c(x8), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n26_), .c(x6), .O(z4));
  ...
  nand2  g29(.a(x9), .b(new_n20_), .O(new_n47_));
  ...
  nor2   g34(.a(x1), .b(x0), .O(new_n52_));
  nor2   g35(.a(new_n19_), .b(x2), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n52_), .c(new_n51_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n50_), .c(new_n26_), .O(z6));
endmodule
