...
module FAU ( 
  ...
  oai21  g19(.a(new_n24_), .b(new_n20_), .c(new_n18_), .O(new_n37_));
  oai21  g20(.a(new_n36_), .b(new_n18_), .c(new_n37_), .O(z4));
  oai21  g21(.a(new_n19_), .b(x7), .c(new_n35_), .O(new_n39_));
  ...
  nand2  g28(.a(new_n19_), .b(new_n20_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n39_), .O(z5));
  ...
  aoi21  g37(.a(new_n54_), .b(new_n53_), .c(z2), .O(new_n55_));
