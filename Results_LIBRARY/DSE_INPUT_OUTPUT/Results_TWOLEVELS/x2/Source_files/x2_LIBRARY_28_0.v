...
module FAU ( 
  ...
  aoi21  g16(.a(new_n33_), .b(x4), .c(x9), .O(z2));
  ...
  oai21  g34(.a(new_n20_), .b(new_n51_), .c(x4), .O(new_n52_));
  nand3  g35(.a(x8), .b(new_n22_), .c(x5), .O(new_n53_));
  inv1   g36(.a(new_n53_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n51_), .c(x9), .O(new_n55_));
  nand4  g38(.a(new_n55_), .b(new_n52_), .c(new_n50_), .d(new_n39_), .O(z5));
  nand2  g39(.a(new_n39_), .b(new_n51_), .O(new_n57_));
  nand3  g40(.a(x8), .b(x7), .c(x3), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n33_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n27_), .c(x4), .O(new_n60_));
  nand3  g43(.a(new_n37_), .b(new_n47_), .c(new_n46_), .O(new_n61_));
