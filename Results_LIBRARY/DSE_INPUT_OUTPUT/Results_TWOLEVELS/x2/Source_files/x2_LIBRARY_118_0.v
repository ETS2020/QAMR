...
module FAU ( 
  ...
  oai21  g37(.a(new_n20_), .b(new_n47_), .c(x4), .O(new_n55_));
  nand3  g38(.a(x8), .b(new_n22_), .c(x5), .O(new_n56_));
  inv1   g39(.a(new_n56_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n47_), .c(x9), .O(new_n58_));
  nand4  g41(.a(new_n58_), .b(new_n55_), .c(new_n54_), .d(new_n31_), .O(z5));
  nand3  g42(.a(x8), .b(x7), .c(x3), .O(new_n60_));
  oai21  g43(.a(x8), .b(x7), .c(new_n60_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n30_), .c(x4), .O(new_n62_));
  aoi21  g45(.a(new_n43_), .b(x8), .c(new_n22_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n57_), .c(x9), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n62_), .c(new_n48_), .O(z6));
endmodule
