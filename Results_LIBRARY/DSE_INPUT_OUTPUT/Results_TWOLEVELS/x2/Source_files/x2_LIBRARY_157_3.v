...
module FAU ( 
  ...
  aoi21  g22(.a(x9), .b(x8), .c(new_n19_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n39_), .O(z4));
  nand4  g24(.a(new_n19_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x9), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n22_), .O(new_n44_));
  inv1   g27(.a(x4), .O(new_n45_));
  nand4  g28(.a(new_n20_), .b(x7), .c(new_n45_), .d(x3), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n44_), .c(new_n39_), .O(z5));
  nand3  g30(.a(x8), .b(x4), .c(x3), .O(new_n48_));
  inv1   g31(.a(new_n48_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(new_n21_), .c(x7), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(new_n28_), .c(new_n27_), .d(x6), .O(z6));
endmodule
