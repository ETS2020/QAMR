...
module FAU ( 
  ...
  nand2  g15(.a(x9), .b(x2), .O(new_n33_));
  ...
  nand4  g23(.a(new_n40_), .b(new_n24_), .c(new_n39_), .d(new_n38_), .O(new_n41_));
  ...
  nand3  g38(.a(x9), .b(new_n21_), .c(x7), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x6), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n24_), .O(new_n58_));
  nand3  g41(.a(x9), .b(new_n39_), .c(new_n38_), .O(new_n59_));
  ...
  oai21  g46(.a(x9), .b(x8), .c(new_n63_), .O(new_n64_));
  oai21  g47(.a(x9), .b(x6), .c(new_n33_), .O(new_n65_));
  aoi21  g48(.a(new_n64_), .b(new_n18_), .c(new_n65_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n62_), .c(new_n58_), .O(z6));
endmodule
