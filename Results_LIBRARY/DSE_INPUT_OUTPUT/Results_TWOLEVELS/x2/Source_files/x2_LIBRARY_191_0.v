...
module FAU ( 
  ...
  oai21  g13(.a(x9), .b(new_n20_), .c(new_n22_), .O(new_n31_));
  oai21  g14(.a(x8), .b(x7), .c(x9), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n24_), .d(new_n30_), .O(z3));
  oai21  g16(.a(x7), .b(new_n29_), .c(new_n18_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x8), .O(new_n35_));
  nand4  g18(.a(new_n35_), .b(new_n31_), .c(new_n30_), .d(x6), .O(z4));
  ...
  nand3  g26(.a(new_n43_), .b(x8), .c(x2), .O(new_n44_));
  ...
  nand3  g34(.a(x7), .b(new_n38_), .c(new_n37_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x9), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n29_), .O(new_n54_));
  nand2  g37(.a(x9), .b(new_n20_), .O(new_n55_));
  ...
  oai21  g42(.a(x9), .b(x8), .c(new_n59_), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n22_), .c(new_n46_), .O(new_n61_));
