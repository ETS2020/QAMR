...
module FAU ( 
  ...
  nand2  g16(.a(x9), .b(x2), .O(new_n34_));
  oai21  g17(.a(new_n33_), .b(x7), .c(new_n34_), .O(z2));
  oai21  g18(.a(x8), .b(x2), .c(x9), .O(new_n36_));
  ...
  oai21  g25(.a(new_n29_), .b(x2), .c(x9), .O(new_n43_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n48_), .c(new_n34_), .O(z5));
  nand4  g36(.a(x9), .b(x8), .c(x5), .d(new_n24_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n33_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n18_), .O(new_n56_));
  oai21  g39(.a(x1), .b(x0), .c(x8), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(x9), .c(new_n24_), .O(new_n58_));
  ...
  nand3  g44(.a(new_n61_), .b(new_n56_), .c(new_n42_), .O(z6));
endmodule
