...
module FAU ( 
  ...
  nand3  g14(.a(new_n25_), .b(new_n19_), .c(new_n18_), .O(new_n32_));
  oai21  g15(.a(new_n25_), .b(x5), .c(new_n32_), .O(z2));
  ...
  oai21  g27(.a(new_n25_), .b(x5), .c(new_n44_), .O(new_n45_));
  nand2  g28(.a(new_n25_), .b(new_n18_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n29_), .O(z4));
  nand2  g30(.a(x8), .b(new_n18_), .O(new_n48_));
  nand4  g31(.a(new_n28_), .b(x2), .c(new_n38_), .d(new_n37_), .O(new_n49_));
  aoi21  g32(.a(new_n49_), .b(new_n48_), .c(new_n25_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n44_), .c(x5), .O(new_n51_));
  ...
  nand3  g42(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x7), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(x9), .c(x8), .d(x5), .O(new_n62_));
  nand4  g45(.a(new_n62_), .b(new_n59_), .c(new_n45_), .d(new_n32_), .O(z6));
endmodule
