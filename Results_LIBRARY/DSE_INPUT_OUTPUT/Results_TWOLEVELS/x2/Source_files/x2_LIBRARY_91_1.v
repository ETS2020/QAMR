...
module FAU ( 
  ...
  oai21  g06(.a(new_n23_), .b(x7), .c(new_n19_), .O(new_n24_));
  inv1   g07(.a(x1), .O(new_n25_));
  oai21  g08(.a(x8), .b(new_n25_), .c(x9), .O(new_n26_));
  nand3  g09(.a(new_n26_), .b(new_n24_), .c(new_n22_), .O(z0));
  nor2   g10(.a(new_n23_), .b(x7), .O(new_n28_));
  oai21  g11(.a(new_n28_), .b(x8), .c(x1), .O(new_n29_));
  oai21  g12(.a(x8), .b(x7), .c(new_n23_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n29_), .O(z1));
  nor2   g14(.a(new_n23_), .b(x1), .O(new_n32_));
  nor3   g15(.a(x9), .b(x8), .c(x7), .O(new_n33_));
  or2    g16(.a(new_n33_), .b(new_n32_), .O(z2));
  oai21  g17(.a(new_n23_), .b(new_n19_), .c(x7), .O(new_n35_));
  nor2   g18(.a(new_n32_), .b(x0), .O(new_n36_));
  nor2   g19(.a(new_n33_), .b(x2), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(new_n35_), .d(new_n29_), .O(z3));
  inv1   g21(.a(x6), .O(new_n39_));
  oai21  g22(.a(new_n28_), .b(new_n39_), .c(x1), .O(new_n40_));
  oai21  g23(.a(new_n18_), .b(new_n39_), .c(new_n23_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n40_), .c(new_n26_), .O(z4));
  ...
  nand2  g33(.a(x9), .b(new_n19_), .O(new_n51_));
  nand4  g34(.a(new_n23_), .b(x8), .c(x4), .d(x3), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x7), .O(new_n54_));
  oai21  g37(.a(x8), .b(x7), .c(x6), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n23_), .c(new_n32_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n54_), .c(new_n45_), .O(z6));
endmodule
