...
module FAU ( 
  ...
  aoi21  g25(.a(x9), .b(new_n19_), .c(x3), .O(new_n43_));
  ...
  nand3  g32(.a(x8), .b(new_n24_), .c(x5), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n49_), .c(x6), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x9), .O(new_n52_));
  nand2  g35(.a(new_n21_), .b(x6), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n18_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n52_), .O(z5));
  oai21  g38(.a(new_n21_), .b(x7), .c(x6), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n18_), .O(new_n57_));
  nand2  g40(.a(new_n50_), .b(x6), .O(new_n58_));
  nand3  g41(.a(new_n37_), .b(new_n47_), .c(new_n46_), .O(new_n59_));
  aoi21  g42(.a(new_n59_), .b(x8), .c(new_n24_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n58_), .c(x9), .O(new_n61_));
