...
module FAU ( 
  ...
  wire new_n19_, new_n20_, new_n21_, new_n24_, new_n25_, new_n27_, new_n29_,
  ...
  nand4  g08(.a(new_n25_), .b(new_n20_), .c(x8), .d(new_n24_), .O(z3));
  oai21  g09(.a(new_n20_), .b(x8), .c(new_n24_), .O(new_n27_));
  nand3  g10(.a(new_n27_), .b(new_n20_), .c(x6), .O(z4));
  inv1   g11(.a(x6), .O(new_n29_));
  oai21  g12(.a(new_n20_), .b(new_n24_), .c(new_n29_), .O(new_n30_));
