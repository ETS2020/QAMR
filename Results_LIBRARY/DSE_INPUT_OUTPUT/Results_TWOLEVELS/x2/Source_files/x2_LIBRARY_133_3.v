...
module FAU ( 
  ...
  nand4  g39(.a(new_n56_), .b(new_n52_), .c(new_n33_), .d(x6), .O(z5));
  nand3  g40(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(new_n58_));
  ...
  nand3  g46(.a(new_n63_), .b(new_n47_), .c(new_n34_), .O(z6));
endmodule
