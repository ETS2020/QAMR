...
module FAU ( 
  ...
  nand3  g10(.a(new_n19_), .b(x7), .c(x4), .O(new_n28_));
  ...
  nand4  g21(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n29_), .O(z3));
  inv1   g22(.a(x6), .O(new_n40_));
  oai21  g23(.a(new_n30_), .b(x4), .c(new_n40_), .O(new_n41_));
  nand2  g24(.a(new_n30_), .b(new_n18_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n41_), .c(new_n29_), .O(z4));
  ...
  aoi21  g37(.a(new_n53_), .b(new_n34_), .c(new_n54_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n51_), .c(new_n48_), .O(z5));
  nand4  g39(.a(x9), .b(x8), .c(x5), .d(x4), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n25_), .c(new_n18_), .O(new_n59_));
  nor2   g42(.a(x2), .b(x1), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n44_), .c(new_n19_), .O(new_n61_));
  nand3  g44(.a(new_n30_), .b(x8), .c(x3), .O(new_n62_));
  oai21  g45(.a(new_n61_), .b(new_n30_), .c(new_n62_), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(x7), .c(x4), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n59_), .c(new_n41_), .O(z6));
endmodule
