...
module FAU ( 
  ...
  oai21  g04(.a(new_n18_), .b(new_n20_), .c(x7), .O(new_n23_));
  inv1   g05(.a(x7), .O(new_n24_));
  oai21  g06(.a(x8), .b(new_n24_), .c(x9), .O(new_n25_));
  nand2  g07(.a(new_n25_), .b(new_n23_), .O(z3));
  oai21  g08(.a(new_n24_), .b(x6), .c(new_n25_), .O(z4));
  ...
  nand3  g22(.a(x9), .b(new_n24_), .c(x5), .O(new_n41_));
