...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    new_n25_, new_n29_, new_n30_, new_n32_, new_n33_, new_n35_, new_n36_,
  ...
  oai21  g07(.a(new_n24_), .b(x9), .c(new_n23_), .O(new_n25_));
  nand3  g08(.a(new_n25_), .b(new_n22_), .c(new_n19_), .O(z0));
  oai21  g09(.a(new_n24_), .b(x7), .c(new_n18_), .O(z1));
  nor3   g10(.a(x9), .b(x8), .c(x7), .O(z2));
  nor2   g11(.a(x1), .b(x0), .O(new_n29_));
  aoi21  g12(.a(x9), .b(x8), .c(x2), .O(new_n30_));
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n25_), .d(new_n19_), .O(z3));
  inv1   g14(.a(x6), .O(new_n32_));
  nand2  g15(.a(x9), .b(new_n32_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n25_), .c(new_n22_), .O(z4));
  ...
  oai21  g23(.a(new_n40_), .b(new_n24_), .c(new_n23_), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n38_), .c(new_n21_), .d(x6), .O(z5));
  nor3   g25(.a(x2), .b(x1), .c(x0), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n18_), .c(x7), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n41_), .c(x6), .O(z6));
endmodule
