...
module FAU ( 
  ...
  oai21  g19(.a(new_n36_), .b(new_n25_), .c(new_n21_), .O(new_n37_));
  inv1   g20(.a(x6), .O(new_n38_));
  nand2  g21(.a(new_n18_), .b(new_n21_), .O(new_n39_));
  aoi21  g22(.a(new_n39_), .b(new_n19_), .c(new_n38_), .O(new_n40_));
  ...
  nand3  g27(.a(new_n44_), .b(x9), .c(x7), .O(new_n45_));
  aoi21  g28(.a(new_n19_), .b(x8), .c(new_n38_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n37_), .O(z6));
endmodule
