...
module FAU ( 
  ...
  nand2  g24(.a(new_n24_), .b(new_n41_), .O(new_n42_));
  ...
  aoi21  g30(.a(new_n34_), .b(x8), .c(new_n21_), .O(new_n48_));
  nand3  g31(.a(x8), .b(new_n21_), .c(x5), .O(new_n49_));
  inv1   g32(.a(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n48_), .c(x9), .O(new_n51_));
  nand2  g34(.a(new_n43_), .b(new_n21_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n51_), .c(new_n42_), .O(z6));
endmodule
