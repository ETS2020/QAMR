...
module FAU ( 
  ...
  nand4  g10(.a(new_n18_), .b(new_n22_), .c(new_n20_), .d(x5), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  oai21  g12(.a(new_n18_), .b(new_n22_), .c(x7), .O(new_n30_));
  oai21  g13(.a(x8), .b(new_n21_), .c(new_n18_), .O(new_n31_));
  ...
  aoi21  g22(.a(x9), .b(new_n22_), .c(new_n21_), .O(new_n40_));
  ...
  oai21  g35(.a(new_n52_), .b(new_n38_), .c(x5), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g37(.a(new_n18_), .b(new_n22_), .O(new_n55_));
  nand2  g38(.a(new_n26_), .b(new_n55_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n20_), .c(x5), .O(new_n57_));
  nand3  g40(.a(new_n32_), .b(new_n44_), .c(new_n43_), .O(new_n58_));
  ...
  nand4  g45(.a(new_n62_), .b(new_n57_), .c(new_n33_), .d(x6), .O(z6));
endmodule
