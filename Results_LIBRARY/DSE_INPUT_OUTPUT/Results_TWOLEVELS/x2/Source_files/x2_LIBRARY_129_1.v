...
module FAU ( 
  ...
  oai21  g23(.a(new_n18_), .b(new_n34_), .c(new_n30_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n29_), .O(z4));
  ...
  nand4  g30(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n48_));
  ...
  nand3  g38(.a(x8), .b(new_n18_), .c(x5), .O(new_n56_));
  inv1   g39(.a(x2), .O(new_n57_));
  nand3  g40(.a(new_n38_), .b(x7), .c(new_n57_), .O(new_n58_));
  nand4  g41(.a(new_n58_), .b(new_n56_), .c(new_n28_), .d(x6), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x9), .O(new_n60_));
  nand2  g43(.a(new_n19_), .b(new_n18_), .O(new_n61_));
  nand4  g44(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n61_), .c(x6), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n30_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n60_), .O(z6));
endmodule
