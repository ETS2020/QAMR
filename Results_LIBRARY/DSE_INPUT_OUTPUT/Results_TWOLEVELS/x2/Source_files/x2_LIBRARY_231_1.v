...
module FAU ( 
  ...
  oai21  g08(.a(new_n18_), .b(x7), .c(new_n21_), .O(new_n26_));
  inv1   g09(.a(x0), .O(new_n27_));
  inv1   g10(.a(x1), .O(new_n28_));
  inv1   g11(.a(x2), .O(new_n29_));
  nand4  g12(.a(new_n21_), .b(new_n29_), .c(new_n28_), .d(new_n27_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(x8), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n26_), .O(z3));
  nand2  g15(.a(new_n20_), .b(x6), .O(z4));
  nand4  g16(.a(x9), .b(x2), .c(new_n28_), .d(new_n27_), .O(new_n34_));
  ...
  nand3  g21(.a(x9), .b(new_n19_), .c(x5), .O(new_n39_));
  ...
  nand4  g26(.a(new_n21_), .b(x8), .c(x4), .d(x3), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x7), .O(new_n46_));
  nand2  g29(.a(x9), .b(x5), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(x8), .c(x7), .O(new_n48_));
  oai21  g31(.a(new_n21_), .b(x8), .c(x6), .O(new_n49_));
