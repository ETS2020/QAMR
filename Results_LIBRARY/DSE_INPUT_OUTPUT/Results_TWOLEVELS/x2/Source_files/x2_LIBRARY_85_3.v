...
module FAU ( 
  ...
  oai21  g04(.a(x8), .b(x0), .c(x9), .O(new_n22_));
  ...
  oai21  g16(.a(new_n18_), .b(x0), .c(new_n33_), .O(z3));
  nand2  g17(.a(new_n23_), .b(x8), .O(new_n35_));
  oai21  g18(.a(x9), .b(new_n25_), .c(new_n20_), .O(new_n36_));
  inv1   g19(.a(x6), .O(new_n37_));
  aoi21  g20(.a(x9), .b(x0), .c(new_n37_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n36_), .c(new_n35_), .O(z4));
  nand3  g22(.a(x9), .b(x8), .c(x7), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n26_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(x2), .c(new_n29_), .O(new_n42_));
  ...
  nand3  g41(.a(new_n58_), .b(new_n53_), .c(new_n38_), .O(z6));
endmodule
