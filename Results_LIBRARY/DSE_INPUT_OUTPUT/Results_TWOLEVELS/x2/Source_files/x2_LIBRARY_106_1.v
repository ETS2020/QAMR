...
module FAU ( 
  ...
  nand3  g19(.a(new_n21_), .b(new_n36_), .c(x3), .O(new_n37_));
  ...
  nand4  g26(.a(x9), .b(new_n26_), .c(new_n34_), .d(new_n33_), .O(new_n44_));
  nand4  g27(.a(new_n21_), .b(x8), .c(x4), .d(x3), .O(new_n45_));
  ...
  oai21  g32(.a(new_n21_), .b(x8), .c(x6), .O(new_n50_));
