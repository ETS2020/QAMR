...
module FAU ( 
  ...
  nand3  g14(.a(new_n31_), .b(new_n29_), .c(new_n24_), .O(z3));
  nand2  g15(.a(x9), .b(x8), .O(new_n33_));
  nand4  g16(.a(new_n33_), .b(new_n22_), .c(x7), .d(x6), .O(z4));
  xnor2a g17(.a(x8), .b(x7), .O(new_n35_));
  nand4  g18(.a(new_n35_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n36_));
  nand3  g19(.a(x8), .b(new_n30_), .c(x5), .O(new_n37_));
