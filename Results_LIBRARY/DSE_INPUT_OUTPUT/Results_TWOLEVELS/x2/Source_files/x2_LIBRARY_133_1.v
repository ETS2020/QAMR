...
module FAU ( 
  ...
  nand3  g20(.a(new_n29_), .b(x9), .c(x5), .O(new_n38_));
  ...
  aoi21  g28(.a(x9), .b(new_n28_), .c(x6), .O(new_n46_));
  inv1   g29(.a(new_n46_), .O(new_n47_));
  nand2  g30(.a(new_n25_), .b(new_n18_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n47_), .c(new_n38_), .O(z4));
  nand4  g32(.a(new_n29_), .b(x2), .c(new_n40_), .d(new_n39_), .O(new_n50_));
  aoi21  g33(.a(x8), .b(new_n18_), .c(new_n28_), .O(new_n51_));
  ...
  aoi21  g39(.a(new_n56_), .b(new_n25_), .c(new_n46_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n53_), .O(z5));
  nand4  g41(.a(new_n25_), .b(x8), .c(x4), .d(x3), .O(new_n59_));
  ...
  nand4  g46(.a(new_n63_), .b(x9), .c(x8), .d(x5), .O(new_n64_));
  nand4  g47(.a(new_n64_), .b(new_n61_), .c(new_n47_), .d(new_n33_), .O(z6));
endmodule
