...
module FAU ( 
  ...
  nand2  g06(.a(new_n24_), .b(x7), .O(new_n25_));
  ...
  nand4  g13(.a(new_n31_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n32_));
  inv1   g14(.a(x6), .O(new_n33_));
  oai21  g15(.a(x9), .b(x7), .c(new_n33_), .O(new_n34_));
  nand3  g16(.a(x9), .b(x8), .c(x5), .O(new_n35_));
  aoi21  g17(.a(new_n35_), .b(x9), .c(x7), .O(new_n36_));
  inv1   g18(.a(x3), .O(new_n37_));
  oai21  g19(.a(x4), .b(new_n37_), .c(x8), .O(new_n38_));
  aoi21  g20(.a(new_n38_), .b(new_n18_), .c(new_n36_), .O(new_n39_));
  nand3  g21(.a(new_n39_), .b(new_n34_), .c(new_n32_), .O(z5));
  nand3  g22(.a(x9), .b(new_n20_), .c(x5), .O(new_n41_));
  nand4  g23(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n42_));
  nand2  g24(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g25(.a(new_n43_), .b(x8), .O(new_n44_));
  inv1   g26(.a(x2), .O(new_n45_));
  nand3  g27(.a(new_n45_), .b(new_n29_), .c(new_n28_), .O(new_n46_));
  nand2  g28(.a(new_n46_), .b(x8), .O(new_n47_));
  nand3  g29(.a(new_n47_), .b(x9), .c(x7), .O(new_n48_));
  nand3  g30(.a(new_n48_), .b(new_n44_), .c(new_n34_), .O(z6));
  zero   g31(.O(z2));
endmodule
