...
module FAU ( 
  ...
  nand4  g19(.a(new_n36_), .b(new_n35_), .c(new_n25_), .d(new_n28_), .O(z3));
  inv1   g20(.a(x6), .O(new_n38_));
  oai21  g21(.a(new_n25_), .b(x2), .c(new_n38_), .O(new_n39_));
  nand3  g22(.a(new_n29_), .b(x9), .c(x2), .O(new_n40_));
  ...
  aoi21  g27(.a(new_n44_), .b(new_n33_), .c(x1), .O(new_n45_));
  ...
  oai21  g35(.a(new_n48_), .b(new_n28_), .c(new_n52_), .O(z5));
  nand3  g36(.a(x8), .b(new_n18_), .c(x5), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n29_), .c(x2), .O(new_n55_));
  ...
  nand3  g42(.a(new_n59_), .b(new_n56_), .c(new_n39_), .O(z6));
endmodule
