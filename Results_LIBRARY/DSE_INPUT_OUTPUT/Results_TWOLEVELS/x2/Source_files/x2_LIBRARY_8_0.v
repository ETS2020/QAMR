...
module FAU ( 
  ...
  oai21  g08(.a(x7), .b(new_n21_), .c(new_n18_), .O(new_n26_));
  ...
  nand4  g16(.a(new_n33_), .b(new_n32_), .c(new_n25_), .d(new_n30_), .O(z3));
  inv1   g17(.a(x6), .O(new_n35_));
  nand2  g18(.a(new_n30_), .b(new_n35_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n32_), .c(new_n25_), .O(z4));
  ...
  aoi21  g26(.a(new_n43_), .b(x6), .c(new_n18_), .O(new_n44_));
  ...
  oai21  g31(.a(new_n42_), .b(new_n21_), .c(new_n48_), .O(z5));
  nor3   g32(.a(x9), .b(x8), .c(x7), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n35_), .c(x2), .O(new_n51_));
  inv1   g34(.a(x1), .O(new_n52_));
  nand3  g35(.a(x7), .b(new_n52_), .c(new_n38_), .O(new_n53_));
  ...
  aoi21  g40(.a(new_n57_), .b(x7), .c(new_n44_), .O(new_n58_));
