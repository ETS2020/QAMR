...
module FAU ( 
  ...
  nand2  g21(.a(x9), .b(new_n28_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n38_), .O(new_n40_));
  nand3  g23(.a(new_n29_), .b(x9), .c(x0), .O(new_n41_));
  nand2  g24(.a(new_n25_), .b(new_n18_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n41_), .c(new_n40_), .O(z4));
  ...
  nand3  g33(.a(new_n50_), .b(new_n46_), .c(new_n39_), .O(z5));
  nand3  g34(.a(x8), .b(new_n18_), .c(x5), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n29_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(x9), .c(x0), .O(new_n54_));
  nand4  g37(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n55_));
  oai21  g38(.a(x8), .b(x7), .c(new_n55_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n25_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n54_), .c(new_n40_), .O(z6));
endmodule
