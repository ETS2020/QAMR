...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(x4), .c(x9), .O(new_n31_));
  ...
  nand3  g20(.a(new_n30_), .b(x9), .c(new_n24_), .O(new_n38_));
  ...
  oai21  g28(.a(new_n19_), .b(new_n24_), .c(new_n45_), .O(new_n46_));
  ...
  nand3  g36(.a(new_n19_), .b(x7), .c(x3), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n24_), .O(new_n56_));
  aoi21  g39(.a(x9), .b(x4), .c(new_n27_), .O(new_n57_));
  nand4  g40(.a(new_n57_), .b(new_n56_), .c(new_n52_), .d(new_n46_), .O(z5));
  nand3  g41(.a(new_n49_), .b(x5), .c(new_n24_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n28_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n18_), .O(new_n61_));
  nand3  g44(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(new_n62_));
  ...
  nand3  g50(.a(new_n67_), .b(new_n61_), .c(new_n46_), .O(z6));
endmodule
