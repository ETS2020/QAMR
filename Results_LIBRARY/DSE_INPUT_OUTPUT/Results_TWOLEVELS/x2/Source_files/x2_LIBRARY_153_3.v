...
module FAU ( 
  ...
  nand3  g21(.a(new_n38_), .b(new_n33_), .c(new_n37_), .O(new_n39_));
  ...
  nand3  g33(.a(new_n19_), .b(x7), .c(x3), .O(new_n51_));
  ...
  oai21  g39(.a(new_n21_), .b(new_n42_), .c(new_n19_), .O(new_n57_));
  nand4  g40(.a(new_n57_), .b(new_n56_), .c(new_n53_), .d(new_n50_), .O(z5));
  nand3  g41(.a(x8), .b(x7), .c(x3), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n19_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x4), .O(new_n61_));
  nand3  g44(.a(x9), .b(new_n21_), .c(x7), .O(new_n62_));
  ...
  oai21  g49(.a(new_n66_), .b(new_n26_), .c(new_n18_), .O(new_n67_));
  nor2   g50(.a(x9), .b(x6), .O(new_n68_));
  nand2  g51(.a(x9), .b(x7), .O(new_n69_));
  nor2   g52(.a(new_n69_), .b(x2), .O(new_n70_));
  aoi21  g53(.a(new_n70_), .b(new_n38_), .c(new_n68_), .O(new_n71_));
  nand4  g54(.a(new_n71_), .b(new_n67_), .c(new_n64_), .d(new_n61_), .O(z6));
endmodule
