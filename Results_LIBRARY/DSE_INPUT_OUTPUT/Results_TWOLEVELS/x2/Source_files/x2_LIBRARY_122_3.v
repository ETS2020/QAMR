...
module FAU ( 
  ...
  oai21  g11(.a(new_n21_), .b(x8), .c(new_n26_), .O(new_n29_));
  nand3  g12(.a(new_n29_), .b(new_n21_), .c(x6), .O(z4));
  inv1   g13(.a(x6), .O(new_n31_));
  nand2  g14(.a(new_n24_), .b(new_n31_), .O(new_n32_));
  inv1   g15(.a(x3), .O(new_n33_));
  oai21  g16(.a(x4), .b(new_n33_), .c(new_n21_), .O(new_n34_));
  ...
  nand4  g24(.a(x9), .b(x8), .c(new_n26_), .d(x5), .O(new_n42_));
  nand4  g25(.a(new_n42_), .b(new_n41_), .c(new_n35_), .d(new_n32_), .O(z5));
  nand3  g26(.a(x9), .b(x8), .c(x5), .O(new_n44_));
  inv1   g27(.a(new_n44_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n18_), .c(new_n26_), .O(new_n46_));
  nor2   g29(.a(x9), .b(new_n36_), .O(new_n47_));
