...
module FAU ( 
  ...
  aoi21  g14(.a(new_n18_), .b(new_n21_), .c(x7), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(new_n29_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n19_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n18_), .O(z3));
  nand4  g18(.a(x9), .b(new_n21_), .c(x7), .d(x6), .O(z4));
