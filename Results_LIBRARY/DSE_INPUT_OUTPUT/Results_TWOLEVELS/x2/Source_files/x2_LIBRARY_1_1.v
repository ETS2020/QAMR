...
module FAU ( 
  ...
  nand3  g16(.a(x9), .b(x7), .c(x0), .O(new_n34_));
  nand2  g17(.a(new_n25_), .b(new_n18_), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n34_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n20_), .O(new_n37_));
  oai21  g20(.a(new_n30_), .b(new_n18_), .c(x0), .O(new_n38_));
  inv1   g21(.a(x2), .O(new_n39_));
  oai21  g22(.a(new_n25_), .b(x7), .c(new_n39_), .O(new_n40_));
  nor2   g23(.a(new_n40_), .b(x1), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n38_), .c(new_n37_), .d(new_n28_), .O(z3));
  inv1   g25(.a(x6), .O(new_n43_));
  oai21  g26(.a(new_n25_), .b(x0), .c(new_n43_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n38_), .c(new_n35_), .O(z4));
  ...
  nand2  g36(.a(new_n20_), .b(x7), .O(new_n54_));
  ...
  nand3  g43(.a(new_n60_), .b(new_n57_), .c(new_n44_), .O(z6));
endmodule
