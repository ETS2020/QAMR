...
module FAU ( 
  ...
  aoi22  g21(.a(new_n38_), .b(x6), .c(x9), .d(x8), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n34_), .c(new_n32_), .O(z3));
  aoi21  g23(.a(x9), .b(new_n20_), .c(new_n30_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(x9), .c(new_n22_), .O(new_n42_));
  oai21  g25(.a(x8), .b(new_n30_), .c(x9), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(new_n42_), .O(z4));
  xnor2a g27(.a(x8), .b(x7), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(x2), .c(new_n36_), .d(new_n35_), .O(new_n46_));
  nand3  g29(.a(x8), .b(new_n22_), .c(x5), .O(new_n47_));
  ...
  nand3  g39(.a(new_n56_), .b(new_n18_), .c(x6), .O(new_n57_));
  nand2  g40(.a(new_n47_), .b(x6), .O(new_n58_));
  aoi21  g41(.a(new_n38_), .b(x8), .c(new_n22_), .O(new_n59_));
