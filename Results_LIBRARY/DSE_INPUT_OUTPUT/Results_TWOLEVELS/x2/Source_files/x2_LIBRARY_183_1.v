...
module FAU ( 
  ...
  nand3  g04(.a(new_n21_), .b(x9), .c(x1), .O(new_n22_));
  ...
  oai21  g15(.a(new_n18_), .b(x1), .c(new_n32_), .O(new_n33_));
  nand2  g16(.a(new_n18_), .b(new_n27_), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(new_n22_), .O(z4));
  nand3  g18(.a(x8), .b(new_n27_), .c(x5), .O(new_n36_));
  ...
  nor2   g30(.a(new_n18_), .b(x1), .O(new_n48_));
  nand3  g31(.a(x9), .b(x8), .c(x5), .O(new_n49_));
  oai21  g32(.a(x9), .b(x8), .c(new_n49_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n27_), .c(new_n48_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n47_), .c(new_n33_), .O(z6));
endmodule
