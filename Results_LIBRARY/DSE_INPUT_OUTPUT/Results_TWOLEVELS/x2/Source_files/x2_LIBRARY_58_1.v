...
module FAU ( 
  ...
  nand4  g19(.a(x8), .b(new_n18_), .c(new_n36_), .d(new_n35_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n25_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n34_), .O(z3));
  inv1   g22(.a(x6), .O(new_n40_));
  nand2  g23(.a(x9), .b(new_n34_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand2  g25(.a(new_n25_), .b(new_n18_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n42_), .c(new_n29_), .O(z4));
  nand3  g27(.a(x9), .b(x8), .c(x7), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n32_), .O(new_n46_));
  ...
  nand4  g37(.a(new_n54_), .b(new_n50_), .c(new_n47_), .d(new_n41_), .O(z5));
  ...
  nand2  g42(.a(new_n59_), .b(new_n32_), .O(new_n60_));
