...
module FAU ( 
  ...
  nand2  g27(.a(new_n30_), .b(new_n18_), .O(new_n45_));
  ...
  nor2   g32(.a(new_n30_), .b(new_n19_), .O(new_n50_));
  ...
  nand3  g50(.a(new_n67_), .b(new_n62_), .c(new_n44_), .O(z6));
endmodule
