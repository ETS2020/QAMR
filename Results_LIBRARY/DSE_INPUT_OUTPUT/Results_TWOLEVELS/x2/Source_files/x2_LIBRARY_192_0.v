...
module FAU ( 
  ...
  nand2  g12(.a(new_n18_), .b(new_n20_), .O(new_n30_));
  oai21  g13(.a(new_n24_), .b(new_n29_), .c(new_n30_), .O(new_n31_));
  oai21  g14(.a(new_n18_), .b(new_n20_), .c(new_n31_), .O(z4));
  ...
  nand4  g25(.a(x9), .b(x8), .c(new_n24_), .d(x5), .O(new_n43_));
  nand4  g26(.a(new_n43_), .b(new_n42_), .c(new_n38_), .d(new_n37_), .O(z5));
  nand3  g27(.a(x9), .b(new_n24_), .c(x5), .O(new_n45_));
  nand4  g28(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n45_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x8), .O(new_n48_));
  inv1   g31(.a(x2), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(new_n34_), .c(new_n33_), .O(new_n50_));
