...
module FAU ( 
  ...
  oai21  g37(.a(new_n54_), .b(new_n40_), .c(x0), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n51_), .O(z5));
  inv1   g39(.a(x2), .O(new_n57_));
  nand3  g40(.a(x7), .b(new_n57_), .c(new_n46_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x9), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n26_), .O(new_n60_));
  oai21  g43(.a(x9), .b(x0), .c(new_n40_), .O(new_n61_));
  nand4  g44(.a(new_n27_), .b(x8), .c(x4), .d(x3), .O(new_n62_));
  oai21  g45(.a(new_n27_), .b(x8), .c(new_n62_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x7), .O(new_n64_));
  nand3  g47(.a(x9), .b(x8), .c(x5), .O(new_n65_));
  inv1   g48(.a(new_n65_), .O(new_n66_));
  oai21  g49(.a(new_n66_), .b(new_n20_), .c(new_n22_), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n64_), .c(new_n61_), .d(new_n60_), .O(z6));
endmodule
