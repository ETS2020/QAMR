...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_, new_n26_,
    new_n27_, new_n28_, new_n30_, new_n32_, new_n33_, new_n34_, new_n35_,
  ...
  nand4  g13(.a(new_n30_), .b(new_n18_), .c(x8), .d(new_n27_), .O(z3));
  inv1   g14(.a(x6), .O(new_n32_));
  nand2  g15(.a(new_n26_), .b(new_n32_), .O(new_n33_));
  oai21  g16(.a(new_n22_), .b(x5), .c(x9), .O(new_n34_));
  nand2  g17(.a(new_n18_), .b(new_n27_), .O(new_n35_));
  ...
  nand2  g31(.a(x9), .b(x7), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n35_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n21_), .O(new_n51_));
  inv1   g34(.a(x2), .O(new_n52_));
  nand4  g35(.a(x9), .b(new_n52_), .c(new_n38_), .d(new_n37_), .O(new_n53_));
  ...
  nand4  g39(.a(new_n56_), .b(new_n51_), .c(new_n26_), .d(x6), .O(z6));
endmodule
