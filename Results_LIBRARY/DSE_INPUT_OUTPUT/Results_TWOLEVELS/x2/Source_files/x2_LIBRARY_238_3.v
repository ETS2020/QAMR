...
module FAU ( 
  ...
  nand3  g13(.a(x8), .b(new_n18_), .c(new_n30_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(new_n29_), .c(new_n20_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n23_), .O(z3));
  nand3  g16(.a(new_n20_), .b(x7), .c(x6), .O(z4));
  ...
  nand3  g22(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n40_));
  nand4  g23(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n40_), .c(new_n20_), .d(x6), .O(z6));
endmodule
