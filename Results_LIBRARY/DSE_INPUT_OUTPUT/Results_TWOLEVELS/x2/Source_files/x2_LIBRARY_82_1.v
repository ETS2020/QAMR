...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(new_n27_), .c(new_n23_), .O(z3));
  inv1   g16(.a(x6), .O(new_n34_));
  aoi21  g17(.a(x9), .b(x8), .c(new_n34_), .O(new_n35_));
  nand2  g18(.a(new_n19_), .b(new_n20_), .O(new_n36_));
  oai21  g19(.a(new_n36_), .b(new_n20_), .c(new_n18_), .O(new_n37_));
  ...
  oai21  g32(.a(new_n49_), .b(new_n24_), .c(new_n48_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x7), .O(new_n51_));
  inv1   g34(.a(new_n40_), .O(new_n52_));
  nor2   g35(.a(new_n19_), .b(x2), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n52_), .c(z2), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n51_), .c(new_n39_), .O(z6));
endmodule
