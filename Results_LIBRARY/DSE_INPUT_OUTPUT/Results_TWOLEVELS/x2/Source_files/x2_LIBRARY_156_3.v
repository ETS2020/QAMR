...
module FAU ( 
  ...
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(new_n20_), .d(new_n25_), .O(z3));
  oai21  g12(.a(x8), .b(x7), .c(x6), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n18_), .O(new_n31_));
  oai21  g14(.a(new_n21_), .b(x7), .c(new_n31_), .O(z4));
  ...
  nand4  g27(.a(new_n44_), .b(new_n38_), .c(new_n35_), .d(x6), .O(z5));
  ...
  nand4  g32(.a(new_n49_), .b(new_n48_), .c(new_n23_), .d(x6), .O(z6));
endmodule
