...
module FAU ( 
  ...
  nand3  g12(.a(new_n29_), .b(new_n26_), .c(new_n28_), .O(new_n30_));
  ...
  nand4  g32(.a(new_n49_), .b(new_n47_), .c(new_n45_), .d(new_n36_), .O(z6));
endmodule
