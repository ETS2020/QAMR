...
module FAU ( 
  ...
  aoi21  g26(.a(x9), .b(new_n21_), .c(x3), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(x9), .c(new_n23_), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n35_), .c(new_n43_), .d(x6), .O(z4));
  oai21  g29(.a(new_n21_), .b(x3), .c(new_n19_), .O(new_n47_));
  nand2  g30(.a(new_n21_), .b(new_n23_), .O(new_n48_));
  oai21  g31(.a(new_n35_), .b(new_n23_), .c(new_n48_), .O(new_n49_));
  ...
  aoi21  g36(.a(new_n53_), .b(new_n36_), .c(new_n51_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n50_), .c(new_n47_), .O(z5));
  aoi21  g38(.a(new_n40_), .b(x8), .c(new_n23_), .O(new_n56_));
  nand3  g39(.a(x8), .b(new_n23_), .c(x5), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n56_), .c(x9), .O(new_n59_));
  nand2  g42(.a(new_n48_), .b(new_n18_), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(new_n19_), .c(new_n51_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n59_), .O(z6));
endmodule
