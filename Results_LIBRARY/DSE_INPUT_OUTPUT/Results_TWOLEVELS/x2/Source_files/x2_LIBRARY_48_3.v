...
module FAU ( 
  ...
  nand3  g09(.a(new_n26_), .b(new_n20_), .c(new_n25_), .O(new_n27_));
  nand2  g10(.a(new_n27_), .b(new_n18_), .O(z2));
  inv1   g11(.a(x2), .O(new_n29_));
  nand3  g12(.a(new_n26_), .b(x8), .c(new_n25_), .O(new_n30_));
  inv1   g13(.a(new_n30_), .O(new_n31_));
  nor2   g14(.a(x1), .b(x0), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n18_), .d(new_n29_), .O(z3));
  nand2  g16(.a(x9), .b(x8), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(x7), .c(x6), .O(new_n35_));
  and2   g18(.a(new_n35_), .b(new_n18_), .O(z4));
  inv1   g19(.a(x0), .O(new_n37_));
  inv1   g20(.a(x1), .O(new_n38_));
  nand2  g21(.a(new_n20_), .b(new_n25_), .O(new_n39_));
  oai21  g22(.a(new_n34_), .b(new_n25_), .c(new_n39_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(x2), .c(new_n38_), .d(new_n37_), .O(new_n41_));
  inv1   g24(.a(x4), .O(new_n42_));
  nand3  g25(.a(new_n26_), .b(x7), .c(x3), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x6), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n42_), .O(new_n45_));
  oai21  g28(.a(new_n34_), .b(x7), .c(new_n42_), .O(new_n46_));
  oai22  g29(.a(x9), .b(x8), .c(x6), .d(x5), .O(new_n47_));
  aoi21  g30(.a(new_n46_), .b(x5), .c(new_n47_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n45_), .c(new_n41_), .O(z5));
  nand4  g32(.a(new_n26_), .b(x8), .c(x7), .d(x3), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(x5), .c(x4), .O(new_n52_));
  inv1   g35(.a(x6), .O(new_n53_));
  nand2  g36(.a(new_n18_), .b(new_n53_), .O(new_n54_));
  nand3  g37(.a(new_n29_), .b(new_n38_), .c(new_n37_), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(x8), .c(new_n25_), .O(new_n56_));
  nand3  g39(.a(x8), .b(new_n25_), .c(x5), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n56_), .c(x9), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n54_), .c(new_n52_), .d(new_n27_), .O(z6));
endmodule
