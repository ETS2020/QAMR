...
module FAU ( 
  ...
  oai21  g26(.a(new_n29_), .b(x3), .c(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n27_), .b(new_n34_), .c(x9), .O(new_n45_));
  nand2  g28(.a(new_n29_), .b(new_n18_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(z4));
  nand2  g30(.a(x9), .b(x8), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n18_), .c(new_n32_), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(x2), .c(new_n38_), .d(new_n37_), .O(new_n50_));
  nand2  g33(.a(new_n18_), .b(x5), .O(new_n51_));
  nand2  g34(.a(new_n29_), .b(x7), .O(new_n52_));
  oai22  g35(.a(new_n52_), .b(x4), .c(new_n51_), .d(new_n48_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x3), .O(new_n54_));
  aoi21  g37(.a(x9), .b(new_n34_), .c(new_n24_), .O(new_n55_));
  nand4  g38(.a(new_n55_), .b(new_n54_), .c(new_n50_), .d(new_n44_), .O(z5));
  ...
  aoi21  g43(.a(new_n60_), .b(new_n37_), .c(new_n19_), .O(new_n61_));
  nand3  g44(.a(new_n29_), .b(x8), .c(x4), .O(new_n62_));
  oai21  g45(.a(new_n61_), .b(new_n29_), .c(new_n62_), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(x7), .c(x3), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n59_), .c(new_n44_), .O(z6));
endmodule
