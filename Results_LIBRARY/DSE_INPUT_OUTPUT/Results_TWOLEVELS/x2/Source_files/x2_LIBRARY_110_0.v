...
module FAU ( 
  ...
  nor2   g05(.a(x8), .b(new_n18_), .O(new_n24_));
  oai21  g06(.a(new_n19_), .b(new_n21_), .c(x7), .O(new_n25_));
  oai21  g07(.a(new_n24_), .b(new_n19_), .c(new_n25_), .O(z3));
  ...
  oai21  g18(.a(new_n21_), .b(new_n36_), .c(x9), .O(new_n37_));
  nand2  g19(.a(new_n37_), .b(new_n18_), .O(new_n38_));
  inv1   g20(.a(x3), .O(new_n39_));
  nor2   g21(.a(x4), .b(new_n39_), .O(new_n40_));
  oai21  g22(.a(new_n40_), .b(new_n24_), .c(new_n19_), .O(new_n41_));
  nand4  g23(.a(new_n41_), .b(new_n38_), .c(new_n35_), .d(new_n33_), .O(z5));
  nand3  g24(.a(x9), .b(new_n18_), .c(x5), .O(new_n43_));
  nand4  g25(.a(new_n19_), .b(x7), .c(x4), .d(x3), .O(new_n44_));
  nand2  g26(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g27(.a(new_n45_), .b(x8), .O(new_n46_));
  inv1   g28(.a(x2), .O(new_n47_));
  nand3  g29(.a(new_n47_), .b(new_n30_), .c(new_n29_), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(x8), .O(new_n49_));
  nand3  g31(.a(new_n49_), .b(x9), .c(x7), .O(new_n50_));
  nand3  g32(.a(new_n50_), .b(new_n46_), .c(new_n35_), .O(z6));
  zero   g33(.O(z2));
endmodule
