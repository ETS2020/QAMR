...
module FAU ( 
  ...
  nor2   g11(.a(new_n19_), .b(x7), .O(new_n29_));
  ...
  nand4  g17(.a(new_n34_), .b(new_n20_), .c(x8), .d(x6), .O(z5));
  nand3  g18(.a(new_n20_), .b(new_n19_), .c(new_n18_), .O(new_n36_));
  nand4  g19(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(new_n20_), .d(x6), .O(z6));
endmodule
