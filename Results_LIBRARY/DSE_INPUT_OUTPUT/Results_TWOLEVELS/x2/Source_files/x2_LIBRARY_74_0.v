...
module FAU ( 
  ...
  nand3  g11(.a(x8), .b(new_n22_), .c(x4), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n18_), .O(new_n30_));
  nand2  g13(.a(new_n20_), .b(new_n22_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(new_n22_), .c(x9), .O(new_n32_));
  ...
  nand2  g24(.a(new_n18_), .b(new_n41_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n40_), .O(new_n43_));
  aoi21  g26(.a(x9), .b(new_n20_), .c(new_n41_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(x9), .c(new_n22_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n43_), .c(new_n39_), .O(z4));
  nand2  g29(.a(new_n20_), .b(new_n22_), .O(new_n47_));
  oai21  g30(.a(new_n39_), .b(new_n22_), .c(new_n47_), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(x2), .c(new_n34_), .d(new_n33_), .O(new_n49_));
  aoi21  g32(.a(x8), .b(x4), .c(x9), .O(new_n50_));
  inv1   g33(.a(new_n39_), .O(new_n51_));
  inv1   g34(.a(x5), .O(new_n52_));
  nor2   g35(.a(x7), .b(new_n52_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n51_), .c(new_n50_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n49_), .c(new_n43_), .O(z5));
  nor3   g38(.a(x9), .b(x8), .c(x7), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n40_), .c(x4), .O(new_n57_));
  nand3  g40(.a(x9), .b(new_n22_), .c(x5), .O(new_n58_));
  nand3  g41(.a(new_n18_), .b(x7), .c(x3), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n58_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x8), .O(new_n61_));
  aoi21  g44(.a(new_n36_), .b(x8), .c(new_n22_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n40_), .c(x9), .O(new_n63_));
  nand4  g46(.a(new_n63_), .b(new_n61_), .c(new_n57_), .d(new_n42_), .O(z6));
endmodule
