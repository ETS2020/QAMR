...
module FAU ( 
  ...
  nand4  g11(.a(new_n28_), .b(new_n18_), .c(x8), .d(new_n27_), .O(z3));
  inv1   g12(.a(x6), .O(new_n30_));
  nand2  g13(.a(x9), .b(x5), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n30_), .O(new_n32_));
  nand2  g15(.a(new_n18_), .b(new_n27_), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n32_), .c(new_n23_), .O(z4));
  ...
  nand4  g37(.a(new_n54_), .b(new_n49_), .c(new_n31_), .d(x6), .O(z6));
endmodule
