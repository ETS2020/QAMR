...
module FAU ( 
  ...
  nand2  g03(.a(new_n19_), .b(x3), .O(new_n21_));
  ...
  nand4  g24(.a(new_n41_), .b(new_n40_), .c(new_n35_), .d(new_n33_), .O(z3));
  inv1   g25(.a(x6), .O(new_n43_));
  nand2  g26(.a(new_n21_), .b(new_n43_), .O(new_n44_));
  aoi21  g27(.a(x9), .b(new_n22_), .c(x3), .O(new_n45_));
  ...
  aoi21  g42(.a(new_n39_), .b(x8), .c(new_n24_), .O(new_n60_));
