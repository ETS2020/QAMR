...
module FAU ( 
  ...
  oai21  g05(.a(new_n18_), .b(new_n20_), .c(x7), .O(new_n23_));
  inv1   g06(.a(x7), .O(new_n24_));
  oai21  g07(.a(x8), .b(new_n24_), .c(x9), .O(new_n25_));
  nand2  g08(.a(new_n25_), .b(new_n23_), .O(z3));
  ...
  aoi21  g21(.a(new_n38_), .b(new_n18_), .c(new_n36_), .O(new_n39_));
  ...
  aoi21  g29(.a(new_n46_), .b(new_n45_), .c(new_n36_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n44_), .c(new_n35_), .O(z6));
endmodule
