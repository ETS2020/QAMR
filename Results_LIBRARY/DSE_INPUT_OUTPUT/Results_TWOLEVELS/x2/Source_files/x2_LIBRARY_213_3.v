...
module FAU ( 
  ...
  aoi21  g21(.a(new_n26_), .b(new_n18_), .c(x2), .O(new_n39_));
  ...
  nor2   g29(.a(new_n19_), .b(new_n21_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x7), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n33_), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(x2), .c(new_n46_), .d(new_n45_), .O(new_n50_));
  oai21  g33(.a(new_n18_), .b(x4), .c(new_n19_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x3), .O(new_n52_));
  nand3  g35(.a(new_n47_), .b(new_n18_), .c(x5), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x6), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n24_), .O(new_n55_));
  oai21  g38(.a(new_n21_), .b(new_n41_), .c(new_n19_), .O(new_n56_));
  nand4  g39(.a(new_n56_), .b(new_n55_), .c(new_n52_), .d(new_n50_), .O(z5));
  nand3  g40(.a(new_n47_), .b(x5), .c(new_n24_), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n26_), .c(new_n18_), .O(new_n60_));
  inv1   g43(.a(x2), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n46_), .c(new_n45_), .O(new_n62_));
  ...
  nand3  g50(.a(new_n67_), .b(new_n60_), .c(new_n42_), .O(z6));
endmodule
