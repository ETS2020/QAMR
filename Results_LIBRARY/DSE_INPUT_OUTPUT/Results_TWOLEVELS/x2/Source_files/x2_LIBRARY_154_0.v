...
module FAU ( 
  ...
  aoi21  g13(.a(new_n30_), .b(x0), .c(x9), .O(z2));
  ...
  nor2   g21(.a(x9), .b(x0), .O(new_n39_));
  aoi21  g22(.a(x9), .b(x8), .c(new_n39_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n38_), .c(new_n36_), .O(z3));
  inv1   g24(.a(x6), .O(new_n42_));
  oai21  g25(.a(x9), .b(x0), .c(new_n42_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n40_), .c(new_n38_), .O(z4));
  inv1   g27(.a(x1), .O(new_n45_));
  xnor2a g28(.a(x8), .b(x7), .O(new_n46_));
  nand4  g29(.a(new_n46_), .b(x2), .c(new_n45_), .d(new_n34_), .O(new_n47_));
  nand3  g30(.a(x8), .b(new_n22_), .c(x5), .O(new_n48_));
  ...
  oai21  g36(.a(new_n53_), .b(new_n42_), .c(x0), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n50_), .O(z5));
  nand4  g38(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n30_), .O(new_n57_));
  nand3  g40(.a(new_n57_), .b(new_n32_), .c(x0), .O(new_n58_));
  inv1   g41(.a(new_n48_), .O(new_n59_));
  inv1   g42(.a(x2), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n45_), .c(new_n34_), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(x8), .c(new_n22_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n59_), .c(x9), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n58_), .c(new_n43_), .O(z6));
endmodule
