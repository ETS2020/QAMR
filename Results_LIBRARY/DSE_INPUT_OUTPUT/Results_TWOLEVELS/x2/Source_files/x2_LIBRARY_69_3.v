...
module FAU ( 
  ...
  oai21  g17(.a(new_n33_), .b(x7), .c(new_n34_), .O(z2));
  oai21  g18(.a(x8), .b(x0), .c(x9), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  nand3  g20(.a(new_n29_), .b(x9), .c(new_n24_), .O(new_n38_));
  nor2   g21(.a(x1), .b(x0), .O(new_n39_));
  aoi21  g22(.a(new_n26_), .b(new_n18_), .c(x2), .O(new_n40_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n38_), .O(z4));
  ...
  nand4  g39(.a(new_n56_), .b(new_n52_), .c(new_n48_), .d(new_n34_), .O(z5));
