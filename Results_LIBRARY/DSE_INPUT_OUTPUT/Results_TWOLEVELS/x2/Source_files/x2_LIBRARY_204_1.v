...
module FAU ( 
  ...
  oai22  g15(.a(new_n26_), .b(x7), .c(new_n25_), .d(x0), .O(z2));
  ...
  oai21  g21(.a(new_n25_), .b(x0), .c(new_n38_), .O(new_n39_));
  nand3  g22(.a(new_n29_), .b(x9), .c(x0), .O(new_n40_));
  ...
  nand3  g39(.a(new_n56_), .b(new_n53_), .c(new_n39_), .O(z6));
endmodule
