...
module FAU ( 
  ...
  nand2  g21(.a(x9), .b(new_n38_), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(new_n21_), .c(new_n19_), .O(z4));
  oai21  g23(.a(new_n25_), .b(new_n18_), .c(new_n27_), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n42_));
  oai21  g25(.a(x9), .b(new_n18_), .c(new_n38_), .O(new_n43_));
  nand3  g26(.a(x9), .b(x8), .c(x5), .O(new_n44_));
  inv1   g27(.a(new_n44_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n24_), .c(new_n18_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n43_), .c(new_n42_), .O(z5));
  aoi21  g30(.a(new_n35_), .b(x8), .c(new_n18_), .O(new_n48_));
  nand3  g31(.a(x8), .b(new_n18_), .c(x5), .O(new_n49_));
  inv1   g32(.a(new_n49_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n48_), .c(x9), .O(new_n51_));
  nand2  g34(.a(new_n24_), .b(new_n18_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n51_), .c(new_n43_), .O(z6));
endmodule
