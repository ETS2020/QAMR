...
module FAU ( 
  ...
  nand4  g12(.a(x9), .b(new_n20_), .c(x7), .d(x6), .O(z4));
  xnor2a g13(.a(x8), .b(x7), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(x2), .c(new_n26_), .d(new_n25_), .O(new_n32_));
  ...
  aoi21  g19(.a(new_n36_), .b(new_n35_), .c(new_n33_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n32_), .c(new_n27_), .O(z5));
  nand2  g21(.a(new_n22_), .b(new_n20_), .O(new_n39_));
  nor3   g22(.a(x2), .b(x1), .c(x0), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(new_n18_), .c(x7), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n39_), .c(new_n37_), .O(z6));
endmodule
