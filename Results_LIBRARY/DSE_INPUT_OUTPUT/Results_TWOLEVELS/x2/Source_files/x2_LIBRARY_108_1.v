...
module FAU ( 
  ...
  oai21  g07(.a(new_n20_), .b(x7), .c(new_n24_), .O(z1));
  nor3   g08(.a(x9), .b(x8), .c(x7), .O(z2));
  inv1   g09(.a(x2), .O(new_n27_));
  inv1   g10(.a(x0), .O(new_n28_));
  inv1   g11(.a(x1), .O(new_n29_));
  nand4  g12(.a(new_n18_), .b(x8), .c(new_n29_), .d(new_n28_), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(new_n21_), .O(new_n31_));
  nand2  g14(.a(new_n31_), .b(new_n27_), .O(z3));
  oai21  g15(.a(new_n18_), .b(new_n27_), .c(x7), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(x8), .O(new_n34_));
  inv1   g17(.a(x8), .O(new_n35_));
  oai21  g18(.a(x9), .b(new_n35_), .c(new_n21_), .O(new_n36_));
  nand2  g19(.a(x7), .b(new_n27_), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(new_n34_), .d(x6), .O(z4));
  nand3  g21(.a(new_n35_), .b(new_n21_), .c(x2), .O(new_n39_));
  ...
  nand3  g26(.a(new_n18_), .b(new_n43_), .c(x3), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x2), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x7), .O(new_n46_));
  inv1   g29(.a(new_n20_), .O(new_n47_));
  ...
  oai21  g36(.a(new_n53_), .b(new_n20_), .c(new_n21_), .O(new_n54_));
  nand2  g37(.a(x9), .b(new_n35_), .O(new_n55_));
