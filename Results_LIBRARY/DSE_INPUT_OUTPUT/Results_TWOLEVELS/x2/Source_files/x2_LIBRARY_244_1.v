...
module FAU ( 
  ...
  oai21  g14(.a(new_n21_), .b(x8), .c(new_n19_), .O(new_n32_));
  inv1   g15(.a(x6), .O(new_n33_));
  nand2  g16(.a(new_n21_), .b(new_n33_), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n32_), .c(new_n31_), .O(z4));
  inv1   g18(.a(x0), .O(new_n36_));
  inv1   g19(.a(x1), .O(new_n37_));
  nand4  g20(.a(x9), .b(x2), .c(new_n37_), .d(new_n36_), .O(new_n38_));
  ...
  nand3  g25(.a(x9), .b(new_n19_), .c(x5), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(x8), .c(x6), .O(new_n44_));
  inv1   g27(.a(new_n44_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n42_), .O(z5));
  nand4  g29(.a(x9), .b(new_n26_), .c(new_n37_), .d(new_n36_), .O(new_n47_));
  nand4  g30(.a(new_n21_), .b(x8), .c(x4), .d(x3), .O(new_n48_));
  ...
  oai21  g35(.a(new_n21_), .b(x8), .c(x6), .O(new_n53_));
  aoi21  g36(.a(new_n52_), .b(new_n19_), .c(new_n53_), .O(new_n54_));
