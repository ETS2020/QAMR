...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(x1), .c(x9), .O(new_n31_));
  ...
  nand3  g41(.a(x7), .b(new_n47_), .c(new_n46_), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n58_), .c(new_n30_), .d(new_n24_), .O(new_n60_));
  ...
  nand3  g47(.a(new_n64_), .b(new_n61_), .c(new_n43_), .O(z6));
endmodule
