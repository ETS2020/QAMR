...
module FAU ( 
  ...
  oai21  g07(.a(new_n20_), .b(x7), .c(new_n22_), .O(new_n25_));
  oai21  g08(.a(x8), .b(new_n19_), .c(x9), .O(new_n26_));
  nand3  g09(.a(new_n26_), .b(new_n25_), .c(new_n24_), .O(z0));
  aoi21  g10(.a(x9), .b(new_n18_), .c(x8), .O(new_n28_));
  oai21  g11(.a(x8), .b(x7), .c(new_n20_), .O(new_n29_));
  oai21  g12(.a(new_n28_), .b(new_n19_), .c(new_n29_), .O(z1));
  nand2  g13(.a(x9), .b(new_n19_), .O(new_n31_));
  nor2   g14(.a(x9), .b(x8), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n18_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n31_), .O(z2));
  oai21  g17(.a(new_n20_), .b(new_n22_), .c(x7), .O(new_n35_));
  nor2   g18(.a(x1), .b(x0), .O(new_n36_));
  nor2   g19(.a(x8), .b(x7), .O(new_n37_));
  aoi22  g20(.a(new_n37_), .b(new_n36_), .c(x8), .d(x2), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n36_), .c(new_n35_), .d(new_n31_), .O(z3));
  oai21  g22(.a(x9), .b(new_n18_), .c(x8), .O(new_n40_));
  oai21  g23(.a(new_n32_), .b(new_n21_), .c(new_n18_), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n40_), .c(new_n31_), .d(x6), .O(z4));
  ...
  nand4  g37(.a(new_n54_), .b(new_n50_), .c(new_n47_), .d(x6), .O(z5));
  nand2  g38(.a(x9), .b(new_n22_), .O(new_n56_));
  ...
  oai21  g42(.a(new_n20_), .b(x2), .c(x6), .O(new_n60_));
  nand3  g43(.a(x9), .b(x8), .c(x5), .O(new_n61_));
  oai21  g44(.a(x9), .b(x8), .c(new_n61_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n18_), .c(new_n60_), .O(new_n63_));
