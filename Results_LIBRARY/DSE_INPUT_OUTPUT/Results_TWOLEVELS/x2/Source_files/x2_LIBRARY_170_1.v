...
module FAU ( 
  ...
  nand3  g14(.a(new_n22_), .b(x9), .c(x5), .O(new_n32_));
  ...
  nand4  g20(.a(new_n22_), .b(x2), .c(new_n37_), .d(new_n36_), .O(new_n38_));
  ...
  nand4  g35(.a(x8), .b(new_n52_), .c(new_n37_), .d(new_n36_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x5), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x9), .O(new_n55_));
  oai21  g38(.a(x8), .b(x7), .c(x6), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n18_), .O(new_n57_));
  nand4  g40(.a(new_n57_), .b(new_n55_), .c(new_n51_), .d(new_n48_), .O(z6));
endmodule
