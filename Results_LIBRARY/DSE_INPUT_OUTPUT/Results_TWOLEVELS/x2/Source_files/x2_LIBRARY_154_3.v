...
module FAU ( 
  ...
  nor2   g23(.a(x2), .b(x0), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n40_), .c(new_n36_), .d(new_n30_), .O(z3));
  inv1   g25(.a(x6), .O(new_n43_));
  nand2  g26(.a(new_n33_), .b(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n29_), .b(x0), .c(x9), .O(new_n45_));
  ...
  aoi21  g32(.a(new_n49_), .b(new_n38_), .c(new_n48_), .O(new_n50_));
  nand4  g33(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x6), .O(new_n52_));
  aoi21  g35(.a(new_n50_), .b(new_n37_), .c(new_n52_), .O(new_n53_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n61_), .c(new_n44_), .O(z6));
endmodule
