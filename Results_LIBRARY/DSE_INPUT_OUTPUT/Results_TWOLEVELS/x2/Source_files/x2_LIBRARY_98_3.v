...
module FAU ( 
  ...
  nand4  g16(.a(new_n21_), .b(x2), .c(new_n25_), .d(new_n24_), .O(new_n34_));
  ...
  nand3  g24(.a(new_n41_), .b(new_n37_), .c(new_n33_), .O(z5));
  ...
  oai21  g29(.a(new_n46_), .b(new_n27_), .c(new_n20_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n45_), .c(new_n33_), .O(z6));
endmodule
