...
module FAU ( 
  ...
  nand3  g26(.a(new_n43_), .b(new_n37_), .c(new_n30_), .O(z3));
  inv1   g27(.a(x6), .O(new_n45_));
  nand2  g28(.a(new_n33_), .b(new_n45_), .O(new_n46_));
  oai21  g29(.a(new_n29_), .b(x3), .c(x9), .O(new_n47_));
  ...
  nand3  g42(.a(x7), .b(new_n59_), .c(x3), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(x8), .c(x6), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n19_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n58_), .O(z5));
  nand3  g46(.a(x8), .b(x7), .c(x4), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x3), .O(new_n66_));
  nand3  g49(.a(x8), .b(new_n18_), .c(x5), .O(new_n67_));
  aoi21  g50(.a(new_n67_), .b(new_n29_), .c(x3), .O(new_n68_));
  nand4  g51(.a(x7), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n69_));
  inv1   g52(.a(new_n69_), .O(new_n70_));
  oai21  g53(.a(new_n70_), .b(new_n68_), .c(x9), .O(new_n71_));
  nand4  g54(.a(new_n71_), .b(new_n66_), .c(new_n46_), .d(new_n34_), .O(z6));
endmodule
