...
module FAU ( 
  ...
  oai21  g10(.a(new_n26_), .b(x6), .c(new_n27_), .O(z1));
  nand2  g11(.a(new_n20_), .b(new_n19_), .O(new_n29_));
  aoi21  g12(.a(new_n29_), .b(new_n18_), .c(x9), .O(z2));
  inv1   g13(.a(x2), .O(new_n31_));
  nor2   g14(.a(x1), .b(x0), .O(new_n32_));
  nor2   g15(.a(x9), .b(new_n18_), .O(new_n33_));
  aoi21  g16(.a(x9), .b(new_n19_), .c(new_n33_), .O(new_n34_));
  nor2   g17(.a(new_n19_), .b(x2), .O(new_n35_));
  aoi22  g18(.a(new_n35_), .b(new_n32_), .c(new_n20_), .d(new_n18_), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(new_n34_), .c(new_n32_), .d(new_n31_), .O(z3));
  nand2  g20(.a(new_n27_), .b(x6), .O(z4));
  ...
  nand2  g28(.a(new_n45_), .b(x6), .O(z5));
  nor3   g29(.a(x2), .b(x1), .c(x0), .O(new_n47_));
  nor2   g30(.a(new_n25_), .b(x8), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n47_), .c(x7), .O(new_n49_));
  nand4  g32(.a(x9), .b(x8), .c(new_n19_), .d(x5), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(new_n49_), .c(x9), .d(x6), .O(z6));
endmodule
