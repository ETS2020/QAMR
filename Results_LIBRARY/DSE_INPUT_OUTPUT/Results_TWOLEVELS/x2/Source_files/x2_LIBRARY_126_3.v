...
module FAU ( 
  ...
  nand2  g15(.a(x9), .b(x5), .O(new_n33_));
  ...
  nand2  g22(.a(new_n21_), .b(new_n18_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n19_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n36_), .c(new_n30_), .O(z3));
  inv1   g26(.a(x6), .O(new_n44_));
  nand2  g27(.a(new_n33_), .b(new_n44_), .O(new_n45_));
  oai21  g28(.a(new_n29_), .b(x5), .c(x9), .O(new_n46_));
  nand2  g29(.a(new_n19_), .b(new_n18_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n45_), .O(z4));
  ...
  nand3  g41(.a(x9), .b(new_n21_), .c(x7), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x6), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n24_), .O(new_n61_));
  nand4  g44(.a(x9), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n62_));
  ...
  nand4  g50(.a(new_n67_), .b(new_n65_), .c(new_n61_), .d(new_n33_), .O(z6));
endmodule
