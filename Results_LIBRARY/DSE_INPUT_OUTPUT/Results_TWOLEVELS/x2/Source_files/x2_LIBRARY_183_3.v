...
module FAU ( 
  ...
  nand4  g21(.a(new_n33_), .b(new_n38_), .c(new_n24_), .d(new_n37_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n19_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n36_), .c(new_n30_), .O(z3));
  inv1   g24(.a(x6), .O(new_n42_));
  nand2  g25(.a(x9), .b(x1), .O(new_n43_));
  ...
  nand3  g31(.a(new_n48_), .b(x2), .c(new_n37_), .O(new_n49_));
  ...
  nand4  g39(.a(new_n56_), .b(new_n52_), .c(new_n49_), .d(new_n44_), .O(z5));
  nand3  g40(.a(x9), .b(new_n21_), .c(x7), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x6), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n24_), .O(new_n60_));
  nand3  g43(.a(x9), .b(new_n38_), .c(new_n37_), .O(new_n61_));
  ...
  oai21  g49(.a(x9), .b(x6), .c(new_n43_), .O(new_n67_));
  aoi21  g50(.a(new_n66_), .b(new_n18_), .c(new_n67_), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n64_), .c(new_n60_), .O(z6));
endmodule
