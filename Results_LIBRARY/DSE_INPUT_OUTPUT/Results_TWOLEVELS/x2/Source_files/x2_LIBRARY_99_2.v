...
module FAU ( 
  ...
  oai21  g10(.a(new_n19_), .b(x0), .c(new_n27_), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n23_), .O(new_n29_));
  oai21  g12(.a(x7), .b(x0), .c(new_n27_), .O(new_n30_));
  ...
  oai21  g19(.a(new_n19_), .b(x0), .c(new_n27_), .O(new_n37_));
  nor2   g20(.a(x2), .b(x1), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(z3));
  inv1   g22(.a(x6), .O(new_n40_));
  oai21  g23(.a(new_n20_), .b(new_n40_), .c(new_n18_), .O(new_n41_));
  oai21  g24(.a(x9), .b(new_n19_), .c(new_n23_), .O(new_n42_));
  oai21  g25(.a(x8), .b(new_n40_), .c(x9), .O(new_n43_));
  nand2  g26(.a(new_n27_), .b(x0), .O(new_n44_));
  nand4  g27(.a(new_n44_), .b(new_n43_), .c(new_n42_), .d(new_n41_), .O(z4));
  inv1   g28(.a(x1), .O(new_n46_));
  nand3  g29(.a(x9), .b(x8), .c(x7), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n33_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(x2), .c(new_n46_), .O(new_n49_));
  ...
  nand2  g38(.a(new_n20_), .b(x5), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x6), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x9), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n55_), .O(z5));
  nand3  g42(.a(new_n38_), .b(x9), .c(x7), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x6), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n18_), .O(new_n62_));
  nand4  g45(.a(new_n27_), .b(x8), .c(x4), .d(x3), .O(new_n63_));
  oai21  g46(.a(new_n27_), .b(x8), .c(new_n63_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x7), .O(new_n65_));
  nand3  g48(.a(x9), .b(x8), .c(x5), .O(new_n66_));
  oai21  g49(.a(x9), .b(x8), .c(new_n66_), .O(new_n67_));
  oai21  g50(.a(new_n27_), .b(x6), .c(new_n44_), .O(new_n68_));
  aoi21  g51(.a(new_n67_), .b(new_n23_), .c(new_n68_), .O(new_n69_));
  nand3  g52(.a(new_n69_), .b(new_n65_), .c(new_n62_), .O(z6));
endmodule
