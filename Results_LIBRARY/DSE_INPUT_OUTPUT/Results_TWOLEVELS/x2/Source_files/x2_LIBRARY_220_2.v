...
module FAU ( 
  ...
  oai21  g35(.a(new_n19_), .b(x7), .c(x9), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x5), .O(new_n54_));
  oai21  g37(.a(new_n21_), .b(new_n43_), .c(new_n18_), .O(new_n55_));
  inv1   g38(.a(x3), .O(new_n56_));
  nor2   g39(.a(x4), .b(new_n56_), .O(new_n57_));
  nor2   g40(.a(x9), .b(new_n23_), .O(new_n58_));
  aoi22  g41(.a(new_n58_), .b(new_n57_), .c(x9), .d(new_n43_), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n55_), .c(new_n54_), .d(new_n52_), .O(z5));
  nand4  g43(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n33_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n27_), .c(new_n18_), .O(new_n63_));
  nand3  g46(.a(new_n37_), .b(new_n49_), .c(new_n48_), .O(new_n64_));
