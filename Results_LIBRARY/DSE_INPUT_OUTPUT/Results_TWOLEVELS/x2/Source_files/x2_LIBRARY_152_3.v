...
module FAU ( 
  ...
  nand3  g40(.a(new_n57_), .b(new_n45_), .c(new_n44_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x8), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(x9), .c(new_n24_), .O(new_n60_));
  nand3  g43(.a(new_n22_), .b(x4), .c(x3), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n60_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(x7), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n41_), .c(new_n56_), .O(z6));
endmodule
