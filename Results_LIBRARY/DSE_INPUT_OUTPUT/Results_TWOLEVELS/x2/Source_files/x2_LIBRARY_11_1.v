...
module FAU ( 
  ...
  aoi21  g36(.a(new_n53_), .b(new_n51_), .c(new_n44_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n50_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x4), .O(new_n56_));
  nand3  g39(.a(x7), .b(new_n35_), .c(x3), .O(new_n57_));
  ...
  aoi21  g47(.a(new_n64_), .b(new_n38_), .c(new_n19_), .O(new_n65_));
  ...
  nand3  g51(.a(new_n68_), .b(new_n63_), .c(new_n45_), .O(z6));
endmodule
