...
module FAU ( 
  ...
  oai21  g18(.a(new_n35_), .b(x9), .c(x7), .O(new_n36_));
  ...
  nand4  g24(.a(x9), .b(x8), .c(new_n21_), .d(x5), .O(new_n42_));
  ...
  oai21  g28(.a(new_n45_), .b(new_n18_), .c(new_n21_), .O(new_n46_));
  nor2   g29(.a(x9), .b(new_n26_), .O(new_n47_));
