...
module FAU ( 
  ...
  nor2   g06(.a(x8), .b(x7), .O(new_n25_));
  nand3  g07(.a(new_n25_), .b(x9), .c(x7), .O(z3));
  inv1   g08(.a(x7), .O(new_n27_));
  oai21  g09(.a(new_n27_), .b(x6), .c(new_n22_), .O(z4));
  ...
  nand3  g24(.a(x9), .b(new_n27_), .c(x5), .O(new_n43_));
  ...
  nand3  g32(.a(new_n50_), .b(new_n46_), .c(new_n42_), .O(z6));
  zero   g33(.O(z2));
endmodule
