...
module FAU ( 
  ...
  nand2  g11(.a(new_n18_), .b(new_n20_), .O(new_n30_));
  nand2  g12(.a(x9), .b(x8), .O(new_n31_));
  nand4  g13(.a(new_n31_), .b(new_n30_), .c(x7), .d(x6), .O(z4));
  xnor2a g14(.a(x8), .b(x7), .O(new_n33_));
  nand4  g15(.a(new_n33_), .b(x2), .c(new_n24_), .d(new_n23_), .O(new_n34_));
  nand3  g16(.a(x8), .b(new_n26_), .c(x5), .O(new_n35_));
  ...
  oai21  g26(.a(new_n18_), .b(x7), .c(new_n20_), .O(new_n45_));
  nand4  g27(.a(x9), .b(new_n25_), .c(new_n24_), .d(new_n23_), .O(new_n46_));
  nand3  g28(.a(new_n18_), .b(x4), .c(x3), .O(new_n47_));
  nand2  g29(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g30(.a(new_n48_), .b(x7), .O(new_n49_));
  nand4  g31(.a(x9), .b(x8), .c(new_n26_), .d(x5), .O(new_n50_));
  nand4  g32(.a(new_n50_), .b(new_n49_), .c(new_n45_), .d(new_n44_), .O(z6));
  zero   g33(.O(z2));
endmodule
