...
module FAU ( 
  ...
  wire new_n18_, new_n20_, new_n21_, new_n22_, new_n24_, new_n25_, new_n26_,
    new_n28_, new_n29_, new_n30_, new_n33_, new_n34_, new_n36_;
  ...
  nor2   g11(.a(new_n25_), .b(x7), .O(new_n29_));
  nor2   g12(.a(x1), .b(x0), .O(new_n30_));
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n18_), .d(new_n28_), .O(z3));
  ...
  nand4  g19(.a(new_n36_), .b(new_n26_), .c(new_n18_), .d(x6), .O(z6));
endmodule
