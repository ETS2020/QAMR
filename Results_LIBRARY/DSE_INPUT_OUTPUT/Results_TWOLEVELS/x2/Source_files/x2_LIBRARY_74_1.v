...
module FAU ( 
  ...
  nand3  g04(.a(new_n21_), .b(x9), .c(x4), .O(new_n22_));
  ...
  nand4  g15(.a(new_n32_), .b(new_n18_), .c(x8), .d(new_n25_), .O(z3));
  inv1   g16(.a(x6), .O(new_n34_));
  oai21  g17(.a(new_n18_), .b(x4), .c(new_n34_), .O(new_n35_));
  nand2  g18(.a(new_n18_), .b(new_n25_), .O(new_n36_));
  nand3  g19(.a(new_n36_), .b(new_n35_), .c(new_n22_), .O(z4));
  ...
  and2   g24(.a(x7), .b(x3), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(x9), .c(new_n41_), .O(new_n43_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n44_), .c(new_n45_), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(new_n43_), .c(new_n40_), .d(new_n35_), .O(z5));
  nand3  g32(.a(new_n42_), .b(new_n18_), .c(x8), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x6), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(x4), .O(new_n52_));
  aoi21  g35(.a(new_n31_), .b(x8), .c(new_n25_), .O(new_n53_));
  nand3  g36(.a(x8), .b(new_n25_), .c(x5), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x4), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n53_), .c(x9), .O(new_n56_));
  nand2  g39(.a(new_n26_), .b(x6), .O(new_n57_));
