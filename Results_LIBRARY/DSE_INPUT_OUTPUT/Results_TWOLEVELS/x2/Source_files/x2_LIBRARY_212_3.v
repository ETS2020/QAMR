...
module FAU ( 
  ...
  oai21  g12(.a(new_n29_), .b(x3), .c(x9), .O(new_n30_));
  ...
  aoi21  g38(.a(new_n55_), .b(new_n53_), .c(new_n46_), .O(new_n56_));
  ...
  nand3  g46(.a(new_n53_), .b(x5), .c(new_n24_), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n26_), .c(new_n18_), .O(new_n66_));
  nand3  g49(.a(new_n41_), .b(new_n40_), .c(new_n39_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x8), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(x9), .c(new_n24_), .O(new_n69_));
  nand3  g52(.a(new_n22_), .b(x4), .c(x3), .O(new_n70_));
  nand2  g53(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g54(.a(new_n71_), .b(x7), .O(new_n72_));
  nand3  g55(.a(new_n72_), .b(new_n66_), .c(new_n47_), .O(z6));
endmodule
