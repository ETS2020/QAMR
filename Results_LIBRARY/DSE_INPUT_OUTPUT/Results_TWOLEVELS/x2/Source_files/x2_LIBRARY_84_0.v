...
module FAU ( 
  ...
  nand4  g15(.a(new_n27_), .b(new_n18_), .c(new_n22_), .d(x2), .O(new_n33_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n44_), .c(new_n43_), .O(new_n48_));
  ...
  nand2  g37(.a(new_n19_), .b(x5), .O(new_n55_));
  inv1   g38(.a(new_n55_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n40_), .c(x9), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n54_), .O(z5));
  nand4  g41(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n45_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n27_), .c(x2), .O(new_n61_));
  nand3  g44(.a(new_n26_), .b(new_n44_), .c(new_n43_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(x8), .c(new_n22_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n56_), .c(x9), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n61_), .c(new_n41_), .O(z6));
endmodule
