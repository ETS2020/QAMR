...
module FAU ( 
  ...
  oai21  g23(.a(new_n40_), .b(new_n25_), .c(new_n21_), .O(new_n41_));
  aoi22  g24(.a(new_n25_), .b(x7), .c(x9), .d(new_n30_), .O(new_n42_));
  ...
  nand2  g33(.a(new_n25_), .b(new_n21_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n50_), .c(new_n44_), .O(z6));
  nand2  g35(.a(new_n22_), .b(new_n20_), .O(z3));
endmodule
