...
module FAU ( 
  ...
  nand3  g16(.a(new_n33_), .b(new_n28_), .c(new_n26_), .O(z3));
  inv1   g17(.a(x6), .O(new_n35_));
  nand2  g18(.a(new_n22_), .b(new_n35_), .O(new_n36_));
  aoi21  g19(.a(x9), .b(x8), .c(new_n20_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n36_), .O(z4));
  nand4  g21(.a(new_n20_), .b(x2), .c(new_n30_), .d(new_n29_), .O(new_n39_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n41_), .c(new_n36_), .O(z5));
  nand3  g27(.a(x8), .b(x4), .c(x3), .O(new_n45_));
  oai21  g28(.a(new_n18_), .b(x8), .c(new_n45_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x7), .O(new_n47_));
  nand3  g30(.a(new_n18_), .b(new_n25_), .c(new_n20_), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(new_n47_), .c(new_n22_), .d(x6), .O(z6));
endmodule
