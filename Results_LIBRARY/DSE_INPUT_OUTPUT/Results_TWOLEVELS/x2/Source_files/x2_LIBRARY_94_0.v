...
module FAU ( 
  ...
  oai21  g31(.a(new_n20_), .b(new_n30_), .c(new_n18_), .O(new_n49_));
  ...
  nand3  g36(.a(new_n53_), .b(new_n49_), .c(new_n48_), .O(z5));
  nand3  g37(.a(x9), .b(x8), .c(x5), .O(new_n55_));
  inv1   g38(.a(new_n55_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n35_), .c(new_n22_), .O(new_n57_));
  inv1   g40(.a(x2), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n34_), .c(new_n33_), .O(new_n59_));
