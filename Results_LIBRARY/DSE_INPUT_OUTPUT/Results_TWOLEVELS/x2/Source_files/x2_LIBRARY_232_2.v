...
module FAU ( 
  ...
  nand2  g20(.a(new_n19_), .b(x7), .O(new_n38_));
  ...
  oai21  g25(.a(new_n42_), .b(new_n24_), .c(new_n21_), .O(new_n43_));
  nand4  g26(.a(new_n43_), .b(new_n40_), .c(new_n38_), .d(x6), .O(z5));
  inv1   g27(.a(x6), .O(new_n45_));
  nand2  g28(.a(new_n38_), .b(new_n45_), .O(new_n46_));
  ...
  nand2  g33(.a(new_n24_), .b(new_n21_), .O(new_n51_));
