...
module FAU ( 
  ...
  oai21  g14(.a(new_n22_), .b(new_n21_), .c(new_n18_), .O(new_n32_));
  ...
  aoi21  g24(.a(x9), .b(new_n22_), .c(new_n21_), .O(new_n42_));
  oai21  g25(.a(new_n42_), .b(x9), .c(new_n20_), .O(new_n43_));
  ...
  oai21  g36(.a(new_n50_), .b(x7), .c(x6), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x4), .O(new_n55_));
  nand3  g38(.a(x9), .b(new_n20_), .c(x5), .O(new_n56_));
  nand3  g39(.a(new_n18_), .b(x7), .c(x3), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x8), .O(new_n59_));
  aoi21  g42(.a(new_n36_), .b(x8), .c(new_n20_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n39_), .c(x9), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(new_n59_), .c(new_n55_), .d(new_n40_), .O(z6));
endmodule
