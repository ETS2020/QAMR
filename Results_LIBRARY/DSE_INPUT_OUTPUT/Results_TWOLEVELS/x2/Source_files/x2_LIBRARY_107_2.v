...
module FAU ( 
  ...
  nand3  g08(.a(new_n25_), .b(new_n22_), .c(new_n18_), .O(z1));
  ...
  aoi22  g20(.a(new_n24_), .b(x7), .c(x9), .d(new_n37_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n36_), .c(new_n33_), .O(z5));
  inv1   g22(.a(x2), .O(new_n40_));
  nand4  g23(.a(x8), .b(new_n40_), .c(new_n30_), .d(new_n29_), .O(new_n41_));
  nand2  g24(.a(x9), .b(new_n18_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  nand2  g26(.a(new_n43_), .b(x7), .O(new_n44_));
  oai21  g27(.a(x9), .b(new_n18_), .c(x6), .O(new_n45_));
  aoi21  g28(.a(new_n35_), .b(new_n21_), .c(new_n45_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n44_), .O(z6));
  nand3  g30(.a(new_n22_), .b(new_n20_), .c(new_n18_), .O(z3));
endmodule
