...
module FAU ( 
  ...
  nand4  g13(.a(new_n18_), .b(new_n22_), .c(new_n20_), .d(x3), .O(new_n31_));
  ...
  oai21  g28(.a(x9), .b(x3), .c(new_n45_), .O(new_n46_));
  ...
  nand2  g42(.a(new_n22_), .b(new_n20_), .O(new_n60_));
  nand3  g43(.a(x8), .b(x7), .c(x4), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n60_), .c(x3), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n18_), .O(new_n63_));
  inv1   g46(.a(new_n52_), .O(new_n64_));
  aoi21  g47(.a(new_n41_), .b(x8), .c(new_n20_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n64_), .c(x9), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n63_), .c(new_n46_), .O(z6));
endmodule
