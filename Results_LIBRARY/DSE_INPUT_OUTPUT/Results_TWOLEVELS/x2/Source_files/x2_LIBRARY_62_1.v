...
module FAU ( 
  ...
  oai21  g12(.a(new_n18_), .b(x5), .c(new_n29_), .O(new_n30_));
  ...
  aoi21  g19(.a(new_n36_), .b(new_n33_), .c(new_n18_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n29_), .c(x5), .O(new_n38_));
  ...
  oai21  g36(.a(x8), .b(x7), .c(x6), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n18_), .O(new_n55_));
  nand4  g38(.a(new_n55_), .b(new_n53_), .c(new_n49_), .d(new_n46_), .O(z6));
endmodule
