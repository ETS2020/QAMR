...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n21_, new_n24_, new_n25_, new_n26_, new_n29_,
  ...
  nor2   g06(.a(new_n19_), .b(new_n24_), .O(new_n25_));
  nand2  g07(.a(x9), .b(x8), .O(new_n26_));
  nand3  g08(.a(new_n26_), .b(new_n25_), .c(x7), .O(z3));
  oai21  g09(.a(new_n18_), .b(x6), .c(new_n21_), .O(z4));
