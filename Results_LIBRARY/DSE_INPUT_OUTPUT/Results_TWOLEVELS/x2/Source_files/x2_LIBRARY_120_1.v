...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(new_n27_), .c(new_n20_), .O(z3));
  oai21  g16(.a(new_n18_), .b(new_n24_), .c(x6), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x7), .O(new_n35_));
  oai21  g18(.a(x9), .b(x7), .c(new_n35_), .O(z4));
  nand2  g19(.a(new_n18_), .b(new_n24_), .O(new_n37_));
  ...
  nand3  g28(.a(new_n45_), .b(new_n39_), .c(new_n37_), .O(z5));
  nand4  g29(.a(x9), .b(new_n30_), .c(new_n29_), .d(new_n28_), .O(new_n47_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n39_), .c(new_n27_), .O(z6));
endmodule
