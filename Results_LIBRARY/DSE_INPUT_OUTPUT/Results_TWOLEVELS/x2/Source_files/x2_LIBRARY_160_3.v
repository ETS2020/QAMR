...
module FAU ( 
  ...
  oai21  g19(.a(new_n30_), .b(x5), .c(x9), .O(new_n37_));
  ...
  nand3  g24(.a(new_n41_), .b(new_n37_), .c(x6), .O(z4));
  ...
  aoi21  g35(.a(x9), .b(x5), .c(new_n52_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n51_), .c(new_n47_), .O(z5));
  nand3  g37(.a(x9), .b(x7), .c(new_n24_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n41_), .O(new_n56_));
  ...
  nand3  g45(.a(new_n62_), .b(new_n57_), .c(new_n53_), .O(z6));
endmodule
