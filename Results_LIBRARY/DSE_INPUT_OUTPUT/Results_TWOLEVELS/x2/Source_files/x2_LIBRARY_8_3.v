...
module FAU ( 
  ...
  nand2  g08(.a(new_n21_), .b(x2), .O(new_n26_));
  nand2  g09(.a(new_n26_), .b(x9), .O(new_n27_));
  oai21  g10(.a(new_n20_), .b(x7), .c(new_n18_), .O(new_n28_));
  nor3   g11(.a(x2), .b(x1), .c(x0), .O(new_n29_));
  nand3  g12(.a(new_n29_), .b(new_n28_), .c(new_n27_), .O(z3));
  inv1   g13(.a(x6), .O(new_n31_));
  nand2  g14(.a(x9), .b(x2), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n31_), .O(new_n33_));
  inv1   g16(.a(x2), .O(new_n34_));
  nand3  g17(.a(new_n21_), .b(x9), .c(new_n34_), .O(new_n35_));
  inv1   g18(.a(x7), .O(new_n36_));
  nand2  g19(.a(new_n18_), .b(new_n36_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n35_), .c(new_n33_), .O(z4));
  nand3  g21(.a(x8), .b(new_n36_), .c(x5), .O(new_n39_));
  ...
  nand4  g37(.a(new_n54_), .b(new_n49_), .c(new_n32_), .d(x6), .O(z6));
endmodule
