...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n24_, new_n25_,
    new_n26_, new_n29_, new_n32_, new_n33_, new_n34_, new_n35_, new_n36_,
  ...
  nor2   g11(.a(x9), .b(new_n18_), .O(new_n29_));
  nand3  g12(.a(new_n29_), .b(new_n18_), .c(new_n21_), .O(z3));
  ...
  oai21  g21(.a(new_n38_), .b(new_n25_), .c(new_n21_), .O(new_n39_));
  inv1   g22(.a(x6), .O(new_n40_));
  nand2  g23(.a(x9), .b(new_n40_), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n39_), .c(new_n36_), .d(new_n26_), .O(z5));
  inv1   g25(.a(x2), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n33_), .c(new_n32_), .O(new_n44_));
  ...
  nor2   g31(.a(z2), .b(new_n40_), .O(new_n49_));
