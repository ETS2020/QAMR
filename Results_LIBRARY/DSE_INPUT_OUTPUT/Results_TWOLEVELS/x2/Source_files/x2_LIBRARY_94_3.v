...
module FAU ( 
  ...
  oai21  g16(.a(new_n19_), .b(new_n24_), .c(new_n33_), .O(z2));
  ...
  oai21  g26(.a(new_n29_), .b(x4), .c(x9), .O(new_n44_));
  inv1   g27(.a(x6), .O(new_n45_));
  aoi21  g28(.a(new_n19_), .b(new_n18_), .c(new_n45_), .O(new_n46_));
  ...
  oai21  g35(.a(new_n52_), .b(x4), .c(x9), .O(new_n53_));
  nand3  g36(.a(x7), .b(new_n24_), .c(x3), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(x8), .O(new_n55_));
  aoi21  g38(.a(new_n55_), .b(new_n19_), .c(new_n45_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(new_n53_), .c(new_n50_), .O(z5));
  nand3  g40(.a(x8), .b(x7), .c(x3), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n19_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x4), .O(new_n60_));
  nand3  g43(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(new_n61_));
  nand2  g44(.a(new_n21_), .b(new_n24_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(new_n61_), .c(new_n18_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n52_), .c(x9), .O(new_n64_));
  aoi21  g47(.a(new_n26_), .b(new_n18_), .c(new_n45_), .O(new_n65_));
