...
module FAU ( 
  ...
  oai21  g16(.a(new_n33_), .b(x9), .c(new_n21_), .O(new_n34_));
  oai21  g17(.a(x2), .b(x0), .c(new_n18_), .O(new_n35_));
  ...
  nand4  g24(.a(new_n41_), .b(new_n39_), .c(new_n37_), .d(new_n24_), .O(z4));
  inv1   g25(.a(x0), .O(new_n43_));
  inv1   g26(.a(x2), .O(new_n44_));
  nand2  g27(.a(new_n22_), .b(new_n21_), .O(new_n45_));
  nand3  g28(.a(x9), .b(x8), .c(x7), .O(new_n46_));
  aoi21  g29(.a(new_n46_), .b(new_n45_), .c(new_n44_), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n43_), .c(new_n40_), .O(new_n48_));
  ...
  aoi21  g36(.a(new_n53_), .b(new_n19_), .c(new_n50_), .O(new_n54_));
  oai21  g37(.a(new_n48_), .b(x1), .c(new_n54_), .O(z5));
  nand2  g38(.a(new_n37_), .b(new_n40_), .O(new_n56_));
  nand3  g39(.a(x9), .b(x8), .c(x5), .O(new_n57_));
  inv1   g40(.a(new_n57_), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n33_), .c(new_n21_), .O(new_n59_));
  nand3  g42(.a(x9), .b(new_n44_), .c(new_n43_), .O(new_n60_));
  nand4  g43(.a(new_n19_), .b(x8), .c(x4), .d(x3), .O(new_n61_));
  aoi21  g44(.a(new_n61_), .b(new_n60_), .c(x1), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n30_), .c(x7), .O(new_n63_));
