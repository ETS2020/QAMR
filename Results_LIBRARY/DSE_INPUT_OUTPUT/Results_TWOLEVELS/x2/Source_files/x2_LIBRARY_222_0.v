...
module FAU ( 
  ...
  aoi21  g26(.a(new_n43_), .b(x8), .c(new_n20_), .O(new_n44_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n45_), .c(new_n40_), .O(z6));
endmodule
