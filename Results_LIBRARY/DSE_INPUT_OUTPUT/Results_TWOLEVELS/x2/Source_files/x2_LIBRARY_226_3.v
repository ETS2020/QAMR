...
module FAU ( 
  ...
  nand2  g05(.a(new_n21_), .b(new_n20_), .O(new_n23_));
  oai21  g06(.a(new_n18_), .b(new_n20_), .c(new_n23_), .O(z2));
  inv1   g07(.a(x8), .O(new_n25_));
  oai21  g08(.a(new_n25_), .b(x7), .c(new_n18_), .O(new_n26_));
  ...
  oai21  g17(.a(new_n21_), .b(x7), .c(new_n34_), .O(z4));
  ...
  nand4  g30(.a(new_n47_), .b(new_n42_), .c(new_n23_), .d(x6), .O(z6));
endmodule
