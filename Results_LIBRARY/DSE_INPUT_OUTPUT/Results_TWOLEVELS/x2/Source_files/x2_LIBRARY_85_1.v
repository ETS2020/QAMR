...
module FAU ( 
  ...
  nand3  g10(.a(new_n27_), .b(x8), .c(new_n20_), .O(new_n28_));
  nand2  g11(.a(new_n28_), .b(new_n18_), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(new_n22_), .O(z3));
  nand2  g13(.a(new_n24_), .b(x8), .O(new_n31_));
  aoi21  g14(.a(new_n18_), .b(x8), .c(x7), .O(new_n32_));
  oai21  g15(.a(new_n18_), .b(x0), .c(x6), .O(new_n33_));
  ...
  nand2  g27(.a(x9), .b(new_n44_), .O(new_n45_));
  ...
  aoi21  g33(.a(new_n50_), .b(new_n20_), .c(new_n33_), .O(new_n51_));
