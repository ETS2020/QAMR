...
module FAU ( 
  ...
  nand4  g12(.a(new_n25_), .b(new_n29_), .c(new_n28_), .d(new_n27_), .O(new_n30_));
  ...
  oai21  g19(.a(new_n36_), .b(new_n21_), .c(x8), .O(new_n37_));
  ...
  oai21  g25(.a(x9), .b(new_n20_), .c(new_n21_), .O(new_n43_));
