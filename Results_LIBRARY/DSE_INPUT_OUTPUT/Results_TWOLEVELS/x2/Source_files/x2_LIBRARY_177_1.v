...
module FAU ( 
  ...
  nand4  g12(.a(new_n29_), .b(new_n28_), .c(new_n19_), .d(new_n27_), .O(z3));
  ...
  oai21  g17(.a(new_n19_), .b(x7), .c(new_n31_), .O(new_n35_));
