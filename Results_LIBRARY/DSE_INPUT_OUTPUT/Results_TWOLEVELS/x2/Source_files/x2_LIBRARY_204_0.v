...
module FAU ( 
  ...
  nand4  g29(.a(new_n46_), .b(x2), .c(new_n45_), .d(new_n29_), .O(new_n47_));
  ...
  nand3  g40(.a(new_n57_), .b(new_n30_), .c(x0), .O(new_n58_));
  inv1   g41(.a(new_n48_), .O(new_n59_));
  inv1   g42(.a(x2), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n45_), .c(new_n29_), .O(new_n61_));
