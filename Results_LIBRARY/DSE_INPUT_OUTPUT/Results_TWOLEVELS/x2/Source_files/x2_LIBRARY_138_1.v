...
module FAU ( 
  ...
  nand4  g27(.a(new_n44_), .b(x2), .c(new_n37_), .d(new_n36_), .O(new_n45_));
  aoi21  g28(.a(x8), .b(new_n18_), .c(new_n21_), .O(new_n46_));
  ...
  aoi22  g35(.a(new_n52_), .b(new_n26_), .c(new_n29_), .d(new_n49_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n48_), .O(z5));
  nand2  g37(.a(new_n29_), .b(new_n49_), .O(new_n55_));
