...
module FAU ( 
  ...
  nand4  g09(.a(new_n26_), .b(new_n18_), .c(x8), .d(new_n20_), .O(z3));
  ...
  nand3  g22(.a(new_n39_), .b(new_n37_), .c(new_n29_), .O(z5));
  ...
  nand4  g27(.a(new_n44_), .b(new_n43_), .c(new_n22_), .d(x6), .O(z6));
endmodule
