...
module FAU ( 
  ...
  nand4  g09(.a(new_n18_), .b(new_n20_), .c(new_n22_), .d(x5), .O(new_n27_));
  ...
  nand2  g23(.a(new_n18_), .b(new_n40_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n39_), .O(new_n42_));
  aoi21  g25(.a(x9), .b(new_n20_), .c(new_n40_), .O(new_n43_));
  ...
  oai21  g37(.a(new_n54_), .b(new_n39_), .c(x5), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n51_), .O(z5));
  nand2  g39(.a(new_n18_), .b(new_n20_), .O(new_n57_));
  nand2  g40(.a(new_n45_), .b(new_n57_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n22_), .c(x5), .O(new_n59_));
  aoi21  g42(.a(new_n36_), .b(x8), .c(new_n18_), .O(new_n60_));
  ...
  nand4  g46(.a(new_n63_), .b(new_n59_), .c(new_n41_), .d(x6), .O(z6));
endmodule
