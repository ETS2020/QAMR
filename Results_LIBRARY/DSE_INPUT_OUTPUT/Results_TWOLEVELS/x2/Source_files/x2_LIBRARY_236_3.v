...
module FAU ( 
  ...
  nand3  g17(.a(new_n34_), .b(new_n29_), .c(new_n27_), .O(z3));
  inv1   g18(.a(x6), .O(new_n36_));
  oai21  g19(.a(new_n20_), .b(new_n22_), .c(new_n36_), .O(new_n37_));
  aoi21  g20(.a(x9), .b(x8), .c(new_n19_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n37_), .O(z4));
  nand4  g22(.a(new_n19_), .b(x2), .c(new_n31_), .d(new_n30_), .O(new_n40_));
  ...
  nand3  g34(.a(new_n20_), .b(new_n22_), .c(new_n19_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n51_), .c(new_n37_), .O(z6));
endmodule
