...
module FAU ( 
  ...
  nand4  g10(.a(new_n27_), .b(new_n26_), .c(new_n18_), .d(new_n24_), .O(z3));
  inv1   g11(.a(x7), .O(new_n29_));
  oai21  g12(.a(new_n18_), .b(x8), .c(new_n29_), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n18_), .c(x6), .O(z4));
  inv1   g14(.a(x6), .O(new_n32_));
  oai21  g15(.a(new_n18_), .b(new_n29_), .c(new_n32_), .O(new_n33_));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  nand4  g18(.a(new_n25_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  ...
  inv1   g27(.a(new_n37_), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n20_), .c(new_n29_), .O(new_n46_));
  nor2   g29(.a(x9), .b(new_n25_), .O(new_n47_));
