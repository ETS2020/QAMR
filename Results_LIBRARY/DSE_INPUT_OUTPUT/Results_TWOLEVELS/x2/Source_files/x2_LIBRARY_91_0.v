...
module FAU ( 
  ...
  oai21  g12(.a(new_n29_), .b(new_n21_), .c(x1), .O(new_n30_));
  ...
  oai21  g20(.a(new_n21_), .b(new_n37_), .c(x1), .O(new_n38_));
  ...
  nand4  g26(.a(new_n43_), .b(x2), .c(new_n31_), .d(new_n42_), .O(new_n44_));
  ...
  oai21  g33(.a(new_n50_), .b(new_n37_), .c(x1), .O(new_n51_));
