...
module FAU ( 
  ...
  nand2  g10(.a(x9), .b(new_n24_), .O(new_n28_));
  oai21  g11(.a(new_n22_), .b(x7), .c(new_n28_), .O(z2));
  ...
  nand4  g18(.a(new_n35_), .b(new_n31_), .c(new_n28_), .d(x6), .O(z4));
  ...
  nand2  g24(.a(x8), .b(new_n20_), .O(new_n42_));
  aoi21  g25(.a(new_n42_), .b(new_n41_), .c(new_n18_), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n37_), .c(x5), .O(new_n44_));
  ...
  oai21  g33(.a(new_n50_), .b(x7), .c(x6), .O(new_n51_));
  ...
  nand3  g39(.a(new_n32_), .b(x8), .c(new_n56_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(x5), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x9), .O(new_n59_));
  oai21  g42(.a(x8), .b(x7), .c(x6), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n18_), .O(new_n61_));
  nand4  g44(.a(new_n61_), .b(new_n59_), .c(new_n55_), .d(new_n52_), .O(z6));
endmodule
