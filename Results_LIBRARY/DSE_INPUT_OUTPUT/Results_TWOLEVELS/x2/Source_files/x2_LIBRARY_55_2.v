...
module FAU ( 
  ...
  aoi21  g26(.a(x9), .b(new_n27_), .c(x3), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(x9), .c(new_n21_), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n35_), .c(new_n43_), .d(x6), .O(z4));
  inv1   g29(.a(x6), .O(new_n47_));
  nand2  g30(.a(new_n43_), .b(new_n47_), .O(new_n48_));
  ...
  aoi21  g34(.a(x8), .b(new_n18_), .c(x9), .O(new_n52_));
  ...
  oai21  g40(.a(new_n57_), .b(new_n47_), .c(new_n18_), .O(new_n58_));
  aoi21  g41(.a(new_n40_), .b(x8), .c(new_n21_), .O(new_n59_));
