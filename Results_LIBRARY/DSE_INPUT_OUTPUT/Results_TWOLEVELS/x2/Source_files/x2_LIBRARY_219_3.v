...
module FAU ( 
  ...
  nand4  g22(.a(new_n33_), .b(new_n39_), .c(new_n38_), .d(new_n24_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n19_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n37_), .c(new_n36_), .O(z3));
  inv1   g25(.a(x6), .O(new_n43_));
  nand2  g26(.a(x9), .b(x0), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n43_), .O(new_n45_));
  nand2  g28(.a(new_n19_), .b(new_n18_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n37_), .O(z4));
  ...
  nand3  g35(.a(new_n52_), .b(x2), .c(new_n38_), .O(new_n53_));
  ...
  nand4  g40(.a(new_n57_), .b(new_n53_), .c(new_n50_), .d(new_n44_), .O(z5));
  nand4  g41(.a(x9), .b(x8), .c(x5), .d(new_n24_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n27_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n18_), .O(new_n61_));
  oai21  g44(.a(x2), .b(x1), .c(x8), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x9), .c(new_n24_), .O(new_n63_));
  ...
  nand3  g49(.a(new_n66_), .b(new_n61_), .c(new_n45_), .O(z6));
endmodule
