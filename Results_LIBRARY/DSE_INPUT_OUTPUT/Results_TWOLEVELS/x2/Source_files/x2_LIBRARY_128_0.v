...
module FAU ( 
  ...
  nand4  g19(.a(new_n37_), .b(x2), .c(new_n25_), .d(new_n24_), .O(new_n38_));
  nand2  g20(.a(new_n33_), .b(new_n32_), .O(new_n39_));
  ...
  nand4  g25(.a(x9), .b(x8), .c(new_n29_), .d(x5), .O(new_n44_));
  nand4  g26(.a(new_n44_), .b(new_n43_), .c(new_n39_), .d(new_n38_), .O(z5));
  nand3  g27(.a(x9), .b(new_n29_), .c(x5), .O(new_n46_));
  ...
  nand3  g31(.a(new_n28_), .b(x9), .c(x7), .O(new_n50_));
  nand3  g32(.a(new_n50_), .b(new_n49_), .c(new_n39_), .O(z6));
  zero   g33(.O(z2));
endmodule
