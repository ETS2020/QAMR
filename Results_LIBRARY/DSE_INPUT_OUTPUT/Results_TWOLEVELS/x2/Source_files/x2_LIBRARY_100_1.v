...
module FAU ( 
  ...
  nand2  g23(.a(x9), .b(new_n28_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n40_), .O(new_n42_));
  nand3  g25(.a(new_n29_), .b(x9), .c(x3), .O(new_n43_));
  nand2  g26(.a(new_n31_), .b(new_n18_), .O(new_n44_));
  ...
  nand4  g33(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n51_));
  inv1   g34(.a(x4), .O(new_n52_));
  nor2   g35(.a(x9), .b(new_n18_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n52_), .c(new_n40_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n51_), .c(new_n50_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x3), .O(new_n56_));
  oai21  g39(.a(new_n19_), .b(new_n40_), .c(new_n31_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(z5));
  nand4  g41(.a(x9), .b(x8), .c(x5), .d(x3), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n25_), .c(new_n18_), .O(new_n61_));
  nand2  g44(.a(x9), .b(new_n19_), .O(new_n62_));
  nand3  g45(.a(new_n31_), .b(x8), .c(x4), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n62_), .c(new_n28_), .O(new_n64_));
  inv1   g47(.a(x2), .O(new_n65_));
  nand3  g48(.a(new_n37_), .b(x9), .c(new_n65_), .O(new_n66_));
  inv1   g49(.a(new_n66_), .O(new_n67_));
  oai21  g50(.a(new_n67_), .b(new_n64_), .c(x7), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n61_), .c(new_n41_), .d(x6), .O(z6));
endmodule
