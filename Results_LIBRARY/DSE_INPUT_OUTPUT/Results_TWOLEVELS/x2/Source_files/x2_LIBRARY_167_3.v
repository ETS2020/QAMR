...
module FAU ( 
  ...
  nand2  g16(.a(x9), .b(x3), .O(new_n34_));
  ...
  oai21  g35(.a(new_n18_), .b(x4), .c(new_n19_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x3), .O(new_n54_));
  nand3  g37(.a(new_n49_), .b(new_n18_), .c(x5), .O(new_n55_));
  ...
  nand4  g41(.a(new_n58_), .b(new_n57_), .c(new_n54_), .d(new_n52_), .O(z5));
