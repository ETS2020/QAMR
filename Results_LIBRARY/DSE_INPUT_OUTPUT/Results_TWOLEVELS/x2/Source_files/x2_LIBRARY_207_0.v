...
module FAU ( 
  ...
  nand3  g10(.a(new_n18_), .b(new_n24_), .c(x7), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(new_n24_), .d(x4), .O(z1));
  nor2   g12(.a(x9), .b(x7), .O(new_n30_));
  nor2   g13(.a(new_n30_), .b(new_n23_), .O(new_n31_));
  nor2   g14(.a(new_n31_), .b(x8), .O(z2));
  inv1   g15(.a(x0), .O(new_n33_));
  inv1   g16(.a(x1), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n33_), .O(new_n35_));
  inv1   g18(.a(x2), .O(new_n36_));
  nand2  g19(.a(new_n30_), .b(new_n36_), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n35_), .c(x8), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n20_), .O(z3));
  oai21  g22(.a(x8), .b(x4), .c(new_n21_), .O(new_n40_));
  nand2  g23(.a(x9), .b(x8), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n40_), .c(new_n25_), .d(x6), .O(z4));
  inv1   g25(.a(x6), .O(new_n43_));
  nand2  g26(.a(new_n25_), .b(new_n43_), .O(new_n44_));
  nand3  g27(.a(new_n24_), .b(new_n21_), .c(x4), .O(new_n45_));
  ...
  nand4  g31(.a(x8), .b(x7), .c(new_n23_), .d(x3), .O(new_n49_));
  oai21  g32(.a(x8), .b(new_n23_), .c(new_n49_), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  nand4  g34(.a(x9), .b(x8), .c(new_n21_), .d(x5), .O(new_n52_));
  nand4  g35(.a(new_n52_), .b(new_n51_), .c(new_n48_), .d(new_n44_), .O(z5));
  inv1   g36(.a(x5), .O(new_n54_));
  nand3  g37(.a(new_n18_), .b(new_n24_), .c(x4), .O(new_n55_));
  oai21  g38(.a(new_n41_), .b(new_n54_), .c(new_n55_), .O(new_n56_));
  ...
  nand3  g43(.a(x9), .b(x8), .c(new_n36_), .O(new_n61_));
  nor2   g44(.a(new_n61_), .b(new_n35_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n60_), .c(x7), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n57_), .c(new_n44_), .O(z6));
endmodule
