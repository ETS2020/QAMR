...
module FAU ( 
  ...
  oai21  g08(.a(x7), .b(x3), .c(new_n19_), .O(new_n26_));
  ...
  oai21  g13(.a(x8), .b(x3), .c(new_n19_), .O(new_n31_));
  inv1   g14(.a(x2), .O(new_n32_));
  nand2  g15(.a(new_n19_), .b(x3), .O(new_n33_));
  ...
  nand4  g28(.a(new_n45_), .b(x2), .c(new_n44_), .d(new_n43_), .O(new_n46_));
