...
module FAU ( 
  ...
  oai21  g22(.a(new_n30_), .b(x2), .c(x9), .O(new_n40_));
  inv1   g23(.a(x6), .O(new_n41_));
  aoi21  g24(.a(new_n19_), .b(new_n18_), .c(new_n41_), .O(new_n42_));
  ...
  nand3  g33(.a(new_n50_), .b(new_n46_), .c(x6), .O(z5));
  nand3  g34(.a(x9), .b(x8), .c(x5), .O(new_n52_));
  inv1   g35(.a(new_n52_), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n27_), .c(new_n18_), .O(new_n54_));
  nor2   g37(.a(x8), .b(x2), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n37_), .c(x9), .O(new_n56_));
  ...
  aoi21  g42(.a(x9), .b(x2), .c(new_n41_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n59_), .c(new_n54_), .O(z6));
endmodule
