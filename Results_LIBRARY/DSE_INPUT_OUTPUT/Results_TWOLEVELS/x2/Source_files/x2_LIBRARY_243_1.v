...
module FAU ( 
  ...
  nand3  g10(.a(new_n27_), .b(x9), .c(x4), .O(new_n28_));
  ...
  nand2  g29(.a(new_n29_), .b(new_n18_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n28_), .O(z4));
  ...
  nand3  g40(.a(x7), .b(new_n32_), .c(x3), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(x8), .c(x6), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n29_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n57_), .O(z5));
  nand4  g44(.a(x9), .b(x8), .c(x5), .d(x4), .O(new_n62_));
  inv1   g45(.a(new_n62_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n24_), .c(new_n18_), .O(new_n64_));
  nand2  g47(.a(x9), .b(new_n19_), .O(new_n65_));
  nand3  g48(.a(new_n29_), .b(x8), .c(x3), .O(new_n66_));
  aoi21  g49(.a(new_n66_), .b(new_n65_), .c(new_n32_), .O(new_n67_));
  nand4  g50(.a(x9), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n68_));
  inv1   g51(.a(new_n68_), .O(new_n69_));
  oai21  g52(.a(new_n69_), .b(new_n67_), .c(x7), .O(new_n70_));
  nand4  g53(.a(new_n70_), .b(new_n64_), .c(new_n33_), .d(x6), .O(z6));
endmodule
