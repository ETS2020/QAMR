...
module FAU ( 
  ...
  oai21  g04(.a(new_n21_), .b(x7), .c(new_n20_), .O(z1));
  ...
  oai21  g24(.a(new_n39_), .b(new_n38_), .c(new_n41_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x7), .O(new_n43_));
  nand2  g26(.a(new_n18_), .b(new_n24_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n37_), .O(z5));
  nand2  g28(.a(x9), .b(new_n24_), .O(new_n46_));
  nand2  g29(.a(x4), .b(x3), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n21_), .c(new_n46_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x7), .O(new_n49_));
  inv1   g32(.a(new_n38_), .O(new_n50_));
  aoi21  g33(.a(new_n18_), .b(x8), .c(x7), .O(new_n51_));
  nor2   g34(.a(new_n18_), .b(x2), .O(new_n52_));
  aoi21  g35(.a(new_n52_), .b(new_n50_), .c(new_n51_), .O(new_n53_));
