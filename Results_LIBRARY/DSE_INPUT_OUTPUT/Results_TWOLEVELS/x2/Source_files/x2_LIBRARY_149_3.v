...
module FAU ( 
  ...
  oai22  g15(.a(new_n27_), .b(x7), .c(new_n19_), .d(new_n24_), .O(z2));
  ...
  nand2  g21(.a(new_n21_), .b(new_n18_), .O(new_n39_));
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n40_));
  nand2  g23(.a(new_n40_), .b(new_n19_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n35_), .c(new_n30_), .O(z3));
  oai21  g25(.a(new_n29_), .b(x5), .c(x9), .O(new_n43_));
  nand2  g26(.a(new_n19_), .b(new_n18_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(x6), .O(z4));
  nand3  g28(.a(x9), .b(x8), .c(x7), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n39_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(x2), .c(new_n37_), .d(new_n36_), .O(new_n48_));
  ...
  aoi21  g36(.a(x9), .b(x5), .c(new_n53_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(new_n48_), .O(z5));
  nand3  g38(.a(x9), .b(x7), .c(new_n24_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n21_), .O(new_n58_));
  nand4  g41(.a(x9), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n59_));
  ...
  nand3  g45(.a(new_n62_), .b(new_n58_), .c(new_n54_), .O(z6));
endmodule
