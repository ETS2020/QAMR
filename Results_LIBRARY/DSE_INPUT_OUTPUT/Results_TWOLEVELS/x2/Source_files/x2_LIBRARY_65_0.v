...
module FAU ( 
  ...
  aoi21  g13(.a(new_n30_), .b(x1), .c(x9), .O(z2));
  ...
  nand3  g19(.a(new_n36_), .b(new_n28_), .c(new_n21_), .O(z3));
  inv1   g20(.a(x6), .O(new_n38_));
  oai21  g21(.a(x9), .b(x1), .c(new_n38_), .O(new_n39_));
  aoi21  g22(.a(x9), .b(new_n18_), .c(new_n34_), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(x9), .c(new_n22_), .O(new_n41_));
  nand2  g24(.a(x9), .b(x8), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n41_), .c(new_n39_), .O(z4));
  inv1   g26(.a(x0), .O(new_n44_));
  xnor2a g27(.a(x8), .b(x7), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(x2), .c(new_n44_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x9), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n34_), .O(new_n48_));
  oai21  g31(.a(new_n20_), .b(new_n38_), .c(x1), .O(new_n49_));
  nand3  g32(.a(x8), .b(new_n22_), .c(x5), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(x6), .O(new_n51_));
  inv1   g34(.a(x3), .O(new_n52_));
  nor2   g35(.a(x4), .b(new_n52_), .O(new_n53_));
  aoi22  g36(.a(new_n53_), .b(new_n26_), .c(new_n51_), .d(x9), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n49_), .c(new_n48_), .O(z5));
  nand2  g38(.a(new_n51_), .b(x9), .O(new_n56_));
  nor3   g39(.a(x9), .b(x8), .c(x7), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n38_), .c(x1), .O(new_n58_));
  inv1   g41(.a(x2), .O(new_n59_));
  nand3  g42(.a(x7), .b(new_n59_), .c(new_n44_), .O(new_n60_));
  ...
  oai21  g47(.a(new_n64_), .b(new_n33_), .c(x7), .O(new_n65_));
  nand4  g48(.a(new_n65_), .b(new_n62_), .c(new_n58_), .d(new_n56_), .O(z6));
endmodule
