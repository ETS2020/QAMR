...
module FAU ( 
  ...
  oai21  g10(.a(x9), .b(x8), .c(new_n18_), .O(new_n28_));
  ...
  nand2  g14(.a(x9), .b(new_n19_), .O(new_n32_));
  oai21  g15(.a(new_n26_), .b(x7), .c(new_n32_), .O(z2));
  oai21  g16(.a(x8), .b(new_n19_), .c(x9), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x7), .O(new_n35_));
  oai21  g18(.a(new_n25_), .b(new_n20_), .c(x7), .O(new_n36_));
  ...
  nand3  g25(.a(new_n42_), .b(new_n37_), .c(new_n35_), .O(z3));
  ...
  nand3  g41(.a(x9), .b(new_n20_), .c(x7), .O(new_n59_));
  ...
  nand4  g47(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x6), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n25_), .O(new_n67_));
  nand4  g50(.a(new_n67_), .b(new_n64_), .c(new_n61_), .d(new_n32_), .O(z6));
endmodule
