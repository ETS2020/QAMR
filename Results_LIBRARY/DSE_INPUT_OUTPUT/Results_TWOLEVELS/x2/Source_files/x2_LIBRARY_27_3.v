...
module FAU ( 
  ...
  oai21  g08(.a(x8), .b(x7), .c(x6), .O(new_n26_));
  nand2  g09(.a(new_n26_), .b(new_n18_), .O(new_n27_));
  nand2  g10(.a(new_n27_), .b(new_n21_), .O(z4));
  inv1   g11(.a(x3), .O(new_n29_));
  oai21  g12(.a(x4), .b(new_n29_), .c(new_n18_), .O(new_n30_));
  ...
  nand3  g26(.a(new_n18_), .b(new_n32_), .c(new_n20_), .O(new_n44_));
