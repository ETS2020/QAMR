...
module FAU ( 
  ...
  nand2  g15(.a(x9), .b(x4), .O(new_n33_));
  ...
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n30_), .O(z4));
  ...
  aoi21  g36(.a(new_n53_), .b(x3), .c(new_n45_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(new_n51_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n24_), .O(new_n56_));
  oai21  g39(.a(new_n21_), .b(new_n45_), .c(new_n19_), .O(new_n57_));
  ...
  aoi21  g45(.a(new_n62_), .b(new_n29_), .c(x4), .O(new_n63_));
  nand4  g46(.a(x7), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n63_), .c(x9), .O(new_n66_));
  nand4  g49(.a(new_n66_), .b(new_n61_), .c(new_n46_), .d(new_n34_), .O(z6));
endmodule
