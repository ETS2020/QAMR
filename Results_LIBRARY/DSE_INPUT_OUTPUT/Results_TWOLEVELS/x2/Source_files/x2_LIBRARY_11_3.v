...
module FAU ( 
  ...
  nand2  g16(.a(new_n21_), .b(new_n18_), .O(new_n34_));
  ...
  nand4  g23(.a(new_n34_), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n19_), .O(new_n42_));
  nand3  g25(.a(new_n42_), .b(new_n37_), .c(new_n31_), .O(z3));
  inv1   g26(.a(x6), .O(new_n44_));
  oai21  g27(.a(new_n19_), .b(new_n24_), .c(new_n44_), .O(new_n45_));
  nand2  g28(.a(new_n19_), .b(new_n18_), .O(new_n46_));
  nand3  g29(.a(new_n46_), .b(new_n45_), .c(new_n31_), .O(z4));
  ...
  nor2   g33(.a(new_n19_), .b(new_n21_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n18_), .c(x5), .O(new_n52_));
  nor2   g35(.a(x9), .b(new_n18_), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(x3), .c(new_n44_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n52_), .c(new_n50_), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n24_), .O(new_n56_));
  oai21  g39(.a(new_n21_), .b(new_n44_), .c(new_n19_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(z5));
  nand3  g41(.a(new_n51_), .b(x5), .c(new_n24_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n28_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n18_), .O(new_n61_));
  nand3  g44(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(new_n62_));
