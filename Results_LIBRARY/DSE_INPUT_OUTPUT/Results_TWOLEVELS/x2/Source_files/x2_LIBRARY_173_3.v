...
module FAU ( 
  ...
  nor2   g09(.a(new_n18_), .b(x7), .O(new_n27_));
  nor2   g10(.a(x1), .b(x0), .O(new_n28_));
  nand4  g11(.a(new_n28_), .b(new_n27_), .c(new_n19_), .d(new_n26_), .O(z3));
  inv1   g12(.a(x6), .O(new_n30_));
  aoi21  g13(.a(new_n18_), .b(new_n22_), .c(new_n30_), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(x9), .c(new_n23_), .O(z4));
  oai21  g15(.a(new_n19_), .b(new_n22_), .c(new_n30_), .O(new_n33_));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  nand4  g18(.a(new_n18_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  ...
  nand2  g27(.a(new_n37_), .b(new_n20_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n22_), .O(new_n46_));
  nor2   g29(.a(x9), .b(new_n18_), .O(new_n47_));
