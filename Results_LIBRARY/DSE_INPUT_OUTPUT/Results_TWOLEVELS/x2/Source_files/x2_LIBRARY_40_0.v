...
module FAU ( 
  ...
  oai22  g07(.a(new_n21_), .b(new_n19_), .c(new_n18_), .d(x6), .O(z4));
  ...
  nor2   g19(.a(x4), .b(new_n37_), .O(new_n38_));
  oai21  g20(.a(new_n38_), .b(new_n21_), .c(new_n19_), .O(new_n39_));
  nand4  g21(.a(new_n39_), .b(new_n36_), .c(new_n33_), .d(new_n31_), .O(z5));
  ...
  nand3  g30(.a(new_n48_), .b(new_n44_), .c(new_n33_), .O(z6));
  zero   g31(.O(z2));
endmodule
