...
module FAU ( 
  ...
  oai21  g30(.a(new_n24_), .b(x7), .c(x6), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x5), .O(new_n49_));
  inv1   g32(.a(x4), .O(new_n50_));
  nand3  g33(.a(x7), .b(new_n50_), .c(x3), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(x8), .c(x5), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  nand2  g36(.a(x9), .b(new_n40_), .O(new_n54_));
  nand4  g37(.a(new_n54_), .b(new_n53_), .c(new_n49_), .d(new_n47_), .O(z5));
  nand2  g38(.a(new_n33_), .b(new_n40_), .O(new_n56_));
  xor2a  g39(.a(x9), .b(x8), .O(new_n57_));
  nand2  g40(.a(x4), .b(x3), .O(new_n58_));
  nand3  g41(.a(new_n18_), .b(x8), .c(x7), .O(new_n59_));
  oai22  g42(.a(new_n59_), .b(new_n58_), .c(new_n57_), .d(x7), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x5), .O(new_n61_));
  nand3  g44(.a(new_n32_), .b(new_n44_), .c(new_n43_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(x8), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(x9), .c(x7), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n61_), .c(new_n56_), .O(z6));
endmodule
