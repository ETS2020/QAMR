...
module FAU ( 
  ...
  nand2  g23(.a(new_n31_), .b(new_n30_), .O(new_n41_));
  nand3  g24(.a(x9), .b(x8), .c(x2), .O(new_n42_));
  inv1   g25(.a(x4), .O(new_n43_));
  nand3  g26(.a(new_n19_), .b(new_n43_), .c(x3), .O(new_n44_));
  oai21  g27(.a(new_n42_), .b(new_n41_), .c(new_n44_), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(x7), .O(new_n46_));
  nand2  g29(.a(new_n19_), .b(new_n20_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n40_), .O(z5));
