...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    new_n26_, new_n27_, new_n29_, new_n31_, new_n32_, new_n33_, new_n36_,
  ...
  oai21  g13(.a(new_n18_), .b(new_n22_), .c(x7), .O(new_n31_));
  ...
  nand4  g17(.a(x9), .b(new_n22_), .c(x7), .d(x6), .O(z4));
  inv1   g18(.a(x0), .O(new_n36_));
  inv1   g19(.a(x1), .O(new_n37_));
  oai21  g20(.a(new_n27_), .b(new_n21_), .c(new_n29_), .O(new_n38_));
  ...
  oai21  g26(.a(new_n43_), .b(new_n26_), .c(new_n21_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n41_), .c(new_n39_), .O(z5));
  ...
  nand3  g35(.a(new_n52_), .b(new_n51_), .c(new_n41_), .O(z6));
endmodule
