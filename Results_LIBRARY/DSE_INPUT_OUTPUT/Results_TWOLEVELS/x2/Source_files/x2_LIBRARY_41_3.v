...
module FAU ( 
  ...
  aoi21  g13(.a(new_n26_), .b(new_n21_), .c(new_n30_), .O(new_n31_));
  oai22  g14(.a(new_n31_), .b(x9), .c(new_n18_), .d(x7), .O(z4));
  nand2  g15(.a(new_n23_), .b(new_n30_), .O(new_n33_));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  nand4  g18(.a(new_n26_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n36_));
  ...
  nand3  g27(.a(new_n44_), .b(new_n39_), .c(new_n33_), .O(z5));
  inv1   g28(.a(new_n37_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n18_), .c(new_n21_), .O(new_n47_));
  nor2   g30(.a(x9), .b(new_n26_), .O(new_n48_));
