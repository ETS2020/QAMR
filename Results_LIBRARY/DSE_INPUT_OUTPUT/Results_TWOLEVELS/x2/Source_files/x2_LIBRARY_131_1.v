...
module FAU ( 
  ...
  oai21  g18(.a(x8), .b(new_n35_), .c(x9), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x7), .O(new_n37_));
  oai21  g20(.a(new_n28_), .b(new_n35_), .c(x9), .O(new_n38_));
  ...
  oai21  g25(.a(new_n30_), .b(x4), .c(new_n42_), .O(new_n43_));
  nand2  g26(.a(new_n30_), .b(new_n18_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n29_), .O(z4));
  inv1   g28(.a(x0), .O(new_n46_));
  inv1   g29(.a(x1), .O(new_n47_));
  nor2   g30(.a(new_n30_), .b(new_n19_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x7), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(new_n33_), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(x2), .c(new_n47_), .d(new_n46_), .O(new_n51_));
  nand3  g34(.a(new_n48_), .b(new_n18_), .c(x5), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(x6), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x4), .O(new_n54_));
  nand2  g37(.a(x7), .b(x3), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n30_), .O(new_n56_));
  aoi21  g39(.a(x8), .b(x6), .c(x9), .O(new_n57_));
  aoi21  g40(.a(new_n56_), .b(new_n35_), .c(new_n57_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n54_), .c(new_n51_), .O(z5));
  nand4  g42(.a(x9), .b(x8), .c(x5), .d(x4), .O(new_n60_));
  inv1   g43(.a(new_n60_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n25_), .c(new_n18_), .O(new_n62_));
  nor2   g45(.a(x2), .b(x1), .O(new_n63_));
  aoi21  g46(.a(new_n63_), .b(new_n46_), .c(new_n19_), .O(new_n64_));
  nand3  g47(.a(new_n30_), .b(x8), .c(x3), .O(new_n65_));
  oai21  g48(.a(new_n64_), .b(new_n30_), .c(new_n65_), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(x7), .c(x4), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n62_), .c(new_n43_), .O(z6));
endmodule
