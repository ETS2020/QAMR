...
module FAU ( 
  ...
  nand3  g22(.a(new_n31_), .b(x6), .c(new_n39_), .O(new_n40_));
  nor3   g23(.a(new_n40_), .b(x1), .c(x0), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n38_), .c(new_n35_), .O(z3));
  aoi21  g25(.a(x9), .b(new_n18_), .c(new_n26_), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(x9), .c(new_n22_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n31_), .c(x6), .O(z4));
  inv1   g28(.a(x0), .O(new_n46_));
  inv1   g29(.a(x1), .O(new_n47_));
  nand2  g30(.a(new_n18_), .b(new_n22_), .O(new_n48_));
  oai21  g31(.a(new_n31_), .b(new_n22_), .c(new_n48_), .O(new_n49_));
  ...
  oai21  g35(.a(x8), .b(new_n26_), .c(new_n52_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n27_), .O(new_n54_));
  inv1   g37(.a(new_n31_), .O(new_n55_));
  inv1   g38(.a(x5), .O(new_n56_));
  nor2   g39(.a(x7), .b(new_n56_), .O(new_n57_));
  aoi21  g40(.a(new_n57_), .b(new_n55_), .c(new_n26_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n54_), .c(new_n50_), .O(z5));
  oai21  g42(.a(new_n31_), .b(new_n56_), .c(new_n36_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n22_), .O(new_n61_));
  nand3  g44(.a(new_n39_), .b(new_n47_), .c(new_n46_), .O(new_n62_));
