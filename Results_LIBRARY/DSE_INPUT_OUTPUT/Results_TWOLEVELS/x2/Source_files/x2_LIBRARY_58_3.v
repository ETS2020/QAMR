...
module FAU ( 
  ...
  nand3  g35(.a(new_n52_), .b(new_n48_), .c(new_n42_), .O(z5));
  ...
  nand3  g44(.a(new_n61_), .b(new_n56_), .c(new_n43_), .O(z6));
endmodule
