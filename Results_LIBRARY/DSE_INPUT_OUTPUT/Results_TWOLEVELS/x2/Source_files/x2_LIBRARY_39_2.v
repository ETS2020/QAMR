...
module FAU ( 
  ...
  nand4  g15(.a(x9), .b(new_n26_), .c(x7), .d(x6), .O(z4));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  oai21  g18(.a(new_n24_), .b(new_n20_), .c(new_n27_), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n37_));
  inv1   g20(.a(x6), .O(new_n38_));
  oai21  g21(.a(x9), .b(new_n20_), .c(new_n38_), .O(new_n39_));
  nand3  g22(.a(x9), .b(x8), .c(x5), .O(new_n40_));
  inv1   g23(.a(new_n40_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n23_), .c(new_n20_), .O(new_n42_));
  ...
  nand2  g32(.a(new_n23_), .b(new_n20_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n49_), .c(new_n39_), .O(z6));
endmodule
