...
module FAU ( 
  ...
  nand3  g26(.a(x9), .b(new_n20_), .c(x5), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x6), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(x8), .c(new_n43_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n42_), .O(z5));
  oai21  g30(.a(new_n18_), .b(x8), .c(new_n31_), .O(new_n48_));
  nand3  g31(.a(new_n26_), .b(x9), .c(new_n25_), .O(new_n49_));
  ...
  aoi21  g38(.a(new_n55_), .b(new_n20_), .c(new_n53_), .O(new_n56_));
