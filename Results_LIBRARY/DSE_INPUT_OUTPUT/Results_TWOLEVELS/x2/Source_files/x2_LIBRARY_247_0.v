...
module FAU ( 
  ...
  oai21  g09(.a(x7), .b(new_n26_), .c(new_n18_), .O(new_n27_));
  nand3  g10(.a(new_n27_), .b(new_n25_), .c(new_n23_), .O(z1));
  nand4  g11(.a(new_n18_), .b(new_n21_), .c(new_n20_), .d(x2), .O(new_n29_));
  inv1   g12(.a(new_n29_), .O(z2));
  nor2   g13(.a(new_n18_), .b(new_n21_), .O(new_n31_));
  nand4  g14(.a(new_n31_), .b(new_n25_), .c(new_n22_), .d(x7), .O(z3));
  oai21  g15(.a(x9), .b(new_n20_), .c(x8), .O(new_n33_));
  nand3  g16(.a(new_n18_), .b(new_n21_), .c(x2), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n18_), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n20_), .O(new_n36_));
  inv1   g19(.a(x6), .O(new_n37_));
  aoi21  g20(.a(new_n18_), .b(new_n26_), .c(new_n37_), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n36_), .c(new_n33_), .O(z4));
  ...
  nand3  g29(.a(new_n46_), .b(x8), .c(x2), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n18_), .O(new_n48_));
  inv1   g31(.a(x5), .O(new_n49_));
  nor2   g32(.a(x7), .b(new_n49_), .O(new_n50_));
  aoi21  g33(.a(new_n50_), .b(new_n24_), .c(new_n37_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n48_), .c(new_n44_), .O(z5));
  nand3  g35(.a(x7), .b(new_n41_), .c(new_n40_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x9), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n26_), .O(new_n55_));
  nand2  g38(.a(x9), .b(new_n21_), .O(new_n56_));
  ...
  aoi21  g44(.a(new_n61_), .b(new_n20_), .c(new_n37_), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n59_), .c(new_n55_), .O(z6));
endmodule
