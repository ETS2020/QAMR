...
module FAU ( 
  ...
  nand4  g29(.a(new_n46_), .b(new_n41_), .c(new_n38_), .d(new_n31_), .O(z3));
  inv1   g30(.a(x6), .O(new_n48_));
  oai21  g31(.a(x9), .b(x3), .c(new_n48_), .O(new_n49_));
  aoi21  g32(.a(x9), .b(new_n18_), .c(new_n19_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(x9), .c(new_n23_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n49_), .c(new_n27_), .O(z4));
  nand3  g35(.a(x9), .b(x8), .c(x7), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n35_), .O(new_n54_));
  nand4  g37(.a(new_n54_), .b(x2), .c(new_n43_), .d(new_n42_), .O(new_n55_));
  oai21  g38(.a(new_n23_), .b(x4), .c(x8), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n19_), .c(new_n24_), .O(new_n57_));
  nand4  g40(.a(x9), .b(x8), .c(new_n23_), .d(x5), .O(new_n58_));
  nand4  g41(.a(new_n58_), .b(new_n57_), .c(new_n55_), .d(new_n49_), .O(z5));
  nand3  g42(.a(x8), .b(x7), .c(x4), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n35_), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n24_), .c(x3), .O(new_n62_));
  aoi21  g45(.a(new_n45_), .b(x8), .c(new_n23_), .O(new_n63_));
  nand3  g46(.a(x8), .b(new_n23_), .c(x5), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n63_), .c(x9), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n62_), .c(new_n49_), .O(z6));
endmodule
