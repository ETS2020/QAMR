...
module FAU ( 
  ...
  oai21  g35(.a(new_n52_), .b(new_n40_), .c(new_n18_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g37(.a(new_n33_), .b(new_n40_), .O(new_n55_));
  ...
  inv1   g41(.a(new_n47_), .O(new_n59_));
  nand3  g42(.a(new_n32_), .b(new_n44_), .c(new_n43_), .O(new_n60_));
  aoi21  g43(.a(new_n60_), .b(x8), .c(new_n21_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n59_), .c(x9), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(new_n58_), .c(new_n55_), .O(z6));
endmodule
