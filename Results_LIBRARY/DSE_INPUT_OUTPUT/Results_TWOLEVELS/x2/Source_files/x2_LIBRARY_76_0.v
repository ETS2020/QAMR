...
module FAU ( 
  ...
  oai21  g13(.a(x8), .b(new_n25_), .c(new_n18_), .O(new_n31_));
  inv1   g14(.a(x2), .O(new_n32_));
  nand2  g15(.a(new_n18_), .b(new_n25_), .O(new_n33_));
  nor2   g16(.a(x1), .b(x0), .O(new_n34_));
  nand4  g17(.a(new_n34_), .b(new_n24_), .c(new_n33_), .d(new_n32_), .O(new_n35_));
  aoi21  g18(.a(new_n31_), .b(new_n20_), .c(new_n35_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n30_), .O(z3));
  oai21  g20(.a(new_n22_), .b(x7), .c(x6), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(x5), .O(new_n39_));
  inv1   g22(.a(x6), .O(new_n40_));
  oai21  g23(.a(x8), .b(new_n40_), .c(x9), .O(new_n41_));
  nand4  g24(.a(new_n41_), .b(new_n39_), .c(new_n33_), .d(new_n23_), .O(z4));
  ...
  oai21  g35(.a(new_n52_), .b(new_n40_), .c(x5), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n49_), .O(z5));
  nand2  g37(.a(new_n33_), .b(new_n40_), .O(new_n55_));
  xor2a  g38(.a(x9), .b(x8), .O(new_n56_));
  nand2  g39(.a(x4), .b(x3), .O(new_n57_));
  nand3  g40(.a(new_n18_), .b(x8), .c(x7), .O(new_n58_));
  oai22  g41(.a(new_n58_), .b(new_n57_), .c(new_n56_), .d(x7), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x5), .O(new_n60_));
  nand3  g43(.a(new_n32_), .b(new_n44_), .c(new_n43_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x8), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x9), .c(x7), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(new_n60_), .c(new_n55_), .O(z6));
endmodule
