...
module FAU ( 
  ...
  aoi21  g10(.a(new_n26_), .b(new_n23_), .c(new_n27_), .O(new_n28_));
  ...
  oai21  g40(.a(new_n42_), .b(new_n57_), .c(new_n30_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n19_), .c(new_n23_), .O(new_n59_));
  aoi21  g42(.a(new_n38_), .b(x8), .c(new_n20_), .O(new_n60_));
  ...
  nand3  g46(.a(new_n63_), .b(new_n59_), .c(new_n50_), .O(z6));
endmodule
