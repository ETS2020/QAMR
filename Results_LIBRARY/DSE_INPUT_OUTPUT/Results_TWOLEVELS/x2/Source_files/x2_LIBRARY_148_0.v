...
module FAU ( 
  ...
  nand4  g15(.a(new_n19_), .b(new_n18_), .c(new_n23_), .d(x2), .O(new_n33_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n47_), .c(x6), .O(new_n52_));
  ...
  oai21  g40(.a(new_n20_), .b(x7), .c(x6), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x2), .O(new_n59_));
  nand3  g42(.a(x7), .b(new_n44_), .c(new_n43_), .O(new_n60_));
  ...
  oai21  g46(.a(new_n19_), .b(x8), .c(new_n63_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x7), .O(new_n65_));
  nand4  g48(.a(new_n65_), .b(new_n62_), .c(new_n59_), .d(new_n56_), .O(z6));
endmodule
