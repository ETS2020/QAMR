...
module FAU ( 
  ...
  nand2  g23(.a(x9), .b(x2), .O(new_n41_));
  ...
  nand3  g27(.a(x8), .b(new_n18_), .c(x5), .O(new_n45_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n47_), .c(new_n42_), .O(z5));
  nand3  g35(.a(x9), .b(new_n21_), .c(x7), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(x6), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n24_), .O(new_n55_));
  inv1   g38(.a(x0), .O(new_n56_));
  inv1   g39(.a(x1), .O(new_n57_));
  nand3  g40(.a(x9), .b(new_n57_), .c(new_n56_), .O(new_n58_));
  ...
  oai21  g46(.a(x9), .b(x6), .c(new_n41_), .O(new_n64_));
  aoi21  g47(.a(new_n63_), .b(new_n18_), .c(new_n64_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n61_), .c(new_n55_), .O(z6));
endmodule
