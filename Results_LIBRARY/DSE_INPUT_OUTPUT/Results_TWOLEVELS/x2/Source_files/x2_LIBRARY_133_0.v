...
module FAU ( 
  ...
  nor2   g37(.a(new_n45_), .b(x7), .O(new_n55_));
  oai21  g38(.a(new_n55_), .b(new_n20_), .c(x5), .O(new_n56_));
  inv1   g39(.a(x4), .O(new_n57_));
  nand3  g40(.a(x7), .b(new_n57_), .c(x3), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x5), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n30_), .O(new_n60_));
  nand4  g43(.a(new_n60_), .b(new_n56_), .c(new_n54_), .d(new_n48_), .O(z5));
  xor2a  g44(.a(x9), .b(x8), .O(new_n62_));
  nand2  g45(.a(x4), .b(x3), .O(new_n63_));
  nand3  g46(.a(new_n30_), .b(x8), .c(x7), .O(new_n64_));
  oai22  g47(.a(new_n64_), .b(new_n63_), .c(new_n62_), .d(x7), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x5), .O(new_n66_));
  nand2  g49(.a(new_n43_), .b(x8), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(x9), .c(x7), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n66_), .c(new_n48_), .O(z6));
endmodule
