...
module FAU ( 
  ...
  nand3  g14(.a(new_n31_), .b(new_n29_), .c(new_n28_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n21_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n19_), .O(z3));
  nand4  g17(.a(x9), .b(new_n18_), .c(x7), .d(x6), .O(z4));
  ...
  oai21  g25(.a(new_n42_), .b(new_n30_), .c(new_n21_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n40_), .c(new_n38_), .O(z5));
  inv1   g27(.a(x2), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n29_), .c(new_n28_), .O(new_n46_));
  ...
  nand2  g33(.a(new_n30_), .b(new_n21_), .O(new_n51_));
