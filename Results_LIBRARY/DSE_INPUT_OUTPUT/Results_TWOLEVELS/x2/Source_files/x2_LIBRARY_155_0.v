...
module FAU ( 
  ...
  nand2  g28(.a(new_n32_), .b(new_n34_), .O(new_n46_));
  aoi21  g29(.a(x9), .b(new_n18_), .c(new_n34_), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(x9), .c(new_n22_), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(new_n46_), .c(new_n44_), .d(x6), .O(z4));
  ...
  oai21  g38(.a(new_n20_), .b(new_n55_), .c(x4), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n54_), .O(z5));
  nand2  g40(.a(new_n46_), .b(new_n55_), .O(new_n58_));
  nand3  g41(.a(x8), .b(x7), .c(x3), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n30_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n32_), .c(x4), .O(new_n61_));
  inv1   g44(.a(new_n52_), .O(new_n62_));
  aoi21  g45(.a(new_n42_), .b(x8), .c(new_n22_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n62_), .c(x9), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n61_), .c(new_n58_), .O(z6));
endmodule
