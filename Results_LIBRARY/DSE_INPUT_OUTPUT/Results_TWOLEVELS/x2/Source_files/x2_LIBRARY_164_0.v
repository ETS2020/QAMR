...
module FAU ( 
  ...
  nand2  g21(.a(new_n33_), .b(new_n32_), .O(new_n39_));
  ...
  nand4  g26(.a(x9), .b(x8), .c(new_n29_), .d(x5), .O(new_n44_));
  nand4  g27(.a(new_n44_), .b(new_n43_), .c(new_n39_), .d(new_n38_), .O(z5));
  oai21  g28(.a(new_n18_), .b(x7), .c(new_n20_), .O(new_n46_));
  nand4  g29(.a(x9), .b(new_n26_), .c(new_n25_), .d(new_n24_), .O(new_n47_));
  nand3  g30(.a(new_n18_), .b(x4), .c(x3), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n47_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x7), .O(new_n50_));
  nand4  g33(.a(new_n50_), .b(new_n44_), .c(new_n39_), .d(new_n46_), .O(z6));
endmodule
