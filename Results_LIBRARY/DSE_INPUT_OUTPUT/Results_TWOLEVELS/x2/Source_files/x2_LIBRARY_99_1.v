...
module FAU ( 
  ...
  nand2  g15(.a(x9), .b(new_n28_), .O(new_n33_));
  oai21  g16(.a(new_n26_), .b(x7), .c(new_n33_), .O(z2));
  inv1   g17(.a(x2), .O(new_n35_));
  oai21  g18(.a(new_n19_), .b(x7), .c(new_n25_), .O(new_n36_));
  nor2   g19(.a(x1), .b(x0), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(new_n33_), .d(new_n35_), .O(z3));
  ...
  nand3  g34(.a(new_n51_), .b(new_n29_), .c(x0), .O(new_n52_));
