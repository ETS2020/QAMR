...
module FAU ( 
  ...
  oai21  g08(.a(x9), .b(new_n18_), .c(new_n21_), .O(new_n26_));
  ...
  oai21  g12(.a(new_n22_), .b(x8), .c(new_n18_), .O(new_n30_));
  ...
  nand3  g18(.a(new_n22_), .b(new_n35_), .c(x3), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n34_), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(x7), .O(new_n38_));
  nand3  g21(.a(x9), .b(new_n18_), .c(x5), .O(new_n39_));
  nand3  g22(.a(new_n39_), .b(x8), .c(x6), .O(new_n40_));
  inv1   g23(.a(new_n40_), .O(new_n41_));
  nand2  g24(.a(new_n41_), .b(new_n38_), .O(z5));
  nand4  g25(.a(x9), .b(new_n25_), .c(new_n33_), .d(new_n32_), .O(new_n43_));
  nand4  g26(.a(new_n22_), .b(x8), .c(x4), .d(x3), .O(new_n44_));
  ...
  oai21  g31(.a(new_n22_), .b(x8), .c(x6), .O(new_n49_));
