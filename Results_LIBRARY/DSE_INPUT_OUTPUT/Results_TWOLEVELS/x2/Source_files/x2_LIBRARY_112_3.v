...
module FAU ( 
  ...
  nand4  g21(.a(new_n33_), .b(new_n38_), .c(new_n37_), .d(new_n24_), .O(new_n39_));
  ...
  oai21  g26(.a(new_n29_), .b(x0), .c(x9), .O(new_n44_));
  ...
  aoi21  g30(.a(new_n47_), .b(new_n33_), .c(new_n38_), .O(new_n48_));
  nand4  g31(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x6), .O(new_n50_));
  aoi21  g33(.a(new_n48_), .b(new_n37_), .c(new_n50_), .O(new_n51_));
  ...
  oai21  g38(.a(new_n51_), .b(x0), .c(new_n55_), .O(z5));
  nand3  g39(.a(x8), .b(new_n18_), .c(x5), .O(new_n57_));
  nand3  g40(.a(x7), .b(new_n38_), .c(new_n37_), .O(new_n58_));
  nand4  g41(.a(new_n58_), .b(new_n57_), .c(new_n29_), .d(new_n24_), .O(new_n59_));
