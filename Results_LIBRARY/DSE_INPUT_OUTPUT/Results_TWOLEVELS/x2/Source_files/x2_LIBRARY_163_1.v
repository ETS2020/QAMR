...
module FAU ( 
  ...
  aoi21  g11(.a(new_n20_), .b(new_n26_), .c(x2), .O(new_n29_));
  ...
  oai21  g16(.a(new_n21_), .b(new_n33_), .c(x7), .O(new_n34_));
  oai21  g17(.a(x9), .b(x7), .c(new_n34_), .O(z4));
  inv1   g18(.a(x4), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(x3), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n26_), .c(x8), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n18_), .O(new_n39_));
  nand4  g22(.a(x8), .b(x2), .c(new_n28_), .d(new_n27_), .O(new_n40_));
