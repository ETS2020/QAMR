...
module FAU ( 
  ...
  oai21  g14(.a(x8), .b(x7), .c(x6), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n24_), .O(new_n33_));
  oai21  g16(.a(new_n20_), .b(x7), .c(new_n33_), .O(z4));
  inv1   g17(.a(x3), .O(new_n35_));
  oai21  g18(.a(x4), .b(new_n35_), .c(new_n24_), .O(new_n36_));
  ...
  nand2  g29(.a(new_n20_), .b(new_n19_), .O(new_n47_));
