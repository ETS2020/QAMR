...
module FAU ( 
  ...
  nor2   g11(.a(x9), .b(new_n23_), .O(new_n29_));
  nor2   g12(.a(new_n18_), .b(x8), .O(new_n30_));
  oai21  g13(.a(new_n30_), .b(new_n29_), .c(x7), .O(new_n31_));
  oai21  g14(.a(x8), .b(new_n23_), .c(new_n18_), .O(new_n32_));
  ...
  nand4  g21(.a(new_n38_), .b(new_n33_), .c(new_n31_), .d(new_n22_), .O(z3));
  oai21  g22(.a(x9), .b(new_n20_), .c(x8), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n33_), .c(x6), .O(z4));
  xnor2a g24(.a(x8), .b(x7), .O(new_n42_));
  nand4  g25(.a(new_n42_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n43_));
  ...
  nand3  g32(.a(new_n49_), .b(new_n18_), .c(x6), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n46_), .O(z5));
  nand4  g34(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n27_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n18_), .c(x6), .O(new_n54_));
  nand2  g37(.a(new_n44_), .b(x6), .O(new_n55_));
  aoi21  g38(.a(new_n37_), .b(x8), .c(new_n20_), .O(new_n56_));
