...
module FAU ( 
  ...
  oai21  g13(.a(x9), .b(x7), .c(new_n31_), .O(new_n32_));
  ...
  nand3  g19(.a(new_n37_), .b(new_n32_), .c(new_n30_), .O(z5));
  inv1   g20(.a(x7), .O(new_n39_));
  nand3  g21(.a(x9), .b(new_n39_), .c(x5), .O(new_n40_));
  ...
  nand3  g29(.a(new_n47_), .b(new_n43_), .c(new_n32_), .O(z6));
  zero   g30(.O(z2));
endmodule
