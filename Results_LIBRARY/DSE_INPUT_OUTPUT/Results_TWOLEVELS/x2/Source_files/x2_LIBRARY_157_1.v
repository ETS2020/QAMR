...
module FAU ( 
  ...
  nand3  g21(.a(new_n26_), .b(new_n38_), .c(x3), .O(new_n39_));
  ...
  nand3  g28(.a(new_n29_), .b(x9), .c(new_n28_), .O(new_n46_));
  nand4  g29(.a(new_n26_), .b(x8), .c(x4), .d(x3), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(new_n46_), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(x7), .O(new_n49_));
  inv1   g32(.a(x5), .O(new_n50_));
  oai21  g33(.a(new_n26_), .b(new_n50_), .c(x8), .O(new_n51_));
  oai21  g34(.a(new_n26_), .b(x8), .c(x6), .O(new_n52_));
