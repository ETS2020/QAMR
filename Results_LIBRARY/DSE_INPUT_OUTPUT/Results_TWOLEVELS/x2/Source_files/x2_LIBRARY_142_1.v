...
module FAU ( 
  ...
  oai21  g13(.a(x8), .b(x7), .c(new_n28_), .O(new_n31_));
  ...
  aoi21  g20(.a(x9), .b(new_n33_), .c(x1), .O(new_n38_));
  ...
  nand2  g25(.a(new_n19_), .b(x7), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n33_), .c(x9), .O(new_n44_));
  nand2  g27(.a(new_n28_), .b(new_n18_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n42_), .O(z4));
  nand4  g29(.a(x9), .b(x8), .c(new_n18_), .d(x5), .O(new_n47_));
  ...
  nand3  g36(.a(new_n53_), .b(new_n49_), .c(new_n34_), .O(z5));
  nand3  g37(.a(x8), .b(new_n18_), .c(x5), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n43_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(x9), .c(x0), .O(new_n57_));
  nand4  g40(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n58_));
  oai21  g41(.a(x8), .b(x7), .c(new_n58_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n28_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n57_), .c(new_n42_), .O(z6));
endmodule
