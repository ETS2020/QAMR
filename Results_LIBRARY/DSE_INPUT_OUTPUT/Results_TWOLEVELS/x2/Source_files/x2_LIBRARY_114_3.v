...
module FAU ( 
  ...
  oai21  g11(.a(new_n28_), .b(x8), .c(new_n19_), .O(new_n29_));
  nand3  g12(.a(new_n29_), .b(new_n28_), .c(x6), .O(z4));
  inv1   g13(.a(x6), .O(new_n31_));
  oai21  g14(.a(new_n28_), .b(new_n19_), .c(new_n31_), .O(new_n32_));
  inv1   g15(.a(x3), .O(new_n33_));
  oai21  g16(.a(x4), .b(new_n33_), .c(new_n28_), .O(new_n34_));
