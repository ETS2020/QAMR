...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n25_,
    ...
    new_n66_, new_n67_;
  aoi21  g00(.a(x9), .b(x6), .c(x8), .O(new_n18_));
  inv1   g01(.a(x7), .O(new_n19_));
  inv1   g02(.a(x8), .O(new_n20_));
  nand3  g03(.a(new_n20_), .b(new_n19_), .c(x6), .O(new_n21_));
  nor2   g04(.a(x9), .b(x8), .O(new_n22_));
  aoi21  g05(.a(new_n21_), .b(x9), .c(new_n22_), .O(new_n23_));
  oai21  g06(.a(new_n18_), .b(x7), .c(new_n23_), .O(z0));
  inv1   g07(.a(x6), .O(new_n25_));
  nand2  g08(.a(new_n20_), .b(x7), .O(new_n26_));
  oai21  g09(.a(new_n26_), .b(new_n25_), .c(x9), .O(new_n27_));
  nand2  g10(.a(x8), .b(new_n19_), .O(new_n28_));
  inv1   g11(.a(x9), .O(new_n29_));
  nand2  g12(.a(new_n29_), .b(x7), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n28_), .c(new_n27_), .O(z1));
  nand2  g14(.a(new_n22_), .b(new_n19_), .O(new_n32_));
  oai21  g15(.a(new_n29_), .b(x6), .c(new_n32_), .O(z2));
  oai21  g16(.a(x8), .b(new_n25_), .c(x9), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(x7), .O(new_n35_));
  nand3  g18(.a(new_n26_), .b(x9), .c(x6), .O(new_n36_));
  ...
  nand3  g25(.a(new_n42_), .b(new_n36_), .c(new_n35_), .O(z3));
  oai21  g26(.a(new_n29_), .b(x8), .c(new_n19_), .O(new_n44_));
  nand2  g27(.a(new_n29_), .b(new_n25_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n27_), .O(z4));
  ...
  nor2   g32(.a(new_n29_), .b(new_n20_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n19_), .c(x5), .O(new_n51_));
  ...
  nand3  g41(.a(new_n50_), .b(x6), .c(x5), .O(new_n59_));
  inv1   g42(.a(new_n59_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n22_), .c(new_n19_), .O(new_n61_));
  nand3  g44(.a(new_n39_), .b(new_n38_), .c(new_n37_), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(x8), .O(new_n63_));
  nand3  g46(.a(new_n63_), .b(x9), .c(x6), .O(new_n64_));
