...
module FAU ( 
  ...
  oai21  g10(.a(new_n25_), .b(x7), .c(new_n19_), .O(new_n28_));
  ...
  nand3  g21(.a(new_n32_), .b(new_n38_), .c(new_n37_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n25_), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n36_), .c(new_n29_), .O(z3));
  inv1   g24(.a(x6), .O(new_n42_));
  oai21  g25(.a(new_n25_), .b(x0), .c(new_n42_), .O(new_n43_));
  nand2  g26(.a(new_n19_), .b(x7), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n34_), .c(x9), .O(new_n45_));
  ...
  nand3  g39(.a(new_n56_), .b(new_n44_), .c(x0), .O(new_n57_));
