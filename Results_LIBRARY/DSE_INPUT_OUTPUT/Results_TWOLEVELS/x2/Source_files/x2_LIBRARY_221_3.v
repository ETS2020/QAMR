...
module FAU ( 
  ...
  oai21  g16(.a(x8), .b(x7), .c(x6), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n26_), .O(new_n35_));
  nand2  g18(.a(new_n35_), .b(new_n22_), .O(z4));
  inv1   g19(.a(x3), .O(new_n37_));
  oai21  g20(.a(x4), .b(new_n37_), .c(new_n26_), .O(new_n38_));
  ...
  and2   g26(.a(new_n43_), .b(x6), .O(new_n44_));
  ...
  nand2  g31(.a(new_n18_), .b(new_n21_), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(new_n48_), .c(new_n43_), .d(x6), .O(z6));
endmodule
