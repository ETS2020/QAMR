...
module FAU ( 
  ...
  nand3  g15(.a(x8), .b(new_n22_), .c(x6), .O(new_n33_));
  ...
  nand3  g40(.a(new_n57_), .b(new_n32_), .c(x6), .O(new_n58_));
  inv1   g41(.a(x5), .O(new_n59_));
  nand2  g42(.a(x8), .b(new_n22_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n59_), .c(x6), .O(new_n61_));
  aoi21  g44(.a(new_n38_), .b(x8), .c(new_n22_), .O(new_n62_));
