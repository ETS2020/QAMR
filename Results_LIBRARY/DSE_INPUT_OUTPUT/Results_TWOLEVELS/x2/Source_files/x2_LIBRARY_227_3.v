...
module FAU ( 
  ...
  oai21  g20(.a(new_n30_), .b(x4), .c(x9), .O(new_n38_));
  nor2   g21(.a(x1), .b(x0), .O(new_n39_));
  aoi21  g22(.a(new_n27_), .b(new_n18_), .c(x2), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(z3));
  inv1   g24(.a(x6), .O(new_n42_));
  nand2  g25(.a(new_n34_), .b(new_n42_), .O(new_n43_));
  nand2  g26(.a(new_n19_), .b(new_n18_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n31_), .O(z4));
  ...
  aoi21  g38(.a(x9), .b(x4), .c(new_n27_), .O(new_n56_));
  nand4  g39(.a(new_n56_), .b(new_n55_), .c(new_n50_), .d(new_n43_), .O(z5));
  nand3  g40(.a(new_n51_), .b(x5), .c(new_n24_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n28_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n18_), .O(new_n60_));
  inv1   g43(.a(x2), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n47_), .c(new_n46_), .O(new_n62_));
  ...
  nand3  g50(.a(new_n67_), .b(new_n60_), .c(new_n43_), .O(z6));
endmodule
