...
module FAU ( 
  ...
  oai21  g25(.a(new_n28_), .b(new_n34_), .c(x9), .O(new_n43_));
  ...
  nand4  g30(.a(new_n47_), .b(x2), .c(new_n38_), .d(new_n37_), .O(new_n48_));
  ...
  nand4  g38(.a(new_n55_), .b(new_n51_), .c(new_n48_), .d(x6), .O(z5));
  nand2  g39(.a(x9), .b(new_n19_), .O(new_n57_));
  nand3  g40(.a(new_n25_), .b(x8), .c(x4), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(new_n57_), .c(new_n34_), .O(new_n59_));
  nand4  g42(.a(x9), .b(new_n39_), .c(new_n38_), .d(new_n37_), .O(new_n60_));
  inv1   g43(.a(new_n60_), .O(new_n61_));
  oai21  g44(.a(new_n61_), .b(new_n59_), .c(x7), .O(new_n62_));
  nand3  g45(.a(x9), .b(x8), .c(x5), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n26_), .O(new_n64_));
  oai21  g47(.a(new_n25_), .b(x3), .c(x6), .O(new_n65_));
  aoi21  g48(.a(new_n64_), .b(new_n18_), .c(new_n65_), .O(new_n66_));
