...
module FAU ( 
  ...
  nor2   g13(.a(x9), .b(x8), .O(new_n31_));
  nor2   g14(.a(new_n31_), .b(x2), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(new_n30_), .c(new_n29_), .O(new_n33_));
  nand2  g16(.a(new_n33_), .b(new_n21_), .O(new_n34_));
  nand2  g17(.a(new_n34_), .b(new_n19_), .O(z3));
  nand4  g18(.a(x9), .b(new_n18_), .c(x7), .d(x6), .O(z4));
  ...
  nand2  g23(.a(new_n24_), .b(new_n40_), .O(new_n41_));
  nand3  g24(.a(x9), .b(x8), .c(x5), .O(new_n42_));
  inv1   g25(.a(new_n42_), .O(new_n43_));
  oai21  g26(.a(new_n43_), .b(new_n31_), .c(new_n21_), .O(new_n44_));
  ...
  nand2  g34(.a(new_n31_), .b(new_n21_), .O(new_n52_));
