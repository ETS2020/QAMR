...
module FAU ( 
  ...
  oai21  g29(.a(x9), .b(x5), .c(new_n46_), .O(new_n47_));
  ...
  oai21  g41(.a(new_n58_), .b(new_n46_), .c(x5), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n55_), .O(z5));
  xor2a  g43(.a(x9), .b(x8), .O(new_n61_));
  nand2  g44(.a(x4), .b(x3), .O(new_n62_));
  nand3  g45(.a(new_n32_), .b(x8), .c(x7), .O(new_n63_));
  oai22  g46(.a(new_n63_), .b(new_n62_), .c(new_n61_), .d(x7), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(x5), .O(new_n65_));
  nand2  g48(.a(new_n42_), .b(x8), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(x9), .c(x7), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n65_), .c(new_n47_), .O(z6));
endmodule
