...
module FAU ( 
  ...
  oai21  g13(.a(new_n30_), .b(x5), .c(new_n19_), .O(new_n31_));
  oai21  g14(.a(new_n20_), .b(x8), .c(x7), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n31_), .O(z1));
  nand3  g16(.a(new_n18_), .b(new_n20_), .c(new_n24_), .O(new_n34_));
  ...
  nand4  g23(.a(new_n40_), .b(new_n25_), .c(new_n19_), .d(new_n23_), .O(z3));
  ...
  oai21  g32(.a(new_n30_), .b(x7), .c(x6), .O(new_n50_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n51_), .c(new_n49_), .O(z5));
  aoi21  g39(.a(new_n39_), .b(x8), .c(new_n20_), .O(new_n57_));
  nand4  g40(.a(new_n20_), .b(x8), .c(x4), .d(x3), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(x6), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n57_), .c(x7), .O(new_n60_));
  nand2  g43(.a(new_n19_), .b(x5), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n60_), .c(new_n51_), .O(z6));
endmodule
