...
module FAU ( 
  ...
  aoi21  g07(.a(new_n18_), .b(x7), .c(new_n24_), .O(new_n25_));
  nand2  g08(.a(new_n25_), .b(new_n23_), .O(z1));
  oai21  g09(.a(x9), .b(new_n21_), .c(new_n20_), .O(new_n27_));
  ...
  nand4  g16(.a(new_n33_), .b(new_n25_), .c(x8), .d(new_n29_), .O(z3));
  inv1   g17(.a(new_n24_), .O(new_n35_));
  nand3  g18(.a(new_n35_), .b(x7), .c(x6), .O(z4));
  inv1   g19(.a(x6), .O(new_n37_));
  oai21  g20(.a(new_n18_), .b(x7), .c(new_n37_), .O(new_n38_));
  nand3  g21(.a(x9), .b(x8), .c(x2), .O(new_n39_));
  inv1   g22(.a(x4), .O(new_n40_));
  nand3  g23(.a(new_n18_), .b(new_n40_), .c(x3), .O(new_n41_));
  oai21  g24(.a(new_n39_), .b(new_n32_), .c(new_n41_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(x7), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n38_), .c(new_n22_), .O(z5));
  nor3   g27(.a(x2), .b(x1), .c(x0), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n21_), .c(x9), .O(new_n46_));
  nor2   g29(.a(x9), .b(new_n21_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(x7), .c(x4), .d(x3), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(new_n46_), .c(new_n38_), .d(new_n27_), .O(z6));
endmodule
