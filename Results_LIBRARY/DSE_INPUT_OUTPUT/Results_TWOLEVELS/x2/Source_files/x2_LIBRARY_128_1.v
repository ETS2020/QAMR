...
module FAU ( 
  ...
  nand2  g11(.a(new_n28_), .b(new_n24_), .O(z3));
  ...
  nand3  g17(.a(new_n26_), .b(x9), .c(x2), .O(new_n35_));
  ...
  nand3  g22(.a(x9), .b(new_n20_), .c(x5), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(x8), .d(x6), .O(z5));
  oai21  g24(.a(new_n18_), .b(x8), .c(new_n31_), .O(new_n42_));
  inv1   g25(.a(new_n40_), .O(new_n43_));
  inv1   g26(.a(x0), .O(new_n44_));
  inv1   g27(.a(x1), .O(new_n45_));
  nand4  g28(.a(x9), .b(new_n25_), .c(new_n45_), .d(new_n44_), .O(new_n46_));
  nand3  g29(.a(new_n18_), .b(x4), .c(x3), .O(new_n47_));
  aoi21  g30(.a(new_n47_), .b(new_n46_), .c(new_n20_), .O(new_n48_));
  oai21  g31(.a(new_n48_), .b(new_n43_), .c(x8), .O(new_n49_));
  nand3  g32(.a(new_n18_), .b(new_n21_), .c(new_n20_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n49_), .c(new_n42_), .O(z6));
endmodule
