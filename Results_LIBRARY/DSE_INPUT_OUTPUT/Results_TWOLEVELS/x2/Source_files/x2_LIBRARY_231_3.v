...
module FAU ( 
  ...
  oai21  g20(.a(x9), .b(new_n19_), .c(x8), .O(new_n38_));
  nand3  g21(.a(new_n38_), .b(new_n31_), .c(x6), .O(z4));
  nand4  g22(.a(new_n19_), .b(x2), .c(new_n33_), .d(new_n32_), .O(new_n40_));
  ...
  nand4  g33(.a(new_n50_), .b(new_n28_), .c(new_n25_), .d(x6), .O(z6));
endmodule
