...
module FAU ( 
  ...
  nand2  g19(.a(new_n32_), .b(new_n34_), .O(new_n37_));
  nand4  g20(.a(new_n37_), .b(new_n36_), .c(new_n28_), .d(new_n21_), .O(z3));
  inv1   g21(.a(x6), .O(new_n39_));
  nand2  g22(.a(new_n37_), .b(new_n39_), .O(new_n40_));
  aoi21  g23(.a(x9), .b(new_n18_), .c(new_n34_), .O(new_n41_));
  ...
  nand3  g29(.a(new_n46_), .b(x2), .c(new_n45_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x9), .O(new_n48_));
  nand2  g31(.a(new_n48_), .b(new_n34_), .O(new_n49_));
  oai21  g32(.a(new_n20_), .b(new_n39_), .c(x1), .O(new_n50_));
  ...
  nand3  g38(.a(new_n55_), .b(new_n50_), .c(new_n49_), .O(z5));
  nand2  g39(.a(new_n52_), .b(x9), .O(new_n57_));
  nor3   g40(.a(x9), .b(x8), .c(x7), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n39_), .c(x1), .O(new_n59_));
  inv1   g42(.a(x2), .O(new_n60_));
  nand3  g43(.a(x7), .b(new_n60_), .c(new_n45_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x9), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n34_), .O(new_n63_));
  nand4  g46(.a(new_n32_), .b(x8), .c(x4), .d(x3), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n33_), .c(x7), .O(new_n66_));
  nand4  g49(.a(new_n66_), .b(new_n63_), .c(new_n59_), .d(new_n57_), .O(z6));
endmodule
