...
module FAU ( 
  ...
  oai21  g11(.a(new_n18_), .b(new_n20_), .c(new_n28_), .O(z2));
  nand2  g12(.a(new_n22_), .b(x2), .O(new_n30_));
  nand2  g13(.a(new_n30_), .b(x9), .O(new_n31_));
  oai21  g14(.a(new_n21_), .b(x7), .c(new_n18_), .O(new_n32_));
  nor3   g15(.a(x2), .b(x1), .c(x0), .O(new_n33_));
  nand3  g16(.a(new_n33_), .b(new_n32_), .c(new_n31_), .O(z3));
  oai21  g17(.a(new_n22_), .b(x2), .c(x9), .O(new_n35_));
  inv1   g18(.a(x6), .O(new_n36_));
  aoi21  g19(.a(new_n18_), .b(new_n26_), .c(new_n36_), .O(new_n37_));
  ...
  oai21  g31(.a(new_n48_), .b(new_n27_), .c(new_n26_), .O(new_n49_));
  ...
  aoi21  g37(.a(x9), .b(x2), .c(new_n36_), .O(new_n55_));
