...
module FAU ( 
  ...
  nand4  g15(.a(new_n30_), .b(new_n18_), .c(new_n22_), .d(x4), .O(new_n33_));
  ...
  oai21  g20(.a(x8), .b(new_n29_), .c(new_n30_), .O(new_n38_));
  ...
  aoi21  g31(.a(x9), .b(new_n18_), .c(new_n29_), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(x9), .c(new_n22_), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(new_n48_), .c(new_n45_), .O(z4));
  xnor2a g34(.a(x8), .b(x7), .O(new_n52_));
  ...
  oai21  g39(.a(new_n20_), .b(new_n47_), .c(x4), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n56_), .O(z5));
  nand3  g41(.a(x8), .b(x7), .c(x3), .O(new_n59_));
  oai21  g42(.a(x8), .b(x7), .c(new_n59_), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n30_), .c(x4), .O(new_n61_));
  inv1   g44(.a(new_n54_), .O(new_n62_));
  aoi21  g45(.a(new_n43_), .b(x8), .c(new_n22_), .O(new_n63_));
  oai21  g46(.a(new_n63_), .b(new_n62_), .c(x9), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n61_), .c(new_n48_), .O(z6));
endmodule
