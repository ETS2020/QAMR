...
module FAU ( 
  ...
  nand3  g15(.a(new_n32_), .b(new_n31_), .c(new_n28_), .O(z4));
  inv1   g16(.a(x0), .O(new_n34_));
  inv1   g17(.a(x1), .O(new_n35_));
  xnor2a g18(.a(x8), .b(x7), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(x2), .c(new_n35_), .d(new_n34_), .O(new_n37_));
  and2   g20(.a(x8), .b(x5), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(new_n24_), .c(new_n21_), .O(new_n39_));
  nand2  g22(.a(new_n18_), .b(new_n21_), .O(new_n40_));
  aoi21  g23(.a(new_n40_), .b(new_n19_), .c(new_n30_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n39_), .c(new_n37_), .O(z5));
  inv1   g25(.a(x2), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n35_), .c(new_n34_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(x8), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(x9), .c(x7), .O(new_n46_));
  aoi21  g29(.a(new_n19_), .b(x8), .c(new_n30_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n39_), .O(z6));
endmodule
