...
module FAU ( 
  ...
  nand3  g23(.a(new_n40_), .b(new_n32_), .c(new_n30_), .O(z5));
  xnor2a g24(.a(x9), .b(x7), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n29_), .O(new_n43_));
  inv1   g26(.a(x2), .O(new_n44_));
  nand4  g27(.a(x9), .b(new_n44_), .c(new_n34_), .d(new_n33_), .O(new_n45_));
  ...
  nand3  g31(.a(new_n48_), .b(new_n43_), .c(new_n32_), .O(z6));
endmodule
