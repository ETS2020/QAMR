...
module FAU ( 
  ...
  nand4  g13(.a(new_n30_), .b(new_n18_), .c(new_n22_), .d(x5), .O(new_n31_));
  inv1   g14(.a(new_n31_), .O(z2));
  nand3  g15(.a(x8), .b(new_n22_), .c(x5), .O(new_n33_));
  ...
  nand2  g26(.a(new_n30_), .b(new_n41_), .O(new_n44_));
  nand2  g27(.a(x9), .b(x8), .O(new_n45_));
  nand4  g28(.a(new_n45_), .b(new_n44_), .c(new_n43_), .d(x6), .O(z4));
  ...
  nor2   g32(.a(new_n45_), .b(x7), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n20_), .c(x5), .O(new_n51_));
  ...
  nand4  g38(.a(new_n55_), .b(new_n51_), .c(new_n49_), .d(x6), .O(z5));
  inv1   g39(.a(new_n20_), .O(new_n57_));
  nand2  g40(.a(new_n45_), .b(new_n57_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n22_), .c(x5), .O(new_n59_));
  aoi21  g42(.a(new_n38_), .b(x8), .c(new_n30_), .O(new_n60_));
  nand4  g43(.a(new_n30_), .b(x8), .c(x4), .d(x3), .O(new_n61_));
  inv1   g44(.a(new_n61_), .O(new_n62_));
  oai21  g45(.a(new_n62_), .b(new_n60_), .c(x7), .O(new_n63_));
  and2   g46(.a(new_n44_), .b(x6), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n63_), .c(new_n59_), .O(z6));
endmodule
