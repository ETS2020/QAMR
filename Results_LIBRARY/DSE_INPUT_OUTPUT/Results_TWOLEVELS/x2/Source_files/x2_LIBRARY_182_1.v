...
module FAU ( 
  ...
  nand4  g16(.a(new_n33_), .b(new_n18_), .c(x8), .d(new_n26_), .O(z3));
  inv1   g17(.a(x6), .O(new_n35_));
  oai21  g18(.a(new_n18_), .b(x4), .c(new_n35_), .O(new_n36_));
  nand3  g19(.a(new_n22_), .b(x9), .c(x4), .O(new_n37_));
  nand2  g20(.a(new_n18_), .b(new_n26_), .O(new_n38_));
  ...
  nor2   g25(.a(new_n18_), .b(new_n21_), .O(new_n43_));
  inv1   g26(.a(x5), .O(new_n44_));
  nor2   g27(.a(x7), .b(new_n44_), .O(new_n45_));
  aoi21  g28(.a(new_n45_), .b(new_n43_), .c(new_n35_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n42_), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x4), .O(new_n48_));
  nand3  g31(.a(x7), .b(new_n20_), .c(x3), .O(new_n49_));
  nand3  g32(.a(new_n49_), .b(x8), .c(x6), .O(new_n50_));
  nand2  g33(.a(new_n50_), .b(new_n18_), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n48_), .O(z5));
  nand3  g35(.a(x9), .b(new_n26_), .c(x5), .O(new_n53_));
  nand3  g36(.a(new_n18_), .b(x7), .c(x3), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(x8), .c(x4), .O(new_n56_));
  aoi21  g39(.a(new_n32_), .b(x8), .c(new_n26_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n20_), .c(x9), .O(new_n58_));
  nand4  g41(.a(new_n58_), .b(new_n56_), .c(new_n36_), .d(new_n27_), .O(z6));
endmodule
