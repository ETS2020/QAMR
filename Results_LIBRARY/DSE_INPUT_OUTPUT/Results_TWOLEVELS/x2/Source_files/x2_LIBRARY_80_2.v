...
module FAU ( 
  ...
  aoi21  g05(.a(new_n22_), .b(new_n18_), .c(x9), .O(new_n23_));
  ...
  nand4  g10(.a(new_n19_), .b(new_n24_), .c(new_n22_), .d(new_n18_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  oai21  g12(.a(new_n19_), .b(new_n24_), .c(x7), .O(new_n30_));
  nor3   g13(.a(x9), .b(x8), .c(x2), .O(new_n31_));
  oai21  g14(.a(new_n31_), .b(x9), .c(new_n22_), .O(new_n32_));
  nor2   g15(.a(x1), .b(x0), .O(new_n33_));
  aoi21  g16(.a(new_n19_), .b(x2), .c(new_n25_), .O(new_n34_));
  ...
  aoi21  g21(.a(x9), .b(new_n24_), .c(x2), .O(new_n39_));
  oai21  g22(.a(new_n39_), .b(x9), .c(new_n22_), .O(new_n40_));
  ...
  oai21  g38(.a(new_n55_), .b(new_n31_), .c(new_n22_), .O(new_n56_));
