...
module FAU ( 
  ...
  oai21  g05(.a(new_n22_), .b(x5), .c(new_n19_), .O(new_n23_));
  nand2  g06(.a(new_n23_), .b(new_n21_), .O(new_n24_));
  oai21  g07(.a(x7), .b(x5), .c(new_n19_), .O(new_n25_));
  ...
  nand4  g17(.a(new_n34_), .b(new_n26_), .c(new_n33_), .d(new_n32_), .O(new_n35_));
  aoi21  g18(.a(new_n31_), .b(new_n21_), .c(new_n35_), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n30_), .O(z3));
  inv1   g20(.a(x6), .O(new_n38_));
  nand2  g21(.a(new_n33_), .b(new_n38_), .O(new_n39_));
  aoi21  g22(.a(x9), .b(new_n22_), .c(x5), .O(new_n40_));
  oai21  g23(.a(new_n40_), .b(x9), .c(new_n21_), .O(new_n41_));
  ...
  oai21  g35(.a(new_n52_), .b(new_n38_), .c(new_n18_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n49_), .O(z5));
  oai21  g37(.a(new_n22_), .b(x7), .c(x9), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(x5), .O(new_n56_));
  nor3   g39(.a(x9), .b(x8), .c(x7), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(new_n38_), .c(new_n18_), .O(new_n58_));
  ...
  nand2  g46(.a(x9), .b(new_n38_), .O(new_n64_));
