...
module FAU ( 
  ...
  nand3  g33(.a(new_n50_), .b(new_n18_), .c(x5), .O(new_n51_));
  nand3  g34(.a(new_n19_), .b(x7), .c(x3), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n24_), .O(new_n54_));
  aoi21  g37(.a(x9), .b(x4), .c(new_n27_), .O(new_n55_));
  nand4  g38(.a(new_n55_), .b(new_n54_), .c(new_n49_), .d(new_n42_), .O(z5));
  nand3  g39(.a(new_n50_), .b(x5), .c(new_n24_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n28_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n18_), .O(new_n59_));
  inv1   g42(.a(x2), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n46_), .c(new_n45_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x8), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x9), .c(new_n24_), .O(new_n63_));
  nand3  g46(.a(new_n22_), .b(x4), .c(x3), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x7), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(new_n59_), .c(new_n42_), .O(z6));
endmodule
