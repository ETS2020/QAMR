...
module FAU ( 
  ...
  nand4  g26(.a(new_n43_), .b(new_n38_), .c(new_n34_), .d(new_n27_), .O(z3));
  ...
  aoi21  g39(.a(x7), .b(new_n56_), .c(new_n22_), .O(new_n57_));
  oai21  g40(.a(new_n57_), .b(x9), .c(x6), .O(new_n58_));
  ...
  nand3  g45(.a(new_n62_), .b(new_n18_), .c(x3), .O(new_n63_));
  inv1   g46(.a(new_n53_), .O(new_n64_));
  aoi21  g47(.a(new_n42_), .b(x8), .c(new_n20_), .O(new_n65_));
