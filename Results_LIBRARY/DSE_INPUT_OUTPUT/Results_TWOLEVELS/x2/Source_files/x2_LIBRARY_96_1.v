...
module FAU ( 
  ...
  nand2  g21(.a(new_n30_), .b(new_n29_), .O(new_n39_));
  ...
  nand2  g27(.a(new_n19_), .b(new_n20_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n44_), .c(new_n38_), .O(z5));
  ...
  aoi21  g34(.a(new_n19_), .b(x8), .c(x7), .O(new_n52_));
  nor2   g35(.a(new_n19_), .b(x2), .O(new_n53_));
  aoi21  g36(.a(new_n53_), .b(new_n51_), .c(new_n52_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n50_), .c(new_n38_), .O(z6));
endmodule
