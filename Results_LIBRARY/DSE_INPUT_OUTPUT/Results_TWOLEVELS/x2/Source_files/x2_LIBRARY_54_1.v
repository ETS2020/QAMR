...
module FAU ( 
  ...
  oai21  g26(.a(new_n18_), .b(new_n34_), .c(new_n29_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n28_), .O(z4));
  ...
  nor2   g31(.a(new_n29_), .b(new_n19_), .O(new_n49_));
  ...
  nand3  g40(.a(new_n49_), .b(x6), .c(x5), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n24_), .c(new_n18_), .O(new_n60_));
  ...
  nand4  g46(.a(new_n29_), .b(x8), .c(x4), .d(x3), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x7), .O(new_n66_));
  nand2  g49(.a(new_n29_), .b(new_n34_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n66_), .c(new_n60_), .O(z6));
endmodule
