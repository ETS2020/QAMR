...
module FAU ( 
  ...
  nor2   g12(.a(new_n19_), .b(new_n21_), .O(new_n30_));
  aoi21  g13(.a(new_n19_), .b(x2), .c(new_n30_), .O(new_n31_));
  nor2   g14(.a(new_n19_), .b(x8), .O(new_n32_));
  nor2   g15(.a(x9), .b(x2), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(x7), .O(new_n34_));
  oai21  g17(.a(x9), .b(new_n21_), .c(new_n23_), .O(new_n35_));
  nor2   g18(.a(x1), .b(x0), .O(new_n36_));
  nand4  g19(.a(new_n36_), .b(new_n35_), .c(new_n34_), .d(new_n31_), .O(z3));
  nor2   g20(.a(x7), .b(x2), .O(new_n38_));
  oai21  g21(.a(new_n38_), .b(x9), .c(x8), .O(new_n39_));
  inv1   g22(.a(x6), .O(new_n40_));
  aoi21  g23(.a(new_n19_), .b(x2), .c(new_n40_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n39_), .c(new_n35_), .O(z4));
  ...
  aoi21  g36(.a(new_n51_), .b(new_n19_), .c(new_n53_), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n48_), .O(z5));
  nand3  g38(.a(x9), .b(x8), .c(x5), .O(new_n56_));
  oai21  g39(.a(x9), .b(x8), .c(new_n56_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n23_), .O(new_n58_));
  nand3  g41(.a(new_n18_), .b(new_n44_), .c(new_n43_), .O(new_n59_));
  ...
  nand3  g46(.a(new_n63_), .b(new_n58_), .c(new_n41_), .O(z6));
endmodule
