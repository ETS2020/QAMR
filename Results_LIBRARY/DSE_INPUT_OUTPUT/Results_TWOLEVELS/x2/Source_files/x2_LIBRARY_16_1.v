...
module FAU ( 
  ...
  nand3  g39(.a(new_n48_), .b(x6), .c(x5), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n26_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n18_), .O(new_n59_));
  inv1   g42(.a(x2), .O(new_n60_));
  nand3  g43(.a(new_n60_), .b(new_n44_), .c(new_n43_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x8), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x9), .c(x6), .O(new_n63_));
  nand4  g46(.a(new_n30_), .b(x8), .c(x4), .d(x3), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n63_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x7), .O(new_n66_));
  nand2  g49(.a(new_n30_), .b(new_n34_), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n66_), .c(new_n59_), .O(z6));
endmodule
