...
module FAU ( 
  ...
  oai21  g10(.a(x8), .b(new_n21_), .c(new_n19_), .O(new_n28_));
  inv1   g11(.a(new_n28_), .O(z2));
  oai21  g12(.a(x9), .b(new_n18_), .c(new_n21_), .O(new_n30_));
  nand3  g13(.a(new_n30_), .b(new_n18_), .c(new_n21_), .O(z3));
  inv1   g14(.a(x6), .O(new_n32_));
  nand2  g15(.a(new_n18_), .b(new_n32_), .O(new_n33_));
  nand2  g16(.a(x9), .b(x8), .O(new_n34_));
  nand3  g17(.a(new_n34_), .b(new_n33_), .c(new_n30_), .O(z4));
  inv1   g18(.a(x0), .O(new_n36_));
  inv1   g19(.a(x1), .O(new_n37_));
  nand2  g20(.a(new_n18_), .b(new_n21_), .O(new_n38_));
  oai21  g21(.a(new_n34_), .b(new_n21_), .c(new_n38_), .O(new_n39_));
  ...
  oai21  g25(.a(new_n42_), .b(new_n25_), .c(new_n21_), .O(new_n43_));
  aoi22  g26(.a(new_n25_), .b(x7), .c(x9), .d(new_n32_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(new_n40_), .O(z5));
  oai21  g28(.a(x9), .b(new_n18_), .c(new_n32_), .O(new_n46_));
  ...
  nand3  g35(.a(new_n52_), .b(new_n46_), .c(new_n28_), .O(z6));
endmodule
