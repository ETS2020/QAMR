...
module FAU ( 
  ...
  aoi21  g24(.a(x9), .b(new_n21_), .c(x5), .O(new_n42_));
  ...
  nand2  g30(.a(new_n22_), .b(x5), .O(new_n48_));
  ...
  oai21  g38(.a(new_n21_), .b(x7), .c(x9), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x5), .O(new_n57_));
  nor3   g40(.a(x9), .b(x8), .c(x7), .O(new_n58_));
  oai21  g41(.a(new_n58_), .b(new_n40_), .c(new_n18_), .O(new_n59_));
  aoi21  g42(.a(new_n37_), .b(x8), .c(new_n19_), .O(new_n60_));
  ...
  nand2  g46(.a(x9), .b(new_n40_), .O(new_n64_));
  nand4  g47(.a(new_n64_), .b(new_n63_), .c(new_n59_), .d(new_n57_), .O(z6));
endmodule
