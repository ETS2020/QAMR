...
module FAU ( 
  ...
  oai21  g17(.a(new_n26_), .b(new_n35_), .c(x9), .O(new_n36_));
  nand2  g18(.a(new_n36_), .b(new_n18_), .O(new_n37_));
  inv1   g19(.a(x3), .O(new_n38_));
  nor2   g20(.a(x4), .b(new_n38_), .O(new_n39_));
  oai21  g21(.a(new_n39_), .b(new_n21_), .c(new_n19_), .O(new_n40_));
  nand4  g22(.a(new_n40_), .b(new_n37_), .c(new_n34_), .d(new_n32_), .O(z5));
  ...
  nand3  g31(.a(new_n49_), .b(new_n45_), .c(new_n34_), .O(z6));
  zero   g32(.O(z2));
endmodule
