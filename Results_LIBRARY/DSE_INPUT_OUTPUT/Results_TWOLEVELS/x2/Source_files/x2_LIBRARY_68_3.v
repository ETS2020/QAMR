...
module FAU ( 
  ...
  oai21  g39(.a(new_n52_), .b(x1), .c(new_n56_), .O(z5));
  nand3  g40(.a(x8), .b(new_n18_), .c(x5), .O(new_n58_));
  nand3  g41(.a(x7), .b(new_n39_), .c(new_n38_), .O(new_n59_));
  nand4  g42(.a(new_n59_), .b(new_n58_), .c(new_n29_), .d(new_n24_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(x9), .O(new_n61_));
  nand4  g44(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n40_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n19_), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(new_n61_), .c(new_n45_), .O(z6));
endmodule
