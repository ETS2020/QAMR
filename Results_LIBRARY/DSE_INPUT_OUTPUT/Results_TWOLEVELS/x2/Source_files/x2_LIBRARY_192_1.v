...
module FAU ( 
  ...
  nand4  g22(.a(new_n39_), .b(new_n38_), .c(x8), .d(x6), .O(z5));
  oai21  g23(.a(new_n18_), .b(x8), .c(new_n30_), .O(new_n41_));
  ...
  oai21  g29(.a(new_n46_), .b(new_n42_), .c(x8), .O(new_n47_));
  nand3  g30(.a(new_n18_), .b(new_n21_), .c(new_n20_), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n47_), .c(new_n41_), .O(z6));
endmodule
