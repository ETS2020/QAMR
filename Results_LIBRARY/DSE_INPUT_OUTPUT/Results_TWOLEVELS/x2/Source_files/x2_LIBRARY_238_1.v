...
module FAU ( 
  ...
  nand3  g19(.a(new_n29_), .b(x9), .c(x6), .O(new_n37_));
  ...
  oai21  g26(.a(new_n18_), .b(new_n28_), .c(new_n25_), .O(new_n44_));
  nand2  g27(.a(new_n44_), .b(new_n30_), .O(z4));
  nand3  g28(.a(x9), .b(x8), .c(x7), .O(new_n46_));
  oai21  g29(.a(x8), .b(x7), .c(new_n46_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(x2), .c(new_n39_), .d(new_n38_), .O(new_n48_));
  ...
  nand4  g40(.a(x7), .b(new_n40_), .c(new_n39_), .d(new_n38_), .O(new_n58_));
  nand4  g41(.a(new_n58_), .b(new_n57_), .c(new_n29_), .d(x6), .O(new_n59_));
  ...
  nand2  g46(.a(new_n63_), .b(new_n60_), .O(z6));
endmodule
