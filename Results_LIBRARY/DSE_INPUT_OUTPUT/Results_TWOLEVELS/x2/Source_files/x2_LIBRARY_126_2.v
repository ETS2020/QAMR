...
module FAU ( 
  ...
  nor2   g21(.a(new_n21_), .b(x2), .O(new_n39_));
  ...
  oai21  g26(.a(new_n20_), .b(new_n43_), .c(new_n18_), .O(new_n44_));
  oai21  g27(.a(x9), .b(new_n19_), .c(new_n23_), .O(new_n45_));
  oai21  g28(.a(x8), .b(new_n43_), .c(x9), .O(new_n46_));
  nand2  g29(.a(new_n33_), .b(x5), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(z4));
  ...
  oai21  g39(.a(new_n56_), .b(new_n43_), .c(new_n18_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n53_), .O(z5));
  oai21  g41(.a(new_n19_), .b(x7), .c(x9), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(x5), .O(new_n60_));
  nand2  g43(.a(new_n47_), .b(new_n43_), .O(new_n61_));
  xnor2a g44(.a(x9), .b(x7), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n19_), .O(new_n63_));
  inv1   g46(.a(x2), .O(new_n64_));
  nand4  g47(.a(x9), .b(new_n64_), .c(new_n38_), .d(new_n37_), .O(new_n65_));
  nand4  g48(.a(new_n33_), .b(x8), .c(x4), .d(x3), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x7), .O(new_n68_));
  nand4  g51(.a(new_n68_), .b(new_n63_), .c(new_n61_), .d(new_n60_), .O(z6));
endmodule
