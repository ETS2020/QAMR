...
module FAU ( 
  ...
  nand2  g25(.a(new_n32_), .b(new_n42_), .O(new_n43_));
  ...
  oai21  g34(.a(new_n20_), .b(new_n41_), .c(x4), .O(new_n52_));
  nand3  g35(.a(x8), .b(new_n22_), .c(x5), .O(new_n53_));
  inv1   g36(.a(new_n53_), .O(new_n54_));
  oai21  g37(.a(new_n54_), .b(new_n41_), .c(x9), .O(new_n55_));
  nand4  g38(.a(new_n55_), .b(new_n52_), .c(new_n51_), .d(new_n43_), .O(z5));
  nand3  g39(.a(x8), .b(x7), .c(x3), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n30_), .O(new_n58_));
  nand3  g41(.a(new_n58_), .b(new_n32_), .c(x4), .O(new_n59_));
  aoi21  g42(.a(new_n38_), .b(x8), .c(new_n22_), .O(new_n60_));
  oai21  g43(.a(new_n60_), .b(new_n54_), .c(x9), .O(new_n61_));
  nand3  g44(.a(new_n61_), .b(new_n59_), .c(new_n44_), .O(z6));
endmodule
