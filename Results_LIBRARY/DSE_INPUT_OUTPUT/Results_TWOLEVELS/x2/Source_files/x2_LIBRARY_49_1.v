...
module FAU ( 
  ...
  nand3  g04(.a(new_n21_), .b(x9), .c(x6), .O(new_n22_));
  ...
  nor2   g23(.a(new_n18_), .b(new_n20_), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n25_), .c(x5), .O(new_n42_));
  ...
  nand3  g32(.a(new_n41_), .b(x6), .c(x5), .O(new_n50_));
  inv1   g33(.a(new_n50_), .O(new_n51_));
  oai21  g34(.a(new_n51_), .b(new_n26_), .c(new_n25_), .O(new_n52_));
  aoi21  g35(.a(new_n32_), .b(x8), .c(new_n18_), .O(new_n53_));
  ...
  nand3  g39(.a(new_n56_), .b(new_n52_), .c(x6), .O(z6));
endmodule
