...
module FAU ( 
  ...
  aoi21  g32(.a(new_n49_), .b(x8), .c(new_n21_), .O(new_n50_));
  nand3  g33(.a(x8), .b(new_n21_), .c(x5), .O(new_n51_));
  inv1   g34(.a(new_n51_), .O(new_n52_));
  oai21  g35(.a(new_n52_), .b(new_n50_), .c(x9), .O(new_n53_));
  nand2  g36(.a(new_n43_), .b(new_n21_), .O(new_n54_));
  nand3  g37(.a(new_n54_), .b(new_n53_), .c(new_n42_), .O(z6));
endmodule
