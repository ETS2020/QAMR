...
module FAU ( 
  ...
  oai21  g05(.a(x9), .b(x8), .c(new_n19_), .O(new_n23_));
  oai21  g06(.a(x8), .b(x0), .c(x9), .O(new_n24_));
  ...
  oai21  g13(.a(new_n20_), .b(x7), .c(new_n18_), .O(new_n31_));
  aoi21  g14(.a(x9), .b(new_n29_), .c(x2), .O(new_n32_));
  nand4  g15(.a(new_n32_), .b(new_n31_), .c(new_n30_), .d(new_n29_), .O(z3));
  oai21  g16(.a(x9), .b(new_n19_), .c(x8), .O(new_n34_));
  oai21  g17(.a(x9), .b(new_n20_), .c(new_n19_), .O(new_n35_));
  inv1   g18(.a(x6), .O(new_n36_));
  aoi21  g19(.a(x9), .b(x0), .c(new_n36_), .O(new_n37_));
  nand3  g20(.a(new_n37_), .b(new_n35_), .c(new_n34_), .O(z4));
  ...
  nand4  g31(.a(new_n48_), .b(new_n44_), .c(new_n41_), .d(x6), .O(z5));
  ...
  nand3  g40(.a(new_n57_), .b(new_n52_), .c(new_n37_), .O(z6));
endmodule
