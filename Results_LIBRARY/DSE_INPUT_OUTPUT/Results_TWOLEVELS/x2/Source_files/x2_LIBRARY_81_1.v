...
module FAU ( 
  ...
  oai21  g08(.a(x9), .b(new_n25_), .c(new_n20_), .O(new_n26_));
  aoi21  g09(.a(x9), .b(new_n25_), .c(x0), .O(new_n27_));
  ...
  oai21  g15(.a(new_n31_), .b(new_n20_), .c(new_n32_), .O(z4));
  nand2  g16(.a(new_n18_), .b(new_n25_), .O(new_n34_));
  oai21  g17(.a(new_n18_), .b(x7), .c(new_n30_), .O(new_n35_));
  ...
  nand3  g26(.a(new_n43_), .b(new_n35_), .c(new_n34_), .O(z5));
  nor3   g27(.a(x2), .b(x1), .c(x0), .O(new_n45_));
  oai21  g28(.a(new_n45_), .b(new_n25_), .c(x9), .O(new_n46_));
  nor2   g29(.a(x9), .b(new_n25_), .O(new_n47_));
  nand4  g30(.a(new_n47_), .b(x7), .c(x4), .d(x3), .O(new_n48_));
  nand4  g31(.a(new_n48_), .b(new_n46_), .c(new_n35_), .d(new_n26_), .O(z6));
endmodule
