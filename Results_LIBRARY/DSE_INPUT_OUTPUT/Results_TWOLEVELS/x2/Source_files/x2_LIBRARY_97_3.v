...
module FAU ( 
  ...
  nand3  g31(.a(new_n18_), .b(new_n22_), .c(new_n20_), .O(new_n49_));
  nand4  g32(.a(new_n49_), .b(new_n48_), .c(new_n38_), .d(x6), .O(z6));
endmodule
