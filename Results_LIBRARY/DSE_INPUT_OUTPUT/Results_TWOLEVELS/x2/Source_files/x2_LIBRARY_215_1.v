...
module FAU ( 
  ...
  oai21  g19(.a(x8), .b(x7), .c(x1), .O(new_n37_));
  nor2   g20(.a(new_n30_), .b(x2), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n37_), .c(new_n36_), .d(new_n35_), .O(z3));
  inv1   g22(.a(x6), .O(new_n40_));
  oai21  g23(.a(new_n22_), .b(new_n40_), .c(x1), .O(new_n41_));
  nand3  g24(.a(new_n41_), .b(new_n33_), .c(new_n25_), .O(z4));
  nand2  g25(.a(new_n33_), .b(new_n40_), .O(new_n43_));
  inv1   g26(.a(x3), .O(new_n44_));
  oai21  g27(.a(x4), .b(new_n44_), .c(x8), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(x7), .c(x1), .O(new_n46_));
  ...
  nand4  g32(.a(new_n20_), .b(x2), .c(new_n27_), .d(new_n35_), .O(new_n50_));
  nand2  g33(.a(new_n22_), .b(x5), .O(new_n51_));
  nand2  g34(.a(new_n51_), .b(new_n50_), .O(new_n52_));
  nand2  g35(.a(new_n52_), .b(new_n18_), .O(new_n53_));
  nand3  g36(.a(new_n53_), .b(new_n49_), .c(new_n43_), .O(z5));
  nand4  g37(.a(new_n21_), .b(x8), .c(x4), .d(x3), .O(new_n55_));
  oai21  g38(.a(new_n21_), .b(x8), .c(new_n55_), .O(new_n56_));
  nand3  g39(.a(new_n56_), .b(x7), .c(x1), .O(new_n57_));
  nand2  g40(.a(new_n51_), .b(new_n29_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n18_), .O(new_n59_));
  nand3  g42(.a(new_n59_), .b(new_n57_), .c(new_n43_), .O(z6));
endmodule
