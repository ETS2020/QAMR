...
module FAU ( 
  ...
  aoi21  g06(.a(new_n23_), .b(new_n22_), .c(new_n19_), .O(z1));
  inv1   g07(.a(x7), .O(new_n25_));
  nand3  g08(.a(new_n18_), .b(new_n22_), .c(new_n25_), .O(new_n26_));
  nand2  g09(.a(new_n26_), .b(new_n20_), .O(z2));
  nor2   g10(.a(new_n18_), .b(x8), .O(new_n28_));
  nor2   g11(.a(new_n28_), .b(new_n25_), .O(new_n29_));
  nand4  g12(.a(new_n29_), .b(new_n20_), .c(x9), .d(new_n22_), .O(z3));
  nor2   g13(.a(new_n18_), .b(new_n22_), .O(new_n31_));
  nor2   g14(.a(new_n31_), .b(new_n25_), .O(new_n32_));
  nand3  g15(.a(new_n32_), .b(new_n20_), .c(x6), .O(z4));
  ...
  nand2  g31(.a(new_n46_), .b(new_n42_), .O(new_n49_));
  ...
  oai21  g36(.a(new_n53_), .b(new_n28_), .c(x7), .O(new_n54_));
  nand4  g37(.a(new_n54_), .b(new_n46_), .c(new_n26_), .d(new_n20_), .O(z6));
endmodule
