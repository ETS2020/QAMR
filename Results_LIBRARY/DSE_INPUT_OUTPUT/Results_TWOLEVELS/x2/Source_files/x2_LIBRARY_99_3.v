...
module FAU ( 
  ...
  nand2  g30(.a(new_n21_), .b(new_n18_), .O(new_n48_));
  ...
  aoi21  g35(.a(new_n50_), .b(new_n46_), .c(new_n52_), .O(new_n53_));
  ...
  oai21  g40(.a(new_n53_), .b(x0), .c(new_n57_), .O(z5));
  nand3  g41(.a(x8), .b(new_n18_), .c(x5), .O(new_n59_));
  nand3  g42(.a(x7), .b(new_n47_), .c(new_n46_), .O(new_n60_));
  nand4  g43(.a(new_n60_), .b(new_n59_), .c(new_n30_), .d(new_n24_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x9), .O(new_n62_));
  nand4  g45(.a(x8), .b(x7), .c(x4), .d(x3), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n48_), .O(new_n64_));
  nand2  g47(.a(new_n64_), .b(new_n19_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n62_), .c(new_n43_), .O(z6));
endmodule
