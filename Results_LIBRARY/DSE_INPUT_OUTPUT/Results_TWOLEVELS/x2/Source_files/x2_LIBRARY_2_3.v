...
module FAU ( 
  ...
  nand3  g06(.a(new_n19_), .b(new_n18_), .c(new_n23_), .O(new_n24_));
  ...
  oai21  g11(.a(new_n28_), .b(x1), .c(x9), .O(new_n29_));
  nand2  g12(.a(x8), .b(new_n18_), .O(new_n30_));
  ...
  nand3  g32(.a(new_n49_), .b(x2), .c(new_n38_), .O(new_n50_));
  ...
  nand4  g41(.a(x9), .b(x8), .c(x5), .d(new_n23_), .O(new_n59_));
  nand2  g42(.a(new_n59_), .b(new_n26_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n18_), .O(new_n61_));
  oai21  g44(.a(x2), .b(x0), .c(x8), .O(new_n62_));
  nand3  g45(.a(new_n62_), .b(x9), .c(new_n23_), .O(new_n63_));
