...
module FAU ( 
  ...
  nand4  g15(.a(new_n27_), .b(new_n18_), .c(new_n22_), .d(x6), .O(new_n33_));
  inv1   g16(.a(new_n33_), .O(z2));
  oai21  g17(.a(new_n27_), .b(new_n18_), .c(x7), .O(new_n35_));
  nand2  g18(.a(new_n20_), .b(x6), .O(new_n36_));
  nand2  g19(.a(new_n36_), .b(new_n27_), .O(new_n37_));
  inv1   g20(.a(x2), .O(new_n38_));
  nor2   g21(.a(x1), .b(x0), .O(new_n39_));
  nand2  g22(.a(new_n27_), .b(new_n26_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n39_), .c(new_n31_), .d(new_n38_), .O(new_n41_));
  aoi21  g24(.a(new_n37_), .b(new_n22_), .c(new_n41_), .O(new_n42_));
  nand2  g25(.a(new_n42_), .b(new_n35_), .O(z3));
  aoi21  g26(.a(x9), .b(new_n18_), .c(new_n26_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(x9), .c(new_n22_), .O(new_n45_));
  nor2   g28(.a(x8), .b(new_n26_), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n27_), .c(new_n45_), .O(z4));
  ...
  oai21  g38(.a(new_n55_), .b(new_n46_), .c(new_n27_), .O(new_n56_));
  nand4  g39(.a(x9), .b(x8), .c(new_n22_), .d(x5), .O(new_n57_));
  nand4  g40(.a(new_n57_), .b(new_n56_), .c(new_n52_), .d(x6), .O(z5));
  inv1   g41(.a(x5), .O(new_n59_));
  oai21  g42(.a(new_n31_), .b(new_n59_), .c(new_n36_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n22_), .O(new_n61_));
  nand3  g44(.a(new_n38_), .b(new_n49_), .c(new_n48_), .O(new_n62_));
  aoi21  g45(.a(new_n62_), .b(x8), .c(new_n27_), .O(new_n63_));
  nand4  g46(.a(new_n27_), .b(x8), .c(x4), .d(x3), .O(new_n64_));
  inv1   g47(.a(new_n64_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n63_), .c(x7), .O(new_n66_));
