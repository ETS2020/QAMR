...
module FAU ( 
  ...
  nand4  g21(.a(new_n38_), .b(new_n36_), .c(new_n33_), .d(new_n25_), .O(z5));
  inv1   g22(.a(x2), .O(new_n40_));
  nand3  g23(.a(new_n40_), .b(new_n30_), .c(new_n29_), .O(new_n41_));
  aoi21  g24(.a(new_n41_), .b(x8), .c(new_n21_), .O(new_n42_));
  nand3  g25(.a(x8), .b(new_n21_), .c(x5), .O(new_n43_));
  inv1   g26(.a(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n42_), .c(x9), .O(new_n45_));
  nor2   g28(.a(z2), .b(new_n37_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(new_n45_), .O(z6));
  nand2  g30(.a(new_n22_), .b(new_n20_), .O(z3));
endmodule
