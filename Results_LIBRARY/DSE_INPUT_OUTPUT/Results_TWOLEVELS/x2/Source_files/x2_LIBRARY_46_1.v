...
module FAU ( 
  ...
  aoi21  g12(.a(x9), .b(new_n18_), .c(x2), .O(new_n30_));
  nand4  g13(.a(new_n30_), .b(new_n29_), .c(new_n28_), .d(new_n23_), .O(z3));
  nor2   g14(.a(new_n19_), .b(new_n18_), .O(new_n32_));
  nor2   g15(.a(x9), .b(x7), .O(new_n33_));
  oai21  g16(.a(new_n33_), .b(new_n32_), .c(x8), .O(new_n34_));
  ...
  nor2   g33(.a(new_n19_), .b(x2), .O(new_n51_));
  aoi21  g34(.a(new_n51_), .b(new_n29_), .c(new_n50_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n49_), .c(new_n26_), .O(z6));
endmodule
