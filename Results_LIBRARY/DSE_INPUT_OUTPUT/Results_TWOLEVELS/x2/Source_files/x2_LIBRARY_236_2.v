...
module FAU ( 
  ...
  oai21  g17(.a(new_n34_), .b(new_n24_), .c(new_n21_), .O(new_n35_));
  oai21  g18(.a(x8), .b(x7), .c(new_n19_), .O(new_n36_));
  inv1   g19(.a(x6), .O(new_n37_));
  nand2  g20(.a(x9), .b(new_n37_), .O(new_n38_));
  nand4  g21(.a(new_n38_), .b(new_n36_), .c(new_n35_), .d(new_n32_), .O(z5));
  oai21  g22(.a(x9), .b(new_n18_), .c(new_n37_), .O(new_n40_));
  ...
  nand2  g29(.a(new_n24_), .b(new_n21_), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n40_), .O(z6));
  nand2  g31(.a(new_n22_), .b(new_n20_), .O(z3));
endmodule
