...
module FAU ( 
  ...
  aoi21  g13(.a(new_n21_), .b(x7), .c(new_n22_), .O(new_n31_));
  aoi21  g14(.a(new_n22_), .b(x4), .c(new_n31_), .O(new_n32_));
  nand2  g15(.a(new_n32_), .b(new_n30_), .O(z1));
  nand4  g16(.a(new_n22_), .b(new_n21_), .c(new_n19_), .d(new_n18_), .O(new_n34_));
  inv1   g17(.a(new_n34_), .O(z2));
  nor2   g18(.a(new_n22_), .b(x8), .O(new_n36_));
  nor2   g19(.a(x9), .b(x4), .O(new_n37_));
  oai21  g20(.a(new_n37_), .b(new_n36_), .c(x7), .O(new_n38_));
  oai21  g21(.a(x8), .b(x4), .c(new_n22_), .O(new_n39_));
  ...
  aoi21  g32(.a(x9), .b(new_n21_), .c(x4), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(x9), .c(new_n19_), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n49_), .c(new_n46_), .O(z4));
  xnor2a g35(.a(x8), .b(x7), .O(new_n53_));
  nand4  g36(.a(new_n53_), .b(x2), .c(new_n42_), .d(new_n41_), .O(new_n54_));
  nand3  g37(.a(x8), .b(new_n19_), .c(x5), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n54_), .c(x6), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(x9), .O(new_n57_));
  nand2  g40(.a(x7), .b(x3), .O(new_n58_));
  aoi21  g41(.a(new_n58_), .b(x8), .c(x9), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n48_), .c(new_n18_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n57_), .O(z5));
  oai21  g44(.a(new_n23_), .b(x7), .c(x6), .O(new_n62_));
  nand2  g45(.a(new_n62_), .b(new_n18_), .O(new_n63_));
  nand2  g46(.a(new_n55_), .b(x6), .O(new_n64_));
  aoi21  g47(.a(new_n44_), .b(x8), .c(new_n19_), .O(new_n65_));
  oai21  g48(.a(new_n65_), .b(new_n64_), .c(x9), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n63_), .O(z6));
endmodule
