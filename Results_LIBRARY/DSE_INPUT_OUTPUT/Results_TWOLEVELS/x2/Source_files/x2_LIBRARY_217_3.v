...
module FAU ( 
  ...
  nand3  g05(.a(new_n18_), .b(new_n21_), .c(new_n20_), .O(new_n23_));
  oai21  g06(.a(new_n18_), .b(new_n20_), .c(new_n23_), .O(z2));
  inv1   g07(.a(x0), .O(new_n25_));
  inv1   g08(.a(x1), .O(new_n26_));
  nor3   g09(.a(x9), .b(x7), .c(x2), .O(new_n27_));
  nand4  g10(.a(new_n27_), .b(new_n23_), .c(new_n26_), .d(new_n25_), .O(z3));
  oai21  g11(.a(new_n18_), .b(x8), .c(new_n20_), .O(new_n29_));
  nand3  g12(.a(new_n29_), .b(new_n18_), .c(x6), .O(z4));
  nand2  g13(.a(x8), .b(x5), .O(new_n31_));
  ...
  nand3  g19(.a(x2), .b(new_n26_), .c(new_n25_), .O(new_n37_));
  nand2  g20(.a(new_n18_), .b(new_n20_), .O(new_n38_));
  nand2  g21(.a(new_n38_), .b(new_n37_), .O(new_n39_));
  nand2  g22(.a(new_n39_), .b(new_n21_), .O(new_n40_));
  nand4  g23(.a(new_n40_), .b(new_n36_), .c(new_n33_), .d(x6), .O(z5));
  ...
  nand4  g28(.a(new_n45_), .b(new_n44_), .c(new_n23_), .d(x6), .O(z6));
endmodule
