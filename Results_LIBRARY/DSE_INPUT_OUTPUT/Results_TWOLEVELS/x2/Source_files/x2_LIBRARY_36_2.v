...
module FAU ( 
  ...
  wire new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_, new_n24_,
    new_n26_, new_n27_, new_n30_, new_n31_, new_n32_, new_n33_, new_n36_,
  ...
  oai21  g27(.a(new_n44_), .b(new_n26_), .c(new_n21_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n42_), .c(new_n40_), .O(z5));
  nor3   g29(.a(x2), .b(x1), .c(x0), .O(new_n47_));
  oai21  g30(.a(new_n47_), .b(new_n30_), .c(x7), .O(new_n48_));
