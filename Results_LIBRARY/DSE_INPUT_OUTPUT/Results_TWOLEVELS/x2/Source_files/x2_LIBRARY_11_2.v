...
module FAU ( 
  ...
  nand4  g15(.a(new_n22_), .b(new_n21_), .c(new_n19_), .d(new_n18_), .O(new_n33_));
  ...
  oai21  g30(.a(x9), .b(new_n18_), .c(new_n47_), .O(new_n48_));
  aoi21  g31(.a(x9), .b(new_n21_), .c(x4), .O(new_n49_));
  oai21  g32(.a(new_n49_), .b(x9), .c(new_n19_), .O(new_n50_));
  ...
  nand3  g36(.a(x8), .b(new_n19_), .c(x5), .O(new_n54_));
