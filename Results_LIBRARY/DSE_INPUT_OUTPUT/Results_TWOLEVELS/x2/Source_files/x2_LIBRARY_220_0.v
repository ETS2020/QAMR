...
module FAU ( 
  ...
  aoi21  g27(.a(x9), .b(new_n18_), .c(new_n26_), .O(new_n45_));
  ...
  nor2   g35(.a(new_n31_), .b(x7), .O(new_n53_));
  oai21  g36(.a(new_n53_), .b(new_n20_), .c(x5), .O(new_n54_));
  ...
  nand4  g41(.a(new_n58_), .b(new_n54_), .c(new_n52_), .d(new_n44_), .O(z5));
  ...
  nand3  g47(.a(new_n37_), .b(new_n49_), .c(new_n48_), .O(new_n65_));
  nand2  g48(.a(new_n65_), .b(x8), .O(new_n66_));
  nand3  g49(.a(new_n66_), .b(x9), .c(x7), .O(new_n67_));
  nand3  g50(.a(new_n67_), .b(new_n64_), .c(new_n44_), .O(z6));
endmodule
