...
module FAU ( 
  ...
  oai21  g19(.a(new_n19_), .b(new_n36_), .c(x9), .O(new_n37_));
  nand2  g20(.a(new_n37_), .b(new_n22_), .O(new_n38_));
  nor2   g21(.a(x8), .b(new_n22_), .O(new_n39_));
  inv1   g22(.a(x3), .O(new_n40_));
  nor2   g23(.a(x4), .b(new_n40_), .O(new_n41_));
  oai21  g24(.a(new_n41_), .b(new_n39_), .c(new_n18_), .O(new_n42_));
  nand4  g25(.a(new_n42_), .b(new_n38_), .c(new_n35_), .d(new_n34_), .O(z5));
  nand3  g26(.a(x9), .b(new_n22_), .c(x5), .O(new_n44_));
  nand4  g27(.a(new_n18_), .b(x7), .c(x4), .d(x3), .O(new_n45_));
  nand2  g28(.a(new_n45_), .b(new_n44_), .O(new_n46_));
  nand2  g29(.a(new_n46_), .b(x8), .O(new_n47_));
  inv1   g30(.a(x2), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n31_), .c(new_n30_), .O(new_n49_));
  nand2  g32(.a(new_n49_), .b(x8), .O(new_n50_));
  nand3  g33(.a(new_n50_), .b(x9), .c(x7), .O(new_n51_));
  nand3  g34(.a(new_n51_), .b(new_n47_), .c(new_n35_), .O(z6));
endmodule
