...
module FAU ( 
  ...
  nand4  g26(.a(new_n43_), .b(x2), .c(new_n31_), .d(new_n30_), .O(new_n44_));
  ...
  nand4  g32(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(x6), .O(z5));
  oai21  g33(.a(new_n26_), .b(x7), .c(x6), .O(new_n51_));
