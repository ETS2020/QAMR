...
module FAU ( 
  ...
  aoi21  g08(.a(x8), .b(new_n20_), .c(x9), .O(z2));
  ...
  nand4  g19(.a(x9), .b(new_n27_), .c(x7), .d(x6), .O(z4));
  ...
  oai21  g24(.a(x9), .b(new_n20_), .c(new_n41_), .O(new_n42_));
  nand3  g25(.a(x9), .b(x8), .c(x5), .O(new_n43_));
  inv1   g26(.a(new_n43_), .O(new_n44_));
  oai21  g27(.a(new_n44_), .b(new_n23_), .c(new_n20_), .O(new_n45_));
  nand3  g28(.a(new_n45_), .b(new_n42_), .c(new_n40_), .O(z5));
  nand3  g29(.a(new_n34_), .b(x9), .c(x8), .O(new_n47_));
  nand2  g30(.a(new_n47_), .b(x7), .O(new_n48_));
  nand3  g31(.a(new_n48_), .b(new_n45_), .c(new_n42_), .O(z6));
endmodule
