...
module FAU ( 
  ...
  nand3  g14(.a(new_n19_), .b(x7), .c(x6), .O(z4));
  ...
  nand2  g24(.a(x9), .b(new_n41_), .O(new_n42_));
  nand4  g25(.a(new_n42_), .b(new_n40_), .c(new_n37_), .d(new_n24_), .O(z5));
  ...
  aoi21  g33(.a(new_n50_), .b(new_n28_), .c(new_n41_), .O(new_n51_));
