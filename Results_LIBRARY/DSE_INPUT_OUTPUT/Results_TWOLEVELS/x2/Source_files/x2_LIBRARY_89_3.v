...
module FAU ( 
  ...
  nand3  g30(.a(new_n47_), .b(new_n46_), .c(new_n31_), .O(z4));
  ...
  nor2   g34(.a(new_n19_), .b(new_n21_), .O(new_n52_));
  nand3  g35(.a(new_n52_), .b(new_n18_), .c(x5), .O(new_n53_));
  nor2   g36(.a(x9), .b(new_n18_), .O(new_n54_));
  aoi21  g37(.a(new_n54_), .b(x3), .c(new_n45_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(new_n53_), .c(new_n51_), .O(new_n56_));
  nand2  g39(.a(new_n56_), .b(new_n24_), .O(new_n57_));
  oai21  g40(.a(new_n21_), .b(new_n45_), .c(new_n19_), .O(new_n58_));
  nand2  g41(.a(new_n58_), .b(new_n57_), .O(z5));
  nand3  g42(.a(new_n52_), .b(x5), .c(new_n24_), .O(new_n60_));
  nand2  g43(.a(new_n60_), .b(new_n28_), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(new_n18_), .O(new_n62_));
  nand3  g45(.a(new_n40_), .b(new_n39_), .c(new_n38_), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(x8), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(x9), .c(new_n24_), .O(new_n65_));
  nand3  g48(.a(new_n22_), .b(x4), .c(x3), .O(new_n66_));
  nand2  g49(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g50(.a(new_n67_), .b(x7), .O(new_n68_));
  nand3  g51(.a(new_n68_), .b(new_n62_), .c(new_n46_), .O(z6));
endmodule
