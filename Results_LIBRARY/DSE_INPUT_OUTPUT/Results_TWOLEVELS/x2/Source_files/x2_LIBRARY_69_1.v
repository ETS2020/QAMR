...
module FAU ( 
  ...
  aoi21  g01(.a(new_n18_), .b(x8), .c(x0), .O(new_n19_));
  inv1   g02(.a(x7), .O(new_n20_));
  inv1   g03(.a(x8), .O(new_n21_));
  nand3  g04(.a(new_n21_), .b(new_n20_), .c(x0), .O(new_n22_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n47_), .c(new_n31_), .O(z5));
  nand2  g35(.a(new_n21_), .b(x7), .O(new_n53_));
  nand3  g36(.a(x8), .b(new_n20_), .c(x5), .O(new_n54_));
  nand2  g37(.a(new_n54_), .b(new_n53_), .O(new_n55_));
  nand3  g38(.a(new_n55_), .b(x9), .c(x0), .O(new_n56_));
  ...
  nand3  g42(.a(new_n59_), .b(new_n56_), .c(new_n42_), .O(z6));
endmodule
