...
module FAU ( 
  ...
  oai21  g09(.a(new_n26_), .b(x7), .c(new_n18_), .O(new_n27_));
  ...
  aoi21  g17(.a(new_n26_), .b(new_n20_), .c(new_n34_), .O(new_n35_));
  oai22  g18(.a(new_n35_), .b(x9), .c(new_n21_), .d(x7), .O(z4));
  nand2  g19(.a(new_n23_), .b(new_n34_), .O(new_n37_));
  nand4  g20(.a(new_n26_), .b(x2), .c(new_n29_), .d(new_n28_), .O(new_n38_));
  ...
  inv1   g32(.a(new_n39_), .O(new_n50_));
  oai21  g33(.a(new_n50_), .b(new_n21_), .c(new_n20_), .O(new_n51_));
