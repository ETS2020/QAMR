...
module FAU ( 
  ...
  oai22  g14(.a(new_n26_), .b(x7), .c(new_n25_), .d(x4), .O(z2));
  ...
  nand3  g24(.a(new_n41_), .b(new_n35_), .c(new_n29_), .O(z3));
  oai21  g25(.a(new_n28_), .b(new_n33_), .c(x9), .O(new_n43_));
  nand2  g26(.a(new_n25_), .b(new_n18_), .O(new_n44_));
  nand3  g27(.a(new_n44_), .b(new_n43_), .c(x6), .O(z4));
  nand2  g28(.a(x9), .b(x8), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n18_), .c(new_n39_), .O(new_n47_));
  ...
  nand3  g34(.a(new_n51_), .b(new_n26_), .c(x6), .O(new_n52_));
  aoi21  g35(.a(new_n50_), .b(new_n33_), .c(new_n52_), .O(new_n53_));
  nand2  g36(.a(new_n53_), .b(new_n48_), .O(z5));
  nand2  g37(.a(x9), .b(new_n19_), .O(new_n55_));
  nand3  g38(.a(new_n25_), .b(x8), .c(x3), .O(new_n56_));
  aoi21  g39(.a(new_n56_), .b(new_n55_), .c(new_n33_), .O(new_n57_));
  nand4  g40(.a(x9), .b(new_n38_), .c(new_n37_), .d(new_n36_), .O(new_n58_));
  inv1   g41(.a(new_n58_), .O(new_n59_));
  oai21  g42(.a(new_n59_), .b(new_n57_), .c(x7), .O(new_n60_));
  inv1   g43(.a(x5), .O(new_n61_));
  oai21  g44(.a(new_n46_), .b(new_n61_), .c(new_n26_), .O(new_n62_));
  oai21  g45(.a(new_n25_), .b(x4), .c(x6), .O(new_n63_));
