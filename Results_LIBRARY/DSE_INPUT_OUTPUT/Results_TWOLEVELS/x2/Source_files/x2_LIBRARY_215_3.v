...
module FAU ( 
  ...
  nand2  g16(.a(x7), .b(x1), .O(new_n34_));
  oai21  g17(.a(new_n28_), .b(x7), .c(new_n34_), .O(z2));
  nand2  g18(.a(x7), .b(x1), .O(new_n36_));
  ...
  oai21  g24(.a(new_n31_), .b(new_n41_), .c(new_n30_), .O(new_n42_));
  nor2   g25(.a(new_n22_), .b(x1), .O(new_n43_));
  ...
  nand2  g37(.a(new_n31_), .b(x5), .O(new_n55_));
  nand2  g38(.a(new_n55_), .b(new_n28_), .O(new_n56_));
  oai21  g39(.a(new_n56_), .b(new_n41_), .c(new_n22_), .O(new_n57_));
  nand2  g40(.a(new_n57_), .b(new_n54_), .O(z5));
  nand2  g41(.a(new_n34_), .b(new_n41_), .O(new_n59_));
  nand2  g42(.a(new_n56_), .b(new_n22_), .O(new_n60_));
  oai21  g43(.a(x2), .b(x0), .c(x8), .O(new_n61_));
  nand2  g44(.a(new_n61_), .b(x9), .O(new_n62_));
  nand4  g45(.a(new_n18_), .b(x8), .c(x4), .d(x3), .O(new_n63_));
  nand2  g46(.a(new_n63_), .b(new_n62_), .O(new_n64_));
  nand3  g47(.a(new_n64_), .b(x7), .c(new_n30_), .O(new_n65_));
  nand3  g48(.a(new_n65_), .b(new_n60_), .c(new_n59_), .O(z6));
endmodule
