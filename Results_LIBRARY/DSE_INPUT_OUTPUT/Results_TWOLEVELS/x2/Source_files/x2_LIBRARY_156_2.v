...
module FAU ( 
  ...
  aoi21  g08(.a(x8), .b(new_n19_), .c(x9), .O(z2));
  oai21  g09(.a(new_n22_), .b(new_n18_), .c(x7), .O(new_n27_));
  oai21  g10(.a(x8), .b(new_n19_), .c(x9), .O(new_n28_));
  nor2   g11(.a(x1), .b(x0), .O(new_n29_));
  aoi21  g12(.a(new_n22_), .b(new_n18_), .c(x2), .O(new_n30_));
  ...
  nor2   g22(.a(new_n22_), .b(new_n18_), .O(new_n40_));
  inv1   g23(.a(x5), .O(new_n41_));
  nor2   g24(.a(x7), .b(new_n41_), .O(new_n42_));
  aoi21  g25(.a(new_n42_), .b(new_n40_), .c(new_n32_), .O(new_n43_));
  nand3  g26(.a(new_n43_), .b(new_n39_), .c(new_n35_), .O(z5));
  nand2  g27(.a(new_n24_), .b(new_n18_), .O(new_n45_));
  nor3   g28(.a(x2), .b(x1), .c(x0), .O(new_n46_));
  oai21  g29(.a(new_n46_), .b(new_n22_), .c(x7), .O(new_n47_));
  nand3  g30(.a(new_n47_), .b(new_n45_), .c(new_n43_), .O(z6));
endmodule
