...
module FAU ( 
  ...
  nor2   g16(.a(z21), .b(x07), .O(z06));
  inv1   g17(.a(new_n79_), .O(z07));
  buf    g18(.a(x33), .O(z08));
  buf    g19(.a(x33), .O(z09));
  nor2   g20(.a(z21), .b(x07), .O(z10));
  nor2   g21(.a(z21), .b(x07), .O(z11));
  nor2   g22(.a(z21), .b(x07), .O(z12));
  inv1   g23(.a(new_n79_), .O(z13));
  inv1   g24(.a(new_n79_), .O(z14));
  buf    g25(.a(x33), .O(z15));
