// Benchmark "FAU" written by ABC on Sat Aug 22 03:35:53 2020
...
module FAU ( 
  ...
  nand2  g449(.a(new_n225_), .b(x56), .O(new_n541_));
  oai21  g450(.a(new_n467_), .b(new_n376_), .c(x72), .O(new_n542_));
  nand2  g451(.a(x74), .b(x53), .O(new_n543_));
  nand2  g452(.a(new_n223_), .b(x54), .O(new_n544_));
  aoi21  g453(.a(new_n544_), .b(new_n543_), .c(new_n222_), .O(new_n545_));
  nand3  g454(.a(x74), .b(new_n222_), .c(x55), .O(new_n546_));
  inv1   g455(.a(new_n546_), .O(new_n547_));
  oai21  g456(.a(new_n547_), .b(new_n545_), .c(new_n220_), .O(new_n548_));
  ...
  nand3  g462(.a(new_n553_), .b(new_n168_), .c(x68), .O(new_n554_));
  nand2  g463(.a(new_n123_), .b(x24), .O(new_n555_));
  oai21  g464(.a(new_n123_), .b(new_n204_), .c(new_n555_), .O(new_n556_));
  nand2  g465(.a(new_n556_), .b(x70), .O(new_n557_));
  oai21  g466(.a(new_n108_), .b(new_n180_), .c(new_n557_), .O(new_n558_));
  ...
  aoi21  g478(.a(new_n303_), .b(new_n302_), .c(new_n136_), .O(new_n570_));
  nand3  g479(.a(new_n297_), .b(new_n172_), .c(x00), .O(new_n571_));
  oai21  g480(.a(new_n570_), .b(new_n172_), .c(new_n571_), .O(new_n572_));
  nand3  g481(.a(new_n572_), .b(x71), .c(new_n107_), .O(new_n573_));
  aoi21  g482(.a(new_n317_), .b(new_n316_), .c(new_n129_), .O(new_n574_));
  nand3  g483(.a(new_n312_), .b(new_n196_), .c(x32), .O(new_n575_));
  oai21  g484(.a(new_n574_), .b(new_n196_), .c(new_n575_), .O(new_n576_));
  ...
  nand2  g488(.a(new_n225_), .b(x57), .O(new_n580_));
  inv1   g489(.a(new_n329_), .O(new_n581_));
  oai21  g490(.a(new_n428_), .b(new_n581_), .c(x72), .O(new_n582_));
  nand2  g491(.a(x74), .b(x54), .O(new_n583_));
  nand2  g492(.a(new_n223_), .b(x55), .O(new_n584_));
  aoi21  g493(.a(new_n584_), .b(new_n583_), .c(new_n222_), .O(new_n585_));
  nand3  g494(.a(x74), .b(new_n222_), .c(x56), .O(new_n586_));
  inv1   g495(.a(new_n586_), .O(new_n587_));
  oai21  g496(.a(new_n587_), .b(new_n585_), .c(new_n220_), .O(new_n588_));
  nand3  g497(.a(new_n588_), .b(new_n582_), .c(new_n580_), .O(new_n589_));
  nand3  g498(.a(new_n589_), .b(new_n149_), .c(new_n148_), .O(new_n590_));
  oai21  g499(.a(new_n131_), .b(new_n196_), .c(new_n590_), .O(new_n591_));
  ...
  nor3   g512(.a(new_n577_), .b(x67), .c(x66), .O(new_n604_));
  ...
  aoi21  g516(.a(new_n303_), .b(new_n106_), .c(new_n136_), .O(new_n608_));
  nand2  g517(.a(new_n303_), .b(new_n106_), .O(new_n609_));
  nand3  g518(.a(new_n609_), .b(new_n296_), .c(x00), .O(new_n610_));
  oai21  g519(.a(new_n608_), .b(new_n296_), .c(new_n610_), .O(new_n611_));
  nand3  g520(.a(new_n611_), .b(x71), .c(new_n107_), .O(new_n612_));
  nand2  g521(.a(new_n317_), .b(new_n122_), .O(new_n613_));
  nand2  g522(.a(new_n613_), .b(x32), .O(new_n614_));
  nand2  g523(.a(new_n614_), .b(x42), .O(new_n615_));
  nand3  g524(.a(new_n613_), .b(new_n311_), .c(x32), .O(new_n616_));
  nand2  g525(.a(new_n616_), .b(new_n615_), .O(new_n617_));
  nand3  g526(.a(new_n617_), .b(new_n123_), .c(x70), .O(new_n618_));
  nand2  g527(.a(new_n618_), .b(new_n612_), .O(new_n619_));
  nand3  g528(.a(new_n619_), .b(new_n96_), .c(new_n94_), .O(new_n620_));
  nand2  g529(.a(new_n135_), .b(x42), .O(new_n621_));
  nand2  g530(.a(new_n225_), .b(x58), .O(new_n622_));
  aoi21  g531(.a(new_n544_), .b(new_n543_), .c(x73), .O(new_n623_));
  nand3  g532(.a(new_n223_), .b(x73), .c(x50), .O(new_n624_));
  inv1   g533(.a(new_n624_), .O(new_n625_));
  oai21  g534(.a(new_n625_), .b(new_n623_), .c(x72), .O(new_n626_));
  nand2  g535(.a(x74), .b(x55), .O(new_n627_));
  nand2  g536(.a(new_n223_), .b(x56), .O(new_n628_));
  aoi21  g537(.a(new_n628_), .b(new_n627_), .c(new_n222_), .O(new_n629_));
  nand3  g538(.a(x74), .b(new_n222_), .c(x57), .O(new_n630_));
  inv1   g539(.a(new_n630_), .O(new_n631_));
  oai21  g540(.a(new_n631_), .b(new_n629_), .c(new_n220_), .O(new_n632_));
  nand3  g541(.a(new_n632_), .b(new_n626_), .c(new_n622_), .O(new_n633_));
  nand3  g542(.a(new_n633_), .b(new_n149_), .c(new_n148_), .O(new_n634_));
  nand2  g543(.a(new_n634_), .b(new_n621_), .O(new_n635_));
  nand4  g544(.a(new_n635_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n636_));
  nand2  g545(.a(new_n636_), .b(new_n620_), .O(new_n637_));
  nand3  g546(.a(new_n637_), .b(new_n168_), .c(x68), .O(new_n638_));
  nand2  g547(.a(new_n123_), .b(x26), .O(new_n639_));
  oai21  g548(.a(new_n123_), .b(new_n311_), .c(new_n639_), .O(new_n640_));
  nand2  g549(.a(new_n640_), .b(x70), .O(new_n641_));
  oai21  g550(.a(new_n108_), .b(new_n296_), .c(new_n641_), .O(new_n642_));
  ...
  nand4  g554(.a(new_n611_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n646_));
  nand3  g555(.a(new_n633_), .b(new_n96_), .c(new_n123_), .O(new_n647_));
  ...
  nand4  g559(.a(new_n650_), .b(x70), .c(new_n149_), .d(new_n148_), .O(new_n651_));
  aoi21  g560(.a(new_n651_), .b(new_n649_), .c(x69), .O(new_n652_));
  nand4  g561(.a(new_n652_), .b(x68), .c(x65), .d(new_n94_), .O(new_n653_));
  nand3  g562(.a(new_n653_), .b(new_n645_), .c(new_n249_), .O(z10));
  oai21  g563(.a(new_n189_), .b(new_n136_), .c(x11), .O(new_n655_));
  nand3  g564(.a(new_n188_), .b(new_n145_), .c(x00), .O(new_n656_));
  nand2  g565(.a(new_n656_), .b(new_n655_), .O(new_n657_));
  nand3  g566(.a(new_n657_), .b(x71), .c(new_n107_), .O(new_n658_));
  oai21  g567(.a(new_n213_), .b(new_n129_), .c(x43), .O(new_n659_));
  inv1   g568(.a(x43), .O(new_n660_));
  nand3  g569(.a(new_n212_), .b(new_n660_), .c(x32), .O(new_n661_));
  ...
  nand2  g575(.a(new_n225_), .b(x59), .O(new_n667_));
  aoi21  g576(.a(new_n584_), .b(new_n583_), .c(x73), .O(new_n668_));
  nand3  g577(.a(new_n223_), .b(x73), .c(x51), .O(new_n669_));
  inv1   g578(.a(new_n669_), .O(new_n670_));
  oai21  g579(.a(new_n670_), .b(new_n668_), .c(x72), .O(new_n671_));
  nand2  g580(.a(x74), .b(x56), .O(new_n672_));
  nand2  g581(.a(new_n223_), .b(x57), .O(new_n673_));
  aoi21  g582(.a(new_n673_), .b(new_n672_), .c(new_n222_), .O(new_n674_));
  nand3  g583(.a(x74), .b(new_n222_), .c(x58), .O(new_n675_));
  inv1   g584(.a(new_n675_), .O(new_n676_));
  oai21  g585(.a(new_n676_), .b(new_n674_), .c(new_n220_), .O(new_n677_));
  ...
  nand3  g591(.a(new_n682_), .b(new_n168_), .c(x68), .O(new_n683_));
  nand2  g592(.a(new_n123_), .b(x27), .O(new_n684_));
  oai21  g593(.a(new_n123_), .b(new_n660_), .c(new_n684_), .O(new_n685_));
  ...
  nand4  g599(.a(new_n657_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n691_));
  ...
  nor2   g609(.a(new_n303_), .b(x12), .O(new_n701_));
  nand2  g610(.a(new_n701_), .b(x00), .O(new_n702_));
  aoi21  g611(.a(new_n702_), .b(new_n700_), .c(new_n123_), .O(new_n703_));
  nand2  g612(.a(new_n703_), .b(new_n107_), .O(new_n704_));
  oai21  g613(.a(new_n317_), .b(new_n129_), .c(x44), .O(new_n705_));
  nor2   g614(.a(new_n317_), .b(x44), .O(new_n706_));
  ...
  aoi21  g621(.a(new_n628_), .b(new_n627_), .c(x73), .O(new_n713_));
  ...
  oai21  g655(.a(x47), .b(x46), .c(new_n209_), .O(new_n747_));
  oai21  g656(.a(new_n198_), .b(new_n129_), .c(x45), .O(new_n748_));
  oai21  g657(.a(new_n747_), .b(new_n129_), .c(new_n748_), .O(new_n749_));
  ...
  nand2  g661(.a(new_n225_), .b(x61), .O(new_n753_));
  aoi21  g662(.a(new_n673_), .b(new_n672_), .c(x73), .O(new_n754_));
  nand3  g663(.a(new_n223_), .b(x73), .c(x53), .O(new_n755_));
  inv1   g664(.a(new_n755_), .O(new_n756_));
  oai21  g665(.a(new_n756_), .b(new_n754_), .c(x72), .O(new_n757_));
  nand2  g666(.a(x74), .b(x58), .O(new_n758_));
  nand2  g667(.a(new_n223_), .b(x59), .O(new_n759_));
  aoi21  g668(.a(new_n759_), .b(new_n758_), .c(new_n222_), .O(new_n760_));
  nand3  g669(.a(x74), .b(new_n222_), .c(x60), .O(new_n761_));
  inv1   g670(.a(new_n761_), .O(new_n762_));
  oai21  g671(.a(new_n762_), .b(new_n760_), .c(new_n220_), .O(new_n763_));
  nand3  g672(.a(new_n763_), .b(new_n757_), .c(new_n753_), .O(new_n764_));
  nand3  g673(.a(new_n764_), .b(new_n149_), .c(new_n148_), .O(new_n765_));
  oai21  g674(.a(new_n131_), .b(new_n209_), .c(new_n765_), .O(new_n766_));
  ...
  oai21  g678(.a(new_n123_), .b(new_n209_), .c(new_n769_), .O(new_n770_));
  nand2  g679(.a(new_n770_), .b(x70), .O(new_n771_));
  oai21  g680(.a(new_n108_), .b(new_n185_), .c(new_n771_), .O(new_n772_));
  ...
  nand3  g684(.a(new_n745_), .b(new_n149_), .c(new_n148_), .O(new_n776_));
  ...
  oai21  g691(.a(new_n187_), .b(new_n136_), .c(x14), .O(new_n783_));
  nand3  g692(.a(x15), .b(new_n186_), .c(x00), .O(new_n784_));
  aoi21  g693(.a(new_n784_), .b(new_n783_), .c(new_n123_), .O(new_n785_));
  nand2  g694(.a(new_n785_), .b(new_n107_), .O(new_n786_));
  oai21  g695(.a(new_n211_), .b(new_n129_), .c(x46), .O(new_n787_));
  nand3  g696(.a(x47), .b(new_n210_), .c(x32), .O(new_n788_));
  nand2  g697(.a(new_n788_), .b(new_n787_), .O(new_n789_));
  nand3  g698(.a(new_n789_), .b(new_n123_), .c(x70), .O(new_n790_));
  nand2  g699(.a(new_n790_), .b(new_n786_), .O(new_n791_));
  nand3  g700(.a(new_n791_), .b(new_n96_), .c(new_n94_), .O(new_n792_));
  nand2  g701(.a(new_n135_), .b(x46), .O(new_n793_));
  ...
  nand2  g715(.a(new_n806_), .b(new_n793_), .O(new_n807_));
  nand4  g716(.a(new_n807_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n808_));
  nand2  g717(.a(new_n808_), .b(new_n792_), .O(new_n809_));
  nand3  g718(.a(new_n809_), .b(new_n168_), .c(x68), .O(new_n810_));
  nand2  g719(.a(new_n123_), .b(x30), .O(new_n811_));
  oai21  g720(.a(new_n123_), .b(new_n210_), .c(new_n811_), .O(new_n812_));
  nand2  g721(.a(new_n812_), .b(x70), .O(new_n813_));
  oai21  g722(.a(new_n108_), .b(new_n186_), .c(new_n813_), .O(new_n814_));
  nand4  g723(.a(new_n814_), .b(new_n135_), .c(new_n93_), .d(x64), .O(new_n815_));
  nand2  g724(.a(new_n815_), .b(new_n810_), .O(new_n816_));
  nand2  g725(.a(new_n816_), .b(new_n92_), .O(new_n817_));
  nand3  g726(.a(new_n785_), .b(new_n149_), .c(new_n148_), .O(new_n818_));
  nand3  g727(.a(new_n805_), .b(new_n96_), .c(new_n123_), .O(new_n819_));
  nand2  g728(.a(new_n819_), .b(new_n818_), .O(new_n820_));
  nand2  g729(.a(new_n820_), .b(new_n107_), .O(new_n821_));
  inv1   g730(.a(new_n790_), .O(new_n822_));
  nand3  g731(.a(new_n822_), .b(new_n149_), .c(new_n148_), .O(new_n823_));
  aoi21  g732(.a(new_n823_), .b(new_n821_), .c(x69), .O(new_n824_));
  nand4  g733(.a(new_n824_), .b(x68), .c(x65), .d(new_n94_), .O(new_n825_));
  nand3  g734(.a(new_n825_), .b(new_n817_), .c(new_n249_), .O(z14));
  nand3  g735(.a(x71), .b(x70), .c(new_n93_), .O(new_n827_));
  nand4  g736(.a(new_n123_), .b(new_n107_), .c(new_n168_), .d(x68), .O(new_n828_));
  aoi21  g737(.a(new_n828_), .b(new_n827_), .c(new_n211_), .O(new_n829_));
  nand3  g738(.a(x71), .b(new_n107_), .c(x15), .O(new_n830_));
  inv1   g739(.a(new_n124_), .O(new_n831_));
  nand2  g740(.a(new_n831_), .b(x31), .O(new_n832_));
  aoi21  g741(.a(new_n832_), .b(new_n830_), .c(x68), .O(new_n833_));
  oai21  g742(.a(new_n833_), .b(new_n829_), .c(new_n135_), .O(new_n834_));
  nand2  g743(.a(new_n225_), .b(x63), .O(new_n835_));
  aoi21  g744(.a(new_n759_), .b(new_n758_), .c(x73), .O(new_n836_));
  nand3  g745(.a(new_n223_), .b(x73), .c(x55), .O(new_n837_));
  inv1   g746(.a(new_n837_), .O(new_n838_));
  oai21  g747(.a(new_n838_), .b(new_n836_), .c(x72), .O(new_n839_));
  nand2  g748(.a(x74), .b(x60), .O(new_n840_));
  nand2  g749(.a(new_n223_), .b(x61), .O(new_n841_));
  aoi21  g750(.a(new_n841_), .b(new_n840_), .c(new_n222_), .O(new_n842_));
  nand2  g751(.a(new_n274_), .b(x62), .O(new_n843_));
  inv1   g752(.a(new_n843_), .O(new_n844_));
  oai21  g753(.a(new_n844_), .b(new_n842_), .c(new_n220_), .O(new_n845_));
  nand3  g754(.a(new_n845_), .b(new_n839_), .c(new_n835_), .O(new_n846_));
  nand4  g755(.a(new_n846_), .b(new_n123_), .c(new_n107_), .d(new_n168_), .O(new_n847_));
  inv1   g756(.a(new_n847_), .O(new_n848_));
  nand4  g757(.a(new_n848_), .b(x68), .c(new_n149_), .d(new_n148_), .O(new_n849_));
  aoi21  g758(.a(new_n849_), .b(new_n834_), .c(new_n94_), .O(new_n850_));
  oai21  g759(.a(new_n124_), .b(new_n211_), .c(new_n830_), .O(new_n851_));
  nand4  g760(.a(new_n851_), .b(new_n96_), .c(new_n168_), .d(x68), .O(new_n852_));
  nor2   g761(.a(new_n852_), .b(x64), .O(new_n853_));
  ...
  nand4  g767(.a(new_n831_), .b(new_n149_), .c(new_n148_), .d(x47), .O(new_n859_));
  aoi21  g768(.a(new_n859_), .b(new_n858_), .c(x69), .O(new_n860_));
  nand4  g769(.a(new_n860_), .b(x68), .c(x65), .d(new_n94_), .O(new_n861_));
  nand3  g770(.a(new_n861_), .b(new_n854_), .c(new_n249_), .O(z15));
endmodule
