// Benchmark "FAU" written by ABC on Sat Aug 22 03:30:00 2020
...
module FAU ( 
  ...
  nand2  g372(.a(new_n225_), .b(x54), .O(new_n464_));
  aoi21  g373(.a(new_n372_), .b(new_n371_), .c(x73), .O(new_n465_));
  nand3  g374(.a(new_n223_), .b(x73), .c(x48), .O(new_n466_));
  inv1   g375(.a(new_n466_), .O(new_n467_));
  oai21  g376(.a(new_n467_), .b(new_n465_), .c(x72), .O(new_n468_));
  aoi21  g377(.a(new_n375_), .b(new_n374_), .c(new_n222_), .O(new_n469_));
  nand3  g378(.a(x74), .b(new_n222_), .c(x53), .O(new_n470_));
  inv1   g379(.a(new_n470_), .O(new_n471_));
  oai21  g380(.a(new_n471_), .b(new_n469_), .c(new_n220_), .O(new_n472_));
  nand3  g381(.a(new_n472_), .b(new_n468_), .c(new_n464_), .O(new_n473_));
  nand3  g382(.a(new_n473_), .b(new_n149_), .c(new_n148_), .O(new_n474_));
  oai21  g383(.a(new_n131_), .b(new_n117_), .c(new_n474_), .O(new_n475_));
  nand4  g384(.a(new_n475_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n476_));
  aoi21  g385(.a(new_n476_), .b(new_n463_), .c(new_n93_), .O(new_n477_));
  ...
  nand4  g394(.a(new_n455_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n486_));
  aoi21  g395(.a(new_n486_), .b(new_n485_), .c(x70), .O(new_n487_));
  nor3   g396(.a(new_n461_), .b(x67), .c(x66), .O(new_n488_));
  ...
  oai21  g400(.a(new_n452_), .b(x06), .c(new_n179_), .O(new_n492_));
  ...
  oai21  g404(.a(new_n457_), .b(x38), .c(new_n203_), .O(new_n496_));
  ...
  nand2  g410(.a(new_n225_), .b(x55), .O(new_n502_));
  aoi21  g411(.a(new_n424_), .b(new_n423_), .c(x73), .O(new_n503_));
  oai21  g412(.a(new_n503_), .b(new_n467_), .c(x72), .O(new_n504_));
  aoi21  g413(.a(new_n427_), .b(new_n426_), .c(new_n222_), .O(new_n505_));
  nand3  g414(.a(x74), .b(new_n222_), .c(x54), .O(new_n506_));
  inv1   g415(.a(new_n506_), .O(new_n507_));
  oai21  g416(.a(new_n507_), .b(new_n505_), .c(new_n220_), .O(new_n508_));
  nand3  g417(.a(new_n508_), .b(new_n504_), .c(new_n502_), .O(new_n509_));
  nand3  g418(.a(new_n509_), .b(new_n149_), .c(new_n148_), .O(new_n510_));
  oai21  g419(.a(new_n131_), .b(new_n203_), .c(new_n510_), .O(new_n511_));
  nand4  g420(.a(new_n511_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n512_));
  aoi21  g421(.a(new_n512_), .b(new_n501_), .c(new_n93_), .O(new_n513_));
  nand2  g422(.a(new_n123_), .b(x23), .O(new_n514_));
  oai21  g423(.a(new_n123_), .b(new_n203_), .c(new_n514_), .O(new_n515_));
  nand2  g424(.a(new_n515_), .b(x70), .O(new_n516_));
  oai21  g425(.a(new_n108_), .b(new_n179_), .c(new_n516_), .O(new_n517_));
  nand4  g426(.a(new_n517_), .b(new_n135_), .c(new_n93_), .d(x64), .O(new_n518_));
  inv1   g427(.a(new_n518_), .O(new_n519_));
  oai21  g428(.a(new_n519_), .b(new_n513_), .c(new_n92_), .O(new_n520_));
  nand3  g429(.a(new_n509_), .b(new_n96_), .c(new_n123_), .O(new_n521_));
  nand4  g430(.a(new_n494_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n522_));
  aoi21  g431(.a(new_n522_), .b(new_n521_), .c(x70), .O(new_n523_));
  nor3   g432(.a(new_n499_), .b(x67), .c(x66), .O(new_n524_));
  or2    g433(.a(new_n524_), .b(new_n523_), .O(new_n525_));
  nand4  g434(.a(new_n525_), .b(x68), .c(x65), .d(new_n94_), .O(new_n526_));
  aoi21  g435(.a(new_n526_), .b(new_n520_), .c(x69), .O(z07));
  nand2  g436(.a(new_n174_), .b(x00), .O(new_n528_));
  nand2  g437(.a(new_n528_), .b(x08), .O(new_n529_));
  nand3  g438(.a(new_n174_), .b(new_n180_), .c(x00), .O(new_n530_));
  aoi21  g439(.a(new_n530_), .b(new_n529_), .c(new_n123_), .O(new_n531_));
  nand2  g440(.a(new_n531_), .b(new_n107_), .O(new_n532_));
  nand2  g441(.a(new_n199_), .b(x32), .O(new_n533_));
  nand2  g442(.a(new_n533_), .b(x40), .O(new_n534_));
  nand3  g443(.a(new_n199_), .b(new_n204_), .c(x32), .O(new_n535_));
  ...
  nand2  g448(.a(new_n225_), .b(x56), .O(new_n540_));
  oai21  g449(.a(new_n467_), .b(new_n376_), .c(x72), .O(new_n541_));
  nand2  g450(.a(x74), .b(x53), .O(new_n542_));
  nand2  g451(.a(new_n223_), .b(x54), .O(new_n543_));
  aoi21  g452(.a(new_n543_), .b(new_n542_), .c(new_n222_), .O(new_n544_));
  nand3  g453(.a(x74), .b(new_n222_), .c(x55), .O(new_n545_));
  inv1   g454(.a(new_n545_), .O(new_n546_));
  oai21  g455(.a(new_n546_), .b(new_n544_), .c(new_n220_), .O(new_n547_));
  nand3  g456(.a(new_n547_), .b(new_n541_), .c(new_n540_), .O(new_n548_));
  nand3  g457(.a(new_n548_), .b(new_n149_), .c(new_n148_), .O(new_n549_));
  oai21  g458(.a(new_n131_), .b(new_n204_), .c(new_n549_), .O(new_n550_));
  nand4  g459(.a(new_n550_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n551_));
  aoi21  g460(.a(new_n551_), .b(new_n539_), .c(new_n93_), .O(new_n552_));
  nand2  g461(.a(new_n123_), .b(x24), .O(new_n553_));
  oai21  g462(.a(new_n123_), .b(new_n204_), .c(new_n553_), .O(new_n554_));
  nand2  g463(.a(new_n554_), .b(x70), .O(new_n555_));
  oai21  g464(.a(new_n108_), .b(new_n180_), .c(new_n555_), .O(new_n556_));
  ...
  nand3  g468(.a(new_n531_), .b(new_n149_), .c(new_n148_), .O(new_n560_));
  nand3  g469(.a(new_n548_), .b(new_n96_), .c(new_n123_), .O(new_n561_));
  nand2  g470(.a(new_n561_), .b(new_n560_), .O(new_n562_));
  nand2  g471(.a(new_n562_), .b(new_n107_), .O(new_n563_));
  nand4  g472(.a(new_n536_), .b(x70), .c(new_n149_), .d(new_n148_), .O(new_n564_));
  ...
  aoi21  g476(.a(new_n303_), .b(new_n302_), .c(new_n136_), .O(new_n568_));
  nand3  g477(.a(new_n297_), .b(new_n172_), .c(x00), .O(new_n569_));
  oai21  g478(.a(new_n568_), .b(new_n172_), .c(new_n569_), .O(new_n570_));
  nand3  g479(.a(new_n570_), .b(x71), .c(new_n107_), .O(new_n571_));
  aoi21  g480(.a(new_n317_), .b(new_n316_), .c(new_n129_), .O(new_n572_));
  nand3  g481(.a(new_n312_), .b(new_n196_), .c(x32), .O(new_n573_));
  oai21  g482(.a(new_n572_), .b(new_n196_), .c(new_n573_), .O(new_n574_));
  ...
  nand2  g486(.a(new_n225_), .b(x57), .O(new_n578_));
  inv1   g487(.a(new_n329_), .O(new_n579_));
  oai21  g488(.a(new_n428_), .b(new_n579_), .c(x72), .O(new_n580_));
  nand2  g489(.a(x74), .b(x54), .O(new_n581_));
  nand2  g490(.a(new_n223_), .b(x55), .O(new_n582_));
  aoi21  g491(.a(new_n582_), .b(new_n581_), .c(new_n222_), .O(new_n583_));
  nand3  g492(.a(x74), .b(new_n222_), .c(x56), .O(new_n584_));
  inv1   g493(.a(new_n584_), .O(new_n585_));
  oai21  g494(.a(new_n585_), .b(new_n583_), .c(new_n220_), .O(new_n586_));
  nand3  g495(.a(new_n586_), .b(new_n580_), .c(new_n578_), .O(new_n587_));
  nand3  g496(.a(new_n587_), .b(new_n149_), .c(new_n148_), .O(new_n588_));
  oai21  g497(.a(new_n131_), .b(new_n196_), .c(new_n588_), .O(new_n589_));
  ...
  oai21  g501(.a(new_n123_), .b(new_n196_), .c(new_n592_), .O(new_n593_));
  nand2  g502(.a(new_n593_), .b(x70), .O(new_n594_));
  oai21  g503(.a(new_n108_), .b(new_n172_), .c(new_n594_), .O(new_n595_));
  ...
  aoi21  g509(.a(new_n600_), .b(new_n599_), .c(x70), .O(new_n601_));
  nor3   g510(.a(new_n575_), .b(x67), .c(x66), .O(new_n602_));
  or2    g511(.a(new_n602_), .b(new_n601_), .O(new_n603_));
  nand4  g512(.a(new_n603_), .b(x68), .c(x65), .d(new_n94_), .O(new_n604_));
  aoi21  g513(.a(new_n604_), .b(new_n598_), .c(x69), .O(z09));
  ...
  nand3  g522(.a(new_n611_), .b(new_n311_), .c(x32), .O(new_n614_));
  ...
  nand2  g528(.a(new_n225_), .b(x58), .O(new_n620_));
  aoi21  g529(.a(new_n543_), .b(new_n542_), .c(x73), .O(new_n621_));
  nand3  g530(.a(new_n223_), .b(x73), .c(x50), .O(new_n622_));
  inv1   g531(.a(new_n622_), .O(new_n623_));
  oai21  g532(.a(new_n623_), .b(new_n621_), .c(x72), .O(new_n624_));
  nand2  g533(.a(x74), .b(x55), .O(new_n625_));
  nand2  g534(.a(new_n223_), .b(x56), .O(new_n626_));
  aoi21  g535(.a(new_n626_), .b(new_n625_), .c(new_n222_), .O(new_n627_));
  nand3  g536(.a(x74), .b(new_n222_), .c(x57), .O(new_n628_));
  inv1   g537(.a(new_n628_), .O(new_n629_));
  oai21  g538(.a(new_n629_), .b(new_n627_), .c(new_n220_), .O(new_n630_));
  ...
  nand3  g544(.a(new_n635_), .b(new_n168_), .c(x68), .O(new_n636_));
  nand2  g545(.a(new_n123_), .b(x26), .O(new_n637_));
  oai21  g546(.a(new_n123_), .b(new_n311_), .c(new_n637_), .O(new_n638_));
  nand2  g547(.a(new_n638_), .b(x70), .O(new_n639_));
  oai21  g548(.a(new_n108_), .b(new_n296_), .c(new_n639_), .O(new_n640_));
  ...
  nand3  g560(.a(new_n651_), .b(new_n643_), .c(new_n249_), .O(z10));
  oai21  g561(.a(new_n189_), .b(new_n136_), .c(x11), .O(new_n653_));
  nand3  g562(.a(new_n188_), .b(new_n145_), .c(x00), .O(new_n654_));
  nand2  g563(.a(new_n654_), .b(new_n653_), .O(new_n655_));
  nand3  g564(.a(new_n655_), .b(x71), .c(new_n107_), .O(new_n656_));
  oai21  g565(.a(new_n213_), .b(new_n129_), .c(x43), .O(new_n657_));
  inv1   g566(.a(x43), .O(new_n658_));
  nand3  g567(.a(new_n212_), .b(new_n658_), .c(x32), .O(new_n659_));
  ...
  nand2  g572(.a(new_n135_), .b(x43), .O(new_n664_));
  nand2  g573(.a(new_n225_), .b(x59), .O(new_n665_));
  aoi21  g574(.a(new_n582_), .b(new_n581_), .c(x73), .O(new_n666_));
  nand3  g575(.a(new_n223_), .b(x73), .c(x51), .O(new_n667_));
  inv1   g576(.a(new_n667_), .O(new_n668_));
  oai21  g577(.a(new_n668_), .b(new_n666_), .c(x72), .O(new_n669_));
  nand2  g578(.a(x74), .b(x56), .O(new_n670_));
  nand2  g579(.a(new_n223_), .b(x57), .O(new_n671_));
  aoi21  g580(.a(new_n671_), .b(new_n670_), .c(new_n222_), .O(new_n672_));
  nand3  g581(.a(x74), .b(new_n222_), .c(x58), .O(new_n673_));
  inv1   g582(.a(new_n673_), .O(new_n674_));
  oai21  g583(.a(new_n674_), .b(new_n672_), .c(new_n220_), .O(new_n675_));
  nand3  g584(.a(new_n675_), .b(new_n669_), .c(new_n665_), .O(new_n676_));
  nand3  g585(.a(new_n676_), .b(new_n149_), .c(new_n148_), .O(new_n677_));
  nand2  g586(.a(new_n677_), .b(new_n664_), .O(new_n678_));
  nand4  g587(.a(new_n678_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n679_));
  nand2  g588(.a(new_n679_), .b(new_n663_), .O(new_n680_));
  nand3  g589(.a(new_n680_), .b(new_n168_), .c(x68), .O(new_n681_));
  nand2  g590(.a(new_n123_), .b(x27), .O(new_n682_));
  oai21  g591(.a(new_n123_), .b(new_n658_), .c(new_n682_), .O(new_n683_));
  ...
  nand4  g597(.a(new_n655_), .b(x71), .c(new_n149_), .d(new_n148_), .O(new_n689_));
  nand3  g598(.a(new_n676_), .b(new_n96_), .c(new_n123_), .O(new_n690_));
  nand2  g599(.a(new_n690_), .b(new_n689_), .O(new_n691_));
  nand2  g600(.a(new_n691_), .b(new_n107_), .O(new_n692_));
  inv1   g601(.a(new_n661_), .O(new_n693_));
  nand3  g602(.a(new_n693_), .b(new_n149_), .c(new_n148_), .O(new_n694_));
  aoi21  g603(.a(new_n694_), .b(new_n692_), .c(x69), .O(new_n695_));
  nand4  g604(.a(new_n695_), .b(x68), .c(x65), .d(new_n94_), .O(new_n696_));
  nand3  g605(.a(new_n696_), .b(new_n688_), .c(new_n249_), .O(z11));
  oai21  g606(.a(new_n303_), .b(new_n136_), .c(x12), .O(new_n698_));
  inv1   g607(.a(new_n303_), .O(new_n699_));
  nand3  g608(.a(new_n699_), .b(new_n184_), .c(x00), .O(new_n700_));
  aoi21  g609(.a(new_n700_), .b(new_n698_), .c(new_n123_), .O(new_n701_));
  nand2  g610(.a(new_n701_), .b(new_n107_), .O(new_n702_));
  oai21  g611(.a(new_n317_), .b(new_n129_), .c(x44), .O(new_n703_));
  nor2   g612(.a(new_n317_), .b(x44), .O(new_n704_));
  ...
  nand2  g619(.a(new_n225_), .b(x60), .O(new_n711_));
  aoi21  g620(.a(new_n626_), .b(new_n625_), .c(x73), .O(new_n712_));
  nand3  g621(.a(new_n223_), .b(x73), .c(x52), .O(new_n713_));
  inv1   g622(.a(new_n713_), .O(new_n714_));
  oai21  g623(.a(new_n714_), .b(new_n712_), .c(x72), .O(new_n715_));
  nand2  g624(.a(x74), .b(x57), .O(new_n716_));
  nand2  g625(.a(new_n223_), .b(x58), .O(new_n717_));
  aoi21  g626(.a(new_n717_), .b(new_n716_), .c(new_n222_), .O(new_n718_));
  nand3  g627(.a(x74), .b(new_n222_), .c(x59), .O(new_n719_));
  inv1   g628(.a(new_n719_), .O(new_n720_));
  oai21  g629(.a(new_n720_), .b(new_n718_), .c(new_n220_), .O(new_n721_));
  ...
  nand3  g635(.a(new_n726_), .b(new_n168_), .c(x68), .O(new_n727_));
  nand2  g636(.a(new_n123_), .b(x28), .O(new_n728_));
  oai21  g637(.a(new_n123_), .b(new_n208_), .c(new_n728_), .O(new_n729_));
  nand2  g638(.a(new_n729_), .b(x70), .O(new_n730_));
  oai21  g639(.a(new_n108_), .b(new_n184_), .c(new_n730_), .O(new_n731_));
  ...
  nand3  g643(.a(new_n701_), .b(new_n149_), .c(new_n148_), .O(new_n735_));
  nand3  g644(.a(new_n722_), .b(new_n96_), .c(new_n123_), .O(new_n736_));
  nand2  g645(.a(new_n736_), .b(new_n735_), .O(new_n737_));
  nand2  g646(.a(new_n737_), .b(new_n107_), .O(new_n738_));
  inv1   g647(.a(new_n707_), .O(new_n739_));
  nand3  g648(.a(new_n739_), .b(new_n149_), .c(new_n148_), .O(new_n740_));
  aoi21  g649(.a(new_n740_), .b(new_n738_), .c(x69), .O(new_n741_));
  nand4  g650(.a(new_n741_), .b(x68), .c(x65), .d(new_n94_), .O(new_n742_));
  nand3  g651(.a(new_n742_), .b(new_n734_), .c(new_n249_), .O(z12));
  ...
  aoi21  g664(.a(new_n671_), .b(new_n670_), .c(x73), .O(new_n756_));
  ...
  oai21  g676(.a(new_n131_), .b(new_n209_), .c(new_n767_), .O(new_n768_));
  nand4  g677(.a(new_n768_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n769_));
  aoi21  g678(.a(new_n769_), .b(new_n754_), .c(new_n93_), .O(new_n770_));
  nand2  g679(.a(new_n123_), .b(x29), .O(new_n771_));
  oai21  g680(.a(new_n123_), .b(new_n209_), .c(new_n771_), .O(new_n772_));
  nand2  g681(.a(new_n772_), .b(x70), .O(new_n773_));
  oai21  g682(.a(new_n108_), .b(new_n185_), .c(new_n773_), .O(new_n774_));
  ...
  nand3  g686(.a(new_n747_), .b(new_n149_), .c(new_n148_), .O(new_n778_));
  ...
  oai21  g693(.a(new_n187_), .b(new_n136_), .c(x14), .O(new_n785_));
  nand3  g694(.a(x15), .b(new_n186_), .c(x00), .O(new_n786_));
  aoi21  g695(.a(new_n786_), .b(new_n785_), .c(new_n123_), .O(new_n787_));
  nand2  g696(.a(new_n787_), .b(new_n107_), .O(new_n788_));
  oai21  g697(.a(new_n211_), .b(new_n129_), .c(x46), .O(new_n789_));
  nand3  g698(.a(x47), .b(new_n210_), .c(x32), .O(new_n790_));
  nand2  g699(.a(new_n790_), .b(new_n789_), .O(new_n791_));
  nand3  g700(.a(new_n791_), .b(new_n123_), .c(x70), .O(new_n792_));
  nand2  g701(.a(new_n792_), .b(new_n788_), .O(new_n793_));
  nand3  g702(.a(new_n793_), .b(new_n96_), .c(new_n94_), .O(new_n794_));
  nand2  g703(.a(new_n135_), .b(x46), .O(new_n795_));
  nand2  g704(.a(new_n225_), .b(x62), .O(new_n796_));
  aoi21  g705(.a(new_n717_), .b(new_n716_), .c(x73), .O(new_n797_));
  nand3  g706(.a(new_n223_), .b(x73), .c(x54), .O(new_n798_));
  inv1   g707(.a(new_n798_), .O(new_n799_));
  oai21  g708(.a(new_n799_), .b(new_n797_), .c(x72), .O(new_n800_));
  nand2  g709(.a(x74), .b(x59), .O(new_n801_));
  nand2  g710(.a(new_n223_), .b(x60), .O(new_n802_));
  aoi21  g711(.a(new_n802_), .b(new_n801_), .c(new_n222_), .O(new_n803_));
  nand3  g712(.a(x74), .b(new_n222_), .c(x61), .O(new_n804_));
  inv1   g713(.a(new_n804_), .O(new_n805_));
  oai21  g714(.a(new_n805_), .b(new_n803_), .c(new_n220_), .O(new_n806_));
  nand3  g715(.a(new_n806_), .b(new_n800_), .c(new_n796_), .O(new_n807_));
  nand3  g716(.a(new_n807_), .b(new_n149_), .c(new_n148_), .O(new_n808_));
  nand2  g717(.a(new_n808_), .b(new_n795_), .O(new_n809_));
  nand4  g718(.a(new_n809_), .b(new_n123_), .c(new_n107_), .d(x64), .O(new_n810_));
  nand2  g719(.a(new_n810_), .b(new_n794_), .O(new_n811_));
  nand3  g720(.a(new_n811_), .b(new_n168_), .c(x68), .O(new_n812_));
  nand2  g721(.a(new_n123_), .b(x30), .O(new_n813_));
  oai21  g722(.a(new_n123_), .b(new_n210_), .c(new_n813_), .O(new_n814_));
  nand2  g723(.a(new_n814_), .b(x70), .O(new_n815_));
  oai21  g724(.a(new_n108_), .b(new_n186_), .c(new_n815_), .O(new_n816_));
  ...
  nand3  g728(.a(new_n787_), .b(new_n149_), .c(new_n148_), .O(new_n820_));
  nand3  g729(.a(new_n807_), .b(new_n96_), .c(new_n123_), .O(new_n821_));
  nand2  g730(.a(new_n821_), .b(new_n820_), .O(new_n822_));
  nand2  g731(.a(new_n822_), .b(new_n107_), .O(new_n823_));
  ...
  nand3  g736(.a(new_n827_), .b(new_n819_), .c(new_n249_), .O(z14));
