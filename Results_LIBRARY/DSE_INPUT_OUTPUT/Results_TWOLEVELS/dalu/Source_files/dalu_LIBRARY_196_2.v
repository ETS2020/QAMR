// Benchmark "FAU" written by ABC on Sat Aug 22 03:33:43 2020
...
module FAU ( 
  ...
  oai21  g144(.a(x74), .b(new_n202_), .c(new_n235_), .O(new_n236_));
  ...
  oai21  g151(.a(new_n242_), .b(new_n234_), .c(new_n164_), .O(new_n243_));
  inv1   g152(.a(x52), .O(new_n244_));
  nand2  g153(.a(new_n166_), .b(x48), .O(new_n245_));
  oai21  g154(.a(new_n135_), .b(new_n244_), .c(new_n245_), .O(new_n246_));
  nand2  g155(.a(new_n246_), .b(x72), .O(new_n247_));
  nand2  g156(.a(x74), .b(x49), .O(new_n248_));
  nand2  g157(.a(new_n141_), .b(x50), .O(new_n249_));
  aoi21  g158(.a(new_n249_), .b(new_n248_), .c(new_n144_), .O(new_n250_));
  nand2  g159(.a(x74), .b(x51), .O(new_n251_));
  nand2  g160(.a(new_n141_), .b(x52), .O(new_n252_));
  aoi21  g161(.a(new_n252_), .b(new_n251_), .c(x73), .O(new_n253_));
  oai21  g162(.a(new_n253_), .b(new_n250_), .c(new_n134_), .O(new_n254_));
  ...
  nand3  g166(.a(new_n257_), .b(x69), .c(new_n108_), .O(new_n258_));
  aoi21  g167(.a(new_n258_), .b(new_n231_), .c(x66), .O(new_n259_));
  nor3   g168(.a(new_n230_), .b(x67), .c(new_n107_), .O(new_n260_));
  oai21  g169(.a(new_n260_), .b(new_n259_), .c(new_n124_), .O(new_n261_));
  nand2  g170(.a(new_n186_), .b(x20), .O(new_n262_));
  nand2  g171(.a(new_n262_), .b(new_n261_), .O(new_n263_));
  nand3  g172(.a(new_n263_), .b(new_n92_), .c(x64), .O(new_n264_));
  nand4  g173(.a(new_n257_), .b(new_n120_), .c(x69), .d(new_n124_), .O(new_n265_));
  nor2   g174(.a(new_n265_), .b(new_n92_), .O(new_n266_));
  aoi21  g175(.a(new_n266_), .b(new_n118_), .c(new_n156_), .O(new_n267_));
  ...
  nand3  g213(.a(new_n304_), .b(x69), .c(new_n108_), .O(new_n305_));
  aoi21  g214(.a(new_n305_), .b(new_n273_), .c(x66), .O(new_n306_));
  nor3   g215(.a(new_n272_), .b(x67), .c(new_n107_), .O(new_n307_));
  oai21  g216(.a(new_n307_), .b(new_n306_), .c(new_n124_), .O(new_n308_));
  nand2  g217(.a(new_n186_), .b(x21), .O(new_n309_));
  nand2  g218(.a(new_n309_), .b(new_n308_), .O(new_n310_));
  nand3  g219(.a(new_n310_), .b(new_n92_), .c(x64), .O(new_n311_));
  nand4  g220(.a(new_n304_), .b(new_n120_), .c(x69), .d(new_n124_), .O(new_n312_));
  nor2   g221(.a(new_n312_), .b(new_n92_), .O(new_n313_));
  aoi21  g222(.a(new_n313_), .b(new_n118_), .c(new_n156_), .O(new_n314_));
  nand2  g223(.a(new_n314_), .b(new_n311_), .O(z05));
  nand2  g224(.a(new_n100_), .b(x06), .O(new_n316_));
  nand2  g225(.a(x71), .b(x38), .O(new_n317_));
  nand2  g226(.a(new_n101_), .b(x22), .O(new_n318_));
  nand2  g227(.a(new_n318_), .b(new_n317_), .O(new_n319_));
  nand2  g228(.a(new_n319_), .b(x70), .O(new_n320_));
  nand3  g229(.a(new_n103_), .b(x69), .c(x54), .O(new_n321_));
  nand3  g230(.a(new_n321_), .b(new_n320_), .c(new_n316_), .O(new_n322_));
  and2   g231(.a(new_n322_), .b(x67), .O(new_n323_));
  nand2  g232(.a(new_n138_), .b(x22), .O(new_n324_));
  and2   g233(.a(new_n236_), .b(new_n144_), .O(new_n325_));
  nor2   g234(.a(x74), .b(new_n144_), .O(new_n326_));
  ...
  nand2  g244(.a(new_n138_), .b(x54), .O(new_n336_));
  ...
  aoi21  g249(.a(new_n252_), .b(new_n251_), .c(new_n144_), .O(new_n341_));
  nand2  g250(.a(new_n170_), .b(x53), .O(new_n342_));
  inv1   g251(.a(new_n342_), .O(new_n343_));
  oai21  g252(.a(new_n343_), .b(new_n341_), .c(new_n134_), .O(new_n344_));
  nand3  g253(.a(new_n344_), .b(new_n340_), .c(new_n336_), .O(new_n345_));
  nand3  g254(.a(new_n345_), .b(x71), .c(x70), .O(new_n346_));
  aoi21  g255(.a(new_n346_), .b(new_n335_), .c(new_n127_), .O(new_n347_));
  aoi21  g256(.a(new_n347_), .b(new_n108_), .c(new_n323_), .O(new_n348_));
  nand3  g257(.a(new_n322_), .b(new_n108_), .c(x66), .O(new_n349_));
  oai21  g258(.a(new_n348_), .b(x66), .c(new_n349_), .O(new_n350_));
  nand3  g259(.a(new_n350_), .b(new_n92_), .c(x64), .O(new_n351_));
  aoi21  g260(.a(new_n346_), .b(new_n335_), .c(new_n119_), .O(new_n352_));
  nand4  g261(.a(new_n352_), .b(x69), .c(x65), .d(new_n118_), .O(new_n353_));
  aoi21  g262(.a(new_n353_), .b(new_n351_), .c(x68), .O(z06));
  nand2  g263(.a(new_n100_), .b(x07), .O(new_n355_));
  inv1   g264(.a(x23), .O(new_n356_));
  nand2  g265(.a(new_n94_), .b(new_n127_), .O(new_n357_));
  ...
  nand3  g270(.a(new_n361_), .b(new_n360_), .c(new_n355_), .O(new_n362_));
  and2   g271(.a(new_n362_), .b(x67), .O(new_n363_));
  nand2  g272(.a(new_n138_), .b(x23), .O(new_n364_));
  and2   g273(.a(new_n282_), .b(new_n144_), .O(new_n365_));
  oai21  g274(.a(new_n365_), .b(new_n328_), .c(x72), .O(new_n366_));
  and2   g275(.a(new_n286_), .b(x73), .O(new_n367_));
  nand2  g276(.a(new_n170_), .b(x22), .O(new_n368_));
  ...
  nand2  g280(.a(new_n371_), .b(new_n164_), .O(new_n372_));
  nand2  g281(.a(new_n138_), .b(x55), .O(new_n373_));
  aoi21  g282(.a(new_n296_), .b(new_n295_), .c(x73), .O(new_n374_));
  oai21  g283(.a(new_n374_), .b(new_n339_), .c(x72), .O(new_n375_));
  aoi21  g284(.a(new_n299_), .b(new_n298_), .c(new_n144_), .O(new_n376_));
  nand2  g285(.a(new_n170_), .b(x54), .O(new_n377_));
  ...
  nand2  g307(.a(new_n327_), .b(new_n241_), .O(new_n399_));
  ...
  oai21  g318(.a(new_n339_), .b(new_n253_), .c(x72), .O(new_n410_));
  ...
  nand2  g335(.a(new_n100_), .b(x09), .O(new_n427_));
  inv1   g336(.a(x25), .O(new_n428_));
  nand2  g337(.a(x71), .b(x41), .O(new_n429_));
  oai21  g338(.a(new_n357_), .b(new_n428_), .c(new_n429_), .O(new_n430_));
  nand2  g339(.a(new_n430_), .b(x70), .O(new_n431_));
  nand3  g340(.a(new_n103_), .b(x69), .c(x57), .O(new_n432_));
  nand3  g341(.a(new_n432_), .b(new_n431_), .c(new_n427_), .O(new_n433_));
  and2   g342(.a(new_n433_), .b(x67), .O(new_n434_));
  nand2  g343(.a(new_n138_), .b(x25), .O(new_n435_));
  nand2  g344(.a(new_n326_), .b(x17), .O(new_n436_));
  nand2  g345(.a(new_n287_), .b(new_n436_), .O(new_n437_));
  nand2  g346(.a(new_n437_), .b(x72), .O(new_n438_));
  nand2  g347(.a(x74), .b(x22), .O(new_n439_));
  oai21  g348(.a(x74), .b(new_n356_), .c(new_n439_), .O(new_n440_));
  and2   g349(.a(new_n440_), .b(x73), .O(new_n441_));
  nand2  g350(.a(new_n170_), .b(x24), .O(new_n442_));
  ...
  nand2  g355(.a(new_n138_), .b(x57), .O(new_n447_));
  nand2  g356(.a(new_n326_), .b(x49), .O(new_n448_));
  inv1   g357(.a(new_n448_), .O(new_n449_));
  oai21  g358(.a(new_n300_), .b(new_n449_), .c(x72), .O(new_n450_));
  nand2  g359(.a(x74), .b(x54), .O(new_n451_));
  nand2  g360(.a(new_n141_), .b(x55), .O(new_n452_));
  aoi21  g361(.a(new_n452_), .b(new_n451_), .c(new_n144_), .O(new_n453_));
  nand2  g362(.a(new_n170_), .b(x56), .O(new_n454_));
  inv1   g363(.a(new_n454_), .O(new_n455_));
  oai21  g364(.a(new_n455_), .b(new_n453_), .c(new_n134_), .O(new_n456_));
  nand3  g365(.a(new_n456_), .b(new_n450_), .c(new_n447_), .O(new_n457_));
  nand3  g366(.a(new_n457_), .b(x71), .c(x70), .O(new_n458_));
  aoi21  g367(.a(new_n458_), .b(new_n446_), .c(new_n127_), .O(new_n459_));
  aoi21  g368(.a(new_n459_), .b(new_n108_), .c(new_n434_), .O(new_n460_));
  nand3  g369(.a(new_n433_), .b(new_n108_), .c(x66), .O(new_n461_));
  oai21  g370(.a(new_n460_), .b(x66), .c(new_n461_), .O(new_n462_));
  nand3  g371(.a(new_n462_), .b(new_n92_), .c(x64), .O(new_n463_));
  aoi21  g372(.a(new_n458_), .b(new_n446_), .c(new_n119_), .O(new_n464_));
  ...
  nand2  g392(.a(new_n483_), .b(new_n164_), .O(new_n484_));
  ...
  nand2  g411(.a(new_n186_), .b(x26), .O(new_n503_));
  ...
  nand2  g445(.a(new_n141_), .b(x57), .O(new_n537_));
  aoi21  g446(.a(new_n537_), .b(new_n536_), .c(new_n144_), .O(new_n538_));
  nand2  g447(.a(new_n170_), .b(x58), .O(new_n539_));
  inv1   g448(.a(new_n539_), .O(new_n540_));
  oai21  g449(.a(new_n540_), .b(new_n538_), .c(new_n134_), .O(new_n541_));
  nand3  g450(.a(new_n541_), .b(new_n535_), .c(new_n531_), .O(new_n542_));
  nand3  g451(.a(new_n542_), .b(x71), .c(x70), .O(new_n543_));
  aoi21  g452(.a(new_n543_), .b(new_n530_), .c(new_n127_), .O(new_n544_));
  aoi21  g453(.a(new_n544_), .b(new_n108_), .c(new_n517_), .O(new_n545_));
  nand3  g454(.a(new_n516_), .b(new_n108_), .c(x66), .O(new_n546_));
  oai21  g455(.a(new_n545_), .b(x66), .c(new_n546_), .O(new_n547_));
  nand3  g456(.a(new_n547_), .b(new_n92_), .c(x64), .O(new_n548_));
  aoi21  g457(.a(new_n543_), .b(new_n530_), .c(new_n119_), .O(new_n549_));
  nand4  g458(.a(new_n549_), .b(x69), .c(x65), .d(new_n118_), .O(new_n550_));
  aoi21  g459(.a(new_n550_), .b(new_n548_), .c(x68), .O(z11));
  nand2  g460(.a(new_n100_), .b(x12), .O(new_n552_));
  nand2  g461(.a(x71), .b(x44), .O(new_n553_));
  nand2  g462(.a(new_n101_), .b(x28), .O(new_n554_));
  nand2  g463(.a(new_n554_), .b(new_n553_), .O(new_n555_));
  nand2  g464(.a(new_n555_), .b(x70), .O(new_n556_));
  nand3  g465(.a(new_n103_), .b(x69), .c(x60), .O(new_n557_));
  nand3  g466(.a(new_n557_), .b(new_n556_), .c(new_n552_), .O(new_n558_));
  and2   g467(.a(new_n558_), .b(x67), .O(new_n559_));
  nand2  g468(.a(new_n138_), .b(x28), .O(new_n560_));
  aoi21  g469(.a(new_n478_), .b(new_n477_), .c(x73), .O(new_n561_));
  nand2  g470(.a(new_n326_), .b(x20), .O(new_n562_));
  inv1   g471(.a(new_n562_), .O(new_n563_));
  oai21  g472(.a(new_n563_), .b(new_n561_), .c(x72), .O(new_n564_));
  nand2  g473(.a(x74), .b(x25), .O(new_n565_));
  nand2  g474(.a(new_n141_), .b(x26), .O(new_n566_));
  aoi21  g475(.a(new_n566_), .b(new_n565_), .c(new_n144_), .O(new_n567_));
  nand2  g476(.a(new_n170_), .b(x27), .O(new_n568_));
  ...
  nand2  g481(.a(new_n138_), .b(x60), .O(new_n573_));
  aoi21  g482(.a(new_n491_), .b(new_n490_), .c(x73), .O(new_n574_));
  nand2  g483(.a(new_n326_), .b(x52), .O(new_n575_));
  inv1   g484(.a(new_n575_), .O(new_n576_));
  oai21  g485(.a(new_n576_), .b(new_n574_), .c(x72), .O(new_n577_));
  nand2  g486(.a(x74), .b(x57), .O(new_n578_));
  nand2  g487(.a(new_n141_), .b(x58), .O(new_n579_));
  aoi21  g488(.a(new_n579_), .b(new_n578_), .c(new_n144_), .O(new_n580_));
  nand2  g489(.a(new_n170_), .b(x59), .O(new_n581_));
  inv1   g490(.a(new_n581_), .O(new_n582_));
  oai21  g491(.a(new_n582_), .b(new_n580_), .c(new_n134_), .O(new_n583_));
  nand3  g492(.a(new_n583_), .b(new_n577_), .c(new_n573_), .O(new_n584_));
  nand3  g493(.a(new_n584_), .b(x71), .c(x70), .O(new_n585_));
  aoi21  g494(.a(new_n585_), .b(new_n572_), .c(new_n127_), .O(new_n586_));
  aoi21  g495(.a(new_n586_), .b(new_n108_), .c(new_n559_), .O(new_n587_));
  nand3  g496(.a(new_n558_), .b(new_n108_), .c(x66), .O(new_n588_));
  oai21  g497(.a(new_n587_), .b(x66), .c(new_n588_), .O(new_n589_));
  nand3  g498(.a(new_n589_), .b(new_n92_), .c(x64), .O(new_n590_));
  aoi21  g499(.a(new_n585_), .b(new_n572_), .c(new_n119_), .O(new_n591_));
  nand4  g500(.a(new_n591_), .b(x69), .c(x65), .d(new_n118_), .O(new_n592_));
  ...
  and2   g511(.a(new_n524_), .b(new_n144_), .O(new_n603_));
  nand2  g512(.a(new_n326_), .b(x21), .O(new_n604_));
  inv1   g513(.a(new_n604_), .O(new_n605_));
  oai21  g514(.a(new_n605_), .b(new_n603_), .c(x72), .O(new_n606_));
  nand2  g515(.a(x74), .b(x26), .O(new_n607_));
  nand2  g516(.a(new_n141_), .b(x27), .O(new_n608_));
  ...
  aoi21  g524(.a(new_n537_), .b(new_n536_), .c(x73), .O(new_n616_));
  nand2  g525(.a(new_n326_), .b(x53), .O(new_n617_));
  ...
  aoi21  g537(.a(new_n628_), .b(new_n108_), .c(new_n601_), .O(new_n629_));
  nand3  g538(.a(new_n600_), .b(new_n108_), .c(x66), .O(new_n630_));
  ...
  nand2  g544(.a(new_n112_), .b(x46), .O(new_n636_));
  nand3  g545(.a(new_n103_), .b(x69), .c(x62), .O(new_n637_));
  nand2  g546(.a(new_n637_), .b(new_n636_), .O(new_n638_));
  aoi21  g547(.a(new_n100_), .b(x14), .c(new_n638_), .O(new_n639_));
  or2    g548(.a(new_n639_), .b(new_n108_), .O(new_n640_));
  nand2  g549(.a(new_n138_), .b(x30), .O(new_n641_));
  aoi21  g550(.a(new_n566_), .b(new_n565_), .c(x73), .O(new_n642_));
  nand3  g551(.a(new_n141_), .b(x73), .c(x22), .O(new_n643_));
  inv1   g552(.a(new_n643_), .O(new_n644_));
  oai21  g553(.a(new_n644_), .b(new_n642_), .c(x72), .O(new_n645_));
  nand2  g554(.a(x74), .b(x27), .O(new_n646_));
  nand2  g555(.a(new_n141_), .b(x28), .O(new_n647_));
  aoi21  g556(.a(new_n647_), .b(new_n646_), .c(new_n144_), .O(new_n648_));
  nand3  g557(.a(x74), .b(new_n144_), .c(x29), .O(new_n649_));
  inv1   g558(.a(new_n649_), .O(new_n650_));
  oai21  g559(.a(new_n650_), .b(new_n648_), .c(new_n134_), .O(new_n651_));
  nand3  g560(.a(new_n651_), .b(new_n645_), .c(new_n641_), .O(new_n652_));
  nand2  g561(.a(new_n652_), .b(new_n164_), .O(new_n653_));
  nand2  g562(.a(new_n138_), .b(x62), .O(new_n654_));
  aoi21  g563(.a(new_n579_), .b(new_n578_), .c(x73), .O(new_n655_));
  nand3  g564(.a(new_n141_), .b(x73), .c(x54), .O(new_n656_));
  inv1   g565(.a(new_n656_), .O(new_n657_));
  oai21  g566(.a(new_n657_), .b(new_n655_), .c(x72), .O(new_n658_));
  nand2  g567(.a(x74), .b(x59), .O(new_n659_));
  nand2  g568(.a(new_n141_), .b(x60), .O(new_n660_));
  aoi21  g569(.a(new_n660_), .b(new_n659_), .c(new_n144_), .O(new_n661_));
  nand3  g570(.a(x74), .b(new_n144_), .c(x61), .O(new_n662_));
  inv1   g571(.a(new_n662_), .O(new_n663_));
  oai21  g572(.a(new_n663_), .b(new_n661_), .c(new_n134_), .O(new_n664_));
  ...
  nand3  g576(.a(new_n667_), .b(x69), .c(new_n108_), .O(new_n668_));
  aoi21  g577(.a(new_n668_), .b(new_n640_), .c(x66), .O(new_n669_));
  nor3   g578(.a(new_n639_), .b(x67), .c(new_n107_), .O(new_n670_));
  oai21  g579(.a(new_n670_), .b(new_n669_), .c(new_n124_), .O(new_n671_));
  nand2  g580(.a(new_n186_), .b(x30), .O(new_n672_));
  nand2  g581(.a(new_n672_), .b(new_n671_), .O(new_n673_));
  nand3  g582(.a(new_n673_), .b(new_n92_), .c(x64), .O(new_n674_));
  nand4  g583(.a(new_n667_), .b(new_n120_), .c(x69), .d(new_n124_), .O(new_n675_));
  nor2   g584(.a(new_n675_), .b(new_n92_), .O(new_n676_));
  aoi21  g585(.a(new_n676_), .b(new_n118_), .c(new_n156_), .O(new_n677_));
  ...
  aoi21  g593(.a(new_n608_), .b(new_n607_), .c(x73), .O(new_n685_));
  ...
  aoi21  g606(.a(new_n621_), .b(new_n620_), .c(x73), .O(new_n698_));
