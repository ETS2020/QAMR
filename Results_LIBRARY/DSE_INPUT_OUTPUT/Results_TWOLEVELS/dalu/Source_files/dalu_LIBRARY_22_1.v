// Benchmark "FAU" written by ABC on Sat Aug 22 03:25:06 2020
...
module FAU ( 
  ...
  nand3  g166(.a(new_n257_), .b(new_n253_), .c(new_n179_), .O(z01));
  ...
  nand3  g172(.a(new_n263_), .b(new_n199_), .c(new_n195_), .O(new_n264_));
  ...
  nand4  g212(.a(new_n303_), .b(new_n182_), .c(new_n191_), .d(new_n302_), .O(new_n304_));
  nand4  g213(.a(new_n184_), .b(new_n110_), .c(new_n197_), .d(new_n107_), .O(new_n305_));
  nor2   g214(.a(new_n305_), .b(new_n304_), .O(new_n306_));
  oai21  g215(.a(new_n306_), .b(new_n144_), .c(x03), .O(new_n307_));
  nor3   g216(.a(x06), .b(x05), .c(x04), .O(new_n308_));
  nor3   g217(.a(x09), .b(x08), .c(x07), .O(new_n309_));
  nand2  g218(.a(new_n196_), .b(new_n153_), .O(new_n310_));
  nor2   g219(.a(new_n310_), .b(x10), .O(new_n311_));
  nand2  g220(.a(new_n184_), .b(new_n197_), .O(new_n312_));
  inv1   g221(.a(new_n312_), .O(new_n313_));
  nand4  g222(.a(new_n313_), .b(new_n311_), .c(new_n309_), .d(new_n308_), .O(new_n314_));
  nand3  g223(.a(new_n314_), .b(new_n100_), .c(x00), .O(new_n315_));
  nand2  g224(.a(new_n315_), .b(new_n307_), .O(new_n316_));
  nand3  g225(.a(new_n316_), .b(x71), .c(new_n111_), .O(new_n317_));
  nor3   g226(.a(x38), .b(x37), .c(x36), .O(new_n318_));
  nand2  g227(.a(new_n318_), .b(new_n168_), .O(new_n319_));
  nand4  g228(.a(new_n207_), .b(new_n126_), .c(new_n218_), .d(new_n125_), .O(new_n320_));
  oai21  g229(.a(new_n320_), .b(new_n319_), .c(x32), .O(new_n321_));
  nand2  g230(.a(new_n321_), .b(x35), .O(new_n322_));
  inv1   g231(.a(x43), .O(new_n323_));
  nand2  g232(.a(new_n217_), .b(new_n323_), .O(new_n324_));
  nor2   g233(.a(new_n324_), .b(x42), .O(new_n325_));
  nand2  g234(.a(new_n207_), .b(new_n218_), .O(new_n326_));
  inv1   g235(.a(new_n326_), .O(new_n327_));
  nand4  g236(.a(new_n327_), .b(new_n325_), .c(new_n318_), .d(new_n168_), .O(new_n328_));
  nand3  g237(.a(new_n328_), .b(new_n117_), .c(x32), .O(new_n329_));
  nand2  g238(.a(new_n329_), .b(new_n322_), .O(new_n330_));
  nand3  g239(.a(new_n330_), .b(new_n129_), .c(x70), .O(new_n331_));
  nand2  g240(.a(new_n331_), .b(new_n317_), .O(new_n332_));
  nand3  g241(.a(new_n332_), .b(new_n97_), .c(new_n94_), .O(new_n333_));
  nand2  g242(.a(new_n234_), .b(x51), .O(new_n334_));
  oai21  g243(.a(new_n230_), .b(x72), .c(new_n280_), .O(new_n335_));
  nand2  g244(.a(new_n335_), .b(x48), .O(new_n336_));
  inv1   g245(.a(x50), .O(new_n337_));
  nand3  g246(.a(new_n232_), .b(x73), .c(x49), .O(new_n338_));
  oai21  g247(.a(new_n238_), .b(new_n337_), .c(new_n338_), .O(new_n339_));
  nand2  g248(.a(new_n339_), .b(new_n229_), .O(new_n340_));
  nand3  g249(.a(new_n340_), .b(new_n336_), .c(new_n334_), .O(new_n341_));
  nand3  g250(.a(new_n341_), .b(new_n96_), .c(new_n95_), .O(new_n342_));
  oai21  g251(.a(new_n137_), .b(new_n117_), .c(new_n342_), .O(new_n343_));
  nand4  g252(.a(new_n343_), .b(new_n129_), .c(new_n111_), .d(x64), .O(new_n344_));
  aoi21  g253(.a(new_n344_), .b(new_n333_), .c(new_n142_), .O(new_n345_));
  ...
  nand3  g261(.a(new_n332_), .b(new_n96_), .c(new_n95_), .O(new_n353_));
  nand4  g262(.a(new_n341_), .b(new_n97_), .c(new_n129_), .d(new_n111_), .O(new_n354_));
  ...
  nand4  g266(.a(new_n199_), .b(new_n191_), .c(new_n102_), .d(new_n190_), .O(new_n358_));
  nand3  g267(.a(new_n358_), .b(new_n302_), .c(x00), .O(new_n359_));
  ...
  nand4  g272(.a(new_n222_), .b(new_n212_), .c(new_n120_), .d(new_n211_), .O(new_n364_));
  nand3  g273(.a(new_n364_), .b(new_n363_), .c(x32), .O(new_n365_));
  nand2  g274(.a(x36), .b(new_n135_), .O(new_n366_));
  nand2  g275(.a(new_n366_), .b(new_n365_), .O(new_n367_));
  nand3  g276(.a(new_n367_), .b(new_n129_), .c(x70), .O(new_n368_));
  ...
  oai21  g280(.a(new_n232_), .b(new_n231_), .c(x48), .O(new_n372_));
  oai21  g281(.a(new_n230_), .b(new_n371_), .c(new_n372_), .O(new_n373_));
  ...
  oai21  g292(.a(new_n137_), .b(new_n363_), .c(new_n383_), .O(new_n384_));
  nand4  g293(.a(new_n384_), .b(new_n129_), .c(new_n111_), .d(x64), .O(new_n385_));
  aoi21  g294(.a(new_n385_), .b(new_n370_), .c(new_n142_), .O(new_n386_));
  nand2  g295(.a(new_n129_), .b(x20), .O(new_n387_));
  oai21  g296(.a(new_n129_), .b(new_n363_), .c(new_n387_), .O(new_n388_));
  nand2  g297(.a(new_n388_), .b(x70), .O(new_n389_));
  oai21  g298(.a(new_n112_), .b(new_n302_), .c(new_n389_), .O(new_n390_));
  ...
  nand3  g302(.a(new_n382_), .b(new_n97_), .c(new_n129_), .O(new_n394_));
  nand4  g303(.a(new_n361_), .b(x71), .c(new_n96_), .d(new_n95_), .O(new_n395_));
  ...
  nand3  g311(.a(new_n184_), .b(new_n154_), .c(new_n302_), .O(new_n403_));
  inv1   g312(.a(new_n403_), .O(new_n404_));
  nand3  g313(.a(new_n404_), .b(new_n191_), .c(new_n102_), .O(new_n405_));
  nand3  g314(.a(new_n405_), .b(new_n190_), .c(x00), .O(new_n406_));
  ...
  nand3  g318(.a(new_n207_), .b(new_n206_), .c(new_n363_), .O(new_n410_));
  inv1   g319(.a(new_n410_), .O(new_n411_));
  nand3  g320(.a(new_n411_), .b(new_n212_), .c(new_n120_), .O(new_n412_));
  nand3  g321(.a(new_n412_), .b(new_n211_), .c(x32), .O(new_n413_));
  ...
  nand3  g330(.a(new_n232_), .b(new_n231_), .c(x49), .O(new_n422_));
  ...
  nand2  g335(.a(new_n232_), .b(x51), .O(new_n427_));
  aoi21  g336(.a(new_n427_), .b(new_n426_), .c(new_n231_), .O(new_n428_));
  nand2  g337(.a(x74), .b(x52), .O(new_n429_));
  nand2  g338(.a(new_n232_), .b(x53), .O(new_n430_));
  aoi21  g339(.a(new_n430_), .b(new_n429_), .c(x73), .O(new_n431_));
  oai21  g340(.a(new_n431_), .b(new_n428_), .c(new_n229_), .O(new_n432_));
  ...
  oai21  g350(.a(new_n112_), .b(new_n190_), .c(new_n441_), .O(new_n442_));
  ...
  nand4  g363(.a(new_n184_), .b(new_n154_), .c(new_n190_), .d(new_n302_), .O(new_n455_));
  ...
  nand4  g368(.a(new_n207_), .b(new_n206_), .c(new_n211_), .d(new_n363_), .O(new_n460_));
  ...
  nand2  g376(.a(new_n234_), .b(x54), .O(new_n468_));
  aoi21  g377(.a(new_n376_), .b(new_n375_), .c(x73), .O(new_n469_));
  nand3  g378(.a(new_n232_), .b(x73), .c(x48), .O(new_n470_));
  inv1   g379(.a(new_n470_), .O(new_n471_));
  oai21  g380(.a(new_n471_), .b(new_n469_), .c(x72), .O(new_n472_));
  aoi21  g381(.a(new_n379_), .b(new_n378_), .c(new_n231_), .O(new_n473_));
  nand3  g382(.a(x74), .b(new_n231_), .c(x53), .O(new_n474_));
  inv1   g383(.a(new_n474_), .O(new_n475_));
  oai21  g384(.a(new_n475_), .b(new_n473_), .c(new_n229_), .O(new_n476_));
  ...
  nand3  g390(.a(new_n481_), .b(new_n93_), .c(x68), .O(new_n482_));
  nand2  g391(.a(new_n129_), .b(x22), .O(new_n483_));
  oai21  g392(.a(new_n129_), .b(new_n120_), .c(new_n483_), .O(new_n484_));
  nand2  g393(.a(new_n484_), .b(x70), .O(new_n485_));
  oai21  g394(.a(new_n112_), .b(new_n102_), .c(new_n485_), .O(new_n486_));
  nand4  g395(.a(new_n486_), .b(new_n143_), .c(new_n142_), .d(x64), .O(new_n487_));
  nand2  g396(.a(new_n487_), .b(new_n482_), .O(new_n488_));
  nand2  g397(.a(new_n488_), .b(new_n92_), .O(new_n489_));
  nand3  g398(.a(new_n477_), .b(new_n97_), .c(new_n129_), .O(new_n490_));
  nand4  g399(.a(new_n458_), .b(x71), .c(new_n96_), .d(new_n95_), .O(new_n491_));
  nand2  g400(.a(new_n491_), .b(new_n490_), .O(new_n492_));
  nand2  g401(.a(new_n492_), .b(new_n111_), .O(new_n493_));
  inv1   g402(.a(new_n464_), .O(new_n494_));
  nand3  g403(.a(new_n494_), .b(new_n96_), .c(new_n95_), .O(new_n495_));
  aoi21  g404(.a(new_n495_), .b(new_n493_), .c(x69), .O(new_n496_));
  nand4  g405(.a(new_n496_), .b(x68), .c(x65), .d(new_n94_), .O(new_n497_));
  nand3  g406(.a(new_n497_), .b(new_n489_), .c(new_n179_), .O(z06));
  oai21  g407(.a(new_n455_), .b(x06), .c(new_n191_), .O(new_n499_));
  nand2  g408(.a(x07), .b(new_n144_), .O(new_n500_));
  oai21  g409(.a(new_n499_), .b(new_n144_), .c(new_n500_), .O(new_n501_));
  nand3  g410(.a(new_n501_), .b(x71), .c(new_n111_), .O(new_n502_));
  oai21  g411(.a(new_n460_), .b(x38), .c(new_n212_), .O(new_n503_));
  nand2  g412(.a(x39), .b(new_n135_), .O(new_n504_));
  oai21  g413(.a(new_n503_), .b(new_n135_), .c(new_n504_), .O(new_n505_));
  nand3  g414(.a(new_n505_), .b(new_n129_), .c(x70), .O(new_n506_));
  nand2  g415(.a(new_n506_), .b(new_n502_), .O(new_n507_));
  nand3  g416(.a(new_n507_), .b(new_n97_), .c(new_n94_), .O(new_n508_));
  ...
  aoi21  g420(.a(new_n430_), .b(new_n429_), .c(new_n231_), .O(new_n512_));
  ...
  oai21  g426(.a(new_n137_), .b(new_n212_), .c(new_n517_), .O(new_n518_));
  nand4  g427(.a(new_n518_), .b(new_n129_), .c(new_n111_), .d(x64), .O(new_n519_));
  aoi21  g428(.a(new_n519_), .b(new_n508_), .c(new_n142_), .O(new_n520_));
  nand2  g429(.a(new_n129_), .b(x23), .O(new_n521_));
  oai21  g430(.a(new_n129_), .b(new_n212_), .c(new_n521_), .O(new_n522_));
  nand2  g431(.a(new_n522_), .b(x70), .O(new_n523_));
  oai21  g432(.a(new_n112_), .b(new_n191_), .c(new_n523_), .O(new_n524_));
  nand4  g433(.a(new_n524_), .b(new_n143_), .c(new_n142_), .d(x64), .O(new_n525_));
  inv1   g434(.a(new_n525_), .O(new_n526_));
  oai21  g435(.a(new_n526_), .b(new_n520_), .c(new_n92_), .O(new_n527_));
  nand3  g436(.a(new_n516_), .b(new_n97_), .c(new_n129_), .O(new_n528_));
  nand4  g437(.a(new_n501_), .b(x71), .c(new_n96_), .d(new_n95_), .O(new_n529_));
  ...
  nand2  g455(.a(new_n234_), .b(x56), .O(new_n547_));
  oai21  g456(.a(new_n471_), .b(new_n380_), .c(x72), .O(new_n548_));
  nand2  g457(.a(x74), .b(x53), .O(new_n549_));
  nand2  g458(.a(new_n232_), .b(x54), .O(new_n550_));
  aoi21  g459(.a(new_n550_), .b(new_n549_), .c(new_n231_), .O(new_n551_));
  nand3  g460(.a(x74), .b(new_n231_), .c(x55), .O(new_n552_));
  ...
  and2   g483(.a(new_n305_), .b(x00), .O(new_n575_));
  ...
  and2   g487(.a(new_n320_), .b(x32), .O(new_n579_));
  nand3  g488(.a(new_n320_), .b(new_n124_), .c(x32), .O(new_n580_));
  ...
  nand2  g493(.a(new_n234_), .b(x57), .O(new_n585_));
  inv1   g494(.a(new_n338_), .O(new_n586_));
  oai21  g495(.a(new_n431_), .b(new_n586_), .c(x72), .O(new_n587_));
  nand2  g496(.a(x74), .b(x54), .O(new_n588_));
  nand2  g497(.a(new_n232_), .b(x55), .O(new_n589_));
  aoi21  g498(.a(new_n589_), .b(new_n588_), .c(new_n231_), .O(new_n590_));
  nand3  g499(.a(x74), .b(new_n231_), .c(x56), .O(new_n591_));
  inv1   g500(.a(new_n591_), .O(new_n592_));
  oai21  g501(.a(new_n592_), .b(new_n590_), .c(new_n229_), .O(new_n593_));
  ...
  nor2   g523(.a(new_n312_), .b(new_n310_), .O(new_n615_));
  oai21  g524(.a(new_n615_), .b(new_n144_), .c(x10), .O(new_n616_));
  nand2  g525(.a(new_n313_), .b(new_n110_), .O(new_n617_));
  ...
  nor2   g529(.a(new_n326_), .b(new_n324_), .O(new_n621_));
  oai21  g530(.a(new_n621_), .b(new_n135_), .c(x42), .O(new_n622_));
  nand2  g531(.a(new_n327_), .b(new_n126_), .O(new_n623_));
  ...
  nand3  g574(.a(new_n221_), .b(new_n323_), .c(x32), .O(new_n666_));
  ...
  oai21  g598(.a(new_n129_), .b(new_n323_), .c(new_n689_), .O(new_n690_));
  ...
  oai21  g613(.a(new_n313_), .b(new_n144_), .c(x12), .O(new_n705_));
  nand3  g614(.a(new_n312_), .b(new_n196_), .c(x00), .O(new_n706_));
  aoi21  g615(.a(new_n706_), .b(new_n705_), .c(new_n129_), .O(new_n707_));
  nand2  g616(.a(new_n707_), .b(new_n111_), .O(new_n708_));
  oai21  g617(.a(new_n327_), .b(new_n135_), .c(x44), .O(new_n709_));
  nand3  g618(.a(new_n326_), .b(new_n217_), .c(x32), .O(new_n710_));
  ...
  nand2  g664(.a(new_n143_), .b(x45), .O(new_n756_));
  nand2  g665(.a(new_n234_), .b(x61), .O(new_n757_));
  aoi21  g666(.a(new_n678_), .b(new_n677_), .c(x73), .O(new_n758_));
  nand3  g667(.a(new_n232_), .b(x73), .c(x53), .O(new_n759_));
  inv1   g668(.a(new_n759_), .O(new_n760_));
  oai21  g669(.a(new_n760_), .b(new_n758_), .c(x72), .O(new_n761_));
  nand2  g670(.a(x74), .b(x58), .O(new_n762_));
  nand2  g671(.a(new_n232_), .b(x59), .O(new_n763_));
  aoi21  g672(.a(new_n763_), .b(new_n762_), .c(new_n231_), .O(new_n764_));
  nand3  g673(.a(x74), .b(new_n231_), .c(x60), .O(new_n765_));
  inv1   g674(.a(new_n765_), .O(new_n766_));
  oai21  g675(.a(new_n766_), .b(new_n764_), .c(new_n229_), .O(new_n767_));
  nand3  g676(.a(new_n767_), .b(new_n761_), .c(new_n757_), .O(new_n768_));
  nand3  g677(.a(new_n768_), .b(new_n96_), .c(new_n95_), .O(new_n769_));
  nand2  g678(.a(new_n769_), .b(new_n756_), .O(new_n770_));
  nand4  g679(.a(new_n770_), .b(new_n129_), .c(new_n111_), .d(x64), .O(new_n771_));
  nand2  g680(.a(new_n771_), .b(new_n755_), .O(new_n772_));
  nand3  g681(.a(new_n772_), .b(new_n93_), .c(x68), .O(new_n773_));
  ...
  oai21  g685(.a(new_n112_), .b(new_n197_), .c(new_n776_), .O(new_n777_));
  ...
  nand3  g689(.a(new_n747_), .b(new_n96_), .c(new_n95_), .O(new_n781_));
  nand3  g690(.a(new_n768_), .b(new_n97_), .c(new_n129_), .O(new_n782_));
  nand2  g691(.a(new_n782_), .b(new_n781_), .O(new_n783_));
  nand2  g692(.a(new_n783_), .b(new_n111_), .O(new_n784_));
  inv1   g693(.a(new_n753_), .O(new_n785_));
  nand3  g694(.a(new_n785_), .b(new_n96_), .c(new_n95_), .O(new_n786_));
  aoi21  g695(.a(new_n786_), .b(new_n784_), .c(x69), .O(new_n787_));
  nand4  g696(.a(new_n787_), .b(x68), .c(x65), .d(new_n94_), .O(new_n788_));
  nand3  g697(.a(new_n788_), .b(new_n780_), .c(new_n179_), .O(z13));
  oai21  g698(.a(new_n157_), .b(new_n144_), .c(x14), .O(new_n790_));
  nand3  g699(.a(x15), .b(new_n156_), .c(x00), .O(new_n791_));
  aoi21  g700(.a(new_n791_), .b(new_n790_), .c(new_n129_), .O(new_n792_));
  nand2  g701(.a(new_n792_), .b(new_n111_), .O(new_n793_));
  oai21  g702(.a(new_n220_), .b(new_n135_), .c(x46), .O(new_n794_));
  nand3  g703(.a(x47), .b(new_n219_), .c(x32), .O(new_n795_));
  nand2  g704(.a(new_n795_), .b(new_n794_), .O(new_n796_));
  nand3  g705(.a(new_n796_), .b(new_n129_), .c(x70), .O(new_n797_));
  nand2  g706(.a(new_n797_), .b(new_n793_), .O(new_n798_));
  nand3  g707(.a(new_n798_), .b(new_n97_), .c(new_n94_), .O(new_n799_));
  nand2  g708(.a(new_n143_), .b(x46), .O(new_n800_));
  nand2  g709(.a(new_n234_), .b(x62), .O(new_n801_));
  aoi21  g710(.a(new_n721_), .b(new_n720_), .c(x73), .O(new_n802_));
  nand3  g711(.a(new_n232_), .b(x73), .c(x54), .O(new_n803_));
  inv1   g712(.a(new_n803_), .O(new_n804_));
  oai21  g713(.a(new_n804_), .b(new_n802_), .c(x72), .O(new_n805_));
  nand2  g714(.a(x74), .b(x59), .O(new_n806_));
  nand2  g715(.a(new_n232_), .b(x60), .O(new_n807_));
  aoi21  g716(.a(new_n807_), .b(new_n806_), .c(new_n231_), .O(new_n808_));
  nand3  g717(.a(x74), .b(new_n231_), .c(x61), .O(new_n809_));
  ...
  nand4  g723(.a(new_n814_), .b(new_n129_), .c(new_n111_), .d(x64), .O(new_n815_));
  nand2  g724(.a(new_n815_), .b(new_n799_), .O(new_n816_));
  nand3  g725(.a(new_n816_), .b(new_n93_), .c(x68), .O(new_n817_));
  nand2  g726(.a(new_n129_), .b(x30), .O(new_n818_));
  oai21  g727(.a(new_n129_), .b(new_n219_), .c(new_n818_), .O(new_n819_));
  nand2  g728(.a(new_n819_), .b(x70), .O(new_n820_));
  oai21  g729(.a(new_n112_), .b(new_n156_), .c(new_n820_), .O(new_n821_));
  nand4  g730(.a(new_n821_), .b(new_n143_), .c(new_n142_), .d(x64), .O(new_n822_));
  nand2  g731(.a(new_n822_), .b(new_n817_), .O(new_n823_));
  nand2  g732(.a(new_n823_), .b(new_n92_), .O(new_n824_));
  nand3  g733(.a(new_n792_), .b(new_n96_), .c(new_n95_), .O(new_n825_));
  nand3  g734(.a(new_n812_), .b(new_n97_), .c(new_n129_), .O(new_n826_));
  nand2  g735(.a(new_n826_), .b(new_n825_), .O(new_n827_));
  nand2  g736(.a(new_n827_), .b(new_n111_), .O(new_n828_));
  ...
  nand3  g741(.a(new_n832_), .b(new_n824_), .c(new_n179_), .O(z14));
  nand3  g742(.a(x71), .b(x70), .c(new_n142_), .O(new_n834_));
  nand3  g743(.a(new_n129_), .b(new_n111_), .c(x68), .O(new_n835_));
  aoi21  g744(.a(new_n835_), .b(new_n834_), .c(new_n220_), .O(new_n836_));
  nand3  g745(.a(x71), .b(new_n111_), .c(x15), .O(new_n837_));
  nand2  g746(.a(new_n173_), .b(x31), .O(new_n838_));
  aoi21  g747(.a(new_n838_), .b(new_n837_), .c(x68), .O(new_n839_));
  oai21  g748(.a(new_n839_), .b(new_n836_), .c(new_n143_), .O(new_n840_));
  nand2  g749(.a(new_n234_), .b(x63), .O(new_n841_));
  aoi21  g750(.a(new_n763_), .b(new_n762_), .c(x73), .O(new_n842_));
  nand3  g751(.a(new_n232_), .b(x73), .c(x55), .O(new_n843_));
  inv1   g752(.a(new_n843_), .O(new_n844_));
  oai21  g753(.a(new_n844_), .b(new_n842_), .c(x72), .O(new_n845_));
  nand2  g754(.a(x74), .b(x60), .O(new_n846_));
  nand2  g755(.a(new_n232_), .b(x61), .O(new_n847_));
  aoi21  g756(.a(new_n847_), .b(new_n846_), .c(new_n231_), .O(new_n848_));
  nand2  g757(.a(new_n283_), .b(x62), .O(new_n849_));
  inv1   g758(.a(new_n849_), .O(new_n850_));
  oai21  g759(.a(new_n850_), .b(new_n848_), .c(new_n229_), .O(new_n851_));
  nand3  g760(.a(new_n851_), .b(new_n845_), .c(new_n841_), .O(new_n852_));
  nand4  g761(.a(new_n852_), .b(new_n129_), .c(new_n111_), .d(x68), .O(new_n853_));
  inv1   g762(.a(new_n853_), .O(new_n854_));
  nand3  g763(.a(new_n854_), .b(new_n96_), .c(new_n95_), .O(new_n855_));
  aoi21  g764(.a(new_n855_), .b(new_n840_), .c(new_n94_), .O(new_n856_));
  oai21  g765(.a(new_n130_), .b(new_n220_), .c(new_n837_), .O(new_n857_));
  nand4  g766(.a(new_n857_), .b(new_n97_), .c(x68), .d(new_n94_), .O(new_n858_));
  inv1   g767(.a(new_n858_), .O(new_n859_));
  oai21  g768(.a(new_n859_), .b(new_n856_), .c(new_n92_), .O(new_n860_));
  nand3  g769(.a(new_n852_), .b(new_n97_), .c(new_n129_), .O(new_n861_));
  nand4  g770(.a(x71), .b(new_n96_), .c(new_n95_), .d(x15), .O(new_n862_));
  nand2  g771(.a(new_n862_), .b(new_n861_), .O(new_n863_));
  nand2  g772(.a(new_n863_), .b(new_n111_), .O(new_n864_));
  nand2  g773(.a(new_n95_), .b(x47), .O(new_n865_));
  oai21  g774(.a(new_n865_), .b(new_n174_), .c(new_n864_), .O(new_n866_));
