...
module FAU ( 
  ...
  nand4  g140(.a(new_n22_), .b(new_n56_), .c(x2), .d(x0), .O(new_n157_));
  inv1   g141(.a(x1), .O(new_n158_));
  nand4  g142(.a(x8), .b(x4), .c(new_n158_), .d(new_n18_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(x7), .O(new_n161_));
  aoi21  g145(.a(x6), .b(new_n37_), .c(new_n19_), .O(new_n162_));
  nand2  g146(.a(new_n19_), .b(new_n37_), .O(new_n163_));
  oai21  g147(.a(new_n162_), .b(new_n18_), .c(new_n163_), .O(new_n164_));
  nand3  g148(.a(new_n164_), .b(x5), .c(new_n56_), .O(new_n165_));
  nand2  g149(.a(new_n22_), .b(new_n37_), .O(new_n166_));
  oai21  g150(.a(new_n37_), .b(x0), .c(new_n166_), .O(new_n167_));
  ...
  aoi21  g154(.a(new_n170_), .b(new_n166_), .c(x0), .O(new_n171_));
  nand2  g155(.a(x5), .b(x2), .O(new_n172_));
  aoi21  g156(.a(new_n172_), .b(x6), .c(new_n19_), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n171_), .c(new_n41_), .O(new_n174_));
  nor2   g158(.a(new_n174_), .b(new_n56_), .O(new_n175_));
  aoi21  g159(.a(new_n169_), .b(new_n158_), .c(new_n175_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n161_), .c(new_n89_), .O(new_n177_));
  nand2  g161(.a(new_n41_), .b(x5), .O(new_n178_));
  ...
  nand3  g165(.a(x5), .b(new_n56_), .c(new_n18_), .O(new_n182_));
  nand3  g166(.a(new_n29_), .b(new_n22_), .c(x4), .O(new_n183_));
  nand2  g167(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  oai21  g168(.a(new_n184_), .b(new_n181_), .c(x2), .O(new_n185_));
  oai21  g169(.a(new_n42_), .b(x2), .c(new_n28_), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(x8), .c(new_n18_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n185_), .c(x1), .O(new_n188_));
  or2    g172(.a(new_n93_), .b(new_n38_), .O(new_n189_));
  inv1   g173(.a(new_n189_), .O(new_n190_));
  oai21  g174(.a(new_n190_), .b(new_n188_), .c(new_n89_), .O(new_n191_));
  nand2  g175(.a(x5), .b(x4), .O(new_n192_));
  or2    g176(.a(new_n192_), .b(new_n48_), .O(new_n193_));
  nand2  g177(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  oai21  g178(.a(new_n194_), .b(new_n177_), .c(x9), .O(new_n195_));
  nand3  g179(.a(new_n195_), .b(new_n156_), .c(new_n124_), .O(z1));
  nand2  g180(.a(new_n58_), .b(x5), .O(new_n197_));
  xor2a  g181(.a(x3), .b(x1), .O(new_n198_));
  nand2  g182(.a(new_n198_), .b(new_n197_), .O(z2));
  oai21  g183(.a(new_n89_), .b(new_n158_), .c(new_n197_), .O(z3));
  nand2  g184(.a(new_n37_), .b(new_n158_), .O(new_n201_));
  oai22  g185(.a(new_n201_), .b(new_n42_), .c(x6), .d(new_n56_), .O(new_n202_));
  nand2  g186(.a(new_n202_), .b(new_n18_), .O(new_n203_));
  nor2   g187(.a(new_n41_), .b(x6), .O(new_n204_));
  nand2  g188(.a(new_n57_), .b(new_n42_), .O(new_n205_));
  aoi22  g189(.a(new_n205_), .b(new_n158_), .c(new_n204_), .d(new_n56_), .O(new_n206_));
  nand4  g190(.a(x7), .b(x6), .c(new_n56_), .d(new_n37_), .O(new_n207_));
  oai21  g191(.a(new_n206_), .b(new_n37_), .c(new_n207_), .O(new_n208_));
  nand2  g192(.a(new_n208_), .b(x0), .O(new_n209_));
  nand2  g193(.a(x6), .b(x1), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n163_), .c(new_n41_), .O(new_n211_));
  aoi21  g195(.a(x8), .b(new_n56_), .c(x6), .O(new_n212_));
  aoi22  g196(.a(new_n212_), .b(new_n37_), .c(new_n211_), .d(new_n56_), .O(new_n213_));
  nand3  g197(.a(new_n213_), .b(new_n209_), .c(new_n203_), .O(new_n214_));
  xor2a  g198(.a(x2), .b(x0), .O(new_n215_));
  aoi21  g199(.a(new_n57_), .b(new_n42_), .c(new_n215_), .O(new_n216_));
  nor2   g200(.a(x7), .b(new_n56_), .O(new_n217_));
  aoi22  g201(.a(new_n217_), .b(x2), .c(new_n216_), .d(x1), .O(new_n218_));
  oai21  g202(.a(new_n82_), .b(new_n18_), .c(new_n158_), .O(new_n219_));
  nand3  g203(.a(x9), .b(new_n41_), .c(new_n22_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n219_), .O(new_n221_));
  aoi21  g205(.a(new_n221_), .b(x4), .c(new_n58_), .O(new_n222_));
  oai21  g206(.a(new_n218_), .b(new_n89_), .c(new_n222_), .O(new_n223_));
  aoi21  g207(.a(new_n214_), .b(new_n89_), .c(new_n223_), .O(new_n224_));
  oai21  g208(.a(new_n41_), .b(new_n37_), .c(x8), .O(new_n225_));
  oai21  g209(.a(new_n56_), .b(new_n89_), .c(new_n158_), .O(new_n226_));
  nand2  g210(.a(new_n226_), .b(new_n225_), .O(new_n227_));
  nand3  g211(.a(x7), .b(x4), .c(x3), .O(new_n228_));
  nand3  g212(.a(new_n228_), .b(new_n113_), .c(new_n57_), .O(new_n229_));
  nand2  g213(.a(new_n229_), .b(x6), .O(new_n230_));
  aoi21  g214(.a(new_n230_), .b(new_n227_), .c(x5), .O(new_n231_));
  nand2  g215(.a(new_n29_), .b(new_n22_), .O(new_n232_));
  aoi21  g216(.a(new_n232_), .b(new_n207_), .c(new_n158_), .O(new_n233_));
  oai21  g217(.a(new_n233_), .b(new_n231_), .c(x0), .O(new_n234_));
  nand3  g218(.a(new_n192_), .b(new_n22_), .c(x3), .O(new_n235_));
  nand3  g219(.a(x6), .b(new_n28_), .c(x4), .O(new_n236_));
  aoi21  g220(.a(new_n236_), .b(new_n235_), .c(new_n41_), .O(new_n237_));
  nand2  g221(.a(new_n44_), .b(new_n89_), .O(new_n238_));
  ...
  nand2  g225(.a(new_n44_), .b(new_n18_), .O(new_n242_));
  nand2  g226(.a(new_n19_), .b(x3), .O(new_n243_));
  aoi21  g227(.a(new_n243_), .b(new_n242_), .c(new_n37_), .O(new_n244_));
  nand3  g228(.a(new_n44_), .b(x3), .c(new_n158_), .O(new_n245_));
  inv1   g229(.a(new_n245_), .O(new_n246_));
  oai21  g230(.a(new_n246_), .b(new_n244_), .c(x4), .O(new_n247_));
  nand2  g231(.a(new_n29_), .b(x6), .O(new_n248_));
  nand2  g232(.a(new_n248_), .b(new_n247_), .O(new_n249_));
  nand2  g233(.a(new_n249_), .b(new_n28_), .O(new_n250_));
  nand3  g234(.a(new_n250_), .b(new_n241_), .c(new_n234_), .O(new_n251_));
  nand2  g235(.a(new_n251_), .b(x9), .O(new_n252_));
  oai21  g236(.a(new_n224_), .b(new_n28_), .c(new_n252_), .O(z4));
  oai21  g237(.a(new_n215_), .b(new_n198_), .c(new_n197_), .O(z5));
endmodule
