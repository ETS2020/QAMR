...
module FAU ( 
  ...
  nor2   g145(.a(x7), .b(new_n27_), .O(new_n162_));
  nor3   g146(.a(x8), .b(x3), .c(x2), .O(new_n163_));
  oai21  g147(.a(new_n163_), .b(new_n162_), .c(new_n19_), .O(new_n164_));
  nand3  g148(.a(x8), .b(new_n23_), .c(x3), .O(new_n165_));
  aoi21  g149(.a(new_n165_), .b(x1), .c(x0), .O(new_n166_));
  nand4  g150(.a(x8), .b(new_n23_), .c(x2), .d(new_n34_), .O(new_n167_));
  inv1   g151(.a(new_n167_), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n166_), .c(x4), .O(new_n169_));
  nand3  g153(.a(new_n93_), .b(x3), .c(new_n18_), .O(new_n170_));
  nand3  g154(.a(new_n128_), .b(new_n34_), .c(x0), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand4  g156(.a(x3), .b(x2), .c(x1), .d(x0), .O(new_n173_));
  nand4  g157(.a(new_n77_), .b(new_n18_), .c(new_n34_), .d(new_n17_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n173_), .c(new_n19_), .O(new_n175_));
  aoi21  g159(.a(new_n172_), .b(new_n144_), .c(new_n175_), .O(new_n176_));
  nand3  g160(.a(new_n176_), .b(new_n169_), .c(new_n164_), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(x5), .O(new_n178_));
  aoi21  g162(.a(new_n89_), .b(new_n34_), .c(new_n17_), .O(new_n179_));
  nand3  g163(.a(x4), .b(x2), .c(x1), .O(new_n180_));
  inv1   g164(.a(new_n180_), .O(new_n181_));
  oai21  g165(.a(new_n181_), .b(new_n179_), .c(new_n19_), .O(new_n182_));
  inv1   g166(.a(new_n134_), .O(new_n183_));
  aoi21  g167(.a(x6), .b(new_n41_), .c(new_n183_), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n182_), .c(x8), .O(new_n185_));
  aoi22  g169(.a(x3), .b(new_n34_), .c(x2), .d(new_n17_), .O(new_n186_));
  aoi21  g170(.a(new_n77_), .b(x1), .c(new_n59_), .O(new_n187_));
  oai21  g171(.a(new_n186_), .b(new_n27_), .c(new_n187_), .O(new_n188_));
  nand3  g172(.a(new_n188_), .b(x6), .c(new_n41_), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n23_), .O(new_n190_));
  nor2   g174(.a(new_n190_), .b(new_n185_), .O(new_n191_));
  aoi21  g175(.a(new_n191_), .b(new_n178_), .c(new_n20_), .O(z4));
  inv1   g176(.a(new_n157_), .O(new_n193_));
  xnor2a g177(.a(x2), .b(x0), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(new_n193_), .c(new_n159_), .O(new_n195_));
