...
module FAU ( 
  ...
  wire new_n17_, new_n18_, new_n19_, new_n20_, new_n21_, new_n22_, new_n23_,
    ...
    new_n132_, new_n133_, new_n134_, new_n136_, new_n139_, new_n140_,
  ...
  nand3  g088(.a(x5), .b(new_n86_), .c(new_n34_), .O(new_n105_));
  ...
  aoi21  g120(.a(x9), .b(new_n49_), .c(new_n136_), .O(z2));
  oai22  g121(.a(new_n21_), .b(x0), .c(new_n86_), .d(new_n87_), .O(z3));
  nor2   g122(.a(x4), .b(x3), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(x7), .c(x5), .O(new_n140_));
  oai21  g124(.a(x7), .b(x5), .c(new_n140_), .O(new_n141_));
  nand2  g125(.a(new_n141_), .b(new_n34_), .O(new_n142_));
  nand3  g126(.a(new_n25_), .b(x4), .c(new_n87_), .O(new_n143_));
  nor2   g127(.a(x7), .b(new_n25_), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(x2), .c(x1), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(x3), .O(new_n147_));
  aoi21  g131(.a(new_n62_), .b(x5), .c(new_n87_), .O(new_n148_));
  nand2  g132(.a(new_n111_), .b(new_n144_), .O(new_n149_));
  inv1   g133(.a(new_n149_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n148_), .c(new_n86_), .O(new_n151_));
  nand3  g135(.a(new_n111_), .b(new_n17_), .c(x4), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n59_), .O(new_n153_));
  nand2  g137(.a(new_n153_), .b(new_n19_), .O(new_n154_));
  nand4  g138(.a(new_n154_), .b(new_n151_), .c(new_n147_), .d(new_n142_), .O(new_n155_));
  nand2  g139(.a(new_n155_), .b(x6), .O(new_n156_));
  nand3  g140(.a(new_n139_), .b(x7), .c(new_n18_), .O(new_n157_));
  nor2   g141(.a(new_n28_), .b(new_n86_), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(x8), .c(new_n17_), .O(new_n159_));
  aoi21  g143(.a(new_n159_), .b(new_n157_), .c(new_n34_), .O(new_n160_));
  nand2  g144(.a(new_n19_), .b(new_n17_), .O(new_n161_));
  nand2  g145(.a(x3), .b(x1), .O(new_n162_));
  aoi21  g146(.a(new_n162_), .b(new_n34_), .c(new_n17_), .O(new_n163_));
  oai22  g147(.a(new_n163_), .b(new_n28_), .c(new_n161_), .d(x3), .O(new_n164_));
  nand2  g148(.a(new_n164_), .b(new_n18_), .O(new_n165_));
  nand3  g149(.a(new_n139_), .b(new_n19_), .c(x7), .O(new_n166_));
  nand2  g150(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  oai21  g151(.a(new_n167_), .b(new_n160_), .c(x5), .O(new_n168_));
  oai21  g152(.a(new_n17_), .b(new_n34_), .c(x8), .O(new_n169_));
  oai21  g153(.a(new_n158_), .b(x1), .c(new_n169_), .O(new_n170_));
  nand3  g154(.a(x7), .b(x3), .c(x1), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(new_n170_), .c(x5), .O(new_n172_));
  oai21  g156(.a(new_n18_), .b(new_n34_), .c(x3), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(x8), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(x7), .c(new_n28_), .O(new_n175_));
  oai21  g159(.a(new_n161_), .b(x6), .c(new_n175_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(x1), .c(new_n172_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n168_), .c(new_n156_), .O(new_n178_));
  nand3  g162(.a(new_n178_), .b(x9), .c(x0), .O(new_n179_));
  inv1   g163(.a(new_n179_), .O(z4));
  nand2  g164(.a(x2), .b(x0), .O(new_n181_));
  nand3  g165(.a(new_n21_), .b(new_n34_), .c(new_n49_), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n181_), .c(new_n136_), .O(z5));
endmodule
