...
module FAU ( 
  ...
  nand2  g115(.a(new_n131_), .b(new_n61_), .O(z2));
  nand2  g116(.a(x3), .b(x1), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n61_), .O(z3));
  oai21  g118(.a(x8), .b(new_n18_), .c(new_n102_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(x3), .O(new_n136_));
  nand3  g120(.a(new_n20_), .b(x2), .c(x1), .O(new_n137_));
  aoi21  g121(.a(new_n137_), .b(new_n136_), .c(x5), .O(new_n138_));
  nand2  g122(.a(new_n133_), .b(new_n94_), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(x7), .c(new_n33_), .O(new_n140_));
  oai21  g124(.a(new_n140_), .b(new_n138_), .c(x4), .O(new_n141_));
  nand3  g125(.a(x5), .b(new_n19_), .c(new_n99_), .O(new_n142_));
  oai21  g126(.a(x5), .b(new_n82_), .c(new_n142_), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n101_), .O(new_n144_));
  nand3  g128(.a(new_n20_), .b(new_n31_), .c(x1), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  oai21  g130(.a(x4), .b(new_n82_), .c(x3), .O(new_n147_));
  nand4  g131(.a(new_n147_), .b(new_n20_), .c(x5), .d(new_n18_), .O(new_n148_));
  nand4  g132(.a(new_n123_), .b(x7), .c(x3), .d(x1), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(new_n148_), .c(new_n73_), .O(new_n150_));
  aoi21  g134(.a(new_n146_), .b(x0), .c(new_n150_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n141_), .c(new_n25_), .O(z4));
  xor2a  g136(.a(x2), .b(x0), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n131_), .c(new_n61_), .O(z5));
endmodule
