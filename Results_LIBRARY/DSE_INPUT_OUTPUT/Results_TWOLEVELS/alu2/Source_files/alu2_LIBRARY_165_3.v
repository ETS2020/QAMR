...
module FAU ( 
  ...
  aoi21  g128(.a(x9), .b(x0), .c(new_n144_), .O(z2));
  nand2  g129(.a(x9), .b(x0), .O(new_n146_));
  nand3  g130(.a(new_n146_), .b(x3), .c(x1), .O(new_n147_));
  inv1   g131(.a(new_n147_), .O(z3));
  nand2  g132(.a(new_n23_), .b(x2), .O(new_n149_));
  aoi21  g133(.a(new_n149_), .b(new_n131_), .c(new_n92_), .O(new_n150_));
  nand2  g134(.a(new_n23_), .b(x3), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n47_), .c(new_n46_), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(new_n150_), .c(new_n17_), .O(new_n153_));
  nand3  g137(.a(new_n19_), .b(x6), .c(x3), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(new_n17_), .c(x1), .O(new_n155_));
  nand2  g139(.a(new_n18_), .b(new_n75_), .O(new_n156_));
  nand2  g140(.a(new_n19_), .b(x3), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n156_), .c(new_n17_), .O(new_n158_));
  nor2   g142(.a(new_n158_), .b(new_n155_), .O(new_n159_));
  nand2  g143(.a(new_n159_), .b(new_n153_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(x4), .O(new_n161_));
  aoi21  g145(.a(new_n95_), .b(new_n47_), .c(new_n17_), .O(new_n162_));
  aoi21  g146(.a(x5), .b(x4), .c(new_n19_), .O(new_n163_));
  aoi22  g147(.a(new_n163_), .b(new_n18_), .c(new_n162_), .d(new_n46_), .O(new_n164_));
  nand3  g148(.a(x7), .b(x5), .c(new_n22_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(new_n113_), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(x6), .c(new_n75_), .O(new_n167_));
  oai21  g151(.a(new_n164_), .b(new_n75_), .c(new_n167_), .O(new_n168_));
  nand4  g152(.a(x5), .b(new_n75_), .c(new_n46_), .d(new_n92_), .O(new_n169_));
  oai21  g153(.a(x8), .b(x5), .c(new_n169_), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n19_), .c(x6), .O(new_n171_));
  aoi21  g155(.a(new_n118_), .b(x6), .c(x8), .O(new_n172_));
  nand4  g156(.a(new_n172_), .b(x5), .c(new_n75_), .d(new_n46_), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(new_n171_), .c(new_n26_), .O(new_n174_));
  aoi21  g158(.a(new_n168_), .b(x1), .c(new_n174_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n161_), .c(new_n27_), .O(z4));
  nand2  g160(.a(new_n46_), .b(new_n26_), .O(new_n177_));
  nand3  g161(.a(new_n27_), .b(x2), .c(x0), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(new_n177_), .c(new_n144_), .O(z5));
endmodule
