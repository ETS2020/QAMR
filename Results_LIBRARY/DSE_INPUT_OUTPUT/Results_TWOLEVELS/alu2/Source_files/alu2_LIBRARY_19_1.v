...
module FAU ( 
  ...
  nand3  g023(.a(new_n39_), .b(new_n18_), .c(x6), .O(new_n40_));
  ...
  nand3  g064(.a(new_n32_), .b(new_n25_), .c(x1), .O(new_n81_));
  inv1   g065(.a(new_n81_), .O(new_n82_));
  oai21  g066(.a(new_n82_), .b(new_n80_), .c(new_n18_), .O(new_n83_));
  inv1   g067(.a(new_n33_), .O(new_n84_));
  nor2   g068(.a(x5), .b(new_n20_), .O(new_n85_));
  oai21  g069(.a(x8), .b(new_n25_), .c(x9), .O(new_n86_));
  aoi22  g070(.a(new_n86_), .b(x1), .c(new_n85_), .d(new_n84_), .O(new_n87_));
  nand3  g071(.a(new_n87_), .b(new_n83_), .c(new_n77_), .O(new_n88_));
  nand3  g072(.a(x3), .b(new_n20_), .c(new_n73_), .O(new_n89_));
  nand3  g073(.a(x9), .b(new_n18_), .c(new_n25_), .O(new_n90_));
  oai22  g074(.a(new_n90_), .b(new_n89_), .c(new_n18_), .d(new_n73_), .O(new_n91_));
  nand2  g075(.a(new_n91_), .b(x0), .O(new_n92_));
  nor2   g076(.a(x5), .b(new_n72_), .O(new_n93_));
  nand4  g077(.a(new_n93_), .b(new_n39_), .c(new_n18_), .d(new_n73_), .O(new_n94_));
  nand2  g078(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  aoi21  g079(.a(new_n88_), .b(new_n72_), .c(new_n95_), .O(new_n96_));
  nand3  g080(.a(x5), .b(new_n26_), .c(x3), .O(new_n97_));
  aoi21  g081(.a(new_n97_), .b(new_n18_), .c(new_n73_), .O(new_n98_));
  nand3  g082(.a(new_n18_), .b(new_n26_), .c(new_n73_), .O(new_n99_));
  aoi21  g083(.a(new_n99_), .b(x5), .c(x3), .O(new_n100_));
  oai21  g084(.a(new_n100_), .b(new_n98_), .c(new_n21_), .O(new_n101_));
  oai21  g085(.a(new_n96_), .b(new_n26_), .c(new_n101_), .O(new_n102_));
  nand2  g086(.a(new_n102_), .b(x6), .O(new_n103_));
  aoi21  g087(.a(x7), .b(x2), .c(new_n53_), .O(new_n104_));
  nand2  g088(.a(new_n53_), .b(x2), .O(new_n105_));
  oai21  g089(.a(new_n104_), .b(new_n38_), .c(new_n105_), .O(new_n106_));
  nand4  g090(.a(x7), .b(x3), .c(new_n20_), .d(new_n38_), .O(new_n107_));
  inv1   g091(.a(new_n107_), .O(new_n108_));
  aoi21  g092(.a(new_n106_), .b(new_n72_), .c(new_n108_), .O(new_n109_));
  nand2  g093(.a(x3), .b(x2), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n25_), .c(x0), .O(new_n111_));
  nand3  g095(.a(new_n17_), .b(x3), .c(new_n20_), .O(new_n112_));
  inv1   g096(.a(new_n112_), .O(new_n113_));
  oai21  g097(.a(new_n113_), .b(new_n111_), .c(x8), .O(new_n114_));
  oai21  g098(.a(new_n109_), .b(x5), .c(new_n114_), .O(new_n115_));
  nand3  g099(.a(new_n115_), .b(x9), .c(x4), .O(new_n116_));
  oai21  g100(.a(new_n18_), .b(x5), .c(x4), .O(new_n117_));
  nand3  g101(.a(new_n117_), .b(new_n17_), .c(x3), .O(new_n118_));
  aoi21  g102(.a(new_n18_), .b(new_n72_), .c(new_n26_), .O(new_n119_));
  oai21  g103(.a(new_n119_), .b(x5), .c(new_n118_), .O(new_n120_));
  ...
  aoi21  g108(.a(new_n124_), .b(new_n33_), .c(new_n38_), .O(new_n125_));
  nand2  g109(.a(new_n20_), .b(new_n38_), .O(new_n126_));
  oai22  g110(.a(new_n126_), .b(new_n31_), .c(new_n33_), .d(new_n20_), .O(new_n127_));
  oai21  g111(.a(new_n127_), .b(new_n125_), .c(x3), .O(new_n128_));
  oai21  g112(.a(x5), .b(x2), .c(new_n32_), .O(new_n129_));
  nand3  g113(.a(new_n129_), .b(new_n17_), .c(new_n38_), .O(new_n130_));
  nand3  g114(.a(x8), .b(new_n20_), .c(x0), .O(new_n131_));
  nand2  g115(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand2  g116(.a(new_n132_), .b(new_n72_), .O(new_n133_));
  inv1   g117(.a(new_n31_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n17_), .O(new_n135_));
  nand3  g119(.a(new_n135_), .b(new_n133_), .c(new_n128_), .O(new_n136_));
  nand3  g120(.a(new_n84_), .b(x5), .c(x3), .O(new_n137_));
  inv1   g121(.a(new_n137_), .O(new_n138_));
  aoi21  g122(.a(new_n136_), .b(x9), .c(new_n138_), .O(new_n139_));
  xnor2a g123(.a(x5), .b(x3), .O(new_n140_));
  nand3  g124(.a(new_n140_), .b(new_n21_), .c(x7), .O(new_n141_));
  oai21  g125(.a(new_n139_), .b(new_n26_), .c(new_n141_), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(x1), .O(new_n143_));
  nand3  g127(.a(new_n18_), .b(x3), .c(new_n38_), .O(new_n144_));
  nand3  g128(.a(x8), .b(x5), .c(new_n72_), .O(new_n145_));
  aoi21  g129(.a(new_n145_), .b(new_n144_), .c(x2), .O(new_n146_));
  nand2  g130(.a(x8), .b(x3), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n25_), .c(x7), .O(new_n148_));
  oai21  g132(.a(new_n148_), .b(new_n146_), .c(new_n17_), .O(new_n149_));
  nand4  g133(.a(new_n134_), .b(x5), .c(x3), .d(x2), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n149_), .c(new_n21_), .O(new_n151_));
  nor2   g135(.a(x4), .b(new_n72_), .O(new_n152_));
  aoi22  g136(.a(new_n152_), .b(new_n28_), .c(new_n151_), .d(x4), .O(new_n153_));
  nand4  g137(.a(new_n153_), .b(new_n143_), .c(new_n123_), .d(new_n103_), .O(z1));
  xor2a  g138(.a(x3), .b(x1), .O(new_n155_));
  nor2   g139(.a(new_n155_), .b(new_n66_), .O(z2));
  nor3   g140(.a(new_n66_), .b(new_n72_), .c(new_n73_), .O(z3));
  oai21  g141(.a(x3), .b(new_n73_), .c(x2), .O(new_n158_));
  aoi22  g142(.a(new_n17_), .b(x4), .c(x3), .d(new_n38_), .O(new_n159_));
  aoi21  g143(.a(new_n159_), .b(new_n158_), .c(x7), .O(new_n160_));
  aoi21  g144(.a(new_n17_), .b(new_n72_), .c(new_n73_), .O(new_n161_));
  nand2  g145(.a(x3), .b(x1), .O(new_n162_));
  nand3  g146(.a(new_n162_), .b(new_n17_), .c(new_n20_), .O(new_n163_));
  oai21  g147(.a(new_n161_), .b(x0), .c(new_n163_), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n160_), .c(x5), .O(new_n165_));
  nand2  g149(.a(x7), .b(x2), .O(new_n166_));
  aoi21  g150(.a(new_n166_), .b(x8), .c(new_n38_), .O(new_n167_));
  nand2  g151(.a(x7), .b(x3), .O(new_n168_));
  nand2  g152(.a(new_n32_), .b(x2), .O(new_n169_));
  nand2  g153(.a(x6), .b(new_n72_), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n169_), .c(new_n168_), .O(new_n171_));
  oai21  g155(.a(new_n171_), .b(new_n167_), .c(x1), .O(new_n172_));
  oai21  g156(.a(new_n18_), .b(new_n38_), .c(x8), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(x2), .O(new_n174_));
  oai21  g158(.a(new_n18_), .b(new_n17_), .c(x8), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x0), .O(new_n176_));
  nand3  g160(.a(new_n18_), .b(x6), .c(new_n73_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n176_), .c(new_n174_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(x3), .O(new_n179_));
  aoi21  g163(.a(new_n20_), .b(x0), .c(new_n32_), .O(new_n180_));
  oai21  g164(.a(new_n20_), .b(x0), .c(new_n180_), .O(new_n181_));
  nand3  g165(.a(new_n181_), .b(new_n18_), .c(x6), .O(new_n182_));
  nand3  g166(.a(new_n182_), .b(new_n179_), .c(new_n172_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n25_), .c(new_n26_), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n165_), .c(new_n21_), .O(z4));
  nand2  g169(.a(x2), .b(x0), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n126_), .c(new_n155_), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n67_), .O(new_n188_));
