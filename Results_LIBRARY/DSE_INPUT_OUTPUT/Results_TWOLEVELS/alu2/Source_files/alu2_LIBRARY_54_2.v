...
module FAU ( 
  ...
  nand2  g189(.a(new_n91_), .b(x4), .O(new_n206_));
  ...
  nand2  g194(.a(new_n40_), .b(new_n18_), .O(new_n211_));
  aoi21  g195(.a(new_n211_), .b(new_n107_), .c(new_n207_), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(x6), .O(new_n213_));
  oai22  g197(.a(x3), .b(new_n18_), .c(x2), .d(new_n141_), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n19_), .c(x4), .O(new_n215_));
  oai21  g199(.a(new_n215_), .b(x6), .c(new_n213_), .O(new_n216_));
  nand2  g200(.a(new_n216_), .b(new_n25_), .O(new_n217_));
  aoi22  g201(.a(new_n19_), .b(new_n40_), .c(x6), .d(new_n92_), .O(new_n218_));
  nand2  g202(.a(x6), .b(new_n40_), .O(new_n219_));
  nand3  g203(.a(new_n219_), .b(new_n66_), .c(x8), .O(new_n220_));
  nand3  g204(.a(new_n220_), .b(new_n92_), .c(x0), .O(new_n221_));
  oai21  g205(.a(new_n218_), .b(new_n141_), .c(new_n221_), .O(new_n222_));
  nand3  g206(.a(new_n222_), .b(x7), .c(new_n52_), .O(new_n223_));
  nand4  g207(.a(new_n137_), .b(new_n19_), .c(new_n92_), .d(new_n40_), .O(new_n224_));
  nand3  g208(.a(new_n224_), .b(new_n223_), .c(new_n217_), .O(new_n225_));
  nand3  g209(.a(x7), .b(new_n52_), .c(x1), .O(new_n226_));
  nand2  g210(.a(new_n226_), .b(new_n86_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(new_n40_), .O(new_n228_));
  nand3  g212(.a(new_n19_), .b(new_n31_), .c(new_n52_), .O(new_n229_));
  aoi21  g213(.a(new_n229_), .b(new_n228_), .c(new_n24_), .O(new_n230_));
  oai22  g214(.a(x8), .b(x4), .c(x5), .d(new_n40_), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(x7), .O(new_n232_));
  nand2  g216(.a(new_n32_), .b(new_n24_), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n232_), .c(new_n141_), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n230_), .c(x0), .O(new_n235_));
  nand4  g219(.a(x7), .b(new_n24_), .c(new_n52_), .d(x3), .O(new_n236_));
  nand2  g220(.a(new_n31_), .b(new_n92_), .O(new_n237_));
  oai21  g221(.a(new_n237_), .b(new_n47_), .c(new_n236_), .O(new_n238_));
  aoi21  g222(.a(new_n238_), .b(x1), .c(new_n144_), .O(new_n239_));
  nand2  g223(.a(new_n239_), .b(new_n235_), .O(new_n240_));
  aoi21  g224(.a(new_n225_), .b(x5), .c(new_n240_), .O(new_n241_));
  oai21  g225(.a(x6), .b(x3), .c(x1), .O(new_n242_));
  nand2  g226(.a(new_n242_), .b(new_n18_), .O(new_n243_));
  nand3  g227(.a(new_n209_), .b(new_n24_), .c(new_n40_), .O(new_n244_));
  nand3  g228(.a(new_n22_), .b(x3), .c(x2), .O(new_n245_));
  nand3  g229(.a(new_n245_), .b(new_n244_), .c(new_n243_), .O(new_n246_));
  ...
  oai21  g246(.a(new_n241_), .b(new_n91_), .c(new_n262_), .O(z4));
  nand2  g247(.a(new_n212_), .b(new_n206_), .O(new_n264_));
