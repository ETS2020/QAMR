...
module FAU ( 
  ...
  oai21  g066(.a(x8), .b(new_n25_), .c(x9), .O(new_n83_));
  ...
  nand3  g070(.a(x3), .b(new_n20_), .c(new_n73_), .O(new_n87_));
  nand3  g071(.a(x9), .b(new_n18_), .c(new_n25_), .O(new_n88_));
  oai22  g072(.a(new_n88_), .b(new_n87_), .c(new_n18_), .d(new_n73_), .O(new_n89_));
  nand2  g073(.a(x7), .b(x2), .O(new_n90_));
  nand2  g074(.a(x3), .b(new_n73_), .O(new_n91_));
  oai22  g075(.a(new_n91_), .b(new_n88_), .c(new_n90_), .d(new_n73_), .O(new_n92_));
  ...
  oai21  g085(.a(x8), .b(x6), .c(new_n90_), .O(new_n102_));
  ...
  oai21  g092(.a(new_n108_), .b(new_n106_), .c(new_n71_), .O(new_n109_));
  ...
  nand2  g103(.a(new_n72_), .b(x4), .O(new_n120_));
  nand3  g104(.a(new_n120_), .b(new_n17_), .c(x3), .O(new_n121_));
  aoi21  g105(.a(new_n18_), .b(new_n71_), .c(new_n26_), .O(new_n122_));
  ...
  oai21  g114(.a(x5), .b(x2), .c(new_n32_), .O(new_n131_));
  nand3  g115(.a(new_n131_), .b(new_n17_), .c(new_n38_), .O(new_n132_));
  nand3  g116(.a(x8), .b(new_n20_), .c(x0), .O(new_n133_));
  nand2  g117(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n71_), .O(new_n135_));
  ...
  nand3  g130(.a(x8), .b(x5), .c(new_n71_), .O(new_n147_));
  ...
  nor2   g137(.a(x4), .b(new_n71_), .O(new_n154_));
  aoi22  g138(.a(new_n154_), .b(new_n28_), .c(new_n153_), .d(x4), .O(new_n155_));
  nand4  g139(.a(new_n155_), .b(new_n145_), .c(new_n126_), .d(new_n101_), .O(z1));
  nor3   g140(.a(new_n65_), .b(new_n71_), .c(new_n73_), .O(z3));
  inv1   g141(.a(z3), .O(new_n158_));
  nor2   g142(.a(x3), .b(x1), .O(new_n159_));
  nor2   g143(.a(new_n159_), .b(new_n65_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(new_n158_), .O(z2));
  oai21  g145(.a(x3), .b(new_n73_), .c(x2), .O(new_n162_));
  aoi22  g146(.a(new_n17_), .b(x4), .c(x3), .d(new_n38_), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n162_), .c(x7), .O(new_n164_));
  aoi21  g148(.a(new_n17_), .b(new_n71_), .c(new_n73_), .O(new_n165_));
  nor2   g149(.a(new_n71_), .b(new_n73_), .O(new_n166_));
  inv1   g150(.a(new_n166_), .O(new_n167_));
  nand3  g151(.a(new_n167_), .b(new_n17_), .c(new_n20_), .O(new_n168_));
  oai21  g152(.a(new_n165_), .b(x0), .c(new_n168_), .O(new_n169_));
  oai21  g153(.a(new_n169_), .b(new_n164_), .c(x5), .O(new_n170_));
  aoi21  g154(.a(new_n90_), .b(x8), .c(new_n38_), .O(new_n171_));
  nand2  g155(.a(new_n32_), .b(x2), .O(new_n172_));
  nand2  g156(.a(x7), .b(x3), .O(new_n173_));
  nand2  g157(.a(x6), .b(new_n71_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(new_n173_), .c(new_n172_), .O(new_n175_));
  oai21  g159(.a(new_n175_), .b(new_n171_), .c(x1), .O(new_n176_));
  oai21  g160(.a(new_n18_), .b(new_n38_), .c(x8), .O(new_n177_));
  nand2  g161(.a(new_n177_), .b(x2), .O(new_n178_));
  oai21  g162(.a(new_n18_), .b(new_n17_), .c(x8), .O(new_n179_));
  nand2  g163(.a(new_n179_), .b(x0), .O(new_n180_));
  nand3  g164(.a(new_n18_), .b(x6), .c(new_n73_), .O(new_n181_));
  nand3  g165(.a(new_n181_), .b(new_n180_), .c(new_n178_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(x3), .O(new_n183_));
  aoi21  g167(.a(new_n20_), .b(x0), .c(new_n32_), .O(new_n184_));
  oai21  g168(.a(new_n20_), .b(x0), .c(new_n184_), .O(new_n185_));
  nand3  g169(.a(new_n185_), .b(new_n18_), .c(x6), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(new_n183_), .c(new_n176_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n25_), .c(new_n26_), .O(new_n188_));
  aoi21  g172(.a(new_n188_), .b(new_n170_), .c(new_n21_), .O(z4));
  nor2   g173(.a(new_n166_), .b(new_n159_), .O(new_n190_));
  xor2a  g174(.a(x2), .b(x0), .O(new_n191_));
  oai21  g175(.a(new_n191_), .b(new_n190_), .c(new_n66_), .O(z5));
endmodule
