...
module FAU ( 
  ...
  nand3  g106(.a(new_n122_), .b(x3), .c(x1), .O(new_n123_));
  nand2  g107(.a(new_n64_), .b(new_n70_), .O(new_n124_));
  nand3  g108(.a(new_n124_), .b(new_n123_), .c(new_n122_), .O(z2));
  inv1   g109(.a(new_n123_), .O(z3));
  ...
  nand2  g132(.a(new_n131_), .b(new_n124_), .O(new_n149_));
  nand2  g133(.a(new_n47_), .b(new_n19_), .O(new_n150_));
  nand2  g134(.a(new_n150_), .b(new_n31_), .O(new_n151_));
  nand3  g135(.a(new_n151_), .b(new_n149_), .c(new_n122_), .O(new_n152_));
