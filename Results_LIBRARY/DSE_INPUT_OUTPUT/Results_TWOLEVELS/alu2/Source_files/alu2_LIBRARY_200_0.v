...
module FAU ( 
  ...
  nand2  g185(.a(new_n17_), .b(new_n47_), .O(new_n202_));
  ...
  nand3  g190(.a(x7), .b(new_n24_), .c(new_n31_), .O(new_n207_));
  nand2  g191(.a(x3), .b(x2), .O(new_n208_));
  oai21  g192(.a(new_n208_), .b(new_n146_), .c(new_n207_), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(x1), .O(new_n210_));
  nand2  g194(.a(new_n18_), .b(new_n24_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(new_n146_), .O(new_n212_));
  nand3  g196(.a(new_n212_), .b(x2), .c(new_n100_), .O(new_n213_));
  nand4  g197(.a(x7), .b(x5), .c(new_n24_), .d(new_n31_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n213_), .O(new_n215_));
  nand2  g199(.a(new_n215_), .b(new_n75_), .O(new_n216_));
  nand3  g200(.a(x7), .b(x4), .c(x3), .O(new_n217_));
  inv1   g201(.a(new_n217_), .O(new_n218_));
  oai21  g202(.a(x7), .b(x2), .c(new_n211_), .O(new_n219_));
  oai21  g203(.a(new_n219_), .b(new_n218_), .c(new_n62_), .O(new_n220_));
  nand3  g204(.a(new_n220_), .b(new_n216_), .c(new_n210_), .O(new_n221_));
  nand2  g205(.a(x4), .b(x3), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n100_), .c(x5), .O(new_n223_));
  nand4  g207(.a(new_n20_), .b(x5), .c(new_n24_), .d(new_n75_), .O(new_n224_));
  inv1   g208(.a(new_n224_), .O(new_n225_));
  oai21  g209(.a(new_n225_), .b(new_n223_), .c(new_n196_), .O(new_n226_));
  inv1   g210(.a(new_n211_), .O(new_n227_));
  nand4  g211(.a(new_n227_), .b(x3), .c(x2), .d(x1), .O(new_n228_));
  nand2  g212(.a(new_n228_), .b(new_n226_), .O(new_n229_));
  aoi21  g213(.a(new_n221_), .b(x6), .c(new_n229_), .O(new_n230_));
  nand2  g214(.a(new_n18_), .b(x2), .O(new_n231_));
  aoi21  g215(.a(new_n231_), .b(new_n71_), .c(new_n100_), .O(new_n232_));
  nand2  g216(.a(new_n48_), .b(new_n100_), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n231_), .c(new_n75_), .O(new_n234_));
  oai21  g218(.a(new_n234_), .b(new_n232_), .c(new_n62_), .O(new_n235_));
  aoi21  g219(.a(new_n205_), .b(new_n31_), .c(new_n25_), .O(new_n236_));
  ...
  aoi21  g223(.a(new_n239_), .b(new_n235_), .c(new_n24_), .O(new_n240_));
  ...
  oai21  g233(.a(new_n230_), .b(new_n47_), .c(new_n249_), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(x9), .O(new_n251_));
  nand2  g235(.a(new_n211_), .b(new_n49_), .O(new_n252_));
  ...
  oai21  g249(.a(new_n265_), .b(new_n203_), .c(new_n202_), .O(z5));
endmodule
