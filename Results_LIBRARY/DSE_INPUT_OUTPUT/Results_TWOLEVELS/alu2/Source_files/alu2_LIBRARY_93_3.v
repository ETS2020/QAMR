...
module FAU ( 
  ...
  oai21  g139(.a(new_n70_), .b(new_n83_), .c(new_n155_), .O(z3));
  nand2  g140(.a(new_n18_), .b(new_n22_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n132_), .O(new_n158_));
  nand2  g142(.a(new_n30_), .b(x8), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n70_), .c(new_n83_), .O(new_n160_));
  nand3  g144(.a(new_n29_), .b(x3), .c(x1), .O(new_n161_));
  ...
  aoi21  g150(.a(new_n166_), .b(new_n165_), .c(new_n32_), .O(new_n167_));
  nor3   g151(.a(x8), .b(x6), .c(x2), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n167_), .c(new_n70_), .O(new_n169_));
  nand4  g153(.a(new_n30_), .b(new_n25_), .c(new_n18_), .d(x1), .O(new_n170_));
  nand3  g154(.a(new_n170_), .b(new_n169_), .c(new_n163_), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(x5), .O(new_n172_));
  oai22  g156(.a(new_n133_), .b(new_n83_), .c(new_n30_), .d(x5), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(new_n18_), .O(new_n174_));
  oai21  g158(.a(new_n32_), .b(new_n83_), .c(x8), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(x6), .c(new_n23_), .O(new_n176_));
  nand2  g160(.a(x7), .b(x2), .O(new_n177_));
  aoi21  g161(.a(new_n177_), .b(x8), .c(x6), .O(new_n178_));
  oai21  g162(.a(new_n178_), .b(new_n113_), .c(x1), .O(new_n179_));
  nand3  g163(.a(new_n179_), .b(new_n176_), .c(new_n174_), .O(new_n180_));
  nand3  g164(.a(new_n29_), .b(new_n23_), .c(new_n70_), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n139_), .O(new_n182_));
  nand2  g166(.a(new_n182_), .b(x1), .O(new_n183_));
  nor2   g167(.a(x8), .b(x7), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n62_), .c(x4), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n183_), .O(new_n186_));
  aoi21  g170(.a(new_n180_), .b(x0), .c(new_n186_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n172_), .c(new_n17_), .O(z4));
  inv1   g172(.a(new_n153_), .O(new_n189_));
  nand3  g173(.a(new_n158_), .b(new_n189_), .c(new_n155_), .O(new_n190_));
