...
module FAU ( 
  ...
  nand4  g078(.a(x7), .b(new_n19_), .c(x2), .d(x0), .O(new_n95_));
  nand3  g079(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(new_n96_));
  oai21  g080(.a(new_n96_), .b(new_n85_), .c(x3), .O(new_n97_));
  ...
  nand3  g088(.a(new_n104_), .b(x1), .c(new_n17_), .O(new_n105_));
  inv1   g089(.a(new_n105_), .O(new_n106_));
  oai21  g090(.a(new_n106_), .b(new_n103_), .c(new_n32_), .O(new_n107_));
  nand2  g091(.a(x5), .b(x4), .O(new_n108_));
  inv1   g092(.a(new_n108_), .O(new_n109_));
  oai21  g093(.a(new_n109_), .b(x1), .c(new_n17_), .O(new_n110_));
  ...
  aoi21  g100(.a(new_n116_), .b(new_n107_), .c(new_n27_), .O(new_n117_));
  ...
  oai21  g106(.a(new_n122_), .b(new_n117_), .c(new_n98_), .O(new_n123_));
  aoi21  g107(.a(new_n19_), .b(x2), .c(new_n68_), .O(new_n124_));
  oai21  g108(.a(new_n124_), .b(x0), .c(new_n20_), .O(new_n125_));
  aoi21  g109(.a(new_n125_), .b(x1), .c(new_n109_), .O(new_n126_));
  oai21  g110(.a(new_n126_), .b(x7), .c(new_n61_), .O(new_n127_));
  nand2  g111(.a(new_n19_), .b(new_n67_), .O(new_n128_));
  oai22  g112(.a(new_n128_), .b(new_n33_), .c(new_n58_), .d(new_n67_), .O(new_n129_));
  aoi21  g113(.a(new_n127_), .b(x9), .c(new_n129_), .O(new_n130_));
  nand3  g114(.a(new_n130_), .b(new_n123_), .c(new_n97_), .O(z1));
  nor2   g115(.a(new_n98_), .b(new_n67_), .O(new_n132_));
  nor2   g116(.a(x3), .b(x1), .O(new_n133_));
  nor2   g117(.a(new_n133_), .b(new_n132_), .O(new_n134_));
  nor2   g118(.a(new_n134_), .b(new_n62_), .O(z2));
  oai21  g119(.a(new_n98_), .b(new_n67_), .c(new_n63_), .O(z3));
  oai21  g120(.a(x8), .b(new_n18_), .c(new_n101_), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(new_n32_), .c(x3), .O(new_n138_));
  nand2  g122(.a(x8), .b(new_n98_), .O(new_n139_));
  aoi21  g123(.a(new_n139_), .b(x1), .c(x0), .O(new_n140_));
  oai21  g124(.a(new_n132_), .b(x2), .c(x7), .O(new_n141_));
  oai21  g125(.a(new_n141_), .b(new_n140_), .c(x5), .O(new_n142_));
  nor2   g126(.a(x8), .b(x3), .O(new_n143_));
  nand4  g127(.a(new_n143_), .b(x2), .c(x1), .d(new_n17_), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(new_n142_), .c(new_n138_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(x4), .O(new_n146_));
  nand3  g130(.a(x5), .b(new_n19_), .c(new_n98_), .O(new_n147_));
  oai21  g131(.a(x5), .b(new_n67_), .c(new_n147_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(x7), .c(x2), .O(new_n149_));
  oai21  g133(.a(new_n25_), .b(new_n32_), .c(x1), .O(new_n150_));
  oai21  g134(.a(new_n112_), .b(x3), .c(new_n150_), .O(new_n151_));
  nand2  g135(.a(new_n151_), .b(new_n20_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  oai21  g137(.a(x7), .b(new_n67_), .c(x3), .O(new_n154_));
  nand4  g138(.a(new_n154_), .b(new_n20_), .c(x5), .d(new_n18_), .O(new_n155_));
  nand4  g139(.a(new_n108_), .b(x7), .c(x3), .d(x1), .O(new_n156_));
  nand3  g140(.a(new_n156_), .b(new_n155_), .c(new_n61_), .O(new_n157_));
  aoi21  g141(.a(new_n153_), .b(x0), .c(new_n157_), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n146_), .c(new_n27_), .O(z4));
  inv1   g143(.a(new_n134_), .O(new_n160_));
  xnor2a g144(.a(x2), .b(x0), .O(new_n161_));
  nand3  g145(.a(new_n161_), .b(new_n160_), .c(new_n63_), .O(new_n162_));
