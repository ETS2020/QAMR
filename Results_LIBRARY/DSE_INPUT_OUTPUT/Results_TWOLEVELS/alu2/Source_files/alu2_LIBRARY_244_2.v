...
module FAU ( 
  ...
  oai21  g187(.a(new_n100_), .b(new_n47_), .c(new_n203_), .O(z3));
  nand3  g188(.a(x7), .b(new_n22_), .c(new_n46_), .O(new_n205_));
  nand2  g189(.a(new_n24_), .b(new_n47_), .O(new_n206_));
  nand2  g190(.a(new_n206_), .b(new_n205_), .O(new_n207_));
  nand3  g191(.a(new_n207_), .b(x2), .c(x0), .O(new_n208_));
  nor2   g192(.a(x6), .b(new_n46_), .O(new_n209_));
  nor2   g193(.a(new_n97_), .b(x1), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n209_), .c(new_n28_), .O(new_n211_));
  nand2  g195(.a(x8), .b(new_n46_), .O(new_n212_));
  nand3  g196(.a(new_n212_), .b(new_n22_), .c(new_n17_), .O(new_n213_));
  nand3  g197(.a(new_n213_), .b(new_n211_), .c(new_n208_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(x9), .O(new_n215_));
  nand3  g199(.a(x7), .b(new_n46_), .c(new_n17_), .O(new_n216_));
  nand3  g200(.a(new_n30_), .b(x2), .c(new_n47_), .O(new_n217_));
  aoi21  g201(.a(new_n217_), .b(new_n216_), .c(new_n28_), .O(new_n218_));
  nand4  g202(.a(new_n30_), .b(new_n17_), .c(new_n47_), .d(new_n28_), .O(new_n219_));
  nand3  g203(.a(x7), .b(new_n46_), .c(x1), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n219_), .O(new_n221_));
  oai21  g205(.a(new_n221_), .b(new_n218_), .c(x6), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n215_), .c(x3), .O(new_n223_));
  nand2  g207(.a(x4), .b(new_n47_), .O(new_n224_));
  nand4  g208(.a(new_n39_), .b(x3), .c(new_n17_), .d(x1), .O(new_n225_));
  ...
  nand2  g212(.a(new_n122_), .b(x2), .O(new_n229_));
  aoi21  g213(.a(new_n229_), .b(new_n228_), .c(new_n46_), .O(new_n230_));
  oai21  g214(.a(new_n230_), .b(new_n226_), .c(x9), .O(new_n231_));
  nor2   g215(.a(new_n17_), .b(new_n28_), .O(new_n232_));
  nor2   g216(.a(new_n232_), .b(new_n121_), .O(new_n233_));
  nor2   g217(.a(new_n233_), .b(x7), .O(new_n234_));
  nand4  g218(.a(new_n234_), .b(x6), .c(x3), .d(x1), .O(new_n235_));
  nand2  g219(.a(new_n235_), .b(new_n231_), .O(new_n236_));
  oai21  g220(.a(new_n236_), .b(new_n223_), .c(x5), .O(new_n237_));
  nand2  g221(.a(new_n220_), .b(new_n56_), .O(new_n238_));
  oai21  g222(.a(new_n30_), .b(x3), .c(x5), .O(new_n239_));
  nand3  g223(.a(new_n239_), .b(new_n18_), .c(new_n46_), .O(new_n240_));
  nand3  g224(.a(new_n54_), .b(x4), .c(x3), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(new_n240_), .O(new_n242_));
  aoi21  g226(.a(new_n238_), .b(new_n17_), .c(new_n242_), .O(new_n243_));
  nor2   g227(.a(new_n243_), .b(new_n22_), .O(new_n244_));
  oai21  g228(.a(new_n30_), .b(new_n17_), .c(x8), .O(new_n245_));
  oai21  g229(.a(new_n46_), .b(new_n100_), .c(new_n47_), .O(new_n246_));
  nand3  g230(.a(new_n246_), .b(new_n245_), .c(new_n29_), .O(new_n247_));
  nand2  g231(.a(new_n178_), .b(x6), .O(new_n248_));
  nand4  g232(.a(new_n248_), .b(new_n18_), .c(new_n46_), .d(x1), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(new_n247_), .c(new_n90_), .O(new_n250_));
  oai21  g234(.a(new_n250_), .b(new_n244_), .c(x0), .O(new_n251_));
  nand4  g235(.a(new_n69_), .b(x9), .c(new_n22_), .d(x3), .O(new_n252_));
  nand3  g236(.a(x6), .b(new_n29_), .c(x4), .O(new_n253_));
  nand2  g237(.a(new_n253_), .b(new_n252_), .O(new_n254_));
  nand2  g238(.a(new_n254_), .b(x7), .O(new_n255_));
  nand4  g239(.a(x9), .b(new_n18_), .c(x4), .d(x2), .O(new_n256_));
  oai21  g240(.a(new_n31_), .b(x3), .c(new_n256_), .O(new_n257_));
  nand2  g241(.a(new_n257_), .b(new_n29_), .O(new_n258_));
  aoi21  g242(.a(new_n258_), .b(new_n255_), .c(new_n47_), .O(new_n259_));
  inv1   g243(.a(new_n31_), .O(new_n260_));
  nand2  g244(.a(new_n260_), .b(new_n28_), .O(new_n261_));
  nand3  g245(.a(x9), .b(new_n18_), .c(x3), .O(new_n262_));
  aoi21  g246(.a(new_n262_), .b(new_n261_), .c(new_n17_), .O(new_n263_));
  nand3  g247(.a(new_n260_), .b(x3), .c(new_n47_), .O(new_n264_));
  inv1   g248(.a(new_n264_), .O(new_n265_));
  oai21  g249(.a(new_n265_), .b(new_n263_), .c(x4), .O(new_n266_));
  aoi21  g250(.a(new_n266_), .b(new_n25_), .c(x5), .O(new_n267_));
  nor3   g251(.a(new_n267_), .b(new_n259_), .c(new_n200_), .O(new_n268_));
  nand3  g252(.a(new_n268_), .b(new_n251_), .c(new_n237_), .O(z4));
  nor2   g253(.a(new_n233_), .b(new_n201_), .O(new_n270_));
  nand2  g254(.a(new_n270_), .b(new_n203_), .O(new_n271_));
