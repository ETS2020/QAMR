...
module FAU ( 
  ...
  nor2   g049(.a(new_n20_), .b(new_n23_), .O(new_n66_));
  aoi21  g050(.a(new_n65_), .b(x0), .c(new_n66_), .O(new_n67_));
  nand3  g051(.a(new_n67_), .b(new_n63_), .c(new_n57_), .O(new_n68_));
  aoi21  g052(.a(new_n53_), .b(x2), .c(new_n68_), .O(new_n69_));
  nand2  g053(.a(new_n69_), .b(new_n45_), .O(z0));
  ...
  oai21  g061(.a(new_n35_), .b(x2), .c(new_n77_), .O(new_n78_));
  nand3  g062(.a(new_n36_), .b(x4), .c(x2), .O(new_n79_));
  inv1   g063(.a(new_n79_), .O(new_n80_));
  aoi21  g064(.a(new_n78_), .b(new_n17_), .c(new_n80_), .O(new_n81_));
  ...
  oai21  g069(.a(new_n85_), .b(new_n82_), .c(new_n72_), .O(new_n86_));
  ...
  aoi21  g075(.a(new_n91_), .b(new_n41_), .c(new_n72_), .O(new_n92_));
  aoi21  g076(.a(new_n36_), .b(x0), .c(new_n20_), .O(new_n93_));
  aoi21  g077(.a(new_n93_), .b(new_n73_), .c(x5), .O(new_n94_));
  oai21  g078(.a(new_n94_), .b(new_n92_), .c(new_n27_), .O(new_n95_));
  oai21  g079(.a(new_n72_), .b(x0), .c(new_n31_), .O(new_n96_));
  nand3  g080(.a(new_n96_), .b(x8), .c(x2), .O(new_n97_));
  nand2  g081(.a(new_n55_), .b(x8), .O(new_n98_));
  nand4  g082(.a(new_n98_), .b(x6), .c(new_n31_), .d(x3), .O(new_n99_));
  aoi21  g083(.a(new_n99_), .b(new_n97_), .c(new_n20_), .O(new_n100_));
  nand4  g084(.a(x7), .b(new_n19_), .c(new_n31_), .d(x3), .O(new_n101_));
  ...
  nand2  g088(.a(new_n104_), .b(new_n71_), .O(new_n105_));
  ...
  aoi22  g093(.a(new_n109_), .b(new_n87_), .c(new_n26_), .d(x4), .O(new_n110_));
  ...
  nor2   g100(.a(new_n72_), .b(x2), .O(new_n117_));
  aoi21  g101(.a(new_n117_), .b(new_n17_), .c(new_n19_), .O(new_n118_));
  aoi21  g102(.a(new_n118_), .b(new_n116_), .c(new_n87_), .O(new_n119_));
  oai21  g103(.a(new_n31_), .b(new_n72_), .c(x6), .O(new_n120_));
  ...
  nand2  g111(.a(new_n62_), .b(new_n72_), .O(new_n128_));
  ...
  nand2  g117(.a(x8), .b(new_n19_), .O(new_n134_));
  ...
  oai21  g122(.a(new_n61_), .b(new_n27_), .c(new_n23_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(x9), .O(new_n140_));
  nand3  g124(.a(new_n140_), .b(new_n138_), .c(new_n128_), .O(new_n141_));
  aoi21  g125(.a(new_n127_), .b(x1), .c(new_n141_), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n105_), .O(z1));
  inv1   g127(.a(new_n66_), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(x3), .c(x1), .O(new_n145_));
  nor2   g129(.a(x3), .b(x1), .O(new_n146_));
  inv1   g130(.a(new_n146_), .O(new_n147_));
  nand3  g131(.a(new_n147_), .b(new_n145_), .c(new_n144_), .O(z2));
  inv1   g132(.a(new_n145_), .O(z3));
  nand2  g133(.a(x8), .b(x3), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(x1), .c(x0), .O(new_n151_));
  nand2  g135(.a(x8), .b(x2), .O(new_n152_));
  oai21  g136(.a(new_n152_), .b(x1), .c(x6), .O(new_n153_));
  oai21  g137(.a(new_n153_), .b(new_n151_), .c(x4), .O(new_n154_));
  nand2  g138(.a(x3), .b(x1), .O(new_n155_));
  xor2a  g139(.a(x2), .b(x0), .O(new_n156_));
  aoi21  g140(.a(new_n155_), .b(new_n147_), .c(new_n156_), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(x6), .O(new_n158_));
  nand2  g142(.a(new_n146_), .b(new_n17_), .O(new_n159_));
  nand2  g143(.a(new_n19_), .b(x1), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n159_), .c(x2), .O(new_n161_));
  nand3  g145(.a(new_n19_), .b(new_n72_), .c(x0), .O(new_n162_));
  inv1   g146(.a(new_n162_), .O(new_n163_));
  oai21  g147(.a(new_n163_), .b(new_n161_), .c(new_n87_), .O(new_n164_));
  nand3  g148(.a(new_n164_), .b(new_n158_), .c(new_n154_), .O(new_n165_));
  nand2  g149(.a(new_n165_), .b(x5), .O(new_n166_));
  nand2  g150(.a(x4), .b(x3), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(new_n71_), .c(new_n17_), .O(new_n168_));
  ...
  inv1   g155(.a(new_n167_), .O(new_n172_));
  aoi22  g156(.a(new_n172_), .b(x2), .c(x6), .d(new_n31_), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n171_), .c(x8), .O(new_n174_));
  aoi22  g158(.a(x3), .b(new_n71_), .c(x2), .d(new_n17_), .O(new_n175_));
  aoi22  g159(.a(new_n72_), .b(x1), .c(new_n18_), .d(x0), .O(new_n176_));
  oai21  g160(.a(new_n175_), .b(new_n27_), .c(new_n176_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(x6), .c(new_n31_), .O(new_n178_));
  nand2  g162(.a(new_n178_), .b(new_n23_), .O(new_n179_));
  nor2   g163(.a(new_n179_), .b(new_n174_), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n166_), .c(new_n20_), .O(z4));
  nand2  g165(.a(new_n157_), .b(new_n144_), .O(new_n182_));
