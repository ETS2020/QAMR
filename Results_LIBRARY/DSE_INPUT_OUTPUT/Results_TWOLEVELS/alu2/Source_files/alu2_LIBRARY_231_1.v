...
module FAU ( 
  ...
  nor3   g117(.a(new_n133_), .b(new_n82_), .c(new_n83_), .O(z3));
  inv1   g118(.a(z3), .O(new_n135_));
  aoi21  g119(.a(new_n82_), .b(new_n83_), .c(new_n133_), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(new_n135_), .O(z2));
  ...
  nand3  g126(.a(new_n142_), .b(x6), .c(x2), .O(new_n143_));
  nand3  g127(.a(new_n25_), .b(new_n38_), .c(new_n82_), .O(new_n144_));
  nand3  g128(.a(new_n144_), .b(new_n143_), .c(new_n140_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n24_), .O(new_n146_));
  nand3  g130(.a(x7), .b(x6), .c(new_n18_), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n39_), .c(x3), .O(new_n148_));
  nand3  g132(.a(new_n38_), .b(x4), .c(new_n83_), .O(new_n149_));
  inv1   g133(.a(new_n149_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n148_), .c(new_n19_), .O(new_n151_));
  oai21  g135(.a(x6), .b(new_n19_), .c(x8), .O(new_n152_));
  nand4  g136(.a(new_n152_), .b(x7), .c(new_n18_), .d(new_n82_), .O(new_n153_));
  nand3  g137(.a(new_n153_), .b(new_n151_), .c(new_n146_), .O(new_n154_));
  oai21  g138(.a(new_n59_), .b(new_n17_), .c(x5), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n82_), .c(x1), .O(new_n156_));
  nand2  g140(.a(new_n25_), .b(new_n24_), .O(new_n157_));
  oai22  g141(.a(new_n157_), .b(new_n19_), .c(x5), .d(new_n82_), .O(new_n158_));
  nand3  g142(.a(new_n158_), .b(x4), .c(new_n83_), .O(new_n159_));
  ...
  aoi22  g149(.a(new_n165_), .b(x8), .c(new_n164_), .d(new_n83_), .O(new_n166_));
  ...
  oai21  g153(.a(new_n38_), .b(new_n19_), .c(x3), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x8), .O(new_n171_));
  nand3  g155(.a(new_n171_), .b(x7), .c(new_n18_), .O(new_n172_));
  oai21  g156(.a(new_n157_), .b(x6), .c(new_n172_), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(x1), .O(new_n174_));
  nand4  g158(.a(new_n174_), .b(new_n169_), .c(new_n163_), .d(x0), .O(new_n175_));
  aoi21  g159(.a(new_n154_), .b(x5), .c(new_n175_), .O(new_n176_));
  nor2   g160(.a(new_n176_), .b(new_n21_), .O(z4));
  nand2  g161(.a(x2), .b(x0), .O(new_n178_));
  nand2  g162(.a(new_n29_), .b(new_n17_), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n178_), .c(new_n141_), .O(z5));
endmodule
