...
module FAU ( 
  ...
  oai21  g094(.a(new_n110_), .b(x1), .c(new_n17_), .O(new_n111_));
  oai21  g095(.a(x5), .b(x1), .c(new_n18_), .O(new_n112_));
  nand3  g096(.a(new_n31_), .b(new_n61_), .c(x5), .O(new_n113_));
  ...
  aoi21  g100(.a(new_n114_), .b(x8), .c(new_n116_), .O(new_n117_));
  aoi21  g101(.a(new_n117_), .b(new_n108_), .c(new_n25_), .O(new_n118_));
  oai21  g102(.a(new_n61_), .b(new_n19_), .c(new_n52_), .O(new_n119_));
  nand2  g103(.a(new_n119_), .b(x1), .O(new_n120_));
  nand2  g104(.a(new_n92_), .b(new_n34_), .O(new_n121_));
  nand3  g105(.a(new_n121_), .b(new_n31_), .c(new_n83_), .O(new_n122_));
  nand3  g106(.a(new_n122_), .b(new_n120_), .c(new_n56_), .O(new_n123_));
  oai21  g107(.a(new_n123_), .b(new_n118_), .c(new_n99_), .O(new_n124_));
  and2   g108(.a(x5), .b(x2), .O(new_n125_));
  nor2   g109(.a(x5), .b(x4), .O(new_n126_));
  oai21  g110(.a(new_n126_), .b(new_n125_), .c(new_n17_), .O(new_n127_));
  aoi21  g111(.a(new_n127_), .b(new_n20_), .c(new_n83_), .O(new_n128_));
  oai21  g112(.a(new_n128_), .b(new_n110_), .c(new_n31_), .O(new_n129_));
  nand2  g113(.a(new_n129_), .b(new_n61_), .O(new_n130_));
  nand2  g114(.a(new_n19_), .b(new_n83_), .O(new_n131_));
  oai22  g115(.a(new_n131_), .b(new_n34_), .c(new_n58_), .d(new_n83_), .O(new_n132_));
  aoi21  g116(.a(new_n130_), .b(x9), .c(new_n132_), .O(new_n133_));
  nand3  g117(.a(new_n133_), .b(new_n124_), .c(new_n98_), .O(z1));
  nor2   g118(.a(new_n99_), .b(new_n83_), .O(new_n135_));
  nor2   g119(.a(x3), .b(x1), .O(new_n136_));
  nor2   g120(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nor2   g121(.a(new_n137_), .b(new_n62_), .O(z2));
  nand3  g122(.a(new_n63_), .b(x3), .c(x1), .O(new_n139_));
  inv1   g123(.a(new_n139_), .O(z3));
  oai21  g124(.a(x8), .b(new_n18_), .c(new_n102_), .O(new_n141_));
  nand3  g125(.a(new_n141_), .b(new_n33_), .c(x3), .O(new_n142_));
  nand2  g126(.a(x8), .b(new_n99_), .O(new_n143_));
  aoi21  g127(.a(new_n143_), .b(x1), .c(x0), .O(new_n144_));
  oai21  g128(.a(new_n135_), .b(x2), .c(x7), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n144_), .c(x5), .O(new_n146_));
  nor2   g130(.a(x8), .b(x3), .O(new_n147_));
  nand4  g131(.a(new_n147_), .b(x2), .c(x1), .d(new_n17_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n146_), .c(new_n142_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(x4), .O(new_n150_));
  nand3  g134(.a(x5), .b(new_n19_), .c(new_n99_), .O(new_n151_));
  oai21  g135(.a(x5), .b(new_n83_), .c(new_n151_), .O(new_n152_));
  nand3  g136(.a(new_n152_), .b(x7), .c(x2), .O(new_n153_));
  oai21  g137(.a(new_n31_), .b(new_n33_), .c(x1), .O(new_n154_));
  nand3  g138(.a(new_n31_), .b(x5), .c(new_n99_), .O(new_n155_));
  ...
  oai21  g142(.a(x7), .b(new_n83_), .c(x3), .O(new_n159_));
  nand4  g143(.a(new_n159_), .b(new_n20_), .c(x5), .d(new_n18_), .O(new_n160_));
  nand4  g144(.a(new_n109_), .b(x7), .c(x3), .d(x1), .O(new_n161_));
  nand3  g145(.a(new_n161_), .b(new_n160_), .c(new_n61_), .O(new_n162_));
  aoi21  g146(.a(new_n158_), .b(x0), .c(new_n162_), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(new_n150_), .c(new_n25_), .O(z4));
  xor2a  g148(.a(x2), .b(x0), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n137_), .c(new_n63_), .O(z5));
endmodule
