...
module FAU ( 
  ...
  nor2   g166(.a(new_n95_), .b(new_n32_), .O(new_n183_));
  nand3  g167(.a(new_n183_), .b(new_n39_), .c(new_n23_), .O(new_n184_));
  nor2   g168(.a(new_n35_), .b(new_n39_), .O(new_n185_));
  nand4  g169(.a(new_n185_), .b(new_n17_), .c(x4), .d(new_n95_), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n184_), .c(new_n19_), .O(new_n187_));
  nor2   g171(.a(new_n133_), .b(x4), .O(new_n188_));
  oai21  g172(.a(new_n188_), .b(new_n187_), .c(x7), .O(new_n189_));
  nand4  g173(.a(x9), .b(new_n39_), .c(x4), .d(new_n32_), .O(new_n190_));
  ...
  nand3  g179(.a(new_n67_), .b(x9), .c(new_n39_), .O(new_n196_));
  ...
  nand3  g185(.a(new_n201_), .b(new_n198_), .c(new_n189_), .O(new_n202_));
  ...
  oai21  g195(.a(new_n183_), .b(new_n39_), .c(x4), .O(new_n212_));
  ...
  nand3  g200(.a(new_n216_), .b(x9), .c(x0), .O(new_n217_));
  nand2  g201(.a(x6), .b(x1), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(new_n217_), .c(x3), .O(new_n219_));
  nand3  g203(.a(new_n55_), .b(new_n32_), .c(x1), .O(new_n220_));
  inv1   g204(.a(new_n220_), .O(new_n221_));
  oai21  g205(.a(new_n221_), .b(new_n219_), .c(x7), .O(new_n222_));
  nand2  g206(.a(new_n95_), .b(x0), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n56_), .c(new_n222_), .O(new_n224_));
  ...
  nand3  g217(.a(new_n233_), .b(new_n225_), .c(new_n215_), .O(new_n234_));
  ...
  aoi21  g230(.a(new_n246_), .b(new_n245_), .c(new_n31_), .O(new_n247_));
  ...
  nor2   g234(.a(new_n250_), .b(new_n35_), .O(new_n251_));
  oai21  g235(.a(new_n251_), .b(new_n243_), .c(x0), .O(new_n252_));
  ...
  nand4  g251(.a(new_n267_), .b(new_n258_), .c(new_n252_), .d(new_n235_), .O(z4));
  or2    g252(.a(new_n209_), .b(new_n200_), .O(z5));
endmodule
