...
module FAU ( 
  ...
  nand2  g116(.a(new_n29_), .b(new_n17_), .O(new_n133_));
  aoi21  g117(.a(new_n133_), .b(new_n132_), .c(new_n24_), .O(new_n134_));
  oai21  g118(.a(new_n134_), .b(new_n131_), .c(x4), .O(new_n135_));
  nand3  g119(.a(x5), .b(new_n28_), .c(new_n64_), .O(new_n136_));
  oai21  g120(.a(x5), .b(new_n70_), .c(new_n136_), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(x7), .c(x2), .O(new_n138_));
  oai21  g122(.a(new_n29_), .b(new_n24_), .c(x1), .O(new_n139_));
  oai21  g123(.a(new_n30_), .b(x3), .c(new_n139_), .O(new_n140_));
  ...
  nand3  g129(.a(new_n145_), .b(new_n144_), .c(new_n17_), .O(new_n146_));
  aoi21  g130(.a(new_n142_), .b(x0), .c(new_n146_), .O(new_n147_));
  aoi21  g131(.a(new_n147_), .b(new_n135_), .c(new_n18_), .O(z4));
