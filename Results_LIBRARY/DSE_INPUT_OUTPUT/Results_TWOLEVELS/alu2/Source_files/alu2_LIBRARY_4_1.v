...
module FAU ( 
  ...
  nor2   g127(.a(x6), .b(new_n71_), .O(new_n144_));
  oai21  g128(.a(new_n144_), .b(new_n63_), .c(new_n84_), .O(new_n145_));
  nor2   g129(.a(new_n71_), .b(new_n84_), .O(new_n146_));
  nand3  g130(.a(new_n146_), .b(x6), .c(x5), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n17_), .c(new_n23_), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(new_n143_), .c(new_n104_), .O(z1));
  nor2   g134(.a(new_n17_), .b(x7), .O(new_n151_));
  inv1   g135(.a(new_n151_), .O(new_n152_));
  nor3   g136(.a(new_n151_), .b(new_n71_), .c(new_n84_), .O(z3));
  inv1   g137(.a(z3), .O(new_n154_));
  nand2  g138(.a(new_n71_), .b(new_n84_), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n154_), .c(new_n152_), .O(z2));
  oai21  g140(.a(x6), .b(x3), .c(x1), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n29_), .O(new_n158_));
  inv1   g142(.a(new_n146_), .O(new_n159_));
  nand3  g143(.a(new_n159_), .b(new_n18_), .c(new_n22_), .O(new_n160_));
  aoi21  g144(.a(new_n160_), .b(new_n158_), .c(new_n63_), .O(new_n161_));
  ...
  aoi21  g155(.a(x6), .b(new_n22_), .c(new_n41_), .O(new_n172_));
  nor2   g156(.a(new_n85_), .b(x3), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n52_), .c(x6), .O(new_n174_));
  oai21  g158(.a(new_n172_), .b(new_n84_), .c(new_n174_), .O(new_n175_));
  ...
  aoi22  g162(.a(new_n41_), .b(new_n22_), .c(x6), .d(new_n71_), .O(new_n179_));
  nand3  g163(.a(new_n41_), .b(new_n71_), .c(new_n22_), .O(new_n180_));
  oai21  g164(.a(new_n179_), .b(new_n84_), .c(new_n180_), .O(new_n181_));
  aoi22  g165(.a(new_n181_), .b(x5), .c(new_n144_), .d(x1), .O(new_n182_));
  nor2   g166(.a(x6), .b(x5), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n146_), .c(new_n19_), .O(new_n184_));
  oai21  g168(.a(new_n182_), .b(x4), .c(new_n184_), .O(new_n185_));
  aoi21  g169(.a(new_n178_), .b(x0), .c(new_n185_), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n168_), .c(new_n17_), .O(z4));
  nand2  g171(.a(new_n155_), .b(new_n159_), .O(new_n188_));
  xnor2a g172(.a(x2), .b(x0), .O(new_n189_));
  nand3  g173(.a(new_n189_), .b(new_n188_), .c(new_n152_), .O(new_n190_));
