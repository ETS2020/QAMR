...
module FAU ( 
  ...
  aoi21  g064(.a(x5), .b(new_n22_), .c(new_n43_), .O(new_n81_));
  nand3  g065(.a(new_n43_), .b(x5), .c(new_n22_), .O(new_n82_));
  oai21  g066(.a(new_n81_), .b(new_n35_), .c(new_n82_), .O(new_n83_));
  nor2   g067(.a(x9), .b(new_n23_), .O(new_n84_));
  aoi21  g068(.a(new_n83_), .b(x9), .c(new_n84_), .O(new_n85_));
  oai21  g069(.a(new_n23_), .b(new_n35_), .c(x9), .O(new_n86_));
  ...
  nand4  g082(.a(new_n45_), .b(new_n18_), .c(x5), .d(new_n22_), .O(new_n99_));
  ...
  nand3  g087(.a(x8), .b(x6), .c(new_n22_), .O(new_n104_));
  aoi21  g088(.a(new_n104_), .b(new_n103_), .c(new_n35_), .O(new_n105_));
  oai21  g089(.a(new_n105_), .b(new_n102_), .c(new_n23_), .O(new_n106_));
  nand3  g090(.a(x7), .b(new_n24_), .c(new_n22_), .O(new_n107_));
  aoi21  g091(.a(new_n107_), .b(new_n43_), .c(x0), .O(new_n108_));
  nand4  g092(.a(x8), .b(x7), .c(new_n18_), .d(new_n22_), .O(new_n109_));
  ...
  nand3  g096(.a(new_n36_), .b(new_n17_), .c(new_n18_), .O(new_n113_));
  inv1   g097(.a(new_n113_), .O(new_n114_));
  oai21  g098(.a(new_n114_), .b(new_n112_), .c(new_n80_), .O(new_n115_));
  nand2  g099(.a(new_n18_), .b(x2), .O(new_n116_));
  aoi21  g100(.a(new_n116_), .b(new_n53_), .c(new_n35_), .O(new_n117_));
  nand3  g101(.a(new_n43_), .b(x4), .c(x2), .O(new_n118_));
  inv1   g102(.a(new_n118_), .O(new_n119_));
  oai21  g103(.a(new_n119_), .b(new_n117_), .c(x9), .O(new_n120_));
  nand2  g104(.a(new_n43_), .b(new_n22_), .O(new_n121_));
  nand3  g105(.a(new_n121_), .b(x7), .c(new_n35_), .O(new_n122_));
  aoi21  g106(.a(x8), .b(x2), .c(new_n17_), .O(new_n123_));
  oai21  g107(.a(new_n123_), .b(new_n24_), .c(new_n122_), .O(new_n124_));
  nand3  g108(.a(new_n124_), .b(x6), .c(new_n23_), .O(new_n125_));
  nand3  g109(.a(new_n43_), .b(new_n18_), .c(new_n22_), .O(new_n126_));
  ...
  aoi21  g117(.a(new_n129_), .b(x1), .c(new_n133_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(new_n115_), .O(new_n135_));
  nor2   g119(.a(x4), .b(x1), .O(new_n136_));
  nand3  g120(.a(new_n136_), .b(x8), .c(new_n24_), .O(new_n137_));
  nand3  g121(.a(x9), .b(x4), .c(x1), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n137_), .c(new_n35_), .O(new_n139_));
  oai22  g123(.a(x8), .b(new_n22_), .c(x4), .d(x0), .O(new_n140_));
  nand3  g124(.a(new_n43_), .b(x5), .c(x4), .O(new_n141_));
  inv1   g125(.a(new_n141_), .O(new_n142_));
  aoi21  g126(.a(new_n140_), .b(new_n24_), .c(new_n142_), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n17_), .c(new_n132_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(x1), .c(new_n139_), .O(new_n145_));
  nor2   g129(.a(new_n17_), .b(x7), .O(new_n146_));
  aoi21  g130(.a(new_n136_), .b(new_n95_), .c(new_n146_), .O(new_n147_));
  oai21  g131(.a(new_n145_), .b(new_n18_), .c(new_n147_), .O(new_n148_));
  aoi21  g132(.a(new_n135_), .b(x3), .c(new_n148_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n101_), .O(z1));
  nor2   g134(.a(new_n69_), .b(new_n80_), .O(new_n151_));
  ...
  inv1   g139(.a(new_n146_), .O(new_n156_));
  ...
  oai21  g156(.a(new_n24_), .b(x2), .c(x8), .O(new_n173_));
  aoi21  g157(.a(new_n173_), .b(new_n69_), .c(new_n52_), .O(new_n174_));
  ...
  aoi22  g162(.a(new_n43_), .b(new_n22_), .c(x6), .d(new_n69_), .O(new_n179_));
  nand3  g163(.a(new_n43_), .b(new_n69_), .c(new_n22_), .O(new_n180_));
  oai21  g164(.a(new_n179_), .b(new_n80_), .c(new_n180_), .O(new_n181_));
  nor2   g165(.a(x6), .b(new_n69_), .O(new_n182_));
  aoi22  g166(.a(new_n182_), .b(x1), .c(new_n181_), .d(x5), .O(new_n183_));
  nor2   g167(.a(x6), .b(x5), .O(new_n184_));
  aoi21  g168(.a(new_n184_), .b(new_n151_), .c(new_n19_), .O(new_n185_));
  ...
  inv1   g172(.a(new_n154_), .O(new_n189_));
  xnor2a g173(.a(x2), .b(x0), .O(new_n190_));
  nand3  g174(.a(new_n190_), .b(new_n189_), .c(new_n156_), .O(new_n191_));
