...
module FAU ( 
  ...
  nand3  g128(.a(new_n144_), .b(x3), .c(x1), .O(new_n145_));
  nand2  g129(.a(new_n75_), .b(new_n92_), .O(new_n146_));
  nand3  g130(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(z2));
  inv1   g131(.a(new_n145_), .O(z3));
  ...
  oai21  g162(.a(new_n178_), .b(new_n177_), .c(new_n144_), .O(z5));
endmodule
