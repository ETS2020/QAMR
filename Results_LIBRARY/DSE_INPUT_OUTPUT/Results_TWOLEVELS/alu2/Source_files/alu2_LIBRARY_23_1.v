...
module FAU ( 
  ...
  nand2  g061(.a(new_n18_), .b(x1), .O(new_n78_));
  nand3  g062(.a(new_n78_), .b(new_n77_), .c(new_n72_), .O(new_n79_));
  nand2  g063(.a(new_n79_), .b(new_n67_), .O(new_n80_));
  nand3  g064(.a(x3), .b(new_n23_), .c(new_n68_), .O(new_n81_));
  nand3  g065(.a(x9), .b(new_n20_), .c(new_n46_), .O(new_n82_));
  oai22  g066(.a(new_n82_), .b(new_n81_), .c(new_n20_), .d(new_n68_), .O(new_n83_));
  oai21  g067(.a(x5), .b(x2), .c(x7), .O(new_n84_));
  nand2  g068(.a(x3), .b(new_n68_), .O(new_n85_));
  oai22  g069(.a(new_n85_), .b(new_n82_), .c(new_n84_), .d(new_n68_), .O(new_n86_));
  aoi22  g070(.a(new_n86_), .b(new_n41_), .c(new_n83_), .d(x0), .O(new_n87_));
  aoi21  g071(.a(new_n87_), .b(new_n80_), .c(new_n17_), .O(new_n88_));
  nand3  g072(.a(x5), .b(new_n17_), .c(x3), .O(new_n89_));
  nand2  g073(.a(new_n89_), .b(new_n20_), .O(new_n90_));
  nand2  g074(.a(new_n90_), .b(x1), .O(new_n91_));
  nor3   g075(.a(x7), .b(x4), .c(x1), .O(new_n92_));
  oai21  g076(.a(new_n92_), .b(new_n46_), .c(new_n67_), .O(new_n93_));
  ...
  nand3  g082(.a(new_n41_), .b(x7), .c(x2), .O(new_n99_));
  aoi21  g083(.a(new_n99_), .b(new_n98_), .c(x5), .O(new_n100_));
  nand4  g084(.a(new_n41_), .b(new_n20_), .c(new_n19_), .d(x2), .O(new_n101_));
  inv1   g085(.a(new_n101_), .O(new_n102_));
  oai21  g086(.a(new_n102_), .b(new_n100_), .c(new_n67_), .O(new_n103_));
  nand3  g087(.a(x7), .b(new_n46_), .c(new_n23_), .O(new_n104_));
  ...
  nand3  g091(.a(x8), .b(new_n19_), .c(new_n23_), .O(new_n108_));
  nand2  g092(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nor3   g093(.a(new_n41_), .b(new_n46_), .c(x0), .O(new_n110_));
  aoi21  g094(.a(new_n109_), .b(x3), .c(new_n110_), .O(new_n111_));
  ...
  aoi21  g102(.a(new_n105_), .b(new_n52_), .c(new_n30_), .O(new_n119_));
  nand2  g103(.a(new_n23_), .b(new_n30_), .O(new_n120_));
  nand2  g104(.a(x8), .b(new_n20_), .O(new_n121_));
  oai21  g105(.a(new_n121_), .b(new_n120_), .c(new_n99_), .O(new_n122_));
  oai21  g106(.a(new_n122_), .b(new_n119_), .c(x3), .O(new_n123_));
  nor2   g107(.a(x5), .b(x2), .O(new_n124_));
  oai21  g108(.a(new_n124_), .b(x8), .c(new_n19_), .O(new_n125_));
  nand3  g109(.a(x8), .b(new_n23_), .c(x0), .O(new_n126_));
  oai21  g110(.a(new_n125_), .b(x0), .c(new_n126_), .O(new_n127_));
  ...
  xnor2a g118(.a(x5), .b(x3), .O(new_n135_));
  nand3  g119(.a(new_n135_), .b(new_n18_), .c(x7), .O(new_n136_));
  oai21  g120(.a(new_n134_), .b(new_n17_), .c(new_n136_), .O(new_n137_));
  nand2  g121(.a(new_n137_), .b(x1), .O(new_n138_));
  nand3  g122(.a(new_n20_), .b(x3), .c(new_n30_), .O(new_n139_));
  nand3  g123(.a(x8), .b(x5), .c(new_n67_), .O(new_n140_));
  aoi21  g124(.a(new_n140_), .b(new_n139_), .c(x2), .O(new_n141_));
  nand2  g125(.a(x8), .b(x3), .O(new_n142_));
  aoi21  g126(.a(new_n142_), .b(new_n46_), .c(x7), .O(new_n143_));
  oai21  g127(.a(new_n143_), .b(new_n141_), .c(new_n19_), .O(new_n144_));
  nand4  g128(.a(new_n129_), .b(x5), .c(x3), .d(x2), .O(new_n145_));
  ...
  nand4  g133(.a(new_n149_), .b(new_n138_), .c(new_n118_), .d(new_n95_), .O(z1));
  nand2  g134(.a(x9), .b(new_n17_), .O(new_n151_));
  xor2a  g135(.a(x3), .b(x1), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n151_), .O(z2));
  nand2  g137(.a(x3), .b(x1), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n151_), .O(z3));
  oai21  g139(.a(x3), .b(new_n68_), .c(x2), .O(new_n156_));
  aoi22  g140(.a(new_n19_), .b(x4), .c(x3), .d(new_n30_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n156_), .c(x7), .O(new_n158_));
  aoi21  g142(.a(new_n19_), .b(new_n67_), .c(new_n68_), .O(new_n159_));
  nand3  g143(.a(new_n154_), .b(new_n19_), .c(new_n23_), .O(new_n160_));
  oai21  g144(.a(new_n159_), .b(x0), .c(new_n160_), .O(new_n161_));
  oai21  g145(.a(new_n161_), .b(new_n158_), .c(x5), .O(new_n162_));
  aoi21  g146(.a(new_n96_), .b(x8), .c(new_n30_), .O(new_n163_));
  nand2  g147(.a(new_n41_), .b(x2), .O(new_n164_));
  nand2  g148(.a(x7), .b(x3), .O(new_n165_));
  nand2  g149(.a(x6), .b(new_n67_), .O(new_n166_));
  nand3  g150(.a(new_n166_), .b(new_n165_), .c(new_n164_), .O(new_n167_));
  oai21  g151(.a(new_n167_), .b(new_n163_), .c(x1), .O(new_n168_));
  oai21  g152(.a(new_n20_), .b(new_n30_), .c(x8), .O(new_n169_));
  nand2  g153(.a(new_n169_), .b(x2), .O(new_n170_));
  nand2  g154(.a(new_n27_), .b(x8), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(x0), .O(new_n172_));
  nand3  g156(.a(new_n20_), .b(x6), .c(new_n68_), .O(new_n173_));
  nand3  g157(.a(new_n173_), .b(new_n172_), .c(new_n170_), .O(new_n174_));
  nand2  g158(.a(new_n174_), .b(x3), .O(new_n175_));
  aoi21  g159(.a(new_n23_), .b(x0), .c(new_n41_), .O(new_n176_));
  oai21  g160(.a(new_n23_), .b(x0), .c(new_n176_), .O(new_n177_));
  nand3  g161(.a(new_n177_), .b(new_n20_), .c(x6), .O(new_n178_));
  nand3  g162(.a(new_n178_), .b(new_n175_), .c(new_n168_), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n46_), .c(new_n17_), .O(new_n180_));
  aoi21  g164(.a(new_n180_), .b(new_n162_), .c(new_n18_), .O(z4));
  inv1   g165(.a(new_n120_), .O(new_n182_));
  nor2   g166(.a(new_n182_), .b(new_n60_), .O(new_n183_));
  oai21  g167(.a(new_n183_), .b(new_n152_), .c(new_n151_), .O(z5));
endmodule
