...
module FAU ( 
  ...
  nand2  g096(.a(new_n23_), .b(x5), .O(new_n113_));
  nand4  g097(.a(new_n22_), .b(new_n21_), .c(x2), .d(new_n17_), .O(new_n114_));
  ...
  aoi21  g101(.a(new_n117_), .b(new_n113_), .c(x2), .O(new_n118_));
  nor2   g102(.a(x8), .b(new_n17_), .O(new_n119_));
  oai21  g103(.a(new_n119_), .b(new_n118_), .c(x9), .O(new_n120_));
  nand3  g104(.a(new_n120_), .b(new_n116_), .c(new_n24_), .O(new_n121_));
  ...
  xnor2a g140(.a(x3), .b(x1), .O(new_n157_));
  inv1   g141(.a(new_n157_), .O(new_n158_));
  nor2   g142(.a(new_n158_), .b(new_n156_), .O(z2));
  inv1   g143(.a(new_n156_), .O(new_n160_));
  oai21  g144(.a(new_n76_), .b(new_n58_), .c(new_n160_), .O(z3));
  nand2  g145(.a(x2), .b(x0), .O(new_n162_));
  nand2  g146(.a(new_n41_), .b(new_n17_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g148(.a(new_n164_), .b(new_n157_), .O(new_n165_));
  oai22  g149(.a(new_n76_), .b(x0), .c(new_n41_), .d(x1), .O(new_n166_));
  nand4  g150(.a(new_n166_), .b(x8), .c(x6), .d(x4), .O(new_n167_));
  aoi21  g151(.a(new_n167_), .b(new_n165_), .c(new_n21_), .O(new_n168_));
  nand2  g152(.a(new_n23_), .b(x3), .O(new_n169_));
  oai21  g153(.a(x5), .b(x0), .c(new_n169_), .O(new_n170_));
  nor2   g154(.a(x5), .b(new_n76_), .O(new_n171_));
  aoi22  g155(.a(new_n171_), .b(new_n58_), .c(new_n170_), .d(x2), .O(new_n172_));
  nor2   g156(.a(x2), .b(new_n17_), .O(new_n173_));
  oai21  g157(.a(x3), .b(new_n58_), .c(x8), .O(new_n174_));
  oai21  g158(.a(new_n174_), .b(new_n173_), .c(new_n21_), .O(new_n175_));
  oai21  g159(.a(new_n172_), .b(new_n19_), .c(new_n175_), .O(new_n176_));
  oai21  g160(.a(new_n176_), .b(new_n168_), .c(new_n22_), .O(new_n177_));
  nand2  g161(.a(new_n157_), .b(x2), .O(new_n178_));
  aoi21  g162(.a(new_n178_), .b(x5), .c(x8), .O(new_n179_));
  nand2  g163(.a(x8), .b(x6), .O(new_n180_));
  oai21  g164(.a(new_n180_), .b(x5), .c(x2), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(x1), .O(new_n182_));
  nand4  g166(.a(x6), .b(x5), .c(new_n76_), .d(new_n41_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n182_), .c(new_n22_), .O(new_n184_));
  oai21  g168(.a(new_n184_), .b(new_n179_), .c(x0), .O(new_n185_));
  oai22  g169(.a(new_n169_), .b(new_n163_), .c(new_n22_), .d(x3), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(x5), .c(x1), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n185_), .O(new_n188_));
  nand3  g172(.a(new_n23_), .b(new_n76_), .c(new_n41_), .O(new_n189_));
  nand2  g173(.a(new_n189_), .b(new_n19_), .O(new_n190_));
  nand4  g174(.a(new_n190_), .b(x5), .c(new_n58_), .d(new_n17_), .O(new_n191_));
  aoi22  g175(.a(new_n23_), .b(x2), .c(x7), .d(x0), .O(new_n192_));
  oai22  g176(.a(new_n192_), .b(new_n76_), .c(new_n22_), .d(new_n58_), .O(new_n193_));
  nand3  g177(.a(new_n193_), .b(new_n21_), .c(x4), .O(new_n194_));
  nand3  g178(.a(new_n194_), .b(new_n191_), .c(x6), .O(new_n195_));
  aoi21  g179(.a(new_n188_), .b(new_n19_), .c(new_n195_), .O(new_n196_));
  aoi21  g180(.a(new_n196_), .b(new_n177_), .c(new_n29_), .O(z4));
  nand2  g181(.a(new_n165_), .b(new_n160_), .O(z5));
endmodule
