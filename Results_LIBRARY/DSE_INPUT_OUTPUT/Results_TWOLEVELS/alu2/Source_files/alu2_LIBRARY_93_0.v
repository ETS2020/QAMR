...
module FAU ( 
  ...
  oai21  g192(.a(new_n87_), .b(new_n41_), .c(new_n208_), .O(z3));
  oai21  g193(.a(x8), .b(new_n17_), .c(new_n84_), .O(new_n210_));
  nand2  g194(.a(new_n210_), .b(x1), .O(new_n211_));
  oai21  g195(.a(new_n26_), .b(new_n34_), .c(x8), .O(new_n212_));
  nand2  g196(.a(new_n212_), .b(x2), .O(new_n213_));
  inv1   g197(.a(new_n84_), .O(new_n214_));
  oai21  g198(.a(new_n214_), .b(new_n18_), .c(x0), .O(new_n215_));
  nand2  g199(.a(new_n45_), .b(new_n41_), .O(new_n216_));
  nand3  g200(.a(new_n216_), .b(new_n215_), .c(new_n213_), .O(new_n217_));
  nand2  g201(.a(new_n217_), .b(x3), .O(new_n218_));
  nand3  g202(.a(new_n45_), .b(x2), .c(new_n34_), .O(new_n219_));
  nand3  g203(.a(new_n219_), .b(new_n218_), .c(new_n211_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n25_), .O(new_n221_));
  oai21  g205(.a(x6), .b(x3), .c(x1), .O(new_n222_));
  nand2  g206(.a(new_n222_), .b(new_n34_), .O(new_n223_));
  aoi21  g207(.a(x3), .b(x1), .c(x2), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n26_), .c(new_n20_), .O(new_n225_));
  nand3  g209(.a(new_n26_), .b(x3), .c(x2), .O(new_n226_));
  nand3  g210(.a(new_n226_), .b(new_n225_), .c(new_n223_), .O(new_n227_));
  nand2  g211(.a(new_n227_), .b(x5), .O(new_n228_));
  aoi21  g212(.a(new_n228_), .b(new_n221_), .c(new_n33_), .O(new_n229_));
  nand3  g213(.a(new_n45_), .b(x5), .c(x3), .O(new_n230_));
  aoi21  g214(.a(new_n230_), .b(new_n179_), .c(new_n17_), .O(new_n231_));
  nor2   g215(.a(x8), .b(x5), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n231_), .c(x0), .O(new_n233_));
  nand3  g217(.a(new_n113_), .b(new_n45_), .c(x5), .O(new_n234_));
  oai21  g218(.a(new_n197_), .b(x5), .c(new_n234_), .O(new_n235_));
  aoi22  g219(.a(new_n235_), .b(x3), .c(new_n92_), .d(new_n45_), .O(new_n236_));
  nand2  g220(.a(new_n236_), .b(new_n233_), .O(new_n237_));
  nand2  g221(.a(new_n237_), .b(x1), .O(new_n238_));
  inv1   g222(.a(new_n232_), .O(new_n239_));
  nand2  g223(.a(x5), .b(new_n87_), .O(new_n240_));
  oai22  g224(.a(new_n240_), .b(new_n130_), .c(x5), .d(x2), .O(new_n241_));
  nand2  g225(.a(new_n241_), .b(x0), .O(new_n242_));
  nand4  g226(.a(new_n122_), .b(x5), .c(new_n87_), .d(new_n17_), .O(new_n243_));
  nand3  g227(.a(new_n243_), .b(new_n242_), .c(new_n239_), .O(new_n244_));
  nand3  g228(.a(new_n244_), .b(new_n26_), .c(x6), .O(new_n245_));
  nand4  g229(.a(new_n103_), .b(new_n79_), .c(new_n87_), .d(new_n34_), .O(new_n246_));
  nand3  g230(.a(new_n246_), .b(new_n245_), .c(new_n238_), .O(new_n247_));
  oai21  g231(.a(new_n247_), .b(new_n229_), .c(x9), .O(new_n248_));
  nand3  g232(.a(new_n18_), .b(x3), .c(x2), .O(new_n249_));
  oai21  g233(.a(new_n84_), .b(x2), .c(new_n249_), .O(new_n250_));
  nand2  g234(.a(new_n250_), .b(x1), .O(new_n251_));
  xor2a  g235(.a(x6), .b(x2), .O(new_n252_));
  nand2  g236(.a(new_n252_), .b(x5), .O(new_n253_));
  aoi21  g237(.a(new_n253_), .b(new_n156_), .c(new_n26_), .O(new_n254_));
  nand2  g238(.a(new_n173_), .b(x5), .O(new_n255_));
  inv1   g239(.a(new_n255_), .O(new_n256_));
  oai21  g240(.a(new_n256_), .b(new_n254_), .c(new_n87_), .O(new_n257_));
  nand3  g241(.a(new_n18_), .b(x6), .c(new_n25_), .O(new_n258_));
  nand3  g242(.a(new_n258_), .b(new_n257_), .c(new_n251_), .O(new_n259_));
  nand2  g243(.a(new_n259_), .b(x0), .O(new_n260_));
  aoi22  g244(.a(new_n214_), .b(new_n87_), .c(new_n46_), .d(new_n17_), .O(new_n261_));
  oai22  g245(.a(new_n261_), .b(new_n25_), .c(new_n197_), .d(new_n87_), .O(new_n262_));
  nand2  g246(.a(new_n262_), .b(x1), .O(new_n263_));
  nand3  g247(.a(new_n263_), .b(new_n260_), .c(x9), .O(new_n264_));
  nand2  g248(.a(new_n264_), .b(new_n33_), .O(new_n265_));
  ...
  nand2  g252(.a(new_n268_), .b(new_n208_), .O(new_n269_));
