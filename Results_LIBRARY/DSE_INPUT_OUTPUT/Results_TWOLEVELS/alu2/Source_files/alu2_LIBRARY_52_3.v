...
module FAU ( 
  ...
  oai21  g141(.a(new_n69_), .b(new_n74_), .c(new_n157_), .O(z3));
  xnor2a g142(.a(x2), .b(x0), .O(new_n159_));
  nand2  g143(.a(new_n43_), .b(x8), .O(new_n160_));
  nand3  g144(.a(new_n160_), .b(new_n69_), .c(new_n74_), .O(new_n161_));
  nand2  g145(.a(new_n154_), .b(new_n122_), .O(new_n162_));
  nand2  g146(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand2  g147(.a(new_n163_), .b(new_n159_), .O(new_n164_));
  nor2   g148(.a(x6), .b(new_n23_), .O(new_n165_));
  nor2   g149(.a(new_n30_), .b(x2), .O(new_n166_));
  oai21  g150(.a(new_n166_), .b(new_n165_), .c(x0), .O(new_n167_));
  nand2  g151(.a(x6), .b(x1), .O(new_n168_));
  aoi21  g152(.a(new_n168_), .b(new_n167_), .c(new_n38_), .O(new_n169_));
  nor2   g153(.a(new_n51_), .b(x2), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n169_), .c(new_n69_), .O(new_n171_));
  nand4  g155(.a(new_n43_), .b(new_n24_), .c(new_n23_), .d(x1), .O(new_n172_));
  nand3  g156(.a(new_n172_), .b(new_n171_), .c(new_n164_), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(x5), .O(new_n174_));
  nand2  g158(.a(new_n38_), .b(new_n19_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n137_), .c(x2), .O(new_n176_));
  nor2   g160(.a(x8), .b(x5), .O(new_n177_));
  oai21  g161(.a(new_n177_), .b(new_n176_), .c(x6), .O(new_n178_));
  aoi21  g162(.a(new_n19_), .b(x2), .c(new_n24_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n38_), .c(new_n51_), .O(new_n180_));
  nand2  g164(.a(new_n180_), .b(x1), .O(new_n181_));
  aoi21  g165(.a(new_n181_), .b(new_n178_), .c(new_n18_), .O(new_n182_));
  nand3  g166(.a(new_n122_), .b(new_n19_), .c(new_n69_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n73_), .c(new_n74_), .O(new_n184_));
  nand3  g168(.a(new_n96_), .b(new_n24_), .c(new_n38_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n17_), .O(new_n186_));
  nor3   g170(.a(new_n186_), .b(new_n184_), .c(new_n182_), .O(new_n187_));
  aoi21  g171(.a(new_n187_), .b(new_n174_), .c(new_n39_), .O(z4));
  inv1   g172(.a(new_n155_), .O(new_n189_));
  nand3  g173(.a(new_n159_), .b(new_n189_), .c(new_n157_), .O(new_n190_));
