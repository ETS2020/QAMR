...
module FAU ( 
  ...
  oai21  g143(.a(new_n78_), .b(new_n24_), .c(new_n159_), .O(z3));
  nand3  g144(.a(x8), .b(new_n20_), .c(x3), .O(new_n161_));
  aoi21  g145(.a(new_n161_), .b(x1), .c(x0), .O(new_n162_));
  nand3  g146(.a(x8), .b(x2), .c(new_n24_), .O(new_n163_));
  aoi21  g147(.a(new_n163_), .b(x6), .c(x7), .O(new_n164_));
  oai21  g148(.a(new_n164_), .b(new_n162_), .c(x4), .O(new_n165_));
  xor2a  g149(.a(x2), .b(x0), .O(new_n166_));
  nor2   g150(.a(new_n166_), .b(new_n157_), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(x6), .O(new_n168_));
  nand2  g152(.a(new_n149_), .b(new_n17_), .O(new_n169_));
  nand2  g153(.a(new_n32_), .b(x1), .O(new_n170_));
  aoi21  g154(.a(new_n170_), .b(new_n169_), .c(x2), .O(new_n171_));
  nand3  g155(.a(new_n32_), .b(new_n78_), .c(x0), .O(new_n172_));
  inv1   g156(.a(new_n172_), .O(new_n173_));
  oai21  g157(.a(new_n173_), .b(new_n171_), .c(new_n35_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(new_n168_), .c(new_n165_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(x5), .O(new_n176_));
  aoi21  g160(.a(new_n90_), .b(new_n24_), .c(new_n17_), .O(new_n177_));
  nand3  g161(.a(x4), .b(x2), .c(x1), .O(new_n178_));
  inv1   g162(.a(new_n178_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n177_), .c(new_n32_), .O(new_n180_));
  inv1   g164(.a(new_n133_), .O(new_n181_));
  nor2   g165(.a(new_n181_), .b(new_n46_), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n180_), .c(x8), .O(new_n183_));
  aoi22  g167(.a(x3), .b(new_n24_), .c(x2), .d(new_n17_), .O(new_n184_));
  aoi21  g168(.a(new_n78_), .b(x1), .c(new_n60_), .O(new_n185_));
  oai21  g169(.a(new_n184_), .b(new_n19_), .c(new_n185_), .O(new_n186_));
  nand3  g170(.a(new_n186_), .b(x6), .c(new_n30_), .O(new_n187_));
  nand2  g171(.a(new_n187_), .b(new_n20_), .O(new_n188_));
  nor2   g172(.a(new_n188_), .b(new_n183_), .O(new_n189_));
  aoi21  g173(.a(new_n189_), .b(new_n176_), .c(new_n21_), .O(z4));
  oai21  g174(.a(new_n166_), .b(new_n157_), .c(new_n159_), .O(z5));
endmodule
