...
module FAU ( 
  ...
  oai21  g109(.a(new_n64_), .b(new_n70_), .c(new_n125_), .O(z3));
  ...
  oai21  g114(.a(new_n64_), .b(new_n70_), .c(new_n31_), .O(new_n131_));
  nand2  g115(.a(new_n29_), .b(new_n17_), .O(new_n132_));
  aoi21  g116(.a(new_n132_), .b(new_n131_), .c(new_n24_), .O(new_n133_));
  ...
  nand3  g128(.a(new_n144_), .b(new_n143_), .c(new_n17_), .O(new_n145_));
  aoi21  g129(.a(new_n141_), .b(x0), .c(new_n145_), .O(new_n146_));
  aoi21  g130(.a(new_n146_), .b(new_n134_), .c(new_n18_), .O(z4));
