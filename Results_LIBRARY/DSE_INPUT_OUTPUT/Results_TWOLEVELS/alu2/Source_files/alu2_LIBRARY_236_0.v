...
module FAU ( 
  ...
  nand2  g187(.a(new_n17_), .b(new_n19_), .O(new_n204_));
  ...
  nand2  g192(.a(new_n26_), .b(x5), .O(new_n209_));
  nand3  g193(.a(x7), .b(new_n18_), .c(new_n42_), .O(new_n210_));
  ...
  nor2   g197(.a(x8), .b(x4), .O(new_n214_));
  inv1   g198(.a(new_n214_), .O(new_n215_));
  nand2  g199(.a(new_n215_), .b(new_n209_), .O(new_n216_));
  nand3  g200(.a(new_n216_), .b(x2), .c(new_n104_), .O(new_n217_));
  nand4  g201(.a(x7), .b(x5), .c(new_n18_), .d(new_n42_), .O(new_n218_));
  ...
  or2    g206(.a(new_n214_), .b(new_n148_), .O(new_n223_));
  oai21  g207(.a(new_n223_), .b(new_n222_), .c(new_n21_), .O(new_n224_));
  nand3  g208(.a(new_n224_), .b(new_n220_), .c(new_n213_), .O(new_n225_));
  nand2  g209(.a(x4), .b(x3), .O(new_n226_));
  aoi21  g210(.a(new_n226_), .b(new_n104_), .c(x5), .O(new_n227_));
  nand4  g211(.a(new_n28_), .b(x5), .c(new_n18_), .d(new_n79_), .O(new_n228_));
  inv1   g212(.a(new_n228_), .O(new_n229_));
  oai21  g213(.a(new_n229_), .b(new_n227_), .c(new_n198_), .O(new_n230_));
  nand4  g214(.a(new_n214_), .b(x3), .c(x2), .d(x1), .O(new_n231_));
  nand2  g215(.a(new_n231_), .b(new_n230_), .O(new_n232_));
  aoi21  g216(.a(new_n225_), .b(x6), .c(new_n232_), .O(new_n233_));
  nand2  g217(.a(new_n34_), .b(x2), .O(new_n234_));
  aoi21  g218(.a(new_n234_), .b(new_n81_), .c(new_n104_), .O(new_n235_));
  nand3  g219(.a(new_n26_), .b(x6), .c(new_n104_), .O(new_n236_));
  aoi21  g220(.a(new_n236_), .b(new_n234_), .c(new_n79_), .O(new_n237_));
  oai21  g221(.a(new_n237_), .b(new_n235_), .c(new_n21_), .O(new_n238_));
  aoi21  g222(.a(new_n207_), .b(new_n42_), .c(new_n26_), .O(new_n239_));
  nand3  g223(.a(new_n26_), .b(x3), .c(x2), .O(new_n240_));
  oai21  g224(.a(new_n239_), .b(x6), .c(new_n240_), .O(new_n241_));
  ...
  nand3  g228(.a(new_n244_), .b(x7), .c(x3), .O(new_n245_));
  nand4  g229(.a(new_n34_), .b(x5), .c(new_n18_), .d(new_n42_), .O(new_n246_));
  aoi21  g230(.a(new_n246_), .b(new_n245_), .c(x6), .O(new_n247_));
  nand3  g231(.a(x7), .b(x5), .c(new_n18_), .O(new_n248_));
  aoi21  g232(.a(new_n248_), .b(new_n110_), .c(new_n28_), .O(new_n249_));
  aoi21  g233(.a(new_n249_), .b(new_n79_), .c(new_n247_), .O(new_n250_));
  oai21  g234(.a(new_n250_), .b(new_n104_), .c(new_n35_), .O(new_n251_));
  nor2   g235(.a(new_n251_), .b(new_n243_), .O(new_n252_));
  oai21  g236(.a(new_n233_), .b(new_n19_), .c(new_n252_), .O(new_n253_));
  nand2  g237(.a(new_n253_), .b(x9), .O(new_n254_));
  nand2  g238(.a(new_n215_), .b(new_n46_), .O(new_n255_));
  nand3  g239(.a(new_n255_), .b(x3), .c(x1), .O(new_n256_));
  nand2  g240(.a(new_n46_), .b(x8), .O(new_n257_));
  nand3  g241(.a(new_n257_), .b(new_n79_), .c(new_n104_), .O(new_n258_));
  nand2  g242(.a(new_n258_), .b(new_n256_), .O(new_n259_));
  nand2  g243(.a(new_n259_), .b(new_n42_), .O(new_n260_));
  oai21  g244(.a(x6), .b(x3), .c(x1), .O(new_n261_));
  nand2  g245(.a(new_n261_), .b(x4), .O(new_n262_));
  aoi21  g246(.a(new_n262_), .b(new_n260_), .c(new_n21_), .O(new_n263_));
  nand2  g247(.a(x4), .b(x2), .O(new_n264_));
  nand3  g248(.a(new_n26_), .b(x6), .c(new_n21_), .O(new_n265_));
  oai21  g249(.a(new_n265_), .b(new_n264_), .c(x9), .O(new_n266_));
  oai21  g250(.a(new_n266_), .b(new_n263_), .c(new_n19_), .O(new_n267_));
  nand2  g251(.a(new_n267_), .b(new_n254_), .O(z4));
  xor2a  g252(.a(x2), .b(x0), .O(new_n269_));
  oai21  g253(.a(new_n269_), .b(new_n205_), .c(new_n204_), .O(z5));
endmodule
