...
module FAU ( 
  ...
  oai21  g191(.a(new_n95_), .b(new_n31_), .c(new_n207_), .O(z3));
  ...
  oai21  g196(.a(new_n184_), .b(new_n39_), .c(x4), .O(new_n213_));
  nand3  g197(.a(new_n89_), .b(new_n32_), .c(x1), .O(new_n214_));
  aoi21  g198(.a(new_n214_), .b(new_n213_), .c(new_n35_), .O(new_n215_));
  oai21  g199(.a(new_n215_), .b(new_n212_), .c(new_n20_), .O(new_n216_));
  nand2  g200(.a(x6), .b(new_n32_), .O(new_n217_));
  nand3  g201(.a(x9), .b(new_n39_), .c(x2), .O(new_n218_));
  aoi21  g202(.a(new_n218_), .b(new_n217_), .c(new_n19_), .O(new_n219_));
  nor2   g203(.a(new_n39_), .b(new_n31_), .O(new_n220_));
  oai21  g204(.a(new_n220_), .b(new_n219_), .c(new_n95_), .O(new_n221_));
  nand3  g205(.a(new_n55_), .b(new_n32_), .c(x1), .O(new_n222_));
  aoi21  g206(.a(new_n222_), .b(new_n221_), .c(new_n20_), .O(new_n223_));
  nor3   g207(.a(new_n56_), .b(x3), .c(new_n19_), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n223_), .c(new_n23_), .O(new_n225_));
  nor3   g209(.a(x8), .b(x3), .c(x2), .O(new_n226_));
  oai21  g210(.a(new_n226_), .b(x4), .c(new_n31_), .O(new_n227_));
  nand3  g211(.a(new_n39_), .b(x4), .c(new_n95_), .O(new_n228_));
  aoi21  g212(.a(new_n228_), .b(new_n227_), .c(x0), .O(new_n229_));
  nand2  g213(.a(x3), .b(x1), .O(new_n230_));
  nand4  g214(.a(new_n230_), .b(new_n39_), .c(x4), .d(new_n32_), .O(new_n231_));
  inv1   g215(.a(new_n231_), .O(new_n232_));
  oai21  g216(.a(new_n232_), .b(new_n229_), .c(x9), .O(new_n233_));
  nand3  g217(.a(new_n233_), .b(new_n225_), .c(new_n216_), .O(new_n234_));
  nand2  g218(.a(new_n234_), .b(x5), .O(new_n235_));
  oai21  g219(.a(new_n20_), .b(new_n32_), .c(x8), .O(new_n236_));
  oai21  g220(.a(new_n23_), .b(new_n95_), .c(new_n31_), .O(new_n237_));
  nand3  g221(.a(new_n237_), .b(new_n236_), .c(x9), .O(new_n238_));
  aoi21  g222(.a(x7), .b(x1), .c(new_n28_), .O(new_n239_));
  nor2   g223(.a(new_n239_), .b(x4), .O(new_n240_));
  oai22  g224(.a(new_n74_), .b(new_n95_), .c(x7), .d(x2), .O(new_n241_));
  ...
  oai21  g228(.a(new_n95_), .b(x2), .c(x8), .O(new_n245_));
  nand3  g229(.a(new_n245_), .b(x7), .c(new_n23_), .O(new_n246_));
  nand2  g230(.a(new_n41_), .b(new_n39_), .O(new_n247_));
  aoi21  g231(.a(new_n247_), .b(new_n246_), .c(new_n35_), .O(new_n248_));
  nand3  g232(.a(new_n28_), .b(x7), .c(x6), .O(new_n249_));
  nor3   g233(.a(new_n249_), .b(x4), .c(x3), .O(new_n250_));
  aoi21  g234(.a(new_n248_), .b(x1), .c(new_n250_), .O(new_n251_));
  nand2  g235(.a(new_n251_), .b(new_n244_), .O(new_n252_));
  nand2  g236(.a(new_n252_), .b(x0), .O(new_n253_));
  nand4  g237(.a(new_n66_), .b(x9), .c(new_n39_), .d(x3), .O(new_n254_));
  nand2  g238(.a(new_n124_), .b(x4), .O(new_n255_));
  aoi21  g239(.a(new_n255_), .b(new_n254_), .c(new_n20_), .O(new_n256_));
  nand2  g240(.a(new_n164_), .b(new_n95_), .O(new_n257_));
  aoi21  g241(.a(new_n257_), .b(new_n92_), .c(x5), .O(new_n258_));
  oai21  g242(.a(new_n258_), .b(new_n256_), .c(x1), .O(new_n259_));
  nand2  g243(.a(new_n164_), .b(new_n19_), .O(new_n260_));
  nand2  g244(.a(new_n55_), .b(x3), .O(new_n261_));
  aoi21  g245(.a(new_n261_), .b(new_n260_), .c(new_n32_), .O(new_n262_));
  nand3  g246(.a(new_n164_), .b(x3), .c(new_n31_), .O(new_n263_));
  inv1   g247(.a(new_n263_), .O(new_n264_));
  oai21  g248(.a(new_n264_), .b(new_n262_), .c(x4), .O(new_n265_));
  nand2  g249(.a(new_n41_), .b(x6), .O(new_n266_));
  nand2  g250(.a(new_n266_), .b(new_n265_), .O(new_n267_));
  aoi21  g251(.a(new_n267_), .b(new_n17_), .c(new_n200_), .O(new_n268_));
  nand4  g252(.a(new_n268_), .b(new_n259_), .c(new_n253_), .d(new_n235_), .O(z4));
  nand2  g253(.a(new_n210_), .b(new_n207_), .O(new_n270_));
