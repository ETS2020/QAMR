...
module FAU ( 
  ...
  nand2  g133(.a(x9), .b(new_n19_), .O(new_n150_));
  nand2  g134(.a(new_n71_), .b(new_n84_), .O(new_n151_));
  and2   g135(.a(new_n151_), .b(new_n145_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n150_), .O(z2));
  nand2  g137(.a(new_n150_), .b(new_n145_), .O(z3));
  ...
  nand3  g173(.a(new_n189_), .b(new_n188_), .c(new_n150_), .O(new_n190_));
