...
module FAU ( 
  ...
  nand2  g079(.a(x5), .b(new_n22_), .O(new_n96_));
  nor2   g080(.a(new_n96_), .b(new_n47_), .O(new_n97_));
  aoi21  g081(.a(new_n95_), .b(x1), .c(new_n97_), .O(new_n98_));
  nand2  g082(.a(new_n98_), .b(new_n89_), .O(new_n99_));
  oai21  g083(.a(new_n99_), .b(new_n79_), .c(new_n67_), .O(new_n100_));
  inv1   g084(.a(new_n82_), .O(new_n101_));
  nand2  g085(.a(new_n42_), .b(x5), .O(new_n102_));
  nand3  g086(.a(x8), .b(x6), .c(new_n22_), .O(new_n103_));
  aoi21  g087(.a(new_n103_), .b(new_n102_), .c(new_n33_), .O(new_n104_));
  oai21  g088(.a(new_n104_), .b(new_n101_), .c(new_n23_), .O(new_n105_));
  nor2   g089(.a(x5), .b(x2), .O(new_n106_));
  oai21  g090(.a(new_n106_), .b(x8), .c(new_n33_), .O(new_n107_));
  nand3  g091(.a(x8), .b(new_n18_), .c(new_n22_), .O(new_n108_));
  nand2  g092(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g093(.a(new_n109_), .b(x4), .O(new_n110_));
  aoi21  g094(.a(new_n110_), .b(new_n105_), .c(new_n17_), .O(new_n111_));
  nand3  g095(.a(new_n34_), .b(new_n17_), .c(new_n18_), .O(new_n112_));
  inv1   g096(.a(new_n112_), .O(new_n113_));
  oai21  g097(.a(new_n113_), .b(new_n111_), .c(new_n80_), .O(new_n114_));
  aoi22  g098(.a(x9), .b(x2), .c(x8), .d(x7), .O(new_n115_));
  oai22  g099(.a(new_n115_), .b(x0), .c(x9), .d(new_n68_), .O(new_n116_));
  nand3  g100(.a(new_n116_), .b(x6), .c(new_n23_), .O(new_n117_));
  nor2   g101(.a(new_n106_), .b(new_n23_), .O(new_n118_));
  nand2  g102(.a(new_n68_), .b(x0), .O(new_n119_));
  nand3  g103(.a(new_n18_), .b(x5), .c(new_n22_), .O(new_n120_));
  nand2  g104(.a(new_n120_), .b(new_n119_), .O(new_n121_));
  oai21  g105(.a(new_n121_), .b(new_n118_), .c(new_n42_), .O(new_n122_));
  nand2  g106(.a(new_n49_), .b(x6), .O(new_n123_));
  nand3  g107(.a(new_n123_), .b(x2), .c(x0), .O(new_n124_));
  nand2  g108(.a(new_n124_), .b(new_n122_), .O(new_n125_));
  nand2  g109(.a(new_n125_), .b(x9), .O(new_n126_));
  nand2  g110(.a(new_n93_), .b(x5), .O(new_n127_));
  nand3  g111(.a(new_n127_), .b(new_n126_), .c(new_n117_), .O(new_n128_));
  nand2  g112(.a(new_n128_), .b(x1), .O(new_n129_));
  nand2  g113(.a(x8), .b(new_n22_), .O(new_n130_));
  nand4  g114(.a(new_n130_), .b(x9), .c(new_n18_), .d(x0), .O(new_n131_));
  inv1   g115(.a(new_n131_), .O(new_n132_));
  oai21  g116(.a(new_n132_), .b(new_n93_), .c(new_n23_), .O(new_n133_));
  nand3  g117(.a(new_n133_), .b(new_n129_), .c(new_n114_), .O(new_n134_));
  nand2  g118(.a(new_n134_), .b(x3), .O(new_n135_));
  nand4  g119(.a(x8), .b(new_n68_), .c(new_n23_), .d(new_n80_), .O(new_n136_));
  ...
  nand2  g123(.a(new_n37_), .b(new_n33_), .O(new_n140_));
  nand3  g124(.a(new_n42_), .b(x4), .c(x2), .O(new_n141_));
  aoi21  g125(.a(new_n141_), .b(new_n140_), .c(new_n17_), .O(new_n142_));
  oai21  g126(.a(new_n142_), .b(new_n93_), .c(x1), .O(new_n143_));
  nand2  g127(.a(new_n143_), .b(new_n139_), .O(new_n144_));
  nand2  g128(.a(x9), .b(new_n19_), .O(new_n145_));
  nand4  g129(.a(new_n17_), .b(new_n68_), .c(new_n23_), .d(new_n80_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n145_), .O(new_n147_));
  aoi21  g131(.a(new_n144_), .b(x6), .c(new_n147_), .O(new_n148_));
  nand3  g132(.a(new_n148_), .b(new_n135_), .c(new_n100_), .O(z1));
  nor2   g133(.a(x3), .b(x1), .O(new_n150_));
  nor2   g134(.a(new_n67_), .b(new_n80_), .O(new_n151_));
  nor2   g135(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g136(.a(new_n152_), .b(new_n145_), .O(z2));
  inv1   g137(.a(new_n151_), .O(new_n154_));
  nand2  g138(.a(new_n154_), .b(new_n145_), .O(z3));
  oai21  g139(.a(x6), .b(x3), .c(x1), .O(new_n156_));
  nand2  g140(.a(new_n156_), .b(new_n33_), .O(new_n157_));
  nand3  g141(.a(new_n154_), .b(new_n18_), .c(new_n22_), .O(new_n158_));
  aoi21  g142(.a(new_n158_), .b(new_n157_), .c(new_n68_), .O(new_n159_));
  oai21  g143(.a(x8), .b(new_n22_), .c(new_n18_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(x1), .O(new_n161_));
  aoi21  g145(.a(x8), .b(new_n33_), .c(new_n22_), .O(new_n162_));
  aoi21  g146(.a(x8), .b(new_n18_), .c(new_n33_), .O(new_n163_));
  oai21  g147(.a(new_n163_), .b(new_n162_), .c(x3), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n161_), .c(x5), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n159_), .c(x4), .O(new_n166_));
  nand4  g150(.a(new_n18_), .b(x5), .c(new_n23_), .d(new_n67_), .O(new_n167_));
  oai21  g151(.a(x5), .b(new_n80_), .c(new_n167_), .O(new_n168_));
  nand2  g152(.a(new_n168_), .b(x2), .O(new_n169_));
  aoi21  g153(.a(x6), .b(new_n22_), .c(new_n42_), .O(new_n170_));
  nand2  g154(.a(new_n96_), .b(x8), .O(new_n171_));
  aoi21  g155(.a(new_n171_), .b(new_n67_), .c(new_n50_), .O(new_n172_));
  oai22  g156(.a(new_n172_), .b(new_n18_), .c(new_n170_), .d(new_n80_), .O(new_n173_));
  nand2  g157(.a(new_n173_), .b(new_n23_), .O(new_n174_));
  nand2  g158(.a(new_n50_), .b(x1), .O(new_n175_));
  nand3  g159(.a(new_n175_), .b(new_n174_), .c(new_n169_), .O(new_n176_));
  aoi22  g160(.a(new_n42_), .b(new_n22_), .c(x6), .d(new_n67_), .O(new_n177_));
  nand3  g161(.a(new_n42_), .b(new_n67_), .c(new_n22_), .O(new_n178_));
  oai21  g162(.a(new_n177_), .b(new_n80_), .c(new_n178_), .O(new_n179_));
  nor2   g163(.a(x6), .b(new_n67_), .O(new_n180_));
  aoi22  g164(.a(new_n180_), .b(x1), .c(new_n179_), .d(x5), .O(new_n181_));
  nor2   g165(.a(x6), .b(x5), .O(new_n182_));
  aoi21  g166(.a(new_n182_), .b(new_n151_), .c(new_n19_), .O(new_n183_));
  oai21  g167(.a(new_n181_), .b(x4), .c(new_n183_), .O(new_n184_));
  aoi21  g168(.a(new_n176_), .b(x0), .c(new_n184_), .O(new_n185_));
  aoi21  g169(.a(new_n185_), .b(new_n166_), .c(new_n17_), .O(z4));
  xor2a  g170(.a(x2), .b(x0), .O(new_n187_));
  oai21  g171(.a(new_n187_), .b(new_n152_), .c(new_n145_), .O(z5));
endmodule
