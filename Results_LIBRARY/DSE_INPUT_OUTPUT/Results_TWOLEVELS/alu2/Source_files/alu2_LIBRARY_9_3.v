...
module FAU ( 
  ...
  nand2  g134(.a(new_n19_), .b(new_n86_), .O(new_n151_));
  aoi21  g135(.a(new_n151_), .b(new_n150_), .c(new_n54_), .O(new_n152_));
  aoi21  g136(.a(new_n86_), .b(new_n54_), .c(new_n30_), .O(new_n153_));
  nand2  g137(.a(new_n17_), .b(x1), .O(new_n154_));
  oai22  g138(.a(new_n154_), .b(new_n110_), .c(new_n153_), .d(x2), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n152_), .c(new_n87_), .O(new_n156_));
  nand2  g140(.a(x7), .b(x4), .O(new_n157_));
  nand4  g141(.a(new_n157_), .b(x3), .c(new_n18_), .d(x1), .O(new_n158_));
  oai21  g142(.a(new_n17_), .b(x1), .c(new_n158_), .O(new_n159_));
  nand4  g143(.a(new_n30_), .b(x4), .c(new_n18_), .d(new_n86_), .O(new_n160_));
  inv1   g144(.a(new_n160_), .O(new_n161_));
  aoi21  g145(.a(new_n159_), .b(new_n54_), .c(new_n161_), .O(new_n162_));
  aoi21  g146(.a(new_n162_), .b(new_n156_), .c(new_n37_), .O(new_n163_));
  nand2  g147(.a(new_n19_), .b(x1), .O(new_n164_));
  aoi21  g148(.a(new_n164_), .b(new_n40_), .c(new_n87_), .O(new_n165_));
  aoi21  g149(.a(x7), .b(x1), .c(new_n60_), .O(new_n166_));
  oai21  g150(.a(new_n66_), .b(new_n37_), .c(x1), .O(new_n167_));
  oai21  g151(.a(new_n166_), .b(x4), .c(new_n167_), .O(new_n168_));
  oai21  g152(.a(new_n168_), .b(new_n165_), .c(x0), .O(new_n169_));
  aoi21  g153(.a(x7), .b(x3), .c(x6), .O(new_n170_));
  oai22  g154(.a(new_n170_), .b(new_n86_), .c(new_n87_), .d(new_n18_), .O(new_n171_));
  ...
  or2    g158(.a(new_n109_), .b(new_n79_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n140_), .O(new_n176_));
  nand3  g160(.a(new_n176_), .b(new_n30_), .c(x1), .O(new_n177_));
  nand4  g161(.a(new_n41_), .b(x4), .c(x3), .d(x2), .O(new_n178_));
  nand4  g162(.a(new_n178_), .b(new_n177_), .c(new_n174_), .d(new_n169_), .O(new_n179_));
  oai21  g163(.a(new_n179_), .b(new_n163_), .c(x9), .O(new_n180_));
  nor2   g164(.a(new_n180_), .b(x8), .O(z4));
  xor2a  g165(.a(x2), .b(x0), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n145_), .c(new_n147_), .O(z5));
endmodule
