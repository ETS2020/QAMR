...
module FAU ( 
  ...
  nor2   g188(.a(x9), .b(x0), .O(new_n205_));
  nor2   g189(.a(new_n205_), .b(new_n204_), .O(z2));
  nor3   g190(.a(new_n205_), .b(new_n79_), .c(new_n104_), .O(z3));
  nand2  g191(.a(new_n26_), .b(x5), .O(new_n208_));
  nand3  g192(.a(x7), .b(new_n18_), .c(new_n42_), .O(new_n209_));
  nand2  g193(.a(x3), .b(x2), .O(new_n210_));
  oai21  g194(.a(new_n210_), .b(new_n208_), .c(new_n209_), .O(new_n211_));
  nand2  g195(.a(new_n211_), .b(x1), .O(new_n212_));
  nor2   g196(.a(x8), .b(x4), .O(new_n213_));
  inv1   g197(.a(new_n213_), .O(new_n214_));
  nand2  g198(.a(new_n214_), .b(new_n208_), .O(new_n215_));
  nand3  g199(.a(new_n215_), .b(x2), .c(new_n104_), .O(new_n216_));
  nand4  g200(.a(x7), .b(x5), .c(new_n18_), .d(new_n42_), .O(new_n217_));
  nand2  g201(.a(new_n217_), .b(new_n216_), .O(new_n218_));
  nand2  g202(.a(new_n218_), .b(new_n79_), .O(new_n219_));
  nand3  g203(.a(x7), .b(x4), .c(x3), .O(new_n220_));
  inv1   g204(.a(new_n220_), .O(new_n221_));
  or2    g205(.a(new_n213_), .b(new_n148_), .O(new_n222_));
  ...
  aoi21  g209(.a(new_n225_), .b(new_n104_), .c(x5), .O(new_n226_));
  nand4  g210(.a(new_n28_), .b(x5), .c(new_n18_), .d(new_n79_), .O(new_n227_));
  inv1   g211(.a(new_n227_), .O(new_n228_));
  oai21  g212(.a(new_n228_), .b(new_n226_), .c(new_n198_), .O(new_n229_));
  nand4  g213(.a(new_n213_), .b(x3), .c(x2), .d(x1), .O(new_n230_));
  nand2  g214(.a(new_n230_), .b(new_n229_), .O(new_n231_));
  aoi21  g215(.a(new_n224_), .b(x6), .c(new_n231_), .O(new_n232_));
  nand2  g216(.a(new_n34_), .b(x2), .O(new_n233_));
  aoi21  g217(.a(new_n233_), .b(new_n81_), .c(new_n104_), .O(new_n234_));
  nand3  g218(.a(new_n26_), .b(x6), .c(new_n104_), .O(new_n235_));
  aoi21  g219(.a(new_n235_), .b(new_n233_), .c(new_n79_), .O(new_n236_));
  oai21  g220(.a(new_n236_), .b(new_n234_), .c(new_n21_), .O(new_n237_));
  nand2  g221(.a(x3), .b(x1), .O(new_n238_));
  aoi21  g222(.a(new_n238_), .b(new_n42_), .c(new_n26_), .O(new_n239_));
  ...
  aoi21  g226(.a(new_n242_), .b(new_n237_), .c(new_n18_), .O(new_n243_));
  ...
  oai21  g236(.a(new_n232_), .b(new_n19_), .c(new_n252_), .O(new_n253_));
  nand2  g237(.a(new_n253_), .b(x9), .O(new_n254_));
  nand2  g238(.a(new_n214_), .b(new_n46_), .O(new_n255_));
  ...
  nand2  g252(.a(x2), .b(x0), .O(new_n269_));
  nand3  g253(.a(x9), .b(new_n42_), .c(new_n19_), .O(new_n270_));
