...
module FAU ( 
  ...
  nor2   g109(.a(new_n41_), .b(new_n18_), .O(new_n126_));
  ...
  inv1   g116(.a(new_n132_), .O(z3));
  nor2   g117(.a(x8), .b(new_n28_), .O(new_n134_));
  oai21  g118(.a(new_n134_), .b(new_n96_), .c(x3), .O(new_n135_));
  nand2  g119(.a(new_n134_), .b(x1), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n135_), .c(x5), .O(new_n137_));
  oai21  g121(.a(new_n28_), .b(new_n21_), .c(new_n127_), .O(new_n138_));
  aoi21  g122(.a(new_n138_), .b(new_n20_), .c(new_n17_), .O(new_n139_));
  oai21  g123(.a(new_n139_), .b(new_n137_), .c(x4), .O(new_n140_));
  nand3  g124(.a(x5), .b(new_n26_), .c(new_n66_), .O(new_n141_));
  oai21  g125(.a(x5), .b(new_n71_), .c(new_n141_), .O(new_n142_));
  nand3  g126(.a(new_n142_), .b(x7), .c(x2), .O(new_n143_));
  oai21  g127(.a(new_n19_), .b(new_n17_), .c(x1), .O(new_n144_));
  oai21  g128(.a(new_n86_), .b(x3), .c(new_n144_), .O(new_n145_));
  nand2  g129(.a(new_n145_), .b(new_n25_), .O(new_n146_));
  nand2  g130(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  oai21  g131(.a(x7), .b(new_n71_), .c(x3), .O(new_n148_));
  nand4  g132(.a(new_n148_), .b(new_n25_), .c(x5), .d(new_n28_), .O(new_n149_));
  nand4  g133(.a(new_n111_), .b(x7), .c(x3), .d(x1), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(new_n149_), .c(new_n18_), .O(new_n151_));
  aoi21  g135(.a(new_n147_), .b(x0), .c(new_n151_), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n140_), .c(new_n41_), .O(z4));
  inv1   g137(.a(new_n129_), .O(new_n154_));
  xnor2a g138(.a(x2), .b(x0), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(new_n154_), .c(new_n131_), .O(new_n156_));
