...
module FAU ( 
  ...
  nor2   g131(.a(new_n31_), .b(new_n17_), .O(new_n148_));
  nor2   g132(.a(new_n67_), .b(new_n69_), .O(new_n149_));
  nor2   g133(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  nor2   g134(.a(new_n150_), .b(new_n148_), .O(z2));
  inv1   g135(.a(new_n148_), .O(new_n152_));
  nand3  g136(.a(new_n152_), .b(x3), .c(x1), .O(new_n153_));
  ...
  nand2  g147(.a(new_n163_), .b(new_n39_), .O(new_n164_));
  nand2  g148(.a(x1), .b(x0), .O(new_n165_));
  nand2  g149(.a(new_n69_), .b(new_n57_), .O(new_n166_));
  oai22  g150(.a(new_n166_), .b(new_n104_), .c(new_n165_), .d(new_n103_), .O(new_n167_));
  ...
  aoi21  g154(.a(new_n80_), .b(new_n69_), .c(new_n57_), .O(new_n171_));
  ...
  nand3  g158(.a(new_n174_), .b(new_n125_), .c(new_n22_), .O(new_n175_));
  nand2  g159(.a(new_n175_), .b(new_n18_), .O(new_n176_));
  aoi22  g160(.a(x3), .b(new_n69_), .c(x2), .d(new_n57_), .O(new_n177_));
  aoi22  g161(.a(new_n67_), .b(x1), .c(new_n30_), .d(x0), .O(new_n178_));
  ...
  nand3  g169(.a(new_n185_), .b(new_n184_), .c(new_n152_), .O(new_n186_));
