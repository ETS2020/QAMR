...
module FAU ( 
  ...
  nor2   g005(.a(new_n20_), .b(new_n21_), .O(new_n22_));
  aoi21  g006(.a(new_n20_), .b(x5), .c(new_n22_), .O(new_n23_));
  inv1   g007(.a(x5), .O(new_n24_));
  nand3  g008(.a(new_n22_), .b(x7), .c(new_n24_), .O(new_n25_));
  ...
  nand2  g012(.a(new_n20_), .b(new_n19_), .O(new_n29_));
  ...
  nand2  g020(.a(new_n22_), .b(new_n31_), .O(new_n37_));
  ...
  or2    g026(.a(new_n42_), .b(new_n41_), .O(new_n43_));
  aoi21  g027(.a(new_n43_), .b(new_n40_), .c(x7), .O(new_n44_));
  aoi21  g028(.a(new_n44_), .b(new_n24_), .c(new_n39_), .O(new_n45_));
  nor2   g029(.a(x9), .b(x5), .O(new_n46_));
  nand2  g030(.a(new_n46_), .b(new_n19_), .O(new_n47_));
  oai21  g031(.a(new_n45_), .b(x0), .c(new_n47_), .O(new_n48_));
  oai21  g032(.a(new_n48_), .b(new_n36_), .c(x6), .O(new_n49_));
  oai21  g033(.a(new_n28_), .b(x6), .c(new_n37_), .O(new_n50_));
  nand2  g034(.a(new_n50_), .b(x0), .O(new_n51_));
  inv1   g035(.a(x6), .O(new_n52_));
  nand3  g036(.a(x9), .b(new_n31_), .c(new_n52_), .O(new_n53_));
  oai21  g037(.a(new_n31_), .b(x0), .c(new_n53_), .O(new_n54_));
  nand3  g038(.a(new_n54_), .b(x8), .c(x4), .O(new_n55_));
  oai22  g039(.a(new_n42_), .b(new_n24_), .c(x9), .d(x6), .O(new_n56_));
  ...
  nor2   g052(.a(x7), .b(new_n52_), .O(new_n69_));
  oai21  g053(.a(new_n69_), .b(x8), .c(x9), .O(new_n70_));
  nand4  g054(.a(new_n70_), .b(new_n41_), .c(new_n24_), .d(new_n17_), .O(new_n71_));
  nand2  g055(.a(new_n20_), .b(x7), .O(new_n72_));
  ...
  oai21  g065(.a(new_n81_), .b(new_n79_), .c(new_n21_), .O(new_n82_));
  ...
  aoi21  g073(.a(new_n89_), .b(new_n82_), .c(new_n20_), .O(new_n90_));
  nand3  g074(.a(new_n24_), .b(x2), .c(new_n17_), .O(new_n91_));
  aoi21  g075(.a(new_n91_), .b(x9), .c(new_n18_), .O(new_n92_));
  nand2  g076(.a(new_n21_), .b(new_n24_), .O(new_n93_));
  inv1   g077(.a(new_n93_), .O(new_n94_));
  oai21  g078(.a(new_n94_), .b(new_n92_), .c(new_n76_), .O(new_n95_));
  nand4  g079(.a(new_n20_), .b(x5), .c(new_n18_), .d(x3), .O(new_n96_));
  ...
  oai21  g083(.a(new_n21_), .b(x2), .c(new_n99_), .O(new_n100_));
  nand3  g084(.a(new_n100_), .b(new_n31_), .c(new_n17_), .O(new_n101_));
  oai21  g085(.a(x5), .b(x4), .c(x8), .O(new_n102_));
  nand3  g086(.a(new_n21_), .b(x7), .c(new_n24_), .O(new_n103_));
  ...
  nand3  g092(.a(new_n108_), .b(new_n21_), .c(x7), .O(new_n109_));
  ...
  oai21  g097(.a(x4), .b(new_n19_), .c(new_n21_), .O(new_n114_));
  ...
  aoi21  g101(.a(new_n117_), .b(new_n21_), .c(x7), .O(new_n118_));
  oai21  g102(.a(new_n118_), .b(new_n116_), .c(new_n52_), .O(new_n119_));
  nand4  g103(.a(new_n64_), .b(x8), .c(new_n31_), .d(new_n76_), .O(new_n120_));
  ...
  nand4  g109(.a(new_n24_), .b(x4), .c(x3), .d(new_n19_), .O(new_n126_));
  ...
  oai21  g118(.a(x9), .b(x3), .c(new_n134_), .O(new_n135_));
  nand2  g119(.a(new_n135_), .b(new_n18_), .O(new_n136_));
  aoi21  g120(.a(new_n136_), .b(new_n133_), .c(new_n52_), .O(new_n137_));
  ...
  aoi21  g125(.a(new_n141_), .b(x2), .c(new_n46_), .O(new_n142_));
  oai21  g126(.a(x6), .b(new_n76_), .c(x5), .O(new_n143_));
  nand3  g127(.a(new_n143_), .b(new_n20_), .c(new_n18_), .O(new_n144_));
  oai21  g128(.a(new_n142_), .b(x3), .c(new_n144_), .O(new_n145_));
  oai21  g129(.a(new_n145_), .b(new_n137_), .c(new_n125_), .O(new_n146_));
  nand2  g130(.a(x5), .b(x4), .O(new_n147_));
  nand3  g131(.a(x6), .b(new_n24_), .c(new_n18_), .O(new_n148_));
  aoi21  g132(.a(new_n148_), .b(new_n147_), .c(new_n19_), .O(new_n149_));
  nor2   g133(.a(x6), .b(new_n18_), .O(new_n150_));
  oai21  g134(.a(new_n150_), .b(new_n149_), .c(x8), .O(new_n151_));
  nand3  g135(.a(new_n150_), .b(new_n19_), .c(new_n17_), .O(new_n152_));
  aoi21  g136(.a(new_n152_), .b(new_n151_), .c(new_n76_), .O(new_n153_));
  nand3  g137(.a(new_n52_), .b(x5), .c(x4), .O(new_n154_));
  inv1   g138(.a(new_n154_), .O(new_n155_));
  oai21  g139(.a(new_n155_), .b(new_n153_), .c(x9), .O(new_n156_));
  nand4  g140(.a(new_n20_), .b(x6), .c(new_n24_), .d(new_n76_), .O(new_n157_));
  nand3  g141(.a(new_n157_), .b(new_n156_), .c(new_n146_), .O(new_n158_));
  nand2  g142(.a(new_n158_), .b(new_n31_), .O(new_n159_));
  oai21  g143(.a(new_n52_), .b(x4), .c(new_n86_), .O(new_n160_));
  nand3  g144(.a(new_n160_), .b(x8), .c(x2), .O(new_n161_));
  nand2  g145(.a(new_n139_), .b(new_n24_), .O(new_n162_));
  aoi21  g146(.a(new_n162_), .b(new_n161_), .c(x3), .O(new_n163_));
  nand2  g147(.a(x6), .b(new_n19_), .O(new_n164_));
  ...
  oai21  g152(.a(new_n168_), .b(new_n139_), .c(new_n24_), .O(new_n169_));
  aoi21  g153(.a(new_n169_), .b(new_n166_), .c(x4), .O(new_n170_));
  oai21  g154(.a(new_n170_), .b(new_n163_), .c(new_n125_), .O(new_n171_));
  nor2   g155(.a(new_n52_), .b(x5), .O(new_n172_));
  nand3  g156(.a(new_n172_), .b(x4), .c(new_n76_), .O(new_n173_));
  nor2   g157(.a(new_n76_), .b(new_n19_), .O(new_n174_));
  nand3  g158(.a(new_n174_), .b(new_n52_), .c(new_n18_), .O(new_n175_));
  ...
  aoi21  g162(.a(new_n18_), .b(x2), .c(x8), .O(new_n179_));
  nand2  g163(.a(x8), .b(x4), .O(new_n180_));
  oai21  g164(.a(new_n179_), .b(x3), .c(new_n180_), .O(new_n181_));
  nand2  g165(.a(new_n181_), .b(new_n17_), .O(new_n182_));
  nand4  g166(.a(new_n21_), .b(new_n18_), .c(x3), .d(new_n19_), .O(new_n183_));
  aoi21  g167(.a(new_n183_), .b(new_n182_), .c(new_n24_), .O(new_n184_));
  nand3  g168(.a(x7), .b(new_n24_), .c(new_n19_), .O(new_n185_));
  nand2  g169(.a(x8), .b(x2), .O(new_n186_));
  aoi21  g170(.a(new_n186_), .b(new_n185_), .c(x0), .O(new_n187_));
  nand3  g171(.a(x8), .b(new_n52_), .c(new_n19_), .O(new_n188_));
  inv1   g172(.a(new_n188_), .O(new_n189_));
  oai21  g173(.a(new_n189_), .b(new_n187_), .c(x3), .O(new_n190_));
  inv1   g174(.a(new_n103_), .O(new_n191_));
  nand3  g175(.a(new_n191_), .b(new_n76_), .c(x2), .O(new_n192_));
  aoi21  g176(.a(new_n192_), .b(new_n190_), .c(new_n18_), .O(new_n193_));
  oai21  g177(.a(new_n193_), .b(new_n184_), .c(new_n125_), .O(new_n194_));
  nand4  g178(.a(new_n65_), .b(x5), .c(new_n76_), .d(new_n19_), .O(new_n195_));
  nand2  g179(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  oai21  g180(.a(new_n196_), .b(new_n178_), .c(x9), .O(new_n197_));
  nand3  g181(.a(new_n197_), .b(new_n159_), .c(new_n124_), .O(z1));
  xor2a  g182(.a(x3), .b(x1), .O(new_n199_));
  nand2  g183(.a(new_n199_), .b(new_n72_), .O(z2));
  nand2  g184(.a(x3), .b(x1), .O(new_n201_));
  nand2  g185(.a(new_n201_), .b(new_n72_), .O(z3));
  nand2  g186(.a(x2), .b(x0), .O(new_n203_));
  aoi21  g187(.a(new_n203_), .b(new_n130_), .c(new_n199_), .O(new_n204_));
  nand2  g188(.a(new_n204_), .b(x6), .O(new_n205_));
  oai21  g189(.a(new_n174_), .b(new_n52_), .c(x4), .O(new_n206_));
  oai22  g190(.a(x3), .b(new_n17_), .c(x2), .d(new_n125_), .O(new_n207_));
  nand3  g191(.a(new_n207_), .b(new_n21_), .c(new_n52_), .O(new_n208_));
  nand3  g192(.a(new_n208_), .b(new_n206_), .c(new_n205_), .O(new_n209_));
  nand2  g193(.a(new_n209_), .b(new_n31_), .O(new_n210_));
  aoi22  g194(.a(new_n21_), .b(new_n19_), .c(x6), .d(new_n76_), .O(new_n211_));
  nand2  g195(.a(new_n52_), .b(x2), .O(new_n212_));
  nand3  g196(.a(new_n212_), .b(new_n164_), .c(x8), .O(new_n213_));
  nand3  g197(.a(new_n213_), .b(new_n76_), .c(x0), .O(new_n214_));
  oai21  g198(.a(new_n211_), .b(new_n125_), .c(new_n214_), .O(new_n215_));
  nand3  g199(.a(new_n215_), .b(x7), .c(new_n18_), .O(new_n216_));
  nor2   g200(.a(x8), .b(x3), .O(new_n217_));
  aoi21  g201(.a(new_n217_), .b(new_n19_), .c(x4), .O(new_n218_));
  nand2  g202(.a(new_n150_), .b(new_n76_), .O(new_n219_));
  oai21  g203(.a(new_n218_), .b(x1), .c(new_n219_), .O(new_n220_));
  nand2  g204(.a(new_n220_), .b(new_n17_), .O(new_n221_));
  nand4  g205(.a(new_n201_), .b(new_n52_), .c(x4), .d(new_n19_), .O(new_n222_));
  nand4  g206(.a(new_n222_), .b(new_n221_), .c(new_n216_), .d(new_n210_), .O(new_n223_));
  nand2  g207(.a(new_n223_), .b(x5), .O(new_n224_));
  oai21  g208(.a(new_n31_), .b(new_n19_), .c(x8), .O(new_n225_));
  nand2  g209(.a(new_n131_), .b(new_n125_), .O(new_n226_));
  ...
  nand3  g216(.a(new_n165_), .b(x7), .c(new_n18_), .O(new_n233_));
  nand3  g217(.a(new_n21_), .b(new_n31_), .c(new_n52_), .O(new_n234_));
  aoi21  g218(.a(new_n234_), .b(new_n233_), .c(new_n125_), .O(new_n235_));
  oai21  g219(.a(new_n235_), .b(new_n232_), .c(x0), .O(new_n236_));
  nand3  g220(.a(new_n147_), .b(new_n52_), .c(x3), .O(new_n237_));
  nand2  g221(.a(new_n172_), .b(x4), .O(new_n238_));
  aoi21  g222(.a(new_n238_), .b(new_n237_), .c(new_n31_), .O(new_n239_));
  nand2  g223(.a(new_n69_), .b(new_n76_), .O(new_n240_));
  ...
  aoi21  g238(.a(new_n254_), .b(new_n224_), .c(new_n20_), .O(z4));
  nand2  g239(.a(new_n204_), .b(new_n72_), .O(new_n256_));
