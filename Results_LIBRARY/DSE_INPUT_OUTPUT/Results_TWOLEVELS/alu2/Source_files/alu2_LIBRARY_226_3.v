...
module FAU ( 
  ...
  nand2  g105(.a(x9), .b(x6), .O(new_n122_));
  xor2a  g106(.a(x3), .b(x1), .O(new_n123_));
  nand2  g107(.a(new_n123_), .b(new_n122_), .O(z2));
  nand2  g108(.a(x3), .b(x1), .O(new_n125_));
  nand2  g109(.a(new_n125_), .b(new_n122_), .O(z3));
  nor2   g110(.a(x8), .b(new_n47_), .O(new_n127_));
  oai21  g111(.a(new_n127_), .b(new_n93_), .c(x3), .O(new_n128_));
  nand2  g112(.a(new_n127_), .b(x1), .O(new_n129_));
  aoi21  g113(.a(new_n129_), .b(new_n128_), .c(x5), .O(new_n130_));
  nand2  g114(.a(new_n125_), .b(new_n31_), .O(new_n131_));
  aoi21  g115(.a(new_n131_), .b(x7), .c(new_n24_), .O(new_n132_));
  oai21  g116(.a(new_n132_), .b(new_n130_), .c(x4), .O(new_n133_));
  nand3  g117(.a(x5), .b(new_n28_), .c(new_n64_), .O(new_n134_));
  oai21  g118(.a(x5), .b(new_n70_), .c(new_n134_), .O(new_n135_));
  nand3  g119(.a(new_n135_), .b(x7), .c(x2), .O(new_n136_));
  oai21  g120(.a(new_n29_), .b(new_n24_), .c(x1), .O(new_n137_));
  oai21  g121(.a(new_n30_), .b(x3), .c(new_n137_), .O(new_n138_));
  nand2  g122(.a(new_n138_), .b(new_n37_), .O(new_n139_));
  nand2  g123(.a(new_n139_), .b(new_n136_), .O(new_n140_));
  nand2  g124(.a(new_n140_), .b(x0), .O(new_n141_));
  oai21  g125(.a(x7), .b(new_n70_), .c(x3), .O(new_n142_));
  nand4  g126(.a(new_n142_), .b(new_n37_), .c(x5), .d(new_n47_), .O(new_n143_));
  nand4  g127(.a(new_n108_), .b(x7), .c(x3), .d(x1), .O(new_n144_));
  nand4  g128(.a(new_n144_), .b(new_n143_), .c(new_n141_), .d(new_n133_), .O(new_n145_));
  nand3  g129(.a(new_n145_), .b(x9), .c(new_n17_), .O(new_n146_));
  inv1   g130(.a(new_n146_), .O(z4));
  nand2  g131(.a(new_n47_), .b(new_n19_), .O(new_n148_));
  aoi21  g132(.a(new_n148_), .b(new_n31_), .c(new_n123_), .O(new_n149_));
  nand2  g133(.a(new_n149_), .b(new_n122_), .O(new_n150_));
  inv1   g134(.a(new_n150_), .O(z5));
endmodule
