...
module FAU ( 
  ...
  aoi21  g117(.a(x9), .b(new_n17_), .c(new_n133_), .O(z2));
  oai22  g118(.a(new_n21_), .b(x0), .c(new_n82_), .d(new_n83_), .O(z3));
  nand3  g119(.a(x8), .b(x3), .c(x2), .O(new_n136_));
  nand2  g120(.a(new_n136_), .b(x6), .O(new_n137_));
  nand3  g121(.a(new_n137_), .b(x4), .c(x0), .O(new_n138_));
  inv1   g122(.a(new_n133_), .O(new_n139_));
  nand3  g123(.a(new_n139_), .b(x6), .c(x2), .O(new_n140_));
  nand3  g124(.a(new_n25_), .b(new_n38_), .c(new_n82_), .O(new_n141_));
  nand3  g125(.a(new_n141_), .b(new_n140_), .c(new_n138_), .O(new_n142_));
  nand2  g126(.a(new_n142_), .b(new_n24_), .O(new_n143_));
  nand3  g127(.a(x7), .b(x6), .c(new_n18_), .O(new_n144_));
  aoi21  g128(.a(new_n144_), .b(new_n39_), .c(x3), .O(new_n145_));
  nand3  g129(.a(new_n38_), .b(x4), .c(new_n83_), .O(new_n146_));
  inv1   g130(.a(new_n146_), .O(new_n147_));
  oai21  g131(.a(new_n147_), .b(new_n145_), .c(new_n19_), .O(new_n148_));
  oai21  g132(.a(x6), .b(new_n19_), .c(x8), .O(new_n149_));
  nand4  g133(.a(new_n149_), .b(x7), .c(new_n18_), .d(new_n82_), .O(new_n150_));
  nand3  g134(.a(new_n150_), .b(new_n148_), .c(new_n143_), .O(new_n151_));
  oai21  g135(.a(new_n59_), .b(new_n17_), .c(x5), .O(new_n152_));
  nand3  g136(.a(new_n152_), .b(new_n82_), .c(x1), .O(new_n153_));
  nand2  g137(.a(new_n25_), .b(new_n24_), .O(new_n154_));
  oai22  g138(.a(new_n154_), .b(new_n19_), .c(x5), .d(new_n82_), .O(new_n155_));
  nand3  g139(.a(new_n155_), .b(x4), .c(new_n83_), .O(new_n156_));
  oai22  g140(.a(x8), .b(x4), .c(x7), .d(x2), .O(new_n157_));
  nand2  g141(.a(new_n157_), .b(new_n31_), .O(new_n158_));
  ...
  nand2  g145(.a(x7), .b(x2), .O(new_n162_));
  aoi22  g146(.a(new_n162_), .b(x8), .c(new_n161_), .d(new_n83_), .O(new_n163_));
  nand3  g147(.a(x7), .b(x3), .c(x1), .O(new_n164_));
  inv1   g148(.a(new_n164_), .O(new_n165_));
  oai21  g149(.a(new_n165_), .b(new_n163_), .c(new_n31_), .O(new_n166_));
  oai21  g150(.a(new_n38_), .b(new_n19_), .c(x3), .O(new_n167_));
  nand2  g151(.a(new_n167_), .b(x8), .O(new_n168_));
  nand3  g152(.a(new_n168_), .b(x7), .c(new_n18_), .O(new_n169_));
  oai21  g153(.a(new_n154_), .b(x6), .c(new_n169_), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(x1), .O(new_n171_));
  nand4  g155(.a(new_n171_), .b(new_n166_), .c(new_n160_), .d(x0), .O(new_n172_));
  aoi21  g156(.a(new_n151_), .b(x5), .c(new_n172_), .O(new_n173_));
  nor2   g157(.a(new_n173_), .b(new_n21_), .O(z4));
  nand2  g158(.a(x2), .b(x0), .O(new_n175_));
  nand2  g159(.a(new_n29_), .b(new_n17_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n175_), .c(new_n133_), .O(z5));
endmodule
