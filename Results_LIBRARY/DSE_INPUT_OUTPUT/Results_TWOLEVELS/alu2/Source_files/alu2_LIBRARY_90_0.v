...
module FAU ( 
  ...
  aoi21  g127(.a(new_n143_), .b(new_n141_), .c(x8), .O(new_n144_));
  aoi21  g128(.a(x2), .b(new_n83_), .c(x5), .O(new_n145_));
  aoi21  g129(.a(x5), .b(x2), .c(new_n19_), .O(new_n146_));
  oai21  g130(.a(new_n145_), .b(x0), .c(new_n146_), .O(new_n147_));
  nand2  g131(.a(new_n147_), .b(new_n34_), .O(new_n148_));
  oai21  g132(.a(new_n34_), .b(x0), .c(new_n76_), .O(new_n149_));
  nand3  g133(.a(new_n149_), .b(x9), .c(new_n83_), .O(new_n150_));
  aoi21  g134(.a(new_n150_), .b(new_n148_), .c(new_n42_), .O(new_n151_));
  oai21  g135(.a(new_n151_), .b(new_n144_), .c(x4), .O(new_n152_));
  nand3  g136(.a(new_n34_), .b(x5), .c(new_n18_), .O(new_n153_));
  nand3  g137(.a(new_n42_), .b(x7), .c(x6), .O(new_n154_));
  aoi21  g138(.a(new_n154_), .b(new_n153_), .c(new_n43_), .O(new_n155_));
  nand2  g139(.a(x6), .b(new_n18_), .O(new_n156_));
  nand2  g140(.a(new_n34_), .b(new_n43_), .O(new_n157_));
  aoi21  g141(.a(new_n157_), .b(new_n156_), .c(new_n42_), .O(new_n158_));
  oai21  g142(.a(new_n158_), .b(new_n155_), .c(new_n17_), .O(new_n159_));
  nand4  g143(.a(new_n88_), .b(new_n19_), .c(x5), .d(new_n43_), .O(new_n160_));
  nand2  g144(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nor3   g145(.a(new_n29_), .b(x2), .c(x1), .O(new_n162_));
  aoi21  g146(.a(new_n161_), .b(x1), .c(new_n162_), .O(new_n163_));
  nand4  g147(.a(new_n163_), .b(new_n152_), .c(new_n139_), .d(new_n129_), .O(new_n164_));
  nand2  g148(.a(new_n164_), .b(x3), .O(new_n165_));
  nand3  g149(.a(x8), .b(x7), .c(x6), .O(new_n166_));
  inv1   g150(.a(new_n166_), .O(new_n167_));
  oai21  g151(.a(new_n167_), .b(new_n86_), .c(x0), .O(new_n168_));
  nand2  g152(.a(new_n43_), .b(x0), .O(new_n169_));
  nand4  g153(.a(new_n169_), .b(x8), .c(new_n34_), .d(x6), .O(new_n170_));
  nand2  g154(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand2  g155(.a(new_n171_), .b(new_n83_), .O(new_n172_));
  nand2  g156(.a(x7), .b(x6), .O(new_n173_));
  nand2  g157(.a(new_n34_), .b(new_n19_), .O(new_n174_));
  aoi21  g158(.a(new_n174_), .b(new_n173_), .c(new_n83_), .O(new_n175_));
  aoi21  g159(.a(new_n175_), .b(new_n17_), .c(new_n30_), .O(new_n176_));
  aoi21  g160(.a(new_n176_), .b(new_n172_), .c(x5), .O(new_n177_));
  nand3  g161(.a(x7), .b(x6), .c(x0), .O(new_n178_));
  nand4  g162(.a(new_n34_), .b(new_n19_), .c(new_n43_), .d(new_n17_), .O(new_n179_));
  aoi21  g163(.a(new_n179_), .b(new_n178_), .c(new_n18_), .O(new_n180_));
  nand2  g164(.a(new_n30_), .b(x6), .O(new_n181_));
  oai21  g165(.a(new_n58_), .b(x6), .c(new_n181_), .O(new_n182_));
  oai21  g166(.a(new_n182_), .b(new_n180_), .c(x1), .O(new_n183_));
  oai21  g167(.a(new_n71_), .b(new_n18_), .c(x9), .O(new_n184_));
  nand2  g168(.a(new_n184_), .b(new_n34_), .O(new_n185_));
  nand2  g169(.a(new_n185_), .b(new_n183_), .O(new_n186_));
  aoi21  g170(.a(new_n177_), .b(new_n18_), .c(new_n186_), .O(new_n187_));
  nand3  g171(.a(new_n187_), .b(new_n165_), .c(new_n125_), .O(z1));
  nor2   g172(.a(x9), .b(x7), .O(new_n189_));
  xor2a  g173(.a(x3), .b(x1), .O(new_n190_));
  nor2   g174(.a(new_n190_), .b(new_n189_), .O(z2));
  nor3   g175(.a(new_n189_), .b(new_n75_), .c(new_n83_), .O(z3));
  ...
  aoi21  g180(.a(new_n196_), .b(x6), .c(new_n18_), .O(new_n197_));
  nand2  g181(.a(new_n43_), .b(x1), .O(new_n198_));
  nand2  g182(.a(new_n75_), .b(x0), .O(new_n199_));
  aoi21  g183(.a(new_n199_), .b(new_n198_), .c(x8), .O(new_n200_));
  aoi21  g184(.a(new_n200_), .b(new_n19_), .c(new_n197_), .O(new_n201_));
  aoi21  g185(.a(new_n201_), .b(new_n195_), .c(x7), .O(new_n202_));
  oai22  g186(.a(x8), .b(x2), .c(new_n19_), .d(x3), .O(new_n203_));
  nand2  g187(.a(new_n203_), .b(x1), .O(new_n204_));
  aoi21  g188(.a(new_n19_), .b(x2), .c(new_n42_), .O(new_n205_));
  oai21  g189(.a(new_n19_), .b(x2), .c(new_n205_), .O(new_n206_));
  nand3  g190(.a(new_n206_), .b(new_n75_), .c(x0), .O(new_n207_));
  nand2  g191(.a(new_n207_), .b(new_n204_), .O(new_n208_));
  nand3  g192(.a(new_n208_), .b(x7), .c(new_n18_), .O(new_n209_));
  nor2   g193(.a(x8), .b(x3), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n43_), .c(x4), .O(new_n211_));
  oai22  g195(.a(new_n211_), .b(x1), .c(new_n102_), .d(x3), .O(new_n212_));
  nand2  g196(.a(x3), .b(x1), .O(new_n213_));
  nand4  g197(.a(new_n213_), .b(new_n19_), .c(x4), .d(new_n43_), .O(new_n214_));
  inv1   g198(.a(new_n214_), .O(new_n215_));
  aoi21  g199(.a(new_n212_), .b(new_n17_), .c(new_n215_), .O(new_n216_));
  aoi21  g200(.a(new_n216_), .b(new_n209_), .c(new_n30_), .O(new_n217_));
  oai21  g201(.a(new_n217_), .b(new_n202_), .c(x5), .O(new_n218_));
  nand2  g202(.a(x7), .b(x2), .O(new_n219_));
  nand2  g203(.a(x4), .b(x3), .O(new_n220_));
  aoi22  g204(.a(new_n220_), .b(new_n83_), .c(new_n219_), .d(x8), .O(new_n221_));
  nand3  g205(.a(x7), .b(x4), .c(x3), .O(new_n222_));
  nand2  g206(.a(new_n42_), .b(new_n18_), .O(new_n223_));
  aoi21  g207(.a(new_n223_), .b(new_n222_), .c(new_n19_), .O(new_n224_));
  oai21  g208(.a(new_n224_), .b(new_n221_), .c(new_n27_), .O(new_n225_));
  oai21  g209(.a(new_n19_), .b(x2), .c(x8), .O(new_n226_));
  nand4  g210(.a(new_n226_), .b(x7), .c(new_n18_), .d(x1), .O(new_n227_));
  aoi21  g211(.a(new_n227_), .b(new_n225_), .c(new_n30_), .O(new_n228_));
  nand2  g212(.a(new_n86_), .b(x1), .O(new_n229_));
  aoi21  g213(.a(new_n229_), .b(new_n67_), .c(x7), .O(new_n230_));
  oai21  g214(.a(new_n230_), .b(new_n228_), .c(x0), .O(new_n231_));
  nand2  g215(.a(x5), .b(x4), .O(new_n232_));
  nand3  g216(.a(new_n232_), .b(new_n19_), .c(x3), .O(new_n233_));
  nand2  g217(.a(new_n20_), .b(x4), .O(new_n234_));
  aoi21  g218(.a(new_n234_), .b(new_n233_), .c(new_n34_), .O(new_n235_));
  nand3  g219(.a(new_n77_), .b(new_n42_), .c(new_n27_), .O(new_n236_));
  inv1   g220(.a(new_n236_), .O(new_n237_));
  oai21  g221(.a(new_n237_), .b(new_n235_), .c(x9), .O(new_n238_));
  nand3  g222(.a(new_n38_), .b(new_n27_), .c(new_n75_), .O(new_n239_));
  aoi21  g223(.a(new_n239_), .b(new_n238_), .c(new_n83_), .O(new_n240_));
  nand2  g224(.a(new_n38_), .b(new_n17_), .O(new_n241_));
  nand2  g225(.a(new_n59_), .b(x3), .O(new_n242_));
  aoi21  g226(.a(new_n242_), .b(new_n241_), .c(new_n43_), .O(new_n243_));
  nand3  g227(.a(new_n38_), .b(x3), .c(new_n83_), .O(new_n244_));
  inv1   g228(.a(new_n244_), .O(new_n245_));
  oai21  g229(.a(new_n245_), .b(new_n243_), .c(x4), .O(new_n246_));
  aoi21  g230(.a(new_n246_), .b(new_n80_), .c(x5), .O(new_n247_));
  nor3   g231(.a(new_n247_), .b(new_n240_), .c(new_n189_), .O(new_n248_));
  nand3  g232(.a(new_n248_), .b(new_n231_), .c(new_n218_), .O(z4));
  inv1   g233(.a(new_n189_), .O(new_n250_));
  nand2  g234(.a(new_n194_), .b(new_n250_), .O(new_n251_));
