...
module FAU ( 
  ...
  aoi21  g190(.a(new_n91_), .b(x4), .c(new_n206_), .O(z2));
  nand2  g191(.a(new_n91_), .b(x4), .O(new_n208_));
  oai21  g192(.a(new_n92_), .b(new_n141_), .c(new_n208_), .O(z3));
  nand2  g193(.a(new_n40_), .b(new_n18_), .O(new_n210_));
  aoi21  g194(.a(new_n210_), .b(new_n107_), .c(new_n206_), .O(new_n211_));
  ...
  nand2  g247(.a(new_n211_), .b(new_n208_), .O(new_n264_));
