...
module FAU ( 
  ...
  oai21  g085(.a(x29), .b(new_n80_), .c(x30), .O(new_n130_));
  ...
  oai21  g104(.a(new_n148_), .b(new_n105_), .c(new_n45_), .O(new_n149_));
  oai21  g105(.a(new_n124_), .b(new_n80_), .c(new_n149_), .O(new_n150_));
  ...
  nand2  g110(.a(x30), .b(new_n105_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n113_), .c(x27), .O(new_n157_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n148_), .c(new_n120_), .O(new_n178_));
  ...
  nand2  g137(.a(new_n90_), .b(x14), .O(new_n182_));
  ...
  nor2   g142(.a(new_n87_), .b(new_n84_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n146_), .c(new_n90_), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n132_), .c(new_n131_), .O(new_n190_));
  aoi21  g146(.a(new_n187_), .b(x11), .c(x16), .O(new_n191_));
  oai21  g147(.a(new_n87_), .b(new_n139_), .c(new_n84_), .O(new_n192_));
  inv1   g148(.a(x13), .O(new_n193_));
  nand2  g149(.a(new_n87_), .b(new_n193_), .O(new_n194_));
  nand2  g150(.a(x31), .b(new_n45_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n192_), .d(new_n155_), .O(new_n196_));
