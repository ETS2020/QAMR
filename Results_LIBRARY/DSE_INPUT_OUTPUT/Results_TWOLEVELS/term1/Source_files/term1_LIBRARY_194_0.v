...
module FAU ( 
  ...
  nand2  g071(.a(x31), .b(new_n106_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(new_n98_), .b(new_n96_), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n117_), .c(x30), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n116_), .O(new_n120_));
  aoi21  g076(.a(new_n118_), .b(x27), .c(new_n117_), .O(new_n121_));
  aoi22  g077(.a(new_n121_), .b(x30), .c(new_n120_), .d(x27), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n115_), .O(z7));
  nor3   g079(.a(new_n106_), .b(new_n98_), .c(x28), .O(new_n124_));
  nor2   g080(.a(x30), .b(x29), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n124_), .c(x27), .O(new_n126_));
  ...
  aoi21  g092(.a(new_n134_), .b(x12), .c(x17), .O(new_n137_));
  nand2  g093(.a(x19), .b(x13), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n132_), .O(new_n139_));
  nand2  g095(.a(x16), .b(x15), .O(new_n140_));
  oai22  g096(.a(new_n140_), .b(new_n129_), .c(x19), .d(x14), .O(new_n141_));
  nand3  g097(.a(x30), .b(x29), .c(x28), .O(new_n142_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n136_), .c(new_n130_), .d(new_n126_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  inv1   g104(.a(x32), .O(new_n149_));
  nand2  g105(.a(new_n106_), .b(x29), .O(new_n150_));
  nand2  g106(.a(new_n96_), .b(new_n95_), .O(new_n151_));
  ...
  nand3  g111(.a(new_n133_), .b(x18), .c(x14), .O(new_n156_));
  ...
  nand3  g127(.a(x33), .b(x30), .c(new_n96_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n171_), .c(x30), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n95_), .O(new_n174_));
  aoi21  g130(.a(new_n162_), .b(new_n160_), .c(new_n127_), .O(new_n175_));
  inv1   g131(.a(new_n165_), .O(new_n176_));
  nand4  g132(.a(new_n151_), .b(x31), .c(x30), .d(x29), .O(new_n177_));
  nand3  g133(.a(new_n117_), .b(new_n106_), .c(new_n98_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n175_), .c(new_n179_), .O(new_n180_));
  inv1   g136(.a(new_n130_), .O(new_n181_));
  inv1   g137(.a(new_n137_), .O(new_n182_));
  nand2  g138(.a(new_n117_), .b(x29), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n152_), .c(new_n116_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n141_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n139_), .c(new_n182_), .d(new_n136_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n181_), .c(x33), .O(new_n187_));
  oai21  g143(.a(new_n180_), .b(x33), .c(new_n187_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n80_), .c(x00), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n174_), .O(z9));
endmodule
