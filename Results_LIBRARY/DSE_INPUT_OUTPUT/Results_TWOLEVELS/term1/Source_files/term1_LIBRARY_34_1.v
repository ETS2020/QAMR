...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n45_), .c(x29), .d(x28), .O(new_n107_));
  oai21  g063(.a(new_n45_), .b(x28), .c(new_n107_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x27), .O(new_n109_));
  oai21  g065(.a(new_n97_), .b(new_n80_), .c(x30), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n85_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n58_), .O(z6));
  ...
  nand2  g083(.a(new_n98_), .b(new_n80_), .O(new_n128_));
  ...
  aoi21  g104(.a(new_n98_), .b(new_n80_), .c(new_n97_), .O(new_n149_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n140_), .c(x31), .O(new_n160_));
  ...
  nand2  g122(.a(new_n133_), .b(x14), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(x18), .c(x17), .d(x16), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n145_), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n159_), .c(new_n133_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n150_), .c(new_n145_), .O(new_n172_));
  ...
  aoi21  g135(.a(new_n98_), .b(new_n80_), .c(x31), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(x29), .c(new_n129_), .d(x30), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  aoi21  g139(.a(new_n142_), .b(new_n138_), .c(new_n145_), .O(new_n184_));
  inv1   g140(.a(new_n146_), .O(new_n185_));
  nand4  g141(.a(new_n128_), .b(x31), .c(x30), .d(x29), .O(new_n186_));
  nand3  g142(.a(new_n129_), .b(new_n106_), .c(new_n45_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(new_n184_), .c(new_n188_), .O(new_n189_));
