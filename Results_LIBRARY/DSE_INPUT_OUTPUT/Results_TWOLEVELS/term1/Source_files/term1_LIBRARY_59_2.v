...
module FAU ( 
  ...
  aoi21  g054(.a(new_n98_), .b(new_n58_), .c(new_n84_), .O(new_n99_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n118_), .c(x29), .O(new_n136_));
  inv1   g092(.a(x29), .O(new_n137_));
  nor2   g093(.a(new_n134_), .b(new_n137_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n118_), .c(new_n136_), .O(new_n139_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n113_), .c(x11), .O(new_n153_));
  ...
  nand4  g114(.a(new_n158_), .b(new_n139_), .c(new_n133_), .d(x31), .O(new_n159_));
  nor2   g115(.a(new_n118_), .b(new_n137_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x27), .O(new_n161_));
  oai21  g117(.a(x30), .b(x27), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n103_), .O(new_n163_));
  ...
  oai21  g122(.a(new_n166_), .b(new_n149_), .c(new_n113_), .O(new_n167_));
  inv1   g123(.a(x12), .O(new_n168_));
  oai21  g124(.a(new_n149_), .b(new_n168_), .c(new_n140_), .O(new_n169_));
  inv1   g125(.a(x13), .O(new_n170_));
  oai21  g126(.a(new_n143_), .b(new_n170_), .c(new_n141_), .O(new_n171_));
  nor2   g127(.a(x19), .b(x14), .O(new_n172_));
  nor2   g128(.a(new_n113_), .b(new_n156_), .O(new_n173_));
  ...
  inv1   g144(.a(new_n138_), .O(new_n189_));
  nand4  g145(.a(new_n158_), .b(new_n184_), .c(new_n128_), .d(new_n118_), .O(new_n190_));
  ...
  aoi21  g149(.a(new_n143_), .b(x14), .c(new_n141_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(x17), .c(x16), .d(x15), .O(new_n195_));
  inv1   g151(.a(new_n173_), .O(new_n196_));
  nand2  g152(.a(x18), .b(x17), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n196_), .c(new_n143_), .O(new_n198_));
  oai21  g154(.a(new_n197_), .b(new_n164_), .c(new_n156_), .O(new_n199_));
  inv1   g155(.a(x11), .O(new_n200_));
  oai21  g156(.a(new_n197_), .b(new_n200_), .c(new_n113_), .O(new_n201_));
  oai21  g157(.a(new_n141_), .b(new_n168_), .c(new_n140_), .O(new_n202_));
  nand2  g158(.a(new_n141_), .b(new_n170_), .O(new_n203_));
