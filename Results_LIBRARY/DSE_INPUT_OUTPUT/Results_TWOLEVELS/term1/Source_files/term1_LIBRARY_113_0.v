...
module FAU ( 
  ...
  inv1   g068(.a(new_n81_), .O(new_n113_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n117_), .c(new_n106_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n113_), .c(x25), .d(x01), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(x00), .c(x26), .O(z5));
  inv1   g078(.a(x26), .O(new_n123_));
  nand3  g079(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  inv1   g081(.a(x30), .O(new_n126_));
  nand3  g082(.a(new_n115_), .b(new_n126_), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n125_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n105_), .c(new_n113_), .d(new_n123_), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(x25), .c(x01), .d(x00), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(z6));
  nand3  g088(.a(new_n115_), .b(x30), .c(x29), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x31), .O(new_n134_));
  inv1   g090(.a(new_n101_), .O(new_n135_));
  inv1   g091(.a(new_n102_), .O(new_n136_));
  inv1   g092(.a(new_n103_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n100_), .O(new_n138_));
  nand3  g094(.a(new_n113_), .b(x25), .c(x01), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  inv1   g096(.a(x31), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x30), .c(x29), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n116_), .c(new_n46_), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(x26), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n140_), .c(new_n138_), .d(new_n134_), .O(z7));
  nand2  g101(.a(new_n114_), .b(new_n97_), .O(new_n146_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n147_), .c(x31), .d(new_n126_), .O(new_n166_));
  nand2  g122(.a(x32), .b(x30), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n146_), .c(x29), .O(new_n169_));
  nand2  g125(.a(new_n146_), .b(x29), .O(new_n170_));
  nand4  g126(.a(new_n165_), .b(new_n147_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x32), .b(new_n126_), .O(new_n172_));
  ...
  nor3   g141(.a(new_n185_), .b(new_n184_), .c(new_n141_), .O(new_n186_));
  ...
  nand3  g144(.a(new_n188_), .b(new_n174_), .c(new_n169_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n123_), .c(x00), .O(new_n190_));
  ...
  nand3  g150(.a(new_n194_), .b(new_n146_), .c(x29), .O(new_n195_));
  nand4  g151(.a(new_n165_), .b(new_n192_), .c(new_n141_), .d(new_n126_), .O(new_n196_));
  oai21  g152(.a(new_n192_), .b(new_n141_), .c(new_n196_), .O(new_n197_));
  xor2a  g153(.a(x31), .b(x30), .O(new_n198_));
  nor3   g154(.a(new_n198_), .b(new_n185_), .c(new_n184_), .O(new_n199_));
  nand4  g155(.a(new_n199_), .b(new_n183_), .c(new_n181_), .d(new_n179_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n176_), .c(x33), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(x00), .O(new_n202_));
  aoi21  g158(.a(new_n197_), .b(new_n170_), .c(new_n202_), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(new_n195_), .c(x26), .O(z9));
endmodule
