...
module FAU ( 
  ...
  nor2   g055(.a(new_n93_), .b(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x30), .c(new_n98_), .O(new_n101_));
  ...
  aoi22  g076(.a(new_n120_), .b(x30), .c(x31), .d(new_n99_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n114_), .O(z7));
  nand2  g078(.a(new_n79_), .b(x00), .O(new_n123_));
  nand3  g079(.a(x32), .b(x30), .c(x29), .O(new_n124_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n98_), .c(x30), .O(new_n129_));
  ...
  nand3  g106(.a(new_n116_), .b(new_n45_), .c(new_n99_), .O(new_n151_));
  ...
  oai21  g114(.a(new_n135_), .b(new_n158_), .c(new_n133_), .O(new_n159_));
  inv1   g115(.a(x14), .O(new_n160_));
  nand2  g116(.a(new_n135_), .b(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n143_), .b(x16), .c(x15), .O(new_n162_));
  nor2   g118(.a(new_n45_), .b(new_n98_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(x28), .c(new_n118_), .O(new_n164_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n126_), .O(z8));
  ...
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n135_), .O(new_n177_));
  ...
  aoi22  g137(.a(new_n181_), .b(new_n132_), .c(new_n133_), .d(new_n158_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n174_), .c(new_n47_), .O(new_n184_));
  aoi21  g140(.a(x31), .b(x29), .c(new_n45_), .O(new_n185_));
  oai21  g141(.a(new_n45_), .b(new_n93_), .c(x31), .O(new_n186_));
  oai21  g142(.a(new_n119_), .b(new_n93_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n99_), .c(new_n185_), .O(new_n188_));
  ...
  nand4  g148(.a(new_n116_), .b(new_n118_), .c(new_n45_), .d(new_n99_), .O(new_n193_));
  inv1   g149(.a(new_n193_), .O(new_n194_));
  nor4   g150(.a(new_n128_), .b(new_n118_), .c(new_n45_), .d(new_n98_), .O(new_n195_));
