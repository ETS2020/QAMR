...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n45_), .c(new_n81_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n80_), .c(new_n60_), .O(z3));
  inv1   g052(.a(x28), .O(new_n97_));
  nand3  g053(.a(new_n46_), .b(new_n97_), .c(x27), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(x27), .c(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n94_), .c(new_n81_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n80_), .c(new_n60_), .O(z4));
  inv1   g057(.a(x29), .O(new_n102_));
  nor2   g058(.a(new_n97_), .b(new_n45_), .O(new_n103_));
  nand3  g059(.a(new_n102_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n93_), .c(new_n61_), .d(new_n81_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n49_), .O(z5));
  nand3  g065(.a(new_n103_), .b(new_n46_), .c(x29), .O(new_n110_));
  oai21  g066(.a(new_n46_), .b(x27), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n94_), .c(new_n81_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n80_), .c(new_n60_), .O(z6));
  nand3  g069(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n114_));
  nand3  g070(.a(new_n61_), .b(x25), .c(x01), .O(new_n115_));
  nor4   g071(.a(new_n115_), .b(new_n47_), .c(x31), .d(x26), .O(new_n116_));
  oai21  g072(.a(new_n114_), .b(new_n91_), .c(new_n116_), .O(z7));
  inv1   g073(.a(x32), .O(new_n118_));
  aoi21  g074(.a(new_n46_), .b(x28), .c(x27), .O(new_n119_));
  nand2  g075(.a(x29), .b(x28), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  oai22  g077(.a(new_n121_), .b(new_n46_), .c(new_n119_), .d(new_n102_), .O(new_n122_));
  nand3  g078(.a(x19), .b(new_n88_), .c(x13), .O(new_n123_));
  inv1   g079(.a(x19), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x18), .c(x14), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n123_), .c(new_n85_), .O(new_n126_));
  nand4  g082(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n127_));
  ...
  nor2   g093(.a(new_n137_), .b(new_n131_), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n135_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n122_), .c(new_n118_), .d(x31), .O(new_n141_));
  oai21  g097(.a(x28), .b(x27), .c(x29), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n46_), .O(new_n143_));
  nand2  g099(.a(x16), .b(x10), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n131_), .c(new_n136_), .O(new_n145_));
  nor2   g101(.a(new_n124_), .b(new_n88_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x17), .c(x11), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n130_), .O(new_n148_));
  aoi21  g104(.a(new_n146_), .b(x12), .c(x17), .O(new_n149_));
  inv1   g105(.a(x13), .O(new_n150_));
  oai21  g106(.a(new_n124_), .b(new_n150_), .c(new_n88_), .O(new_n151_));
  inv1   g107(.a(x14), .O(new_n152_));
  nand2  g108(.a(new_n124_), .b(new_n152_), .O(new_n153_));
  nand3  g109(.a(new_n132_), .b(x16), .c(x15), .O(new_n154_));
  inv1   g110(.a(x31), .O(new_n155_));
  nor2   g111(.a(new_n46_), .b(new_n102_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(x28), .c(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n154_), .c(new_n153_), .d(new_n151_), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n149_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n148_), .c(new_n145_), .d(new_n143_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x32), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n141_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n81_), .c(x00), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n49_), .O(z8));
  nand4  g120(.a(x33), .b(x29), .c(new_n81_), .d(x00), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n46_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x27), .O(new_n167_));
  aoi21  g123(.a(new_n133_), .b(new_n129_), .c(new_n136_), .O(new_n168_));
  nand3  g124(.a(new_n142_), .b(new_n155_), .c(new_n46_), .O(new_n169_));
  nand3  g125(.a(new_n121_), .b(x31), .c(x30), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  oai21  g127(.a(new_n138_), .b(new_n168_), .c(new_n171_), .O(new_n172_));
  nand2  g128(.a(new_n124_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x18), .c(x17), .d(x16), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n136_), .O(new_n175_));
  nand2  g131(.a(new_n120_), .b(x31), .O(new_n176_));
  nor2   g132(.a(new_n88_), .b(new_n85_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(x16), .c(x15), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n124_), .O(new_n179_));
  inv1   g135(.a(new_n177_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n144_), .c(new_n136_), .O(new_n181_));
  nand2  g137(.a(new_n177_), .b(x11), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n85_), .O(new_n184_));
  nand2  g140(.a(new_n88_), .b(new_n150_), .O(new_n185_));
  nand3  g141(.a(new_n46_), .b(x29), .c(x28), .O(new_n186_));
  nand2  g142(.a(new_n155_), .b(x30), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n184_), .O(new_n188_));
  aoi21  g144(.a(new_n182_), .b(new_n130_), .c(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n181_), .c(new_n179_), .d(new_n176_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n175_), .c(x33), .O(new_n191_));
  oai21  g147(.a(new_n172_), .b(x33), .c(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n81_), .c(x00), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n167_), .O(z9));
endmodule
