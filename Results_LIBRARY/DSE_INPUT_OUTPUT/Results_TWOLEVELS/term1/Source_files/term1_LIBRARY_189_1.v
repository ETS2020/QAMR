...
module FAU ( 
  ...
  nor3   g048(.a(x30), .b(x22), .c(x17), .O(new_n93_));
  aoi21  g049(.a(new_n92_), .b(new_n48_), .c(new_n93_), .O(new_n94_));
  ...
  oai21  g060(.a(new_n45_), .b(x22), .c(new_n92_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n103_), .c(x29), .O(new_n107_));
  inv1   g063(.a(x29), .O(new_n108_));
  inv1   g064(.a(new_n94_), .O(new_n109_));
  ...
  nor2   g068(.a(new_n112_), .b(new_n60_), .O(z5));
  nand3  g069(.a(new_n103_), .b(x30), .c(x22), .O(new_n114_));
  nand3  g070(.a(new_n45_), .b(x28), .c(x27), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n114_), .c(new_n108_), .O(new_n116_));
  nor2   g072(.a(new_n45_), .b(x29), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n116_), .c(new_n92_), .O(new_n118_));
  nor2   g074(.a(x22), .b(x17), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x29), .c(x28), .d(x27), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n118_), .c(new_n61_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n81_), .c(x25), .d(x01), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n48_), .O(z6));
  inv1   g079(.a(x31), .O(new_n124_));
  nand3  g080(.a(new_n102_), .b(new_n124_), .c(x29), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x22), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x30), .O(new_n127_));
  nor2   g083(.a(new_n45_), .b(new_n108_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n102_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x31), .O(new_n130_));
  inv1   g086(.a(new_n119_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n132_));
  nand4  g088(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n132_), .c(new_n130_), .d(new_n127_), .O(z7));
  inv1   g091(.a(x32), .O(new_n136_));
  nor2   g092(.a(x28), .b(x27), .O(new_n137_));
  inv1   g093(.a(new_n137_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(new_n45_), .c(x29), .O(new_n139_));
  nor2   g095(.a(new_n137_), .b(new_n108_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n45_), .c(new_n139_), .O(new_n141_));
  inv1   g097(.a(x17), .O(new_n142_));
  nand3  g098(.a(x19), .b(new_n86_), .c(x13), .O(new_n143_));
  nand3  g099(.a(new_n89_), .b(x18), .c(x14), .O(new_n144_));
  ...
  nand4  g115(.a(new_n159_), .b(new_n141_), .c(new_n136_), .d(x31), .O(new_n160_));
  nand2  g116(.a(new_n128_), .b(x27), .O(new_n161_));
  ...
  oai21  g124(.a(new_n150_), .b(new_n168_), .c(new_n142_), .O(new_n169_));
  ...
  oai21  g157(.a(new_n86_), .b(new_n168_), .c(new_n142_), .O(new_n202_));
  nand2  g158(.a(new_n86_), .b(new_n170_), .O(new_n203_));
