...
module FAU ( 
  ...
  oai21  g058(.a(new_n102_), .b(new_n80_), .c(x29), .O(new_n103_));
  ...
  oai21  g070(.a(new_n114_), .b(new_n102_), .c(new_n112_), .O(new_n115_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n46_), .O(z6));
  ...
  nand2  g079(.a(x31), .b(new_n113_), .O(new_n124_));
  inv1   g080(.a(x31), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x30), .c(x29), .d(x28), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n124_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x27), .O(new_n128_));
  nand3  g084(.a(new_n111_), .b(x31), .c(x30), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n128_), .c(new_n123_), .O(z7));
  ...
  nand4  g100(.a(new_n144_), .b(new_n140_), .c(new_n138_), .d(new_n134_), .O(new_n145_));
  oai21  g101(.a(x30), .b(x27), .c(new_n145_), .O(new_n146_));
  inv1   g102(.a(new_n133_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(x16), .c(x15), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x31), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n46_), .O(new_n150_));
  nor2   g106(.a(new_n113_), .b(new_n104_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n102_), .O(new_n152_));
  oai21  g108(.a(x30), .b(x29), .c(new_n152_), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(x27), .c(new_n151_), .d(x28), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n150_), .c(new_n146_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  inv1   g112(.a(x32), .O(new_n157_));
  aoi21  g113(.a(new_n102_), .b(new_n80_), .c(new_n104_), .O(new_n158_));
  oai22  g114(.a(new_n158_), .b(new_n113_), .c(new_n114_), .d(new_n80_), .O(new_n159_));
  nand3  g115(.a(x19), .b(new_n87_), .c(x13), .O(new_n160_));
  nand3  g116(.a(new_n142_), .b(x18), .c(x14), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n160_), .c(new_n84_), .O(new_n162_));
  nand4  g118(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n162_), .c(x16), .O(new_n165_));
  nand3  g121(.a(new_n147_), .b(new_n135_), .c(x11), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x15), .O(new_n168_));
  nand4  g124(.a(new_n147_), .b(x16), .c(new_n131_), .d(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n159_), .c(new_n157_), .d(x31), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n156_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n79_), .c(x00), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(z8));
  nand2  g130(.a(new_n79_), .b(x00), .O(new_n175_));
  nand3  g131(.a(x33), .b(x30), .c(new_n102_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n80_), .O(new_n178_));
  aoi21  g134(.a(new_n166_), .b(new_n165_), .c(new_n131_), .O(new_n179_));
  inv1   g135(.a(new_n169_), .O(new_n180_));
  nand2  g136(.a(new_n102_), .b(new_n80_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  nand3  g138(.a(new_n125_), .b(new_n113_), .c(new_n104_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  oai21  g140(.a(new_n180_), .b(new_n179_), .c(new_n184_), .O(new_n185_));
  inv1   g141(.a(new_n134_), .O(new_n186_));
  inv1   g142(.a(new_n143_), .O(new_n187_));
  nand2  g143(.a(new_n142_), .b(new_n141_), .O(new_n188_));
  nand2  g144(.a(new_n148_), .b(new_n188_), .O(new_n189_));
  nand2  g145(.a(x30), .b(new_n104_), .O(new_n190_));
  nand2  g146(.a(new_n125_), .b(x29), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n190_), .c(new_n124_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n189_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n187_), .c(new_n140_), .d(new_n138_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n186_), .c(x33), .O(new_n195_));
  oai21  g151(.a(new_n185_), .b(x33), .c(new_n195_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n79_), .c(x00), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n178_), .O(z9));
endmodule
