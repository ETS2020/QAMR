...
module FAU ( 
  ...
  oai21  g061(.a(new_n96_), .b(new_n98_), .c(x27), .O(new_n106_));
  ...
  aoi22  g076(.a(new_n120_), .b(x30), .c(x31), .d(new_n97_), .O(new_n121_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n96_), .c(x30), .O(new_n128_));
  ...
  nand3  g105(.a(new_n116_), .b(new_n45_), .c(new_n97_), .O(new_n150_));
  ...
  nor2   g117(.a(new_n45_), .b(new_n96_), .O(new_n162_));
  ...
  oai21  g138(.a(new_n182_), .b(new_n173_), .c(new_n47_), .O(new_n183_));
  aoi21  g139(.a(x31), .b(x29), .c(new_n45_), .O(new_n184_));
  oai21  g140(.a(new_n45_), .b(new_n98_), .c(x31), .O(new_n185_));
  oai21  g141(.a(new_n119_), .b(new_n98_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n97_), .c(new_n184_), .O(new_n187_));
  ...
  nand4  g147(.a(new_n116_), .b(new_n118_), .c(new_n45_), .d(new_n97_), .O(new_n192_));
  inv1   g148(.a(new_n192_), .O(new_n193_));
  nor4   g149(.a(new_n127_), .b(new_n118_), .c(new_n45_), .d(new_n96_), .O(new_n194_));
