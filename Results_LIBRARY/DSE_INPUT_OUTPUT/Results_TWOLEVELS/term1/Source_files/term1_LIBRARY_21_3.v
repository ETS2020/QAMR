...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n87_), .c(new_n59_), .d(new_n78_), .O(new_n99_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n79_), .c(new_n103_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n88_), .c(new_n78_), .d(x25), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n57_), .c(new_n45_), .O(z6));
  inv1   g063(.a(new_n84_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n83_), .c(new_n81_), .O(new_n109_));
  nand3  g065(.a(new_n59_), .b(x25), .c(x01), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand3  g067(.a(new_n45_), .b(new_n111_), .c(new_n78_), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n110_), .O(new_n113_));
  oai21  g069(.a(new_n109_), .b(new_n85_), .c(new_n113_), .O(z7));
  ...
  nor2   g085(.a(x19), .b(x14), .O(new_n130_));
  nand2  g086(.a(x16), .b(x15), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n116_), .c(x31), .O(new_n132_));
  nor2   g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n129_), .c(new_n125_), .d(new_n122_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n118_), .c(new_n45_), .O(new_n135_));
  nand3  g091(.a(x30), .b(x29), .c(x28), .O(new_n136_));
  oai21  g092(.a(x30), .b(x28), .c(new_n136_), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n79_), .c(new_n103_), .d(new_n96_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand3  g097(.a(new_n104_), .b(x30), .c(new_n79_), .O(new_n142_));
  nand2  g098(.a(new_n94_), .b(new_n79_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n103_), .c(x29), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  nand3  g101(.a(x19), .b(new_n127_), .c(x13), .O(new_n146_));
  nand3  g102(.a(new_n128_), .b(x18), .c(x14), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n146_), .c(new_n124_), .O(new_n148_));
  nand4  g104(.a(x19), .b(x18), .c(new_n124_), .d(x12), .O(new_n149_));
  ...
  nand4  g114(.a(new_n158_), .b(new_n145_), .c(new_n141_), .d(x31), .O(new_n159_));
  ...
  nand2  g118(.a(new_n128_), .b(x14), .O(new_n163_));
  ...
  oai21  g122(.a(new_n166_), .b(new_n131_), .c(new_n128_), .O(new_n167_));
  ...
  aoi22  g127(.a(new_n171_), .b(new_n124_), .c(new_n127_), .d(new_n126_), .O(new_n172_));
  ...
  nand2  g130(.a(new_n143_), .b(x29), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n111_), .O(new_n176_));
  nand2  g132(.a(new_n104_), .b(x31), .O(new_n177_));
  oai21  g133(.a(x31), .b(new_n103_), .c(new_n177_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n79_), .c(new_n176_), .d(new_n103_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n174_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  aoi21  g137(.a(new_n153_), .b(new_n151_), .c(new_n156_), .O(new_n182_));
  ...
  nand3  g143(.a(new_n111_), .b(new_n103_), .c(new_n96_), .O(new_n188_));
