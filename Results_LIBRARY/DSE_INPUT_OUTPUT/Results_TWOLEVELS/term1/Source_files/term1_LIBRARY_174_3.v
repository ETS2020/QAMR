...
module FAU ( 
  ...
  aoi21  g079(.a(new_n123_), .b(new_n103_), .c(new_n97_), .O(new_n124_));
  ...
  oai21  g087(.a(new_n129_), .b(new_n46_), .c(x30), .O(new_n132_));
  ...
  nor2   g105(.a(new_n110_), .b(new_n46_), .O(new_n150_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n141_), .c(new_n146_), .O(new_n155_));
  nor2   g111(.a(new_n89_), .b(new_n86_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(x17), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n156_), .b(x12), .O(new_n158_));
  ...
  nor2   g118(.a(new_n140_), .b(new_n146_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n142_), .c(new_n162_), .O(new_n164_));
  oai21  g120(.a(x30), .b(x29), .c(x31), .O(new_n165_));
  aoi21  g121(.a(new_n150_), .b(x28), .c(new_n165_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n164_), .c(new_n161_), .d(new_n159_), .O(new_n167_));
  aoi21  g123(.a(new_n157_), .b(new_n140_), .c(new_n167_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n155_), .c(new_n153_), .O(new_n169_));
  ...
  nand2  g131(.a(x33), .b(new_n121_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n130_), .O(new_n178_));
  aoi21  g134(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n179_));
  inv1   g135(.a(new_n147_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n174_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(x31), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n110_), .c(new_n102_), .d(new_n81_), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(new_n178_), .c(new_n46_), .O(new_n184_));
  aoi21  g140(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(x17), .c(x16), .d(x15), .O(new_n186_));
  nand2  g142(.a(new_n150_), .b(new_n130_), .O(new_n187_));
  ...
  nand3  g148(.a(new_n190_), .b(x16), .c(x10), .O(new_n193_));
  nand2  g149(.a(new_n121_), .b(x30), .O(new_n194_));
  inv1   g150(.a(x11), .O(new_n195_));
  oai21  g151(.a(new_n189_), .b(new_n195_), .c(new_n140_), .O(new_n196_));
  nand2  g152(.a(x18), .b(x12), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n83_), .O(new_n198_));
  nand2  g154(.a(new_n86_), .b(new_n160_), .O(new_n199_));
  nand4  g155(.a(new_n199_), .b(new_n198_), .c(new_n196_), .d(new_n194_), .O(new_n200_));
  aoi21  g156(.a(new_n193_), .b(new_n146_), .c(new_n200_), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n192_), .c(new_n188_), .d(new_n186_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(x33), .O(new_n203_));
  nand3  g159(.a(new_n182_), .b(new_n110_), .c(new_n46_), .O(new_n204_));
  aoi21  g160(.a(new_n204_), .b(new_n203_), .c(x26), .O(new_n205_));
  oai21  g161(.a(new_n205_), .b(new_n184_), .c(x00), .O(new_n206_));
