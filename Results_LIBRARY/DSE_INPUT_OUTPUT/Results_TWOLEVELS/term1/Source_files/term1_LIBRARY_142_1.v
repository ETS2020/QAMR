...
module FAU ( 
  ...
  nand3  g085(.a(x32), .b(new_n129_), .c(x00), .O(new_n130_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n111_), .c(x29), .O(new_n136_));
  nor2   g092(.a(new_n134_), .b(new_n100_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n111_), .c(new_n136_), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n88_), .c(x13), .O(new_n139_));
  nand3  g095(.a(new_n91_), .b(x18), .c(x14), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n85_), .O(new_n141_));
  ...
  nand3  g102(.a(new_n146_), .b(new_n129_), .c(x11), .O(new_n147_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n138_), .c(new_n133_), .d(x31), .O(new_n153_));
  ...
  nand2  g113(.a(x17), .b(x15), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n129_), .O(new_n159_));
  nand2  g115(.a(x17), .b(x10), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n157_), .c(new_n150_), .O(new_n161_));
  inv1   g117(.a(x12), .O(new_n162_));
  oai21  g118(.a(new_n157_), .b(new_n162_), .c(new_n85_), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  oai21  g120(.a(new_n91_), .b(new_n164_), .c(new_n88_), .O(new_n165_));
  nor2   g121(.a(x19), .b(x14), .O(new_n166_));
  nor2   g122(.a(new_n129_), .b(new_n150_), .O(new_n167_));
  ...
  nand2  g132(.a(new_n176_), .b(new_n132_), .O(z8));
  nand3  g133(.a(x33), .b(new_n129_), .c(x00), .O(new_n178_));
  ...
  nand2  g138(.a(x33), .b(new_n118_), .O(new_n183_));
  ...
  nand4  g142(.a(new_n152_), .b(new_n181_), .c(new_n118_), .d(new_n111_), .O(new_n187_));
  ...
  oai21  g149(.a(new_n193_), .b(new_n150_), .c(new_n91_), .O(new_n194_));
  inv1   g150(.a(x10), .O(new_n195_));
  oai21  g151(.a(new_n193_), .b(new_n195_), .c(new_n150_), .O(new_n196_));
  oai21  g152(.a(new_n88_), .b(new_n162_), .c(new_n85_), .O(new_n197_));
  nand2  g153(.a(new_n88_), .b(new_n164_), .O(new_n198_));
  ...
  nand4  g157(.a(new_n201_), .b(new_n194_), .c(new_n192_), .d(new_n159_), .O(new_n202_));
