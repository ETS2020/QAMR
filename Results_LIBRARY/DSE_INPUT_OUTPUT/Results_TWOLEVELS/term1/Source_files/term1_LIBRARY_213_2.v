...
module FAU ( 
  ...
  nand2  g035(.a(x30), .b(x27), .O(new_n80_));
  ...
  oai21  g060(.a(new_n95_), .b(new_n97_), .c(x27), .O(new_n105_));
  oai21  g061(.a(new_n45_), .b(x27), .c(new_n105_), .O(new_n106_));
  ...
  nand2  g065(.a(new_n109_), .b(new_n47_), .O(z6));
  nor4   g066(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n111_));
  nand4  g067(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n112_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n114_), .c(new_n116_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x30), .c(x31), .d(new_n96_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n113_), .O(z7));
  nand2  g077(.a(x16), .b(x10), .O(new_n122_));
  nand3  g078(.a(x19), .b(x18), .c(x17), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n122_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(x15), .O(new_n125_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n133_), .c(new_n134_), .O(new_n136_));
  nor2   g092(.a(x19), .b(x14), .O(new_n137_));
  nand2  g093(.a(x16), .b(x15), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n123_), .c(x31), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n137_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n136_), .c(new_n132_), .d(new_n129_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n125_), .c(new_n47_), .O(new_n142_));
  nand3  g098(.a(new_n115_), .b(new_n45_), .c(new_n96_), .O(new_n143_));
  nand2  g099(.a(new_n97_), .b(new_n96_), .O(new_n144_));
  ...
  nand3  g104(.a(new_n45_), .b(x29), .c(x28), .O(new_n149_));
  oai21  g105(.a(new_n45_), .b(x28), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n96_), .O(new_n151_));
  oai21  g107(.a(new_n45_), .b(x29), .c(new_n151_), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n134_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n135_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n131_), .O(new_n155_));
  ...
  inv1   g114(.a(new_n123_), .O(new_n159_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n152_), .c(new_n148_), .d(x31), .O(new_n166_));
  ...
  nand2  g125(.a(new_n135_), .b(x14), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x18), .c(x17), .d(x16), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n163_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n138_), .c(new_n135_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n122_), .c(new_n163_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n126_), .O(new_n177_));
  nand2  g133(.a(x18), .b(x12), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n131_), .c(new_n134_), .d(new_n133_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n177_), .c(new_n175_), .d(new_n174_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n172_), .c(new_n47_), .O(new_n181_));
  aoi21  g137(.a(x31), .b(x29), .c(new_n45_), .O(new_n182_));
  oai21  g138(.a(new_n45_), .b(new_n97_), .c(x31), .O(new_n183_));
  oai21  g139(.a(new_n118_), .b(new_n97_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n96_), .c(new_n182_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n181_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x33), .O(new_n187_));
  aoi21  g143(.a(new_n160_), .b(new_n158_), .c(new_n163_), .O(new_n188_));
  inv1   g144(.a(new_n164_), .O(new_n189_));
  nand4  g145(.a(new_n115_), .b(new_n117_), .c(new_n45_), .d(new_n96_), .O(new_n190_));
  nand4  g146(.a(new_n144_), .b(x31), .c(x30), .d(x29), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n188_), .c(new_n192_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(x33), .c(new_n187_), .O(new_n194_));
