...
module FAU ( 
  ...
  nor3   g070(.a(new_n114_), .b(new_n80_), .c(new_n59_), .O(z6));
  nor2   g071(.a(new_n111_), .b(new_n100_), .O(new_n116_));
  ...
  aoi21  g082(.a(x32), .b(x00), .c(x26), .O(new_n127_));
  ...
  nor2   g087(.a(new_n129_), .b(new_n100_), .O(new_n132_));
  ...
  nand2  g109(.a(new_n153_), .b(new_n101_), .O(new_n154_));
  ...
  oai21  g115(.a(new_n141_), .b(new_n159_), .c(new_n85_), .O(new_n160_));
  ...
  aoi21  g121(.a(new_n165_), .b(new_n144_), .c(new_n163_), .O(new_n166_));
  nor2   g122(.a(x30), .b(x29), .O(new_n167_));
  aoi21  g123(.a(new_n116_), .b(x28), .c(new_n167_), .O(new_n168_));
  ...
  oai21  g130(.a(new_n127_), .b(x31), .c(new_n174_), .O(z8));
  aoi21  g131(.a(new_n149_), .b(new_n147_), .c(x33), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x31), .c(x30), .d(new_n45_), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n122_), .O(new_n178_));
  ...
  nand4  g138(.a(new_n150_), .b(new_n182_), .c(new_n122_), .d(new_n111_), .O(new_n183_));
  nand3  g139(.a(x33), .b(x31), .c(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n122_), .b(x30), .O(new_n186_));
  ...
  oai21  g145(.a(new_n189_), .b(new_n164_), .c(new_n91_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n155_), .c(new_n148_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n140_), .O(new_n193_));
  oai21  g149(.a(new_n88_), .b(new_n159_), .c(new_n85_), .O(new_n194_));
  nand2  g150(.a(new_n88_), .b(new_n161_), .O(new_n195_));
  nand2  g151(.a(x31), .b(new_n111_), .O(new_n196_));
  ...
  aoi21  g156(.a(new_n200_), .b(new_n186_), .c(new_n182_), .O(new_n201_));
  aoi21  g157(.a(new_n185_), .b(new_n181_), .c(new_n201_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n180_), .O(new_n203_));
