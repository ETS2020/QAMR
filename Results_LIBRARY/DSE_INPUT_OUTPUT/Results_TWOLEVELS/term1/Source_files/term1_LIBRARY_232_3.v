...
module FAU ( 
  ...
  nand2  g048(.a(x28), .b(new_n82_), .O(new_n93_));
  inv1   g049(.a(x28), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x27), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(new_n93_), .O(new_n96_));
  inv1   g052(.a(new_n84_), .O(new_n97_));
  nor2   g053(.a(new_n88_), .b(new_n83_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(x30), .c(new_n97_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n96_), .c(new_n62_), .O(new_n100_));
  inv1   g056(.a(new_n98_), .O(new_n101_));
  nand3  g057(.a(x30), .b(x28), .c(new_n82_), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n95_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n101_), .c(new_n62_), .d(new_n45_), .O(new_n104_));
  ...
  nor2   g065(.a(new_n94_), .b(new_n82_), .O(new_n110_));
  nand3  g066(.a(new_n109_), .b(x28), .c(x27), .O(new_n111_));
  oai21  g067(.a(new_n110_), .b(new_n109_), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n108_), .c(new_n62_), .d(new_n81_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x25), .c(x01), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n58_), .O(z5));
  nand3  g072(.a(x30), .b(new_n82_), .c(new_n45_), .O(new_n117_));
  nand2  g073(.a(new_n46_), .b(x29), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n82_), .c(new_n117_), .O(new_n119_));
  aoi21  g075(.a(x29), .b(x28), .c(new_n46_), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(new_n45_), .c(new_n119_), .d(x28), .O(new_n121_));
  inv1   g077(.a(x17), .O(new_n122_));
  inv1   g078(.a(new_n110_), .O(new_n123_));
  nand3  g079(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  oai21  g081(.a(new_n118_), .b(new_n123_), .c(new_n125_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n45_), .c(new_n122_), .O(new_n127_));
  oai21  g083(.a(new_n121_), .b(new_n98_), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g087(.a(new_n110_), .b(new_n131_), .c(x29), .O(new_n132_));
  ...
  inv1   g093(.a(new_n85_), .O(new_n138_));
  inv1   g094(.a(new_n86_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n138_), .c(new_n97_), .d(new_n137_), .O(new_n140_));
  nand4  g096(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n141_));
  inv1   g097(.a(new_n141_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n140_), .c(new_n136_), .d(new_n134_), .O(z7));
  nand2  g099(.a(new_n94_), .b(new_n82_), .O(new_n144_));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n147_), .c(new_n122_), .O(new_n150_));
  nand4  g106(.a(x19), .b(x18), .c(new_n122_), .d(x12), .O(new_n151_));
  ...
  nand4  g118(.a(new_n162_), .b(new_n145_), .c(x31), .d(new_n46_), .O(new_n163_));
  ...
  aoi21  g129(.a(new_n173_), .b(new_n156_), .c(x15), .O(new_n174_));
  nor2   g130(.a(new_n148_), .b(new_n146_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(x17), .c(x11), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n154_), .O(new_n177_));
  nand2  g133(.a(new_n175_), .b(x12), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n122_), .O(new_n179_));
  inv1   g135(.a(x13), .O(new_n180_));
  oai21  g136(.a(new_n148_), .b(new_n180_), .c(new_n146_), .O(new_n181_));
  nor2   g137(.a(x19), .b(x14), .O(new_n182_));
  nand2  g138(.a(x16), .b(x15), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n155_), .c(x31), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n181_), .c(new_n179_), .d(new_n177_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n174_), .c(x32), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n171_), .c(new_n166_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n81_), .c(x00), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n58_), .O(z8));
  inv1   g146(.a(x33), .O(new_n191_));
  nand4  g147(.a(new_n162_), .b(new_n191_), .c(x31), .d(x30), .O(new_n192_));
  nand2  g148(.a(x33), .b(new_n131_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n144_), .c(x29), .O(new_n195_));
  nand4  g151(.a(new_n162_), .b(new_n191_), .c(new_n131_), .d(new_n46_), .O(new_n196_));
  nand2  g152(.a(x33), .b(x31), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n167_), .O(new_n199_));
  aoi21  g155(.a(new_n148_), .b(x14), .c(new_n146_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(x17), .c(x16), .d(x15), .O(new_n201_));
  nand2  g157(.a(x18), .b(x17), .O(new_n202_));
  oai21  g158(.a(new_n202_), .b(new_n183_), .c(new_n148_), .O(new_n203_));
  oai21  g159(.a(new_n202_), .b(new_n172_), .c(new_n160_), .O(new_n204_));
  inv1   g160(.a(x11), .O(new_n205_));
  oai21  g161(.a(new_n202_), .b(new_n205_), .c(new_n154_), .O(new_n206_));
  nand2  g162(.a(x18), .b(x12), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(new_n122_), .O(new_n208_));
  nand2  g164(.a(new_n146_), .b(new_n180_), .O(new_n209_));
  ...
  nand4  g168(.a(new_n212_), .b(new_n204_), .c(new_n203_), .d(new_n201_), .O(new_n213_));
  nand2  g169(.a(new_n213_), .b(x33), .O(new_n214_));
  nand3  g170(.a(new_n214_), .b(new_n199_), .c(new_n195_), .O(new_n215_));
  nand3  g171(.a(new_n215_), .b(new_n81_), .c(x00), .O(new_n216_));
  nand2  g172(.a(new_n216_), .b(new_n58_), .O(z9));
endmodule
