...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n61_), .d(new_n45_), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n96_), .c(new_n59_), .O(z6));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(new_n112_), .b(new_n101_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n103_), .c(new_n96_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n119_), .c(new_n45_), .O(new_n127_));
  nand2  g083(.a(x26), .b(x00), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n127_), .O(z7));
  ...
  nor2   g089(.a(new_n131_), .b(new_n101_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n112_), .c(new_n133_), .O(new_n135_));
  nand3  g091(.a(x19), .b(new_n85_), .c(x13), .O(new_n136_));
  nand3  g092(.a(new_n88_), .b(x18), .c(x14), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n136_), .c(new_n82_), .O(new_n138_));
  nand4  g094(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n139_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n135_), .c(new_n130_), .d(x31), .O(new_n153_));
  ...
  oai21  g117(.a(new_n143_), .b(new_n161_), .c(new_n82_), .O(new_n162_));
  inv1   g118(.a(x13), .O(new_n163_));
  oai21  g119(.a(new_n88_), .b(new_n163_), .c(new_n85_), .O(new_n164_));
  ...
  aoi21  g124(.a(new_n118_), .b(x28), .c(new_n168_), .O(new_n169_));
  ...
  nand3  g130(.a(new_n174_), .b(new_n45_), .c(x00), .O(new_n175_));
  ...
  nand4  g138(.a(new_n152_), .b(new_n177_), .c(new_n117_), .d(new_n112_), .O(new_n183_));
  ...
  oai21  g146(.a(new_n190_), .b(new_n189_), .c(new_n88_), .O(new_n191_));
  ...
  oai21  g150(.a(new_n85_), .b(new_n161_), .c(new_n82_), .O(new_n195_));
  nand2  g151(.a(new_n85_), .b(new_n163_), .O(new_n196_));
  ...
  nand2  g159(.a(new_n203_), .b(new_n57_), .O(z9));
endmodule
