...
module FAU ( 
  ...
  nor2   g070(.a(new_n99_), .b(new_n94_), .O(new_n115_));
  nand2  g071(.a(new_n114_), .b(x29), .O(new_n116_));
  oai22  g072(.a(new_n116_), .b(new_n101_), .c(new_n115_), .d(new_n114_), .O(new_n117_));
  aoi22  g073(.a(new_n117_), .b(x30), .c(x31), .d(new_n45_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g075(.a(new_n80_), .b(x00), .O(new_n120_));
  nand3  g076(.a(x32), .b(x30), .c(x29), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n120_), .c(x30), .O(new_n122_));
  ...
  inv1   g104(.a(new_n115_), .O(new_n149_));
  ...
  nor2   g117(.a(new_n127_), .b(new_n99_), .O(new_n162_));
  ...
  nand3  g129(.a(new_n149_), .b(new_n114_), .c(new_n127_), .O(new_n174_));
  ...
  nand3  g134(.a(new_n114_), .b(x29), .c(x28), .O(new_n179_));
