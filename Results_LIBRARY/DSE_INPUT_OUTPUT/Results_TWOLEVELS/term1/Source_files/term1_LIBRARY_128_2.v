...
module FAU ( 
  ...
  nand3  g044(.a(new_n88_), .b(new_n60_), .c(new_n47_), .O(new_n89_));
  ...
  nand4  g066(.a(new_n110_), .b(x29), .c(x28), .d(new_n45_), .O(new_n111_));
  ...
  nand4  g109(.a(new_n149_), .b(new_n129_), .c(new_n131_), .d(x31), .O(new_n154_));
  nand2  g110(.a(new_n100_), .b(new_n80_), .O(new_n155_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n176_), .c(new_n123_), .d(new_n110_), .O(new_n181_));
  oai21  g137(.a(new_n176_), .b(new_n110_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n130_), .O(new_n183_));
  nor3   g139(.a(new_n169_), .b(new_n168_), .c(new_n126_), .O(new_n184_));
