...
module FAU ( 
  ...
  xnor2a g066(.a(x30), .b(x29), .O(new_n111_));
  ...
  nand2  g070(.a(x30), .b(new_n81_), .O(new_n115_));
  ...
  nor4   g074(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n119_));
  ...
  nand3  g103(.a(new_n147_), .b(x30), .c(x15), .O(new_n148_));
  ...
  nand3  g109(.a(x32), .b(new_n153_), .c(new_n45_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n132_), .O(new_n156_));
  aoi21  g112(.a(new_n146_), .b(new_n142_), .c(new_n130_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n133_), .c(x31), .d(new_n153_), .O(new_n158_));
  nand2  g114(.a(new_n101_), .b(new_n81_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(x32), .c(x30), .O(new_n160_));
  oai21  g116(.a(new_n158_), .b(new_n149_), .c(new_n160_), .O(new_n161_));
  aoi21  g117(.a(new_n149_), .b(x10), .c(new_n137_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(x18), .c(x17), .d(x16), .O(new_n163_));
  nor2   g119(.a(new_n137_), .b(new_n135_), .O(new_n164_));
  nor2   g120(.a(new_n134_), .b(new_n143_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n164_), .c(x15), .O(new_n166_));
  nand3  g122(.a(new_n164_), .b(x17), .c(x11), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n143_), .O(new_n168_));
  nand2  g124(.a(new_n164_), .b(x12), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n134_), .O(new_n170_));
  nand2  g126(.a(x19), .b(x13), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n135_), .O(new_n172_));
  inv1   g128(.a(x14), .O(new_n173_));
  aoi21  g129(.a(new_n137_), .b(new_n173_), .c(new_n124_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n166_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n163_), .c(new_n133_), .O(new_n177_));
  ...
  nand3  g138(.a(new_n151_), .b(new_n182_), .c(x31), .O(new_n183_));
  nand2  g139(.a(x33), .b(new_n124_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n131_), .c(x29), .O(new_n186_));
  nand4  g142(.a(new_n147_), .b(new_n182_), .c(new_n124_), .d(new_n153_), .O(new_n187_));
  oai22  g143(.a(new_n187_), .b(new_n149_), .c(new_n182_), .d(new_n153_), .O(new_n188_));
  aoi21  g144(.a(new_n137_), .b(new_n173_), .c(new_n127_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n172_), .c(new_n170_), .d(new_n168_), .O(new_n190_));
  nor2   g146(.a(new_n190_), .b(new_n166_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n163_), .c(new_n182_), .O(new_n192_));
  aoi21  g148(.a(new_n188_), .b(new_n132_), .c(new_n192_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n186_), .O(new_n194_));
