...
module FAU ( 
  ...
  nand4  g061(.a(new_n105_), .b(new_n101_), .c(new_n62_), .d(new_n45_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n100_), .c(new_n60_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n62_), .d(new_n45_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n100_), .c(new_n60_), .O(z6));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n103_), .c(new_n100_), .O(new_n124_));
  ...
  nor2   g102(.a(new_n146_), .b(new_n140_), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n130_), .c(x31), .d(x30), .O(new_n150_));
  nand2  g106(.a(x32), .b(new_n110_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n150_), .c(new_n129_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n140_), .c(new_n145_), .O(new_n154_));
  nand3  g110(.a(new_n139_), .b(x17), .c(x11), .O(new_n155_));
  ...
  nor2   g118(.a(x28), .b(new_n81_), .O(new_n163_));
  nor2   g119(.a(new_n110_), .b(new_n46_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n163_), .c(new_n121_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n162_), .c(new_n159_), .d(new_n157_), .O(new_n166_));
  aoi21  g122(.a(new_n155_), .b(new_n137_), .c(new_n166_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n154_), .c(new_n130_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n152_), .c(new_n45_), .O(new_n169_));
  inv1   g125(.a(new_n128_), .O(new_n170_));
  nand4  g126(.a(new_n149_), .b(new_n170_), .c(new_n130_), .d(x31), .O(new_n171_));
  nand3  g127(.a(x32), .b(x30), .c(x28), .O(new_n172_));
  oai21  g128(.a(new_n171_), .b(x30), .c(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x29), .O(new_n174_));
  ...
  nand2  g135(.a(x33), .b(new_n121_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n170_), .O(new_n182_));
  aoi21  g138(.a(new_n142_), .b(new_n136_), .c(new_n145_), .O(new_n183_));
  oai21  g139(.a(new_n147_), .b(new_n183_), .c(new_n178_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(x31), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n110_), .c(new_n102_), .d(new_n81_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n182_), .c(new_n46_), .O(new_n187_));
  aoi21  g143(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  nand2  g145(.a(new_n164_), .b(new_n170_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x31), .O(new_n191_));
  nand2  g147(.a(x18), .b(x17), .O(new_n192_));
  inv1   g148(.a(new_n192_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n161_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n89_), .O(new_n195_));
  nand3  g151(.a(new_n193_), .b(x16), .c(x10), .O(new_n196_));
  nand2  g152(.a(new_n121_), .b(x30), .O(new_n197_));
  inv1   g153(.a(x11), .O(new_n198_));
  oai21  g154(.a(new_n192_), .b(new_n198_), .c(new_n137_), .O(new_n199_));
  oai21  g155(.a(new_n86_), .b(new_n156_), .c(new_n83_), .O(new_n200_));
  nand2  g156(.a(new_n86_), .b(new_n158_), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n200_), .c(new_n199_), .d(new_n197_), .O(new_n202_));
  aoi21  g158(.a(new_n196_), .b(new_n145_), .c(new_n202_), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n195_), .c(new_n191_), .d(new_n189_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(x33), .O(new_n205_));
  nand3  g161(.a(new_n185_), .b(new_n110_), .c(new_n46_), .O(new_n206_));
  aoi21  g162(.a(new_n206_), .b(new_n205_), .c(x26), .O(new_n207_));
  oai21  g163(.a(new_n207_), .b(new_n187_), .c(x00), .O(new_n208_));
  nand2  g164(.a(new_n208_), .b(new_n58_), .O(z9));
endmodule
