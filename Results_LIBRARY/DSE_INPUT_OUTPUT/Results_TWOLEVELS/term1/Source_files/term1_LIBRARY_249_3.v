...
module FAU ( 
  ...
  nand2  g000(.a(x33), .b(x26), .O(new_n45_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n57_), .c(new_n45_), .O(z4));
  ...
  nor3   g061(.a(new_n105_), .b(new_n98_), .c(new_n57_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n99_), .c(new_n59_), .d(new_n78_), .O(new_n112_));
  ...
  oai21  g115(.a(new_n141_), .b(new_n159_), .c(new_n81_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n87_), .b(new_n161_), .c(new_n84_), .O(new_n162_));
  ...
  oai21  g148(.a(new_n84_), .b(new_n159_), .c(new_n81_), .O(new_n193_));
  nand2  g149(.a(new_n84_), .b(new_n161_), .O(new_n194_));
