...
module FAU ( 
  ...
  nand2  g083(.a(new_n127_), .b(new_n85_), .O(new_n128_));
  nand2  g084(.a(x19), .b(x13), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n88_), .O(new_n130_));
  inv1   g086(.a(x14), .O(new_n131_));
  nand2  g087(.a(x16), .b(x15), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n122_), .c(x31), .O(new_n133_));
  aoi21  g089(.a(new_n91_), .b(new_n131_), .c(new_n133_), .O(new_n134_));
  ...
  nand2  g134(.a(new_n91_), .b(new_n131_), .O(new_n179_));
