...
module FAU ( 
  ...
  aoi21  g046(.a(new_n90_), .b(new_n45_), .c(x27), .O(z3));
  inv1   g047(.a(x25), .O(new_n92_));
  inv1   g048(.a(x27), .O(new_n93_));
  nand3  g049(.a(new_n45_), .b(x28), .c(new_n93_), .O(new_n94_));
  oai21  g050(.a(x28), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n89_), .c(new_n80_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n92_), .c(new_n59_), .O(z4));
  xnor2a g053(.a(x29), .b(x28), .O(new_n98_));
  nand3  g054(.a(new_n45_), .b(x29), .c(new_n93_), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n93_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n92_), .c(new_n59_), .O(z5));
  inv1   g058(.a(x28), .O(new_n103_));
  inv1   g059(.a(x29), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand3  g061(.a(new_n45_), .b(x29), .c(x28), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n45_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n88_), .c(new_n61_), .d(x27), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n80_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z6));
  nor4   g067(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n112_));
  nand4  g068(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n112_), .c(new_n57_), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n105_), .b(new_n115_), .c(x30), .O(new_n116_));
  oai21  g072(.a(new_n105_), .b(new_n115_), .c(new_n116_), .O(new_n117_));
  nor2   g073(.a(new_n115_), .b(x30), .O(new_n118_));
  aoi21  g074(.a(new_n117_), .b(x27), .c(new_n118_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n114_), .O(z7));
  nand2  g076(.a(new_n80_), .b(x00), .O(new_n121_));
  nand3  g077(.a(x32), .b(new_n45_), .c(new_n103_), .O(new_n122_));
  ...
  nand3  g083(.a(new_n127_), .b(new_n45_), .c(x29), .O(new_n128_));
  nor2   g084(.a(new_n45_), .b(x29), .O(new_n129_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n131_), .c(new_n125_), .d(x31), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n142_), .c(new_n147_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nand2  g109(.a(x19), .b(x18), .O(new_n154_));
  nand2  g110(.a(x17), .b(x11), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n154_), .c(new_n141_), .O(new_n156_));
  inv1   g112(.a(x12), .O(new_n157_));
  oai21  g113(.a(new_n154_), .b(new_n157_), .c(new_n132_), .O(new_n158_));
  nand2  g114(.a(x19), .b(x13), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n133_), .O(new_n160_));
  nor2   g116(.a(x19), .b(x14), .O(new_n161_));
  nor2   g117(.a(new_n141_), .b(new_n147_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n143_), .c(new_n161_), .O(new_n163_));
  nand2  g119(.a(new_n45_), .b(new_n104_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x31), .O(new_n165_));
  aoi21  g121(.a(x30), .b(x29), .c(new_n165_), .O(new_n166_));
  and2   g122(.a(new_n166_), .b(new_n163_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n160_), .c(new_n158_), .d(new_n156_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n153_), .c(x32), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n150_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n80_), .c(x00), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n124_), .O(z8));
  inv1   g128(.a(x33), .O(new_n173_));
  aoi21  g129(.a(new_n45_), .b(new_n104_), .c(new_n126_), .O(new_n174_));
  nand3  g130(.a(x31), .b(x30), .c(x29), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(x31), .c(new_n175_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n149_), .c(new_n173_), .O(new_n177_));
  nand3  g133(.a(new_n127_), .b(new_n115_), .c(x29), .O(new_n178_));
  nor2   g134(.a(new_n129_), .b(new_n118_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n163_), .c(new_n160_), .d(new_n158_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n178_), .c(new_n156_), .d(new_n152_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n177_), .O(new_n184_));
