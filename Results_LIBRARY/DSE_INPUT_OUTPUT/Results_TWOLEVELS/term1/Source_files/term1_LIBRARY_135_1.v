...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x25), .c(x01), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n57_), .O(z5));
  nor2   g062(.a(new_n100_), .b(new_n98_), .O(new_n107_));
  nor2   g063(.a(x30), .b(new_n100_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x28), .O(new_n109_));
  oai21  g065(.a(new_n107_), .b(new_n45_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n88_), .c(new_n61_), .d(x27), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n80_), .c(x25), .d(x01), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(z6));
  nor4   g070(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n115_));
  ...
  nand3  g074(.a(new_n107_), .b(new_n118_), .c(x30), .O(new_n119_));
  oai21  g075(.a(new_n107_), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  nor2   g076(.a(new_n118_), .b(x30), .O(new_n121_));
  aoi21  g077(.a(new_n120_), .b(x27), .c(new_n121_), .O(new_n122_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n137_), .c(new_n134_), .d(new_n131_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n127_), .c(new_n57_), .O(new_n143_));
  nand2  g099(.a(new_n98_), .b(new_n93_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x29), .O(new_n145_));
  nor2   g101(.a(new_n45_), .b(new_n100_), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(x27), .c(new_n145_), .d(new_n45_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n143_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nor2   g106(.a(new_n45_), .b(x29), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n108_), .c(x27), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n109_), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n135_), .c(x13), .O(new_n154_));
  ...
  aoi21  g126(.a(new_n161_), .b(new_n160_), .c(new_n164_), .O(new_n171_));
  inv1   g127(.a(new_n165_), .O(new_n172_));
  aoi22  g128(.a(new_n45_), .b(new_n100_), .c(new_n98_), .d(new_n93_), .O(new_n173_));
  nand3  g129(.a(x31), .b(x30), .c(x29), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(x31), .c(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n172_), .b(new_n171_), .c(new_n175_), .O(new_n176_));
  inv1   g132(.a(new_n127_), .O(new_n177_));
  nand3  g133(.a(new_n144_), .b(new_n118_), .c(x29), .O(new_n178_));
  nor2   g134(.a(new_n139_), .b(new_n125_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n138_), .O(new_n180_));
  nor2   g136(.a(new_n151_), .b(new_n121_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n137_), .d(new_n134_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n178_), .c(new_n131_), .d(new_n177_), .O(new_n184_));
  ...
  nand2  g143(.a(new_n187_), .b(new_n57_), .O(z9));
endmodule
