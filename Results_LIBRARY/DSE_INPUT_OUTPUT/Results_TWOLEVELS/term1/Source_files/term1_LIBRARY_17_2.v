...
module FAU ( 
  ...
  nand3  g032(.a(new_n76_), .b(new_n45_), .c(x08), .O(new_n77_));
  ...
  nand4  g047(.a(new_n91_), .b(x25), .c(new_n45_), .d(x01), .O(new_n92_));
  ...
  aoi21  g067(.a(new_n111_), .b(new_n45_), .c(x26), .O(z6));
  ...
  nor4   g077(.a(new_n99_), .b(x31), .c(new_n108_), .d(new_n101_), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(x26), .c(x09), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(new_n119_), .d(new_n115_), .O(z7));
  ...
  nand4  g106(.a(new_n150_), .b(new_n130_), .c(new_n125_), .d(x31), .O(new_n151_));
  ...
  aoi21  g122(.a(new_n113_), .b(x28), .c(new_n166_), .O(new_n167_));
  ...
  nand4  g128(.a(new_n172_), .b(new_n79_), .c(new_n45_), .d(x00), .O(new_n173_));
  ...
  nand2  g133(.a(x33), .b(new_n177_), .O(new_n178_));
  ...
  nand4  g137(.a(new_n150_), .b(new_n175_), .c(new_n177_), .d(new_n108_), .O(new_n182_));
  ...
  inv1   g143(.a(new_n164_), .O(new_n188_));
  ...
  oai21  g149(.a(new_n132_), .b(new_n159_), .c(new_n131_), .O(new_n194_));
  nand2  g150(.a(new_n132_), .b(new_n161_), .O(new_n195_));
