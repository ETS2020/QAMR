...
module FAU ( 
  ...
  nor3   g071(.a(new_n115_), .b(new_n101_), .c(new_n63_), .O(z6));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(new_n112_), .b(new_n104_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n105_), .c(new_n101_), .O(new_n125_));
  ...
  nand2  g085(.a(new_n112_), .b(new_n82_), .O(new_n130_));
  ...
  nor2   g094(.a(new_n90_), .b(new_n87_), .O(new_n139_));
  ...
  oai21  g099(.a(new_n90_), .b(new_n143_), .c(new_n87_), .O(new_n144_));
  ...
  nor2   g113(.a(new_n155_), .b(new_n104_), .O(new_n158_));
  ...
  nand2  g148(.a(new_n192_), .b(new_n84_), .O(new_n193_));
  nand2  g149(.a(new_n87_), .b(new_n143_), .O(new_n194_));
