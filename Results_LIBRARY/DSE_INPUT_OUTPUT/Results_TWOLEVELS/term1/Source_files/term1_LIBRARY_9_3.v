...
module FAU ( 
  ...
  nand2  g034(.a(new_n78_), .b(new_n49_), .O(z2));
  inv1   g035(.a(x26), .O(new_n80_));
  inv1   g036(.a(x27), .O(new_n81_));
  nand2  g037(.a(x30), .b(x14), .O(new_n82_));
  ...
  nor2   g059(.a(new_n93_), .b(new_n81_), .O(new_n104_));
  nand3  g060(.a(new_n103_), .b(x28), .c(x27), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n103_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n49_), .O(z5));
  aoi21  g066(.a(x28), .b(x27), .c(x14), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n103_), .c(x30), .O(new_n112_));
  nand3  g068(.a(new_n104_), .b(new_n46_), .c(x29), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n87_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n60_), .c(new_n49_), .O(z6));
  nor4   g072(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n117_));
  nand4  g073(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n49_), .O(new_n119_));
  inv1   g075(.a(new_n104_), .O(new_n120_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n120_), .c(new_n122_), .O(new_n125_));
  aoi22  g081(.a(new_n125_), .b(new_n45_), .c(x31), .d(new_n46_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n131_), .b(x16), .c(x10), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  inv1   g089(.a(x16), .O(new_n134_));
  nand2  g090(.a(new_n131_), .b(x11), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand2  g092(.a(x18), .b(x12), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n129_), .O(new_n138_));
  inv1   g094(.a(x13), .O(new_n139_));
  aoi21  g095(.a(new_n130_), .b(new_n139_), .c(new_n123_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n136_), .d(new_n133_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n49_), .O(new_n142_));
  nand2  g098(.a(new_n46_), .b(x19), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(x14), .c(new_n130_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(x17), .c(x16), .d(x15), .O(new_n145_));
  nand2  g101(.a(new_n93_), .b(new_n81_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x30), .c(x29), .O(new_n147_));
  ...
  nand2  g108(.a(new_n146_), .b(x29), .O(new_n153_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n149_), .c(new_n145_), .d(new_n142_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  inv1   g114(.a(x32), .O(new_n159_));
  nand3  g115(.a(x19), .b(new_n130_), .c(x13), .O(new_n160_));
  nand3  g116(.a(new_n150_), .b(x18), .c(x14), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n160_), .c(new_n129_), .O(new_n162_));
  nand4  g118(.a(x19), .b(x18), .c(new_n129_), .d(x12), .O(new_n163_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n134_), .c(x11), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x15), .O(new_n170_));
  nand4  g126(.a(new_n167_), .b(x16), .c(new_n128_), .d(x10), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n146_), .c(new_n46_), .d(x29), .O(new_n173_));
  nand3  g129(.a(x18), .b(new_n129_), .c(x12), .O(new_n174_));
  nand3  g130(.a(new_n130_), .b(x17), .c(x13), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n174_), .c(new_n134_), .O(new_n176_));
  nand4  g132(.a(x18), .b(x17), .c(new_n134_), .d(x11), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n176_), .c(x15), .O(new_n179_));
  nand4  g135(.a(new_n131_), .b(x16), .c(new_n128_), .d(x10), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n179_), .c(new_n154_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x30), .c(x19), .d(new_n45_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n173_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n159_), .c(x31), .O(new_n184_));
  ...
  nand2  g144(.a(new_n130_), .b(new_n139_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n138_), .c(new_n136_), .d(new_n133_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n49_), .O(new_n191_));
  nand3  g147(.a(new_n153_), .b(new_n152_), .c(new_n123_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n46_), .O(new_n193_));
  aoi21  g149(.a(new_n123_), .b(x30), .c(new_n150_), .O(new_n194_));
  oai21  g150(.a(new_n154_), .b(new_n123_), .c(new_n194_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n45_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n193_), .c(new_n191_), .d(new_n145_), .O(new_n197_));
  and2   g153(.a(new_n197_), .b(x33), .O(new_n198_));
  nand4  g154(.a(new_n172_), .b(new_n153_), .c(new_n123_), .d(new_n46_), .O(new_n199_));
  nand2  g155(.a(new_n180_), .b(new_n179_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n146_), .c(x31), .d(x30), .O(new_n201_));
  inv1   g157(.a(new_n201_), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(x29), .c(x19), .d(new_n45_), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(new_n199_), .c(x33), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n198_), .c(new_n80_), .O(new_n205_));
  nor2   g161(.a(new_n205_), .b(new_n188_), .O(z9));
endmodule
