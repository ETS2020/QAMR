...
module FAU ( 
  ...
  oai21  g061(.a(new_n97_), .b(new_n98_), .c(x27), .O(new_n106_));
  ...
  aoi22  g076(.a(new_n120_), .b(x30), .c(x31), .d(new_n82_), .O(new_n121_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n137_), .c(new_n133_), .d(new_n130_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n126_), .c(new_n46_), .O(new_n143_));
  nand3  g099(.a(new_n116_), .b(new_n45_), .c(new_n82_), .O(new_n144_));
  nand2  g100(.a(new_n98_), .b(new_n82_), .O(new_n145_));
  ...
  nand3  g105(.a(new_n45_), .b(x29), .c(x28), .O(new_n150_));
  oai21  g106(.a(new_n45_), .b(x28), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n82_), .O(new_n152_));
  oai21  g108(.a(new_n45_), .b(x29), .c(new_n152_), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n135_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n136_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n132_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n132_), .d(x12), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(x16), .O(new_n159_));
  inv1   g115(.a(new_n124_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n127_), .c(x11), .O(new_n161_));
  ...
  nand2  g126(.a(new_n136_), .b(x14), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x18), .c(x17), .d(x16), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n164_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n139_), .c(new_n136_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n123_), .c(new_n164_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n127_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x12), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n132_), .c(new_n135_), .d(new_n134_), .O(new_n180_));
  ...
  oai21  g139(.a(new_n45_), .b(new_n98_), .c(x31), .O(new_n184_));
  oai21  g140(.a(new_n119_), .b(new_n98_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n82_), .c(new_n183_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  aoi21  g144(.a(new_n161_), .b(new_n159_), .c(new_n164_), .O(new_n189_));
  inv1   g145(.a(new_n165_), .O(new_n190_));
  nand4  g146(.a(new_n116_), .b(new_n118_), .c(new_n45_), .d(new_n82_), .O(new_n191_));
  nand4  g147(.a(new_n145_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  oai21  g149(.a(new_n190_), .b(new_n189_), .c(new_n193_), .O(new_n194_));
