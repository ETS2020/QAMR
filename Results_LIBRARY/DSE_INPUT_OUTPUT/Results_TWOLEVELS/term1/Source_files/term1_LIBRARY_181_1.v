...
module FAU ( 
  ...
  nand4  g061(.a(new_n105_), .b(new_n94_), .c(new_n62_), .d(new_n82_), .O(new_n106_));
  ...
  nor2   g067(.a(x30), .b(new_n103_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x28), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n111_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n62_), .d(x27), .O(new_n115_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n101_), .c(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x30), .O(new_n122_));
  nand2  g078(.a(x30), .b(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n101_), .c(x31), .O(new_n124_));
  ...
  oai21  g110(.a(new_n154_), .b(new_n112_), .c(x27), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n113_), .O(new_n156_));
