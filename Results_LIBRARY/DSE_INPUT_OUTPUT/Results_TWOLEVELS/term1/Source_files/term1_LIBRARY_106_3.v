...
module FAU ( 
  ...
  nor3   g062(.a(new_n106_), .b(new_n97_), .c(new_n60_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n62_), .d(new_n46_), .O(new_n113_));
  ...
  aoi21  g085(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x17), .c(x16), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(new_n129_), .O(new_n132_));
  nand2  g088(.a(new_n118_), .b(x27), .O(new_n133_));
  nand2  g089(.a(new_n110_), .b(new_n81_), .O(new_n134_));
  ...
  nand2  g102(.a(new_n86_), .b(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n118_), .b(x28), .O(new_n148_));
  ...
  nand3  g111(.a(new_n155_), .b(new_n110_), .c(x29), .O(new_n156_));
  nor2   g112(.a(new_n154_), .b(new_n102_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n110_), .c(new_n156_), .O(new_n158_));
  ...
  nand4  g137(.a(new_n172_), .b(new_n176_), .c(new_n117_), .d(new_n110_), .O(new_n182_));
