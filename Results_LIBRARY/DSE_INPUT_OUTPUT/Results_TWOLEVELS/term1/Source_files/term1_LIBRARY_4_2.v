...
module FAU ( 
  ...
  aoi21  g058(.a(x30), .b(new_n97_), .c(new_n81_), .O(new_n103_));
  nand4  g059(.a(x30), .b(new_n102_), .c(x28), .d(x27), .O(new_n104_));
  ...
  nor3   g062(.a(new_n106_), .b(new_n79_), .c(new_n59_), .O(z5));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n60_), .d(x30), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n80_), .c(x25), .d(x01), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n46_), .O(z6));
  ...
  oai21  g073(.a(new_n117_), .b(new_n81_), .c(x31), .O(new_n118_));
  nand4  g074(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n119_));
  nand4  g075(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n119_), .c(new_n118_), .d(new_n116_), .O(z7));
  ...
  oai21  g083(.a(new_n127_), .b(new_n102_), .c(x30), .O(new_n128_));
  ...
  nand2  g102(.a(new_n117_), .b(new_n45_), .O(new_n147_));
  ...
  oai21  g111(.a(new_n91_), .b(new_n155_), .c(new_n88_), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  nand2  g113(.a(x16), .b(x15), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n138_), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nor2   g116(.a(new_n97_), .b(x27), .O(new_n161_));
  nor2   g117(.a(new_n45_), .b(new_n102_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n113_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n160_), .c(new_n156_), .d(new_n154_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n152_), .c(new_n149_), .d(new_n147_), .O(new_n166_));
  ...
  nor2   g128(.a(new_n172_), .b(new_n143_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n158_), .c(new_n91_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n148_), .c(new_n143_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n137_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x12), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n85_), .c(new_n88_), .d(new_n155_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n176_), .d(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n173_), .c(new_n46_), .O(new_n182_));
  aoi21  g138(.a(x31), .b(x29), .c(new_n45_), .O(new_n183_));
  oai21  g139(.a(new_n45_), .b(new_n97_), .c(x31), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n114_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n81_), .c(new_n183_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n182_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(x33), .O(new_n188_));
  aoi21  g144(.a(new_n140_), .b(new_n136_), .c(new_n143_), .O(new_n189_));
  inv1   g145(.a(new_n144_), .O(new_n190_));
  nand4  g146(.a(new_n117_), .b(new_n113_), .c(new_n45_), .d(new_n81_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nor4   g148(.a(new_n127_), .b(new_n113_), .c(new_n45_), .d(new_n102_), .O(new_n193_));
