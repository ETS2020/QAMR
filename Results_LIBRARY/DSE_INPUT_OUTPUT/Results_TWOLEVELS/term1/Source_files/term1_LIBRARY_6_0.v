...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(x30), .c(new_n45_), .O(new_n91_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n60_), .c(new_n47_), .O(z4));
  inv1   g053(.a(x28), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n45_), .c(x29), .O(new_n99_));
  ...
  oai21  g066(.a(new_n110_), .b(new_n98_), .c(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n89_), .c(new_n62_), .d(new_n81_), .O(new_n112_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n136_), .c(new_n133_), .d(new_n129_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n125_), .O(new_n141_));
  nor3   g097(.a(new_n128_), .b(new_n130_), .c(new_n126_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n119_), .c(new_n47_), .O(new_n143_));
  nor2   g099(.a(new_n46_), .b(new_n100_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n98_), .O(new_n145_));
  oai21  g101(.a(x30), .b(x29), .c(new_n145_), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(x27), .c(new_n144_), .d(x28), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n143_), .c(new_n141_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nor2   g106(.a(x28), .b(x27), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n100_), .c(x30), .O(new_n152_));
  oai21  g108(.a(new_n110_), .b(new_n45_), .c(new_n152_), .O(new_n153_));
  ...
  aoi21  g113(.a(new_n157_), .b(new_n155_), .c(new_n135_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(new_n135_), .d(x12), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(x16), .O(new_n161_));
  inv1   g117(.a(new_n128_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n130_), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x15), .O(new_n165_));
  nand4  g121(.a(new_n162_), .b(x16), .c(new_n126_), .d(x10), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n153_), .c(new_n150_), .d(x31), .O(new_n168_));
  ...
  nor2   g127(.a(new_n130_), .b(new_n126_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n172_), .c(x19), .O(new_n175_));
  oai21  g131(.a(new_n173_), .b(new_n127_), .c(new_n126_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n177_), .c(new_n130_), .O(new_n178_));
  oai21  g134(.a(new_n154_), .b(new_n134_), .c(new_n135_), .O(new_n179_));
  nor2   g135(.a(x18), .b(x13), .O(new_n180_));
  nor2   g136(.a(new_n126_), .b(x14), .O(new_n181_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n175_), .c(new_n125_), .O(new_n186_));
  nor3   g142(.a(new_n48_), .b(new_n156_), .c(new_n154_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(x17), .c(x16), .d(x15), .O(new_n188_));
  nand2  g144(.a(new_n119_), .b(new_n100_), .O(new_n189_));
  ...
  nand3  g155(.a(new_n107_), .b(x31), .c(x30), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n167_), .c(new_n195_), .O(new_n202_));
