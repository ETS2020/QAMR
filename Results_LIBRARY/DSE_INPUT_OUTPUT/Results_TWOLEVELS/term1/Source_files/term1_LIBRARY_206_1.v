...
module FAU ( 
  ...
  nor2   g076(.a(new_n114_), .b(new_n103_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n105_), .O(new_n122_));
  ...
  oai21  g122(.a(new_n90_), .b(new_n166_), .c(new_n87_), .O(new_n167_));
  ...
  nand4  g141(.a(new_n155_), .b(new_n180_), .c(new_n128_), .d(new_n114_), .O(new_n186_));
  ...
  oai21  g153(.a(new_n87_), .b(new_n164_), .c(new_n84_), .O(new_n198_));
  nand2  g154(.a(new_n87_), .b(new_n166_), .O(new_n199_));
