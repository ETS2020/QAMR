...
module FAU ( 
  ...
  and2   g074(.a(x28), .b(x27), .O(new_n119_));
  nand3  g075(.a(new_n118_), .b(x28), .c(x27), .O(new_n120_));
  oai21  g076(.a(new_n119_), .b(new_n118_), .c(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n117_), .c(new_n83_), .d(new_n111_), .O(new_n122_));
  ...
  nand3  g084(.a(new_n119_), .b(new_n128_), .c(x29), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n117_), .c(new_n83_), .d(new_n111_), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(x25), .c(x01), .d(new_n45_), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(z6));
  nand3  g090(.a(new_n119_), .b(x30), .c(x29), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x31), .O(new_n136_));
  inv1   g092(.a(new_n102_), .O(new_n137_));
  nand4  g093(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n137_), .O(new_n138_));
  nor2   g094(.a(new_n101_), .b(new_n61_), .O(new_n139_));
  ...
  aoi21  g099(.a(new_n143_), .b(new_n119_), .c(new_n140_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n139_), .c(new_n138_), .d(new_n136_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n45_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n111_), .O(z7));
  zero   g103(.O(z8));
endmodule
