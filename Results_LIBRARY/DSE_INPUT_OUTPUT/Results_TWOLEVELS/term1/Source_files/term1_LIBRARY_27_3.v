...
module FAU ( 
  ...
  oai21  g046(.a(new_n82_), .b(new_n81_), .c(new_n90_), .O(new_n91_));
  nor2   g047(.a(x20), .b(x15), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  aoi21  g049(.a(new_n93_), .b(new_n91_), .c(new_n59_), .O(new_n94_));
  ...
  nand2  g053(.a(new_n84_), .b(new_n83_), .O(new_n98_));
  nor2   g054(.a(new_n92_), .b(new_n85_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n89_), .c(new_n98_), .O(new_n100_));
  and2   g056(.a(new_n100_), .b(new_n60_), .O(new_n101_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n100_), .c(new_n60_), .d(new_n79_), .O(new_n109_));
  ...
  aoi21  g069(.a(new_n113_), .b(x27), .c(x15), .O(new_n114_));
  oai21  g070(.a(x27), .b(x20), .c(new_n113_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n90_), .c(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n100_), .b(new_n82_), .c(x29), .d(x28), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n80_), .c(new_n116_), .d(new_n82_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n58_), .c(new_n45_), .O(z6));
  ...
  oai21  g104(.a(new_n148_), .b(new_n134_), .c(x31), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n147_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n146_), .c(new_n142_), .d(new_n140_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n136_), .c(new_n45_), .O(new_n152_));
  oai21  g108(.a(x28), .b(x27), .c(x30), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n104_), .O(new_n154_));
  nand2  g110(.a(new_n105_), .b(new_n80_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x29), .O(new_n156_));
  aoi22  g112(.a(new_n156_), .b(new_n82_), .c(new_n154_), .d(new_n81_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x32), .O(new_n159_));
  inv1   g115(.a(x32), .O(new_n160_));
  nand3  g116(.a(new_n156_), .b(x30), .c(new_n81_), .O(new_n161_));
  nand3  g117(.a(new_n155_), .b(new_n82_), .c(x29), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand3  g119(.a(x19), .b(new_n144_), .c(x13), .O(new_n164_));
  nand3  g120(.a(new_n145_), .b(x18), .c(x14), .O(new_n165_));
  ...
  inv1   g125(.a(new_n134_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n137_), .c(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x15), .O(new_n173_));
  inv1   g129(.a(x15), .O(new_n174_));
  nand4  g130(.a(new_n170_), .b(x16), .c(new_n174_), .d(x10), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n163_), .c(new_n160_), .d(x31), .O(new_n177_));
  ...
  nand2  g136(.a(new_n145_), .b(x14), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x18), .c(x17), .d(x16), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n174_), .O(new_n183_));
  nand2  g139(.a(x18), .b(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n148_), .c(new_n145_), .O(new_n185_));
  oai21  g141(.a(new_n184_), .b(new_n133_), .c(new_n174_), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n187_), .c(new_n137_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x12), .O(new_n189_));
  aoi22  g145(.a(new_n189_), .b(new_n83_), .c(new_n144_), .d(new_n143_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(new_n186_), .d(new_n185_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n183_), .c(new_n45_), .O(new_n192_));
  nand2  g148(.a(new_n156_), .b(new_n121_), .O(new_n193_));
  nand2  g149(.a(new_n156_), .b(x31), .O(new_n194_));
  nand2  g150(.a(new_n121_), .b(x30), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  aoi22  g152(.a(new_n196_), .b(new_n81_), .c(new_n193_), .d(new_n82_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n192_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(x33), .O(new_n199_));
  aoi21  g155(.a(new_n171_), .b(new_n169_), .c(new_n174_), .O(new_n200_));
  inv1   g156(.a(new_n175_), .O(new_n201_));
  nand4  g157(.a(new_n155_), .b(x31), .c(x30), .d(x29), .O(new_n202_));
  oai22  g158(.a(new_n202_), .b(x20), .c(new_n193_), .d(x30), .O(new_n203_));
  oai21  g159(.a(new_n201_), .b(new_n200_), .c(new_n203_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(x33), .c(new_n199_), .O(new_n205_));
