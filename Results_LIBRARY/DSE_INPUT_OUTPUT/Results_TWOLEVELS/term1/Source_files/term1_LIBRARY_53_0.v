...
module FAU ( 
  ...
  oai21  g067(.a(new_n111_), .b(new_n106_), .c(new_n110_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n89_), .c(new_n62_), .d(new_n81_), .O(new_n113_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n48_), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  nand3  g076(.a(new_n108_), .b(new_n120_), .c(x30), .O(new_n121_));
  oai21  g077(.a(new_n120_), .b(x30), .c(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x27), .O(new_n123_));
  nand3  g079(.a(new_n109_), .b(x31), .c(x30), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n123_), .c(new_n119_), .O(z7));
  ...
  nor3   g098(.a(new_n129_), .b(new_n131_), .c(new_n127_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n120_), .c(new_n48_), .O(new_n144_));
  nand2  g100(.a(new_n46_), .b(new_n107_), .O(new_n145_));
  oai21  g101(.a(new_n100_), .b(x28), .c(new_n145_), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(x27), .c(new_n101_), .d(x28), .O(new_n147_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n107_), .c(x30), .O(new_n152_));
  oai21  g108(.a(new_n111_), .b(new_n45_), .c(new_n152_), .O(new_n153_));
  ...
  aoi21  g113(.a(new_n157_), .b(new_n155_), .c(new_n136_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(new_n136_), .d(x12), .O(new_n159_));
  ...
  nor2   g127(.a(new_n131_), .b(new_n127_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n172_), .c(x19), .O(new_n175_));
  oai21  g131(.a(new_n173_), .b(new_n128_), .c(new_n127_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n177_), .c(new_n131_), .O(new_n178_));
  oai21  g134(.a(new_n154_), .b(new_n135_), .c(new_n136_), .O(new_n179_));
  nor2   g135(.a(x18), .b(x13), .O(new_n180_));
  nor2   g136(.a(new_n127_), .b(x14), .O(new_n181_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n175_), .c(new_n126_), .O(new_n186_));
  nand3  g142(.a(new_n48_), .b(x19), .c(x18), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n136_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(x16), .c(x15), .O(new_n189_));
  nand2  g145(.a(new_n120_), .b(new_n107_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n46_), .c(x27), .O(new_n191_));
  nand2  g147(.a(x31), .b(x29), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n151_), .c(x30), .O(new_n193_));
  ...
  nand3  g156(.a(new_n108_), .b(x31), .c(x30), .O(new_n201_));
