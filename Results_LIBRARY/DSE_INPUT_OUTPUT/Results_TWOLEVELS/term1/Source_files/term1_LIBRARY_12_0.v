...
module FAU ( 
  ...
  nand2  g059(.a(new_n99_), .b(x28), .O(new_n104_));
  nand2  g060(.a(x30), .b(new_n97_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n104_), .c(x27), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n88_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n61_), .c(x25), .d(x01), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(x30), .c(x26), .O(z6));
  ...
  nand4  g071(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(new_n83_), .O(new_n116_));
  ...
  nand3  g076(.a(new_n120_), .b(new_n116_), .c(new_n112_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x30), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n45_), .O(z7));
  inv1   g079(.a(x32), .O(new_n124_));
  nand2  g080(.a(new_n97_), .b(new_n80_), .O(new_n125_));
  ...
  aoi21  g113(.a(new_n128_), .b(new_n157_), .c(new_n117_), .O(new_n158_));
  ...
  aoi21  g120(.a(new_n164_), .b(x30), .c(x26), .O(z8));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n144_), .b(new_n125_), .c(new_n166_), .d(x31), .O(new_n167_));
  nand2  g123(.a(new_n128_), .b(new_n157_), .O(new_n168_));
  nor2   g124(.a(new_n117_), .b(new_n99_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n156_), .d(new_n125_), .O(new_n170_));
  ...
  oai21  g130(.a(new_n167_), .b(new_n99_), .c(new_n174_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x30), .c(new_n45_), .d(x00), .O(new_n176_));
