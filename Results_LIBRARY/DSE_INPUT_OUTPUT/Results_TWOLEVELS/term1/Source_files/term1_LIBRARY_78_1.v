...
module FAU ( 
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n81_), .d(x25), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n60_), .c(new_n46_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n94_), .c(new_n62_), .d(new_n81_), .O(new_n108_));
  ...
  nand4  g072(.a(new_n116_), .b(new_n94_), .c(new_n62_), .d(x27), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n81_), .c(x25), .d(x01), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(z6));
  inv1   g076(.a(x31), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x29), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n103_), .c(x27), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x30), .O(new_n124_));
  nand2  g080(.a(x30), .b(x29), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n103_), .c(x31), .O(new_n126_));
  ...
  nand4  g085(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(new_n124_), .O(z7));
  oai21  g086(.a(x29), .b(new_n45_), .c(x30), .O(new_n131_));
  ...
  oai21  g096(.a(new_n137_), .b(new_n140_), .c(new_n85_), .O(new_n141_));
  aoi21  g097(.a(x19), .b(x13), .c(x18), .O(new_n142_));
  nor2   g098(.a(x19), .b(x14), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n141_), .c(new_n139_), .d(new_n135_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n131_), .O(new_n146_));
  nand2  g102(.a(x16), .b(x15), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n134_), .c(x31), .O(new_n148_));
  oai21  g104(.a(x28), .b(x27), .c(x29), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n82_), .O(new_n150_));
  oai21  g106(.a(new_n125_), .b(new_n45_), .c(new_n150_), .O(new_n151_));
  aoi21  g107(.a(new_n148_), .b(new_n46_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n146_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x32), .O(new_n154_));
  inv1   g110(.a(x32), .O(new_n155_));
  nor2   g111(.a(new_n82_), .b(x29), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n114_), .c(x27), .O(new_n157_));
  ...
  nand4  g128(.a(new_n172_), .b(new_n158_), .c(new_n155_), .d(x31), .O(new_n173_));
  ...
  nor2   g134(.a(new_n178_), .b(new_n132_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x17), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n147_), .c(new_n91_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n133_), .c(new_n132_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n136_), .O(new_n184_));
  ...
  oai21  g145(.a(new_n82_), .b(x29), .c(new_n122_), .O(new_n190_));
  aoi21  g146(.a(new_n112_), .b(new_n121_), .c(x30), .O(new_n191_));
  aoi21  g147(.a(new_n190_), .b(x27), .c(new_n191_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n189_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  aoi21  g150(.a(new_n166_), .b(new_n164_), .c(new_n132_), .O(new_n195_));
  nand3  g151(.a(new_n149_), .b(new_n121_), .c(new_n82_), .O(new_n196_));
  nand4  g152(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  oai21  g154(.a(new_n170_), .b(new_n195_), .c(new_n198_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(x33), .c(new_n194_), .O(new_n200_));
