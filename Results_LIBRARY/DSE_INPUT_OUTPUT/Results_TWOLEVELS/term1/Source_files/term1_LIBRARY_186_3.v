...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n45_), .O(z5));
  nand4  g066(.a(new_n98_), .b(x29), .c(x28), .d(x27), .O(new_n111_));
  oai21  g067(.a(new_n98_), .b(x27), .c(new_n111_), .O(new_n112_));
  ...
  nor4   g072(.a(new_n116_), .b(new_n46_), .c(x31), .d(x26), .O(new_n117_));
  ...
  oai21  g083(.a(new_n124_), .b(new_n127_), .c(new_n84_), .O(new_n128_));
  inv1   g084(.a(x13), .O(new_n129_));
  inv1   g085(.a(x19), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n129_), .c(new_n87_), .O(new_n131_));
  ...
  oai21  g092(.a(new_n136_), .b(new_n122_), .c(new_n45_), .O(new_n137_));
  nand3  g093(.a(x30), .b(x29), .c(x28), .O(new_n138_));
  oai21  g094(.a(x30), .b(x28), .c(new_n138_), .O(new_n139_));
  aoi22  g095(.a(new_n139_), .b(new_n80_), .c(new_n98_), .d(new_n104_), .O(new_n140_));
  ...
  nand2  g101(.a(new_n97_), .b(new_n80_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n98_), .c(x29), .O(new_n147_));
  ...
  oai21  g126(.a(new_n169_), .b(new_n119_), .c(new_n159_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  oai21  g128(.a(new_n169_), .b(new_n172_), .c(new_n123_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x12), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(new_n84_), .c(new_n87_), .d(new_n129_), .O(new_n175_));
  ...
  nand2  g134(.a(new_n146_), .b(x29), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g136(.a(new_n144_), .b(x31), .O(new_n181_));
  oai21  g137(.a(x31), .b(new_n98_), .c(new_n181_), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n80_), .c(new_n180_), .d(new_n98_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n177_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  aoi21  g141(.a(new_n156_), .b(new_n154_), .c(new_n159_), .O(new_n186_));
  inv1   g142(.a(new_n160_), .O(new_n187_));
  nand4  g143(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nor3   g145(.a(x31), .b(x30), .c(x28), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n189_), .c(new_n80_), .O(new_n191_));
  nand3  g147(.a(new_n178_), .b(new_n98_), .c(new_n104_), .O(new_n192_));
