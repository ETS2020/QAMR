...
module FAU ( 
  ...
  nor2   g059(.a(new_n46_), .b(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n45_), .O(new_n105_));
  oai21  g061(.a(new_n102_), .b(new_n45_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n62_), .d(new_n81_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n62_), .d(new_n81_), .O(new_n113_));
  ...
  nand2  g073(.a(new_n104_), .b(x28), .O(new_n118_));
  inv1   g074(.a(new_n82_), .O(new_n119_));
  nand4  g075(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n117_), .b(x29), .c(x28), .d(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n81_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n100_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n120_), .c(new_n62_), .d(x01), .O(new_n124_));
  aoi21  g080(.a(new_n118_), .b(x31), .c(new_n124_), .O(new_n125_));
  oai21  g081(.a(new_n117_), .b(x27), .c(new_n125_), .O(z7));
  ...
  oai21  g092(.a(new_n133_), .b(new_n136_), .c(new_n83_), .O(new_n137_));
  aoi21  g093(.a(x19), .b(x13), .c(x18), .O(new_n138_));
  nor2   g094(.a(x19), .b(x14), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n138_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n137_), .c(new_n135_), .d(new_n131_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n127_), .O(new_n142_));
  inv1   g098(.a(x31), .O(new_n143_));
  nor3   g099(.a(new_n130_), .b(new_n132_), .c(new_n128_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n143_), .c(new_n47_), .O(new_n145_));
  nor3   g101(.a(new_n46_), .b(new_n103_), .c(x28), .O(new_n146_));
  nor2   g102(.a(x30), .b(x29), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(x27), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n145_), .c(new_n142_), .d(new_n118_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  nor2   g107(.a(x28), .b(x27), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n103_), .c(x30), .O(new_n153_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n132_), .c(x11), .O(new_n163_));
  ...
  nor2   g127(.a(new_n132_), .b(new_n128_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n172_), .c(x19), .O(new_n175_));
  oai21  g131(.a(new_n173_), .b(new_n129_), .c(new_n128_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n177_), .c(new_n132_), .O(new_n178_));
  oai21  g134(.a(new_n86_), .b(new_n136_), .c(new_n83_), .O(new_n179_));
  nor2   g135(.a(x18), .b(x13), .O(new_n180_));
  nor2   g136(.a(new_n128_), .b(x14), .O(new_n181_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n175_), .c(new_n127_), .O(new_n186_));
  nand3  g142(.a(new_n47_), .b(x19), .c(x18), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n83_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(x16), .c(x15), .O(new_n189_));
  nand2  g145(.a(new_n143_), .b(new_n103_), .O(new_n190_));
