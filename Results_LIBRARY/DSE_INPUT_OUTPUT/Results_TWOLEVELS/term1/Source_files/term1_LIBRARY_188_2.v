...
module FAU ( 
  ...
  and2   g51(.a(x28), .b(x27), .O(new_n96_));
  nand3  g52(.a(new_n95_), .b(x28), .c(x27), .O(new_n97_));
  oai21  g53(.a(new_n96_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(new_n87_), .c(new_n61_), .d(new_n94_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  nand4  g56(.a(new_n100_), .b(x25), .c(x01), .d(new_n45_), .O(new_n101_));
  inv1   g57(.a(new_n101_), .O(z5));
  nand3  g58(.a(x29), .b(x28), .c(x27), .O(new_n103_));
  nand2  g59(.a(new_n103_), .b(x30), .O(new_n104_));
  inv1   g60(.a(x30), .O(new_n105_));
  nand3  g61(.a(new_n96_), .b(new_n105_), .c(x29), .O(new_n106_));
  nand2  g62(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(new_n87_), .c(new_n61_), .d(new_n94_), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(new_n109_));
  nand4  g65(.a(new_n109_), .b(x25), .c(x01), .d(new_n45_), .O(new_n110_));
  inv1   g66(.a(new_n110_), .O(z6));
  nand3  g67(.a(new_n96_), .b(x30), .c(x29), .O(new_n112_));
  nand2  g68(.a(new_n112_), .b(x31), .O(new_n113_));
  nand4  g69(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n114_));
  aoi21  g70(.a(x03), .b(x02), .c(new_n60_), .O(new_n115_));
  ...
  aoi21  g75(.a(new_n119_), .b(new_n96_), .c(new_n116_), .O(new_n120_));
  nand4  g76(.a(new_n120_), .b(new_n115_), .c(new_n114_), .d(new_n113_), .O(new_n121_));
  nand2  g77(.a(new_n121_), .b(new_n45_), .O(new_n122_));
  nand2  g78(.a(new_n122_), .b(new_n94_), .O(z7));
  nor2   g79(.a(x26), .b(new_n45_), .O(z9));
endmodule
