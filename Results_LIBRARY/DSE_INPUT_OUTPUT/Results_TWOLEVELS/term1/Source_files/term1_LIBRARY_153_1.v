...
module FAU ( 
  ...
  nor2   g060(.a(new_n104_), .b(new_n45_), .O(new_n105_));
  ...
  nor2   g069(.a(x30), .b(new_n103_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n105_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n61_), .d(new_n80_), .O(new_n117_));
  ...
  nand3  g077(.a(new_n121_), .b(x29), .c(x28), .O(new_n122_));
  ...
  oai21  g087(.a(x29), .b(new_n45_), .c(x30), .O(new_n132_));
  ...
  oai21  g097(.a(new_n138_), .b(new_n141_), .c(new_n83_), .O(new_n142_));
  ...
  oai21  g104(.a(new_n148_), .b(new_n135_), .c(x31), .O(new_n149_));
  oai21  g105(.a(x28), .b(x27), .c(x29), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n81_), .O(new_n151_));
  oai21  g107(.a(new_n125_), .b(new_n45_), .c(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n149_), .b(new_n46_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n147_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  inv1   g111(.a(x32), .O(new_n156_));
  inv1   g112(.a(new_n114_), .O(new_n157_));
  nand2  g113(.a(x30), .b(new_n103_), .O(new_n158_));
  and2   g114(.a(new_n158_), .b(new_n157_), .O(new_n159_));
  oai22  g115(.a(new_n159_), .b(new_n45_), .c(new_n157_), .d(new_n104_), .O(new_n160_));
  nand3  g116(.a(x19), .b(new_n86_), .c(x13), .O(new_n161_));
  nand3  g117(.a(new_n89_), .b(x18), .c(x14), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n83_), .O(new_n163_));
  nand4  g119(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n163_), .c(x16), .O(new_n166_));
  inv1   g122(.a(new_n135_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n137_), .c(x11), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x15), .O(new_n170_));
  nand3  g126(.a(x16), .b(new_n133_), .c(x10), .O(new_n171_));
  ...
  nand4  g130(.a(new_n174_), .b(new_n160_), .c(new_n156_), .d(x31), .O(new_n175_));
  ...
  nand2  g134(.a(new_n89_), .b(x14), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x18), .c(x17), .d(x16), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n133_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x17), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n148_), .c(new_n89_), .O(new_n183_));
  oai21  g139(.a(new_n182_), .b(new_n134_), .c(new_n133_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n137_), .O(new_n186_));
  aoi21  g142(.a(x18), .b(x12), .c(x17), .O(new_n187_));
  nor2   g143(.a(x18), .b(x13), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n186_), .c(new_n184_), .d(new_n183_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n181_), .c(new_n46_), .O(new_n191_));
  oai21  g147(.a(x31), .b(new_n103_), .c(new_n158_), .O(new_n192_));
  aoi21  g148(.a(new_n112_), .b(new_n121_), .c(x30), .O(new_n193_));
  aoi21  g149(.a(new_n192_), .b(x27), .c(new_n193_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n191_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  aoi21  g152(.a(new_n168_), .b(new_n166_), .c(new_n133_), .O(new_n197_));
  nand3  g153(.a(new_n150_), .b(new_n121_), .c(new_n81_), .O(new_n198_));
  nand4  g154(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  oai21  g156(.a(new_n172_), .b(new_n197_), .c(new_n200_), .O(new_n201_));
  oai21  g157(.a(new_n201_), .b(x33), .c(new_n196_), .O(new_n202_));
