...
module FAU ( 
  ...
  nand4  g055(.a(new_n99_), .b(new_n88_), .c(new_n60_), .d(new_n80_), .O(new_n100_));
  ...
  nor2   g061(.a(x30), .b(new_n95_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n97_), .O(new_n107_));
  oai21  g063(.a(new_n105_), .b(new_n79_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n88_), .c(new_n60_), .d(new_n80_), .O(new_n109_));
  ...
  nand4  g069(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n47_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n105_), .b(new_n116_), .c(x30), .O(new_n117_));
  oai21  g073(.a(new_n105_), .b(new_n116_), .c(new_n117_), .O(new_n118_));
  aoi22  g074(.a(new_n118_), .b(x27), .c(x31), .d(new_n79_), .O(new_n119_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n135_), .c(new_n131_), .d(new_n128_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n124_), .c(new_n47_), .O(new_n141_));
  oai21  g097(.a(x28), .b(x27), .c(x29), .O(new_n142_));
  nor2   g098(.a(new_n79_), .b(new_n95_), .O(new_n143_));
  aoi22  g099(.a(new_n143_), .b(x27), .c(new_n142_), .d(new_n79_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x32), .O(new_n146_));
  inv1   g102(.a(x32), .O(new_n147_));
  inv1   g103(.a(new_n106_), .O(new_n148_));
  nand2  g104(.a(x30), .b(new_n95_), .O(new_n149_));
  and2   g105(.a(new_n149_), .b(new_n148_), .O(new_n150_));
  oai22  g106(.a(new_n150_), .b(new_n45_), .c(new_n148_), .d(new_n96_), .O(new_n151_));
  nand3  g107(.a(x19), .b(new_n133_), .c(x13), .O(new_n152_));
  nand3  g108(.a(new_n134_), .b(x18), .c(x14), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n152_), .c(new_n130_), .O(new_n154_));
  nand4  g110(.a(x19), .b(x18), .c(new_n130_), .d(x12), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n154_), .c(x16), .O(new_n157_));
  inv1   g113(.a(new_n122_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n125_), .c(x11), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x15), .O(new_n161_));
  inv1   g117(.a(x15), .O(new_n162_));
  nand3  g118(.a(x16), .b(new_n162_), .c(x10), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n122_), .O(new_n164_));
  ...
  nor2   g128(.a(new_n172_), .b(new_n162_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n137_), .c(new_n134_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n121_), .c(new_n162_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n125_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x12), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n130_), .c(new_n133_), .d(new_n132_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n176_), .d(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n173_), .c(new_n47_), .O(new_n182_));
  oai21  g138(.a(x31), .b(new_n95_), .c(new_n149_), .O(new_n183_));
  aoi21  g139(.a(new_n104_), .b(new_n116_), .c(x30), .O(new_n184_));
  ...
  aoi21  g143(.a(new_n159_), .b(new_n157_), .c(new_n162_), .O(new_n188_));
  nand3  g144(.a(new_n142_), .b(new_n116_), .c(new_n79_), .O(new_n189_));
  nand4  g145(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  oai21  g147(.a(new_n164_), .b(new_n188_), .c(new_n191_), .O(new_n192_));
