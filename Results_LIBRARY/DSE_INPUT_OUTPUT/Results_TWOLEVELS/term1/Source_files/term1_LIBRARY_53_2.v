...
module FAU ( 
  ...
  nor2   g055(.a(new_n45_), .b(x29), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n99_), .c(new_n98_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n90_), .c(new_n61_), .d(new_n81_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n80_), .c(new_n59_), .O(z5));
  inv1   g060(.a(x28), .O(new_n105_));
  oai21  g061(.a(new_n100_), .b(new_n105_), .c(x27), .O(new_n106_));
  oai21  g062(.a(new_n45_), .b(x27), .c(new_n106_), .O(new_n107_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n99_), .c(new_n116_), .O(new_n119_));
  ...
  nand3  g098(.a(new_n115_), .b(new_n45_), .c(new_n82_), .O(new_n143_));
  nand2  g099(.a(new_n105_), .b(new_n82_), .O(new_n144_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n97_), .c(new_n82_), .O(new_n151_));
  ...
  oai21  g138(.a(new_n45_), .b(new_n105_), .c(x31), .O(new_n183_));
  oai21  g139(.a(new_n118_), .b(new_n105_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n82_), .c(new_n182_), .O(new_n185_));
  ...
  nand4  g145(.a(new_n115_), .b(new_n117_), .c(new_n45_), .d(new_n82_), .O(new_n190_));
