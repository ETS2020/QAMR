...
module FAU ( 
  ...
  aoi21  g069(.a(new_n113_), .b(x28), .c(new_n102_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n111_), .c(new_n89_), .O(new_n115_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n83_), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n86_), .c(new_n85_), .O(new_n120_));
  nand4  g076(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n120_), .c(new_n46_), .O(new_n122_));
  nand2  g078(.a(x31), .b(new_n94_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n128_), .b(x31), .c(x30), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n127_), .c(new_n122_), .O(z7));
  ...
  nand4  g101(.a(new_n145_), .b(new_n141_), .c(new_n138_), .d(new_n134_), .O(new_n146_));
  ...
  nand2  g106(.a(new_n150_), .b(new_n46_), .O(new_n151_));
  nand2  g107(.a(new_n94_), .b(new_n112_), .O(new_n152_));
  oai21  g108(.a(new_n104_), .b(x28), .c(new_n152_), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(x27), .c(new_n105_), .d(x28), .O(new_n154_));
  ...
  nand2  g134(.a(new_n80_), .b(x00), .O(new_n179_));
  nand3  g135(.a(x33), .b(x30), .c(new_n93_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(x30), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n102_), .O(new_n182_));
  aoi21  g138(.a(new_n170_), .b(new_n169_), .c(new_n131_), .O(new_n183_));
  inv1   g139(.a(new_n173_), .O(new_n184_));
  nand4  g140(.a(new_n158_), .b(x31), .c(x30), .d(x29), .O(new_n185_));
  nand3  g141(.a(new_n124_), .b(new_n94_), .c(new_n112_), .O(new_n186_));
  ...
  nand2  g146(.a(new_n143_), .b(new_n142_), .O(new_n191_));
  nand2  g147(.a(new_n149_), .b(new_n191_), .O(new_n192_));
  nand2  g148(.a(x30), .b(new_n112_), .O(new_n193_));
  nand2  g149(.a(new_n124_), .b(x29), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n193_), .c(new_n123_), .O(new_n195_));
  nor2   g151(.a(new_n195_), .b(new_n192_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n190_), .c(new_n141_), .d(new_n138_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n189_), .c(x33), .O(new_n198_));
  oai21  g154(.a(new_n188_), .b(x33), .c(new_n198_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n80_), .c(x00), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n182_), .O(z9));
endmodule
