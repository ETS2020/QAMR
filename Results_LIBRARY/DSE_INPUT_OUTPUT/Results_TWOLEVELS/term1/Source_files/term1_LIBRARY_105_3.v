...
module FAU ( 
  ...
  nand3  g060(.a(new_n104_), .b(new_n60_), .c(new_n80_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n45_), .O(z5));
  inv1   g064(.a(x30), .O(new_n109_));
  nor2   g065(.a(new_n102_), .b(new_n100_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n81_), .c(new_n109_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n113_));
  ...
  nor3   g074(.a(new_n118_), .b(new_n59_), .c(new_n58_), .O(new_n119_));
  ...
  oai21  g085(.a(new_n126_), .b(new_n129_), .c(new_n83_), .O(new_n130_));
  inv1   g086(.a(x13), .O(new_n131_));
  oai21  g087(.a(new_n89_), .b(new_n131_), .c(new_n86_), .O(new_n132_));
  nor2   g088(.a(x19), .b(x14), .O(new_n133_));
  nand2  g089(.a(x16), .b(x15), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n122_), .c(x31), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n133_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n132_), .c(new_n130_), .d(new_n128_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n124_), .c(new_n45_), .O(new_n138_));
  nand3  g094(.a(x30), .b(x29), .c(x28), .O(new_n139_));
  oai21  g095(.a(x30), .b(x28), .c(new_n139_), .O(new_n140_));
  aoi22  g096(.a(new_n140_), .b(new_n81_), .c(new_n109_), .d(new_n102_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n138_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x32), .O(new_n143_));
  inv1   g099(.a(x32), .O(new_n144_));
  nand3  g100(.a(new_n111_), .b(x30), .c(new_n81_), .O(new_n145_));
  nand2  g101(.a(new_n100_), .b(new_n81_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n109_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g104(.a(x19), .b(new_n86_), .c(x13), .O(new_n149_));
  nand3  g105(.a(new_n89_), .b(x18), .c(x14), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(new_n83_), .O(new_n151_));
  nand4  g107(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(x16), .O(new_n154_));
  inv1   g110(.a(new_n122_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n125_), .c(x11), .O(new_n156_));
  ...
  nand4  g117(.a(new_n161_), .b(new_n148_), .c(new_n144_), .d(x31), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n143_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n80_), .c(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  nand2  g121(.a(new_n89_), .b(x14), .O(new_n166_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n134_), .c(new_n89_), .O(new_n170_));
  oai21  g126(.a(new_n169_), .b(new_n121_), .c(new_n159_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  oai21  g128(.a(new_n169_), .b(new_n172_), .c(new_n125_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x12), .O(new_n174_));
  aoi22  g130(.a(new_n174_), .b(new_n83_), .c(new_n86_), .d(new_n131_), .O(new_n175_));
  ...
  aoi21  g134(.a(new_n178_), .b(new_n117_), .c(x30), .O(new_n179_));
  oai21  g135(.a(new_n117_), .b(new_n102_), .c(x30), .O(new_n180_));
  oai21  g136(.a(new_n117_), .b(x28), .c(new_n180_), .O(new_n181_));
  ...
  nand3  g142(.a(new_n110_), .b(x31), .c(x30), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nor3   g144(.a(x31), .b(x30), .c(x28), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n188_), .c(new_n81_), .O(new_n190_));
  nand3  g146(.a(new_n117_), .b(new_n109_), .c(new_n102_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  oai21  g148(.a(new_n186_), .b(new_n185_), .c(new_n192_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(x33), .c(new_n184_), .O(new_n194_));
