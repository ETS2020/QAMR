...
module FAU ( 
  ...
  nor2   g017(.a(new_n52_), .b(new_n51_), .O(new_n62_));
  inv1   g018(.a(new_n62_), .O(new_n63_));
  nand2  g019(.a(new_n52_), .b(new_n51_), .O(new_n64_));
  aoi21  g020(.a(new_n64_), .b(new_n63_), .c(new_n61_), .O(new_n65_));
  nand2  g021(.a(x05), .b(new_n52_), .O(new_n66_));
  nand3  g022(.a(new_n66_), .b(x06), .c(new_n51_), .O(new_n67_));
  nand2  g023(.a(x06), .b(new_n51_), .O(new_n68_));
  nand3  g024(.a(new_n68_), .b(x05), .c(new_n52_), .O(new_n69_));
  ...
  nand4  g052(.a(new_n59_), .b(new_n96_), .c(x28), .d(x27), .O(new_n97_));
  nand2  g053(.a(x32), .b(x30), .O(new_n98_));
  nand2  g054(.a(x28), .b(x27), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n98_), .c(x29), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n89_), .c(new_n82_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n95_), .c(new_n61_), .O(z5));
  nand3  g059(.a(new_n99_), .b(new_n56_), .c(x30), .O(new_n104_));
  ...
  nand3  g063(.a(new_n56_), .b(x30), .c(new_n96_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n107_), .c(new_n88_), .O(new_n109_));
  ...
  oai21  g069(.a(new_n113_), .b(new_n99_), .c(new_n56_), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x30), .O(new_n115_));
  nand2  g071(.a(x30), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n99_), .c(x31), .O(new_n117_));
  inv1   g073(.a(new_n86_), .O(new_n118_));
  inv1   g074(.a(new_n87_), .O(new_n119_));
  nor2   g075(.a(new_n85_), .b(new_n84_), .O(new_n120_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(new_n117_), .d(new_n115_), .O(z7));
  inv1   g080(.a(x28), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n83_), .O(new_n126_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(new_n56_), .d(x31), .O(new_n149_));
  nand2  g105(.a(x16), .b(x10), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n141_), .c(new_n146_), .O(new_n151_));
  nand2  g107(.a(x19), .b(x18), .O(new_n152_));
  nand2  g108(.a(x17), .b(x11), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n140_), .O(new_n154_));
  inv1   g110(.a(x12), .O(new_n155_));
  oai21  g111(.a(new_n152_), .b(new_n155_), .c(new_n131_), .O(new_n156_));
  ...
  nor2   g116(.a(new_n160_), .b(new_n141_), .O(new_n161_));
  aoi21  g117(.a(new_n134_), .b(new_n159_), .c(new_n161_), .O(new_n162_));
  nor2   g118(.a(new_n112_), .b(new_n96_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n158_), .d(new_n126_), .O(new_n164_));
  ...
  inv1   g126(.a(new_n160_), .O(new_n171_));
  nand2  g127(.a(x18), .b(x17), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n171_), .c(x19), .O(new_n174_));
  oai21  g130(.a(new_n172_), .b(new_n150_), .c(new_n146_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n176_), .c(new_n140_), .O(new_n177_));
  oai21  g133(.a(new_n132_), .b(new_n155_), .c(new_n131_), .O(new_n178_));
  nor2   g134(.a(x18), .b(x13), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n161_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n174_), .c(new_n59_), .O(new_n182_));
  nand3  g138(.a(new_n45_), .b(x18), .c(x17), .O(new_n183_));
  oai22  g139(.a(new_n183_), .b(new_n160_), .c(x32), .d(x19), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n159_), .O(new_n185_));
  nand2  g141(.a(new_n128_), .b(new_n112_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n45_), .O(new_n187_));
  nand2  g143(.a(new_n128_), .b(x31), .O(new_n188_));
  oai21  g144(.a(x31), .b(new_n45_), .c(new_n188_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n56_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n187_), .c(new_n185_), .d(new_n182_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand4  g148(.a(new_n126_), .b(new_n56_), .c(x31), .d(x30), .O(new_n193_));
  oai22  g149(.a(new_n193_), .b(new_n96_), .c(new_n186_), .d(x30), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n148_), .c(new_n47_), .O(new_n195_));
