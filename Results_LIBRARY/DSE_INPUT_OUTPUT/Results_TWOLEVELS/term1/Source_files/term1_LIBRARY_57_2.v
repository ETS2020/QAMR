...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n90_), .c(new_n62_), .d(new_n82_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n81_), .c(new_n60_), .O(z5));
  ...
  nand4  g063(.a(new_n107_), .b(new_n90_), .c(new_n62_), .d(new_n82_), .O(new_n108_));
  ...
  nand4  g068(.a(new_n62_), .b(new_n82_), .c(x25), .d(x01), .O(new_n113_));
  ...
  nand2  g076(.a(new_n82_), .b(x00), .O(new_n121_));
  nand3  g077(.a(x32), .b(x30), .c(x29), .O(new_n122_));
  ...
  nand3  g084(.a(new_n128_), .b(x29), .c(x28), .O(new_n129_));
  ...
  inv1   g105(.a(new_n116_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n128_), .c(new_n45_), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n141_), .c(new_n146_), .O(new_n153_));
  nor2   g109(.a(new_n134_), .b(new_n132_), .O(new_n154_));
  ...
  nor2   g118(.a(new_n128_), .b(new_n97_), .O(new_n163_));
  ...
  nand4  g129(.a(new_n173_), .b(x31), .c(x30), .d(x29), .O(new_n174_));
  nand3  g130(.a(new_n150_), .b(new_n115_), .c(new_n128_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n148_), .c(new_n172_), .O(new_n177_));
  aoi21  g133(.a(x31), .b(x29), .c(new_n128_), .O(new_n178_));
  oai21  g134(.a(new_n126_), .b(new_n128_), .c(x31), .O(new_n179_));
  nand3  g135(.a(new_n115_), .b(x29), .c(x28), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n162_), .c(new_n161_), .d(new_n159_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n157_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n179_), .c(new_n156_), .d(new_n153_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n178_), .c(x33), .O(new_n184_));
