...
module FAU ( 
  ...
  nand4  g054(.a(new_n46_), .b(new_n98_), .c(x28), .d(x27), .O(new_n99_));
  nand2  g055(.a(new_n45_), .b(x30), .O(new_n100_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n92_), .c(new_n80_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n59_), .O(z5));
  nand3  g063(.a(new_n103_), .b(x31), .c(x30), .O(new_n108_));
  ...
  nand3  g068(.a(x31), .b(x30), .c(new_n98_), .O(new_n113_));
  ...
  nand2  g072(.a(new_n102_), .b(x29), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n90_), .c(new_n61_), .d(x31), .O(new_n118_));
  ...
  nand3  g078(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  aoi21  g080(.a(x31), .b(new_n109_), .c(x26), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n61_), .c(x25), .d(x01), .O(new_n126_));
  aoi21  g082(.a(new_n124_), .b(new_n89_), .c(new_n126_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n122_), .O(z7));
  nand3  g084(.a(x32), .b(new_n80_), .c(x00), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n109_), .O(new_n130_));
  ...
  nand4  g112(.a(new_n156_), .b(new_n134_), .c(x31), .d(new_n109_), .O(new_n157_));
  ...
  nand2  g116(.a(new_n133_), .b(x29), .O(new_n161_));
  aoi21  g117(.a(new_n149_), .b(new_n143_), .c(new_n152_), .O(new_n162_));
  oai21  g118(.a(new_n154_), .b(new_n162_), .c(new_n134_), .O(new_n163_));
  nand2  g119(.a(x32), .b(new_n109_), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n109_), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(x16), .b(x10), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n147_), .c(new_n152_), .O(new_n167_));
  nand3  g123(.a(new_n146_), .b(x17), .c(x11), .O(new_n168_));
  inv1   g124(.a(x12), .O(new_n169_));
  oai21  g125(.a(new_n145_), .b(new_n169_), .c(new_n135_), .O(new_n170_));
  inv1   g126(.a(x13), .O(new_n171_));
  oai21  g127(.a(new_n138_), .b(new_n171_), .c(new_n136_), .O(new_n172_));
  inv1   g128(.a(x14), .O(new_n173_));
  nand2  g129(.a(new_n138_), .b(new_n173_), .O(new_n174_));
  nand3  g130(.a(new_n148_), .b(x16), .c(x15), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n174_), .c(new_n172_), .d(new_n170_), .O(new_n176_));
  aoi21  g132(.a(new_n168_), .b(new_n144_), .c(new_n176_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n167_), .c(new_n134_), .O(new_n178_));
  aoi21  g134(.a(new_n165_), .b(new_n161_), .c(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n160_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n80_), .c(x00), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n131_), .O(z8));
  nand2  g138(.a(new_n138_), .b(x14), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(x18), .c(x17), .d(x16), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n152_), .O(new_n185_));
  nand2  g141(.a(x16), .b(x15), .O(new_n186_));
  nand2  g142(.a(x18), .b(x17), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n186_), .c(new_n138_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n166_), .c(new_n152_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  oai21  g146(.a(new_n187_), .b(new_n190_), .c(new_n144_), .O(new_n191_));
  nand2  g147(.a(x18), .b(x12), .O(new_n192_));
  aoi22  g148(.a(new_n192_), .b(new_n135_), .c(new_n136_), .d(new_n171_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n191_), .c(new_n189_), .d(new_n188_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n185_), .c(new_n46_), .O(new_n195_));
  nor2   g151(.a(new_n132_), .b(x30), .O(new_n196_));
  aoi22  g152(.a(new_n196_), .b(x29), .c(new_n161_), .d(x31), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n195_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(x33), .O(new_n199_));
  nand4  g155(.a(new_n133_), .b(x31), .c(x30), .d(x29), .O(new_n200_));
  nand3  g156(.a(new_n161_), .b(new_n45_), .c(new_n109_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n200_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n156_), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(x33), .c(new_n199_), .O(new_n204_));
