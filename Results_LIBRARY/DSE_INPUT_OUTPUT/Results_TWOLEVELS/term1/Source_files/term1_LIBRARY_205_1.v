...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(new_n80_), .c(x27), .O(z3));
  ...
  nand4  g056(.a(new_n100_), .b(new_n89_), .c(new_n61_), .d(new_n81_), .O(new_n101_));
  ...
  nand4  g062(.a(new_n80_), .b(x29), .c(x28), .d(x27), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n80_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n89_), .c(new_n61_), .d(new_n81_), .O(new_n109_));
  ...
  aoi22  g074(.a(new_n118_), .b(x27), .c(x31), .d(new_n80_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n115_), .O(z7));
  nand2  g076(.a(new_n81_), .b(x00), .O(new_n121_));
  nand3  g077(.a(x32), .b(new_n80_), .c(new_n96_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(new_n80_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n45_), .O(new_n124_));
  inv1   g080(.a(x32), .O(new_n125_));
  nand2  g081(.a(new_n96_), .b(new_n45_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n80_), .c(x29), .O(new_n127_));
  nand2  g083(.a(x30), .b(new_n98_), .O(new_n128_));
  ...
  oai21  g111(.a(new_n152_), .b(new_n155_), .c(new_n130_), .O(new_n156_));
  inv1   g112(.a(x13), .O(new_n157_));
  oai21  g113(.a(new_n133_), .b(new_n157_), .c(new_n131_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  oai22  g115(.a(new_n159_), .b(new_n140_), .c(x19), .d(x14), .O(new_n160_));
  aoi21  g116(.a(new_n80_), .b(new_n98_), .c(new_n116_), .O(new_n161_));
  oai21  g117(.a(new_n80_), .b(new_n98_), .c(new_n161_), .O(new_n162_));
  ...
  nand2  g123(.a(new_n167_), .b(new_n124_), .O(z8));
  nand2  g124(.a(new_n133_), .b(x14), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(x18), .c(x17), .d(x16), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n145_), .O(new_n171_));
  nand2  g127(.a(x18), .b(x17), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n159_), .c(new_n133_), .O(new_n173_));
  oai21  g129(.a(new_n172_), .b(new_n149_), .c(new_n145_), .O(new_n174_));
  inv1   g130(.a(x11), .O(new_n175_));
  oai21  g131(.a(new_n172_), .b(new_n175_), .c(new_n139_), .O(new_n176_));
  nand2  g132(.a(x18), .b(x12), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n130_), .c(new_n131_), .d(new_n157_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n176_), .c(new_n174_), .d(new_n173_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n171_), .c(new_n47_), .O(new_n180_));
  oai21  g136(.a(x31), .b(new_n98_), .c(new_n128_), .O(new_n181_));
  aoi21  g137(.a(new_n105_), .b(new_n116_), .c(x30), .O(new_n182_));
  aoi21  g138(.a(new_n181_), .b(x27), .c(new_n182_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n180_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  aoi21  g141(.a(new_n142_), .b(new_n138_), .c(new_n145_), .O(new_n186_));
  inv1   g142(.a(new_n146_), .O(new_n187_));
  nand2  g143(.a(new_n126_), .b(x29), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n116_), .c(new_n80_), .O(new_n189_));
  nand4  g145(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  oai21  g147(.a(new_n187_), .b(new_n186_), .c(new_n191_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(x33), .c(new_n185_), .O(new_n193_));
