...
module FAU ( 
  ...
  oai21  g016(.a(new_n59_), .b(new_n50_), .c(new_n60_), .O(new_n61_));
  ...
  nor2   g021(.a(new_n50_), .b(new_n53_), .O(new_n66_));
  inv1   g022(.a(new_n66_), .O(new_n67_));
  nand2  g023(.a(new_n50_), .b(new_n53_), .O(new_n68_));
  nand2  g024(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand3  g025(.a(new_n69_), .b(new_n48_), .c(x01), .O(new_n70_));
  inv1   g026(.a(new_n70_), .O(new_n71_));
  oai21  g027(.a(new_n71_), .b(new_n65_), .c(new_n58_), .O(new_n72_));
  xor2a  g028(.a(x07), .b(x04), .O(new_n73_));
  nand2  g029(.a(new_n63_), .b(new_n61_), .O(new_n74_));
  nand4  g030(.a(x06), .b(x05), .c(new_n50_), .d(new_n53_), .O(new_n75_));
  aoi21  g031(.a(new_n75_), .b(new_n74_), .c(x01), .O(new_n76_));
  inv1   g032(.a(x01), .O(new_n77_));
  oai21  g033(.a(new_n59_), .b(new_n77_), .c(new_n60_), .O(new_n78_));
  nand3  g034(.a(new_n78_), .b(new_n50_), .c(x02), .O(new_n79_));
  nand4  g035(.a(new_n48_), .b(x03), .c(new_n53_), .d(x01), .O(new_n80_));
  nand2  g036(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  oai21  g037(.a(new_n81_), .b(new_n76_), .c(new_n73_), .O(new_n82_));
  aoi21  g038(.a(new_n82_), .b(new_n72_), .c(x09), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(x08), .O(new_n84_));
  inv1   g040(.a(new_n84_), .O(z2));
  ...
  nor2   g055(.a(new_n99_), .b(new_n66_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n87_), .c(new_n45_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n86_), .c(new_n77_), .O(z3));
  xor2a  g058(.a(x28), .b(x27), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n100_), .c(new_n45_), .d(x25), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n77_), .c(new_n48_), .O(z4));
  ...
  nand4  g067(.a(new_n111_), .b(new_n106_), .c(new_n67_), .d(new_n45_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n86_), .c(new_n77_), .O(z5));
  nand3  g069(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x30), .O(new_n115_));
  inv1   g071(.a(x30), .O(new_n116_));
  nand3  g072(.a(new_n109_), .b(new_n116_), .c(x29), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n115_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n106_), .c(new_n67_), .d(new_n45_), .O(new_n119_));
  nor3   g075(.a(new_n119_), .b(new_n86_), .c(new_n77_), .O(z6));
  nor2   g076(.a(new_n116_), .b(new_n107_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n109_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x31), .O(new_n123_));
  inv1   g079(.a(new_n88_), .O(new_n124_));
  nand4  g080(.a(new_n97_), .b(new_n94_), .c(new_n91_), .d(new_n124_), .O(new_n125_));
  nor2   g081(.a(new_n66_), .b(new_n77_), .O(new_n126_));
  inv1   g082(.a(new_n109_), .O(new_n127_));
  ...
  nor2   g092(.a(new_n134_), .b(new_n107_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n116_), .c(new_n136_), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n92_), .c(x13), .O(new_n139_));
  nand3  g095(.a(new_n95_), .b(x18), .c(x14), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n89_), .O(new_n141_));
  nand4  g097(.a(x19), .b(x18), .c(new_n89_), .d(x12), .O(new_n142_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n108_), .O(new_n159_));
  ...
  oai21  g120(.a(new_n146_), .b(new_n164_), .c(new_n89_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  oai21  g122(.a(new_n95_), .b(new_n166_), .c(new_n92_), .O(new_n167_));
  ...
  oai21  g153(.a(new_n92_), .b(new_n164_), .c(new_n89_), .O(new_n198_));
  nand2  g154(.a(new_n92_), .b(new_n166_), .O(new_n199_));
  ...
  nand2  g162(.a(new_n206_), .b(new_n48_), .O(z9));
endmodule
