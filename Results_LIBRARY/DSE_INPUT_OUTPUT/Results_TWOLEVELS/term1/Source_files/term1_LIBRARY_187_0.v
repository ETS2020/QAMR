...
module FAU ( 
  ...
  nand2  g073(.a(x31), .b(new_n101_), .O(new_n118_));
  ...
  nor3   g081(.a(new_n101_), .b(new_n100_), .c(x28), .O(new_n126_));
  ...
  aoi21  g101(.a(new_n102_), .b(x28), .c(new_n119_), .O(new_n146_));
  ...
  nand2  g107(.a(new_n110_), .b(new_n94_), .O(new_n152_));
  nand2  g108(.a(x30), .b(new_n100_), .O(new_n153_));
  nand2  g109(.a(new_n101_), .b(x29), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n153_), .c(new_n152_), .O(new_n155_));
  inv1   g111(.a(x17), .O(new_n156_));
  nand3  g112(.a(x19), .b(new_n134_), .c(x13), .O(new_n157_));
  nand3  g113(.a(new_n135_), .b(x18), .c(x14), .O(new_n158_));
  ...
  aoi21  g132(.a(new_n164_), .b(new_n162_), .c(new_n129_), .O(new_n177_));
  inv1   g133(.a(new_n167_), .O(new_n178_));
  nand4  g134(.a(new_n152_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand3  g135(.a(new_n119_), .b(new_n101_), .c(new_n100_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  oai21  g137(.a(new_n178_), .b(new_n177_), .c(new_n181_), .O(new_n182_));
  inv1   g138(.a(new_n132_), .O(new_n183_));
  inv1   g139(.a(new_n139_), .O(new_n184_));
  nand2  g140(.a(new_n119_), .b(x29), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n153_), .c(new_n118_), .O(new_n186_));
  nor3   g142(.a(new_n186_), .b(new_n144_), .c(new_n142_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n141_), .c(new_n184_), .d(new_n138_), .O(new_n188_));
