...
module FAU ( 
  ...
  oai21  g062(.a(new_n106_), .b(new_n81_), .c(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n90_), .c(new_n80_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n59_), .c(new_n45_), .O(z6));
  inv1   g065(.a(new_n86_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n85_), .c(new_n83_), .O(new_n111_));
  ...
  aoi22  g093(.a(new_n137_), .b(new_n81_), .c(new_n105_), .d(new_n98_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n135_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand3  g097(.a(new_n106_), .b(x30), .c(new_n81_), .O(new_n142_));
  nand2  g098(.a(new_n96_), .b(new_n81_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n105_), .c(x29), .O(new_n144_));
  ...
  nand2  g133(.a(new_n106_), .b(x31), .O(new_n178_));
  oai21  g134(.a(x31), .b(new_n105_), .c(new_n178_), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n81_), .c(new_n177_), .d(new_n105_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n174_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  aoi21  g138(.a(new_n153_), .b(new_n151_), .c(new_n156_), .O(new_n183_));
  inv1   g139(.a(new_n157_), .O(new_n184_));
  nand4  g140(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n185_));
  ...
  nand3  g144(.a(new_n175_), .b(new_n105_), .c(new_n98_), .O(new_n189_));
