...
module FAU ( 
  ...
  or2    g048(.a(new_n92_), .b(new_n82_), .O(new_n93_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  ...
  nor2   g067(.a(x33), .b(x30), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x29), .O(new_n113_));
  oai22  g069(.a(new_n113_), .b(new_n103_), .c(new_n111_), .d(x29), .O(new_n114_));
  nand2  g070(.a(x28), .b(x27), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n82_), .c(x30), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  aoi21  g073(.a(new_n114_), .b(new_n93_), .c(new_n117_), .O(new_n118_));
  aoi22  g074(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n92_), .c(x30), .O(new_n120_));
  oai21  g076(.a(new_n118_), .b(new_n60_), .c(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n80_), .c(x25), .d(x01), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(z6));
  oai21  g079(.a(x33), .b(x31), .c(new_n111_), .O(new_n124_));
  ...
  nand4  g086(.a(new_n104_), .b(new_n130_), .c(x30), .d(x29), .O(new_n131_));
  ...
  aoi21  g098(.a(new_n142_), .b(x11), .c(x16), .O(new_n143_));
  ...
  aoi21  g105(.a(new_n86_), .b(new_n147_), .c(new_n149_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n146_), .c(new_n144_), .d(new_n141_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n138_), .c(new_n48_), .O(new_n152_));
  inv1   g108(.a(x14), .O(new_n153_));
  nand3  g109(.a(x30), .b(x18), .c(x17), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n135_), .c(x33), .d(x19), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n153_), .O(new_n156_));
  inv1   g112(.a(x28), .O(new_n157_));
  nand3  g113(.a(x30), .b(x29), .c(x27), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nor3   g115(.a(x33), .b(x30), .c(x27), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n157_), .O(new_n161_));
  nor2   g117(.a(new_n111_), .b(new_n102_), .O(new_n162_));
  aoi22  g118(.a(new_n162_), .b(x28), .c(new_n112_), .d(new_n102_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n161_), .c(new_n156_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n152_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x32), .O(new_n167_));
  inv1   g123(.a(x32), .O(new_n168_));
  nand2  g124(.a(new_n157_), .b(new_n81_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n45_), .c(new_n111_), .d(x29), .O(new_n170_));
  nand2  g126(.a(new_n169_), .b(x29), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand3  g129(.a(x19), .b(new_n86_), .c(x13), .O(new_n174_));
  nand3  g130(.a(new_n89_), .b(x18), .c(x14), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n174_), .c(new_n83_), .O(new_n176_));
  nand4  g132(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n176_), .c(x16), .O(new_n179_));
  inv1   g135(.a(x16), .O(new_n180_));
  inv1   g136(.a(new_n148_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n180_), .c(x11), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n179_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x15), .O(new_n184_));
  nand4  g140(.a(new_n181_), .b(x16), .c(new_n139_), .d(x10), .O(new_n185_));
  ...
  aoi21  g147(.a(new_n183_), .b(x15), .c(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n169_), .b(new_n45_), .c(x31), .d(x30), .O(new_n193_));
  inv1   g149(.a(new_n193_), .O(new_n194_));
  aoi21  g150(.a(new_n169_), .b(x29), .c(x31), .O(new_n195_));
  aoi22  g151(.a(new_n195_), .b(new_n111_), .c(new_n194_), .d(x29), .O(new_n196_));
  aoi21  g152(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(x17), .c(x16), .d(x15), .O(new_n198_));
  nand2  g154(.a(new_n86_), .b(new_n147_), .O(new_n199_));
  nor2   g155(.a(new_n130_), .b(new_n102_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n169_), .c(new_n199_), .d(new_n146_), .O(new_n201_));
  nor2   g157(.a(new_n201_), .b(new_n143_), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(new_n198_), .c(new_n141_), .d(new_n137_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(x33), .O(new_n204_));
  oai21  g160(.a(new_n196_), .b(new_n192_), .c(new_n204_), .O(new_n205_));
