...
module FAU ( 
  ...
  oai21  g063(.a(new_n104_), .b(new_n81_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n99_), .c(new_n60_), .O(z5));
  inv1   g066(.a(x28), .O(new_n111_));
  oai21  g067(.a(new_n105_), .b(new_n111_), .c(x30), .O(new_n112_));
  nand2  g068(.a(new_n106_), .b(x28), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n61_), .d(x27), .O(new_n115_));
  ...
  oai21  g084(.a(x29), .b(new_n81_), .c(x30), .O(new_n129_));
  ...
  oai21  g103(.a(new_n147_), .b(new_n105_), .c(new_n45_), .O(new_n148_));
  oai21  g104(.a(new_n123_), .b(new_n81_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n146_), .b(new_n47_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(x32), .O(new_n153_));
  nand2  g109(.a(x30), .b(new_n105_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n106_), .c(x27), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n113_), .O(new_n157_));
  ...
  aoi21  g129(.a(new_n165_), .b(new_n163_), .c(new_n130_), .O(new_n174_));
  inv1   g130(.a(new_n168_), .O(new_n175_));
  nor2   g131(.a(x30), .b(x29), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n147_), .c(new_n119_), .O(new_n177_));
  ...
  nand2  g136(.a(new_n91_), .b(x14), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x18), .c(x17), .d(x16), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n130_), .O(new_n183_));
  nor2   g139(.a(new_n147_), .b(x31), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x29), .O(new_n185_));
  nor2   g141(.a(new_n88_), .b(new_n85_), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n145_), .c(new_n91_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n131_), .c(new_n130_), .O(new_n189_));
  aoi21  g145(.a(new_n186_), .b(x11), .c(x16), .O(new_n190_));
  oai21  g146(.a(new_n88_), .b(new_n138_), .c(new_n85_), .O(new_n191_));
  inv1   g147(.a(x13), .O(new_n192_));
  nand2  g148(.a(new_n88_), .b(new_n192_), .O(new_n193_));
  nand2  g149(.a(x31), .b(new_n45_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n193_), .c(new_n191_), .d(new_n154_), .O(new_n195_));
  nor2   g151(.a(new_n195_), .b(new_n190_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n189_), .c(new_n188_), .d(new_n185_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n183_), .c(x33), .O(new_n198_));
  oai21  g154(.a(new_n180_), .b(x33), .c(new_n198_), .O(new_n199_));
