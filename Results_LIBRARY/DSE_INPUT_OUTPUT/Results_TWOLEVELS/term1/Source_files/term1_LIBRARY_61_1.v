...
module FAU ( 
  ...
  nor2   g075(.a(new_n112_), .b(new_n101_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n103_), .c(new_n119_), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n103_), .c(new_n96_), .O(new_n127_));
  ...
  nor2   g091(.a(new_n133_), .b(new_n101_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n112_), .c(new_n135_), .O(new_n137_));
  nand3  g093(.a(x19), .b(new_n85_), .c(x13), .O(new_n138_));
  nand3  g094(.a(new_n88_), .b(x18), .c(x14), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n138_), .c(new_n82_), .O(new_n140_));
  nand4  g096(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n141_));
  ...
  oai21  g119(.a(new_n145_), .b(new_n163_), .c(new_n82_), .O(new_n164_));
  inv1   g120(.a(x13), .O(new_n165_));
  oai21  g121(.a(new_n88_), .b(new_n165_), .c(new_n85_), .O(new_n166_));
  ...
  oai21  g148(.a(new_n192_), .b(new_n191_), .c(new_n88_), .O(new_n193_));
  ...
  oai21  g152(.a(new_n85_), .b(new_n163_), .c(new_n82_), .O(new_n197_));
  nand2  g153(.a(new_n85_), .b(new_n165_), .O(new_n198_));
