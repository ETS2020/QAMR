...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n59_), .c(x28), .d(new_n79_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n78_), .c(x25), .d(x01), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(z3));
  nand3  g052(.a(new_n94_), .b(x25), .c(x01), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(x28), .c(x26), .O(z4));
  xor2a  g054(.a(x29), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n92_), .c(new_n59_), .d(x28), .O(new_n100_));
  ...
  oai21  g060(.a(x29), .b(new_n104_), .c(x27), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x30), .O(new_n106_));
  inv1   g062(.a(x30), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x29), .c(x27), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(new_n91_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n59_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x28), .c(x26), .O(z6));
  nand2  g067(.a(x30), .b(x29), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n79_), .c(x31), .O(new_n113_));
  inv1   g069(.a(new_n80_), .O(new_n114_));
  nand4  g070(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n114_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(x30), .c(x29), .d(x27), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n59_), .c(x25), .d(x01), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n115_), .c(new_n113_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x28), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n78_), .O(z7));
  inv1   g078(.a(x32), .O(new_n123_));
  nand2  g079(.a(new_n107_), .b(x29), .O(new_n124_));
  inv1   g080(.a(x29), .O(new_n125_));
  nand2  g081(.a(x30), .b(new_n125_), .O(new_n126_));
  ...
  nor2   g095(.a(new_n134_), .b(x15), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n136_), .c(x10), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n127_), .c(new_n123_), .d(x31), .O(new_n143_));
  and2   g099(.a(x16), .b(x10), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n136_), .c(x15), .O(new_n145_));
  nand2  g101(.a(x19), .b(x18), .O(new_n146_));
  nand2  g102(.a(x17), .b(x11), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n146_), .c(new_n134_), .O(new_n148_));
  inv1   g104(.a(x12), .O(new_n149_));
  oai21  g105(.a(new_n146_), .b(new_n149_), .c(new_n81_), .O(new_n150_));
  nand2  g106(.a(x19), .b(x13), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n84_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x15), .O(new_n153_));
  oai22  g109(.a(new_n153_), .b(new_n135_), .c(x19), .d(x14), .O(new_n154_));
  nand2  g110(.a(new_n107_), .b(new_n125_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n112_), .c(x31), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n145_), .c(x32), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n143_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(x28), .c(new_n78_), .d(x00), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(z8));
  inv1   g118(.a(x33), .O(new_n163_));
  nand3  g119(.a(x31), .b(x30), .c(x29), .O(new_n164_));
  nand3  g120(.a(new_n116_), .b(new_n107_), .c(new_n125_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n142_), .c(new_n163_), .O(new_n167_));
  nand2  g123(.a(x31), .b(new_n107_), .O(new_n168_));
  nand2  g124(.a(new_n116_), .b(x29), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n168_), .c(new_n126_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n154_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n152_), .c(new_n150_), .d(new_n148_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n145_), .c(x33), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n167_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x00), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(x28), .c(x26), .O(z9));
endmodule
