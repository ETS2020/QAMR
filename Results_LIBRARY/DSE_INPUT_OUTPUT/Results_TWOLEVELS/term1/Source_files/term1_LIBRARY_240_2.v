...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n100_), .c(new_n61_), .d(new_n80_), .O(new_n105_));
  ...
  oai21  g065(.a(new_n109_), .b(x29), .c(new_n102_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n100_), .c(new_n61_), .d(new_n80_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x25), .c(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n57_), .O(z6));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(new_n127_), .d(x31), .O(new_n145_));
  aoi21  g101(.a(new_n101_), .b(new_n81_), .c(new_n45_), .O(new_n146_));
  nand2  g102(.a(x16), .b(x10), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n137_), .c(new_n142_), .O(new_n148_));
  nand2  g104(.a(x19), .b(x18), .O(new_n149_));
  nand2  g105(.a(x17), .b(x11), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n149_), .c(new_n136_), .O(new_n151_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n137_), .c(x31), .O(new_n157_));
  nor3   g113(.a(new_n157_), .b(new_n155_), .c(new_n154_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n153_), .c(new_n151_), .d(new_n148_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n146_), .c(x32), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n145_), .c(new_n109_), .O(new_n161_));
  nand3  g117(.a(x32), .b(new_n109_), .c(new_n45_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n161_), .c(new_n80_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n126_), .O(z8));
  nand2  g121(.a(new_n89_), .b(x14), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x18), .c(x17), .d(x16), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n142_), .O(new_n168_));
  nand2  g124(.a(x18), .b(x17), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n156_), .c(new_n89_), .O(new_n170_));
  oai21  g126(.a(new_n169_), .b(new_n147_), .c(new_n142_), .O(new_n171_));
  inv1   g127(.a(x11), .O(new_n172_));
  oai21  g128(.a(new_n169_), .b(new_n172_), .c(new_n136_), .O(new_n173_));
  aoi21  g129(.a(x18), .b(x12), .c(x17), .O(new_n174_));
  nor2   g130(.a(x18), .b(x13), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n173_), .c(new_n171_), .d(new_n170_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n168_), .c(new_n57_), .O(new_n178_));
  nand2  g134(.a(new_n128_), .b(x31), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(x30), .c(x31), .d(new_n45_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n178_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nor3   g138(.a(new_n179_), .b(new_n109_), .c(new_n45_), .O(new_n183_));
  nor3   g139(.a(x31), .b(x30), .c(x29), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(new_n144_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(x33), .c(new_n182_), .O(new_n186_));
