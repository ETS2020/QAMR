...
module FAU ( 
  ...
  nand3  g043(.a(new_n87_), .b(x29), .c(new_n81_), .O(new_n88_));
  ...
  nor3   g058(.a(new_n102_), .b(new_n95_), .c(new_n59_), .O(z5));
  ...
  nand2  g069(.a(new_n113_), .b(new_n81_), .O(new_n114_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n122_), .c(new_n80_), .d(x25), .O(new_n124_));
  ...
  nand2  g084(.a(new_n128_), .b(new_n81_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n104_), .c(x29), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(new_n81_), .c(new_n97_), .O(new_n131_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n178_), .c(new_n46_), .O(new_n187_));
  ...
  aoi21  g146(.a(new_n190_), .b(new_n113_), .c(new_n81_), .O(new_n191_));
  nand2  g147(.a(new_n104_), .b(x28), .O(new_n192_));
  nand3  g148(.a(x31), .b(new_n128_), .c(new_n81_), .O(new_n193_));
