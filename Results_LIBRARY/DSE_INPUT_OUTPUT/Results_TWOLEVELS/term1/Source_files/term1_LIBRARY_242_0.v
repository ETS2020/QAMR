...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n61_), .c(x30), .d(new_n45_), .O(new_n93_));
  ...
  nand3  g053(.a(x30), .b(x28), .c(new_n45_), .O(new_n98_));
  oai21  g054(.a(x28), .b(new_n45_), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n92_), .c(new_n61_), .d(new_n80_), .O(new_n100_));
  ...
  nor2   g060(.a(new_n102_), .b(new_n45_), .O(new_n105_));
  oai22  g061(.a(new_n105_), .b(new_n103_), .c(new_n104_), .d(new_n102_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n48_), .O(z5));
  nand2  g066(.a(x30), .b(new_n103_), .O(new_n111_));
  ...
  oai21  g070(.a(new_n105_), .b(new_n46_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n92_), .c(new_n61_), .d(new_n80_), .O(new_n116_));
  ...
  nor2   g078(.a(new_n103_), .b(new_n102_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(x30), .O(new_n124_));
  oai21  g080(.a(new_n122_), .b(x30), .c(new_n124_), .O(new_n125_));
  aoi21  g081(.a(new_n123_), .b(x27), .c(new_n122_), .O(new_n126_));
  aoi22  g082(.a(new_n126_), .b(x30), .c(new_n125_), .d(x27), .O(new_n127_));
  ...
  oai21  g100(.a(new_n144_), .b(new_n122_), .c(new_n48_), .O(new_n145_));
  nor2   g101(.a(new_n46_), .b(new_n103_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n102_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x29), .c(new_n147_), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(x27), .c(new_n146_), .d(x28), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n145_), .c(new_n143_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nor2   g108(.a(x28), .b(x27), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n103_), .c(x30), .O(new_n154_));
  oai21  g110(.a(new_n112_), .b(new_n45_), .c(new_n154_), .O(new_n155_));
  ...
  nor2   g128(.a(new_n133_), .b(new_n129_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n173_), .c(x19), .O(new_n176_));
  oai21  g132(.a(new_n174_), .b(new_n130_), .c(new_n129_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n174_), .b(new_n178_), .c(new_n133_), .O(new_n179_));
  oai21  g135(.a(new_n87_), .b(new_n137_), .c(new_n84_), .O(new_n180_));
  nor2   g136(.a(x18), .b(x13), .O(new_n181_));
  nor2   g137(.a(new_n129_), .b(x14), .O(new_n182_));
  ...
  nand4  g141(.a(new_n185_), .b(new_n180_), .c(new_n179_), .d(new_n177_), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n176_), .c(x30), .d(x27), .O(new_n187_));
  nand4  g143(.a(new_n48_), .b(x19), .c(x18), .d(x17), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n133_), .O(new_n189_));
  nand2  g145(.a(new_n122_), .b(new_n103_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n46_), .c(x27), .O(new_n191_));
  nand2  g147(.a(x31), .b(x29), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n153_), .c(x30), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  aoi21  g150(.a(new_n189_), .b(x15), .c(new_n194_), .O(new_n195_));
  ...
  nand3  g158(.a(new_n123_), .b(x31), .c(x30), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n168_), .c(new_n198_), .O(new_n205_));
