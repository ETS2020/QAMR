...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n58_), .c(new_n46_), .O(z3));
  ...
  nand2  g061(.a(x27), .b(x06), .O(new_n106_));
  nand3  g062(.a(new_n105_), .b(x29), .c(x28), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(x29), .O(new_n108_));
  nand2  g064(.a(x28), .b(x27), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n81_), .c(x30), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  aoi21  g067(.a(new_n108_), .b(new_n95_), .c(new_n111_), .O(new_n112_));
  inv1   g068(.a(new_n86_), .O(new_n113_));
  aoi22  g069(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n113_), .c(x30), .O(new_n115_));
  oai21  g071(.a(new_n112_), .b(new_n59_), .c(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n79_), .c(x25), .d(x01), .O(new_n117_));
  inv1   g073(.a(new_n117_), .O(z6));
  inv1   g074(.a(x06), .O(new_n119_));
  oai21  g075(.a(x31), .b(new_n119_), .c(new_n105_), .O(new_n120_));
  ...
  nand4  g081(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n82_), .O(new_n126_));
  nor2   g082(.a(new_n59_), .b(new_n58_), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  nand4  g084(.a(new_n98_), .b(new_n128_), .c(x30), .d(x29), .O(new_n129_));
  ...
  nor2   g092(.a(new_n134_), .b(new_n96_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n105_), .c(new_n136_), .O(new_n138_));
  ...
  nor2   g115(.a(new_n105_), .b(new_n96_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x27), .O(new_n161_));
  oai21  g117(.a(x30), .b(x27), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n97_), .O(new_n163_));
  ...
  nand4  g145(.a(new_n158_), .b(new_n184_), .c(new_n128_), .d(new_n105_), .O(new_n190_));
