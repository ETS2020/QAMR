...
module FAU ( 
  ...
  inv1   g51(.a(new_n61_), .O(new_n96_));
  nor3   g52(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n97_));
  aoi21  g53(.a(new_n97_), .b(new_n84_), .c(new_n96_), .O(new_n98_));
  xor2a  g54(.a(x28), .b(x27), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n98_), .c(x25), .d(x01), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n45_), .c(x26), .O(z4));
  ...
  aoi22  g61(.a(new_n105_), .b(new_n103_), .c(new_n97_), .d(new_n84_), .O(new_n106_));
  ...
  nand4  g69(.a(new_n113_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n114_));
  ...
  nand4  g75(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n120_));
  nor2   g76(.a(new_n96_), .b(new_n60_), .O(new_n121_));
  ...
  nand2  g84(.a(new_n128_), .b(new_n80_), .O(z7));
  zero   g85(.O(z9));
endmodule
