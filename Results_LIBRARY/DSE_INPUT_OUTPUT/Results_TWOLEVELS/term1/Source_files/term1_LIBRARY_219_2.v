...
module FAU ( 
  ...
  nor3   g052(.a(new_n96_), .b(new_n80_), .c(new_n60_), .O(z4));
  ...
  nand4  g067(.a(new_n61_), .b(new_n81_), .c(x25), .d(x01), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(new_n47_), .O(new_n113_));
  oai21  g069(.a(new_n104_), .b(new_n93_), .c(x31), .O(new_n114_));
  nor2   g070(.a(x31), .b(new_n104_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x28), .c(x27), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  aoi22  g073(.a(new_n117_), .b(x29), .c(x31), .d(new_n45_), .O(new_n118_));
  ...
  nor3   g092(.a(new_n121_), .b(new_n124_), .c(new_n136_), .O(new_n137_));
  ...
  oai21  g095(.a(new_n139_), .b(new_n123_), .c(new_n47_), .O(new_n140_));
  aoi21  g096(.a(new_n93_), .b(new_n45_), .c(new_n104_), .O(new_n141_));
  aoi21  g097(.a(x29), .b(x28), .c(x30), .O(new_n142_));
  aoi22  g098(.a(new_n142_), .b(new_n45_), .c(new_n141_), .d(x29), .O(new_n143_));
  ...
  nand3  g103(.a(new_n147_), .b(x30), .c(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n93_), .b(new_n45_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n104_), .c(x29), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand3  g107(.a(x19), .b(new_n131_), .c(x13), .O(new_n152_));
  inv1   g108(.a(x19), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n152_), .c(new_n129_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n129_), .d(x12), .O(new_n156_));
  ...
  nand4  g117(.a(new_n122_), .b(x16), .c(new_n136_), .d(x10), .O(new_n162_));
  ...
  nand2  g123(.a(new_n147_), .b(new_n45_), .O(new_n168_));
  inv1   g124(.a(x33), .O(new_n169_));
  nand4  g125(.a(new_n163_), .b(new_n169_), .c(x31), .d(x30), .O(new_n170_));
  ...
  nand4  g130(.a(new_n163_), .b(new_n169_), .c(new_n134_), .d(new_n104_), .O(new_n175_));
  ...
  nor3   g134(.a(new_n137_), .b(new_n135_), .c(new_n115_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n133_), .c(new_n130_), .d(new_n127_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n123_), .c(x33), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n178_), .c(new_n173_), .O(new_n182_));
