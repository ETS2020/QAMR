...
module FAU ( 
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n61_), .d(new_n45_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n96_), .c(new_n59_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n100_), .c(new_n61_), .d(new_n45_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n96_), .c(new_n59_), .O(z6));
  nor2   g070(.a(new_n110_), .b(new_n101_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n103_), .O(new_n116_));
  ...
  nor2   g086(.a(new_n128_), .b(new_n101_), .O(new_n131_));
  ...
  nand2  g106(.a(new_n115_), .b(x27), .O(new_n151_));
  oai21  g107(.a(x30), .b(x27), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n102_), .O(new_n153_));
  ...
  oai21  g114(.a(new_n140_), .b(new_n158_), .c(new_n82_), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  oai21  g116(.a(new_n88_), .b(new_n160_), .c(new_n85_), .O(new_n161_));
  ...
  aoi21  g121(.a(new_n115_), .b(x28), .c(new_n165_), .O(new_n166_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n45_), .c(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n47_), .O(z8));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n122_), .d(new_n110_), .O(new_n180_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n186_), .c(new_n88_), .O(new_n188_));
  ...
  oai21  g147(.a(new_n85_), .b(new_n158_), .c(new_n82_), .O(new_n192_));
  nand2  g148(.a(new_n85_), .b(new_n160_), .O(new_n193_));
  ...
  nand2  g156(.a(new_n200_), .b(new_n47_), .O(z9));
endmodule
