...
module FAU ( 
  ...
  oai21  g059(.a(new_n103_), .b(new_n102_), .c(x29), .O(new_n104_));
  inv1   g060(.a(x29), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x28), .c(x27), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n101_), .c(new_n62_), .d(new_n81_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x25), .c(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n46_), .O(z5));
  oai21  g067(.a(new_n105_), .b(new_n103_), .c(x27), .O(new_n112_));
  oai21  g068(.a(new_n45_), .b(x27), .c(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n62_), .d(new_n81_), .O(new_n114_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n102_), .c(x31), .O(new_n123_));
  ...
  oai21  g095(.a(new_n90_), .b(new_n139_), .c(new_n87_), .O(new_n140_));
  nor2   g096(.a(x19), .b(x14), .O(new_n141_));
  nand2  g097(.a(x16), .b(x15), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n130_), .c(x31), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  nand4  g100(.a(new_n144_), .b(new_n140_), .c(new_n138_), .d(new_n136_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n132_), .c(new_n46_), .O(new_n146_));
  aoi21  g102(.a(x29), .b(x28), .c(x30), .O(new_n147_));
  aoi21  g103(.a(new_n103_), .b(new_n102_), .c(new_n45_), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(x29), .c(new_n147_), .d(new_n102_), .O(new_n149_));
  ...
  nand4  g125(.a(new_n169_), .b(new_n156_), .c(new_n152_), .d(x31), .O(new_n170_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n142_), .c(new_n90_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n129_), .c(new_n167_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n133_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n84_), .c(new_n87_), .d(new_n139_), .O(new_n183_));
  ...
  oai21  g142(.a(new_n45_), .b(new_n103_), .c(x31), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n119_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n102_), .c(new_n186_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n164_), .b(new_n162_), .c(new_n167_), .O(new_n192_));
  inv1   g148(.a(new_n168_), .O(new_n193_));
  nand4  g149(.a(new_n122_), .b(new_n118_), .c(new_n45_), .d(new_n102_), .O(new_n194_));
  nand2  g150(.a(new_n103_), .b(new_n102_), .O(new_n195_));
