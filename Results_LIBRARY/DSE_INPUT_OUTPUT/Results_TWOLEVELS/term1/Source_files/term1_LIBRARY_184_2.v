...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n61_), .c(new_n57_), .O(new_n91_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n90_), .c(new_n61_), .d(new_n57_), .O(new_n107_));
  ...
  nand2  g067(.a(x30), .b(new_n102_), .O(new_n112_));
  inv1   g068(.a(x30), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x29), .c(new_n45_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n103_), .O(new_n115_));
  nor2   g071(.a(new_n113_), .b(x28), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(x27), .O(new_n117_));
  nand2  g073(.a(x30), .b(new_n81_), .O(new_n118_));
  ...
  oai21  g077(.a(x31), .b(x00), .c(new_n113_), .O(new_n122_));
  nand3  g078(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x31), .O(new_n124_));
  nand4  g080(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n125_));
  nor2   g081(.a(new_n60_), .b(new_n59_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand4  g083(.a(new_n104_), .b(new_n127_), .c(x30), .d(x29), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n126_), .c(new_n80_), .d(x25), .O(new_n129_));
  ...
  nand2  g088(.a(new_n103_), .b(new_n81_), .O(new_n133_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n134_), .c(new_n132_), .d(x31), .O(new_n155_));
  aoi21  g111(.a(new_n103_), .b(new_n81_), .c(new_n102_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n147_), .c(new_n152_), .O(new_n158_));
  nand2  g114(.a(x17), .b(x11), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n145_), .c(new_n144_), .O(new_n160_));
  inv1   g116(.a(x12), .O(new_n161_));
  oai21  g117(.a(new_n145_), .b(new_n161_), .c(new_n135_), .O(new_n162_));
  aoi21  g118(.a(x19), .b(x13), .c(x18), .O(new_n163_));
  nor2   g119(.a(x19), .b(x14), .O(new_n164_));
  nand2  g120(.a(x16), .b(x15), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n147_), .c(x31), .O(new_n166_));
  ...
  aoi21  g127(.a(new_n171_), .b(x30), .c(new_n45_), .O(z8));
  inv1   g128(.a(x33), .O(new_n173_));
  nand4  g129(.a(new_n154_), .b(new_n133_), .c(new_n173_), .d(x31), .O(new_n174_));
  aoi21  g130(.a(new_n138_), .b(x14), .c(new_n136_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x17), .c(x16), .d(x15), .O(new_n176_));
  nor2   g132(.a(new_n136_), .b(new_n135_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n165_), .c(new_n138_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n157_), .c(new_n152_), .O(new_n180_));
  aoi21  g136(.a(new_n177_), .b(x11), .c(x16), .O(new_n181_));
  oai21  g137(.a(new_n136_), .b(new_n161_), .c(new_n135_), .O(new_n182_));
  inv1   g138(.a(x13), .O(new_n183_));
  nand2  g139(.a(new_n136_), .b(new_n183_), .O(new_n184_));
  nor2   g140(.a(new_n127_), .b(new_n102_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n184_), .c(new_n182_), .d(new_n133_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n181_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n180_), .c(new_n179_), .d(new_n176_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  oai21  g145(.a(new_n174_), .b(new_n102_), .c(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(x30), .c(new_n80_), .d(x00), .O(new_n191_));
