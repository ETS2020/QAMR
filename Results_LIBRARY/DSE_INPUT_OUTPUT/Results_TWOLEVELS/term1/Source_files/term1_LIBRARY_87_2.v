...
module FAU ( 
  ...
  nand2  g057(.a(new_n101_), .b(new_n57_), .O(z5));
  ...
  nand3  g063(.a(new_n104_), .b(x29), .c(x28), .O(new_n108_));
  oai22  g064(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n104_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n103_), .c(new_n59_), .O(z6));
  ...
  oai21  g072(.a(new_n106_), .b(new_n115_), .c(new_n116_), .O(new_n117_));
  nor2   g073(.a(new_n115_), .b(x30), .O(new_n118_));
  aoi22  g074(.a(new_n118_), .b(new_n45_), .c(new_n117_), .d(x30), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n114_), .O(z7));
  nand2  g076(.a(new_n94_), .b(new_n81_), .O(new_n121_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n123_), .c(x31), .d(x30), .O(new_n142_));
  nand3  g098(.a(x32), .b(new_n104_), .c(new_n45_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n142_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n122_), .O(new_n145_));
  nand4  g101(.a(new_n141_), .b(new_n121_), .c(new_n123_), .d(x31), .O(new_n146_));
  nand2  g102(.a(new_n94_), .b(new_n81_), .O(new_n147_));
  ...
  aoi21  g107(.a(new_n151_), .b(new_n135_), .c(x15), .O(new_n152_));
  nor2   g108(.a(new_n127_), .b(new_n125_), .O(new_n153_));
  ...
  nor3   g116(.a(new_n134_), .b(new_n133_), .c(new_n139_), .O(new_n161_));
  nor3   g117(.a(new_n161_), .b(new_n160_), .c(new_n115_), .O(new_n162_));
  ...
  nand2  g125(.a(x33), .b(new_n115_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n121_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n141_), .b(new_n168_), .c(new_n115_), .d(new_n104_), .O(new_n173_));
  oai21  g129(.a(new_n168_), .b(new_n104_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n122_), .O(new_n175_));
  nor3   g131(.a(new_n161_), .b(new_n160_), .c(new_n118_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n152_), .c(x33), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n175_), .c(new_n172_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n80_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n57_), .O(z9));
endmodule
