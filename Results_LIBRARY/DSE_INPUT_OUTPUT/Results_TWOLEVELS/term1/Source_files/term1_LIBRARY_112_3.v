...
module FAU ( 
  ...
  nand4  g074(.a(new_n94_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n119_));
  nor2   g075(.a(new_n61_), .b(new_n60_), .O(new_n120_));
  inv1   g076(.a(new_n103_), .O(new_n121_));
  nand3  g077(.a(new_n46_), .b(x30), .c(x29), .O(new_n122_));
  ...
  nand3  g086(.a(x19), .b(new_n89_), .c(x13), .O(new_n131_));
  nand3  g087(.a(new_n92_), .b(x18), .c(x14), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n86_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n134_));
  ...
  aoi21  g096(.a(new_n140_), .b(new_n136_), .c(new_n130_), .O(new_n141_));
  nand3  g097(.a(x16), .b(new_n130_), .c(x10), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n138_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n141_), .c(new_n129_), .O(new_n144_));
  ...
  nor2   g103(.a(new_n127_), .b(new_n101_), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  nand2  g105(.a(x32), .b(new_n112_), .O(new_n150_));
  oai21  g106(.a(new_n144_), .b(new_n112_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g108(.a(new_n92_), .b(x14), .O(new_n153_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n152_), .c(new_n147_), .O(new_n172_));
  nand3  g128(.a(x32), .b(new_n46_), .c(new_n45_), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n172_), .b(x31), .c(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n126_), .c(new_n49_), .O(z8));
  nand2  g132(.a(new_n140_), .b(new_n136_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x15), .O(new_n178_));
  inv1   g134(.a(new_n143_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n178_), .c(x33), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n46_), .c(new_n112_), .d(new_n45_), .O(new_n181_));
  nand2  g137(.a(x33), .b(x31), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n181_), .c(new_n148_), .O(new_n183_));
  inv1   g139(.a(x33), .O(new_n184_));
  nand2  g140(.a(new_n179_), .b(new_n178_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n184_), .c(x31), .d(x30), .O(new_n186_));
  nand3  g142(.a(x33), .b(new_n46_), .c(new_n45_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n128_), .c(x29), .O(new_n189_));
  nand2  g145(.a(new_n46_), .b(x30), .O(new_n190_));
  nand4  g146(.a(new_n168_), .b(new_n166_), .c(new_n164_), .d(new_n190_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n162_), .c(new_n160_), .d(new_n156_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n45_), .O(new_n194_));
  oai21  g150(.a(new_n46_), .b(x30), .c(new_n194_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n189_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n183_), .c(x00), .O(new_n198_));
