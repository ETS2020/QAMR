...
module FAU ( 
  ...
  oai21  g044(.a(new_n45_), .b(x23), .c(new_n88_), .O(new_n89_));
  ...
  aoi21  g052(.a(new_n91_), .b(new_n90_), .c(new_n86_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n85_), .c(new_n83_), .O(new_n98_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n98_), .c(new_n61_), .d(new_n80_), .O(new_n106_));
  ...
  nand3  g066(.a(new_n110_), .b(x30), .c(x23), .O(new_n111_));
  ...
  nand2  g070(.a(new_n114_), .b(new_n88_), .O(new_n115_));
  nor2   g071(.a(new_n81_), .b(x23), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n112_), .c(x28), .d(new_n90_), .O(new_n117_));
  ...
  nand3  g079(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n124_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(new_n122_), .O(z7));
  and2   g087(.a(x16), .b(x10), .O(new_n132_));
  inv1   g088(.a(x19), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n90_), .O(new_n134_));
  ...
  nand4  g137(.a(x23), .b(new_n133_), .c(x18), .d(x14), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n163_), .c(new_n141_), .O(new_n183_));
  nand2  g139(.a(new_n141_), .b(x12), .O(new_n184_));
  nand3  g140(.a(x23), .b(x19), .c(x18), .O(new_n185_));
  ...
  nand4  g144(.a(new_n188_), .b(x17), .c(new_n138_), .d(x11), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x15), .O(new_n191_));
  nor2   g147(.a(new_n91_), .b(new_n133_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n174_), .c(x18), .d(x17), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n191_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n181_), .c(x31), .d(x30), .O(new_n195_));
  nand2  g151(.a(x33), .b(new_n125_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n154_), .c(x29), .O(new_n198_));
  nand4  g154(.a(new_n176_), .b(new_n181_), .c(new_n125_), .d(new_n45_), .O(new_n199_));
  nand2  g155(.a(x33), .b(x31), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n155_), .O(new_n202_));
  xor2a  g158(.a(x31), .b(x30), .O(new_n203_));
  nor3   g159(.a(new_n203_), .b(new_n148_), .c(new_n146_), .O(new_n204_));
  nand4  g160(.a(new_n204_), .b(new_n145_), .c(new_n143_), .d(new_n140_), .O(new_n205_));
  oai21  g161(.a(new_n205_), .b(new_n137_), .c(x33), .O(new_n206_));
  nand3  g162(.a(new_n206_), .b(new_n202_), .c(new_n198_), .O(new_n207_));
  nand3  g163(.a(new_n207_), .b(new_n80_), .c(x00), .O(new_n208_));
  nand2  g164(.a(new_n208_), .b(new_n57_), .O(z9));
endmodule
