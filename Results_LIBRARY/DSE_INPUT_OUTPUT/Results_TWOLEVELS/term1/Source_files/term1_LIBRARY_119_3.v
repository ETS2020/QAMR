...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n61_), .c(new_n45_), .O(z3));
  ...
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n101_), .d(new_n80_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n97_), .c(new_n61_), .O(z6));
