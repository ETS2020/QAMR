...
module FAU ( 
  ...
  and2   g44(.a(new_n88_), .b(new_n61_), .O(new_n89_));
  nand4  g45(.a(new_n89_), .b(new_n81_), .c(x25), .d(x01), .O(new_n90_));
  aoi21  g46(.a(new_n90_), .b(new_n80_), .c(x26), .O(z3));
  xor2a  g47(.a(x28), .b(x27), .O(new_n92_));
  nand4  g48(.a(new_n92_), .b(new_n88_), .c(new_n61_), .d(new_n45_), .O(new_n93_));
  inv1   g49(.a(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(x25), .c(x01), .d(new_n80_), .O(new_n95_));
  ...
  nand4  g57(.a(new_n101_), .b(new_n88_), .c(new_n61_), .d(new_n45_), .O(new_n102_));
  inv1   g58(.a(new_n102_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(x25), .c(x01), .d(new_n80_), .O(new_n104_));
  ...
  nand4  g66(.a(new_n110_), .b(new_n88_), .c(new_n61_), .d(new_n45_), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  nand4  g68(.a(new_n112_), .b(x25), .c(x01), .d(new_n80_), .O(new_n113_));
