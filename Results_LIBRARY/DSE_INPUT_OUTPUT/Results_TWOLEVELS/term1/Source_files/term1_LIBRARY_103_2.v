...
module FAU ( 
  ...
  nand3  g092(.a(new_n83_), .b(x25), .c(x01), .O(new_n137_));
  ...
  oai21  g097(.a(new_n141_), .b(new_n139_), .c(new_n47_), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(x26), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n138_), .c(new_n136_), .d(new_n134_), .O(z7));
  nor2   g100(.a(x26), .b(new_n45_), .O(z9));
endmodule
