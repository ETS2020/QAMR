...
module FAU ( 
  ...
  oai21  g054(.a(new_n98_), .b(new_n62_), .c(new_n48_), .O(z4));
  ...
  nand4  g072(.a(new_n116_), .b(new_n101_), .c(new_n100_), .d(new_n45_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n111_), .c(new_n62_), .O(z6));
  inv1   g074(.a(x31), .O(new_n119_));
  nor2   g075(.a(new_n114_), .b(new_n102_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n104_), .c(new_n119_), .O(new_n121_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n104_), .c(new_n111_), .O(new_n127_));
  ...
  nand3  g090(.a(new_n134_), .b(new_n114_), .c(x29), .O(new_n135_));
  nor2   g091(.a(new_n133_), .b(new_n102_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n114_), .c(new_n135_), .O(new_n137_));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n119_), .d(new_n114_), .O(new_n185_));
