...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n45_), .c(x29), .O(new_n100_));
  nand2  g056(.a(x28), .b(x27), .O(new_n101_));
  nor2   g057(.a(new_n98_), .b(x29), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n101_), .c(new_n100_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n90_), .c(new_n62_), .d(new_n81_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n97_), .c(new_n60_), .O(z5));
  inv1   g062(.a(x28), .O(new_n107_));
  oai21  g063(.a(new_n102_), .b(new_n107_), .c(x27), .O(new_n108_));
  oai21  g064(.a(new_n98_), .b(x27), .c(new_n108_), .O(new_n109_));
  ...
  nand3  g100(.a(new_n117_), .b(new_n98_), .c(new_n45_), .O(new_n145_));
  nand2  g101(.a(new_n107_), .b(new_n45_), .O(new_n146_));
