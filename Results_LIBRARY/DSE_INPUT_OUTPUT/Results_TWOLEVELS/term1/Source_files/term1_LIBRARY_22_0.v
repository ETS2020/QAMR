...
module FAU ( 
  ...
  oai21  g056(.a(new_n100_), .b(new_n60_), .c(new_n48_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n103_), .c(new_n62_), .d(new_n81_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n102_), .c(new_n60_), .O(z5));
  nand2  g064(.a(x29), .b(x28), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n45_), .c(x30), .O(new_n110_));
  inv1   g066(.a(x28), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n45_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand2  g069(.a(new_n46_), .b(x29), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n110_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n103_), .c(new_n62_), .d(new_n81_), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n102_), .c(new_n60_), .O(z6));
  ...
  nand4  g080(.a(new_n112_), .b(new_n124_), .c(x30), .d(x29), .O(new_n125_));
  ...
  nand2  g088(.a(x30), .b(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n131_), .c(new_n114_), .O(new_n134_));
  ...
  nand2  g106(.a(new_n111_), .b(new_n45_), .O(new_n151_));
  ...
  aoi21  g120(.a(new_n46_), .b(new_n132_), .c(new_n124_), .O(new_n165_));
  ...
  aoi22  g140(.a(new_n184_), .b(new_n182_), .c(new_n86_), .d(new_n159_), .O(new_n185_));
  ...
  nor2   g144(.a(new_n188_), .b(new_n83_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(x16), .c(x15), .O(new_n190_));
  nand2  g146(.a(new_n124_), .b(new_n132_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n46_), .c(x27), .O(new_n192_));
  nand2  g148(.a(x31), .b(x29), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n130_), .c(x30), .O(new_n194_));
  ...
  oai21  g158(.a(new_n198_), .b(new_n109_), .c(new_n202_), .O(new_n203_));
  nand3  g159(.a(new_n203_), .b(new_n149_), .c(new_n197_), .O(new_n204_));
