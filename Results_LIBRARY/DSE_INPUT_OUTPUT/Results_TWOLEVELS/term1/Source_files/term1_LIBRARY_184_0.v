...
module FAU ( 
  ...
  nor2   g000(.a(x30), .b(x00), .O(new_n45_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n60_), .c(new_n56_), .O(new_n90_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n89_), .c(new_n60_), .d(new_n56_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n79_), .c(x25), .d(x01), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(z5));
  inv1   g065(.a(new_n89_), .O(new_n110_));
  nand2  g066(.a(x30), .b(new_n101_), .O(new_n111_));
  inv1   g067(.a(x30), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x29), .c(x00), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(new_n102_), .O(new_n114_));
  nor2   g070(.a(new_n112_), .b(x28), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(x27), .O(new_n116_));
  nand2  g072(.a(x30), .b(new_n80_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n116_), .c(new_n110_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n58_), .O(z6));
  inv1   g076(.a(x00), .O(new_n121_));
  oai21  g077(.a(x31), .b(new_n121_), .c(new_n112_), .O(new_n122_));
  nand3  g078(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x31), .O(new_n124_));
  nand4  g080(.a(new_n88_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n125_));
  nor2   g081(.a(new_n59_), .b(new_n58_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand4  g083(.a(new_n103_), .b(new_n127_), .c(x30), .d(x29), .O(new_n128_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n134_), .c(x31), .d(x30), .O(new_n153_));
  nand2  g109(.a(x32), .b(new_n112_), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n121_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n133_), .O(new_n156_));
  nand2  g112(.a(new_n102_), .b(new_n80_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(x32), .c(x30), .d(x00), .O(new_n158_));
  nand4  g114(.a(new_n152_), .b(new_n132_), .c(new_n134_), .d(x31), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(x30), .c(new_n158_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x29), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n145_), .c(new_n150_), .O(new_n163_));
  nor2   g119(.a(new_n138_), .b(new_n136_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(x17), .c(x11), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n144_), .O(new_n166_));
  nand2  g122(.a(new_n164_), .b(x12), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n135_), .O(new_n168_));
  aoi21  g124(.a(x19), .b(x13), .c(x18), .O(new_n169_));
  nor2   g125(.a(x19), .b(x14), .O(new_n170_));
  nand2  g126(.a(x16), .b(x15), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n145_), .c(x31), .O(new_n172_));
  nor3   g128(.a(new_n172_), .b(new_n170_), .c(new_n169_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n168_), .c(new_n166_), .d(new_n163_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(x32), .c(x00), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n161_), .c(new_n156_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n79_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n56_), .O(z8));
  inv1   g134(.a(x33), .O(new_n179_));
  nand4  g135(.a(new_n152_), .b(new_n179_), .c(x31), .d(x30), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n127_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n132_), .c(x29), .O(new_n183_));
  nand4  g139(.a(new_n152_), .b(new_n179_), .c(new_n127_), .d(new_n112_), .O(new_n184_));
  oai21  g140(.a(new_n179_), .b(new_n127_), .c(new_n184_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n133_), .O(new_n186_));
  aoi21  g142(.a(new_n138_), .b(x14), .c(new_n136_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(x17), .c(x16), .d(x15), .O(new_n188_));
  nand2  g144(.a(x18), .b(x17), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n171_), .c(new_n138_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n162_), .c(new_n150_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n144_), .O(new_n193_));
  nand2  g149(.a(x18), .b(x12), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n135_), .O(new_n195_));
  inv1   g151(.a(x13), .O(new_n196_));
  nand2  g152(.a(new_n136_), .b(new_n196_), .O(new_n197_));
  xnor2a g153(.a(x31), .b(x30), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n197_), .c(new_n195_), .d(new_n193_), .O(new_n199_));
  inv1   g155(.a(new_n199_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n191_), .c(new_n190_), .d(new_n188_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(x33), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n186_), .c(new_n183_), .O(new_n203_));
  nand3  g159(.a(new_n203_), .b(new_n79_), .c(x00), .O(new_n204_));
