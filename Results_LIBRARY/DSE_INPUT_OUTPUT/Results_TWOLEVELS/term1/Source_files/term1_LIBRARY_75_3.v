...
module FAU ( 
  ...
  inv1   g073(.a(new_n101_), .O(new_n118_));
  ...
  nand2  g104(.a(new_n148_), .b(new_n100_), .O(new_n149_));
  ...
  nand2  g109(.a(new_n152_), .b(x12), .O(new_n154_));
  ...
  nor2   g114(.a(new_n137_), .b(new_n143_), .O(new_n159_));
  ...
  aoi21  g119(.a(new_n153_), .b(new_n137_), .c(new_n163_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n151_), .c(new_n149_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(x32), .c(x26), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n146_), .c(new_n124_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n145_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n119_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n127_), .c(x29), .O(new_n172_));
  inv1   g128(.a(new_n129_), .O(new_n173_));
  nand4  g129(.a(new_n145_), .b(new_n168_), .c(new_n119_), .d(new_n108_), .O(new_n174_));
  ...
  aoi21  g133(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x17), .c(x16), .d(x15), .O(new_n179_));
  inv1   g135(.a(new_n159_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n180_), .c(new_n90_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n150_), .c(new_n143_), .O(new_n183_));
  inv1   g139(.a(x11), .O(new_n184_));
  oai21  g140(.a(new_n181_), .b(new_n184_), .c(new_n137_), .O(new_n185_));
  nand2  g141(.a(x18), .b(x12), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n84_), .O(new_n187_));
  nand2  g143(.a(new_n87_), .b(new_n156_), .O(new_n188_));
  ...
  nand3  g149(.a(new_n193_), .b(new_n177_), .c(new_n172_), .O(new_n194_));
