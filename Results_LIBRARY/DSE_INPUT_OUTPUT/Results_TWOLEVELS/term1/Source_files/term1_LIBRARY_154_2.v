...
module FAU ( 
  ...
  nor2   g051(.a(new_n45_), .b(x28), .O(new_n96_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n89_), .c(new_n60_), .d(x30), .O(new_n106_));
  ...
  nand4  g066(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(new_n46_), .O(new_n112_));
  ...
  aoi22  g073(.a(new_n117_), .b(x30), .c(x31), .d(new_n81_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n112_), .O(z7));
  ...
  aoi21  g084(.a(new_n128_), .b(x12), .c(x17), .O(new_n129_));
  ...
  aoi21  g093(.a(new_n135_), .b(new_n134_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n133_), .c(new_n130_), .d(new_n127_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n123_), .c(new_n46_), .O(new_n140_));
  nand3  g096(.a(new_n113_), .b(new_n45_), .c(new_n81_), .O(new_n141_));
  oai21  g097(.a(x28), .b(x27), .c(x30), .O(new_n142_));
  inv1   g098(.a(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x29), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n141_), .c(new_n140_), .O(new_n145_));
  ...
  oai21  g105(.a(new_n149_), .b(new_n96_), .c(new_n81_), .O(new_n150_));
  oai21  g106(.a(new_n45_), .b(x29), .c(new_n150_), .O(new_n151_));
  inv1   g107(.a(x17), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n131_), .c(x13), .O(new_n153_));
  ...
  nand3  g114(.a(new_n122_), .b(new_n124_), .c(x11), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x15), .O(new_n161_));
  nor2   g117(.a(new_n124_), .b(x15), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n122_), .c(x10), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n151_), .c(new_n147_), .d(x31), .O(new_n165_));
  ...
  nand2  g125(.a(x30), .b(x28), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n81_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x31), .c(x29), .O(new_n172_));
  nand3  g128(.a(new_n113_), .b(new_n115_), .c(new_n45_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n164_), .c(new_n169_), .O(new_n175_));
  aoi21  g131(.a(x31), .b(x29), .c(new_n45_), .O(new_n176_));
  inv1   g132(.a(new_n123_), .O(new_n177_));
  nand2  g133(.a(new_n142_), .b(x31), .O(new_n178_));
  nand2  g134(.a(new_n135_), .b(new_n134_), .O(new_n179_));
  nand3  g135(.a(new_n122_), .b(x16), .c(x15), .O(new_n180_));
  nand3  g136(.a(new_n115_), .b(x29), .c(x28), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n133_), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n129_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n178_), .c(new_n127_), .d(new_n177_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n176_), .c(x33), .O(new_n185_));
