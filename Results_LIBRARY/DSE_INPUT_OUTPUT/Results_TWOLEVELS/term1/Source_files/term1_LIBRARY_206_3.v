...
module FAU ( 
  ...
  nand3  g023(.a(new_n67_), .b(new_n56_), .c(new_n46_), .O(new_n68_));
  ...
  nand3  g030(.a(new_n74_), .b(new_n69_), .c(new_n46_), .O(new_n75_));
  ...
  oai21  g054(.a(new_n98_), .b(new_n60_), .c(new_n46_), .O(z4));
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n100_), .d(new_n80_), .O(new_n116_));
  ...
  nor2   g080(.a(new_n57_), .b(new_n60_), .O(new_n125_));
  inv1   g081(.a(new_n104_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x30), .c(x29), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n80_), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n79_), .O(new_n130_));
