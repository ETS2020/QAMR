...
module FAU ( 
  ...
  nand3  g051(.a(new_n46_), .b(new_n95_), .c(x27), .O(new_n96_));
  nand2  g052(.a(x30), .b(new_n45_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(x28), .c(new_n81_), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n96_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n94_), .c(new_n59_), .O(z4));
  inv1   g057(.a(x30), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n45_), .c(x28), .O(new_n103_));
  oai21  g059(.a(new_n45_), .b(x28), .c(new_n103_), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(x27), .O(new_n105_));
  nand2  g061(.a(x29), .b(new_n81_), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n105_), .c(new_n90_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n59_), .O(z5));
  xor2a  g065(.a(x30), .b(x27), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x29), .c(x28), .O(new_n111_));
  oai21  g067(.a(new_n102_), .b(x28), .c(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x25), .c(x01), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n46_), .O(z6));
  nor4   g072(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n117_));
  nand4  g073(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n46_), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  nor2   g076(.a(new_n95_), .b(new_n81_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n120_), .c(x30), .O(new_n122_));
  oai21  g078(.a(new_n121_), .b(new_n120_), .c(new_n122_), .O(new_n123_));
  nor2   g079(.a(new_n120_), .b(x30), .O(new_n124_));
  aoi21  g080(.a(new_n123_), .b(x29), .c(new_n124_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n119_), .O(z7));
  inv1   g082(.a(x32), .O(new_n127_));
  nand2  g083(.a(new_n80_), .b(x00), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(new_n102_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n45_), .O(new_n130_));
  nand2  g086(.a(new_n95_), .b(new_n81_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n102_), .c(x29), .O(new_n132_));
  nand3  g088(.a(x30), .b(new_n95_), .c(new_n81_), .O(new_n133_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n134_), .c(new_n127_), .d(x31), .O(new_n153_));
  oai21  g109(.a(new_n45_), .b(new_n81_), .c(new_n95_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x30), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n145_), .c(new_n150_), .O(new_n157_));
  nor2   g113(.a(new_n138_), .b(new_n136_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(x17), .c(x11), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n144_), .O(new_n160_));
  aoi21  g116(.a(new_n158_), .b(x12), .c(x17), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n138_), .b(new_n162_), .c(new_n136_), .O(new_n163_));
  inv1   g119(.a(x14), .O(new_n164_));
  nand2  g120(.a(new_n138_), .b(new_n164_), .O(new_n165_));
  nand3  g121(.a(new_n146_), .b(x16), .c(x15), .O(new_n166_));
  nor2   g122(.a(x30), .b(x28), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n81_), .c(new_n120_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n166_), .c(new_n165_), .d(new_n163_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n161_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n160_), .c(new_n157_), .d(new_n155_), .O(new_n171_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n130_), .O(z8));
  nand2  g131(.a(new_n138_), .b(x14), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x18), .c(x17), .d(x16), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n150_), .O(new_n178_));
  nand2  g134(.a(x16), .b(x15), .O(new_n179_));
  nand2  g135(.a(x18), .b(x17), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n138_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n156_), .c(new_n150_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n144_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(new_n135_), .c(new_n136_), .d(new_n162_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n184_), .c(new_n182_), .d(new_n181_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n178_), .c(new_n46_), .O(new_n188_));
  nand2  g144(.a(new_n131_), .b(new_n120_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n133_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(x29), .c(new_n124_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n188_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  aoi21  g149(.a(new_n147_), .b(new_n143_), .c(new_n150_), .O(new_n194_));
  inv1   g150(.a(new_n151_), .O(new_n195_));
  nand4  g151(.a(new_n131_), .b(x31), .c(x30), .d(x29), .O(new_n196_));
  nand2  g152(.a(new_n131_), .b(x29), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n120_), .c(new_n102_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n196_), .O(new_n199_));
  oai21  g155(.a(new_n195_), .b(new_n194_), .c(new_n199_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(x33), .c(new_n193_), .O(new_n201_));
