...
module FAU ( 
  ...
  nand2  g073(.a(new_n117_), .b(new_n49_), .O(z6));
  ...
  nor2   g083(.a(new_n127_), .b(new_n81_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n123_), .c(new_n122_), .d(new_n121_), .O(z7));
  ...
  oai21  g117(.a(new_n143_), .b(new_n161_), .c(new_n86_), .O(new_n162_));
  inv1   g118(.a(x13), .O(new_n163_));
  oai21  g119(.a(new_n92_), .b(new_n163_), .c(new_n89_), .O(new_n164_));
  ...
  nand2  g131(.a(new_n175_), .b(new_n49_), .O(z8));
  nand4  g132(.a(new_n152_), .b(new_n46_), .c(x31), .d(x30), .O(new_n177_));
  ...
  nand4  g137(.a(new_n152_), .b(new_n46_), .c(new_n125_), .d(new_n112_), .O(new_n182_));
  ...
  aoi21  g141(.a(new_n92_), .b(x14), .c(new_n89_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(x17), .c(x16), .d(x15), .O(new_n187_));
  inv1   g143(.a(new_n166_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x17), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n188_), .c(new_n92_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n157_), .c(new_n150_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n142_), .O(new_n193_));
  oai21  g149(.a(new_n89_), .b(new_n161_), .c(new_n86_), .O(new_n194_));
  nand2  g150(.a(new_n89_), .b(new_n163_), .O(new_n195_));
