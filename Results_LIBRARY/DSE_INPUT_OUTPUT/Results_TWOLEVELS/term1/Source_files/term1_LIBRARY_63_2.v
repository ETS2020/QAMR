...
module FAU ( 
  ...
  nand4  g067(.a(new_n111_), .b(new_n100_), .c(x25), .d(x01), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n45_), .c(x26), .O(z3));
  xor2a  g069(.a(x28), .b(x27), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n111_), .c(x25), .d(x01), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g072(.a(x29), .O(new_n117_));
  and2   g073(.a(x28), .b(x27), .O(new_n118_));
  or2    g074(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  nand3  g075(.a(new_n117_), .b(x28), .c(x27), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n119_), .c(new_n110_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n83_), .c(x25), .d(x01), .O(new_n122_));
  ...
  nand4  g085(.a(new_n129_), .b(new_n109_), .c(new_n83_), .d(new_n124_), .O(new_n130_));
  ...
  inv1   g091(.a(new_n105_), .O(new_n136_));
  inv1   g092(.a(new_n106_), .O(new_n137_));
  inv1   g093(.a(new_n107_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n137_), .c(new_n136_), .d(new_n104_), .O(new_n139_));
  nor2   g095(.a(new_n101_), .b(new_n61_), .O(new_n140_));
