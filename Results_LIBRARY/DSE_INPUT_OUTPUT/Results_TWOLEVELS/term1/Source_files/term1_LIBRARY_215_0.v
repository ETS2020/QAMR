...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n58_), .c(new_n56_), .O(z4));
  ...
  nand3  g058(.a(new_n99_), .b(x28), .c(x27), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n99_), .c(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n98_), .c(new_n60_), .d(new_n79_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n56_), .O(z5));
  nand2  g064(.a(x29), .b(x28), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x30), .O(new_n110_));
  inv1   g066(.a(x30), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(x29), .c(x28), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n110_), .c(x27), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n98_), .c(new_n60_), .d(new_n79_), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x25), .c(x01), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n56_), .O(z6));
  oai21  g073(.a(x31), .b(new_n111_), .c(new_n100_), .O(new_n118_));
  ...
  nand2  g085(.a(new_n111_), .b(x29), .O(new_n130_));
  nand2  g086(.a(new_n101_), .b(new_n100_), .O(new_n131_));
  ...
  nand2  g105(.a(new_n101_), .b(new_n100_), .O(new_n150_));
  ...
  aoi21  g118(.a(new_n111_), .b(new_n99_), .c(new_n124_), .O(new_n163_));
  ...
  aoi21  g139(.a(new_n124_), .b(new_n99_), .c(x30), .O(new_n184_));
  nand3  g140(.a(new_n131_), .b(x31), .c(x29), .O(new_n185_));
  ...
  oai21  g151(.a(new_n191_), .b(new_n109_), .c(new_n195_), .O(new_n196_));
