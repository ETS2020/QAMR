...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n90_), .c(new_n81_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n93_), .c(new_n60_), .O(z4));
  inv1   g054(.a(x29), .O(new_n99_));
  aoi21  g055(.a(x30), .b(new_n94_), .c(new_n45_), .O(new_n100_));
  nand2  g056(.a(x28), .b(x27), .O(new_n101_));
  nand2  g057(.a(x30), .b(new_n99_), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n101_), .c(new_n100_), .d(new_n99_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n89_), .c(new_n62_), .d(new_n81_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n93_), .c(new_n60_), .O(z5));
  nand3  g061(.a(x29), .b(x28), .c(x27), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n89_), .c(new_n62_), .d(x30), .O(new_n107_));
  ...
  oai21  g073(.a(new_n117_), .b(new_n101_), .c(new_n115_), .O(new_n118_));
  ...
  nand2  g104(.a(new_n114_), .b(new_n127_), .O(new_n149_));
  nand3  g105(.a(x30), .b(x29), .c(x28), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(x27), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n140_), .c(new_n145_), .O(new_n153_));
  nor2   g109(.a(new_n133_), .b(new_n131_), .O(new_n154_));
  ...
  nand3  g117(.a(new_n141_), .b(x16), .c(x15), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n161_), .c(x31), .O(new_n163_));
  aoi21  g119(.a(new_n159_), .b(new_n131_), .c(new_n163_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n158_), .c(new_n156_), .d(new_n153_), .O(new_n165_));
  ...
  oai21  g126(.a(new_n127_), .b(new_n94_), .c(new_n45_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x31), .c(x29), .O(new_n172_));
  nand3  g128(.a(new_n114_), .b(new_n116_), .c(new_n127_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n147_), .c(new_n170_), .O(new_n175_));
  aoi21  g131(.a(x31), .b(x29), .c(new_n127_), .O(new_n176_));
  oai21  g132(.a(new_n125_), .b(new_n127_), .c(x31), .O(new_n177_));
  nand2  g133(.a(new_n159_), .b(new_n131_), .O(new_n178_));
  nand3  g134(.a(new_n116_), .b(x29), .c(x28), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n162_), .c(new_n161_), .d(new_n178_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n157_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n177_), .c(new_n156_), .d(new_n153_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n176_), .c(x33), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n175_), .O(new_n184_));
