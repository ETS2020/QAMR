...
module FAU ( 
  ...
  nor2   g047(.a(new_n91_), .b(new_n82_), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(new_n61_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n81_), .c(new_n46_), .d(x25), .O(new_n94_));
  ...
  nor3   g054(.a(new_n98_), .b(new_n96_), .c(new_n60_), .O(z4));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n62_), .d(new_n46_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n58_), .O(z5));
  ...
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n62_), .d(new_n46_), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n96_), .c(new_n60_), .O(z6));
  nor2   g072(.a(new_n112_), .b(new_n101_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n103_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  inv1   g075(.a(new_n82_), .O(new_n120_));
  nand4  g076(.a(new_n90_), .b(new_n87_), .c(new_n85_), .d(new_n120_), .O(new_n121_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n46_), .O(new_n126_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n112_), .c(new_n132_), .O(new_n134_));
  ...
  oai21  g118(.a(new_n88_), .b(new_n162_), .c(new_n86_), .O(new_n163_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n46_), .c(x00), .O(new_n174_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n124_), .d(new_n112_), .O(new_n182_));
  ...
  nand3  g157(.a(new_n201_), .b(new_n46_), .c(x00), .O(new_n202_));
