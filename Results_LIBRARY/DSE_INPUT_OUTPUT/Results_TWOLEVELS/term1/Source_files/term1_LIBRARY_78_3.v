...
module FAU ( 
  ...
  nand4  g065(.a(new_n109_), .b(x29), .c(x28), .d(x27), .O(new_n110_));
  oai21  g066(.a(new_n109_), .b(x27), .c(new_n110_), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n94_), .c(new_n80_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n79_), .c(new_n59_), .O(z6));
  ...
  oai21  g091(.a(new_n135_), .b(new_n121_), .c(new_n45_), .O(new_n136_));
  nand3  g092(.a(x30), .b(x29), .c(x28), .O(new_n137_));
  oai21  g093(.a(x30), .b(x28), .c(new_n137_), .O(new_n138_));
  aoi22  g094(.a(new_n138_), .b(new_n81_), .c(new_n109_), .d(new_n102_), .O(new_n139_));
  ...
  nand3  g099(.a(new_n143_), .b(x30), .c(new_n81_), .O(new_n144_));
  ...
  nand2  g120(.a(new_n129_), .b(x14), .O(new_n165_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n132_), .c(new_n129_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n118_), .c(new_n158_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n168_), .b(new_n171_), .c(new_n122_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x12), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(new_n85_), .c(new_n88_), .d(new_n128_), .O(new_n174_));
  ...
  oai21  g136(.a(x31), .b(new_n109_), .c(new_n180_), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n81_), .c(new_n179_), .d(new_n109_), .O(new_n182_));
  ...
  nand3  g146(.a(new_n177_), .b(new_n109_), .c(new_n102_), .O(new_n191_));
