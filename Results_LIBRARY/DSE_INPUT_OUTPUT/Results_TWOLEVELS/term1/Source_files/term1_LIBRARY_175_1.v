...
module FAU ( 
  ...
  nand3  g055(.a(new_n45_), .b(x28), .c(new_n81_), .O(new_n100_));
  oai21  g056(.a(x28), .b(new_n81_), .c(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n94_), .c(new_n80_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n99_), .c(new_n60_), .O(z4));
  xor2a  g059(.a(x29), .b(x28), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n94_), .c(x27), .O(new_n105_));
  ...
  oai21  g065(.a(new_n45_), .b(new_n109_), .c(x30), .O(new_n110_));
  inv1   g066(.a(x30), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x29), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n109_), .c(new_n110_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x25), .c(x01), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n47_), .O(z6));
  nand3  g073(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n91_), .O(new_n119_));
  nand4  g075(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n47_), .O(new_n121_));
  oai21  g077(.a(new_n111_), .b(new_n109_), .c(x31), .O(new_n122_));
  ...
  nand2  g084(.a(x30), .b(new_n45_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n112_), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n88_), .c(x13), .O(new_n131_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n130_), .c(new_n128_), .d(x31), .O(new_n147_));
  and2   g103(.a(x16), .b(x10), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n140_), .c(x15), .O(new_n149_));
  ...
  oai21  g109(.a(new_n150_), .b(new_n153_), .c(new_n85_), .O(new_n154_));
  nand2  g110(.a(x19), .b(x13), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n88_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n139_), .c(x19), .d(x14), .O(new_n158_));
  aoi21  g114(.a(new_n111_), .b(new_n45_), .c(new_n123_), .O(new_n159_));
  oai21  g115(.a(new_n111_), .b(new_n45_), .c(new_n159_), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n162_));
  ...
  nand3  g124(.a(new_n123_), .b(new_n111_), .c(new_n45_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n146_), .c(new_n167_), .O(new_n171_));
  nand2  g127(.a(x31), .b(new_n111_), .O(new_n172_));
  nand2  g128(.a(new_n123_), .b(x29), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n172_), .c(new_n129_), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n158_), .O(new_n175_));
  ...
  nand2  g133(.a(new_n177_), .b(new_n171_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n80_), .c(x00), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n47_), .O(z9));
endmodule
