...
module FAU ( 
  ...
  nand4  g081(.a(x32), .b(x29), .c(new_n80_), .d(x00), .O(new_n126_));
  ...
  nor2   g117(.a(new_n161_), .b(new_n141_), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  inv1   g119(.a(x28), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(x27), .O(new_n165_));
  nor2   g121(.a(new_n45_), .b(new_n103_), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n165_), .c(new_n115_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n163_), .c(new_n159_), .d(new_n157_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n155_), .c(new_n152_), .d(new_n150_), .O(new_n170_));
  ...
  nand2  g129(.a(new_n173_), .b(new_n128_), .O(z8));
  nand2  g130(.a(new_n89_), .b(x14), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x18), .c(x17), .d(x16), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n146_), .O(new_n177_));
  nand2  g133(.a(x18), .b(x17), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n161_), .c(new_n89_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n151_), .c(new_n146_), .O(new_n180_));
  inv1   g136(.a(x11), .O(new_n181_));
  oai21  g137(.a(new_n178_), .b(new_n181_), .c(new_n140_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(new_n83_), .c(new_n86_), .d(new_n158_), .O(new_n184_));
  ...
  oai21  g143(.a(new_n45_), .b(new_n164_), .c(x31), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n116_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n81_), .c(new_n187_), .O(new_n190_));
  ...
  nand4  g150(.a(new_n119_), .b(new_n115_), .c(new_n45_), .d(new_n81_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nor4   g152(.a(new_n130_), .b(new_n115_), .c(new_n45_), .d(new_n103_), .O(new_n197_));
  oai22  g153(.a(new_n197_), .b(new_n196_), .c(new_n194_), .d(new_n193_), .O(new_n198_));
