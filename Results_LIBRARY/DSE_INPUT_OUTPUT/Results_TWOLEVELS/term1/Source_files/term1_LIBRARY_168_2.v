...
module FAU ( 
  ...
  nand3  g055(.a(new_n99_), .b(new_n61_), .c(new_n47_), .O(new_n100_));
  ...
  nand3  g061(.a(new_n105_), .b(x29), .c(new_n45_), .O(new_n106_));
  ...
  nand3  g102(.a(x32), .b(new_n105_), .c(new_n45_), .O(new_n147_));
  ...
  nand4  g149(.a(new_n126_), .b(new_n119_), .c(new_n105_), .d(new_n45_), .O(new_n194_));
