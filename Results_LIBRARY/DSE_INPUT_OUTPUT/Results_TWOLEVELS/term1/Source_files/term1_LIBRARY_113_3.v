...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n63_), .c(new_n48_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n46_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n63_), .c(new_n48_), .O(z4));
  ...
  nor2   g075(.a(new_n115_), .b(new_n103_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n105_), .O(new_n121_));
  ...
  nor2   g085(.a(new_n129_), .b(new_n112_), .O(new_n130_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n144_), .O(new_n161_));
  inv1   g117(.a(x12), .O(new_n162_));
  oai21  g118(.a(new_n159_), .b(new_n162_), .c(new_n84_), .O(new_n163_));
  ...
  nor2   g123(.a(new_n167_), .b(new_n145_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n166_), .O(new_n169_));
  oai21  g125(.a(x30), .b(x29), .c(x31), .O(new_n170_));
  aoi21  g126(.a(new_n120_), .b(x28), .c(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n169_), .c(new_n165_), .d(new_n163_), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n161_), .c(new_n158_), .d(new_n156_), .O(new_n174_));
  ...
  nand4  g140(.a(new_n152_), .b(new_n179_), .c(new_n127_), .d(new_n115_), .O(new_n185_));
  ...
  oai21  g146(.a(new_n190_), .b(new_n167_), .c(new_n90_), .O(new_n191_));
  oai21  g147(.a(new_n190_), .b(new_n157_), .c(new_n150_), .O(new_n192_));
  inv1   g148(.a(x11), .O(new_n193_));
  oai21  g149(.a(new_n190_), .b(new_n193_), .c(new_n144_), .O(new_n194_));
  oai21  g150(.a(new_n87_), .b(new_n162_), .c(new_n84_), .O(new_n195_));
  nand2  g151(.a(new_n87_), .b(new_n164_), .O(new_n196_));
  ...
  aoi21  g158(.a(new_n187_), .b(new_n184_), .c(new_n202_), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(new_n183_), .c(new_n45_), .O(z9));
endmodule
