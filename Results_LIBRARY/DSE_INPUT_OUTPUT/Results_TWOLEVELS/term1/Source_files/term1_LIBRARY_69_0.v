...
module FAU ( 
  ...
  aoi21  g066(.a(new_n110_), .b(x28), .c(x26), .O(z3));
  nand4  g067(.a(new_n109_), .b(new_n45_), .c(x25), .d(x01), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z4));
  xor2a  g069(.a(x29), .b(x27), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n107_), .c(x25), .d(x01), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(x28), .c(x26), .O(z5));
  inv1   g072(.a(x29), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n98_), .c(x30), .O(new_n118_));
  inv1   g074(.a(x30), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x29), .c(x27), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n118_), .c(new_n106_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n62_), .c(x25), .d(x01), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(x28), .c(x26), .O(z6));
  nand2  g079(.a(x30), .b(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n98_), .c(x31), .O(new_n125_));
  inv1   g081(.a(new_n102_), .O(new_n126_));
  inv1   g082(.a(new_n103_), .O(new_n127_));
  inv1   g083(.a(new_n104_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n126_), .d(new_n101_), .O(new_n129_));
  nor2   g085(.a(new_n72_), .b(new_n61_), .O(new_n130_));
  ...
  aoi21  g091(.a(new_n135_), .b(new_n132_), .c(new_n131_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n130_), .c(new_n129_), .d(new_n125_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x28), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n45_), .O(z7));
  inv1   g095(.a(x32), .O(new_n140_));
  nand2  g096(.a(new_n119_), .b(x29), .O(new_n141_));
  nand2  g097(.a(x30), .b(new_n117_), .O(new_n142_));
  ...
  nor2   g114(.a(new_n153_), .b(x15), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n155_), .c(x10), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n143_), .c(new_n140_), .d(x31), .O(new_n162_));
  and2   g118(.a(x16), .b(x10), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n155_), .c(x15), .O(new_n164_));
  nand2  g120(.a(x19), .b(x18), .O(new_n165_));
  nand2  g121(.a(x17), .b(x11), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n165_), .c(new_n153_), .O(new_n167_));
  inv1   g123(.a(x12), .O(new_n168_));
  oai21  g124(.a(new_n165_), .b(new_n168_), .c(new_n144_), .O(new_n169_));
  nand2  g125(.a(x19), .b(x13), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n145_), .O(new_n171_));
  nand2  g127(.a(x16), .b(x15), .O(new_n172_));
  oai22  g128(.a(new_n172_), .b(new_n154_), .c(x19), .d(x14), .O(new_n173_));
  nand3  g129(.a(new_n119_), .b(new_n117_), .c(x28), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n124_), .c(x31), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n173_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n171_), .c(new_n169_), .d(new_n167_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n164_), .c(x32), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n162_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x00), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(x28), .c(x26), .O(z8));
  inv1   g137(.a(x33), .O(new_n182_));
  nand3  g138(.a(x31), .b(x30), .c(x29), .O(new_n183_));
  nand3  g139(.a(new_n133_), .b(new_n119_), .c(new_n117_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n161_), .c(new_n182_), .O(new_n186_));
  nand2  g142(.a(x31), .b(new_n117_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n134_), .c(new_n141_), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n173_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n171_), .c(new_n169_), .d(new_n167_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n164_), .c(x33), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n186_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x00), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(x28), .c(x26), .O(z9));
endmodule
