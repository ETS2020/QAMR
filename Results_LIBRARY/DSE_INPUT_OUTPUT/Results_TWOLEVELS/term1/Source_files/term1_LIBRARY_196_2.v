...
module FAU ( 
  ...
  nand4  g046(.a(new_n90_), .b(new_n45_), .c(new_n81_), .d(x25), .O(new_n91_));
  ...
  aoi21  g054(.a(x30), .b(new_n98_), .c(new_n45_), .O(new_n99_));
  nand2  g055(.a(x28), .b(x27), .O(new_n100_));
  nand2  g056(.a(x30), .b(new_n97_), .O(new_n101_));
  ...
  aoi21  g060(.a(x30), .b(new_n97_), .c(new_n98_), .O(new_n105_));
  ...
  nor2   g071(.a(new_n97_), .b(new_n98_), .O(new_n116_));
  nand2  g072(.a(new_n115_), .b(x29), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n100_), .c(new_n116_), .d(new_n115_), .O(new_n118_));
  aoi22  g074(.a(new_n118_), .b(x30), .c(x31), .d(new_n45_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n114_), .O(z7));
  nand4  g076(.a(x32), .b(x29), .c(new_n81_), .d(x00), .O(new_n121_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n97_), .c(x30), .O(new_n126_));
  inv1   g082(.a(x30), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x29), .c(x28), .O(new_n128_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(new_n124_), .d(x31), .O(new_n148_));
  inv1   g104(.a(new_n116_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n127_), .c(new_n45_), .O(new_n150_));
  ...
  nor2   g117(.a(new_n127_), .b(new_n97_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(x28), .c(new_n115_), .O(new_n163_));
  ...
  inv1   g127(.a(new_n125_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x31), .c(x30), .d(x29), .O(new_n173_));
  nand3  g129(.a(new_n149_), .b(new_n115_), .c(new_n127_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n147_), .c(new_n171_), .O(new_n176_));
  aoi21  g132(.a(x31), .b(x29), .c(new_n127_), .O(new_n177_));
  oai21  g133(.a(new_n125_), .b(new_n127_), .c(x31), .O(new_n178_));
  nand3  g134(.a(new_n115_), .b(x29), .c(x28), .O(new_n179_));
