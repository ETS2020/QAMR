// Benchmark "FAU" written by ABC on Thu Aug 20 01:03:10 2020
...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n46_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n63_), .c(new_n49_), .O(z4));
  inv1   g056(.a(new_n60_), .O(new_n101_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n101_), .d(new_n46_), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x25), .c(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n49_), .O(z5));
  ...
  nand4  g073(.a(new_n117_), .b(new_n102_), .c(new_n101_), .d(new_n46_), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n112_), .c(new_n63_), .O(z6));
  inv1   g075(.a(x31), .O(new_n120_));
  nor2   g076(.a(new_n115_), .b(new_n103_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n105_), .c(new_n120_), .O(new_n122_));
  ...
  nand3  g081(.a(new_n120_), .b(x30), .c(x29), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n105_), .c(new_n112_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n122_), .c(new_n46_), .O(new_n130_));
  oai21  g086(.a(new_n46_), .b(x00), .c(new_n130_), .O(z7));
  inv1   g087(.a(x32), .O(new_n132_));
  nor2   g088(.a(x28), .b(x27), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n115_), .c(x29), .O(new_n135_));
  nor2   g091(.a(new_n133_), .b(new_n103_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n115_), .c(new_n135_), .O(new_n137_));
  ...
  nand2  g111(.a(new_n121_), .b(x27), .O(new_n156_));
  ...
  aoi21  g126(.a(new_n121_), .b(x28), .c(new_n170_), .O(new_n171_));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n120_), .d(new_n115_), .O(new_n185_));
  ...
  oai21  g152(.a(new_n87_), .b(new_n163_), .c(new_n84_), .O(new_n197_));
  nand2  g153(.a(new_n87_), .b(new_n165_), .O(new_n198_));
  ...
  nand3  g160(.a(new_n204_), .b(new_n46_), .c(x00), .O(new_n205_));
