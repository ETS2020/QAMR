...
module FAU ( 
  ...
  nand3  g054(.a(new_n81_), .b(x29), .c(new_n45_), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n45_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n90_), .c(new_n62_), .d(new_n82_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n97_), .c(new_n60_), .O(z5));
  nand2  g058(.a(x29), .b(x28), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n81_), .b(x29), .c(x28), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n81_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n90_), .c(new_n62_), .d(x27), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n82_), .c(x25), .d(x01), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(z6));
  nor4   g066(.a(new_n88_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n111_));
  nand4  g067(.a(new_n62_), .b(new_n82_), .c(x25), .d(x01), .O(new_n112_));
  ...
  oai21  g071(.a(new_n104_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  aoi22  g072(.a(new_n116_), .b(x27), .c(x31), .d(new_n81_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n113_), .O(z7));
  nand2  g074(.a(new_n82_), .b(x00), .O(new_n119_));
  inv1   g075(.a(x28), .O(new_n120_));
  nand3  g076(.a(x32), .b(new_n81_), .c(new_n120_), .O(new_n121_));
  ...
  nand2  g080(.a(new_n120_), .b(new_n45_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n81_), .c(x29), .O(new_n126_));
  inv1   g082(.a(x29), .O(new_n127_));
  nand2  g083(.a(x30), .b(new_n127_), .O(new_n128_));
  ...
  aoi21  g116(.a(new_n81_), .b(new_n127_), .c(new_n114_), .O(new_n161_));
  oai21  g117(.a(new_n81_), .b(new_n127_), .c(new_n161_), .O(new_n162_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n171_), .c(new_n46_), .O(new_n180_));
  oai21  g136(.a(x31), .b(new_n127_), .c(new_n128_), .O(new_n181_));
  aoi21  g137(.a(new_n103_), .b(new_n114_), .c(x30), .O(new_n182_));
  ...
  nand2  g143(.a(new_n125_), .b(x29), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n114_), .c(new_n81_), .O(new_n189_));
