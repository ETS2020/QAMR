...
module FAU ( 
  ...
  nor3   g049(.a(new_n93_), .b(new_n79_), .c(new_n59_), .O(z3));
  inv1   g050(.a(x28), .O(new_n95_));
  nand3  g051(.a(x30), .b(new_n95_), .c(x27), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n60_), .d(new_n80_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n79_), .c(new_n59_), .O(z4));
  inv1   g055(.a(x29), .O(new_n100_));
  aoi21  g056(.a(x30), .b(new_n95_), .c(new_n45_), .O(new_n101_));
  nand2  g057(.a(x28), .b(x27), .O(new_n102_));
  nand2  g058(.a(x30), .b(new_n100_), .O(new_n103_));
  oai22  g059(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n100_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n92_), .c(new_n60_), .d(new_n80_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n79_), .c(new_n59_), .O(z5));
  nand3  g062(.a(x29), .b(x28), .c(x27), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n60_), .d(x30), .O(new_n108_));
  ...
  nand3  g067(.a(new_n89_), .b(new_n86_), .c(new_n83_), .O(new_n112_));
  ...
  nor2   g072(.a(new_n100_), .b(new_n95_), .O(new_n117_));
  nand2  g073(.a(new_n116_), .b(x29), .O(new_n118_));
  oai22  g074(.a(new_n118_), .b(new_n102_), .c(new_n117_), .d(new_n116_), .O(new_n119_));
  ...
  nand3  g085(.a(new_n129_), .b(x29), .c(x28), .O(new_n130_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n131_), .c(new_n126_), .d(x31), .O(new_n148_));
  inv1   g104(.a(new_n117_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n129_), .c(new_n45_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n140_), .c(new_n145_), .O(new_n152_));
  nor2   g108(.a(new_n133_), .b(new_n87_), .O(new_n153_));
  ...
  nor2   g117(.a(new_n129_), .b(new_n100_), .O(new_n162_));
  ...
  nand3  g129(.a(new_n149_), .b(new_n116_), .c(new_n129_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n147_), .c(new_n171_), .O(new_n176_));
  aoi21  g132(.a(x31), .b(x29), .c(new_n129_), .O(new_n177_));
  oai21  g133(.a(new_n127_), .b(new_n129_), .c(x31), .O(new_n178_));
