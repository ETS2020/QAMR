...
module FAU ( 
  ...
  nand4  g033(.a(new_n77_), .b(x30), .c(new_n57_), .d(x08), .O(new_n78_));
  ...
  oai21  g044(.a(new_n88_), .b(new_n59_), .c(new_n46_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n87_), .c(new_n46_), .O(new_n91_));
  ...
  oai21  g051(.a(new_n95_), .b(new_n81_), .c(x29), .O(new_n96_));
  inv1   g052(.a(x29), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(x28), .c(x27), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n96_), .c(new_n86_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n61_), .c(new_n46_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n80_), .c(x25), .d(x01), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(z5));
  nand2  g059(.a(x30), .b(new_n97_), .O(new_n104_));
  inv1   g060(.a(x30), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x29), .c(x09), .O(new_n106_));
  aoi21  g062(.a(new_n106_), .b(new_n104_), .c(new_n95_), .O(new_n107_));
  nor2   g063(.a(new_n105_), .b(x28), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n107_), .c(x27), .O(new_n109_));
  nand2  g065(.a(x30), .b(new_n81_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n109_), .c(new_n86_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n59_), .O(z6));
  nor4   g069(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n114_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(x31), .d(x30), .O(new_n146_));
  nand3  g102(.a(x32), .b(new_n105_), .c(x09), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n126_), .O(new_n149_));
  nand4  g105(.a(new_n145_), .b(new_n125_), .c(new_n127_), .d(x31), .O(new_n150_));
  nand2  g106(.a(new_n95_), .b(new_n81_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(x32), .c(x30), .O(new_n152_));
  oai21  g108(.a(new_n150_), .b(x30), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x29), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n139_), .c(x15), .O(new_n157_));
  ...
  oai21  g119(.a(new_n131_), .b(new_n163_), .c(new_n129_), .O(new_n164_));
  nor2   g120(.a(x19), .b(x14), .O(new_n165_));
  nand2  g121(.a(x16), .b(x15), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n138_), .c(x31), .O(new_n167_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n154_), .c(new_n149_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n80_), .c(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n46_), .O(z8));
  nand2  g129(.a(new_n131_), .b(x14), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x18), .c(x17), .d(x16), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n143_), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n166_), .c(new_n131_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n155_), .c(new_n143_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n137_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n128_), .c(new_n129_), .d(new_n163_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n181_), .c(new_n179_), .d(new_n178_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n176_), .c(new_n46_), .O(new_n185_));
  inv1   g141(.a(new_n122_), .O(new_n186_));
  nand3  g142(.a(new_n125_), .b(new_n119_), .c(x29), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nor2   g144(.a(new_n119_), .b(new_n97_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n125_), .c(new_n105_), .O(new_n190_));
  aoi21  g146(.a(new_n188_), .b(x09), .c(new_n190_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n185_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  nand4  g149(.a(new_n126_), .b(new_n119_), .c(new_n105_), .d(x09), .O(new_n194_));
  nand4  g150(.a(new_n125_), .b(x31), .c(x30), .d(x29), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n145_), .O(new_n197_));
