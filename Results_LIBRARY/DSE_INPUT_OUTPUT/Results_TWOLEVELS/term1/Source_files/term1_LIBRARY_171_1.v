...
module FAU ( 
  ...
  nand4  g033(.a(x06), .b(x05), .c(new_n49_), .d(new_n52_), .O(new_n78_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n45_), .c(new_n85_), .O(new_n92_));
  nor3   g048(.a(new_n92_), .b(new_n84_), .c(new_n61_), .O(z3));
  inv1   g049(.a(x28), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(x27), .c(x07), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(x27), .c(new_n95_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n91_), .c(new_n85_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n84_), .c(new_n61_), .O(z4));
  ...
  aoi22  g057(.a(new_n101_), .b(x07), .c(x29), .d(new_n45_), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n90_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n63_), .c(new_n85_), .d(x25), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n61_), .O(z5));
  ...
  nor2   g137(.a(new_n45_), .b(new_n58_), .O(new_n182_));
