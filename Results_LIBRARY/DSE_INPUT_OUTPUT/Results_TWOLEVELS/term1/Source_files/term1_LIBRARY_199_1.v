...
module FAU ( 
  ...
  nor3   g071(.a(new_n115_), .b(new_n81_), .c(new_n62_), .O(z6));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n105_), .c(new_n81_), .O(new_n125_));
  ...
  oai21  g146(.a(new_n190_), .b(new_n189_), .c(new_n90_), .O(new_n191_));
  ...
  oai21  g150(.a(new_n87_), .b(new_n161_), .c(new_n84_), .O(new_n195_));
  nand2  g151(.a(new_n87_), .b(new_n163_), .O(new_n196_));
