...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n99_), .c(new_n59_), .d(new_n79_), .O(new_n104_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n99_), .c(new_n59_), .d(new_n79_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n78_), .c(new_n57_), .O(z6));
  nand3  g068(.a(new_n101_), .b(x30), .c(x29), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x31), .O(new_n114_));
  inv1   g070(.a(new_n81_), .O(new_n115_));
  nand4  g071(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n115_), .O(new_n116_));
  nor2   g072(.a(new_n58_), .b(new_n57_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(x30), .c(x29), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n101_), .c(new_n78_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n117_), .c(new_n116_), .d(new_n114_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n79_), .O(new_n123_));
  oai21  g079(.a(new_n79_), .b(x00), .c(new_n123_), .O(z7));
  ...
  nand3  g101(.a(x32), .b(new_n108_), .c(new_n79_), .O(new_n146_));
  oai21  g102(.a(new_n145_), .b(new_n108_), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n128_), .O(new_n148_));
  nand4  g104(.a(new_n144_), .b(new_n129_), .c(x31), .d(new_n108_), .O(new_n149_));
  ...
  nand2  g119(.a(new_n85_), .b(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x31), .O(new_n165_));
  aoi21  g121(.a(new_n162_), .b(new_n82_), .c(new_n165_), .O(new_n166_));
  ...
  nand2  g124(.a(new_n168_), .b(new_n79_), .O(new_n169_));
  aoi21  g125(.a(new_n151_), .b(x29), .c(new_n169_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n148_), .c(new_n125_), .O(z8));
  ...
  nand4  g131(.a(new_n144_), .b(new_n172_), .c(new_n118_), .d(new_n108_), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n118_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n162_), .b(new_n82_), .O(new_n178_));
  xnor2a g134(.a(x31), .b(x30), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n164_), .c(new_n178_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n154_), .c(x33), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n79_), .O(new_n184_));
  aoi21  g140(.a(new_n177_), .b(new_n128_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n175_), .c(new_n125_), .O(z9));
endmodule
