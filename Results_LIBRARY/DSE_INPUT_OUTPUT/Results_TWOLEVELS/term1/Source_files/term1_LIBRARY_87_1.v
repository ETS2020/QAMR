...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n59_), .c(new_n57_), .O(z4));
  ...
  nand3  g062(.a(new_n106_), .b(x30), .c(x04), .O(new_n107_));
  nand3  g063(.a(new_n98_), .b(new_n45_), .c(x29), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n105_), .c(new_n59_), .O(z6));
  ...
  inv1   g070(.a(new_n98_), .O(new_n115_));
  nand2  g071(.a(new_n106_), .b(x31), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x30), .c(x29), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n115_), .c(new_n116_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x04), .c(x31), .d(new_n45_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n114_), .O(z7));
  inv1   g077(.a(x32), .O(new_n122_));
  nand2  g078(.a(new_n97_), .b(new_n81_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n45_), .c(x29), .O(new_n124_));
  ...
  aoi21  g128(.a(new_n140_), .b(new_n136_), .c(new_n143_), .O(new_n173_));
  nand4  g129(.a(new_n152_), .b(x31), .c(x30), .d(x29), .O(new_n174_));
  nand3  g130(.a(new_n125_), .b(new_n117_), .c(new_n45_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n145_), .b(new_n173_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n154_), .b(new_n117_), .O(new_n178_));
  nand3  g134(.a(new_n123_), .b(x30), .c(x29), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x31), .O(new_n180_));
  nand2  g136(.a(new_n129_), .b(new_n164_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n156_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n180_), .c(new_n178_), .d(new_n150_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  oai21  g141(.a(new_n177_), .b(x33), .c(new_n185_), .O(new_n186_));
