...
module FAU ( 
  ...
  inv1   g009(.a(x30), .O(new_n54_));
  nand2  g010(.a(z0), .b(new_n54_), .O(new_n55_));
  nand3  g011(.a(new_n55_), .b(new_n53_), .c(new_n49_), .O(z1));
  ...
  nand2  g033(.a(new_n77_), .b(new_n55_), .O(z2));
  ...
  nand4  g043(.a(new_n87_), .b(new_n80_), .c(new_n79_), .d(x25), .O(new_n88_));
  oai21  g044(.a(new_n88_), .b(new_n58_), .c(new_n55_), .O(z3));
  xor2a  g045(.a(x28), .b(x27), .O(new_n90_));
  nand3  g046(.a(new_n90_), .b(new_n87_), .c(new_n55_), .O(new_n91_));
  inv1   g047(.a(new_n91_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n79_), .c(x25), .d(x01), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(z4));
  nand2  g050(.a(new_n86_), .b(new_n82_), .O(new_n95_));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n60_), .d(new_n79_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x25), .c(x01), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n55_), .O(z5));
  inv1   g060(.a(new_n98_), .O(new_n105_));
  nand3  g061(.a(x32), .b(new_n54_), .c(x29), .O(new_n106_));
  oai22  g062(.a(new_n106_), .b(new_n105_), .c(new_n54_), .d(x29), .O(new_n107_));
  nand2  g063(.a(x28), .b(x27), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n81_), .c(x30), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  aoi21  g066(.a(new_n107_), .b(new_n95_), .c(new_n110_), .O(new_n111_));
  inv1   g067(.a(new_n86_), .O(new_n112_));
  aoi22  g068(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n112_), .c(x30), .O(new_n114_));
  oai21  g070(.a(new_n111_), .b(new_n59_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n79_), .c(x25), .d(x01), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(z6));
  oai21  g073(.a(z0), .b(x31), .c(new_n54_), .O(new_n118_));
  ...
  nand4  g079(.a(new_n123_), .b(new_n122_), .c(new_n121_), .d(new_n82_), .O(new_n124_));
  ...
  nand2  g087(.a(x32), .b(new_n54_), .O(new_n132_));
  nand2  g088(.a(new_n97_), .b(new_n80_), .O(new_n133_));
  ...
  nand4  g111(.a(new_n155_), .b(z0), .c(x31), .d(x30), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n132_), .c(new_n135_), .O(new_n157_));
  nand2  g113(.a(new_n97_), .b(new_n80_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(x30), .c(x29), .O(new_n159_));
  nand2  g115(.a(x16), .b(x10), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n149_), .c(x15), .O(new_n162_));
  nand2  g118(.a(x17), .b(x11), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n146_), .c(new_n145_), .O(new_n164_));
  inv1   g120(.a(x12), .O(new_n165_));
  oai21  g121(.a(new_n146_), .b(new_n165_), .c(new_n136_), .O(new_n166_));
  inv1   g122(.a(x13), .O(new_n167_));
  oai21  g123(.a(new_n139_), .b(new_n167_), .c(new_n137_), .O(new_n168_));
  nor2   g124(.a(x19), .b(x14), .O(new_n169_));
  nand2  g125(.a(x16), .b(x15), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n148_), .c(x31), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n162_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n159_), .c(z0), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n157_), .c(new_n79_), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n131_), .O(z8));
  inv1   g133(.a(x33), .O(new_n178_));
  nand4  g134(.a(new_n155_), .b(new_n178_), .c(x31), .d(x30), .O(new_n179_));
  ...
  nand4  g138(.a(new_n155_), .b(new_n178_), .c(new_n126_), .d(new_n54_), .O(new_n183_));
  nand2  g139(.a(x33), .b(x31), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n134_), .O(new_n186_));
  aoi21  g142(.a(new_n139_), .b(x14), .c(new_n137_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(x17), .c(x16), .d(x15), .O(new_n188_));
  nand2  g144(.a(x18), .b(x17), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n170_), .c(new_n139_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n160_), .c(new_n153_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n145_), .O(new_n193_));
  oai21  g149(.a(new_n137_), .b(new_n165_), .c(new_n136_), .O(new_n194_));
  nand2  g150(.a(new_n137_), .b(new_n167_), .O(new_n195_));
  ...
  nand3  g156(.a(new_n200_), .b(new_n186_), .c(new_n182_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n79_), .c(x00), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n55_), .O(z9));
endmodule
