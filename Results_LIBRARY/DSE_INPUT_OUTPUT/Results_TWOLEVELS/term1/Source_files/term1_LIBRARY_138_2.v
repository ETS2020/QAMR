...
module FAU ( 
  ...
  oai21  g057(.a(new_n101_), .b(new_n100_), .c(x29), .O(new_n102_));
  inv1   g058(.a(x29), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x28), .c(x27), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n102_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n99_), .c(new_n60_), .d(new_n79_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n46_), .O(z5));
  oai21  g065(.a(new_n103_), .b(new_n101_), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n45_), .b(x27), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n99_), .c(new_n60_), .d(new_n79_), .O(new_n112_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n100_), .c(x31), .O(new_n121_));
  ...
  oai21  g091(.a(new_n132_), .b(new_n135_), .c(new_n82_), .O(new_n136_));
  inv1   g092(.a(x13), .O(new_n137_));
  oai21  g093(.a(new_n88_), .b(new_n137_), .c(new_n85_), .O(new_n138_));
  nor2   g094(.a(x19), .b(x14), .O(new_n139_));
  nand2  g095(.a(x16), .b(x15), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n128_), .c(x31), .O(new_n141_));
  nor2   g097(.a(new_n141_), .b(new_n139_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n138_), .c(new_n136_), .d(new_n134_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n130_), .c(new_n46_), .O(new_n144_));
  aoi21  g100(.a(x29), .b(x28), .c(x30), .O(new_n145_));
  aoi21  g101(.a(new_n101_), .b(new_n100_), .c(new_n45_), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(x29), .c(new_n145_), .d(new_n100_), .O(new_n147_));
  ...
  oai21  g107(.a(new_n45_), .b(x28), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n100_), .O(new_n153_));
  oai21  g109(.a(new_n45_), .b(x29), .c(new_n153_), .O(new_n154_));
  ...
  inv1   g116(.a(new_n128_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n131_), .c(x11), .O(new_n162_));
  ...
  aoi21  g127(.a(new_n162_), .b(new_n160_), .c(new_n165_), .O(new_n172_));
  inv1   g128(.a(new_n166_), .O(new_n173_));
  oai21  g129(.a(new_n45_), .b(new_n101_), .c(new_n100_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(x31), .c(x29), .O(new_n175_));
  nand3  g131(.a(new_n120_), .b(new_n116_), .c(new_n45_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n172_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n88_), .b(x14), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x18), .c(x17), .d(x16), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n165_), .O(new_n181_));
  oai21  g137(.a(x28), .b(x27), .c(x29), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x31), .O(new_n183_));
  nor2   g139(.a(new_n85_), .b(new_n82_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n140_), .c(new_n88_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n127_), .c(new_n165_), .O(new_n187_));
  aoi21  g143(.a(new_n184_), .b(x11), .c(x16), .O(new_n188_));
  oai21  g144(.a(new_n85_), .b(new_n135_), .c(new_n82_), .O(new_n189_));
  nand2  g145(.a(new_n85_), .b(new_n137_), .O(new_n190_));
  nand2  g146(.a(new_n116_), .b(x30), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n151_), .O(new_n192_));
