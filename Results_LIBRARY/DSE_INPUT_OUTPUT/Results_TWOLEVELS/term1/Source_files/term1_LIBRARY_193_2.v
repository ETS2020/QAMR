...
module FAU ( 
  ...
  nand3  g047(.a(x29), .b(new_n91_), .c(x27), .O(new_n92_));
  oai21  g048(.a(new_n91_), .b(x27), .c(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n88_), .c(new_n82_), .d(x25), .O(new_n94_));
  ...
  nand4  g054(.a(new_n98_), .b(new_n82_), .c(x25), .d(x01), .O(new_n99_));
  ...
  aoi22  g059(.a(new_n103_), .b(x29), .c(x30), .d(new_n45_), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n87_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n62_), .c(new_n82_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n60_), .O(z6));
  inv1   g063(.a(x31), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x30), .c(x28), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g067(.a(x30), .b(x28), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n45_), .c(x31), .O(new_n113_));
  ...
  nand4  g073(.a(new_n62_), .b(new_n82_), .c(x25), .d(x01), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n117_), .c(new_n113_), .d(new_n111_), .O(z7));
  inv1   g076(.a(x00), .O(new_n121_));
  inv1   g077(.a(x29), .O(new_n122_));
  aoi21  g078(.a(new_n91_), .b(new_n45_), .c(new_n122_), .O(new_n123_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n124_), .c(x31), .d(x30), .O(new_n143_));
  nand2  g099(.a(x32), .b(new_n101_), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(new_n123_), .O(new_n145_));
  nand2  g101(.a(x29), .b(x28), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n45_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n142_), .c(new_n124_), .d(x31), .O(new_n148_));
  nand2  g104(.a(new_n91_), .b(x27), .O(new_n149_));
  aoi21  g105(.a(new_n146_), .b(new_n149_), .c(new_n101_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n135_), .c(new_n140_), .O(new_n152_));
  ...
  oai21  g112(.a(new_n153_), .b(new_n156_), .c(new_n125_), .O(new_n157_));
  aoi21  g113(.a(x19), .b(x13), .c(x18), .O(new_n158_));
  nor2   g114(.a(x19), .b(x14), .O(new_n159_));
  nand2  g115(.a(x16), .b(x15), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n135_), .c(x31), .O(new_n161_));
  nor3   g117(.a(new_n161_), .b(new_n159_), .c(new_n158_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n157_), .c(new_n155_), .d(new_n152_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n150_), .c(x32), .O(new_n164_));
  oai21  g120(.a(new_n148_), .b(x30), .c(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n145_), .c(new_n82_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n121_), .c(new_n47_), .O(z8));
  nand2  g123(.a(new_n128_), .b(x14), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(x18), .c(x17), .d(x16), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n140_), .O(new_n170_));
  nand2  g126(.a(x18), .b(x17), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n160_), .c(new_n128_), .O(new_n172_));
  oai21  g128(.a(new_n171_), .b(new_n151_), .c(new_n140_), .O(new_n173_));
  inv1   g129(.a(x11), .O(new_n174_));
  oai21  g130(.a(new_n171_), .b(new_n174_), .c(new_n134_), .O(new_n175_));
  aoi21  g131(.a(x18), .b(x12), .c(x17), .O(new_n176_));
  nor2   g132(.a(x18), .b(x13), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n175_), .c(new_n173_), .d(new_n172_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n170_), .c(new_n47_), .O(new_n180_));
  nand2  g136(.a(new_n122_), .b(new_n45_), .O(new_n181_));
  nand2  g137(.a(new_n108_), .b(x29), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n181_), .c(new_n101_), .O(new_n183_));
  nand3  g139(.a(new_n112_), .b(x31), .c(new_n45_), .O(new_n184_));
  aoi22  g140(.a(new_n108_), .b(x28), .c(new_n101_), .d(x27), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n122_), .c(new_n184_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n180_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  nand4  g145(.a(new_n146_), .b(new_n108_), .c(new_n101_), .d(new_n45_), .O(new_n190_));
  nand2  g146(.a(new_n91_), .b(new_n45_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
