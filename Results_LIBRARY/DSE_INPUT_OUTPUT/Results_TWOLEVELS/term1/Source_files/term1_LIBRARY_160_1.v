...
module FAU ( 
  ...
  oai21  g049(.a(new_n93_), .b(new_n59_), .c(new_n81_), .O(z4));
  ...
  nand4  g056(.a(new_n100_), .b(new_n95_), .c(new_n61_), .d(new_n79_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x25), .c(x01), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n81_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n95_), .c(new_n61_), .d(new_n81_), .O(new_n110_));
  ...
  nand4  g073(.a(new_n98_), .b(new_n117_), .c(x30), .d(x29), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n79_), .c(x25), .O(new_n119_));
  nor4   g075(.a(new_n119_), .b(new_n116_), .c(new_n60_), .d(new_n59_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n115_), .c(new_n46_), .O(z7));
  ...
  nand4  g097(.a(new_n141_), .b(new_n123_), .c(x31), .d(new_n107_), .O(new_n142_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n81_), .O(z8));
  ...
  nand4  g128(.a(new_n141_), .b(new_n168_), .c(new_n117_), .d(new_n107_), .O(new_n173_));
  ...
  nor3   g133(.a(new_n177_), .b(new_n161_), .c(new_n160_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n179_));
  ...
  nand2  g138(.a(new_n182_), .b(new_n81_), .O(z9));
endmodule
