...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n61_), .c(new_n49_), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n82_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n61_), .c(new_n49_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n102_), .c(new_n63_), .d(new_n82_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n101_), .c(new_n61_), .O(z5));
  ...
  oai21  g088(.a(new_n128_), .b(new_n132_), .c(new_n84_), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand2  g090(.a(x19), .b(x13), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n87_), .O(new_n136_));
  inv1   g092(.a(x14), .O(new_n137_));
  nand2  g093(.a(new_n90_), .b(new_n137_), .O(new_n138_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n49_), .O(z8));
  nand4  g123(.a(x33), .b(x29), .c(new_n82_), .d(x00), .O(new_n168_));
