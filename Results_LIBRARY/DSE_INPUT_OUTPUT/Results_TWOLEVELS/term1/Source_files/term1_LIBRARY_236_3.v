...
module FAU ( 
  ...
  nand2  g036(.a(x30), .b(x04), .O(new_n81_));
  ...
  nand4  g048(.a(new_n92_), .b(new_n87_), .c(new_n79_), .d(x25), .O(new_n93_));
  ...
  nor2   g104(.a(new_n148_), .b(new_n95_), .O(new_n149_));
  nand2  g105(.a(new_n99_), .b(new_n80_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x29), .O(new_n151_));
  aoi22  g107(.a(new_n151_), .b(new_n107_), .c(new_n149_), .d(new_n113_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n147_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x32), .O(new_n154_));
  inv1   g110(.a(x32), .O(new_n155_));
  nand3  g111(.a(new_n151_), .b(x30), .c(new_n113_), .O(new_n156_));
  nand3  g112(.a(new_n150_), .b(new_n107_), .c(x29), .O(new_n157_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n178_), .c(new_n45_), .O(new_n187_));
  ...
  aoi22  g147(.a(new_n191_), .b(new_n113_), .c(new_n188_), .d(new_n107_), .O(new_n192_));
  ...
  oai22  g153(.a(new_n197_), .b(x04), .c(new_n188_), .d(x30), .O(new_n198_));
