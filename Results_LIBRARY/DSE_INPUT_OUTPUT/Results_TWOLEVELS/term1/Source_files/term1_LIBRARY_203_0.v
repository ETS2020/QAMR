...
module FAU ( 
  ...
  nand4  g030(.a(x06), .b(x05), .c(new_n53_), .d(new_n52_), .O(new_n75_));
  ...
  aoi21  g051(.a(new_n95_), .b(new_n86_), .c(new_n61_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n82_), .c(new_n81_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n60_), .c(new_n47_), .O(z3));
  ...
  inv1   g064(.a(new_n87_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n94_), .c(new_n47_), .O(new_n111_));
  nand3  g067(.a(x33), .b(new_n84_), .c(new_n83_), .O(new_n112_));
  aoi22  g068(.a(new_n112_), .b(new_n111_), .c(new_n107_), .d(new_n105_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n60_), .O(z5));
  inv1   g071(.a(x25), .O(new_n116_));
  nand2  g072(.a(new_n112_), .b(new_n111_), .O(new_n117_));
  nand3  g073(.a(x29), .b(x28), .c(x27), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  inv1   g075(.a(x30), .O(new_n120_));
  nand3  g076(.a(new_n103_), .b(new_n120_), .c(x29), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(new_n62_), .d(new_n81_), .O(new_n123_));
  nor3   g079(.a(new_n123_), .b(new_n116_), .c(new_n60_), .O(z6));
  nand2  g080(.a(x30), .b(x29), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n104_), .c(x31), .O(new_n126_));
  nor2   g082(.a(new_n116_), .b(new_n60_), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  nand4  g084(.a(new_n103_), .b(new_n128_), .c(x30), .d(x29), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n127_), .c(new_n126_), .d(new_n81_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n47_), .O(new_n131_));
  nand2  g087(.a(new_n48_), .b(new_n83_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(x03), .c(x02), .O(new_n133_));
  aoi21  g089(.a(x33), .b(x20), .c(x15), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n85_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n93_), .c(new_n90_), .d(new_n109_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n133_), .c(new_n131_), .O(z7));
  nor2   g093(.a(x28), .b(x27), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  inv1   g095(.a(x32), .O(new_n140_));
  inv1   g096(.a(x17), .O(new_n141_));
  nand3  g097(.a(x19), .b(new_n88_), .c(x13), .O(new_n142_));
  nand3  g098(.a(new_n91_), .b(x18), .c(x14), .O(new_n143_));
  ...
  nand4  g109(.a(new_n150_), .b(x16), .c(new_n83_), .d(x10), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n140_), .c(x31), .d(new_n120_), .O(new_n156_));
  nand2  g112(.a(x32), .b(x30), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n139_), .c(x29), .O(new_n159_));
  nor2   g115(.a(new_n138_), .b(new_n106_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n155_), .b(new_n140_), .c(x31), .d(x30), .O(new_n162_));
  nand2  g118(.a(x32), .b(new_n120_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n161_), .O(new_n165_));
  nand2  g121(.a(new_n91_), .b(x14), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(x18), .c(x17), .d(x16), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n83_), .O(new_n168_));
  nand2  g124(.a(x16), .b(x15), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n169_), .c(new_n91_), .O(new_n171_));
  ...
  nor3   g133(.a(new_n177_), .b(new_n176_), .c(new_n128_), .O(new_n178_));
  ...
  nand3  g136(.a(new_n180_), .b(new_n165_), .c(new_n159_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n81_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n47_), .O(z8));
  oai21  g139(.a(new_n160_), .b(x30), .c(new_n128_), .O(new_n184_));
  oai21  g140(.a(new_n170_), .b(new_n148_), .c(new_n91_), .O(new_n185_));
  inv1   g141(.a(new_n176_), .O(new_n186_));
  inv1   g142(.a(new_n177_), .O(new_n187_));
  oai21  g143(.a(new_n138_), .b(new_n125_), .c(x31), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n175_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n185_), .c(new_n184_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n168_), .c(x33), .O(new_n192_));
  nand4  g148(.a(new_n139_), .b(x31), .c(x30), .d(x29), .O(new_n193_));
  nand3  g149(.a(new_n161_), .b(new_n128_), .c(new_n120_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n152_), .c(new_n48_), .O(new_n196_));
  oai21  g152(.a(new_n172_), .b(new_n149_), .c(new_n83_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n196_), .c(new_n192_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n81_), .c(x00), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n47_), .O(z9));
endmodule
