// Benchmark "FAU" written by ABC on Thu Aug 20 01:03:18 2020
...
module FAU ( 
  ...
  nand3  g054(.a(new_n98_), .b(new_n90_), .c(new_n80_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n93_), .c(new_n59_), .O(z4));
  oai21  g056(.a(new_n96_), .b(new_n45_), .c(x29), .O(new_n101_));
  nand2  g057(.a(x28), .b(x27), .O(new_n102_));
  nor2   g058(.a(new_n95_), .b(x29), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n102_), .c(new_n101_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n93_), .c(new_n59_), .O(z5));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n89_), .c(new_n61_), .d(x30), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n80_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z6));
  nor4   g068(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n113_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n102_), .c(new_n117_), .O(new_n120_));
  ...
  oai21  g088(.a(new_n128_), .b(new_n131_), .c(new_n132_), .O(new_n133_));
  aoi21  g089(.a(x19), .b(x13), .c(x18), .O(new_n134_));
  nor2   g090(.a(x19), .b(x14), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n133_), .c(new_n130_), .d(new_n126_), .O(new_n137_));
  oai21  g093(.a(new_n103_), .b(new_n45_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n125_), .c(x31), .O(new_n140_));
  inv1   g096(.a(x29), .O(new_n141_));
  oai21  g097(.a(x28), .b(x27), .c(x30), .O(new_n142_));
  nand3  g098(.a(new_n116_), .b(new_n95_), .c(new_n45_), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(new_n141_), .c(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n140_), .b(new_n47_), .c(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n138_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nand3  g104(.a(new_n95_), .b(x29), .c(x28), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n96_), .c(new_n45_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n104_), .O(new_n152_));
  ...
  aoi21  g112(.a(new_n156_), .b(new_n154_), .c(new_n132_), .O(new_n157_));
  nand4  g113(.a(x19), .b(x18), .c(new_n132_), .d(x12), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n157_), .c(x16), .O(new_n160_));
  inv1   g116(.a(new_n125_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n127_), .c(x11), .O(new_n162_));
  ...
  aoi21  g126(.a(new_n162_), .b(new_n160_), .c(new_n123_), .O(new_n171_));
  ...
  nand3  g130(.a(new_n116_), .b(new_n118_), .c(new_n95_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n171_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n155_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n123_), .O(new_n180_));
  oai21  g136(.a(new_n118_), .b(new_n141_), .c(x30), .O(new_n181_));
  oai21  g137(.a(x28), .b(x27), .c(x30), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x31), .O(new_n183_));
  nand2  g139(.a(x18), .b(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n139_), .c(new_n155_), .O(new_n185_));
  or2    g141(.a(new_n184_), .b(new_n124_), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n187_), .c(new_n127_), .O(new_n188_));
  oai21  g144(.a(new_n153_), .b(new_n131_), .c(new_n132_), .O(new_n189_));
  inv1   g145(.a(x13), .O(new_n190_));
  nand2  g146(.a(new_n153_), .b(new_n190_), .O(new_n191_));
  nand3  g147(.a(new_n118_), .b(x29), .c(x28), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n191_), .c(new_n189_), .d(new_n188_), .O(new_n193_));
  aoi21  g149(.a(new_n186_), .b(new_n123_), .c(new_n193_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n185_), .c(new_n183_), .d(new_n181_), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n180_), .c(x33), .O(new_n196_));
  oai21  g152(.a(new_n177_), .b(x33), .c(new_n196_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n80_), .c(x00), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n47_), .O(z9));
endmodule
