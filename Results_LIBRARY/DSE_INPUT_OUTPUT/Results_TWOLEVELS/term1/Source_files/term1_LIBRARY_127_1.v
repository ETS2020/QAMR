...
module FAU ( 
  ...
  nand3  g075(.a(new_n98_), .b(new_n119_), .c(x30), .O(new_n120_));
  ...
  nor2   g084(.a(new_n107_), .b(new_n82_), .O(new_n129_));
  nor3   g085(.a(x30), .b(x28), .c(x27), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n129_), .c(x29), .O(new_n131_));
  nand2  g087(.a(x16), .b(x15), .O(new_n132_));
  nand2  g088(.a(x18), .b(x17), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n132_), .c(new_n125_), .O(new_n134_));
  nand4  g090(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n135_));
  ...
  aoi21  g100(.a(x30), .b(x28), .c(new_n119_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n141_), .d(new_n138_), .O(new_n146_));
  aoi21  g102(.a(new_n135_), .b(new_n124_), .c(new_n146_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n134_), .c(new_n131_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n128_), .c(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nor2   g106(.a(x28), .b(x27), .O(new_n151_));
  nand3  g107(.a(x30), .b(new_n97_), .c(new_n82_), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(x30), .c(new_n152_), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n143_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n125_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n139_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n139_), .d(x12), .O(new_n157_));
  ...
  nand2  g126(.a(new_n135_), .b(new_n124_), .O(new_n171_));
  and2   g127(.a(new_n144_), .b(new_n141_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n138_), .c(new_n171_), .d(new_n134_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n128_), .c(new_n46_), .O(new_n174_));
  oai21  g130(.a(new_n151_), .b(new_n107_), .c(x31), .O(new_n175_));
  oai21  g131(.a(new_n151_), .b(x31), .c(new_n175_), .O(new_n176_));
  aoi22  g132(.a(new_n176_), .b(x29), .c(new_n119_), .d(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n174_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x33), .O(new_n179_));
  aoi21  g135(.a(new_n162_), .b(new_n159_), .c(new_n124_), .O(new_n180_));
  inv1   g136(.a(new_n165_), .O(new_n181_));
  inv1   g137(.a(new_n151_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(x31), .c(x30), .d(x29), .O(new_n183_));
  nand2  g139(.a(new_n182_), .b(x29), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n119_), .c(new_n107_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n183_), .O(new_n186_));
  oai21  g142(.a(new_n181_), .b(new_n180_), .c(new_n186_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(x33), .c(new_n179_), .O(new_n188_));
