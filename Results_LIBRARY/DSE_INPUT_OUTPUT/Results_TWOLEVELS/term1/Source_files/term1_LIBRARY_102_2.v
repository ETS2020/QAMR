...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n60_), .c(new_n46_), .O(z3));
  inv1   g049(.a(x28), .O(new_n94_));
  nand3  g050(.a(x30), .b(new_n94_), .c(x27), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(x27), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n91_), .c(new_n81_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n60_), .c(new_n46_), .O(z4));
  inv1   g054(.a(x25), .O(new_n99_));
  inv1   g055(.a(x29), .O(new_n100_));
  inv1   g056(.a(x27), .O(new_n101_));
  aoi21  g057(.a(x30), .b(new_n94_), .c(new_n101_), .O(new_n102_));
  nand2  g058(.a(x28), .b(x27), .O(new_n103_));
  nand2  g059(.a(x30), .b(new_n100_), .O(new_n104_));
  oai22  g060(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n100_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n90_), .c(new_n62_), .d(new_n81_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n99_), .c(new_n60_), .O(z5));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n90_), .c(new_n62_), .d(x30), .O(new_n109_));
  ...
  nand4  g069(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n46_), .O(new_n115_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n103_), .c(new_n117_), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(x30), .c(x31), .d(new_n101_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n115_), .O(z7));
  nand4  g078(.a(x32), .b(x29), .c(new_n81_), .d(x00), .O(new_n123_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n100_), .c(x30), .O(new_n128_));
  ...
  nand2  g105(.a(new_n116_), .b(new_n45_), .O(new_n150_));
  nand3  g106(.a(x30), .b(x29), .c(x28), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n150_), .c(x27), .O(new_n152_));
  ...
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n140_), .O(new_n157_));
  inv1   g113(.a(x12), .O(new_n158_));
  oai21  g114(.a(new_n155_), .b(new_n158_), .c(new_n131_), .O(new_n159_));
  aoi21  g115(.a(x19), .b(x13), .c(x18), .O(new_n160_));
  nor2   g116(.a(x19), .b(x14), .O(new_n161_));
  nand2  g117(.a(x16), .b(x15), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n141_), .c(x31), .O(new_n163_));
  nor3   g119(.a(new_n163_), .b(new_n161_), .c(new_n160_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n152_), .c(x32), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n149_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n81_), .c(x00), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n125_), .O(z8));
  nand2  g125(.a(new_n134_), .b(x14), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x18), .c(x17), .d(x16), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n146_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n162_), .c(new_n134_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n153_), .c(new_n146_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n140_), .O(new_n177_));
  ...
  aoi21  g138(.a(x31), .b(x29), .c(new_n45_), .O(new_n183_));
  oai21  g139(.a(new_n45_), .b(new_n94_), .c(x31), .O(new_n184_));
  oai21  g140(.a(new_n119_), .b(new_n94_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n101_), .c(new_n183_), .O(new_n186_));
  ...
  nand4  g146(.a(new_n116_), .b(new_n118_), .c(new_n45_), .d(new_n101_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nor4   g148(.a(new_n127_), .b(new_n118_), .c(new_n45_), .d(new_n100_), .O(new_n193_));
  oai22  g149(.a(new_n193_), .b(new_n192_), .c(new_n190_), .d(new_n189_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(x33), .c(new_n188_), .O(new_n195_));
