...
module FAU ( 
  ...
  nand4  g057(.a(new_n101_), .b(new_n94_), .c(new_n80_), .d(x01), .O(new_n102_));
  aoi21  g058(.a(new_n102_), .b(x30), .c(new_n45_), .O(z4));
  inv1   g059(.a(new_n93_), .O(new_n104_));
  oai21  g060(.a(new_n99_), .b(new_n81_), .c(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x28), .c(x27), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n104_), .c(new_n61_), .d(x30), .O(new_n109_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n104_), .c(new_n61_), .d(x30), .O(new_n114_));
  ...
  nand3  g079(.a(new_n123_), .b(new_n47_), .c(new_n80_), .O(new_n124_));
  nor4   g080(.a(new_n124_), .b(new_n60_), .c(new_n45_), .d(new_n59_), .O(new_n125_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(x29), .O(new_n131_));
  nor2   g087(.a(new_n129_), .b(new_n106_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n128_), .c(new_n131_), .O(new_n133_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(new_n127_), .d(x31), .O(new_n151_));
  nor2   g107(.a(new_n128_), .b(new_n106_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x27), .O(new_n153_));
  oai21  g109(.a(x30), .b(x27), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n99_), .O(new_n155_));
  ...
  oai21  g116(.a(new_n141_), .b(new_n160_), .c(new_n83_), .O(new_n161_));
  ...
  nand2  g133(.a(x33), .b(new_n128_), .O(new_n178_));
  ...
  nand4  g137(.a(new_n150_), .b(new_n176_), .c(new_n122_), .d(new_n128_), .O(new_n182_));
  ...
  nand2  g151(.a(new_n122_), .b(x30), .O(new_n196_));
  ...
  nand2  g158(.a(new_n202_), .b(new_n47_), .O(z9));
endmodule
