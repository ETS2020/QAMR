...
module FAU ( 
  ...
  nand2  g064(.a(new_n108_), .b(new_n57_), .O(z5));
  nand3  g065(.a(new_n103_), .b(new_n45_), .c(x29), .O(new_n110_));
  oai21  g066(.a(new_n103_), .b(new_n45_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n100_), .c(new_n61_), .d(new_n80_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x25), .c(x01), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n57_), .O(z6));
  ...
  nand3  g075(.a(x30), .b(x28), .c(x27), .O(new_n120_));
  ...
  nand3  g085(.a(x30), .b(new_n102_), .c(new_n81_), .O(new_n130_));
  oai21  g086(.a(new_n129_), .b(x30), .c(new_n130_), .O(new_n131_));
  nand3  g087(.a(x19), .b(new_n86_), .c(x13), .O(new_n132_));
  nand3  g088(.a(new_n89_), .b(x18), .c(x14), .O(new_n133_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n131_), .c(new_n128_), .d(x31), .O(new_n147_));
  aoi21  g103(.a(new_n102_), .b(new_n81_), .c(new_n45_), .O(new_n148_));
  ...
  oai21  g110(.a(new_n151_), .b(new_n154_), .c(new_n83_), .O(new_n155_));
  aoi21  g111(.a(x19), .b(x13), .c(x18), .O(new_n156_));
  nor2   g112(.a(x19), .b(x14), .O(new_n157_));
  nand2  g113(.a(x16), .b(x15), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n139_), .c(x31), .O(new_n159_));
  nor3   g115(.a(new_n159_), .b(new_n157_), .c(new_n156_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n155_), .c(new_n153_), .d(new_n150_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n148_), .c(x32), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n147_), .c(new_n101_), .O(new_n163_));
  inv1   g119(.a(new_n129_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x29), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(x32), .c(new_n45_), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n163_), .c(new_n80_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n127_), .O(z8));
  nand2  g125(.a(new_n89_), .b(x14), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x18), .c(x17), .d(x16), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n144_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n158_), .c(new_n89_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n149_), .c(new_n144_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n138_), .O(new_n177_));
  ...
  oai21  g138(.a(new_n129_), .b(x31), .c(new_n130_), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(x29), .c(x31), .d(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n182_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  nand4  g142(.a(new_n164_), .b(x31), .c(x30), .d(x29), .O(new_n187_));
  nand3  g143(.a(new_n165_), .b(new_n116_), .c(new_n45_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n146_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(x33), .c(new_n186_), .O(new_n191_));
