...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n80_), .c(new_n46_), .O(new_n91_));
  ...
  nor2   g063(.a(new_n98_), .b(new_n80_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n88_), .c(new_n61_), .d(new_n46_), .O(new_n111_));
  ...
  nand2  g084(.a(new_n128_), .b(new_n46_), .O(z7));
  ...
  oai21  g111(.a(new_n150_), .b(new_n107_), .c(new_n155_), .O(new_n156_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n175_), .c(new_n123_), .d(new_n107_), .O(new_n180_));
  ...
  aoi21  g140(.a(new_n184_), .b(new_n143_), .c(x15), .O(new_n185_));
  nor2   g141(.a(new_n135_), .b(new_n133_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(x17), .c(x11), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n141_), .O(new_n188_));
  nand2  g144(.a(new_n186_), .b(x12), .O(new_n189_));
  ...
  oai22  g148(.a(new_n160_), .b(new_n142_), .c(x19), .d(x14), .O(new_n193_));
  xor2a  g149(.a(x31), .b(x30), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n192_), .c(new_n190_), .d(new_n188_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n185_), .c(x33), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n183_), .c(new_n179_), .O(new_n198_));
