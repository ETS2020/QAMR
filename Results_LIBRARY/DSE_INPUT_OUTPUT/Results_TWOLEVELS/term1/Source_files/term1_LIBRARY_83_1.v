...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n62_), .c(new_n82_), .d(new_n45_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n81_), .c(new_n60_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n62_), .d(new_n45_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n81_), .c(new_n60_), .O(z4));
  ...
  nand2  g060(.a(new_n90_), .b(new_n87_), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n83_), .c(new_n45_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n93_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n104_), .c(new_n62_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n60_), .c(new_n47_), .O(z5));
  ...
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n62_), .d(new_n45_), .O(new_n115_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n112_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n100_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n112_), .c(new_n130_), .O(new_n132_));
  nand3  g088(.a(new_n91_), .b(x18), .c(x14), .O(new_n133_));
  nand4  g089(.a(new_n45_), .b(x19), .c(new_n88_), .d(x13), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n85_), .O(new_n135_));
  nand2  g091(.a(new_n85_), .b(x12), .O(new_n136_));
  nand3  g092(.a(new_n45_), .b(x19), .c(x18), .O(new_n137_));
  ...
  nor2   g100(.a(x26), .b(new_n91_), .O(new_n145_));
  nor2   g101(.a(new_n140_), .b(x15), .O(new_n146_));
  nand2  g102(.a(x18), .b(x17), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n146_), .c(new_n145_), .d(x10), .O(new_n149_));
  ...
  nand3  g108(.a(x30), .b(x29), .c(x27), .O(new_n153_));
  nand2  g109(.a(new_n112_), .b(new_n82_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(x28), .O(new_n155_));
  inv1   g111(.a(x15), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n147_), .c(new_n156_), .O(new_n158_));
  inv1   g114(.a(x11), .O(new_n159_));
  oai21  g115(.a(new_n147_), .b(new_n159_), .c(new_n140_), .O(new_n160_));
  ...
  oai22  g120(.a(new_n164_), .b(new_n163_), .c(x18), .d(x13), .O(new_n165_));
  aoi21  g121(.a(new_n112_), .b(new_n100_), .c(new_n122_), .O(new_n166_));
  oai21  g122(.a(new_n118_), .b(new_n101_), .c(new_n166_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n155_), .c(new_n45_), .O(new_n170_));
  nand2  g126(.a(x15), .b(x14), .O(new_n171_));
  nand2  g127(.a(new_n148_), .b(x16), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n171_), .c(new_n91_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n170_), .c(new_n127_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n152_), .c(x00), .O(new_n175_));
  ...
  nand3  g134(.a(x33), .b(new_n122_), .c(new_n45_), .O(new_n179_));
  ...
  nand4  g138(.a(new_n150_), .b(new_n177_), .c(new_n122_), .d(new_n112_), .O(new_n183_));
  nand3  g139(.a(x33), .b(x31), .c(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n182_), .O(new_n186_));
  inv1   g142(.a(new_n173_), .O(new_n187_));
  aoi21  g143(.a(new_n88_), .b(x13), .c(new_n91_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  nand3  g145(.a(x17), .b(x16), .c(x15), .O(new_n190_));
  nand3  g146(.a(x17), .b(x16), .c(x10), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n156_), .O(new_n192_));
  oai21  g148(.a(new_n85_), .b(new_n159_), .c(new_n140_), .O(new_n193_));
  ...
  aoi21  g152(.a(new_n190_), .b(new_n88_), .c(new_n196_), .O(new_n197_));
  aoi21  g153(.a(new_n197_), .b(new_n189_), .c(x26), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n187_), .c(x33), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n186_), .c(new_n181_), .O(new_n200_));
