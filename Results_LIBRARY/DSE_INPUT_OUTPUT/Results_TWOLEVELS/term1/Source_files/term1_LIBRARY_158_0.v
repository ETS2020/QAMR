...
module FAU ( 
  ...
  nand3  g050(.a(x30), .b(x28), .c(new_n94_), .O(new_n95_));
  oai21  g051(.a(x28), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  ...
  nand2  g074(.a(x31), .b(new_n106_), .O(new_n119_));
  inv1   g075(.a(x31), .O(new_n120_));
  nor2   g076(.a(new_n111_), .b(new_n110_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n120_), .c(x30), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  aoi21  g079(.a(new_n121_), .b(x27), .c(new_n120_), .O(new_n124_));
  aoi22  g080(.a(new_n124_), .b(x30), .c(new_n123_), .d(x27), .O(new_n125_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n137_), .c(new_n134_), .d(new_n130_), .O(new_n142_));
  oai21  g098(.a(x30), .b(x27), .c(new_n142_), .O(new_n143_));
  inv1   g099(.a(new_n129_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x16), .c(x15), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x31), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n46_), .O(new_n147_));
  nand2  g103(.a(new_n106_), .b(new_n111_), .O(new_n148_));
  oai21  g104(.a(new_n100_), .b(x28), .c(new_n148_), .O(new_n149_));
  aoi22  g105(.a(new_n149_), .b(x27), .c(new_n101_), .d(x28), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n147_), .c(new_n143_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(x32), .O(new_n153_));
  aoi21  g109(.a(new_n110_), .b(new_n94_), .c(new_n111_), .O(new_n154_));
  nand3  g110(.a(new_n106_), .b(x29), .c(x27), .O(new_n155_));
  oai21  g111(.a(new_n154_), .b(new_n106_), .c(new_n155_), .O(new_n156_));
  inv1   g112(.a(x18), .O(new_n157_));
  nand3  g113(.a(x19), .b(new_n157_), .c(x13), .O(new_n158_));
  nand3  g114(.a(new_n139_), .b(x18), .c(x14), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n136_), .O(new_n160_));
  nand4  g116(.a(x19), .b(x18), .c(new_n136_), .d(x12), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n160_), .c(x16), .O(new_n163_));
  nand3  g119(.a(new_n144_), .b(new_n131_), .c(x11), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x15), .O(new_n166_));
  nand4  g122(.a(new_n144_), .b(x16), .c(new_n127_), .d(x10), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n156_), .c(new_n153_), .d(x31), .O(new_n169_));
  ...
  nand2  g128(.a(new_n80_), .b(x00), .O(new_n173_));
  nand3  g129(.a(x33), .b(x30), .c(new_n110_), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n173_), .c(x30), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n94_), .O(new_n176_));
  aoi21  g132(.a(new_n164_), .b(new_n163_), .c(new_n127_), .O(new_n177_));
  inv1   g133(.a(new_n167_), .O(new_n178_));
  nand2  g134(.a(new_n110_), .b(new_n94_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
  nand3  g136(.a(new_n120_), .b(new_n106_), .c(new_n111_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n177_), .c(new_n182_), .O(new_n183_));
  inv1   g139(.a(new_n130_), .O(new_n184_));
  inv1   g140(.a(new_n140_), .O(new_n185_));
  nand2  g141(.a(new_n139_), .b(new_n138_), .O(new_n186_));
  nand2  g142(.a(new_n145_), .b(new_n186_), .O(new_n187_));
  nand2  g143(.a(x30), .b(new_n111_), .O(new_n188_));
  nand2  g144(.a(new_n120_), .b(x29), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n188_), .c(new_n119_), .O(new_n190_));
  nor2   g146(.a(new_n190_), .b(new_n187_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n185_), .c(new_n137_), .d(new_n134_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n184_), .c(x33), .O(new_n193_));
  oai21  g149(.a(new_n183_), .b(x33), .c(new_n193_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n80_), .c(x00), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n176_), .O(z9));
endmodule
