...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(new_n45_), .c(x27), .O(z3));
  ...
  nor2   g055(.a(x30), .b(new_n99_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n97_), .O(new_n101_));
  oai21  g057(.a(new_n98_), .b(new_n97_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n89_), .c(new_n62_), .d(new_n81_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n96_), .c(new_n60_), .O(z5));
  inv1   g060(.a(x28), .O(new_n105_));
  nor2   g061(.a(new_n99_), .b(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n100_), .b(x28), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n45_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n89_), .c(new_n62_), .d(new_n81_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x25), .c(x01), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n47_), .O(z6));
  ...
  and2   g077(.a(x16), .b(x10), .O(new_n122_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n135_), .c(new_n132_), .d(new_n129_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n125_), .c(new_n47_), .O(new_n141_));
  nand2  g097(.a(new_n105_), .b(new_n97_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x29), .O(new_n143_));
  nor2   g099(.a(new_n45_), .b(new_n99_), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(x27), .c(new_n143_), .d(new_n45_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nor2   g104(.a(new_n45_), .b(x29), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n100_), .c(x27), .O(new_n150_));
  nand2  g106(.a(new_n100_), .b(x28), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n133_), .c(x13), .O(new_n153_));
  inv1   g109(.a(x19), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n153_), .c(new_n131_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n131_), .d(x12), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(x16), .O(new_n159_));
  nand3  g115(.a(new_n124_), .b(new_n126_), .c(x11), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x15), .O(new_n162_));
  inv1   g118(.a(x15), .O(new_n163_));
  nand4  g119(.a(new_n124_), .b(x16), .c(new_n163_), .d(x10), .O(new_n164_));
  ...
  aoi21  g125(.a(new_n160_), .b(new_n159_), .c(new_n163_), .O(new_n170_));
  inv1   g126(.a(new_n164_), .O(new_n171_));
  aoi22  g127(.a(new_n45_), .b(new_n99_), .c(new_n105_), .d(new_n97_), .O(new_n172_));
  nand3  g128(.a(x31), .b(x30), .c(x29), .O(new_n173_));
  oai21  g129(.a(new_n172_), .b(x31), .c(new_n173_), .O(new_n174_));
  oai21  g130(.a(new_n171_), .b(new_n170_), .c(new_n174_), .O(new_n175_));
  inv1   g131(.a(new_n125_), .O(new_n176_));
  nand3  g132(.a(new_n142_), .b(new_n116_), .c(x29), .O(new_n177_));
  nor2   g133(.a(new_n137_), .b(new_n123_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n136_), .O(new_n179_));
  nor2   g135(.a(new_n149_), .b(new_n119_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n135_), .d(new_n132_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n177_), .c(new_n129_), .d(new_n176_), .O(new_n183_));
