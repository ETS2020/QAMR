...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n89_), .c(new_n61_), .d(x30), .O(new_n104_));
  ...
  aoi21  g064(.a(new_n108_), .b(x30), .c(new_n81_), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n90_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n61_), .c(new_n80_), .d(x01), .O(new_n111_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n84_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x29), .c(x28), .d(x27), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n48_), .c(new_n80_), .O(new_n121_));
  nor4   g077(.a(new_n121_), .b(new_n60_), .c(new_n45_), .d(new_n59_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n118_), .c(new_n114_), .O(z7));
  inv1   g079(.a(x32), .O(new_n124_));
  inv1   g080(.a(x30), .O(new_n125_));
  nor2   g081(.a(x28), .b(x27), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n125_), .c(x29), .O(new_n128_));
  nor2   g084(.a(new_n126_), .b(new_n101_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n125_), .c(new_n128_), .O(new_n130_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n130_), .c(new_n124_), .d(x31), .O(new_n151_));
  nor2   g107(.a(new_n125_), .b(new_n101_), .O(new_n152_));
  ...
  oai21  g116(.a(new_n141_), .b(new_n160_), .c(new_n131_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n134_), .b(new_n162_), .c(new_n132_), .O(new_n163_));
  ...
  nand3  g135(.a(new_n179_), .b(new_n127_), .c(x29), .O(new_n180_));
  inv1   g136(.a(new_n129_), .O(new_n181_));
  nand4  g137(.a(new_n150_), .b(new_n176_), .c(new_n119_), .d(new_n125_), .O(new_n182_));
  ...
  oai21  g149(.a(new_n132_), .b(new_n160_), .c(new_n131_), .O(new_n194_));
  nand2  g150(.a(new_n132_), .b(new_n162_), .O(new_n195_));
  nand2  g151(.a(new_n119_), .b(x30), .O(new_n196_));
