...
module FAU ( 
  ...
  nor2   g053(.a(new_n97_), .b(new_n65_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(x32), .c(new_n85_), .O(new_n99_));
  ...
  aoi21  g060(.a(new_n104_), .b(x32), .c(x26), .O(z4));
  inv1   g061(.a(new_n97_), .O(new_n106_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n106_), .c(new_n66_), .d(x32), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n45_), .c(x25), .d(x01), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(z5));
  inv1   g071(.a(x30), .O(new_n116_));
  aoi21  g072(.a(x32), .b(new_n107_), .c(new_n85_), .O(new_n117_));
  nand3  g073(.a(new_n109_), .b(new_n116_), .c(x29), .O(new_n118_));
  oai21  g074(.a(new_n117_), .b(new_n116_), .c(new_n118_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n106_), .c(new_n66_), .O(new_n120_));
  oai21  g076(.a(new_n58_), .b(x03), .c(x02), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n106_), .c(x30), .d(new_n108_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x25), .c(x01), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(x32), .c(x26), .O(z6));
  nand3  g081(.a(new_n109_), .b(x30), .c(x29), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x31), .O(new_n127_));
  inv1   g083(.a(new_n86_), .O(new_n128_));
  nand4  g084(.a(new_n95_), .b(new_n92_), .c(new_n89_), .d(new_n128_), .O(new_n129_));
  nor2   g085(.a(new_n65_), .b(new_n64_), .O(new_n130_));
  ...
  aoi21  g090(.a(new_n134_), .b(new_n109_), .c(new_n131_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n130_), .c(new_n129_), .d(new_n127_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x32), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n45_), .O(z7));
  aoi21  g094(.a(x32), .b(x28), .c(x27), .O(new_n139_));
  nor3   g095(.a(new_n139_), .b(new_n116_), .c(new_n107_), .O(new_n140_));
  nand2  g096(.a(new_n108_), .b(new_n85_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x29), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(x32), .c(new_n116_), .O(new_n143_));
  ...
  nor2   g104(.a(new_n93_), .b(new_n90_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(x17), .c(x11), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  aoi21  g107(.a(new_n149_), .b(x12), .c(x17), .O(new_n152_));
  nand2  g108(.a(x19), .b(x13), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n90_), .O(new_n154_));
  inv1   g110(.a(x14), .O(new_n155_));
  nand2  g111(.a(new_n93_), .b(new_n155_), .O(new_n156_));
  inv1   g112(.a(new_n146_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(x16), .c(x15), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n156_), .c(new_n154_), .d(x31), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n152_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n151_), .c(new_n147_), .d(new_n143_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n140_), .c(x00), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(x32), .c(x26), .O(z8));
  nand3  g119(.a(x19), .b(new_n90_), .c(x13), .O(new_n164_));
  nand3  g120(.a(new_n93_), .b(x18), .c(x14), .O(new_n165_));
  ...
  nand3  g125(.a(new_n157_), .b(new_n148_), .c(x11), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x15), .O(new_n172_));
  nand4  g128(.a(new_n157_), .b(x16), .c(new_n144_), .d(x10), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n49_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n132_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n141_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n174_), .b(new_n49_), .c(new_n132_), .d(new_n116_), .O(new_n179_));
  ...
  inv1   g138(.a(new_n147_), .O(new_n183_));
  inv1   g139(.a(new_n152_), .O(new_n184_));
  oai21  g140(.a(new_n132_), .b(x30), .c(new_n158_), .O(new_n185_));
  aoi21  g141(.a(new_n93_), .b(new_n155_), .c(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n154_), .c(new_n184_), .d(new_n151_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n183_), .c(x33), .O(new_n188_));
