...
module FAU ( 
  ...
  nand4  g61(.a(new_n105_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n106_));
  ...
  oai21  g66(.a(new_n110_), .b(new_n81_), .c(x30), .O(new_n111_));
  inv1   g67(.a(x30), .O(new_n112_));
  nand3  g68(.a(new_n103_), .b(new_n112_), .c(x29), .O(new_n113_));
  aoi22  g69(.a(new_n113_), .b(new_n111_), .c(new_n97_), .d(new_n84_), .O(new_n114_));
  ...
  nor2   g75(.a(new_n96_), .b(new_n60_), .O(new_n120_));
