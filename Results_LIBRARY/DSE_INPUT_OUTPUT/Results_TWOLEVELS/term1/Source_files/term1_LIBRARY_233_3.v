...
module FAU ( 
  ...
  oai21  g057(.a(new_n97_), .b(new_n45_), .c(x29), .O(new_n102_));
  ...
  nor2   g076(.a(new_n120_), .b(x15), .O(new_n121_));
  ...
  inv1   g081(.a(x12), .O(new_n126_));
  oai21  g082(.a(new_n123_), .b(new_n126_), .c(new_n85_), .O(new_n127_));
  inv1   g083(.a(x13), .O(new_n128_));
  inv1   g084(.a(x19), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n128_), .c(new_n88_), .O(new_n130_));
  nor2   g086(.a(x19), .b(x14), .O(new_n131_));
  nand2  g087(.a(x16), .b(x15), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n119_), .c(x31), .O(new_n133_));
  nor2   g089(.a(new_n133_), .b(new_n131_), .O(new_n134_));
  nand4  g090(.a(new_n134_), .b(new_n130_), .c(new_n127_), .d(new_n125_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n121_), .c(new_n48_), .O(new_n136_));
  ...
  oai21  g098(.a(new_n103_), .b(new_n97_), .c(x30), .O(new_n143_));
  nand2  g099(.a(new_n97_), .b(new_n45_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n46_), .c(x29), .O(new_n145_));
  oai21  g101(.a(new_n143_), .b(x27), .c(new_n145_), .O(new_n146_));
  nand3  g102(.a(x19), .b(new_n88_), .c(x13), .O(new_n147_));
  nand3  g103(.a(new_n129_), .b(x18), .c(x14), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n85_), .O(new_n149_));
  nand4  g105(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(x16), .O(new_n152_));
  inv1   g108(.a(new_n119_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n122_), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  inv1   g112(.a(x15), .O(new_n157_));
  nand3  g113(.a(x16), .b(new_n157_), .c(x10), .O(new_n158_));
  nor2   g114(.a(new_n158_), .b(new_n119_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n146_), .c(new_n142_), .d(x31), .O(new_n162_));
  ...
  aoi21  g124(.a(new_n154_), .b(new_n152_), .c(new_n157_), .O(new_n169_));
  ...
  nand4  g128(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  oai21  g130(.a(new_n159_), .b(new_n169_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n129_), .b(x14), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x18), .c(x17), .d(x16), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n157_), .O(new_n178_));
  nor2   g134(.a(new_n88_), .b(new_n85_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n132_), .c(new_n129_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n118_), .c(new_n157_), .O(new_n182_));
  aoi21  g138(.a(new_n179_), .b(x11), .c(x16), .O(new_n183_));
  oai21  g139(.a(new_n88_), .b(new_n126_), .c(new_n85_), .O(new_n184_));
  nand2  g140(.a(new_n88_), .b(new_n128_), .O(new_n185_));
  nand2  g141(.a(x31), .b(new_n46_), .O(new_n186_));
  nand3  g142(.a(new_n170_), .b(x29), .c(x28), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n184_), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n183_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n182_), .c(new_n181_), .d(new_n143_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n178_), .c(x33), .O(new_n191_));
  oai21  g147(.a(new_n175_), .b(x33), .c(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n81_), .c(x00), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n168_), .O(z9));
endmodule
