...
module FAU ( 
  ...
  aoi21  g032(.a(new_n76_), .b(x30), .c(x09), .O(z2));
  ...
  nand3  g043(.a(new_n87_), .b(new_n59_), .c(new_n46_), .O(new_n88_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n87_), .c(new_n59_), .d(new_n78_), .O(new_n104_));
  ...
  nand4  g065(.a(new_n109_), .b(x29), .c(x28), .d(x09), .O(new_n110_));
  oai21  g066(.a(new_n109_), .b(x28), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x27), .O(new_n112_));
  oai21  g068(.a(new_n101_), .b(new_n79_), .c(x30), .O(new_n113_));
  ...
  aoi22  g081(.a(new_n125_), .b(x09), .c(new_n124_), .d(x30), .O(new_n126_));
  ...
  nand3  g105(.a(x32), .b(new_n109_), .c(x09), .O(new_n150_));
  ...
  aoi21  g114(.a(new_n158_), .b(new_n142_), .c(x15), .O(new_n159_));
  nor2   g115(.a(new_n134_), .b(new_n132_), .O(new_n160_));
  ...
  nor3   g123(.a(new_n141_), .b(new_n140_), .c(new_n146_), .O(new_n168_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n157_), .c(new_n152_), .O(new_n172_));
  ...
  nand4  g135(.a(new_n148_), .b(new_n175_), .c(new_n122_), .d(new_n109_), .O(new_n180_));
  oai21  g136(.a(new_n175_), .b(new_n109_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n129_), .O(new_n182_));
  nor3   g138(.a(new_n168_), .b(new_n167_), .c(new_n125_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n166_), .c(new_n164_), .d(new_n162_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n159_), .c(x33), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n182_), .c(new_n179_), .O(new_n186_));
