...
module FAU ( 
  ...
  aoi21  g083(.a(new_n98_), .b(new_n45_), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g101(.a(x32), .b(new_n109_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n128_), .O(new_n147_));
  nand2  g103(.a(x29), .b(x28), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n45_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n144_), .c(new_n129_), .d(x31), .O(new_n150_));
  nand2  g106(.a(new_n98_), .b(x27), .O(new_n151_));
  aoi21  g107(.a(new_n148_), .b(new_n151_), .c(new_n109_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n137_), .c(new_n142_), .O(new_n154_));
  nand2  g110(.a(x19), .b(x18), .O(new_n155_));
  nand2  g111(.a(x17), .b(x11), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n155_), .c(new_n136_), .O(new_n157_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n137_), .c(x31), .O(new_n163_));
  ...
  oai21  g122(.a(new_n150_), .b(x30), .c(new_n166_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n147_), .c(new_n81_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n126_), .c(new_n58_), .O(z8));
  nand2  g125(.a(new_n91_), .b(x14), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x18), .c(x17), .d(x16), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n142_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n162_), .c(new_n91_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n153_), .c(new_n142_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n136_), .O(new_n177_));
  ...
  oai21  g137(.a(new_n181_), .b(new_n172_), .c(new_n58_), .O(new_n182_));
  nand2  g138(.a(new_n127_), .b(new_n45_), .O(new_n183_));
  nand2  g139(.a(new_n116_), .b(x29), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n183_), .c(new_n109_), .O(new_n185_));
  nand3  g141(.a(new_n120_), .b(x31), .c(new_n45_), .O(new_n186_));
  aoi22  g142(.a(new_n116_), .b(x28), .c(new_n109_), .d(x27), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n127_), .c(new_n186_), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n185_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n182_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  nand4  g147(.a(new_n148_), .b(new_n116_), .c(new_n109_), .d(new_n45_), .O(new_n192_));
  nand2  g148(.a(new_n98_), .b(new_n45_), .O(new_n193_));
