...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n59_), .c(new_n46_), .O(z3));
  ...
  nand3  g054(.a(new_n98_), .b(new_n91_), .c(new_n80_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n94_), .c(new_n59_), .O(z4));
  inv1   g056(.a(x29), .O(new_n101_));
  nor2   g057(.a(new_n96_), .b(new_n81_), .O(new_n102_));
  nand2  g058(.a(new_n101_), .b(x28), .O(new_n103_));
  oai22  g059(.a(new_n103_), .b(new_n81_), .c(new_n102_), .d(new_n101_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n46_), .O(z5));
  aoi21  g064(.a(new_n103_), .b(new_n97_), .c(new_n81_), .O(new_n109_));
  aoi21  g065(.a(x30), .b(new_n81_), .c(new_n109_), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n90_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n59_), .c(new_n46_), .O(z6));
  nor4   g069(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n114_));
  nand4  g070(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n46_), .O(new_n116_));
  inv1   g072(.a(new_n102_), .O(new_n117_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n117_), .c(new_n119_), .O(new_n122_));
  aoi22  g078(.a(new_n122_), .b(x30), .c(x31), .d(new_n81_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n116_), .O(z7));
  nand4  g080(.a(x32), .b(x29), .c(new_n80_), .d(x00), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x30), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x27), .O(new_n127_));
  inv1   g083(.a(x32), .O(new_n128_));
  nor2   g084(.a(x28), .b(x27), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n101_), .c(x30), .O(new_n130_));
  nand3  g086(.a(new_n45_), .b(x29), .c(x28), .O(new_n131_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n132_), .c(new_n128_), .d(x31), .O(new_n151_));
  nand3  g107(.a(new_n118_), .b(new_n45_), .c(new_n81_), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n143_), .c(new_n148_), .O(new_n154_));
  nor2   g110(.a(new_n136_), .b(new_n134_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(x17), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n142_), .O(new_n157_));
  aoi21  g113(.a(new_n155_), .b(x12), .c(x17), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  oai21  g115(.a(new_n136_), .b(new_n159_), .c(new_n134_), .O(new_n160_));
  inv1   g116(.a(x14), .O(new_n161_));
  nand2  g117(.a(new_n136_), .b(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n144_), .b(x16), .c(x15), .O(new_n163_));
  nor2   g119(.a(new_n45_), .b(new_n101_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(x28), .c(new_n120_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n163_), .c(new_n162_), .d(new_n160_), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n158_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n157_), .c(new_n154_), .d(new_n152_), .O(new_n168_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n127_), .O(z8));
  nand2  g128(.a(new_n136_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x18), .c(x17), .d(x16), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n148_), .O(new_n175_));
  nand2  g131(.a(x16), .b(x15), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n176_), .c(new_n136_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n153_), .c(new_n148_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n142_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n133_), .c(new_n134_), .d(new_n159_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n181_), .c(new_n179_), .d(new_n178_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n175_), .c(new_n46_), .O(new_n185_));
  aoi21  g141(.a(x31), .b(x29), .c(new_n45_), .O(new_n186_));
  oai21  g142(.a(new_n45_), .b(new_n96_), .c(x31), .O(new_n187_));
  oai21  g143(.a(new_n121_), .b(new_n96_), .c(new_n187_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n81_), .c(new_n186_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n145_), .b(new_n141_), .c(new_n148_), .O(new_n192_));
  inv1   g148(.a(new_n149_), .O(new_n193_));
  nand4  g149(.a(new_n118_), .b(new_n120_), .c(new_n45_), .d(new_n81_), .O(new_n194_));
  inv1   g150(.a(new_n194_), .O(new_n195_));
  nor4   g151(.a(new_n129_), .b(new_n120_), .c(new_n45_), .d(new_n101_), .O(new_n196_));
  oai22  g152(.a(new_n196_), .b(new_n195_), .c(new_n193_), .d(new_n192_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(x33), .c(new_n191_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n80_), .c(x00), .O(new_n199_));
