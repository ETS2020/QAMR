...
module FAU ( 
  ...
  nand4  g055(.a(new_n98_), .b(new_n96_), .c(x28), .d(x27), .O(new_n100_));
  oai21  g056(.a(new_n99_), .b(new_n96_), .c(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n88_), .c(new_n60_), .d(new_n79_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n95_), .c(new_n58_), .O(z5));
  nand4  g059(.a(new_n98_), .b(x29), .c(x28), .d(x27), .O(new_n104_));
  oai21  g060(.a(new_n98_), .b(x27), .c(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n89_), .c(new_n79_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n95_), .c(new_n58_), .O(z6));
  inv1   g063(.a(new_n85_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n84_), .c(new_n82_), .O(new_n109_));
  inv1   g065(.a(x31), .O(new_n110_));
  nand3  g066(.a(new_n45_), .b(new_n110_), .c(new_n79_), .O(new_n111_));
  nor4   g067(.a(new_n111_), .b(new_n59_), .c(new_n95_), .d(new_n58_), .O(new_n112_));
  oai21  g068(.a(new_n109_), .b(new_n86_), .c(new_n112_), .O(z7));
  inv1   g069(.a(x32), .O(new_n114_));
  aoi21  g070(.a(new_n98_), .b(x28), .c(x27), .O(new_n115_));
  nor2   g071(.a(new_n96_), .b(new_n97_), .O(new_n116_));
  oai22  g072(.a(new_n116_), .b(new_n98_), .c(new_n115_), .d(new_n96_), .O(new_n117_));
  ...
  nand4  g091(.a(new_n135_), .b(new_n117_), .c(new_n114_), .d(x31), .O(new_n136_));
  oai21  g092(.a(x28), .b(x27), .c(x29), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n98_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x10), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n128_), .c(new_n133_), .O(new_n140_));
  nor2   g096(.a(new_n121_), .b(new_n119_), .O(new_n141_));
  ...
  oai21  g101(.a(new_n121_), .b(new_n145_), .c(new_n119_), .O(new_n146_));
  inv1   g102(.a(x14), .O(new_n147_));
  nand2  g103(.a(new_n121_), .b(new_n147_), .O(new_n148_));
  nand3  g104(.a(new_n129_), .b(x16), .c(x15), .O(new_n149_));
  nor2   g105(.a(new_n98_), .b(new_n96_), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(x28), .c(new_n110_), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n149_), .c(new_n148_), .d(new_n146_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n144_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n143_), .c(new_n140_), .d(new_n138_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n136_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n79_), .c(x00), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n45_), .O(z8));
  nand2  g114(.a(new_n121_), .b(x14), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(x18), .c(x17), .d(x16), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n133_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x15), .O(new_n162_));
  nand2  g118(.a(x18), .b(x17), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n121_), .O(new_n164_));
  oai21  g120(.a(new_n163_), .b(new_n139_), .c(new_n133_), .O(new_n165_));
  inv1   g121(.a(x11), .O(new_n166_));
  oai21  g122(.a(new_n163_), .b(new_n166_), .c(new_n127_), .O(new_n167_));
  nand2  g123(.a(x18), .b(x12), .O(new_n168_));
  aoi22  g124(.a(new_n168_), .b(new_n118_), .c(new_n119_), .d(new_n145_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n167_), .c(new_n165_), .d(new_n164_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n161_), .c(new_n45_), .O(new_n171_));
  aoi21  g127(.a(new_n137_), .b(new_n110_), .c(x30), .O(new_n172_));
  nand2  g128(.a(new_n110_), .b(x30), .O(new_n173_));
  oai21  g129(.a(new_n116_), .b(new_n110_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n80_), .c(new_n172_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n171_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x33), .O(new_n177_));
  aoi21  g133(.a(new_n130_), .b(new_n126_), .c(new_n133_), .O(new_n178_));
  inv1   g134(.a(new_n134_), .O(new_n179_));
  nand3  g135(.a(new_n116_), .b(x31), .c(x30), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nor3   g137(.a(x31), .b(x30), .c(x28), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n181_), .c(new_n80_), .O(new_n183_));
  nand3  g139(.a(new_n110_), .b(new_n98_), .c(new_n96_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  oai21  g141(.a(new_n179_), .b(new_n178_), .c(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(x33), .c(new_n177_), .O(new_n187_));
