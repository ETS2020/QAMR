...
module FAU ( 
  ...
  nand2  g052(.a(x30), .b(new_n95_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x27), .O(new_n98_));
  aoi22  g054(.a(new_n98_), .b(new_n45_), .c(new_n96_), .d(new_n95_), .O(new_n99_));
  nand4  g055(.a(new_n94_), .b(x28), .c(x27), .d(new_n45_), .O(new_n100_));
  oai21  g056(.a(new_n99_), .b(new_n94_), .c(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n93_), .c(new_n61_), .d(x25), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n59_), .c(new_n47_), .O(z5));
  nand3  g059(.a(new_n96_), .b(x28), .c(x27), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n97_), .O(new_n105_));
  aoi21  g061(.a(x29), .b(x27), .c(new_n96_), .O(new_n106_));
  ...
  nand2  g101(.a(x32), .b(new_n96_), .O(new_n146_));
  oai21  g102(.a(new_n145_), .b(x26), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n125_), .O(new_n148_));
  nand4  g104(.a(new_n144_), .b(new_n124_), .c(new_n126_), .d(x31), .O(new_n149_));
  nand2  g105(.a(new_n95_), .b(new_n81_), .O(new_n150_));
  ...
  nor2   g111(.a(new_n130_), .b(new_n128_), .O(new_n156_));
  ...
  nand2  g128(.a(x33), .b(new_n96_), .O(new_n173_));
  oai21  g129(.a(new_n172_), .b(x26), .c(new_n173_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n124_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n144_), .b(new_n171_), .c(new_n119_), .d(new_n96_), .O(new_n176_));
  nand3  g132(.a(x33), .b(x31), .c(new_n45_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  aoi21  g134(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x17), .c(x16), .d(x15), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n163_), .c(new_n130_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n154_), .c(new_n142_), .O(new_n183_));
  nand2  g139(.a(new_n119_), .b(x30), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n181_), .b(new_n185_), .c(new_n136_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x12), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n127_), .O(new_n188_));
  inv1   g144(.a(x13), .O(new_n189_));
  nand2  g145(.a(new_n128_), .b(new_n189_), .O(new_n190_));
  ...
  nand3  g149(.a(new_n193_), .b(x33), .c(new_n45_), .O(new_n194_));
  inv1   g150(.a(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n178_), .b(new_n125_), .c(new_n195_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n175_), .O(new_n197_));
