...
module FAU ( 
  ...
  nand3  g056(.a(new_n45_), .b(x28), .c(new_n81_), .O(new_n101_));
  oai21  g057(.a(x28), .b(new_n81_), .c(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(new_n95_), .c(new_n80_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n100_), .c(new_n60_), .O(z4));
  xor2a  g060(.a(x29), .b(x28), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n95_), .c(x27), .O(new_n106_));
  ...
  oai21  g066(.a(new_n45_), .b(new_n110_), .c(x30), .O(new_n111_));
  inv1   g067(.a(x30), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x29), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n110_), .c(new_n111_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n58_), .O(z6));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x30), .c(x28), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x29), .O(new_n122_));
  nand2  g078(.a(x30), .b(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n110_), .c(x31), .O(new_n124_));
  ...
  nand2  g085(.a(x30), .b(new_n45_), .O(new_n130_));
  ...
  oai21  g112(.a(new_n91_), .b(new_n156_), .c(new_n88_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x15), .O(new_n158_));
  oai22  g114(.a(new_n158_), .b(new_n139_), .c(x19), .d(x14), .O(new_n159_));
  nand2  g115(.a(new_n112_), .b(new_n45_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n123_), .c(x31), .O(new_n161_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n58_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n169_));
  nand2  g125(.a(new_n119_), .b(new_n112_), .O(new_n170_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n158_), .c(new_n91_), .O(new_n177_));
  ...
  aoi22  g137(.a(new_n181_), .b(new_n85_), .c(new_n88_), .d(new_n156_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n175_), .c(new_n58_), .O(new_n184_));
  oai21  g140(.a(x31), .b(new_n112_), .c(new_n113_), .O(new_n185_));
