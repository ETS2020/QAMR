...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n83_), .c(new_n45_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n82_), .c(new_n61_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n45_), .d(x25), .O(new_n100_));
  ...
  nor3   g064(.a(new_n108_), .b(new_n82_), .c(new_n61_), .O(z5));
  ...
  nor3   g070(.a(new_n114_), .b(new_n82_), .c(new_n61_), .O(z6));
  oai21  g071(.a(x31), .b(x26), .c(new_n46_), .O(new_n116_));
  nand2  g072(.a(new_n110_), .b(x31), .O(new_n117_));
  inv1   g073(.a(new_n84_), .O(new_n118_));
  nand4  g074(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n118_), .O(new_n119_));
  nor2   g075(.a(new_n62_), .b(new_n61_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(x30), .c(x29), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n105_), .c(new_n82_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n116_), .O(z7));
  ...
  oai21  g114(.a(new_n158_), .b(new_n141_), .c(new_n140_), .O(new_n159_));
  inv1   g115(.a(x12), .O(new_n160_));
  oai21  g116(.a(new_n141_), .b(new_n160_), .c(new_n85_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n91_), .b(new_n162_), .c(new_n88_), .O(new_n163_));
  nor2   g119(.a(x19), .b(x14), .O(new_n164_));
  nor2   g120(.a(new_n140_), .b(new_n148_), .O(new_n165_));
  ...
  nand4  g137(.a(new_n150_), .b(new_n176_), .c(new_n121_), .d(new_n46_), .O(new_n182_));
  ...
  aoi21  g141(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(x17), .c(x16), .d(x15), .O(new_n187_));
  inv1   g143(.a(new_n165_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x17), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n188_), .c(new_n91_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n156_), .c(new_n148_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n140_), .O(new_n193_));
  oai21  g149(.a(new_n88_), .b(new_n160_), .c(new_n85_), .O(new_n194_));
  nand2  g150(.a(new_n88_), .b(new_n162_), .O(new_n195_));
