...
module FAU ( 
  ...
  nand2  g078(.a(new_n80_), .b(x00), .O(new_n123_));
  nand3  g079(.a(x32), .b(x29), .c(new_n97_), .O(new_n124_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n102_), .c(x30), .O(new_n129_));
  ...
  nand2  g113(.a(new_n91_), .b(new_n157_), .O(new_n158_));
  nand3  g114(.a(new_n140_), .b(x16), .c(x15), .O(new_n159_));
  nor2   g115(.a(new_n45_), .b(new_n102_), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(x28), .c(new_n113_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n159_), .c(new_n158_), .d(new_n156_), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n154_), .O(new_n163_));
  ...
  aoi22  g134(.a(new_n178_), .b(new_n85_), .c(new_n88_), .d(new_n155_), .O(new_n179_));
  ...
  nand2  g139(.a(new_n183_), .b(new_n114_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n81_), .c(new_n182_), .O(new_n185_));
  ...
  nand4  g145(.a(new_n117_), .b(new_n113_), .c(new_n45_), .d(new_n81_), .O(new_n190_));
  inv1   g146(.a(new_n190_), .O(new_n191_));
  nor4   g147(.a(new_n128_), .b(new_n113_), .c(new_n45_), .d(new_n102_), .O(new_n192_));
  oai22  g148(.a(new_n192_), .b(new_n191_), .c(new_n189_), .d(new_n188_), .O(new_n193_));
