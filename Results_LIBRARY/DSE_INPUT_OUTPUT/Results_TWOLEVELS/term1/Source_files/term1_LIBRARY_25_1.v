...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n88_), .c(new_n47_), .O(new_n94_));
  ...
  nand3  g054(.a(new_n45_), .b(new_n98_), .c(x28), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(x28), .c(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n98_), .b(x27), .O(new_n101_));
  aoi21  g057(.a(new_n100_), .b(x27), .c(new_n101_), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n87_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n60_), .O(z5));
  ...
  nor2   g065(.a(new_n109_), .b(new_n82_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n108_), .c(x29), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n107_), .c(new_n87_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n62_), .c(new_n81_), .O(new_n113_));
  ...
  nand3  g081(.a(new_n45_), .b(x30), .c(x29), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n125_), .c(new_n81_), .O(new_n127_));
  nor2   g083(.a(new_n127_), .b(new_n124_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n123_), .c(new_n122_), .d(new_n118_), .O(z7));
  inv1   g085(.a(x00), .O(new_n130_));
  inv1   g086(.a(x32), .O(new_n131_));
  nor2   g087(.a(x28), .b(x27), .O(new_n132_));
  nand3  g088(.a(x30), .b(new_n109_), .c(new_n82_), .O(new_n133_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n134_), .c(new_n131_), .d(x31), .O(new_n155_));
  xor2a  g111(.a(x30), .b(x27), .O(new_n156_));
  nor2   g112(.a(new_n156_), .b(x28), .O(new_n157_));
  ...
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n144_), .O(new_n162_));
  ...
  oai22  g123(.a(new_n167_), .b(new_n145_), .c(new_n108_), .d(new_n109_), .O(new_n168_));
  nor3   g124(.a(new_n168_), .b(new_n166_), .c(new_n165_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n164_), .c(new_n162_), .d(new_n159_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n157_), .c(x32), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n155_), .c(new_n98_), .O(new_n172_));
  nor2   g128(.a(new_n131_), .b(x31), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n172_), .c(new_n81_), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n130_), .O(z8));
  inv1   g131(.a(new_n132_), .O(new_n176_));
  inv1   g132(.a(x33), .O(new_n177_));
  nand4  g133(.a(new_n154_), .b(new_n177_), .c(x31), .d(x30), .O(new_n178_));
  nand3  g134(.a(x33), .b(new_n45_), .c(x29), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n176_), .O(new_n181_));
  aoi21  g137(.a(new_n147_), .b(new_n143_), .c(new_n150_), .O(new_n182_));
  nand3  g138(.a(new_n45_), .b(new_n109_), .c(new_n82_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x29), .O(new_n184_));
  oai21  g140(.a(new_n152_), .b(new_n182_), .c(new_n184_), .O(new_n185_));
  nand2  g141(.a(x33), .b(x31), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(x33), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n138_), .b(x14), .c(new_n136_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  nor2   g145(.a(new_n136_), .b(new_n135_), .O(new_n190_));
  inv1   g146(.a(new_n190_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n167_), .c(new_n138_), .O(new_n192_));
  oai21  g148(.a(new_n191_), .b(new_n158_), .c(new_n150_), .O(new_n193_));
  aoi21  g149(.a(new_n190_), .b(x11), .c(x16), .O(new_n194_));
  nand2  g150(.a(new_n45_), .b(x30), .O(new_n195_));
  oai21  g151(.a(new_n136_), .b(new_n163_), .c(new_n135_), .O(new_n196_));
  inv1   g152(.a(x13), .O(new_n197_));
  nand2  g153(.a(new_n136_), .b(new_n197_), .O(new_n198_));
  nand3  g154(.a(x31), .b(new_n109_), .c(new_n82_), .O(new_n199_));
  nand4  g155(.a(new_n199_), .b(new_n198_), .c(new_n196_), .d(new_n195_), .O(new_n200_));
  nor2   g156(.a(new_n200_), .b(new_n194_), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n193_), .c(new_n192_), .d(new_n189_), .O(new_n202_));
  and2   g158(.a(new_n202_), .b(x33), .O(new_n203_));
  aoi21  g159(.a(new_n187_), .b(new_n108_), .c(new_n203_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n181_), .O(new_n205_));
