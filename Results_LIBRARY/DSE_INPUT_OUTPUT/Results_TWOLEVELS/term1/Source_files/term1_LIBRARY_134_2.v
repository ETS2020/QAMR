...
module FAU ( 
  ...
  nand3  g051(.a(x28), .b(new_n80_), .c(new_n45_), .O(new_n96_));
  oai21  g052(.a(x28), .b(new_n80_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n93_), .c(new_n60_), .d(x25), .O(new_n98_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n93_), .c(new_n60_), .d(new_n45_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n79_), .c(new_n59_), .O(z5));
  nor2   g062(.a(new_n102_), .b(new_n100_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n93_), .c(new_n60_), .d(new_n45_), .O(new_n113_));
  ...
  nor2   g073(.a(new_n117_), .b(x27), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n117_), .b(x30), .c(x29), .d(x27), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n119_), .c(new_n45_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x28), .O(new_n122_));
  nor2   g078(.a(new_n110_), .b(new_n102_), .O(new_n123_));
  ...
  nand3  g082(.a(new_n60_), .b(x25), .c(x01), .O(new_n127_));
  ...
  nand2  g088(.a(new_n100_), .b(new_n80_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n110_), .c(x29), .O(new_n134_));
  aoi21  g090(.a(new_n100_), .b(new_n80_), .c(new_n102_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n110_), .c(new_n134_), .O(new_n136_));
  ...
  nor2   g106(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  ...
  oai21  g110(.a(x30), .b(x28), .c(new_n124_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n80_), .O(new_n156_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n159_), .c(new_n143_), .O(new_n161_));
  ...
  nor2   g122(.a(new_n143_), .b(new_n149_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n145_), .c(new_n166_), .O(new_n168_));
  oai21  g124(.a(x30), .b(x29), .c(x31), .O(new_n169_));
  aoi21  g125(.a(new_n123_), .b(x27), .c(new_n169_), .O(new_n170_));
  ...
  aoi21  g133(.a(new_n146_), .b(new_n142_), .c(new_n149_), .O(new_n178_));
  nand2  g134(.a(new_n117_), .b(new_n110_), .O(new_n179_));
  oai21  g135(.a(x28), .b(x27), .c(x31), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n110_), .O(new_n181_));
  nor2   g137(.a(new_n179_), .b(x29), .O(new_n182_));
  aoi21  g138(.a(new_n181_), .b(x29), .c(new_n182_), .O(new_n183_));
  oai22  g139(.a(new_n183_), .b(x26), .c(new_n179_), .d(new_n133_), .O(new_n184_));
  oai21  g140(.a(new_n151_), .b(new_n178_), .c(new_n184_), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(x33), .O(new_n186_));
  ...
  oai21  g145(.a(new_n110_), .b(new_n102_), .c(x31), .O(new_n190_));
  oai21  g146(.a(new_n107_), .b(x30), .c(new_n117_), .O(new_n191_));
  nand3  g147(.a(new_n167_), .b(x18), .c(x17), .O(new_n192_));
  nand2  g148(.a(x18), .b(x17), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n157_), .c(new_n149_), .O(new_n194_));
  inv1   g150(.a(x11), .O(new_n195_));
  oai21  g151(.a(new_n193_), .b(new_n195_), .c(new_n143_), .O(new_n196_));
  oai21  g152(.a(new_n87_), .b(new_n162_), .c(new_n84_), .O(new_n197_));
  nand2  g153(.a(new_n87_), .b(new_n164_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n197_), .c(new_n196_), .d(new_n194_), .O(new_n199_));
  aoi21  g155(.a(new_n192_), .b(new_n90_), .c(new_n199_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n191_), .c(new_n190_), .d(new_n189_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n45_), .O(new_n202_));
  nand3  g158(.a(new_n117_), .b(x29), .c(x27), .O(new_n203_));
  inv1   g159(.a(new_n203_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n118_), .c(new_n100_), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n202_), .c(new_n187_), .O(new_n206_));
  oai21  g162(.a(new_n206_), .b(new_n186_), .c(x00), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(new_n48_), .O(z9));
endmodule
