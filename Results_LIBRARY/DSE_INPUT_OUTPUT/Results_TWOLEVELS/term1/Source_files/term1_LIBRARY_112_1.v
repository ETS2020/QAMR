...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n93_), .c(new_n60_), .d(new_n45_), .O(new_n115_));
  ...
  nand3  g076(.a(new_n60_), .b(x25), .c(x01), .O(new_n121_));
  nand4  g077(.a(x30), .b(x29), .c(x28), .d(x27), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n45_), .c(new_n79_), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n121_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n120_), .O(z7));
  nand2  g081(.a(x32), .b(x00), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n45_), .c(x26), .O(z8));
  inv1   g083(.a(x33), .O(new_n128_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(new_n128_), .d(new_n112_), .O(new_n145_));
  aoi21  g101(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(x17), .c(x16), .d(x15), .O(new_n147_));
  nand2  g103(.a(x16), .b(x15), .O(new_n148_));
  nand2  g104(.a(x18), .b(x17), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n148_), .c(new_n88_), .O(new_n150_));
  ...
  aoi21  g113(.a(new_n85_), .b(new_n157_), .c(x30), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n156_), .c(new_n154_), .d(new_n152_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n150_), .c(new_n147_), .d(new_n129_), .O(new_n161_));
  ...
  aoi21  g120(.a(new_n164_), .b(new_n45_), .c(x26), .O(z9));
endmodule
