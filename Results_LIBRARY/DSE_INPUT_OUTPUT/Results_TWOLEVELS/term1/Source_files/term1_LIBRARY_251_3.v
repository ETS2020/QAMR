...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n60_), .c(new_n49_), .O(z4));
  oai21  g052(.a(x30), .b(x28), .c(x27), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x29), .O(new_n98_));
  nor2   g054(.a(x30), .b(x29), .O(new_n99_));
  ...
  nor3   g058(.a(new_n102_), .b(new_n81_), .c(new_n60_), .O(z5));
  nand2  g059(.a(x29), .b(x28), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n45_), .c(new_n46_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n91_), .c(new_n82_), .d(x25), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n60_), .c(new_n49_), .O(z6));
  inv1   g063(.a(new_n87_), .O(new_n108_));
  ...
  nor2   g071(.a(new_n115_), .b(x15), .O(new_n116_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n116_), .c(new_n49_), .O(new_n133_));
  nand3  g089(.a(x30), .b(x29), .c(x28), .O(new_n134_));
  oai21  g090(.a(x30), .b(x28), .c(new_n134_), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n45_), .c(new_n99_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x32), .O(new_n138_));
  inv1   g094(.a(x32), .O(new_n139_));
  nand3  g095(.a(new_n104_), .b(x30), .c(new_n45_), .O(new_n140_));
  inv1   g096(.a(x28), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n45_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n46_), .c(x29), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n140_), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n125_), .c(x13), .O(new_n145_));
  nand3  g101(.a(new_n126_), .b(x18), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n122_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n122_), .d(x12), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n147_), .c(x16), .O(new_n150_));
  inv1   g106(.a(new_n114_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n117_), .c(x11), .O(new_n152_));
  ...
  nor2   g112(.a(new_n156_), .b(new_n114_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n144_), .c(new_n139_), .d(x31), .O(new_n160_));
  ...
  aoi21  g122(.a(new_n152_), .b(new_n150_), .c(new_n155_), .O(new_n167_));
  inv1   g123(.a(x31), .O(new_n168_));
  nand2  g124(.a(new_n142_), .b(x29), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n168_), .c(new_n46_), .O(new_n170_));
  nand2  g126(.a(x31), .b(x30), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n104_), .c(new_n170_), .O(new_n172_));
  oai21  g128(.a(new_n157_), .b(new_n167_), .c(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n126_), .b(x14), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x18), .c(x17), .d(x16), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n155_), .O(new_n176_));
  nand2  g132(.a(new_n104_), .b(x31), .O(new_n177_));
  nor2   g133(.a(new_n125_), .b(new_n122_), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n129_), .c(new_n126_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n113_), .c(new_n155_), .O(new_n181_));
  aoi21  g137(.a(new_n178_), .b(x11), .c(x16), .O(new_n182_));
  oai21  g138(.a(new_n125_), .b(new_n121_), .c(new_n122_), .O(new_n183_));
  nand2  g139(.a(new_n125_), .b(new_n124_), .O(new_n184_));
  nand3  g140(.a(new_n46_), .b(x29), .c(x28), .O(new_n185_));
  nand2  g141(.a(new_n168_), .b(x30), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n183_), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n182_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n181_), .c(new_n180_), .d(new_n177_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n176_), .c(x33), .O(new_n190_));
  oai21  g146(.a(new_n173_), .b(x33), .c(new_n190_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n82_), .c(x00), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n166_), .O(z9));
endmodule
