...
module FAU ( 
  ...
  aoi21  g056(.a(x30), .b(new_n94_), .c(new_n100_), .O(new_n101_));
  nand2  g057(.a(x28), .b(x27), .O(new_n102_));
  nand2  g058(.a(x30), .b(new_n99_), .O(new_n103_));
  oai22  g059(.a(new_n103_), .b(new_n102_), .c(new_n101_), .d(new_n99_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n93_), .c(new_n59_), .O(z5));
  ...
  oai21  g074(.a(new_n118_), .b(new_n102_), .c(new_n116_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x30), .c(x31), .d(new_n100_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n114_), .O(z7));
  nand3  g077(.a(new_n94_), .b(new_n80_), .c(x00), .O(new_n122_));
  nand3  g078(.a(x32), .b(x30), .c(x29), .O(new_n123_));
  ...
  aoi21  g129(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n174_));
  inv1   g130(.a(new_n147_), .O(new_n175_));
  oai21  g131(.a(new_n45_), .b(new_n94_), .c(new_n100_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(x31), .c(x29), .O(new_n177_));
  nand3  g133(.a(new_n115_), .b(new_n117_), .c(new_n45_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  oai21  g135(.a(new_n175_), .b(new_n174_), .c(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n117_), .b(new_n99_), .c(x30), .O(new_n181_));
  oai21  g137(.a(new_n127_), .b(new_n45_), .c(x31), .O(new_n182_));
  nand3  g138(.a(new_n117_), .b(x29), .c(x28), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n184_));
  aoi21  g140(.a(new_n157_), .b(new_n146_), .c(new_n184_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n182_), .c(new_n181_), .d(new_n156_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n152_), .c(x33), .O(new_n187_));
