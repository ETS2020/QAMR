...
module FAU ( 
  ...
  nand4  g068(.a(new_n112_), .b(new_n98_), .c(x25), .d(x01), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(x00), .c(x26), .O(z3));
  xor2a  g070(.a(x28), .b(x27), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n112_), .c(x25), .d(x01), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(x00), .c(x26), .O(z4));
  inv1   g073(.a(x26), .O(new_n118_));
  inv1   g074(.a(new_n111_), .O(new_n119_));
  inv1   g075(.a(x29), .O(new_n120_));
  inv1   g076(.a(x28), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n98_), .O(new_n122_));
  nand3  g078(.a(new_n120_), .b(x28), .c(x27), .O(new_n123_));
  oai21  g079(.a(new_n122_), .b(new_n120_), .c(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n81_), .d(new_n118_), .O(new_n125_));
  ...
  nand4  g089(.a(new_n133_), .b(new_n119_), .c(new_n81_), .d(new_n118_), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(x25), .c(x01), .d(x00), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(z6));
  nor2   g093(.a(new_n131_), .b(new_n120_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n122_), .O(new_n139_));
  ...
  nand3  g098(.a(new_n81_), .b(x25), .c(x01), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  inv1   g100(.a(new_n122_), .O(new_n145_));
  inv1   g101(.a(x31), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x30), .c(x29), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(new_n46_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(x26), .O(new_n149_));
  ...
  nor2   g110(.a(new_n152_), .b(new_n120_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n131_), .c(new_n154_), .O(new_n156_));
  nand3  g112(.a(x19), .b(new_n104_), .c(x13), .O(new_n157_));
  nand3  g113(.a(new_n107_), .b(x18), .c(x14), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(new_n101_), .O(new_n159_));
  nand4  g115(.a(x19), .b(x18), .c(new_n101_), .d(x12), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(x16), .O(new_n162_));
  inv1   g118(.a(x16), .O(new_n163_));
  nand3  g119(.a(x19), .b(x18), .c(x17), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n163_), .c(x11), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n162_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x15), .O(new_n168_));
  inv1   g124(.a(x15), .O(new_n169_));
  nand4  g125(.a(new_n165_), .b(x16), .c(new_n169_), .d(x10), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n168_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n156_), .c(new_n151_), .d(x31), .O(new_n172_));
  inv1   g128(.a(x00), .O(new_n173_));
  nand2  g129(.a(new_n138_), .b(x27), .O(new_n174_));
  oai21  g130(.a(x30), .b(x27), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n121_), .O(new_n176_));
  nand2  g132(.a(x16), .b(x10), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n164_), .c(new_n169_), .O(new_n178_));
  nand2  g134(.a(x19), .b(x18), .O(new_n179_));
  nand2  g135(.a(x17), .b(x11), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n163_), .O(new_n181_));
  inv1   g137(.a(x12), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n182_), .c(new_n101_), .O(new_n183_));
  nand2  g139(.a(x19), .b(x13), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n104_), .O(new_n185_));
  nand2  g141(.a(x16), .b(x15), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n164_), .c(x19), .d(x14), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  oai21  g144(.a(x30), .b(x29), .c(x31), .O(new_n189_));
  aoi21  g145(.a(new_n138_), .b(x28), .c(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(new_n185_), .d(new_n183_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n181_), .c(new_n178_), .d(new_n176_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(x32), .c(new_n173_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(new_n172_), .c(x26), .O(z8));
  inv1   g151(.a(x33), .O(new_n196_));
  nand4  g152(.a(new_n171_), .b(new_n196_), .c(x31), .d(x30), .O(new_n197_));
  nand2  g153(.a(x33), .b(new_n146_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n153_), .c(x29), .O(new_n200_));
  inv1   g156(.a(new_n155_), .O(new_n201_));
  nand4  g157(.a(new_n171_), .b(new_n196_), .c(new_n146_), .d(new_n131_), .O(new_n202_));
  nand2  g158(.a(x33), .b(x31), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  inv1   g160(.a(new_n178_), .O(new_n205_));
  xor2a  g161(.a(x31), .b(x30), .O(new_n206_));
  nor2   g162(.a(new_n206_), .b(new_n187_), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(new_n185_), .c(new_n183_), .d(new_n181_), .O(new_n208_));
  oai21  g164(.a(new_n208_), .b(new_n205_), .c(x33), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(x00), .O(new_n210_));
  aoi21  g166(.a(new_n204_), .b(new_n201_), .c(new_n210_), .O(new_n211_));
  aoi21  g167(.a(new_n211_), .b(new_n200_), .c(x26), .O(z9));
endmodule
