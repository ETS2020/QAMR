...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n96_), .c(x25), .d(x01), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x00), .c(x26), .O(z3));
  xor2a  g064(.a(x28), .b(x27), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n106_), .c(x25), .d(x01), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(x00), .c(x26), .O(z4));
  inv1   g067(.a(x26), .O(new_n112_));
  inv1   g068(.a(new_n80_), .O(new_n113_));
  inv1   g069(.a(x29), .O(new_n114_));
  inv1   g070(.a(x28), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n96_), .O(new_n116_));
  nand3  g072(.a(new_n114_), .b(x28), .c(x27), .O(new_n117_));
  oai21  g073(.a(new_n116_), .b(new_n114_), .c(new_n117_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n104_), .c(new_n113_), .d(new_n112_), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x25), .c(x01), .d(x00), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(z5));
  nand3  g078(.a(x29), .b(x28), .c(x27), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x30), .O(new_n124_));
  inv1   g080(.a(x30), .O(new_n125_));
  nand3  g081(.a(new_n116_), .b(new_n125_), .c(x29), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n124_), .c(new_n105_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n113_), .c(x25), .d(x01), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(x00), .c(x26), .O(z6));
  nand3  g085(.a(new_n116_), .b(x30), .c(x29), .O(new_n130_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n133_), .c(new_n132_), .d(new_n99_), .O(new_n135_));
  ...
  aoi21  g096(.a(new_n140_), .b(new_n116_), .c(new_n137_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n136_), .c(new_n135_), .d(new_n131_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x00), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n112_), .O(z7));
  nand2  g100(.a(new_n115_), .b(new_n96_), .O(new_n145_));
  ...
  oai21  g141(.a(x18), .b(x13), .c(x31), .O(new_n186_));
  ...
  aoi21  g146(.a(new_n174_), .b(x29), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n169_), .c(x26), .O(z8));
  inv1   g148(.a(x33), .O(new_n193_));
  nand4  g149(.a(new_n165_), .b(new_n193_), .c(x31), .d(x30), .O(new_n194_));
  ...
  nand4  g153(.a(new_n165_), .b(new_n193_), .c(new_n138_), .d(new_n125_), .O(new_n198_));
  nand2  g154(.a(x33), .b(x31), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n146_), .O(new_n201_));
  inv1   g157(.a(new_n181_), .O(new_n202_));
  aoi21  g158(.a(new_n202_), .b(new_n159_), .c(x15), .O(new_n203_));
  nor2   g159(.a(new_n151_), .b(new_n149_), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(x17), .c(x11), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(new_n157_), .O(new_n206_));
  nand2  g162(.a(new_n204_), .b(x12), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(new_n148_), .O(new_n208_));
  nand2  g164(.a(x19), .b(x13), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(new_n149_), .O(new_n210_));
  oai22  g166(.a(new_n178_), .b(new_n158_), .c(x19), .d(x14), .O(new_n211_));
  xor2a  g167(.a(x31), .b(x30), .O(new_n212_));
  nor2   g168(.a(new_n212_), .b(new_n211_), .O(new_n213_));
  nand4  g169(.a(new_n213_), .b(new_n210_), .c(new_n208_), .d(new_n206_), .O(new_n214_));
  oai21  g170(.a(new_n214_), .b(new_n203_), .c(x33), .O(new_n215_));
  nand3  g171(.a(new_n215_), .b(new_n201_), .c(new_n197_), .O(new_n216_));
  nand3  g172(.a(new_n216_), .b(new_n112_), .c(x00), .O(new_n217_));
