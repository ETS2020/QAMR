...
module FAU ( 
  ...
  nand4  g059(.a(new_n103_), .b(new_n87_), .c(new_n59_), .d(new_n56_), .O(new_n104_));
  ...
  oai21  g066(.a(new_n109_), .b(new_n99_), .c(new_n110_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x27), .O(new_n112_));
  nand2  g068(.a(x30), .b(new_n79_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n108_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n58_), .c(new_n56_), .O(z6));
  nor4   g072(.a(new_n85_), .b(new_n84_), .c(new_n82_), .d(new_n80_), .O(new_n117_));
  nand4  g073(.a(new_n59_), .b(new_n78_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n56_), .O(new_n119_));
  ...
  aoi22  g081(.a(new_n125_), .b(x04), .c(new_n124_), .d(x30), .O(new_n126_));
  ...
  inv1   g105(.a(x30), .O(new_n150_));
  nand3  g106(.a(x32), .b(new_n150_), .c(x04), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n149_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n129_), .O(new_n153_));
  nand4  g109(.a(new_n148_), .b(new_n128_), .c(new_n130_), .d(x31), .O(new_n154_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n132_), .O(new_n167_));
  nor2   g123(.a(x19), .b(x14), .O(new_n168_));
  nor3   g124(.a(new_n141_), .b(new_n140_), .c(new_n146_), .O(new_n169_));
  ...
  nand4  g136(.a(new_n148_), .b(new_n176_), .c(new_n122_), .d(new_n150_), .O(new_n181_));
  oai21  g137(.a(new_n176_), .b(new_n150_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n129_), .O(new_n183_));
  nor3   g139(.a(new_n169_), .b(new_n168_), .c(new_n125_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n167_), .c(new_n165_), .d(new_n163_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n160_), .c(x33), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n183_), .c(new_n180_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n78_), .c(x00), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n56_), .O(z9));
endmodule
