...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n81_), .c(new_n80_), .O(new_n91_));
  nor3   g047(.a(new_n91_), .b(new_n79_), .c(new_n58_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n80_), .d(x25), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n58_), .c(new_n45_), .O(z4));
  ...
  nand4  g056(.a(new_n100_), .b(new_n89_), .c(new_n60_), .d(new_n80_), .O(new_n101_));
  ...
  nor2   g061(.a(new_n98_), .b(new_n96_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n81_), .c(new_n105_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n90_), .c(new_n80_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n58_), .c(new_n45_), .O(z6));
  ...
  nor4   g070(.a(new_n114_), .b(new_n59_), .c(new_n79_), .d(new_n58_), .O(new_n115_));
  ...
  aoi22  g095(.a(new_n139_), .b(new_n81_), .c(new_n105_), .d(new_n98_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  nand3  g099(.a(new_n107_), .b(x30), .c(new_n81_), .O(new_n144_));
  nand2  g100(.a(new_n96_), .b(new_n81_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n105_), .c(x29), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g103(.a(x19), .b(new_n129_), .c(x13), .O(new_n148_));
  nand3  g104(.a(new_n130_), .b(x18), .c(x14), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n148_), .c(new_n126_), .O(new_n150_));
  nand4  g106(.a(x19), .b(x18), .c(new_n126_), .d(x12), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n150_), .c(x16), .O(new_n153_));
  inv1   g109(.a(new_n118_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n121_), .c(x11), .O(new_n155_));
  ...
  nand4  g116(.a(new_n160_), .b(new_n147_), .c(new_n143_), .d(x31), .O(new_n161_));
  ...
  nand2  g120(.a(new_n130_), .b(x14), .O(new_n165_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n133_), .c(new_n130_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n117_), .c(new_n158_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n168_), .b(new_n171_), .c(new_n121_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x12), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(new_n126_), .c(new_n129_), .d(new_n128_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n172_), .c(new_n170_), .d(new_n169_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n167_), .c(new_n45_), .O(new_n176_));
  nand2  g132(.a(new_n145_), .b(x29), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n113_), .c(x30), .O(new_n178_));
  oai21  g134(.a(new_n113_), .b(new_n98_), .c(x30), .O(new_n179_));
  oai21  g135(.a(new_n113_), .b(x28), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n81_), .c(new_n178_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n176_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  aoi21  g139(.a(new_n155_), .b(new_n153_), .c(new_n158_), .O(new_n184_));
  inv1   g140(.a(new_n159_), .O(new_n185_));
  nand3  g141(.a(new_n106_), .b(x31), .c(x30), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nor3   g143(.a(x31), .b(x30), .c(x28), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(new_n81_), .O(new_n189_));
  nand3  g145(.a(new_n113_), .b(new_n105_), .c(new_n98_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  oai21  g147(.a(new_n185_), .b(new_n184_), .c(new_n191_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(x33), .c(new_n183_), .O(new_n193_));
