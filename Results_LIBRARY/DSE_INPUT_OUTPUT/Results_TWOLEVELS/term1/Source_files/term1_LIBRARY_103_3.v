...
module FAU ( 
  ...
  aoi21  g124(.a(new_n116_), .b(x28), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g136(.a(new_n151_), .b(new_n175_), .c(new_n123_), .d(new_n111_), .O(new_n181_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n165_), .c(new_n88_), .O(new_n187_));
  ...
  oai21  g146(.a(new_n85_), .b(new_n160_), .c(new_n82_), .O(new_n191_));
  nand2  g147(.a(new_n85_), .b(new_n162_), .O(new_n192_));
  ...
  nand2  g153(.a(new_n197_), .b(new_n79_), .O(new_n198_));
