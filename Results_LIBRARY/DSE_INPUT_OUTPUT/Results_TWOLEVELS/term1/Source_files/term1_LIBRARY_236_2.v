...
module FAU ( 
  ...
  oai21  g073(.a(x31), .b(x04), .c(new_n45_), .O(new_n118_));
  ...
  oai21  g098(.a(x30), .b(new_n128_), .c(new_n142_), .O(new_n143_));
  ...
  nand2  g102(.a(new_n103_), .b(new_n81_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n45_), .c(new_n128_), .O(new_n149_));
  ...
  nand4  g110(.a(new_n147_), .b(new_n45_), .c(x29), .d(new_n128_), .O(new_n155_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n144_), .c(new_n90_), .O(new_n178_));
  ...
  nand3  g142(.a(new_n147_), .b(new_n123_), .c(x29), .O(new_n187_));
  oai21  g143(.a(new_n123_), .b(x30), .c(new_n187_), .O(new_n188_));
  nor2   g144(.a(new_n123_), .b(new_n102_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n147_), .c(new_n45_), .O(new_n190_));
  aoi21  g146(.a(new_n188_), .b(new_n128_), .c(new_n190_), .O(new_n191_));
  ...
  nand4  g151(.a(new_n148_), .b(new_n123_), .c(new_n45_), .d(new_n128_), .O(new_n196_));
