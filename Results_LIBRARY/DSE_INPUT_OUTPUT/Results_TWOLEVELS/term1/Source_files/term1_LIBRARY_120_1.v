...
module FAU ( 
  ...
  nand3  g025(.a(new_n69_), .b(new_n58_), .c(new_n48_), .O(new_n70_));
  ...
  nand3  g032(.a(new_n76_), .b(new_n71_), .c(new_n48_), .O(new_n77_));
  ...
  nor2   g074(.a(new_n112_), .b(new_n103_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n105_), .O(new_n120_));
  ...
  nor2   g084(.a(new_n128_), .b(new_n81_), .O(new_n129_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n112_), .c(x29), .O(new_n134_));
  nor2   g090(.a(new_n132_), .b(new_n103_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n112_), .c(new_n134_), .O(new_n136_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n136_), .c(new_n131_), .d(x31), .O(new_n154_));
  nand2  g110(.a(new_n119_), .b(x27), .O(new_n155_));
  oai21  g111(.a(x30), .b(x27), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n104_), .O(new_n157_));
  ...
  aoi21  g125(.a(new_n119_), .b(x28), .c(new_n169_), .O(new_n170_));
  ...
  nand2  g135(.a(x33), .b(new_n126_), .O(new_n180_));
  ...
  nand4  g139(.a(new_n153_), .b(new_n178_), .c(new_n126_), .d(new_n112_), .O(new_n184_));
  ...
  nand3  g159(.a(new_n203_), .b(new_n45_), .c(x00), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n48_), .O(z9));
endmodule
