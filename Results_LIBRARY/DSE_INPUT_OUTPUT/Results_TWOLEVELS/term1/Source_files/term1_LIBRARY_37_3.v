...
module FAU ( 
  ...
  aoi21  g055(.a(new_n99_), .b(new_n98_), .c(new_n81_), .O(new_n100_));
  nand4  g056(.a(new_n99_), .b(new_n97_), .c(x28), .d(x27), .O(new_n101_));
  ...
  nand4  g060(.a(new_n99_), .b(x29), .c(x28), .d(x27), .O(new_n105_));
  oai21  g061(.a(new_n99_), .b(x27), .c(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n90_), .c(new_n80_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n96_), .c(new_n59_), .O(z6));
  inv1   g064(.a(new_n86_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n85_), .c(new_n83_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand3  g067(.a(new_n45_), .b(new_n111_), .c(new_n80_), .O(new_n112_));
  nor4   g068(.a(new_n112_), .b(new_n60_), .c(new_n96_), .d(new_n59_), .O(new_n113_));
  oai21  g069(.a(new_n110_), .b(new_n87_), .c(new_n113_), .O(z7));
  inv1   g070(.a(x32), .O(new_n115_));
  aoi21  g071(.a(new_n99_), .b(x28), .c(x27), .O(new_n116_));
  nor2   g072(.a(new_n97_), .b(new_n98_), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n99_), .c(new_n116_), .d(new_n97_), .O(new_n118_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n118_), .c(new_n115_), .d(x31), .O(new_n137_));
  oai21  g093(.a(x28), .b(x27), .c(x29), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n99_), .O(new_n139_));
  nand2  g095(.a(x16), .b(x10), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n129_), .c(new_n134_), .O(new_n141_));
  nor2   g097(.a(new_n122_), .b(new_n120_), .O(new_n142_));
  ...
  oai21  g102(.a(new_n122_), .b(new_n146_), .c(new_n120_), .O(new_n147_));
  inv1   g103(.a(x14), .O(new_n148_));
  nand2  g104(.a(new_n122_), .b(new_n148_), .O(new_n149_));
  nand3  g105(.a(new_n130_), .b(x16), .c(x15), .O(new_n150_));
  nor2   g106(.a(new_n99_), .b(new_n97_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(x28), .c(new_n111_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n150_), .c(new_n149_), .d(new_n147_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n145_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n144_), .c(new_n141_), .d(new_n139_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n137_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n80_), .c(x00), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n45_), .O(z8));
  nand2  g115(.a(new_n122_), .b(x14), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(x18), .c(x17), .d(x16), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n134_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x15), .O(new_n163_));
  nand2  g119(.a(x18), .b(x17), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n163_), .c(new_n122_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n140_), .c(new_n134_), .O(new_n166_));
  inv1   g122(.a(x11), .O(new_n167_));
  oai21  g123(.a(new_n164_), .b(new_n167_), .c(new_n128_), .O(new_n168_));
  nand2  g124(.a(x18), .b(x12), .O(new_n169_));
  aoi22  g125(.a(new_n169_), .b(new_n119_), .c(new_n120_), .d(new_n146_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n168_), .c(new_n166_), .d(new_n165_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n162_), .c(new_n45_), .O(new_n172_));
  aoi21  g128(.a(new_n138_), .b(new_n111_), .c(x30), .O(new_n173_));
  nand2  g129(.a(new_n111_), .b(x30), .O(new_n174_));
  oai21  g130(.a(new_n117_), .b(new_n111_), .c(new_n174_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n81_), .c(new_n173_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x33), .O(new_n178_));
  aoi21  g134(.a(new_n131_), .b(new_n127_), .c(new_n134_), .O(new_n179_));
  inv1   g135(.a(new_n135_), .O(new_n180_));
  nand3  g136(.a(new_n117_), .b(x31), .c(x30), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nor3   g138(.a(x31), .b(x30), .c(x28), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n182_), .c(new_n81_), .O(new_n184_));
  nand3  g140(.a(new_n111_), .b(new_n99_), .c(new_n97_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  oai21  g142(.a(new_n180_), .b(new_n179_), .c(new_n186_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(x33), .c(new_n178_), .O(new_n188_));
