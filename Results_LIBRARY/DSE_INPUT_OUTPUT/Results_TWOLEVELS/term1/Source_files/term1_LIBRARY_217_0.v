...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n61_), .c(x30), .d(new_n81_), .O(new_n95_));
  ...
  nand3  g055(.a(x30), .b(x28), .c(new_n81_), .O(new_n100_));
  ...
  nand2  g063(.a(new_n107_), .b(new_n81_), .O(new_n108_));
  oai21  g064(.a(new_n104_), .b(new_n81_), .c(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n99_), .c(new_n59_), .O(z5));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x30), .O(new_n113_));
  nand2  g069(.a(x28), .b(x27), .O(new_n114_));
  nand2  g070(.a(new_n106_), .b(x29), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n113_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n99_), .c(new_n59_), .O(z6));
  inv1   g074(.a(x31), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x30), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n81_), .O(new_n121_));
  nand2  g077(.a(new_n107_), .b(x28), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x31), .O(new_n123_));
  nand4  g079(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n124_));
  nor2   g080(.a(new_n60_), .b(new_n59_), .O(new_n125_));
  inv1   g081(.a(new_n120_), .O(new_n126_));
  ...
  nand4  g085(.a(new_n129_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(z7));
  ...
  oai21  g095(.a(new_n136_), .b(new_n139_), .c(new_n85_), .O(new_n140_));
  ...
  inv1   g104(.a(x28), .O(new_n149_));
  nand2  g105(.a(new_n107_), .b(new_n149_), .O(new_n150_));
  oai21  g106(.a(x30), .b(x29), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x27), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n148_), .c(new_n145_), .d(new_n122_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x32), .O(new_n154_));
  inv1   g110(.a(x32), .O(new_n155_));
  aoi21  g111(.a(new_n149_), .b(new_n81_), .c(new_n105_), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n106_), .c(new_n115_), .d(new_n81_), .O(new_n157_));
  ...
  nand4  g125(.a(new_n169_), .b(new_n157_), .c(new_n155_), .d(x31), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n154_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n80_), .c(x00), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(z8));
  nand4  g129(.a(x33), .b(new_n149_), .c(new_n80_), .d(x00), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x30), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n81_), .O(new_n176_));
  aoi21  g132(.a(new_n165_), .b(new_n163_), .c(new_n131_), .O(new_n177_));
  inv1   g133(.a(new_n168_), .O(new_n178_));
  nand2  g134(.a(new_n149_), .b(new_n81_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x31), .c(x30), .d(x29), .O(new_n180_));
  nand3  g136(.a(new_n119_), .b(new_n106_), .c(new_n105_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n177_), .c(new_n182_), .O(new_n183_));
  nand2  g139(.a(new_n91_), .b(x14), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x18), .c(x17), .d(x16), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n131_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x17), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n146_), .c(new_n91_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n132_), .c(new_n131_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  oai21  g146(.a(new_n187_), .b(new_n190_), .c(new_n135_), .O(new_n191_));
  aoi21  g147(.a(x18), .b(x12), .c(x17), .O(new_n192_));
  inv1   g148(.a(x13), .O(new_n193_));
  nand2  g149(.a(new_n88_), .b(new_n193_), .O(new_n194_));
  nand2  g150(.a(x31), .b(new_n105_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n120_), .d(new_n115_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n192_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n191_), .c(new_n189_), .d(new_n188_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n186_), .c(x33), .O(new_n199_));
  oai21  g155(.a(new_n183_), .b(x33), .c(new_n199_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n80_), .c(x00), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n176_), .O(z9));
endmodule
