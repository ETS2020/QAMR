...
module FAU ( 
  ...
  aoi21  g060(.a(x30), .b(new_n104_), .c(new_n45_), .O(new_n105_));
  nand4  g061(.a(x30), .b(new_n103_), .c(x28), .d(x27), .O(new_n106_));
  ...
  nor3   g064(.a(new_n108_), .b(new_n101_), .c(new_n60_), .O(z5));
  nand2  g065(.a(x30), .b(new_n45_), .O(new_n110_));
  aoi21  g066(.a(x30), .b(new_n103_), .c(new_n104_), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n45_), .c(new_n110_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n102_), .c(new_n62_), .d(new_n81_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x25), .c(x01), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n48_), .O(z6));
  ...
  nand4  g082(.a(new_n126_), .b(new_n124_), .c(new_n122_), .d(new_n120_), .O(z7));
  nand4  g083(.a(x32), .b(x29), .c(new_n81_), .d(x00), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x30), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x27), .O(new_n130_));
  ...
  nand3  g090(.a(new_n134_), .b(x29), .c(x28), .O(new_n135_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n136_), .c(new_n131_), .d(x31), .O(new_n152_));
  nand2  g108(.a(new_n121_), .b(new_n134_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n144_), .c(new_n149_), .O(new_n155_));
  nand2  g111(.a(x19), .b(x18), .O(new_n156_));
  nand2  g112(.a(x17), .b(x11), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n143_), .O(new_n158_));
  inv1   g114(.a(x12), .O(new_n159_));
  oai21  g115(.a(new_n156_), .b(new_n159_), .c(new_n84_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n90_), .b(new_n161_), .c(new_n87_), .O(new_n162_));
  nor2   g118(.a(x19), .b(x14), .O(new_n163_));
  nand2  g119(.a(x16), .b(x15), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n144_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nor2   g122(.a(new_n104_), .b(x27), .O(new_n167_));
  nor2   g123(.a(new_n134_), .b(new_n103_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n117_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n166_), .c(new_n162_), .d(new_n160_), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n158_), .c(new_n155_), .d(new_n153_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x32), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n152_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n81_), .c(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n130_), .O(z8));
  aoi21  g132(.a(new_n146_), .b(new_n142_), .c(new_n149_), .O(new_n177_));
  inv1   g133(.a(new_n150_), .O(new_n178_));
  oai21  g134(.a(new_n134_), .b(new_n104_), .c(new_n45_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(x31), .c(x29), .O(new_n180_));
  nand3  g136(.a(new_n121_), .b(new_n117_), .c(new_n134_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n177_), .c(new_n182_), .O(new_n183_));
  nand2  g139(.a(new_n90_), .b(x14), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x18), .c(x17), .d(x16), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n149_), .O(new_n186_));
  nand2  g142(.a(new_n132_), .b(x31), .O(new_n187_));
  nor2   g143(.a(new_n87_), .b(new_n84_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n164_), .c(new_n90_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n154_), .c(new_n149_), .O(new_n191_));
  aoi21  g147(.a(new_n188_), .b(x11), .c(x16), .O(new_n192_));
  oai21  g148(.a(new_n87_), .b(new_n159_), .c(new_n84_), .O(new_n193_));
  nand2  g149(.a(new_n87_), .b(new_n161_), .O(new_n194_));
  nand2  g150(.a(new_n117_), .b(x30), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n193_), .d(new_n135_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n192_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n191_), .c(new_n190_), .d(new_n187_), .O(new_n198_));
