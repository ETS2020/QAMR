...
module FAU ( 
  ...
  nand3  g069(.a(new_n80_), .b(x29), .c(x28), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n93_), .c(new_n60_), .d(x27), .O(new_n116_));
  ...
  nand4  g085(.a(x32), .b(new_n103_), .c(new_n79_), .d(x00), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n80_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n45_), .O(new_n132_));
  inv1   g088(.a(x32), .O(new_n133_));
  nand2  g089(.a(new_n103_), .b(new_n45_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n80_), .c(x29), .O(new_n135_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n137_), .c(new_n133_), .d(x31), .O(new_n153_));
  ...
  nand2  g121(.a(new_n80_), .b(new_n105_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n124_), .c(x31), .O(new_n167_));
  ...
  nand2  g128(.a(new_n172_), .b(new_n132_), .O(z8));
  nand2  g129(.a(new_n90_), .b(x14), .O(new_n174_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n164_), .c(new_n90_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n154_), .c(new_n150_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n144_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n84_), .c(new_n87_), .d(new_n162_), .O(new_n183_));
  ...
  oai21  g141(.a(x31), .b(new_n105_), .c(new_n136_), .O(new_n186_));
  aoi21  g142(.a(new_n112_), .b(new_n120_), .c(x30), .O(new_n187_));
  ...
  aoi21  g146(.a(new_n147_), .b(new_n143_), .c(new_n150_), .O(new_n191_));
  inv1   g147(.a(new_n151_), .O(new_n192_));
  nand2  g148(.a(new_n134_), .b(x29), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n120_), .c(new_n80_), .O(new_n194_));
