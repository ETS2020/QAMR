...
module FAU ( 
  ...
  nor2   g129(.a(new_n173_), .b(new_n165_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x17), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n140_), .c(new_n88_), .O(new_n176_));
  oai21  g132(.a(new_n175_), .b(new_n127_), .c(new_n165_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n175_), .b(new_n178_), .c(new_n131_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x12), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n82_), .c(new_n85_), .d(new_n137_), .O(new_n181_));
  ...
  oai21  g140(.a(new_n45_), .b(new_n101_), .c(x31), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n117_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n100_), .c(new_n184_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n183_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  aoi21  g145(.a(new_n162_), .b(new_n160_), .c(new_n165_), .O(new_n190_));
  inv1   g146(.a(new_n166_), .O(new_n191_));
  nand4  g147(.a(new_n120_), .b(new_n116_), .c(new_n45_), .d(new_n100_), .O(new_n192_));
  nand2  g148(.a(new_n101_), .b(new_n100_), .O(new_n193_));
