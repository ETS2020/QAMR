...
module FAU ( 
  ...
  aoi21  g041(.a(new_n85_), .b(x23), .c(x26), .O(z3));
  inv1   g042(.a(x26), .O(new_n87_));
  xnor2a g043(.a(x28), .b(x27), .O(new_n88_));
  nor3   g044(.a(new_n88_), .b(new_n83_), .c(new_n59_), .O(new_n89_));
  nand4  g045(.a(new_n89_), .b(new_n87_), .c(x25), .d(x23), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(new_n58_), .O(z4));
  inv1   g047(.a(x28), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(new_n79_), .O(new_n93_));
  inv1   g049(.a(new_n93_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x29), .O(new_n95_));
  inv1   g051(.a(x29), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(x28), .c(x27), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n95_), .c(new_n83_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n60_), .c(x25), .d(x01), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(x23), .c(x26), .O(z5));
  nand3  g056(.a(x29), .b(x28), .c(x27), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(x30), .O(new_n102_));
  inv1   g058(.a(x30), .O(new_n103_));
  nand3  g059(.a(new_n93_), .b(new_n103_), .c(x29), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n83_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n60_), .c(new_n87_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(x25), .c(x23), .d(x01), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(z6));
  nand3  g065(.a(new_n93_), .b(x30), .c(x29), .O(new_n110_));
  ...
  nand3  g070(.a(new_n60_), .b(x25), .c(x01), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x30), .c(x29), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n94_), .c(new_n56_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(x26), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n116_), .c(new_n114_), .d(new_n111_), .O(z7));
  nand2  g077(.a(new_n92_), .b(new_n79_), .O(new_n122_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n123_), .c(x31), .d(new_n103_), .O(new_n142_));
  ...
  aoi21  g108(.a(new_n152_), .b(new_n135_), .c(x15), .O(new_n153_));
  nor2   g109(.a(new_n127_), .b(new_n125_), .O(new_n154_));
  ...
  oai21  g115(.a(new_n127_), .b(new_n159_), .c(new_n125_), .O(new_n160_));
  nor2   g116(.a(x19), .b(x14), .O(new_n161_));
  nand2  g117(.a(x16), .b(x15), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n134_), .c(x31), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n161_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n160_), .c(new_n158_), .d(new_n156_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n153_), .c(x32), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n150_), .c(new_n145_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n87_), .c(x23), .d(x00), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n141_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n117_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n122_), .c(x29), .O(new_n174_));
  nand4  g130(.a(new_n141_), .b(new_n170_), .c(new_n117_), .d(new_n103_), .O(new_n175_));
  ...
  aoi21  g134(.a(new_n127_), .b(x14), .c(new_n125_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x17), .c(x16), .d(x15), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n162_), .c(new_n127_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n151_), .c(new_n139_), .O(new_n183_));
  inv1   g139(.a(x11), .O(new_n184_));
  oai21  g140(.a(new_n181_), .b(new_n184_), .c(new_n133_), .O(new_n185_));
  nand2  g141(.a(x18), .b(x12), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n124_), .O(new_n187_));
  nand2  g143(.a(new_n125_), .b(new_n159_), .O(new_n188_));
  ...
  nand3  g149(.a(new_n193_), .b(new_n178_), .c(new_n174_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n87_), .c(x23), .d(x00), .O(new_n195_));
