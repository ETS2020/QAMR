...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n107_), .b(new_n83_), .c(new_n82_), .O(new_n108_));
  inv1   g064(.a(x30), .O(new_n109_));
  nor2   g065(.a(new_n86_), .b(new_n84_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n90_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n109_), .c(x29), .d(x28), .O(new_n112_));
  ...
  and2   g071(.a(new_n115_), .b(new_n111_), .O(new_n116_));
  nor3   g072(.a(x27), .b(x21), .c(x16), .O(new_n117_));
  aoi21  g073(.a(new_n116_), .b(x30), .c(new_n117_), .O(new_n118_));
  ...
  nand2  g079(.a(new_n115_), .b(x31), .O(new_n124_));
  inv1   g080(.a(new_n88_), .O(new_n125_));
  inv1   g081(.a(new_n89_), .O(new_n126_));
  nand3  g082(.a(new_n110_), .b(new_n126_), .c(new_n125_), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x16), .O(new_n129_));
  ...
  oai21  g090(.a(new_n134_), .b(new_n128_), .c(x21), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n133_), .c(new_n123_), .O(z7));
  nand2  g092(.a(new_n98_), .b(new_n81_), .O(new_n137_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n82_), .c(x11), .O(new_n151_));
  ...
  nand3  g113(.a(x32), .b(new_n109_), .c(x21), .O(new_n158_));
  ...
  nand2  g117(.a(new_n98_), .b(new_n81_), .O(new_n162_));
  ...
  nand2  g121(.a(new_n143_), .b(x14), .O(new_n166_));
  ...
  nand2  g138(.a(new_n182_), .b(new_n57_), .O(z8));
  nor2   g139(.a(new_n177_), .b(new_n176_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n175_), .c(new_n173_), .d(new_n171_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n168_), .c(new_n57_), .O(new_n186_));
  inv1   g142(.a(new_n134_), .O(new_n187_));
  nand3  g143(.a(new_n137_), .b(new_n130_), .c(x29), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nor2   g145(.a(new_n130_), .b(new_n100_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n137_), .c(new_n109_), .O(new_n191_));
  aoi21  g147(.a(new_n189_), .b(x21), .c(new_n191_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n186_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand4  g150(.a(new_n138_), .b(new_n130_), .c(new_n109_), .d(x21), .O(new_n195_));
  nand4  g151(.a(new_n137_), .b(x31), .c(x30), .d(x29), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n156_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(x33), .c(new_n194_), .O(new_n199_));
