...
module FAU ( 
  ...
  oai21  g065(.a(new_n104_), .b(new_n109_), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n45_), .b(x27), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n101_), .c(new_n61_), .d(new_n81_), .O(new_n112_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n82_), .c(x31), .O(new_n121_));
  ...
  oai21  g096(.a(new_n104_), .b(new_n82_), .c(new_n140_), .O(new_n141_));
  ...
  inv1   g118(.a(new_n129_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n131_), .c(x11), .O(new_n164_));
  ...
  aoi21  g128(.a(new_n164_), .b(new_n162_), .c(new_n127_), .O(new_n173_));
  inv1   g129(.a(new_n167_), .O(new_n174_));
  oai21  g130(.a(new_n45_), .b(new_n109_), .c(new_n82_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(x31), .c(x29), .O(new_n176_));
  nand3  g132(.a(new_n120_), .b(new_n116_), .c(new_n45_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  oai21  g134(.a(new_n174_), .b(new_n173_), .c(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n90_), .b(x14), .O(new_n180_));
  ...
  nor2   g140(.a(new_n87_), .b(new_n84_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n142_), .c(new_n90_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n128_), .c(new_n127_), .O(new_n188_));
  aoi21  g144(.a(new_n185_), .b(x11), .c(x16), .O(new_n189_));
  oai21  g145(.a(new_n87_), .b(new_n135_), .c(new_n84_), .O(new_n190_));
  inv1   g146(.a(x13), .O(new_n191_));
  nand2  g147(.a(new_n87_), .b(new_n191_), .O(new_n192_));
  nand2  g148(.a(new_n116_), .b(x30), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n192_), .c(new_n190_), .d(new_n153_), .O(new_n194_));
