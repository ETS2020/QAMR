...
module FAU ( 
  ...
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n46_), .O(new_n121_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n134_), .c(new_n129_), .d(x31), .O(new_n151_));
  aoi21  g107(.a(new_n136_), .b(x14), .c(new_n87_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(x17), .c(x16), .d(x15), .O(new_n153_));
  nand2  g109(.a(x30), .b(x29), .O(new_n154_));
  nand2  g110(.a(new_n111_), .b(new_n105_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x27), .O(new_n157_));
  xnor2a g113(.a(x30), .b(x28), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(x29), .c(new_n80_), .O(new_n159_));
  nand4  g115(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n160_));
  nand2  g116(.a(x18), .b(x17), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n148_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n161_), .b(new_n164_), .c(new_n142_), .O(new_n165_));
  ...
  nand3  g124(.a(new_n168_), .b(new_n165_), .c(new_n163_), .O(new_n169_));
  aoi21  g125(.a(new_n160_), .b(new_n136_), .c(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n159_), .c(new_n157_), .d(new_n153_), .O(new_n171_));
  ...
  aoi21  g131(.a(new_n145_), .b(new_n141_), .c(new_n148_), .O(new_n176_));
  inv1   g132(.a(new_n149_), .O(new_n177_));
  nand4  g133(.a(new_n130_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  nand3  g134(.a(new_n132_), .b(new_n122_), .c(new_n111_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n176_), .c(new_n180_), .O(new_n181_));
  xor2a  g137(.a(x31), .b(x28), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n80_), .O(new_n183_));
  nand2  g139(.a(new_n154_), .b(x31), .O(new_n184_));
  nand2  g140(.a(x29), .b(x27), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n111_), .c(x31), .O(new_n186_));
  nand2  g142(.a(new_n160_), .b(new_n136_), .O(new_n187_));
  nor2   g143(.a(new_n167_), .b(new_n166_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n165_), .c(new_n163_), .d(new_n187_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n184_), .c(new_n183_), .d(new_n153_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  oai21  g148(.a(new_n181_), .b(x33), .c(new_n192_), .O(new_n193_));
