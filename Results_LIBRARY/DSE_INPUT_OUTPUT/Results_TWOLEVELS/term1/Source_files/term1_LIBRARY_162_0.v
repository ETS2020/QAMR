...
module FAU ( 
  ...
  nand4  g066(.a(new_n110_), .b(new_n87_), .c(new_n60_), .d(new_n92_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(x25), .c(x01), .d(x00), .O(new_n113_));
  ...
  aoi21  g115(.a(new_n159_), .b(new_n143_), .c(x15), .O(new_n160_));
  ...
  nor3   g124(.a(new_n142_), .b(new_n141_), .c(new_n147_), .O(new_n169_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n92_), .c(x00), .O(new_n174_));
  ...
  nand4  g136(.a(new_n149_), .b(new_n176_), .c(new_n123_), .d(new_n107_), .O(new_n181_));
  ...
  nor3   g141(.a(new_n185_), .b(new_n169_), .c(new_n168_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n167_), .c(new_n165_), .d(new_n163_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n160_), .c(x33), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n184_), .c(new_n180_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n92_), .c(x00), .O(new_n190_));
