...
module FAU ( 
  ...
  nand4  g034(.a(new_n78_), .b(new_n45_), .c(new_n58_), .d(x08), .O(new_n79_));
  ...
  nand2  g059(.a(x30), .b(new_n58_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n103_), .c(x29), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n100_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n91_), .c(new_n81_), .d(x25), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n60_), .O(z5));
  inv1   g064(.a(x25), .O(new_n109_));
  nand2  g065(.a(new_n102_), .b(x29), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x30), .c(x09), .O(new_n111_));
  nand3  g067(.a(new_n102_), .b(new_n45_), .c(x29), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n90_), .c(new_n62_), .d(new_n81_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n109_), .c(new_n60_), .O(z6));
  ...
  oai21  g078(.a(new_n122_), .b(new_n103_), .c(new_n120_), .O(new_n123_));
  aoi22  g079(.a(new_n123_), .b(x09), .c(x31), .d(new_n45_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n118_), .O(z7));
  inv1   g081(.a(x32), .O(new_n126_));
  nand2  g082(.a(new_n101_), .b(new_n82_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n45_), .c(x29), .O(new_n128_));
  aoi21  g084(.a(new_n101_), .b(new_n82_), .c(new_n99_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n45_), .c(new_n128_), .O(new_n130_));
  ...
  nand4  g108(.a(x30), .b(x29), .c(x27), .d(x09), .O(new_n153_));
  ...
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n134_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x10), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n157_), .c(new_n146_), .O(new_n160_));
  inv1   g116(.a(new_n157_), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(x11), .c(x16), .O(new_n162_));
  aoi21  g118(.a(x18), .b(x12), .c(x17), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  nand2  g120(.a(new_n132_), .b(new_n164_), .O(new_n165_));
  nand3  g121(.a(x30), .b(x29), .c(x28), .O(new_n166_));
  nand2  g122(.a(new_n45_), .b(new_n99_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n166_), .c(new_n165_), .d(x31), .O(new_n168_));
  nor3   g124(.a(new_n168_), .b(new_n163_), .c(new_n162_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n160_), .c(new_n158_), .d(new_n155_), .O(new_n170_));
  ...
  inv1   g130(.a(new_n162_), .O(new_n175_));
  aoi21  g131(.a(new_n132_), .b(new_n164_), .c(new_n163_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n175_), .c(new_n160_), .d(new_n158_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n152_), .c(new_n47_), .O(new_n178_));
  or2    g134(.a(new_n129_), .b(x31), .O(new_n179_));
  nand2  g135(.a(new_n121_), .b(x30), .O(new_n180_));
  oai21  g136(.a(new_n129_), .b(new_n121_), .c(new_n180_), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(x09), .c(new_n179_), .d(new_n45_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n178_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  inv1   g140(.a(x33), .O(new_n185_));
  nand4  g141(.a(new_n127_), .b(x31), .c(x30), .d(x29), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n58_), .c(new_n179_), .d(x30), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n148_), .c(new_n185_), .O(new_n188_));
