...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(x29), .c(x27), .O(z3));
  inv1   g048(.a(x25), .O(new_n93_));
  inv1   g049(.a(x28), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x27), .O(new_n95_));
  nand2  g051(.a(x29), .b(x28), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(x27), .c(new_n95_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n90_), .c(new_n80_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n93_), .c(new_n59_), .O(z4));
  xnor2a g055(.a(x29), .b(x28), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(x27), .c(new_n89_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n59_), .c(new_n57_), .O(z5));
  inv1   g059(.a(x27), .O(new_n104_));
  oai21  g060(.a(new_n96_), .b(new_n104_), .c(x30), .O(new_n105_));
  ...
  nand2  g069(.a(new_n113_), .b(new_n83_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n86_), .c(new_n85_), .O(new_n115_));
  ...
  oai22  g075(.a(new_n119_), .b(new_n96_), .c(new_n118_), .d(x29), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x27), .O(new_n121_));
  nand3  g077(.a(x30), .b(x28), .c(x27), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x31), .c(x29), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n121_), .c(new_n117_), .O(z7));
  inv1   g080(.a(x32), .O(new_n125_));
  nand2  g081(.a(new_n94_), .b(new_n104_), .O(new_n126_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(new_n125_), .d(x31), .O(new_n149_));
  aoi21  g105(.a(new_n134_), .b(x14), .c(new_n132_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(x17), .c(x16), .d(x15), .O(new_n151_));
  xnor2a g107(.a(x30), .b(x29), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x27), .O(new_n153_));
  xnor2a g109(.a(x30), .b(x28), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(x29), .c(new_n104_), .O(new_n155_));
  nand4  g111(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n156_));
  nand2  g112(.a(x18), .b(x17), .O(new_n157_));
  nand2  g113(.a(x16), .b(x10), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n146_), .O(new_n159_));
  inv1   g115(.a(x11), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(new_n160_), .c(new_n140_), .O(new_n161_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n161_), .c(new_n159_), .O(new_n165_));
  aoi21  g121(.a(new_n156_), .b(new_n134_), .c(new_n165_), .O(new_n166_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n57_), .O(z8));
  aoi21  g127(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n172_));
  inv1   g128(.a(new_n147_), .O(new_n173_));
  nand4  g129(.a(new_n126_), .b(x31), .c(x30), .d(x29), .O(new_n174_));
  nand3  g130(.a(new_n128_), .b(new_n118_), .c(new_n106_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n172_), .c(new_n176_), .O(new_n177_));
  xor2a  g133(.a(x31), .b(x28), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n104_), .O(new_n179_));
  nand2  g135(.a(x30), .b(x29), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x31), .O(new_n181_));
  nand2  g137(.a(x29), .b(x27), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n106_), .c(x31), .O(new_n183_));
  nand2  g139(.a(new_n156_), .b(new_n134_), .O(new_n184_));
  nor2   g140(.a(new_n163_), .b(new_n162_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n161_), .c(new_n159_), .d(new_n184_), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n183_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n181_), .c(new_n179_), .d(new_n151_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  oai21  g145(.a(new_n177_), .b(x33), .c(new_n189_), .O(new_n190_));
