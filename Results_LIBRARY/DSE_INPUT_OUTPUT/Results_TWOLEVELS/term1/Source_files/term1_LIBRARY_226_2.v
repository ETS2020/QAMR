...
module FAU ( 
  ...
  nor2   g072(.a(new_n97_), .b(new_n98_), .O(new_n117_));
  nand3  g073(.a(new_n99_), .b(new_n116_), .c(x29), .O(new_n118_));
  oai21  g074(.a(new_n117_), .b(new_n116_), .c(new_n118_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x30), .c(x31), .d(new_n45_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n115_), .O(z7));
  nand4  g077(.a(x32), .b(x29), .c(new_n82_), .d(x00), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x30), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x27), .O(new_n124_));
  inv1   g080(.a(x32), .O(new_n125_));
  nor2   g081(.a(x28), .b(x27), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n97_), .c(x30), .O(new_n127_));
  nand3  g083(.a(new_n106_), .b(x29), .c(x28), .O(new_n128_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(new_n125_), .d(x31), .O(new_n148_));
  inv1   g104(.a(new_n117_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n106_), .c(new_n45_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n140_), .c(new_n145_), .O(new_n152_));
  nor2   g108(.a(new_n133_), .b(new_n131_), .O(new_n153_));
  ...
  nand2  g112(.a(x19), .b(x13), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n131_), .O(new_n158_));
  inv1   g114(.a(x14), .O(new_n159_));
  nand2  g115(.a(new_n133_), .b(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n141_), .b(x16), .c(x15), .O(new_n161_));
  nor2   g117(.a(new_n106_), .b(new_n97_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(x28), .c(new_n116_), .O(new_n163_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n124_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  inv1   g127(.a(new_n126_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x31), .c(x30), .d(x29), .O(new_n173_));
  nand3  g129(.a(new_n149_), .b(new_n116_), .c(new_n106_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n147_), .c(new_n171_), .O(new_n176_));
  aoi21  g132(.a(x31), .b(x29), .c(new_n106_), .O(new_n177_));
  oai21  g133(.a(new_n126_), .b(new_n106_), .c(x31), .O(new_n178_));
  nand3  g134(.a(new_n116_), .b(x29), .c(x28), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n161_), .c(new_n160_), .d(new_n158_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n156_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n178_), .c(new_n155_), .d(new_n152_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n177_), .c(x33), .O(new_n183_));
