...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(new_n47_), .c(new_n82_), .O(new_n92_));
  ...
  nand2  g053(.a(x30), .b(new_n45_), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n82_), .c(new_n97_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n91_), .c(new_n81_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n96_), .c(new_n60_), .O(z4));
  inv1   g057(.a(new_n90_), .O(new_n102_));
  xnor2a g058(.a(x29), .b(x27), .O(new_n103_));
  nand2  g059(.a(x30), .b(x29), .O(new_n104_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n62_), .d(new_n81_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n96_), .c(new_n60_), .O(z5));
  nand2  g065(.a(new_n46_), .b(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n98_), .O(new_n111_));
  nand2  g067(.a(x29), .b(x27), .O(new_n112_));
  aoi22  g068(.a(new_n112_), .b(x30), .c(new_n111_), .d(x27), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n90_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n60_), .c(new_n47_), .O(z6));
  nor4   g072(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n83_), .O(new_n117_));
  nand4  g073(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n47_), .O(new_n119_));
  nand2  g075(.a(x31), .b(new_n46_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x30), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n112_), .c(new_n120_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x28), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(x31), .c(x30), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n124_), .c(new_n119_), .O(z7));
  ...
  oai21  g093(.a(new_n133_), .b(new_n136_), .c(new_n137_), .O(new_n138_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n138_), .c(new_n135_), .d(new_n131_), .O(new_n143_));
  oai21  g099(.a(x30), .b(x28), .c(new_n143_), .O(new_n144_));
  inv1   g100(.a(new_n130_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x16), .c(x15), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x31), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n47_), .O(new_n148_));
  inv1   g104(.a(x29), .O(new_n149_));
  nand2  g105(.a(new_n46_), .b(new_n149_), .O(new_n150_));
  oai21  g106(.a(new_n104_), .b(x27), .c(new_n150_), .O(new_n151_));
  aoi22  g107(.a(new_n151_), .b(x28), .c(new_n105_), .d(x27), .O(new_n152_));
  ...
  aoi21  g111(.a(new_n45_), .b(new_n82_), .c(new_n149_), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n46_), .c(new_n110_), .d(new_n45_), .O(new_n157_));
  inv1   g113(.a(x18), .O(new_n158_));
  nand3  g114(.a(x19), .b(new_n158_), .c(x13), .O(new_n159_));
  nand3  g115(.a(new_n140_), .b(x18), .c(x14), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n159_), .c(new_n137_), .O(new_n161_));
  nand4  g117(.a(x19), .b(x18), .c(new_n137_), .d(x12), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n161_), .c(x16), .O(new_n164_));
  nand3  g120(.a(new_n145_), .b(new_n132_), .c(x11), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x15), .O(new_n167_));
  nand4  g123(.a(new_n145_), .b(x16), .c(new_n128_), .d(x10), .O(new_n168_));
  ...
  nand2  g129(.a(new_n81_), .b(x00), .O(new_n174_));
  nand3  g130(.a(x33), .b(x30), .c(new_n82_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n174_), .c(x30), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n45_), .O(new_n177_));
  aoi21  g133(.a(new_n165_), .b(new_n164_), .c(new_n128_), .O(new_n178_));
  inv1   g134(.a(new_n168_), .O(new_n179_));
  nand2  g135(.a(new_n45_), .b(new_n82_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  nand3  g137(.a(new_n121_), .b(new_n46_), .c(new_n149_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(new_n178_), .c(new_n183_), .O(new_n184_));
  inv1   g140(.a(new_n131_), .O(new_n185_));
  inv1   g141(.a(new_n141_), .O(new_n186_));
  nand2  g142(.a(new_n140_), .b(new_n139_), .O(new_n187_));
  nand2  g143(.a(new_n146_), .b(new_n187_), .O(new_n188_));
  nand2  g144(.a(x31), .b(new_n149_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n122_), .c(new_n110_), .O(new_n190_));
  nor2   g146(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n186_), .c(new_n138_), .d(new_n135_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n185_), .c(x33), .O(new_n193_));
  oai21  g149(.a(new_n184_), .b(x33), .c(new_n193_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n81_), .c(x00), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n177_), .O(z9));
endmodule
