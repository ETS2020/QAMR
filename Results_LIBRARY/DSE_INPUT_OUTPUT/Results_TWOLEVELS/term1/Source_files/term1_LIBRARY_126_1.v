...
module FAU ( 
  ...
  nand4  g052(.a(new_n46_), .b(new_n96_), .c(x28), .d(x27), .O(new_n97_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n90_), .c(new_n80_), .d(x25), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n59_), .O(z5));
  inv1   g061(.a(x25), .O(new_n106_));
  nand2  g062(.a(new_n99_), .b(x29), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x30), .c(x04), .O(new_n108_));
  ...
  nor3   g068(.a(new_n112_), .b(new_n106_), .c(new_n59_), .O(z6));
  ...
  aoi22  g077(.a(new_n121_), .b(x04), .c(x31), .d(new_n109_), .O(new_n122_));
  ...
  nand2  g102(.a(new_n98_), .b(new_n81_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(new_n109_), .c(new_n146_), .d(x04), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand3  g108(.a(new_n148_), .b(x30), .c(x04), .O(new_n153_));
  ...
  aoi22  g144(.a(new_n188_), .b(x04), .c(new_n185_), .d(new_n109_), .O(new_n189_));
  ...
  oai22  g150(.a(new_n194_), .b(new_n45_), .c(new_n185_), .d(x30), .O(new_n195_));
