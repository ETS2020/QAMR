...
module FAU ( 
  ...
  aoi21  g078(.a(new_n122_), .b(new_n102_), .c(new_n79_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n118_), .c(new_n80_), .O(new_n125_));
  ...
  oai21  g114(.a(new_n140_), .b(new_n158_), .c(new_n85_), .O(new_n159_));
  ...
  nand2  g131(.a(x33), .b(new_n116_), .O(new_n176_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n116_), .d(new_n111_), .O(new_n180_));
  ...
  oai21  g147(.a(new_n88_), .b(new_n158_), .c(new_n85_), .O(new_n192_));
  nand2  g148(.a(new_n88_), .b(new_n160_), .O(new_n193_));
