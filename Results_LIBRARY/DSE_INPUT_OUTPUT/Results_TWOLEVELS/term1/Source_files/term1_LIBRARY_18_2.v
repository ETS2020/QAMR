...
module FAU ( 
  ...
  inv1   g037(.a(x33), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(x30), .O(new_n83_));
  ...
  nand3  g051(.a(new_n83_), .b(new_n95_), .c(x27), .O(new_n96_));
  nand3  g052(.a(new_n48_), .b(x28), .c(new_n81_), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n94_), .c(new_n60_), .O(z4));
  inv1   g056(.a(x29), .O(new_n101_));
  nor2   g057(.a(new_n95_), .b(new_n81_), .O(new_n102_));
  ...
  nand3  g064(.a(new_n45_), .b(x29), .c(x28), .O(new_n109_));
  nand3  g065(.a(x33), .b(x30), .c(new_n95_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  aoi21  g067(.a(x29), .b(x27), .c(new_n82_), .O(new_n112_));
  aoi22  g068(.a(new_n112_), .b(x30), .c(new_n111_), .d(x27), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n88_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n115_));
  nor2   g071(.a(new_n115_), .b(new_n60_), .O(z6));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n102_), .b(new_n117_), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x33), .O(new_n119_));
  ...
  nor2   g081(.a(new_n85_), .b(new_n84_), .O(new_n126_));
  ...
  nor2   g104(.a(new_n143_), .b(x15), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n145_), .c(x10), .O(new_n150_));
  ...
  and2   g116(.a(x16), .b(x10), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n145_), .c(x15), .O(new_n162_));
  nor2   g118(.a(new_n137_), .b(new_n135_), .O(new_n163_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n144_), .c(x31), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n174_));
  ...
  nand2  g133(.a(new_n177_), .b(new_n48_), .O(z8));
  nand3  g134(.a(new_n156_), .b(new_n151_), .c(new_n82_), .O(new_n179_));
  nor2   g135(.a(new_n131_), .b(new_n82_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(x29), .c(x30), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n117_), .O(new_n183_));
  aoi21  g139(.a(new_n137_), .b(x14), .c(new_n135_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  nand2  g141(.a(new_n122_), .b(x31), .O(new_n186_));
  nand2  g142(.a(x18), .b(x17), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n171_), .c(new_n137_), .O(new_n188_));
  inv1   g144(.a(new_n187_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n161_), .c(x15), .O(new_n190_));
  aoi21  g146(.a(new_n189_), .b(x11), .c(x16), .O(new_n191_));
  aoi21  g147(.a(x18), .b(x12), .c(x17), .O(new_n192_));
  nor2   g148(.a(x18), .b(x13), .O(new_n193_));
  nor4   g149(.a(new_n193_), .b(new_n192_), .c(new_n191_), .d(new_n190_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n188_), .c(new_n186_), .d(new_n185_), .O(new_n195_));
  nor2   g151(.a(new_n45_), .b(x28), .O(new_n196_));
  aoi22  g152(.a(new_n196_), .b(new_n81_), .c(new_n195_), .d(x33), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n183_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n80_), .c(x00), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n48_), .O(z9));
endmodule
