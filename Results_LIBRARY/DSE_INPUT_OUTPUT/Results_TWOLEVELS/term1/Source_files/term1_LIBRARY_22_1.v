...
module FAU ( 
  ...
  nand3  g058(.a(new_n80_), .b(x29), .c(new_n45_), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n45_), .c(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n101_), .c(new_n61_), .d(new_n81_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n100_), .c(new_n59_), .O(z5));
  nand2  g062(.a(x29), .b(x28), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x30), .O(new_n108_));
  nand3  g064(.a(new_n80_), .b(x29), .c(x28), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n101_), .c(new_n61_), .d(x27), .O(new_n111_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(x31), .O(new_n121_));
  inv1   g077(.a(new_n82_), .O(new_n122_));
  nand4  g078(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n61_), .b(new_n81_), .c(x25), .d(x01), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n123_), .c(new_n121_), .d(new_n118_), .O(z7));
  nand4  g082(.a(x32), .b(new_n119_), .c(new_n81_), .d(x00), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n80_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n45_), .O(new_n129_));
  inv1   g085(.a(x32), .O(new_n130_));
  nand2  g086(.a(new_n119_), .b(new_n45_), .O(new_n131_));
  ...
  oai21  g114(.a(new_n155_), .b(new_n158_), .c(new_n83_), .O(new_n159_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n120_), .c(x31), .O(new_n165_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n162_), .c(new_n89_), .O(new_n176_));
  ...
  aoi22  g136(.a(new_n180_), .b(new_n83_), .c(new_n86_), .d(new_n160_), .O(new_n181_));
  ...
  aoi21  g140(.a(new_n107_), .b(new_n115_), .c(x30), .O(new_n185_));
  ...
  nand3  g147(.a(new_n191_), .b(new_n115_), .c(new_n80_), .O(new_n192_));
