...
module FAU ( 
  ...
  oai21  g058(.a(new_n102_), .b(x30), .c(new_n94_), .O(new_n103_));
  ...
  nand4  g070(.a(new_n94_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n114_), .c(new_n62_), .d(new_n81_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x25), .c(x01), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n49_), .O(z5));
  nand2  g075(.a(new_n46_), .b(x29), .O(new_n120_));
  oai22  g076(.a(new_n120_), .b(new_n99_), .c(new_n105_), .d(x24), .O(new_n121_));
  aoi21  g077(.a(x29), .b(x27), .c(new_n46_), .O(new_n122_));
  aoi22  g078(.a(new_n122_), .b(new_n45_), .c(new_n121_), .d(x27), .O(new_n123_));
  inv1   g079(.a(new_n112_), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x30), .O(new_n126_));
  oai21  g082(.a(new_n120_), .b(new_n124_), .c(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n45_), .c(new_n93_), .O(new_n128_));
  oai21  g084(.a(new_n123_), .b(new_n102_), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n60_), .O(z6));
  nand4  g087(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n49_), .O(new_n133_));
  nand2  g089(.a(new_n125_), .b(x31), .O(new_n134_));
  nand3  g090(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n135_));
  ...
  nand3  g099(.a(new_n143_), .b(new_n141_), .c(new_n133_), .O(z7));
  ...
  nor2   g106(.a(new_n93_), .b(new_n88_), .O(new_n151_));
  ...
  nor3   g114(.a(new_n147_), .b(new_n150_), .c(new_n145_), .O(new_n159_));
  nor3   g115(.a(new_n159_), .b(new_n158_), .c(new_n138_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n149_), .c(new_n49_), .O(new_n162_));
  nor2   g118(.a(x28), .b(x27), .O(new_n163_));
  nor3   g119(.a(new_n163_), .b(new_n46_), .c(new_n111_), .O(new_n164_));
  inv1   g120(.a(new_n163_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x29), .O(new_n166_));
  aoi22  g122(.a(new_n166_), .b(new_n46_), .c(new_n164_), .d(new_n45_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n162_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x32), .O(new_n169_));
  inv1   g125(.a(x32), .O(new_n170_));
  nand3  g126(.a(new_n166_), .b(x30), .c(new_n45_), .O(new_n171_));
  nand3  g127(.a(new_n165_), .b(new_n46_), .c(x29), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(x19), .b(new_n88_), .c(x13), .O(new_n174_));
  nand3  g130(.a(new_n93_), .b(x18), .c(x14), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n174_), .c(new_n85_), .O(new_n176_));
  nand4  g132(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n176_), .c(x16), .O(new_n179_));
  inv1   g135(.a(new_n147_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n150_), .c(x11), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x15), .O(new_n183_));
  nand4  g139(.a(new_n180_), .b(x16), .c(new_n145_), .d(x10), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n173_), .c(new_n170_), .d(x31), .O(new_n186_));
  ...
  aoi21  g145(.a(new_n184_), .b(new_n183_), .c(x33), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(x31), .c(x30), .d(new_n45_), .O(new_n191_));
  nand2  g147(.a(x33), .b(new_n138_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n165_), .c(x29), .O(new_n194_));
  inv1   g150(.a(x33), .O(new_n195_));
  nand4  g151(.a(new_n185_), .b(new_n195_), .c(new_n138_), .d(new_n46_), .O(new_n196_));
  nand2  g152(.a(x33), .b(x31), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nor2   g154(.a(new_n159_), .b(new_n158_), .O(new_n199_));
  xnor2a g155(.a(x31), .b(x30), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n199_), .c(new_n157_), .d(new_n155_), .O(new_n201_));
  aoi21  g157(.a(new_n152_), .b(new_n150_), .c(new_n201_), .O(new_n202_));
  aoi21  g158(.a(new_n202_), .b(new_n148_), .c(new_n195_), .O(new_n203_));
  aoi21  g159(.a(new_n198_), .b(new_n166_), .c(new_n203_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(new_n194_), .O(new_n205_));
