...
module FAU ( 
  ...
  nor3   g055(.a(new_n99_), .b(new_n79_), .c(new_n59_), .O(z4));
  inv1   g056(.a(x29), .O(new_n101_));
  nor2   g057(.a(new_n96_), .b(new_n45_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x30), .c(new_n101_), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n101_), .c(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n93_), .c(new_n60_), .d(new_n80_), .O(new_n105_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n93_), .c(new_n60_), .d(x30), .O(new_n110_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n45_), .c(x31), .O(new_n119_));
  nand4  g075(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n120_));
  nand4  g076(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(z7));
  nand2  g079(.a(new_n80_), .b(x00), .O(new_n124_));
  nand3  g080(.a(x32), .b(x29), .c(new_n96_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n124_), .c(x30), .O(new_n126_));
  ...
  nand2  g105(.a(new_n118_), .b(new_n131_), .O(new_n150_));
  ...
  nor2   g117(.a(new_n131_), .b(new_n101_), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(x28), .c(new_n114_), .O(new_n163_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n127_), .O(z8));
  aoi21  g126(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n171_));
  inv1   g127(.a(new_n147_), .O(new_n172_));
  oai21  g128(.a(new_n131_), .b(new_n96_), .c(new_n45_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(x31), .c(x29), .O(new_n174_));
  nand3  g130(.a(new_n118_), .b(new_n114_), .c(new_n131_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n171_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n90_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n146_), .O(new_n180_));
  nand2  g136(.a(new_n129_), .b(x31), .O(new_n181_));
  nor2   g137(.a(new_n87_), .b(new_n84_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(x16), .c(x15), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n90_), .O(new_n184_));
  inv1   g140(.a(new_n182_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n151_), .c(new_n146_), .O(new_n186_));
  nand2  g142(.a(new_n182_), .b(x11), .O(new_n187_));
  nand2  g143(.a(x18), .b(x12), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n84_), .O(new_n189_));
  nand2  g145(.a(new_n87_), .b(new_n157_), .O(new_n190_));
  nand2  g146(.a(new_n114_), .b(x30), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n132_), .O(new_n192_));
  aoi21  g148(.a(new_n187_), .b(new_n140_), .c(new_n192_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n186_), .c(new_n184_), .d(new_n181_), .O(new_n194_));
