...
module FAU ( 
  ...
  aoi21  g001(.a(x29), .b(new_n45_), .c(x32), .O(z0));
  nand2  g002(.a(x29), .b(new_n45_), .O(new_n47_));
  ...
  nor3   g050(.a(new_n94_), .b(new_n45_), .c(new_n58_), .O(z3));
  ...
  nor3   g061(.a(new_n105_), .b(new_n45_), .c(new_n58_), .O(z5));
  ...
  nor3   g068(.a(new_n112_), .b(new_n45_), .c(new_n58_), .O(z6));
  ...
  aoi21  g084(.a(new_n101_), .b(new_n80_), .c(new_n100_), .O(new_n129_));
  ...
  nor2   g116(.a(new_n160_), .b(new_n138_), .O(new_n161_));
  ...
  nor2   g129(.a(new_n173_), .b(new_n143_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x17), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n160_), .c(new_n88_), .O(new_n176_));
  oai21  g132(.a(new_n175_), .b(new_n150_), .c(new_n143_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n175_), .b(new_n178_), .c(new_n137_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x12), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n82_), .c(new_n85_), .d(new_n157_), .O(new_n181_));
  ...
  nand3  g139(.a(new_n127_), .b(new_n121_), .c(x29), .O(new_n184_));
  nand3  g140(.a(x30), .b(new_n101_), .c(new_n80_), .O(new_n185_));
  nand2  g141(.a(x31), .b(new_n109_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n185_), .c(new_n184_), .O(new_n187_));
  nand2  g143(.a(new_n121_), .b(new_n109_), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(new_n100_), .c(new_n187_), .d(x25), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n183_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n140_), .b(new_n136_), .c(new_n143_), .O(new_n192_));
  inv1   g148(.a(new_n144_), .O(new_n193_));
  nand4  g149(.a(new_n127_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  oai21  g150(.a(new_n188_), .b(new_n127_), .c(new_n194_), .O(new_n195_));
  and2   g151(.a(new_n195_), .b(x25), .O(new_n196_));
  nor2   g152(.a(new_n188_), .b(x29), .O(new_n197_));
  oai22  g153(.a(new_n197_), .b(new_n196_), .c(new_n193_), .d(new_n192_), .O(new_n198_));
