...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n81_), .c(new_n45_), .O(new_n95_));
  ...
  inv1   g058(.a(new_n93_), .O(new_n103_));
  xnor2a g059(.a(x29), .b(x28), .O(new_n104_));
  inv1   g060(.a(x29), .O(new_n105_));
  nor2   g061(.a(x30), .b(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n45_), .O(new_n107_));
  oai21  g063(.a(new_n104_), .b(new_n45_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n61_), .d(new_n80_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n102_), .c(new_n59_), .O(z5));
  inv1   g066(.a(x28), .O(new_n111_));
  oai21  g067(.a(new_n105_), .b(new_n111_), .c(x30), .O(new_n112_));
  nand3  g068(.a(new_n106_), .b(x28), .c(x27), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n103_), .c(new_n61_), .d(new_n80_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n46_), .O(z6));
  ...
  oai21  g079(.a(new_n123_), .b(new_n111_), .c(x31), .O(new_n124_));
  inv1   g080(.a(new_n82_), .O(new_n125_));
  nand4  g081(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n125_), .O(new_n126_));
  nand4  g082(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n126_), .c(new_n124_), .d(new_n122_), .O(z7));
  oai21  g085(.a(x29), .b(new_n45_), .c(x30), .O(new_n130_));
  ...
  oai21  g095(.a(new_n136_), .b(new_n139_), .c(new_n83_), .O(new_n140_));
  ...
  oai21  g104(.a(new_n148_), .b(new_n105_), .c(new_n81_), .O(new_n149_));
  oai21  g105(.a(new_n123_), .b(new_n45_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n147_), .b(new_n46_), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n145_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x32), .O(new_n153_));
  inv1   g109(.a(x32), .O(new_n154_));
  inv1   g110(.a(new_n106_), .O(new_n155_));
  nand2  g111(.a(x30), .b(new_n105_), .O(new_n156_));
  and2   g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n45_), .c(new_n155_), .d(new_n111_), .O(new_n158_));
  nand3  g114(.a(x19), .b(new_n86_), .c(x13), .O(new_n159_));
  nand3  g115(.a(new_n89_), .b(x18), .c(x14), .O(new_n160_));
  aoi21  g116(.a(new_n160_), .b(new_n159_), .c(new_n83_), .O(new_n161_));
  nand4  g117(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n161_), .c(x16), .O(new_n164_));
  inv1   g120(.a(new_n133_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n135_), .c(x11), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n164_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x15), .O(new_n168_));
  nand4  g124(.a(new_n165_), .b(x16), .c(new_n131_), .d(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n158_), .c(new_n154_), .d(x31), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n153_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n80_), .c(x00), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(z8));
  aoi21  g130(.a(new_n166_), .b(new_n164_), .c(new_n131_), .O(new_n175_));
  inv1   g131(.a(new_n169_), .O(new_n176_));
  nor2   g132(.a(x30), .b(x29), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n148_), .c(new_n119_), .O(new_n178_));
  nand3  g134(.a(x31), .b(x30), .c(x29), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  oai21  g136(.a(new_n176_), .b(new_n175_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n89_), .b(x14), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(x18), .c(x17), .d(x16), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n131_), .O(new_n184_));
  nor2   g140(.a(new_n148_), .b(x31), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x29), .O(new_n186_));
  nor2   g142(.a(new_n86_), .b(new_n83_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n146_), .c(new_n89_), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n132_), .c(new_n131_), .O(new_n190_));
  aoi21  g146(.a(new_n187_), .b(x11), .c(x16), .O(new_n191_));
  oai21  g147(.a(new_n86_), .b(new_n139_), .c(new_n83_), .O(new_n192_));
  inv1   g148(.a(x13), .O(new_n193_));
  nand2  g149(.a(new_n86_), .b(new_n193_), .O(new_n194_));
  nand2  g150(.a(x31), .b(new_n81_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n192_), .d(new_n156_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n191_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n190_), .c(new_n189_), .d(new_n186_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n184_), .c(x33), .O(new_n199_));
  oai21  g155(.a(new_n181_), .b(x33), .c(new_n199_), .O(new_n200_));
