...
module FAU ( 
  ...
  nand4  g61(.a(new_n105_), .b(new_n96_), .c(new_n61_), .d(new_n92_), .O(new_n106_));
  inv1   g62(.a(new_n106_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(x25), .c(x01), .d(new_n45_), .O(new_n108_));
  inv1   g64(.a(new_n108_), .O(z5));
  oai21  g65(.a(x28), .b(x00), .c(x29), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n80_), .c(x30), .O(new_n111_));
  inv1   g67(.a(x30), .O(new_n112_));
  nand3  g68(.a(new_n103_), .b(new_n112_), .c(x29), .O(new_n113_));
  aoi22  g69(.a(new_n113_), .b(new_n111_), .c(new_n88_), .d(new_n84_), .O(new_n114_));
  nand4  g70(.a(new_n114_), .b(new_n61_), .c(x25), .d(x01), .O(new_n115_));
  aoi21  g71(.a(new_n115_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g72(.a(new_n103_), .b(x30), .c(x29), .O(new_n117_));
  nand2  g73(.a(new_n117_), .b(x31), .O(new_n118_));
  nand4  g74(.a(new_n95_), .b(new_n94_), .c(new_n93_), .d(new_n84_), .O(new_n119_));
  nor2   g75(.a(new_n81_), .b(new_n60_), .O(new_n120_));
