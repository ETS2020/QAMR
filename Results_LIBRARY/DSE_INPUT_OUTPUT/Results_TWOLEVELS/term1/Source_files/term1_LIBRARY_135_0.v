...
module FAU ( 
  ...
  nand3  g049(.a(x30), .b(x28), .c(new_n93_), .O(new_n94_));
  oai21  g050(.a(x28), .b(new_n93_), .c(new_n94_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n89_), .c(new_n79_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n92_), .c(new_n58_), .O(z4));
  inv1   g053(.a(x28), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n93_), .c(x29), .O(new_n99_));
  inv1   g055(.a(x29), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(x28), .c(x27), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n99_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n87_), .c(new_n60_), .d(new_n79_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n107_), .b(x29), .c(x27), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(x27), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x28), .O(new_n110_));
  oai21  g066(.a(new_n100_), .b(new_n98_), .c(x30), .O(new_n111_));
  ...
  nor4   g070(.a(new_n85_), .b(new_n84_), .c(new_n82_), .d(new_n80_), .O(new_n115_));
  nand4  g071(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n56_), .O(new_n117_));
  nand2  g073(.a(x31), .b(new_n107_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nor2   g075(.a(new_n100_), .b(new_n98_), .O(new_n120_));
  ...
  aoi21  g095(.a(new_n138_), .b(new_n137_), .c(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n136_), .c(new_n133_), .d(new_n129_), .O(new_n141_));
  oai21  g097(.a(x30), .b(x27), .c(new_n141_), .O(new_n142_));
  inv1   g098(.a(new_n128_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x16), .c(x15), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x31), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n56_), .O(new_n146_));
  nor2   g102(.a(new_n107_), .b(new_n100_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n98_), .O(new_n148_));
  oai21  g104(.a(x30), .b(x29), .c(new_n148_), .O(new_n149_));
  aoi22  g105(.a(new_n149_), .b(x27), .c(new_n147_), .d(x28), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n146_), .c(new_n142_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(x32), .O(new_n153_));
  aoi21  g109(.a(new_n98_), .b(new_n93_), .c(new_n100_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n107_), .c(new_n108_), .O(new_n155_));
  inv1   g111(.a(x18), .O(new_n156_));
  nand3  g112(.a(x19), .b(new_n156_), .c(x13), .O(new_n157_));
  nand3  g113(.a(new_n138_), .b(x18), .c(x14), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(new_n135_), .O(new_n159_));
  nand4  g115(.a(x19), .b(x18), .c(new_n135_), .d(x12), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(x16), .O(new_n162_));
  nand3  g118(.a(new_n143_), .b(new_n130_), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x15), .O(new_n165_));
  nand4  g121(.a(new_n143_), .b(x16), .c(new_n126_), .d(x10), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n165_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n155_), .c(new_n153_), .d(x31), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n152_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n79_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  nand2  g127(.a(new_n79_), .b(x00), .O(new_n172_));
  nand3  g128(.a(x33), .b(x30), .c(new_n98_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n172_), .c(x30), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n93_), .O(new_n175_));
  aoi21  g131(.a(new_n163_), .b(new_n162_), .c(new_n126_), .O(new_n176_));
  inv1   g132(.a(new_n166_), .O(new_n177_));
  nand2  g133(.a(new_n98_), .b(new_n93_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand3  g135(.a(new_n119_), .b(new_n107_), .c(new_n100_), .O(new_n180_));
  ...
  inv1   g139(.a(new_n139_), .O(new_n184_));
  nand2  g140(.a(new_n138_), .b(new_n137_), .O(new_n185_));
  nand2  g141(.a(new_n144_), .b(new_n185_), .O(new_n186_));
  nand2  g142(.a(x30), .b(new_n100_), .O(new_n187_));
  nand2  g143(.a(new_n119_), .b(x29), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n187_), .c(new_n118_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n186_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n184_), .c(new_n136_), .d(new_n133_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n183_), .c(x33), .O(new_n192_));
  oai21  g148(.a(new_n182_), .b(x33), .c(new_n192_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n79_), .c(x00), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n175_), .O(z9));
endmodule
