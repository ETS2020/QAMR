...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n61_), .c(new_n45_), .d(new_n81_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n80_), .c(new_n60_), .O(z3));
  inv1   g052(.a(x28), .O(new_n97_));
  inv1   g053(.a(x30), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(x28), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x27), .O(new_n100_));
  oai21  g056(.a(new_n97_), .b(x27), .c(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n94_), .c(new_n61_), .d(new_n81_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n80_), .c(new_n60_), .O(z4));
  oai21  g059(.a(new_n99_), .b(new_n45_), .c(x29), .O(new_n104_));
  nor2   g060(.a(new_n98_), .b(x29), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x28), .c(x27), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n104_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n94_), .c(new_n61_), .d(new_n81_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n80_), .c(new_n60_), .O(z5));
  nand3  g065(.a(x29), .b(x28), .c(x27), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n94_), .c(new_n61_), .d(x30), .O(new_n111_));
  ...
  nand3  g071(.a(new_n115_), .b(x29), .c(x28), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x30), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x27), .O(new_n118_));
  nand2  g074(.a(x29), .b(x28), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n45_), .c(x31), .O(new_n120_));
  nand4  g076(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n121_));
  nand4  g077(.a(new_n61_), .b(new_n81_), .c(x25), .d(x01), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(z7));
  ...
  oai21  g089(.a(new_n130_), .b(new_n133_), .c(new_n85_), .O(new_n134_));
  aoi21  g090(.a(x19), .b(x13), .c(x18), .O(new_n135_));
  nor2   g091(.a(x19), .b(x14), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n134_), .c(new_n132_), .d(new_n128_), .O(new_n138_));
  oai21  g094(.a(new_n105_), .b(new_n45_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(x16), .b(x15), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n127_), .c(x31), .O(new_n141_));
  inv1   g097(.a(x29), .O(new_n142_));
  oai21  g098(.a(x28), .b(x27), .c(x30), .O(new_n143_));
  nand3  g099(.a(new_n119_), .b(new_n98_), .c(new_n45_), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(new_n142_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n141_), .b(new_n47_), .c(new_n145_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n139_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  inv1   g104(.a(x32), .O(new_n149_));
  inv1   g105(.a(new_n105_), .O(new_n150_));
  nand3  g106(.a(new_n98_), .b(x29), .c(x28), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n99_), .c(new_n45_), .O(new_n153_));
  ...
  inv1   g116(.a(new_n127_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n129_), .c(x11), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n160_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x15), .O(new_n164_));
  nand4  g120(.a(new_n161_), .b(x16), .c(new_n125_), .d(x10), .O(new_n165_));
  ...
  aoi21  g126(.a(new_n162_), .b(new_n160_), .c(new_n125_), .O(new_n171_));
  inv1   g127(.a(new_n165_), .O(new_n172_));
  oai21  g128(.a(new_n98_), .b(new_n97_), .c(new_n45_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(x31), .c(x29), .O(new_n174_));
  nand3  g130(.a(new_n119_), .b(new_n115_), .c(new_n98_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n171_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n91_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n125_), .O(new_n180_));
  oai21  g136(.a(x28), .b(x27), .c(x29), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x31), .O(new_n182_));
  nor2   g138(.a(new_n88_), .b(new_n85_), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n140_), .c(new_n91_), .O(new_n185_));
  oai21  g141(.a(new_n184_), .b(new_n126_), .c(new_n125_), .O(new_n186_));
  aoi21  g142(.a(new_n183_), .b(x11), .c(x16), .O(new_n187_));
  oai21  g143(.a(new_n88_), .b(new_n133_), .c(new_n85_), .O(new_n188_));
  inv1   g144(.a(x13), .O(new_n189_));
  nand2  g145(.a(new_n88_), .b(new_n189_), .O(new_n190_));
  nand2  g146(.a(new_n115_), .b(x30), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n188_), .d(new_n151_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n187_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n186_), .c(new_n185_), .d(new_n182_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n180_), .c(x33), .O(new_n195_));
  oai21  g151(.a(new_n177_), .b(x33), .c(new_n195_), .O(new_n196_));
