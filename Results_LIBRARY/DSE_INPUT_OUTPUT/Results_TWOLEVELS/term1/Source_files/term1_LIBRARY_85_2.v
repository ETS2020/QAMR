...
module FAU ( 
  ...
  aoi21  g060(.a(x30), .b(new_n96_), .c(new_n104_), .O(new_n105_));
  ...
  nor3   g064(.a(new_n108_), .b(new_n101_), .c(new_n58_), .O(z5));
  nand3  g065(.a(x29), .b(x28), .c(x27), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n102_), .c(new_n60_), .d(x30), .O(new_n111_));
  ...
  nand2  g081(.a(new_n79_), .b(x00), .O(new_n126_));
  nand3  g082(.a(x32), .b(x29), .c(new_n96_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n126_), .c(x30), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x27), .O(new_n129_));
  inv1   g085(.a(x32), .O(new_n130_));
  nor2   g086(.a(x28), .b(x27), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n103_), .c(x30), .O(new_n132_));
  nand3  g088(.a(new_n45_), .b(x29), .c(x28), .O(new_n133_));
  ...
  oai21  g114(.a(new_n88_), .b(new_n158_), .c(new_n85_), .O(new_n159_));
  inv1   g115(.a(x14), .O(new_n160_));
  nand2  g116(.a(new_n88_), .b(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n143_), .b(x16), .c(x15), .O(new_n162_));
  nor2   g118(.a(new_n45_), .b(new_n103_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(x28), .c(new_n115_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n162_), .c(new_n161_), .d(new_n159_), .O(new_n165_));
  ...
  nor2   g129(.a(new_n173_), .b(new_n147_), .O(new_n174_));
  nand2  g130(.a(x16), .b(x15), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n88_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n152_), .c(new_n147_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n141_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n82_), .c(new_n85_), .d(new_n158_), .O(new_n182_));
  ...
  aoi21  g143(.a(new_n187_), .b(new_n104_), .c(new_n185_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n184_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  aoi21  g146(.a(new_n144_), .b(new_n140_), .c(new_n147_), .O(new_n191_));
  inv1   g147(.a(new_n148_), .O(new_n192_));
  nand4  g148(.a(new_n119_), .b(new_n115_), .c(new_n45_), .d(new_n104_), .O(new_n193_));
  inv1   g149(.a(new_n193_), .O(new_n194_));
  nor4   g150(.a(new_n131_), .b(new_n115_), .c(new_n45_), .d(new_n103_), .O(new_n195_));
