...
module FAU ( 
  ...
  nand4  g057(.a(new_n101_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n98_), .c(new_n60_), .O(z4));
  oai21  g059(.a(new_n99_), .b(new_n81_), .c(x29), .O(new_n104_));
  ...
  nor2   g067(.a(new_n105_), .b(new_n81_), .O(new_n112_));
  nor2   g068(.a(x30), .b(new_n105_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(x27), .O(new_n114_));
  oai21  g070(.a(new_n112_), .b(new_n45_), .c(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n93_), .c(new_n61_), .d(x28), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n80_), .c(x25), .d(x01), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(z6));
  nand3  g075(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n120_));
  nor2   g076(.a(new_n120_), .b(new_n91_), .O(new_n121_));
  nand4  g077(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n121_), .c(new_n48_), .O(new_n123_));
  ...
  aoi21  g083(.a(new_n126_), .b(x28), .c(new_n127_), .O(new_n128_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n88_), .O(new_n141_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n133_), .c(new_n48_), .O(new_n147_));
  nand2  g103(.a(new_n99_), .b(new_n81_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x29), .O(new_n149_));
  nor2   g105(.a(new_n45_), .b(new_n105_), .O(new_n150_));
  aoi22  g106(.a(new_n150_), .b(x28), .c(new_n149_), .d(new_n45_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n147_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x32), .O(new_n153_));
  inv1   g109(.a(x32), .O(new_n154_));
  nor2   g110(.a(new_n45_), .b(x29), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n113_), .c(x28), .O(new_n156_));
  ...
  aoi21  g116(.a(new_n160_), .b(new_n158_), .c(new_n85_), .O(new_n161_));
  ...
  nand3  g120(.a(new_n132_), .b(new_n134_), .c(x11), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x15), .O(new_n167_));
  inv1   g123(.a(x15), .O(new_n168_));
  nand4  g124(.a(new_n132_), .b(x16), .c(new_n168_), .d(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n157_), .c(new_n154_), .d(x31), .O(new_n171_));
  ...
  aoi21  g130(.a(new_n165_), .b(new_n164_), .c(new_n168_), .O(new_n175_));
  inv1   g131(.a(new_n169_), .O(new_n176_));
  aoi22  g132(.a(new_n45_), .b(new_n105_), .c(new_n99_), .d(new_n81_), .O(new_n177_));
  nand3  g133(.a(x31), .b(x30), .c(x29), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(x31), .c(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n175_), .c(new_n179_), .O(new_n180_));
  inv1   g136(.a(new_n133_), .O(new_n181_));
  nand3  g137(.a(new_n148_), .b(new_n124_), .c(x29), .O(new_n182_));
  nor2   g138(.a(new_n143_), .b(new_n131_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n142_), .O(new_n184_));
  nor2   g140(.a(new_n155_), .b(new_n127_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n184_), .c(new_n141_), .d(new_n139_), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n182_), .c(new_n137_), .d(new_n181_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  oai21  g145(.a(new_n180_), .b(x33), .c(new_n189_), .O(new_n190_));
