...
module FAU ( 
  ...
  nor3   g050(.a(new_n94_), .b(new_n80_), .c(new_n60_), .O(z3));
  inv1   g051(.a(x28), .O(new_n96_));
  nand3  g052(.a(x30), .b(new_n96_), .c(x27), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(x27), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n61_), .d(new_n81_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n80_), .c(new_n60_), .O(z4));
  inv1   g056(.a(x29), .O(new_n101_));
  aoi21  g057(.a(x30), .b(new_n96_), .c(new_n45_), .O(new_n102_));
  nand2  g058(.a(x28), .b(x27), .O(new_n103_));
  nand2  g059(.a(x30), .b(new_n101_), .O(new_n104_));
  oai22  g060(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n101_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n93_), .c(new_n61_), .d(new_n81_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n80_), .c(new_n60_), .O(z5));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n93_), .c(new_n61_), .d(x30), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n81_), .c(x25), .d(x01), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(z6));
  nand3  g068(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n91_), .O(new_n114_));
  nand4  g070(.a(new_n61_), .b(new_n81_), .c(x25), .d(x01), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n48_), .O(new_n116_));
  ...
  nand4  g079(.a(x32), .b(x29), .c(new_n81_), .d(x00), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x27), .O(new_n126_));
  inv1   g082(.a(x32), .O(new_n127_));
  nor2   g083(.a(x28), .b(x27), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n101_), .c(x30), .O(new_n129_));
  inv1   g085(.a(x30), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(x29), .c(x28), .O(new_n131_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n132_), .c(new_n127_), .d(x31), .O(new_n149_));
  nand2  g105(.a(new_n117_), .b(new_n130_), .O(new_n150_));
  ...
  nor2   g110(.a(new_n134_), .b(new_n88_), .O(new_n155_));
  ...
  nand2  g117(.a(new_n134_), .b(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n142_), .b(x16), .c(x15), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n162_), .c(x31), .O(new_n164_));
  aoi21  g120(.a(new_n160_), .b(new_n88_), .c(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n159_), .c(new_n157_), .d(new_n154_), .O(new_n166_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n126_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  oai21  g127(.a(new_n130_), .b(new_n96_), .c(new_n45_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(x31), .c(x29), .O(new_n173_));
  nand3  g129(.a(new_n117_), .b(new_n119_), .c(new_n130_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n148_), .c(new_n171_), .O(new_n176_));
  aoi21  g132(.a(x31), .b(x29), .c(new_n130_), .O(new_n177_));
  oai21  g133(.a(new_n128_), .b(new_n130_), .c(x31), .O(new_n178_));
  nand2  g134(.a(new_n160_), .b(new_n88_), .O(new_n179_));
  nand3  g135(.a(new_n119_), .b(x29), .c(x28), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n163_), .c(new_n162_), .d(new_n179_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n158_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n178_), .c(new_n157_), .d(new_n154_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n177_), .c(x33), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n176_), .O(new_n185_));
