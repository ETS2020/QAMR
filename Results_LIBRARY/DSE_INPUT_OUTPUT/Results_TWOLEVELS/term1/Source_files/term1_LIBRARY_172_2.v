...
module FAU ( 
  ...
  aoi21  g054(.a(x30), .b(new_n93_), .c(new_n45_), .O(new_n99_));
  nand2  g055(.a(x28), .b(x27), .O(new_n100_));
  nand2  g056(.a(x30), .b(new_n98_), .O(new_n101_));
  oai22  g057(.a(new_n101_), .b(new_n100_), .c(new_n99_), .d(new_n98_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n92_), .c(new_n59_), .O(z5));
  nand3  g060(.a(x29), .b(x28), .c(x27), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n88_), .c(new_n61_), .d(x30), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n80_), .c(x25), .d(x01), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(z6));
  nor4   g065(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n110_));
  nand4  g066(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n110_), .c(new_n57_), .O(new_n112_));
  ...
  aoi22  g073(.a(new_n117_), .b(x30), .c(x31), .d(new_n45_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n112_), .O(z7));
  nand4  g075(.a(x32), .b(x29), .c(new_n80_), .d(x00), .O(new_n120_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n98_), .c(x30), .O(new_n125_));
  inv1   g081(.a(x30), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(x29), .c(x28), .O(new_n127_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(new_n123_), .d(x31), .O(new_n147_));
  nand2  g103(.a(new_n113_), .b(new_n126_), .O(new_n148_));
  nand3  g104(.a(x30), .b(x29), .c(x28), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n148_), .c(x27), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n139_), .c(new_n144_), .O(new_n152_));
  nor2   g108(.a(new_n132_), .b(new_n130_), .O(new_n153_));
  ...
  nand2  g115(.a(new_n132_), .b(new_n159_), .O(new_n160_));
  nand3  g116(.a(new_n140_), .b(x16), .c(x15), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(x31), .O(new_n162_));
  aoi21  g118(.a(new_n158_), .b(new_n130_), .c(new_n162_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n157_), .c(new_n155_), .d(new_n152_), .O(new_n164_));
  ...
  nand2  g123(.a(new_n167_), .b(new_n122_), .O(z8));
  inv1   g124(.a(x33), .O(new_n169_));
  oai21  g125(.a(new_n126_), .b(new_n93_), .c(new_n45_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(x31), .c(x29), .O(new_n171_));
  nand3  g127(.a(new_n113_), .b(new_n115_), .c(new_n126_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n146_), .c(new_n169_), .O(new_n174_));
  aoi21  g130(.a(x31), .b(x29), .c(new_n126_), .O(new_n175_));
  oai21  g131(.a(new_n124_), .b(new_n126_), .c(x31), .O(new_n176_));
  nand2  g132(.a(new_n158_), .b(new_n130_), .O(new_n177_));
  nand3  g133(.a(new_n115_), .b(x29), .c(x28), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n161_), .c(new_n160_), .d(new_n177_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n156_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n176_), .c(new_n155_), .d(new_n152_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n175_), .c(x33), .O(new_n182_));
