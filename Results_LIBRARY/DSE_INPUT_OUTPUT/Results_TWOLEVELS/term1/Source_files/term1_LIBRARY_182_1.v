...
module FAU ( 
  ...
  nor3   g064(.a(new_n108_), .b(new_n97_), .c(new_n61_), .O(z5));
  ...
  nor3   g071(.a(new_n115_), .b(new_n97_), .c(new_n61_), .O(z6));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(new_n112_), .b(new_n103_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n105_), .c(new_n117_), .O(new_n119_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n105_), .c(new_n97_), .O(new_n125_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n117_), .d(new_n112_), .O(new_n182_));
