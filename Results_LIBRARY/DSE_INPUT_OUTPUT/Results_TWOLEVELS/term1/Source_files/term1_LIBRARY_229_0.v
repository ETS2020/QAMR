...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n199_;
  nor2   g000(.a(x29), .b(x24), .O(new_n45_));
  ...
  nor2   g055(.a(new_n99_), .b(new_n97_), .O(new_n100_));
  nor2   g056(.a(x29), .b(new_n98_), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(x27), .c(new_n100_), .O(new_n102_));
  nor3   g058(.a(new_n84_), .b(new_n83_), .c(new_n82_), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n102_), .c(new_n96_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n59_), .c(new_n47_), .O(z5));
  oai22  g062(.a(new_n103_), .b(x29), .c(new_n99_), .d(new_n86_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x30), .O(new_n108_));
  inv1   g064(.a(x30), .O(new_n109_));
  inv1   g065(.a(new_n85_), .O(new_n110_));
  oai21  g066(.a(new_n103_), .b(new_n97_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n109_), .c(x28), .d(x27), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n108_), .c(new_n60_), .O(new_n113_));
  ...
  nand2  g073(.a(x30), .b(x28), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n81_), .c(x31), .O(new_n119_));
  ...
  nand3  g081(.a(new_n99_), .b(new_n125_), .c(x30), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n124_), .c(new_n119_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x29), .O(new_n128_));
  nor2   g084(.a(new_n125_), .b(x29), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n123_), .c(x24), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n128_), .c(new_n117_), .O(z7));
  nor2   g087(.a(x29), .b(new_n94_), .O(new_n132_));
  ...
  oai21  g100(.a(new_n135_), .b(new_n143_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(x19), .b(x13), .c(x18), .O(new_n146_));
  nor2   g102(.a(x19), .b(x14), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n145_), .c(new_n142_), .O(new_n149_));
  oai22  g105(.a(new_n149_), .b(new_n139_), .c(new_n132_), .d(x29), .O(new_n150_));
  nor3   g106(.a(new_n137_), .b(new_n140_), .c(new_n133_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n125_), .c(new_n47_), .O(new_n152_));
  xor2a  g108(.a(x30), .b(x27), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(x28), .c(new_n118_), .O(new_n154_));
  nor2   g110(.a(x30), .b(x29), .O(new_n155_));
  aoi22  g111(.a(new_n155_), .b(x24), .c(new_n154_), .d(x29), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n152_), .c(new_n150_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  inv1   g114(.a(x32), .O(new_n159_));
  nand3  g115(.a(x29), .b(new_n98_), .c(new_n81_), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n132_), .c(x30), .O(new_n162_));
  nand2  g118(.a(new_n98_), .b(new_n81_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n109_), .c(x29), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  inv1   g121(.a(x18), .O(new_n166_));
  nand3  g122(.a(x19), .b(new_n166_), .c(x13), .O(new_n167_));
  nand3  g123(.a(new_n93_), .b(x18), .c(x14), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n144_), .O(new_n169_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n140_), .c(x11), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x15), .O(new_n176_));
  nand4  g132(.a(new_n173_), .b(x16), .c(new_n133_), .d(x10), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n165_), .c(new_n159_), .d(x31), .O(new_n179_));
  ...
  nand2  g140(.a(x33), .b(new_n125_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n163_), .c(x29), .O(new_n187_));
  nand2  g143(.a(new_n163_), .b(x29), .O(new_n188_));
  nand4  g144(.a(new_n178_), .b(new_n183_), .c(new_n125_), .d(new_n109_), .O(new_n189_));
  ...
  xor2a  g149(.a(x31), .b(x30), .O(new_n194_));
  nor3   g150(.a(new_n194_), .b(new_n151_), .c(new_n147_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n193_), .c(new_n145_), .d(new_n142_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n139_), .c(x33), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n192_), .c(new_n187_), .O(new_n198_));
