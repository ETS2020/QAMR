...
module FAU ( 
  ...
  aoi21  g047(.a(new_n91_), .b(new_n85_), .c(new_n61_), .O(new_n92_));
  ...
  nand3  g052(.a(new_n89_), .b(new_n96_), .c(new_n85_), .O(new_n97_));
  nor3   g053(.a(x30), .b(x24), .c(x19), .O(new_n98_));
  aoi21  g054(.a(new_n97_), .b(new_n58_), .c(new_n98_), .O(new_n99_));
  ...
  oai21  g061(.a(new_n45_), .b(x24), .c(new_n97_), .O(new_n106_));
  ...
  inv1   g065(.a(new_n99_), .O(new_n110_));
  ...
  nand2  g070(.a(new_n105_), .b(x29), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(x30), .c(x24), .O(new_n116_));
  ...
  nand2  g075(.a(new_n119_), .b(new_n97_), .O(new_n120_));
  inv1   g076(.a(x19), .O(new_n121_));
  nor2   g077(.a(new_n82_), .b(x24), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(x28), .d(new_n121_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n60_), .O(z6));
  ...
  nand3  g086(.a(new_n89_), .b(new_n96_), .c(new_n85_), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand4  g088(.a(new_n105_), .b(new_n132_), .c(x30), .d(x29), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n131_), .c(new_n130_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x24), .O(new_n135_));
  oai21  g091(.a(new_n131_), .b(new_n121_), .c(new_n132_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n45_), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(new_n128_), .O(z7));
  ...
  oai21  g100(.a(new_n144_), .b(new_n140_), .c(new_n143_), .O(new_n145_));
  inv1   g101(.a(x11), .O(new_n146_));
  inv1   g102(.a(x16), .O(new_n147_));
  oai21  g103(.a(new_n140_), .b(new_n146_), .c(new_n147_), .O(new_n148_));
  ...
  nand4  g111(.a(new_n155_), .b(new_n151_), .c(new_n148_), .d(new_n145_), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n142_), .c(new_n58_), .O(new_n157_));
  inv1   g113(.a(x14), .O(new_n158_));
  nand3  g114(.a(x24), .b(x18), .c(x17), .O(new_n159_));
  oai22  g115(.a(new_n159_), .b(new_n139_), .c(x30), .d(x19), .O(new_n160_));
  nand2  g116(.a(new_n104_), .b(new_n82_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(x30), .c(x29), .d(x24), .O(new_n162_));
  nor2   g118(.a(x28), .b(x27), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n109_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(x30), .c(new_n162_), .O(new_n165_));
  aoi21  g121(.a(new_n160_), .b(new_n158_), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n157_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x32), .O(new_n168_));
  inv1   g124(.a(x32), .O(new_n169_));
  inv1   g125(.a(new_n164_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(x30), .c(x24), .O(new_n171_));
  inv1   g127(.a(new_n163_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n45_), .c(x29), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  nand3  g130(.a(x19), .b(new_n87_), .c(x13), .O(new_n175_));
  nand3  g131(.a(new_n121_), .b(x18), .c(x14), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n175_), .c(new_n149_), .O(new_n177_));
  nand4  g133(.a(x19), .b(x18), .c(new_n149_), .d(x12), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n177_), .c(x16), .O(new_n180_));
  inv1   g136(.a(new_n153_), .O(new_n181_));
  ...
  nand4  g140(.a(new_n181_), .b(x16), .c(new_n143_), .d(x10), .O(new_n185_));
  ...
  nand2  g148(.a(x33), .b(new_n132_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n172_), .c(x29), .O(new_n195_));
  nand4  g151(.a(new_n186_), .b(new_n191_), .c(new_n132_), .d(new_n45_), .O(new_n196_));
  nand2  g152(.a(x33), .b(x31), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n196_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n170_), .O(new_n199_));
  aoi21  g155(.a(new_n121_), .b(x14), .c(new_n87_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(x17), .c(x16), .d(x15), .O(new_n201_));
  inv1   g157(.a(new_n152_), .O(new_n202_));
  xnor2a g158(.a(x31), .b(x30), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n202_), .c(new_n151_), .d(new_n148_), .O(new_n204_));
  inv1   g160(.a(new_n204_), .O(new_n205_));
  nand4  g161(.a(new_n205_), .b(new_n201_), .c(new_n145_), .d(new_n141_), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(x33), .O(new_n207_));
  nand3  g163(.a(new_n207_), .b(new_n199_), .c(new_n195_), .O(new_n208_));
  nand3  g164(.a(new_n208_), .b(new_n81_), .c(x00), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(new_n58_), .O(z9));
endmodule
