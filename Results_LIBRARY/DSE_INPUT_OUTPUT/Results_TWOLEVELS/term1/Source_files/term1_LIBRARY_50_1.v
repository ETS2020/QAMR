...
module FAU ( 
  ...
  nor2   g073(.a(new_n110_), .b(new_n101_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n103_), .c(new_n79_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n119_), .c(new_n80_), .O(new_n127_));
  oai21  g083(.a(new_n80_), .b(new_n45_), .c(new_n127_), .O(z7));
  ...
  nand2  g108(.a(new_n118_), .b(x27), .O(new_n153_));
  ...
  aoi21  g123(.a(new_n118_), .b(x28), .c(new_n167_), .O(new_n168_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n46_), .O(z8));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n117_), .d(new_n110_), .O(new_n182_));
