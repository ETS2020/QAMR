...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n81_), .c(new_n80_), .d(x01), .O(new_n95_));
  ...
  nand3  g066(.a(new_n94_), .b(x29), .c(x28), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(x27), .c(new_n80_), .d(x01), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n46_), .c(new_n45_), .O(z6));
  ...
  nand2  g147(.a(new_n191_), .b(new_n49_), .O(z9));
endmodule
