...
module FAU ( 
  ...
  aoi21  g11(.a(new_n55_), .b(new_n51_), .c(z8), .O(z1));
  inv1   g12(.a(z8), .O(new_n57_));
  ...
  nand2  g50(.a(x28), .b(x27), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(x29), .O(new_n96_));
  inv1   g52(.a(x29), .O(new_n97_));
  nand3  g53(.a(new_n97_), .b(x28), .c(x27), .O(new_n98_));
  aoi22  g54(.a(new_n98_), .b(new_n96_), .c(new_n88_), .d(new_n84_), .O(new_n99_));
  nand4  g55(.a(new_n99_), .b(new_n61_), .c(x25), .d(x01), .O(new_n100_));
  aoi21  g56(.a(new_n100_), .b(new_n45_), .c(x26), .O(z5));
  inv1   g57(.a(x26), .O(new_n102_));
  inv1   g58(.a(new_n85_), .O(new_n103_));
  inv1   g59(.a(new_n86_), .O(new_n104_));
  inv1   g60(.a(new_n87_), .O(new_n105_));
  nand4  g61(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n84_), .O(new_n106_));
  nand3  g62(.a(x29), .b(x28), .c(x27), .O(new_n107_));
  nand2  g63(.a(new_n107_), .b(x30), .O(new_n108_));
  inv1   g64(.a(x30), .O(new_n109_));
  nand2  g65(.a(new_n109_), .b(x29), .O(new_n110_));
  oai21  g66(.a(new_n110_), .b(new_n95_), .c(new_n108_), .O(new_n111_));
  nand4  g67(.a(new_n111_), .b(new_n106_), .c(new_n61_), .d(new_n102_), .O(new_n112_));
  inv1   g68(.a(new_n112_), .O(new_n113_));
  nand4  g69(.a(new_n113_), .b(x25), .c(x01), .d(new_n45_), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(z6));
  nand2  g71(.a(x30), .b(x29), .O(new_n116_));
  oai21  g72(.a(new_n116_), .b(new_n95_), .c(x31), .O(new_n117_));
  nand4  g73(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n84_), .O(new_n118_));
  nor2   g74(.a(new_n81_), .b(new_n60_), .O(new_n119_));
  inv1   g75(.a(x25), .O(new_n120_));
  inv1   g76(.a(x31), .O(new_n121_));
  nand3  g77(.a(new_n121_), .b(x30), .c(x29), .O(new_n122_));
  nor2   g78(.a(new_n122_), .b(new_n95_), .O(new_n123_));
  nor2   g79(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n102_), .O(z7));
  zero   g83(.O(z9));
endmodule
