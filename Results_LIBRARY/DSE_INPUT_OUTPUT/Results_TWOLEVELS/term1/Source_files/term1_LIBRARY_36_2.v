...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n61_), .d(new_n81_), .O(new_n99_));
  ...
  nand3  g064(.a(new_n108_), .b(x30), .c(new_n81_), .O(new_n109_));
  nand3  g065(.a(new_n103_), .b(new_n45_), .c(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n95_), .c(new_n61_), .d(x25), .O(new_n112_));
  ...
  inv1   g073(.a(new_n103_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x30), .c(x29), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(new_n81_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n80_), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(new_n116_), .d(new_n115_), .O(z7));
  nand2  g079(.a(new_n102_), .b(new_n82_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x29), .O(new_n125_));
  inv1   g081(.a(x32), .O(new_n126_));
  nand3  g082(.a(x19), .b(new_n89_), .c(x13), .O(new_n127_));
  nand3  g083(.a(new_n92_), .b(x18), .c(x14), .O(new_n128_));
  aoi21  g084(.a(new_n128_), .b(new_n127_), .c(new_n86_), .O(new_n129_));
  nand4  g085(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n130_));
  ...
  nand4  g097(.a(new_n141_), .b(new_n126_), .c(x31), .d(x30), .O(new_n142_));
  nand2  g098(.a(x32), .b(new_n45_), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(x26), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n125_), .O(new_n145_));
  nand4  g101(.a(new_n141_), .b(new_n124_), .c(new_n126_), .d(x31), .O(new_n146_));
  nand2  g102(.a(new_n102_), .b(new_n82_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(x32), .c(x30), .d(new_n81_), .O(new_n148_));
  oai21  g104(.a(new_n146_), .b(x30), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x29), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n134_), .c(new_n139_), .O(new_n152_));
  nor2   g108(.a(new_n92_), .b(new_n89_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(x17), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n133_), .O(new_n155_));
  nand2  g111(.a(new_n153_), .b(x12), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n86_), .O(new_n157_));
  aoi21  g113(.a(x19), .b(x13), .c(x18), .O(new_n158_));
  nor2   g114(.a(x19), .b(x14), .O(new_n159_));
  nand2  g115(.a(x16), .b(x15), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n134_), .c(x31), .O(new_n161_));
  ...
  nand3  g119(.a(new_n163_), .b(x32), .c(new_n81_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n150_), .c(new_n145_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x00), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n46_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n141_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n45_), .O(new_n170_));
  oai21  g126(.a(new_n169_), .b(x26), .c(new_n170_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n124_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n141_), .b(new_n168_), .c(new_n119_), .d(new_n45_), .O(new_n173_));
  nand3  g129(.a(x33), .b(x31), .c(new_n81_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  aoi21  g131(.a(new_n92_), .b(x14), .c(new_n89_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x17), .c(x16), .d(x15), .O(new_n177_));
  nand2  g133(.a(x18), .b(x17), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n160_), .c(new_n92_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n151_), .c(new_n139_), .O(new_n180_));
  ...
  nand2  g140(.a(new_n184_), .b(new_n86_), .O(new_n185_));
  inv1   g141(.a(x13), .O(new_n186_));
  nand2  g142(.a(new_n89_), .b(new_n186_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n185_), .c(new_n183_), .d(new_n181_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n180_), .c(new_n179_), .d(new_n177_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(x33), .c(new_n81_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  aoi21  g148(.a(new_n175_), .b(new_n125_), .c(new_n192_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n172_), .O(new_n194_));
