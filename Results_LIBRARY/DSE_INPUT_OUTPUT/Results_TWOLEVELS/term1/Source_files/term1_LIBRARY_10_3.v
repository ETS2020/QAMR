...
module FAU ( 
  ...
  nand3  g049(.a(new_n48_), .b(new_n93_), .c(x27), .O(new_n94_));
  nand2  g050(.a(x30), .b(x29), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x28), .c(new_n83_), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n94_), .c(new_n88_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n63_), .c(new_n82_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n92_), .c(new_n61_), .O(z4));
  nand3  g055(.a(new_n46_), .b(x29), .c(new_n83_), .O(new_n100_));
  oai21  g056(.a(x29), .b(new_n83_), .c(new_n100_), .O(new_n101_));
  nor2   g057(.a(new_n45_), .b(x28), .O(new_n102_));
  aoi21  g058(.a(new_n101_), .b(x28), .c(new_n102_), .O(new_n103_));
  nor2   g059(.a(new_n103_), .b(new_n88_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n63_), .c(new_n82_), .d(x25), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n61_), .c(new_n48_), .O(z5));
  nand3  g062(.a(x29), .b(x28), .c(x27), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n46_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n89_), .c(new_n82_), .d(x25), .O(new_n109_));
  oai21  g065(.a(new_n109_), .b(new_n61_), .c(new_n48_), .O(z6));
  inv1   g066(.a(new_n86_), .O(new_n111_));
  inv1   g067(.a(new_n87_), .O(new_n112_));
  ...
  oai21  g085(.a(new_n125_), .b(new_n128_), .c(new_n129_), .O(new_n130_));
  ...
  oai21  g092(.a(new_n136_), .b(new_n121_), .c(x31), .O(new_n137_));
  nor2   g093(.a(new_n137_), .b(new_n135_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n134_), .c(new_n130_), .d(new_n127_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n123_), .c(new_n48_), .O(new_n140_));
  nand2  g096(.a(new_n93_), .b(new_n83_), .O(new_n141_));
  ...
  nand3  g102(.a(new_n141_), .b(new_n46_), .c(x29), .O(new_n147_));
  oai21  g103(.a(new_n46_), .b(x29), .c(new_n147_), .O(new_n148_));
  nand3  g104(.a(x19), .b(new_n132_), .c(x13), .O(new_n149_));
  nand3  g105(.a(new_n133_), .b(x18), .c(x14), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(new_n129_), .O(new_n151_));
  nand4  g107(.a(x19), .b(x18), .c(new_n129_), .d(x12), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(x16), .O(new_n154_));
  nand3  g110(.a(new_n122_), .b(new_n124_), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x15), .O(new_n157_));
  inv1   g113(.a(x15), .O(new_n158_));
  nand4  g114(.a(new_n122_), .b(x16), .c(new_n158_), .d(x10), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n148_), .c(new_n146_), .d(x31), .O(new_n161_));
  ...
  nand4  g122(.a(new_n160_), .b(new_n142_), .c(new_n166_), .d(new_n115_), .O(new_n167_));
  aoi21  g123(.a(new_n133_), .b(x14), .c(new_n132_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(x17), .c(x16), .d(x15), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n136_), .c(new_n133_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n119_), .c(new_n158_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n170_), .b(new_n173_), .c(new_n124_), .O(new_n174_));
  oai21  g130(.a(new_n132_), .b(new_n128_), .c(new_n129_), .O(new_n175_));
  aoi21  g131(.a(new_n132_), .b(new_n131_), .c(x31), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n175_), .c(new_n174_), .d(new_n172_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n171_), .c(new_n169_), .d(new_n142_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n167_), .c(x30), .O(new_n181_));
  nor3   g137(.a(new_n166_), .b(new_n46_), .c(x29), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n181_), .c(new_n82_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n165_), .O(z9));
endmodule
