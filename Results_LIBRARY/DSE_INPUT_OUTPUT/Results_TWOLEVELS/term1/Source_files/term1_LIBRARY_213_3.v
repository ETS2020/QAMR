...
module FAU ( 
  ...
  nand3  g059(.a(new_n103_), .b(new_n60_), .c(new_n79_), .O(new_n104_));
  ...
  oai21  g065(.a(new_n109_), .b(new_n80_), .c(new_n108_), .O(new_n110_));
  ...
  nand4  g069(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n113_), .O(new_n114_));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n79_), .c(x25), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n59_), .c(new_n58_), .O(new_n117_));
  ...
  aoi22  g094(.a(new_n138_), .b(new_n80_), .c(new_n108_), .d(new_n101_), .O(new_n139_));
  ...
  nand2  g099(.a(new_n99_), .b(new_n80_), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(new_n108_), .c(x29), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n143_), .O(new_n146_));
  nand3  g102(.a(x19), .b(new_n85_), .c(x13), .O(new_n147_));
  nand3  g103(.a(new_n88_), .b(x18), .c(x14), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n82_), .O(new_n149_));
  nand4  g105(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n150_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n132_), .c(new_n88_), .O(new_n168_));
  ...
  aoi22  g128(.a(new_n172_), .b(new_n82_), .c(new_n85_), .d(new_n129_), .O(new_n173_));
  ...
  nand2  g133(.a(new_n109_), .b(x31), .O(new_n178_));
  oai21  g134(.a(x31), .b(new_n108_), .c(new_n178_), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n80_), .c(new_n177_), .d(new_n108_), .O(new_n180_));
  ...
  nand3  g144(.a(new_n115_), .b(new_n108_), .c(new_n101_), .O(new_n189_));
