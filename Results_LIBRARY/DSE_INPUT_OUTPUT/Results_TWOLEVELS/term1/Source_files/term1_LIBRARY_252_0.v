...
module FAU ( 
  ...
  nand3  g043(.a(x30), .b(new_n87_), .c(new_n86_), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n85_), .c(new_n83_), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(new_n81_), .c(new_n61_), .O(new_n90_));
  nor2   g046(.a(new_n90_), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n80_), .c(x25), .d(x01), .O(new_n92_));
  nand2  g048(.a(new_n92_), .b(new_n57_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  inv1   g050(.a(new_n88_), .O(new_n95_));
  nor3   g051(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(new_n96_));
  inv1   g052(.a(new_n96_), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n57_), .c(new_n95_), .O(new_n98_));
  ...
  aoi21  g067(.a(new_n87_), .b(new_n86_), .c(new_n84_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n83_), .c(new_n111_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n110_), .c(x30), .O(new_n114_));
  nor2   g070(.a(new_n96_), .b(x30), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x29), .c(x28), .d(x27), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n87_), .c(new_n114_), .O(new_n117_));
  ...
  nand3  g079(.a(new_n85_), .b(new_n83_), .c(new_n111_), .O(new_n124_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n144_), .c(new_n141_), .d(new_n137_), .O(new_n148_));
  oai21  g104(.a(x30), .b(x24), .c(new_n148_), .O(new_n149_));
  nor3   g105(.a(new_n136_), .b(new_n138_), .c(new_n134_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n127_), .c(new_n57_), .O(new_n151_));
  inv1   g107(.a(x30), .O(new_n152_));
  nor2   g108(.a(x28), .b(x27), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n102_), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n152_), .c(x24), .O(new_n156_));
  inv1   g112(.a(x27), .O(new_n157_));
  nand2  g113(.a(new_n104_), .b(new_n157_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(x30), .c(x29), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n156_), .c(new_n151_), .d(new_n149_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x32), .O(new_n161_));
  inv1   g117(.a(x32), .O(new_n162_));
  inv1   g118(.a(new_n153_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n152_), .c(x29), .d(x24), .O(new_n164_));
  oai21  g120(.a(new_n154_), .b(new_n152_), .c(new_n164_), .O(new_n165_));
  inv1   g121(.a(x18), .O(new_n166_));
  nand3  g122(.a(x19), .b(new_n166_), .c(x13), .O(new_n167_));
  nand3  g123(.a(new_n86_), .b(x18), .c(x14), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n143_), .O(new_n169_));
  nand4  g125(.a(x19), .b(x18), .c(new_n143_), .d(x12), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n169_), .c(x16), .O(new_n172_));
  inv1   g128(.a(new_n136_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n138_), .c(x11), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n172_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x15), .O(new_n176_));
  nand4  g132(.a(new_n173_), .b(x16), .c(new_n134_), .d(x10), .O(new_n177_));
  ...
  nand4  g143(.a(new_n178_), .b(new_n183_), .c(new_n127_), .d(new_n152_), .O(new_n188_));
  ...
  inv1   g148(.a(new_n145_), .O(new_n193_));
  nor3   g149(.a(new_n150_), .b(new_n146_), .c(new_n131_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n193_), .c(new_n144_), .d(new_n141_), .O(new_n195_));
