...
module FAU ( 
  ...
  nor2   g076(.a(new_n113_), .b(new_n102_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n104_), .c(new_n120_), .O(new_n122_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n104_), .c(new_n97_), .O(new_n128_));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n120_), .d(new_n113_), .O(new_n185_));
