...
module FAU ( 
  ...
  nand2  g069(.a(new_n105_), .b(x29), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(new_n112_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n102_), .c(new_n60_), .d(new_n79_), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n101_), .c(new_n58_), .O(z6));
  inv1   g073(.a(x31), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(new_n80_), .O(new_n120_));
  ...
  inv1   g081(.a(new_n119_), .O(new_n126_));
  ...
  nand2  g105(.a(new_n106_), .b(new_n149_), .O(new_n150_));
  oai21  g106(.a(x30), .b(x29), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x27), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n148_), .c(new_n145_), .d(new_n121_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x32), .O(new_n154_));
  inv1   g110(.a(x32), .O(new_n155_));
  aoi21  g111(.a(new_n149_), .b(new_n80_), .c(new_n104_), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n105_), .c(new_n114_), .d(new_n80_), .O(new_n157_));
  nand3  g113(.a(x19), .b(new_n85_), .c(x13), .O(new_n158_));
  nand3  g114(.a(new_n88_), .b(x18), .c(x14), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n158_), .c(new_n82_), .O(new_n160_));
  nand4  g116(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n161_));
  ...
  nand4  g129(.a(x33), .b(new_n149_), .c(new_n79_), .d(x00), .O(new_n174_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n146_), .c(new_n88_), .O(new_n188_));
  ...
  nand2  g149(.a(new_n85_), .b(new_n193_), .O(new_n194_));
  nand2  g150(.a(x31), .b(new_n104_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n119_), .d(new_n114_), .O(new_n196_));
