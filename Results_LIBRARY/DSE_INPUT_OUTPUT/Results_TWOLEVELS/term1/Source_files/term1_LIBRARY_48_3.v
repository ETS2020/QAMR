...
module FAU ( 
  ...
  nand4  g064(.a(new_n46_), .b(x29), .c(x28), .d(x27), .O(new_n109_));
  oai21  g065(.a(new_n46_), .b(x27), .c(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n95_), .c(new_n82_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n101_), .c(new_n61_), .O(z6));
  ...
  oai21  g091(.a(new_n135_), .b(new_n124_), .c(new_n59_), .O(new_n136_));
  ...
  nand3  g126(.a(new_n170_), .b(new_n115_), .c(new_n46_), .O(new_n171_));
  inv1   g127(.a(new_n143_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(x31), .c(x30), .O(new_n173_));
  ...
  oai21  g132(.a(new_n172_), .b(x30), .c(new_n115_), .O(new_n177_));
