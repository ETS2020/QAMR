...
module FAU ( 
  ...
  inv1   g038(.a(x16), .O(new_n83_));
  nor2   g039(.a(x20), .b(x15), .O(new_n84_));
  aoi21  g040(.a(new_n45_), .b(new_n83_), .c(new_n84_), .O(new_n85_));
  ...
  aoi21  g050(.a(new_n94_), .b(new_n85_), .c(new_n61_), .O(new_n95_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n45_), .c(new_n83_), .O(new_n105_));
  nor2   g061(.a(new_n86_), .b(new_n84_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(new_n92_), .d(new_n89_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n103_), .c(new_n62_), .d(x29), .O(new_n108_));
  inv1   g064(.a(x29), .O(new_n109_));
  nand3  g065(.a(new_n95_), .b(new_n109_), .c(x28), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n82_), .c(new_n108_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n81_), .c(x25), .d(x01), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n58_), .O(z5));
  nand3  g069(.a(x29), .b(new_n45_), .c(new_n83_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n92_), .c(new_n89_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n106_), .c(new_n102_), .O(new_n117_));
  aoi21  g073(.a(new_n94_), .b(new_n85_), .c(x29), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(x30), .O(new_n119_));
  nor2   g075(.a(new_n84_), .b(new_n83_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n94_), .c(x30), .O(new_n121_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n60_), .c(new_n58_), .O(z6));
  nand4  g081(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n58_), .O(new_n127_));
  nand3  g083(.a(x29), .b(x28), .c(x27), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x31), .O(new_n129_));
  nand3  g085(.a(new_n106_), .b(new_n92_), .c(new_n89_), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x21), .O(new_n132_));
  inv1   g088(.a(x31), .O(new_n133_));
  nand3  g089(.a(new_n102_), .b(new_n133_), .c(x29), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n132_), .c(new_n129_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x30), .O(new_n136_));
  nand2  g092(.a(x31), .b(new_n104_), .O(new_n137_));
  oai21  g093(.a(new_n130_), .b(new_n83_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n45_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n136_), .c(new_n127_), .O(z7));
  nand2  g096(.a(new_n101_), .b(new_n82_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x29), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  inv1   g099(.a(x17), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n87_), .c(x13), .O(new_n145_));
  nand3  g101(.a(new_n90_), .b(x18), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n144_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n144_), .d(x12), .O(new_n148_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n83_), .c(x11), .O(new_n153_));
  ...
  nand4  g114(.a(new_n158_), .b(new_n143_), .c(x31), .d(x30), .O(new_n159_));
  nand3  g115(.a(x32), .b(new_n104_), .c(new_n45_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n142_), .O(new_n162_));
  nand4  g118(.a(new_n158_), .b(new_n141_), .c(new_n143_), .d(x31), .O(new_n163_));
  nand2  g119(.a(new_n101_), .b(new_n82_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(x32), .c(x30), .O(new_n165_));
  oai21  g121(.a(new_n163_), .b(x30), .c(new_n165_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x29), .O(new_n167_));
  nand2  g123(.a(x16), .b(x10), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n152_), .c(x15), .O(new_n170_));
  nor2   g126(.a(new_n90_), .b(new_n87_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x17), .c(x11), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n83_), .O(new_n173_));
  nand2  g129(.a(new_n171_), .b(x12), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n144_), .O(new_n175_));
  inv1   g131(.a(x13), .O(new_n176_));
  oai21  g132(.a(new_n90_), .b(new_n176_), .c(new_n87_), .O(new_n177_));
  nor2   g133(.a(x19), .b(x14), .O(new_n178_));
  nand2  g134(.a(x16), .b(x15), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n151_), .c(x31), .O(new_n180_));
  ...
  nand3  g139(.a(new_n183_), .b(new_n167_), .c(new_n162_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n81_), .c(x00), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n58_), .O(z8));
  nand2  g142(.a(new_n90_), .b(x14), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(x18), .c(x17), .d(x16), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n156_), .O(new_n189_));
  nand2  g145(.a(x18), .b(x17), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n179_), .c(new_n90_), .O(new_n191_));
  oai21  g147(.a(new_n190_), .b(new_n168_), .c(new_n156_), .O(new_n192_));
  inv1   g148(.a(x11), .O(new_n193_));
  oai21  g149(.a(new_n190_), .b(new_n193_), .c(new_n83_), .O(new_n194_));
  nand2  g150(.a(x18), .b(x12), .O(new_n195_));
  aoi22  g151(.a(new_n195_), .b(new_n144_), .c(new_n87_), .d(new_n176_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n194_), .c(new_n192_), .d(new_n191_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n189_), .c(new_n58_), .O(new_n198_));
  nand3  g154(.a(new_n141_), .b(new_n133_), .c(x29), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n137_), .O(new_n200_));
  nor2   g156(.a(new_n133_), .b(new_n109_), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n141_), .c(new_n104_), .O(new_n202_));
  aoi21  g158(.a(new_n200_), .b(new_n45_), .c(new_n202_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n198_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(x33), .O(new_n205_));
  nand4  g161(.a(new_n142_), .b(new_n133_), .c(new_n104_), .d(new_n45_), .O(new_n206_));
  nand4  g162(.a(new_n141_), .b(x31), .c(x30), .d(x29), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(new_n206_), .O(new_n208_));
  nand2  g164(.a(new_n208_), .b(new_n158_), .O(new_n209_));
  oai21  g165(.a(new_n209_), .b(x33), .c(new_n205_), .O(new_n210_));
  nand3  g166(.a(new_n210_), .b(new_n81_), .c(x00), .O(new_n211_));
