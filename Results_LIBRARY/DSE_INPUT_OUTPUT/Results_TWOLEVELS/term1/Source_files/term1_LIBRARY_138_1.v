...
module FAU ( 
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n60_), .d(new_n80_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n46_), .O(z5));
  oai21  g064(.a(new_n100_), .b(new_n101_), .c(x30), .O(new_n109_));
  nor2   g065(.a(x30), .b(new_n100_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n102_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n99_), .c(new_n60_), .d(new_n80_), .O(new_n113_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n100_), .c(new_n79_), .O(new_n147_));
  oai21  g103(.a(new_n121_), .b(new_n45_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n145_), .b(new_n46_), .c(new_n148_), .O(new_n149_));
  ...
  nand2  g109(.a(x30), .b(new_n100_), .O(new_n154_));
  and2   g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  oai22  g111(.a(new_n155_), .b(new_n45_), .c(new_n153_), .d(new_n101_), .O(new_n156_));
  ...
  aoi21  g128(.a(new_n164_), .b(new_n162_), .c(new_n129_), .O(new_n173_));
  inv1   g129(.a(new_n167_), .O(new_n174_));
  nor2   g130(.a(x30), .b(x29), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n146_), .c(new_n117_), .O(new_n176_));
  nand3  g132(.a(x31), .b(x30), .c(x29), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  oai21  g134(.a(new_n174_), .b(new_n173_), .c(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n88_), .b(x14), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x18), .c(x17), .d(x16), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n129_), .O(new_n182_));
  nor2   g138(.a(new_n146_), .b(x31), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x29), .O(new_n184_));
  nor2   g140(.a(new_n85_), .b(new_n82_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n144_), .c(new_n88_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n130_), .c(new_n129_), .O(new_n188_));
  aoi21  g144(.a(new_n185_), .b(x11), .c(x16), .O(new_n189_));
  oai21  g145(.a(new_n85_), .b(new_n137_), .c(new_n82_), .O(new_n190_));
  inv1   g146(.a(x13), .O(new_n191_));
  nand2  g147(.a(new_n85_), .b(new_n191_), .O(new_n192_));
  nand2  g148(.a(x31), .b(new_n79_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n192_), .c(new_n190_), .d(new_n154_), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n189_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n188_), .c(new_n187_), .d(new_n184_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n182_), .c(x33), .O(new_n197_));
  oai21  g153(.a(new_n179_), .b(x33), .c(new_n197_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n80_), .c(x00), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n46_), .O(z9));
endmodule
