...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n62_), .c(new_n47_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n62_), .c(new_n47_), .O(z4));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n105_), .c(new_n100_), .O(new_n127_));
