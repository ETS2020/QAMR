...
module FAU ( 
  ...
  nand4  g064(.a(new_n104_), .b(x29), .c(x28), .d(x27), .O(new_n109_));
  oai21  g065(.a(new_n104_), .b(x27), .c(new_n109_), .O(new_n110_));
  ...
  nor4   g070(.a(new_n114_), .b(new_n47_), .c(x31), .d(x26), .O(new_n115_));
  oai21  g071(.a(new_n113_), .b(new_n90_), .c(new_n115_), .O(z7));
  inv1   g072(.a(x32), .O(new_n117_));
  aoi21  g073(.a(new_n104_), .b(x28), .c(x27), .O(new_n118_));
  nor2   g074(.a(new_n103_), .b(new_n96_), .O(new_n119_));
  oai22  g075(.a(new_n119_), .b(new_n104_), .c(new_n118_), .d(new_n103_), .O(new_n120_));
