// Benchmark "FAU" written by ABC on Thu Aug 20 01:02:56 2020
...
module FAU ( 
  ...
  nand4  g076(.a(new_n120_), .b(new_n108_), .c(new_n82_), .d(new_n116_), .O(new_n121_));
  ...
  aoi21  g084(.a(new_n128_), .b(new_n126_), .c(new_n109_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n82_), .c(x25), .d(x01), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g087(.a(new_n118_), .b(x30), .c(x29), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x31), .O(new_n133_));
  inv1   g089(.a(new_n104_), .O(new_n134_));
  inv1   g090(.a(new_n105_), .O(new_n135_));
  inv1   g091(.a(new_n106_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n103_), .O(new_n137_));
  nor2   g093(.a(new_n100_), .b(new_n60_), .O(new_n138_));
  ...
  nand2  g101(.a(new_n145_), .b(new_n116_), .O(z7));
  zero   g102(.O(z9));
endmodule
