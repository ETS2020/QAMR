...
module FAU ( 
  ...
  nand2  g058(.a(new_n102_), .b(new_n56_), .O(z5));
  ...
  oai21  g066(.a(new_n110_), .b(new_n58_), .c(new_n56_), .O(z6));
  ...
  nand2  g083(.a(x18), .b(x16), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n127_), .O(new_n129_));
  inv1   g085(.a(x10), .O(new_n130_));
  oai21  g086(.a(new_n128_), .b(new_n130_), .c(new_n126_), .O(new_n131_));
  ...
  nor2   g093(.a(new_n127_), .b(new_n134_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x17), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n137_), .c(x31), .O(new_n140_));
  aoi21  g096(.a(new_n134_), .b(new_n136_), .c(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n135_), .c(new_n131_), .d(new_n129_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n56_), .O(new_n143_));
  inv1   g099(.a(x14), .O(new_n144_));
  nand3  g100(.a(x30), .b(x18), .c(x17), .O(new_n145_));
  oai22  g101(.a(new_n145_), .b(new_n137_), .c(x19), .d(new_n112_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g103(.a(x30), .b(x29), .c(x27), .O(new_n148_));
  nand3  g104(.a(new_n104_), .b(new_n80_), .c(x12), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n148_), .c(x28), .O(new_n150_));
  inv1   g106(.a(x17), .O(new_n151_));
  aoi22  g107(.a(x29), .b(x28), .c(new_n151_), .d(new_n112_), .O(new_n152_));
  nand3  g108(.a(new_n138_), .b(x16), .c(x15), .O(new_n153_));
  aoi22  g109(.a(new_n153_), .b(new_n151_), .c(new_n104_), .d(new_n95_), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n112_), .c(new_n152_), .d(new_n104_), .O(new_n155_));
  ...
  nand2  g115(.a(new_n96_), .b(new_n80_), .O(new_n160_));
  nand3  g116(.a(x19), .b(new_n134_), .c(x13), .O(new_n161_));
  nand3  g117(.a(new_n127_), .b(x18), .c(x14), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x17), .O(new_n164_));
  nand2  g120(.a(new_n138_), .b(new_n151_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n164_), .c(new_n133_), .O(new_n166_));
  nand2  g122(.a(new_n133_), .b(x11), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n139_), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n166_), .c(x15), .O(new_n169_));
  inv1   g125(.a(new_n139_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x16), .c(new_n126_), .d(x10), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n160_), .c(new_n104_), .d(x29), .O(new_n173_));
  nand2  g129(.a(new_n160_), .b(x29), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x30), .c(x19), .d(x18), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n151_), .c(x16), .d(x15), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n173_), .c(new_n112_), .O(new_n178_));
  aoi21  g134(.a(new_n162_), .b(new_n161_), .c(new_n133_), .O(new_n179_));
  nand3  g135(.a(new_n138_), .b(new_n133_), .c(x11), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n179_), .c(x15), .O(new_n182_));
  nand4  g138(.a(new_n138_), .b(x16), .c(new_n126_), .d(x10), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n174_), .c(x30), .d(x17), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n178_), .c(new_n159_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n121_), .c(new_n158_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n79_), .c(x00), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(z8));
  inv1   g146(.a(x33), .O(new_n191_));
  nand3  g147(.a(new_n138_), .b(new_n151_), .c(x12), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n164_), .c(new_n133_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n168_), .c(x15), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n171_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n191_), .c(x31), .d(x30), .O(new_n196_));
  oai21  g152(.a(new_n191_), .b(x31), .c(new_n196_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n160_), .c(x29), .O(new_n198_));
  nand4  g154(.a(new_n172_), .b(new_n191_), .c(new_n121_), .d(new_n104_), .O(new_n199_));
  oai21  g155(.a(new_n191_), .b(new_n121_), .c(new_n199_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n174_), .O(new_n201_));
  aoi21  g157(.a(new_n127_), .b(x14), .c(new_n134_), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(x17), .c(x16), .d(x15), .O(new_n203_));
  nor2   g159(.a(new_n134_), .b(new_n151_), .O(new_n204_));
  inv1   g160(.a(new_n204_), .O(new_n205_));
  oai21  g161(.a(new_n205_), .b(new_n137_), .c(new_n127_), .O(new_n206_));
  nand3  g162(.a(new_n204_), .b(x16), .c(x10), .O(new_n207_));
  nand2  g163(.a(new_n134_), .b(new_n136_), .O(new_n208_));
  oai21  g164(.a(new_n205_), .b(new_n132_), .c(new_n133_), .O(new_n209_));
  oai21  g165(.a(new_n134_), .b(new_n112_), .c(new_n151_), .O(new_n210_));
  xnor2a g166(.a(x31), .b(x30), .O(new_n211_));
  nand4  g167(.a(new_n211_), .b(new_n210_), .c(new_n209_), .d(new_n208_), .O(new_n212_));
  aoi21  g168(.a(new_n207_), .b(new_n126_), .c(new_n212_), .O(new_n213_));
  nand3  g169(.a(new_n213_), .b(new_n206_), .c(new_n203_), .O(new_n214_));
  nand2  g170(.a(new_n214_), .b(x33), .O(new_n215_));
  nand3  g171(.a(new_n215_), .b(new_n201_), .c(new_n198_), .O(new_n216_));
