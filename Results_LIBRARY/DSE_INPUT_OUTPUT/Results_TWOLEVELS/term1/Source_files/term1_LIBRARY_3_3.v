...
module FAU ( 
  ...
  nand3  g020(.a(new_n64_), .b(x06), .c(x05), .O(new_n65_));
  oai21  g021(.a(x06), .b(x05), .c(new_n65_), .O(new_n66_));
  oai21  g022(.a(new_n66_), .b(new_n63_), .c(new_n62_), .O(new_n67_));
  aoi21  g023(.a(new_n67_), .b(new_n61_), .c(new_n59_), .O(new_n68_));
  xor2a  g024(.a(x07), .b(x04), .O(new_n69_));
  oai21  g025(.a(new_n64_), .b(new_n63_), .c(x01), .O(new_n70_));
  nand3  g026(.a(x05), .b(new_n51_), .c(x02), .O(new_n71_));
  nand3  g027(.a(x06), .b(x03), .c(new_n54_), .O(new_n72_));
  nand2  g028(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand2  g029(.a(new_n73_), .b(new_n62_), .O(new_n74_));
  aoi21  g030(.a(new_n74_), .b(new_n70_), .c(new_n69_), .O(new_n75_));
  oai21  g031(.a(new_n75_), .b(new_n68_), .c(new_n48_), .O(new_n76_));
  oai22  g032(.a(x06), .b(new_n51_), .c(x05), .d(new_n54_), .O(new_n77_));
  nand3  g033(.a(new_n77_), .b(new_n46_), .c(new_n62_), .O(new_n78_));
  inv1   g034(.a(x05), .O(new_n79_));
  nand3  g035(.a(new_n79_), .b(new_n51_), .c(x02), .O(new_n80_));
  inv1   g036(.a(x06), .O(new_n81_));
  nand3  g037(.a(new_n81_), .b(x03), .c(new_n54_), .O(new_n82_));
  nand2  g038(.a(new_n82_), .b(new_n80_), .O(new_n83_));
  nand2  g039(.a(new_n83_), .b(new_n45_), .O(new_n84_));
  aoi21  g040(.a(new_n84_), .b(new_n78_), .c(new_n59_), .O(new_n85_));
  nand2  g041(.a(x06), .b(new_n79_), .O(new_n86_));
  nand2  g042(.a(new_n81_), .b(x05), .O(new_n87_));
  oai22  g043(.a(new_n87_), .b(x03), .c(new_n86_), .d(x02), .O(new_n88_));
  nand3  g044(.a(new_n88_), .b(new_n46_), .c(new_n62_), .O(new_n89_));
  nand2  g045(.a(new_n87_), .b(new_n86_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n45_), .c(new_n51_), .d(new_n54_), .O(new_n91_));
  aoi21  g047(.a(new_n91_), .b(new_n89_), .c(new_n69_), .O(new_n92_));
  ...
  inv1   g053(.a(new_n63_), .O(new_n98_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n98_), .c(new_n97_), .d(new_n46_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n45_), .c(new_n62_), .O(z3));
  xor2a  g069(.a(x28), .b(x27), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n111_), .c(new_n98_), .d(x01), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n46_), .c(new_n45_), .O(z4));
  ...
  nand4  g077(.a(new_n121_), .b(new_n111_), .c(new_n98_), .d(new_n46_), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n45_), .c(new_n62_), .O(z5));
  oai21  g079(.a(x28), .b(x26), .c(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n97_), .c(x30), .O(new_n125_));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n46_), .c(new_n45_), .O(z6));
  ...
  oai21  g094(.a(new_n138_), .b(new_n136_), .c(new_n48_), .O(new_n139_));
  ...
  nand2  g121(.a(new_n131_), .b(x27), .O(new_n166_));
  ...
  aoi21  g136(.a(new_n131_), .b(x28), .c(new_n180_), .O(new_n181_));
  ...
  nand3  g142(.a(new_n186_), .b(new_n46_), .c(x00), .O(new_n187_));
