...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n60_), .c(new_n58_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(new_n58_), .O(new_n92_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n62_), .d(new_n58_), .O(new_n102_));
  ...
  aoi21  g064(.a(x29), .b(x28), .c(new_n106_), .O(new_n109_));
  aoi21  g065(.a(new_n108_), .b(x28), .c(new_n109_), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n87_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n60_), .c(new_n58_), .O(z6));
  nand3  g069(.a(new_n99_), .b(x30), .c(x29), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  inv1   g071(.a(new_n85_), .O(new_n116_));
  inv1   g072(.a(new_n86_), .O(new_n117_));
  nor2   g073(.a(new_n84_), .b(new_n83_), .O(new_n118_));
  ...
  nand3  g078(.a(new_n45_), .b(x30), .c(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n81_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n121_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(new_n115_), .O(z7));
  inv1   g082(.a(x32), .O(new_n127_));
  nand2  g083(.a(new_n98_), .b(new_n82_), .O(new_n128_));
  ...
  aoi21  g099(.a(new_n143_), .b(new_n139_), .c(new_n130_), .O(new_n144_));
  nand3  g100(.a(x16), .b(new_n130_), .c(x10), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n141_), .O(new_n146_));
  or2    g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n129_), .c(new_n127_), .d(x31), .O(new_n148_));
  aoi21  g104(.a(new_n98_), .b(new_n82_), .c(new_n97_), .O(new_n149_));
  nand2  g105(.a(x16), .b(x10), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n141_), .c(new_n130_), .O(new_n151_));
  nor2   g107(.a(new_n134_), .b(new_n132_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(x17), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n140_), .O(new_n154_));
  nand2  g110(.a(new_n152_), .b(x12), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n131_), .O(new_n156_));
  aoi21  g112(.a(x19), .b(x13), .c(x18), .O(new_n157_));
  nor2   g113(.a(x19), .b(x14), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n141_), .c(x31), .O(new_n160_));
  ...
  nand3  g120(.a(new_n164_), .b(new_n81_), .c(x00), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n58_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  oai21  g123(.a(new_n146_), .b(new_n144_), .c(new_n167_), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n45_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n45_), .c(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n128_), .c(x29), .O(new_n171_));
  nand2  g127(.a(x33), .b(x31), .O(new_n172_));
  oai21  g128(.a(new_n168_), .b(x30), .c(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n129_), .O(new_n174_));
  aoi21  g130(.a(new_n134_), .b(x14), .c(new_n132_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x17), .c(x16), .d(x15), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n159_), .c(new_n134_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n150_), .c(new_n130_), .O(new_n179_));
  nand2  g135(.a(new_n45_), .b(x30), .O(new_n180_));
  inv1   g136(.a(x11), .O(new_n181_));
  oai21  g137(.a(new_n177_), .b(new_n181_), .c(new_n140_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n131_), .O(new_n184_));
  ...
  nand4  g144(.a(new_n188_), .b(new_n179_), .c(new_n178_), .d(new_n176_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n174_), .c(new_n171_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n81_), .c(x00), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n58_), .O(z9));
endmodule
