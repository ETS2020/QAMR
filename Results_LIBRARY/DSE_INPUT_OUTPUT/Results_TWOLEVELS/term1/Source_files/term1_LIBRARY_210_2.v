...
module FAU ( 
  ...
  nand2  g001(.a(new_n45_), .b(x20), .O(new_n46_));
  ...
  nor2   g049(.a(new_n93_), .b(new_n59_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nor2   g051(.a(new_n90_), .b(new_n82_), .O(new_n96_));
  nor3   g052(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n96_), .c(new_n60_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n95_), .c(new_n80_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n59_), .c(new_n46_), .O(z4));
  ...
  nor2   g071(.a(new_n82_), .b(new_n108_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n97_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n45_), .c(x29), .d(x28), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n81_), .c(new_n115_), .O(new_n119_));
  ...
  nand2  g079(.a(new_n110_), .b(x31), .O(new_n124_));
  nand3  g080(.a(new_n88_), .b(new_n86_), .c(new_n84_), .O(new_n125_));
  ...
  nor2   g087(.a(new_n125_), .b(new_n108_), .O(new_n132_));
  nor2   g088(.a(new_n128_), .b(x30), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n132_), .c(new_n109_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n131_), .c(new_n123_), .O(z7));
  ...
  nand4  g109(.a(new_n150_), .b(x16), .c(new_n108_), .d(x10), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand4  g111(.a(new_n155_), .b(new_n138_), .c(x31), .d(x30), .O(new_n156_));
  nand3  g112(.a(x32), .b(new_n45_), .c(new_n109_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n156_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n137_), .O(new_n159_));
  nand4  g115(.a(new_n155_), .b(new_n136_), .c(new_n138_), .d(x31), .O(new_n160_));
  nand2  g116(.a(new_n101_), .b(new_n81_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x32), .c(x30), .O(new_n162_));
  oai21  g118(.a(new_n160_), .b(x30), .c(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(x29), .O(new_n164_));
  and2   g120(.a(x16), .b(x10), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n150_), .c(x15), .O(new_n166_));
  nor2   g122(.a(new_n142_), .b(new_n140_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(x17), .c(x11), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n148_), .O(new_n169_));
  nand2  g125(.a(new_n167_), .b(x12), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n139_), .O(new_n171_));
  nand2  g127(.a(x19), .b(x13), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n140_), .O(new_n173_));
  nor2   g129(.a(x19), .b(x14), .O(new_n174_));
  nor3   g130(.a(new_n149_), .b(new_n148_), .c(new_n108_), .O(new_n175_));
  ...
  nand3  g134(.a(new_n178_), .b(new_n164_), .c(new_n159_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n80_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n46_), .O(z8));
  inv1   g137(.a(x33), .O(new_n182_));
  nand4  g138(.a(new_n155_), .b(new_n182_), .c(x31), .d(x30), .O(new_n183_));
  nand2  g139(.a(x33), .b(new_n128_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n136_), .c(x29), .O(new_n186_));
  nand4  g142(.a(new_n155_), .b(new_n182_), .c(new_n128_), .d(new_n45_), .O(new_n187_));
  oai21  g143(.a(new_n182_), .b(new_n45_), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n137_), .O(new_n189_));
  nor3   g145(.a(new_n175_), .b(new_n174_), .c(new_n133_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n173_), .c(new_n171_), .d(new_n169_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n166_), .c(x33), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n189_), .c(new_n186_), .O(new_n193_));
