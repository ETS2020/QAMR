...
module FAU ( 
  ...
  nand3  g050(.a(new_n45_), .b(x28), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g055(.a(new_n45_), .b(x29), .c(new_n94_), .O(new_n100_));
  ...
  nand3  g062(.a(new_n45_), .b(x29), .c(x28), .O(new_n107_));
  oai21  g063(.a(new_n106_), .b(new_n45_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n89_), .c(new_n62_), .d(x27), .O(new_n109_));
  ...
  nand3  g078(.a(x32), .b(new_n45_), .c(new_n104_), .O(new_n123_));
  ...
  nand2  g120(.a(new_n45_), .b(new_n105_), .O(new_n165_));
  ...
  aoi21  g130(.a(new_n45_), .b(new_n105_), .c(new_n127_), .O(new_n175_));
