...
module FAU ( 
  ...
  nand2  g051(.a(new_n45_), .b(x28), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(x27), .c(new_n95_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n90_), .c(new_n81_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n93_), .c(new_n60_), .O(z4));
  inv1   g055(.a(x27), .O(new_n100_));
  nand2  g056(.a(x29), .b(new_n94_), .O(new_n101_));
  oai21  g057(.a(new_n96_), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n90_), .c(new_n81_), .d(x25), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n60_), .c(new_n58_), .O(z5));
  oai21  g060(.a(new_n45_), .b(new_n94_), .c(x30), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x29), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n94_), .c(new_n105_), .O(new_n108_));
  ...
  oai21  g071(.a(new_n106_), .b(new_n94_), .c(x31), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(x30), .c(x29), .d(x28), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x27), .c(x31), .d(new_n45_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n115_), .O(z7));
  inv1   g077(.a(x32), .O(new_n122_));
  nand2  g078(.a(x30), .b(new_n45_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n107_), .O(new_n124_));
  ...
  oai21  g105(.a(new_n146_), .b(new_n149_), .c(new_n125_), .O(new_n150_));
  ...
  aoi21  g110(.a(new_n106_), .b(new_n45_), .c(new_n117_), .O(new_n155_));
  oai21  g111(.a(new_n106_), .b(new_n45_), .c(new_n155_), .O(new_n156_));
  ...
  nand3  g116(.a(new_n160_), .b(new_n81_), .c(x00), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n58_), .O(z8));
  inv1   g118(.a(x33), .O(new_n163_));
  nand3  g119(.a(x31), .b(x30), .c(x29), .O(new_n164_));
  nand3  g120(.a(new_n117_), .b(new_n106_), .c(new_n45_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n164_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n142_), .c(new_n163_), .O(new_n167_));
  nand2  g123(.a(x31), .b(new_n106_), .O(new_n168_));
  nand2  g124(.a(new_n117_), .b(x29), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n168_), .c(new_n123_), .O(new_n170_));
  ...
  nand2  g131(.a(new_n175_), .b(new_n58_), .O(z9));
endmodule
