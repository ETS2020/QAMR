...
module FAU ( 
  ...
  nand2  g037(.a(x31), .b(x30), .O(new_n82_));
  ...
  nand3  g050(.a(new_n82_), .b(new_n94_), .c(x27), .O(new_n95_));
  nand3  g051(.a(new_n49_), .b(x28), .c(new_n81_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n93_), .c(new_n60_), .O(z4));
  oai21  g055(.a(new_n94_), .b(new_n81_), .c(x29), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x28), .c(x27), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n100_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n104_));
  ...
  nand3  g064(.a(new_n46_), .b(x30), .c(new_n94_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  aoi21  g066(.a(x29), .b(x27), .c(x31), .O(new_n111_));
  aoi22  g067(.a(new_n111_), .b(x30), .c(new_n110_), .d(x27), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n60_), .O(z6));
  ...
  nand4  g075(.a(x30), .b(x29), .c(x28), .d(x27), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n46_), .c(new_n80_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n119_), .O(new_n122_));
  oai21  g078(.a(new_n118_), .b(new_n86_), .c(new_n122_), .O(z7));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(new_n124_), .d(x31), .O(new_n145_));
  nand2  g101(.a(x16), .b(x10), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n138_), .c(x15), .O(new_n148_));
  ...
  oai21  g108(.a(new_n149_), .b(new_n152_), .c(new_n127_), .O(new_n153_));
  inv1   g109(.a(x13), .O(new_n154_));
  oai21  g110(.a(new_n130_), .b(new_n154_), .c(new_n128_), .O(new_n155_));
  nand2  g111(.a(x16), .b(x15), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n137_), .c(x19), .d(x14), .O(new_n157_));
  nor4   g113(.a(new_n157_), .b(new_n125_), .c(new_n46_), .d(new_n101_), .O(new_n158_));
  ...
  oai21  g116(.a(new_n145_), .b(new_n101_), .c(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n80_), .c(x00), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n49_), .O(z8));
  inv1   g119(.a(x00), .O(new_n164_));
  inv1   g120(.a(x33), .O(new_n165_));
  nand2  g121(.a(new_n126_), .b(x29), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n144_), .c(new_n165_), .d(new_n45_), .O(new_n167_));
  aoi21  g123(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(x17), .c(x16), .d(x15), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n156_), .c(new_n130_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n146_), .c(new_n142_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n170_), .b(new_n173_), .c(new_n136_), .O(new_n174_));
  oai21  g130(.a(new_n128_), .b(new_n152_), .c(new_n127_), .O(new_n175_));
  aoi21  g131(.a(new_n128_), .b(new_n154_), .c(x30), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n175_), .c(new_n174_), .d(new_n172_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n171_), .c(new_n169_), .d(new_n166_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n167_), .c(x31), .O(new_n181_));
  nor3   g137(.a(new_n165_), .b(new_n46_), .c(x30), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n181_), .c(new_n80_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n164_), .O(z9));
endmodule
