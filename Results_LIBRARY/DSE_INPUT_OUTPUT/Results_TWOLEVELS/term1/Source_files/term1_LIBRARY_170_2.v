...
module FAU ( 
  ...
  inv1   g060(.a(x27), .O(new_n105_));
  aoi21  g061(.a(x30), .b(new_n97_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(x30), .b(new_n104_), .c(x28), .d(x27), .O(new_n107_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n103_), .c(new_n61_), .d(x30), .O(new_n112_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n105_), .c(x31), .O(new_n121_));
  ...
  nand3  g083(.a(x32), .b(x29), .c(new_n97_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(x30), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x27), .O(new_n130_));
  inv1   g086(.a(x32), .O(new_n131_));
  nor2   g087(.a(x28), .b(x27), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n104_), .c(x30), .O(new_n133_));
  nand3  g089(.a(new_n45_), .b(x29), .c(x28), .O(new_n134_));
  ...
  oai21  g115(.a(new_n89_), .b(new_n159_), .c(new_n86_), .O(new_n160_));
  inv1   g116(.a(x14), .O(new_n161_));
  nand2  g117(.a(new_n89_), .b(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n144_), .b(x16), .c(x15), .O(new_n163_));
  nor2   g119(.a(new_n45_), .b(new_n104_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(x28), .c(new_n116_), .O(new_n165_));
  ...
  aoi22  g138(.a(new_n182_), .b(new_n83_), .c(new_n86_), .d(new_n159_), .O(new_n183_));
  ...
  oai21  g142(.a(new_n45_), .b(new_n97_), .c(x31), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n117_), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n105_), .c(new_n186_), .O(new_n189_));
  ...
  nand4  g149(.a(new_n120_), .b(new_n116_), .c(new_n45_), .d(new_n105_), .O(new_n194_));
  inv1   g150(.a(new_n194_), .O(new_n195_));
  nor4   g151(.a(new_n132_), .b(new_n116_), .c(new_n45_), .d(new_n104_), .O(new_n196_));
