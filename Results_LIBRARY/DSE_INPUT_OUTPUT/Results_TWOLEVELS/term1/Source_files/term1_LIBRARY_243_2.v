...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n60_), .d(new_n79_), .O(new_n107_));
  ...
  nand4  g080(.a(new_n104_), .b(new_n124_), .c(x30), .d(x29), .O(new_n125_));
  ...
  oai21  g094(.a(new_n135_), .b(new_n138_), .c(new_n82_), .O(new_n139_));
  ...
  oai21  g099(.a(x30), .b(new_n129_), .c(new_n143_), .O(new_n144_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n45_), .c(new_n129_), .O(new_n151_));
  nand2  g107(.a(new_n103_), .b(new_n80_), .O(new_n152_));
  ...
  nand4  g113(.a(new_n157_), .b(new_n45_), .c(x29), .d(new_n129_), .O(new_n158_));
  oai21  g114(.a(new_n149_), .b(new_n45_), .c(new_n158_), .O(new_n159_));
  nand3  g115(.a(x19), .b(new_n85_), .c(x13), .O(new_n160_));
  nand3  g116(.a(new_n88_), .b(x18), .c(x14), .O(new_n161_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n145_), .c(new_n88_), .O(new_n188_));
  ...
  oai21  g147(.a(new_n85_), .b(new_n138_), .c(new_n82_), .O(new_n192_));
