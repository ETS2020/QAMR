...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n59_), .c(new_n46_), .O(z4));
  ...
  nand4  g059(.a(new_n45_), .b(x28), .c(x27), .d(new_n103_), .O(new_n104_));
  oai21  g060(.a(new_n96_), .b(new_n45_), .c(new_n104_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(x29), .O(new_n106_));
  nand2  g062(.a(x30), .b(new_n94_), .O(new_n107_));
  ...
  oai21  g066(.a(x31), .b(x11), .c(new_n45_), .O(new_n111_));
  ...
  oai21  g092(.a(new_n136_), .b(new_n134_), .c(x30), .O(new_n137_));
  ...
  nand3  g097(.a(new_n141_), .b(new_n128_), .c(x11), .O(new_n142_));
  oai21  g098(.a(new_n137_), .b(new_n128_), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x15), .O(new_n144_));
  nor2   g100(.a(new_n128_), .b(x15), .O(new_n145_));
  nor2   g101(.a(new_n130_), .b(new_n129_), .O(new_n146_));
  nor2   g102(.a(new_n45_), .b(new_n132_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n146_), .c(new_n145_), .d(x10), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n144_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n127_), .c(x31), .O(new_n150_));
  nand2  g106(.a(x32), .b(new_n45_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n150_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n126_), .O(new_n153_));
  ...
  aoi21  g112(.a(new_n156_), .b(new_n154_), .c(new_n124_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n127_), .c(x31), .d(new_n45_), .O(new_n158_));
  nand2  g114(.a(new_n95_), .b(new_n81_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(x32), .c(x30), .O(new_n160_));
  oai21  g116(.a(new_n158_), .b(new_n128_), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n140_), .c(new_n155_), .O(new_n163_));
  nand3  g119(.a(new_n139_), .b(x17), .c(x11), .O(new_n164_));
  inv1   g120(.a(x12), .O(new_n165_));
  oai21  g121(.a(new_n138_), .b(new_n165_), .c(new_n129_), .O(new_n166_));
  inv1   g122(.a(x13), .O(new_n167_));
  oai21  g123(.a(new_n132_), .b(new_n167_), .c(new_n130_), .O(new_n168_));
  inv1   g124(.a(x14), .O(new_n169_));
  nand2  g125(.a(new_n132_), .b(new_n169_), .O(new_n170_));
  nor2   g126(.a(new_n128_), .b(new_n155_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n141_), .c(new_n119_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n170_), .c(new_n168_), .d(new_n166_), .O(new_n173_));
  aoi21  g129(.a(new_n164_), .b(new_n128_), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n163_), .c(new_n127_), .O(new_n175_));
  aoi21  g131(.a(new_n161_), .b(x29), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n153_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n80_), .c(x00), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n46_), .O(z8));
  inv1   g135(.a(x33), .O(new_n180_));
  nand3  g136(.a(new_n149_), .b(new_n180_), .c(x31), .O(new_n181_));
  ...
  nand2  g140(.a(new_n156_), .b(new_n154_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n180_), .c(new_n119_), .d(new_n45_), .O(new_n186_));
  oai22  g142(.a(new_n186_), .b(new_n128_), .c(new_n180_), .d(new_n119_), .O(new_n187_));
  aoi21  g143(.a(new_n132_), .b(x14), .c(new_n130_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  aoi21  g145(.a(new_n171_), .b(new_n146_), .c(x19), .O(new_n190_));
  inv1   g146(.a(new_n162_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n146_), .c(x15), .O(new_n192_));
  aoi21  g148(.a(new_n146_), .b(x11), .c(x16), .O(new_n193_));
  oai21  g149(.a(new_n130_), .b(new_n165_), .c(new_n129_), .O(new_n194_));
  nand2  g150(.a(new_n130_), .b(new_n167_), .O(new_n195_));
  xnor2a g151(.a(x31), .b(x30), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n195_), .c(new_n194_), .O(new_n197_));
  nor4   g153(.a(new_n197_), .b(new_n193_), .c(new_n192_), .d(new_n190_), .O(new_n198_));
  aoi21  g154(.a(new_n198_), .b(new_n189_), .c(new_n180_), .O(new_n199_));
  aoi21  g155(.a(new_n187_), .b(new_n126_), .c(new_n199_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n184_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n80_), .c(x00), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n46_), .O(z9));
endmodule
