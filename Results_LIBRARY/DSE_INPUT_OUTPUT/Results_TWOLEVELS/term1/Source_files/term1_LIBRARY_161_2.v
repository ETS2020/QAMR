...
module FAU ( 
  ...
  nand2  g009(.a(z0), .b(x30), .O(new_n54_));
  ...
  nand2  g031(.a(new_n75_), .b(new_n54_), .O(z2));
  inv1   g032(.a(x26), .O(new_n77_));
  inv1   g033(.a(x27), .O(new_n78_));
  nand2  g034(.a(z0), .b(x30), .O(new_n79_));
  ...
  nand4  g041(.a(new_n85_), .b(new_n79_), .c(new_n58_), .d(new_n78_), .O(new_n86_));
  inv1   g042(.a(new_n86_), .O(new_n87_));
  nand4  g043(.a(new_n87_), .b(new_n77_), .c(x25), .d(x01), .O(new_n88_));
  inv1   g044(.a(new_n88_), .O(z3));
  inv1   g045(.a(x25), .O(new_n90_));
  inv1   g046(.a(x28), .O(new_n91_));
  nand3  g047(.a(new_n79_), .b(new_n91_), .c(x27), .O(new_n92_));
  nand3  g048(.a(new_n54_), .b(x28), .c(new_n78_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n85_), .c(new_n58_), .d(new_n77_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n90_), .c(new_n57_), .O(z4));
  inv1   g052(.a(x29), .O(new_n97_));
  nor2   g053(.a(new_n91_), .b(new_n78_), .O(new_n98_));
  nand3  g054(.a(new_n97_), .b(x28), .c(x27), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n85_), .c(new_n58_), .d(new_n77_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x25), .c(x01), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n54_), .O(z5));
  inv1   g060(.a(x30), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x29), .c(x28), .O(new_n106_));
  nand3  g062(.a(x32), .b(x30), .c(new_n91_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  aoi21  g064(.a(x29), .b(x27), .c(z0), .O(new_n109_));
  aoi22  g065(.a(new_n109_), .b(x30), .c(new_n108_), .d(x27), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n84_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n58_), .c(new_n77_), .d(x25), .O(new_n112_));
  nor2   g068(.a(new_n112_), .b(new_n57_), .O(z6));
  inv1   g069(.a(x31), .O(new_n114_));
  nand3  g070(.a(new_n98_), .b(new_n114_), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x32), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x30), .O(new_n117_));
  nand3  g073(.a(new_n98_), .b(x30), .c(x29), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  inv1   g075(.a(new_n82_), .O(new_n120_));
  inv1   g076(.a(new_n83_), .O(new_n121_));
  nor2   g077(.a(new_n81_), .b(new_n80_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n121_), .c(new_n120_), .O(new_n123_));
  nand4  g079(.a(new_n58_), .b(new_n77_), .c(x25), .d(x01), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n123_), .c(new_n119_), .d(new_n117_), .O(z7));
  nand2  g082(.a(new_n91_), .b(new_n78_), .O(new_n127_));
  ...
  nand3  g101(.a(new_n145_), .b(z0), .c(x31), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n105_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n127_), .c(x29), .O(new_n148_));
  aoi21  g104(.a(new_n127_), .b(x29), .c(x30), .O(new_n149_));
  nand2  g105(.a(x16), .b(x10), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n138_), .c(new_n143_), .O(new_n151_));
  nor2   g107(.a(new_n131_), .b(new_n129_), .O(new_n152_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n128_), .O(new_n156_));
  aoi21  g112(.a(x19), .b(x13), .c(x18), .O(new_n157_));
  nor2   g113(.a(x19), .b(x14), .O(new_n158_));
  nand2  g114(.a(x16), .b(x15), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n138_), .c(x31), .O(new_n160_));
  nor3   g116(.a(new_n160_), .b(new_n158_), .c(new_n157_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n156_), .c(new_n154_), .d(new_n151_), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n149_), .c(x32), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n148_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n77_), .c(x00), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n54_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n145_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n114_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n127_), .c(x29), .O(new_n171_));
  nand2  g127(.a(new_n127_), .b(x29), .O(new_n172_));
  nand4  g128(.a(new_n145_), .b(new_n167_), .c(new_n114_), .d(new_n105_), .O(new_n173_));
  ...
  aoi21  g132(.a(new_n131_), .b(x14), .c(new_n129_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x17), .c(x16), .d(x15), .O(new_n178_));
  nand2  g134(.a(x18), .b(x17), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n159_), .c(new_n131_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n150_), .c(new_n143_), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n182_), .c(new_n137_), .O(new_n183_));
  nand2  g139(.a(x18), .b(x12), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n128_), .O(new_n185_));
  inv1   g141(.a(x13), .O(new_n186_));
  nand2  g142(.a(new_n129_), .b(new_n186_), .O(new_n187_));
  nand2  g143(.a(x31), .b(new_n105_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n185_), .d(new_n183_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n181_), .c(new_n180_), .d(new_n178_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n176_), .c(new_n171_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n77_), .c(x00), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n54_), .O(z9));
endmodule
