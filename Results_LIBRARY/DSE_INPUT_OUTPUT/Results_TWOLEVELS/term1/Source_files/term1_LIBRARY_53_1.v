...
module FAU ( 
  ...
  nor3   g060(.a(new_n104_), .b(new_n98_), .c(new_n59_), .O(z5));
  nand2  g061(.a(x29), .b(x28), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n101_), .b(x28), .c(x27), .O(new_n108_));
  ...
  nand2  g068(.a(new_n112_), .b(new_n47_), .O(z6));
  ...
  aoi22  g075(.a(new_n119_), .b(x27), .c(x31), .d(new_n81_), .O(new_n120_));
  ...
  nor2   g099(.a(new_n81_), .b(new_n100_), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(x27), .c(new_n143_), .d(new_n81_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n142_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nor2   g104(.a(new_n81_), .b(x29), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n101_), .c(x27), .O(new_n150_));
  nand2  g106(.a(new_n101_), .b(x28), .O(new_n151_));
  ...
  nand3  g119(.a(x16), .b(new_n163_), .c(x10), .O(new_n164_));
  ...
  nand2  g124(.a(new_n168_), .b(new_n147_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n80_), .c(x00), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(z8));
  nand2  g127(.a(new_n135_), .b(x14), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x18), .c(x17), .d(x16), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n163_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x17), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n138_), .c(new_n135_), .O(new_n176_));
  oai21  g132(.a(new_n175_), .b(new_n122_), .c(new_n163_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n175_), .b(new_n178_), .c(new_n126_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x12), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n131_), .c(new_n134_), .d(new_n133_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n179_), .c(new_n177_), .d(new_n176_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n174_), .c(new_n47_), .O(new_n183_));
  nand2  g139(.a(x30), .b(new_n100_), .O(new_n184_));
  oai21  g140(.a(x31), .b(new_n100_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n106_), .b(new_n117_), .c(x30), .O(new_n186_));
  ...
  aoi21  g145(.a(new_n160_), .b(new_n158_), .c(new_n163_), .O(new_n190_));
  nand3  g146(.a(new_n143_), .b(new_n117_), .c(new_n81_), .O(new_n191_));
  nand4  g147(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  oai21  g149(.a(new_n165_), .b(new_n190_), .c(new_n193_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(x33), .c(new_n189_), .O(new_n195_));
