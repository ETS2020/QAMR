...
module FAU ( 
  ...
  and2   g047(.a(new_n91_), .b(new_n83_), .O(new_n92_));
  ...
  oai21  g061(.a(new_n101_), .b(new_n96_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n91_), .c(new_n83_), .d(new_n82_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n95_), .c(new_n62_), .O(z5));
  inv1   g064(.a(x28), .O(new_n109_));
  oai21  g065(.a(new_n102_), .b(new_n109_), .c(x30), .O(new_n110_));
  nand3  g066(.a(new_n103_), .b(x29), .c(x28), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n110_), .c(x27), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n91_), .c(new_n83_), .d(new_n82_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x25), .c(x01), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n46_), .O(z6));
  nor4   g072(.a(new_n89_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n117_));
  nand4  g073(.a(new_n83_), .b(new_n82_), .c(x25), .d(x01), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n46_), .O(new_n119_));
  nand2  g075(.a(x31), .b(new_n103_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nor2   g077(.a(new_n102_), .b(new_n109_), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n121_), .c(x30), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n120_), .O(new_n124_));
  aoi21  g080(.a(new_n122_), .b(x27), .c(new_n121_), .O(new_n125_));
  aoi22  g081(.a(new_n125_), .b(x30), .c(new_n124_), .d(x27), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n119_), .O(z7));
  nor3   g083(.a(new_n103_), .b(new_n102_), .c(x28), .O(new_n128_));
  ...
  aoi21  g096(.a(new_n138_), .b(x12), .c(x17), .O(new_n141_));
  ...
  nor2   g101(.a(new_n145_), .b(new_n133_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  aoi21  g103(.a(new_n104_), .b(x28), .c(new_n121_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n147_), .c(new_n143_), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n141_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n140_), .c(new_n134_), .d(new_n130_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(x32), .O(new_n153_));
  nand2  g109(.a(new_n103_), .b(x29), .O(new_n154_));
  nand2  g110(.a(new_n109_), .b(new_n96_), .O(new_n155_));
  nand2  g111(.a(x30), .b(new_n102_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n155_), .c(new_n154_), .O(new_n157_));
  inv1   g113(.a(x17), .O(new_n158_));
  nand3  g114(.a(x19), .b(new_n136_), .c(x13), .O(new_n159_));
  nand3  g115(.a(new_n137_), .b(x18), .c(x14), .O(new_n160_));
  ...
  nand2  g129(.a(new_n173_), .b(new_n46_), .O(z8));
  nand2  g130(.a(new_n82_), .b(x00), .O(new_n175_));
  nand3  g131(.a(x33), .b(x30), .c(new_n109_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n96_), .O(new_n178_));
  aoi21  g134(.a(new_n166_), .b(new_n164_), .c(new_n131_), .O(new_n179_));
  inv1   g135(.a(new_n169_), .O(new_n180_));
  nand4  g136(.a(new_n155_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  nand3  g137(.a(new_n121_), .b(new_n103_), .c(new_n102_), .O(new_n182_));
  ...
  nand2  g142(.a(new_n121_), .b(x29), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n156_), .c(new_n120_), .O(new_n188_));
  nor3   g144(.a(new_n188_), .b(new_n146_), .c(new_n144_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n143_), .c(new_n186_), .d(new_n140_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n185_), .c(x33), .O(new_n191_));
  oai21  g147(.a(new_n184_), .b(x33), .c(new_n191_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n82_), .c(x00), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n178_), .O(z9));
endmodule
