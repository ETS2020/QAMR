...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n83_), .c(new_n82_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n81_), .c(new_n60_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n82_), .d(x25), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n60_), .c(new_n46_), .O(z4));
  nor2   g057(.a(new_n45_), .b(x28), .O(new_n102_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n95_), .c(new_n62_), .d(new_n82_), .O(new_n107_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n95_), .c(new_n62_), .d(x30), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n82_), .c(x25), .d(x01), .O(new_n114_));
  ...
  oai21  g091(.a(new_n132_), .b(new_n135_), .c(new_n86_), .O(new_n136_));
  ...
  nand2  g096(.a(new_n140_), .b(new_n126_), .O(new_n141_));
  ...
  nand3  g100(.a(new_n120_), .b(new_n45_), .c(new_n83_), .O(new_n145_));
  oai21  g101(.a(new_n144_), .b(new_n104_), .c(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n143_), .b(new_n46_), .c(new_n146_), .O(new_n147_));
  ...
  oai21  g108(.a(new_n152_), .b(new_n102_), .c(new_n83_), .O(new_n153_));
  oai21  g109(.a(new_n45_), .b(x29), .c(new_n153_), .O(new_n154_));
  nand3  g110(.a(x19), .b(new_n89_), .c(x13), .O(new_n155_));
  nand3  g111(.a(new_n92_), .b(x18), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n86_), .O(new_n157_));
  ...
  nand2  g126(.a(new_n92_), .b(x14), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x18), .c(x17), .d(x16), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n127_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n142_), .c(new_n92_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n128_), .c(new_n127_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n131_), .O(new_n178_));
  ...
  inv1   g140(.a(x28), .O(new_n185_));
  oai21  g141(.a(new_n45_), .b(new_n185_), .c(x31), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n117_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n83_), .c(new_n184_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n183_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  aoi21  g146(.a(new_n162_), .b(new_n160_), .c(new_n127_), .O(new_n191_));
  inv1   g147(.a(new_n165_), .O(new_n192_));
  nand4  g148(.a(new_n120_), .b(new_n116_), .c(new_n45_), .d(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n185_), .b(new_n83_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(x31), .c(x30), .d(x29), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  oai21  g152(.a(new_n192_), .b(new_n191_), .c(new_n196_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(x33), .c(new_n190_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n82_), .c(x00), .O(new_n199_));
