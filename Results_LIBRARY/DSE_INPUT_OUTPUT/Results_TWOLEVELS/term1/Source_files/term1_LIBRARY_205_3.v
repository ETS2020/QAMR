...
module FAU ( 
  ...
  oai21  g068(.a(new_n112_), .b(new_n59_), .c(new_n45_), .O(z6));
  ...
  nor3   g073(.a(new_n117_), .b(new_n60_), .c(new_n59_), .O(new_n118_));
  ...
  aoi21  g093(.a(new_n109_), .b(new_n102_), .c(new_n116_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n137_), .c(new_n135_), .d(new_n133_), .O(new_n139_));
  nor2   g095(.a(new_n139_), .b(new_n131_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n130_), .c(new_n126_), .d(new_n122_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  inv1   g099(.a(new_n110_), .O(new_n144_));
  aoi21  g100(.a(new_n109_), .b(x28), .c(x27), .O(new_n145_));
  oai22  g101(.a(new_n145_), .b(new_n102_), .c(new_n144_), .d(new_n109_), .O(new_n146_));
  nand3  g102(.a(x19), .b(new_n86_), .c(x13), .O(new_n147_));
  nand3  g103(.a(new_n89_), .b(x18), .c(x14), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n83_), .O(new_n149_));
  nand4  g105(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(x16), .O(new_n152_));
  nand3  g108(.a(new_n136_), .b(new_n127_), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x15), .O(new_n155_));
  nand4  g111(.a(new_n136_), .b(x16), .c(new_n123_), .d(x10), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n146_), .c(new_n143_), .d(x31), .O(new_n158_));
  ...
  nand2  g117(.a(new_n89_), .b(x14), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(x18), .c(x17), .d(x16), .O(new_n163_));
  nor2   g119(.a(new_n163_), .b(new_n123_), .O(new_n164_));
  nand2  g120(.a(x16), .b(x15), .O(new_n165_));
  nand2  g121(.a(x18), .b(x17), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n165_), .c(new_n89_), .O(new_n167_));
  oai21  g123(.a(new_n166_), .b(new_n124_), .c(new_n123_), .O(new_n168_));
  inv1   g124(.a(x11), .O(new_n169_));
  oai21  g125(.a(new_n166_), .b(new_n169_), .c(new_n127_), .O(new_n170_));
  nand2  g126(.a(x18), .b(x12), .O(new_n171_));
  aoi22  g127(.a(new_n171_), .b(new_n83_), .c(new_n86_), .d(new_n132_), .O(new_n172_));
  ...
  aoi21  g131(.a(new_n175_), .b(new_n116_), .c(x30), .O(new_n176_));
  nand2  g132(.a(new_n116_), .b(x30), .O(new_n177_));
  oai21  g133(.a(new_n144_), .b(new_n116_), .c(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n81_), .c(new_n176_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n174_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  aoi21  g137(.a(new_n153_), .b(new_n152_), .c(new_n123_), .O(new_n182_));
  inv1   g138(.a(new_n156_), .O(new_n183_));
  nand3  g139(.a(new_n144_), .b(x31), .c(x30), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  nor3   g141(.a(x31), .b(x30), .c(x28), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n185_), .c(new_n81_), .O(new_n187_));
  nand3  g143(.a(new_n116_), .b(new_n109_), .c(new_n102_), .O(new_n188_));
