...
module FAU ( 
  ...
  nor3   g051(.a(new_n95_), .b(new_n78_), .c(new_n58_), .O(z3));
  ...
  nor3   g057(.a(new_n101_), .b(new_n78_), .c(new_n58_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n93_), .c(new_n59_), .d(new_n79_), .O(new_n107_));
  ...
  oai21  g067(.a(new_n111_), .b(new_n80_), .c(new_n98_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n94_), .c(new_n79_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n58_), .c(new_n45_), .O(z6));
  nand4  g070(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n115_));
  nand2  g071(.a(new_n59_), .b(x01), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(x31), .c(x26), .d(new_n78_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n46_), .O(z7));
  ...
  nand3  g102(.a(x19), .b(new_n87_), .c(x13), .O(new_n147_));
  nand3  g103(.a(new_n90_), .b(x18), .c(x14), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n84_), .O(new_n149_));
  nand4  g105(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n149_), .c(x16), .O(new_n152_));
  inv1   g108(.a(new_n120_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n123_), .c(x11), .O(new_n154_));
  ...
  nand2  g119(.a(new_n90_), .b(x14), .O(new_n164_));
  ...
  oai21  g123(.a(new_n167_), .b(new_n132_), .c(new_n90_), .O(new_n168_));
  oai21  g124(.a(new_n167_), .b(new_n119_), .c(new_n157_), .O(new_n169_));
  inv1   g125(.a(x11), .O(new_n170_));
  oai21  g126(.a(new_n167_), .b(new_n170_), .c(new_n123_), .O(new_n171_));
  nand2  g127(.a(x18), .b(x12), .O(new_n172_));
  aoi22  g128(.a(new_n172_), .b(new_n84_), .c(new_n87_), .d(new_n129_), .O(new_n173_));
  ...
  inv1   g131(.a(x31), .O(new_n176_));
  nand2  g132(.a(new_n144_), .b(x29), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  nand2  g134(.a(new_n111_), .b(x31), .O(new_n179_));
  oai21  g135(.a(x31), .b(new_n98_), .c(new_n179_), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n80_), .c(new_n178_), .d(new_n98_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n175_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  aoi21  g139(.a(new_n154_), .b(new_n152_), .c(new_n157_), .O(new_n184_));
  inv1   g140(.a(new_n158_), .O(new_n185_));
  nand4  g141(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nor3   g143(.a(x31), .b(x30), .c(x28), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(new_n80_), .O(new_n189_));
  nand3  g145(.a(new_n176_), .b(new_n98_), .c(new_n104_), .O(new_n190_));
