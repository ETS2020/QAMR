...
module FAU ( 
  ...
  oai21  g054(.a(new_n98_), .b(new_n58_), .c(new_n46_), .O(z4));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n60_), .d(new_n80_), .O(new_n106_));
  ...
  inv1   g078(.a(new_n103_), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(x30), .c(x29), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n80_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(new_n79_), .O(new_n127_));
  ...
  nand3  g087(.a(new_n131_), .b(new_n110_), .c(x29), .O(new_n132_));
  nor2   g088(.a(new_n130_), .b(new_n101_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n110_), .c(new_n132_), .O(new_n134_));
  nand3  g090(.a(x19), .b(new_n86_), .c(x13), .O(new_n135_));
  nand3  g091(.a(new_n89_), .b(x18), .c(x14), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n83_), .O(new_n137_));
  nand4  g093(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n138_));
  ...
  nand2  g108(.a(new_n117_), .b(x27), .O(new_n153_));
  oai21  g109(.a(x30), .b(x27), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n102_), .O(new_n155_));
  ...
  oai21  g116(.a(new_n142_), .b(new_n160_), .c(new_n83_), .O(new_n161_));
  ...
  aoi21  g123(.a(new_n117_), .b(x28), .c(new_n167_), .O(new_n168_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n124_), .d(new_n110_), .O(new_n182_));
  ...
  oai21  g145(.a(new_n189_), .b(new_n188_), .c(new_n89_), .O(new_n190_));
  ...
  oai21  g149(.a(new_n86_), .b(new_n160_), .c(new_n83_), .O(new_n194_));
  nand2  g150(.a(new_n86_), .b(new_n162_), .O(new_n195_));
  ...
  nand3  g157(.a(new_n201_), .b(new_n80_), .c(x00), .O(new_n202_));
