...
module FAU ( 
  ...
  nand2  g000(.a(x29), .b(x27), .O(new_n45_));
  ...
  oai21  g046(.a(new_n90_), .b(new_n59_), .c(new_n45_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n89_), .c(new_n80_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n59_), .c(new_n45_), .O(z4));
  inv1   g050(.a(x28), .O(new_n95_));
  inv1   g051(.a(x29), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(new_n81_), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n89_), .c(new_n80_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n59_), .c(new_n45_), .O(z5));
  nand3  g055(.a(new_n89_), .b(new_n45_), .c(x30), .O(new_n100_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n84_), .O(new_n107_));
  inv1   g063(.a(x31), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n80_), .c(x25), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n60_), .c(new_n59_), .O(new_n110_));
  aoi21  g066(.a(new_n110_), .b(new_n107_), .c(new_n46_), .O(z7));
  nand2  g067(.a(x16), .b(x10), .O(new_n112_));
  nand3  g068(.a(x19), .b(x18), .c(x17), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(x15), .O(new_n115_));
  inv1   g071(.a(x16), .O(new_n116_));
  nand2  g072(.a(x19), .b(x18), .O(new_n117_));
  nand2  g073(.a(x17), .b(x11), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n116_), .O(new_n119_));
  inv1   g075(.a(x12), .O(new_n120_));
  inv1   g076(.a(x17), .O(new_n121_));
  oai21  g077(.a(new_n117_), .b(new_n120_), .c(new_n121_), .O(new_n122_));
  inv1   g078(.a(x13), .O(new_n123_));
  inv1   g079(.a(x18), .O(new_n124_));
  inv1   g080(.a(x19), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n124_), .O(new_n126_));
  nor2   g082(.a(x19), .b(x14), .O(new_n127_));
  nand2  g083(.a(x16), .b(x15), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n113_), .c(x31), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n126_), .c(new_n122_), .d(new_n119_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n115_), .c(new_n45_), .O(new_n132_));
  inv1   g088(.a(x30), .O(new_n133_));
  nand3  g089(.a(x30), .b(x29), .c(x28), .O(new_n134_));
  oai21  g090(.a(x30), .b(x28), .c(new_n134_), .O(new_n135_));
  aoi22  g091(.a(new_n135_), .b(new_n81_), .c(new_n133_), .d(new_n96_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n132_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x32), .O(new_n138_));
  inv1   g094(.a(x32), .O(new_n139_));
  nand2  g095(.a(x30), .b(new_n95_), .O(new_n140_));
  nand3  g096(.a(new_n133_), .b(x29), .c(x28), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n140_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n81_), .O(new_n143_));
  oai21  g099(.a(new_n133_), .b(x29), .c(new_n143_), .O(new_n144_));
  nand3  g100(.a(x19), .b(new_n124_), .c(x13), .O(new_n145_));
  nand3  g101(.a(new_n125_), .b(x18), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n121_), .O(new_n147_));
  ...
  inv1   g106(.a(new_n113_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n116_), .c(x11), .O(new_n152_));
  ...
  nand4  g113(.a(new_n157_), .b(new_n144_), .c(new_n139_), .d(x31), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n138_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n80_), .c(x00), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(z8));
  nand2  g117(.a(new_n125_), .b(x14), .O(new_n162_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n128_), .c(new_n125_), .O(new_n166_));
  oai21  g122(.a(new_n165_), .b(new_n112_), .c(new_n155_), .O(new_n167_));
  inv1   g123(.a(x11), .O(new_n168_));
  oai21  g124(.a(new_n165_), .b(new_n168_), .c(new_n116_), .O(new_n169_));
  nand2  g125(.a(x18), .b(x12), .O(new_n170_));
  aoi22  g126(.a(new_n170_), .b(new_n121_), .c(new_n124_), .d(new_n123_), .O(new_n171_));
  ...
  nand2  g129(.a(new_n108_), .b(new_n133_), .O(new_n174_));
  nand2  g130(.a(x31), .b(new_n133_), .O(new_n175_));
  nand3  g131(.a(new_n108_), .b(x29), .c(x28), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n175_), .c(new_n140_), .O(new_n177_));
  aoi22  g133(.a(new_n177_), .b(new_n81_), .c(new_n174_), .d(new_n96_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n173_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  aoi21  g136(.a(new_n152_), .b(new_n150_), .c(new_n155_), .O(new_n181_));
  inv1   g137(.a(new_n156_), .O(new_n182_));
  nand4  g138(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n183_));
  oai21  g139(.a(new_n174_), .b(x28), .c(new_n183_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n81_), .O(new_n185_));
  oai21  g141(.a(new_n174_), .b(x29), .c(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n182_), .b(new_n181_), .c(new_n186_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(x33), .c(new_n180_), .O(new_n188_));
