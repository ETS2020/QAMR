...
module FAU ( 
  ...
  nand3  g051(.a(new_n95_), .b(new_n90_), .c(new_n45_), .O(new_n96_));
  ...
  nand4  g075(.a(new_n119_), .b(new_n118_), .c(new_n117_), .d(new_n84_), .O(new_n120_));
  nand3  g076(.a(new_n80_), .b(x25), .c(x01), .O(new_n121_));
  ...
  nand2  g081(.a(new_n51_), .b(x02), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n48_), .O(new_n127_));
  aoi21  g083(.a(new_n125_), .b(new_n110_), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g134(.a(new_n154_), .b(new_n123_), .c(new_n109_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n149_), .c(new_n45_), .d(new_n80_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n177_), .O(z9));
endmodule
