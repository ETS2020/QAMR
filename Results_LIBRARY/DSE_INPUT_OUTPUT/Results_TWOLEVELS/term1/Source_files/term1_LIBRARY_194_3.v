...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n61_), .c(new_n59_), .O(z4));
  ...
  aoi21  g060(.a(new_n104_), .b(new_n102_), .c(new_n94_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n63_), .c(new_n82_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x25), .c(x01), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n59_), .O(z5));
  nor2   g065(.a(new_n103_), .b(new_n101_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x27), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n46_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n95_), .c(new_n82_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n61_), .c(new_n59_), .O(z6));
  inv1   g070(.a(new_n83_), .O(new_n115_));
  nand4  g071(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n115_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(new_n82_), .c(x25), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n62_), .c(new_n61_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n116_), .c(new_n47_), .O(z7));
  aoi21  g076(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x17), .c(x16), .d(x15), .O(new_n122_));
  nand3  g078(.a(x30), .b(x29), .c(x28), .O(new_n123_));
  oai21  g079(.a(x30), .b(x28), .c(new_n123_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n45_), .O(new_n125_));
  nand4  g081(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n126_));
  and2   g082(.a(new_n126_), .b(new_n90_), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  inv1   g084(.a(x15), .O(new_n129_));
  nand4  g085(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n130_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n84_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  nand2  g092(.a(new_n87_), .b(new_n136_), .O(new_n137_));
  aoi21  g093(.a(new_n46_), .b(new_n103_), .c(new_n117_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n137_), .c(new_n135_), .d(new_n133_), .O(new_n139_));
  aoi21  g095(.a(new_n130_), .b(new_n129_), .c(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n128_), .c(new_n125_), .d(new_n122_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  aoi21  g099(.a(new_n46_), .b(x28), .c(x27), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(new_n103_), .c(new_n110_), .d(new_n46_), .O(new_n145_));
  nand3  g101(.a(x19), .b(new_n87_), .c(x13), .O(new_n146_));
  nand3  g102(.a(new_n90_), .b(x18), .c(x14), .O(new_n147_));
  ...
  nand3  g107(.a(x19), .b(x18), .c(x17), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n131_), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nand3  g112(.a(x16), .b(new_n129_), .c(x10), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n152_), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n156_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n145_), .c(new_n143_), .d(x31), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n142_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n82_), .c(x00), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n59_), .O(z8));
  nand4  g120(.a(x33), .b(x29), .c(new_n82_), .d(x00), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n46_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x27), .O(new_n167_));
  aoi21  g123(.a(new_n154_), .b(new_n151_), .c(new_n129_), .O(new_n168_));
  oai21  g124(.a(x28), .b(x27), .c(x29), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n117_), .c(new_n46_), .O(new_n170_));
  nand3  g126(.a(new_n110_), .b(x31), .c(x30), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  oai21  g128(.a(new_n158_), .b(new_n168_), .c(new_n172_), .O(new_n173_));
  oai21  g129(.a(new_n110_), .b(x30), .c(new_n117_), .O(new_n174_));
  nand2  g130(.a(new_n123_), .b(x31), .O(new_n175_));
  nand2  g131(.a(new_n130_), .b(new_n129_), .O(new_n176_));
  nand4  g132(.a(new_n137_), .b(new_n135_), .c(new_n133_), .d(new_n176_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n127_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n175_), .c(new_n174_), .d(new_n122_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  oai21  g136(.a(new_n173_), .b(x33), .c(new_n180_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n82_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n167_), .O(z9));
endmodule
