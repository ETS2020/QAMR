...
module FAU ( 
  ...
  wire new_n45_, new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_,
    ...
    new_n199_;
  nand2  g000(.a(x31), .b(x26), .O(new_n45_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n93_), .c(new_n59_), .d(new_n79_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n78_), .c(new_n57_), .O(z6));
  nor2   g070(.a(new_n110_), .b(new_n99_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n101_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  nand4  g073(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n118_));
  nor2   g074(.a(new_n58_), .b(new_n57_), .O(new_n119_));
  ...
  nor2   g079(.a(new_n123_), .b(new_n78_), .O(new_n124_));
  ...
  nand3  g084(.a(new_n128_), .b(new_n110_), .c(x29), .O(new_n129_));
  nor2   g085(.a(new_n127_), .b(new_n99_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n110_), .c(new_n129_), .O(new_n131_));
  ...
  nand2  g105(.a(new_n115_), .b(x27), .O(new_n150_));
  oai21  g106(.a(x30), .b(x27), .c(new_n150_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n100_), .O(new_n152_));
  ...
  oai21  g113(.a(new_n139_), .b(new_n157_), .c(new_n84_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  oai21  g115(.a(new_n90_), .b(new_n159_), .c(new_n87_), .O(new_n160_));
  ...
  aoi21  g120(.a(new_n115_), .b(x28), .c(new_n164_), .O(new_n165_));
  ...
  nand4  g134(.a(new_n148_), .b(new_n173_), .c(new_n121_), .d(new_n110_), .O(new_n179_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n185_), .c(new_n90_), .O(new_n187_));
  ...
  oai21  g146(.a(new_n87_), .b(new_n157_), .c(new_n84_), .O(new_n191_));
  nand2  g147(.a(new_n87_), .b(new_n159_), .O(new_n192_));
