...
module FAU ( 
  ...
  nand4  g030(.a(x06), .b(x05), .c(new_n54_), .d(new_n53_), .O(new_n75_));
  ...
  nand2  g049(.a(new_n49_), .b(x30), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n93_), .c(x27), .O(new_n95_));
  nand3  g051(.a(new_n48_), .b(x28), .c(new_n82_), .O(new_n96_));
  ...
  nand3  g064(.a(x33), .b(x30), .c(new_n93_), .O(new_n109_));
  ...
  oai21  g070(.a(new_n114_), .b(new_n60_), .c(new_n48_), .O(z6));
  nor4   g071(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n116_));
  nand3  g072(.a(new_n81_), .b(x25), .c(x01), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(new_n116_), .c(new_n48_), .O(new_n118_));
  nand2  g074(.a(new_n49_), .b(x30), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x03), .c(x02), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand3  g077(.a(x29), .b(x28), .c(x27), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(x33), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(x30), .c(new_n121_), .O(new_n124_));
  nor4   g080(.a(new_n122_), .b(new_n49_), .c(x31), .d(new_n45_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n120_), .c(new_n118_), .O(z7));
  ...
  nor2   g087(.a(new_n129_), .b(new_n101_), .O(new_n132_));
  ...
  aoi21  g108(.a(x33), .b(x28), .c(x27), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n45_), .c(new_n101_), .O(new_n154_));
  inv1   g110(.a(new_n132_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n45_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n145_), .c(new_n134_), .O(new_n158_));
  nor2   g114(.a(new_n138_), .b(new_n136_), .O(new_n159_));
  ...
  oai21  g121(.a(new_n165_), .b(new_n145_), .c(x31), .O(new_n166_));
  nor4   g122(.a(new_n166_), .b(new_n164_), .c(new_n163_), .d(new_n162_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n161_), .c(new_n158_), .d(new_n156_), .O(new_n168_));
  ...
  oai21  g128(.a(new_n150_), .b(new_n148_), .c(new_n49_), .O(new_n173_));
  nand2  g129(.a(x33), .b(x31), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(x31), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n155_), .O(new_n176_));
  aoi21  g132(.a(new_n138_), .b(x14), .c(new_n136_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x17), .c(x16), .d(x15), .O(new_n178_));
  nand3  g134(.a(new_n130_), .b(new_n121_), .c(x29), .O(new_n179_));
  nand2  g135(.a(x18), .b(x17), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n165_), .c(new_n138_), .O(new_n181_));
  or2    g137(.a(new_n180_), .b(new_n157_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n144_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n135_), .O(new_n186_));
  inv1   g142(.a(x13), .O(new_n187_));
  nand2  g143(.a(new_n136_), .b(new_n187_), .O(new_n188_));
  nand2  g144(.a(x31), .b(new_n45_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n188_), .c(new_n186_), .d(new_n184_), .O(new_n190_));
  aoi21  g146(.a(new_n182_), .b(new_n134_), .c(new_n190_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n181_), .c(new_n179_), .d(new_n178_), .O(new_n192_));
  aoi22  g148(.a(new_n192_), .b(x33), .c(new_n121_), .d(x30), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n176_), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n81_), .c(x00), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n48_), .O(z9));
endmodule
