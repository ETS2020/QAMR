...
module FAU ( 
  ...
  and2   g043(.a(new_n87_), .b(new_n59_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n79_), .c(new_n78_), .d(x25), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(new_n57_), .c(new_n45_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand4  g047(.a(new_n91_), .b(new_n88_), .c(new_n78_), .d(x25), .O(new_n92_));
  oai21  g048(.a(new_n92_), .b(new_n57_), .c(new_n45_), .O(z4));
  inv1   g049(.a(x25), .O(new_n94_));
  inv1   g050(.a(x29), .O(new_n95_));
  inv1   g051(.a(x28), .O(new_n96_));
  inv1   g052(.a(x30), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n96_), .c(new_n79_), .O(new_n98_));
  nand4  g054(.a(new_n97_), .b(new_n95_), .c(x28), .d(x27), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n95_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n87_), .c(new_n59_), .d(new_n78_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n94_), .c(new_n57_), .O(z5));
  nand4  g058(.a(new_n97_), .b(x29), .c(x28), .d(x27), .O(new_n103_));
  oai21  g059(.a(new_n97_), .b(x27), .c(new_n103_), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(new_n88_), .c(new_n78_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n94_), .c(new_n57_), .O(z6));
  inv1   g062(.a(new_n84_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n83_), .c(new_n81_), .O(new_n108_));
  inv1   g064(.a(x31), .O(new_n109_));
  nand3  g065(.a(new_n45_), .b(new_n109_), .c(new_n78_), .O(new_n110_));
  nor4   g066(.a(new_n110_), .b(new_n58_), .c(new_n94_), .d(new_n57_), .O(new_n111_));
  oai21  g067(.a(new_n108_), .b(new_n85_), .c(new_n111_), .O(z7));
  inv1   g068(.a(x32), .O(new_n113_));
  aoi21  g069(.a(new_n97_), .b(x28), .c(x27), .O(new_n114_));
  nor2   g070(.a(new_n95_), .b(new_n96_), .O(new_n115_));
  oai22  g071(.a(new_n115_), .b(new_n97_), .c(new_n114_), .d(new_n95_), .O(new_n116_));
  ...
  oai21  g128(.a(new_n115_), .b(new_n109_), .c(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n79_), .c(new_n171_), .O(new_n174_));
  ...
  nand3  g134(.a(new_n115_), .b(x31), .c(x30), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  nor3   g136(.a(x31), .b(x30), .c(x28), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n180_), .c(new_n79_), .O(new_n182_));
