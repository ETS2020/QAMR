...
module FAU ( 
  ...
  oai21  g057(.a(new_n98_), .b(new_n93_), .c(new_n101_), .O(new_n102_));
  ...
  aoi21  g067(.a(new_n111_), .b(new_n108_), .c(new_n88_), .O(new_n112_));
  ...
  nand2  g073(.a(x31), .b(new_n105_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nor2   g075(.a(new_n110_), .b(new_n109_), .O(new_n120_));
  ...
  nand2  g102(.a(new_n105_), .b(new_n110_), .O(new_n147_));
  oai21  g103(.a(new_n99_), .b(x28), .c(new_n147_), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(x27), .c(new_n100_), .d(x28), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n146_), .c(new_n142_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  aoi21  g108(.a(new_n109_), .b(new_n93_), .c(new_n110_), .O(new_n153_));
  nand3  g109(.a(new_n105_), .b(x29), .c(x27), .O(new_n154_));
  oai21  g110(.a(new_n153_), .b(new_n105_), .c(new_n154_), .O(new_n155_));
  ...
  nand3  g128(.a(x33), .b(x30), .c(new_n109_), .O(new_n173_));
  ...
  nand2  g133(.a(new_n109_), .b(new_n93_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand3  g135(.a(new_n119_), .b(new_n105_), .c(new_n110_), .O(new_n180_));
  ...
  nand2  g142(.a(x30), .b(new_n110_), .O(new_n187_));
