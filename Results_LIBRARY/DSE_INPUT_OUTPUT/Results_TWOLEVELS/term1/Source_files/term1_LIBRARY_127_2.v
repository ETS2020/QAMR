...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(x31), .c(x29), .O(new_n98_));
  nand3  g054(.a(new_n45_), .b(x28), .c(x27), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n90_), .c(new_n62_), .d(new_n81_), .O(new_n101_));
  ...
  oai21  g064(.a(new_n108_), .b(new_n97_), .c(new_n106_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n90_), .c(new_n62_), .d(new_n81_), .O(new_n110_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n90_), .c(new_n62_), .d(x29), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n81_), .c(x25), .d(x01), .O(new_n120_));
  ...
  nand3  g104(.a(new_n148_), .b(new_n130_), .c(new_n107_), .O(new_n149_));
  nand3  g105(.a(x32), .b(x31), .c(x30), .O(new_n150_));
  ...
  nand2  g110(.a(x32), .b(new_n107_), .O(new_n155_));
  ...
  aoi21  g115(.a(new_n159_), .b(new_n142_), .c(x15), .O(new_n160_));
  nor2   g116(.a(new_n134_), .b(new_n132_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x17), .c(x11), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n140_), .O(new_n163_));
  nand2  g119(.a(new_n161_), .b(x12), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n131_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  oai21  g122(.a(new_n134_), .b(new_n166_), .c(new_n132_), .O(new_n167_));
  nor2   g123(.a(x19), .b(x14), .O(new_n168_));
  nand2  g124(.a(x16), .b(x15), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n142_), .c(new_n168_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n167_), .c(new_n165_), .d(new_n163_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n160_), .c(x32), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n157_), .c(new_n152_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n81_), .c(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n127_), .O(z8));
  nand2  g132(.a(new_n134_), .b(x14), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x18), .c(x17), .d(x16), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n146_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x17), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n169_), .c(new_n134_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n158_), .c(new_n146_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n140_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(new_n131_), .c(new_n132_), .d(new_n166_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n184_), .c(new_n182_), .d(new_n181_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n179_), .c(new_n58_), .O(new_n188_));
  nand2  g144(.a(new_n129_), .b(x30), .O(new_n189_));
  aoi22  g145(.a(new_n189_), .b(x31), .c(x30), .d(new_n45_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n188_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand4  g148(.a(new_n129_), .b(x31), .c(x30), .d(x29), .O(new_n193_));
  nand3  g149(.a(new_n124_), .b(new_n107_), .c(new_n45_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n148_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(x33), .c(new_n192_), .O(new_n197_));
