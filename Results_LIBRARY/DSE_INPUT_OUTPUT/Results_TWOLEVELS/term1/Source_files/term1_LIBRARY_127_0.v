...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n57_), .c(new_n81_), .O(new_n91_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n112_));
  ...
  nor4   g073(.a(new_n89_), .b(x27), .c(x26), .d(new_n117_), .O(new_n118_));
  nor2   g074(.a(new_n109_), .b(new_n98_), .O(new_n119_));
  nand2  g075(.a(new_n119_), .b(x28), .O(new_n120_));
  aoi21  g076(.a(new_n118_), .b(x01), .c(new_n120_), .O(new_n121_));
  nor4   g077(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n82_), .O(new_n122_));
  nor2   g078(.a(new_n60_), .b(new_n59_), .O(new_n123_));
  nand3  g079(.a(new_n100_), .b(new_n116_), .c(x30), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n123_), .c(new_n80_), .d(x25), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n122_), .c(x29), .O(new_n126_));
  oai21  g082(.a(new_n121_), .b(new_n116_), .c(new_n126_), .O(z7));
  nand3  g083(.a(x32), .b(new_n80_), .c(x00), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x29), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n116_), .O(new_n130_));
  nand2  g086(.a(new_n99_), .b(new_n81_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n109_), .c(x29), .O(new_n132_));
  nand3  g088(.a(x30), .b(new_n99_), .c(new_n81_), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n132_), .c(new_n116_), .O(new_n134_));
  nor2   g090(.a(new_n109_), .b(x29), .O(new_n135_));
  ...
  oai21  g111(.a(new_n135_), .b(new_n134_), .c(new_n155_), .O(new_n156_));
  inv1   g112(.a(new_n119_), .O(new_n157_));
  nand2  g113(.a(new_n109_), .b(new_n81_), .O(new_n158_));
  oai21  g114(.a(new_n157_), .b(new_n81_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n99_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x10), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n148_), .c(new_n153_), .O(new_n162_));
  ...
  aoi22  g127(.a(new_n171_), .b(new_n149_), .c(new_n139_), .d(new_n169_), .O(new_n172_));
  inv1   g128(.a(new_n120_), .O(new_n173_));
  aoi21  g129(.a(new_n109_), .b(new_n98_), .c(new_n173_), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(new_n172_), .c(new_n168_), .d(new_n166_), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x32), .O(new_n178_));
  oai21  g134(.a(new_n156_), .b(x32), .c(new_n178_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n80_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n130_), .O(z8));
  inv1   g137(.a(new_n131_), .O(new_n182_));
  inv1   g138(.a(x33), .O(new_n183_));
  nand4  g139(.a(new_n155_), .b(new_n183_), .c(x31), .d(x30), .O(new_n184_));
  nand2  g140(.a(x33), .b(new_n116_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n184_), .c(new_n182_), .O(new_n186_));
  nand2  g142(.a(x33), .b(x18), .O(new_n187_));
  nor2   g143(.a(x27), .b(x18), .O(new_n188_));
  nor2   g144(.a(x30), .b(x28), .O(new_n189_));
  nor2   g145(.a(x33), .b(x31), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(x13), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n187_), .c(new_n139_), .O(new_n192_));
  nand2  g148(.a(x33), .b(new_n169_), .O(new_n193_));
  nor2   g149(.a(x27), .b(x19), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n190_), .c(new_n189_), .d(x14), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n193_), .c(new_n137_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n192_), .c(x17), .O(new_n197_));
  nor3   g153(.a(x33), .b(x31), .c(x30), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n143_), .c(new_n182_), .O(new_n199_));
  aoi21  g155(.a(new_n199_), .b(new_n197_), .c(new_n145_), .O(new_n200_));
  nand2  g156(.a(new_n198_), .b(new_n182_), .O(new_n201_));
  nor2   g157(.a(new_n201_), .b(new_n150_), .O(new_n202_));
  oai21  g158(.a(new_n202_), .b(new_n200_), .c(x15), .O(new_n203_));
  nand2  g159(.a(x33), .b(x30), .O(new_n204_));
  inv1   g160(.a(x10), .O(new_n205_));
  nor2   g161(.a(x15), .b(new_n205_), .O(new_n206_));
  nor2   g162(.a(new_n136_), .b(new_n145_), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(new_n206_), .c(new_n198_), .d(new_n147_), .O(new_n208_));
  aoi21  g164(.a(new_n208_), .b(new_n204_), .c(x28), .O(new_n209_));
  nand2  g165(.a(x18), .b(x17), .O(new_n210_));
  oai21  g166(.a(new_n210_), .b(new_n170_), .c(new_n139_), .O(new_n211_));
  oai21  g167(.a(new_n210_), .b(new_n161_), .c(new_n153_), .O(new_n212_));
  inv1   g168(.a(x11), .O(new_n213_));
  oai21  g169(.a(new_n210_), .b(new_n213_), .c(new_n145_), .O(new_n214_));
  nand2  g170(.a(x18), .b(x12), .O(new_n215_));
  aoi22  g171(.a(new_n215_), .b(new_n136_), .c(new_n137_), .d(new_n167_), .O(new_n216_));
  nand4  g172(.a(new_n216_), .b(new_n214_), .c(new_n212_), .d(new_n211_), .O(new_n217_));
  aoi22  g173(.a(new_n217_), .b(x33), .c(new_n209_), .d(new_n81_), .O(new_n218_));
  nand2  g174(.a(new_n218_), .b(new_n203_), .O(new_n219_));
  oai21  g175(.a(new_n219_), .b(new_n186_), .c(x29), .O(new_n220_));
  nand3  g176(.a(new_n157_), .b(x33), .c(x31), .O(new_n221_));
