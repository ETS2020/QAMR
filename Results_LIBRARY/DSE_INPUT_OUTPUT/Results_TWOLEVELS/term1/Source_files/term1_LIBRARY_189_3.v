...
module FAU ( 
  ...
  aoi21  g047(.a(new_n90_), .b(new_n49_), .c(new_n91_), .O(new_n92_));
  ...
  nor2   g053(.a(new_n97_), .b(new_n61_), .O(z4));
  ...
  oai21  g058(.a(new_n46_), .b(new_n45_), .c(new_n90_), .O(new_n103_));
  ...
  nor2   g066(.a(new_n110_), .b(new_n61_), .O(z5));
  nand2  g067(.a(x30), .b(new_n106_), .O(new_n112_));
  nand3  g068(.a(new_n100_), .b(new_n46_), .c(x29), .O(new_n113_));
  nor3   g069(.a(new_n91_), .b(new_n88_), .c(new_n86_), .O(new_n114_));
  aoi22  g070(.a(new_n114_), .b(new_n85_), .c(new_n113_), .d(new_n112_), .O(new_n115_));
  nand4  g071(.a(new_n101_), .b(new_n90_), .c(x29), .d(new_n45_), .O(new_n116_));
  inv1   g072(.a(x17), .O(new_n117_));
  nand2  g073(.a(new_n83_), .b(new_n117_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n46_), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n115_), .c(new_n63_), .O(new_n120_));
  oai21  g076(.a(x22), .b(x03), .c(x02), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x30), .c(new_n99_), .d(new_n117_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n82_), .c(x25), .d(x01), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n49_), .O(z6));
  inv1   g081(.a(x31), .O(new_n126_));
  nand3  g082(.a(new_n100_), .b(new_n126_), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n45_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x30), .O(new_n129_));
  nor2   g085(.a(new_n46_), .b(new_n106_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n100_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x31), .O(new_n132_));
  nand4  g088(.a(new_n102_), .b(new_n89_), .c(new_n87_), .d(new_n85_), .O(new_n133_));
  ...
  nand3  g095(.a(new_n139_), .b(new_n46_), .c(x29), .O(new_n140_));
  nor2   g096(.a(new_n138_), .b(new_n106_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n46_), .c(new_n140_), .O(new_n142_));
  ...
  aoi21  g102(.a(new_n146_), .b(new_n144_), .c(new_n117_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n117_), .d(x12), .O(new_n148_));
  ...
  nand3  g111(.a(new_n155_), .b(new_n151_), .c(x11), .O(new_n156_));
  ...
  nand4  g117(.a(new_n161_), .b(new_n142_), .c(new_n137_), .d(x31), .O(new_n162_));
  nand2  g118(.a(new_n130_), .b(x27), .O(new_n163_));
  oai21  g119(.a(x30), .b(x27), .c(new_n163_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n99_), .O(new_n165_));
  nand2  g121(.a(x16), .b(x10), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n154_), .c(new_n159_), .O(new_n167_));
  nand2  g123(.a(x17), .b(x11), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n152_), .c(new_n151_), .O(new_n169_));
  inv1   g125(.a(x12), .O(new_n170_));
  oai21  g126(.a(new_n152_), .b(new_n170_), .c(new_n117_), .O(new_n171_));
  inv1   g127(.a(x13), .O(new_n172_));
  oai21  g128(.a(new_n145_), .b(new_n172_), .c(new_n143_), .O(new_n173_));
  nor2   g129(.a(x19), .b(x14), .O(new_n174_));
  nor2   g130(.a(new_n151_), .b(new_n159_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n155_), .c(new_n174_), .O(new_n176_));
  oai21  g132(.a(x30), .b(x29), .c(x31), .O(new_n177_));
  aoi21  g133(.a(new_n130_), .b(x28), .c(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n176_), .c(new_n173_), .d(new_n171_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n169_), .c(new_n167_), .d(new_n165_), .O(new_n181_));
  ...
  nand4  g142(.a(new_n161_), .b(new_n186_), .c(x31), .d(x30), .O(new_n187_));
  nand2  g143(.a(x33), .b(new_n126_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n139_), .c(x29), .O(new_n190_));
  inv1   g146(.a(new_n141_), .O(new_n191_));
  nand4  g147(.a(new_n161_), .b(new_n186_), .c(new_n126_), .d(new_n46_), .O(new_n192_));
  ...
  aoi21  g151(.a(new_n145_), .b(x14), .c(new_n143_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(x17), .c(x16), .d(x15), .O(new_n197_));
  inv1   g153(.a(new_n175_), .O(new_n198_));
  nand2  g154(.a(x18), .b(x17), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n198_), .c(new_n145_), .O(new_n200_));
  oai21  g156(.a(new_n199_), .b(new_n166_), .c(new_n159_), .O(new_n201_));
  inv1   g157(.a(x11), .O(new_n202_));
  oai21  g158(.a(new_n199_), .b(new_n202_), .c(new_n151_), .O(new_n203_));
  oai21  g159(.a(new_n143_), .b(new_n170_), .c(new_n117_), .O(new_n204_));
  nand2  g160(.a(new_n143_), .b(new_n172_), .O(new_n205_));
  xnor2a g161(.a(x31), .b(x30), .O(new_n206_));
  nand4  g162(.a(new_n206_), .b(new_n205_), .c(new_n204_), .d(new_n203_), .O(new_n207_));
  inv1   g163(.a(new_n207_), .O(new_n208_));
  nand4  g164(.a(new_n208_), .b(new_n201_), .c(new_n200_), .d(new_n197_), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(x33), .O(new_n210_));
  nand3  g166(.a(new_n210_), .b(new_n195_), .c(new_n190_), .O(new_n211_));
  nand3  g167(.a(new_n211_), .b(new_n82_), .c(x00), .O(new_n212_));
  nand2  g168(.a(new_n212_), .b(new_n49_), .O(z9));
endmodule
