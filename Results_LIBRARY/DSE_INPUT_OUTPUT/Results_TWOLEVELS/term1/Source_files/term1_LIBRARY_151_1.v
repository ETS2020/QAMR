...
module FAU ( 
  ...
  nor2   g104(.a(new_n80_), .b(new_n102_), .O(new_n149_));
  ...
  nand2  g110(.a(x30), .b(new_n102_), .O(new_n155_));
  and2   g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n45_), .c(new_n154_), .d(new_n103_), .O(new_n157_));
  nand3  g113(.a(x19), .b(new_n87_), .c(x13), .O(new_n158_));
  nand3  g114(.a(new_n140_), .b(x18), .c(x14), .O(new_n159_));
  ...
  nand3  g124(.a(x16), .b(new_n168_), .c(x10), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n130_), .O(new_n170_));
  ...
  oai21  g136(.a(new_n180_), .b(new_n143_), .c(new_n140_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n129_), .c(new_n168_), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n180_), .b(new_n183_), .c(new_n133_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(new_n84_), .c(new_n87_), .d(new_n139_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n184_), .c(new_n182_), .d(new_n181_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n179_), .c(new_n46_), .O(new_n188_));
  oai21  g144(.a(x31), .b(new_n102_), .c(new_n155_), .O(new_n189_));
  ...
  aoi21  g149(.a(new_n165_), .b(new_n163_), .c(new_n168_), .O(new_n194_));
  ...
  oai21  g153(.a(new_n170_), .b(new_n194_), .c(new_n197_), .O(new_n198_));
