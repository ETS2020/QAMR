...
module FAU ( 
  ...
  nand4  g058(.a(new_n102_), .b(new_n89_), .c(new_n61_), .d(new_n81_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n93_), .c(new_n59_), .O(z5));
  and2   g060(.a(x29), .b(x28), .O(new_n105_));
  nand2  g061(.a(new_n100_), .b(x28), .O(new_n106_));
  ...
  oai21  g076(.a(x29), .b(new_n45_), .c(x30), .O(new_n121_));
  ...
  nand4  g092(.a(new_n136_), .b(new_n132_), .c(new_n129_), .d(new_n125_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n121_), .O(new_n138_));
  nor3   g094(.a(new_n124_), .b(new_n126_), .c(new_n122_), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n115_), .c(new_n46_), .O(new_n140_));
  nor2   g096(.a(x28), .b(x27), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n99_), .c(new_n80_), .O(new_n142_));
  nand3  g098(.a(x30), .b(x29), .c(x27), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(new_n138_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  inv1   g101(.a(x32), .O(new_n146_));
  nor2   g102(.a(new_n80_), .b(x29), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n100_), .c(x27), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n106_), .O(new_n149_));
  nand3  g105(.a(x19), .b(new_n133_), .c(x13), .O(new_n150_));
  inv1   g106(.a(x19), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(x18), .c(x14), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n150_), .c(new_n131_), .O(new_n153_));
  nand4  g109(.a(x19), .b(x18), .c(new_n131_), .d(x12), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n153_), .c(x16), .O(new_n156_));
  inv1   g112(.a(new_n124_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n126_), .c(x11), .O(new_n158_));
  ...
  aoi21  g122(.a(new_n158_), .b(new_n156_), .c(new_n122_), .O(new_n167_));
  inv1   g123(.a(new_n161_), .O(new_n168_));
  nor2   g124(.a(x30), .b(x29), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n141_), .c(new_n115_), .O(new_n170_));
  nand3  g126(.a(x31), .b(x30), .c(x29), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  oai21  g128(.a(new_n168_), .b(new_n167_), .c(new_n172_), .O(new_n173_));
  inv1   g129(.a(new_n141_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n115_), .c(x29), .O(new_n175_));
  nand2  g131(.a(new_n134_), .b(new_n133_), .O(new_n176_));
  nor2   g132(.a(new_n126_), .b(new_n122_), .O(new_n177_));
  aoi21  g133(.a(new_n177_), .b(new_n157_), .c(new_n135_), .O(new_n178_));
  nor2   g134(.a(new_n147_), .b(new_n118_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n178_), .c(new_n176_), .d(new_n132_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n175_), .c(new_n129_), .d(new_n125_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  oai21  g139(.a(new_n173_), .b(x33), .c(new_n183_), .O(new_n184_));
