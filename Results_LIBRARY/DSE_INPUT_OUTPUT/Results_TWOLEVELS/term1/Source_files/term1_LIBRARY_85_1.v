...
module FAU ( 
  ...
  nand3  g057(.a(new_n79_), .b(x29), .c(new_n45_), .O(new_n102_));
  oai21  g058(.a(new_n101_), .b(new_n45_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n100_), .c(new_n60_), .d(new_n80_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n99_), .c(new_n58_), .O(z5));
  ...
  nand4  g065(.a(new_n109_), .b(new_n100_), .c(new_n60_), .d(x27), .O(new_n110_));
  ...
  oai21  g075(.a(new_n119_), .b(new_n118_), .c(x31), .O(new_n120_));
  ...
  nand4  g080(.a(new_n124_), .b(new_n122_), .c(new_n120_), .d(new_n117_), .O(z7));
  nand4  g081(.a(x32), .b(new_n118_), .c(new_n80_), .d(x00), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n79_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n45_), .O(new_n128_));
  inv1   g084(.a(x32), .O(new_n129_));
  nand2  g085(.a(new_n118_), .b(new_n45_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n79_), .c(x29), .O(new_n131_));
  ...
  nand2  g118(.a(new_n79_), .b(new_n132_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n119_), .c(x31), .O(new_n164_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n128_), .O(z8));
  ...
  oai21  g130(.a(new_n174_), .b(new_n161_), .c(new_n88_), .O(new_n175_));
  ...
  aoi22  g135(.a(new_n179_), .b(new_n82_), .c(new_n85_), .d(new_n159_), .O(new_n180_));
  ...
  oai21  g138(.a(x31), .b(new_n132_), .c(new_n133_), .O(new_n183_));
  aoi21  g139(.a(new_n106_), .b(new_n114_), .c(x30), .O(new_n184_));
  ...
  nand2  g145(.a(new_n130_), .b(x29), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n114_), .c(new_n79_), .O(new_n191_));
