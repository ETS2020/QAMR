...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n60_), .c(new_n79_), .d(new_n46_), .O(new_n93_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n60_), .d(new_n46_), .O(new_n107_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n92_), .c(new_n60_), .d(new_n46_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(x25), .c(x01), .d(x00), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(z6));
  nor2   g075(.a(new_n113_), .b(new_n102_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n104_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x31), .O(new_n122_));
  nand4  g078(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n123_));
  nand3  g079(.a(new_n60_), .b(x25), .c(x01), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  inv1   g081(.a(new_n104_), .O(new_n126_));
  inv1   g082(.a(x31), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(x30), .c(x29), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n47_), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(x26), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n125_), .c(new_n123_), .d(new_n122_), .O(z7));
  ...
  nand2  g118(.a(new_n162_), .b(new_n83_), .O(new_n163_));
  nand2  g119(.a(x19), .b(x13), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n86_), .O(new_n165_));
  nand2  g121(.a(x16), .b(x15), .O(new_n166_));
  oai22  g122(.a(new_n166_), .b(new_n145_), .c(x19), .d(x14), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  oai21  g124(.a(x30), .b(x29), .c(x31), .O(new_n169_));
  aoi21  g125(.a(new_n120_), .b(x28), .c(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n168_), .c(new_n165_), .d(new_n163_), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n161_), .c(new_n158_), .d(new_n156_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(x32), .c(new_n45_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n153_), .c(x26), .O(z8));
  inv1   g131(.a(x33), .O(new_n176_));
  nand4  g132(.a(new_n152_), .b(new_n176_), .c(x31), .d(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n127_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n134_), .c(x29), .O(new_n180_));
  inv1   g136(.a(new_n136_), .O(new_n181_));
  nand4  g137(.a(new_n152_), .b(new_n176_), .c(new_n127_), .d(new_n113_), .O(new_n182_));
  ...
  inv1   g141(.a(new_n158_), .O(new_n186_));
  xor2a  g142(.a(x31), .b(x30), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n167_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n186_), .c(x33), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n185_), .c(new_n180_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n46_), .c(x00), .O(new_n192_));
