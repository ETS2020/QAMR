...
module FAU ( 
  ...
  oai21  g058(.a(new_n98_), .b(new_n45_), .c(x29), .O(new_n103_));
  ...
  oai21  g067(.a(new_n46_), .b(x27), .c(new_n111_), .O(new_n112_));
  ...
  nand4  g116(.a(new_n160_), .b(new_n148_), .c(new_n143_), .d(x31), .O(new_n161_));
  ...
  oai22  g132(.a(new_n133_), .b(new_n122_), .c(x19), .d(x14), .O(new_n177_));
  nand2  g133(.a(x31), .b(new_n46_), .O(new_n178_));
  nand3  g134(.a(new_n170_), .b(x29), .c(x28), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nor3   g136(.a(new_n180_), .b(new_n177_), .c(new_n130_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n129_), .c(new_n127_), .d(new_n176_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n144_), .c(x33), .O(new_n183_));
  oai21  g139(.a(new_n175_), .b(x33), .c(new_n183_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n80_), .c(x00), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n167_), .O(z9));
endmodule
