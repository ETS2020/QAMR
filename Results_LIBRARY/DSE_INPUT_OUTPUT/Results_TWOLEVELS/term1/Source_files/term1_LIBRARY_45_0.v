...
module FAU ( 
  ...
  nor2   g054(.a(new_n46_), .b(x21), .O(new_n99_));
  aoi22  g055(.a(new_n99_), .b(new_n96_), .c(new_n98_), .d(new_n47_), .O(new_n100_));
  ...
  aoi21  g060(.a(x28), .b(x27), .c(new_n104_), .O(new_n105_));
  inv1   g061(.a(x28), .O(new_n106_));
  nor2   g062(.a(x29), .b(new_n106_), .O(new_n107_));
  aoi21  g063(.a(new_n107_), .b(x27), .c(new_n105_), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n100_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n60_), .O(z5));
  nand2  g067(.a(x29), .b(x28), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n91_), .c(x30), .O(new_n113_));
  nand4  g069(.a(new_n98_), .b(new_n46_), .c(x29), .d(x28), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x27), .O(new_n116_));
  aoi21  g072(.a(new_n98_), .b(x30), .c(new_n84_), .O(new_n117_));
  oai21  g073(.a(new_n117_), .b(x27), .c(new_n116_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n60_), .c(new_n47_), .O(z6));
  nand4  g076(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n121_));
  ...
  nand3  g082(.a(new_n97_), .b(new_n126_), .c(new_n125_), .O(new_n127_));
  ...
  nand2  g092(.a(new_n106_), .b(new_n82_), .O(new_n137_));
  ...
  nand3  g106(.a(new_n150_), .b(new_n96_), .c(x11), .O(new_n151_));
  ...
  nand3  g113(.a(x32), .b(new_n46_), .c(x21), .O(new_n158_));
  ...
  nand2  g117(.a(new_n106_), .b(new_n82_), .O(new_n162_));
  ...
  oai21  g130(.a(new_n170_), .b(new_n174_), .c(new_n96_), .O(new_n175_));
  ...
  nor2   g145(.a(new_n130_), .b(new_n104_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n137_), .c(new_n46_), .O(new_n191_));
  ...
  nand4  g150(.a(new_n138_), .b(new_n130_), .c(new_n46_), .d(x21), .O(new_n195_));
