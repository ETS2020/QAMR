...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n60_), .c(new_n58_), .O(z3));
  inv1   g050(.a(x25), .O(new_n95_));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand3  g052(.a(new_n91_), .b(new_n86_), .c(new_n83_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n62_), .d(new_n45_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n95_), .c(new_n60_), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n92_), .c(new_n62_), .d(x25), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n60_), .c(new_n58_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n97_), .c(new_n62_), .d(new_n45_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n95_), .c(new_n60_), .O(z6));
  ...
  nand4  g074(.a(new_n91_), .b(new_n118_), .c(new_n117_), .d(new_n83_), .O(new_n119_));
  ...
  nor2   g080(.a(new_n124_), .b(new_n95_), .O(new_n125_));
  ...
  aoi21  g092(.a(new_n136_), .b(new_n134_), .c(new_n89_), .O(new_n137_));
  nand4  g093(.a(x19), .b(x18), .c(new_n89_), .d(x12), .O(new_n138_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n132_), .c(new_n127_), .d(x31), .O(new_n152_));
  nand2  g108(.a(new_n114_), .b(x27), .O(new_n153_));
  ...
  oai21  g116(.a(new_n142_), .b(new_n160_), .c(new_n89_), .O(new_n161_));
  ...
  aoi21  g123(.a(new_n114_), .b(x28), .c(new_n167_), .O(new_n168_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n122_), .d(new_n109_), .O(new_n182_));
  ...
  oai21  g149(.a(new_n133_), .b(new_n160_), .c(new_n89_), .O(new_n194_));
