...
module FAU ( 
  ...
  oai21  g056(.a(new_n100_), .b(new_n59_), .c(new_n48_), .O(z4));
  ...
  oai21  g085(.a(x29), .b(new_n81_), .c(x30), .O(new_n130_));
  ...
  oai21  g105(.a(new_n123_), .b(new_n81_), .c(new_n149_), .O(new_n150_));
  aoi21  g106(.a(new_n147_), .b(new_n48_), .c(new_n150_), .O(new_n151_));
  ...
  oai22  g113(.a(new_n157_), .b(new_n81_), .c(new_n155_), .d(new_n111_), .O(new_n158_));
