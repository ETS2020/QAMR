...
module FAU ( 
  ...
  aoi21  g043(.a(new_n87_), .b(new_n83_), .c(new_n60_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n81_), .c(new_n80_), .d(x25), .O(new_n89_));
  oai21  g045(.a(new_n89_), .b(new_n59_), .c(new_n47_), .O(z3));
  xor2a  g046(.a(x28), .b(x27), .O(new_n91_));
  nand3  g047(.a(new_n91_), .b(new_n88_), .c(new_n47_), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n80_), .c(x25), .d(x01), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(z4));
  nand2  g051(.a(new_n87_), .b(new_n83_), .O(new_n96_));
  ...
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n61_), .d(new_n80_), .O(new_n102_));
  ...
  nand2  g062(.a(x27), .b(new_n45_), .O(new_n107_));
  nand3  g063(.a(new_n106_), .b(x29), .c(x28), .O(new_n108_));
  oai22  g064(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(x29), .O(new_n109_));
  nand2  g065(.a(x28), .b(x27), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n82_), .c(x30), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  aoi21  g068(.a(new_n109_), .b(new_n96_), .c(new_n112_), .O(new_n113_));
  inv1   g069(.a(new_n87_), .O(new_n114_));
  aoi22  g070(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n114_), .c(x30), .O(new_n116_));
  oai21  g072(.a(new_n113_), .b(new_n60_), .c(new_n116_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n80_), .c(x25), .d(x01), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(z6));
  oai21  g075(.a(x31), .b(x06), .c(new_n106_), .O(new_n120_));
  nand3  g076(.a(x29), .b(x28), .c(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x31), .O(new_n122_));
  inv1   g078(.a(new_n84_), .O(new_n123_));
  inv1   g079(.a(new_n85_), .O(new_n124_));
  inv1   g080(.a(new_n86_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n124_), .c(new_n123_), .d(new_n83_), .O(new_n126_));
  nor2   g082(.a(new_n60_), .b(new_n59_), .O(new_n127_));
  inv1   g083(.a(x31), .O(new_n128_));
  nand4  g084(.a(new_n99_), .b(new_n128_), .c(x30), .d(x29), .O(new_n129_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n106_), .c(x29), .O(new_n136_));
  nor2   g092(.a(new_n134_), .b(new_n97_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n106_), .c(new_n136_), .O(new_n138_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n148_), .c(x11), .O(new_n153_));
  ...
  nand4  g114(.a(new_n158_), .b(new_n138_), .c(new_n133_), .d(x31), .O(new_n159_));
  nor2   g115(.a(new_n106_), .b(new_n97_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(x27), .O(new_n161_));
  oai21  g117(.a(x30), .b(x27), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n98_), .O(new_n163_));
  nand2  g119(.a(x16), .b(x10), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n151_), .c(new_n156_), .O(new_n165_));
  nand2  g121(.a(x17), .b(x11), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n149_), .c(new_n148_), .O(new_n167_));
  inv1   g123(.a(x12), .O(new_n168_));
  oai21  g124(.a(new_n149_), .b(new_n168_), .c(new_n139_), .O(new_n169_));
  inv1   g125(.a(x13), .O(new_n170_));
  oai21  g126(.a(new_n142_), .b(new_n170_), .c(new_n140_), .O(new_n171_));
  nor2   g127(.a(x19), .b(x14), .O(new_n172_));
  nor2   g128(.a(new_n148_), .b(new_n156_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n152_), .c(new_n172_), .O(new_n174_));
  oai21  g130(.a(x30), .b(x29), .c(x31), .O(new_n175_));
  aoi21  g131(.a(new_n160_), .b(x28), .c(new_n175_), .O(new_n176_));
  ...
  nand2  g136(.a(new_n180_), .b(new_n159_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n80_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n47_), .O(z8));
  inv1   g139(.a(x33), .O(new_n184_));
  nand4  g140(.a(new_n158_), .b(new_n184_), .c(x31), .d(x30), .O(new_n185_));
  nand2  g141(.a(x33), .b(new_n128_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n135_), .c(x29), .O(new_n188_));
  inv1   g144(.a(new_n137_), .O(new_n189_));
  nand4  g145(.a(new_n158_), .b(new_n184_), .c(new_n128_), .d(new_n106_), .O(new_n190_));
  ...
  aoi21  g149(.a(new_n142_), .b(x14), .c(new_n140_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(x17), .c(x16), .d(x15), .O(new_n195_));
  inv1   g151(.a(new_n173_), .O(new_n196_));
  nand2  g152(.a(x18), .b(x17), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n196_), .c(new_n142_), .O(new_n198_));
  oai21  g154(.a(new_n197_), .b(new_n164_), .c(new_n156_), .O(new_n199_));
  inv1   g155(.a(x11), .O(new_n200_));
  oai21  g156(.a(new_n197_), .b(new_n200_), .c(new_n148_), .O(new_n201_));
  oai21  g157(.a(new_n140_), .b(new_n168_), .c(new_n139_), .O(new_n202_));
  nand2  g158(.a(new_n140_), .b(new_n170_), .O(new_n203_));
