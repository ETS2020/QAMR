...
module FAU ( 
  ...
  nand4  g061(.a(new_n48_), .b(new_n105_), .c(x28), .d(x27), .O(new_n106_));
  nand2  g062(.a(x28), .b(x27), .O(new_n107_));
  nand2  g063(.a(x30), .b(x10), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n106_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n92_), .c(new_n81_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n104_), .c(new_n61_), .O(z5));
  inv1   g068(.a(new_n91_), .O(new_n113_));
  nand3  g069(.a(new_n107_), .b(x30), .c(new_n45_), .O(new_n114_));
  nand3  g070(.a(new_n46_), .b(x28), .c(x27), .O(new_n115_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n61_), .c(new_n48_), .O(z6));
  nand2  g077(.a(new_n87_), .b(new_n85_), .O(new_n122_));
  nor3   g078(.a(new_n122_), .b(new_n89_), .c(new_n88_), .O(new_n123_));
  ...
  nor2   g083(.a(x31), .b(new_n46_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x29), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n107_), .c(new_n127_), .O(new_n130_));
  inv1   g086(.a(x31), .O(new_n131_));
  nor2   g087(.a(new_n131_), .b(x30), .O(new_n132_));
  aoi21  g088(.a(new_n130_), .b(new_n45_), .c(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n125_), .O(z7));
  ...
  nand2  g105(.a(new_n149_), .b(x17), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n147_), .c(x11), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n146_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n46_), .c(x15), .O(new_n154_));
  ...
  nand4  g115(.a(new_n159_), .b(new_n153_), .c(x30), .d(x15), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n135_), .c(x31), .O(new_n162_));
  nand3  g118(.a(new_n149_), .b(x17), .c(x16), .O(new_n163_));
  nor2   g119(.a(new_n46_), .b(new_n105_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x28), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(new_n163_), .c(x10), .O(new_n166_));
  nand2  g122(.a(new_n159_), .b(new_n46_), .O(new_n167_));
  nand2  g123(.a(new_n163_), .b(new_n155_), .O(new_n168_));
  nand2  g124(.a(x17), .b(x11), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n148_), .c(new_n147_), .O(new_n170_));
  inv1   g126(.a(x12), .O(new_n171_));
  oai21  g127(.a(new_n148_), .b(new_n171_), .c(new_n138_), .O(new_n172_));
  ...
  nand2  g132(.a(new_n141_), .b(new_n176_), .O(new_n177_));
  nand3  g133(.a(new_n151_), .b(x16), .c(x15), .O(new_n178_));
  aoi21  g134(.a(new_n164_), .b(x27), .c(new_n131_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n173_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n170_), .c(new_n168_), .d(new_n167_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n166_), .c(x32), .O(new_n183_));
  ...
  nand3  g143(.a(new_n157_), .b(new_n187_), .c(new_n131_), .O(new_n188_));
  nand2  g144(.a(x33), .b(x31), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n159_), .O(new_n191_));
  aoi21  g147(.a(new_n152_), .b(new_n146_), .c(x33), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(x31), .c(x30), .d(x15), .O(new_n193_));
  oai22  g149(.a(new_n193_), .b(x10), .c(new_n187_), .d(x31), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n137_), .c(x29), .O(new_n195_));
  aoi21  g151(.a(new_n155_), .b(x10), .c(new_n141_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(x18), .c(x17), .d(x16), .O(new_n197_));
  nor2   g153(.a(new_n132_), .b(new_n128_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n177_), .c(new_n175_), .d(new_n172_), .O(new_n199_));
  inv1   g155(.a(new_n199_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n197_), .c(new_n170_), .d(new_n168_), .O(new_n201_));
