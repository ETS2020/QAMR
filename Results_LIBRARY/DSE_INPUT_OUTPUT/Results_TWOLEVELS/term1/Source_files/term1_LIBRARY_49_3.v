...
module FAU ( 
  ...
  nand4  g052(.a(new_n96_), .b(new_n63_), .c(new_n83_), .d(new_n45_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n82_), .c(new_n61_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n63_), .d(new_n45_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n82_), .c(new_n61_), .O(z4));
  inv1   g057(.a(x28), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n83_), .O(new_n103_));
  nand3  g059(.a(new_n46_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n46_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n96_), .c(new_n63_), .d(new_n45_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n82_), .c(new_n61_), .O(z5));
  nand3  g063(.a(x29), .b(x28), .c(x27), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x30), .O(new_n109_));
  inv1   g065(.a(x30), .O(new_n110_));
  nand3  g066(.a(new_n103_), .b(new_n110_), .c(x29), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n109_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n96_), .c(new_n63_), .d(new_n45_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n82_), .c(new_n61_), .O(z6));
  ...
  oai21  g086(.a(new_n128_), .b(new_n46_), .c(x30), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g088(.a(x19), .b(new_n90_), .c(x13), .O(new_n133_));
  nand3  g089(.a(new_n93_), .b(x18), .c(x14), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n133_), .c(new_n87_), .O(new_n135_));
  nand4  g091(.a(x19), .b(x18), .c(new_n87_), .d(x12), .O(new_n136_));
  ...
  nor2   g104(.a(new_n110_), .b(new_n46_), .O(new_n149_));
  ...
  oai21  g109(.a(new_n153_), .b(new_n140_), .c(new_n145_), .O(new_n154_));
  nor2   g110(.a(new_n93_), .b(new_n90_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(x17), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n155_), .b(x12), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n87_), .O(new_n158_));
  inv1   g114(.a(x13), .O(new_n159_));
  oai21  g115(.a(new_n93_), .b(new_n159_), .c(new_n90_), .O(new_n160_));
  ...
  aoi21  g120(.a(new_n149_), .b(x28), .c(new_n164_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n163_), .c(new_n160_), .d(new_n158_), .O(new_n166_));
  aoi21  g122(.a(new_n156_), .b(new_n139_), .c(new_n166_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n154_), .c(new_n152_), .O(new_n168_));
  ...
  aoi21  g133(.a(new_n142_), .b(new_n138_), .c(new_n145_), .O(new_n178_));
  inv1   g134(.a(new_n146_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n173_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(x31), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n110_), .c(new_n102_), .d(new_n83_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n177_), .c(new_n46_), .O(new_n183_));
  aoi21  g139(.a(new_n93_), .b(x14), .c(new_n90_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  nand2  g141(.a(new_n149_), .b(new_n129_), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(x31), .O(new_n187_));
  nand2  g143(.a(x18), .b(x17), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n162_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n93_), .O(new_n191_));
  nand3  g147(.a(new_n189_), .b(x16), .c(x10), .O(new_n192_));
  nand2  g148(.a(new_n120_), .b(x30), .O(new_n193_));
  inv1   g149(.a(x11), .O(new_n194_));
  oai21  g150(.a(new_n188_), .b(new_n194_), .c(new_n139_), .O(new_n195_));
  nand2  g151(.a(x18), .b(x12), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n87_), .O(new_n197_));
  nand2  g153(.a(new_n90_), .b(new_n159_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n197_), .c(new_n195_), .d(new_n193_), .O(new_n199_));
  aoi21  g155(.a(new_n192_), .b(new_n145_), .c(new_n199_), .O(new_n200_));
  nand4  g156(.a(new_n200_), .b(new_n191_), .c(new_n187_), .d(new_n185_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(x33), .O(new_n202_));
  nand3  g158(.a(new_n181_), .b(new_n110_), .c(new_n46_), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(new_n202_), .c(x26), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n183_), .c(x00), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(new_n48_), .O(z9));
endmodule
