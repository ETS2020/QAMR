...
module FAU ( 
  ...
  nor3   g071(.a(new_n115_), .b(new_n100_), .c(new_n62_), .O(z6));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n105_), .c(new_n100_), .O(new_n125_));
  ...
  nor2   g089(.a(new_n131_), .b(new_n103_), .O(new_n134_));
