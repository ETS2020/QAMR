...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n60_), .c(x30), .d(new_n81_), .O(new_n95_));
  inv1   g051(.a(new_n95_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n80_), .c(x01), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(x30), .c(new_n79_), .O(z3));
  xor2a  g054(.a(x28), .b(x27), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n60_), .d(x30), .O(new_n100_));
  ...
  nand4  g069(.a(new_n113_), .b(new_n94_), .c(new_n60_), .d(x30), .O(new_n114_));
  ...
  nand3  g081(.a(new_n125_), .b(new_n120_), .c(new_n119_), .O(z7));
  ...
  oai21  g093(.a(new_n91_), .b(new_n137_), .c(new_n88_), .O(new_n138_));
  inv1   g094(.a(x14), .O(new_n139_));
  nand2  g095(.a(x16), .b(x15), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n128_), .c(x31), .O(new_n141_));
  aoi21  g097(.a(new_n91_), .b(new_n139_), .c(new_n141_), .O(new_n142_));
  ...
  nand2  g100(.a(new_n104_), .b(new_n81_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(x29), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n45_), .c(new_n79_), .O(new_n147_));
  nand2  g103(.a(new_n104_), .b(new_n81_), .O(new_n148_));
  ...
  nand4  g108(.a(new_n145_), .b(new_n45_), .c(x29), .d(new_n79_), .O(new_n153_));
  ...
  inv1   g128(.a(new_n140_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n173_), .c(x19), .O(new_n176_));
  oai21  g132(.a(new_n174_), .b(new_n127_), .c(new_n166_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n174_), .b(new_n178_), .c(new_n131_), .O(new_n179_));
  oai21  g135(.a(new_n88_), .b(new_n135_), .c(new_n85_), .O(new_n180_));
  aoi22  g136(.a(new_n173_), .b(new_n162_), .c(new_n88_), .d(new_n137_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n179_), .d(new_n177_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n176_), .c(new_n46_), .O(new_n183_));
  nand3  g139(.a(x30), .b(x18), .c(x17), .O(new_n184_));
  oai22  g140(.a(new_n184_), .b(new_n140_), .c(x25), .d(x19), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n139_), .O(new_n186_));
  nand3  g142(.a(new_n145_), .b(new_n122_), .c(x29), .O(new_n187_));
  oai21  g143(.a(new_n122_), .b(x30), .c(new_n187_), .O(new_n188_));
  nor2   g144(.a(new_n122_), .b(new_n106_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n145_), .c(new_n45_), .O(new_n190_));
  aoi21  g146(.a(new_n188_), .b(new_n79_), .c(new_n190_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n186_), .c(new_n183_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  inv1   g149(.a(x33), .O(new_n194_));
  nand4  g150(.a(new_n146_), .b(new_n122_), .c(new_n45_), .d(new_n79_), .O(new_n195_));
  nand4  g151(.a(new_n145_), .b(x31), .c(x30), .d(x29), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n195_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n168_), .c(new_n194_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n193_), .O(new_n199_));
