...
module FAU ( 
  ...
  nand3  g054(.a(x30), .b(x28), .c(new_n82_), .O(new_n99_));
  ...
  oai21  g060(.a(new_n104_), .b(new_n45_), .c(x29), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nand4  g062(.a(x30), .b(new_n106_), .c(x28), .d(x27), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n62_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n98_), .c(new_n60_), .O(z5));
  nand3  g066(.a(x29), .b(x28), .c(x27), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n94_), .c(new_n62_), .d(x30), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n81_), .c(x25), .d(x01), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x29), .c(x27), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x30), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x28), .O(new_n119_));
  nand3  g075(.a(x29), .b(x28), .c(x27), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(x31), .O(new_n121_));
  nand4  g077(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n122_));
  nand4  g078(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n122_), .c(new_n121_), .d(new_n119_), .O(z7));
  ...
  oai21  g090(.a(new_n131_), .b(new_n134_), .c(new_n85_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  oai21  g092(.a(new_n91_), .b(new_n136_), .c(new_n88_), .O(new_n137_));
  nor2   g093(.a(x19), .b(x14), .O(new_n138_));
  nand2  g094(.a(x16), .b(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n127_), .c(x31), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n138_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n137_), .c(new_n135_), .d(new_n133_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n129_), .c(new_n58_), .O(new_n143_));
  aoi21  g099(.a(new_n45_), .b(new_n82_), .c(new_n103_), .O(new_n144_));
  aoi21  g100(.a(x29), .b(x27), .c(x30), .O(new_n145_));
  aoi22  g101(.a(new_n145_), .b(new_n45_), .c(new_n144_), .d(x29), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n143_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x32), .O(new_n148_));
  inv1   g104(.a(x32), .O(new_n149_));
  nand3  g105(.a(new_n103_), .b(x29), .c(x27), .O(new_n150_));
  inv1   g106(.a(new_n150_), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n104_), .c(new_n45_), .O(new_n152_));
  oai21  g108(.a(new_n103_), .b(x29), .c(new_n152_), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n88_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n91_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n85_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(x16), .O(new_n159_));
  inv1   g115(.a(new_n127_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n130_), .c(x11), .O(new_n161_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n153_), .c(new_n149_), .d(x31), .O(new_n167_));
  ...
  aoi21  g126(.a(new_n161_), .b(new_n159_), .c(new_n164_), .O(new_n171_));
  inv1   g127(.a(new_n165_), .O(new_n172_));
  oai21  g128(.a(new_n103_), .b(new_n82_), .c(new_n45_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(x31), .c(x29), .O(new_n174_));
  nand2  g130(.a(x29), .b(x27), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n116_), .c(new_n103_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n174_), .O(new_n177_));
  oai21  g133(.a(new_n172_), .b(new_n171_), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n91_), .b(x14), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x18), .c(x17), .d(x16), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n164_), .O(new_n181_));
  oai21  g137(.a(x28), .b(x27), .c(x29), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x31), .O(new_n183_));
  nor2   g139(.a(new_n88_), .b(new_n85_), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n139_), .c(new_n91_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n126_), .c(new_n164_), .O(new_n187_));
  aoi21  g143(.a(new_n184_), .b(x11), .c(x16), .O(new_n188_));
  oai21  g144(.a(new_n88_), .b(new_n134_), .c(new_n85_), .O(new_n189_));
  nand2  g145(.a(new_n88_), .b(new_n136_), .O(new_n190_));
  nand2  g146(.a(new_n116_), .b(x30), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n150_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n188_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n187_), .c(new_n186_), .d(new_n183_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n181_), .c(x33), .O(new_n195_));
  oai21  g151(.a(new_n178_), .b(x33), .c(new_n195_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n81_), .c(x00), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n58_), .O(z9));
endmodule
