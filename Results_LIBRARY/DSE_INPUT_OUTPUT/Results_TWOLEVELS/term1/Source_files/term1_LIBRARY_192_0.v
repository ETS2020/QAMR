...
module FAU ( 
  ...
  nand3  g042(.a(new_n86_), .b(x29), .c(new_n80_), .O(new_n87_));
  ...
  nand3  g047(.a(x29), .b(x28), .c(new_n80_), .O(new_n92_));
  oai21  g048(.a(x28), .b(new_n80_), .c(new_n92_), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(new_n86_), .c(new_n79_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n91_), .c(new_n58_), .O(z4));
  ...
  nor3   g058(.a(new_n102_), .b(new_n91_), .c(new_n58_), .O(z5));
  inv1   g059(.a(x30), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x29), .c(x28), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(x29), .c(new_n105_), .O(new_n106_));
  nor2   g062(.a(new_n99_), .b(new_n104_), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(x29), .c(new_n106_), .d(x27), .O(new_n108_));
  ...
  nor2   g070(.a(new_n104_), .b(new_n97_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x28), .O(new_n116_));
  ...
  nand4  g078(.a(new_n99_), .b(new_n112_), .c(x30), .d(x29), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n122_), .c(new_n79_), .d(x25), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n121_), .c(new_n117_), .d(new_n114_), .O(z7));
  inv1   g082(.a(x32), .O(new_n127_));
  inv1   g083(.a(x28), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n80_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n104_), .c(x29), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(new_n80_), .c(new_n97_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n104_), .c(new_n130_), .O(new_n132_));
  ...
  xnor2a g107(.a(x30), .b(x28), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n80_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n143_), .c(new_n148_), .O(new_n155_));
  nand2  g111(.a(x19), .b(x18), .O(new_n156_));
  nand2  g112(.a(x17), .b(x11), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n142_), .O(new_n158_));
  inv1   g114(.a(x12), .O(new_n159_));
  oai21  g115(.a(new_n156_), .b(new_n159_), .c(new_n133_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n136_), .b(new_n161_), .c(new_n134_), .O(new_n162_));
  nor2   g118(.a(x19), .b(x14), .O(new_n163_));
  nand2  g119(.a(x16), .b(x15), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n143_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  oai21  g122(.a(x30), .b(x29), .c(x31), .O(new_n167_));
  aoi21  g123(.a(new_n115_), .b(x27), .c(new_n167_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n166_), .c(new_n162_), .d(new_n160_), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n158_), .c(new_n155_), .d(new_n153_), .O(new_n171_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n56_), .O(z8));
  nand2  g131(.a(new_n136_), .b(x14), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x18), .c(x17), .d(x16), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n148_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x17), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n164_), .c(new_n136_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n154_), .c(new_n148_), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n182_), .c(new_n142_), .O(new_n183_));
  nand2  g139(.a(x18), .b(x12), .O(new_n184_));
  aoi22  g140(.a(new_n184_), .b(new_n133_), .c(new_n134_), .d(new_n161_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n183_), .c(new_n181_), .d(new_n180_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n178_), .c(new_n56_), .O(new_n187_));
  nand2  g143(.a(new_n97_), .b(x27), .O(new_n188_));
  aoi21  g144(.a(new_n188_), .b(new_n113_), .c(new_n104_), .O(new_n189_));
  nand2  g145(.a(x31), .b(new_n104_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n113_), .c(new_n80_), .O(new_n191_));
  nand2  g147(.a(new_n104_), .b(x28), .O(new_n192_));
  nand3  g148(.a(x31), .b(new_n128_), .c(new_n80_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n192_), .c(new_n97_), .O(new_n194_));
  nor3   g150(.a(new_n194_), .b(new_n191_), .c(new_n189_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n187_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(x33), .O(new_n197_));
  aoi21  g153(.a(new_n145_), .b(new_n141_), .c(new_n148_), .O(new_n198_));
  inv1   g154(.a(new_n149_), .O(new_n199_));
  nand3  g155(.a(x31), .b(x30), .c(x29), .O(new_n200_));
  nand2  g156(.a(new_n112_), .b(new_n104_), .O(new_n201_));
  oai21  g157(.a(new_n201_), .b(x29), .c(new_n200_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(x27), .O(new_n203_));
  nand3  g159(.a(x31), .b(x30), .c(x28), .O(new_n204_));
  oai21  g160(.a(new_n201_), .b(new_n129_), .c(new_n204_), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(x29), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(new_n203_), .O(new_n207_));
  oai21  g163(.a(new_n199_), .b(new_n198_), .c(new_n207_), .O(new_n208_));
  oai21  g164(.a(new_n208_), .b(x33), .c(new_n197_), .O(new_n209_));
