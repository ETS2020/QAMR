...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n61_), .c(x30), .d(new_n45_), .O(new_n90_));
  ...
  oai21  g050(.a(new_n46_), .b(x27), .c(new_n94_), .O(new_n95_));
  oai21  g051(.a(new_n94_), .b(x27), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(x25), .c(x01), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n48_), .O(z4));
  inv1   g056(.a(x29), .O(new_n101_));
  nor2   g057(.a(new_n94_), .b(new_n45_), .O(new_n102_));
  ...
  nand2  g065(.a(x30), .b(new_n94_), .O(new_n110_));
  ...
  nand2  g086(.a(x30), .b(new_n101_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n130_), .c(new_n111_), .O(new_n132_));
  ...
  nand2  g107(.a(new_n94_), .b(new_n45_), .O(new_n152_));
  ...
  nor2   g111(.a(new_n136_), .b(new_n134_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(x17), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n142_), .O(new_n158_));
  aoi21  g114(.a(new_n156_), .b(x12), .c(x17), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  oai21  g116(.a(new_n136_), .b(new_n160_), .c(new_n134_), .O(new_n161_));
  inv1   g117(.a(x14), .O(new_n162_));
  nand2  g118(.a(new_n136_), .b(new_n162_), .O(new_n163_));
  nor2   g119(.a(new_n142_), .b(new_n148_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n144_), .O(new_n165_));
  aoi21  g121(.a(new_n46_), .b(new_n101_), .c(new_n123_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n159_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n158_), .c(new_n155_), .d(new_n153_), .O(new_n169_));
  ...
  nand2  g129(.a(new_n46_), .b(new_n45_), .O(new_n174_));
  nand2  g130(.a(x18), .b(x17), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n164_), .c(x19), .O(new_n177_));
  oai21  g133(.a(new_n175_), .b(new_n154_), .c(new_n148_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n175_), .b(new_n179_), .c(new_n142_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n133_), .O(new_n182_));
  nor2   g138(.a(new_n148_), .b(x14), .O(new_n183_));
  nand3  g139(.a(x18), .b(x17), .c(x16), .O(new_n184_));
  inv1   g140(.a(new_n184_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(new_n183_), .c(new_n134_), .d(new_n160_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n182_), .c(new_n180_), .d(new_n178_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n177_), .c(new_n174_), .O(new_n188_));
  nand3  g144(.a(new_n48_), .b(x19), .c(x18), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n133_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(x16), .c(x15), .O(new_n191_));
  nand2  g147(.a(new_n123_), .b(new_n101_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n46_), .c(x27), .O(new_n193_));
  nand2  g149(.a(x31), .b(x29), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n129_), .c(x30), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n193_), .c(new_n191_), .d(new_n188_), .O(new_n196_));
  ...
  nand4  g158(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n202_), .O(new_n204_));
  nand3  g160(.a(new_n204_), .b(new_n150_), .c(new_n198_), .O(new_n205_));
