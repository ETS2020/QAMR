...
module FAU ( 
  ...
  oai21  g054(.a(new_n98_), .b(new_n58_), .c(new_n47_), .O(z4));
  inv1   g055(.a(new_n93_), .O(new_n100_));
  inv1   g056(.a(x29), .O(new_n101_));
  inv1   g057(.a(x28), .O(new_n102_));
  aoi21  g058(.a(x30), .b(new_n102_), .c(new_n81_), .O(new_n103_));
  nand4  g059(.a(x30), .b(new_n101_), .c(x28), .d(x27), .O(new_n104_));
  ...
  aoi21  g063(.a(x30), .b(new_n101_), .c(new_n102_), .O(new_n108_));
  nand2  g064(.a(x30), .b(new_n81_), .O(new_n109_));
  oai21  g065(.a(new_n108_), .b(new_n81_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n100_), .c(new_n60_), .d(new_n80_), .O(new_n111_));
  ...
  nand4  g078(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n122_), .c(new_n120_), .d(new_n118_), .O(z7));
  nand2  g081(.a(new_n80_), .b(x00), .O(new_n126_));
  nand3  g082(.a(x32), .b(x29), .c(new_n102_), .O(new_n127_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n101_), .c(x30), .O(new_n132_));
  ...
  nor2   g118(.a(new_n45_), .b(new_n101_), .O(new_n163_));
  ...
  aoi22  g137(.a(new_n181_), .b(new_n83_), .c(new_n86_), .d(new_n158_), .O(new_n182_));
  ...
  oai21  g141(.a(new_n45_), .b(new_n102_), .c(x31), .O(new_n186_));
  ...
  nor4   g150(.a(new_n131_), .b(new_n115_), .c(new_n45_), .d(new_n101_), .O(new_n195_));
