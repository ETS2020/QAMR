...
module FAU ( 
  ...
  aoi21  g055(.a(new_n93_), .b(new_n80_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n93_), .b(new_n98_), .c(x28), .d(x27), .O(new_n101_));
  ...
  nor3   g059(.a(new_n103_), .b(new_n92_), .c(new_n58_), .O(z5));
  ...
  nand3  g067(.a(new_n46_), .b(new_n111_), .c(new_n79_), .O(new_n112_));
  nor4   g068(.a(new_n112_), .b(new_n59_), .c(new_n92_), .d(new_n58_), .O(new_n113_));
  oai21  g069(.a(new_n110_), .b(new_n86_), .c(new_n113_), .O(z7));
  inv1   g070(.a(x32), .O(new_n115_));
  aoi21  g071(.a(new_n93_), .b(x27), .c(x28), .O(new_n116_));
  nor2   g072(.a(new_n98_), .b(new_n80_), .O(new_n117_));
  oai22  g073(.a(new_n117_), .b(new_n93_), .c(new_n116_), .d(new_n98_), .O(new_n118_));
  ...
  nor2   g106(.a(new_n93_), .b(new_n98_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(x27), .c(new_n111_), .O(new_n152_));
  ...
  nand3  g113(.a(new_n157_), .b(new_n79_), .c(x00), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n46_), .O(z8));
  ...
  oai21  g127(.a(new_n171_), .b(new_n162_), .c(new_n46_), .O(new_n172_));
  ...
  aoi21  g131(.a(new_n175_), .b(new_n99_), .c(new_n173_), .O(new_n176_));
  ...
  nor3   g138(.a(x31), .b(x30), .c(x27), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n182_), .c(new_n99_), .O(new_n184_));
  nand3  g140(.a(new_n111_), .b(new_n93_), .c(new_n98_), .O(new_n185_));
