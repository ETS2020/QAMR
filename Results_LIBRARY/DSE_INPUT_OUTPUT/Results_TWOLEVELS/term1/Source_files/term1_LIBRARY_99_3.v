...
module FAU ( 
  ...
  nand2  g000(.a(x30), .b(x07), .O(new_n45_));
  ...
  nand2  g035(.a(x30), .b(x07), .O(new_n80_));
  ...
  nor2   g066(.a(x27), .b(x07), .O(new_n111_));
  ...
  nor2   g081(.a(new_n114_), .b(new_n102_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n104_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x31), .O(new_n128_));
  inv1   g084(.a(new_n81_), .O(new_n129_));
  nand4  g085(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n59_), .b(new_n78_), .c(x25), .d(x01), .O(new_n131_));
  ...
  nand2  g090(.a(new_n103_), .b(new_n79_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n114_), .c(x29), .O(new_n136_));
  aoi21  g092(.a(new_n103_), .b(new_n79_), .c(new_n102_), .O(new_n137_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n138_), .c(new_n134_), .d(x31), .O(new_n154_));
  nand2  g110(.a(new_n126_), .b(x28), .O(new_n155_));
  oai21  g111(.a(x30), .b(x28), .c(new_n155_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n79_), .O(new_n157_));
  ...
  nand2  g134(.a(new_n178_), .b(new_n45_), .O(z8));
  nand2  g135(.a(new_n88_), .b(x14), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x18), .c(x17), .d(x16), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n151_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x17), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n168_), .c(new_n88_), .O(new_n184_));
  oai21  g140(.a(new_n183_), .b(new_n158_), .c(new_n151_), .O(new_n185_));
  inv1   g141(.a(x11), .O(new_n186_));
  oai21  g142(.a(new_n183_), .b(new_n186_), .c(new_n145_), .O(new_n187_));
  nand2  g143(.a(x18), .b(x12), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(new_n82_), .c(new_n85_), .d(new_n165_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n187_), .c(new_n185_), .d(new_n184_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n182_), .c(new_n45_), .O(new_n191_));
  or2    g147(.a(new_n137_), .b(x31), .O(new_n192_));
  nand2  g148(.a(new_n122_), .b(x30), .O(new_n193_));
  oai21  g149(.a(new_n137_), .b(new_n122_), .c(new_n193_), .O(new_n194_));
  aoi22  g150(.a(new_n194_), .b(new_n121_), .c(new_n192_), .d(new_n114_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n191_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(x33), .O(new_n197_));
  aoi21  g153(.a(new_n148_), .b(new_n144_), .c(new_n151_), .O(new_n198_));
  inv1   g154(.a(new_n152_), .O(new_n199_));
  nand4  g155(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n200_));
  oai22  g156(.a(new_n200_), .b(x07), .c(new_n192_), .d(x30), .O(new_n201_));
  oai21  g157(.a(new_n199_), .b(new_n198_), .c(new_n201_), .O(new_n202_));
  oai21  g158(.a(new_n202_), .b(x33), .c(new_n197_), .O(new_n203_));
