...
module FAU ( 
  ...
  nand3  g013(.a(new_n57_), .b(x07), .c(x04), .O(new_n58_));
  ...
  nand3  g027(.a(new_n57_), .b(new_n71_), .c(x04), .O(new_n72_));
  oai21  g028(.a(new_n71_), .b(x04), .c(new_n72_), .O(new_n73_));
  ...
  nand3  g053(.a(new_n97_), .b(new_n84_), .c(new_n57_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n83_), .c(new_n60_), .O(z3));
  xor2a  g055(.a(x28), .b(x27), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n97_), .c(new_n57_), .d(x25), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n60_), .c(new_n45_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n62_), .d(new_n57_), .O(new_n109_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n103_), .c(new_n62_), .d(new_n57_), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n83_), .c(new_n60_), .O(z6));
  nor2   g075(.a(new_n115_), .b(new_n104_), .O(new_n120_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n57_), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n83_), .O(new_n130_));
  ...
  nand3  g093(.a(x19), .b(new_n89_), .c(x13), .O(new_n138_));
  nand3  g094(.a(new_n92_), .b(x18), .c(x14), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n138_), .c(new_n86_), .O(new_n140_));
  ...
  oai21  g119(.a(new_n145_), .b(new_n163_), .c(new_n86_), .O(new_n164_));
  inv1   g120(.a(x13), .O(new_n165_));
  oai21  g121(.a(new_n92_), .b(new_n165_), .c(new_n89_), .O(new_n166_));
  ...
  nand3  g132(.a(new_n176_), .b(new_n57_), .c(x00), .O(new_n177_));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n127_), .d(new_n115_), .O(new_n185_));
  ...
  oai21  g152(.a(new_n89_), .b(new_n163_), .c(new_n86_), .O(new_n197_));
  nand2  g153(.a(new_n89_), .b(new_n165_), .O(new_n198_));
  ...
  nand2  g161(.a(new_n205_), .b(new_n45_), .O(z9));
endmodule
