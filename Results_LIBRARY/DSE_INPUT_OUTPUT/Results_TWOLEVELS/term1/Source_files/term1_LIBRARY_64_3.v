...
module FAU ( 
  ...
  aoi21  g135(.a(new_n179_), .b(new_n178_), .c(x30), .O(new_n180_));
  oai21  g136(.a(new_n178_), .b(new_n104_), .c(x30), .O(new_n181_));
  oai21  g137(.a(new_n178_), .b(x28), .c(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n80_), .c(new_n180_), .O(new_n183_));
  ...
  nand2  g143(.a(new_n178_), .b(new_n99_), .O(new_n188_));
  nand2  g144(.a(x31), .b(x30), .O(new_n189_));
  oai22  g145(.a(new_n188_), .b(x28), .c(new_n189_), .d(new_n144_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n80_), .O(new_n191_));
  oai21  g147(.a(new_n188_), .b(x29), .c(new_n191_), .O(new_n192_));
  oai21  g148(.a(new_n187_), .b(new_n186_), .c(new_n192_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(x33), .c(new_n185_), .O(new_n194_));
