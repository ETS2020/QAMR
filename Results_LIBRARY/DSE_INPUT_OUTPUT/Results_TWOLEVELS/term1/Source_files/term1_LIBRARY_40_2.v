...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n58_), .c(new_n47_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n79_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n58_), .c(new_n47_), .O(z4));
  ...
  oai21  g099(.a(new_n143_), .b(new_n130_), .c(new_n47_), .O(new_n144_));
  aoi21  g100(.a(new_n101_), .b(new_n100_), .c(new_n45_), .O(new_n145_));
  aoi21  g101(.a(x29), .b(x28), .c(x30), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n100_), .c(new_n145_), .d(x29), .O(new_n147_));
