...
module FAU ( 
  ...
  and2   g069(.a(new_n109_), .b(new_n83_), .O(new_n114_));
  xor2a  g070(.a(x28), .b(x27), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n114_), .c(x25), .d(x01), .O(new_n116_));
  aoi21  g072(.a(new_n116_), .b(new_n45_), .c(x26), .O(z4));
  ...
  nand4  g079(.a(new_n123_), .b(new_n83_), .c(x25), .d(x01), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n45_), .c(x26), .O(z5));
  ...
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(new_n118_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n83_), .c(x25), .d(x01), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n45_), .c(x26), .O(z6));
  ...
  inv1   g092(.a(new_n107_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n104_), .O(new_n138_));
  nand3  g094(.a(new_n83_), .b(x25), .c(x01), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nor4   g096(.a(new_n119_), .b(x31), .c(new_n128_), .d(new_n121_), .O(new_n141_));
