// Benchmark "FAU" written by ABC on Thu Aug 20 01:03:33 2020
...
module FAU ( 
  ...
  nand2  g001(.a(x31), .b(new_n45_), .O(new_n46_));
  ...
  oai21  g049(.a(new_n93_), .b(new_n59_), .c(new_n46_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n92_), .c(new_n80_), .d(x25), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n59_), .c(new_n46_), .O(z4));
  ...
  nand4  g058(.a(new_n102_), .b(new_n90_), .c(new_n61_), .d(new_n46_), .O(new_n103_));
  ...
  nand3  g063(.a(new_n100_), .b(new_n107_), .c(new_n45_), .O(new_n108_));
  oai21  g064(.a(new_n100_), .b(new_n45_), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x29), .O(new_n110_));
  nand2  g066(.a(x30), .b(new_n98_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n110_), .c(new_n91_), .O(new_n112_));
  ...
  nand4  g072(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n117_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n120_), .c(new_n80_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n119_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n118_), .c(new_n117_), .d(new_n116_), .O(z7));
  inv1   g080(.a(x32), .O(new_n125_));
  nand2  g081(.a(new_n99_), .b(new_n81_), .O(new_n126_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n127_), .c(new_n125_), .d(x31), .O(new_n146_));
  aoi21  g102(.a(new_n99_), .b(new_n81_), .c(new_n98_), .O(new_n147_));
  nand2  g103(.a(x16), .b(x10), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n138_), .c(new_n143_), .O(new_n149_));
  nand2  g105(.a(x19), .b(x18), .O(new_n150_));
  nand2  g106(.a(x17), .b(x11), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n150_), .c(new_n137_), .O(new_n152_));
  inv1   g108(.a(x12), .O(new_n153_));
  oai21  g109(.a(new_n150_), .b(new_n153_), .c(new_n128_), .O(new_n154_));
  aoi21  g110(.a(x19), .b(x13), .c(x18), .O(new_n155_));
  nor2   g111(.a(x19), .b(x14), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n138_), .c(x31), .O(new_n158_));
  nor3   g114(.a(new_n158_), .b(new_n156_), .c(new_n155_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n154_), .c(new_n152_), .d(new_n149_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n147_), .c(x32), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n146_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n80_), .c(x00), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n46_), .O(z8));
  nand2  g120(.a(new_n131_), .b(x14), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(x18), .c(x17), .d(x16), .O(new_n166_));
  nor2   g122(.a(new_n166_), .b(new_n143_), .O(new_n167_));
  nand2  g123(.a(x18), .b(x17), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n157_), .c(new_n131_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n148_), .c(new_n143_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n168_), .b(new_n171_), .c(new_n137_), .O(new_n172_));
  aoi21  g128(.a(x18), .b(x12), .c(x17), .O(new_n173_));
  nor2   g129(.a(x18), .b(x13), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n172_), .c(new_n170_), .d(new_n169_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n167_), .c(new_n46_), .O(new_n177_));
  aoi21  g133(.a(new_n99_), .b(new_n81_), .c(x31), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(x29), .c(new_n127_), .d(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n177_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  aoi21  g137(.a(new_n140_), .b(new_n136_), .c(new_n143_), .O(new_n182_));
  inv1   g138(.a(new_n144_), .O(new_n183_));
  nand4  g139(.a(new_n126_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
  nand3  g140(.a(new_n127_), .b(new_n107_), .c(new_n45_), .O(new_n185_));
