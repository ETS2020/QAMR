...
module FAU ( 
  ...
  nand3  g060(.a(new_n45_), .b(x29), .c(new_n81_), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n81_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n94_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  ...
  nand4  g067(.a(new_n45_), .b(x29), .c(x28), .d(x27), .O(new_n112_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n109_), .c(x31), .O(new_n123_));
  ...
  nand4  g082(.a(new_n126_), .b(new_n124_), .c(new_n123_), .d(new_n121_), .O(z7));
  nand4  g083(.a(x32), .b(new_n109_), .c(new_n80_), .d(x00), .O(new_n128_));
  ...
  nand2  g090(.a(x30), .b(new_n110_), .O(new_n135_));
  ...
  oai21  g115(.a(new_n156_), .b(new_n159_), .c(new_n85_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n91_), .b(new_n161_), .c(new_n88_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x15), .O(new_n163_));
  oai22  g119(.a(new_n163_), .b(new_n144_), .c(x19), .d(x14), .O(new_n164_));
  nand2  g120(.a(new_n45_), .b(new_n110_), .O(new_n165_));
  ...
  aoi21  g129(.a(new_n45_), .b(new_n110_), .c(new_n132_), .O(new_n174_));
  ...
  nand3  g136(.a(new_n133_), .b(new_n118_), .c(x29), .O(new_n181_));
  nor2   g137(.a(new_n88_), .b(new_n85_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n163_), .c(new_n91_), .O(new_n184_));
  oai21  g140(.a(new_n183_), .b(new_n153_), .c(new_n149_), .O(new_n185_));
  aoi21  g141(.a(new_n182_), .b(x11), .c(x16), .O(new_n186_));
  oai21  g142(.a(new_n88_), .b(new_n159_), .c(new_n85_), .O(new_n187_));
  nand2  g143(.a(new_n88_), .b(new_n161_), .O(new_n188_));
  nand2  g144(.a(x31), .b(new_n45_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n188_), .c(new_n187_), .d(new_n135_), .O(new_n190_));
  nor2   g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n185_), .c(new_n184_), .d(new_n181_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n180_), .c(x33), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n177_), .O(new_n194_));
