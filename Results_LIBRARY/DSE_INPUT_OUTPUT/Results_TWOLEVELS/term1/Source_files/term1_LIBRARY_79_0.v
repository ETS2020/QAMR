...
module FAU ( 
  ...
  nand4  g063(.a(new_n107_), .b(new_n97_), .c(x25), .d(x01), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(x00), .c(x26), .O(z3));
  xor2a  g065(.a(x28), .b(x27), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n107_), .c(x25), .d(x01), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(x00), .c(x26), .O(z4));
  inv1   g068(.a(x26), .O(new_n113_));
  inv1   g069(.a(new_n81_), .O(new_n114_));
  inv1   g070(.a(x29), .O(new_n115_));
  inv1   g071(.a(x28), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n97_), .O(new_n117_));
  nand3  g073(.a(new_n115_), .b(x28), .c(x27), .O(new_n118_));
  oai21  g074(.a(new_n117_), .b(new_n115_), .c(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n105_), .c(new_n114_), .d(new_n113_), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x25), .c(x01), .d(x00), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(z5));
  nand3  g079(.a(x29), .b(x28), .c(x27), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  inv1   g081(.a(x30), .O(new_n126_));
  nand3  g082(.a(new_n117_), .b(new_n126_), .c(x29), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n125_), .c(new_n106_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n114_), .c(x25), .d(x01), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(x00), .c(x26), .O(z6));
  inv1   g086(.a(new_n117_), .O(new_n131_));
  nand2  g087(.a(x30), .b(x29), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(x31), .O(new_n133_));
  inv1   g089(.a(new_n101_), .O(new_n134_));
  inv1   g090(.a(new_n102_), .O(new_n135_));
  inv1   g091(.a(new_n103_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n135_), .c(new_n134_), .d(new_n100_), .O(new_n137_));
  nor2   g093(.a(new_n81_), .b(new_n59_), .O(new_n138_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n117_), .c(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n138_), .c(new_n137_), .d(new_n133_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x00), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n113_), .O(z7));
  nor2   g102(.a(x28), .b(x27), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n115_), .O(new_n148_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n160_), .c(x11), .O(new_n163_));
  ...
  nand4  g124(.a(new_n168_), .b(new_n150_), .c(x31), .d(x30), .O(new_n169_));
  nand3  g125(.a(x32), .b(new_n126_), .c(x00), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n149_), .O(new_n172_));
  inv1   g128(.a(new_n147_), .O(new_n173_));
  nand4  g129(.a(new_n168_), .b(new_n173_), .c(new_n150_), .d(x31), .O(new_n174_));
  inv1   g130(.a(x00), .O(new_n175_));
  oai21  g131(.a(new_n97_), .b(new_n175_), .c(new_n116_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(x32), .c(x30), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(x30), .c(new_n177_), .O(new_n178_));
  nand2  g134(.a(new_n154_), .b(x14), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x18), .c(x17), .d(x16), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n166_), .O(new_n181_));
  nand4  g137(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n154_), .O(new_n183_));
  nand2  g139(.a(x18), .b(x17), .O(new_n184_));
  nand2  g140(.a(x16), .b(x10), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n184_), .c(new_n166_), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n187_), .c(new_n160_), .O(new_n188_));
  aoi21  g144(.a(x18), .b(x12), .c(x17), .O(new_n189_));
  nor2   g145(.a(x18), .b(x13), .O(new_n190_));
  nor3   g146(.a(new_n190_), .b(new_n189_), .c(new_n140_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n188_), .c(new_n186_), .d(new_n183_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n181_), .c(x32), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x00), .O(new_n194_));
  aoi21  g150(.a(new_n178_), .b(x29), .c(new_n194_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n172_), .c(x26), .O(z8));
  inv1   g152(.a(x33), .O(new_n197_));
  nand4  g153(.a(new_n176_), .b(x31), .c(x30), .d(x29), .O(new_n198_));
  nand3  g154(.a(new_n149_), .b(new_n140_), .c(new_n126_), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n168_), .c(new_n197_), .O(new_n201_));
  inv1   g157(.a(new_n181_), .O(new_n202_));
  oai21  g158(.a(new_n148_), .b(x30), .c(new_n140_), .O(new_n203_));
  oai21  g159(.a(new_n147_), .b(new_n132_), .c(x31), .O(new_n204_));
  inv1   g160(.a(new_n183_), .O(new_n205_));
  nor2   g161(.a(new_n190_), .b(new_n189_), .O(new_n206_));
  nand3  g162(.a(new_n206_), .b(new_n188_), .c(new_n186_), .O(new_n207_));
  nor2   g163(.a(new_n207_), .b(new_n205_), .O(new_n208_));
  nand4  g164(.a(new_n208_), .b(new_n204_), .c(new_n203_), .d(new_n202_), .O(new_n209_));
  aoi21  g165(.a(new_n209_), .b(x33), .c(new_n175_), .O(new_n210_));
  aoi21  g166(.a(new_n210_), .b(new_n201_), .c(x26), .O(z9));
endmodule
