...
module FAU ( 
  ...
  nand4  g52(.a(new_n96_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n97_));
  inv1   g53(.a(new_n97_), .O(new_n98_));
  nand4  g54(.a(new_n98_), .b(x25), .c(x01), .d(new_n45_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(z4));
  nor3   g56(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n101_));
  inv1   g57(.a(x29), .O(new_n102_));
  and2   g58(.a(x28), .b(x27), .O(new_n103_));
  or2    g59(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand3  g60(.a(new_n102_), .b(x28), .c(x27), .O(new_n105_));
  aoi22  g61(.a(new_n105_), .b(new_n104_), .c(new_n101_), .d(new_n84_), .O(new_n106_));
  ...
  aoi22  g68(.a(new_n112_), .b(new_n110_), .c(new_n101_), .d(new_n84_), .O(new_n113_));
  ...
  nand4  g73(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n118_));
  aoi21  g74(.a(x03), .b(x02), .c(new_n60_), .O(new_n119_));
  ...
  aoi21  g79(.a(new_n123_), .b(new_n103_), .c(new_n120_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(new_n125_));
  nand2  g81(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(new_n80_), .O(z7));
  nor2   g83(.a(x26), .b(new_n45_), .O(z9));
endmodule
