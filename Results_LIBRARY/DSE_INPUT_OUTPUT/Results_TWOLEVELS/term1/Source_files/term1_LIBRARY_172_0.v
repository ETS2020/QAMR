...
module FAU ( 
  ...
  nand2  g057(.a(new_n101_), .b(new_n93_), .O(new_n102_));
  oai21  g058(.a(new_n98_), .b(new_n93_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n87_), .c(new_n60_), .d(new_n79_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n92_), .c(new_n58_), .O(z5));
  nand2  g061(.a(x30), .b(new_n93_), .O(new_n106_));
  nand2  g062(.a(new_n100_), .b(x29), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n93_), .c(new_n106_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x28), .O(new_n109_));
  inv1   g065(.a(x28), .O(new_n110_));
  oai21  g066(.a(new_n99_), .b(new_n110_), .c(x30), .O(new_n111_));
  ...
  nand2  g073(.a(x31), .b(new_n100_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nor2   g075(.a(new_n99_), .b(new_n110_), .O(new_n120_));
  ...
  nor3   g081(.a(new_n100_), .b(new_n99_), .c(x28), .O(new_n126_));
  ...
  nand2  g107(.a(new_n110_), .b(new_n93_), .O(new_n152_));
  nand2  g108(.a(x30), .b(new_n99_), .O(new_n153_));
  ...
  nand3  g134(.a(new_n119_), .b(new_n100_), .c(new_n99_), .O(new_n179_));
