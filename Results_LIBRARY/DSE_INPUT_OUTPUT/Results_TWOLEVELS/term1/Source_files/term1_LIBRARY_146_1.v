...
module FAU ( 
  ...
  nor2   g017(.a(new_n51_), .b(new_n50_), .O(new_n62_));
  inv1   g018(.a(new_n62_), .O(new_n63_));
  nand2  g019(.a(new_n51_), .b(new_n50_), .O(new_n64_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n92_), .c(new_n63_), .d(new_n59_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n82_), .c(x25), .d(x01), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(z5));
  nand3  g064(.a(new_n102_), .b(new_n55_), .c(new_n58_), .O(new_n109_));
  oai21  g065(.a(new_n102_), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  ...
  nor2   g070(.a(new_n114_), .b(new_n61_), .O(z6));
  oai21  g071(.a(x32), .b(x31), .c(new_n58_), .O(new_n116_));
  ...
  nand2  g081(.a(new_n101_), .b(new_n83_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n58_), .c(x29), .O(new_n127_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n130_), .c(new_n55_), .d(x31), .O(new_n149_));
  ...
  nor2   g118(.a(new_n162_), .b(new_n121_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n160_), .c(new_n158_), .O(new_n164_));
  ...
  oai21  g130(.a(new_n172_), .b(new_n151_), .c(new_n146_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n176_), .c(new_n140_), .O(new_n177_));
  nand2  g133(.a(x18), .b(x12), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n131_), .O(new_n179_));
  aoi21  g135(.a(new_n132_), .b(new_n157_), .c(new_n162_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n177_), .d(new_n175_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n174_), .c(new_n59_), .O(new_n182_));
  nand3  g138(.a(x30), .b(x18), .c(x17), .O(new_n183_));
  oai22  g139(.a(new_n183_), .b(new_n161_), .c(x32), .d(x19), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n159_), .O(new_n185_));
  nand3  g141(.a(new_n126_), .b(new_n55_), .c(x29), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n58_), .c(x31), .O(new_n187_));
  nand3  g143(.a(new_n55_), .b(x31), .c(new_n58_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n129_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n185_), .c(new_n182_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  nand4  g148(.a(new_n126_), .b(x31), .c(x30), .d(x29), .O(new_n193_));
  nand4  g149(.a(new_n128_), .b(new_n55_), .c(new_n121_), .d(new_n58_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n148_), .c(new_n46_), .O(new_n196_));
