...
module FAU ( 
  ...
  oai21  g066(.a(new_n110_), .b(new_n81_), .c(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n112_));
  ...
  nand3  g072(.a(new_n116_), .b(new_n80_), .c(x25), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n59_), .c(new_n58_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n115_), .c(new_n46_), .O(z7));
  ...
  oai21  g084(.a(new_n125_), .b(new_n128_), .c(new_n83_), .O(new_n129_));
  inv1   g085(.a(x13), .O(new_n130_));
  oai21  g086(.a(new_n89_), .b(new_n130_), .c(new_n86_), .O(new_n131_));
  ...
  aoi22  g095(.a(new_n139_), .b(new_n81_), .c(new_n109_), .d(new_n102_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  nand3  g099(.a(new_n110_), .b(x30), .c(new_n81_), .O(new_n144_));
  nand2  g100(.a(new_n100_), .b(new_n81_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n109_), .c(x29), .O(new_n146_));
  ...
  inv1   g109(.a(new_n121_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n124_), .c(x11), .O(new_n155_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n133_), .c(new_n89_), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(new_n120_), .c(new_n158_), .O(new_n170_));
  inv1   g126(.a(x11), .O(new_n171_));
  oai21  g127(.a(new_n168_), .b(new_n171_), .c(new_n124_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x12), .O(new_n173_));
  aoi22  g129(.a(new_n173_), .b(new_n83_), .c(new_n86_), .d(new_n130_), .O(new_n174_));
  ...
  nand2  g134(.a(new_n110_), .b(x31), .O(new_n179_));
  oai21  g135(.a(x31), .b(new_n109_), .c(new_n179_), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n81_), .c(new_n178_), .d(new_n109_), .O(new_n181_));
  ...
  nand3  g145(.a(new_n116_), .b(new_n109_), .c(new_n102_), .O(new_n190_));
