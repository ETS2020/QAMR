...
module FAU ( 
  ...
  nand3  g051(.a(new_n95_), .b(new_n82_), .c(new_n81_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n80_), .c(new_n59_), .O(z3));
  inv1   g053(.a(x28), .O(new_n98_));
  nor2   g054(.a(new_n45_), .b(x28), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(x27), .O(new_n100_));
  oai21  g056(.a(new_n98_), .b(x27), .c(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n95_), .c(new_n81_), .d(x25), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n59_), .c(new_n46_), .O(z4));
  oai21  g059(.a(new_n99_), .b(new_n82_), .c(x29), .O(new_n104_));
  nor2   g060(.a(new_n45_), .b(x29), .O(new_n105_));
  ...
  nor3   g064(.a(new_n108_), .b(new_n80_), .c(new_n59_), .O(z5));
  ...
  oai21  g075(.a(new_n119_), .b(new_n82_), .c(x31), .O(new_n120_));
  ...
  oai21  g094(.a(new_n105_), .b(new_n82_), .c(new_n138_), .O(new_n139_));
  ...
  nand3  g099(.a(new_n119_), .b(new_n45_), .c(new_n82_), .O(new_n144_));
  oai21  g100(.a(new_n143_), .b(new_n142_), .c(new_n144_), .O(new_n145_));
  aoi21  g101(.a(new_n141_), .b(new_n46_), .c(new_n145_), .O(new_n146_));
  ...
  nand3  g106(.a(new_n45_), .b(x29), .c(x28), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n99_), .c(new_n82_), .O(new_n153_));
  ...
  nand2  g126(.a(new_n91_), .b(x14), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x18), .c(x17), .d(x16), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n125_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n140_), .c(new_n91_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n126_), .c(new_n125_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n129_), .O(new_n178_));
  ...
  oai21  g140(.a(new_n45_), .b(new_n98_), .c(x31), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n116_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n82_), .c(new_n184_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n183_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  aoi21  g145(.a(new_n162_), .b(new_n160_), .c(new_n125_), .O(new_n190_));
  inv1   g146(.a(new_n165_), .O(new_n191_));
  nand4  g147(.a(new_n119_), .b(new_n115_), .c(new_n45_), .d(new_n82_), .O(new_n192_));
  nand2  g148(.a(new_n98_), .b(new_n82_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n192_), .O(new_n195_));
  oai21  g151(.a(new_n191_), .b(new_n190_), .c(new_n195_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(x33), .c(new_n189_), .O(new_n197_));
