...
module FAU ( 
  ...
  aoi21  g075(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(x17), .c(x16), .d(x15), .O(new_n121_));
  ...
  and2   g081(.a(new_n125_), .b(new_n91_), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  inv1   g083(.a(x15), .O(new_n128_));
  nand4  g084(.a(x18), .b(x17), .c(x16), .d(x10), .O(new_n129_));
  ...
  nand2  g089(.a(new_n133_), .b(new_n85_), .O(new_n134_));
  inv1   g090(.a(x13), .O(new_n135_));
  nand2  g091(.a(new_n88_), .b(new_n135_), .O(new_n136_));
  inv1   g092(.a(x31), .O(new_n137_));
  aoi21  g093(.a(new_n46_), .b(new_n107_), .c(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n138_), .b(new_n136_), .c(new_n134_), .d(new_n132_), .O(new_n139_));
  aoi21  g095(.a(new_n129_), .b(new_n128_), .c(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n127_), .c(new_n124_), .d(new_n121_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  aoi21  g099(.a(new_n46_), .b(x28), .c(x27), .O(new_n144_));
  nor2   g100(.a(new_n107_), .b(new_n99_), .O(new_n145_));
  oai22  g101(.a(new_n145_), .b(new_n46_), .c(new_n144_), .d(new_n107_), .O(new_n146_));
  ...
  nand3  g110(.a(new_n154_), .b(new_n130_), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n152_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x15), .O(new_n157_));
  nand3  g113(.a(x16), .b(new_n128_), .c(x10), .O(new_n158_));
  ...
  aoi21  g124(.a(new_n155_), .b(new_n152_), .c(new_n128_), .O(new_n169_));
  oai21  g125(.a(x28), .b(x27), .c(x29), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n137_), .c(new_n46_), .O(new_n171_));
  nand3  g127(.a(new_n145_), .b(x31), .c(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  oai21  g129(.a(new_n159_), .b(new_n169_), .c(new_n173_), .O(new_n174_));
  oai21  g130(.a(new_n145_), .b(x30), .c(new_n137_), .O(new_n175_));
  nand2  g131(.a(new_n122_), .b(x31), .O(new_n176_));
  nand2  g132(.a(new_n129_), .b(new_n128_), .O(new_n177_));
  nand4  g133(.a(new_n136_), .b(new_n134_), .c(new_n132_), .d(new_n177_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n126_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n176_), .c(new_n175_), .d(new_n121_), .O(new_n180_));
