...
module FAU ( 
  ...
  nand4  g072(.a(new_n116_), .b(new_n102_), .c(new_n63_), .d(new_n46_), .O(new_n117_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n127_), .c(new_n46_), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n98_), .O(new_n131_));
  ...
  oai21  g119(.a(new_n146_), .b(new_n45_), .c(new_n84_), .O(new_n164_));
  inv1   g120(.a(x13), .O(new_n165_));
  oai21  g121(.a(new_n90_), .b(new_n165_), .c(new_n87_), .O(new_n166_));
  nor2   g122(.a(x19), .b(x14), .O(new_n167_));
  nor2   g123(.a(new_n145_), .b(new_n153_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n149_), .c(new_n167_), .O(new_n169_));
  ...
  nand4  g129(.a(new_n173_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n174_));
  ...
  nand4  g135(.a(new_n155_), .b(new_n179_), .c(x31), .d(x30), .O(new_n180_));
  ...
  nand4  g140(.a(new_n155_), .b(new_n179_), .c(new_n128_), .d(new_n114_), .O(new_n185_));
  ...
  oai21  g152(.a(new_n87_), .b(new_n45_), .c(new_n84_), .O(new_n197_));
