...
module FAU ( 
  ...
  nand2  g000(.a(x28), .b(x26), .O(new_n45_));
  ...
  nand3  g053(.a(new_n97_), .b(x27), .c(new_n80_), .O(new_n98_));
  oai21  g054(.a(new_n97_), .b(x27), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n60_), .d(x25), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n58_), .c(new_n45_), .O(z4));
  inv1   g057(.a(x29), .O(new_n102_));
  nor2   g058(.a(new_n97_), .b(new_n81_), .O(new_n103_));
  nand3  g059(.a(new_n102_), .b(x28), .c(x27), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n102_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n94_), .c(new_n60_), .d(new_n80_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n79_), .c(new_n58_), .O(z5));
  inv1   g063(.a(x30), .O(new_n108_));
  nand2  g064(.a(x29), .b(x28), .O(new_n109_));
  aoi22  g065(.a(new_n109_), .b(new_n80_), .c(x28), .d(new_n81_), .O(new_n110_));
  ...
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(x31), .O(new_n117_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n115_), .c(new_n80_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n79_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n119_), .c(new_n118_), .d(new_n117_), .O(z7));
  inv1   g080(.a(x32), .O(new_n125_));
  oai21  g081(.a(new_n81_), .b(x26), .c(new_n97_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n108_), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n97_), .b(new_n81_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x29), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(x30), .c(new_n80_), .O(new_n130_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n131_), .c(new_n125_), .d(x31), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  nand3  g106(.a(x30), .b(x29), .c(x28), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  nor3   g108(.a(x30), .b(x28), .c(x26), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n152_), .c(new_n81_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n142_), .c(x15), .O(new_n157_));
  nand2  g113(.a(x17), .b(x11), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n139_), .c(new_n138_), .O(new_n159_));
  inv1   g115(.a(x12), .O(new_n160_));
  oai21  g116(.a(new_n139_), .b(new_n160_), .c(new_n85_), .O(new_n161_));
  ...
  aoi21  g121(.a(new_n108_), .b(new_n102_), .c(new_n120_), .O(new_n166_));
  oai21  g122(.a(new_n116_), .b(new_n81_), .c(new_n166_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n157_), .c(new_n80_), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n154_), .c(new_n125_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n150_), .c(x00), .O(new_n172_));
  ...
  nand3  g133(.a(new_n177_), .b(new_n128_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n148_), .b(new_n174_), .c(new_n120_), .d(new_n108_), .O(new_n179_));
  nand2  g135(.a(x33), .b(x31), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n129_), .O(new_n182_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n164_), .c(new_n91_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n155_), .c(new_n146_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(new_n188_), .c(new_n138_), .O(new_n189_));
  oai21  g145(.a(new_n88_), .b(new_n160_), .c(new_n85_), .O(new_n190_));
  nand2  g146(.a(new_n88_), .b(new_n162_), .O(new_n191_));
  ...
  nand3  g152(.a(new_n196_), .b(new_n182_), .c(new_n178_), .O(new_n197_));
