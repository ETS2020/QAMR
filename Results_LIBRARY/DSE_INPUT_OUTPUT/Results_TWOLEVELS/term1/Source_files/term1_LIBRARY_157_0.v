...
module FAU ( 
  ...
  oai21  g079(.a(new_n123_), .b(new_n99_), .c(new_n56_), .O(new_n124_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n132_), .c(new_n127_), .d(x31), .O(new_n153_));
  ...
  oai21  g117(.a(new_n143_), .b(new_n161_), .c(new_n133_), .O(new_n162_));
  ...
  nand4  g138(.a(new_n152_), .b(new_n177_), .c(new_n122_), .d(new_n108_), .O(new_n183_));
  ...
  inv1   g142(.a(new_n158_), .O(new_n187_));
  xnor2a g143(.a(x31), .b(x30), .O(new_n188_));
  and2   g144(.a(new_n188_), .b(new_n167_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n187_), .c(x33), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n186_), .c(new_n181_), .O(new_n192_));
