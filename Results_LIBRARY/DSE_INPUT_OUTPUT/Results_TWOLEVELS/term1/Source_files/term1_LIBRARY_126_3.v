...
module FAU ( 
  ...
  nand4  g052(.a(new_n45_), .b(new_n96_), .c(x28), .d(x27), .O(new_n97_));
  inv1   g053(.a(x28), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(new_n80_), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand2  g056(.a(x30), .b(x04), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n100_), .c(x29), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n97_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(new_n89_), .c(new_n79_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n95_), .c(new_n58_), .O(z5));
  inv1   g061(.a(x04), .O(new_n106_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n88_), .c(new_n60_), .d(new_n79_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n95_), .c(new_n58_), .O(z6));
  nor4   g069(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n114_));
  nand4  g070(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n115_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n100_), .c(new_n118_), .O(new_n121_));
  aoi22  g077(.a(new_n121_), .b(new_n106_), .c(x31), .d(new_n109_), .O(new_n122_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n127_), .c(new_n45_), .O(new_n144_));
  oai21  g100(.a(x28), .b(x27), .c(x30), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n96_), .O(new_n146_));
  nand2  g102(.a(new_n98_), .b(new_n80_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(x29), .O(new_n148_));
  aoi22  g104(.a(new_n148_), .b(new_n109_), .c(new_n146_), .d(new_n106_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n144_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand3  g108(.a(new_n148_), .b(x30), .c(new_n106_), .O(new_n153_));
  nand3  g109(.a(new_n147_), .b(new_n109_), .c(x29), .O(new_n154_));
  ...
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n133_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(new_n133_), .d(x12), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(x16), .O(new_n161_));
  inv1   g117(.a(new_n125_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n128_), .c(x11), .O(new_n163_));
  ...
  nand2  g128(.a(new_n137_), .b(x14), .O(new_n173_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n140_), .c(new_n137_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n124_), .c(new_n166_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n128_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n133_), .c(new_n136_), .d(new_n135_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n175_), .c(new_n45_), .O(new_n184_));
  nand2  g140(.a(new_n148_), .b(new_n119_), .O(new_n185_));
  nand2  g141(.a(new_n119_), .b(x30), .O(new_n186_));
  nand2  g142(.a(new_n148_), .b(x31), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(new_n106_), .c(new_n185_), .d(new_n109_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n184_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n163_), .b(new_n161_), .c(new_n166_), .O(new_n192_));
  inv1   g148(.a(new_n167_), .O(new_n193_));
  nand4  g149(.a(new_n147_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  oai22  g150(.a(new_n194_), .b(x04), .c(new_n185_), .d(x30), .O(new_n195_));
  oai21  g151(.a(new_n193_), .b(new_n192_), .c(new_n195_), .O(new_n196_));
