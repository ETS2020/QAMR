...
module FAU ( 
  ...
  and2   g072(.a(x28), .b(x27), .O(new_n117_));
  nand3  g073(.a(new_n116_), .b(x28), .c(x27), .O(new_n118_));
  oai21  g074(.a(new_n117_), .b(new_n116_), .c(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n115_), .c(new_n83_), .d(new_n114_), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(x25), .c(x01), .d(new_n45_), .O(new_n122_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n115_), .c(new_n83_), .d(new_n114_), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(x25), .c(x01), .d(new_n45_), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(z6));
  nand3  g088(.a(new_n117_), .b(x30), .c(x29), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x31), .O(new_n134_));
  inv1   g090(.a(new_n102_), .O(new_n135_));
  nand4  g091(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n135_), .O(new_n136_));
  nor2   g092(.a(new_n101_), .b(new_n61_), .O(new_n137_));
  ...
  aoi21  g097(.a(new_n141_), .b(new_n117_), .c(new_n138_), .O(new_n142_));
  nand4  g098(.a(new_n142_), .b(new_n137_), .c(new_n136_), .d(new_n134_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n45_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n114_), .O(z7));
  zero   g101(.O(z9));
endmodule
