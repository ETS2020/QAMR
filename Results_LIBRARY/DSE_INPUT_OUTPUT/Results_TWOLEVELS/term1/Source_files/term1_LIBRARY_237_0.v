...
module FAU ( 
  ...
  oai21  g054(.a(x28), .b(new_n98_), .c(x27), .O(new_n99_));
  ...
  nor2   g065(.a(new_n109_), .b(new_n79_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n108_), .c(x29), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n107_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n87_), .c(new_n60_), .d(new_n92_), .O(new_n113_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n121_), .c(new_n120_), .d(new_n82_), .O(new_n123_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n136_), .c(x31), .d(x30), .O(new_n155_));
  nand3  g111(.a(x32), .b(new_n108_), .c(x00), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n135_), .O(new_n158_));
  inv1   g114(.a(new_n133_), .O(new_n159_));
  nand4  g115(.a(new_n154_), .b(new_n159_), .c(new_n136_), .d(x31), .O(new_n160_));
  oai21  g116(.a(new_n79_), .b(new_n98_), .c(new_n109_), .O(new_n161_));
  ...
  oai21  g128(.a(new_n169_), .b(new_n172_), .c(new_n146_), .O(new_n173_));
  aoi21  g129(.a(x18), .b(x12), .c(x17), .O(new_n174_));
  nor2   g130(.a(x18), .b(x13), .O(new_n175_));
  nor3   g131(.a(new_n175_), .b(new_n174_), .c(new_n126_), .O(new_n176_));
  ...
  aoi21  g135(.a(new_n163_), .b(x29), .c(new_n179_), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n158_), .c(x26), .O(z8));
  inv1   g137(.a(x33), .O(new_n182_));
  nand4  g138(.a(new_n161_), .b(x31), .c(x30), .d(x29), .O(new_n183_));
  nand3  g139(.a(new_n135_), .b(new_n126_), .c(new_n108_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n154_), .c(new_n182_), .O(new_n186_));
  inv1   g142(.a(new_n166_), .O(new_n187_));
  oai21  g143(.a(new_n134_), .b(x30), .c(new_n126_), .O(new_n188_));
  oai21  g144(.a(new_n133_), .b(new_n118_), .c(x31), .O(new_n189_));
  inv1   g145(.a(new_n168_), .O(new_n190_));
  nor2   g146(.a(new_n175_), .b(new_n174_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n173_), .c(new_n171_), .O(new_n192_));
  nor2   g148(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n189_), .c(new_n188_), .d(new_n187_), .O(new_n194_));
  aoi21  g150(.a(new_n194_), .b(x33), .c(new_n98_), .O(new_n195_));
  aoi21  g151(.a(new_n195_), .b(new_n186_), .c(x26), .O(z9));
endmodule
