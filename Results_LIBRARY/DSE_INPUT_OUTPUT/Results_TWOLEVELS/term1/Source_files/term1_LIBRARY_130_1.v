...
module FAU ( 
  ...
  oai21  g065(.a(new_n108_), .b(new_n80_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n89_), .c(new_n61_), .d(x27), .O(new_n111_));
  ...
  nand4  g071(.a(new_n61_), .b(new_n81_), .c(x25), .d(x01), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n46_), .O(new_n117_));
  inv1   g073(.a(x31), .O(new_n118_));
  nand3  g074(.a(new_n108_), .b(new_n118_), .c(x30), .O(new_n119_));
  oai21  g075(.a(new_n108_), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(x27), .c(x31), .d(new_n80_), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n117_), .O(z7));
  nand2  g078(.a(new_n81_), .b(x00), .O(new_n123_));
  nand3  g079(.a(x32), .b(new_n80_), .c(new_n98_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n123_), .c(new_n80_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(new_n45_), .O(new_n126_));
  inv1   g082(.a(x32), .O(new_n127_));
  nand2  g083(.a(new_n98_), .b(new_n45_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n80_), .c(x29), .O(new_n129_));
  nand2  g085(.a(x30), .b(new_n100_), .O(new_n130_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n131_), .c(new_n127_), .d(x31), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  aoi21  g108(.a(new_n152_), .b(new_n143_), .c(x15), .O(new_n153_));
  ...
  oai21  g115(.a(new_n135_), .b(new_n159_), .c(new_n133_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x15), .O(new_n161_));
  oai22  g117(.a(new_n161_), .b(new_n142_), .c(x19), .d(x14), .O(new_n162_));
  aoi21  g118(.a(new_n80_), .b(new_n100_), .c(new_n118_), .O(new_n163_));
  oai21  g119(.a(new_n80_), .b(new_n100_), .c(new_n163_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n160_), .c(new_n158_), .d(new_n156_), .O(new_n166_));
  oai21  g122(.a(new_n166_), .b(new_n153_), .c(x32), .O(new_n167_));
  ...
  nand2  g126(.a(new_n135_), .b(x14), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(x18), .c(x17), .d(x16), .O(new_n172_));
  nor2   g128(.a(new_n172_), .b(new_n147_), .O(new_n173_));
  nand2  g129(.a(x18), .b(x17), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n161_), .c(new_n135_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n151_), .c(new_n147_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n141_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x12), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n132_), .c(new_n133_), .d(new_n159_), .O(new_n180_));
  ...
  oai21  g138(.a(x31), .b(new_n100_), .c(new_n130_), .O(new_n183_));
  aoi21  g139(.a(new_n107_), .b(new_n118_), .c(x30), .O(new_n184_));
  ...
  aoi21  g143(.a(new_n144_), .b(new_n140_), .c(new_n147_), .O(new_n188_));
  inv1   g144(.a(new_n148_), .O(new_n189_));
  nand2  g145(.a(new_n128_), .b(x29), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n118_), .c(new_n80_), .O(new_n191_));
