...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n60_), .c(new_n58_), .O(z4));
  inv1   g049(.a(x28), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n82_), .c(x29), .O(new_n95_));
  nand3  g051(.a(new_n45_), .b(x28), .c(x27), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n95_), .c(new_n87_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n62_), .c(new_n81_), .O(new_n98_));
  ...
  nand4  g059(.a(new_n103_), .b(new_n88_), .c(new_n81_), .d(x25), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n60_), .c(new_n58_), .O(z6));
  inv1   g061(.a(new_n85_), .O(new_n106_));
  nor2   g062(.a(new_n84_), .b(new_n83_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand3  g064(.a(new_n62_), .b(x25), .c(x01), .O(new_n109_));
  nor4   g065(.a(new_n109_), .b(new_n47_), .c(x31), .d(x26), .O(new_n110_));
  ...
  aoi21  g071(.a(new_n115_), .b(new_n113_), .c(x15), .O(new_n116_));
  inv1   g072(.a(x16), .O(new_n117_));
  nand2  g073(.a(x19), .b(x18), .O(new_n118_));
  ...
  oai21  g078(.a(new_n118_), .b(new_n121_), .c(new_n122_), .O(new_n123_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n114_), .c(x31), .O(new_n130_));
  nor2   g086(.a(new_n130_), .b(new_n128_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n127_), .c(new_n123_), .d(new_n120_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n116_), .c(new_n58_), .O(new_n133_));
  nand2  g089(.a(new_n94_), .b(new_n82_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(x29), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n46_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(new_n133_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x32), .O(new_n138_));
  inv1   g094(.a(x32), .O(new_n139_));
  nand3  g095(.a(new_n134_), .b(new_n46_), .c(x29), .O(new_n140_));
  oai21  g096(.a(new_n46_), .b(x29), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(x19), .b(new_n125_), .c(x13), .O(new_n142_));
  nand3  g098(.a(new_n126_), .b(x18), .c(x14), .O(new_n143_));
  aoi21  g099(.a(new_n143_), .b(new_n142_), .c(new_n122_), .O(new_n144_));
  nand4  g100(.a(x19), .b(x18), .c(new_n122_), .d(x12), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n144_), .c(x16), .O(new_n147_));
  nand3  g103(.a(new_n115_), .b(new_n117_), .c(x11), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x15), .O(new_n150_));
  inv1   g106(.a(x15), .O(new_n151_));
  nand4  g107(.a(new_n115_), .b(x16), .c(new_n151_), .d(x10), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n141_), .c(new_n139_), .d(x31), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n138_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n81_), .c(x00), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(z8));
  inv1   g113(.a(x00), .O(new_n158_));
  inv1   g114(.a(x31), .O(new_n159_));
  inv1   g115(.a(x33), .O(new_n160_));
  nand4  g116(.a(new_n153_), .b(new_n135_), .c(new_n160_), .d(new_n159_), .O(new_n161_));
  aoi21  g117(.a(new_n126_), .b(x14), .c(new_n125_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(x17), .c(x16), .d(x15), .O(new_n163_));
  nand2  g119(.a(x18), .b(x17), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n129_), .c(new_n126_), .O(new_n165_));
  oai21  g121(.a(new_n164_), .b(new_n112_), .c(new_n151_), .O(new_n166_));
  inv1   g122(.a(x11), .O(new_n167_));
  oai21  g123(.a(new_n164_), .b(new_n167_), .c(new_n117_), .O(new_n168_));
  oai21  g124(.a(new_n125_), .b(new_n121_), .c(new_n122_), .O(new_n169_));
  aoi21  g125(.a(new_n125_), .b(new_n124_), .c(x31), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n169_), .c(new_n168_), .d(new_n166_), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n165_), .c(new_n163_), .d(new_n135_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x33), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n161_), .c(x30), .O(new_n175_));
  nor3   g131(.a(new_n160_), .b(new_n46_), .c(x29), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n81_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n158_), .O(z9));
endmodule
