...
module FAU ( 
  ...
  aoi21  g127(.a(new_n171_), .b(x32), .c(x26), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n151_), .c(new_n45_), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n150_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  ...
  inv1   g134(.a(new_n132_), .O(new_n179_));
  nand4  g135(.a(new_n150_), .b(new_n174_), .c(new_n123_), .d(new_n111_), .O(new_n180_));
  ...
  oai21  g141(.a(new_n185_), .b(new_n164_), .c(new_n89_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n155_), .c(new_n148_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(new_n188_), .c(new_n140_), .O(new_n189_));
  oai21  g145(.a(new_n86_), .b(new_n159_), .c(new_n83_), .O(new_n190_));
  nand2  g146(.a(new_n86_), .b(new_n161_), .O(new_n191_));
  ...
  nand2  g152(.a(new_n196_), .b(new_n46_), .O(new_n197_));
  aoi21  g153(.a(new_n182_), .b(new_n179_), .c(new_n197_), .O(new_n198_));
  aoi21  g154(.a(new_n198_), .b(new_n178_), .c(new_n45_), .O(z9));
endmodule
