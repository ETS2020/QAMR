...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(x29), .c(new_n80_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x25), .c(x01), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(x29), .c(x27), .O(z3));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n93_), .c(new_n80_), .d(x25), .O(new_n99_));
  ...
  oai21  g061(.a(new_n104_), .b(new_n46_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n102_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n101_), .c(new_n59_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n102_), .c(new_n61_), .d(new_n80_), .O(new_n114_));
  ...
  oai21  g098(.a(x29), .b(x27), .c(new_n142_), .O(new_n143_));
  ...
  nand3  g102(.a(x30), .b(x29), .c(new_n103_), .O(new_n147_));
  nand2  g103(.a(new_n111_), .b(new_n46_), .O(new_n148_));
  aoi21  g104(.a(new_n148_), .b(new_n147_), .c(new_n45_), .O(new_n149_));
  nand2  g105(.a(x30), .b(x28), .O(new_n150_));
  nand3  g106(.a(new_n111_), .b(new_n103_), .c(new_n45_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(new_n150_), .c(new_n46_), .O(new_n152_));
  nor2   g108(.a(new_n152_), .b(new_n149_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n146_), .c(new_n143_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  inv1   g111(.a(x32), .O(new_n156_));
  xnor2a g112(.a(x30), .b(x29), .O(new_n157_));
  nand3  g113(.a(x30), .b(new_n103_), .c(new_n45_), .O(new_n158_));
  oai21  g114(.a(x30), .b(new_n103_), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x29), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(new_n45_), .c(new_n160_), .O(new_n161_));
  ...
  nand4  g129(.a(new_n173_), .b(new_n161_), .c(new_n156_), .d(x31), .O(new_n174_));
  ...
  aoi21  g133(.a(new_n169_), .b(new_n167_), .c(new_n129_), .O(new_n178_));
  inv1   g134(.a(new_n172_), .O(new_n179_));
  nand2  g135(.a(new_n103_), .b(new_n45_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  nand2  g137(.a(new_n180_), .b(x29), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n124_), .c(new_n111_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  oai21  g140(.a(new_n179_), .b(new_n178_), .c(new_n184_), .O(new_n185_));
  aoi21  g141(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(x17), .c(x16), .d(x15), .O(new_n187_));
  xor2a  g143(.a(x31), .b(x28), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n45_), .O(new_n189_));
  nand2  g145(.a(new_n119_), .b(x31), .O(new_n190_));
  nand2  g146(.a(x29), .b(x27), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n111_), .c(x31), .O(new_n192_));
  nand2  g148(.a(x18), .b(x17), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n144_), .c(new_n88_), .O(new_n194_));
  oai21  g150(.a(new_n193_), .b(new_n130_), .c(new_n129_), .O(new_n195_));
  inv1   g151(.a(x11), .O(new_n196_));
  oai21  g152(.a(new_n193_), .b(new_n196_), .c(new_n133_), .O(new_n197_));
  ...
  nor2   g157(.a(new_n201_), .b(new_n192_), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(new_n190_), .c(new_n189_), .d(new_n187_), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(x33), .O(new_n204_));
  oai21  g160(.a(new_n185_), .b(x33), .c(new_n204_), .O(new_n205_));
