...
module FAU ( 
  ...
  nand2  g002(.a(x32), .b(x30), .O(new_n47_));
  ...
  nand2  g035(.a(x32), .b(x30), .O(new_n80_));
  ...
  nand4  g042(.a(new_n86_), .b(new_n80_), .c(new_n59_), .d(new_n79_), .O(new_n87_));
  inv1   g043(.a(new_n87_), .O(new_n88_));
  nand4  g044(.a(new_n88_), .b(new_n78_), .c(x25), .d(x01), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(z3));
  inv1   g046(.a(x25), .O(new_n91_));
  inv1   g047(.a(x28), .O(new_n92_));
  nand3  g048(.a(new_n80_), .b(new_n92_), .c(x27), .O(new_n93_));
  nand3  g049(.a(new_n47_), .b(x28), .c(new_n79_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n86_), .c(new_n59_), .d(new_n78_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n91_), .c(new_n58_), .O(z4));
  inv1   g053(.a(x29), .O(new_n98_));
  nor2   g054(.a(new_n92_), .b(new_n79_), .O(new_n99_));
  nand3  g055(.a(new_n98_), .b(x28), .c(x27), .O(new_n100_));
  oai21  g056(.a(new_n99_), .b(new_n98_), .c(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n86_), .c(new_n59_), .d(new_n78_), .O(new_n102_));
  ...
  nand3  g063(.a(new_n107_), .b(x30), .c(new_n92_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  aoi21  g065(.a(x29), .b(x27), .c(x32), .O(new_n110_));
  aoi22  g066(.a(new_n110_), .b(x30), .c(new_n109_), .d(x27), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n85_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n59_), .c(new_n78_), .d(x25), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n58_), .O(z6));
  inv1   g070(.a(x31), .O(new_n115_));
  nand3  g071(.a(new_n99_), .b(new_n115_), .c(x29), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n107_), .O(new_n117_));
  ...
  nor2   g078(.a(new_n82_), .b(new_n81_), .O(new_n123_));
  ...
  nand4  g085(.a(new_n129_), .b(new_n107_), .c(new_n45_), .d(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n98_), .O(new_n131_));
  ...
  nand2  g114(.a(new_n158_), .b(new_n133_), .O(new_n159_));
  inv1   g115(.a(x13), .O(new_n160_));
  oai21  g116(.a(new_n136_), .b(new_n160_), .c(new_n134_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x15), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n143_), .c(x19), .d(x14), .O(new_n163_));
  nor4   g119(.a(new_n163_), .b(new_n128_), .c(new_n115_), .d(new_n98_), .O(new_n164_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n151_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n78_), .c(x00), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n47_), .O(z8));
  inv1   g125(.a(x33), .O(new_n170_));
  nand4  g126(.a(new_n150_), .b(new_n170_), .c(x31), .d(x30), .O(new_n171_));
  nand2  g127(.a(x33), .b(new_n115_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n129_), .c(x29), .O(new_n174_));
  inv1   g130(.a(new_n131_), .O(new_n175_));
  nand4  g131(.a(new_n150_), .b(new_n170_), .c(new_n115_), .d(new_n45_), .O(new_n176_));
  ...
  aoi21  g135(.a(new_n136_), .b(x14), .c(new_n134_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x17), .c(x16), .d(x15), .O(new_n181_));
  nand2  g137(.a(x18), .b(x17), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n162_), .c(new_n136_), .O(new_n183_));
  oai21  g139(.a(new_n182_), .b(new_n152_), .c(new_n148_), .O(new_n184_));
  inv1   g140(.a(x11), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n185_), .c(new_n142_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x12), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n133_), .O(new_n188_));
  nand2  g144(.a(new_n134_), .b(new_n160_), .O(new_n189_));
  xnor2a g145(.a(x31), .b(x30), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(new_n186_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n184_), .c(new_n183_), .d(new_n181_), .O(new_n193_));
