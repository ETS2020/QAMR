...
module FAU ( 
  ...
  nand2  g065(.a(new_n109_), .b(new_n56_), .O(z5));
  ...
  oai21  g070(.a(new_n114_), .b(new_n103_), .c(new_n112_), .O(new_n115_));
  ...
  nand2  g074(.a(new_n118_), .b(new_n56_), .O(z6));
  oai21  g075(.a(x31), .b(new_n113_), .c(new_n80_), .O(new_n120_));
  ...
  nand3  g104(.a(x30), .b(x29), .c(new_n103_), .O(new_n149_));
  ...
  aoi21  g110(.a(new_n103_), .b(new_n80_), .c(new_n102_), .O(new_n155_));
  oai22  g111(.a(new_n155_), .b(new_n113_), .c(new_n114_), .d(new_n80_), .O(new_n156_));
  ...
  aoi21  g141(.a(new_n126_), .b(new_n102_), .c(x30), .O(new_n186_));
  nand2  g142(.a(new_n103_), .b(new_n80_), .O(new_n187_));
