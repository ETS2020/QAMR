...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n94_), .c(new_n60_), .d(new_n80_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n79_), .c(new_n58_), .O(z6));
  ...
  nand3  g077(.a(new_n45_), .b(x30), .c(x29), .O(new_n122_));
  ...
  nand4  g104(.a(new_n148_), .b(new_n131_), .c(new_n126_), .d(x31), .O(new_n149_));
  ...
  oai21  g113(.a(new_n139_), .b(new_n157_), .c(new_n85_), .O(new_n158_));
  ...
  nand4  g134(.a(new_n148_), .b(new_n173_), .c(new_n45_), .d(new_n111_), .O(new_n179_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n185_), .c(new_n91_), .O(new_n187_));
  ...
  oai21  g146(.a(new_n88_), .b(new_n157_), .c(new_n85_), .O(new_n191_));
  nand2  g147(.a(new_n88_), .b(new_n159_), .O(new_n192_));
