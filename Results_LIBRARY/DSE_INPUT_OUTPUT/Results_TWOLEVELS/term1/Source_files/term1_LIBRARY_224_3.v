...
module FAU ( 
  ...
  nand2  g040(.a(new_n45_), .b(new_n84_), .O(new_n85_));
  ...
  nand4  g050(.a(new_n94_), .b(new_n82_), .c(new_n46_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n61_), .c(new_n59_), .O(z3));
  inv1   g052(.a(x25), .O(new_n97_));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n94_), .c(new_n46_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n97_), .c(new_n61_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n63_), .d(new_n46_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n59_), .O(z5));
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n63_), .d(new_n46_), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n97_), .c(new_n61_), .O(z6));
  nor2   g073(.a(new_n113_), .b(new_n102_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n104_), .O(new_n119_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n124_), .c(new_n46_), .O(new_n127_));
  ...
  oai21  g117(.a(new_n143_), .b(new_n161_), .c(new_n84_), .O(new_n162_));
  ...
  nand2  g134(.a(x33), .b(new_n125_), .O(new_n179_));
  ...
  nand4  g138(.a(new_n152_), .b(new_n177_), .c(new_n125_), .d(new_n113_), .O(new_n183_));
  ...
  oai21  g150(.a(new_n86_), .b(new_n161_), .c(new_n84_), .O(new_n195_));
