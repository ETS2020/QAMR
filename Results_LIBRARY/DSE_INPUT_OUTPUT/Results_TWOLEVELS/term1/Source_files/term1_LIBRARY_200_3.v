...
module FAU ( 
  ...
  nand4  g066(.a(new_n110_), .b(new_n93_), .c(new_n59_), .d(new_n79_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n78_), .c(new_n57_), .O(z6));
  inv1   g068(.a(x31), .O(new_n113_));
  nor2   g069(.a(new_n108_), .b(new_n99_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n101_), .c(new_n113_), .O(new_n115_));
  nand4  g071(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n116_));
  ...
  aoi21  g075(.a(new_n119_), .b(new_n101_), .c(new_n78_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n117_), .c(new_n116_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n115_), .c(new_n79_), .O(new_n122_));
  oai21  g078(.a(new_n79_), .b(x00), .c(new_n122_), .O(z7));
  ...
  nor2   g083(.a(new_n125_), .b(new_n99_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n129_), .c(new_n124_), .d(x31), .O(new_n147_));
  nand2  g103(.a(new_n114_), .b(x27), .O(new_n148_));
  ...
  oai21  g111(.a(new_n137_), .b(new_n155_), .c(new_n84_), .O(new_n156_));
  ...
  aoi21  g118(.a(new_n114_), .b(x28), .c(new_n162_), .O(new_n163_));
  ...
  nand2  g128(.a(x33), .b(new_n113_), .O(new_n173_));
  ...
  nand4  g132(.a(new_n146_), .b(new_n171_), .c(new_n113_), .d(new_n108_), .O(new_n177_));
  ...
  oai21  g144(.a(new_n87_), .b(new_n155_), .c(new_n84_), .O(new_n189_));
