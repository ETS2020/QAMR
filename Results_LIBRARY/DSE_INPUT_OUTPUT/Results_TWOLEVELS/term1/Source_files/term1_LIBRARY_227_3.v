...
module FAU ( 
  ...
  nor3   g059(.a(new_n103_), .b(new_n98_), .c(new_n61_), .O(z4));
  oai21  g060(.a(new_n100_), .b(new_n45_), .c(x29), .O(new_n105_));
  nand2  g061(.a(x28), .b(x27), .O(new_n106_));
  inv1   g062(.a(x29), .O(new_n107_));
  nand2  g063(.a(new_n46_), .b(new_n107_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n106_), .c(new_n105_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n94_), .c(new_n62_), .d(new_n81_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n98_), .c(new_n61_), .O(z5));
  nand2  g067(.a(new_n46_), .b(x29), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n106_), .c(new_n46_), .d(x27), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n95_), .c(new_n81_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n98_), .c(new_n61_), .O(z6));
  nand4  g071(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n116_));
  nand2  g072(.a(new_n62_), .b(x01), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(x31), .c(x26), .d(new_n98_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n47_), .O(z7));
  nand3  g075(.a(x30), .b(x29), .c(x28), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n100_), .c(new_n45_), .O(new_n122_));
  ...
  and2   g084(.a(x17), .b(x11), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n128_), .c(x16), .O(new_n130_));
  inv1   g086(.a(x12), .O(new_n131_));
  oai21  g087(.a(new_n127_), .b(new_n131_), .c(new_n85_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand2  g089(.a(x19), .b(x13), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n88_), .O(new_n135_));
  inv1   g091(.a(x14), .O(new_n136_));
  nand2  g092(.a(new_n91_), .b(new_n136_), .O(new_n137_));
  inv1   g093(.a(new_n125_), .O(new_n138_));
  nand3  g094(.a(new_n138_), .b(x16), .c(x15), .O(new_n139_));
  inv1   g095(.a(x31), .O(new_n140_));
  aoi21  g096(.a(new_n46_), .b(new_n107_), .c(new_n140_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n139_), .c(new_n137_), .d(new_n135_), .O(new_n142_));
  nor3   g098(.a(new_n142_), .b(new_n133_), .c(new_n130_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n126_), .c(new_n122_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x32), .O(new_n145_));
  inv1   g101(.a(x32), .O(new_n146_));
  aoi21  g102(.a(new_n46_), .b(x28), .c(x27), .O(new_n147_));
  nor2   g103(.a(new_n107_), .b(new_n99_), .O(new_n148_));
  oai22  g104(.a(new_n148_), .b(new_n46_), .c(new_n147_), .d(new_n107_), .O(new_n149_));
  ...
  nand3  g112(.a(new_n138_), .b(new_n156_), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n155_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x15), .O(new_n159_));
  nand3  g115(.a(x16), .b(new_n123_), .c(x10), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n125_), .O(new_n161_));
  ...
  aoi21  g126(.a(new_n157_), .b(new_n155_), .c(new_n123_), .O(new_n171_));
  oai21  g127(.a(x28), .b(x27), .c(x29), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n140_), .c(new_n46_), .O(new_n173_));
  nand3  g129(.a(new_n148_), .b(x31), .c(x30), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g131(.a(new_n161_), .b(new_n171_), .c(new_n175_), .O(new_n176_));
  oai21  g132(.a(new_n148_), .b(x30), .c(new_n140_), .O(new_n177_));
  nand2  g133(.a(new_n120_), .b(x31), .O(new_n178_));
  nand4  g134(.a(new_n139_), .b(new_n137_), .c(new_n135_), .d(new_n132_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n130_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n177_), .d(new_n126_), .O(new_n181_));
