...
module FAU ( 
  ...
  nand4  g063(.a(new_n96_), .b(x30), .c(new_n82_), .d(x25), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n61_), .c(new_n48_), .O(z6));
  nand4  g065(.a(new_n94_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n110_));
  nand2  g066(.a(new_n62_), .b(x01), .O(new_n111_));
  nor4   g067(.a(new_n111_), .b(x31), .c(x26), .d(new_n81_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n110_), .c(new_n47_), .O(z7));
  inv1   g069(.a(x32), .O(new_n114_));
  nand3  g070(.a(x30), .b(x29), .c(x28), .O(new_n115_));
  oai21  g071(.a(x30), .b(x28), .c(new_n115_), .O(new_n116_));
  ...
  nand2  g085(.a(new_n92_), .b(new_n129_), .O(new_n130_));
  inv1   g086(.a(new_n119_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(x16), .c(x15), .O(new_n132_));
  inv1   g088(.a(x30), .O(new_n133_));
  inv1   g089(.a(x31), .O(new_n134_));
  aoi21  g090(.a(new_n133_), .b(new_n46_), .c(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n132_), .c(new_n130_), .d(new_n128_), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n126_), .c(new_n124_), .d(new_n120_), .O(new_n138_));
  aoi21  g094(.a(new_n116_), .b(new_n45_), .c(new_n138_), .O(new_n139_));
  nand2  g095(.a(x29), .b(x28), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n133_), .b(x29), .c(x28), .O(new_n142_));
  oai21  g098(.a(new_n141_), .b(new_n133_), .c(new_n142_), .O(new_n143_));
  nand3  g099(.a(x19), .b(new_n89_), .c(x13), .O(new_n144_));
  nand3  g100(.a(new_n92_), .b(x18), .c(x14), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(new_n144_), .c(new_n86_), .O(new_n146_));
  nand4  g102(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n146_), .c(x16), .O(new_n149_));
  nand3  g105(.a(new_n131_), .b(new_n121_), .c(x11), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x15), .O(new_n152_));
  nand4  g108(.a(new_n131_), .b(x16), .c(new_n117_), .d(x10), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n143_), .c(new_n114_), .d(x31), .O(new_n155_));
  oai21  g111(.a(new_n139_), .b(new_n114_), .c(new_n155_), .O(new_n156_));
  ...
  nand4  g116(.a(new_n154_), .b(new_n160_), .c(new_n134_), .d(new_n133_), .O(new_n161_));
  nand2  g117(.a(x33), .b(x31), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n141_), .O(new_n163_));
  nand3  g119(.a(x28), .b(new_n92_), .c(x14), .O(new_n164_));
  nand4  g120(.a(new_n160_), .b(x31), .c(x30), .d(x29), .O(new_n165_));
  oai22  g121(.a(new_n165_), .b(new_n164_), .c(new_n160_), .d(new_n92_), .O(new_n166_));
  nand4  g122(.a(x28), .b(x19), .c(new_n89_), .d(x13), .O(new_n167_));
  ...
  oai22  g128(.a(new_n172_), .b(new_n147_), .c(new_n169_), .d(new_n86_), .O(new_n173_));
  nor2   g129(.a(new_n172_), .b(new_n150_), .O(new_n174_));
  aoi21  g130(.a(new_n173_), .b(x16), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n133_), .O(new_n176_));
  nor2   g132(.a(new_n86_), .b(new_n121_), .O(new_n177_));
  nor2   g133(.a(new_n170_), .b(new_n122_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n177_), .c(new_n117_), .d(x10), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n176_), .c(new_n46_), .O(new_n180_));
  nand2  g136(.a(new_n134_), .b(x30), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n130_), .c(new_n128_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n126_), .c(new_n124_), .d(new_n120_), .O(new_n184_));
  aoi22  g140(.a(new_n184_), .b(x33), .c(new_n180_), .d(x28), .O(new_n185_));
  oai21  g141(.a(new_n175_), .b(new_n117_), .c(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n163_), .c(new_n82_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n159_), .c(new_n48_), .O(z9));
endmodule
