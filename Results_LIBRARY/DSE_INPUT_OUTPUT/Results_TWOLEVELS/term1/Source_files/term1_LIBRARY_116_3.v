...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n78_), .c(new_n77_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n57_), .c(new_n45_), .O(z3));
  inv1   g050(.a(x25), .O(new_n95_));
  nand2  g051(.a(x28), .b(new_n78_), .O(new_n96_));
  inv1   g052(.a(x28), .O(new_n97_));
  inv1   g053(.a(x30), .O(new_n98_));
  nand2  g054(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n78_), .c(new_n96_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n92_), .c(new_n77_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n95_), .c(new_n57_), .O(z4));
  inv1   g058(.a(x29), .O(new_n103_));
  aoi21  g059(.a(new_n98_), .b(new_n97_), .c(new_n78_), .O(new_n104_));
  nand2  g060(.a(x28), .b(x27), .O(new_n105_));
  nand2  g061(.a(new_n98_), .b(new_n103_), .O(new_n106_));
  oai22  g062(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n103_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n91_), .c(new_n58_), .d(new_n77_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n95_), .c(new_n57_), .O(z5));
  nand2  g065(.a(new_n98_), .b(x29), .O(new_n110_));
  oai22  g066(.a(new_n110_), .b(new_n105_), .c(new_n98_), .d(x27), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n92_), .c(new_n77_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n95_), .c(new_n57_), .O(z6));
  inv1   g069(.a(new_n45_), .O(new_n114_));
  nand4  g070(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n81_), .O(new_n115_));
  nand2  g071(.a(new_n58_), .b(x01), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(x31), .c(x26), .d(new_n95_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n114_), .O(z7));
  ...
  oai21  g083(.a(new_n124_), .b(new_n127_), .c(new_n82_), .O(new_n128_));
  inv1   g084(.a(x13), .O(new_n129_));
  oai21  g085(.a(new_n88_), .b(new_n129_), .c(new_n85_), .O(new_n130_));
  ...
  nand2  g093(.a(new_n137_), .b(new_n99_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n78_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n136_), .c(new_n106_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x32), .O(new_n141_));
  inv1   g097(.a(x32), .O(new_n142_));
  nand2  g098(.a(x29), .b(x28), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x30), .c(new_n78_), .O(new_n144_));
  nand2  g100(.a(new_n97_), .b(new_n78_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n98_), .c(x29), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n144_), .O(new_n147_));
  nand3  g103(.a(x19), .b(new_n85_), .c(x13), .O(new_n148_));
  nand3  g104(.a(new_n88_), .b(x18), .c(x14), .O(new_n149_));
  ...
  nand3  g118(.a(new_n162_), .b(new_n77_), .c(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z8));
  nand2  g120(.a(new_n88_), .b(x14), .O(new_n165_));
  ...
  oai21  g124(.a(new_n168_), .b(new_n132_), .c(new_n88_), .O(new_n169_));
  ...
  aoi22  g129(.a(new_n173_), .b(new_n82_), .c(new_n85_), .d(new_n129_), .O(new_n174_));
  ...
  inv1   g132(.a(x31), .O(new_n177_));
  nand2  g133(.a(new_n145_), .b(x29), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand2  g135(.a(new_n143_), .b(x31), .O(new_n180_));
  oai21  g136(.a(x31), .b(new_n98_), .c(new_n180_), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n78_), .c(new_n179_), .d(new_n98_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n176_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  aoi21  g140(.a(new_n155_), .b(new_n153_), .c(new_n158_), .O(new_n185_));
  inv1   g141(.a(new_n159_), .O(new_n186_));
  nand4  g142(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nor3   g144(.a(x31), .b(x30), .c(x28), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n188_), .c(new_n78_), .O(new_n190_));
  nand3  g146(.a(new_n177_), .b(new_n98_), .c(new_n103_), .O(new_n191_));
