...
module FAU ( 
  ...
  nand2  g076(.a(new_n89_), .b(x14), .O(new_n121_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n98_), .c(new_n79_), .O(new_n126_));
  nand2  g082(.a(x16), .b(x15), .O(new_n127_));
  nand2  g083(.a(x18), .b(x17), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(new_n89_), .O(new_n129_));
  ...
  nand2  g090(.a(new_n134_), .b(new_n83_), .O(new_n135_));
  inv1   g091(.a(x13), .O(new_n136_));
  nand2  g092(.a(new_n86_), .b(new_n136_), .O(new_n137_));
  ...
  aoi21  g096(.a(new_n130_), .b(new_n120_), .c(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n129_), .c(new_n126_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n123_), .c(x32), .O(new_n143_));
  ...
  nand3  g111(.a(new_n155_), .b(new_n132_), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n153_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x15), .O(new_n158_));
  nand4  g114(.a(new_n155_), .b(x16), .c(new_n120_), .d(x10), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n147_), .c(new_n144_), .d(x31), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n143_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n78_), .c(x00), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n45_), .O(z8));
  nand2  g120(.a(new_n130_), .b(new_n120_), .O(new_n165_));
  and2   g121(.a(new_n137_), .b(new_n135_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n133_), .c(new_n165_), .d(new_n129_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n123_), .c(new_n45_), .O(new_n168_));
  oai21  g124(.a(x28), .b(x27), .c(x29), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n138_), .c(x30), .O(new_n170_));
  nand2  g126(.a(new_n138_), .b(x30), .O(new_n171_));
  oai21  g127(.a(new_n146_), .b(new_n138_), .c(new_n171_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n79_), .c(new_n170_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n168_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(x33), .O(new_n175_));
  aoi21  g131(.a(new_n156_), .b(new_n153_), .c(new_n120_), .O(new_n176_));
  inv1   g132(.a(new_n159_), .O(new_n177_));
  nand3  g133(.a(new_n146_), .b(x31), .c(x30), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  nor3   g135(.a(x31), .b(x30), .c(x28), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n179_), .c(new_n79_), .O(new_n181_));
  nand3  g137(.a(new_n138_), .b(new_n111_), .c(new_n104_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  oai21  g139(.a(new_n177_), .b(new_n176_), .c(new_n183_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(x33), .c(new_n175_), .O(new_n185_));
