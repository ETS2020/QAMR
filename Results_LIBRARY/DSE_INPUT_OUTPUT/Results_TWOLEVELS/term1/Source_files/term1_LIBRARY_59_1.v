...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n60_), .c(new_n58_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  inv1   g049(.a(new_n83_), .O(new_n94_));
  inv1   g050(.a(new_n86_), .O(new_n95_));
  inv1   g051(.a(new_n87_), .O(new_n96_));
  inv1   g052(.a(new_n88_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n94_), .O(new_n98_));
  nor3   g054(.a(x30), .b(x21), .c(x16), .O(new_n99_));
  aoi21  g055(.a(new_n98_), .b(new_n58_), .c(new_n99_), .O(new_n100_));
  nor2   g056(.a(new_n100_), .b(new_n61_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n93_), .c(new_n81_), .d(x25), .O(new_n102_));
  nor2   g058(.a(new_n102_), .b(new_n60_), .O(z4));
  inv1   g059(.a(x28), .O(new_n104_));
  nor2   g060(.a(new_n104_), .b(new_n82_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  inv1   g062(.a(new_n99_), .O(new_n107_));
  oai21  g063(.a(new_n45_), .b(x21), .c(new_n98_), .O(new_n108_));
  ...
  inv1   g067(.a(new_n100_), .O(new_n112_));
  ...
  nand3  g072(.a(new_n106_), .b(x30), .c(x21), .O(new_n117_));
  nand3  g073(.a(new_n45_), .b(x28), .c(x27), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n117_), .c(new_n111_), .O(new_n119_));
  nor2   g075(.a(new_n45_), .b(x29), .O(new_n120_));
  oai21  g076(.a(new_n120_), .b(new_n119_), .c(new_n98_), .O(new_n121_));
  nand4  g077(.a(new_n84_), .b(x29), .c(x28), .d(x27), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n121_), .c(new_n61_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n81_), .c(x25), .d(x01), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n58_), .O(z6));
  inv1   g081(.a(x31), .O(new_n126_));
  nand3  g082(.a(new_n105_), .b(new_n126_), .c(x29), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x21), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x30), .O(new_n129_));
  nor2   g085(.a(new_n45_), .b(new_n111_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(new_n105_), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x31), .O(new_n132_));
  nand4  g088(.a(new_n97_), .b(new_n96_), .c(new_n95_), .d(new_n85_), .O(new_n133_));
  nand4  g089(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n132_), .d(new_n129_), .O(z7));
  inv1   g092(.a(x32), .O(new_n137_));
  nor2   g093(.a(x28), .b(x27), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n45_), .c(x29), .O(new_n140_));
  nor2   g096(.a(new_n138_), .b(new_n111_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n45_), .c(new_n140_), .O(new_n142_));
  ...
  nand2  g110(.a(new_n154_), .b(x17), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n152_), .c(x11), .O(new_n157_));
  ...
  nand2  g119(.a(new_n130_), .b(x27), .O(new_n164_));
  oai21  g120(.a(x30), .b(x27), .c(new_n164_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n104_), .O(new_n166_));
  nand2  g122(.a(x16), .b(x10), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n155_), .c(new_n160_), .O(new_n168_));
  nand2  g124(.a(x17), .b(x11), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n153_), .c(new_n152_), .O(new_n170_));
  inv1   g126(.a(x12), .O(new_n171_));
  oai21  g127(.a(new_n153_), .b(new_n171_), .c(new_n143_), .O(new_n172_));
  inv1   g128(.a(x13), .O(new_n173_));
  oai21  g129(.a(new_n146_), .b(new_n173_), .c(new_n144_), .O(new_n174_));
  nor2   g130(.a(x19), .b(x14), .O(new_n175_));
  nor2   g131(.a(new_n152_), .b(new_n160_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n156_), .c(new_n175_), .O(new_n177_));
  oai21  g133(.a(x30), .b(x29), .c(x31), .O(new_n178_));
  aoi21  g134(.a(new_n130_), .b(x28), .c(new_n178_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n177_), .c(new_n174_), .d(new_n172_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n170_), .c(new_n168_), .d(new_n166_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x32), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n163_), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n81_), .c(x00), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n58_), .O(z8));
  inv1   g142(.a(x33), .O(new_n187_));
  nand4  g143(.a(new_n162_), .b(new_n187_), .c(x31), .d(x30), .O(new_n188_));
  nand2  g144(.a(x33), .b(new_n126_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n139_), .c(x29), .O(new_n191_));
  inv1   g147(.a(new_n141_), .O(new_n192_));
  nand4  g148(.a(new_n162_), .b(new_n187_), .c(new_n126_), .d(new_n45_), .O(new_n193_));
  ...
  aoi21  g152(.a(new_n146_), .b(x14), .c(new_n144_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(x17), .c(x16), .d(x15), .O(new_n198_));
  inv1   g154(.a(new_n176_), .O(new_n199_));
  nand2  g155(.a(x18), .b(x17), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n199_), .c(new_n146_), .O(new_n201_));
  oai21  g157(.a(new_n200_), .b(new_n167_), .c(new_n160_), .O(new_n202_));
  inv1   g158(.a(x11), .O(new_n203_));
  oai21  g159(.a(new_n200_), .b(new_n203_), .c(new_n152_), .O(new_n204_));
  oai21  g160(.a(new_n144_), .b(new_n171_), .c(new_n143_), .O(new_n205_));
  nand2  g161(.a(new_n144_), .b(new_n173_), .O(new_n206_));
  xnor2a g162(.a(x31), .b(x30), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(new_n206_), .c(new_n205_), .d(new_n204_), .O(new_n208_));
  inv1   g164(.a(new_n208_), .O(new_n209_));
  nand4  g165(.a(new_n209_), .b(new_n202_), .c(new_n201_), .d(new_n198_), .O(new_n210_));
  nand2  g166(.a(new_n210_), .b(x33), .O(new_n211_));
  nand3  g167(.a(new_n211_), .b(new_n196_), .c(new_n191_), .O(new_n212_));
  nand3  g168(.a(new_n212_), .b(new_n81_), .c(x00), .O(new_n213_));
  nand2  g169(.a(new_n213_), .b(new_n58_), .O(z9));
endmodule
