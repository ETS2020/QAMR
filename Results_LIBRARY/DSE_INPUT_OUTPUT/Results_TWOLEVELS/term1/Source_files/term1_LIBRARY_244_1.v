...
module FAU ( 
  ...
  nand3  g059(.a(new_n45_), .b(x29), .c(new_n102_), .O(new_n104_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n108_), .c(x31), .O(new_n122_));
  ...
  nand4  g083(.a(x32), .b(new_n108_), .c(new_n81_), .d(x00), .O(new_n128_));
  ...
  nand2  g120(.a(new_n45_), .b(new_n109_), .O(new_n165_));
  ...
  aoi21  g129(.a(new_n45_), .b(new_n109_), .c(new_n132_), .O(new_n174_));
  ...
  nand3  g136(.a(new_n133_), .b(new_n117_), .c(x29), .O(new_n181_));
  nor2   g137(.a(new_n86_), .b(new_n83_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n163_), .c(new_n89_), .O(new_n184_));
