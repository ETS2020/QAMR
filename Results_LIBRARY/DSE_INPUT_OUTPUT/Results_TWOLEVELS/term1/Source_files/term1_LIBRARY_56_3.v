...
module FAU ( 
  ...
  nor3   g064(.a(new_n108_), .b(new_n81_), .c(new_n61_), .O(z5));
  nand2  g065(.a(x29), .b(x28), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n45_), .c(new_n46_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n95_), .c(new_n82_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n61_), .c(new_n48_), .O(z6));
  nand3  g069(.a(new_n91_), .b(new_n88_), .c(new_n85_), .O(new_n114_));
  nand3  g070(.a(new_n62_), .b(x25), .c(x01), .O(new_n115_));
  nor4   g071(.a(new_n115_), .b(new_n47_), .c(x31), .d(x26), .O(new_n116_));
  oai21  g072(.a(new_n114_), .b(new_n92_), .c(new_n116_), .O(z7));
  inv1   g073(.a(x32), .O(new_n118_));
  inv1   g074(.a(new_n110_), .O(new_n119_));
  aoi21  g075(.a(new_n46_), .b(x28), .c(x27), .O(new_n120_));
  oai22  g076(.a(new_n120_), .b(new_n105_), .c(new_n119_), .d(new_n46_), .O(new_n121_));
  nand3  g077(.a(x19), .b(new_n89_), .c(x13), .O(new_n122_));
  inv1   g078(.a(x19), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(x18), .c(x14), .O(new_n124_));
  aoi21  g080(.a(new_n124_), .b(new_n122_), .c(new_n86_), .O(new_n125_));
  nand4  g081(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n126_));
  ...
  nand4  g095(.a(new_n139_), .b(new_n121_), .c(new_n118_), .d(x31), .O(new_n140_));
  oai21  g096(.a(x28), .b(x27), .c(x29), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(new_n46_), .O(new_n142_));
  nand2  g098(.a(x16), .b(x10), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n130_), .c(new_n135_), .O(new_n144_));
  nor2   g100(.a(new_n123_), .b(new_n89_), .O(new_n145_));
  ...
  oai21  g105(.a(new_n123_), .b(new_n149_), .c(new_n89_), .O(new_n150_));
  inv1   g106(.a(x14), .O(new_n151_));
  nand2  g107(.a(new_n123_), .b(new_n151_), .O(new_n152_));
  nand3  g108(.a(new_n131_), .b(x16), .c(x15), .O(new_n153_));
  inv1   g109(.a(x31), .O(new_n154_));
  nor2   g110(.a(new_n46_), .b(new_n105_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(x28), .c(new_n154_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n153_), .c(new_n152_), .d(new_n150_), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n148_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(new_n147_), .c(new_n144_), .d(new_n142_), .O(new_n159_));
  ...
  aoi21  g122(.a(new_n132_), .b(new_n128_), .c(new_n135_), .O(new_n167_));
  nand3  g123(.a(new_n141_), .b(new_n154_), .c(new_n46_), .O(new_n168_));
  nand3  g124(.a(new_n119_), .b(x31), .c(x30), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  oai21  g126(.a(new_n137_), .b(new_n167_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n123_), .b(x14), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(x18), .c(x17), .d(x16), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n135_), .O(new_n174_));
  nand2  g130(.a(new_n110_), .b(x31), .O(new_n175_));
  nor2   g131(.a(new_n89_), .b(new_n86_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(x16), .c(x15), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n123_), .O(new_n178_));
  inv1   g134(.a(new_n176_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n143_), .c(new_n135_), .O(new_n180_));
  nand2  g136(.a(new_n176_), .b(x11), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n86_), .O(new_n183_));
  nand2  g139(.a(new_n89_), .b(new_n149_), .O(new_n184_));
  nand3  g140(.a(new_n46_), .b(x29), .c(x28), .O(new_n185_));
  nand2  g141(.a(new_n154_), .b(x30), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n185_), .c(new_n184_), .d(new_n183_), .O(new_n187_));
  aoi21  g143(.a(new_n181_), .b(new_n129_), .c(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n180_), .c(new_n178_), .d(new_n175_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n174_), .c(x33), .O(new_n190_));
  oai21  g146(.a(new_n171_), .b(x33), .c(new_n190_), .O(new_n191_));
