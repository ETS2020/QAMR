...
module FAU ( 
  ...
  oai21  g049(.a(new_n93_), .b(new_n59_), .c(new_n48_), .O(z4));
  inv1   g050(.a(x27), .O(new_n95_));
  inv1   g051(.a(x28), .O(new_n96_));
  oai21  g052(.a(new_n96_), .b(new_n95_), .c(x29), .O(new_n97_));
  ...
  nor2   g060(.a(new_n98_), .b(new_n96_), .O(new_n105_));
  nand4  g061(.a(new_n45_), .b(x29), .c(x28), .d(x27), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n45_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n108_));
  ...
  nand3  g077(.a(x32), .b(new_n45_), .c(new_n96_), .O(new_n122_));
  ...
  nand2  g119(.a(new_n45_), .b(new_n98_), .O(new_n164_));
  ...
  aoi21  g129(.a(new_n45_), .b(new_n98_), .c(new_n126_), .O(new_n174_));
