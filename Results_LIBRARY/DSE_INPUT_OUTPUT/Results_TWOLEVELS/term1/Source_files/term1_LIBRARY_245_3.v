...
module FAU ( 
  ...
  oai21  g045(.a(new_n46_), .b(new_n45_), .c(new_n89_), .O(new_n90_));
  ...
  nand4  g054(.a(new_n92_), .b(new_n98_), .c(new_n97_), .d(new_n85_), .O(new_n99_));
  and2   g055(.a(new_n99_), .b(new_n62_), .O(new_n100_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n99_), .c(new_n62_), .d(new_n81_), .O(new_n107_));
  ...
  nor2   g069(.a(new_n83_), .b(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n88_), .c(new_n112_), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n111_), .c(x30), .O(new_n116_));
  nor2   g072(.a(new_n82_), .b(x18), .O(new_n117_));
  ...
  aoi21  g076(.a(new_n88_), .b(new_n85_), .c(x30), .O(new_n121_));
  ...
  nand2  g083(.a(new_n111_), .b(x31), .O(new_n128_));
  nand3  g084(.a(new_n98_), .b(new_n97_), .c(new_n85_), .O(new_n129_));
  ...
  nor2   g101(.a(new_n145_), .b(new_n113_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x17), .c(x11), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  inv1   g104(.a(x17), .O(new_n149_));
  nand2  g105(.a(new_n146_), .b(x12), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(x19), .b(x13), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n113_), .O(new_n153_));
  nor2   g109(.a(x19), .b(x14), .O(new_n154_));
  nor3   g110(.a(new_n141_), .b(new_n144_), .c(new_n139_), .O(new_n155_));
  nor3   g111(.a(new_n155_), .b(new_n154_), .c(new_n132_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n153_), .c(new_n151_), .d(new_n148_), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n143_), .c(new_n58_), .O(new_n158_));
  nor2   g114(.a(x28), .b(x27), .O(new_n159_));
  nor3   g115(.a(new_n159_), .b(new_n46_), .c(new_n103_), .O(new_n160_));
  inv1   g116(.a(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(x29), .O(new_n162_));
  aoi22  g118(.a(new_n162_), .b(new_n46_), .c(new_n160_), .d(new_n45_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n158_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x32), .O(new_n165_));
  inv1   g121(.a(x32), .O(new_n166_));
  nand3  g122(.a(new_n162_), .b(x30), .c(new_n45_), .O(new_n167_));
  nand3  g123(.a(new_n161_), .b(new_n46_), .c(x29), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n167_), .O(new_n169_));
  nand3  g125(.a(x19), .b(new_n113_), .c(x13), .O(new_n170_));
  nand3  g126(.a(new_n145_), .b(x18), .c(x14), .O(new_n171_));
  ...
  nand4  g137(.a(new_n181_), .b(new_n169_), .c(new_n166_), .d(x31), .O(new_n182_));
  ...
  aoi21  g141(.a(new_n180_), .b(new_n179_), .c(x33), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(x31), .c(x30), .d(new_n45_), .O(new_n187_));
  nand2  g143(.a(x33), .b(new_n132_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n161_), .c(x29), .O(new_n190_));
  inv1   g146(.a(x33), .O(new_n191_));
  nand4  g147(.a(new_n181_), .b(new_n191_), .c(new_n132_), .d(new_n46_), .O(new_n192_));
  nand2  g148(.a(x33), .b(x31), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nor2   g150(.a(new_n155_), .b(new_n154_), .O(new_n195_));
  xnor2a g151(.a(x31), .b(x30), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n195_), .c(new_n153_), .d(new_n151_), .O(new_n197_));
  aoi21  g153(.a(new_n147_), .b(new_n144_), .c(new_n197_), .O(new_n198_));
  aoi21  g154(.a(new_n198_), .b(new_n142_), .c(new_n191_), .O(new_n199_));
  aoi21  g155(.a(new_n194_), .b(new_n162_), .c(new_n199_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n190_), .O(new_n201_));
