...
module FAU ( 
  ...
  nand3  g049(.a(new_n80_), .b(x28), .c(new_n45_), .O(new_n94_));
  oai21  g050(.a(x28), .b(new_n45_), .c(new_n94_), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(new_n90_), .c(new_n81_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n93_), .c(new_n59_), .O(z4));
  xnor2a g053(.a(x29), .b(x28), .O(new_n98_));
  nand3  g054(.a(new_n80_), .b(x29), .c(new_n45_), .O(new_n99_));
  ...
  nand3  g077(.a(x32), .b(new_n80_), .c(new_n103_), .O(new_n122_));
  ...
  nand3  g083(.a(new_n127_), .b(new_n80_), .c(x29), .O(new_n128_));
  nor2   g084(.a(new_n80_), .b(x29), .O(new_n129_));
  ...
  nand2  g119(.a(new_n80_), .b(new_n104_), .O(new_n164_));
  ...
  aoi21  g129(.a(new_n80_), .b(new_n104_), .c(new_n126_), .O(new_n174_));
  ...
  nand2  g141(.a(new_n185_), .b(new_n46_), .O(z9));
endmodule
