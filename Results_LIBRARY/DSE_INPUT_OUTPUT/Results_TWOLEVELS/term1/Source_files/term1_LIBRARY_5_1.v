...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n60_), .d(new_n47_), .O(new_n98_));
  ...
  nand2  g058(.a(x29), .b(new_n80_), .O(new_n103_));
  oai21  g059(.a(new_n102_), .b(new_n80_), .c(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n105_));
  ...
  nand4  g079(.a(new_n45_), .b(x30), .c(x28), .d(x27), .O(new_n124_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n131_), .c(x31), .d(new_n111_), .O(new_n148_));
  nand2  g104(.a(x32), .b(x30), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n148_), .c(new_n130_), .O(new_n150_));
  nand3  g106(.a(new_n80_), .b(new_n133_), .c(x14), .O(new_n151_));
  nand4  g107(.a(new_n131_), .b(x31), .c(x30), .d(new_n128_), .O(new_n152_));
  oai22  g108(.a(new_n152_), .b(new_n151_), .c(new_n131_), .d(new_n133_), .O(new_n153_));
  nand4  g109(.a(new_n80_), .b(x19), .c(new_n87_), .d(x13), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n152_), .O(new_n155_));
  aoi21  g111(.a(new_n153_), .b(x18), .c(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n131_), .b(x31), .c(x30), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n130_), .O(new_n159_));
  oai22  g115(.a(new_n159_), .b(new_n136_), .c(new_n156_), .d(new_n84_), .O(new_n160_));
  nor2   g116(.a(new_n159_), .b(new_n142_), .O(new_n161_));
  aoi21  g117(.a(new_n160_), .b(x16), .c(new_n161_), .O(new_n162_));
  nand2  g118(.a(x32), .b(new_n111_), .O(new_n163_));
  nor2   g119(.a(new_n133_), .b(new_n87_), .O(new_n164_));
  nand4  g120(.a(x17), .b(x16), .c(new_n145_), .d(x10), .O(new_n165_));
  inv1   g121(.a(new_n165_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(new_n158_), .c(new_n164_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n163_), .c(x28), .O(new_n168_));
  nand2  g124(.a(x16), .b(x10), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n140_), .c(new_n145_), .O(new_n170_));
  nand3  g126(.a(new_n164_), .b(x17), .c(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n139_), .O(new_n172_));
  nand2  g128(.a(new_n164_), .b(x12), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n84_), .O(new_n174_));
  ...
  aoi22  g134(.a(new_n178_), .b(x32), .c(new_n168_), .d(new_n80_), .O(new_n179_));
  oai21  g135(.a(new_n162_), .b(new_n145_), .c(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n150_), .c(x29), .O(new_n181_));
  nand2  g137(.a(x32), .b(new_n45_), .O(new_n182_));
  ...
  inv1   g141(.a(x29), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n80_), .c(new_n128_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(x31), .c(x30), .O(new_n188_));
  nor2   g144(.a(x31), .b(x28), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n80_), .c(new_n186_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(x30), .c(new_n188_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n147_), .O(new_n192_));
  aoi21  g148(.a(new_n133_), .b(x14), .c(new_n87_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(x17), .c(x16), .d(x15), .O(new_n194_));
  oai21  g150(.a(new_n130_), .b(new_n186_), .c(new_n111_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n45_), .O(new_n196_));
  oai21  g152(.a(new_n130_), .b(new_n111_), .c(x31), .O(new_n197_));
  nand4  g153(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n198_));
  nand2  g154(.a(x18), .b(x17), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n169_), .c(new_n145_), .O(new_n200_));
  inv1   g156(.a(x11), .O(new_n201_));
  oai21  g157(.a(new_n199_), .b(new_n201_), .c(new_n139_), .O(new_n202_));
  nand2  g158(.a(x18), .b(x12), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n84_), .O(new_n204_));
  inv1   g160(.a(x13), .O(new_n205_));
  nand2  g161(.a(new_n87_), .b(new_n205_), .O(new_n206_));
  nand4  g162(.a(new_n206_), .b(new_n204_), .c(new_n202_), .d(new_n200_), .O(new_n207_));
  aoi21  g163(.a(new_n198_), .b(new_n133_), .c(new_n207_), .O(new_n208_));
  nand4  g164(.a(new_n208_), .b(new_n197_), .c(new_n196_), .d(new_n194_), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(x33), .O(new_n210_));
  oai21  g166(.a(new_n192_), .b(x33), .c(new_n210_), .O(new_n211_));
