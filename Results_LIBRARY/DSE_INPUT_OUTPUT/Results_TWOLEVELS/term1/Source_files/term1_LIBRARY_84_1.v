...
module FAU ( 
  ...
  oai21  g048(.a(new_n92_), .b(new_n59_), .c(new_n48_), .O(z3));
  ...
  nand2  g069(.a(new_n113_), .b(new_n48_), .O(z5));
  ...
  oai21  g078(.a(new_n122_), .b(new_n59_), .c(new_n48_), .O(z6));
  ...
  nor2   g083(.a(new_n45_), .b(new_n107_), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n108_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x31), .O(new_n130_));
  inv1   g086(.a(new_n87_), .O(new_n131_));
  inv1   g087(.a(new_n88_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n131_), .c(new_n86_), .d(new_n84_), .O(new_n133_));
  nand4  g089(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n133_), .c(new_n130_), .d(new_n127_), .O(z7));
  ...
  oai21  g104(.a(new_n148_), .b(new_n146_), .c(new_n45_), .O(new_n149_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n140_), .c(x11), .O(new_n154_));
  oai21  g110(.a(new_n149_), .b(new_n140_), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nor2   g112(.a(new_n140_), .b(x15), .O(new_n157_));
  nand2  g113(.a(x18), .b(x17), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nor2   g115(.a(x30), .b(new_n144_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n159_), .c(new_n157_), .d(x10), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n156_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n139_), .c(x29), .O(new_n163_));
  nor2   g119(.a(new_n138_), .b(new_n107_), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(new_n165_));
  oai21  g121(.a(new_n148_), .b(new_n146_), .c(x15), .O(new_n166_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n152_), .c(new_n167_), .O(new_n177_));
  nand2  g133(.a(x17), .b(x11), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n150_), .c(new_n140_), .O(new_n179_));
  inv1   g135(.a(x12), .O(new_n180_));
  oai21  g136(.a(new_n150_), .b(new_n180_), .c(new_n141_), .O(new_n181_));
  inv1   g137(.a(x13), .O(new_n182_));
  oai21  g138(.a(new_n144_), .b(new_n182_), .c(new_n142_), .O(new_n183_));
  nor2   g139(.a(x19), .b(x14), .O(new_n184_));
  nor2   g140(.a(new_n140_), .b(new_n167_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n153_), .c(new_n184_), .O(new_n186_));
  oai21  g142(.a(x30), .b(x29), .c(x31), .O(new_n187_));
  aoi21  g143(.a(new_n128_), .b(x28), .c(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n186_), .c(new_n183_), .d(new_n181_), .O(new_n189_));
  ...
  nand3  g153(.a(new_n162_), .b(new_n197_), .c(new_n124_), .O(new_n198_));
  nand2  g154(.a(x33), .b(x31), .O(new_n199_));
  aoi21  g155(.a(new_n199_), .b(new_n198_), .c(new_n164_), .O(new_n200_));
  nand4  g156(.a(new_n169_), .b(new_n197_), .c(x31), .d(x30), .O(new_n201_));
  oai21  g157(.a(new_n197_), .b(x31), .c(new_n201_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n139_), .c(x29), .O(new_n203_));
  aoi21  g159(.a(new_n144_), .b(x14), .c(new_n142_), .O(new_n204_));
  nand4  g160(.a(new_n204_), .b(x17), .c(x16), .d(x15), .O(new_n205_));
  nand2  g161(.a(new_n185_), .b(new_n159_), .O(new_n206_));
  nand2  g162(.a(new_n206_), .b(new_n144_), .O(new_n207_));
  oai21  g163(.a(new_n176_), .b(new_n158_), .c(new_n167_), .O(new_n208_));
  inv1   g164(.a(x11), .O(new_n209_));
  oai21  g165(.a(new_n158_), .b(new_n209_), .c(new_n140_), .O(new_n210_));
  oai21  g166(.a(new_n142_), .b(new_n180_), .c(new_n141_), .O(new_n211_));
  nand2  g167(.a(new_n142_), .b(new_n182_), .O(new_n212_));
  ...
  nand4  g171(.a(new_n215_), .b(new_n208_), .c(new_n207_), .d(new_n205_), .O(new_n216_));
  nand2  g172(.a(new_n216_), .b(x33), .O(new_n217_));
  nand2  g173(.a(new_n217_), .b(new_n203_), .O(new_n218_));
  oai21  g174(.a(new_n218_), .b(new_n200_), .c(new_n80_), .O(new_n219_));
  oai21  g175(.a(new_n219_), .b(new_n196_), .c(new_n48_), .O(z9));
endmodule
