...
module FAU ( 
  ...
  nand3  g059(.a(new_n81_), .b(x29), .c(new_n45_), .O(new_n104_));
  oai21  g060(.a(new_n103_), .b(new_n45_), .c(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n102_), .c(new_n62_), .d(new_n82_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n101_), .c(new_n60_), .O(z5));
  nand2  g063(.a(x29), .b(x28), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x30), .O(new_n109_));
  nand3  g065(.a(new_n81_), .b(x29), .c(x28), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n102_), .c(new_n62_), .d(x27), .O(new_n112_));
  ...
  nand4  g083(.a(x32), .b(new_n120_), .c(new_n82_), .d(x00), .O(new_n128_));
  ...
  nand3  g088(.a(new_n132_), .b(new_n81_), .c(x29), .O(new_n133_));
  ...
  nand2  g120(.a(new_n81_), .b(new_n134_), .O(new_n165_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n163_), .c(new_n90_), .O(new_n177_));
  ...
  aoi22  g137(.a(new_n181_), .b(new_n84_), .c(new_n87_), .d(new_n161_), .O(new_n182_));
  ...
  nand3  g148(.a(new_n192_), .b(new_n116_), .c(new_n81_), .O(new_n193_));
