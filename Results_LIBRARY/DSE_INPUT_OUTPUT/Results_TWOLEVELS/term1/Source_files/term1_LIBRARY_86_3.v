...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n45_), .c(new_n80_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n60_), .c(new_n48_), .O(z3));
  inv1   g052(.a(x25), .O(new_n97_));
  nand2  g053(.a(x28), .b(new_n45_), .O(new_n98_));
  inv1   g054(.a(x28), .O(new_n99_));
  nand2  g055(.a(new_n46_), .b(new_n99_), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n45_), .c(new_n98_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n94_), .c(new_n80_), .O(new_n102_));
  nor3   g058(.a(new_n102_), .b(new_n97_), .c(new_n60_), .O(z4));
  inv1   g059(.a(x29), .O(new_n104_));
  aoi21  g060(.a(new_n46_), .b(new_n99_), .c(new_n45_), .O(new_n105_));
  nand2  g061(.a(x28), .b(x27), .O(new_n106_));
  nand2  g062(.a(new_n46_), .b(new_n104_), .O(new_n107_));
  ...
  nor3   g065(.a(new_n109_), .b(new_n97_), .c(new_n60_), .O(z5));
  nand2  g066(.a(new_n46_), .b(x29), .O(new_n111_));
  oai22  g067(.a(new_n111_), .b(new_n106_), .c(new_n46_), .d(x27), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n94_), .c(new_n80_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n97_), .c(new_n60_), .O(z6));
  nand4  g070(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n115_));
  nand2  g071(.a(new_n61_), .b(x01), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(x31), .c(x26), .d(new_n97_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n47_), .O(z7));
  ...
  nand2  g093(.a(new_n137_), .b(new_n100_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n45_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n136_), .c(new_n107_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x32), .O(new_n141_));
  inv1   g097(.a(x32), .O(new_n142_));
  nor2   g098(.a(new_n104_), .b(new_n99_), .O(new_n143_));
  ...
  nand3  g105(.a(new_n90_), .b(x18), .c(x14), .O(new_n150_));
  ...
  nand3  g110(.a(new_n123_), .b(new_n120_), .c(x11), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(x15), .O(new_n157_));
  nor4   g113(.a(new_n122_), .b(new_n120_), .c(x15), .d(new_n119_), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n157_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n148_), .c(new_n142_), .d(x31), .O(new_n161_));
  ...
  nand4  g120(.a(x33), .b(x29), .c(new_n80_), .d(x00), .O(new_n165_));
  ...
  nand3  g128(.a(new_n143_), .b(x31), .c(x30), .O(new_n173_));
  ...
  oai21  g132(.a(new_n143_), .b(x30), .c(new_n170_), .O(new_n177_));
  nand2  g133(.a(new_n137_), .b(x31), .O(new_n178_));
  nand2  g134(.a(new_n90_), .b(new_n131_), .O(new_n179_));
  nand3  g135(.a(new_n123_), .b(x16), .c(x15), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n130_), .d(new_n128_), .O(new_n181_));
  aoi21  g137(.a(new_n125_), .b(new_n120_), .c(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n178_), .c(new_n177_), .d(new_n176_), .O(new_n183_));
