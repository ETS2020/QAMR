...
module FAU ( 
  ...
  oai21  g054(.a(new_n98_), .b(new_n60_), .c(new_n48_), .O(z4));
  oai21  g055(.a(x30), .b(x28), .c(x27), .O(new_n100_));
  ...
  nand2  g063(.a(new_n46_), .b(x29), .O(new_n108_));
  oai22  g064(.a(new_n108_), .b(new_n102_), .c(new_n46_), .d(x27), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n94_), .c(new_n81_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n80_), .c(new_n60_), .O(z6));
  nand3  g067(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n112_));
  nand3  g068(.a(new_n61_), .b(x25), .c(x01), .O(new_n113_));
  nor4   g069(.a(new_n113_), .b(new_n47_), .c(x31), .d(x26), .O(new_n114_));
  oai21  g070(.a(new_n112_), .b(new_n91_), .c(new_n114_), .O(z7));
  ...
  nand3  g103(.a(new_n127_), .b(x18), .c(x14), .O(new_n148_));
  ...
  nor2   g114(.a(new_n158_), .b(new_n117_), .O(new_n159_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n141_), .c(new_n172_), .O(new_n174_));
  oai21  g130(.a(new_n159_), .b(new_n169_), .c(new_n174_), .O(new_n175_));
  nand2  g131(.a(new_n127_), .b(x14), .O(new_n176_));
  nand4  g132(.a(new_n176_), .b(x18), .c(x17), .d(x16), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n157_), .O(new_n178_));
  nand2  g134(.a(new_n141_), .b(x31), .O(new_n179_));
  nor2   g135(.a(new_n88_), .b(new_n85_), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n130_), .c(new_n127_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n116_), .c(new_n157_), .O(new_n183_));
  aoi21  g139(.a(new_n180_), .b(x11), .c(x16), .O(new_n184_));
  oai21  g140(.a(new_n88_), .b(new_n124_), .c(new_n85_), .O(new_n185_));
  nand2  g141(.a(new_n88_), .b(new_n126_), .O(new_n186_));
  nand3  g142(.a(new_n46_), .b(x29), .c(x28), .O(new_n187_));
  nand2  g143(.a(new_n170_), .b(x30), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n186_), .d(new_n185_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n184_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n183_), .c(new_n182_), .d(new_n179_), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n178_), .c(x33), .O(new_n192_));
  oai21  g148(.a(new_n175_), .b(x33), .c(new_n192_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n81_), .c(x00), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n168_), .O(z9));
endmodule
