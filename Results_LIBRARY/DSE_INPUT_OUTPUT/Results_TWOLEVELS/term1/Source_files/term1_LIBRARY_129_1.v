...
module FAU ( 
  ...
  nand3  g054(.a(new_n81_), .b(x28), .c(new_n45_), .O(new_n99_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n94_), .c(new_n62_), .d(new_n82_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n98_), .c(new_n60_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n94_), .c(new_n62_), .d(x27), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n82_), .c(x25), .d(x01), .O(new_n116_));
  ...
  nand4  g081(.a(new_n62_), .b(new_n82_), .c(x25), .d(x01), .O(new_n126_));
  ...
  nand3  g113(.a(new_n91_), .b(x18), .c(x14), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(new_n85_), .O(new_n159_));
  nand4  g115(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n160_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n145_), .c(new_n91_), .O(new_n179_));
