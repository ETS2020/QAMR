...
module FAU ( 
  ...
  nand3  g042(.a(new_n86_), .b(new_n55_), .c(new_n80_), .O(new_n87_));
  ...
  nand3  g047(.a(new_n91_), .b(new_n86_), .c(new_n55_), .O(new_n92_));
  ...
  nand2  g060(.a(new_n104_), .b(new_n55_), .O(z5));
  nand2  g061(.a(x29), .b(x28), .O(new_n106_));
  nand2  g062(.a(x32), .b(new_n54_), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n106_), .c(new_n54_), .d(x28), .O(new_n108_));
  ...
  oai21  g070(.a(new_n106_), .b(new_n80_), .c(x31), .O(new_n115_));
  ...
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n115_), .d(new_n114_), .O(z7));
  ...
  oai21  g104(.a(x28), .b(x27), .c(x30), .O(new_n149_));
  nor2   g105(.a(new_n149_), .b(new_n97_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x10), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n138_), .c(new_n143_), .O(new_n152_));
  nor2   g108(.a(new_n131_), .b(new_n129_), .O(new_n153_));
  ...
  oai21  g116(.a(new_n160_), .b(new_n138_), .c(x31), .O(new_n161_));
  ...
  nand2  g122(.a(new_n166_), .b(new_n55_), .O(z8));
  inv1   g123(.a(x33), .O(new_n168_));
  nand4  g124(.a(new_n145_), .b(new_n168_), .c(x31), .d(x30), .O(new_n169_));
  nand2  g125(.a(x33), .b(new_n54_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n126_), .c(x29), .O(new_n172_));
  nand4  g128(.a(new_n145_), .b(new_n168_), .c(new_n121_), .d(new_n54_), .O(new_n173_));
  nand2  g129(.a(x33), .b(x31), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n127_), .O(new_n176_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n160_), .c(new_n131_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n151_), .c(new_n143_), .O(new_n181_));
  nand2  g137(.a(new_n121_), .b(x30), .O(new_n182_));
  inv1   g138(.a(x11), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(new_n183_), .c(new_n137_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x12), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n128_), .O(new_n186_));
  inv1   g142(.a(x13), .O(new_n187_));
  nand2  g143(.a(new_n129_), .b(new_n187_), .O(new_n188_));
  ...
  nand3  g148(.a(new_n192_), .b(new_n176_), .c(new_n172_), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n79_), .c(x00), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n55_), .O(z9));
endmodule
