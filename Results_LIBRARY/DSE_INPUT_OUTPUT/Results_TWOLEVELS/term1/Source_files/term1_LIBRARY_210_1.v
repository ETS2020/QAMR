...
module FAU ( 
  ...
  nor3   g046(.a(x30), .b(x20), .c(x15), .O(new_n91_));
  aoi21  g047(.a(new_n90_), .b(new_n47_), .c(new_n91_), .O(new_n92_));
  ...
  nor3   g054(.a(new_n88_), .b(new_n86_), .c(new_n84_), .O(new_n99_));
  aoi21  g055(.a(new_n99_), .b(new_n98_), .c(new_n61_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n96_), .c(new_n81_), .d(x25), .O(new_n101_));
  ...
  oai21  g062(.a(new_n45_), .b(x20), .c(new_n90_), .O(new_n107_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n110_), .c(x28), .d(x27), .O(new_n112_));
  ...
  nand3  g093(.a(new_n137_), .b(new_n134_), .c(new_n128_), .O(z7));
  inv1   g094(.a(x32), .O(new_n139_));
  nor2   g095(.a(x28), .b(x27), .O(new_n140_));
  inv1   g096(.a(new_n140_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n45_), .c(x29), .O(new_n142_));
  nor2   g098(.a(new_n140_), .b(new_n110_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n45_), .c(new_n142_), .O(new_n144_));
  ...
  nand4  g115(.a(new_n156_), .b(x16), .c(new_n135_), .d(x10), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n144_), .c(new_n139_), .d(x31), .O(new_n162_));
  aoi21  g118(.a(new_n148_), .b(x14), .c(new_n146_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x17), .c(x16), .d(x15), .O(new_n164_));
  aoi21  g120(.a(x28), .b(x20), .c(x27), .O(new_n165_));
  ...
  nor2   g125(.a(new_n146_), .b(new_n145_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(x16), .c(x15), .O(new_n171_));
  and2   g127(.a(new_n171_), .b(new_n148_), .O(new_n172_));
  nand3  g128(.a(new_n170_), .b(x16), .c(x10), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n135_), .O(new_n174_));
  nand2  g130(.a(new_n170_), .b(x11), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n154_), .O(new_n176_));
  nand2  g132(.a(x18), .b(x12), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n145_), .O(new_n178_));
  inv1   g134(.a(x13), .O(new_n179_));
  aoi21  g135(.a(new_n146_), .b(new_n179_), .c(new_n131_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n176_), .d(new_n174_), .O(new_n181_));
  nor2   g137(.a(new_n181_), .b(new_n172_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n169_), .c(new_n167_), .d(new_n164_), .O(new_n183_));
  ...
  nand4  g144(.a(x17), .b(x16), .c(new_n135_), .d(x10), .O(new_n189_));
  nor2   g145(.a(new_n148_), .b(new_n146_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(x31), .d(x30), .O(new_n191_));
  oai22  g147(.a(new_n191_), .b(new_n189_), .c(new_n188_), .d(x31), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n141_), .O(new_n193_));
  aoi21  g149(.a(new_n157_), .b(new_n153_), .c(new_n165_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n188_), .c(x31), .d(x30), .O(new_n195_));
  oai21  g151(.a(new_n195_), .b(new_n135_), .c(new_n193_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(x29), .O(new_n197_));
  nand4  g153(.a(new_n161_), .b(new_n188_), .c(new_n131_), .d(new_n45_), .O(new_n198_));
  nand2  g154(.a(x33), .b(x31), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n168_), .O(new_n201_));
  inv1   g157(.a(new_n172_), .O(new_n202_));
  nand2  g158(.a(new_n146_), .b(new_n179_), .O(new_n203_));
  xnor2a g159(.a(x31), .b(x30), .O(new_n204_));
  nand4  g160(.a(new_n204_), .b(new_n203_), .c(new_n178_), .d(new_n176_), .O(new_n205_));
  inv1   g161(.a(new_n205_), .O(new_n206_));
  nand4  g162(.a(new_n206_), .b(new_n174_), .c(new_n202_), .d(new_n164_), .O(new_n207_));
  nand2  g163(.a(new_n207_), .b(x33), .O(new_n208_));
  nand3  g164(.a(new_n208_), .b(new_n201_), .c(new_n197_), .O(new_n209_));
