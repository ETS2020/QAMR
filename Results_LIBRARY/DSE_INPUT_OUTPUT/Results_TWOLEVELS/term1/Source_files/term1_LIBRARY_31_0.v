// Benchmark "FAU" written by ABC on Thu Aug 20 01:02:57 2020
...
module FAU ( 
  ...
  oai21  g045(.a(new_n89_), .b(new_n62_), .c(new_n47_), .O(z3));
  inv1   g046(.a(new_n59_), .O(new_n91_));
  inv1   g047(.a(new_n87_), .O(new_n92_));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n92_), .c(new_n91_), .d(new_n47_), .O(new_n94_));
  inv1   g050(.a(new_n94_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n81_), .c(x25), .d(x01), .O(new_n96_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n92_), .c(new_n91_), .d(new_n47_), .O(new_n103_));
  inv1   g059(.a(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n81_), .c(x25), .d(x01), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(z5));
  nand2  g062(.a(x30), .b(new_n98_), .O(new_n107_));
  nand3  g063(.a(new_n46_), .b(x29), .c(x00), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n107_), .c(new_n99_), .O(new_n109_));
  nor2   g065(.a(new_n46_), .b(x28), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(new_n109_), .c(x27), .O(new_n111_));
  nand2  g067(.a(x30), .b(new_n82_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n111_), .c(new_n87_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n91_), .c(new_n81_), .d(x25), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n62_), .O(z6));
  oai21  g071(.a(x31), .b(new_n45_), .c(new_n46_), .O(new_n116_));
  ...
  oai21  g107(.a(new_n150_), .b(new_n45_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n130_), .O(new_n153_));
  nand2  g109(.a(new_n99_), .b(new_n82_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(x32), .c(x30), .d(x00), .O(new_n155_));
  nand4  g111(.a(new_n149_), .b(new_n129_), .c(new_n131_), .d(x31), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(x30), .c(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x29), .O(new_n158_));
  nand2  g114(.a(x16), .b(x10), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n142_), .c(new_n147_), .O(new_n160_));
  nor2   g116(.a(new_n135_), .b(new_n133_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x17), .c(x11), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n141_), .O(new_n163_));
  nand2  g119(.a(new_n161_), .b(x12), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n132_), .O(new_n165_));
  aoi21  g121(.a(x19), .b(x13), .c(x18), .O(new_n166_));
  nor2   g122(.a(x19), .b(x14), .O(new_n167_));
  nand2  g123(.a(x16), .b(x15), .O(new_n168_));
  oai21  g124(.a(new_n168_), .b(new_n142_), .c(x31), .O(new_n169_));
  nor3   g125(.a(new_n169_), .b(new_n167_), .c(new_n166_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n165_), .c(new_n163_), .d(new_n160_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(x32), .c(x00), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n158_), .c(new_n153_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n81_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n47_), .O(z8));
  inv1   g131(.a(x33), .O(new_n176_));
  nand4  g132(.a(new_n149_), .b(new_n176_), .c(x31), .d(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n124_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n129_), .c(x29), .O(new_n180_));
  nand4  g136(.a(new_n149_), .b(new_n176_), .c(new_n124_), .d(new_n46_), .O(new_n181_));
  oai21  g137(.a(new_n176_), .b(new_n124_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n130_), .O(new_n183_));
  aoi21  g139(.a(new_n135_), .b(x14), .c(new_n133_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x17), .c(x16), .d(x15), .O(new_n185_));
  nand2  g141(.a(x18), .b(x17), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n168_), .c(new_n135_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n159_), .c(new_n147_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n186_), .b(new_n189_), .c(new_n141_), .O(new_n190_));
  nand2  g146(.a(x18), .b(x12), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n132_), .O(new_n192_));
  inv1   g148(.a(x13), .O(new_n193_));
  nand2  g149(.a(new_n133_), .b(new_n193_), .O(new_n194_));
  xnor2a g150(.a(x31), .b(x30), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n194_), .c(new_n192_), .d(new_n190_), .O(new_n196_));
  inv1   g152(.a(new_n196_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n188_), .c(new_n187_), .d(new_n185_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(x33), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n183_), .c(new_n180_), .O(new_n200_));
