...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(x27), .c(new_n98_), .O(new_n100_));
  oai21  g056(.a(new_n98_), .b(x27), .c(new_n100_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n93_), .c(new_n60_), .d(new_n79_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x25), .c(x01), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n47_), .O(z4));
  ...
  oai21  g066(.a(new_n107_), .b(new_n80_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n93_), .c(new_n60_), .d(new_n79_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n106_), .c(new_n58_), .O(z5));
  nand3  g069(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x30), .O(new_n115_));
  nand2  g071(.a(new_n99_), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n98_), .c(new_n115_), .O(new_n117_));
  ...
  nand2  g079(.a(new_n123_), .b(new_n80_), .O(new_n124_));
  nand2  g080(.a(new_n109_), .b(x28), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  nand4  g082(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n83_), .O(new_n127_));
  nor2   g083(.a(new_n59_), .b(new_n58_), .O(new_n128_));
  inv1   g084(.a(new_n123_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(x29), .c(x28), .d(x27), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n128_), .c(new_n79_), .d(x25), .O(new_n131_));
  ...
  oai21  g098(.a(new_n139_), .b(new_n142_), .c(new_n84_), .O(new_n143_));
  aoi21  g099(.a(x19), .b(x13), .c(x18), .O(new_n144_));
  nor2   g100(.a(x19), .b(x14), .O(new_n145_));
  nor2   g101(.a(new_n145_), .b(new_n144_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n143_), .c(new_n141_), .d(new_n137_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x27), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(x16), .b(x15), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n136_), .c(x31), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n47_), .O(new_n151_));
  nand2  g107(.a(new_n109_), .b(new_n98_), .O(new_n152_));
  oai21  g108(.a(x30), .b(x29), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x27), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n151_), .c(new_n148_), .d(new_n125_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x32), .O(new_n156_));
  inv1   g112(.a(x32), .O(new_n157_));
  aoi21  g113(.a(new_n98_), .b(new_n80_), .c(new_n108_), .O(new_n158_));
  oai22  g114(.a(new_n158_), .b(new_n99_), .c(new_n116_), .d(new_n80_), .O(new_n159_));
  ...
  inv1   g121(.a(new_n136_), .O(new_n166_));
  ...
  nand4  g125(.a(new_n166_), .b(x16), .c(new_n134_), .d(x10), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n169_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n159_), .c(new_n157_), .d(x31), .O(new_n172_));
  ...
  nand4  g131(.a(x33), .b(new_n98_), .c(new_n79_), .d(x00), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(x30), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n80_), .O(new_n178_));
  aoi21  g134(.a(new_n167_), .b(new_n165_), .c(new_n134_), .O(new_n179_));
  inv1   g135(.a(new_n170_), .O(new_n180_));
  nand2  g136(.a(new_n98_), .b(new_n80_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x31), .c(x30), .d(x29), .O(new_n182_));
  nand3  g138(.a(new_n122_), .b(new_n99_), .c(new_n108_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n182_), .O(new_n184_));
  oai21  g140(.a(new_n180_), .b(new_n179_), .c(new_n184_), .O(new_n185_));
  nand2  g141(.a(new_n90_), .b(x14), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(x18), .c(x17), .d(x16), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n134_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x17), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n149_), .c(new_n90_), .O(new_n190_));
  oai21  g146(.a(new_n189_), .b(new_n135_), .c(new_n134_), .O(new_n191_));
  inv1   g147(.a(x11), .O(new_n192_));
  oai21  g148(.a(new_n189_), .b(new_n192_), .c(new_n138_), .O(new_n193_));
  aoi21  g149(.a(x18), .b(x12), .c(x17), .O(new_n194_));
  inv1   g150(.a(x13), .O(new_n195_));
  nand2  g151(.a(new_n87_), .b(new_n195_), .O(new_n196_));
  nand2  g152(.a(x31), .b(new_n108_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n196_), .c(new_n123_), .d(new_n116_), .O(new_n198_));
  nor2   g154(.a(new_n198_), .b(new_n194_), .O(new_n199_));
  nand4  g155(.a(new_n199_), .b(new_n193_), .c(new_n191_), .d(new_n190_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n188_), .c(x33), .O(new_n201_));
  oai21  g157(.a(new_n185_), .b(x33), .c(new_n201_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n79_), .c(x00), .O(new_n203_));
  nand2  g159(.a(new_n203_), .b(new_n178_), .O(z9));
endmodule
