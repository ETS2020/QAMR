...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(x30), .c(new_n45_), .O(new_n95_));
  ...
  nor2   g061(.a(new_n46_), .b(new_n105_), .O(new_n106_));
  ...
  nor3   g065(.a(new_n109_), .b(new_n102_), .c(new_n60_), .O(z5));
  inv1   g066(.a(x28), .O(new_n111_));
  nand3  g067(.a(x29), .b(x28), .c(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(x30), .O(new_n113_));
  nand2  g069(.a(new_n46_), .b(x29), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n111_), .c(new_n113_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n103_), .c(new_n62_), .d(new_n81_), .O(new_n116_));
  ...
  nand2  g078(.a(new_n106_), .b(x28), .O(new_n123_));
  ...
  nand2  g106(.a(new_n106_), .b(new_n111_), .O(new_n151_));
  oai21  g107(.a(x30), .b(x29), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x27), .O(new_n153_));
  nand4  g109(.a(new_n153_), .b(new_n150_), .c(new_n147_), .d(new_n123_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x32), .O(new_n155_));
  inv1   g111(.a(x32), .O(new_n156_));
  aoi21  g112(.a(new_n111_), .b(new_n45_), .c(new_n105_), .O(new_n157_));
  oai22  g113(.a(new_n157_), .b(new_n46_), .c(new_n114_), .d(new_n45_), .O(new_n158_));
  ...
  nand4  g130(.a(x33), .b(new_n111_), .c(new_n81_), .d(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(x30), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n45_), .O(new_n177_));
  aoi21  g133(.a(new_n166_), .b(new_n164_), .c(new_n133_), .O(new_n178_));
  inv1   g134(.a(new_n169_), .O(new_n179_));
  nand2  g135(.a(new_n111_), .b(new_n45_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  nand3  g137(.a(new_n120_), .b(new_n46_), .c(new_n105_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(new_n178_), .c(new_n183_), .O(new_n184_));
  nand2  g140(.a(new_n89_), .b(x14), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(x18), .c(x17), .d(x16), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n133_), .O(new_n187_));
  nand2  g143(.a(x18), .b(x17), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n148_), .c(new_n89_), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n134_), .c(new_n133_), .O(new_n190_));
  ...
  nand2  g151(.a(x31), .b(new_n105_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n195_), .c(new_n121_), .d(new_n114_), .O(new_n197_));
  nor2   g153(.a(new_n197_), .b(new_n193_), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n192_), .c(new_n190_), .d(new_n189_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n187_), .c(x33), .O(new_n200_));
  oai21  g156(.a(new_n184_), .b(x33), .c(new_n200_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n81_), .c(x00), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n177_), .O(z9));
endmodule
