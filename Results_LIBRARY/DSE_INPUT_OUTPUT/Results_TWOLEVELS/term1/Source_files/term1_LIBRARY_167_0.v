...
module FAU ( 
  ...
  nand3  g044(.a(new_n88_), .b(new_n48_), .c(new_n82_), .O(new_n89_));
  inv1   g045(.a(new_n89_), .O(new_n90_));
  nand4  g046(.a(new_n90_), .b(new_n81_), .c(x25), .d(x01), .O(new_n91_));
  nand2  g047(.a(new_n91_), .b(new_n48_), .O(z3));
  inv1   g048(.a(x25), .O(new_n93_));
  nand2  g049(.a(x28), .b(new_n82_), .O(new_n94_));
  nand2  g050(.a(x30), .b(new_n45_), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n82_), .c(new_n94_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n88_), .c(new_n81_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n93_), .c(new_n60_), .O(z4));
  inv1   g054(.a(new_n87_), .O(new_n99_));
  xnor2a g055(.a(x29), .b(x27), .O(new_n100_));
  nand3  g056(.a(x30), .b(x29), .c(new_n45_), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n45_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n99_), .c(new_n62_), .d(new_n81_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n93_), .c(new_n60_), .O(z5));
  nand2  g060(.a(new_n46_), .b(x29), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n95_), .O(new_n106_));
  nand2  g062(.a(x29), .b(x27), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(x30), .c(new_n106_), .d(x27), .O(new_n108_));
  ...
  nor2   g067(.a(x31), .b(new_n46_), .O(new_n112_));
  nand3  g068(.a(x30), .b(x29), .c(x27), .O(new_n113_));
  and2   g069(.a(new_n113_), .b(x31), .O(new_n114_));
  nor4   g070(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n115_));
  nor2   g071(.a(new_n61_), .b(new_n60_), .O(new_n116_));
  nand4  g072(.a(new_n112_), .b(x29), .c(x28), .d(x27), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n81_), .d(x25), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n115_), .c(new_n114_), .O(new_n119_));
  oai21  g075(.a(new_n112_), .b(x28), .c(new_n119_), .O(z7));
  inv1   g076(.a(x32), .O(new_n121_));
  nor2   g077(.a(x28), .b(x27), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  inv1   g079(.a(x29), .O(new_n124_));
  nand2  g080(.a(x30), .b(new_n124_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n123_), .c(new_n105_), .O(new_n126_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n126_), .c(new_n121_), .d(x31), .O(new_n145_));
  ...
  nor2   g105(.a(new_n130_), .b(new_n128_), .O(new_n150_));
  ...
  nand2  g112(.a(new_n130_), .b(new_n156_), .O(new_n157_));
  nor2   g113(.a(new_n136_), .b(new_n142_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n138_), .O(new_n159_));
  inv1   g115(.a(x31), .O(new_n160_));
  aoi21  g116(.a(new_n46_), .b(new_n124_), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n159_), .c(new_n157_), .d(new_n155_), .O(new_n162_));
  nor2   g118(.a(new_n162_), .b(new_n153_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n152_), .c(new_n149_), .d(new_n147_), .O(new_n164_));
  ...
  nand2  g123(.a(new_n167_), .b(new_n48_), .O(z8));
  nand2  g124(.a(new_n46_), .b(new_n45_), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n158_), .c(x19), .O(new_n172_));
  oai21  g128(.a(new_n170_), .b(new_n148_), .c(new_n142_), .O(new_n173_));
  inv1   g129(.a(x11), .O(new_n174_));
  oai21  g130(.a(new_n170_), .b(new_n174_), .c(new_n136_), .O(new_n175_));
  nand2  g131(.a(x18), .b(x12), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n127_), .O(new_n177_));
  nor2   g133(.a(new_n142_), .b(x14), .O(new_n178_));
  nand3  g134(.a(x18), .b(x17), .c(x16), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n178_), .c(new_n128_), .d(new_n154_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n177_), .c(new_n175_), .d(new_n173_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n172_), .c(new_n169_), .O(new_n183_));
  nand3  g139(.a(new_n48_), .b(x19), .c(x18), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n127_), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(x16), .c(x15), .O(new_n186_));
  nand2  g142(.a(new_n160_), .b(new_n124_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n46_), .c(x28), .O(new_n188_));
  nand2  g144(.a(x31), .b(x29), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n122_), .c(x30), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n188_), .c(new_n186_), .d(new_n183_), .O(new_n191_));
  ...
  oai21  g153(.a(new_n197_), .b(new_n196_), .c(x28), .O(new_n198_));
  oai21  g154(.a(new_n194_), .b(new_n107_), .c(new_n198_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n144_), .c(new_n193_), .O(new_n200_));
