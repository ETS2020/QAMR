...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n45_), .c(new_n81_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n60_), .c(new_n49_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n60_), .c(new_n49_), .O(z4));
  inv1   g055(.a(x28), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n45_), .c(x29), .O(new_n101_));
  ...
  nand3  g060(.a(new_n104_), .b(new_n62_), .c(new_n81_), .O(new_n105_));
  inv1   g061(.a(new_n105_), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x25), .c(x01), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(new_n49_), .O(z5));
  nor2   g064(.a(new_n102_), .b(new_n100_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x27), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n46_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n60_), .c(new_n49_), .O(z6));
  inv1   g069(.a(new_n82_), .O(new_n114_));
  nand4  g070(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n114_), .O(new_n115_));
  inv1   g071(.a(x31), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n81_), .c(x25), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n61_), .c(new_n60_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n115_), .c(new_n47_), .O(z7));
  nand3  g075(.a(x30), .b(x29), .c(x28), .O(new_n120_));
  oai21  g076(.a(x30), .b(x28), .c(new_n120_), .O(new_n121_));
  ...
  oai21  g087(.a(new_n127_), .b(new_n131_), .c(new_n83_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand2  g089(.a(x19), .b(x13), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n86_), .O(new_n135_));
  ...
  aoi21  g095(.a(new_n46_), .b(new_n102_), .c(new_n116_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n139_), .c(new_n137_), .d(new_n135_), .O(new_n141_));
  nor3   g097(.a(new_n141_), .b(new_n133_), .c(new_n130_), .O(new_n142_));
  nand3  g098(.a(new_n142_), .b(new_n126_), .c(new_n122_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x32), .O(new_n144_));
  inv1   g100(.a(x32), .O(new_n145_));
  aoi21  g101(.a(new_n46_), .b(x28), .c(x27), .O(new_n146_));
  oai22  g102(.a(new_n146_), .b(new_n102_), .c(new_n109_), .d(new_n46_), .O(new_n147_));
  ...
  aoi21  g124(.a(new_n155_), .b(new_n153_), .c(new_n123_), .O(new_n169_));
  oai21  g125(.a(x28), .b(x27), .c(x29), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n116_), .c(new_n46_), .O(new_n171_));
  nand3  g127(.a(new_n109_), .b(x31), .c(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n171_), .O(new_n173_));
  oai21  g129(.a(new_n159_), .b(new_n169_), .c(new_n173_), .O(new_n174_));
  oai21  g130(.a(new_n109_), .b(x30), .c(new_n116_), .O(new_n175_));
  nand2  g131(.a(new_n120_), .b(x31), .O(new_n176_));
  nand4  g132(.a(new_n139_), .b(new_n137_), .c(new_n135_), .d(new_n132_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n130_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n176_), .c(new_n175_), .d(new_n126_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x33), .O(new_n180_));
  oai21  g136(.a(new_n174_), .b(x33), .c(new_n180_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n81_), .c(x00), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n168_), .O(z9));
endmodule
