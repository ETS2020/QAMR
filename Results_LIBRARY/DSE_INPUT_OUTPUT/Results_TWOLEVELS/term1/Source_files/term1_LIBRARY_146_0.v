...
module FAU ( 
  ...
  oai21  g047(.a(new_n91_), .b(new_n60_), .c(new_n81_), .O(z3));
  xor2a  g048(.a(x28), .b(x27), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n90_), .c(new_n83_), .d(x25), .O(new_n94_));
  oai21  g050(.a(new_n94_), .b(new_n60_), .c(new_n81_), .O(z4));
  ...
  nand4  g057(.a(new_n101_), .b(new_n96_), .c(new_n81_), .d(new_n62_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n83_), .c(x25), .d(x01), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(z5));
  nand3  g061(.a(new_n99_), .b(x32), .c(new_n80_), .O(new_n106_));
  oai21  g062(.a(new_n99_), .b(new_n80_), .c(new_n106_), .O(new_n107_));
  nand2  g063(.a(new_n107_), .b(x29), .O(new_n108_));
  nand2  g064(.a(x30), .b(new_n97_), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n108_), .c(new_n89_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n62_), .c(new_n83_), .d(x25), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n60_), .O(z6));
  oai21  g068(.a(z0), .b(x31), .c(new_n80_), .O(new_n113_));
  nand3  g069(.a(x29), .b(x28), .c(x27), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(x31), .O(new_n115_));
  inv1   g071(.a(new_n87_), .O(new_n116_));
  inv1   g072(.a(new_n88_), .O(new_n117_));
  ...
  nand4  g077(.a(new_n99_), .b(new_n121_), .c(x30), .d(x29), .O(new_n122_));
  nand4  g078(.a(new_n122_), .b(new_n120_), .c(new_n83_), .d(x25), .O(new_n123_));
  ...
  nand2  g082(.a(x32), .b(new_n80_), .O(new_n127_));
  nand2  g083(.a(new_n98_), .b(new_n84_), .O(new_n128_));
  ...
  aoi21  g105(.a(new_n149_), .b(new_n127_), .c(new_n130_), .O(new_n150_));
  nand2  g106(.a(new_n98_), .b(new_n84_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(x30), .c(x29), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n142_), .c(x15), .O(new_n155_));
  nand2  g111(.a(x19), .b(x18), .O(new_n156_));
  nand2  g112(.a(x17), .b(x11), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n156_), .c(new_n140_), .O(new_n158_));
  inv1   g114(.a(x12), .O(new_n159_));
  oai21  g115(.a(new_n156_), .b(new_n159_), .c(new_n131_), .O(new_n160_));
  ...
  nor3   g121(.a(new_n165_), .b(new_n163_), .c(new_n121_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n155_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n152_), .c(z0), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n150_), .c(new_n83_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n126_), .O(z8));
  ...
  oai21  g131(.a(new_n173_), .b(new_n153_), .c(new_n146_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n173_), .b(new_n177_), .c(new_n140_), .O(new_n178_));
  oai21  g134(.a(new_n132_), .b(new_n159_), .c(new_n131_), .O(new_n179_));
  aoi21  g135(.a(new_n132_), .b(new_n161_), .c(new_n165_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n178_), .d(new_n176_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n175_), .c(new_n81_), .O(new_n182_));
  inv1   g138(.a(x14), .O(new_n183_));
  nand3  g139(.a(x30), .b(x18), .c(x17), .O(new_n184_));
  oai22  g140(.a(new_n184_), .b(new_n164_), .c(z0), .d(x19), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n183_), .O(new_n186_));
  nand3  g142(.a(new_n128_), .b(x32), .c(x29), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n80_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n121_), .O(new_n189_));
  nor3   g145(.a(z0), .b(new_n121_), .c(x30), .O(new_n190_));
  aoi21  g146(.a(new_n129_), .b(x30), .c(new_n190_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n189_), .c(new_n186_), .d(new_n182_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  nand4  g149(.a(new_n128_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  nand4  g150(.a(new_n129_), .b(x32), .c(new_n121_), .d(new_n80_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n148_), .c(new_n48_), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n193_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n83_), .c(x00), .O(new_n199_));
