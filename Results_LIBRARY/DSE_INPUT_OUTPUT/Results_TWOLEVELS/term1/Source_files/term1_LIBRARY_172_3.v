...
module FAU ( 
  ...
  oai22  g067(.a(new_n111_), .b(new_n105_), .c(new_n46_), .d(x27), .O(new_n112_));
  ...
  aoi21  g074(.a(new_n90_), .b(x14), .c(new_n87_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x17), .c(x16), .d(x15), .O(new_n120_));
  nand3  g076(.a(x30), .b(x29), .c(x28), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n99_), .c(new_n45_), .O(new_n123_));
  nand4  g079(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n124_));
  and2   g080(.a(new_n124_), .b(new_n90_), .O(new_n125_));
  ...
  nand2  g088(.a(new_n132_), .b(new_n84_), .O(new_n133_));
  inv1   g089(.a(x13), .O(new_n134_));
  nand2  g090(.a(new_n87_), .b(new_n134_), .O(new_n135_));
  inv1   g091(.a(x31), .O(new_n136_));
  aoi21  g092(.a(new_n46_), .b(new_n106_), .c(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n135_), .c(new_n133_), .d(new_n131_), .O(new_n138_));
  aoi21  g094(.a(new_n128_), .b(new_n127_), .c(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n126_), .c(new_n123_), .d(new_n120_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x32), .O(new_n141_));
  inv1   g097(.a(x32), .O(new_n142_));
  aoi21  g098(.a(new_n46_), .b(x28), .c(x27), .O(new_n143_));
  nor2   g099(.a(new_n106_), .b(new_n98_), .O(new_n144_));
  oai22  g100(.a(new_n144_), .b(new_n46_), .c(new_n143_), .d(new_n106_), .O(new_n145_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n129_), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n151_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nand3  g112(.a(x16), .b(new_n127_), .c(x10), .O(new_n157_));
  ...
  nand4  g116(.a(new_n160_), .b(new_n145_), .c(new_n142_), .d(x31), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n141_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n80_), .c(x00), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n58_), .O(z8));
  ...
  aoi21  g123(.a(new_n154_), .b(new_n151_), .c(new_n127_), .O(new_n168_));
  oai21  g124(.a(x28), .b(x27), .c(x29), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n136_), .c(new_n46_), .O(new_n170_));
  nand3  g126(.a(new_n144_), .b(x31), .c(x30), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  oai21  g128(.a(new_n158_), .b(new_n168_), .c(new_n172_), .O(new_n173_));
  oai21  g129(.a(new_n144_), .b(x30), .c(new_n136_), .O(new_n174_));
  nand2  g130(.a(new_n121_), .b(x31), .O(new_n175_));
  nand2  g131(.a(new_n128_), .b(new_n127_), .O(new_n176_));
  nand4  g132(.a(new_n135_), .b(new_n133_), .c(new_n131_), .d(new_n176_), .O(new_n177_));
  nor2   g133(.a(new_n177_), .b(new_n125_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n175_), .c(new_n174_), .d(new_n120_), .O(new_n179_));
