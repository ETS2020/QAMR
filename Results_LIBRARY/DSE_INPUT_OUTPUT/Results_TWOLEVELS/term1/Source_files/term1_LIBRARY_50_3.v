...
module FAU ( 
  ...
  nor2   g072(.a(new_n109_), .b(new_n100_), .O(new_n117_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n109_), .c(new_n132_), .O(new_n134_));
  ...
  nand4  g133(.a(new_n149_), .b(new_n172_), .c(new_n116_), .d(new_n109_), .O(new_n178_));
