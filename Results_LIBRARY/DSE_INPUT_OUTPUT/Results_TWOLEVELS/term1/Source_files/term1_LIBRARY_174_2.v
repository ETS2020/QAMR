...
module FAU ( 
  ...
  aoi21  g079(.a(x31), .b(new_n102_), .c(new_n97_), .O(new_n124_));
  ...
  oai21  g087(.a(new_n129_), .b(new_n102_), .c(x30), .O(new_n132_));
  ...
  nor2   g105(.a(new_n111_), .b(new_n102_), .O(new_n150_));
  ...
  oai21  g137(.a(new_n129_), .b(new_n111_), .c(x31), .O(new_n182_));
  nand2  g138(.a(x18), .b(x17), .O(new_n183_));
  inv1   g139(.a(new_n183_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n163_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n89_), .O(new_n186_));
  nand3  g142(.a(new_n184_), .b(x16), .c(x10), .O(new_n187_));
  nand2  g143(.a(new_n118_), .b(x30), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n183_), .b(new_n189_), .c(new_n140_), .O(new_n190_));
  ...
  aoi21  g150(.a(new_n187_), .b(new_n146_), .c(new_n194_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n186_), .c(new_n182_), .d(new_n181_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(x33), .O(new_n197_));
  aoi21  g153(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n198_));
  inv1   g154(.a(new_n147_), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n198_), .c(new_n175_), .O(new_n200_));
  nor2   g156(.a(new_n200_), .b(x31), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n111_), .c(new_n103_), .d(new_n80_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n197_), .c(new_n179_), .O(new_n203_));
  nand2  g159(.a(new_n201_), .b(new_n111_), .O(new_n204_));
  nand2  g160(.a(x33), .b(x31), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n204_), .c(x29), .O(new_n206_));
  aoi21  g162(.a(new_n203_), .b(new_n45_), .c(new_n206_), .O(new_n207_));
  oai21  g163(.a(new_n207_), .b(new_n174_), .c(new_n48_), .O(z9));
endmodule
