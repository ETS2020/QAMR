...
module FAU ( 
  ...
  nor2   g063(.a(new_n101_), .b(new_n99_), .O(new_n108_));
  nand4  g064(.a(new_n45_), .b(x29), .c(x28), .d(x27), .O(new_n109_));
  ...
  nand2  g069(.a(new_n113_), .b(new_n58_), .O(z6));
  nor4   g070(.a(new_n88_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n115_));
  ...
  nand3  g080(.a(x32), .b(new_n45_), .c(new_n99_), .O(new_n125_));
  ...
  nor2   g087(.a(new_n45_), .b(x29), .O(new_n132_));
  ...
  nand4  g108(.a(new_n152_), .b(new_n134_), .c(new_n128_), .d(x31), .O(new_n153_));
  ...
  oai21  g116(.a(new_n157_), .b(new_n160_), .c(new_n135_), .O(new_n161_));
  nand2  g117(.a(x19), .b(x13), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n136_), .O(new_n163_));
  ...
  nand2  g122(.a(new_n45_), .b(new_n101_), .O(new_n167_));
  ...
  nand2  g130(.a(new_n174_), .b(new_n127_), .O(z8));
  inv1   g131(.a(x33), .O(new_n176_));
  aoi21  g132(.a(new_n45_), .b(new_n101_), .c(new_n129_), .O(new_n177_));
  ...
  nand3  g136(.a(new_n130_), .b(new_n118_), .c(x29), .O(new_n181_));
  nor2   g137(.a(new_n132_), .b(new_n121_), .O(new_n182_));
