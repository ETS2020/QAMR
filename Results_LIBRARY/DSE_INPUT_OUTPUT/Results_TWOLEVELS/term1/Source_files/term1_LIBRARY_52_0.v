...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n79_), .c(x29), .O(new_n96_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n60_), .c(x25), .d(x01), .O(new_n100_));
  aoi21  g056(.a(new_n100_), .b(x00), .c(x26), .O(z5));
  ...
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(new_n115_), .d(new_n82_), .O(new_n118_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n106_), .c(new_n120_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n119_), .c(new_n118_), .d(new_n114_), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x00), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n102_), .O(z7));
  ...
  nand3  g105(.a(x32), .b(new_n105_), .c(x00), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n129_), .O(new_n152_));
  nand4  g108(.a(new_n148_), .b(new_n128_), .c(new_n130_), .d(x31), .O(new_n153_));
  nand2  g109(.a(x27), .b(x00), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n95_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(x32), .c(x30), .O(new_n156_));
  oai21  g112(.a(new_n153_), .b(x30), .c(new_n156_), .O(new_n157_));
  ...
  oai21  g124(.a(x18), .b(x13), .c(x31), .O(new_n169_));
  ...
  aoi21  g129(.a(new_n157_), .b(x29), .c(new_n173_), .O(new_n174_));
  aoi21  g130(.a(new_n174_), .b(new_n152_), .c(x26), .O(z8));
  inv1   g131(.a(x33), .O(new_n176_));
  nand4  g132(.a(new_n148_), .b(new_n176_), .c(x31), .d(x30), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n121_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n177_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n128_), .c(x29), .O(new_n180_));
  nand4  g136(.a(new_n148_), .b(new_n176_), .c(new_n121_), .d(new_n105_), .O(new_n181_));
  ...
  inv1   g140(.a(new_n164_), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n142_), .c(x15), .O(new_n186_));
  nor2   g142(.a(new_n134_), .b(new_n132_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(x17), .c(x11), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n140_), .O(new_n189_));
  nand2  g145(.a(new_n187_), .b(x12), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n131_), .O(new_n191_));
  nand2  g147(.a(x19), .b(x13), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n132_), .O(new_n193_));
  oai22  g149(.a(new_n161_), .b(new_n141_), .c(x19), .d(x14), .O(new_n194_));
  xor2a  g150(.a(x31), .b(x30), .O(new_n195_));
  nor2   g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n193_), .c(new_n191_), .d(new_n189_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n186_), .c(x33), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n184_), .c(new_n180_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n102_), .c(x00), .O(new_n200_));
