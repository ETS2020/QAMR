...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(new_n60_), .d(new_n80_), .O(new_n114_));
  ...
  nand4  g081(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n126_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n79_), .O(new_n148_));
  ...
  inv1   g109(.a(new_n111_), .O(new_n154_));
  nand2  g110(.a(x30), .b(new_n100_), .O(new_n155_));
  and2   g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  oai22  g112(.a(new_n156_), .b(new_n45_), .c(new_n154_), .d(new_n101_), .O(new_n157_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n145_), .c(new_n88_), .O(new_n180_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n178_), .c(new_n47_), .O(new_n188_));
  oai21  g144(.a(x31), .b(new_n100_), .c(new_n155_), .O(new_n189_));
  aoi21  g145(.a(new_n109_), .b(new_n118_), .c(x30), .O(new_n190_));
  ...
  nand3  g150(.a(new_n147_), .b(new_n118_), .c(new_n79_), .O(new_n195_));
