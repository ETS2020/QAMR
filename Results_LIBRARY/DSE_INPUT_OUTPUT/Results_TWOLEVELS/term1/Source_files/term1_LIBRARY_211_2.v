...
module FAU ( 
  ...
  nand4  g064(.a(new_n108_), .b(new_n82_), .c(new_n100_), .d(new_n99_), .O(new_n109_));
  ...
  inv1   g069(.a(new_n108_), .O(new_n114_));
  nor2   g070(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  xor2a  g071(.a(x28), .b(x27), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n115_), .c(x25), .d(x01), .O(new_n117_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n108_), .c(new_n82_), .d(new_n99_), .O(new_n123_));
  ...
  aoi21  g086(.a(new_n130_), .b(new_n128_), .c(new_n114_), .O(new_n131_));
  ...
  nor2   g095(.a(new_n113_), .b(new_n60_), .O(new_n140_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n99_), .O(z7));
  zero   g104(.O(z9));
endmodule
