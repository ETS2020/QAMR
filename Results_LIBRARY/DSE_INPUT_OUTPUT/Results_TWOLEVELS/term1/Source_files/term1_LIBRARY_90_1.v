...
module FAU ( 
  ...
  aoi21  g063(.a(new_n107_), .b(new_n79_), .c(x26), .O(z5));
  ...
  oai21  g068(.a(new_n112_), .b(new_n102_), .c(new_n110_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n92_), .c(new_n59_), .d(new_n79_), .O(new_n114_));
  ...
  nand4  g076(.a(x30), .b(x29), .c(x28), .d(x27), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n79_), .c(new_n45_), .O(new_n122_));
  nor2   g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n119_), .O(z7));
  nand4  g080(.a(x32), .b(new_n79_), .c(new_n45_), .d(x00), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(z8));
  inv1   g082(.a(x33), .O(new_n127_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n128_), .c(new_n127_), .d(new_n111_), .O(new_n144_));
  aoi21  g100(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(x17), .c(x16), .d(x15), .O(new_n146_));
  nand2  g102(.a(x16), .b(x15), .O(new_n147_));
  nand2  g103(.a(x18), .b(x17), .O(new_n148_));
  oai21  g104(.a(new_n148_), .b(new_n147_), .c(new_n87_), .O(new_n149_));
  ...
  aoi21  g112(.a(new_n84_), .b(new_n156_), .c(x30), .O(new_n157_));
  ...
  nand4  g118(.a(new_n162_), .b(new_n79_), .c(new_n45_), .d(x00), .O(new_n163_));
