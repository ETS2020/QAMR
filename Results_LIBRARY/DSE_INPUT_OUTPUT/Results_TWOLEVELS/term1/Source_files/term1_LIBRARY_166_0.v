...
module FAU ( 
  ...
  nand2  g088(.a(x30), .b(new_n103_), .O(new_n133_));
  ...
  nand4  g105(.a(new_n149_), .b(new_n134_), .c(new_n131_), .d(x31), .O(new_n150_));
  nand2  g106(.a(new_n104_), .b(new_n80_), .O(new_n151_));
  ...
  nor2   g110(.a(new_n90_), .b(new_n87_), .O(new_n155_));
  ...
  nand2  g117(.a(new_n90_), .b(new_n161_), .O(new_n162_));
  nand3  g118(.a(new_n143_), .b(x16), .c(x15), .O(new_n163_));
  aoi21  g119(.a(new_n115_), .b(new_n103_), .c(new_n120_), .O(new_n164_));
  ...
  nand4  g127(.a(x33), .b(new_n104_), .c(new_n79_), .d(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x30), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n80_), .O(new_n174_));
  ...
  nand2  g146(.a(new_n87_), .b(new_n159_), .O(new_n191_));
  nand2  g147(.a(x31), .b(new_n103_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n191_), .c(new_n121_), .d(new_n116_), .O(new_n193_));
