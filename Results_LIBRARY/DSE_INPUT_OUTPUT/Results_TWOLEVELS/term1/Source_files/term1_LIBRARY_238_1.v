...
module FAU ( 
  ...
  aoi21  g050(.a(new_n94_), .b(new_n91_), .c(new_n61_), .O(new_n95_));
  ...
  nor3   g056(.a(new_n88_), .b(new_n86_), .c(new_n84_), .O(new_n101_));
  aoi21  g057(.a(new_n101_), .b(new_n100_), .c(new_n61_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n98_), .c(new_n81_), .d(x25), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n60_), .c(new_n47_), .O(z4));
  nand2  g060(.a(x28), .b(x27), .O(new_n105_));
  oai21  g061(.a(new_n45_), .b(x21), .c(new_n90_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n94_), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(new_n105_), .c(x29), .O(new_n108_));
  inv1   g064(.a(x29), .O(new_n109_));
  nand2  g065(.a(new_n94_), .b(new_n91_), .O(new_n110_));
  ...
  nand3  g070(.a(new_n105_), .b(x30), .c(x21), .O(new_n115_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(new_n90_), .O(new_n119_));
  ...
  nand2  g080(.a(new_n124_), .b(new_n47_), .O(z6));
  ...
  nand3  g084(.a(new_n89_), .b(new_n87_), .c(new_n85_), .O(new_n129_));
  inv1   g085(.a(x31), .O(new_n130_));
  inv1   g086(.a(new_n105_), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n130_), .c(x30), .d(x29), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n129_), .c(new_n128_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x21), .O(new_n134_));
  oai21  g090(.a(new_n129_), .b(new_n92_), .c(new_n130_), .O(new_n135_));
  ...
  nand2  g095(.a(new_n139_), .b(new_n82_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n45_), .c(x29), .O(new_n141_));
  ...
  nand4  g108(.a(x19), .b(x18), .c(new_n152_), .d(x12), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  inv1   g110(.a(x11), .O(new_n155_));
  nand3  g111(.a(x19), .b(x18), .c(x17), .O(new_n156_));
  nor3   g112(.a(new_n156_), .b(x16), .c(new_n155_), .O(new_n157_));
  aoi21  g113(.a(new_n154_), .b(x16), .c(new_n157_), .O(new_n158_));
  inv1   g114(.a(new_n156_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(x16), .c(new_n145_), .d(x10), .O(new_n160_));
  oai21  g116(.a(new_n158_), .b(new_n145_), .c(new_n160_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n144_), .c(new_n138_), .d(x31), .O(new_n162_));
  aoi21  g118(.a(new_n148_), .b(x14), .c(new_n146_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(x17), .c(x16), .d(x15), .O(new_n164_));
  oai21  g120(.a(new_n139_), .b(new_n93_), .c(new_n82_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(x30), .c(x29), .O(new_n166_));
  nand2  g122(.a(new_n142_), .b(new_n45_), .O(new_n167_));
  nand4  g123(.a(x18), .b(x17), .c(x16), .d(x15), .O(new_n168_));
  nand2  g124(.a(x18), .b(x17), .O(new_n169_));
  nand2  g125(.a(x16), .b(x10), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n169_), .c(new_n145_), .O(new_n171_));
  oai21  g127(.a(new_n169_), .b(new_n155_), .c(new_n92_), .O(new_n172_));
  aoi21  g128(.a(x18), .b(x12), .c(x17), .O(new_n173_));
  nor2   g129(.a(x18), .b(x13), .O(new_n174_));
  nor3   g130(.a(new_n174_), .b(new_n173_), .c(new_n130_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n172_), .c(new_n171_), .O(new_n176_));
  aoi21  g132(.a(new_n168_), .b(new_n148_), .c(new_n176_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n167_), .c(new_n166_), .d(new_n164_), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(x32), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n162_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n81_), .c(x00), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n47_), .O(z8));
  inv1   g138(.a(x00), .O(new_n183_));
  nand4  g139(.a(new_n165_), .b(x31), .c(x30), .d(x29), .O(new_n184_));
  nand3  g140(.a(new_n142_), .b(new_n130_), .c(new_n45_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n184_), .O(new_n186_));
  inv1   g142(.a(new_n153_), .O(new_n187_));
  aoi21  g143(.a(new_n150_), .b(x17), .c(new_n187_), .O(new_n188_));
  nand3  g144(.a(new_n159_), .b(new_n145_), .c(x10), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n145_), .c(new_n189_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n186_), .c(x16), .O(new_n191_));
  nand4  g147(.a(new_n140_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n185_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(x19), .c(x18), .d(x17), .O(new_n194_));
  inv1   g150(.a(new_n194_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n92_), .c(x15), .d(x11), .O(new_n196_));
  aoi21  g152(.a(new_n196_), .b(new_n191_), .c(x33), .O(new_n197_));
  inv1   g153(.a(x33), .O(new_n198_));
  aoi21  g154(.a(new_n142_), .b(new_n45_), .c(x31), .O(new_n199_));
  nor2   g155(.a(new_n45_), .b(new_n109_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n140_), .c(new_n130_), .O(new_n201_));
  nand2  g157(.a(new_n168_), .b(new_n148_), .O(new_n202_));
  nor2   g158(.a(new_n174_), .b(new_n173_), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n172_), .c(new_n171_), .d(new_n202_), .O(new_n204_));
  nor3   g160(.a(new_n204_), .b(new_n201_), .c(new_n199_), .O(new_n205_));
  aoi21  g161(.a(new_n205_), .b(new_n164_), .c(new_n198_), .O(new_n206_));
  oai21  g162(.a(new_n206_), .b(new_n197_), .c(new_n81_), .O(new_n207_));
  oai21  g163(.a(new_n207_), .b(new_n183_), .c(new_n47_), .O(z9));
endmodule
