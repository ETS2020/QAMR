...
module FAU ( 
  ...
  nand3  g051(.a(x30), .b(new_n95_), .c(x27), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n90_), .c(x25), .d(x01), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(x30), .c(x26), .O(z4));
  ...
  aoi21  g059(.a(new_n103_), .b(new_n100_), .c(new_n89_), .O(new_n104_));
  ...
  nand4  g063(.a(new_n107_), .b(new_n88_), .c(new_n60_), .d(x30), .O(new_n108_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n126_), .c(new_n124_), .d(x31), .O(new_n147_));
  aoi21  g103(.a(new_n95_), .b(new_n80_), .c(new_n101_), .O(new_n148_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n137_), .c(new_n136_), .O(new_n152_));
  inv1   g108(.a(x12), .O(new_n153_));
  oai21  g109(.a(new_n137_), .b(new_n153_), .c(new_n127_), .O(new_n154_));
  ...
  nand4  g115(.a(new_n159_), .b(new_n154_), .c(new_n152_), .d(new_n150_), .O(new_n160_));
  ...
  nand4  g121(.a(new_n146_), .b(new_n125_), .c(new_n165_), .d(x31), .O(new_n166_));
  aoi21  g122(.a(new_n130_), .b(x14), .c(new_n128_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(x17), .c(x16), .d(x15), .O(new_n168_));
  nor2   g124(.a(new_n128_), .b(new_n127_), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n157_), .c(new_n130_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n149_), .c(new_n144_), .O(new_n172_));
  aoi21  g128(.a(new_n169_), .b(x11), .c(x16), .O(new_n173_));
  oai21  g129(.a(new_n128_), .b(new_n153_), .c(new_n127_), .O(new_n174_));
  inv1   g130(.a(x13), .O(new_n175_));
  nand2  g131(.a(new_n128_), .b(new_n175_), .O(new_n176_));
  nor2   g132(.a(new_n119_), .b(new_n101_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(new_n176_), .c(new_n174_), .d(new_n125_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n173_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n172_), .c(new_n171_), .d(new_n168_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  oai21  g137(.a(new_n166_), .b(new_n101_), .c(new_n181_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x00), .O(new_n183_));
  aoi21  g139(.a(new_n183_), .b(x30), .c(x26), .O(z9));
endmodule
