...
module FAU ( 
  ...
  nand2  g017(.a(new_n58_), .b(x26), .O(new_n62_));
  ...
  nand3  g052(.a(new_n96_), .b(new_n93_), .c(new_n90_), .O(new_n97_));
  nor2   g053(.a(new_n97_), .b(new_n87_), .O(new_n98_));
  nor2   g054(.a(new_n98_), .b(new_n65_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n86_), .c(new_n57_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n85_), .c(new_n64_), .O(z3));
  xor2a  g057(.a(x28), .b(x27), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n99_), .c(new_n57_), .d(x25), .O(new_n103_));
  oai21  g059(.a(new_n103_), .b(new_n64_), .c(new_n62_), .O(z4));
  ...
  nand4  g066(.a(new_n110_), .b(new_n105_), .c(new_n66_), .d(new_n57_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n85_), .c(new_n64_), .O(z5));
  ...
  nand4  g073(.a(new_n117_), .b(new_n105_), .c(new_n66_), .d(new_n57_), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x25), .c(x01), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n62_), .O(z6));
  inv1   g077(.a(x31), .O(new_n122_));
  nor2   g078(.a(new_n115_), .b(new_n106_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n108_), .c(new_n122_), .O(new_n124_));
  inv1   g080(.a(new_n87_), .O(new_n125_));
  nand4  g081(.a(new_n96_), .b(new_n93_), .c(new_n90_), .d(new_n125_), .O(new_n126_));
  nor2   g082(.a(new_n65_), .b(new_n64_), .O(new_n127_));
  nand3  g083(.a(new_n122_), .b(x30), .c(x29), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n108_), .c(new_n85_), .O(new_n130_));
  nand3  g086(.a(new_n130_), .b(new_n127_), .c(new_n126_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n124_), .c(new_n57_), .O(new_n132_));
  oai21  g088(.a(new_n58_), .b(new_n57_), .c(new_n132_), .O(z7));
  nor2   g089(.a(x28), .b(x27), .O(new_n134_));
  inv1   g090(.a(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n115_), .c(x29), .O(new_n136_));
  nor2   g092(.a(new_n134_), .b(new_n106_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n115_), .c(new_n136_), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n91_), .c(x13), .O(new_n139_));
  nand3  g095(.a(new_n94_), .b(x18), .c(x14), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n88_), .O(new_n141_));
  nand4  g097(.a(x19), .b(x18), .c(new_n88_), .d(x12), .O(new_n142_));
  ...
  nand4  g111(.a(new_n155_), .b(new_n138_), .c(new_n58_), .d(x31), .O(new_n156_));
  nand2  g112(.a(new_n123_), .b(x27), .O(new_n157_));
  oai21  g113(.a(x30), .b(x27), .c(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n107_), .O(new_n159_));
  ...
  oai21  g120(.a(new_n146_), .b(new_n164_), .c(new_n88_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  oai21  g122(.a(new_n94_), .b(new_n166_), .c(new_n91_), .O(new_n167_));
  ...
  nand3  g131(.a(new_n175_), .b(x32), .c(new_n57_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n156_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x00), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n62_), .O(z8));
  nand4  g135(.a(new_n155_), .b(new_n48_), .c(x31), .d(x30), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n122_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n135_), .c(x29), .O(new_n183_));
  inv1   g139(.a(new_n137_), .O(new_n184_));
  nand4  g140(.a(new_n155_), .b(new_n48_), .c(new_n122_), .d(new_n115_), .O(new_n185_));
  ...
  aoi21  g144(.a(new_n94_), .b(x14), .c(new_n91_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(x17), .c(x16), .d(x15), .O(new_n190_));
  inv1   g146(.a(new_n169_), .O(new_n191_));
  nand2  g147(.a(x18), .b(x17), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n191_), .c(new_n94_), .O(new_n193_));
  oai21  g149(.a(new_n192_), .b(new_n160_), .c(new_n153_), .O(new_n194_));
  inv1   g150(.a(x11), .O(new_n195_));
  oai21  g151(.a(new_n192_), .b(new_n195_), .c(new_n145_), .O(new_n196_));
  oai21  g152(.a(new_n91_), .b(new_n164_), .c(new_n88_), .O(new_n197_));
  nand2  g153(.a(new_n91_), .b(new_n166_), .O(new_n198_));
  ...
  nand3  g160(.a(new_n204_), .b(new_n57_), .c(x00), .O(new_n205_));
