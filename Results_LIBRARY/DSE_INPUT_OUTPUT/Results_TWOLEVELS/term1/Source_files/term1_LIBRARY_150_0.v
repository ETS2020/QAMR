...
module FAU ( 
  ...
  nand4  g071(.a(new_n115_), .b(new_n93_), .c(new_n61_), .d(new_n46_), .O(new_n116_));
  ...
  nand2  g121(.a(new_n165_), .b(new_n82_), .O(new_n166_));
  ...
  oai21  g126(.a(new_n170_), .b(new_n142_), .c(x31), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n169_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n168_), .c(new_n166_), .d(new_n164_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n161_), .c(x32), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n158_), .c(new_n153_), .O(new_n175_));
  ...
  nand4  g137(.a(new_n149_), .b(new_n178_), .c(new_n126_), .d(new_n112_), .O(new_n182_));
  oai21  g138(.a(new_n178_), .b(new_n126_), .c(new_n182_), .O(new_n183_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n170_), .c(new_n88_), .O(new_n187_));
  ...
  nand2  g148(.a(new_n85_), .b(new_n167_), .O(new_n193_));
  ...
  aoi21  g155(.a(new_n183_), .b(new_n154_), .c(new_n199_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n181_), .c(x26), .O(z9));
endmodule
