...
module FAU ( 
  ...
  nand3  g048(.a(new_n92_), .b(new_n45_), .c(new_n83_), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n82_), .c(new_n61_), .O(z3));
  ...
  oai21  g053(.a(x30), .b(x28), .c(x27), .O(new_n98_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n91_), .c(new_n63_), .d(new_n83_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n82_), .c(new_n61_), .O(z5));
  nand2  g060(.a(x29), .b(x28), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n45_), .c(new_n46_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n83_), .d(x25), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n61_), .c(new_n48_), .O(z6));
  inv1   g064(.a(new_n88_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n87_), .c(new_n85_), .O(new_n110_));
  nand3  g066(.a(new_n63_), .b(x25), .c(x01), .O(new_n111_));
  nor4   g067(.a(new_n111_), .b(new_n47_), .c(x31), .d(x26), .O(new_n112_));
  oai21  g068(.a(new_n110_), .b(new_n89_), .c(new_n112_), .O(z7));
  ...
  oai21  g089(.a(new_n133_), .b(new_n117_), .c(new_n48_), .O(new_n134_));
  nand3  g090(.a(x30), .b(x29), .c(x28), .O(new_n135_));
  oai21  g091(.a(x30), .b(x28), .c(new_n135_), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n45_), .c(new_n100_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n134_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(x32), .O(new_n139_));
  inv1   g095(.a(x32), .O(new_n140_));
  nand3  g096(.a(new_n105_), .b(x30), .c(new_n45_), .O(new_n141_));
  inv1   g097(.a(x28), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n45_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(new_n46_), .c(x29), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(new_n141_), .O(new_n145_));
  nand3  g101(.a(x19), .b(new_n126_), .c(x13), .O(new_n146_));
  nand3  g102(.a(new_n127_), .b(x18), .c(x14), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n146_), .c(new_n123_), .O(new_n148_));
  nand4  g104(.a(x19), .b(x18), .c(new_n123_), .d(x12), .O(new_n149_));
  inv1   g105(.a(new_n149_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n148_), .c(x16), .O(new_n151_));
  inv1   g107(.a(new_n115_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(new_n118_), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x15), .O(new_n155_));
  inv1   g111(.a(x15), .O(new_n156_));
  nand3  g112(.a(x16), .b(new_n156_), .c(x10), .O(new_n157_));
  nor2   g113(.a(new_n157_), .b(new_n115_), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n155_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n145_), .c(new_n140_), .d(x31), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n139_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n83_), .c(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z8));
  nand4  g120(.a(x33), .b(x29), .c(new_n83_), .d(x00), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n46_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x27), .O(new_n167_));
  aoi21  g123(.a(new_n153_), .b(new_n151_), .c(new_n156_), .O(new_n168_));
  inv1   g124(.a(x31), .O(new_n169_));
  nand2  g125(.a(new_n143_), .b(x29), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n169_), .c(new_n46_), .O(new_n171_));
  nand2  g127(.a(x31), .b(x30), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n105_), .c(new_n171_), .O(new_n173_));
  oai21  g129(.a(new_n158_), .b(new_n168_), .c(new_n173_), .O(new_n174_));
  nand2  g130(.a(new_n127_), .b(x14), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x18), .c(x17), .d(x16), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n156_), .O(new_n177_));
  nand2  g133(.a(new_n105_), .b(x31), .O(new_n178_));
  nor2   g134(.a(new_n126_), .b(new_n123_), .O(new_n179_));
  inv1   g135(.a(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n130_), .c(new_n127_), .O(new_n181_));
  oai21  g137(.a(new_n180_), .b(new_n114_), .c(new_n156_), .O(new_n182_));
  aoi21  g138(.a(new_n179_), .b(x11), .c(x16), .O(new_n183_));
  oai21  g139(.a(new_n126_), .b(new_n122_), .c(new_n123_), .O(new_n184_));
  nand2  g140(.a(new_n126_), .b(new_n125_), .O(new_n185_));
  nand3  g141(.a(new_n46_), .b(x29), .c(x28), .O(new_n186_));
  nand2  g142(.a(new_n169_), .b(x30), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n186_), .c(new_n185_), .d(new_n184_), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n183_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n182_), .c(new_n181_), .d(new_n178_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n177_), .c(x33), .O(new_n191_));
  oai21  g147(.a(new_n174_), .b(x33), .c(new_n191_), .O(new_n192_));
