...
module FAU ( 
  ...
  nand3  g056(.a(new_n100_), .b(new_n93_), .c(new_n78_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n96_), .c(new_n58_), .O(z4));
  oai21  g058(.a(new_n97_), .b(new_n79_), .c(x29), .O(new_n103_));
  inv1   g059(.a(x29), .O(new_n104_));
  nand3  g060(.a(new_n104_), .b(x28), .c(x27), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n103_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n92_), .c(new_n59_), .d(new_n78_), .O(new_n107_));
  ...
  oai21  g068(.a(new_n111_), .b(x27), .c(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n93_), .c(new_n78_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n96_), .c(new_n58_), .O(z6));
  nand4  g071(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n116_));
  nand2  g072(.a(new_n59_), .b(x01), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(x31), .c(x26), .d(new_n96_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n116_), .c(new_n46_), .O(z7));
  nand3  g075(.a(x30), .b(x29), .c(x28), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n98_), .c(new_n79_), .O(new_n122_));
  inv1   g078(.a(x15), .O(new_n123_));
  nand2  g079(.a(x16), .b(x10), .O(new_n124_));
  ...
  nor2   g083(.a(new_n89_), .b(new_n86_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x17), .c(x11), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  aoi21  g086(.a(new_n128_), .b(x12), .c(x17), .O(new_n131_));
  inv1   g087(.a(x13), .O(new_n132_));
  oai21  g088(.a(new_n89_), .b(new_n132_), .c(new_n86_), .O(new_n133_));
  inv1   g089(.a(x14), .O(new_n134_));
  nand2  g090(.a(new_n89_), .b(new_n134_), .O(new_n135_));
  inv1   g091(.a(new_n125_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x16), .c(x15), .O(new_n137_));
  inv1   g093(.a(x31), .O(new_n138_));
  aoi21  g094(.a(new_n111_), .b(new_n104_), .c(new_n138_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n137_), .c(new_n135_), .d(new_n133_), .O(new_n140_));
  nor2   g096(.a(new_n140_), .b(new_n131_), .O(new_n141_));
  nand4  g097(.a(new_n141_), .b(new_n130_), .c(new_n126_), .d(new_n122_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(x32), .O(new_n143_));
  inv1   g099(.a(x32), .O(new_n144_));
  aoi21  g100(.a(new_n111_), .b(x28), .c(x27), .O(new_n145_));
  nor2   g101(.a(new_n104_), .b(new_n97_), .O(new_n146_));
  oai22  g102(.a(new_n146_), .b(new_n111_), .c(new_n145_), .d(new_n104_), .O(new_n147_));
  ...
  nand3  g109(.a(new_n136_), .b(new_n127_), .c(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(x15), .O(new_n156_));
  nand4  g112(.a(new_n136_), .b(x16), .c(new_n123_), .d(x10), .O(new_n157_));
  ...
  nor2   g120(.a(new_n164_), .b(new_n123_), .O(new_n165_));
  ...
  oai21  g124(.a(new_n167_), .b(new_n124_), .c(new_n123_), .O(new_n169_));
  inv1   g125(.a(x11), .O(new_n170_));
  oai21  g126(.a(new_n167_), .b(new_n170_), .c(new_n127_), .O(new_n171_));
  nand2  g127(.a(x18), .b(x12), .O(new_n172_));
  aoi22  g128(.a(new_n172_), .b(new_n83_), .c(new_n86_), .d(new_n132_), .O(new_n173_));
  ...
  aoi21  g132(.a(new_n176_), .b(new_n138_), .c(x30), .O(new_n177_));
  nand2  g133(.a(new_n138_), .b(x30), .O(new_n178_));
  oai21  g134(.a(new_n146_), .b(new_n138_), .c(new_n178_), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n79_), .c(new_n177_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n175_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  aoi21  g138(.a(new_n154_), .b(new_n153_), .c(new_n123_), .O(new_n183_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n186_), .c(new_n79_), .O(new_n188_));
  nand3  g144(.a(new_n138_), .b(new_n111_), .c(new_n104_), .O(new_n189_));
