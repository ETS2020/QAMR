...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n59_), .c(new_n80_), .d(new_n79_), .O(new_n93_));
  ...
  oai21  g053(.a(new_n95_), .b(x27), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n92_), .c(new_n59_), .d(new_n79_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n78_), .c(new_n58_), .O(z4));
  oai21  g056(.a(new_n96_), .b(new_n80_), .c(x29), .O(new_n101_));
  ...
  nor3   g062(.a(new_n106_), .b(new_n78_), .c(new_n58_), .O(z5));
  ...
  nand4  g070(.a(new_n59_), .b(new_n79_), .c(x25), .d(x01), .O(new_n115_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n102_), .c(new_n118_), .O(new_n121_));
  aoi22  g077(.a(new_n121_), .b(x30), .c(x31), .d(new_n80_), .O(new_n122_));
  ...
  oai21  g088(.a(new_n129_), .b(new_n132_), .c(new_n84_), .O(new_n133_));
  aoi21  g089(.a(x19), .b(x13), .c(x18), .O(new_n134_));
  nor2   g090(.a(x19), .b(x14), .O(new_n135_));
  nor2   g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand4  g092(.a(new_n136_), .b(new_n133_), .c(new_n131_), .d(new_n127_), .O(new_n137_));
  oai21  g093(.a(new_n103_), .b(new_n80_), .c(new_n137_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x15), .O(new_n139_));
  oai21  g095(.a(new_n139_), .b(new_n126_), .c(x31), .O(new_n140_));
  inv1   g096(.a(x29), .O(new_n141_));
  oai21  g097(.a(x28), .b(x27), .c(x30), .O(new_n142_));
  nand3  g098(.a(new_n117_), .b(new_n45_), .c(new_n80_), .O(new_n143_));
  oai21  g099(.a(new_n142_), .b(new_n141_), .c(new_n143_), .O(new_n144_));
  aoi21  g100(.a(new_n140_), .b(new_n46_), .c(new_n144_), .O(new_n145_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n96_), .c(new_n80_), .O(new_n151_));
  ...
  aoi21  g111(.a(new_n155_), .b(new_n153_), .c(new_n84_), .O(new_n156_));
  ...
  aoi21  g125(.a(new_n161_), .b(new_n159_), .c(new_n124_), .O(new_n170_));
  inv1   g126(.a(new_n164_), .O(new_n171_));
  oai21  g127(.a(new_n45_), .b(new_n95_), .c(new_n80_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(x31), .c(x29), .O(new_n173_));
  nand3  g129(.a(new_n117_), .b(new_n119_), .c(new_n45_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g131(.a(new_n171_), .b(new_n170_), .c(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n154_), .b(x14), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x18), .c(x17), .d(x16), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n124_), .O(new_n179_));
  oai21  g135(.a(new_n119_), .b(new_n141_), .c(x30), .O(new_n180_));
  oai21  g136(.a(x28), .b(x27), .c(x30), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x31), .O(new_n182_));
  nand2  g138(.a(x18), .b(x17), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n139_), .c(new_n154_), .O(new_n184_));
  or2    g140(.a(new_n183_), .b(new_n125_), .O(new_n185_));
  inv1   g141(.a(x11), .O(new_n186_));
  oai21  g142(.a(new_n183_), .b(new_n186_), .c(new_n128_), .O(new_n187_));
  oai21  g143(.a(new_n87_), .b(new_n132_), .c(new_n84_), .O(new_n188_));
  inv1   g144(.a(x13), .O(new_n189_));
  nand2  g145(.a(new_n87_), .b(new_n189_), .O(new_n190_));
  nand3  g146(.a(new_n119_), .b(x29), .c(x28), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n188_), .d(new_n187_), .O(new_n192_));
  aoi21  g148(.a(new_n185_), .b(new_n124_), .c(new_n192_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n184_), .c(new_n182_), .d(new_n180_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n179_), .c(x33), .O(new_n195_));
  oai21  g151(.a(new_n176_), .b(x33), .c(new_n195_), .O(new_n196_));
