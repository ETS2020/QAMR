...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n89_), .c(new_n80_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n59_), .c(new_n57_), .O(z4));
  ...
  nand2  g058(.a(new_n102_), .b(new_n98_), .O(new_n103_));
  oai21  g059(.a(new_n99_), .b(new_n98_), .c(new_n103_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n97_), .c(new_n59_), .O(z5));
  ...
  nand2  g067(.a(new_n101_), .b(x29), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(new_n110_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n97_), .c(new_n59_), .O(z6));
  ...
  nand3  g078(.a(new_n109_), .b(x31), .c(x30), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n122_), .c(new_n118_), .O(z7));
  nor3   g080(.a(new_n101_), .b(new_n100_), .c(x28), .O(new_n125_));
  nor2   g081(.a(x30), .b(x29), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n125_), .c(x27), .O(new_n127_));
  ...
  aoi21  g093(.a(new_n135_), .b(x12), .c(x17), .O(new_n138_));
  inv1   g094(.a(x13), .O(new_n139_));
  oai21  g095(.a(new_n134_), .b(new_n139_), .c(new_n133_), .O(new_n140_));
  inv1   g096(.a(x14), .O(new_n141_));
  nand2  g097(.a(new_n134_), .b(new_n141_), .O(new_n142_));
  inv1   g098(.a(new_n130_), .O(new_n143_));
  nand3  g099(.a(new_n143_), .b(x16), .c(x15), .O(new_n144_));
  aoi21  g100(.a(new_n102_), .b(x28), .c(new_n119_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n144_), .c(new_n142_), .d(new_n140_), .O(new_n146_));
  nor2   g102(.a(new_n146_), .b(new_n138_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n137_), .c(new_n131_), .d(new_n127_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  inv1   g106(.a(x28), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n98_), .O(new_n152_));
  nand2  g108(.a(x30), .b(new_n100_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(new_n112_), .O(new_n154_));
  inv1   g110(.a(x17), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n133_), .c(x13), .O(new_n156_));
  nand3  g112(.a(new_n134_), .b(x18), .c(x14), .O(new_n157_));
  ...
  oai21  g132(.a(new_n175_), .b(new_n129_), .c(new_n128_), .O(new_n177_));
  inv1   g133(.a(x11), .O(new_n178_));
  oai21  g134(.a(new_n175_), .b(new_n178_), .c(new_n132_), .O(new_n179_));
  nand2  g135(.a(x18), .b(x12), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(new_n155_), .c(new_n133_), .d(new_n139_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n179_), .c(new_n177_), .d(new_n176_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n173_), .c(new_n57_), .O(new_n183_));
  aoi21  g139(.a(new_n119_), .b(new_n100_), .c(x30), .O(new_n184_));
  nand3  g140(.a(new_n152_), .b(x31), .c(x29), .O(new_n185_));
  ...
  aoi21  g144(.a(new_n162_), .b(new_n161_), .c(new_n128_), .O(new_n189_));
  inv1   g145(.a(new_n165_), .O(new_n190_));
  ...
  nand3  g150(.a(new_n108_), .b(x31), .c(x30), .O(new_n195_));
