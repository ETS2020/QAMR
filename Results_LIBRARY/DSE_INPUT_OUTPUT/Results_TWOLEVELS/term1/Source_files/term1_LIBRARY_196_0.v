...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(x27), .c(new_n93_), .O(new_n95_));
  oai21  g051(.a(new_n93_), .b(x27), .c(new_n95_), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(x25), .c(x01), .O(new_n99_));
  nand2  g055(.a(new_n99_), .b(new_n47_), .O(z4));
  inv1   g056(.a(x25), .O(new_n101_));
  inv1   g057(.a(x27), .O(new_n102_));
  xnor2a g058(.a(x29), .b(x28), .O(new_n103_));
  inv1   g059(.a(x29), .O(new_n104_));
  nor2   g060(.a(new_n94_), .b(new_n104_), .O(new_n105_));
  nand2  g061(.a(new_n105_), .b(new_n102_), .O(new_n106_));
  oai21  g062(.a(new_n103_), .b(new_n102_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n101_), .c(new_n59_), .O(z5));
  oai21  g065(.a(x28), .b(new_n102_), .c(x29), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x30), .O(new_n111_));
  nor2   g067(.a(x30), .b(new_n104_), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(x28), .c(new_n102_), .O(new_n113_));
  aoi21  g069(.a(new_n113_), .b(new_n111_), .c(new_n89_), .O(new_n114_));
  ...
  nand2  g073(.a(new_n117_), .b(new_n83_), .O(new_n118_));
  ...
  nand2  g077(.a(x31), .b(new_n94_), .O(new_n122_));
  ...
  nand3  g083(.a(new_n127_), .b(x31), .c(x30), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n126_), .c(new_n121_), .O(z7));
  nor3   g085(.a(new_n94_), .b(new_n104_), .c(x28), .O(new_n130_));
  nor2   g086(.a(x30), .b(x29), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n130_), .c(x27), .O(new_n132_));
  ...
  aoi21  g105(.a(new_n105_), .b(x28), .c(new_n123_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(new_n149_), .c(new_n145_), .O(new_n151_));
  nor2   g107(.a(new_n151_), .b(new_n143_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n142_), .c(new_n136_), .d(new_n132_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(x32), .O(new_n154_));
  inv1   g110(.a(x32), .O(new_n155_));
  inv1   g111(.a(new_n112_), .O(new_n156_));
  nand2  g112(.a(new_n93_), .b(new_n102_), .O(new_n157_));
  nand2  g113(.a(x30), .b(new_n104_), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n157_), .c(new_n156_), .O(new_n159_));
  inv1   g115(.a(x17), .O(new_n160_));
  nand3  g116(.a(x19), .b(new_n138_), .c(x13), .O(new_n161_));
  nand3  g117(.a(new_n139_), .b(x18), .c(x14), .O(new_n162_));
  aoi21  g118(.a(new_n162_), .b(new_n161_), .c(new_n160_), .O(new_n163_));
  nand4  g119(.a(x19), .b(x18), .c(new_n160_), .d(x12), .O(new_n164_));
  ...
  nand4  g126(.a(new_n167_), .b(x16), .c(new_n133_), .d(x10), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand4  g128(.a(new_n172_), .b(new_n159_), .c(new_n155_), .d(x31), .O(new_n173_));
  ...
  nand2  g132(.a(new_n80_), .b(x00), .O(new_n177_));
  nand3  g133(.a(x33), .b(x30), .c(new_n93_), .O(new_n178_));
  oai21  g134(.a(new_n178_), .b(new_n177_), .c(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n102_), .O(new_n180_));
  aoi21  g136(.a(new_n168_), .b(new_n166_), .c(new_n133_), .O(new_n181_));
  inv1   g137(.a(new_n171_), .O(new_n182_));
  nand4  g138(.a(new_n157_), .b(x31), .c(x30), .d(x29), .O(new_n183_));
  nand3  g139(.a(new_n123_), .b(new_n94_), .c(new_n104_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  oai21  g141(.a(new_n182_), .b(new_n181_), .c(new_n185_), .O(new_n186_));
  inv1   g142(.a(new_n136_), .O(new_n187_));
  inv1   g143(.a(new_n143_), .O(new_n188_));
  nand2  g144(.a(new_n123_), .b(x29), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n158_), .c(new_n122_), .O(new_n190_));
  nor3   g146(.a(new_n190_), .b(new_n148_), .c(new_n146_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n145_), .c(new_n188_), .d(new_n142_), .O(new_n192_));
