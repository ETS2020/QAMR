...
module FAU ( 
  ...
  oai21  g058(.a(new_n102_), .b(new_n59_), .c(new_n47_), .O(z4));
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n61_), .d(new_n81_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n80_), .c(new_n59_), .O(z5));
  nand3  g065(.a(x29), .b(x28), .c(x27), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n93_), .c(new_n61_), .d(x30), .O(new_n111_));
  ...
  oai21  g089(.a(new_n130_), .b(new_n133_), .c(new_n84_), .O(new_n134_));
  ...
  nand3  g110(.a(x19), .b(new_n87_), .c(x13), .O(new_n155_));
  nand3  g111(.a(new_n90_), .b(x18), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n84_), .O(new_n157_));
  nand4  g113(.a(x19), .b(x18), .c(new_n84_), .d(x12), .O(new_n158_));
  ...
  oai21  g140(.a(new_n184_), .b(new_n140_), .c(new_n90_), .O(new_n185_));
  oai21  g141(.a(new_n184_), .b(new_n126_), .c(new_n125_), .O(new_n186_));
  aoi21  g142(.a(new_n183_), .b(x11), .c(x16), .O(new_n187_));
  oai21  g143(.a(new_n87_), .b(new_n133_), .c(new_n84_), .O(new_n188_));
  inv1   g144(.a(x13), .O(new_n189_));
  nand2  g145(.a(new_n87_), .b(new_n189_), .O(new_n190_));
