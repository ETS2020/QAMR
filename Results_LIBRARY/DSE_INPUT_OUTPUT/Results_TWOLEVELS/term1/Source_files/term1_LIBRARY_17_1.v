...
module FAU ( 
  ...
  nand4  g054(.a(new_n98_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n99_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n61_), .d(new_n45_), .O(new_n116_));
  ...
  oai21  g084(.a(new_n128_), .b(new_n126_), .c(new_n45_), .O(new_n129_));
