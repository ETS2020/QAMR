...
module FAU ( 
  ...
  nand4  g067(.a(new_n111_), .b(new_n94_), .c(new_n60_), .d(new_n80_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n79_), .c(new_n58_), .O(z6));
  inv1   g069(.a(x31), .O(new_n114_));
  nor2   g070(.a(new_n109_), .b(new_n100_), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n102_), .c(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n117_));
  nor2   g073(.a(new_n59_), .b(new_n58_), .O(new_n118_));
  nand3  g074(.a(new_n114_), .b(x30), .c(x29), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  aoi21  g076(.a(new_n120_), .b(new_n102_), .c(new_n79_), .O(new_n121_));
  nand3  g077(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  oai21  g078(.a(new_n122_), .b(new_n116_), .c(new_n80_), .O(new_n123_));
  oai21  g079(.a(new_n80_), .b(new_n45_), .c(new_n123_), .O(z7));
  inv1   g080(.a(x32), .O(new_n125_));
  nor2   g081(.a(x28), .b(x27), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n109_), .c(x29), .O(new_n128_));
  nor2   g084(.a(new_n126_), .b(new_n100_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n109_), .c(new_n128_), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n88_), .c(x13), .O(new_n131_));
  nand3  g087(.a(new_n91_), .b(x18), .c(x14), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n85_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n134_));
  ...
  nand4  g103(.a(new_n147_), .b(new_n130_), .c(new_n125_), .d(x31), .O(new_n148_));
  nand2  g104(.a(new_n115_), .b(x27), .O(new_n149_));
  ...
  oai21  g112(.a(new_n138_), .b(new_n156_), .c(new_n85_), .O(new_n157_));
  ...
  aoi21  g119(.a(new_n115_), .b(x28), .c(new_n163_), .O(new_n164_));
  ...
  nand4  g133(.a(new_n147_), .b(new_n172_), .c(new_n114_), .d(new_n109_), .O(new_n178_));
  ...
  oai21  g145(.a(new_n88_), .b(new_n156_), .c(new_n85_), .O(new_n190_));
  nand2  g146(.a(new_n88_), .b(new_n158_), .O(new_n191_));
