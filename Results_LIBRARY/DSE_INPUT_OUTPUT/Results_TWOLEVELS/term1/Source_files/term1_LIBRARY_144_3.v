...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n63_), .c(new_n58_), .O(z3));
  ...
  nand2  g074(.a(new_n118_), .b(new_n58_), .O(z6));
  inv1   g075(.a(x31), .O(new_n120_));
  nor2   g076(.a(new_n113_), .b(new_n104_), .O(new_n121_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n106_), .c(new_n98_), .O(new_n128_));
  ...
  nand2  g109(.a(new_n121_), .b(x27), .O(new_n154_));
  ...
  nand2  g120(.a(new_n164_), .b(new_n87_), .O(new_n165_));
  nor2   g121(.a(x19), .b(x14), .O(new_n166_));
  nor2   g122(.a(new_n144_), .b(new_n150_), .O(new_n167_));
  aoi21  g123(.a(new_n167_), .b(new_n146_), .c(new_n166_), .O(new_n168_));
  oai21  g124(.a(x30), .b(x29), .c(x31), .O(new_n169_));
  aoi21  g125(.a(new_n121_), .b(x28), .c(new_n169_), .O(new_n170_));
  ...
  nand4  g134(.a(new_n152_), .b(new_n178_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n120_), .O(new_n180_));
  ...
  nand4  g139(.a(new_n152_), .b(new_n178_), .c(new_n120_), .d(new_n113_), .O(new_n184_));
  ...
  and2   g144(.a(new_n188_), .b(new_n168_), .O(new_n189_));
  ...
  aoi21  g149(.a(new_n193_), .b(new_n182_), .c(new_n45_), .O(z9));
endmodule
