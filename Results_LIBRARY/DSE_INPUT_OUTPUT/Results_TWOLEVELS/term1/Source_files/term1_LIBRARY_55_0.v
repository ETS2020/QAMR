...
module FAU ( 
  ...
  nand3  g053(.a(x30), .b(new_n45_), .c(new_n97_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n96_), .c(new_n61_), .O(new_n99_));
  ...
  nand3  g066(.a(new_n104_), .b(new_n46_), .c(x29), .O(new_n111_));
  oai21  g067(.a(new_n46_), .b(x29), .c(new_n111_), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n95_), .O(new_n113_));
  nand2  g069(.a(x30), .b(new_n103_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(new_n105_), .c(x27), .O(new_n115_));
  nand3  g071(.a(new_n115_), .b(new_n45_), .c(new_n97_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n113_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n62_), .O(new_n118_));
  aoi22  g074(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n95_), .c(x30), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n118_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n81_), .c(x25), .d(x01), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n47_), .O(z6));
  oai21  g079(.a(x31), .b(new_n45_), .c(new_n46_), .O(new_n124_));
  ...
  nand4  g084(.a(new_n128_), .b(new_n127_), .c(new_n86_), .d(new_n84_), .O(new_n129_));
  ...
  nand4  g090(.a(new_n134_), .b(new_n129_), .c(new_n126_), .d(new_n124_), .O(z7));
  ...
  oai21  g100(.a(new_n141_), .b(new_n144_), .c(new_n97_), .O(new_n145_));
  aoi21  g101(.a(x19), .b(x13), .c(x18), .O(new_n146_));
  nor2   g102(.a(x19), .b(x14), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n145_), .c(new_n143_), .d(new_n139_), .O(new_n149_));
  oai21  g105(.a(x30), .b(x22), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(x16), .b(x15), .O(new_n151_));
  oai21  g107(.a(new_n151_), .b(new_n138_), .c(x31), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n47_), .O(new_n153_));
  nor2   g109(.a(x28), .b(x27), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(new_n102_), .O(new_n155_));
  inv1   g111(.a(new_n155_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n46_), .c(x22), .O(new_n157_));
  nand2  g113(.a(new_n103_), .b(new_n82_), .O(new_n158_));
  ...
  nand4  g119(.a(new_n163_), .b(new_n46_), .c(x29), .d(x22), .O(new_n164_));
  oai21  g120(.a(new_n155_), .b(new_n46_), .c(new_n164_), .O(new_n165_));
  ...
  aoi21  g125(.a(new_n169_), .b(new_n167_), .c(new_n97_), .O(new_n170_));
  nand4  g126(.a(x19), .b(x18), .c(new_n97_), .d(x12), .O(new_n171_));
  ...
  nand4  g144(.a(new_n179_), .b(new_n184_), .c(new_n131_), .d(new_n46_), .O(new_n189_));
  ...
  oai21  g152(.a(new_n195_), .b(new_n137_), .c(new_n136_), .O(new_n197_));
  inv1   g153(.a(x11), .O(new_n198_));
  oai21  g154(.a(new_n195_), .b(new_n198_), .c(new_n140_), .O(new_n199_));
  oai21  g155(.a(new_n166_), .b(new_n144_), .c(new_n97_), .O(new_n200_));
