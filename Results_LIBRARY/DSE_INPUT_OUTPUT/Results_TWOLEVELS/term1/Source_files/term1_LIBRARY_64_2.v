...
module FAU ( 
  ...
  aoi21  g099(.a(new_n99_), .b(new_n82_), .c(new_n45_), .O(new_n144_));
  aoi21  g100(.a(x29), .b(x28), .c(x30), .O(new_n145_));
  aoi22  g101(.a(new_n145_), .b(new_n82_), .c(new_n144_), .d(x29), .O(new_n146_));
  ...
  oai21  g107(.a(new_n151_), .b(new_n100_), .c(new_n82_), .O(new_n152_));
  ...
  oai21  g130(.a(new_n174_), .b(new_n139_), .c(new_n91_), .O(new_n175_));
  oai21  g131(.a(new_n174_), .b(new_n126_), .c(new_n164_), .O(new_n176_));
  inv1   g132(.a(x11), .O(new_n177_));
  oai21  g133(.a(new_n174_), .b(new_n177_), .c(new_n130_), .O(new_n178_));
  nand2  g134(.a(x18), .b(x12), .O(new_n179_));
  aoi22  g135(.a(new_n179_), .b(new_n85_), .c(new_n88_), .d(new_n136_), .O(new_n180_));
  ...
  oai21  g139(.a(new_n45_), .b(new_n99_), .c(x31), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n117_), .O(new_n185_));
  ...
  nand4  g146(.a(new_n120_), .b(new_n116_), .c(new_n45_), .d(new_n82_), .O(new_n191_));
  nand2  g147(.a(new_n99_), .b(new_n82_), .O(new_n192_));
