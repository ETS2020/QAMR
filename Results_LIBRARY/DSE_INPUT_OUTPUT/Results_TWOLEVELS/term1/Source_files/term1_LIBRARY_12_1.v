...
module FAU ( 
  ...
  aoi21  g046(.a(new_n90_), .b(new_n79_), .c(x26), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(new_n89_), .c(new_n79_), .O(new_n93_));
  ...
  aoi21  g058(.a(new_n102_), .b(new_n79_), .c(x26), .O(z5));
  nand3  g059(.a(new_n89_), .b(x29), .c(x28), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(x27), .c(x25), .d(x01), .O(new_n106_));
  ...
  nor3   g065(.a(new_n109_), .b(new_n86_), .c(new_n85_), .O(new_n110_));
  inv1   g066(.a(x31), .O(new_n111_));
  nand4  g067(.a(new_n60_), .b(new_n111_), .c(x25), .d(x01), .O(new_n112_));
  oai21  g068(.a(new_n112_), .b(new_n110_), .c(new_n79_), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n45_), .O(z7));
  inv1   g070(.a(x32), .O(new_n115_));
  nand2  g071(.a(new_n97_), .b(new_n80_), .O(new_n116_));
  ...
  oai21  g107(.a(new_n135_), .b(new_n99_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x00), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n79_), .c(x26), .O(z8));
  inv1   g110(.a(x33), .O(new_n155_));
  nand2  g111(.a(new_n116_), .b(x29), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n134_), .c(new_n155_), .d(new_n111_), .O(new_n157_));
  ...
  nand2  g126(.a(new_n170_), .b(new_n157_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n79_), .c(new_n45_), .d(x00), .O(new_n172_));
