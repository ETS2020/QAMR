...
module FAU ( 
  ...
  nor2   g000(.a(x29), .b(x25), .O(new_n45_));
  ...
  oai21  g083(.a(x28), .b(x27), .c(new_n110_), .O(new_n128_));
  nor2   g084(.a(x28), .b(x27), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n101_), .c(x30), .O(new_n130_));
  oai21  g086(.a(new_n128_), .b(new_n101_), .c(new_n130_), .O(new_n131_));
  ...
  nor2   g117(.a(new_n161_), .b(new_n139_), .O(new_n162_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n161_), .c(new_n89_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n151_), .c(new_n144_), .O(new_n178_));
  ...
  nand2  g140(.a(x30), .b(new_n101_), .O(new_n185_));
  nand2  g141(.a(x31), .b(new_n110_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n185_), .c(new_n79_), .O(new_n187_));
  nand2  g143(.a(new_n122_), .b(x30), .O(new_n188_));
  nand3  g144(.a(x31), .b(new_n102_), .c(new_n81_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n128_), .c(new_n188_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(x29), .c(new_n187_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n184_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x33), .O(new_n193_));
  aoi21  g149(.a(new_n141_), .b(new_n137_), .c(new_n144_), .O(new_n194_));
  inv1   g150(.a(new_n145_), .O(new_n195_));
  nor3   g151(.a(new_n129_), .b(new_n122_), .c(new_n110_), .O(new_n196_));
  nand3  g152(.a(new_n129_), .b(new_n122_), .c(new_n110_), .O(new_n197_));
  inv1   g153(.a(new_n197_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n196_), .c(x29), .O(new_n199_));
  nand4  g155(.a(new_n122_), .b(new_n110_), .c(new_n101_), .d(x25), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n199_), .O(new_n201_));
  oai21  g157(.a(new_n195_), .b(new_n194_), .c(new_n201_), .O(new_n202_));
