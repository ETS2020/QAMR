...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(x30), .c(new_n80_), .O(new_n94_));
  ...
  oai21  g055(.a(new_n99_), .b(new_n58_), .c(new_n56_), .O(z4));
  ...
  nand2  g062(.a(new_n106_), .b(new_n80_), .O(new_n107_));
  oai21  g063(.a(new_n103_), .b(new_n80_), .c(new_n107_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n102_), .c(new_n60_), .d(new_n79_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n101_), .c(new_n58_), .O(z5));
  nand2  g066(.a(x29), .b(x28), .O(new_n111_));
  oai21  g067(.a(new_n111_), .b(new_n80_), .c(x30), .O(new_n112_));
  inv1   g068(.a(x28), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n80_), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand2  g071(.a(new_n105_), .b(x29), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n112_), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n102_), .c(new_n60_), .d(new_n79_), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n101_), .c(new_n58_), .O(z6));
  oai21  g075(.a(x31), .b(new_n105_), .c(new_n80_), .O(new_n120_));
  nand2  g076(.a(new_n106_), .b(x28), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x31), .O(new_n122_));
  inv1   g078(.a(new_n81_), .O(new_n123_));
  nand4  g079(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n123_), .O(new_n124_));
  nor2   g080(.a(new_n59_), .b(new_n58_), .O(new_n125_));
  inv1   g081(.a(x31), .O(new_n126_));
  nand4  g082(.a(new_n114_), .b(new_n126_), .c(x30), .d(x29), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n125_), .c(new_n79_), .d(x25), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n124_), .c(new_n122_), .d(new_n120_), .O(z7));
  ...
  oai21  g095(.a(new_n136_), .b(new_n139_), .c(new_n82_), .O(new_n140_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n56_), .O(new_n148_));
  nand2  g104(.a(new_n106_), .b(new_n113_), .O(new_n149_));
  oai21  g105(.a(x30), .b(x29), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x27), .O(new_n151_));
  nand4  g107(.a(new_n151_), .b(new_n148_), .c(new_n145_), .d(new_n121_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x32), .O(new_n153_));
  inv1   g109(.a(x32), .O(new_n154_));
  aoi21  g110(.a(new_n113_), .b(new_n80_), .c(new_n104_), .O(new_n155_));
  oai22  g111(.a(new_n155_), .b(new_n105_), .c(new_n116_), .d(new_n80_), .O(new_n156_));
  nand3  g112(.a(x19), .b(new_n85_), .c(x13), .O(new_n157_));
  nand3  g113(.a(new_n88_), .b(x18), .c(x14), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n157_), .c(new_n82_), .O(new_n159_));
  nand4  g115(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n160_));
  ...
  nand2  g128(.a(new_n88_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x18), .c(x17), .d(x16), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n131_), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n146_), .c(new_n88_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n132_), .c(new_n131_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n135_), .O(new_n180_));
  aoi21  g136(.a(x18), .b(x12), .c(x17), .O(new_n181_));
  nor2   g137(.a(x18), .b(x13), .O(new_n182_));
  nor2   g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n175_), .c(new_n56_), .O(new_n185_));
  aoi21  g141(.a(new_n126_), .b(new_n104_), .c(x30), .O(new_n186_));
  nand2  g142(.a(new_n113_), .b(new_n80_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(x31), .c(x29), .O(new_n188_));
  aoi22  g144(.a(new_n188_), .b(x30), .c(new_n186_), .d(x27), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n185_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(x33), .O(new_n191_));
  aoi21  g147(.a(new_n164_), .b(new_n162_), .c(new_n131_), .O(new_n192_));
  inv1   g148(.a(new_n167_), .O(new_n193_));
  nand2  g149(.a(x31), .b(x30), .O(new_n194_));
  nand3  g150(.a(x31), .b(x30), .c(x29), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nor3   g152(.a(x31), .b(x30), .c(x29), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(new_n196_), .c(x27), .O(new_n198_));
  oai21  g154(.a(new_n194_), .b(new_n111_), .c(new_n198_), .O(new_n199_));
  oai21  g155(.a(new_n193_), .b(new_n192_), .c(new_n199_), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(x33), .c(new_n191_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n79_), .c(x00), .O(new_n202_));
