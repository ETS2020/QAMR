...
module FAU ( 
  ...
  nand2  g109(.a(new_n117_), .b(x27), .O(new_n154_));
  ...
  nand2  g123(.a(new_n85_), .b(new_n167_), .O(new_n168_));
  nand2  g124(.a(new_n117_), .b(x28), .O(new_n169_));
  aoi21  g125(.a(new_n110_), .b(new_n101_), .c(new_n124_), .O(new_n170_));
  ...
  nand4  g133(.a(new_n149_), .b(new_n45_), .c(x31), .d(x30), .O(new_n178_));
  ...
  nand4  g138(.a(new_n149_), .b(new_n45_), .c(new_n124_), .d(new_n110_), .O(new_n183_));
  ...
  nand3  g143(.a(new_n187_), .b(new_n168_), .c(new_n166_), .O(new_n188_));
  inv1   g144(.a(new_n188_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n163_), .c(new_n161_), .d(new_n159_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n153_), .c(x33), .O(new_n191_));
