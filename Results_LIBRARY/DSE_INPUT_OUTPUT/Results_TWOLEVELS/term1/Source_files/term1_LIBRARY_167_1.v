...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n59_), .c(new_n47_), .O(z3));
  ...
  nand3  g056(.a(new_n100_), .b(new_n94_), .c(new_n80_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n97_), .c(new_n59_), .O(z4));
  inv1   g058(.a(new_n93_), .O(new_n103_));
  xnor2a g059(.a(x29), .b(x27), .O(new_n104_));
  nand3  g060(.a(new_n98_), .b(x29), .c(new_n45_), .O(new_n105_));
  oai21  g061(.a(new_n104_), .b(new_n45_), .c(new_n105_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n103_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n97_), .c(new_n59_), .O(z5));
  ...
  nand4  g068(.a(new_n112_), .b(new_n103_), .c(new_n61_), .d(new_n80_), .O(new_n113_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n81_), .c(x31), .O(new_n122_));
  inv1   g078(.a(new_n82_), .O(new_n123_));
  nand4  g079(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n123_), .O(new_n124_));
  ...
  aoi21  g110(.a(new_n154_), .b(new_n145_), .c(x15), .O(new_n155_));
  ...
  oai21  g115(.a(new_n156_), .b(new_n159_), .c(new_n83_), .O(new_n160_));
  inv1   g116(.a(x13), .O(new_n161_));
  oai21  g117(.a(new_n89_), .b(new_n161_), .c(new_n86_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x15), .O(new_n163_));
  oai22  g119(.a(new_n163_), .b(new_n144_), .c(x19), .d(x14), .O(new_n164_));
  nand2  g120(.a(new_n98_), .b(new_n134_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n121_), .c(x31), .O(new_n166_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n130_), .O(z8));
  nand2  g128(.a(new_n89_), .b(x14), .O(new_n173_));
  ...
  oai21  g132(.a(new_n176_), .b(new_n163_), .c(new_n89_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n153_), .c(new_n149_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n143_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n83_), .c(new_n86_), .d(new_n161_), .O(new_n182_));
  ...
  oai21  g140(.a(x31), .b(new_n134_), .c(new_n135_), .O(new_n185_));
  aoi21  g141(.a(new_n109_), .b(new_n117_), .c(x30), .O(new_n186_));
  aoi21  g142(.a(new_n185_), .b(x28), .c(new_n186_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n184_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  aoi21  g145(.a(new_n146_), .b(new_n142_), .c(new_n149_), .O(new_n190_));
  inv1   g146(.a(new_n150_), .O(new_n191_));
  nand2  g147(.a(new_n132_), .b(x29), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n117_), .c(new_n98_), .O(new_n193_));
  nand4  g149(.a(x31), .b(x30), .c(x29), .d(x28), .O(new_n194_));
