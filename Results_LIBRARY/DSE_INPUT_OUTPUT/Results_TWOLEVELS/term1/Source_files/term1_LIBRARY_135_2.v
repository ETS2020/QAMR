...
module FAU ( 
  ...
  nand4  g045(.a(new_n89_), .b(new_n45_), .c(new_n80_), .d(x25), .O(new_n90_));
  ...
  nor2   g050(.a(new_n94_), .b(x28), .O(new_n95_));
  nand2  g051(.a(new_n95_), .b(x27), .O(new_n96_));
  oai21  g052(.a(new_n93_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n89_), .c(new_n80_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n92_), .c(new_n59_), .O(z4));
  ...
  oai21  g059(.a(new_n103_), .b(new_n100_), .c(new_n101_), .O(new_n104_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n88_), .c(new_n61_), .d(x30), .O(new_n110_));
  ...
  oai21  g099(.a(new_n143_), .b(new_n127_), .c(new_n57_), .O(new_n144_));
  nand3  g100(.a(new_n117_), .b(new_n94_), .c(new_n45_), .O(new_n145_));
  nand2  g101(.a(new_n93_), .b(new_n45_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x30), .c(x29), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n145_), .c(new_n144_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  nand3  g106(.a(new_n94_), .b(x29), .c(x28), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n95_), .c(new_n45_), .O(new_n153_));
  ...
  nand4  g128(.a(new_n146_), .b(x31), .c(x30), .d(x29), .O(new_n173_));
  nand3  g129(.a(new_n117_), .b(new_n119_), .c(new_n94_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n167_), .c(new_n172_), .O(new_n176_));
  aoi21  g132(.a(x31), .b(x29), .c(new_n94_), .O(new_n177_));
  inv1   g133(.a(new_n127_), .O(new_n178_));
  nand2  g134(.a(new_n146_), .b(x30), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x31), .O(new_n180_));
  nand2  g136(.a(new_n139_), .b(new_n138_), .O(new_n181_));
  nand3  g137(.a(new_n126_), .b(x16), .c(x15), .O(new_n182_));
  nand3  g138(.a(new_n119_), .b(x29), .c(x28), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n182_), .c(new_n181_), .d(new_n137_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n133_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n180_), .c(new_n131_), .d(new_n178_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n177_), .c(x33), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n176_), .O(new_n188_));
