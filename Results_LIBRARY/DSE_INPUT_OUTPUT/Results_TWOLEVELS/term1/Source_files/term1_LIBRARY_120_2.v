...
module FAU ( 
  ...
  aoi21  g018(.a(new_n62_), .b(new_n60_), .c(z9), .O(new_n63_));
  ...
  aoi21  g027(.a(new_n71_), .b(new_n70_), .c(z9), .O(new_n72_));
  ...
  aoi21  g043(.a(new_n87_), .b(new_n82_), .c(z9), .O(new_n88_));
  ...
  nor2   g057(.a(x20), .b(x15), .O(new_n102_));
  nor2   g058(.a(x21), .b(x16), .O(new_n103_));
  nor2   g059(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  or2    g060(.a(x22), .b(x17), .O(new_n105_));
  or2    g061(.a(x23), .b(x18), .O(new_n106_));
  or2    g062(.a(x24), .b(x19), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n104_), .O(new_n108_));
  and2   g064(.a(new_n108_), .b(new_n83_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n101_), .c(new_n100_), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(x25), .c(x01), .d(new_n45_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z3));
  xor2a  g069(.a(x28), .b(x27), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n109_), .c(x25), .d(x01), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g072(.a(x29), .O(new_n117_));
  inv1   g073(.a(x28), .O(new_n118_));
  nor2   g074(.a(new_n118_), .b(new_n101_), .O(new_n119_));
  nand3  g075(.a(new_n117_), .b(x28), .c(x27), .O(new_n120_));
  oai21  g076(.a(new_n119_), .b(new_n117_), .c(new_n120_), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n108_), .c(new_n83_), .d(new_n100_), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(x25), .c(x01), .d(new_n45_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(z5));
  inv1   g081(.a(x30), .O(new_n126_));
  aoi21  g082(.a(new_n117_), .b(new_n45_), .c(new_n101_), .O(new_n127_));
  nand3  g083(.a(new_n119_), .b(new_n126_), .c(x29), .O(new_n128_));
  oai21  g084(.a(new_n127_), .b(new_n126_), .c(new_n128_), .O(new_n129_));
  nand3  g085(.a(new_n129_), .b(new_n108_), .c(new_n83_), .O(new_n130_));
  oai21  g086(.a(x03), .b(x00), .c(x02), .O(new_n131_));
  nand4  g087(.a(new_n131_), .b(new_n108_), .c(x30), .d(new_n118_), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(new_n130_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(x25), .c(x01), .O(new_n134_));
  aoi21  g090(.a(new_n134_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g091(.a(new_n119_), .b(x30), .c(x29), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x31), .O(new_n137_));
  nand4  g093(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n104_), .O(new_n138_));
  nand3  g094(.a(new_n83_), .b(x25), .c(x01), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  inv1   g096(.a(new_n119_), .O(new_n141_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n140_), .c(new_n138_), .d(new_n137_), .O(z7));
  zero   g102(.O(z8));
endmodule
