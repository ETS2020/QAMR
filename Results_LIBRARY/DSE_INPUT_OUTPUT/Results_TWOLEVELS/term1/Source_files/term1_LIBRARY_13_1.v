...
module FAU ( 
  ...
  oai21  g043(.a(new_n87_), .b(new_n58_), .c(new_n47_), .O(z3));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n86_), .c(new_n47_), .O(new_n90_));
  ...
  and2   g051(.a(x28), .b(x27), .O(new_n96_));
  nand3  g052(.a(new_n95_), .b(x28), .c(x27), .O(new_n97_));
  oai21  g053(.a(new_n96_), .b(new_n95_), .c(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n94_), .c(new_n60_), .d(new_n79_), .O(new_n99_));
  ...
  oai22  g061(.a(new_n105_), .b(new_n103_), .c(new_n46_), .d(x28), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x27), .O(new_n107_));
  oai21  g063(.a(new_n95_), .b(new_n80_), .c(x30), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n107_), .c(new_n85_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n60_), .c(new_n79_), .d(x25), .O(new_n110_));
  nor2   g066(.a(new_n110_), .b(new_n58_), .O(z6));
  oai21  g067(.a(x32), .b(x31), .c(new_n46_), .O(new_n112_));
  oai21  g068(.a(new_n103_), .b(new_n80_), .c(x31), .O(new_n113_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n117_), .c(new_n113_), .d(new_n112_), .O(z7));
  nor2   g079(.a(x28), .b(x27), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n46_), .c(x29), .O(new_n126_));
  nor2   g082(.a(new_n124_), .b(new_n95_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n46_), .c(new_n126_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(new_n104_), .d(x31), .O(new_n147_));
  ...
  nor2   g106(.a(new_n132_), .b(new_n130_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(x17), .c(x11), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n138_), .O(new_n153_));
  aoi21  g109(.a(new_n151_), .b(x12), .c(x17), .O(new_n154_));
  aoi21  g110(.a(x19), .b(x13), .c(x18), .O(new_n155_));
  nor2   g111(.a(x19), .b(x14), .O(new_n156_));
  nand2  g112(.a(x16), .b(x15), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n139_), .c(x31), .O(new_n158_));
  nor4   g114(.a(new_n158_), .b(new_n156_), .c(new_n155_), .d(new_n154_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n153_), .c(new_n150_), .d(new_n148_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(x32), .c(x30), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n147_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(new_n79_), .c(x00), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(z8));
  inv1   g120(.a(x33), .O(new_n165_));
  nand4  g121(.a(new_n146_), .b(new_n165_), .c(x31), .d(x30), .O(new_n166_));
  nand2  g122(.a(x33), .b(new_n46_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n166_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n125_), .c(x29), .O(new_n169_));
  inv1   g125(.a(new_n127_), .O(new_n170_));
  nand4  g126(.a(new_n146_), .b(new_n165_), .c(new_n119_), .d(new_n46_), .O(new_n171_));
  ...
  aoi21  g130(.a(new_n132_), .b(x14), .c(new_n130_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(x17), .c(x16), .d(x15), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n157_), .c(new_n132_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n149_), .c(new_n144_), .O(new_n179_));
  nand2  g135(.a(new_n119_), .b(x30), .O(new_n180_));
  inv1   g136(.a(x11), .O(new_n181_));
  oai21  g137(.a(new_n177_), .b(new_n181_), .c(new_n138_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n129_), .O(new_n184_));
  inv1   g140(.a(x13), .O(new_n185_));
  nand2  g141(.a(new_n130_), .b(new_n185_), .O(new_n186_));
  ...
  nand3  g146(.a(new_n190_), .b(new_n174_), .c(new_n169_), .O(new_n191_));
  nand3  g147(.a(new_n191_), .b(new_n79_), .c(x00), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n47_), .O(z9));
endmodule
