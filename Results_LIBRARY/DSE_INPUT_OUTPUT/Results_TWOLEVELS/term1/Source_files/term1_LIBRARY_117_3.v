...
module FAU ( 
  ...
  nand2  g052(.a(x28), .b(new_n45_), .O(new_n97_));
  inv1   g053(.a(x28), .O(new_n98_));
  nand2  g054(.a(new_n46_), .b(new_n98_), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n45_), .c(new_n97_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n93_), .c(new_n80_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n96_), .c(new_n60_), .O(z4));
  inv1   g058(.a(x29), .O(new_n103_));
  aoi21  g059(.a(new_n46_), .b(new_n98_), .c(new_n45_), .O(new_n104_));
  nand2  g060(.a(x28), .b(x27), .O(new_n105_));
  nand2  g061(.a(new_n46_), .b(new_n103_), .O(new_n106_));
  oai22  g062(.a(new_n106_), .b(new_n105_), .c(new_n104_), .d(new_n103_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n92_), .c(new_n61_), .d(new_n80_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n96_), .c(new_n60_), .O(z5));
  nand2  g065(.a(new_n46_), .b(x29), .O(new_n110_));
  oai22  g066(.a(new_n110_), .b(new_n105_), .c(new_n46_), .d(x27), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n93_), .c(new_n80_), .O(new_n112_));
  nor3   g068(.a(new_n112_), .b(new_n96_), .c(new_n60_), .O(z6));
  ...
  oai21  g082(.a(new_n123_), .b(new_n126_), .c(new_n84_), .O(new_n127_));
  inv1   g083(.a(x13), .O(new_n128_));
  inv1   g084(.a(x19), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n128_), .c(new_n87_), .O(new_n130_));
  ...
  nand4  g122(.a(x33), .b(x29), .c(new_n80_), .d(x00), .O(new_n167_));
  ...
  nor2   g136(.a(new_n87_), .b(new_n84_), .O(new_n181_));
  ...
  oai21  g141(.a(new_n87_), .b(new_n126_), .c(new_n84_), .O(new_n186_));
  nand2  g142(.a(new_n87_), .b(new_n128_), .O(new_n187_));
