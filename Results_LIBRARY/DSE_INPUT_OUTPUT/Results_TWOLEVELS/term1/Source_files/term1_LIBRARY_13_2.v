...
module FAU ( 
  ...
  nand2  g032(.a(new_n76_), .b(new_n54_), .O(z2));
  ...
  oai21  g042(.a(new_n86_), .b(new_n57_), .c(new_n54_), .O(z3));
  inv1   g043(.a(x25), .O(new_n88_));
  inv1   g044(.a(new_n84_), .O(new_n89_));
  inv1   g045(.a(x28), .O(new_n90_));
  nand3  g046(.a(new_n54_), .b(new_n90_), .c(x27), .O(new_n91_));
  nand2  g047(.a(z0), .b(x30), .O(new_n92_));
  nand3  g048(.a(new_n92_), .b(x28), .c(new_n79_), .O(new_n93_));
  nand2  g049(.a(new_n93_), .b(new_n91_), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n89_), .c(new_n59_), .d(new_n78_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n88_), .c(new_n57_), .O(z4));
  inv1   g052(.a(x29), .O(new_n97_));
  nor2   g053(.a(new_n90_), .b(new_n79_), .O(new_n98_));
  nand3  g054(.a(new_n97_), .b(x28), .c(x27), .O(new_n99_));
  oai21  g055(.a(new_n98_), .b(new_n97_), .c(new_n99_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n89_), .c(new_n59_), .d(new_n78_), .O(new_n101_));
  inv1   g057(.a(new_n101_), .O(new_n102_));
  nand3  g058(.a(new_n102_), .b(x25), .c(x01), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(new_n54_), .O(z5));
  nand2  g060(.a(x32), .b(x30), .O(new_n105_));
  inv1   g061(.a(x30), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(x29), .c(x27), .O(new_n107_));
  oai21  g063(.a(new_n105_), .b(x27), .c(new_n107_), .O(new_n108_));
  aoi21  g064(.a(x29), .b(x28), .c(z0), .O(new_n109_));
  aoi22  g065(.a(new_n109_), .b(x30), .c(new_n108_), .d(x28), .O(new_n110_));
  ...
  nand2  g082(.a(new_n90_), .b(new_n79_), .O(new_n127_));
  ...
  nand4  g128(.a(new_n145_), .b(new_n167_), .c(new_n114_), .d(new_n106_), .O(new_n173_));
