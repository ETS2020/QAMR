...
module FAU ( 
  ...
  nand3  g046(.a(new_n90_), .b(new_n81_), .c(new_n45_), .O(new_n91_));
  ...
  nor2   g055(.a(new_n99_), .b(new_n45_), .O(new_n100_));
  ...
  nor2   g064(.a(x30), .b(new_n98_), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n100_), .O(new_n110_));
  oai21  g066(.a(new_n108_), .b(new_n81_), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n112_));
  ...
  aoi22  g077(.a(new_n121_), .b(x27), .c(x31), .d(new_n81_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n118_), .O(z7));
  nand2  g079(.a(x16), .b(x10), .O(new_n124_));
  nand3  g080(.a(x19), .b(x18), .c(x17), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n124_), .O(new_n126_));
  nor2   g082(.a(new_n126_), .b(x15), .O(new_n127_));
  ...
  nand4  g098(.a(new_n142_), .b(new_n138_), .c(new_n134_), .d(new_n131_), .O(new_n143_));
  oai21  g099(.a(new_n143_), .b(new_n127_), .c(new_n46_), .O(new_n144_));
  oai21  g100(.a(x28), .b(x27), .c(x29), .O(new_n145_));
  nor2   g101(.a(new_n81_), .b(new_n98_), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(x27), .c(new_n145_), .d(new_n81_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n144_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x32), .O(new_n149_));
  inv1   g105(.a(x32), .O(new_n150_));
  inv1   g106(.a(new_n109_), .O(new_n151_));
  nand2  g107(.a(x30), .b(new_n98_), .O(new_n152_));
  and2   g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  oai22  g109(.a(new_n153_), .b(new_n45_), .c(new_n151_), .d(new_n99_), .O(new_n154_));
  nand3  g110(.a(x19), .b(new_n136_), .c(x13), .O(new_n155_));
  nand3  g111(.a(new_n137_), .b(x18), .c(x14), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n133_), .O(new_n157_));
  ...
  nand3  g121(.a(x16), .b(new_n165_), .c(x10), .O(new_n166_));
  ...
  nand4  g125(.a(new_n169_), .b(new_n154_), .c(new_n150_), .d(x31), .O(new_n170_));
  ...
  nand2  g129(.a(new_n137_), .b(x14), .O(new_n174_));
  nand4  g130(.a(new_n174_), .b(x18), .c(x17), .d(x16), .O(new_n175_));
  nor2   g131(.a(new_n175_), .b(new_n165_), .O(new_n176_));
  nand2  g132(.a(x18), .b(x17), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(new_n140_), .c(new_n137_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n124_), .c(new_n165_), .O(new_n179_));
  inv1   g135(.a(x11), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n180_), .c(new_n128_), .O(new_n181_));
  nand2  g137(.a(x18), .b(x12), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(new_n133_), .c(new_n136_), .d(new_n135_), .O(new_n183_));
  ...
  oai21  g141(.a(x31), .b(new_n98_), .c(new_n152_), .O(new_n186_));
  aoi21  g142(.a(new_n107_), .b(new_n119_), .c(x30), .O(new_n187_));
  aoi21  g143(.a(new_n186_), .b(x27), .c(new_n187_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n185_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  aoi21  g146(.a(new_n162_), .b(new_n160_), .c(new_n165_), .O(new_n191_));
  nand3  g147(.a(new_n145_), .b(new_n119_), .c(new_n81_), .O(new_n192_));
  nand4  g148(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  oai21  g150(.a(new_n167_), .b(new_n191_), .c(new_n194_), .O(new_n195_));
