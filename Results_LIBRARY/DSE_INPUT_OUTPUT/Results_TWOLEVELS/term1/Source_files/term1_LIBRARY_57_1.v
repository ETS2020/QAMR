...
module FAU ( 
  ...
  nand3  g056(.a(new_n45_), .b(x29), .c(new_n82_), .O(new_n101_));
  oai21  g057(.a(new_n100_), .b(new_n82_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n90_), .c(new_n62_), .d(new_n81_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n99_), .c(new_n60_), .O(z5));
  inv1   g060(.a(x28), .O(new_n105_));
  inv1   g061(.a(x29), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand4  g063(.a(new_n45_), .b(x29), .c(x28), .d(x27), .O(new_n108_));
  ...
  nand3  g079(.a(x32), .b(new_n45_), .c(new_n105_), .O(new_n124_));
  ...
  nor2   g086(.a(new_n45_), .b(x29), .O(new_n131_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n133_), .c(new_n127_), .d(x31), .O(new_n152_));
  nand2  g108(.a(x16), .b(x10), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n144_), .c(new_n149_), .O(new_n154_));
  ...
  oai21  g115(.a(new_n156_), .b(new_n159_), .c(new_n134_), .O(new_n160_));
  nand2  g116(.a(x19), .b(x13), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n135_), .O(new_n162_));
  nor2   g118(.a(x19), .b(x14), .O(new_n163_));
  nor2   g119(.a(new_n143_), .b(new_n149_), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n145_), .c(new_n163_), .O(new_n165_));
  nand2  g121(.a(new_n45_), .b(new_n106_), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(x31), .O(new_n167_));
  aoi21  g123(.a(x30), .b(x29), .c(new_n167_), .O(new_n168_));
  and2   g124(.a(new_n168_), .b(new_n165_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n162_), .c(new_n160_), .d(new_n158_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n155_), .c(x32), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n152_), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n81_), .c(x00), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n126_), .O(z8));
  inv1   g130(.a(x33), .O(new_n175_));
  aoi21  g131(.a(new_n45_), .b(new_n106_), .c(new_n128_), .O(new_n176_));
  nand3  g132(.a(x31), .b(x30), .c(x29), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(x31), .c(new_n177_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n151_), .c(new_n175_), .O(new_n179_));
  nand3  g135(.a(new_n129_), .b(new_n117_), .c(x29), .O(new_n180_));
  nor2   g136(.a(new_n131_), .b(new_n120_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n165_), .c(new_n162_), .d(new_n160_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n180_), .c(new_n158_), .d(new_n154_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n179_), .O(new_n186_));
