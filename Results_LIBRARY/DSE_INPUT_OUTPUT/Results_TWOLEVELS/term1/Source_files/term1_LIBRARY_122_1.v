...
module FAU ( 
  ...
  nor2   g066(.a(new_n45_), .b(new_n109_), .O(new_n111_));
  nand2  g067(.a(new_n110_), .b(x29), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n109_), .c(new_n111_), .d(new_n110_), .O(new_n113_));
  ...
  nand2  g072(.a(new_n116_), .b(new_n58_), .O(z6));
  ...
  oai21  g078(.a(new_n110_), .b(new_n109_), .c(x31), .O(new_n123_));
  inv1   g079(.a(x31), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(x30), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n122_), .c(new_n123_), .O(new_n126_));
  aoi22  g082(.a(new_n126_), .b(x27), .c(x31), .d(new_n45_), .O(new_n127_));
  ...
  aoi21  g117(.a(new_n110_), .b(new_n45_), .c(new_n124_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n161_), .O(new_n163_));
  aoi21  g119(.a(new_n159_), .b(new_n85_), .c(new_n163_), .O(new_n164_));
  ...
  nand4  g126(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n171_));
  nand2  g127(.a(new_n124_), .b(new_n110_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(x29), .c(new_n171_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n147_), .c(new_n170_), .O(new_n174_));
  aoi21  g130(.a(new_n159_), .b(new_n85_), .c(new_n160_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n151_), .c(new_n58_), .O(new_n177_));
  nand2  g133(.a(new_n125_), .b(new_n112_), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(x27), .c(new_n172_), .d(new_n45_), .O(new_n179_));
