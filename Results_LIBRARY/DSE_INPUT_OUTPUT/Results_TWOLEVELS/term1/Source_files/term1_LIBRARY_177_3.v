...
module FAU ( 
  ...
  nor3   g059(.a(new_n103_), .b(new_n81_), .c(new_n61_), .O(z4));
  ...
  nand4  g065(.a(new_n109_), .b(new_n95_), .c(new_n62_), .d(new_n82_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n81_), .c(new_n61_), .O(z5));
  nand2  g067(.a(new_n46_), .b(x29), .O(new_n112_));
  oai22  g068(.a(new_n112_), .b(new_n106_), .c(new_n46_), .d(x27), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n96_), .c(new_n82_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n81_), .c(new_n61_), .O(z6));
  ...
  oai21  g087(.a(new_n127_), .b(new_n131_), .c(new_n86_), .O(new_n132_));
  ...
  nand2  g092(.a(new_n92_), .b(new_n136_), .O(new_n137_));
