...
module FAU ( 
  ...
  nor3   g070(.a(new_n114_), .b(new_n81_), .c(new_n60_), .O(z6));
  nand2  g071(.a(new_n109_), .b(x31), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n104_), .b(new_n117_), .c(x29), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n116_), .c(new_n45_), .O(new_n119_));
  ...
  nor2   g078(.a(new_n117_), .b(x30), .O(new_n123_));
  nor2   g079(.a(new_n123_), .b(new_n81_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n122_), .c(new_n62_), .d(x01), .O(new_n125_));
  ...
  oai21  g116(.a(new_n141_), .b(new_n160_), .c(new_n84_), .O(new_n161_));
  ...
  nand4  g137(.a(new_n150_), .b(new_n176_), .c(new_n117_), .d(new_n111_), .O(new_n182_));
  ...
  nor2   g151(.a(x31), .b(new_n111_), .O(new_n196_));
  nor2   g152(.a(new_n196_), .b(new_n123_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n195_), .c(new_n194_), .d(new_n193_), .O(new_n198_));
