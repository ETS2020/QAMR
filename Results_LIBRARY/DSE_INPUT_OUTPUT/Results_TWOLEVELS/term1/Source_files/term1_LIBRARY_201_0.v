...
module FAU ( 
  ...
  aoi21  g045(.a(new_n89_), .b(new_n86_), .c(new_n59_), .O(new_n90_));
  ...
  inv1   g058(.a(new_n83_), .O(new_n103_));
  ...
  aoi21  g061(.a(new_n105_), .b(new_n101_), .c(new_n59_), .O(new_n106_));
  ...
  aoi21  g069(.a(new_n110_), .b(new_n85_), .c(new_n113_), .O(new_n114_));
  nor2   g070(.a(new_n84_), .b(x30), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(x29), .c(x28), .d(x27), .O(new_n116_));
  oai22  g072(.a(new_n116_), .b(new_n88_), .c(new_n114_), .d(new_n109_), .O(new_n117_));
  ...
  oai21  g087(.a(new_n131_), .b(new_n125_), .c(x24), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n121_), .O(z7));
  nand2  g089(.a(x16), .b(x15), .O(new_n134_));
  nand2  g090(.a(x18), .b(x17), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n134_), .c(new_n87_), .O(new_n136_));
  inv1   g092(.a(x15), .O(new_n137_));
  nand2  g093(.a(x16), .b(x10), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n135_), .c(new_n137_), .O(new_n139_));
  inv1   g095(.a(x11), .O(new_n140_));
  inv1   g096(.a(x16), .O(new_n141_));
  oai21  g097(.a(new_n135_), .b(new_n140_), .c(new_n141_), .O(new_n142_));
  inv1   g098(.a(x13), .O(new_n143_));
  inv1   g099(.a(x17), .O(new_n144_));
  inv1   g100(.a(x18), .O(new_n145_));
  nand2  g101(.a(x18), .b(x12), .O(new_n146_));
  aoi22  g102(.a(new_n146_), .b(new_n144_), .c(new_n145_), .d(new_n143_), .O(new_n147_));
  nand4  g103(.a(new_n147_), .b(new_n142_), .c(new_n139_), .d(new_n136_), .O(new_n148_));
  oai21  g104(.a(x30), .b(x24), .c(new_n148_), .O(new_n149_));
  inv1   g105(.a(x14), .O(new_n150_));
  nand3  g106(.a(x24), .b(x18), .c(x17), .O(new_n151_));
  oai22  g107(.a(new_n151_), .b(new_n134_), .c(new_n109_), .d(x19), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n150_), .O(new_n153_));
  nand3  g109(.a(x19), .b(x18), .c(x17), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n134_), .c(x31), .O(new_n155_));
  nor2   g111(.a(x28), .b(x27), .O(new_n156_));
  inv1   g112(.a(new_n156_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x29), .O(new_n158_));
  nand3  g114(.a(new_n158_), .b(new_n109_), .c(x24), .O(new_n159_));
  inv1   g115(.a(x28), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n80_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x30), .c(x29), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n159_), .O(new_n163_));
  aoi21  g119(.a(new_n155_), .b(new_n47_), .c(new_n163_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n153_), .c(new_n149_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x32), .O(new_n166_));
  inv1   g122(.a(x32), .O(new_n167_));
  nand4  g123(.a(new_n157_), .b(new_n109_), .c(x29), .d(x24), .O(new_n168_));
  nand2  g124(.a(new_n158_), .b(x30), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(x19), .b(new_n145_), .c(x13), .O(new_n171_));
  nand3  g127(.a(new_n87_), .b(x18), .c(x14), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n171_), .c(new_n144_), .O(new_n173_));
  nand4  g129(.a(x19), .b(x18), .c(new_n144_), .d(x12), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n173_), .c(x16), .O(new_n176_));
  inv1   g132(.a(new_n154_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n141_), .c(x11), .O(new_n178_));
  nand2  g134(.a(new_n178_), .b(new_n176_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(x15), .O(new_n180_));
  nand4  g136(.a(new_n177_), .b(x16), .c(new_n137_), .d(x10), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n170_), .c(new_n167_), .d(x31), .O(new_n183_));
  ...
  nand2  g144(.a(x33), .b(new_n127_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n157_), .c(x29), .O(new_n191_));
  nand4  g147(.a(new_n182_), .b(new_n187_), .c(new_n127_), .d(new_n109_), .O(new_n192_));
  nand2  g148(.a(x33), .b(x30), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n192_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n158_), .O(new_n195_));
  inv1   g151(.a(new_n138_), .O(new_n196_));
  aoi21  g152(.a(new_n177_), .b(new_n196_), .c(x15), .O(new_n197_));
  nor2   g153(.a(new_n87_), .b(new_n145_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(x17), .c(x11), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n141_), .O(new_n200_));
  nand2  g156(.a(new_n198_), .b(x12), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(new_n144_), .O(new_n202_));
  oai21  g158(.a(new_n87_), .b(new_n143_), .c(new_n145_), .O(new_n203_));
  oai22  g159(.a(new_n154_), .b(new_n134_), .c(new_n127_), .d(x30), .O(new_n204_));
  aoi21  g160(.a(new_n87_), .b(new_n150_), .c(new_n204_), .O(new_n205_));
  nand4  g161(.a(new_n205_), .b(new_n203_), .c(new_n202_), .d(new_n200_), .O(new_n206_));
  oai21  g162(.a(new_n206_), .b(new_n197_), .c(x33), .O(new_n207_));
  nand3  g163(.a(new_n207_), .b(new_n195_), .c(new_n191_), .O(new_n208_));
