...
module FAU ( 
  ...
  nor3   g073(.a(new_n117_), .b(new_n97_), .c(new_n62_), .O(z6));
  nor2   g074(.a(new_n114_), .b(new_n103_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n133_), .b(new_n114_), .c(x29), .O(new_n134_));
  nor2   g090(.a(new_n132_), .b(new_n103_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n114_), .c(new_n134_), .O(new_n136_));
  ...
  nand4  g139(.a(new_n153_), .b(new_n178_), .c(new_n126_), .d(new_n114_), .O(new_n184_));
