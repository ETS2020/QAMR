...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(new_n59_), .d(new_n79_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n78_), .c(new_n57_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nor2   g072(.a(new_n111_), .b(new_n100_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n102_), .c(new_n116_), .O(new_n118_));
  ...
  aoi21  g079(.a(new_n123_), .b(new_n102_), .c(new_n78_), .O(new_n124_));
  ...
  aoi21  g125(.a(new_n169_), .b(x32), .c(x26), .O(new_n170_));
  aoi21  g126(.a(new_n170_), .b(new_n150_), .c(new_n128_), .O(z8));
  inv1   g127(.a(x33), .O(new_n172_));
  nand4  g128(.a(new_n149_), .b(new_n172_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x33), .b(new_n116_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(new_n131_), .c(x29), .O(new_n176_));
  inv1   g132(.a(new_n133_), .O(new_n177_));
  nand4  g133(.a(new_n149_), .b(new_n172_), .c(new_n116_), .d(new_n111_), .O(new_n178_));
  ...
  inv1   g139(.a(new_n163_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x17), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n184_), .c(new_n88_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n154_), .c(new_n147_), .O(new_n187_));
  ...
  nand2  g147(.a(new_n85_), .b(new_n160_), .O(new_n192_));
  ...
  nand3  g153(.a(new_n197_), .b(new_n181_), .c(new_n176_), .O(new_n198_));
