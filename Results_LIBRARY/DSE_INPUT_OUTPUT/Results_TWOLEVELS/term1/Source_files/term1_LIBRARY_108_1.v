...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n99_), .c(new_n61_), .d(new_n45_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n96_), .c(new_n59_), .O(z6));
  ...
  nand4  g074(.a(new_n92_), .b(new_n87_), .c(new_n84_), .d(new_n98_), .O(new_n119_));
  ...
  nand3  g089(.a(new_n85_), .b(x18), .c(x14), .O(new_n134_));
  ...
  oai21  g116(.a(new_n85_), .b(new_n160_), .c(new_n90_), .O(new_n161_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n122_), .d(new_n111_), .O(new_n180_));
  ...
  oai21  g147(.a(new_n90_), .b(new_n158_), .c(new_n82_), .O(new_n192_));
  nand2  g148(.a(new_n90_), .b(new_n160_), .O(new_n193_));
