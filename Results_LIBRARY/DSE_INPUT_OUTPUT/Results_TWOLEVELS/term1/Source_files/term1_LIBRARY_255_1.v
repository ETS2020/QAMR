...
module FAU ( 
  ...
  nand2  g071(.a(new_n115_), .b(new_n57_), .O(z6));
  ...
  oai21  g118(.a(new_n88_), .b(new_n162_), .c(new_n85_), .O(new_n163_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n45_), .c(x00), .O(new_n174_));
  ...
  aoi21  g141(.a(new_n88_), .b(x14), .c(new_n85_), .O(new_n186_));
  ...
  oai21  g149(.a(new_n85_), .b(new_n160_), .c(new_n82_), .O(new_n194_));
  nand2  g150(.a(new_n85_), .b(new_n162_), .O(new_n195_));
  ...
  nand3  g157(.a(new_n201_), .b(new_n45_), .c(x00), .O(new_n202_));
