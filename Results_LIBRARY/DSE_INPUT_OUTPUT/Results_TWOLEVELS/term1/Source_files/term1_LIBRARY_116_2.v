...
module FAU ( 
  ...
  nor2   g049(.a(new_n45_), .b(x28), .O(new_n94_));
  ...
  nor3   g053(.a(new_n97_), .b(new_n92_), .c(new_n58_), .O(z4));
  inv1   g054(.a(x27), .O(new_n99_));
  oai21  g055(.a(new_n94_), .b(new_n99_), .c(x29), .O(new_n100_));
  nand2  g056(.a(x28), .b(x27), .O(new_n101_));
  inv1   g057(.a(x29), .O(new_n102_));
  nand2  g058(.a(x30), .b(new_n102_), .O(new_n103_));
  ...
  nor3   g061(.a(new_n105_), .b(new_n92_), .c(new_n58_), .O(z5));
  ...
  nand4  g068(.a(new_n60_), .b(new_n79_), .c(x25), .d(x01), .O(new_n113_));
  ...
  oai21  g074(.a(new_n118_), .b(new_n101_), .c(new_n116_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x30), .c(x31), .d(new_n99_), .O(new_n120_));
  ...
  oai21  g097(.a(new_n141_), .b(new_n125_), .c(new_n46_), .O(new_n142_));
  aoi21  g098(.a(new_n93_), .b(new_n99_), .c(new_n45_), .O(new_n143_));
  aoi21  g099(.a(x29), .b(x28), .c(x30), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(new_n99_), .c(new_n143_), .d(x29), .O(new_n145_));
  ...
  oai21  g106(.a(new_n150_), .b(new_n94_), .c(new_n99_), .O(new_n151_));
  ...
  oai21  g136(.a(new_n180_), .b(new_n172_), .c(new_n46_), .O(new_n181_));
  aoi21  g137(.a(x31), .b(x29), .c(new_n45_), .O(new_n182_));
  oai21  g138(.a(new_n45_), .b(new_n93_), .c(x31), .O(new_n183_));
  oai21  g139(.a(new_n118_), .b(new_n93_), .c(new_n183_), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n99_), .c(new_n182_), .O(new_n185_));
  ...
  nand4  g145(.a(new_n115_), .b(new_n117_), .c(new_n45_), .d(new_n99_), .O(new_n190_));
  nand2  g146(.a(new_n93_), .b(new_n99_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x31), .c(x30), .d(x29), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n190_), .O(new_n193_));
  oai21  g149(.a(new_n189_), .b(new_n188_), .c(new_n193_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(x33), .c(new_n187_), .O(new_n195_));
