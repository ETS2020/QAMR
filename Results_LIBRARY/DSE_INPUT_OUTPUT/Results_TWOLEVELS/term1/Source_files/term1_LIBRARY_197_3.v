...
module FAU ( 
  ...
  oai21  g084(.a(new_n128_), .b(new_n127_), .c(new_n122_), .O(new_n129_));
  inv1   g085(.a(x12), .O(new_n130_));
  oai21  g086(.a(new_n127_), .b(new_n130_), .c(new_n85_), .O(new_n131_));
  ...
  oai21  g091(.a(new_n135_), .b(new_n124_), .c(x31), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n134_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n133_), .c(new_n131_), .d(new_n129_), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n126_), .c(new_n59_), .O(new_n139_));
  nand3  g095(.a(x30), .b(x29), .c(x28), .O(new_n140_));
  oai21  g096(.a(x30), .b(x28), .c(new_n140_), .O(new_n141_));
  aoi22  g097(.a(new_n141_), .b(new_n45_), .c(new_n46_), .d(new_n104_), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n139_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x32), .O(new_n144_));
  inv1   g100(.a(x32), .O(new_n145_));
  nand2  g101(.a(new_n111_), .b(x30), .O(new_n146_));
  nand2  g102(.a(new_n102_), .b(new_n45_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n46_), .c(x29), .O(new_n148_));
  oai21  g104(.a(new_n146_), .b(x27), .c(new_n148_), .O(new_n149_));
  ...
  nand3  g111(.a(new_n125_), .b(new_n122_), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x15), .O(new_n158_));
  nor4   g114(.a(new_n124_), .b(new_n122_), .c(x15), .d(new_n121_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n149_), .c(new_n145_), .d(x31), .O(new_n162_));
  ...
  nand3  g127(.a(new_n171_), .b(new_n117_), .c(new_n46_), .O(new_n172_));
  nand2  g128(.a(x31), .b(x30), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n111_), .c(new_n172_), .O(new_n174_));
  oai21  g130(.a(new_n159_), .b(new_n170_), .c(new_n174_), .O(new_n175_));
  inv1   g131(.a(new_n146_), .O(new_n176_));
  inv1   g132(.a(new_n126_), .O(new_n177_));
  oai22  g133(.a(new_n135_), .b(new_n124_), .c(x19), .d(x14), .O(new_n178_));
  nand2  g134(.a(x31), .b(new_n46_), .O(new_n179_));
  nand3  g135(.a(new_n117_), .b(x29), .c(x28), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nor3   g137(.a(new_n181_), .b(new_n178_), .c(new_n132_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n131_), .c(new_n129_), .d(new_n177_), .O(new_n183_));
  ...
  nand2  g142(.a(new_n186_), .b(new_n168_), .O(z9));
endmodule
