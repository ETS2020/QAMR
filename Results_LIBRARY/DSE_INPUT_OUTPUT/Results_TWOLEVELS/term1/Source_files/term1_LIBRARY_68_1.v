...
module FAU ( 
  ...
  oai21  g045(.a(new_n45_), .b(x23), .c(new_n89_), .O(new_n90_));
  ...
  nor2   g053(.a(x23), .b(x18), .O(new_n98_));
  nor4   g054(.a(new_n98_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n99_));
  nor2   g055(.a(new_n99_), .b(new_n61_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n97_), .c(new_n81_), .d(x25), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n60_), .c(new_n47_), .O(z4));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n62_), .d(new_n81_), .O(new_n109_));
  ...
  nand3  g069(.a(new_n113_), .b(x30), .c(x23), .O(new_n114_));
  nor2   g070(.a(x30), .b(new_n104_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n106_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(new_n114_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n89_), .O(new_n118_));
  nor2   g074(.a(new_n82_), .b(x23), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(new_n115_), .c(x28), .d(new_n91_), .O(new_n120_));
  ...
  nand3  g080(.a(new_n106_), .b(new_n124_), .c(x29), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x23), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(x30), .O(new_n127_));
  nand3  g083(.a(new_n106_), .b(x30), .c(x29), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(x31), .O(new_n129_));
  inv1   g085(.a(new_n98_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n88_), .c(new_n86_), .d(new_n84_), .O(new_n131_));
  nand4  g087(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand4  g089(.a(new_n133_), .b(new_n131_), .c(new_n129_), .d(new_n127_), .O(z7));
  nand2  g090(.a(new_n105_), .b(new_n82_), .O(new_n135_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n136_), .c(x31), .d(new_n45_), .O(new_n154_));
  ...
  nand4  g114(.a(new_n153_), .b(new_n136_), .c(x31), .d(x30), .O(new_n159_));
  ...
  aoi21  g120(.a(new_n164_), .b(new_n147_), .c(x15), .O(new_n165_));
  nor2   g121(.a(new_n139_), .b(new_n91_), .O(new_n166_));
  ...
  nand2  g125(.a(new_n169_), .b(new_n137_), .O(new_n170_));
  inv1   g126(.a(x13), .O(new_n171_));
  oai21  g127(.a(new_n139_), .b(new_n171_), .c(new_n91_), .O(new_n172_));
  nor2   g128(.a(x19), .b(x14), .O(new_n173_));
  nand2  g129(.a(x16), .b(x15), .O(new_n174_));
  oai21  g130(.a(new_n174_), .b(new_n146_), .c(x31), .O(new_n175_));
  ...
  nand3  g134(.a(new_n178_), .b(new_n162_), .c(new_n157_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n81_), .c(x00), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n47_), .O(z8));
  inv1   g137(.a(x33), .O(new_n182_));
  nand4  g138(.a(new_n153_), .b(new_n182_), .c(x31), .d(x30), .O(new_n183_));
  ...
  nand4  g142(.a(new_n153_), .b(new_n182_), .c(new_n124_), .d(new_n45_), .O(new_n187_));
  nand2  g143(.a(x33), .b(x31), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n158_), .O(new_n190_));
  aoi21  g146(.a(new_n139_), .b(x14), .c(new_n91_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(x17), .c(x16), .d(x15), .O(new_n192_));
  nand2  g148(.a(x18), .b(x17), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n174_), .c(new_n139_), .O(new_n194_));
  oai21  g150(.a(new_n193_), .b(new_n163_), .c(new_n151_), .O(new_n195_));
  inv1   g151(.a(x11), .O(new_n196_));
  oai21  g152(.a(new_n193_), .b(new_n196_), .c(new_n145_), .O(new_n197_));
  nand2  g153(.a(x18), .b(x12), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n137_), .O(new_n199_));
  nand2  g155(.a(new_n91_), .b(new_n171_), .O(new_n200_));
  xnor2a g156(.a(x31), .b(x30), .O(new_n201_));
  nand4  g157(.a(new_n201_), .b(new_n200_), .c(new_n199_), .d(new_n197_), .O(new_n202_));
  inv1   g158(.a(new_n202_), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n195_), .c(new_n194_), .d(new_n192_), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(x33), .O(new_n205_));
  nand3  g161(.a(new_n205_), .b(new_n190_), .c(new_n186_), .O(new_n206_));
