...
module FAU ( 
  ...
  nand3  g053(.a(new_n97_), .b(new_n94_), .c(new_n48_), .O(new_n98_));
  ...
  nand4  g059(.a(new_n48_), .b(new_n103_), .c(x28), .d(x27), .O(new_n104_));
  inv1   g060(.a(x28), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n81_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand2  g063(.a(x30), .b(x09), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(new_n107_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n104_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n94_), .c(new_n80_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n102_), .c(new_n60_), .O(z5));
  nand2  g068(.a(new_n106_), .b(x29), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x30), .c(new_n45_), .O(new_n114_));
  nand3  g070(.a(new_n106_), .b(new_n46_), .c(x29), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n117_));
  nor3   g073(.a(new_n117_), .b(new_n102_), .c(new_n60_), .O(z6));
  nand3  g074(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n119_));
  nor2   g075(.a(new_n119_), .b(new_n91_), .O(new_n120_));
  ...
  oai21  g082(.a(new_n126_), .b(new_n107_), .c(new_n124_), .O(new_n127_));
  ...
  nand2  g086(.a(new_n105_), .b(new_n81_), .O(new_n131_));
  nand3  g087(.a(new_n131_), .b(new_n46_), .c(x29), .O(new_n132_));
  aoi21  g088(.a(new_n105_), .b(new_n81_), .c(new_n103_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n46_), .c(new_n132_), .O(new_n134_));
  nand3  g090(.a(x19), .b(new_n88_), .c(x13), .O(new_n135_));
  inv1   g091(.a(x19), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x18), .c(x14), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n135_), .c(new_n85_), .O(new_n138_));
  nand4  g094(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n139_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n134_), .c(new_n130_), .d(x31), .O(new_n151_));
  nand2  g107(.a(new_n136_), .b(x14), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(x18), .c(x17), .d(x16), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n148_), .O(new_n154_));
  nand4  g110(.a(x30), .b(x29), .c(x27), .d(new_n45_), .O(new_n155_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n136_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x10), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n159_), .c(new_n148_), .O(new_n162_));
  inv1   g118(.a(new_n159_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(x11), .c(x16), .O(new_n164_));
  aoi21  g120(.a(x18), .b(x12), .c(x17), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  nand2  g122(.a(new_n88_), .b(new_n166_), .O(new_n167_));
  nand3  g123(.a(x30), .b(x29), .c(x28), .O(new_n168_));
  nand2  g124(.a(new_n46_), .b(new_n103_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n168_), .c(new_n167_), .d(x31), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n165_), .c(new_n164_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n162_), .c(new_n160_), .d(new_n157_), .O(new_n172_));
  oai21  g128(.a(new_n172_), .b(new_n154_), .c(x32), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n151_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n80_), .c(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n48_), .O(z8));
  inv1   g132(.a(new_n164_), .O(new_n177_));
  aoi21  g133(.a(new_n88_), .b(new_n166_), .c(new_n165_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n177_), .c(new_n162_), .d(new_n160_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n154_), .c(new_n48_), .O(new_n180_));
  or2    g136(.a(new_n133_), .b(x31), .O(new_n181_));
  nand2  g137(.a(new_n125_), .b(x30), .O(new_n182_));
  oai21  g138(.a(new_n133_), .b(new_n125_), .c(new_n182_), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(new_n45_), .c(new_n181_), .d(new_n46_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n180_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  inv1   g142(.a(x33), .O(new_n187_));
  nand4  g143(.a(new_n131_), .b(x31), .c(x30), .d(x29), .O(new_n188_));
  oai22  g144(.a(new_n188_), .b(x09), .c(new_n181_), .d(x30), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n150_), .c(new_n187_), .O(new_n190_));
