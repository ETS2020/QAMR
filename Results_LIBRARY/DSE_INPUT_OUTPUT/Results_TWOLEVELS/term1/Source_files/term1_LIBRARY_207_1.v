...
module FAU ( 
  ...
  oai21  g061(.a(new_n102_), .b(new_n45_), .c(new_n105_), .O(new_n106_));
  ...
  nand3  g066(.a(new_n104_), .b(x28), .c(x27), .O(new_n111_));
  ...
  nand4  g083(.a(new_n127_), .b(new_n125_), .c(new_n123_), .d(new_n120_), .O(z7));
  ...
  nand2  g103(.a(new_n147_), .b(new_n80_), .O(new_n148_));
  oai21  g104(.a(new_n122_), .b(new_n45_), .c(new_n148_), .O(new_n149_));
  ...
  oai22  g112(.a(new_n156_), .b(new_n45_), .c(new_n154_), .d(new_n121_), .O(new_n157_));
  ...
  nand3  g123(.a(x16), .b(new_n130_), .c(x10), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n132_), .O(new_n169_));
  inv1   g125(.a(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n167_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n157_), .c(new_n153_), .d(x31), .O(new_n172_));
  ...
  nand2  g131(.a(new_n89_), .b(x14), .O(new_n176_));
  ...
  oai21  g135(.a(new_n179_), .b(new_n145_), .c(new_n89_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n131_), .c(new_n130_), .O(new_n181_));
  inv1   g137(.a(x11), .O(new_n182_));
  oai21  g138(.a(new_n179_), .b(new_n182_), .c(new_n134_), .O(new_n183_));
  ...
  oai21  g144(.a(x31), .b(new_n103_), .c(new_n155_), .O(new_n189_));
  aoi21  g145(.a(new_n109_), .b(new_n117_), .c(x30), .O(new_n190_));
  ...
  aoi21  g149(.a(new_n165_), .b(new_n163_), .c(new_n130_), .O(new_n194_));
  nand3  g150(.a(new_n147_), .b(new_n117_), .c(new_n80_), .O(new_n195_));
