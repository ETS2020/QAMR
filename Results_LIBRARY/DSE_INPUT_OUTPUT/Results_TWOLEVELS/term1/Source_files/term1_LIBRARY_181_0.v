...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n82_), .c(x25), .d(x01), .O(new_n94_));
  ...
  aoi21  g056(.a(x30), .b(new_n45_), .c(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n99_), .b(x28), .c(x27), .O(new_n102_));
  oai21  g058(.a(new_n101_), .b(new_n99_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n91_), .c(new_n63_), .d(new_n82_), .O(new_n104_));
  inv1   g060(.a(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(x25), .c(x01), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n47_), .O(z5));
  nand3  g063(.a(new_n46_), .b(x28), .c(x27), .O(new_n108_));
  oai21  g064(.a(new_n46_), .b(x27), .c(new_n108_), .O(new_n109_));
  nand2  g065(.a(x29), .b(x28), .O(new_n110_));
  aoi22  g066(.a(new_n110_), .b(x30), .c(new_n109_), .d(x29), .O(new_n111_));
  nor2   g067(.a(new_n111_), .b(new_n92_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n63_), .c(new_n82_), .d(x25), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n61_), .O(z6));
  nor2   g070(.a(x31), .b(new_n46_), .O(new_n115_));
  nand3  g071(.a(x30), .b(x29), .c(x28), .O(new_n116_));
  and2   g072(.a(new_n116_), .b(x31), .O(new_n117_));
  nor4   g073(.a(new_n89_), .b(new_n87_), .c(new_n85_), .d(new_n83_), .O(new_n118_));
  nor2   g074(.a(new_n62_), .b(new_n61_), .O(new_n119_));
  nand4  g075(.a(new_n115_), .b(x29), .c(x28), .d(x27), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n119_), .c(new_n82_), .d(x25), .O(new_n121_));
  nor3   g077(.a(new_n121_), .b(new_n118_), .c(new_n117_), .O(new_n122_));
  oai21  g078(.a(new_n115_), .b(x27), .c(new_n122_), .O(z7));
  ...
  oai21  g089(.a(new_n129_), .b(new_n132_), .c(new_n133_), .O(new_n134_));
  aoi21  g090(.a(x19), .b(x13), .c(x18), .O(new_n135_));
  nor2   g091(.a(x19), .b(x14), .O(new_n136_));
  nor2   g092(.a(new_n136_), .b(new_n135_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n134_), .c(new_n131_), .d(new_n127_), .O(new_n138_));
  oai21  g094(.a(x30), .b(x27), .c(new_n138_), .O(new_n139_));
  inv1   g095(.a(x31), .O(new_n140_));
  nor3   g096(.a(new_n126_), .b(new_n128_), .c(new_n124_), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n140_), .c(new_n47_), .O(new_n142_));
  nand3  g098(.a(x30), .b(x29), .c(new_n100_), .O(new_n143_));
  oai21  g099(.a(x30), .b(x29), .c(new_n143_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x27), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n142_), .c(new_n139_), .d(new_n116_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nor2   g104(.a(x28), .b(x27), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n99_), .c(x30), .O(new_n150_));
  nand3  g106(.a(new_n46_), .b(x29), .c(x27), .O(new_n151_));
  ...
  aoi21  g112(.a(new_n156_), .b(new_n154_), .c(new_n133_), .O(new_n157_));
  nand4  g113(.a(x19), .b(x18), .c(new_n133_), .d(x12), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n157_), .c(x16), .O(new_n160_));
  inv1   g116(.a(new_n126_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n128_), .c(x11), .O(new_n162_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n152_), .c(new_n148_), .d(x31), .O(new_n167_));
  ...
  nor2   g126(.a(new_n128_), .b(new_n124_), .O(new_n171_));
  nand2  g127(.a(x18), .b(x17), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n171_), .c(x19), .O(new_n174_));
  oai21  g130(.a(new_n172_), .b(new_n125_), .c(new_n124_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n176_), .c(new_n128_), .O(new_n177_));
  oai21  g133(.a(new_n153_), .b(new_n132_), .c(new_n133_), .O(new_n178_));
  nor2   g134(.a(x18), .b(x13), .O(new_n179_));
  nor2   g135(.a(new_n124_), .b(x14), .O(new_n180_));
  nand3  g136(.a(x18), .b(x17), .c(x16), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n180_), .c(new_n179_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n178_), .c(new_n177_), .d(new_n175_), .O(new_n184_));
  oai22  g140(.a(new_n184_), .b(new_n174_), .c(x30), .d(x27), .O(new_n185_));
  nand4  g141(.a(new_n47_), .b(x19), .c(x18), .d(x17), .O(new_n186_));
  nor2   g142(.a(new_n186_), .b(new_n128_), .O(new_n187_));
  nand2  g143(.a(new_n140_), .b(new_n99_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n46_), .c(x27), .O(new_n189_));
  nand2  g145(.a(x31), .b(x29), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n149_), .c(x30), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  aoi21  g148(.a(new_n187_), .b(x15), .c(new_n192_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(new_n185_), .O(new_n194_));
  ...
  oai21  g157(.a(new_n197_), .b(new_n110_), .c(new_n201_), .O(new_n202_));
  nand3  g158(.a(new_n202_), .b(new_n166_), .c(new_n196_), .O(new_n203_));
