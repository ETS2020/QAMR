...
module FAU ( 
  ...
  nor2   g046(.a(new_n46_), .b(x21), .O(new_n91_));
  aoi22  g047(.a(new_n91_), .b(new_n83_), .c(new_n90_), .d(new_n47_), .O(new_n92_));
  ...
  aoi21  g052(.a(new_n45_), .b(new_n83_), .c(new_n84_), .O(new_n97_));
  nor3   g053(.a(new_n88_), .b(new_n87_), .c(new_n85_), .O(new_n98_));
  aoi21  g054(.a(new_n98_), .b(new_n97_), .c(new_n61_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n96_), .c(new_n81_), .d(x25), .O(new_n100_));
  oai21  g056(.a(new_n100_), .b(new_n60_), .c(new_n47_), .O(z4));
  inv1   g057(.a(x28), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n82_), .c(x29), .O(new_n103_));
  ...
  xor2a  g064(.a(x30), .b(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n90_), .O(new_n110_));
  nand4  g066(.a(x30), .b(new_n104_), .c(new_n45_), .d(new_n83_), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n110_), .c(new_n102_), .O(new_n112_));
  nor3   g068(.a(x28), .b(x21), .c(x16), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n112_), .c(x27), .O(new_n114_));
  inv1   g070(.a(new_n90_), .O(new_n115_));
  nor2   g071(.a(new_n102_), .b(new_n82_), .O(new_n116_));
  nand3  g072(.a(new_n82_), .b(new_n45_), .c(new_n83_), .O(new_n117_));
  oai21  g073(.a(new_n116_), .b(new_n115_), .c(new_n117_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x30), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n114_), .c(new_n61_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n81_), .c(x25), .d(x01), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n47_), .O(z6));
  nand4  g078(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n47_), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  inv1   g082(.a(new_n87_), .O(new_n127_));
  inv1   g083(.a(new_n88_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n127_), .c(new_n86_), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x16), .O(new_n131_));
  inv1   g087(.a(x31), .O(new_n132_));
  nand3  g088(.a(new_n116_), .b(new_n132_), .c(x29), .O(new_n133_));
  ...
  oai21  g092(.a(new_n136_), .b(new_n130_), .c(x21), .O(new_n137_));
  nand3  g093(.a(new_n137_), .b(new_n135_), .c(new_n124_), .O(z7));
  nand2  g094(.a(new_n102_), .b(new_n82_), .O(new_n139_));
  ...
  nand4  g114(.a(new_n158_), .b(new_n141_), .c(x31), .d(x30), .O(new_n159_));
  nand3  g115(.a(x32), .b(new_n46_), .c(x21), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n159_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n140_), .O(new_n162_));
  nand4  g118(.a(new_n158_), .b(new_n139_), .c(new_n141_), .d(x31), .O(new_n163_));
  nand2  g119(.a(new_n102_), .b(new_n82_), .O(new_n164_));
  ...
  aoi21  g124(.a(new_n168_), .b(new_n152_), .c(x15), .O(new_n169_));
  nor2   g125(.a(new_n145_), .b(new_n143_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(x17), .c(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n83_), .O(new_n172_));
  nand2  g128(.a(new_n170_), .b(x12), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n142_), .O(new_n174_));
  nand2  g130(.a(x19), .b(x13), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n143_), .O(new_n176_));
  nor2   g132(.a(x19), .b(x14), .O(new_n177_));
  nor3   g133(.a(new_n151_), .b(new_n83_), .c(new_n156_), .O(new_n178_));
  nor3   g134(.a(new_n178_), .b(new_n177_), .c(new_n132_), .O(new_n179_));
  ...
  nand3  g137(.a(new_n181_), .b(new_n167_), .c(new_n162_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n81_), .c(x00), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n47_), .O(z8));
  inv1   g140(.a(x33), .O(new_n185_));
  nand4  g141(.a(new_n158_), .b(new_n185_), .c(x31), .d(x30), .O(new_n186_));
  nand2  g142(.a(x33), .b(new_n132_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n139_), .c(x29), .O(new_n189_));
  nand4  g145(.a(new_n158_), .b(new_n185_), .c(new_n132_), .d(new_n46_), .O(new_n190_));
  oai21  g146(.a(new_n185_), .b(new_n46_), .c(new_n190_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n140_), .O(new_n192_));
  nor3   g148(.a(new_n178_), .b(new_n177_), .c(new_n136_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n176_), .c(new_n174_), .d(new_n172_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n169_), .c(x33), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n192_), .c(new_n189_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n81_), .c(x00), .O(new_n197_));
  nand2  g153(.a(new_n197_), .b(new_n47_), .O(z9));
endmodule
