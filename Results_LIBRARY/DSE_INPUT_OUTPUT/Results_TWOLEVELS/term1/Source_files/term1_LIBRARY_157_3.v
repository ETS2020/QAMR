...
module FAU ( 
  ...
  nand4  g070(.a(new_n114_), .b(new_n100_), .c(new_n60_), .d(new_n80_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n45_), .O(z6));
  nor2   g074(.a(new_n112_), .b(new_n101_), .O(new_n119_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n125_), .c(new_n80_), .O(new_n128_));
  nor2   g084(.a(new_n128_), .b(new_n79_), .O(new_n129_));
  ...
  nor2   g090(.a(new_n132_), .b(new_n101_), .O(new_n135_));
  ...
  oai21  g118(.a(new_n144_), .b(new_n162_), .c(new_n83_), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  oai21  g120(.a(new_n89_), .b(new_n164_), .c(new_n86_), .O(new_n165_));
  ...
  oai21  g147(.a(new_n191_), .b(new_n190_), .c(new_n89_), .O(new_n192_));
  ...
  oai21  g151(.a(new_n86_), .b(new_n162_), .c(new_n83_), .O(new_n196_));
  nand2  g152(.a(new_n86_), .b(new_n164_), .O(new_n197_));
