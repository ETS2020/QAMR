...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n100_), .d(new_n79_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n96_), .c(new_n60_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n100_), .d(new_n79_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n96_), .c(new_n60_), .O(z6));
  inv1   g071(.a(x31), .O(new_n116_));
  nor2   g072(.a(new_n111_), .b(new_n102_), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n104_), .c(new_n116_), .O(new_n118_));
  ...
  nand3  g077(.a(new_n116_), .b(x30), .c(x29), .O(new_n122_));
  inv1   g078(.a(new_n122_), .O(new_n123_));
  aoi21  g079(.a(new_n123_), .b(new_n104_), .c(new_n96_), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  oai21  g081(.a(new_n125_), .b(new_n118_), .c(new_n79_), .O(new_n126_));
  oai21  g082(.a(new_n79_), .b(x00), .c(new_n126_), .O(z7));
  ...
  nand2  g105(.a(new_n117_), .b(x27), .O(new_n150_));
  ...
  oai21  g114(.a(new_n155_), .b(new_n158_), .c(new_n82_), .O(new_n159_));
  ...
  nor2   g119(.a(new_n163_), .b(new_n141_), .O(new_n164_));
  nor2   g120(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  oai21  g121(.a(x30), .b(x29), .c(x31), .O(new_n166_));
  aoi21  g122(.a(new_n117_), .b(x28), .c(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n165_), .c(new_n161_), .d(new_n159_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n157_), .c(new_n154_), .d(new_n152_), .O(new_n170_));
  ...
  nand4  g137(.a(new_n148_), .b(new_n176_), .c(new_n116_), .d(new_n111_), .O(new_n182_));
  ...
  oai21  g143(.a(new_n187_), .b(new_n163_), .c(new_n88_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n153_), .c(new_n146_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  oai21  g146(.a(new_n187_), .b(new_n190_), .c(new_n140_), .O(new_n191_));
  ...
  nand2  g154(.a(new_n198_), .b(new_n79_), .O(new_n199_));
  aoi21  g155(.a(new_n184_), .b(new_n181_), .c(new_n199_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n180_), .c(new_n175_), .O(z9));
endmodule
