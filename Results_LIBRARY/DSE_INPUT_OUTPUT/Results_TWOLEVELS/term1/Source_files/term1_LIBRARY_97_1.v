...
module FAU ( 
  ...
  nor3   g055(.a(new_n99_), .b(new_n97_), .c(new_n59_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n61_), .d(new_n80_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n97_), .c(new_n59_), .O(z5));
  nand3  g064(.a(new_n104_), .b(new_n45_), .c(x29), .O(new_n109_));
  oai21  g065(.a(new_n45_), .b(x28), .c(new_n109_), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x25), .O(new_n111_));
  oai21  g067(.a(new_n102_), .b(new_n81_), .c(x30), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n61_), .d(new_n80_), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n59_), .c(new_n48_), .O(z6));
  nor2   g071(.a(new_n45_), .b(new_n102_), .O(new_n116_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(new_n80_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n97_), .O(new_n126_));
  ...
  nor2   g087(.a(new_n129_), .b(new_n102_), .O(new_n132_));
  ...
  oai21  g115(.a(new_n141_), .b(new_n159_), .c(new_n83_), .O(new_n160_));
  ...
  nand4  g136(.a(new_n150_), .b(new_n175_), .c(new_n123_), .d(new_n45_), .O(new_n181_));
  ...
  oai21  g144(.a(new_n188_), .b(new_n187_), .c(new_n89_), .O(new_n189_));
  ...
  oai21  g148(.a(new_n86_), .b(new_n159_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n86_), .b(new_n161_), .O(new_n194_));
