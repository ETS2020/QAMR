...
module FAU ( 
  ...
  oai21  g071(.a(new_n115_), .b(new_n101_), .c(x31), .O(new_n116_));
  ...
  nand4  g107(.a(new_n151_), .b(new_n133_), .c(x31), .d(x30), .O(new_n152_));
  nand3  g108(.a(x32), .b(new_n110_), .c(x00), .O(new_n153_));
  ...
  nand4  g112(.a(new_n151_), .b(new_n156_), .c(new_n133_), .d(x31), .O(new_n157_));
  inv1   g113(.a(x00), .O(new_n158_));
  oai21  g114(.a(new_n80_), .b(new_n158_), .c(new_n99_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(x32), .c(x30), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(x30), .c(new_n160_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n144_), .c(new_n149_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  nand4  g120(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n143_), .O(new_n166_));
  nand3  g122(.a(x19), .b(x18), .c(x12), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n134_), .O(new_n168_));
  nand2  g124(.a(x19), .b(x13), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n135_), .O(new_n170_));
  nor2   g126(.a(x19), .b(x14), .O(new_n171_));
  nand3  g127(.a(new_n145_), .b(x16), .c(x15), .O(new_n172_));
  ...
  aoi21  g133(.a(new_n161_), .b(x29), .c(new_n177_), .O(new_n178_));
  aoi21  g134(.a(new_n178_), .b(new_n155_), .c(x26), .O(z8));
  inv1   g135(.a(x33), .O(new_n180_));
  nand4  g136(.a(new_n159_), .b(x31), .c(x30), .d(x29), .O(new_n181_));
  nand3  g137(.a(new_n132_), .b(new_n123_), .c(new_n110_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n151_), .c(new_n180_), .O(new_n184_));
  oai21  g140(.a(new_n131_), .b(x30), .c(new_n123_), .O(new_n185_));
  oai21  g141(.a(new_n130_), .b(new_n115_), .c(x31), .O(new_n186_));
  inv1   g142(.a(new_n166_), .O(new_n187_));
  inv1   g143(.a(new_n171_), .O(new_n188_));
  nand4  g144(.a(new_n172_), .b(new_n188_), .c(new_n170_), .d(new_n168_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n187_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n186_), .c(new_n185_), .d(new_n163_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(x33), .c(new_n158_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n184_), .c(x26), .O(z9));
endmodule
