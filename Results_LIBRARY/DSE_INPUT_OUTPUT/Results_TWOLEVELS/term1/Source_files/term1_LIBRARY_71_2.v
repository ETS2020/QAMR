...
module FAU ( 
  ...
  nand4  g048(.a(new_n92_), .b(new_n59_), .c(new_n45_), .d(new_n79_), .O(new_n93_));
  nor3   g049(.a(new_n93_), .b(new_n78_), .c(new_n58_), .O(z3));
  inv1   g050(.a(x28), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x27), .c(new_n79_), .O(new_n96_));
  oai21  g052(.a(new_n95_), .b(x27), .c(new_n96_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n92_), .c(new_n59_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n58_), .c(new_n46_), .O(z4));
  inv1   g055(.a(x29), .O(new_n100_));
  nor2   g056(.a(new_n95_), .b(new_n45_), .O(new_n101_));
  ...
  nand4  g066(.a(new_n110_), .b(new_n92_), .c(new_n59_), .d(new_n79_), .O(new_n111_));
  ...
  nor2   g073(.a(new_n108_), .b(new_n100_), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n101_), .c(new_n114_), .O(new_n119_));
  nand4  g075(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n82_), .O(new_n120_));
  nand3  g076(.a(new_n59_), .b(x25), .c(x01), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(new_n122_));
  nand2  g078(.a(new_n122_), .b(new_n120_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n119_), .c(new_n79_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n117_), .O(z7));
  inv1   g081(.a(x32), .O(new_n126_));
  aoi21  g082(.a(new_n95_), .b(new_n45_), .c(x30), .O(new_n127_));
  nor2   g083(.a(new_n108_), .b(x29), .O(new_n128_));
  aoi21  g084(.a(new_n127_), .b(x29), .c(new_n128_), .O(new_n129_));
  nand3  g085(.a(x30), .b(new_n95_), .c(new_n45_), .O(new_n130_));
  oai21  g086(.a(new_n129_), .b(x26), .c(new_n130_), .O(new_n131_));
  ...
  nand2  g103(.a(new_n118_), .b(x27), .O(new_n148_));
  ...
  oai21  g135(.a(new_n108_), .b(new_n100_), .c(x31), .O(new_n180_));
  ...
  nand3  g140(.a(new_n182_), .b(x16), .c(x10), .O(new_n185_));
  inv1   g141(.a(x11), .O(new_n186_));
  oai21  g142(.a(new_n181_), .b(new_n186_), .c(new_n138_), .O(new_n187_));
  ...
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n187_), .d(new_n115_), .O(new_n191_));
  aoi21  g147(.a(new_n185_), .b(new_n144_), .c(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n184_), .c(new_n180_), .d(new_n179_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand4  g150(.a(new_n146_), .b(new_n173_), .c(new_n114_), .d(new_n108_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n100_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n194_), .c(new_n177_), .O(new_n198_));
  nand2  g154(.a(x33), .b(x31), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n195_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n95_), .c(new_n45_), .O(new_n201_));
  inv1   g157(.a(new_n201_), .O(new_n202_));
  aoi21  g158(.a(new_n198_), .b(new_n79_), .c(new_n202_), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(new_n171_), .c(new_n46_), .O(z9));
endmodule
