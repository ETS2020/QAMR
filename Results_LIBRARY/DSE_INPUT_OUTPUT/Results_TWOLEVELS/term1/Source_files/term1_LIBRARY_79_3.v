...
module FAU ( 
  ...
  oai21  g053(.a(new_n97_), .b(new_n60_), .c(new_n45_), .O(z4));
  ...
  nand4  g061(.a(new_n105_), .b(new_n101_), .c(new_n100_), .d(new_n79_), .O(new_n106_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n100_), .d(new_n79_), .O(new_n113_));
  inv1   g069(.a(new_n113_), .O(new_n114_));
  nand3  g070(.a(new_n114_), .b(x25), .c(x01), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n45_), .O(z6));
  inv1   g072(.a(x31), .O(new_n117_));
  nor2   g073(.a(new_n110_), .b(new_n102_), .O(new_n118_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n103_), .c(new_n99_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n119_), .c(new_n79_), .O(new_n127_));
  oai21  g083(.a(new_n79_), .b(x00), .c(new_n127_), .O(z7));
  nand2  g084(.a(new_n118_), .b(x27), .O(new_n129_));
  nand2  g085(.a(new_n110_), .b(new_n80_), .O(new_n130_));
  aoi21  g086(.a(new_n130_), .b(new_n129_), .c(x28), .O(new_n131_));
  nor2   g087(.a(x30), .b(x29), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n131_), .c(new_n79_), .O(new_n133_));
  ...
  oai21  g098(.a(new_n139_), .b(new_n142_), .c(new_n82_), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand2  g100(.a(x19), .b(x13), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n85_), .O(new_n146_));
  inv1   g102(.a(x14), .O(new_n147_));
  nand2  g103(.a(new_n88_), .b(new_n147_), .O(new_n148_));
  ...
  nand3  g114(.a(new_n158_), .b(new_n110_), .c(x29), .O(new_n159_));
  nor2   g115(.a(new_n157_), .b(new_n102_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n110_), .c(new_n159_), .O(new_n161_));
  nand3  g117(.a(x19), .b(new_n85_), .c(x13), .O(new_n162_));
  nand3  g118(.a(new_n88_), .b(x18), .c(x14), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n162_), .c(new_n82_), .O(new_n164_));
  nand4  g120(.a(x19), .b(x18), .c(new_n82_), .d(x12), .O(new_n165_));
  ...
  nand3  g129(.a(new_n173_), .b(new_n155_), .c(new_n79_), .O(new_n174_));
  ...
  nand3  g136(.a(new_n180_), .b(new_n158_), .c(x29), .O(new_n181_));
  inv1   g137(.a(new_n160_), .O(new_n182_));
  nand4  g138(.a(new_n172_), .b(new_n177_), .c(new_n117_), .d(new_n110_), .O(new_n183_));
  nand2  g139(.a(x33), .b(x31), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  inv1   g141(.a(new_n137_), .O(new_n186_));
  nand2  g142(.a(new_n150_), .b(new_n148_), .O(new_n187_));
  xor2a  g143(.a(x31), .b(x30), .O(new_n188_));
  nor2   g144(.a(new_n188_), .b(new_n187_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(new_n146_), .c(new_n143_), .d(new_n141_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n186_), .c(x33), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n79_), .O(new_n192_));
  aoi21  g148(.a(new_n185_), .b(new_n182_), .c(new_n192_), .O(new_n193_));
  aoi21  g149(.a(new_n193_), .b(new_n181_), .c(new_n176_), .O(z9));
endmodule
