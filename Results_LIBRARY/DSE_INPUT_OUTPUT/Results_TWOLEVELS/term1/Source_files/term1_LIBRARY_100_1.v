...
module FAU ( 
  ...
  nor2   g067(.a(new_n103_), .b(new_n104_), .O(new_n112_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n116_));
  ...
  aoi21  g083(.a(new_n126_), .b(x27), .c(new_n127_), .O(new_n128_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n133_), .c(new_n47_), .O(new_n147_));
  nand2  g103(.a(new_n104_), .b(new_n81_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x29), .O(new_n149_));
  nor2   g105(.a(new_n45_), .b(new_n103_), .O(new_n150_));
  aoi22  g106(.a(new_n150_), .b(x27), .c(new_n149_), .d(new_n45_), .O(new_n151_));
  ...
  oai21  g111(.a(new_n155_), .b(new_n113_), .c(x27), .O(new_n156_));
  ...
  inv1   g115(.a(x19), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(x18), .c(x14), .O(new_n161_));
  aoi21  g117(.a(new_n161_), .b(new_n159_), .c(new_n85_), .O(new_n162_));
  nand4  g118(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n163_));
  ...
  nand4  g125(.a(new_n132_), .b(x16), .c(new_n169_), .d(x10), .O(new_n170_));
  ...
  aoi21  g131(.a(new_n166_), .b(new_n165_), .c(new_n169_), .O(new_n176_));
  inv1   g132(.a(new_n170_), .O(new_n177_));
  aoi22  g133(.a(new_n45_), .b(new_n103_), .c(new_n104_), .d(new_n81_), .O(new_n178_));
  ...
  nand3  g138(.a(new_n148_), .b(new_n124_), .c(x29), .O(new_n183_));
  nor2   g139(.a(new_n143_), .b(new_n131_), .O(new_n184_));
  nor2   g140(.a(new_n184_), .b(new_n142_), .O(new_n185_));
  nor2   g141(.a(new_n155_), .b(new_n127_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n185_), .c(new_n141_), .d(new_n139_), .O(new_n187_));
  inv1   g143(.a(new_n187_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n183_), .c(new_n137_), .d(new_n182_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  oai21  g146(.a(new_n181_), .b(x33), .c(new_n190_), .O(new_n191_));
