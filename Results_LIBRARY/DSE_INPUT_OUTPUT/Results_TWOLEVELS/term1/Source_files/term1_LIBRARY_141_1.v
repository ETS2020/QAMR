...
module FAU ( 
  ...
  nand4  g063(.a(new_n107_), .b(new_n93_), .c(new_n61_), .d(new_n80_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n102_), .c(new_n59_), .O(z5));
  nand2  g065(.a(x29), .b(x28), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(x30), .O(new_n111_));
  nand2  g067(.a(new_n105_), .b(x28), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n93_), .c(new_n61_), .d(x27), .O(new_n114_));
  ...
  oai21  g076(.a(new_n120_), .b(new_n118_), .c(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(x30), .O(new_n122_));
  nand2  g078(.a(x30), .b(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n118_), .c(x31), .O(new_n124_));
  ...
  oai21  g084(.a(x29), .b(new_n45_), .c(x30), .O(new_n129_));
  ...
  oai21  g094(.a(new_n135_), .b(new_n138_), .c(new_n84_), .O(new_n139_));
  ...
  nand2  g103(.a(new_n147_), .b(new_n81_), .O(new_n148_));
  oai21  g104(.a(new_n123_), .b(new_n45_), .c(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n146_), .b(new_n46_), .c(new_n149_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n144_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x32), .O(new_n152_));
  inv1   g108(.a(x32), .O(new_n153_));
  nor2   g109(.a(new_n81_), .b(x29), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n105_), .c(x27), .O(new_n155_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n134_), .c(x11), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n162_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x15), .O(new_n166_));
  nand3  g122(.a(x16), .b(new_n130_), .c(x10), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n132_), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n166_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n156_), .c(new_n153_), .d(x31), .O(new_n171_));
  ...
  nand2  g130(.a(new_n90_), .b(x14), .O(new_n175_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n145_), .c(new_n90_), .O(new_n179_));
  oai21  g135(.a(new_n178_), .b(new_n131_), .c(new_n130_), .O(new_n180_));
  ...
  nor2   g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n182_), .c(new_n180_), .d(new_n179_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n177_), .c(new_n46_), .O(new_n187_));
  oai21  g143(.a(new_n81_), .b(x29), .c(new_n120_), .O(new_n188_));
  aoi21  g144(.a(new_n110_), .b(new_n119_), .c(x30), .O(new_n189_));
  aoi21  g145(.a(new_n188_), .b(x27), .c(new_n189_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n187_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  aoi21  g148(.a(new_n164_), .b(new_n162_), .c(new_n130_), .O(new_n193_));
  nand3  g149(.a(new_n147_), .b(new_n119_), .c(new_n81_), .O(new_n194_));
  nand4  g150(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  oai21  g152(.a(new_n168_), .b(new_n193_), .c(new_n196_), .O(new_n197_));
  oai21  g153(.a(new_n197_), .b(x33), .c(new_n192_), .O(new_n198_));
