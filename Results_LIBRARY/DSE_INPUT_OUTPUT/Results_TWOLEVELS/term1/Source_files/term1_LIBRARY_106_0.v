...
module FAU ( 
  ...
  aoi21  g042(.a(new_n86_), .b(x00), .c(x26), .O(z3));
  inv1   g043(.a(x26), .O(new_n88_));
  xor2a  g044(.a(x28), .b(x27), .O(new_n89_));
  nand3  g045(.a(new_n89_), .b(new_n85_), .c(new_n88_), .O(new_n90_));
  ...
  nand4  g055(.a(new_n99_), .b(new_n94_), .c(new_n60_), .d(new_n88_), .O(new_n100_));
  ...
  nand3  g106(.a(x32), .b(new_n107_), .c(x00), .O(new_n151_));
  ...
  nand4  g110(.a(new_n149_), .b(new_n154_), .c(new_n131_), .d(x31), .O(new_n155_));
  inv1   g111(.a(x00), .O(new_n156_));
  oai21  g112(.a(new_n79_), .b(new_n156_), .c(new_n96_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(x32), .c(x30), .O(new_n158_));
  oai21  g114(.a(new_n155_), .b(x30), .c(new_n158_), .O(new_n159_));
  nand2  g115(.a(x16), .b(x10), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n142_), .c(new_n147_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand4  g118(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n141_), .O(new_n164_));
  nand3  g120(.a(x19), .b(x18), .c(x12), .O(new_n165_));
  ...
  nand3  g125(.a(new_n143_), .b(x16), .c(x15), .O(new_n170_));
  ...
  aoi21  g131(.a(new_n159_), .b(x29), .c(new_n175_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n153_), .c(x26), .O(z8));
  inv1   g133(.a(x33), .O(new_n178_));
  nand4  g134(.a(new_n157_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand3  g135(.a(new_n130_), .b(new_n121_), .c(new_n107_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n149_), .c(new_n178_), .O(new_n182_));
  oai21  g138(.a(new_n129_), .b(x30), .c(new_n121_), .O(new_n183_));
  oai21  g139(.a(new_n128_), .b(new_n113_), .c(x31), .O(new_n184_));
  inv1   g140(.a(new_n164_), .O(new_n185_));
  inv1   g141(.a(new_n169_), .O(new_n186_));
  nand4  g142(.a(new_n170_), .b(new_n186_), .c(new_n168_), .d(new_n166_), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n185_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n184_), .c(new_n183_), .d(new_n161_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(x33), .c(new_n156_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n182_), .c(x26), .O(z9));
endmodule
