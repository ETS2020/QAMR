...
module FAU ( 
  ...
  nand2  g038(.a(x30), .b(new_n82_), .O(new_n83_));
  ...
  nand3  g045(.a(new_n89_), .b(new_n83_), .c(new_n81_), .O(new_n90_));
  ...
  nand3  g050(.a(new_n94_), .b(new_n89_), .c(new_n57_), .O(new_n95_));
  ...
  nand2  g057(.a(new_n101_), .b(new_n57_), .O(new_n102_));
  ...
  nand4  g061(.a(new_n105_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n106_));
  nor2   g062(.a(new_n106_), .b(new_n59_), .O(z5));
  aoi21  g063(.a(x29), .b(new_n103_), .c(new_n81_), .O(new_n108_));
  oai21  g064(.a(new_n108_), .b(new_n82_), .c(x29), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x30), .O(new_n110_));
  nand4  g066(.a(new_n45_), .b(x29), .c(x28), .d(x27), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n110_), .c(new_n88_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n59_), .c(new_n57_), .O(z6));
  ...
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n57_), .O(new_n117_));
  ...
  aoi21  g081(.a(new_n123_), .b(x04), .c(new_n125_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n45_), .c(x29), .O(new_n131_));
  nor2   g087(.a(new_n129_), .b(new_n99_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n45_), .c(new_n131_), .O(new_n133_));
  ...
  aoi21  g108(.a(x28), .b(x04), .c(x27), .O(new_n153_));
  nor3   g109(.a(new_n153_), .b(new_n45_), .c(new_n99_), .O(new_n154_));
  inv1   g110(.a(new_n132_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n45_), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n144_), .c(new_n149_), .O(new_n158_));
  nor2   g114(.a(new_n137_), .b(new_n135_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(x17), .c(x11), .O(new_n160_));
  and2   g116(.a(new_n160_), .b(new_n143_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n159_), .b(x12), .O(new_n163_));
  nand2  g119(.a(x19), .b(x13), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n135_), .O(new_n165_));
  inv1   g121(.a(x14), .O(new_n166_));
  nand2  g122(.a(new_n137_), .b(new_n166_), .O(new_n167_));
  nor3   g123(.a(new_n144_), .b(new_n143_), .c(new_n149_), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n124_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(new_n167_), .c(new_n165_), .O(new_n170_));
  aoi21  g126(.a(new_n163_), .b(new_n134_), .c(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n162_), .c(new_n158_), .d(new_n156_), .O(new_n172_));
  ...
  aoi21  g132(.a(new_n150_), .b(new_n148_), .c(x33), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x31), .c(x30), .d(x04), .O(new_n178_));
  nand2  g134(.a(x33), .b(new_n124_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n130_), .c(x29), .O(new_n181_));
  inv1   g137(.a(x33), .O(new_n182_));
  nand4  g138(.a(new_n151_), .b(new_n182_), .c(new_n124_), .d(new_n45_), .O(new_n183_));
  nand2  g139(.a(x33), .b(x31), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n183_), .O(new_n185_));
  nand2  g141(.a(new_n163_), .b(new_n134_), .O(new_n186_));
  aoi21  g142(.a(new_n137_), .b(new_n166_), .c(new_n168_), .O(new_n187_));
  nor2   g143(.a(new_n125_), .b(new_n121_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(new_n187_), .c(new_n165_), .d(new_n186_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n161_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n158_), .c(new_n182_), .O(new_n191_));
  aoi21  g147(.a(new_n185_), .b(new_n155_), .c(new_n191_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n181_), .O(new_n193_));
