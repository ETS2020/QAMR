...
module FAU ( 
  ...
  nor3   g051(.a(new_n95_), .b(new_n79_), .c(new_n60_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n80_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n60_), .c(new_n45_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n100_), .d(new_n80_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n79_), .c(new_n60_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n100_), .d(new_n80_), .O(new_n114_));
  ...
  nor2   g074(.a(new_n111_), .b(new_n102_), .O(new_n119_));
  ...
  nor2   g078(.a(new_n57_), .b(new_n60_), .O(new_n123_));
  nand3  g079(.a(new_n118_), .b(x30), .c(x29), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n104_), .c(new_n79_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n123_), .c(new_n122_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n120_), .c(new_n80_), .O(new_n128_));
  oai21  g084(.a(new_n80_), .b(x00), .c(new_n128_), .O(z7));
