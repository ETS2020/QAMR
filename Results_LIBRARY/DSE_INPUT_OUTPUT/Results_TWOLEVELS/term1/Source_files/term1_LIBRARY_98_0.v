...
module FAU ( 
  ...
  and2   g043(.a(new_n87_), .b(new_n60_), .O(new_n88_));
  ...
  nor3   g078(.a(new_n105_), .b(new_n97_), .c(x28), .O(new_n123_));
  nor2   g079(.a(x30), .b(x29), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n123_), .c(x27), .O(new_n125_));
  ...
  aoi21  g091(.a(new_n133_), .b(x12), .c(x17), .O(new_n136_));
  nand2  g092(.a(x19), .b(x13), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n131_), .O(new_n138_));
  nand2  g094(.a(x16), .b(x15), .O(new_n139_));
  oai22  g095(.a(new_n139_), .b(new_n128_), .c(x19), .d(x14), .O(new_n140_));
  nand3  g096(.a(x30), .b(x29), .c(x28), .O(new_n141_));
  ...
  nor2   g100(.a(new_n144_), .b(new_n136_), .O(new_n145_));
  nand4  g101(.a(new_n145_), .b(new_n135_), .c(new_n129_), .d(new_n125_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nand2  g104(.a(new_n105_), .b(x29), .O(new_n149_));
  nand2  g105(.a(new_n95_), .b(new_n94_), .O(new_n150_));
  nand2  g106(.a(x30), .b(new_n97_), .O(new_n151_));
  nand3  g107(.a(new_n151_), .b(new_n150_), .c(new_n149_), .O(new_n152_));
  inv1   g108(.a(x17), .O(new_n153_));
  nand3  g109(.a(x19), .b(new_n131_), .c(x13), .O(new_n154_));
  nand3  g110(.a(new_n132_), .b(x18), .c(x14), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n154_), .c(new_n153_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n153_), .d(x12), .O(new_n157_));
  ...
  nand4  g119(.a(new_n160_), .b(x16), .c(new_n126_), .d(x10), .O(new_n164_));
  ...
  nand2  g125(.a(new_n79_), .b(x00), .O(new_n170_));
  nand3  g126(.a(x33), .b(x30), .c(new_n95_), .O(new_n171_));
  oai21  g127(.a(new_n171_), .b(new_n170_), .c(x30), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n94_), .O(new_n173_));
  aoi21  g129(.a(new_n161_), .b(new_n159_), .c(new_n126_), .O(new_n174_));
  inv1   g130(.a(new_n164_), .O(new_n175_));
  nand4  g131(.a(new_n150_), .b(x31), .c(x30), .d(x29), .O(new_n176_));
  nand3  g132(.a(new_n116_), .b(new_n105_), .c(new_n97_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n176_), .O(new_n178_));
  oai21  g134(.a(new_n175_), .b(new_n174_), .c(new_n178_), .O(new_n179_));
  inv1   g135(.a(new_n129_), .O(new_n180_));
  inv1   g136(.a(new_n136_), .O(new_n181_));
  nand2  g137(.a(new_n116_), .b(x29), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n151_), .c(new_n115_), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n140_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n138_), .c(new_n181_), .d(new_n135_), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n180_), .c(x33), .O(new_n186_));
  oai21  g142(.a(new_n179_), .b(x33), .c(new_n186_), .O(new_n187_));
  nand3  g143(.a(new_n187_), .b(new_n79_), .c(x00), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n173_), .O(z9));
endmodule
