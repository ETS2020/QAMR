...
module FAU ( 
  ...
  nand2  g064(.a(new_n108_), .b(new_n89_), .O(new_n109_));
  ...
  nor2   g071(.a(new_n82_), .b(new_n110_), .O(new_n116_));
  ...
  nand2  g082(.a(new_n126_), .b(x21), .O(new_n127_));
  ...
  nor2   g087(.a(new_n125_), .b(new_n110_), .O(new_n132_));
  nor2   g088(.a(new_n128_), .b(x30), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n132_), .c(new_n111_), .O(new_n134_));
  ...
  nand3  g105(.a(new_n149_), .b(new_n110_), .c(x11), .O(new_n150_));
  ...
  nand3  g112(.a(x32), .b(new_n45_), .c(new_n111_), .O(new_n157_));
  ...
  aoi21  g121(.a(new_n165_), .b(new_n149_), .c(x15), .O(new_n166_));
  nor2   g122(.a(new_n142_), .b(new_n140_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(x17), .c(x11), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(new_n110_), .O(new_n169_));
  ...
  nor3   g130(.a(new_n148_), .b(new_n110_), .c(new_n153_), .O(new_n175_));
