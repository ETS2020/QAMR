...
module FAU ( 
  ...
  nand3  g077(.a(new_n119_), .b(x28), .c(x27), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n121_), .c(new_n114_), .O(new_n123_));
  ...
  nand3  g084(.a(new_n120_), .b(new_n128_), .c(x29), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(new_n127_), .c(new_n114_), .O(new_n130_));
  nand4  g086(.a(new_n130_), .b(new_n82_), .c(x25), .d(x01), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g088(.a(new_n120_), .b(x30), .c(x29), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x31), .O(new_n134_));
  inv1   g090(.a(new_n104_), .O(new_n135_));
  inv1   g091(.a(new_n105_), .O(new_n136_));
  inv1   g092(.a(new_n106_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(new_n136_), .c(new_n135_), .d(new_n103_), .O(new_n138_));
  nor2   g094(.a(new_n113_), .b(new_n60_), .O(new_n139_));
