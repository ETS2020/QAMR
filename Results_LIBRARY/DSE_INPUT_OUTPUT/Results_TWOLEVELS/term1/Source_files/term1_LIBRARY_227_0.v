...
module FAU ( 
  ...
  aoi21  g048(.a(new_n92_), .b(x30), .c(x27), .O(z3));
  inv1   g049(.a(x25), .O(new_n94_));
  nand3  g050(.a(x30), .b(x28), .c(new_n45_), .O(new_n95_));
  oai21  g051(.a(x28), .b(new_n45_), .c(new_n95_), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n91_), .c(new_n81_), .O(new_n97_));
  nor3   g053(.a(new_n97_), .b(new_n94_), .c(new_n60_), .O(z4));
  xnor2a g054(.a(x29), .b(x28), .O(new_n99_));
  inv1   g055(.a(x29), .O(new_n100_));
  nor2   g056(.a(new_n46_), .b(new_n100_), .O(new_n101_));
  nand2  g057(.a(new_n101_), .b(new_n45_), .O(new_n102_));
  oai21  g058(.a(new_n99_), .b(new_n45_), .c(new_n102_), .O(new_n103_));
  nand4  g059(.a(new_n103_), .b(new_n89_), .c(new_n62_), .d(new_n81_), .O(new_n104_));
  nor3   g060(.a(new_n104_), .b(new_n94_), .c(new_n60_), .O(z5));
  nand2  g061(.a(x30), .b(new_n45_), .O(new_n106_));
  nand2  g062(.a(new_n46_), .b(x29), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n45_), .c(new_n106_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x28), .O(new_n109_));
  inv1   g065(.a(x28), .O(new_n110_));
  oai21  g066(.a(new_n100_), .b(new_n110_), .c(x30), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(new_n109_), .c(new_n90_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n113_));
  nor2   g069(.a(new_n113_), .b(new_n60_), .O(z6));
  nor4   g070(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n115_));
  nand4  g071(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n115_), .c(new_n47_), .O(new_n117_));
  nand2  g073(.a(x31), .b(new_n46_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nor2   g075(.a(new_n100_), .b(new_n110_), .O(new_n120_));
  nand3  g076(.a(new_n120_), .b(new_n119_), .c(x30), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n118_), .O(new_n122_));
  aoi21  g078(.a(new_n120_), .b(x27), .c(new_n119_), .O(new_n123_));
  aoi22  g079(.a(new_n123_), .b(x30), .c(new_n122_), .d(x27), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n117_), .O(z7));
  nor3   g081(.a(new_n46_), .b(new_n100_), .c(x28), .O(new_n126_));
  nor2   g082(.a(x30), .b(x29), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n126_), .c(x27), .O(new_n128_));
  ...
  nor2   g091(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x17), .c(x11), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n133_), .O(new_n138_));
  aoi21  g094(.a(new_n136_), .b(x12), .c(x17), .O(new_n139_));
  nand2  g095(.a(x19), .b(x13), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n134_), .O(new_n141_));
  nor2   g097(.a(x19), .b(x14), .O(new_n142_));
  nand2  g098(.a(x16), .b(x15), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n131_), .O(new_n144_));
  nor2   g100(.a(new_n144_), .b(new_n142_), .O(new_n145_));
  aoi21  g101(.a(new_n101_), .b(x28), .c(new_n119_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n145_), .c(new_n141_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n139_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n138_), .c(new_n132_), .d(new_n128_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  nand2  g107(.a(new_n110_), .b(new_n45_), .O(new_n152_));
  nand2  g108(.a(x30), .b(new_n100_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(new_n107_), .O(new_n154_));
  inv1   g110(.a(x17), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n134_), .c(x13), .O(new_n156_));
  nand3  g112(.a(new_n135_), .b(x18), .c(x14), .O(new_n157_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n154_), .c(new_n151_), .d(x31), .O(new_n168_));
  ...
  nand2  g127(.a(new_n81_), .b(x00), .O(new_n172_));
  nand3  g128(.a(x33), .b(x30), .c(new_n110_), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n172_), .c(x30), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n45_), .O(new_n175_));
  aoi21  g131(.a(new_n163_), .b(new_n161_), .c(new_n129_), .O(new_n176_));
  inv1   g132(.a(new_n166_), .O(new_n177_));
  nand4  g133(.a(new_n152_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  nand3  g134(.a(new_n119_), .b(new_n46_), .c(new_n100_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  oai21  g136(.a(new_n177_), .b(new_n176_), .c(new_n180_), .O(new_n181_));
  inv1   g137(.a(new_n132_), .O(new_n182_));
  inv1   g138(.a(new_n139_), .O(new_n183_));
  nand2  g139(.a(new_n119_), .b(x29), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n153_), .c(new_n118_), .O(new_n185_));
  nor3   g141(.a(new_n185_), .b(new_n144_), .c(new_n142_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n141_), .c(new_n183_), .d(new_n138_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n182_), .c(x33), .O(new_n188_));
  oai21  g144(.a(new_n181_), .b(x33), .c(new_n188_), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n81_), .c(x00), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n175_), .O(z9));
endmodule
