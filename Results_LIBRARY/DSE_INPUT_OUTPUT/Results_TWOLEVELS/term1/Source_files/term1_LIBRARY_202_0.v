...
module FAU ( 
  ...
  nand4  g047(.a(new_n91_), .b(x25), .c(x01), .d(x00), .O(new_n92_));
  inv1   g048(.a(new_n92_), .O(z3));
  xor2a  g049(.a(x28), .b(x27), .O(new_n94_));
  nand4  g050(.a(new_n94_), .b(new_n89_), .c(x25), .d(x01), .O(new_n95_));
  ...
  nand3  g064(.a(new_n98_), .b(new_n108_), .c(x29), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n88_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n60_), .c(x25), .d(x01), .O(new_n111_));
  aoi21  g067(.a(new_n111_), .b(x00), .c(x26), .O(z6));
  nor2   g068(.a(new_n108_), .b(new_n101_), .O(new_n113_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n99_), .c(new_n46_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n108_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n101_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n108_), .c(new_n130_), .O(new_n132_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n132_), .c(new_n127_), .d(x31), .O(new_n151_));
  inv1   g107(.a(x00), .O(new_n152_));
  nand2  g108(.a(new_n113_), .b(x27), .O(new_n153_));
  oai21  g109(.a(x30), .b(x27), .c(new_n153_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n97_), .O(new_n155_));
  ...
  oai21  g115(.a(new_n159_), .b(new_n158_), .c(new_n142_), .O(new_n160_));
  inv1   g116(.a(x12), .O(new_n161_));
  oai21  g117(.a(new_n158_), .b(new_n161_), .c(new_n133_), .O(new_n162_));
  nand2  g118(.a(x19), .b(x13), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n134_), .O(new_n164_));
  nand2  g120(.a(x16), .b(x15), .O(new_n165_));
  oai22  g121(.a(new_n165_), .b(new_n143_), .c(x19), .d(x14), .O(new_n166_));
  inv1   g122(.a(new_n166_), .O(new_n167_));
  oai21  g123(.a(x30), .b(x29), .c(x31), .O(new_n168_));
  aoi21  g124(.a(new_n113_), .b(x28), .c(new_n168_), .O(new_n169_));
  nand4  g125(.a(new_n169_), .b(new_n167_), .c(new_n164_), .d(new_n162_), .O(new_n170_));
  inv1   g126(.a(new_n170_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n160_), .c(new_n157_), .d(new_n155_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(x32), .c(new_n152_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n151_), .c(x26), .O(z8));
  ...
  nand3  g134(.a(new_n178_), .b(new_n129_), .c(x29), .O(new_n179_));
  inv1   g135(.a(new_n131_), .O(new_n180_));
  nand4  g136(.a(new_n150_), .b(new_n175_), .c(new_n122_), .d(new_n108_), .O(new_n181_));
  nand2  g137(.a(x33), .b(x31), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n181_), .O(new_n183_));
  inv1   g139(.a(new_n157_), .O(new_n184_));
  xor2a  g140(.a(x31), .b(x30), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n166_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n184_), .c(x33), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x00), .O(new_n189_));
  aoi21  g145(.a(new_n183_), .b(new_n180_), .c(new_n189_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n179_), .c(x26), .O(z9));
endmodule
