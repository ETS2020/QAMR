...
module FAU ( 
  ...
  aoi21  g071(.a(new_n104_), .b(x28), .c(x27), .O(new_n116_));
  oai22  g072(.a(new_n116_), .b(new_n97_), .c(new_n115_), .d(new_n104_), .O(new_n117_));
  ...
  nor2   g106(.a(new_n104_), .b(new_n97_), .O(new_n151_));
  aoi21  g107(.a(new_n151_), .b(x28), .c(new_n150_), .O(new_n152_));
  ...
  nand2  g115(.a(new_n121_), .b(x14), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(x18), .c(x17), .d(x16), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n133_), .O(new_n162_));
  ...
  oai21  g121(.a(new_n164_), .b(new_n139_), .c(new_n133_), .O(new_n166_));
  inv1   g122(.a(x11), .O(new_n167_));
  oai21  g123(.a(new_n164_), .b(new_n167_), .c(new_n127_), .O(new_n168_));
  nand2  g124(.a(x18), .b(x12), .O(new_n169_));
  aoi22  g125(.a(new_n169_), .b(new_n118_), .c(new_n119_), .d(new_n145_), .O(new_n170_));
  ...
  aoi21  g128(.a(new_n137_), .b(new_n150_), .c(x30), .O(new_n173_));
  nand2  g129(.a(new_n150_), .b(x30), .O(new_n174_));
  oai21  g130(.a(new_n115_), .b(new_n150_), .c(new_n174_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n80_), .c(new_n173_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n172_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(x33), .O(new_n178_));
  aoi21  g134(.a(new_n130_), .b(new_n126_), .c(new_n133_), .O(new_n179_));
  inv1   g135(.a(new_n134_), .O(new_n180_));
  nand3  g136(.a(new_n115_), .b(x31), .c(x30), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nor3   g138(.a(x31), .b(x30), .c(x28), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n182_), .c(new_n80_), .O(new_n184_));
  nand3  g140(.a(new_n150_), .b(new_n104_), .c(new_n97_), .O(new_n185_));
