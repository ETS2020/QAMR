...
module FAU ( 
  ...
  nand2  g107(.a(new_n119_), .b(x27), .O(new_n152_));
  ...
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n142_), .O(new_n159_));
  inv1   g115(.a(x12), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(new_n160_), .c(new_n83_), .O(new_n161_));
  ...
  nand4  g138(.a(new_n150_), .b(new_n177_), .c(new_n118_), .d(new_n113_), .O(new_n183_));
  ...
  oai21  g144(.a(new_n188_), .b(new_n165_), .c(new_n89_), .O(new_n189_));
  oai21  g145(.a(new_n188_), .b(new_n155_), .c(new_n148_), .O(new_n190_));
  inv1   g146(.a(x11), .O(new_n191_));
  oai21  g147(.a(new_n188_), .b(new_n191_), .c(new_n142_), .O(new_n192_));
  oai21  g148(.a(new_n86_), .b(new_n160_), .c(new_n83_), .O(new_n193_));
  nand2  g149(.a(new_n86_), .b(new_n162_), .O(new_n194_));
  ...
  aoi21  g156(.a(new_n185_), .b(new_n182_), .c(new_n200_), .O(new_n201_));
  aoi21  g157(.a(new_n201_), .b(new_n181_), .c(new_n45_), .O(z9));
endmodule
