...
module FAU ( 
  ...
  aoi21  g046(.a(new_n90_), .b(new_n79_), .c(x27), .O(z3));
  inv1   g047(.a(x25), .O(new_n92_));
  nand3  g048(.a(new_n79_), .b(x28), .c(new_n45_), .O(new_n93_));
  oai21  g049(.a(x28), .b(new_n45_), .c(new_n93_), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n89_), .c(new_n80_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n92_), .c(new_n58_), .O(z4));
  ...
  nand4  g057(.a(new_n101_), .b(new_n88_), .c(new_n60_), .d(new_n80_), .O(new_n102_));
  ...
  nand3  g063(.a(new_n79_), .b(x29), .c(x28), .O(new_n108_));
  oai21  g064(.a(new_n107_), .b(new_n79_), .c(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n88_), .c(new_n60_), .d(x27), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n80_), .c(x25), .d(x01), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(z6));
  nor4   g069(.a(new_n86_), .b(new_n85_), .c(new_n83_), .d(new_n81_), .O(new_n114_));
  nand4  g070(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n114_), .c(new_n47_), .O(new_n116_));
  inv1   g072(.a(x31), .O(new_n117_));
  nand3  g073(.a(new_n107_), .b(new_n117_), .c(x30), .O(new_n118_));
  oai21  g074(.a(new_n107_), .b(new_n117_), .c(new_n118_), .O(new_n119_));
  aoi22  g075(.a(new_n119_), .b(x27), .c(x31), .d(new_n79_), .O(new_n120_));
  nand2  g076(.a(new_n120_), .b(new_n116_), .O(z7));
  nand2  g077(.a(new_n80_), .b(x00), .O(new_n122_));
  nand3  g078(.a(x32), .b(new_n79_), .c(new_n97_), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n122_), .c(new_n79_), .O(new_n124_));
  nand2  g080(.a(new_n124_), .b(new_n45_), .O(new_n125_));
  inv1   g081(.a(x32), .O(new_n126_));
  nand2  g082(.a(new_n97_), .b(new_n45_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n79_), .c(x29), .O(new_n128_));
  nand2  g084(.a(x30), .b(new_n99_), .O(new_n129_));
  ...
  oai21  g112(.a(new_n153_), .b(new_n156_), .c(new_n131_), .O(new_n157_));
  inv1   g113(.a(x13), .O(new_n158_));
  oai21  g114(.a(new_n134_), .b(new_n158_), .c(new_n132_), .O(new_n159_));
  nand2  g115(.a(x16), .b(x15), .O(new_n160_));
  oai22  g116(.a(new_n160_), .b(new_n141_), .c(x19), .d(x14), .O(new_n161_));
  aoi21  g117(.a(new_n79_), .b(new_n99_), .c(new_n117_), .O(new_n162_));
  oai21  g118(.a(new_n79_), .b(new_n99_), .c(new_n162_), .O(new_n163_));
  ...
  oai21  g129(.a(new_n173_), .b(new_n160_), .c(new_n134_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n150_), .c(new_n146_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n140_), .O(new_n177_));
  nand2  g133(.a(x18), .b(x12), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n131_), .c(new_n132_), .d(new_n158_), .O(new_n179_));
  ...
  oai21  g137(.a(x31), .b(new_n99_), .c(new_n129_), .O(new_n182_));
  aoi21  g138(.a(new_n106_), .b(new_n117_), .c(x30), .O(new_n183_));
  aoi21  g139(.a(new_n182_), .b(x27), .c(new_n183_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n181_), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(x33), .O(new_n186_));
  aoi21  g142(.a(new_n143_), .b(new_n139_), .c(new_n146_), .O(new_n187_));
  inv1   g143(.a(new_n147_), .O(new_n188_));
  nand2  g144(.a(new_n127_), .b(x29), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n117_), .c(new_n79_), .O(new_n190_));
  nand4  g146(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  oai21  g148(.a(new_n188_), .b(new_n187_), .c(new_n192_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(x33), .c(new_n186_), .O(new_n194_));
