...
module FAU ( 
  ...
  nand3  g061(.a(new_n105_), .b(new_n97_), .c(new_n47_), .O(new_n106_));
  ...
  nand2  g073(.a(new_n117_), .b(new_n47_), .O(z5));
  ...
  nand3  g079(.a(new_n123_), .b(x30), .c(x06), .O(new_n124_));
  ...
  nand2  g087(.a(new_n131_), .b(x06), .O(new_n132_));
  nand2  g088(.a(new_n132_), .b(x30), .O(new_n133_));
  nor2   g089(.a(new_n45_), .b(new_n110_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n112_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x31), .O(new_n136_));
  inv1   g092(.a(new_n82_), .O(new_n137_));
  nand4  g093(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n137_), .O(new_n138_));
  ...
  nand3  g100(.a(new_n144_), .b(new_n45_), .c(x29), .O(new_n145_));
  nor2   g101(.a(new_n143_), .b(new_n110_), .O(new_n146_));
  oai21  g102(.a(new_n146_), .b(new_n45_), .c(new_n145_), .O(new_n147_));
  ...
  oai21  g129(.a(new_n155_), .b(new_n173_), .c(new_n83_), .O(new_n174_));
  inv1   g130(.a(x13), .O(new_n175_));
  oai21  g131(.a(new_n89_), .b(new_n175_), .c(new_n86_), .O(new_n176_));
  ...
  nand4  g150(.a(new_n164_), .b(new_n189_), .c(new_n130_), .d(new_n45_), .O(new_n195_));
  ...
  oai21  g162(.a(new_n86_), .b(new_n173_), .c(new_n83_), .O(new_n207_));
  nand2  g163(.a(new_n86_), .b(new_n175_), .O(new_n208_));
  ...
  nand2  g171(.a(new_n215_), .b(new_n47_), .O(z9));
endmodule
