...
module FAU ( 
  ...
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n47_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n107_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n95_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n107_), .c(new_n130_), .O(new_n132_));
  ...
  nand2  g109(.a(new_n112_), .b(x27), .O(new_n154_));
  ...
  aoi21  g124(.a(new_n112_), .b(x28), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g138(.a(new_n152_), .b(new_n177_), .c(new_n122_), .d(new_n107_), .O(new_n183_));
