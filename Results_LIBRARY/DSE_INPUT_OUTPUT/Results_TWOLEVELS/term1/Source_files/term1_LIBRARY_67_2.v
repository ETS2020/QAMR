...
module FAU ( 
  ...
  nand4  g050(.a(new_n94_), .b(new_n81_), .c(new_n45_), .d(x25), .O(new_n95_));
  oai21  g051(.a(new_n95_), .b(new_n60_), .c(new_n47_), .O(z3));
  xor2a  g052(.a(x28), .b(x27), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n45_), .d(x25), .O(new_n98_));
  oai21  g054(.a(new_n98_), .b(new_n60_), .c(new_n47_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n62_), .d(new_n45_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n100_), .c(new_n60_), .O(z5));
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n62_), .d(new_n45_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n100_), .c(new_n60_), .O(z6));
  nand3  g071(.a(new_n104_), .b(x30), .c(x29), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  inv1   g073(.a(new_n82_), .O(new_n118_));
  nand4  g074(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n118_), .O(new_n119_));
  nor2   g075(.a(new_n61_), .b(new_n60_), .O(new_n120_));
  inv1   g076(.a(new_n104_), .O(new_n121_));
  inv1   g077(.a(x31), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(x30), .c(x29), .O(new_n123_));
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n45_), .O(new_n124_));
  nor2   g080(.a(new_n124_), .b(new_n100_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n120_), .c(new_n119_), .d(new_n117_), .O(z7));
  nand2  g082(.a(new_n103_), .b(new_n81_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(x29), .O(new_n128_));
  inv1   g084(.a(x32), .O(new_n129_));
  nand3  g085(.a(x19), .b(new_n86_), .c(x13), .O(new_n130_));
  nand3  g086(.a(new_n89_), .b(x18), .c(x14), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n130_), .c(new_n83_), .O(new_n132_));
  nand4  g088(.a(x19), .b(x18), .c(new_n83_), .d(x12), .O(new_n133_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n129_), .c(x31), .d(x30), .O(new_n145_));
  nand2  g101(.a(x32), .b(new_n111_), .O(new_n146_));
  oai21  g102(.a(new_n145_), .b(x26), .c(new_n146_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n128_), .O(new_n148_));
  nand4  g104(.a(new_n144_), .b(new_n127_), .c(new_n129_), .d(x31), .O(new_n149_));
  nand2  g105(.a(new_n103_), .b(new_n81_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(x32), .c(x30), .d(new_n45_), .O(new_n151_));
  oai21  g107(.a(new_n149_), .b(x30), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x29), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n137_), .c(new_n142_), .O(new_n155_));
  nor2   g111(.a(new_n89_), .b(new_n86_), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(x17), .c(x11), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n136_), .O(new_n158_));
  nand2  g114(.a(new_n156_), .b(x12), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n83_), .O(new_n160_));
  aoi21  g116(.a(x19), .b(x13), .c(x18), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  nand2  g118(.a(x16), .b(x15), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n137_), .c(x31), .O(new_n164_));
  nor3   g120(.a(new_n164_), .b(new_n162_), .c(new_n161_), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n160_), .c(new_n158_), .d(new_n155_), .O(new_n166_));
  nand3  g122(.a(new_n166_), .b(x32), .c(new_n45_), .O(new_n167_));
  nand3  g123(.a(new_n167_), .b(new_n153_), .c(new_n148_), .O(new_n168_));
  nand2  g124(.a(new_n168_), .b(x00), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n47_), .O(z8));
  inv1   g126(.a(x33), .O(new_n171_));
  nand4  g127(.a(new_n144_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x33), .b(new_n122_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n127_), .c(x29), .O(new_n175_));
  nand4  g131(.a(new_n144_), .b(new_n171_), .c(new_n122_), .d(new_n111_), .O(new_n176_));
  oai21  g132(.a(new_n171_), .b(new_n122_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n128_), .O(new_n178_));
  aoi21  g134(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x17), .c(x16), .d(x15), .O(new_n180_));
  nand2  g136(.a(x18), .b(x17), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n163_), .c(new_n89_), .O(new_n182_));
  oai21  g138(.a(new_n181_), .b(new_n154_), .c(new_n142_), .O(new_n183_));
  inv1   g139(.a(x11), .O(new_n184_));
  oai21  g140(.a(new_n181_), .b(new_n184_), .c(new_n136_), .O(new_n185_));
  nand2  g141(.a(x18), .b(x12), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n83_), .O(new_n187_));
  inv1   g143(.a(x13), .O(new_n188_));
  nand2  g144(.a(new_n86_), .b(new_n188_), .O(new_n189_));
  xnor2a g145(.a(x31), .b(x30), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n187_), .d(new_n185_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n183_), .c(new_n182_), .d(new_n180_), .O(new_n193_));
  nand2  g149(.a(new_n193_), .b(x33), .O(new_n194_));
  nand3  g150(.a(new_n194_), .b(new_n178_), .c(new_n175_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n45_), .c(x00), .O(new_n196_));
