...
module FAU ( 
  ...
  nand4  g063(.a(new_n107_), .b(new_n102_), .c(new_n101_), .d(new_n81_), .O(new_n108_));
  nor3   g064(.a(new_n108_), .b(new_n80_), .c(new_n61_), .O(z5));
  ...
  nand4  g070(.a(new_n114_), .b(new_n102_), .c(new_n101_), .d(new_n81_), .O(new_n115_));
  ...
  aoi21  g082(.a(new_n126_), .b(new_n105_), .c(new_n80_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n124_), .c(new_n123_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n121_), .c(new_n81_), .O(new_n129_));
  oai21  g085(.a(new_n81_), .b(new_n45_), .c(new_n129_), .O(z7));
  ...
  nand2  g110(.a(new_n120_), .b(x27), .O(new_n155_));
  ...
  nand2  g135(.a(x33), .b(new_n119_), .O(new_n180_));
  ...
  nand4  g139(.a(new_n153_), .b(new_n178_), .c(new_n119_), .d(new_n112_), .O(new_n184_));
