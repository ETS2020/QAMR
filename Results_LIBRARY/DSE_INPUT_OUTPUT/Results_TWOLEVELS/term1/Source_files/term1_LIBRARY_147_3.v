...
module FAU ( 
  ...
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n61_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n80_), .c(new_n60_), .O(z5));
  nor2   g066(.a(new_n106_), .b(new_n98_), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n46_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n95_), .c(new_n81_), .d(x25), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n60_), .c(new_n48_), .O(z6));
  nand4  g071(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n84_), .O(new_n116_));
  nand2  g072(.a(new_n61_), .b(x01), .O(new_n117_));
  nor4   g073(.a(new_n117_), .b(x31), .c(x26), .d(new_n80_), .O(new_n118_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n99_), .c(new_n45_), .O(new_n122_));
  ...
  aoi21  g096(.a(new_n46_), .b(new_n106_), .c(new_n140_), .O(new_n141_));
  ...
  oai22  g103(.a(new_n147_), .b(new_n106_), .c(new_n111_), .d(new_n46_), .O(new_n148_));
  ...
  nand3  g111(.a(new_n138_), .b(new_n155_), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x15), .O(new_n158_));
  nand3  g114(.a(x16), .b(new_n123_), .c(x10), .O(new_n159_));
  nor2   g115(.a(new_n159_), .b(new_n125_), .O(new_n160_));
  ...
  aoi21  g125(.a(new_n156_), .b(new_n154_), .c(new_n123_), .O(new_n170_));
  oai21  g126(.a(x28), .b(x27), .c(x29), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n140_), .c(new_n46_), .O(new_n172_));
  nand3  g128(.a(new_n111_), .b(x31), .c(x30), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n172_), .O(new_n174_));
  oai21  g130(.a(new_n160_), .b(new_n170_), .c(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n111_), .b(x30), .c(new_n140_), .O(new_n176_));
  nand2  g132(.a(new_n120_), .b(x31), .O(new_n177_));
  nand4  g133(.a(new_n139_), .b(new_n137_), .c(new_n135_), .d(new_n132_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n130_), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(new_n177_), .c(new_n176_), .d(new_n126_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x33), .O(new_n181_));
  oai21  g137(.a(new_n175_), .b(x33), .c(new_n181_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n81_), .c(x00), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n169_), .O(z9));
endmodule
