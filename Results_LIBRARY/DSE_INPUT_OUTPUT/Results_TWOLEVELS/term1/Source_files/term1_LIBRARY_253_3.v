...
module FAU ( 
  ...
  oai21  g049(.a(new_n93_), .b(new_n60_), .c(new_n58_), .O(z4));
  ...
  oai21  g056(.a(new_n100_), .b(new_n60_), .c(new_n58_), .O(z6));
  inv1   g057(.a(new_n85_), .O(new_n102_));
  inv1   g058(.a(new_n86_), .O(new_n103_));
  inv1   g059(.a(new_n87_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n103_), .c(new_n102_), .d(new_n84_), .O(new_n105_));
  inv1   g061(.a(x31), .O(new_n106_));
  nand3  g062(.a(new_n106_), .b(new_n81_), .c(x25), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n61_), .c(new_n60_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n105_), .c(new_n47_), .O(z7));
  inv1   g065(.a(x15), .O(new_n110_));
  nand2  g066(.a(x16), .b(x10), .O(new_n111_));
  ...
  oai21  g076(.a(new_n116_), .b(new_n119_), .c(new_n120_), .O(new_n121_));
  ...
  oai21  g083(.a(new_n127_), .b(new_n112_), .c(x31), .O(new_n128_));
  aoi21  g084(.a(new_n126_), .b(new_n125_), .c(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(new_n124_), .c(new_n121_), .d(new_n118_), .O(new_n130_));
  oai21  g086(.a(new_n130_), .b(new_n114_), .c(new_n58_), .O(new_n131_));
  inv1   g087(.a(x30), .O(new_n132_));
  nand3  g088(.a(x30), .b(x29), .c(x28), .O(new_n133_));
  oai21  g089(.a(x30), .b(x28), .c(new_n133_), .O(new_n134_));
  aoi22  g090(.a(new_n134_), .b(new_n45_), .c(new_n132_), .d(new_n46_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n131_), .O(new_n136_));
  nand2  g092(.a(new_n136_), .b(x32), .O(new_n137_));
  inv1   g093(.a(x32), .O(new_n138_));
  nand3  g094(.a(new_n132_), .b(x29), .c(x28), .O(new_n139_));
  oai21  g095(.a(new_n132_), .b(x28), .c(new_n139_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n45_), .O(new_n141_));
  oai21  g097(.a(new_n132_), .b(x29), .c(new_n141_), .O(new_n142_));
  nand3  g098(.a(x19), .b(new_n122_), .c(x13), .O(new_n143_));
  nand3  g099(.a(new_n126_), .b(x18), .c(x14), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(new_n120_), .O(new_n145_));
  nand4  g101(.a(x19), .b(x18), .c(new_n120_), .d(x12), .O(new_n146_));
  inv1   g102(.a(new_n146_), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n145_), .c(x16), .O(new_n148_));
  inv1   g104(.a(new_n112_), .O(new_n149_));
  nand3  g105(.a(new_n149_), .b(new_n115_), .c(x11), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n148_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(x15), .O(new_n152_));
  nand4  g108(.a(new_n149_), .b(x16), .c(new_n110_), .d(x10), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n152_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n142_), .c(new_n138_), .d(x31), .O(new_n155_));
  ...
  nand2  g115(.a(x29), .b(x28), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(new_n161_));
  inv1   g117(.a(x33), .O(new_n162_));
  nand4  g118(.a(new_n154_), .b(new_n162_), .c(new_n106_), .d(new_n132_), .O(new_n163_));
  nand2  g119(.a(x33), .b(x31), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n163_), .c(new_n161_), .O(new_n165_));
  nand3  g121(.a(x28), .b(new_n126_), .c(x14), .O(new_n166_));
  nand4  g122(.a(new_n162_), .b(x31), .c(x30), .d(x29), .O(new_n167_));
  oai22  g123(.a(new_n167_), .b(new_n166_), .c(new_n162_), .d(new_n126_), .O(new_n168_));
  nand4  g124(.a(x28), .b(x19), .c(new_n122_), .d(x13), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n167_), .O(new_n170_));
  aoi21  g126(.a(new_n168_), .b(x18), .c(new_n170_), .O(new_n171_));
  nand3  g127(.a(new_n162_), .b(x31), .c(x30), .O(new_n172_));
  inv1   g128(.a(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n161_), .O(new_n174_));
  oai22  g130(.a(new_n174_), .b(new_n146_), .c(new_n171_), .d(new_n120_), .O(new_n175_));
  nor2   g131(.a(new_n174_), .b(new_n150_), .O(new_n176_));
  aoi21  g132(.a(new_n175_), .b(x16), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(x33), .b(new_n132_), .O(new_n178_));
  nor2   g134(.a(new_n120_), .b(new_n115_), .O(new_n179_));
  nor2   g135(.a(new_n172_), .b(new_n116_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n179_), .c(new_n110_), .d(x10), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n178_), .c(new_n46_), .O(new_n182_));
  nand2  g138(.a(new_n126_), .b(new_n125_), .O(new_n183_));
  nand2  g139(.a(new_n106_), .b(x30), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n183_), .c(new_n124_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  nand4  g142(.a(new_n186_), .b(new_n121_), .c(new_n118_), .d(new_n113_), .O(new_n187_));
  aoi22  g143(.a(new_n187_), .b(x33), .c(new_n182_), .d(x28), .O(new_n188_));
  oai21  g144(.a(new_n177_), .b(new_n110_), .c(new_n188_), .O(new_n189_));
  oai21  g145(.a(new_n189_), .b(new_n165_), .c(new_n81_), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n159_), .c(new_n58_), .O(z9));
endmodule
