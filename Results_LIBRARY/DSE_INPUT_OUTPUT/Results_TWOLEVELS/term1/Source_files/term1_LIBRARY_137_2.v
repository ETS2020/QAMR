...
module FAU ( 
  ...
  nand2  g057(.a(new_n83_), .b(new_n82_), .O(new_n102_));
  ...
  nand2  g062(.a(new_n106_), .b(new_n46_), .O(new_n107_));
  aoi22  g063(.a(new_n107_), .b(new_n97_), .c(new_n101_), .d(new_n99_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n109_));
  nor2   g065(.a(new_n109_), .b(new_n59_), .O(z5));
  nor2   g066(.a(new_n98_), .b(new_n81_), .O(new_n111_));
  nand2  g067(.a(new_n106_), .b(x29), .O(new_n112_));
  aoi21  g068(.a(new_n112_), .b(new_n97_), .c(new_n111_), .O(new_n113_));
  nor2   g069(.a(new_n90_), .b(x29), .O(new_n114_));
  oai21  g070(.a(new_n114_), .b(new_n113_), .c(x30), .O(new_n115_));
  inv1   g071(.a(x21), .O(new_n116_));
  nand3  g072(.a(new_n89_), .b(new_n102_), .c(x16), .O(new_n117_));
  nand4  g073(.a(new_n117_), .b(new_n45_), .c(x29), .d(x28), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(x27), .c(new_n116_), .O(new_n120_));
  ...
  oai21  g079(.a(x31), .b(x21), .c(new_n45_), .O(new_n124_));
  nand3  g080(.a(x29), .b(x28), .c(x27), .O(new_n125_));
  nand2  g081(.a(new_n125_), .b(x31), .O(new_n126_));
  nand4  g082(.a(new_n105_), .b(new_n104_), .c(new_n103_), .d(new_n85_), .O(new_n127_));
  ...
  nand2  g090(.a(new_n98_), .b(new_n81_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n45_), .c(x29), .O(new_n136_));
  ...
  nand4  g110(.a(new_n151_), .b(x16), .c(new_n82_), .d(x10), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n154_), .O(new_n156_));
  nand4  g112(.a(new_n156_), .b(new_n139_), .c(new_n134_), .d(x31), .O(new_n157_));
  nor2   g113(.a(new_n45_), .b(new_n100_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(x27), .O(new_n159_));
  oai21  g115(.a(x30), .b(x27), .c(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n98_), .O(new_n161_));
  nand2  g117(.a(x16), .b(x10), .O(new_n162_));
  oai21  g118(.a(new_n162_), .b(new_n150_), .c(new_n82_), .O(new_n163_));
  nand2  g119(.a(x19), .b(x18), .O(new_n164_));
  nand2  g120(.a(x17), .b(x11), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n164_), .c(new_n149_), .O(new_n166_));
  inv1   g122(.a(x12), .O(new_n167_));
  oai21  g123(.a(new_n164_), .b(new_n167_), .c(new_n140_), .O(new_n168_));
  inv1   g124(.a(x13), .O(new_n169_));
  oai21  g125(.a(new_n143_), .b(new_n169_), .c(new_n141_), .O(new_n170_));
  ...
  aoi21  g131(.a(new_n158_), .b(x28), .c(new_n175_), .O(new_n176_));
  ...
  nand2  g139(.a(new_n143_), .b(x14), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(x18), .c(x17), .d(x16), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n82_), .O(new_n186_));
  nand2  g142(.a(x18), .b(x17), .O(new_n187_));
  oai21  g143(.a(new_n187_), .b(new_n172_), .c(new_n143_), .O(new_n188_));
  oai21  g144(.a(new_n187_), .b(new_n162_), .c(new_n82_), .O(new_n189_));
  inv1   g145(.a(x11), .O(new_n190_));
  oai21  g146(.a(new_n187_), .b(new_n190_), .c(new_n149_), .O(new_n191_));
  nand2  g147(.a(x18), .b(x12), .O(new_n192_));
  aoi22  g148(.a(new_n192_), .b(new_n140_), .c(new_n141_), .d(new_n169_), .O(new_n193_));
  ...
  nand3  g151(.a(new_n135_), .b(new_n129_), .c(x29), .O(new_n196_));
  oai21  g152(.a(new_n129_), .b(x30), .c(new_n196_), .O(new_n197_));
  nor2   g153(.a(new_n129_), .b(new_n100_), .O(new_n198_));
  aoi21  g154(.a(new_n198_), .b(new_n135_), .c(new_n45_), .O(new_n199_));
  aoi21  g155(.a(new_n197_), .b(new_n116_), .c(new_n199_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n195_), .O(new_n201_));
  nand2  g157(.a(new_n201_), .b(x33), .O(new_n202_));
  aoi21  g158(.a(new_n152_), .b(new_n148_), .c(new_n82_), .O(new_n203_));
  inv1   g159(.a(new_n155_), .O(new_n204_));
  nand4  g160(.a(new_n137_), .b(new_n129_), .c(new_n45_), .d(new_n116_), .O(new_n205_));
  nand4  g161(.a(new_n135_), .b(x31), .c(x30), .d(x29), .O(new_n206_));
