...
module FAU ( 
  ...
  nand4  g049(.a(new_n93_), .b(new_n60_), .c(new_n81_), .d(new_n80_), .O(new_n94_));
  nor3   g050(.a(new_n94_), .b(new_n79_), .c(new_n59_), .O(z3));
  inv1   g051(.a(x28), .O(new_n96_));
  nor2   g052(.a(new_n45_), .b(x28), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x27), .O(new_n98_));
  oai21  g054(.a(new_n96_), .b(x27), .c(new_n98_), .O(new_n99_));
  nand4  g055(.a(new_n99_), .b(new_n93_), .c(new_n60_), .d(new_n80_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n79_), .c(new_n59_), .O(z4));
  ...
  oai21  g061(.a(new_n105_), .b(new_n102_), .c(new_n103_), .O(new_n106_));
  nand4  g062(.a(new_n106_), .b(new_n93_), .c(new_n60_), .d(new_n80_), .O(new_n107_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n93_), .c(new_n60_), .d(x30), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n80_), .c(x25), .d(x01), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(z6));
  nand3  g071(.a(new_n90_), .b(new_n87_), .c(new_n84_), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n91_), .O(new_n117_));
  nand4  g073(.a(new_n60_), .b(new_n80_), .c(x25), .d(x01), .O(new_n118_));
  ...
  aoi22  g080(.a(new_n124_), .b(x30), .c(x31), .d(new_n81_), .O(new_n125_));
  ...
  oai21  g091(.a(new_n132_), .b(new_n135_), .c(new_n85_), .O(new_n136_));
  inv1   g092(.a(x13), .O(new_n137_));
  inv1   g093(.a(x19), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n88_), .O(new_n139_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n139_), .c(new_n136_), .d(new_n134_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n130_), .c(new_n47_), .O(new_n145_));
  nand3  g101(.a(new_n120_), .b(new_n45_), .c(new_n81_), .O(new_n146_));
  nand2  g102(.a(new_n96_), .b(new_n81_), .O(new_n147_));
  ...
  nand3  g107(.a(new_n45_), .b(x29), .c(x28), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n97_), .c(new_n81_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n105_), .O(new_n155_));
  nand3  g111(.a(x19), .b(new_n88_), .c(x13), .O(new_n156_));
  nand3  g112(.a(new_n138_), .b(x18), .c(x14), .O(new_n157_));
  aoi21  g113(.a(new_n157_), .b(new_n156_), .c(new_n85_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(new_n85_), .d(x12), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n158_), .c(x16), .O(new_n161_));
  inv1   g117(.a(new_n128_), .O(new_n162_));
  ...
  nand2  g128(.a(new_n138_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x18), .c(x17), .d(x16), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n166_), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n141_), .c(new_n138_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n127_), .c(new_n166_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n131_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n85_), .c(new_n88_), .d(new_n137_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n175_), .c(new_n47_), .O(new_n184_));
  aoi21  g140(.a(x31), .b(x29), .c(new_n45_), .O(new_n185_));
  oai21  g141(.a(new_n45_), .b(new_n96_), .c(x31), .O(new_n186_));
  oai21  g142(.a(new_n123_), .b(new_n96_), .c(new_n186_), .O(new_n187_));
  aoi21  g143(.a(new_n187_), .b(new_n81_), .c(new_n185_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n184_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(x33), .O(new_n190_));
  aoi21  g146(.a(new_n163_), .b(new_n161_), .c(new_n166_), .O(new_n191_));
  inv1   g147(.a(new_n167_), .O(new_n192_));
  nand4  g148(.a(new_n120_), .b(new_n122_), .c(new_n45_), .d(new_n81_), .O(new_n193_));
  nand4  g149(.a(new_n147_), .b(x31), .c(x30), .d(x29), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  oai21  g151(.a(new_n192_), .b(new_n191_), .c(new_n195_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(x33), .c(new_n190_), .O(new_n197_));
