...
module FAU ( 
  ...
  nand3  g052(.a(new_n96_), .b(new_n92_), .c(new_n95_), .O(new_n97_));
  inv1   g053(.a(new_n97_), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(x25), .c(x01), .d(x00), .O(new_n99_));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n60_), .d(new_n95_), .O(new_n107_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n60_), .d(new_n95_), .O(new_n116_));
  ...
  inv1   g078(.a(new_n80_), .O(new_n123_));
  nand4  g079(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n123_), .O(new_n124_));
  nand3  g080(.a(new_n60_), .b(x25), .c(x01), .O(new_n125_));
  ...
  nand3  g091(.a(new_n135_), .b(new_n113_), .c(x29), .O(new_n136_));
  nor2   g092(.a(new_n134_), .b(new_n102_), .O(new_n137_));
  oai21  g093(.a(new_n137_), .b(new_n113_), .c(new_n136_), .O(new_n138_));
  nand3  g094(.a(x19), .b(new_n84_), .c(x13), .O(new_n139_));
  nand3  g095(.a(new_n87_), .b(x18), .c(x14), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n139_), .c(new_n81_), .O(new_n141_));
  nand4  g097(.a(x19), .b(x18), .c(new_n81_), .d(x12), .O(new_n142_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n138_), .c(new_n133_), .d(x31), .O(new_n154_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n161_), .c(new_n145_), .O(new_n163_));
  inv1   g119(.a(x12), .O(new_n164_));
  oai21  g120(.a(new_n161_), .b(new_n164_), .c(new_n81_), .O(new_n165_));
  nand2  g121(.a(x19), .b(x13), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n84_), .O(new_n167_));
  nand2  g123(.a(x16), .b(x15), .O(new_n168_));
  oai22  g124(.a(new_n168_), .b(new_n146_), .c(x19), .d(x14), .O(new_n169_));
  ...
  nand4  g130(.a(new_n174_), .b(new_n163_), .c(new_n160_), .d(new_n158_), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(x32), .c(new_n155_), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n154_), .c(x26), .O(z8));
  inv1   g133(.a(x33), .O(new_n178_));
  nand4  g134(.a(new_n153_), .b(new_n178_), .c(x31), .d(x30), .O(new_n179_));
  nand2  g135(.a(x33), .b(new_n128_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(new_n179_), .O(new_n181_));
  nand3  g137(.a(new_n181_), .b(new_n135_), .c(x29), .O(new_n182_));
  inv1   g138(.a(new_n137_), .O(new_n183_));
  nand4  g139(.a(new_n153_), .b(new_n178_), .c(new_n128_), .d(new_n113_), .O(new_n184_));
  ...
  nor2   g144(.a(new_n188_), .b(new_n169_), .O(new_n189_));
  ...
  aoi21  g148(.a(new_n186_), .b(new_n183_), .c(new_n192_), .O(new_n193_));
