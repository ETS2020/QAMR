...
module FAU ( 
  ...
  nand2  g054(.a(x28), .b(new_n45_), .O(new_n99_));
  inv1   g055(.a(x28), .O(new_n100_));
  nand2  g056(.a(new_n46_), .b(new_n100_), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n45_), .c(new_n99_), .O(new_n102_));
  ...
  aoi21  g061(.a(new_n46_), .b(new_n100_), .c(new_n45_), .O(new_n106_));
  nand2  g062(.a(x28), .b(x27), .O(new_n107_));
  nand2  g063(.a(new_n46_), .b(new_n105_), .O(new_n108_));
  oai22  g064(.a(new_n108_), .b(new_n107_), .c(new_n106_), .d(new_n105_), .O(new_n109_));
  ...
  oai22  g068(.a(new_n112_), .b(new_n107_), .c(new_n46_), .d(x27), .O(new_n113_));
  ...
  nand4  g081(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n121_), .O(new_n127_));
  nand3  g083(.a(x19), .b(x18), .c(x12), .O(new_n128_));
  nand2  g084(.a(new_n128_), .b(new_n85_), .O(new_n129_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n123_), .c(x31), .O(new_n134_));
  aoi21  g090(.a(new_n91_), .b(new_n132_), .c(new_n134_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n131_), .c(new_n129_), .d(new_n127_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n125_), .c(new_n48_), .O(new_n137_));
  nand3  g093(.a(x30), .b(x29), .c(x28), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n101_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n45_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n137_), .c(new_n108_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  nor2   g099(.a(new_n105_), .b(new_n100_), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(x30), .c(new_n45_), .O(new_n146_));
  nand2  g102(.a(new_n100_), .b(new_n45_), .O(new_n147_));
  nand3  g103(.a(new_n147_), .b(new_n46_), .c(x29), .O(new_n148_));
  ...
  nand3  g111(.a(new_n124_), .b(new_n121_), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x15), .O(new_n158_));
  nor4   g114(.a(new_n123_), .b(new_n121_), .c(x15), .d(new_n120_), .O(new_n159_));
  inv1   g115(.a(new_n159_), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n158_), .O(new_n161_));
  nand4  g117(.a(new_n161_), .b(new_n149_), .c(new_n143_), .d(x31), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n142_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n81_), .c(x00), .O(new_n164_));
  inv1   g120(.a(new_n164_), .O(z8));
  nand4  g121(.a(x33), .b(x29), .c(new_n81_), .d(x00), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n46_), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(x27), .O(new_n168_));
  inv1   g124(.a(x15), .O(new_n169_));
  aoi21  g125(.a(new_n156_), .b(new_n155_), .c(new_n169_), .O(new_n170_));
  inv1   g126(.a(x31), .O(new_n171_));
  nand2  g127(.a(new_n147_), .b(x29), .O(new_n172_));
  nand3  g128(.a(new_n172_), .b(new_n171_), .c(new_n46_), .O(new_n173_));
  nand3  g129(.a(new_n144_), .b(x31), .c(x30), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  oai21  g131(.a(new_n159_), .b(new_n170_), .c(new_n175_), .O(new_n176_));
  inv1   g132(.a(new_n125_), .O(new_n177_));
  oai21  g133(.a(new_n144_), .b(x30), .c(new_n171_), .O(new_n178_));
  nand2  g134(.a(new_n138_), .b(x31), .O(new_n179_));
  nand2  g135(.a(new_n91_), .b(new_n132_), .O(new_n180_));
  nand3  g136(.a(new_n124_), .b(x16), .c(x15), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n180_), .c(new_n131_), .d(new_n129_), .O(new_n182_));
  aoi21  g138(.a(new_n126_), .b(new_n121_), .c(new_n182_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n179_), .c(new_n178_), .d(new_n177_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  oai21  g141(.a(new_n176_), .b(x33), .c(new_n185_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n81_), .c(x00), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n168_), .O(z9));
endmodule
