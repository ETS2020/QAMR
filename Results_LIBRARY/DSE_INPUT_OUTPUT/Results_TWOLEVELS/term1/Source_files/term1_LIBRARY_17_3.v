...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n81_), .c(new_n46_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n80_), .c(new_n59_), .O(z3));
  inv1   g052(.a(new_n47_), .O(new_n97_));
  xor2a  g053(.a(x28), .b(x27), .O(new_n98_));
  nand4  g054(.a(new_n98_), .b(new_n94_), .c(new_n46_), .d(x25), .O(new_n99_));
  oai21  g055(.a(new_n99_), .b(new_n59_), .c(new_n97_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n61_), .d(new_n46_), .O(new_n107_));
  inv1   g063(.a(new_n107_), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x25), .c(x01), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(new_n97_), .O(z5));
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n61_), .d(new_n46_), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(new_n117_));
  nand3  g073(.a(new_n117_), .b(x25), .c(x01), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n97_), .O(z6));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n127_), .d(new_n113_), .O(new_n185_));
  ...
  nand2  g161(.a(new_n205_), .b(new_n97_), .O(z9));
endmodule
