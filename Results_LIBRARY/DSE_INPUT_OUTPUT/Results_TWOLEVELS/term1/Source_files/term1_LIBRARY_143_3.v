...
module FAU ( 
  ...
  oai21  g065(.a(new_n108_), .b(x27), .c(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n93_), .c(new_n79_), .O(new_n111_));
  nor3   g067(.a(new_n111_), .b(new_n78_), .c(new_n58_), .O(z6));
  ...
  aoi21  g073(.a(new_n108_), .b(x28), .c(x27), .O(new_n118_));
  nor2   g074(.a(new_n101_), .b(new_n99_), .O(new_n119_));
  oai22  g075(.a(new_n119_), .b(new_n108_), .c(new_n118_), .d(new_n101_), .O(new_n120_));
  ...
  nor2   g107(.a(new_n108_), .b(new_n101_), .O(new_n152_));
  ...
  oai21  g131(.a(new_n119_), .b(new_n151_), .c(new_n175_), .O(new_n176_));
  ...
  nand3  g137(.a(new_n119_), .b(x31), .c(x30), .O(new_n182_));
  ...
  nand3  g141(.a(new_n151_), .b(new_n108_), .c(new_n101_), .O(new_n186_));
