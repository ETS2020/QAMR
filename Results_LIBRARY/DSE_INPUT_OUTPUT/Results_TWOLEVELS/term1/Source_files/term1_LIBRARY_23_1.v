...
module FAU ( 
  ...
  oai21  g055(.a(new_n99_), .b(new_n59_), .c(new_n47_), .O(z4));
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n61_), .d(new_n81_), .O(new_n107_));
  nor3   g063(.a(new_n107_), .b(new_n80_), .c(new_n59_), .O(z5));
  nand3  g064(.a(x29), .b(x28), .c(x27), .O(new_n109_));
  nand2  g065(.a(new_n109_), .b(x30), .O(new_n110_));
  nand3  g066(.a(new_n104_), .b(new_n45_), .c(x29), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand4  g068(.a(new_n112_), .b(new_n101_), .c(new_n61_), .d(new_n81_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n80_), .c(new_n59_), .O(z6));
  nor2   g070(.a(new_n45_), .b(new_n102_), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(new_n104_), .O(new_n116_));
  nand2  g072(.a(new_n116_), .b(x31), .O(new_n117_));
  inv1   g073(.a(new_n83_), .O(new_n118_));
  nand4  g074(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n118_), .O(new_n119_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n121_), .c(new_n81_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n129_), .b(new_n45_), .c(x29), .O(new_n130_));
  nor2   g086(.a(new_n128_), .b(new_n102_), .O(new_n131_));
  oai21  g087(.a(new_n131_), .b(new_n45_), .c(new_n130_), .O(new_n132_));
  ...
  nand2  g108(.a(new_n152_), .b(new_n103_), .O(new_n153_));
  ...
  oai21  g114(.a(new_n140_), .b(new_n158_), .c(new_n84_), .O(new_n159_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n122_), .d(new_n45_), .O(new_n180_));
  ...
  oai21  g147(.a(new_n87_), .b(new_n158_), .c(new_n84_), .O(new_n192_));
  nand2  g148(.a(new_n87_), .b(new_n160_), .O(new_n193_));
  ...
  nand3  g155(.a(new_n199_), .b(new_n81_), .c(x00), .O(new_n200_));
