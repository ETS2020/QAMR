...
module FAU ( 
  ...
  inv1   g038(.a(new_n58_), .O(new_n83_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n96_), .c(new_n83_), .d(new_n81_), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n80_), .c(new_n61_), .O(z6));
  ...
  nand4  g076(.a(new_n95_), .b(new_n92_), .c(new_n89_), .d(new_n86_), .O(new_n121_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n123_), .c(new_n81_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n131_), .b(new_n113_), .c(x29), .O(new_n132_));
  nor2   g088(.a(new_n130_), .b(new_n102_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n113_), .c(new_n132_), .O(new_n134_));
  nand3  g090(.a(x19), .b(new_n90_), .c(x13), .O(new_n135_));
  nand3  g091(.a(new_n93_), .b(x18), .c(x14), .O(new_n136_));
  aoi21  g092(.a(new_n136_), .b(new_n135_), .c(new_n87_), .O(new_n137_));
  nand4  g093(.a(x19), .b(x18), .c(new_n87_), .d(x12), .O(new_n138_));
  ...
  oai21  g116(.a(new_n142_), .b(new_n160_), .c(new_n87_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n93_), .b(new_n162_), .c(new_n90_), .O(new_n163_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n124_), .d(new_n113_), .O(new_n182_));
  ...
  oai21  g149(.a(new_n90_), .b(new_n160_), .c(new_n87_), .O(new_n194_));
  nand2  g150(.a(new_n90_), .b(new_n162_), .O(new_n195_));
