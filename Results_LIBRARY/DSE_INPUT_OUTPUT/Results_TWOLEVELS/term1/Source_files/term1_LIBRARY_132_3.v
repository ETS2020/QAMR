...
module FAU ( 
  ...
  oai21  g050(.a(new_n94_), .b(new_n60_), .c(new_n49_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  nand4  g052(.a(new_n96_), .b(new_n93_), .c(new_n46_), .d(x25), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n60_), .c(new_n49_), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n62_), .d(new_n46_), .O(new_n105_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n99_), .c(new_n62_), .d(new_n46_), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n109_), .c(new_n60_), .O(z6));
  nor2   g072(.a(new_n112_), .b(new_n100_), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n102_), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(x31), .O(new_n119_));
  inv1   g075(.a(new_n82_), .O(new_n120_));
  nand4  g076(.a(new_n90_), .b(new_n88_), .c(new_n85_), .d(new_n120_), .O(new_n121_));
  ...
  nor2   g082(.a(new_n126_), .b(new_n109_), .O(new_n127_));
  ...
  nand4  g091(.a(new_n46_), .b(new_n45_), .c(x18), .d(x14), .O(new_n136_));
  ...
  nand2  g110(.a(x17), .b(x16), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n142_), .c(new_n149_), .O(new_n156_));
  nand2  g112(.a(new_n144_), .b(new_n141_), .O(new_n157_));
  inv1   g113(.a(x14), .O(new_n158_));
  oai21  g114(.a(new_n86_), .b(new_n158_), .c(new_n45_), .O(new_n159_));
  nand2  g115(.a(new_n117_), .b(x28), .O(new_n160_));
  aoi21  g116(.a(new_n112_), .b(new_n100_), .c(new_n124_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n160_), .c(new_n159_), .O(new_n162_));
  aoi21  g118(.a(new_n142_), .b(new_n83_), .c(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n163_), .b(new_n157_), .c(new_n156_), .O(new_n164_));
  aoi21  g120(.a(new_n154_), .b(new_n101_), .c(new_n164_), .O(new_n165_));
  oai22  g121(.a(x16), .b(x11), .c(x15), .d(x10), .O(new_n166_));
  ...
  oai21  g128(.a(new_n172_), .b(new_n166_), .c(x19), .O(new_n173_));
  oai21  g129(.a(new_n165_), .b(x26), .c(new_n173_), .O(new_n174_));
  ...
  nand2  g133(.a(new_n177_), .b(new_n49_), .O(z8));
  inv1   g134(.a(x33), .O(new_n179_));
  nand3  g135(.a(new_n45_), .b(x18), .c(x14), .O(new_n180_));
  aoi21  g136(.a(new_n180_), .b(new_n135_), .c(new_n83_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n139_), .c(x16), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n146_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x15), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n150_), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n179_), .c(x31), .d(x30), .O(new_n186_));
  nand2  g142(.a(x33), .b(new_n124_), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n131_), .c(x29), .O(new_n189_));
  inv1   g145(.a(new_n133_), .O(new_n190_));
  nand4  g146(.a(new_n185_), .b(new_n179_), .c(new_n124_), .d(new_n112_), .O(new_n191_));
  ...
  aoi21  g150(.a(new_n86_), .b(x13), .c(new_n45_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(x17), .c(x16), .d(x15), .O(new_n196_));
  nand2  g152(.a(x16), .b(x15), .O(new_n197_));
  nand2  g153(.a(x19), .b(x17), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n197_), .c(new_n86_), .O(new_n199_));
  nand2  g155(.a(x16), .b(x10), .O(new_n200_));
  oai21  g156(.a(new_n200_), .b(new_n198_), .c(new_n149_), .O(new_n201_));
  inv1   g157(.a(x11), .O(new_n202_));
  oai21  g158(.a(new_n198_), .b(new_n202_), .c(new_n141_), .O(new_n203_));
  oai21  g159(.a(new_n45_), .b(new_n167_), .c(new_n83_), .O(new_n204_));
  nand2  g160(.a(new_n45_), .b(new_n158_), .O(new_n205_));
  ...
  nand4  g164(.a(new_n208_), .b(new_n201_), .c(new_n199_), .d(new_n196_), .O(new_n209_));
  nand2  g165(.a(new_n209_), .b(x33), .O(new_n210_));
  nand3  g166(.a(new_n210_), .b(new_n194_), .c(new_n189_), .O(new_n211_));
  nand3  g167(.a(new_n211_), .b(new_n46_), .c(x00), .O(new_n212_));
