...
module FAU ( 
  ...
  nand3  g050(.a(new_n94_), .b(new_n91_), .c(new_n47_), .O(new_n95_));
  ...
  nand4  g055(.a(new_n47_), .b(new_n99_), .c(x28), .d(x27), .O(new_n100_));
  ...
  nand3  g061(.a(new_n105_), .b(new_n102_), .c(x29), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(new_n100_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n91_), .c(new_n80_), .d(x25), .O(new_n108_));
  nor2   g064(.a(new_n108_), .b(new_n59_), .O(z5));
  nand3  g065(.a(new_n105_), .b(x31), .c(x30), .O(new_n110_));
  ...
  nand3  g069(.a(x31), .b(x30), .c(new_n99_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n113_), .c(new_n90_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n116_));
  nor2   g072(.a(new_n116_), .b(new_n59_), .O(z6));
  nor4   g073(.a(new_n87_), .b(new_n86_), .c(new_n84_), .d(new_n82_), .O(new_n118_));
  nand4  g074(.a(new_n61_), .b(new_n80_), .c(x25), .d(x01), .O(new_n119_));
  oai21  g075(.a(new_n119_), .b(new_n118_), .c(new_n47_), .O(new_n120_));
  nand2  g076(.a(new_n104_), .b(x29), .O(new_n121_));
  nand4  g077(.a(new_n121_), .b(new_n89_), .c(new_n61_), .d(x30), .O(new_n122_));
  ...
  nor2   g108(.a(new_n129_), .b(new_n99_), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n148_), .b(new_n146_), .c(new_n154_), .O(new_n155_));
  nor2   g111(.a(new_n155_), .b(x32), .O(new_n156_));
  nand2  g112(.a(x16), .b(x10), .O(new_n157_));
  oai21  g113(.a(new_n157_), .b(new_n143_), .c(new_n132_), .O(new_n158_));
  nand4  g114(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n159_));
  nand3  g115(.a(x19), .b(x18), .c(x12), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n133_), .O(new_n161_));
  ...
  nand3  g121(.a(new_n144_), .b(x16), .c(x15), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n167_));
  aoi21  g123(.a(new_n159_), .b(new_n142_), .c(new_n167_), .O(new_n168_));
  and2   g124(.a(new_n168_), .b(new_n158_), .O(new_n169_));
  nor2   g125(.a(new_n169_), .b(new_n131_), .O(new_n170_));
  aoi21  g126(.a(new_n156_), .b(x30), .c(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n152_), .c(new_n101_), .O(new_n172_));
  nand2  g128(.a(x31), .b(x29), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n129_), .c(x32), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(x30), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n172_), .c(new_n80_), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n128_), .O(z8));
  nand3  g133(.a(new_n130_), .b(new_n101_), .c(x29), .O(new_n178_));
  nand2  g134(.a(x30), .b(x29), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n129_), .c(x31), .O(new_n180_));
  nand3  g136(.a(new_n180_), .b(new_n178_), .c(new_n169_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(x33), .O(new_n182_));
  nand3  g138(.a(new_n130_), .b(x30), .c(x29), .O(new_n183_));
  oai21  g139(.a(new_n153_), .b(x31), .c(new_n183_), .O(new_n184_));
  oai21  g140(.a(new_n148_), .b(new_n146_), .c(new_n184_), .O(new_n185_));
