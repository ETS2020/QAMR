...
module FAU ( 
  ...
  nor2   g054(.a(x30), .b(x28), .O(new_n99_));
  ...
  oai21  g060(.a(new_n99_), .b(new_n45_), .c(x29), .O(new_n105_));
  ...
  nand4  g065(.a(new_n109_), .b(new_n104_), .c(new_n62_), .d(new_n81_), .O(new_n110_));
  nor3   g066(.a(new_n110_), .b(new_n97_), .c(new_n60_), .O(z5));
  ...
  nand4  g070(.a(new_n114_), .b(new_n94_), .c(new_n81_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n60_), .c(new_n48_), .O(z6));
  inv1   g072(.a(new_n82_), .O(new_n117_));
  nand4  g073(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n117_), .O(new_n118_));
  inv1   g074(.a(x31), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n81_), .c(x25), .O(new_n120_));
  nor3   g076(.a(new_n120_), .b(new_n61_), .c(new_n60_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n118_), .c(new_n47_), .O(z7));
  nand3  g078(.a(x30), .b(x29), .c(x28), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n99_), .c(new_n45_), .O(new_n125_));
  ...
  and2   g087(.a(x17), .b(x11), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(x16), .O(new_n133_));
  inv1   g089(.a(x12), .O(new_n134_));
  oai21  g090(.a(new_n130_), .b(new_n134_), .c(new_n83_), .O(new_n135_));
  inv1   g091(.a(new_n135_), .O(new_n136_));
  nand2  g092(.a(x19), .b(x13), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n86_), .O(new_n138_));
  inv1   g094(.a(x14), .O(new_n139_));
  nand2  g095(.a(new_n89_), .b(new_n139_), .O(new_n140_));
  inv1   g096(.a(new_n128_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(x16), .c(x15), .O(new_n142_));
  aoi21  g098(.a(new_n46_), .b(new_n107_), .c(new_n119_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n142_), .c(new_n140_), .d(new_n138_), .O(new_n144_));
  nor3   g100(.a(new_n144_), .b(new_n136_), .c(new_n133_), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n129_), .c(new_n125_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  aoi21  g104(.a(new_n46_), .b(x28), .c(x27), .O(new_n149_));
  oai22  g105(.a(new_n149_), .b(new_n107_), .c(new_n112_), .d(new_n46_), .O(new_n150_));
  ...
  nand3  g113(.a(new_n141_), .b(new_n157_), .c(x11), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n156_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(x15), .O(new_n160_));
  nand3  g116(.a(x16), .b(new_n126_), .c(x10), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n128_), .O(new_n162_));
  inv1   g118(.a(new_n162_), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n160_), .O(new_n164_));
  nand4  g120(.a(new_n164_), .b(new_n150_), .c(new_n148_), .d(x31), .O(new_n165_));
  ...
  nand4  g124(.a(x33), .b(x29), .c(new_n81_), .d(x00), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n46_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x27), .O(new_n171_));
  aoi21  g127(.a(new_n158_), .b(new_n156_), .c(new_n126_), .O(new_n172_));
  oai21  g128(.a(x28), .b(x27), .c(x29), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n119_), .c(new_n46_), .O(new_n174_));
  nand3  g130(.a(new_n112_), .b(x31), .c(x30), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n162_), .b(new_n172_), .c(new_n176_), .O(new_n177_));
  oai21  g133(.a(new_n112_), .b(x30), .c(new_n119_), .O(new_n178_));
  nand2  g134(.a(new_n123_), .b(x31), .O(new_n179_));
  nand4  g135(.a(new_n142_), .b(new_n140_), .c(new_n138_), .d(new_n135_), .O(new_n180_));
  nor2   g136(.a(new_n180_), .b(new_n133_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n179_), .c(new_n178_), .d(new_n129_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  oai21  g139(.a(new_n177_), .b(x33), .c(new_n183_), .O(new_n184_));
