...
module FAU ( 
  ...
  nor3   g046(.a(new_n90_), .b(new_n84_), .c(new_n83_), .O(new_n91_));
  nor2   g047(.a(new_n91_), .b(new_n61_), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n82_), .c(new_n81_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n60_), .c(new_n48_), .O(z3));
  xor2a  g050(.a(x28), .b(x27), .O(new_n95_));
  nor2   g051(.a(new_n85_), .b(new_n83_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n89_), .O(new_n97_));
  aoi21  g053(.a(new_n97_), .b(new_n48_), .c(new_n84_), .O(new_n98_));
  ...
  nand2  g069(.a(x27), .b(new_n45_), .O(new_n114_));
  nand3  g070(.a(new_n113_), .b(x29), .c(x28), .O(new_n115_));
  oai22  g071(.a(new_n115_), .b(new_n114_), .c(new_n113_), .d(x29), .O(new_n116_));
  nand3  g072(.a(x29), .b(x28), .c(x27), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x30), .O(new_n118_));
  nand3  g074(.a(new_n105_), .b(new_n113_), .c(x29), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n118_), .c(x21), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(new_n112_), .c(new_n116_), .d(new_n97_), .O(new_n121_));
  aoi22  g077(.a(x28), .b(x27), .c(x03), .d(x02), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n97_), .c(x30), .O(new_n123_));
  oai21  g079(.a(new_n121_), .b(new_n61_), .c(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(new_n81_), .c(x25), .d(x01), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(z6));
  nand4  g082(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n48_), .O(new_n128_));
  nand2  g084(.a(new_n117_), .b(x31), .O(new_n129_));
  inv1   g085(.a(new_n87_), .O(new_n130_));
  inv1   g086(.a(new_n88_), .O(new_n131_));
  nand3  g087(.a(new_n96_), .b(new_n131_), .c(new_n130_), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x21), .O(new_n134_));
  inv1   g090(.a(x31), .O(new_n135_));
  nand3  g091(.a(new_n105_), .b(new_n135_), .c(x29), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n134_), .c(new_n129_), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(x30), .O(new_n138_));
  nor2   g094(.a(new_n132_), .b(new_n112_), .O(new_n139_));
  nor2   g095(.a(new_n135_), .b(x30), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n139_), .c(new_n45_), .O(new_n141_));
  nand3  g097(.a(new_n141_), .b(new_n138_), .c(new_n128_), .O(z7));
  nand2  g098(.a(new_n104_), .b(new_n82_), .O(new_n143_));
  ...
  nand3  g112(.a(new_n156_), .b(new_n112_), .c(x11), .O(new_n157_));
  ...
  nand4  g118(.a(new_n162_), .b(new_n145_), .c(x31), .d(x30), .O(new_n163_));
  nand3  g119(.a(x32), .b(new_n113_), .c(new_n45_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n163_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n144_), .O(new_n166_));
  nand4  g122(.a(new_n162_), .b(new_n143_), .c(new_n145_), .d(x31), .O(new_n167_));
  nand2  g123(.a(new_n104_), .b(new_n82_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(x32), .c(x30), .O(new_n169_));
  oai21  g125(.a(new_n167_), .b(x30), .c(new_n169_), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(x29), .O(new_n171_));
  and2   g127(.a(x16), .b(x10), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n156_), .c(x15), .O(new_n173_));
  nor2   g129(.a(new_n149_), .b(new_n147_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(x17), .c(x11), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n112_), .O(new_n176_));
  nand2  g132(.a(new_n174_), .b(x12), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n146_), .O(new_n178_));
  nand2  g134(.a(x19), .b(x13), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n147_), .O(new_n180_));
  nor2   g136(.a(x19), .b(x14), .O(new_n181_));
  nor3   g137(.a(new_n155_), .b(new_n112_), .c(new_n160_), .O(new_n182_));
  nor3   g138(.a(new_n182_), .b(new_n181_), .c(new_n135_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n180_), .c(new_n178_), .d(new_n176_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n173_), .c(x32), .O(new_n185_));
  nand3  g141(.a(new_n185_), .b(new_n171_), .c(new_n166_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(new_n81_), .c(x00), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n48_), .O(z8));
  inv1   g144(.a(x33), .O(new_n189_));
  nand4  g145(.a(new_n162_), .b(new_n189_), .c(x31), .d(x30), .O(new_n190_));
  nand2  g146(.a(x33), .b(new_n135_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n190_), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n143_), .c(x29), .O(new_n193_));
  nand4  g149(.a(new_n162_), .b(new_n189_), .c(new_n135_), .d(new_n113_), .O(new_n194_));
  oai21  g150(.a(new_n189_), .b(new_n113_), .c(new_n194_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n144_), .O(new_n196_));
  nor3   g152(.a(new_n182_), .b(new_n181_), .c(new_n140_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(new_n180_), .c(new_n178_), .d(new_n176_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(new_n173_), .c(x33), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n196_), .c(new_n193_), .O(new_n200_));
