...
module FAU ( 
  ...
  oai21  g056(.a(new_n100_), .b(new_n63_), .c(new_n49_), .O(z4));
  ...
  nor3   g065(.a(new_n109_), .b(new_n82_), .c(new_n63_), .O(z5));
  ...
  nand4  g079(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n123_), .O(new_n124_));
  ...
  nor2   g085(.a(new_n129_), .b(new_n82_), .O(new_n130_));
  ...
  nand3  g094(.a(new_n91_), .b(x18), .c(x14), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n138_), .c(new_n85_), .O(new_n140_));
  ...
  nand2  g111(.a(new_n155_), .b(new_n105_), .O(new_n156_));
  ...
  oai21  g118(.a(new_n159_), .b(new_n162_), .c(new_n85_), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  oai21  g120(.a(new_n91_), .b(new_n164_), .c(new_n88_), .O(new_n165_));
  ...
  nand4  g140(.a(new_n152_), .b(new_n179_), .c(new_n127_), .d(new_n113_), .O(new_n185_));
  nand2  g141(.a(x33), .b(x31), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  aoi21  g143(.a(new_n91_), .b(x14), .c(new_n88_), .O(new_n188_));
  nand4  g144(.a(new_n188_), .b(x17), .c(x16), .d(x15), .O(new_n189_));
  nand2  g145(.a(x18), .b(x17), .O(new_n190_));
  oai21  g146(.a(new_n190_), .b(new_n167_), .c(new_n91_), .O(new_n191_));
  ...
  oai21  g150(.a(new_n88_), .b(new_n162_), .c(new_n85_), .O(new_n195_));
  nand2  g151(.a(new_n88_), .b(new_n164_), .O(new_n196_));
