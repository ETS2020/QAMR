...
module FAU ( 
  ...
  nand3  g048(.a(new_n47_), .b(new_n92_), .c(x27), .O(new_n93_));
  inv1   g049(.a(x30), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(x29), .O(new_n95_));
  nand3  g051(.a(new_n95_), .b(x28), .c(new_n81_), .O(new_n96_));
  nand2  g052(.a(new_n96_), .b(new_n93_), .O(new_n97_));
  nand4  g053(.a(new_n97_), .b(new_n91_), .c(new_n61_), .d(new_n80_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n90_), .c(new_n59_), .O(z4));
  nor2   g055(.a(x29), .b(new_n81_), .O(new_n100_));
  nor3   g056(.a(new_n94_), .b(new_n45_), .c(x27), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n100_), .c(x28), .O(new_n102_));
  nand3  g058(.a(x30), .b(x29), .c(new_n92_), .O(new_n103_));
  aoi21  g059(.a(new_n103_), .b(new_n102_), .c(new_n86_), .O(new_n104_));
  nand4  g060(.a(new_n104_), .b(new_n61_), .c(new_n80_), .d(x25), .O(new_n105_));
  nor2   g061(.a(new_n105_), .b(new_n59_), .O(z5));
  nand3  g062(.a(x29), .b(x28), .c(x27), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n91_), .c(new_n61_), .d(x30), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n80_), .c(x25), .d(x01), .O(new_n110_));
  nand2  g066(.a(new_n110_), .b(new_n47_), .O(z6));
  nor4   g067(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n112_));
  ...
  nor2   g071(.a(new_n92_), .b(new_n81_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(new_n115_), .c(x29), .O(new_n117_));
  ...
  nand2  g078(.a(new_n92_), .b(new_n81_), .O(new_n123_));
  ...
  nand3  g099(.a(x32), .b(x29), .c(x28), .O(new_n144_));
  aoi21  g100(.a(new_n144_), .b(new_n143_), .c(new_n94_), .O(new_n145_));
  nand2  g101(.a(new_n128_), .b(x14), .O(new_n146_));
  ...
  nor2   g105(.a(new_n126_), .b(new_n125_), .O(new_n150_));
  nand3  g106(.a(new_n150_), .b(x16), .c(x15), .O(new_n151_));
  nand3  g107(.a(new_n150_), .b(x16), .c(x10), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n140_), .O(new_n153_));
  nand2  g109(.a(new_n150_), .b(x11), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n134_), .O(new_n155_));
  aoi21  g111(.a(x18), .b(x12), .c(x17), .O(new_n156_));
  nor2   g112(.a(x18), .b(x13), .O(new_n157_));
  aoi21  g113(.a(x29), .b(x27), .c(new_n157_), .O(new_n158_));
  aoi21  g114(.a(new_n94_), .b(new_n45_), .c(new_n115_), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n156_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(new_n155_), .c(new_n153_), .O(new_n162_));
  aoi21  g118(.a(new_n151_), .b(new_n128_), .c(new_n162_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n149_), .c(new_n122_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n145_), .c(new_n80_), .O(new_n165_));
  oai21  g121(.a(new_n165_), .b(new_n121_), .c(new_n47_), .O(z8));
  nand2  g122(.a(new_n151_), .b(new_n128_), .O(new_n167_));
  nor2   g123(.a(new_n157_), .b(new_n156_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n155_), .c(new_n153_), .d(new_n167_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n148_), .c(new_n47_), .O(new_n170_));
  nand2  g126(.a(new_n123_), .b(x31), .O(new_n171_));
  aoi22  g127(.a(new_n171_), .b(x30), .c(x31), .d(new_n45_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n170_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(x33), .O(new_n174_));
  nor3   g130(.a(new_n171_), .b(new_n94_), .c(new_n45_), .O(new_n175_));
  nor3   g131(.a(x31), .b(x30), .c(x29), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n142_), .O(new_n177_));
  oai21  g133(.a(new_n177_), .b(x33), .c(new_n174_), .O(new_n178_));
