...
module FAU ( 
  ...
  nor3   g004(.a(x32), .b(x26), .c(x03), .O(new_n49_));
  ...
  nor2   g052(.a(new_n96_), .b(new_n63_), .O(new_n97_));
  nand3  g053(.a(new_n97_), .b(new_n84_), .c(new_n45_), .O(new_n98_));
  nor3   g054(.a(new_n98_), .b(new_n83_), .c(new_n62_), .O(z3));
  xor2a  g055(.a(x28), .b(x27), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n97_), .c(new_n45_), .d(x25), .O(new_n101_));
  ...
  nand4  g064(.a(new_n108_), .b(new_n103_), .c(new_n64_), .d(new_n45_), .O(new_n109_));
  inv1   g065(.a(new_n109_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(x25), .c(x01), .O(new_n111_));
  nand2  g067(.a(new_n111_), .b(new_n60_), .O(z5));
  ...
  nand4  g073(.a(new_n117_), .b(new_n103_), .c(new_n64_), .d(new_n45_), .O(new_n118_));
  nor3   g074(.a(new_n118_), .b(new_n83_), .c(new_n62_), .O(z6));
  inv1   g075(.a(x31), .O(new_n120_));
  nor2   g076(.a(new_n115_), .b(new_n104_), .O(new_n121_));
  aoi21  g077(.a(new_n121_), .b(new_n106_), .c(new_n120_), .O(new_n122_));
  inv1   g078(.a(new_n85_), .O(new_n123_));
  nand4  g079(.a(new_n94_), .b(new_n91_), .c(new_n88_), .d(new_n123_), .O(new_n124_));
  ...
  aoi21  g083(.a(new_n127_), .b(new_n106_), .c(new_n83_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(new_n125_), .c(new_n124_), .O(new_n129_));
  oai21  g085(.a(new_n129_), .b(new_n122_), .c(new_n45_), .O(new_n130_));
  oai21  g086(.a(x33), .b(new_n45_), .c(new_n130_), .O(z7));
  nor2   g087(.a(x28), .b(x27), .O(new_n132_));
  inv1   g088(.a(new_n132_), .O(new_n133_));
  nand3  g089(.a(new_n133_), .b(new_n115_), .c(x29), .O(new_n134_));
  nor2   g090(.a(new_n132_), .b(new_n104_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(new_n115_), .c(new_n134_), .O(new_n136_));
  nand3  g092(.a(x19), .b(new_n89_), .c(x13), .O(new_n137_));
  nand3  g093(.a(new_n92_), .b(x18), .c(x14), .O(new_n138_));
  aoi21  g094(.a(new_n138_), .b(new_n137_), .c(new_n86_), .O(new_n139_));
  nand4  g095(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n140_));
  ...
  nand4  g109(.a(new_n153_), .b(new_n136_), .c(new_n54_), .d(x31), .O(new_n154_));
  nand2  g110(.a(new_n121_), .b(x27), .O(new_n155_));
  ...
  oai21  g118(.a(new_n144_), .b(new_n162_), .c(new_n86_), .O(new_n163_));
  nand2  g119(.a(x19), .b(x13), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n89_), .O(new_n165_));
  nor2   g121(.a(x19), .b(x14), .O(new_n166_));
  nand2  g122(.a(x16), .b(x15), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n147_), .c(new_n166_), .O(new_n169_));
  ...
  nand2  g133(.a(new_n177_), .b(new_n60_), .O(z8));
  aoi21  g134(.a(new_n152_), .b(new_n150_), .c(x33), .O(new_n179_));
  nand4  g135(.a(new_n179_), .b(x31), .c(x30), .d(new_n45_), .O(new_n180_));
  nand2  g136(.a(x33), .b(new_n120_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n133_), .c(x29), .O(new_n183_));
  inv1   g139(.a(new_n135_), .O(new_n184_));
  nand4  g140(.a(new_n179_), .b(new_n120_), .c(new_n115_), .d(new_n45_), .O(new_n185_));
  ...
  inv1   g144(.a(new_n159_), .O(new_n189_));
  xnor2a g145(.a(x31), .b(x30), .O(new_n190_));
  and2   g146(.a(new_n190_), .b(new_n169_), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n165_), .c(new_n163_), .d(new_n161_), .O(new_n192_));
  oai21  g148(.a(new_n192_), .b(new_n189_), .c(x33), .O(new_n193_));
  nand3  g149(.a(new_n193_), .b(new_n188_), .c(new_n183_), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(x00), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n60_), .O(z9));
endmodule
