...
module FAU ( 
  ...
  nand4  g053(.a(new_n97_), .b(new_n94_), .c(new_n46_), .d(x25), .O(new_n98_));
  ...
  nor2   g071(.a(new_n110_), .b(new_n102_), .O(new_n116_));
  ...
  aoi21  g078(.a(new_n122_), .b(new_n103_), .c(new_n100_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n117_), .c(new_n46_), .O(new_n125_));
  oai21  g081(.a(new_n46_), .b(x00), .c(new_n125_), .O(z7));
  inv1   g082(.a(x15), .O(new_n127_));
  aoi21  g083(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n128_));
  nand3  g084(.a(new_n128_), .b(x17), .c(x16), .O(new_n129_));
  nor2   g085(.a(new_n129_), .b(new_n127_), .O(new_n130_));
  nand2  g086(.a(new_n116_), .b(x27), .O(new_n131_));
  nand2  g087(.a(new_n110_), .b(new_n81_), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(x28), .O(new_n133_));
  nor2   g089(.a(x30), .b(x29), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n133_), .c(new_n46_), .O(new_n135_));
  nor2   g091(.a(new_n86_), .b(new_n83_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(x16), .c(x15), .O(new_n137_));
  nand2  g093(.a(new_n137_), .b(new_n89_), .O(new_n138_));
  nand3  g094(.a(new_n136_), .b(x16), .c(x10), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(new_n127_), .O(new_n140_));
  aoi21  g096(.a(new_n136_), .b(x11), .c(x16), .O(new_n141_));
  nand2  g097(.a(x18), .b(x12), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n83_), .O(new_n143_));
  inv1   g099(.a(x13), .O(new_n144_));
  nand2  g100(.a(new_n86_), .b(new_n144_), .O(new_n145_));
  nand2  g101(.a(new_n116_), .b(x28), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n145_), .c(new_n143_), .d(x31), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n141_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n140_), .c(new_n138_), .d(new_n135_), .O(new_n149_));
  ...
  nand3  g109(.a(new_n153_), .b(new_n110_), .c(x29), .O(new_n154_));
  nor2   g110(.a(new_n152_), .b(new_n102_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n110_), .c(new_n154_), .O(new_n156_));
  nand3  g112(.a(x19), .b(new_n86_), .c(x13), .O(new_n157_));
  nand3  g113(.a(new_n89_), .b(x18), .c(x14), .O(new_n158_));
  ...
  nand4  g124(.a(new_n165_), .b(x16), .c(new_n127_), .d(x10), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(new_n156_), .c(new_n151_), .d(x31), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n150_), .c(new_n46_), .O(new_n172_));
  and2   g128(.a(new_n172_), .b(x00), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n170_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  nand2  g131(.a(x33), .b(new_n115_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n175_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n153_), .c(x29), .O(new_n178_));
  inv1   g134(.a(new_n155_), .O(new_n179_));
  nand4  g135(.a(new_n170_), .b(new_n174_), .c(new_n115_), .d(new_n110_), .O(new_n180_));
  nand2  g136(.a(x33), .b(x31), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n180_), .O(new_n182_));
  inv1   g138(.a(new_n130_), .O(new_n183_));
  inv1   g139(.a(new_n141_), .O(new_n184_));
  xnor2a g140(.a(x31), .b(x30), .O(new_n185_));
  nand4  g141(.a(new_n185_), .b(new_n145_), .c(new_n143_), .d(new_n184_), .O(new_n186_));
  inv1   g142(.a(new_n186_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n140_), .c(new_n138_), .d(new_n183_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n46_), .O(new_n190_));
  aoi21  g146(.a(new_n182_), .b(new_n179_), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n178_), .c(new_n45_), .O(z9));
endmodule
