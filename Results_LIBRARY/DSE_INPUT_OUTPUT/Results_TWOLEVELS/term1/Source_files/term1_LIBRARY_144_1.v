...
module FAU ( 
  ...
  oai21  g051(.a(new_n95_), .b(new_n62_), .c(new_n57_), .O(z3));
  ...
  nor3   g064(.a(new_n108_), .b(new_n97_), .c(new_n62_), .O(z5));
  ...
  nand4  g070(.a(new_n114_), .b(new_n102_), .c(new_n101_), .d(new_n45_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x25), .c(x01), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(new_n57_), .O(z6));
  inv1   g074(.a(x31), .O(new_n119_));
  nor2   g075(.a(new_n112_), .b(new_n103_), .O(new_n120_));
  ...
  nor2   g079(.a(new_n59_), .b(new_n62_), .O(new_n124_));
  nand3  g080(.a(new_n119_), .b(x30), .c(x29), .O(new_n125_));
  inv1   g081(.a(new_n125_), .O(new_n126_));
  aoi21  g082(.a(new_n126_), .b(new_n105_), .c(new_n97_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n124_), .c(new_n123_), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n121_), .c(new_n45_), .O(new_n129_));
  nand2  g085(.a(x26), .b(x00), .O(new_n130_));
  ...
  oai21  g119(.a(new_n145_), .b(new_n163_), .c(new_n83_), .O(new_n164_));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n119_), .d(new_n112_), .O(new_n185_));
  ...
  oai21  g152(.a(new_n86_), .b(new_n163_), .c(new_n83_), .O(new_n197_));
  ...
  nand3  g160(.a(new_n204_), .b(new_n45_), .c(x00), .O(new_n205_));
  nand2  g161(.a(new_n205_), .b(new_n57_), .O(z9));
endmodule
