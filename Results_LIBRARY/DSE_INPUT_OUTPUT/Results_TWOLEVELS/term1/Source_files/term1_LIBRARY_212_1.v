...
module FAU ( 
  ...
  nor2   g074(.a(new_n111_), .b(new_n100_), .O(new_n119_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n102_), .c(new_n80_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n120_), .c(new_n45_), .O(new_n127_));
  ...
  nand3  g088(.a(new_n132_), .b(new_n111_), .c(x29), .O(new_n133_));
  nor2   g089(.a(new_n131_), .b(new_n100_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n111_), .c(new_n133_), .O(new_n135_));
  ...
  oai21  g117(.a(new_n143_), .b(new_n161_), .c(new_n85_), .O(new_n162_));
  inv1   g118(.a(x13), .O(new_n163_));
  oai21  g119(.a(new_n91_), .b(new_n163_), .c(new_n88_), .O(new_n164_));
  ...
  nand2  g131(.a(new_n175_), .b(new_n47_), .O(z8));
  ...
  nand4  g138(.a(new_n152_), .b(new_n177_), .c(new_n118_), .d(new_n111_), .O(new_n183_));
  ...
  oai21  g150(.a(new_n88_), .b(new_n161_), .c(new_n85_), .O(new_n195_));
  nand2  g151(.a(new_n88_), .b(new_n163_), .O(new_n196_));
