...
module FAU ( 
  ...
  nor2   g000(.a(x08), .b(x05), .O(new_n45_));
  ...
  nand3  g020(.a(x06), .b(x03), .c(new_n51_), .O(new_n65_));
  aoi21  g021(.a(new_n65_), .b(new_n64_), .c(x01), .O(new_n66_));
  oai21  g022(.a(new_n66_), .b(new_n62_), .c(x08), .O(new_n67_));
  inv1   g023(.a(x05), .O(new_n68_));
  nand4  g024(.a(x06), .b(new_n68_), .c(new_n51_), .d(new_n58_), .O(new_n69_));
  nand2  g025(.a(new_n69_), .b(new_n67_), .O(new_n70_));
  xnor2a g026(.a(x07), .b(x04), .O(new_n71_));
  xnor2a g027(.a(x03), .b(x02), .O(new_n72_));
  nor2   g028(.a(new_n72_), .b(new_n58_), .O(new_n73_));
  nand2  g029(.a(new_n63_), .b(x03), .O(new_n74_));
  nand4  g030(.a(x06), .b(x05), .c(new_n48_), .d(new_n51_), .O(new_n75_));
  aoi21  g031(.a(new_n75_), .b(new_n74_), .c(x01), .O(new_n76_));
  oai21  g032(.a(new_n76_), .b(new_n73_), .c(x08), .O(new_n77_));
  nand3  g033(.a(new_n63_), .b(new_n68_), .c(new_n58_), .O(new_n78_));
  aoi21  g034(.a(new_n78_), .b(new_n77_), .c(new_n71_), .O(new_n79_));
  aoi21  g035(.a(new_n70_), .b(new_n57_), .c(new_n79_), .O(new_n80_));
  oai21  g036(.a(new_n80_), .b(x09), .c(new_n56_), .O(z2));
  ...
  nand3  g045(.a(new_n89_), .b(new_n56_), .c(new_n83_), .O(new_n90_));
  ...
  nand4  g058(.a(new_n102_), .b(new_n97_), .c(new_n60_), .d(new_n82_), .O(new_n103_));
  ...
  nand4  g067(.a(new_n111_), .b(new_n97_), .c(new_n60_), .d(new_n56_), .O(new_n112_));
  ...
  nor4   g077(.a(new_n121_), .b(new_n118_), .c(new_n59_), .d(new_n58_), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(new_n117_), .c(new_n45_), .O(z7));
  ...
  nand4  g099(.a(new_n143_), .b(new_n125_), .c(x31), .d(new_n109_), .O(new_n144_));
  ...
  nand2  g105(.a(x32), .b(new_n109_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(new_n149_), .O(new_n151_));
  nand2  g107(.a(new_n151_), .b(new_n148_), .O(new_n152_));
  and2   g108(.a(x16), .b(x10), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n137_), .c(x15), .O(new_n154_));
  nor2   g110(.a(new_n129_), .b(new_n127_), .O(new_n155_));
  ...
  nand2  g116(.a(new_n160_), .b(new_n127_), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  nor3   g118(.a(new_n136_), .b(new_n135_), .c(new_n141_), .O(new_n163_));
  ...
  nand4  g130(.a(new_n143_), .b(new_n170_), .c(new_n119_), .d(new_n109_), .O(new_n175_));
  ...
  nor3   g135(.a(new_n179_), .b(new_n163_), .c(new_n162_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n154_), .c(x33), .O(new_n182_));
  nand3  g138(.a(new_n182_), .b(new_n178_), .c(new_n174_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n82_), .c(x00), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n56_), .O(z9));
endmodule
