...
module FAU ( 
  ...
  nand2  g066(.a(x27), .b(new_n78_), .O(new_n111_));
  inv1   g067(.a(x30), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x29), .c(x28), .O(new_n113_));
  oai21  g069(.a(new_n113_), .b(new_n111_), .c(new_n110_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n99_), .c(new_n59_), .d(x25), .O(new_n115_));
  oai21  g071(.a(new_n115_), .b(new_n57_), .c(new_n45_), .O(z6));
  oai21  g072(.a(x31), .b(x26), .c(new_n112_), .O(new_n117_));
  nand2  g073(.a(new_n109_), .b(x31), .O(new_n118_));
  inv1   g074(.a(new_n80_), .O(new_n119_));
  nand4  g075(.a(new_n89_), .b(new_n86_), .c(new_n83_), .d(new_n119_), .O(new_n120_));
  ...
  aoi21  g080(.a(new_n124_), .b(new_n102_), .c(new_n95_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(new_n121_), .c(new_n120_), .d(new_n118_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n78_), .O(new_n127_));
  nand2  g083(.a(new_n127_), .b(new_n117_), .O(z7));
  nand2  g084(.a(new_n101_), .b(new_n79_), .O(new_n129_));
  inv1   g085(.a(x32), .O(new_n130_));
  nand3  g086(.a(x19), .b(new_n84_), .c(x13), .O(new_n131_));
  nand3  g087(.a(new_n87_), .b(x18), .c(x14), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n131_), .c(new_n81_), .O(new_n133_));
  nand4  g089(.a(x19), .b(x18), .c(new_n81_), .d(x12), .O(new_n134_));
  ...
  nand4  g101(.a(new_n145_), .b(new_n130_), .c(x31), .d(new_n112_), .O(new_n146_));
  nand2  g102(.a(x32), .b(x30), .O(new_n147_));
  oai21  g103(.a(new_n146_), .b(x26), .c(new_n147_), .O(new_n148_));
  nand3  g104(.a(new_n148_), .b(new_n129_), .c(x29), .O(new_n149_));
  nand2  g105(.a(new_n129_), .b(x29), .O(new_n150_));
  nand4  g106(.a(new_n145_), .b(new_n130_), .c(x31), .d(x30), .O(new_n151_));
  nand3  g107(.a(x32), .b(new_n112_), .c(new_n78_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(new_n151_), .O(new_n153_));
  nand2  g109(.a(x16), .b(x10), .O(new_n154_));
  inv1   g110(.a(new_n154_), .O(new_n155_));
  aoi21  g111(.a(new_n155_), .b(new_n139_), .c(x15), .O(new_n156_));
  nand2  g112(.a(x19), .b(x18), .O(new_n157_));
  nand2  g113(.a(x17), .b(x11), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n157_), .c(new_n137_), .O(new_n159_));
  inv1   g115(.a(x12), .O(new_n160_));
  oai21  g116(.a(new_n157_), .b(new_n160_), .c(new_n81_), .O(new_n161_));
  inv1   g117(.a(x13), .O(new_n162_));
  oai21  g118(.a(new_n87_), .b(new_n162_), .c(new_n84_), .O(new_n163_));
  ...
  nor2   g125(.a(new_n169_), .b(x26), .O(new_n170_));
  aoi21  g126(.a(new_n153_), .b(new_n150_), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n149_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x00), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n45_), .O(z8));
  inv1   g130(.a(x33), .O(new_n175_));
  nand4  g131(.a(new_n145_), .b(new_n175_), .c(x31), .d(x30), .O(new_n176_));
  ...
  nand4  g135(.a(new_n145_), .b(new_n175_), .c(new_n122_), .d(new_n112_), .O(new_n180_));
  oai21  g136(.a(new_n175_), .b(new_n122_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n150_), .O(new_n182_));
  aoi21  g138(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(x17), .c(x16), .d(x15), .O(new_n184_));
  nand2  g140(.a(x18), .b(x17), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n165_), .c(new_n87_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n154_), .c(new_n143_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(new_n188_), .c(new_n137_), .O(new_n189_));
  oai21  g145(.a(new_n84_), .b(new_n160_), .c(new_n81_), .O(new_n190_));
  nand2  g146(.a(new_n84_), .b(new_n162_), .O(new_n191_));
  ...
  nand3  g152(.a(new_n196_), .b(new_n182_), .c(new_n179_), .O(new_n197_));
