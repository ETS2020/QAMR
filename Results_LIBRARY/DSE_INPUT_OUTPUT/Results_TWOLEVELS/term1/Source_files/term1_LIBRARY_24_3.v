...
module FAU ( 
  ...
  oai21  g053(.a(new_n97_), .b(new_n57_), .c(new_n45_), .O(z4));
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n59_), .d(new_n79_), .O(new_n105_));
  nor3   g061(.a(new_n105_), .b(new_n78_), .c(new_n57_), .O(z5));
  ...
  nand4  g067(.a(new_n111_), .b(new_n99_), .c(new_n59_), .d(new_n79_), .O(new_n112_));
  inv1   g068(.a(new_n112_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(x25), .c(x01), .O(new_n114_));
  nand2  g070(.a(new_n114_), .b(new_n45_), .O(z6));
  nor2   g071(.a(new_n109_), .b(new_n100_), .O(new_n116_));
  ...
  oai21  g080(.a(new_n124_), .b(new_n122_), .c(new_n79_), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n78_), .O(new_n126_));
  ...
  nand3  g086(.a(new_n130_), .b(new_n109_), .c(x29), .O(new_n131_));
  nor2   g087(.a(new_n129_), .b(new_n100_), .O(new_n132_));
  oai21  g088(.a(new_n132_), .b(new_n109_), .c(new_n131_), .O(new_n133_));
  ...
  nand4  g136(.a(new_n150_), .b(new_n175_), .c(new_n123_), .d(new_n109_), .O(new_n181_));
