...
module FAU ( 
  ...
  nand3  g047(.a(new_n47_), .b(new_n91_), .c(x27), .O(new_n92_));
  nand2  g048(.a(x32), .b(x30), .O(new_n93_));
  nand3  g049(.a(new_n93_), .b(x28), .c(new_n80_), .O(new_n94_));
  nand2  g050(.a(new_n94_), .b(new_n92_), .O(new_n95_));
  nand4  g051(.a(new_n95_), .b(new_n90_), .c(new_n60_), .d(new_n79_), .O(new_n96_));
  nor3   g052(.a(new_n96_), .b(new_n89_), .c(new_n58_), .O(z4));
  ...
  nand4  g057(.a(new_n101_), .b(new_n90_), .c(new_n60_), .d(new_n79_), .O(new_n102_));
  inv1   g058(.a(new_n102_), .O(new_n103_));
  nand3  g059(.a(new_n103_), .b(x25), .c(x01), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n47_), .O(z5));
  nand3  g061(.a(new_n45_), .b(x29), .c(x27), .O(new_n106_));
  inv1   g062(.a(x32), .O(new_n107_));
  nand3  g063(.a(new_n107_), .b(x30), .c(new_n80_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n106_), .O(new_n109_));
  aoi21  g065(.a(x29), .b(x28), .c(x32), .O(new_n110_));
  aoi22  g066(.a(new_n110_), .b(x30), .c(new_n109_), .d(x28), .O(new_n111_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n132_), .c(new_n107_), .d(x31), .O(new_n151_));
  nand2  g107(.a(x16), .b(x10), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n143_), .c(new_n148_), .O(new_n153_));
  nor2   g109(.a(new_n136_), .b(new_n134_), .O(new_n154_));
  ...
  oai21  g114(.a(new_n136_), .b(new_n158_), .c(new_n134_), .O(new_n159_));
  inv1   g115(.a(x14), .O(new_n160_));
  nand2  g116(.a(new_n136_), .b(new_n160_), .O(new_n161_));
  nand3  g117(.a(new_n144_), .b(x16), .c(x15), .O(new_n162_));
  nor3   g118(.a(new_n128_), .b(new_n115_), .c(new_n98_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n162_), .c(new_n161_), .d(new_n159_), .O(new_n164_));
  aoi21  g120(.a(new_n157_), .b(new_n133_), .c(new_n164_), .O(new_n165_));
  ...
  nand4  g127(.a(new_n150_), .b(new_n171_), .c(x31), .d(x30), .O(new_n172_));
  ...
  inv1   g131(.a(new_n131_), .O(new_n176_));
  nand4  g132(.a(new_n150_), .b(new_n171_), .c(new_n115_), .d(new_n45_), .O(new_n177_));
  ...
  aoi21  g136(.a(new_n136_), .b(x14), .c(new_n134_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(x17), .c(x16), .d(x15), .O(new_n182_));
  nand2  g138(.a(x16), .b(x15), .O(new_n183_));
  nand2  g139(.a(x18), .b(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n183_), .c(new_n136_), .O(new_n185_));
  oai21  g141(.a(new_n184_), .b(new_n152_), .c(new_n148_), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n187_), .c(new_n142_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x12), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n133_), .O(new_n190_));
  nand2  g146(.a(new_n134_), .b(new_n158_), .O(new_n191_));
  ...
  nand4  g150(.a(new_n194_), .b(new_n186_), .c(new_n185_), .d(new_n182_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n180_), .c(new_n175_), .O(new_n197_));
