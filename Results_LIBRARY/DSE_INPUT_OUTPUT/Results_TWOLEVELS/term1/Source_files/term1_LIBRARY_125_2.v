...
module FAU ( 
  ...
  aoi21  g018(.a(new_n62_), .b(new_n60_), .c(new_n46_), .O(new_n63_));
  ...
  aoi21  g043(.a(new_n87_), .b(new_n82_), .c(new_n46_), .O(new_n88_));
  ...
  nor3   g063(.a(new_n107_), .b(new_n106_), .c(new_n105_), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(new_n104_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n83_), .c(new_n101_), .d(new_n100_), .O(new_n110_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n116_), .c(x25), .d(x01), .O(new_n118_));
  aoi21  g074(.a(new_n118_), .b(new_n45_), .c(x26), .O(z4));
  inv1   g075(.a(x29), .O(new_n120_));
  and2   g076(.a(x28), .b(x27), .O(new_n121_));
  nand3  g077(.a(new_n120_), .b(x28), .c(x27), .O(new_n122_));
  oai21  g078(.a(new_n121_), .b(new_n120_), .c(new_n122_), .O(new_n123_));
  nand4  g079(.a(new_n123_), .b(new_n109_), .c(new_n83_), .d(new_n100_), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  nand4  g081(.a(new_n125_), .b(x25), .c(x01), .d(new_n45_), .O(new_n126_));
  inv1   g082(.a(new_n126_), .O(z5));
  oai21  g083(.a(x28), .b(x00), .c(x29), .O(new_n128_));
  oai21  g084(.a(new_n128_), .b(new_n101_), .c(x30), .O(new_n129_));
  inv1   g085(.a(x30), .O(new_n130_));
  nand3  g086(.a(new_n121_), .b(new_n130_), .c(x29), .O(new_n131_));
  aoi21  g087(.a(new_n131_), .b(new_n129_), .c(new_n115_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n83_), .c(x25), .d(x01), .O(new_n133_));
  aoi21  g089(.a(new_n133_), .b(new_n45_), .c(x26), .O(z6));
  nand3  g090(.a(new_n121_), .b(x30), .c(x29), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x31), .O(new_n136_));
  inv1   g092(.a(new_n105_), .O(new_n137_));
  inv1   g093(.a(new_n106_), .O(new_n138_));
  inv1   g094(.a(new_n107_), .O(new_n139_));
  nand4  g095(.a(new_n139_), .b(new_n138_), .c(new_n137_), .d(new_n104_), .O(new_n140_));
  nor2   g096(.a(new_n114_), .b(new_n61_), .O(new_n141_));
  ...
  aoi21  g101(.a(new_n145_), .b(new_n121_), .c(new_n142_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n141_), .c(new_n140_), .d(new_n136_), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n45_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n100_), .O(z7));
  zero   g105(.O(z8));
  zero   g106(.O(z9));
endmodule
