...
module FAU ( 
  ...
  aoi21  g078(.a(new_n122_), .b(new_n103_), .c(new_n79_), .O(new_n123_));
  nand3  g079(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n117_), .c(new_n80_), .O(new_n125_));
  oai21  g081(.a(new_n80_), .b(new_n45_), .c(new_n125_), .O(z7));
  ...
  nand2  g106(.a(new_n116_), .b(x27), .O(new_n151_));
  ...
  aoi21  g121(.a(new_n116_), .b(x28), .c(new_n165_), .O(new_n166_));
  ...
  nand4  g135(.a(new_n149_), .b(new_n174_), .c(new_n115_), .d(new_n110_), .O(new_n180_));
