...
module FAU ( 
  ...
  or2    g040(.a(new_n84_), .b(new_n83_), .O(new_n85_));
  ...
  nor2   g061(.a(new_n83_), .b(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n93_), .b(new_n88_), .O(new_n107_));
  nor2   g063(.a(new_n107_), .b(new_n84_), .O(new_n108_));
  aoi21  g064(.a(new_n108_), .b(new_n106_), .c(x29), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(x28), .c(x27), .O(new_n110_));
  oai21  g066(.a(new_n110_), .b(x23), .c(new_n104_), .O(new_n111_));
  ...
  oai21  g070(.a(new_n107_), .b(new_n85_), .c(x29), .O(new_n115_));
  aoi21  g071(.a(new_n115_), .b(new_n90_), .c(new_n102_), .O(new_n116_));
  aoi21  g072(.a(new_n109_), .b(new_n45_), .c(new_n116_), .O(new_n117_));
  nor2   g073(.a(new_n95_), .b(x30), .O(new_n118_));
  ...
  oai21  g081(.a(new_n125_), .b(new_n82_), .c(x31), .O(new_n126_));
  inv1   g082(.a(new_n85_), .O(new_n127_));
  nand3  g083(.a(new_n93_), .b(new_n88_), .c(new_n127_), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x23), .O(new_n130_));
  inv1   g086(.a(x31), .O(new_n131_));
  nand3  g087(.a(new_n102_), .b(new_n131_), .c(x30), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n126_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(x29), .O(new_n134_));
  oai22  g090(.a(new_n128_), .b(new_n105_), .c(new_n131_), .d(x29), .O(new_n135_));
  ...
  nand3  g100(.a(x19), .b(new_n105_), .c(x13), .O(new_n145_));
  nand3  g101(.a(new_n91_), .b(x18), .c(x14), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n145_), .c(new_n86_), .O(new_n147_));
  nand4  g103(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n148_));
  ...
  xor2a  g116(.a(x30), .b(x27), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(x28), .c(new_n125_), .O(new_n162_));
  nand2  g118(.a(x16), .b(x10), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n152_), .c(new_n157_), .O(new_n164_));
  nor2   g120(.a(new_n91_), .b(new_n105_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(x17), .c(x11), .O(new_n166_));
  nand2  g122(.a(new_n166_), .b(new_n151_), .O(new_n167_));
  aoi21  g123(.a(new_n165_), .b(x12), .c(x17), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  nand2  g125(.a(x19), .b(x13), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n105_), .O(new_n171_));
  nand2  g127(.a(x16), .b(x15), .O(new_n172_));
  oai22  g128(.a(new_n172_), .b(new_n152_), .c(x19), .d(x14), .O(new_n173_));
  inv1   g129(.a(new_n173_), .O(new_n174_));
  nor2   g130(.a(x30), .b(x29), .O(new_n175_));
  aoi21  g131(.a(new_n175_), .b(new_n45_), .c(new_n131_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n174_), .c(new_n171_), .O(new_n177_));
  inv1   g133(.a(new_n177_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n169_), .c(new_n167_), .d(new_n164_), .O(new_n179_));
  aoi21  g135(.a(new_n162_), .b(x29), .c(new_n179_), .O(new_n180_));
  oai21  g136(.a(new_n180_), .b(new_n138_), .c(new_n160_), .O(new_n181_));
  ...
  nand3  g143(.a(new_n187_), .b(new_n140_), .c(x29), .O(new_n188_));
  nand4  g144(.a(new_n159_), .b(new_n184_), .c(new_n131_), .d(new_n114_), .O(new_n189_));
  nand2  g145(.a(x33), .b(x31), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n189_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n142_), .O(new_n192_));
  inv1   g148(.a(new_n164_), .O(new_n193_));
  xor2a  g149(.a(x31), .b(x30), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n173_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n171_), .c(new_n169_), .d(new_n167_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n193_), .c(x33), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n192_), .c(new_n188_), .O(new_n198_));
