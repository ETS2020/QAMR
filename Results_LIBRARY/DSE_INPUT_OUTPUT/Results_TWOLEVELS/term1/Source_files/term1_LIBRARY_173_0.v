...
module FAU ( 
  ...
  nand4  g068(.a(new_n112_), .b(new_n81_), .c(new_n99_), .d(new_n98_), .O(new_n113_));
  ...
  nand4  g073(.a(new_n117_), .b(new_n112_), .c(new_n81_), .d(new_n98_), .O(new_n118_));
  inv1   g074(.a(new_n118_), .O(new_n119_));
  nand4  g075(.a(new_n119_), .b(x25), .c(x01), .d(x00), .O(new_n120_));
  inv1   g076(.a(new_n120_), .O(z4));
  ...
  nand3  g082(.a(new_n126_), .b(x28), .c(x27), .O(new_n127_));
  aoi21  g083(.a(new_n127_), .b(new_n125_), .c(new_n111_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n81_), .c(x25), .d(x01), .O(new_n129_));
  aoi21  g085(.a(new_n129_), .b(x00), .c(x26), .O(z5));
  nand3  g086(.a(x29), .b(x28), .c(x27), .O(new_n131_));
  nand2  g087(.a(new_n131_), .b(x30), .O(new_n132_));
  inv1   g088(.a(x30), .O(new_n133_));
  nand3  g089(.a(new_n123_), .b(new_n133_), .c(x29), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n112_), .c(new_n81_), .d(new_n98_), .O(new_n136_));
  inv1   g092(.a(new_n136_), .O(new_n137_));
  nand4  g093(.a(new_n137_), .b(x25), .c(x01), .d(x00), .O(new_n138_));
  inv1   g094(.a(new_n138_), .O(z6));
  nand3  g095(.a(new_n123_), .b(x30), .c(x29), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(x31), .O(new_n141_));
  inv1   g097(.a(new_n100_), .O(new_n142_));
  nand4  g098(.a(new_n109_), .b(new_n106_), .c(new_n103_), .d(new_n142_), .O(new_n143_));
  nand3  g099(.a(new_n81_), .b(x25), .c(x01), .O(new_n144_));
  inv1   g100(.a(new_n144_), .O(new_n145_));
  inv1   g101(.a(x31), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x30), .c(x29), .O(new_n147_));
  oai21  g103(.a(new_n147_), .b(new_n124_), .c(new_n46_), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(x26), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(z7));
  nand2  g106(.a(new_n122_), .b(new_n99_), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand3  g108(.a(x19), .b(new_n104_), .c(x13), .O(new_n153_));
  nand3  g109(.a(new_n107_), .b(x18), .c(x14), .O(new_n154_));
  aoi21  g110(.a(new_n154_), .b(new_n153_), .c(new_n101_), .O(new_n155_));
  nand4  g111(.a(x19), .b(x18), .c(new_n101_), .d(x12), .O(new_n156_));
  ...
  nand3  g123(.a(new_n167_), .b(new_n152_), .c(x31), .O(new_n168_));
  nand2  g124(.a(x32), .b(x30), .O(new_n169_));
  oai21  g125(.a(new_n168_), .b(x30), .c(new_n169_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n151_), .c(x29), .O(new_n171_));
  nand2  g127(.a(new_n151_), .b(x29), .O(new_n172_));
  nand4  g128(.a(new_n167_), .b(new_n152_), .c(x31), .d(x30), .O(new_n173_));
  nand2  g129(.a(x32), .b(new_n133_), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  and2   g131(.a(x16), .b(x10), .O(new_n176_));
  aoi21  g132(.a(new_n176_), .b(new_n161_), .c(x15), .O(new_n177_));
  nand2  g133(.a(x19), .b(x18), .O(new_n178_));
  nand2  g134(.a(x17), .b(x11), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n178_), .c(new_n159_), .O(new_n180_));
  inv1   g136(.a(x12), .O(new_n181_));
  oai21  g137(.a(new_n178_), .b(new_n181_), .c(new_n101_), .O(new_n182_));
  nand2  g138(.a(x19), .b(x13), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n104_), .O(new_n184_));
  nor2   g140(.a(x19), .b(x14), .O(new_n185_));
  nor3   g141(.a(new_n160_), .b(new_n159_), .c(new_n165_), .O(new_n186_));
  nor3   g142(.a(new_n186_), .b(new_n185_), .c(new_n146_), .O(new_n187_));
  ...
  aoi21  g146(.a(new_n175_), .b(new_n172_), .c(new_n190_), .O(new_n191_));
  aoi21  g147(.a(new_n191_), .b(new_n171_), .c(x26), .O(z8));
  inv1   g148(.a(x33), .O(new_n193_));
  nand4  g149(.a(new_n167_), .b(new_n193_), .c(x31), .d(x30), .O(new_n194_));
  nand2  g150(.a(x33), .b(new_n146_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n151_), .c(x29), .O(new_n197_));
  nand4  g153(.a(new_n167_), .b(new_n193_), .c(new_n146_), .d(new_n133_), .O(new_n198_));
  nand2  g154(.a(x33), .b(x31), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  xor2a  g156(.a(x31), .b(x30), .O(new_n201_));
  nor3   g157(.a(new_n201_), .b(new_n186_), .c(new_n185_), .O(new_n202_));
  nand4  g158(.a(new_n202_), .b(new_n184_), .c(new_n182_), .d(new_n180_), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(new_n177_), .c(x33), .O(new_n204_));
  nand2  g160(.a(new_n204_), .b(x00), .O(new_n205_));
  aoi21  g161(.a(new_n200_), .b(new_n172_), .c(new_n205_), .O(new_n206_));
  aoi21  g162(.a(new_n206_), .b(new_n197_), .c(x26), .O(z9));
endmodule
