...
module FAU ( 
  ...
  nor3   g071(.a(new_n115_), .b(new_n82_), .c(new_n63_), .O(z6));
  ...
  nand4  g076(.a(new_n93_), .b(new_n90_), .c(new_n87_), .d(new_n120_), .O(new_n121_));
  ...
  nand2  g085(.a(new_n112_), .b(new_n83_), .O(new_n130_));
  ...
  oai21  g098(.a(new_n139_), .b(new_n142_), .c(new_n85_), .O(new_n143_));
  inv1   g099(.a(new_n143_), .O(new_n144_));
  nand2  g100(.a(x19), .b(x13), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n88_), .O(new_n146_));
  inv1   g102(.a(x14), .O(new_n147_));
  nand2  g103(.a(new_n91_), .b(new_n147_), .O(new_n148_));
  ...
  nand3  g118(.a(new_n91_), .b(x18), .c(x14), .O(new_n163_));
