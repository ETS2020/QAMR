...
module FAU ( 
  ...
  nand2  g035(.a(x29), .b(x27), .O(new_n80_));
  ...
  nand3  g052(.a(x29), .b(new_n96_), .c(x27), .O(new_n97_));
  ...
  nand3  g057(.a(new_n101_), .b(new_n93_), .c(x29), .O(new_n102_));
  ...
  oai21  g062(.a(new_n96_), .b(new_n106_), .c(x30), .O(new_n107_));
  inv1   g063(.a(x30), .O(new_n108_));
  nand3  g064(.a(new_n108_), .b(x28), .c(x27), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n92_), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n60_), .c(new_n79_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x25), .c(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n46_), .O(z6));
  inv1   g070(.a(x31), .O(new_n115_));
  nand2  g071(.a(new_n115_), .b(x30), .O(new_n116_));
  oai21  g072(.a(new_n116_), .b(new_n96_), .c(x29), .O(new_n117_));
  nand2  g073(.a(new_n117_), .b(x27), .O(new_n118_));
  nand3  g074(.a(x30), .b(x28), .c(x27), .O(new_n119_));
  ...
  aoi21  g087(.a(new_n131_), .b(new_n127_), .c(x15), .O(new_n132_));
  inv1   g088(.a(x16), .O(new_n133_));
  nand2  g089(.a(x17), .b(x11), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n128_), .c(new_n133_), .O(new_n135_));
  inv1   g091(.a(x12), .O(new_n136_));
  oai21  g092(.a(new_n128_), .b(new_n136_), .c(new_n82_), .O(new_n137_));
  inv1   g093(.a(x13), .O(new_n138_));
  oai21  g094(.a(new_n88_), .b(new_n138_), .c(new_n85_), .O(new_n139_));
  nor2   g095(.a(x19), .b(x14), .O(new_n140_));
  nand2  g096(.a(x16), .b(x15), .O(new_n141_));
  oai21  g097(.a(new_n141_), .b(new_n130_), .c(x31), .O(new_n142_));
  nor2   g098(.a(new_n142_), .b(new_n140_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n139_), .c(new_n137_), .d(new_n135_), .O(new_n144_));
  oai21  g100(.a(new_n144_), .b(new_n132_), .c(new_n46_), .O(new_n145_));
  aoi21  g101(.a(x29), .b(x28), .c(x30), .O(new_n146_));
  aoi21  g102(.a(new_n96_), .b(new_n106_), .c(new_n108_), .O(new_n147_));
  aoi22  g103(.a(new_n147_), .b(x29), .c(new_n146_), .d(new_n106_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(new_n145_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  nand2  g107(.a(x29), .b(x28), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(x30), .c(new_n106_), .O(new_n153_));
  nand2  g109(.a(new_n96_), .b(new_n106_), .O(new_n154_));
  nand3  g110(.a(new_n154_), .b(new_n108_), .c(x29), .O(new_n155_));
  ...
  nand3  g118(.a(new_n131_), .b(new_n133_), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x15), .O(new_n165_));
  inv1   g121(.a(x15), .O(new_n166_));
  nand4  g122(.a(new_n131_), .b(x16), .c(new_n166_), .d(x10), .O(new_n167_));
  nand2  g123(.a(new_n167_), .b(new_n165_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n156_), .c(new_n151_), .d(x31), .O(new_n169_));
  ...
  nand2  g128(.a(new_n152_), .b(new_n106_), .O(new_n173_));
  inv1   g129(.a(x33), .O(new_n174_));
  nand4  g130(.a(new_n168_), .b(new_n174_), .c(x31), .d(x30), .O(new_n175_));
  ...
  nand2  g134(.a(new_n154_), .b(x29), .O(new_n179_));
  nand4  g135(.a(new_n168_), .b(new_n174_), .c(new_n115_), .d(new_n108_), .O(new_n180_));
  ...
  oai21  g142(.a(new_n186_), .b(new_n141_), .c(new_n88_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n126_), .c(new_n166_), .O(new_n188_));
  inv1   g144(.a(x11), .O(new_n189_));
  oai21  g145(.a(new_n186_), .b(new_n189_), .c(new_n133_), .O(new_n190_));
  oai21  g146(.a(new_n85_), .b(new_n136_), .c(new_n82_), .O(new_n191_));
  nand2  g147(.a(new_n85_), .b(new_n138_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n191_), .c(new_n190_), .d(new_n116_), .O(new_n193_));
  inv1   g149(.a(new_n193_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n188_), .c(new_n187_), .d(new_n185_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n183_), .c(new_n178_), .O(new_n197_));
  nand3  g153(.a(new_n197_), .b(new_n79_), .c(x00), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n46_), .O(z9));
endmodule
