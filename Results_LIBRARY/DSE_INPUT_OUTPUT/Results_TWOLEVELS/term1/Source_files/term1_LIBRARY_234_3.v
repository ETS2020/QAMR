...
module FAU ( 
  ...
  oai21  g052(.a(new_n96_), .b(new_n60_), .c(new_n48_), .O(z3));
  ...
  nand2  g073(.a(new_n117_), .b(new_n48_), .O(z5));
  ...
  nand3  g079(.a(new_n123_), .b(x30), .c(new_n45_), .O(new_n124_));
  ...
  nor2   g089(.a(new_n46_), .b(new_n110_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n112_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(x31), .O(new_n136_));
  inv1   g092(.a(new_n83_), .O(new_n137_));
  nand4  g093(.a(new_n92_), .b(new_n89_), .c(new_n86_), .d(new_n137_), .O(new_n138_));
  nand4  g094(.a(new_n62_), .b(new_n81_), .c(x25), .d(x01), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand4  g096(.a(new_n140_), .b(new_n138_), .c(new_n136_), .d(new_n133_), .O(z7));
  ...
  nor2   g101(.a(new_n143_), .b(new_n110_), .O(new_n146_));
  ...
  nand2  g121(.a(new_n134_), .b(x27), .O(new_n166_));
  ...
  oai21  g129(.a(new_n155_), .b(new_n173_), .c(new_n84_), .O(new_n174_));
  inv1   g130(.a(x13), .O(new_n175_));
  oai21  g131(.a(new_n90_), .b(new_n175_), .c(new_n87_), .O(new_n176_));
  ...
  aoi21  g136(.a(new_n134_), .b(x28), .c(new_n180_), .O(new_n181_));
  ...
  nand4  g150(.a(new_n164_), .b(new_n189_), .c(new_n130_), .d(new_n46_), .O(new_n195_));
  ...
  oai21  g162(.a(new_n87_), .b(new_n173_), .c(new_n84_), .O(new_n207_));
  nand2  g163(.a(new_n87_), .b(new_n175_), .O(new_n208_));
  ...
  nand2  g171(.a(new_n215_), .b(new_n48_), .O(z9));
endmodule
