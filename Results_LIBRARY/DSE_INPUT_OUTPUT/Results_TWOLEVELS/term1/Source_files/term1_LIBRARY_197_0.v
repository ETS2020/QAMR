...
module FAU ( 
  ...
  aoi21  g109(.a(new_n98_), .b(new_n81_), .c(new_n100_), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n109_), .c(new_n110_), .d(new_n81_), .O(new_n155_));
  ...
  nand2  g133(.a(new_n98_), .b(new_n81_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x31), .c(x30), .d(x29), .O(new_n179_));
  nand3  g135(.a(new_n120_), .b(new_n109_), .c(new_n100_), .O(new_n180_));
  ...
  nand2  g143(.a(new_n120_), .b(x29), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n187_), .c(new_n119_), .O(new_n189_));
