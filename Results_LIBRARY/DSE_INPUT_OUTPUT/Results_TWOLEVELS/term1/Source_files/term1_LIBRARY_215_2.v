...
module FAU ( 
  ...
  nand3  g083(.a(x32), .b(x29), .c(new_n101_), .O(new_n128_));
  ...
  oai21  g088(.a(new_n132_), .b(new_n103_), .c(x30), .O(new_n133_));
  ...
  nor2   g119(.a(new_n45_), .b(new_n103_), .O(new_n164_));
  ...
  oai21  g142(.a(new_n45_), .b(new_n101_), .c(x31), .O(new_n187_));
  ...
  nand4  g149(.a(new_n120_), .b(new_n116_), .c(new_n45_), .d(new_n81_), .O(new_n194_));
  inv1   g150(.a(new_n194_), .O(new_n195_));
  nor4   g151(.a(new_n132_), .b(new_n116_), .c(new_n45_), .d(new_n103_), .O(new_n196_));
