...
module FAU ( 
  ...
  nor2   g052(.a(new_n96_), .b(x28), .O(new_n97_));
  nand2  g053(.a(new_n97_), .b(x27), .O(new_n98_));
  oai21  g054(.a(new_n95_), .b(x27), .c(new_n98_), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(new_n91_), .c(new_n81_), .O(new_n100_));
  nor3   g056(.a(new_n100_), .b(new_n94_), .c(new_n60_), .O(z4));
  ...
  nor3   g063(.a(new_n107_), .b(new_n94_), .c(new_n60_), .O(z5));
  ...
  aoi21  g100(.a(new_n95_), .b(new_n45_), .c(new_n96_), .O(new_n145_));
  ...
  nand3  g106(.a(new_n96_), .b(x29), .c(x28), .O(new_n151_));
  inv1   g107(.a(new_n151_), .O(new_n152_));
  oai21  g108(.a(new_n152_), .b(new_n97_), .c(new_n45_), .O(new_n153_));
  ...
  oai21  g128(.a(new_n96_), .b(new_n95_), .c(new_n45_), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(x31), .c(x29), .O(new_n174_));
  nand3  g130(.a(new_n117_), .b(new_n119_), .c(new_n96_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n172_), .b(new_n171_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n137_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n164_), .O(new_n180_));
  oai21  g136(.a(new_n119_), .b(new_n104_), .c(x30), .O(new_n181_));
  oai21  g137(.a(x28), .b(x27), .c(x30), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x31), .O(new_n183_));
  nand2  g139(.a(x18), .b(x17), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n140_), .c(new_n137_), .O(new_n185_));
  nand3  g141(.a(new_n124_), .b(x18), .c(x17), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n184_), .b(new_n187_), .c(new_n128_), .O(new_n188_));
  oai21  g144(.a(new_n136_), .b(new_n132_), .c(new_n133_), .O(new_n189_));
  nand2  g145(.a(new_n136_), .b(new_n135_), .O(new_n190_));
  nand3  g146(.a(new_n119_), .b(x29), .c(x28), .O(new_n191_));
  nand4  g147(.a(new_n191_), .b(new_n190_), .c(new_n189_), .d(new_n188_), .O(new_n192_));
  aoi21  g148(.a(new_n186_), .b(new_n164_), .c(new_n192_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n185_), .c(new_n183_), .d(new_n181_), .O(new_n194_));
