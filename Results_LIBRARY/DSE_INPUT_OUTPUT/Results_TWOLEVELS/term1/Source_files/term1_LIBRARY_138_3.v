...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n90_), .c(new_n81_), .d(x25), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n60_), .c(new_n48_), .O(z6));
  inv1   g064(.a(new_n86_), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n85_), .c(new_n83_), .O(new_n110_));
  nand3  g066(.a(new_n62_), .b(x25), .c(x01), .O(new_n111_));
  ...
  aoi22  g092(.a(new_n136_), .b(new_n45_), .c(new_n46_), .d(new_n98_), .O(new_n137_));
  ...
  nand2  g097(.a(new_n96_), .b(new_n45_), .O(new_n142_));
  ...
  nor2   g112(.a(new_n156_), .b(new_n115_), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n154_), .O(new_n159_));
  nand4  g115(.a(new_n159_), .b(new_n144_), .c(new_n140_), .d(x31), .O(new_n160_));
  ...
  oai21  g127(.a(new_n171_), .b(new_n105_), .c(new_n170_), .O(new_n172_));
  oai21  g128(.a(new_n157_), .b(new_n167_), .c(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n127_), .b(x14), .O(new_n174_));
  ...
  nor2   g133(.a(new_n126_), .b(new_n123_), .O(new_n178_));
  inv1   g134(.a(new_n178_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n130_), .c(new_n127_), .O(new_n180_));
  oai21  g136(.a(new_n179_), .b(new_n114_), .c(new_n155_), .O(new_n181_));
  aoi21  g137(.a(new_n178_), .b(x11), .c(x16), .O(new_n182_));
  oai21  g138(.a(new_n126_), .b(new_n122_), .c(new_n123_), .O(new_n183_));
  nand2  g139(.a(new_n126_), .b(new_n125_), .O(new_n184_));
