...
module FAU ( 
  ...
  aoi21  g047(.a(new_n90_), .b(new_n48_), .c(new_n91_), .O(new_n92_));
  nor2   g048(.a(new_n92_), .b(new_n62_), .O(new_n93_));
  nand4  g049(.a(new_n93_), .b(new_n83_), .c(new_n82_), .d(x25), .O(new_n94_));
  nor2   g050(.a(new_n94_), .b(new_n61_), .O(z3));
  xor2a  g051(.a(x28), .b(x27), .O(new_n96_));
  inv1   g052(.a(new_n85_), .O(new_n97_));
  nor2   g053(.a(new_n91_), .b(new_n84_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n89_), .c(new_n97_), .O(new_n99_));
  and2   g055(.a(new_n99_), .b(new_n63_), .O(new_n100_));
  nand4  g056(.a(new_n100_), .b(new_n96_), .c(new_n82_), .d(x25), .O(new_n101_));
  oai21  g057(.a(new_n101_), .b(new_n61_), .c(new_n48_), .O(z4));
  inv1   g058(.a(new_n91_), .O(new_n103_));
  ...
  aoi21  g062(.a(new_n106_), .b(new_n103_), .c(new_n105_), .O(new_n107_));
  ...
  oai21  g072(.a(new_n105_), .b(x20), .c(x29), .O(new_n117_));
  aoi22  g073(.a(new_n117_), .b(new_n90_), .c(new_n116_), .d(new_n115_), .O(new_n118_));
  nand4  g074(.a(new_n99_), .b(new_n46_), .c(x29), .d(x28), .O(new_n119_));
  oai22  g075(.a(new_n119_), .b(new_n83_), .c(new_n118_), .d(new_n46_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n63_), .c(new_n82_), .d(x25), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n61_), .c(new_n48_), .O(z6));
  nand4  g078(.a(new_n63_), .b(new_n82_), .c(x25), .d(x01), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n48_), .O(new_n124_));
  nand2  g080(.a(new_n116_), .b(x31), .O(new_n125_));
  inv1   g081(.a(new_n87_), .O(new_n126_));
  inv1   g082(.a(new_n88_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n126_), .c(new_n86_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n132_), .b(new_n130_), .c(new_n125_), .O(new_n133_));
  nand2  g089(.a(new_n133_), .b(new_n45_), .O(new_n134_));
  oai21  g090(.a(new_n128_), .b(new_n45_), .c(new_n131_), .O(new_n135_));
  nand2  g091(.a(new_n135_), .b(new_n46_), .O(new_n136_));
  nand3  g092(.a(new_n136_), .b(new_n134_), .c(new_n124_), .O(z7));
  inv1   g093(.a(x32), .O(new_n138_));
  nor2   g094(.a(x28), .b(x27), .O(new_n139_));
  inv1   g095(.a(new_n139_), .O(new_n140_));
  nand3  g096(.a(new_n140_), .b(new_n46_), .c(x29), .O(new_n141_));
  nor2   g097(.a(new_n139_), .b(new_n109_), .O(new_n142_));
  oai21  g098(.a(new_n142_), .b(new_n46_), .c(new_n141_), .O(new_n143_));
  ...
  nand4  g114(.a(new_n155_), .b(x16), .c(new_n115_), .d(x10), .O(new_n159_));
  nand2  g115(.a(new_n159_), .b(new_n158_), .O(new_n160_));
  nand4  g116(.a(new_n160_), .b(new_n143_), .c(new_n138_), .d(x31), .O(new_n161_));
  oai21  g117(.a(new_n104_), .b(x20), .c(new_n83_), .O(new_n162_));
  nand3  g118(.a(new_n162_), .b(x30), .c(x29), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  inv1   g120(.a(new_n142_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n46_), .O(new_n166_));
  nand2  g122(.a(x16), .b(x10), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n154_), .c(new_n115_), .O(new_n168_));
  nor2   g124(.a(new_n147_), .b(new_n145_), .O(new_n169_));
  ...
  nand2  g132(.a(new_n147_), .b(new_n176_), .O(new_n177_));
  nor3   g133(.a(new_n154_), .b(new_n153_), .c(new_n115_), .O(new_n178_));
  nor2   g134(.a(new_n178_), .b(new_n131_), .O(new_n179_));
  nand3  g135(.a(new_n179_), .b(new_n177_), .c(new_n175_), .O(new_n180_));
  aoi21  g136(.a(new_n173_), .b(new_n144_), .c(new_n180_), .O(new_n181_));
  nand4  g137(.a(new_n181_), .b(new_n172_), .c(new_n168_), .d(new_n166_), .O(new_n182_));
  oai21  g138(.a(new_n182_), .b(new_n164_), .c(x32), .O(new_n183_));
  ...
  aoi21  g142(.a(new_n159_), .b(new_n158_), .c(x33), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(x31), .c(x30), .d(new_n45_), .O(new_n188_));
  nand2  g144(.a(x33), .b(new_n131_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n140_), .c(x29), .O(new_n191_));
  inv1   g147(.a(x33), .O(new_n192_));
  nand4  g148(.a(new_n160_), .b(new_n192_), .c(new_n131_), .d(new_n46_), .O(new_n193_));
  nand2  g149(.a(x33), .b(x31), .O(new_n194_));
  nand2  g150(.a(new_n194_), .b(new_n193_), .O(new_n195_));
  nand2  g151(.a(new_n173_), .b(new_n144_), .O(new_n196_));
  aoi21  g152(.a(new_n147_), .b(new_n176_), .c(new_n178_), .O(new_n197_));
  xnor2a g153(.a(x31), .b(x30), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n197_), .c(new_n175_), .d(new_n196_), .O(new_n199_));
  nor2   g155(.a(new_n199_), .b(new_n171_), .O(new_n200_));
  aoi21  g156(.a(new_n200_), .b(new_n168_), .c(new_n192_), .O(new_n201_));
  aoi21  g157(.a(new_n195_), .b(new_n165_), .c(new_n201_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(new_n191_), .O(new_n203_));
