...
module FAU ( 
  ...
  nor2   g056(.a(x29), .b(new_n82_), .O(new_n101_));
  nor3   g057(.a(new_n95_), .b(new_n45_), .c(x27), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n101_), .c(x28), .O(new_n103_));
  nand2  g059(.a(x29), .b(new_n93_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n103_), .c(new_n87_), .O(new_n105_));
  nand4  g061(.a(new_n105_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n106_));
  oai21  g062(.a(new_n106_), .b(new_n60_), .c(new_n47_), .O(z5));
  aoi21  g063(.a(x30), .b(new_n82_), .c(new_n93_), .O(new_n108_));
  nand2  g064(.a(x30), .b(new_n45_), .O(new_n109_));
  oai21  g065(.a(new_n108_), .b(new_n45_), .c(new_n109_), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n92_), .c(new_n62_), .d(new_n81_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x25), .c(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n47_), .O(z6));
  nor4   g070(.a(new_n86_), .b(new_n85_), .c(new_n84_), .d(new_n83_), .O(new_n115_));
  ...
  nor2   g074(.a(new_n93_), .b(new_n82_), .O(new_n119_));
  nand3  g075(.a(new_n119_), .b(new_n118_), .c(x29), .O(new_n120_));
  ...
  inv1   g102(.a(new_n127_), .O(new_n147_));
  ...
  aoi21  g117(.a(new_n161_), .b(new_n146_), .c(new_n95_), .O(new_n162_));
  nand3  g118(.a(x32), .b(new_n95_), .c(new_n45_), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  oai21  g120(.a(new_n164_), .b(new_n162_), .c(new_n81_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n124_), .O(z8));
  nand2  g122(.a(new_n131_), .b(x14), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(x18), .c(x17), .d(x16), .O(new_n168_));
  nor2   g124(.a(new_n168_), .b(new_n143_), .O(new_n169_));
  nand2  g125(.a(x18), .b(x17), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(new_n157_), .c(new_n131_), .O(new_n171_));
  oai21  g127(.a(new_n170_), .b(new_n148_), .c(new_n143_), .O(new_n172_));
  inv1   g128(.a(x11), .O(new_n173_));
  oai21  g129(.a(new_n170_), .b(new_n173_), .c(new_n137_), .O(new_n174_));
  ...
  oai21  g134(.a(new_n178_), .b(new_n169_), .c(new_n47_), .O(new_n179_));
  nand2  g135(.a(new_n126_), .b(x31), .O(new_n180_));
  aoi22  g136(.a(new_n180_), .b(x30), .c(x31), .d(new_n45_), .O(new_n181_));
  nand2  g137(.a(new_n181_), .b(new_n179_), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(x33), .O(new_n183_));
  nor3   g139(.a(new_n180_), .b(new_n95_), .c(new_n45_), .O(new_n184_));
  nor3   g140(.a(x31), .b(x30), .c(x29), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n184_), .c(new_n145_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(x33), .c(new_n183_), .O(new_n187_));
