...
module FAU ( 
  ...
  nand3  g047(.a(new_n91_), .b(new_n45_), .c(new_n80_), .O(new_n92_));
  ...
  nand3  g052(.a(new_n45_), .b(x28), .c(new_n80_), .O(new_n97_));
  oai21  g053(.a(x28), .b(new_n80_), .c(new_n97_), .O(new_n98_));
  nand3  g054(.a(new_n98_), .b(new_n91_), .c(new_n79_), .O(new_n99_));
  nor3   g055(.a(new_n99_), .b(new_n96_), .c(new_n59_), .O(z4));
  xor2a  g056(.a(x29), .b(x28), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(new_n91_), .c(x27), .O(new_n102_));
  ...
  aoi21  g069(.a(new_n113_), .b(new_n112_), .c(new_n106_), .O(new_n114_));
  ...
  nand2  g083(.a(new_n113_), .b(new_n110_), .O(new_n128_));
  ...
  nand4  g102(.a(new_n146_), .b(new_n128_), .c(new_n127_), .d(x31), .O(new_n147_));
  nand2  g103(.a(x16), .b(x10), .O(new_n148_));
  inv1   g104(.a(new_n148_), .O(new_n149_));
  aoi21  g105(.a(new_n149_), .b(new_n140_), .c(x15), .O(new_n150_));
  ...
  oai21  g110(.a(new_n151_), .b(new_n154_), .c(new_n129_), .O(new_n155_));
  inv1   g111(.a(x13), .O(new_n156_));
  oai21  g112(.a(new_n132_), .b(new_n156_), .c(new_n130_), .O(new_n157_));
  nand2  g113(.a(x16), .b(x15), .O(new_n158_));
  oai22  g114(.a(new_n158_), .b(new_n139_), .c(x19), .d(x14), .O(new_n159_));
  nand2  g115(.a(new_n109_), .b(new_n45_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n121_), .c(x31), .O(new_n161_));
  nor2   g117(.a(new_n161_), .b(new_n159_), .O(new_n162_));
  nand4  g118(.a(new_n162_), .b(new_n157_), .c(new_n155_), .d(new_n153_), .O(new_n163_));
  ...
  nand4  g124(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n169_));
  nand2  g125(.a(new_n117_), .b(new_n109_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(x29), .c(new_n169_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n146_), .c(new_n168_), .O(new_n172_));
  nand2  g128(.a(new_n132_), .b(x14), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(x18), .c(x17), .d(x16), .O(new_n174_));
  nor2   g130(.a(new_n174_), .b(new_n144_), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n158_), .c(new_n132_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n148_), .c(new_n144_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n138_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n129_), .c(new_n130_), .d(new_n156_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n175_), .c(new_n57_), .O(new_n184_));
  oai21  g140(.a(x31), .b(new_n109_), .c(new_n110_), .O(new_n185_));
  aoi22  g141(.a(new_n185_), .b(x27), .c(new_n170_), .d(new_n45_), .O(new_n186_));
