...
module FAU ( 
  ...
  oai21  g066(.a(new_n105_), .b(new_n82_), .c(x30), .O(new_n111_));
  nand2  g067(.a(new_n106_), .b(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n94_), .c(new_n62_), .d(x28), .O(new_n114_));
  ...
  oai21  g078(.a(new_n122_), .b(new_n82_), .c(x31), .O(new_n123_));
  ...
  oai21  g083(.a(x29), .b(new_n99_), .c(x30), .O(new_n128_));
  ...
  oai21  g102(.a(new_n146_), .b(new_n105_), .c(new_n45_), .O(new_n147_));
  oai21  g103(.a(new_n122_), .b(new_n99_), .c(new_n147_), .O(new_n148_));
  aoi21  g104(.a(new_n145_), .b(new_n58_), .c(new_n148_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n143_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand2  g108(.a(x30), .b(new_n105_), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n106_), .c(x28), .O(new_n155_));
  ...
  oai21  g131(.a(new_n175_), .b(new_n146_), .c(new_n118_), .O(new_n176_));
  ...
  nor2   g140(.a(new_n88_), .b(new_n85_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n144_), .c(new_n91_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n130_), .c(new_n129_), .O(new_n188_));
  aoi21  g144(.a(new_n185_), .b(x11), .c(x16), .O(new_n189_));
  oai21  g145(.a(new_n88_), .b(new_n137_), .c(new_n85_), .O(new_n190_));
  inv1   g146(.a(x13), .O(new_n191_));
  nand2  g147(.a(new_n88_), .b(new_n191_), .O(new_n192_));
  nand2  g148(.a(x31), .b(new_n45_), .O(new_n193_));
