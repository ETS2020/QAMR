...
module FAU ( 
  ...
  nand4  g034(.a(new_n78_), .b(new_n59_), .c(new_n58_), .d(x08), .O(new_n79_));
  ...
  oai21  g052(.a(new_n96_), .b(new_n61_), .c(new_n59_), .O(z3));
  inv1   g053(.a(x25), .O(new_n98_));
  nand3  g054(.a(new_n46_), .b(x28), .c(new_n82_), .O(new_n99_));
  oai21  g055(.a(x28), .b(new_n82_), .c(new_n99_), .O(new_n100_));
  nand3  g056(.a(new_n100_), .b(new_n95_), .c(new_n81_), .O(new_n101_));
  nor3   g057(.a(new_n101_), .b(new_n98_), .c(new_n61_), .O(z4));
  oai21  g058(.a(x30), .b(x27), .c(x28), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x29), .O(new_n104_));
  nand2  g060(.a(x28), .b(x27), .O(new_n105_));
  nor2   g061(.a(x30), .b(x29), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  oai21  g063(.a(new_n107_), .b(new_n105_), .c(new_n104_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n94_), .c(new_n62_), .d(new_n81_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n98_), .c(new_n61_), .O(z5));
  nand2  g066(.a(new_n46_), .b(x29), .O(new_n111_));
  oai22  g067(.a(new_n111_), .b(new_n105_), .c(new_n46_), .d(x28), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(new_n95_), .c(new_n81_), .O(new_n113_));
  nor3   g069(.a(new_n113_), .b(new_n98_), .c(new_n61_), .O(z6));
  nand3  g070(.a(new_n91_), .b(new_n88_), .c(new_n85_), .O(new_n115_));
  nand3  g071(.a(new_n62_), .b(x25), .c(x01), .O(new_n116_));
  nor4   g072(.a(new_n116_), .b(new_n47_), .c(x31), .d(x26), .O(new_n117_));
  oai21  g073(.a(new_n115_), .b(new_n92_), .c(new_n117_), .O(z7));
  ...
  oai21  g083(.a(new_n124_), .b(new_n127_), .c(new_n86_), .O(new_n128_));
  ...
  oai21  g089(.a(new_n133_), .b(new_n120_), .c(x31), .O(new_n134_));
  nor2   g090(.a(new_n134_), .b(new_n132_), .O(new_n135_));
  nand4  g091(.a(new_n135_), .b(new_n131_), .c(new_n128_), .d(new_n126_), .O(new_n136_));
  oai21  g092(.a(new_n136_), .b(new_n122_), .c(new_n59_), .O(new_n137_));
  nand3  g093(.a(x30), .b(x29), .c(x27), .O(new_n138_));
  oai21  g094(.a(x30), .b(x27), .c(new_n138_), .O(new_n139_));
  aoi21  g095(.a(new_n139_), .b(new_n45_), .c(new_n106_), .O(new_n140_));
  nand2  g096(.a(new_n140_), .b(new_n137_), .O(new_n141_));
  nand2  g097(.a(new_n141_), .b(x32), .O(new_n142_));
  inv1   g098(.a(x32), .O(new_n143_));
  nand2  g099(.a(x29), .b(x27), .O(new_n144_));
  nand3  g100(.a(new_n144_), .b(x30), .c(new_n45_), .O(new_n145_));
  nand2  g101(.a(new_n45_), .b(new_n82_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(new_n46_), .c(x29), .O(new_n147_));
  nand2  g103(.a(new_n147_), .b(new_n145_), .O(new_n148_));
  nand3  g104(.a(x19), .b(new_n89_), .c(x13), .O(new_n149_));
  nand3  g105(.a(new_n130_), .b(x18), .c(x14), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n149_), .c(new_n86_), .O(new_n151_));
  nand4  g107(.a(x19), .b(x18), .c(new_n86_), .d(x12), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  oai21  g109(.a(new_n153_), .b(new_n151_), .c(x16), .O(new_n154_));
  inv1   g110(.a(new_n120_), .O(new_n155_));
  nand3  g111(.a(new_n155_), .b(new_n123_), .c(x11), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n154_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x15), .O(new_n158_));
  inv1   g114(.a(x15), .O(new_n159_));
  nand3  g115(.a(x16), .b(new_n159_), .c(x10), .O(new_n160_));
  nor2   g116(.a(new_n160_), .b(new_n120_), .O(new_n161_));
  inv1   g117(.a(new_n161_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(new_n158_), .O(new_n163_));
  nand4  g119(.a(new_n163_), .b(new_n148_), .c(new_n143_), .d(x31), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(new_n142_), .O(new_n165_));
  ...
  aoi21  g126(.a(new_n156_), .b(new_n154_), .c(new_n159_), .O(new_n171_));
  inv1   g127(.a(x31), .O(new_n172_));
  nand2  g128(.a(new_n146_), .b(x29), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n172_), .c(new_n46_), .O(new_n174_));
  nand2  g130(.a(x31), .b(x30), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n144_), .c(new_n174_), .O(new_n176_));
  oai21  g132(.a(new_n161_), .b(new_n171_), .c(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n130_), .b(x14), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x18), .c(x17), .d(x16), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n159_), .O(new_n180_));
  nand2  g136(.a(new_n144_), .b(x31), .O(new_n181_));
  nor2   g137(.a(new_n89_), .b(new_n86_), .O(new_n182_));
  inv1   g138(.a(new_n182_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n133_), .c(new_n130_), .O(new_n184_));
  oai21  g140(.a(new_n183_), .b(new_n119_), .c(new_n159_), .O(new_n185_));
  aoi21  g141(.a(new_n182_), .b(x11), .c(x16), .O(new_n186_));
  oai21  g142(.a(new_n89_), .b(new_n127_), .c(new_n86_), .O(new_n187_));
  nand2  g143(.a(new_n89_), .b(new_n129_), .O(new_n188_));
  nand3  g144(.a(new_n46_), .b(x29), .c(x27), .O(new_n189_));
  nand2  g145(.a(new_n172_), .b(x30), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n188_), .d(new_n187_), .O(new_n191_));
  nor2   g147(.a(new_n191_), .b(new_n186_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n185_), .c(new_n184_), .d(new_n181_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n180_), .c(x33), .O(new_n194_));
  oai21  g150(.a(new_n177_), .b(x33), .c(new_n194_), .O(new_n195_));
  nand3  g151(.a(new_n195_), .b(new_n81_), .c(x00), .O(new_n196_));
  nand2  g152(.a(new_n196_), .b(new_n170_), .O(z9));
endmodule
