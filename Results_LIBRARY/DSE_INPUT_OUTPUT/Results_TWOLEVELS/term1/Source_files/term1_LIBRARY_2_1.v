...
module FAU ( 
  ...
  oai21  g044(.a(new_n88_), .b(new_n59_), .c(new_n48_), .O(z3));
  ...
  nand3  g055(.a(new_n99_), .b(new_n61_), .c(new_n80_), .O(new_n100_));
  inv1   g056(.a(new_n100_), .O(new_n101_));
  nand3  g057(.a(new_n101_), .b(x25), .c(x01), .O(new_n102_));
  nand2  g058(.a(new_n102_), .b(new_n48_), .O(z5));
  oai21  g059(.a(new_n95_), .b(x02), .c(x03), .O(new_n104_));
  nand2  g060(.a(new_n104_), .b(new_n81_), .O(new_n105_));
  oai21  g061(.a(new_n97_), .b(new_n95_), .c(new_n53_), .O(new_n106_));
  oai21  g062(.a(x28), .b(new_n81_), .c(x29), .O(new_n107_));
  ...
  nor2   g066(.a(new_n60_), .b(x30), .O(new_n111_));
  ...
  nor4   g071(.a(new_n85_), .b(new_n84_), .c(new_n83_), .d(new_n82_), .O(new_n116_));
  ...
  nor2   g080(.a(x33), .b(new_n122_), .O(new_n125_));
  ...
  nand3  g106(.a(new_n45_), .b(x32), .c(new_n119_), .O(new_n151_));
  ...
  nand2  g111(.a(new_n95_), .b(new_n81_), .O(new_n156_));
  ...
  oai21  g125(.a(new_n169_), .b(new_n142_), .c(x31), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n168_), .c(new_n167_), .O(new_n171_));
  nand4  g127(.a(new_n171_), .b(new_n166_), .c(new_n164_), .d(new_n161_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x32), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(new_n159_), .c(new_n153_), .O(new_n174_));
  nand3  g130(.a(new_n174_), .b(new_n80_), .c(x00), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n48_), .O(z8));
  nand4  g132(.a(new_n154_), .b(new_n45_), .c(x31), .d(x30), .O(new_n177_));
  nand3  g133(.a(new_n130_), .b(new_n122_), .c(new_n119_), .O(new_n178_));
  oai21  g134(.a(new_n177_), .b(new_n97_), .c(new_n178_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n149_), .O(new_n180_));
  nor2   g136(.a(new_n129_), .b(new_n119_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n172_), .c(x33), .O(new_n182_));
