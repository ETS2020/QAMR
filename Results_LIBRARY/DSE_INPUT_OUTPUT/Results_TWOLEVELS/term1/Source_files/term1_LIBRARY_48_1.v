...
module FAU ( 
  ...
  nor3   g059(.a(new_n103_), .b(new_n97_), .c(new_n60_), .O(z5));
  and2   g060(.a(x29), .b(x28), .O(new_n105_));
  nand2  g061(.a(new_n100_), .b(x28), .O(new_n106_));
  oai21  g062(.a(new_n105_), .b(new_n81_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(new_n90_), .c(new_n62_), .d(x27), .O(new_n108_));
  ...
  oai21  g097(.a(new_n141_), .b(new_n99_), .c(new_n81_), .O(new_n142_));
  ...
  nor2   g102(.a(new_n81_), .b(x29), .O(new_n147_));
