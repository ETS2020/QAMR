...
module FAU ( 
  ...
  aoi21  g049(.a(new_n93_), .b(x12), .c(x26), .O(z3));
  ...
  nand4  g054(.a(new_n98_), .b(x25), .c(x12), .d(x01), .O(new_n99_));
  ...
  nand4  g064(.a(new_n108_), .b(x25), .c(x12), .d(x01), .O(new_n109_));
  ...
  nand4  g073(.a(new_n117_), .b(x25), .c(x12), .d(x01), .O(new_n118_));
  ...
  oai21  g085(.a(new_n129_), .b(new_n127_), .c(new_n47_), .O(new_n130_));
  ...
  nor2   g098(.a(new_n142_), .b(x17), .O(new_n143_));
  ...
  nand3  g104(.a(new_n148_), .b(new_n145_), .c(x11), .O(new_n149_));
  ...
  nand4  g110(.a(new_n154_), .b(new_n138_), .c(new_n133_), .d(x31), .O(new_n155_));
  ...
  nor2   g114(.a(new_n145_), .b(new_n152_), .O(new_n159_));
  ...
  oai21  g118(.a(new_n162_), .b(new_n142_), .c(new_n152_), .O(new_n163_));
  inv1   g119(.a(x11), .O(new_n164_));
  oai21  g120(.a(new_n142_), .b(new_n164_), .c(new_n145_), .O(new_n165_));
  inv1   g121(.a(x13), .O(new_n166_));
  oai21  g122(.a(new_n87_), .b(new_n166_), .c(new_n84_), .O(new_n167_));
  nor2   g123(.a(x19), .b(x14), .O(new_n168_));
  aoi21  g124(.a(new_n159_), .b(new_n148_), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g129(.a(new_n173_), .b(new_n163_), .c(new_n161_), .d(new_n158_), .O(new_n174_));
  ...
  aoi21  g133(.a(new_n177_), .b(x12), .c(x26), .O(z8));
  ...
  nand4  g140(.a(new_n154_), .b(new_n179_), .c(new_n128_), .d(new_n113_), .O(new_n185_));
  ...
  aoi21  g144(.a(new_n87_), .b(x14), .c(new_n84_), .O(new_n189_));
  nand4  g145(.a(new_n189_), .b(x17), .c(x16), .d(x15), .O(new_n190_));
  nand2  g146(.a(x18), .b(x16), .O(new_n191_));
  oai21  g147(.a(new_n191_), .b(new_n152_), .c(new_n87_), .O(new_n192_));
  inv1   g148(.a(x10), .O(new_n193_));
  oai21  g149(.a(new_n191_), .b(new_n193_), .c(new_n152_), .O(new_n194_));
  oai21  g150(.a(new_n84_), .b(new_n164_), .c(new_n145_), .O(new_n195_));
  nand2  g151(.a(new_n84_), .b(new_n166_), .O(new_n196_));
  ...
  nand4  g155(.a(new_n199_), .b(new_n192_), .c(new_n190_), .d(new_n161_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(x33), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(new_n188_), .c(new_n183_), .O(new_n202_));
  nand2  g158(.a(new_n202_), .b(x00), .O(new_n203_));
  aoi21  g159(.a(new_n203_), .b(x12), .c(x26), .O(z9));
endmodule
