...
module FAU ( 
  ...
  xor2a  g051(.a(x29), .b(x28), .O(new_n96_));
  nand3  g052(.a(new_n96_), .b(new_n88_), .c(x27), .O(new_n97_));
  ...
  nand2  g057(.a(x30), .b(new_n101_), .O(new_n102_));
  inv1   g058(.a(x30), .O(new_n103_));
  nand2  g059(.a(new_n103_), .b(x29), .O(new_n104_));
  oai21  g060(.a(new_n104_), .b(new_n101_), .c(new_n102_), .O(new_n105_));
  ...
  nand4  g078(.a(new_n122_), .b(new_n120_), .c(new_n116_), .d(new_n114_), .O(z7));
  inv1   g079(.a(x32), .O(new_n124_));
  nand2  g080(.a(new_n107_), .b(new_n104_), .O(new_n125_));
  ...
  nand4  g099(.a(new_n143_), .b(new_n125_), .c(new_n124_), .d(x31), .O(new_n144_));
  nand2  g100(.a(x16), .b(x10), .O(new_n145_));
  inv1   g101(.a(new_n145_), .O(new_n146_));
  aoi21  g102(.a(new_n146_), .b(new_n137_), .c(x15), .O(new_n147_));
  ...
  oai21  g107(.a(new_n148_), .b(new_n151_), .c(new_n126_), .O(new_n152_));
  inv1   g108(.a(x13), .O(new_n153_));
  oai21  g109(.a(new_n129_), .b(new_n153_), .c(new_n127_), .O(new_n154_));
  nand2  g110(.a(x16), .b(x15), .O(new_n155_));
  oai22  g111(.a(new_n155_), .b(new_n136_), .c(x19), .d(x14), .O(new_n156_));
  nand2  g112(.a(new_n103_), .b(new_n45_), .O(new_n157_));
  nand3  g113(.a(new_n157_), .b(new_n115_), .c(x31), .O(new_n158_));
  ...
  nand2  g119(.a(new_n163_), .b(new_n47_), .O(z8));
  inv1   g120(.a(x33), .O(new_n165_));
  nand4  g121(.a(x31), .b(x30), .c(x29), .d(x27), .O(new_n166_));
  nand2  g122(.a(new_n111_), .b(new_n103_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(x29), .c(new_n166_), .O(new_n168_));
  nand3  g124(.a(new_n168_), .b(new_n143_), .c(new_n165_), .O(new_n169_));
  nand2  g125(.a(new_n129_), .b(x14), .O(new_n170_));
  nand4  g126(.a(new_n170_), .b(x18), .c(x17), .d(x16), .O(new_n171_));
  nor2   g127(.a(new_n171_), .b(new_n141_), .O(new_n172_));
  nand2  g128(.a(x18), .b(x17), .O(new_n173_));
  oai21  g129(.a(new_n173_), .b(new_n155_), .c(new_n129_), .O(new_n174_));
  oai21  g130(.a(new_n173_), .b(new_n145_), .c(new_n141_), .O(new_n175_));
  inv1   g131(.a(x11), .O(new_n176_));
  oai21  g132(.a(new_n173_), .b(new_n176_), .c(new_n135_), .O(new_n177_));
  nand2  g133(.a(x18), .b(x12), .O(new_n178_));
  aoi22  g134(.a(new_n178_), .b(new_n126_), .c(new_n127_), .d(new_n153_), .O(new_n179_));
  ...
  oai21  g137(.a(x31), .b(new_n103_), .c(new_n104_), .O(new_n182_));
  aoi22  g138(.a(new_n182_), .b(x27), .c(new_n167_), .d(new_n45_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x33), .O(new_n185_));
  nand2  g141(.a(new_n185_), .b(new_n169_), .O(new_n186_));
