...
module FAU ( 
  ...
  nand2  g056(.a(new_n100_), .b(new_n56_), .O(z5));
  ...
  nand2  g061(.a(x27), .b(x04), .O(new_n106_));
  nand3  g062(.a(new_n103_), .b(x29), .c(x28), .O(new_n107_));
  oai22  g063(.a(new_n107_), .b(new_n106_), .c(new_n105_), .d(new_n103_), .O(new_n108_));
  nand4  g064(.a(new_n108_), .b(new_n92_), .c(new_n60_), .d(new_n79_), .O(new_n109_));
  nor3   g065(.a(new_n109_), .b(new_n102_), .c(new_n58_), .O(z6));
  ...
  oai21  g068(.a(new_n112_), .b(new_n111_), .c(new_n56_), .O(new_n113_));
  inv1   g069(.a(x31), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(x29), .c(x28), .d(x27), .O(new_n115_));
  oai21  g071(.a(new_n105_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nor2   g072(.a(new_n114_), .b(x30), .O(new_n117_));
  aoi22  g073(.a(new_n117_), .b(x04), .c(new_n116_), .d(x30), .O(new_n118_));
  nand2  g074(.a(new_n118_), .b(new_n113_), .O(z7));
  nand2  g075(.a(new_n93_), .b(new_n80_), .O(new_n120_));
  ...
  nand4  g096(.a(new_n140_), .b(new_n122_), .c(x31), .d(x30), .O(new_n141_));
  nand3  g097(.a(x32), .b(new_n103_), .c(x04), .O(new_n142_));
  nand2  g098(.a(new_n142_), .b(new_n141_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n121_), .O(new_n144_));
  nand4  g100(.a(new_n140_), .b(new_n120_), .c(new_n122_), .d(x31), .O(new_n145_));
  nand2  g101(.a(new_n93_), .b(new_n80_), .O(new_n146_));
  nand3  g102(.a(new_n146_), .b(x32), .c(x30), .O(new_n147_));
  oai21  g103(.a(new_n145_), .b(x30), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x29), .O(new_n149_));
  and2   g105(.a(x16), .b(x10), .O(new_n150_));
  aoi21  g106(.a(new_n150_), .b(new_n134_), .c(x15), .O(new_n151_));
  nor2   g107(.a(new_n126_), .b(new_n124_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(x17), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n132_), .O(new_n154_));
  ...
  nor3   g115(.a(new_n133_), .b(new_n132_), .c(new_n138_), .O(new_n160_));
  ...
  nand3  g119(.a(new_n163_), .b(new_n149_), .c(new_n144_), .O(new_n164_));
  nand3  g120(.a(new_n164_), .b(new_n79_), .c(x00), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n56_), .O(z8));
  inv1   g122(.a(x33), .O(new_n167_));
  nand4  g123(.a(new_n140_), .b(new_n167_), .c(x31), .d(x30), .O(new_n168_));
  nand2  g124(.a(x33), .b(new_n114_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(new_n168_), .O(new_n170_));
  nand3  g126(.a(new_n170_), .b(new_n120_), .c(x29), .O(new_n171_));
  nand4  g127(.a(new_n140_), .b(new_n167_), .c(new_n114_), .d(new_n103_), .O(new_n172_));
  oai21  g128(.a(new_n167_), .b(new_n103_), .c(new_n172_), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n121_), .O(new_n174_));
  nor3   g130(.a(new_n160_), .b(new_n159_), .c(new_n117_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n158_), .c(new_n156_), .d(new_n154_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n151_), .c(x33), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n174_), .c(new_n171_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n79_), .c(x00), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n56_), .O(z9));
endmodule
