...
module FAU ( 
  ...
  nand4  g077(.a(new_n121_), .b(new_n109_), .c(new_n83_), .d(new_n117_), .O(new_n122_));
  ...
  nand3  g088(.a(new_n119_), .b(x30), .c(x29), .O(new_n133_));
  ...
  nand4  g100(.a(new_n144_), .b(new_n139_), .c(new_n138_), .d(new_n134_), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n45_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(new_n117_), .O(z7));
  nor2   g103(.a(x26), .b(new_n45_), .O(z9));
endmodule
