...
module FAU ( 
  ...
  aoi21  g080(.a(new_n124_), .b(new_n102_), .c(new_n79_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  oai21  g082(.a(new_n126_), .b(new_n120_), .c(new_n80_), .O(new_n127_));
  oai21  g083(.a(new_n80_), .b(x18), .c(new_n127_), .O(z7));
  ...
  nand2  g108(.a(new_n119_), .b(x27), .O(new_n153_));
  ...
  oai21  g116(.a(new_n142_), .b(new_n160_), .c(new_n85_), .O(new_n161_));
  ...
  aoi21  g123(.a(new_n119_), .b(x28), .c(new_n167_), .O(new_n168_));
  ...
  nand4  g137(.a(new_n151_), .b(new_n176_), .c(new_n118_), .d(new_n111_), .O(new_n182_));
