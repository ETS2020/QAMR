...
module FAU ( 
  ...
  oai21  g060(.a(new_n46_), .b(x27), .c(new_n104_), .O(new_n105_));
  nand3  g061(.a(new_n105_), .b(new_n96_), .c(new_n82_), .O(new_n106_));
  nor3   g062(.a(new_n106_), .b(new_n81_), .c(new_n61_), .O(z5));
  nand3  g063(.a(new_n96_), .b(new_n48_), .c(x30), .O(new_n108_));
  inv1   g064(.a(new_n108_), .O(new_n109_));
  nand4  g065(.a(new_n109_), .b(new_n82_), .c(x25), .d(x01), .O(new_n110_));
  inv1   g066(.a(new_n110_), .O(z6));
  nand4  g067(.a(new_n94_), .b(new_n91_), .c(new_n88_), .d(new_n85_), .O(new_n112_));
  nand2  g068(.a(new_n62_), .b(x01), .O(new_n113_));
  nor4   g069(.a(new_n113_), .b(x31), .c(x26), .d(new_n81_), .O(new_n114_));
  aoi21  g070(.a(new_n114_), .b(new_n112_), .c(new_n47_), .O(z7));
  ...
  oai21  g081(.a(new_n122_), .b(new_n125_), .c(new_n86_), .O(new_n126_));
  ...
  oai21  g086(.a(new_n130_), .b(new_n118_), .c(x31), .O(new_n131_));
  aoi21  g087(.a(new_n92_), .b(new_n129_), .c(new_n131_), .O(new_n132_));
  nand4  g088(.a(new_n132_), .b(new_n128_), .c(new_n126_), .d(new_n124_), .O(new_n133_));
  oai21  g089(.a(new_n133_), .b(new_n120_), .c(new_n48_), .O(new_n134_));
  inv1   g090(.a(x30), .O(new_n135_));
  nand3  g091(.a(x30), .b(x29), .c(x28), .O(new_n136_));
  oai21  g092(.a(x30), .b(x28), .c(new_n136_), .O(new_n137_));
  aoi22  g093(.a(new_n137_), .b(new_n45_), .c(new_n135_), .d(new_n46_), .O(new_n138_));
  nand2  g094(.a(new_n138_), .b(new_n134_), .O(new_n139_));
  nand2  g095(.a(new_n139_), .b(x32), .O(new_n140_));
  inv1   g096(.a(x32), .O(new_n141_));
  nand3  g097(.a(new_n135_), .b(x29), .c(x28), .O(new_n142_));
  oai21  g098(.a(new_n135_), .b(x28), .c(new_n142_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(new_n45_), .O(new_n144_));
  oai21  g100(.a(new_n135_), .b(x29), .c(new_n144_), .O(new_n145_));
  nand3  g101(.a(x19), .b(new_n89_), .c(x13), .O(new_n146_));
  nand3  g102(.a(new_n92_), .b(x18), .c(x14), .O(new_n147_));
  aoi21  g103(.a(new_n147_), .b(new_n146_), .c(new_n86_), .O(new_n148_));
  ...
  nand3  g108(.a(new_n152_), .b(new_n121_), .c(x11), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n151_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(x15), .O(new_n155_));
  nand4  g111(.a(new_n152_), .b(x16), .c(new_n116_), .d(x10), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n155_), .O(new_n157_));
  nand4  g113(.a(new_n157_), .b(new_n145_), .c(new_n141_), .d(x31), .O(new_n158_));
  nand2  g114(.a(new_n158_), .b(new_n140_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n82_), .c(x00), .O(new_n160_));
  inv1   g116(.a(new_n160_), .O(z8));
  inv1   g117(.a(x00), .O(new_n162_));
  nand2  g118(.a(x29), .b(x28), .O(new_n163_));
  inv1   g119(.a(new_n163_), .O(new_n164_));
  inv1   g120(.a(x31), .O(new_n165_));
  inv1   g121(.a(x33), .O(new_n166_));
  nand4  g122(.a(new_n157_), .b(new_n166_), .c(new_n165_), .d(new_n135_), .O(new_n167_));
  nand2  g123(.a(x33), .b(x31), .O(new_n168_));
  aoi21  g124(.a(new_n168_), .b(new_n167_), .c(new_n164_), .O(new_n169_));
  nand3  g125(.a(x28), .b(new_n92_), .c(x14), .O(new_n170_));
  nand4  g126(.a(new_n166_), .b(x31), .c(x30), .d(x29), .O(new_n171_));
  oai22  g127(.a(new_n171_), .b(new_n170_), .c(new_n166_), .d(new_n92_), .O(new_n172_));
  nand4  g128(.a(x28), .b(x19), .c(new_n89_), .d(x13), .O(new_n173_));
  nor2   g129(.a(new_n173_), .b(new_n171_), .O(new_n174_));
  aoi21  g130(.a(new_n172_), .b(x18), .c(new_n174_), .O(new_n175_));
  nand3  g131(.a(new_n166_), .b(x31), .c(x30), .O(new_n176_));
  inv1   g132(.a(new_n176_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n164_), .O(new_n178_));
  oai22  g134(.a(new_n178_), .b(new_n149_), .c(new_n175_), .d(new_n86_), .O(new_n179_));
  nor2   g135(.a(new_n178_), .b(new_n153_), .O(new_n180_));
  aoi21  g136(.a(new_n179_), .b(x16), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(x33), .b(new_n135_), .O(new_n182_));
  nor2   g138(.a(new_n86_), .b(new_n121_), .O(new_n183_));
  nor2   g139(.a(new_n176_), .b(new_n122_), .O(new_n184_));
  nand4  g140(.a(new_n184_), .b(new_n183_), .c(new_n116_), .d(x10), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n182_), .c(new_n46_), .O(new_n186_));
  nand2  g142(.a(new_n92_), .b(new_n129_), .O(new_n187_));
  nand2  g143(.a(new_n165_), .b(x30), .O(new_n188_));
  nand3  g144(.a(new_n188_), .b(new_n187_), .c(new_n128_), .O(new_n189_));
  inv1   g145(.a(new_n189_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n126_), .c(new_n124_), .d(new_n119_), .O(new_n191_));
  aoi22  g147(.a(new_n191_), .b(x33), .c(new_n186_), .d(x28), .O(new_n192_));
  oai21  g148(.a(new_n181_), .b(new_n116_), .c(new_n192_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n169_), .c(new_n82_), .O(new_n194_));
  oai21  g150(.a(new_n194_), .b(new_n162_), .c(new_n48_), .O(z9));
endmodule
