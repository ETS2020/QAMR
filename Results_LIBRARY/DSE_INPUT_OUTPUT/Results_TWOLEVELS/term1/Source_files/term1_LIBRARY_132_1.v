...
module FAU ( 
  ...
  nand2  g050(.a(new_n94_), .b(new_n48_), .O(z3));
  ...
  nand2  g054(.a(new_n92_), .b(new_n89_), .O(new_n99_));
  ...
  nand4  g060(.a(new_n104_), .b(new_n99_), .c(new_n61_), .d(x25), .O(new_n105_));
  oai21  g061(.a(new_n105_), .b(new_n59_), .c(new_n48_), .O(z5));
  ...
  nand4  g069(.a(new_n92_), .b(new_n87_), .c(new_n84_), .d(new_n113_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n112_), .c(new_n61_), .d(new_n45_), .O(new_n115_));
  nor3   g071(.a(new_n115_), .b(new_n107_), .c(new_n59_), .O(z6));
  inv1   g072(.a(new_n102_), .O(new_n117_));
  nand2  g073(.a(x30), .b(x29), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(x31), .O(new_n119_));
  nand4  g075(.a(new_n92_), .b(new_n87_), .c(new_n84_), .d(new_n113_), .O(new_n120_));
  ...
  nor2   g089(.a(x26), .b(new_n90_), .O(new_n134_));
  nand3  g090(.a(new_n134_), .b(new_n85_), .c(x13), .O(new_n135_));
  aoi21  g091(.a(new_n135_), .b(new_n133_), .c(new_n82_), .O(new_n136_));
  inv1   g092(.a(x12), .O(new_n137_));
  nand2  g093(.a(new_n134_), .b(x18), .O(new_n138_));
  nor3   g094(.a(new_n138_), .b(x17), .c(new_n137_), .O(new_n139_));
  ...
  nor2   g101(.a(new_n141_), .b(x15), .O(new_n146_));
  nand2  g102(.a(x18), .b(x17), .O(new_n147_));
  inv1   g103(.a(new_n147_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n146_), .c(new_n134_), .d(x10), .O(new_n149_));
  ...
  nand2  g108(.a(new_n110_), .b(new_n80_), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n152_), .c(x28), .O(new_n154_));
  inv1   g110(.a(x15), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n147_), .c(new_n155_), .O(new_n157_));
  inv1   g113(.a(x11), .O(new_n158_));
  oai21  g114(.a(new_n147_), .b(new_n158_), .c(new_n141_), .O(new_n159_));
  oai21  g115(.a(new_n85_), .b(new_n137_), .c(new_n82_), .O(new_n160_));
  nand2  g116(.a(x16), .b(x15), .O(new_n161_));
  nand3  g117(.a(x19), .b(x18), .c(x17), .O(new_n162_));
  oai22  g118(.a(new_n162_), .b(new_n161_), .c(x18), .d(x13), .O(new_n163_));
  aoi21  g119(.a(new_n110_), .b(new_n100_), .c(new_n122_), .O(new_n164_));
  oai21  g120(.a(new_n118_), .b(new_n101_), .c(new_n164_), .O(new_n165_));
  nor2   g121(.a(new_n165_), .b(new_n163_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n160_), .c(new_n159_), .d(new_n157_), .O(new_n167_));
  oai21  g123(.a(new_n167_), .b(new_n154_), .c(new_n45_), .O(new_n168_));
  inv1   g124(.a(x14), .O(new_n169_));
  nor4   g125(.a(new_n147_), .b(new_n141_), .c(new_n155_), .d(new_n169_), .O(new_n170_));
  oai21  g126(.a(new_n170_), .b(x19), .c(new_n168_), .O(new_n171_));
  ...
  aoi21  g133(.a(new_n177_), .b(new_n133_), .c(new_n82_), .O(new_n178_));
  ...
  nand3  g138(.a(new_n182_), .b(new_n141_), .c(x11), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(new_n181_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x15), .O(new_n185_));
  nand3  g141(.a(new_n182_), .b(new_n146_), .c(x10), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n176_), .c(x31), .d(x30), .O(new_n188_));
  nand2  g144(.a(x33), .b(new_n122_), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n188_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n129_), .c(x29), .O(new_n191_));
  inv1   g147(.a(new_n131_), .O(new_n192_));
  nand4  g148(.a(new_n187_), .b(new_n176_), .c(new_n122_), .d(new_n110_), .O(new_n193_));
  ...
  aoi21  g152(.a(new_n85_), .b(x13), .c(new_n90_), .O(new_n197_));
  nand4  g153(.a(new_n197_), .b(x17), .c(x16), .d(x15), .O(new_n198_));
  nand2  g154(.a(x19), .b(x17), .O(new_n199_));
  oai21  g155(.a(new_n199_), .b(new_n161_), .c(new_n85_), .O(new_n200_));
  oai21  g156(.a(new_n199_), .b(new_n156_), .c(new_n155_), .O(new_n201_));
  oai21  g157(.a(new_n199_), .b(new_n158_), .c(new_n141_), .O(new_n202_));
  oai21  g158(.a(new_n90_), .b(new_n137_), .c(new_n82_), .O(new_n203_));
  nand2  g159(.a(new_n90_), .b(new_n169_), .O(new_n204_));
  ...
  nand4  g163(.a(new_n207_), .b(new_n201_), .c(new_n200_), .d(new_n198_), .O(new_n208_));
  nand2  g164(.a(new_n208_), .b(x33), .O(new_n209_));
  nand3  g165(.a(new_n209_), .b(new_n196_), .c(new_n191_), .O(new_n210_));
  nand3  g166(.a(new_n210_), .b(new_n45_), .c(x00), .O(new_n211_));
