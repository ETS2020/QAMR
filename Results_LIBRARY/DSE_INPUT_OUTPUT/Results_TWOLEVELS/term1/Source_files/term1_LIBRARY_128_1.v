...
module FAU ( 
  ...
  aoi21  g033(.a(new_n77_), .b(new_n45_), .c(x09), .O(z2));
  ...
  nand2  g051(.a(new_n95_), .b(x09), .O(new_n96_));
  ...
  nor2   g078(.a(x31), .b(new_n45_), .O(new_n123_));
  ...
  aoi21  g083(.a(new_n125_), .b(x09), .c(new_n127_), .O(new_n128_));
  ...
  nand3  g088(.a(new_n132_), .b(new_n45_), .c(x29), .O(new_n133_));
  ...
  aoi21  g110(.a(x27), .b(x09), .c(x28), .O(new_n155_));
  nor3   g111(.a(new_n155_), .b(new_n45_), .c(new_n102_), .O(new_n156_));
  inv1   g112(.a(new_n134_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n45_), .O(new_n158_));
  nand2  g114(.a(x16), .b(x10), .O(new_n159_));
  oai21  g115(.a(new_n159_), .b(new_n146_), .c(new_n151_), .O(new_n160_));
  nor2   g116(.a(new_n139_), .b(new_n137_), .O(new_n161_));
  nand3  g117(.a(new_n161_), .b(x17), .c(x11), .O(new_n162_));
  and2   g118(.a(new_n162_), .b(new_n145_), .O(new_n163_));
  ...
  nand2  g124(.a(new_n139_), .b(new_n168_), .O(new_n169_));
  nor3   g125(.a(new_n146_), .b(new_n145_), .c(new_n151_), .O(new_n170_));
  nor2   g126(.a(new_n170_), .b(new_n126_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n169_), .c(new_n167_), .O(new_n172_));
  aoi21  g128(.a(new_n165_), .b(new_n136_), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n164_), .c(new_n160_), .d(new_n158_), .O(new_n174_));
  ...
  nand4  g135(.a(new_n179_), .b(x31), .c(x30), .d(x09), .O(new_n180_));
  ...
  nand4  g140(.a(new_n153_), .b(new_n184_), .c(new_n126_), .d(new_n45_), .O(new_n185_));
  nand2  g141(.a(x33), .b(x31), .O(new_n186_));
  nand2  g142(.a(new_n186_), .b(new_n185_), .O(new_n187_));
  nand2  g143(.a(new_n165_), .b(new_n136_), .O(new_n188_));
  aoi21  g144(.a(new_n139_), .b(new_n168_), .c(new_n170_), .O(new_n189_));
  nor2   g145(.a(new_n127_), .b(new_n123_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(new_n189_), .c(new_n167_), .d(new_n188_), .O(new_n191_));
  nor2   g147(.a(new_n191_), .b(new_n163_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n160_), .c(new_n184_), .O(new_n193_));
  aoi21  g149(.a(new_n187_), .b(new_n157_), .c(new_n193_), .O(new_n194_));
