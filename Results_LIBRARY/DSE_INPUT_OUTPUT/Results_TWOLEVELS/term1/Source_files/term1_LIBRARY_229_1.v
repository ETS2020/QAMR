...
module FAU ( 
  ...
  nor3   g104(.a(new_n148_), .b(new_n146_), .c(new_n125_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n145_), .c(new_n143_), .d(new_n140_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n137_), .c(new_n48_), .O(new_n151_));
  nand2  g107(.a(new_n96_), .b(new_n82_), .O(new_n152_));
  nand3  g108(.a(new_n152_), .b(x30), .c(x29), .O(new_n153_));
  nand3  g109(.a(new_n110_), .b(new_n96_), .c(new_n82_), .O(new_n154_));
  nand2  g110(.a(new_n154_), .b(new_n153_), .O(new_n155_));
  aoi22  g111(.a(new_n155_), .b(x24), .c(new_n110_), .d(new_n45_), .O(new_n156_));
  nand2  g112(.a(new_n156_), .b(new_n151_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x32), .O(new_n158_));
  inv1   g114(.a(x32), .O(new_n159_));
  nand3  g115(.a(new_n152_), .b(new_n110_), .c(x29), .O(new_n160_));
  nand3  g116(.a(x30), .b(new_n96_), .c(new_n82_), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n160_), .O(new_n162_));
  nand2  g118(.a(new_n162_), .b(x24), .O(new_n163_));
  oai21  g119(.a(new_n110_), .b(x29), .c(new_n163_), .O(new_n164_));
  nand3  g120(.a(x19), .b(new_n133_), .c(x13), .O(new_n165_));
  nand3  g121(.a(new_n114_), .b(x18), .c(x14), .O(new_n166_));
  aoi21  g122(.a(new_n166_), .b(new_n165_), .c(new_n141_), .O(new_n167_));
  nand4  g123(.a(x19), .b(x18), .c(new_n141_), .d(x12), .O(new_n168_));
  inv1   g124(.a(new_n168_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n167_), .c(x16), .O(new_n170_));
  nand3  g126(.a(new_n136_), .b(new_n138_), .c(x11), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(new_n170_), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x15), .O(new_n173_));
  inv1   g129(.a(x15), .O(new_n174_));
  nand3  g130(.a(x16), .b(new_n174_), .c(x10), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  nand2  g132(.a(new_n176_), .b(new_n136_), .O(new_n177_));
  nand2  g133(.a(new_n177_), .b(new_n173_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(new_n164_), .c(new_n159_), .d(x31), .O(new_n179_));
  ...
  nand4  g139(.a(x24), .b(x19), .c(new_n133_), .d(x13), .O(new_n184_));
  aoi21  g140(.a(new_n184_), .b(new_n166_), .c(new_n141_), .O(new_n185_));
  nand2  g141(.a(new_n141_), .b(x12), .O(new_n186_));
  nand3  g142(.a(x24), .b(x19), .c(x18), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n186_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n185_), .c(x16), .O(new_n189_));
  inv1   g145(.a(new_n187_), .O(new_n190_));
  nand4  g146(.a(new_n190_), .b(x17), .c(new_n138_), .d(x11), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(new_n189_), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(x15), .O(new_n193_));
  nor2   g149(.a(new_n115_), .b(new_n114_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n176_), .c(x18), .d(x17), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n193_), .O(new_n196_));
  nand4  g152(.a(new_n196_), .b(new_n183_), .c(x31), .d(x30), .O(new_n197_));
  nand2  g153(.a(x33), .b(new_n125_), .O(new_n198_));
  nand2  g154(.a(new_n198_), .b(new_n197_), .O(new_n199_));
  nand3  g155(.a(new_n199_), .b(new_n152_), .c(x29), .O(new_n200_));
  nand2  g156(.a(new_n152_), .b(x29), .O(new_n201_));
  nand4  g157(.a(new_n178_), .b(new_n183_), .c(new_n125_), .d(new_n110_), .O(new_n202_));
  ...
  nor3   g162(.a(new_n206_), .b(new_n148_), .c(new_n146_), .O(new_n207_));
  nand4  g163(.a(new_n207_), .b(new_n145_), .c(new_n143_), .d(new_n140_), .O(new_n208_));
  oai21  g164(.a(new_n208_), .b(new_n137_), .c(x33), .O(new_n209_));
  nand3  g165(.a(new_n209_), .b(new_n205_), .c(new_n200_), .O(new_n210_));
