...
module FAU ( 
  ...
  nand4  g051(.a(new_n95_), .b(new_n90_), .c(x25), .d(x01), .O(new_n96_));
  aoi21  g052(.a(new_n96_), .b(new_n45_), .c(x26), .O(z4));
  ...
  nand3  g060(.a(new_n90_), .b(new_n45_), .c(x29), .O(new_n105_));
  ...
  nand2  g071(.a(new_n98_), .b(new_n81_), .O(new_n116_));
  ...
  oai21  g098(.a(new_n139_), .b(new_n142_), .c(new_n117_), .O(new_n143_));
  ...
  nand3  g103(.a(new_n116_), .b(x31), .c(x29), .O(new_n148_));
  nor2   g104(.a(new_n148_), .b(new_n147_), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n145_), .c(new_n143_), .d(new_n141_), .O(new_n150_));
  oai21  g106(.a(new_n150_), .b(new_n138_), .c(x32), .O(new_n151_));
  oai21  g107(.a(new_n135_), .b(new_n100_), .c(new_n151_), .O(new_n152_));
  nand2  g108(.a(new_n152_), .b(x00), .O(new_n153_));
  aoi21  g109(.a(new_n153_), .b(new_n45_), .c(x26), .O(z8));
  inv1   g110(.a(x33), .O(new_n155_));
  nand2  g111(.a(new_n116_), .b(x29), .O(new_n156_));
  nand3  g112(.a(new_n156_), .b(new_n134_), .c(new_n155_), .O(new_n157_));
  aoi21  g113(.a(new_n120_), .b(x14), .c(new_n118_), .O(new_n158_));
  nand4  g114(.a(new_n158_), .b(x17), .c(x16), .d(x15), .O(new_n159_));
  nand2  g115(.a(x18), .b(x17), .O(new_n160_));
  oai21  g116(.a(new_n160_), .b(new_n146_), .c(new_n120_), .O(new_n161_));
  oai21  g117(.a(new_n160_), .b(new_n136_), .c(new_n132_), .O(new_n162_));
  inv1   g118(.a(x11), .O(new_n163_));
  oai21  g119(.a(new_n160_), .b(new_n163_), .c(new_n126_), .O(new_n164_));
  oai21  g120(.a(new_n118_), .b(new_n142_), .c(new_n117_), .O(new_n165_));
  aoi21  g121(.a(new_n118_), .b(new_n144_), .c(x31), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n165_), .c(new_n164_), .d(new_n162_), .O(new_n167_));
  inv1   g123(.a(new_n167_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n161_), .c(new_n159_), .d(new_n156_), .O(new_n169_));
  nand2  g125(.a(new_n169_), .b(x33), .O(new_n170_));
  oai21  g126(.a(new_n157_), .b(x31), .c(new_n170_), .O(new_n171_));
  nand2  g127(.a(new_n171_), .b(x00), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n45_), .c(x26), .O(z9));
endmodule
