...
module FAU ( 
  ...
  nand3  g049(.a(new_n93_), .b(new_n80_), .c(new_n46_), .O(new_n94_));
  ...
  aoi21  g055(.a(new_n99_), .b(x00), .c(x26), .O(z4));
  ...
  nand4  g061(.a(new_n105_), .b(new_n101_), .c(new_n61_), .d(new_n46_), .O(new_n106_));
  inv1   g062(.a(new_n106_), .O(new_n107_));
  nand4  g063(.a(new_n107_), .b(x25), .c(x01), .d(x00), .O(new_n108_));
  ...
  nand4  g070(.a(new_n114_), .b(new_n101_), .c(new_n61_), .d(new_n46_), .O(new_n115_));
  inv1   g071(.a(new_n115_), .O(new_n116_));
  nand4  g072(.a(new_n116_), .b(x25), .c(x01), .d(x00), .O(new_n117_));
  ...
  nand3  g107(.a(x32), .b(new_n112_), .c(x00), .O(new_n152_));
  oai21  g108(.a(new_n151_), .b(new_n112_), .c(new_n152_), .O(new_n153_));
  nand2  g109(.a(new_n153_), .b(new_n134_), .O(new_n154_));
  nand4  g110(.a(new_n150_), .b(new_n135_), .c(x31), .d(new_n112_), .O(new_n155_));
  nand2  g111(.a(x32), .b(x30), .O(new_n156_));
  aoi21  g112(.a(new_n156_), .b(new_n155_), .c(new_n132_), .O(new_n157_));
  and2   g113(.a(x16), .b(x10), .O(new_n158_));
  aoi21  g114(.a(new_n158_), .b(new_n144_), .c(x15), .O(new_n159_));
  nand2  g115(.a(x19), .b(x18), .O(new_n160_));
  nand2  g116(.a(x17), .b(x11), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n160_), .c(new_n142_), .O(new_n162_));
  inv1   g118(.a(x12), .O(new_n163_));
  oai21  g119(.a(new_n160_), .b(new_n163_), .c(new_n82_), .O(new_n164_));
  nand2  g120(.a(x19), .b(x13), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(new_n85_), .O(new_n166_));
  nor2   g122(.a(x19), .b(x14), .O(new_n167_));
  nor3   g123(.a(new_n143_), .b(new_n142_), .c(new_n148_), .O(new_n168_));
  ...
  aoi21  g128(.a(new_n157_), .b(x29), .c(new_n172_), .O(new_n173_));
  aoi21  g129(.a(new_n173_), .b(new_n154_), .c(x26), .O(z8));
  ...
  nand3  g133(.a(new_n177_), .b(new_n133_), .c(x29), .O(new_n178_));
  nand4  g134(.a(new_n150_), .b(new_n175_), .c(new_n125_), .d(new_n112_), .O(new_n179_));
  oai21  g135(.a(new_n175_), .b(new_n125_), .c(new_n179_), .O(new_n180_));
  xor2a  g136(.a(x31), .b(x30), .O(new_n181_));
  nor3   g137(.a(new_n181_), .b(new_n168_), .c(new_n167_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n166_), .c(new_n164_), .d(new_n162_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n159_), .c(x33), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x00), .O(new_n185_));
  aoi21  g141(.a(new_n180_), .b(new_n134_), .c(new_n185_), .O(new_n186_));
  aoi21  g142(.a(new_n186_), .b(new_n178_), .c(x26), .O(z9));
endmodule
