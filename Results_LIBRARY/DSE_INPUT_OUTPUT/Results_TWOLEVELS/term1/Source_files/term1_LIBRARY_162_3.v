...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n101_), .c(new_n62_), .d(new_n46_), .O(new_n107_));
  ...
  nand4  g071(.a(new_n115_), .b(new_n101_), .c(new_n62_), .d(new_n46_), .O(new_n116_));
  nor3   g072(.a(new_n116_), .b(new_n97_), .c(new_n60_), .O(z6));
  inv1   g073(.a(x31), .O(new_n118_));
  nor2   g074(.a(new_n113_), .b(new_n102_), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(new_n104_), .c(new_n118_), .O(new_n120_));
  inv1   g076(.a(new_n82_), .O(new_n121_));
  nand4  g077(.a(new_n91_), .b(new_n88_), .c(new_n85_), .d(new_n121_), .O(new_n122_));
  nor2   g078(.a(new_n61_), .b(new_n60_), .O(new_n123_));
  nand3  g079(.a(new_n118_), .b(x30), .c(x29), .O(new_n124_));
  inv1   g080(.a(new_n124_), .O(new_n125_));
  aoi21  g081(.a(new_n125_), .b(new_n104_), .c(new_n97_), .O(new_n126_));
  nand3  g082(.a(new_n126_), .b(new_n123_), .c(new_n122_), .O(new_n127_));
  oai21  g083(.a(new_n127_), .b(new_n120_), .c(new_n46_), .O(new_n128_));
  oai21  g084(.a(new_n46_), .b(x00), .c(new_n128_), .O(z7));
  inv1   g085(.a(x32), .O(new_n130_));
  nor2   g086(.a(x28), .b(x27), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  nand3  g088(.a(new_n132_), .b(new_n113_), .c(x29), .O(new_n133_));
  nor2   g089(.a(new_n131_), .b(new_n102_), .O(new_n134_));
  oai21  g090(.a(new_n134_), .b(new_n113_), .c(new_n133_), .O(new_n135_));
  ...
  nand2  g109(.a(new_n119_), .b(x27), .O(new_n154_));
  oai21  g110(.a(x30), .b(x27), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(new_n155_), .b(new_n103_), .O(new_n156_));
  ...
  oai21  g117(.a(new_n143_), .b(new_n161_), .c(new_n83_), .O(new_n162_));
  inv1   g118(.a(x13), .O(new_n163_));
  oai21  g119(.a(new_n89_), .b(new_n163_), .c(new_n86_), .O(new_n164_));
  ...
  aoi21  g124(.a(new_n119_), .b(x28), .c(new_n168_), .O(new_n169_));
  ...
  nand4  g138(.a(new_n152_), .b(new_n177_), .c(new_n118_), .d(new_n113_), .O(new_n183_));
  ...
  oai21  g146(.a(new_n190_), .b(new_n189_), .c(new_n89_), .O(new_n191_));
  ...
  oai21  g150(.a(new_n86_), .b(new_n161_), .c(new_n83_), .O(new_n195_));
  nand2  g151(.a(new_n86_), .b(new_n163_), .O(new_n196_));
  ...
  nand3  g158(.a(new_n202_), .b(new_n46_), .c(x00), .O(new_n203_));
