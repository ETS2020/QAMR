...
module FAU ( 
  ...
  aoi21  g051(.a(new_n95_), .b(new_n80_), .c(x27), .O(z3));
  ...
  nand4  g061(.a(new_n105_), .b(new_n100_), .c(new_n61_), .d(new_n81_), .O(new_n106_));
  ...
  nand4  g067(.a(new_n80_), .b(x29), .c(x28), .d(x27), .O(new_n112_));
  nand2  g068(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand4  g069(.a(new_n113_), .b(new_n100_), .c(new_n61_), .d(new_n81_), .O(new_n114_));
  ...
  nand2  g120(.a(new_n80_), .b(new_n103_), .O(new_n165_));
  nand3  g121(.a(new_n165_), .b(new_n122_), .c(x31), .O(new_n166_));
  ...
  oai21  g140(.a(x31), .b(new_n103_), .c(new_n135_), .O(new_n185_));
  aoi21  g141(.a(new_n110_), .b(new_n118_), .c(x30), .O(new_n186_));
  ...
  nand2  g147(.a(new_n133_), .b(x29), .O(new_n192_));
  nand3  g148(.a(new_n192_), .b(new_n118_), .c(new_n80_), .O(new_n193_));
