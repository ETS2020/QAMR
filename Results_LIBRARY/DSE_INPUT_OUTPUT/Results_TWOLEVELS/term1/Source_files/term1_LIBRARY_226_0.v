...
module FAU ( 
  ...
  oai21  g066(.a(new_n110_), .b(new_n98_), .c(new_n108_), .O(new_n111_));
  ...
  nand2  g074(.a(x31), .b(new_n109_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n107_), .b(x31), .c(x30), .O(new_n124_));
  nand3  g080(.a(new_n124_), .b(new_n123_), .c(new_n118_), .O(z7));
  nor3   g081(.a(new_n109_), .b(new_n100_), .c(x28), .O(new_n126_));
  ...
  oai22  g098(.a(new_n142_), .b(new_n131_), .c(x19), .d(x14), .O(new_n143_));
  nand3  g099(.a(x30), .b(x29), .c(x28), .O(new_n144_));
  ...
  nand2  g107(.a(new_n98_), .b(new_n81_), .O(new_n152_));
  nand2  g108(.a(x30), .b(new_n100_), .O(new_n153_));
  nand3  g109(.a(new_n153_), .b(new_n152_), .c(new_n110_), .O(new_n154_));
  ...
  nand2  g127(.a(new_n80_), .b(x00), .O(new_n172_));
  ...
  nand3  g134(.a(new_n120_), .b(new_n109_), .c(new_n100_), .O(new_n179_));
  ...
  nand2  g139(.a(new_n120_), .b(x29), .O(new_n184_));
  nand3  g140(.a(new_n184_), .b(new_n153_), .c(new_n119_), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n143_), .O(new_n186_));
