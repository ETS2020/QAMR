...
module FAU ( 
  ...
  aoi21  g062(.a(x30), .b(new_n98_), .c(new_n106_), .O(new_n107_));
  nand4  g063(.a(x30), .b(new_n105_), .c(x28), .d(x27), .O(new_n108_));
  ...
  nand4  g068(.a(new_n112_), .b(new_n104_), .c(new_n62_), .d(x30), .O(new_n113_));
  ...
  oai21  g077(.a(new_n121_), .b(new_n106_), .c(x31), .O(new_n122_));
  ...
  nand2  g083(.a(new_n81_), .b(x00), .O(new_n128_));
  nand3  g084(.a(x32), .b(x29), .c(new_n98_), .O(new_n129_));
  ...
  nand3  g090(.a(new_n45_), .b(x29), .c(x28), .O(new_n135_));
  ...
  nand2  g108(.a(new_n121_), .b(new_n45_), .O(new_n153_));
  ...
  nand2  g118(.a(new_n90_), .b(new_n162_), .O(new_n163_));
  nand3  g119(.a(new_n145_), .b(x16), .c(x15), .O(new_n164_));
  nor2   g120(.a(new_n45_), .b(new_n105_), .O(new_n165_));
  aoi21  g121(.a(new_n165_), .b(x28), .c(new_n117_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n164_), .c(new_n163_), .d(new_n161_), .O(new_n167_));
  ...
  nor2   g131(.a(new_n175_), .b(new_n149_), .O(new_n176_));
  ...
  oai21  g135(.a(new_n178_), .b(new_n154_), .c(new_n149_), .O(new_n180_));
  inv1   g136(.a(x11), .O(new_n181_));
  oai21  g137(.a(new_n178_), .b(new_n181_), .c(new_n143_), .O(new_n182_));
  nand2  g138(.a(x18), .b(x12), .O(new_n183_));
  aoi22  g139(.a(new_n183_), .b(new_n84_), .c(new_n87_), .d(new_n160_), .O(new_n184_));
  ...
  oai21  g143(.a(new_n45_), .b(new_n98_), .c(x31), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(new_n118_), .O(new_n189_));
  aoi21  g145(.a(new_n189_), .b(new_n106_), .c(new_n187_), .O(new_n190_));
  nand2  g146(.a(new_n190_), .b(new_n186_), .O(new_n191_));
  nand2  g147(.a(new_n191_), .b(x33), .O(new_n192_));
  aoi21  g148(.a(new_n146_), .b(new_n142_), .c(new_n149_), .O(new_n193_));
  inv1   g149(.a(new_n150_), .O(new_n194_));
  nand4  g150(.a(new_n121_), .b(new_n117_), .c(new_n45_), .d(new_n106_), .O(new_n195_));
  inv1   g151(.a(new_n195_), .O(new_n196_));
  nor4   g152(.a(new_n133_), .b(new_n117_), .c(new_n45_), .d(new_n105_), .O(new_n197_));
