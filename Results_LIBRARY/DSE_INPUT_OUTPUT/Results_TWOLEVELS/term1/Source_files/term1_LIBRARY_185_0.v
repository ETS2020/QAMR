...
module FAU ( 
  ...
  nand3  g048(.a(x30), .b(x28), .c(new_n92_), .O(new_n93_));
  oai21  g049(.a(x28), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand3  g050(.a(new_n94_), .b(new_n88_), .c(new_n79_), .O(new_n95_));
  nor3   g051(.a(new_n95_), .b(new_n91_), .c(new_n58_), .O(z4));
  inv1   g052(.a(x28), .O(new_n97_));
  oai21  g053(.a(new_n97_), .b(new_n92_), .c(x29), .O(new_n98_));
  inv1   g054(.a(x29), .O(new_n99_));
  nand3  g055(.a(new_n99_), .b(x28), .c(x27), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n98_), .O(new_n101_));
  nand4  g057(.a(new_n101_), .b(new_n87_), .c(new_n60_), .d(new_n79_), .O(new_n102_));
  ...
  nand3  g065(.a(new_n109_), .b(new_n107_), .c(x27), .O(new_n110_));
  nand4  g066(.a(new_n110_), .b(new_n87_), .c(new_n60_), .d(new_n79_), .O(new_n111_));
  inv1   g067(.a(new_n111_), .O(new_n112_));
  nand3  g068(.a(new_n112_), .b(x25), .c(x01), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n56_), .O(z6));
  ...
  oai21  g076(.a(new_n118_), .b(x30), .c(new_n120_), .O(new_n121_));
  aoi21  g077(.a(new_n119_), .b(x27), .c(new_n118_), .O(new_n122_));
  aoi22  g078(.a(new_n122_), .b(x30), .c(new_n121_), .d(x27), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(new_n117_), .O(z7));
  nor3   g080(.a(new_n108_), .b(new_n99_), .c(x28), .O(new_n125_));
  ...
  nor2   g100(.a(new_n108_), .b(new_n99_), .O(new_n145_));
  aoi21  g101(.a(new_n145_), .b(x28), .c(new_n118_), .O(new_n146_));
  nand4  g102(.a(new_n146_), .b(new_n144_), .c(new_n142_), .d(new_n140_), .O(new_n147_));
  nor2   g103(.a(new_n147_), .b(new_n138_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n137_), .c(new_n131_), .d(new_n127_), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(x32), .O(new_n150_));
  inv1   g106(.a(x32), .O(new_n151_));
  nand2  g107(.a(new_n108_), .b(x29), .O(new_n152_));
  nand2  g108(.a(new_n97_), .b(new_n92_), .O(new_n153_));
  nand2  g109(.a(x30), .b(new_n99_), .O(new_n154_));
  ...
  nand3  g113(.a(new_n134_), .b(x18), .c(x14), .O(new_n158_));
  ...
  nand3  g118(.a(new_n143_), .b(new_n132_), .c(x11), .O(new_n163_));
  nand2  g119(.a(new_n163_), .b(new_n162_), .O(new_n164_));
  nand2  g120(.a(new_n164_), .b(x15), .O(new_n165_));
  nand4  g121(.a(new_n143_), .b(x16), .c(new_n128_), .d(x10), .O(new_n166_));
  ...
  nor2   g129(.a(new_n173_), .b(new_n128_), .O(new_n174_));
  nand2  g130(.a(x16), .b(x15), .O(new_n175_));
  nand2  g131(.a(x18), .b(x17), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n175_), .c(new_n134_), .O(new_n177_));
  oai21  g133(.a(new_n176_), .b(new_n129_), .c(new_n128_), .O(new_n178_));
  inv1   g134(.a(x11), .O(new_n179_));
  oai21  g135(.a(new_n176_), .b(new_n179_), .c(new_n132_), .O(new_n180_));
  nand2  g136(.a(x18), .b(x12), .O(new_n181_));
  aoi22  g137(.a(new_n181_), .b(new_n156_), .c(new_n133_), .d(new_n139_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n180_), .c(new_n178_), .d(new_n177_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n174_), .c(new_n56_), .O(new_n184_));
  aoi21  g140(.a(new_n118_), .b(new_n99_), .c(x30), .O(new_n185_));
  nand3  g141(.a(new_n153_), .b(x31), .c(x29), .O(new_n186_));
  aoi22  g142(.a(new_n186_), .b(x30), .c(new_n185_), .d(x27), .O(new_n187_));
  nand2  g143(.a(new_n187_), .b(new_n184_), .O(new_n188_));
  nand2  g144(.a(new_n188_), .b(x33), .O(new_n189_));
  aoi21  g145(.a(new_n163_), .b(new_n162_), .c(new_n128_), .O(new_n190_));
  ...
  nand3  g151(.a(new_n119_), .b(x31), .c(x30), .O(new_n196_));
