...
module FAU ( 
  ...
  oai21  g070(.a(new_n114_), .b(new_n97_), .c(x29), .O(new_n115_));
  inv1   g071(.a(x29), .O(new_n116_));
  nand3  g072(.a(new_n116_), .b(x28), .c(x27), .O(new_n117_));
  aoi21  g073(.a(new_n117_), .b(new_n115_), .c(new_n106_), .O(new_n118_));
  nand4  g074(.a(new_n118_), .b(new_n113_), .c(x25), .d(x01), .O(new_n119_));
  aoi21  g075(.a(new_n119_), .b(x00), .c(x26), .O(z5));
  ...
  nor2   g080(.a(new_n114_), .b(new_n97_), .O(new_n125_));
  nand3  g081(.a(new_n125_), .b(new_n124_), .c(x29), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n123_), .O(new_n127_));
  nand4  g083(.a(new_n127_), .b(new_n105_), .c(new_n113_), .d(new_n121_), .O(new_n128_));
  inv1   g084(.a(new_n128_), .O(new_n129_));
  nand4  g085(.a(new_n129_), .b(x25), .c(x01), .d(x00), .O(new_n130_));
  inv1   g086(.a(new_n130_), .O(z6));
  nand3  g087(.a(new_n125_), .b(x30), .c(x29), .O(new_n132_));
  ...
  aoi21  g098(.a(new_n142_), .b(new_n125_), .c(new_n139_), .O(new_n143_));
  nand4  g099(.a(new_n143_), .b(new_n138_), .c(new_n137_), .d(new_n133_), .O(new_n144_));
  nand2  g100(.a(new_n144_), .b(x00), .O(new_n145_));
  nand2  g101(.a(new_n145_), .b(new_n121_), .O(z7));
  nand2  g102(.a(new_n114_), .b(new_n97_), .O(new_n147_));
  ...
  nand4  g122(.a(new_n166_), .b(new_n148_), .c(x31), .d(new_n124_), .O(new_n167_));
  ...
  nand2  g126(.a(new_n147_), .b(x29), .O(new_n171_));
  nand4  g127(.a(new_n166_), .b(new_n148_), .c(x31), .d(x30), .O(new_n172_));
  nand2  g128(.a(x32), .b(new_n124_), .O(new_n173_));
  ...
  aoi21  g132(.a(new_n176_), .b(new_n160_), .c(x15), .O(new_n177_));
  nor2   g133(.a(new_n152_), .b(new_n150_), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(x17), .c(x11), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n158_), .O(new_n180_));
  nand2  g136(.a(new_n178_), .b(x12), .O(new_n181_));
  ...
  nor3   g141(.a(new_n159_), .b(new_n158_), .c(new_n164_), .O(new_n186_));
  nor3   g142(.a(new_n186_), .b(new_n185_), .c(new_n140_), .O(new_n187_));
  nand4  g143(.a(new_n187_), .b(new_n184_), .c(new_n182_), .d(new_n180_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n177_), .c(x32), .O(new_n189_));
  nand3  g145(.a(new_n189_), .b(new_n175_), .c(new_n170_), .O(new_n190_));
  nand3  g146(.a(new_n190_), .b(new_n121_), .c(x00), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(z8));
  inv1   g148(.a(x33), .O(new_n193_));
  nand4  g149(.a(new_n166_), .b(new_n193_), .c(x31), .d(x30), .O(new_n194_));
  nand2  g150(.a(x33), .b(new_n140_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(new_n194_), .O(new_n196_));
  nand3  g152(.a(new_n196_), .b(new_n147_), .c(x29), .O(new_n197_));
  nand4  g153(.a(new_n166_), .b(new_n193_), .c(new_n140_), .d(new_n124_), .O(new_n198_));
  nand2  g154(.a(x33), .b(x31), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand2  g156(.a(new_n200_), .b(new_n171_), .O(new_n201_));
  xor2a  g157(.a(x31), .b(x30), .O(new_n202_));
  nor3   g158(.a(new_n202_), .b(new_n186_), .c(new_n185_), .O(new_n203_));
  nand4  g159(.a(new_n203_), .b(new_n184_), .c(new_n182_), .d(new_n180_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n177_), .c(x33), .O(new_n205_));
  nand3  g161(.a(new_n205_), .b(new_n201_), .c(new_n197_), .O(new_n206_));
  nand3  g162(.a(new_n206_), .b(new_n121_), .c(x00), .O(new_n207_));
