...
module FAU ( 
  ...
  nand2  g038(.a(new_n82_), .b(x29), .O(new_n83_));
  ...
  nand3  g052(.a(new_n47_), .b(x28), .c(new_n81_), .O(new_n97_));
  ...
  nor2   g056(.a(x29), .b(new_n95_), .O(new_n101_));
  nor3   g057(.a(new_n82_), .b(new_n45_), .c(x28), .O(new_n102_));
  oai21  g058(.a(new_n102_), .b(new_n101_), .c(x27), .O(new_n103_));
  nand3  g059(.a(x31), .b(x29), .c(new_n81_), .O(new_n104_));
  aoi21  g060(.a(new_n104_), .b(new_n103_), .c(new_n88_), .O(new_n105_));
  ...
  nor2   g072(.a(x30), .b(new_n95_), .O(new_n117_));
  nor2   g073(.a(new_n82_), .b(x28), .O(new_n118_));
  oai21  g074(.a(new_n118_), .b(new_n117_), .c(x27), .O(new_n119_));
  oai21  g075(.a(new_n82_), .b(x27), .c(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n89_), .c(new_n61_), .d(new_n80_), .O(new_n121_));
  nor2   g077(.a(new_n121_), .b(new_n94_), .O(new_n122_));
  aoi21  g078(.a(new_n122_), .b(x01), .c(new_n82_), .O(new_n123_));
  nor4   g079(.a(new_n87_), .b(new_n86_), .c(new_n85_), .d(new_n84_), .O(new_n124_));
  ...
  oai21  g083(.a(new_n123_), .b(new_n45_), .c(new_n127_), .O(z7));
  inv1   g084(.a(x00), .O(new_n129_));
  nand2  g085(.a(new_n95_), .b(new_n81_), .O(new_n130_));
  ...
  oai21  g104(.a(new_n148_), .b(new_n146_), .c(new_n131_), .O(new_n149_));
  ...
  oai21  g109(.a(new_n148_), .b(new_n146_), .c(new_n153_), .O(new_n154_));
  nor2   g110(.a(new_n154_), .b(x32), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  oai21  g112(.a(new_n156_), .b(new_n143_), .c(new_n132_), .O(new_n157_));
  nand4  g113(.a(x19), .b(x18), .c(x17), .d(x11), .O(new_n158_));
  nand3  g114(.a(x19), .b(x18), .c(x12), .O(new_n159_));
  ...
  nand2  g119(.a(new_n136_), .b(new_n163_), .O(new_n164_));
  nor2   g120(.a(new_n142_), .b(new_n132_), .O(new_n165_));
  nor3   g121(.a(x30), .b(x28), .c(x27), .O(new_n166_));
  aoi21  g122(.a(new_n165_), .b(new_n144_), .c(new_n166_), .O(new_n167_));
  nand4  g123(.a(new_n167_), .b(new_n164_), .c(new_n162_), .d(new_n160_), .O(new_n168_));
  aoi21  g124(.a(new_n158_), .b(new_n142_), .c(new_n168_), .O(new_n169_));
  aoi21  g125(.a(new_n169_), .b(new_n157_), .c(new_n131_), .O(new_n170_));
  aoi21  g126(.a(new_n155_), .b(x30), .c(new_n170_), .O(new_n171_));
  aoi21  g127(.a(new_n171_), .b(new_n152_), .c(new_n82_), .O(new_n172_));
  nand2  g128(.a(x31), .b(x30), .O(new_n173_));
  nand3  g129(.a(new_n173_), .b(x32), .c(new_n45_), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(new_n175_));
  oai21  g131(.a(new_n175_), .b(new_n172_), .c(new_n80_), .O(new_n176_));
  nor2   g132(.a(new_n176_), .b(new_n129_), .O(z8));
  aoi21  g133(.a(new_n136_), .b(x14), .c(new_n134_), .O(new_n178_));
  nand4  g134(.a(new_n178_), .b(x17), .c(x16), .d(x15), .O(new_n179_));
  nand2  g135(.a(new_n130_), .b(x30), .O(new_n180_));
  ...
  nand2  g140(.a(new_n184_), .b(new_n136_), .O(new_n185_));
  nand3  g141(.a(new_n183_), .b(x16), .c(x10), .O(new_n186_));
  inv1   g142(.a(x11), .O(new_n187_));
  oai21  g143(.a(new_n182_), .b(new_n187_), .c(new_n142_), .O(new_n188_));
  nand2  g144(.a(x18), .b(x12), .O(new_n189_));
  nand2  g145(.a(new_n189_), .b(new_n133_), .O(new_n190_));
  nand2  g146(.a(new_n134_), .b(new_n161_), .O(new_n191_));
  nand2  g147(.a(x30), .b(new_n45_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n191_), .c(new_n190_), .d(new_n188_), .O(new_n193_));
  aoi21  g149(.a(new_n186_), .b(new_n132_), .c(new_n193_), .O(new_n194_));
  nand4  g150(.a(new_n194_), .b(new_n185_), .c(new_n181_), .d(new_n179_), .O(new_n195_));
  nand2  g151(.a(new_n195_), .b(x33), .O(new_n196_));
  oai22  g152(.a(new_n180_), .b(new_n45_), .c(x31), .d(x30), .O(new_n197_));
  oai21  g153(.a(new_n148_), .b(new_n146_), .c(new_n197_), .O(new_n198_));
  oai21  g154(.a(new_n198_), .b(x33), .c(new_n196_), .O(new_n199_));
