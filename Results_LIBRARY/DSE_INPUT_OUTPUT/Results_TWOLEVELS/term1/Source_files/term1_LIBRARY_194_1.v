...
module FAU ( 
  ...
  nand2  g077(.a(new_n81_), .b(x00), .O(new_n122_));
  nand3  g078(.a(x32), .b(new_n45_), .c(new_n97_), .O(new_n123_));
  ...
  nor2   g085(.a(new_n45_), .b(x29), .O(new_n130_));
  ...
  nand4  g106(.a(new_n150_), .b(new_n132_), .c(new_n126_), .d(x31), .O(new_n151_));
  ...
  oai21  g114(.a(new_n155_), .b(new_n158_), .c(new_n133_), .O(new_n159_));
  nand2  g115(.a(x19), .b(x13), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n134_), .O(new_n161_));
  nor2   g117(.a(x19), .b(x14), .O(new_n162_));
  nor2   g118(.a(new_n142_), .b(new_n148_), .O(new_n163_));
  aoi21  g119(.a(new_n163_), .b(new_n144_), .c(new_n162_), .O(new_n164_));
  nand2  g120(.a(new_n45_), .b(new_n99_), .O(new_n165_));
  nand2  g121(.a(new_n165_), .b(x31), .O(new_n166_));
  aoi21  g122(.a(x30), .b(x29), .c(new_n166_), .O(new_n167_));
  and2   g123(.a(new_n167_), .b(new_n164_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n161_), .c(new_n159_), .d(new_n157_), .O(new_n169_));
  oai21  g125(.a(new_n169_), .b(new_n154_), .c(x32), .O(new_n170_));
  nand2  g126(.a(new_n170_), .b(new_n151_), .O(new_n171_));
  nand3  g127(.a(new_n171_), .b(new_n81_), .c(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(new_n125_), .O(z8));
  inv1   g129(.a(x33), .O(new_n174_));
  aoi21  g130(.a(new_n45_), .b(new_n99_), .c(new_n127_), .O(new_n175_));
  nand3  g131(.a(x31), .b(x30), .c(x29), .O(new_n176_));
  oai21  g132(.a(new_n175_), .b(x31), .c(new_n176_), .O(new_n177_));
  nand3  g133(.a(new_n177_), .b(new_n150_), .c(new_n174_), .O(new_n178_));
  nand3  g134(.a(new_n128_), .b(new_n116_), .c(x29), .O(new_n179_));
  nor2   g135(.a(new_n130_), .b(new_n119_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n164_), .c(new_n161_), .d(new_n159_), .O(new_n181_));
  inv1   g137(.a(new_n181_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n179_), .c(new_n157_), .d(new_n153_), .O(new_n183_));
  nand2  g139(.a(new_n183_), .b(x33), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n178_), .O(new_n185_));
