...
module FAU ( 
  ...
  and2   g068(.a(new_n112_), .b(new_n62_), .O(new_n113_));
  nand3  g069(.a(new_n113_), .b(new_n45_), .c(new_n99_), .O(new_n114_));
  inv1   g070(.a(new_n114_), .O(new_n115_));
  nand4  g071(.a(new_n115_), .b(new_n98_), .c(x25), .d(x01), .O(new_n116_));
  inv1   g072(.a(new_n116_), .O(z3));
  xor2a  g073(.a(x28), .b(x27), .O(new_n118_));
  nand3  g074(.a(new_n118_), .b(new_n113_), .c(new_n45_), .O(new_n119_));
  inv1   g075(.a(new_n119_), .O(new_n120_));
  nand4  g076(.a(new_n120_), .b(new_n98_), .c(x25), .d(x01), .O(new_n121_));
  inv1   g077(.a(new_n121_), .O(z4));
  nand3  g078(.a(new_n113_), .b(new_n45_), .c(x28), .O(new_n123_));
  inv1   g079(.a(new_n123_), .O(new_n124_));
  nand4  g080(.a(new_n124_), .b(x27), .c(new_n98_), .d(x25), .O(new_n125_));
  nor2   g081(.a(new_n125_), .b(new_n61_), .O(z5));
  nand3  g082(.a(new_n113_), .b(x30), .c(new_n45_), .O(new_n127_));
  inv1   g083(.a(new_n127_), .O(new_n128_));
  nand4  g084(.a(new_n128_), .b(new_n98_), .c(x25), .d(x01), .O(new_n129_));
  inv1   g085(.a(new_n129_), .O(z6));
  nand3  g086(.a(new_n108_), .b(new_n105_), .c(new_n102_), .O(new_n131_));
  inv1   g087(.a(new_n131_), .O(new_n132_));
  inv1   g088(.a(x31), .O(new_n133_));
  nand4  g089(.a(new_n62_), .b(new_n133_), .c(x25), .d(x01), .O(new_n134_));
  aoi21  g090(.a(new_n132_), .b(new_n111_), .c(new_n134_), .O(new_n135_));
  oai21  g091(.a(new_n135_), .b(x29), .c(new_n98_), .O(z7));
  inv1   g092(.a(x15), .O(new_n137_));
  nand2  g093(.a(x32), .b(x19), .O(new_n138_));
  nand2  g094(.a(new_n109_), .b(x14), .O(new_n139_));
  ...
  nand3  g098(.a(x19), .b(new_n106_), .c(x13), .O(new_n143_));
  nor2   g099(.a(new_n143_), .b(new_n141_), .O(new_n144_));
  aoi21  g100(.a(new_n142_), .b(x18), .c(new_n144_), .O(new_n145_));
  nand3  g101(.a(x18), .b(new_n103_), .c(x12), .O(new_n146_));
  nand4  g102(.a(new_n140_), .b(x31), .c(x30), .d(x19), .O(new_n147_));
  or2    g103(.a(new_n147_), .b(new_n146_), .O(new_n148_));
  oai21  g104(.a(new_n145_), .b(new_n103_), .c(new_n148_), .O(new_n149_));
  ...
  aoi21  g110(.a(new_n149_), .b(x16), .c(new_n154_), .O(new_n155_));
  nand2  g111(.a(x16), .b(x10), .O(new_n156_));
  nor2   g112(.a(new_n109_), .b(new_n106_), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(x17), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(new_n137_), .O(new_n159_));
  nand3  g115(.a(new_n157_), .b(x17), .c(x11), .O(new_n160_));
  nand2  g116(.a(new_n160_), .b(new_n150_), .O(new_n161_));
  inv1   g117(.a(x12), .O(new_n162_));
  inv1   g118(.a(new_n157_), .O(new_n163_));
  oai21  g119(.a(new_n163_), .b(new_n162_), .c(new_n103_), .O(new_n164_));
  inv1   g120(.a(x30), .O(new_n165_));
  aoi21  g121(.a(x19), .b(x13), .c(x18), .O(new_n166_));
  nor2   g122(.a(x19), .b(x14), .O(new_n167_));
  nor4   g123(.a(new_n167_), .b(new_n166_), .c(new_n133_), .d(new_n165_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n164_), .c(new_n161_), .d(new_n159_), .O(new_n169_));
  nand4  g125(.a(x17), .b(x16), .c(new_n137_), .d(x10), .O(new_n170_));
  nor3   g126(.a(new_n170_), .b(new_n163_), .c(new_n141_), .O(new_n171_));
  aoi21  g127(.a(new_n169_), .b(x32), .c(new_n171_), .O(new_n172_));
  oai21  g128(.a(new_n155_), .b(new_n137_), .c(new_n172_), .O(new_n173_));
  nand4  g129(.a(new_n173_), .b(new_n45_), .c(new_n98_), .d(x00), .O(new_n174_));
  inv1   g130(.a(new_n174_), .O(z8));
  nand2  g131(.a(x33), .b(x18), .O(new_n176_));
  nand2  g132(.a(new_n106_), .b(x13), .O(new_n177_));
  inv1   g133(.a(x33), .O(new_n178_));
  nand3  g134(.a(new_n178_), .b(new_n133_), .c(new_n165_), .O(new_n179_));
  oai21  g135(.a(new_n179_), .b(new_n177_), .c(new_n176_), .O(new_n180_));
  nand2  g136(.a(new_n180_), .b(x19), .O(new_n181_));
  inv1   g137(.a(x14), .O(new_n182_));
  nand2  g138(.a(x33), .b(new_n182_), .O(new_n183_));
  oai21  g139(.a(new_n179_), .b(new_n139_), .c(new_n183_), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(x18), .O(new_n185_));
  aoi21  g141(.a(new_n185_), .b(new_n181_), .c(new_n103_), .O(new_n186_));
  nand4  g142(.a(new_n178_), .b(new_n133_), .c(new_n165_), .d(x19), .O(new_n187_));
  nor2   g143(.a(new_n187_), .b(new_n146_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n186_), .c(x16), .O(new_n189_));
  or2    g145(.a(new_n187_), .b(new_n153_), .O(new_n190_));
  aoi21  g146(.a(new_n190_), .b(new_n189_), .c(new_n137_), .O(new_n191_));
  nor2   g147(.a(new_n150_), .b(new_n137_), .O(new_n192_));
  aoi21  g148(.a(new_n192_), .b(new_n152_), .c(x19), .O(new_n193_));
  oai21  g149(.a(new_n156_), .b(new_n151_), .c(new_n137_), .O(new_n194_));
  inv1   g150(.a(x11), .O(new_n195_));
  oai21  g151(.a(new_n151_), .b(new_n195_), .c(new_n150_), .O(new_n196_));
  oai21  g152(.a(new_n106_), .b(new_n162_), .c(new_n103_), .O(new_n197_));
  nor2   g153(.a(x18), .b(x13), .O(new_n198_));
  nor3   g154(.a(new_n198_), .b(x31), .c(x30), .O(new_n199_));
  nand4  g155(.a(new_n199_), .b(new_n197_), .c(new_n196_), .d(new_n194_), .O(new_n200_));
  ...
  oai21  g159(.a(new_n203_), .b(new_n170_), .c(new_n201_), .O(new_n204_));
  oai21  g160(.a(new_n204_), .b(new_n191_), .c(x00), .O(new_n205_));
