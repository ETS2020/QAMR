...
module FAU ( 
  ...
  nand4  g069(.a(new_n113_), .b(new_n101_), .c(new_n62_), .d(new_n46_), .O(new_n114_));
  nor3   g070(.a(new_n114_), .b(new_n97_), .c(new_n60_), .O(z6));
  ...
  nand3  g093(.a(new_n137_), .b(new_n46_), .c(x17), .O(new_n138_));
  nor2   g094(.a(new_n89_), .b(new_n86_), .O(new_n139_));
  nand3  g095(.a(new_n139_), .b(new_n83_), .c(x12), .O(new_n140_));
  aoi21  g096(.a(new_n140_), .b(new_n138_), .c(new_n134_), .O(new_n141_));
  inv1   g097(.a(x11), .O(new_n142_));
  nor2   g098(.a(x26), .b(new_n89_), .O(new_n143_));
  nand2  g099(.a(new_n143_), .b(x18), .O(new_n144_));
  nor4   g100(.a(new_n144_), .b(new_n83_), .c(x16), .d(new_n142_), .O(new_n145_));
  oai21  g101(.a(new_n145_), .b(new_n141_), .c(x15), .O(new_n146_));
  nor2   g102(.a(new_n134_), .b(x15), .O(new_n147_));
  nor2   g103(.a(new_n86_), .b(new_n83_), .O(new_n148_));
  nand4  g104(.a(new_n148_), .b(new_n147_), .c(new_n143_), .d(x10), .O(new_n149_));
  nand2  g105(.a(new_n149_), .b(new_n146_), .O(new_n150_));
  nand4  g106(.a(new_n150_), .b(new_n133_), .c(new_n128_), .d(x31), .O(new_n151_));
  aoi21  g107(.a(new_n89_), .b(x14), .c(new_n86_), .O(new_n152_));
  ...
  nand3  g112(.a(new_n148_), .b(x16), .c(x15), .O(new_n157_));
  nand2  g113(.a(new_n157_), .b(new_n89_), .O(new_n158_));
  and2   g114(.a(x16), .b(x10), .O(new_n159_));
  aoi21  g115(.a(new_n159_), .b(new_n148_), .c(x15), .O(new_n160_));
  nand2  g116(.a(new_n148_), .b(x11), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n134_), .O(new_n162_));
  oai21  g118(.a(new_n86_), .b(new_n45_), .c(new_n83_), .O(new_n163_));
  inv1   g119(.a(x13), .O(new_n164_));
  aoi22  g120(.a(new_n116_), .b(x28), .c(new_n86_), .d(new_n164_), .O(new_n165_));
  aoi21  g121(.a(new_n111_), .b(new_n102_), .c(new_n123_), .O(new_n166_));
  nand4  g122(.a(new_n166_), .b(new_n165_), .c(new_n163_), .d(new_n162_), .O(new_n167_));
  nor2   g123(.a(new_n167_), .b(new_n160_), .O(new_n168_));
  nand4  g124(.a(new_n168_), .b(new_n158_), .c(new_n156_), .d(new_n153_), .O(new_n169_));
  nand3  g125(.a(new_n169_), .b(x32), .c(new_n46_), .O(new_n170_));
  ...
  aoi21  g129(.a(new_n136_), .b(new_n135_), .c(new_n134_), .O(new_n174_));
  nand4  g130(.a(x19), .b(x18), .c(new_n134_), .d(x11), .O(new_n175_));
  inv1   g131(.a(new_n175_), .O(new_n176_));
  oai21  g132(.a(new_n176_), .b(new_n174_), .c(x15), .O(new_n177_));
  inv1   g133(.a(x15), .O(new_n178_));
  nand4  g134(.a(new_n139_), .b(x16), .c(new_n178_), .d(x10), .O(new_n179_));
  aoi21  g135(.a(new_n179_), .b(new_n177_), .c(x33), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(x31), .c(x30), .d(x17), .O(new_n181_));
  nand2  g137(.a(x33), .b(new_n123_), .O(new_n182_));
  aoi21  g138(.a(new_n182_), .b(new_n181_), .c(x26), .O(new_n183_));
  inv1   g139(.a(new_n139_), .O(new_n184_));
  nand4  g140(.a(new_n83_), .b(x16), .c(x15), .d(x12), .O(new_n185_));
  inv1   g141(.a(x33), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(x31), .c(x30), .O(new_n187_));
  nor3   g143(.a(new_n187_), .b(new_n185_), .c(new_n184_), .O(new_n188_));
  oai21  g144(.a(new_n188_), .b(new_n183_), .c(new_n130_), .O(new_n189_));
  nor2   g145(.a(new_n189_), .b(new_n102_), .O(new_n190_));
  nand4  g146(.a(new_n180_), .b(new_n123_), .c(new_n111_), .d(x17), .O(new_n191_));
  nand2  g147(.a(x33), .b(x31), .O(new_n192_));
  nand2  g148(.a(new_n192_), .b(new_n191_), .O(new_n193_));
  nand4  g149(.a(new_n139_), .b(new_n186_), .c(new_n123_), .d(new_n111_), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n185_), .O(new_n195_));
  aoi21  g151(.a(new_n193_), .b(new_n46_), .c(new_n195_), .O(new_n196_));
  nand2  g152(.a(new_n86_), .b(new_n164_), .O(new_n197_));
  xnor2a g153(.a(x31), .b(x30), .O(new_n198_));
  nand4  g154(.a(new_n198_), .b(new_n197_), .c(new_n163_), .d(new_n162_), .O(new_n199_));
  nor2   g155(.a(new_n199_), .b(new_n160_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n158_), .c(new_n153_), .O(new_n201_));
  nand3  g157(.a(new_n201_), .b(x33), .c(new_n46_), .O(new_n202_));
  oai21  g158(.a(new_n196_), .b(new_n132_), .c(new_n202_), .O(new_n203_));
  oai21  g159(.a(new_n203_), .b(new_n190_), .c(x00), .O(new_n204_));
