...
module FAU ( 
  ...
  nand4  g062(.a(new_n106_), .b(new_n100_), .c(new_n61_), .d(new_n81_), .O(new_n107_));
  ...
  oai21  g066(.a(new_n101_), .b(x27), .c(new_n110_), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n100_), .c(new_n61_), .d(new_n81_), .O(new_n112_));
  ...
  oai21  g091(.a(new_n132_), .b(new_n135_), .c(new_n83_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n104_), .b(new_n45_), .c(new_n140_), .O(new_n141_));
  ...
  nand3  g101(.a(new_n120_), .b(new_n101_), .c(new_n45_), .O(new_n146_));
  ...
  nand3  g108(.a(new_n101_), .b(x29), .c(x28), .O(new_n153_));
  inv1   g109(.a(new_n153_), .O(new_n154_));
  oai21  g110(.a(new_n154_), .b(new_n102_), .c(new_n45_), .O(new_n155_));
  ...
  oai21  g130(.a(new_n101_), .b(new_n109_), .c(new_n45_), .O(new_n175_));
  nand3  g131(.a(new_n175_), .b(x31), .c(x29), .O(new_n176_));
  nand3  g132(.a(new_n120_), .b(new_n116_), .c(new_n101_), .O(new_n177_));
  ...
  nor2   g140(.a(new_n86_), .b(new_n83_), .O(new_n185_));
  inv1   g141(.a(new_n185_), .O(new_n186_));
  oai21  g142(.a(new_n186_), .b(new_n142_), .c(new_n89_), .O(new_n187_));
  oai21  g143(.a(new_n186_), .b(new_n128_), .c(new_n127_), .O(new_n188_));
  aoi21  g144(.a(new_n185_), .b(x11), .c(x16), .O(new_n189_));
  oai21  g145(.a(new_n86_), .b(new_n135_), .c(new_n83_), .O(new_n190_));
  inv1   g146(.a(x13), .O(new_n191_));
  nand2  g147(.a(new_n86_), .b(new_n191_), .O(new_n192_));
