...
module FAU ( 
  ...
  oai21  g064(.a(new_n102_), .b(new_n100_), .c(x30), .O(new_n109_));
  nand3  g065(.a(new_n46_), .b(x29), .c(x28), .O(new_n110_));
  nand3  g066(.a(new_n110_), .b(new_n109_), .c(x27), .O(new_n111_));
  nand4  g067(.a(new_n111_), .b(new_n99_), .c(new_n61_), .d(new_n80_), .O(new_n112_));
  ...
  nand2  g101(.a(new_n145_), .b(new_n47_), .O(new_n146_));
  nand3  g102(.a(x30), .b(x29), .c(new_n100_), .O(new_n147_));
  oai21  g103(.a(x30), .b(x29), .c(new_n147_), .O(new_n148_));
  nand2  g104(.a(new_n148_), .b(x27), .O(new_n149_));
  nand4  g105(.a(new_n149_), .b(new_n146_), .c(new_n143_), .d(new_n119_), .O(new_n150_));
  nand2  g106(.a(new_n150_), .b(x32), .O(new_n151_));
  inv1   g107(.a(x32), .O(new_n152_));
  nand2  g108(.a(new_n46_), .b(x29), .O(new_n153_));
  aoi21  g109(.a(new_n100_), .b(new_n45_), .c(new_n102_), .O(new_n154_));
  oai22  g110(.a(new_n154_), .b(new_n46_), .c(new_n153_), .d(new_n45_), .O(new_n155_));
  ...
  nand4  g123(.a(new_n167_), .b(new_n155_), .c(new_n152_), .d(x31), .O(new_n168_));
  ...
  nand4  g127(.a(x33), .b(new_n100_), .c(new_n80_), .d(x00), .O(new_n172_));
  nand2  g128(.a(new_n172_), .b(x30), .O(new_n173_));
  nand2  g129(.a(new_n173_), .b(new_n45_), .O(new_n174_));
  aoi21  g130(.a(new_n163_), .b(new_n161_), .c(new_n129_), .O(new_n175_));
  inv1   g131(.a(new_n166_), .O(new_n176_));
  nand2  g132(.a(new_n100_), .b(new_n45_), .O(new_n177_));
  nand4  g133(.a(new_n177_), .b(x31), .c(x30), .d(x29), .O(new_n178_));
  nand3  g134(.a(new_n116_), .b(new_n46_), .c(new_n102_), .O(new_n179_));
  nand2  g135(.a(new_n179_), .b(new_n178_), .O(new_n180_));
  oai21  g136(.a(new_n176_), .b(new_n175_), .c(new_n180_), .O(new_n181_));
  nand2  g137(.a(new_n88_), .b(x14), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(x18), .c(x17), .d(x16), .O(new_n183_));
  nor2   g139(.a(new_n183_), .b(new_n129_), .O(new_n184_));
  nand2  g140(.a(x18), .b(x17), .O(new_n185_));
  oai21  g141(.a(new_n185_), .b(new_n144_), .c(new_n88_), .O(new_n186_));
  oai21  g142(.a(new_n185_), .b(new_n130_), .c(new_n129_), .O(new_n187_));
  inv1   g143(.a(x11), .O(new_n188_));
  oai21  g144(.a(new_n185_), .b(new_n188_), .c(new_n133_), .O(new_n189_));
  aoi21  g145(.a(x18), .b(x12), .c(x17), .O(new_n190_));
  inv1   g146(.a(x13), .O(new_n191_));
  nand2  g147(.a(new_n85_), .b(new_n191_), .O(new_n192_));
  nand2  g148(.a(x31), .b(new_n102_), .O(new_n193_));
  nand4  g149(.a(new_n193_), .b(new_n192_), .c(new_n117_), .d(new_n153_), .O(new_n194_));
  nor2   g150(.a(new_n194_), .b(new_n190_), .O(new_n195_));
  nand4  g151(.a(new_n195_), .b(new_n189_), .c(new_n187_), .d(new_n186_), .O(new_n196_));
  oai21  g152(.a(new_n196_), .b(new_n184_), .c(x33), .O(new_n197_));
  oai21  g153(.a(new_n181_), .b(x33), .c(new_n197_), .O(new_n198_));
  nand3  g154(.a(new_n198_), .b(new_n80_), .c(x00), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n174_), .O(z9));
endmodule
