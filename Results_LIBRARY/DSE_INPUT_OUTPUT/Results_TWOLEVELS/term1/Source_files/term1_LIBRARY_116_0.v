...
module FAU ( 
  ...
  nand3  g049(.a(x30), .b(x28), .c(new_n45_), .O(new_n94_));
  ...
  nand2  g054(.a(x30), .b(x29), .O(new_n99_));
  inv1   g055(.a(new_n99_), .O(new_n100_));
  nand2  g056(.a(new_n100_), .b(new_n45_), .O(new_n101_));
  oai21  g057(.a(new_n98_), .b(new_n45_), .c(new_n101_), .O(new_n102_));
  nand4  g058(.a(new_n102_), .b(new_n88_), .c(new_n61_), .d(new_n80_), .O(new_n103_));
  nor3   g059(.a(new_n103_), .b(new_n93_), .c(new_n59_), .O(z5));
  nand3  g060(.a(new_n46_), .b(x29), .c(x27), .O(new_n105_));
  oai21  g061(.a(new_n46_), .b(x27), .c(new_n105_), .O(new_n106_));
  nand2  g062(.a(new_n106_), .b(x28), .O(new_n107_));
  nand2  g063(.a(x29), .b(x28), .O(new_n108_));
  nand2  g064(.a(new_n108_), .b(x30), .O(new_n109_));
  aoi21  g065(.a(new_n109_), .b(new_n107_), .c(new_n89_), .O(new_n110_));
  ...
  oai21  g074(.a(new_n116_), .b(x30), .c(new_n118_), .O(new_n119_));
  aoi21  g075(.a(new_n117_), .b(x27), .c(new_n116_), .O(new_n120_));
  aoi22  g076(.a(new_n120_), .b(x30), .c(new_n119_), .d(x27), .O(new_n121_));
  nand2  g077(.a(new_n121_), .b(new_n115_), .O(z7));
  nand2  g078(.a(new_n46_), .b(new_n45_), .O(new_n123_));
  ...
  nand2  g094(.a(new_n138_), .b(new_n123_), .O(new_n139_));
  nor3   g095(.a(new_n126_), .b(new_n128_), .c(new_n124_), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n116_), .c(new_n47_), .O(new_n141_));
  inv1   g097(.a(x29), .O(new_n142_));
  nand2  g098(.a(new_n46_), .b(new_n142_), .O(new_n143_));
  oai21  g099(.a(new_n99_), .b(x28), .c(new_n143_), .O(new_n144_));
  aoi22  g100(.a(new_n144_), .b(x27), .c(new_n100_), .d(x28), .O(new_n145_));
  nand3  g101(.a(new_n145_), .b(new_n141_), .c(new_n139_), .O(new_n146_));
  nand2  g102(.a(new_n146_), .b(x32), .O(new_n147_));
  inv1   g103(.a(x32), .O(new_n148_));
  nor2   g104(.a(x28), .b(x27), .O(new_n149_));
  oai21  g105(.a(new_n149_), .b(new_n142_), .c(x30), .O(new_n150_));
  ...
  aoi21  g111(.a(new_n155_), .b(new_n153_), .c(new_n133_), .O(new_n156_));
  nand4  g112(.a(x19), .b(x18), .c(new_n133_), .d(x12), .O(new_n157_));
  inv1   g113(.a(new_n157_), .O(new_n158_));
  oai21  g114(.a(new_n158_), .b(new_n156_), .c(x16), .O(new_n159_));
  inv1   g115(.a(new_n126_), .O(new_n160_));
  nand3  g116(.a(new_n160_), .b(new_n128_), .c(x11), .O(new_n161_));
  ...
  nand4  g121(.a(new_n165_), .b(new_n151_), .c(new_n148_), .d(x31), .O(new_n166_));
  ...
  nor2   g125(.a(new_n128_), .b(new_n124_), .O(new_n170_));
  nand2  g126(.a(x18), .b(x17), .O(new_n171_));
  inv1   g127(.a(new_n171_), .O(new_n172_));
  aoi21  g128(.a(new_n172_), .b(new_n170_), .c(x19), .O(new_n173_));
  oai21  g129(.a(new_n171_), .b(new_n125_), .c(new_n124_), .O(new_n174_));
  inv1   g130(.a(x11), .O(new_n175_));
  oai21  g131(.a(new_n171_), .b(new_n175_), .c(new_n128_), .O(new_n176_));
  oai21  g132(.a(new_n152_), .b(new_n132_), .c(new_n133_), .O(new_n177_));
  nor2   g133(.a(x18), .b(x13), .O(new_n178_));
  nor2   g134(.a(new_n124_), .b(x14), .O(new_n179_));
  nand3  g135(.a(x18), .b(x17), .c(x16), .O(new_n180_));
  inv1   g136(.a(new_n180_), .O(new_n181_));
  aoi21  g137(.a(new_n181_), .b(new_n179_), .c(new_n178_), .O(new_n182_));
  nand4  g138(.a(new_n182_), .b(new_n177_), .c(new_n176_), .d(new_n174_), .O(new_n183_));
  oai21  g139(.a(new_n183_), .b(new_n173_), .c(new_n123_), .O(new_n184_));
  nand3  g140(.a(new_n47_), .b(x19), .c(x18), .O(new_n185_));
  nor2   g141(.a(new_n185_), .b(new_n133_), .O(new_n186_));
  nand3  g142(.a(new_n186_), .b(x16), .c(x15), .O(new_n187_));
  nand2  g143(.a(new_n116_), .b(new_n142_), .O(new_n188_));
  ...
  nand4  g147(.a(new_n191_), .b(new_n189_), .c(new_n187_), .d(new_n184_), .O(new_n192_));
  ...
  nand3  g154(.a(new_n117_), .b(x31), .c(x30), .O(new_n199_));
  nand2  g155(.a(new_n199_), .b(new_n198_), .O(new_n200_));
  nand3  g156(.a(new_n200_), .b(new_n165_), .c(new_n194_), .O(new_n201_));
