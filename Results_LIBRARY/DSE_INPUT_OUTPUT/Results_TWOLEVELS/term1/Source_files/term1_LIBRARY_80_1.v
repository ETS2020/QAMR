...
module FAU ( 
  ...
  oai21  g046(.a(new_n90_), .b(new_n60_), .c(new_n47_), .O(z3));
  xor2a  g047(.a(x28), .b(x27), .O(new_n92_));
  nand4  g048(.a(new_n92_), .b(new_n89_), .c(new_n81_), .d(x25), .O(new_n93_));
  oai21  g049(.a(new_n93_), .b(new_n60_), .c(new_n47_), .O(z4));
  ...
  nand3  g055(.a(new_n99_), .b(x29), .c(x23), .O(new_n100_));
  and2   g056(.a(new_n96_), .b(new_n100_), .O(new_n101_));
  nor3   g057(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(new_n102_));
  oai22  g058(.a(new_n102_), .b(new_n101_), .c(new_n96_), .d(new_n95_), .O(new_n103_));
  ...
  aoi22  g064(.a(new_n108_), .b(x23), .c(x30), .d(new_n45_), .O(new_n109_));
  nand3  g065(.a(new_n86_), .b(x30), .c(new_n45_), .O(new_n110_));
  oai21  g066(.a(new_n109_), .b(new_n102_), .c(new_n110_), .O(new_n111_));
  ...
  nand3  g075(.a(new_n119_), .b(new_n118_), .c(new_n84_), .O(new_n120_));
  inv1   g076(.a(x31), .O(new_n121_));
  nand4  g077(.a(new_n98_), .b(new_n121_), .c(x30), .d(x29), .O(new_n122_));
  nand3  g078(.a(new_n122_), .b(new_n120_), .c(new_n117_), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x23), .O(new_n124_));
  inv1   g080(.a(x18), .O(new_n125_));
  oai21  g081(.a(new_n120_), .b(new_n125_), .c(new_n121_), .O(new_n126_));
  nand2  g082(.a(new_n126_), .b(new_n45_), .O(new_n127_));
  nand3  g083(.a(new_n127_), .b(new_n124_), .c(new_n115_), .O(z7));
  ...
  nand3  g089(.a(x30), .b(x29), .c(x27), .O(new_n134_));
  oai21  g090(.a(x30), .b(x27), .c(new_n134_), .O(new_n135_));
  nand3  g091(.a(new_n135_), .b(new_n97_), .c(x23), .O(new_n136_));
  nand2  g092(.a(x16), .b(x15), .O(new_n137_));
  nand2  g093(.a(x18), .b(x17), .O(new_n138_));
  oai21  g094(.a(new_n138_), .b(new_n137_), .c(new_n130_), .O(new_n139_));
  nand2  g095(.a(x16), .b(x10), .O(new_n140_));
  oai21  g096(.a(new_n140_), .b(new_n138_), .c(new_n129_), .O(new_n141_));
  ...
  nand2  g105(.a(new_n125_), .b(new_n149_), .O(new_n150_));
  nand3  g106(.a(x30), .b(x29), .c(x28), .O(new_n151_));
  aoi21  g107(.a(new_n106_), .b(new_n45_), .c(new_n121_), .O(new_n152_));
  nand4  g108(.a(new_n152_), .b(new_n151_), .c(new_n150_), .d(new_n148_), .O(new_n153_));
  nor2   g109(.a(new_n153_), .b(new_n145_), .O(new_n154_));
  nand4  g110(.a(new_n154_), .b(new_n141_), .c(new_n139_), .d(new_n136_), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n133_), .c(x32), .O(new_n156_));
  inv1   g112(.a(x32), .O(new_n157_));
  nor2   g113(.a(x28), .b(x27), .O(new_n158_));
  inv1   g114(.a(new_n158_), .O(new_n159_));
  nand3  g115(.a(new_n159_), .b(new_n106_), .c(x29), .O(new_n160_));
  nor2   g116(.a(new_n158_), .b(new_n45_), .O(new_n161_));
  oai21  g117(.a(new_n161_), .b(new_n106_), .c(new_n160_), .O(new_n162_));
  nand3  g118(.a(x19), .b(new_n125_), .c(x13), .O(new_n163_));
  nand3  g119(.a(new_n130_), .b(x18), .c(x14), .O(new_n164_));
  aoi21  g120(.a(new_n164_), .b(new_n163_), .c(new_n146_), .O(new_n165_));
  nand4  g121(.a(x19), .b(x18), .c(new_n146_), .d(x12), .O(new_n166_));
  ...
  nand4  g129(.a(new_n170_), .b(x16), .c(new_n129_), .d(x10), .O(new_n174_));
  nand2  g130(.a(new_n174_), .b(new_n173_), .O(new_n175_));
  nand4  g131(.a(new_n175_), .b(new_n162_), .c(new_n157_), .d(x31), .O(new_n176_));
  ...
  nand4  g141(.a(new_n175_), .b(new_n180_), .c(new_n121_), .d(new_n106_), .O(new_n186_));
  ...
  nand3  g146(.a(new_n190_), .b(new_n150_), .c(new_n148_), .O(new_n191_));
  inv1   g147(.a(new_n191_), .O(new_n192_));
  nand4  g148(.a(new_n192_), .b(new_n144_), .c(new_n141_), .d(new_n139_), .O(new_n193_));
  oai21  g149(.a(new_n193_), .b(new_n133_), .c(x33), .O(new_n194_));
