...
module FAU ( 
  ...
  nand4  g033(.a(new_n77_), .b(new_n58_), .c(new_n57_), .d(x08), .O(new_n78_));
  ...
  aoi21  g075(.a(new_n118_), .b(new_n93_), .c(new_n119_), .O(new_n120_));
  inv1   g076(.a(new_n110_), .O(new_n121_));
  oai21  g077(.a(new_n109_), .b(new_n99_), .c(x31), .O(new_n122_));
  inv1   g078(.a(x31), .O(new_n123_));
  nand2  g079(.a(new_n123_), .b(x30), .O(new_n124_));
  oai21  g080(.a(new_n124_), .b(new_n121_), .c(new_n122_), .O(new_n125_));
  aoi22  g081(.a(new_n125_), .b(x29), .c(x31), .d(new_n45_), .O(new_n126_));
  oai21  g082(.a(new_n120_), .b(new_n46_), .c(new_n126_), .O(z7));
  inv1   g083(.a(x32), .O(new_n128_));
  nand2  g084(.a(new_n99_), .b(new_n45_), .O(new_n129_));
  nand2  g085(.a(new_n129_), .b(x29), .O(new_n130_));
  nand2  g086(.a(new_n130_), .b(x30), .O(new_n131_));
  nand2  g087(.a(x29), .b(x28), .O(new_n132_));
  aoi21  g088(.a(new_n132_), .b(new_n45_), .c(x30), .O(new_n133_));
  inv1   g089(.a(new_n133_), .O(new_n134_));
  nand2  g090(.a(new_n134_), .b(new_n131_), .O(new_n135_));
  nand3  g091(.a(x19), .b(new_n88_), .c(x13), .O(new_n136_));
  nand3  g092(.a(new_n91_), .b(x18), .c(x14), .O(new_n137_));
  aoi21  g093(.a(new_n137_), .b(new_n136_), .c(new_n85_), .O(new_n138_));
  ...
  nand3  g107(.a(new_n132_), .b(new_n109_), .c(new_n45_), .O(new_n152_));
  inv1   g108(.a(new_n152_), .O(new_n153_));
  nand3  g109(.a(new_n129_), .b(x30), .c(x29), .O(new_n154_));
  nand2  g110(.a(x16), .b(x10), .O(new_n155_));
  oai21  g111(.a(new_n155_), .b(new_n143_), .c(new_n148_), .O(new_n156_));
  nor2   g112(.a(new_n91_), .b(new_n88_), .O(new_n157_));
  ...
  nand2  g116(.a(x19), .b(x13), .O(new_n161_));
  nand2  g117(.a(new_n161_), .b(new_n88_), .O(new_n162_));
  inv1   g118(.a(x14), .O(new_n163_));
  nand2  g119(.a(new_n91_), .b(new_n163_), .O(new_n164_));
  nand3  g120(.a(new_n144_), .b(x16), .c(x15), .O(new_n165_));
  nand4  g121(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(x31), .O(new_n166_));
  ...
  nand2  g127(.a(new_n171_), .b(new_n58_), .O(z8));
  inv1   g128(.a(x33), .O(new_n173_));
  nand4  g129(.a(new_n129_), .b(x31), .c(x30), .d(x29), .O(new_n174_));
  nand3  g130(.a(new_n130_), .b(new_n123_), .c(new_n109_), .O(new_n175_));
  nand2  g131(.a(new_n175_), .b(new_n174_), .O(new_n176_));
  nand3  g132(.a(new_n176_), .b(new_n150_), .c(new_n173_), .O(new_n177_));
  nand2  g133(.a(new_n130_), .b(x31), .O(new_n178_));
  nand4  g134(.a(new_n165_), .b(new_n164_), .c(new_n162_), .d(new_n124_), .O(new_n179_));
  nor2   g135(.a(new_n179_), .b(new_n160_), .O(new_n180_));
  nand4  g136(.a(new_n180_), .b(new_n178_), .c(new_n159_), .d(new_n156_), .O(new_n181_));
  oai21  g137(.a(new_n181_), .b(new_n133_), .c(x33), .O(new_n182_));
  nand2  g138(.a(new_n182_), .b(new_n177_), .O(new_n183_));
  nand3  g139(.a(new_n183_), .b(new_n80_), .c(x00), .O(new_n184_));
  nand2  g140(.a(new_n184_), .b(new_n58_), .O(z9));
endmodule
