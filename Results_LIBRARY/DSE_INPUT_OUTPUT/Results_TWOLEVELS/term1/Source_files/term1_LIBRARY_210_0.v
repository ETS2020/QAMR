...
module FAU ( 
  ...
  nor2   g046(.a(new_n46_), .b(x20), .O(new_n91_));
  ...
  oai21  g064(.a(new_n46_), .b(x29), .c(x28), .O(new_n109_));
  nand3  g065(.a(new_n109_), .b(new_n45_), .c(new_n83_), .O(new_n110_));
  xor2a  g066(.a(x30), .b(x29), .O(new_n111_));
  nand3  g067(.a(new_n111_), .b(new_n90_), .c(x28), .O(new_n112_));
  ...
  nand4  g076(.a(new_n120_), .b(new_n62_), .c(new_n81_), .d(x25), .O(new_n121_));
  oai21  g077(.a(new_n121_), .b(new_n60_), .c(new_n47_), .O(z6));
  ...
  aoi21  g124(.a(new_n168_), .b(new_n153_), .c(x15), .O(new_n169_));
  ...
  nor3   g133(.a(new_n152_), .b(new_n151_), .c(new_n83_), .O(new_n178_));
