...
module FAU ( 
  ...
  nand3  g068(.a(new_n80_), .b(x29), .c(x28), .O(new_n113_));
  nand2  g069(.a(new_n113_), .b(new_n112_), .O(new_n114_));
  nand4  g070(.a(new_n114_), .b(new_n101_), .c(new_n60_), .d(x27), .O(new_n115_));
  ...
  oai21  g079(.a(new_n123_), .b(new_n102_), .c(x31), .O(new_n124_));
  inv1   g080(.a(new_n81_), .O(new_n125_));
  nand4  g081(.a(new_n90_), .b(new_n87_), .c(new_n84_), .d(new_n125_), .O(new_n126_));
  ...
  oai21  g116(.a(new_n157_), .b(new_n160_), .c(new_n82_), .O(new_n161_));
  ...
  nand2  g121(.a(new_n80_), .b(new_n104_), .O(new_n166_));
  ...
  nand2  g129(.a(new_n88_), .b(x14), .O(new_n174_));
  ...
  oai21  g133(.a(new_n177_), .b(new_n164_), .c(new_n88_), .O(new_n178_));
  ...
  aoi22  g138(.a(new_n182_), .b(new_n82_), .c(new_n85_), .d(new_n162_), .O(new_n183_));
  nand4  g139(.a(new_n183_), .b(new_n181_), .c(new_n179_), .d(new_n178_), .O(new_n184_));
  oai21  g140(.a(new_n184_), .b(new_n176_), .c(new_n47_), .O(new_n185_));
  oai21  g141(.a(x31), .b(new_n104_), .c(new_n136_), .O(new_n186_));
  aoi21  g142(.a(new_n111_), .b(new_n119_), .c(x30), .O(new_n187_));
  ...
  nand3  g149(.a(new_n193_), .b(new_n119_), .c(new_n80_), .O(new_n194_));
