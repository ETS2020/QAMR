...
module FAU ( 
  ...
  oai21  g11(.a(new_n52_), .b(x14), .c(x12), .O(new_n53_));
  aoi21  g12(.a(new_n53_), .b(new_n44_), .c(x11), .O(z02));
  nand3  g13(.a(new_n52_), .b(x12), .c(x11), .O(new_n55_));
  nor3   g14(.a(new_n55_), .b(new_n44_), .c(x14), .O(z03));
  nor2   g15(.a(new_n45_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nand2  g17(.a(new_n46_), .b(new_n58_), .O(z05));
  nor2   g18(.a(new_n44_), .b(new_n42_), .O(z06));
  ...
  nand2  g35(.a(new_n76_), .b(x11), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x15), .O(new_n78_));
  nand2  g37(.a(new_n52_), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x14), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n78_), .O(z13));
  nand3  g40(.a(new_n51_), .b(x15), .c(x11), .O(new_n82_));
  ...
  oai21  g51(.a(new_n61_), .b(new_n69_), .c(x11), .O(new_n93_));
  ...
  nand2  g66(.a(new_n51_), .b(x19), .O(new_n108_));
  ...
  nand3  g70(.a(x19), .b(x15), .c(x11), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n69_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n69_), .c(x11), .O(new_n114_));
