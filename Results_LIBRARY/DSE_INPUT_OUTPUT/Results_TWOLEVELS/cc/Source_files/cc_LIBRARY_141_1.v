...
module FAU ( 
  ...
  nor2   g41(.a(x15), .b(new_n76_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x08), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n43_), .O(z14));
  oai21  g44(.a(new_n63_), .b(x14), .c(x12), .O(new_n86_));
  ...
  nand3  g52(.a(new_n83_), .b(x08), .c(x04), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n43_), .O(z16));
  nand2  g54(.a(new_n51_), .b(x18), .O(new_n96_));
  nand3  g55(.a(new_n83_), .b(x08), .c(x05), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n43_), .O(z17));
  oai21  g57(.a(x19), .b(new_n43_), .c(x15), .O(new_n99_));
  nand2  g58(.a(new_n47_), .b(x19), .O(new_n100_));
  ...
  oai21  g63(.a(x20), .b(new_n43_), .c(x15), .O(new_n105_));
