...
module FAU ( 
  ...
  inv1   g20(.a(new_n59_), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n61_), .O(z05));
  nand2  g22(.a(new_n48_), .b(new_n56_), .O(z06));
  ...
  nand2  g28(.a(new_n69_), .b(new_n62_), .O(z09));
  nand3  g29(.a(new_n62_), .b(x09), .c(x08), .O(z10));
  inv1   g30(.a(new_n49_), .O(z11));
  nand2  g31(.a(new_n57_), .b(new_n48_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n56_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x13), .O(new_n75_));
  nand4  g34(.a(new_n50_), .b(x10), .c(x08), .d(x00), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n55_), .O(z12));
  ...
  nand3  g53(.a(new_n56_), .b(x10), .c(x08), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(x17), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n94_), .O(z16));
  nand2  g56(.a(new_n74_), .b(x18), .O(new_n98_));
  ...
  nand2  g61(.a(new_n102_), .b(new_n56_), .O(new_n103_));
  nand3  g62(.a(new_n95_), .b(x19), .c(x12), .O(new_n104_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n55_), .O(z19));
endmodule
