...
module FAU ( 
  ...
  nor2   g19(.a(new_n46_), .b(x15), .O(z05));
  ...
  nand3  g42(.a(new_n72_), .b(new_n46_), .c(x15), .O(new_n84_));
  ...
  nand2  g47(.a(new_n46_), .b(x15), .O(new_n89_));
  ...
  nand3  g67(.a(new_n108_), .b(new_n45_), .c(x12), .O(new_n109_));
  ...
  nand2  g72(.a(new_n72_), .b(x20), .O(new_n114_));
