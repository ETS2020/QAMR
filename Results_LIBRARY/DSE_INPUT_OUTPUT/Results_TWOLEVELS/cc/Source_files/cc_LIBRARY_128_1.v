...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x03), .c(new_n47_), .O(z01));
  oai21  g09(.a(new_n47_), .b(x03), .c(x14), .O(new_n51_));
  ...
  aoi21  g15(.a(new_n56_), .b(x03), .c(new_n47_), .O(z03));
  ...
  nand2  g41(.a(x10), .b(x08), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x15), .c(x03), .O(new_n84_));
  ...
  nand3  g48(.a(new_n83_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  oai21  g53(.a(new_n62_), .b(new_n70_), .c(x03), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x15), .O(new_n96_));
  nand2  g55(.a(new_n83_), .b(x17), .O(new_n97_));
  ...
  nand2  g61(.a(new_n102_), .b(x03), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x15), .O(new_n104_));
  nand2  g63(.a(new_n83_), .b(x18), .O(new_n105_));
  nand4  g64(.a(new_n47_), .b(x10), .c(x08), .d(x05), .O(new_n106_));
  ...
  nand2  g68(.a(new_n83_), .b(x19), .O(new_n110_));
  ...
  nand3  g72(.a(x19), .b(x15), .c(x03), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n70_), .O(z18));
  nand2  g74(.a(new_n83_), .b(x20), .O(new_n116_));
  nand3  g75(.a(x10), .b(x08), .c(x07), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(new_n47_), .O(new_n119_));
  nand3  g78(.a(x20), .b(x15), .c(x03), .O(new_n120_));
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n70_), .O(z19));
endmodule
