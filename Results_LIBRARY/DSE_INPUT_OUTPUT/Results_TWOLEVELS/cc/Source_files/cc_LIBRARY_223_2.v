...
module FAU ( 
  ...
  nand2  g26(.a(new_n47_), .b(new_n67_), .O(z08));
  ...
  nand2  g31(.a(new_n47_), .b(new_n48_), .O(z11));
  inv1   g32(.a(x12), .O(new_n74_));
  nand2  g33(.a(x15), .b(x13), .O(new_n75_));
  nand3  g34(.a(new_n53_), .b(new_n44_), .c(x10), .O(new_n76_));
  ...
  nand2  g44(.a(new_n49_), .b(x15), .O(new_n86_));
  ...
  nand4  g48(.a(new_n53_), .b(x10), .c(x08), .d(x03), .O(new_n90_));
  ...
  oai21  g54(.a(new_n50_), .b(new_n65_), .c(new_n95_), .O(new_n96_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n74_), .O(z18));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n74_), .O(z19));
endmodule
