...
module FAU ( 
  ...
  aoi21  g21(.a(x10), .b(new_n62_), .c(new_n56_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n62_), .c(x15), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(x12), .O(z06));
  ...
  nand3  g42(.a(new_n57_), .b(x15), .c(x12), .O(new_n84_));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n56_), .O(z17));
  nand2  g56(.a(new_n52_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n75_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n56_), .O(z18));
  nand2  g59(.a(new_n52_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n75_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n56_), .O(z19));
endmodule
