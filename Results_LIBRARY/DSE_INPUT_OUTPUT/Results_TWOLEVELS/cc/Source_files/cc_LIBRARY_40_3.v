...
module FAU ( 
  ...
  nor2   g24(.a(new_n43_), .b(x15), .O(z08));
  ...
  oai21  g40(.a(new_n81_), .b(new_n52_), .c(new_n48_), .O(new_n82_));
  ...
  nand3  g45(.a(new_n74_), .b(new_n43_), .c(x15), .O(new_n87_));
  nand4  g46(.a(new_n42_), .b(x10), .c(x08), .d(x02), .O(new_n88_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n45_), .O(z15));
  ...
  nand3  g57(.a(x17), .b(new_n43_), .c(x15), .O(new_n99_));
  ...
  oai21  g67(.a(new_n62_), .b(new_n80_), .c(new_n43_), .O(new_n109_));
