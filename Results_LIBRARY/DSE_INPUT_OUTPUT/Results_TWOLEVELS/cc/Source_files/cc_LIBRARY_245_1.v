...
module FAU ( 
  ...
  nor2   g27(.a(new_n46_), .b(x12), .O(new_n69_));
  nor3   g28(.a(new_n69_), .b(new_n68_), .c(new_n60_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n69_), .O(z10));
  nor2   g30(.a(new_n69_), .b(new_n50_), .O(z11));
  ...
  oai21  g45(.a(new_n66_), .b(x14), .c(x12), .O(new_n87_));
