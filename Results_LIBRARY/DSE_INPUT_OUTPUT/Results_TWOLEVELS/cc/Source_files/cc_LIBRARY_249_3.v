...
module FAU ( 
  ...
  nor2   g22(.a(new_n56_), .b(new_n47_), .O(z11));
  ...
  aoi21  g41(.a(new_n67_), .b(x05), .c(x15), .O(new_n84_));
  aoi21  g42(.a(new_n84_), .b(new_n83_), .c(new_n45_), .O(z17));
  ...
  nand2  g48(.a(new_n51_), .b(x20), .O(new_n91_));
  aoi21  g49(.a(new_n67_), .b(x07), .c(x15), .O(new_n92_));
  aoi21  g50(.a(new_n92_), .b(new_n91_), .c(new_n45_), .O(z19));
  zero   g51(.O(z03));
  buf    g52(.a(x15), .O(z06));
endmodule
