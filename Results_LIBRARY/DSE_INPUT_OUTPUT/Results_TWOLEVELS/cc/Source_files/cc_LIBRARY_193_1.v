...
module FAU ( 
  ...
  oai21  g17(.a(new_n58_), .b(new_n46_), .c(new_n44_), .O(z03));
  ...
  nand2  g30(.a(new_n46_), .b(new_n61_), .O(new_n72_));
  ...
  oai21  g42(.a(new_n52_), .b(new_n43_), .c(new_n83_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n44_), .O(z14));
  nand3  g45(.a(new_n73_), .b(x16), .c(new_n47_), .O(new_n87_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n71_), .O(z16));
  nand2  g51(.a(new_n73_), .b(x18), .O(new_n93_));
  nand4  g52(.a(new_n53_), .b(x10), .c(x08), .d(x05), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n71_), .O(z17));
  nand4  g54(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n61_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n44_), .O(z18));
  nand2  g58(.a(new_n46_), .b(x20), .O(new_n100_));
  nand4  g59(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n61_), .O(new_n103_));
  nand2  g62(.a(x20), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n71_), .O(z19));
  buf    g64(.a(x19), .O(z05));
endmodule
