...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n52_, new_n53_, new_n56_, new_n58_, new_n60_, new_n65_, new_n66_,
  ...
  aoi21  g09(.a(new_n50_), .b(x15), .c(x11), .O(z02));
  inv1   g10(.a(x12), .O(new_n52_));
  inv1   g11(.a(x15), .O(new_n53_));
  nor4   g12(.a(new_n46_), .b(new_n53_), .c(x14), .d(new_n52_), .O(z03));
  ...
  nand2  g22(.a(new_n44_), .b(new_n47_), .O(z11));
  nand2  g23(.a(new_n46_), .b(x13), .O(new_n65_));
  nand4  g24(.a(new_n53_), .b(x10), .c(x08), .d(x00), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n65_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x11), .O(new_n68_));
  nand2  g27(.a(x15), .b(x13), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n68_), .c(new_n52_), .O(z12));
  aoi21  g29(.a(x10), .b(x08), .c(x14), .O(new_n71_));
  nor2   g30(.a(new_n71_), .b(new_n53_), .O(new_n72_));
  nand3  g31(.a(x10), .b(x08), .c(x01), .O(new_n73_));
  and2   g32(.a(new_n73_), .b(x14), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n72_), .c(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n44_), .O(z13));
  nand2  g35(.a(new_n46_), .b(x15), .O(new_n77_));
  and2   g36(.a(x08), .b(x02), .O(new_n78_));
  nand4  g37(.a(new_n78_), .b(new_n53_), .c(x11), .d(x10), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n77_), .c(new_n52_), .O(z14));
  nand4  g39(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x11), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n53_), .O(new_n83_));
  nand3  g42(.a(new_n53_), .b(x10), .c(x08), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(x16), .c(new_n47_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n83_), .O(z15));
  ...
  nand3  g48(.a(new_n84_), .b(x17), .c(x12), .O(new_n90_));
  ...
  nand3  g53(.a(new_n84_), .b(x18), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z17));
  nand2  g55(.a(new_n46_), .b(x19), .O(new_n97_));
  nand4  g56(.a(new_n53_), .b(x10), .c(x08), .d(x06), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x11), .O(new_n100_));
  nand2  g59(.a(x19), .b(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n52_), .O(z18));
  nand4  g61(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x11), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n53_), .O(new_n105_));
  nand3  g64(.a(new_n84_), .b(x20), .c(x12), .O(new_n106_));
