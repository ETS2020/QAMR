...
module FAU ( 
  ...
  nor2   g23(.a(new_n44_), .b(new_n52_), .O(z08));
  ...
  nor2   g41(.a(x16), .b(x15), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n57_), .O(z14));
  nand4  g44(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  oai21  g45(.a(new_n44_), .b(x14), .c(new_n86_), .O(new_n87_));
