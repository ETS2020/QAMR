...
module FAU ( 
  ...
  oai21  g34(.a(new_n75_), .b(new_n63_), .c(new_n48_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x15), .O(new_n77_));
  inv1   g36(.a(x01), .O(new_n78_));
  oai21  g37(.a(new_n69_), .b(new_n78_), .c(x14), .O(new_n79_));
  ...
  oai21  g44(.a(new_n61_), .b(x14), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand3  g46(.a(new_n69_), .b(x16), .c(new_n48_), .O(new_n88_));
  ...
  nor2   g52(.a(x15), .b(new_n75_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x08), .c(x04), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n43_), .O(z16));
  nand2  g55(.a(new_n51_), .b(x18), .O(new_n97_));
  nand3  g56(.a(new_n94_), .b(x08), .c(x05), .O(new_n98_));
  ...
  nand2  g65(.a(new_n69_), .b(x20), .O(new_n107_));
  ...
  aoi21  g70(.a(new_n49_), .b(x12), .c(new_n47_), .O(z03));
endmodule
