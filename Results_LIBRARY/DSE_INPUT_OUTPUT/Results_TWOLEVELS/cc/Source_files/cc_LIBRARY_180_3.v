...
module FAU ( 
  ...
  nor2   g26(.a(x15), .b(new_n43_), .O(z11));
  ...
  nand2  g36(.a(new_n70_), .b(new_n49_), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n56_), .O(z13));
  nand3  g38(.a(new_n48_), .b(x15), .c(new_n43_), .O(new_n80_));
  ...
  nand3  g49(.a(x17), .b(x15), .c(new_n43_), .O(new_n91_));
  ...
  oai21  g59(.a(new_n59_), .b(new_n56_), .c(new_n43_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x15), .O(new_n102_));
  nand2  g61(.a(new_n48_), .b(x19), .O(new_n103_));
  nand4  g62(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n104_));
  ...
  nand3  g70(.a(x20), .b(x15), .c(new_n43_), .O(new_n112_));
