...
module FAU ( 
  ...
  nor2   g30(.a(new_n45_), .b(new_n51_), .O(z11));
  ...
  oai21  g41(.a(new_n82_), .b(new_n50_), .c(new_n51_), .O(new_n83_));
  ...
  nand3  g46(.a(new_n48_), .b(x20), .c(x15), .O(new_n88_));
  ...
  nand3  g52(.a(new_n48_), .b(x16), .c(new_n51_), .O(new_n94_));
  ...
  oai21  g57(.a(new_n65_), .b(new_n81_), .c(x20), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n48_), .b(x17), .O(new_n101_));
  ...
  nand3  g68(.a(x20), .b(x18), .c(x15), .O(new_n110_));
  ...
  aoi21  g83(.a(new_n124_), .b(new_n121_), .c(new_n81_), .O(z19));
endmodule
