...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n57_, new_n60_, new_n62_, new_n64_,
  ...
  nand3  g27(.a(x10), .b(x08), .c(x00), .O(new_n69_));
  and2   g28(.a(new_n69_), .b(new_n46_), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n68_), .c(new_n45_), .O(z12));
  ...
  and2   g51(.a(new_n92_), .b(new_n46_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n91_), .c(new_n45_), .O(z18));
