...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(new_n55_), .c(x15), .d(new_n50_), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z03));
  nand2  g18(.a(new_n42_), .b(x18), .O(z04));
  nor2   g19(.a(new_n55_), .b(x15), .O(z05));
  ...
  nand2  g26(.a(new_n42_), .b(new_n50_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  aoi21  g28(.a(x10), .b(x08), .c(x15), .O(new_n70_));
  nor2   g29(.a(x19), .b(new_n45_), .O(new_n71_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n49_), .c(new_n50_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(new_n55_), .c(x15), .O(new_n78_));
  ...
  nand3  g40(.a(new_n46_), .b(new_n55_), .c(x15), .O(new_n82_));
  ...
  nand3  g46(.a(new_n46_), .b(x16), .c(new_n50_), .O(new_n88_));
