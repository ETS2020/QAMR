...
module FAU ( 
  ...
  nor4   g15(.a(new_n48_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  ...
  nor2   g35(.a(new_n61_), .b(new_n46_), .O(new_n77_));
  ...
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n43_), .O(z14));
  oai21  g43(.a(new_n66_), .b(x14), .c(x12), .O(new_n85_));
  ...
  nand3  g60(.a(new_n74_), .b(x08), .c(x06), .O(new_n102_));
