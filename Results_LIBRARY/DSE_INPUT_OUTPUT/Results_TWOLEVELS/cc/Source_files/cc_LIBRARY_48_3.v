...
module FAU ( 
  ...
  nand2  g07(.a(new_n42_), .b(x14), .O(new_n49_));
  ...
  nor2   g13(.a(x16), .b(x14), .O(new_n55_));
  ...
  nor2   g22(.a(x15), .b(new_n63_), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n63_), .c(new_n54_), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n42_), .O(z09));
  aoi22  g26(.a(x16), .b(x15), .c(x09), .d(x08), .O(z10));
  inv1   g27(.a(new_n49_), .O(z11));
  nand2  g28(.a(x13), .b(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n54_), .O(new_n71_));
  ...
  oai21  g39(.a(new_n79_), .b(new_n63_), .c(new_n80_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n54_), .c(x15), .O(new_n82_));
  ...
  nand2  g44(.a(new_n46_), .b(x15), .O(new_n86_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n42_), .O(z14));
  nand3  g49(.a(new_n46_), .b(x16), .c(new_n80_), .O(new_n91_));
  ...
  oai21  g54(.a(new_n61_), .b(new_n78_), .c(new_n54_), .O(new_n96_));
  ...
  nand3  g65(.a(x18), .b(new_n54_), .c(x15), .O(new_n107_));
  ...
  nand3  g71(.a(x19), .b(new_n54_), .c(x15), .O(new_n113_));
  ...
  nand3  g77(.a(x20), .b(new_n54_), .c(x15), .O(new_n119_));
