...
module FAU ( 
  ...
  nand2  g18(.a(new_n50_), .b(x04), .O(z06));
  ...
  oai21  g46(.a(new_n80_), .b(x17), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z16));
  nand2  g48(.a(new_n46_), .b(x18), .O(new_n90_));
  nand4  g49(.a(new_n50_), .b(x10), .c(x08), .d(x05), .O(new_n91_));
