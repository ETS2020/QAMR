...
module FAU ( 
  ...
  oai21  g31(.a(new_n68_), .b(new_n72_), .c(new_n47_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n69_), .b(x08), .c(x04), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n43_), .O(z16));
  oai21  g45(.a(x18), .b(new_n43_), .c(x15), .O(new_n87_));
  nand2  g46(.a(new_n55_), .b(x18), .O(new_n88_));
  nand4  g47(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n89_));
  ...
  nand3  g55(.a(new_n69_), .b(x08), .c(x07), .O(new_n97_));
