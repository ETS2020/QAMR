...
module FAU ( 
  ...
  nand2  g30(.a(new_n44_), .b(new_n48_), .O(z11));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n73_), .c(new_n43_), .O(z12));
  inv1   g36(.a(new_n61_), .O(new_n78_));
  ...
  nand2  g41(.a(new_n49_), .b(x15), .O(new_n83_));
  ...
  oai21  g46(.a(new_n67_), .b(x14), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x15), .O(new_n89_));
  nand3  g48(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  nand4  g55(.a(new_n47_), .b(x10), .c(x08), .d(x04), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n95_), .O(z16));
  nand2  g59(.a(new_n53_), .b(x18), .O(new_n101_));
  nand3  g60(.a(new_n75_), .b(x08), .c(x05), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n43_), .O(z17));
  ...
  oai21  g68(.a(x20), .b(new_n43_), .c(x15), .O(new_n110_));
