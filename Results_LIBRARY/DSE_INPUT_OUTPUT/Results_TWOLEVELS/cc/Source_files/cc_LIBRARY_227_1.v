...
module FAU ( 
  ...
  aoi21  g32(.a(new_n73_), .b(new_n70_), .c(new_n68_), .O(z12));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n68_), .O(z14));
  nand3  g42(.a(x16), .b(x15), .c(new_n49_), .O(new_n84_));
  nand3  g43(.a(new_n72_), .b(x08), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n68_), .O(z15));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n68_), .O(z17));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n68_), .O(z19));
  buf    g67(.a(x15), .O(z06));
  buf    g68(.a(x16), .O(z08));
endmodule
