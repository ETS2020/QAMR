...
module FAU ( 
  ...
  nand2  g34(.a(new_n75_), .b(x05), .O(new_n76_));
  ...
  nand3  g48(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n56_), .O(z15));
  ...
  nand2  g60(.a(new_n52_), .b(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x05), .O(new_n103_));
  nand2  g62(.a(x18), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n56_), .O(z17));
  nand2  g64(.a(new_n47_), .b(x19), .O(new_n106_));
  nand4  g65(.a(new_n51_), .b(x10), .c(x08), .d(x06), .O(new_n107_));
  ...
  nand2  g71(.a(new_n112_), .b(x05), .O(new_n113_));
