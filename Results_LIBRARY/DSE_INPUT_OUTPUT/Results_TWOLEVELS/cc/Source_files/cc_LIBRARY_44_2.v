...
module FAU ( 
  ...
  oai21  g52(.a(new_n49_), .b(new_n65_), .c(new_n93_), .O(new_n94_));
  ...
  oai21  g63(.a(new_n49_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  ...
  aoi21  g67(.a(new_n48_), .b(new_n44_), .c(x15), .O(new_n109_));
  nor3   g68(.a(new_n109_), .b(new_n43_), .c(new_n58_), .O(z19));
endmodule
