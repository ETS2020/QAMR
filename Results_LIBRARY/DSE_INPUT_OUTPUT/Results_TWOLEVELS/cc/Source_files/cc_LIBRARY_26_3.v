...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n56_, new_n57_, new_n58_, new_n62_, new_n63_, new_n66_,
  ...
  oai21  g16(.a(new_n57_), .b(new_n56_), .c(x15), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(x12), .O(z06));
  and2   g18(.a(new_n42_), .b(x17), .O(z07));
  and2   g19(.a(new_n42_), .b(x16), .O(z08));
  nand2  g20(.a(x15), .b(x12), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(x09), .c(x08), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z09));
  aoi22  g23(.a(x15), .b(x12), .c(x09), .d(x08), .O(z10));
  inv1   g24(.a(x14), .O(new_n66_));
  nand2  g25(.a(new_n42_), .b(new_n66_), .O(z11));
  nand2  g26(.a(new_n46_), .b(x13), .O(new_n68_));
  nand3  g27(.a(x10), .b(x08), .c(x00), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n68_), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(new_n45_), .c(x12), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z12));
  inv1   g31(.a(x01), .O(new_n73_));
  oai21  g32(.a(new_n46_), .b(new_n73_), .c(x14), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n45_), .c(new_n48_), .O(z13));
  nand2  g34(.a(new_n50_), .b(x02), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n45_), .c(new_n48_), .O(z14));
  nand3  g36(.a(new_n46_), .b(x16), .c(new_n66_), .O(new_n78_));
  ...
  nand2  g41(.a(new_n46_), .b(x17), .O(new_n83_));
  aoi21  g42(.a(new_n50_), .b(x04), .c(x15), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n48_), .O(z16));
  nand2  g44(.a(new_n46_), .b(x18), .O(new_n86_));
  nand3  g45(.a(x10), .b(x08), .c(x05), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n45_), .c(x12), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z17));
  nand2  g49(.a(new_n46_), .b(x19), .O(new_n91_));
  aoi21  g50(.a(new_n50_), .b(x06), .c(x15), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n48_), .O(z18));
  nand2  g52(.a(new_n46_), .b(x20), .O(new_n94_));
  aoi21  g53(.a(new_n50_), .b(x07), .c(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n48_), .O(z19));
endmodule
