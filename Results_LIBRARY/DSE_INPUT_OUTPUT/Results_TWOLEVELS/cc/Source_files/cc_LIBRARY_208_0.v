...
module FAU ( 
  ...
  nand4  g52(.a(new_n77_), .b(x16), .c(new_n47_), .d(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(z15));
  nor2   g54(.a(new_n68_), .b(x04), .O(new_n96_));
  ...
  nand2  g71(.a(new_n112_), .b(x17), .O(new_n113_));
  nand2  g72(.a(x20), .b(x15), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n80_), .O(z19));
endmodule
