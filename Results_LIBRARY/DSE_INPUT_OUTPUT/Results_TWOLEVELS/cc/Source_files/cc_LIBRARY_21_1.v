...
module FAU ( 
  ...
  nand2  g07(.a(new_n48_), .b(x12), .O(new_n49_));
  ...
  nor2   g19(.a(new_n52_), .b(new_n43_), .O(z06));
  ...
  nand2  g39(.a(new_n80_), .b(new_n50_), .O(z13));
  ...
  nand2  g45(.a(x12), .b(x10), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n86_), .O(z14));
  oai21  g48(.a(new_n64_), .b(x14), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x15), .O(new_n91_));
  nand3  g50(.a(new_n71_), .b(x16), .c(new_n47_), .O(new_n92_));
  nand4  g51(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n93_));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n43_), .O(z16));
  oai21  g58(.a(x18), .b(new_n43_), .c(x15), .O(new_n100_));
  nand2  g59(.a(new_n71_), .b(x18), .O(new_n101_));
  nand4  g60(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n102_));
  ...
  oai21  g64(.a(x19), .b(new_n43_), .c(x15), .O(new_n106_));
  nand2  g65(.a(new_n71_), .b(x19), .O(new_n107_));
  nand4  g66(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n108_));
  ...
  oai21  g70(.a(x20), .b(new_n43_), .c(x15), .O(new_n112_));
  nand2  g71(.a(new_n71_), .b(x20), .O(new_n113_));
  nand4  g72(.a(new_n52_), .b(x10), .c(x08), .d(x07), .O(new_n114_));
