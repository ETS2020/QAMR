...
module FAU ( 
  ...
  aoi21  g25(.a(x19), .b(x15), .c(new_n47_), .O(z11));
  ...
  oai21  g37(.a(new_n78_), .b(new_n51_), .c(new_n47_), .O(new_n79_));
  ...
  nand3  g42(.a(new_n71_), .b(new_n46_), .c(x15), .O(new_n84_));
  ...
  nand3  g48(.a(new_n71_), .b(x16), .c(new_n47_), .O(new_n90_));
  ...
  nand3  g63(.a(new_n46_), .b(x18), .c(x15), .O(new_n105_));
  ...
  nand3  g74(.a(x20), .b(new_n46_), .c(x15), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n77_), .O(z19));
  buf    g76(.a(x19), .O(z05));
  buf    g77(.a(x15), .O(z06));
endmodule
