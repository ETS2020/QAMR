...
module FAU ( 
  ...
  nand3  g18(.a(x12), .b(x10), .c(x08), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(new_n43_), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(new_n59_), .c(new_n47_), .O(z06));
  ...
  oai22  g42(.a(new_n83_), .b(new_n82_), .c(new_n61_), .d(new_n47_), .O(z14));
  ...
  nand2  g47(.a(new_n58_), .b(x17), .O(new_n89_));
  ...
  nand2  g53(.a(new_n58_), .b(x18), .O(new_n95_));
  ...
  nand2  g59(.a(new_n58_), .b(x19), .O(new_n101_));
  ...
  nand2  g65(.a(new_n58_), .b(x20), .O(new_n107_));
