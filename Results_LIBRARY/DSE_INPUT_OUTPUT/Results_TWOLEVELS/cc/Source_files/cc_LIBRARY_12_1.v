...
module FAU ( 
  ...
  aoi21  g17(.a(x10), .b(x08), .c(x14), .O(new_n59_));
  nand4  g18(.a(new_n59_), .b(x12), .c(x10), .d(x08), .O(new_n60_));
  and2   g19(.a(new_n60_), .b(x15), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n44_), .b(new_n62_), .O(z07));
  and2   g22(.a(new_n44_), .b(x16), .O(z08));
  nand2  g23(.a(x09), .b(x08), .O(new_n65_));
  nand2  g24(.a(new_n65_), .b(new_n44_), .O(z09));
  aoi22  g25(.a(x15), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  nor2   g26(.a(new_n57_), .b(new_n50_), .O(z11));
  ...
  oai21  g55(.a(x20), .b(new_n43_), .c(x15), .O(new_n97_));
  nand2  g56(.a(new_n47_), .b(x20), .O(new_n98_));
  nand4  g57(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n97_), .O(z19));
  nor4   g61(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
