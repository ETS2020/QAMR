...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x06), .O(new_n55_));
  ...
  aoi21  g37(.a(new_n50_), .b(x01), .c(new_n48_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n78_), .c(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n47_), .O(z13));
  nand2  g40(.a(new_n53_), .b(x10), .O(new_n82_));
  nand2  g41(.a(x08), .b(x02), .O(new_n83_));
  oai22  g42(.a(new_n83_), .b(new_n82_), .c(new_n50_), .d(new_n53_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n47_), .O(z14));
  inv1   g45(.a(x12), .O(new_n87_));
  nand3  g46(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n88_));
  nand2  g47(.a(x08), .b(x03), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n82_), .c(new_n88_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n44_), .O(new_n91_));
  nand3  g50(.a(x16), .b(x15), .c(new_n48_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n87_), .O(z15));
  nand2  g52(.a(x08), .b(x04), .O(new_n94_));
  oai22  g53(.a(new_n94_), .b(new_n82_), .c(new_n50_), .d(new_n64_), .O(new_n95_));
  ...
  oai21  g59(.a(new_n100_), .b(new_n82_), .c(new_n99_), .O(new_n101_));
  ...
  nand3  g63(.a(new_n54_), .b(x19), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n47_), .O(z18));
  nand2  g65(.a(x08), .b(x07), .O(new_n107_));
  oai22  g66(.a(new_n107_), .b(new_n82_), .c(new_n50_), .d(new_n43_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n44_), .O(new_n109_));
  nand2  g68(.a(x20), .b(x15), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n87_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
