...
module FAU ( 
  ...
  nor3   g28(.a(new_n44_), .b(new_n69_), .c(new_n68_), .O(z09));
  ...
  oai21  g37(.a(new_n78_), .b(new_n68_), .c(new_n48_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  inv1   g39(.a(new_n47_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x14), .c(x13), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n80_), .c(new_n77_), .O(z13));
  nand2  g43(.a(new_n47_), .b(x15), .O(new_n85_));
  nor2   g44(.a(x15), .b(new_n51_), .O(new_n86_));
  nand4  g45(.a(new_n86_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n77_), .O(z14));
  nand3  g47(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n89_));
  nand4  g48(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x13), .O(new_n92_));
  nand3  g51(.a(x16), .b(x15), .c(new_n48_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n77_), .O(z15));
  nand4  g53(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n95_));
  oai21  g54(.a(new_n81_), .b(new_n64_), .c(new_n95_), .O(new_n96_));
  ...
  nand4  g63(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n105_));
  oai21  g64(.a(new_n81_), .b(new_n61_), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x13), .O(new_n107_));
  nand2  g66(.a(x19), .b(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n77_), .O(z18));
  nand4  g68(.a(new_n52_), .b(x10), .c(x08), .d(x07), .O(new_n110_));
  oai21  g69(.a(new_n81_), .b(new_n43_), .c(new_n110_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x13), .O(new_n112_));
  nand2  g71(.a(x20), .b(x15), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n77_), .O(z19));
endmodule
