...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n66_), .c(new_n48_), .O(new_n80_));
  ...
  oai21  g61(.a(new_n74_), .b(new_n99_), .c(new_n102_), .O(z17));
  nand2  g62(.a(new_n52_), .b(x19), .O(new_n104_));
  nand3  g63(.a(new_n91_), .b(x08), .c(x06), .O(new_n105_));
  ...
  oai21  g68(.a(new_n74_), .b(new_n43_), .c(new_n109_), .O(z19));
endmodule
