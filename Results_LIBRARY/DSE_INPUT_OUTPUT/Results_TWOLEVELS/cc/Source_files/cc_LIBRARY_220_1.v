...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(new_n50_), .c(new_n43_), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n47_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n44_), .b(new_n59_), .O(z05));
  aoi21  g19(.a(x10), .b(x08), .c(x14), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n55_), .O(new_n62_));
  nand3  g21(.a(new_n62_), .b(x15), .c(x12), .O(new_n63_));
  inv1   g22(.a(new_n63_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  aoi21  g24(.a(x15), .b(new_n43_), .c(new_n65_), .O(z07));
  ...
  nor2   g29(.a(new_n70_), .b(new_n69_), .O(z09));
  ...
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n43_), .O(z12));
  nor2   g37(.a(new_n61_), .b(new_n47_), .O(new_n79_));
  ...
  nand3  g43(.a(new_n76_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n43_), .O(z14));
  nand3  g45(.a(new_n51_), .b(x16), .c(new_n50_), .O(new_n87_));
  nand3  g46(.a(new_n76_), .b(x08), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n43_), .O(z15));
  nand2  g48(.a(new_n51_), .b(x17), .O(new_n90_));
  nand3  g49(.a(new_n76_), .b(x08), .c(x04), .O(new_n91_));
  ...
  nand3  g58(.a(new_n76_), .b(x08), .c(x06), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n43_), .O(z18));
  nand2  g60(.a(new_n51_), .b(x20), .O(new_n102_));
  nand3  g61(.a(new_n76_), .b(x08), .c(x07), .O(new_n103_));
