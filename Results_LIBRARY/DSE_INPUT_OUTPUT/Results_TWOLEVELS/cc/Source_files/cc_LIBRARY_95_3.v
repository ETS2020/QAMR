...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n60_, new_n62_, new_n66_, new_n67_,
  ...
  and2   g44(.a(new_n85_), .b(new_n46_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n45_), .O(z17));
  nand2  g46(.a(new_n51_), .b(x19), .O(new_n88_));
  nand3  g47(.a(x10), .b(x08), .c(x06), .O(new_n89_));
  and2   g48(.a(new_n89_), .b(new_n46_), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n88_), .c(new_n45_), .O(z18));
