...
module FAU ( 
  ...
  nand2  g22(.a(new_n53_), .b(new_n44_), .O(z06));
  ...
  nand2  g28(.a(new_n69_), .b(new_n47_), .O(z09));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n73_), .O(z13));
  nand2  g45(.a(new_n49_), .b(x15), .O(new_n87_));
  inv1   g46(.a(new_n54_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n44_), .c(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n73_), .O(z14));
  nor2   g49(.a(new_n73_), .b(new_n81_), .O(new_n91_));
  ...
  nand4  g53(.a(new_n54_), .b(x16), .c(new_n48_), .d(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z15));
  nand4  g55(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n97_));
  oai21  g56(.a(new_n50_), .b(new_n65_), .c(new_n97_), .O(new_n98_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n53_), .O(new_n104_));
  nand3  g63(.a(new_n54_), .b(x18), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(z17));
  nand3  g65(.a(new_n91_), .b(x08), .c(x06), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n44_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n53_), .O(new_n109_));
  nand3  g68(.a(new_n54_), .b(x19), .c(x12), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n109_), .O(z18));
  nand3  g70(.a(new_n54_), .b(x20), .c(x12), .O(new_n112_));
