...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x04), .O(new_n55_));
  ...
  nand2  g31(.a(new_n53_), .b(x10), .O(new_n73_));
  ...
  or2    g39(.a(new_n80_), .b(new_n53_), .O(new_n81_));
  nand2  g40(.a(new_n50_), .b(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x14), .c(new_n44_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n72_), .O(z13));
  nand2  g43(.a(x08), .b(x02), .O(new_n85_));
  oai22  g44(.a(new_n85_), .b(new_n73_), .c(new_n50_), .d(new_n53_), .O(new_n86_));
  ...
  nand3  g52(.a(new_n54_), .b(x17), .c(x12), .O(new_n94_));
  ...
  nand3  g57(.a(new_n54_), .b(x18), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(z17));
  nand2  g59(.a(x08), .b(x06), .O(new_n101_));
  oai22  g60(.a(new_n101_), .b(new_n73_), .c(new_n50_), .d(new_n62_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n44_), .O(new_n103_));
  nand2  g62(.a(x19), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n72_), .O(z18));
  nand2  g64(.a(x08), .b(x07), .O(new_n106_));
  oai22  g65(.a(new_n106_), .b(new_n73_), .c(new_n50_), .d(new_n43_), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n44_), .O(new_n108_));
  nand2  g67(.a(x20), .b(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n72_), .O(z19));
  buf    g69(.a(x15), .O(z06));
endmodule
