...
module FAU ( 
  ...
  nand4  g14(.a(new_n55_), .b(new_n46_), .c(x12), .d(new_n45_), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n42_), .O(z03));
  nor2   g16(.a(new_n42_), .b(new_n45_), .O(new_n58_));
  ...
  nand2  g30(.a(new_n61_), .b(new_n46_), .O(z11));
  aoi21  g31(.a(x13), .b(x12), .c(x11), .O(new_n73_));
  nand2  g32(.a(new_n54_), .b(x13), .O(new_n74_));
  ...
  oai21  g36(.a(new_n73_), .b(new_n42_), .c(new_n77_), .O(z12));
  inv1   g37(.a(x12), .O(new_n79_));
  oai21  g38(.a(new_n54_), .b(x11), .c(new_n46_), .O(new_n80_));
  nand3  g39(.a(x10), .b(x08), .c(x01), .O(new_n81_));
  aoi22  g40(.a(new_n81_), .b(x14), .c(new_n80_), .d(x15), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n79_), .c(new_n61_), .O(z13));
  nand3  g42(.a(new_n54_), .b(x15), .c(new_n45_), .O(new_n84_));
  inv1   g43(.a(new_n50_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x08), .c(x02), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n79_), .O(z14));
  oai21  g46(.a(new_n55_), .b(x15), .c(new_n63_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x16), .c(new_n46_), .O(new_n89_));
  nand3  g48(.a(new_n85_), .b(x08), .c(x03), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n79_), .O(z15));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n79_), .O(z16));
  ...
  nand3  g60(.a(x18), .b(x15), .c(new_n45_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n79_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand2  g63(.a(new_n54_), .b(x19), .O(new_n105_));
  oai21  g64(.a(new_n54_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n42_), .O(new_n107_));
  nand3  g66(.a(x19), .b(x15), .c(new_n45_), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n79_), .O(z18));
  inv1   g68(.a(x07), .O(new_n110_));
  nand2  g69(.a(new_n54_), .b(x20), .O(new_n111_));
  oai21  g70(.a(new_n54_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n42_), .O(new_n113_));
  nand3  g72(.a(x20), .b(x15), .c(new_n45_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n79_), .O(z19));
endmodule
