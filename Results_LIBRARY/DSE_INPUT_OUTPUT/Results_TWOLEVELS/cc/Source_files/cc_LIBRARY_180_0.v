...
module FAU ( 
  ...
  nand2  g25(.a(new_n54_), .b(x14), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n53_), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x13), .O(new_n69_));
  nand3  g28(.a(new_n53_), .b(x14), .c(x10), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x08), .c(x00), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n69_), .c(new_n52_), .O(z12));
  aoi21  g32(.a(x10), .b(x08), .c(x14), .O(new_n74_));
  or2    g33(.a(new_n74_), .b(new_n53_), .O(new_n75_));
  inv1   g34(.a(x01), .O(new_n76_));
  oai21  g35(.a(new_n54_), .b(new_n76_), .c(x14), .O(new_n77_));
  ...
  nand3  g40(.a(new_n71_), .b(x08), .c(x03), .O(new_n82_));
  nand3  g41(.a(x16), .b(x15), .c(new_n46_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n52_), .O(z15));
  nand2  g43(.a(new_n54_), .b(x17), .O(new_n85_));
  nand4  g44(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n86_));
  ...
  nand3  g52(.a(new_n53_), .b(x10), .c(x08), .O(new_n94_));
  ...
  nand3  g58(.a(new_n94_), .b(x19), .c(x12), .O(new_n100_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n52_), .O(z19));
  buf    g66(.a(x14), .O(z11));
endmodule
