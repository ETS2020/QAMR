...
module FAU ( 
  ...
  oai21  g12(.a(new_n53_), .b(new_n46_), .c(new_n51_), .O(new_n54_));
  ...
  nand4  g45(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
