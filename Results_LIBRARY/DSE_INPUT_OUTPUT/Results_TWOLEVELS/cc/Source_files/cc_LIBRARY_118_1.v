...
module FAU ( 
  ...
  nor2   g18(.a(x18), .b(x12), .O(new_n60_));
  ...
  nand2  g28(.a(new_n44_), .b(new_n50_), .O(z11));
  ...
  nand3  g34(.a(new_n47_), .b(new_n50_), .c(x12), .O(new_n76_));
  ...
  nand3  g44(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n86_));
  ...
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n43_), .O(z16));
  oai21  g52(.a(x18), .b(new_n43_), .c(x15), .O(new_n94_));
  nand2  g53(.a(new_n47_), .b(x18), .O(new_n95_));
  nand4  g54(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n96_));
