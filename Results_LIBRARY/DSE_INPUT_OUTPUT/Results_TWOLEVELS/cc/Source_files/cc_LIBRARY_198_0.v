...
module FAU ( 
  ...
  nand2  g29(.a(new_n52_), .b(x10), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(new_n72_));
  nand3  g31(.a(new_n72_), .b(x08), .c(x00), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n70_), .c(new_n51_), .O(z12));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n51_), .O(z14));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n51_), .O(z17));
  nor2   g53(.a(x15), .b(x08), .O(new_n95_));
  aoi21  g54(.a(new_n71_), .b(x12), .c(new_n95_), .O(new_n96_));
  inv1   g55(.a(x06), .O(new_n97_));
  oai21  g56(.a(new_n47_), .b(new_n97_), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  oai21  g58(.a(new_n96_), .b(new_n59_), .c(new_n99_), .O(z18));
  nand2  g59(.a(new_n53_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n72_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n51_), .O(z19));
endmodule
