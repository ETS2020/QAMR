...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(z04), .c(new_n44_), .O(z01));
  ...
  aoi21  g18(.a(new_n59_), .b(z04), .c(new_n44_), .O(z03));
  ...
  nor2   g31(.a(x18), .b(new_n44_), .O(new_n73_));
  ...
  nand2  g37(.a(new_n78_), .b(z04), .O(new_n79_));
  ...
  nand3  g42(.a(new_n57_), .b(z04), .c(x15), .O(new_n84_));
  ...
  nand3  g48(.a(new_n57_), .b(x16), .c(new_n49_), .O(new_n90_));
  ...
  nand2  g60(.a(new_n57_), .b(x18), .O(new_n102_));
  oai21  g61(.a(new_n57_), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g71(.a(new_n43_), .b(new_n71_), .c(z04), .O(new_n113_));
