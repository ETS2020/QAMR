...
module FAU ( 
  ...
  nand2  g28(.a(new_n44_), .b(x09), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n48_), .O(z09));
  ...
  nand2  g35(.a(new_n76_), .b(new_n64_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n43_), .O(new_n78_));
  nand3  g37(.a(new_n53_), .b(x13), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n78_), .O(z12));
  oai21  g39(.a(new_n49_), .b(new_n48_), .c(new_n47_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  nand2  g41(.a(new_n50_), .b(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x14), .c(new_n64_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n74_), .O(z13));
  nand2  g44(.a(new_n58_), .b(x15), .O(new_n86_));
  inv1   g45(.a(new_n53_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n64_), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n74_), .O(z14));
  oai21  g48(.a(new_n50_), .b(x03), .c(new_n43_), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(x16), .c(new_n47_), .d(x12), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(z15));
  nand4  g51(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  oai21  g52(.a(new_n50_), .b(new_n66_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n64_), .O(new_n95_));
  nand2  g54(.a(x17), .b(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n74_), .O(z16));
  nand3  g56(.a(new_n75_), .b(x08), .c(x05), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n64_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n43_), .O(new_n100_));
  nand3  g59(.a(new_n53_), .b(x18), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(z17));
  nand3  g61(.a(new_n75_), .b(x08), .c(x06), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n64_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n43_), .O(new_n105_));
  nand3  g64(.a(new_n53_), .b(x19), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(z18));
  nand3  g66(.a(new_n75_), .b(x08), .c(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n64_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n43_), .O(new_n110_));
  nand3  g69(.a(new_n53_), .b(x20), .c(x12), .O(new_n111_));
