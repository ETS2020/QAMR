...
module FAU ( 
  ...
  oai21  g35(.a(new_n73_), .b(new_n46_), .c(new_n47_), .O(new_n77_));
  ...
  nand2  g50(.a(new_n52_), .b(x12), .O(new_n92_));
  ...
  aoi22  g55(.a(new_n96_), .b(new_n74_), .c(new_n52_), .d(x18), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n43_), .c(new_n44_), .O(z17));
  ...
  nand3  g61(.a(new_n74_), .b(x08), .c(x07), .O(new_n103_));
