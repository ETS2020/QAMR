...
module FAU ( 
  ...
  aoi21  g48(.a(new_n89_), .b(new_n86_), .c(new_n57_), .O(z14));
  nand3  g49(.a(new_n53_), .b(x16), .c(new_n48_), .O(new_n91_));
  nand3  g50(.a(new_n88_), .b(x08), .c(x03), .O(new_n92_));
  ...
  nand3  g58(.a(new_n88_), .b(x08), .c(x05), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n57_), .O(z17));
  nand2  g60(.a(new_n53_), .b(x19), .O(new_n102_));
  nand3  g61(.a(new_n88_), .b(x08), .c(x06), .O(new_n103_));
  ...
  oai21  g66(.a(new_n75_), .b(new_n43_), .c(new_n107_), .O(z19));
endmodule
