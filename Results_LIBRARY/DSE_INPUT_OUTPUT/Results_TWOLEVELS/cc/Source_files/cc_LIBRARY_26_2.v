...
module FAU ( 
  ...
  nand2  g08(.a(x14), .b(new_n42_), .O(new_n50_));
  aoi21  g09(.a(new_n50_), .b(x15), .c(new_n44_), .O(z02));
  ...
  nor2   g16(.a(x15), .b(new_n44_), .O(new_n58_));
  ...
  nand2  g23(.a(new_n55_), .b(x09), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n64_), .O(z09));
  aoi22  g25(.a(new_n54_), .b(x12), .c(x09), .d(x08), .O(z10));
  nand2  g26(.a(new_n55_), .b(new_n47_), .O(z11));
  nand3  g27(.a(x15), .b(x13), .c(x12), .O(new_n69_));
  inv1   g28(.a(new_n69_), .O(z12));
  nand3  g29(.a(new_n52_), .b(x15), .c(new_n47_), .O(new_n71_));
  and2   g30(.a(new_n71_), .b(x12), .O(z13));
  nor2   g31(.a(new_n54_), .b(new_n64_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x10), .c(new_n44_), .O(z14));
  nand4  g33(.a(x16), .b(x15), .c(new_n47_), .d(x12), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z15));
  aoi21  g35(.a(new_n60_), .b(x15), .c(new_n44_), .O(z16));
  nand3  g36(.a(x18), .b(x15), .c(x12), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z17));
  aoi21  g38(.a(new_n57_), .b(x15), .c(new_n44_), .O(z18));
