...
module FAU ( 
  ...
  nand3  g40(.a(new_n81_), .b(x15), .c(new_n45_), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n46_), .c(x14), .O(new_n84_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n46_), .O(new_n91_));
  ...
  nand2  g74(.a(new_n74_), .b(x20), .O(new_n116_));
  ...
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n80_), .O(z19));
endmodule
