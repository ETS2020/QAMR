...
module FAU ( 
  ...
  nand2  g40(.a(new_n71_), .b(x15), .O(new_n82_));
  ...
  nand3  g47(.a(new_n71_), .b(x16), .c(new_n46_), .O(new_n89_));
  ...
  nand2  g59(.a(new_n71_), .b(x19), .O(new_n101_));
  ...
  nand2  g65(.a(new_n71_), .b(x20), .O(new_n107_));
