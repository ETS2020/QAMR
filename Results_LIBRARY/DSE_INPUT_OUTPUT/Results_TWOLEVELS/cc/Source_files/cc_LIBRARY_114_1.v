...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n61_, new_n62_, new_n66_, new_n68_, new_n70_, new_n74_,
  ...
  oai21  g21(.a(new_n62_), .b(x18), .c(new_n44_), .O(z04));
  and2   g22(.a(new_n44_), .b(x19), .O(z05));
  oai21  g23(.a(new_n62_), .b(new_n43_), .c(new_n44_), .O(z06));
  ...
  nor2   g29(.a(new_n70_), .b(new_n60_), .O(z09));
  aoi22  g30(.a(x18), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  inv1   g31(.a(new_n52_), .O(z11));
  ...
  nand3  g35(.a(new_n43_), .b(x10), .c(x08), .O(new_n77_));
  ...
  nand4  g51(.a(new_n77_), .b(x16), .c(new_n48_), .d(x12), .O(new_n93_));
  ...
  nand3  g56(.a(new_n77_), .b(x17), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z16));
  nand2  g58(.a(x18), .b(x15), .O(new_n100_));
  nand4  g59(.a(new_n53_), .b(x10), .c(x08), .d(x05), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n80_), .O(z17));
  ...
  nand3  g64(.a(new_n77_), .b(x19), .c(x12), .O(new_n106_));
  ...
  nand3  g69(.a(new_n77_), .b(x20), .c(x12), .O(new_n111_));
