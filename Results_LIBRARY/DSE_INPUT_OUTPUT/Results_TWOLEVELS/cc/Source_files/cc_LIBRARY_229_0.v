...
module FAU ( 
  ...
  nor2   g16(.a(x18), .b(new_n50_), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n44_), .b(new_n59_), .O(z05));
  nand2  g19(.a(x18), .b(new_n50_), .O(z06));
  ...
  nand2  g28(.a(new_n56_), .b(x18), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n50_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x13), .O(new_n72_));
  nand3  g31(.a(x18), .b(new_n50_), .c(x10), .O(new_n73_));
  ...
  nand2  g44(.a(new_n85_), .b(x18), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n50_), .O(new_n87_));
  nand4  g46(.a(new_n51_), .b(x16), .c(new_n46_), .d(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z15));
  nand2  g48(.a(new_n71_), .b(x17), .O(new_n90_));
  nand3  g49(.a(new_n74_), .b(x08), .c(x04), .O(new_n91_));
  ...
  nand2  g54(.a(new_n95_), .b(new_n49_), .O(z17));
