...
module FAU ( 
  ...
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n84_), .O(z18));
  nand2  g74(.a(new_n46_), .b(x20), .O(new_n116_));
  nand2  g75(.a(x08), .b(x07), .O(new_n117_));
  oai21  g76(.a(new_n117_), .b(new_n51_), .c(new_n116_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x12), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(new_n49_), .O(z19));
  buf    g79(.a(x15), .O(z06));
endmodule
