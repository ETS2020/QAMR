...
module FAU ( 
  ...
  oai21  g30(.a(new_n71_), .b(new_n70_), .c(x06), .O(new_n72_));
  ...
  nand2  g39(.a(x08), .b(x06), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n48_), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  aoi22  g42(.a(new_n83_), .b(x14), .c(new_n82_), .d(x15), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n70_), .c(new_n46_), .O(z13));
  nand4  g44(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n86_));
  oai21  g45(.a(new_n75_), .b(new_n44_), .c(new_n86_), .O(new_n87_));
  ...
  nand3  g51(.a(new_n74_), .b(x16), .c(new_n48_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n61_), .b(new_n70_), .c(x06), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand4  g58(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n100_));
  oai21  g59(.a(new_n75_), .b(new_n61_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n99_), .O(z16));
  inv1   g62(.a(x18), .O(new_n104_));
  oai21  g63(.a(new_n104_), .b(new_n70_), .c(x06), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand4  g65(.a(new_n44_), .b(x10), .c(x08), .d(x05), .O(new_n107_));
  oai21  g66(.a(new_n75_), .b(new_n104_), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x12), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n106_), .O(z17));
  nand2  g69(.a(new_n51_), .b(new_n58_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x06), .O(new_n112_));
  nand3  g71(.a(new_n74_), .b(x19), .c(new_n44_), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n70_), .O(z18));
  oai21  g73(.a(new_n43_), .b(new_n70_), .c(x06), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand4  g75(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n117_));
  oai21  g76(.a(new_n75_), .b(new_n43_), .c(new_n117_), .O(new_n118_));
