...
module FAU ( 
  ...
  nand2  g19(.a(new_n43_), .b(new_n51_), .O(z06));
  ...
  nand3  g29(.a(new_n43_), .b(new_n51_), .c(x10), .O(new_n71_));
  ...
  oai21  g34(.a(new_n75_), .b(new_n64_), .c(new_n48_), .O(new_n76_));
