...
module FAU ( 
  ...
  nand3  g31(.a(new_n55_), .b(new_n48_), .c(x12), .O(new_n73_));
  ...
  nand2  g36(.a(x15), .b(new_n63_), .O(new_n78_));
  ...
  oai21  g40(.a(new_n43_), .b(new_n69_), .c(x15), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(z14));
  ...
  nand2  g46(.a(new_n55_), .b(x17), .O(new_n88_));
