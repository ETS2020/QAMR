...
module FAU ( 
  ...
  nor2   g21(.a(new_n62_), .b(new_n59_), .O(z05));
  oai21  g22(.a(new_n62_), .b(new_n51_), .c(new_n46_), .O(z06));
  ...
  nand2  g36(.a(new_n77_), .b(x08), .O(new_n78_));
  ...
  nand4  g54(.a(new_n78_), .b(x16), .c(new_n48_), .d(x12), .O(new_n96_));
  ...
  nand3  g59(.a(new_n90_), .b(x08), .c(x04), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n87_), .O(z16));
  nand2  g61(.a(new_n99_), .b(x18), .O(new_n103_));
  nand3  g62(.a(new_n90_), .b(x08), .c(x05), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n87_), .O(z17));
  nor2   g64(.a(new_n60_), .b(x06), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n77_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(x19), .c(x12), .O(new_n108_));
  ...
  nand2  g71(.a(new_n112_), .b(x19), .O(new_n113_));
  nand2  g72(.a(x20), .b(x15), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n87_), .O(z19));
endmodule
