...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(new_n44_), .c(x15), .d(new_n49_), .O(new_n58_));
  inv1   g17(.a(new_n58_), .O(z03));
  nor2   g18(.a(new_n53_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n53_), .b(new_n61_), .O(z05));
  nor2   g21(.a(x20), .b(new_n43_), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  nor2   g23(.a(new_n53_), .b(new_n64_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nand2  g25(.a(new_n54_), .b(new_n66_), .O(z08));
  nand2  g26(.a(x09), .b(x08), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n54_), .O(z09));
  nand3  g28(.a(new_n54_), .b(x09), .c(x08), .O(z10));
  nor2   g29(.a(new_n53_), .b(new_n49_), .O(z11));
  ...
  oai21  g40(.a(new_n81_), .b(new_n48_), .c(new_n49_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n44_), .c(x15), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x01), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n43_), .c(x14), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z13));
  nand3  g45(.a(new_n46_), .b(new_n44_), .c(x15), .O(new_n87_));
  nand4  g46(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n80_), .O(z14));
  nand3  g48(.a(x16), .b(new_n49_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n44_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand3  g51(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n93_));
  nand4  g52(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n92_), .O(z15));
  oai21  g56(.a(new_n64_), .b(new_n80_), .c(new_n44_), .O(new_n98_));
  ...
  nand2  g63(.a(new_n46_), .b(x18), .O(new_n105_));
  ...
  nand3  g67(.a(new_n44_), .b(x18), .c(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n80_), .O(z17));
  oai21  g69(.a(new_n61_), .b(new_n80_), .c(new_n44_), .O(new_n111_));
  ...
  nand2  g77(.a(new_n46_), .b(x20), .O(new_n119_));
  oai21  g78(.a(new_n46_), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  nand3  g79(.a(new_n120_), .b(new_n43_), .c(x12), .O(new_n121_));
