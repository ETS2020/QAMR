...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x18), .c(new_n43_), .O(z03));
  ...
  nand4  g34(.a(new_n43_), .b(x10), .c(x08), .d(x00), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n71_), .O(z12));
  oai21  g36(.a(new_n56_), .b(new_n71_), .c(x18), .O(new_n78_));
  ...
  oai21  g61(.a(x15), .b(new_n102_), .c(new_n73_), .O(new_n103_));
  ...
  nand3  g69(.a(x19), .b(x18), .c(x15), .O(new_n111_));
  ...
  nand3  g75(.a(x20), .b(x18), .c(x15), .O(new_n117_));
