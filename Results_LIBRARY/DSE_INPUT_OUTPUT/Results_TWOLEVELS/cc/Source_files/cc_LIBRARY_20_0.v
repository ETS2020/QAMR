...
module FAU ( 
  ...
  oai21  g20(.a(new_n51_), .b(new_n61_), .c(x12), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(x08), .O(new_n63_));
  oai21  g22(.a(new_n56_), .b(x10), .c(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(x15), .O(new_n65_));
  nand3  g24(.a(new_n65_), .b(new_n63_), .c(new_n44_), .O(z06));
  inv1   g25(.a(x17), .O(new_n67_));
  nand2  g26(.a(new_n44_), .b(new_n67_), .O(z07));
  inv1   g27(.a(x16), .O(new_n69_));
  nand2  g28(.a(new_n44_), .b(new_n69_), .O(z08));
  aoi21  g29(.a(x09), .b(x08), .c(new_n43_), .O(z10));
  inv1   g30(.a(z10), .O(z09));
  nor2   g31(.a(new_n43_), .b(new_n47_), .O(z11));
  nand2  g32(.a(new_n52_), .b(x13), .O(new_n74_));
  nor2   g33(.a(x15), .b(new_n61_), .O(new_n75_));
