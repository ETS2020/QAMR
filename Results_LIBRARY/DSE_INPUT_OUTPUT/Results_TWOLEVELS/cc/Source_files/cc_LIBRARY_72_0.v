...
module FAU ( 
  ...
  nand2  g28(.a(new_n50_), .b(x20), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n52_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x13), .O(new_n72_));
  nand3  g31(.a(x20), .b(new_n52_), .c(x10), .O(new_n73_));
  ...
  nand3  g38(.a(new_n79_), .b(x20), .c(x14), .O(new_n80_));
  ...
  nand4  g47(.a(new_n88_), .b(x16), .c(new_n46_), .d(x12), .O(new_n89_));
