...
module FAU ( 
  ...
  nand2  g10(.a(new_n51_), .b(x14), .O(new_n52_));
  nand2  g11(.a(new_n42_), .b(x10), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(new_n50_), .c(new_n52_), .O(new_n54_));
  ...
  aoi21  g16(.a(new_n57_), .b(new_n45_), .c(new_n42_), .O(z03));
  aoi21  g17(.a(x20), .b(x15), .c(x18), .O(z04));
  and2   g18(.a(new_n51_), .b(x19), .O(z05));
  inv1   g19(.a(x17), .O(new_n61_));
  nand2  g20(.a(new_n51_), .b(new_n61_), .O(z07));
  and2   g21(.a(new_n51_), .b(x16), .O(z08));
  nand2  g22(.a(x09), .b(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n51_), .O(z09));
  ...
  nor2   g36(.a(new_n77_), .b(new_n42_), .O(new_n78_));
  ...
  nand3  g46(.a(new_n72_), .b(x16), .c(new_n46_), .O(new_n88_));
  nand3  g47(.a(new_n74_), .b(x08), .c(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n68_), .O(z15));
  oai21  g49(.a(new_n61_), .b(new_n68_), .c(new_n45_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n69_), .b(x17), .O(new_n93_));
  ...
  nand2  g59(.a(new_n69_), .b(x18), .O(new_n101_));
  ...
  nand2  g64(.a(new_n69_), .b(x19), .O(new_n106_));
  ...
  nand3  g68(.a(new_n45_), .b(x19), .c(x15), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n68_), .O(z18));
  nand2  g70(.a(new_n69_), .b(x20), .O(new_n112_));
  ...
  nand2  g74(.a(new_n115_), .b(new_n51_), .O(z19));
  buf    g75(.a(x15), .O(z06));
endmodule
