...
module FAU ( 
  ...
  nor2   g38(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  ...
  oai21  g55(.a(new_n63_), .b(new_n85_), .c(new_n44_), .O(new_n97_));
  ...
  nand3  g66(.a(x18), .b(x15), .c(new_n44_), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n85_), .O(z17));
  oai21  g68(.a(new_n60_), .b(new_n85_), .c(new_n44_), .O(new_n110_));
  ...
  oai21  g75(.a(new_n43_), .b(new_n85_), .c(new_n44_), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x15), .O(new_n118_));
  nand2  g77(.a(new_n73_), .b(x20), .O(new_n119_));
