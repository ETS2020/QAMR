...
module FAU ( 
  ...
  nand2  g27(.a(new_n47_), .b(new_n68_), .O(z07));
  ...
  nand2  g33(.a(new_n47_), .b(new_n48_), .O(z11));
  ...
  nand2  g41(.a(new_n47_), .b(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n51_), .c(new_n82_), .O(z13));
  nand2  g43(.a(new_n49_), .b(x15), .O(new_n85_));
  inv1   g44(.a(new_n54_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x02), .c(new_n44_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n82_), .O(z14));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n82_), .O(z15));
  nand4  g53(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n95_));
  oai21  g54(.a(new_n50_), .b(new_n68_), .c(new_n95_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n44_), .O(new_n97_));
  nand2  g56(.a(x17), .b(x15), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n82_), .O(z16));
