...
module FAU ( 
  ...
  nor4   g13(.a(new_n54_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  aoi21  g14(.a(x15), .b(new_n43_), .c(x18), .O(z04));
  ...
  aoi21  g23(.a(x15), .b(new_n43_), .c(new_n47_), .O(z11));
  oai21  g24(.a(x13), .b(new_n43_), .c(x15), .O(new_n66_));
  nand2  g25(.a(new_n54_), .b(x13), .O(new_n67_));
  ...
  nor2   g31(.a(new_n72_), .b(new_n46_), .O(new_n73_));
  ...
  nand3  g41(.a(new_n50_), .b(x16), .c(new_n47_), .O(new_n83_));
