...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    ...
    new_n63_, new_n65_, new_n66_, new_n69_, new_n70_, new_n71_, new_n73_,
  ...
  nand3  g08(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n50_));
  inv1   g09(.a(new_n50_), .O(z01));
  inv1   g10(.a(x11), .O(new_n52_));
  nand2  g11(.a(new_n48_), .b(new_n43_), .O(new_n53_));
  nand4  g12(.a(new_n53_), .b(new_n44_), .c(x12), .d(new_n52_), .O(new_n54_));
  inv1   g13(.a(new_n54_), .O(z02));
  aoi21  g14(.a(new_n49_), .b(x12), .c(x14), .O(new_n56_));
  nor2   g15(.a(new_n56_), .b(new_n44_), .O(z03));
  ...
  nand3  g42(.a(new_n49_), .b(x15), .c(new_n43_), .O(new_n84_));
  ...
  nand3  g49(.a(new_n44_), .b(x10), .c(x08), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x16), .c(new_n43_), .O(new_n92_));
  nand4  g51(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n81_), .O(z15));
  ...
  nand3  g57(.a(x17), .b(x15), .c(new_n43_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n81_), .O(z16));
  ...
  nand3  g63(.a(x18), .b(x15), .c(new_n43_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n81_), .O(z17));
  oai21  g65(.a(new_n59_), .b(new_n81_), .c(new_n43_), .O(new_n107_));
  ...
  nand3  g76(.a(x20), .b(x15), .c(new_n43_), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n81_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
