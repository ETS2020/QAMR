...
module FAU ( 
  ...
  and2   g27(.a(new_n68_), .b(new_n46_), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n67_), .c(new_n45_), .O(z12));
  inv1   g29(.a(x01), .O(new_n71_));
  oai21  g30(.a(new_n51_), .b(new_n71_), .c(x14), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n46_), .c(new_n45_), .O(z13));
  ...
  and2   g50(.a(new_n91_), .b(new_n46_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n90_), .c(new_n45_), .O(z18));
