...
module FAU ( 
  ...
  aoi21  g06(.a(new_n47_), .b(new_n42_), .c(new_n43_), .O(z01));
  ...
  nand4  g16(.a(new_n57_), .b(new_n46_), .c(x12), .d(new_n42_), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(new_n43_), .O(z03));
  nor2   g18(.a(new_n53_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nand2  g20(.a(new_n54_), .b(new_n61_), .O(z05));
  nor2   g21(.a(new_n43_), .b(x11), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  nor2   g23(.a(new_n53_), .b(new_n64_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nor2   g25(.a(new_n53_), .b(new_n66_), .O(z08));
  nand2  g26(.a(x09), .b(x08), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n54_), .O(z09));
  inv1   g28(.a(z09), .O(z10));
  nand2  g29(.a(new_n54_), .b(new_n46_), .O(z11));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n72_), .O(z12));
  nand3  g36(.a(x12), .b(x10), .c(x08), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n42_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  nand2  g39(.a(new_n57_), .b(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x14), .c(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n80_), .O(z13));
  nand3  g42(.a(new_n56_), .b(x15), .c(new_n42_), .O(new_n84_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n42_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x15), .O(new_n89_));
  nand3  g48(.a(new_n56_), .b(x16), .c(new_n46_), .O(new_n90_));
  ...
  nand3  g72(.a(x19), .b(x15), .c(new_n42_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n72_), .O(z18));
  oai21  g74(.a(new_n44_), .b(new_n72_), .c(new_n42_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n56_), .b(x20), .O(new_n118_));
  nand2  g77(.a(x08), .b(x07), .O(new_n119_));
  oai21  g78(.a(new_n119_), .b(new_n50_), .c(new_n118_), .O(new_n120_));
