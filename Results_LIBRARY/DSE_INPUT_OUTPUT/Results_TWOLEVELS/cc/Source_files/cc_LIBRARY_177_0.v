...
module FAU ( 
  ...
  nor2   g30(.a(x15), .b(x08), .O(new_n72_));
  aoi21  g31(.a(new_n71_), .b(x12), .c(new_n72_), .O(new_n73_));
  nand3  g32(.a(x10), .b(x08), .c(x00), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n51_), .O(new_n76_));
  oai21  g35(.a(new_n73_), .b(new_n70_), .c(new_n76_), .O(z12));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n90_), .c(new_n89_), .O(z15));
  nand2  g53(.a(new_n52_), .b(x17), .O(new_n95_));
  nand3  g54(.a(new_n92_), .b(x08), .c(x04), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n89_), .O(z16));
  nand2  g56(.a(new_n52_), .b(x18), .O(new_n98_));
  nand3  g57(.a(new_n92_), .b(x08), .c(x05), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n89_), .O(z17));
  nand2  g59(.a(new_n52_), .b(x19), .O(new_n101_));
  nand3  g60(.a(new_n92_), .b(x08), .c(x06), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n89_), .O(z18));
  nand2  g62(.a(new_n52_), .b(x20), .O(new_n104_));
  nand3  g63(.a(new_n92_), .b(x08), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n89_), .O(z19));
  buf    g65(.a(x15), .O(z06));
endmodule
