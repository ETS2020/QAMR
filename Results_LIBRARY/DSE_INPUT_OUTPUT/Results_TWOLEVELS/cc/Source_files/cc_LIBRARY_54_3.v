...
module FAU ( 
  ...
  and2   g25(.a(new_n66_), .b(new_n46_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n45_), .O(z12));
  ...
  nand3  g32(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n74_));
  nand3  g33(.a(x10), .b(x08), .c(x03), .O(new_n75_));
  and2   g34(.a(new_n75_), .b(new_n46_), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n45_), .O(z15));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n45_), .O(z17));
  nand2  g44(.a(new_n51_), .b(x19), .O(new_n86_));
  nand3  g45(.a(x10), .b(x08), .c(x06), .O(new_n87_));
  and2   g46(.a(new_n87_), .b(new_n46_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n45_), .O(z18));
  nand2  g48(.a(new_n51_), .b(x20), .O(new_n90_));
