...
module FAU ( 
  ...
  nor2   g19(.a(new_n46_), .b(x03), .O(z06));
  ...
  nor2   g36(.a(new_n77_), .b(new_n46_), .O(new_n78_));
  ...
  nand2  g40(.a(new_n81_), .b(new_n42_), .O(z13));
  nand2  g41(.a(x10), .b(x08), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x15), .c(new_n45_), .O(new_n84_));
  nand3  g43(.a(new_n74_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n70_), .O(z14));
  nand3  g45(.a(x12), .b(x10), .c(x08), .O(new_n87_));
  ...
  oai21  g50(.a(new_n62_), .b(new_n70_), .c(new_n45_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x15), .O(new_n93_));
  nand2  g52(.a(new_n83_), .b(x17), .O(new_n94_));
  ...
  nand2  g60(.a(new_n83_), .b(x18), .O(new_n102_));
  ...
  nand2  g65(.a(new_n83_), .b(x19), .O(new_n107_));
  ...
  nand3  g69(.a(x19), .b(x15), .c(new_n45_), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n70_), .O(z18));
  nand2  g71(.a(new_n83_), .b(x20), .O(new_n113_));
