...
module FAU ( 
  ...
  oai22  g34(.a(new_n75_), .b(new_n74_), .c(new_n48_), .d(new_n73_), .O(new_n76_));
  ...
  oai22  g53(.a(new_n94_), .b(new_n74_), .c(new_n48_), .d(new_n63_), .O(new_n95_));
  ...
  oai22  g59(.a(new_n100_), .b(new_n74_), .c(new_n48_), .d(new_n99_), .O(new_n101_));
  ...
  nand2  g69(.a(new_n110_), .b(new_n59_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
