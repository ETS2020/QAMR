...
module FAU ( 
  ...
  nor2   g20(.a(x16), .b(new_n42_), .O(z06));
  ...
  nand3  g40(.a(new_n81_), .b(new_n43_), .c(x15), .O(new_n82_));
  nand3  g41(.a(new_n72_), .b(x08), .c(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n69_), .O(z14));
  nand3  g43(.a(new_n81_), .b(x16), .c(new_n48_), .O(new_n85_));
  nand3  g44(.a(x10), .b(x08), .c(x03), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(new_n42_), .c(x12), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z15));
  oai21  g48(.a(new_n63_), .b(new_n69_), .c(new_n43_), .O(new_n90_));
  ...
  nand2  g55(.a(new_n81_), .b(x18), .O(new_n97_));
  ...
  nand3  g59(.a(x18), .b(new_n43_), .c(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n69_), .O(z17));
  oai21  g61(.a(new_n60_), .b(new_n69_), .c(new_n43_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x15), .O(new_n104_));
  nand2  g63(.a(new_n81_), .b(x19), .O(new_n105_));
  ...
  nand2  g68(.a(new_n81_), .b(x20), .O(new_n110_));
  ...
  nand3  g72(.a(x20), .b(new_n43_), .c(x15), .O(new_n114_));
