...
module FAU ( 
  ...
  aoi21  g22(.a(new_n43_), .b(x12), .c(new_n46_), .O(z11));
  inv1   g23(.a(x13), .O(new_n65_));
  aoi21  g24(.a(x15), .b(new_n65_), .c(new_n49_), .O(z12));
  nor2   g25(.a(new_n43_), .b(x14), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n53_), .c(new_n49_), .O(z13));
  nand3  g27(.a(x15), .b(x10), .c(x08), .O(new_n69_));
  and2   g28(.a(new_n69_), .b(x12), .O(z14));
  nand4  g29(.a(x16), .b(x15), .c(new_n46_), .d(x12), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z15));
  nand3  g31(.a(x17), .b(x15), .c(x12), .O(new_n73_));
