...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(new_n47_), .c(x07), .O(new_n54_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n58_), .O(z16));
  ...
  oai22  g61(.a(new_n102_), .b(new_n81_), .c(new_n49_), .d(new_n61_), .O(new_n103_));
  ...
  aoi21  g66(.a(new_n48_), .b(new_n43_), .c(x15), .O(new_n108_));
  nor3   g67(.a(new_n108_), .b(new_n107_), .c(new_n58_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
