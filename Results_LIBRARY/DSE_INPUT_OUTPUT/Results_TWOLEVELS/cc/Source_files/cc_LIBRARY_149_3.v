...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(x15), .c(new_n47_), .d(new_n45_), .O(new_n58_));
  ...
  aoi21  g27(.a(x15), .b(x13), .c(new_n47_), .O(z11));
  ...
  nand3  g41(.a(new_n70_), .b(x15), .c(new_n45_), .O(new_n83_));
  inv1   g42(.a(new_n52_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n82_), .O(z14));
  nand2  g45(.a(new_n70_), .b(new_n46_), .O(new_n87_));
  nand2  g46(.a(x15), .b(new_n45_), .O(new_n88_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n82_), .O(z15));
  ...
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n82_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
