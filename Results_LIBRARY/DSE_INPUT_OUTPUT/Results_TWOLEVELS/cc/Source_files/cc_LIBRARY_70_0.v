...
module FAU ( 
  ...
  aoi21  g11(.a(new_n52_), .b(new_n46_), .c(new_n50_), .O(new_n53_));
  nor2   g12(.a(new_n51_), .b(new_n46_), .O(new_n54_));
  oai21  g13(.a(new_n54_), .b(new_n53_), .c(x12), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(x11), .O(z02));
  nand3  g15(.a(new_n47_), .b(new_n46_), .c(x12), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n51_), .O(z03));
  ...
  nand2  g32(.a(new_n51_), .b(x10), .O(new_n74_));
  nand2  g33(.a(x08), .b(x00), .O(new_n75_));
  oai22  g34(.a(new_n75_), .b(new_n74_), .c(new_n47_), .d(new_n73_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x07), .O(new_n77_));
  ...
  oai22  g59(.a(new_n100_), .b(new_n74_), .c(new_n47_), .d(new_n99_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(x07), .O(new_n102_));
  nand2  g61(.a(x18), .b(x15), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n72_), .O(z17));
  ...
  nand2  g70(.a(new_n111_), .b(new_n59_), .O(z19));
  buf    g71(.a(x15), .O(z06));
endmodule
