...
module FAU ( 
  ...
  aoi21  g31(.a(x10), .b(x08), .c(x17), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(x15), .c(x13), .O(new_n74_));
  nand3  g33(.a(new_n44_), .b(new_n51_), .c(x10), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x08), .c(x00), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n56_), .O(z12));
  inv1   g37(.a(x10), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n69_), .c(new_n47_), .O(new_n80_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n56_), .O(z14));
  ...
  nand3  g51(.a(new_n76_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n65_), .c(new_n56_), .O(z16));
  ...
  nand2  g64(.a(new_n57_), .b(x20), .O(new_n106_));
