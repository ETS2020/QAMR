...
module FAU ( 
  ...
  nand2  g27(.a(new_n68_), .b(new_n42_), .O(z09));
  nand3  g28(.a(new_n42_), .b(x09), .c(x08), .O(z10));
  ...
  oai21  g41(.a(new_n82_), .b(new_n51_), .c(new_n47_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n46_), .c(x15), .O(new_n84_));
  ...
  nand3  g46(.a(new_n75_), .b(new_n46_), .c(x15), .O(new_n88_));
  nand4  g47(.a(new_n45_), .b(x10), .c(x08), .d(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n81_), .O(z14));
  nand3  g49(.a(x16), .b(new_n47_), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n46_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x15), .O(new_n93_));
  nand3  g52(.a(new_n75_), .b(x16), .c(new_n47_), .O(new_n94_));
  ...
  oai21  g57(.a(new_n64_), .b(new_n81_), .c(new_n46_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n75_), .b(x17), .O(new_n101_));
  ...
  nand3  g68(.a(new_n46_), .b(x18), .c(x15), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n81_), .O(z17));
  ...
  nand2  g74(.a(new_n115_), .b(new_n42_), .O(z18));
