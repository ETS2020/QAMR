...
module FAU ( 
  ...
  nand3  g20(.a(new_n61_), .b(new_n55_), .c(x12), .O(new_n62_));
  and2   g21(.a(new_n62_), .b(x15), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  nor2   g23(.a(new_n47_), .b(x12), .O(new_n65_));
  ...
  aoi22  g29(.a(x15), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  nor2   g30(.a(new_n65_), .b(new_n50_), .O(z11));
  ...
  nand3  g47(.a(new_n51_), .b(x16), .c(new_n50_), .O(new_n89_));
