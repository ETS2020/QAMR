...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    ...
    new_n59_, new_n61_, new_n63_, new_n66_, new_n68_, new_n72_, new_n73_,
  ...
  nor4   g06(.a(new_n47_), .b(x16), .c(new_n46_), .d(x14), .O(z01));
  ...
  nor2   g22(.a(new_n61_), .b(new_n63_), .O(z05));
  nor2   g23(.a(x16), .b(new_n46_), .O(z06));
  inv1   g24(.a(x17), .O(new_n66_));
  nand2  g25(.a(new_n44_), .b(new_n66_), .O(z07));
  nand3  g26(.a(new_n44_), .b(x09), .c(x08), .O(new_n68_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n51_), .c(new_n75_), .O(new_n77_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n49_), .c(new_n55_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n56_), .c(x15), .O(new_n83_));
  ...
  oai21  g53(.a(new_n66_), .b(new_n80_), .c(new_n56_), .O(new_n95_));
  ...
  nand3  g64(.a(x18), .b(new_n56_), .c(x15), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n80_), .O(z17));
  oai21  g66(.a(new_n63_), .b(new_n80_), .c(new_n56_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n47_), .b(x19), .O(new_n110_));
  ...
  oai21  g73(.a(new_n43_), .b(new_n80_), .c(new_n56_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n47_), .b(x20), .O(new_n117_));
  nand2  g76(.a(x08), .b(x07), .O(new_n118_));
  oai21  g77(.a(new_n118_), .b(new_n51_), .c(new_n117_), .O(new_n119_));
