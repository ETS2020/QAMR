...
module FAU ( 
  ...
  nor2   g17(.a(x18), .b(x12), .O(new_n59_));
  aoi21  g18(.a(new_n59_), .b(x12), .c(new_n46_), .O(z06));
  inv1   g19(.a(x17), .O(new_n61_));
  nor2   g20(.a(new_n55_), .b(new_n61_), .O(z07));
  ...
  nand3  g33(.a(new_n47_), .b(new_n50_), .c(x12), .O(new_n75_));
  ...
  nand4  g50(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  ...
  nand3  g61(.a(new_n87_), .b(x08), .c(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z18));
  nand2  g63(.a(new_n51_), .b(x20), .O(new_n105_));
  nand3  g64(.a(new_n87_), .b(x08), .c(x07), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n43_), .O(z19));
  nor4   g66(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
