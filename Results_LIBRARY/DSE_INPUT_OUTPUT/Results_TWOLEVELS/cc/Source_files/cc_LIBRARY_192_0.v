...
module FAU ( 
  ...
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n50_), .O(z14));
  ...
  aoi21  g55(.a(new_n56_), .b(x18), .c(new_n96_), .O(new_n97_));
  nand3  g56(.a(x18), .b(x15), .c(x12), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(x15), .c(new_n98_), .O(z17));
  nand2  g58(.a(new_n52_), .b(x19), .O(new_n100_));
  nand3  g59(.a(new_n84_), .b(x08), .c(x06), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n50_), .O(z18));
