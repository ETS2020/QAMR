...
module FAU ( 
  ...
  nor2   g02(.a(x19), .b(x12), .O(new_n44_));
  ...
  nand2  g22(.a(x10), .b(new_n63_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n63_), .c(x12), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n59_), .c(new_n51_), .O(z06));
  ...
  nor3   g29(.a(new_n44_), .b(new_n60_), .c(new_n63_), .O(z09));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n74_), .O(z16));
  and2   g53(.a(x08), .b(x05), .O(new_n95_));
  aoi22  g54(.a(new_n95_), .b(new_n77_), .c(new_n52_), .d(x18), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n74_), .c(new_n46_), .O(z17));
  nand2  g56(.a(new_n52_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n77_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n74_), .O(z18));
  nand2  g59(.a(new_n52_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n77_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n74_), .O(z19));
endmodule
