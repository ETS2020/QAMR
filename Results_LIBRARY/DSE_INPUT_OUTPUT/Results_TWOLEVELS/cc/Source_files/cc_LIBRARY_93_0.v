...
module FAU ( 
  ...
  nand2  g31(.a(new_n51_), .b(x10), .O(new_n73_));
  nor2   g32(.a(x15), .b(x08), .O(new_n74_));
  aoi21  g33(.a(new_n73_), .b(x12), .c(new_n74_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x00), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n51_), .O(new_n78_));
  oai21  g37(.a(new_n75_), .b(new_n72_), .c(new_n78_), .O(z12));
  nand3  g38(.a(x10), .b(x08), .c(x01), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x14), .O(new_n81_));
  nand3  g40(.a(x15), .b(x10), .c(x08), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n81_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n44_), .O(z13));
  nand3  g44(.a(new_n57_), .b(x15), .c(x12), .O(new_n86_));
  inv1   g45(.a(x02), .O(new_n87_));
  oai21  g46(.a(new_n57_), .b(new_n87_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n51_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n86_), .O(z14));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n91_), .c(new_n56_), .O(z15));
  inv1   g54(.a(x04), .O(new_n96_));
  oai21  g55(.a(new_n57_), .b(new_n96_), .c(x12), .O(new_n97_));
  ...
  oai21  g63(.a(new_n75_), .b(new_n101_), .c(new_n104_), .O(z17));
  nand2  g64(.a(new_n52_), .b(x19), .O(new_n106_));
  nand3  g65(.a(new_n93_), .b(x08), .c(x06), .O(new_n107_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n56_), .O(z19));
endmodule
