...
module FAU ( 
  ...
  nand2  g31(.a(new_n44_), .b(new_n46_), .O(z11));
  ...
  nand4  g51(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(z15));
  inv1   g53(.a(x12), .O(new_n95_));
  nand2  g54(.a(new_n52_), .b(x17), .O(new_n96_));
  inv1   g55(.a(x10), .O(new_n97_));
  nor2   g56(.a(x15), .b(new_n97_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(x08), .c(x04), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n96_), .c(new_n95_), .O(z16));
  inv1   g59(.a(x05), .O(new_n101_));
  oai21  g60(.a(new_n56_), .b(new_n101_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n51_), .O(new_n103_));
  nand3  g62(.a(new_n52_), .b(x18), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(z17));
  inv1   g64(.a(x06), .O(new_n106_));
  oai21  g65(.a(new_n56_), .b(new_n106_), .c(x12), .O(new_n107_));
  ...
  nand2  g69(.a(new_n52_), .b(x20), .O(new_n111_));
  nand3  g70(.a(new_n98_), .b(x08), .c(x07), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n95_), .O(z19));
endmodule
