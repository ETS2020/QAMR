...
module FAU ( 
  ...
  oai21  g12(.a(new_n44_), .b(new_n47_), .c(new_n53_), .O(new_n54_));
  ...
  nand2  g31(.a(new_n43_), .b(x00), .O(new_n73_));
  ...
  nor2   g39(.a(new_n80_), .b(new_n43_), .O(new_n81_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n71_), .c(new_n45_), .O(z13));
  nand4  g44(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n86_));
  oai21  g45(.a(new_n49_), .b(new_n43_), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n45_), .O(z14));
  nand2  g48(.a(x15), .b(x13), .O(new_n90_));
  oai21  g49(.a(new_n49_), .b(x15), .c(new_n90_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x16), .c(new_n47_), .O(new_n92_));
  nand4  g51(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n71_), .O(z15));
  inv1   g53(.a(x04), .O(new_n95_));
  nand2  g54(.a(new_n48_), .b(x17), .O(new_n96_));
  oai21  g55(.a(new_n48_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n71_), .O(z17));
  oai21  g65(.a(new_n60_), .b(new_n71_), .c(x13), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand4  g67(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n109_));
  oai21  g68(.a(new_n49_), .b(new_n60_), .c(new_n109_), .O(new_n110_));
  ...
  nand3  g75(.a(x20), .b(x15), .c(x13), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n71_), .O(z19));
  buf    g77(.a(x15), .O(z06));
endmodule
