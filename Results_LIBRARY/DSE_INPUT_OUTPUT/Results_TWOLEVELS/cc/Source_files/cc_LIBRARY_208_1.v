...
module FAU ( 
  ...
  nand4  g11(.a(new_n43_), .b(new_n52_), .c(x10), .d(x08), .O(new_n53_));
  oai21  g12(.a(new_n44_), .b(new_n48_), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g34(.a(new_n52_), .b(x10), .c(x08), .O(new_n76_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n69_), .c(new_n48_), .O(new_n81_));
  ...
  nand4  g52(.a(new_n76_), .b(x16), .c(new_n48_), .d(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(z15));
  nor2   g54(.a(x17), .b(x15), .O(new_n96_));
  nand4  g55(.a(new_n96_), .b(x10), .c(x08), .d(x04), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n65_), .c(new_n79_), .O(z16));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n79_), .O(z19));
endmodule
