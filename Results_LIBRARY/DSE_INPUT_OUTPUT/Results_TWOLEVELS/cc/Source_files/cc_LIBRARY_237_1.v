...
module FAU ( 
  ...
  oai21  g33(.a(new_n70_), .b(new_n74_), .c(new_n47_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x15), .O(new_n76_));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n55_), .b(new_n77_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n76_), .c(new_n43_), .O(z13));
  nand2  g38(.a(x15), .b(new_n74_), .O(new_n80_));
  ...
  nand4  g59(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n101_));
  ...
  oai21  g63(.a(x19), .b(new_n43_), .c(x15), .O(new_n105_));
  nand2  g64(.a(new_n55_), .b(x19), .O(new_n106_));
  ...
  nand3  g70(.a(new_n71_), .b(x08), .c(x07), .O(new_n112_));
