...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n56_, new_n59_, new_n63_, new_n64_, new_n65_, new_n66_,
  ...
  aoi21  g31(.a(new_n72_), .b(new_n45_), .c(new_n68_), .O(z14));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n74_), .c(new_n68_), .O(z15));
  nand2  g36(.a(new_n46_), .b(x17), .O(new_n78_));
  nand3  g37(.a(x10), .b(x08), .c(x04), .O(new_n79_));
  and2   g38(.a(new_n79_), .b(new_n45_), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n68_), .O(z16));
  nand2  g40(.a(new_n46_), .b(x18), .O(new_n82_));
