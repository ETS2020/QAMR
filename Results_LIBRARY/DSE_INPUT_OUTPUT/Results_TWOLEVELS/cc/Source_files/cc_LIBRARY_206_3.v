...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n60_, new_n64_, new_n65_, new_n66_, new_n68_,
  ...
  nand2  g22(.a(x10), .b(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(x13), .O(new_n65_));
  aoi21  g24(.a(new_n51_), .b(x00), .c(x15), .O(new_n66_));
  aoi21  g25(.a(new_n66_), .b(new_n65_), .c(new_n45_), .O(z12));
  inv1   g26(.a(x01), .O(new_n68_));
  oai21  g27(.a(new_n64_), .b(new_n68_), .c(x14), .O(new_n69_));
  aoi21  g28(.a(new_n69_), .b(new_n46_), .c(new_n45_), .O(z13));
  nand2  g29(.a(new_n51_), .b(x02), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n46_), .c(new_n45_), .O(z14));
  nand3  g31(.a(new_n64_), .b(x16), .c(new_n47_), .O(new_n73_));
  ...
  nand2  g36(.a(new_n64_), .b(x17), .O(new_n78_));
  ...
  nand2  g41(.a(new_n64_), .b(x18), .O(new_n83_));
  ...
  nand2  g46(.a(new_n64_), .b(x19), .O(new_n88_));
  aoi21  g47(.a(new_n51_), .b(x06), .c(x15), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n45_), .O(z18));
  nand2  g49(.a(new_n64_), .b(x20), .O(new_n91_));
  aoi21  g50(.a(new_n51_), .b(x07), .c(x15), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n45_), .O(z19));
endmodule
