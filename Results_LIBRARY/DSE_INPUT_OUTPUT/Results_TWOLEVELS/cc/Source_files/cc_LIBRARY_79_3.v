...
module FAU ( 
  ...
  aoi21  g16(.a(x15), .b(x06), .c(x18), .O(z04));
  ...
  nand2  g48(.a(new_n72_), .b(new_n46_), .O(new_n90_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n89_), .O(z15));
  ...
  nand3  g57(.a(x17), .b(x15), .c(new_n45_), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n89_), .O(z16));
  nand2  g59(.a(new_n72_), .b(x18), .O(new_n101_));
  ...
  nand3  g63(.a(x18), .b(x15), .c(new_n45_), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n89_), .O(z17));
  nand3  g65(.a(x12), .b(x10), .c(x08), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n46_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x06), .O(new_n109_));
  nand3  g68(.a(new_n52_), .b(x19), .c(x12), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n109_), .O(z18));
  nand2  g70(.a(new_n72_), .b(x20), .O(new_n112_));
  ...
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n89_), .O(z19));
endmodule
