...
module FAU ( 
  ...
  nand3  g34(.a(x18), .b(new_n52_), .c(x10), .O(new_n76_));
  ...
  nand3  g50(.a(new_n52_), .b(x10), .c(x08), .O(new_n92_));
  ...
  nand3  g63(.a(new_n92_), .b(x19), .c(x12), .O(new_n105_));
  ...
  nand3  g68(.a(new_n92_), .b(x20), .c(x12), .O(new_n110_));
