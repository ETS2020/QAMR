...
module FAU ( 
  ...
  nor2   g02(.a(x12), .b(x02), .O(new_n44_));
  ...
  nand3  g49(.a(new_n72_), .b(x08), .c(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n70_), .O(z16));
  and2   g51(.a(x08), .b(x05), .O(new_n93_));
  aoi22  g52(.a(new_n93_), .b(new_n72_), .c(new_n52_), .d(x18), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n70_), .c(new_n48_), .O(z17));
  nand2  g54(.a(new_n52_), .b(x19), .O(new_n96_));
  nand3  g55(.a(new_n72_), .b(x08), .c(x06), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n70_), .O(z18));
  nand2  g57(.a(new_n52_), .b(x20), .O(new_n99_));
  nand3  g58(.a(new_n72_), .b(x08), .c(x07), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n70_), .O(z19));
endmodule
