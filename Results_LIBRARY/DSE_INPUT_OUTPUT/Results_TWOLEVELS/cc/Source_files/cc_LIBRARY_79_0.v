...
module FAU ( 
  ...
  oai22  g42(.a(new_n83_), .b(new_n82_), .c(new_n78_), .d(new_n52_), .O(new_n84_));
  ...
  oai22  g53(.a(new_n94_), .b(new_n82_), .c(new_n78_), .d(new_n63_), .O(new_n95_));
