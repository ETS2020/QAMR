...
module FAU ( 
  ...
  oai21  g53(.a(new_n61_), .b(new_n77_), .c(new_n44_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n51_), .O(new_n96_));
  oai21  g55(.a(x15), .b(new_n71_), .c(x17), .O(new_n97_));
  ...
  oai21  g63(.a(x15), .b(new_n71_), .c(x18), .O(new_n105_));
  ...
  oai21  g69(.a(new_n59_), .b(x08), .c(new_n110_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n44_), .O(new_n112_));
  nand3  g71(.a(new_n52_), .b(x19), .c(x08), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n77_), .O(z18));
  oai21  g73(.a(new_n43_), .b(new_n77_), .c(new_n44_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(new_n51_), .O(new_n116_));
  oai21  g75(.a(x15), .b(new_n71_), .c(x20), .O(new_n117_));
