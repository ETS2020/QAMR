...
module FAU ( 
  ...
  oai21  g34(.a(new_n56_), .b(new_n75_), .c(x14), .O(new_n76_));
  ...
  nand3  g41(.a(new_n72_), .b(x08), .c(x03), .O(new_n83_));
  ...
  nand3  g49(.a(new_n72_), .b(x08), .c(x05), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n55_), .O(z17));
  nand2  g51(.a(new_n51_), .b(x19), .O(new_n93_));
  nand3  g52(.a(new_n72_), .b(x08), .c(x06), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n55_), .O(z18));
  nand2  g54(.a(new_n50_), .b(x10), .O(new_n96_));
  ...
  oai21  g60(.a(new_n98_), .b(new_n43_), .c(new_n101_), .O(z19));
endmodule
