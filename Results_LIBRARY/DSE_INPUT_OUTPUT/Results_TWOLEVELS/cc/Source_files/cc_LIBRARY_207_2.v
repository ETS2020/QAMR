...
module FAU ( 
  ...
  aoi21  g27(.a(new_n43_), .b(x02), .c(new_n48_), .O(z11));
  ...
  nand2  g39(.a(new_n52_), .b(x12), .O(new_n81_));
  ...
  nand3  g44(.a(new_n71_), .b(x08), .c(x03), .O(new_n86_));
  ...
  aoi22  g50(.a(new_n91_), .b(new_n71_), .c(new_n52_), .d(x18), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n43_), .c(new_n44_), .O(z17));
  nand2  g52(.a(new_n52_), .b(x19), .O(new_n94_));
  nand3  g53(.a(new_n71_), .b(x08), .c(x06), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n43_), .O(z18));
  nand2  g55(.a(new_n52_), .b(x20), .O(new_n97_));
  nand3  g56(.a(new_n71_), .b(x08), .c(x07), .O(new_n98_));
