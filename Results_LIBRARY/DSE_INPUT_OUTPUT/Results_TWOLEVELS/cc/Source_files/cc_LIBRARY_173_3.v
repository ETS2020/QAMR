...
module FAU ( 
  ...
  aoi21  g20(.a(new_n61_), .b(new_n45_), .c(new_n46_), .O(z06));
  ...
  nand4  g36(.a(new_n77_), .b(new_n46_), .c(x14), .d(x12), .O(new_n78_));
  ...
  and2   g52(.a(new_n93_), .b(new_n46_), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n45_), .O(z17));
  nand2  g54(.a(new_n51_), .b(x19), .O(new_n96_));
  nand3  g55(.a(x10), .b(x08), .c(x06), .O(new_n97_));
  ...
  nand3  g60(.a(x10), .b(x08), .c(x07), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand3  g62(.a(new_n103_), .b(new_n46_), .c(x12), .O(new_n104_));
