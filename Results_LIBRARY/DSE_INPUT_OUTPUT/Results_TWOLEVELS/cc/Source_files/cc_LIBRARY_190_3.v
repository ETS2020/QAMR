...
module FAU ( 
  ...
  nor2   g11(.a(new_n42_), .b(new_n47_), .O(new_n53_));
  inv1   g12(.a(new_n53_), .O(new_n54_));
  nand2  g13(.a(new_n54_), .b(new_n52_), .O(z02));
  inv1   g14(.a(new_n45_), .O(new_n56_));
  nand4  g15(.a(new_n56_), .b(new_n49_), .c(x12), .d(new_n47_), .O(new_n57_));
  nor2   g16(.a(new_n57_), .b(new_n42_), .O(z03));
  nor2   g17(.a(new_n53_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nand2  g19(.a(new_n54_), .b(new_n60_), .O(z05));
  ...
  nand2  g48(.a(new_n45_), .b(new_n42_), .O(new_n90_));
  nand2  g49(.a(x15), .b(new_n47_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x16), .c(new_n49_), .O(new_n93_));
  nand4  g52(.a(new_n42_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n89_), .O(z15));
  oai21  g54(.a(new_n62_), .b(new_n89_), .c(new_n47_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x15), .O(new_n97_));
  nand2  g56(.a(new_n45_), .b(x17), .O(new_n98_));
  nand2  g57(.a(x08), .b(x04), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n50_), .c(new_n98_), .O(new_n100_));
  ...
  nand2  g69(.a(new_n45_), .b(x19), .O(new_n111_));
  ...
  nand3  g73(.a(x19), .b(x15), .c(new_n47_), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n89_), .O(z18));
  ...
  oai21  g80(.a(new_n121_), .b(new_n50_), .c(new_n120_), .O(new_n122_));
