...
module FAU ( 
  ...
  oai21  g29(.a(new_n55_), .b(new_n70_), .c(x12), .O(new_n71_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n75_), .O(z14));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n75_), .O(z17));
  ...
  nand3  g64(.a(new_n51_), .b(x20), .c(x12), .O(new_n106_));
