...
module FAU ( 
  ...
  nor3   g26(.a(new_n58_), .b(new_n67_), .c(new_n66_), .O(z09));
  inv1   g27(.a(new_n58_), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x09), .c(x08), .O(z10));
  nand2  g29(.a(new_n69_), .b(new_n45_), .O(z11));
  ...
  oai21  g36(.a(new_n77_), .b(new_n66_), .c(new_n45_), .O(new_n78_));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n54_), .O(z13));
  ...
  nand3  g44(.a(new_n73_), .b(x16), .c(new_n45_), .O(new_n86_));
  nand4  g45(.a(new_n49_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n54_), .O(z15));
  nand4  g47(.a(x12), .b(x10), .c(x08), .d(x04), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n43_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n55_), .O(new_n91_));
  nand3  g50(.a(new_n55_), .b(x10), .c(x08), .O(new_n92_));
  ...
  nand3  g61(.a(new_n92_), .b(x19), .c(x12), .O(new_n103_));
