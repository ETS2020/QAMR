...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n52_, new_n54_, new_n57_, new_n59_, new_n60_, new_n61_,
  ...
  aoi21  g13(.a(new_n54_), .b(x15), .c(x14), .O(z03));
  ...
  oai21  g21(.a(new_n62_), .b(new_n59_), .c(new_n44_), .O(z06));
  ...
  nand3  g33(.a(new_n59_), .b(x10), .c(x08), .O(new_n75_));
  ...
  oai21  g42(.a(new_n48_), .b(new_n59_), .c(new_n83_), .O(new_n84_));
  ...
  nand4  g50(.a(new_n59_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  ...
  nand4  g56(.a(new_n59_), .b(x10), .c(x08), .d(x05), .O(new_n98_));
  ...
  nand2  g63(.a(new_n104_), .b(new_n59_), .O(new_n105_));
  ...
  nand4  g67(.a(new_n59_), .b(x10), .c(x08), .d(x07), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x14), .O(new_n111_));
