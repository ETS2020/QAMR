...
module FAU ( 
  ...
  nor2   g08(.a(new_n49_), .b(new_n43_), .O(new_n50_));
  nand3  g09(.a(new_n50_), .b(new_n48_), .c(x10), .O(new_n51_));
  nor2   g10(.a(new_n51_), .b(new_n47_), .O(z01));
  oai21  g11(.a(new_n47_), .b(x03), .c(x14), .O(new_n53_));
  ...
  nand4  g16(.a(new_n50_), .b(new_n48_), .c(x12), .d(x10), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x03), .c(new_n47_), .O(z03));
  ...
  nor2   g26(.a(new_n67_), .b(new_n49_), .O(z09));
  ...
  oai21  g40(.a(new_n81_), .b(new_n49_), .c(new_n48_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x15), .c(x03), .O(new_n83_));
  ...
  nand3  g45(.a(new_n74_), .b(x15), .c(x03), .O(new_n87_));
  ...
  nand4  g51(.a(new_n74_), .b(x16), .c(new_n47_), .d(new_n48_), .O(new_n93_));
  ...
  nand3  g57(.a(x17), .b(x15), .c(x03), .O(new_n99_));
  ...
  oai21  g67(.a(new_n61_), .b(new_n80_), .c(x03), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n74_), .b(x19), .O(new_n111_));
  ...
  nand2  g75(.a(new_n116_), .b(x03), .O(new_n117_));
