...
module FAU ( 
  ...
  oai21  g10(.a(new_n51_), .b(x15), .c(x14), .O(new_n52_));
  ...
  nor2   g19(.a(new_n51_), .b(new_n43_), .O(z05));
  ...
  nand3  g31(.a(new_n43_), .b(x10), .c(x08), .O(new_n73_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n48_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x15), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(x01), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n51_), .c(x14), .O(new_n81_));
  ...
  nand4  g47(.a(new_n73_), .b(x16), .c(new_n48_), .d(x12), .O(new_n89_));
  ...
  oai21  g55(.a(new_n96_), .b(x15), .c(x18), .O(new_n97_));
  nand4  g56(.a(new_n53_), .b(x10), .c(x08), .d(x05), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n58_), .O(z17));
  nand4  g58(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n100_));
  ...
  nand3  g65(.a(new_n73_), .b(x20), .c(x12), .O(new_n107_));
