...
module FAU ( 
  ...
  or2    g31(.a(new_n72_), .b(new_n50_), .O(new_n73_));
  nand3  g32(.a(x10), .b(x08), .c(x01), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(x19), .c(x14), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n71_), .O(z13));
  ...
  nand3  g48(.a(new_n51_), .b(x17), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(z16));
  nand2  g50(.a(new_n46_), .b(x19), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n50_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x18), .O(new_n94_));
  and2   g53(.a(x08), .b(x05), .O(new_n95_));
  nand4  g54(.a(new_n95_), .b(x19), .c(new_n50_), .d(x10), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n94_), .c(new_n71_), .O(z17));
  ...
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(z18));
