...
module FAU ( 
  ...
  nand2  g18(.a(new_n49_), .b(x07), .O(z06));
  ...
  nor2   g36(.a(new_n77_), .b(new_n49_), .O(new_n78_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n70_), .O(z14));
  ...
  nand4  g51(.a(new_n49_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  ...
  oai21  g66(.a(new_n84_), .b(x20), .c(x12), .O(new_n108_));
