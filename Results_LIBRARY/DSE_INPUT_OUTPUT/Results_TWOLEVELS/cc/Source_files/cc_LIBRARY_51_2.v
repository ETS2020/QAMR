...
module FAU ( 
  ...
  nand2  g22(.a(new_n59_), .b(new_n43_), .O(z06));
  ...
  aoi21  g33(.a(new_n74_), .b(new_n73_), .c(new_n58_), .O(z12));
  aoi21  g34(.a(new_n48_), .b(x15), .c(x14), .O(new_n76_));
  oai21  g35(.a(new_n76_), .b(new_n58_), .c(new_n45_), .O(z13));
  nand4  g36(.a(new_n59_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  oai21  g37(.a(new_n48_), .b(new_n59_), .c(new_n78_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n45_), .O(z14));
  nand3  g40(.a(new_n59_), .b(x10), .c(x08), .O(new_n82_));
  ...
  nand3  g44(.a(new_n85_), .b(new_n43_), .c(x12), .O(new_n86_));
  ...
  nand3  g49(.a(new_n82_), .b(x17), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(z16));
  nand2  g51(.a(new_n47_), .b(x18), .O(new_n93_));
  nand4  g52(.a(new_n59_), .b(x10), .c(x08), .d(x05), .O(new_n94_));
  ...
  nand4  g58(.a(new_n59_), .b(x10), .c(x08), .d(x06), .O(new_n100_));
  ...
  nand4  g64(.a(new_n59_), .b(x10), .c(x08), .d(x07), .O(new_n106_));
