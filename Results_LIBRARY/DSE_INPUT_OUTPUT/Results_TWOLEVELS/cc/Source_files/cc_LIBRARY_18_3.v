...
module FAU ( 
  ...
  nand2  g22(.a(x15), .b(x12), .O(new_n65_));
  nand3  g23(.a(new_n65_), .b(x09), .c(x08), .O(new_n66_));
  inv1   g24(.a(new_n66_), .O(z09));
  aoi22  g25(.a(x15), .b(x12), .c(x09), .d(x08), .O(z10));
  nand2  g26(.a(new_n43_), .b(new_n47_), .O(z11));
  nand2  g27(.a(new_n51_), .b(x13), .O(new_n70_));
  nand3  g28(.a(x10), .b(x08), .c(x00), .O(new_n71_));
  and2   g29(.a(new_n71_), .b(new_n46_), .O(new_n72_));
  aoi21  g30(.a(new_n72_), .b(new_n70_), .c(new_n45_), .O(z12));
  nand3  g31(.a(x10), .b(x08), .c(x01), .O(new_n74_));
  nand4  g32(.a(new_n74_), .b(new_n46_), .c(x14), .d(x12), .O(new_n75_));
  inv1   g33(.a(new_n75_), .O(z13));
  ...
  aoi21  g39(.a(new_n81_), .b(new_n79_), .c(new_n45_), .O(z15));
  nand2  g40(.a(new_n51_), .b(x17), .O(new_n83_));
  nand3  g41(.a(x10), .b(x08), .c(x04), .O(new_n84_));
  and2   g42(.a(new_n84_), .b(new_n46_), .O(new_n85_));
  aoi21  g43(.a(new_n85_), .b(new_n83_), .c(new_n45_), .O(z16));
  nand2  g44(.a(new_n51_), .b(x18), .O(new_n87_));
  nand3  g45(.a(x10), .b(x08), .c(x05), .O(new_n88_));
  and2   g46(.a(new_n88_), .b(new_n46_), .O(new_n89_));
  aoi21  g47(.a(new_n89_), .b(new_n87_), .c(new_n45_), .O(z17));
  nand2  g48(.a(new_n51_), .b(x19), .O(new_n91_));
  nand3  g49(.a(x10), .b(x08), .c(x06), .O(new_n92_));
  nand2  g50(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g51(.a(new_n93_), .b(new_n46_), .c(x12), .O(new_n94_));
  inv1   g52(.a(new_n94_), .O(z18));
