...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(new_n47_), .c(x07), .O(new_n51_));
  ...
  nand4  g49(.a(new_n43_), .b(x10), .c(x08), .d(x04), .O(new_n91_));
  ...
  nand4  g60(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n102_));
  oai21  g61(.a(new_n78_), .b(new_n58_), .c(new_n102_), .O(new_n103_));
  ...
  aoi21  g66(.a(new_n46_), .b(new_n60_), .c(x15), .O(new_n108_));
  nor3   g67(.a(new_n108_), .b(new_n107_), .c(new_n75_), .O(z19));
endmodule
