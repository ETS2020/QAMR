...
module FAU ( 
  ...
  nor2   g27(.a(new_n47_), .b(x12), .O(new_n69_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n60_), .c(new_n50_), .O(new_n80_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(z14));
  ...
  oai21  g65(.a(x19), .b(new_n43_), .c(x15), .O(new_n107_));
  ...
  oai21  g71(.a(x20), .b(new_n43_), .c(x15), .O(new_n113_));
  nand2  g72(.a(new_n48_), .b(x20), .O(new_n114_));
  nand4  g73(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n115_));
