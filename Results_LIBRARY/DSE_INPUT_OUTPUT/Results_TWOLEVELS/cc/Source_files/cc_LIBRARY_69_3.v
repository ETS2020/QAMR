...
module FAU ( 
  ...
  nor2   g22(.a(x16), .b(new_n42_), .O(z06));
  ...
  nand3  g53(.a(x17), .b(new_n43_), .c(x15), .O(new_n95_));
  ...
  nand2  g58(.a(new_n57_), .b(x18), .O(new_n100_));
  ...
  nand2  g66(.a(new_n107_), .b(new_n42_), .O(new_n108_));
  nand3  g67(.a(x19), .b(new_n43_), .c(x15), .O(new_n109_));
