...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n56_, new_n57_, new_n62_,
  ...
  nor2   g18(.a(new_n45_), .b(x15), .O(z05));
  nor2   g19(.a(x19), .b(new_n44_), .O(z06));
  ...
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n49_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n45_), .c(x15), .O(new_n83_));
  ...
  nand3  g50(.a(x16), .b(new_n49_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n45_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x15), .O(new_n94_));
  nand3  g53(.a(new_n73_), .b(x16), .c(new_n49_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n62_), .b(new_n79_), .c(new_n45_), .O(new_n100_));
  ...
  nand3  g69(.a(new_n45_), .b(x18), .c(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n79_), .O(z17));
  ...
  nand2  g75(.a(new_n116_), .b(new_n47_), .O(z18));
  oai21  g76(.a(new_n43_), .b(new_n79_), .c(new_n45_), .O(new_n118_));
