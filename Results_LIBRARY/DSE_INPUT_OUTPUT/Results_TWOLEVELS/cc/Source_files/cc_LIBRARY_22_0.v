...
module FAU ( 
  ...
  nand2  g19(.a(new_n44_), .b(x06), .O(z06));
  ...
  nand4  g51(.a(new_n51_), .b(x16), .c(new_n48_), .d(x12), .O(new_n93_));
  ...
  nand3  g61(.a(new_n51_), .b(x18), .c(x12), .O(new_n103_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n72_), .O(z18));
  nand2  g67(.a(new_n47_), .b(x20), .O(new_n109_));
  nand2  g68(.a(x08), .b(x07), .O(new_n110_));
  oai21  g69(.a(new_n110_), .b(new_n85_), .c(new_n109_), .O(new_n111_));
