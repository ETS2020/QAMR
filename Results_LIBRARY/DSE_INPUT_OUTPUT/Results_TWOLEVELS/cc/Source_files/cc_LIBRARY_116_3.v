...
module FAU ( 
  ...
  nand3  g40(.a(new_n81_), .b(x15), .c(new_n44_), .O(new_n82_));
  ...
  nand2  g44(.a(new_n72_), .b(x15), .O(new_n86_));
  ...
  nand3  g49(.a(x16), .b(new_n51_), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n44_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x15), .O(new_n93_));
  nand3  g52(.a(new_n72_), .b(x16), .c(new_n51_), .O(new_n94_));
  ...
  oai21  g57(.a(new_n61_), .b(new_n78_), .c(new_n44_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n72_), .b(x17), .O(new_n101_));
  nand4  g60(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n102_));
  ...
  nand3  g68(.a(x18), .b(x15), .c(new_n44_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n78_), .O(z17));
  nand2  g70(.a(new_n72_), .b(x19), .O(new_n112_));
  ...
  nand3  g74(.a(x19), .b(x15), .c(new_n44_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n78_), .O(z18));
  oai21  g76(.a(new_n43_), .b(new_n78_), .c(new_n44_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n72_), .b(x20), .O(new_n120_));
  nand4  g79(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n121_));
