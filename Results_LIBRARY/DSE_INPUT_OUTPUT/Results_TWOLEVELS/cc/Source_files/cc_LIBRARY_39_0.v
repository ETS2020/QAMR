...
module FAU ( 
  ...
  nand2  g04(.a(new_n45_), .b(x20), .O(new_n46_));
  nor2   g05(.a(new_n46_), .b(new_n42_), .O(z00));
  nand2  g06(.a(x10), .b(x08), .O(new_n48_));
  inv1   g07(.a(x14), .O(new_n49_));
  nand2  g08(.a(x15), .b(new_n49_), .O(new_n50_));
  oai21  g09(.a(new_n50_), .b(new_n48_), .c(new_n45_), .O(z01));
  oai21  g10(.a(x19), .b(x15), .c(x14), .O(new_n52_));
  nand2  g11(.a(x19), .b(new_n43_), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(new_n48_), .c(new_n52_), .O(new_n54_));
  nand3  g13(.a(new_n54_), .b(x12), .c(new_n42_), .O(new_n55_));
  inv1   g14(.a(new_n55_), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  nor4   g16(.a(new_n48_), .b(new_n43_), .c(x14), .d(new_n57_), .O(z03));
  ...
  nand4  g45(.a(new_n71_), .b(x16), .c(new_n49_), .d(x12), .O(new_n87_));
