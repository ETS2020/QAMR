...
module FAU ( 
  ...
  inv1   g19(.a(x18), .O(new_n61_));
  nor2   g20(.a(new_n61_), .b(x12), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(x12), .c(new_n49_), .O(z06));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n82_), .O(z14));
  nand3  g46(.a(new_n50_), .b(x16), .c(new_n46_), .O(new_n88_));
  nand3  g47(.a(new_n85_), .b(x08), .c(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n82_), .O(z15));
  inv1   g49(.a(x04), .O(new_n91_));
  oai21  g50(.a(new_n55_), .b(new_n91_), .c(x12), .O(new_n92_));
  ...
  aoi21  g54(.a(new_n49_), .b(x08), .c(new_n82_), .O(new_n96_));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n82_), .O(z18));
