...
module FAU ( 
  ...
  nand4  g06(.a(new_n47_), .b(x10), .c(new_n46_), .d(x08), .O(new_n48_));
  ...
  and2   g19(.a(new_n42_), .b(x19), .O(z05));
  ...
  aoi21  g25(.a(x15), .b(x09), .c(new_n47_), .O(z11));
  inv1   g26(.a(x12), .O(new_n68_));
  nand2  g27(.a(new_n56_), .b(new_n45_), .O(new_n69_));
  nand2  g28(.a(x15), .b(new_n46_), .O(new_n70_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n52_), .c(new_n82_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n42_), .O(z14));
  nand3  g45(.a(new_n71_), .b(x16), .c(new_n47_), .O(new_n87_));
  nand3  g46(.a(new_n73_), .b(x08), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n68_), .O(z15));
  nand2  g48(.a(new_n56_), .b(x17), .O(new_n90_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n68_), .O(z17));
