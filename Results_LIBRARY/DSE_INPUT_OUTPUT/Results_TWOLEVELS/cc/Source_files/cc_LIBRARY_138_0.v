...
module FAU ( 
  ...
  nand3  g38(.a(new_n79_), .b(x14), .c(x13), .O(new_n80_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n58_), .O(z14));
  ...
  oai21  g51(.a(new_n78_), .b(new_n64_), .c(new_n92_), .O(new_n93_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n58_), .O(z17));
