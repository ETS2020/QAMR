...
module FAU ( 
  ...
  nor2   g33(.a(new_n74_), .b(new_n48_), .O(new_n75_));
  ...
  nand2  g37(.a(new_n78_), .b(new_n53_), .O(z13));
  inv1   g38(.a(x12), .O(new_n80_));
  nand2  g39(.a(new_n55_), .b(x15), .O(new_n81_));
  nand3  g40(.a(new_n43_), .b(new_n48_), .c(x10), .O(new_n82_));
  ...
  nand2  g46(.a(new_n87_), .b(new_n48_), .O(new_n88_));
  nand4  g47(.a(new_n49_), .b(x16), .c(new_n45_), .d(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(z15));
  aoi21  g49(.a(x10), .b(x08), .c(x20), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(x15), .c(x17), .O(new_n92_));
  nand3  g51(.a(new_n83_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n80_), .O(z16));
  oai21  g53(.a(new_n91_), .b(x15), .c(x18), .O(new_n95_));
  nand3  g54(.a(new_n83_), .b(x08), .c(x05), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n80_), .O(z17));
  oai21  g56(.a(new_n91_), .b(x15), .c(x19), .O(new_n98_));
  nand3  g57(.a(new_n83_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n80_), .O(z18));
  ...
  nand2  g62(.a(new_n103_), .b(new_n53_), .O(z19));
  buf    g63(.a(x15), .O(z06));
endmodule
