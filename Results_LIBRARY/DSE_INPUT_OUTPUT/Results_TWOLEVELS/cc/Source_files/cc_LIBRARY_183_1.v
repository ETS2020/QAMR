...
module FAU ( 
  ...
  nand2  g39(.a(new_n49_), .b(new_n48_), .O(new_n81_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n44_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n61_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x16), .c(new_n48_), .O(new_n93_));
  nand4  g52(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n80_), .O(z15));
  ...
  nand3  g58(.a(x17), .b(x15), .c(x07), .O(new_n100_));
  ...
  nand3  g76(.a(new_n74_), .b(x20), .c(new_n44_), .O(new_n118_));
