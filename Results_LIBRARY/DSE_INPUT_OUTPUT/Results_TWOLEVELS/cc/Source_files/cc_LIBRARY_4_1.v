...
module FAU ( 
  ...
  aoi21  g22(.a(new_n63_), .b(x12), .c(new_n47_), .O(z06));
  ...
  oai21  g35(.a(new_n73_), .b(new_n61_), .c(new_n48_), .O(new_n77_));
  ...
  nand3  g62(.a(new_n74_), .b(x08), .c(x06), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n43_), .O(z18));
  nand2  g64(.a(new_n51_), .b(x20), .O(new_n106_));
  nand3  g65(.a(new_n74_), .b(x08), .c(x07), .O(new_n107_));
