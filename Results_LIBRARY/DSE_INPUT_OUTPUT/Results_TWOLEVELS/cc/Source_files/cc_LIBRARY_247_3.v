...
module FAU ( 
  ...
  nor2   g30(.a(new_n44_), .b(x07), .O(new_n72_));
  ...
  nand3  g43(.a(new_n84_), .b(x15), .c(new_n43_), .O(new_n85_));
  nand3  g44(.a(new_n75_), .b(x08), .c(x02), .O(new_n86_));
  ...
  nand3  g49(.a(new_n84_), .b(x16), .c(new_n48_), .O(new_n91_));
  ...
  nand2  g54(.a(new_n84_), .b(x17), .O(new_n96_));
  ...
  nand3  g58(.a(x17), .b(x15), .c(new_n43_), .O(new_n100_));
  ...
  nand2  g63(.a(new_n84_), .b(x18), .O(new_n105_));
  ...
  oai21  g68(.a(new_n60_), .b(new_n70_), .c(new_n43_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n84_), .b(x19), .O(new_n112_));
  ...
  nand3  g75(.a(x12), .b(x10), .c(x08), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(new_n44_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x07), .O(new_n119_));
  nand2  g78(.a(new_n75_), .b(x08), .O(new_n120_));
  nand3  g79(.a(new_n120_), .b(x20), .c(x12), .O(new_n121_));
  nand2  g80(.a(new_n121_), .b(new_n119_), .O(z19));
  buf    g81(.a(x15), .O(z06));
endmodule
