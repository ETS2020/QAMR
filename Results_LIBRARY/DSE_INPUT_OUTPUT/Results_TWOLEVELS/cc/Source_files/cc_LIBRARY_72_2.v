...
module FAU ( 
  ...
  nand2  g21(.a(x20), .b(x15), .O(new_n63_));
  ...
  nand2  g30(.a(new_n46_), .b(new_n55_), .O(z11));
  ...
  oai21  g39(.a(new_n76_), .b(new_n80_), .c(new_n55_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x20), .c(x15), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n44_), .c(x14), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n73_), .O(z13));
  ...
  oai21  g55(.a(new_n65_), .b(new_n73_), .c(x20), .O(new_n97_));
  ...
  oai21  g70(.a(new_n61_), .b(new_n73_), .c(x20), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x15), .O(new_n113_));
  nand2  g72(.a(new_n48_), .b(x19), .O(new_n114_));
  nand4  g73(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n115_));
  ...
  oai22  g78(.a(new_n63_), .b(x14), .c(x15), .d(new_n119_), .O(new_n120_));
  nand3  g79(.a(new_n120_), .b(x10), .c(x08), .O(new_n121_));
  nand2  g80(.a(x15), .b(x14), .O(new_n122_));
  nand3  g81(.a(new_n122_), .b(x10), .c(x08), .O(new_n123_));
  nand2  g82(.a(new_n123_), .b(x20), .O(new_n124_));
  aoi21  g83(.a(new_n124_), .b(new_n121_), .c(new_n73_), .O(z19));
endmodule
