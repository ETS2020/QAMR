...
module FAU ( 
  ...
  oai21  g19(.a(new_n51_), .b(x08), .c(new_n56_), .O(new_n61_));
  nand3  g20(.a(x18), .b(new_n56_), .c(x08), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(x15), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(new_n61_), .O(z06));
  ...
  oai21  g36(.a(new_n73_), .b(new_n77_), .c(new_n47_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x15), .O(new_n79_));
  inv1   g38(.a(x01), .O(new_n80_));
  oai21  g39(.a(new_n46_), .b(new_n80_), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n56_), .O(z13));
  nand3  g41(.a(new_n46_), .b(x15), .c(x12), .O(new_n83_));
  ...
  nand4  g49(.a(new_n52_), .b(x16), .c(new_n47_), .d(x12), .O(new_n91_));
  ...
  aoi21  g56(.a(new_n51_), .b(x08), .c(new_n56_), .O(new_n98_));
  nor2   g57(.a(x15), .b(x10), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n98_), .c(x18), .O(new_n100_));
  inv1   g59(.a(x05), .O(new_n101_));
  oai21  g60(.a(new_n46_), .b(new_n101_), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n51_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n100_), .O(z17));
  inv1   g63(.a(x06), .O(new_n105_));
  oai21  g64(.a(new_n46_), .b(new_n105_), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n51_), .O(new_n107_));
  nand3  g66(.a(new_n52_), .b(x19), .c(x12), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(z18));
  nand2  g68(.a(new_n52_), .b(x20), .O(new_n110_));
  nand3  g69(.a(new_n74_), .b(x08), .c(x07), .O(new_n111_));
