...
module FAU ( 
  ...
  aoi21  g24(.a(x15), .b(new_n65_), .c(new_n43_), .O(z09));
  ...
  nand4  g41(.a(new_n82_), .b(new_n51_), .c(x10), .d(new_n43_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n80_), .O(z14));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n80_), .O(z17));
