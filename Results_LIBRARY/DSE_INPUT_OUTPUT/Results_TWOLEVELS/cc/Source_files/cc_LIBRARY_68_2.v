...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(x04), .c(new_n49_), .O(z06));
  ...
  nand4  g15(.a(new_n56_), .b(new_n45_), .c(x12), .d(new_n54_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(z02));
  nand4  g17(.a(z06), .b(new_n48_), .c(x12), .d(x10), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n47_), .O(z03));
  nand2  g19(.a(new_n45_), .b(x18), .O(z04));
  nand2  g20(.a(new_n50_), .b(new_n43_), .O(z05));
  ...
  oai21  g37(.a(new_n76_), .b(new_n49_), .c(new_n78_), .O(new_n79_));
  ...
  oai21  g42(.a(new_n82_), .b(new_n49_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g50(.a(new_n82_), .b(new_n49_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x19), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x04), .O(new_n94_));
  nand3  g53(.a(new_n55_), .b(x17), .c(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z16));
  inv1   g55(.a(x12), .O(new_n97_));
  inv1   g56(.a(x10), .O(new_n98_));
  nor2   g57(.a(x15), .b(new_n98_), .O(new_n99_));
  and2   g58(.a(x08), .b(x05), .O(new_n100_));
  aoi22  g59(.a(new_n100_), .b(new_n99_), .c(new_n55_), .d(x18), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n97_), .c(new_n45_), .O(z17));
  nand4  g61(.a(new_n49_), .b(x10), .c(x08), .d(new_n43_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n50_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x06), .O(new_n105_));
  oai21  g64(.a(new_n76_), .b(new_n49_), .c(new_n82_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x19), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n105_), .c(new_n97_), .O(z18));
  and2   g67(.a(x08), .b(x07), .O(new_n109_));
  aoi22  g68(.a(new_n109_), .b(new_n99_), .c(new_n55_), .d(x20), .O(new_n110_));
  oai21  g69(.a(new_n110_), .b(new_n97_), .c(new_n45_), .O(z19));
endmodule
