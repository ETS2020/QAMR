...
module FAU ( 
  ...
  nor2   g20(.a(new_n61_), .b(new_n43_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nor2   g22(.a(new_n57_), .b(new_n63_), .O(z07));
  and2   g23(.a(new_n44_), .b(x16), .O(z08));
  inv1   g24(.a(x09), .O(new_n66_));
  nor3   g25(.a(new_n57_), .b(new_n66_), .c(new_n59_), .O(z09));
  aoi21  g26(.a(x09), .b(x08), .c(new_n57_), .O(z10));
  ...
  oai21  g36(.a(new_n77_), .b(new_n59_), .c(new_n47_), .O(new_n78_));
  ...
  nand2  g41(.a(x15), .b(new_n59_), .O(new_n83_));
  ...
  oai21  g45(.a(new_n43_), .b(new_n77_), .c(x15), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(z14));
  nand3  g47(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n89_));
  nor2   g48(.a(x15), .b(new_n77_), .O(new_n90_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n43_), .O(z16));
  ...
  nand3  g67(.a(new_n90_), .b(x08), .c(x07), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n43_), .O(z19));
  aoi21  g69(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
endmodule
