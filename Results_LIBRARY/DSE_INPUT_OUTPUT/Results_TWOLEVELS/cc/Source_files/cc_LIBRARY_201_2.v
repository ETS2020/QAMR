...
module FAU ( 
  ...
  nor2   g32(.a(x15), .b(x13), .O(new_n74_));
  nand4  g33(.a(new_n74_), .b(x10), .c(x08), .d(x00), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n73_), .c(new_n58_), .O(z12));
  aoi21  g35(.a(x10), .b(x08), .c(x14), .O(new_n77_));
  nor2   g36(.a(new_n77_), .b(new_n53_), .O(new_n78_));
  ...
  oai21  g42(.a(new_n49_), .b(new_n53_), .c(new_n83_), .O(new_n84_));
  ...
  nand4  g48(.a(new_n54_), .b(x16), .c(new_n47_), .d(x12), .O(new_n90_));
  ...
  nand3  g59(.a(new_n54_), .b(x18), .c(x12), .O(new_n101_));
