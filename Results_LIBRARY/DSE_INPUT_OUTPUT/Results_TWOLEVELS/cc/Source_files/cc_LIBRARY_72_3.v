...
module FAU ( 
  ...
  nand2  g06(.a(x20), .b(x15), .O(new_n48_));
  ...
  nand4  g15(.a(new_n56_), .b(new_n44_), .c(x15), .d(new_n54_), .O(new_n57_));
  inv1   g16(.a(new_n57_), .O(z03));
  nand2  g17(.a(new_n48_), .b(x18), .O(z04));
  inv1   g18(.a(x19), .O(new_n60_));
  nand2  g19(.a(new_n48_), .b(new_n60_), .O(z05));
  nor2   g20(.a(x20), .b(new_n43_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  aoi21  g22(.a(x20), .b(x15), .c(new_n63_), .O(z07));
  and2   g23(.a(new_n48_), .b(x16), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n48_), .O(z09));
  nand3  g26(.a(new_n48_), .b(x09), .c(x08), .O(z10));
  nand2  g27(.a(new_n48_), .b(new_n54_), .O(z11));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n72_), .c(new_n70_), .O(z12));
  inv1   g35(.a(x08), .O(new_n77_));
  oai21  g36(.a(new_n73_), .b(new_n77_), .c(new_n54_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n44_), .c(x15), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(x01), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n43_), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n70_), .O(z13));
  nand3  g41(.a(new_n46_), .b(new_n44_), .c(x15), .O(new_n83_));
  nand3  g42(.a(new_n74_), .b(x08), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n70_), .O(z14));
  nand3  g44(.a(x16), .b(new_n54_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand3  g47(.a(new_n46_), .b(x16), .c(new_n54_), .O(new_n89_));
  nand4  g48(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n88_), .O(z15));
  oai21  g52(.a(new_n63_), .b(new_n70_), .c(new_n44_), .O(new_n94_));
  ...
  nand4  g63(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n105_));
  ...
  oai21  g67(.a(new_n60_), .b(new_n70_), .c(new_n44_), .O(new_n109_));
  ...
  nand2  g74(.a(new_n46_), .b(x20), .O(new_n116_));
  nand3  g75(.a(x10), .b(x08), .c(x07), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  nand3  g77(.a(new_n118_), .b(new_n43_), .c(x12), .O(new_n119_));
  inv1   g78(.a(new_n119_), .O(z19));
endmodule
