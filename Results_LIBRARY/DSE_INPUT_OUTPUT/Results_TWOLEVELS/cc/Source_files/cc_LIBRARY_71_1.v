...
module FAU ( 
  ...
  nor2   g09(.a(x19), .b(x15), .O(new_n51_));
  ...
  nand2  g20(.a(new_n60_), .b(new_n43_), .O(z06));
  ...
  oai21  g34(.a(new_n75_), .b(new_n66_), .c(new_n46_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x15), .O(new_n77_));
  nand3  g36(.a(x10), .b(x08), .c(x01), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n60_), .c(x14), .O(new_n79_));
  ...
  oai21  g53(.a(new_n71_), .b(x15), .c(x18), .O(new_n95_));
