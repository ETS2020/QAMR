...
module FAU ( 
  ...
  aoi21  g10(.a(new_n51_), .b(new_n48_), .c(new_n43_), .O(new_n52_));
  nor2   g11(.a(new_n44_), .b(new_n48_), .O(new_n53_));
  ...
  nand2  g19(.a(new_n44_), .b(x07), .O(z06));
  ...
  or2    g35(.a(new_n76_), .b(new_n44_), .O(new_n77_));
  inv1   g36(.a(new_n47_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x14), .c(x07), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n77_), .c(new_n75_), .O(z13));
  nand2  g40(.a(new_n47_), .b(x15), .O(new_n82_));
  inv1   g41(.a(new_n51_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x07), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n75_), .O(z14));
  ...
  nand4  g49(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n91_));
  oai21  g50(.a(new_n78_), .b(new_n62_), .c(new_n91_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x07), .O(new_n93_));
  nand2  g52(.a(x17), .b(x15), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n75_), .O(z16));
  nand2  g54(.a(new_n47_), .b(x18), .O(new_n96_));
  nand4  g55(.a(new_n44_), .b(x10), .c(x08), .d(x05), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x07), .O(new_n99_));
  nand2  g58(.a(x18), .b(x15), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n75_), .O(z17));
  nand4  g60(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n102_));
  oai21  g61(.a(new_n78_), .b(new_n59_), .c(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x07), .O(new_n104_));
  nand2  g63(.a(x19), .b(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n75_), .O(z18));
  oai21  g65(.a(new_n83_), .b(x20), .c(x07), .O(new_n107_));
  nand2  g66(.a(x20), .b(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n75_), .O(z19));
endmodule
