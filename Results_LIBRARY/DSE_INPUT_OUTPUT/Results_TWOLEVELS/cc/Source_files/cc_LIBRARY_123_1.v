...
module FAU ( 
  ...
  aoi21  g26(.a(x15), .b(new_n43_), .c(new_n50_), .O(z11));
  ...
  nor2   g33(.a(new_n74_), .b(new_n46_), .O(new_n75_));
  ...
  nand3  g41(.a(new_n46_), .b(x12), .c(x10), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z14));
  oai21  g43(.a(new_n62_), .b(x14), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x15), .O(new_n86_));
  nand3  g45(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n87_));
  ...
  nand3  g51(.a(new_n71_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z16));
  nand2  g53(.a(new_n51_), .b(x18), .O(new_n95_));
  nand3  g54(.a(new_n71_), .b(x08), .c(x05), .O(new_n96_));
  ...
  nand3  g63(.a(new_n71_), .b(x08), .c(x07), .O(new_n105_));
