...
module FAU ( 
  ...
  nand2  g24(.a(new_n65_), .b(new_n44_), .O(z07));
  ...
  nand2  g32(.a(new_n73_), .b(x17), .O(new_n74_));
  ...
  oai21  g37(.a(new_n78_), .b(new_n52_), .c(new_n77_), .O(new_n79_));
  ...
  nand2  g46(.a(new_n76_), .b(x15), .O(new_n88_));
  ...
  nand2  g52(.a(new_n76_), .b(new_n44_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n63_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(x16), .c(new_n47_), .O(new_n96_));
  nand4  g55(.a(new_n44_), .b(x10), .c(x08), .d(x03), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n93_), .O(z15));
  oai21  g57(.a(x15), .b(x04), .c(x10), .O(new_n99_));
  nand2  g58(.a(new_n76_), .b(x17), .O(new_n100_));
  oai21  g59(.a(new_n99_), .b(new_n51_), .c(new_n100_), .O(new_n101_));
  ...
  nand2  g65(.a(new_n76_), .b(x18), .O(new_n107_));
  ...
  nand2  g70(.a(new_n76_), .b(x19), .O(new_n112_));
  ...
  nand3  g74(.a(x19), .b(x17), .c(x15), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n93_), .O(z18));
  oai21  g76(.a(new_n43_), .b(new_n93_), .c(x17), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n76_), .b(x20), .O(new_n120_));
  nand2  g79(.a(x08), .b(x07), .O(new_n121_));
  oai21  g80(.a(new_n121_), .b(new_n52_), .c(new_n120_), .O(new_n122_));
