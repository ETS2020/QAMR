...
module FAU ( 
  ...
  nand3  g26(.a(new_n54_), .b(x09), .c(x08), .O(z10));
  ...
  nand3  g43(.a(new_n50_), .b(x16), .c(new_n46_), .O(new_n85_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n70_), .O(z16));
  inv1   g49(.a(x18), .O(new_n91_));
  nand2  g50(.a(new_n49_), .b(x10), .O(new_n92_));
  nor2   g51(.a(x15), .b(x08), .O(new_n93_));
  aoi21  g52(.a(new_n92_), .b(x12), .c(new_n93_), .O(new_n94_));
  nand3  g53(.a(x10), .b(x08), .c(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n49_), .O(new_n97_));
  oai21  g56(.a(new_n94_), .b(new_n91_), .c(new_n97_), .O(z17));
  ...
  nand3  g62(.a(x10), .b(x08), .c(x07), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n49_), .O(new_n106_));
  oai21  g65(.a(new_n94_), .b(new_n43_), .c(new_n106_), .O(z19));
  buf    g66(.a(x15), .O(z06));
endmodule
