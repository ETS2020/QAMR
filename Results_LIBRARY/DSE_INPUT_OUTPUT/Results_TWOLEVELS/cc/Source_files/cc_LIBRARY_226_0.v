...
module FAU ( 
  ...
  aoi21  g24(.a(new_n65_), .b(x08), .c(new_n52_), .O(z06));
  ...
  nor3   g30(.a(new_n44_), .b(new_n64_), .c(new_n71_), .O(z09));
  aoi21  g31(.a(x09), .b(x08), .c(new_n44_), .O(z10));
  nand2  g32(.a(new_n62_), .b(new_n46_), .O(z11));
  ...
  nand2  g36(.a(new_n77_), .b(x03), .O(new_n78_));
  nand2  g37(.a(x15), .b(x13), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n58_), .O(z12));
  inv1   g39(.a(x10), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n71_), .c(new_n46_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x15), .O(new_n83_));
  nand2  g42(.a(new_n48_), .b(x01), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x14), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n58_), .O(z13));
  nand2  g45(.a(new_n47_), .b(x15), .O(new_n87_));
  inv1   g46(.a(new_n53_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x03), .c(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n58_), .O(z14));
  nor2   g49(.a(new_n69_), .b(x14), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(new_n88_), .c(x03), .O(new_n92_));
  nand3  g51(.a(x16), .b(x15), .c(new_n46_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n58_), .O(z15));
  nor2   g53(.a(new_n58_), .b(new_n81_), .O(new_n95_));
  ...
  nand2  g70(.a(new_n111_), .b(x03), .O(new_n112_));
