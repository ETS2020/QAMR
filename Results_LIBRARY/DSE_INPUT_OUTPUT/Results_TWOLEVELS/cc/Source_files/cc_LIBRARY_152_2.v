...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n69_, new_n71_, new_n73_, new_n76_, new_n78_;
  ...
  nand2  g16(.a(new_n44_), .b(new_n50_), .O(z06));
  inv1   g17(.a(x17), .O(new_n59_));
  nand2  g18(.a(new_n45_), .b(new_n59_), .O(z07));
  inv1   g19(.a(x16), .O(new_n61_));
  aoi21  g20(.a(new_n44_), .b(x12), .c(new_n61_), .O(z08));
  ...
  aoi21  g28(.a(new_n69_), .b(x15), .c(new_n50_), .O(z13));
  ...
  aoi21  g33(.a(new_n59_), .b(x15), .c(new_n50_), .O(z16));
