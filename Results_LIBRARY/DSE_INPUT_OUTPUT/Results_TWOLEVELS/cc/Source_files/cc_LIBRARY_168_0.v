...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x04), .O(new_n43_));
  ...
  nor3   g26(.a(new_n43_), .b(new_n67_), .c(new_n46_), .O(z09));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n71_), .O(z13));
  ...
  aoi22  g50(.a(new_n91_), .b(new_n74_), .c(new_n52_), .d(x17), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n71_), .c(new_n44_), .O(z16));
  and2   g52(.a(x08), .b(x05), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n74_), .c(new_n52_), .d(x18), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n71_), .c(new_n44_), .O(z17));
  ...
  nand3  g59(.a(new_n74_), .b(x08), .c(x07), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n71_), .O(z19));
endmodule
