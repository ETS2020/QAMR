...
module FAU ( 
  ...
  aoi21  g21(.a(new_n62_), .b(x08), .c(new_n51_), .O(z06));
  ...
  oai21  g36(.a(new_n77_), .b(new_n68_), .c(new_n47_), .O(new_n78_));
  ...
  nor2   g42(.a(x15), .b(new_n77_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n56_), .O(z14));
  ...
  nand3  g56(.a(new_n52_), .b(x18), .c(x12), .O(new_n98_));
