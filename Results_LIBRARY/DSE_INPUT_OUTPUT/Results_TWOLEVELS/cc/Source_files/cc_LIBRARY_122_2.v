...
module FAU ( 
  ...
  nand2  g24(.a(new_n65_), .b(new_n45_), .O(z06));
  ...
  nand2  g32(.a(new_n45_), .b(new_n47_), .O(z11));
  ...
  oai21  g37(.a(new_n78_), .b(new_n76_), .c(new_n77_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n43_), .O(new_n80_));
  nand2  g39(.a(x15), .b(x13), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n75_), .O(z12));
  inv1   g41(.a(x10), .O(new_n83_));
  oai21  g42(.a(new_n83_), .b(new_n63_), .c(new_n47_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x15), .O(new_n85_));
  nand2  g44(.a(new_n49_), .b(x01), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x14), .c(new_n43_), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n75_), .O(z13));
  nand2  g47(.a(x08), .b(x02), .O(new_n89_));
  oai22  g48(.a(new_n89_), .b(new_n76_), .c(new_n49_), .d(new_n52_), .O(new_n90_));
  ...
  nand4  g54(.a(new_n53_), .b(x16), .c(new_n47_), .d(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n95_), .O(z15));
  nand3  g56(.a(new_n53_), .b(x17), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n45_), .O(z16));
  nand2  g58(.a(new_n48_), .b(x18), .O(new_n100_));
  nand2  g59(.a(x08), .b(x05), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n76_), .c(new_n100_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n43_), .O(new_n103_));
  nand2  g62(.a(x18), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n75_), .O(z17));
  nand2  g64(.a(x08), .b(x06), .O(new_n106_));
  oai22  g65(.a(new_n106_), .b(new_n76_), .c(new_n49_), .d(new_n61_), .O(new_n107_));
