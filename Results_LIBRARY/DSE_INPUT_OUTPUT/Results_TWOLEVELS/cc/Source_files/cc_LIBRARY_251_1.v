...
module FAU ( 
  ...
  nand3  g43(.a(new_n72_), .b(x15), .c(x09), .O(new_n85_));
  ...
  oai21  g54(.a(new_n62_), .b(new_n84_), .c(x09), .O(new_n96_));
  ...
  nand3  g65(.a(x18), .b(x15), .c(x09), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n84_), .O(z17));
  oai21  g67(.a(new_n59_), .b(new_n84_), .c(x09), .O(new_n109_));
  ...
  oai21  g74(.a(new_n43_), .b(new_n84_), .c(x09), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n72_), .b(x20), .O(new_n118_));
