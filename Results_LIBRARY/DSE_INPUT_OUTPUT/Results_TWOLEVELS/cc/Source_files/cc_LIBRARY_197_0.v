...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(new_n47_), .c(new_n53_), .O(new_n56_));
  nor2   g15(.a(new_n54_), .b(new_n47_), .O(new_n57_));
  oai21  g16(.a(new_n57_), .b(new_n56_), .c(x12), .O(new_n58_));
  nor2   g17(.a(new_n58_), .b(x11), .O(z02));
  inv1   g18(.a(new_n50_), .O(new_n60_));
  nand3  g19(.a(x15), .b(new_n47_), .c(x12), .O(new_n61_));
  oai21  g20(.a(new_n61_), .b(new_n60_), .c(new_n46_), .O(z03));
  nand2  g21(.a(new_n46_), .b(x18), .O(z04));
  inv1   g22(.a(x19), .O(new_n64_));
  nor2   g23(.a(new_n44_), .b(new_n64_), .O(z05));
  nand2  g24(.a(x09), .b(new_n48_), .O(new_n66_));
  oai21  g25(.a(new_n66_), .b(new_n48_), .c(x15), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n46_), .O(z06));
  inv1   g27(.a(x17), .O(new_n69_));
  nand2  g28(.a(new_n46_), .b(new_n69_), .O(z07));
  inv1   g29(.a(x16), .O(new_n71_));
  nor2   g30(.a(new_n44_), .b(new_n71_), .O(z08));
  inv1   g31(.a(x09), .O(new_n73_));
  nor3   g32(.a(new_n44_), .b(new_n73_), .c(new_n48_), .O(z09));
  aoi21  g33(.a(x09), .b(x08), .c(new_n44_), .O(z10));
  nand2  g34(.a(new_n46_), .b(new_n47_), .O(z11));
  inv1   g35(.a(x00), .O(new_n77_));
  nand4  g36(.a(new_n54_), .b(x10), .c(x08), .d(new_n77_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x13), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n46_), .O(z12));
  aoi21  g39(.a(x10), .b(x08), .c(x14), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n54_), .O(new_n82_));
  aoi21  g41(.a(new_n50_), .b(x01), .c(new_n47_), .O(new_n83_));
  ...
  nand4  g53(.a(new_n55_), .b(x16), .c(new_n47_), .d(x12), .O(new_n95_));
  ...
  oai21  g66(.a(new_n50_), .b(new_n64_), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x13), .O(new_n109_));
  ...
  nand2  g71(.a(new_n112_), .b(x13), .O(new_n113_));
