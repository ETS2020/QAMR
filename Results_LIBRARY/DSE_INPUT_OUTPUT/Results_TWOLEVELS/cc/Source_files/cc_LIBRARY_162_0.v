...
module FAU ( 
  ...
  nand3  g32(.a(x17), .b(new_n51_), .c(x10), .O(new_n74_));
  ...
  nand2  g63(.a(new_n92_), .b(x08), .O(new_n105_));
  ...
  nand2  g67(.a(new_n108_), .b(x17), .O(new_n109_));
