// Benchmark "FAU" written by ABC on Tue Aug 18 14:00:16 2020
...
module FAU ( 
  ...
  nand2  g22(.a(new_n49_), .b(new_n63_), .O(z08));
  ...
  aoi21  g32(.a(new_n73_), .b(new_n70_), .c(new_n50_), .O(z12));
  ...
  nand3  g43(.a(new_n72_), .b(x08), .c(x03), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n50_), .O(z15));
  nand2  g45(.a(new_n52_), .b(x17), .O(new_n87_));
  nand3  g46(.a(new_n72_), .b(x08), .c(x04), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n50_), .O(z16));
  nand3  g48(.a(x10), .b(x08), .c(x05), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x12), .O(new_n91_));
  aoi21  g50(.a(new_n56_), .b(x18), .c(new_n91_), .O(new_n92_));
  nand3  g51(.a(x18), .b(x15), .c(x12), .O(new_n93_));
  oai21  g52(.a(new_n92_), .b(x15), .c(new_n93_), .O(z17));
  inv1   g53(.a(x06), .O(new_n95_));
  oai21  g54(.a(new_n56_), .b(new_n95_), .c(x12), .O(new_n96_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n50_), .O(z19));
  buf    g61(.a(x15), .O(z06));
endmodule
