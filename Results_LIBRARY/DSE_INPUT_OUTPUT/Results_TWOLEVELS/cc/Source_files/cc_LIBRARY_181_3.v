...
module FAU ( 
  ...
  nor2   g04(.a(new_n44_), .b(new_n43_), .O(new_n46_));
  ...
  nor2   g18(.a(new_n46_), .b(new_n52_), .O(z06));
  ...
  oai21  g32(.a(new_n73_), .b(new_n69_), .c(new_n47_), .O(z12));
  ...
  nand3  g44(.a(new_n53_), .b(x16), .c(new_n49_), .O(new_n86_));
  nand4  g45(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n86_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(new_n47_), .c(x12), .O(new_n89_));
  inv1   g48(.a(new_n89_), .O(z15));
  and2   g49(.a(x08), .b(x04), .O(new_n91_));
  aoi22  g50(.a(new_n91_), .b(new_n71_), .c(new_n53_), .d(x17), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n69_), .c(new_n47_), .O(z16));
  and2   g52(.a(x08), .b(x05), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n71_), .c(new_n53_), .d(x18), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n69_), .c(new_n47_), .O(z17));
  nand2  g55(.a(new_n43_), .b(new_n52_), .O(new_n97_));
  nand2  g56(.a(new_n44_), .b(x19), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(new_n48_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g59(.a(new_n53_), .b(new_n44_), .c(x19), .O(new_n101_));
  ...
  oai21  g63(.a(new_n104_), .b(new_n69_), .c(new_n47_), .O(z19));
  buf    g64(.a(x19), .O(z05));
endmodule
