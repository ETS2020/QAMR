...
module FAU ( 
  ...
  oai21  g36(.a(new_n72_), .b(new_n64_), .c(new_n48_), .O(new_n78_));
  ...
  nand3  g42(.a(x17), .b(new_n51_), .c(x10), .O(new_n84_));
  ...
  nand3  g49(.a(new_n85_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n77_), .O(z15));
  nor2   g51(.a(new_n64_), .b(x04), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n73_), .O(new_n94_));
  ...
  nand3  g58(.a(new_n74_), .b(x18), .c(x12), .O(new_n100_));
  ...
  nand2  g68(.a(new_n109_), .b(x17), .O(new_n110_));
  nand2  g69(.a(x20), .b(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n77_), .O(z19));
  buf    g71(.a(x17), .O(z07));
endmodule
