...
module FAU ( 
  ...
  nand3  g17(.a(new_n58_), .b(x10), .c(x08), .O(new_n59_));
  nand3  g18(.a(new_n59_), .b(x15), .c(x12), .O(new_n60_));
  ...
  aoi21  g27(.a(x15), .b(new_n43_), .c(new_n50_), .O(z11));
  ...
  nor2   g34(.a(new_n58_), .b(new_n47_), .O(new_n76_));
  ...
  inv1   g58(.a(x10), .O(new_n100_));
  nor2   g59(.a(x15), .b(new_n100_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(x08), .c(x05), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n99_), .c(new_n43_), .O(z17));
  ...
  nand3  g69(.a(new_n101_), .b(x08), .c(x07), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n43_), .O(z19));
  nor4   g71(.a(new_n48_), .b(new_n47_), .c(x14), .d(new_n43_), .O(z03));
endmodule
