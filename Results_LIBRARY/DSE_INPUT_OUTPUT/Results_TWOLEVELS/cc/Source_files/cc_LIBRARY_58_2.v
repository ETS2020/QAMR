...
module FAU ( 
  ...
  nand2  g30(.a(new_n48_), .b(x13), .O(new_n72_));
  ...
  oai21  g43(.a(new_n49_), .b(new_n52_), .c(new_n84_), .O(new_n85_));
  ...
  aoi21  g58(.a(new_n48_), .b(new_n43_), .c(x15), .O(new_n100_));
  nor3   g59(.a(new_n100_), .b(new_n99_), .c(new_n57_), .O(z17));
