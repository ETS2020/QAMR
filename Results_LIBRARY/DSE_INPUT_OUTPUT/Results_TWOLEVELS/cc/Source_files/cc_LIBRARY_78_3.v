...
module FAU ( 
  ...
  nand2  g43(.a(new_n75_), .b(x15), .O(new_n85_));
  ...
  nand3  g48(.a(new_n77_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(new_n43_), .O(new_n97_));
  ...
  nand3  g61(.a(x18), .b(x15), .c(new_n43_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n74_), .O(z17));
  oai21  g63(.a(new_n62_), .b(new_n74_), .c(new_n43_), .O(new_n105_));
  ...
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n74_), .O(z19));
endmodule
