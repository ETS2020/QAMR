...
module FAU ( 
  ...
  oai21  g20(.a(new_n51_), .b(x08), .c(new_n61_), .O(new_n62_));
  nand3  g21(.a(x18), .b(new_n61_), .c(x08), .O(new_n63_));
  nand2  g22(.a(new_n63_), .b(x15), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n62_), .O(z06));
  ...
  aoi21  g35(.a(new_n76_), .b(new_n73_), .c(new_n61_), .O(z12));
  inv1   g36(.a(x08), .O(new_n78_));
  oai21  g37(.a(new_n74_), .b(new_n78_), .c(new_n47_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  inv1   g39(.a(x01), .O(new_n81_));
  oai21  g40(.a(new_n46_), .b(new_n81_), .c(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n61_), .O(z13));
