...
module FAU ( 
  ...
  oai21  g27(.a(new_n55_), .b(new_n68_), .c(x12), .O(new_n69_));
  ...
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n46_), .O(new_n75_));
  ...
  nand4  g54(.a(new_n49_), .b(x10), .c(x08), .d(x05), .O(new_n96_));
