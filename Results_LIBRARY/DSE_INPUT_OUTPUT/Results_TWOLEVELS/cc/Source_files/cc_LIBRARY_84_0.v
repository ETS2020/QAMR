...
module FAU ( 
  ...
  nand3  g29(.a(new_n51_), .b(x10), .c(x00), .O(new_n71_));
  oai21  g30(.a(new_n70_), .b(new_n68_), .c(new_n71_), .O(new_n72_));
  ...
  aoi21  g35(.a(x10), .b(x01), .c(new_n48_), .O(new_n77_));
  ...
  nand3  g42(.a(new_n51_), .b(x10), .c(x03), .O(new_n84_));
  ...
  nand2  g47(.a(x12), .b(x10), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n88_), .c(x08), .O(new_n90_));
  ...
  oai21  g53(.a(new_n89_), .b(new_n94_), .c(x08), .O(new_n95_));
  ...
  nand3  g57(.a(new_n51_), .b(x10), .c(x06), .O(new_n99_));
  nand2  g58(.a(x19), .b(new_n69_), .O(new_n100_));
  ...
  oai21  g64(.a(new_n89_), .b(new_n105_), .c(x08), .O(new_n106_));
