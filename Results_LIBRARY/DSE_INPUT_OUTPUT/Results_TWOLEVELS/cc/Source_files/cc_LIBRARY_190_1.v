...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n51_,
    new_n53_, new_n55_, new_n56_, new_n58_, new_n60_, new_n62_, new_n65_,
  ...
  aoi21  g08(.a(new_n49_), .b(new_n45_), .c(x11), .O(z02));
  nand3  g09(.a(new_n48_), .b(x12), .c(x11), .O(new_n51_));
  nor3   g10(.a(new_n51_), .b(new_n45_), .c(x14), .O(z03));
  nor2   g11(.a(new_n45_), .b(x11), .O(new_n53_));
  ...
  nor2   g19(.a(new_n53_), .b(new_n60_), .O(z08));
  ...
  nor2   g24(.a(new_n53_), .b(new_n65_), .O(z11));
  ...
  nand2  g34(.a(new_n75_), .b(x11), .O(new_n76_));
  ...
  oai21  g72(.a(new_n43_), .b(new_n86_), .c(x11), .O(new_n114_));
