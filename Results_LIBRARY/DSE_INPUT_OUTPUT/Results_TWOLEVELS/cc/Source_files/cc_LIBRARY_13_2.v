...
module FAU ( 
  ...
  nand2  g47(.a(new_n48_), .b(new_n44_), .O(new_n89_));
  nand2  g48(.a(x17), .b(x15), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n89_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x16), .c(new_n52_), .O(new_n92_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n97_), .c(new_n77_), .O(z16));
  ...
  nand3  g64(.a(x18), .b(x17), .c(x15), .O(new_n106_));
  ...
  nand3  g70(.a(x19), .b(x17), .c(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n77_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n77_), .c(x17), .O(new_n114_));
