...
module FAU ( 
  ...
  oai21  g08(.a(new_n44_), .b(x00), .c(x14), .O(new_n50_));
  ...
  nand2  g18(.a(new_n59_), .b(new_n58_), .O(z05));
  ...
  nor2   g23(.a(new_n64_), .b(new_n61_), .O(z06));
  ...
  oai21  g28(.a(new_n44_), .b(x00), .c(x09), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n62_), .O(z09));
  aoi22  g30(.a(x15), .b(new_n61_), .c(x09), .d(x08), .O(z10));
  nand2  g31(.a(new_n59_), .b(new_n47_), .O(z11));
  inv1   g32(.a(x12), .O(new_n74_));
  inv1   g33(.a(x13), .O(new_n75_));
  nand2  g34(.a(new_n51_), .b(new_n75_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x00), .O(new_n77_));
  nand2  g36(.a(x10), .b(x08), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n44_), .c(x13), .O(new_n79_));
  ...
  nand2  g44(.a(new_n85_), .b(new_n59_), .O(z13));
  nand3  g45(.a(new_n78_), .b(x15), .c(x00), .O(new_n87_));
  ...
  nand2  g49(.a(new_n90_), .b(x00), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand3  g51(.a(new_n78_), .b(x16), .c(new_n47_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n66_), .b(new_n74_), .c(x00), .O(new_n98_));
  ...
  nand3  g67(.a(x18), .b(x15), .c(x00), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n74_), .O(z17));
  oai21  g69(.a(new_n58_), .b(new_n74_), .c(x00), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n78_), .b(x19), .O(new_n113_));
  ...
  oai21  g76(.a(new_n43_), .b(new_n74_), .c(x00), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n78_), .b(x20), .O(new_n120_));
