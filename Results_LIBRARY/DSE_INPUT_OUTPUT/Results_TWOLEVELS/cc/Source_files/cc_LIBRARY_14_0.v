...
module FAU ( 
  ...
  nand4  g47(.a(new_n52_), .b(x16), .c(new_n48_), .d(x12), .O(new_n89_));
  ...
  nand2  g53(.a(new_n47_), .b(x18), .O(new_n95_));
  ...
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n56_), .O(z17));
  ...
  nand2  g65(.a(new_n106_), .b(x17), .O(new_n107_));
