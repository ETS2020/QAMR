...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n59_, new_n61_, new_n63_, new_n65_, new_n68_, new_n72_, new_n73_,
  ...
  and2   g25(.a(new_n49_), .b(x16), .O(z08));
  ...
  nand2  g31(.a(new_n45_), .b(new_n42_), .O(new_n73_));
  nand2  g32(.a(new_n56_), .b(x15), .O(new_n74_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n56_), .O(new_n81_));
  ...
  nand2  g44(.a(new_n45_), .b(x15), .O(new_n86_));
  nand2  g45(.a(x08), .b(x02), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n51_), .c(new_n86_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n49_), .O(z14));
  nand3  g49(.a(new_n75_), .b(x16), .c(new_n55_), .O(new_n91_));
  nand3  g50(.a(new_n77_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n72_), .O(z15));
  oai21  g52(.a(new_n65_), .b(new_n72_), .c(new_n56_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x15), .O(new_n95_));
  nand2  g54(.a(new_n45_), .b(x17), .O(new_n96_));
  ...
  nand2  g59(.a(new_n45_), .b(x18), .O(new_n101_));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n72_), .O(z17));
  oai21  g65(.a(new_n63_), .b(new_n72_), .c(new_n56_), .O(new_n107_));
  ...
  nand2  g73(.a(new_n45_), .b(x20), .O(new_n115_));
  oai21  g74(.a(new_n45_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand3  g75(.a(new_n116_), .b(new_n42_), .c(x12), .O(new_n117_));
