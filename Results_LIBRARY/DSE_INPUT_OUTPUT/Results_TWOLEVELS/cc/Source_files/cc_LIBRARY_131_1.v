...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x12), .c(new_n47_), .O(z06));
  ...
  nand3  g61(.a(new_n93_), .b(x08), .c(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n43_), .O(z18));
  nand2  g63(.a(new_n51_), .b(x20), .O(new_n105_));
  nand3  g64(.a(new_n93_), .b(x08), .c(x07), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n43_), .O(z19));
  nor4   g66(.a(new_n48_), .b(new_n47_), .c(x14), .d(new_n43_), .O(z03));
endmodule
