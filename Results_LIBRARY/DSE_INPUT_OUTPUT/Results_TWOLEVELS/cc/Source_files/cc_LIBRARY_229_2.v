...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n60_, new_n63_, new_n65_, new_n67_, new_n69_, new_n73_,
  ...
  nand4  g18(.a(new_n59_), .b(x18), .c(x15), .d(new_n52_), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z03));
  nor2   g20(.a(x18), .b(x15), .O(z04));
  ...
  nand2  g32(.a(x18), .b(x15), .O(new_n74_));
  oai21  g33(.a(new_n57_), .b(x15), .c(new_n74_), .O(new_n75_));
  ...
  oai21  g39(.a(new_n77_), .b(new_n51_), .c(new_n52_), .O(new_n81_));
  ...
  nand3  g44(.a(new_n48_), .b(x18), .c(x15), .O(new_n86_));
  ...
  nand3  g59(.a(x18), .b(x17), .c(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n73_), .O(z16));
  inv1   g61(.a(x05), .O(new_n103_));
  oai21  g62(.a(new_n74_), .b(x14), .c(new_n103_), .O(new_n104_));
  ...
  nand2  g69(.a(new_n110_), .b(new_n50_), .O(z17));
  aoi21  g70(.a(x19), .b(x12), .c(new_n47_), .O(new_n112_));
  and2   g71(.a(x08), .b(x06), .O(new_n113_));
  aoi22  g72(.a(new_n113_), .b(new_n78_), .c(new_n48_), .d(x19), .O(new_n114_));
  oai22  g73(.a(new_n114_), .b(new_n73_), .c(new_n112_), .d(new_n44_), .O(z18));
  aoi21  g74(.a(x20), .b(x12), .c(new_n47_), .O(new_n116_));
  and2   g75(.a(x08), .b(x07), .O(new_n117_));
  aoi22  g76(.a(new_n117_), .b(new_n78_), .c(new_n48_), .d(x20), .O(new_n118_));
  oai22  g77(.a(new_n118_), .b(new_n73_), .c(new_n116_), .d(new_n44_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
