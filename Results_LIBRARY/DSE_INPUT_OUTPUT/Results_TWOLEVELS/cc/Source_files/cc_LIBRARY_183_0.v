...
module FAU ( 
  ...
  or2    g34(.a(new_n75_), .b(new_n51_), .O(new_n76_));
  inv1   g35(.a(new_n46_), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(x01), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x14), .c(x07), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n76_), .c(new_n57_), .O(z13));
  nand2  g39(.a(new_n51_), .b(x10), .O(new_n81_));
  nand2  g40(.a(x08), .b(x02), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n81_), .c(new_n77_), .d(new_n51_), .O(new_n83_));
  ...
  nand2  g47(.a(new_n88_), .b(x07), .O(new_n89_));
  ...
  oai22  g51(.a(new_n92_), .b(new_n81_), .c(new_n77_), .d(new_n62_), .O(new_n93_));
  ...
  oai22  g61(.a(new_n102_), .b(new_n81_), .c(new_n77_), .d(new_n60_), .O(new_n103_));
  ...
  inv1   g65(.a(new_n52_), .O(new_n107_));
  oai21  g66(.a(new_n107_), .b(x20), .c(x07), .O(new_n108_));
