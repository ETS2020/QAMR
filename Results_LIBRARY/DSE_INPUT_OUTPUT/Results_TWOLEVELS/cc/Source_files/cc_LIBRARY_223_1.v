...
module FAU ( 
  ...
  oai21  g08(.a(new_n44_), .b(x13), .c(x14), .O(new_n50_));
  ...
  nand4  g15(.a(new_n56_), .b(new_n47_), .c(x13), .d(x12), .O(new_n57_));
  ...
  nand2  g24(.a(new_n61_), .b(new_n65_), .O(z08));
  inv1   g25(.a(x08), .O(new_n67_));
  inv1   g26(.a(x09), .O(new_n68_));
  nor3   g27(.a(new_n45_), .b(new_n68_), .c(new_n67_), .O(z09));
  nand3  g28(.a(new_n61_), .b(x09), .c(x08), .O(z10));
  nand2  g29(.a(new_n61_), .b(new_n47_), .O(z11));
  ...
  nand3  g40(.a(new_n81_), .b(x15), .c(x13), .O(new_n82_));
  ...
  nand3  g44(.a(new_n55_), .b(x15), .c(x13), .O(new_n86_));
  inv1   g45(.a(x10), .O(new_n87_));
  nor2   g46(.a(x15), .b(new_n87_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x08), .c(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n86_), .c(new_n72_), .O(z14));
  nand2  g49(.a(new_n55_), .b(new_n44_), .O(new_n91_));
  nand2  g50(.a(x15), .b(x13), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x16), .c(new_n47_), .O(new_n94_));
  nand3  g53(.a(new_n88_), .b(x08), .c(x03), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n72_), .O(z15));
  ...
  nand3  g59(.a(x17), .b(x15), .c(x13), .O(new_n101_));
  ...
  nand2  g64(.a(new_n55_), .b(x18), .O(new_n106_));
  ...
  nand2  g69(.a(new_n55_), .b(x19), .O(new_n111_));
  ...
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n72_), .O(z18));
  nand2  g75(.a(new_n55_), .b(x20), .O(new_n117_));
