...
module FAU ( 
  ...
  nand2  g18(.a(x16), .b(new_n49_), .O(z06));
  ...
  nand2  g26(.a(new_n67_), .b(x16), .O(new_n68_));
  ...
  nand4  g38(.a(new_n79_), .b(x16), .c(new_n49_), .d(x10), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n54_), .O(z14));
  nand4  g40(.a(new_n49_), .b(x10), .c(x08), .d(x03), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n51_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x16), .c(x12), .O(new_n84_));
  ...
  nand2  g47(.a(new_n88_), .b(x16), .O(new_n89_));
  nand2  g48(.a(x17), .b(x15), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n54_), .O(z16));
  nand2  g50(.a(new_n55_), .b(x18), .O(new_n92_));
  nand4  g51(.a(new_n49_), .b(x10), .c(x08), .d(x05), .O(new_n93_));
  ...
  nand3  g64(.a(new_n50_), .b(x20), .c(x12), .O(new_n106_));
