...
module FAU ( 
  ...
  nand3  g57(.a(new_n83_), .b(x08), .c(x05), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n57_), .O(z17));
  inv1   g59(.a(x06), .O(new_n101_));
  nand4  g60(.a(new_n52_), .b(x10), .c(x08), .d(new_n101_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(x19), .c(x12), .O(new_n103_));
