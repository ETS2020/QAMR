...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n54_, new_n56_, new_n58_, new_n61_, new_n65_, new_n67_,
  ...
  and2   g18(.a(new_n54_), .b(x16), .O(z08));
  nand2  g19(.a(x09), .b(x08), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(new_n54_), .O(z09));
  aoi22  g21(.a(new_n51_), .b(x12), .c(x09), .d(x08), .O(z10));
  nand2  g22(.a(new_n54_), .b(new_n46_), .O(z11));
  nand3  g23(.a(x15), .b(x13), .c(x12), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z12));
  nand2  g25(.a(x10), .b(x08), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(x15), .c(new_n46_), .O(new_n68_));
  and2   g27(.a(new_n68_), .b(x12), .O(z13));
  nand3  g28(.a(new_n67_), .b(x15), .c(x12), .O(new_n70_));
