...
module FAU ( 
  ...
  nand3  g38(.a(new_n79_), .b(x14), .c(x06), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n56_), .O(z13));
  nand2  g40(.a(new_n47_), .b(x15), .O(new_n82_));
  inv1   g41(.a(new_n52_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x06), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n56_), .O(z14));
  ...
  nand2  g61(.a(new_n52_), .b(new_n59_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x06), .O(new_n104_));
  nand2  g63(.a(x19), .b(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n56_), .O(z18));
