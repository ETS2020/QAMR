...
module FAU ( 
  ...
  nand2  g21(.a(new_n52_), .b(x07), .O(z06));
  ...
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n48_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  inv1   g41(.a(new_n47_), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x01), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x14), .c(x07), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n72_), .O(z13));
  nand2  g45(.a(new_n47_), .b(x15), .O(new_n87_));
  inv1   g46(.a(new_n53_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x07), .c(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n72_), .O(z14));
  nor2   g49(.a(new_n72_), .b(new_n80_), .O(new_n91_));
  ...
  oai21  g56(.a(new_n83_), .b(new_n64_), .c(new_n97_), .O(new_n98_));
  ...
  nand3  g63(.a(new_n53_), .b(x18), .c(x12), .O(new_n105_));
  ...
  nand3  g68(.a(new_n53_), .b(x19), .c(x12), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n109_), .O(z18));
  oai21  g70(.a(new_n88_), .b(x20), .c(x12), .O(new_n112_));
