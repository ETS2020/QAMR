...
module FAU ( 
  ...
  aoi21  g20(.a(new_n61_), .b(new_n44_), .c(x18), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nor2   g22(.a(new_n45_), .b(new_n63_), .O(z05));
  inv1   g23(.a(x17), .O(new_n65_));
  inv1   g24(.a(new_n45_), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n65_), .O(z07));
  inv1   g26(.a(x16), .O(new_n68_));
  nand2  g27(.a(new_n66_), .b(new_n68_), .O(z08));
  oai21  g28(.a(x18), .b(new_n44_), .c(x09), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n59_), .O(z09));
  inv1   g30(.a(x18), .O(new_n72_));
  aoi22  g31(.a(new_n72_), .b(x15), .c(x09), .d(x08), .O(z10));
  ...
  nand2  g36(.a(new_n55_), .b(x13), .O(new_n78_));
  ...
  nand2  g42(.a(new_n48_), .b(new_n47_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x18), .c(x15), .O(new_n85_));
  ...
  nand3  g47(.a(new_n55_), .b(x18), .c(x15), .O(new_n89_));
  nand4  g48(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n83_), .O(z14));
  nand3  g50(.a(x16), .b(new_n47_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x18), .O(new_n93_));
  ...
  oai21  g58(.a(new_n65_), .b(new_n83_), .c(x18), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x15), .O(new_n101_));
  nand2  g60(.a(new_n55_), .b(x17), .O(new_n102_));
  nand4  g61(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n103_));
  ...
  nand2  g65(.a(new_n44_), .b(x05), .O(new_n107_));
  nand3  g66(.a(x18), .b(x15), .c(new_n47_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(x10), .c(x08), .O(new_n110_));
  nand2  g69(.a(x15), .b(x14), .O(new_n111_));
  nand3  g70(.a(new_n111_), .b(x10), .c(x08), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x18), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n110_), .c(new_n83_), .O(z17));
  oai21  g73(.a(new_n63_), .b(new_n83_), .c(x18), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n55_), .b(x19), .O(new_n117_));
  ...
  oai21  g80(.a(new_n43_), .b(new_n83_), .c(x18), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(x15), .O(new_n123_));
  nand2  g82(.a(new_n55_), .b(x20), .O(new_n124_));
