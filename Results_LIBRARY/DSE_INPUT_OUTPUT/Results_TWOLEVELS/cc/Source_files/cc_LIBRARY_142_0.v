...
module FAU ( 
  ...
  nor2   g20(.a(new_n61_), .b(new_n58_), .O(z05));
  oai21  g21(.a(new_n61_), .b(new_n49_), .c(new_n44_), .O(z06));
  ...
  nor2   g38(.a(new_n79_), .b(new_n49_), .O(new_n80_));
  ...
  nand3  g46(.a(new_n73_), .b(x16), .c(new_n46_), .O(new_n88_));
  nand3  g47(.a(new_n76_), .b(x08), .c(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n54_), .O(z15));
  nand2  g49(.a(new_n73_), .b(x17), .O(new_n91_));
  nand3  g50(.a(new_n76_), .b(x08), .c(x04), .O(new_n92_));
  ...
  nand2  g61(.a(new_n55_), .b(x20), .O(new_n103_));
