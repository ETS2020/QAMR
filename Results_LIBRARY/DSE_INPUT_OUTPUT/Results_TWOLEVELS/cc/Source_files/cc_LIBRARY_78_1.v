...
module FAU ( 
  ...
  aoi21  g15(.a(new_n56_), .b(x01), .c(new_n43_), .O(z03));
  nand2  g16(.a(new_n45_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n44_), .b(new_n59_), .O(z05));
  nand2  g19(.a(x15), .b(x01), .O(new_n61_));
  ...
  nand2  g28(.a(new_n45_), .b(new_n51_), .O(z11));
  ...
  oai21  g38(.a(new_n51_), .b(new_n71_), .c(new_n43_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n79_), .O(new_n81_));
  aoi21  g40(.a(x10), .b(x08), .c(x14), .O(new_n82_));
  nand2  g41(.a(new_n72_), .b(x14), .O(new_n83_));
  oai21  g42(.a(new_n82_), .b(new_n43_), .c(new_n83_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n81_), .O(z13));
  nand2  g45(.a(new_n72_), .b(x15), .O(new_n87_));
  ...
  nand3  g50(.a(new_n74_), .b(x16), .c(new_n51_), .O(new_n92_));
  nand3  g51(.a(new_n76_), .b(x08), .c(x03), .O(new_n93_));
  ...
  nand3  g57(.a(x17), .b(x15), .c(x01), .O(new_n99_));
  ...
  oai21  g65(.a(new_n59_), .b(new_n71_), .c(x01), .O(new_n107_));
