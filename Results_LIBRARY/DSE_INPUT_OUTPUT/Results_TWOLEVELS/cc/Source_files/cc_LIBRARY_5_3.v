...
module FAU ( 
  ...
  nand2  g11(.a(new_n52_), .b(new_n42_), .O(z02));
  inv1   g12(.a(x19), .O(new_n54_));
  nor2   g13(.a(x19), .b(x14), .O(new_n55_));
  nand4  g14(.a(new_n55_), .b(x12), .c(x10), .d(x08), .O(new_n56_));
  aoi21  g15(.a(new_n56_), .b(new_n54_), .c(new_n45_), .O(z03));
  aoi21  g16(.a(x19), .b(x15), .c(x18), .O(z04));
  ...
  nand2  g24(.a(new_n42_), .b(new_n49_), .O(z11));
  inv1   g25(.a(x12), .O(new_n67_));
  aoi21  g26(.a(x10), .b(x08), .c(x15), .O(new_n68_));
  nor2   g27(.a(x19), .b(new_n45_), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(new_n68_), .c(x13), .O(new_n70_));
  nand4  g29(.a(new_n45_), .b(x10), .c(x08), .d(x00), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n70_), .c(new_n67_), .O(z12));
  inv1   g31(.a(x08), .O(new_n73_));
  inv1   g32(.a(x10), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(new_n49_), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(new_n54_), .c(x15), .O(new_n76_));
  ...
  nand3  g43(.a(x16), .b(new_n49_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n54_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand3  g46(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n88_));
  ...
  oai21  g51(.a(new_n59_), .b(new_n67_), .c(new_n54_), .O(new_n93_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n54_), .O(new_n101_));
