...
module FAU ( 
  ...
  nor2   g16(.a(x18), .b(new_n51_), .O(z04));
  ...
  nand2  g29(.a(new_n46_), .b(x18), .O(new_n71_));
  ...
  nand2  g52(.a(new_n93_), .b(x08), .O(new_n94_));
  nand4  g53(.a(new_n94_), .b(x16), .c(new_n47_), .d(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n91_), .O(z15));
  nand2  g55(.a(new_n72_), .b(x17), .O(new_n97_));
  nand3  g56(.a(new_n75_), .b(x08), .c(x04), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n70_), .O(z16));
  inv1   g58(.a(x05), .O(new_n100_));
  nand3  g59(.a(new_n93_), .b(x08), .c(new_n100_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(x18), .c(x12), .O(new_n102_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n70_), .O(z18));
  nand2  g68(.a(new_n46_), .b(x20), .O(new_n110_));
  nand4  g69(.a(new_n51_), .b(x10), .c(x08), .d(x07), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n110_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x18), .O(new_n113_));
  nand2  g72(.a(x20), .b(x15), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n70_), .O(z19));
endmodule
