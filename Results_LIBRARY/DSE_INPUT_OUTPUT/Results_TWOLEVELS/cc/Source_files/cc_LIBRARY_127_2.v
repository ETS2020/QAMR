...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n52_, new_n55_, new_n56_, new_n57_, new_n60_, new_n62_, new_n64_,
    new_n68_, new_n70_, new_n72_, new_n73_, new_n75_, new_n78_, new_n80_;
  ...
  nor3   g29(.a(new_n70_), .b(new_n44_), .c(new_n56_), .O(z13));
  ...
  aoi21  g35(.a(new_n60_), .b(x15), .c(new_n56_), .O(z16));
