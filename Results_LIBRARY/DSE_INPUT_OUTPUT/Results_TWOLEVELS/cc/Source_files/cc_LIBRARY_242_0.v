...
module FAU ( 
  ...
  nand3  g40(.a(x20), .b(new_n44_), .c(x10), .O(new_n82_));
  ...
  nand2  g44(.a(new_n50_), .b(x20), .O(new_n86_));
  ...
  nand2  g59(.a(new_n87_), .b(x19), .O(new_n101_));
  nand3  g60(.a(new_n83_), .b(x08), .c(x06), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n56_), .O(z18));
  inv1   g62(.a(x07), .O(new_n104_));
  nand4  g63(.a(new_n44_), .b(x10), .c(x08), .d(new_n104_), .O(new_n105_));
