...
module FAU ( 
  ...
  and2   g29(.a(x12), .b(x10), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x08), .c(x00), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x06), .O(new_n73_));
  ...
  inv1   g37(.a(new_n46_), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x01), .c(new_n47_), .O(new_n80_));
  ...
  nand2  g56(.a(new_n97_), .b(x06), .O(new_n98_));
  ...
  nand2  g60(.a(new_n52_), .b(new_n60_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x06), .O(new_n103_));
  nand2  g62(.a(x19), .b(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n57_), .O(z18));
  nand3  g64(.a(new_n71_), .b(x08), .c(x07), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x06), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n51_), .O(new_n108_));
  nand3  g67(.a(new_n52_), .b(x20), .c(x12), .O(new_n109_));
