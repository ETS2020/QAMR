...
module FAU ( 
  ...
  nand2  g34(.a(new_n49_), .b(x13), .O(new_n76_));
  ...
  aoi21  g39(.a(new_n80_), .b(new_n79_), .c(new_n59_), .O(z12));
  aoi21  g40(.a(x10), .b(x08), .c(x14), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n53_), .O(new_n83_));
  aoi21  g42(.a(new_n50_), .b(x01), .c(new_n48_), .O(new_n84_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n87_), .c(new_n59_), .O(z14));
  nand3  g49(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n91_));
  nand4  g50(.a(new_n53_), .b(x10), .c(x08), .d(x03), .O(new_n92_));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n59_), .O(z15));
  aoi21  g55(.a(new_n49_), .b(new_n44_), .c(x15), .O(new_n97_));
  nor3   g56(.a(new_n97_), .b(new_n68_), .c(new_n59_), .O(z16));
