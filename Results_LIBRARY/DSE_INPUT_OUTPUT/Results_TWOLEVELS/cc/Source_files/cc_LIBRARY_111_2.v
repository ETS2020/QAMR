...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(x19), .c(new_n52_), .d(x12), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x19), .c(new_n44_), .O(z03));
  ...
  nor3   g24(.a(new_n45_), .b(new_n65_), .c(new_n51_), .O(z09));
  nand3  g25(.a(new_n50_), .b(x09), .c(x08), .O(z10));
  nor2   g26(.a(new_n45_), .b(new_n52_), .O(z11));
  inv1   g27(.a(x12), .O(new_n69_));
  nand2  g28(.a(x19), .b(x15), .O(new_n70_));
  oai21  g29(.a(new_n57_), .b(x15), .c(new_n70_), .O(new_n71_));
  ...
  nor2   g34(.a(new_n75_), .b(new_n47_), .O(new_n76_));
  nand3  g35(.a(x10), .b(x08), .c(x01), .O(new_n77_));
  and2   g36(.a(new_n77_), .b(x14), .O(new_n78_));
  aoi21  g37(.a(new_n76_), .b(x15), .c(new_n78_), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n69_), .c(new_n50_), .O(z13));
  nand2  g39(.a(x08), .b(x02), .O(new_n81_));
  oai22  g40(.a(new_n81_), .b(new_n53_), .c(new_n57_), .d(new_n44_), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n50_), .O(z14));
  nand3  g43(.a(x16), .b(new_n52_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x19), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand3  g46(.a(new_n48_), .b(x16), .c(new_n52_), .O(new_n88_));
  ...
  aoi21  g51(.a(x17), .b(x12), .c(new_n47_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n93_), .b(new_n44_), .c(new_n97_), .O(z16));
  aoi21  g57(.a(x18), .b(x12), .c(new_n47_), .O(new_n99_));
  ...
  oai22  g64(.a(new_n70_), .b(x14), .c(x15), .d(new_n105_), .O(new_n106_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n107_), .c(new_n69_), .O(z18));
  inv1   g70(.a(x07), .O(new_n112_));
  nand2  g71(.a(new_n48_), .b(x20), .O(new_n113_));
  oai21  g72(.a(new_n48_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
