...
module FAU ( 
  ...
  nor2   g22(.a(new_n51_), .b(new_n63_), .O(z07));
  ...
  oai21  g38(.a(new_n79_), .b(x06), .c(x15), .O(new_n80_));
  ...
  oai21  g54(.a(new_n63_), .b(new_n84_), .c(new_n46_), .O(new_n96_));
  ...
  nand2  g61(.a(new_n56_), .b(x18), .O(new_n103_));
  ...
  nand3  g65(.a(x18), .b(x15), .c(new_n46_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n84_), .O(z17));
  oai21  g67(.a(new_n79_), .b(x15), .c(x06), .O(new_n109_));
