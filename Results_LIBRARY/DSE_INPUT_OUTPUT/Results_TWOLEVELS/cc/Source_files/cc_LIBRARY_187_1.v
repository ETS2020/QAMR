...
module FAU ( 
  ...
  nor2   g21(.a(new_n62_), .b(new_n43_), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  nand2  g23(.a(new_n44_), .b(new_n64_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  aoi21  g25(.a(x15), .b(new_n43_), .c(new_n66_), .O(z08));
  oai21  g26(.a(new_n47_), .b(x12), .c(x09), .O(new_n68_));
  ...
  oai21  g46(.a(new_n66_), .b(x14), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x15), .O(new_n89_));
  nand3  g48(.a(new_n55_), .b(x16), .c(new_n48_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n85_), .b(x08), .c(x04), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z16));
  ...
  nand3  g69(.a(new_n85_), .b(x08), .c(x07), .O(new_n111_));
