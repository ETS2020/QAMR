...
module FAU ( 
  ...
  nand2  g06(.a(x08), .b(x06), .O(new_n48_));
  nor4   g07(.a(new_n48_), .b(new_n43_), .c(x14), .d(new_n47_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(new_n43_), .b(x06), .c(x14), .O(new_n51_));
  ...
  nand2  g37(.a(new_n78_), .b(new_n72_), .O(z12));
  ...
  nand3  g67(.a(x18), .b(x15), .c(x06), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n86_), .O(z17));
  oai21  g69(.a(new_n60_), .b(new_n86_), .c(x06), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n74_), .b(x19), .O(new_n113_));
  oai21  g72(.a(new_n73_), .b(new_n48_), .c(new_n113_), .O(new_n114_));
  ...
  nand2  g78(.a(new_n119_), .b(new_n43_), .O(new_n120_));
  nand3  g79(.a(x20), .b(x15), .c(x06), .O(new_n121_));
  aoi21  g80(.a(new_n121_), .b(new_n120_), .c(new_n86_), .O(z19));
  buf    g81(.a(x15), .O(z06));
endmodule
