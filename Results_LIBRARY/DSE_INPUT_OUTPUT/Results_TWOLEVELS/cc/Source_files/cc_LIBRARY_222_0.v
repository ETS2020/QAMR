...
module FAU ( 
  ...
  nor2   g20(.a(new_n61_), .b(x08), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(x08), .c(new_n50_), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  aoi21  g23(.a(new_n62_), .b(x08), .c(new_n64_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nand2  g25(.a(new_n49_), .b(new_n66_), .O(z08));
  inv1   g26(.a(x08), .O(new_n68_));
  nor3   g27(.a(new_n44_), .b(new_n61_), .c(new_n68_), .O(z09));
  aoi21  g28(.a(x09), .b(x08), .c(new_n44_), .O(z10));
  nor2   g29(.a(new_n44_), .b(new_n46_), .O(z11));
  nand2  g30(.a(new_n56_), .b(x17), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n50_), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x13), .O(new_n74_));
  nand3  g33(.a(x17), .b(new_n50_), .c(x10), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x08), .c(x00), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n55_), .O(z12));
  inv1   g37(.a(x10), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n68_), .c(new_n46_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x17), .c(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n55_), .O(z13));
  nand2  g43(.a(new_n56_), .b(x15), .O(new_n85_));
  nand3  g44(.a(new_n76_), .b(x08), .c(x02), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n55_), .O(z14));
  nand4  g46(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x17), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n50_), .O(new_n90_));
  nand4  g49(.a(new_n51_), .b(x16), .c(new_n46_), .d(x12), .O(new_n91_));
  ...
  nand2  g69(.a(new_n110_), .b(x17), .O(new_n111_));
