...
module FAU ( 
  ...
  aoi21  g20(.a(new_n61_), .b(x08), .c(new_n49_), .O(z06));
  ...
  nand2  g30(.a(x13), .b(new_n67_), .O(new_n72_));
  nand3  g31(.a(new_n49_), .b(x08), .c(x00), .O(new_n73_));
  ...
  nand3  g45(.a(new_n49_), .b(x08), .c(x03), .O(new_n87_));
  ...
  nand3  g55(.a(new_n49_), .b(x08), .c(x05), .O(new_n97_));
  nand2  g56(.a(x18), .b(new_n67_), .O(new_n98_));
  ...
  oai21  g62(.a(new_n92_), .b(new_n103_), .c(x10), .O(new_n104_));
  ...
  oai21  g67(.a(new_n92_), .b(new_n108_), .c(x10), .O(new_n109_));
