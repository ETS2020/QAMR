...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    ...
    new_n59_, new_n61_, new_n63_, new_n66_, new_n70_, new_n71_, new_n72_,
  ...
  nand2  g29(.a(new_n70_), .b(new_n56_), .O(new_n71_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n49_), .c(new_n55_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n56_), .c(x15), .O(new_n81_));
  ...
  nand2  g48(.a(new_n46_), .b(new_n45_), .O(new_n90_));
  nand2  g49(.a(new_n56_), .b(x15), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x16), .c(new_n55_), .O(new_n93_));
  ...
  nand2  g58(.a(new_n99_), .b(new_n42_), .O(z16));
  ...
  oai21  g67(.a(new_n63_), .b(new_n78_), .c(new_n56_), .O(new_n109_));
