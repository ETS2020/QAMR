...
module FAU ( 
  ...
  oai21  g37(.a(new_n51_), .b(new_n67_), .c(new_n48_), .O(new_n79_));
  ...
  nand2  g45(.a(x15), .b(new_n67_), .O(new_n87_));
  ...
  nand3  g50(.a(x16), .b(new_n48_), .c(new_n67_), .O(new_n92_));
  ...
  nand2  g56(.a(x12), .b(x08), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n97_), .c(x10), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n52_), .O(new_n100_));
  nand3  g59(.a(new_n86_), .b(x17), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(z16));
  inv1   g61(.a(x05), .O(new_n103_));
  oai21  g62(.a(new_n98_), .b(new_n103_), .c(x10), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n52_), .O(new_n105_));
  nand3  g64(.a(new_n86_), .b(x18), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(z17));
  inv1   g66(.a(x06), .O(new_n108_));
  oai21  g67(.a(new_n98_), .b(new_n108_), .c(x10), .O(new_n109_));
  ...
  nand2  g72(.a(x20), .b(new_n67_), .O(new_n114_));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n78_), .O(z19));
  buf    g77(.a(x15), .O(z06));
endmodule
