...
module FAU ( 
  ...
  nand2  g37(.a(new_n49_), .b(new_n48_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x15), .c(new_n43_), .O(new_n80_));
  ...
  nand3  g59(.a(x18), .b(x15), .c(new_n43_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n70_), .O(z17));
  oai21  g61(.a(new_n60_), .b(new_n70_), .c(new_n43_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(x15), .O(new_n104_));
  nand2  g63(.a(new_n71_), .b(x19), .O(new_n105_));
  ...
  nand3  g72(.a(x20), .b(x15), .c(new_n43_), .O(new_n114_));
