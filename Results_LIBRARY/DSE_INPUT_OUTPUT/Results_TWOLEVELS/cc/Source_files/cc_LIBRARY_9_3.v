...
module FAU ( 
  ...
  nor2   g22(.a(z03), .b(new_n50_), .O(z11));
  nand2  g23(.a(new_n46_), .b(x13), .O(new_n65_));
  nand3  g24(.a(x10), .b(x08), .c(x00), .O(new_n66_));
  and2   g25(.a(new_n66_), .b(new_n45_), .O(new_n67_));
  aoi21  g26(.a(new_n67_), .b(new_n65_), .c(new_n48_), .O(z12));
  inv1   g27(.a(x01), .O(new_n69_));
  oai21  g28(.a(new_n46_), .b(new_n69_), .c(x14), .O(new_n70_));
  aoi21  g29(.a(new_n70_), .b(new_n45_), .c(new_n48_), .O(z13));
  ...
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(z16));
