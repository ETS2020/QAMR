...
module FAU ( 
  ...
  nor2   g11(.a(x18), .b(x15), .O(new_n53_));
  ...
  oai21  g17(.a(new_n58_), .b(new_n48_), .c(new_n44_), .O(z03));
  inv1   g18(.a(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nand2  g20(.a(new_n44_), .b(new_n61_), .O(z05));
  nand2  g21(.a(z04), .b(new_n43_), .O(z06));
  ...
  nand2  g31(.a(new_n48_), .b(z04), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n43_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x13), .O(new_n75_));
  nand4  g34(.a(new_n53_), .b(x10), .c(x08), .d(x00), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n72_), .O(z12));
  aoi21  g36(.a(x10), .b(x08), .c(x14), .O(new_n78_));
  or2    g37(.a(new_n78_), .b(new_n43_), .O(new_n79_));
  nand2  g38(.a(new_n49_), .b(x01), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(z04), .c(x14), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n72_), .O(z13));
  nand4  g41(.a(new_n43_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  oai21  g42(.a(new_n49_), .b(new_n43_), .c(new_n83_), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n44_), .O(z14));
  nand3  g45(.a(new_n74_), .b(x16), .c(new_n47_), .O(new_n87_));
  nand4  g46(.a(new_n53_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n72_), .O(z15));
  nand2  g48(.a(new_n74_), .b(x17), .O(new_n90_));
  nand4  g49(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n72_), .O(z16));
  nand4  g51(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(z04), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n44_), .O(z17));
  ...
  nand3  g58(.a(new_n43_), .b(x10), .c(x08), .O(new_n100_));
  nand3  g59(.a(new_n100_), .b(x19), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n99_), .O(z18));
  nand2  g61(.a(new_n48_), .b(x20), .O(new_n103_));
  nand4  g62(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(z04), .O(new_n106_));
  nand2  g65(.a(x20), .b(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n72_), .O(z19));
endmodule
