...
module FAU ( 
  ...
  nor2   g01(.a(x05), .b(x00), .O(new_n43_));
  ...
  nand4  g12(.a(new_n53_), .b(new_n44_), .c(x12), .d(new_n50_), .O(new_n54_));
  ...
  oai21  g29(.a(new_n70_), .b(x13), .c(x00), .O(new_n71_));
  nand3  g30(.a(new_n52_), .b(x13), .c(x05), .O(new_n72_));
  ...
  oai21  g53(.a(new_n70_), .b(x18), .c(x05), .O(new_n95_));
  nand3  g54(.a(new_n52_), .b(x18), .c(x00), .O(new_n96_));
  ...
  aoi22  g59(.a(new_n100_), .b(new_n99_), .c(new_n52_), .d(x19), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n69_), .c(new_n44_), .O(z18));
  and2   g61(.a(x08), .b(x07), .O(new_n103_));
  aoi22  g62(.a(new_n103_), .b(new_n99_), .c(new_n52_), .d(x20), .O(new_n104_));
