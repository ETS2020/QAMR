...
module FAU ( 
  ...
  oai21  g29(.a(new_n56_), .b(new_n70_), .c(x12), .O(new_n71_));
  ...
  nor2   g34(.a(new_n75_), .b(new_n51_), .O(new_n76_));
  ...
  nand3  g39(.a(new_n56_), .b(x15), .c(x12), .O(new_n81_));
  inv1   g40(.a(x02), .O(new_n82_));
  oai21  g41(.a(new_n56_), .b(new_n82_), .c(x12), .O(new_n83_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n91_), .c(new_n50_), .O(z16));
  nand3  g54(.a(x10), .b(x08), .c(x05), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x12), .O(new_n97_));
  aoi21  g56(.a(new_n56_), .b(x18), .c(new_n97_), .O(new_n98_));
  nand3  g57(.a(x18), .b(x15), .c(x12), .O(new_n99_));
  oai21  g58(.a(new_n98_), .b(x15), .c(new_n99_), .O(z17));
  nand2  g59(.a(new_n52_), .b(x19), .O(new_n101_));
  nand3  g60(.a(new_n93_), .b(x08), .c(x06), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n50_), .O(z18));
  nand2  g62(.a(new_n52_), .b(x20), .O(new_n104_));
  nand3  g63(.a(new_n93_), .b(x08), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n50_), .O(z19));
endmodule
