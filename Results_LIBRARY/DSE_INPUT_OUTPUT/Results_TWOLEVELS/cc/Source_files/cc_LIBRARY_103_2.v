...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n71_, new_n75_, new_n76_, new_n77_, new_n78_, new_n80_, new_n81_,
  ...
  nand2  g21(.a(new_n50_), .b(x18), .O(z04));
  ...
  nand2  g27(.a(new_n68_), .b(new_n44_), .O(z08));
  ...
  aoi21  g34(.a(x13), .b(x12), .c(new_n68_), .O(new_n76_));
  and2   g35(.a(x08), .b(x00), .O(new_n77_));
  aoi22  g36(.a(new_n77_), .b(new_n52_), .c(new_n57_), .d(x13), .O(new_n78_));
  oai22  g37(.a(new_n78_), .b(new_n75_), .c(new_n76_), .d(new_n44_), .O(z12));
  nand2  g38(.a(new_n48_), .b(new_n47_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x16), .c(x15), .O(new_n81_));
  ...
  nand3  g43(.a(new_n57_), .b(x16), .c(x15), .O(new_n85_));
  nand3  g44(.a(new_n52_), .b(x08), .c(x02), .O(new_n86_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n51_), .O(new_n90_));
  nand3  g49(.a(new_n57_), .b(x16), .c(new_n47_), .O(new_n91_));
  inv1   g50(.a(new_n91_), .O(new_n92_));
  aoi21  g51(.a(new_n90_), .b(x08), .c(new_n92_), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n75_), .c(new_n50_), .O(z15));
  aoi21  g53(.a(x17), .b(x12), .c(new_n68_), .O(new_n95_));
  and2   g54(.a(x08), .b(x04), .O(new_n96_));
  aoi22  g55(.a(new_n96_), .b(new_n52_), .c(new_n57_), .d(x17), .O(new_n97_));
  oai22  g56(.a(new_n97_), .b(new_n75_), .c(new_n95_), .d(new_n44_), .O(z16));
  aoi21  g57(.a(x18), .b(x12), .c(new_n68_), .O(new_n99_));
  and2   g58(.a(x08), .b(x05), .O(new_n100_));
  aoi22  g59(.a(new_n100_), .b(new_n52_), .c(new_n57_), .d(x18), .O(new_n101_));
  oai22  g60(.a(new_n101_), .b(new_n75_), .c(new_n99_), .d(new_n44_), .O(z17));
  aoi21  g61(.a(x19), .b(x12), .c(new_n68_), .O(new_n103_));
  and2   g62(.a(x08), .b(x06), .O(new_n104_));
  aoi22  g63(.a(new_n104_), .b(new_n52_), .c(new_n57_), .d(x19), .O(new_n105_));
  oai22  g64(.a(new_n105_), .b(new_n75_), .c(new_n103_), .d(new_n44_), .O(z18));
  inv1   g65(.a(x07), .O(new_n107_));
  nand2  g66(.a(new_n57_), .b(x20), .O(new_n108_));
  oai21  g67(.a(new_n57_), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n44_), .O(new_n110_));
  nand3  g69(.a(x20), .b(x16), .c(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n75_), .O(z19));
  buf    g71(.a(x15), .O(z06));
endmodule
