...
module FAU ( 
  ...
  nor2   g49(.a(x15), .b(new_n79_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n90_), .c(new_n77_), .O(z15));
  ...
  nand3  g58(.a(new_n91_), .b(x08), .c(x05), .O(new_n100_));
  ...
  oai21  g63(.a(new_n72_), .b(new_n59_), .c(new_n104_), .O(z18));
  ...
  oai21  g67(.a(new_n72_), .b(new_n43_), .c(new_n108_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
