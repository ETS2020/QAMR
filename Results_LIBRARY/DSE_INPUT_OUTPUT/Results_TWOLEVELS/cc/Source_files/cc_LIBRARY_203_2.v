...
module FAU ( 
  ...
  aoi21  g11(.a(new_n52_), .b(new_n48_), .c(x06), .O(new_n53_));
  nor2   g12(.a(new_n51_), .b(new_n48_), .O(new_n54_));
  oai21  g13(.a(new_n54_), .b(new_n53_), .c(x12), .O(new_n55_));
  nor2   g14(.a(new_n55_), .b(x11), .O(z02));
  inv1   g15(.a(x12), .O(new_n57_));
  nor4   g16(.a(new_n47_), .b(new_n51_), .c(x14), .d(new_n57_), .O(z03));
  ...
  oai21  g37(.a(new_n78_), .b(new_n67_), .c(new_n48_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  nand3  g39(.a(x10), .b(x08), .c(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x14), .c(new_n43_), .O(new_n82_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n57_), .O(z14));
  nand3  g46(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n88_));
  ...
  nor2   g52(.a(new_n57_), .b(new_n78_), .O(new_n94_));
  ...
  aoi21  g63(.a(new_n47_), .b(new_n43_), .c(x15), .O(new_n105_));
  nor3   g64(.a(new_n105_), .b(new_n60_), .c(new_n57_), .O(z18));
  nand3  g65(.a(new_n94_), .b(x08), .c(x07), .O(new_n107_));
