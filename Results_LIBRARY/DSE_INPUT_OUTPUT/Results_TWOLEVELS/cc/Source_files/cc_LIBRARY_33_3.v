...
module FAU ( 
  ...
  aoi21  g18(.a(new_n59_), .b(new_n48_), .c(new_n45_), .O(z06));
  ...
  nand2  g27(.a(new_n43_), .b(new_n50_), .O(z11));
  nand2  g28(.a(new_n46_), .b(x13), .O(new_n70_));
  nand3  g29(.a(x10), .b(x08), .c(x00), .O(new_n71_));
  and2   g30(.a(new_n71_), .b(new_n45_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(new_n70_), .c(new_n48_), .O(z12));
  inv1   g32(.a(x01), .O(new_n74_));
  oai21  g33(.a(new_n46_), .b(new_n74_), .c(x14), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n45_), .c(new_n48_), .O(z13));
  nand3  g35(.a(x10), .b(x08), .c(x02), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n45_), .c(new_n48_), .O(z14));
  nand3  g37(.a(new_n46_), .b(x16), .c(new_n50_), .O(new_n79_));
