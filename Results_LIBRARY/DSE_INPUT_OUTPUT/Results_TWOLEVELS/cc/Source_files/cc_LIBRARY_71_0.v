...
module FAU ( 
  ...
  nand3  g30(.a(x19), .b(new_n51_), .c(x10), .O(new_n72_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n64_), .c(new_n46_), .O(new_n77_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n87_), .O(z15));
  ...
  nor2   g58(.a(new_n64_), .b(x06), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n88_), .O(new_n101_));
