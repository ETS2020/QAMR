...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x06), .c(new_n44_), .O(z01));
  oai21  g09(.a(new_n44_), .b(x06), .c(x14), .O(new_n51_));
  nand3  g10(.a(new_n44_), .b(x10), .c(x08), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(new_n51_), .O(new_n53_));
  nand3  g12(.a(new_n53_), .b(x12), .c(new_n42_), .O(new_n54_));
  inv1   g13(.a(new_n54_), .O(z02));
  nand4  g14(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n56_));
  ...
  nand2  g31(.a(x15), .b(x06), .O(new_n73_));
  ...
  nand2  g38(.a(new_n49_), .b(new_n48_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(x15), .c(x06), .O(new_n81_));
  ...
  nand3  g43(.a(new_n71_), .b(x15), .c(x06), .O(new_n85_));
  ...
  oai21  g49(.a(new_n61_), .b(new_n70_), .c(x06), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand2  g51(.a(new_n71_), .b(x17), .O(new_n93_));
  nand4  g52(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n94_));
  ...
  nand2  g64(.a(new_n52_), .b(new_n59_), .O(new_n106_));
  ...
  oai21  g68(.a(new_n43_), .b(new_n70_), .c(x06), .O(new_n110_));
