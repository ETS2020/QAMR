...
module FAU ( 
  ...
  nand2  g18(.a(new_n50_), .b(x13), .O(z06));
  ...
  and2   g37(.a(x08), .b(x02), .O(new_n79_));
  nand4  g38(.a(new_n79_), .b(new_n50_), .c(x13), .d(x10), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n55_), .O(z14));
  nand3  g40(.a(new_n46_), .b(x16), .c(new_n47_), .O(new_n82_));
  ...
  nand3  g44(.a(x16), .b(x15), .c(new_n47_), .O(new_n86_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n55_), .O(z19));
endmodule
