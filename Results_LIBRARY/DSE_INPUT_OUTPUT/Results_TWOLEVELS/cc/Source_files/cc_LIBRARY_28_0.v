...
module FAU ( 
  ...
  wire new_n43_, new_n44_, new_n45_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n52_, new_n55_, new_n57_, new_n59_, new_n61_, new_n63_, new_n64_,
  ...
  nand2  g16(.a(new_n57_), .b(x11), .O(z06));
  ...
  nor3   g23(.a(new_n43_), .b(new_n64_), .c(new_n63_), .O(z09));
  ...
  nand2  g28(.a(new_n69_), .b(new_n57_), .O(new_n70_));
  nand3  g29(.a(new_n57_), .b(x10), .c(x08), .O(new_n71_));
  nand3  g30(.a(new_n71_), .b(x13), .c(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(new_n70_), .O(z12));
  aoi21  g32(.a(x10), .b(x08), .c(x14), .O(new_n74_));
  nor2   g33(.a(new_n74_), .b(new_n57_), .O(new_n75_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n57_), .O(new_n87_));
  nand4  g46(.a(new_n71_), .b(x16), .c(new_n46_), .d(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n87_), .O(z15));
  inv1   g48(.a(x12), .O(new_n90_));
  nand2  g49(.a(new_n45_), .b(x17), .O(new_n91_));
  nand4  g50(.a(new_n57_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x11), .O(new_n94_));
  nand2  g53(.a(x17), .b(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n90_), .O(z16));
  ...
  nand3  g58(.a(new_n71_), .b(x18), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(z17));
  nand2  g60(.a(new_n45_), .b(x19), .O(new_n102_));
  nand4  g61(.a(new_n57_), .b(x10), .c(x08), .d(x06), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x11), .O(new_n105_));
  nand2  g64(.a(x19), .b(x15), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n90_), .O(z18));
  nand4  g66(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x11), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n57_), .O(new_n110_));
  nand3  g69(.a(new_n71_), .b(x20), .c(x12), .O(new_n111_));
