...
module FAU ( 
  ...
  aoi21  g12(.a(new_n53_), .b(new_n45_), .c(new_n42_), .O(z03));
  nor2   g13(.a(new_n42_), .b(new_n45_), .O(new_n55_));
  ...
  nand2  g21(.a(new_n58_), .b(new_n62_), .O(z08));
  nand3  g22(.a(new_n58_), .b(x09), .c(x08), .O(new_n64_));
  ...
  nand2  g45(.a(new_n86_), .b(new_n58_), .O(z14));
  ...
  nand3  g49(.a(new_n71_), .b(x16), .c(new_n46_), .O(new_n91_));
  ...
  nand4  g65(.a(new_n42_), .b(x10), .c(x08), .d(x05), .O(new_n107_));
  ...
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n96_), .O(z18));
