...
module FAU ( 
  ...
  nand3  g16(.a(new_n57_), .b(new_n52_), .c(x12), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n43_), .c(new_n42_), .O(z03));
  nor2   g18(.a(new_n44_), .b(x18), .O(z04));
  nor2   g19(.a(new_n43_), .b(x15), .O(z05));
  ...
  oai21  g53(.a(new_n62_), .b(new_n70_), .c(new_n43_), .O(new_n95_));
  ...
  oai21  g70(.a(new_n48_), .b(new_n110_), .c(new_n111_), .O(new_n112_));
  nand3  g71(.a(new_n112_), .b(new_n42_), .c(x12), .O(new_n113_));
  ...
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n70_), .O(z19));
  buf    g79(.a(x15), .O(z06));
endmodule
