...
module FAU ( 
  ...
  nor2   g18(.a(new_n51_), .b(x08), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(x08), .c(new_n59_), .O(z05));
  oai21  g20(.a(new_n59_), .b(x15), .c(x08), .O(new_n62_));
  inv1   g21(.a(x08), .O(new_n63_));
  nand2  g22(.a(x15), .b(new_n63_), .O(new_n64_));
  nand3  g23(.a(new_n64_), .b(new_n62_), .c(new_n46_), .O(z06));
