...
module FAU ( 
  ...
  oai21  g31(.a(new_n47_), .b(new_n72_), .c(x12), .O(new_n73_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n56_), .O(z14));
  ...
  nand3  g52(.a(new_n85_), .b(x08), .c(x04), .O(new_n94_));
  ...
  nand3  g65(.a(new_n85_), .b(x08), .c(x07), .O(new_n107_));
