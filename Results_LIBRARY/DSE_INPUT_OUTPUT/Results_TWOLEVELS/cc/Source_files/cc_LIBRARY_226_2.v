...
module FAU ( 
  ...
  oai21  g40(.a(new_n81_), .b(new_n71_), .c(new_n47_), .O(new_n82_));
  ...
  oai21  g49(.a(new_n49_), .b(x03), .c(new_n52_), .O(new_n91_));
  nand4  g50(.a(new_n91_), .b(x16), .c(new_n47_), .d(x12), .O(new_n92_));
  inv1   g51(.a(new_n92_), .O(z15));
  nor2   g52(.a(new_n58_), .b(new_n81_), .O(new_n94_));
  ...
  oai21  g64(.a(new_n49_), .b(new_n61_), .c(new_n105_), .O(new_n106_));
