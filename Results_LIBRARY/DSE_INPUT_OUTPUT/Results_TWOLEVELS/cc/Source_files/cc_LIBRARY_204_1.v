...
module FAU ( 
  ...
  nor4   g18(.a(new_n59_), .b(new_n58_), .c(x14), .d(new_n57_), .O(z03));
  nor2   g19(.a(new_n44_), .b(x18), .O(z04));
  nand2  g20(.a(new_n43_), .b(new_n58_), .O(z06));
  ...
  nand2  g42(.a(new_n59_), .b(x15), .O(new_n84_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n58_), .O(new_n89_));
  nand4  g48(.a(new_n74_), .b(x16), .c(new_n47_), .d(x12), .O(new_n90_));
  ...
  nand2  g52(.a(new_n93_), .b(new_n58_), .O(new_n94_));
  nand3  g53(.a(new_n74_), .b(x17), .c(x12), .O(new_n95_));
  ...
  nand2  g64(.a(new_n105_), .b(new_n58_), .O(new_n106_));
