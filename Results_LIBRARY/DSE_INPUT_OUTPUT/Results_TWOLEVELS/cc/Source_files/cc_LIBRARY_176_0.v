...
module FAU ( 
  ...
  aoi21  g36(.a(new_n77_), .b(x01), .c(new_n48_), .O(new_n78_));
  ...
  nand3  g49(.a(new_n85_), .b(x08), .c(x04), .O(new_n91_));
  ...
  nand3  g54(.a(new_n85_), .b(x08), .c(x05), .O(new_n96_));
  ...
  nand3  g59(.a(new_n85_), .b(x08), .c(x06), .O(new_n101_));
  ...
  nand3  g64(.a(new_n85_), .b(x08), .c(x07), .O(new_n106_));
