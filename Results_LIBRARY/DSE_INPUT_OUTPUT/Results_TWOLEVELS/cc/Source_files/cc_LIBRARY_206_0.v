...
module FAU ( 
  ...
  oai21  g12(.a(new_n47_), .b(new_n51_), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g40(.a(new_n46_), .b(x15), .c(x12), .O(new_n82_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n87_), .c(new_n51_), .O(z15));
  ...
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n51_), .O(z17));
