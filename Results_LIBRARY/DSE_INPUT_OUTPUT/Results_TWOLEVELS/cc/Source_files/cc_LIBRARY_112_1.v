...
module FAU ( 
  ...
  aoi21  g08(.a(new_n49_), .b(x07), .c(new_n47_), .O(z01));
  oai21  g09(.a(new_n47_), .b(x07), .c(x14), .O(new_n51_));
  ...
  nor2   g15(.a(new_n56_), .b(new_n44_), .O(new_n57_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n56_), .c(new_n48_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x15), .c(x07), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x01), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n47_), .c(x14), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n80_), .O(z13));
  nand3  g45(.a(new_n74_), .b(x15), .c(x07), .O(new_n87_));
  ...
  nand2  g56(.a(new_n74_), .b(x17), .O(new_n98_));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n80_), .O(z16));
  nand2  g62(.a(new_n74_), .b(x18), .O(new_n104_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n80_), .O(z17));
  nand2  g68(.a(new_n74_), .b(x19), .O(new_n110_));
  ...
  nand3  g72(.a(x19), .b(x15), .c(x07), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n80_), .O(z18));
  nand2  g74(.a(new_n52_), .b(new_n43_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x07), .O(new_n117_));
  nand3  g76(.a(new_n74_), .b(x20), .c(new_n47_), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n80_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
