...
module FAU ( 
  ...
  oai21  g42(.a(new_n49_), .b(new_n52_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g55(.a(new_n72_), .b(x08), .c(x05), .O(new_n97_));
  ...
  aoi21  g60(.a(new_n48_), .b(new_n43_), .c(x15), .O(new_n102_));
  nor3   g61(.a(new_n102_), .b(new_n61_), .c(new_n58_), .O(z18));
