...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n65_), .c(new_n55_), .O(new_n80_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n59_), .O(z14));
  nand2  g48(.a(new_n44_), .b(x03), .O(new_n90_));
  nand3  g49(.a(x16), .b(x15), .c(new_n55_), .O(new_n91_));
  ...
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n78_), .O(z15));
  ...
  nand3  g58(.a(x17), .b(x16), .c(x15), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n78_), .O(z16));
  ...
  nand3  g64(.a(x18), .b(x16), .c(x15), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n78_), .O(z17));
  oai21  g66(.a(new_n61_), .b(new_n78_), .c(x16), .O(new_n108_));
  ...
  oai21  g73(.a(new_n43_), .b(new_n78_), .c(x16), .O(new_n115_));
