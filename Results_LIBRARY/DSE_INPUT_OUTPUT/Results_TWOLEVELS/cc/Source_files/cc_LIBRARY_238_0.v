...
module FAU ( 
  ...
  oai21  g28(.a(new_n56_), .b(new_n69_), .c(x12), .O(new_n70_));
  ...
  nand3  g38(.a(new_n56_), .b(x15), .c(x12), .O(new_n80_));
  inv1   g39(.a(x02), .O(new_n81_));
  oai21  g40(.a(new_n56_), .b(new_n81_), .c(x12), .O(new_n82_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n50_), .O(z16));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n50_), .O(z18));
  nand2  g57(.a(new_n52_), .b(x20), .O(new_n99_));
  nand3  g58(.a(new_n87_), .b(x08), .c(x07), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n50_), .O(z19));
endmodule
