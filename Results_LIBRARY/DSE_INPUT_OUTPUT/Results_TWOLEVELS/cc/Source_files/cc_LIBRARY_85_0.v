...
module FAU ( 
  ...
  nand3  g30(.a(new_n58_), .b(x09), .c(x08), .O(z10));
  nand2  g31(.a(new_n58_), .b(new_n46_), .O(z11));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n74_), .O(z12));
  ...
  aoi21  g48(.a(x16), .b(new_n46_), .c(new_n87_), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n74_), .c(new_n58_), .O(z15));
  nand4  g50(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  oai21  g51(.a(new_n48_), .b(new_n65_), .c(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x03), .O(new_n94_));
