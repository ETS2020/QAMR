...
module FAU ( 
  ...
  nand2  g06(.a(new_n47_), .b(x12), .O(new_n48_));
  ...
  nand2  g39(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x14), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n49_), .O(z13));
  nand2  g42(.a(x15), .b(new_n67_), .O(new_n84_));
  ...
  oai21  g49(.a(new_n65_), .b(x14), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand3  g51(.a(new_n73_), .b(x16), .c(new_n46_), .O(new_n93_));
  nand4  g52(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  ...
  nand4  g58(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n100_));
  ...
  nand4  g64(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n106_));
  ...
  nand2  g68(.a(new_n53_), .b(x19), .O(new_n110_));
  nor2   g69(.a(x15), .b(new_n88_), .O(new_n111_));
  nand3  g70(.a(new_n111_), .b(x08), .c(x06), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n110_), .c(new_n43_), .O(z18));
  nand2  g72(.a(new_n53_), .b(x20), .O(new_n114_));
  nand3  g73(.a(new_n111_), .b(x08), .c(x07), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n43_), .O(z19));
  inv1   g75(.a(new_n49_), .O(z03));
endmodule
