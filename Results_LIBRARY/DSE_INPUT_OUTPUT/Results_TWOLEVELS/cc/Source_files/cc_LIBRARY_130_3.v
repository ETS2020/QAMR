...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n55_, new_n57_, new_n58_, new_n59_, new_n60_, new_n63_,
  ...
  nor2   g27(.a(z03), .b(new_n49_), .O(z11));
  ...
  nand3  g38(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n80_));
  nand3  g39(.a(x10), .b(x08), .c(x03), .O(new_n81_));
  and2   g40(.a(new_n81_), .b(new_n45_), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n57_), .O(z15));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n96_), .c(new_n57_), .O(z19));
endmodule
