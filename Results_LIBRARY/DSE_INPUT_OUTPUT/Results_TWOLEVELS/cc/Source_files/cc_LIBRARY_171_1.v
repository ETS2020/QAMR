...
module FAU ( 
  ...
  aoi22  g27(.a(x15), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  ...
  oai21  g36(.a(new_n77_), .b(new_n66_), .c(new_n47_), .O(new_n78_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n43_), .O(z14));
  ...
  nand3  g62(.a(new_n84_), .b(x08), .c(x06), .O(new_n104_));
