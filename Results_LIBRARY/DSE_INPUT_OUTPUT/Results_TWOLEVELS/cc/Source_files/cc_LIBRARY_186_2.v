...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n43_), .c(x11), .O(z02));
  ...
  aoi21  g25(.a(x11), .b(new_n47_), .c(new_n43_), .O(z09));
  ...
  oai21  g33(.a(new_n74_), .b(new_n70_), .c(new_n45_), .O(z12));
  ...
  oai21  g52(.a(new_n93_), .b(new_n70_), .c(new_n45_), .O(z16));
  ...
  aoi22  g59(.a(new_n100_), .b(new_n72_), .c(new_n52_), .d(x19), .O(new_n101_));
  oai21  g60(.a(new_n101_), .b(new_n70_), .c(new_n45_), .O(z18));
