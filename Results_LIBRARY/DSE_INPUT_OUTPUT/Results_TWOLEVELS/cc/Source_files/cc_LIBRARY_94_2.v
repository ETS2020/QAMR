...
module FAU ( 
  ...
  nand2  g06(.a(x15), .b(new_n43_), .O(new_n48_));
  oai21  g07(.a(new_n48_), .b(new_n47_), .c(new_n45_), .O(z01));
  inv1   g08(.a(x15), .O(new_n50_));
  nand3  g09(.a(new_n50_), .b(x10), .c(x08), .O(new_n51_));
  nand2  g10(.a(new_n51_), .b(new_n43_), .O(new_n52_));
  nand2  g11(.a(new_n52_), .b(x12), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(x11), .c(new_n45_), .O(z02));
  inv1   g13(.a(x12), .O(new_n55_));
  nor4   g14(.a(new_n47_), .b(new_n50_), .c(x14), .d(new_n55_), .O(z03));
  ...
  nand2  g21(.a(new_n62_), .b(new_n45_), .O(z06));
  ...
  nor3   g27(.a(new_n44_), .b(new_n68_), .c(new_n60_), .O(z09));
  aoi21  g28(.a(x09), .b(x08), .c(new_n44_), .O(z10));
  nor2   g29(.a(new_n50_), .b(new_n43_), .O(z11));
  aoi21  g30(.a(x10), .b(x08), .c(x14), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(x15), .c(x13), .O(new_n73_));
  nand3  g32(.a(new_n50_), .b(new_n43_), .c(x10), .O(new_n74_));
  ...
  nand3  g50(.a(new_n51_), .b(x17), .c(x12), .O(new_n92_));
