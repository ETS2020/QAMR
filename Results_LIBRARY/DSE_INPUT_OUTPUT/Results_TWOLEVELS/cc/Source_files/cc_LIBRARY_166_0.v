...
module FAU ( 
  ...
  and2   g32(.a(x12), .b(x10), .O(new_n74_));
  ...
  nand3  g36(.a(new_n52_), .b(x13), .c(x12), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(new_n77_), .O(z12));
  inv1   g38(.a(x10), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n62_), .c(new_n47_), .O(new_n81_));
  aoi22  g40(.a(new_n81_), .b(x15), .c(new_n46_), .d(x14), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n57_), .c(new_n44_), .O(z13));
  nand2  g42(.a(new_n46_), .b(x15), .O(new_n84_));
  inv1   g43(.a(new_n52_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x02), .c(x01), .O(new_n86_));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n57_), .O(z19));
endmodule
