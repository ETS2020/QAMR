...
module FAU ( 
  ...
  nand2  g17(.a(x19), .b(x15), .O(new_n59_));
  ...
  nand2  g22(.a(new_n63_), .b(new_n45_), .O(z06));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n59_), .c(new_n55_), .O(z18));
  nand2  g60(.a(new_n56_), .b(x20), .O(new_n102_));
