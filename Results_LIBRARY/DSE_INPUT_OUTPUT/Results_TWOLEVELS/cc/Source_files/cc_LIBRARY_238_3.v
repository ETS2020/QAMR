...
module FAU ( 
  ...
  nand2  g15(.a(x09), .b(x08), .O(new_n58_));
  nand2  g16(.a(new_n58_), .b(new_n42_), .O(z09));
  inv1   g17(.a(z09), .O(z10));
  inv1   g18(.a(x14), .O(new_n61_));
  nand2  g19(.a(new_n42_), .b(new_n61_), .O(z11));
