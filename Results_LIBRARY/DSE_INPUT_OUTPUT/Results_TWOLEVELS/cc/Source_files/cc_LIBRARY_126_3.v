...
module FAU ( 
  ...
  nor2   g11(.a(new_n44_), .b(new_n43_), .O(new_n53_));
  ...
  nor2   g16(.a(new_n53_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n53_), .b(new_n59_), .O(z05));
  nor2   g19(.a(x20), .b(new_n43_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nand2  g21(.a(new_n54_), .b(new_n62_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nor2   g23(.a(new_n53_), .b(new_n64_), .O(z08));
  nand2  g24(.a(x09), .b(x08), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n54_), .O(z09));
  inv1   g26(.a(z09), .O(z10));
  nand2  g27(.a(new_n54_), .b(new_n49_), .O(z11));
  ...
  oai21  g33(.a(new_n74_), .b(new_n50_), .c(new_n73_), .O(new_n75_));
  ...
  nand2  g41(.a(new_n82_), .b(new_n54_), .O(z13));
  inv1   g42(.a(x12), .O(new_n84_));
  nand3  g43(.a(new_n46_), .b(new_n44_), .c(x15), .O(new_n85_));
  ...
  nand3  g49(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n91_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n84_), .O(z16));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n84_), .O(z17));
  ...
  nand3  g70(.a(new_n44_), .b(x19), .c(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n84_), .O(z18));
  nand2  g72(.a(new_n46_), .b(x20), .O(new_n114_));
  nand2  g73(.a(x08), .b(x07), .O(new_n115_));
  oai21  g74(.a(new_n115_), .b(new_n50_), .c(new_n114_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x12), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(new_n54_), .O(z19));
endmodule
