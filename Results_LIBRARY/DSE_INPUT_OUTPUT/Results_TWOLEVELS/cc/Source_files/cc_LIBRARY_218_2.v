...
module FAU ( 
  ...
  nand3  g45(.a(new_n74_), .b(x16), .c(x15), .O(new_n87_));
  ...
  nand3  g52(.a(new_n74_), .b(x16), .c(new_n47_), .O(new_n94_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n86_), .O(z16));
  ...
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n86_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n86_), .c(x16), .O(new_n116_));
