...
module FAU ( 
  ...
  or2    g37(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  ...
  nand3  g48(.a(new_n44_), .b(new_n53_), .c(x10), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n89_), .c(new_n77_), .O(z15));
  nand3  g52(.a(new_n91_), .b(x08), .c(x04), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n64_), .c(new_n77_), .O(z16));
  nand2  g54(.a(new_n48_), .b(x18), .O(new_n96_));
  nand4  g55(.a(new_n53_), .b(x10), .c(x08), .d(x05), .O(new_n97_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n77_), .O(z18));
