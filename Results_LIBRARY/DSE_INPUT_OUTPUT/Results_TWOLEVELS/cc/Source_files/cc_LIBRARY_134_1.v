...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x05), .c(new_n44_), .O(z01));
  ...
  nand4  g13(.a(x12), .b(x10), .c(x08), .d(x05), .O(new_n55_));
  ...
  aoi21  g21(.a(new_n62_), .b(x05), .c(new_n44_), .O(z06));
  inv1   g22(.a(x17), .O(new_n64_));
  nor2   g23(.a(new_n45_), .b(new_n64_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nand2  g25(.a(new_n50_), .b(new_n66_), .O(z08));
  oai21  g26(.a(new_n44_), .b(x05), .c(x09), .O(new_n68_));
  ...
  oai21  g34(.a(new_n75_), .b(x15), .c(new_n70_), .O(new_n76_));
  ...
  aoi21  g39(.a(new_n80_), .b(new_n77_), .c(new_n73_), .O(z12));
  nand2  g40(.a(x08), .b(x05), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n78_), .c(new_n47_), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x01), .O(new_n84_));
  aoi22  g43(.a(new_n84_), .b(x14), .c(new_n83_), .d(x15), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n73_), .c(new_n50_), .O(z13));
  nand4  g45(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
  oai21  g46(.a(new_n75_), .b(new_n44_), .c(new_n87_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n50_), .O(z14));
  nand3  g49(.a(new_n76_), .b(x16), .c(new_n47_), .O(new_n91_));
  nand3  g50(.a(new_n79_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n73_), .O(z15));
  oai21  g52(.a(new_n64_), .b(new_n73_), .c(x05), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x15), .O(new_n95_));
  nand4  g54(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n96_));
  oai21  g55(.a(new_n75_), .b(new_n64_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n95_), .O(z16));
  inv1   g58(.a(new_n51_), .O(new_n100_));
  oai21  g59(.a(new_n100_), .b(x18), .c(x05), .O(new_n101_));
  nand3  g60(.a(new_n74_), .b(x18), .c(new_n44_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n73_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand2  g63(.a(new_n74_), .b(x19), .O(new_n105_));
  oai21  g64(.a(new_n74_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n44_), .O(new_n107_));
  nand3  g66(.a(x19), .b(x15), .c(x05), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n73_), .O(z18));
  oai21  g68(.a(new_n43_), .b(new_n73_), .c(x05), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand4  g70(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n112_));
  oai21  g71(.a(new_n75_), .b(new_n43_), .c(new_n112_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n111_), .O(z19));
endmodule
