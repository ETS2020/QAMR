...
module FAU ( 
  ...
  oai21  g35(.a(new_n72_), .b(new_n76_), .c(new_n48_), .O(new_n77_));
  ...
  nand3  g46(.a(new_n73_), .b(x08), .c(x03), .O(new_n88_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n70_), .O(z16));
  inv1   g51(.a(x18), .O(new_n93_));
  nand2  g52(.a(new_n52_), .b(x10), .O(new_n94_));
  nor2   g53(.a(x15), .b(x08), .O(new_n95_));
  aoi21  g54(.a(new_n94_), .b(x12), .c(new_n95_), .O(new_n96_));
  nand3  g55(.a(x10), .b(x08), .c(x05), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  oai21  g58(.a(new_n96_), .b(new_n93_), .c(new_n99_), .O(z17));
  nand2  g59(.a(new_n53_), .b(x19), .O(new_n101_));
  nand3  g60(.a(new_n73_), .b(x08), .c(x06), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n70_), .O(z18));
  nand2  g62(.a(new_n53_), .b(x20), .O(new_n104_));
  nand3  g63(.a(new_n73_), .b(x08), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n70_), .O(z19));
  buf    g65(.a(x15), .O(z06));
endmodule
