...
module FAU ( 
  ...
  aoi21  g16(.a(new_n57_), .b(x07), .c(new_n48_), .O(z03));
  ...
  nor2   g27(.a(new_n61_), .b(new_n52_), .O(z11));
  ...
  nand3  g42(.a(new_n83_), .b(x15), .c(x07), .O(new_n84_));
  ...
  nand3  g48(.a(new_n83_), .b(x16), .c(new_n52_), .O(new_n90_));
  ...
  nand2  g53(.a(new_n83_), .b(x17), .O(new_n95_));
  ...
  nand2  g62(.a(new_n83_), .b(x18), .O(new_n104_));
  ...
  oai21  g67(.a(new_n60_), .b(new_n70_), .c(x07), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g69(.a(new_n83_), .b(x19), .O(new_n111_));
  ...
  oai21  g74(.a(new_n43_), .b(new_n70_), .c(x07), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n83_), .b(x20), .O(new_n118_));
  oai21  g77(.a(new_n53_), .b(new_n49_), .c(new_n118_), .O(new_n119_));
