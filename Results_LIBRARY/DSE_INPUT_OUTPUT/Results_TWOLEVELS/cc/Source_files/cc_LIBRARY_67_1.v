...
module FAU ( 
  ...
  aoi21  g23(.a(new_n64_), .b(x04), .c(new_n44_), .O(z06));
  ...
  oai21  g28(.a(new_n44_), .b(x04), .c(x09), .O(new_n70_));
  nor2   g29(.a(new_n70_), .b(new_n56_), .O(z09));
  aoi22  g30(.a(x15), .b(new_n55_), .c(x09), .d(x08), .O(z10));
  nor2   g31(.a(new_n45_), .b(new_n48_), .O(z11));
  ...
  nand2  g42(.a(new_n49_), .b(new_n48_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x15), .c(x04), .O(new_n85_));
  nand3  g44(.a(x10), .b(x08), .c(x01), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(new_n44_), .c(x14), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n83_), .O(z13));
  nand3  g47(.a(new_n77_), .b(x15), .c(x04), .O(new_n89_));
  inv1   g48(.a(x10), .O(new_n90_));
  nor2   g49(.a(x15), .b(new_n90_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x08), .c(x02), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n89_), .c(new_n83_), .O(z14));
  nand2  g52(.a(x15), .b(x04), .O(new_n94_));
  nand2  g53(.a(new_n77_), .b(new_n44_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(x16), .c(new_n48_), .O(new_n97_));
  nand3  g56(.a(new_n91_), .b(x08), .c(x03), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n83_), .O(z15));
  nand2  g58(.a(new_n51_), .b(new_n66_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x04), .O(new_n101_));
  nand3  g60(.a(new_n77_), .b(x17), .c(new_n44_), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n83_), .O(z16));
  nand2  g62(.a(x18), .b(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x04), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand2  g65(.a(new_n77_), .b(x18), .O(new_n107_));
  ...
  nand2  g70(.a(new_n77_), .b(x19), .O(new_n112_));
  ...
  nand3  g74(.a(x19), .b(x15), .c(x04), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n83_), .O(z18));
  oai21  g76(.a(new_n43_), .b(new_n83_), .c(x04), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n77_), .b(x20), .O(new_n120_));
