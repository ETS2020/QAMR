...
module FAU ( 
  ...
  nand4  g08(.a(new_n46_), .b(x15), .c(new_n49_), .d(x10), .O(new_n50_));
  ...
  oai21  g17(.a(new_n58_), .b(new_n57_), .c(new_n46_), .O(z03));
  ...
  oai21  g27(.a(x20), .b(new_n44_), .c(x09), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n48_), .O(z09));
  aoi22  g29(.a(new_n43_), .b(x17), .c(x09), .d(x08), .O(z10));
  ...
  nand2  g53(.a(x20), .b(x17), .O(new_n95_));
  ...
  nand3  g57(.a(new_n53_), .b(x20), .c(x17), .O(new_n99_));
  ...
  aoi22  g67(.a(new_n108_), .b(new_n107_), .c(new_n53_), .d(x19), .O(new_n109_));
  oai21  g68(.a(new_n109_), .b(new_n94_), .c(new_n46_), .O(z18));
  nand2  g69(.a(new_n53_), .b(x20), .O(new_n111_));
  nand2  g70(.a(new_n96_), .b(new_n43_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x07), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n111_), .c(new_n94_), .O(z19));
endmodule
