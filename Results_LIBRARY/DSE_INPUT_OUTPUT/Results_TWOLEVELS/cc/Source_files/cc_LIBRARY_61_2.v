...
module FAU ( 
  ...
  nand3  g40(.a(new_n81_), .b(x19), .c(x15), .O(new_n82_));
  ...
  nand3  g44(.a(new_n48_), .b(x19), .c(x15), .O(new_n86_));
  nand4  g45(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n78_), .O(z14));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n78_), .O(z16));
  ...
  nand3  g70(.a(x19), .b(x15), .c(new_n55_), .O(new_n112_));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n114_), .c(new_n78_), .O(z18));
  oai21  g77(.a(new_n43_), .b(new_n78_), .c(x19), .O(new_n119_));
