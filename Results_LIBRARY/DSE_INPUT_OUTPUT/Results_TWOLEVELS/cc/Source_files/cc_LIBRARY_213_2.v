...
module FAU ( 
  ...
  nor2   g02(.a(x05), .b(new_n43_), .O(new_n44_));
  ...
  nand3  g32(.a(new_n73_), .b(x05), .c(x00), .O(new_n74_));
  nand3  g33(.a(new_n53_), .b(x13), .c(new_n43_), .O(new_n75_));
  ...
  inv1   g56(.a(new_n53_), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(x18), .c(x05), .O(new_n99_));
