...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n67_), .c(new_n47_), .O(new_n79_));
  ...
  nand3  g64(.a(x12), .b(x08), .c(x06), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x10), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n50_), .O(new_n108_));
  nand3  g67(.a(new_n51_), .b(x19), .c(x12), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n108_), .O(z18));
  nand3  g69(.a(new_n50_), .b(x08), .c(x07), .O(new_n111_));
  nand2  g70(.a(x20), .b(new_n67_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x10), .O(new_n114_));
