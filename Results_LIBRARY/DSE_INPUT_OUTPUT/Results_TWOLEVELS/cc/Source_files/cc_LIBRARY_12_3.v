...
module FAU ( 
  ...
  nand2  g14(.a(new_n43_), .b(new_n56_), .O(z07));
  and2   g15(.a(new_n43_), .b(x16), .O(z08));
  nand2  g16(.a(x09), .b(x08), .O(new_n59_));
  nand2  g17(.a(new_n59_), .b(new_n43_), .O(z09));
  inv1   g18(.a(z09), .O(z10));
  aoi21  g19(.a(x15), .b(x12), .c(new_n49_), .O(z11));
  ...
  aoi21  g24(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(z12));
  ...
  aoi21  g53(.a(new_n95_), .b(new_n93_), .c(new_n63_), .O(z19));
  zero   g54(.O(z03));
  buf    g55(.a(x15), .O(z06));
endmodule
