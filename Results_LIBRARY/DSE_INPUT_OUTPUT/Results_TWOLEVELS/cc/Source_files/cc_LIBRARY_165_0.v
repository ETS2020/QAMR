...
module FAU ( 
  ...
  nand2  g54(.a(x12), .b(x10), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n95_), .c(x08), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n50_), .O(new_n98_));
  nand3  g57(.a(new_n51_), .b(x17), .c(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n98_), .O(z16));
  inv1   g59(.a(x05), .O(new_n101_));
  oai21  g60(.a(new_n96_), .b(new_n101_), .c(x08), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n50_), .O(new_n103_));
  nand3  g62(.a(new_n51_), .b(x18), .c(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n103_), .O(z17));
  nand3  g64(.a(new_n50_), .b(x10), .c(x06), .O(new_n106_));
  nand2  g65(.a(x19), .b(new_n77_), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n106_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x08), .O(new_n109_));
  nand2  g68(.a(x19), .b(x15), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n75_), .O(z18));
  inv1   g70(.a(x07), .O(new_n112_));
  oai21  g71(.a(new_n96_), .b(new_n112_), .c(x08), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(new_n50_), .O(new_n114_));
  nand3  g73(.a(new_n51_), .b(x20), .c(x12), .O(new_n115_));
