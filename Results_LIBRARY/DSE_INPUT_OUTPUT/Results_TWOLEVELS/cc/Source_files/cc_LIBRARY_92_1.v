...
module FAU ( 
  ...
  nand2  g52(.a(new_n93_), .b(new_n88_), .O(z16));
  nand2  g53(.a(new_n53_), .b(x18), .O(new_n95_));
  nand3  g54(.a(new_n72_), .b(x08), .c(x05), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z17));
  nand2  g56(.a(new_n53_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n72_), .b(x08), .c(x06), .O(new_n99_));
