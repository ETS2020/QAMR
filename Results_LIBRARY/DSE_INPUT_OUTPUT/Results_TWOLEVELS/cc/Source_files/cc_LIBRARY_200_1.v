...
module FAU ( 
  ...
  aoi21  g29(.a(x10), .b(x08), .c(x19), .O(new_n71_));
  oai21  g30(.a(new_n71_), .b(x15), .c(x13), .O(new_n72_));
  nand3  g31(.a(new_n44_), .b(new_n51_), .c(x10), .O(new_n73_));
  ...
  oai21  g48(.a(new_n71_), .b(x15), .c(x17), .O(new_n90_));
  nand3  g49(.a(new_n74_), .b(x08), .c(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n56_), .O(z16));
  oai21  g51(.a(new_n71_), .b(x15), .c(x18), .O(new_n93_));
  nand3  g52(.a(new_n74_), .b(x08), .c(x05), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n56_), .O(z17));
  nand3  g54(.a(new_n74_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n60_), .c(new_n56_), .O(z18));
  nand2  g56(.a(new_n57_), .b(x20), .O(new_n98_));
