...
module FAU ( 
  ...
  nor2   g01(.a(x11), .b(x09), .O(new_n43_));
  ...
  aoi21  g13(.a(new_n54_), .b(x09), .c(x11), .O(z02));
  ...
  oai21  g25(.a(new_n66_), .b(new_n46_), .c(new_n44_), .O(z09));
  nand2  g26(.a(x11), .b(new_n66_), .O(new_n68_));
  oai21  g27(.a(new_n66_), .b(x08), .c(new_n68_), .O(z10));
  ...
  nor2   g36(.a(new_n77_), .b(new_n48_), .O(new_n78_));
  ...
  nand4  g42(.a(new_n48_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  ...
  aoi22  g52(.a(new_n93_), .b(new_n73_), .c(new_n52_), .d(x17), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n71_), .c(new_n44_), .O(z16));
  ...
  aoi22  g60(.a(new_n101_), .b(new_n73_), .c(new_n52_), .d(x19), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n71_), .c(new_n44_), .O(z18));
  nand2  g62(.a(new_n52_), .b(x20), .O(new_n104_));
  nand4  g63(.a(new_n48_), .b(x10), .c(x08), .d(x07), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand3  g65(.a(new_n106_), .b(new_n44_), .c(x12), .O(new_n107_));
