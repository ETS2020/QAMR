...
module FAU ( 
  ...
  nand2  g26(.a(x15), .b(new_n46_), .O(z11));
  nand2  g27(.a(new_n54_), .b(x14), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n53_), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x13), .O(new_n71_));
  nand3  g30(.a(new_n53_), .b(x14), .c(x10), .O(new_n72_));
  inv1   g31(.a(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x08), .c(x00), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n71_), .c(new_n52_), .O(z12));
  oai21  g34(.a(new_n54_), .b(new_n52_), .c(x15), .O(new_n76_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n52_), .O(z14));
  ...
  nand2  g52(.a(new_n79_), .b(x08), .O(new_n94_));
