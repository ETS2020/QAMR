...
module FAU ( 
  ...
  nand2  g24(.a(new_n50_), .b(x17), .O(new_n66_));
  nand2  g25(.a(new_n66_), .b(new_n51_), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(x13), .O(new_n68_));
  nand3  g27(.a(x17), .b(new_n51_), .c(x10), .O(new_n69_));
  ...
  nand2  g41(.a(new_n82_), .b(x17), .O(new_n83_));
  ...
  nand3  g49(.a(new_n86_), .b(x08), .c(new_n90_), .O(new_n91_));
  ...
  nand3  g55(.a(new_n87_), .b(x18), .c(x12), .O(new_n97_));
  ...
  nand3  g60(.a(new_n87_), .b(x19), .c(x12), .O(new_n102_));
