...
module FAU ( 
  ...
  nand3  g25(.a(new_n53_), .b(x09), .c(x08), .O(z10));
  nor2   g26(.a(new_n52_), .b(new_n45_), .O(z11));
  ...
  oai21  g34(.a(new_n75_), .b(new_n74_), .c(new_n45_), .O(new_n76_));
  ...
  nor2   g40(.a(x20), .b(x15), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n55_), .O(z14));
  ...
  aoi21  g53(.a(x10), .b(x08), .c(x20), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(x15), .c(x18), .O(new_n96_));
  nand4  g55(.a(new_n82_), .b(x10), .c(x08), .d(x05), .O(new_n97_));
  ...
  nand3  g60(.a(new_n49_), .b(x19), .c(x12), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n101_), .O(z18));
  nand2  g62(.a(x20), .b(x15), .O(new_n104_));
  nand4  g63(.a(new_n82_), .b(x10), .c(x08), .d(x07), .O(new_n105_));
