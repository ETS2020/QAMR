...
module FAU ( 
  ...
  nand2  g30(.a(new_n44_), .b(new_n47_), .O(z11));
  inv1   g31(.a(x00), .O(new_n73_));
  oai21  g32(.a(new_n46_), .b(new_n73_), .c(x12), .O(new_n74_));
  ...
  nand4  g50(.a(new_n52_), .b(x16), .c(new_n47_), .d(x12), .O(new_n92_));
  ...
  oai21  g58(.a(new_n46_), .b(new_n99_), .c(x12), .O(new_n100_));
  ...
  nand2  g63(.a(new_n52_), .b(x19), .O(new_n105_));
  inv1   g64(.a(x10), .O(new_n106_));
  nor2   g65(.a(x15), .b(new_n106_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(x08), .c(x06), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n105_), .c(new_n104_), .O(z18));
  nand2  g68(.a(new_n52_), .b(x20), .O(new_n110_));
  nand3  g69(.a(new_n107_), .b(x08), .c(x07), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n104_), .O(z19));
endmodule
