...
module FAU ( 
  ...
  nand2  g06(.a(new_n43_), .b(new_n47_), .O(new_n48_));
  ...
  nand2  g17(.a(x09), .b(new_n45_), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n45_), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(x20), .c(x18), .O(z04));
  inv1   g20(.a(x19), .O(new_n62_));
  nand2  g21(.a(new_n48_), .b(new_n62_), .O(z05));
  nand2  g22(.a(new_n48_), .b(new_n51_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n48_), .b(new_n65_), .O(z07));
  and2   g25(.a(new_n48_), .b(x16), .O(z08));
  oai21  g26(.a(x20), .b(x18), .c(x09), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n45_), .O(z09));
  aoi22  g28(.a(new_n43_), .b(new_n47_), .c(x09), .d(x08), .O(z10));
  ...
  nand2  g46(.a(new_n87_), .b(new_n48_), .O(z14));
  ...
  nand3  g53(.a(new_n74_), .b(x08), .c(x04), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(new_n48_), .c(x12), .O(new_n97_));
  inv1   g56(.a(new_n97_), .O(z16));
  nand2  g57(.a(x20), .b(new_n51_), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n56_), .c(new_n47_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x05), .O(new_n101_));
  nand3  g60(.a(new_n51_), .b(x10), .c(x08), .O(new_n102_));
  ...
  aoi22  g64(.a(new_n105_), .b(new_n74_), .c(new_n52_), .d(x19), .O(new_n106_));
  oai21  g65(.a(new_n106_), .b(new_n72_), .c(new_n48_), .O(z18));
  nand2  g66(.a(new_n51_), .b(x07), .O(new_n108_));
  nand2  g67(.a(x20), .b(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n73_), .O(new_n110_));
  aoi21  g69(.a(x10), .b(x08), .c(new_n43_), .O(new_n111_));
  aoi21  g70(.a(new_n110_), .b(x08), .c(new_n111_), .O(new_n112_));
  oai21  g71(.a(new_n112_), .b(new_n72_), .c(new_n48_), .O(z19));
endmodule
