...
module FAU ( 
  ...
  oai21  g37(.a(new_n72_), .b(new_n78_), .c(new_n48_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  nand3  g39(.a(x10), .b(x08), .c(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x18), .c(x14), .O(new_n82_));
  ...
  nand4  g50(.a(new_n74_), .b(x16), .c(new_n48_), .d(x12), .O(new_n92_));
  ...
  inv1   g55(.a(new_n52_), .O(new_n97_));
  nand4  g56(.a(new_n97_), .b(x10), .c(x08), .d(x04), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n96_), .c(new_n77_), .O(z16));
  nor2   g58(.a(new_n78_), .b(x05), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n73_), .O(new_n101_));
