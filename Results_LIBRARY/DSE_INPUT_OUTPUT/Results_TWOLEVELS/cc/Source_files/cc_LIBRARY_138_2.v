...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x13), .O(new_n55_));
  ...
  nand2  g30(.a(new_n47_), .b(new_n48_), .O(z11));
  ...
  nor2   g41(.a(x15), .b(x13), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(x10), .c(x08), .d(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n59_), .O(z14));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n59_), .O(z15));
  nand4  g50(.a(new_n53_), .b(x10), .c(x08), .d(x04), .O(new_n92_));
  oai21  g51(.a(new_n50_), .b(new_n65_), .c(new_n92_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n44_), .O(new_n94_));
  nand2  g53(.a(x17), .b(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n59_), .O(z16));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n59_), .O(z17));
  ...
  nand3  g64(.a(new_n54_), .b(x19), .c(x12), .O(new_n106_));
  ...
  nand3  g69(.a(new_n54_), .b(x20), .c(x12), .O(new_n111_));
