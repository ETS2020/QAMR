...
module FAU ( 
  ...
  oai21  g15(.a(new_n56_), .b(new_n55_), .c(new_n45_), .O(z03));
  nor2   g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n44_), .b(new_n59_), .O(z05));
  nand2  g19(.a(new_n50_), .b(x12), .O(z06));
  ...
  nand2  g29(.a(new_n51_), .b(x13), .O(new_n71_));
  ...
  oai21  g35(.a(new_n72_), .b(new_n76_), .c(new_n47_), .O(new_n77_));
  ...
  oai21  g44(.a(new_n55_), .b(new_n85_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n50_), .O(new_n87_));
  nand4  g46(.a(new_n51_), .b(x16), .c(new_n47_), .d(x12), .O(new_n88_));
  ...
  nand3  g51(.a(new_n51_), .b(x17), .c(x12), .O(new_n93_));
  ...
  nand3  g59(.a(new_n51_), .b(x19), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(z18));
  nand2  g61(.a(new_n50_), .b(x10), .O(new_n103_));
  nor2   g62(.a(x15), .b(x08), .O(new_n104_));
  aoi21  g63(.a(new_n103_), .b(x12), .c(new_n104_), .O(new_n105_));
  nand3  g64(.a(x10), .b(x08), .c(x07), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n50_), .O(new_n108_));
  oai21  g67(.a(new_n105_), .b(new_n43_), .c(new_n108_), .O(z19));
endmodule
