...
module FAU ( 
  ...
  nand3  g05(.a(x10), .b(x08), .c(x03), .O(new_n47_));
  nor3   g06(.a(new_n47_), .b(new_n44_), .c(x14), .O(z01));
  oai21  g07(.a(new_n44_), .b(x03), .c(x14), .O(new_n49_));
  ...
  nor2   g22(.a(new_n63_), .b(new_n60_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n58_), .b(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n58_), .b(new_n67_), .O(z08));
  oai21  g27(.a(new_n44_), .b(x03), .c(x09), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n61_), .O(z09));
  aoi22  g29(.a(x15), .b(new_n60_), .c(x09), .d(x08), .O(z10));
  inv1   g30(.a(x14), .O(new_n72_));
  nand2  g31(.a(new_n58_), .b(new_n72_), .O(z11));
  nor2   g32(.a(new_n44_), .b(new_n60_), .O(new_n74_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n76_), .c(new_n54_), .O(z12));
  oai21  g39(.a(new_n77_), .b(new_n61_), .c(new_n72_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x15), .c(x03), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n44_), .c(x14), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n54_), .O(z13));
  nand2  g44(.a(x10), .b(x08), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x15), .c(x03), .O(new_n87_));
  nand3  g46(.a(new_n78_), .b(x08), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n54_), .O(z14));
  nand2  g48(.a(x16), .b(new_n72_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n50_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x03), .O(new_n92_));
  nand4  g51(.a(new_n86_), .b(x16), .c(new_n44_), .d(new_n72_), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n54_), .O(z15));
  oai21  g53(.a(new_n65_), .b(new_n54_), .c(x03), .O(new_n95_));
  ...
  nand2  g68(.a(new_n86_), .b(x19), .O(new_n110_));
  ...
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n54_), .O(z18));
  oai21  g74(.a(new_n43_), .b(new_n54_), .c(x03), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x15), .O(new_n117_));
  nand2  g76(.a(new_n86_), .b(x20), .O(new_n118_));
