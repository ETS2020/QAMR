...
module FAU ( 
  ...
  nor2   g19(.a(new_n57_), .b(new_n60_), .O(z05));
  ...
  nor2   g24(.a(new_n57_), .b(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n58_), .b(new_n67_), .O(z08));
  inv1   g27(.a(x08), .O(new_n69_));
  nor3   g28(.a(new_n57_), .b(new_n62_), .c(new_n69_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n57_), .O(z10));
  inv1   g30(.a(new_n49_), .O(z11));
  nand2  g31(.a(new_n48_), .b(x20), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n50_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x13), .O(new_n75_));
  nand3  g34(.a(x20), .b(new_n50_), .c(x10), .O(new_n76_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n69_), .c(new_n45_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x20), .c(x14), .O(new_n84_));
  ...
  nand3  g50(.a(new_n50_), .b(x10), .c(x08), .O(new_n92_));
  nand4  g51(.a(new_n92_), .b(x16), .c(new_n45_), .d(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n91_), .O(z15));
  nand2  g53(.a(new_n74_), .b(x17), .O(new_n95_));
  nand3  g54(.a(new_n77_), .b(x08), .c(x04), .O(new_n96_));
  ...
  nand3  g59(.a(new_n92_), .b(x18), .c(x12), .O(new_n101_));
  ...
  nand3  g64(.a(new_n92_), .b(x19), .c(x12), .O(new_n106_));
  ...
  nand2  g69(.a(new_n110_), .b(new_n58_), .O(z19));
endmodule
