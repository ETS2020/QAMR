...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n92_, new_n93_, new_n95_, new_n96_, new_n98_, new_n99_;
  ...
  nor2   g18(.a(new_n55_), .b(new_n59_), .O(z07));
  and2   g19(.a(new_n44_), .b(x16), .O(z08));
  nand2  g20(.a(x09), .b(x08), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n44_), .O(z09));
  aoi22  g22(.a(x15), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  nand2  g23(.a(new_n44_), .b(new_n50_), .O(z11));
  oai21  g24(.a(x13), .b(new_n43_), .c(x15), .O(new_n66_));
  nand2  g25(.a(new_n48_), .b(x13), .O(new_n67_));
  nand4  g26(.a(new_n47_), .b(x10), .c(x08), .d(x00), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(new_n67_), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(x12), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n66_), .O(z12));
  nand3  g30(.a(new_n48_), .b(new_n50_), .c(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x15), .O(new_n73_));
  inv1   g32(.a(x01), .O(new_n74_));
  oai21  g33(.a(new_n48_), .b(new_n74_), .c(x14), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(new_n43_), .c(new_n73_), .O(z13));
  inv1   g35(.a(x08), .O(new_n77_));
  nand2  g36(.a(x15), .b(new_n77_), .O(new_n78_));
  nand4  g37(.a(new_n47_), .b(x10), .c(x08), .d(x02), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x12), .O(new_n81_));
  inv1   g40(.a(x10), .O(new_n82_));
  oai21  g41(.a(new_n43_), .b(new_n82_), .c(x15), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n81_), .O(z14));
  nand3  g43(.a(new_n51_), .b(x16), .c(new_n50_), .O(new_n85_));
  nor2   g44(.a(x15), .b(new_n82_), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x08), .c(x03), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n43_), .O(z15));
  nand2  g47(.a(new_n51_), .b(x17), .O(new_n89_));
  nand3  g48(.a(new_n86_), .b(x08), .c(x04), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z16));
  nand2  g50(.a(new_n51_), .b(x18), .O(new_n92_));
  nand3  g51(.a(new_n86_), .b(x08), .c(x05), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z17));
  nand2  g53(.a(new_n51_), .b(x19), .O(new_n95_));
  nand3  g54(.a(new_n86_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z18));
  nand2  g56(.a(new_n51_), .b(x20), .O(new_n98_));
  nand3  g57(.a(new_n86_), .b(x08), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z19));
  nor4   g59(.a(new_n48_), .b(new_n47_), .c(x14), .d(new_n43_), .O(z03));
  buf    g60(.a(x15), .O(z06));
endmodule
