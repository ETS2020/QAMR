...
module FAU ( 
  ...
  nand2  g29(.a(new_n69_), .b(new_n47_), .O(z11));
  ...
  nor2   g34(.a(x15), .b(new_n66_), .O(new_n76_));
  ...
  aoi21  g39(.a(x08), .b(x01), .c(new_n47_), .O(new_n81_));
  nor2   g40(.a(new_n44_), .b(new_n66_), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n81_), .c(x10), .O(new_n83_));
  nand3  g42(.a(new_n44_), .b(x14), .c(new_n50_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n72_), .O(z13));
