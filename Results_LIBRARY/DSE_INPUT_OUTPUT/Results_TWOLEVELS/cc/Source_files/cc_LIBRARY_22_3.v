...
module FAU ( 
  ...
  nor2   g15(.a(new_n56_), .b(x06), .O(new_n57_));
  ...
  oai21  g58(.a(new_n63_), .b(new_n80_), .c(new_n45_), .O(new_n100_));
  ...
  nand2  g73(.a(new_n74_), .b(x19), .O(new_n115_));
  ...
  nand3  g77(.a(x19), .b(x15), .c(new_n45_), .O(new_n119_));
  aoi21  g78(.a(new_n119_), .b(new_n118_), .c(new_n80_), .O(z18));
  ...
  nand2  g82(.a(new_n123_), .b(new_n46_), .O(new_n124_));
  nand3  g83(.a(x20), .b(x15), .c(new_n45_), .O(new_n125_));
  aoi21  g84(.a(new_n125_), .b(new_n124_), .c(new_n80_), .O(z19));
  buf    g85(.a(x15), .O(z06));
endmodule
