...
module FAU ( 
  ...
  aoi21  g24(.a(x16), .b(x15), .c(new_n47_), .O(z11));
  aoi21  g25(.a(x13), .b(x12), .c(x16), .O(new_n67_));
  nand2  g26(.a(x10), .b(x08), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x13), .O(new_n69_));
  nand2  g28(.a(x08), .b(x00), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(new_n51_), .c(new_n69_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x12), .O(new_n72_));
  oai21  g31(.a(new_n67_), .b(new_n45_), .c(new_n72_), .O(z12));
  inv1   g32(.a(x12), .O(new_n74_));
  oai21  g33(.a(new_n68_), .b(x16), .c(new_n47_), .O(new_n75_));
  nand3  g34(.a(x10), .b(x08), .c(x01), .O(new_n76_));
  aoi22  g35(.a(new_n76_), .b(x14), .c(new_n75_), .d(x15), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n74_), .c(new_n42_), .O(z13));
  nand3  g37(.a(new_n68_), .b(new_n46_), .c(x15), .O(new_n79_));
  ...
  nand3  g41(.a(new_n68_), .b(x16), .c(new_n47_), .O(new_n83_));
  oai21  g42(.a(new_n68_), .b(new_n82_), .c(new_n83_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n45_), .c(x12), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z15));
  inv1   g45(.a(x04), .O(new_n87_));
  nand2  g46(.a(new_n68_), .b(x17), .O(new_n88_));
  oai21  g47(.a(new_n68_), .b(new_n87_), .c(new_n88_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n45_), .O(new_n90_));
  nand3  g49(.a(x17), .b(new_n46_), .c(x15), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n74_), .O(z16));
  aoi21  g51(.a(x18), .b(x12), .c(x16), .O(new_n93_));
  ...
  oai21  g56(.a(new_n93_), .b(new_n45_), .c(new_n97_), .O(z17));
  inv1   g57(.a(x06), .O(new_n99_));
  nand2  g58(.a(new_n68_), .b(x19), .O(new_n100_));
  oai21  g59(.a(new_n68_), .b(new_n99_), .c(new_n100_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n45_), .O(new_n102_));
  nand3  g61(.a(x19), .b(new_n46_), .c(x15), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n74_), .O(z18));
  aoi21  g63(.a(x20), .b(x12), .c(x16), .O(new_n105_));
  nand2  g64(.a(new_n68_), .b(x20), .O(new_n106_));
