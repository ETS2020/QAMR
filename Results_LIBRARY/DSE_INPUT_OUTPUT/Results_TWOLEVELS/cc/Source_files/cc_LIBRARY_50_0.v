...
module FAU ( 
  ...
  oai21  g31(.a(new_n72_), .b(x13), .c(x12), .O(new_n73_));
  ...
  nand3  g41(.a(new_n72_), .b(x02), .c(x00), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n81_), .O(z14));
  nand3  g43(.a(new_n55_), .b(x16), .c(new_n46_), .O(new_n85_));
  ...
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n81_), .O(z15));
  ...
  nand2  g55(.a(new_n96_), .b(x00), .O(new_n97_));
