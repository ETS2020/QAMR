...
module FAU ( 
  ...
  nor2   g19(.a(new_n55_), .b(x15), .O(z07));
  ...
  aoi21  g25(.a(x17), .b(x15), .c(new_n50_), .O(z11));
  ...
  oai21  g36(.a(new_n77_), .b(new_n49_), .c(new_n50_), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(new_n55_), .c(x15), .O(new_n79_));
  ...
  oai21  g43(.a(new_n84_), .b(new_n51_), .c(new_n83_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n42_), .O(z14));
  nand2  g46(.a(new_n46_), .b(new_n45_), .O(new_n88_));
  nand2  g47(.a(new_n55_), .b(x15), .O(new_n89_));
  ...
  nand3  g61(.a(x18), .b(new_n55_), .c(x15), .O(new_n103_));
  ...
  nand3  g67(.a(x19), .b(new_n55_), .c(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n76_), .O(z18));
