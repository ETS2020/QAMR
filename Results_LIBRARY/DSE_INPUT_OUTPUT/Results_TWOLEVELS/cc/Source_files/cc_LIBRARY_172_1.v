...
module FAU ( 
  ...
  nand3  g06(.a(x10), .b(x08), .c(x05), .O(new_n48_));
  ...
  nor4   g15(.a(new_n48_), .b(new_n44_), .c(x14), .d(new_n56_), .O(z03));
  nand2  g16(.a(new_n46_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n45_), .b(new_n59_), .O(z05));
  and2   g19(.a(x15), .b(x05), .O(z06));
  ...
  nand2  g29(.a(new_n70_), .b(x05), .O(new_n71_));
  ...
  nand2  g38(.a(new_n79_), .b(x05), .O(new_n80_));
  ...
  nand2  g49(.a(new_n90_), .b(x05), .O(new_n91_));
  ...
  nand3  g60(.a(x17), .b(x15), .c(x05), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n56_), .O(z16));
  nand2  g62(.a(x18), .b(x12), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x05), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x15), .O(new_n106_));
  nand2  g65(.a(x08), .b(x05), .O(new_n107_));
  nand2  g66(.a(new_n73_), .b(x18), .O(new_n108_));
  oai21  g67(.a(new_n52_), .b(new_n107_), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x12), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n106_), .O(z17));
  oai21  g70(.a(new_n59_), .b(new_n56_), .c(x05), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x15), .O(new_n113_));
  nand2  g72(.a(new_n73_), .b(x19), .O(new_n114_));
  ...
  oai21  g77(.a(new_n43_), .b(new_n56_), .c(x05), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x15), .O(new_n120_));
  nand2  g79(.a(new_n73_), .b(x20), .O(new_n121_));
  nand2  g80(.a(x08), .b(x07), .O(new_n122_));
  oai21  g81(.a(new_n122_), .b(new_n52_), .c(new_n121_), .O(new_n123_));
