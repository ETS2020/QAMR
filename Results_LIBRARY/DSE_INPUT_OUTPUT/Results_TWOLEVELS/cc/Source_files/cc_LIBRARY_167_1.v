...
module FAU ( 
  ...
  nor2   g10(.a(x17), .b(x15), .O(new_n52_));
  ...
  nand2  g21(.a(new_n62_), .b(new_n43_), .O(z06));
  nand2  g22(.a(x17), .b(x15), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(z07));
  ...
  nand3  g33(.a(new_n43_), .b(x10), .c(x08), .O(new_n75_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n67_), .c(new_n48_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n62_), .c(x14), .O(new_n83_));
  ...
  nand2  g46(.a(new_n47_), .b(new_n62_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n43_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x16), .c(new_n48_), .O(new_n90_));
  nand4  g49(.a(new_n52_), .b(x10), .c(x08), .d(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n78_), .O(z15));
  nand4  g51(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n64_), .c(new_n78_), .O(z16));
  nand4  g53(.a(x12), .b(x10), .c(x08), .d(x05), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n62_), .O(new_n96_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n62_), .O(new_n101_));
  ...
  nand2  g66(.a(new_n107_), .b(new_n62_), .O(new_n108_));
  nand2  g67(.a(x20), .b(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n78_), .O(z19));
endmodule
