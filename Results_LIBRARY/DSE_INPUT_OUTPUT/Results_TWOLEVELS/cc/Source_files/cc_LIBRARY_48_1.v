...
module FAU ( 
  ...
  nand2  g43(.a(new_n84_), .b(new_n57_), .O(z14));
  nand3  g44(.a(x16), .b(x15), .c(new_n47_), .O(new_n86_));
  nor2   g45(.a(x16), .b(x15), .O(new_n87_));
  nand4  g46(.a(new_n87_), .b(x10), .c(x08), .d(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n76_), .O(z15));
  ...
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n76_), .O(z18));
  ...
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n76_), .O(z19));
  buf    g71(.a(x16), .O(z08));
endmodule
