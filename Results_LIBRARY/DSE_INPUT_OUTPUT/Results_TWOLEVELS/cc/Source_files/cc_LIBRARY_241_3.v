...
module FAU ( 
  ...
  nor2   g06(.a(new_n47_), .b(x03), .O(new_n48_));
  nand3  g07(.a(new_n48_), .b(new_n46_), .c(x10), .O(new_n49_));
  ...
  nand4  g16(.a(new_n48_), .b(new_n46_), .c(x12), .d(x10), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n57_), .c(new_n45_), .O(z03));
  nand2  g18(.a(new_n42_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  aoi21  g20(.a(x15), .b(x03), .c(new_n61_), .O(z05));
  nand2  g21(.a(x15), .b(new_n57_), .O(new_n63_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n47_), .c(new_n46_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x15), .c(new_n57_), .O(new_n82_));
  ...
  nand3  g54(.a(x17), .b(x15), .c(new_n57_), .O(new_n96_));
  ...
  oai21  g64(.a(new_n61_), .b(new_n72_), .c(new_n57_), .O(new_n106_));
  ...
  nand2  g72(.a(new_n113_), .b(new_n57_), .O(new_n114_));
