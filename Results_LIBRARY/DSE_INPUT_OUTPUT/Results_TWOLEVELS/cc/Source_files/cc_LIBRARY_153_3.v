...
module FAU ( 
  ...
  nor2   g21(.a(new_n60_), .b(new_n62_), .O(z05));
  ...
  oai21  g39(.a(new_n80_), .b(new_n48_), .c(new_n55_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n44_), .c(x15), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n43_), .c(x14), .O(new_n84_));
  ...
  oai21  g65(.a(new_n62_), .b(new_n73_), .c(new_n44_), .O(new_n107_));
  ...
  oai21  g74(.a(new_n46_), .b(new_n114_), .c(new_n115_), .O(new_n116_));
  nand3  g75(.a(new_n116_), .b(new_n43_), .c(x12), .O(new_n117_));
