...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n57_, new_n58_, new_n59_, new_n61_, new_n63_,
  ...
  nand2  g46(.a(new_n46_), .b(x18), .O(new_n89_));
  nand3  g47(.a(x10), .b(x08), .c(x05), .O(new_n90_));
  and2   g48(.a(new_n90_), .b(new_n45_), .O(new_n91_));
  aoi21  g49(.a(new_n91_), .b(new_n89_), .c(new_n48_), .O(z17));
  nand2  g50(.a(new_n46_), .b(x19), .O(new_n93_));
  nand3  g51(.a(x10), .b(x08), .c(x06), .O(new_n94_));
  and2   g52(.a(new_n94_), .b(new_n45_), .O(new_n95_));
  aoi21  g53(.a(new_n95_), .b(new_n93_), .c(new_n48_), .O(z18));
  nand2  g54(.a(new_n46_), .b(x20), .O(new_n97_));
  nand3  g55(.a(x10), .b(x08), .c(x07), .O(new_n98_));
  nand2  g56(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand3  g57(.a(new_n99_), .b(new_n45_), .c(x12), .O(new_n100_));
