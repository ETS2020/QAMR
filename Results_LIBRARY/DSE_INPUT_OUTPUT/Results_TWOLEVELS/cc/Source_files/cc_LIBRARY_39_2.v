...
module FAU ( 
  ...
  nand3  g29(.a(new_n61_), .b(x09), .c(x08), .O(z10));
  nand2  g30(.a(new_n61_), .b(new_n47_), .O(z11));
  ...
  aoi22  g37(.a(new_n78_), .b(new_n77_), .c(new_n55_), .d(x13), .O(new_n79_));
  oai22  g38(.a(new_n79_), .b(new_n73_), .c(new_n75_), .d(new_n44_), .O(z12));
  ...
  nand3  g44(.a(new_n55_), .b(x19), .c(x15), .O(new_n86_));
  ...
  nand3  g50(.a(new_n55_), .b(x16), .c(new_n47_), .O(new_n92_));
  ...
  aoi21  g55(.a(x17), .b(x12), .c(new_n74_), .O(new_n97_));
  and2   g56(.a(x08), .b(x04), .O(new_n98_));
  aoi22  g57(.a(new_n98_), .b(new_n77_), .c(new_n55_), .d(x17), .O(new_n99_));
  oai22  g58(.a(new_n99_), .b(new_n73_), .c(new_n97_), .d(new_n44_), .O(z16));
  inv1   g59(.a(x05), .O(new_n101_));
  nand2  g60(.a(new_n55_), .b(x18), .O(new_n102_));
  oai21  g61(.a(new_n55_), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  ...
  oai21  g66(.a(new_n63_), .b(x14), .c(new_n107_), .O(new_n108_));
  ...
  nand2  g71(.a(new_n112_), .b(new_n109_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x12), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n61_), .O(z18));
  aoi21  g74(.a(x20), .b(x12), .c(new_n74_), .O(new_n116_));
  and2   g75(.a(x08), .b(x07), .O(new_n117_));
  aoi22  g76(.a(new_n117_), .b(new_n77_), .c(new_n55_), .d(x20), .O(new_n118_));
