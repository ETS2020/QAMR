...
module FAU ( 
  ...
  nor2   g20(.a(new_n61_), .b(x12), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n42_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nand2  g24(.a(new_n42_), .b(new_n65_), .O(z08));
  nand2  g25(.a(x15), .b(x12), .O(new_n67_));
  nand3  g26(.a(new_n67_), .b(x09), .c(x08), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z09));
  aoi22  g28(.a(x15), .b(x12), .c(x09), .d(x08), .O(z10));
  nor2   g29(.a(z03), .b(new_n47_), .O(z11));
  nand2  g30(.a(new_n51_), .b(x13), .O(new_n72_));
  nand3  g31(.a(x10), .b(x08), .c(x00), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n72_), .O(new_n74_));
  nand3  g33(.a(new_n74_), .b(new_n46_), .c(x12), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(z12));
  inv1   g35(.a(x01), .O(new_n77_));
  oai21  g36(.a(new_n51_), .b(new_n77_), .c(x14), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n46_), .c(new_n45_), .O(z13));
  nand4  g38(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(x15), .O(z14));
  nand3  g40(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x03), .O(new_n83_));
  and2   g42(.a(new_n83_), .b(new_n46_), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n45_), .O(z15));
  nand2  g44(.a(new_n51_), .b(x17), .O(new_n86_));
  nand3  g45(.a(x10), .b(x08), .c(x04), .O(new_n87_));
  and2   g46(.a(new_n87_), .b(new_n46_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n45_), .O(z16));
  nand2  g48(.a(new_n51_), .b(x18), .O(new_n90_));
  nand3  g49(.a(x10), .b(x08), .c(x05), .O(new_n91_));
  ...
  nand3  g54(.a(x10), .b(x08), .c(x06), .O(new_n96_));
  and2   g55(.a(new_n96_), .b(new_n46_), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n95_), .c(new_n45_), .O(z18));
  nand2  g57(.a(new_n51_), .b(x20), .O(new_n99_));
  nand3  g58(.a(x10), .b(x08), .c(x07), .O(new_n100_));
  and2   g59(.a(new_n100_), .b(new_n46_), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n99_), .c(new_n45_), .O(z19));
endmodule
