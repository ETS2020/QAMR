...
module FAU ( 
  ...
  aoi21  g09(.a(new_n50_), .b(new_n47_), .c(x06), .O(new_n51_));
  nor2   g10(.a(new_n43_), .b(new_n47_), .O(new_n52_));
  oai21  g11(.a(new_n52_), .b(new_n51_), .c(x12), .O(new_n53_));
  nor2   g12(.a(new_n53_), .b(x11), .O(z02));
  ...
  nand2  g19(.a(new_n43_), .b(new_n60_), .O(z06));
  ...
  nor2   g31(.a(new_n72_), .b(new_n71_), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(x08), .c(x00), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n60_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  nand3  g35(.a(new_n50_), .b(x13), .c(x12), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(z12));
  oai21  g37(.a(new_n71_), .b(new_n66_), .c(new_n47_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  inv1   g39(.a(new_n46_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x14), .c(new_n60_), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n80_), .c(new_n72_), .O(z13));
  nand2  g43(.a(new_n43_), .b(x10), .O(new_n85_));
  nand2  g44(.a(x08), .b(x02), .O(new_n86_));
  oai22  g45(.a(new_n86_), .b(new_n85_), .c(new_n81_), .d(new_n43_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n44_), .O(z14));
  nand3  g48(.a(new_n73_), .b(x08), .c(x03), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n60_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n43_), .O(new_n92_));
  nand4  g51(.a(new_n50_), .b(x16), .c(new_n47_), .d(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(z15));
  nand3  g53(.a(new_n73_), .b(x08), .c(x04), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n60_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n43_), .O(new_n97_));
  nand3  g56(.a(new_n50_), .b(x17), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z16));
  nand3  g58(.a(new_n73_), .b(x08), .c(x05), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n60_), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n43_), .O(new_n102_));
  nand3  g61(.a(new_n50_), .b(x18), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(z17));
  aoi21  g63(.a(new_n46_), .b(new_n60_), .c(x15), .O(new_n105_));
  nor3   g64(.a(new_n105_), .b(new_n58_), .c(new_n72_), .O(z18));
  nand2  g65(.a(new_n46_), .b(x20), .O(new_n107_));
  nand2  g66(.a(x08), .b(x07), .O(new_n108_));
  oai21  g67(.a(new_n108_), .b(new_n85_), .c(new_n107_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n60_), .O(new_n110_));
  nand2  g69(.a(x20), .b(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n72_), .O(z19));
endmodule
