...
module FAU ( 
  ...
  aoi21  g14(.a(new_n55_), .b(x12), .c(new_n46_), .O(z03));
  nand2  g15(.a(new_n44_), .b(x18), .O(z04));
  inv1   g16(.a(x19), .O(new_n58_));
  nor2   g17(.a(new_n46_), .b(x12), .O(new_n59_));
  nor2   g18(.a(new_n59_), .b(new_n58_), .O(z05));
  inv1   g19(.a(x08), .O(new_n61_));
  nand2  g20(.a(x09), .b(new_n61_), .O(new_n62_));
  nor2   g21(.a(new_n62_), .b(new_n61_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(x12), .c(new_n46_), .O(z06));
  ...
  nor3   g28(.a(new_n59_), .b(new_n69_), .c(new_n61_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n59_), .O(z10));
  nand2  g30(.a(new_n44_), .b(new_n50_), .O(z11));
  oai21  g31(.a(x13), .b(new_n43_), .c(x15), .O(new_n73_));
  ...
  nand3  g37(.a(new_n47_), .b(new_n50_), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  inv1   g39(.a(x01), .O(new_n81_));
  oai21  g40(.a(new_n47_), .b(new_n81_), .c(x14), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n43_), .c(new_n80_), .O(z13));
  nand2  g42(.a(x15), .b(new_n61_), .O(new_n84_));
  ...
  oai21  g47(.a(new_n43_), .b(new_n88_), .c(x15), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n87_), .O(z14));
  oai21  g49(.a(new_n67_), .b(x14), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand3  g51(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n93_));
  ...
  nand2  g56(.a(new_n51_), .b(x17), .O(new_n98_));
  nor2   g57(.a(x15), .b(new_n88_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(x08), .c(x04), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n98_), .c(new_n43_), .O(z16));
  oai21  g60(.a(x18), .b(new_n43_), .c(x15), .O(new_n102_));
  nand2  g61(.a(new_n47_), .b(x18), .O(new_n103_));
  nand4  g62(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n104_));
  ...
  oai21  g66(.a(x19), .b(new_n43_), .c(x15), .O(new_n108_));
  nand2  g67(.a(new_n47_), .b(x19), .O(new_n109_));
  nand4  g68(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n110_));
  ...
  nand2  g72(.a(new_n51_), .b(x20), .O(new_n114_));
  nand3  g73(.a(new_n99_), .b(x08), .c(x07), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n43_), .O(z19));
endmodule
