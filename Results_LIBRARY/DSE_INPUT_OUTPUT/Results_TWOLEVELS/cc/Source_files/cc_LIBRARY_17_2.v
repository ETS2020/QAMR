...
module FAU ( 
  ...
  oai21  g14(.a(x15), .b(new_n54_), .c(x19), .O(new_n56_));
  inv1   g15(.a(new_n56_), .O(z05));
  inv1   g16(.a(x17), .O(new_n58_));
  nor2   g17(.a(x15), .b(new_n54_), .O(new_n59_));
  ...
  nand4  g30(.a(x15), .b(new_n47_), .c(x10), .d(x08), .O(new_n72_));
  ...
  oai21  g37(.a(new_n58_), .b(new_n68_), .c(new_n45_), .O(z16));
  nor2   g38(.a(z04), .b(new_n68_), .O(z17));
  nor2   g39(.a(new_n56_), .b(new_n68_), .O(z18));
  oai21  g40(.a(new_n43_), .b(new_n68_), .c(new_n45_), .O(z19));
  buf    g41(.a(x15), .O(z06));
endmodule
