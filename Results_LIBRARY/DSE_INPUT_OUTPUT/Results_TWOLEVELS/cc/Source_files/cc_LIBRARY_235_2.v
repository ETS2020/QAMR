...
module FAU ( 
  ...
  aoi21  g36(.a(new_n49_), .b(x01), .c(new_n47_), .O(new_n78_));
  ...
  oai22  g41(.a(new_n82_), .b(new_n81_), .c(new_n49_), .d(new_n52_), .O(new_n83_));
  ...
  oai22  g51(.a(new_n92_), .b(new_n81_), .c(new_n49_), .d(new_n63_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n43_), .O(new_n94_));
  nand2  g53(.a(x17), .b(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n91_), .O(z16));
  nand3  g55(.a(new_n53_), .b(x18), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n45_), .O(z17));
  nand2  g57(.a(x08), .b(x06), .O(new_n99_));
  oai22  g58(.a(new_n99_), .b(new_n81_), .c(new_n49_), .d(new_n61_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n43_), .O(new_n101_));
  nand2  g60(.a(x19), .b(x15), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n91_), .O(z18));
  nand2  g62(.a(new_n48_), .b(x20), .O(new_n104_));
  nand2  g63(.a(x08), .b(x07), .O(new_n105_));
  oai21  g64(.a(new_n105_), .b(new_n81_), .c(new_n104_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n43_), .O(new_n107_));
  nand2  g66(.a(x20), .b(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n91_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
