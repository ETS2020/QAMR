...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n56_, new_n59_, new_n64_,
  ...
  oai21  g30(.a(new_n71_), .b(new_n43_), .c(new_n44_), .O(z12));
  oai21  g31(.a(new_n68_), .b(new_n46_), .c(new_n47_), .O(new_n73_));
  ...
  nand3  g42(.a(new_n69_), .b(x08), .c(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n43_), .O(z15));
  and2   g44(.a(x08), .b(x04), .O(new_n86_));
  aoi22  g45(.a(new_n86_), .b(new_n69_), .c(new_n51_), .d(x17), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n43_), .c(new_n44_), .O(z16));
  ...
  aoi22  g51(.a(new_n92_), .b(new_n69_), .c(new_n51_), .d(x19), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(new_n43_), .c(new_n44_), .O(z18));
  nand2  g53(.a(new_n51_), .b(x20), .O(new_n95_));
  nand3  g54(.a(new_n69_), .b(x08), .c(x07), .O(new_n96_));
