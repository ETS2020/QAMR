...
module FAU ( 
  ...
  nand2  g32(.a(new_n53_), .b(x13), .O(new_n74_));
  inv1   g33(.a(x10), .O(new_n75_));
  nor2   g34(.a(x15), .b(new_n75_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x08), .c(x00), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n57_), .O(z12));
  oai21  g37(.a(new_n75_), .b(new_n62_), .c(new_n47_), .O(new_n79_));
  ...
  oai21  g46(.a(new_n46_), .b(new_n87_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n52_), .O(new_n89_));
  nand4  g48(.a(new_n53_), .b(x16), .c(new_n47_), .d(x12), .O(new_n90_));
  ...
  nand3  g56(.a(new_n76_), .b(x08), .c(x05), .O(new_n98_));
  ...
  nand2  g63(.a(new_n53_), .b(x20), .O(new_n105_));
  nand3  g64(.a(new_n76_), .b(x08), .c(x07), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n57_), .O(z19));
endmodule
