...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n54_, new_n58_, new_n60_, new_n64_, new_n65_, new_n66_,
  ...
  nor2   g20(.a(new_n54_), .b(new_n49_), .O(z11));
  ...
  and2   g53(.a(new_n95_), .b(new_n45_), .O(new_n96_));
  aoi21  g54(.a(new_n96_), .b(new_n94_), .c(new_n79_), .O(z19));
  zero   g55(.O(z03));
  buf    g56(.a(x15), .O(z06));
endmodule
