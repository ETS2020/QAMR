...
module FAU ( 
  ...
  aoi22  g24(.a(new_n56_), .b(x12), .c(x09), .d(x08), .O(z10));
  aoi21  g25(.a(new_n56_), .b(x12), .c(new_n46_), .O(z11));
  nand3  g26(.a(x15), .b(x13), .c(x12), .O(new_n68_));
  inv1   g27(.a(new_n68_), .O(z12));
  aoi21  g28(.a(x10), .b(x08), .c(x14), .O(new_n70_));
  nor3   g29(.a(new_n70_), .b(new_n56_), .c(new_n43_), .O(z13));
  nor2   g30(.a(new_n56_), .b(new_n63_), .O(new_n72_));
  aoi21  g31(.a(new_n72_), .b(x10), .c(new_n43_), .O(z14));
  ...
  aoi21  g38(.a(new_n55_), .b(x15), .c(new_n43_), .O(z18));
