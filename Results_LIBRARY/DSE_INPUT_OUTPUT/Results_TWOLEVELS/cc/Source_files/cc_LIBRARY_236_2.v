...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n61_, new_n62_, new_n63_, new_n65_, new_n67_, new_n69_, new_n74_,
  ...
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n74_), .O(z12));
  ...
  nand2  g46(.a(new_n75_), .b(x15), .O(new_n88_));
  ...
  nand3  g51(.a(new_n77_), .b(x16), .c(new_n47_), .O(new_n93_));
  nand3  g52(.a(new_n79_), .b(x08), .c(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n74_), .O(z15));
  oai21  g54(.a(new_n67_), .b(new_n74_), .c(x19), .O(new_n96_));
  ...
  nand2  g61(.a(new_n75_), .b(x18), .O(new_n103_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n74_), .O(z17));
  oai21  g67(.a(x15), .b(x06), .c(x10), .O(new_n109_));
  nand2  g68(.a(new_n75_), .b(x19), .O(new_n110_));
  oai21  g69(.a(new_n109_), .b(new_n51_), .c(new_n110_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x12), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n50_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n74_), .c(x19), .O(new_n114_));
