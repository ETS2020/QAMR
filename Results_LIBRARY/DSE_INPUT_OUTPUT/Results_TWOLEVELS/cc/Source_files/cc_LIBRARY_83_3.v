...
module FAU ( 
  ...
  nor2   g20(.a(new_n53_), .b(new_n61_), .O(z07));
  inv1   g21(.a(x16), .O(new_n63_));
  nor2   g22(.a(new_n53_), .b(new_n63_), .O(z08));
  nand3  g23(.a(new_n54_), .b(x09), .c(x08), .O(new_n65_));
  inv1   g24(.a(new_n65_), .O(z09));
  nand3  g25(.a(new_n54_), .b(x09), .c(x08), .O(z10));
  nand2  g26(.a(new_n54_), .b(new_n49_), .O(z11));
  ...
  nand3  g42(.a(new_n46_), .b(new_n44_), .c(x15), .O(new_n84_));
  ...
  nand3  g48(.a(new_n46_), .b(x16), .c(new_n49_), .O(new_n90_));
  ...
  nand3  g63(.a(new_n44_), .b(x18), .c(x15), .O(new_n105_));
  ...
  nand3  g69(.a(new_n44_), .b(x19), .c(x15), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n83_), .O(z18));
  inv1   g71(.a(x07), .O(new_n113_));
  nand2  g72(.a(new_n46_), .b(x20), .O(new_n114_));
  oai21  g73(.a(new_n46_), .b(new_n113_), .c(new_n114_), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(new_n43_), .c(x12), .O(new_n116_));
