...
module FAU ( 
  ...
  inv1   g12(.a(new_n43_), .O(new_n55_));
  nor2   g13(.a(new_n55_), .b(x18), .O(z04));
  ...
  nor2   g22(.a(new_n55_), .b(new_n47_), .O(z11));
  nand2  g23(.a(x10), .b(x08), .O(new_n66_));
  nand2  g24(.a(new_n66_), .b(x13), .O(new_n67_));
  aoi21  g25(.a(new_n51_), .b(x00), .c(x15), .O(new_n68_));
  aoi21  g26(.a(new_n68_), .b(new_n67_), .c(new_n45_), .O(z12));
  inv1   g27(.a(x01), .O(new_n70_));
  oai21  g28(.a(new_n66_), .b(new_n70_), .c(x14), .O(new_n71_));
  aoi21  g29(.a(new_n71_), .b(new_n46_), .c(new_n45_), .O(z13));
  nand2  g30(.a(new_n51_), .b(x02), .O(new_n73_));
  aoi21  g31(.a(new_n73_), .b(new_n46_), .c(new_n45_), .O(z14));
  nand3  g32(.a(new_n66_), .b(x16), .c(new_n47_), .O(new_n75_));
  ...
  nand2  g37(.a(new_n66_), .b(x17), .O(new_n80_));
  aoi21  g38(.a(new_n51_), .b(x04), .c(x15), .O(new_n81_));
  aoi21  g39(.a(new_n81_), .b(new_n80_), .c(new_n45_), .O(z16));
  nand2  g40(.a(new_n66_), .b(x18), .O(new_n83_));
  ...
  nand2  g45(.a(new_n66_), .b(x19), .O(new_n88_));
  ...
  nand2  g50(.a(new_n66_), .b(x20), .O(new_n93_));
  aoi21  g51(.a(new_n51_), .b(x07), .c(x15), .O(new_n94_));
  aoi21  g52(.a(new_n94_), .b(new_n93_), .c(new_n45_), .O(z19));
  zero   g53(.O(z03));
  buf    g54(.a(x15), .O(z06));
endmodule
