...
module FAU ( 
  ...
  nand4  g09(.a(new_n43_), .b(new_n46_), .c(x10), .d(x08), .O(new_n51_));
  ...
  nand2  g19(.a(new_n43_), .b(new_n46_), .O(z06));
  ...
  aoi21  g31(.a(new_n72_), .b(new_n70_), .c(new_n55_), .O(z12));
  oai21  g32(.a(new_n56_), .b(new_n43_), .c(new_n46_), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(x12), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n44_), .O(z13));
  nand2  g35(.a(new_n56_), .b(x15), .O(new_n77_));
  nand4  g36(.a(new_n71_), .b(x10), .c(x08), .d(x02), .O(new_n78_));
  ...
  nand3  g41(.a(new_n43_), .b(x10), .c(x08), .O(new_n83_));
  nand4  g42(.a(new_n83_), .b(x16), .c(new_n46_), .d(x12), .O(new_n84_));
