...
module FAU ( 
  ...
  nand2  g19(.a(new_n50_), .b(new_n43_), .O(z06));
  ...
  nand3  g44(.a(new_n85_), .b(new_n43_), .c(x02), .O(new_n86_));
  ...
  nand4  g49(.a(new_n51_), .b(x16), .c(new_n47_), .d(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(z15));
  nand2  g51(.a(new_n55_), .b(x17), .O(new_n93_));
  nand4  g52(.a(new_n50_), .b(x10), .c(x08), .d(x04), .O(new_n94_));
  ...
  nand3  g60(.a(new_n51_), .b(x18), .c(x12), .O(new_n102_));
  ...
  nand3  g65(.a(new_n51_), .b(x19), .c(x12), .O(new_n107_));
