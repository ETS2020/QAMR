...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n66_), .c(new_n46_), .O(new_n79_));
  ...
  nand3  g51(.a(new_n52_), .b(x10), .c(x08), .O(new_n93_));
  nand3  g52(.a(new_n93_), .b(x17), .c(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n92_), .O(z16));
  ...
  nand3  g57(.a(new_n93_), .b(x18), .c(x12), .O(new_n99_));
  ...
  nand3  g62(.a(new_n93_), .b(x19), .c(x12), .O(new_n104_));
