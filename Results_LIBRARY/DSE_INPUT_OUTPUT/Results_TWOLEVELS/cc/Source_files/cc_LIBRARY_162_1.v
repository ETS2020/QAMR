...
module FAU ( 
  ...
  nand2  g28(.a(new_n47_), .b(new_n61_), .O(new_n70_));
  ...
  nor2   g34(.a(new_n75_), .b(new_n43_), .O(new_n76_));
  ...
  nand2  g51(.a(new_n92_), .b(new_n61_), .O(new_n93_));
  ...
  nand3  g63(.a(new_n99_), .b(x20), .c(x12), .O(new_n105_));
