...
module FAU ( 
  ...
  nor2   g15(.a(new_n51_), .b(x07), .O(new_n57_));
  ...
  nor2   g21(.a(x08), .b(new_n45_), .O(new_n63_));
  aoi21  g22(.a(new_n63_), .b(new_n45_), .c(new_n46_), .O(z06));
  ...
  aoi21  g37(.a(new_n78_), .b(new_n75_), .c(new_n72_), .O(z12));
  oai21  g38(.a(new_n76_), .b(new_n51_), .c(new_n47_), .O(new_n80_));
  ...
  nand3  g44(.a(new_n85_), .b(x15), .c(new_n45_), .O(new_n86_));
  nand3  g45(.a(new_n77_), .b(x08), .c(x02), .O(new_n87_));
  aoi21  g46(.a(new_n87_), .b(new_n86_), .c(new_n72_), .O(z14));
  ...
  nand3  g50(.a(new_n85_), .b(x16), .c(new_n47_), .O(new_n92_));
  nand4  g51(.a(new_n46_), .b(x10), .c(x08), .d(x03), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n91_), .O(z15));
  nand2  g55(.a(new_n85_), .b(x17), .O(new_n97_));
  ...
  nand3  g59(.a(x17), .b(x15), .c(new_n45_), .O(new_n101_));
  ...
  nand2  g64(.a(new_n85_), .b(x18), .O(new_n106_));
  ...
  oai21  g69(.a(new_n61_), .b(new_n72_), .c(new_n45_), .O(new_n111_));
  ...
  nand3  g76(.a(x12), .b(x10), .c(x08), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(new_n46_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x07), .O(new_n120_));
  nand2  g79(.a(new_n77_), .b(x08), .O(new_n121_));
  nand3  g80(.a(new_n121_), .b(x20), .c(x12), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(new_n120_), .O(z19));
endmodule
