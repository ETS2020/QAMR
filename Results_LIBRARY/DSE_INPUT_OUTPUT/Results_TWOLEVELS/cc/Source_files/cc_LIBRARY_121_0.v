...
module FAU ( 
  ...
  nor2   g02(.a(x15), .b(x10), .O(new_n44_));
  ...
  aoi21  g11(.a(new_n52_), .b(x08), .c(x14), .O(new_n53_));
  nand2  g12(.a(x15), .b(x14), .O(new_n54_));
  oai21  g13(.a(new_n53_), .b(new_n51_), .c(new_n54_), .O(new_n55_));
  ...
  aoi21  g31(.a(new_n52_), .b(x08), .c(new_n72_), .O(new_n73_));
  nand3  g32(.a(new_n52_), .b(x08), .c(x00), .O(new_n74_));
  ...
  oai21  g41(.a(new_n52_), .b(x12), .c(new_n51_), .O(new_n83_));
  inv1   g42(.a(x02), .O(new_n84_));
  nand2  g43(.a(new_n52_), .b(x08), .O(new_n85_));
  nand2  g44(.a(x15), .b(new_n67_), .O(new_n86_));
  ...
  nand3  g49(.a(x16), .b(new_n48_), .c(new_n67_), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x10), .O(new_n93_));
  nand3  g52(.a(x16), .b(x15), .c(new_n48_), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n58_), .O(z15));
  inv1   g54(.a(x04), .O(new_n96_));
  nand2  g55(.a(x12), .b(x08), .O(new_n97_));
  oai21  g56(.a(new_n97_), .b(new_n96_), .c(x10), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  nand3  g58(.a(new_n85_), .b(x17), .c(x12), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(z16));
  inv1   g60(.a(x05), .O(new_n102_));
  oai21  g61(.a(new_n97_), .b(new_n102_), .c(x10), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n52_), .O(new_n104_));
  nand3  g63(.a(new_n85_), .b(x18), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(z17));
  inv1   g65(.a(x06), .O(new_n107_));
  oai21  g66(.a(new_n97_), .b(new_n107_), .c(x10), .O(new_n108_));
  ...
  nand2  g71(.a(x20), .b(new_n67_), .O(new_n113_));
  oai21  g72(.a(new_n85_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x10), .O(new_n115_));
  nand2  g74(.a(x20), .b(x15), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n58_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
