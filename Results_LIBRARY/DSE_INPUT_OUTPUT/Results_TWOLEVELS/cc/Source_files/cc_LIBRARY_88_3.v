...
module FAU ( 
  ...
  aoi21  g27(.a(new_n68_), .b(new_n66_), .c(new_n65_), .O(z12));
  inv1   g28(.a(x01), .O(new_n70_));
  oai21  g29(.a(new_n46_), .b(new_n70_), .c(x14), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(new_n45_), .c(new_n65_), .O(z13));
  ...
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n65_), .O(z19));
endmodule
