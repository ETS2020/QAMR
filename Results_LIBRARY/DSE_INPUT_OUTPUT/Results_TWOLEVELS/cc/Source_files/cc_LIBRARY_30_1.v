...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n49_, new_n50_,
    ...
    new_n61_, new_n63_, new_n65_, new_n67_, new_n69_, new_n72_, new_n73_,
  ...
  nand3  g05(.a(x10), .b(x09), .c(x08), .O(new_n47_));
  ...
  nand3  g16(.a(new_n57_), .b(new_n51_), .c(x12), .O(new_n58_));
  ...
  oai21  g26(.a(new_n67_), .b(new_n50_), .c(new_n49_), .O(z09));
  nand2  g27(.a(new_n44_), .b(new_n67_), .O(new_n69_));
  oai21  g28(.a(new_n67_), .b(x08), .c(new_n69_), .O(z10));
  nor2   g29(.a(new_n45_), .b(new_n51_), .O(z11));
  inv1   g30(.a(x12), .O(new_n72_));
  nand2  g31(.a(new_n56_), .b(new_n44_), .O(new_n73_));
  nand2  g32(.a(x15), .b(x09), .O(new_n74_));
  ...
  nand2  g39(.a(new_n80_), .b(x09), .O(new_n81_));
  ...
  nand3  g56(.a(x17), .b(x15), .c(x09), .O(new_n98_));
  ...
  nand3  g62(.a(x18), .b(x15), .c(x09), .O(new_n104_));
  ...
  nand3  g68(.a(x19), .b(x15), .c(x09), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n72_), .O(z18));
  oai21  g70(.a(new_n43_), .b(new_n72_), .c(x09), .O(new_n112_));
