...
module FAU ( 
  ...
  oai21  g30(.a(new_n71_), .b(new_n67_), .c(new_n45_), .O(z12));
  nand2  g31(.a(new_n49_), .b(x01), .O(new_n73_));
  nand3  g32(.a(new_n73_), .b(new_n45_), .c(x14), .O(new_n74_));
  inv1   g33(.a(x16), .O(new_n75_));
  nand2  g34(.a(x19), .b(new_n75_), .O(new_n76_));
  nand4  g35(.a(new_n76_), .b(x15), .c(x10), .d(x08), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n74_), .c(new_n67_), .O(z13));
  ...
  aoi22  g48(.a(new_n89_), .b(new_n69_), .c(new_n53_), .d(x17), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n67_), .c(new_n45_), .O(z16));
  ...
  nand3  g64(.a(new_n105_), .b(new_n45_), .c(x12), .O(new_n106_));
