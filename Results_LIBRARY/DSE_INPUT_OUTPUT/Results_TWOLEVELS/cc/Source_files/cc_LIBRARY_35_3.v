...
module FAU ( 
  ...
  nand4  g43(.a(new_n42_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  ...
  oai21  g57(.a(new_n72_), .b(new_n97_), .c(new_n98_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(new_n42_), .c(x12), .O(new_n100_));
  ...
  nand3  g73(.a(x19), .b(new_n43_), .c(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n110_), .O(z18));
  ...
  nand4  g79(.a(new_n42_), .b(x10), .c(x08), .d(x07), .O(new_n121_));
