...
module FAU ( 
  ...
  oai21  g42(.a(new_n79_), .b(new_n44_), .c(new_n83_), .O(new_n84_));
  ...
  nand3  g48(.a(new_n78_), .b(x16), .c(new_n49_), .O(new_n90_));
  ...
  nand2  g54(.a(new_n78_), .b(x17), .O(new_n96_));
  oai21  g55(.a(new_n78_), .b(new_n95_), .c(new_n96_), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n44_), .O(new_n98_));
  nand3  g57(.a(x17), .b(x15), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n54_), .O(z16));
  inv1   g59(.a(x05), .O(new_n101_));
  nand2  g60(.a(new_n78_), .b(x18), .O(new_n102_));
  oai21  g61(.a(new_n78_), .b(new_n101_), .c(new_n102_), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n44_), .O(new_n104_));
  nand3  g63(.a(x18), .b(x15), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n54_), .O(z17));
  oai21  g65(.a(new_n58_), .b(new_n54_), .c(x07), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand4  g67(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n109_));
  oai21  g68(.a(new_n79_), .b(new_n58_), .c(new_n109_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x12), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(new_n108_), .O(z18));
  aoi21  g71(.a(new_n50_), .b(new_n43_), .c(new_n60_), .O(new_n113_));
  nor2   g72(.a(new_n79_), .b(new_n43_), .O(new_n114_));
  oai21  g73(.a(new_n114_), .b(new_n113_), .c(x12), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(new_n56_), .O(z19));
endmodule
