...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n62_, new_n63_, new_n64_, new_n67_, new_n69_, new_n73_, new_n74_,
  ...
  nand2  g21(.a(x10), .b(new_n62_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n62_), .c(x12), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(x04), .c(new_n51_), .O(z06));
  ...
  aoi21  g29(.a(x09), .b(x08), .c(new_n58_), .O(z10));
  nor2   g30(.a(new_n58_), .b(new_n48_), .O(z11));
  ...
  oai21  g35(.a(new_n76_), .b(new_n43_), .c(new_n44_), .O(z12));
  ...
  nand3  g51(.a(new_n74_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z16));
  nand2  g53(.a(new_n52_), .b(x18), .O(new_n95_));
  nand3  g54(.a(new_n74_), .b(x08), .c(x05), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n43_), .O(z17));
  nand2  g56(.a(new_n52_), .b(x19), .O(new_n98_));
  nand3  g57(.a(new_n74_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z18));
  and2   g59(.a(x08), .b(x07), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n74_), .c(new_n52_), .d(x20), .O(new_n102_));
  oai21  g61(.a(new_n102_), .b(new_n43_), .c(new_n44_), .O(z19));
endmodule
