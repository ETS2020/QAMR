...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n51_,
    new_n53_, new_n55_, new_n56_, new_n59_, new_n60_, new_n62_, new_n64_,
  ...
  aoi21  g12(.a(new_n53_), .b(x12), .c(x18), .O(z04));
  inv1   g13(.a(x19), .O(new_n55_));
  nand2  g14(.a(new_n53_), .b(x12), .O(new_n56_));
  ...
  aoi22  g25(.a(new_n53_), .b(x12), .c(x09), .d(x08), .O(z10));
  ...
  nor3   g30(.a(new_n71_), .b(new_n53_), .c(new_n43_), .O(z13));
  ...
  aoi21  g36(.a(new_n59_), .b(x15), .c(new_n43_), .O(z16));
