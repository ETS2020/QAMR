...
module FAU ( 
  ...
  nand2  g25(.a(new_n66_), .b(new_n43_), .O(z08));
  inv1   g26(.a(x09), .O(new_n68_));
  nor3   g27(.a(new_n44_), .b(new_n68_), .c(new_n50_), .O(z09));
  ...
  nor2   g32(.a(new_n66_), .b(new_n43_), .O(new_n74_));
  ...
  oai21  g52(.a(new_n93_), .b(new_n72_), .c(new_n45_), .O(z15));
  ...
  aoi21  g59(.a(x18), .b(x12), .c(new_n66_), .O(new_n101_));
  and2   g60(.a(x08), .b(x05), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n77_), .c(new_n55_), .d(x18), .O(new_n103_));
  oai22  g62(.a(new_n103_), .b(new_n72_), .c(new_n101_), .d(new_n43_), .O(z17));
  aoi21  g63(.a(x19), .b(x12), .c(new_n66_), .O(new_n105_));
  and2   g64(.a(x08), .b(x06), .O(new_n106_));
  aoi22  g65(.a(new_n106_), .b(new_n77_), .c(new_n55_), .d(x19), .O(new_n107_));
  oai22  g66(.a(new_n107_), .b(new_n72_), .c(new_n105_), .d(new_n43_), .O(z18));
  inv1   g67(.a(x07), .O(new_n109_));
  nand2  g68(.a(new_n55_), .b(x20), .O(new_n110_));
  oai21  g69(.a(new_n55_), .b(new_n109_), .c(new_n110_), .O(new_n111_));
