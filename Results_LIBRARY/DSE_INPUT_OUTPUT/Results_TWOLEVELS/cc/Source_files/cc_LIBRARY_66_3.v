...
module FAU ( 
  ...
  aoi21  g18(.a(x16), .b(x15), .c(new_n59_), .O(z05));
  ...
  nand2  g27(.a(new_n68_), .b(new_n54_), .O(new_n69_));
  ...
  oai21  g38(.a(new_n78_), .b(new_n77_), .c(new_n79_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n54_), .c(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n45_), .c(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n76_), .O(z13));
  ...
  nand3  g48(.a(new_n46_), .b(x16), .c(new_n79_), .O(new_n90_));
  nand3  g49(.a(x10), .b(x08), .c(x03), .O(new_n91_));
  ...
  nand3  g57(.a(x17), .b(new_n54_), .c(x15), .O(new_n99_));
  ...
  nand3  g63(.a(x18), .b(new_n54_), .c(x15), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n76_), .O(z17));
  oai21  g65(.a(new_n59_), .b(new_n76_), .c(new_n54_), .O(new_n107_));
  ...
  nand2  g73(.a(new_n114_), .b(new_n54_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n46_), .b(x20), .O(new_n117_));
