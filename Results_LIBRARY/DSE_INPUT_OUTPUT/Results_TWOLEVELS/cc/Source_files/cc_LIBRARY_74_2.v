...
module FAU ( 
  ...
  nand2  g19(.a(new_n51_), .b(new_n43_), .O(z06));
  ...
  nand4  g29(.a(new_n51_), .b(x10), .c(x08), .d(x00), .O(new_n71_));
  ...
  or2    g35(.a(new_n76_), .b(new_n51_), .O(new_n77_));
  ...
  nand3  g41(.a(new_n47_), .b(x16), .c(new_n48_), .O(new_n83_));
