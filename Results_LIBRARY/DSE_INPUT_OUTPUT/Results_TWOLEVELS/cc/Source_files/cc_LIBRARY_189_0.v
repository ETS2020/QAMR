...
module FAU ( 
  ...
  oai21  g38(.a(new_n79_), .b(new_n69_), .c(new_n46_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  inv1   g40(.a(x01), .O(new_n82_));
  oai21  g41(.a(new_n56_), .b(new_n82_), .c(x14), .O(new_n83_));
  ...
  nand4  g49(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n91_));
