...
module FAU ( 
  ...
  nor2   g02(.a(x12), .b(x04), .O(new_n44_));
  ...
  nand3  g20(.a(new_n61_), .b(x10), .c(x08), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(x12), .c(x04), .O(new_n63_));
  ...
  nor3   g29(.a(new_n44_), .b(new_n70_), .c(new_n69_), .O(z09));
  ...
  aoi22  g36(.a(new_n77_), .b(new_n76_), .c(new_n52_), .d(x13), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n74_), .c(new_n46_), .O(z12));
  nor2   g38(.a(new_n61_), .b(new_n51_), .O(new_n80_));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n74_), .O(z18));
  and2   g60(.a(x08), .b(x07), .O(new_n102_));
  aoi22  g61(.a(new_n102_), .b(new_n76_), .c(new_n52_), .d(x20), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(new_n74_), .c(new_n46_), .O(z19));
endmodule
