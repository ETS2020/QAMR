...
module FAU ( 
  ...
  oai21  g39(.a(new_n48_), .b(new_n51_), .c(new_n80_), .O(new_n81_));
  ...
  nand4  g45(.a(new_n52_), .b(x16), .c(new_n46_), .d(x12), .O(new_n87_));
  ...
  nand2  g58(.a(new_n52_), .b(new_n59_), .O(new_n100_));
