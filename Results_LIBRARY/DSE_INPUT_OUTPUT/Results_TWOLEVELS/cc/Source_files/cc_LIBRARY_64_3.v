...
module FAU ( 
  ...
  aoi21  g16(.a(new_n57_), .b(z04), .c(new_n45_), .O(z03));
  ...
  nand2  g28(.a(new_n46_), .b(new_n45_), .O(new_n70_));
  ...
  oai21  g37(.a(new_n77_), .b(new_n49_), .c(new_n78_), .O(new_n79_));
  ...
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n69_), .O(z13));
  ...
  nand3  g47(.a(new_n72_), .b(x16), .c(new_n78_), .O(new_n89_));
  nand3  g48(.a(new_n74_), .b(x08), .c(x03), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n69_), .O(z15));
  ...
  nand3  g54(.a(z04), .b(x17), .c(x15), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n69_), .O(z16));
  nand2  g56(.a(new_n46_), .b(x18), .O(new_n98_));
  nand2  g57(.a(x08), .b(x05), .O(new_n99_));
  oai21  g58(.a(new_n99_), .b(new_n51_), .c(new_n98_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n42_), .O(z17));
  oai21  g61(.a(new_n59_), .b(new_n69_), .c(z04), .O(new_n103_));
  ...
  nand3  g72(.a(x20), .b(z04), .c(x15), .O(new_n114_));
