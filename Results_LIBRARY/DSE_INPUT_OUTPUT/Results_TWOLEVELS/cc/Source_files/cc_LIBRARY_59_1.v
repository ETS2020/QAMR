...
module FAU ( 
  ...
  oai21  g37(.a(new_n67_), .b(new_n55_), .c(new_n44_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n78_), .O(new_n80_));
  nand2  g39(.a(x08), .b(x01), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n74_), .c(new_n67_), .O(new_n82_));
  aoi21  g41(.a(x10), .b(x08), .c(new_n67_), .O(new_n83_));
  aoi21  g42(.a(new_n82_), .b(x15), .c(new_n83_), .O(new_n84_));
  oai21  g43(.a(new_n84_), .b(new_n55_), .c(new_n80_), .O(z13));
  nand2  g44(.a(new_n69_), .b(x15), .O(new_n86_));
  ...
  nand3  g49(.a(new_n72_), .b(x16), .c(new_n67_), .O(new_n91_));
  nand3  g50(.a(new_n75_), .b(x08), .c(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n55_), .O(z15));
  oai21  g52(.a(new_n60_), .b(new_n55_), .c(x01), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x15), .O(new_n95_));
  nand2  g54(.a(new_n69_), .b(x17), .O(new_n96_));
  ...
  nand2  g62(.a(new_n69_), .b(x18), .O(new_n104_));
  ...
  nand2  g67(.a(new_n69_), .b(x19), .O(new_n109_));
  ...
  nand3  g71(.a(x19), .b(x15), .c(x01), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n55_), .O(z18));
  oai21  g73(.a(new_n43_), .b(new_n55_), .c(x01), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n69_), .b(x20), .O(new_n117_));
