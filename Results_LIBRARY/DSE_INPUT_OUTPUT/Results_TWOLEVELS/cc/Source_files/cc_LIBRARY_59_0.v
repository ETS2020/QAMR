...
module FAU ( 
  ...
  nor2   g01(.a(x15), .b(x01), .O(new_n43_));
  ...
  nand2  g21(.a(new_n52_), .b(x01), .O(z06));
  ...
  aoi22  g40(.a(new_n81_), .b(x15), .c(new_n47_), .d(x14), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n58_), .c(new_n44_), .O(z13));
  nand2  g42(.a(x08), .b(x02), .O(new_n84_));
  oai22  g43(.a(new_n84_), .b(new_n72_), .c(new_n48_), .d(new_n52_), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n44_), .O(z14));
  nand3  g46(.a(new_n47_), .b(x16), .c(new_n46_), .O(new_n88_));
  nand2  g47(.a(x08), .b(x03), .O(new_n89_));
  oai21  g48(.a(new_n89_), .b(new_n72_), .c(new_n88_), .O(new_n90_));
  ...
  nor2   g52(.a(new_n58_), .b(new_n80_), .O(new_n94_));
  ...
  nand3  g58(.a(new_n94_), .b(x08), .c(x05), .O(new_n100_));
  ...
  oai22  g64(.a(new_n105_), .b(new_n72_), .c(new_n48_), .d(new_n61_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x01), .O(new_n107_));
  nand2  g66(.a(x19), .b(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n58_), .O(z18));
  nand3  g68(.a(new_n94_), .b(x08), .c(x07), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x01), .O(new_n111_));
