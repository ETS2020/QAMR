...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n65_, new_n69_, new_n71_, new_n73_, new_n74_, new_n76_, new_n78_,
    new_n80_, new_n82_;
  ...
  aoi22  g25(.a(new_n44_), .b(x12), .c(x09), .d(x08), .O(z10));
  nor2   g26(.a(new_n57_), .b(new_n47_), .O(z11));
  inv1   g27(.a(x13), .O(new_n69_));
  aoi21  g28(.a(x15), .b(new_n69_), .c(new_n50_), .O(z12));
  aoi21  g29(.a(x10), .b(x08), .c(x14), .O(new_n71_));
  aoi21  g30(.a(new_n71_), .b(x15), .c(new_n50_), .O(z13));
  ...
  aoi21  g42(.a(new_n43_), .b(x15), .c(new_n50_), .O(z19));
endmodule
