...
module FAU ( 
  ...
  nand4  g16(.a(new_n57_), .b(x19), .c(x15), .d(new_n47_), .O(new_n58_));
  ...
  nand3  g42(.a(new_n72_), .b(x19), .c(x15), .O(new_n84_));
  ...
  nand2  g47(.a(x19), .b(x15), .O(new_n89_));
  ...
  nand3  g56(.a(x19), .b(x17), .c(x15), .O(new_n98_));
  ...
  nand3  g62(.a(x19), .b(x18), .c(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n78_), .O(z17));
  inv1   g64(.a(x06), .O(new_n106_));
  oai22  g65(.a(new_n89_), .b(x14), .c(x15), .d(new_n106_), .O(new_n107_));
  nand3  g66(.a(new_n107_), .b(x10), .c(x08), .O(new_n108_));
  nand2  g67(.a(x15), .b(x14), .O(new_n109_));
  nand3  g68(.a(new_n109_), .b(x10), .c(x08), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x19), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n108_), .c(new_n78_), .O(z18));
  oai21  g71(.a(new_n43_), .b(new_n78_), .c(x19), .O(new_n113_));
