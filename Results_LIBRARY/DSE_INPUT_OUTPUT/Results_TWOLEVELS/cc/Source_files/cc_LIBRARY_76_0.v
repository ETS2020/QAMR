...
module FAU ( 
  ...
  aoi21  g21(.a(new_n62_), .b(x08), .c(new_n49_), .O(z06));
  ...
  oai21  g31(.a(new_n55_), .b(new_n72_), .c(x12), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n49_), .O(new_n74_));
  nand3  g33(.a(new_n50_), .b(x13), .c(x12), .O(new_n75_));
  ...
  aoi21  g45(.a(new_n86_), .b(new_n83_), .c(new_n54_), .O(z14));
