...
module FAU ( 
  ...
  nor2   g01(.a(x12), .b(x01), .O(new_n43_));
  ...
  nor3   g25(.a(new_n43_), .b(new_n66_), .c(new_n46_), .O(z09));
  ...
  aoi22  g32(.a(new_n73_), .b(new_n72_), .c(new_n51_), .d(x13), .O(new_n74_));
  oai21  g33(.a(new_n74_), .b(new_n70_), .c(new_n44_), .O(z12));
  oai21  g34(.a(new_n71_), .b(new_n46_), .c(new_n47_), .O(new_n76_));
  ...
  aoi22  g48(.a(new_n89_), .b(new_n72_), .c(new_n51_), .d(x17), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n70_), .c(new_n44_), .O(z16));
  nand2  g50(.a(new_n51_), .b(x18), .O(new_n92_));
  nand3  g51(.a(new_n72_), .b(x08), .c(x05), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n70_), .O(z17));
  and2   g53(.a(x08), .b(x06), .O(new_n95_));
  aoi22  g54(.a(new_n95_), .b(new_n72_), .c(new_n51_), .d(x19), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(new_n70_), .c(new_n44_), .O(z18));
  nand2  g56(.a(new_n51_), .b(x20), .O(new_n98_));
  nand3  g57(.a(new_n72_), .b(x08), .c(x07), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n70_), .O(z19));
endmodule
