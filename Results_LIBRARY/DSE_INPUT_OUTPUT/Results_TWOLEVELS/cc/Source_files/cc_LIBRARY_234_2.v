...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n51_,
    new_n52_, new_n54_, new_n56_, new_n58_, new_n59_, new_n62_, new_n66_,
  ...
  aoi21  g37(.a(new_n78_), .b(x15), .c(new_n43_), .O(z19));
  buf    g38(.a(x15), .O(z06));
endmodule
