...
module FAU ( 
  ...
  nand3  g24(.a(new_n56_), .b(x09), .c(x08), .O(z10));
  nand2  g25(.a(new_n56_), .b(new_n49_), .O(z11));
  ...
  oai21  g33(.a(new_n69_), .b(new_n44_), .c(new_n74_), .O(z12));
  inv1   g34(.a(x10), .O(new_n76_));
  nand2  g35(.a(x08), .b(x07), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n49_), .O(new_n78_));
  nand3  g37(.a(x10), .b(x08), .c(x01), .O(new_n79_));
  aoi22  g38(.a(new_n79_), .b(x14), .c(new_n78_), .d(x15), .O(new_n80_));
  oai21  g39(.a(new_n80_), .b(new_n54_), .c(new_n56_), .O(z13));
  nand3  g40(.a(new_n70_), .b(x15), .c(x07), .O(new_n82_));
  nor2   g41(.a(x15), .b(new_n76_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x08), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n54_), .O(z14));
  nand2  g44(.a(new_n70_), .b(new_n44_), .O(new_n86_));
  nand2  g45(.a(x15), .b(x07), .O(new_n87_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n54_), .O(z15));
  inv1   g50(.a(x04), .O(new_n92_));
  nand2  g51(.a(new_n70_), .b(x17), .O(new_n93_));
  oai21  g52(.a(new_n70_), .b(new_n92_), .c(new_n93_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(new_n95_));
  nand3  g54(.a(x17), .b(x15), .c(x07), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n54_), .O(z16));
  inv1   g56(.a(x05), .O(new_n98_));
  nand2  g57(.a(new_n70_), .b(x18), .O(new_n99_));
  oai21  g58(.a(new_n70_), .b(new_n98_), .c(new_n99_), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n44_), .O(new_n101_));
  nand3  g60(.a(x18), .b(x15), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n54_), .O(z17));
  inv1   g62(.a(x06), .O(new_n104_));
  nand2  g63(.a(new_n70_), .b(x19), .O(new_n105_));
  oai21  g64(.a(new_n70_), .b(new_n104_), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n44_), .O(new_n107_));
  nand3  g66(.a(x19), .b(x15), .c(x07), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n54_), .O(z18));
  nand2  g68(.a(new_n50_), .b(new_n43_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x07), .O(new_n111_));
  nand3  g70(.a(new_n70_), .b(x20), .c(new_n44_), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n54_), .O(z19));
  buf    g72(.a(x15), .O(z06));
endmodule
