...
module FAU ( 
  ...
  oai21  g18(.a(new_n59_), .b(new_n48_), .c(new_n58_), .O(z03));
  ...
  nand2  g29(.a(new_n58_), .b(new_n47_), .O(z11));
  ...
  oai21  g52(.a(new_n49_), .b(new_n64_), .c(new_n93_), .O(new_n94_));
  ...
  nor2   g56(.a(new_n72_), .b(new_n80_), .O(new_n98_));
  nand3  g57(.a(new_n98_), .b(x08), .c(x05), .O(new_n99_));
  ...
  nand3  g62(.a(new_n98_), .b(x08), .c(x06), .O(new_n104_));
  ...
  nand3  g67(.a(new_n98_), .b(x08), .c(x07), .O(new_n109_));
