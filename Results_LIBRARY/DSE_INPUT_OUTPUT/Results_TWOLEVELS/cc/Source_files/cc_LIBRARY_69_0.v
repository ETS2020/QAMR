...
module FAU ( 
  ...
  nand2  g32(.a(new_n47_), .b(x16), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n51_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x13), .O(new_n76_));
  nand3  g35(.a(x16), .b(new_n51_), .c(x10), .O(new_n77_));
  ...
  nor2   g40(.a(new_n81_), .b(new_n51_), .O(new_n82_));
  ...
  nand3  g50(.a(new_n91_), .b(x16), .c(x12), .O(new_n92_));
  ...
  nand2  g70(.a(new_n111_), .b(x16), .O(new_n112_));
