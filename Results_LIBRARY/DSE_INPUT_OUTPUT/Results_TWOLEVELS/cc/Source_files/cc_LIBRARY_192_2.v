...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n52_, new_n55_, new_n56_, new_n59_, new_n61_, new_n63_, new_n64_,
  ...
  aoi21  g15(.a(new_n55_), .b(x12), .c(new_n56_), .O(z05));
  nand2  g16(.a(new_n55_), .b(new_n44_), .O(z06));
  inv1   g17(.a(x17), .O(new_n59_));
  aoi21  g18(.a(new_n55_), .b(x12), .c(new_n59_), .O(z07));
  inv1   g19(.a(x16), .O(new_n61_));
  nor2   g20(.a(new_n45_), .b(new_n61_), .O(z08));
  inv1   g21(.a(new_n45_), .O(new_n63_));
  nand2  g22(.a(x09), .b(x08), .O(new_n64_));
  nand2  g23(.a(new_n64_), .b(new_n63_), .O(z09));
  nand3  g24(.a(new_n63_), .b(x09), .c(x08), .O(z10));
  nand2  g25(.a(new_n63_), .b(new_n47_), .O(z11));
  inv1   g26(.a(x13), .O(new_n68_));
  aoi21  g27(.a(x15), .b(new_n68_), .c(new_n44_), .O(z12));
  ...
  aoi21  g35(.a(new_n59_), .b(x15), .c(new_n44_), .O(z16));
  inv1   g36(.a(x18), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(x15), .c(new_n44_), .O(z17));
