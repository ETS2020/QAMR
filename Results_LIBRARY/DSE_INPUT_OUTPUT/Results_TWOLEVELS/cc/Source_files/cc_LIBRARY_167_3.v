...
module FAU ( 
  ...
  nor2   g21(.a(new_n46_), .b(x15), .O(z07));
  ...
  oai21  g54(.a(new_n72_), .b(new_n94_), .c(new_n95_), .O(new_n96_));
  ...
  oai21  g65(.a(new_n61_), .b(new_n78_), .c(new_n46_), .O(new_n107_));
  ...
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n78_), .O(z19));
  buf    g78(.a(x15), .O(z06));
endmodule
