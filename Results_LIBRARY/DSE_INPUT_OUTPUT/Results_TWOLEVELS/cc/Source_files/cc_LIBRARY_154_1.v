...
module FAU ( 
  ...
  aoi21  g13(.a(x15), .b(new_n43_), .c(x18), .O(z04));
  inv1   g14(.a(x19), .O(new_n56_));
  aoi21  g15(.a(x15), .b(new_n43_), .c(new_n56_), .O(z05));
  nor2   g16(.a(x18), .b(x12), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(x12), .c(new_n46_), .O(z06));
  ...
  nand2  g50(.a(new_n69_), .b(x17), .O(new_n92_));
  nand4  g51(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n93_));
  ...
  nand4  g57(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n99_));
  ...
  nand2  g62(.a(new_n69_), .b(x19), .O(new_n104_));
  nand4  g63(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n105_));
  ...
  oai21  g67(.a(x20), .b(new_n43_), .c(x15), .O(new_n109_));
  ...
  aoi21  g73(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
endmodule
