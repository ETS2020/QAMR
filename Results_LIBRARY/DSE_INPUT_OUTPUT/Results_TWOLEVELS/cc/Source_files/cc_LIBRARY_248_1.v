...
module FAU ( 
  ...
  nor2   g18(.a(new_n47_), .b(x12), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n59_), .O(z05));
  aoi21  g20(.a(x10), .b(x08), .c(x14), .O(new_n62_));
  nand2  g21(.a(new_n62_), .b(new_n55_), .O(new_n63_));
  nand3  g22(.a(new_n63_), .b(x15), .c(x12), .O(new_n64_));
  ...
  nor2   g31(.a(new_n60_), .b(new_n50_), .O(z11));
  ...
  nor2   g37(.a(new_n62_), .b(new_n47_), .O(new_n79_));
  ...
  nand4  g68(.a(new_n47_), .b(x10), .c(x08), .d(x07), .O(new_n110_));
