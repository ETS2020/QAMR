...
module FAU ( 
  ...
  nand2  g28(.a(new_n49_), .b(x16), .O(new_n70_));
  ...
  nor2   g36(.a(new_n77_), .b(new_n50_), .O(new_n78_));
  ...
  nand2  g40(.a(new_n81_), .b(new_n55_), .O(z13));
  ...
  nand3  g44(.a(new_n50_), .b(x10), .c(x08), .O(new_n86_));
  ...
  nand3  g59(.a(new_n86_), .b(x18), .c(x12), .O(new_n101_));
  ...
  nand3  g64(.a(new_n86_), .b(x19), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(z18));
  nand2  g66(.a(new_n49_), .b(x20), .O(new_n108_));
  ...
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n69_), .O(z19));
  buf    g72(.a(x15), .O(z06));
endmodule
