...
module FAU ( 
  ...
  nand2  g20(.a(x20), .b(new_n52_), .O(z06));
  ...
  nand3  g32(.a(x20), .b(new_n52_), .c(x10), .O(new_n74_));
  ...
  nand3  g47(.a(new_n72_), .b(x16), .c(new_n48_), .O(new_n89_));
  ...
  nand3  g61(.a(new_n97_), .b(x18), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(z17));
  nand2  g63(.a(new_n72_), .b(x19), .O(new_n105_));
  nand3  g64(.a(new_n75_), .b(x08), .c(x06), .O(new_n106_));
