...
module FAU ( 
  ...
  nand3  g07(.a(x10), .b(x08), .c(x03), .O(new_n49_));
  nor3   g08(.a(new_n49_), .b(new_n48_), .c(x14), .O(z01));
  oai21  g09(.a(new_n48_), .b(x03), .c(x14), .O(new_n51_));
  ...
  nor2   g30(.a(new_n48_), .b(new_n44_), .O(new_n72_));
  ...
  nand3  g58(.a(x17), .b(x15), .c(x03), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n70_), .O(z16));
  nand2  g60(.a(new_n84_), .b(x18), .O(new_n102_));
  nand3  g61(.a(x10), .b(x08), .c(x05), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n48_), .O(new_n105_));
  nand3  g64(.a(x18), .b(x15), .c(x03), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n70_), .O(z17));
  oai21  g66(.a(new_n60_), .b(new_n70_), .c(x03), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n84_), .b(x19), .O(new_n110_));
  nand4  g69(.a(new_n48_), .b(x10), .c(x08), .d(x06), .O(new_n111_));
  ...
  oai21  g73(.a(new_n43_), .b(new_n70_), .c(x03), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n84_), .b(x20), .O(new_n117_));
