...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n60_, new_n61_, new_n64_, new_n66_, new_n68_, new_n69_,
    ...
    new_n106_, new_n108_, new_n109_, new_n110_;
  ...
  nand4  g19(.a(new_n60_), .b(x16), .c(x15), .d(new_n47_), .O(new_n61_));
  inv1   g20(.a(new_n61_), .O(z03));
  nor2   g21(.a(new_n45_), .b(x18), .O(z04));
  ...
  aoi21  g33(.a(x13), .b(x12), .c(new_n74_), .O(new_n75_));
  and2   g34(.a(x08), .b(x00), .O(new_n76_));
  aoi22  g35(.a(new_n76_), .b(new_n52_), .c(new_n57_), .d(x13), .O(new_n77_));
  oai22  g36(.a(new_n77_), .b(new_n73_), .c(new_n75_), .d(new_n44_), .O(z12));
  nand2  g37(.a(new_n48_), .b(new_n47_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x16), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n58_), .b(x01), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(new_n44_), .c(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n73_), .O(z13));
  nand3  g42(.a(new_n57_), .b(x16), .c(x15), .O(new_n84_));
  nand3  g43(.a(new_n52_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n73_), .O(z14));
  nand2  g45(.a(new_n44_), .b(x03), .O(new_n87_));
  nand3  g46(.a(x16), .b(x15), .c(new_n47_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n51_), .O(new_n89_));
  nand3  g48(.a(new_n57_), .b(x16), .c(new_n47_), .O(new_n90_));
  inv1   g49(.a(new_n90_), .O(new_n91_));
  aoi21  g50(.a(new_n89_), .b(x08), .c(new_n91_), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n73_), .c(new_n50_), .O(z15));
  ...
  nand3  g56(.a(x17), .b(x16), .c(x15), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n73_), .O(z16));
  aoi21  g58(.a(x18), .b(x12), .c(new_n74_), .O(new_n100_));
  and2   g59(.a(x08), .b(x05), .O(new_n101_));
  aoi22  g60(.a(new_n101_), .b(new_n52_), .c(new_n57_), .d(x18), .O(new_n102_));
  oai22  g61(.a(new_n102_), .b(new_n73_), .c(new_n100_), .d(new_n44_), .O(z17));
  aoi21  g62(.a(x19), .b(x12), .c(new_n74_), .O(new_n104_));
  and2   g63(.a(x08), .b(x06), .O(new_n105_));
  aoi22  g64(.a(new_n105_), .b(new_n52_), .c(new_n57_), .d(x19), .O(new_n106_));
  oai22  g65(.a(new_n106_), .b(new_n73_), .c(new_n104_), .d(new_n44_), .O(z18));
  aoi21  g66(.a(x20), .b(x12), .c(new_n74_), .O(new_n108_));
  and2   g67(.a(x08), .b(x07), .O(new_n109_));
  aoi22  g68(.a(new_n109_), .b(new_n52_), .c(new_n57_), .d(x20), .O(new_n110_));
  oai22  g69(.a(new_n110_), .b(new_n73_), .c(new_n108_), .d(new_n44_), .O(z19));
  buf    g70(.a(x15), .O(z06));
  buf    g71(.a(x16), .O(z08));
endmodule
