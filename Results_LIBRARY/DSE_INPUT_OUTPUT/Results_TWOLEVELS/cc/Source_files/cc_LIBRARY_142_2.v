...
module FAU ( 
  ...
  nor3   g26(.a(new_n44_), .b(new_n61_), .c(new_n50_), .O(z09));
  ...
  nand2  g31(.a(x19), .b(x15), .O(new_n73_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n71_), .c(new_n45_), .O(z13));
  nand3  g43(.a(new_n48_), .b(x19), .c(x15), .O(new_n85_));
  nand3  g44(.a(new_n76_), .b(x08), .c(x02), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n71_), .O(z14));
  nand3  g46(.a(new_n74_), .b(x16), .c(new_n51_), .O(new_n88_));
  ...
  nand3  g53(.a(x19), .b(x17), .c(x15), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n71_), .O(z16));
  aoi21  g55(.a(x18), .b(x12), .c(new_n47_), .O(new_n97_));
  ...
  oai21  g60(.a(new_n97_), .b(new_n43_), .c(new_n101_), .O(z17));
  inv1   g61(.a(x06), .O(new_n103_));
  oai22  g62(.a(new_n73_), .b(x14), .c(x15), .d(new_n103_), .O(new_n104_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n105_), .c(new_n71_), .O(z18));
  ...
  nand3  g72(.a(x20), .b(x19), .c(x15), .O(new_n114_));
