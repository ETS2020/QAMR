...
module FAU ( 
  ...
  nand3  g18(.a(new_n59_), .b(x10), .c(x08), .O(new_n60_));
  nand3  g19(.a(new_n60_), .b(x15), .c(x12), .O(new_n61_));
  ...
  inv1   g35(.a(new_n59_), .O(new_n77_));
  ...
  nand3  g47(.a(new_n47_), .b(x16), .c(new_n50_), .O(new_n89_));
  ...
  nand4  g60(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n102_));
  ...
  nor4   g73(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
