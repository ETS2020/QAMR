...
module FAU ( 
  ...
  nand2  g43(.a(new_n84_), .b(new_n81_), .O(new_n85_));
  ...
  oai21  g53(.a(new_n77_), .b(new_n62_), .c(new_n94_), .O(new_n95_));
  ...
  nand3  g58(.a(new_n83_), .b(x08), .c(x05), .O(new_n100_));
  ...
  oai21  g63(.a(new_n77_), .b(new_n60_), .c(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x05), .O(new_n106_));
  nand2  g65(.a(x19), .b(x15), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n93_), .O(z18));
  ...
  nand2  g70(.a(new_n111_), .b(x05), .O(new_n112_));
  nand2  g71(.a(x20), .b(x15), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n93_), .O(z19));
  buf    g73(.a(x15), .O(z06));
endmodule
