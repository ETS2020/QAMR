...
module FAU ( 
  ...
  aoi21  g34(.a(new_n75_), .b(new_n72_), .c(new_n50_), .O(z12));
  ...
  aoi21  g54(.a(new_n56_), .b(x18), .c(new_n95_), .O(new_n96_));
  nand3  g55(.a(x18), .b(x15), .c(x12), .O(new_n97_));
  ...
  oai21  g63(.a(new_n56_), .b(new_n104_), .c(x12), .O(new_n105_));
