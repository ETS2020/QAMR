...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n55_, new_n59_, new_n62_, new_n64_, new_n65_, new_n66_,
  ...
  aoi21  g20(.a(x15), .b(x12), .c(new_n62_), .O(z11));
  ...
  oai21  g27(.a(new_n46_), .b(new_n69_), .c(x14), .O(new_n70_));
  aoi21  g28(.a(new_n70_), .b(new_n45_), .c(new_n48_), .O(z13));
  nand2  g29(.a(new_n50_), .b(x02), .O(new_n72_));
  aoi21  g30(.a(new_n72_), .b(new_n45_), .c(new_n48_), .O(z14));
  nand3  g31(.a(new_n46_), .b(x16), .c(new_n62_), .O(new_n74_));
