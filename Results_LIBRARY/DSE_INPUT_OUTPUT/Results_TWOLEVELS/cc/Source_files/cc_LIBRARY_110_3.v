...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n58_, new_n60_, new_n64_, new_n65_, new_n66_,
  ...
  nand3  g31(.a(new_n46_), .b(x16), .c(new_n50_), .O(new_n74_));
  ...
  aoi21  g39(.a(new_n81_), .b(new_n79_), .c(new_n48_), .O(z16));
  ...
  aoi21  g48(.a(new_n90_), .b(new_n88_), .c(new_n48_), .O(z18));
  nand2  g49(.a(new_n46_), .b(x20), .O(new_n92_));
  nand3  g50(.a(x10), .b(x08), .c(x07), .O(new_n93_));
  nand2  g51(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand3  g52(.a(new_n94_), .b(new_n45_), .c(x12), .O(new_n95_));
  inv1   g53(.a(new_n95_), .O(z19));
  zero   g54(.O(z03));
  buf    g55(.a(x15), .O(z06));
endmodule
