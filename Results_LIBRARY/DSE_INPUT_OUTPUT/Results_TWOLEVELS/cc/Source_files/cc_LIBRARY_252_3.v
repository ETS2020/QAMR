...
module FAU ( 
  ...
  nor4   g07(.a(new_n48_), .b(new_n43_), .c(x14), .d(x13), .O(z01));
  ...
  aoi21  g14(.a(new_n55_), .b(new_n42_), .c(new_n43_), .O(z03));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n92_), .O(z16));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n92_), .O(z17));
  oai21  g63(.a(new_n58_), .b(new_n92_), .c(new_n42_), .O(new_n105_));
  ...
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n92_), .O(z19));
  buf    g76(.a(x15), .O(z06));
endmodule
