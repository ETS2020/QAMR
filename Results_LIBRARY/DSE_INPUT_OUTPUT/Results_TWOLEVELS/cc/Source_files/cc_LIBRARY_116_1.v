...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(new_n50_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x15), .c(x06), .O(new_n80_));
  ...
  nand3  g47(.a(x16), .b(new_n50_), .c(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x06), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x15), .O(new_n91_));
  nand3  g50(.a(new_n71_), .b(x16), .c(new_n50_), .O(new_n92_));
  ...
  oai21  g55(.a(new_n60_), .b(new_n55_), .c(x06), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(x15), .O(new_n98_));
  nand2  g57(.a(new_n71_), .b(x17), .O(new_n99_));
  ...
  nand3  g66(.a(x18), .b(x15), .c(x06), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n55_), .O(z17));
  nand2  g68(.a(new_n51_), .b(new_n58_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x06), .O(new_n111_));
  nand3  g70(.a(new_n71_), .b(x19), .c(new_n44_), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n55_), .O(z18));
  oai21  g72(.a(new_n43_), .b(new_n55_), .c(x06), .O(new_n114_));
