...
module FAU ( 
  ...
  aoi21  g26(.a(new_n63_), .b(x08), .c(new_n67_), .O(z08));
  inv1   g27(.a(x08), .O(new_n69_));
  nor3   g28(.a(new_n44_), .b(new_n62_), .c(new_n69_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n44_), .O(z10));
  nand2  g30(.a(new_n56_), .b(new_n46_), .O(z11));
  ...
  nand3  g34(.a(new_n51_), .b(x10), .c(x08), .O(new_n76_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n69_), .c(new_n46_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  nand2  g41(.a(new_n48_), .b(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x16), .c(x14), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n79_), .O(z13));
  nand2  g44(.a(new_n47_), .b(x15), .O(new_n86_));
  inv1   g45(.a(new_n52_), .O(new_n87_));
  nand4  g46(.a(new_n87_), .b(x10), .c(x08), .d(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n79_), .O(z14));
  nand2  g48(.a(new_n76_), .b(new_n46_), .O(new_n90_));
  nand4  g49(.a(new_n51_), .b(x10), .c(x08), .d(x03), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(x16), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z15));
  nand4  g53(.a(x12), .b(x10), .c(x08), .d(x04), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x16), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n51_), .O(new_n97_));
  nand3  g56(.a(new_n76_), .b(x17), .c(x12), .O(new_n98_));
  ...
  nand3  g61(.a(new_n76_), .b(x18), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(z17));
  nand2  g63(.a(new_n47_), .b(x19), .O(new_n105_));
  ...
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n79_), .O(z18));
  nand2  g69(.a(new_n47_), .b(x20), .O(new_n111_));
  nand4  g70(.a(new_n51_), .b(x10), .c(x08), .d(x07), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x16), .O(new_n114_));
  nand2  g73(.a(x20), .b(x15), .O(new_n115_));
  aoi21  g74(.a(new_n115_), .b(new_n114_), .c(new_n79_), .O(z19));
endmodule
