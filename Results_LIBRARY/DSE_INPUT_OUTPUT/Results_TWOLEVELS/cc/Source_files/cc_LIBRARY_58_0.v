...
module FAU ( 
  ...
  nand2  g19(.a(new_n51_), .b(x05), .O(z06));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n56_), .O(z12));
  ...
  nand2  g48(.a(new_n89_), .b(x05), .O(new_n90_));
  ...
  nand2  g52(.a(new_n93_), .b(x05), .O(new_n94_));
  ...
  nand2  g69(.a(new_n110_), .b(x05), .O(new_n111_));
