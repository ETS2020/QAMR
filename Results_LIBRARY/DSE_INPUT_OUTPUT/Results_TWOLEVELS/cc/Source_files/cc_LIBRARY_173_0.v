...
module FAU ( 
  ...
  oai21  g37(.a(new_n75_), .b(new_n61_), .c(new_n47_), .O(new_n79_));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n73_), .O(z16));
  ...
  nand3  g57(.a(new_n76_), .b(x08), .c(x06), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n73_), .O(z18));
  nand2  g59(.a(new_n52_), .b(x20), .O(new_n101_));
  nand3  g60(.a(new_n76_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n73_), .O(z19));
endmodule
