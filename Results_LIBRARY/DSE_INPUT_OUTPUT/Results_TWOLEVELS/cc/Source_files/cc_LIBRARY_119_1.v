...
module FAU ( 
  ...
  nand3  g40(.a(new_n44_), .b(new_n52_), .c(x10), .O(new_n82_));
  ...
  nand3  g55(.a(new_n83_), .b(x08), .c(x06), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n60_), .c(new_n57_), .O(z18));
  ...
  nand3  g60(.a(new_n53_), .b(x20), .c(x12), .O(new_n102_));
