...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n55_, new_n60_, new_n63_, new_n67_,
  ...
  nor4   g14(.a(new_n55_), .b(new_n43_), .c(x14), .d(new_n54_), .O(z03));
  inv1   g15(.a(x18), .O(z04));
  and2   g16(.a(new_n44_), .b(x19), .O(z05));
  nand2  g17(.a(z04), .b(new_n43_), .O(z06));
  ...
  nand4  g43(.a(new_n50_), .b(x16), .c(new_n47_), .d(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n84_), .O(z15));
  oai21  g45(.a(new_n67_), .b(x15), .c(x17), .O(new_n87_));
  nand4  g46(.a(new_n69_), .b(x10), .c(x08), .d(x04), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n54_), .O(z16));
  ...
  nand2  g51(.a(new_n92_), .b(new_n44_), .O(z17));
