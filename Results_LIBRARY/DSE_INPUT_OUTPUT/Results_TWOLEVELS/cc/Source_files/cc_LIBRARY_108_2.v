...
module FAU ( 
  ...
  nand3  g40(.a(new_n71_), .b(x08), .c(x02), .O(new_n82_));
  ...
  oai21  g51(.a(new_n92_), .b(new_n69_), .c(new_n45_), .O(z16));
  ...
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n70_), .O(new_n101_));
  aoi21  g60(.a(x10), .b(x08), .c(new_n59_), .O(new_n102_));
  aoi21  g61(.a(new_n101_), .b(x08), .c(new_n102_), .O(new_n103_));
  oai21  g62(.a(new_n103_), .b(new_n69_), .c(new_n45_), .O(z18));
