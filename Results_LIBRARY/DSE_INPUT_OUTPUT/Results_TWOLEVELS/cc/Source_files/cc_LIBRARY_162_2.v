...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n60_, new_n62_, new_n64_, new_n66_, new_n68_, new_n69_, new_n73_,
  ...
  nand4  g16(.a(new_n57_), .b(x17), .c(x15), .d(new_n47_), .O(new_n58_));
  ...
  nand2  g23(.a(new_n64_), .b(new_n44_), .O(z07));
  inv1   g24(.a(x16), .O(new_n66_));
  nand2  g25(.a(new_n60_), .b(new_n66_), .O(z08));
  ...
  oai21  g33(.a(new_n55_), .b(x15), .c(new_n74_), .O(new_n75_));
  ...
  aoi21  g38(.a(new_n79_), .b(new_n76_), .c(new_n73_), .O(z12));
  aoi21  g39(.a(x10), .b(x08), .c(x14), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n64_), .O(new_n82_));
  nand3  g41(.a(x10), .b(x08), .c(x01), .O(new_n83_));
  and2   g42(.a(new_n83_), .b(x14), .O(new_n84_));
  aoi21  g43(.a(new_n82_), .b(x15), .c(new_n84_), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n73_), .c(new_n60_), .O(z13));
  nand3  g45(.a(new_n54_), .b(x17), .c(x15), .O(new_n87_));
  nand3  g46(.a(new_n78_), .b(x08), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n73_), .O(z14));
  nand3  g48(.a(new_n75_), .b(x16), .c(new_n47_), .O(new_n90_));
  nand3  g49(.a(new_n78_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n73_), .O(z15));
  inv1   g51(.a(x04), .O(new_n93_));
  oai22  g52(.a(new_n74_), .b(x14), .c(x15), .d(new_n93_), .O(new_n94_));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n95_), .c(new_n73_), .O(z16));
  ...
  oai21  g64(.a(new_n62_), .b(new_n73_), .c(x17), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand4  g66(.a(new_n44_), .b(x10), .c(x08), .d(x06), .O(new_n108_));
  oai21  g67(.a(new_n55_), .b(new_n62_), .c(new_n108_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x12), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n107_), .O(z18));
  oai21  g70(.a(new_n43_), .b(new_n73_), .c(x17), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x15), .O(new_n113_));
  nand4  g72(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n114_));
  oai21  g73(.a(new_n55_), .b(new_n43_), .c(new_n114_), .O(new_n115_));
