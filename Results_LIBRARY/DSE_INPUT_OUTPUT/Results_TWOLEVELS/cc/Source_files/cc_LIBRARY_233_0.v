...
module FAU ( 
  ...
  inv1   g39(.a(new_n52_), .O(new_n81_));
  nand3  g40(.a(new_n81_), .b(x06), .c(x02), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n56_), .O(z14));
  nand4  g42(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(x06), .O(new_n85_));
  ...
  nand2  g54(.a(new_n95_), .b(x06), .O(new_n96_));
  ...
  oai21  g58(.a(new_n81_), .b(x19), .c(x12), .O(new_n100_));
