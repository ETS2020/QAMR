...
module FAU ( 
  ...
  nor3   g26(.a(new_n44_), .b(new_n62_), .c(new_n67_), .O(z09));
  ...
  nand3  g32(.a(new_n51_), .b(x10), .c(x08), .O(new_n74_));
  ...
  nor2   g42(.a(x16), .b(x15), .O(new_n84_));
  nand4  g43(.a(new_n84_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n56_), .O(z14));
  nand4  g45(.a(new_n51_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  oai21  g46(.a(new_n43_), .b(x14), .c(new_n87_), .O(new_n88_));
