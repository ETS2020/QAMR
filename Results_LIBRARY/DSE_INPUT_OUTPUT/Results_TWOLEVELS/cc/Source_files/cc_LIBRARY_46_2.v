...
module FAU ( 
  ...
  nand3  g13(.a(x15), .b(new_n43_), .c(x12), .O(new_n55_));
  ...
  nand2  g18(.a(new_n50_), .b(new_n43_), .O(z06));
  ...
  nor2   g27(.a(new_n50_), .b(new_n43_), .O(z11));
