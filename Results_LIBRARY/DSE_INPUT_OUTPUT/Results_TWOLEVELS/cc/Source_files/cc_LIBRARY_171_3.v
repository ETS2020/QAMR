...
module FAU ( 
  ...
  oai21  g18(.a(new_n60_), .b(new_n59_), .c(x15), .O(new_n61_));
  nor2   g19(.a(new_n61_), .b(x12), .O(z06));
  ...
  aoi21  g49(.a(new_n91_), .b(new_n89_), .c(new_n45_), .O(z17));
  nand2  g50(.a(new_n51_), .b(x19), .O(new_n93_));
  ...
  and2   g57(.a(new_n99_), .b(new_n46_), .O(new_n100_));
  aoi21  g58(.a(new_n100_), .b(new_n98_), .c(new_n45_), .O(z19));
  zero   g59(.O(z03));
endmodule
