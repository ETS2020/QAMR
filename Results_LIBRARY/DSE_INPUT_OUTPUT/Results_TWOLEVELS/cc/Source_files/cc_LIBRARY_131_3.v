...
module FAU ( 
  ...
  nand2  g15(.a(new_n42_), .b(new_n57_), .O(z07));
  ...
  aoi21  g27(.a(new_n69_), .b(new_n45_), .c(new_n48_), .O(z13));
  nand3  g28(.a(x10), .b(x08), .c(x02), .O(new_n71_));
  aoi21  g29(.a(new_n71_), .b(new_n45_), .c(new_n48_), .O(z14));
