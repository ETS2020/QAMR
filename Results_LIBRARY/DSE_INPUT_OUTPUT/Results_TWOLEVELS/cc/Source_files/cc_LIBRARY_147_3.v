...
module FAU ( 
  ...
  nor2   g20(.a(new_n43_), .b(x06), .O(z06));
  ...
  oai21  g36(.a(new_n77_), .b(new_n52_), .c(new_n48_), .O(new_n78_));
  ...
  nand3  g42(.a(new_n83_), .b(x15), .c(new_n42_), .O(new_n84_));
  ...
  nand2  g59(.a(new_n83_), .b(x18), .O(new_n101_));
  ...
  nand3  g63(.a(x18), .b(x15), .c(new_n42_), .O(new_n105_));
