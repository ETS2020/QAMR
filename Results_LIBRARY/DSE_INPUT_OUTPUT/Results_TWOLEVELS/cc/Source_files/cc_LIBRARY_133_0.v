...
module FAU ( 
  ...
  aoi21  g47(.a(new_n88_), .b(new_n85_), .c(new_n57_), .O(z14));
  ...
  oai21  g54(.a(new_n74_), .b(new_n63_), .c(new_n95_), .O(z16));
  ...
  oai21  g59(.a(new_n74_), .b(new_n97_), .c(new_n100_), .O(z17));
  nand2  g60(.a(new_n53_), .b(x19), .O(new_n102_));
  nand3  g61(.a(new_n87_), .b(x08), .c(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n57_), .O(z18));
  nand3  g63(.a(x10), .b(x08), .c(x07), .O(new_n105_));
