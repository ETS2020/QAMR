...
module FAU ( 
  ...
  or2    g37(.a(new_n78_), .b(new_n52_), .O(new_n79_));
  ...
  nand4  g49(.a(new_n74_), .b(x16), .c(new_n49_), .d(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(z15));
  aoi21  g51(.a(x10), .b(x08), .c(x18), .O(new_n93_));
  oai21  g52(.a(new_n93_), .b(x15), .c(x17), .O(new_n94_));
  nor2   g53(.a(x18), .b(x15), .O(new_n95_));
  nand4  g54(.a(new_n95_), .b(x10), .c(x08), .d(x04), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n94_), .c(new_n77_), .O(z16));
