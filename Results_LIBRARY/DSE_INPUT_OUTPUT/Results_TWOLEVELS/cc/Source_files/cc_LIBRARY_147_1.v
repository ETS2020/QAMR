...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n46_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n56_, new_n59_, new_n64_,
  ...
  aoi21  g09(.a(new_n50_), .b(x06), .c(new_n48_), .O(z01));
  ...
  nor3   g15(.a(new_n56_), .b(new_n48_), .c(x14), .O(z03));
  nor2   g16(.a(new_n46_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nor2   g18(.a(new_n46_), .b(new_n59_), .O(z05));
  nor2   g19(.a(new_n48_), .b(new_n44_), .O(z06));
  ...
  oai21  g34(.a(new_n72_), .b(new_n64_), .c(new_n49_), .O(new_n76_));
  nand3  g35(.a(new_n76_), .b(x15), .c(x06), .O(new_n77_));
  ...
  nand3  g40(.a(new_n81_), .b(x15), .c(x06), .O(new_n82_));
  ...
  nand2  g44(.a(new_n85_), .b(x06), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand3  g46(.a(new_n81_), .b(x16), .c(new_n49_), .O(new_n88_));
  ...
  nand2  g51(.a(new_n81_), .b(x17), .O(new_n93_));
  ...
  nand3  g55(.a(x17), .b(x15), .c(x06), .O(new_n97_));
  ...
  nand3  g61(.a(x18), .b(x15), .c(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n69_), .O(z17));
  nand2  g63(.a(new_n52_), .b(new_n59_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x06), .O(new_n106_));
  nand3  g65(.a(new_n81_), .b(x19), .c(new_n48_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n69_), .O(z18));
  oai21  g67(.a(new_n43_), .b(new_n69_), .c(x06), .O(new_n109_));
