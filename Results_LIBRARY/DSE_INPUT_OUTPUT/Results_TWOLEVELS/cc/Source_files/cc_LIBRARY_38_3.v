...
module FAU ( 
  ...
  nor2   g15(.a(x17), .b(x14), .O(new_n57_));
  ...
  nor2   g23(.a(x15), .b(new_n52_), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(new_n52_), .c(new_n43_), .O(z07));
  ...
  nand2  g41(.a(new_n49_), .b(new_n48_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n43_), .c(x15), .O(new_n84_));
  ...
  nand3  g46(.a(new_n76_), .b(new_n43_), .c(x15), .O(new_n88_));
  inv1   g47(.a(new_n53_), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x08), .c(x02), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n88_), .c(new_n82_), .O(z14));
  nand2  g50(.a(new_n76_), .b(new_n42_), .O(new_n92_));
  ...
  nand2  g59(.a(new_n100_), .b(new_n45_), .O(z16));
  ...
  oai21  g68(.a(new_n61_), .b(new_n82_), .c(new_n43_), .O(new_n110_));
