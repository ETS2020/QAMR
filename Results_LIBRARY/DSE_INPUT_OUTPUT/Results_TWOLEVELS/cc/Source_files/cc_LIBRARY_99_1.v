...
module FAU ( 
  ...
  nor4   g17(.a(new_n47_), .b(new_n58_), .c(x14), .d(new_n57_), .O(z03));
  ...
  aoi21  g23(.a(new_n64_), .b(x08), .c(new_n58_), .O(z06));
  ...
  nor3   g29(.a(new_n45_), .b(new_n63_), .c(new_n70_), .O(z09));
  aoi21  g30(.a(x09), .b(x08), .c(new_n45_), .O(z10));
  nand2  g31(.a(new_n46_), .b(new_n48_), .O(z11));
  aoi21  g32(.a(x10), .b(x08), .c(x20), .O(new_n74_));
  ...
  nor2   g37(.a(new_n78_), .b(new_n58_), .O(new_n79_));
  ...
  nand4  g43(.a(new_n58_), .b(x10), .c(x08), .d(x02), .O(new_n85_));
  ...
  nand3  g50(.a(new_n58_), .b(x10), .c(x08), .O(new_n92_));
  nand4  g51(.a(new_n92_), .b(x16), .c(new_n48_), .d(x12), .O(new_n93_));
