...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x02), .c(new_n43_), .O(z01));
  ...
  nand4  g12(.a(x12), .b(x10), .c(x08), .d(x02), .O(new_n54_));
  ...
  nand2  g28(.a(x15), .b(x02), .O(new_n70_));
  ...
  aoi21  g34(.a(new_n75_), .b(new_n72_), .c(new_n67_), .O(z12));
  nand2  g35(.a(new_n48_), .b(new_n47_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x15), .c(x02), .O(new_n78_));
  nand3  g37(.a(x10), .b(x08), .c(x01), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(new_n43_), .c(x14), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n67_), .O(z13));
  nand2  g40(.a(new_n68_), .b(x15), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n50_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x12), .c(x02), .O(new_n84_));
  ...
  oai21  g47(.a(new_n59_), .b(new_n67_), .c(x02), .O(new_n89_));
  ...
  nand2  g54(.a(new_n68_), .b(x18), .O(new_n96_));
  ...
  nand3  g58(.a(x18), .b(x15), .c(x02), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n67_), .O(z17));
  oai21  g60(.a(new_n57_), .b(new_n67_), .c(x02), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g62(.a(new_n68_), .b(x19), .O(new_n104_));
  nand4  g63(.a(new_n43_), .b(x10), .c(x08), .d(x06), .O(new_n105_));
  ...
  nand2  g67(.a(new_n68_), .b(x20), .O(new_n109_));
  ...
  nand3  g71(.a(x20), .b(x15), .c(x02), .O(new_n113_));
