...
module FAU ( 
  ...
  aoi21  g19(.a(new_n43_), .b(x12), .c(new_n60_), .O(z07));
  ...
  aoi21  g28(.a(x15), .b(new_n69_), .c(new_n54_), .O(z12));
  aoi21  g29(.a(x10), .b(x08), .c(x14), .O(new_n71_));
  nor3   g30(.a(new_n71_), .b(new_n43_), .c(new_n54_), .O(z13));
  nor2   g31(.a(new_n43_), .b(new_n64_), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(x10), .c(new_n54_), .O(z14));
  nand2  g33(.a(x16), .b(new_n46_), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(x15), .c(new_n54_), .O(z15));
