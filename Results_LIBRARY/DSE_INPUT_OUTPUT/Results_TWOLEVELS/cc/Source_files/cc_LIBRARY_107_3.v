...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n59_, new_n62_, new_n64_, new_n65_, new_n68_, new_n70_, new_n71_,
  ...
  aoi21  g21(.a(x20), .b(x15), .c(new_n62_), .O(z05));
  nand2  g22(.a(x09), .b(new_n48_), .O(new_n64_));
  oai21  g23(.a(new_n64_), .b(new_n48_), .c(new_n56_), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n42_), .O(z06));
  and2   g25(.a(new_n49_), .b(x17), .O(z07));
  inv1   g26(.a(x16), .O(new_n68_));
  nand2  g27(.a(new_n49_), .b(new_n68_), .O(z08));
  nand2  g28(.a(x20), .b(x15), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(x09), .c(x08), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z09));
  aoi22  g31(.a(x20), .b(x15), .c(x09), .d(x08), .O(z10));
  inv1   g32(.a(new_n50_), .O(z11));
  inv1   g33(.a(x12), .O(new_n75_));
  nor2   g34(.a(x20), .b(new_n42_), .O(new_n76_));
  aoi21  g35(.a(x10), .b(x08), .c(x15), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(x13), .O(new_n78_));
  inv1   g37(.a(new_n51_), .O(new_n79_));
  nand3  g38(.a(new_n79_), .b(x08), .c(x00), .O(new_n80_));
  aoi21  g39(.a(new_n80_), .b(new_n78_), .c(new_n75_), .O(z12));
  inv1   g40(.a(x10), .O(new_n82_));
  oai21  g41(.a(new_n82_), .b(new_n48_), .c(new_n55_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(new_n56_), .c(x15), .O(new_n84_));
  nand3  g43(.a(x10), .b(x08), .c(x01), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n42_), .c(x14), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n75_), .O(z13));
  nand3  g46(.a(new_n45_), .b(new_n56_), .c(x15), .O(new_n88_));
  ...
  nand2  g50(.a(new_n91_), .b(new_n56_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x15), .O(new_n93_));
  nand3  g52(.a(new_n45_), .b(x16), .c(new_n55_), .O(new_n94_));
  nand4  g53(.a(new_n42_), .b(x10), .c(x08), .d(x03), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n93_), .O(z15));
  nand2  g57(.a(new_n45_), .b(x17), .O(new_n99_));
  ...
  nand3  g61(.a(new_n56_), .b(x17), .c(x15), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n75_), .O(z16));
  nand2  g63(.a(x18), .b(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n56_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x15), .O(new_n107_));
  nand2  g66(.a(new_n45_), .b(x18), .O(new_n108_));
  ...
  oai21  g71(.a(new_n62_), .b(new_n75_), .c(new_n56_), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(x15), .O(new_n114_));
  nand2  g73(.a(new_n45_), .b(x19), .O(new_n115_));
  ...
  nand2  g78(.a(new_n45_), .b(x20), .O(new_n120_));
  nand2  g79(.a(x08), .b(x07), .O(new_n121_));
  oai21  g80(.a(new_n121_), .b(new_n51_), .c(new_n120_), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(x12), .O(new_n123_));
  nand2  g82(.a(new_n123_), .b(new_n49_), .O(z19));
endmodule
