...
module FAU ( 
  ...
  nor2   g02(.a(x17), .b(x07), .O(new_n44_));
  ...
  nand2  g22(.a(new_n63_), .b(x07), .O(z07));
  ...
  oai21  g34(.a(new_n75_), .b(new_n71_), .c(new_n46_), .O(z12));
  ...
  nand4  g51(.a(new_n51_), .b(x10), .c(x08), .d(x07), .O(new_n93_));
  ...
  nand3  g59(.a(new_n100_), .b(new_n46_), .c(x12), .O(new_n101_));
  inv1   g60(.a(new_n101_), .O(z17));
  nand2  g61(.a(new_n52_), .b(x19), .O(new_n103_));
  ...
  aoi22  g67(.a(new_n108_), .b(new_n73_), .c(new_n52_), .d(x20), .O(new_n109_));
  oai21  g68(.a(new_n109_), .b(new_n71_), .c(new_n46_), .O(z19));
endmodule
