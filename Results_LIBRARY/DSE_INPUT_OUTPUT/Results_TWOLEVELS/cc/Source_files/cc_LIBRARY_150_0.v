...
module FAU ( 
  ...
  nand3  g37(.a(new_n56_), .b(x15), .c(x12), .O(new_n79_));
  inv1   g38(.a(x02), .O(new_n80_));
  oai21  g39(.a(new_n56_), .b(new_n80_), .c(x12), .O(new_n81_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n50_), .O(z17));
  nand2  g53(.a(new_n52_), .b(x19), .O(new_n95_));
  nand3  g54(.a(new_n70_), .b(x08), .c(x06), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n50_), .O(z18));
