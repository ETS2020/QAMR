...
module FAU ( 
  ...
  aoi21  g22(.a(x16), .b(x15), .c(new_n63_), .O(z07));
  ...
  oai21  g38(.a(new_n79_), .b(new_n51_), .c(new_n47_), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n46_), .c(x15), .O(new_n81_));
  ...
  nand3  g43(.a(new_n72_), .b(new_n46_), .c(x15), .O(new_n85_));
  ...
  oai21  g51(.a(new_n63_), .b(new_n78_), .c(new_n46_), .O(new_n93_));
  ...
  oai21  g66(.a(new_n61_), .b(new_n78_), .c(new_n46_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n72_), .b(x19), .O(new_n110_));
  nand2  g69(.a(x08), .b(x06), .O(new_n111_));
  oai21  g70(.a(new_n111_), .b(new_n52_), .c(new_n110_), .O(new_n112_));
  ...
  nand3  g77(.a(x20), .b(new_n46_), .c(x15), .O(new_n119_));
