...
module FAU ( 
  ...
  nor3   g28(.a(new_n43_), .b(new_n62_), .c(new_n69_), .O(z09));
  ...
  oai22  g54(.a(new_n95_), .b(new_n73_), .c(new_n82_), .d(new_n65_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(x06), .O(new_n97_));
  nand2  g56(.a(x17), .b(x15), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n57_), .O(z16));
  ...
  nand2  g63(.a(new_n52_), .b(new_n60_), .O(new_n105_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n73_), .c(new_n108_), .O(new_n110_));
