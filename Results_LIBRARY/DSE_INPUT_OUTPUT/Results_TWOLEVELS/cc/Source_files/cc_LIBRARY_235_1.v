...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x05), .c(new_n43_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(new_n43_), .b(x05), .c(x14), .O(new_n51_));
  ...
  nand3  g61(.a(x17), .b(x15), .c(x05), .O(new_n103_));
  ...
  nand4  g67(.a(new_n43_), .b(x10), .c(x08), .d(x05), .O(new_n109_));
  ...
  nand3  g75(.a(x19), .b(x15), .c(x05), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n98_), .O(z18));
  ...
  nand2  g80(.a(new_n121_), .b(new_n43_), .O(new_n122_));
  nand3  g81(.a(x20), .b(x15), .c(x05), .O(new_n123_));
  aoi21  g82(.a(new_n123_), .b(new_n122_), .c(new_n98_), .O(z19));
endmodule
