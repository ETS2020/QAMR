...
module FAU ( 
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x03), .O(new_n55_));
  ...
  oai21  g18(.a(new_n59_), .b(new_n49_), .c(new_n47_), .O(z03));
  ...
  nor2   g38(.a(new_n79_), .b(new_n53_), .O(new_n80_));
  aoi21  g39(.a(new_n50_), .b(x01), .c(new_n48_), .O(new_n81_));
  ...
  inv1   g43(.a(new_n54_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(new_n44_), .c(x02), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n72_), .O(z14));
  nand4  g46(.a(new_n54_), .b(x16), .c(new_n48_), .d(x12), .O(new_n88_));
  ...
  nand3  g51(.a(new_n54_), .b(x17), .c(x12), .O(new_n93_));
  ...
  nand3  g56(.a(new_n54_), .b(x18), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(z17));
  nand4  g58(.a(new_n53_), .b(x10), .c(x08), .d(x06), .O(new_n100_));
  oai21  g59(.a(new_n50_), .b(new_n62_), .c(new_n100_), .O(new_n101_));
  ...
  nand4  g63(.a(new_n53_), .b(x10), .c(x08), .d(x07), .O(new_n105_));
  oai21  g64(.a(new_n50_), .b(new_n43_), .c(new_n105_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n44_), .O(new_n107_));
  nand2  g66(.a(x20), .b(x15), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n72_), .O(z19));
  buf    g68(.a(x15), .O(z06));
endmodule
