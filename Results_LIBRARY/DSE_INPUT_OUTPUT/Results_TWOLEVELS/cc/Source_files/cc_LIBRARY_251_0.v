...
module FAU ( 
  ...
  and2   g38(.a(x08), .b(x02), .O(new_n80_));
  nand4  g39(.a(new_n80_), .b(new_n50_), .c(x10), .d(x09), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n79_), .c(new_n78_), .O(z14));
  nand4  g41(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x09), .O(new_n84_));
  ...
  nand3  g49(.a(new_n51_), .b(x17), .c(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(z16));
  nand2  g51(.a(new_n46_), .b(x18), .O(new_n93_));
  nand4  g52(.a(new_n50_), .b(x10), .c(x08), .d(x05), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x09), .O(new_n96_));
  nand2  g55(.a(x18), .b(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n78_), .O(z17));
  ...
  nand2  g63(.a(new_n104_), .b(x09), .O(new_n105_));
