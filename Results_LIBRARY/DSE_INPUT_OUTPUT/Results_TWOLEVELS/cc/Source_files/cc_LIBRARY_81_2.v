...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n59_, new_n62_, new_n64_, new_n65_, new_n67_, new_n69_, new_n71_,
  ...
  aoi21  g13(.a(new_n54_), .b(new_n48_), .c(x00), .O(new_n55_));
  ...
  aoi21  g24(.a(new_n65_), .b(x08), .c(new_n53_), .O(z06));
  inv1   g25(.a(x17), .O(new_n67_));
  nand2  g26(.a(new_n47_), .b(new_n67_), .O(z07));
  inv1   g27(.a(x16), .O(new_n69_));
  nor2   g28(.a(new_n45_), .b(new_n69_), .O(z08));
  inv1   g29(.a(x08), .O(new_n71_));
  nor3   g30(.a(new_n45_), .b(new_n64_), .c(new_n71_), .O(z09));
  aoi21  g31(.a(x09), .b(x08), .c(new_n45_), .O(z10));
  nand2  g32(.a(new_n47_), .b(new_n48_), .O(z11));
  inv1   g33(.a(x12), .O(new_n75_));
  inv1   g34(.a(x13), .O(new_n76_));
  aoi21  g35(.a(new_n49_), .b(new_n44_), .c(x15), .O(new_n77_));
  nor3   g36(.a(new_n77_), .b(new_n76_), .c(new_n75_), .O(z12));
  ...
  nand3  g44(.a(new_n85_), .b(x02), .c(new_n44_), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n84_), .c(new_n75_), .O(z14));
  ...
  nand3  g52(.a(new_n88_), .b(x08), .c(x04), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n44_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n53_), .O(new_n96_));
  nand3  g55(.a(new_n54_), .b(x17), .c(x12), .O(new_n97_));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n75_), .O(z17));
  nand3  g63(.a(new_n88_), .b(x08), .c(x06), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n44_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n53_), .O(new_n107_));
  nand3  g66(.a(new_n54_), .b(x19), .c(x12), .O(new_n108_));
  ...
  nand3  g71(.a(new_n54_), .b(x20), .c(x12), .O(new_n113_));
