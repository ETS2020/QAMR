...
module FAU ( 
  ...
  nand2  g32(.a(new_n44_), .b(x08), .O(new_n74_));
  ...
  nand3  g36(.a(new_n58_), .b(new_n44_), .c(x13), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n77_), .c(new_n57_), .O(z12));
  ...
  oai21  g45(.a(new_n74_), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x12), .c(x10), .O(new_n88_));
  inv1   g47(.a(new_n88_), .O(z14));
  nand3  g48(.a(new_n44_), .b(x08), .c(x03), .O(new_n90_));
  ...
  nand4  g52(.a(new_n58_), .b(x16), .c(new_n44_), .d(new_n48_), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n57_), .O(z15));
  oai21  g54(.a(new_n64_), .b(new_n57_), .c(new_n44_), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n51_), .O(new_n97_));
  nor2   g56(.a(x15), .b(new_n68_), .O(new_n98_));
  nand4  g57(.a(new_n44_), .b(x10), .c(x08), .d(x04), .O(new_n99_));
  oai21  g58(.a(new_n98_), .b(new_n64_), .c(new_n99_), .O(new_n100_));
  ...
  oai21  g63(.a(new_n74_), .b(new_n103_), .c(new_n104_), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x10), .O(new_n106_));
  nand3  g65(.a(new_n58_), .b(x18), .c(new_n44_), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n57_), .O(z17));
  inv1   g67(.a(x06), .O(new_n109_));
  nand2  g68(.a(x19), .b(x15), .O(new_n110_));
  oai21  g69(.a(new_n74_), .b(new_n109_), .c(new_n110_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x10), .O(new_n112_));
  nand3  g71(.a(new_n58_), .b(x19), .c(new_n44_), .O(new_n113_));
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n57_), .O(z18));
  ...
  oai21  g76(.a(new_n98_), .b(new_n43_), .c(new_n117_), .O(new_n118_));
