...
module FAU ( 
  ...
  aoi21  g24(.a(new_n63_), .b(x08), .c(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n44_), .b(new_n67_), .O(z08));
  nor3   g27(.a(new_n43_), .b(new_n62_), .c(new_n50_), .O(z09));
  ...
  nand3  g33(.a(x17), .b(new_n51_), .c(x10), .O(new_n75_));
  ...
  nand3  g48(.a(new_n73_), .b(x16), .c(new_n46_), .O(new_n90_));
  ...
  nand2  g55(.a(new_n57_), .b(x18), .O(new_n97_));
  ...
  nand2  g70(.a(new_n111_), .b(x17), .O(new_n112_));
