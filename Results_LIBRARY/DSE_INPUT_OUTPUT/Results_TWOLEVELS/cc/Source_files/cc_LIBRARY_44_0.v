...
module FAU ( 
  ...
  nand2  g30(.a(new_n60_), .b(new_n46_), .O(z11));
  ...
  nand2  g40(.a(new_n81_), .b(new_n60_), .O(z13));
  ...
  oai21  g52(.a(new_n48_), .b(new_n65_), .c(new_n93_), .O(new_n94_));
  ...
  oai21  g63(.a(new_n48_), .b(new_n62_), .c(new_n104_), .O(new_n105_));
  ...
  oai21  g67(.a(new_n84_), .b(x20), .c(x07), .O(new_n109_));
