...
module FAU ( 
  ...
  nand2  g18(.a(x19), .b(new_n50_), .O(z06));
  ...
  oai21  g34(.a(new_n75_), .b(new_n65_), .c(new_n47_), .O(new_n76_));
  ...
  nand3  g40(.a(x19), .b(new_n50_), .c(x10), .O(new_n82_));
  ...
  oai21  g61(.a(new_n99_), .b(x15), .c(new_n102_), .O(z18));
