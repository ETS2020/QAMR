...
module FAU ( 
  ...
  nand4  g61(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n103_));
  ...
  nand2  g66(.a(new_n47_), .b(x19), .O(new_n108_));
  nand4  g67(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n108_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x09), .O(new_n111_));
  nand2  g70(.a(x19), .b(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n73_), .O(z18));
  nand4  g72(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x09), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(new_n52_), .O(new_n116_));
  nand3  g75(.a(new_n53_), .b(x20), .c(x12), .O(new_n117_));
