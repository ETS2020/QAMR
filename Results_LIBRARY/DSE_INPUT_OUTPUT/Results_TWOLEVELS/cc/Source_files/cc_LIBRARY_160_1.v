...
module FAU ( 
  ...
  nand2  g06(.a(x08), .b(x07), .O(new_n48_));
  nor4   g07(.a(new_n48_), .b(new_n44_), .c(x14), .d(new_n47_), .O(z01));
  oai21  g08(.a(new_n44_), .b(x07), .c(x14), .O(new_n50_));
  ...
  and2   g32(.a(x15), .b(x07), .O(new_n74_));
  ...
  nand2  g37(.a(new_n78_), .b(x07), .O(new_n79_));
  ...
  nand2  g42(.a(new_n44_), .b(x10), .O(new_n84_));
  ...
  oai21  g68(.a(new_n62_), .b(new_n72_), .c(x07), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x15), .O(new_n111_));
  nand2  g70(.a(new_n56_), .b(x19), .O(new_n112_));
  nand2  g71(.a(x08), .b(x06), .O(new_n113_));
  oai21  g72(.a(new_n113_), .b(new_n84_), .c(new_n112_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x12), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(new_n111_), .O(z18));
  oai21  g75(.a(new_n43_), .b(new_n72_), .c(x07), .O(new_n117_));
  nand2  g76(.a(new_n117_), .b(x15), .O(new_n118_));
  nand2  g77(.a(new_n56_), .b(x20), .O(new_n119_));
  oai21  g78(.a(new_n84_), .b(new_n48_), .c(new_n119_), .O(new_n120_));
