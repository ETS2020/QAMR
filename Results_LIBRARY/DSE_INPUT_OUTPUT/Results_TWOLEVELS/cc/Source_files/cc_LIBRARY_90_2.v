...
module FAU ( 
  ...
  nand2  g02(.a(new_n43_), .b(x13), .O(new_n44_));
  ...
  aoi21  g10(.a(new_n51_), .b(new_n46_), .c(x13), .O(new_n52_));
  nor2   g11(.a(new_n43_), .b(new_n46_), .O(new_n53_));
  oai21  g12(.a(new_n53_), .b(new_n52_), .c(x12), .O(new_n54_));
  nor2   g13(.a(new_n54_), .b(x11), .O(z02));
  inv1   g14(.a(x12), .O(new_n56_));
  nor4   g15(.a(new_n47_), .b(new_n43_), .c(x14), .d(new_n56_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n44_), .b(new_n59_), .O(z05));
  inv1   g19(.a(x13), .O(new_n61_));
  nand2  g20(.a(new_n43_), .b(new_n61_), .O(z06));
  inv1   g21(.a(x17), .O(new_n63_));
  nand2  g22(.a(new_n44_), .b(new_n63_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nand2  g24(.a(new_n44_), .b(new_n65_), .O(z08));
  inv1   g25(.a(x08), .O(new_n67_));
  nand2  g26(.a(new_n44_), .b(x09), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n67_), .O(z09));
  nand3  g28(.a(new_n44_), .b(x09), .c(x08), .O(z10));
  aoi21  g29(.a(new_n43_), .b(x13), .c(new_n46_), .O(z11));
  nand2  g30(.a(x15), .b(x13), .O(new_n72_));
  nor2   g31(.a(x15), .b(x13), .O(new_n73_));
  nand4  g32(.a(new_n73_), .b(x10), .c(x08), .d(x00), .O(new_n74_));
  aoi21  g33(.a(new_n74_), .b(new_n72_), .c(new_n56_), .O(z12));
  aoi21  g34(.a(x10), .b(x08), .c(x14), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  aoi21  g36(.a(new_n48_), .b(x01), .c(new_n46_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n44_), .O(z13));
  nand2  g39(.a(new_n43_), .b(x10), .O(new_n81_));
  nand2  g40(.a(x08), .b(x02), .O(new_n82_));
  oai22  g41(.a(new_n82_), .b(new_n81_), .c(new_n48_), .d(new_n43_), .O(new_n83_));
  ...
  nand2  g45(.a(x08), .b(x03), .O(new_n87_));
  oai21  g46(.a(new_n87_), .b(new_n81_), .c(new_n86_), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n61_), .O(new_n89_));
  ...
  oai22  g51(.a(new_n92_), .b(new_n81_), .c(new_n48_), .d(new_n63_), .O(new_n93_));
  ...
  oai21  g57(.a(new_n98_), .b(new_n81_), .c(new_n97_), .O(new_n99_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n61_), .O(new_n104_));
  ...
  oai21  g68(.a(new_n109_), .b(new_n81_), .c(new_n108_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n61_), .O(new_n111_));
  nand2  g70(.a(x20), .b(x15), .O(new_n112_));
  aoi21  g71(.a(new_n112_), .b(new_n111_), .c(new_n56_), .O(z19));
endmodule
