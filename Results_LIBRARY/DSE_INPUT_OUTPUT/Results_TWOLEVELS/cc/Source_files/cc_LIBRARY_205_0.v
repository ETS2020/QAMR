...
module FAU ( 
  ...
  oai21  g26(.a(new_n63_), .b(new_n67_), .c(new_n44_), .O(z08));
  ...
  oai21  g38(.a(new_n79_), .b(new_n61_), .c(new_n46_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x16), .c(x14), .O(new_n83_));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n85_), .c(new_n56_), .O(z14));
  ...
  nand4  g50(.a(new_n76_), .b(x16), .c(new_n46_), .d(x12), .O(new_n92_));
  ...
  nand3  g55(.a(new_n76_), .b(x17), .c(x12), .O(new_n97_));
  ...
  nand3  g66(.a(new_n76_), .b(x19), .c(x12), .O(new_n108_));
  ...
  nand3  g71(.a(new_n76_), .b(x20), .c(x12), .O(new_n113_));
