...
module FAU ( 
  ...
  nand3  g28(.a(new_n69_), .b(x09), .c(x08), .O(z10));
  inv1   g29(.a(new_n50_), .O(z11));
  nand4  g30(.a(x12), .b(x10), .c(x08), .d(x00), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x17), .O(new_n73_));
  ...
  oai21  g38(.a(new_n75_), .b(new_n66_), .c(new_n46_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x17), .c(x14), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n56_), .O(z13));
  nand2  g43(.a(new_n49_), .b(x15), .O(new_n85_));
  nand4  g44(.a(new_n51_), .b(x10), .c(x08), .d(x02), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n69_), .O(z14));
  ...
  nor2   g51(.a(new_n62_), .b(x15), .O(new_n93_));
  nand4  g52(.a(new_n93_), .b(x10), .c(x08), .d(x03), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n92_), .c(new_n56_), .O(z15));
  nor2   g54(.a(new_n66_), .b(x04), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n76_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(x17), .c(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n69_), .O(z16));
  ...
  nand3  g61(.a(new_n77_), .b(x18), .c(x12), .O(new_n103_));
