...
module FAU ( 
  ...
  nand2  g31(.a(new_n46_), .b(new_n55_), .O(z11));
  inv1   g32(.a(x12), .O(new_n74_));
  nand2  g33(.a(new_n48_), .b(new_n44_), .O(new_n75_));
  ...
  oai21  g40(.a(new_n78_), .b(new_n69_), .c(new_n55_), .O(new_n82_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n74_), .O(z13));
  nand3  g45(.a(new_n48_), .b(x20), .c(x15), .O(new_n87_));
  nand3  g46(.a(new_n79_), .b(x08), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n74_), .O(z14));
  nand3  g48(.a(new_n76_), .b(x16), .c(new_n55_), .O(new_n90_));
  nand3  g49(.a(new_n79_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n74_), .O(z15));
  oai21  g51(.a(new_n65_), .b(new_n74_), .c(x20), .O(new_n93_));
  ...
  oai21  g66(.a(new_n61_), .b(new_n74_), .c(x20), .O(new_n108_));
  ...
  oai22  g74(.a(new_n63_), .b(x14), .c(x15), .d(new_n115_), .O(new_n116_));
  nand3  g75(.a(new_n116_), .b(x10), .c(x08), .O(new_n117_));
  nand2  g76(.a(x15), .b(x14), .O(new_n118_));
  nand3  g77(.a(new_n118_), .b(x10), .c(x08), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x20), .O(new_n120_));
  aoi21  g79(.a(new_n120_), .b(new_n117_), .c(new_n74_), .O(z19));
endmodule
