...
module FAU ( 
  ...
  nor2   g30(.a(new_n59_), .b(new_n48_), .O(z11));
  ...
  nor2   g37(.a(new_n78_), .b(new_n47_), .O(new_n79_));
  ...
  oai21  g45(.a(new_n67_), .b(x14), .c(x12), .O(new_n87_));
  ...
  nand2  g68(.a(new_n55_), .b(x20), .O(new_n110_));
