...
module FAU ( 
  ...
  aoi22  g24(.a(new_n43_), .b(x12), .c(x09), .d(x08), .O(z10));
  ...
  aoi21  g29(.a(new_n70_), .b(x15), .c(new_n49_), .O(z13));
  ...
  aoi21  g34(.a(new_n75_), .b(x15), .c(new_n49_), .O(z15));
  nand3  g35(.a(x17), .b(x15), .c(x12), .O(new_n77_));
  inv1   g36(.a(new_n77_), .O(z16));
  inv1   g37(.a(x18), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(x15), .c(new_n49_), .O(z17));
  aoi21  g39(.a(new_n56_), .b(x15), .c(new_n49_), .O(z18));
