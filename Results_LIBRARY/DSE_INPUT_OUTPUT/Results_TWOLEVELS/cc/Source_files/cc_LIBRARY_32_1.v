...
module FAU ( 
  ...
  oai21  g33(.a(new_n74_), .b(new_n73_), .c(x14), .O(new_n75_));
  nand3  g34(.a(x15), .b(x10), .c(x08), .O(new_n76_));
  aoi21  g35(.a(new_n76_), .b(new_n75_), .c(new_n43_), .O(z13));
  nand2  g36(.a(new_n74_), .b(x15), .O(new_n78_));
  nand3  g37(.a(new_n70_), .b(x08), .c(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n43_), .O(z14));
  nand3  g39(.a(new_n51_), .b(x16), .c(new_n48_), .O(new_n81_));
  nand3  g40(.a(new_n70_), .b(x08), .c(x03), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n81_), .c(new_n43_), .O(z15));
  nand2  g42(.a(new_n51_), .b(x17), .O(new_n84_));
  nand3  g43(.a(new_n70_), .b(x08), .c(x04), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n84_), .c(new_n43_), .O(z16));
  oai21  g45(.a(x18), .b(new_n43_), .c(x15), .O(new_n87_));
  nand2  g46(.a(new_n74_), .b(x18), .O(new_n88_));
  nand4  g47(.a(new_n47_), .b(x10), .c(x08), .d(x05), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x12), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n87_), .O(z17));
  ...
  nand2  g55(.a(new_n74_), .b(x20), .O(new_n97_));
  ...
  aoi21  g60(.a(new_n49_), .b(x12), .c(new_n47_), .O(z03));
endmodule
