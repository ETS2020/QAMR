...
module FAU ( 
  ...
  oai21  g23(.a(new_n64_), .b(new_n49_), .c(x12), .O(z06));
  inv1   g24(.a(x17), .O(new_n66_));
  nand2  g25(.a(new_n57_), .b(new_n66_), .O(z07));
  inv1   g26(.a(x16), .O(new_n68_));
  nand2  g27(.a(new_n57_), .b(new_n68_), .O(z08));
  ...
  nand2  g41(.a(new_n82_), .b(new_n57_), .O(z13));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n54_), .O(z18));
