...
module FAU ( 
  ...
  nor2   g15(.a(new_n52_), .b(x04), .O(new_n57_));
  nand4  g16(.a(new_n57_), .b(new_n49_), .c(x12), .d(x10), .O(new_n58_));
  aoi21  g17(.a(new_n58_), .b(new_n44_), .c(new_n45_), .O(z03));
  nor2   g18(.a(new_n46_), .b(x18), .O(z04));
  inv1   g19(.a(x19), .O(new_n61_));
  nor2   g20(.a(new_n46_), .b(new_n61_), .O(z05));
  nand2  g21(.a(x09), .b(new_n52_), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n52_), .O(new_n64_));
  aoi21  g23(.a(new_n64_), .b(new_n44_), .c(new_n45_), .O(z06));
  inv1   g24(.a(x17), .O(new_n66_));
  nor2   g25(.a(new_n46_), .b(new_n66_), .O(z07));
  inv1   g26(.a(x16), .O(new_n68_));
  nand2  g27(.a(new_n47_), .b(new_n68_), .O(z08));
  nand2  g28(.a(x15), .b(x04), .O(new_n70_));
  nand3  g29(.a(new_n70_), .b(x09), .c(x08), .O(new_n71_));
  inv1   g30(.a(new_n71_), .O(z09));
  aoi22  g31(.a(x15), .b(x04), .c(x09), .d(x08), .O(z10));
  nor2   g32(.a(new_n46_), .b(new_n49_), .O(z11));
  ...
  nand2  g43(.a(new_n50_), .b(new_n49_), .O(new_n85_));
  nand3  g44(.a(new_n85_), .b(x15), .c(new_n44_), .O(new_n86_));
  ...
  nand3  g48(.a(new_n78_), .b(x15), .c(new_n44_), .O(new_n90_));
  inv1   g49(.a(new_n53_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x08), .c(x02), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n90_), .c(new_n84_), .O(z14));
  nand2  g52(.a(x15), .b(new_n44_), .O(new_n94_));
  nand2  g53(.a(new_n78_), .b(new_n45_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(new_n96_));
  nand3  g55(.a(new_n96_), .b(x16), .c(new_n49_), .O(new_n97_));
  nand3  g56(.a(new_n91_), .b(x08), .c(x03), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n84_), .O(z15));
  nand2  g58(.a(new_n78_), .b(x17), .O(new_n100_));
  nand3  g59(.a(x10), .b(x08), .c(x04), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n45_), .O(new_n103_));
  nand3  g62(.a(x17), .b(x15), .c(new_n44_), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n84_), .O(z16));
  nand2  g64(.a(x18), .b(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n44_), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand2  g67(.a(new_n78_), .b(x18), .O(new_n109_));
  nand2  g68(.a(x08), .b(x05), .O(new_n110_));
  oai21  g69(.a(new_n110_), .b(new_n53_), .c(new_n109_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x12), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n108_), .O(z17));
  nand2  g72(.a(new_n78_), .b(x19), .O(new_n114_));
  nand3  g73(.a(x10), .b(x08), .c(x06), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n45_), .O(new_n117_));
  nand3  g76(.a(x19), .b(x15), .c(new_n44_), .O(new_n118_));
  aoi21  g77(.a(new_n118_), .b(new_n117_), .c(new_n84_), .O(z18));
  oai21  g78(.a(new_n43_), .b(new_n84_), .c(new_n44_), .O(new_n120_));
  nand2  g79(.a(new_n120_), .b(x15), .O(new_n121_));
  nand2  g80(.a(new_n78_), .b(x20), .O(new_n122_));
  nand2  g81(.a(x08), .b(x07), .O(new_n123_));
  oai21  g82(.a(new_n123_), .b(new_n53_), .c(new_n122_), .O(new_n124_));
