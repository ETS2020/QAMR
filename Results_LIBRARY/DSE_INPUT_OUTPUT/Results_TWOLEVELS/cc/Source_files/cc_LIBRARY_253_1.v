...
module FAU ( 
  ...
  or2    g16(.a(new_n57_), .b(new_n43_), .O(new_n58_));
  nand3  g17(.a(x12), .b(x10), .c(x08), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(new_n60_));
  aoi21  g19(.a(new_n60_), .b(new_n58_), .c(new_n46_), .O(z06));
  ...
  aoi21  g27(.a(x15), .b(new_n43_), .c(new_n49_), .O(z11));
  ...
  nor2   g33(.a(new_n57_), .b(new_n46_), .O(new_n75_));
  ...
  oai22  g40(.a(new_n81_), .b(new_n80_), .c(new_n60_), .d(new_n46_), .O(z14));
  oai21  g41(.a(new_n64_), .b(x14), .c(x12), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(x15), .O(new_n84_));
  nand3  g43(.a(new_n47_), .b(x16), .c(new_n49_), .O(new_n85_));
  ...
  nand3  g52(.a(new_n72_), .b(x08), .c(x05), .O(new_n94_));
