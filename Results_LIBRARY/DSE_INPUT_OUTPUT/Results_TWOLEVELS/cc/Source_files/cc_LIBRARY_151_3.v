...
module FAU ( 
  ...
  nand2  g28(.a(new_n55_), .b(x15), .O(new_n70_));
  ...
  nand3  g45(.a(new_n71_), .b(x16), .c(new_n50_), .O(new_n87_));
  ...
  nand3  g57(.a(x18), .b(new_n55_), .c(x15), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n68_), .O(z17));
  oai21  g59(.a(new_n61_), .b(new_n68_), .c(new_n55_), .O(new_n101_));
  ...
  nand2  g67(.a(new_n108_), .b(new_n55_), .O(new_n109_));
