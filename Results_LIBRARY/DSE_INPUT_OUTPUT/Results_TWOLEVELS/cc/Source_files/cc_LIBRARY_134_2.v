...
module FAU ( 
  ...
  nand2  g23(.a(new_n64_), .b(new_n47_), .O(z06));
  ...
  nor3   g29(.a(new_n45_), .b(new_n70_), .c(new_n62_), .O(z09));
  ...
  nand3  g49(.a(new_n48_), .b(x16), .c(new_n49_), .O(new_n91_));
  ...
  nand3  g53(.a(x16), .b(x15), .c(new_n49_), .O(new_n95_));
  ...
  aoi21  g61(.a(new_n48_), .b(new_n44_), .c(x15), .O(new_n103_));
  nor3   g62(.a(new_n103_), .b(new_n102_), .c(new_n57_), .O(z17));
