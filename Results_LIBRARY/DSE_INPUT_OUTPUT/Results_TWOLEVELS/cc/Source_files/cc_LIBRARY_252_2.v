...
module FAU ( 
  ...
  nand2  g33(.a(new_n74_), .b(new_n52_), .O(z12));
  aoi21  g34(.a(x10), .b(x08), .c(x14), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n53_), .O(new_n77_));
  ...
  nand4  g47(.a(new_n54_), .b(x16), .c(new_n47_), .d(x12), .O(new_n89_));
  ...
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n91_), .O(z17));
  ...
  nand3  g65(.a(new_n54_), .b(x19), .c(x12), .O(new_n107_));
  ...
  aoi21  g72(.a(new_n113_), .b(new_n112_), .c(new_n91_), .O(z19));
endmodule
