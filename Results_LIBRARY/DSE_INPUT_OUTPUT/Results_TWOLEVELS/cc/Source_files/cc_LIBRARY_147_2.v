...
module FAU ( 
  ...
  oai21  g36(.a(new_n77_), .b(new_n66_), .c(new_n49_), .O(new_n78_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n57_), .O(z14));
  ...
  aoi21  g62(.a(new_n48_), .b(new_n44_), .c(x15), .O(new_n104_));
  nor3   g63(.a(new_n104_), .b(new_n60_), .c(new_n57_), .O(z18));
