...
module FAU ( 
  ...
  aoi21  g21(.a(x15), .b(x13), .c(new_n62_), .O(z05));
  ...
  nand2  g28(.a(new_n42_), .b(new_n47_), .O(z11));
  ...
  nand3  g41(.a(new_n71_), .b(x15), .c(new_n45_), .O(new_n83_));
  ...
  nand2  g45(.a(new_n71_), .b(new_n46_), .O(new_n87_));
  ...
  nand2  g57(.a(new_n71_), .b(x18), .O(new_n99_));
  ...
  nand3  g61(.a(x18), .b(x15), .c(new_n45_), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n77_), .O(z17));
  oai21  g63(.a(new_n62_), .b(new_n77_), .c(new_n45_), .O(new_n105_));
