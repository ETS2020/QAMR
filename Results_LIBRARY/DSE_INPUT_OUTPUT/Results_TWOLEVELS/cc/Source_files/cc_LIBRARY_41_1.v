...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n56_, new_n59_, new_n62_, new_n63_,
  ...
  nand2  g37(.a(new_n68_), .b(x15), .O(new_n79_));
  ...
  nand2  g49(.a(new_n68_), .b(x18), .O(new_n91_));
  nand4  g50(.a(new_n46_), .b(x10), .c(x08), .d(x05), .O(new_n92_));
  ...
  nand2  g55(.a(new_n68_), .b(x19), .O(new_n97_));
  nand4  g56(.a(new_n46_), .b(x10), .c(x08), .d(x06), .O(new_n98_));
  ...
  aoi21  g63(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
endmodule
