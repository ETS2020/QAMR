...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n50_,
    ...
    new_n61_, new_n64_, new_n66_, new_n67_, new_n69_, new_n72_, new_n73_,
  ...
  oai21  g08(.a(new_n44_), .b(x15), .c(x14), .O(new_n50_));
  nor2   g09(.a(x17), .b(x15), .O(new_n51_));
  ...
  nand2  g21(.a(new_n44_), .b(new_n57_), .O(z06));
  ...
  nand2  g32(.a(new_n73_), .b(new_n57_), .O(new_n74_));
  nand3  g33(.a(new_n57_), .b(x10), .c(x08), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(x13), .c(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n74_), .O(z12));
  inv1   g36(.a(x10), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n66_), .c(new_n47_), .O(new_n79_));
  ...
  nand3  g64(.a(new_n75_), .b(x19), .c(x12), .O(new_n106_));
  ...
  nand3  g69(.a(new_n75_), .b(x20), .c(x12), .O(new_n111_));
