...
module FAU ( 
  ...
  nand2  g01(.a(x16), .b(x10), .O(new_n43_));
  ...
  nor2   g10(.a(x16), .b(x15), .O(new_n52_));
  ...
  aoi21  g31(.a(new_n64_), .b(x08), .c(x16), .O(new_n73_));
  oai21  g32(.a(new_n73_), .b(new_n45_), .c(x13), .O(new_n74_));
  nand4  g33(.a(new_n52_), .b(x10), .c(x08), .d(x00), .O(new_n75_));
  aoi21  g34(.a(new_n75_), .b(new_n74_), .c(new_n72_), .O(z12));
  nand3  g35(.a(x15), .b(x12), .c(x08), .O(new_n77_));
  ...
  oai21  g41(.a(x16), .b(x08), .c(x10), .O(new_n83_));
  ...
  nand4  g45(.a(new_n64_), .b(x12), .c(x08), .d(x03), .O(new_n87_));
  ...
  nand4  g50(.a(new_n64_), .b(x12), .c(x08), .d(x04), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n46_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x10), .O(new_n94_));
  nand3  g53(.a(new_n64_), .b(x10), .c(x08), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(x17), .c(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n94_), .O(z16));
  nand4  g56(.a(new_n64_), .b(x12), .c(x08), .d(x05), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n46_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x10), .O(new_n100_));
  nand3  g59(.a(new_n95_), .b(x18), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(z17));
  nand4  g61(.a(new_n64_), .b(x12), .c(x08), .d(x06), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n46_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x10), .O(new_n105_));
  nand3  g64(.a(new_n95_), .b(x19), .c(x12), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(z18));
  nand4  g66(.a(new_n64_), .b(x12), .c(x08), .d(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n46_), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(x10), .O(new_n110_));
  nand3  g69(.a(new_n95_), .b(x20), .c(x12), .O(new_n111_));
