...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    new_n51_, new_n52_, new_n55_, new_n57_, new_n58_, new_n60_, new_n61_,
  ...
  and2   g17(.a(new_n58_), .b(x15), .O(z06));
  inv1   g18(.a(x17), .O(new_n60_));
  nor2   g19(.a(new_n46_), .b(x12), .O(new_n61_));
  ...
  nor2   g25(.a(new_n61_), .b(new_n49_), .O(z11));
  nand2  g26(.a(new_n50_), .b(x13), .O(new_n68_));
  ...
  nor2   g31(.a(new_n57_), .b(new_n46_), .O(new_n73_));
  ...
  nand3  g43(.a(new_n50_), .b(x16), .c(new_n49_), .O(new_n85_));
  ...
  nand2  g52(.a(new_n50_), .b(x19), .O(new_n94_));
  nand3  g53(.a(new_n70_), .b(x08), .c(x06), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n43_), .O(z18));
  nand2  g55(.a(new_n50_), .b(x20), .O(new_n97_));
  nand3  g56(.a(new_n70_), .b(x08), .c(x07), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n43_), .O(z19));
  nor3   g58(.a(new_n47_), .b(new_n46_), .c(x14), .O(z03));
endmodule
