...
module FAU ( 
  ...
  nand2  g30(.a(new_n71_), .b(new_n57_), .O(new_n72_));
  ...
  oai21  g40(.a(new_n81_), .b(new_n47_), .c(new_n46_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x15), .c(new_n57_), .O(new_n83_));
  ...
  nand3  g45(.a(new_n74_), .b(x15), .c(new_n57_), .O(new_n87_));
  ...
  nand2  g49(.a(new_n74_), .b(new_n45_), .O(new_n91_));
  nand2  g50(.a(x15), .b(new_n57_), .O(new_n92_));
  ...
  nand3  g59(.a(x17), .b(x15), .c(new_n57_), .O(new_n101_));
  ...
  oai21  g69(.a(new_n61_), .b(new_n80_), .c(new_n57_), .O(new_n111_));
  ...
  nand2  g77(.a(new_n118_), .b(new_n57_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x15), .O(new_n120_));
  nand2  g79(.a(new_n74_), .b(x20), .O(new_n121_));
