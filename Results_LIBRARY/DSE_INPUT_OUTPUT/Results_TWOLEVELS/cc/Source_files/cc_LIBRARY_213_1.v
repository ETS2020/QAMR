...
module FAU ( 
  ...
  nor2   g02(.a(new_n43_), .b(x00), .O(new_n44_));
  ...
  nand4  g13(.a(new_n54_), .b(new_n45_), .c(x12), .d(new_n51_), .O(new_n55_));
  ...
  inv1   g30(.a(new_n53_), .O(new_n72_));
  oai21  g31(.a(new_n72_), .b(x13), .c(x00), .O(new_n73_));
  nand3  g32(.a(new_n53_), .b(x13), .c(new_n43_), .O(new_n74_));
  ...
  nand3  g57(.a(new_n98_), .b(x05), .c(x00), .O(new_n99_));
  nand3  g58(.a(new_n53_), .b(x18), .c(new_n43_), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n71_), .O(z17));
  inv1   g60(.a(x10), .O(new_n102_));
  nor2   g61(.a(x15), .b(new_n102_), .O(new_n103_));
  and2   g62(.a(x08), .b(x06), .O(new_n104_));
  aoi22  g63(.a(new_n104_), .b(new_n103_), .c(new_n53_), .d(x19), .O(new_n105_));
  oai21  g64(.a(new_n105_), .b(new_n71_), .c(new_n45_), .O(z18));
  and2   g65(.a(x08), .b(x07), .O(new_n107_));
  aoi22  g66(.a(new_n107_), .b(new_n103_), .c(new_n53_), .d(x20), .O(new_n108_));
  oai21  g67(.a(new_n108_), .b(new_n71_), .c(new_n45_), .O(z19));
endmodule
