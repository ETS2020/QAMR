...
module FAU ( 
  ...
  nor2   g17(.a(new_n48_), .b(x15), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(new_n60_));
  nand2  g19(.a(new_n60_), .b(x18), .O(z04));
  inv1   g20(.a(x19), .O(new_n62_));
  nor2   g21(.a(new_n59_), .b(new_n62_), .O(z05));
  inv1   g22(.a(x09), .O(new_n64_));
  nor2   g23(.a(new_n64_), .b(x08), .O(new_n65_));
  aoi21  g24(.a(new_n65_), .b(x08), .c(new_n56_), .O(z06));
  inv1   g25(.a(x17), .O(new_n67_));
  nor2   g26(.a(new_n59_), .b(new_n67_), .O(z07));
  inv1   g27(.a(x16), .O(new_n69_));
  nand2  g28(.a(new_n60_), .b(new_n69_), .O(z08));
  inv1   g29(.a(x08), .O(new_n71_));
  nor3   g30(.a(new_n59_), .b(new_n64_), .c(new_n71_), .O(z09));
  aoi21  g31(.a(x09), .b(x08), .c(new_n59_), .O(z10));
  inv1   g32(.a(new_n49_), .O(z11));
  aoi21  g33(.a(x10), .b(x08), .c(x20), .O(new_n75_));
  oai21  g34(.a(new_n75_), .b(x15), .c(x13), .O(new_n76_));
  nand4  g35(.a(new_n50_), .b(x10), .c(x08), .d(x00), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n55_), .O(z12));
  inv1   g37(.a(x10), .O(new_n79_));
  oai21  g38(.a(new_n79_), .b(new_n71_), .c(new_n44_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand3  g40(.a(x10), .b(x08), .c(x01), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(new_n48_), .c(x14), .O(new_n83_));
  ...
  nand3  g49(.a(new_n56_), .b(x10), .c(x08), .O(new_n91_));
  nand4  g50(.a(new_n91_), .b(x16), .c(new_n44_), .d(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n90_), .O(z15));
  oai21  g52(.a(new_n75_), .b(x15), .c(x17), .O(new_n94_));
  ...
  nand3  g58(.a(new_n91_), .b(x18), .c(x12), .O(new_n100_));
  ...
  nand3  g63(.a(new_n91_), .b(x19), .c(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(z18));
  nand4  g65(.a(new_n56_), .b(x10), .c(x08), .d(x07), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n48_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x12), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n60_), .O(z19));
endmodule
