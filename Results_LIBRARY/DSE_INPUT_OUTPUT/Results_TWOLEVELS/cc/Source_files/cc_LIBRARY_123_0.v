...
module FAU ( 
  ...
  nand3  g41(.a(new_n55_), .b(x15), .c(x12), .O(new_n83_));
  inv1   g42(.a(x02), .O(new_n84_));
  oai21  g43(.a(new_n55_), .b(new_n84_), .c(x12), .O(new_n85_));
  nand2  g44(.a(new_n85_), .b(new_n50_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n83_), .O(z14));
  oai21  g46(.a(x15), .b(new_n73_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n50_), .b(new_n66_), .O(new_n89_));
