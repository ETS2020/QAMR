...
module FAU ( 
  ...
  nor2   g31(.a(new_n44_), .b(new_n47_), .O(z11));
  nand2  g32(.a(new_n52_), .b(x10), .O(new_n74_));
  nand2  g33(.a(new_n48_), .b(x13), .O(new_n75_));
  ...
  nand4  g51(.a(new_n53_), .b(x16), .c(new_n47_), .d(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(z15));
  nand2  g53(.a(x08), .b(x04), .O(new_n95_));
  oai22  g54(.a(new_n95_), .b(new_n74_), .c(new_n49_), .d(new_n66_), .O(new_n96_));
  ...
  oai21  g67(.a(new_n108_), .b(new_n74_), .c(new_n107_), .O(new_n109_));
