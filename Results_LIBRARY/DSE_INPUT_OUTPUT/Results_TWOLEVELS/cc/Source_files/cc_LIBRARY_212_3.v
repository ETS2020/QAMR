...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n51_, new_n52_, new_n53_, new_n55_, new_n59_, new_n62_, new_n66_,
  ...
  nand3  g41(.a(new_n69_), .b(x15), .c(new_n46_), .O(new_n83_));
  ...
  nand3  g47(.a(new_n69_), .b(x16), .c(new_n48_), .O(new_n89_));
  ...
  nand3  g52(.a(x12), .b(x10), .c(x08), .O(new_n94_));
  ...
  nand2  g57(.a(new_n69_), .b(x18), .O(new_n99_));
  ...
  oai21  g69(.a(new_n43_), .b(new_n75_), .c(new_n46_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n69_), .b(x20), .O(new_n113_));
