...
module FAU ( 
  ...
  nand4  g15(.a(new_n56_), .b(new_n47_), .c(x12), .d(x10), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x07), .c(new_n44_), .O(z03));
  ...
  nor2   g34(.a(new_n44_), .b(new_n71_), .O(new_n76_));
  ...
  oai21  g42(.a(new_n83_), .b(new_n82_), .c(new_n47_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x15), .c(x07), .O(new_n85_));
  ...
  nand3  g48(.a(new_n89_), .b(x15), .c(x07), .O(new_n90_));
  nand3  g49(.a(new_n79_), .b(x08), .c(x02), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n74_), .O(z14));
  nand3  g51(.a(x16), .b(new_n47_), .c(x12), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x07), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x15), .O(new_n95_));
  nand3  g54(.a(new_n89_), .b(x16), .c(new_n47_), .O(new_n96_));
  ...
  nand3  g63(.a(x17), .b(x15), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n74_), .O(z16));
  nand2  g65(.a(x18), .b(x12), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x15), .O(new_n109_));
  nand2  g68(.a(new_n89_), .b(x18), .O(new_n110_));
  nand2  g69(.a(x08), .b(x05), .O(new_n111_));
  oai21  g70(.a(new_n111_), .b(new_n78_), .c(new_n110_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(x12), .O(new_n113_));
  nand2  g72(.a(new_n113_), .b(new_n109_), .O(z17));
  oai21  g73(.a(new_n61_), .b(new_n74_), .c(x07), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n89_), .b(x19), .O(new_n117_));
  nand2  g76(.a(x08), .b(x06), .O(new_n118_));
  oai21  g77(.a(new_n118_), .b(new_n78_), .c(new_n117_), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x12), .O(new_n120_));
  nand2  g79(.a(new_n120_), .b(new_n116_), .O(z18));
  oai21  g80(.a(new_n43_), .b(new_n74_), .c(x07), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(x15), .O(new_n123_));
  nand2  g82(.a(new_n89_), .b(x20), .O(new_n124_));
  oai21  g83(.a(new_n55_), .b(new_n78_), .c(new_n124_), .O(new_n125_));
  nand2  g84(.a(new_n125_), .b(x12), .O(new_n126_));
  nand2  g85(.a(new_n126_), .b(new_n123_), .O(z19));
endmodule
