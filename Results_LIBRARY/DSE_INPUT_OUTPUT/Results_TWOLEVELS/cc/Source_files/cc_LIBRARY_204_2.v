...
module FAU ( 
  ...
  oai21  g09(.a(x19), .b(new_n44_), .c(x14), .O(new_n51_));
  ...
  nand4  g17(.a(new_n58_), .b(x19), .c(x15), .d(new_n56_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z03));
  nor2   g19(.a(new_n45_), .b(x18), .O(z04));
  nand2  g20(.a(new_n48_), .b(new_n44_), .O(z05));
  ...
  nand2  g28(.a(new_n46_), .b(new_n56_), .O(z11));
  ...
  oai21  g40(.a(new_n81_), .b(new_n80_), .c(new_n56_), .O(new_n82_));
  nand3  g41(.a(new_n82_), .b(x19), .c(x15), .O(new_n83_));
  nand3  g42(.a(x10), .b(x08), .c(x01), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n44_), .c(x14), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n79_), .O(z13));
  nand3  g45(.a(new_n49_), .b(x19), .c(x15), .O(new_n87_));
  nand4  g46(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n79_), .O(z14));
  nand3  g48(.a(x16), .b(new_n56_), .c(x12), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x19), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(x15), .O(new_n92_));
  nand3  g51(.a(new_n49_), .b(x16), .c(new_n56_), .O(new_n93_));
  ...
  oai21  g56(.a(new_n63_), .b(new_n79_), .c(x19), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x15), .O(new_n99_));
  nand2  g58(.a(new_n49_), .b(x17), .O(new_n100_));
  ...
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n79_), .O(z17));
  nand2  g69(.a(new_n44_), .b(x06), .O(new_n111_));
  nand3  g70(.a(x19), .b(x15), .c(new_n56_), .O(new_n112_));
  nand2  g71(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g72(.a(new_n113_), .b(x10), .c(x08), .O(new_n114_));
  nand2  g73(.a(x15), .b(x14), .O(new_n115_));
  nand3  g74(.a(new_n115_), .b(x10), .c(x08), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(x19), .O(new_n117_));
  aoi21  g76(.a(new_n117_), .b(new_n114_), .c(new_n79_), .O(z18));
  oai21  g77(.a(new_n43_), .b(new_n79_), .c(x19), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(x15), .O(new_n120_));
  nand2  g79(.a(new_n49_), .b(x20), .O(new_n121_));
  nand4  g80(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(new_n121_), .O(new_n123_));
