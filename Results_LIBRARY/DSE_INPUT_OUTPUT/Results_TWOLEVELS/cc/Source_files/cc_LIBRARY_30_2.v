...
module FAU ( 
  ...
  oai21  g26(.a(new_n53_), .b(x08), .c(x09), .O(z10));
  ...
  nor2   g37(.a(new_n78_), .b(new_n53_), .O(new_n79_));
  ...
  nand4  g65(.a(new_n53_), .b(x10), .c(x08), .d(x06), .O(new_n107_));
  ...
  nand3  g73(.a(new_n54_), .b(x20), .c(x12), .O(new_n115_));
