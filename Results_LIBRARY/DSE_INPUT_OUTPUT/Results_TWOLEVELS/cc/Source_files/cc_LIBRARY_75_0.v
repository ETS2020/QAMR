...
module FAU ( 
  ...
  nand2  g30(.a(new_n44_), .b(new_n46_), .O(z11));
  ...
  oai21  g37(.a(new_n75_), .b(new_n69_), .c(new_n46_), .O(new_n79_));
  ...
  nand3  g63(.a(new_n76_), .b(x08), .c(x06), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n73_), .O(z18));
  nand2  g65(.a(new_n52_), .b(x20), .O(new_n107_));
  nand3  g66(.a(new_n76_), .b(x08), .c(x07), .O(new_n108_));
