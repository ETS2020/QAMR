...
module FAU ( 
  ...
  aoi21  g02(.a(x16), .b(new_n42_), .c(new_n43_), .O(z00));
  ...
  and2   g19(.a(new_n48_), .b(x19), .O(z05));
  aoi21  g20(.a(x20), .b(new_n47_), .c(x15), .O(new_n62_));
  inv1   g21(.a(new_n62_), .O(z06));
  and2   g22(.a(new_n48_), .b(x17), .O(z07));
  nand2  g23(.a(new_n48_), .b(x09), .O(new_n65_));
  nor2   g24(.a(new_n65_), .b(new_n45_), .O(z09));
  nand3  g25(.a(new_n48_), .b(x09), .c(x08), .O(z10));
  nand2  g26(.a(new_n48_), .b(new_n46_), .O(z11));
  ...
  nand2  g62(.a(x20), .b(x16), .O(new_n104_));
  nand4  g63(.a(new_n43_), .b(new_n51_), .c(x10), .d(x08), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n104_), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(x07), .O(new_n107_));
  nand3  g66(.a(new_n52_), .b(x20), .c(x16), .O(new_n108_));
