...
module FAU ( 
  ...
  nand4  g12(.a(new_n53_), .b(new_n46_), .c(x12), .d(x11), .O(new_n54_));
  aoi21  g13(.a(new_n54_), .b(x11), .c(new_n45_), .O(z03));
  nand2  g14(.a(x15), .b(new_n42_), .O(new_n56_));
  ...
  nor2   g21(.a(new_n62_), .b(new_n42_), .O(z06));
  ...
  oai21  g26(.a(new_n45_), .b(x11), .c(x09), .O(new_n68_));
  nor2   g27(.a(new_n68_), .b(new_n60_), .O(z09));
  aoi22  g28(.a(x15), .b(new_n42_), .c(x09), .d(x08), .O(z10));
  nand2  g29(.a(new_n56_), .b(new_n46_), .O(z11));
  nand2  g30(.a(x13), .b(x12), .O(new_n72_));
  nand2  g31(.a(new_n72_), .b(x11), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(x15), .O(new_n74_));
  nand2  g33(.a(new_n49_), .b(x13), .O(new_n75_));
  ...
  nand3  g41(.a(new_n82_), .b(x15), .c(x11), .O(new_n83_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n56_), .O(z14));
  nand3  g50(.a(x16), .b(new_n46_), .c(x12), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(x11), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x15), .O(new_n94_));
  nand3  g53(.a(new_n49_), .b(x16), .c(new_n46_), .O(new_n95_));
  ...
  oai21  g58(.a(new_n64_), .b(new_n80_), .c(x11), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x15), .O(new_n101_));
  nand2  g60(.a(new_n49_), .b(x17), .O(new_n102_));
  nand4  g61(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n103_));
  ...
  nand2  g68(.a(new_n49_), .b(x18), .O(new_n110_));
  nand4  g69(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n111_));
  ...
  oai21  g73(.a(new_n58_), .b(new_n80_), .c(x11), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x15), .O(new_n116_));
  nand2  g75(.a(new_n49_), .b(x19), .O(new_n117_));
  nand4  g76(.a(new_n45_), .b(x10), .c(x08), .d(x06), .O(new_n118_));
  ...
  oai21  g80(.a(new_n43_), .b(new_n80_), .c(x11), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(x15), .O(new_n123_));
  nand2  g82(.a(new_n49_), .b(x20), .O(new_n124_));
  nand4  g83(.a(new_n45_), .b(x10), .c(x08), .d(x07), .O(new_n125_));
