...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n61_, new_n64_, new_n67_, new_n68_, new_n72_, new_n73_, new_n74_,
  ...
  oai21  g12(.a(new_n45_), .b(new_n47_), .c(new_n53_), .O(new_n54_));
  ...
  nand3  g33(.a(new_n52_), .b(x10), .c(x08), .O(new_n75_));
  ...
  oai21  g38(.a(new_n79_), .b(new_n67_), .c(new_n47_), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(x15), .O(new_n81_));
  nand2  g40(.a(new_n49_), .b(x01), .O(new_n82_));
  ...
  oai21  g44(.a(new_n49_), .b(new_n52_), .c(new_n85_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n57_), .O(z14));
  nand2  g47(.a(z08), .b(new_n47_), .O(new_n89_));
  nor2   g48(.a(x16), .b(x15), .O(new_n90_));
  nand4  g49(.a(new_n90_), .b(x10), .c(x08), .d(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n89_), .c(new_n78_), .O(z15));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n78_), .O(z16));
  ...
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n78_), .O(z17));
  ...
  nand3  g66(.a(new_n75_), .b(x19), .c(x12), .O(new_n108_));
  ...
  nand3  g71(.a(new_n75_), .b(x20), .c(x12), .O(new_n113_));
