...
module FAU ( 
  ...
  aoi22  g21(.a(x15), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  ...
  oai21  g29(.a(new_n66_), .b(new_n70_), .c(new_n47_), .O(new_n71_));
  ...
  nand2  g34(.a(x15), .b(new_n70_), .O(new_n76_));
  nand4  g35(.a(new_n46_), .b(x10), .c(x08), .d(x02), .O(new_n77_));
  nand2  g36(.a(new_n77_), .b(new_n76_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x12), .O(new_n79_));
  oai21  g38(.a(new_n43_), .b(new_n66_), .c(x15), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n79_), .O(z14));
  nand3  g40(.a(new_n51_), .b(x16), .c(new_n47_), .O(new_n82_));
  nand3  g41(.a(new_n67_), .b(x08), .c(x03), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n82_), .c(new_n43_), .O(z15));
  nand2  g43(.a(new_n51_), .b(x17), .O(new_n85_));
  nand3  g44(.a(new_n67_), .b(x08), .c(x04), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n43_), .O(z16));
  nand2  g46(.a(new_n51_), .b(x18), .O(new_n88_));
  nand3  g47(.a(new_n67_), .b(x08), .c(x05), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n43_), .O(z17));
  nand2  g49(.a(new_n51_), .b(x19), .O(new_n91_));
  nand3  g50(.a(new_n67_), .b(x08), .c(x06), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n43_), .O(z18));
  nand2  g52(.a(new_n51_), .b(x20), .O(new_n94_));
  nand3  g53(.a(new_n67_), .b(x08), .c(x07), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n43_), .O(z19));
  aoi21  g55(.a(new_n48_), .b(x12), .c(new_n46_), .O(z03));
  buf    g56(.a(x15), .O(z06));
endmodule
