...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n59_, new_n62_, new_n64_, new_n67_, new_n71_, new_n72_, new_n73_,
  ...
  nor2   g31(.a(x18), .b(new_n45_), .O(new_n73_));
  ...
  nand2  g63(.a(new_n104_), .b(new_n42_), .O(z17));
  oai21  g64(.a(new_n62_), .b(new_n71_), .c(new_n46_), .O(new_n106_));
