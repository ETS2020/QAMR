...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x19), .c(new_n46_), .O(z01));
  inv1   g08(.a(x11), .O(new_n50_));
  oai21  g09(.a(x19), .b(new_n46_), .c(x14), .O(new_n51_));
  ...
  aoi21  g17(.a(new_n58_), .b(x19), .c(new_n46_), .O(z03));
  nand2  g18(.a(new_n44_), .b(x18), .O(z04));
  nand2  g19(.a(new_n43_), .b(new_n46_), .O(z05));
  ...
  nand2  g29(.a(new_n56_), .b(new_n46_), .O(new_n71_));
  ...
  nand3  g48(.a(new_n73_), .b(x16), .c(new_n47_), .O(new_n90_));
  ...
  nand3  g55(.a(x19), .b(x17), .c(x15), .O(new_n97_));
  ...
  inv1   g63(.a(x08), .O(new_n105_));
  oai21  g64(.a(x15), .b(x06), .c(x10), .O(new_n106_));
  nand2  g65(.a(new_n56_), .b(x19), .O(new_n107_));
  oai21  g66(.a(new_n106_), .b(new_n105_), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x12), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n44_), .O(z18));
