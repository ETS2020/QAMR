...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n54_, new_n60_, new_n62_, new_n63_, new_n67_,
  ...
  nand3  g12(.a(x15), .b(new_n47_), .c(x12), .O(new_n54_));
  oai21  g13(.a(new_n54_), .b(new_n46_), .c(new_n44_), .O(z03));
  inv1   g14(.a(x18), .O(z04));
  and2   g15(.a(new_n44_), .b(x19), .O(z05));
  nand2  g16(.a(z04), .b(new_n43_), .O(z06));
  ...
  nand3  g28(.a(z04), .b(new_n43_), .c(x10), .O(new_n70_));
  ...
  nor2   g33(.a(new_n74_), .b(new_n43_), .O(new_n75_));
  ...
  nand4  g44(.a(new_n50_), .b(x16), .c(new_n47_), .d(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(z15));
  oai21  g46(.a(new_n68_), .b(x15), .c(x17), .O(new_n88_));
  nand3  g47(.a(new_n71_), .b(x08), .c(x04), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n67_), .O(z16));
  nand2  g49(.a(x18), .b(x15), .O(new_n91_));
  nand3  g50(.a(new_n71_), .b(x08), .c(x05), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n67_), .O(z17));
  nand4  g52(.a(x12), .b(x10), .c(x08), .d(x06), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(z04), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n43_), .O(new_n96_));
  nand3  g55(.a(new_n50_), .b(x19), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(z18));
  nand4  g57(.a(x12), .b(x10), .c(x08), .d(x07), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(z04), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n43_), .O(new_n101_));
  nand3  g60(.a(new_n50_), .b(x20), .c(x12), .O(new_n102_));
