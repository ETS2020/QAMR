...
module FAU ( 
  ...
  nor2   g02(.a(x20), .b(x16), .O(new_n44_));
  ...
  nand4  g12(.a(new_n53_), .b(new_n45_), .c(x12), .d(new_n42_), .O(new_n54_));
  ...
  nand4  g45(.a(new_n62_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  ...
  aoi22  g56(.a(new_n97_), .b(new_n96_), .c(new_n52_), .d(x18), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n86_), .c(new_n45_), .O(z17));
  ...
  nand4  g63(.a(x16), .b(new_n51_), .c(x10), .d(x08), .O(new_n105_));
  ...
  aoi21  g67(.a(new_n108_), .b(new_n107_), .c(new_n86_), .O(z19));
  buf    g68(.a(x16), .O(z08));
endmodule
