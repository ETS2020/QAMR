...
module FAU ( 
  ...
  nand2  g02(.a(x16), .b(new_n43_), .O(new_n44_));
  ...
  nor2   g11(.a(x16), .b(x15), .O(new_n53_));
  ...
  nand2  g20(.a(new_n51_), .b(new_n43_), .O(z06));
  ...
  aoi21  g27(.a(x10), .b(x08), .c(x16), .O(new_n69_));
  oai21  g28(.a(new_n69_), .b(x15), .c(x13), .O(new_n70_));
  nand4  g29(.a(new_n53_), .b(x10), .c(x08), .d(x00), .O(new_n71_));
  ...
  nand3  g40(.a(x16), .b(x15), .c(new_n48_), .O(new_n82_));
  ...
  nand3  g52(.a(new_n88_), .b(x18), .c(x12), .O(new_n94_));
  ...
  nand3  g57(.a(new_n88_), .b(x19), .c(x12), .O(new_n99_));
  ...
  nand3  g62(.a(new_n88_), .b(x20), .c(x12), .O(new_n104_));
