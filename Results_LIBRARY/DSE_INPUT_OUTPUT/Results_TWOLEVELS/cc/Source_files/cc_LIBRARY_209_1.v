...
module FAU ( 
  ...
  aoi21  g16(.a(x10), .b(x08), .c(x14), .O(new_n58_));
  nand4  g17(.a(new_n58_), .b(x12), .c(x10), .d(x08), .O(new_n59_));
  and2   g18(.a(new_n59_), .b(x15), .O(z06));
  ...
  nor2   g32(.a(new_n58_), .b(new_n47_), .O(new_n74_));
  ...
  nor4   g68(.a(new_n48_), .b(new_n47_), .c(x14), .d(new_n43_), .O(z03));
endmodule
