...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n61_), .c(new_n47_), .O(new_n79_));
  ...
  nor2   g63(.a(x15), .b(new_n78_), .O(new_n105_));
  nand3  g64(.a(new_n105_), .b(x08), .c(x06), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n104_), .c(new_n56_), .O(z18));
  nand2  g66(.a(new_n52_), .b(x20), .O(new_n108_));
  nand3  g67(.a(new_n105_), .b(x08), .c(x07), .O(new_n109_));
