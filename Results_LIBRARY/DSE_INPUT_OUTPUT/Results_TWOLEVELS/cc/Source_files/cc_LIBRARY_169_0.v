...
module FAU ( 
  ...
  oai21  g37(.a(new_n78_), .b(new_n68_), .c(new_n47_), .O(new_n79_));
  ...
  nor2   g48(.a(x15), .b(new_n78_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(x08), .c(x03), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n89_), .c(new_n77_), .O(z15));
  ...
  oai21  g55(.a(new_n46_), .b(new_n96_), .c(x12), .O(new_n97_));
  ...
  nand2  g64(.a(new_n52_), .b(x20), .O(new_n106_));
  nand3  g65(.a(new_n90_), .b(x08), .c(x07), .O(new_n107_));
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n77_), .O(z19));
endmodule
