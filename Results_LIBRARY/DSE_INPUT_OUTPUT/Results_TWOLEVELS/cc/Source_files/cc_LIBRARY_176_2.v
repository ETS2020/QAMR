...
module FAU ( 
  ...
  aoi21  g36(.a(new_n50_), .b(x01), .c(new_n48_), .O(new_n78_));
  ...
  nor2   g40(.a(x15), .b(x13), .O(new_n82_));
  nand4  g41(.a(new_n82_), .b(x10), .c(x08), .d(x02), .O(new_n83_));
  aoi21  g42(.a(new_n83_), .b(new_n81_), .c(new_n59_), .O(z14));
  ...
  nand4  g47(.a(new_n54_), .b(x16), .c(new_n48_), .d(x12), .O(new_n89_));
