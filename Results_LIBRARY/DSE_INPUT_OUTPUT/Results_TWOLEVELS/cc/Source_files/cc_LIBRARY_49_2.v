...
module FAU ( 
  ...
  nand3  g14(.a(x15), .b(new_n43_), .c(x12), .O(new_n56_));
  ...
  nor2   g27(.a(new_n51_), .b(new_n43_), .O(z11));
  ...
  nor3   g35(.a(new_n76_), .b(new_n51_), .c(new_n70_), .O(z13));
  ...
  nand4  g43(.a(new_n52_), .b(x16), .c(new_n43_), .d(x12), .O(new_n85_));
