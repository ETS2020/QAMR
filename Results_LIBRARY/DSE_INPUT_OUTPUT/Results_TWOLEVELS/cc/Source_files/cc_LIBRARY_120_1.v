...
module FAU ( 
  ...
  nor2   g14(.a(new_n46_), .b(x12), .O(new_n56_));
  ...
  nor2   g21(.a(new_n56_), .b(new_n62_), .O(z07));
  inv1   g22(.a(x16), .O(new_n64_));
  nand2  g23(.a(new_n44_), .b(new_n64_), .O(z08));
  inv1   g24(.a(x09), .O(new_n66_));
  nor3   g25(.a(new_n56_), .b(new_n66_), .c(new_n58_), .O(z09));
  aoi21  g26(.a(x09), .b(x08), .c(new_n56_), .O(z10));
  nor2   g27(.a(new_n56_), .b(new_n49_), .O(z11));
  ...
  nor2   g35(.a(new_n76_), .b(new_n46_), .O(new_n77_));
  ...
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n43_), .O(z14));
  nand3  g45(.a(new_n50_), .b(x16), .c(new_n49_), .O(new_n87_));
  nand3  g46(.a(new_n84_), .b(x08), .c(x03), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n43_), .O(z15));
  nand2  g48(.a(new_n50_), .b(x17), .O(new_n90_));
  nand3  g49(.a(new_n84_), .b(x08), .c(x04), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n43_), .O(z16));
  nand2  g51(.a(new_n50_), .b(x18), .O(new_n93_));
  nand3  g52(.a(new_n84_), .b(x08), .c(x05), .O(new_n94_));
  aoi21  g53(.a(new_n94_), .b(new_n93_), .c(new_n43_), .O(z17));
  nand2  g54(.a(new_n50_), .b(x19), .O(new_n96_));
  nand3  g55(.a(new_n84_), .b(x08), .c(x06), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n43_), .O(z18));
  oai21  g57(.a(x20), .b(new_n43_), .c(x15), .O(new_n99_));
  nand2  g58(.a(new_n47_), .b(x20), .O(new_n100_));
  nand4  g59(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n101_));
  ...
  nor4   g63(.a(new_n47_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
endmodule
