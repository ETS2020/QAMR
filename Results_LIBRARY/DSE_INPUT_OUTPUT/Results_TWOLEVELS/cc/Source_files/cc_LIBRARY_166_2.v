...
module FAU ( 
  ...
  and2   g33(.a(x12), .b(x10), .O(new_n75_));
  ...
  aoi21  g39(.a(new_n49_), .b(x15), .c(x14), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n58_), .c(new_n45_), .O(z13));
  nand2  g41(.a(new_n48_), .b(x15), .O(new_n83_));
  inv1   g42(.a(new_n53_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x02), .c(new_n43_), .O(new_n85_));
  ...
  nand3  g55(.a(new_n75_), .b(x08), .c(x05), .O(new_n97_));
  ...
  oai21  g61(.a(new_n49_), .b(new_n61_), .c(new_n102_), .O(new_n103_));
