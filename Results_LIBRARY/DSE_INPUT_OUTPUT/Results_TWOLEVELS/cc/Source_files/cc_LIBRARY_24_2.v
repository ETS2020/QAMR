...
module FAU ( 
  ...
  aoi21  g17(.a(new_n58_), .b(x18), .c(new_n44_), .O(z03));
  ...
  and2   g31(.a(x18), .b(x15), .O(new_n73_));
  ...
  oai21  g60(.a(x15), .b(x05), .c(x10), .O(new_n102_));
  nand2  g61(.a(new_n56_), .b(x18), .O(new_n103_));
  oai21  g62(.a(new_n102_), .b(new_n51_), .c(new_n103_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x12), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(new_n50_), .O(z17));
  oai21  g65(.a(new_n61_), .b(new_n71_), .c(x18), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x15), .O(new_n108_));
  nand2  g67(.a(new_n56_), .b(x19), .O(new_n109_));
  ...
  oai21  g72(.a(new_n43_), .b(new_n71_), .c(x18), .O(new_n114_));
