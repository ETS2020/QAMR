...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n55_, new_n57_, new_n59_, new_n61_, new_n62_, new_n65_,
  ...
  nor3   g20(.a(z01), .b(new_n62_), .c(new_n61_), .O(z09));
  aoi21  g21(.a(x09), .b(x08), .c(z01), .O(z10));
  nor2   g22(.a(new_n62_), .b(x08), .O(new_n65_));
  aoi21  g23(.a(new_n65_), .b(x08), .c(new_n48_), .O(z11));
  inv1   g24(.a(x12), .O(new_n67_));
  aoi21  g25(.a(x10), .b(x08), .c(x15), .O(new_n68_));
  and2   g26(.a(x15), .b(x14), .O(new_n69_));
  oai21  g27(.a(new_n69_), .b(new_n68_), .c(x13), .O(new_n70_));
  inv1   g28(.a(x10), .O(new_n71_));
  nor2   g29(.a(x15), .b(new_n71_), .O(new_n72_));
  nand3  g30(.a(new_n72_), .b(x08), .c(x00), .O(new_n73_));
  aoi21  g31(.a(new_n73_), .b(new_n70_), .c(new_n67_), .O(z12));
  oai21  g32(.a(new_n48_), .b(x12), .c(x15), .O(new_n75_));
  inv1   g33(.a(x01), .O(new_n76_));
  oai21  g34(.a(new_n49_), .b(new_n76_), .c(x14), .O(new_n77_));
  oai21  g35(.a(new_n77_), .b(new_n67_), .c(new_n75_), .O(z13));
  nand3  g36(.a(new_n49_), .b(x15), .c(x14), .O(new_n79_));
  nand3  g37(.a(new_n72_), .b(x08), .c(x02), .O(new_n80_));
  aoi21  g38(.a(new_n80_), .b(new_n79_), .c(new_n67_), .O(z14));
  nand3  g39(.a(new_n49_), .b(x16), .c(new_n48_), .O(new_n82_));
  ...
  oai21  g44(.a(new_n57_), .b(new_n67_), .c(x14), .O(new_n87_));
  nand2  g45(.a(new_n87_), .b(x15), .O(new_n88_));
  nand2  g46(.a(new_n49_), .b(x17), .O(new_n89_));
  ...
  nand2  g54(.a(new_n49_), .b(x18), .O(new_n97_));
  ...
  oai21  g59(.a(new_n55_), .b(new_n67_), .c(x14), .O(new_n102_));
  nand2  g60(.a(new_n102_), .b(x15), .O(new_n103_));
  nand2  g61(.a(new_n49_), .b(x19), .O(new_n104_));
  ...
  oai21  g66(.a(new_n43_), .b(new_n67_), .c(x14), .O(new_n109_));
  nand2  g67(.a(new_n109_), .b(x15), .O(new_n110_));
  nand2  g68(.a(new_n49_), .b(x20), .O(new_n111_));
  nand4  g69(.a(new_n44_), .b(x10), .c(x08), .d(x07), .O(new_n112_));
  nand2  g70(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand2  g71(.a(new_n113_), .b(x12), .O(new_n114_));
  nand2  g72(.a(new_n114_), .b(new_n110_), .O(z19));
  zero   g73(.O(z03));
  buf    g74(.a(x15), .O(z06));
endmodule
