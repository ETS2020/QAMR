...
module FAU ( 
  ...
  nor4   g14(.a(new_n49_), .b(new_n45_), .c(x14), .d(new_n55_), .O(z03));
  ...
  nand3  g22(.a(new_n47_), .b(x09), .c(x08), .O(new_n64_));
  inv1   g23(.a(new_n64_), .O(z09));
  aoi21  g24(.a(x09), .b(x08), .c(new_n46_), .O(z10));
  nor2   g25(.a(x15), .b(new_n44_), .O(z11));
  aoi21  g26(.a(x10), .b(x08), .c(x15), .O(new_n68_));
  nor2   g27(.a(new_n45_), .b(x14), .O(new_n69_));
  ...
  oai21  g33(.a(new_n49_), .b(new_n55_), .c(new_n44_), .O(new_n75_));
  ...
  nand3  g38(.a(new_n49_), .b(x15), .c(new_n44_), .O(new_n80_));
  nand3  g39(.a(new_n72_), .b(x08), .c(x02), .O(new_n81_));
  aoi21  g40(.a(new_n81_), .b(new_n80_), .c(new_n55_), .O(z14));
  nand3  g41(.a(new_n51_), .b(x16), .c(new_n44_), .O(new_n83_));
  nand3  g42(.a(new_n72_), .b(x08), .c(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n55_), .O(z15));
  oai21  g44(.a(new_n60_), .b(new_n55_), .c(new_n44_), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x15), .O(new_n87_));
  nand2  g46(.a(new_n49_), .b(x17), .O(new_n88_));
  nand4  g47(.a(new_n45_), .b(x10), .c(x08), .d(x04), .O(new_n89_));
  ...
  nand2  g54(.a(new_n49_), .b(x18), .O(new_n96_));
  nand4  g55(.a(new_n45_), .b(x10), .c(x08), .d(x05), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x12), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(new_n95_), .O(z17));
  oai21  g59(.a(new_n58_), .b(new_n55_), .c(new_n44_), .O(new_n101_));
  ...
  oai21  g66(.a(new_n43_), .b(new_n55_), .c(new_n44_), .O(new_n108_));
