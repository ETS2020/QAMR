...
module FAU ( 
  ...
  nor2   g02(.a(x20), .b(x17), .O(new_n44_));
  ...
  oai21  g17(.a(new_n58_), .b(new_n57_), .c(new_n45_), .O(z03));
  ...
  nor3   g27(.a(new_n44_), .b(new_n64_), .c(new_n47_), .O(z09));
  ...
  nand4  g47(.a(new_n49_), .b(x10), .c(x08), .d(x03), .O(new_n89_));
  ...
  nand2  g52(.a(x20), .b(new_n49_), .O(new_n94_));
  oai21  g53(.a(new_n94_), .b(new_n57_), .c(new_n63_), .O(new_n95_));
  ...
  nand4  g58(.a(new_n49_), .b(x10), .c(x08), .d(x05), .O(new_n100_));
  ...
  aoi22  g65(.a(new_n106_), .b(new_n105_), .c(new_n53_), .d(x19), .O(new_n107_));
  oai21  g66(.a(new_n107_), .b(new_n93_), .c(new_n45_), .O(z18));
  nand2  g67(.a(x17), .b(new_n49_), .O(new_n109_));
  oai21  g68(.a(new_n109_), .b(new_n57_), .c(new_n43_), .O(new_n110_));
