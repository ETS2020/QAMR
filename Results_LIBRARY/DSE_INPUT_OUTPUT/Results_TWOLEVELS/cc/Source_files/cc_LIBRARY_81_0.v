...
module FAU ( 
  ...
  oai21  g34(.a(new_n75_), .b(x13), .c(x00), .O(new_n76_));
  nand2  g35(.a(x15), .b(x13), .O(new_n77_));
  aoi21  g36(.a(new_n77_), .b(new_n76_), .c(new_n74_), .O(z12));
  ...
  nand3  g44(.a(new_n75_), .b(x02), .c(x00), .O(new_n86_));
  ...
  nand2  g69(.a(new_n110_), .b(x00), .O(new_n111_));
