...
module FAU ( 
  ...
  nor2   g19(.a(new_n60_), .b(new_n43_), .O(z06));
  inv1   g20(.a(x17), .O(new_n62_));
  nor2   g21(.a(new_n47_), .b(x12), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n62_), .O(z07));
  inv1   g23(.a(x16), .O(new_n65_));
  nand2  g24(.a(new_n44_), .b(new_n65_), .O(z08));
  inv1   g25(.a(x09), .O(new_n67_));
  nor3   g26(.a(new_n63_), .b(new_n67_), .c(new_n58_), .O(z09));
  aoi21  g27(.a(x09), .b(x08), .c(new_n63_), .O(z10));
  nor2   g28(.a(new_n63_), .b(new_n50_), .O(z11));
  ...
  oai21  g46(.a(new_n65_), .b(x14), .c(x12), .O(new_n88_));
