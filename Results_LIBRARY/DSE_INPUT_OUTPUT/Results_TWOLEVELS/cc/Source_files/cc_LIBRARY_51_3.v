...
module FAU ( 
  ...
  nand4  g10(.a(new_n51_), .b(new_n44_), .c(x12), .d(new_n50_), .O(new_n52_));
  inv1   g11(.a(new_n52_), .O(z02));
  inv1   g12(.a(x12), .O(new_n54_));
  nor4   g13(.a(new_n48_), .b(new_n44_), .c(x14), .d(new_n54_), .O(z03));
  ...
  nor2   g25(.a(new_n44_), .b(x14), .O(new_n67_));
  ...
  oai21  g31(.a(new_n48_), .b(new_n54_), .c(new_n43_), .O(new_n73_));
  ...
  nand3  g56(.a(x18), .b(x15), .c(new_n43_), .O(new_n98_));
  ...
  nand3  g62(.a(x19), .b(x15), .c(new_n43_), .O(new_n104_));
  ...
  nand3  g68(.a(x20), .b(x15), .c(new_n43_), .O(new_n110_));
