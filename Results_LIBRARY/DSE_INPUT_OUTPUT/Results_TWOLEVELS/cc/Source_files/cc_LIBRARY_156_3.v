...
module FAU ( 
  ...
  and2   g49(.a(new_n90_), .b(new_n46_), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n89_), .c(new_n45_), .O(z18));
  nand2  g51(.a(new_n51_), .b(x20), .O(new_n93_));
  nand3  g52(.a(x10), .b(x08), .c(x07), .O(new_n94_));
  and2   g53(.a(new_n94_), .b(new_n46_), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n93_), .c(new_n45_), .O(z19));
  buf    g55(.a(x15), .O(z06));
endmodule
