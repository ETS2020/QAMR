...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n49_, new_n50_,
    ...
    new_n61_, new_n62_, new_n65_, new_n67_, new_n69_, new_n73_, new_n74_,
  ...
  oai21  g21(.a(new_n62_), .b(new_n59_), .c(new_n49_), .O(z05));
  ...
  nand2  g26(.a(new_n49_), .b(new_n67_), .O(z08));
  inv1   g27(.a(x09), .O(new_n69_));
  nor3   g28(.a(new_n44_), .b(new_n69_), .c(new_n60_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n44_), .O(z10));
  nand2  g30(.a(new_n49_), .b(new_n46_), .O(z11));
  ...
  oai21  g38(.a(new_n79_), .b(new_n60_), .c(new_n46_), .O(new_n80_));
  ...
  nand2  g43(.a(new_n55_), .b(x15), .O(new_n85_));
  nand4  g44(.a(new_n50_), .b(x10), .c(x08), .d(x02), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n85_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(new_n49_), .O(z14));
  nand2  g48(.a(new_n55_), .b(x19), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(new_n50_), .O(new_n91_));
  nand3  g50(.a(new_n91_), .b(x16), .c(new_n46_), .O(new_n92_));
  nand3  g51(.a(x19), .b(new_n50_), .c(x10), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(new_n94_));
  nand3  g53(.a(new_n94_), .b(x08), .c(x03), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n92_), .c(new_n78_), .O(z15));
  nand2  g55(.a(new_n91_), .b(x17), .O(new_n97_));
  nand3  g56(.a(new_n94_), .b(x08), .c(x04), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n78_), .O(z16));
  nand2  g58(.a(new_n91_), .b(x18), .O(new_n100_));
  nand3  g59(.a(new_n94_), .b(x08), .c(x05), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n78_), .O(z17));
  ...
  nand2  g66(.a(new_n107_), .b(x19), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n50_), .O(new_n109_));
  nand3  g68(.a(new_n51_), .b(x20), .c(x12), .O(new_n110_));
