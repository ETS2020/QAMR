...
module FAU ( 
  ...
  nor2   g01(.a(x20), .b(new_n42_), .O(new_n43_));
  inv1   g02(.a(new_n43_), .O(new_n44_));
  nand2  g03(.a(x20), .b(x11), .O(new_n45_));
  nand2  g04(.a(new_n45_), .b(new_n44_), .O(z00));
  ...
  nand4  g13(.a(new_n54_), .b(new_n44_), .c(x12), .d(new_n51_), .O(new_n55_));
  ...
  nor2   g18(.a(new_n43_), .b(new_n52_), .O(z06));
  ...
  oai21  g32(.a(new_n73_), .b(new_n69_), .c(new_n44_), .O(z12));
  ...
  oai21  g51(.a(new_n92_), .b(new_n69_), .c(new_n44_), .O(z16));
  and2   g52(.a(x08), .b(x05), .O(new_n94_));
  aoi22  g53(.a(new_n94_), .b(new_n71_), .c(new_n53_), .d(x18), .O(new_n95_));
  oai21  g54(.a(new_n95_), .b(new_n69_), .c(new_n44_), .O(z17));
  nand2  g55(.a(new_n42_), .b(new_n52_), .O(new_n97_));
  nand2  g56(.a(x20), .b(x19), .O(new_n98_));
  oai21  g57(.a(new_n97_), .b(new_n47_), .c(new_n98_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x06), .O(new_n100_));
  nand3  g59(.a(new_n53_), .b(x20), .c(x19), .O(new_n101_));
  ...
  oai21  g63(.a(new_n104_), .b(new_n69_), .c(new_n44_), .O(z19));
  buf    g64(.a(x19), .O(z05));
endmodule
