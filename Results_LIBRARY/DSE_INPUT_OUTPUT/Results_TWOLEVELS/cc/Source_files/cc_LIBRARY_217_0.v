...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n44_), .O(z06));
  ...
  nor3   g28(.a(new_n43_), .b(new_n69_), .c(new_n61_), .O(z09));
  aoi21  g29(.a(x09), .b(x08), .c(new_n43_), .O(z10));
  nor2   g30(.a(new_n43_), .b(new_n47_), .O(z11));
  ...
  oai21  g36(.a(new_n74_), .b(new_n61_), .c(new_n47_), .O(new_n78_));
  ...
  nand3  g46(.a(new_n52_), .b(x16), .c(new_n47_), .O(new_n88_));
  ...
  nand3  g53(.a(new_n75_), .b(x08), .c(x05), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n56_), .O(z17));
  nand2  g55(.a(new_n52_), .b(x19), .O(new_n97_));
  nand3  g56(.a(new_n75_), .b(x08), .c(x06), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n56_), .O(z18));
  inv1   g58(.a(x07), .O(new_n100_));
  oai21  g59(.a(new_n46_), .b(new_n100_), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n51_), .O(new_n102_));
  nand3  g61(.a(new_n52_), .b(x20), .c(x12), .O(new_n103_));
