...
module FAU ( 
  ...
  nand2  g31(.a(new_n72_), .b(x07), .O(new_n73_));
  ...
  nand3  g43(.a(new_n84_), .b(x07), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n83_), .c(new_n55_), .O(z14));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n55_), .O(z15));
  ...
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n55_), .O(z16));
