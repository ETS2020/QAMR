...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n49_,
    new_n50_, new_n52_, new_n53_, new_n54_, new_n58_, new_n59_, new_n61_,
  ...
  nor4   g14(.a(new_n48_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  ...
  nand3  g20(.a(new_n61_), .b(new_n49_), .c(x12), .O(new_n62_));
  and2   g21(.a(new_n62_), .b(x15), .O(z06));
  ...
  nor2   g30(.a(new_n59_), .b(new_n47_), .O(z11));
  ...
  nor2   g37(.a(new_n61_), .b(new_n46_), .O(new_n79_));
  ...
  nand4  g52(.a(new_n46_), .b(x10), .c(x08), .d(x04), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x12), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n92_), .O(z16));
  nand2  g56(.a(new_n52_), .b(x18), .O(new_n98_));
  nand3  g57(.a(new_n86_), .b(x08), .c(x05), .O(new_n99_));
