...
module FAU ( 
  ...
  nand3  g20(.a(new_n46_), .b(x10), .c(new_n61_), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(x12), .c(new_n61_), .O(new_n63_));
  oai21  g22(.a(new_n63_), .b(new_n49_), .c(x12), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n54_), .b(new_n65_), .O(z07));
  ...
  nor2   g37(.a(new_n78_), .b(new_n49_), .O(new_n79_));
  ...
  nand3  g42(.a(new_n55_), .b(x15), .c(x12), .O(new_n84_));
  ...
  nand4  g50(.a(new_n50_), .b(x16), .c(new_n46_), .d(x12), .O(new_n92_));
  ...
  nand3  g55(.a(new_n50_), .b(x17), .c(x12), .O(new_n97_));
  nand2  g56(.a(new_n97_), .b(new_n96_), .O(z16));
  nand2  g57(.a(new_n50_), .b(x18), .O(new_n99_));
  nand3  g58(.a(new_n75_), .b(x08), .c(x05), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n72_), .O(z17));
  nand2  g60(.a(new_n50_), .b(x19), .O(new_n102_));
  nand3  g61(.a(new_n75_), .b(x08), .c(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n102_), .c(new_n72_), .O(z18));
  nand2  g63(.a(new_n50_), .b(x20), .O(new_n105_));
  nand3  g64(.a(new_n75_), .b(x08), .c(x07), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n72_), .O(z19));
endmodule
