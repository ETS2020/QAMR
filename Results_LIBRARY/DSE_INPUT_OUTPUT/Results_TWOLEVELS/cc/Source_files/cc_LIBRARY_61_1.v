...
module FAU ( 
  ...
  oai21  g09(.a(new_n50_), .b(x15), .c(x14), .O(new_n51_));
  ...
  nand3  g30(.a(new_n43_), .b(x10), .c(x08), .O(new_n72_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n76_), .c(new_n47_), .O(new_n78_));
  nand2  g37(.a(new_n78_), .b(x15), .O(new_n79_));
  nand3  g38(.a(x10), .b(x08), .c(x01), .O(new_n80_));
  nand3  g39(.a(new_n80_), .b(new_n50_), .c(x14), .O(new_n81_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n75_), .O(z14));
  ...
  nand4  g47(.a(new_n72_), .b(x16), .c(new_n47_), .d(x12), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(z15));
  aoi21  g49(.a(x10), .b(x08), .c(x19), .O(new_n91_));
  oai21  g50(.a(new_n91_), .b(x15), .c(x17), .O(new_n92_));
  ...
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n75_), .O(z18));
  ...
  nand3  g64(.a(new_n72_), .b(x20), .c(x12), .O(new_n106_));
