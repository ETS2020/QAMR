...
module FAU ( 
  ...
  nand2  g01(.a(x15), .b(x05), .O(new_n43_));
  ...
  aoi21  g15(.a(new_n56_), .b(new_n45_), .c(new_n46_), .O(z03));
  nor2   g16(.a(new_n51_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n43_), .b(new_n59_), .O(z05));
  nor2   g19(.a(new_n46_), .b(x05), .O(z06));
  ...
  nor2   g38(.a(new_n79_), .b(new_n46_), .O(new_n80_));
  ...
  nand2  g47(.a(new_n88_), .b(new_n43_), .O(z14));
  ...
  nand2  g65(.a(new_n106_), .b(x05), .O(new_n107_));
  nand3  g66(.a(new_n52_), .b(x18), .c(x12), .O(new_n108_));
  ...
  nand2  g71(.a(new_n112_), .b(new_n46_), .O(new_n113_));
  nand3  g72(.a(x19), .b(x15), .c(new_n45_), .O(new_n114_));
  aoi21  g73(.a(new_n114_), .b(new_n113_), .c(new_n98_), .O(z18));
  ...
  nand2  g77(.a(new_n118_), .b(new_n46_), .O(new_n119_));
  nand3  g78(.a(x20), .b(x15), .c(new_n45_), .O(new_n120_));
  aoi21  g79(.a(new_n120_), .b(new_n119_), .c(new_n98_), .O(z19));
endmodule
