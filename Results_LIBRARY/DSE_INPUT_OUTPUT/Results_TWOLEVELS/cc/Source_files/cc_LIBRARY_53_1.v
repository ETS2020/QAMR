...
module FAU ( 
  ...
  nand3  g15(.a(new_n48_), .b(x12), .c(x08), .O(new_n57_));
  aoi21  g16(.a(new_n57_), .b(x10), .c(new_n44_), .O(z03));
  ...
  nand3  g50(.a(new_n77_), .b(x16), .c(new_n48_), .O(new_n92_));
  ...
  oai22  g56(.a(new_n74_), .b(new_n97_), .c(new_n63_), .d(x10), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n44_), .O(new_n99_));
  nand3  g58(.a(new_n77_), .b(x17), .c(x10), .O(new_n100_));
  aoi21  g59(.a(new_n100_), .b(new_n99_), .c(new_n71_), .O(z16));
  inv1   g60(.a(x05), .O(new_n102_));
  inv1   g61(.a(x18), .O(new_n103_));
  oai22  g62(.a(new_n74_), .b(new_n102_), .c(new_n103_), .d(x10), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(new_n44_), .O(new_n105_));
  nand3  g64(.a(new_n77_), .b(x18), .c(x10), .O(new_n106_));
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n71_), .O(z17));
  inv1   g66(.a(x06), .O(new_n108_));
  oai22  g67(.a(new_n74_), .b(new_n108_), .c(new_n60_), .d(x10), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n44_), .O(new_n110_));
  nand3  g69(.a(new_n77_), .b(x19), .c(x10), .O(new_n111_));
  aoi21  g70(.a(new_n111_), .b(new_n110_), .c(new_n71_), .O(z18));
  oai21  g71(.a(new_n43_), .b(new_n71_), .c(new_n44_), .O(new_n113_));
