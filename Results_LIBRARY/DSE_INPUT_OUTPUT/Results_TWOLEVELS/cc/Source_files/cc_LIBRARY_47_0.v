...
module FAU ( 
  ...
  nand4  g53(.a(new_n53_), .b(x16), .c(new_n48_), .d(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n94_), .O(z15));
  nand2  g55(.a(new_n53_), .b(x17), .O(new_n97_));
  nand3  g56(.a(new_n89_), .b(x08), .c(x04), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n86_), .O(z16));
  nand2  g58(.a(new_n53_), .b(x18), .O(new_n100_));
  nand3  g59(.a(new_n89_), .b(x08), .c(x05), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n86_), .O(z17));
  ...
  nand3  g66(.a(x10), .b(x08), .c(x07), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(x12), .O(new_n109_));
  nand2  g68(.a(new_n109_), .b(new_n52_), .O(new_n110_));
  oai21  g69(.a(new_n75_), .b(new_n43_), .c(new_n110_), .O(z19));
endmodule
