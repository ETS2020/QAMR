...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n76_, new_n78_, new_n80_, new_n82_;
  ...
  nand4  g09(.a(new_n44_), .b(x14), .c(x12), .d(new_n42_), .O(new_n51_));
  ...
  nand2  g28(.a(x12), .b(x08), .O(new_n70_));
  oai21  g29(.a(new_n70_), .b(x14), .c(x15), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x10), .O(new_n72_));
  nand2  g31(.a(x14), .b(x12), .O(new_n73_));
  nand2  g32(.a(new_n73_), .b(new_n72_), .O(z13));
  nand2  g33(.a(x10), .b(x08), .O(new_n75_));
  nand3  g34(.a(new_n75_), .b(x15), .c(x12), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n44_), .O(z14));
  nand4  g36(.a(new_n44_), .b(x16), .c(new_n48_), .d(x12), .O(new_n78_));
  inv1   g37(.a(new_n78_), .O(z15));
  inv1   g38(.a(x12), .O(new_n80_));
  oai21  g39(.a(new_n58_), .b(new_n80_), .c(new_n44_), .O(z16));
  nand2  g40(.a(x18), .b(x12), .O(new_n82_));
  nand2  g41(.a(new_n82_), .b(new_n44_), .O(z17));
  oai21  g42(.a(new_n56_), .b(new_n80_), .c(new_n44_), .O(z18));
  nor2   g43(.a(new_n45_), .b(new_n80_), .O(z19));
  buf    g44(.a(x15), .O(z06));
endmodule
