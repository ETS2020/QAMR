...
module FAU ( 
  ...
  aoi21  g47(.a(new_n88_), .b(new_n85_), .c(new_n84_), .O(z14));
  nand3  g48(.a(new_n51_), .b(x16), .c(new_n46_), .O(new_n90_));
  ...
  nand3  g54(.a(new_n51_), .b(x17), .c(x12), .O(new_n96_));
  ...
  nand3  g67(.a(new_n87_), .b(x08), .c(x07), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n84_), .O(z19));
endmodule
