...
module FAU ( 
  ...
  nand2  g17(.a(x19), .b(new_n50_), .O(z06));
  ...
  nand2  g25(.a(new_n56_), .b(x19), .O(new_n67_));
  nand2  g26(.a(new_n67_), .b(new_n50_), .O(new_n68_));
  nand2  g27(.a(new_n68_), .b(x13), .O(new_n69_));
  nand3  g28(.a(x19), .b(new_n50_), .c(x10), .O(new_n70_));
  ...
  or2    g33(.a(new_n74_), .b(new_n50_), .O(new_n75_));
  ...
  nand2  g48(.a(new_n68_), .b(x18), .O(new_n90_));
  ...
  nand3  g53(.a(new_n94_), .b(x19), .c(x12), .O(new_n95_));
  inv1   g54(.a(new_n95_), .O(z18));
  nand2  g55(.a(new_n56_), .b(x20), .O(new_n97_));
  nand4  g56(.a(new_n50_), .b(x10), .c(x08), .d(x07), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(new_n97_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x19), .O(new_n100_));
  nand2  g59(.a(x20), .b(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n55_), .O(z19));
  buf    g61(.a(x19), .O(z05));
endmodule
