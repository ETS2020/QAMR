...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    ...
    new_n62_, new_n64_, new_n66_, new_n68_, new_n69_, new_n73_, new_n74_,
  ...
  nor2   g05(.a(x14), .b(new_n43_), .O(new_n47_));
  ...
  nor4   g15(.a(new_n56_), .b(new_n46_), .c(x14), .d(new_n43_), .O(z03));
  nand2  g16(.a(new_n44_), .b(x18), .O(z04));
  inv1   g17(.a(x19), .O(new_n59_));
  nand2  g18(.a(new_n44_), .b(new_n59_), .O(z05));
  nand3  g19(.a(x14), .b(x10), .c(x08), .O(new_n61_));
  nand2  g20(.a(new_n61_), .b(x12), .O(new_n62_));
  aoi21  g21(.a(new_n62_), .b(new_n47_), .c(new_n46_), .O(z06));
  ...
  nand2  g27(.a(new_n44_), .b(x09), .O(new_n69_));
  nor2   g28(.a(new_n69_), .b(new_n68_), .O(z09));
  nand3  g29(.a(new_n44_), .b(x09), .c(x08), .O(z10));
  nand2  g30(.a(new_n44_), .b(new_n51_), .O(z11));
  ...
  nand3  g37(.a(new_n56_), .b(new_n51_), .c(x12), .O(new_n79_));
  ...
  aoi21  g46(.a(new_n87_), .b(new_n84_), .c(new_n43_), .O(z14));
  nand3  g47(.a(new_n52_), .b(x16), .c(new_n51_), .O(new_n89_));
  nand3  g48(.a(new_n86_), .b(x08), .c(x03), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n43_), .O(z15));
  nand2  g50(.a(new_n52_), .b(x17), .O(new_n92_));
  nand3  g51(.a(new_n86_), .b(x08), .c(x04), .O(new_n93_));
  aoi21  g52(.a(new_n93_), .b(new_n92_), .c(new_n43_), .O(z16));
  oai21  g53(.a(x18), .b(new_n43_), .c(x15), .O(new_n95_));
  nand2  g54(.a(new_n56_), .b(x18), .O(new_n96_));
  ...
  nand3  g60(.a(new_n86_), .b(x08), .c(x06), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n43_), .O(z18));
  oai21  g62(.a(x20), .b(new_n43_), .c(x15), .O(new_n104_));
  nand2  g63(.a(new_n56_), .b(x20), .O(new_n105_));
  nand4  g64(.a(new_n46_), .b(x10), .c(x08), .d(x07), .O(new_n106_));
