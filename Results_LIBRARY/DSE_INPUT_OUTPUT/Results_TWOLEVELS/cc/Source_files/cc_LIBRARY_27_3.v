...
module FAU ( 
  ...
  nor2   g22(.a(x20), .b(new_n42_), .O(z06));
  inv1   g23(.a(x17), .O(new_n65_));
  nand2  g24(.a(new_n49_), .b(new_n65_), .O(z07));
  inv1   g25(.a(x16), .O(new_n67_));
  nand2  g26(.a(new_n49_), .b(new_n67_), .O(z08));
  nand2  g27(.a(x09), .b(x08), .O(new_n69_));
  nand2  g28(.a(new_n69_), .b(new_n49_), .O(z09));
  nand3  g29(.a(new_n49_), .b(x09), .c(x08), .O(z10));
  nand2  g30(.a(new_n49_), .b(new_n55_), .O(z11));
  ...
  oai21  g37(.a(new_n78_), .b(new_n48_), .c(new_n55_), .O(new_n79_));
  ...
  nand2  g42(.a(new_n45_), .b(x15), .O(new_n84_));
  ...
  nand2  g48(.a(new_n89_), .b(new_n56_), .O(new_n90_));
  nand2  g49(.a(new_n90_), .b(x15), .O(new_n91_));
  nand3  g50(.a(new_n45_), .b(x16), .c(new_n55_), .O(new_n92_));
  nand4  g51(.a(new_n42_), .b(x10), .c(x08), .d(x03), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(new_n92_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(x12), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(new_n91_), .O(z15));
  nand2  g55(.a(new_n45_), .b(x17), .O(new_n97_));
  ...
  nand3  g59(.a(new_n56_), .b(x17), .c(x15), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n73_), .O(z16));
  nand2  g61(.a(x18), .b(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n56_), .O(new_n104_));
  nand2  g63(.a(new_n104_), .b(x15), .O(new_n105_));
  nand2  g64(.a(new_n45_), .b(x18), .O(new_n106_));
  ...
  oai21  g69(.a(new_n62_), .b(new_n73_), .c(new_n56_), .O(new_n111_));
  nand2  g70(.a(new_n111_), .b(x15), .O(new_n112_));
  nand2  g71(.a(new_n45_), .b(x19), .O(new_n113_));
  nand2  g72(.a(x08), .b(x06), .O(new_n114_));
  oai21  g73(.a(new_n114_), .b(new_n51_), .c(new_n113_), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x12), .O(new_n116_));
  nand2  g75(.a(new_n116_), .b(new_n112_), .O(z18));
  inv1   g76(.a(x07), .O(new_n118_));
  nand2  g77(.a(new_n45_), .b(x20), .O(new_n119_));
  oai21  g78(.a(new_n45_), .b(new_n118_), .c(new_n119_), .O(new_n120_));
  nand3  g79(.a(new_n120_), .b(new_n42_), .c(x12), .O(new_n121_));
