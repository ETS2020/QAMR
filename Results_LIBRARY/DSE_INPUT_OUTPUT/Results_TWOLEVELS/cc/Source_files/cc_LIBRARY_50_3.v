...
module FAU ( 
  ...
  nand4  g07(.a(new_n48_), .b(x10), .c(x08), .d(new_n42_), .O(new_n49_));
  ...
  oai21  g21(.a(new_n62_), .b(new_n52_), .c(x15), .O(new_n63_));
  ...
  nand2  g27(.a(x15), .b(x00), .O(new_n69_));
  nand3  g28(.a(new_n69_), .b(x09), .c(x08), .O(new_n70_));
  inv1   g29(.a(new_n70_), .O(z09));
  aoi22  g30(.a(x15), .b(x00), .c(x09), .d(x08), .O(z10));
  ...
  nand2  g37(.a(new_n78_), .b(x08), .O(new_n79_));
  ...
  oai21  g44(.a(new_n85_), .b(new_n83_), .c(x12), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(new_n45_), .O(z13));
  inv1   g46(.a(x12), .O(new_n88_));
  nand2  g47(.a(x10), .b(x08), .O(new_n89_));
  nand3  g48(.a(new_n89_), .b(x15), .c(new_n42_), .O(new_n90_));
  nand3  g49(.a(new_n78_), .b(x08), .c(x02), .O(new_n91_));
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n88_), .O(z14));
  nand2  g51(.a(x15), .b(new_n42_), .O(new_n93_));
  nand2  g52(.a(new_n89_), .b(new_n43_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(x16), .c(new_n48_), .O(new_n96_));
  nand3  g55(.a(new_n78_), .b(x08), .c(x03), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n88_), .O(z15));
  oai21  g57(.a(new_n65_), .b(new_n88_), .c(new_n42_), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n89_), .b(x17), .O(new_n101_));
  ...
  oai21  g72(.a(new_n60_), .b(new_n88_), .c(new_n42_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(x15), .O(new_n115_));
  nand2  g74(.a(new_n89_), .b(x19), .O(new_n116_));
  nand2  g75(.a(x08), .b(x06), .O(new_n117_));
  oai21  g76(.a(new_n117_), .b(new_n53_), .c(new_n116_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x12), .O(new_n119_));
  nand2  g78(.a(new_n119_), .b(new_n115_), .O(z18));
  nand2  g79(.a(new_n89_), .b(x20), .O(new_n121_));
  nand3  g80(.a(x10), .b(x08), .c(x07), .O(new_n122_));
  nand2  g81(.a(new_n122_), .b(new_n121_), .O(new_n123_));
  nand2  g82(.a(new_n123_), .b(new_n43_), .O(new_n124_));
  nand3  g83(.a(x20), .b(x15), .c(new_n42_), .O(new_n125_));
  aoi21  g84(.a(new_n125_), .b(new_n124_), .c(new_n88_), .O(z19));
endmodule
