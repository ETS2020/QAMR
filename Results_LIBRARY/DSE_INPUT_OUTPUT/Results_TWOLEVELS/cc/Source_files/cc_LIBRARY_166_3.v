...
module FAU ( 
  ...
  oai21  g41(.a(new_n76_), .b(new_n46_), .c(new_n47_), .O(new_n83_));
  aoi21  g42(.a(x10), .b(x08), .c(new_n47_), .O(new_n84_));
  aoi21  g43(.a(new_n83_), .b(new_n45_), .c(new_n84_), .O(new_n85_));
  oai21  g44(.a(new_n85_), .b(new_n82_), .c(new_n43_), .O(z13));
  nand3  g45(.a(new_n76_), .b(x15), .c(new_n45_), .O(new_n87_));
  nand4  g46(.a(new_n46_), .b(x10), .c(x08), .d(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n87_), .c(new_n82_), .O(z14));
  ...
  oai21  g56(.a(new_n65_), .b(new_n82_), .c(new_n45_), .O(new_n98_));
  ...
  nand2  g66(.a(new_n76_), .b(x18), .O(new_n108_));
  ...
  nand2  g71(.a(new_n76_), .b(x19), .O(new_n113_));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n82_), .O(z18));
  ...
  aoi21  g82(.a(new_n123_), .b(new_n122_), .c(new_n82_), .O(z19));
endmodule
