...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n46_, new_n47_, new_n48_, new_n50_,
    new_n51_, new_n52_, new_n53_, new_n54_, new_n55_, new_n57_, new_n64_,
  ...
  nor2   g10(.a(x18), .b(x15), .O(new_n52_));
  ...
  nand2  g19(.a(z04), .b(new_n43_), .O(z06));
  ...
  nor2   g32(.a(new_n73_), .b(new_n43_), .O(new_n74_));
  ...
  nand2  g57(.a(new_n98_), .b(z04), .O(new_n99_));
  ...
  aoi21  g65(.a(new_n106_), .b(new_n105_), .c(new_n68_), .O(z19));
endmodule
