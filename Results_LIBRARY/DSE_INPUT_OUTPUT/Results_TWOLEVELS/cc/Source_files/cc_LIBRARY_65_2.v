...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n44_, new_n45_, new_n47_, new_n48_, new_n49_,
    ...
    new_n60_, new_n63_, new_n66_, new_n68_, new_n72_, new_n73_, new_n74_,
  ...
  aoi21  g17(.a(new_n58_), .b(x07), .c(new_n52_), .O(z06));
  nand4  g18(.a(z06), .b(new_n49_), .c(x12), .d(x10), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n57_), .O(z03));
  nand2  g20(.a(new_n47_), .b(x18), .O(z04));
  inv1   g21(.a(x19), .O(new_n63_));
  nand2  g22(.a(new_n47_), .b(new_n63_), .O(z05));
  nand2  g23(.a(new_n58_), .b(new_n44_), .O(z07));
  ...
  nand2  g41(.a(new_n82_), .b(new_n47_), .O(z13));
  ...
  nand3  g47(.a(new_n53_), .b(x16), .c(new_n49_), .O(new_n89_));
  ...
  nand4  g52(.a(new_n52_), .b(x10), .c(x08), .d(new_n44_), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n58_), .O(new_n95_));
  ...
  nand4  g58(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(new_n99_), .O(new_n101_));
  nand3  g60(.a(new_n101_), .b(new_n47_), .c(x12), .O(new_n102_));
  ...
  nand3  g65(.a(new_n106_), .b(new_n47_), .c(x12), .O(new_n107_));
  inv1   g66(.a(new_n107_), .O(z18));
  nand2  g67(.a(new_n52_), .b(x12), .O(new_n109_));
  oai21  g68(.a(new_n109_), .b(new_n48_), .c(x17), .O(new_n110_));
