...
module FAU ( 
  ...
  aoi21  g21(.a(new_n62_), .b(x08), .c(new_n52_), .O(z06));
  ...
  nand3  g33(.a(new_n44_), .b(new_n52_), .c(x10), .O(new_n75_));
  ...
  nor2   g38(.a(new_n79_), .b(new_n52_), .O(new_n80_));
  ...
  nand3  g48(.a(new_n73_), .b(x16), .c(new_n49_), .O(new_n90_));
  ...
  nand2  g62(.a(new_n103_), .b(new_n47_), .O(z18));
