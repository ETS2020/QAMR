...
module FAU ( 
  ...
  nand2  g19(.a(z04), .b(new_n52_), .O(z06));
  ...
  nand2  g30(.a(new_n71_), .b(z04), .O(new_n72_));
  ...
  oai21  g35(.a(new_n76_), .b(new_n66_), .c(new_n49_), .O(new_n77_));
  ...
  nand3  g41(.a(z04), .b(new_n52_), .c(x10), .O(new_n83_));
  inv1   g42(.a(new_n83_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(x08), .c(x02), .O(new_n85_));
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n57_), .O(z14));
  nand2  g45(.a(new_n48_), .b(z04), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n52_), .O(new_n88_));
  nand3  g47(.a(new_n88_), .b(x16), .c(new_n49_), .O(new_n89_));
  nand3  g48(.a(new_n84_), .b(x08), .c(x03), .O(new_n90_));
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n57_), .O(z15));
  nand2  g50(.a(new_n88_), .b(x17), .O(new_n92_));
  nand3  g51(.a(new_n84_), .b(x08), .c(x04), .O(new_n93_));
  ...
  nand2  g56(.a(new_n97_), .b(new_n47_), .O(z17));
  ...
  nand2  g63(.a(new_n104_), .b(z04), .O(new_n105_));
