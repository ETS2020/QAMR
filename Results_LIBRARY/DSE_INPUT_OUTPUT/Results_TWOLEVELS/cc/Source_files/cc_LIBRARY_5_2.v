...
module FAU ( 
  ...
  oai21  g36(.a(new_n77_), .b(new_n51_), .c(new_n52_), .O(new_n78_));
  ...
  nand3  g46(.a(x16), .b(new_n52_), .c(x12), .O(new_n88_));
  nand2  g47(.a(new_n88_), .b(x19), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(x15), .O(new_n90_));
  nand3  g49(.a(new_n48_), .b(x16), .c(new_n52_), .O(new_n91_));
  nand2  g50(.a(x08), .b(x03), .O(new_n92_));
  oai21  g51(.a(new_n92_), .b(new_n53_), .c(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n90_), .O(z15));
  oai21  g54(.a(new_n62_), .b(new_n70_), .c(x19), .O(new_n96_));
  ...
  nand2  g64(.a(new_n48_), .b(x18), .O(new_n106_));
  ...
  oai22  g70(.a(new_n72_), .b(x14), .c(x15), .d(new_n111_), .O(new_n112_));
  nand3  g71(.a(new_n112_), .b(x10), .c(x08), .O(new_n113_));
  nand2  g72(.a(x15), .b(x14), .O(new_n114_));
  nand3  g73(.a(new_n114_), .b(x10), .c(x08), .O(new_n115_));
  nand2  g74(.a(new_n115_), .b(x19), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n113_), .c(new_n70_), .O(z18));
  oai21  g76(.a(new_n43_), .b(new_n70_), .c(x19), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x15), .O(new_n119_));
  nand2  g78(.a(new_n48_), .b(x20), .O(new_n120_));
