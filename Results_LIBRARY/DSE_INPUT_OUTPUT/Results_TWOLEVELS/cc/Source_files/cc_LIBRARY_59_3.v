...
module FAU ( 
  ...
  nand2  g02(.a(x15), .b(x01), .O(new_n44_));
  ...
  nand2  g31(.a(x15), .b(new_n47_), .O(new_n73_));
  ...
  oai21  g37(.a(new_n71_), .b(new_n46_), .c(new_n68_), .O(new_n79_));
  aoi21  g38(.a(x10), .b(x08), .c(new_n68_), .O(new_n80_));
  aoi21  g39(.a(new_n79_), .b(new_n47_), .c(new_n80_), .O(new_n81_));
  oai21  g40(.a(new_n81_), .b(new_n70_), .c(new_n44_), .O(z13));
  ...
  nand3  g46(.a(new_n74_), .b(x16), .c(new_n68_), .O(new_n88_));
  nand3  g47(.a(new_n76_), .b(x08), .c(x03), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n70_), .O(z15));
  oai21  g49(.a(new_n61_), .b(new_n70_), .c(new_n47_), .O(new_n91_));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n70_), .O(z18));
  oai21  g70(.a(new_n43_), .b(new_n70_), .c(new_n47_), .O(new_n112_));
