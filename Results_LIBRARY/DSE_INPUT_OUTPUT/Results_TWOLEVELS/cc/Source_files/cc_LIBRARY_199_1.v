...
module FAU ( 
  ...
  nand3  g19(.a(new_n47_), .b(new_n60_), .c(x08), .O(new_n61_));
  nand2  g20(.a(x12), .b(x10), .O(new_n62_));
  aoi21  g21(.a(new_n61_), .b(x12), .c(new_n62_), .O(new_n63_));
  nor2   g22(.a(new_n63_), .b(new_n46_), .O(z06));
  ...
  oai21  g37(.a(new_n60_), .b(new_n78_), .c(new_n47_), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(x15), .O(new_n80_));
  inv1   g39(.a(x01), .O(new_n81_));
  oai21  g40(.a(new_n55_), .b(new_n81_), .c(x14), .O(new_n82_));
  aoi21  g41(.a(new_n82_), .b(new_n80_), .c(new_n43_), .O(z13));
  nand2  g42(.a(x15), .b(new_n78_), .O(new_n84_));
  ...
  oai21  g61(.a(x20), .b(new_n43_), .c(x15), .O(new_n103_));
  nand2  g62(.a(new_n55_), .b(x20), .O(new_n104_));
