...
module FAU ( 
  ...
  nor2   g10(.a(x19), .b(x15), .O(new_n52_));
  ...
  oai21  g16(.a(new_n57_), .b(new_n47_), .c(new_n44_), .O(z03));
  nand2  g17(.a(new_n44_), .b(x18), .O(z04));
  nand2  g18(.a(x19), .b(x15), .O(new_n60_));
  inv1   g19(.a(new_n60_), .O(z05));
  ...
  nor2   g29(.a(new_n70_), .b(new_n62_), .O(z09));
  aoi22  g30(.a(x19), .b(new_n43_), .c(x09), .d(x08), .O(z10));
  nand2  g31(.a(new_n44_), .b(new_n48_), .O(z11));
  inv1   g32(.a(x19), .O(new_n74_));
  nand4  g33(.a(x12), .b(x10), .c(x08), .d(x00), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(new_n74_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(new_n43_), .O(new_n77_));
  nand3  g36(.a(new_n43_), .b(x10), .c(x08), .O(new_n78_));
  nand3  g37(.a(new_n78_), .b(x13), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n77_), .O(z12));
  aoi21  g39(.a(x10), .b(x08), .c(x14), .O(new_n81_));
  nor2   g40(.a(new_n81_), .b(new_n43_), .O(new_n82_));
  ...
  nand4  g47(.a(new_n52_), .b(x10), .c(x08), .d(x02), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n87_), .O(z14));
  nand4  g49(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n74_), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n43_), .O(new_n93_));
  nand4  g52(.a(new_n78_), .b(x16), .c(new_n48_), .d(x12), .O(new_n94_));
  nand2  g53(.a(new_n94_), .b(new_n93_), .O(z15));
  aoi21  g54(.a(x10), .b(x08), .c(x19), .O(new_n96_));
  oai21  g55(.a(new_n96_), .b(x15), .c(x17), .O(new_n97_));
  nand4  g56(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n98_));
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n87_), .O(z16));
  oai21  g58(.a(new_n96_), .b(x15), .c(x18), .O(new_n100_));
  nand4  g59(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n101_));
  aoi21  g60(.a(new_n101_), .b(new_n100_), .c(new_n87_), .O(z17));
  nand4  g61(.a(new_n52_), .b(x10), .c(x08), .d(x06), .O(new_n103_));
  aoi21  g62(.a(new_n103_), .b(new_n60_), .c(new_n87_), .O(z18));
  nand2  g63(.a(new_n47_), .b(x20), .O(new_n105_));
  nand4  g64(.a(new_n43_), .b(x10), .c(x08), .d(x07), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n105_), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(new_n74_), .O(new_n108_));
  nand2  g67(.a(x20), .b(x15), .O(new_n109_));
  aoi21  g68(.a(new_n109_), .b(new_n108_), .c(new_n87_), .O(z19));
endmodule
