...
module FAU ( 
  ...
  nand2  g28(.a(new_n55_), .b(x13), .O(new_n70_));
  ...
  oai21  g45(.a(new_n63_), .b(x14), .c(x12), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x15), .O(new_n88_));
  nand3  g47(.a(new_n55_), .b(x16), .c(new_n48_), .O(new_n89_));
  ...
  nor2   g53(.a(x15), .b(new_n76_), .O(new_n95_));
  nand3  g54(.a(new_n95_), .b(x08), .c(x04), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n94_), .c(new_n43_), .O(z16));
  nand2  g56(.a(new_n51_), .b(x18), .O(new_n98_));
  nand3  g57(.a(new_n95_), .b(x08), .c(x05), .O(new_n99_));
  aoi21  g58(.a(new_n99_), .b(new_n98_), .c(new_n43_), .O(z17));
