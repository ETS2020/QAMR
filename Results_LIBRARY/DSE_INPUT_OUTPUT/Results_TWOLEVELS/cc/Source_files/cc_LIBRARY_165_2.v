...
module FAU ( 
  ...
  oai21  g25(.a(x15), .b(new_n43_), .c(x14), .O(new_n67_));
  ...
  aoi21  g31(.a(new_n72_), .b(new_n67_), .c(new_n71_), .O(z13));
  ...
  oai21  g37(.a(new_n60_), .b(new_n71_), .c(new_n50_), .O(z16));
  nand2  g38(.a(x18), .b(x12), .O(new_n80_));
  nand2  g39(.a(new_n80_), .b(new_n50_), .O(z17));
  oai21  g40(.a(x15), .b(new_n43_), .c(x19), .O(new_n82_));
  nor2   g41(.a(new_n82_), .b(new_n71_), .O(z18));
  nand2  g42(.a(x20), .b(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n50_), .O(z19));
endmodule
