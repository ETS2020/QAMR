...
module FAU ( 
  ...
  nand2  g29(.a(new_n58_), .b(new_n46_), .O(z11));
  inv1   g30(.a(x12), .O(new_n72_));
  nand2  g31(.a(new_n47_), .b(x13), .O(new_n73_));
  nand4  g32(.a(new_n52_), .b(x10), .c(x08), .d(x00), .O(new_n74_));
  nand2  g33(.a(new_n74_), .b(new_n73_), .O(new_n75_));
  nand2  g34(.a(new_n75_), .b(x03), .O(new_n76_));
  ...
  oai21  g39(.a(new_n80_), .b(new_n79_), .c(new_n46_), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x15), .O(new_n82_));
  nand2  g41(.a(new_n48_), .b(x01), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x14), .c(x03), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n72_), .O(z13));
  nand2  g44(.a(new_n47_), .b(x15), .O(new_n86_));
  inv1   g45(.a(new_n53_), .O(new_n87_));
  nand3  g46(.a(new_n87_), .b(x03), .c(x02), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n72_), .O(z14));
  nor2   g48(.a(new_n66_), .b(x14), .O(new_n90_));
  oai21  g49(.a(new_n90_), .b(new_n87_), .c(x03), .O(new_n91_));
  nand3  g50(.a(x16), .b(x15), .c(new_n46_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n72_), .O(z15));
  nand4  g52(.a(new_n52_), .b(x10), .c(x08), .d(x04), .O(new_n94_));
  oai21  g53(.a(new_n48_), .b(new_n64_), .c(new_n94_), .O(new_n95_));
  nand2  g54(.a(new_n95_), .b(x03), .O(new_n96_));
  nand2  g55(.a(x17), .b(x15), .O(new_n97_));
  aoi21  g56(.a(new_n97_), .b(new_n96_), .c(new_n72_), .O(z16));
  nor2   g57(.a(new_n72_), .b(new_n80_), .O(new_n99_));
  nand3  g58(.a(new_n99_), .b(x08), .c(x05), .O(new_n100_));
  nand2  g59(.a(new_n100_), .b(x03), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n52_), .O(new_n102_));
  nand3  g61(.a(new_n53_), .b(x18), .c(x12), .O(new_n103_));
  nand2  g62(.a(new_n103_), .b(new_n102_), .O(z17));
  nand3  g63(.a(new_n99_), .b(x08), .c(x06), .O(new_n105_));
  nand2  g64(.a(new_n105_), .b(x03), .O(new_n106_));
  ...
  nand3  g68(.a(new_n99_), .b(x08), .c(x07), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(x03), .O(new_n111_));
