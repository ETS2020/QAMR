...
module FAU ( 
  ...
  aoi21  g19(.a(new_n43_), .b(x16), .c(x15), .O(new_n61_));
  ...
  nand3  g31(.a(new_n72_), .b(new_n44_), .c(x12), .O(new_n73_));
  ...
  nand4  g45(.a(new_n61_), .b(x10), .c(x08), .d(x03), .O(new_n87_));
  nand4  g46(.a(new_n51_), .b(x20), .c(x16), .d(new_n47_), .O(new_n88_));
  ...
  nand3  g51(.a(new_n92_), .b(new_n44_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z16));
  inv1   g53(.a(x10), .O(new_n95_));
  nor2   g54(.a(x15), .b(new_n95_), .O(new_n96_));
  and2   g55(.a(x08), .b(x05), .O(new_n97_));
  aoi22  g56(.a(new_n97_), .b(new_n96_), .c(new_n51_), .d(x18), .O(new_n98_));
  oai21  g57(.a(new_n98_), .b(new_n86_), .c(new_n44_), .O(z17));
  nand2  g58(.a(new_n51_), .b(x19), .O(new_n100_));
  nand4  g59(.a(new_n50_), .b(x10), .c(x08), .d(x06), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(new_n102_));
  nand3  g61(.a(new_n102_), .b(new_n44_), .c(x12), .O(new_n103_));
  inv1   g62(.a(new_n103_), .O(z18));
  nand2  g63(.a(new_n51_), .b(x20), .O(new_n105_));
  nand4  g64(.a(new_n64_), .b(new_n50_), .c(x10), .d(x08), .O(new_n106_));
  nand2  g65(.a(new_n106_), .b(new_n43_), .O(new_n107_));
  nand2  g66(.a(new_n107_), .b(x07), .O(new_n108_));
  aoi21  g67(.a(new_n108_), .b(new_n105_), .c(new_n86_), .O(z19));
endmodule
