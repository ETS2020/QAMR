...
module FAU ( 
  ...
  oai21  g33(.a(new_n71_), .b(new_n65_), .c(new_n50_), .O(new_n75_));
  ...
  nand2  g38(.a(x15), .b(new_n65_), .O(new_n80_));
  ...
  oai21  g42(.a(new_n43_), .b(new_n71_), .c(x15), .O(new_n84_));
  ...
  nand4  g52(.a(new_n47_), .b(x10), .c(x08), .d(x05), .O(new_n94_));
