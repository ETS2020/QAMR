...
module FAU ( 
  ...
  nand2  g27(.a(new_n47_), .b(x13), .O(new_n69_));
  nand4  g28(.a(new_n51_), .b(x10), .c(x08), .d(x00), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n69_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x01), .O(new_n72_));
  nand2  g31(.a(x15), .b(x13), .O(new_n73_));
  aoi21  g32(.a(new_n73_), .b(new_n72_), .c(new_n68_), .O(z12));
  nand3  g33(.a(x15), .b(x10), .c(x08), .O(new_n75_));
  inv1   g34(.a(new_n75_), .O(new_n76_));
  aoi21  g35(.a(new_n47_), .b(x14), .c(new_n76_), .O(new_n77_));
  oai21  g36(.a(new_n77_), .b(new_n68_), .c(new_n44_), .O(z13));
  ...
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n68_), .O(z19));
  buf    g70(.a(x15), .O(z06));
endmodule
