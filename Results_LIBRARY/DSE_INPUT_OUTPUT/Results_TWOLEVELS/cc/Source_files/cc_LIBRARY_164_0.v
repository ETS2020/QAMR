...
module FAU ( 
  ...
  nor2   g18(.a(x12), .b(x10), .O(new_n60_));
  nor2   g19(.a(new_n60_), .b(new_n59_), .O(z05));
  nor2   g20(.a(new_n60_), .b(new_n50_), .O(z06));
  ...
  nor2   g27(.a(new_n60_), .b(new_n46_), .O(z11));
  ...
  oai21  g33(.a(x14), .b(new_n55_), .c(new_n71_), .O(new_n75_));
  aoi21  g34(.a(x10), .b(x08), .c(x14), .O(new_n76_));
  nor2   g35(.a(new_n76_), .b(new_n50_), .O(new_n77_));
  aoi21  g36(.a(x08), .b(x01), .c(new_n46_), .O(new_n78_));
  oai21  g37(.a(new_n78_), .b(new_n77_), .c(x12), .O(new_n79_));
  nand2  g38(.a(new_n79_), .b(new_n75_), .O(z13));
  ...
  oai21  g42(.a(new_n65_), .b(x14), .c(x12), .O(new_n84_));
  nand2  g43(.a(new_n84_), .b(new_n71_), .O(new_n85_));
  nand2  g44(.a(new_n50_), .b(x08), .O(new_n86_));
  nand3  g45(.a(new_n86_), .b(x16), .c(new_n46_), .O(new_n87_));
  ...
  nand2  g49(.a(new_n90_), .b(new_n85_), .O(z15));
  ...
  oai21  g53(.a(x18), .b(new_n55_), .c(new_n71_), .O(new_n95_));
  nand2  g54(.a(new_n86_), .b(x18), .O(new_n96_));
  ...
  nand3  g60(.a(new_n72_), .b(x08), .c(x06), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n55_), .O(z18));
  nand2  g62(.a(new_n51_), .b(x20), .O(new_n104_));
  nand3  g63(.a(new_n72_), .b(x08), .c(x07), .O(new_n105_));
  aoi21  g64(.a(new_n105_), .b(new_n104_), .c(new_n55_), .O(z19));
endmodule
