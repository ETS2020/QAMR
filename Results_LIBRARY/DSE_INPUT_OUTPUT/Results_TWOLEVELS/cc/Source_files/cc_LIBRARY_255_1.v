...
module FAU ( 
  ...
  nor2   g26(.a(new_n55_), .b(new_n50_), .O(z11));
  ...
  nor2   g33(.a(new_n74_), .b(new_n47_), .O(new_n75_));
  ...
  nand3  g60(.a(new_n71_), .b(x08), .c(x07), .O(new_n102_));
  aoi21  g61(.a(new_n102_), .b(new_n101_), .c(new_n43_), .O(z19));
  nor4   g62(.a(new_n48_), .b(new_n47_), .c(x14), .d(new_n43_), .O(z03));
endmodule
