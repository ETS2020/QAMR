...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n54_), .O(z06));
  ...
  nand2  g32(.a(new_n50_), .b(x13), .O(new_n74_));
  ...
  oai21  g37(.a(new_n75_), .b(new_n61_), .c(new_n46_), .O(new_n79_));
  ...
  oai21  g66(.a(new_n55_), .b(new_n107_), .c(x12), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n49_), .O(new_n109_));
  nand3  g68(.a(new_n50_), .b(x20), .c(x12), .O(new_n110_));
