...
module FAU ( 
  ...
  nand2  g22(.a(new_n63_), .b(new_n49_), .O(z06));
  ...
  nand3  g43(.a(x18), .b(new_n50_), .c(x10), .O(new_n85_));
  ...
  nand4  g50(.a(new_n51_), .b(x16), .c(new_n46_), .d(x12), .O(new_n92_));
  ...
  nand3  g55(.a(new_n86_), .b(x08), .c(x04), .O(new_n97_));
  ...
  nand3  g59(.a(new_n100_), .b(x18), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n49_), .O(z17));
  nand2  g61(.a(new_n56_), .b(x19), .O(new_n103_));
  ...
  aoi21  g66(.a(new_n107_), .b(new_n106_), .c(new_n55_), .O(z18));
  ...
  nand2  g70(.a(new_n111_), .b(x18), .O(new_n112_));
