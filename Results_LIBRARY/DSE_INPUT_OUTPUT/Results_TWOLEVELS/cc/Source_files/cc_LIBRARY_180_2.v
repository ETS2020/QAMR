...
module FAU ( 
  ...
  nand2  g21(.a(new_n57_), .b(new_n43_), .O(z06));
  ...
  nor3   g35(.a(new_n76_), .b(new_n57_), .c(new_n56_), .O(z13));
  nand2  g36(.a(new_n58_), .b(x15), .O(new_n78_));
  nand4  g37(.a(new_n51_), .b(x10), .c(x08), .d(x02), .O(new_n79_));
  aoi21  g38(.a(new_n79_), .b(new_n78_), .c(new_n56_), .O(z14));
  nand3  g39(.a(new_n57_), .b(x10), .c(x08), .O(new_n81_));
  nand2  g40(.a(new_n81_), .b(x16), .O(new_n82_));
  nand4  g41(.a(new_n57_), .b(x10), .c(x08), .d(x03), .O(new_n83_));
  nand2  g42(.a(new_n83_), .b(new_n82_), .O(new_n84_));
  nand3  g43(.a(new_n84_), .b(new_n43_), .c(x12), .O(new_n85_));
  inv1   g44(.a(new_n85_), .O(z15));
  nand2  g45(.a(new_n58_), .b(x17), .O(new_n87_));
  nand4  g46(.a(new_n57_), .b(x10), .c(x08), .d(x04), .O(new_n88_));
  ...
  nand2  g53(.a(new_n94_), .b(new_n57_), .O(new_n95_));
  nand3  g54(.a(new_n81_), .b(x18), .c(x12), .O(new_n96_));
  ...
  nand3  g59(.a(new_n81_), .b(x19), .c(x12), .O(new_n101_));
  nand2  g60(.a(new_n101_), .b(new_n100_), .O(z18));
  nand2  g61(.a(new_n58_), .b(x20), .O(new_n103_));
  nand4  g62(.a(new_n57_), .b(x10), .c(x08), .d(x07), .O(new_n104_));
