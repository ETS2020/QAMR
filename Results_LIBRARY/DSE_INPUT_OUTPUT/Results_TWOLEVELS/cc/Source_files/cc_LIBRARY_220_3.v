...
module FAU ( 
  ...
  wire new_n42_, new_n43_, new_n45_, new_n46_, new_n48_, new_n49_, new_n50_,
    new_n51_, new_n55_, new_n59_, new_n61_, new_n65_, new_n66_, new_n67_,
  ...
  and2   g46(.a(new_n87_), .b(new_n45_), .O(new_n88_));
  aoi21  g47(.a(new_n88_), .b(new_n86_), .c(new_n70_), .O(z17));
  nand2  g48(.a(new_n46_), .b(x19), .O(new_n90_));
  nand3  g49(.a(x10), .b(x08), .c(x06), .O(new_n91_));
  nand2  g50(.a(new_n91_), .b(new_n90_), .O(new_n92_));
  nand3  g51(.a(new_n92_), .b(new_n45_), .c(x12), .O(new_n93_));
  inv1   g52(.a(new_n93_), .O(z18));
  nand2  g53(.a(new_n46_), .b(x20), .O(new_n95_));
  nand3  g54(.a(x10), .b(x08), .c(x07), .O(new_n96_));
  nand2  g55(.a(new_n96_), .b(new_n95_), .O(new_n97_));
  nand3  g56(.a(new_n97_), .b(new_n45_), .c(x12), .O(new_n98_));
