...
module FAU ( 
  ...
  nor4   g08(.a(new_n49_), .b(new_n48_), .c(new_n44_), .d(x14), .O(z01));
  ...
  nand4  g17(.a(new_n58_), .b(x16), .c(x15), .d(new_n52_), .O(new_n59_));
  inv1   g18(.a(new_n59_), .O(z03));
  nand2  g19(.a(new_n46_), .b(x18), .O(z04));
  inv1   g20(.a(x19), .O(new_n62_));
  nand2  g21(.a(new_n46_), .b(new_n62_), .O(z05));
  ...
  nor2   g27(.a(new_n45_), .b(new_n52_), .O(z11));
  ...
  nand2  g37(.a(new_n78_), .b(x16), .O(new_n79_));
  ...
  nand3  g43(.a(new_n49_), .b(x16), .c(x15), .O(new_n85_));
  nand4  g44(.a(new_n44_), .b(x10), .c(x08), .d(x02), .O(new_n86_));
  aoi21  g45(.a(new_n86_), .b(new_n85_), .c(new_n84_), .O(z14));
  nand2  g46(.a(new_n44_), .b(x03), .O(new_n88_));
  nand3  g47(.a(x16), .b(x15), .c(new_n52_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n88_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(x10), .c(x08), .O(new_n91_));
  nand3  g50(.a(new_n49_), .b(x16), .c(new_n52_), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n84_), .O(z15));
  nand2  g52(.a(new_n49_), .b(x17), .O(new_n94_));
  ...
  aoi21  g57(.a(new_n98_), .b(new_n97_), .c(new_n84_), .O(z16));
  nand2  g58(.a(new_n49_), .b(x18), .O(new_n100_));
  ...
  nand3  g62(.a(x18), .b(x16), .c(x15), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n84_), .O(z17));
  oai21  g64(.a(new_n62_), .b(new_n84_), .c(x16), .O(new_n106_));
  ...
  oai21  g71(.a(new_n43_), .b(new_n84_), .c(x16), .O(new_n113_));
