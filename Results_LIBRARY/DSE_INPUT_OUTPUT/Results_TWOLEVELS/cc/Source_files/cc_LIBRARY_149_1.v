...
module FAU ( 
  ...
  aoi21  g07(.a(new_n48_), .b(x13), .c(new_n43_), .O(z01));
  ...
  oai21  g27(.a(x15), .b(x00), .c(x10), .O(new_n69_));
  nand2  g28(.a(x10), .b(x08), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(x13), .O(new_n71_));
  oai21  g30(.a(new_n69_), .b(new_n51_), .c(new_n71_), .O(new_n72_));
  ...
  nand3  g40(.a(new_n70_), .b(x15), .c(x13), .O(new_n82_));
  inv1   g41(.a(new_n52_), .O(new_n83_));
  nand3  g42(.a(new_n83_), .b(x08), .c(x02), .O(new_n84_));
  aoi21  g43(.a(new_n84_), .b(new_n82_), .c(new_n81_), .O(z14));
  nand2  g44(.a(new_n70_), .b(new_n43_), .O(new_n86_));
  nand2  g45(.a(x15), .b(x13), .O(new_n87_));
  ...
  aoi21  g49(.a(new_n90_), .b(new_n89_), .c(new_n81_), .O(z15));
  ...
  nand3  g54(.a(x17), .b(x15), .c(x13), .O(new_n96_));
  aoi21  g55(.a(new_n96_), .b(new_n95_), .c(new_n81_), .O(z16));
  nand2  g56(.a(x18), .b(x12), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x13), .O(new_n99_));
  nand2  g58(.a(new_n99_), .b(x15), .O(new_n100_));
  nand2  g59(.a(new_n70_), .b(x18), .O(new_n101_));
  ...
  oai21  g64(.a(new_n59_), .b(new_n81_), .c(x13), .O(new_n106_));
  ...
  nand2  g71(.a(new_n70_), .b(x20), .O(new_n113_));
  ...
  aoi21  g76(.a(new_n117_), .b(new_n116_), .c(new_n81_), .O(z19));
  buf    g77(.a(x15), .O(z06));
endmodule
