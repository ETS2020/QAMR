...
module FAU ( 
  ...
  aoi21  g22(.a(new_n63_), .b(x08), .c(new_n52_), .O(z06));
  ...
  nand3  g34(.a(new_n43_), .b(new_n52_), .c(x10), .O(new_n76_));
  inv1   g35(.a(new_n76_), .O(new_n77_));
  nand3  g36(.a(new_n77_), .b(x08), .c(x00), .O(new_n78_));
  aoi21  g37(.a(new_n78_), .b(new_n75_), .c(new_n57_), .O(z12));
  aoi21  g38(.a(x10), .b(x08), .c(x14), .O(new_n80_));
  nor2   g39(.a(new_n80_), .b(new_n52_), .O(new_n81_));
  ...
  oai21  g45(.a(new_n49_), .b(new_n52_), .c(new_n86_), .O(new_n87_));
  ...
  aoi21  g52(.a(new_n93_), .b(new_n65_), .c(new_n57_), .O(z16));
  nand2  g53(.a(new_n48_), .b(x18), .O(new_n95_));
  nand4  g54(.a(new_n52_), .b(x10), .c(x08), .d(x05), .O(new_n96_));
