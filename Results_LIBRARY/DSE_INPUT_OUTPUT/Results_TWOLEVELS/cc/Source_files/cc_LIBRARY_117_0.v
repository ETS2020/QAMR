...
module FAU ( 
  ...
  nand2  g18(.a(x16), .b(new_n50_), .O(z06));
  ...
  nand2  g28(.a(new_n46_), .b(x16), .O(new_n70_));
  nand2  g29(.a(new_n70_), .b(new_n50_), .O(new_n71_));
  nand2  g30(.a(new_n71_), .b(x13), .O(new_n72_));
  nand3  g31(.a(x16), .b(new_n50_), .c(x10), .O(new_n73_));
  ...
  oai21  g36(.a(new_n77_), .b(new_n65_), .c(new_n47_), .O(new_n78_));
  ...
  aoi21  g43(.a(new_n84_), .b(new_n83_), .c(new_n55_), .O(z14));
  nand4  g44(.a(x12), .b(x10), .c(x08), .d(x03), .O(new_n86_));
  nand2  g45(.a(new_n86_), .b(x16), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(new_n50_), .O(new_n88_));
  nand4  g47(.a(new_n51_), .b(x16), .c(new_n47_), .d(x12), .O(new_n89_));
  ...
  nand2  g52(.a(new_n93_), .b(x16), .O(new_n94_));
  ...
  nand3  g63(.a(new_n51_), .b(x19), .c(x12), .O(new_n105_));
