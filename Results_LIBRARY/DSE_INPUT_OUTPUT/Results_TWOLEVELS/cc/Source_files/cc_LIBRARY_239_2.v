...
module FAU ( 
  ...
  nor2   g03(.a(x08), .b(new_n44_), .O(new_n45_));
  ...
  nand2  g26(.a(new_n51_), .b(new_n44_), .O(new_n68_));
  oai21  g27(.a(x09), .b(new_n51_), .c(new_n68_), .O(z10));
  ...
  nand3  g33(.a(new_n52_), .b(x10), .c(x00), .O(new_n75_));
  oai21  g34(.a(new_n74_), .b(new_n72_), .c(new_n75_), .O(new_n76_));
  nand2  g35(.a(new_n76_), .b(x08), .O(new_n77_));
  nand3  g36(.a(x13), .b(new_n51_), .c(new_n44_), .O(new_n78_));
  ...
  nand2  g44(.a(x15), .b(new_n73_), .O(new_n86_));
  oai21  g45(.a(new_n53_), .b(new_n85_), .c(new_n86_), .O(new_n87_));
  nand2  g46(.a(new_n87_), .b(x08), .O(new_n88_));
  nand3  g47(.a(x15), .b(new_n51_), .c(new_n44_), .O(new_n89_));
  aoi21  g48(.a(new_n89_), .b(new_n88_), .c(new_n71_), .O(z14));
  nand3  g49(.a(new_n53_), .b(x16), .c(new_n47_), .O(new_n91_));
  nand3  g50(.a(new_n52_), .b(x10), .c(x03), .O(new_n92_));
  nand2  g51(.a(new_n92_), .b(new_n91_), .O(new_n93_));
  nand2  g52(.a(new_n93_), .b(x08), .O(new_n94_));
  nand4  g53(.a(x16), .b(new_n47_), .c(new_n51_), .d(new_n44_), .O(new_n95_));
  aoi21  g54(.a(new_n95_), .b(new_n94_), .c(new_n71_), .O(z15));
  nand3  g55(.a(new_n52_), .b(x10), .c(x04), .O(new_n97_));
  oai21  g56(.a(new_n74_), .b(new_n63_), .c(new_n97_), .O(new_n98_));
  nand2  g57(.a(new_n98_), .b(x08), .O(new_n99_));
  nand3  g58(.a(x17), .b(new_n51_), .c(new_n44_), .O(new_n100_));
  ...
  nand2  g63(.a(new_n53_), .b(x18), .O(new_n105_));
  nand3  g64(.a(new_n74_), .b(x08), .c(x05), .O(new_n106_));
  ...
  oai21  g68(.a(new_n60_), .b(new_n71_), .c(new_n44_), .O(new_n110_));
  nand2  g69(.a(new_n110_), .b(new_n51_), .O(new_n111_));
  nand2  g70(.a(new_n53_), .b(x19), .O(new_n112_));
  nand3  g71(.a(new_n74_), .b(x08), .c(x06), .O(new_n113_));
  ...
  nand3  g75(.a(new_n52_), .b(x10), .c(x07), .O(new_n117_));
  oai21  g76(.a(new_n74_), .b(new_n43_), .c(new_n117_), .O(new_n118_));
  nand2  g77(.a(new_n118_), .b(x08), .O(new_n119_));
  nand3  g78(.a(x20), .b(new_n51_), .c(new_n44_), .O(new_n120_));
