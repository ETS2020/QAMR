...
module FAU ( 
  ...
  nand2  g47(.a(new_n74_), .b(new_n43_), .O(new_n89_));
  nand2  g48(.a(new_n89_), .b(new_n63_), .O(new_n90_));
  nand3  g49(.a(new_n90_), .b(x16), .c(new_n48_), .O(new_n91_));
  nand4  g50(.a(new_n43_), .b(x10), .c(x08), .d(x03), .O(new_n92_));
  aoi21  g51(.a(new_n92_), .b(new_n91_), .c(new_n79_), .O(z15));
  aoi21  g52(.a(x17), .b(x12), .c(x13), .O(new_n94_));
  nand2  g53(.a(new_n74_), .b(x17), .O(new_n95_));
  ...
  nand2  g59(.a(new_n74_), .b(x18), .O(new_n101_));
  oai21  g60(.a(new_n74_), .b(new_n100_), .c(new_n101_), .O(new_n102_));
  nand2  g61(.a(new_n102_), .b(new_n43_), .O(new_n103_));
  nand3  g62(.a(x18), .b(x15), .c(new_n42_), .O(new_n104_));
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n79_), .O(z17));
  inv1   g64(.a(x06), .O(new_n106_));
  nand2  g65(.a(new_n74_), .b(x19), .O(new_n107_));
  oai21  g66(.a(new_n74_), .b(new_n106_), .c(new_n107_), .O(new_n108_));
  nand2  g67(.a(new_n108_), .b(new_n43_), .O(new_n109_));
  nand3  g68(.a(x19), .b(x15), .c(new_n42_), .O(new_n110_));
  aoi21  g69(.a(new_n110_), .b(new_n109_), .c(new_n79_), .O(z18));
  inv1   g70(.a(x07), .O(new_n112_));
  nand2  g71(.a(new_n74_), .b(x20), .O(new_n113_));
  oai21  g72(.a(new_n74_), .b(new_n112_), .c(new_n113_), .O(new_n114_));
  nand2  g73(.a(new_n114_), .b(new_n43_), .O(new_n115_));
  nand3  g74(.a(x20), .b(x15), .c(new_n42_), .O(new_n116_));
  aoi21  g75(.a(new_n116_), .b(new_n115_), .c(new_n79_), .O(z19));
endmodule
