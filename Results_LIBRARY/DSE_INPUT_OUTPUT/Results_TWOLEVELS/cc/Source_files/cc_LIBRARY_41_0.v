...
module FAU ( 
  ...
  aoi21  g44(.a(new_n85_), .b(new_n82_), .c(new_n51_), .O(z14));
  ...
  aoi21  g53(.a(new_n46_), .b(x18), .c(new_n94_), .O(new_n95_));
  nand3  g54(.a(x18), .b(x15), .c(x12), .O(new_n96_));
  oai21  g55(.a(new_n95_), .b(x15), .c(new_n96_), .O(z17));
  ...
  aoi21  g63(.a(new_n104_), .b(new_n103_), .c(new_n51_), .O(z19));
  buf    g64(.a(x15), .O(z06));
endmodule
