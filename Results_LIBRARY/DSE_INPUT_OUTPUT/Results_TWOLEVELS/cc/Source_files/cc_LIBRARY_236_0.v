...
module FAU ( 
  ...
  aoi21  g20(.a(new_n61_), .b(x08), .c(new_n59_), .O(z05));
  aoi21  g21(.a(new_n61_), .b(x08), .c(new_n51_), .O(z06));
  ...
  aoi21  g50(.a(new_n91_), .b(new_n90_), .c(new_n56_), .O(z15));
  ...
  nand2  g56(.a(new_n73_), .b(x18), .O(new_n98_));
  nand3  g57(.a(new_n76_), .b(x08), .c(x05), .O(new_n99_));
