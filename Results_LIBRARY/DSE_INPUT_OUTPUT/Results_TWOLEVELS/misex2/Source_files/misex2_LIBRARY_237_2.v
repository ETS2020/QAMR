...
module FAU ( 
  ...
  aoi21  g20(.a(new_n63_), .b(new_n61_), .c(new_n52_), .O(new_n64_));
  ...
  nand4  g35(.a(new_n61_), .b(new_n70_), .c(x11), .d(x10), .O(new_n79_));
  ...
  nand4  g41(.a(new_n84_), .b(x02), .c(new_n52_), .d(new_n44_), .O(new_n85_));
  ...
  oai21  g54(.a(new_n97_), .b(new_n92_), .c(new_n44_), .O(new_n98_));
  nand2  g55(.a(new_n98_), .b(new_n52_), .O(new_n99_));
  nor3   g56(.a(new_n51_), .b(new_n52_), .c(x00), .O(new_n100_));
  ...
  nand3  g60(.a(new_n96_), .b(x16), .c(x15), .O(new_n104_));
  oai21  g61(.a(new_n104_), .b(new_n92_), .c(new_n44_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n52_), .O(new_n106_));
  nand4  g63(.a(new_n101_), .b(new_n100_), .c(x22), .d(x21), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n106_), .O(z10));
  inv1   g65(.a(x16), .O(new_n109_));
  nand3  g66(.a(new_n96_), .b(new_n109_), .c(x15), .O(new_n110_));
  oai21  g67(.a(new_n110_), .b(new_n92_), .c(new_n44_), .O(new_n111_));
  nand2  g68(.a(new_n111_), .b(new_n52_), .O(new_n112_));
  inv1   g69(.a(x22), .O(new_n113_));
  nand4  g70(.a(new_n101_), .b(new_n100_), .c(new_n113_), .d(x21), .O(new_n114_));
  ...
  nand3  g75(.a(new_n65_), .b(x17), .c(new_n45_), .O(new_n119_));
  ...
  nor3   g79(.a(new_n53_), .b(x19), .c(new_n50_), .O(z13));
  nand4  g80(.a(new_n47_), .b(new_n58_), .c(new_n46_), .d(new_n45_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n44_), .c(x01), .O(z14));
  inv1   g82(.a(new_n117_), .O(new_n126_));
  aoi21  g83(.a(x19), .b(new_n45_), .c(x00), .O(new_n127_));
  oai21  g84(.a(new_n127_), .b(x01), .c(new_n126_), .O(z15));
  xor2a  g85(.a(x01), .b(x00), .O(z16));
  nand3  g86(.a(x02), .b(new_n52_), .c(new_n44_), .O(new_n130_));
