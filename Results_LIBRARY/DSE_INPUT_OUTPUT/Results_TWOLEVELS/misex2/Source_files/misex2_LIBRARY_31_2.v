...
module FAU ( 
  ...
  aoi21  g029(.a(new_n72_), .b(x16), .c(new_n63_), .O(z04));
  nand4  g030(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(new_n44_), .c(new_n56_), .O(z05));
  ...
  aoi21  g035(.a(new_n78_), .b(x16), .c(new_n63_), .O(z06));
  ...
  nand2  g043(.a(x02), .b(new_n63_), .O(new_n87_));
  inv1   g044(.a(new_n87_), .O(new_n88_));
  inv1   g045(.a(x04), .O(new_n89_));
  nor2   g046(.a(x05), .b(new_n89_), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n88_), .c(new_n86_), .d(new_n62_), .O(new_n91_));
  nor3   g048(.a(x08), .b(x07), .c(x06), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(x19), .c(new_n57_), .d(x17), .O(new_n93_));
  ...
  nand4  g054(.a(x12), .b(new_n97_), .c(x02), .d(new_n63_), .O(new_n98_));
  inv1   g055(.a(x15), .O(new_n99_));
  nor2   g056(.a(x14), .b(x13), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(x20), .c(new_n44_), .d(new_n99_), .O(new_n101_));
  nor2   g058(.a(x20), .b(x19), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(x18), .c(x16), .d(x01), .O(new_n103_));
  ...
  nand3  g068(.a(new_n111_), .b(x12), .c(new_n97_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n87_), .O(new_n113_));
  ...
  aoi21  g074(.a(new_n117_), .b(new_n113_), .c(new_n110_), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n45_), .O(z10));
  and2   g076(.a(x18), .b(x01), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(x21), .c(new_n108_), .d(new_n65_), .O(new_n121_));
  nand4  g078(.a(new_n111_), .b(x12), .c(new_n97_), .d(x02), .O(new_n122_));
  nor2   g079(.a(new_n99_), .b(x14), .O(new_n123_));
  nor2   g080(.a(x21), .b(new_n108_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n123_), .c(new_n44_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n122_), .c(new_n121_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n62_), .O(new_n127_));
  nand2  g084(.a(new_n127_), .b(new_n45_), .O(z11));
  inv1   g085(.a(x24), .O(new_n129_));
  nand2  g086(.a(x10), .b(x02), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(x16), .c(x01), .d(x00), .O(new_n131_));
  oai21  g088(.a(x19), .b(x02), .c(x23), .O(new_n132_));
  nand3  g089(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n133_));
  ...
  nand3  g097(.a(new_n51_), .b(new_n50_), .c(new_n56_), .O(new_n141_));
  ...
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n63_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n45_), .O(z15));
  nand3  g103(.a(x16), .b(x01), .c(new_n62_), .O(new_n147_));
