...
module FAU ( 
  ...
  inv1   g022(.a(new_n46_), .O(new_n66_));
  ...
  nand4  g028(.a(new_n71_), .b(new_n58_), .c(x18), .d(new_n52_), .O(new_n72_));
  aoi21  g029(.a(new_n72_), .b(new_n70_), .c(new_n66_), .O(z03));
  ...
  nor3   g037(.a(new_n66_), .b(new_n74_), .c(new_n56_), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(new_n50_), .c(x02), .d(x01), .O(new_n82_));
  oai21  g039(.a(new_n82_), .b(new_n47_), .c(new_n46_), .O(z06));
  nand3  g040(.a(new_n75_), .b(x11), .c(x10), .O(new_n84_));
  oai21  g041(.a(new_n84_), .b(x09), .c(x01), .O(new_n85_));
  nand4  g042(.a(new_n85_), .b(new_n46_), .c(x02), .d(x00), .O(new_n86_));
  ...
  nand4  g049(.a(new_n46_), .b(x19), .c(new_n57_), .d(x17), .O(new_n93_));
  ...
  nor2   g057(.a(new_n66_), .b(x20), .O(new_n101_));
  nand4  g058(.a(new_n101_), .b(new_n58_), .c(x18), .d(x01), .O(new_n102_));
  nand3  g059(.a(new_n44_), .b(x12), .c(new_n74_), .O(new_n103_));
  nor3   g060(.a(new_n103_), .b(new_n49_), .c(x01), .O(new_n104_));
  ...
  nor4   g072(.a(new_n115_), .b(x22), .c(x21), .d(new_n106_), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n104_), .c(new_n113_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n46_), .O(z10));
  nor3   g075(.a(new_n66_), .b(new_n99_), .c(x20), .O(new_n119_));
  nand4  g076(.a(new_n119_), .b(new_n58_), .c(x18), .d(x01), .O(new_n120_));
  inv1   g077(.a(x16), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(x15), .c(new_n114_), .O(new_n122_));
  nor4   g079(.a(new_n122_), .b(new_n45_), .c(x21), .d(new_n106_), .O(new_n123_));
  nand2  g080(.a(new_n123_), .b(new_n104_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n120_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n100_), .c(new_n47_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n58_), .b(x17), .c(new_n49_), .O(new_n131_));
  nand2  g088(.a(new_n131_), .b(new_n130_), .O(new_n132_));
  nand3  g089(.a(new_n132_), .b(new_n48_), .c(new_n47_), .O(new_n133_));
  aoi21  g090(.a(new_n133_), .b(new_n129_), .c(x24), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(x09), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n46_), .O(z12));
  nand2  g093(.a(new_n48_), .b(new_n47_), .O(new_n137_));
  oai21  g094(.a(new_n131_), .b(new_n137_), .c(new_n46_), .O(z13));
  nand3  g095(.a(new_n53_), .b(new_n52_), .c(new_n56_), .O(new_n139_));
  oai21  g096(.a(new_n139_), .b(new_n51_), .c(new_n46_), .O(z14));
  oai21  g097(.a(x10), .b(new_n48_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n49_), .c(new_n48_), .O(new_n143_));
  aoi21  g100(.a(new_n143_), .b(new_n142_), .c(new_n66_), .O(z15));
  oai21  g101(.a(new_n48_), .b(x00), .c(new_n46_), .O(z16));
  nor4   g102(.a(new_n66_), .b(new_n49_), .c(x01), .d(x00), .O(z17));
endmodule
