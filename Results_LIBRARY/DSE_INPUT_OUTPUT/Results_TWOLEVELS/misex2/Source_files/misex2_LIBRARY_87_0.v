...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n55_,
    ...
    new_n74_, new_n76_, new_n77_, new_n79_, new_n81_, new_n82_, new_n86_,
    new_n87_;
  ...
  nand3  g19(.a(x02), .b(x01), .c(x00), .O(new_n65_));
  nand4  g20(.a(new_n48_), .b(x11), .c(x10), .d(new_n49_), .O(new_n66_));
  ...
  nand2  g37(.a(new_n82_), .b(new_n55_), .O(z12));
