...
module FAU ( 
  ...
  nor3   g57(.a(new_n100_), .b(x11), .c(new_n48_), .O(new_n101_));
  ...
  nand4  g70(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n114_));
