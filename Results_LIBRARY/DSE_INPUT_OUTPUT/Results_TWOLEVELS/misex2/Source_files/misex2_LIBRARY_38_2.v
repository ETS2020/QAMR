...
module FAU ( 
  ...
  nor2   g34(.a(x12), .b(new_n68_), .O(new_n78_));
  ...
  nor2   g63(.a(new_n48_), .b(x01), .O(new_n107_));
  ...
  nand4  g70(.a(new_n94_), .b(x20), .c(new_n93_), .d(x15), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n91_), .c(new_n46_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  inv1   g73(.a(x22), .O(new_n117_));
  nand4  g74(.a(new_n99_), .b(new_n98_), .c(new_n117_), .d(x21), .O(new_n118_));
  ...
  aoi21  g84(.a(new_n123_), .b(new_n46_), .c(x01), .O(z13));
  ...
  or2    g89(.a(new_n132_), .b(new_n121_), .O(z15));
