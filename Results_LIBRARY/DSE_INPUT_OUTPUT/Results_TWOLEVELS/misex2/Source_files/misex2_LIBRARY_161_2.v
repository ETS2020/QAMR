...
module FAU ( 
  ...
  nand4  g060(.a(x20), .b(new_n103_), .c(new_n68_), .d(new_n102_), .O(new_n104_));
  nand2  g061(.a(x18), .b(x01), .O(new_n105_));
  inv1   g062(.a(x20), .O(new_n106_));
  nand2  g063(.a(new_n106_), .b(new_n64_), .O(new_n107_));
  oai22  g064(.a(new_n107_), .b(new_n105_), .c(new_n104_), .d(new_n101_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n99_), .c(new_n98_), .d(new_n78_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n87_), .O(z09));
  nand3  g067(.a(new_n64_), .b(x18), .c(x01), .O(new_n111_));
  nand3  g068(.a(x22), .b(x21), .c(new_n106_), .O(new_n112_));
  nor2   g069(.a(new_n112_), .b(new_n111_), .O(new_n113_));
  nand3  g070(.a(new_n100_), .b(x12), .c(new_n69_), .O(new_n114_));
  nor2   g071(.a(new_n114_), .b(new_n90_), .O(new_n115_));
  nand3  g072(.a(x16), .b(x15), .c(new_n102_), .O(new_n116_));
  nand3  g073(.a(new_n99_), .b(new_n98_), .c(x20), .O(new_n117_));
  nor2   g074(.a(new_n117_), .b(new_n116_), .O(new_n118_));
  aoi21  g075(.a(new_n118_), .b(new_n115_), .c(new_n113_), .O(new_n119_));
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n87_), .O(z10));
  nand3  g077(.a(x21), .b(new_n106_), .c(new_n64_), .O(new_n121_));
  nand4  g078(.a(x12), .b(new_n69_), .c(x02), .d(new_n75_), .O(new_n122_));
  nor2   g079(.a(x14), .b(x13), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n124_));
  oai22  g081(.a(new_n124_), .b(new_n122_), .c(new_n121_), .d(new_n105_), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n99_), .c(x15), .d(new_n78_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n75_), .c(new_n78_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n130_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n128_), .c(x09), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(new_n87_), .O(z12));
  inv1   g094(.a(new_n48_), .O(new_n138_));
  oai21  g095(.a(new_n132_), .b(new_n138_), .c(new_n87_), .O(z13));
  nand4  g096(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  aoi22  g098(.a(new_n87_), .b(x00), .c(x19), .d(new_n75_), .O(new_n142_));
  nand4  g099(.a(x15), .b(new_n57_), .c(x01), .d(x00), .O(new_n143_));
  oai21  g100(.a(new_n142_), .b(x02), .c(new_n143_), .O(z15));
  aoi21  g101(.a(x15), .b(x00), .c(new_n75_), .O(z16));
