...
module FAU ( 
  ...
  nand4  g020(.a(x15), .b(x12), .c(x11), .d(x10), .O(new_n64_));
  ...
  aoi21  g031(.a(new_n74_), .b(x15), .c(new_n70_), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x15), .c(new_n70_), .O(z05));
  ...
  nand3  g040(.a(x15), .b(new_n72_), .c(x11), .O(new_n84_));
  ...
  nand2  g045(.a(new_n88_), .b(new_n78_), .O(new_n89_));
  ...
  nand4  g057(.a(new_n100_), .b(x12), .c(new_n71_), .d(x02), .O(new_n101_));
  inv1   g058(.a(x14), .O(new_n102_));
  inv1   g059(.a(x16), .O(new_n103_));
  nand4  g060(.a(x20), .b(new_n103_), .c(new_n44_), .d(new_n102_), .O(new_n104_));
  ...
  nand2  g070(.a(x02), .b(new_n70_), .O(new_n114_));
  nand3  g071(.a(new_n100_), .b(x12), .c(new_n71_), .O(new_n115_));
  nor2   g072(.a(new_n115_), .b(new_n114_), .O(new_n116_));
  nand3  g073(.a(x16), .b(x15), .c(new_n102_), .O(new_n117_));
  ...
  nand3  g091(.a(new_n52_), .b(x17), .c(new_n46_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n70_), .c(new_n78_), .O(new_n137_));
  ...
  nand4  g101(.a(new_n144_), .b(new_n51_), .c(new_n50_), .d(new_n60_), .O(new_n145_));
  nor2   g102(.a(new_n145_), .b(x19), .O(z14));
  aoi22  g103(.a(new_n45_), .b(x00), .c(x19), .d(new_n70_), .O(new_n147_));
  nand4  g104(.a(x15), .b(new_n60_), .c(x01), .d(x00), .O(new_n148_));
  oai21  g105(.a(new_n147_), .b(x02), .c(new_n148_), .O(z15));
  aoi21  g106(.a(x15), .b(x00), .c(new_n70_), .O(z16));
  nand2  g107(.a(new_n89_), .b(new_n45_), .O(z17));
endmodule
