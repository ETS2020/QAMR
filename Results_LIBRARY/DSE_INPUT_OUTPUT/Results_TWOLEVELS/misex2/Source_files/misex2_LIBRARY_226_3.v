...
module FAU ( 
  ...
  inv1   g021(.a(x03), .O(new_n65_));
  nand4  g022(.a(new_n65_), .b(x02), .c(x01), .d(x00), .O(new_n66_));
  nand4  g023(.a(x12), .b(x11), .c(x10), .d(new_n48_), .O(new_n67_));
  oai22  g024(.a(new_n67_), .b(new_n66_), .c(new_n64_), .d(new_n63_), .O(z03));
  inv1   g025(.a(x11), .O(new_n69_));
  nor4   g026(.a(x03), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n69_), .c(x10), .d(new_n48_), .O(new_n71_));
  nor2   g028(.a(new_n71_), .b(x12), .O(z04));
  nand3  g029(.a(new_n70_), .b(x10), .c(x09), .O(new_n73_));
  inv1   g030(.a(new_n73_), .O(z05));
  nor3   g031(.a(new_n69_), .b(new_n60_), .c(x09), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(new_n65_), .c(x02), .d(x01), .O(new_n76_));
  nor2   g033(.a(new_n76_), .b(new_n45_), .O(z06));
  nand2  g034(.a(new_n48_), .b(new_n65_), .O(new_n78_));
  ...
  nand4  g043(.a(new_n65_), .b(x02), .c(new_n46_), .d(new_n45_), .O(new_n87_));
  ...
  nand4  g047(.a(new_n90_), .b(new_n51_), .c(x17), .d(new_n84_), .O(new_n91_));
  ...
  nand4  g058(.a(new_n101_), .b(x18), .c(new_n65_), .d(x01), .O(new_n102_));
  ...
  nand2  g063(.a(x22), .b(x21), .O(new_n107_));
  nor3   g064(.a(new_n107_), .b(new_n106_), .c(x20), .O(new_n108_));
  ...
  nor2   g075(.a(new_n51_), .b(x03), .O(new_n119_));
  nor2   g076(.a(new_n93_), .b(x20), .O(new_n120_));
  nand4  g077(.a(new_n120_), .b(new_n119_), .c(new_n52_), .d(x01), .O(new_n121_));
  ...
  nand3  g081(.a(new_n124_), .b(new_n94_), .c(new_n45_), .O(new_n125_));
  ...
  nand2  g094(.a(new_n55_), .b(new_n48_), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n51_), .c(new_n50_), .d(new_n60_), .O(new_n140_));
  ...
  nand3  g102(.a(new_n65_), .b(x01), .c(new_n45_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n95_), .b(new_n45_), .O(new_n148_));
