...
module FAU ( 
  ...
  nor2   g50(.a(new_n76_), .b(new_n55_), .O(new_n94_));
  ...
  oai21  g55(.a(new_n93_), .b(new_n89_), .c(new_n98_), .O(new_n99_));
  nand4  g56(.a(new_n99_), .b(new_n87_), .c(new_n86_), .d(new_n44_), .O(new_n100_));
  inv1   g57(.a(new_n100_), .O(z09));
  nand4  g58(.a(new_n92_), .b(x12), .c(new_n69_), .d(x02), .O(new_n102_));
  nor2   g59(.a(x22), .b(x21), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(x20), .c(x16), .d(x15), .O(new_n104_));
  oai21  g61(.a(new_n104_), .b(new_n102_), .c(new_n44_), .O(new_n105_));
  nand2  g62(.a(new_n105_), .b(new_n55_), .O(new_n106_));
  nor2   g63(.a(new_n87_), .b(new_n86_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n97_), .c(new_n94_), .d(new_n44_), .O(new_n108_));
  nand2  g65(.a(new_n108_), .b(new_n106_), .O(z10));
  nand4  g66(.a(new_n94_), .b(x21), .c(new_n95_), .d(new_n60_), .O(new_n110_));
  nor2   g67(.a(x13), .b(new_n70_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n88_), .c(new_n69_), .O(new_n112_));
  nor2   g69(.a(new_n90_), .b(x14), .O(new_n113_));
  nand4  g70(.a(new_n113_), .b(new_n86_), .c(x20), .d(new_n91_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n112_), .c(new_n110_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n87_), .c(new_n44_), .O(new_n116_));
  ...
  nand3  g77(.a(new_n60_), .b(x17), .c(new_n45_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n120_), .c(x01), .O(new_n122_));
  oai21  g79(.a(new_n122_), .b(new_n119_), .c(new_n118_), .O(new_n123_));
  oai22  g80(.a(new_n123_), .b(new_n46_), .c(x01), .d(new_n44_), .O(z12));
  aoi21  g81(.a(new_n121_), .b(new_n44_), .c(x01), .O(z13));
  ...
  nand4  g86(.a(x19), .b(new_n45_), .c(new_n55_), .d(new_n44_), .O(new_n130_));
  nand2  g87(.a(new_n130_), .b(new_n129_), .O(z15));
  nor2   g88(.a(new_n55_), .b(x00), .O(z16));
