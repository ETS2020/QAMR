...
module FAU ( 
  ...
  nand3  g14(.a(new_n49_), .b(new_n57_), .c(new_n50_), .O(new_n58_));
  inv1   g15(.a(x19), .O(new_n59_));
  nand3  g16(.a(new_n59_), .b(x18), .c(new_n45_), .O(new_n60_));
  ...
  nor2   g20(.a(new_n57_), .b(new_n50_), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(x10), .c(new_n44_), .d(x02), .O(new_n65_));
  nor3   g22(.a(new_n65_), .b(x12), .c(x11), .O(z04));
  nand3  g23(.a(x10), .b(x09), .c(x00), .O(new_n67_));
  aoi21  g24(.a(new_n67_), .b(x01), .c(new_n49_), .O(z05));
  nand4  g25(.a(x11), .b(x10), .c(new_n44_), .d(x02), .O(new_n69_));
  nor3   g26(.a(new_n69_), .b(new_n57_), .c(new_n50_), .O(z06));
  inv1   g27(.a(x11), .O(new_n71_));
  nor3   g28(.a(new_n65_), .b(x12), .c(new_n71_), .O(z07));
  nand2  g29(.a(x02), .b(new_n57_), .O(new_n73_));
  inv1   g30(.a(new_n73_), .O(z08));
  nand3  g31(.a(x18), .b(x01), .c(new_n50_), .O(new_n75_));
  inv1   g32(.a(x20), .O(new_n76_));
  inv1   g33(.a(x21), .O(new_n77_));
  inv1   g34(.a(x22), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(new_n77_), .c(new_n76_), .d(new_n59_), .O(new_n79_));
  oai21  g36(.a(new_n79_), .b(new_n75_), .c(new_n73_), .O(z09));
  nor2   g37(.a(new_n57_), .b(x00), .O(z16));
  nand3  g38(.a(z16), .b(new_n59_), .c(x18), .O(new_n82_));
  inv1   g39(.a(new_n82_), .O(new_n83_));
  nand4  g40(.a(new_n83_), .b(x22), .c(x21), .d(new_n76_), .O(new_n84_));
  inv1   g41(.a(new_n84_), .O(z10));
  nand4  g42(.a(new_n78_), .b(x21), .c(new_n76_), .d(new_n59_), .O(new_n86_));
  oai21  g43(.a(new_n86_), .b(new_n75_), .c(new_n73_), .O(z11));
  ...
  nand3  g49(.a(new_n92_), .b(new_n57_), .c(new_n50_), .O(new_n93_));
  nand2  g50(.a(new_n93_), .b(new_n90_), .O(new_n94_));
  nand3  g51(.a(new_n94_), .b(new_n88_), .c(x09), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n73_), .O(z12));
  nand2  g53(.a(new_n46_), .b(x17), .O(new_n97_));
  nor2   g54(.a(new_n97_), .b(x19), .O(z13));
  nand4  g55(.a(new_n51_), .b(new_n54_), .c(new_n44_), .d(new_n50_), .O(new_n99_));
  aoi21  g56(.a(new_n99_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g57(.a(new_n54_), .b(x01), .c(new_n49_), .O(new_n101_));
  nand3  g58(.a(x19), .b(new_n49_), .c(new_n57_), .O(new_n102_));
  oai21  g59(.a(new_n101_), .b(new_n50_), .c(new_n102_), .O(z15));
  zero   g60(.O(z17));
endmodule
