...
module FAU ( 
  ...
  nor3   g34(.a(new_n77_), .b(new_n56_), .c(new_n62_), .O(z06));
  ...
  nand2  g39(.a(x01), .b(new_n62_), .O(new_n83_));
  ...
  nand4  g45(.a(new_n88_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n89_));
  ...
  nand4  g55(.a(new_n70_), .b(x02), .c(new_n56_), .d(new_n62_), .O(new_n99_));
  ...
  nand3  g61(.a(new_n98_), .b(new_n97_), .c(x12), .O(new_n105_));
  nor3   g62(.a(new_n105_), .b(x11), .c(new_n57_), .O(new_n106_));
  inv1   g63(.a(x22), .O(new_n107_));
  nand3  g64(.a(new_n107_), .b(new_n96_), .c(x20), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n106_), .c(x16), .d(x15), .O(new_n110_));
  aoi21  g67(.a(new_n110_), .b(new_n56_), .c(x00), .O(z10));
  nand4  g68(.a(new_n109_), .b(new_n106_), .c(new_n95_), .d(x15), .O(new_n112_));
  aoi21  g69(.a(new_n112_), .b(new_n56_), .c(x00), .O(z11));
  inv1   g70(.a(x24), .O(new_n114_));
  aoi21  g71(.a(x10), .b(x02), .c(new_n56_), .O(new_n115_));
  oai21  g72(.a(x19), .b(x02), .c(x23), .O(new_n116_));
  nand3  g73(.a(new_n63_), .b(x17), .c(new_n57_), .O(new_n117_));
  aoi21  g74(.a(new_n117_), .b(new_n116_), .c(x00), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n115_), .c(new_n114_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n46_), .c(new_n83_), .O(z12));
  nand2  g77(.a(new_n47_), .b(x17), .O(new_n121_));
  nor2   g78(.a(new_n121_), .b(x19), .O(z13));
  nand4  g79(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n123_));
  aoi21  g80(.a(new_n123_), .b(new_n56_), .c(x00), .O(z14));
  oai21  g81(.a(new_n58_), .b(new_n62_), .c(x01), .O(new_n125_));
  oai21  g82(.a(x19), .b(x00), .c(new_n57_), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n125_), .O(z15));
  aoi21  g84(.a(new_n57_), .b(new_n56_), .c(x00), .O(z17));
  zero   g85(.O(z16));
endmodule
