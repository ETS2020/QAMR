...
module FAU ( 
  ...
  nand4  g51(.a(new_n68_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n95_));
  ...
  nand4  g73(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n117_));
  nor2   g74(.a(new_n117_), .b(x19), .O(z14));
  oai21  g75(.a(new_n58_), .b(new_n46_), .c(x01), .O(new_n119_));
