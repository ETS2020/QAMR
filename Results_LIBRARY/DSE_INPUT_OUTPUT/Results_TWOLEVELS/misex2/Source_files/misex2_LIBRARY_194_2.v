...
module FAU ( 
  ...
  nor2   g27(.a(x09), .b(new_n57_), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(new_n70_), .c(new_n69_), .d(x10), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x01), .c(new_n56_), .O(z04));
  ...
  aoi21  g36(.a(new_n79_), .b(x01), .c(new_n56_), .O(z07));
  nor2   g37(.a(x03), .b(new_n57_), .O(new_n81_));
  ...
  aoi21  g44(.a(new_n87_), .b(new_n56_), .c(x01), .O(z08));
  inv1   g45(.a(x21), .O(new_n89_));
  inv1   g46(.a(x22), .O(new_n90_));
  nand4  g47(.a(x12), .b(new_n69_), .c(x02), .d(new_n62_), .O(new_n91_));
  ...
  nand4  g55(.a(new_n98_), .b(new_n90_), .c(new_n89_), .d(new_n56_), .O(new_n99_));
  ...
  nor3   g61(.a(new_n104_), .b(new_n57_), .c(x01), .O(new_n105_));
  ...
  oai21  g70(.a(new_n113_), .b(new_n112_), .c(new_n56_), .O(new_n114_));
  nand2  g71(.a(new_n114_), .b(new_n62_), .O(new_n115_));
  nor3   g72(.a(new_n45_), .b(new_n62_), .c(x00), .O(new_n116_));
  ...
  nand3  g81(.a(new_n124_), .b(new_n62_), .c(new_n56_), .O(new_n125_));
  ...
  nand4  g87(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n131_));
  aoi21  g88(.a(new_n131_), .b(new_n56_), .c(x01), .O(z14));
  aoi21  g89(.a(x19), .b(new_n57_), .c(x00), .O(new_n133_));
  nand2  g90(.a(new_n120_), .b(x00), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(x01), .c(new_n134_), .O(z15));
