...
module FAU ( 
  ...
  nand2  g26(.a(new_n46_), .b(x02), .O(new_n70_));
  ...
  aoi21  g32(.a(x12), .b(new_n59_), .c(new_n68_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(x10), .c(new_n46_), .d(x02), .O(new_n77_));
  aoi21  g34(.a(new_n77_), .b(x00), .c(new_n60_), .O(z06));
  nand3  g35(.a(new_n69_), .b(x11), .c(x10), .O(new_n79_));
  oai21  g36(.a(new_n79_), .b(new_n70_), .c(x00), .O(new_n80_));
  nand2  g37(.a(new_n80_), .b(x01), .O(new_n81_));
  nand3  g38(.a(x02), .b(new_n60_), .c(x00), .O(new_n82_));
  ...
  nor3   g55(.a(new_n98_), .b(x11), .c(new_n61_), .O(new_n99_));
  inv1   g56(.a(x21), .O(new_n100_));
  inv1   g57(.a(x22), .O(new_n101_));
  nand3  g58(.a(new_n101_), .b(new_n100_), .c(x20), .O(new_n102_));
  inv1   g59(.a(new_n102_), .O(new_n103_));
  nand4  g60(.a(new_n103_), .b(new_n99_), .c(new_n95_), .d(new_n94_), .O(new_n104_));
  aoi21  g61(.a(new_n104_), .b(new_n60_), .c(x00), .O(z09));
  nand4  g62(.a(new_n103_), .b(new_n99_), .c(x16), .d(x15), .O(new_n106_));
  aoi21  g63(.a(new_n106_), .b(new_n60_), .c(x00), .O(z10));
  nand4  g64(.a(new_n68_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n108_));
  inv1   g65(.a(new_n108_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n97_), .c(new_n96_), .d(x12), .O(new_n110_));
  nor2   g67(.a(new_n110_), .b(new_n94_), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n100_), .c(x20), .d(new_n95_), .O(new_n112_));
  ...
  oai22  g76(.a(new_n119_), .b(new_n46_), .c(new_n60_), .d(x00), .O(z12));
  ...
  aoi21  g81(.a(new_n124_), .b(new_n60_), .c(x00), .O(z14));
  oai21  g82(.a(new_n56_), .b(new_n59_), .c(x01), .O(new_n126_));
  oai21  g83(.a(x19), .b(x00), .c(new_n61_), .O(new_n127_));
