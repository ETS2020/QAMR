...
module FAU ( 
  ...
  nor4   g028(.a(x04), .b(new_n46_), .c(new_n71_), .d(new_n70_), .O(new_n72_));
  ...
  aoi21  g032(.a(new_n75_), .b(new_n61_), .c(new_n71_), .O(z05));
  nor3   g033(.a(new_n69_), .b(new_n58_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(new_n61_), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n70_), .O(z06));
  nand2  g036(.a(new_n47_), .b(new_n61_), .O(new_n80_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n71_), .d(new_n70_), .O(new_n90_));
  ...
  nand4  g061(.a(new_n104_), .b(x18), .c(new_n61_), .d(x01), .O(new_n105_));
  ...
  nor3   g067(.a(new_n110_), .b(new_n109_), .c(x20), .O(new_n111_));
  ...
  nor2   g078(.a(new_n45_), .b(x04), .O(new_n122_));
  ...
  nand3  g084(.a(new_n127_), .b(new_n97_), .c(new_n70_), .O(new_n128_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n71_), .c(new_n70_), .O(new_n135_));
  ...
  oai21  g096(.a(new_n133_), .b(new_n139_), .c(new_n53_), .O(z13));
  nand4  g097(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n141_));
  ...
  nand3  g103(.a(new_n61_), .b(x01), .c(new_n70_), .O(new_n147_));
