...
module FAU ( 
  ...
  inv1   g018(.a(new_n45_), .O(new_n62_));
  ...
  oai21  g030(.a(new_n73_), .b(new_n63_), .c(new_n45_), .O(z04));
  inv1   g031(.a(x00), .O(new_n75_));
  nor2   g032(.a(new_n62_), .b(new_n65_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(x09), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n75_), .O(z05));
  nand4  g035(.a(new_n45_), .b(x11), .c(x10), .d(new_n47_), .O(new_n79_));
  ...
  nand4  g047(.a(new_n90_), .b(x02), .c(new_n57_), .d(new_n75_), .O(new_n91_));
  ...
  nor2   g062(.a(new_n51_), .b(new_n57_), .O(new_n106_));
  ...
  nand4  g067(.a(new_n45_), .b(x22), .c(x21), .d(new_n105_), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n52_), .c(x18), .d(x01), .O(new_n113_));
  nand3  g070(.a(new_n44_), .b(x12), .c(new_n71_), .O(new_n114_));
  nor4   g071(.a(new_n114_), .b(x05), .c(new_n46_), .d(x01), .O(new_n115_));
  ...
  nand2  g078(.a(new_n121_), .b(new_n99_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n98_), .c(new_n75_), .O(new_n126_));
  ...
  nand3  g089(.a(new_n132_), .b(new_n57_), .c(new_n75_), .O(new_n133_));
  ...
  nand4  g095(.a(new_n59_), .b(new_n47_), .c(new_n46_), .d(new_n57_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x00), .O(z14));
  oai21  g097(.a(x10), .b(new_n57_), .c(x02), .O(new_n141_));
  nand2  g098(.a(new_n141_), .b(x00), .O(new_n142_));
  nand3  g099(.a(x19), .b(new_n46_), .c(new_n57_), .O(new_n143_));
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n45_), .O(z15));
  nor3   g101(.a(new_n62_), .b(new_n57_), .c(x00), .O(z16));
  nand2  g102(.a(new_n99_), .b(new_n75_), .O(new_n146_));
