...
module FAU ( 
  ...
  nand4  g040(.a(new_n51_), .b(new_n66_), .c(x11), .d(x10), .O(new_n84_));
  ...
  nand4  g048(.a(new_n91_), .b(new_n89_), .c(new_n88_), .d(new_n72_), .O(new_n92_));
  ...
  nand3  g054(.a(new_n89_), .b(x12), .c(new_n65_), .O(new_n98_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n72_), .O(new_n106_));
  ...
  nand3  g068(.a(new_n111_), .b(x12), .c(new_n65_), .O(new_n112_));
  ...
  nand2  g076(.a(new_n119_), .b(new_n89_), .O(new_n120_));
  nor2   g077(.a(new_n99_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n96_), .c(x20), .d(new_n100_), .O(new_n122_));
  inv1   g079(.a(new_n108_), .O(new_n123_));
  nor2   g080(.a(x23), .b(new_n96_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n123_), .c(new_n103_), .O(new_n125_));
  oai21  g082(.a(new_n122_), .b(new_n120_), .c(new_n125_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n97_), .c(new_n72_), .O(new_n127_));
  ...
  aoi21  g089(.a(new_n132_), .b(new_n131_), .c(new_n62_), .O(new_n133_));
  nand2  g090(.a(new_n50_), .b(new_n45_), .O(new_n134_));
  nand4  g091(.a(new_n134_), .b(x23), .c(new_n96_), .d(new_n44_), .O(new_n135_));
  nor2   g092(.a(new_n135_), .b(x00), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n133_), .c(new_n129_), .O(new_n137_));
  nor2   g094(.a(new_n137_), .b(new_n46_), .O(z12));
  nand2  g095(.a(new_n132_), .b(new_n51_), .O(z13));
  ...
  nand3  g103(.a(new_n51_), .b(x01), .c(new_n72_), .O(new_n147_));
  inv1   g104(.a(new_n147_), .O(z16));
  nand4  g105(.a(new_n51_), .b(x02), .c(new_n44_), .d(new_n72_), .O(new_n149_));
