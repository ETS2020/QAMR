...
module FAU ( 
  ...
  nor3   g30(.a(new_n70_), .b(new_n57_), .c(new_n49_), .O(z05));
  nand4  g31(.a(x11), .b(x10), .c(new_n49_), .d(x02), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x01), .c(new_n46_), .O(z06));
  nor2   g33(.a(x12), .b(new_n69_), .O(new_n77_));
  nand3  g34(.a(new_n77_), .b(new_n61_), .c(x10), .O(new_n78_));
  ...
  nand2  g65(.a(new_n108_), .b(x20), .O(new_n109_));
  inv1   g66(.a(new_n109_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n107_), .c(new_n106_), .d(new_n103_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n102_), .c(x00), .O(z10));
  nand4  g69(.a(new_n94_), .b(x12), .c(new_n69_), .d(x02), .O(new_n113_));
  nand4  g70(.a(new_n108_), .b(x20), .c(new_n93_), .d(x15), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(new_n113_), .c(new_n46_), .O(new_n115_));
  nand2  g72(.a(new_n115_), .b(new_n47_), .O(new_n116_));
  nor3   g73(.a(new_n45_), .b(new_n47_), .c(x00), .O(new_n117_));
  nand4  g74(.a(new_n117_), .b(new_n96_), .c(new_n90_), .d(x21), .O(new_n118_));
  nand2  g75(.a(new_n118_), .b(new_n116_), .O(z11));
  inv1   g76(.a(x24), .O(new_n120_));
  aoi21  g77(.a(x10), .b(x02), .c(new_n46_), .O(new_n121_));
  oai21  g78(.a(x19), .b(x02), .c(x23), .O(new_n122_));
  nand3  g79(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n123_));
  ...
  nand2  g84(.a(new_n58_), .b(x17), .O(new_n128_));
  nor2   g85(.a(new_n128_), .b(x19), .O(z13));
  nand4  g86(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n130_));
  ...
  aoi21  g92(.a(new_n48_), .b(new_n46_), .c(x01), .O(z17));
endmodule
