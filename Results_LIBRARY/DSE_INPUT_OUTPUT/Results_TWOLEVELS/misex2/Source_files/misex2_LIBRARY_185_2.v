...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n135_, new_n137_, new_n140_, new_n141_, new_n142_, new_n145_;
  inv1   g000(.a(x03), .O(new_n44_));
  nor2   g001(.a(x12), .b(new_n44_), .O(new_n45_));
  ...
  nand4  g029(.a(new_n67_), .b(new_n68_), .c(x10), .d(new_n48_), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(new_n44_), .c(x12), .O(z04));
  ...
  nand2  g034(.a(new_n69_), .b(x03), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x11), .c(x10), .d(new_n48_), .O(new_n79_));
  inv1   g036(.a(new_n79_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x02), .c(x01), .d(x00), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(new_n46_), .O(z06));
  nand3  g039(.a(new_n48_), .b(new_n44_), .c(x01), .O(new_n83_));
  nand3  g040(.a(new_n69_), .b(x11), .c(x10), .O(new_n84_));
  oai22  g041(.a(new_n84_), .b(new_n83_), .c(new_n45_), .d(x01), .O(new_n85_));
  ...
  nand4  g047(.a(new_n44_), .b(x02), .c(new_n62_), .d(new_n61_), .O(new_n91_));
  ...
  nor2   g071(.a(x13), .b(new_n69_), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(new_n101_), .c(new_n68_), .O(new_n116_));
  nor3   g073(.a(new_n104_), .b(new_n103_), .c(x14), .O(new_n117_));
  nand4  g074(.a(new_n117_), .b(new_n98_), .c(new_n97_), .d(x20), .O(new_n118_));
  or2    g075(.a(new_n118_), .b(new_n116_), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n114_), .c(x00), .O(z10));
  nor2   g077(.a(new_n52_), .b(new_n62_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n111_), .d(new_n53_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n98_), .c(new_n61_), .O(new_n126_));
  ...
  nand3  g087(.a(new_n53_), .b(x17), .c(new_n47_), .O(new_n131_));
  ...
  oai21  g096(.a(x10), .b(new_n62_), .c(x02), .O(new_n140_));
  nand2  g097(.a(new_n140_), .b(x00), .O(new_n141_));
  nand3  g098(.a(x19), .b(new_n47_), .c(new_n62_), .O(new_n142_));
  aoi21  g099(.a(new_n142_), .b(new_n141_), .c(new_n45_), .O(z15));
  nor3   g100(.a(new_n45_), .b(new_n62_), .c(x00), .O(z16));
  nand4  g101(.a(new_n46_), .b(x02), .c(new_n62_), .d(new_n61_), .O(new_n145_));
