...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n131_, new_n133_, new_n134_, new_n136_, new_n138_;
  ...
  aoi21  g28(.a(new_n71_), .b(x11), .c(new_n61_), .O(z05));
  ...
  nand4  g55(.a(new_n98_), .b(x18), .c(x11), .d(x01), .O(new_n99_));
  ...
  nand3  g59(.a(x18), .b(x11), .c(x01), .O(new_n103_));
  inv1   g60(.a(new_n103_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n98_), .c(x22), .d(x21), .O(new_n105_));
  nor2   g62(.a(x13), .b(new_n75_), .O(new_n106_));
  nand3  g63(.a(new_n106_), .b(new_n92_), .c(new_n68_), .O(new_n107_));
  ...
  nor2   g68(.a(new_n90_), .b(x20), .O(new_n112_));
  nand3  g69(.a(new_n112_), .b(new_n104_), .c(new_n63_), .O(new_n113_));
  nor2   g70(.a(new_n94_), .b(x14), .O(new_n114_));
  nand4  g71(.a(new_n114_), .b(new_n90_), .c(x20), .d(new_n95_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n107_), .c(new_n113_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n91_), .c(new_n60_), .O(new_n117_));
  ...
  nand3  g80(.a(new_n123_), .b(new_n61_), .c(new_n60_), .O(new_n124_));
  aoi21  g81(.a(new_n124_), .b(new_n120_), .c(x24), .O(new_n125_));
  nand2  g82(.a(new_n125_), .b(x09), .O(new_n126_));
  nand2  g83(.a(new_n126_), .b(new_n69_), .O(z12));
  inv1   g84(.a(new_n48_), .O(new_n128_));
  oai21  g85(.a(new_n122_), .b(new_n128_), .c(new_n69_), .O(z13));
  nand3  g86(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n130_));
  nand4  g87(.a(new_n63_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n131_));
  oai21  g88(.a(new_n131_), .b(new_n130_), .c(new_n69_), .O(z14));
  aoi22  g89(.a(new_n69_), .b(x00), .c(x19), .d(new_n61_), .O(new_n133_));
  nand4  g90(.a(x11), .b(new_n57_), .c(x01), .d(x00), .O(new_n134_));
  oai21  g91(.a(new_n133_), .b(x02), .c(new_n134_), .O(z15));
  nand3  g92(.a(x11), .b(x01), .c(new_n60_), .O(new_n136_));
