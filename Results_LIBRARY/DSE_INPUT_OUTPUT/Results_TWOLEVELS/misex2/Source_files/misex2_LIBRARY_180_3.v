...
module FAU ( 
  ...
  nor2   g021(.a(x09), .b(new_n61_), .O(new_n65_));
  nand3  g022(.a(new_n65_), .b(x01), .c(x00), .O(new_n66_));
  inv1   g023(.a(x23), .O(new_n67_));
  nand4  g024(.a(new_n67_), .b(x12), .c(x11), .d(x10), .O(new_n68_));
  oai22  g025(.a(new_n68_), .b(new_n66_), .c(new_n64_), .d(new_n62_), .O(z03));
  nor2   g026(.a(x12), .b(x11), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n65_), .c(x10), .d(x00), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(new_n67_), .c(new_n60_), .O(z04));
  nand4  g029(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n73_));
  nor3   g030(.a(new_n73_), .b(x23), .c(new_n56_), .O(z05));
  nand4  g031(.a(new_n67_), .b(x11), .c(x10), .d(new_n46_), .O(new_n75_));
  ...
  nand3  g037(.a(new_n67_), .b(new_n80_), .c(x11), .O(new_n81_));
  ...
  nand4  g045(.a(new_n88_), .b(x02), .c(new_n60_), .d(new_n59_), .O(new_n89_));
  ...
  nor2   g054(.a(new_n61_), .b(x01), .O(new_n98_));
  ...
  nand3  g075(.a(new_n96_), .b(new_n95_), .c(x20), .O(new_n119_));
  nor3   g076(.a(new_n119_), .b(new_n118_), .c(x14), .O(new_n120_));
  aoi22  g077(.a(new_n120_), .b(new_n117_), .c(new_n112_), .d(new_n111_), .O(new_n121_));
  oai21  g078(.a(new_n121_), .b(x00), .c(new_n108_), .O(z10));
  nor2   g079(.a(new_n100_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n95_), .c(x20), .d(new_n101_), .O(new_n124_));
  nand4  g081(.a(new_n111_), .b(new_n67_), .c(x21), .d(new_n104_), .O(new_n125_));
  oai21  g082(.a(new_n124_), .b(new_n116_), .c(new_n125_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n96_), .c(new_n59_), .O(new_n127_));
  ...
  nand4  g090(.a(new_n63_), .b(x17), .c(new_n61_), .d(new_n60_), .O(new_n134_));
  aoi21  g091(.a(new_n134_), .b(new_n133_), .c(x00), .O(new_n135_));
  oai21  g092(.a(new_n135_), .b(new_n132_), .c(new_n129_), .O(new_n136_));
  oai21  g093(.a(new_n136_), .b(new_n46_), .c(new_n108_), .O(z12));
  nand2  g094(.a(new_n47_), .b(x17), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z13));
  nand4  g096(.a(new_n46_), .b(new_n61_), .c(new_n60_), .d(new_n59_), .O(new_n140_));
  nand4  g097(.a(new_n63_), .b(new_n45_), .c(new_n44_), .d(new_n56_), .O(new_n141_));
  oai21  g098(.a(new_n141_), .b(new_n140_), .c(new_n108_), .O(z14));
  oai21  g099(.a(x10), .b(new_n60_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n61_), .c(new_n60_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n108_), .O(z15));
  aoi21  g103(.a(new_n67_), .b(x00), .c(new_n60_), .O(z16));
  nand2  g104(.a(new_n98_), .b(new_n59_), .O(new_n148_));
  nand2  g105(.a(new_n148_), .b(new_n108_), .O(z17));
endmodule
