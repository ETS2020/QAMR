...
module FAU ( 
  ...
  nor2   g64(.a(new_n97_), .b(new_n103_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n91_), .c(x20), .d(new_n90_), .O(new_n109_));
  ...
  nand3  g70(.a(new_n61_), .b(x17), .c(new_n48_), .O(new_n114_));
