...
module FAU ( 
  ...
  nor2   g011(.a(new_n54_), .b(x22), .O(z00));
  ...
  inv1   g016(.a(x22), .O(new_n60_));
  nor2   g017(.a(new_n60_), .b(x09), .O(new_n61_));
  inv1   g018(.a(new_n61_), .O(new_n62_));
  nand4  g019(.a(x09), .b(new_n50_), .c(new_n49_), .d(new_n48_), .O(new_n63_));
  nand4  g020(.a(new_n46_), .b(new_n45_), .c(new_n44_), .d(new_n47_), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(new_n62_), .O(z02));
  nand3  g022(.a(x02), .b(x01), .c(x00), .O(new_n66_));
  nand4  g023(.a(new_n60_), .b(x12), .c(x11), .d(x10), .O(new_n67_));
  oai21  g024(.a(new_n67_), .b(new_n66_), .c(new_n60_), .O(new_n68_));
  nand2  g025(.a(new_n68_), .b(new_n51_), .O(new_n69_));
  nor3   g026(.a(x02), .b(x01), .c(x00), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n46_), .c(x18), .d(new_n44_), .O(new_n71_));
  nand2  g028(.a(new_n71_), .b(new_n69_), .O(z03));
  inv1   g029(.a(x11), .O(new_n73_));
  inv1   g030(.a(x12), .O(new_n74_));
  inv1   g031(.a(new_n66_), .O(new_n75_));
  nand4  g032(.a(new_n75_), .b(new_n74_), .c(new_n73_), .d(x10), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(new_n60_), .c(x09), .O(z04));
  nand4  g034(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n47_), .O(z05));
  nand4  g036(.a(new_n60_), .b(x11), .c(x10), .d(new_n51_), .O(new_n80_));
  inv1   g037(.a(new_n80_), .O(new_n81_));
  nand4  g038(.a(new_n81_), .b(x02), .c(x01), .d(x00), .O(new_n82_));
  inv1   g039(.a(new_n82_), .O(z06));
  nand3  g040(.a(x10), .b(new_n51_), .c(x01), .O(new_n84_));
  nand3  g041(.a(new_n60_), .b(new_n74_), .c(x11), .O(new_n85_));
  oai22  g042(.a(new_n85_), .b(new_n84_), .c(new_n61_), .d(x01), .O(new_n86_));
  nand3  g043(.a(new_n86_), .b(x02), .c(x00), .O(new_n87_));
  inv1   g044(.a(new_n87_), .O(z07));
  inv1   g045(.a(x03), .O(new_n89_));
  nor2   g046(.a(new_n50_), .b(x01), .O(new_n90_));
  inv1   g047(.a(x04), .O(new_n91_));
  nor2   g048(.a(x05), .b(new_n91_), .O(new_n92_));
  nand4  g049(.a(new_n92_), .b(new_n90_), .c(new_n89_), .d(new_n48_), .O(new_n93_));
  nor3   g050(.a(x08), .b(x07), .c(x06), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(x19), .c(new_n45_), .d(x17), .O(new_n95_));
  oai21  g052(.a(new_n95_), .b(new_n93_), .c(new_n62_), .O(z08));
  inv1   g053(.a(x21), .O(new_n97_));
  nand4  g054(.a(x12), .b(new_n73_), .c(x02), .d(new_n49_), .O(new_n98_));
  ...
  nand3  g061(.a(new_n104_), .b(new_n103_), .c(new_n46_), .O(new_n105_));
  oai21  g062(.a(new_n102_), .b(new_n98_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n60_), .c(new_n97_), .d(new_n48_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n62_), .O(z09));
  nand3  g065(.a(new_n46_), .b(x18), .c(x01), .O(new_n109_));
  nand3  g066(.a(x22), .b(x21), .c(new_n103_), .O(new_n110_));
  nor2   g067(.a(new_n110_), .b(new_n109_), .O(new_n111_));
  nand2  g068(.a(x02), .b(new_n49_), .O(new_n112_));
  ...
  nand3  g074(.a(new_n60_), .b(new_n97_), .c(x20), .O(new_n118_));
  nor2   g075(.a(new_n118_), .b(new_n117_), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n115_), .c(new_n111_), .O(new_n120_));
  oai21  g077(.a(new_n120_), .b(x00), .c(new_n62_), .O(z10));
  nor2   g078(.a(x13), .b(new_n74_), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n90_), .c(new_n73_), .O(new_n123_));
  nand4  g080(.a(new_n104_), .b(x21), .c(new_n103_), .d(new_n46_), .O(new_n124_));
  ...
  nand3  g085(.a(new_n128_), .b(new_n60_), .c(new_n48_), .O(new_n129_));
  ...
  nand3  g091(.a(new_n46_), .b(x17), .c(new_n50_), .O(new_n135_));
  nand2  g092(.a(new_n135_), .b(new_n134_), .O(new_n136_));
  nand3  g093(.a(new_n136_), .b(new_n49_), .c(new_n48_), .O(new_n137_));
  ...
  nor2   g097(.a(new_n61_), .b(x19), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(x17), .c(new_n50_), .d(new_n49_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x00), .O(z13));
  nor2   g100(.a(new_n52_), .b(x10), .O(new_n144_));
  nand4  g101(.a(new_n144_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n145_));
  nor2   g102(.a(new_n145_), .b(x22), .O(z14));
  ...
  nand3  g106(.a(new_n149_), .b(new_n148_), .c(new_n62_), .O(z15));
  oai21  g107(.a(new_n49_), .b(x00), .c(new_n62_), .O(z16));
  nand4  g108(.a(new_n62_), .b(x02), .c(new_n49_), .d(new_n48_), .O(new_n152_));
