...
module FAU ( 
  ...
  nor2   g022(.a(new_n63_), .b(new_n62_), .O(new_n66_));
  nand3  g023(.a(new_n66_), .b(x04), .c(x02), .O(new_n67_));
  ...
  aoi21  g029(.a(new_n72_), .b(x04), .c(new_n63_), .O(z04));
  nand3  g030(.a(new_n66_), .b(x04), .c(x02), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(new_n59_), .c(new_n47_), .O(z05));
  nand2  g032(.a(x12), .b(new_n53_), .O(new_n76_));
  ...
  aoi21  g036(.a(new_n79_), .b(x04), .c(new_n63_), .O(z06));
  ...
  nor2   g051(.a(new_n94_), .b(new_n56_), .O(z08));
  ...
  nand4  g062(.a(new_n105_), .b(x18), .c(x04), .d(x01), .O(new_n106_));
  ...
  nand4  g076(.a(new_n119_), .b(new_n56_), .c(x18), .d(x01), .O(new_n120_));
  ...
  nand3  g080(.a(new_n123_), .b(new_n97_), .c(new_n62_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n54_), .O(z11));
  ...
  nand2  g090(.a(new_n133_), .b(new_n54_), .O(z12));
  ...
  aoi22  g095(.a(new_n54_), .b(x00), .c(x19), .d(new_n63_), .O(new_n139_));
  nand3  g096(.a(new_n66_), .b(new_n59_), .c(x04), .O(new_n140_));
  oai21  g097(.a(new_n139_), .b(x02), .c(new_n140_), .O(z15));
  aoi21  g098(.a(x04), .b(x00), .c(new_n63_), .O(z16));
