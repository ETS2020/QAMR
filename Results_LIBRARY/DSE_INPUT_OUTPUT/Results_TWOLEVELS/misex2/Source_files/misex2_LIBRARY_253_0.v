...
module FAU ( 
  ...
  nor2   g13(.a(new_n59_), .b(new_n58_), .O(z05));
  nand4  g14(.a(x11), .b(x10), .c(new_n51_), .d(x02), .O(new_n61_));
  nor3   g15(.a(new_n61_), .b(new_n48_), .c(z16), .O(z06));
  nand3  g16(.a(new_n55_), .b(x11), .c(x10), .O(new_n63_));
  oai21  g17(.a(new_n63_), .b(x09), .c(x01), .O(new_n64_));
  ...
  nand4  g24(.a(new_n71_), .b(x18), .c(x01), .d(z16), .O(new_n72_));
  inv1   g25(.a(new_n72_), .O(new_n73_));
  nand4  g26(.a(new_n73_), .b(new_n70_), .c(new_n69_), .d(new_n68_), .O(new_n74_));
  inv1   g27(.a(new_n74_), .O(z09));
  nor2   g28(.a(new_n70_), .b(new_n69_), .O(new_n76_));
  nand4  g29(.a(new_n76_), .b(new_n68_), .c(new_n71_), .d(x18), .O(new_n77_));
  aoi21  g30(.a(new_n77_), .b(x01), .c(x00), .O(z10));
  nand4  g31(.a(new_n73_), .b(new_n70_), .c(x21), .d(new_n68_), .O(new_n79_));
  ...
  inv1   g36(.a(new_n49_), .O(z13));
  inv1   g37(.a(x02), .O(new_n86_));
  aoi21  g38(.a(new_n58_), .b(x01), .c(new_n86_), .O(new_n87_));
  oai21  g39(.a(new_n87_), .b(z16), .c(new_n49_), .O(z15));
  zero   g40(.O(z00));
  zero   g41(.O(z01));
  zero   g42(.O(z02));
  zero   g43(.O(z08));
