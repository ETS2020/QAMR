...
module FAU ( 
  ...
  nand2  g001(.a(new_n44_), .b(x22), .O(new_n45_));
  ...
  inv1   g017(.a(x22), .O(new_n61_));
  nor2   g018(.a(x24), .b(new_n61_), .O(new_n62_));
  ...
  nand3  g052(.a(new_n88_), .b(x12), .c(new_n65_), .O(new_n96_));
  ...
  nor2   g057(.a(new_n52_), .b(new_n47_), .O(new_n101_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n61_), .c(new_n95_), .d(new_n46_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  inv1   g063(.a(x13), .O(new_n107_));
  nand3  g064(.a(new_n107_), .b(x12), .c(new_n65_), .O(new_n108_));
  inv1   g065(.a(new_n108_), .O(new_n109_));
  nor3   g066(.a(new_n98_), .b(new_n97_), .c(x14), .O(new_n110_));
  nand3  g067(.a(new_n61_), .b(new_n95_), .c(x20), .O(new_n111_));
  inv1   g068(.a(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n110_), .c(new_n109_), .d(new_n88_), .O(new_n113_));
  nor2   g070(.a(new_n95_), .b(x20), .O(new_n114_));
  nor2   g071(.a(new_n44_), .b(new_n61_), .O(new_n115_));
  nand4  g072(.a(new_n115_), .b(new_n114_), .c(new_n70_), .d(x01), .O(new_n116_));
  aoi21  g073(.a(new_n116_), .b(new_n113_), .c(x00), .O(z10));
  nand2  g074(.a(new_n109_), .b(new_n88_), .O(new_n118_));
  nand3  g075(.a(new_n114_), .b(new_n101_), .c(new_n53_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n122_), .b(new_n61_), .c(new_n46_), .O(new_n123_));
  nand2  g080(.a(new_n123_), .b(new_n45_), .O(z11));
  ...
  aoi21  g089(.a(new_n132_), .b(new_n61_), .c(x24), .O(z12));
