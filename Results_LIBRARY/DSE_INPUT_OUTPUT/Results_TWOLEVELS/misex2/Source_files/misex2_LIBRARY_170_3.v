...
module FAU ( 
  ...
  nor3   g031(.a(new_n74_), .b(x16), .c(new_n56_), .O(z05));
  ...
  aoi21  g035(.a(new_n78_), .b(new_n68_), .c(new_n63_), .O(z06));
  ...
  nand4  g050(.a(new_n93_), .b(new_n50_), .c(x17), .d(new_n86_), .O(new_n94_));
  ...
  nor2   g062(.a(new_n50_), .b(new_n63_), .O(new_n106_));
  nand3  g063(.a(new_n106_), .b(new_n105_), .c(new_n51_), .O(new_n107_));
  oai21  g064(.a(new_n104_), .b(new_n100_), .c(new_n107_), .O(new_n108_));
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n68_), .O(new_n109_));
  ...
  nand3  g070(.a(new_n102_), .b(new_n101_), .c(x12), .O(new_n114_));
  nor3   g071(.a(new_n114_), .b(x11), .c(new_n45_), .O(new_n115_));
  nand3  g072(.a(new_n97_), .b(new_n96_), .c(x20), .O(new_n116_));
  nor3   g073(.a(new_n116_), .b(new_n68_), .c(new_n103_), .O(new_n117_));
  aoi21  g074(.a(new_n117_), .b(new_n115_), .c(new_n113_), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n44_), .O(z10));
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n51_), .O(new_n120_));
  nand4  g077(.a(new_n99_), .b(new_n101_), .c(x12), .d(new_n98_), .O(new_n121_));
  nor2   g078(.a(new_n103_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n96_), .c(x20), .d(new_n68_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n121_), .c(new_n120_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n97_), .c(new_n62_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n44_), .O(z11));
  nand2  g083(.a(x10), .b(x02), .O(new_n127_));
  nand4  g084(.a(new_n127_), .b(new_n68_), .c(x01), .d(x00), .O(new_n128_));
  ...
  nand3  g088(.a(new_n131_), .b(new_n63_), .c(new_n62_), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n128_), .c(x24), .O(new_n133_));
  nand2  g090(.a(new_n133_), .b(x09), .O(new_n134_));
  inv1   g091(.a(new_n134_), .O(z12));
  nand2  g092(.a(new_n57_), .b(x17), .O(new_n136_));
  nor2   g093(.a(new_n136_), .b(x19), .O(z13));
  nand2  g094(.a(new_n57_), .b(new_n46_), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n50_), .c(new_n49_), .d(new_n56_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  oai21  g098(.a(x10), .b(new_n63_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n45_), .c(new_n63_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n44_), .O(z15));
  nand3  g102(.a(new_n68_), .b(x01), .c(new_n62_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n99_), .b(new_n62_), .O(new_n148_));
