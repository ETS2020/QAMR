...
module FAU ( 
  ...
  nand2  g35(.a(new_n47_), .b(x01), .O(new_n79_));
  nand3  g36(.a(new_n71_), .b(x11), .c(x10), .O(new_n80_));
  oai22  g37(.a(new_n80_), .b(new_n79_), .c(x17), .d(x01), .O(new_n81_));
  nand3  g38(.a(new_n81_), .b(x02), .c(x00), .O(new_n82_));
  inv1   g39(.a(new_n82_), .O(z07));
  inv1   g40(.a(x21), .O(new_n85_));
  inv1   g41(.a(x22), .O(new_n86_));
  nand4  g42(.a(x12), .b(new_n70_), .c(x02), .d(new_n60_), .O(new_n87_));
  ...
  nand4  g48(.a(new_n92_), .b(new_n61_), .c(x18), .d(x01), .O(new_n93_));
  oai21  g49(.a(new_n91_), .b(new_n87_), .c(new_n93_), .O(new_n94_));
  nand4  g50(.a(new_n94_), .b(new_n86_), .c(new_n85_), .d(new_n45_), .O(new_n95_));
  nand2  g51(.a(new_n95_), .b(new_n69_), .O(z09));
  nor3   g52(.a(new_n86_), .b(new_n85_), .c(x20), .O(new_n97_));
  nand4  g53(.a(new_n97_), .b(new_n61_), .c(x18), .d(x01), .O(new_n98_));
  nand3  g54(.a(new_n70_), .b(x02), .c(new_n60_), .O(new_n99_));
  inv1   g55(.a(new_n99_), .O(new_n100_));
  nand3  g56(.a(new_n44_), .b(x16), .c(x15), .O(new_n101_));
  nand3  g57(.a(new_n86_), .b(new_n85_), .c(x20), .O(new_n102_));
  nor2   g58(.a(new_n102_), .b(new_n101_), .O(new_n103_));
  nand4  g59(.a(new_n103_), .b(new_n100_), .c(new_n90_), .d(x12), .O(new_n104_));
  aoi21  g60(.a(new_n104_), .b(new_n98_), .c(x00), .O(z10));
  inv1   g61(.a(x18), .O(new_n106_));
  nor2   g62(.a(new_n106_), .b(new_n60_), .O(new_n107_));
  nand4  g63(.a(new_n107_), .b(x21), .c(new_n92_), .d(new_n61_), .O(new_n108_));
  nor2   g64(.a(new_n46_), .b(x01), .O(new_n109_));
  inv1   g65(.a(x13), .O(new_n110_));
  nand3  g66(.a(new_n110_), .b(x12), .c(new_n70_), .O(new_n111_));
  inv1   g67(.a(new_n111_), .O(new_n112_));
  inv1   g68(.a(x14), .O(new_n113_));
  nand3  g69(.a(new_n89_), .b(x15), .c(new_n113_), .O(new_n114_));
  inv1   g70(.a(new_n114_), .O(new_n115_));
  nand3  g71(.a(new_n85_), .b(x20), .c(new_n44_), .O(new_n116_));
  inv1   g72(.a(new_n116_), .O(new_n117_));
  nand4  g73(.a(new_n117_), .b(new_n115_), .c(new_n112_), .d(new_n109_), .O(new_n118_));
  nand2  g74(.a(new_n118_), .b(new_n108_), .O(new_n119_));
  nand3  g75(.a(new_n119_), .b(new_n86_), .c(new_n45_), .O(new_n120_));
  inv1   g76(.a(new_n120_), .O(z11));
  nand2  g77(.a(x10), .b(x02), .O(new_n122_));
  nand3  g78(.a(new_n122_), .b(x01), .c(x00), .O(new_n123_));
  nand2  g79(.a(new_n61_), .b(new_n46_), .O(new_n124_));
  nand4  g80(.a(new_n124_), .b(x23), .c(new_n60_), .d(new_n45_), .O(new_n125_));
  aoi21  g81(.a(new_n125_), .b(new_n123_), .c(x24), .O(new_n126_));
  nand2  g82(.a(new_n126_), .b(x09), .O(new_n127_));
  nand2  g83(.a(new_n127_), .b(new_n69_), .O(z12));
  nand4  g84(.a(new_n47_), .b(new_n46_), .c(new_n60_), .d(new_n45_), .O(new_n130_));
  inv1   g85(.a(new_n130_), .O(new_n131_));
  nand4  g86(.a(new_n131_), .b(new_n106_), .c(new_n44_), .d(new_n57_), .O(new_n132_));
  nor2   g87(.a(new_n132_), .b(x19), .O(z14));
  aoi21  g88(.a(new_n57_), .b(x01), .c(new_n46_), .O(new_n134_));
  aoi21  g89(.a(x19), .b(new_n46_), .c(x17), .O(new_n135_));
  oai22  g90(.a(new_n135_), .b(x01), .c(new_n134_), .d(new_n45_), .O(z15));
  oai21  g91(.a(new_n60_), .b(x00), .c(new_n69_), .O(z16));
  nand4  g92(.a(new_n44_), .b(x02), .c(new_n60_), .d(new_n45_), .O(new_n138_));
  inv1   g93(.a(new_n138_), .O(z17));
  zero   g94(.O(z08));
  zero   g95(.O(z13));
endmodule
