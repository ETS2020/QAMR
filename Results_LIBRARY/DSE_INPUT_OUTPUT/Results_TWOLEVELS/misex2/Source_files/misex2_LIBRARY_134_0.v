...
module FAU ( 
  ...
  nor2   g007(.a(x21), .b(x08), .O(new_n51_));
  ...
  nor2   g035(.a(new_n78_), .b(new_n73_), .O(z06));
  nand4  g036(.a(new_n52_), .b(new_n70_), .c(x11), .d(x10), .O(new_n80_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n44_), .d(new_n73_), .O(new_n90_));
  ...
  nand3  g065(.a(new_n108_), .b(new_n96_), .c(new_n73_), .O(new_n109_));
  aoi21  g066(.a(new_n109_), .b(x08), .c(x21), .O(z09));
  nand3  g067(.a(new_n50_), .b(x18), .c(x01), .O(new_n111_));
  nor4   g068(.a(new_n111_), .b(new_n96_), .c(new_n84_), .d(x20), .O(new_n112_));
  nor4   g069(.a(new_n97_), .b(x13), .c(new_n70_), .d(x11), .O(new_n113_));
  ...
  aoi21  g073(.a(new_n116_), .b(new_n113_), .c(new_n112_), .O(new_n117_));
  oai21  g074(.a(new_n117_), .b(x00), .c(new_n52_), .O(z10));
  nand4  g075(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n50_), .O(new_n119_));
  nand2  g076(.a(x15), .b(new_n114_), .O(new_n120_));
  nand3  g077(.a(new_n84_), .b(x20), .c(new_n102_), .O(new_n121_));
  nor3   g078(.a(new_n121_), .b(new_n120_), .c(x13), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n99_), .c(new_n98_), .d(x08), .O(new_n123_));
  nand2  g080(.a(new_n123_), .b(new_n119_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n96_), .c(new_n73_), .O(new_n125_));
  ...
  oai21  g102(.a(new_n97_), .b(x00), .c(new_n52_), .O(z17));
endmodule
