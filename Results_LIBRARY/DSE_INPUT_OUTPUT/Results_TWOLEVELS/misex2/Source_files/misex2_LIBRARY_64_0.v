...
module FAU ( 
  ...
  inv1   g24(.a(x04), .O(new_n68_));
  nand2  g25(.a(new_n68_), .b(new_n47_), .O(new_n69_));
  ...
  nand4  g52(.a(new_n95_), .b(x12), .c(new_n70_), .d(x04), .O(new_n96_));
  ...
  nor3   g65(.a(new_n68_), .b(new_n48_), .c(x01), .O(new_n109_));
  inv1   g66(.a(x13), .O(new_n110_));
  nand3  g67(.a(new_n110_), .b(x12), .c(new_n70_), .O(new_n111_));
  inv1   g68(.a(new_n111_), .O(new_n112_));
  nor3   g69(.a(new_n98_), .b(new_n97_), .c(x14), .O(new_n113_));
  nand3  g70(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n114_));
  inv1   g71(.a(new_n114_), .O(new_n115_));
  nand4  g72(.a(new_n115_), .b(new_n113_), .c(new_n112_), .d(new_n109_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n108_), .c(x00), .O(z10));
  nand4  g74(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n62_), .O(new_n118_));
  nand2  g75(.a(new_n112_), .b(new_n95_), .O(new_n119_));
  nor2   g76(.a(new_n97_), .b(x14), .O(new_n120_));
  nand4  g77(.a(new_n120_), .b(new_n93_), .c(x20), .d(new_n98_), .O(new_n121_));
  oai21  g78(.a(new_n121_), .b(new_n119_), .c(new_n118_), .O(new_n122_));
  nand3  g79(.a(new_n122_), .b(new_n94_), .c(new_n46_), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n69_), .O(z11));
  aoi21  g81(.a(x10), .b(x02), .c(new_n47_), .O(new_n125_));
  ...
  nand2  g89(.a(new_n132_), .b(new_n69_), .O(z12));
  nand4  g90(.a(new_n62_), .b(x17), .c(new_n48_), .d(new_n46_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(x04), .c(x01), .O(z13));
  nand4  g92(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n136_));
  nor2   g93(.a(new_n136_), .b(x19), .O(z14));
  aoi21  g94(.a(x04), .b(new_n48_), .c(new_n125_), .O(new_n138_));
  nand4  g95(.a(x19), .b(x04), .c(new_n48_), .d(new_n47_), .O(new_n139_));
  oai21  g96(.a(new_n138_), .b(new_n46_), .c(new_n139_), .O(z15));
  oai21  g97(.a(new_n47_), .b(x00), .c(new_n69_), .O(z16));
  nand4  g98(.a(x04), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n142_));
