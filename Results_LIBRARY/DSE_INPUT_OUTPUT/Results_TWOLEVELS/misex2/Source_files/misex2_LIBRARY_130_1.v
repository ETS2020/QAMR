...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
    ...
    new_n116_, new_n118_, new_n120_, new_n122_, new_n123_;
  ...
  nand4  g14(.a(new_n57_), .b(x18), .c(new_n56_), .d(new_n45_), .O(new_n58_));
  nand2  g15(.a(new_n58_), .b(new_n44_), .O(new_n59_));
  nand2  g16(.a(new_n59_), .b(new_n55_), .O(new_n60_));
  ...
  nor3   g25(.a(new_n65_), .b(new_n52_), .c(new_n46_), .O(z05));
  inv1   g26(.a(x12), .O(new_n70_));
  aoi21  g27(.a(new_n70_), .b(new_n55_), .c(new_n64_), .O(new_n71_));
  nand4  g28(.a(new_n71_), .b(x10), .c(new_n46_), .d(x02), .O(new_n72_));
  aoi21  g29(.a(new_n72_), .b(x00), .c(new_n44_), .O(z06));
  nand3  g30(.a(new_n70_), .b(x11), .c(x10), .O(new_n74_));
  ...
  nand4  g43(.a(new_n86_), .b(new_n79_), .c(x17), .d(new_n78_), .O(new_n87_));
  nor2   g44(.a(new_n87_), .b(new_n57_), .O(z08));
  inv1   g45(.a(x16), .O(new_n89_));
  inv1   g46(.a(x21), .O(new_n90_));
  inv1   g47(.a(x13), .O(new_n91_));
  inv1   g48(.a(x14), .O(new_n92_));
  nand4  g49(.a(new_n64_), .b(x02), .c(new_n44_), .d(new_n55_), .O(new_n93_));
  ...
  nor3   g56(.a(new_n99_), .b(x11), .c(new_n45_), .O(new_n100_));
  ...
  aoi21  g61(.a(new_n104_), .b(new_n44_), .c(x00), .O(z10));
  ...
  oai21  g66(.a(new_n52_), .b(new_n45_), .c(x01), .O(new_n110_));
  nand2  g67(.a(x23), .b(x19), .O(new_n111_));
  oai21  g68(.a(x19), .b(new_n56_), .c(new_n111_), .O(new_n112_));
  and2   g69(.a(x23), .b(x02), .O(new_n113_));
  aoi21  g70(.a(new_n112_), .b(new_n45_), .c(new_n113_), .O(new_n114_));
  oai21  g71(.a(new_n114_), .b(x00), .c(new_n110_), .O(new_n115_));
  nand3  g72(.a(new_n115_), .b(new_n109_), .c(x09), .O(new_n116_));
  oai21  g73(.a(new_n44_), .b(x00), .c(new_n116_), .O(z12));
  nand3  g74(.a(new_n57_), .b(x17), .c(new_n45_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n44_), .c(x00), .O(z13));
  nand4  g76(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n120_));
