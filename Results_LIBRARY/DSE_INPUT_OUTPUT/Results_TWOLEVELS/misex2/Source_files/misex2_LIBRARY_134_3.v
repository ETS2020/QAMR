...
module FAU ( 
  ...
  nand2  g007(.a(x21), .b(x08), .O(new_n51_));
  ...
  nand4  g030(.a(new_n51_), .b(x10), .c(x09), .d(x02), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(new_n44_), .c(new_n73_), .O(z05));
  ...
  nand4  g036(.a(new_n51_), .b(new_n70_), .c(x11), .d(x10), .O(new_n80_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n73_), .O(new_n105_));
  ...
  nand2  g069(.a(new_n112_), .b(new_n96_), .O(new_n113_));
  ...
  nor2   g076(.a(new_n49_), .b(x08), .O(new_n120_));
  nor2   g077(.a(new_n94_), .b(x20), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n120_), .c(new_n50_), .d(x01), .O(new_n122_));
  nor2   g079(.a(new_n98_), .b(x14), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n94_), .c(x20), .d(new_n99_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n113_), .c(new_n122_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n95_), .c(new_n73_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n44_), .c(new_n73_), .O(new_n134_));
  ...
  nand2  g094(.a(new_n44_), .b(new_n73_), .O(new_n138_));
  oai21  g095(.a(new_n132_), .b(new_n138_), .c(new_n51_), .O(z13));
  nand4  g096(.a(new_n58_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n140_));
  ...
  oai21  g102(.a(new_n44_), .b(x00), .c(new_n51_), .O(z16));
  nand2  g103(.a(new_n96_), .b(new_n73_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n51_), .O(z17));
endmodule
