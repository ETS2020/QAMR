...
module FAU ( 
  ...
  aoi21  g33(.a(new_n76_), .b(x00), .c(new_n52_), .O(z06));
  ...
  nor3   g48(.a(new_n91_), .b(x11), .c(new_n53_), .O(new_n92_));
  ...
  aoi21  g52(.a(new_n95_), .b(new_n52_), .c(x00), .O(z09));
  inv1   g53(.a(x21), .O(new_n97_));
  inv1   g54(.a(x15), .O(new_n98_));
  nand4  g55(.a(new_n69_), .b(x02), .c(new_n52_), .d(new_n62_), .O(new_n99_));
  ...
  nand4  g59(.a(new_n102_), .b(new_n97_), .c(x20), .d(x16), .O(new_n103_));
  nor2   g60(.a(new_n103_), .b(x22), .O(z10));
  inv1   g61(.a(x16), .O(new_n105_));
  nand4  g62(.a(new_n102_), .b(new_n97_), .c(x20), .d(new_n105_), .O(new_n106_));
  nor2   g63(.a(new_n106_), .b(x22), .O(z11));
  inv1   g64(.a(x24), .O(new_n108_));
  aoi21  g65(.a(x10), .b(x02), .c(new_n52_), .O(new_n109_));
  oai21  g66(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g67(.a(new_n64_), .b(x17), .c(new_n53_), .O(new_n111_));
  aoi21  g68(.a(new_n111_), .b(new_n110_), .c(x00), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n109_), .c(new_n108_), .O(new_n113_));
  oai22  g70(.a(new_n113_), .b(new_n46_), .c(new_n52_), .d(x00), .O(z12));
  nand2  g71(.a(new_n47_), .b(x17), .O(new_n115_));
  nor2   g72(.a(new_n115_), .b(x19), .O(z13));
  nand4  g73(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n117_));
  nor2   g74(.a(new_n117_), .b(x19), .O(z14));
  aoi21  g75(.a(new_n57_), .b(x01), .c(new_n53_), .O(new_n119_));
  nand3  g76(.a(x19), .b(new_n53_), .c(new_n52_), .O(new_n120_));
  oai21  g77(.a(new_n119_), .b(new_n62_), .c(new_n120_), .O(z15));
  aoi21  g78(.a(new_n53_), .b(new_n52_), .c(x00), .O(z17));
  zero   g79(.O(z16));
endmodule
