...
module FAU ( 
  ...
  nand3  g035(.a(x21), .b(x12), .c(new_n51_), .O(new_n79_));
  ...
  aoi21  g052(.a(new_n95_), .b(new_n88_), .c(x05), .O(z08));
  inv1   g053(.a(x00), .O(new_n97_));
  ...
  nand4  g064(.a(new_n107_), .b(new_n98_), .c(new_n88_), .d(new_n97_), .O(new_n108_));
  ...
  nand3  g073(.a(new_n98_), .b(new_n88_), .c(x20), .O(new_n117_));
  ...
  nand2  g077(.a(new_n115_), .b(new_n99_), .O(new_n121_));
  nor2   g078(.a(new_n88_), .b(x20), .O(new_n122_));
  nand3  g079(.a(new_n122_), .b(new_n111_), .c(new_n50_), .O(new_n123_));
  nor2   g080(.a(new_n101_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n88_), .c(x20), .d(new_n102_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n121_), .c(new_n123_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n98_), .c(new_n97_), .O(new_n127_));
  ...
  nand3  g091(.a(new_n134_), .b(new_n44_), .c(new_n97_), .O(new_n135_));
  ...
  oai21  g095(.a(new_n133_), .b(new_n89_), .c(new_n52_), .O(z13));
  nand4  g096(.a(new_n61_), .b(new_n46_), .c(new_n45_), .d(new_n44_), .O(new_n140_));
  ...
  nand2  g103(.a(new_n99_), .b(new_n97_), .O(new_n147_));
  nand2  g104(.a(new_n147_), .b(new_n52_), .O(z17));
endmodule
