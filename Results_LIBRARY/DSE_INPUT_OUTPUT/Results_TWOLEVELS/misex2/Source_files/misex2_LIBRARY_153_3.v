...
module FAU ( 
  ...
  nand3  g22(.a(x02), .b(new_n62_), .c(x00), .O(new_n69_));
  inv1   g23(.a(new_n69_), .O(z07));
  inv1   g24(.a(x08), .O(new_n71_));
  inv1   g25(.a(x05), .O(new_n72_));
  inv1   g26(.a(x06), .O(new_n73_));
  inv1   g27(.a(x03), .O(new_n74_));
  nand4  g28(.a(new_n74_), .b(x02), .c(new_n62_), .d(new_n61_), .O(new_n75_));
  ...
  nor2   g33(.a(new_n79_), .b(new_n55_), .O(z08));
  ...
  nor2   g44(.a(new_n45_), .b(new_n62_), .O(new_n91_));
  nand3  g45(.a(new_n91_), .b(new_n90_), .c(new_n55_), .O(new_n92_));
  oai21  g46(.a(new_n89_), .b(new_n85_), .c(new_n92_), .O(new_n93_));
  nand4  g47(.a(new_n93_), .b(new_n82_), .c(new_n81_), .d(new_n61_), .O(new_n94_));
  inv1   g48(.a(new_n94_), .O(z09));
  nor3   g49(.a(new_n82_), .b(new_n81_), .c(x20), .O(new_n96_));
  nand4  g50(.a(new_n96_), .b(new_n55_), .c(x18), .d(x01), .O(new_n97_));
  ...
  nand4  g57(.a(new_n91_), .b(x21), .c(new_n90_), .d(new_n55_), .O(new_n104_));
  ...
  nand3  g61(.a(new_n107_), .b(new_n82_), .c(new_n61_), .O(new_n108_));
  inv1   g62(.a(new_n108_), .O(z11));
  oai21  g63(.a(x19), .b(x02), .c(x23), .O(new_n110_));
  nand3  g64(.a(new_n55_), .b(x17), .c(new_n46_), .O(new_n111_));
  aoi21  g65(.a(new_n111_), .b(new_n110_), .c(x24), .O(new_n112_));
  nand4  g66(.a(new_n112_), .b(x09), .c(new_n62_), .d(new_n61_), .O(new_n113_));
  nand2  g67(.a(new_n113_), .b(new_n53_), .O(z12));
  inv1   g68(.a(new_n48_), .O(new_n115_));
  oai21  g69(.a(new_n111_), .b(new_n115_), .c(new_n53_), .O(z13));
  nand4  g70(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n117_));
  nor2   g71(.a(new_n117_), .b(x19), .O(z14));
  nor2   g72(.a(x19), .b(x00), .O(new_n119_));
  nor3   g73(.a(new_n119_), .b(x02), .c(x01), .O(z15));
  nor2   g74(.a(new_n62_), .b(x00), .O(z16));
  nand2  g75(.a(new_n48_), .b(x02), .O(new_n122_));
