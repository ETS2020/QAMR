...
module FAU ( 
  ...
  nand2  g24(.a(new_n46_), .b(x02), .O(new_n68_));
  ...
  aoi21  g30(.a(x12), .b(new_n52_), .c(new_n66_), .O(new_n74_));
  ...
  oai21  g34(.a(new_n77_), .b(new_n68_), .c(x00), .O(new_n78_));
  ...
  nand2  g48(.a(new_n66_), .b(x02), .O(new_n92_));
  nor4   g49(.a(new_n92_), .b(x14), .c(x13), .d(new_n67_), .O(new_n93_));
