...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n50_, new_n52_,
    ...
    new_n69_, new_n72_, new_n73_, new_n74_, new_n75_, new_n78_, new_n79_,
    ...
    new_n123_, new_n126_, new_n128_, new_n129_, new_n132_;
  ...
  nor3   g17(.a(new_n60_), .b(x09), .c(new_n45_), .O(new_n61_));
  oai21  g18(.a(new_n61_), .b(new_n55_), .c(x00), .O(new_n62_));
  inv1   g19(.a(x19), .O(new_n63_));
  nor2   g20(.a(x02), .b(x01), .O(new_n64_));
  nand4  g21(.a(new_n64_), .b(new_n63_), .c(x18), .d(new_n53_), .O(new_n65_));
  ...
  nand4  g42(.a(new_n85_), .b(new_n54_), .c(x17), .d(new_n78_), .O(new_n86_));
  nor2   g43(.a(new_n86_), .b(new_n63_), .O(z08));
  inv1   g44(.a(x21), .O(new_n88_));
  inv1   g45(.a(x22), .O(new_n89_));
  nor2   g46(.a(new_n45_), .b(x01), .O(new_n90_));
  nand3  g47(.a(new_n90_), .b(x12), .c(new_n72_), .O(new_n91_));
  ...
  nand4  g56(.a(new_n99_), .b(new_n89_), .c(new_n88_), .d(new_n44_), .O(new_n100_));
  ...
  nor2   g60(.a(x13), .b(new_n73_), .O(new_n104_));
  nand3  g61(.a(new_n104_), .b(new_n90_), .c(new_n72_), .O(new_n105_));
  nor3   g62(.a(new_n93_), .b(new_n92_), .c(x14), .O(new_n106_));
  nand4  g63(.a(new_n106_), .b(new_n89_), .c(new_n88_), .d(x20), .O(new_n107_));
  or2    g64(.a(new_n107_), .b(new_n105_), .O(new_n108_));
  aoi21  g65(.a(new_n108_), .b(new_n103_), .c(x00), .O(z10));
  nand4  g66(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n63_), .O(new_n110_));
  nor2   g67(.a(new_n92_), .b(x14), .O(new_n111_));
  nand4  g68(.a(new_n111_), .b(new_n88_), .c(x20), .d(new_n93_), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n105_), .c(new_n110_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n89_), .c(new_n44_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n63_), .b(x17), .c(new_n45_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n118_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n55_), .c(new_n44_), .O(new_n121_));
  ...
  nand4  g82(.a(new_n47_), .b(new_n52_), .c(new_n46_), .d(new_n45_), .O(new_n126_));
  aoi21  g83(.a(new_n126_), .b(new_n44_), .c(x01), .O(z14));
  aoi21  g84(.a(x19), .b(new_n45_), .c(x00), .O(new_n128_));
  nand2  g85(.a(new_n116_), .b(x00), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(x01), .c(new_n129_), .O(z15));
  nor2   g87(.a(new_n55_), .b(x00), .O(z16));
  nand3  g88(.a(x02), .b(new_n55_), .c(new_n44_), .O(new_n132_));
