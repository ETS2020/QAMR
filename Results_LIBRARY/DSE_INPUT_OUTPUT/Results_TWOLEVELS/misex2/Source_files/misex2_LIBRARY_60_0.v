...
module FAU ( 
  ...
  wire new_n46_, new_n47_, new_n48_, new_n50_, new_n51_, new_n52_, new_n53_,
    new_n54_, new_n55_, new_n58_, new_n60_, new_n62_, new_n63_, new_n64_,
  ...
  nand4  g14(.a(x11), .b(x10), .c(new_n52_), .d(x02), .O(new_n60_));
  nor3   g15(.a(new_n60_), .b(new_n47_), .c(new_n46_), .O(z06));
  nand3  g16(.a(new_n51_), .b(x11), .c(x10), .O(new_n62_));
  ...
  nand4  g24(.a(new_n70_), .b(x18), .c(x01), .d(new_n46_), .O(new_n71_));
  ...
  nor2   g34(.a(new_n80_), .b(new_n46_), .O(z12));
  inv1   g35(.a(x02), .O(new_n83_));
  aoi21  g36(.a(new_n58_), .b(x01), .c(new_n83_), .O(new_n84_));
  oai21  g37(.a(new_n84_), .b(new_n46_), .c(new_n48_), .O(z15));
  nor2   g38(.a(new_n47_), .b(x00), .O(z16));
  zero   g39(.O(z00));
  zero   g40(.O(z01));
  zero   g41(.O(z08));
  zero   g42(.O(z14));
  inv1   g43(.a(new_n48_), .O(z13));
