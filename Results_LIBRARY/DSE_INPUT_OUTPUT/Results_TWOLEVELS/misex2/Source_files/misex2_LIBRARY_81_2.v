...
module FAU ( 
  ...
  nor2   g31(.a(x09), .b(new_n48_), .O(new_n75_));
  nor2   g32(.a(x12), .b(new_n67_), .O(new_n76_));
  nand4  g33(.a(new_n76_), .b(new_n75_), .c(x10), .d(x01), .O(new_n77_));
  ...
  nand4  g46(.a(x12), .b(new_n67_), .c(x02), .d(new_n47_), .O(new_n90_));
  ...
  nand4  g55(.a(new_n98_), .b(new_n89_), .c(new_n88_), .d(new_n46_), .O(new_n99_));
  inv1   g56(.a(new_n99_), .O(z09));
  nand4  g57(.a(new_n93_), .b(x12), .c(new_n67_), .d(x02), .O(new_n101_));
  ...
  nand4  g63(.a(new_n106_), .b(new_n96_), .c(new_n95_), .d(new_n46_), .O(new_n107_));
  nand2  g64(.a(new_n107_), .b(new_n105_), .O(z10));
  inv1   g65(.a(x20), .O(new_n109_));
  nand4  g66(.a(new_n95_), .b(x21), .c(new_n109_), .d(new_n62_), .O(new_n110_));
  nor2   g67(.a(new_n48_), .b(x01), .O(new_n111_));
  inv1   g68(.a(x12), .O(new_n112_));
  nor2   g69(.a(x13), .b(new_n112_), .O(new_n113_));
  nand3  g70(.a(new_n113_), .b(new_n111_), .c(new_n67_), .O(new_n114_));
  nor2   g71(.a(new_n91_), .b(x14), .O(new_n115_));
  nor2   g72(.a(x21), .b(new_n109_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n115_), .c(new_n92_), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n114_), .c(new_n110_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n89_), .c(new_n46_), .O(new_n119_));
  ...
  nand3  g85(.a(new_n48_), .b(new_n47_), .c(new_n46_), .O(new_n129_));
  nor3   g86(.a(new_n129_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g87(.a(new_n51_), .b(new_n45_), .c(new_n44_), .d(new_n58_), .O(new_n131_));
  nor2   g88(.a(new_n131_), .b(x19), .O(z14));
  nand2  g89(.a(x19), .b(new_n48_), .O(new_n133_));
  aoi21  g90(.a(new_n133_), .b(new_n46_), .c(x01), .O(new_n134_));
  or2    g91(.a(new_n134_), .b(new_n122_), .O(z15));
