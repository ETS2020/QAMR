...
module FAU ( 
  ...
  wire new_n44_, new_n45_, new_n46_, new_n47_, new_n48_, new_n49_, new_n50_,
    ...
    new_n117_, new_n118_, new_n121_, new_n123_, new_n124_, new_n126_;
  ...
  oai21  g23(.a(new_n66_), .b(new_n64_), .c(new_n63_), .O(z03));
  ...
  nor3   g29(.a(new_n69_), .b(new_n57_), .c(new_n65_), .O(z05));
  nand4  g30(.a(x11), .b(x10), .c(new_n65_), .d(x02), .O(new_n74_));
  ...
  nand4  g43(.a(new_n86_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n87_));
  ...
  nor2   g48(.a(new_n91_), .b(new_n60_), .O(z08));
  inv1   g49(.a(x15), .O(new_n93_));
  inv1   g50(.a(x16), .O(new_n94_));
  inv1   g51(.a(x13), .O(new_n95_));
  inv1   g52(.a(x14), .O(new_n96_));
  nand3  g53(.a(new_n96_), .b(new_n95_), .c(x12), .O(new_n97_));
  nor3   g54(.a(new_n97_), .b(x11), .c(new_n48_), .O(new_n98_));
  inv1   g55(.a(x21), .O(new_n99_));
  inv1   g56(.a(x22), .O(new_n100_));
  nand3  g57(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n101_));
  inv1   g58(.a(new_n101_), .O(new_n102_));
  nand4  g59(.a(new_n102_), .b(new_n98_), .c(new_n94_), .d(new_n93_), .O(new_n103_));
  aoi21  g60(.a(new_n103_), .b(new_n47_), .c(x00), .O(z09));
  nand4  g61(.a(new_n102_), .b(new_n98_), .c(x16), .d(x15), .O(new_n105_));
  aoi21  g62(.a(new_n105_), .b(new_n47_), .c(x00), .O(z10));
  nand4  g63(.a(new_n68_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n107_));
  inv1   g64(.a(new_n107_), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(new_n96_), .c(new_n95_), .d(x12), .O(new_n109_));
  nor2   g66(.a(new_n109_), .b(new_n93_), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n99_), .c(x20), .d(new_n94_), .O(new_n111_));
  nor2   g68(.a(new_n111_), .b(x22), .O(z11));
  inv1   g69(.a(x24), .O(new_n113_));
  aoi21  g70(.a(x10), .b(x02), .c(new_n47_), .O(new_n114_));
  oai21  g71(.a(x19), .b(x02), .c(x23), .O(new_n115_));
  nand3  g72(.a(new_n60_), .b(x17), .c(new_n48_), .O(new_n116_));
  aoi21  g73(.a(new_n116_), .b(new_n115_), .c(x00), .O(new_n117_));
  oai21  g74(.a(new_n117_), .b(new_n114_), .c(new_n113_), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n65_), .c(new_n81_), .O(z12));
  nor3   g76(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g77(.a(new_n54_), .b(new_n57_), .c(new_n65_), .d(new_n48_), .O(new_n121_));
  aoi21  g78(.a(new_n121_), .b(new_n47_), .c(x00), .O(z14));
  oai21  g79(.a(new_n57_), .b(new_n46_), .c(x01), .O(new_n123_));
  oai21  g80(.a(x19), .b(x00), .c(new_n48_), .O(new_n124_));
  nand2  g81(.a(new_n124_), .b(new_n123_), .O(z15));
  nand3  g82(.a(x02), .b(new_n47_), .c(new_n46_), .O(new_n126_));
