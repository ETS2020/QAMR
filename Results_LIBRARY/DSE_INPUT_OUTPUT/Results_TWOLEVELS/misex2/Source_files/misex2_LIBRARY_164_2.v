...
module FAU ( 
  ...
  nand4  g017(.a(new_n47_), .b(new_n44_), .c(new_n60_), .d(x09), .O(new_n61_));
  nor3   g018(.a(new_n61_), .b(x19), .c(x18), .O(z02));
  inv1   g019(.a(x00), .O(new_n63_));
  inv1   g020(.a(x01), .O(new_n64_));
  nand3  g021(.a(new_n54_), .b(new_n64_), .c(new_n63_), .O(new_n65_));
  nand3  g022(.a(new_n57_), .b(x18), .c(new_n44_), .O(new_n66_));
  nand4  g023(.a(x08), .b(x02), .c(x01), .d(x00), .O(new_n67_));
  ...
  aoi21  g032(.a(new_n75_), .b(x08), .c(new_n64_), .O(z05));
  nor3   g033(.a(new_n70_), .b(new_n60_), .c(x09), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x08), .c(x02), .d(x01), .O(new_n78_));
  nor2   g035(.a(new_n78_), .b(new_n63_), .O(z06));
  nand2  g036(.a(new_n46_), .b(x08), .O(new_n80_));
  ...
  nand2  g042(.a(x02), .b(new_n63_), .O(new_n86_));
  inv1   g043(.a(x05), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(x04), .O(new_n88_));
  nor3   g045(.a(new_n88_), .b(new_n86_), .c(x03), .O(new_n89_));
  nand3  g046(.a(x19), .b(new_n45_), .c(x17), .O(new_n90_));
  nor3   g047(.a(new_n90_), .b(x07), .c(x06), .O(new_n91_));
  nand2  g048(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  aoi21  g049(.a(new_n92_), .b(new_n64_), .c(x08), .O(z08));
  inv1   g050(.a(x21), .O(new_n94_));
  inv1   g051(.a(x22), .O(new_n95_));
  nand4  g052(.a(x12), .b(new_n70_), .c(x02), .d(new_n64_), .O(new_n96_));
  ...
  nand3  g059(.a(new_n102_), .b(new_n101_), .c(new_n57_), .O(new_n103_));
  oai21  g060(.a(new_n100_), .b(new_n96_), .c(new_n103_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n95_), .c(new_n94_), .d(new_n63_), .O(new_n105_));
  nand2  g062(.a(new_n105_), .b(new_n53_), .O(z09));
  nand3  g063(.a(new_n57_), .b(x18), .c(x01), .O(new_n107_));
  nand3  g064(.a(x22), .b(x21), .c(new_n101_), .O(new_n108_));
  nor2   g065(.a(new_n108_), .b(new_n107_), .O(new_n109_));
  nand2  g066(.a(x02), .b(new_n64_), .O(new_n110_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n53_), .O(z10));
  nor2   g076(.a(new_n54_), .b(x01), .O(new_n120_));
  nor2   g077(.a(x13), .b(new_n81_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n70_), .O(new_n122_));
  nand4  g079(.a(new_n102_), .b(x21), .c(new_n101_), .d(new_n57_), .O(new_n123_));
  nor2   g080(.a(new_n97_), .b(x14), .O(new_n124_));
  nor2   g081(.a(x21), .b(new_n101_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n124_), .c(new_n98_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n122_), .c(new_n123_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n95_), .c(new_n63_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n53_), .O(z11));
  ...
  nand3  g090(.a(new_n57_), .b(x17), .c(new_n54_), .O(new_n134_));
  ...
  nand4  g098(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n60_), .O(new_n142_));
  nor2   g099(.a(new_n142_), .b(x19), .O(z14));
  oai21  g100(.a(x10), .b(new_n64_), .c(x02), .O(new_n144_));
  nand2  g101(.a(new_n144_), .b(x00), .O(new_n145_));
  nand3  g102(.a(x19), .b(new_n54_), .c(new_n64_), .O(new_n146_));
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n53_), .O(z15));
  nand3  g104(.a(x08), .b(x01), .c(new_n63_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  nand2  g106(.a(new_n55_), .b(x02), .O(new_n150_));
