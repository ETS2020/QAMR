...
module FAU ( 
  ...
  nor2   g017(.a(new_n60_), .b(x24), .O(z02));
  inv1   g018(.a(x24), .O(new_n62_));
  ...
  nor3   g032(.a(new_n72_), .b(new_n47_), .c(new_n68_), .O(z05));
  nand4  g033(.a(x11), .b(x10), .c(new_n68_), .d(x02), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n49_), .c(new_n48_), .O(z06));
  ...
  nand2  g039(.a(x24), .b(new_n49_), .O(new_n83_));
  ...
  nor2   g046(.a(new_n46_), .b(x18), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x17), .O(new_n91_));
  aoi21  g048(.a(new_n91_), .b(new_n62_), .c(x01), .O(z08));
  inv1   g049(.a(x21), .O(new_n93_));
  inv1   g050(.a(x22), .O(new_n94_));
  inv1   g051(.a(x20), .O(new_n95_));
  nor2   g052(.a(new_n45_), .b(new_n49_), .O(new_n96_));
  nand3  g053(.a(new_n96_), .b(new_n95_), .c(new_n46_), .O(new_n97_));
  nor2   g054(.a(new_n50_), .b(x01), .O(new_n98_));
  nor2   g055(.a(x13), .b(new_n79_), .O(new_n99_));
  nand3  g056(.a(new_n99_), .b(new_n98_), .c(new_n71_), .O(new_n100_));
  inv1   g057(.a(x16), .O(new_n101_));
  nor2   g058(.a(x15), .b(x14), .O(new_n102_));
  nand4  g059(.a(new_n102_), .b(new_n62_), .c(x20), .d(new_n101_), .O(new_n103_));
  oai21  g060(.a(new_n103_), .b(new_n100_), .c(new_n97_), .O(new_n104_));
  nand4  g061(.a(new_n104_), .b(new_n94_), .c(new_n93_), .d(new_n48_), .O(new_n105_));
  inv1   g062(.a(new_n105_), .O(z09));
  nand2  g063(.a(x02), .b(new_n49_), .O(new_n107_));
  inv1   g064(.a(x13), .O(new_n108_));
  nand3  g065(.a(new_n108_), .b(x12), .c(new_n71_), .O(new_n109_));
  nor2   g066(.a(new_n109_), .b(new_n107_), .O(new_n110_));
  nand3  g067(.a(new_n46_), .b(x18), .c(x01), .O(new_n111_));
  nand3  g068(.a(x22), .b(x21), .c(new_n95_), .O(new_n112_));
  ...
  aoi21  g074(.a(new_n117_), .b(new_n110_), .c(new_n113_), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n83_), .O(z10));
  nand4  g076(.a(new_n96_), .b(x21), .c(new_n95_), .d(new_n46_), .O(new_n120_));
  inv1   g077(.a(x15), .O(new_n121_));
  nor2   g078(.a(x16), .b(new_n121_), .O(new_n122_));
  nor2   g079(.a(x24), .b(x21), .O(new_n123_));
  nand4  g080(.a(new_n123_), .b(new_n122_), .c(x20), .d(new_n114_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n100_), .c(new_n120_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n94_), .c(new_n48_), .O(new_n126_));
  ...
  nand3  g088(.a(new_n46_), .b(x17), .c(new_n50_), .O(new_n132_));
  aoi21  g089(.a(new_n132_), .b(new_n131_), .c(x01), .O(new_n133_));
  aoi21  g090(.a(new_n133_), .b(new_n48_), .c(new_n130_), .O(new_n134_));
  oai21  g091(.a(new_n134_), .b(new_n68_), .c(new_n83_), .O(z12));
  nand4  g092(.a(new_n46_), .b(x17), .c(new_n50_), .d(new_n48_), .O(new_n136_));
  aoi21  g093(.a(new_n136_), .b(new_n62_), .c(x01), .O(z13));
  nor3   g094(.a(x09), .b(x02), .c(x00), .O(new_n138_));
  nor2   g095(.a(x19), .b(x18), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n138_), .c(new_n44_), .d(new_n47_), .O(new_n140_));
  aoi21  g097(.a(new_n140_), .b(new_n62_), .c(x01), .O(z14));
  aoi21  g098(.a(new_n47_), .b(x01), .c(new_n50_), .O(new_n142_));
  aoi21  g099(.a(x19), .b(new_n50_), .c(x24), .O(new_n143_));
  oai22  g100(.a(new_n143_), .b(x01), .c(new_n142_), .d(new_n48_), .O(z15));
  oai21  g101(.a(new_n49_), .b(x00), .c(new_n83_), .O(z16));
  aoi21  g102(.a(new_n85_), .b(new_n62_), .c(x01), .O(z17));
endmodule
