...
module FAU ( 
  ...
  nand4  g015(.a(new_n45_), .b(new_n58_), .c(new_n57_), .d(new_n50_), .O(new_n59_));
  nor2   g016(.a(new_n59_), .b(x10), .O(new_n60_));
  nand4  g017(.a(new_n60_), .b(x09), .c(new_n46_), .d(new_n56_), .O(new_n61_));
  ...
  nand4  g026(.a(new_n69_), .b(new_n58_), .c(x18), .d(new_n50_), .O(new_n70_));
  ...
  nand2  g040(.a(new_n83_), .b(new_n45_), .O(z06));
  nand3  g041(.a(new_n73_), .b(x11), .c(x10), .O(new_n85_));
  oai21  g042(.a(new_n85_), .b(x09), .c(x01), .O(new_n86_));
  nand3  g043(.a(new_n86_), .b(x02), .c(x00), .O(new_n87_));
  nand2  g044(.a(new_n87_), .b(new_n45_), .O(z07));
  inv1   g045(.a(x14), .O(new_n89_));
  ...
  aoi21  g053(.a(new_n96_), .b(new_n89_), .c(x08), .O(z08));
  ...
  nor2   g063(.a(new_n57_), .b(new_n56_), .O(new_n107_));
  ...
  nand4  g068(.a(new_n45_), .b(x22), .c(x21), .d(new_n106_), .O(new_n112_));
  inv1   g069(.a(new_n112_), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n58_), .c(x18), .d(x01), .O(new_n114_));
  ...
  nand4  g079(.a(new_n100_), .b(new_n116_), .c(x12), .d(new_n72_), .O(new_n123_));
  nand4  g080(.a(new_n107_), .b(x21), .c(new_n106_), .d(new_n58_), .O(new_n124_));
  nor2   g081(.a(new_n102_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n123_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n99_), .c(new_n76_), .O(new_n128_));
  ...
  nand3  g090(.a(new_n58_), .b(x17), .c(new_n46_), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n133_), .O(new_n135_));
  nand3  g092(.a(new_n135_), .b(new_n56_), .c(new_n76_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n134_), .b(new_n90_), .c(new_n45_), .O(z13));
  nand3  g097(.a(new_n51_), .b(new_n50_), .c(new_n66_), .O(new_n141_));
  oai21  g098(.a(new_n141_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g099(.a(x10), .b(new_n56_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n56_), .O(new_n145_));
  aoi21  g102(.a(new_n145_), .b(new_n144_), .c(new_n63_), .O(z15));
  nor3   g103(.a(new_n63_), .b(new_n56_), .c(x00), .O(z16));
  oai21  g104(.a(new_n115_), .b(x00), .c(new_n45_), .O(z17));
endmodule
