...
module FAU ( 
  ...
  nand4  g33(.a(new_n73_), .b(new_n70_), .c(x21), .d(new_n68_), .O(new_n78_));
  ...
  aoi21  g39(.a(new_n56_), .b(x01), .c(new_n83_), .O(new_n84_));
  oai21  g40(.a(new_n84_), .b(new_n44_), .c(new_n46_), .O(z15));
