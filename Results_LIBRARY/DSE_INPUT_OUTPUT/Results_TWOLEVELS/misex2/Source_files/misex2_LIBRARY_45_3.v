...
module FAU ( 
  ...
  nand4  g18(.a(new_n53_), .b(x12), .c(x11), .d(x10), .O(new_n62_));
  oai21  g19(.a(new_n62_), .b(new_n61_), .c(new_n53_), .O(new_n63_));
  nand2  g20(.a(new_n63_), .b(x01), .O(new_n64_));
  inv1   g21(.a(x19), .O(new_n65_));
  nor2   g22(.a(x02), .b(x00), .O(new_n66_));
  nand4  g23(.a(new_n66_), .b(new_n65_), .c(x18), .d(new_n49_), .O(new_n67_));
  ...
  nor4   g29(.a(x09), .b(new_n45_), .c(new_n72_), .d(new_n71_), .O(new_n73_));
  ...
  aoi21  g33(.a(new_n76_), .b(new_n53_), .c(new_n72_), .O(z05));
  nand4  g34(.a(new_n53_), .b(x11), .c(x10), .d(new_n46_), .O(new_n78_));
  inv1   g35(.a(new_n78_), .O(new_n79_));
  nand4  g36(.a(new_n79_), .b(x02), .c(x01), .d(x00), .O(new_n80_));
  inv1   g37(.a(new_n80_), .O(z06));
  nand2  g38(.a(x10), .b(new_n46_), .O(new_n82_));
  nand3  g39(.a(new_n53_), .b(new_n70_), .c(x11), .O(new_n83_));
  oai21  g40(.a(new_n83_), .b(new_n82_), .c(x01), .O(new_n84_));
  nand3  g41(.a(new_n84_), .b(x02), .c(x00), .O(new_n85_));
  nand2  g42(.a(new_n85_), .b(new_n44_), .O(z07));
  inv1   g43(.a(x04), .O(new_n87_));
  nand3  g44(.a(x02), .b(new_n72_), .c(new_n71_), .O(new_n88_));
  nor4   g45(.a(new_n88_), .b(x05), .c(new_n87_), .d(x03), .O(new_n89_));
  ...
  nand3  g80(.a(new_n47_), .b(x17), .c(new_n45_), .O(new_n124_));
  nor2   g81(.a(new_n124_), .b(x19), .O(z13));
  nand3  g82(.a(new_n50_), .b(new_n49_), .c(new_n58_), .O(new_n126_));
  oai21  g83(.a(new_n126_), .b(new_n48_), .c(new_n44_), .O(z14));
  aoi22  g84(.a(new_n44_), .b(x00), .c(x19), .d(new_n72_), .O(new_n128_));
  nand4  g85(.a(new_n53_), .b(new_n58_), .c(x01), .d(x00), .O(new_n129_));
  oai21  g86(.a(new_n128_), .b(x02), .c(new_n129_), .O(z15));
  aoi21  g87(.a(new_n53_), .b(x00), .c(new_n72_), .O(z16));
  nand2  g88(.a(new_n47_), .b(x02), .O(new_n132_));
