...
module FAU ( 
  ...
  nand4  g025(.a(x16), .b(x12), .c(x11), .d(x10), .O(new_n69_));
  ...
  aoi21  g029(.a(new_n72_), .b(x16), .c(new_n64_), .O(z04));
  nand4  g030(.a(x09), .b(x02), .c(x01), .d(x00), .O(new_n74_));
  nor3   g031(.a(new_n74_), .b(new_n44_), .c(new_n57_), .O(z05));
  nand3  g032(.a(x16), .b(x11), .c(x10), .O(new_n76_));
  inv1   g033(.a(new_n76_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(new_n47_), .c(x02), .d(x00), .O(new_n78_));
  aoi21  g035(.a(new_n78_), .b(x16), .c(new_n64_), .O(z06));
  nand2  g036(.a(x10), .b(new_n47_), .O(new_n80_));
  inv1   g037(.a(x12), .O(new_n81_));
  nand3  g038(.a(x16), .b(new_n81_), .c(x11), .O(new_n82_));
  ...
  nand4  g046(.a(new_n89_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n51_), .c(x17), .d(new_n86_), .O(new_n94_));
  nor2   g051(.a(new_n94_), .b(new_n52_), .O(z08));
  inv1   g052(.a(x21), .O(new_n96_));
  inv1   g053(.a(x22), .O(new_n97_));
  inv1   g054(.a(x11), .O(new_n98_));
  nand4  g055(.a(x12), .b(new_n98_), .c(x02), .d(new_n64_), .O(new_n99_));
  inv1   g056(.a(x15), .O(new_n100_));
  nor2   g057(.a(x14), .b(x13), .O(new_n101_));
  nand4  g058(.a(new_n101_), .b(x20), .c(new_n44_), .d(new_n100_), .O(new_n102_));
  ...
  nand4  g062(.a(new_n105_), .b(new_n97_), .c(new_n96_), .d(new_n63_), .O(new_n106_));
  ...
  nand2  g068(.a(x02), .b(new_n64_), .O(new_n112_));
  ...
  aoi21  g075(.a(new_n118_), .b(new_n115_), .c(new_n111_), .O(new_n119_));
  oai21  g076(.a(new_n119_), .b(x00), .c(new_n45_), .O(z10));
  nor2   g077(.a(new_n51_), .b(new_n64_), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(x21), .c(new_n109_), .d(new_n52_), .O(new_n122_));
  nand4  g079(.a(new_n113_), .b(x12), .c(new_n98_), .d(x02), .O(new_n123_));
  nor2   g080(.a(new_n100_), .b(x14), .O(new_n124_));
  nand4  g081(.a(new_n124_), .b(new_n96_), .c(x20), .d(new_n44_), .O(new_n125_));
  oai21  g082(.a(new_n125_), .b(new_n123_), .c(new_n122_), .O(new_n126_));
  nand3  g083(.a(new_n126_), .b(new_n97_), .c(new_n63_), .O(new_n127_));
  ...
  nand2  g094(.a(new_n58_), .b(x17), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(x19), .O(z13));
  nand2  g096(.a(new_n58_), .b(new_n47_), .O(new_n140_));
  inv1   g097(.a(new_n140_), .O(new_n141_));
  nand4  g098(.a(new_n141_), .b(new_n51_), .c(new_n50_), .d(new_n57_), .O(new_n142_));
  ...
  nand3  g103(.a(new_n146_), .b(new_n145_), .c(new_n45_), .O(z15));
  nand3  g104(.a(x16), .b(x01), .c(new_n63_), .O(new_n148_));
  inv1   g105(.a(new_n148_), .O(z16));
  oai21  g106(.a(new_n112_), .b(x00), .c(new_n45_), .O(z17));
endmodule
