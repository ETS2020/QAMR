...
module FAU ( 
  ...
  oai21  g57(.a(new_n100_), .b(new_n89_), .c(new_n44_), .O(new_n101_));
  ...
  nor2   g63(.a(new_n106_), .b(x20), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n65_), .c(x18), .d(x01), .O(new_n108_));
  inv1   g65(.a(x13), .O(new_n109_));
  nor2   g66(.a(new_n45_), .b(x01), .O(new_n110_));
  nand4  g67(.a(new_n110_), .b(new_n109_), .c(x12), .d(new_n76_), .O(new_n111_));
  nor2   g68(.a(new_n90_), .b(x14), .O(new_n112_));
  nand4  g69(.a(new_n112_), .b(new_n106_), .c(x20), .d(new_n91_), .O(new_n113_));
  oai21  g70(.a(new_n113_), .b(new_n111_), .c(new_n108_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n105_), .c(new_n44_), .O(new_n115_));
  ...
  nand2  g89(.a(new_n117_), .b(x00), .O(new_n133_));
  oai21  g90(.a(new_n132_), .b(x01), .c(new_n133_), .O(z15));
  nor2   g91(.a(new_n60_), .b(x00), .O(z16));
  nand3  g92(.a(x02), .b(new_n60_), .c(new_n44_), .O(new_n136_));
