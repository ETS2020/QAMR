...
module FAU ( 
  ...
  nand2  g029(.a(x06), .b(new_n47_), .O(new_n73_));
  ...
  nor2   g035(.a(new_n78_), .b(new_n59_), .O(z05));
  nor3   g036(.a(new_n74_), .b(new_n59_), .c(x09), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(x02), .c(x01), .d(x00), .O(new_n81_));
  nand2  g038(.a(new_n81_), .b(new_n73_), .O(z06));
  ...
  nand4  g076(.a(new_n97_), .b(new_n112_), .c(x12), .d(new_n74_), .O(new_n120_));
  nor2   g077(.a(new_n99_), .b(x14), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n95_), .c(x20), .d(new_n100_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n120_), .c(new_n119_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n96_), .c(new_n46_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n73_), .O(z11));
  ...
  nand3  g086(.a(new_n65_), .b(x17), .c(new_n48_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand4  g088(.a(new_n131_), .b(new_n49_), .c(new_n47_), .d(new_n46_), .O(new_n132_));
  ...
  nor3   g092(.a(new_n50_), .b(x19), .c(new_n44_), .O(z13));
  nor3   g093(.a(x09), .b(x02), .c(x00), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n61_), .O(new_n138_));
  aoi21  g095(.a(new_n138_), .b(new_n49_), .c(x01), .O(z14));
  aoi21  g096(.a(new_n59_), .b(x01), .c(new_n48_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n48_), .c(x06), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n46_), .O(z15));
  oai21  g099(.a(new_n47_), .b(x00), .c(new_n73_), .O(z16));
