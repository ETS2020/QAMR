...
module FAU ( 
  ...
  nand2  g38(.a(new_n57_), .b(x01), .O(new_n84_));
  aoi21  g39(.a(new_n84_), .b(x02), .c(z16), .O(z15));
  zero   g40(.O(z01));
  zero   g41(.O(z08));
  inv1   g42(.a(new_n46_), .O(z02));
  inv1   g43(.a(new_n46_), .O(z13));
  inv1   g44(.a(new_n46_), .O(z14));
  inv1   g45(.a(new_n46_), .O(z17));
endmodule
