...
module FAU ( 
  ...
  aoi21  g013(.a(new_n56_), .b(x08), .c(new_n49_), .O(z01));
  inv1   g014(.a(x10), .O(new_n58_));
  nand4  g015(.a(new_n55_), .b(new_n54_), .c(new_n44_), .d(new_n58_), .O(new_n59_));
  aoi21  g016(.a(new_n59_), .b(x08), .c(new_n49_), .O(z02));
  nor2   g017(.a(new_n49_), .b(x08), .O(new_n61_));
  inv1   g018(.a(new_n61_), .O(new_n62_));
  inv1   g019(.a(x19), .O(new_n63_));
  nand4  g020(.a(new_n54_), .b(new_n63_), .c(x18), .d(new_n44_), .O(new_n64_));
  ...
  nand3  g027(.a(new_n70_), .b(new_n64_), .c(new_n62_), .O(z03));
  nand3  g028(.a(x02), .b(x01), .c(x00), .O(new_n72_));
  inv1   g029(.a(new_n72_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n67_), .c(x10), .d(new_n49_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand4  g032(.a(x10), .b(x02), .c(x01), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x08), .c(new_n49_), .O(z05));
  ...
  nand3  g037(.a(new_n68_), .b(x11), .c(x10), .O(new_n81_));
  oai22  g038(.a(new_n81_), .b(new_n80_), .c(new_n61_), .d(x01), .O(new_n82_));
  ...
  nand2  g054(.a(x02), .b(new_n47_), .O(new_n98_));
  inv1   g055(.a(new_n98_), .O(new_n99_));
  nand3  g056(.a(new_n99_), .b(x12), .c(new_n67_), .O(new_n100_));
  ...
  nand4  g065(.a(new_n108_), .b(new_n97_), .c(new_n96_), .d(new_n46_), .O(new_n109_));
  nand2  g066(.a(new_n109_), .b(new_n62_), .O(z09));
  ...
  nand3  g070(.a(new_n113_), .b(new_n99_), .c(new_n67_), .O(new_n114_));
  ...
  oai21  g075(.a(new_n118_), .b(x00), .c(new_n62_), .O(z10));
  nand4  g076(.a(new_n106_), .b(x21), .c(new_n105_), .d(new_n63_), .O(new_n120_));
  ...
  nand3  g089(.a(new_n132_), .b(x09), .c(x08), .O(new_n133_));
  inv1   g090(.a(new_n133_), .O(z12));
  nor2   g091(.a(new_n61_), .b(x19), .O(new_n135_));
  ...
  nand3  g099(.a(new_n142_), .b(new_n141_), .c(new_n62_), .O(z15));
  oai21  g100(.a(new_n47_), .b(x00), .c(new_n62_), .O(z16));
  nand4  g101(.a(new_n62_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n145_));
