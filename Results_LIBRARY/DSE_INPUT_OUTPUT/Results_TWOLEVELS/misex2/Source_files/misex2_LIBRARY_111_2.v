...
module FAU ( 
  ...
  nand4  g14(.a(new_n47_), .b(new_n44_), .c(new_n57_), .d(x09), .O(new_n58_));
  ...
  oai21  g25(.a(new_n65_), .b(new_n52_), .c(new_n68_), .O(z03));
  ...
  nor3   g33(.a(new_n76_), .b(new_n60_), .c(new_n52_), .O(z06));
  inv1   g34(.a(x12), .O(new_n78_));
  nand4  g35(.a(new_n62_), .b(new_n78_), .c(x11), .d(x10), .O(new_n79_));
  aoi21  g36(.a(new_n79_), .b(x01), .c(new_n52_), .O(z07));
  nor2   g37(.a(x03), .b(new_n53_), .O(new_n81_));
  ...
  aoi21  g44(.a(new_n87_), .b(new_n52_), .c(x01), .O(z08));
  ...
  oai21  g51(.a(new_n94_), .b(new_n90_), .c(new_n52_), .O(new_n95_));
  nand2  g52(.a(new_n95_), .b(new_n60_), .O(new_n96_));
  and2   g53(.a(x18), .b(x01), .O(new_n97_));
  nor2   g54(.a(x20), .b(x19), .O(new_n98_));
  nand4  g55(.a(new_n98_), .b(new_n97_), .c(new_n93_), .d(new_n52_), .O(new_n99_));
  ...
  nor2   g62(.a(new_n53_), .b(x01), .O(new_n106_));
  ...
  nand3  g78(.a(new_n121_), .b(new_n113_), .c(new_n52_), .O(new_n122_));
  ...
  nand3  g84(.a(new_n66_), .b(x17), .c(new_n53_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n127_), .O(new_n129_));
  nand3  g86(.a(new_n129_), .b(new_n60_), .c(new_n52_), .O(new_n130_));
  ...
  nand2  g90(.a(new_n47_), .b(x17), .O(new_n134_));
  nor2   g91(.a(new_n134_), .b(x19), .O(z13));
  nand4  g92(.a(new_n49_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n136_));
  nor2   g93(.a(new_n136_), .b(x19), .O(z14));
  nor2   g94(.a(x01), .b(x00), .O(new_n138_));
  nand3  g95(.a(new_n138_), .b(x19), .c(new_n53_), .O(new_n139_));
  nand2  g96(.a(new_n139_), .b(new_n126_), .O(z15));
  xor2a  g97(.a(x01), .b(x00), .O(z16));
  nand2  g98(.a(new_n138_), .b(x02), .O(new_n142_));
