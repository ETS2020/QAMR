...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n53_, new_n54_,
    ...
    new_n83_, new_n85_, new_n86_, new_n90_, new_n91_, new_n92_;
  ...
  oai21  g20(.a(x02), .b(new_n53_), .c(new_n54_), .O(new_n67_));
  nand4  g21(.a(new_n47_), .b(x11), .c(x10), .d(new_n48_), .O(new_n68_));
  oai21  g22(.a(new_n68_), .b(new_n56_), .c(new_n67_), .O(z07));
  inv1   g23(.a(x20), .O(new_n71_));
  inv1   g24(.a(x21), .O(new_n72_));
  inv1   g25(.a(x22), .O(new_n73_));
  inv1   g26(.a(x19), .O(new_n74_));
  nand4  g27(.a(new_n74_), .b(x18), .c(x01), .d(new_n53_), .O(new_n75_));
  ...
  nand4  g38(.a(new_n85_), .b(x09), .c(x01), .d(x00), .O(new_n86_));
  nand2  g39(.a(new_n86_), .b(new_n55_), .O(z12));
  inv1   g40(.a(x02), .O(new_n90_));
  inv1   g41(.a(x10), .O(new_n91_));
  aoi21  g42(.a(new_n91_), .b(x01), .c(new_n90_), .O(new_n92_));
  oai21  g43(.a(new_n92_), .b(new_n53_), .c(new_n55_), .O(z15));
  nor2   g44(.a(new_n54_), .b(x00), .O(z16));
  zero   g45(.O(z00));
  zero   g46(.O(z01));
  zero   g47(.O(z02));
  zero   g48(.O(z08));
