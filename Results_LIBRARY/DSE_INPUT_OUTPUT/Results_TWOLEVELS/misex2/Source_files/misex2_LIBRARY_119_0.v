...
module FAU ( 
  ...
  nand2  g020(.a(new_n51_), .b(new_n49_), .O(new_n64_));
  nand3  g021(.a(new_n47_), .b(x18), .c(new_n45_), .O(new_n65_));
  oai21  g022(.a(new_n65_), .b(new_n64_), .c(x20), .O(new_n66_));
  nand2  g023(.a(new_n66_), .b(new_n50_), .O(new_n67_));
  nand3  g024(.a(x02), .b(x01), .c(x00), .O(new_n68_));
  nand4  g025(.a(x12), .b(x11), .c(x10), .d(new_n52_), .O(new_n69_));
  ...
  nand4  g030(.a(new_n73_), .b(new_n71_), .c(x10), .d(new_n52_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nor3   g032(.a(new_n72_), .b(new_n48_), .c(new_n52_), .O(z05));
  nand4  g033(.a(x11), .b(x10), .c(new_n52_), .d(x02), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n50_), .c(new_n49_), .O(z06));
  ...
  nand2  g039(.a(new_n44_), .b(new_n50_), .O(new_n83_));
  ...
  nor2   g046(.a(new_n47_), .b(x18), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(new_n89_), .c(new_n88_), .d(x17), .O(new_n91_));
  aoi21  g048(.a(new_n91_), .b(x20), .c(x01), .O(z08));
  inv1   g049(.a(x21), .O(new_n93_));
  inv1   g050(.a(x22), .O(new_n94_));
  nor2   g051(.a(new_n51_), .b(x01), .O(new_n95_));
  ...
  nor2   g057(.a(new_n46_), .b(new_n50_), .O(new_n101_));
  nand3  g058(.a(new_n101_), .b(new_n44_), .c(new_n47_), .O(new_n102_));
  oai21  g059(.a(new_n100_), .b(new_n96_), .c(new_n102_), .O(new_n103_));
  nand4  g060(.a(new_n103_), .b(new_n94_), .c(new_n93_), .d(new_n49_), .O(new_n104_));
  inv1   g061(.a(new_n104_), .O(z09));
  nor2   g062(.a(x19), .b(new_n46_), .O(new_n106_));
  nor3   g063(.a(new_n94_), .b(new_n93_), .c(x20), .O(new_n107_));
  nand2  g064(.a(x02), .b(new_n50_), .O(new_n108_));
  ...
  nand2  g069(.a(x15), .b(new_n112_), .O(new_n113_));
  nand3  g070(.a(new_n94_), .b(new_n93_), .c(x16), .O(new_n114_));
  nor2   g071(.a(new_n114_), .b(new_n113_), .O(new_n115_));
  aoi22  g072(.a(new_n115_), .b(new_n111_), .c(new_n107_), .d(new_n106_), .O(new_n116_));
  oai21  g073(.a(new_n116_), .b(x00), .c(new_n83_), .O(z10));
  nand4  g074(.a(new_n95_), .b(new_n109_), .c(x12), .d(new_n71_), .O(new_n118_));
  nand4  g075(.a(new_n101_), .b(x21), .c(new_n44_), .d(new_n47_), .O(new_n119_));
  ...
  nand3  g079(.a(new_n122_), .b(new_n94_), .c(new_n49_), .O(new_n123_));
  ...
  nand3  g085(.a(new_n47_), .b(x17), .c(new_n51_), .O(new_n129_));
  nand2  g086(.a(new_n129_), .b(new_n128_), .O(new_n130_));
  nand4  g087(.a(new_n130_), .b(x20), .c(new_n50_), .d(new_n49_), .O(new_n131_));
  ...
  nand3  g091(.a(new_n51_), .b(new_n50_), .c(new_n49_), .O(new_n135_));
  nor4   g092(.a(new_n135_), .b(new_n44_), .c(x19), .d(new_n45_), .O(z13));
  nor2   g093(.a(new_n53_), .b(x10), .O(new_n137_));
  nand4  g094(.a(new_n137_), .b(new_n47_), .c(new_n46_), .d(new_n45_), .O(new_n138_));
  nor2   g095(.a(new_n138_), .b(new_n44_), .O(z14));
  aoi21  g096(.a(new_n48_), .b(x01), .c(new_n51_), .O(new_n140_));
  aoi21  g097(.a(x19), .b(new_n51_), .c(new_n44_), .O(new_n141_));
  oai22  g098(.a(new_n141_), .b(x01), .c(new_n140_), .d(new_n49_), .O(z15));
  oai21  g099(.a(new_n50_), .b(x00), .c(new_n83_), .O(z16));
  nand4  g100(.a(x20), .b(x02), .c(new_n50_), .d(new_n49_), .O(new_n144_));
