...
module FAU ( 
  ...
  nor2   g001(.a(new_n44_), .b(x08), .O(new_n45_));
  ...
  nor2   g014(.a(new_n45_), .b(x19), .O(new_n58_));
  nand3  g015(.a(new_n58_), .b(new_n52_), .c(new_n51_), .O(new_n59_));
  nor2   g016(.a(new_n59_), .b(new_n57_), .O(new_n60_));
  nand4  g017(.a(new_n60_), .b(x09), .c(new_n47_), .d(new_n56_), .O(new_n61_));
  nor2   g018(.a(new_n61_), .b(x00), .O(z01));
  nand3  g019(.a(new_n49_), .b(x09), .c(new_n47_), .O(new_n63_));
  nand4  g020(.a(new_n53_), .b(new_n52_), .c(new_n51_), .d(new_n57_), .O(new_n64_));
  oai21  g021(.a(new_n64_), .b(new_n63_), .c(new_n46_), .O(z02));
  ...
  nor2   g026(.a(new_n57_), .b(x09), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n69_), .c(x12), .d(x11), .O(new_n71_));
  nand3  g028(.a(new_n71_), .b(new_n67_), .c(new_n46_), .O(z03));
  inv1   g029(.a(x00), .O(new_n73_));
  inv1   g030(.a(x11), .O(new_n74_));
  inv1   g031(.a(x12), .O(new_n75_));
  nand4  g032(.a(new_n46_), .b(new_n75_), .c(new_n74_), .d(x10), .O(new_n76_));
  ...
  nor2   g039(.a(new_n45_), .b(new_n74_), .O(new_n83_));
  nand4  g040(.a(new_n83_), .b(x10), .c(new_n48_), .d(x02), .O(new_n84_));
  nor3   g041(.a(new_n84_), .b(new_n56_), .c(new_n73_), .O(z06));
  nand3  g042(.a(new_n70_), .b(new_n75_), .c(x11), .O(new_n86_));
  ...
  nand4  g051(.a(new_n94_), .b(x02), .c(new_n56_), .d(new_n73_), .O(new_n95_));
  ...
  nand4  g055(.a(new_n98_), .b(x19), .c(new_n52_), .d(x17), .O(new_n99_));
  nor2   g056(.a(new_n99_), .b(x21), .O(z08));
  inv1   g057(.a(x22), .O(new_n101_));
  nand2  g058(.a(x02), .b(new_n56_), .O(new_n102_));
  ...
  nor2   g066(.a(new_n52_), .b(new_n56_), .O(new_n110_));
  nand3  g067(.a(new_n110_), .b(new_n109_), .c(new_n53_), .O(new_n111_));
  oai21  g068(.a(new_n108_), .b(new_n104_), .c(new_n111_), .O(new_n112_));
  nand4  g069(.a(new_n112_), .b(new_n101_), .c(new_n44_), .d(new_n73_), .O(new_n113_));
  nand2  g070(.a(new_n113_), .b(new_n46_), .O(z09));
  nand3  g071(.a(new_n53_), .b(x18), .c(x01), .O(new_n115_));
  nor4   g072(.a(new_n115_), .b(new_n101_), .c(new_n44_), .d(x20), .O(new_n116_));
  nor2   g073(.a(x13), .b(new_n75_), .O(new_n117_));
  nand3  g074(.a(new_n117_), .b(new_n103_), .c(new_n74_), .O(new_n118_));
  inv1   g075(.a(new_n118_), .O(new_n119_));
  nand3  g076(.a(new_n101_), .b(new_n44_), .c(x20), .O(new_n120_));
  ...
  nand4  g080(.a(new_n110_), .b(x21), .c(new_n109_), .d(new_n53_), .O(new_n124_));
  nor2   g081(.a(new_n105_), .b(x14), .O(new_n125_));
  nand4  g082(.a(new_n125_), .b(new_n44_), .c(x20), .d(new_n106_), .O(new_n126_));
  oai21  g083(.a(new_n126_), .b(new_n118_), .c(new_n124_), .O(new_n127_));
  nand3  g084(.a(new_n127_), .b(new_n101_), .c(new_n73_), .O(new_n128_));
  nand2  g085(.a(new_n128_), .b(new_n46_), .O(z11));
  ...
  nand3  g091(.a(new_n134_), .b(new_n56_), .c(new_n73_), .O(new_n135_));
  aoi21  g092(.a(new_n135_), .b(new_n131_), .c(x24), .O(new_n136_));
  nand2  g093(.a(new_n136_), .b(x09), .O(new_n137_));
  nand2  g094(.a(new_n137_), .b(new_n46_), .O(z12));
  nand4  g095(.a(new_n58_), .b(x17), .c(new_n47_), .d(new_n56_), .O(new_n139_));
  nor2   g096(.a(new_n139_), .b(x00), .O(z13));
  oai21  g097(.a(new_n64_), .b(new_n50_), .c(new_n46_), .O(z14));
  oai21  g098(.a(x10), .b(new_n56_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n47_), .c(new_n56_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n46_), .O(z15));
  nor3   g102(.a(new_n45_), .b(new_n56_), .c(x00), .O(z16));
  oai21  g103(.a(new_n102_), .b(x00), .c(new_n46_), .O(z17));
endmodule
