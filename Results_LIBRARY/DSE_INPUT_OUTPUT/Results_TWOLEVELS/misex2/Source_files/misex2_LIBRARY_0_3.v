...
module FAU ( 
  ...
  aoi21  g031(.a(new_n74_), .b(new_n61_), .c(new_n70_), .O(z04));
  nand3  g032(.a(x02), .b(x01), .c(x00), .O(new_n76_));
  inv1   g033(.a(new_n76_), .O(new_n77_));
  nand4  g034(.a(new_n77_), .b(x10), .c(x09), .d(new_n61_), .O(new_n78_));
  inv1   g035(.a(new_n78_), .O(z05));
  nor2   g036(.a(new_n71_), .b(new_n55_), .O(new_n80_));
  nand4  g037(.a(new_n80_), .b(new_n46_), .c(x02), .d(x00), .O(new_n81_));
  aoi21  g038(.a(new_n81_), .b(new_n61_), .c(new_n70_), .O(z06));
  ...
  nand3  g047(.a(new_n90_), .b(x04), .c(new_n61_), .O(new_n91_));
  nor2   g048(.a(new_n91_), .b(new_n89_), .O(new_n92_));
  nor3   g049(.a(x08), .b(x07), .c(x06), .O(new_n93_));
  nor2   g050(.a(new_n66_), .b(x18), .O(new_n94_));
  ...
  nand4  g063(.a(new_n106_), .b(new_n98_), .c(new_n97_), .d(new_n87_), .O(new_n107_));
  nand2  g064(.a(new_n107_), .b(new_n44_), .O(z09));
  nor2   g065(.a(new_n56_), .b(x03), .O(new_n109_));
  ...
  nand4  g076(.a(new_n88_), .b(new_n112_), .c(x12), .d(new_n71_), .O(new_n120_));
  nor2   g077(.a(new_n97_), .b(x20), .O(new_n121_));
  nand4  g078(.a(new_n121_), .b(new_n109_), .c(new_n66_), .d(x01), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n98_), .c(new_n87_), .O(new_n126_));
  ...
  nand3  g090(.a(new_n133_), .b(new_n70_), .c(new_n87_), .O(new_n134_));
  ...
  oai21  g098(.a(x10), .b(new_n70_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n45_), .c(new_n70_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n44_), .O(z15));
  nand3  g102(.a(new_n61_), .b(x01), .c(new_n87_), .O(new_n146_));
  inv1   g103(.a(new_n146_), .O(z16));
  nand2  g104(.a(new_n89_), .b(new_n44_), .O(z17));
endmodule
