...
module FAU ( 
  ...
  nor3   g30(.a(new_n70_), .b(new_n57_), .c(new_n68_), .O(z05));
  ...
  nand4  g69(.a(new_n112_), .b(new_n111_), .c(x12), .d(new_n69_), .O(new_n113_));
  ...
  nand3  g78(.a(new_n64_), .b(x17), .c(new_n48_), .O(new_n122_));
  aoi21  g79(.a(new_n122_), .b(new_n121_), .c(x01), .O(new_n123_));
  oai21  g80(.a(new_n123_), .b(new_n120_), .c(new_n119_), .O(new_n124_));
  oai22  g81(.a(new_n124_), .b(new_n68_), .c(x01), .d(new_n46_), .O(z12));
  nor3   g82(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g83(.a(new_n54_), .b(new_n57_), .c(new_n68_), .d(new_n48_), .O(new_n127_));
