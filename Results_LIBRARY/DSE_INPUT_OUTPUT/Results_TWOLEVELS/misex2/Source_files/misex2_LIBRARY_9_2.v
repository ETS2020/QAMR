...
module FAU ( 
  ...
  nor2   g14(.a(x09), .b(new_n45_), .O(new_n58_));
  nand3  g15(.a(x12), .b(x11), .c(x10), .O(new_n59_));
  inv1   g16(.a(new_n59_), .O(new_n60_));
  aoi21  g17(.a(new_n60_), .b(new_n58_), .c(new_n57_), .O(new_n61_));
  inv1   g18(.a(x19), .O(new_n62_));
  nor2   g19(.a(x02), .b(x01), .O(new_n63_));
  nand4  g20(.a(new_n63_), .b(new_n62_), .c(x18), .d(new_n53_), .O(new_n64_));
  ...
  nand3  g32(.a(new_n75_), .b(new_n58_), .c(x10), .O(new_n76_));
  ...
  nand4  g42(.a(new_n85_), .b(new_n82_), .c(new_n81_), .d(new_n78_), .O(new_n86_));
  aoi21  g43(.a(new_n86_), .b(new_n44_), .c(x01), .O(z08));
  nor2   g44(.a(x14), .b(x13), .O(new_n88_));
  nand4  g45(.a(new_n88_), .b(x12), .c(new_n66_), .d(x02), .O(new_n89_));
  ...
  nand2  g51(.a(new_n94_), .b(new_n57_), .O(new_n95_));
  nor3   g52(.a(new_n83_), .b(new_n57_), .c(x00), .O(new_n96_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n62_), .c(x18), .d(x01), .O(new_n102_));
  ...
  nand3  g63(.a(new_n106_), .b(x12), .c(new_n66_), .O(new_n107_));
  ...
  nand4  g68(.a(new_n92_), .b(x20), .c(new_n91_), .d(x15), .O(new_n112_));
  oai21  g69(.a(new_n112_), .b(new_n89_), .c(new_n44_), .O(new_n113_));
  nand2  g70(.a(new_n113_), .b(new_n57_), .O(new_n114_));
  inv1   g71(.a(x22), .O(new_n115_));
  nand4  g72(.a(new_n97_), .b(new_n96_), .c(new_n115_), .d(x21), .O(new_n116_));
  nand2  g73(.a(new_n116_), .b(new_n114_), .O(z11));
  inv1   g74(.a(x24), .O(new_n118_));
  aoi21  g75(.a(x10), .b(x02), .c(new_n44_), .O(new_n119_));
  ...
  nand2  g80(.a(new_n57_), .b(x00), .O(new_n124_));
  oai21  g81(.a(new_n123_), .b(new_n46_), .c(new_n124_), .O(z12));
  nand2  g82(.a(new_n54_), .b(x17), .O(new_n126_));
  nor2   g83(.a(new_n126_), .b(x19), .O(z13));
  nand4  g84(.a(new_n54_), .b(new_n53_), .c(new_n52_), .d(new_n46_), .O(new_n128_));
  nor3   g85(.a(new_n128_), .b(x19), .c(x18), .O(z14));
  nand2  g86(.a(x10), .b(x02), .O(new_n130_));
  nand3  g87(.a(new_n130_), .b(x01), .c(x00), .O(new_n131_));
  nand4  g88(.a(x19), .b(new_n45_), .c(new_n57_), .d(new_n44_), .O(new_n132_));
