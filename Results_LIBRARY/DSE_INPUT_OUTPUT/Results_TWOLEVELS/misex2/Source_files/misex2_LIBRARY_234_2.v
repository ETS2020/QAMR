...
module FAU ( 
  ...
  nand4  g53(.a(new_n96_), .b(new_n95_), .c(new_n91_), .d(new_n46_), .O(new_n97_));
  nand2  g54(.a(new_n97_), .b(new_n94_), .O(z09));
  nand2  g55(.a(x22), .b(x21), .O(new_n99_));
  nor2   g56(.a(new_n99_), .b(x20), .O(new_n100_));
  nand4  g57(.a(new_n100_), .b(new_n62_), .c(x18), .d(x01), .O(new_n101_));
  ...
  nand3  g62(.a(new_n105_), .b(x12), .c(new_n67_), .O(new_n106_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n104_), .c(new_n67_), .O(new_n114_));
  inv1   g71(.a(x20), .O(new_n115_));
  nand4  g72(.a(new_n95_), .b(x21), .c(new_n115_), .d(new_n62_), .O(new_n116_));
  nor2   g73(.a(new_n89_), .b(x14), .O(new_n117_));
  nor2   g74(.a(x21), .b(new_n115_), .O(new_n118_));
  nand3  g75(.a(new_n118_), .b(new_n117_), .c(new_n90_), .O(new_n119_));
  oai21  g76(.a(new_n119_), .b(new_n114_), .c(new_n116_), .O(new_n120_));
  nand3  g77(.a(new_n120_), .b(new_n111_), .c(new_n46_), .O(new_n121_));
