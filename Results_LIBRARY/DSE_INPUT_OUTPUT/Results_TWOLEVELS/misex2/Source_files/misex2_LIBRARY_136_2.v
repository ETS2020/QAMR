...
module FAU ( 
  ...
  nor2   g023(.a(new_n64_), .b(new_n63_), .O(new_n67_));
  nand3  g024(.a(new_n67_), .b(x03), .c(x02), .O(new_n68_));
  ...
  nand3  g028(.a(new_n67_), .b(x03), .c(x02), .O(new_n72_));
  inv1   g029(.a(new_n72_), .O(new_n73_));
  nand4  g030(.a(new_n73_), .b(new_n71_), .c(x10), .d(new_n47_), .O(new_n74_));
  nor2   g031(.a(new_n74_), .b(x12), .O(z04));
  nand4  g032(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n76_));
  aoi21  g033(.a(new_n76_), .b(x03), .c(new_n64_), .O(z05));
  nor3   g034(.a(new_n71_), .b(new_n60_), .c(x09), .O(new_n78_));
  nand4  g035(.a(new_n78_), .b(x03), .c(x02), .d(x00), .O(new_n79_));
  aoi21  g036(.a(new_n79_), .b(x03), .c(new_n64_), .O(z06));
  nand2  g037(.a(new_n47_), .b(x03), .O(new_n81_));
  ...
  nand4  g046(.a(new_n44_), .b(x02), .c(new_n64_), .d(new_n63_), .O(new_n90_));
  ...
  nand4  g050(.a(new_n93_), .b(new_n51_), .c(x17), .d(new_n87_), .O(new_n94_));
  ...
  nand4  g061(.a(new_n104_), .b(new_n52_), .c(x18), .d(x01), .O(new_n105_));
  oai21  g062(.a(new_n103_), .b(new_n99_), .c(new_n105_), .O(new_n106_));
  nand4  g063(.a(new_n106_), .b(new_n97_), .c(new_n96_), .d(new_n63_), .O(new_n107_));
  ...
  nand2  g096(.a(new_n55_), .b(new_n47_), .O(new_n140_));
  ...
  aoi22  g100(.a(new_n45_), .b(x00), .c(x19), .d(new_n64_), .O(new_n144_));
  nand3  g101(.a(new_n67_), .b(new_n60_), .c(x03), .O(new_n145_));
  oai21  g102(.a(new_n144_), .b(x02), .c(new_n145_), .O(z15));
  aoi21  g103(.a(x03), .b(x00), .c(new_n64_), .O(z16));
