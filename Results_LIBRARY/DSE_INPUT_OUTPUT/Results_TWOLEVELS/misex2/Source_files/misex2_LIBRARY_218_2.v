...
module FAU ( 
  ...
  aoi21  g26(.a(new_n69_), .b(x01), .c(new_n60_), .O(z04));
  ...
  nand4  g39(.a(new_n82_), .b(x02), .c(new_n61_), .d(new_n60_), .O(new_n83_));
  ...
  nand4  g58(.a(new_n101_), .b(new_n90_), .c(new_n89_), .d(new_n60_), .O(new_n102_));
  ...
  oai21  g72(.a(new_n115_), .b(new_n114_), .c(new_n60_), .O(new_n116_));
  ...
  aoi21  g79(.a(x10), .b(x02), .c(new_n60_), .O(new_n123_));
  oai21  g80(.a(x19), .b(x02), .c(x23), .O(new_n124_));
  nand3  g81(.a(new_n63_), .b(x17), .c(new_n46_), .O(new_n125_));
  aoi21  g82(.a(new_n125_), .b(new_n124_), .c(x01), .O(new_n126_));
  oai21  g83(.a(new_n126_), .b(new_n123_), .c(new_n122_), .O(new_n127_));
  oai22  g84(.a(new_n127_), .b(new_n47_), .c(x01), .d(new_n60_), .O(z12));
  aoi21  g85(.a(new_n125_), .b(new_n60_), .c(x01), .O(z13));
  ...
  aoi21  g93(.a(new_n46_), .b(new_n60_), .c(x01), .O(z17));
endmodule
