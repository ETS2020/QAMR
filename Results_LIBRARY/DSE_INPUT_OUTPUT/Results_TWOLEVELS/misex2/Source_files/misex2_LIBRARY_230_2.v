...
module FAU ( 
  ...
  nand3  g015(.a(new_n58_), .b(new_n50_), .c(new_n56_), .O(new_n59_));
  nor3   g016(.a(new_n59_), .b(x19), .c(x18), .O(z02));
  ...
  nand4  g024(.a(x16), .b(x12), .c(x11), .d(x10), .O(new_n68_));
  oai22  g025(.a(new_n68_), .b(new_n67_), .c(new_n65_), .d(new_n63_), .O(z03));
  nor2   g026(.a(x12), .b(x11), .O(new_n70_));
  nand4  g027(.a(new_n70_), .b(new_n66_), .c(x10), .d(x00), .O(new_n71_));
  aoi21  g028(.a(new_n71_), .b(x16), .c(new_n62_), .O(z04));
  nand4  g029(.a(x10), .b(x09), .c(x02), .d(x00), .O(new_n73_));
  aoi21  g030(.a(new_n73_), .b(x16), .c(new_n62_), .O(z05));
  nand2  g031(.a(new_n44_), .b(x12), .O(new_n75_));
  ...
  aoi21  g035(.a(new_n78_), .b(x16), .c(new_n62_), .O(z06));
  ...
  nand3  g041(.a(x02), .b(new_n62_), .c(new_n61_), .O(new_n85_));
  ...
  nand4  g052(.a(x12), .b(new_n95_), .c(x02), .d(new_n62_), .O(new_n96_));
  inv1   g053(.a(x15), .O(new_n97_));
  nor2   g054(.a(x14), .b(x13), .O(new_n98_));
  nand4  g055(.a(new_n98_), .b(x20), .c(new_n44_), .d(new_n97_), .O(new_n99_));
  nor2   g056(.a(x20), .b(x19), .O(new_n100_));
  nand4  g057(.a(new_n100_), .b(x18), .c(x16), .d(x01), .O(new_n101_));
  ...
  nand4  g076(.a(new_n119_), .b(x21), .c(new_n106_), .d(new_n64_), .O(new_n120_));
  nand4  g077(.a(new_n110_), .b(x12), .c(new_n95_), .d(x02), .O(new_n121_));
  nor2   g078(.a(new_n97_), .b(x14), .O(new_n122_));
  nor2   g079(.a(x21), .b(new_n106_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n122_), .c(new_n44_), .O(new_n124_));
  oai21  g081(.a(new_n124_), .b(new_n121_), .c(new_n120_), .O(new_n125_));
  nand3  g082(.a(new_n125_), .b(new_n94_), .c(new_n61_), .O(new_n126_));
  ...
  nand3  g088(.a(new_n64_), .b(x17), .c(new_n46_), .O(new_n132_));
  ...
  nand3  g096(.a(new_n51_), .b(new_n50_), .c(new_n56_), .O(new_n140_));
  oai21  g097(.a(new_n140_), .b(new_n49_), .c(new_n45_), .O(z14));
  oai21  g098(.a(x10), .b(new_n62_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n62_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n45_), .O(z15));
  aoi21  g102(.a(x16), .b(x00), .c(new_n62_), .O(z16));
  nand2  g103(.a(new_n85_), .b(new_n45_), .O(z17));
endmodule
