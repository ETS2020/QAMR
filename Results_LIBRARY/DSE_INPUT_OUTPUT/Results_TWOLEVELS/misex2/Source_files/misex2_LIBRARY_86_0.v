...
module FAU ( 
  ...
  wire new_n47_, new_n48_, new_n49_, new_n50_, new_n51_, new_n52_, new_n55_,
    ...
    new_n74_, new_n75_, new_n77_, new_n79_, new_n80_, new_n81_, new_n84_,
    new_n85_;
  ...
  nor3   g10(.a(new_n50_), .b(new_n55_), .c(new_n49_), .O(z05));
  inv1   g11(.a(x00), .O(new_n57_));
  inv1   g12(.a(x01), .O(new_n58_));
  nand4  g13(.a(x11), .b(x10), .c(new_n49_), .d(x02), .O(new_n59_));
  nor3   g14(.a(new_n59_), .b(new_n58_), .c(new_n57_), .O(z06));
  oai21  g15(.a(x02), .b(new_n57_), .c(new_n58_), .O(new_n61_));
  nand3  g16(.a(x02), .b(x01), .c(x00), .O(new_n62_));
  nand4  g17(.a(new_n48_), .b(x11), .c(x10), .d(new_n49_), .O(new_n63_));
  oai21  g18(.a(new_n63_), .b(new_n62_), .c(new_n61_), .O(z07));
  inv1   g19(.a(x20), .O(new_n65_));
  inv1   g20(.a(x21), .O(new_n66_));
  inv1   g21(.a(x22), .O(new_n67_));
  inv1   g22(.a(x19), .O(new_n68_));
  nand4  g23(.a(new_n68_), .b(x18), .c(x01), .d(new_n57_), .O(new_n69_));
  inv1   g24(.a(new_n69_), .O(new_n70_));
  nand4  g25(.a(new_n70_), .b(new_n67_), .c(new_n66_), .d(new_n65_), .O(new_n71_));
  inv1   g26(.a(new_n71_), .O(z09));
  inv1   g27(.a(x18), .O(new_n73_));
  nor2   g28(.a(x19), .b(new_n73_), .O(new_n74_));
  nand4  g29(.a(new_n74_), .b(x22), .c(x21), .d(new_n65_), .O(new_n75_));
  aoi21  g30(.a(new_n75_), .b(x01), .c(x00), .O(z10));
  nand4  g31(.a(new_n74_), .b(new_n67_), .c(x21), .d(new_n65_), .O(new_n77_));
  aoi21  g32(.a(new_n77_), .b(x01), .c(x00), .O(z11));
  inv1   g33(.a(z01), .O(new_n79_));
  aoi21  g34(.a(x10), .b(x02), .c(x24), .O(new_n80_));
  nand4  g35(.a(new_n80_), .b(x09), .c(x01), .d(x00), .O(new_n81_));
  nand2  g36(.a(new_n81_), .b(new_n79_), .O(z12));
  inv1   g37(.a(x02), .O(new_n84_));
  aoi21  g38(.a(new_n55_), .b(x01), .c(new_n84_), .O(new_n85_));
  oai21  g39(.a(new_n85_), .b(new_n57_), .c(new_n79_), .O(z15));
  nor2   g40(.a(new_n58_), .b(x00), .O(z16));
  zero   g41(.O(z00));
  zero   g42(.O(z02));
  zero   g43(.O(z14));
