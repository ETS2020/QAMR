...
module FAU ( 
  ...
  nor2   g032(.a(new_n69_), .b(new_n57_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(new_n47_), .c(x02), .d(x00), .O(new_n77_));
  aoi21  g034(.a(new_n77_), .b(x17), .c(new_n44_), .O(z06));
  ...
  nand2  g038(.a(new_n64_), .b(x01), .O(new_n82_));
  ...
  nand4  g044(.a(new_n87_), .b(new_n85_), .c(new_n84_), .d(new_n45_), .O(new_n88_));
  inv1   g045(.a(x18), .O(new_n89_));
  nor3   g046(.a(x08), .b(x07), .c(x06), .O(new_n90_));
  nand4  g047(.a(new_n90_), .b(x19), .c(new_n89_), .d(x17), .O(new_n91_));
  oai21  g048(.a(new_n91_), .b(new_n88_), .c(new_n82_), .O(z08));
  inv1   g049(.a(x21), .O(new_n93_));
  inv1   g050(.a(x22), .O(new_n94_));
  nand4  g051(.a(x12), .b(new_n69_), .c(x02), .d(new_n44_), .O(new_n95_));
  ...
  nand4  g059(.a(new_n102_), .b(new_n94_), .c(new_n93_), .d(new_n45_), .O(new_n103_));
  ...
  nand2  g065(.a(new_n108_), .b(new_n69_), .O(new_n109_));
  ...
  nand3  g072(.a(new_n108_), .b(new_n85_), .c(new_n69_), .O(new_n116_));
  inv1   g073(.a(x20), .O(new_n117_));
  and2   g074(.a(x18), .b(x01), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(x21), .c(new_n117_), .d(new_n65_), .O(new_n119_));
  nor2   g076(.a(new_n96_), .b(x14), .O(new_n120_));
  nor2   g077(.a(x21), .b(new_n117_), .O(new_n121_));
  nand3  g078(.a(new_n121_), .b(new_n120_), .c(new_n97_), .O(new_n122_));
  oai21  g079(.a(new_n122_), .b(new_n116_), .c(new_n119_), .O(new_n123_));
  nand3  g080(.a(new_n123_), .b(new_n94_), .c(new_n45_), .O(new_n124_));
  nand2  g081(.a(new_n124_), .b(new_n82_), .O(z11));
  ...
  nand3  g086(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n130_));
  nand2  g087(.a(new_n130_), .b(new_n129_), .O(new_n131_));
  nand3  g088(.a(new_n131_), .b(new_n44_), .c(new_n45_), .O(new_n132_));
  nand2  g089(.a(new_n132_), .b(new_n128_), .O(new_n133_));
  nand3  g090(.a(new_n133_), .b(new_n126_), .c(x09), .O(new_n134_));
  nand2  g091(.a(new_n134_), .b(new_n82_), .O(z12));
  nand3  g092(.a(new_n46_), .b(new_n44_), .c(new_n45_), .O(new_n136_));
  nor3   g093(.a(new_n136_), .b(x19), .c(new_n64_), .O(z13));
  nand4  g094(.a(new_n47_), .b(new_n46_), .c(new_n44_), .d(new_n45_), .O(new_n138_));
  inv1   g095(.a(new_n138_), .O(new_n139_));
  nand4  g096(.a(new_n139_), .b(new_n89_), .c(new_n64_), .d(new_n57_), .O(new_n140_));
  nor2   g097(.a(new_n140_), .b(x19), .O(z14));
  oai21  g098(.a(x10), .b(new_n44_), .c(x02), .O(new_n142_));
  nand2  g099(.a(new_n142_), .b(x00), .O(new_n143_));
  nand3  g100(.a(x19), .b(new_n46_), .c(new_n44_), .O(new_n144_));
  nand3  g101(.a(new_n144_), .b(new_n143_), .c(new_n82_), .O(z15));
  aoi21  g102(.a(x17), .b(x00), .c(new_n44_), .O(z16));
