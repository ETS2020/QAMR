...
module FAU ( 
  ...
  nand4  g024(.a(x12), .b(x11), .c(x10), .d(new_n58_), .O(new_n68_));
  ...
  nor2   g029(.a(x17), .b(new_n47_), .O(new_n73_));
  inv1   g030(.a(new_n73_), .O(new_n74_));
  nand4  g031(.a(new_n74_), .b(new_n72_), .c(new_n71_), .d(x10), .O(new_n75_));
  inv1   g032(.a(new_n75_), .O(new_n76_));
  nand4  g033(.a(new_n76_), .b(new_n58_), .c(x02), .d(x01), .O(new_n77_));
  nor2   g034(.a(new_n77_), .b(new_n70_), .O(z04));
  nor2   g035(.a(new_n73_), .b(new_n57_), .O(new_n79_));
  nand4  g036(.a(new_n79_), .b(x09), .c(x02), .d(x01), .O(new_n80_));
  nor2   g037(.a(new_n80_), .b(new_n70_), .O(z05));
  nand2  g038(.a(new_n73_), .b(new_n72_), .O(new_n82_));
  nand4  g039(.a(new_n82_), .b(x11), .c(x10), .d(new_n58_), .O(new_n83_));
  inv1   g040(.a(new_n83_), .O(new_n84_));
  nand4  g041(.a(new_n84_), .b(x02), .c(x01), .d(x00), .O(new_n85_));
  nand2  g042(.a(new_n85_), .b(new_n74_), .O(z06));
  nand3  g043(.a(new_n72_), .b(x11), .c(x10), .O(new_n87_));
  oai21  g044(.a(new_n87_), .b(x09), .c(x01), .O(new_n88_));
  nand4  g045(.a(new_n88_), .b(new_n74_), .c(x02), .d(x00), .O(new_n89_));
  inv1   g046(.a(new_n89_), .O(z07));
  inv1   g047(.a(x03), .O(new_n91_));
  nor2   g048(.a(new_n46_), .b(x01), .O(new_n92_));
  inv1   g049(.a(x04), .O(new_n93_));
  nor2   g050(.a(x05), .b(new_n93_), .O(new_n94_));
  nand4  g051(.a(new_n94_), .b(new_n92_), .c(new_n91_), .d(new_n70_), .O(new_n95_));
  nor3   g052(.a(x08), .b(x07), .c(x06), .O(new_n96_));
  nand4  g053(.a(new_n96_), .b(x19), .c(new_n45_), .d(x17), .O(new_n97_));
  oai21  g054(.a(new_n97_), .b(new_n95_), .c(new_n74_), .O(z08));
  inv1   g055(.a(x21), .O(new_n99_));
  inv1   g056(.a(x22), .O(new_n100_));
  nand3  g057(.a(new_n92_), .b(x12), .c(new_n71_), .O(new_n101_));
  ...
  nand3  g065(.a(new_n108_), .b(new_n106_), .c(new_n63_), .O(new_n109_));
  oai21  g066(.a(new_n105_), .b(new_n101_), .c(new_n109_), .O(new_n110_));
  nand4  g067(.a(new_n110_), .b(new_n74_), .c(new_n100_), .d(new_n99_), .O(new_n111_));
  nor2   g068(.a(new_n111_), .b(x00), .O(z09));
  nor3   g069(.a(new_n100_), .b(new_n99_), .c(x20), .O(new_n113_));
  nand4  g070(.a(new_n113_), .b(new_n63_), .c(x18), .d(x01), .O(new_n114_));
  nor2   g071(.a(x13), .b(new_n72_), .O(new_n115_));
  nand3  g072(.a(new_n115_), .b(new_n92_), .c(new_n71_), .O(new_n116_));
  nor3   g073(.a(new_n103_), .b(new_n102_), .c(x14), .O(new_n117_));
  nand4  g074(.a(new_n117_), .b(new_n100_), .c(new_n99_), .d(x20), .O(new_n118_));
  oai21  g075(.a(new_n118_), .b(new_n116_), .c(new_n114_), .O(new_n119_));
  nand3  g076(.a(new_n119_), .b(new_n74_), .c(new_n70_), .O(new_n120_));
  inv1   g077(.a(new_n120_), .O(z10));
  nand4  g078(.a(new_n108_), .b(x21), .c(new_n106_), .d(new_n63_), .O(new_n122_));
  ...
  nand3  g082(.a(new_n125_), .b(new_n100_), .c(new_n70_), .O(new_n126_));
  nand2  g083(.a(new_n126_), .b(new_n74_), .O(z11));
  inv1   g084(.a(x24), .O(new_n128_));
  nand2  g085(.a(x10), .b(x02), .O(new_n129_));
  nand4  g086(.a(new_n129_), .b(new_n74_), .c(x01), .d(x00), .O(new_n130_));
  ...
  nand3  g092(.a(new_n135_), .b(new_n107_), .c(new_n70_), .O(new_n136_));
  ...
  oai21  g096(.a(new_n134_), .b(new_n62_), .c(new_n74_), .O(z13));
  nand4  g097(.a(new_n50_), .b(new_n45_), .c(new_n44_), .d(new_n57_), .O(new_n141_));
  nor2   g098(.a(new_n141_), .b(x19), .O(z14));
  oai21  g099(.a(x10), .b(new_n107_), .c(x02), .O(new_n143_));
  nand2  g100(.a(new_n143_), .b(x00), .O(new_n144_));
  nand3  g101(.a(x19), .b(new_n46_), .c(new_n107_), .O(new_n145_));
  nand3  g102(.a(new_n145_), .b(new_n144_), .c(new_n74_), .O(z15));
  nor3   g103(.a(new_n73_), .b(new_n107_), .c(x00), .O(z16));
  nand4  g104(.a(new_n74_), .b(x02), .c(new_n107_), .d(new_n70_), .O(new_n148_));
