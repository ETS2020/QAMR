...
module FAU ( 
  ...
  nor3   g34(.a(new_n69_), .b(x12), .c(new_n73_), .O(z07));
  ...
  nand4  g47(.a(x12), .b(new_n73_), .c(x02), .d(new_n60_), .O(new_n91_));
  ...
  nand4  g58(.a(new_n94_), .b(x12), .c(new_n73_), .d(x02), .O(new_n102_));
