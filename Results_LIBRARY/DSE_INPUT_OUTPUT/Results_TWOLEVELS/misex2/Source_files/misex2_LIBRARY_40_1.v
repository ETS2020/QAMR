...
module FAU ( 
  ...
  nand4  g28(.a(new_n71_), .b(new_n69_), .c(x10), .d(new_n68_), .O(new_n72_));
  nor2   g29(.a(new_n72_), .b(x12), .O(z04));
  nor3   g30(.a(new_n70_), .b(new_n46_), .c(new_n68_), .O(z05));
  nand4  g31(.a(x11), .b(x10), .c(new_n68_), .d(x02), .O(new_n75_));
  nor3   g32(.a(new_n75_), .b(new_n44_), .c(new_n60_), .O(z06));
  ...
  nand4  g42(.a(new_n85_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n86_));
  ...
  nand4  g62(.a(new_n69_), .b(x02), .c(new_n44_), .d(new_n60_), .O(new_n106_));
  inv1   g63(.a(new_n106_), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n95_), .c(new_n94_), .d(x12), .O(new_n108_));
  nor2   g65(.a(new_n108_), .b(new_n92_), .O(new_n109_));
  nand4  g66(.a(new_n109_), .b(new_n98_), .c(x20), .d(new_n93_), .O(new_n110_));
  ...
  nand3  g73(.a(new_n116_), .b(new_n44_), .c(new_n60_), .O(new_n117_));
  ...
  nand2  g79(.a(new_n53_), .b(new_n68_), .O(new_n123_));
  inv1   g80(.a(new_n123_), .O(new_n124_));
  nand4  g81(.a(new_n124_), .b(new_n52_), .c(new_n51_), .d(new_n46_), .O(new_n125_));
  nor2   g82(.a(new_n125_), .b(x19), .O(z14));
  oai21  g83(.a(new_n46_), .b(new_n60_), .c(x01), .O(new_n127_));
  oai21  g84(.a(x19), .b(x00), .c(new_n45_), .O(new_n128_));
  nand2  g85(.a(new_n128_), .b(new_n127_), .O(z15));
  nand3  g86(.a(x02), .b(new_n44_), .c(new_n60_), .O(new_n131_));
