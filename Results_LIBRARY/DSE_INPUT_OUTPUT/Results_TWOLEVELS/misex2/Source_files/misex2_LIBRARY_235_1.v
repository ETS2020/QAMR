...
module FAU ( 
  ...
  nor2   g27(.a(new_n70_), .b(new_n57_), .O(z05));
  ...
  nor3   g50(.a(new_n93_), .b(x11), .c(new_n48_), .O(new_n94_));
  ...
  nand4  g58(.a(new_n101_), .b(x02), .c(new_n47_), .d(new_n46_), .O(new_n102_));
  ...
  aoi21  g67(.a(x10), .b(x02), .c(new_n47_), .O(new_n111_));
  ...
  oai22  g72(.a(new_n115_), .b(new_n64_), .c(new_n47_), .d(x00), .O(z12));
  nor3   g73(.a(new_n49_), .b(x19), .c(new_n44_), .O(z13));
  nand4  g74(.a(new_n54_), .b(new_n57_), .c(new_n64_), .d(new_n48_), .O(new_n118_));
  aoi21  g75(.a(new_n118_), .b(new_n47_), .c(x00), .O(z14));
  oai21  g76(.a(new_n57_), .b(new_n46_), .c(x01), .O(new_n120_));
