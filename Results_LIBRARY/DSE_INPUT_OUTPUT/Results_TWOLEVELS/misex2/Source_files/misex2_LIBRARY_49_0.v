...
module FAU ( 
  ...
  nand4  g029(.a(new_n72_), .b(new_n69_), .c(x10), .d(new_n46_), .O(new_n73_));
  nand3  g030(.a(new_n73_), .b(new_n67_), .c(new_n53_), .O(z03));
  inv1   g031(.a(x00), .O(new_n75_));
  nand4  g032(.a(new_n53_), .b(new_n71_), .c(new_n70_), .d(x10), .O(new_n76_));
  ...
  oai21  g038(.a(new_n81_), .b(new_n80_), .c(new_n53_), .O(z05));
  nor3   g039(.a(new_n70_), .b(new_n47_), .c(x09), .O(new_n83_));
  ...
  aoi21  g053(.a(new_n96_), .b(x20), .c(x05), .O(z08));
  ...
  nand4  g062(.a(new_n52_), .b(new_n50_), .c(x18), .d(x01), .O(new_n106_));
  oai21  g063(.a(new_n105_), .b(new_n101_), .c(new_n106_), .O(new_n107_));
  nand4  g064(.a(new_n107_), .b(new_n99_), .c(new_n98_), .d(new_n75_), .O(new_n108_));
  nand2  g065(.a(new_n108_), .b(new_n53_), .O(z09));
  nand3  g066(.a(new_n50_), .b(x18), .c(x01), .O(new_n110_));
  nand3  g067(.a(x22), .b(x21), .c(new_n52_), .O(new_n111_));
  ...
  inv1   g079(.a(new_n115_), .O(new_n123_));
  nand2  g080(.a(new_n123_), .b(new_n100_), .O(new_n124_));
  nand3  g081(.a(x18), .b(x05), .c(x01), .O(new_n125_));
  inv1   g082(.a(new_n125_), .O(new_n126_));
  nand4  g083(.a(new_n126_), .b(x21), .c(new_n52_), .d(new_n50_), .O(new_n127_));
  nor2   g084(.a(new_n102_), .b(x14), .O(new_n128_));
  nand4  g085(.a(new_n128_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n129_));
  oai21  g086(.a(new_n129_), .b(new_n124_), .c(new_n127_), .O(new_n130_));
  nand3  g087(.a(new_n130_), .b(new_n99_), .c(new_n75_), .O(new_n131_));
  ...
  nand3  g095(.a(new_n138_), .b(new_n44_), .c(new_n75_), .O(new_n139_));
  ...
  oai21  g099(.a(new_n137_), .b(new_n90_), .c(new_n53_), .O(z13));
  nor2   g100(.a(x09), .b(x02), .O(new_n144_));
  nor2   g101(.a(x17), .b(x10), .O(new_n145_));
  nand4  g102(.a(new_n145_), .b(new_n144_), .c(new_n60_), .d(new_n58_), .O(new_n146_));
  nand2  g103(.a(new_n146_), .b(new_n53_), .O(z14));
  ...
  nand3  g107(.a(new_n150_), .b(new_n149_), .c(new_n53_), .O(z15));
  inv1   g108(.a(new_n53_), .O(new_n152_));
  nor3   g109(.a(new_n152_), .b(new_n44_), .c(x00), .O(z16));
  nor4   g110(.a(new_n152_), .b(new_n45_), .c(x01), .d(x00), .O(z17));
endmodule
