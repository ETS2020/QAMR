...
module FAU ( 
  ...
  nor3   g31(.a(new_n74_), .b(new_n60_), .c(new_n53_), .O(z06));
  ...
  nand4  g38(.a(new_n81_), .b(x02), .c(new_n60_), .d(new_n53_), .O(new_n82_));
  ...
  nand3  g47(.a(new_n90_), .b(x12), .c(new_n76_), .O(new_n91_));
  ...
  nand4  g56(.a(new_n99_), .b(new_n89_), .c(new_n88_), .d(new_n53_), .O(new_n100_));
  ...
  nand4  g61(.a(new_n90_), .b(new_n104_), .c(x12), .d(new_n76_), .O(new_n105_));
  ...
  nand4  g66(.a(new_n97_), .b(x21), .c(new_n96_), .d(new_n65_), .O(new_n110_));
  ...
  nand3  g70(.a(new_n113_), .b(new_n89_), .c(new_n53_), .O(new_n114_));
  ...
  nand3  g75(.a(new_n65_), .b(x17), .c(new_n46_), .O(new_n119_));
  aoi21  g76(.a(new_n119_), .b(new_n118_), .c(x01), .O(new_n120_));
  oai21  g77(.a(new_n120_), .b(new_n117_), .c(new_n116_), .O(new_n121_));
  oai22  g78(.a(new_n121_), .b(new_n47_), .c(x01), .d(new_n53_), .O(z12));
  aoi21  g79(.a(new_n119_), .b(new_n53_), .c(x01), .O(z13));
