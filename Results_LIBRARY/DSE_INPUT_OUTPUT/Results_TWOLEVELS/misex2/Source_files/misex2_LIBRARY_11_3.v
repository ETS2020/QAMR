...
module FAU ( 
  ...
  nand2  g007(.a(x24), .b(x21), .O(new_n51_));
  ...
  nor2   g032(.a(new_n75_), .b(new_n56_), .O(z04));
  nand4  g033(.a(new_n51_), .b(x10), .c(x09), .d(x02), .O(new_n77_));
  nor3   g034(.a(new_n77_), .b(new_n44_), .c(new_n56_), .O(z05));
  ...
  nand4  g039(.a(new_n51_), .b(new_n66_), .c(x11), .d(x10), .O(new_n83_));
  ...
  nand4  g066(.a(new_n109_), .b(new_n99_), .c(new_n98_), .d(new_n56_), .O(new_n110_));
  nand2  g067(.a(new_n110_), .b(new_n51_), .O(z09));
  nor2   g068(.a(x13), .b(new_n66_), .O(new_n112_));
  nand3  g069(.a(new_n112_), .b(new_n100_), .c(new_n65_), .O(new_n113_));
  nor3   g070(.a(new_n103_), .b(new_n102_), .c(x14), .O(new_n114_));
  nand4  g071(.a(new_n114_), .b(new_n99_), .c(new_n98_), .d(x20), .O(new_n115_));
  or2    g072(.a(new_n115_), .b(new_n113_), .O(new_n116_));
  nor2   g073(.a(new_n98_), .b(x20), .O(new_n117_));
  nor2   g074(.a(x24), .b(new_n99_), .O(new_n118_));
  nand4  g075(.a(new_n118_), .b(new_n117_), .c(new_n70_), .d(x01), .O(new_n119_));
  aoi21  g076(.a(new_n119_), .b(new_n116_), .c(x00), .O(z10));
  nand3  g077(.a(new_n117_), .b(new_n106_), .c(new_n50_), .O(new_n121_));
  nor2   g078(.a(new_n102_), .b(x14), .O(new_n122_));
  nand4  g079(.a(new_n122_), .b(new_n98_), .c(x20), .d(new_n103_), .O(new_n123_));
  oai21  g080(.a(new_n123_), .b(new_n113_), .c(new_n121_), .O(new_n124_));
  nand3  g081(.a(new_n124_), .b(new_n99_), .c(new_n56_), .O(new_n125_));
  nand2  g082(.a(new_n125_), .b(new_n51_), .O(z11));
  ...
  nand3  g100(.a(new_n143_), .b(new_n142_), .c(new_n51_), .O(z15));
  nand3  g101(.a(new_n51_), .b(x01), .c(new_n56_), .O(new_n145_));
  inv1   g102(.a(new_n145_), .O(z16));
  nand2  g103(.a(new_n100_), .b(new_n56_), .O(new_n147_));
