...
module FAU ( 
  ...
  aoi21  g30(.a(x12), .b(new_n60_), .c(new_n67_), .O(new_n74_));
  nand4  g31(.a(new_n74_), .b(x10), .c(new_n46_), .d(x02), .O(new_n75_));
  aoi21  g32(.a(new_n75_), .b(x01), .c(new_n44_), .O(z06));
  inv1   g33(.a(x12), .O(new_n77_));
  nor2   g34(.a(x09), .b(new_n45_), .O(new_n78_));
  nand4  g35(.a(new_n78_), .b(new_n77_), .c(x11), .d(x10), .O(new_n79_));
  ...
  nor3   g53(.a(new_n51_), .b(new_n60_), .c(x00), .O(new_n97_));
  nor2   g54(.a(x20), .b(x19), .O(new_n98_));
  nand3  g55(.a(new_n98_), .b(new_n97_), .c(new_n93_), .O(new_n99_));
  nand2  g56(.a(new_n99_), .b(new_n96_), .O(z09));
  nand4  g57(.a(new_n93_), .b(x20), .c(x16), .d(x15), .O(new_n101_));
  oai21  g58(.a(new_n101_), .b(new_n90_), .c(new_n44_), .O(new_n102_));
  nand2  g59(.a(new_n102_), .b(new_n60_), .O(new_n103_));
  nand4  g60(.a(new_n98_), .b(new_n97_), .c(x22), .d(x21), .O(new_n104_));
  nand2  g61(.a(new_n104_), .b(new_n103_), .O(z10));
  inv1   g62(.a(x22), .O(new_n106_));
  inv1   g63(.a(x20), .O(new_n107_));
  and2   g64(.a(x18), .b(x01), .O(new_n108_));
  nand4  g65(.a(new_n108_), .b(x21), .c(new_n107_), .d(new_n62_), .O(new_n109_));
  nor2   g66(.a(new_n45_), .b(x01), .O(new_n110_));
  nor2   g67(.a(x13), .b(new_n77_), .O(new_n111_));
  nand3  g68(.a(new_n111_), .b(new_n110_), .c(new_n67_), .O(new_n112_));
  nor2   g69(.a(new_n91_), .b(x14), .O(new_n113_));
  nor2   g70(.a(x21), .b(new_n107_), .O(new_n114_));
  nand3  g71(.a(new_n114_), .b(new_n113_), .c(new_n92_), .O(new_n115_));
  oai21  g72(.a(new_n115_), .b(new_n112_), .c(new_n109_), .O(new_n116_));
  nand3  g73(.a(new_n116_), .b(new_n106_), .c(new_n44_), .O(new_n117_));
  ...
  nand3  g79(.a(new_n62_), .b(x17), .c(new_n45_), .O(new_n123_));
