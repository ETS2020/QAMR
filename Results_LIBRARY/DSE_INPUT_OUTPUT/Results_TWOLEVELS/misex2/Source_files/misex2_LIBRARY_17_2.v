...
module FAU ( 
  ...
  nor3   g33(.a(new_n76_), .b(new_n62_), .c(new_n56_), .O(z06));
  ...
  nor2   g37(.a(new_n80_), .b(x12), .O(z07));
  ...
  nand2  g59(.a(new_n102_), .b(new_n67_), .O(new_n103_));
  oai22  g60(.a(new_n103_), .b(new_n101_), .c(new_n100_), .d(new_n96_), .O(new_n104_));
  nand4  g61(.a(new_n104_), .b(new_n93_), .c(new_n92_), .d(new_n56_), .O(new_n105_));
  inv1   g62(.a(new_n105_), .O(z09));
  nor3   g63(.a(new_n93_), .b(new_n92_), .c(x20), .O(new_n107_));
  nand4  g64(.a(new_n107_), .b(new_n67_), .c(x18), .d(x01), .O(new_n108_));
  inv1   g65(.a(x13), .O(new_n109_));
  nand3  g66(.a(new_n109_), .b(x12), .c(new_n94_), .O(new_n110_));
  ...
  nand4  g73(.a(new_n99_), .b(x12), .c(new_n94_), .d(x02), .O(new_n117_));
  nand3  g74(.a(new_n114_), .b(new_n98_), .c(x15), .O(new_n118_));
  oai21  g75(.a(new_n118_), .b(new_n117_), .c(new_n56_), .O(new_n119_));
  nand2  g76(.a(new_n119_), .b(new_n62_), .O(new_n120_));
  inv1   g77(.a(new_n103_), .O(new_n121_));
  nor2   g78(.a(new_n101_), .b(x00), .O(new_n122_));
  nand4  g79(.a(new_n122_), .b(new_n121_), .c(new_n93_), .d(x21), .O(new_n123_));
  nand2  g80(.a(new_n123_), .b(new_n120_), .O(z11));
  inv1   g81(.a(x24), .O(new_n125_));
  aoi21  g82(.a(x10), .b(x02), .c(new_n56_), .O(new_n126_));
  oai21  g83(.a(x19), .b(x02), .c(x23), .O(new_n127_));
  nand3  g84(.a(new_n67_), .b(x17), .c(new_n57_), .O(new_n128_));
  aoi21  g85(.a(new_n128_), .b(new_n127_), .c(x01), .O(new_n129_));
  oai21  g86(.a(new_n129_), .b(new_n126_), .c(new_n125_), .O(new_n130_));
  oai22  g87(.a(new_n130_), .b(new_n46_), .c(x01), .d(new_n56_), .O(z12));
  nand2  g88(.a(new_n47_), .b(x17), .O(new_n132_));
  nor2   g89(.a(new_n132_), .b(x19), .O(z13));
  nand4  g90(.a(new_n59_), .b(new_n58_), .c(new_n46_), .d(new_n57_), .O(new_n134_));
  aoi21  g91(.a(new_n134_), .b(new_n56_), .c(x01), .O(z14));
  inv1   g92(.a(new_n126_), .O(new_n136_));
  aoi21  g93(.a(x19), .b(new_n57_), .c(x00), .O(new_n137_));
  oai21  g94(.a(new_n137_), .b(x01), .c(new_n136_), .O(z15));
